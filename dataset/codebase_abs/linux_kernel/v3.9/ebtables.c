...
{
int V_125 ;
struct V_116 * V_116 = F_79 ( V_204 ) ;
if ( ! F_80 ( V_116 -> V_205 , V_206 ) )
return - V_207 ;
switch( V_201 ) {
case V_208 :
V_125 = F_59 ( V_116 , V_183 , V_97 ) ;
break;
case V_209 :
V_125 = F_72 ( V_116 , V_183 , V_97 ) ;
break;
default:
V_125 = - V_127 ;
}
...
if ( F_60 ( & V_185 , V_183 , sizeof( V_185 ) ) )
return - V_7 ;
V_74 = F_31 ( V_116 , V_185 . V_30 , & V_125 , & V_179 ) ;
if ( ! V_74 )
return V_125 ;
switch( V_201 ) {
case V_210 :
...
unsigned int V_214 )
{
if ( F_87 ( V_21 -> V_215 == - 1 ) )
return F_84 ( V_214 ) - F_85 ( V_214 ) ;
return F_88 ( V_21 ) ;
}
static int F_89 ( struct V_19 * V_20 , void T_1 * * V_216 ,
unsigned int * V_177 )
{
const struct V_122 * V_21 = V_20 -> V_15 . V_21 ;
struct V_213 T_1 * V_217 = * V_216 ;
int V_218 = F_86 ( V_21 , V_20 -> V_126 ) ;
T_4 V_219 = V_20 -> V_126 - V_218 ;
F_90 ( V_218 >= V_20 -> V_126 ) ;
if ( F_4 ( V_217 -> V_15 . V_30 , V_21 -> V_30 ,
strlen ( V_21 -> V_30 ) + 1 ) || F_91 ( V_219 , & V_217 -> V_126 ) )
return - V_7 ;
if ( V_21 -> V_220 ) {
if ( V_21 -> V_220 ( V_217 -> V_18 , V_20 -> V_18 ) )
return - V_7 ;
} else if ( F_4 ( V_217 -> V_18 , V_20 -> V_18 , V_219 ) )
return - V_7 ;
* V_177 -= F_82 () + V_218 ;
* V_216 = V_217 -> V_18 ;
* V_216 += V_219 ;
...
struct V_213 T_1 * V_217 = * V_216 ;
int V_218 = F_93 ( V_14 ) ;
T_4 V_221 = V_74 -> V_162 - V_218 ;
F_90 ( V_218 >= V_74 -> V_162 ) ;
if ( F_4 ( V_217 -> V_15 . V_30 , V_14 -> V_30 ,
strlen ( V_14 -> V_30 ) + 1 ) || F_91 ( V_221 , & V_217 -> V_126 ) )
return - V_7 ;
if ( V_14 -> V_220 ) {
if ( V_14 -> V_220 ( V_217 -> V_18 , V_74 -> V_18 ) )
return - V_7 ;
} else if ( F_4 ( V_217 -> V_18 , V_74 -> V_18 , V_221 ) )
return - V_7 ;
* V_177 -= F_82 () + V_218 ;
* V_216 = V_217 -> V_18 ;
* V_216 += V_221 ;
...
static int F_95 ( struct V_31 * V_32 , void T_1 * * V_216 ,
unsigned int * V_177 )
{
struct V_73 * V_74 ;
struct V_31 T_1 * V_222 ;
...
return - V_127 ;
if ( F_4 ( * V_216 , V_32 , sizeof( struct V_78 ) ) )
return - V_7 ;
* V_216 += sizeof( struct V_78 ) ;
* V_177 -= sizeof( struct V_78 ) ;
return 0 ;
}
if ( * V_177 < sizeof( * V_222 ) )
return - V_127 ;
V_222 = (struct V_31 T_1 * ) * V_216 ;
if ( F_4 ( V_222 , V_32 , sizeof( * V_222 ) ) )
return - V_7 ;
V_223 = * V_177 ;
* V_216 += sizeof( * V_222 ) ;
V_125 = F_19 ( V_32 , F_89 , V_216 , V_177 ) ;
if ( V_125 )
return V_125 ;
V_124 = V_32 -> V_124 - ( V_223 - * V_177 ) ;
V_125 = F_21 ( V_32 , F_94 , V_216 , V_177 ) ;
if ( V_125 )
return V_125 ;
V_98 = V_32 -> V_98 - ( V_223 - * V_177 ) ;
V_74 = (struct V_73 * ) ( ( char * ) V_32 + V_32 -> V_98 ) ;
V_125 = F_92 ( V_74 , V_216 , V_177 ) ;
if ( V_125 )
return V_125 ;
V_142 = V_32 -> V_142 - ( V_223 - * V_177 ) ;
if ( F_91 ( V_124 , & V_222 -> V_124 ) ||
F_91 ( V_98 , & V_222 -> V_98 ) ||
F_91 ( V_142 , & V_222 -> V_142 ) )
return - V_7 ;
* V_177 -= sizeof( * V_222 ) ;
return 0 ;
}
static int F_96 ( struct V_19 * V_20 , int * V_218 )
{
* V_218 += F_86 ( V_20 -> V_15 . V_21 , V_20 -> V_126 ) ;
* V_218 += F_82 () ;
return 0 ;
}
static int F_97 ( struct V_8 * V_9 , int * V_218 )
{
* V_218 += F_93 ( V_9 -> V_15 . V_16 ) ;
* V_218 += F_82 () ;
return 0 ;
}
static int F_98 ( const struct V_31 * V_32 ,
const struct V_81 * V_224 ,
const void * V_80 ,
struct V_225 * V_135 )
{
const struct V_73 * V_74 ;
unsigned int V_226 ;
int V_218 , V_125 , V_28 ;
if ( V_32 -> V_43 == 0 )
return 0 ;
V_218 = 0 ;
V_226 = ( void * ) V_32 - V_80 ;
F_19 ( V_32 , F_96 , & V_218 ) ;
F_21 ( V_32 , F_97 , & V_218 ) ;
V_74 = ( const struct V_73 * ) ( ( char * ) V_32 + V_32 -> V_98 ) ;
V_218 += F_93 ( V_74 -> V_15 . V_14 ) ;
V_218 += F_82 () ;
V_135 -> V_137 -= V_218 ;
V_125 = F_99 ( V_5 , V_226 , V_218 ) ;
if ( V_125 )
return V_125 ;
for ( V_28 = 0 ; V_28 < V_140 ; V_28 ++ ) {
const void * V_227 = V_224 -> V_90 [ V_28 ] ;
if ( V_224 -> V_90 [ V_28 ] &&
( V_32 < (struct V_31 * ) ( V_80 - V_227 ) ) ) {
V_135 -> V_90 [ V_28 ] -= V_218 ;
F_100 ( L_45 ,
V_135 -> V_90 [ V_28 ] + V_218 ,
V_135 -> V_90 [ V_28 ] ) ;
}
...
static int F_101 ( const struct V_81 * V_224 ,
struct V_225 * V_135 )
{
unsigned int V_177 = V_224 -> V_137 ;
const void * V_92 = V_224 -> V_92 ;
V_135 -> V_137 = V_177 ;
F_102 ( V_5 , V_224 -> V_68 ) ;
return F_50 ( V_92 , V_177 , F_98 , V_224 ,
V_92 , V_135 ) ;
}
static int F_103 ( struct V_66 * V_74 ,
void T_1 * V_183 , int * V_97 , int V_201 )
{
struct V_225 V_134 , V_185 ;
struct V_70 * V_173 ;
struct V_81 V_228 ;
int V_125 ;
void T_1 * V_166 ;
...
if ( V_201 == V_202 ) {
V_228 . V_137 = V_74 -> V_82 -> V_137 ;
V_228 . V_68 = V_74 -> V_82 -> V_68 ;
V_228 . V_92 = V_74 -> V_82 -> V_92 ;
V_173 = V_74 -> V_82 -> V_88 ;
} else {
V_228 . V_137 = V_74 -> V_67 -> V_137 ;
V_228 . V_68 = V_74 -> V_67 -> V_68 ;
V_228 . V_92 = V_74 -> V_67 -> V_92 ;
V_173 = V_74 -> V_67 -> V_88 ;
}
if ( F_60 ( & V_185 , V_183 , sizeof( V_185 ) ) )
return - V_7 ;
if ( V_185 . V_68 != V_228 . V_68 ||
( V_185 . V_176 && V_185 . V_176 != V_228 . V_68 ) )
return - V_127 ;
memcpy ( & V_134 , & V_185 , sizeof( V_134 ) ) ;
if ( V_201 == V_202 )
V_125 = F_101 ( V_74 -> V_82 , & V_134 ) ;
else
V_125 = F_101 ( & V_228 , & V_134 ) ;
if ( V_125 )
return V_125 ;
if ( * V_97 != sizeof( V_185 ) + V_134 . V_137 +
( V_185 . V_176 ? V_228 . V_68 * sizeof( struct V_70 ) : 0 ) ) {
F_104 ( L_46 ,
* V_97 , V_228 . V_137 , V_134 . V_137 ) ;
return - V_127 ;
}
V_125 = F_76 ( V_74 , V_173 , F_105 ( V_185 . V_88 ) ,
V_185 . V_176 , V_228 . V_68 ) ;
if ( V_125 )
return V_125 ;
V_166 = F_105 ( V_185 . V_92 ) ;
return F_50 ( V_228 . V_92 , V_228 . V_137 ,
F_95 , & V_166 , & V_185 . V_137 ) ;
}
static int F_106 ( struct V_229 * V_230 , unsigned int V_231 )
{
V_230 -> V_232 += V_231 ;
return V_230 -> V_232 >= V_231 ? 0 : - V_127 ;
}
static int F_107 ( struct V_229 * V_230 ,
void * V_18 , unsigned int V_231 )
{
if ( V_230 -> V_233 == NULL )
goto V_234;
F_90 ( V_230 -> V_232 + V_231 > V_230 -> V_235 ) ;
memcpy ( V_230 -> V_233 + V_230 -> V_232 , V_18 , V_231 ) ;
V_234:
V_230 -> V_236 += V_231 ;
return F_106 ( V_230 , V_231 ) ;
}
static int F_108 ( struct V_229 * V_230 , unsigned int V_231 )
{
char * V_237 = V_230 -> V_233 ;
F_90 ( V_237 && V_230 -> V_232 > V_230 -> V_235 ) ;
if ( V_237 != NULL && V_231 > 0 )
memset ( V_237 + V_230 -> V_232 , 0 , V_231 ) ;
return F_106 ( V_230 , V_231 ) ;
}
static int F_109 ( struct V_213 * V_238 ,
enum V_239 V_239 ,
struct V_229 * V_230 ,
...
void * V_1 = NULL ;
int V_218 , V_241 = 0 ;
unsigned int V_242 , V_126 = V_238 -> V_126 ;
F_110 ( V_30 , V_238 -> V_15 . V_30 , sizeof( V_30 ) ) ;
if ( V_230 -> V_233 )
V_1 = V_230 -> V_233 + V_230 -> V_232 ;
switch ( V_239 ) {
case V_243 :
V_21 = F_33 ( V_5 , V_30 , 0 ) ;
if ( F_34 ( V_21 ) )
return F_35 ( V_21 ) ;
V_218 = F_86 ( V_21 , V_126 ) ;
if ( V_1 ) {
if ( V_21 -> V_244 )
V_21 -> V_244 ( V_1 , V_238 -> V_18 ) ;
else
memcpy ( V_1 , V_238 -> V_18 , V_126 ) ;
}
V_242 = V_21 -> V_215 ;
if ( F_87 ( V_242 == - 1 ) )
V_242 = V_126 ;
...
case V_245 :
case V_246 :
V_240 = F_39 ( V_5 , V_30 , 0 ) ;
if ( F_34 ( V_240 ) )
return F_35 ( V_240 ) ;
V_218 = F_93 ( V_240 ) ;
if ( V_1 ) {
if ( V_240 -> V_244 )
V_240 -> V_244 ( V_1 , V_238 -> V_18 ) ;
else
memcpy ( V_1 , V_238 -> V_18 , V_126 ) ;
}
V_242 = V_240 -> V_247 ;
...
V_230 -> V_232 += V_126 + V_218 ;
V_230 -> V_236 += V_126 ;
V_241 = F_84 ( V_242 ) - V_242 ;
if ( V_241 > 0 && V_1 ) {
F_90 ( V_230 -> V_235 <= V_241 ) ;
F_90 ( V_230 -> V_232 - ( V_126 + V_218 ) + V_242 > V_230 -> V_235 - V_241 ) ;
memset ( V_1 + V_242 , 0 , V_241 ) ;
}
return V_218 + V_126 ;
}
static int F_111 ( struct V_213 * V_248 ,
unsigned int V_249 , enum V_239 type ,
struct V_229 * V_230 , const void * V_80 )
{
int V_250 = 0 ;
char * V_251 ;
if ( V_249 == 0 )
return 0 ;
V_251 = ( char * ) V_248 ;
while ( V_249 >= sizeof( * V_248 ) ) {
struct V_19 * V_252 ;
int V_125 ;
V_252 = (struct V_19 * ) V_230 -> V_233 ;
if ( V_252 ) {
char * V_185 ;
V_185 = V_230 -> V_233 + V_230 -> V_232 ;
V_252 = (struct V_19 * ) V_185 ;
}
V_125 = F_107 ( V_230 , V_251 , sizeof( * V_248 ) ) ;
if ( V_125 < 0 )
return V_125 ;
V_249 -= sizeof( * V_248 ) ;
V_125 = F_108 ( V_230 , F_82 () ) ;
if ( V_125 < 0 )
return V_125 ;
if ( V_248 -> V_126 > V_249 )
return - V_127 ;
V_249 -= V_248 -> V_126 ;
V_125 = F_109 ( V_248 , type , V_230 , V_80 ) ;
if ( V_125 < 0 )
return V_125 ;
F_90 ( V_125 < V_248 -> V_126 ) ;
V_250 += V_125 - V_248 -> V_126 ;
V_250 += F_82 () ;
V_251 += sizeof( * V_248 ) ;
V_251 += V_248 -> V_126 ;
if ( V_252 )
V_252 -> V_126 = V_125 ;
F_112 ( type == V_246 && V_249 ) ;
V_248 = (struct V_213 * ) V_251 ;
}
return V_250 ;
}
...
struct V_229 * V_230 )
{
unsigned int V_28 , V_152 , V_254 , V_255 = 0 ;
unsigned int V_256 [ 4 ] ;
unsigned int * V_257 = NULL ;
int V_125 ;
char * V_258 ;
if ( * V_253 < sizeof( struct V_78 ) )
return - V_127 ;
if ( ! V_25 -> V_43 ) {
* V_253 -= sizeof( struct V_78 ) ;
return F_107 ( V_230 , V_25 , sizeof( struct V_78 ) ) ;
}
if ( * V_253 < sizeof( * V_25 ) || V_25 -> V_142 < sizeof( * V_25 ) )
return - V_127 ;
V_254 = V_230 -> V_236 ;
V_125 = F_107 ( V_230 , V_25 ,
F_114 ( struct V_31 , V_124 ) ) ;
if ( V_125 < 0 )
return V_125 ;
V_256 [ 0 ] = sizeof( struct V_31 ) ;
memcpy ( & V_256 [ 1 ] , & V_25 -> V_124 ,
sizeof( V_256 ) - sizeof( V_256 [ 0 ] ) ) ;
if ( V_230 -> V_233 ) {
V_258 = V_230 -> V_233 + V_230 -> V_232 ;
V_257 = ( unsigned int * ) V_258 ;
}
V_125 = F_107 ( V_230 , & V_256 [ 1 ] ,
sizeof( V_256 ) - sizeof( V_256 [ 0 ] ) ) ;
if ( V_125 < 0 )
return V_125 ;
V_258 = ( char * ) V_25 ;
...
unsigned int V_177 ;
char * V_251 = V_258 ;
V_251 = V_258 + V_256 [ V_28 ] ;
if ( V_256 [ V_28 ] > V_256 [ V_152 ] )
return - V_127 ;
V_248 = (struct V_213 * ) V_251 ;
V_177 = V_256 [ V_152 ] - V_256 [ V_28 ] ;
V_125 = F_111 ( V_248 , V_177 , V_28 , V_230 , V_80 ) ;
if ( V_125 < 0 )
return V_125 ;
V_255 += V_125 ;
if ( V_257 && V_255 ) {
F_100 ( L_47 ,
V_257 [ V_28 ] , V_256 [ V_152 ] + V_255 ) ;
V_257 [ V_28 ] = V_256 [ V_152 ] + V_255 ;
}
}
if ( V_230 -> V_233 == NULL ) {
unsigned int V_139 = V_258 - ( char * ) V_80 ;
V_125 = F_99 ( V_5 , V_139 , V_255 ) ;
if ( V_125 < 0 )
return V_125 ;
}
V_254 = V_230 -> V_236 - V_254 ;
F_90 ( * V_253 < V_254 ) ;
* V_253 -= V_254 ;
return 0 ;
}
static int F_115 ( unsigned char * V_18 , unsigned int V_259 ,
struct V_229 * V_230 )
{
unsigned int V_260 = V_259 ;
int V_125 ;
V_125 = F_50 ( V_18 , V_259 , F_113 , V_18 ,
& V_260 , V_230 ) ;
if ( V_125 < 0 )
return V_125 ;
F_112 ( V_260 ) ;
...
V_125 = F_115 ( V_262 , V_185 . V_137 , & V_230 ) ;
if ( V_125 < 0 )
goto V_263;
F_100 ( L_48 ,
V_185 . V_137 , V_230 . V_232 , V_230 . V_236 ,
F_2 ( V_5 , V_185 . V_137 ) ) ;
V_261 = V_125 ;
V_135 -> V_92 = F_51 ( V_261 ) ;
if ( ! V_135 -> V_92 ) {
F_53 ( V_262 ) ;
V_125 = - V_172 ;
goto V_263;
...
if ( V_185 . V_90 [ V_28 ] ) {
unsigned int V_265 ;
V_264 = ( char T_1 * ) V_185 . V_90 [ V_28 ] ;
V_265 = V_264 - V_185 . V_92 ;
V_264 += F_2 ( V_5 , V_265 ) ;
V_185 . V_90 [ V_28 ] = (struct V_78 T_1 * ) V_264 ;
}
}
F_119 ( V_5 ) ;
F_120 ( V_5 ) ;
...
switch ( V_201 ) {
case V_208 :
V_125 = F_117 ( V_116 , V_183 , V_97 ) ;
break;
case V_209 :
V_125 = F_121 ( V_116 , V_183 , V_97 ) ;
break;
default:
V_125 = - V_127 ;
}
