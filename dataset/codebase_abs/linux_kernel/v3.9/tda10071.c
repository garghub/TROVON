...
V_23 . args [ 3 ] = 0x00 ;
V_23 . args [ 4 ] = 0x00 ;
V_23 . args [ 5 ] = ( V_2 -> V_11 . V_123 ) ? V_2 -> V_11 . V_123 : 0x14 ;
V_23 . args [ 6 ] = 0x00 ;
V_23 . args [ 7 ] = 0x03 ;
V_23 . args [ 8 ] = 0x02 ;
V_23 . args [ 9 ] = 0x02 ;
...
struct V_28 * F_35 ( const struct V_133 * V_134 ,
struct V_135 * V_14 )
{
int V_6 ;
struct V_1 * V_2 = NULL ;
T_1 V_20 ;
V_2 = F_36 ( sizeof( struct V_1 ) , V_136 ) ;
if ( V_2 == NULL ) {
V_6 = - V_137 ;
goto error;
}
if ( ! V_134 -> V_12 ) {
F_11 ( & V_14 -> V_15 , L_37 , V_26 ) ;
V_6 = - V_35 ;
goto error;
}
if ( ! V_134 -> V_123 ) {
F_11 ( & V_14 -> V_15 , L_38 , V_26 ) ;
V_6 = - V_35 ;
goto error;
}
V_2 -> V_14 = V_14 ;
memcpy ( & V_2 -> V_11 , V_134 , sizeof( struct V_133 ) ) ;
...
if ( V_6 || V_20 != 0x01 )
goto error;
memcpy ( & V_2 -> V_29 . V_138 , & V_98 , sizeof( struct V_139 ) ) ;
V_2 -> V_29 . V_31 = V_2 ;
return & V_2 -> V_29 ;
error:
