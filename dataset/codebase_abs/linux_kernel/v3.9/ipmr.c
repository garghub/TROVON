...
V_342 -> V_376 = V_378 ;
V_342 -> V_361 = 0 ;
if ( F_216 ( V_33 , V_379 , V_138 -> V_188 ) ||
F_216 ( V_33 , V_380 , V_138 -> V_189 ) )
goto V_373;
V_12 = F_107 ( V_4 , V_33 , V_138 , V_342 ) ;
if ( V_12 < 0 && V_12 != - V_223 )
goto V_373;
return F_217 ( V_33 , V_148 ) ;
V_373:
F_218 ( V_33 , V_148 ) ;
return - V_197 ;
}
static T_8 F_219 ( bool V_146 , int V_128 )
{
T_8 V_107 =
F_220 ( sizeof( struct V_341 ) )
+ F_221 ( 4 )
+ F_221 ( 4 )
+ F_221 ( 4 )
;
...
+ F_221 ( 4 )
+ F_221 ( 0 )
+ V_128 * F_222 ( sizeof( struct V_343 ) )
+ F_221 ( sizeof( struct V_346 ) )
;
return V_107 ;
}
...
struct V_32 * V_33 ;
int V_12 = - V_171 ;
V_33 = F_223 ( F_219 ( V_219 -> V_193 >= V_166 , V_4 -> V_128 ) ,
V_194 ) ;
if ( V_33 == NULL )
goto V_381;
...
if ( V_12 < 0 )
goto V_381;
F_224 ( V_33 , V_2 , 0 , V_382 , NULL , V_194 ) ;
return;
V_381:
F_48 ( V_33 ) ;
if ( V_12 < 0 )
F_225 ( V_2 , V_382 , V_12 ) ;
}
static int F_226 ( struct V_32 * V_33 , struct V_383 * V_384 )
{
...
static struct V_127 * F_227 ( struct V_2 * V_2 ,
struct V_395 * V_396 ,
T_9 V_397 )
{
...
static void * F_228 ( struct V_398 * V_364 , T_9 * V_397 )
__acquires( V_104 )
{
struct V_395 * V_396 = V_364 -> V_399 ;
struct V_2 * V_2 = F_229 ( V_364 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , V_45 ) ;
if ( V_4 == NULL )
return F_190 ( - V_223 ) ;
V_396 -> V_4 = V_4 ;
F_49 ( & V_104 ) ;
return * V_397 ? F_227 ( V_2 , V_364 -> V_399 , * V_397 - 1 )
: V_400 ;
}
static void * F_230 ( struct V_398 * V_364 , void * V_62 , T_9 * V_397 )
{
struct V_395 * V_396 = V_364 -> V_399 ;
struct V_2 * V_2 = F_229 ( V_364 ) ;
struct V_1 * V_4 = V_396 -> V_4 ;
...
static void F_231 ( struct V_398 * V_364 , void * V_62 )
__releases( V_104 )
{
F_51 ( & V_104 ) ;
}
static int F_232 ( struct V_398 * V_364 , void * V_62 )
{
struct V_395 * V_396 = V_364 -> V_399 ;
struct V_1 * V_4 = V_396 -> V_4 ;
if ( V_62 == V_400 ) {
...
static int F_235 ( struct V_401 * V_401 , struct V_402 * V_402 )
{
return F_236 ( V_401 , V_402 , & V_403 ,
sizeof( struct V_395 ) ) ;
}
static struct V_137 * F_237 ( struct V_2 * V_2 ,
...
static void * F_238 ( struct V_398 * V_364 , T_9 * V_397 )
{
...
V_405 -> V_163 = NULL ;
V_405 -> V_286 = 0 ;
return * V_397 ? F_237 ( V_2 , V_364 -> V_399 , * V_397 - 1 )
: V_400 ;
}
static void * F_239 ( struct V_398 * V_364 , void * V_62 , T_9 * V_397 )
{
...
++ * V_397 ;
if ( V_62 == V_400 )
return F_237 ( V_2 , V_364 -> V_399 , 0 ) ;
if ( V_219 -> V_50 . V_49 != V_405 -> V_163 )
return F_240 ( V_219 -> V_50 . V_49 , struct V_137 , V_50 ) ;
if ( V_405 -> V_163 == & V_4 -> V_55 )
goto V_406;
F_241 ( V_405 -> V_163 != & V_4 -> V_54 [ V_405 -> V_286 ] ) ;
while ( ++ V_405 -> V_286 < V_53 ) {
V_405 -> V_163 = & V_4 -> V_54 [ V_405 -> V_286 ] ;
if ( F_87 ( V_405 -> V_163 ) )
continue;
return F_242 ( V_405 -> V_163 , struct V_137 , V_50 ) ;
}
F_59 () ;
V_405 -> V_163 = & V_4 -> V_55 ;
V_405 -> V_286 = 0 ;
...
static void F_243 ( struct V_398 * V_364 , void * V_62 )
{
struct V_404 * V_405 = V_364 -> V_399 ;
struct V_1 * V_4 = V_405 -> V_4 ;
if ( V_405 -> V_163 == & V_4 -> V_55 )
...
static int F_244 ( struct V_398 * V_364 , void * V_62 )
{
int V_407 ;
if ( V_62 == V_400 ) {
F_233 ( V_364 ,
...
F_234 ( V_364 , L_11 , 0ul , 0ul , 0ul ) ;
}
F_245 ( V_364 , '\n' ) ;
}
return 0 ;
}
static int F_246 ( struct V_401 * V_401 , struct V_402 * V_402 )
{
return F_236 ( V_401 , V_402 , & V_408 ,
sizeof( struct V_404 ) ) ;
}
static int T_2 F_247 ( struct V_2 * V_2 )
{
int V_12 ;
V_12 = F_11 ( V_2 ) ;
if ( V_12 < 0 )
...
#ifdef F_248
V_12 = - V_46 ;
if ( ! F_249 ( L_13 , 0 , V_2 -> V_410 , & V_411 ) )
goto V_412;
if ( ! F_249 ( L_14 , 0 , V_2 -> V_410 , & V_413 ) )
goto V_414;
#endif
return 0 ;
#ifdef F_248
V_414:
F_250 ( L_13 , V_2 -> V_410 ) ;
V_412:
F_20 ( V_2 ) ;
#endif
V_409:
...
static void T_3 F_251 ( struct V_2 * V_2 )
{
#ifdef F_248
F_250 ( L_14 , V_2 -> V_410 ) ;
F_250 ( L_13 , V_2 -> V_410 ) ;
#endif
F_20 ( V_2 ) ;
}
