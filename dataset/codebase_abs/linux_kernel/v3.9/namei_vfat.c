...
struct V_1 * V_148 ;
int V_34 ;
F_52 ( & F_11 ( V_147 ) -> V_149 ) ;
V_34 = F_47 ( V_31 , & V_1 -> V_150 , & V_33 ) ;
if ( V_34 ) {
if ( V_34 == - V_35 ) {
V_16 = NULL ;
goto V_151;
...
V_16 = F_53 ( V_147 , V_33 . V_111 , V_33 . V_152 ) ;
F_25 ( V_33 . V_36 ) ;
if ( F_54 ( V_16 ) ) {
V_34 = F_55 ( V_16 ) ;
goto error;
...
static int F_66 ( struct V_16 * V_31 , struct V_1 * V_1 , T_5 V_154 ,
bool V_155 )
{
struct V_146 * V_147 = V_31 -> V_54 ;
struct V_16 * V_16 ;
...
F_52 ( & F_11 ( V_147 ) -> V_149 ) ;
V_103 = V_156 ;
V_34 = F_40 ( V_31 , & V_1 -> V_150 , 0 , 0 , & V_103 , & V_33 ) ;
if ( V_34 )
goto V_151;
V_31 -> V_7 ++ ;
V_16 = F_53 ( V_147 , V_33 . V_111 , V_33 . V_152 ) ;
...
static int F_75 ( struct V_16 * V_31 , struct V_1 * V_1 , T_5 V_154 )
{
struct V_146 * V_147 = V_31 -> V_54 ;
struct V_16 * V_16 ;
struct V_32 V_33 ;
...
V_34 = F_40 ( V_31 , & V_1 -> V_150 , 1 , V_101 , & V_103 , & V_33 ) ;
if ( V_34 )
goto V_120;
V_31 -> V_7 ++ ;
F_77 ( V_31 ) ;
...
static int F_80 ( struct V_16 * V_157 , struct V_1 * V_158 ,
struct V_16 * V_159 , struct V_1 * V_160 )
{
struct V_161 * V_162 ;
struct V_110 * V_163 ;
struct V_16 * V_164 , * V_165 ;
struct V_32 V_166 , V_33 ;
struct V_102 V_103 ;
T_4 V_167 ;
int V_34 , V_100 , V_168 , V_169 = 0 ;
struct V_146 * V_147 = V_157 -> V_54 ;
V_166 . V_36 = V_33 . V_36 = V_162 = NULL ;
V_164 = V_158 -> V_6 ;
V_165 = V_160 -> V_6 ;
F_52 ( & F_11 ( V_147 ) -> V_149 ) ;
V_34 = F_47 ( V_157 , & V_158 -> V_150 , & V_166 ) ;
if ( V_34 )
goto V_151;
V_100 = F_59 ( V_164 -> V_153 ) ;
V_168 = ( V_100 && V_157 != V_159 ) ;
if ( V_168 ) {
if ( F_81 ( V_164 , & V_162 , & V_163 ) ) {
V_34 = - V_170 ;
goto V_151;
}
}
...
V_167 = F_82 ( V_165 ) -> V_152 ;
F_73 ( V_165 ) ;
} else {
V_34 = F_40 ( V_159 , & V_160 -> V_150 , V_100 , 0 ,
& V_103 , & V_33 ) ;
if ( V_34 )
goto V_151;
V_167 = V_33 . V_152 ;
...
V_34 = F_70 ( V_157 , & V_166 ) ;
V_166 . V_36 = NULL ;
if ( V_34 )
goto V_173;
V_157 -> V_7 ++ ;
V_157 -> V_141 = V_157 -> V_142 = V_103 ;
if ( F_43 ( V_157 ) )
( void ) F_44 ( V_157 ) ;
else
F_45 ( V_157 ) ;
...
V_169 = 1 ;
if ( V_168 ) {
F_38 ( V_163 , F_82 ( V_157 ) -> V_172 ) ;
F_84 ( V_162 , V_164 ) ;
V_169 |= F_85 ( V_162 ) ;
}
V_171:
F_73 ( V_164 ) ;
F_83 ( V_164 , V_166 . V_152 ) ;
if ( V_165 ) {
F_83 ( V_165 , V_167 ) ;
if ( V_169 )
V_169 |= F_44 ( V_165 ) ;
} else {
int V_174 = F_70 ( V_159 , & V_33 ) ;
if ( V_169 )
V_169 |= V_174 ;
V_33 . V_36 = NULL ;
}
