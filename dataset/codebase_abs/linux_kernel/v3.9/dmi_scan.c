...
return memcmp ( V_23 + 16 , L_21 , 5 ) || F_28 ( V_23 + 16 ) ;
}
return 1 ;
}
void T_1 F_33 ( void )
...
if ( memcmp ( V_70 , L_22 , 4 ) == 0 && V_70 - V_23 <= 0xFFE0 )
V_71 = F_31 ( V_70 ) ;
else if ( memcmp ( V_70 , L_21 , 5 ) == 0 )
V_71 = F_28 ( V_70 ) ;
else
continue;
if ( ! V_71 ) {
...
static bool F_35 ( const struct V_80 * V_81 )
{
int V_15 ;
F_36 ( ! V_79 , V_10 L_24 ) ;
for ( V_15 = 0 ; V_15 < F_37 ( V_81 -> V_82 ) ; V_15 ++ ) {
int V_3 = V_81 -> V_82 [ V_15 ] . V_21 ;
if ( V_3 == V_83 )
break;
if ( V_24 [ V_3 ]
&& strstr ( V_24 [ V_3 ] , V_81 -> V_82 [ V_15 ] . V_84 ) )
continue;
return false ;
}
return true ;
}
static bool F_38 ( const struct V_80 * V_81 )
{
return V_81 -> V_82 [ 0 ] . V_21 == V_83 ;
}
int F_39 ( const struct V_80 * V_33 )
{
int V_35 = 0 ;
const struct V_80 * V_22 ;
for ( V_22 = V_33 ; ! F_38 ( V_22 ) ; V_22 ++ )
if ( F_35 ( V_22 ) ) {
V_35 ++ ;
if ( V_22 -> V_85 && V_22 -> V_85 ( V_22 ) )
break;
}
return V_35 ;
}
const struct V_80 * F_40 ( const struct V_80 * V_33 )
{
const struct V_80 * V_22 ;
for ( V_22 = V_33 ; ! F_38 ( V_22 ) ; V_22 ++ )
if ( F_35 ( V_22 ) )
...
{
int V_87 = V_54 ;
if ( V_24 [ V_87 ] && strstr ( V_24 [ V_87 ] , V_9 ) )
return 1 ;
return 0 ;
}
int F_42 ( const char * V_9 )
{
static int V_88 [] = { V_51 , V_56 , V_83 } ;
int V_15 ;
for ( V_15 = 0 ; V_88 [ V_15 ] != V_83 ; V_15 ++ ) {
int V_87 = V_88 [ V_15 ] ;
if ( V_24 [ V_87 ] && strstr ( V_24 [ V_87 ] , V_9 ) )
return 1 ;
}
...
{
const struct V_90 * V_91 = V_89 ? & V_89 -> V_33 : & V_34 ;
struct V_90 * V_22 ;
for( V_22 = V_91 -> V_92 ; V_22 != & V_34 ; V_22 = V_22 -> V_92 ) {
const struct V_30 * V_31 =
F_43 ( V_22 , struct V_30 , V_33 ) ;
if ( ( ( type == V_93 ) || ( V_31 -> type == type ) ) &&
( ( V_29 == NULL ) || ( strcmp ( V_31 -> V_29 , V_29 ) == 0 ) ) )
return V_31 ;
}
return NULL ;
}
bool F_44 ( int V_86 , int * V_94 , int * V_95 , int * V_96 )
{
int V_97 = 0 , V_98 = 0 , V_99 = 0 ;
bool V_100 ;
const char * V_3 , * V_101 ;
char * V_102 ;
V_3 = F_27 ( V_86 ) ;
V_100 = V_3 ;
if ( ! V_100 )
...
goto V_77;
V_101 ++ ;
V_97 = F_45 ( V_101 , & V_102 , 10 ) ;
if ( V_101 != V_102 && V_97 < 100 ) {
V_97 += 1900 ;
if ( V_97 < 1996 )
V_97 += 100 ;
}
if ( V_97 > 9999 )
V_97 = 0 ;
V_98 = F_45 ( V_3 , & V_102 , 10 ) ;
if ( V_3 == V_102 || * V_102 != '/' || ! V_98 || V_98 > 12 ) {
V_98 = 0 ;
goto V_77;
}
V_3 = V_102 + 1 ;
V_99 = F_45 ( V_3 , & V_102 , 10 ) ;
if ( V_3 == V_101 || V_3 == V_102 || * V_102 != '/' || V_99 > 31 )
V_99 = 0 ;
V_77:
if ( V_94 )
* V_94 = V_97 ;
...
bool F_49 ( enum V_103 V_87 , const char * V_9 )
{
const char * V_66 = F_27 ( V_87 ) ;
