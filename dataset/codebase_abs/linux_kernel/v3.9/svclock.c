...
if ( F_50 ( F_51 ( V_38 ) ) && ! V_85 ) {
V_86 = V_95 ;
goto V_90;
}
if ( V_85 && ! F_50 ( F_51 ( V_38 ) ) ) {
V_86 = V_95 ;
goto V_90;
}
if ( ! V_84 )
V_25 -> V_27 . V_47 &= ~ V_48 ;
error = F_52 ( V_23 -> V_61 , V_96 , & V_25 -> V_27 , NULL ) ;
V_25 -> V_27 . V_47 &= ~ V_48 ;
F_3 ( L_14 , error ) ;
switch ( error ) {
case 0 :
...
error = F_54 ( V_23 -> V_61 , & V_25 -> V_27 ) ;
if ( error == V_98 ) {
V_86 = F_46 ( V_38 , V_10 ) ;
goto V_90;
}
...
( long long ) V_25 -> V_27 . V_30 ) ;
V_102 -> V_68 = L_19 ;
V_102 -> V_6 = strlen ( V_102 -> V_68 ) ;
V_102 -> V_70 . V_6 = 0 ;
V_102 -> V_72 = V_25 -> V_27 . V_28 ;
...
V_10 -> V_91 = 1 ;
F_11 ( V_10 , V_18 ) ;
error = F_67 ( V_10 -> V_32 , V_119 ,
& V_120 ) ;
if ( error < 0 )
F_11 ( V_10 , 10 * V_118 ) ;
}
static void F_68 ( struct V_121 * V_122 , void * V_8 )
{
...
static void F_69 ( void * V_8 )
{
struct V_41 * V_42 = V_8 ;
F_15 ( V_42 -> V_59 ) ;
}
void
F_70 ( struct V_1 * V_2 , T_2 V_60 )
{
struct V_9 * V_10 ;
F_3 ( L_31 ,
