...
T_7 * V_29 = F_50 ( V_76 , V_49 ) ;
struct V_18 * V_79 ;
const struct V_48 * V_16 ;
struct V_74 * V_80 ;
int V_81 = 0 ;
F_21 ( V_29 ) ;
F_51 (sk2, node, &head->twchain) {
if ( V_79 -> V_67 != V_49 )
continue;
if ( F_46 ( F_48 ( V_79 , V_4 , V_68 ,
V_45 , V_35 , V_62 , V_36 ) ) ) {
V_80 = F_52 ( V_79 ) ;
if ( F_53 ( V_19 , V_79 , V_75 ) )
goto V_82;
else
goto V_83;
}
...
V_88 = & V_6 -> V_17 ;
V_29 = F_50 ( V_21 , V_19 -> V_67 ) ;
F_21 ( V_29 ) ;
F_57 ( V_19 , V_88 ) ;
if ( V_80 ) {
F_55 ( V_19 -> V_67 != V_80 -> V_89 ) ;
V_81 = F_58 ( V_80 ) ;
}
F_23 ( V_29 ) ;
F_61 ( F_19 ( V_19 ) , V_19 -> V_22 , 1 ) ;
