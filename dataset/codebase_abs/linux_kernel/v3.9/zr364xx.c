...
F_104 ( V_200 , & V_21 -> V_198 . V_74 ) ;
F_105 ( & V_21 -> V_198 , V_21 ) ;
if ( V_201 )
V_21 -> V_198 . V_201 = V_202 | V_203 ;
V_21 -> V_2 = V_2 ;
switch ( V_152 ) {
case 1 :
F_40 ( & V_2 -> V_11 , L_64 ) ;
...
V_187 = V_184 -> V_204 ;
F_15 ( L_68 , V_187 -> V_205 . V_206 ) ;
for ( V_79 = 0 ; V_79 < V_187 -> V_205 . V_206 ; ++ V_79 ) {
V_189 = & V_187 -> V_189 [ V_79 ] . V_205 ;
if ( ! V_21 -> V_166 && F_106 ( V_189 ) ) {
V_21 -> V_166 = V_189 -> V_207 ;
}
}
if ( ! V_21 -> V_166 ) {
V_50 = - V_12 ;
...
F_109 ( & V_21 -> V_75 ) ;
V_21 -> V_25 = V_135 ;
F_110 ( & V_21 -> V_55 , & V_208 ,
NULL , & V_21 -> V_75 ,
V_54 ,
V_141 ,
sizeof( struct V_28 ) , V_21 , & V_21 -> V_51 ) ;
V_50 = F_111 ( & V_21 -> V_198 , V_209 , - 1 ) ;
if ( V_50 ) {
F_3 ( & V_2 -> V_11 , L_70 ) ;
goto V_42;
}
...
static void F_113 ( struct V_183 * V_184 )
{
struct V_20 * V_21 = F_114 ( V_184 ) ;
F_53 ( & V_21 -> V_51 ) ;
F_108 ( V_184 , NULL ) ;
...
static int F_118 ( struct V_183 * V_184 , T_9 V_210 )
{
struct V_20 * V_21 = F_114 ( V_184 ) ;
V_21 -> V_211 = V_21 -> V_94 ;
if ( ! V_21 -> V_211 )
return 0 ;
F_74 ( V_21 ) ;
F_70 ( V_21 ) ;
