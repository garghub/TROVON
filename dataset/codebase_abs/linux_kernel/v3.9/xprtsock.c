...
V_8 -> V_19 [ V_32 ] ) ;
F_200 ( V_8 ) ;
args -> V_286 -> V_334 = V_8 ;
V_8 -> V_286 = args -> V_286 ;
V_333 = F_27 ( args -> V_286 , struct V_332 , V_336 ) ;
V_76 -> V_37 = V_333 -> V_337 ;
V_76 -> V_79 = V_333 -> V_338 ;
F_149 ( V_8 ) ;
if ( F_194 ( V_123 ) )
return V_8 ;
F_201 ( V_8 ) ;
...
static int F_209 ( const char * V_345 ,
...
if ( ! V_345 )
return - V_260 ;
V_83 = F_210 ( V_345 , 0 , & V_350 ) ;
if ( V_83 == - V_260 || V_350 < V_348 || V_350 > V_349 )
return - V_260 ;
* ( ( unsigned int * ) V_347 -> V_175 ) = V_350 ;
return 0 ;
}
static int F_211 ( const char * V_345 , const struct V_346 * V_347 )
{
return F_209 ( V_345 , V_347 ,
V_351 ,
V_352 ) ;
}
static int F_212 ( const char * V_345 ,
const struct V_346 * V_347 )
{
return F_209 ( V_345 , V_347 ,
V_353 ,
...
static int F_213 ( const char * V_345 ,
const struct V_346 * V_347 )
{
return F_209 ( V_345 , V_347 ,
V_353 ,
