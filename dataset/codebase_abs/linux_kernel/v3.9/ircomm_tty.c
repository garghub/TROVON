...
static int F_42 ( struct V_87 * V_12 , struct V_61 * V_62 )
{
struct V_3 * V_4 ;
unsigned int line = V_62 -> V_88 ;
V_4 = F_43 ( V_15 , line , NULL ) ;
if ( ! V_4 ) {
V_4 = F_44 ( sizeof( struct V_3 ) , V_89 ) ;
if ( V_4 == NULL ) {
F_8 ( L_14 , V_17 ) ;
return - V_14 ;
}
...
V_62 -> V_73 . V_102 = 0 ;
V_62 -> V_73 . V_103 = 0 ;
F_49 ( V_15 , ( V_104 * ) V_4 , line , NULL ) ;
}
V_62 -> V_105 = V_4 ;
return F_50 ( & V_4 -> V_2 , V_12 , V_62 ) ;
}
static int F_51 ( struct V_61 * V_62 , struct V_63 * V_64 )
{
...
static void F_56 ( struct V_61 * V_62 , struct V_63 * V_64 )
{
...
memcpy ( F_72 ( V_118 , V_128 ) , V_125 + V_127 , V_128 ) ;
V_76 -= V_128 ;
V_127 += V_128 ;
}
F_35 ( & V_4 -> V_101 , V_35 ) ;
...
static void F_74 ( struct V_61 * V_62 , int V_132 )
{
struct V_3 * V_4 = (struct V_3 * ) V_62 -> V_105 ;
...
if ( F_38 ( V_66 ) )
break;
if ( V_132 && F_78 ( V_135 , V_133 + V_132 ) )
break;
}
F_35 ( & V_4 -> V_101 , V_35 ) ;
V_66 -> V_84 = V_86 ;
...
static void F_81 ( struct V_61 * V_62 , char V_138 )
{
F_13 ( 0 , L_24 , V_17 ) ;
}
...
F_67 ( V_62 ) ;
F_101 ( & V_4 -> V_2 , V_118 -> V_145 , V_118 -> V_127 ) ;
F_102 ( & V_4 -> V_2 ) ;
return 0 ;
}
...
F_14 (skb != NULL, return -1;) ;
V_146 = V_118 -> V_145 [ 0 ] ;
F_103 ( V_4 , V_118 -> V_145 + 1 , F_75 ( V_118 -> V_127 - 1 , V_146 ) ,
& V_147 ) ;
return 0 ;
}
...
static void F_104 ( struct V_3 * V_4 , struct V_149 * V_150 )
{
struct V_61 * V_62 ;
char V_151 ;
F_105 ( V_150 , L_35 , V_152 [ V_4 -> V_84 ] ) ;
F_106 ( V_150 , L_36 ) ;
if ( V_4 -> V_58 & V_110 )
F_106 ( V_150 , L_37 ) ;
...
F_106 ( V_150 , L_40 ) ;
F_107 ( V_150 , '\n' ) ;
F_105 ( V_150 , L_41 , V_4 -> V_5 . V_153 ) ;
F_105 ( V_150 , L_42 ) ;
V_151 = ' ' ;
if ( V_4 -> V_5 . V_6 & V_7 ) {
F_105 ( V_150 , L_43 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_6 & V_8 ) {
F_105 ( V_150 , L_44 , V_151 ) ;
V_151 = '|' ;
}
F_107 ( V_150 , '\n' ) ;
F_106 ( V_150 , L_45 ) ;
...
F_105 ( V_150 , L_46 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_10 & V_112 ) {
F_105 ( V_150 , L_47 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_10 & V_11 ) {
F_105 ( V_150 , L_48 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_10 & V_113 ) {
F_105 ( V_150 , L_49 , V_151 ) ;
V_151 = '|' ;
}
F_107 ( V_150 , '\n' ) ;
F_106 ( V_150 , L_50 ) ;
...
F_106 ( V_150 , L_52 ) ;
F_105 ( V_150 , L_53 , V_4 -> V_5 . V_155 ) ;
F_106 ( V_150 , L_54 ) ;
V_151 = ' ' ;
if ( V_4 -> V_5 . V_156 & V_157 ) {
F_105 ( V_150 , L_55 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_158 ) {
F_105 ( V_150 , L_56 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_159 ) {
F_105 ( V_150 , L_57 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_160 ) {
F_105 ( V_150 , L_58 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_161 ) {
F_105 ( V_150 , L_59 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_162 ) {
F_105 ( V_150 , L_60 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_163 ) {
F_105 ( V_150 , L_61 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_5 . V_156 & V_164 ) {
F_105 ( V_150 , L_62 , V_151 ) ;
V_151 = '|' ;
}
F_107 ( V_150 , '\n' ) ;
F_106 ( V_150 , L_63 ) ;
V_151 = ' ' ;
if ( F_98 ( & V_4 -> V_2 ) ) {
F_105 ( V_150 , L_64 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_141 ) {
F_105 ( V_150 , L_65 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_165 ) {
F_105 ( V_150 , L_66 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_107 ) {
F_105 ( V_150 , L_67 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_166 ) {
F_105 ( V_150 , L_68 , V_151 ) ;
V_151 = '|' ;
}
if ( V_4 -> V_2 . V_35 & V_70 ) {
F_105 ( V_150 , L_69 , V_151 ) ;
V_151 = '|' ;
}
F_107 ( V_150 , '\n' ) ;
F_105 ( V_150 , L_70 , V_4 -> V_167 ? L_71 : L_72 ) ;
F_105 ( V_150 , L_73 , V_4 -> V_2 . V_76 ) ;
F_105 ( V_150 , L_74 , V_4 -> V_98 ) ;
F_105 ( V_150 , L_75 , V_4 -> V_96 ) ;
V_62 = F_62 ( & V_4 -> V_2 ) ;
if ( V_62 ) {
F_105 ( V_150 , L_76 ,
...
static int F_108 ( struct V_149 * V_150 , void * V_168 )
{
struct V_3 * V_4 ;
unsigned long V_35 ;
...
static int F_111 ( struct V_170 * V_170 , struct V_63 * V_63 )
{
return F_112 ( V_63 , F_108 , NULL ) ;
}
