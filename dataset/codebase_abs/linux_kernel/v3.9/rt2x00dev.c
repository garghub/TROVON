...
static inline int F_42 ( struct V_42 * V_43 )
{
struct V_1 * V_2 = V_43 -> V_48 -> V_2 ;
struct V_49 * V_50 = ( void * ) V_43 -> V_36 -> V_20 ;
struct V_51 * V_52 ;
int V_53 ;
if ( F_43 ( ! F_44 ( V_50 -> V_54 ) ) )
return 0 ;
V_53 = 0 ;
F_45 () ;
F_46 (bar_entry, &rt2x00dev->bar_list, list) {
if ( V_52 -> V_43 != V_43 )
continue;
F_47 ( & V_2 -> V_55 ) ;
V_53 = V_52 -> V_56 ;
...
{
struct V_1 * V_2 = V_43 -> V_48 -> V_2 ;
struct V_61 * V_62 = F_53 ( V_43 -> V_36 ) ;
struct V_63 * V_64 = F_54 ( V_43 -> V_36 ) ;
unsigned int V_65 , V_66 ;
T_2 V_67 , V_68 , V_69 ;
T_2 V_70 = V_64 -> V_11 ;
bool V_71 ;
F_55 ( V_43 ) ;
F_56 ( V_43 -> V_36 , V_2 -> V_7 -> V_72 ) ;
V_64 -> V_11 &= ~ V_73 ;
V_65 = F_57 ( V_43 -> V_36 ) ;
...
F_40 ( V_43 , V_108 ) ;
F_47 ( & V_43 -> V_48 -> V_109 ) ;
if ( ! F_64 ( V_43 -> V_48 ) )
F_65 ( V_43 -> V_48 ) ;
F_49 ( & V_43 -> V_48 -> V_109 ) ;
}
void F_66 ( struct V_42 * V_43 , T_1 V_9 )
{
struct V_59 V_60 ;
V_60 . V_11 = 0 ;
F_67 ( V_9 , & V_60 . V_11 ) ;
...
static T_2 * F_68 ( T_2 * V_20 , unsigned int V_110 , T_2 V_111 )
{
...
if ( F_43 ( ! F_72 ( V_124 -> V_54 ) ) )
return;
if ( V_123 -> V_125 < sizeof( * V_124 ) + V_126 )
return;
F_45 () ;
F_46 (entry, &rt2x00dev->bar_list, list) {
...
continue;
#undef F_73
if ( F_74 ( V_124 -> V_128 , V_43 -> V_129 ) )
continue;
if ( F_74 ( V_124 -> V_129 , V_43 -> V_128 ) )
continue;
F_47 ( & V_2 -> V_55 ) ;
V_43 -> V_56 = 1 ;
F_49 ( & V_2 -> V_55 ) ;
...
return;
V_2 -> V_141 = V_142 ;
V_134 = F_68 ( V_36 -> V_20 , V_36 -> V_110 - V_126 , V_143 ) ;
if ( ! V_134 )
return;
...
V_136 = F_77 ( V_133 , V_135 , V_2 -> V_140 ) ;
V_136 |= ( V_133 -> V_144 & 0x01 ) ;
if ( ! V_136 && ! F_3 ( V_34 , & V_2 -> V_11 ) )
F_78 ( V_2 -> V_145 , & V_2 -> V_119 ) ;
}
...
signal = F_80 ( V_123 -> V_151 , signal ) ;
V_147 = & V_2 -> V_155 [ V_2 -> V_156 ] ;
for ( V_66 = 0 ; V_66 < V_147 -> V_157 ; V_66 ++ ) {
V_149 = F_81 ( V_147 -> V_158 [ V_66 ] . V_159 ) ;
if ( ( ( type == V_160 ) &&
( V_149 -> V_161 == signal ) ) ||
( ( type == V_162 ) &&
( V_149 -> V_163 == signal ) ) ||
...
void F_83 ( struct V_42 * V_43 , T_5 V_167 )
{
struct V_1 * V_2 = V_43 -> V_48 -> V_2 ;
struct V_122 V_123 ;
struct V_35 * V_36 ;
...
goto V_170;
V_36 = F_84 ( V_43 , V_167 ) ;
if ( ! V_36 )
goto V_170;
F_55 ( V_43 ) ;
memset ( & V_123 , 0 , sizeof( V_123 ) ) ;
V_2 -> V_7 -> V_12 -> V_172 ( V_43 , & V_123 ) ;
if ( F_85 ( V_123 . V_125 == 0 ||
...
( V_123 . V_138 & V_177 ) )
F_58 ( V_43 -> V_36 , V_65 ) ;
F_88 ( V_43 -> V_36 , V_123 . V_125 ) ;
V_67 = F_79 ( V_2 , & V_123 ) ;
if ( V_123 . V_151 == V_165 ||
V_123 . V_151 == V_166 )
V_123 . V_11 |= V_178 ;
F_75 ( V_2 , V_43 -> V_36 , & V_123 ) ;
F_71 ( V_2 , V_43 -> V_36 , & V_123 ) ;
F_89 ( V_2 , V_43 -> V_36 , & V_123 ) ;
F_90 ( V_2 , & V_123 ) ;
F_60 ( V_2 , V_179 , V_43 -> V_36 ) ;
V_169 = F_91 ( V_43 -> V_36 ) ;
...
static void F_93 ( struct V_191 * V_43 ,
const int V_192 , const int V_193 ,
const int V_194 )
{
V_43 -> V_182 = V_192 <= 14 ? V_195 : V_196 ;
V_43 -> V_197 = F_94 ( V_192 ,
V_43 -> V_182 ) ;
V_43 -> V_159 = V_194 ;
V_43 -> V_198 = V_193 ;
V_43 -> V_199 = 0xff ;
}
static void F_95 ( struct V_200 * V_43 ,
...
V_209 += 8 ;
V_208 = F_97 ( V_206 -> V_213 , sizeof( * V_208 ) , V_214 ) ;
if ( ! V_208 )
return - V_215 ;
V_89 = F_97 ( V_209 , sizeof( * V_89 ) , V_214 ) ;
if ( ! V_89 )
goto V_216;
for ( V_66 = 0 ; V_66 < V_209 ; V_66 ++ )
F_95 ( & V_89 [ V_66 ] , V_66 , F_81 ( V_66 ) ) ;
...
F_100 ( V_2 -> V_29 ) ;
if ( F_43 ( V_2 -> V_29 -> V_221 -> V_155 [ V_195 ] ) ) {
F_98 ( V_2 -> V_29 -> V_221 -> V_155 [ V_195 ] -> V_208 ) ;
F_98 ( V_2 -> V_29 -> V_221 -> V_155 [ V_195 ] -> V_158 ) ;
V_2 -> V_29 -> V_221 -> V_155 [ V_195 ] = NULL ;
V_2 -> V_29 -> V_221 -> V_155 [ V_196 ] = NULL ;
}
F_98 ( V_2 -> V_206 . V_217 ) ;
}
...
V_2 -> V_29 -> V_72 =
F_102 (unsigned int, IEEE80211_TX_STATUS_HEADROOM,
...
V_251 -> V_256 = F_116 ( V_37 ) ;
#ifdef F_117
V_251 -> V_256 |= F_116 ( V_39 ) ;
#endif
...
( V_2 -> V_7 -> V_8 - 1 ) ;
V_2 -> V_29 -> V_221 -> V_273 = F_116 ( V_274 ) ;
...
int F_143 ( struct V_1 * V_2 , T_8 V_281 )
{
F_144 ( V_2 , L_8 ) ;
