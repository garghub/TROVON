...
V_341 -> V_87 = F_439 ( F_440 ( V_484 , V_1165 , V_1198 , V_490 ) ) ;
V_341 -> V_1207 = 0 ;
V_490 = F_208 ( V_484 ) ;
...
if ( V_1211 > V_579 )
V_1211 = V_579 ;
F_438 ( V_493 , V_798 , V_502 , V_1211 , V_1202 , V_1200 ) ;
V_1202 = V_1200 = 0 ;
...
V_490 = F_211 ( V_1212 ) ;
V_502 = V_4 -> V_304 -> V_507 ( V_4 -> V_508 , F_457 ( V_1212 ) ,
V_1212 -> V_1213 , V_490 ,
V_575 ) ;
...
static int F_458 ( struct V_308 * V_11 , int V_1217 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
...
F_460 ( V_1222 -> V_1225 , V_1226 , sizeof( V_1222 -> V_1225 ) ) ;
F_460 ( V_1222 -> V_1227 , V_1228 , sizeof( V_1222 -> V_1227 ) ) ;
snprintf ( V_1222 -> V_1229 , sizeof( V_1222 -> V_1229 ) , L_124 ,
V_1224 -> V_1230 , V_1224 -> V_1231 ) ;
if ( V_4 -> V_25 -> V_339 != V_343 )
F_460 ( V_1222 -> V_1232 , F_461 ( V_4 -> V_1233 ) ,
sizeof( V_1222 -> V_1232 ) ) ;
}
static int F_462 ( struct V_308 * V_11 , struct V_1234 * V_1152 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
struct V_38 * V_13 ;
V_13 = & V_4 -> V_39 ;
...
static int F_464 ( struct V_308 * V_11 , struct V_1234 * V_1152 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
struct V_38 * V_13 = & V_4 -> V_39 ;
...
static void F_467 ( struct V_308 * V_11 , T_3 V_1242 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
V_4 -> V_1241 = V_1242 ;
}
...
static void F_472 ( int V_1248 , T_5 * V_1249 )
{
switch ( V_1248 ) {
case V_1250 :
case V_1251 :
...
static int F_473 ( T_1 V_421 , int * V_1248 )
{
switch ( V_421 ) {
case V_1263 :
* V_1248 = V_1250 ;
...
static int F_474 ( int V_1248 , T_1 * V_421 )
{
switch ( V_1248 ) {
case V_1250 :
* V_421 = V_1263 ;
...
static int F_476 ( T_1 V_1275 , T_1 * V_928 )
{
T_1 V_403 = 0 ;
if ( V_1275 & V_1277 )
V_403 |= V_1276 ;
...
static int F_477 ( struct V_3 * V_4 , struct V_1291 * V_1292 )
{
T_1 V_421 ;
V_1292 -> V_35 = 0 ;
if ( ! F_474 ( V_1292 -> V_1248 , & V_421 ) )
return - V_21 ;
if ( V_4 -> V_25 -> V_927 [ V_421 - V_425 ] &
V_1293 )
V_1292 -> V_35 = V_1294 ;
else
V_1292 -> V_35 = F_475 ( V_4 -> V_25 -> V_928 [ V_421 -
V_425 ] ) ;
return 0 ;
}
...
V_1296 -> V_1300 . V_1301 . V_1302 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1303 ) >> V_1304 ;
V_1296 -> V_1300 . V_1301 . V_1305 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1298 ) >> V_1299 ;
V_1296 -> V_1306 . V_1301 . V_1302 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1303 ) >> V_1304 ;
V_1296 -> V_1306 . V_1301 . V_1305 = F_479 ( V_584 ) ;
...
V_1311 ;
V_1296 -> V_1300 . V_1314 . V_1315 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1306 . V_1314 . V_1315 = F_479 ( V_584 ) ;
break;
case V_1272 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1300 . V_1316 . V_1317 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1306 . V_1316 . V_1317 = F_479 ( V_584 ) ;
...
V_1326 ;
V_860 = F_473 ( V_421 , & V_1296 -> V_1248 ) ;
if ( V_860 < 0 ) {
...
static int F_483 ( struct V_308 * V_11 , struct V_1291 * V_1152 ,
T_3 * V_1331 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
int V_860 = 0 ;
...
static int F_484 ( struct V_3 * V_4 , struct V_1291 * V_1292 )
{
T_1 V_421 ;
T_1 V_928 = 0 ;
unsigned long V_87 ;
...
static void F_485 ( struct V_1295 * V_1296 ,
struct V_908 * V_341 ,
...
V_1341 = F_486 ( V_1296 -> V_1300 . V_1301 . V_1302 ) ;
V_1343 = F_486 ( V_1296 -> V_1306 . V_1301 . V_1302 ) ;
V_1342 = F_486 ( V_1296 -> V_1300 . V_1301 . V_1305 ) ;
V_1344 = F_486 ( V_1296 -> V_1306 . V_1301 . V_1305 ) ;
...
F_472 ( V_1296 -> V_1248 , & V_1249 ) ;
break;
case V_1257 :
case V_1260 :
V_1315 = F_486 ( V_1296 -> V_1300 . V_1314 . V_1315 ) ;
V_1345 = F_486 ( V_1296 -> V_1306 . V_1314 . V_1315 ) ;
V_341 -> V_403 [ 2 ] |= V_1315 ;
V_341 -> V_911 [ 2 ] |= V_1345 ;
F_472 ( V_1296 -> V_1248 , & V_1249 ) ;
break;
case V_1272 :
V_1315 = F_486 ( V_1296 -> V_1300 . V_1316 . V_1317 ) ;
V_1345 = F_486 ( V_1296 -> V_1306 . V_1316 . V_1317 ) ;
V_341 -> V_403 [ 2 ] |= V_1315 ;
V_341 -> V_911 [ 2 ] |= V_1345 ;
...
case V_1257 :
case V_1260 :
F_485 ( V_1296 , V_341 , V_1352 , V_421 ) ;
break;
case V_1251 :
case V_1253 :
case V_1255 :
...
static int F_488 ( struct V_3 * V_4 , T_3 V_1361 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
T_4 V_386 ;
...
static int F_489 ( struct V_308 * V_11 , struct V_1291 * V_1152 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
int V_860 = 0 ;
switch ( V_1152 -> V_1152 ) {
...
break;
case V_1364 :
V_860 = F_488 ( V_4 , V_1152 -> V_1323 . V_1324 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static void F_490 ( struct V_308 * V_11 , T_3 V_1365 , T_5 * V_35 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
int V_26 ;
if ( V_1365 != V_1366 )
...
static int F_491 ( struct V_308 * V_11 , int V_1365 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
if ( V_1365 != V_1366 )
return - V_21 ;
...
static int F_499 ( struct V_3 * V_4 , int V_1386 )
{
...
static int F_500 ( struct V_3 * V_4 , int V_29 , int V_1389 , int V_1390 )
{
if ( ( V_29 < V_1384 || V_29 > V_1385 ) ||
( V_1389 < 0 || V_1389 > 3 ) ||
( V_1390 < 0 || V_1390 > 0x1f ) )
return - V_21 ;
F_18 ( F_501 ( V_29 ) , ( V_1389 << V_1391 ) | V_1390 ) ;
return 0 ;
}
...
static int F_505 ( struct V_3 * V_4 , T_3 V_335 , char * V_1401 ,
int V_1402 )
{
int V_26 ;
...
static int F_507 ( struct V_3 * V_4 , T_3 V_1182 , T_3 V_1407 )
{
...
V_490 = V_10 ;
V_1182 += 3 ;
V_1409 = F_502 ( V_4 , V_1182 + 4 ) ;
V_10 = F_505 ( V_4 , V_1182 + 5 , V_1401 , 64 ) ;
if ( V_10 < 0 )
return V_10 ;
V_1410 = NULL ;
V_1411 = 0 ;
...
T_3 V_1407 ;
V_10 = F_502 ( V_4 , V_1422 ) ;
if ( V_10 != 0x90 )
return;
V_10 = F_504 ( V_4 , V_1422 + 1 ) ;
if ( V_10 < 0 )
return;
V_1422 = V_1182 + V_486 + 3 ;
V_1407 = V_1182 + V_486 + V_10 ;
V_486 += V_10 ;
V_10 = F_507 ( V_4 , V_1422 , V_1407 ) ;
if ( V_10 < 0 || V_10 == 1 )
return;
}
}
...
static int F_517 ( struct V_3 * V_4 , const char * V_1423 )
{
...
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
} else if ( F_517 ( V_4 , V_4 -> V_1224 . V_1419 ) ) {
...
static int F_526 ( struct V_276 * V_498 , int * V_1470 )
{
* V_1470 = 32 ;
...
V_1490 , V_1492 ) ;
V_10 = F_522 ( V_25 , V_1222 , V_1460 , V_1461 , V_30 ,
V_1464 ) ;
if ( V_10 )
break;
V_1460 = F_29 ( V_4 , V_30 ,
...
V_10 = F_531 ( V_4 , V_25 , V_1222 ) ;
if ( V_10 )
return V_10 ;
V_1472 = F_525 ( V_1222 , & V_1494 ) ;
V_1473 = F_526 ( V_1222 , & V_1495 ) ;
...
F_528 ( V_25 , V_1472 , V_1473 ) ;
F_530 ( V_25 , V_1472 , V_1473 ) ;
return 0 ;
V_1497:
F_523 ( L_179 , V_1495 ) ;
return - V_21 ;
...
static void F_537 ( struct V_3 * V_4 , T_5 * V_1510 )
{
struct V_1511 V_1512 [ V_1513 ] ;
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_1514 * V_1233 = V_4 -> V_1233 ;
int V_26 , V_1515 , V_10 ;
T_5 V_1516 ;
...
static int F_539 ( struct V_3 * V_4 , T_5 * V_1510 )
{
#ifdef F_540
...
if ( ! V_1522 )
return - V_8 ;
for ( V_26 = 0 ; V_26 < V_1521 -> V_1524 . V_1515 ; V_26 ++ ) {
V_1510 [ V_26 ] = V_1522 [ V_26 ] ;
V_4 -> V_29 [ V_26 ] . V_782 = V_1521 -> V_1524 . V_1525 [ V_26 ] ;
}
V_4 -> V_28 = V_1521 -> V_1524 . V_1515 ;
return 0 ;
#else
return - V_21 ;
#endif
...
V_1528 = 0 ;
V_10 = F_497 ( V_4 , V_25 , V_1510 [ V_1528 ] ,
F_544 ( V_30 ) ) ;
if ( V_10 )
return V_10 ;
V_1528 ++ ;
...
V_1526 = 0 ;
for ( V_26 = 0 ; V_26 < V_30 ; V_26 ++ )
V_1526 += V_25 -> V_809 [ V_26 ] ;
V_1527 = V_25 -> V_809 [ V_30 ] ;
...
V_1531 = F_548 ( V_4 -> V_1233 ) ;
V_1419 = F_541 ( V_1531 , L_142 , & V_1409 ) ;
if ( ! V_1419 ) {
F_10 ( V_11 , L_182 ,
V_1531 -> V_1533 ) ;
return - V_21 ;
...
if ( F_517 ( V_4 , V_4 -> V_1224 . V_1419 ) ) {
F_10 ( V_11 , L_184 ,
V_1531 -> V_1533 , V_4 -> V_1224 . V_1419 ) ;
return - V_21 ;
}
V_1532 = F_541 ( V_1531 , L_140 , & V_1409 ) ;
if ( ! V_1532 ) {
F_10 ( V_11 , L_185 ,
V_1531 -> V_1533 ) ;
return - V_21 ;
}
if ( V_1409 != V_11 -> V_1534 ) {
F_10 ( V_11 , L_186 ,
V_1531 -> V_1533 , V_1409 ) ;
}
memcpy ( V_11 -> V_1104 , V_1532 , V_11 -> V_1534 ) ;
if ( ! F_428 ( & V_11 -> V_1104 [ 0 ] ) ) {
F_10 ( V_11 , L_187 ,
V_1531 -> V_1533 ) ;
F_10 ( V_11 , L_188 , V_1531 -> V_1533 , V_11 -> V_1104 ) ;
return - V_21 ;
}
V_1412 = F_541 ( V_1531 , L_137 , & V_1409 ) ;
if ( V_1412 )
strcpy ( V_4 -> V_1224 . V_1412 , V_1412 ) ;
if ( F_549 ( V_1531 , L_189 , & V_1409 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
}
return 0 ;
...
union V_1548 * V_1463 , T_5 V_543 )
{
struct V_1520 * V_1541 ;
struct V_24 * V_498 ;
int V_26 ;
V_1541 = F_559 ( L_205 , V_1549 ,
NULL , 0 ) ;
if ( F_560 ( V_1541 ) )
return NULL ;
for ( V_26 = 0 ; F_561 ( V_1550 [ V_26 ] ) ; V_26 ++ ) {
...
T_14 V_1564 ;
void * V_860 ;
V_860 = F_580 ( V_11 , V_487 , & V_1564 , V_1563 ) ;
if ( V_860 )
* V_1562 = V_1564 ;
return V_860 ;
}
...
struct V_308 * V_11 ;
struct V_3 * V_4 ;
V_11 = F_593 ( sizeof( struct V_3 ) , V_1481 ) ;
if ( ! V_11 )
return NULL ;
F_594 ( V_11 , V_1570 ) ;
V_4 = F_399 ( V_11 ) ;
...
static int F_599 ( struct V_1514 * V_1233 ,
...
if ( ! ( F_601 ( V_1233 , 0 ) & V_1586 ) ||
! ( F_601 ( V_1233 , 2 ) & V_1586 ) ) {
...
V_1584 . V_1591 . V_1592 = F_605 ( V_1233 -> V_1593 ) ;
V_1584 . V_1591 . V_1593 = V_1233 -> V_1593 -> V_1594 ;
V_1584 . V_1591 . V_508 = F_606 ( V_1233 -> V_1590 ) ;
...
V_1602 ) ;
V_1585 = F_608 ( 44 ) ;
V_10 = F_609 ( V_1233 , V_1585 ) ;
if ( ! V_10 ) {
V_11 -> V_552 |= V_1603 ;
V_10 = F_610 ( V_1233 , V_1585 ) ;
if ( V_10 ) {
...
static void F_620 ( struct V_1514 * V_1233 )
{
...
static int F_623 ( struct V_1514 * V_1233 , T_15 V_1377 )
{
struct V_308 * V_11 = F_621 ( V_1233 ) ;
struct V_3 * V_4 = F_399 ( V_11 ) ;
unsigned long V_87 ;
...
static int F_626 ( struct V_1514 * V_1233 )
{
struct V_308 * V_11 = F_621 ( V_1233 ) ;
struct V_3 * V_4 = F_399 ( V_11 ) ;
unsigned long V_87 ;
...
F_598 ( V_11 ) ;
V_4 -> V_1502 = F_642 ( & V_1521 -> V_1613 [ 1 ] , 0 ,
...
if ( V_4 -> V_1502 ) {
F_645 ( & V_1521 -> V_1613 [ 1 ] , V_4 -> V_1502 ,
F_643 ( & V_1521 -> V_1613 [ 1 ] ) ) ;
V_4 -> V_1502 = NULL ;
}
V_1604:
...
{
struct V_308 * V_11 = F_647 ( & V_1521 -> V_11 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_399 ( V_11 ) ;
F_622 ( V_11 ) ;
if ( V_4 -> V_1614 ) {
