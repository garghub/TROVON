...
static int F_68 ( struct V_41 * V_42 , struct V_163 * V_164 , void * V_154 )
{
...
static int F_70 ( struct V_41 * V_42 , struct V_163 * V_164 , void * V_154 )
{
struct V_1 * V_1 = F_69 ( V_42 -> V_196 ) ;
struct V_100 V_101 ;
struct V_2 * V_15 ;
...
V_1 = F_69 ( V_42 -> V_196 ) ;
V_164 = F_91 ( V_42 ) ;
if ( V_42 -> V_93 < F_92 ( 0 ) || V_42 -> V_93 < V_164 -> F_72 ||
V_164 -> F_72 < F_93 ( sizeof( * V_236 ) ) )
return;
V_42 = F_94 ( V_42 , V_145 ) ;
if ( V_42 == NULL )
return;
V_164 = F_91 ( V_42 ) ;
V_236 = (struct V_235 * ) F_95 ( V_164 ) ;
V_15 = F_6 ( V_1 , V_236 -> V_244 ) ;
F_87 ( V_236 , V_15 ) ;
V_182 = F_64 ( V_42 ) . V_182 ;
F_64 ( V_42 ) . V_182 = 0 ;
F_64 ( V_42 ) . V_245 = 0 ;
F_96 ( V_1 -> V_10 . V_246 , V_42 , V_182 , V_247 ) ;
}
...
V_196 = F_98 ( V_1 , V_251 , & V_101 ) ;
if ( V_196 == NULL )
return - V_108 ;
V_1 -> V_10 . V_246 = V_196 ;
return 0 ;
}
static void F_99 ( struct V_1 * V_1 )
{
F_100 ( V_1 -> V_10 . V_246 ) ;
V_1 -> V_10 . V_246 = NULL ;
}
static void F_101 ( struct V_26 * V_27 , int V_252 )
{
if ( F_102 ( V_27 , V_252 ) )
F_10 ( F_26 ( V_27 ) ) ;
F_13 ( F_26 ( V_27 ) ) ;
...
{
struct V_133 * V_134 = (struct V_133 * ) V_256 ;
...
static int F_107 ( struct V_253 * V_254 , unsigned long V_255 , void * V_256 )
{
struct V_26 * V_27 = V_256 ;
struct V_43 * V_44 ;
struct V_1 * V_1 = F_26 ( V_27 ) ;
if ( V_255 == V_261 ) {
F_101 ( V_27 , 2 ) ;
...
V_264 = F_112 ( T_6 , V_264 , V_265 ) ;
V_1 -> V_10 . V_11 = F_54 ( V_264 , V_145 ) ;
...
void T_8 F_124 ( void )
{
F_125 ( V_271 , V_210 , F_70 , NULL , NULL ) ;
F_125 ( V_271 , V_232 , F_68 , NULL , NULL ) ;
F_125 ( V_271 , V_272 , NULL , F_71 , NULL ) ;
F_126 ( & V_273 ) ;
F_127 ( & V_274 ) ;
F_128 ( & V_275 ) ;
F_129 () ;
