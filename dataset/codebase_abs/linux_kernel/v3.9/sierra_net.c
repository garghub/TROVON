...
{
struct V_1 * V_5 =
F_31 ( V_76 , struct V_1 , F_30 ) ;
struct V_2 * V_3 = V_5 -> V_2 ;
int V_53 ;
int V_77 ;
T_1 * V_19 ;
T_1 V_45 ;
if ( F_32 ( V_78 , & V_5 -> V_79 ) ) {
F_33 ( V_78 , & V_5 -> V_79 ) ;
V_19 = F_34 ( V_80 , V_81 ) ;
if ( ! V_19 )
return;
V_45 = V_5 -> V_45 ;
V_53 = F_35 ( V_3 -> V_47 , F_36 ( V_3 -> V_47 , 0 ) ,
V_82 ,
V_83 | V_43 | V_44 ,
0 , V_45 , V_19 , V_80 ,
V_84 ) ;
...
static void F_42 ( struct V_2 * V_3 , struct V_91 * V_91 )
{
struct V_92 * V_93 ;
F_20 ( & V_3 -> V_47 -> V_3 , L_3 , V_48 ) ;
...
static void F_43 ( struct V_100 * V_10 ,
struct V_101 * V_102 )
{
F_44 ( V_10 , V_102 ) ;
F_45 ( V_102 -> V_103 , V_104 , sizeof( V_102 -> V_103 ) ) ;
F_45 ( V_102 -> V_105 , V_106 , sizeof( V_102 -> V_105 ) ) ;
}
static T_2 F_46 ( struct V_100 * V_10 )
{
struct V_2 * V_3 = F_47 ( V_10 ) ;
return F_1 ( V_3 ) -> V_68 && F_48 ( V_10 ) ;
}
static int F_49 ( struct V_100 * V_10 , int V_107 )
{
if ( V_107 > V_108 )
return - V_34 ;
...
static int F_54 ( struct V_2 * V_3 , struct V_114 * V_115 )
{
T_1 V_116 ;
T_1 V_117 ;
T_3 V_118 = 0 ;
...
V_40 = F_56 ( V_3 , V_115 ) ;
if ( V_40 < 0 ) {
F_55 ( & V_3 -> V_47 -> V_3 , L_34 ,
V_40 ) ;
return - V_46 ;
}
V_5 = F_34 ( sizeof *V_5 , V_81 ) ;
if ( ! V_5 )
return - V_130 ;
V_5 -> V_2 = V_3 ;
V_5 -> V_45 = V_116 ;
V_3 -> V_10 -> V_131 = & V_132 ;
V_3 -> V_10 -> V_133 [ V_134 - 2 ] = F_57 ( & V_135 ) ;
...
V_3 -> V_138 = F_58 ( V_142 , 4096 , V_139 ) ;
V_3 -> V_10 -> V_143 += V_32 ;
...
static struct V_6 * F_63 ( struct V_2 * V_3 ,
struct V_6 * V_7 , int V_53 )
{
struct V_6 * V_151 ;
V_151 = F_64 ( V_7 , V_152 ) ;
F_65 ( V_7 , V_53 ) ;
if ( V_151 ) {
F_66 ( V_151 , V_53 ) ;
} else {
...
static int F_68 ( struct V_2 * V_3 , struct V_6 * V_7 )
{
int V_77 ;
struct V_21 V_22 ;
struct V_6 * V_151 ;
...
return 1 ;
V_151 = F_63 ( V_3 , V_7 , V_22 . V_27 . V_17 ) ;
if ( V_151 )
F_70 ( V_3 , V_151 ) ;
}
return 0 ;
