...
if ( V_38 -> V_39 != F_23 () )
return - V_28 ;
V_2 -> V_13 . V_39 = V_38 -> V_39 ;
F_24 ( V_2 -> V_13 . V_40 , V_41 ) ;
for ( V_30 = 0 ; V_30 < sizeof( V_38 -> V_40 ) * 8 ; V_30 ++ ) {
if ( F_25 ( V_30 , ( void * ) V_38 -> V_40 ) ) {
if ( V_30 >= V_41 )
return - V_15 ;
F_26 ( V_30 , V_2 -> V_13 . V_40 ) ;
}
}
return F_27 ( V_2 ) ;
}
int F_28 ( struct V_1 * V_2 , struct V_42 * V_43 )
{
return - V_28 ;
}
int F_29 ( struct V_1 * V_2 , struct V_42 * V_43 )
{
return - V_28 ;
}
