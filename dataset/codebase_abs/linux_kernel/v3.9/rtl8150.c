...
{
T_1 * V_1 = F_22 ( V_30 ) ;
F_81 ( V_135 -> V_136 , V_137 , sizeof( V_135 -> V_136 ) ) ;
F_81 ( V_135 -> V_138 , V_139 , sizeof( V_135 -> V_138 ) ) ;
F_82 ( V_1 -> V_5 , V_135 -> V_140 , sizeof( V_135 -> V_140 ) ) ;
}
static int F_83 ( struct V_45 * V_30 , struct V_141 * V_142 )
{
T_1 * V_1 = F_22 ( V_30 ) ;
short V_143 , V_144 ;
V_142 -> V_145 = ( V_146 |
...
static int F_85 ( struct V_45 * V_30 , struct V_175 * V_176 , int V_177 )
{
T_1 * V_1 = F_22 ( V_30 ) ;
...
{
struct V_185 * V_5 = F_88 ( V_109 ) ;
T_1 * V_1 ;
struct V_45 * V_30 ;
V_30 = F_89 ( sizeof( T_1 ) ) ;
if ( ! V_30 )
return - V_130 ;
V_1 = F_22 ( V_30 ) ;
V_1 -> V_131 = F_90 ( V_132 , V_57 ) ;
if ( ! V_1 -> V_131 ) {
F_91 ( V_30 ) ;
return - V_130 ;
}
F_92 ( & V_1 -> V_83 , F_62 , ( unsigned long ) V_1 ) ;
F_93 ( & V_1 -> V_80 ) ;
V_1 -> V_5 = V_5 ;
V_1 -> V_30 = V_30 ;
V_30 -> V_186 = & V_187 ;
...
static void F_99 ( struct V_108 * V_109 )
{
T_1 * V_1 = F_54 ( V_109 ) ;
F_95 ( V_109 , NULL ) ;
if ( V_1 ) {
