...
{
struct V_40 * V_41 = F_41 ( NULL , NULL ) ;
struct V_67 * V_68 ;
int V_42 = - 1 , V_61 ;
unsigned long V_87 ;
...
V_42 = F_46 ( V_41 ) ;
if ( V_42 < 0 ) {
printf ( L_52 , strerror ( V_93 ) ) ;
goto V_89;
}
V_42 = F_47 ( V_41 , V_94 , false ) ;
if ( V_42 < 0 ) {
printf ( L_53 , strerror ( V_93 ) ) ;
goto V_89;
}
F_48 ( V_41 ) ;
if ( V_88 )
F_49 ( V_41 ) ;
V_21 -> V_28 = V_41 -> V_47 -> V_95 [ 0 ] == - 1 || V_41 -> V_47 -> V_96 > 1 ;
V_97:
V_87 = V_21 -> V_20 ;
for ( V_61 = 0 ; V_61 < V_41 -> V_98 ; V_61 ++ ) {
union V_31 * V_32 ;
...
static T_1 F_58 ( struct V_21 * V_21 , T_2 * V_8 )
{
T_1 V_11 = F_57 ( V_8 ) ;
struct V_107 * V_108 ;
for ( V_108 = F_59 ( & V_21 -> V_43 . V_47 ) ; V_108 ; V_108 = F_60 ( V_108 ) ) {
struct V_16 * V_16 = F_61 ( V_108 , struct V_16 , V_107 ) ;
struct V_15 * V_17 = V_16 -> V_19 ;
const char * V_109 ;
double V_110 ;
if ( V_17 == NULL )
continue;
V_110 = ( double ) V_17 -> V_20 / V_21 -> V_20 * 100.0 ;
V_109 = V_14 ;
if ( V_110 > 50.0 )
V_109 = V_12 ;
else if ( V_110 > 25.0 )
...
V_109 = V_13 ;
V_11 += F_5 ( V_8 , V_109 , L_62 , V_16 -> V_112 ) ;
V_11 += fprintf ( V_8 , L_63 , V_16 -> V_29 , V_17 -> V_20 ) ;
V_11 += F_5 ( V_8 , V_109 , L_64 , V_110 ) ;
V_11 += fprintf ( V_8 , L_65 , V_17 -> V_82 ) ;
}
return V_11 ;
}
static int F_62 ( const struct V_113 * V_114 , const char * V_115 ,
int T_9 V_26 )
{
struct V_21 * V_21 = V_114 -> V_116 ;
V_21 -> V_22 = atof ( V_115 ) ;
return 0 ;
}
int F_63 ( int V_85 , const char * * V_86 , const char * T_10 V_26 )
{
const char * const V_117 [] = {
L_66 ,
L_67 ,
NULL
} ;
...
const struct V_113 V_125 [] = {
F_65 ( 'p' , L_39 , & V_21 . V_45 . V_46 . V_29 , L_39 ,
L_68 ) ,
F_65 ( 0 , L_69 , & V_21 . V_45 . V_46 . V_71 , L_69 ,
L_70 ) ,
F_66 ( 0 , L_71 , & V_21 . V_45 . V_46 . V_126 ,
L_72 ) ,
F_65 ( 0 , L_73 , & V_21 . V_45 . V_46 . V_127 , L_73 ,
L_74 ) ,
F_66 ( 0 , L_75 , & V_21 . V_45 . V_128 ,
L_76 ) ,
F_67 ( 0 , L_77 , & V_21 . V_45 . V_124 ,
L_78 ) ,
F_65 ( 0 , L_79 , & V_21 . V_45 . V_46 . V_129 , L_80 ,
L_81 ) ,
F_68 ( 0 , L_82 , & V_21 , L_83 ,
L_84 ,
F_62 ) ,
F_66 ( 0 , L_46 , & V_21 . V_90 , L_85 ) ,
F_69 ()
} ;
int V_42 ;
char V_59 [ V_130 ] ;
V_85 = F_70 ( V_85 , V_86 , V_125 , V_117 , 0 ) ;
V_42 = F_71 ( & V_21 . V_45 . V_46 ) ;
if ( V_42 ) {
F_72 ( & V_21 . V_45 . V_46 , V_42 , V_59 , sizeof( V_59 ) ) ;
printf ( L_86 , V_59 ) ;
return V_42 ;
}
V_42 = F_73 ( & V_21 . V_45 . V_46 ) ;
if ( V_42 ) {
F_72 ( & V_21 . V_45 . V_46 , V_42 , V_59 , sizeof( V_59 ) ) ;
printf ( L_86 , V_59 ) ;
return V_42 ;
}
if ( ! V_85 && F_74 ( & V_21 . V_45 . V_46 ) )
V_21 . V_45 . V_46 . V_126 = true ;
