...
static T_1
F_13 ( struct V_1 * V_2 , const char * V_14 , T_2 V_21 )
{
struct V_11 V_22 ;
unsigned short V_16 ;
...
return - V_5 ;
V_22 . V_20 = F_14 ( V_24 + 1 , NULL , 10 ) ;
V_23 [ V_24 - V_23 ] = '\0' ;
F_2 ( L_9 , V_6 , V_22 . V_20 ) ;
for ( V_16 = 5 ; ( ( V_24 = strrchr ( V_23 , '/' ) ) ) && ( V_24 - V_23 > 0 ) && ( F_15 ( V_16 ) ) ; V_16 -- ) {
V_22 . V_19 [ V_16 ] = F_14 ( V_24 + 1 , NULL , 10 ) ;
V_23 [ V_24 - V_23 ] = '\0' ;
F_2 ( L_10 , V_6 , V_16 , V_22 . V_19 [ V_16 ] ) ;
}
V_22 . V_19 [ V_16 ] = F_14 ( V_23 , NULL , 10 ) ;
F_2 ( L_10 , V_6 , V_16 , V_22 . V_19 [ V_16 ] ) ;
...
F_20 ( V_26 ) ;
F_21 ( & V_2 -> V_17 ) ;
F_16 (KERN_INFO PDCS_PREFIX L_14 ,
entry->name, buf) ;
return V_21 ;
}
static T_1
F_22 ( struct V_1 * V_2 , char * V_14 )
{
char * V_15 = V_14 ;
struct V_3 * V_4 ;
short V_16 ;
...
static T_1
F_23 ( struct V_1 * V_2 , const char * V_14 , T_2 V_21 )
{
unsigned int V_30 [ 6 ] ;
unsigned short V_16 ;
char V_23 [ V_21 + 1 ] , * V_24 ;
...
if ( F_24 ( ! isdigit ( * V_23 ) ) )
return - V_5 ;
V_30 [ 0 ] = F_14 ( V_23 , NULL , 10 ) ;
F_2 ( L_17 , V_6 , V_30 [ 0 ] ) ;
V_24 = V_23 ;
for ( V_16 = 1 ; ( ( V_24 = strchr ( V_24 , '.' ) ) ) && ( F_15 ( V_16 < 6 ) ) ; V_16 ++ ) {
if ( F_24 ( ! isdigit ( * ( ++ V_24 ) ) ) )
return - V_5 ;
V_30 [ V_16 ] = F_14 ( V_24 , NULL , 10 ) ;
...
F_5 ( V_2 ) ;
F_21 ( & V_2 -> V_17 ) ;
F_16 (KERN_INFO PDCS_PREFIX L_19 ,
entry->name, buf) ;
return V_21 ;
}
static T_1
F_25 ( struct V_31 * V_29 , struct V_32 * V_33 , char * V_14 )
{
...
static T_1
F_28 ( struct V_31 * V_29 , struct V_32 * V_33 ,
...
{
return F_31 ( V_29 , V_33 , V_14 , V_46 ) ;
}
static T_1 F_33 ( struct V_31 * V_29 ,
struct V_40 * V_33 , char * V_14 )
{
return F_31 ( V_29 , V_33 , V_14 , V_47 ) ;
}
...
static T_1 F_35 ( struct V_31 * V_29 ,
struct V_40 * V_33 , char * V_14 )
{
char * V_15 = V_14 ;
if ( ! V_14 )
...
static T_1 F_41 ( struct V_31 * V_29 ,
...
F_5 ( V_43 ) ;
F_21 ( & V_43 -> V_17 ) ;
F_16 (KERN_INFO PDCS_PREFIX L_31 ,
...
const char * V_14 , T_2 V_21 )
{
return F_41 ( V_29 , V_33 , V_14 , V_21 , V_46 ) ;
}
static T_1 F_44 ( struct V_31 * V_29 ,
struct V_40 * V_33 ,
const char * V_14 , T_2 V_21 )
{
return F_41 ( V_29 , V_33 , V_14 , V_21 , V_47 ) ;
}
...
static T_1 F_46 ( struct V_31 * V_29 ,
struct V_40 * V_33 ,
const char * V_14 , T_2 V_21 )
{
unsigned long V_54 ;
...
if ( V_41 < 96 )
return - V_18 ;
F_16 (KERN_INFO PDCS_PREFIX L_36 , PDCS_VERSION) ;
...
error = F_56 ( V_72 , & V_76 ) ;
V_65 = F_57 ( L_38 , NULL , V_72 ) ;
if ( ! V_65 ) {
V_68 = - V_74 ;
goto V_77;
}
...
F_52 ( V_72 ) ;
V_75:
F_16 (KERN_INFO PDCS_PREFIX L_39 ) ;
return V_68 ;
}
static void T_6
F_59 ( void )
