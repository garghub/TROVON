...
snprintf ( V_18 -> V_50 , 8 , L_20 , V_16 ) ;
V_18 -> V_23 = V_16 ;
V_18 -> V_5 = V_5 ;
V_18 -> V_52 = F_53 ( V_74 ,
V_18 -> V_50 ) ;
F_22 ( V_5 -> V_24 , L_21 , V_18 -> V_52 ,
V_18 -> V_50 ) ;
...
F_22 ( V_5 -> V_24 , L_23 , V_16 ) ;
V_77 = F_62 ( & V_5 -> V_3 ) ;
if ( V_77 ) {
F_20 ( V_5 -> V_24 , L_24 , V_77 ) ;
goto V_109;
}
for ( V_68 = 0 ; V_68 < F_63 ( V_110 ) ; V_68 ++ ) {
struct V_111 * V_20 = & V_110 [ V_68 ] ;
V_77 = F_64 ( & V_5 -> V_3 , L_25 ,
