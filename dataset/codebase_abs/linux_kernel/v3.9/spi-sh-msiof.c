...
F_64 ( & V_2 -> V_17 ) ;
V_2 -> V_65 = F_65 ( & V_63 -> V_64 , NULL ) ;
if ( F_66 ( V_2 -> V_65 ) ) {
F_52 ( & V_63 -> V_64 , L_9 ) ;
V_73 = F_67 ( V_2 -> V_65 ) ;
goto V_108;
}
V_101 = F_68 ( V_63 , V_109 , 0 ) ;
V_103 = F_69 ( V_63 , 0 ) ;
if ( ! V_101 || V_103 < 0 ) {
F_52 ( & V_63 -> V_64 , L_10 ) ;
V_73 = - V_110 ;
...
V_2 -> V_6 = F_70 ( V_101 -> V_112 , F_71 ( V_101 ) ) ;
if ( ! V_2 -> V_6 ) {
F_52 ( & V_63 -> V_64 , L_11 ) ;
V_73 = - V_107 ;
goto V_111;
}
V_73 = F_72 ( V_103 , F_9 , 0 ,
F_73 ( & V_63 -> V_64 ) , V_2 ) ;
if ( V_73 ) {
F_52 ( & V_63 -> V_64 , L_12 ) ;
goto V_113;
...
V_58 -> V_114 = V_66 | V_67 | V_60 ;
V_58 -> V_114 |= V_69 | V_68 ;
V_58 -> V_62 = 0 ;
V_58 -> V_115 = V_63 -> V_116 ;
V_58 -> V_98 = V_2 -> V_90 -> V_98 ;
V_58 -> V_117 = V_118 ;
V_58 -> V_119 = V_120 ;
V_2 -> V_121 . V_58 = V_58 ;
V_2 -> V_121 . V_122 = F_39 ;
V_2 -> V_121 . V_123 = F_37 ;
V_2 -> V_121 . V_124 = F_54 ;
V_2 -> V_121 . V_125 [ V_126 ] = F_56 ;
V_2 -> V_121 . V_125 [ V_127 ] = F_56 ;
V_2 -> V_121 . V_125 [ V_128 ] = F_56 ;
V_2 -> V_121 . V_125 [ V_129 ] = F_56 ;
V_73 = F_75 ( & V_2 -> V_121 ) ;
if ( V_73 == 0 )
return 0 ;
F_76 ( & V_63 -> V_64 ) ;
...
static int F_80 ( struct V_99 * V_63 )
{
struct V_1 * V_2 = F_81 ( V_63 ) ;
int V_73 ;
V_73 = F_82 ( & V_2 -> V_121 ) ;
if ( ! V_73 ) {
F_76 ( & V_63 -> V_64 ) ;
F_83 ( F_69 ( V_63 , 0 ) , V_2 ) ;
F_77 ( V_2 -> V_6 ) ;
F_78 ( V_2 -> V_65 ) ;
F_79 ( V_2 -> V_121 . V_58 ) ;
}
...
static int F_84 ( struct V_89 * V_64 )
{
return 0 ;
}
