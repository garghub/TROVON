...
static void F_48 ( struct V_31 * V_32 , T_3 V_80 )
{
struct V_81 * V_81 = F_49 ( V_32 -> V_82 ) ;
const struct V_13 * V_14 = ( const struct V_13 * ) V_32 -> V_33 ;
struct V_40 * V_41 = (struct V_40 * ) ( V_32 -> V_33 + ( V_14 -> V_18 << 2 ) ) ;
struct V_34 * V_35 ;
switch ( F_50 ( V_32 ) -> type ) {
case V_83 :
if ( F_50 ( V_32 ) -> V_84 != V_85 )
return;
case V_86 :
break;
default:
...
V_35 = F_51 ( V_81 , V_32 -> V_87 , ( const V_88 * ) & V_14 -> V_15 ,
V_41 -> V_61 , V_53 , V_89 ) ;
if ( ! V_35 )
return;
if ( F_50 ( V_32 ) -> type == V_83 ) {
F_52 ( & V_90 ) ;
F_53 ( V_81 ) ;
F_54 ( V_32 , V_81 , V_80 , 0 , 0 , V_53 , 0 ) ;
} else
F_55 ( V_32 , V_81 , 0 , 0 , V_53 , 0 ) ;
F_56 ( V_35 ) ;
}
...
if ( V_35 -> V_94 )
goto error;
V_38 = F_58 ( sizeof( * V_38 ) , V_95 ) ;
if ( ! V_38 )
return - V_50 ;
V_2 = F_59 ( V_35 -> V_93 -> V_96 , 0 , 0 ) ;
if ( F_60 ( V_2 ) )
goto error;
V_38 -> V_2 = V_2 ;
if ( F_61 ( V_2 , V_35 -> V_93 -> V_97 ,
( V_35 -> V_93 -> V_98 + 7 ) / 8 ) )
goto error;
V_92 = F_62 ( V_35 -> V_93 -> V_96 , 0 ) ;
F_63 ( ! V_92 ) ;
...
{
if ( F_68 ( & V_106 , V_89 ) < 0 ) {
F_64 ( L_2 , V_102 ) ;
return - V_107 ;
}
if ( F_69 ( & V_108 , V_53 ) < 0 ) {
F_64 ( L_3 , V_102 ) ;
F_70 ( & V_106 , V_89 ) ;
return - V_107 ;
}
...
{
if ( F_72 ( & V_108 , V_53 ) < 0 )
F_64 ( L_4 , V_102 ) ;
if ( F_70 ( & V_106 , V_89 ) < 0 )
F_64 ( L_5 , V_102 ) ;
}
