...
V_1 -> V_174 = V_174 ;
V_1 -> V_73 . V_195 . V_174 = & V_174 -> V_174 ;
return 0 ;
}
...
{
struct V_1 * V_1 = F_118 ( V_192 ) ;
V_174 -> V_196 ( & V_1 -> V_73 ) ;
V_1 -> V_73 . V_195 . V_174 = NULL ;
F_116 ( V_1 ) ;
V_1 -> V_174 = NULL ;
return 0 ;
}
static int F_120 ( struct V_191 * V_197 , int V_198 )
{
return 0 ;
}
static int T_7 F_121 ( struct V_199 * V_200 )
{
struct V_1 * V_1 = F_122 ( & V_200 -> V_195 ) ;
F_123 ( & V_1 -> V_73 ) ;
F_124 ( V_1 -> V_4 ) ;
F_125 ( F_126 ( V_200 , 0 ) , V_1 ) ;
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_101 ) ;
F_43 ( V_1 ) ;
return 0 ;
}
static int T_8 F_127 ( struct V_199 * V_200 )
{
...
int V_80 = 0 ;
int V_59 ;
V_202 = F_128 ( V_200 , V_205 , 0 ) ;
if ( ! V_202 ) {
V_80 = - V_206 ;
F_12 ( L_31 ) ;
goto V_207;
}
V_203 = F_128 ( V_200 , V_208 , 0 ) ;
if ( ! V_203 ) {
V_80 = - V_206 ;
F_129 ( & V_200 -> V_195 ,
L_32 ) ;
...
V_4 = F_130 ( V_202 -> V_209 , F_131 ( V_202 ) ) ;
if ( V_4 == NULL ) {
V_80 = - V_210 ;
F_12 ( L_34 ) ;
goto V_207;
...
F_132 ( & V_1 -> V_49 ) ;
F_133 ( & V_200 -> V_195 , V_1 ) ;
V_1 -> V_73 . V_211 = & V_212 ;
F_134 ( & V_1 -> V_73 . V_195 ) ;
F_135 ( & V_1 -> V_73 . V_195 , L_37 ) ;
V_1 -> V_73 . V_213 = V_144 ;
V_1 -> V_73 . V_195 . V_214 = & V_200 -> V_195 ;
V_1 -> V_73 . V_195 . V_215 = V_200 -> V_195 . V_215 ;
V_1 -> V_73 . V_195 . V_216 = V_200 -> V_195 . V_216 ;
V_1 -> V_73 . V_217 = V_218 ;
V_1 -> V_4 = V_4 ;
V_80 = F_136 ( V_203 -> V_209 , F_110 , V_219 ,
V_218 , V_1 ) ;
if ( V_80 < 0 ) {
F_12 ( L_38 , V_80 ) ;
goto V_207;
}
V_80 = F_136 ( V_204 -> V_209 , F_110 ,
V_219 , V_218 , V_1 ) ;
if ( V_80 < 0 ) {
F_12 ( L_39 , V_80 ) ;
goto V_207;
...
if ( V_59 != 0 ) {
F_41 ( & V_1 -> V_6 [ V_59 ] -> V_6 . V_220 ) ;
F_56 ( & V_1 -> V_6 [ V_59 ] -> V_6 . V_220 ,
& V_1 -> V_73 . V_220 ) ;
}
V_6 -> V_1 = V_1 ;
F_41 ( & V_6 -> V_47 ) ;
V_6 -> V_6 . V_217 = V_221 [ V_59 ] ;
V_6 -> V_6 . V_211 = & V_222 ;
V_6 -> V_6 . V_21 = V_223 ;
}
V_1 -> V_6 [ 0 ] -> V_6 . V_21 = V_224 ;
V_1 -> V_6 [ 0 ] -> V_9 = 0 ;
V_1 -> V_73 . V_102 = & V_1 -> V_6 [ 0 ] -> V_6 ;
F_41 ( & V_1 -> V_73 . V_102 -> V_220 ) ;
V_1 -> V_101 = F_39 ( & V_1 -> V_6 [ 0 ] -> V_6 ,
V_103 ) ;
if ( V_1 -> V_101 == NULL )
goto V_225;
F_116 ( V_1 ) ;
V_80 = F_137 ( & V_200 -> V_195 , & V_1 -> V_73 ) ;
if ( V_80 )
goto V_226;
V_80 = F_138 ( & V_1 -> V_73 . V_195 ) ;
if ( V_80 ) {
F_12 ( L_40 , V_80 ) ;
goto V_227;
}
F_139 ( & V_200 -> V_195 , L_41 , V_228 ) ;
return 0 ;
V_227:
F_123 ( & V_1 -> V_73 ) ;
V_226:
