...
static T_5 F_96 ( struct V_158 * V_159 , const struct V_93 * V_140 ,
...
V_171 . V_169 = F_100 ( V_172 ) ;
V_171 . V_170 = F_100 ( F_101 ( V_20 ) ) ;
V_167 = F_102 ( struct V_173 , V_169 ) ;
V_88 = F_72 ( int , V_20 -> V_88 + V_174 , V_88 ) ;
V_97 = F_72 ( int , V_167 , V_88 ) ;
V_166 = F_103 ( V_20 , 0 , V_140 , V_168 , V_97 ) ;
V_88 -= V_97 ;
V_168 += V_97 ;
if ( V_166 || ! V_88 )
goto V_175;
V_97 = F_72 ( int , sizeof( V_171 ) , V_88 ) ;
V_166 = F_98 ( V_140 , ( void * ) & V_171 , V_168 , V_97 ) ;
V_88 -= V_97 ;
V_168 += V_97 ;
if ( V_166 || ! V_88 )
goto V_175;
}
V_166 = F_103 ( V_20 , V_167 , V_140 , V_168 , V_88 ) ;
V_168 += V_88 ;
V_175:
F_92 () ;
V_2 = F_93 ( V_4 -> V_2 ) ;
if ( V_2 )
F_104 ( V_2 , V_168 - V_142 , V_166 == 0 , 0 ) ;
F_95 () ;
return V_166 ? V_166 : V_168 ;
}
static T_5 F_105 ( struct V_3 * V_4 , struct V_158 * V_159 ,
...
T_5 V_166 = 0 ;
while ( V_88 ) {
F_107 ( F_27 ( & V_4 -> V_17 ) , & V_68 , V_176 ) ;
...
V_166 = F_97 ( V_4 , V_20 , V_140 , V_88 ) ;
F_28 ( V_20 ) ;
break;
}
F_111 ( F_27 ( & V_4 -> V_17 ) , & V_68 ) ;
return V_166 ;
}
static T_5 F_112 ( struct V_158 * V_159 , const struct V_93 * V_140 ,
unsigned long V_96 , T_6 V_160 )
{
struct V_11 * V_11 = V_159 -> V_161 ;
struct V_3 * V_4 = V_11 -> V_18 ;
...
V_166 = F_105 ( V_4 , V_159 , V_140 , V_88 , V_11 -> V_164 & V_165 ) ;
V_166 = F_72 ( T_5 , V_166 , V_88 ) ;
V_16:
return V_166 ;
}
static long F_113 ( struct V_11 * V_11 , unsigned int V_179 ,
unsigned long V_180 )
{
struct V_3 * V_4 = V_11 -> V_18 ;
struct V_1 * V_2 ;
...
return - V_163 ;
V_166 = 0 ;
if ( F_115 ( & V_183 -> V_191 , V_2 -> V_10 -> V_192 , V_193 ) ||
F_116 ( V_4 -> V_56 , & V_183 -> V_189 ) )
V_166 = - V_102 ;
F_59 ( V_2 -> V_10 ) ;
return V_166 ;
case V_194 :
if ( F_116 ( V_78 | V_77 | V_76 , V_184 ) )
return - V_102 ;
return 0 ;
case V_195 :
...
case V_197 :
V_187 = V_4 -> V_79 ;
if ( F_116 ( V_187 , V_186 ) )
return - V_102 ;
return 0 ;
case V_198 :
if ( F_114 ( V_187 , V_186 ) )
return - V_102 ;
...
static long F_117 ( struct V_11 * V_11 , unsigned int V_179 ,
unsigned long V_180 )
{
return F_113 ( V_11 , V_179 , ( unsigned long ) F_118 ( V_180 ) ) ;
}
static int F_119 ( struct V_158 * V_159 , struct V_205 * V_52 ,
struct V_138 * V_139 , T_4 V_141 )
{
struct V_3 * V_4 = F_120 ( V_52 , struct V_3 , V_52 ) ;
return F_85 ( V_4 , V_139 , V_139 -> V_206 , V_141 , V_139 -> V_207 ,
V_139 -> V_208 & V_209 ) ;
}
static int F_121 ( struct V_158 * V_159 , struct V_205 * V_52 ,
struct V_138 * V_139 , T_4 V_141 ,
int V_56 )
{
struct V_3 * V_4 = F_120 ( V_52 , struct V_3 , V_52 ) ;
...
if ( V_56 & ~ ( V_209 | V_210 ) )
return - V_43 ;
V_166 = F_105 ( V_4 , V_159 , V_139 -> V_206 , V_141 ,
V_56 & V_209 ) ;
if ( V_166 > V_141 ) {
V_139 -> V_208 |= V_210 ;
...
struct V_205 * F_122 ( struct V_11 * V_11 )
{
struct V_3 * V_4 ;
if ( V_11 -> V_211 != & V_212 )
return F_123 ( - V_43 ) ;
...
static int F_124 ( struct V_214 * V_215 ,
...
if ( V_13 )
return F_125 ( V_13 ) ;
V_220 = F_126 ( F_127 ( V_225 ) , V_2 -> V_40 ) ;
V_219 = F_128 ( V_226 , & V_10 -> V_10 , V_220 ,
V_10 , L_2 , V_10 -> V_227 ) ;
if ( F_129 ( V_219 ) ) {
F_36 ( V_2 ) ;
return F_125 ( F_130 ( V_219 ) ) ;
}
break;
case V_228 :
V_220 = F_126 ( F_127 ( V_225 ) , V_2 -> V_40 ) ;
...
goto V_229;
F_134 ( & V_230 , & V_212 ) ;
V_13 = F_135 ( & V_230 , V_225 , V_38 ) ;
if ( V_13 )
goto V_231;
V_226 = F_136 ( V_232 , L_3 ) ;
if ( F_129 ( V_226 ) ) {
V_13 = F_130 ( V_226 ) ;
goto V_233;
}
