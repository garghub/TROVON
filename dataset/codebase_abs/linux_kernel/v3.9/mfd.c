...
return - V_231 ;
if ( V_226 )
F_86 ( V_226 , & V_173 , & V_101 , & V_227 , & V_228 ) ;
return F_87 ( & V_2 -> V_6 , V_220 , V_173 , V_101 , V_227 , V_228 ) ;
}
...
return V_16 ;
if ( V_19 == 3 ) {
V_16 = F_105 ( V_233 -> V_122 , F_53 , 0 , L_29 , V_243 ) ;
if ( V_16 ) {
...
V_16 = F_105 ( V_233 -> V_122 , F_49 , 0 , V_133 -> V_47 , V_133 ) ;
if ( V_16 ) {
F_104 ( & V_233 -> V_71 , L_30 ) ;
goto V_244;
}
...
V_45 -> V_247 = 0x1000 ;
if ( ! ( F_112 ( V_45 -> V_246 , V_45 -> V_247 , L_31 ) ) )
F_113 ( L_32 ) ;
V_45 -> V_248 = F_114 ( ( unsigned long ) V_45 -> V_246 , V_45 -> V_247 ) ;
if ( ! V_45 -> V_248 ) {
F_115 ( L_33 ) ;
V_16 = - V_49 ;
goto V_249;
