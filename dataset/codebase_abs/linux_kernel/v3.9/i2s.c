...
if ( ! V_190 ) {
V_186 = F_86 ( V_32 , V_195 , 0 ) ;
if ( ! V_186 ) {
F_22 ( & V_32 -> V_33 ,
L_22 ) ;
return - V_144 ;
}
V_3 -> V_93 . V_196 = V_186 -> V_197 ;
V_186 = F_86 ( V_32 , V_195 , 1 ) ;
if ( ! V_186 ) {
F_22 ( & V_32 -> V_33 ,
L_23 ) ;
return - V_144 ;
}
V_3 -> V_95 . V_196 = V_186 -> V_197 ;
if ( V_181 == NULL ) {
F_22 ( & V_32 -> V_33 , L_24 ) ;
return - V_67 ;
}
...
V_186 = F_86 ( V_32 , V_199 , 0 ) ;
if ( ! V_186 ) {
F_22 ( & V_32 -> V_33 , L_31 ) ;
return - V_144 ;
}
if ( ! F_89 ( V_186 -> V_197 , F_90 ( V_186 ) ,
L_32 ) ) {
F_22 ( & V_32 -> V_33 , L_33 ) ;
return - V_200 ;
}
V_187 = V_186 -> V_197 ;
V_3 -> V_93 . V_148 = V_187 + V_201 ;
V_3 -> V_95 . V_148 = V_187 + V_202 ;
V_3 -> V_93 . V_203 =
(struct V_204 * ) & V_3 -> V_93 ;
V_3 -> V_93 . V_205 = L_34 ;
V_3 -> V_95 . V_203 =
(struct V_204 * ) & V_3 -> V_95 ;
V_3 -> V_95 . V_205 = L_35 ;
V_3 -> V_93 . V_94 = 4 ;
V_3 -> V_95 . V_94 = 4 ;
V_3 -> V_143 = V_187 ;
...
V_12 -> V_93 . V_148 = V_187 + V_207 ;
V_12 -> V_93 . V_203 =
(struct V_204 * ) & V_12 -> V_93 ;
V_12 -> V_93 . V_205 = L_37 ;
if ( ! V_190 ) {
V_186 = F_86 ( V_32 , V_195 , 2 ) ;
if ( V_186 )
V_12 -> V_93 . V_196 = V_186 -> V_197 ;
}
V_12 -> V_93 . V_94 = 4 ;
V_12 -> V_143 = V_187 ;
V_12 -> V_62 = V_62 ;
...
if ( V_181 -> V_208 && V_181 -> V_208 ( V_32 ) ) {
F_22 ( & V_32 -> V_33 , L_38 ) ;
V_151 = - V_67 ;
goto V_206;
}
}
F_84 ( & V_3 -> V_32 -> V_33 , & V_3 -> V_153 ) ;
F_91 ( & V_32 -> V_33 ) ;
F_85 ( & V_32 -> V_33 ) ;
return 0 ;
V_206:
...
if ( ! V_181 -> V_208 && V_32 -> V_33 . V_170 )
F_75 ( V_2 -> V_3 ) ;
if ( V_11 ) {
V_11 -> V_3 = NULL ;
V_11 -> V_12 = NULL ;
