...
struct V_1 * V_2 ;
int V_16 ;
V_54 = F_32 ( V_9 , V_55 , 0 ) ;
if ( ! V_54 )
return - V_56 ;
V_2 = F_33 ( & V_9 -> V_10 , sizeof( * V_2 ) , V_57 ) ;
if ( ! V_2 )
return - V_58 ;
V_2 -> V_9 = V_9 ;
if ( ! F_34 ( & V_9 -> V_10 , V_54 -> V_59 , F_35 ( V_54 ) ,
V_9 -> V_60 ) )
return - V_61 ;
V_2 -> V_6 = F_36 ( & V_9 -> V_10 , V_54 -> V_59 ,
F_35 ( V_54 ) ) ;
if ( V_2 -> V_6 == NULL )
return - V_58 ;
F_37 ( & V_2 -> V_5 ) ;
...
F_40 ( & V_2 -> V_47 , F_28 ) ;
F_41 ( & V_2 -> V_17 ) ;
V_2 -> V_62 = F_42 ( & V_9 -> V_10 , NULL ) ;
if ( F_43 ( V_2 -> V_62 ) )
return F_44 ( V_2 -> V_62 ) ;
F_45 ( V_2 -> V_62 ) ;
F_3 ( 0 , V_2 -> V_6 + V_7 ) ;
V_16 = F_46 ( & V_9 -> V_10 , V_2 -> V_41 , F_24 ,
V_63 , V_9 -> V_60 , V_2 ) ;
if ( V_16 ) {
F_8 ( & V_9 -> V_10 , L_5 ) ;
goto V_64;
}
if ( F_4 ( V_2 -> V_6 + V_12 ) & V_65 ) {
V_16 = F_11 ( V_2 , V_65 | V_66 , V_12 ) ;
if ( V_16 )
goto V_64;
}
V_16 = F_11 ( V_2 , V_67 , V_36 ) ;
if ( V_16 )
goto V_64;
V_16 = F_11 ( V_2 , 0 , V_68 ) ;
if ( V_16 )
goto V_64;
...
if ( ! ( F_4 ( V_2 -> V_6 + V_69 ) & V_70 ) ) {
V_16 = F_11 ( V_2 ,
F_4 ( V_2 -> V_6 + V_69 ) | V_70 ,
V_69 ) ;
if ( V_16 )
goto V_64;
}
F_47 ( V_9 , V_2 ) ;
V_2 -> V_49 = F_48 ( V_9 -> V_60 , & V_9 -> V_10 ,
& V_71 , V_72 ) ;
if ( F_43 ( V_2 -> V_49 ) ) {
V_16 = F_44 ( V_2 -> V_49 ) ;
goto V_64;
...
static int F_50 ( struct V_52 * V_9 )
{
