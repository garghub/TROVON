...
if ( V_17 ) {
if ( ! ( V_23 -> V_26 & V_27 ) )
V_15 -> V_28 = F_8 ( V_17 ) -> V_29 ;
if ( F_8 ( V_17 ) -> V_29 == V_15 -> V_28 ) {
F_9 ( V_17 , V_15 ) ;
goto V_30;
}
}
...
V_15 -> V_33 = V_23 -> V_34 ;
if ( V_15 -> V_35 & V_36 ) {
V_15 -> V_37 = V_38 | V_23 -> V_39 ;
V_15 -> V_40 = V_41 ;
} else {
V_15 -> V_37 = V_42 | V_23 -> V_43 ;
V_15 -> V_40 = V_44 ;
}
if ( V_15 -> V_35 & V_45 )
V_15 -> V_37 &= ~ V_46 ;
...
void
F_16 ( struct V_14 * V_15 , T_1 * V_56 ,
struct V_22 * V_23 )
{
memset ( V_15 , 0 , sizeof( * V_15 ) ) ;
V_15 -> V_35 = F_17 ( V_56 -> V_57 ) ;
V_15 -> V_52 = F_18 ( V_56 -> V_58 ) ;
V_15 -> V_59 = F_18 ( V_56 -> V_60 ) ;
V_15 -> V_61 = F_18 ( V_56 -> V_62 ) ;
V_15 -> V_63 = F_19 ( V_56 -> V_64 ) ;
V_15 -> V_65 = F_19 ( V_56 -> V_66 ) ;
V_15 -> V_67 = F_19 ( V_56 -> V_68 ) ;
F_15 ( V_15 , V_23 ) ;
}
static void
F_20 ( struct V_14 * V_15 , T_2 * V_56 ,
struct V_22 * V_23 )
{
int V_69 = F_21 ( V_23 ) -> V_70 -> V_71 -> V_72 ;
memset ( V_15 , 0 , sizeof( * V_15 ) ) ;
V_15 -> V_63 = F_22 ( V_56 -> V_73 ,
V_56 -> V_64 , V_69 ) ;
V_15 -> V_65 = F_22 ( V_56 -> V_74 ,
V_56 -> V_68 , V_69 ) ;
V_15 -> V_67 = F_22 ( V_56 -> V_74 ,
V_56 -> V_68 , V_69 ) ;
V_15 -> V_35 = F_23 ( V_56 -> V_75 ) ;
V_15 -> V_59 = F_17 ( V_56 -> V_60 ) ;
V_15 -> V_52 = F_17 ( V_56 -> V_76 ) ;
F_15 ( V_15 , V_23 ) ;
}
static int
F_24 ( const unsigned int V_77 , struct V_1 * V_1 )
{
T_3 V_78 ;
int V_79 = 0 ;
char * V_80 = NULL ;
struct V_3 * V_81 ;
struct V_22 * V_23 = F_4 ( V_1 -> V_82 . V_10 -> V_83 ) ;
...
if ( F_31 ( V_23 ) )
V_78 |= V_108 ;
V_79 = V_71 -> V_92 -> V_93 ( V_77 , V_87 , V_80 , V_23 ,
& V_81 -> V_109 , V_78 ,
& V_81 -> V_7 ) ;
if ( V_79 == 0 )
V_81 -> V_6 = false ;
...
static int F_34 ( const char * V_111 )
{
int V_112 ;
const T_4 * V_113 = ( const T_4 * ) V_111 ;
...
V_124 -> V_130 = F_18 ( V_56 -> V_131 . V_132 ) ;
}
static void F_39 ( struct V_123 * V_124 ,
const T_1 * V_56 )
{
V_124 -> V_13 = & V_56 -> V_126 [ 0 ] ;
V_124 -> V_127 = F_17 ( V_56 -> V_121 ) ;
...
{
struct V_17 * V_17 = F_47 ( V_1 ) ;
struct V_139 * V_140 = F_8 ( V_17 ) ;
if ( V_140 -> time == 0 )
return 1 ;
else
return 0 ;
}
static int F_48 ( const char * V_141 ,
struct V_3 * V_142 )
{
struct V_123 V_124 ;
int V_79 ;
...
static int
F_49 ( const unsigned int V_77 , struct V_86 * V_87 ,
...
F_51 ( & V_155 ) ;
if ( V_71 -> V_92 -> V_156 )
V_71 -> V_92 -> V_156 ( V_77 , V_87 , & V_150 -> V_109 ) ;
} else
F_51 ( & V_155 ) ;
if ( V_150 -> V_7 . V_157 ) {
F_2 ( 1 , L_14 ) ;
...
F_2 ( 1 , L_16 ) ;
V_79 = V_71 -> V_92 -> V_151 ( V_77 , V_87 , & V_150 -> V_109 ,
V_78 ,
& V_150 -> V_7 ) ;
if ( V_150 -> V_7 . V_159 )
F_48 ( V_150 -> V_7 . V_159 , V_150 ) ;
...
static int F_54 ( char * V_164 , struct V_1 * V_1 , T_11 V_165 ,
...
return 0 ;
if ( V_142 -> V_7 . V_143 ) {
struct V_169 * V_170 = V_23 -> V_171 ;
V_13 . V_13 = V_167 ;
V_13 . V_112 =
F_55 ( ( char * ) V_13 . V_13 , ( T_4 * ) V_124 . V_13 ,
V_172 ,
F_56 ( V_173 , V_124 . V_127 ,
( V_173 ) V_168 ) , V_170 ,
V_23 -> V_26 &
V_174 ) ;
V_13 . V_112 -= F_57 ( V_170 ) ;
} else {
V_13 . V_13 = V_124 . V_13 ;
V_13 . V_112 = V_124 . V_127 ;
}
...
if ( V_124 . V_130 && ( V_23 -> V_26 & V_27 ) ) {
V_15 . V_28 = V_124 . V_130 ;
} else {
V_15 . V_28 = F_59 ( V_19 , V_175 ) ;
F_60 ( V_23 ) ;
}
if ( ( V_23 -> V_26 & V_176 ) &&
F_61 ( & V_15 ) )
V_15 . V_48 |= V_49 ;
F_3 ( V_1 -> V_177 , & V_13 , & V_15 ) ;
V_130 = F_62 ( V_15 . V_28 ) ;
V_79 = V_165 ( V_166 , V_13 . V_13 , V_13 . V_112 , V_1 -> V_95 , V_130 ,
V_15 . V_40 ) ;
return V_79 ;
}
int F_63 ( struct V_1 * V_1 , void * V_178 , T_11 V_165 )
{
int V_79 = 0 ;
unsigned int V_77 ;
int V_160 ;
