...
static int F_162 ( struct V_296 * V_205 ,
...
int V_123 ;
struct V_377 * V_196 ;
V_123 = F_163 ( V_378 , V_379 , V_380 , 0 , & V_198 ) ;
if ( V_123 < 0 )
return V_123 ;
if ( V_219 < 0 )
V_219 = F_159 ( V_205 ) ;
strcpy ( V_198 -> V_381 , L_51 ) ;
if ( ! V_219 ) {
switch ( V_376 -> V_382 ) {
case V_154 :
strcpy ( V_198 -> V_381 , L_52 ) ;
break;
case V_155 :
...
static void F_168 ( struct V_296 * V_205 )
{
F_164 ( F_169 ( V_205 ) ) ;
F_167 ( V_205 , NULL ) ;
}
