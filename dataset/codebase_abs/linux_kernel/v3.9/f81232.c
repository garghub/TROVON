...
static void F_28 ( struct V_1 * V_2 , int V_51 )
{
struct V_16 * V_17 = F_8 ( V_2 ) ;
unsigned long V_20 ;
T_1 V_52 ;
...
static int F_30 ( struct V_1 * V_2 , unsigned int V_58 )
{
struct V_16 * V_17 = F_8 ( V_2 ) ;
unsigned long V_20 ;
unsigned int V_59 ;
...
unsigned int V_72 , unsigned long V_58 )
{
struct V_73 V_74 ;
struct V_1 * V_2 = V_39 -> V_75 ;
...
V_74 . type = V_78 ;
V_74 . line = V_2 -> V_56 -> V_79 ;
V_74 . V_2 = V_2 -> V_76 ;
V_74 . V_80 = 460800 ;
if ( F_34 ( ( void V_81 * ) V_58 , & V_74 , sizeof V_74 ) )
return - V_82 ;
return 0 ;
case V_83 :
