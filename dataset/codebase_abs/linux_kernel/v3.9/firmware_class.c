...
static T_2 F_57 ( struct V_60 * V_60 ,
struct V_61 * V_62 ,
char * V_17 )
{
...
{
V_10 = F_59 ( V_17 , NULL , 10 ) ;
if ( V_10 < 0 )
V_10 = 0 ;
return V_63 ;
}
static void F_60 ( struct V_40 * V_50 )
{
struct V_57 * V_58 = F_54 ( V_50 ) ;
F_23 ( V_58 ) ;
F_61 ( V_64 ) ;
}
static int F_62 ( struct V_40 * V_50 , struct V_65 * V_66 )
{
struct V_57 * V_58 = F_54 ( V_50 ) ;
if ( F_63 ( V_66 , L_7 , V_58 -> V_17 -> V_20 ) )
return - V_28 ;
if ( F_63 ( V_66 , L_8 , V_10 ) )
return - V_28 ;
if ( F_63 ( V_66 , L_9 , V_58 -> V_67 ) )
return - V_28 ;
return 0 ;
}
static T_2 F_64 ( struct V_40 * V_50 ,
struct V_68 * V_62 , char * V_17 )
{
struct V_57 * V_58 = F_54 ( V_50 ) ;
int V_69 = F_65 ( V_70 , & V_58 -> V_17 -> V_48 ) ;
...
{
struct V_57 * V_58 = F_54 ( V_50 ) ;
struct V_13 * V_39 = V_58 -> V_17 ;
int V_69 = F_59 ( V_17 , NULL , 10 ) ;
int V_31 ;
F_41 ( & V_46 ) ;
if ( ! V_39 )
goto V_72;
