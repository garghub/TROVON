...
if ( ! ( V_4 -> V_44 & V_45 ) && F_23 ( V_4 ) )
return - V_46 ;
if ( ! F_24 ( V_43 -> V_47 ) )
return - V_48 ;
return 0 ;
}
void F_25 ( struct V_3 * V_4 , void * V_41 )
{
struct V_42 * V_43 = V_41 ;
memcpy ( V_4 -> V_14 , V_43 -> V_47 , V_16 ) ;
}
int F_26 ( struct V_3 * V_4 , void * V_41 )
{
int V_49 ;
V_49 = F_22 ( V_4 , V_41 ) ;
if ( V_49 < 0 )
...
int F_27 ( struct V_3 * V_4 , int V_50 )
{
...
struct V_3 * F_30 ( int V_63 , unsigned int V_64 ,
unsigned int V_65 )
{
return F_31 ( V_63 , L_2 , F_29 , V_64 , V_65 ) ;
}
static T_2 F_32 ( char * V_66 , int V_67 ,
const unsigned char * V_43 , int V_7 )
{
int V_68 ;
char * V_69 = V_66 ;
for ( V_68 = 0 ; V_68 < V_7 ; V_68 ++ ) {
V_69 += F_33 ( V_69 , V_67 - ( V_69 - V_66 ) , L_3 , V_43 [ V_68 ] ) ;
if ( V_68 == V_7 - 1 )
break;
V_69 += F_33 ( V_69 , V_67 - ( V_69 - V_66 ) , L_4 ) ;
}
return V_69 - V_66 ;
}
T_3 F_34 ( char * V_66 , const unsigned char * V_43 , int V_7 )
{
T_2 V_70 ;
V_70 = F_32 ( V_66 , V_71 , V_43 , V_7 ) ;
V_70 += F_33 ( V_66 + V_70 , V_71 - V_70 , L_5 ) ;
return ( T_3 ) V_70 ;
}
