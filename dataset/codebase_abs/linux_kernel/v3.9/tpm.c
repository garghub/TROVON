...
if ( V_190 ) {
V_47 . V_53 . V_59 = V_131 ;
V_47 . V_63 . V_132 . V_121 = F_18 ( V_190 ) ;
memcpy ( V_47 . V_63 . V_132 . V_130 , V_189 ,
V_128 ) ;
V_24 = F_15 ( V_3 , & V_47 , V_133 ,
L_48 ) ;
}
V_47 . V_53 . V_59 = V_191 ;
V_24 = F_15 ( V_3 , & V_47 , V_192 ,
L_49 ) ;
return V_24 ;
}
int F_82 ( struct V_55 * V_29 )
{
struct V_2 * V_3 = F_17 ( V_29 ) ;
if ( V_3 == NULL )
return - V_129 ;
...
int F_83 ( T_1 V_115 , T_2 * V_33 , T_4 V_193 )
{
struct V_2 * V_3 ;
struct V_46 V_58 ;
T_1 V_194 , V_195 = F_84 ( T_1 , V_193 , V_196 ) ;
int V_50 , V_197 = 0 , V_198 = 5 ;
T_2 * V_199 = V_33 ;
V_3 = F_29 ( V_115 ) ;
if ( V_3 == NULL )
return - V_129 ;
if ( ! V_33 || ! V_195 || V_193 > V_196 )
return - V_87 ;
do {
V_58 . V_53 . V_59 = V_200 ;
V_58 . V_63 . V_201 . V_195 = F_18 ( V_195 ) ;
V_50 = F_15 ( V_3 , & V_58 ,
V_202 + V_195 ,
L_50 ) ;
if ( V_50 )
break;
V_194 = F_10 ( V_58 . V_63 . V_203 . V_204 ) ;
memcpy ( V_199 , V_58 . V_63 . V_203 . V_205 , V_194 ) ;
V_199 += V_194 ;
V_197 += V_194 ;
V_195 -= V_194 ;
} while ( V_198 -- && V_197 < V_193 );
return V_197 ? V_197 : - V_206 ;
}
...
return;
if ( V_3 -> V_20 . V_207 )
V_3 -> V_20 . V_207 ( V_3 -> V_29 ) ;
F_61 ( V_3 -> V_118 , V_208 ) ;
F_86 ( V_3 -> V_20 . V_171 . V_209 ) ;
}
static void F_87 ( struct V_55 * V_29 )
{
struct V_2 * V_3 = F_17 ( V_29 ) ;
if ( ! V_3 )
return;
...
struct V_2 * F_88 ( struct V_55 * V_29 ,
...
V_212 = F_90 ( F_89 , V_174 ) ;
if ( V_3 == NULL || V_212 == NULL )
goto V_213;
F_91 ( & V_3 -> V_6 ) ;
F_91 ( & V_3 -> V_31 ) ;
F_92 ( & V_3 -> V_185 ) ;
...
F_94 ( & V_3 -> V_177 , F_1 ,
( unsigned long ) V_3 ) ;
memcpy ( & V_3 -> V_20 , V_211 , sizeof( struct V_210 ) ) ;
V_3 -> V_118 = F_95 ( V_208 , V_214 ) ;
if ( V_3 -> V_118 >= V_214 ) {
F_11 ( V_29 , L_51 ) ;
goto V_213;
} else if ( V_3 -> V_118 == 0 )
V_3 -> V_20 . V_171 . V_170 = V_215 ;
else
V_3 -> V_20 . V_171 . V_170 = V_216 ;
F_96 ( V_3 -> V_118 , V_208 ) ;
F_97 ( V_212 , F_89 , L_52 , L_53 , V_3 -> V_118 ) ;
V_3 -> V_20 . V_171 . V_209 = V_212 ;
V_3 -> V_20 . V_171 . V_217 = V_29 ;
V_3 -> V_29 = F_56 ( V_29 ) ;
V_3 -> V_207 = V_29 -> V_207 ;
V_29 -> V_207 = F_87 ;
F_98 ( V_29 , V_3 ) ;
if ( F_99 ( & V_3 -> V_20 . V_171 ) ) {
F_11 ( V_3 -> V_29 ,
L_54 ,
V_3 -> V_20 . V_171 . V_209 ,
V_3 -> V_20 . V_171 . V_170 ) ;
goto F_59;
}
if ( F_100 ( & V_29 -> V_186 , V_3 -> V_20 . V_187 ) ) {
F_77 ( & V_3 -> V_20 . V_171 ) ;
goto F_59;
}
if ( F_101 ( & V_29 -> V_186 ) ) {
...
V_3 -> V_188 = F_102 ( V_212 ) ;
F_73 ( & V_184 ) ;
F_103 ( & V_3 -> V_185 , & V_218 ) ;
F_75 ( & V_184 ) ;
return V_3 ;
F_59:
F_59 ( V_3 -> V_29 ) ;
