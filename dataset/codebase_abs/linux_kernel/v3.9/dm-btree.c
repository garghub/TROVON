...
static int F_59 ( struct V_64 * V_48 , T_5 V_65 ,
int (* F_60)( void * V_28 , T_2 * V_19 , void * V_100 ) ,
void * V_28 )
{
int V_41 ;
unsigned V_24 , V_101 ;
...
V_41 = F_39 ( V_48 , V_65 ) ;
V_10 = F_40 ( V_48 ) ;
V_101 = F_4 ( V_10 -> V_15 . V_16 ) ;
for ( V_24 = 0 ; V_24 < V_101 ; V_24 ++ ) {
if ( F_4 ( V_10 -> V_15 . V_25 ) & V_26 ) {
V_41 = F_59 ( V_48 , F_9 ( V_10 , V_24 ) , F_60 , V_28 ) ;
if ( V_41 )
goto V_62;
} else {
V_19 = F_5 ( * F_61 ( V_10 , V_24 ) ) ;
V_41 = F_60 ( V_28 , & V_19 , F_10 ( V_10 , V_24 ) ) ;
if ( V_41 )
goto V_62;
}
}
