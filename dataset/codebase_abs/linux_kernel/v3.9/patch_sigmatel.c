...
struct V_8 * V_9 = V_4 -> V_9 ;
int V_183 ;
V_183 = F_111 ( V_4 , & V_9 -> V_15 . V_104 , NULL , 0 ) ;
if ( V_183 < 0 )
return V_183 ;
V_9 -> V_15 . V_184 = F_1 ;
V_9 -> V_15 . V_185 = F_3 ;
...
if ( V_183 < 0 )
return V_183 ;
V_183 = F_114 ( V_4 , V_18 ) ;
if ( V_183 < 0 )
return V_183 ;
if ( V_4 -> V_126 ) {
V_4 -> V_126 -> V_193 = V_9 -> V_194 ;
...
#endif
if ( V_9 -> V_53 )
V_9 -> V_15 . V_195 . V_196 = F_12 ;
if ( V_9 -> V_197 &&
F_34 ( V_4 , L_18 ) == 1 ) {
if ( ! F_55 ( & V_9 -> V_15 , NULL , V_9 -> V_197 ) )
return - V_123 ;
}
if ( V_9 -> V_198 ) {
V_183 = F_66 ( V_4 ) ;
...
static void F_123 ( struct V_199 * V_200 ,
...
{
F_124 ( V_200 , L_20 ,
F_7 ( V_4 , V_4 -> V_31 , 0 , V_202 , 0 ) ) ;
}
static void F_126 ( struct V_199 * V_200 ,
struct V_3 * V_4 , T_1 V_18 )
{
F_123 ( V_200 , V_4 , V_18 ) ;
if ( V_18 == V_4 -> V_31 )
F_125 ( V_200 , V_4 , 0xfa0 ) ;
}
static void F_127 ( struct V_199 * V_200 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_125 ( V_200 , V_4 , 0xfe0 ) ;
}
static void F_128 ( struct V_199 * V_200 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_125 ( V_200 , V_4 , 0xfeb ) ;
}
...
static void F_133 ( struct V_3 * V_4 , T_1 V_205 ,
unsigned int V_206 )
{
unsigned int V_207 = V_206 ;
struct V_8 * V_9 = V_4 -> V_9 ;
if ( V_206 == V_23 ) {
if ( V_9 -> V_55 ) {
V_207 = V_208 ;
...
F_7 ( V_4 , V_205 , 0 , V_19 ,
V_207 ) ;
F_134 ( V_4 , V_205 , V_206 ) ;
}
static int F_135 ( struct V_3 * V_4 )
{
struct V_8 * V_9 ;
V_9 = F_136 ( sizeof( * V_9 ) , V_209 ) ;
if ( ! V_9 )
return - V_123 ;
F_137 ( & V_9 -> V_15 ) ;
V_4 -> V_9 = V_9 ;
...
V_9 -> V_43 = 0x01 ;
V_9 -> V_64 = 1 ;
V_9 -> V_68 = F_142 ( V_227 ) ;
V_9 -> V_69 = V_227 ;
V_9 -> V_15 . V_211 = 1 ;
V_9 -> V_15 . V_228 = 1 ;
V_4 -> V_203 = V_212 ;
F_100 ( V_4 , V_229 , V_230 ,
V_231 ) ;
F_101 ( V_4 , V_149 ) ;
if ( ! V_9 -> V_154 )
F_75 ( V_4 , V_232 ) ;
...
V_9 -> V_192 = 0x21 ;
V_9 -> V_69 = V_237 ;
V_9 -> V_68 = F_142 ( V_237 ) ;
V_9 -> V_96 = - 1 ;
V_4 -> V_203 = V_212 ;
F_75 ( V_4 , V_238 ) ;
F_100 ( V_4 , V_239 , V_240 ,
V_241 ) ;
F_101 ( V_4 , V_149 ) ;
F_143 ( V_4 ) ;
V_183 = F_110 ( V_4 ) ;
...
if ( F_147 ( F_148 ( V_4 , 0x28 ) ) == V_247 )
F_75 ( V_4 , V_248 ) ;
if ( F_148 ( V_4 , 0xa ) & V_249 )
F_149 ( V_4 , V_244 ) ;
V_9 -> V_197 = & V_250 ;
V_9 -> V_86 = 0x50 ;
V_9 -> V_90 = 0 ;
V_9 -> V_14 = 1 ;
V_9 -> V_192 = 0x26 ;
V_9 -> V_68 = F_142 ( V_251 ) ;
V_9 -> V_69 = V_251 ;
F_100 ( V_4 , V_252 , V_253 ,
V_254 ) ;
F_101 ( V_4 , V_149 ) ;
F_143 ( V_4 ) ;
V_183 = F_110 ( V_4 ) ;
...
V_4 -> V_203 = V_212 ;
F_75 ( V_4 , V_255 ) ;
F_151 ( V_4 , 0x12 , V_113 ,
( 0 << V_256 ) |
( 2 << V_125 ) |
( 0x27 << V_257 ) |
( 0 << V_120 ) ) ;
F_100 ( V_4 , V_258 , V_259 ,
V_175 ) ;
F_101 ( V_4 , V_149 ) ;
V_183 = F_110 ( V_4 ) ;
if ( V_183 < 0 ) {
