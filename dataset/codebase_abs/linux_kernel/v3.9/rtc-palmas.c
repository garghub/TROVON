...
int V_9 ;
V_34 = F_19 ( & V_41 -> V_2 , sizeof( struct V_34 ) ,
V_42 ) ;
if ( ! V_34 )
return - V_43 ;
V_9 = F_15 ( & V_41 -> V_2 ) ;
if ( V_9 < 0 ) {
F_4 ( & V_41 -> V_2 , L_13 , V_9 ) ;
return V_9 ;
}
V_34 -> V_2 = & V_41 -> V_2 ;
F_20 ( V_41 , V_34 ) ;
...
V_20 ) ;
if ( V_9 < 0 ) {
F_4 ( & V_41 -> V_2 , L_14 , V_9 ) ;
return V_9 ;
}
V_34 -> V_32 = F_21 ( V_41 , 0 ) ;
V_34 -> V_36 = F_22 ( V_41 -> V_44 , & V_41 -> V_2 ,
& V_45 , V_46 ) ;
if ( F_23 ( V_34 -> V_36 ) ) {
V_9 = F_24 ( V_34 -> V_36 ) ;
...
V_9 = F_25 ( V_34 -> V_32 , NULL ,
F_16 ,
V_47 | V_48 |
V_49 ,
F_26 ( & V_41 -> V_2 ) , V_34 ) ;
if ( V_9 < 0 ) {
F_4 ( & V_41 -> V_2 , L_16 , V_9 ) ;
F_27 ( V_34 -> V_36 ) ;
return V_9 ;
}
F_28 ( & V_41 -> V_2 , 1 ) ;
