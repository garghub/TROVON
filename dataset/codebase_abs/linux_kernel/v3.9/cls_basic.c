...
struct V_32 V_33 ;
struct V_34 V_23 ;
V_30 = F_22 ( V_25 , V_4 , V_28 , V_29 , & V_33 , & V_35 ) ;
if ( V_30 < 0 )
return V_30 ;
V_30 = F_23 ( V_4 , V_28 [ V_36 ] , & V_23 ) ;
if ( V_30 < 0 )
goto V_37;
if ( V_28 [ V_38 ] ) {
V_12 -> V_6 . V_39 = F_24 ( V_28 [ V_38 ] ) ;
F_25 ( V_4 , & V_12 -> V_6 , V_26 ) ;
}
F_26 ( V_4 , & V_12 -> V_14 , & V_33 ) ;
...
static int F_28 ( struct V_25 * V_25 , struct V_1 * V_40 ,
...
return - V_31 ;
return F_21 ( V_25 , V_4 , V_12 , V_26 , V_28 , V_41 [ V_45 ] ) ;
}
V_30 = - V_18 ;
...
V_30 = F_21 ( V_25 , V_4 , V_12 , V_26 , V_28 , V_41 [ V_45 ] ) ;
if ( V_30 < 0 )
goto V_37;
F_19 ( V_4 ) ;
...
goto V_58;
if ( V_12 -> V_6 . V_39 &&
F_35 ( V_2 , V_38 , V_12 -> V_6 . V_39 ) )
goto V_58;
if ( F_36 ( V_2 , & V_12 -> V_14 , & V_35 ) < 0 ||
F_37 ( V_2 , & V_12 -> V_13 , V_36 ) < 0 )
goto V_58;
F_38 ( V_2 , V_55 ) ;
if ( F_39 ( V_2 , & V_12 -> V_14 , & V_35 ) < 0 )
goto V_58;
return V_2 -> V_56 ;
V_58:
F_40 ( V_2 , V_55 ) ;
