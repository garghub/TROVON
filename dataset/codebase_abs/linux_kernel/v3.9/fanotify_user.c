...
T_8 (F_83)( int V_122 , unsigned int V_89 ,
T_9 V_29 , int V_87 ,
...
case V_125 :
if ( V_89 & V_135 )
V_24 = F_79 ( V_3 , V_17 , V_29 , V_89 ) ;
else
V_24 = F_82 ( V_3 , V_72 , V_29 , V_89 ) ;
break;
case V_126 :
if ( V_89 & V_135 )
V_24 = F_69 ( V_3 , V_17 , V_29 , V_89 ) ;
else
V_24 = F_75 ( V_3 , V_72 , V_29 , V_89 ) ;
break;
case V_127 :
if ( V_89 & V_135 )
F_84 ( V_3 ) ;
...
T_10 long F_86 ( long V_122 , long V_89 , T_9 V_29 ,
long V_87 , long V_123 )
{
return F_87 ( ( int ) V_122 , ( unsigned int ) V_89 ,
V_29 , ( int ) V_87 ,
( const char T_5 * ) V_123 ) ;
}
static int T_11 F_88 ( void )
{
V_86 = F_89 ( V_84 , V_136 ) ;
V_48 = F_89 ( V_36 ,
V_136 ) ;
return 0 ;
}
