...
static void F_24 ( struct V_39 * V_40 , T_1 * V_2 , int V_3 )
{
int V_41 , V_42 , V_23 , V_43 ;
F_25 ( V_40 ) ;
V_42 = V_3 / V_40 -> V_44 ;
V_41 = V_42 * V_40 -> V_44 ;
if ( V_42 ) {
V_23 = F_26 ( V_40 , 0 , V_2 , V_41 ) ;
if ( V_23 < 0 ) {
if ( V_23 != - V_45 )
F_27 ( & V_40 -> V_46 ,
L_4 ,
...
V_43 = ( V_43 + 3 ) & ~ 3 ;
if ( V_43 ) {
V_23 = F_26 ( V_40 , 0 , V_2 + V_41 , V_43 ) ;
if ( V_23 < 0 ) {
if ( V_23 != - V_45 )
F_27 ( & V_40 -> V_46 ,
L_4 ,
...
static void F_29 ( struct V_39 * V_40 , struct V_7 * V_8 )
{
...
static void F_36 ( struct V_39 * V_40 , struct V_7 * V_8 ,
struct V_6 * V_9 )
{
unsigned long V_58 ;
#ifdef F_34
F_1 ( L_5 , V_9 -> V_11 + V_59 ,
V_9 -> V_3 - V_59 ) ;
#endif
F_24 ( V_40 , V_9 -> V_11 , V_9 -> V_3 ) ;
F_30 ( & V_8 -> V_26 , V_58 ) ;
if ( V_9 -> V_65 )
V_9 -> V_65 ( V_9 -> V_66 ) ;
F_7 ( V_9 ) ;
...
static void F_44 ( struct V_39 * V_40 )
{
struct V_88 * V_88 = F_45 ( V_40 ) ;
...
T_3 V_3 , V_42 , V_41 ;
int V_23 , V_43 ;
V_89 = F_46 ( V_40 , 0x13 , & V_23 ) ;
if ( V_89 & 0x01 )
F_47 ( V_40 , 0x01 , 0x13 , & V_23 ) ;
else
return;
V_23 = F_48 ( V_40 , V_90 , 0x0 , V_91 ) ;
if ( V_23 ) {
F_27 ( & V_40 -> V_46 ,
L_8 , V_40 -> V_92 ) ;
goto V_93;
...
F_33 ( & V_8 -> V_26 , V_58 ) ;
#ifdef F_34
F_2 ( V_5 L_10 , F_49 ( * V_94 ) ) ;
#endif
goto V_93;
}
memcpy ( V_15 -> V_35 , V_90 + V_59 ,
V_91 - V_59 ) ;
V_11 = V_15 -> V_35 + V_91 - V_59 ;
V_43 = V_3 - V_91 + V_59 ;
if ( V_43 <= 0 )
goto V_48;
V_42 = V_43 / V_40 -> V_44 ;
...
V_48:
#ifdef F_34
F_1 ( L_11 , V_15 -> V_35 , V_3 ) ;
#endif
V_3 = F_43 ( V_22 , V_15 -> V_35 , V_3 ) ;
F_30 ( & V_15 -> V_26 , V_58 ) ;
if ( ! F_11 ( & V_15 -> V_33 ) ) {
V_16 = F_12 ( V_15 -> V_33 . V_51 , struct V_13 , V_20 ) ;
F_33 ( & V_15 -> V_26 , V_58 ) ;
if ( V_16 -> V_65 )
V_16 -> V_65 ( V_16 -> V_66 , V_15 -> V_35 , V_3 ) ;
F_30 ( & V_15 -> V_26 , V_58 ) ;
F_13 ( & V_16 -> V_20 ) ;
F_17 ( V_15 , V_16 ) ;
}
