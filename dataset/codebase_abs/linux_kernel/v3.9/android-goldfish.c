...
V_2 -> V_107 = F_33 ( V_98 -> V_105 , V_98 -> V_106 - V_98 -> V_105 + 1 ) ;
if ( V_2 -> V_107 == NULL ) {
V_99 = - V_103 ;
goto V_108;
}
V_2 -> V_44 = F_34 ( & V_96 -> V_4 , V_109 ,
& V_100 , V_110 ) ;
if ( V_2 -> V_44 == 0 ) {
V_99 = - V_103 ;
goto V_111;
...
V_99 = F_35 ( V_2 -> V_58 , F_17 , 0 , V_128 , V_2 ) ;
if ( V_99 ) {
F_6 ( & V_96 -> V_4 , L_8 ) ;
goto V_129;
}
...
{
struct V_1 * V_2 = F_44 ( V_96 ) ;
F_36 ( V_96 , NULL ) ;
F_45 ( V_2 == NULL ) ;
F_46 ( V_2 -> V_18 ) ;
F_47 ( V_2 -> V_58 , V_2 ) ;
F_40 ( & V_96 -> V_4 , V_109 , V_2 -> V_44 , V_2 -> V_112 ) ;
F_41 ( V_2 -> V_107 ) ;
F_42 ( V_2 -> V_18 ) ;
return 0 ;
}
