...
static inline const struct V_168 * T_8 F_99 (
struct V_169 * V_170 )
{
if ( V_170 -> V_74 . V_171 ) {
const struct V_172 * V_173 ;
V_173 = F_100 ( V_174 , V_170 -> V_74 . V_171 ) ;
if ( V_173 == NULL )
return NULL ;
return V_173 -> V_63 ;
}
...
F_31 ( V_12 , V_176 , 0 ) ;
F_31 ( V_12 , V_177 , - 1L ) ;
while ( F_53 ( V_12 , V_150 ) & V_12 -> V_178 )
F_88 () ;
}
static int T_8 F_103 ( struct V_169 * V_170 )
{
struct V_179 * V_180 ;
struct V_11 * V_12 ;
T_7 V_181 ;
...
F_104 ( V_183 , V_184 . V_185 ) ;
F_104 ( V_183 , V_186 . V_185 ) ;
F_104 ( V_187 , V_186 . V_185 ) ;
V_182 = F_99 ( V_170 ) ;
if ( ! V_182 )
return - V_188 ;
V_180 = F_105 ( V_170 , V_189 , 0 ) ;
if ( ! V_180 )
return - V_136 ;
V_66 = F_106 ( V_170 , 0 ) ;
if ( V_66 < 0 )
...
V_12 = F_107 ( V_181 , V_166 ) ;
if ( ! V_12 )
return - V_191 ;
V_12 -> V_73 . V_185 = V_182 -> V_185 ;
V_12 -> V_178 = ( 1 << V_182 -> V_190 ) - 1 ;
V_181 = F_108 ( V_180 ) ;
if ( ! F_109 ( V_180 -> V_192 , V_181 , V_170 -> V_74 . V_193 -> V_194 ) ) {
V_127 = - V_100 ;
goto V_195;
}
V_12 -> V_196 = F_110 ( V_180 -> V_192 , V_181 ) ;
if ( ! V_12 -> V_196 ) {
V_127 = - V_191 ;
goto V_197;
}
V_12 -> V_198 = F_111 ( & V_170 -> V_74 , L_38 ) ;
if ( F_112 ( V_12 -> V_198 ) ) {
V_127 = F_113 ( V_12 -> V_198 ) ;
goto V_199;
}
F_114 ( V_12 -> V_198 ) ;
F_102 ( V_12 ) ;
V_127 = F_115 ( V_66 , F_52 , 0 , L_39 , V_12 ) ;
if ( V_127 )
goto V_200;
F_116 ( V_170 , V_12 ) ;
V_12 -> V_15 = F_117 ( L_40 ,
...
V_12 -> V_73 . V_206 = F_97 ;
V_12 -> V_73 . V_207 = F_89 ;
V_12 -> V_73 . V_208 = F_92 ;
V_12 -> V_73 . V_74 = & V_170 -> V_74 ;
if ( F_121 ( V_183 , V_12 -> V_73 . V_185 ) )
V_12 -> V_73 . V_209 = F_62 ;
if ( F_121 ( V_187 , V_12 -> V_73 . V_185 ) ) {
V_12 -> V_73 . V_210 = F_66 ;
F_104 ( V_211 , V_12 -> V_73 . V_185 ) ;
V_12 -> V_73 . V_212 = F_79 ;
V_12 -> V_73 . V_213 = F_85 ;
}
F_31 ( V_12 , V_176 , V_214 ) ;
F_122 ( & V_170 -> V_74 , L_42 ,
F_121 ( V_183 , V_12 -> V_73 . V_185 ) ? L_43 : L_44 ,
F_121 ( V_187 , V_12 -> V_73 . V_185 ) ? L_45 : L_44 ,
V_182 -> V_190 ) ;
F_123 ( & V_12 -> V_73 ) ;
return 0 ;
V_201:
F_116 ( V_170 , NULL ) ;
F_124 ( F_106 ( V_170 , 0 ) , V_12 ) ;
V_200:
F_125 ( V_12 -> V_198 ) ;
F_126 ( V_12 -> V_198 ) ;
V_199:
...
V_12 -> V_196 = NULL ;
V_197:
F_128 ( V_180 -> V_192 , V_181 ) ;
V_195:
F_129 ( V_12 ) ;
return V_127 ;
}
static int T_9 F_130 ( struct V_169 * V_170 )
{
struct V_11 * V_12 = F_131 ( V_170 ) ;
...
static int F_138 ( struct V_13 * V_74 )
{
struct V_169 * V_170 = F_139 ( V_74 ) ;
struct V_11 * V_12 = F_131 ( V_170 ) ;
struct V_7 * V_8 , * V_215 ;
F_12 (chan, _chan, &atdma->dma_common.channels,
device_node) {
...
static int F_142 ( struct V_13 * V_74 )
{
struct V_169 * V_170 = F_139 ( V_74 ) ;
struct V_11 * V_12 = F_131 ( V_170 ) ;
struct V_7 * V_8 , * V_215 ;
...
static int F_144 ( struct V_13 * V_74 )
{
struct V_169 * V_170 = F_139 ( V_74 ) ;
struct V_11 * V_12 = F_131 ( V_170 ) ;
struct V_7 * V_8 , * V_215 ;
