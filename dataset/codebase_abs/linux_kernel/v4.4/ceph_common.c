...
int V_105 , V_106 , V_46 ;
if ( ! * V_89 )
continue;
V_70 = - V_71 ;
V_105 = F_35 ( ( char * ) V_89 , V_107 , V_92 ) ;
if ( V_105 < 0 && F_29 ) {
...
if ( V_105 < V_108 ) {
V_46 = F_36 ( & V_92 [ 0 ] , & V_106 ) ;
if ( V_46 < 0 ) {
F_6 ( L_40
L_41 , V_89 ) ;
continue;
}
F_17 ( L_42 , V_105 , V_106 ) ;
} else if ( V_105 > V_108 && V_105 < V_109 ) {
F_17 ( L_43 , V_105 ,
V_92 [ 0 ] . V_110 ) ;
} else {
F_17 ( L_44 , V_105 ) ;
...
break;
case V_115 :
V_70 = F_16 ( V_92 [ 0 ] . V_110 , & V_73 -> V_34 ) ;
if ( V_70 == 0 )
V_73 -> V_61 |= V_116 ;
break;
case V_117 :
V_73 -> V_52 = F_37 ( V_92 [ 0 ] . V_110 ,
V_92 [ 0 ] . V_112 - V_92 [ 0 ] . V_110 ,
V_94 ) ;
break;
case V_118 :
...
V_70 = F_38 ( V_73 -> V_53 , V_92 [ 0 ] . V_110 ) ;
if ( V_70 < 0 )
goto V_84;
break;
case V_119 :
...
V_70 = F_21 ( V_73 -> V_53 , V_92 [ 0 ] . V_110 ) ;
if ( V_70 < 0 )
goto V_84;
break;
case V_120 :
...
V_73 -> V_101 = F_39 ( V_106 * 1000 ) ;
break;
case V_124 :
if ( V_106 < 0 || V_106 > V_122 / 1000 ) {
F_6 ( L_48 ) ;
V_70 = - V_71 ;
goto V_84;
}
V_73 -> V_99 = F_39 ( V_106 * 1000 ) ;
break;
case V_125 :
V_73 -> V_61 &= ~ V_126 ;
break;
...
int F_41 ( struct V_140 * V_141 , struct V_31 * V_32 )
{
struct V_38 * V_73 = V_32 -> V_42 ;
T_1 V_142 = V_141 -> V_143 ;
if ( V_73 -> V_52 ) {
F_42 ( V_141 , L_49 ) ;
F_43 ( V_141 , V_73 -> V_52 , L_50 ) ;
F_44 ( V_141 , ',' ) ;
}
if ( V_73 -> V_53 )
F_42 ( V_141 , L_51 ) ;
if ( V_73 -> V_61 & V_116 )
F_45 ( V_141 , L_52 , & V_73 -> V_34 ) ;
if ( V_73 -> V_61 & V_126 )
F_42 ( V_141 , L_53 ) ;
if ( V_73 -> V_61 & V_129 )
F_42 ( V_141 , L_54 ) ;
...
F_45 ( V_141 , L_60 ,
F_46 ( V_73 -> V_97 ) / 1000 ) ;
if ( V_141 -> V_143 != V_142 )
V_141 -> V_143 -- ;
return 0 ;
}
T_4 F_47 ( struct V_31 * V_32 )
{
return V_32 -> V_58 . V_144 -> V_145 ;
}
...
V_147 ;
if ( F_51 ( V_32 , V_158 ) )
V_149 = & V_32 -> V_42 -> V_113 ;
F_52 ( & V_32 -> V_50 , V_149 ) ;
V_70 = F_53 ( & V_32 -> V_58 , V_32 ) ;
if ( V_70 < 0 )
goto V_159;
V_70 = F_54 ( & V_32 -> V_160 , V_32 ) ;
if ( V_70 < 0 )
goto V_161;
return V_32 ;
V_161:
...
{
return V_32 -> V_58 . V_59 && V_32 -> V_58 . V_59 -> V_163 &&
V_32 -> V_160 . V_164 && V_32 -> V_160 . V_164 -> V_163 ;
}
int F_62 ( struct V_31 * V_32 , unsigned long V_165 )
{
unsigned long V_166 = V_32 -> V_42 -> V_99 ;
long V_70 ;
V_70 = F_63 ( & V_32 -> V_58 ) ;
if ( V_70 < 0 )
return V_70 ;
while ( ! F_61 ( V_32 ) ) {
if ( V_166 && F_64 ( V_167 , V_165 + V_166 ) )
return - V_168 ;
F_17 ( L_63 ) ;
V_70 = F_65 ( V_32 -> V_151 ,
F_61 ( V_32 ) || ( V_32 -> V_152 < 0 ) ,
F_66 ( V_166 ) ) ;
if ( V_70 < 0 )
return V_70 ;
if ( V_32 -> V_152 < 0 )
