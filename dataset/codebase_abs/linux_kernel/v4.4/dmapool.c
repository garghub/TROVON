...
int V_43 ;
T_5 * V_44 = V_23 ;
for ( V_43 = sizeof( V_10 -> V_32 ) ; V_43 < V_12 -> V_7 ; V_43 ++ ) {
if ( V_44 [ V_43 ] == V_37 )
continue;
if ( V_12 -> V_2 )
F_33 ( V_12 -> V_2 ,
...
F_40 ( L_4 ,
V_12 -> V_19 , V_23 ) ;
F_41 ( V_38 , L_5 , V_45 , 16 , 1 ,
V_44 , V_12 -> V_7 , 1 ) ;
break;
}
}
if ( ! ( V_35 & V_42 ) )
memset ( V_23 , V_46 , V_12 -> V_7 ) ;
#endif
F_39 ( & V_12 -> V_17 , V_40 ) ;
if ( V_35 & V_42 )
...
static struct V_9 * F_42 ( struct V_11 * V_12 , T_4 V_36 )
{
struct V_9 * V_10 ;
F_4 (page, &pool->page_list, page_list) {
if ( V_36 < V_10 -> V_36 )
...
void F_43 ( struct V_11 * V_12 , void * V_34 , T_4 V_36 )
{
struct V_9 * V_10 ;
unsigned long V_40 ;
unsigned int V_32 ;
...
{
unsigned int V_47 = V_10 -> V_32 ;
while ( V_47 < V_12 -> V_20 ) {
if ( V_47 != V_32 ) {
V_47 = * ( int * ) ( V_10 -> V_34 + V_47 ) ;
continue;
}
F_39 ( & V_12 -> V_17 , V_40 ) ;
if ( V_12 -> V_2 )
...
static void F_44 ( struct V_1 * V_2 , void * V_48 )
{
struct V_11 * V_12 = * (struct V_11 * * ) V_48 ;
F_30 ( V_12 ) ;
}
static int F_45 ( struct V_1 * V_2 , void * V_48 , void * V_49 )
{
return * (struct V_11 * * ) V_48 == V_49 ;
}
struct V_11 * F_46 ( const char * V_19 , struct V_1 * V_2 ,
T_2 V_7 , T_2 V_21 , T_2 V_20 )
{
struct V_11 * * V_50 , * V_12 ;
V_50 = F_47 ( F_44 , sizeof( * V_50 ) , V_25 ) ;
if ( ! V_50 )
return NULL ;
V_12 = * V_50 = F_8 ( V_19 , V_2 , V_7 , V_21 , V_20 ) ;
if ( V_12 )
F_48 ( V_2 , V_50 ) ;
else
F_49 ( V_50 ) ;
