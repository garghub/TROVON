...
static int F_66 ( struct V_78 * V_12 , struct V_123 * V_123 ,
...
switch( V_70 ) {
case V_127 :
V_108 = F_67 ( ( void V_128 * ) V_124 , V_34 -> V_38 ,
strlen ( V_34 -> V_38 ) + 1 ) ? - V_129 : 0 ;
break;
case V_130 :
V_108 = F_68 ( 0 , ( int V_128 * ) V_124 ) ;
break;
case V_131 :
if ( F_69 ( V_125 , ( int V_128 * ) V_124 ) ) {
V_108 = - V_129 ;
break;
}
V_3 -> V_132 = V_125 ;
...
default:
V_108 = F_71 ( V_12 , V_123 , V_70 , V_124 ) ;
}
F_35 ( V_3 ) ;
return V_108 ;
}
static long F_72 ( struct V_78 * V_12 , struct V_123 * V_123 ,
unsigned int V_70 , unsigned long V_124 )
{
switch ( V_70 ) {
case V_127 :
...
case V_131 :
case V_134 :
return F_66 ( V_12 , V_123 , V_70 ,
( unsigned long ) F_73 ( V_124 ) ) ;
}
return - V_135 ;
}
...
static void F_78 ( struct V_2 * V_3 , unsigned char V_106 )
{
unsigned char * V_87 ;
if ( V_3 -> V_99 != 3 ) {
