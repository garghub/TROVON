...
static int F_33 ( struct V_5 * V_6 , struct V_2 * V_3 )
{
struct V_19 * V_20 = F_7 ( V_6 ) ;
struct V_40 * V_41 ;
struct V_1 * V_1 ;
...
if ( ! V_1 )
return - V_33 ;
* F_34 ( V_3 , 1 ) = F_35 ( V_3 ) -> V_42 ;
switch ( F_35 ( V_3 ) -> V_42 ) {
case V_43 :
...
V_41 -> V_47 = 0 ;
V_41 -> V_48 = 0 ;
V_41 -> V_49 = F_36 ( V_3 -> V_50 ) ;
V_23 = F_37 ( V_20 -> V_34 , 0x00 ) ;
F_38 ( V_1 , V_20 -> V_34 , V_23 , ( void * ) V_41 ,
V_3 -> V_20 , V_3 -> V_50 , F_1 , V_3 ) ;
V_6 -> V_14 . V_51 ++ ;
break;
case V_52 :
V_23 = F_39 ( V_20 -> V_34 , 0x02 ) ;
F_24 ( V_1 , V_20 -> V_34 , V_23 ,
V_3 -> V_20 , V_3 -> V_50 , F_1 , V_3 ) ;
V_6 -> V_14 . V_53 ++ ;
break;
...
static int F_40 ( struct V_5 * V_6 , bool V_57 )
{
const T_1 V_38 [] = { 0x00 , V_57 } ;
struct V_2 * V_3 ;
F_2 ( L_4 , V_6 -> V_8 ) ;
if ( ! F_3 ( V_11 , & V_6 -> V_12 ) )
return - V_58 ;
...
static int F_41 ( struct V_59 * V_60 , const struct V_61 * V_62 )
{
struct V_19 * V_20 ;
struct V_5 * V_6 ;
int V_21 ;
F_2 ( L_8 , V_60 , V_62 ) ;
if ( V_60 -> V_63 -> V_64 . V_65 != 0 )
return - V_66 ;
V_20 = F_42 ( & V_60 -> V_7 , sizeof( * V_20 ) , V_32 ) ;
if ( ! V_20 )
return - V_33 ;
V_20 -> V_34 = F_43 ( V_60 ) ;
F_44 ( & V_20 -> V_37 ) ;
