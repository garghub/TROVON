...
static int F_55 ( char * V_5 , struct V_51 * V_52 )
{
int V_12 ;
...
int F_58 ( struct V_51 * V_52 , T_2 V_69 , const void * V_70 )
{
char V_5 [ 128 ] ;
struct V_6 * V_7 ;
int V_71 ;
...
F_60 ( & V_7 -> V_14 ) ;
#ifdef F_61
F_62 ( & V_7 -> V_28 , sizeof( struct V_29 ) , 32 ) ;
F_62 ( & V_7 -> V_37 , sizeof( struct V_38 ) , 32 ) ;
F_62 ( & V_7 -> V_45 , sizeof( struct V_16 ) , 16 ) ;
#endif
}
