...
void F_28 ( struct V_5 * V_6 , V_10 V_47 ,
struct V_19 * V_21 )
{
struct V_7 * V_8 = F_3 ( V_6 ) ;
switch ( V_47 ) {
...
if ( F_14 ( V_20 , V_28 , V_8 -> V_49 . V_50 -> V_25 ,
V_8 -> V_49 . V_50 -> V_3 ) ) {
F_15 ( V_20 ) ;
V_18 = - V_29 ;
goto V_27;
...
if ( ! V_20 )
return - V_26 ;
if ( F_14 ( V_20 , V_28 , sizeof( V_6 -> V_55 ) ,
& V_6 -> V_55 ) ) {
F_15 ( V_20 ) ;
return - V_29 ;
}
