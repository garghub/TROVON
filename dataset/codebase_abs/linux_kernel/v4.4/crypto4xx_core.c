...
V_151 -> V_152 . V_19 . V_194 = 0 ;
V_92 -> V_159 = 0xffffffff ;
V_92 -> V_158 = 0 ;
}
if ( V_77 -> V_189 || F_53 ( V_144 ) ) {
V_92 -> V_166 = 0 ;
V_92 -> V_148 = 0xffffffff ;
V_92 -> V_160 = 0 ;
V_92 -> V_155 = V_144 ;
V_151 -> V_152 . V_19 . V_198 = 0 ;
if ( V_77 -> V_189 )
V_142 -> V_199 = F_54 ( ( void * ) V_144 ) ;
else
V_142 -> V_199 = ( T_1 ) F_33 ( V_2 -> V_80 -> V_81 ,
F_34 ( V_144 ) , V_144 -> V_139 ,
V_144 -> V_138 , V_149 ) ;
} else {
struct V_125 * V_200 = NULL ;
T_1 V_201 = V_186 ;
V_140 = V_181 ;
V_151 -> V_152 . V_19 . V_198 = 1 ;
V_92 -> V_166 = 1 ;
V_92 -> V_155 = V_144 ;
V_92 -> V_148 = V_186 ;
V_92 -> V_160 = V_160 ;
V_200 = F_29 ( V_2 , & V_136 , V_201 ) ;
V_142 -> V_199 = V_136 ;
V_200 -> V_202 . V_196 = 0 ;
V_200 -> V_202 . V_203 = 1 ;
V_110 = 0 ;
...
V_151 -> V_204 . V_19 . V_205 = 0 ;
V_142 -> V_175 . V_18 = V_77 -> V_175 ;
V_142 -> V_176 . V_18 = 0x00400000 | ( V_77 -> V_206 << 24 ) | V_181 ;
V_92 -> V_114 = V_207 ;
F_55 () ;
F_2 ( 1 , V_2 -> V_16 + V_208 ) ;
return - V_209 ;
}
static int F_56 ( struct V_210 * V_165 )
{
struct V_211 * V_212 = V_165 -> V_213 ;
struct V_214 * V_215 = F_57 ( V_212 ) ;
...
V_77 -> V_86 = 0 ;
V_77 -> V_87 = 0 ;
switch ( V_212 -> V_216 & V_217 ) {
default:
V_165 -> V_218 . V_219 = sizeof( struct V_76 ) ;
break;
case V_220 :
F_58 ( F_59 ( V_165 ) ,
sizeof( struct V_76 ) ) ;
...
static void F_60 ( struct V_210 * V_165 )
{
struct V_76 * V_77 = F_39 ( V_165 ) ;
F_8 ( V_77 ) ;
F_10 ( V_77 ) ;
}
int F_61 ( struct V_1 * V_221 ,
struct V_222 * V_211 ,
int V_223 )
{
struct V_214 * V_212 ;
...
V_212 = F_12 ( sizeof( struct V_214 ) , V_96 ) ;
if ( ! V_212 )
return - V_84 ;
V_212 -> V_212 = V_211 [ V_91 ] ;
V_212 -> V_2 = V_221 ;
switch ( V_212 -> V_212 . type ) {
case V_220 :
V_224 = F_62 ( & V_212 -> V_212 . V_225 . V_226 ) ;
break;
default:
V_224 = F_63 ( & V_212 -> V_212 . V_225 . V_227 ) ;
break;
}
if ( V_224 ) {
F_64 ( & V_212 -> V_228 ) ;
...
F_65 ( & V_212 -> V_228 , & V_221 -> V_229 ) ;
}
}
return 0 ;
}
static void F_66 ( struct V_1 * V_221 )
{
struct V_214 * V_212 , * V_106 ;
F_67 (alg, tmp, &sec_dev->alg_list, entry) {
F_64 ( & V_212 -> V_228 ) ;
switch ( V_212 -> V_212 . type ) {
case V_220 :
F_68 ( & V_212 -> V_212 . V_225 . V_226 ) ;
break;
default:
F_69 ( & V_212 -> V_212 . V_225 . V_227 ) ;
}
F_14 ( V_212 ) ;
}
}
static void F_70 ( unsigned long V_230 )
{
struct V_81 * V_2 = (struct V_81 * ) V_230 ;
struct V_173 * V_80 = F_71 ( V_2 ) ;
struct V_92 * V_92 ;
struct V_94 * V_142 ;
T_1 V_231 ;
while ( V_80 -> V_2 -> V_107 != V_80 -> V_2 -> V_108 ) {
V_231 = V_80 -> V_2 -> V_108 ;
V_92 = V_80 -> V_2 -> V_95 +
sizeof( struct V_92 ) * V_231 ;
V_142 = V_80 -> V_2 -> V_93 + sizeof( struct V_94 ) * V_231 ;
if ( ( V_92 -> V_114 == V_207 ) &&
V_142 -> V_175 . V_19 . V_232 &&
! V_142 -> V_175 . V_19 . V_233 ) {
V_142 -> V_175 . V_19 . V_232 = 0 ;
F_42 ( V_80 -> V_2 , V_231 ) ;
F_16 ( V_80 -> V_2 , V_231 ) ;
V_92 -> V_114 = V_115 ;
} else {
...
static T_4 F_72 ( int V_234 , void * V_230 )
{
struct V_81 * V_2 = (struct V_81 * ) V_230 ;
struct V_173 * V_80 = F_71 ( V_2 ) ;
if ( ! V_80 -> V_2 -> V_16 )
...
static int F_74 ( struct V_237 * V_238 )
{
int V_224 ;
struct V_239 V_240 ;
struct V_81 * V_2 = & V_238 -> V_2 ;
struct V_173 * V_80 ;
V_224 = F_75 ( V_238 -> V_2 . V_241 , 0 , & V_240 ) ;
if ( V_224 )
return - V_242 ;
if ( F_76 ( NULL , NULL , L_1 ) ) {
F_77 ( V_243 , V_244 ,
F_78 ( V_243 , V_244 ) | V_245 ) ;
F_77 ( V_243 , V_244 ,
F_78 ( V_243 , V_244 ) & ~ V_245 ) ;
} else if ( F_76 ( NULL , NULL ,
L_2 ) ) {
F_77 ( V_243 , V_246 ,
F_78 ( V_243 , V_246 ) | V_247 ) ;
F_77 ( V_243 , V_246 ,
F_78 ( V_243 , V_246 ) & ~ V_247 ) ;
} else if ( F_76 ( NULL , NULL ,
L_3 ) ) {
F_77 ( V_243 , V_248 ,
F_78 ( V_243 , V_248 ) | V_249 ) ;
F_77 ( V_243 , V_248 ,
F_78 ( V_243 , V_248 ) & ~ V_249 ) ;
} else {
F_79 ( V_250 L_4 ) ;
...
if ( V_224 )
goto V_255;
F_83 ( & V_80 -> V_235 , F_70 ,
( unsigned long ) V_2 ) ;
V_80 -> V_234 = F_84 ( V_238 -> V_2 . V_241 , 0 ) ;
V_224 = F_85 ( V_80 -> V_234 , F_72 , 0 ,
V_80 -> V_2 -> V_256 , V_2 ) ;
if ( V_224 )
goto V_257;
V_80 -> V_2 -> V_16 = F_86 ( V_238 -> V_2 . V_241 , 0 ) ;
if ( ! V_80 -> V_2 -> V_16 ) {
F_87 ( V_2 , L_5 ) ;
V_224 = - V_84 ;
goto V_258;
...
static int F_92 ( struct V_237 * V_238 )
{
struct V_81 * V_2 = & V_238 -> V_2 ;
struct V_173 * V_80 = F_71 ( V_2 ) ;
F_89 ( V_80 -> V_234 , V_2 ) ;
