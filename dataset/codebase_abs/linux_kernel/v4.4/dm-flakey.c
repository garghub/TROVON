...
if ( V_7 )
goto V_30;
V_7 = F_9 ( V_6 , V_24 , F_10 ( V_6 -> V_34 ) , & V_4 -> V_35 ) ;
if ( V_7 ) {
V_6 -> error = L_22 ;
goto V_30;
}
...
struct V_65 * * V_44 , T_3 * V_66 )
{
struct V_3 * V_4 = V_6 -> V_40 ;
* V_44 = V_4 -> V_35 -> V_44 ;
if ( V_4 -> V_31 ||
V_6 -> V_67 != F_31 ( ( * V_44 ) -> V_68 ) >> V_69 )
return 1 ;
return 0 ;
}
static int F_32 ( struct V_5 * V_6 , T_4 V_70 , void * V_47 )
{
struct V_3 * V_4 = V_6 -> V_40 ;
return V_70 ( V_6 , V_4 -> V_35 , V_4 -> V_31 , V_6 -> V_67 , V_47 ) ;
}
