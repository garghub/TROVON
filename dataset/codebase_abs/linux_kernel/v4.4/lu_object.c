...
{
if ( V_171 -> V_129 ++ == 0 && V_171 -> V_125 -> V_172 != NULL )
...
F_4 ( V_171 -> V_129 > 0 ) ;
if ( -- V_171 -> V_129 == 0 && V_171 -> V_125 -> V_130 != NULL )
...
struct V_39 * V_20 ;
F_34 ( V_2 , V_10 , ~ 0 ) ;
for ( V_44 = V_8 ; V_44 != NULL ; V_44 = V_20 ) {
...
{
if ( V_196 -> V_198 != NULL && V_196 -> V_198 [ V_197 ] != NULL ) {
struct V_184 * V_84 ;
V_84 = V_190 [ V_197 ] ;
F_4 ( V_84 != NULL ) ;
F_4 ( V_84 -> V_186 != NULL ) ;
...
V_84 -> V_187 |= V_205 ;
F_95 ( & V_189 ) ;
F_28 (ctx, &lu_context_remembered,
lc_remember)
...
{
int V_73 ;
F_138 ( V_196 -> V_198 != NULL ) ;
for ( V_73 = 0 ; V_73 < F_46 ( V_190 ) ; ++ V_73 ) {
struct V_184 * V_84 ;
V_84 = V_190 [ V_73 ] ;
if ( V_196 -> V_198 [ V_73 ] == NULL && V_84 != NULL &&
( V_84 -> V_187 & V_196 -> V_199 ) &&
! ( V_84 -> V_187 & V_205 ) ) {
void * V_206 ;
F_138 ( V_84 -> V_185 != NULL ) ;
...
F_138 ( V_196 -> V_203 == V_204 ) ;
V_196 -> V_203 = V_217 ;
if ( V_196 -> V_199 & V_208 && V_196 -> V_198 != NULL ) {
for ( V_73 = 0 ; V_73 < F_46 ( V_190 ) ; ++ V_73 ) {
if ( V_196 -> V_198 [ V_73 ] != NULL ) {
struct V_184 * V_84 ;
V_84 = V_190 [ V_73 ] ;
F_4 ( V_84 != NULL ) ;
if ( V_84 -> V_207 != NULL )
...
for ( V_50 = 0 ; V_255 -> V_256 != NULL ; ++ V_255 ) {
