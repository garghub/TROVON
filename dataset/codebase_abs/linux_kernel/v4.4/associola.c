...
static struct V_118 * F_119 ( struct V_118 * V_251 ,
struct V_118 * V_252 )
{
...
static struct V_118 * F_121 ( struct V_118 * V_254 ,
struct V_118 * V_255 )
{
T_8 V_256 , V_257 ;
...
V_260 = V_259 ;
if ( V_259 == NULL ) {
V_259 = F_121 ( V_2 -> V_69 . V_147 , V_261 ) ;
V_260 = V_259 ;
}
...
void F_128 ( struct V_1 * V_2 , unsigned int V_268 )
{
struct V_164 * V_269 ;
struct V_270 * V_271 ;
if ( V_2 -> V_272 ) {
...
int V_274 = F_75 ( V_2 -> V_39 , V_2 -> V_273 ) ;
V_2 -> V_67 += V_274 ;
V_2 -> V_273 -= V_274 ;
}
F_28 ( L_8 ,
...
return F_135 ( & V_2 -> V_15 . V_18 , V_288 , V_286 ,
...
F_138 ( V_8 ) ;
F_53 ( & V_138 ) ;
V_291 = F_139 ( & V_139 , V_2 , 1 , 0 , V_292 ) ;
F_55 ( & V_138 ) ;
if ( V_290 )
F_140 () ;
if ( V_291 < 0 )
...
void F_144 ( const struct V_1 * V_2 )
{
struct V_164 * V_297 ;
struct V_164 * V_295 ;
F_82 (ack, tmp, &asoc->asconf_ack_list,
