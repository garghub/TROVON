...
F_87 ( & V_2 -> V_49 [ V_70 ] ) ;
V_128 = strlen ( F_88 ( V_2 -> V_11 ) ) + 16 ;
V_86 = F_75 ( V_2 -> V_11 , V_128 , V_82 ) ;
if ( ! V_86 )
return - V_83 ;
snprintf ( V_86 , V_128 , L_20 , F_88 ( V_2 -> V_11 ) , V_70 ) ;
...
V_2 -> V_132 = F_91 ( & V_133 , V_11 , V_2 ) ;
if ( F_79 ( V_2 -> V_132 ) ) {
F_92 ( & V_2 -> V_16 ) ;
return F_80 ( V_2 -> V_132 ) ;
}
V_2 -> V_134 = V_135 ;
V_2 -> V_134 . V_4 = V_2 -> V_16 . V_4 ;
V_2 -> V_134 . V_136 = & V_2 -> V_16 ;
F_93 ( V_2 -> V_132 , & V_2 -> V_134 ) ;
return 0 ;
}
