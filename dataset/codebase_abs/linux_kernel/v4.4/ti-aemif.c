...
if ( V_48 == NULL )
return 0 ;
V_13 = F_31 ( V_8 , sizeof( * V_13 ) , V_59 ) ;
if ( ! V_13 )
return - V_60 ;
F_32 ( V_2 , V_13 ) ;
V_13 -> V_4 = F_33 ( V_8 , NULL ) ;
if ( F_34 ( V_13 -> V_4 ) ) {
F_6 ( V_8 , L_17 ) ;
return F_35 ( V_13 -> V_4 ) ;
}
F_36 ( V_13 -> V_4 ) ;
V_13 -> V_24 = F_37 ( V_13 -> V_4 ) / V_61 ;
if ( F_38 ( V_48 , L_18 ) )
V_13 -> V_30 = 2 ;
V_55 = F_39 ( V_2 , V_62 , 0 ) ;
V_13 -> V_44 = F_40 ( V_8 , V_55 ) ;
if ( F_34 ( V_13 -> V_44 ) ) {
V_52 = F_35 ( V_13 -> V_44 ) ;
goto error;
}
