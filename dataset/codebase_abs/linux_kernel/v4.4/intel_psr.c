...
if ( F_34 ( V_5 ) &&
F_3 ( F_36 ( V_19 -> V_23 -> V_22 ) ) &
V_99 ) {
F_35 ( L_3 ) ;
return false ;
}
if ( F_34 ( V_5 ) &&
V_19 -> V_23 -> V_18 . V_100 . V_101 & V_102 ) {
F_35 ( L_4 ) ;
return false ;
}
...
F_15 ( V_1 ) ;
if ( V_8 -> V_52 . V_85 ) {
if ( V_20 -> V_23 -> V_108 > 3200 ||
V_20 -> V_23 -> V_109 > 2000 )
V_8 -> V_52 . V_85 = false ;
else
F_14 ( V_1 ) ;
}
...
static void F_54 ( struct V_116 * V_115 )
{
struct V_7 * V_8 =
F_55 ( V_115 , F_56 ( * V_8 ) , V_52 . V_115 . V_115 ) ;
