...
static int F_121 ( struct V_200 * V_219 ,
struct V_220 * V_8 )
{
struct V_4 * V_5 = F_122 ( V_219 ) ;
int V_221 ;
V_5 -> V_8 = V_8 ;
if ( ! F_106 ( V_5 -> V_205 ) ) {
V_221 = F_123 ( V_5 -> V_205 -> V_222 ,
& V_5 -> V_75 ) ;
if ( V_221 ) {
F_20 ( V_5 -> V_87 , L_68 ) ;
goto V_223;
...
static void F_124 ( struct V_4 * V_5 , struct V_220 * V_8 )
{
int V_45 ;
...
static int F_125 ( struct V_200 * V_219 )
{
struct V_4 * V_5 = F_122 ( V_219 ) ;
F_124 ( V_5 , NULL ) ;
F_110 ( V_5 ) ;
V_5 -> V_8 = NULL ;
if ( ! F_106 ( V_5 -> V_205 ) )
return F_123 ( V_5 -> V_205 -> V_222 , NULL ) ;
return 0 ;
}
...
if ( F_60 ( F_38 ( V_42 ) ) )
goto V_230;
V_227 . V_226 [ V_45 ] = F_10 ( V_42 , V_153 ) ;
}
V_228 = ! F_38 ( V_42 ) ;
while ( ! F_38 ( V_42 ) ) {
...
F_127 ( V_227 . V_225 . V_233 ) , F_127 ( V_227 . V_225 . V_234 ) ,
F_127 ( V_227 . V_225 . V_235 ) ) ;
if ( F_60 ( V_228 ) )
goto V_230;
if ( V_227 . V_225 . V_231 & V_147 )
F_41 ( V_5 , V_179 ) ;
else
F_41 ( V_5 , V_180 ) ;
F_34 ( V_42 , V_54 | V_60 ) ;
F_67 ( & V_42 -> V_146 , V_143 ) ;
V_45 = V_5 -> V_8 -> V_236 ( & V_5 -> V_75 , & V_227 . V_225 ) ;
F_71 ( & V_42 -> V_146 , V_143 ) ;
if ( V_45 < 0 )
goto V_230;
V_181:
...
F_43 ( V_42 , L_71 ,
F_10 ( V_42 , V_53 ) , V_45 ) ;
F_34 ( V_42 , V_56 | V_237 ) ;
F_41 ( V_5 , V_188 ) ;
goto V_181;
}
static void F_128 ( struct V_4 * V_5 , int V_238 , int V_239 )
{
T_1 V_240 ;
struct V_41 * V_42 = & V_5 -> V_41 [ 0 ] ;
...
if ( ! F_6 ( & V_42 -> V_49 ) )
V_44 = F_77 ( V_42 -> V_49 . V_150 , struct V_43 , V_49 ) ;
V_240 = F_10 ( V_42 , V_53 ) ;
F_43 ( V_42 , L_72 ,
F_42 ( V_5 ) , V_44 , V_240 , F_10 ( V_42 , V_66 ) ,
( V_238 << 1 | V_239 ) ) ;
if ( V_240 & V_57 ) {
F_43 ( V_42 , L_73 ) ;
F_76 ( V_42 , - V_241 ) ;
...
V_44 . V_235 = 0 ;
F_41 ( V_5 , V_177 ) ;
V_5 -> V_8 -> V_236 ( & V_5 -> V_75 , & V_44 ) ;
F_34 ( & V_5 -> V_41 [ 0 ] , V_246 ) ;
}
...
static void F_131 ( int V_249 , struct V_4 * V_5 )
{
int V_45 ;
struct V_41 * V_42 ;
T_1 V_250 = F_3 ( V_5 , V_33 ) & V_251 ;
T_1 V_252 = F_3 ( V_5 , V_34 ) & V_253 ;
if ( V_250 & V_254 ) {
V_5 -> V_41 [ 0 ] . V_36 . V_65 ++ ;
F_30 ( V_5 , V_33 , F_132 ( 0 , V_254 ) ) ;
F_128 ( V_5 , ! ! ( V_250 & V_255 ) ,
! ! ( V_250 & V_256 ) ) ;
}
V_250 >>= 2 ;
for ( V_45 = 1 ; V_250 != 0 && V_45 < 16 ; V_250 >>= 2 , V_45 ++ ) {
if ( ! ( V_250 & V_254 ) )
continue;
F_30 ( V_5 , V_33 , F_132 ( V_45 , V_254 ) ) ;
...
for ( V_45 = 16 ; V_252 != 0 && V_45 < 24 ; V_252 >>= 2 , V_45 ++ ) {
F_30 ( V_5 , V_34 , F_132 ( V_45 - 16 , V_254 ) ) ;
if ( ! ( V_252 & V_254 ) )
continue;
F_57 ( V_45 >= F_133 ( V_5 -> V_41 ) ) ;
if ( V_45 < F_133 ( V_5 -> V_41 ) ) {
...
V_5 -> V_36 . V_38 ++ ;
if ( V_5 -> V_75 . V_171 != V_172
&& V_5 -> V_8 && V_5 -> V_8 -> V_258 )
V_5 -> V_8 -> V_258 ( & V_5 -> V_75 ) ;
F_44 ( V_5 ) ;
}
...
V_5 -> V_36 . V_39 ++ ;
if ( V_5 -> V_75 . V_171 != V_172
&& V_5 -> V_8 && V_5 -> V_8 -> V_260 )
V_5 -> V_8 -> V_260 ( & V_5 -> V_75 ) ;
}
static void F_136 ( struct V_4 * V_5 )
{
unsigned V_89 , V_90 , V_95 , V_261 ;
T_1 V_106 = F_3 ( V_5 , V_14 ) ;
F_30 ( V_5 , V_34 , V_262 ) ;
V_5 -> V_36 . V_40 ++ ;
...
memset ( & V_5 -> V_36 , 0 , sizeof V_5 -> V_36 ) ;
F_76 ( V_42 , - V_229 ) ;
F_34 ( V_42 , V_237 | V_60 ) ;
F_44 ( V_5 ) ;
}
static T_4 F_139 ( int V_249 , void * V_264 )
{
struct V_4 * V_5 = V_264 ;
T_1 V_250 = F_3 ( V_5 , V_33 ) ;
T_1 V_252 = F_3 ( V_5 , V_34 ) ;
T_1 V_106 = F_3 ( V_5 , V_14 ) ;
T_1 V_265 ;
F_140 ( V_5 -> V_87 , L_80
L_81 , V_250 , V_252 , V_106 ) ;
...
static int F_141 ( struct V_267 * V_268 )
{
struct V_269 * V_270 ;
struct V_4 * V_5 = & V_271 ;
int V_221 = 0 , V_272 ;
struct V_273 * V_274 = F_142 ( & V_268 -> V_87 ) ;
unsigned long V_275 ;
if ( V_274 ) {
V_275 = V_274 -> V_276 ? V_277 : 0 ;
V_272 = V_274 -> V_278 ;
if ( F_143 ( V_272 ) ) {
V_221 = F_144 ( & V_268 -> V_87 , V_272 ,
V_275 ,
L_82 ) ;
if ( V_221 )
return V_221 ;
V_5 -> V_195 = F_145 ( V_274 -> V_278 ) ;
}
V_5 -> V_196 = V_274 -> V_196 ;
} else {
V_5 -> V_195 = F_146 ( & V_268 -> V_87 , NULL , V_279 ) ;
}
V_270 = F_147 ( V_268 , V_280 , 0 ) ;
V_5 -> V_270 = F_148 ( & V_268 -> V_87 , V_270 ) ;
if ( F_17 ( V_5 -> V_270 ) )
return F_149 ( V_5 -> V_270 ) ;
V_5 -> V_249 = F_150 ( V_268 , 0 ) ;
if ( V_5 -> V_249 < 0 )
return V_5 -> V_249 ;
V_5 -> V_87 = & V_268 -> V_87 ;
V_5 -> V_205 = F_151 ( V_281 ) ;
if ( F_17 ( V_5 -> V_195 ) ) {
F_20 ( & V_268 -> V_87 , L_83 ,
F_149 ( V_5 -> V_195 ) ) ;
return F_149 ( V_5 -> V_195 ) ;
}
if ( V_5 -> V_195 )
F_152 ( V_5 -> V_195 , 0 ) ;
V_5 -> V_209 = F_153 ( & V_268 -> V_87 , NULL ) ;
if ( F_17 ( V_5 -> V_209 ) )
return F_149 ( V_5 -> V_209 ) ;
V_221 = F_154 ( V_5 -> V_209 ) ;
if ( V_221 )
return V_221 ;
V_5 -> V_204 = 0 ;
V_282 = V_5 ;
F_155 ( V_268 , V_5 ) ;
F_115 ( V_5 ) ;
V_221 = F_156 ( & V_268 -> V_87 , V_5 -> V_249 , F_139 ,
V_283 , V_11 , V_5 ) ;
if ( V_221 != 0 ) {
F_20 ( V_5 -> V_87 , L_84 ,
V_11 , V_5 -> V_249 , V_221 ) ;
goto V_284;
}
V_221 = F_157 ( & V_268 -> V_87 , & V_5 -> V_75 ) ;
if ( V_221 )
goto V_284;
F_15 ( V_5 ) ;
if ( F_105 ( V_5 ) )
...
static int F_159 ( struct V_267 * V_264 )
{
struct V_4 * V_5 = F_160 ( V_264 ) ;
F_161 ( & V_5 -> V_75 ) ;
F_21 ( V_5 ) ;
F_162 ( V_5 -> V_205 ) ;
V_5 -> V_205 = NULL ;
...
static void F_163 ( struct V_267 * V_264 )
{
struct V_4 * V_5 = F_160 ( V_264 ) ;
if ( F_3 ( V_5 , V_14 ) & V_24 )
F_110 ( V_5 ) ;
}
static int F_164 ( struct V_267 * V_264 , T_5 V_72 )
{
struct V_4 * V_5 = F_160 ( V_264 ) ;
struct V_41 * V_42 ;
V_42 = & V_5 -> V_41 [ 0 ] ;
V_5 -> V_240 = F_10 ( V_42 , V_53 ) ;
F_110 ( V_5 ) ;
V_5 -> V_285 = V_5 -> V_199 ;
F_100 ( V_5 , 0 ) ;
if ( V_5 -> V_8 )
V_5 -> V_8 -> V_286 ( & V_5 -> V_75 ) ;
return 0 ;
}
static int F_165 ( struct V_267 * V_264 )
{
struct V_4 * V_5 = F_160 ( V_264 ) ;
struct V_41 * V_42 ;
V_42 = & V_5 -> V_41 [ 0 ] ;
F_36 ( V_42 , V_53 , V_5 -> V_240 & ( V_56 | V_58 ) ) ;
F_100 ( V_5 , V_5 -> V_285 ) ;
if ( F_105 ( V_5 ) )
F_109 ( V_5 ) ;
F_166 () ;
