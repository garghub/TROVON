...
static
int F_102 ( struct V_131 * V_132 , int V_133 ,
void T_5 * V_134 , T_6 * V_135 , T_7 * V_136 )
{
int V_46 ;
V_46 = F_103 ( V_132 , V_133 , V_134 , V_135 , V_136 ) ;
...
{
int V_46 ;
V_46 = F_105 ( V_137 , F_106 ( V_137 ) ) ;
if ( V_46 < 0 )
return V_46 ;
#ifdef F_107
V_138 = F_108 ( & V_139 , L_1 , V_140 ) ;
if ( V_138 == NULL ) {
F_109 ( V_141
L_2 ) ;
F_110 ( V_137 , F_106 ( V_137 ) ) ;
return - V_142 ;
}
#endif
F_111 ( V_143 , & V_144 ) ;
