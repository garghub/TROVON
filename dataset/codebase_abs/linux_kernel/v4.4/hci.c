...
* F_7 ( V_28 , 1 ) = V_31 ;
if ( V_29 > 0 )
memcpy ( F_8 ( V_28 , V_29 ) , V_23 + V_9 , V_29 ) ;
...
F_35 (&ndev->hci_dev->rx_hcp_frags, frag_skb) {
V_90 = V_89 -> V_29 - V_83 ;
memcpy ( F_8 ( V_88 , V_90 ) , V_89 -> V_23 +
V_83 , V_90 ) ;
}
F_37 ( & V_19 -> V_20 -> V_91 ) ;
} else {
...
int F_39 ( struct V_18 * V_19 , T_1 V_21 )
{
struct V_40 V_23 ;
struct V_25 * V_26 ;
V_26 = V_19 -> V_20 -> V_26 ;
...
static T_1 F_40 ( struct V_18 * V_19 , T_1 V_92 ,
T_1 V_61 , int * V_1 )
{
T_1 V_21 ;
struct V_27 * V_28 ;
...
static int F_41 ( struct V_18 * V_19 , T_1 V_21 )
{
F_21 ( L_4 ) ;
return F_13 ( V_19 , V_55 ,
V_98 , & V_21 , 1 , NULL ) ;
}
int F_42 ( struct V_18 * V_19 , T_1 V_12 , T_1 V_99 ,
const T_1 * V_43 , T_2 V_44 )
{
struct V_47 * V_48 ;
struct V_25 * V_26 ;
...
int F_45 ( struct V_18 * V_19 , T_1 V_12 , T_1 V_99 ,
struct V_27 * * V_28 )
{
struct V_47 * V_48 ;
struct V_25 * V_26 ;
...
struct V_7 * F_49 ( struct V_18 * V_19 )
{
struct V_7 * V_8 ;
V_8 = F_50 ( sizeof( * V_8 ) , V_35 ) ;
if ( ! V_8 )
return NULL ;
F_51 ( & V_8 -> V_91 ) ;
F_52 ( & V_8 -> V_81 , F_27 ) ;
