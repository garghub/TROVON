...
for ( V_70 = 0 ; V_70 < V_69 -> V_73 ; V_70 ++ ) {
if ( V_69 -> V_25 [ V_70 ] -> V_45 < 1 )
continue;
for ( V_71 = 0 ; V_71 < V_69 -> V_25 [ V_70 ] -> V_74 ; V_71 ++ ) {
F_15 ( V_2 , V_69 -> V_25 [ V_70 ] ,
V_69 -> V_25 [ V_70 ] -> V_31 + V_71 ) ;
}
}
}
V_68 = & V_2 -> V_72 [ V_75 ] ;
...
return 0 ;
V_77 = & ( V_2 -> V_72 [ V_41 ] ) ;
V_76 = V_77 -> V_78 [ V_34 -> V_46 ] ;
if ( V_76 ) {
V_76 -> V_25 [ 0 ] -> V_79 [ V_34 -> V_47 ] = 2 ;
F_29 ( V_2 , V_76 , V_10 ) ;
}
return 0 ;
}
static int F_30 ( struct V_1 * V_2 , int V_80 ,
int V_81 , int V_82 )
{
unsigned char * V_83 ;
int error = - V_84 , V_85 = 0 ;
V_83 = F_16 ( V_81 , V_39 ) ;
if ( ! V_83 )
return error ;
do {
...
error = F_1 ( V_2 , V_41 ,
V_83 , V_81 , 1 ) ;
} while ( error >= 0 && V_83 [ 1 ] != V_82 && V_85 ++ < V_86 );
F_18 ( V_83 ) ;
return error < 0 ? error : 0 ;
}
static int F_31 ( struct V_1 * V_2 , T_1 V_87 ,
struct V_32 * V_33 )
{
struct V_14 * V_14 = F_6 ( V_2 ) ;
int V_35 ;
...
V_83 [ 0 ] = 0x03 ;
V_83 [ 1 ] = 0x00 ;
V_35 = F_4 ( V_2 , V_41 , V_83 , 2 ,
3 ) ;
if ( V_35 >= 0 ) {
V_83 [ 0 ] = V_87 == 0 ? 0x05 : 0x06 ;
V_83 [ 1 ] = 0x00 ;
V_35 = F_4 ( V_2 , V_41 ,
V_83 , 2 , 3 ) ;
if ( V_35 >= 0 ) {
...
V_3 [ 2 ] = V_70 ;
memcpy ( V_3 + 3 , V_147 + V_70 * V_148 , V_148 ) ;
...
struct V_1 * V_2 = F_43 ( V_19 , struct V_1 , V_19 ) ;
struct V_14 * V_14 = F_6 ( V_2 ) ;
return snprintf ( V_3 , V_219 , L_12 , V_14 -> V_16 . V_89 ) ;
}
...
struct V_14 * V_14 = F_6 ( V_2 ) ;
T_1 V_82 ;
V_82 = V_14 -> V_134 . V_135 [ V_224 ] ;
if ( V_82 >= 0 && V_82 < 3 )
return snprintf ( V_3 , V_219 , L_13 , V_82 ) ;
else
...
if ( V_16 -> V_226 [ V_70 ] == V_226 ) {
V_16 -> V_226 [ V_70 ] = 0 ;
V_14 -> V_134 . V_135 [ V_70 ] = V_231 ;
if ( V_14 -> V_228 [ V_70 ] . V_209 ) {
F_56 ( V_14 -> V_229 ,
& V_14 -> V_228 [ V_70 ] ) ;
F_18 ( V_14 -> V_228 [ V_70 ] . V_209 ) ;
V_14 -> V_228 [ V_70 ] . V_209 = NULL ;
}
}
}
}
...
if ( ! V_16 -> V_248 || ! V_16 -> V_65 || ! V_16 -> V_251 ) {
F_86 ( V_14 ) ;
return - V_84 ;
}
V_16 -> V_248 -> V_209 = V_16 -> V_253 ;
V_16 -> V_65 -> V_209 = V_16 -> V_254 ;
...
F_95 ( & V_274 -> V_33 ) ;
F_96 ( & V_274 -> V_33 ) ;
snprintf ( V_274 -> V_253 , V_282 , L_21 ,
V_274 -> V_33 . V_209 ) ;
if ( V_274 -> V_33 . type < V_283 ||
V_274 -> V_33 . type > V_53 ) {
snprintf ( V_274 -> V_255 , V_282 , L_22 ,
V_274 -> V_33 . V_209 ) ;
...
goto V_284;
if ( V_274 -> V_33 . V_38 ||
( V_274 -> V_33 . type >= V_285 &&
V_274 -> V_33 . type <= V_53 ) ) {
V_275 -> V_33 =
* ( (struct V_32 * ) V_40 -> V_281 ) ;
V_275 -> V_33 . V_286 = V_287 ;
F_95 ( & V_275 -> V_33 ) ;
V_275 -> V_33 . V_55 = V_275 -> V_33 . V_60 = 4096 ;
F_96 ( & V_275 -> V_33 ) ;
snprintf ( V_275 -> V_254 , V_282 ,
L_23 , V_275 -> V_33 . V_209 ) ;
if ( V_274 -> V_33 . V_38 )
V_275 -> V_33 . V_50 |= V_52 ;
if ( V_274 -> V_33 . type >= V_285 &&
V_274 -> V_33 . type <= V_53 ) {
snprintf ( V_275 -> V_255 , V_282 ,
...
goto V_284;
if ( ( V_274 -> V_33 . type == V_285 ||
V_274 -> V_33 . type == V_288 ) &&
V_274 -> V_33 . V_38 )
V_16 -> V_126 -> V_65 = V_275 -> V_65 ;
}
error = F_60 ( V_14 ) ;
if ( error )
goto V_284;
...
{
struct V_98 * V_99 = F_105 ( V_2 -> V_19 . V_225 ) ;
struct V_268 * V_19 = F_106 ( V_99 ) ;
struct V_14 * V_14 ;
struct V_16 * V_16 ;
struct V_32 * V_33 ;
int error ;
...
V_33 = & V_16 -> V_33 ;
V_33 -> V_286 = F_100 ( V_2 ) ;
if ( V_33 -> V_286 > V_15 ) {
error = - V_158 ;
goto V_296;
}
if ( V_33 -> V_297 && V_33 -> V_298 != V_2 -> type ) {
error = - V_299 ;
goto V_300;
}
V_14 -> V_269 = V_19 ;
...
if ( V_33 -> V_50 & V_108 )
error = F_10 ( V_2 ) ;
if ( ( V_16 -> V_33 . type == V_285 ||
V_16 -> V_33 . type == V_288 ) &&
( V_16 -> V_33 . V_50 & V_52 ) ) {
V_16 -> V_126 -> V_65 = V_16 -> V_65 ;
}
return 0 ;
V_310:
if ( V_2 -> V_92 == V_93 )
F_115 ( & V_2 -> V_19 , & V_308 ) ;
V_307:
F_86 ( V_14 ) ;
F_69 ( V_14 ) ;
V_306:
