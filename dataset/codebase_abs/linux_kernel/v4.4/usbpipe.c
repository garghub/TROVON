...
if ( V_21 -> V_38 ) {
if ( F_19 ( V_2 , V_37 , V_21 -> V_38 ) ) {
V_37 -> V_39 = F_20 ( V_2 -> V_40 ) ;
if ( ! V_37 -> V_39 ) {
F_12 ( & V_2 -> V_13 -> V_29 ,
L_4 ) ;
V_37 -> V_28 = false ;
...
F_21 ( V_37 -> V_39 , F_22 ( V_37 -> V_39 ) ) ;
F_23 ( V_37 -> V_39 , 0 ) ;
}
V_21 -> V_41 = F_24 ( V_37 -> V_39 ,
F_25 ( V_37 -> V_39 ) ) ;
}
if ( F_14 ( V_21 , V_32 ) ) {
...
int F_26 ( struct V_1 * V_2 , struct V_36 * V_37 )
{
int V_8 = 0 ;
struct V_21 * V_21 ;
V_21 = V_37 -> V_21 ;
...
{
struct V_43 * V_22 = V_21 -> V_22 ;
struct V_1 * V_2 = V_22 -> V_2 ;
switch ( V_21 -> V_8 ) {
case 0 :
F_12 ( & V_2 -> V_13 -> V_29 , L_8 , V_22 -> V_44 ) ;
break;
case - V_24 :
case - V_25 :
case - V_26 :
...
if ( V_22 -> type == V_45 )
F_30 ( V_2 -> V_46 ) ;
if ( V_21 -> V_8 || V_22 -> type == V_47 ) {
if ( V_22 -> V_39 )
F_31 ( V_2 -> V_46 , V_22 -> V_39 ) ;
V_22 -> V_28 = false ;
}
}
