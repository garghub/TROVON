...
if ( V_233 -> V_124 -> V_125 != V_249 ) {
V_8 -> V_250 += V_233 -> V_24 ;
V_231 -> V_23 += V_233 -> V_24 ;
V_231 -> V_251 += V_233 -> V_24 ;
...
static int F_177 ( struct V_14 * V_15 , int V_252 )
{
int V_44 ;
if ( ! F_65 ( V_253 , & V_15 -> V_12 ) )
return 1 ;
if ( ! V_252 )
return 0 ;
...
{
F_53 ( V_253 , & V_15 -> V_12 ) ;
F_85 () ;
F_86 ( & V_15 -> V_12 , V_253 ) ;
}
...
int F_182 ( struct V_255 * V_256 , struct V_1 * V_85 ,
const struct V_190 * V_257 ,
...
V_257 -> V_268 ( V_85 , & V_189 ) ;
F_151 ( L_6 ) ;
F_183 ( F_43 ( V_85 -> V_20 ) -> V_196 ,
V_269 , & V_193 . V_197 , & V_189 ) ;
V_218 = F_184 ( & V_193 ) ;
if ( F_68 ( V_218 ) )
return F_67 ( V_218 ) ;
if ( V_184 & V_270 )
...
if ( V_271 < ( F_189 ( V_17 ) + V_17 -> V_36 ) )
V_271 = F_189 ( V_17 ) + V_17 -> V_36 ;
return V_271 ;
}
...
struct V_103 * V_104 )
{
struct V_13 * V_272 = F_122 ( V_31 -> V_130 ) ;
struct V_20 * V_20 = F_95 ( V_272 -> V_98 -> V_99 ) ;
F_191 ( V_31 , & V_85 -> V_5 ) ;
V_85 -> V_20 = V_20 ;
V_85 -> V_167 = V_272 -> V_98 -> V_167 ;
V_85 -> V_118 = V_118 ;
if ( V_118 )
V_85 -> V_271 = F_187 ( & V_85 -> V_5 ) ;
V_85 -> V_273 = & V_274 ;
V_85 -> V_114 = V_104 -> V_114 ;
V_85 -> V_113 = V_104 -> V_113 ;
V_85 -> args . V_275 = F_192 ( V_85 -> V_20 ) ;
V_85 -> args . V_23 = 0 ;
V_85 -> args . V_24 = 0 ;
V_85 -> V_254 = F_193 ( V_272 -> V_98 ) ;
V_85 -> V_234 . V_229 = & V_85 -> V_229 ;
V_85 -> V_234 . V_124 = & V_85 -> V_124 ;
F_194 ( & V_85 -> V_229 ) ;
}
void F_195 ( struct V_106 * V_276 ,
struct V_117 * V_118 ,
struct V_103 * V_104 ,
T_3 V_119 )
{
...
F_209 ( V_31 ) ;
struct V_103 V_104 ;
int V_252 = V_184 & V_270 ;
int V_234 ;
V_234 = F_177 ( F_22 ( V_20 ) , V_252 ) ;
if ( V_234 <= 0 )
goto V_286;
F_100 ( & V_104 , V_20 ) ;
...
int V_44 ;
F_214 ( V_20 ) ;
V_44 = F_215 ( V_20 -> V_289 ) ;
if ( V_44 )
goto V_29;
V_44 = F_208 ( V_20 , V_270 ) ;
if ( V_44 < 0 )
goto V_29;
F_216 ( V_20 , true ) ;
V_44 = 0 ;
...
int F_223 ( struct V_86 * V_87 , struct V_16 * V_294 ,
struct V_16 * V_16 , enum V_295 V_220 )
{
if ( F_12 ( V_16 ) )
return - V_296 ;
if ( ! F_224 ( V_16 , V_297 ) )
return - V_296 ;
return F_225 ( V_87 , V_294 , V_16 , V_220 ) ;
}
int T_6 F_226 ( void )
{
V_298 = F_227 ( L_12 ,
