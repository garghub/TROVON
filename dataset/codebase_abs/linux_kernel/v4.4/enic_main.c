...
F_298 ( V_1 -> V_366 [ V_5 ] . V_367 ) ;
}
static int F_299 ( struct V_368 * V_3 , const struct V_369 * V_370 )
{
...
V_10 = F_304 ( V_3 , V_377 ) ;
if ( V_10 ) {
F_251 ( V_4 , L_39 ) ;
goto V_378;
}
F_305 ( V_3 ) ;
V_10 = F_306 ( V_3 , F_307 ( 64 ) ) ;
if ( V_10 ) {
V_10 = F_306 ( V_3 , F_307 ( 32 ) ) ;
if ( V_10 ) {
F_251 ( V_4 , L_40 ) ;
goto V_379;
}
V_10 = F_308 ( V_3 , F_307 ( 32 ) ) ;
if ( V_10 ) {
F_251 ( V_4 , L_41
L_42 , 32 ) ;
goto V_379;
...
for ( V_5 = 0 ; V_5 < F_199 ( V_1 -> V_366 ) ; V_5 ++ ) {
if ( ! ( F_309 ( V_3 , V_5 ) & V_380 ) )
continue;
V_1 -> V_366 [ V_5 ] . V_30 = F_310 ( V_3 , V_5 ) ;
V_1 -> V_366 [ V_5 ] . V_367 = F_311 ( V_3 , V_5 , V_1 -> V_366 [ V_5 ] . V_30 ) ;
if ( ! V_1 -> V_366 [ V_5 ] . V_367 ) {
F_251 ( V_4 , L_43 , V_5 ) ;
V_10 = - V_381 ;
goto V_382;
}
V_1 -> V_366 [ V_5 ] . V_383 = F_312 ( V_3 , V_5 ) ;
}
V_1 -> V_27 = F_313 ( NULL , V_1 , V_3 , V_1 -> V_366 ,
F_199 ( V_1 -> V_366 ) ) ;
if ( ! V_1 -> V_27 ) {
F_251 ( V_4 , L_44 ) ;
V_10 = - V_381 ;
...
goto V_384;
#ifdef F_21
V_372 = F_315 ( V_3 , V_385 ) ;
if ( V_372 ) {
F_316 ( V_3 , V_372 + V_386 ,
& V_1 -> V_22 ) ;
if ( V_1 -> V_22 ) {
V_10 = F_317 ( V_3 , V_1 -> V_22 ) ;
if ( V_10 ) {
F_251 ( V_4 , L_45
L_46 ,
V_10 ) ;
...
#endif
V_1 -> V_163 = F_318 ( V_373 , sizeof( * V_1 -> V_163 ) , V_9 ) ;
if ( ! V_1 -> V_163 ) {
V_10 = - V_73 ;
goto V_387;
}
...
F_204 ( V_1 ) ;
F_324 ( & V_1 -> V_62 , F_269 ) ;
F_324 ( & V_1 -> V_160 , F_273 ) ;
F_324 ( & V_1 -> V_50 , F_238 ) ;
for ( V_5 = 0 ; V_5 < V_1 -> V_14 ; V_5 ++ )
F_319 ( & V_1 -> V_38 [ V_5 ] ) ;
...
static void F_335 ( struct V_368 * V_3 )
{
struct V_46 * V_13 = F_336 ( V_3 ) ;
if ( V_13 ) {
struct V_1 * V_1 = F_55 ( V_13 ) ;
F_337 ( & V_1 -> V_62 ) ;
F_337 ( & V_1 -> V_50 ) ;
...
static int T_10 F_339 ( void )
{
F_340 ( L_54 , V_414 , V_415 ) ;
return F_341 ( & V_416 ) ;
}
