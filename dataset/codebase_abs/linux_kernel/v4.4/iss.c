...
V_2 -> V_232 = V_30 ;
if ( F_138 ( V_2 -> V_3 , V_2 -> V_232 , F_35 , V_233 ,
L_94 , V_2 ) ) {
F_64 ( V_2 -> V_3 , L_95 ) ;
V_30 = - V_204 ;
goto V_224;
...
static int F_140 ( struct V_172 * V_173 )
{
struct V_1 * V_2 = F_141 ( V_173 ) ;
F_99 ( V_2 ) ;
F_119 ( V_2 ) ;
return 0 ;
}
