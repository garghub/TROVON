...
static void
F_88 ( struct V_22 * V_23 , const struct V_143 * V_144 )
{
V_23 -> V_16 = V_144 -> V_16 ;
V_23 -> V_17 = V_144 -> V_17 ;
V_23 -> V_142 = V_144 -> V_142 ;
V_23 -> V_69 = V_144 -> V_69 ;
V_23 -> V_112 = V_144 -> V_112 ;
V_23 -> V_50 = V_144 -> V_50 ;
memcpy ( V_23 -> V_34 , V_144 -> V_34 , sizeof( V_144 -> V_34 ) ) ;
}
static void
F_89 ( struct V_143 * V_144 , const struct V_22 * V_23 )
{
V_144 -> V_16 = V_23 -> V_16 ;
V_144 -> V_17 = V_23 -> V_17 ;
V_144 -> V_142 = V_23 -> V_142 ;
V_144 -> V_69 = V_23 -> V_69 ;
V_144 -> V_112 = V_23 -> V_112 ;
V_144 -> V_50 = V_23 -> V_50 ;
memcpy ( V_144 -> V_34 , V_23 -> V_34 , sizeof( V_144 -> V_34 ) ) ;
}
static int
F_90 ( struct V_30 * V_18 , struct V_145 * V_146 , int V_147 )
{
int V_32 = 0 ;
struct V_143 V_23 ;
struct V_22 V_148 ;
...
case V_149 :
if ( V_18 == V_12 -> V_43 ) {
if ( F_91 ( & V_23 , V_146 -> V_150 . V_151 , sizeof( V_23 ) ) ) {
V_32 = - V_152 ;
break;
}
F_88 ( & V_148 , & V_23 ) ;
V_10 = F_27 ( V_7 , & V_148 , 0 ) ;
} else {
...
V_10 = F_19 ( V_18 ) ;
F_89 ( & V_23 , & V_10 -> V_15 ) ;
if ( F_92 ( V_146 -> V_150 . V_151 , & V_23 , sizeof( V_23 ) ) )
V_32 = - V_152 ;
break;
case V_153 :
case V_154 :
V_32 = - V_70 ;
if ( ! F_93 ( V_7 -> V_155 , V_156 ) )
break;
V_32 = - V_152 ;
if ( F_91 ( & V_23 , V_146 -> V_150 . V_151 , sizeof( V_23 ) ) )
break;
...
break;
F_88 ( & V_148 , & V_23 ) ;
V_10 = F_27 ( V_7 , & V_148 , V_147 == V_153 ) ;
if ( V_18 != V_12 -> V_43 && V_147 == V_154 ) {
if ( V_10 ) {
if ( V_10 -> V_18 != V_18 ) {
V_32 = - V_157 ;
break;
...
static int F_95 ( struct V_30 * V_18 , int V_161 )
{
if ( V_161 < V_162 )
return - V_58 ;
V_18 -> V_87 = V_161 ;
...
V_18 -> V_165 = F_15 ;
V_18 -> type = V_166 ;
V_18 -> V_167 = V_168 + sizeof( struct V_46 ) ;
V_18 -> V_87 = V_169 ;
V_18 -> V_19 |= V_170 ;
V_18 -> V_171 = sizeof( struct V_1 ) ;
F_96 ( V_18 ) ;
}
...
static int F_101 ( struct V_173 * V_174 [] , struct V_173 * V_128 [] )
{
return 0 ;
}
static void F_102 ( struct V_173 * V_128 [] ,
struct V_22 * V_15 )
{
...
return;
if ( V_128 [ V_175 ] )
V_15 -> V_142 = F_103 ( V_128 [ V_175 ] ) ;
if ( V_128 [ V_176 ] )
V_15 -> V_16 = F_104 ( V_128 [ V_176 ] ) ;
if ( V_128 [ V_177 ] )
V_15 -> V_17 = F_104 ( V_128 [ V_177 ] ) ;
if ( V_128 [ V_178 ] )
V_15 -> V_69 = F_105 ( V_128 [ V_178 ] ) ;
if ( V_128 [ V_179 ] )
V_15 -> V_112 = F_105 ( V_128 [ V_179 ] ) ;
}
static int F_106 ( struct V_7 * V_180 , struct V_30 * V_18 ,
struct V_173 * V_174 [] , struct V_173 * V_128 [] )
{
struct V_7 * V_7 = F_20 ( V_18 ) ;
struct V_6 * V_181 ;
V_181 = F_19 ( V_18 ) ;
F_102 ( V_128 , & V_181 -> V_15 ) ;
V_181 -> V_15 . V_50 = V_51 ;
if ( F_27 ( V_7 , & V_181 -> V_15 , 0 ) )
return - V_157 ;
return F_18 ( V_18 ) ;
}
static void F_107 ( struct V_30 * V_18 , struct V_182 * V_183 )
{
struct V_7 * V_7 = F_20 ( V_18 ) ;
struct V_11 * V_12 = F_5 ( V_7 , V_13 ) ;
if ( V_18 != V_12 -> V_43 )
...
static int F_109 ( struct V_30 * V_18 , struct V_173 * V_174 [] ,
struct V_173 * V_128 [] )
{
struct V_6 * V_10 ;
struct V_22 V_23 ;
...
struct V_22 * V_184 = & V_56 -> V_15 ;
if ( F_113 ( V_45 , V_175 , V_184 -> V_142 ) ||
F_114 ( V_45 , V_176 , & V_184 -> V_16 ) ||
F_114 ( V_45 , V_177 , & V_184 -> V_17 ) ||
F_115 ( V_45 , V_178 , V_184 -> V_69 ) ||
F_115 ( V_45 , V_179 , V_184 -> V_112 ) )
goto V_185;
return 0 ;
V_185:
return - V_101 ;
...
V_10 = F_13 ( V_12 -> V_188 [ V_24 ] ) ;
while ( V_10 ) {
F_108 ( V_10 -> V_18 , & V_186 ) ;
V_10 = F_13 ( V_10 -> V_28 ) ;
}
}
...
goto V_193;
V_191 = L_5 ;
V_32 = F_126 ( & V_194 , V_130 ) ;
if ( V_32 < 0 )
goto V_195;
V_32 = F_126 ( & V_196 , V_131 ) ;
if ( V_32 < 0 )
goto V_197;
V_32 = F_126 ( & V_198 , V_132 ) ;
if ( V_32 < 0 )
goto V_199;
V_191 = L_6 ;
V_32 = F_127 ( & V_36 ) ;
