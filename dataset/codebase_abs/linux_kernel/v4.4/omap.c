...
V_4 -> V_101 = F_78 ( V_94 -> V_41 -> V_42 , V_71 -> V_100 , V_101 ,
V_92 ) ;
if ( V_4 -> V_101 == 0 )
goto V_183;
V_178 = F_79 ( V_94 , V_71 -> V_100 , V_4 -> V_101 ,
...
static void F_82 ( struct V_46 * V_16 , struct V_29 * V_165 )
{
struct V_1 * V_2 = F_25 ( V_16 ) ;
struct V_8 * V_4 = V_2 -> V_4 ;
unsigned long V_10 ;
...
static void F_83 ( struct V_1 * V_2 , int V_200 ,
int V_201 )
{
struct V_8 * V_4 ;
V_4 = V_2 -> V_4 ;
...
static int F_85 ( struct V_46 * V_16 , struct V_204 * V_205 )
{
struct V_1 * V_2 = F_25 ( V_16 ) ;
struct V_8 * V_4 = V_2 -> V_4 ;
int V_206 = F_86 ( V_4 -> V_12 ) ;
int V_207 ;
if ( V_205 -> clock == 0 )
return 0 ;
...
static void F_87 ( struct V_46 * V_16 , struct V_204 * V_205 )
{
struct V_1 * V_2 = F_25 ( V_16 ) ;
struct V_8 * V_4 = V_2 -> V_4 ;
int V_33 , V_207 ;
int V_32 ;
F_9 ( V_2 , 0 ) ;
V_207 = F_85 ( V_16 , V_205 ) ;
if ( V_205 -> V_201 != V_2 -> V_201 )
V_2 -> V_201 = V_205 -> V_201 ;
V_32 = 0 ;
switch ( V_205 -> V_210 ) {
case V_211 :
F_83 ( V_2 , 0 , V_205 -> V_201 ) ;
break;
case V_212 :
F_83 ( V_2 , 1 , V_205 -> V_201 ) ;
goto exit;
case V_213 :
F_4 ( V_4 , 1 ) ;
V_32 = 1 ;
...
static int F_88 ( struct V_8 * V_4 , int V_24 )
{
struct V_1 * V_2 = NULL ;
struct V_46 * V_16 ;
int V_216 ;
V_16 = F_89 ( sizeof( struct V_1 ) , V_4 -> V_42 ) ;
if ( V_16 == NULL )
return - V_217 ;
V_2 = F_25 ( V_16 ) ;
V_2 -> V_4 = V_4 ;
...
V_16 -> V_225 = 24000000 ;
if ( V_4 -> V_22 -> V_226 )
V_16 -> V_225 = F_90 ( V_4 -> V_22 -> V_226 , V_16 -> V_225 ) ;
...
static int F_102 ( struct V_238 * V_239 )
{
...
V_4 = F_103 ( & V_239 -> V_42 , sizeof( struct V_8 ) ,
V_248 ) ;
if ( V_4 == NULL )
return - V_217 ;
V_131 = F_104 ( V_239 , 0 ) ;
if ( V_131 < 0 )
return - V_246 ;
V_145 = F_105 ( V_239 , V_249 , 0 ) ;
V_4 -> V_141 = F_106 ( & V_239 -> V_42 , V_145 ) ;
if ( F_107 ( V_4 -> V_141 ) )
return F_108 ( V_4 -> V_141 ) ;
F_109 ( & V_4 -> V_27 , F_15 ) ;
F_109 ( & V_4 -> V_102 , F_34 ) ;
F_109 ( & V_4 -> V_129 , F_43 ) ;
F_91 ( & V_4 -> V_73 , F_46 ,
( unsigned long ) V_4 ) ;
F_110 ( & V_4 -> V_11 ) ;
F_91 ( & V_4 -> V_18 , F_50 , ( unsigned long ) V_4 ) ;
F_110 ( & V_4 -> V_115 ) ;
F_110 ( & V_4 -> V_15 ) ;
F_111 ( & V_4 -> V_17 ) ;
V_4 -> V_22 = V_22 ;
...
V_4 -> V_252 = F_113 ( & V_239 -> V_42 , L_35 ) ;
if ( F_107 ( V_4 -> V_252 ) )
return F_108 ( V_4 -> V_252 ) ;
F_6 ( V_4 -> V_252 ) ;
V_4 -> V_12 = F_113 ( & V_239 -> V_42 , L_36 ) ;
if ( F_107 ( V_4 -> V_12 ) ) {
V_245 = F_108 ( V_4 -> V_12 ) ;
goto V_253;
}
F_114 ( V_243 ) ;
F_115 ( V_254 , V_243 ) ;
V_4 -> V_181 = - 1 ;
V_4 -> V_182 = - 1 ;
V_145 = F_116 ( V_239 , V_255 , L_37 ) ;
if ( V_145 )
V_244 = V_145 -> V_251 ;
V_4 -> V_96 = F_117 ( V_243 ,
V_256 , & V_244 , & V_239 -> V_42 , L_37 ) ;
if ( ! V_4 -> V_96 )
F_118 ( V_4 -> V_42 , L_38 ,
V_244 ) ;
V_145 = F_116 ( V_239 , V_255 , L_39 ) ;
if ( V_145 )
V_244 = V_145 -> V_251 ;
V_4 -> V_98 = F_117 ( V_243 ,
V_256 , & V_244 , & V_239 -> V_42 , L_39 ) ;
if ( ! V_4 -> V_98 )
F_118 ( V_4 -> V_42 , L_40 ,
V_244 ) ;
V_245 = F_119 ( V_4 -> V_131 , F_58 , 0 , V_257 , V_4 ) ;
if ( V_245 )
goto V_258;
if ( V_22 -> V_259 != NULL ) {
...
static int F_126 ( struct V_238 * V_239 )
{
struct V_8 * V_4 = F_127 ( V_239 ) ;
int V_33 ;
F_19 ( V_4 == NULL ) ;
for ( V_33 = 0 ; V_33 < V_4 -> V_36 ; V_33 ++ )
F_98 ( V_4 -> V_38 [ V_33 ] ) ;
