...
static int F_73 ( struct V_182 * V_28 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
V_2 = F_74 ( V_28 ) ;
...
static int F_75 ( struct V_183 * V_184 )
{
struct V_1 * V_2 ;
...
T_1 V_190 = 0 ;
static int V_191 = 1 ;
struct V_192 * V_162 = V_184 -> V_28 . V_193 ;
const struct V_194 * V_195 ;
V_2 = F_76 ( & V_184 -> V_28 , sizeof *V_6 ) ;
if ( V_2 == NULL ) {
F_48 ( & V_184 -> V_28 , L_27 ) ;
return - V_161 ;
}
V_2 -> V_196 = V_145 | V_147 | V_26 ;
V_2 -> V_197 = F_77 ( 4 , 32 ) ;
V_2 -> V_198 = F_56 ;
V_2 -> V_199 = true ;
V_2 -> V_200 = F_68 ;
...
V_2 -> V_202 = F_13 ;
V_2 -> V_203 = F_63 ;
V_2 -> V_28 . V_193 = V_162 ;
V_2 -> V_133 = V_128 ;
V_2 -> V_204 = V_128 >> 15 ;
F_78 ( V_184 , V_2 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_2 = V_2 ;
V_195 = F_79 ( V_205 , & V_184 -> V_28 ) ;
if ( V_195 ) {
T_1 V_206 = 1 ;
V_186 = V_195 -> V_62 ;
F_80 ( V_162 , L_28 , & V_206 ) ;
V_2 -> V_164 = V_206 ;
V_2 -> V_191 = V_191 ++ ;
if ( F_81 ( V_162 , L_29 , NULL ) )
V_6 -> V_136 = V_207 ;
} else {
V_186 = F_82 ( & V_184 -> V_28 ) ;
V_2 -> V_164 = V_186 -> V_206 ;
if ( V_184 -> V_208 != - 1 )
V_2 -> V_191 = V_184 -> V_208 ;
V_6 -> V_136 = V_186 -> V_136 ;
}
V_190 = V_186 -> V_190 ;
V_188 = F_83 ( V_184 , V_209 , 0 ) ;
if ( V_188 == NULL ) {
V_168 = - V_210 ;
goto V_211;
}
V_188 -> V_212 += V_190 ;
V_188 -> V_213 += V_190 ;
V_6 -> V_110 = V_188 -> V_212 ;
V_6 -> V_7 = F_84 ( & V_184 -> V_28 , V_188 ) ;
if ( F_85 ( V_6 -> V_7 ) ) {
V_168 = F_86 ( V_6 -> V_7 ) ;
goto V_211;
}
V_6 -> V_28 = & V_184 -> V_28 ;
F_87 ( & V_6 -> V_31 . V_11 ) ;
V_6 -> V_65 = F_88 ( & V_184 -> V_28 , V_2 -> V_164 ,
sizeof( struct V_63 ) ,
V_160 ) ;
if ( V_6 -> V_65 == NULL ) {
V_168 = - V_161 ;
...
for ( V_189 = 0 ; V_189 < V_2 -> V_164 ; V_189 ++ ) {
char * V_154 = V_6 -> V_65 [ V_189 ] . V_154 ;
char * V_157 = V_6 -> V_65 [ V_189 ] . V_157 ;
struct V_187 * V_214 ;
sprintf ( V_154 , L_30 , V_189 ) ;
if ( ! V_184 -> V_28 . V_193 ) {
V_214 =
F_89 ( V_184 ,
V_215 ,
...
V_6 -> V_65 [ V_189 ] . V_152 =
V_214 -> V_212 ;
}
sprintf ( V_157 , L_32 , V_189 ) ;
if ( ! V_184 -> V_28 . V_193 ) {
V_214 =
F_89 ( V_184 ,
V_215 ,
...
goto V_211;
F_90 ( & V_184 -> V_28 ) ;
F_91 ( & V_184 -> V_28 , V_216 ) ;
F_92 ( & V_184 -> V_28 ) ;
V_168 = F_72 ( V_6 ) ;
if ( V_168 < 0 )
goto V_217;
V_168 = F_93 ( & V_184 -> V_28 , V_2 ) ;
if ( V_168 < 0 )
goto V_217;
return V_168 ;
V_217:
...
{
struct V_1 * V_2 = F_97 ( V_184 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_98 ( V_6 -> V_28 ) ;
F_94 ( & V_184 -> V_28 ) ;
return 0 ;
}
static int F_99 ( struct V_182 * V_28 )
{
