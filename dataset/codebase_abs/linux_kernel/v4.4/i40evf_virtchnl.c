...
V_9 = ( T_3 ) F_10 ( V_25 . V_33 . V_35 ) ;
memcpy ( V_2 -> V_51 , V_25 . V_28 , F_16 ( V_25 . V_52 , V_6 ) ) ;
F_17 ( V_8 , V_2 -> V_51 ) ;
V_32:
F_12 ( V_25 . V_28 ) ;
V_31:
...
V_2 -> V_39 = V_61 ;
V_6 = sizeof( struct V_53 ) +
( sizeof( struct V_55 ) * V_57 ) ;
V_54 = F_8 ( V_6 , V_62 ) ;
if ( ! V_54 )
return;
V_54 -> V_63 = V_2 -> V_64 -> V_63 ;
V_54 -> V_65 = V_57 ;
V_56 = V_54 -> V_66 ;
for ( V_59 = 0 ; V_59 < V_57 ; V_59 ++ ) {
V_56 -> V_67 . V_63 = V_54 -> V_63 ;
V_56 -> V_67 . V_68 = V_59 ;
V_56 -> V_67 . V_69 = V_2 -> V_70 [ V_59 ] -> V_71 ;
V_56 -> V_67 . V_72 = V_2 -> V_70 [ V_59 ] -> V_73 ;
V_56 -> V_67 . V_74 = 1 ;
V_56 -> V_67 . V_75 = V_56 -> V_67 . V_72 +
( V_56 -> V_67 . V_69 * sizeof( struct V_76 ) ) ;
V_56 -> V_77 . V_63 = V_54 -> V_63 ;
V_56 -> V_77 . V_68 = V_59 ;
V_56 -> V_77 . V_69 = V_2 -> V_78 [ V_59 ] -> V_71 ;
V_56 -> V_77 . V_72 = V_2 -> V_78 [ V_59 ] -> V_73 ;
V_56 -> V_77 . V_79 = V_2 -> V_80 -> V_81
+ V_82 + V_83 + V_84 ;
V_56 -> V_77 . V_85 = V_2 -> V_78 [ V_59 ] -> V_86 ;
V_56 ++ ;
}
V_2 -> V_41 &= ~ V_87 ;
F_1 ( V_2 , V_61 ,
...
F_24 (f, &adapter->mac_filter_list, list) {
if ( V_116 -> V_117 ) {
F_26 ( V_114 -> V_122 [ V_59 ] . V_123 , V_116 -> V_124 ) ;
V_59 ++ ;
V_116 -> V_117 = false ;
}
}
...
break;
case V_40 : {
T_2 V_6 = sizeof( struct V_48 ) +
V_49 *
sizeof( struct V_50 ) ;
memcpy ( V_2 -> V_51 , V_5 , F_16 ( V_144 , V_6 ) ) ;
F_17 ( & V_2 -> V_8 , V_2 -> V_51 ) ;
F_26 ( V_2 -> V_8 . V_176 . V_123 , V_80 -> V_177 ) ;
F_42 ( V_2 ) ;
}
break;
case V_90 :
