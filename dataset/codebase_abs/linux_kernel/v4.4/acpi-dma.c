...
if ( V_8 -> V_22 != V_13 || V_8 -> V_23 != V_14 )
return 0 ;
F_7 ( & V_4 -> V_24 , L_1 ,
( char * ) & V_2 -> V_25 , V_2 -> V_26 , V_2 -> V_27 ) ;
...
static void F_8 ( struct V_3 * V_4 , struct V_5 * V_6 )
{
struct V_1 * V_2 , * V_31 ;
struct V_32 * V_33 ;
T_2 V_34 ;
...
static void F_17 ( struct V_40 * V_24 , void * V_18 )
{
F_12 ( V_24 ) ;
}
void F_18 ( struct V_40 * V_24 )
{
F_19 ( F_20 ( V_24 , F_17 , NULL , NULL ) ) ;
}
...
static int F_22 ( struct V_47 * V_18 , void * V_48 )
{
struct V_49 * V_50 = V_48 ;
if ( V_18 -> type == V_51 ) {
struct V_52 * V_53 = & V_18 -> V_48 . V_54 ;
...
struct V_60 * F_23 ( struct V_40 * V_24 ,
T_3 V_56 )
{
struct V_49 V_50 ;
...
F_15 ( & V_42 ) ;
return V_61 ? V_61 : F_24 ( - V_64 ) ;
}
struct V_60 * F_26 ( struct V_40 * V_24 ,
const char * V_65 )
{
int V_56 ;
V_56 = F_27 ( V_24 , L_5 , V_65 ) ;
if ( V_56 < 0 ) {
if ( ! strcmp ( V_65 , L_6 ) )
V_56 = 0 ;
else if ( ! strcmp ( V_65 , L_7 ) )
V_56 = 1 ;
else
return F_24 ( - V_17 ) ;
}
F_7 ( V_24 , L_8 , V_65 , V_56 ) ;
return F_23 ( V_24 , V_56 ) ;
}
struct V_60 * F_28 ( struct V_44 * V_45 ,
struct V_5 * V_6 )
{
struct V_66 * V_67 = V_6 -> V_48 ;
if ( ! V_67 || ! V_67 -> V_68 )
return NULL ;
return F_29 ( V_67 -> V_69 , V_67 -> V_68 , V_45 ) ;
}
