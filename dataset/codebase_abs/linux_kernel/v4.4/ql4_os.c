...
F_3 ( F_113 ( L_249
L_250 , V_26 ) ) ;
sprintf ( V_273 , L_251 , V_10 -> V_576 ) ;
...
V_10 -> V_1139 = F_400 ( L_253 , V_1385 , 1 ,
V_10 -> V_576 ) ;
if ( ! V_10 -> V_1139 ) {
F_4 ( V_38 , V_10 , L_254 ) ;
V_277 = - V_1339 ;
...
F_4 ( V_25 , V_10 ,
L_270 ,
V_10 -> V_576 , V_1421 , V_1422 , ( V_277 == V_1416 ) ? L_271 : L_272 ) ;
return V_277 ;
}
...
if ( F_429 ( V_10 ) != V_41 ) {
F_3 ( F_113 ( L_289
L_290 , V_10 -> V_576 , V_955 -> V_295 -> V_1426 ,
V_26 ) ) ;
return V_1424 ;
}
if ( ! F_55 ( V_974 , & V_10 -> V_972 ) ) {
...
int V_1395 ;
struct V_1144 * V_1394 = NULL ;
F_4 ( V_38 , V_10 , L_297 , V_10 -> V_576 , V_26 ) ;
F_202 ( V_973 , & V_10 -> V_972 ) ;
if ( F_55 ( V_977 , & V_10 -> V_289 ) ) {
F_115 ( V_977 , & V_10 -> V_289 ) ;
F_115 ( V_652 , & V_10 -> V_289 ) ;
...
if ( V_1460 )
V_1343 . V_1461 = 1 ;
V_1015 = F_459 ( L_315 , sizeof( struct V_954 ) , 0 ,
V_1462 , NULL ) ;
if ( V_1015 == NULL ) {
F_113 ( V_252
L_316
