...
V_38 -> V_97 = V_85 ;
V_38 -> V_98 = V_99 ;
F_58 ( & F_34 ( V_38 ) -> V_79 . V_35 . V_80 ,
F_48 ) ;
return 0 ;
}
static int F_59 ( struct V_83 * V_37 )
{
...
static int F_63 ( struct V_83 * V_37 , struct V_104 * V_105 ,
int V_106 , int V_107 )
{
struct V_37 * V_38 = V_37 -> V_38 ;
...
memset ( & V_26 -> V_62 , 0 , sizeof( V_26 -> V_62 ) ) ;
memset ( & V_26 -> V_60 , 0 , sizeof( V_26 -> V_60 ) ) ;
V_26 -> V_25 = NULL ;
V_26 -> V_112 = 0 ;
V_38 -> V_40 = V_94 ;
}
...
if ( error < 0 )
goto V_114;
V_26 -> V_60 . V_116 = ( sizeof( struct V_69 ) +
V_33 -> V_117 ) ;
V_26 -> V_60 . V_118 = V_33 -> V_118 - sizeof( struct V_69 ) - 2 ;
V_26 -> V_60 . V_119 = V_38 ;
V_26 -> V_60 . V_91 = & V_120 ;
...
char * V_145 ;
F_26 ( V_38 ) ;
if ( F_60 ( V_38 , V_100 ) || ! ( V_38 -> V_40 & V_41 ) ) {
error = - V_138 ;
goto V_110;
}
V_144 . V_146 = 1 ;
V_144 . type = 1 ;
V_144 . V_81 = 0 ;
V_144 . V_1 = V_26 -> V_112 ;
V_33 = V_26 -> V_39 ;
error = - V_147 ;
if ( V_143 > ( V_33 -> V_118 + V_33 -> V_117 ) )
goto V_110;
V_55 = F_72 ( V_38 , V_143 + V_33 -> V_117 + 32 ,
0 , V_86 ) ;
if ( ! V_55 ) {
error = - V_88 ;
goto V_110;
}
F_73 ( V_55 , V_33 -> V_117 ) ;
F_74 ( V_55 ) ;
V_55 -> V_33 = V_33 ;
...
if ( ! V_33 )
goto abort;
if ( F_81 ( V_55 , sizeof( * V_70 ) + V_33 -> V_117 ) )
goto abort;
...
{
struct V_37 * V_38 = (struct V_37 * ) V_60 -> V_119 ;
