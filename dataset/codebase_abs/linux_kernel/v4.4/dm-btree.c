...
static int F_58 ( struct V_38 * V_39 , T_5 V_40 ,
...
V_41 = F_55 ( & V_53 , V_67 , & V_94 , V_19 [ V_57 ] , & V_7 ) ;
if ( V_41 < 0 )
goto V_95;
V_10 = F_23 ( F_52 ( & V_53 ) ) ;
...
int F_63 ( struct V_38 * V_39 , T_5 V_40 ,
T_2 * V_19 , void * V_31 , T_5 * V_91 )
__dm_written_to_disk( V_31 )
{
return F_58 ( V_39 , V_40 , V_19 , V_31 , V_91 , NULL ) ;
}
...
__dm_written_to_disk( V_31 )
{
return F_58 ( V_39 , V_40 , V_19 , V_31 , V_91 , V_92 ) ;
}
static int F_65 ( struct V_66 * V_48 , T_5 V_67 , bool V_100 ,
T_2 * V_68 , T_5 * V_101 )
{
int V_24 , V_41 ;
T_3 V_25 ;
...
static int F_66 ( struct V_38 * V_39 , T_5 V_40 ,
...
F_46 ( & V_53 , V_39 ) ;
for ( V_57 = 0 ; V_57 < V_39 -> V_58 ; V_57 ++ ) {
V_41 = F_65 ( & V_53 , V_40 , V_100 , V_102 + V_57 ,
...
T_2 * V_102 )
{
return F_66 ( V_39 , V_40 , true , V_102 ) ;
}
int F_68 ( struct V_38 * V_39 , T_5 V_40 ,
T_2 * V_102 )
{
return F_66 ( V_39 , V_40 , false , V_102 ) ;
}
static int F_69 ( struct V_38 * V_39 , T_5 V_67 ,
int (* F_70)( void * V_28 , T_2 * V_19 , void * V_103 ) ,
void * V_28 )
{
int V_41 ;
unsigned V_24 , V_104 ;
...
if ( F_4 ( V_10 -> V_15 . V_25 ) & V_26 ) {
V_41 = F_69 ( V_39 , F_10 ( V_10 , V_24 ) , F_70 , V_28 ) ;
if ( V_41 )
goto V_64;
} else {
V_19 = F_5 ( * F_71 ( V_10 , V_24 ) ) ;
V_41 = F_70 ( V_28 , & V_19 , F_11 ( V_10 , V_24 ) ) ;
if ( V_41 )
goto V_64;
}
}
...
int F_72 ( struct V_38 * V_39 , T_5 V_40 ,
int (* F_70)( void * V_28 , T_2 * V_19 , void * V_103 ) ,
void * V_28 )
{
F_73 ( V_39 -> V_58 > 1 ) ;
return F_69 ( V_39 , V_40 , F_70 , V_28 ) ;
}
