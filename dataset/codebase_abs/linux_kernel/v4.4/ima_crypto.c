...
if ( strcmp ( V_71 -> V_79 , V_80 ) != 0 ) {
V_11 = F_48 ( V_64 ,
( const T_5 * ) & V_69 [ V_73 ] . V_78 ,
sizeof( V_69 [ V_73 ] . V_78 ) ) ;
if ( V_11 )
break;
} else if ( strcmp ( V_71 -> V_81 [ V_73 ] -> V_82 , L_4 ) == 0 ) {
...
if ( F_6 ( V_18 ) )
return F_7 ( V_18 ) ;
V_11 = F_53 ( V_69 , V_83 , V_72 ,
V_42 , V_18 ) ;
F_10 ( V_18 ) ;
return V_11 ;
}
static void T_1 F_55 ( int V_84 , T_5 * V_85 )
{
if ( ! V_86 )
return;
if ( F_56 ( V_87 , V_84 , V_85 ) != 0 )
F_8 ( L_5 ) ;
}
static int T_1 F_57 ( char * V_63 ,
struct V_15 * V_18 )
{
T_5 V_88 [ V_89 ] ;
int V_11 , V_73 ;
...
if ( V_11 != 0 )
return V_11 ;
for ( V_73 = V_90 ; V_73 < V_91 ; V_73 ++ ) {
F_55 ( V_73 , V_88 ) ;
V_11 = F_48 ( V_64 , V_88 , V_89 ) ;
}
if ( ! V_11 )
F_50 ( V_64 , V_63 ) ;
return V_11 ;
}
int T_1 F_58 ( struct V_41 * V_42 )
{
struct V_15 * V_18 ;
int V_11 ;
V_18 = F_9 ( V_42 -> V_17 ) ;
