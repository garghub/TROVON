...
static int F_31 ( struct V_2 * V_3 , unsigned V_17 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_5 * V_6 ;
V_6 = V_4 -> V_97 -> V_15 -> V_18 [ V_17 ] . V_51 ;
...
static void F_32 ( struct V_91 * V_92 , struct V_2 * V_3 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
unsigned V_81 ;
...
int V_9 , V_16 , V_81 ;
T_1 V_132 [ 2 ] ;
V_9 = F_35 ( V_12 -> V_133 , L_24 , V_132 , 2 ) ;
if ( V_9 < 0 ) {
F_5 ( V_12 , L_25 ) ;
return V_9 ;
}
...
return - V_65 ;
F_36 ( V_16 > F_12 ( V_26 ) ) ;
V_4 = F_37 ( V_12 , sizeof( * V_4 ) , V_135 ) ;
if ( ! V_4 )
return - V_136 ;
F_38 ( V_125 , V_4 ) ;
V_4 -> V_12 = & V_125 -> V_12 ;
V_4 -> V_10 = F_39 ( V_12 -> V_137 , NULL ) ;
V_128 = F_40 ( V_12 , V_16 , sizeof( * V_128 ) , V_135 ) ;
if ( ! V_128 )
return - V_136 ;
V_131 = F_40 ( V_12 , V_16 , sizeof( * V_131 ) , V_135 ) ;
if ( ! V_131 )
return - V_136 ;
V_130 = F_37 ( V_12 , sizeof( * V_130 ) , V_135 ) ;
if ( ! V_130 )
return - V_136 ;
V_130 -> V_138 = & V_139 ;
V_130 -> V_140 = & V_141 ;
...
V_4 -> V_3 . V_11 = - 1 ;
V_4 -> V_3 . V_104 = V_16 ;
V_4 -> V_3 . V_152 = F_41 ( V_12 ) ;
V_4 -> V_3 . V_102 = 2 ;
V_4 -> V_3 . V_153 = false ;
V_4 -> V_97 = F_44 ( V_130 , V_12 , V_4 ) ;
if ( F_45 ( V_4 -> V_97 ) )
return F_46 ( V_4 -> V_97 ) ;
V_9 = F_47 ( & V_4 -> V_3 ) ;
if ( V_9 ) {
F_5 ( V_4 -> V_12 , L_26 ) ;
goto V_154;
}
V_9 = F_48 ( & V_4 -> V_3 , F_41 ( V_12 ) , 0 , 0 , V_16 ) ;
if ( V_9 ) {
F_5 ( V_12 , L_27 ) ;
goto V_155;
}
