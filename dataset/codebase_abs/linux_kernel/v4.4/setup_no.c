...
#endif
F_14 ( L_16 ,
V_24 , V_26 , V_39 , V_28 , V_40 , V_41 ) ;
F_14 ( L_17 ,
V_41 , V_18 , V_18 , V_20 ) ;
* V_16 = & V_30 [ 0 ] ;
memcpy ( V_42 , V_30 , V_43 ) ;
V_42 [ V_43 - 1 ] = 0 ;
#if F_2 ( V_44 ) && F_2 ( V_45 )
V_46 = & V_47 ;
#endif
V_48 = F_15 ( V_18 ) ;
V_49 = V_50 = F_15 ( V_20 ) ;
...
static int F_21 ( struct V_53 * V_54 , void * V_55 )
{
char * V_56 , * V_57 , * V_58 ;
T_2 V_59 ;
V_56 = V_34 ;
...
static void * F_23 ( struct V_53 * V_54 , T_3 * V_63 )
{
return * V_63 < V_64 ? ( ( void * ) 0x12345678 ) : NULL ;
}
static void * F_24 ( struct V_53 * V_54 , void * V_55 , T_3 * V_63 )
{
++ * V_63 ;
return F_23 ( V_54 , V_63 ) ;
}
static void F_25 ( struct V_53 * V_54 , void * V_55 )
{
}
