...
static inline int
F_147 ( struct V_72 * V_73 , struct V_7 * V_8 )
{
struct V_28 * V_29 = F_43 ( V_8 ) ;
struct V_75 * V_76 = F_86 ( V_73 ) ;
int V_119 = - 1 ;
...
F_116 ( V_29 , V_76 ) )
return - 1 ;
V_100 = F_58 ( V_73 , F_148 ( V_73 ) ) ;
if ( V_100 > 0 ) {
struct V_90 * V_91 ;
V_91 = (struct V_90 * ) & F_148 ( V_73 ) [ V_100 ] ;
if ( V_91 -> V_119 == 0 ) {
F_87 ( V_73 , V_117 ,
V_118 , V_100 + 2 ) ;
return - 1 ;
...
static T_8
F_150 ( struct V_72 * V_73 , struct V_7 * V_8 )
{
struct V_28 * V_29 = F_43 ( V_8 ) ;
struct V_6 * V_20 = & V_29 -> V_8 -> V_20 ;
int V_159 ;
...
static int
F_152 ( struct V_28 * V_29 , const struct V_50 * V_51 )
{
...
static int F_153 ( struct V_28 * V_29 , struct V_50 * V_51 )
{
struct V_37 * V_37 = V_29 -> V_37 ;
struct V_40 * V_41 = F_34 ( V_37 , V_42 ) ;
int V_58 ;
F_41 ( V_41 , V_29 ) ;
F_154 () ;
V_58 = F_152 ( V_29 , V_51 ) ;
F_39 ( V_41 , V_29 ) ;
F_155 ( V_29 -> V_8 ) ;
return V_58 ;
}
static int F_156 ( struct V_28 * V_29 , struct V_50 * V_51 )
{
V_29 -> V_44 . V_112 = V_51 -> V_112 ;
F_155 ( V_29 -> V_8 ) ;
return 0 ;
...
static void
F_157 ( struct V_50 * V_51 , const struct V_225 * V_205 )
{
...
static void
F_158 ( struct V_225 * V_205 , const struct V_50 * V_51 )
{
...
static int
F_159 ( struct V_7 * V_8 , struct V_226 * V_227 , int V_228 )
{
int V_58 = 0 ;
struct V_225 V_51 ;
struct V_50 V_229 ;
...
case V_230 :
if ( V_8 == V_41 -> V_71 ) {
if ( F_160 ( & V_51 , V_227 -> V_231 . V_232 , sizeof( V_51 ) ) ) {
V_58 = - V_233 ;
break;
}
F_157 ( & V_229 , & V_51 ) ;
...
F_158 ( & V_51 , & V_29 -> V_44 ) ;
if ( F_161 ( V_227 -> V_231 . V_232 , & V_51 , sizeof( V_51 ) ) ) {
V_58 = - V_233 ;
}
break;
case V_234 :
...
V_29 = F_43 ( V_8 ) ;
if ( V_8 == V_41 -> V_71 )
V_58 = F_156 ( V_29 , & V_229 ) ;
else
V_58 = F_153 ( V_29 , & V_229 ) ;
}
if ( ! F_75 ( V_29 ) ) {
V_58 = 0 ;
F_158 ( & V_51 , & V_29 -> V_44 ) ;
...
static int
F_164 ( struct V_7 * V_8 , int V_241 )
{
...
int F_165 ( const struct V_7 * V_8 )
{
struct V_28 * V_29 = F_43 ( V_8 ) ;
...
static int T_9 F_171 ( struct V_7 * V_8 )
{
struct V_28 * V_29 = F_43 ( V_8 ) ;
struct V_37 * V_37 = F_46 ( V_8 ) ;
struct V_40 * V_41 = F_34 ( V_37 , V_42 ) ;
...
static int F_172 ( struct V_254 * V_255 [] , struct V_254 * V_83 [] )
{
T_5 V_112 ;
if ( ! V_83 || ! V_83 [ V_256 ] )
return 0 ;
V_112 = F_173 ( V_83 [ V_256 ] ) ;
if ( V_112 != V_144 &&
V_112 != V_130 &&
V_112 != 0 )
return - V_239 ;
...
static void F_174 ( struct V_254 * V_83 [] ,
struct V_50 * V_44 )
{
...
return;
if ( V_83 [ V_257 ] )
V_44 -> V_156 = F_175 ( V_83 [ V_257 ] ) ;
if ( V_83 [ V_258 ] )
V_44 -> V_45 = F_176 ( V_83 [ V_258 ] ) ;
if ( V_83 [ V_259 ] )
V_44 -> V_46 = F_176 ( V_83 [ V_259 ] ) ;
if ( V_83 [ V_260 ] )
V_44 -> V_200 = F_173 ( V_83 [ V_260 ] ) ;
if ( V_83 [ V_261 ] )
V_44 -> V_119 = F_173 ( V_83 [ V_261 ] ) ;
if ( V_83 [ V_262 ] )
V_44 -> V_220 = F_177 ( V_83 [ V_262 ] ) ;
if ( V_83 [ V_263 ] )
V_44 -> V_47 = F_175 ( V_83 [ V_263 ] ) ;
if ( V_83 [ V_256 ] )
V_44 -> V_112 = F_173 ( V_83 [ V_256 ] ) ;
}
static int F_178 ( struct V_37 * V_264 , struct V_7 * V_8 ,
struct V_254 * V_255 [] , struct V_254 * V_83 [] )
{
struct V_37 * V_37 = F_46 ( V_8 ) ;
struct V_28 * V_265 , * V_29 ;
V_265 = F_43 ( V_8 ) ;
F_174 ( V_83 , & V_265 -> V_44 ) ;
V_29 = F_54 ( V_37 , & V_265 -> V_44 , 0 ) ;
if ( ! F_75 ( V_29 ) )
return - V_69 ;
return F_45 ( V_8 ) ;
}
static int F_179 ( struct V_7 * V_8 , struct V_254 * V_255 [] ,
struct V_254 * V_83 [] )
{
struct V_28 * V_29 = F_43 ( V_8 ) ;
struct V_50 V_51 ;
...
V_29 = F_43 ( V_8 ) ;
return F_153 ( V_29 , & V_51 ) ;
}
static void F_180 ( struct V_7 * V_8 , struct V_266 * V_267 )
{
struct V_37 * V_37 = F_46 ( V_8 ) ;
struct V_40 * V_41 = F_34 ( V_37 , V_42 ) ;
if ( V_8 != V_41 -> V_71 )
...
static T_10 F_182 ( const struct V_7 * V_8 )
{
return
F_183 ( 4 ) +
F_183 ( sizeof( struct V_1 ) ) +
F_183 ( sizeof( struct V_1 ) ) +
F_183 ( 1 ) +
F_183 ( 1 ) +
F_183 ( 4 ) +
...
static int F_184 ( struct V_72 * V_73 , const struct V_7 * V_8 )
{
struct V_28 * V_268 = F_43 ( V_8 ) ;
struct V_50 * V_269 = & V_268 -> V_44 ;
if ( F_185 ( V_73 , V_257 , V_269 -> V_156 ) ||
F_186 ( V_73 , V_258 , & V_269 -> V_45 ) ||
F_186 ( V_73 , V_259 , & V_269 -> V_46 ) ||
F_187 ( V_73 , V_260 , V_269 -> V_200 ) ||
F_187 ( V_73 , V_261 , V_269 -> V_119 ) ||
F_188 ( V_73 , V_262 , V_269 -> V_220 ) ||
F_185 ( V_73 , V_263 , V_269 -> V_47 ) ||
F_187 ( V_73 , V_256 , V_269 -> V_112 ) )
goto V_270;
return 0 ;
V_270:
return - V_193 ;
}
struct V_37 * F_189 ( const struct V_7 * V_8 )
{
struct V_28 * V_268 = F_43 ( V_8 ) ;
return V_268 -> V_37 ;
}
static void T_11 F_190 ( struct V_37 * V_37 )
{
struct V_40 * V_41 = F_34 ( V_37 , V_42 ) ;
...
F_181 ( V_29 -> V_8 , & V_272 ) ;
V_29 = F_40 ( V_29 -> V_56 ) ;
}
}
F_193 ( & V_272 ) ;
}
static int T_9 F_194 ( struct V_37 * V_37 )
{
struct V_40 * V_41 = F_34 ( V_37 , V_42 ) ;
...
V_58 = F_171 ( V_41 -> V_71 ) ;
if ( V_58 < 0 )
goto V_278;
V_58 = F_195 ( V_41 -> V_71 ) ;
if ( V_58 < 0 )
goto V_278;
V_29 = F_43 ( V_41 -> V_71 ) ;
...
static void T_11 F_196 ( struct V_37 * V_37 )
{
F_197 () ;
F_190 ( V_37 ) ;
F_198 () ;
...
if ( V_58 < 0 )
goto V_280;
V_58 = F_201 ( & V_281 , V_282 ) ;
if ( V_58 < 0 ) {
F_202 ( L_11 , V_283 ) ;
goto V_284;
}
V_58 = F_201 ( & V_285 , V_286 ) ;
if ( V_58 < 0 ) {
F_202 ( L_12 , V_283 ) ;
goto V_287;
}
...
static void T_13 F_206 ( void )
{
F_207 ( & V_62 ) ;
if ( F_204 ( & V_281 , V_282 ) )
F_208 ( L_13 , V_283 ) ;
if ( F_204 ( & V_285 , V_286 ) )
F_208 ( L_14 , V_283 ) ;
F_205 ( & V_279 ) ;
}
