...
F_147 ( & V_29 , V_27 ) ;
F_138 ( V_25 -> V_105 , & V_29 , 1 ) ;
if ( V_25 -> V_184 && V_25 -> V_184 -> V_197 )
V_25 -> V_184 -> V_197 ( V_27 ) ;
F_144 ( V_170 , V_27 ) ;
return 1 ;
}
return 0 ;
...
void F_154 ( struct V_60 * V_27 , struct V_135 * V_198 ,
struct V_140 * V_141 )
{
F_155 ( V_27 ) ;
F_93 ( V_141 , L_36 ) ;
if ( V_141 -> V_145 & V_199 ) {
F_21 ( V_200 , L_37 ) ;
return;
}
F_45 ( F_67 ( & V_141 -> V_144 ) ) ;
F_156 ( & V_141 -> V_144 , V_198 ) ;
}
void F_157 ( struct V_140 * V_141 )
{
int type = V_141 -> V_201 -> V_190 ;
F_155 ( V_141 -> V_201 ) ;
if ( type == V_202 || type == V_203 )
F_158 ( V_141 ) ;
else if ( type == V_204 )
F_159 ( V_141 ) ;
F_115 ( & V_141 -> V_144 ) ;
}
void F_160 ( struct V_60 * V_27 , struct V_205 * V_206 )
{
V_206 -> V_190 = V_27 -> V_190 ;
V_206 -> V_87 = V_27 -> V_87 ;
}
void F_2 ( T_7 V_88 , int V_207 )
{
struct V_135 * V_38 ;
if ( ! ( ( V_208 | V_156 ) & V_207 ) )
return;
F_65 ( F_66 ( V_88 ) ) ;
...
{
struct V_60 * V_27 = F_98 ( V_65 , V_85 ) ;
int V_207 = ( int ) ( unsigned long ) V_152 ;
F_88 ( V_27 ) ;
F_102 ( V_207 , V_27 ) ;
F_92 ( V_27 ) ;
return 0 ;
}
void F_161 ( int V_207 , struct V_24 * V_25 )
{
if ( ! ( ( V_208 | V_156 ) & V_207 ) )
return;
F_21 ( V_207 , L_38 ,
F_22 ( V_25 ) , F_47 ( & V_25 -> V_124 ) ) ;
if ( F_163 ( F_164 () , V_25 -> V_209 ) )
return;
F_103 ( V_25 -> V_105 ,
F_162 ,
( void * ) ( unsigned long ) V_207 ) ;
F_110 ( & V_25 -> V_123 ) ;
V_25 -> V_209 = F_165 ( 10 ) ;
F_111 ( & V_25 -> V_123 ) ;
}
void F_102 ( int V_207 , struct V_60 * V_27 )
{
struct V_140 * V_141 ;
