...
T_1 V_147 = F_38 ( V_146 ) ;
T_1 V_148 = F_39 ( V_146 ) ;
switch ( V_145 ) {
case V_149 :
case V_150 :
case V_151 :
...
V_182 = F_27 ( V_2 -> V_188 ) ;
V_181 = ( T_4 ) V_182 * V_183 ;
F_54 ( V_181 , V_189 [ V_63 ] * 1024 ) ;
F_54 ( V_181 , 128 * 1024 ) ;
...
static int F_56 ( struct V_155 * V_156 ,
struct V_157 * V_158 )
{
V_158 -> type = V_177 ;
V_158 -> V_160 = 1 ;
...
static int F_59 ( struct V_108 * V_140 )
{
struct V_1 * V_193 = F_25 ( V_140 ) ;
F_60 ( V_140 , & V_193 -> V_194 ,
& V_193 -> V_195 ) ;
F_61 ( V_140 , V_196 , F_62 ( V_196 ) ) ;
return 0 ;
}
static bool F_63 ( struct V_197 * V_9 , unsigned int V_20 )
{
switch ( V_20 ) {
case V_54 :
case V_190 :
...
static bool F_64 ( struct V_197 * V_9 , unsigned int V_20 )
{
switch ( V_20 ) {
case V_7 :
case V_30 :
...
static bool F_65 ( struct V_197 * V_9 , unsigned int V_20 )
{
switch ( V_20 ) {
case V_54 :
case V_190 :
...
bool V_206 = F_67 ( V_81 , V_2 -> V_188 ) ;
...
if ( ! F_27 ( V_81 ) )
continue;
V_84 = F_66 ( V_2 , V_81 , V_202 , V_204 ,
V_110 == V_97 ) ;
if ( V_202 == V_84 )
continue;
V_202 = V_84 ;
...
if ( F_67 ( V_2 -> V_99 [ V_204 ] , V_2 -> V_188 ) )
F_3 ( & V_5 -> V_9 , L_40 ,
...
if ( ! V_216 )
return - V_221 ;
V_2 = F_74 ( & V_5 -> V_9 , sizeof( * V_2 ) , V_222 ) ;
if ( ! V_2 )
return - V_223 ;
V_2 -> V_5 = V_5 ;
memcpy ( & V_2 -> V_224 , & V_225 , sizeof( V_225 ) ) ;
V_2 -> V_224 . V_13 = F_75 ( & V_5 -> V_9 ) ;
V_219 = F_76 ( V_5 , V_226 , 0 ) ;
V_220 = F_77 ( & V_5 -> V_9 , V_219 ) ;
if ( F_71 ( V_220 ) )
return F_72 ( V_220 ) ;
...
V_2 -> V_188 = F_70 ( & V_5 -> V_9 , L_46 ) ;
if ( F_71 ( V_2 -> V_188 ) ) {
F_7 ( & V_5 -> V_9 , L_47 ) ;
return F_72 ( V_2 -> V_188 ) ;
}
V_2 -> V_112 = F_70 ( & V_5 -> V_9 , L_42 ) ;
if ( F_71 ( V_2 -> V_112 ) ) {
F_7 ( & V_5 -> V_9 , L_48 ) ;
return F_72 ( V_2 -> V_112 ) ;
}
V_2 -> V_134 = F_70 ( & V_5 -> V_9 , L_49 ) ;
if ( F_71 ( V_2 -> V_134 ) ) {
F_7 ( & V_5 -> V_9 , L_50 ) ;
return F_72 ( V_2 -> V_134 ) ;
}
V_2 -> V_65 = V_228 ;
for ( V_110 = 0 ; V_110 < V_126 ; V_110 ++ ) {
V_84 = F_69 ( V_2 , V_110 ) ;
...
static int F_85 ( struct V_197 * V_9 )
{
...
static int F_88 ( struct V_197 * V_9 )
{
struct V_1 * V_2 = F_86 ( V_9 ) ;
F_87 ( V_2 -> V_3 , false ) ;
F_5 ( V_2 -> V_3 , V_7 ,
