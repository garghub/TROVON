...
static inline int F_70 ( int V_99 , struct V_17 * V_18 ,
...
! F_73 ( V_94 -> V_103 , & V_94 -> V_104 , & V_94 -> V_24 ) )
F_68 ( V_18 ) ;
if ( ! V_72 ) {
F_66 ( V_18 ) ;
if ( ! V_18 -> V_56 )
F_67 ( V_18 ) ;
F_74 ( V_99 , V_105 , V_94 -> V_60 -> V_23 , NULL , V_18 ,
NULL , F_27 ( V_18 ) -> V_38 , V_106 ) ;
} else
V_95 = V_96 ;
return V_95 ;
}
static inline int F_75 ( int V_99 , struct V_17 * V_18 ,
struct V_93 * V_94 , int V_72 )
{
int V_95 = V_100 ;
V_18 -> V_97 = 1 ;
...
{
return F_75 ( V_109 , V_18 , V_94 , 1 ) ;
}
int
F_77 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_61 * V_62 )
{
...
int
F_85 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_61 * V_62 )
{
struct V_22 * V_29 ;
...
T_3 V_118 , * V_119 ;
V_119 = F_86 ( V_18 , V_62 -> V_21 , sizeof( V_118 ) , & V_118 ) ;
if ( V_119 == NULL )
goto V_112;
F_87 ( V_94 , * V_119 ) ;
F_37 ( 10 , L_12 , F_88 ( * V_119 ) ) ;
}
V_116 = F_89 ( F_30 ( V_18 ) ) ;
...
enum V_122 V_123 ;
struct V_124 * V_125 = F_91 ( V_18 , & V_123 ) ;
if ( V_125 && ! F_92 ( V_125 ) ) {
F_93 ( 10 , V_126 , V_108 , V_18 , V_62 -> V_127 ,
L_13
L_14 ) ;
goto V_112;
}
...
F_93 ( 1 , V_126 , V_108 , V_18 , V_62 -> V_127 ,
L_15
L_16 ) ;
goto V_112;
}
if ( ! F_94 ( V_18 , sizeof( struct V_81 ) ) )
goto V_112;
if ( F_95 ( V_18 , V_29 -> V_7 . V_38 -> V_128 ) )
goto V_112;
if ( V_108 -> V_129 && ! V_108 -> V_129 ( V_18 , V_108 , V_94 , V_62 ) )
goto V_112;
F_29 ( V_18 ) -> V_24 = V_94 -> V_24 . V_76 ;
F_80 ( F_29 ( V_18 ) ) ;
F_96 ( 10 , V_126 , V_108 , V_18 , V_62 -> V_127 , L_17 ) ;
V_18 -> V_113 = 1 ;
V_115 = F_70 ( V_109 , V_18 , V_94 , V_72 ) ;
F_81 () ;
F_82 ( 10 ) ;
return V_115 ;
V_112:
...
int
F_97 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_61 * V_62 )
{
struct V_37 * V_29 ;
int V_72 , V_115 ;
...
struct V_124 * V_125 = F_91 ( V_18 , & V_123 ) ;
if ( V_125 && ! F_92 ( V_125 ) ) {
F_93 ( 10 , V_50 , V_108 , V_18 , V_62 -> V_127 ,
L_18
L_14 ) ;
goto V_112;
}
...
F_93 ( 1 , V_50 , V_108 , V_18 , V_62 -> V_127 ,
L_18
L_19 ) ;
goto V_112;
}
if ( ! F_94 ( V_18 , sizeof( struct V_91 ) ) )
goto V_112;
if ( F_95 ( V_18 , V_29 -> V_7 . V_38 -> V_128 ) )
goto V_112;
if ( V_108 -> V_129 && ! V_108 -> V_129 ( V_18 , V_108 , V_94 , V_62 ) )
...
F_96 ( 10 , V_50 , V_108 , V_18 , V_62 -> V_127 , L_17 ) ;
V_18 -> V_113 = 1 ;
V_115 = F_70 ( V_114 , V_18 , V_94 , V_72 ) ;
F_81 () ;
F_82 ( 10 ) ;
return V_115 ;
V_112:
...
static struct V_17 *
F_98 ( struct V_17 * V_18 , int V_41 ,
...
#endif
F_68 ( V_18 ) ;
if ( F_99 ( V_18 ) < V_130 || F_100 ( V_18 ) ) {
V_136 = F_101 ( V_18 , V_130 ) ;
if ( ! V_136 )
goto error;
if ( V_18 -> V_56 )
F_102 ( V_136 , V_18 -> V_56 ) ;
F_103 ( V_18 ) ;
V_18 = V_136 ;
}
#ifdef F_24
...
static inline int F_107 ( int V_144 , int V_145 )
{
if ( V_144 == V_126 ) {
if ( V_145 == V_126 )
return V_146 ;
...
int
F_108 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_61 * V_62 )
{
...
V_29 = F_30 ( V_18 ) ;
V_149 = V_29 -> V_7 . V_38 ;
V_130 = F_109 ( V_149 ) + sizeof( struct V_81 ) ;
V_150 = F_38 ( V_60 ) ? & V_135 : NULL ;
V_18 = F_98 ( V_18 , V_94 -> V_103 , V_130 ,
& V_131 , NULL , & V_133 ,
& V_134 , V_150 ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 = F_110 (
V_18 , false , F_107 ( V_126 , V_94 -> V_103 ) ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 -> V_151 = V_18 -> V_152 ;
F_111 ( V_18 , sizeof( struct V_81 ) ) ;
F_112 ( V_18 ) ;
memset ( & ( F_113 ( V_18 ) -> V_153 ) , 0 , sizeof( F_113 ( V_18 ) -> V_153 ) ) ;
V_110 = F_29 ( V_18 ) ;
V_110 -> V_154 = 4 ;
...
V_110 -> V_26 = V_26 ;
V_110 -> V_134 = V_134 ;
F_114 ( V_23 , V_18 , NULL ) ;
V_18 -> V_113 = 1 ;
V_95 = F_63 ( V_18 , V_94 ) ;
if ( V_95 == V_96 )
F_115 ( V_23 , V_18 -> V_56 , V_18 ) ;
else if ( V_95 == V_158 )
F_83 ( V_18 ) ;
F_81 () ;
F_82 ( 10 ) ;
...
int
F_116 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_61 * V_62 )
{
struct V_37 * V_29 ;
struct V_83 V_26 ;
...
if ( V_72 ) {
F_81 () ;
return F_75 ( V_114 , V_18 , V_94 , 1 ) ;
}
V_29 = (struct V_37 * ) F_27 ( V_18 ) ;
V_149 = V_29 -> V_7 . V_38 ;
V_130 = F_109 ( V_149 ) + sizeof( struct V_91 ) ;
V_18 = F_98 ( V_18 , V_94 -> V_103 , V_130 ,
& V_131 , & V_132 ,
& V_133 , & V_134 , NULL ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 = F_110 (
V_18 , false , F_107 ( V_50 , V_94 -> V_103 ) ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 -> V_151 = V_18 -> V_152 ;
F_111 ( V_18 , sizeof( struct V_91 ) ) ;
F_112 ( V_18 ) ;
memset ( & ( F_113 ( V_18 ) -> V_153 ) , 0 , sizeof( F_113 ( V_18 ) -> V_153 ) ) ;
V_110 = F_26 ( V_18 ) ;
V_110 -> V_154 = 6 ;
...
V_95 = F_63 ( V_18 , V_94 ) ;
if ( V_95 == V_96 )
F_118 ( V_94 -> V_60 -> V_23 , V_18 -> V_56 , V_18 ) ;
else if ( V_95 == V_158 )
F_83 ( V_18 ) ;
F_81 () ;
F_82 ( 10 ) ;
...
int
F_125 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , int V_161 , unsigned int V_162 ,
struct V_61 * V_62 )
{
struct V_37 * V_29 ;
