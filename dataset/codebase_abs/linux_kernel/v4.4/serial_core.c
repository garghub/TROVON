...
* V_111 = V_275 ;
V_272 += 7 ;
} else if ( strncmp ( V_272 , L_26 , 9 ) == 0 ) {
* V_111 = V_276 ;
V_272 += 9 ;
} else if ( strncmp ( V_272 , L_27 , 13 ) == 0 ) {
* V_111 = F_124 ( V_277 ) ?
V_276 : V_275 ;
V_272 += 13 ;
} else if ( strncmp ( V_272 , L_28 , 3 ) == 0 ) {
* V_111 = V_278 ;
V_272 += 3 ;
} else if ( strncmp ( V_272 , L_29 , 2 ) == 0 ) {
* V_111 = V_259 ;
} else {
return - V_132 ;
}
...
void
F_126 ( char * V_274 , int * V_45 , int * V_184 , int * V_46 , int * V_279 )
{
char * V_266 = V_274 ;
...
F_128 ( & V_5 -> V_12 ) ;
F_129 ( & V_5 -> V_12 , & V_282 ) ;
}
memset ( & V_33 , 0 , sizeof( struct V_56 ) ) ;
V_33 . V_34 = V_283 | V_43 | V_76 ;
for ( V_254 = 0 ; V_284 [ V_254 ] . V_285 ; V_254 ++ )
if ( V_284 [ V_254 ] . V_285 <= V_45 )
break;
V_33 . V_34 |= V_284 [ V_254 ] . V_32 ;
if ( V_46 == 7 )
V_33 . V_34 |= V_50 ;
else
V_33 . V_34 |= V_286 ;
...
if ( V_7 -> V_256 != V_256 ) {
if ( V_5 -> V_13 -> V_288 )
V_5 -> V_13 -> V_288 ( V_5 , V_256 , V_7 -> V_256 ) ;
V_7 -> V_256 = V_256 ;
}
}
static int F_130 ( struct V_289 * V_145 , void * V_290 )
{
struct V_291 * V_292 = V_290 ;
struct V_261 * V_293 = V_292 -> V_231 -> V_261 ;
T_6 V_294 = F_131 ( V_293 -> V_295 , V_293 -> V_296 ) +
V_292 -> V_5 -> line ;
...
F_59 ( & V_5 -> V_116 ) ;
V_297 = F_133 ( V_2 -> V_145 , & V_292 , F_130 ) ;
if ( F_134 ( V_297 ) ) {
if ( ! F_135 ( V_2 -> V_103 ) )
V_2 -> V_298 = 1 ;
F_136 ( V_297 ) ;
...
F_137 ( 10 ) ;
if ( ! V_303 )
F_138 ( V_2 -> V_145 , L_30 ,
V_230 -> V_304 ,
V_230 -> V_261 -> V_305 + V_2 -> line ) ;
V_13 -> V_244 ( V_2 ) ;
}
if ( F_16 ( V_2 ) )
F_139 ( V_2 -> V_31 ) ;
...
switch ( V_5 -> V_111 ) {
case V_278 :
snprintf ( V_307 , sizeof( V_307 ) , L_31 , V_5 -> V_100 ) ;
break;
case V_308 :
snprintf ( V_307 , sizeof( V_307 ) ,
L_32 , V_5 -> V_100 , V_5 -> V_109 ) ;
break;
case V_259 :
case V_275 :
case V_276 :
...
case V_310 :
snprintf ( V_307 , sizeof( V_307 ) ,
L_33 , ( unsigned long long ) V_5 -> V_115 ) ;
break;
default:
F_144 ( V_307 , L_34 , sizeof( V_307 ) ) ;
break;
}
F_145 ( V_311 L_35 ,
...
if ( V_274 ) {
F_126 ( V_274 , & V_45 , & V_184 , & V_46 , & V_279 ) ;
return F_127 ( V_5 , NULL , V_45 , V_184 , V_46 , V_279 ) ;
}
return 0 ;
}
...
{
struct V_229 * V_272 = V_269 -> V_290 ;
* V_89 = V_269 -> V_89 ;
return V_272 -> V_261 ;
}
static T_7 F_163 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_105 * 16 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . type ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . line ) ;
}
...
return snprintf ( V_27 , V_334 , L_38 , V_335 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_103 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_39 , V_117 . V_11 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_104 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_106 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_107 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_69 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_110 ) ;
}
...
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_38 , ( unsigned long ) V_117 . V_114 ) ;
}
static T_7 F_176 ( struct V_289 * V_145 ,
struct V_332 * V_333 , char * V_27 )
{
struct V_98 V_117 ;
struct V_39 * V_5 = F_164 ( V_145 ) ;
F_58 ( V_5 , & V_117 ) ;
return snprintf ( V_27 , V_334 , L_37 , V_117 . V_112 ) ;
}
...
V_7 -> V_256 = V_338 ;
V_2 -> V_31 = V_230 -> V_31 ;
V_2 -> V_322 = V_230 -> V_261 -> V_296 + V_2 -> line ;
if ( ! ( F_16 ( V_2 ) && ( V_2 -> V_31 -> V_11 & V_281 ) ) ) {
F_128 ( & V_2 -> V_12 ) ;
F_129 ( & V_2 -> V_12 , & V_282 ) ;
}
...
V_297 = F_181 ( V_5 , V_230 -> V_261 ,
V_2 -> line , V_2 -> V_145 , V_5 , V_2 -> V_341 ) ;
if ( F_182 ( ! F_183 ( V_297 ) ) ) {
F_184 ( V_297 , 1 ) ;
} else {
F_138 ( V_2 -> V_145 , L_40 ,
V_2 -> line ) ;
}
V_2 -> V_11 &= ~ V_248 ;
V_201:
