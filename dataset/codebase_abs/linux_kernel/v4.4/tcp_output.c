...
struct V_3 * F_246 ( const struct V_1 * V_2 , struct V_17 * V_18 ,
struct V_74 * V_75 ,
struct V_132 * V_133 ,
bool V_439 )
{
...
F_239 ( V_4 , V_323 ) ;
if ( V_439 ) {
F_248 ( V_4 , F_249 ( V_75 ) ) ;
} else {
F_248 ( V_4 , (struct V_1 * ) V_2 ) ;
}
F_250 ( V_4 , V_18 ) ;
V_19 = F_15 ( V_18 ) ;
V_440 = F_251 ( V_8 -> V_58 . V_440 ) ;
if ( V_440 && V_440 < V_19 )
V_19 = V_440 ;
memset ( & V_99 , 0 , sizeof( V_99 ) ) ;
#ifdef F_252
if ( F_52 ( V_75 -> V_441 ) )
V_4 -> V_217 . V_442 = F_253 ( V_75 ) ;
else
#endif
F_99 ( & V_4 -> V_217 ) ;
#ifdef F_56
F_254 () ;
V_143 = F_255 ( V_75 ) -> V_149 -> V_443 ( V_2 , F_249 ( V_75 ) ) ;
#endif
F_256 ( V_4 , F_255 ( V_75 ) -> V_444 , V_445 ) ;
...
V_77 -> V_447 = 1 ;
F_42 ( V_75 , V_77 ) ;
V_77 -> V_222 = F_111 ( V_166 -> V_448 ) ;
V_77 -> V_224 = V_166 -> V_449 ;
F_48 ( V_4 , F_255 ( V_75 ) -> V_450 ,
V_93 | V_236 ) ;
V_77 -> V_82 = F_53 ( F_5 ( V_4 ) -> V_82 ) ;
V_77 -> V_226 = F_53 ( F_255 ( V_75 ) -> V_60 ) ;
V_77 -> V_228 = F_111 ( F_20 ( V_75 -> V_451 , 65535U ) ) ;
F_51 ( ( T_8 * ) ( V_77 + 1 ) , NULL , & V_99 ) ;
V_77 -> V_452 = ( V_215 >> 2 ) ;
F_257 ( F_9 ( V_2 ) , V_237 ) ;
#ifdef F_56
if ( V_143 )
F_255 ( V_75 ) -> V_149 -> V_234 ( V_99 . V_105 ,
V_143 , F_249 ( V_75 ) , V_4 ) ;
F_258 () ;
#endif
V_4 -> V_241 . V_242 = 0 ;
return V_4 ;
}
static void F_259 ( struct V_1 * V_2 , const struct V_17 * V_18 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
const struct V_453 * V_454 ;
T_4 V_455 = F_260 ( V_18 , V_456 ) ;
if ( V_455 == V_457 )
return;
F_254 () ;
V_454 = F_261 ( V_455 ) ;
if ( F_54 ( V_454 && F_262 ( V_454 -> V_458 ) ) ) {
F_263 ( V_6 -> V_459 -> V_458 ) ;
V_6 -> V_460 = F_264 ( V_18 ) ;
V_6 -> V_459 = V_454 ;
}
F_258 () ;
}
...
#endif
if ( V_8 -> V_58 . V_440 )
V_8 -> V_58 . V_291 = V_8 -> V_58 . V_440 ;
V_8 -> V_461 = 0 ;
F_156 ( V_2 ) ;
F_157 ( V_2 , F_159 ( V_18 ) ) ;
F_259 ( V_2 , V_18 ) ;
if ( ! V_8 -> V_45 )
V_8 -> V_45 = F_260 ( V_18 , V_462 ) ;
V_8 -> V_20 = F_15 ( V_18 ) ;
if ( V_8 -> V_58 . V_440 && V_8 -> V_58 . V_440 < V_8 -> V_20 )
V_8 -> V_20 = V_8 -> V_58 . V_440 ;
F_266 ( V_2 ) ;
if ( V_2 -> V_463 & V_464 &&
( V_8 -> V_45 > F_214 ( V_2 ) || V_8 -> V_45 == 0 ) )
V_8 -> V_45 = F_214 ( V_2 ) ;
F_28 ( F_214 ( V_2 ) ,
V_8 -> V_20 - ( V_8 -> V_58 . V_465 ? V_8 -> V_80 - sizeof( struct V_76 ) : 0 ) ,
& V_8 -> V_44 ,
& V_8 -> V_45 ,
V_157 ,
& V_47 ,
...
static int F_272 ( struct V_1 * V_2 , struct V_3 * V_446 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_146 * V_472 = V_8 -> V_148 ;
int V_473 = 0 , V_49 , V_216 = 0 ;
unsigned long V_474 = 0 ;
struct V_3 * V_475 ;
V_8 -> V_58 . V_291 = V_8 -> V_20 ;
F_273 ( V_2 , & V_8 -> V_58 . V_291 , & V_472 -> V_161 ,
& V_473 , & V_474 ) ;
if ( V_473 > 1 &&
F_274 ( V_476 , V_474 + ( 60 * V_348 << V_473 ) ) ) {
V_472 -> V_161 . V_81 = - 1 ;
goto V_477;
}
if ( V_478 & V_479 )
V_472 -> V_161 . V_81 = - 1 ;
else if ( V_472 -> V_161 . V_81 <= 0 )
goto V_477;
if ( V_8 -> V_58 . V_440 && V_8 -> V_58 . V_440 < V_8 -> V_58 . V_291 )
V_8 -> V_58 . V_291 = V_8 -> V_58 . V_440 ;
V_49 = F_152 ( V_2 , F_2 ( V_2 ) -> V_303 ) -
V_145 ;
V_49 = F_30 ( V_480 , V_49 , V_472 -> V_169 ) ;
V_49 = F_30 ( V_480 , V_49 , F_275 ( V_323 ) ) ;
V_475 = F_136 ( V_2 , V_49 , V_2 -> V_385 , false ) ;
if ( ! V_475 )
goto V_477;
V_475 -> V_89 = V_90 ;
memcpy ( V_475 -> V_243 , V_446 -> V_243 , sizeof( V_446 -> V_243 ) ) ;
if ( V_49 ) {
int V_481 = F_276 ( F_138 ( V_475 , V_49 ) , V_49 ,
& V_472 -> V_181 -> V_482 ) ;
if ( F_52 ( ! V_481 ) ) {
F_277 ( V_475 ) ;
goto V_477;
...
V_472 -> V_481 = V_49 ;
F_270 ( V_2 , V_475 ) ;
V_216 = F_97 ( V_2 , V_475 , 1 , V_2 -> V_385 ) ;
V_446 -> V_217 = V_475 -> V_217 ;
F_5 ( V_475 ) -> V_82 ++ ;
F_5 ( V_475 ) -> V_64 = V_236 | V_279 ;
if ( ! V_216 ) {
V_8 -> V_475 = ( V_472 -> V_481 > 0 ) ;
F_34 ( F_9 ( V_2 ) , V_16 ) ;
goto V_483;
}
V_477:
if ( V_472 -> V_161 . V_81 > 0 )
V_472 -> V_161 . V_81 = 0 ;
V_216 = F_97 ( V_2 , V_446 , 1 , V_2 -> V_385 ) ;
if ( V_216 )
V_8 -> V_163 = 0 ;
V_483:
V_472 -> V_161 . V_81 = - 1 ;
...
F_270 ( V_2 , V_273 ) ;
F_39 ( V_2 , V_273 ) ;
V_216 = V_8 -> V_148 ? F_272 ( V_2 , V_273 ) :
...
V_37 = F_20 ( V_37 , V_489 ) ;
}
V_366 = V_476 + V_37 ;
if ( V_6 -> V_35 . V_490 & V_492 ) {
if ( V_6 -> V_35 . V_493 ||
F_281 ( V_6 -> V_35 . V_366 , V_476 + ( V_37 >> 2 ) ) ) {
F_282 ( V_2 ) ;
return;
}
if ( ! F_274 ( V_366 , V_6 -> V_35 . V_366 ) )
V_366 = V_6 -> V_35 . V_366 ;
}
V_6 -> V_35 . V_490 |= V_494 | V_492 ;
V_6 -> V_35 . V_366 = V_366 ;
F_283 ( V_2 , & V_6 -> V_495 , V_366 ) ;
}
...
static int F_286 ( struct V_1 * V_2 , int V_498 , int V_499 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_3 * V_4 ;
...
{
if ( V_2 -> V_173 == V_500 ) {
F_3 ( V_2 ) -> V_501 = F_3 ( V_2 ) -> V_60 - 1 ;
F_286 ( V_2 , 0 , V_502 ) ;
}
}
int F_288 ( struct V_1 * V_2 , int V_499 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_3 * V_4 ;
if ( V_2 -> V_173 == V_384 )
...
unsigned int V_503 = F_12 ( V_8 ) - F_5 ( V_4 ) -> V_82 ;
if ( F_11 ( V_8 -> V_485 , F_5 ( V_4 ) -> V_12 ) )
V_8 -> V_485 = F_5 ( V_4 ) -> V_12 ;
if ( V_503 < F_5 ( V_4 ) -> V_12 - F_5 ( V_4 ) -> V_82 ||
V_4 -> V_81 > V_19 ) {
V_503 = F_20 ( V_503 , V_19 ) ;
F_5 ( V_4 ) -> V_64 |= V_279 ;
if ( F_132 ( V_2 , V_4 , V_503 , V_19 , V_180 ) )
return - 1 ;
} else if ( ! F_6 ( V_4 ) )
F_122 ( V_4 , V_19 ) ;
F_5 ( V_4 ) -> V_64 |= V_279 ;
...
if ( F_289 ( V_8 -> V_96 , V_8 -> V_95 + 1 , V_8 -> V_95 + 0xFFFF ) )
F_286 ( V_2 , 1 , V_499 ) ;
return F_286 ( V_2 , 0 , V_499 ) ;
}
}
...
int F_292 ( const struct V_1 * V_2 , struct V_74 * V_75 )
{
const struct V_510 * V_511 = F_255 ( V_75 ) -> V_149 ;
struct V_512 V_248 ;
int V_513 ;
F_255 ( V_75 ) -> V_444 = F_293 () ;
V_513 = V_511 -> V_514 ( V_2 , NULL , & V_248 , V_75 , NULL , true ) ;
if ( ! V_513 ) {
F_257 ( F_9 ( V_2 ) , V_409 ) ;
F_204 ( F_9 ( V_2 ) , V_410 ) ;
}
