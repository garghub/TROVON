...
int V_10 = 0 ;
int V_54 = ! ! ( V_50 & V_55 ) ;
if ( V_50 == V_33 -> V_41 || ( V_33 -> V_41 & V_56 ) ||
F_65 ( V_33 ) || V_33 == F_66 ( V_57 -> V_52 ) )
goto V_18;
V_53 = V_33 -> V_58 + ( ( V_35 - V_33 -> V_59 ) >> V_48 ) ;
* V_49 = F_67 ( V_52 , * V_49 , V_35 , V_36 , V_50 , V_33 -> V_60 ,
V_33 -> V_61 , V_53 , F_68 ( V_33 ) ,
V_33 -> V_62 ) ;
if ( * V_49 ) {
V_33 = * V_49 ;
goto V_63;
...
static int F_70 ( unsigned long V_35 , T_5 V_66 ,
T_3 V_67 )
{
...
if ( V_36 == V_35 )
return 0 ;
V_33 = F_73 ( V_57 -> V_52 , V_35 ) ;
if ( ! V_33 || V_33 -> V_59 > V_35 )
return - V_21 ;
V_49 = V_33 -> V_71 ;
if ( V_35 > V_33 -> V_59 )
V_49 = V_33 ;
for ( V_68 = V_35 ; ; ) {
T_3 V_50 = V_33 -> V_41 & V_42 ;
V_50 |= V_67 ;
V_69 = V_33 -> V_64 ;
if ( V_69 > V_36 )
V_69 = V_36 ;
error = F_64 ( V_33 , & V_49 , V_68 , V_69 , V_50 ) ;
if ( error )
break;
V_68 = V_69 ;
if ( V_68 < V_49 -> V_64 )
...
static int F_74 ( unsigned long V_35 , T_5 V_66 , T_3 V_67 )
{
unsigned long V_73 ;
unsigned long V_74 ;
int error = - V_21 ;
...
error = F_70 ( V_35 , V_66 , V_67 ) ;
F_77 ( & V_57 -> V_52 -> V_77 ) ;
if ( error )
return error ;
error = F_78 ( V_35 , V_66 , 0 ) ;
if ( error )
return F_33 ( error ) ;
return 0 ;
}
static int F_79 ( int V_67 )
{
...
for ( V_33 = V_57 -> V_52 -> V_84 ; V_33 ; V_33 = V_49 -> V_72 ) {
T_3 V_50 ;
V_50 = V_33 -> V_41 & V_42 ;
V_50 |= V_78 ;
F_64 ( V_33 , & V_49 , V_33 -> V_59 , V_33 -> V_64 , V_50 ) ;
F_80 () ;
}
V_18:
return 0 ;
}
int F_81 ( T_5 V_85 , struct V_86 * V_87 )
{
unsigned long V_74 , V_73 ;
int V_88 = 0 ;
V_73 = ( V_85 + V_40 - 1 ) >> V_48 ;
V_74 = F_2 ( V_1 ) ;
if ( V_74 == V_89 )
V_88 = 1 ;
V_74 >>= V_48 ;
...
void F_85 ( T_5 V_85 , struct V_86 * V_87 )
{
F_82 ( & V_90 ) ;
V_87 -> V_91 -= ( V_85 + V_40 - 1 ) >> V_48 ;
F_84 ( & V_90 ) ;
F_86 ( V_87 ) ;
}
