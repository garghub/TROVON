...
struct V_1 * V_2 ;
unsigned long V_30 = V_32 + ( V_200 * V_38 ) ;
int V_34 = 0 ;
F_20 () ;
V_2 = F_21 ( V_6 -> V_10 ) ;
...
{
struct V_205 * V_206 = V_74 -> V_75 ;
struct V_4 * V_5 = V_206 -> V_76 ;
...
V_12 = F_172 ( V_12 , NULL , V_209 . V_15 ) ;
F_3 ( V_2 ) ;
return V_12 ;
V_223:
F_3 ( V_2 ) ;
...
{
struct V_4 * V_224 = V_74 -> V_75 -> V_76 ;
struct V_6 * V_6 = F_7 ( V_224 ,
struct V_6 ,
V_7 ) ;
struct V_97 * V_57 = V_224 -> V_96 ;
struct V_190 V_191 = {
. V_62 = V_224 -> V_94 ,
. V_197 = V_6 -> V_95 ,
...
V_226 = V_6 -> V_71 ;
V_227 = V_226 + V_228 * V_38 ;
if ( F_175 ( V_31 , V_226 , V_227 ) )
return 1 ;
}
return 0 ;
}
...
if ( V_230 != V_214 )
goto V_233;
V_229 = F_167 ( V_74 -> V_75 -> V_215 ) ;
V_211 . V_217 = & V_229 ;
V_211 . V_220 = sizeof( V_229 ) ;
F_170 ( & V_211 , & V_213 ) ;
V_209 . V_20 = ( V_221 * ) V_12 ;
V_209 . V_15 = V_15 ;
V_34 = F_15 ( - V_41 ) ;
V_208 = F_180 ( V_2 -> V_43 , & V_213 , & V_209 ) ;
if ( V_208 == V_222 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_208 ) {
F_29 ( L_30 ,
V_74 -> V_98 , V_46 , V_208 ) ;
goto V_233;
}
...
static void F_182 ( T_9 V_235 , struct V_205 * V_236 ,
T_8 * V_12 , void * V_237 )
{
struct V_238 V_239 ;
F_183 ( & V_239 , & V_236 -> V_219 , V_12 ) ;
V_235 ( V_236 , & V_239 , V_237 ) ;
}
static inline int
F_184 ( struct V_4 * V_5 , struct V_1 * V_2 ,
T_9 V_235 , struct V_205 * V_236 ,
T_8 * V_12 , void * V_237 )
{
struct V_212 * V_240 = & V_236 -> V_219 ;
struct V_212 V_241 ;
T_8 * V_242 = NULL ;
struct V_18 V_209 ;
T_2 V_243 ;
...
int V_244 = - V_231 ;
V_242 = V_12 ++ ;
V_243 = ( V_221 * ) V_12 - ( V_221 * ) V_240 -> V_187 [ 0 ] . V_217 ;
* V_12 ++ = F_167 ( V_236 -> V_215 ) ;
F_182 ( V_235 , V_236 , V_12 , V_237 ) ;
if ( F_185 ( V_240 , & V_241 ,
V_243 , V_240 -> V_15 - V_243 ) )
return V_244 ;
* V_242 = F_167 ( V_241 . V_15 ) ;
if ( V_240 -> V_245 || V_240 -> V_246 [ 0 ] . V_220 )
V_211 = V_240 -> V_246 ;
else
V_211 = V_240 -> V_187 ;
V_12 = V_211 -> V_217 + V_211 -> V_220 ;
V_209 . V_20 = ( V_221 * ) ( V_12 + 1 ) ;
V_208 = F_171 ( V_2 -> V_43 , & V_241 , & V_209 ) ;
V_244 = - V_231 ;
if ( V_208 == V_222 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
else if ( V_208 )
return V_244 ;
V_16 = F_172 ( V_12 , NULL , V_209 . V_15 ) ;
V_243 = ( V_221 * ) V_16 - ( V_221 * ) V_12 ;
V_211 -> V_220 += V_243 ;
V_240 -> V_15 += V_243 ;
return 0 ;
}
static void
F_186 ( struct V_205 * V_236 )
{
int V_247 ;
...
memcpy ( V_260 , V_240 -> V_246 [ 0 ] . V_217 , V_240 -> V_246 [ 0 ] . V_220 ) ;
V_240 -> V_246 [ 0 ] . V_217 = V_260 ;
}
V_208 = F_192 ( V_2 -> V_43 , V_243 , V_240 , V_258 ) ;
...
struct V_205 * V_236 , T_8 * * V_12 )
{
struct V_212 * V_265 = & V_236 -> V_266 ;
struct V_212 V_241 ;
struct V_18 V_209 ;
T_2 V_267 , V_268 ;
T_2 V_242 ;
...
if ( V_242 & 3 )
return V_244 ;
V_267 = ( V_221 * ) ( * V_12 ) - ( V_221 * ) V_265 -> V_187 [ 0 ] . V_217 ;
V_268 = V_242 + V_267 ;
if ( V_268 > V_265 -> V_15 )
return V_244 ;
if ( F_179 ( * ( * V_12 ) ++ ) != V_236 -> V_215 )
return V_244 ;
if ( F_185 ( V_265 , & V_241 , V_267 ,
V_268 - V_267 ) )
return V_244 ;
if ( F_195 ( V_265 , & V_209 , V_268 ) )
return V_244 ;
V_208 = F_180 ( V_2 -> V_43 , & V_241 , & V_209 ) ;
if ( V_208 == V_222 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_208 != V_269 )
return V_244 ;
...
int V_244 = - V_231 ;
V_257 = F_179 ( * ( * V_12 ) ++ ) ;
V_243 = ( V_221 * ) ( * V_12 ) - ( V_221 * ) V_265 -> V_187 [ 0 ] . V_217 ;
if ( V_243 + V_257 > V_265 -> V_15 )
return V_244 ;
V_265 -> V_15 = V_243 + V_257 ;
V_208 = F_197 ( V_2 -> V_43 , V_243 , V_265 ) ;
if ( V_208 == V_222 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_208 != V_269 )
return V_244 ;
...
static int
F_198 ( T_10 V_270 , struct V_205 * V_236 ,
T_8 * V_12 , void * V_237 )
{
struct V_238 V_239 ;
...
struct V_1 * V_2 = F_19 ( V_5 ) ;
T_8 * V_271 = V_12 ;
struct V_210 * V_187 = ( (struct V_205 * ) V_236 ) -> V_266 . V_187 ;
int V_272 = V_187 -> V_220 ;
int V_244 = - V_231 ;
if ( V_2 -> V_23 != V_24 )
goto V_273;
switch ( V_6 -> V_195 ) {
