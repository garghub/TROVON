...
int V_15 ;
if ( V_8 -> V_10 -> V_16 )
V_15 = V_8 -> V_10 -> V_16 ( V_8 , V_14 , V_2 , V_3 ) ;
else
V_15 = F_1 ( V_8 -> V_12 + V_14 , V_2 , V_3 ) ;
return V_15 ;
}
...
int V_15 ;
if ( V_8 -> V_10 -> V_17 )
V_15 = V_8 -> V_10 -> V_17 ( V_8 , V_14 , V_2 , V_3 ) ;
else
V_15 = F_5 ( V_8 -> V_12 + V_14 , V_2 , V_3 ) ;
return V_15 ;
}
static void F_13 ( struct V_7 * V_8 , int V_18 ,
int type , T_3 V_19 , T_3 V_20 , T_2 V_2 )
{
F_10 ( V_8 , V_21 | V_18 ,
V_22 ) ;
F_10 ( V_8 , F_14 ( V_19 ) , V_23 ) ;
F_10 ( V_8 , F_15 ( V_19 ) , V_24 ) ;
F_10 ( V_8 , F_14 ( V_19 + V_2 - 1 ) ,
V_25 ) ;
F_10 ( V_8 , F_14 ( V_20 ) , V_26 ) ;
F_10 ( V_8 , F_15 ( V_20 ) , V_27 ) ;
F_10 ( V_8 , type , V_28 ) ;
F_10 ( V_8 , V_29 , V_30 ) ;
}
...
F_11 ( V_8 , V_36 + V_31 * 12 , 4 ,
( T_2 * ) & V_3 ) ;
if ( V_3 ) {
V_15 = V_37 ;
V_32 = 0 ;
while ( ( V_32 = F_17 ( & V_3 , 32 , V_32 ) ) != 32 ) {
V_33 = F_18 ( V_8 -> V_38 ,
V_31 * 32 + V_32 ) ;
F_12 ( V_8 ,
V_36 + V_31 * 12 ,
...
static void F_23 ( struct V_7 * V_8 , int V_33 )
{
...
unsigned int V_48 , unsigned int V_32 )
{
unsigned int V_31 ;
for ( V_31 = 0 ; V_31 < V_48 ; V_31 ++ ) {
F_25 ( V_47 , V_31 , NULL ) ;
if ( V_8 -> V_10 -> V_49 )
V_8 -> V_10 -> V_49 ( V_8 , V_32 + V_31 ) ;
else
F_23 ( V_8 , V_32 + V_31 ) ;
}
F_26 ( V_8 -> V_50 , V_32 , F_27 ( V_48 ) ) ;
}
static void F_28 ( struct V_7 * V_8 , int V_33 )
{
unsigned int V_44 , V_45 , V_3 ;
V_44 = ( V_33 / 32 ) * 12 ;
V_45 = V_33 % 32 ;
...
static int F_29 ( int V_51 , struct V_52 * V_53 , int * V_32 )
{
int V_33 , V_54 , V_31 ;
...
if ( V_54 < 0 )
goto V_56;
V_33 = F_18 ( V_8 -> V_38 , V_54 ) ;
if ( ! V_33 )
goto V_56;
for ( V_31 = 0 ; V_31 < V_51 ; V_31 ++ ) {
if ( F_25 ( V_33 , V_31 , V_53 ) != 0 ) {
F_24 ( V_8 , V_33 , V_31 , V_54 ) ;
goto V_56;
}
if ( V_8 -> V_10 -> V_57 )
V_8 -> V_10 -> V_57 ( V_8 , V_54 + V_31 ) ;
else
F_28 ( V_8 , V_54 + V_31 ) ;
}
* V_32 = V_54 ;
...
static void F_32 ( struct V_7 * V_8 , unsigned int V_33 , T_2 V_32 )
{
struct V_62 V_63 ;
T_3 V_39 ;
if ( V_8 -> V_10 -> V_64 )
...
if ( V_8 -> V_10 -> V_67 )
V_63 . V_68 = V_8 -> V_10 -> V_67 ( V_8 , V_32 ) ;
else
V_63 . V_68 = V_32 ;
F_33 ( V_33 , & V_63 ) ;
}
...
static void F_40 ( struct V_69 * V_70 , unsigned int V_33 )
{
struct V_82 * V_68 = F_41 ( V_33 ) ;
struct V_52 * V_83 = F_42 ( V_68 ) ;
struct V_7 * V_8 = (struct V_7 * ) F_30 ( V_83 ) ;
F_24 ( V_8 , V_33 , 1 , V_68 -> V_84 ) ;
}
...
static int F_44 ( struct V_38 * V_86 , unsigned int V_33 ,
T_5 V_84 )
{
F_45 ( V_33 , & V_87 , V_88 ) ;
F_46 ( V_33 , V_86 -> V_89 ) ;
...
V_15 = F_53 ( V_91 , 0 , 0xff , & V_44 , & V_8 -> V_107 ) ;
if ( V_15 )
return V_15 ;
F_54 (win, &res) {
...
return 0 ;
if ( V_73 -> V_153 == V_8 -> V_137 && V_78 > 0 )
return 0 ;
return 1 ;
}
...
if ( V_73 -> V_147 != V_8 -> V_137 )
if ( V_8 -> V_10 -> V_129 )
V_15 = V_8 -> V_10 -> V_129 ( V_8 , V_73 , V_143 ,
V_14 , V_2 , V_3 ) ;
else
V_15 = F_73 ( V_8 , V_73 , V_143 ,
V_14 , V_2 , V_3 ) ;
else
V_15 = F_11 ( V_8 , V_14 , V_2 , V_3 ) ;
return V_15 ;
}
...
if ( V_73 -> V_147 != V_8 -> V_137 )
if ( V_8 -> V_10 -> V_155 )
V_15 = V_8 -> V_10 -> V_155 ( V_8 , V_73 , V_143 ,
V_14 , V_2 , V_3 ) ;
else
V_15 = F_79 ( V_8 , V_73 , V_143 ,
V_14 , V_2 , V_3 ) ;
else
V_15 = F_12 ( V_8 , V_14 , V_2 , V_3 ) ;
return V_15 ;
}
