...
static int T_6 F_72 ( struct V_6 * V_7 , struct V_39 * V_40 )
{
int V_112 ;
F_73 ( & V_7 -> V_142 ) ;
F_56 ( & V_7 -> V_106 , & V_143 ) ;
V_7 -> V_144 = V_145 ++ ;
if ( F_74 ( V_7 -> V_144 >= V_146 ) ) {
F_75 ( 1 , L_25 ) ;
return - V_147 ;
}
V_148 [ V_7 -> V_144 ] = V_7 ;
...
static int T_6 F_77 ( struct V_49 * V_50 )
{
...
return;
V_158 = true ;
if ( ( 0 != F_79 ( 0 , 0 , 0 , 0 , & V_10 , true ) ) ||
( 0 != F_79 ( 0 , 0 , 0 , 0 , & V_156 , false ) ) ||
( V_10 != V_156 ) ) {
F_24 ( L_29 ) ;
V_158 = false ;
return;
...
static T_7 F_80 ( struct V_161 * V_11 ,
struct V_162 * V_163 ,
char * V_164 )
{
struct V_6 * V_7 = F_81 ( V_11 ) ;
return sprintf ( V_164 , L_31 , V_7 -> V_165 ) ;
}
static T_7 F_82 ( struct V_161 * V_11 ,
struct V_162 * V_163 ,
char * V_164 )
{
struct V_6 * V_7 = F_81 ( V_11 ) ;
return sprintf ( V_164 , L_32 , V_7 -> V_166 ) ;
}
static int F_83 ( struct V_6 * V_7 )
{
int V_149 = V_7 -> V_149 ;
T_2 V_167 , V_168 , V_169 , V_170 ;
V_7 -> V_11 = F_84 ( F_61 ( V_7 -> V_1 ) ,
V_7 -> V_1 & 0xff ) ;
if ( ! V_7 -> V_11 )
return - V_53 ;
...
if ( F_86 ( V_7 -> V_11 ) ) {
int V_51 , V_193 ;
V_7 -> V_194 = F_84 ( V_7 -> V_11 -> V_195 -> V_196 ,
F_87 ( 0 , 0 ) ) ;
...
F_69 ( V_7 ) ;
V_7 -> V_201 = F_88 ( & V_7 -> V_11 -> V_11 , V_7 ,
V_202 , L_33 ,
V_7 -> V_144 ) ;
...
F_54 ( L_45 ) ;
for ( V_51 = 0 ; V_51 < F_92 ( V_203 ) ; ++ V_51 ) {
if ( F_46 ( V_7 , ( 1ULL << V_51 ) ) )
F_93 ( L_46 , V_203 [ V_51 ] ) ;
}
F_93 ( L_47 ) ;
}
}
...
static int T_6 F_105 ( struct V_117 * V_118 )
{
int V_51 ;
switch ( V_118 -> type ) {
case V_214 :
...
V_127 -> V_220 = F_107 ( V_118 -> V_121 ) ;
V_127 -> V_221 = V_127 -> V_220 + F_107 ( V_118 -> V_122 ) ;
...
static int T_6 F_108 ( struct V_49 * V_50 )
{
T_3 * V_41 = ( T_3 * ) V_50 , * V_35 = ( T_3 * ) V_50 ;
struct V_117 * V_118 ;
V_35 += V_50 -> V_43 ;
...
if ( ! V_258 )
return - V_53 ;
V_257 = F_129 ( L_59 , 0 , & V_255 , & V_256 ) ;
if ( V_257 == V_259 )
return - V_53 ;
else if ( F_130 ( V_257 ) ) {
const char * V_260 = F_131 ( V_257 ) ;
F_24 ( L_60 , V_260 ) ;
return - V_111 ;
}
V_112 = F_32 ( V_255 ) ;
...
static int T_6 F_140 ( enum V_282 V_283 )
{
int V_112 = 0 ;
while ( V_268 != V_283 ) {
V_112 = F_136 () ;
...
V_258 = true ;
V_286 = 1 ;
V_289 . V_7 . V_290 = F_146 ;
return 1 ;
}
static int T_6 F_148 ( char * V_291 )
{
V_292 = true ;
return 1 ;
}
...
{
for (; * V_291 ; ++ V_291 ) {
if ( strncmp ( V_291 , L_62 , 9 ) == 0 )
V_293 = true ;
if ( strncmp ( V_291 , L_63 , 3 ) == 0 )
V_288 = true ;
if ( strncmp ( V_291 , L_64 , 15 ) == 0 )
V_294 = true ;
}
return 1 ;
}
...
T_1 V_1 ;
V_112 = sscanf ( V_291 , L_65 , & V_102 , & V_195 , & V_11 , & V_295 ) ;
if ( V_112 != 4 ) {
F_24 ( L_66 , V_291 ) ;
return 1 ;
}
...
int F_79 ( T_1 V_1 , T_3 V_297 , T_3 V_298 , T_3 V_299 ,
...
return - V_53 ;
V_7 = V_87 [ V_1 ] ;
if ( F_31 ( ( V_7 == NULL ) || ( V_299 > 0x28 ) || ( V_299 & 7 ) ) )
return - V_53 ;
