...
struct V_4 * V_5 = (struct V_4 * ) V_82 -> V_96 ;
F_139 ( & V_82 -> V_214 , V_75 ) ;
V_219 = F_140 ( V_5 , V_221 ) ;
V_219 += V_82 -> V_216 ;
F_142 ( & V_82 -> V_214 , V_75 ) ;
V_218 -> V_222 = F_145 ( V_219 , 1000000000ULL , & V_220 ) ;
V_218 -> V_223 = V_220 ;
return 0 ;
}
...
V_82 -> V_209 . V_234 = 0 ;
V_82 -> V_209 . V_235 = 0 ;
V_82 -> V_209 . V_236 = F_136 ;
V_82 -> V_209 . V_237 = F_143 ;
V_82 -> V_209 . V_238 = F_144 ;
V_82 -> V_209 . V_239 = F_146 ;
V_82 -> V_209 . V_240 = F_148 ;
V_82 -> V_216 = 0 ;
V_82 -> V_241 = F_151 ( & V_82 -> V_209 ,
& V_5 -> V_50 -> V_37 ) ;
if ( F_152 ( V_82 -> V_241 ) )
V_82 -> V_241 = NULL ;
}
...
F_138 ( V_242 , V_5 -> V_213 ) ;
F_141 ( V_5 , V_242 , V_215 ) ;
V_243 = F_140 ( V_5 , V_245 ) ;
F_141 ( V_5 , V_243 | 0x01 , V_245 ) ;
}
...
F_120 ( V_5 ) -> V_194 , V_250 ,
V_256 ) ;
V_191 = F_155 ( & V_247 , V_248 , & V_5 -> V_50 -> V_37 ) ;
if ( V_191 ) {
F_20 ( & V_5 -> V_50 -> V_37 , L_33 ,
V_248 ) ;
return V_191 ;
}
V_191 = F_156 ( V_5 , V_247 -> V_257 , V_247 -> V_204 ) ;
F_157 ( V_247 ) ;
return V_191 ;
}
static int F_158 ( struct V_4 * V_5 , int V_2 , int V_258 ,
int V_259 , void * V_260 )
{
int V_92 = 0 ;
F_34 ( & V_5 -> V_50 -> V_37 , L_34 , V_2 ) ;
V_92 = F_159 ( V_5 , V_2 , V_258 , V_259 , V_260 ) ;
if ( V_92 == - 1 )
return V_92 ;
if ( V_92 == 1 ) {
...
struct V_123 * V_12 = F_137 ( V_277 , struct V_123 ,
V_279 ) ;
if ( V_86 ) {
int V_283 ;
struct V_82 * V_82 = F_62 ( V_86 ) ;
...
V_28 -> V_288 = F_176 ( V_28 , V_28 -> V_37 ) ;
if ( ( V_86 -> V_289 & V_290 ) &&
( V_276 -> V_282 . V_291 == V_292 ) )
V_28 -> V_293 = V_294 ;
else
V_28 -> V_293 = V_295 ;
V_283 = F_177 ( V_279 , V_28 ) != V_296 ;
if ( V_283 ) {
...
static void F_178 ( void * V_277 )
{
struct V_278 * V_279 = V_277 ;
F_179 ( V_279 ) ;
}
static void F_180 ( void * V_301 )
{
...
V_305 -> V_75 = 0 ;
F_181 ( V_12 -> V_303 , V_305 ) ;
}
}
static int F_182 ( struct V_123 * V_12 , int V_308 )
{
int V_309 ;
struct V_82 * V_82 = F_62 ( V_12 -> V_279 . V_37 ) ;
struct V_4 * V_5 = V_82 -> V_96 ;
V_309 = F_183 ( V_5 , V_12 -> V_2 ,
V_310 ,
V_308 ) ;
if ( V_309 < 0 ) {
F_78 ( V_82 , V_181 , V_82 -> V_86 ,
...
V_311:
F_184 ( & V_12 -> V_279 ) ;
F_183 ( V_5 , V_12 -> V_2 , V_312 ,
0 ) ;
return 0 ;
}
static int F_185 ( struct V_278 * V_279 , int V_308 )
{
struct V_123 * V_12 ;
int V_309 ;
V_12 = F_137 ( V_279 , struct V_123 , V_279 ) ;
V_309 = F_182 ( V_12 , V_308 ) ;
if ( V_309 < V_308 ) {
F_184 ( V_279 ) ;
...
static inline int F_186 ( struct V_4 * V_313 ,
struct V_85 * V_85 )
{
static int V_314 = 1 ;
...
V_12 = V_313 -> V_12 [ V_2 ] ;
V_279 = & V_12 -> V_279 ;
F_190 ( V_85 , V_279 , F_185 , 64 ) ;
V_12 -> V_303 = V_303 ;
V_303 ++ ;
if ( V_303 >= V_317 )
V_303 = 0 ;
F_191 ( V_313 , V_2 , & V_316 ) ;
}
for ( V_91 = 0 ; V_91 < V_82 -> V_88 . V_95 ; V_91 ++ ) {
V_319 = F_192 ( F_120
( V_313 ) ,
V_82 -> V_176 ) ;
V_318 = F_193 ( V_313 , V_82 -> V_88 . V_94 [ V_91 ] ,
V_319 ,
F_11 ( V_85 , V_91 ) ) ;
if ( V_318 ) {
F_20 ( & V_313 -> V_50 -> V_37 ,
...
static void F_194 ( struct V_321 * V_164 )
{
...
return;
F_65 ( V_82 ) ;
F_195 ( V_82 -> V_324 . V_325 ,
& V_82 -> V_324 . V_323 . V_164 , F_196 ( 1 ) ) ;
}
static inline void F_197 ( struct V_85 * V_86 )
{
struct V_82 * V_82 = F_62 ( V_86 ) ;
struct V_4 * V_5 = V_82 -> V_96 ;
V_82 -> V_324 . V_325 = F_198 ( L_42 ) ;
if ( ! V_82 -> V_324 . V_325 ) {
F_20 ( & V_5 -> V_50 -> V_37 , L_43 ) ;
return;
}
F_199 ( & V_82 -> V_324 . V_323 . V_164 ,
F_194 ) ;
...
F_197 ( V_86 ) ;
F_61 ( V_86 ) ;
F_78 ( V_82 , V_327 , V_82 -> V_86 , L_44 ) ;
F_203 ( V_230 ) ;
F_107 ( V_82 , 1 ) ;
V_82 -> V_120 = 1 ;
...
struct V_82 * V_82 = F_62 ( V_86 ) ;
struct V_4 * V_5 = V_82 -> V_96 ;
F_78 ( V_82 , V_328 , V_82 -> V_86 , L_46 ) ;
V_82 -> V_120 = 0 ;
V_82 -> V_88 . V_89 . V_90 . V_63 = 0 ;
F_81 ( V_86 ) ;
F_107 ( V_82 , 0 ) ;
F_104 ( & V_82 -> V_324 . V_323 . V_164 ) ;
F_205 ( V_82 -> V_324 . V_325 ) ;
F_206 ( V_82 -> V_324 . V_325 ) ;
if ( V_82 -> V_241 ) {
F_207 ( V_82 -> V_241 ) ;
V_82 -> V_241 = NULL ;
}
F_49 ( V_82 , V_183 ) ;
F_208 ( V_329 , & V_82 -> V_86 -> V_77 ) ;
F_201 (napi, n, &netdev->napi_list, dev_list)
F_209 ( V_279 ) ;
F_50 ( V_86 ) ;
F_89 ( & V_5 -> V_50 -> V_37 , L_47 , V_86 -> V_228 ) ;
F_210 ( V_230 ) ;
return 0 ;
}
void F_211 ( void * V_330 )
{
...
break;
case V_333 :
F_78 ( V_82 , V_334 , V_82 -> V_86 , L_48 ,
F_164 ( V_169 -> V_335 [ 0 ] ) ) ;
F_89 ( & V_5 -> V_50 -> V_37 , L_49 ,
V_86 -> V_228 , F_164 ( V_169 -> V_335 [ 0 ] ) ) ;
memcpy ( V_86 -> V_336 , ( ( V_337 * ) & V_169 -> V_335 [ 0 ] ) + 2 , V_338 ) ;
break;
case V_339 :
F_78 ( V_82 , V_334 , V_82 -> V_86 , L_50 ,
...
break;
case V_341 :
F_78 ( V_82 , V_334 , V_82 -> V_86 , L_52 ) ;
break;
case V_342 :
F_89 ( & V_5 -> V_50 -> V_37 , L_53 , V_86 -> V_228 ) ;
break;
case V_343 :
...
static inline enum V_347 F_212 ( struct V_85 * V_86 )
{
...
V_121 * V_361 ;
int V_191 , V_18 ;
int V_362 = F_215 ( F_213 ( V_86 ) , V_356 ) ;
memset ( & V_169 , 0 , sizeof( struct V_168 ) ) ;
V_169 . V_172 . V_121 = 0 ;
...
static int F_217 ( struct V_85 * V_86 , void * V_368 )
{
int V_191 = 0 ;
struct V_82 * V_82 = F_62 ( V_86 ) ;
struct V_4 * V_5 = V_82 -> V_96 ;
...
static struct V_375 * F_219 ( struct V_85 * V_86 )
{
struct V_82 * V_82 = F_62 ( V_86 ) ;
...
static int F_220 ( struct V_85 * V_86 , int V_394 )
{
struct V_82 * V_82 = F_62 ( V_86 ) ;
struct V_4 * V_5 = V_82 -> V_96 ;
struct V_168 V_169 ;
...
static int F_221 ( struct V_85 * V_86 , struct V_400 * V_401 , int V_173 )
{
struct V_402 V_403 ;
struct V_82 * V_82 = F_62 ( V_86 ) ;
if ( F_222 ( & V_403 , V_401 -> V_404 , sizeof( V_403 ) ) )
return - V_405 ;
if ( V_403 . V_75 )
return - V_399 ;
switch ( V_403 . V_406 ) {
...
F_49 ( V_82 , V_286 ) ;
return F_223 ( V_401 -> V_404 , & V_403 , sizeof( V_403 ) ) ? - V_405 : 0 ;
}
static int F_224 ( struct V_85 * V_86 , struct V_400 * V_401 , int V_173 )
{
switch ( V_173 ) {
case V_426 :
return F_221 ( V_86 , V_401 , V_173 ) ;
default:
return - V_227 ;
}
}
...
F_226 ( & V_264 -> V_429 , 1 ) ;
if ( F_227 ( ( F_131 ( V_28 ) -> V_430 | V_431 ) != 0 ) ) {
struct V_280 V_218 ;
V_121 V_219 = V_264 -> V_429 ;
F_78 ( V_82 , V_384 , V_82 -> V_86 ,
L_63 ,
V_28 , ( unsigned long long ) V_219 ) ;
V_218 . V_287 = F_174 ( V_219 + V_82 -> V_216 ) ;
F_228 ( V_28 , & V_218 ) ;
}
F_229 ( V_5 , V_30 ) ;
F_129 ( V_28 ) ;
...
V_439 = ! V_434 ;
V_318 = F_232 ( V_5 , V_30 -> V_383 , V_439 , & V_30 -> V_173 ,
...
F_78 ( V_82 , V_443 , V_82 -> V_86 , L_66 ) ;
}
return V_318 ;
}
static inline int F_233 ( struct V_27 * V_28 )
{
return ( V_28 -> V_288 == F_234 ( V_444 ) ) &&
( F_235 ( V_28 ) -> V_445 == 4 ) ;
}
static inline int F_236 ( struct V_27 * V_28 )
{
return V_28 -> V_288 == F_234 ( V_446 ) ;
}
static inline int F_237 ( struct V_27 * V_28 )
{
return ( F_235 ( V_28 ) -> V_447 & F_234 ( V_448 | V_449 ) ) ? 1 : 0 ;
}
static inline int F_238 ( struct V_27 * V_28 )
{
return ( V_28 -> V_288 == F_234 ( V_450 ) ) &&
( F_239 ( V_28 ) -> V_445 == 6 ) ;
}
static inline int F_240 ( struct V_27 * V_28 )
{
return ( F_239 ( V_28 ) -> V_451 != V_452 ) &&
( F_239 ( V_28 ) -> V_451 != V_453 ) ;
}
static inline int F_241 ( struct V_27 * V_28 )
{
return ( F_235 ( V_28 ) -> V_288 == V_452 ) ||
( F_235 ( V_28 ) -> V_288 == V_453 ) ;
}
static inline T_1 F_242 ( struct V_27 * V_28 )
{
T_1 V_454 ;
struct V_455 * V_455 = F_235 ( V_28 ) ;
V_454 = F_243 ( 0 , & V_455 -> V_288 , 1 ) ;
V_454 = F_243 ( V_454 , ( V_337 * ) & V_455 -> V_456 , 8 ) ;
V_454 = F_243 ( V_454 , F_244 ( V_28 ) , 4 ) ;
return V_454 ;
}
static inline T_1 F_245 ( struct V_27 * V_28 )
{
T_1 V_454 ;
struct V_457 * V_457 = F_239 ( V_28 ) ;
V_454 = F_243 ( 0 , & V_457 -> V_451 , 1 ) ;
V_454 = F_243 ( V_454 , ( V_337 * ) & V_457 -> V_456 , 32 ) ;
V_454 = F_243 ( V_454 , F_244 ( V_28 ) , 4 ) ;
return V_454 ;
}
...
F_78 ( V_82 , V_462 , V_82 -> V_86 , L_68 ,
V_433 . V_2 ) ;
V_60 -> V_464 ++ ;
return V_465 ;
}
...
if ( F_227 ( F_131 ( V_28 ) -> V_430 & V_476 ) ) {
F_131 ( V_28 ) -> V_430 |= V_431 ;
V_459 . V_90 . V_429 = 1 ;
}
if ( F_131 ( V_28 ) -> V_199 == 0 ) {
V_459 . V_90 . V_477 . V_466 = V_28 -> V_36 ;
F_248 ( & V_433 . V_173 , & V_459 , V_454 ) ;
V_433 . V_173 . V_196 = F_249 ( & V_5 -> V_50 -> V_37 ,
V_28 -> V_257 ,
V_28 -> V_36 ,
V_197 ) ;
if ( F_250 ( & V_5 -> V_50 -> V_37 , V_433 . V_173 . V_196 ) ) {
...
V_459 . V_90 . V_478 = 1 ;
V_459 . V_90 . V_477 . V_479 = ( F_131 ( V_28 ) -> V_199 + 1 ) ;
F_248 ( & V_433 . V_173 , & V_459 , V_454 ) ;
...
V_484 -> V_36 = 1 ;
V_485 -> V_90 . V_482 = F_131 ( V_28 ) -> V_482 ;
V_485 -> V_90 . V_487 = F_131 ( V_28 ) -> V_487 ;
}
V_434 = V_28 -> V_434 ;
if ( F_227 ( V_459 . V_90 . V_429 ) )
V_63 = F_230 ( V_5 , & V_433 , V_26 , V_434 ) ;
else
V_63 = F_253 ( V_5 , & V_433 , V_434 ) ;
if ( V_63 == V_440 )
goto V_463;
F_78 ( V_82 , V_443 , V_82 -> V_86 , L_73 ) ;
if ( V_63 == V_488 )
...
V_463:
V_60 -> V_385 ++ ;
F_78 ( V_82 , V_462 , V_82 -> V_86 , L_74 ,
V_383 , V_60 -> V_385 ) ;
F_128 ( & V_5 -> V_50 -> V_37 , V_433 . V_173 . V_196 ,
V_433 . V_466 , V_197 ) ;
F_129 ( V_28 ) ;
return V_490 ;
}
...
static int F_263 ( struct V_501 * V_502 , void * V_23 )
{
...
V_266 = (struct V_265 * ) V_30 -> V_268 ;
V_512 =
F_271 ( F_120 ( V_313 ) , V_18 ) ;
V_513 =
F_272 ( F_120 ( V_313 ) , V_18 ) ;
V_518 =
F_273 ( F_120 ( V_313 ) , V_18 ) ;
V_519 =
F_274 ( F_120 ( V_313 ) , V_18 ) ;
if ( V_512 > V_515 )
V_512 = V_515 ;
if ( V_513 > V_515 )
V_513 = V_515 ;
...
F_277 ( V_313 , V_30 , V_522 ,
V_524 , V_18 ,
V_517 . V_121 , 0 ) ;
V_30 -> V_441 = F_162 ;
V_30 -> V_35 = V_30 ;
V_30 -> V_367 = 1000 ;
V_318 = F_278 ( V_313 , V_30 ) ;
if ( V_318 ) {
F_20 ( & V_313 -> V_50 -> V_37 ,
L_81 ,
V_318 ) ;
...
F_279 ( & V_266 -> V_270 , & V_266 -> V_269 ) ;
V_318 = V_264 -> V_63 ;
if ( V_318 ) {
F_20 ( & V_313 -> V_50 -> V_37 , L_82 ) ;
goto V_525;
}
F_226 ( ( V_121 * ) ( & V_264 -> V_526 ) ,
( sizeof( struct V_527 ) ) >> 3 ) ;
V_512 = F_280 ( V_264 -> V_526 . V_528 ) ;
V_513 = F_280 ( V_264 -> V_526 . V_529 ) ;
if ( ! ( V_512 ) || ! ( V_513 ) ) {
F_20 ( & V_313 -> V_50 -> V_37 ,
L_83 ,
V_264 -> V_526 . V_528 ,
...
F_34 ( & V_313 -> V_50 -> V_37 ,
L_86 , V_18 ,
V_82 -> V_88 . V_534 , F_164 ( V_82 -> V_88 . V_374 ) ) ;
F_226 ( & V_82 -> V_88 . V_374 , 1 ) ;
for ( V_184 = 0 ; V_184 < 6 ; V_184 ++ )
V_510 [ V_184 ] = * ( ( V_337 * ) ( ( ( V_337 * ) & V_82 -> V_88 . V_374 ) + 2 + V_184 ) ) ;
F_285 ( V_86 -> V_336 , V_510 ) ;
if ( F_186 ( V_313 , V_86 ) ) {
...
V_82 -> V_107 = F_286 ( V_313 , V_82 -> V_19 ) ;
V_82 -> V_548 = F_287 ( V_313 , V_82 -> V_547 ) ;
if ( F_71 ( V_82 ) ) {
F_20 ( & V_313 -> V_50 -> V_37 ,
L_88 ) ;
goto V_525;
...
static void F_292 ( struct V_321 * V_164 )
{
struct V_4 * V_5 ;
struct V_322 * V_323 = (struct V_322 * ) V_164 ;
...
static int F_93 ( struct V_4 * V_313 )
{
int V_184 , V_191 ;
struct V_6 * V_7 =
...
V_573 ,
V_313 ) ;
F_199 ( & V_313 -> V_163 . V_164 , F_292 ) ;
V_313 -> V_163 . V_268 = ( void * ) V_313 ;
F_293 ( & V_313 -> V_163 . V_164 ,
V_571 ) ;
...
if ( V_579 == 0 ) {
F_89 ( & V_313 -> V_50 -> V_37 ,
L_107 ) ;
}
F_6 ( V_49 * V_580 ) ;
V_191 = F_301 ( V_313 , & V_579 ) ;
if ( V_191 ) {
F_20 ( & V_313 -> V_50 -> V_37 ,
L_108 ,
V_191 ) ;
...
F_92 ( & V_137 [ V_313 -> V_142 ] . V_143 ) ;
F_30 ( & V_313 -> V_63 , V_150 ) ;
for ( V_184 = 0 ; V_184 < V_313 -> V_575 ; V_184 ++ )
F_161 ( V_313 -> V_12 [ V_184 ] -> V_261 ,
