...
F_129 ( V_24 , V_157 ,
V_202 ) ;
if ( F_132 ( V_195 -> V_201 ) || F_132 ( V_195 -> V_196 ) ||
F_132 ( V_195 -> V_140 ) || F_132 ( V_195 -> V_199 ) ) {
F_77 ( V_25 , L_56 ,
V_195 -> V_38 ) ;
if ( ! F_132 ( V_195 -> V_201 ) )
F_135 ( V_25 , V_195 -> V_201 ) ;
if ( ! F_132 ( V_195 -> V_196 ) )
F_135 ( V_25 , V_195 -> V_196 ) ;
if ( ! F_132 ( V_195 -> V_140 ) )
F_135 ( V_25 , V_195 -> V_140 ) ;
if ( ! F_132 ( V_195 -> V_199 ) )
F_135 ( V_25 , V_195 -> V_199 ) ;
F_29 ( V_25 , V_195 ) ;
continue;
}
...
F_74 ( V_25 , L_57 ,
V_195 -> V_38 , V_195 -> V_201 , V_195 -> V_196 , V_195 -> V_140 ,
V_195 -> V_199 ) ;
}
return 0 ;
}
...
T_3 V_82 , V_80 = 1000 ;
int V_19 ;
V_82 = F_47 ( & V_195 -> V_140 -> V_203 ) & ~ V_204 ;
F_60 ( V_82 , & V_195 -> V_140 -> V_203 ) ;
V_19 = F_54 ( & V_195 -> V_140 -> V_203 , V_80 ,
V_205 ) ;
if ( V_19 < 0 ) {
F_77 ( V_24 -> V_25 , L_58 , V_195 -> V_38 ) ;
return V_19 ;
}
V_195 -> V_206 = false ;
V_195 -> V_207 = false ;
...
struct V_194 * V_195 )
{
int V_107 , V_19 , V_208 ;
const struct V_209 * V_210 ;
bool V_211 = false ;
T_3 * V_212 ;
for ( V_107 = 0 ; V_107 < F_139 ( V_213 ) ; V_107 ++ ) {
if ( V_213 [ V_107 ] ) {
V_19 = F_140 ( & V_210 ,
V_213 [ V_107 ] ,
V_24 -> V_25 ) ;
...
F_134 ( V_24 -> V_25 , L_60 ,
V_213 [ V_107 ] ) ;
F_60 ( V_195 -> V_16 + 1 , V_195 -> V_201 + 0x18 ) ;
V_212 = ( T_3 * ) V_210 -> V_133 ;
V_208 = ( V_210 -> V_97 + sizeof( T_3 ) - 1 ) / sizeof( T_3 ) ;
for ( V_107 = 0 ; V_107 < V_208 ; V_107 ++ )
F_60 ( F_141 ( V_212 [ V_107 ] ) , V_195 -> V_196 + V_107 ) ;
F_142 ( V_210 ) ;
return 0 ;
}
static int F_143 ( struct V_34 * V_24 ,
struct V_194 * V_195 )
{
T_3 V_82 , V_80 = 1000 ;
int V_19 ;
F_60 ( 0xffffffff , V_195 -> V_201 ) ;
while ( F_47 ( V_195 -> V_201 ) != 0xffffffff )
F_57 () ;
V_82 = F_47 ( & V_195 -> V_140 -> V_203 ) ;
V_82 &= ~ ( V_214 | V_215 ) ;
F_60 ( V_82 , & V_195 -> V_140 -> V_203 ) ;
V_82 = F_47 ( & V_195 -> V_140 -> V_203 ) | V_204 ;
F_60 ( V_82 , & V_195 -> V_140 -> V_203 ) ;
V_19 = F_54 ( V_195 -> V_201 , V_80 , 0 ) ;
if ( V_19 < 0 ) {
F_77 ( V_24 -> V_25 ,
L_61 ,
V_195 -> V_38 ) ;
...
static void F_144 ( struct V_34 * V_24 )
{
struct V_194 * V_195 ;
F_145 (kdev, pdsp)
F_137 ( V_24 , V_195 ) ;
...
static inline struct V_141 * F_147 ( unsigned V_16 )
{
struct V_141 * V_41 ;
F_102 (kdev, qmgr) {
if ( ( V_16 >= V_41 -> V_42 ) &&
...
V_2 -> V_216 = - 1 ;
V_2 -> V_16 = V_16 ;
F_149 ( V_23 , sizeof( V_23 ) , L_62 , V_16 ) ;
V_2 -> V_23 = F_28 ( V_23 , sizeof( V_23 ) , V_39 ) ;
if ( V_14 -> V_47 && V_14 -> V_47 -> V_217 )
return V_14 -> V_47 -> V_217 ( V_14 , V_2 ) ;
else
return 0 ;
}
static int F_150 ( struct V_34 * V_24 )
{
struct V_13 * V_14 ;
int V_97 , V_16 , V_218 ;
int V_35 = 0 , V_19 = 0 ;
V_97 = sizeof( struct V_1 ) ;
V_24 -> V_219 = F_151 ( V_97 ) ;
V_97 = ( 1 << V_24 -> V_219 ) * V_24 -> V_180 ;
V_24 -> V_220 = F_26 ( V_24 -> V_25 , V_97 , V_39 ) ;
if ( ! V_24 -> V_220 )
return - V_40 ;
F_152 (kdev, range) {
if ( V_14 -> V_47 && V_14 -> V_47 -> V_221 )
V_14 -> V_47 -> V_221 ( V_14 ) ;
V_218 = V_35 ;
for ( V_16 = V_14 -> V_17 ;
V_16 < V_14 -> V_17 + V_14 -> V_37 ; V_16 ++ , V_35 ++ ) {
V_19 = F_148 ( V_24 , V_14 ,
F_153 ( V_24 , V_35 ) , V_16 ) ;
if ( V_19 < 0 )
return V_19 ;
}
V_14 -> V_222 =
...
F_112 ( & V_24 -> V_193 ) ;
F_156 ( & V_162 -> V_25 ) ;
V_19 = F_157 ( & V_162 -> V_25 ) ;
if ( V_19 < 0 ) {
F_77 ( V_25 , L_65 ) ;
return V_19 ;
}
if ( F_110 ( V_125 , L_66 , V_158 , 2 ) ) {
F_77 ( V_25 , L_67 ) ;
V_19 = - V_51 ;
goto V_128;
}
...
F_160 ( L_79 , V_223 | V_224 , NULL , NULL ,
& V_225 ) ;
return 0 ;
V_128:
F_144 ( V_24 ) ;
...
static int F_163 ( struct V_161 * V_162 )
{
F_161 ( & V_162 -> V_25 ) ;
F_162 ( & V_162 -> V_25 ) ;
return 0 ;
