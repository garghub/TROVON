...
V_36 = F_18 ( V_33 , V_35 -> V_19 . V_17 ) ;
if ( ! V_36 )
continue;
F_10 ( V_36 , & V_35 -> V_19 ) ;
}
}
static int F_19 ( struct V_39 * V_40 , char * V_10 ,
unsigned int * V_41 )
{
const char * V_42 ;
int V_22 ;
V_22 = F_20 ( V_40 , V_10 , & V_42 ) ;
if ( V_22 < 0 )
return V_22 ;
...
static int F_21 ( struct V_39 * V_40 , char * V_10 ,
unsigned int * V_41 )
{
const char * V_46 ;
int V_22 ;
V_22 = F_20 ( V_40 , V_10 , & V_46 ) ;
if ( V_22 < 0 )
return V_22 ;
...
if ( ! V_12 )
return;
V_22 = F_24 ( V_40 , V_10 , sizeof( V_10 ) ) ;
if ( V_22 )
goto V_22;
F_12 ( & V_12 -> V_1 , L_3 , V_10 ) ;
V_22 = F_19 ( V_40 , L_11 , & V_42 ) ;
if ( V_22 ) {
V_22 = F_19 ( V_40 , L_12 ,
& V_12 -> V_15 . V_42 ) ;
if ( V_22 )
...
V_12 -> V_15 . V_23 = V_57 ;
V_12 -> V_13 . V_23 = V_57 ;
V_12 -> V_15 . V_14 = F_11 ( V_57 * sizeof( V_53 ) , V_21 ) ;
if ( ! V_12 -> V_15 . V_14 ) {
V_22 = - V_62 ;
goto V_22;
}
V_12 -> V_13 . V_14 = F_11 ( V_57 * sizeof( V_53 ) , V_21 ) ;
if ( ! V_12 -> V_13 . V_14 ) {
V_22 = - V_62 ;
goto V_63;
}
...
void F_29 ( struct V_16 * V_17 , struct V_39 * V_67 )
{
struct V_39 * V_68 ;
F_10 ( V_17 , & V_69 ) ;
F_30 (clients, child)
...
V_71:
while ( V_58 -- > 0 )
F_43 ( & V_33 -> V_17 [ V_58 ] -> V_1 ) ;
F_43 ( & V_33 -> V_1 ) ;
return V_22 ;
}
int F_44 ( struct V_72 * V_73 )
{
V_73 -> V_9 . V_26 = & V_27 ;
return F_45 ( & V_73 -> V_9 ) ;
}
static inline int F_46 ( struct V_74 * T_5 V_4 )
{
return 0 ;
}
...
F_15 ( & V_33 -> V_17 [ V_58 ] -> V_1 ) ;
F_15 ( & V_33 -> V_1 ) ;
}
struct V_32 * F_49 ( unsigned int V_75 , T_6 V_76 )
{
struct V_32 * V_33 ;
struct V_16 * * V_17 ;
unsigned int V_58 ;
...
if ( ! V_33 )
return NULL ;
V_17 = F_11 ( sizeof( * V_17 ) * V_75 , V_76 ) ;
if ( ! V_17 ) {
F_9 ( V_33 ) ;
return NULL ;
}
...
F_51 ( & V_17 [ V_58 ] -> V_83 ) ;
F_52 ( & V_17 [ V_58 ] -> V_84 ) ;
F_12 ( & V_17 [ V_58 ] -> V_1 , L_20 , V_58 ) ;
V_33 -> V_17 [ V_58 ] -> V_1 . V_29 = F_37 ;
F_50 ( & V_33 -> V_17 [ V_58 ] -> V_1 ) ;
}
return V_33 ;
V_71:
F_48 ( V_33 ) ;
...
struct V_74 * F_55 ( unsigned int V_86 , T_6 V_76 )
{
struct V_74 * T_5 ;
int V_22 ;
...
int F_58 ( struct V_11 * V_12 , struct V_74 * T_5 )
{
struct V_16 * V_17 = F_59 ( V_12 ) ;
if ( ! F_60 ( V_12 ) )
return - V_87 ;
F_61 ( ! T_5 -> V_88 || ! T_5 -> V_89 ) ;
T_5 -> V_12 = V_12 ;
return V_17 -> V_78 ( T_5 ) ;
}
int F_62 ( struct V_11 * V_12 , unsigned int V_90 )
{
struct V_16 * V_17 = F_59 ( V_12 ) ;
int V_22 = 0 ;
F_63 ( & V_17 -> V_83 ) ;
...
if ( ! F_64 ( F_36 ( V_17 -> V_1 . V_28 ) -> V_94 ) ) {
V_22 = - V_95 ;
goto V_71;
}
V_17 -> V_91 ++ ;
...
if ( ! V_17 -> V_91 )
V_17 -> V_92 = 0 ;
F_68 ( F_36 ( V_17 -> V_1 . V_28 ) -> V_94 ) ;
F_65 ( & V_17 -> V_83 ) ;
}
static int F_69 ( struct V_97 * V_98 ,
unsigned long V_99 , void * T_4 V_4 )
{
struct V_11 * V_12 = F_70 ( V_98 , struct V_11 , V_98 ) ;
...
return - V_87 ;
V_12 -> V_100 = F_72 ;
V_12 -> V_98 . V_101 = F_69 ;
return F_73 ( & V_17 -> V_84 , & V_12 -> V_98 ) ;
}
...
int V_22 ;
F_75 ( ! F_60 ( V_12 ) ) ;
V_22 = F_76 ( & V_17 -> V_84 , & V_12 -> V_98 ) ;
if ( ! V_22 )
V_12 -> V_100 = NULL ;
return V_22 ;
}
int F_77 ( struct V_16 * V_17 , unsigned long V_99 )
{
return F_78 ( & V_17 -> V_84 , V_99 , NULL ) ;
}
