...
V_4 = F_1 ( V_46 , V_78 , L_152 , V_198 , V_58 ) ;
if ( V_4 < 0 ) {
F_4 ( L_149 , V_4 ) ;
goto V_11;
}
...
goto V_11;
for ( V_58 = 0 ; V_58 < V_163 -> V_162 ; V_58 ++ )
if ( F_142 ( V_163 -> args [ V_58 ] . V_172 , L_154 ) ) {
F_7 ( L_155
L_156 ,
...
V_163 -> V_67 = V_73 -> V_67 ;
V_85 = - V_47 ;
if ( F_156 ( & V_99 -> V_14 , L_162 , V_99 -> V_59 ) < 0 )
goto V_212;
if ( ( ! V_163 -> V_67 ) &&
...
if ( F_156 ( & V_99 -> V_105 , L_163 , V_99 -> V_59 ) < 0 )
goto V_212;
if ( V_73 -> V_39 ) {
