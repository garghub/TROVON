...
static int F_51 ( struct V_32 * V_33 , struct V_97 * V_98 )
{
F_52 ( V_99 L_3 ,
...
static int F_53 ( T_4 * V_109 , struct V_10 * V_110 ,
unsigned long V_85 , void * V_16 )
{
return F_54 ( * V_109 ) ? 0 : - V_111 ;
}
static int F_44 (
struct V_32 * V_33 ,
unsigned long V_85 ,
unsigned long V_80 )
{
return F_55 ( V_33 -> V_112 , V_85 , V_80 << V_37 ,
F_53 , NULL ) != 0 ;
}
