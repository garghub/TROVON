...
int F_43 ( struct V_51 * V_12 , int V_13 , T_4 V_76 ,
struct V_18 * V_18 ,
int (* V_43)( struct V_51 * V_12 , T_5 V_77 ) )
{
const struct V_78 * V_79 = F_44 ( V_12 ) ;
struct V_80 * V_81 = V_12 -> V_82 ;
struct V_1 * V_2 ;
struct V_72 * V_72 ;
unsigned int V_83 = V_22 ;
unsigned int V_84 = V_22 ;
unsigned int V_85 = V_22 ;
unsigned int V_86 = V_87 ;
unsigned int V_88 = V_89 ;
unsigned int V_90 = V_91 ;
unsigned int V_29 = V_92 ;
unsigned int V_50 ;
int error ;
if ( ! V_81 && ! V_79 ) {
F_45 ( V_12 , L_10 ) ;
...
V_2 = F_49 ( V_12 , sizeof( * V_2 ) , V_102 ) ;
if ( ! V_2 )
return - V_103 ;
V_72 = F_50 ( V_12 ) ;
if ( ! V_72 )
...
V_2 -> V_29 = V_29 ;
V_2 -> V_50 = V_50 ;
V_2 -> V_47 = F_51 ( V_12 , L_15 , V_104 ) ;
if ( F_46 ( V_2 -> V_47 ) ) {
error = F_47 ( V_2 -> V_47 ) ;
F_45 ( V_12 , L_16 , error ) ;
return error ;
}
V_2 -> V_105 = F_52 ( V_12 , L_17 ) ;
if ( F_46 ( V_2 -> V_105 ) ) {
error = F_47 ( V_2 -> V_105 ) ;
...
F_56 ( & V_2 -> V_49 , F_36 ) ;
snprintf ( V_2 -> V_106 , sizeof( V_2 -> V_106 ) ,
L_19 , F_57 ( V_12 ) ) ;
V_72 -> V_107 = L_20 ;
V_72 -> V_106 = V_2 -> V_106 ;
V_72 -> V_108 . V_76 = V_76 ;
V_72 -> V_12 . V_109 = V_12 ;
V_72 -> V_110 [ 0 ] = F_58 ( V_111 ) | F_58 ( V_112 ) ;
V_72 -> V_113 [ F_59 ( V_11 ) ] = F_60 ( V_11 ) ;
F_61 ( V_72 , V_7 , 0 , V_83 , V_86 , 0 ) ;
F_61 ( V_72 , V_8 , 0 , V_84 , V_88 , 0 ) ;
F_61 ( V_72 , V_9 , 0 , V_85 , V_90 , 0 ) ;
if ( V_81 )
F_62 ( V_72 , false ) ;
V_72 -> V_114 = F_40 ;
V_72 -> V_115 = F_42 ;
F_63 ( V_72 , V_2 ) ;
F_16 ( V_2 ) ;
error = F_64 ( V_12 , V_13 , NULL ,
F_6 ,
V_116 | V_117 ,
L_21 , V_2 ) ;
if ( error ) {
F_45 ( V_12 , L_22 , error ) ;
return error ;
}
if ( V_2 -> V_105 ) {
error = F_65 ( V_2 -> V_105 ) ;
if ( error )
return error ;
}
F_66 ( V_12 , V_2 ) ;
error = F_67 ( & V_12 -> V_62 , & V_118 ) ;
if ( error ) {
F_45 ( V_12 ,
L_23 , error ) ;
goto V_119;
...
return 0 ;
V_120:
F_70 ( & V_12 -> V_62 , & V_118 ) ;
V_119:
if ( V_2 -> V_105 )
F_71 ( V_2 -> V_105 ) ;
return error ;
}
int F_72 ( struct V_51 * V_12 )
{
struct V_1 * V_2 = F_28 ( V_12 ) ;
F_70 ( & V_12 -> V_62 , & V_118 ) ;
if ( V_2 -> V_105 )
...
static int T_6 F_73 ( struct V_51 * V_12 )
{
struct V_1 * V_2 = F_28 ( V_12 ) ;
F_29 ( & V_2 -> V_59 ) ;
...
static int T_6 F_74 ( struct V_51 * V_12 )
{
struct V_1 * V_2 = F_28 ( V_12 ) ;
F_29 ( & V_2 -> V_59 ) ;
if ( V_2 -> V_74 && V_2 -> V_75 )
