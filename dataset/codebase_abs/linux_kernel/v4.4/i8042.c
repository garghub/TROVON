...
V_4 -> V_115 = F_23 ;
V_4 -> V_28 = V_11 ;
V_4 -> V_103 . V_116 = & V_83 -> V_103 ;
F_76 ( V_4 -> V_117 , L_48 , sizeof( V_4 -> V_117 ) ) ;
F_76 ( V_4 -> V_118 , V_119 , sizeof( V_4 -> V_118 ) ) ;
F_76 ( V_4 -> V_120 , V_121 ,
sizeof( V_4 -> V_120 ) ) ;
V_11 -> V_4 = V_4 ;
V_11 -> V_47 = V_45 ;
return 0 ;
}
static int T_2 F_77 ( int V_122 )
{
struct V_4 * V_4 ;
int V_50 = V_122 < 0 ? V_36 : V_60 + V_122 ;
...
V_4 -> V_103 . V_116 = & V_83 -> V_103 ;
if ( V_122 < 0 ) {
F_76 ( V_4 -> V_117 , L_49 , sizeof( V_4 -> V_117 ) ) ;
F_76 ( V_4 -> V_118 , V_123 , sizeof( V_4 -> V_118 ) ) ;
F_76 ( V_4 -> V_120 , V_124 ,
sizeof( V_4 -> V_120 ) ) ;
V_4 -> V_115 = F_23 ;
} else {
snprintf ( V_4 -> V_117 , sizeof( V_4 -> V_117 ) , L_50 , V_122 ) ;
snprintf ( V_4 -> V_118 , sizeof( V_4 -> V_118 ) , V_125 , V_122 + 1 ) ;
F_76 ( V_4 -> V_120 , V_124 ,
sizeof( V_4 -> V_120 ) ) ;
}
V_11 -> V_4 = V_4 ;
...
bool F_87 ( const struct V_4 * V_11 )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_104 ; V_13 ++ )
...
unsigned long V_137 , void * V_2 )
{
struct V_102 * V_103 = V_2 ;
struct V_4 * V_4 = F_93 ( V_103 ) ;
struct V_27 * V_11 = V_4 -> V_28 ;
...
static int T_2 F_94 ( struct V_105 * V_103 )
{
int error ;
V_83 = V_103 ;
if ( V_96 ) {
...
static int F_95 ( struct V_105 * V_103 )
{
F_85 () ;
F_88 () ;
F_58 ( false ) ;
...
if ( V_144 )
goto V_145;
V_143 = F_99 ( & V_146 , F_94 , NULL , 0 , NULL , 0 ) ;
if ( F_100 ( V_143 ) ) {
V_144 = F_101 ( V_143 ) ;
goto V_145;
}
