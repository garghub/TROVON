...
if ( F_19 ( V_34 ) )
return F_20 ( V_34 ) ;
V_41 = F_16 ( V_38 -> V_39 -> V_40 , V_36 , & V_52 ) ;
if ( ! V_41 )
return F_17 ( - V_53 ) ;
* V_41 = * V_56 ;
...
V_34 = V_27 -> V_45 ;
V_34 -> V_41 = V_41 ;
V_34 -> V_60 = F_13 ( V_58 | F_21 ( 31 ) ) ;
V_34 -> V_42 = F_13 ( V_52 ) ;
V_34 -> V_36 = V_46 | V_37 ;
return V_41 ;
}
int F_22 ( struct V_50 * V_27 ,
...
int F_24 ( struct V_50 * V_27 , T_1 V_36 )
{
struct V_33 * V_34 ;
V_34 = F_15 ( V_27 , V_36 ) ;
if ( F_19 ( V_34 ) )
...
if ( F_19 ( V_34 ) )
return F_23 ( V_34 ) ;
V_34 -> V_60 = F_13 ( F_21 ( 31 ) ) ;
return 0 ;
}
int F_26 ( struct V_50 * V_27 ,
struct V_1 * V_63 ,
struct V_3 * V_4 ,
T_1 V_61 )
{
...
if ( V_4 -> V_64 == V_65 ) {
V_47 = V_67 + V_4 -> V_7 ;
V_42 = F_28 ( V_4 -> V_6 ) + V_4 -> V_8 ;
} else {
V_47 = F_28 ( V_4 -> V_6 ) + V_4 -> V_8 ;
V_42 = V_67 + V_4 -> V_7 ;
}
V_66 = F_22 ( V_27 , V_47 , V_42 , V_5 ,
V_36 , V_61 ) ;
if ( V_66 )
return V_66 ;
