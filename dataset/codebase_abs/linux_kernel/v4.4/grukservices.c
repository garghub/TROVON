...
if ( ! V_83 -> V_100 )
return V_143 ;
V_141 = F_83 ( V_83 -> V_99 , V_144 ) ;
V_142 = * V_81 ;
* V_81 = F_84 ( V_83 -> V_101 , V_83 -> V_100 ,
V_145 ) ;
F_85 ( V_34 , V_141 , F_70 ( V_102 ) , V_146 , V_110 ) ;
V_27 = F_71 ( V_34 ) ;
* V_81 = V_142 ;
if ( V_27 != V_69 )
return V_113 ;
...
static int F_86 ( void * V_34 , struct V_82 * V_83 ,
void * V_102 , int V_105 )
{
int V_107 , V_27 = 0 ;
V_107 = F_56 ( V_34 ) ;
...
int F_87 ( struct V_82 * V_83 , void * V_102 ,
unsigned int V_84 )
{
struct V_77 * V_78 ;
void * V_34 ;
...
V_78 -> V_105 = V_153 ;
if ( V_153 == 2 ) {
V_78 -> V_157 = F_63 ( V_78 ) ;
F_64 ( V_78 , V_156 ) ;
}
do {
V_27 = V_143 ;
F_69 ( V_34 , V_83 -> V_98 , F_70 ( V_78 ) , V_153 , V_110 ) ;
V_64 = F_71 ( V_34 ) ;
if ( V_64 != V_69 )
V_27 = F_86 ( V_34 , V_83 , V_35 , V_153 ) ;
} while ( V_27 == V_124 );
F_30 ( V_34 , V_35 ) ;
if ( V_27 )
F_7 ( V_158 ) ;
...
void F_89 ( struct V_82 * V_83 , void * V_102 )
{
...
if ( V_78 -> V_105 == 2 )
F_64 ( V_78 , V_78 -> V_157 ) ;
F_7 ( V_162 ) ;
return V_78 ;
}
int F_91 ( unsigned long * V_163 , unsigned long V_141 )
{
void * V_34 ;
void * V_35 ;
int V_27 , V_164 ;
...
return V_155 ;
V_164 = V_141 >> 62 ;
F_92 ( V_34 , V_141 , F_70 ( V_35 ) , V_164 , V_110 ) ;
V_27 = F_71 ( V_34 ) ;
if ( V_27 == V_69 )
...
int F_93 ( unsigned long V_166 , unsigned long V_167 ,
unsigned int V_84 )
{
void * V_34 ;
void * V_35 ;
...
if ( F_26 ( V_20 , & V_34 , & V_35 ) )
return V_155 ;
F_94 ( V_34 , V_167 , V_166 , F_70 ( V_35 ) ,
V_169 , V_84 , V_170 , V_110 ) ;
V_27 = F_71 ( V_34 ) ;
F_30 ( V_34 , V_35 ) ;
return V_27 ;
}
static int F_95 ( unsigned long V_171 )
{
unsigned long V_172 ;
unsigned long V_173 ;
void * V_34 ;
...
V_172 = V_175 ;
V_173 = 0 ;
F_96 ( V_34 , F_67 ( & V_172 ) , F_70 ( V_35 ) , V_132 , 1 , 1 , V_110 ) ;
if ( F_71 ( V_34 ) != V_69 ) {
F_97 ( V_176 L_6 , F_51 () ) ;
goto V_41;
}
if ( * V_76 != V_175 ) {
F_97 ( V_176 L_7 , F_51 () , * V_76 ) ;
goto V_41;
}
F_73 ( V_34 , F_67 ( & V_173 ) , F_70 ( V_35 ) , V_132 , 1 , 1 , V_110 ) ;
if ( F_71 ( V_34 ) != V_69 ) {
F_97 ( V_176 L_8 , F_51 () ) ;
goto V_41;
}
...
static int F_98 ( unsigned long V_171 )
{
struct V_82 V_83 ;
void * V_76 , * V_89 ;
int V_177 , V_27 = - V_174 ;
char V_178 [ V_79 ] , * V_106 ;
V_76 = F_99 ( 4096 , 0 ) ;
if ( V_76 == NULL )
return - V_179 ;
V_89 = F_100 ( V_76 , 1024 ) ;
memset ( V_178 , 0xee , sizeof( V_178 ) ) ;
F_65 ( & V_83 , V_89 , 8 * V_79 , 0 , 0 , 0 ) ;
for ( V_177 = 0 ; V_177 < 6 ; V_177 ++ ) {
V_178 [ 8 ] = V_177 ;
do {
V_27 = F_87 ( & V_83 , V_178 , sizeof( V_178 ) ) ;
} while ( V_27 == V_116 );
if ( V_27 )
break;
}
if ( V_27 != V_135 || V_177 != 4 ) {
F_97 ( V_176 L_10 ,
F_51 () , V_27 , V_177 ) ;
goto V_41;
}
for ( V_177 = 0 ; V_177 < 6 ; V_177 ++ ) {
V_106 = F_90 ( & V_83 ) ;
if ( ! V_106 || V_106 [ 8 ] != V_177 )
break;
F_89 ( & V_83 , V_106 ) ;
}
if ( V_177 != 4 ) {
F_97 ( V_176 L_11 ,
F_51 () , V_177 , V_106 , V_106 ? V_106 [ 8 ] : - 1 ) ;
goto V_41;
}
V_27 = 0 ;
V_41:
...
static int F_101 ( unsigned long V_171 )
{
static F_102 ( V_40 ) ;
unsigned long V_43 ;
int V_3 = 0 ;
...
void * V_181 , * V_34 ;
struct V_62 * V_63 ;
int V_177 , V_182 , V_64 , V_84 ;
V_84 = V_180 * 4 * 8 ;
V_60 = F_99 ( V_84 , V_183 ) ;
if ( ! V_60 )
return - V_179 ;
V_27 = - V_184 ;
V_43 = F_32 ( V_3 , V_180 , 0 , & V_40 ) ;
if ( ! V_43 )
goto V_41;
F_39 ( V_43 , & V_181 , NULL ) ;
memset ( V_60 , 0xee , V_84 ) ;
for ( V_177 = 0 ; V_177 < V_180 ; V_177 ++ )
F_82 ( V_181 + V_177 * V_37 , F_67 ( & V_60 [ V_177 * 4 ] ) , 0 ,
V_132 , 4 , 1 , V_185 ) ;
V_27 = 0 ;
V_182 = V_180 ;
do {
F_36 ( V_43 ) ;
for ( V_177 = 0 ; V_177 < V_180 ; V_177 ++ ) {
V_34 = V_181 + V_177 * V_37 ;
V_64 = F_103 ( V_34 ) ;
if ( V_64 != V_66 && V_64 != V_186 )
break;
}
if ( V_177 == V_180 )
continue;
if ( V_64 != V_69 ) {
F_97 ( V_176 L_12 , F_51 () , V_177 ) ;
V_27 = - V_187 ;
} else if ( V_60 [ 4 * V_177 ] || V_60 [ 4 * V_177 + 1 ] || V_60 [ 4 * V_177 + 2 ] ||
V_60 [ 4 * V_177 + 3 ] ) {
F_97 ( V_176 L_13 ,
F_51 () , V_177 , V_60 [ 4 * V_177 ] , V_60 [ 4 * V_177 + 1 ] , V_60 [ 4 * V_177 + 2 ] , V_60 [ 4 * V_177 + 3 ] ) ;
V_27 = - V_174 ;
}
V_182 -- ;
V_63 = V_34 ;
...
static int F_104 ( unsigned long V_171 )
{
char V_188 [ V_189 ] , V_190 [ V_189 ] ;
int V_27 = 0 ;
memset ( V_190 , 0 , sizeof( V_190 ) ) ;
memset ( V_188 , F_105 () & 255 , sizeof( V_188 ) ) ;
F_93 ( F_67 ( V_190 ) , F_67 ( V_188 ) , V_189 ) ;
if ( memcmp ( V_188 , V_190 , V_189 ) ) {
F_97 ( V_176 L_14 , F_51 () ) ;
V_27 = - V_174 ;
}
return V_27 ;
}
int F_106 ( unsigned long V_171 )
{
int V_27 = - V_191 ;
switch ( V_171 & 0xff ) {
case 0 :
