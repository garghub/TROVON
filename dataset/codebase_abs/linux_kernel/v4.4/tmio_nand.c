...
if ( V_40 == NULL )
F_9 ( & V_31 -> V_31 , L_6 ) ;
V_6 = F_33 ( & V_31 -> V_31 , sizeof( * V_6 ) , V_76 ) ;
if ( ! V_6 )
return - V_77 ;
V_6 -> V_31 = V_31 ;
F_34 ( V_31 , V_6 ) ;
...
V_2 -> V_9 = V_7 ;
V_2 -> V_78 = L_7 ;
V_2 -> V_31 . V_79 = & V_31 -> V_31 ;
V_6 -> V_60 = F_35 ( & V_31 -> V_31 , V_60 -> V_80 , F_36 ( V_60 ) ) ;
if ( ! V_6 -> V_60 )
return - V_81 ;
V_6 -> V_62 = V_19 -> V_80 & 0xfffff ;
V_6 -> V_19 = F_35 ( & V_31 -> V_31 , V_19 -> V_80 , F_36 ( V_19 ) ) ;
if ( ! V_6 -> V_19 )
return - V_81 ;
V_75 = F_24 ( V_31 , V_6 ) ;
if ( V_75 )
...
V_7 -> V_94 = V_40 -> V_94 ;
V_7 -> V_95 = 15 ;
V_75 = F_37 ( & V_31 -> V_31 , V_26 , & F_6 , 0 ,
F_38 ( & V_31 -> V_31 ) , V_6 ) ;
if ( V_75 ) {
...
static int F_43 ( struct V_55 * V_31 )
{
struct V_5 * V_6 = F_44 ( V_31 ) ;
F_42 ( & V_6 -> V_2 ) ;
F_28 ( V_31 , V_6 ) ;
return 0 ;
}
static int F_45 ( struct V_55 * V_31 , T_4 V_35 )
{
const struct V_56 * V_57 = F_25 ( V_31 ) ;
if ( V_57 -> V_101 )
V_57 -> V_101 ( V_31 ) ;
