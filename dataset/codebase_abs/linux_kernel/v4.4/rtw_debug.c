...
int F_41 ( struct V_9 * V_9 , const char T_2 * V_10 ,
unsigned long V_4 , void * V_6 )
{
struct V_11 * V_12 = V_6 ;
struct V_13 * V_14 = (struct V_13 * ) F_4 ( V_12 ) ;
...
if ( V_101 ) {
V_101 -> V_103 = V_104 ;
F_42 ( L_52 , V_101 -> V_103 ) ;
}
}
return V_4 ;
}
int F_43 ( char * V_1 , char * * V_2 ,
T_1 V_3 , int V_4 ,
int * V_5 , void * V_6 )
{
struct V_11 * V_12 = V_6 ;
...
int F_44 ( struct V_9 * V_9 , const char T_2 * V_10 ,
unsigned long V_4 , void * V_6 )
{
struct V_11 * V_12 = V_6 ;
struct V_13 * V_14 = (struct V_13 * ) F_4 ( V_12 ) ;
...
int F_46 ( struct V_9 * V_9 , const char T_2 * V_10 ,
unsigned long V_4 , void * V_6 )
{
struct V_11 * V_12 = V_6 ;
struct V_13 * V_14 = (struct V_13 * ) F_4 ( V_12 ) ;
...
int F_49 ( struct V_9 * V_9 , const char T_2 * V_10 ,
unsigned long V_4 , void * V_6 )
{
struct V_11 * V_12 = V_6 ;
struct V_13 * V_14 = (struct V_13 * ) F_4 ( V_12 ) ;
...
if ( V_101 ) {
V_101 -> V_107 = V_104 ;
F_50 ( V_12 , L_56 , V_104 ) ;
}
}
return V_4 ;
}
int F_51 ( char * V_1 , char * * V_2 ,
T_1 V_3 , int V_4 ,
int * V_5 , void * V_6 )
{
* V_5 = 1 ;
...
int F_52 ( struct V_9 * V_9 , const char T_2 * V_10 ,
unsigned long V_4 , void * V_6 )
{
struct V_11 * V_12 = V_6 ;
struct V_13 * V_14 = (struct V_13 * ) F_4 ( V_12 ) ;
...
V_110 = V_111 -> V_117 ;
while ( V_111 != V_110 ) {
V_49 = F_55 ( V_110 , struct V_48 , V_118 ) ;
V_110 = V_110 -> V_117 ;
