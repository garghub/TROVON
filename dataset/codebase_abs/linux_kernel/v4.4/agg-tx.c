...
if ( F_81 ( ! V_12 ) )
return;
V_144 = (struct V_143 * ) & V_12 -> V_145 ;
memcpy ( & V_144 -> V_41 , V_41 , V_18 ) ;
V_144 -> V_4 = V_4 ;
V_12 -> V_146 = V_147 ;
F_82 ( & V_2 -> V_148 , V_12 ) ;
...
T_1 V_138 ;
bool V_139 ;
V_15 = F_90 ( V_14 -> V_27 . V_34 . V_27 . V_155 . V_15 ) ;
V_139 = V_15 & V_156 ;
V_4 = ( V_15 & V_157 ) >> 2 ;
V_138 = ( V_15 & V_158 ) >> 6 ;
V_138 = F_91 ( V_138 , V_10 -> V_16 . V_159 ) ;
F_76 ( & V_57 -> V_60 . V_61 ) ;
V_59 = F_39 ( V_57 , V_4 ) ;
if ( ! V_59 )
goto V_160;
if ( V_14 -> V_27 . V_34 . V_27 . V_155 . V_5 != V_59 -> V_5 ) {
F_47 ( V_57 -> V_2 , L_21 ,
V_57 -> V_57 . V_21 , V_4 ) ;
goto V_160;
}
...
if ( F_90 ( V_14 -> V_27 . V_34 . V_27 . V_155 . V_161 )
== V_162 && V_138 ) {
if ( F_79 ( V_103 ,
& V_59 -> V_90 ) ) {
goto V_160;
