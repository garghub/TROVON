...
V_109 = F_62 ( V_10 , V_46 -> V_44 , & V_35 ) ;
if ( ! V_109 )
return;
...
V_114 = F_65 ( V_107 -> V_68 -> V_118 . V_119 ) ;
if ( V_114 == V_75 )
goto V_120;
}
F_64 (entry, &duplicates, head) {
V_114 = F_65 ( V_107 -> V_68 -> V_118 . V_119 ) ;
if ( V_114 == V_75 )
goto V_120;
}
...
goto V_120;
if ( V_104 == V_121 )
V_18 = F_68 ( V_10 , V_46 , & V_46 -> V_68 -> V_7 . V_118 ) ;
V_120:
F_69 ( & V_111 , & V_35 ) ;
V_117:
F_70 ( V_109 ) ;
...
case V_144 : {
struct V_145 V_146 ;
void T_6 * V_66 = ( void T_6 * ) ( long ) args -> V_147 ;
V_146 . V_57 = V_4 -> V_5 . V_11 ;
V_146 . V_12 = V_4 -> V_7 . V_118 . V_148 << V_149 ;
V_146 . V_59 = V_4 -> V_13 ;
V_146 . V_65 = V_4 -> V_14 ;
F_22 ( V_4 ) ;
if ( F_75 ( V_66 , & V_146 , sizeof( V_146 ) ) )
V_18 = - V_150 ;
break;
}
case V_151 :
...
T_4 V_58 ;
int V_18 ;
args -> V_153 = F_77 ( V_10 , args -> V_154 , args -> V_155 , 0 ) * ( ( args -> V_155 + 1 ) / 8 ) ;
args -> V_11 = ( T_2 ) args -> V_153 * args -> V_156 ;
...
static int F_79 ( struct V_159 * V_160 , void * V_52 )
{
struct V_161 * V_162 = (struct V_161 * ) V_160 -> V_163 ;
struct V_51 * V_48 = V_162 -> V_164 -> V_48 ;
struct V_9 * V_10 = V_48 -> V_54 ;
struct V_3 * V_39 ;
unsigned V_165 = 0 ;
F_11 ( & V_10 -> V_33 . V_34 ) ;
...
unsigned V_114 ;
const char * V_81 ;
V_114 = F_65 ( V_39 -> V_7 . V_118 . V_119 ) ;
switch ( V_114 ) {
case V_29 :
V_81 = L_10 ;
break;
...
F_80 ( V_160 , L_13 ,
V_165 , F_81 ( V_39 ) >> 10 , F_81 ( V_39 ) >> 20 ,
