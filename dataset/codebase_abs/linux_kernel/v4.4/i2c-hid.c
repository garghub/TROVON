...
F_79 ( V_69 -> V_161 , F_80 ( & V_2 -> V_45 ) , sizeof( V_69 -> V_161 ) ) ;
V_14 = F_81 ( V_69 ) ;
if ( V_14 ) {
if ( V_14 != - V_125 )
F_43 ( V_2 , L_40 , V_14 ) ;
...
static int F_89 ( struct V_76 * V_45 )
{
struct V_1 * V_2 = F_90 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
struct V_80 * V_69 = V_11 -> V_69 ;
int V_14 = 0 ;
int V_163 ;
if ( V_69 -> V_164 && V_69 -> V_164 -> V_165 )
V_14 = V_69 -> V_164 -> V_165 ( V_69 , V_166 ) ;
F_91 ( V_11 -> V_71 ) ;
if ( F_92 ( & V_2 -> V_45 ) ) {
V_163 = F_93 ( V_11 -> V_71 ) ;
if ( ! V_163 )
V_11 -> V_167 = true ;
else
F_94 ( V_69 , L_41 ,
...
static int F_95 ( struct V_76 * V_45 )
{
int V_14 ;
struct V_1 * V_2 = F_90 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
...
if ( V_14 )
return V_14 ;
if ( F_92 ( & V_2 -> V_45 ) && V_11 -> V_167 ) {
V_163 = F_97 ( V_11 -> V_71 ) ;
if ( ! V_163 )
V_11 -> V_167 = false ;
else
F_94 ( V_69 , L_42 ,
...
if ( V_69 -> V_164 && V_69 -> V_164 -> V_168 ) {
V_14 = V_69 -> V_164 -> V_168 ( V_69 ) ;
return V_14 ;
}
return 0 ;
}
static int F_98 ( struct V_76 * V_45 )
{
struct V_1 * V_2 = F_90 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_15 ( V_2 , V_63 ) ;
...
static int F_99 ( struct V_76 * V_45 )
{
struct V_1 * V_2 = F_90 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_96 ( V_11 -> V_71 ) ;
