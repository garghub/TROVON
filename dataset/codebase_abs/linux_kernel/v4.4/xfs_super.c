...
goto V_390;
V_391 =
F_151 ( sizeof( V_392 ) , L_51 ,
V_389 , NULL ) ;
if ( ! V_391 )
goto V_393;
V_394 = F_149 ( sizeof( struct V_395 ) ,
L_52 ) ;
if ( ! V_394 )
goto V_396;
return 0 ;
...
if ( error )
goto V_402;
V_300 = F_165 ( L_56 , NULL , V_403 ) ;
if ( ! V_300 ) {
error = - V_24 ;
goto V_404;
}
V_320 . V_405 . V_298 . V_299 = V_300 ;
V_320 . V_319 = F_126 ( struct V_320 ) ;
if ( ! V_320 . V_319 ) {
error = - V_24 ;
goto V_406;
}
error = F_166 ( & V_320 . V_405 , & V_407 , NULL ,
L_57 ) ;
if ( error )
goto V_322;
#ifdef F_167
V_408 . V_298 . V_299 = V_300 ;
error = F_166 ( & V_408 , & V_409 , NULL , L_58 ) ;
if ( error )
goto V_410;
#endif
error = F_168 () ;
