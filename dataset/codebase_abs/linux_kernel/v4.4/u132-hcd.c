...
char V_93 [ 30 * 3 + 4 ] ;
char * V_212 = V_93 ;
int V_213 = ( sizeof( V_93 ) - 1 ) / 3 ;
int V_214 = 0 ;
V_93 [ 0 ] = 0 ;
while ( V_211 -- > 0 ) {
if ( V_60 > V_213 ) {
} else if ( V_60 ++ < V_213 ) {
int V_215 = sprintf ( V_212 , L_51 , * V_100 ++ ) ;
V_212 += V_215 ;
V_214 += V_215 ;
} else
V_212 += sprintf ( V_212 , L_52 ) ;
}
if ( V_28 ) {
unsigned long V_67 ;
int V_49 ;
...
T_3 V_73 = V_28 -> V_73 ;
T_3 V_217 = V_28 -> V_71 ;
struct V_66 * * V_218 = NULL ;
while ( ++ V_216 < V_72 && -- V_73 > 0 ) {
if ( V_66 == V_28 -> V_78 [ V_79 &
++ V_217 ] ) {
V_218 = & V_28 -> V_78 [ V_79 &
V_217 ] ;
break;
} else
continue;
...
return V_49 ;
V_221 -> V_223 = V_224 ;
V_221 -> V_225 = ( V_138 & V_180 ) >> 24 ;
V_221 -> V_226 = 0 ;
V_221 -> V_227 = V_1 -> V_59 ;
V_149 = 1 + ( V_1 -> V_59 / 8 ) ;
V_221 -> V_228 = 7 + 2 * V_149 ;
V_149 = V_229 | V_230 ;
if ( V_138 & V_152 )
V_149 |= V_231 ;
if ( V_138 & V_176 )
...
V_149 |= V_234 ;
V_221 -> V_235 = F_129 ( V_149 ) ;
V_49 = F_45 ( V_1 , V_53 . V_100 , & V_222 ) ;
if ( V_49 )
return V_49 ;
memset ( V_221 -> V_97 . V_236 . V_237 , 0xff ,
sizeof( V_221 -> V_97 . V_236 . V_237 ) ) ;
V_221 -> V_97 . V_236 . V_237 [ 0 ] = V_222 & V_238 ;
if ( V_1 -> V_59 > 7 ) {
V_221 -> V_97 . V_236 . V_237 [ 1 ] = ( V_222 & V_238 ) >> 8 ;
V_221 -> V_97 . V_236 . V_237 [ 2 ] = 0xff ;
} else
V_221 -> V_97 . V_236 . V_237 [ 1 ] = 0xff ;
return 0 ;
}
static int F_130 ( struct V_1 * V_1 , T_5 * V_221 )
{
T_2 V_239 = - 1 ;
int V_240 = F_45 ( V_1 , V_53 . V_54 , & V_239 ) ;
* V_221 = F_131 ( V_239 ) ;
return V_240 ;
}
static int F_132 ( struct V_1 * V_1 , T_5 * V_221 , T_3 V_241 )
{
if ( V_241 == 0 || V_241 > V_1 -> V_59 ) {
return - V_141 ;
} else {
int V_123 = V_241 - 1 ;
T_2 V_242 = - 1 ;
int V_243 = F_45 ( V_1 ,
V_53 . V_61 [ V_123 ] , & V_242 ) ;
* V_221 = F_131 ( V_242 ) ;
if ( * ( T_3 * ) ( V_221 + 2 ) ) {
...
static int F_133 ( struct V_1 * V_1 , int V_244 )
{
int V_49 ;
T_2 V_245 ;
T_3 V_246 ;
T_3 V_247 ;
V_49 = F_45 ( V_1 , V_245 , & V_245 ) ;
if ( V_49 )
return V_49 ;
V_246 = V_245 ;
V_247 = V_246 + V_248 ;
...
static int F_135 ( struct V_1 * V_1 , T_3 V_254 ,
T_3 V_241 )
{
if ( V_241 == 0 || V_241 > V_1 -> V_59 ) {
return - V_141 ;
...
int V_244 = V_241 - 1 ;
struct V_255 * V_123 = & V_1 -> V_123 [ V_244 ] ;
V_123 -> V_256 &= ~ ( 1 << V_254 ) ;
switch ( V_254 ) {
case V_257 :
return F_90 ( V_1 ,
V_53 . V_61 [ V_244 ] , V_258 ) ;
case V_259 :
return F_90 ( V_1 ,
V_53 . V_61 [ V_244 ] , V_260 ) ;
case V_261 :
return F_133 ( V_1 , V_244 ) ;
default:
return - V_262 ;
}
}
}
static int F_136 ( struct V_1 * V_1 , T_3 V_254 ,
T_3 V_241 )
{
if ( V_241 == 0 || V_241 > V_1 -> V_59 ) {
return - V_141 ;
...
return F_90 ( V_1 , V_53 . V_61 [ V_244 ] ,
V_149 ) ;
}
}
...
int V_60 , V_274 = 0 , V_38 = 1 ;
if ( V_1 -> V_157 & V_181 ) {
if ( ( V_1 -> V_57 & V_139 ) > V_275 ) {
...
if ( ! ( V_1 -> V_62 [ V_60 ] & V_251 ) )
continue;
if ( ( V_1 -> V_62 [ V_60 ] & V_258 ) )
continue;
}
V_276:
return V_274 ? V_38 : 0 ;
...
static int F_138 ( struct V_5 * V_6 , T_3 V_278 , T_3 V_254 ,
T_3 V_241 , char * V_84 , T_3 V_279 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
static int F_139 ( struct V_5 * V_6 , unsigned V_290 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
F_43 ( V_1 ) ;
while ( V_291 -- > 0 ) {
struct V_22 * V_23 = & V_1 -> V_23 [ V_291 ] ;
F_27 ( V_1 , V_23 ) ;
} while ( V_293 -- > 0 ) {
struct V_27 * V_28 = V_1 -> V_28 [ V_293 ] ;
if ( V_28 )
F_39 ( V_1 , V_28 ) ;
}
V_1 -> V_14 += 1 ;
...
F_107 ( & V_1 -> V_47 , F_47 ) ;
while ( V_296 -- > 0 ) {
struct V_255 * V_123 = & V_1 -> V_123 [ V_296 ] ;
V_123 -> V_1 = V_1 ;
V_123 -> V_301 = 0 ;
V_123 -> V_302 = 0 ;
V_123 -> V_124 = 0 ;
...
while ( V_297 -- > 0 ) {
struct V_203 * V_31 = & V_1 -> V_31 [ V_297 ] ;
V_31 -> V_30 = 0 ;
}
while ( V_299 -- > 0 ) {
struct V_2 * V_3 = & V_1 -> V_3 [ V_299 ] ;
int V_60 = F_147 ( V_3 -> V_43 ) ;
int V_303 = F_147 ( V_3 -> V_45 ) ;
V_3 -> V_19 = NULL ;
V_3 -> V_4 = 0 ;
V_3 -> V_20 = 0 ;
V_3 -> V_304 = 0 ;
...
if ( V_305 > 0 )
return - V_50 ;
V_49 = F_149 ( V_12 , V_136 , V_137 ) ;
if ( V_49 )
return V_49 ;
V_49 = F_150 ( V_12 , V_51 , & V_51 ) ;
if ( V_49 )
return V_49 ;
V_49 = F_150 ( V_12 , V_53 . V_56 , & V_138 ) ;
if ( V_49 )
return V_49 ;
V_59 = V_138 & V_139 ;
if ( V_12 -> V_18 . V_306 )
return - V_141 ;
V_6 = F_151 ( & V_307 , & V_12 -> V_18 , F_152 ( & V_12 -> V_18 ) ) ;
if ( ! V_6 ) {
F_119 ( V_207 L_76
) ;
F_49 ( V_12 ) ;
