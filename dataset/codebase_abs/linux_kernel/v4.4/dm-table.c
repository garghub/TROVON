...
void F_46 ( struct V_21 * V_49 , struct V_40 * V_77 )
{
int V_78 = 0 ;
...
static int F_49 ( struct V_6 * V_66 , struct V_21 * V_49 )
{
struct V_21 * V_79 ;
if ( ! V_66 -> V_28 )
return ! V_49 -> V_80 ;
...
static char * * F_50 ( unsigned * V_81 , char * * V_82 )
{
char * * V_83 ;
unsigned V_84 ;
T_4 V_85 ;
...
V_83 = F_39 ( V_84 * sizeof( * V_83 ) , V_85 ) ;
if ( V_83 ) {
...
int F_51 ( int * V_87 , char * * * V_88 , char * V_89 )
{
...
static int F_53 ( struct V_6 * V_66 ,
struct V_55 * V_56 )
{
unsigned short V_92 =
V_56 -> V_62 >> V_60 ;
...
struct V_55 V_95 ;
unsigned V_42 = 0 ;
while ( V_42 < F_54 ( V_66 ) ) {
V_49 = F_55 ( V_66 , V_42 ++ ) ;
F_56 ( & V_95 ) ;
if ( V_49 -> type -> V_96 )
V_49 -> type -> V_96 ( V_49 , F_43 ,
& V_95 ) ;
if ( V_94 < V_49 -> V_51 &&
V_94 & ( ( V_95 . V_62 >>
V_60 ) - 1 ) )
...
int F_57 ( struct V_6 * V_7 , const char * type ,
...
if ( ! V_51 ) {
F_58 ( L_16 , F_20 ( V_7 -> V_30 ) ) ;
return - V_97 ;
}
V_43 -> type = F_59 ( type ) ;
if ( ! V_43 -> type ) {
F_58 ( L_17 , F_20 ( V_7 -> V_30 ) ,
type ) ;
return - V_97 ;
}
if ( F_60 ( V_43 -> type ) ) {
...
if ( F_61 ( V_43 -> type ) && ! ( V_7 -> V_27 & V_100 ) ) {
F_58 ( L_18 ,
F_20 ( V_7 -> V_30 ) , type ) ;
return - V_97 ;
}
...
return 0 ;
V_102:
F_58 ( L_24 , F_20 ( V_7 -> V_30 ) , type , V_43 -> error ) ;
F_23 ( V_43 -> type ) ;
return V_68 ;
}
static int F_63 ( struct V_106 * V_107 , struct V_108 * V_109 ,
unsigned * V_110 , char * * error , unsigned V_111 )
{
const char * V_112 = F_64 ( V_109 ) ;
char V_113 ;
if ( ! V_112 ||
...
int F_65 ( struct V_106 * V_107 , struct V_108 * V_109 ,
unsigned * V_110 , char * * error )
{
return F_63 ( V_107 , V_109 , V_110 , error , 0 ) ;
}
int F_66 ( struct V_106 * V_107 , struct V_108 * V_109 ,
unsigned * V_110 , char * * error )
{
return F_63 ( V_107 , V_109 , V_110 , error , 1 ) ;
}
const char * F_64 ( struct V_108 * V_116 )
{
char * V_68 ;
if ( V_116 -> V_87 ) {
V_116 -> V_87 -- ;
...
void F_67 ( struct V_108 * V_116 , unsigned V_117 )
{
F_34 ( V_116 -> V_87 < V_117 ) ;
V_116 -> V_87 -= V_117 ;
V_116 -> V_83 += V_117 ;
}
static bool F_68 ( unsigned V_118 )
{
return ( V_118 == V_119 ||
V_118 == V_120 ) ;
}
...
V_7 -> type = V_120 ;
} else if ( F_75 ( V_32 ) && F_68 ( V_125 ) ) {
V_7 -> type = V_125 ;
} else
V_7 -> type = V_119 ;
return 0 ;
}
unsigned F_76 ( struct V_6 * V_7 )
{
return V_7 -> type ;
}
struct V_128 * F_77 ( struct V_6 * V_7 )
{
return V_7 -> V_101 ;
}
bool F_78 ( struct V_6 * V_7 )
{
return F_68 ( F_76 ( V_7 ) ) ;
}
bool F_79 ( struct V_6 * V_7 )
{
return F_76 ( V_7 ) == V_120 ;
}
static int F_80 ( struct V_6 * V_7 , struct V_29 * V_30 )
{
unsigned type = F_76 ( V_7 ) ;
unsigned V_129 = 0 ;
struct V_21 * V_43 ;
unsigned V_42 ;
if ( F_44 ( type == V_130 ) ) {
...
V_7 -> V_45 = F_81 ( V_30 , type , V_7 -> V_131 , V_129 ) ;
if ( ! V_7 -> V_45 )
return - V_23 ;
return 0 ;
}
...
struct V_132 * F_83 ( struct V_6 * V_7 )
{
return V_7 -> V_45 ;
}
...
static bool F_86 ( struct V_137 * V_138 )
{
return ! ! F_87 ( V_138 ) ;
}
static struct V_137 * F_88 ( struct V_6 * V_7 )
{
struct V_34 * V_32 = F_73 ( V_7 ) ;
...
V_68 = F_80 ( V_7 , V_7 -> V_30 ) ;
if ( V_68 )
F_58 ( L_40 ) ;
return V_68 ;
}
void F_94 ( struct V_6 * V_7 ,
void (* F_95)( void * ) , void * V_144 )
{
F_96 ( & V_145 ) ;
V_7 -> V_146 = F_95 ;
V_7 -> V_147 = V_144 ;
...
T_1 F_100 ( struct V_6 * V_7 )
{
return V_7 -> V_28 ? ( V_7 -> V_24 [ V_7 -> V_28 - 1 ] + 1 ) : 0 ;
}
struct V_21 * F_55 ( struct V_6 * V_7 , unsigned int V_9 )
{
if ( V_9 >= V_7 -> V_28 )
return NULL ;
return V_7 -> V_26 + V_9 ;
}
struct V_21 * F_101 ( struct V_6 * V_7 , T_1 V_148 )
{
...
static int F_102 ( struct V_21 * V_49 , struct V_40 * V_46 ,
T_1 V_50 , T_1 V_51 , void * V_52 )
{
unsigned * V_149 = V_52 ;
( * V_149 ) ++ ;
...
if ( ! V_49 -> type -> V_96 )
return false ;
V_49 -> type -> V_96 ( V_49 , F_102 , & V_149 ) ;
if ( V_149 )
return false ;
}
return true ;
}
int F_104 ( struct V_6 * V_66 ,
struct V_55 * V_56 )
{
struct V_21 * V_72 ( V_49 ) ;
struct V_55 V_95 ;
...
V_140 = F_88 ( V_7 ) ;
if ( V_140 &&
F_89 ( F_91 ( V_7 -> V_30 ) , V_140 ) >= 0 )
return;
}
if ( F_86 ( F_91 ( V_7 -> V_30 ) ) ) {
F_19 ( L_44 ,
F_20 ( V_7 -> V_30 ) ) ;
F_107 ( F_91 ( V_7 -> V_30 ) ) ;
}
}
static int F_108 ( struct V_21 * V_49 , struct V_40 * V_46 ,
T_1 V_50 , T_1 V_51 , void * V_52 )
{
...
static bool F_109 ( struct V_6 * V_7 , unsigned V_152 )
{
struct V_21 * V_49 ;
unsigned V_42 = 0 ;
while ( V_42 < F_54 ( V_7 ) ) {
...
return true ;
if ( V_49 -> type -> V_96 &&
V_49 -> type -> V_96 ( V_49 , F_108 , & V_152 ) )
return true ;
}
return false ;
}
static bool F_110 ( struct V_6 * V_7 )
{
struct V_21 * V_49 ;
unsigned V_42 = 0 ;
while ( V_42 < F_54 ( V_7 ) ) {
...
{
struct V_53 * V_54 = F_29 ( V_46 -> V_47 ) ;
return V_54 && F_112 ( V_54 ) ;
}
static int F_113 ( struct V_21 * V_49 , struct V_40 * V_46 ,
T_1 V_50 , T_1 V_51 , void * V_52 )
{
struct V_53 * V_54 = F_29 ( V_46 -> V_47 ) ;
return V_54 && ! F_114 ( V_54 ) ;
}
static int F_115 ( struct V_21 * V_49 , struct V_40 * V_46 ,
T_1 V_50 , T_1 V_51 , void * V_52 )
{
struct V_53 * V_54 = F_29 ( V_46 -> V_47 ) ;
return V_54 && ! F_116 ( V_157 , & V_54 -> V_158 ) ;
}
...
return false ;
if ( ! V_49 -> type -> V_96 ||
V_49 -> type -> V_96 ( V_49 , F_118 , NULL ) )
return false ;
}
return true ;
}
...
return true ;
if ( V_49 -> type -> V_96 &&
V_49 -> type -> V_96 ( V_49 , F_120 , NULL ) )
return true ;
}
return false ;
}
void F_123 ( struct V_6 * V_7 , struct V_53 * V_54 ,
struct V_55 * V_56 )
{
unsigned V_152 = 0 ;
V_54 -> V_56 = * V_56 ;
...
F_125 ( V_157 , V_54 ) ;
F_106 ( V_7 ) ;
if ( F_114 ( V_54 ) && F_117 ( V_7 , F_113 ) )
F_124 ( V_167 , V_54 ) ;
F_127 () ;
if ( F_78 ( V_7 ) )
F_125 ( V_168 , V_54 ) ;
}
unsigned int F_54 ( struct V_6 * V_7 )
{
return V_7 -> V_28 ;
}
struct V_34 * F_73 ( struct V_6 * V_7 )
{
return & V_7 -> V_32 ;
}
T_2 F_128 ( struct V_6 * V_7 )
{
return V_7 -> V_27 ;
}
static void F_129 ( struct V_6 * V_7 , enum V_169 V_27 )
{
int V_42 = V_7 -> V_28 ;
...
void F_134 ( struct V_6 * V_7 , struct V_178 * V_179 )
{
F_41 ( & V_179 -> V_39 , & V_7 -> V_33 ) ;
}
int F_135 ( struct V_6 * V_7 , int V_180 )
{
struct V_37 * V_38 ;
struct V_34 * V_32 = F_73 ( V_7 ) ;
struct V_178 * V_179 ;
...
struct V_29 * F_139 ( struct V_6 * V_7 )
{
return V_7 -> V_30 ;
}
...
F_143 ( V_183 -> V_185 , V_184 ) ;
F_144 ( V_183 ) ;
F_145 ( V_183 -> V_185 , V_184 ) ;
}
}
}
