...
V_108 -> V_112 |= V_130 ;
if ( V_135 == V_159 ) {
V_2 -> V_80 . V_155 . V_173 ++ ;
V_108 -> V_72 [ 1 ] = ( V_140 > V_139 ) ?
V_174 :
V_175 ;
} else {
V_2 -> V_80 . V_155 . V_176 ++ ;
V_108 -> V_72 [ 1 ] = ( V_140 > V_139 ) ?
V_177 :
V_178 ;
}
...
case V_179 :
case V_180 :
V_2 -> V_181 . V_139 = V_8 -> V_72 [ 5 ] ;
V_2 -> V_181 . V_140 = V_8 -> V_72 [ 6 ] ;
F_45 ( & V_2 -> V_182 ) ;
break;
case V_183 :
V_2 -> V_184 = V_8 -> V_72 [ 6 ] & V_101 ;
F_45 ( & V_2 -> V_185 ) ;
break;
default:
F_9 ( V_2 -> V_19 , L_13 ) ;
...
V_2 -> V_186 , V_8 -> V_66 , F_40 ( V_8 -> V_68 ) ) ;
switch ( V_8 -> V_66 ) {
case V_187 :
F_35 ( V_2 , V_8 ) ;
break;
...
V_190 = V_108 -> V_114 ;
if ( V_128 -> V_191 != V_192 ) {
F_41 ( V_128 ) ;
return V_190 ;
}
V_128 -> V_193 = F_53 ( V_194 ) ;
V_128 -> V_191 = V_195 ;
V_128 -> V_196 = V_197 ;
...
struct V_127 * V_198 = F_56 ( & V_2 -> V_146 ) ;
struct V_107 * V_199 ;
if ( ! V_198 )
return false ;
V_199 = (struct V_107 * ) V_198 -> V_72 ;
if ( V_108 -> V_112 != V_199 -> V_112 )
return false ;
if ( V_108 -> V_114 != V_199 -> V_114 )
return false ;
return memcmp ( V_108 -> V_72 , V_199 -> V_72 , V_108 -> V_114 ) == 0 ;
}
...
if ( F_55 ( V_2 , V_128 ) ) {
V_126 -> V_203 ++ ;
V_126 -> V_204 += F_52 ( V_2 ) ;
F_41 ( V_128 ) ;
goto V_202;
}
V_126 -> V_205 ++ ;
V_126 -> V_206 += V_108 -> V_114 ;
F_54 ( V_128 ) ;
V_202:
V_33 . V_42 ^= V_49 ;
F_12 ( & V_2 -> V_37 , V_34 ) ;
...
static int F_62 ( struct V_207 * V_208 , int V_209 )
{
struct V_1 * V_2 = F_63 ( V_208 , struct V_1 , V_208 ) ;
unsigned long V_34 ;
int V_210 = 0 ;
int V_64 ;
while ( true ) {
struct V_7 V_211 ( V_8 ) ;
V_64 = F_19 ( V_2 , & V_8 ) ;
if ( V_64 )
break;
F_48 ( V_2 , & V_8 ) ;
...
F_66 ( V_2 -> V_19 ) ;
F_14 ( & V_2 -> V_37 , V_34 ) ;
F_3 ( 1 << V_2 -> V_186 , & V_2 -> V_212 -> V_213 ) ;
return V_210 ;
}
static T_3 F_67 ( int V_214 , void * V_215 )
{
struct V_1 * V_2 = V_215 ;
T_1 V_216 ;
V_216 = F_5 ( & V_2 -> V_212 -> V_217 ) & ( 1 << V_2 -> V_186 ) ;
if ( V_216 == ( 1 << V_2 -> V_186 ) )
return V_218 ;
F_5 ( & V_2 -> V_5 -> V_219 ) ;
F_3 ( 1 << V_2 -> V_186 , & V_2 -> V_212 -> V_217 ) ;
F_68 ( & V_2 -> V_208 ) ;
return V_220 ;
}
...
V_2 -> V_45 = V_224 ;
F_1 ( V_2 , V_14 ) ;
V_222 = F_5 ( V_2 -> V_15 + V_225 ) ;
F_3 ( 0x00 , & V_2 -> V_5 -> V_226 ) ;
V_221 = V_227 ;
do {
F_1 ( V_2 , V_14 ) ;
V_223 = F_5 ( V_2 -> V_15 + V_225 ) ;
if ( V_223 == ( V_222 ^ 0xff ) )
return 0 ;
F_70 ( 10 ) ;
} while ( F_71 ( V_227 , V_221 + V_228 / 2 ) );
F_9 ( V_2 -> V_19 , L_17 ) ;
return - V_229 ;
}
...
F_7 ( V_2 -> V_230 , V_2 -> V_15 + V_231 , sizeof( V_2 -> V_230 ) - 1 ) ;
if ( strncmp ( V_2 -> V_230 , L_19 , 10 ) ) {
F_9 ( V_2 -> V_19 , L_20 , V_2 -> V_230 ) ;
return - V_142 ;
}
if ( strstr ( V_2 -> V_230 , L_21 ) )
V_2 -> V_92 = V_97 ;
else
V_2 -> V_92 = V_93 ;
F_3 ( 1 << V_2 -> V_186 , & V_2 -> V_212 -> V_213 ) ;
...
static int F_84 ( struct V_123 * V_19 , enum V_236 V_237 )
{
struct V_1 * V_2 = F_75 ( V_19 ) ;
int V_64 ;
if ( V_237 != V_238 )
...
if ( V_64 )
return V_64 ;
if ( ! F_86 ( & V_2 -> V_182 , V_228 ) ) {
F_87 ( V_2 -> V_19 , L_32 , V_63 ) ;
return - V_229 ;
}
V_181 -> V_139 = V_2 -> V_181 . V_139 ;
V_181 -> V_140 = V_2 -> V_181 . V_140 ;
return 0 ;
}
static T_4 F_88 ( struct V_240 * V_124 ,
struct V_241 * V_242 ,
char * V_243 )
{
...
if ( V_64 )
return V_64 ;
if ( ! F_86 ( & V_2 -> V_185 , V_228 ) ) {
F_87 ( V_2 -> V_19 , L_32 , V_63 ) ;
return - V_229 ;
}
return snprintf ( V_243 , V_244 , L_33 , V_2 -> V_184 ) ;
}
static T_4 F_90 ( struct V_240 * V_124 ,
struct V_241 * V_242 ,
const char * V_243 , T_5 V_245 )
{
struct V_1 * V_2 = F_75 ( F_89 ( V_124 ) ) ;
unsigned long V_246 ;
int V_64 ;
if ( F_91 ( V_243 , 0 , & V_246 ) )
return - V_143 ;
V_64 = F_29 ( V_2 , V_246 ) ;
if ( V_64 )
return V_64 ;
...
static T_4 F_92 ( struct V_240 * V_124 ,
struct V_241 * V_242 ,
char * V_243 )
{
struct V_1 * V_2 = F_75 ( F_89 ( V_124 ) ) ;
return F_93 ( V_243 , V_244 , L_34 , V_2 -> V_230 ) ;
}
static int F_94 ( struct V_247 * V_248 )
{
struct V_249 * V_250 ;
struct V_123 * V_19 ;
struct V_1 * V_2 ;
...
struct V_240 * V_124 ;
int V_64 ;
V_250 = F_95 ( & V_248 -> V_124 ) ;
if ( ! V_250 )
return - V_252 ;
F_96 ( & V_248 -> V_124 , L_35 , V_250 -> V_253 ) ;
V_124 = & V_248 -> V_124 ;
...
V_2 = F_75 ( V_19 ) ;
V_2 -> V_19 = V_19 ;
V_2 -> V_186 = V_250 -> V_253 ;
F_100 ( V_19 , & V_2 -> V_208 , F_62 , V_57 ) ;
F_101 ( & V_2 -> V_146 ) ;
F_102 ( & V_2 -> V_37 ) ;
F_103 ( & V_2 -> V_185 ) ;
F_103 ( & V_2 -> V_182 ) ;
...
V_19 -> V_257 = & V_258 ;
V_19 -> V_34 |= V_259 ;
F_104 ( V_19 , & V_248 -> V_124 ) ;
V_2 -> V_80 . clock . V_260 = V_261 ;
V_2 -> V_80 . V_262 = & V_263 ;
V_2 -> V_80 . V_264 = F_84 ;
V_2 -> V_80 . V_265 = F_85 ;
V_2 -> V_80 . V_266 = V_91
| V_148
| V_121 ;
V_2 -> V_214 = F_105 ( V_248 , 0 ) ;
if ( V_2 -> V_214 < 0 ) {
F_98 ( V_124 , L_37 ) ;
V_64 = - V_142 ;
goto V_267;
}
V_19 -> V_214 = V_2 -> V_214 ;
V_84 = F_106 ( V_248 , V_268 , 0 ) ;
if ( ! V_84 ) {
F_98 ( V_124 , L_38 ) ;
V_64 = - V_142 ;
goto V_267;
}
V_2 -> V_15 = F_107 ( V_84 -> V_221 , F_108 ( V_84 ) ) ;
if ( ! V_2 -> V_15 ) {
F_98 ( V_124 , L_39 ) ;
V_64 = - V_20 ;
goto V_267;
...
V_84 = F_106 ( V_248 , V_268 , 1 ) ;
if ( ! V_84 ) {
F_98 ( V_124 , L_40 ) ;
V_64 = - V_142 ;
goto V_269;
}
V_2 -> V_212 = F_107 ( V_84 -> V_221 , F_108 ( V_84 ) ) ;
if ( ! V_2 -> V_212 ) {
F_98 ( V_124 , L_41 ) ;
V_64 = - V_20 ;
goto V_269;
...
F_3 ( 1 << V_2 -> V_186 , & V_2 -> V_212 -> V_217 ) ;
V_64 = F_109 ( V_2 -> V_214 , F_67 , V_270 , V_271 , V_2 ) ;
if ( V_64 ) {
F_98 ( V_124 , L_42 ) ;
goto V_272;
}
...
F_87 ( V_2 -> V_19 , L_45 , V_250 -> V_253 ) ;
return 0 ;
V_273:
F_112 ( & V_2 -> V_208 ) ;
F_3 ( 1 << V_2 -> V_186 , & V_2 -> V_212 -> V_217 ) ;
