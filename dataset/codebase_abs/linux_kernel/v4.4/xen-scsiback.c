...
F_99 (se_lun, &tpg_entry->se_tpg.tpg_lun_hlist, link) {
...
V_170 = F_100 ( sizeof( struct V_43 ) , V_105 ) ;
if ( V_170 == NULL ) {
V_35 = - V_83 ;
goto V_178;
}
...
static void F_103 ( struct V_43 * V_44 )
{
F_16 ( & V_44 -> V_180 ) ;
F_43 ( & V_44 -> V_42 , F_33 ) ;
}
...
static void F_105 ( struct V_1 * V_2 , const char * V_182 ,
char * V_169 , struct V_127 * V_135 , int V_183 )
{
if ( ! F_97 ( V_2 , V_169 , V_135 ) ) {
if ( F_106 ( V_167 , V_2 -> V_107 -> V_184 , V_182 ,
L_22 , V_185 ) ) {
F_22 ( L_23 , V_182 ) ;
F_104 ( V_2 , V_135 ) ;
}
} else if ( ! V_183 ) {
F_106 ( V_167 , V_2 -> V_107 -> V_184 , V_182 ,
L_22 , V_186 ) ;
}
}
static void F_107 ( struct V_1 * V_2 , const char * V_182 ,
struct V_127 * V_135 )
{
if ( ! F_104 ( V_2 , V_135 ) ) {
if ( F_106 ( V_167 , V_2 -> V_107 -> V_184 , V_182 ,
...
static void F_108 ( struct V_1 * V_2 , int V_187 ,
char * V_188 )
{
int V_35 ;
struct V_127 V_135 ;
...
char V_182 [ 64 ] ;
struct V_166 * V_107 = V_2 -> V_107 ;
snprintf ( V_182 , sizeof( V_182 ) , L_24 , V_188 ) ;
V_35 = F_109 ( V_167 , V_107 -> V_184 , V_182 , L_13 , & V_190 ) ;
if ( F_110 ( V_35 ) )
return;
snprintf ( V_192 , sizeof( V_192 ) , L_25 , V_188 ) ;
V_189 = F_111 ( V_167 , V_107 -> V_184 , V_192 , NULL ) ;
if ( F_112 ( V_189 ) ) {
F_106 ( V_167 , V_107 -> V_184 , V_182 ,
L_22 , V_186 ) ;
return;
}
F_113 ( V_169 , V_189 , V_191 ) ;
F_28 ( V_189 ) ;
snprintf ( V_192 , sizeof( V_192 ) , L_26 , V_188 ) ;
V_35 = F_109 ( V_167 , V_107 -> V_184 , V_192 , L_27 ,
& V_135 . V_193 , & V_135 . V_133 , & V_135 . V_134 , & V_135 . V_28 ) ;
if ( F_110 ( V_35 ) ) {
F_106 ( V_167 , V_107 -> V_184 , V_182 ,
L_22 , V_186 ) ;
return;
...
switch ( V_190 ) {
case V_195 :
F_105 ( V_2 , V_182 , V_169 , & V_135 , 0 ) ;
break;
case V_196 :
F_105 ( V_2 , V_182 , V_169 , & V_135 , 1 ) ;
break;
case V_197 :
F_107 ( V_2 , V_182 , & V_135 ) ;
break;
default:
break;
}
...
case V_198 :
if ( V_190 == V_185 ) {
if ( F_106 ( V_167 , V_107 -> V_184 , V_182 ,
L_22 , V_196 ) ) {
F_22 ( L_23 , V_192 ) ;
F_104 ( V_2 , & V_135 ) ;
F_106 ( V_167 , V_107 -> V_184 , V_182 ,
...
static void F_114 ( struct V_1 * V_2 , int V_187 )
{
int V_8 ;
char * * V_199 ;
unsigned int V_200 = 0 ;
V_199 = F_115 ( V_167 , V_2 -> V_107 -> V_184 , L_28 ,
& V_200 ) ;
if ( F_112 ( V_199 ) )
return;
for ( V_8 = 0 ; V_8 < V_200 ; V_8 ++ )
F_108 ( V_2 , V_187 , V_199 [ V_8 ] ) ;
F_28 ( V_199 ) ;
}
static void F_116 ( struct V_166 * V_107 ,
enum V_201 V_202 )
{
struct V_1 * V_2 = F_117 ( & V_107 -> V_107 ) ;
switch ( V_202 ) {
case V_195 :
break;
case V_185 :
...
{
struct V_43 * V_44 , * V_206 ;
struct V_129 * V_130 = & ( V_2 -> V_131 ) ;
unsigned long V_7 ;
F_9 ( & V_2 -> V_132 , V_7 ) ;
F_122 (entry, tmp, head, l)
F_103 ( V_44 ) ;
F_11 ( & V_2 -> V_132 , V_7 ) ;
}
static int F_123 ( struct V_166 * V_107 )
{
struct V_1 * V_2 = F_117 ( & V_107 -> V_107 ) ;
if ( V_2 -> V_63 )
F_61 ( V_2 ) ;
F_121 ( V_2 ) ;
F_124 ( & V_107 -> V_107 , NULL ) ;
return 0 ;
}
static int F_125 ( struct V_166 * V_107 ,
const struct V_207 * V_137 )
{
int V_35 ;
struct V_1 * V_2 = F_67 ( sizeof( struct V_1 ) ,
V_105 ) ;
F_56 ( L_30 , V_208 , V_107 , V_107 -> V_209 ) ;
if ( ! V_2 ) {
F_96 ( V_107 , - V_83 , L_31 ) ;
return - V_83 ;
}
V_2 -> V_107 = V_107 ;
F_124 ( & V_107 -> V_107 , V_2 ) ;
V_2 -> V_87 = V_107 -> V_209 ;
F_126 ( & V_2 -> V_55 ) ;
V_2 -> V_148 = 0 ;
F_127 ( & V_2 -> V_3 , 0 ) ;
F_68 ( & V_2 -> V_4 ) ;
...
F_128 ( & V_2 -> V_131 ) ;
F_126 ( & V_2 -> V_132 ) ;
V_35 = F_106 ( V_167 , V_107 -> V_184 , L_32 , L_13 ,
V_104 ) ;
if ( V_35 )
F_129 ( V_107 , V_35 , L_33 ) ;
V_35 = F_118 ( V_107 , V_210 ) ;
if ( V_35 )
goto V_211;
return 0 ;
V_211:
...
static char * F_130 ( struct V_212 * V_26 )
{
switch ( V_26 -> V_213 ) {
case V_214 :
return L_35 ;
...
static char * F_131 ( struct V_217 * V_116 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
struct V_212 * V_26 = V_24 -> V_26 ;
return & V_26 -> V_27 [ 0 ] ;
}
static T_9 F_132 ( struct V_217 * V_116 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
return V_24 -> V_218 ;
...
T_10 V_226 = 0 ;
int V_227 = 0 ;
V_26 = F_67 ( sizeof( struct V_212 ) , V_105 ) ;
if ( ! V_26 )
return F_134 ( - V_83 ) ;
V_26 -> V_228 = V_226 ;
V_225 = strstr ( V_224 , L_39 ) ;
if ( V_225 ) {
V_26 -> V_213 = V_214 ;
goto V_229;
}
V_225 = strstr ( V_224 , L_40 ) ;
if ( V_225 ) {
V_26 -> V_213 = V_215 ;
V_227 = 3 ;
goto V_229;
}
V_225 = strstr ( V_224 , L_41 ) ;
if ( V_225 ) {
V_26 -> V_213 = V_216 ;
goto V_229;
}
...
return F_134 ( - V_99 ) ;
V_229:
if ( strlen ( V_224 ) >= V_191 ) {
F_22 ( L_43 , V_224 ,
F_130 ( V_26 ) , V_191 ) ;
F_28 ( V_26 ) ;
return F_134 ( - V_99 ) ;
}
snprintf ( & V_26 -> V_27 [ 0 ] , V_191 , L_44 , & V_224 [ V_227 ] ) ;
F_56 ( L_45 ,
F_130 ( V_26 ) , V_224 ) ;
return & V_26 -> V_230 ;
}
static void F_135 ( struct V_219 * V_231 )
{
struct V_212 * V_26 = F_34 ( V_231 ,
struct V_212 , V_230 ) ;
F_56 ( L_46 ,
F_130 ( V_26 ) , V_26 -> V_27 ) ;
F_28 ( V_26 ) ;
}
static T_4 F_136 ( struct V_217 * V_116 )
{
return 1 ;
}
static int F_137 ( struct V_64 * V_64 )
{
if ( V_64 -> V_232 & V_233 )
return 0 ;
F_48 ( V_64 , 0 ) ;
...
static void F_138 ( struct V_64 * V_64 )
{
struct V_16 * V_22 = F_34 ( V_64 ,
struct V_16 , V_64 ) ;
F_73 ( V_126 , V_22 ) ;
}
static int F_139 ( struct V_67 * V_234 )
{
return 0 ;
}
static void F_140 ( struct V_67 * V_234 )
{
}
static T_4 F_141 ( struct V_67 * V_234 )
{
return 0 ;
}
...
V_22 -> V_47 = V_64 -> V_242 ;
F_44 ( V_22 ) ;
return 0 ;
}
static void F_149 ( struct V_64 * V_64 )
{
struct V_120 * V_243 = V_64 -> V_120 ;
struct V_112 * V_113 = V_243 -> V_244 ;
F_127 ( & V_113 -> V_122 , 1 ) ;
F_5 ( & V_113 -> V_115 ) ;
}
...
static T_11 F_151 ( struct V_245 * V_246 ,
char * V_5 )
{
struct V_217 * V_116 = F_152 ( V_246 ) ;
struct V_23 * V_24 = F_34 ( V_116 , struct V_23 ,
V_116 ) ;
T_11 V_247 ;
F_35 ( & V_24 -> V_45 ) ;
V_247 = snprintf ( V_5 , V_103 , L_47 , V_24 -> V_176 ) ;
F_36 ( & V_24 -> V_45 ) ;
return V_247 ;
}
static T_11 F_153 ( struct V_245 * V_246 ,
const char * V_5 , T_12 V_248 )
{
struct V_217 * V_116 = F_152 ( V_246 ) ;
struct V_23 * V_24 = F_34 ( V_116 , struct V_23 ,
V_116 ) ;
...
F_35 ( & V_24 -> V_45 ) ;
V_54 = snprintf ( V_24 -> V_176 , V_191 , L_44 , V_5 ) ;
...
V_116 = & V_24 -> V_116 ;
V_250 = F_67 ( sizeof( struct V_249 ) , V_105 ) ;
if ( ! V_250 ) {
F_36 ( & V_24 -> V_45 ) ;
return - V_83 ;
}
V_250 -> V_70 = F_155 ( V_251 ) ;
if ( F_112 ( V_250 -> V_70 ) ) {
F_36 ( & V_24 -> V_45 ) ;
F_28 ( V_250 ) ;
return - V_83 ;
...
V_234 = V_250 -> V_70 ;
V_250 -> V_70 -> V_235 = F_156 (
V_116 , ( unsigned char * ) V_224 ) ;
if ( ! V_250 -> V_70 -> V_235 ) {
F_36 ( & V_24 -> V_45 ) ;
F_56 ( L_50 ,
V_224 ) ;
...
static T_11 F_161 ( struct V_245 * V_246 , char * V_5 )
{
struct V_217 * V_116 = F_162 ( V_246 ) ;
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
struct V_249 * V_250 ;
T_11 V_255 ;
...
V_255 = snprintf ( V_5 , V_103 , L_47 ,
V_250 -> V_70 -> V_235 -> V_254 ) ;
F_36 ( & V_24 -> V_45 ) ;
return V_255 ;
}
static T_11 F_163 ( struct V_245 * V_246 ,
const char * V_5 , T_12 V_248 )
{
struct V_217 * V_116 = F_162 ( V_246 ) ;
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
struct V_212 * V_230 = V_24 -> V_26 ;
unsigned char V_256 [ V_191 ] , * V_225 , * V_257 ;
int V_255 ;
if ( ! strncmp ( V_5 , L_54 , 4 ) ) {
V_255 = F_159 ( V_24 ) ;
return ( ! V_255 ) ? V_248 : V_255 ;
}
if ( strlen ( V_5 ) >= V_191 ) {
F_22 ( L_55 ,
V_5 , V_191 ) ;
...
snprintf ( & V_256 [ 0 ] , V_191 , L_44 , V_5 ) ;
V_225 = strstr ( V_256 , L_39 ) ;
if ( V_225 ) {
if ( V_230 -> V_213 != V_214 ) {
F_22 ( L_56 ,
V_256 , F_130 ( V_230 ) ) ;
return - V_99 ;
}
...
V_225 = strstr ( V_256 , L_40 ) ;
if ( V_225 ) {
if ( V_230 -> V_213 != V_215 ) {
F_22 ( L_57 ,
V_256 , F_130 ( V_230 ) ) ;
return - V_99 ;
}
...
V_225 = strstr ( V_256 , L_41 ) ;
if ( V_225 ) {
if ( V_230 -> V_213 != V_216 ) {
F_22 ( L_58 ,
V_256 , F_130 ( V_230 ) ) ;
return - V_99 ;
}
...
V_255 = F_154 ( V_24 , V_257 ) ;
if ( V_255 < 0 )
return V_255 ;
return V_248 ;
}
static T_11
F_164 ( struct V_245 * V_246 , char * V_5 )
{
return sprintf ( V_5 , L_60
V_259 L_61 ,
V_260 , F_165 () -> V_261 , F_165 () -> V_262 ) ;
}
static char * F_166 ( void )
{
return L_62 ;
}
static int F_167 ( struct V_217 * V_116 ,
struct V_173 * V_28 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
...
static void F_168 ( struct V_217 * V_116 ,
struct V_173 * V_28 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
...
T_9 V_263 ;
int V_255 ;
if ( strstr ( V_224 , L_63 ) != V_224 )
return F_134 ( - V_99 ) ;
V_255 = F_170 ( V_224 + 5 , 10 , & V_263 ) ;
if ( V_255 )
return F_134 ( V_255 ) ;
...
V_24 -> V_26 = V_26 ;
V_24 -> V_218 = V_263 ;
V_255 = F_172 ( V_231 , & V_24 -> V_116 , V_26 -> V_213 ) ;
if ( V_255 < 0 ) {
F_28 ( V_24 ) ;
return NULL ;
}
F_35 ( & V_175 ) ;
F_102 ( & V_24 -> V_264 , & V_266 ) ;
F_36 ( & V_175 ) ;
return & V_24 -> V_116 ;
}
static void F_173 ( struct V_217 * V_116 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
F_35 ( & V_175 ) ;
...
static int F_175 ( struct V_217 * V_116 )
{
return 1 ;
}
static int F_176 ( struct V_217 * V_116 )
{
return 0 ;
}
static void F_177 ( void * V_267 )
{
...
V_271:
F_184 ( V_126 ) ;
F_22 ( L_66 , V_208 , V_255 ) ;
return V_255 ;
}
static void T_14 F_185 ( void )
{
struct V_5 * V_5 ;
while ( V_9 ) {
if ( F_12 ( & V_5 ) )
