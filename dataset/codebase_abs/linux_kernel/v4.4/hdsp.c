...
static int F_259 ( struct V_168 * V_26 ,
struct V_10 * V_10 )
{
...
V_10 -> V_26 = V_26 ;
F_73 ( & V_10 -> V_49 ) ;
F_260 ( & V_10 -> V_164 , F_192 , ( unsigned long ) V_10 ) ;
F_261 ( V_10 -> V_2 , V_534 , & V_10 -> V_17 ) ;
V_10 -> V_17 &= 0xff ;
F_262 ( V_10 -> V_2 , V_535 , 0xFF ) ;
...
if ( ( V_293 = F_263 ( V_2 ) ) < 0 )
return V_293 ;
F_264 ( V_10 -> V_2 ) ;
if ( ( V_293 = F_265 ( V_2 , L_172 ) ) < 0 )
return V_293 ;
V_10 -> V_314 = F_266 ( V_2 , 0 ) ;
if ( ( V_10 -> V_22 = F_267 ( V_10 -> V_314 , V_538 ) ) == NULL ) {
F_15 ( V_10 -> V_26 -> V_6 , L_207 ,
V_10 -> V_314 , V_10 -> V_314 + V_538 - 1 ) ;
return - V_129 ;
}
if ( F_268 ( V_2 -> V_313 , F_193 , V_539 ,
V_540 , V_10 ) ) {
...
static int F_269 ( struct V_10 * V_10 )
{
if ( V_10 -> V_314 ) {
F_62 ( & V_10 -> V_164 ) ;
