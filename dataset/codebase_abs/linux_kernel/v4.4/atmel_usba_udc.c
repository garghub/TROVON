...
F_65 ( & V_13 -> V_14 ) ;
V_249 = F_40 ( V_13 ) ;
V_34 = F_99 ( V_13 , V_252 ) & ( V_249 | V_253 ) ;
F_49 ( V_235 , L_60 , V_34 ) ;
if ( V_34 & V_254 ) {
F_46 ( V_13 , 0 ) ;
F_42 ( V_13 , V_255 , V_254 ) ;
F_41 ( V_13 , V_249 | V_256 ) ;
V_13 -> V_80 = true ;
F_49 ( V_195 , L_61 ) ;
if ( V_13 -> V_66 . V_154 != V_155
...
if ( V_34 & V_256 ) {
F_46 ( V_13 , 1 ) ;
F_42 ( V_13 , V_255 , V_256 ) ;
F_41 ( V_13 , V_249 & ~ V_256 ) ;
F_49 ( V_195 , L_62 ) ;
}
if ( V_34 & V_258 ) {
F_42 ( V_13 , V_255 , V_258 ) ;
F_47 ( V_13 ) ;
F_49 ( V_195 , L_63 ) ;
if ( V_13 -> V_66 . V_154 != V_155
&& V_13 -> V_168 && V_13 -> V_168 -> V_259 ) {
F_63 ( & V_13 -> V_14 ) ;
V_13 -> V_168 -> V_259 ( & V_13 -> V_66 ) ;
F_65 ( & V_13 -> V_14 ) ;
}
}
...
if ( V_251 ) {
int V_39 ;
for ( V_39 = 0 ; V_39 < V_13 -> V_261 ; V_39 ++ )
if ( V_251 & ( 1 << V_39 ) ) {
...
V_13 -> V_261 ++ ;
V_290 = F_149 ( & V_61 -> V_62 , sizeof( struct V_3 ) * V_13 -> V_261 ,
V_11 ) ;
if ( ! V_290 )
return F_146 ( - V_12 ) ;
...
if ( ! V_307 )
return F_146 ( - V_308 ) ;
V_290 = F_149 ( & V_61 -> V_62 , sizeof( struct V_3 ) * V_307 -> V_261 ,
V_11 ) ;
if ( ! V_290 )
return F_146 ( - V_12 ) ;
V_13 -> V_66 . V_72 = & V_290 [ 0 ] . V_4 ;
...
V_13 -> V_261 = V_307 -> V_261 ;
F_3 ( & V_290 [ 0 ] . V_4 . V_293 ) ;
for ( V_39 = 0 ; V_39 < V_307 -> V_261 ; V_39 ++ ) {
...
F_172 ( & V_61 -> V_62 , 1 ) ;
F_33 ( V_13 ) ;
for ( V_39 = 1 ; V_39 < V_13 -> V_261 ; V_39 ++ )
