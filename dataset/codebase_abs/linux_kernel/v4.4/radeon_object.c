...
int F_31 ( struct V_1 * V_2 , void * * V_83 )
{
bool V_84 ;
int V_64 ;
if ( V_2 -> V_85 ) {
...
V_64 = F_32 ( & V_2 -> V_8 , 0 , V_2 -> V_8 . V_9 , & V_2 -> V_86 ) ;
if ( V_64 ) {
return V_64 ;
}
V_2 -> V_85 = F_33 ( & V_2 -> V_86 , & V_84 ) ;
if ( V_83 ) {
* V_83 = V_2 -> V_85 ;
}
F_34 ( V_2 , 0 , 0 ) ;
...
int F_41 ( struct V_1 * V_2 , T_2 V_24 , T_1 V_87 ,
T_1 * V_88 )
{
int V_64 , V_26 ;
if ( F_42 ( V_2 -> V_8 . V_89 ) )
return - V_90 ;
if ( V_2 -> V_91 ) {
V_2 -> V_91 ++ ;
if ( V_88 )
...
* V_88 = F_43 ( V_2 ) ;
if ( V_24 == V_30 )
V_2 -> V_6 -> V_96 += F_47 ( V_2 ) ;
else
V_2 -> V_6 -> V_97 += F_47 ( V_2 ) ;
} else {
F_48 ( V_2 -> V_6 -> V_98 , L_3 , V_2 ) ;
}
return V_64 ;
}
int F_49 ( struct V_1 * V_2 , T_2 V_24 , T_1 * V_88 )
{
return F_41 ( V_2 , V_24 , 0 , V_88 ) ;
}
int F_50 ( struct V_1 * V_2 )
{
int V_64 , V_26 ;
if ( ! V_2 -> V_91 ) {
F_51 ( V_2 -> V_6 -> V_98 , L_4 , V_2 ) ;
return 0 ;
}
V_2 -> V_91 -- ;
if ( V_2 -> V_91 )
...
{
if ( ! V_6 -> V_104 ) {
V_6 -> V_33 . V_105 = F_58 ( V_6 -> V_33 . V_106 ,
V_6 -> V_33 . V_107 ) ;
}
F_59 ( L_8 ,
V_6 -> V_33 . V_108 >> 20 ,
...
T_1 V_113 = V_112 >> 1 ;
return F_66 ( V_113 , 1024 * 1024ull ) ;
}
...
T_1 V_113 = F_64 ( V_6 ) ;
F_23 ( & V_121 ) ;
V_64 = F_68 ( V_115 , V_117 , true , & V_121 ) ;
if ( F_22 ( V_64 != 0 ) ) {
return V_64 ;
}
...
if ( V_118 == V_130 )
F_71 ( V_2 , V_126 ) ;
V_123 = F_65 ( & V_6 -> V_131 ) ;
V_64 = F_45 ( & V_2 -> V_8 , & V_2 -> V_27 , true , false ) ;
V_122 += F_65 ( & V_6 -> V_131 ) -
V_123 ;
if ( F_22 ( V_64 ) ) {
if ( V_64 != - V_132 &&
V_24 != V_120 -> V_127 ) {
...
V_136 -> V_2 = V_2 ;
V_142:
F_77 ( V_6 , V_26 , V_2 -> V_134 , V_2 -> V_144 ,
...
int F_34 ( struct V_1 * V_2 , bool V_163 ,
bool V_164 )
{
if ( ! V_164 )
F_74 ( & V_2 -> V_8 . V_58 -> V_139 . V_140 ) ;
...
int F_86 ( struct V_1 * V_2 , T_2 * V_3 , bool V_169 )
{
int V_64 ;
V_64 = F_87 ( & V_2 -> V_8 , true , V_169 , false , NULL ) ;
if ( F_22 ( V_64 != 0 ) )
return V_64 ;
if ( V_3 )
* V_3 = V_2 -> V_8 . V_16 . V_3 ;
V_64 = F_88 ( & V_2 -> V_8 , true , true , V_169 ) ;
F_89 ( & V_2 -> V_8 ) ;
return V_64 ;
}
void F_90 ( struct V_1 * V_2 , struct V_170 * V_171 ,
bool V_172 )
{
struct V_57 * V_58 = V_2 -> V_8 . V_58 ;
if ( V_172 )
F_91 ( V_58 , & V_171 -> V_140 ) ;
else
F_92 ( V_58 , & V_171 -> V_140 ) ;
}
