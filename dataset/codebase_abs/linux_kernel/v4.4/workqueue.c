...
V_15 = F_122 ( sizeof( * V_15 ) , V_20 , V_201 ) ;
...
F_210 ( V_220 , V_116 ) ;
F_251 ( V_220 -> V_117 , V_220 -> V_117 , V_187 ) ;
V_217 -> V_116 = V_220 ;
V_217 -> V_24 = V_24 ;
F_204 ( V_221 ) ;
return V_217 ;
...
{
int V_25 ;
F_125 ( & V_217 -> V_24 -> V_161 ) ;
F_210 ( V_217 -> V_24 -> V_200 , V_217 -> V_116 ) ;
F_235 (node)
V_217 -> V_218 [ V_25 ] = F_255 ( V_217 -> V_24 , V_25 ,
V_217 -> V_218 [ V_25 ] ) ;
F_246 ( V_217 -> V_219 ) ;
F_261 ( V_217 -> V_24 -> V_219 , V_217 -> V_219 ) ;
F_127 ( & V_217 -> V_24 -> V_161 ) ;
}
...
V_24 -> V_208 . V_129 != & V_24 -> V_219 -> V_207 ) ,
L_10 , V_24 -> V_97 ) ;
return V_16 ;
} else {
...
F_123 ( & V_24 -> V_162 ) ;
F_123 ( & V_24 -> V_133 ) ;
F_274 ( & V_24 -> V_160 , V_243 , V_174 , 0 ) ;
F_123 ( & V_24 -> V_158 ) ;
if ( F_267 ( V_24 ) < 0 )
goto V_247;
if ( V_32 & V_249 ) {
...
if ( V_182 || V_97 [ 0 ] || V_256 [ 0 ] ) {
F_293 ( L_13 , V_258 , V_97 , V_182 ) ;
if ( V_256 [ 0 ] )
F_294 ( L_14 , V_256 ) ;
F_294 ( L_15 ) ;
}
...
V_285 -> V_16 = V_285 -> V_182 ( V_285 -> V_286 ) ;
}
long F_317 ( int V_55 , long (* V_182)( void * ) , void * V_286 )
{
struct V_284 V_285 = { . V_182 = V_182 , . V_286 = V_286 } ;
...
if ( V_24 -> V_32 & V_226 )
continue;
V_217 = F_259 ( V_24 , V_24 -> V_200 ) ;
if ( ! V_217 ) {
V_16 = - V_181 ;
break;
}
F_99 ( & V_217 -> V_158 , & V_288 ) ;
}
...
{
struct V_23 * V_24 = F_325 ( V_291 ) ;
return F_327 ( V_296 , V_297 , L_37 , V_24 -> V_171 ) ;
}
...
int V_301 ;
F_125 ( & V_24 -> V_161 ) ;
V_301 = F_327 ( V_296 , V_297 , L_37 , V_24 -> V_200 -> V_125 ) ;
F_127 ( & V_24 -> V_161 ) ;
return V_301 ;
}
