...
if ( V_27 -> V_127 < 0 )
V_27 -> V_127 = V_165 -> V_173 ;
else
F_73 ( V_27 -> V_127 != V_165 -> V_173 ) ;
V_30 -> V_5 = V_5 ;
V_30 -> V_164 = V_165 ;
V_30 -> V_27 = V_27 ;
F_101 ( V_30 ) ;
...
struct V_28 * V_30 ;
while ( ! F_102 ( & V_181 ) ) {
V_30 = F_121 ( V_181 . V_182 ,
struct V_28 , V_15 ) ;
F_105 ( & V_30 -> V_15 ) ;
F_10 ( V_30 ) ;
}
}
static void F_122 ( int V_29 )
{
struct V_78 * type ;
struct V_25 * V_27 ;
struct V_28 * V_30 ;
...
V_30 = * F_15 ( V_27 -> V_30 , V_29 ) ;
* F_15 ( V_27 -> V_30 , V_29 ) = NULL ;
if ( V_30 && F_123 ( & V_30 -> V_33 ) )
F_124 ( & V_30 -> V_15 , & V_181 ) ;
}
}
}
static int F_125 ( int V_29 )
{
struct V_78 * type ;
struct V_25 * V_27 ;
...
static int F_127 ( int V_29 , int V_5 )
{
struct V_78 * type ;
struct V_25 * V_27 ;
struct V_28 * V_30 ;
...
static void
F_129 ( struct V_78 * * V_186 , int V_187 , int V_188 )
{
struct V_78 * type ;
struct V_25 * V_27 ;
struct V_28 * V_30 ;
...
if ( V_189 >= 0 )
F_133 ( V_189 , & V_140 ) ;
F_129 ( V_183 , V_29 , V_189 ) ;
F_129 ( V_172 , V_29 , V_189 ) ;
}
static void F_134 ( int V_29 )
{
int V_11 , V_5 ;
V_5 = F_16 ( V_29 ) ;
F_135 (i, &uncore_cpu_mask) {
if ( V_5 == F_16 ( V_11 ) )
return;
}
F_133 ( V_29 , & V_140 ) ;
...
static void T_3 F_137 ( void * V_204 )
{
F_125 ( F_19 () ) ;
}
