...
static int
F_115 ( struct V_13 * V_14 , int V_196 , const char * * V_197 )
{
...
V_199 ++ ;
V_198 = F_116 ( V_201 ) + V_196 + 2 +
2 * V_199 ;
V_200 = calloc ( V_198 + 1 , sizeof( char * ) ) ;
if ( V_200 == NULL )
return - V_205 ;
for ( V_28 = 0 ; V_28 < F_116 ( V_201 ) ; V_28 ++ )
V_200 [ V_28 ] = F_117 ( V_201 [ V_28 ] ) ;
for ( V_35 = 0 ; V_35 < V_199 ; V_35 ++ ) {
V_200 [ V_28 ++ ] = L_65 ;
V_200 [ V_28 ++ ] = F_117 ( V_204 [ V_35 ] ) ;
}
V_200 [ V_28 ++ ] = F_117 ( L_66 ) ;
V_200 [ V_28 ++ ] = F_117 ( V_14 -> V_191 ) ;
for ( V_35 = 1 ; V_35 < ( unsigned int ) V_196 ; V_35 ++ , V_28 ++ )
V_200 [ V_28 ] = V_197 [ V_35 ] ;
F_118 ( V_206 , 'e' , L_67 , V_207 ) ;
F_118 ( V_206 , 0 , L_68 , V_207 ) ;
F_118 ( V_206 , 'R' , L_69 , V_207 ) ;
F_118 ( V_206 , 'F' , L_70 , V_208 ) ;
F_118 ( V_206 , 0 , L_71 , V_208 ) ;
F_118 ( V_206 , 'g' , NULL , V_208 ) ;
F_118 ( V_206 , 0 , L_72 , V_208 ) ;
F_118 ( V_206 , 'd' , L_73 , V_208 ) ;
F_118 ( V_206 , 'T' , L_74 , V_208 ) ;
F_118 ( V_206 , 'P' , L_75 , V_208 ) ;
F_118 ( V_206 , 'n' , L_76 , V_208 ) ;
F_118 ( V_206 , 'N' , L_77 , V_208 ) ;
F_118 ( V_206 , 'B' , L_78 , V_208 ) ;
F_118 ( V_206 , 'G' , L_79 , V_208 ) ;
F_118 ( V_206 , 'b' , L_80 , V_208 ) ;
F_118 ( V_206 , 'j' , L_81 , V_208 ) ;
F_118 ( V_206 , 'W' , L_82 , V_208 ) ;
F_118 ( V_206 , 0 , L_83 , V_208 ) ;
V_209 = V_202 ;
return F_119 ( V_28 , V_200 , NULL ) ;
}
static int
F_120 ( struct V_13 * V_14 , int V_196 , const char * * V_197 )
{
const struct V_210 V_211 [] = {
F_121 ( 0 , L_67 , & V_14 -> V_26 , L_84 ,
L_85
L_86 ) ,
F_122 ( 0 , L_87 , & V_14 -> V_60 ,
L_88 ) ,
F_121 ( 'k' , L_89 , & V_14 -> V_71 , L_90 ,
L_91
L_92 ) ,
F_121 ( 'p' , L_93 , & V_14 -> V_85 . V_86 . V_64 , L_93 ,
L_94 ) ,
F_123 ( 'f' , L_95 , & V_14 -> V_194 , L_96 ) ,
F_124 ()
} ;
...
static struct V_165 * F_127 ( void )
{
struct V_165 * V_120 ;
...
F_121 ( 'p' , L_93 , & V_14 -> V_85 . V_86 . V_64 , L_93 ,
L_100 ) ,
F_133 ( 'm' , L_101 , & V_14 -> V_85 . V_185 , L_102 ,
L_103 ,
V_218 ) ,
F_134 ( 'v' , L_104 , & V_219 ,
L_105 ) ,
F_123 ( 'a' , L_106 , & V_14 -> V_85 . V_86 . V_87 ,
L_107 ) ,
F_135 ( 'd' , L_108 , & V_14 -> V_139 ,
L_109 ) ,
F_121 ( 0 , L_67 , & V_14 -> V_26 , L_84 ,
L_110
L_111 ) ,
...
L_91
L_92 ) ,
F_136 ( 0 , L_112 , & V_14 -> V_61 ,
L_113
L_114
L_115 ) ,
F_135 ( 0 , L_116 , & V_14 -> V_85 . V_220 ,
L_117 ) ,
F_124 ()
} ;
...
static int F_150 ( const char * V_191 , int V_196 , const char * * V_197 )
{
struct V_13 V_14 = {
. V_191 = V_191 ,
. V_60 = - 1 ,
...
if ( ! strncmp ( V_197 [ 1 ] , L_127 , 3 ) )
return F_115 ( & V_14 , V_196 - 1 , V_197 + 1 ) ;
if ( ! strncmp ( V_197 [ 1 ] , L_128 , 3 ) )
return F_120 ( & V_14 , V_196 - 1 , V_197 + 1 ) ;
#ifdef F_151
if ( ! strncmp ( V_197 [ 1 ] , L_129 , 4 ) )
return F_132 ( & V_14 , V_196 - 1 , V_197 + 1 ) ;
#endif
V_240:
return F_152 ( V_196 , V_197 , NULL ) ;
}
...
V_198 = V_196 + 2 ;
V_200 = calloc ( V_198 + 1 , sizeof( char * ) ) ;
V_200 [ V_28 ++ ] = F_129 ( L_58 ) ;
V_200 [ V_28 ++ ] = F_129 ( L_66 ) ;
V_200 [ V_28 ++ ] = F_129 ( V_191 ) ;
for ( V_35 = 1 ; V_35 < V_196 ; V_35 ++ , V_28 ++ )
V_200 [ V_28 ] = V_197 [ V_35 ] ;
F_22 ( V_28 != V_198 ) ;
return F_119 ( V_28 , V_200 , NULL ) ;
}
static int F_154 ( const char * V_191 , int V_196 , const char * * V_197 )
{
int V_198 , V_28 = 0 , V_35 ;
const char * * V_200 ;
V_198 = V_196 + 2 ;
V_200 = calloc ( V_198 + 1 , sizeof( char * ) ) ;
V_200 [ V_28 ++ ] = F_129 ( L_130 ) ;
V_200 [ V_28 ++ ] = F_129 ( L_131 ) ;
V_200 [ V_28 ++ ] = F_129 ( V_191 ) ;
for ( V_35 = 1 ; V_35 < V_196 ; V_35 ++ , V_28 ++ )
V_200 [ V_28 ] = V_197 [ V_35 ] ;
F_22 ( V_28 != V_198 ) ;
return F_155 ( V_28 , V_200 , NULL ) ;
}
static int
F_156 ( const char * V_191 , int V_196 , const char * * V_197 )
{
int V_198 , V_28 = 0 , V_35 ;
const char * * V_200 ;
V_198 = V_196 + 2 ;
V_200 = calloc ( V_198 + 1 , sizeof( char * ) ) ;
V_200 [ V_28 ++ ] = F_129 ( L_132 ) ;
V_200 [ V_28 ++ ] = F_129 ( L_131 ) ;
V_200 [ V_28 ++ ] = F_129 ( V_191 ) ;
for ( V_35 = 1 ; V_35 < V_196 ; V_35 ++ , V_28 ++ )
V_200 [ V_28 ] = V_197 [ V_35 ] ;
F_22 ( V_28 != V_198 ) ;
return F_157 ( V_28 , V_200 , NULL ) ;
}
int F_158 ( int V_196 , const char * * V_197 , const char * T_6 V_12 )
{
const char * V_191 = NULL ;
const struct V_210 V_241 [] = {
F_121 ( 'i' , L_133 , & V_191 , L_134 ,
L_135 ) ,
F_121 ( 'o' , L_136 , & V_191 , L_134 ,
L_137 ) ,
F_123 ( 0 , L_138 , & V_242 ,
L_139 ) ,
F_123 ( 0 , L_140 , & V_243 ,
L_141 ) ,
F_121 ( 0 , L_142 , & V_234 . V_244 , L_143 ,
L_144
L_145 ) ,
F_121 ( 0 , L_146 , & V_234 . V_245 ,
L_134 , L_147 ) ,
F_121 ( 0 , L_148 , & V_234 . V_246 ,
L_134 , L_149 ) ,
F_121 ( 0 , L_150 , & V_234 . V_247 ,
L_134 , L_151 ) ,
F_134 ( 'v' , L_104 , & V_219 ,
L_105 ) ,
F_124 ()
} ;
const char * const V_248 [] = { L_152 , L_58 , L_130 , L_153 ,
L_132 , L_154 , NULL } ;
const char * V_249 [] = { NULL , NULL } ;
V_243 = 0 ;
V_242 = 1 ;
V_196 = F_159 ( V_196 , V_197 , V_241 , V_248 , V_249 ,
V_250 ) ;
if ( ! V_196 )
F_126 ( V_249 , V_241 ) ;
if ( ! V_243 )
...
if ( ! strncmp ( V_197 [ 0 ] , L_127 , 3 ) )
return F_153 ( V_191 , V_196 , V_197 ) ;
else if ( ! strncmp ( V_197 [ 0 ] , L_128 , 3 ) )
return F_154 ( V_191 , V_196 , V_197 ) ;
else if ( ! strncmp ( V_197 [ 0 ] , L_153 , 4 ) )
return F_161 ( V_196 , V_197 , NULL ) ;
else if ( ! strncmp ( V_197 [ 0 ] , L_152 , 3 ) )
return F_162 ( V_196 , V_197 , NULL ) ;
else if ( ! strncmp ( V_197 [ 0 ] , L_132 , 12 ) )
return F_156 ( V_191 , V_196 , V_197 ) ;
#ifdef F_163
else if ( ! strncmp ( V_197 [ 0 ] , L_154 , 4 ) )
return F_150 ( V_191 , V_196 , V_197 ) ;
#endif
else
F_126 ( V_249 , V_241 ) ;
return 0 ;
