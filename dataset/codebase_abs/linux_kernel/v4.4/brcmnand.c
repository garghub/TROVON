...
if ( F_87 ( ( unsigned long ) V_65 & 0x03 ) ) {
...
const T_6 * V_65 , int V_229 , int V_230 )
{
struct V_47 * V_48 = V_97 -> V_98 ;
...
F_3 ( V_2 , V_61 , V_36 ) ;
F_25 ( V_48 , V_68 -> V_69 ) ;
F_17 ( V_48 , F_37 ( V_97 -> V_264 . V_265 * 3 , 4 ) ) ;
return 0 ;
}
...
static inline int F_98 ( T_5 V_266 , T_1 V_232 )
{
return F_99 ( F_100 ( V_266 ) - F_100 ( V_232 ) , 8 ) >> 3 ;
}
...
V_68 -> V_245 = V_94 -> V_266 ;
V_68 -> V_244 = V_94 -> V_270 ;
V_68 -> V_82 = V_94 -> V_232 ;
V_68 -> V_257 = ( V_97 -> V_271 & V_272 ) ? 16 : 8 ;
V_68 -> V_253 = 2 ;
V_68 -> V_251 = F_98 ( V_94 -> V_266 , V_94 -> V_232 ) ;
switch ( V_97 -> V_264 . V_266 ) {
case 512 :
if ( V_97 -> V_264 . V_265 == 1 )
V_68 -> V_60 = 15 ;
else
V_68 -> V_60 = V_97 -> V_264 . V_265 ;
V_68 -> V_69 = 0 ;
break;
case 1024 :
if ( ! ( V_2 -> V_26 & V_29 ) ) {
...
if ( V_97 -> V_264 . V_265 & 0x1 ) {
F_6 ( V_2 -> V_10 ,
L_34 ) ;
return - V_247 ;
}
V_68 -> V_60 = V_97 -> V_264 . V_265 >> 1 ;
V_68 -> V_69 = 1 ;
break;
default:
F_6 ( V_2 -> V_10 , L_35 ,
...
V_68 -> V_255 = V_68 -> V_251 ;
if ( V_94 -> V_232 > 512 )
V_68 -> V_255 += V_68 -> V_253 ;
else
V_68 -> V_255 += 1 ;
...
{
struct V_1 * V_2 = V_48 -> V_2 ;
struct V_277 * V_278 = V_48 -> V_31 ;
struct V_279 * V_80 = V_48 -> V_80 ;
struct V_93 * V_94 ;
struct V_96 * V_97 ;
int V_174 ;
T_2 V_240 ;
struct V_280 V_281 = { . V_31 = V_278 } ;
V_174 = F_102 ( V_278 , L_37 , & V_48 -> V_39 ) ;
if ( V_174 ) {
F_6 ( & V_80 -> V_10 , L_38 ) ;
return - V_282 ;
}
...
V_97 -> V_98 = V_48 ;
V_94 -> V_98 = V_97 ;
V_94 -> V_283 = F_104 ( & V_80 -> V_10 , V_81 , L_39 ,
V_48 -> V_39 ) ;
V_94 -> V_284 = V_285 ;
V_94 -> V_10 . V_286 = & V_80 -> V_10 ;
V_97 -> V_287 = ( void V_288 * ) 0xdeadbeef ;
V_97 -> V_289 = ( void V_288 * ) 0xdeadbeef ;
V_97 -> V_290 = F_54 ;
V_97 -> V_178 = F_60 ;
V_97 -> V_291 = F_55 ;
V_97 -> V_292 = F_64 ;
V_97 -> V_293 = F_65 ;
V_97 -> V_294 = F_66 ;
V_97 -> V_264 . V_295 = V_296 ;
V_97 -> V_264 . V_297 = F_81 ;
V_97 -> V_264 . V_298 = F_85 ;
V_97 -> V_264 . V_299 = F_90 ;
V_97 -> V_264 . V_300 = F_82 ;
V_97 -> V_264 . V_301 = F_91 ;
V_97 -> V_264 . V_302 = F_93 ;
V_97 -> V_264 . V_303 = F_84 ;
V_97 -> V_264 . V_304 = F_83 ;
V_97 -> V_264 . V_305 = F_92 ;
V_97 -> V_306 = & V_2 -> V_306 ;
V_240 = F_15 ( V_2 , V_48 -> V_39 , V_241 ) ;
F_3 ( V_2 , V_240 ,
F_1 ( V_2 , V_240 ) & ~ V_307 ) ;
...
V_97 -> V_271 |= V_309 ;
if ( F_106 ( V_278 ) )
V_97 -> V_310 |= V_311 | V_312 ;
if ( F_101 ( V_48 ) )
return - V_282 ;
V_97 -> V_264 . V_266 = V_48 -> V_59 . V_69 ? 1024 : 512 ;
V_94 -> V_228 = 1 ;
V_97 -> V_264 . V_74 = F_38 ( V_48 ) ;
if ( ! V_97 -> V_264 . V_74 )
return - V_282 ;
if ( F_107 ( V_94 ) )
return - V_282 ;
return F_108 ( V_94 , NULL , & V_281 , NULL , 0 ) ;
}
...
T_2 V_61 = F_15 ( V_2 , V_48 -> V_39 ,
V_54 ) ;
T_2 V_314 = F_15 ( V_2 , V_48 -> V_39 , V_315 ) ;
T_2 V_316 = F_15 ( V_2 , V_48 -> V_39 , V_317 ) ;
if ( V_313 ) {
F_3 ( V_2 , V_240 , V_48 -> V_59 . V_318 ) ;
if ( V_240 != V_242 )
F_3 ( V_2 , V_242 ,
V_48 -> V_59 . V_319 ) ;
F_3 ( V_2 , V_61 , V_48 -> V_59 . V_55 ) ;
F_3 ( V_2 , V_314 , V_48 -> V_59 . V_320 ) ;
F_3 ( V_2 , V_316 , V_48 -> V_59 . V_321 ) ;
} else {
V_48 -> V_59 . V_318 = F_1 ( V_2 , V_240 ) ;
if ( V_240 != V_242 )
V_48 -> V_59 . V_319 =
F_1 ( V_2 , V_242 ) ;
V_48 -> V_59 . V_55 = F_1 ( V_2 , V_61 ) ;
V_48 -> V_59 . V_320 = F_1 ( V_2 , V_314 ) ;
V_48 -> V_59 . V_321 = F_1 ( V_2 , V_316 ) ;
}
}
static int F_110 ( struct V_322 * V_10 )
{
struct V_1 * V_2 = F_111 ( V_10 ) ;
struct V_47 * V_48 ;
F_112 (host, &ctrl->host_list, node)
F_109 ( V_48 , 0 ) ;
V_2 -> V_323 = F_8 ( V_2 , V_63 ) ;
V_2 -> V_324 = F_8 ( V_2 , V_325 ) ;
V_2 -> V_326 =
F_8 ( V_2 , V_50 ) ;
if ( F_27 ( V_2 ) )
V_2 -> V_327 = F_33 ( V_2 , V_328 ) ;
return 0 ;
}
static int F_113 ( struct V_322 * V_10 )
{
struct V_1 * V_2 = F_111 ( V_10 ) ;
struct V_47 * V_48 ;
if ( F_27 ( V_2 ) ) {
F_32 ( V_2 , V_328 , V_2 -> V_327 ) ;
F_32 ( V_2 , V_202 , 0 ) ;
}
F_9 ( V_2 , V_63 , V_2 -> V_323 ) ;
F_9 ( V_2 , V_325 , V_2 -> V_324 ) ;
F_9 ( V_2 , V_50 ,
V_2 -> V_326 ) ;
if ( V_2 -> V_116 ) {
V_2 -> V_116 -> V_117 ( V_2 -> V_116 ) ;
V_2 -> V_116 -> V_329 ( V_2 -> V_116 , true ) ;
}
F_112 (host, &ctrl->host_list, node) {
struct V_93 * V_94 = & V_48 -> V_94 ;
struct V_96 * V_97 = V_94 -> V_98 ;
...
int F_114 ( struct V_279 * V_80 , struct V_330 * V_116 )
{
struct V_322 * V_10 = & V_80 -> V_10 ;
struct V_277 * V_278 = V_10 -> V_31 , * V_331 ;
struct V_1 * V_2 ;
struct V_332 * V_333 ;
int V_174 ;
if ( ! V_278 )
return - V_11 ;
if ( ! F_115 ( V_334 , V_278 ) )
return - V_11 ;
...
F_117 ( & V_2 -> V_115 ) ;
F_117 ( & V_2 -> V_119 ) ;
F_118 ( & V_2 -> V_306 . V_335 ) ;
F_119 ( & V_2 -> V_306 . V_336 ) ;
F_120 ( & V_2 -> V_337 ) ;
V_333 = F_121 ( V_80 , V_338 , 0 ) ;
V_2 -> V_4 = F_122 ( V_10 , V_333 ) ;
if ( F_123 ( V_2 -> V_4 ) )
return F_124 ( V_2 -> V_4 ) ;
V_174 = F_5 ( V_2 ) ;
if ( V_174 )
return V_174 ;
V_333 = F_125 ( V_80 , V_338 , L_40 ) ;
if ( V_333 ) {
V_2 -> V_38 = F_122 ( V_10 , V_333 ) ;
if ( F_123 ( V_2 -> V_38 ) )
...
V_333 = F_125 ( V_80 , V_338 , L_41 ) ;
if ( V_333 ) {
V_2 -> V_64 = F_122 ( V_10 , V_333 ) ;
if ( F_123 ( V_2 -> V_64 ) )
...
if ( ! V_2 -> V_209 )
return - V_208 ;
V_2 -> V_340 = F_127 ( V_80 , 1 ) ;
if ( ( int ) V_2 -> V_340 < 0 ) {
F_6 ( V_10 , L_42 ) ;
return - V_11 ;
}
V_174 = F_128 ( V_10 , V_2 -> V_340 ,
F_50 , 0 , V_341 ,
V_2 ) ;
if ( V_174 < 0 ) {
F_6 ( V_10 , L_43 ,
