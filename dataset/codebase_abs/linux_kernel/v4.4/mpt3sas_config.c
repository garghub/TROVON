...
V_6 -> V_10 . V_74 = V_5 -> V_10 . V_74 ;
V_6 -> V_75 = V_5 -> V_75 ;
V_6 -> V_20 = V_5 -> V_20 ;
if ( V_6 -> V_10 . V_74 )
V_37 . V_39 = V_6 -> V_10 . V_74 * 4 ;
else
V_37 . V_39 = F_5 ( V_5 -> V_75 ) * 4 ;
V_38 = F_6 ( V_2 , & V_37 ) ;
if ( V_38 != 0 )
goto V_76;
if ( V_6 -> V_32 ==
...
V_48 && V_6 -> V_32 ==
V_96 ) {
T_4 * V_97 = ( T_4 * ) V_37 . V_41 ;
if ( V_97 ) {
if ( ( V_6 -> V_10 . V_11 & 0xF ) !=
( V_97 [ 3 ] & 0xF ) ) {
F_24 ( V_6 , V_2 -> V_93 / 4 ) ;
F_26 ( V_5 , V_2 -> V_93 / 4 ) ;
F_28 ( V_97 , F_17 ( T_1 , V_37 . V_39 ,
V_40 ) / 4 ) ;
...
* V_5 , T_20 * V_48 , T_5 V_115 , T_5 V_116 )
{
T_3 V_6 ;
int V_38 ;
memset ( & V_6 , 0 , sizeof( T_3 ) ) ;
...
* V_5 , T_22 * V_48 , T_5 V_115 , T_5 V_116 )
{
T_3 V_6 ;
int V_38 ;
memset ( & V_6 , 0 , sizeof( T_3 ) ) ;
...
if ( V_67 != V_95 )
goto V_76;
for ( V_141 = 0 ; V_141 < V_48 -> V_147 ; V_141 ++ ) {
V_143 = F_5 ( V_48 ->
V_148 [ V_141 ] . V_149 ) &
V_150 ;
if ( V_143 ==
