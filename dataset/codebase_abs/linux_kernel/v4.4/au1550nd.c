...
static int F_30 ( unsigned long V_56 )
{
void T_2 * V_20 =
( void T_2 * ) F_31 ( V_57 ) ;
...
V_17 = F_36 ( sizeof( * V_17 ) , V_71 ) ;
if ( ! V_17 )
return - V_72 ;
V_69 = F_37 ( V_65 , V_73 , 0 ) ;
if ( ! V_69 ) {
F_35 ( & V_65 -> V_70 , L_2 ) ;
V_6 = - V_63 ;
goto V_74;
}
if ( F_38 ( V_69 -> V_60 , F_39 ( V_69 ) , L_3 ) ) {
F_35 ( & V_65 -> V_70 , L_4 ) ;
V_6 = - V_72 ;
goto V_74;
}
V_17 -> V_20 = F_40 ( V_69 -> V_60 , 0x1000 ) ;
if ( ! V_17 -> V_20 ) {
F_35 ( & V_65 -> V_70 , L_5 ) ;
V_6 = - V_63 ;
goto V_75;
...
if ( V_67 -> V_83 )
V_4 -> V_45 |= V_46 ;
V_4 -> V_84 = ( V_67 -> V_83 ) ? F_6 : F_1 ;
V_17 -> V_44 = ( V_67 -> V_83 ) ? F_9 : F_4 ;
V_4 -> V_85 = F_12 ;
V_4 -> V_86 = ( V_67 -> V_83 ) ? F_15 : F_13 ;
V_4 -> V_87 = ( V_67 -> V_83 ) ? F_16 : F_14 ;
V_6 = F_41 ( & V_17 -> V_18 , 1 ) ;
if ( V_6 ) {
F_35 ( & V_65 -> V_70 , L_7 , V_6 ) ;
goto V_77;
}
F_42 ( & V_17 -> V_18 , V_67 -> V_88 , V_67 -> V_89 ) ;
F_43 ( V_65 , V_17 ) ;
return 0 ;
V_77:
F_44 ( V_17 -> V_20 ) ;
V_75:
F_45 ( V_69 -> V_60 , F_39 ( V_69 ) ) ;
V_74:
F_46 ( V_17 ) ;
return V_6 ;
}
...
{
struct V_16 * V_17 = F_48 ( V_65 ) ;
struct V_68 * V_69 = F_37 ( V_65 , V_73 , 0 ) ;
F_49 ( & V_17 -> V_18 ) ;
F_44 ( V_17 -> V_20 ) ;
F_45 ( V_69 -> V_60 , 0x1000 ) ;
F_46 ( V_17 ) ;
return 0 ;
}
