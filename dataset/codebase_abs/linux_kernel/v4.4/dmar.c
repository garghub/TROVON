...
if ( V_74 -> V_181 ) {
F_113 ( ( unsigned long ) V_74 -> V_181 -> V_182 ) ;
...
static inline void F_114 ( struct V_184 * V_181 )
{
...
sizeof( struct V_202 ) ) ;
F_116 ( V_74 , & V_181 -> V_182 [ V_53 ] ,
sizeof( struct V_202 ) ) ;
F_117 ( V_197 , V_74 -> V_146 + V_196 ) ;
return - V_52 ;
}
}
if ( V_191 & V_203 ) {
...
if ( V_191 & V_206 )
F_117 ( V_206 , V_74 -> V_146 + V_196 ) ;
return 0 ;
}
int F_118 ( struct V_202 * V_182 , struct V_145 * V_74 )
{
int V_207 ;
struct V_184 * V_181 = V_74 -> V_181 ;
...
V_210:
V_207 = 0 ;
F_119 ( & V_181 -> V_211 , V_73 ) ;
while ( V_181 -> V_190 < 3 ) {
F_120 ( & V_181 -> V_211 , V_73 ) ;
F_121 () ;
F_119 ( & V_181 -> V_211 , V_73 ) ;
}
V_53 = V_181 -> V_212 ;
...
V_208 [ V_53 ] = * V_182 ;
V_209 . V_200 = F_122 ( V_186 ) |
V_213 | V_214 ;
V_209 . V_201 = F_123 ( & V_181 -> V_183 [ V_194 ] ) ;
V_208 [ V_194 ] = V_209 ;
F_116 ( V_74 , & V_208 [ V_53 ] , sizeof( struct V_202 ) ) ;
F_116 ( V_74 , & V_208 [ V_194 ] , sizeof( struct V_202 ) ) ;
V_181 -> V_212 = ( V_181 -> V_212 + 2 ) % V_189 ;
V_181 -> V_190 -= 2 ;
F_117 ( V_181 -> V_212 << V_199 , V_74 -> V_146 + V_204 ) ;
while ( V_181 -> V_183 [ V_194 ] != V_186 ) {
V_207 = F_115 ( V_74 , V_53 ) ;
if ( V_207 )
break;
F_124 ( & V_181 -> V_211 ) ;
F_121 () ;
...
void F_127 ( struct V_145 * V_74 , T_2 V_216 , T_2 V_217 , T_5 V_218 ,
T_7 type )
{
struct V_202 V_182 ;
V_182 . V_200 = F_128 ( V_218 ) | F_129 ( V_217 ) | F_130 ( V_216 )
| F_131 ( type ) | V_219 ;
V_182 . V_201 = 0 ;
F_118 ( & V_182 , V_74 ) ;
}
void F_132 ( struct V_145 * V_74 , T_2 V_216 , T_7 V_129 ,
...
if ( F_134 ( V_74 -> V_132 ) )
V_222 = 1 ;
V_182 . V_200 = F_135 ( V_216 ) | F_136 ( V_222 ) | F_137 ( V_221 )
| F_138 ( type ) | V_224 ;
V_182 . V_201 = F_139 ( V_129 ) | F_140 ( V_223 )
| F_141 ( V_220 ) ;
F_118 ( & V_182 , V_74 ) ;
}
void F_142 ( struct V_145 * V_74 , T_2 V_217 , T_2 V_225 ,
...
V_182 . V_201 = F_143 ( V_129 ) | V_228 ;
} else
V_182 . V_201 = F_143 ( V_129 ) ;
if ( V_225 >= V_229 )
V_225 = 0 ;
V_182 . V_200 = F_144 ( V_217 ) | F_145 ( V_225 ) |
V_230 ;
F_118 ( & V_182 , V_74 ) ;
}
...
F_121 () ;
V_74 -> V_169 &= ~ V_174 ;
F_117 ( V_74 -> V_169 , V_74 -> V_146 + V_233 ) ;
...
V_181 -> V_190 = V_189 ;
F_119 ( & V_74 -> V_175 , V_73 ) ;
F_117 ( 0 , V_74 -> V_146 + V_204 ) ;
F_151 ( V_74 -> V_146 + V_234 , F_123 ( V_181 -> V_182 ) ) ;
V_74 -> V_169 |= V_174 ;
F_117 ( V_74 -> V_169 , V_74 -> V_146 + V_233 ) ;
...
if ( V_74 -> V_181 )
return 0 ;
V_74 -> V_181 = F_153 ( sizeof( * V_181 ) , V_238 ) ;
if ( ! V_74 -> V_181 )
return - V_39 ;
V_181 = V_74 -> V_181 ;
V_236 = F_154 ( V_74 -> V_86 , V_238 | V_239 , 0 ) ;
if ( ! V_236 ) {
F_10 ( V_181 ) ;
V_74 -> V_181 = NULL ;
return - V_39 ;
}
V_181 -> V_182 = F_155 ( V_236 ) ;
V_181 -> V_183 = F_13 ( V_189 * sizeof( int ) , V_238 ) ;
if ( ! V_181 -> V_183 ) {
F_113 ( ( unsigned long ) V_181 -> V_182 ) ;
F_10 ( V_181 ) ;
V_74 -> V_181 = NULL ;
return - V_39 ;
}
...
static const char * F_156 ( T_5 V_240 , int * V_241 )
{
if ( V_240 >= 0x20 && ( V_240 - 0x20 <
F_157 ( V_242 ) ) ) {
* V_241 = V_243 ;
return V_242 [ V_240 - 0x20 ] ;
} else if ( V_240 < F_157 ( V_244 ) ) {
* V_241 = V_245 ;
return V_244 [ V_240 ] ;
} else {
* V_241 = V_246 ;
...
static inline int F_158 ( struct V_145 * V_74 , int V_179 )
{
if ( V_74 -> V_179 == V_179 )
return V_247 ;
...
void F_160 ( struct V_249 * V_62 )
{
struct V_145 * V_74 = F_161 ( V_62 ) ;
int V_146 = F_158 ( V_74 , V_62 -> V_179 ) ;
unsigned long V_250 ;
F_119 ( & V_74 -> V_175 , V_250 ) ;
F_117 ( 0 , V_74 -> V_146 + V_146 ) ;
F_105 ( V_74 -> V_146 + V_146 ) ;
F_120 ( & V_74 -> V_175 , V_250 ) ;
}
...
unsigned long V_250 ;
F_119 ( & V_74 -> V_175 , V_250 ) ;
F_117 ( V_251 , V_74 -> V_146 + V_146 ) ;
F_105 ( V_74 -> V_146 + V_146 ) ;
F_120 ( & V_74 -> V_175 , V_250 ) ;
}
void F_163 ( int V_179 , struct V_252 * V_253 )
{
struct V_145 * V_74 = F_164 ( V_179 ) ;
int V_146 = F_158 ( V_74 , V_179 ) ;
unsigned long V_250 ;
F_119 ( & V_74 -> V_175 , V_250 ) ;
F_117 ( V_253 -> V_62 , V_74 -> V_146 + V_146 + 4 ) ;
F_117 ( V_253 -> V_254 , V_74 -> V_146 + V_146 + 8 ) ;
F_117 ( V_253 -> V_255 , V_74 -> V_146 + V_146 + 12 ) ;
F_120 ( & V_74 -> V_175 , V_250 ) ;
}
...
static int F_166 ( struct V_145 * V_74 , int type ,
T_5 V_240 , T_2 V_256 , unsigned long long V_129 )
{
const char * V_257 ;
int V_241 ;
V_257 = F_156 ( V_240 , & V_241 ) ;
if ( V_241 == V_243 )
F_71 ( L_44
L_45
L_46 ,
...
T_12 F_167 ( int V_179 , void * V_258 )
{
...
V_259 * V_264 + 8 ) ;
V_256 = F_172 ( V_62 ) ;
V_263 = F_83 ( V_74 -> V_146 + V_146 +
V_259 * V_264 ) ;
V_263 = F_173 ( V_263 ) ;
F_117 ( V_265 , V_74 -> V_146 + V_146 +
V_259 * V_264 + 12 ) ;
F_120 ( & V_74 -> V_175 , V_250 ) ;
F_166 ( V_74 , type , V_240 ,
V_256 , V_263 ) ;
V_259 ++ ;
if ( V_259 >= F_174 ( V_74 -> V_132 ) )
V_259 = 0 ;
F_119 ( & V_74 -> V_175 , V_250 ) ;
}
F_117 ( V_266 | V_261 , V_74 -> V_146 + V_196 ) ;
V_262:
F_120 ( & V_74 -> V_175 , V_250 ) ;
return V_267 ;
}
int F_175 ( struct V_145 * V_74 )
{
int V_179 , V_54 ;
if ( V_74 -> V_179 )
return 0 ;
V_179 = F_176 ( V_74 -> V_156 , V_74 -> V_86 , V_74 ) ;
if ( V_179 > 0 ) {
V_74 -> V_179 = V_179 ;
} else {
F_71 ( L_53 ) ;
...
V_54 = F_177 ( V_179 , F_167 , V_268 , V_74 -> V_152 , V_74 ) ;
if ( V_54 )
F_71 ( L_54 ) ;
return V_54 ;
}
...
F_167 ( V_74 -> V_179 , V_74 ) ;
V_260 = F_105 ( V_74 -> V_146 + V_196 ) ;
F_117 ( V_260 , V_74 -> V_146 + V_196 ) ;
}
return 0 ;
}
...
static inline bool F_187 ( T_6 V_271 , int V_272 )
{
return F_188 ( V_271 , V_273 , V_274 , 1 << V_272 ) ;
}
static int F_189 ( T_6 V_271 , int V_272 ,
T_13 V_275 , void * V_71 )
{
int V_54 = - V_118 ;
union V_276 * V_277 ;
struct V_70 * V_6 ;
...
if ( ! F_187 ( V_271 , V_272 ) )
return 0 ;
V_277 = F_190 ( V_271 , V_273 , V_274 ,
V_272 , NULL , V_283 ) ;
if ( ! V_277 )
return - V_118 ;
memset ( & V_278 , 0 , sizeof( V_278 ) ) ;
V_278 . V_107 [ V_279 [ V_272 ] ] = V_275 ;
V_278 . V_71 [ V_279 [ V_272 ] ] = V_71 ;
V_6 = (struct V_70 * ) V_277 -> V_284 . V_285 ;
V_54 = F_55 ( V_6 , V_277 -> V_284 . V_17 , & V_278 ) ;
F_191 ( V_277 ) ;
return V_54 ;
}
...
static int F_198 ( T_6 V_271 )
{
int V_54 ;
int V_115 = 0 ;
V_54 = F_189 ( V_271 , V_280 ,
& F_80 , ( void * ) 1 ) ;
if ( V_54 )
goto V_72;
V_54 = F_189 ( V_271 , V_280 ,
...
V_54 = F_189 ( V_271 , V_282 ,
& F_48 , NULL ) ;
if ( V_54 )
goto V_286;
V_54 = F_189 ( V_271 , V_281 ,
& V_117 , NULL ) ;
if ( V_54 )
goto V_287;
V_54 = F_189 ( V_271 , V_280 ,
...
& F_195 , NULL ) ;
if ( V_54 == 0 ) {
F_200 ( F_189 ( V_271 , V_281 ,
& V_288 , NULL ) ) ;
F_200 ( F_189 ( V_271 , V_280 ,
& F_196 , NULL ) ) ;
} else {
F_189 ( V_271 , V_280 ,
& F_192 , NULL ) ;
...
static T_4 F_201 ( T_6 V_271 , T_10 V_290 ,
void * V_291 , void * * V_292 )
{
T_6 * V_293 = V_292 ;
if ( F_187 ( V_271 , V_280 ) ) {
* V_293 = V_271 ;
return V_294 ;
}
return V_99 ;
}
static int F_202 ( T_6 V_271 , bool V_295 )
{
int V_54 ;
T_6 V_30 = NULL ;
T_4 V_98 ;
...
int F_205 ( T_6 V_271 )
{
return F_202 ( V_271 , true ) ;
}
int F_206 ( T_6 V_271 )
{
return F_202 ( V_271 , false ) ;
}
