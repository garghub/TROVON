...
{
struct V_56 * V_57 = V_140 -> V_143 ;
void (* F_103)( struct V_56 * ) = V_140 -> V_144 ;
F_104 ( V_140 ) ;
F_103 ( V_57 ) ;
}
...
F_107 ( V_140 , F_53 ( V_57 ) , F_54 ( V_57 ) ) ;
...
static void * F_109 ( struct V_56 * V_57 , bool V_300 ,
unsigned long * V_16 )
{
F_5 ( & V_301 , * V_16 ) ;
...
static inline void F_111 ( struct V_56 * V_57 , bool V_304 ,
unsigned long * V_16 )
{
if ( V_304 )
F_112 ( F_53 ( V_57 ) , F_54 ( V_57 ) ,
V_302 , V_303 ) ;
F_9 ( & V_301 , * V_16 ) ;
}
...
static unsigned int F_116 ( struct V_305 * args , T_3 * V_306 )
{
const T_3 V_309 [] = {
0 ,
0x80 ,
...
V_306 [ V_315 + 3 ] = V_101 ;
V_315 += 4 ;
F_37 ( args -> V_93 , ( unsigned char * ) V_306 + V_315 ,
V_100 , V_101 ) ;
V_315 += V_101 ;
V_306 [ V_315 + 0 ] = 2 ;
V_306 [ V_315 + 1 ] = 1 ;
...
V_315 += 8 ;
F_37 ( args -> V_93 , ( unsigned char * ) V_306 + V_315 , V_96 ,
V_97 ) ;
V_315 += V_97 ;
F_37 ( args -> V_93 , ( unsigned char * ) V_306 + V_315 , V_100 ,
V_101 ) ;
V_315 += V_101 ;
if ( F_118 ( args -> V_93 ) ) {
V_306 [ V_315 + 0 ] = 1 ;
...
V_306 [ 1 ] = 0xb0 ;
V_306 [ 3 ] = 0x3c ;
V_320 = 1 << F_122 ( args -> V_93 ) ;
F_123 ( V_320 , & V_306 [ 6 ] ) ;
if ( F_124 ( args -> V_93 ) ) {
F_125 ( 65535 * 512 / 8 , & V_306 [ 36 ] ) ;
F_126 ( 1 , & V_306 [ 28 ] ) ;
}
return 0 ;
}
static unsigned int F_127 ( struct V_305 * args , T_3 * V_306 )
{
int V_321 = F_128 ( args -> V_93 ) ;
int V_322 = F_129 ( args -> V_93 ) ;
V_306 [ 1 ] = 0xb1 ;
V_306 [ 3 ] = 0x3c ;
V_306 [ 4 ] = V_322 >> 8 ;
V_306 [ 5 ] = V_322 ;
...
static unsigned int F_130 ( struct V_305 * args , T_3 * V_306 )
{
V_306 [ 1 ] = 0xb2 ;
V_306 [ 3 ] = 0x4 ;
V_306 [ 5 ] = 1 << 6 ;
...
static unsigned int F_131 ( struct V_305 * args , T_3 * V_306 )
{
F_93 ( L_31 ) ;
return 0 ;
}
static void F_132 ( T_3 * V_323 , const T_3 * V_324 , int V_325 , bool V_326 )
{
if ( V_326 ) {
...
static unsigned int F_133 ( T_6 * V_93 , T_3 * V_4 , bool V_326 )
{
F_132 ( V_4 , V_327 , sizeof( V_327 ) , V_326 ) ;
if ( V_326 || F_134 ( V_93 ) )
V_4 [ 2 ] |= ( 1 << 2 ) ;
if ( ! V_326 && ! F_135 ( V_93 ) )
V_4 [ 12 ] |= ( 1 << 5 ) ;
...
static unsigned int F_136 ( T_3 * V_4 , bool V_326 )
{
F_132 ( V_4 , V_328 , sizeof( V_328 ) , V_326 ) ;
return sizeof( V_328 ) ;
}
static unsigned int F_137 ( T_3 * V_4 , bool V_326 )
{
F_132 ( V_4 , V_329 , sizeof( V_329 ) ,
V_326 ) ;
return sizeof( V_329 ) ;
}
static int F_138 ( T_6 * V_93 )
{
...
if ( ! F_139 ( V_93 ) )
return 0 ;
F_140 ( V_93 , V_330 , V_96 , sizeof( V_330 ) ) ;
F_140 ( V_93 , V_331 , V_98 , sizeof( V_331 ) ) ;
...
static unsigned int F_141 ( struct V_305 * args , T_3 * V_306 )
{
...
switch( V_335 ) {
case V_344 :
V_333 += F_137 ( V_333 , V_338 == 1 ) ;
break;
case V_345 :
V_333 += F_133 ( args -> V_93 , V_333 , V_338 == 1 ) ;
break;
case V_346 :
V_333 += F_136 ( V_333 , V_338 == 1 ) ;
break;
case V_347 :
V_333 += F_137 ( V_333 , V_338 == 1 ) ;
V_333 += F_133 ( args -> V_93 , V_333 , V_338 == 1 ) ;
...
V_340 = 0 ;
if ( F_138 ( args -> V_93 ) && ( V_13 -> V_16 & V_266 ) &&
...
static unsigned int F_142 ( struct V_305 * args , T_3 * V_306 )
{
struct V_12 * V_13 = args -> V_13 ;
...
V_352 = F_122 ( V_13 -> V_93 ) ;
V_353 = F_143 ( V_13 -> V_93 , V_352 ) ;
F_93 ( L_31 ) ;
...
static unsigned int F_146 ( struct V_305 * args , T_3 * V_306 )
{
F_93 ( L_31 ) ;
V_306 [ 3 ] = 8 ;
return 0 ;
...
F_151 ( V_140 ) ;
F_152 ( & V_140 -> V_359 , V_57 -> V_64 , V_111 ) ;
F_107 ( V_140 , & V_140 -> V_359 , 1 ) ;
V_140 -> V_291 = V_116 ;
...
static unsigned int F_154 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
struct V_12 * V_13 = V_140 -> V_13 ;
...
V_140 -> V_154 . V_156 = V_362 ;
F_55 ( V_140 ) ;
if ( ! V_370 && ! V_371 && F_155 ( V_140 ) )
V_371 = 1 ;
V_152 = F_78 ( F_156 ( V_140 ) , ( unsigned int ) 63 * 1024 ) ;
if ( V_152 & 0x1 )
V_152 ++ ;
...
{
if ( ! F_158 ( V_9 ) ) {
if ( F_65 ( V_43 < F_159 ( & V_9 -> V_11 ) ) )
return & V_9 -> V_11 . V_1 [ V_43 ] ;
} else {
if ( F_65 ( V_43 < V_9 -> V_375 ) )
...
int V_43 ;
if ( ! F_158 ( V_9 ) ) {
if ( F_19 ( V_102 -> V_377 || V_102 -> V_378 ) )
return NULL ;
V_43 = V_102 -> V_93 ;
} else {
if ( F_19 ( V_102 -> V_93 || V_102 -> V_378 ) )
return NULL ;
V_43 = V_102 -> V_377 ;
}
...
struct V_12 * V_13 = V_140 -> V_13 ;
const T_3 * V_234 = V_149 -> V_235 ;
if ( ( V_154 -> V_240 = F_160 ( V_234 [ 1 ] ) ) == V_383 )
goto V_237;
V_154 -> V_16 |= V_243 ;
if ( V_234 [ 0 ] == V_118 ) {
if ( V_234 [ 1 ] & 0x01 ) {
...
if ( ! F_54 ( V_149 ) )
goto V_237;
V_4 = F_164 ( F_165 ( F_53 ( V_149 ) ) ) ;
V_423 = F_166 ( V_4 , 512 , V_201 , V_261 ) ;
if ( F_87 ( V_13 ) && F_167 ( V_13 ) ) {
V_154 -> V_240 = V_382 ;
V_154 -> V_156 = V_424 ;
...
static unsigned int F_169 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
const T_3 * V_234 = V_149 -> V_235 ;
const T_3 * V_333 ;
...
goto V_237;
if ( ! F_54 ( V_149 ) || F_53 ( V_149 ) -> V_438 < V_45 )
goto V_439;
V_333 = F_164 ( F_165 ( F_53 ( V_149 ) ) ) ;
if ( V_45 < V_435 )
goto V_439;
if ( V_339 )
V_436 = V_333 [ 3 ] ;
...
static inline int F_174 ( struct V_56 * V_149 ,
struct V_12 * V_13 )
{
...
if ( F_19 ( ! V_149 -> V_236 || V_149 -> V_236 > V_13 -> V_360 ) )
goto V_446;
V_286 = F_170 ( V_13 , V_445 ) ;
} else {
if ( F_19 ( ! V_149 -> V_236 ) )
goto V_446;
V_286 = NULL ;
if ( F_65 ( ( V_445 != V_118 ) || ! V_447 ) ) {
int V_45 = F_175 ( V_445 ) ;
if ( F_19 ( V_45 > V_149 -> V_236 || V_45 > V_13 -> V_360 ) )
goto V_446;
V_286 = F_154 ;
} else {
if ( F_19 ( V_149 -> V_236 > 16 ) )
...
void F_184 ( struct V_8 * V_9 , int V_480 )
{
int V_481 = 5 ;
...
V_377 = V_11 -> V_484 ;
V_29 = F_186 ( V_9 -> V_469 , V_377 , V_93 , 0 ,
NULL ) ;
if ( ! F_187 ( V_29 ) ) {
V_13 -> V_29 = V_29 ;
F_188 ( V_29 ) ;
...
F_191 ( V_486 , & V_9 -> V_487 ,
F_192 ( V_120 ) ) ;
}
int F_193 ( struct V_12 * V_13 )
{
if ( V_13 -> V_29 ) {
F_194 ( V_13 -> V_29 , V_488 ) ;
return 1 ;
}
return 0 ;
}
...
void F_205 ( struct V_12 * V_13 )
{
if ( V_13 -> V_29 )
F_206 ( V_13 -> V_29 , V_223 ,
V_492 ) ;
}
void F_207 ( struct V_493 * V_494 )
{
struct V_8 * V_9 =
F_208 ( V_494 , struct V_8 , V_487 . V_494 ) ;
int V_177 ;
if ( V_9 -> V_39 & V_495 ) {
F_99 ( L_53 ) ;
return;
...
F_202 ( & V_9 -> V_376 [ V_177 ] ) ;
F_184 ( V_9 , 0 ) ;
F_199 ( & V_9 -> V_497 ) ;
F_99 ( L_33 ) ;
}
int F_210 ( struct V_6 * V_7 , unsigned int V_377 ,
...
void F_211 ( struct V_493 * V_494 )
{
struct V_8 * V_9 =
F_208 ( V_494 , struct V_8 , V_504 ) ;
struct V_10 * V_11 ;
struct V_12 * V_13 ;
unsigned long V_16 ;
F_196 ( & V_9 -> V_497 ) ;
...
struct V_8 * F_213 ( struct V_461 * V_34 ,
struct V_505 * V_506 ,
struct V_6 * V_7 )
{
struct V_8 * V_9 ;
...
if ( V_33 )
return V_33 ;
V_9 -> V_191 = F_222 ( & V_516 ) ;
return 0 ;
}
void F_223 ( struct V_8 * V_9 )
{
if ( V_9 -> V_65 -> V_517 )
V_9 -> V_65 -> V_517 ( V_9 ) ;
F_45 ( V_9 ) ;
}
int F_224 ( struct V_28 * V_29 , struct V_8 * V_9 )
{
F_63 ( V_29 ) ;
F_68 ( V_29 , V_9 -> V_11 . V_1 ) ;
return 0 ;
}
int F_225 ( struct V_56 * V_57 , struct V_8 * V_9 )
{
int V_33 = 0 ;
F_172 ( V_9 , V_57 ) ;
...
void F_228 ( unsigned int V_142 , struct V_8 * V_9 )
{
F_229 ( V_142 , & V_9 -> V_522 ) ;
}
