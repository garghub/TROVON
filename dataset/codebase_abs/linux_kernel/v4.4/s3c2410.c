...
V_45 -> V_29 = V_29 ;
#ifdef F_70
V_44 -> V_84 . V_125 = F_48 ;
V_44 -> V_84 . V_126 = F_43 ;
V_44 -> V_84 . V_78 = V_127 ;
V_44 -> V_84 . V_128 = 1 ;
switch ( V_5 -> V_22 ) {
case V_36 :
V_44 -> V_84 . V_129 = F_45 ;
V_44 -> V_84 . V_125 = F_48 ;
break;
case V_23 :
V_44 -> V_84 . V_129 = F_46 ;
V_44 -> V_84 . V_125 = F_49 ;
break;
case V_38 :
V_44 -> V_84 . V_129 = F_47 ;
V_44 -> V_84 . V_125 = F_50 ;
break;
}
#else
V_44 -> V_84 . V_78 = V_130 ;
#endif
if ( V_29 -> V_131 != NULL )
V_44 -> V_84 . V_132 = V_29 -> V_131 ;
if ( V_29 -> V_133 )
V_44 -> V_84 . V_78 = V_134 ;
...
int V_148 ;
int V_149 ;
V_22 = F_73 ( V_102 ) -> V_150 ;
V_5 = F_74 ( & V_102 -> V_7 , sizeof( * V_5 ) , V_151 ) ;
if ( V_5 == NULL ) {
V_147 = - V_152 ;
goto V_153;
}
F_75 ( V_102 , V_5 ) ;
F_76 ( & V_5 -> V_117 . V_154 ) ;
F_77 ( & V_5 -> V_117 . V_155 ) ;
V_5 -> V_14 = F_78 ( & V_102 -> V_7 , L_19 ) ;
if ( F_66 ( V_5 -> V_14 ) ) {
F_19 ( & V_102 -> V_7 , L_20 ) ;
V_147 = - V_156 ;
goto V_153;
...
V_5 -> V_20 = V_19 ;
V_5 -> V_22 = V_22 ;
V_5 -> V_39 = F_80 ( & V_102 -> V_7 , V_146 ) ;
if ( F_66 ( V_5 -> V_39 ) ) {
V_147 = F_81 ( V_5 -> V_39 ) ;
goto V_153;
}
F_33 ( & V_102 -> V_7 , L_21 , V_5 -> V_39 ) ;
V_147 = F_34 ( V_5 ) ;
if ( V_147 != 0 )
goto V_153;
V_144 = ( V_19 != NULL ) ? V_19 -> V_144 : NULL ;
V_148 = ( V_19 != NULL ) ? V_19 -> V_148 : 1 ;
V_5 -> V_106 = V_148 ;
V_140 = V_148 * sizeof( * V_5 -> V_103 ) ;
V_5 -> V_103 = F_74 ( & V_102 -> V_7 , V_140 , V_151 ) ;
if ( V_5 -> V_103 == NULL ) {
V_147 = - V_152 ;
goto V_153;
}
...
F_15 ( L_22 ,
V_149 , V_45 , V_5 ) ;
V_45 -> V_3 . V_7 . V_157 = & V_102 -> V_7 ;
F_69 ( V_5 , V_45 , V_144 ) ;
V_45 -> V_158 = F_82 ( & V_45 -> V_3 ,
( V_144 ) ? V_144 -> V_52 : 1 ,
NULL ) ;
if ( V_45 -> V_158 == 0 ) {
F_71 ( V_5 , V_45 ) ;
...
static int F_84 ( struct V_6 * V_7 , T_3 V_159 )
{
struct V_4 * V_5 = F_5 ( V_7 ) ;
if ( V_5 ) {
V_5 -> V_160 = F_30 ( V_5 -> V_50 ) ;
F_31 ( V_5 -> V_160 | V_5 -> V_51 , V_5 -> V_50 ) ;
F_10 ( V_5 , V_107 ) ;
}
return 0 ;
}
