...
static bool F_49 ( struct V_165 * V_11 , unsigned int V_166 )
{
switch ( V_166 ) {
case V_157 :
case V_69 :
...
void T_5 * V_190 ;
int V_1 , V_56 ;
V_4 = F_51 ( & V_6 -> V_11 , sizeof( * V_4 ) , V_191 ) ;
if ( ! V_4 )
return - V_192 ;
V_4 -> V_6 = V_6 ;
strncpy ( V_4 -> V_193 , V_185 -> V_193 , sizeof( V_4 -> V_193 ) - 1 ) ;
V_188 = F_52 ( V_6 , V_194 , 0 ) ;
V_190 = F_53 ( & V_6 -> V_11 , V_188 ) ;
if ( F_13 ( V_190 ) )
return F_14 ( V_190 ) ;
V_4 -> V_8 = F_54 ( & V_6 -> V_11 ,
L_21 , V_190 , & V_195 ) ;
if ( F_13 ( V_4 -> V_8 ) ) {
F_7 ( & V_6 -> V_11 , L_22 ,
F_14 ( V_4 -> V_8 ) ) ;
...
V_4 -> V_117 = F_55 ( & V_6 -> V_11 , L_21 ) ;
if ( F_13 ( V_4 -> V_117 ) ) {
F_7 ( & V_6 -> V_11 , L_23 ,
F_14 ( V_4 -> V_117 ) ) ;
return F_14 ( V_4 -> V_117 ) ;
}
V_4 -> V_50 = F_55 ( & V_6 -> V_11 , L_16 ) ;
if ( F_13 ( V_4 -> V_50 ) )
F_4 ( & V_6 -> V_11 , L_24 ,
F_14 ( V_4 -> V_50 ) ) ;
V_4 -> V_63 = F_55 ( & V_6 -> V_11 , L_17 ) ;
if ( F_13 ( V_4 -> V_63 ) )
F_4 ( & V_6 -> V_11 , L_25 ,
F_14 ( V_4 -> V_63 ) ) ;
V_1 = F_56 ( V_6 , 0 ) ;
...
V_4 -> V_74 = 2 ;
V_4 -> V_70 = true ;
V_189 = F_58 ( V_185 , L_28 , NULL ) ;
if ( V_189 )
V_4 -> V_142 = F_59 ( V_189 ) ;
else
V_4 -> V_142 = 64 ;
V_4 -> V_163 . V_196 = 16 ;
V_4 -> V_164 . V_196 = 16 ;
...
static int F_64 ( struct V_165 * V_11 )
{
struct V_3 * V_207 = F_65 ( V_11 ) ;
F_66 ( V_207 -> V_8 , true ) ;
F_67 ( V_207 -> V_8 ) ;
return 0 ;
}
static int F_68 ( struct V_165 * V_11 )
{
struct V_3 * V_207 = F_65 ( V_11 ) ;
int V_56 ;
F_66 ( V_207 -> V_8 , false ) ;
F_8 ( V_207 -> V_8 , V_168 ,
V_136 , V_136 ) ;
F_8 ( V_207 -> V_8 , V_170 ,
V_136 , V_136 ) ;
...
if ( V_56 )
return V_56 ;
F_8 ( V_207 -> V_8 , V_168 , V_136 , 0 ) ;
F_8 ( V_207 -> V_8 , V_170 , V_136 , 0 ) ;
return 0 ;
}
