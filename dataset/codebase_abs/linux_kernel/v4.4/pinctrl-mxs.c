...
unsigned V_57 , unsigned long * V_46 ,
unsigned V_48 )
{
return - V_63 ;
}
...
V_55 = F_18 ( V_54 -> V_10 [ V_32 ] ) ;
V_57 = F_19 ( V_54 -> V_10 [ V_32 ] ) ;
V_30 = V_4 -> V_58 + V_4 -> V_5 -> V_59 -> V_68 ;
...
struct V_53 * V_54 = & V_4 -> V_5 -> V_8 [ V_71 ] ;
struct V_73 * V_74 ;
const char * V_75 = L_8 ;
char * V_7 ;
int V_26 = strlen ( V_18 -> V_9 ) + V_27 ;
T_1 V_29 , V_32 ;
V_7 = F_32 ( & V_70 -> V_16 , V_26 , V_38 ) ;
if ( ! V_7 )
return - V_39 ;
...
V_54 -> V_9 = V_7 ;
V_74 = F_33 ( V_18 , V_75 , & V_26 ) ;
if ( ! V_74 )
return - V_76 ;
V_54 -> V_12 = V_26 / sizeof( T_1 ) ;
V_54 -> V_10 = F_32 ( & V_70 -> V_16 , V_54 -> V_12 * sizeof( * V_54 -> V_10 ) ,
V_38 ) ;
if ( ! V_54 -> V_10 )
return - V_39 ;
V_54 -> V_60 = F_32 ( & V_70 -> V_16 , V_54 -> V_12 * sizeof( * V_54 -> V_60 ) ,
V_38 ) ;
if ( ! V_54 -> V_60 )
return - V_39 ;
F_34 ( V_18 , V_75 , V_54 -> V_10 , V_54 -> V_12 ) ;
for ( V_32 = 0 ; V_32 < V_54 -> V_12 ; V_32 ++ ) {
...
struct V_3 * V_4 )
{
struct V_77 * V_5 = V_4 -> V_5 ;
struct V_17 * V_18 = V_70 -> V_16 . V_78 ;
struct V_17 * V_79 ;
struct V_80 * V_81 ;
const char * V_82 = L_10 ;
const char * V_83 , * V_84 = L_11 ;
int V_32 = 0 , V_85 = 0 , V_86 = 0 ;
int V_31 ;
T_1 V_29 ;
V_79 = F_38 ( V_18 , NULL ) ;
if ( ! V_79 ) {
...
continue;
V_5 -> V_6 ++ ;
if ( F_9 ( V_79 , L_2 , & V_29 ) )
continue;
if ( strcmp ( V_83 , V_79 -> V_9 ) ) {
V_83 = V_79 -> V_9 ;
V_5 -> V_49 ++ ;
}
}
V_5 -> V_50 = F_32 ( & V_70 -> V_16 , V_5 -> V_49 *
sizeof( * V_5 -> V_50 ) , V_38 ) ;
if ( ! V_5 -> V_50 )
return - V_39 ;
V_5 -> V_8 = F_32 ( & V_70 -> V_16 , V_5 -> V_6 *
sizeof( * V_5 -> V_8 ) , V_38 ) ;
if ( ! V_5 -> V_8 )
return - V_39 ;
V_83 = V_84 ;
...
struct V_17 * V_88 ;
F_42 ( V_79 ) ;
for ( V_88 = F_38 ( V_18 , V_79 ) ;
V_88 != NULL ;
V_88 = F_38 ( V_18 , V_88 ) ) {
if ( ! strcmp ( V_88 -> V_9 , V_83 ) )
F_43 ( & V_70 -> V_16 ,
L_13 ,
V_83 ) ;
}
V_81 = & V_5 -> V_50 [ V_85 ++ ] ;
V_81 -> V_9 = V_83 = V_79 -> V_9 ;
}
V_81 -> V_6 ++ ;
}
V_85 = 0 ;
...
if ( strcmp ( V_83 , V_79 -> V_9 ) ) {
V_81 = & V_5 -> V_50 [ V_85 ++ ] ;
V_81 -> V_8 = F_32 ( & V_70 -> V_16 , V_81 -> V_6 *
sizeof( * V_81 -> V_8 ) ,
V_38 ) ;
if ( ! V_81 -> V_8 )
return - V_39 ;
...
int F_44 ( struct V_69 * V_70 ,
struct V_77 * V_5 )
{
struct V_17 * V_18 = V_70 -> V_16 . V_78 ;
struct V_3 * V_4 ;
int V_31 ;
V_4 = F_32 ( & V_70 -> V_16 , sizeof( * V_4 ) , V_38 ) ;
if ( ! V_4 )
return - V_39 ;
V_4 -> V_16 = & V_70 -> V_16 ;
V_4 -> V_5 = V_5 ;
V_4 -> V_58 = F_45 ( V_18 , 0 ) ;
if ( ! V_4 -> V_58 )
return - V_89 ;
V_90 . V_10 = V_4 -> V_5 -> V_10 ;
V_90 . V_12 = V_4 -> V_5 -> V_12 ;
V_90 . V_9 = F_7 ( & V_70 -> V_16 ) ;
F_46 ( V_70 , V_4 ) ;
V_31 = F_37 ( V_70 , V_4 ) ;
if ( V_31 ) {
F_39 ( & V_70 -> V_16 , L_14 , V_31 ) ;
goto V_91;
}
V_4 -> V_92 = F_47 ( & V_90 , & V_70 -> V_16 , V_4 ) ;
if ( F_48 ( V_4 -> V_92 ) ) {
F_39 ( & V_70 -> V_16 , L_15 ) ;
V_31 = F_49 ( V_4 -> V_92 ) ;
goto V_91;
