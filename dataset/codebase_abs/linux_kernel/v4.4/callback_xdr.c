...
{
if ( V_160 -> V_161 != V_158 )
F_51 ( V_160 -> V_162 -> V_163 ) ;
}
static T_1
F_50 ( int V_130 , unsigned int V_131 , struct V_132 * * V_37 )
{
...
static T_1
F_56 ( int V_130 , unsigned int V_131 , struct V_132 * * V_37 )
{
...
static T_1
F_57 ( unsigned int V_131 , struct V_132 * * V_37 )
{
switch ( V_131 ) {
case V_136 :
case V_137 :
...
static T_1 F_58 ( int V_130 , struct V_1 * V_2 ,
...
switch ( V_160 -> V_32 ) {
case 0 :
V_27 = F_57 ( V_131 , & V_37 ) ;
break;
case 1 :
V_27 = F_50 ( V_130 , V_131 , & V_37 ) ;
break;
case 2 :
V_27 = F_56 ( V_130 , V_131 , & V_37 ) ;
break;
default:
V_27 = F_2 ( V_35 ) ;
}
...
V_27 = V_37 -> V_173 ( V_2 , V_165 , V_3 ) ;
if ( F_15 ( V_27 == 0 ) )
V_27 = V_37 -> F_58 ( V_3 , V_4 , V_160 ) ;
} else
V_27 = F_2 ( V_14 ) ;
V_169:
V_119 = F_46 ( V_166 , V_131 , V_27 ) ;
if ( F_9 ( V_119 ) )
return V_119 ;
if ( V_37 -> V_174 != NULL && V_27 == 0 )
V_27 = V_37 -> V_174 ( V_2 , V_166 , V_4 ) ;
...
unsigned int V_36 = 0 ;
F_19 ( L_12 , V_31 ) ;
F_61 ( & V_165 , & V_2 -> V_178 , V_2 -> V_178 . V_179 [ 0 ] . V_180 ) ;
V_6 = ( T_1 * ) ( ( char * ) V_2 -> V_181 . V_179 [ 0 ] . V_180 + V_2 -> V_181 . V_179 [ 0 ] . V_182 ) ;
F_62 ( & V_166 , & V_2 -> V_181 , V_6 ) ;
V_27 = F_17 ( & V_165 , & V_175 ) ;
if ( V_27 == F_2 ( V_14 ) )
return V_183 ;
if ( V_175 . V_32 == 0 ) {
V_160 . V_162 = F_63 ( F_60 ( V_2 ) , V_175 . V_34 ) ;
if ( ! V_160 . V_162 || ! F_64 ( V_160 . V_162 , V_2 ) )
return V_184 ;
}
V_160 . V_32 = V_175 . V_32 ;
V_176 . V_28 = V_175 . V_28 ;
V_176 . V_29 = V_175 . V_29 ;
if ( F_45 ( & V_166 , & V_176 ) != 0 )
return V_185 ;
while ( V_27 == 0 && V_36 != V_175 . V_36 ) {
V_27 = F_58 ( V_36 , V_2 , & V_165 ,
V_3 , & V_166 , V_4 , & V_160 ) ;
V_36 ++ ;
}
