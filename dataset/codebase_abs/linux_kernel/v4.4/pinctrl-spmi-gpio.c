...
static int F_30 ( struct V_2 * V_3 , unsigned V_17 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_5 * V_6 ;
V_6 = V_4 -> V_86 -> V_15 -> V_18 [ V_17 ] . V_27 ;
...
static void F_31 ( struct V_78 * V_79 , struct V_2 * V_3 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
unsigned V_66 ;
...
int V_9 , V_16 , V_66 ;
T_1 V_118 [ 2 ] ;
V_9 = F_34 ( V_12 -> V_119 , L_29 , V_118 , 2 ) ;
if ( V_9 < 0 ) {
F_5 ( V_12 , L_30 ) ;
return V_9 ;
}
...
return - V_63 ;
F_35 ( V_16 > F_12 ( V_26 ) ) ;
V_4 = F_36 ( V_12 , sizeof( * V_4 ) , V_121 ) ;
if ( ! V_4 )
return - V_122 ;
F_37 ( V_111 , V_4 ) ;
V_4 -> V_12 = & V_111 -> V_12 ;
V_4 -> V_10 = F_38 ( V_12 -> V_123 , NULL ) ;
V_114 = F_39 ( V_12 , V_16 , sizeof( * V_114 ) , V_121 ) ;
if ( ! V_114 )
return - V_122 ;
V_117 = F_39 ( V_12 , V_16 , sizeof( * V_117 ) , V_121 ) ;
if ( ! V_117 )
return - V_122 ;
V_116 = F_36 ( V_12 , sizeof( * V_116 ) , V_121 ) ;
if ( ! V_116 )
return - V_122 ;
V_116 -> V_124 = & V_125 ;
V_116 -> V_126 = & V_127 ;
...
V_4 -> V_3 . V_11 = - 1 ;
V_4 -> V_3 . V_93 = V_16 ;
V_4 -> V_3 . V_138 = F_40 ( V_12 ) ;
V_4 -> V_3 . V_91 = 2 ;
V_4 -> V_3 . V_139 = false ;
V_4 -> V_86 = F_43 ( V_116 , V_12 , V_4 ) ;
if ( F_44 ( V_4 -> V_86 ) )
return F_45 ( V_4 -> V_86 ) ;
V_9 = F_46 ( & V_4 -> V_3 ) ;
if ( V_9 ) {
F_5 ( V_4 -> V_12 , L_31 ) ;
goto V_140;
}
V_9 = F_47 ( & V_4 -> V_3 , F_40 ( V_12 ) , 0 , 0 , V_16 ) ;
if ( V_9 ) {
F_5 ( V_12 , L_32 ) ;
goto V_141;
}
