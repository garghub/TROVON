...
F_70 ( V_212 , V_4 , V_212 -> V_505 . V_524 [ V_4 ] ) ;
if ( V_212 -> V_503 ) {
...
static int F_88 ( void * V_534 , unsigned int V_3 , unsigned int V_271 )
{
struct V_513 * V_535 = V_534 ;
struct V_211 * V_212 = F_74 ( V_535 ) ;
if ( V_212 -> V_231 ) {
...
{
struct V_546 * V_505 = F_98 ( & V_514 -> V_2 ) ;
struct V_211 * V_212 ;
int V_218 ;
unsigned int V_271 ;
...
V_212 -> V_532 = F_101 ( & V_514 -> V_2 ,
L_29 , V_550 ) ;
if ( F_102 ( V_212 -> V_532 ) ) {
V_218 = F_103 ( V_212 -> V_532 ) ;
...
V_212 -> V_230 = F_105 ( & V_514 -> V_2 , NULL , V_514 , & V_552 ) ;
