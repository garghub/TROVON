...
static void T_4 * F_23 ( struct V_4 * V_8 ,
unsigned int V_16 )
{
struct V_15 * V_26 ;
F_24 (bus, &pcie->buses, list)
if ( V_26 -> V_32 == V_16 )
return ( void T_4 * ) V_26 -> V_33 -> V_37 ;
V_26 = F_13 ( V_8 , V_16 ) ;
if ( F_25 ( V_26 ) )
return NULL ;
F_26 ( & V_26 -> V_31 , & V_8 -> V_43 ) ;
return ( void T_4 * ) V_26 -> V_33 -> V_37 ;
}
static void T_4 * F_27 ( struct V_44 * V_26 ,
unsigned int V_13 ,
int V_14 )
{
...
static unsigned long F_28 ( struct V_48 * V_49 )
{
...
F_34 ( V_8 -> V_41 , V_49 -> V_51 ) ;
F_35 ( V_8 -> V_41 , V_49 -> V_65 . V_25 ,
F_36 ( & V_49 -> V_65 ) ) ;
F_37 ( & V_49 -> V_31 ) ;
F_38 ( V_8 -> V_41 , V_49 ) ;
}
...
static void F_40 ( struct V_66 * V_41 )
{
F_41 ( V_41 , V_69 , V_70 ) ;
}
static int F_42 ( int V_32 , struct V_5 * V_6 )
{
struct V_4 * V_8 = F_3 ( V_6 ) ;
int V_28 ;
V_28 = F_43 ( V_8 -> V_41 , & V_8 -> V_71 , & V_8 -> V_72 ) ;
if ( V_28 < 0 )
return V_28 ;
V_28 = F_43 ( V_8 -> V_41 , & V_8 -> V_71 , & V_8 -> V_73 ) ;
if ( V_28 )
return V_28 ;
F_44 ( & V_6 -> V_74 , & V_8 -> V_72 , V_6 -> V_75 ) ;
F_44 ( & V_6 -> V_74 , & V_8 -> V_73 ,
V_6 -> V_75 ) ;
F_45 ( & V_6 -> V_74 , & V_8 -> V_76 ) ;
F_46 ( V_8 -> V_77 . V_25 , V_8 -> V_78 . V_25 ) ;
return 1 ;
}
static int F_47 ( const struct V_66 * V_79 , T_5 V_47 , T_5 V_80 )
{
struct V_4 * V_8 = F_3 ( V_79 -> V_26 -> V_45 ) ;
int V_81 ;
F_48 () ;
V_81 = F_49 ( V_79 , V_47 , V_80 ) ;
if ( ! V_81 )
V_81 = V_8 -> V_81 ;
return V_81 ;
}
static T_6 F_50 ( int V_81 , void * V_82 )
{
const char * V_83 [] = {
L_3 ,
L_4 ,
...
V_84 = 0 ;
if ( V_84 == V_91 )
F_52 ( V_8 -> V_41 , L_18 , V_83 [ V_84 ] ,
V_85 ) ;
else
F_20 ( V_8 -> V_41 , L_18 , V_83 [ V_84 ] ,
V_85 ) ;
...
if ( V_84 == V_91 )
F_52 ( V_8 -> V_41 , L_19 , V_96 ) ;
else
F_20 ( V_8 -> V_41 , L_19 , V_96 ) ;
}
return V_97 ;
}
static void F_53 ( struct V_4 * V_8 )
{
T_1 V_98 , V_99 , V_100 ;
V_98 = 0xfe100000 ;
V_99 = F_36 ( V_8 -> V_24 ) ;
...
static int F_54 ( struct V_4 * V_8 , unsigned long V_127 )
{
const struct V_58 * V_59 = V_8 -> V_60 ;
T_1 V_9 ;
V_127 = V_128 + F_55 ( V_127 ) ;
while ( F_56 ( V_128 , V_127 ) ) {
...
static int F_58 ( struct V_4 * V_8 )
{
const struct V_58 * V_59 = V_8 -> V_60 ;
struct V_48 * V_49 ;
unsigned long V_9 ;
...
V_28 = F_63 ( V_8 -> V_146 ) ;
if ( V_28 < 0 )
F_64 ( V_8 -> V_41 , L_22 , V_28 ) ;
F_65 ( V_8 -> V_159 ) ;
F_65 ( V_8 -> V_175 ) ;
F_65 ( V_8 -> V_176 ) ;
F_66 ( V_177 ) ;
V_28 = F_67 ( V_8 -> V_178 , V_8 -> V_179 ) ;
if ( V_28 < 0 )
F_64 ( V_8 -> V_41 , L_23 , V_28 ) ;
}
...
static int F_72 ( struct V_4 * V_8 )
{
const struct V_58 * V_59 = V_8 -> V_60 ;
V_8 -> V_180 = F_73 ( V_8 -> V_41 , L_29 ) ;
if ( F_25 ( V_8 -> V_180 ) )
return F_74 ( V_8 -> V_180 ) ;
V_8 -> V_181 = F_73 ( V_8 -> V_41 , L_30 ) ;
if ( F_25 ( V_8 -> V_181 ) )
return F_74 ( V_8 -> V_181 ) ;
V_8 -> V_184 = F_73 ( V_8 -> V_41 , L_31 ) ;
if ( F_25 ( V_8 -> V_184 ) )
return F_74 ( V_8 -> V_184 ) ;
if ( V_59 -> V_182 ) {
V_8 -> V_183 = F_73 ( V_8 -> V_41 , L_32 ) ;
if ( F_25 ( V_8 -> V_183 ) )
return F_74 ( V_8 -> V_183 ) ;
}
return 0 ;
}
static int F_75 ( struct V_4 * V_8 )
{
V_8 -> V_176 = F_76 ( V_8 -> V_41 , L_29 ) ;
if ( F_25 ( V_8 -> V_176 ) )
return F_74 ( V_8 -> V_176 ) ;
V_8 -> V_175 = F_76 ( V_8 -> V_41 , L_30 ) ;
if ( F_25 ( V_8 -> V_175 ) )
return F_74 ( V_8 -> V_175 ) ;
V_8 -> V_159 = F_76 ( V_8 -> V_41 , L_33 ) ;
if ( F_25 ( V_8 -> V_159 ) )
return F_74 ( V_8 -> V_159 ) ;
return 0 ;
}
static int F_77 ( struct V_4 * V_8 )
{
struct V_185 * V_79 = F_78 ( V_8 -> V_41 ) ;
struct V_186 * V_12 , * V_11 , * V_187 ;
int V_28 ;
V_28 = F_72 ( V_8 ) ;
if ( V_28 ) {
F_20 ( & V_79 -> V_41 , L_34 , V_28 ) ;
return V_28 ;
}
V_28 = F_75 ( V_8 ) ;
if ( V_28 ) {
F_20 ( & V_79 -> V_41 , L_35 , V_28 ) ;
return V_28 ;
}
V_8 -> V_146 = F_79 ( V_8 -> V_41 , L_36 ) ;
if ( F_25 ( V_8 -> V_146 ) ) {
V_28 = F_74 ( V_8 -> V_146 ) ;
F_20 ( & V_79 -> V_41 , L_37 , V_28 ) ;
return V_28 ;
}
V_28 = F_80 ( V_8 -> V_146 ) ;
if ( V_28 < 0 ) {
F_20 ( & V_79 -> V_41 , L_38 , V_28 ) ;
return V_28 ;
}
V_28 = F_68 ( V_8 ) ;
if ( V_28 ) {
F_20 ( & V_79 -> V_41 , L_39 , V_28 ) ;
return V_28 ;
}
V_12 = F_81 ( V_79 , V_188 , L_40 ) ;
V_8 -> V_12 = F_82 ( & V_79 -> V_41 , V_12 ) ;
if ( F_25 ( V_8 -> V_12 ) ) {
V_28 = F_74 ( V_8 -> V_12 ) ;
goto V_189;
}
V_11 = F_81 ( V_79 , V_188 , L_30 ) ;
V_8 -> V_11 = F_82 ( & V_79 -> V_41 , V_11 ) ;
if ( F_25 ( V_8 -> V_11 ) ) {
V_28 = F_74 ( V_8 -> V_11 ) ;
goto V_189;
}
V_187 = F_81 ( V_79 , V_188 , L_41 ) ;
if ( ! V_187 ) {
V_28 = - V_190 ;
goto V_189;
}
V_8 -> V_24 = F_83 ( V_8 -> V_41 , V_187 -> V_25 ,
F_36 ( V_187 ) , V_187 -> V_191 ) ;
if ( ! V_8 -> V_24 ) {
V_28 = - V_190 ;
goto V_189;
}
V_28 = F_84 ( V_79 , L_42 ) ;
if ( V_28 < 0 ) {
F_20 ( & V_79 -> V_41 , L_43 , V_28 ) ;
goto V_189;
}
V_8 -> V_81 = V_28 ;
V_28 = F_85 ( V_8 -> V_81 , F_50 , V_192 , L_44 , V_8 ) ;
if ( V_28 ) {
F_20 ( & V_79 -> V_41 , L_45 , V_28 ) ;
goto V_189;
}
return 0 ;
V_189:
...
int V_193 ;
F_90 ( & V_3 -> V_194 ) ;
V_193 = F_91 ( V_3 -> V_195 , V_196 ) ;
if ( V_193 < V_196 )
F_92 ( V_193 , V_3 -> V_195 ) ;
else
V_193 = - V_197 ;
F_93 ( & V_3 -> V_194 ) ;
return V_193 ;
}
static void F_94 ( struct V_1 * V_3 , unsigned long V_81 )
{
struct V_198 * V_41 = V_3 -> V_3 . V_41 ;
F_90 ( & V_3 -> V_194 ) ;
if ( ! F_95 ( V_81 , V_3 -> V_195 ) )
F_20 ( V_41 , L_47 , V_81 ) ;
else
F_96 ( V_81 , V_3 -> V_195 ) ;
F_93 ( & V_3 -> V_194 ) ;
}
static T_6 F_97 ( int V_81 , void * V_199 )
{
...
while ( V_201 ) {
unsigned int V_10 = F_98 ( & V_201 , 32 ) ;
unsigned int V_50 = V_27 * 32 + V_10 ;
unsigned int V_81 ;
F_4 ( V_8 , 1 << V_10 , V_202 + V_27 * 4 ) ;
V_81 = F_99 ( V_193 -> V_203 , V_50 ) ;
if ( V_81 ) {
if ( F_95 ( V_50 , V_193 -> V_195 ) )
F_100 ( V_81 ) ;
else
F_101 ( V_8 -> V_41 , L_48 ) ;
} else {
...
if ( V_208 < 0 )
return V_208 ;
V_81 = F_103 ( V_193 -> V_203 , V_208 ) ;
if ( ! V_81 ) {
F_94 ( V_193 , V_208 ) ;
return - V_209 ;
}
F_104 ( V_81 , V_205 ) ;
V_207 . V_210 = F_105 ( ( void * ) V_193 -> V_211 ) ;
V_207 . V_212 = 0 ;
V_207 . V_199 = V_208 ;
F_106 ( V_81 , & V_207 ) ;
return 0 ;
...
{
struct V_1 * V_193 = F_1 ( V_3 ) ;
struct V_213 * V_214 = F_108 ( V_81 ) ;
T_8 V_208 = F_109 ( V_214 ) ;
F_110 ( V_81 ) ;
F_94 ( V_193 , V_208 ) ;
}
static int F_111 ( struct V_215 * V_203 , unsigned int V_81 ,
T_8 V_208 )
{
F_112 ( V_81 , & V_216 , V_217 ) ;
F_113 ( V_81 , V_203 -> V_218 ) ;
F_48 () ;
return 0 ;
}
static int F_114 ( struct V_4 * V_8 )
{
struct V_185 * V_79 = F_78 ( V_8 -> V_41 ) ;
const struct V_58 * V_59 = V_8 -> V_60 ;
struct V_1 * V_193 = & V_8 -> V_193 ;
...
V_193 -> V_3 . V_219 = F_102 ;
V_193 -> V_3 . V_220 = F_107 ;
V_193 -> V_203 = F_116 ( V_8 -> V_41 -> V_221 , V_196 ,
& V_222 , & V_193 -> V_3 ) ;
if ( ! V_193 -> V_203 ) {
F_20 ( & V_79 -> V_41 , L_50 ) ;
return - V_30 ;
...
V_193 -> V_81 = V_28 ;
V_28 = F_85 ( V_193 -> V_81 , F_97 , 0 ,
V_216 . V_191 , V_8 ) ;
if ( V_28 < 0 ) {
F_20 ( & V_79 -> V_41 , L_52 , V_28 ) ;
goto V_28;
}
V_193 -> V_211 = F_117 ( V_29 , 0 ) ;
V_51 = F_105 ( ( void * ) V_193 -> V_211 ) ;
...
static int F_119 ( struct V_4 * V_8 )
{
struct V_1 * V_193 = & V_8 -> V_193 ;
...
static int F_121 ( struct V_4 * V_8 , T_1 V_233 ,
T_1 * V_234 )
{
...
static bool F_123 ( struct V_235 * V_236 ,
struct V_244 * V_179 ,
unsigned int V_178 )
{
char V_245 [ 32 ] ;
...
if ( F_124 ( V_236 , V_245 , NULL ) == NULL )
return false ;
}
return true ;
}
...
V_8 -> V_179 = F_126 ( V_8 -> V_41 , V_8 -> V_178 ,
sizeof( * V_8 -> V_179 ) ,
V_29 ) ;
if ( ! V_8 -> V_179 )
return - V_30 ;
...
return F_127 ( V_8 -> V_41 , V_8 -> V_178 ,
V_8 -> V_179 ) ;
}
static int F_128 ( struct V_4 * V_8 , T_1 V_249 )
{
struct V_235 * V_236 = V_8 -> V_41 -> V_221 ;
unsigned int V_27 = 0 ;
if ( F_122 ( V_236 , L_53 ) ) {
...
if ( F_123 ( V_8 -> V_41 -> V_221 , V_8 -> V_179 ,
V_8 -> V_178 ) )
return F_127 ( V_8 -> V_41 , V_8 -> V_178 ,
V_8 -> V_179 ) ;
F_101 ( V_8 -> V_41 , L_83 ) ;
F_38 ( V_8 -> V_41 , V_8 -> V_179 ) ;
V_8 -> V_178 = 0 ;
return F_125 ( V_8 ) ;
}
...
V_8 -> V_71 . V_25 = ~ 0 ;
V_8 -> V_71 . V_259 = 0 ;
if ( F_130 ( & V_253 , V_236 ) ) {
F_20 ( V_8 -> V_41 , L_84 ) ;
return - V_209 ;
}
F_131 (&parser, &range) {
V_28 = F_132 ( & V_255 , V_236 , & V_187 ) ;
if ( V_28 < 0 )
return V_28 ;
...
V_28 = F_43 ( V_8 -> V_41 , & V_264 , & V_8 -> V_71 ) ;
if ( V_28 < 0 )
return V_28 ;
V_28 = F_133 ( V_236 , & V_8 -> V_76 ) ;
if ( V_28 < 0 ) {
F_20 ( V_8 -> V_41 , L_88 ,
V_28 ) ;
...
F_20 ( V_8 -> V_41 , L_90 , V_50 ) ;
return - V_209 ;
}
V_50 -- ;
V_28 = F_136 ( V_49 , L_91 , & V_9 ) ;
if ( V_28 < 0 ) {
F_20 ( V_8 -> V_41 , L_92 ,
V_28 ) ;
return V_28 ;
...
V_256 |= ( ( 1 << V_9 ) - 1 ) << V_257 ;
V_257 += V_9 ;
V_266 = F_138 ( V_8 -> V_41 , sizeof( * V_266 ) , V_29 ) ;
if ( ! V_266 )
return - V_30 ;
V_28 = F_139 ( V_49 , 0 , & V_266 -> V_65 ) ;
if ( V_28 < 0 ) {
F_20 ( V_8 -> V_41 , L_89 ,
V_28 ) ;
return V_28 ;
...
V_266 -> V_233 = V_9 ;
V_266 -> V_8 = V_8 ;
V_266 -> V_51 = F_82 ( V_8 -> V_41 , & V_266 -> V_65 ) ;
if ( F_25 ( V_266 -> V_51 ) )
return F_74 ( V_266 -> V_51 ) ;
F_26 ( & V_266 -> V_31 , & V_8 -> V_267 ) ;
}
V_28 = F_121 ( V_8 , V_233 , & V_8 -> V_155 ) ;
if ( V_28 < 0 ) {
F_20 ( V_8 -> V_41 , L_94 ) ;
return V_28 ;
}
V_28 = F_128 ( V_8 , V_256 ) ;
if ( V_28 < 0 )
return V_28 ;
return 0 ;
}
static bool F_140 ( struct V_48 * V_49 )
{
...
V_280 . V_284 = F_47 ;
V_280 . V_285 = & V_286 ;
F_144 ( V_8 -> V_41 , & V_280 ) ;
return 0 ;
}
static void * F_145 ( struct V_287 * V_288 , T_9 * V_289 )
{
struct V_4 * V_8 = V_288 -> V_290 ;
if ( F_146 ( & V_8 -> V_267 ) )
return NULL ;
F_147 ( V_288 , L_98 ) ;
return F_148 ( & V_8 -> V_267 , * V_289 ) ;
}
static void * F_149 ( struct V_287 * V_288 , void * V_291 , T_9 * V_289 )
{
struct V_4 * V_8 = V_288 -> V_290 ;
return F_150 ( V_291 , & V_8 -> V_267 , V_289 ) ;
}
static void F_151 ( struct V_287 * V_288 , void * V_291 )
{
}
static int F_152 ( struct V_287 * V_288 , void * V_291 )
{
bool V_292 = false , V_293 = false ;
struct V_48 * V_49 ;
unsigned int V_9 ;
V_49 = F_153 ( V_291 , struct V_48 , V_31 ) ;
V_9 = F_7 ( V_49 -> V_51 + V_273 ) ;
if ( V_9 & V_274 )
V_292 = true ;
V_9 = F_7 ( V_49 -> V_51 + V_276 ) ;
...
static int F_154 ( struct V_294 * V_294 , struct V_295 * V_295 )
{
struct V_4 * V_8 = V_294 -> V_296 ;
struct V_287 * V_288 ;
int V_28 ;
V_28 = F_155 ( V_295 , & V_297 ) ;
if ( V_28 )
return V_28 ;
V_288 = V_295 -> V_7 ;
V_288 -> V_290 = V_8 ;
...
{
struct V_298 * V_295 ;
V_8 -> V_299 = F_157 ( L_36 , NULL ) ;
if ( ! V_8 -> V_299 )
return - V_30 ;
V_295 = F_158 ( L_104 , V_300 | V_301 , V_8 -> V_299 ,
V_8 , & V_302 ) ;
if ( ! V_295 )
goto remove;
return 0 ;
...
static int F_160 ( struct V_185 * V_79 )
{
const struct V_303 * V_304 ;
struct V_4 * V_8 ;
int V_28 ;
V_304 = F_161 ( V_305 , & V_79 -> V_41 ) ;
if ( ! V_304 )
return - V_248 ;
V_8 = F_138 ( & V_79 -> V_41 , sizeof( * V_8 ) , V_29 ) ;
if ( ! V_8 )
return - V_30 ;
F_17 ( & V_8 -> V_43 ) ;
F_17 ( & V_8 -> V_267 ) ;
...
V_28 = F_141 ( V_8 ) ;
if ( V_28 < 0 ) {
F_20 ( & V_79 -> V_41 , L_107 , V_28 ) ;
goto V_308;
}
if ( F_162 ( V_309 ) ) {
V_28 = F_156 ( V_8 ) ;
if ( V_28 < 0 )
F_20 ( & V_79 -> V_41 , L_108 ,
V_28 ) ;
}
F_163 ( V_79 , V_8 ) ;
return 0 ;
