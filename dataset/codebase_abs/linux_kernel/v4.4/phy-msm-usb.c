...
V_217 = F_122 ( V_214 , L_64 , & V_218 ) ;
if ( ! V_217 || ! V_218 )
return 0 ;
V_219 = V_218 / sizeof( T_1 ) ;
if ( V_219 >= V_40 ) {
F_123 ( & V_209 -> V_10 , L_65 , V_219 ) ;
return 0 ;
}
...
static int F_124 ( struct V_199 * V_232 ,
...
V_237 ? L_72 : L_73 ) ;
V_239 = F_128 ( V_209 , V_242 , 0 ) ;
if ( ! V_239 )
return - V_193 ;
V_2 -> V_236 = F_129 ( & V_209 -> V_10 , V_239 -> V_243 , F_130 ( V_239 ) ) ;
if ( ! V_2 -> V_236 )
return - V_222 ;
if ( V_2 -> V_53 ) {
V_240 = F_131 ( & V_209 -> V_10 , V_244 , 4 ) ;
if ( ! V_240 )
return - V_222 ;
F_13 ( 0x1 , V_240 ) ;
}
...
V_236 [ 1 ] . V_245 = L_77 ;
V_236 [ 2 ] . V_245 = L_78 ;
V_4 = F_133 ( V_2 -> V_9 . V_10 , F_134 ( V_236 ) , V_236 ) ;
if ( V_4 )
return V_4 ;
...
F_147 ( & V_2 -> V_234 ) ;
F_105 ( V_2 -> V_205 , 0 ) ;
F_148 ( V_2 -> V_207 . V_228 , V_231 , & V_2 -> V_207 . V_200 ) ;
F_148 ( V_2 -> V_204 . V_228 , V_230 , & V_2 -> V_204 . V_200 ) ;
F_103 () ;
F_86 ( & V_2 -> V_139 ) ;
F_149 ( & V_2 -> V_128 ) ;
F_150 ( & V_209 -> V_10 ) ;
...
static int F_154 ( struct V_259 * V_10 )
{
...
static int F_157 ( struct V_259 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
F_60 ( V_10 , L_86 ) ;
return F_43 ( V_2 ) ;
}
static int F_158 ( struct V_259 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
F_60 ( V_10 , L_87 ) ;
return F_53 ( V_2 ) ;
}
static int F_159 ( struct V_259 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
F_60 ( V_10 , L_88 ) ;
return F_43 ( V_2 ) ;
}
static int F_160 ( struct V_259 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
int V_4 ;
F_60 ( V_10 , L_89 ) ;
