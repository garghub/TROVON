...
{
int V_144 = F_46 ( & V_31 -> V_72 ) ;
if ( V_144 < V_71 || V_144 >= V_71 + V_74 )
return 1 ;
if ( F_46 ( & V_31 -> V_70 ) < V_73 )
return 1 ;
return 0 ;
...
{
struct V_29 * V_31 ;
struct V_141 * V_30 = V_8 -> V_30 ;
V_31 = F_10 ( V_8 ) ;
if ( F_46 ( & V_31 -> V_70 ) < V_73 )
return;
if ( F_46 ( & V_31 -> V_70 ) >= V_145 ) {
int V_71 ;
int V_38 ;
V_71 = F_46 ( & V_31 -> V_72 ) ;
V_38 = F_135 ( V_31 , V_30 , 0 ) ;
if ( V_38 )
return;
F_141 ( V_31 -> V_75 ,
F_139 ( V_31 , V_71 ) ) ;
...
if ( F_127 ( V_6 ) )
return F_128 ( V_6 ) ;
V_61 = F_51 ( sizeof( * V_153 ) + V_147 ) ;
if ( ! V_61 ) {
V_38 = - V_5 ;
goto V_154;
}
V_61 -> V_25 . V_27 = F_13 ( V_148 ) ;
V_61 -> V_25 . type = V_26 ;
V_61 -> V_25 . V_28 = V_151 ;
V_153 = (struct V_152 * ) V_61 -> V_112 ;
V_153 -> V_155 = * V_150 ;
F_143 ( V_153 , V_77 -> V_156 ) ;
F_144 ( V_153 , 0 ) ;
F_145 ( V_153 , V_147 ) ;
F_146 ( V_153 , type ) ;
...
struct V_7 * V_8 , struct V_32 * V_148 ,
T_2 V_151 )
{
struct V_2 * V_35 ;
struct V_22 * V_54 ;
...
if ( F_127 ( V_35 ) )
return F_128 ( V_35 ) ;
V_157 . V_27 = F_13 ( V_148 ) ;
V_157 . type = V_26 ;
V_157 . V_28 = V_151 ;
V_38 = F_149 ( V_8 , V_35 , & V_157 ) ;
if ( ! V_38 )
goto V_158;
V_54 = F_51 ( 0 ) ;
if ( ! V_54 ) {
...
void F_152 ( struct V_32 * V_32 , struct V_49 * V_160 ,
struct V_49 * V_161 )
{
struct V_2 * V_6 ;
struct V_22 * V_54 ;
...
while ( V_54 ) {
F_15 ( & V_54 -> V_10 ) ;
F_32 ( & V_54 -> V_162 , V_160 ) ;
V_54 = F_77 ( V_54 ) ;
}
V_54 = F_76 ( V_6 ) ;
while ( V_54 ) {
F_15 ( & V_54 -> V_10 ) ;
F_32 ( & V_54 -> V_162 , V_161 ) ;
V_54 = F_77 ( V_54 ) ;
}
F_44 ( & V_6 -> V_16 ) ;
F_35 ( & V_6 -> V_10 ) ;
}
void F_153 ( struct V_49 * V_160 ,
struct V_49 * V_161 )
{
struct V_22 * V_96 , * V_52 ;
...
return 0 ;
F_96 (curr, next, del_list, readdir_list) {
if ( V_96 -> V_25 . V_28 > V_151 )
break;
F_99 ( & V_96 -> V_162 ) ;
V_38 = ( V_96 -> V_25 . V_28 == V_151 ) ;
if ( F_45 ( & V_96 -> V_10 ) )
F_73 ( V_96 ) ;
if ( V_38 )
return 1 ;
...
F_96 (curr, next, ins_list, readdir_list) {
F_99 ( & V_96 -> V_162 ) ;
if ( V_96 -> V_25 . V_28 < V_164 -> V_168 ) {
if ( F_45 ( & V_96 -> V_10 ) )
F_73 ( V_96 ) ;
continue;
}
V_164 -> V_168 = V_96 -> V_25 . V_28 ;
V_165 = (struct V_152 * ) V_96 -> V_112 ;
V_146 = ( char * ) ( V_165 + 1 ) ;
V_147 = F_156 ( V_165 ) ;
V_167 = V_169 [ V_165 -> type ] ;
F_157 ( & V_155 , & V_165 -> V_155 ) ;
V_166 = ! F_158 ( V_164 , V_146 , V_147 ,
V_155 . V_27 , V_167 ) ;
if ( F_45 ( & V_96 -> V_10 ) )
F_73 ( V_96 ) ;
if ( V_166 )
...
F_164 ( V_21 , F_12 ( V_32 ) -> V_170 ) ;
F_165 ( V_21 , V_32 -> V_171 ) ;
F_166 ( V_21 , V_32 -> V_172 ) ;
F_167 ( V_21 , F_168 ( V_32 ) ) ;
F_169 ( V_21 ,
F_12 ( V_32 ) -> V_173 ) ;
F_170 ( V_21 , V_32 -> V_174 ) ;
F_171 ( V_21 , V_77 -> V_156 ) ;
F_172 ( V_21 , V_32 -> V_175 ) ;
...
V_32 -> V_182 . V_179 ) ;
F_175 ( & V_21 -> V_183 ,
F_12 ( V_32 ) -> V_184 . V_178 ) ;
F_176 ( & V_21 -> V_183 ,
F_12 ( V_32 ) -> V_184 . V_179 ) ;
}
int F_177 ( struct V_32 * V_32 , T_3 * V_185 )
{
struct V_2 * V_6 ;
struct V_121 * V_21 ;
V_6 = F_11 ( V_32 ) ;
...
V_21 = & V_6 -> V_21 ;
F_178 ( V_32 , F_179 ( V_21 ) ) ;
F_180 ( V_32 , F_181 ( V_21 ) ) ;
F_182 ( V_32 , F_183 ( V_21 ) ) ;
V_32 -> V_171 = F_184 ( V_21 ) ;
F_185 ( V_32 , F_186 ( V_21 ) ) ;
F_187 ( V_32 , F_188 ( V_21 ) ) ;
F_12 ( V_32 ) -> V_173 = F_189 ( V_21 ) ;
F_12 ( V_32 ) -> V_186 = F_190 ( V_21 ) ;
V_32 -> V_174 = F_191 ( V_21 ) ;
V_32 -> V_175 = 0 ;
* V_185 = F_192 ( V_21 ) ;
F_12 ( V_32 ) -> V_12 = F_193 ( V_21 ) ;
V_32 -> V_177 . V_178 = F_194 ( & V_21 -> V_176 ) ;
V_32 -> V_177 . V_179 = F_195 ( & V_21 -> V_176 ) ;
V_32 -> V_181 . V_178 = F_194 ( & V_21 -> V_180 ) ;
V_32 -> V_181 . V_179 = F_195 ( & V_21 -> V_180 ) ;
V_32 -> V_182 . V_178 = F_194 ( & V_21 -> ctime ) ;
V_32 -> V_182 . V_179 = F_195 ( & V_21 -> ctime ) ;
F_12 ( V_32 ) -> V_184 . V_178 =
F_194 ( & V_21 -> V_183 ) ;
F_12 ( V_32 ) -> V_184 . V_179 =
F_195 ( & V_21 -> V_183 ) ;
V_32 -> V_187 = F_12 ( V_32 ) -> V_173 ;
F_12 ( V_32 ) -> V_17 = ( T_2 ) - 1 ;
F_44 ( & V_6 -> V_16 ) ;
F_48 ( V_6 ) ;
return 0 ;
}
int F_196 ( struct V_76 * V_77 ,
...
int F_197 ( struct V_32 * V_32 )
{
struct V_2 * V_6 ;
if ( F_12 ( V_32 ) -> V_8 -> V_30 -> V_188 )
return - V_88 ;
V_6 = F_21 ( V_32 ) ;
if ( F_127 ( V_6 ) )
return F_128 ( V_6 ) ;
...
V_9 = V_191 [ V_192 - 1 ] -> V_9 + 1 ;
for ( V_108 = 0 ; V_108 < V_192 ; V_108 ++ )
F_15 ( & V_191 [ V_108 ] -> V_10 ) ;
F_19 ( & V_8 -> V_36 ) ;
for ( V_108 = 0 ; V_108 < V_192 ; V_108 ++ ) {
F_198 ( V_191 [ V_108 ] ) ;
F_48 ( V_191 [ V_108 ] ) ;
