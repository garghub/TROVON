...
static int F_54 ( unsigned long V_76 )
{
return ( V_76 / ( V_75 >> V_77 ) ) % V_24 ;
}
static unsigned long F_55 ( void )
{
return V_75 ;
}
static int F_56 ( int V_78 , int V_79 )
{
return ( V_78 != V_79 ) * V_80 ;
}
static int T_1 F_57 ( char * V_81 )
{
int V_13 ;
if ( F_58 ( V_81 , 0 , & V_13 ) != 0 || V_13 <= 0 )
return 0 ;
if ( V_13 <= 0 )
return 0 ;
V_24 = F_12 ( V_13 , V_63 ) ;
