...
T_2 V_62 , V_77 ;
int V_24 ;
if ( F_50 ( V_55 -> V_57 -> V_74 ) )
return F_51 ( V_55 , V_56 , V_2 , V_39 , V_10 ) ;
V_62 = F_48 ( V_55 -> V_57 -> V_74 ) ;
if ( F_42 ( * V_56 >= V_62 ) )
return 0 ;
V_77 = V_62 - * V_56 ;
if ( F_42 ( V_77 < V_39 ) )
...
static T_1 F_54 ( struct V_54 * V_54 , const struct V_78 * V_79 ,
...
V_81 = F_55 () ;
F_56 ( F_57 () ) ;
V_83 = F_58 ( V_54 , ( const struct V_78 V_84 * ) V_79 , V_80 , & V_82 ) ;
F_56 ( V_81 ) ;
return V_83 ;
}
T_1 F_59 ( struct V_54 * V_54 , const char * V_4 , T_3 V_85 ,
T_2 V_82 )
{
T_5 V_81 ;
T_1 V_83 ;
V_81 = F_55 () ;
F_56 ( F_57 () ) ;
V_83 = F_60 ( V_54 , ( V_86 const char V_84 * ) V_4 , V_85 , & V_82 ) ;
F_56 ( V_81 ) ;
return V_83 ;
}
...
V_79 [ V_49 ] . V_92 = ( void V_84 * ) F_62 ( V_5 ) ;
V_79 [ V_49 ] . V_93 = V_69 ;
V_21 . V_36 [ V_49 ] = V_5 ;
V_21 . V_23 ++ ;
V_39 -= V_69 ;
...
V_83 = F_54 ( V_55 , V_79 , V_21 . V_23 , * V_56 ) ;
if ( V_83 < 0 ) {
error = V_83 ;
goto V_12;
}
...
static int F_68 ( struct V_1 * V_2 , struct V_94 * V_95 )
{
if ( F_24 ( V_29 ) )
return - V_46 ;
while ( ! V_2 -> V_31 ) {
...
static void F_70 ( struct V_1 * V_2 , struct V_94 * V_95 )
{
if ( V_95 -> V_112 )
F_66 ( V_2 ) ;
}
T_1 F_71 ( struct V_1 * V_2 , struct V_94 * V_95 ,
T_6 * V_107 )
{
int V_24 ;
F_69 ( V_95 ) ;
...
V_24 = F_68 ( V_2 , V_95 ) ;
if ( V_24 > 0 )
V_24 = F_67 ( V_2 , V_95 , V_107 ) ;
} while ( V_24 > 0 );
F_70 ( V_2 , V_95 ) ;
return V_95 -> V_110 ? V_95 -> V_110 : V_24 ;
}
T_1 F_73 ( struct V_1 * V_2 , struct V_54 * V_114 ,
...
F_22 ( V_2 ) ;
V_24 = F_71 ( V_2 , & V_95 , V_107 ) ;
F_27 ( V_2 ) ;
return V_24 ;
}
T_1
F_74 ( struct V_1 * V_2 , struct V_54 * V_114 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
struct V_94 V_95 = {
. V_103 = V_39 ,
...
int V_115 = V_2 -> V_32 ;
struct V_116 * V_117 = F_75 ( V_115 , sizeof( struct V_116 ) ,
V_8 ) ;
T_1 V_24 ;
if ( F_42 ( ! V_117 ) )
return - V_53 ;
...
F_32 ( V_117 ) ;
V_115 = V_2 -> V_32 ;
V_117 = F_75 ( V_115 , sizeof( struct V_116 ) ,
V_8 ) ;
if ( ! V_117 ) {
V_24 = - V_53 ;
break;
...
F_76 ( & V_119 , V_126 | V_127 , V_117 , V_120 ,
V_95 . V_103 - V_77 ) ;
V_24 = F_77 ( V_114 , & V_119 , & V_95 . V_82 ) ;
if ( V_24 <= 0 )
break;
V_95 . V_110 += V_24 ;
V_95 . V_103 -= V_24 ;
...
T_2 V_129 = V_95 -> V_82 ;
V_128 = F_79 ( V_4 -> V_5 ) ;
V_24 = F_80 ( V_95 -> V_96 . V_54 , V_128 + V_4 -> V_37 , V_95 -> V_39 , & V_129 ) ;
F_81 ( V_4 -> V_5 ) ;
return V_24 ;
}
...
{
T_1 V_24 ;
V_24 = F_73 ( V_2 , V_114 , V_56 , V_39 , V_10 , F_78 ) ;
if ( V_24 > 0 )
* V_56 += V_24 ;
return V_24 ;
}
T_1 F_83 ( struct V_1 * V_2 , struct V_54 * V_114 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
return F_73 ( V_2 , V_114 , V_56 , V_39 , V_10 , F_64 ) ;
}
static long F_84 ( struct V_1 * V_2 , struct V_54 * V_114 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
T_1 (* F_85)( struct V_1 * , struct V_54 * ,
T_2 * , T_3 , unsigned int );
if ( V_114 -> V_98 -> F_85 )
F_85 = V_114 -> V_98 -> F_85 ;
else
F_85 = F_82 ;
return F_85 ( V_2 , V_114 , V_56 , V_39 , V_10 ) ;
}
...
return - V_132 ;
V_24 = F_88 ( V_133 , V_55 , V_56 , V_39 ) ;
if ( F_42 ( V_24 < 0 ) )
return V_24 ;
if ( V_55 -> V_98 -> F_87 )
F_87 = V_55 -> V_98 -> F_87 ;
...
T_1 F_89 ( struct V_54 * V_55 , struct V_94 * V_95 ,
T_7 * V_107 )
{
struct V_1 * V_2 ;
long V_24 , V_134 ;
...
T_3 V_39 ;
int V_49 , V_10 , V_97 ;
V_135 = F_90 ( V_55 ) -> V_135 ;
if ( F_42 ( ! F_91 ( V_135 ) && ! F_92 ( V_135 ) ) )
return - V_100 ;
V_2 = V_29 -> V_136 ;
if ( F_42 ( ! V_2 ) ) {
V_2 = F_93 () ;
...
V_24 = F_86 ( V_55 , & V_82 , V_2 , V_39 , V_10 ) ;
if ( F_42 ( V_24 <= 0 ) )
goto V_138;
V_137 = V_24 ;
V_95 -> V_103 = V_137 ;
...
{
struct V_54 * V_54 = V_95 -> V_96 . V_54 ;
return F_84 ( V_2 , V_54 , V_95 -> V_139 , V_95 -> V_103 ,
V_95 -> V_10 ) ;
}
long F_95 ( struct V_54 * V_55 , T_2 * V_56 , struct V_54 * V_114 ,
...
return - V_100 ;
V_24 = F_88 ( V_127 , V_114 , V_139 , V_39 ) ;
if ( F_42 ( V_24 < 0 ) )
return V_24 ;
V_24 = F_89 ( V_55 , & V_95 , F_94 ) ;
if ( V_24 > 0 )
* V_56 = V_95 . V_82 ;
return V_24 ;
}
static long F_96 ( struct V_54 * V_55 , T_2 V_84 * V_143 ,
...
if ( V_145 == V_146 )
return - V_100 ;
return F_98 ( V_145 , V_146 , V_39 , V_10 ) ;
}
if ( V_145 ) {
if ( V_143 )
return - V_147 ;
...
if ( F_42 ( V_114 -> V_141 & V_142 ) )
return - V_100 ;
V_24 = F_88 ( V_127 , V_114 , & V_37 , V_39 ) ;
if ( F_42 ( V_24 < 0 ) )
return V_24 ;
F_100 ( V_114 ) ;
V_24 = F_84 ( V_145 , V_114 , & V_37 , V_39 , V_10 ) ;
F_101 ( V_114 ) ;
if ( ! V_144 )
V_114 -> V_150 = V_37 ;
...
if ( ! ( V_55 -> V_130 & V_151 ) )
return - V_100 ;
if ( F_99 ( & V_37 , V_143 , sizeof( T_2 ) ) )
return - V_149 ;
} else {
V_37 = V_55 -> V_150 ;
}
V_24 = F_86 ( V_55 , & V_37 , V_146 , V_39 , V_10 ) ;
if ( ! V_143 )
V_55 -> V_150 = V_37 ;
else if ( F_102 ( V_143 , & V_37 , sizeof( T_2 ) ) )
V_24 = - V_149 ;
return V_24 ;
}
return - V_100 ;
}
static int F_103 ( const struct V_78 V_84 * V_152 ,
...
int V_49 ;
error = - V_149 ;
if ( F_99 ( & V_158 , V_152 , sizeof( V_158 ) ) )
break;
V_159 = V_158 . V_92 ;
V_39 = V_158 . V_93 ;
error = 0 ;
...
if ( V_157 > V_155 - V_32 )
V_157 = V_155 - V_32 ;
error = F_105 ( ( unsigned long ) V_159 , V_157 ,
0 , & V_36 [ V_32 ] ) ;
if ( F_42 ( error <= 0 ) )
break;
...
struct V_94 * V_95 )
{
int V_120 = F_107 ( V_4 -> V_5 , V_4 -> V_37 , V_95 -> V_39 , V_95 -> V_96 . V_128 ) ;
return V_120 == V_95 -> V_39 ? V_120 : - V_149 ;
}
static long F_108 ( struct V_54 * V_54 , const struct V_78 V_84 * V_164 ,
...
if ( ! V_2 )
return - V_132 ;
V_24 = F_109 ( V_133 , V_164 , V_165 ,
F_110 ( V_166 ) , & V_152 , & V_168 ) ;
if ( V_24 < 0 )
return V_24 ;
V_95 . V_103 = F_111 ( & V_168 ) ;
V_95 . V_39 = 0 ;
V_95 . V_10 = V_10 ;
...
if ( V_95 . V_103 ) {
F_22 ( V_2 ) ;
V_24 = F_71 ( V_2 , & V_95 , F_106 ) ;
F_27 ( V_2 ) ;
}
F_32 ( V_152 ) ;
return V_24 ;
}
static long F_112 ( struct V_54 * V_54 , const struct V_78 V_84 * V_152 ,
unsigned long V_165 , unsigned int V_10 )
{
struct V_1 * V_2 ;
struct V_5 * V_36 [ V_51 ] ;
...
if ( F_29 ( V_2 , & V_21 ) )
return - V_53 ;
V_21 . V_23 = F_103 ( V_152 , V_165 , V_21 . V_36 ,
V_21 . V_38 , false ,
V_21 . V_50 ) ;
if ( V_21 . V_23 <= 0 )
V_24 = V_21 . V_23 ;
...
static int F_98 ( struct V_1 * V_145 ,
struct V_1 * V_146 ,
T_3 V_39 , unsigned int V_10 )
{
...
bool V_173 = false ;
V_174:
V_24 = F_113 ( V_145 , V_10 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_114 ( V_146 , V_10 ) ;
if ( V_24 )
return V_24 ;
F_115 ( V_145 , V_146 ) ;
do {
...
static int F_116 ( struct V_1 * V_145 ,
struct V_1 * V_146 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_3 * V_170 , * V_171 ;
...
static long F_117 ( struct V_54 * V_55 , struct V_54 * V_114 , T_3 V_39 ,
unsigned int V_10 )
{
struct V_1 * V_145 = F_97 ( V_55 ) ;
struct V_1 * V_146 = F_97 ( V_114 ) ;
int V_24 = - V_100 ;
...
V_24 = F_114 ( V_146 , V_10 ) ;
if ( ! V_24 )
V_24 = F_116 ( V_145 , V_146 , V_39 , V_10 ) ;
}
}
return V_24 ;
}
