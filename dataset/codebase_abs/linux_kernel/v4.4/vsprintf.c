...
int F_91 ( T_5 * V_210 , T_3 V_24 , const char * V_55 , T_6 args )
{
struct V_31 V_32 = { 0 } ;
char * V_202 , * V_30 ;
V_202 = ( char * ) V_210 ;
V_30 = ( char * ) ( V_210 + V_24 ) ;
#define F_92 ( type ) \
do { \
if (sizeof(type) == 8) { \
...
break;
case V_187 : {
const char * V_211 = va_arg ( args , char * ) ;
T_3 V_29 ;
if ( ( unsigned long ) V_211 > ( unsigned long ) - V_51
|| ( unsigned long ) V_211 < V_51 )
V_211 = L_1 ;
V_29 = strlen ( V_211 ) + 1 ;
if ( V_202 + V_29 < V_30 )
memcpy ( V_202 , V_211 , V_29 ) ;
V_202 += V_29 ;
break;
}
case V_188 :
...
V_207:
return ( T_5 * ) ( F_93 ( V_202 , sizeof( T_5 ) ) ) - V_210 ;
#undef F_92
}
int F_94 ( char * V_9 , T_3 V_24 , const char * V_55 , const T_5 * V_210 )
{
struct V_31 V_32 = { 0 } ;
char * V_202 , * V_30 ;
const char * args = ( const char * ) V_210 ;
if ( F_87 ( V_24 > V_203 ) )
return 0 ;
V_202 = V_9 ;
V_30 = V_9 + V_24 ;
...
case V_187 : {
const char * V_212 = args ;
args += strlen ( V_212 ) + 1 ;
V_202 = string ( V_202 , V_30 , ( char * ) V_212 , V_32 ) ;
break;
}
case V_188 :
...
int F_96 ( T_5 * V_210 , T_3 V_24 , const char * V_55 , ... )
{
T_6 args ;
int V_213 ;
va_start ( args , V_55 ) ;
V_213 = F_91 ( V_210 , V_24 , V_55 , args ) ;
va_end ( args ) ;
return V_213 ;
}
...
V_215 = * ( V_202 + 1 ) ;
if ( ! V_215
|| ( V_3 == 16 && ! isxdigit ( V_215 ) )
|| ( V_3 == 10 && ! isdigit ( V_215 ) )
|| ( V_3 == 8 && ( ! isdigit ( V_215 ) || V_215 > '7' ) )
|| ( V_3 == 0 && ! isdigit ( V_215 ) ) )
break;
if ( V_217 )
V_96 . V_7 = V_185 != 'L' ?
...
F_4 ( V_202 , & V_214 , V_3 ) :
F_1 ( V_202 , & V_214 , V_3 ) ;
if ( V_43 > 0 && V_214 - V_202 > V_43 ) {
if ( V_3 == 0 )
F_2 ( V_202 , & V_3 ) ;
while ( V_214 - V_202 > V_43 ) {
if ( V_217 )
V_96 . V_7 = F_98 ( V_96 . V_7 , V_3 ) ;
else
V_96 . V_216 = F_99 ( V_96 . V_216 , V_3 ) ;
-- V_214 ;
}
}
switch ( V_185 ) {
...
* va_arg (args, unsigned char *) = V_96 . V_216 ;
break;
case 'h' :
if ( V_217 )
* va_arg ( args , short * ) = V_96 . V_7 ;
else
* va_arg (args, unsigned short *) = V_96 . V_216 ;
break;
case 'l' :
if ( V_217 )
* va_arg ( args , long * ) = V_96 . V_7 ;
else
* va_arg (args, unsigned long *) = V_96 . V_216 ;
break;
case 'L' :
if ( V_217 )
* va_arg (args, long long *) = V_96 . V_7 ;
else
* va_arg (args, unsigned long long *) = V_96 . V_216 ;
break;
case 'Z' :
case 'z' :
* va_arg ( args , T_3 * ) = V_96 . V_216 ;
break;
default:
if ( V_217 )
* va_arg ( args , int * ) = V_96 . V_7 ;
else
* va_arg (args, unsigned int *) = V_96 . V_216 ;
break;
}
V_25 ++ ;
if ( ! V_214 )
