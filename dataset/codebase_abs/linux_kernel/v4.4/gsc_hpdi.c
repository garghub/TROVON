...
return V_146 ;
F_41 ( V_114 ) ;
V_5 -> V_18 = F_42 ( V_114 , 0 ) ;
V_2 -> V_47 = F_42 ( V_114 , 2 ) ;
if ( ! V_5 -> V_18 || ! V_2 -> V_47 ) {
F_43 ( V_2 -> V_58 , L_5 ) ;
return - V_148 ;
}
F_36 ( V_2 ) ;
if ( F_44 ( V_114 -> V_31 , F_5 , V_149 ,
V_2 -> V_147 , V_2 ) ) {
F_43 ( V_2 -> V_58 ,
L_6 , V_114 -> V_31 ) ;
return - V_68 ;
...
static int F_51 ( struct V_113 * V_2 ,
const struct V_167 * V_168 )
{
return F_52 ( V_2 , & V_169 , V_168 -> V_170 ) ;
}
