...
struct F_289 * V_587 ;
struct V_11 * V_23 ;
T_2 V_14 , V_159 , V_588 ;
if ( V_497 != sizeof( * V_587 ) )
return - V_500 ;
V_587 = (struct F_289 * ) V_188 ;
V_14 = F_69 ( V_587 -> V_14 ) ;
V_159 = F_69 ( V_587 -> V_159 ) ;
F_23 ( L_68 , V_14 , V_159 ) ;
V_23 = F_11 ( V_13 , V_14 ) ;
if ( ! V_23 )
return - V_512 ;
V_588 = V_589 - V_23 -> V_107 ;
if ( V_159 > V_588 ) {
F_286 ( L_69 ) ;
F_86 ( V_23 , V_320 ) ;
F_48 ( V_23 ) ;
...
V_594 = F_103 ( V_49 -> V_188 + V_49 -> V_187 ) ;
V_593 = F_114 ( 0 , V_49 -> V_188 - V_595 , V_49 -> V_187 + V_595 ) ;
if ( V_593 != V_594 )
return - V_596 ;
}
return 0 ;
...
static void F_297 ( struct V_45 * V_49 , struct V_45 * V_597 ,
struct V_45 * * V_598 )
{
if ( ! F_298 ( V_49 ) )
F_190 ( V_49 ) -> V_387 = V_597 ;
V_597 -> V_392 = NULL ;
( * V_598 ) -> V_392 = V_597 ;
* V_598 = V_597 ;
V_49 -> V_187 += V_597 -> V_187 ;
V_49 -> V_391 += V_597 -> V_187 ;
V_49 -> V_599 += V_597 -> V_599 ;
}
...
void F_301 ( struct V_11 * V_23 , int V_600 )
{
T_1 V_412 ;
if ( V_23 -> V_141 != V_144 )
return;
V_412 = V_600 ? V_413 : V_415 ;
...
V_23 -> V_601 = V_205 -> V_206 ;
}
} else {
F_214 ( V_23 , V_205 ) ;
if ( V_205 -> V_209 ) {
if ( V_23 -> V_601 != V_205 -> V_206 ||
! F_116 ( V_282 ,
& V_23 -> V_252 ) )
F_182 ( V_23 , V_205 ) ;
} else {
...
V_23 -> V_13 -> V_158 = V_23 -> V_13 -> V_8 -> V_189 -> V_617 ;
return F_300 ( V_23 ) ;
}
...
{
T_2 V_618 ;
V_618 = F_186 ( V_23 , V_23 -> V_371 , V_23 -> V_411 ) ;
return F_186 ( V_23 , V_23 -> V_371 , V_206 ) <= V_618 ;
}
...
return;
V_620 = V_109 - V_23 -> V_108 ;
F_23 ( L_101 , V_23 , V_620 ) ;
V_23 -> V_108 += V_620 ;
V_587 . V_14 = F_18 ( V_23 -> V_17 ) ;
V_587 . V_159 = F_18 ( V_620 ) ;
V_23 -> V_19 = F_91 ( V_13 ) ;
F_83 ( V_13 , V_23 -> V_19 , V_591 , sizeof( V_587 ) , & V_587 ) ;
}
...
goto V_623;
F_23 ( L_110 , V_23 , V_49 -> V_187 ) ;
if ( V_23 -> V_38 != V_624 && V_23 -> V_38 != V_68 )
goto V_592;
if ( V_23 -> V_111 < V_49 -> V_187 )
goto V_592;
F_81 ( & F_35 ( V_49 ) -> V_50 . V_625 , & V_8 -> V_150 ) ;
...
if ( V_8 -> type == V_2 &&
F_322 ( & V_8 -> V_189 -> V_626 , & V_8 -> V_150 ,
F_3 ( V_8 ) ) ) {
F_97 ( V_49 ) ;
return;
}
...
case V_2 :
if ( V_8 -> V_189 -> V_627 ) {
V_13 -> V_158 = V_8 -> V_189 -> V_627 ;
break;
}
default:
V_13 -> V_158 = V_8 -> V_189 -> V_617 ;
break;
}
V_13 -> V_309 = 0 ;
V_13 -> V_263 = V_628 | V_629 ;
if ( V_8 -> type == V_117 &&
F_241 ( V_8 -> V_189 , V_630 ) )
V_13 -> V_263 |= V_264 ;
if ( F_241 ( V_8 -> V_189 , V_631 ) &&
( F_328 ( V_8 -> V_189 ) ||
F_241 ( V_8 -> V_189 , V_632 ) ) )
V_13 -> V_263 |= V_633 ;
F_52 ( & V_13 -> V_184 ) ;
F_52 ( & V_13 -> V_18 ) ;
F_329 ( & V_13 -> V_134 ) ;
...
V_10 = V_637 ;
if ( F_241 ( V_189 , V_638 ) )
V_333 = V_334 ;
else
V_333 = V_574 ;
V_8 = F_335 ( V_189 , V_150 , V_10 ,
V_23 -> V_72 ,
V_639 ,
V_333 ) ;
} else {
...
int F_337 ( struct V_261 * V_189 , T_4 * V_625 )
{
int V_642 = 0 , V_643 = 0 , V_644 = 0 ;
struct V_11 * V_15 ;
F_23 ( L_118 , V_189 -> V_330 , V_625 ) ;
F_122 ( & V_25 ) ;
F_5 (c, &chan_list, global_l) {
if ( V_15 -> V_38 != V_166 )
continue;
if ( ! F_15 ( & V_15 -> V_21 , & V_189 -> V_625 ) ) {
V_643 |= V_645 ;
...
return;
V_10 = F_3 ( V_8 ) ;
if ( F_322 ( & V_189 -> V_626 , & V_8 -> V_150 , V_10 ) )
return;
...
static inline void F_347 ( struct V_11 * V_23 , T_1 V_648 )
{
if ( V_23 -> V_32 != V_116 )
return;
if ( V_648 == 0x00 ) {
...
static void F_348 ( struct V_7 * V_8 , T_1 V_163 , T_1 V_648 )
{
struct V_12 * V_13 = V_8 -> V_356 ;
struct V_11 * V_23 ;
if ( ! V_13 )
...
V_653 = (struct V_246 * ) V_49 -> V_188 ;
V_187 = F_69 ( V_653 -> V_187 ) + V_243 ;
if ( V_187 == V_49 -> V_187 ) {
F_321 ( V_13 , V_49 ) ;
return;
}
...
static int F_351 ( struct V_658 * V_659 , void * V_28 )
{
struct V_11 * V_15 ;
F_122 ( & V_25 ) ;
F_5 (c, &chan_list, global_l) {
...
static int F_353 ( struct V_660 * V_660 , struct V_661 * V_661 )
{
return F_354 ( V_661 , F_351 , V_660 -> V_662 ) ;
}
int T_11 F_355 ( void )
{
int V_24 ;
...
if ( F_358 ( V_664 ) )
return 0 ;
V_665 = F_359 ( L_133 , 0444 , V_664 ,
NULL , & V_666 ) ;
F_360 ( L_134 , 0644 , V_664 ,
& V_109 ) ;
F_360 ( L_135 , 0644 , V_664 ,
& V_112 ) ;
return 0 ;
}
void F_361 ( void )
