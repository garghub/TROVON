...
static int F_42 ( struct V_95 * V_51 , struct V_25 * V_26 )
{
struct V_2 * V_3 = F_36 ( V_51 ) ;
switch ( F_15 ( V_26 ) -> V_33 ) {
case V_98 :
...
memcpy ( F_43 ( V_26 , 1 ) , & F_15 ( V_26 ) -> V_33 , 1 ) ;
F_37 ( & ( V_3 -> V_32 ) , V_26 ) ;
F_8 ( V_3 ) ;
return 0 ;
}
...
{
struct V_2 * V_3 ;
V_3 = F_57 ( & V_122 -> V_108 , sizeof( * V_3 ) , V_123 ) ;
if ( ! V_3 )
return - V_105 ;
V_3 -> V_5 = V_122 ;
V_122 -> V_124 = V_3 ;
...
{
struct V_2 * V_3 = V_122 -> V_124 ;
int V_17 , V_55 ;
V_122 -> V_127 = 0x20 ;
V_122 -> V_6 [ 0 ] -> V_128 |= V_129 ;
V_122 -> V_6 [ 0 ] -> V_130 = 64 ;
V_122 -> V_131 = 6 ;
for ( V_55 = 0 ; V_55 < 0x400 ; V_55 += 0x40 ) {
V_122 -> V_6 [ 0 ] -> V_7 = V_55 ^ 0x300 ;
V_17 = F_61 ( V_122 ) ;
if ( V_17 == 0 )
break;
}
