...
{
struct V_1 * V_2 = V_54 -> V_140 ;
F_27 ( V_2 , V_54 , V_54 -> V_141 , V_97 ,
( T_1 * ) V_139 , V_73 , V_100 ) ;
F_26 ( V_2 ) ;
}
static int F_43 ( struct V_95 * V_54 , T_6 V_142 ,
T_5 V_73 , T_5 * V_100 , T_7 * V_139 )
{
struct V_1 * V_2 = V_54 -> V_140 ;
T_4 V_28 = V_54 -> V_120 ;
if ( ! V_2 -> V_143 ) {
V_2 -> V_144 = V_2 -> V_23 + V_142 ;
V_2 -> V_145 = V_73 > V_146 ? V_73 : V_146 ;
V_2 -> V_143 = F_44 (
V_2 -> V_78 + V_2 -> V_144 ,
V_2 -> V_145 ) ;
if ( ! V_2 -> V_143 ) {
...
} else if ( V_2 -> V_23 + V_142 < V_2 -> V_144
|| V_2 -> V_23 + V_142 + V_73 >
V_2 -> V_144 + V_2 -> V_145 ) {
F_45 ( V_2 -> V_143 ) ;
V_2 -> V_144 = V_2 -> V_23 + V_142 ;
...
F_13 ( V_2 -> V_22 , L_10 ,
V_28 , V_2 -> V_143 + V_2 -> V_23 + V_142 - V_2 -> V_144 ,
V_73 ) ;
memcpy ( V_139 , V_2 -> V_143 + V_2 -> V_23 + V_142 - V_2 -> V_144 ,
V_73 ) ;
* V_100 += V_73 ;
return 0 ;
}
static int F_46 ( struct V_95 * V_54 , T_6 V_148 )
{
struct V_1 * V_2 = V_54 -> V_140 ;
int V_101 ;
F_13 ( V_54 -> V_22 , L_11 ,
V_54 -> V_149 . V_150 / 1024 , V_2 -> V_23 , ( T_1 ) V_148 ) ;
V_101 = F_20 ( V_2 , V_54 -> V_55 , V_148 , 0 ) ;
if ( V_101 )
return V_101 ;
F_26 ( V_2 ) ;
return 0 ;
}
static int F_47 ( struct V_95 * V_54 , enum V_151 V_152 )
{
struct V_1 * V_2 = V_54 -> V_140 ;
int V_101 ;
F_48 ( & V_2 -> V_153 ) ;
...
static void F_50 ( struct V_95 * V_54 , enum V_151 V_152 )
{
struct V_1 * V_2 = V_54 -> V_140 ;
F_34 ( V_2 ) ;
F_49 ( & V_2 -> V_153 ) ;
}
static int F_51 ( struct V_155 * V_156 )
{
struct V_157 * V_158 = V_156 -> V_22 . V_159 ;
struct V_160 V_161 ;
struct V_162 * V_22 = & V_156 -> V_22 ;
struct V_1 * V_2 ;
struct V_163 * V_164 ;
struct V_95 * V_54 ;
struct V_165 * V_149 ;
...
F_52 ( V_168 , & V_156 -> V_22 ) ;
V_2 = F_53 ( V_22 , sizeof( * V_2 ) , V_169 ) ;
if ( ! V_2 )
return - V_147 ;
V_2 -> V_170 = F_54 ( V_22 -> V_159 ) ;
if ( ! V_2 -> V_170 || V_2 -> V_170 > V_171 )
return - V_172 ;
V_2 -> V_22 = V_22 ;
V_2 -> V_3 = (struct V_173 * ) V_167 -> V_174 ;
F_55 ( V_156 , V_2 ) ;
V_164 = F_56 ( V_156 , V_175 , L_12 ) ;
V_2 -> V_11 = F_57 ( V_22 , V_164 ) ;
if ( F_58 ( V_2 -> V_11 ) )
return F_59 ( V_2 -> V_11 ) ;
V_164 = F_56 ( V_156 , V_175 ,
L_13 ) ;
if ( ! F_60 ( V_22 , V_164 -> V_176 , F_61 ( V_164 ) ,
V_164 -> V_177 ) ) {
F_19 ( V_22 , L_14 , V_164 ) ;
return - V_178 ;
}
V_2 -> V_78 = V_164 -> V_176 ;
...
V_54 -> V_188 = F_47 ;
V_54 -> V_189 = F_50 ;
V_101 = F_68 ( V_158 , L_21 ,
& V_2 -> V_138 ) ;
if ( V_101 < 0 )
goto V_190;
F_39 ( V_2 , V_54 ) ;
V_101 = F_69 ( V_54 , NULL , V_191 ) ;
if ( V_101 )
goto V_190;
V_161 . V_159 = V_158 ;
V_101 = F_70 ( V_149 , NULL , & V_161 , NULL , 0 ) ;
if ( V_101 )
goto V_190;
if ( V_2 -> V_35 == 0 ) {
V_2 -> V_35 = V_149 -> V_192 ;
F_28 ( V_2 ) ;
}
if ( V_54 -> V_193 > V_2 -> V_3 -> V_194 )
V_54 -> V_193 = V_2 -> V_3 -> V_194 ;
V_31 ++ ;
}
V_101 = F_38 ( V_2 ) ;
if ( V_101 )
...
return 0 ;
V_195:
for ( V_31 = 0 ; V_31 < V_2 -> V_170 ; V_31 ++ ) {
if ( ! V_2 -> V_181 )
V_31 *= 2 ;
F_71 ( & V_2 -> V_54 [ V_31 ] . V_149 ) ;
}
V_190:
F_72 ( & V_2 -> V_153 ) ;
V_180:
...
static int F_75 ( struct V_155 * V_156 , T_8 V_196 )
{
return 0 ;
}
