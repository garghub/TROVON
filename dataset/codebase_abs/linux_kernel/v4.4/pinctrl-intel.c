...
static void F_47 ( struct V_88 * V_89 , bool V_93 )
{
struct V_83 * V_90 = F_43 ( V_89 ) ;
struct V_2 * V_3 = F_36 ( V_90 ) ;
const struct V_1 * V_5 ;
...
static int F_50 ( struct V_88 * V_89 , unsigned type )
{
struct V_83 * V_90 = F_43 ( V_89 ) ;
struct V_2 * V_3 = F_36 ( V_90 ) ;
unsigned V_4 = F_44 ( V_89 ) ;
...
static int F_52 ( struct V_88 * V_89 , unsigned int V_109 )
{
struct V_83 * V_90 = F_43 ( V_89 ) ;
struct V_2 * V_3 = F_36 ( V_90 ) ;
const struct V_1 * V_5 ;
...
F_53 ( V_3 -> V_11 , L_12 , V_109 ? L_13 : L_14 , V_4 ) ;
return 0 ;
}
static T_4 F_54 ( struct V_2 * V_3 ,
const struct V_1 * V_5 )
{
...
V_116 = F_7 ( V_5 -> V_21 + V_5 -> V_94 +
V_15 * 4 ) ;
V_115 &= V_116 ;
F_55 (gpp_offset, &pending, community->gpp_size) {
unsigned V_13 , V_117 ;
V_13 = V_91 + V_15 * V_5 -> V_20 ;
if ( V_13 >= V_5 -> V_10 )
break;
V_117 = F_56 ( V_90 -> V_118 ,
V_5 -> V_9 + V_13 ) ;
F_57 ( V_117 ) ;
V_80 |= V_119 ;
}
...
static T_4 F_58 ( int V_117 , void * V_120 )
{
const struct V_1 * V_5 ;
...
static int F_59 ( struct V_2 * V_3 , int V_117 )
{
int V_80 ;
V_3 -> V_84 = V_121 ;
V_3 -> V_84 . V_122 = V_3 -> V_28 -> V_10 ;
V_3 -> V_84 . V_123 = F_60 ( V_3 -> V_11 ) ;
V_3 -> V_84 . V_11 = V_3 -> V_11 ;
V_3 -> V_84 . V_87 = - 1 ;
V_80 = F_61 ( & V_3 -> V_84 ) ;
if ( V_80 ) {
F_62 ( V_3 -> V_11 , L_15 ) ;
...
V_80 = F_63 ( & V_3 -> V_84 , F_60 ( V_3 -> V_11 ) ,
0 , 0 , V_3 -> V_28 -> V_10 ) ;
if ( V_80 ) {
F_62 ( V_3 -> V_11 , L_16 ) ;
goto V_124;
}
V_80 = F_64 ( V_3 -> V_11 , V_117 , F_58 , V_125 ,
F_60 ( V_3 -> V_11 ) , V_3 ) ;
if ( V_80 ) {
F_62 ( V_3 -> V_11 , L_17 ) ;
goto V_124;
}
V_80 = F_65 ( & V_3 -> V_84 , & V_126 , 0 ,
V_127 , V_128 ) ;
if ( V_80 ) {
F_62 ( V_3 -> V_11 , L_18 ) ;
goto V_124;
}
F_66 ( & V_3 -> V_84 , & V_126 , V_117 ,
NULL ) ;
return 0 ;
V_124:
F_67 ( & V_3 -> V_84 ) ;
...
{
#ifdef F_69
const struct V_129 * V_28 = V_3 -> V_28 ;
struct V_130 * V_8 ;
struct V_131 * V_132 ;
int V_6 ;
V_132 = F_70 ( V_3 -> V_11 , V_28 -> V_10 , sizeof( * V_132 ) , V_133 ) ;
if ( ! V_132 )
return - V_134 ;
V_8 = F_70 ( V_3 -> V_11 , V_3 -> V_7 ,
sizeof( * V_8 ) , V_133 ) ;
if ( ! V_8 )
return - V_134 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 ; V_6 ++ ) {
...
T_2 * V_135 ;
V_135 = F_70 ( V_3 -> V_11 , V_5 -> V_114 ,
sizeof( * V_135 ) , V_133 ) ;
if ( ! V_135 )
return - V_134 ;
V_8 [ V_6 ] . V_135 = V_135 ;
}
V_3 -> V_136 . V_132 = V_132 ;
V_3 -> V_136 . V_8 = V_8 ;
#endif
return 0 ;
}
int F_71 ( struct V_137 * V_138 ,
...
if ( ! V_139 )
return - V_71 ;
V_3 = F_72 ( & V_138 -> V_11 , sizeof( * V_3 ) , V_133 ) ;
if ( ! V_3 )
return - V_134 ;
V_3 -> V_11 = & V_138 -> V_11 ;
V_3 -> V_28 = V_139 ;
...
V_3 -> V_8 = F_70 ( & V_138 -> V_11 , V_3 -> V_7 ,
sizeof( * V_3 -> V_8 ) , V_133 ) ;
if ( ! V_3 -> V_8 )
return - V_134 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 ; V_6 ++ ) {
struct V_1 * V_5 = & V_3 -> V_8 [ V_6 ] ;
...
V_141 = F_74 ( V_138 , V_143 ,
V_5 -> V_144 ) ;
V_21 = F_75 ( & V_138 -> V_11 , V_141 ) ;
if ( F_76 ( V_21 ) )
return F_77 ( V_21 ) ;
V_142 = F_7 ( V_21 + V_145 ) ;
V_5 -> V_21 = V_21 ;
V_5 -> V_14 = V_21 + V_142 ;
V_5 -> V_114 = F_78 ( V_5 -> V_10 ,
V_5 -> V_20 ) ;
}
V_117 = F_79 ( V_138 , 0 ) ;
if ( V_117 < 0 ) {
F_62 ( & V_138 -> V_11 , L_19 ) ;
return V_117 ;
}
V_80 = F_68 ( V_3 ) ;
if ( V_80 )
return V_80 ;
V_3 -> V_146 = V_147 ;
V_3 -> V_146 . V_31 = F_60 ( & V_138 -> V_11 ) ;
V_3 -> V_146 . V_32 = V_3 -> V_28 -> V_32 ;
V_3 -> V_146 . V_10 = V_3 -> V_28 -> V_10 ;
V_3 -> V_27 = F_80 ( & V_3 -> V_146 , & V_138 -> V_11 , V_3 ) ;
if ( F_76 ( V_3 -> V_27 ) ) {
F_62 ( & V_138 -> V_11 , L_20 ) ;
return F_77 ( V_3 -> V_27 ) ;
}
V_80 = F_59 ( V_3 , V_117 ) ;
if ( V_80 ) {
F_81 ( V_3 -> V_27 ) ;
...
int F_85 ( struct V_148 * V_11 )
{
struct V_137 * V_138 = F_86 ( V_11 ) ;
struct V_2 * V_3 = F_84 ( V_138 ) ;
struct V_130 * V_8 ;
struct V_131 * V_132 ;
int V_6 ;
V_132 = V_3 -> V_136 . V_132 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_28 -> V_10 ; V_6 ++ ) {
const struct V_149 * V_150 = & V_3 -> V_28 -> V_32 [ V_6 ] ;
T_2 V_151 ;
if ( ! F_12 ( V_3 , V_150 -> V_152 ) )
continue;
V_151 = F_7 ( F_3 ( V_3 , V_150 -> V_152 , V_40 ) ) ;
V_132 [ V_6 ] . V_52 = V_151 & ~ V_85 ;
V_151 = F_7 ( F_3 ( V_3 , V_150 -> V_152 , V_41 ) ) ;
V_132 [ V_6 ] . V_79 = V_151 ;
}
V_8 = V_3 -> V_136 . V_8 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 ; V_6 ++ ) {
struct V_1 * V_5 = & V_3 -> V_8 [ V_6 ] ;
void T_1 * V_87 ;
unsigned V_15 ;
V_87 = V_5 -> V_21 + V_5 -> V_94 ;
for ( V_15 = 0 ; V_15 < V_5 -> V_114 ; V_15 ++ )
V_8 [ V_6 ] . V_135 [ V_15 ] = F_7 ( V_87 + V_15 * 4 ) ;
}
return 0 ;
}
...
V_87 = V_5 -> V_21 ;
for ( V_15 = 0 ; V_15 < V_5 -> V_114 ; V_15 ++ ) {
F_26 ( 0 , V_87 + V_5 -> V_94 + V_15 * 4 ) ;
F_26 ( 0xffff , V_87 + V_92 + V_15 * 4 ) ;
}
}
}
int F_88 ( struct V_148 * V_11 )
{
struct V_137 * V_138 = F_86 ( V_11 ) ;
struct V_2 * V_3 = F_84 ( V_138 ) ;
const struct V_130 * V_8 ;
...
if ( ! F_12 ( V_3 , V_150 -> V_152 ) )
continue;
V_153 = F_3 ( V_3 , V_150 -> V_152 , V_40 ) ;
V_151 = F_7 ( V_153 ) & ~ V_85 ;
if ( V_151 != V_132 [ V_6 ] . V_52 ) {
F_26 ( V_132 [ V_6 ] . V_52 , V_153 ) ;
F_53 ( V_11 , L_21 ,
V_150 -> V_152 , F_7 ( V_153 ) ) ;
}
V_153 = F_3 ( V_3 , V_150 -> V_152 , V_41 ) ;
V_151 = F_7 ( V_153 ) ;
if ( V_151 != V_132 [ V_6 ] . V_79 ) {
F_26 ( V_132 [ V_6 ] . V_79 , V_153 ) ;
F_53 ( V_11 , L_22 ,
V_150 -> V_152 , F_7 ( V_153 ) ) ;
}
}
...
V_87 = V_5 -> V_21 + V_5 -> V_94 ;
for ( V_15 = 0 ; V_15 < V_5 -> V_114 ; V_15 ++ ) {
F_26 ( V_8 [ V_6 ] . V_135 [ V_15 ] , V_87 + V_15 * 4 ) ;
F_53 ( V_11 , L_23 , V_6 , V_15 ,
F_7 ( V_87 + V_15 * 4 ) ) ;
}
}
return 0 ;
