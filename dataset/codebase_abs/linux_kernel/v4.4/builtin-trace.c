...
V_314 = V_219 -> V_246 ;
V_42 += F_16 ( V_314 + V_42 , V_317 - V_42 , L_49 , V_278 -> V_20 ) ;
...
T_7 V_333 ;
char * V_296 ;
const char * V_244 = F_127 ( V_19 , V_15 , L_59 ) ;
if ( ! V_223 )
goto V_301;
V_219 = F_74 ( V_223 ) ;
if ( ! V_219 )
...
struct V_14 * V_15 )
{
T_5 V_336 = F_129 ( V_19 , V_15 , L_60 ) ;
...
V_19 -> V_20 ,
F_130 ( V_19 , V_15 , L_64 ) ,
( V_339 ) F_129 ( V_19 , V_15 , L_65 ) ,
V_336 ,
F_129 ( V_19 , V_15 , L_66 ) ) ;
F_121 ( V_223 ) ;
return 0 ;
}
static int F_131 ( struct V_238 * V_238 , struct V_18 * V_19 ,
union V_258 * V_259 V_313 ,
struct V_14 * V_15 )
{
F_116 ( V_238 , V_15 ) ;
...
static void F_133 ( V_57 * V_335 , struct V_14 * V_15 ,
struct V_343 * V_344 ,
...
static int F_134 ( struct V_238 * V_238 ,
struct V_18 * V_19 ,
union V_258 * V_259 ,
struct V_14 * V_15 )
{
...
F_133 ( V_238 -> V_262 , V_15 , & V_344 , true , false ) ;
...
static bool F_136 ( struct V_238 * V_238 , struct V_14 * V_15 )
{
if ( ( V_238 -> V_367 && F_137 ( V_238 -> V_367 , V_15 -> V_315 ) ) ||
( V_238 -> V_368 && F_137 ( V_238 -> V_368 , V_15 -> V_235 ) ) )
return false ;
if ( V_238 -> V_367 || V_238 -> V_368 )
return true ;
return false ;
}
static int F_138 ( struct V_265 * V_266 ,
union V_258 * V_259 ,
struct V_14 * V_15 ,
struct V_18 * V_19 ,
...
static int F_139 ( struct V_238 * V_238 )
{
if ( V_238 -> V_273 . V_274 . V_315 ) {
V_238 -> V_367 = F_72 ( V_238 -> V_273 . V_274 . V_315 ) ;
if ( V_238 -> V_367 == NULL ) {
F_140 ( L_77 ) ;
return - V_300 ;
}
...
V_238 -> V_368 = F_72 ( V_238 -> V_273 . V_274 . V_235 ) ;
if ( V_238 -> V_368 == NULL ) {
F_140 ( L_78 ) ;
return - V_300 ;
}
...
static int F_141 ( struct V_238 * V_238 , int V_370 , const char * * V_371 )
{
...
unsigned int V_377 = F_67 ( V_376 ) ;
const char * const V_378 [] = { L_85 , L_86 } ;
unsigned int V_379 = F_67 ( V_378 ) ;
const char * const V_380 [] = { L_85 , L_87 } ;
unsigned int V_381 = F_67 ( V_380 ) ;
V_372 = F_67 ( V_375 ) + V_377 + 1 +
V_379 + V_381 + V_370 ;
V_374 = calloc ( V_372 + 1 , sizeof( char * ) ) ;
if ( V_374 == NULL )
return - V_26 ;
V_373 = 0 ;
for ( V_294 = 0 ; V_294 < F_67 ( V_375 ) ; V_294 ++ )
...
return F_143 ( V_373 , V_374 , NULL ) ;
}
static bool F_144 ( struct V_267 * V_268 )
{
...
static int F_146 ( struct V_267 * V_268 ,
T_5 V_359 )
{
struct V_18 * V_19 ;
struct V_385 V_358 = {
...
static void F_149 ( struct V_238 * V_238 , union V_258 * V_259 , struct V_14 * V_15 )
{
...
V_19 = F_150 ( V_238 -> V_268 , V_15 -> V_24 ) ;
if ( V_19 == NULL ) {
...
static int F_151 ( struct V_238 * V_238 )
{
int V_233 = - 1 ;
struct V_267 * V_268 = V_238 -> V_268 ;
struct V_18 * V_391 , * V_392 ;
V_391 = F_12 ( L_98 , F_117 ) ;
if ( V_391 == NULL )
goto V_301;
if ( F_152 ( V_391 , args ) )
goto V_393;
V_392 = F_12 ( L_99 , F_123 ) ;
if ( V_392 == NULL )
goto V_393;
if ( F_11 ( V_392 , V_233 ) )
goto V_394;
...
static int F_153 ( struct V_238 * V_238 )
{
int V_269 = - 1 ;
char * V_396 = F_154 ( L_100 , ! V_238 -> V_397 ,
V_238 -> V_297 . V_298 ,
V_238 -> V_297 . V_39 ) ;
if ( V_396 == NULL )
goto V_398;
if ( ! F_155 ( V_238 -> V_286 . V_395 . V_391 , L_101 , V_396 ) )
V_269 = F_155 ( V_238 -> V_286 . V_395 . V_392 , L_101 , V_396 ) ;
free ( V_396 ) ;
V_301:
return V_269 ;
V_398:
...
static int F_156 ( struct V_238 * V_238 , int V_370 , const char * * V_371 )
{
struct V_267 * V_268 = V_238 -> V_268 ;
struct V_18 * V_19 ;
int V_269 = - 1 , V_294 ;
...
bool V_401 = false ;
V_238 -> V_239 = true ;
if ( V_238 -> V_340 && F_151 ( V_238 ) )
goto V_402;
if ( V_238 -> V_340 )
V_238 -> V_247 = F_144 ( V_268 ) ;
if ( ( V_238 -> V_382 & V_383 ) &&
F_146 ( V_268 , V_360 ) ) {
goto V_403;
}
...
goto V_403;
if ( V_238 -> V_405 &&
F_157 ( V_268 , L_102 , L_103 ,
F_128 ) )
goto V_406;
V_269 = F_158 ( V_268 , & V_238 -> V_273 . V_274 ) ;
if ( V_269 < 0 ) {
...
F_159 ( V_268 , & V_238 -> V_273 ) ;
signal ( V_408 , F_87 ) ;
signal ( V_254 , F_87 ) ;
if ( V_400 ) {
V_269 = F_160 ( V_268 , & V_238 -> V_273 . V_274 ,
V_371 , false , NULL ) ;
if ( V_269 < 0 ) {
...
V_269 = F_162 ( V_268 , V_238 -> V_410 . V_298 , V_238 -> V_410 . V_39 ) ;
else if ( F_163 ( V_268 -> V_275 , 0 ) == - 1 )
V_269 = F_164 ( V_268 , F_165 () ) ;
if ( V_269 < 0 )
goto V_403;
...
V_269 = F_167 ( V_268 , & V_19 ) ;
if ( V_269 < 0 )
goto V_412;
V_269 = F_168 ( V_268 , V_238 -> V_273 . V_413 , false ) ;
if ( V_269 < 0 )
goto V_414;
if ( ! F_169 ( & V_238 -> V_273 . V_274 ) )
F_170 ( V_268 ) ;
if ( V_400 )
F_171 ( V_268 ) ;
V_238 -> V_255 = F_163 ( V_268 -> V_275 , 0 ) == - 1 ||
V_268 -> V_275 -> V_298 > 1 ||
F_172 ( V_268 ) -> V_358 . V_415 ;
V_416:
V_399 = V_238 -> V_225 ;
for ( V_294 = 0 ; V_294 < V_268 -> V_417 ; V_294 ++ ) {
union V_258 * V_259 ;
while ( ( V_259 = F_173 ( V_268 , V_294 ) ) != NULL ) {
struct V_14 V_15 ;
++ V_238 -> V_225 ;
V_269 = F_174 ( V_268 , V_259 , & V_15 ) ;
if ( V_269 ) {
fprintf ( V_238 -> V_262 , L_108 , V_269 ) ;
goto V_418;
}
F_149 ( V_238 , V_259 , & V_15 ) ;
V_418:
F_175 ( V_268 , V_294 ) ;
if ( V_253 )
goto V_419;
...
if ( ! V_401 && F_177 ( V_268 , V_328 ) > 0 ) {
if ( F_178 ( V_268 , V_420 | V_421 ) == 0 )
V_401 = true ;
goto V_416;
}
} else {
...
char V_423 [ V_424 ] ;
V_406:
F_182 ( V_272 , V_423 , sizeof( V_423 ) , L_102 , L_103 ) ;
goto V_425;
V_402:
F_182 ( V_272 , V_423 , sizeof( V_423 ) , L_1 , L_113 ) ;
goto V_425;
V_414:
F_183 ( V_268 , V_272 , V_423 , sizeof( V_423 ) ) ;
goto V_425;
V_409:
F_184 ( V_268 , V_272 , V_423 , sizeof( V_423 ) ) ;
V_425:
...
fprintf ( V_238 -> V_262 ,
L_115 ,
V_19 -> V_396 , F_111 ( V_19 ) , V_272 ,
F_124 ( V_272 , V_423 , sizeof( V_423 ) ) ) ;
goto V_407;
}
V_403:
...
static int F_185 ( struct V_238 * V_238 )
{
...
V_238 -> V_255 = true ;
V_434 = F_186 ( & V_429 , false , & V_238 -> V_266 ) ;
if ( V_434 == NULL )
return - 1 ;
if ( F_96 ( & V_434 -> V_260 . V_451 ) < 0 )
goto V_301;
V_238 -> V_270 = & V_434 -> V_452 . V_270 ;
V_269 = F_187 ( V_434 , V_427 ) ;
if ( V_269 )
goto V_301;
V_19 = F_188 ( V_434 -> V_268 ,
L_88 ) ;
if ( V_19 == NULL )
V_19 = F_188 ( V_434 -> V_268 ,
L_90 ) ;
...
static T_1 F_193 ( V_57 * V_212 )
{
T_1 V_42 ;
V_42 = fprintf ( V_212 , L_124 ) ;
return V_42 ;
}
static T_1 F_194 ( struct V_218 * V_219 ,
struct V_238 * V_238 , V_57 * V_212 )
{
struct V_240 * V_240 ;
T_1 V_42 = 0 ;
struct V_277 * V_278 ;
struct V_308 * V_309 = F_195 ( V_219 -> V_222 ) ;
if ( V_309 == NULL )
return 0 ;
...
double V_455 = F_196 ( V_240 ) ;
double V_456 ;
T_5 T_2 = ( T_5 ) V_240 -> T_2 ;
V_456 = V_455 ? 100.0 * F_197 ( V_240 ) / V_455 : 0.0 ;
V_455 /= V_214 ;
...
static int F_199 ( struct V_223 * V_223 , void * V_21 )
{
...
V_42 += fprintf ( V_212 , L_133 , F_89 ( V_223 ) , V_223 -> V_235 ) ;
...
V_42 += F_194 ( V_219 , V_238 , V_212 ) ;
V_458 -> V_42 += V_42 ;
return 0 ;
}
static T_1 F_180 ( struct V_238 * V_238 , V_57 * V_212 )
{
struct V_457 V_458 = {
. V_212 = V_212 ,
. V_238 = V_238
} ;
V_458 . V_42 = F_193 ( V_212 ) ;
F_200 ( V_238 -> V_270 , F_199 , & V_458 ) ;
return V_458 . V_42 ;
}
...
static int F_202 ( const struct V_460 * V_461 , const char * V_462 ,
int T_10 V_313 )
{
int V_233 = - 1 ;
T_1 V_294 ;
struct V_238 * V_238 = V_461 -> V_463 ;
struct V_464 * V_465 = F_72 ( V_462 ) ;
if ( V_465 == NULL )
return - 1 ;
V_294 = V_238 -> V_410 . V_298 = F_203 ( V_465 ) + 1 ;
V_238 -> V_410 . V_39 = calloc ( V_294 , sizeof( V_339 ) ) ;
if ( V_238 -> V_410 . V_39 == NULL )
goto V_301;
V_238 -> V_410 . V_39 [ 0 ] = F_165 () ;
for ( V_294 = 1 ; V_294 < V_238 -> V_410 . V_298 ; ++ V_294 )
V_238 -> V_410 . V_39 [ V_294 ] = F_204 ( V_465 , V_294 - 1 ) -> V_294 ;
F_205 ( V_465 ) ;
V_233 = 0 ;
V_301:
return V_233 ;
}
static int F_206 ( struct V_238 * V_238 , const char * V_244 )
{
struct V_231 V_232 ;
if ( ! V_231 ( V_244 , & V_232 ) && V_232 . V_236 ) {
char V_466 [ V_230 ] ;
F_16 ( V_466 , sizeof( V_466 ) , L_139 , V_244 ) ;
F_207 ( V_466 ) ;
rename ( V_244 , V_466 ) ;
}
...
static int F_208 ( const struct V_460 * V_461 , const char * V_462 ,
int T_10 V_313 )
{
...
static void F_209 ( struct V_267 * V_268 , void * V_22 )
{
struct V_18 * V_19 ;
F_189 (evlist, evsel)
V_19 -> V_22 = V_22 ;
}
int F_210 ( int V_370 , const char * * V_371 , const char * T_11 V_313 )
{
const char * V_467 [] = {
L_142 ,
L_143 ,
...
. V_285 = {
. V_257 = F_211 () ,
. V_321 = F_108 ( L_146 , V_238 . V_285 . V_257 ) ,
} ,
. V_286 = {
. V_221 = - 1 ,
} ,
...
F_212 ( 0 , L_147 , & V_238 . V_268 , L_147 ,
L_148 ,
V_479 ) ,
F_213 ( 0 , L_64 , & V_238 . V_256 ,
L_149 ) ,
F_213 ( 0 , L_150 , & V_238 . V_422 , L_151 ) ,
F_214 ( 'e' , L_152 , & V_477 , L_152 , L_153 ) ,
F_214 ( 'o' , L_154 , & V_476 , L_155 , L_156 ) ,
F_214 ( 'i' , L_157 , & V_430 , L_155 , L_158 ) ,
F_214 ( 'p' , L_65 , & V_238 . V_273 . V_274 . V_315 , L_65 ,
L_159 ) ,
F_214 ( 't' , L_160 , & V_238 . V_273 . V_274 . V_235 , L_160 ,
L_161 ) ,
F_212 ( 0 , L_162 , & V_238 , L_163 ,
L_164 , F_202 ) ,
F_213 ( 'a' , L_165 , & V_238 . V_273 . V_274 . V_480 ,
L_166 ) ,
F_214 ( 'C' , L_167 , & V_238 . V_273 . V_274 . V_481 , L_167 ,
L_168 ) ,
F_213 ( 0 , L_169 , & V_238 . V_273 . V_482 ,
L_170 ) ,
F_212 ( 'm' , L_171 , & V_238 . V_273 . V_413 , L_172 ,
L_173 ,
V_483 ) ,
F_214 ( 'u' , L_174 , & V_238 . V_273 . V_274 . V_484 , L_175 ,
L_176 ) ,
F_212 ( 0 , L_177 , & V_238 , L_178 ,
L_179 ,
F_201 ) ,
F_213 ( 0 , L_102 , & V_238 . V_405 , L_180 ) ,
F_215 ( 'v' , L_181 , & V_306 , L_182 ) ,
F_213 ( 'T' , L_183 , & V_238 . V_369 ,
L_184 ) ,
F_213 ( 's' , L_185 , & V_238 . V_318 ,
L_186 ) ,
F_213 ( 'S' , L_187 , & V_238 . V_320 ,
L_188 ) ,
F_216 ( 'F' , L_189 , & V_238 . V_382 , L_190 ,
L_191 , F_208 , L_73 ) ,
F_213 ( 0 , L_2 , & V_238 . V_340 , L_192 ) ,
F_213 ( 'f' , L_193 , & V_238 . V_432 , L_194 ) ,
F_217 ( 0 , L_195 , & V_238 . V_273 . V_276 ,
L_196 ) ,
F_218 ()
} ;
...
V_370 = F_220 ( V_370 , V_371 , V_478 , V_485 ,
V_467 , V_489 ) ;
if ( V_238 . V_382 ) {
...
F_209 ( V_238 . V_268 , F_131 ) ;
if ( ( V_370 >= 1 ) && ( strcmp ( V_371 [ 0 ] , L_79 ) == 0 ) )
return F_141 ( & V_238 , V_370 - 1 , & V_371 [ 1 ] ) ;
if ( V_238 . V_318 )
...
V_269 = F_223 ( & V_238 . V_273 . V_274 ) ;
if ( V_269 ) {
F_224 ( & V_238 . V_273 . V_274 , V_269 , V_29 , sizeof( V_29 ) ) ;
fprintf ( V_238 . V_262 , L_3 , V_29 ) ;
goto V_496;
}
V_269 = F_225 ( & V_238 . V_273 . V_274 ) ;
if ( V_269 ) {
F_224 ( & V_238 . V_273 . V_274 , V_269 , V_29 , sizeof( V_29 ) ) ;
fprintf ( V_238 . V_262 , L_3 , V_29 ) ;
goto V_496;
}
if ( ! V_370 && F_169 ( & V_238 . V_273 . V_274 ) )
V_238 . V_273 . V_274 . V_480 = true ;
if ( V_430 )
V_269 = F_185 ( & V_238 ) ;
else
V_269 = F_156 ( & V_238 , V_370 , V_371 ) ;
V_496:
if ( V_476 != NULL )
fclose ( V_238 . V_262 ) ;
V_301:
