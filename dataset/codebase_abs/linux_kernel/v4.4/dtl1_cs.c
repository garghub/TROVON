...
static int F_30 ( struct V_60 * V_22 , struct V_18 * V_19 )
{
struct V_9 * V_10 = F_27 ( V_22 ) ;
struct V_18 * V_61 ;
struct V_28 V_28 ;
...
V_28 . V_69 = 0 ;
V_28 . V_4 = V_19 -> V_4 ;
V_61 = F_18 ( V_37 + V_19 -> V_4 + 1 , V_33 ) ;
if ( ! V_61 )
return - V_70 ;
F_31 ( V_61 , V_37 ) ;
F_32 ( V_19 , F_19 ( V_61 , V_19 -> V_4 ) , V_19 -> V_4 ) ;
if ( V_19 -> V_4 & 0x0001 )
* F_19 ( V_61 , 1 ) = 0 ;
memcpy ( F_33 ( V_61 , V_37 ) , & V_28 , V_37 ) ;
F_34 ( & ( V_10 -> V_20 ) , V_61 ) ;
F_4 ( V_10 ) ;
F_12 ( V_19 ) ;
return 0 ;
...
{
struct V_9 * V_10 ;
V_10 = F_49 ( & V_91 -> V_74 , sizeof( * V_10 ) , V_92 ) ;
if ( ! V_10 )
return - V_70 ;
V_10 -> V_15 = V_91 ;
V_91 -> V_93 = V_10 ;
...
{
struct V_9 * V_10 = V_91 -> V_93 ;
F_46 ( V_10 ) ;
F_52 ( V_91 ) ;
}
static int F_53 ( struct V_90 * V_15 , void * V_97 )
{
if ( ( V_15 -> V_16 [ 1 ] -> V_98 ) || ( V_15 -> V_16 [ 1 ] -> V_98 < 8 ) )
return - V_89 ;
V_15 -> V_16 [ 0 ] -> V_71 &= ~ V_99 ;
V_15 -> V_16 [ 0 ] -> V_71 |= V_100 ;
return F_54 ( V_15 ) ;
}
...
int V_101 ;
V_91 -> V_16 [ 0 ] -> V_98 = 8 ;
V_101 = F_55 ( V_91 , F_53 , NULL ) ;
if ( V_101 )
goto V_102;
V_101 = F_56 ( V_91 , F_22 ) ;
if ( V_101 )
goto V_102;
V_101 = F_57 ( V_91 ) ;
if ( V_101 )
