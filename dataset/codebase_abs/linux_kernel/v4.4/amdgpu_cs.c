...
V_35 -> V_129 = F_38 ( V_35 -> V_12 , & V_61 -> V_105 ,
& V_35 -> V_74 ) ;
if ( V_35 -> V_43 . V_44 )
...
V_135:
if ( V_111 )
F_42 ( & V_35 -> V_133 , & V_35 -> V_74 ) ;
V_134:
if ( V_124 )
F_43 ( & V_130 -> V_131 -> V_132 ) ;
return V_111 ;
}
...
V_111 = F_45 ( V_35 -> V_12 , & V_35 -> V_95 [ 0 ] . V_139 , V_138 , V_35 -> V_42 ) ;
if ( V_111 )
return V_111 ;
}
return 0 ;
}
static int F_46 ( void * V_140 , struct V_6 * V_141 ,
struct V_6 * V_2 )
{
struct V_106 * V_142 = F_47 ( V_141 , struct V_106 , V_53 . V_128 ) ;
struct V_106 * V_143 = F_47 ( V_2 , struct V_106 , V_53 . V_128 ) ;
return ( int ) V_142 -> V_49 -> V_46 . V_144 - ( int ) V_143 -> V_49 -> V_46 . V_144 ;
}
static void F_48 ( struct V_34 * V_145 , int error , bool V_146 )
{
unsigned V_3 ;
if ( ! error ) {
F_49 ( NULL , & V_145 -> V_74 , F_46 ) ;
F_50 ( & V_145 -> V_133 ,
& V_145 -> V_74 ,
V_145 -> V_147 ) ;
} else if ( V_146 ) {
...
F_52 ( V_145 -> V_12 , & V_145 -> V_95 [ V_3 ] ) ;
F_23 ( V_145 -> V_95 ) ;
F_53 ( & V_145 -> V_43 . V_44 ) ;
F_53 ( & V_145 -> V_48 . V_49 ) ;
}
...
struct V_108 * V_44 ;
int V_3 , V_111 ;
V_111 = F_55 ( V_12 , V_105 ) ;
if ( V_111 )
return V_111 ;
V_111 = F_56 ( V_12 , & V_35 -> V_95 [ 0 ] . V_139 , V_105 -> V_149 ) ;
if ( V_111 )
return V_111 ;
...
if ( V_121 == NULL )
continue;
V_111 = F_58 ( V_12 , V_121 , & V_44 -> V_46 . V_115 ) ;
if ( V_111 )
return V_111 ;
V_150 = V_121 -> V_151 ;
V_111 = F_56 ( V_12 , & V_35 -> V_95 [ 0 ] . V_139 , V_150 ) ;
if ( V_111 )
return V_111 ;
}
}
V_111 = F_59 ( V_12 , V_105 , & V_35 -> V_95 [ 0 ] . V_139 ) ;
if ( V_152 && V_35 -> V_72 ) {
for ( V_3 = 0 ; V_3 < V_35 -> V_72 -> V_126 ; V_3 ++ ) {
V_44 = V_35 -> V_72 -> V_127 [ V_3 ] . V_49 ;
if ( ! V_44 )
...
if ( V_15 -> V_153 -> V_154 ) {
V_111 = F_62 ( V_15 , V_145 , V_3 ) ;
if ( V_111 )
return V_111 ;
}
}
V_111 = F_54 ( V_145 , V_105 ) ;
if ( ! V_111 )
F_44 ( V_145 ) ;
return V_111 ;
}
static int F_63 ( struct V_11 * V_12 , int V_111 )
{
if ( V_111 == - V_155 ) {
V_111 = F_64 ( V_12 ) ;
if ( ! V_111 )
...
T_3 V_45 ;
T_5 * V_165 ;
V_163 = F_66 ( V_145 , V_161 -> va_start ,
& V_164 ) ;
if ( ! V_164 ) {
F_9 ( L_7 ) ;
return - V_18 ;
...
V_111 = F_67 ( V_164 , ( void * * ) & V_165 ) ;
if ( V_111 ) {
return V_111 ;
}
V_45 = ( ( T_3 ) V_163 -> V_167 . V_170 ) * V_169 ;
V_165 += V_161 -> va_start - V_45 ;
V_111 = F_68 ( V_15 , NULL , V_161 -> V_166 , V_159 ) ;
if ( V_111 ) {
F_9 ( L_9 ) ;
return V_111 ;
}
...
V_111 = F_56 ( V_12 , & V_159 -> V_139 , V_147 ) ;
F_51 ( V_147 ) ;
F_26 ( V_69 ) ;
if ( V_111 )
return V_111 ;
...
F_52 ( V_194 -> V_12 , & V_194 -> V_95 [ V_3 ] ) ;
F_23 ( V_194 -> V_95 ) ;
if ( V_194 -> V_43 . V_44 )
F_53 ( & V_194 -> V_43 . V_44 ) ;
return 0 ;
}
int F_77 ( struct V_195 * V_196 , void * V_55 , struct V_197 * V_42 )
{
...
if ( V_111 ) {
F_9 ( L_10 ) ;
F_48 ( & V_145 , V_111 , false ) ;
V_111 = F_63 ( V_12 , V_111 ) ;
return V_111 ;
}
V_111 = F_37 ( & V_145 ) ;
if ( V_111 == - V_68 )
...
V_199 = true ;
V_111 = F_65 ( V_12 , & V_145 ) ;
}
if ( ! V_111 ) {
V_111 = F_72 ( V_12 , & V_145 ) ;
if ( V_111 )
F_9 ( L_13 , V_111 ) ;
}
if ( V_111 )
...
struct V_204 * V_147 ;
struct V_193 * V_194 ;
V_194 = F_79 ( sizeof( struct V_193 ) , V_67 ) ;
if ( ! V_194 ) {
V_111 = - V_68 ;
goto V_202;
}
...
V_145 . V_147 = F_81 ( & V_147 -> V_205 ) ;
V_57 -> V_202 . V_40 = F_82 ( V_145 . V_69 , V_15 ,
& V_147 -> V_205 ) ;
...
struct V_215 * V_147 ;
V_111 = F_85 ( V_12 , V_145 . V_92 , V_145 . V_95 ,
V_145 . V_42 ) ;
...
V_202:
F_48 ( & V_145 , V_111 , V_199 ) ;
V_111 = F_63 ( V_12 , V_111 ) ;
return V_111 ;
}
int F_86 ( struct V_195 * V_196 , void * V_55 ,
struct V_197 * V_42 )
{
union V_216 * V_217 = V_55 ;
struct V_11 * V_12 = V_196 -> V_198 ;
unsigned long V_218 = F_87 ( V_217 -> V_65 . V_218 ) ;
...
if ( V_69 == NULL )
return - V_18 ;
V_147 = F_73 ( V_69 , V_15 , V_217 -> V_65 . V_40 ) ;
if ( F_74 ( V_147 ) )
V_111 = F_75 ( V_147 ) ;
else if ( V_147 ) {
V_111 = F_88 ( V_147 , true , V_218 ) ;
F_51 ( V_147 ) ;
} else
V_111 = 1 ;
F_26 ( V_69 ) ;
