...
struct V_28 * F_23 ( struct V_5 * V_37 )
{
struct V_28 * V_26 ;
int V_32 ;
V_26 = F_24 ( sizeof( struct V_28 ) , V_38 ) ;
if ( ! V_26 )
return F_25 ( - V_17 ) ;
V_32 = F_26 ( & V_39 , 0 , 0 , V_38 ) ;
if ( V_32 < 0 ) {
F_17 ( V_26 ) ;
return F_25 ( V_32 ) ;
}
...
static int F_28 ( struct V_5 * V_4 , void * V_41 )
{
F_29 ( V_4 ) ;
return 0 ;
}
...
{
struct V_3 * V_4 ;
V_4 = F_24 ( sizeof( struct V_3 ) , V_38 ) ;
if ( ! V_4 )
return NULL ;
F_27 ( & V_4 -> V_42 ) ;
V_4 -> V_26 = V_26 ;
...
static int F_38 ( struct V_5 * V_4 , void * V_41 )
{
struct V_3 * V_11 = F_4 ( V_4 ) ;
int V_43 ;
if ( V_11 -> V_44 )
...
static int F_41 ( struct V_5 * V_4 , void * V_41 )
{
struct V_3 * V_11 = F_4 ( V_4 ) ;
struct V_28 * V_45 ;
F_42 ( ! V_11 -> V_44 ) ;
...
struct V_47 * F_44 ( struct V_3 * V_4 , const char * V_48 )
{
struct V_47 * V_49 ;
T_1 V_50 ;
if ( ! V_48 )
V_48 = V_4 -> V_4 . V_18 -> V_48 ;
V_50 = F_45 ( & V_4 -> V_49 ) ;
V_49 = F_46 ( V_4 -> V_49 . V_51 , V_50 , V_48 ) ;
if ( ! V_49 )
return F_25 ( - V_52 ) ;
return V_49 ;
}
void F_47 ( struct V_47 * V_49 )
{
T_1 V_50 ;
V_50 = F_45 ( V_49 ) ;
F_48 ( V_49 -> V_51 , V_50 ) ;
...
{
struct V_47 * V_53 = & V_4 -> V_53 ;
return V_53 -> V_51 ;
}
int F_50 ( struct V_3 * V_4 )
{
struct V_28 * V_26 = V_4 -> V_26 ;
if ( V_26 -> V_54 )
return V_26 -> V_54 ( V_4 ) ;
return F_49 ( V_4 ) ;
}
