...
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
struct V_119 * V_87 = & V_19 -> V_87 ;
switch ( V_87 -> V_120 ) {
case V_121 :
return F_26 ( V_10 -> V_111 ) ;
case V_122 :
...
static void F_27 ( struct V_9 * V_10 , int V_126 )
{
T_1 V_127 ;
switch ( V_126 ) {
case V_128 :
...
static int F_30 ( struct V_9 * V_10 , T_1 V_91 )
{
int V_133 , V_134 , V_135 , V_59 ;
V_133 = V_136 ;
while ( V_133 < V_137 ) {
F_28 ( V_10 , V_133 ) ;
if ( ! F_31 ( V_10 -> V_111 , V_91 , NULL ) )
break;
V_133 += V_138 ;
}
V_134 = V_133 + V_138 ;
...
V_135 = ( V_133 + V_134 ) / 2 ;
F_28 ( V_10 , V_135 ) ;
V_59 = F_31 ( V_10 -> V_111 , V_91 , NULL ) ;
F_29 ( V_10 ) ;
F_22 ( F_23 ( V_10 -> V_111 ) , L_3 ,
V_59 ? L_4 : L_5 , V_135 , V_59 ) ;
return V_59 ;
}
...
struct V_1 * V_19 = V_18 -> V_20 ;
struct V_140 * V_141 ;
F_22 ( F_23 ( V_10 -> V_111 ) , L_6 , V_139 ) ;
if ( F_33 ( V_19 -> V_141 ) ||
F_33 ( V_19 -> V_142 ) ||
F_33 ( V_19 -> V_143 ) ||
F_33 ( V_19 -> V_144 ) )
...
V_52 = V_153 |
( 7 << V_154 ) ;
F_6 ( V_52 , V_10 -> V_15 + V_152 ) ;
F_36 ( 1 ) ;
V_52 = F_7 ( V_10 -> V_15 + V_155 ) ;
if ( ! ( V_52 & V_156 ) )
F_37 ( F_23 ( V_10 -> V_111 ) ,
L_7 ) ;
if ( ! ( V_52 & V_157 ) )
F_37 ( F_23 ( V_10 -> V_111 ) ,
L_8 ) ;
...
static void F_38 ( struct V_9 * V_10 , unsigned V_158 )
{
T_1 V_74 ;
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
...
{
F_40 ( V_10 , V_11 ) ;
F_21 ( V_10 , V_10 -> V_169 , V_45 ) ;
F_21 ( V_10 , V_10 -> V_169 , V_46 ) ;
}
...
static void F_42 ( struct V_9 * V_10 , struct V_170 * V_90 )
{
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
...
struct V_119 * V_87 = & V_19 -> V_87 ;
int V_59 ;
if ( F_45 ( V_175 , L_9 , NULL ) )
V_87 -> V_120 = V_122 ;
V_87 -> V_178 = F_46 ( V_175 , L_10 , 0 ) ;
if ( F_47 ( V_87 -> V_178 ) )
V_87 -> V_120 = V_121 ;
F_48 ( V_175 , L_11 , & V_87 -> V_88 ) ;
if ( F_49 ( V_175 , L_12 , NULL ) )
V_87 -> V_179 = false ;
else
V_87 -> V_179 = true ;
if ( F_48 ( V_175 , L_13 , & V_87 -> V_165 ) )
V_87 -> V_165 = 0 ;
F_50 ( V_175 , & V_10 -> V_180 ) ;
if ( ( V_87 -> V_179 ) && F_4 ( V_19 ) &&
! F_33 ( V_19 -> V_142 ) ) {
V_19 -> V_143 = F_51 ( V_19 -> V_141 ,
V_181 ) ;
V_19 -> V_144 = F_51 ( V_19 -> V_141 ,
V_182 ) ;
if ( F_33 ( V_19 -> V_143 ) ||
F_33 ( V_19 -> V_144 ) ) {
F_37 ( F_23 ( V_10 -> V_111 ) ,
...
V_59 = F_52 ( V_10 -> V_111 ) ;
if ( V_59 )
return V_59 ;
if ( ! F_53 ( F_54 ( V_10 -> V_111 ) ) )
V_10 -> V_185 &= ~ V_186 ;
return 0 ;
}
static inline int
...
F_56 ( F_23 ( V_10 -> V_111 ) , L_15 ) ;
return - V_145 ;
}
V_19 -> V_87 = * ( (struct V_119 * )
V_10 -> V_111 -> V_189 -> V_190 ) ;
if ( V_87 -> V_120 == V_121 ) {
V_188 = F_57 ( V_10 -> V_111 , V_87 -> V_178 ) ;
if ( V_188 ) {
F_56 ( F_23 ( V_10 -> V_111 ) ,
L_16 ) ;
return V_188 ;
}
...
switch ( V_87 -> V_193 ) {
case V_194 :
V_188 = F_58 ( V_10 -> V_111 , V_87 -> V_195 , 0 ) ;
if ( V_188 ) {
F_56 ( F_23 ( V_10 -> V_111 ) ,
L_17 ) ;
return V_188 ;
...
int V_188 ;
struct V_1 * V_19 ;
V_10 = F_61 ( V_173 , & V_208 , 0 ) ;
if ( F_33 ( V_10 ) )
return F_62 ( V_10 ) ;
V_18 = F_9 ( V_10 ) ;
V_19 = F_63 ( & V_173 -> V_176 , sizeof( * V_19 ) , V_209 ) ;
if ( ! V_19 ) {
V_188 = - V_210 ;
goto V_211;
}
V_19 -> V_3 = V_206 ? V_206 -> V_2 : (struct V_212 * )
V_173 -> V_213 -> V_214 ;
V_18 -> V_20 = V_19 ;
V_19 -> V_215 = F_64 ( & V_173 -> V_176 , L_18 ) ;
if ( F_33 ( V_19 -> V_215 ) ) {
V_188 = F_62 ( V_19 -> V_215 ) ;
goto V_211;
}
V_19 -> V_216 = F_64 ( & V_173 -> V_176 , L_19 ) ;
if ( F_33 ( V_19 -> V_216 ) ) {
V_188 = F_62 ( V_19 -> V_216 ) ;
goto V_211;
}
V_19 -> V_217 = F_64 ( & V_173 -> V_176 , L_20 ) ;
if ( F_33 ( V_19 -> V_217 ) ) {
V_188 = F_62 ( V_19 -> V_217 ) ;
goto V_211;
}
V_18 -> V_218 = V_19 -> V_217 ;
V_18 -> clock = F_65 ( V_18 -> V_218 ) ;
F_66 ( V_19 -> V_217 ) ;
F_66 ( V_19 -> V_215 ) ;
F_66 ( V_19 -> V_216 ) ;
V_19 -> V_141 = F_67 ( & V_173 -> V_176 ) ;
if ( F_33 ( V_19 -> V_141 ) ) {
V_188 = F_62 ( V_19 -> V_141 ) ;
goto V_219;
}
V_19 -> V_142 = F_51 ( V_19 -> V_141 ,
V_220 ) ;
if ( F_33 ( V_19 -> V_142 ) )
F_37 ( F_23 ( V_10 -> V_111 ) , L_21 ) ;
V_10 -> V_185 |= V_221 ;
if ( V_19 -> V_3 -> V_7 & V_222 )
V_10 -> V_185 |= V_223
| V_224 ;
if ( F_4 ( V_19 ) ) {
F_6 ( 0x10401040 , V_10 -> V_15 + V_225 ) ;
V_10 -> V_183 |= V_226 ;
V_10 -> V_111 -> V_198 |= V_227 ;
...
V_85 | V_86 ,
V_10 -> V_15 + V_84 ) ;
if ( V_19 -> V_3 -> V_7 & V_233 )
V_10 -> V_185 |= V_224 ;
if ( V_19 -> V_3 -> V_7 & V_32 )
V_10 -> V_183 |= V_234 ;
if ( V_206 )
V_188 = F_44 ( V_173 , V_10 , V_19 ) ;
else
...
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
int V_235 = ( F_7 ( V_10 -> V_15 + V_38 ) == 0xffffffff ) ;
F_79 ( & V_173 -> V_176 ) ;
F_80 ( & V_173 -> V_176 ) ;
F_81 ( & V_173 -> V_176 ) ;
F_82 ( V_10 , V_235 ) ;
...
static int F_83 ( struct V_236 * V_176 )
{
...
static int F_87 ( struct V_236 * V_176 )
{
struct V_9 * V_10 = F_84 ( V_176 ) ;
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
