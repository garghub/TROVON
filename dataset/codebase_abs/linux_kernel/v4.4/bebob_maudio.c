...
struct V_36 * V_37 = V_23 -> V_38 ;
V_73 -> V_74 . V_75 . V_76 [ 0 ] = V_37 -> V_32 ;
return 0 ;
}
...
V_69 -> type = V_77 ;
V_69 -> V_78 = 1 ;
V_69 -> V_74 . integer . V_79 = 0 ;
V_69 -> V_74 . integer . V_47 = 1 ;
return 0 ;
}
...
V_5 = F_42 ( V_23 -> V_2 , 0x00 , 0x04 , V_83 ) ;
if ( V_5 < 0 )
F_5 ( & V_23 -> V_2 -> V_4 ,
L_9 , V_5 ) ;
V_5 = 1 ;
...
struct V_36 * V_37 = V_23 -> V_38 ;
F_20 ( & V_23 -> V_56 ) ;
V_73 -> V_74 . V_75 . V_76 [ 0 ] = V_37 -> V_34 ;
F_23 ( & V_23 -> V_56 ) ;
return 0 ;
}
...
static int
F_48 ( struct V_22 * V_23 , T_4 * V_90 , unsigned int V_25 )
{
T_5 * V_24 ;
unsigned int V_46 , V_91 , V_92 ;
int V_5 ;
V_92 = F_32 ( V_93 ) * 2 ;
if ( V_25 < V_92 * sizeof( T_4 ) )
return - V_42 ;
V_24 = F_10 ( V_81 - 4 , V_30 ) ;
if ( V_24 == NULL )
return - V_31 ;
V_5 = F_7 ( V_23 , ( void * ) V_24 , V_81 - 4 ) ;
if ( V_5 < 0 )
goto V_12;
V_46 = 0 ;
for ( V_91 = 2 ; V_91 < V_92 + 2 ; V_91 ++ )
V_90 [ V_46 ++ ] = F_49 ( V_24 [ V_91 ] ) << 16 ;
V_12:
F_11 ( V_24 ) ;
return V_5 ;
}
...
{
const struct V_94 * V_95 = V_23 -> V_95 -> V_96 ;
