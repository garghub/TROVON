...
F_9 ( 1 , V_27 ,
L_16 ,
& V_132 -> V_38 , V_132 -> V_109 -> V_5 -> V_188 ) ;
F_65 ( V_132 ) ;
return;
}
...
F_100 ( V_54 , V_166 ,
V_135 -> V_141 . V_144 ? V_191 : V_183 ,
V_184 |
( V_135 -> V_141 . V_145 ? V_185 : 0 ) |
V_192 |
( V_135 -> V_141 . V_143 ? V_193 : 0 ) ) ;
if ( ( V_189 & ~ V_54 -> V_72 ) & V_165 ) {
F_105 ( F_34 ( V_5 ) , V_99 ) ;
}
V_173:
F_101 ( V_54 ) ;
...
static void F_107 ( struct V_1 * V_194 , struct V_10 * V_9 )
{
struct V_110 * V_111 = (struct V_110 * ) F_86 ( V_194 ) ;
struct V_1 * V_2 ;
struct V_195 * V_196 ;
struct V_197 * V_198 ;
struct V_108 * V_108 = F_34 ( V_194 -> V_5 ) ;
int V_96 ;
int V_199 = F_108 ( sizeof( struct V_197 )
+ ( V_9 -> V_14 << 3 ) ) ;
T_4 V_200 = V_199 + F_109 ( sizeof( struct V_37 ) ) ;
V_2 = F_110 ( V_200 , V_95 ) ;
if ( ! V_2 ) {
V_96 = - V_201 ;
goto V_202;
}
V_196 = F_111 ( V_2 , 0 , 0 , V_203 , V_199 , 0 ) ;
if ( ! V_196 ) {
goto V_204;
}
V_198 = F_112 ( V_196 ) ;
V_198 -> V_205 = V_206 ;
V_198 -> V_207 = V_194 -> V_5 -> V_116 ;
V_198 -> V_208 = V_111 -> V_112 ;
V_198 -> V_209 = V_111 -> V_210 ;
V_198 -> V_211 = V_9 -> V_14 << 3 ;
memcpy ( V_198 + 1 , V_9 , V_9 -> V_14 << 3 ) ;
if ( F_113 ( V_2 , V_212 , & F_43 ( V_194 ) -> V_99 ) )
goto V_204;
F_114 ( V_2 , V_196 ) ;
F_115 ( V_2 , V_108 , 0 , V_213 , NULL , V_95 ) ;
return;
V_204:
F_116 ( V_2 ) ;
V_96 = - V_214 ;
V_202:
F_117 ( V_108 , V_213 , V_96 ) ;
}
static void F_118 ( struct V_1 * V_2 )
{
struct V_215 * V_215 = (struct V_215 * ) F_86 ( V_2 ) ;
...
V_218 = F_123 ( V_215 -> V_141 . V_238 ) ;
#ifdef F_124
V_219 = V_215 -> V_141 . V_239 ;
if ( V_219 == V_240 ||
! V_57 -> V_138 . V_241 )
V_219 = V_242 ;
#endif
V_217 = F_125 ( & F_43 ( V_2 ) -> V_99 , V_2 -> V_5 ) ;
if ( V_217 ) {
V_54 = F_126 ( & V_217 -> V_107 , & F_43 ( V_2 ) -> V_99 ) ;
if ( ! V_54 ) {
F_9 ( 0 , V_96 ,
L_29 ,
V_28 ) ;
...
F_9 ( 3 , V_222 , L_30 ,
V_217 , V_218 , V_2 -> V_5 -> V_188 ) ;
if ( ! V_217 && V_218 ) {
F_9 ( 3 , V_222 , L_31 ) ;
V_217 = F_129 ( & F_43 ( V_2 ) -> V_99 , V_2 -> V_5 , V_219 ) ;
if ( ! V_217 ) {
F_9 ( 0 , V_96 ,
L_32 ,
V_28 ) ;
...
V_217 -> V_243 = ( V_217 -> V_243 & ~ V_244 ) | F_130 ( V_219 ) ;
}
if ( V_217 )
F_131 ( V_217 , V_245 + ( V_246 * V_218 ) ) ;
if ( V_57 -> V_138 . V_247 < 256 &&
V_215 -> V_141 . V_248 ) {
if ( V_57 -> V_138 . V_247 <= V_215 -> V_141 . V_248 ) {
V_57 -> V_138 . V_101 = V_215 -> V_141 . V_248 ;
if ( V_217 )
F_132 ( & V_217 -> V_107 , V_249 ,
V_215 -> V_141 . V_248 ) ;
} else {
F_9 ( 2 , V_27 , L_33 ) ;
}
...
V_236:
if ( V_57 -> V_61 ) {
unsigned long V_250 = F_133 ( V_215 -> V_251 ) ;
if ( V_250 && V_250 / 1000 < V_252 / V_246 ) {
V_250 = ( V_250 * V_246 ) / 1000 ;
if ( V_250 < V_246 / 10 )
V_250 = V_246 / 10 ;
F_134 ( V_57 -> V_61 , V_253 , V_250 ) ;
V_57 -> V_254 = V_245 ;
V_221 = true ;
}
V_250 = F_133 ( V_215 -> V_255 ) ;
if ( V_250 && V_250 / 1000 < V_252 / ( 3 * V_246 ) ) {
V_250 = ( V_250 * V_246 ) / 1000 ;
if ( V_250 < V_246 / 10 )
V_250 = V_246 / 10 ;
if ( V_250 != F_81 ( V_57 -> V_61 , V_256 ) ) {
F_134 ( V_57 -> V_61 ,
V_256 , V_250 ) ;
F_134 ( V_57 -> V_61 ,
V_257 , 3 * V_250 ) ;
V_57 -> V_61 -> V_255 = F_135 ( V_250 ) ;
V_57 -> V_254 = V_245 ;
V_221 = true ;
}
}
...
if ( V_57 -> V_138 . V_241 && V_19 . V_33 ) {
struct V_10 * V_260 ;
for ( V_260 = V_19 . V_33 ;
V_260 ;
V_260 = F_5 ( V_260 , V_19 . V_32 ) ) {
...
! V_57 -> V_138 . V_235 )
continue;
if ( V_262 -> V_263 > V_57 -> V_138 . V_264 )
continue;
F_137 ( V_2 -> V_5 , ( T_1 * ) V_260 , ( V_260 -> V_14 ) << 3 ,
& F_43 ( V_2 ) -> V_99 ) ;
}
}
V_259:
...
#endif
if ( V_57 -> V_138 . V_265 && V_19 . V_266 ) {
struct V_10 * V_260 ;
for ( V_260 = V_19 . V_266 ;
V_260 ;
V_260 = F_5 ( V_260 , V_19 . V_30 ) ) {
F_138 ( V_2 -> V_5 , ( T_1 * ) V_260 ,
( V_260 -> V_14 ) << 3 ,
V_19 . V_171 != NULL ) ;
}
}
if ( V_19 . V_267 && V_57 -> V_138 . V_268 ) {
T_6 V_53 ;
T_2 V_269 ;
memcpy ( & V_53 , ( ( T_1 * ) ( V_19 . V_267 + 1 ) ) + 2 , sizeof( V_269 ) ) ;
V_269 = F_133 ( V_53 ) ;
if ( V_269 < V_270 || V_269 > V_2 -> V_5 -> V_269 ) {
F_9 ( 2 , V_27 , L_38 , V_269 ) ;
} else if ( V_57 -> V_138 . V_271 != V_269 ) {
V_57 -> V_138 . V_271 = V_269 ;
if ( V_217 )
F_132 ( & V_217 -> V_107 , V_272 , V_269 ) ;
F_139 ( V_2 -> V_5 , V_269 ) ;
}
}
if ( V_19 . V_35 ) {
...
for ( V_260 = V_19 . V_35 ;
V_260 ;
V_260 = F_7 ( V_260 , V_19 . V_34 ) ) {
F_107 ( V_2 , V_260 ) ;
}
}
if ( V_19 . V_186 || V_19 . V_273 ) {
F_9 ( 2 , V_27 , L_39 ) ;
}
V_173:
F_127 ( V_217 ) ;
...
T_1 * V_102 ;
struct V_17 V_19 ;
struct V_274 * V_135 = (struct V_274 * ) F_86 ( V_2 ) ;
T_2 V_167 = F_87 ( V_2 ) - ( F_86 ( V_2 ) +
F_88 ( struct V_274 , V_9 ) ) ;
#ifdef F_120
switch ( V_2 -> V_224 ) {
case V_225 :
case V_227 :
...
int V_277 )
{
T_1 * V_9 = F_4 ( V_2 , V_277 ) ;
memset ( V_9 , 0 , 8 ) ;
* ( V_9 ++ ) = V_25 ;
* ( V_9 ++ ) = ( V_277 >> 3 ) ;
V_9 += 6 ;
memcpy ( V_9 , F_43 ( V_276 ) , V_277 - 8 ) ;
}
...
struct V_113 V_114 ;
int V_277 ;
T_1 V_282 [ V_283 ] , * V_71 = NULL ;
int V_115 = F_48 ( V_5 ) ;
bool V_163 ;
if ( F_72 ( V_5 , & V_281 , V_153 ) ) {
F_9 ( 2 , V_27 , L_42 ,
V_5 -> V_188 ) ;
return;
}
if ( ! F_146 ( & F_43 ( V_2 ) -> V_100 , V_146 ) &&
F_119 ( V_146 ) != ( V_284 | V_223 ) ) {
F_9 ( 2 , V_27 ,
L_43 ) ;
return;
}
F_49 ( V_91 , & V_114 , V_275 ,
& V_281 , & F_43 ( V_2 ) -> V_99 , V_115 ) ;
if ( V_115 != V_2 -> V_5 -> V_116 )
V_114 . V_117 |= V_118 ;
...
if ( F_51 ( V_107 ) )
return;
V_217 = (struct V_216 * ) V_107 ;
if ( V_217 -> V_243 & V_285 ) {
F_9 ( 2 , V_27 ,
L_44 ) ;
goto V_286;
}
V_279 = F_151 ( V_108 -> V_92 . V_287 , & F_43 ( V_2 ) -> V_99 , 1 ) ;
V_163 = F_152 ( V_279 , 1 * V_246 ) ;
if ( V_279 )
F_153 ( V_279 ) ;
if ( ! V_163 )
goto V_286;
...
F_68 ( & V_54 -> V_148 ) ;
if ( V_54 -> V_65 & V_81 ) {
memcpy ( V_282 , V_54 -> V_71 , V_5 -> V_7 ) ;
F_70 ( & V_54 -> V_148 ) ;
V_71 = V_282 ;
V_136 += F_3 ( V_5 ) ;
} else
...
V_277 = F_154 (unsigned int,
IPV6_MIN_MTU - sizeof(struct ipv6hdr) - sizeof(*msg) - optlen,
skb->len + 8 ) ;
V_277 &= ~ 0x7 ;
V_136 += V_277 ;
V_280 = F_32 ( V_5 , sizeof( * V_135 ) + V_136 ) ;
if ( ! V_280 )
goto V_286;
V_135 = (struct V_274 * ) F_4 ( V_280 , sizeof( * V_135 ) ) ;
* V_135 = (struct V_274 ) {
. V_141 = {
. V_112 = V_275 ,
} ,
. V_146 = * V_146 ,
. V_288 = F_43 ( V_2 ) -> V_100 ,
} ;
if ( V_71 )
F_1 ( V_280 , V_23 , V_71 ) ;
if ( V_277 )
F_144 ( V_280 , V_2 , V_277 ) ;
F_53 ( V_280 , V_107 ) ;
F_45 ( V_280 , & F_43 ( V_2 ) -> V_99 , & V_281 ) ;
return;
V_286:
F_148 ( V_107 ) ;
}
...
if ( V_135 -> V_141 . V_210 != 0 ) {
F_9 ( 2 , V_27 , L_48 ,
V_135 -> V_141 . V_210 ) ;
return 0 ;
}
memset ( F_95 ( V_2 ) , 0 , sizeof( struct V_291 ) ) ;
...
static int F_162 ( struct V_293 * V_294 , unsigned long V_295 , void * V_296 )
{
struct V_40 * V_5 = F_163 ( V_296 ) ;
struct V_297 * V_298 ;
struct V_108 * V_108 = F_34 ( V_5 ) ;
struct V_56 * V_109 ;
switch ( V_295 ) {
...
{
static char V_310 [ V_311 ] ;
static int V_312 ;
if ( strcmp ( V_310 , V_313 -> V_314 ) && V_312 < 5 ) {
strcpy ( V_310 , V_313 -> V_314 ) ;
F_168 ( L_49 ,
V_310 , V_308 ,
V_309 , V_307 -> V_315 ,
V_309 , V_307 -> V_315 ) ;
...
int F_169 ( struct V_306 * V_307 , int V_316 , void T_7 * V_317 , T_4 * V_318 , T_8 * V_319 )
{
struct V_40 * V_5 = V_307 -> V_320 ;
struct V_56 * V_109 ;
int V_163 ;
if ( ( strcmp ( V_307 -> V_315 , L_50 ) == 0 ) ||
( strcmp ( V_307 -> V_315 , L_51 ) == 0 ) )
F_167 ( V_307 , L_52 , V_5 ? V_5 -> V_188 : L_53 ) ;
if ( strcmp ( V_307 -> V_315 , L_50 ) == 0 )
V_163 = F_170 ( V_307 , V_316 , V_317 , V_318 , V_319 ) ;
else if ( strcmp ( V_307 -> V_315 , L_51 ) == 0 )
V_163 = F_171 ( V_307 , V_316 ,
V_317 , V_318 , V_319 ) ;
else if ( ( strcmp ( V_307 -> V_315 , L_54 ) == 0 ) ||
( strcmp ( V_307 -> V_315 , L_55 ) == 0 ) )
V_163 = F_172 ( V_307 , V_316 ,
V_317 , V_318 , V_319 ) ;
else
V_163 = - 1 ;
if ( V_316 && V_163 == 0 && V_5 && ( V_109 = F_22 ( V_5 ) ) != NULL ) {
if ( V_307 -> V_3 == & F_81 ( V_109 -> V_61 , V_256 ) )
V_109 -> V_61 -> V_255 =
F_135 ( F_81 ( V_109 -> V_61 , V_256 ) ) ;
V_109 -> V_254 = V_245 ;
F_136 ( V_258 , V_109 ) ;
F_25 ( V_109 ) ;
}
