...
V_12 -> V_53 = F_28 ( V_3 ) ;
V_15 -> V_54 = F_3 ( V_12 -> V_35 ) ;
F_29 ( V_15 ) ;
if ( F_30 ( V_12 , V_12 -> V_53 , F_31 ( V_12 -> V_13 ) ,
V_52 -> V_55 , V_52 -> V_56 , V_12 -> V_35 ) < 0 )
goto V_48;
F_32 ( V_12 ) ;
} else
#endif
F_33 ( V_41 , V_12 -> V_57 , V_12 ) ;
return;
V_48:
F_34 ( V_12 ) ;
}
...
if ( V_60 -> V_13 == V_10 || V_60 -> V_13 == V_64 )
V_61 = V_60 -> V_13 ;
else
V_61 = 0 ;
