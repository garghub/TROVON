...
static int F_110 ( struct V_215 * V_216 , void * V_217 )
{
struct V_218 * V_219 = (struct V_218 * ) V_216 -> V_220 ;
unsigned V_221 = * ( int * ) V_219 -> V_222 -> V_217 ;
struct V_223 * V_141 = V_219 -> V_195 -> V_141 ;
struct V_1 * V_6 = V_141 -> V_196 ;
struct V_224 * V_124 = (struct V_224 * ) V_6 -> V_5 . V_3 . V_28 [ V_221 ] . V_225 ;
int V_226 ;
struct V_23 * V_227 = V_6 -> V_5 . V_3 . V_227 ;
F_111 ( & V_227 -> V_228 ) ;
V_226 = F_112 ( V_216 , V_124 ) ;
F_113 ( & V_227 -> V_228 ) ;
if ( V_221 == V_42 )
F_114 ( V_216 , L_21 ,
V_6 -> V_5 . V_3 . V_28 [ V_221 ] . V_16 ,
( V_99 ) F_115 ( & V_6 -> V_229 ) >> 20 ,
( V_99 ) F_115 ( & V_6 -> V_230 ) >> 20 ) ;
return V_226 ;
}
static T_3 F_116 ( struct V_72 * V_231 , char T_4 * V_232 ,
T_5 V_16 , T_6 * V_233 )
{
struct V_1 * V_6 = V_231 -> V_234 -> V_235 ;
T_3 V_236 = 0 ;
int V_11 ;
if ( V_16 & 0x3 || * V_233 & 0x3 )
return - V_50 ;
while ( V_16 ) {
unsigned long V_26 ;
T_1 V_237 ;
if ( * V_233 >= V_6 -> V_39 . V_238 )
return V_236 ;
F_117 ( & V_6 -> V_239 , V_26 ) ;
F_118 ( V_240 , ( ( T_1 ) * V_233 ) | 0x80000000 ) ;
F_118 ( V_241 , * V_233 >> 31 ) ;
V_237 = F_119 ( V_242 ) ;
F_120 ( & V_6 -> V_239 , V_26 ) ;
V_11 = F_121 ( V_237 , ( T_1 * ) V_232 ) ;
if ( V_11 )
return V_11 ;
V_236 += 4 ;
V_232 += 4 ;
...
static T_3 F_122 ( struct V_72 * V_231 , char T_4 * V_232 ,
T_5 V_16 , T_6 * V_233 )
{
struct V_1 * V_6 = V_231 -> V_234 -> V_235 ;
T_3 V_236 = 0 ;
int V_11 ;
while ( V_16 ) {
T_6 V_243 = * V_233 / V_89 ;
unsigned V_244 = * V_233 & ~ V_245 ;
T_5 V_246 = F_123 ( T_5 , V_16 , V_89 - V_244 ) ;
struct V_134 * V_134 ;
void * V_247 ;
if ( V_243 >= V_6 -> V_147 . V_248 )
return V_236 ;
V_134 = V_6 -> V_147 . V_135 [ V_243 ] ;
if ( V_134 ) {
V_247 = F_124 ( V_134 ) ;
V_247 += V_244 ;
V_11 = F_125 ( V_232 , V_247 , V_246 ) ;
F_126 ( V_6 -> V_147 . V_135 [ V_243 ] ) ;
} else
V_11 = F_127 ( V_232 , V_246 ) ;
if ( V_11 )
return - V_160 ;
V_236 += V_246 ;
V_232 += V_246 ;
...
#if F_128 ( V_249 )
unsigned V_250 ;
struct V_251 * V_195 = V_6 -> V_108 -> V_252 ;
struct V_253 * V_254 , * V_255 = V_195 -> V_256 ;
V_254 = F_129 ( L_22 , V_257 | V_258 , V_255 ,
V_6 , & V_259 ) ;
if ( F_130 ( V_254 ) )
return F_131 ( V_254 ) ;
F_132 ( V_254 -> V_260 , V_6 -> V_39 . V_238 ) ;
V_6 -> V_5 . V_261 = V_254 ;
V_254 = F_129 ( L_23 , V_257 | V_258 , V_255 ,
V_6 , & V_262 ) ;
if ( F_130 ( V_254 ) )
return F_131 ( V_254 ) ;
F_132 ( V_254 -> V_260 , V_6 -> V_39 . V_181 ) ;
V_6 -> V_5 . V_113 = V_254 ;
V_250 = F_133 ( V_263 ) ;
#ifdef F_69
if ( ! F_70 () )
