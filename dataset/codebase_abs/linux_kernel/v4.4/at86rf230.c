...
V_62 -> V_72 . F_26 = F_26 ;
V_13 = F_27 ( V_2 -> V_66 , & V_62 -> V_72 ) ;
if ( V_13 )
F_23 ( V_2 , V_62 , V_13 ) ;
}
static void
F_28 ( struct V_1 * V_2 , T_1 V_16 , T_1 V_73 ,
struct V_61 * V_62 ,
void (* F_26)( void * V_60 ) )
{
int V_13 ;
...
static enum V_86 F_31 ( struct V_87 * V_88 )
{
struct V_61 * V_62 =
F_32 ( V_88 , struct V_61 , V_88 ) ;
struct V_1 * V_2 = V_62 -> V_2 ;
F_25 ( V_2 , V_53 , V_62 ,
F_29 ) ;
return V_89 ;
...
switch ( V_62 -> V_77 ) {
case V_64 :
V_93 = F_34 ( 0 , V_91 -> V_95 * V_96 ) ;
V_2 -> V_97 = V_98 + V_99 ;
goto V_100;
case V_101 :
case V_80 :
V_93 = F_34 ( 0 , V_91 -> V_102 * V_96 ) ;
V_2 -> V_97 = V_98 + V_99 ;
goto V_100;
default:
break;
...
case V_80 :
if ( ! V_92 ) {
V_93 = F_34 ( 0 , ( V_91 -> V_103 + V_91 -> V_104 ) *
V_96 ) ;
goto V_100;
}
break;
...
V_62 -> V_85 = V_75 ;
F_28 ( V_2 , V_17 , V_62 -> V_77 , V_62 ,
F_33 ) ;
}
static void
F_20 ( struct V_1 * V_2 ,
struct V_61 * V_62 ,
const T_1 V_82 , void (* F_26)( void * V_60 ) )
{
V_62 -> V_77 = V_82 ;
V_62 -> F_26 = F_26 ;
F_25 ( V_2 , V_53 , V_62 ,
...
{
unsigned long V_13 ;
F_20 ( V_2 , & V_2 -> V_82 , V_82 ,
F_37 ) ;
V_13 = F_39 ( & V_2 -> V_109 ,
F_40 ( 100 ) ) ;
if ( ! V_13 ) {
F_23 ( V_2 , & V_2 -> V_82 , - V_110 ) ;
return - V_110 ;
}
return 0 ;
}
...
static int
F_69 ( struct V_144 * V_65 , struct V_124 * V_125 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
...
static int
F_71 ( struct V_144 * V_65 , T_1 * V_147 )
{
F_72 ( ! V_147 ) ;
* V_147 = 0xbe ;
return 0 ;
...
switch ( V_155 ) {
case - 98 :
V_2 -> V_65 -> V_158 -> V_159 . V_160 = V_161 ;
V_2 -> V_65 -> V_158 -> V_159 . V_162 = F_77 ( V_161 ) ;
V_2 -> V_65 -> V_158 -> V_163 = V_161 [ V_156 ] ;
break;
case - 100 :
V_2 -> V_65 -> V_158 -> V_159 . V_160 = V_164 ;
V_2 -> V_65 -> V_158 -> V_159 . V_162 = F_77 ( V_164 ) ;
V_2 -> V_65 -> V_158 -> V_163 = V_164 [ V_156 ] ;
break;
default:
F_80 ( 1 ) ;
}
...
if ( V_153 == 0 ) {
if ( V_152 == 0 ) {
V_2 -> V_65 -> V_158 -> V_167 = 50 ;
} else {
V_2 -> V_65 -> V_158 -> V_167 = 25 ;
}
} else {
if ( V_152 == 0 )
V_2 -> V_65 -> V_158 -> V_167 = 40 ;
else
V_2 -> V_65 -> V_158 -> V_167 = 16 ;
}
V_2 -> V_65 -> V_158 -> V_168 = V_169 *
V_2 -> V_65 -> V_158 -> V_167 ;
V_2 -> V_65 -> V_158 -> V_170 = V_171 *
V_2 -> V_65 -> V_158 -> V_167 ;
return F_11 ( V_2 , V_154 , V_153 ) ;
}
static int
F_82 ( struct V_144 * V_65 , T_1 V_152 , T_1 V_153 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
int V_13 ;
...
{
T_6 V_183 ;
for ( V_183 = 0 ; V_183 < V_2 -> V_65 -> V_158 -> V_159 . V_189 ; V_183 ++ ) {
if ( V_2 -> V_65 -> V_158 -> V_159 . V_190 [ V_183 ] == V_188 )
...
static int
F_87 ( struct V_144 * V_65 , T_5 V_188 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
return V_2 -> V_4 -> V_194 ( V_2 , V_188 ) ;
}
static int
F_88 ( struct V_144 * V_65 , bool V_195 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
return F_11 ( V_2 , V_196 , V_195 ) ;
}
static int
F_89 ( struct V_144 * V_65 ,
...
static int
F_90 ( struct V_144 * V_65 , T_5 V_188 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
T_6 V_183 ;
for ( V_183 = 0 ; V_183 < V_65 -> V_158 -> V_159 . V_162 ; V_183 ++ ) {
if ( V_65 -> V_158 -> V_159 . V_160 [ V_183 ] == V_188 )
return F_11 ( V_2 , V_157 , V_183 ) ;
}
return - V_192 ;
}
static int
F_91 ( struct V_144 * V_65 , T_1 V_207 , T_1 V_208 ,
T_1 V_209 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
int V_13 ;
...
static int
F_92 ( struct V_144 * V_65 , T_7 V_209 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
return F_11 ( V_2 , V_213 , V_209 ) ;
}
static int
F_93 ( struct V_144 * V_65 , const bool V_195 )
{
struct V_1 * V_2 = V_65 -> V_145 ;
int V_13 ;
if ( V_195 ) {
...
return V_13 ;
if ( V_244 != 0x001f ) {
F_24 ( & V_2 -> V_66 -> V_15 , L_16 ,
V_244 >> 8 , V_244 & 0xFF ) ;
return - V_192 ;
}
V_2 -> V_65 -> V_246 = V_247 |
V_248 |
V_249 | V_250 |
V_251 ;
V_2 -> V_65 -> V_158 -> V_246 = V_252 |
V_253 |
V_254 ;
V_2 -> V_65 -> V_158 -> V_159 . V_255 = F_100 ( V_200 ) |
F_100 ( V_201 ) | F_100 ( V_202 ) ;
V_2 -> V_65 -> V_158 -> V_159 . V_256 = F_100 ( V_204 ) |
F_100 ( V_205 ) ;
V_2 -> V_65 -> V_158 -> V_159 . V_160 = V_257 ;
V_2 -> V_65 -> V_158 -> V_159 . V_162 = F_77 ( V_257 ) ;
V_2 -> V_65 -> V_158 -> V_198 . V_199 = V_200 ;
switch ( V_242 ) {
case 2 :
V_245 = L_17 ;
V_13 = - V_258 ;
...
V_245 = L_18 ;
V_2 -> V_4 = & V_260 ;
V_2 -> V_65 -> V_158 -> V_159 . V_261 [ 0 ] = 0x7FFF800 ;
V_2 -> V_65 -> V_158 -> V_262 = 11 ;
V_2 -> V_65 -> V_158 -> V_167 = 16 ;
V_2 -> V_65 -> V_158 -> V_159 . V_190 = V_263 ;
V_2 -> V_65 -> V_158 -> V_159 . V_189 = F_77 ( V_263 ) ;
break;
case 7 :
V_245 = L_19 ;
V_2 -> V_4 = & V_264 ;
V_2 -> V_65 -> V_246 |= V_265 ;
V_2 -> V_65 -> V_158 -> V_159 . V_261 [ 0 ] = 0x00007FF ;
V_2 -> V_65 -> V_158 -> V_159 . V_261 [ 2 ] = 0x00007FF ;
V_2 -> V_65 -> V_158 -> V_262 = 5 ;
V_2 -> V_65 -> V_158 -> V_167 = 25 ;
V_2 -> V_65 -> V_158 -> V_159 . V_266 = V_267 ;
V_2 -> V_65 -> V_158 -> V_159 . V_190 = V_268 ;
V_2 -> V_65 -> V_158 -> V_159 . V_189 = F_77 ( V_268 ) ;
V_2 -> V_65 -> V_158 -> V_159 . V_160 = V_164 ;
V_2 -> V_65 -> V_158 -> V_159 . V_162 = F_77 ( V_164 ) ;
break;
case 11 :
...
V_2 -> V_4 = & V_269 ;
V_2 -> V_65 -> V_158 -> V_159 . V_261 [ 0 ] = 0x7FFF800 ;
V_2 -> V_65 -> V_158 -> V_262 = 13 ;
V_2 -> V_65 -> V_158 -> V_167 = 16 ;
V_2 -> V_65 -> V_158 -> V_159 . V_190 = V_270 ;
V_2 -> V_65 -> V_158 -> V_159 . V_189 = F_77 ( V_270 ) ;
break;
default:
V_245 = L_21 ;
V_13 = - V_258 ;
...
V_2 -> V_65 -> V_158 -> V_163 = V_2 -> V_65 -> V_158 -> V_159 . V_160 [ 7 ] ;
V_2 -> V_65 -> V_158 -> V_271 = V_2 -> V_65 -> V_158 -> V_159 . V_190 [ 0 ] ;
V_259:
F_101 ( & V_2 -> V_66 -> V_15 , L_22 , V_245 , V_243 ) ;
return V_13 ;
}
static int F_102 ( struct V_272 * V_273 , void * V_274 )
{
struct V_1 * V_2 = V_273 -> V_275 ;
F_103 ( V_273 , L_23 , V_2 -> V_113 . V_115 ) ;
F_103 ( V_273 , L_24 ,
V_2 -> V_113 . V_117 ) ;
F_103 ( V_273 , L_25 ,
V_2 -> V_113 . V_130 ) ;
F_103 ( V_273 , L_26 ,
V_2 -> V_113 . V_119 ) ;
F_103 ( V_273 , L_27 , V_2 -> V_113 . V_121 ) ;
F_103 ( V_273 , L_28 , V_2 -> V_113 . V_123 ) ;
return 0 ;
}
static int F_104 ( struct V_276 * V_276 , struct V_273 * V_273 )
{
return F_105 ( V_273 , F_102 , V_276 -> V_277 ) ;
}
static int F_106 ( struct V_1 * V_2 )
{
char V_278 [ V_279 + 1 ] = L_29 ;
struct V_280 * V_281 ;
strncat ( V_278 , F_107 ( & V_2 -> V_66 -> V_15 ) , V_279 ) ;
V_282 = F_108 ( V_278 , NULL ) ;
if ( ! V_282 )
return - V_283 ;
V_281 = F_109 ( L_30 , V_284 ,
V_282 , V_2 ,
& V_285 ) ;
if ( ! V_281 )
return - V_283 ;
...
V_2 -> V_66 = V_66 ;
V_2 -> V_3 = V_3 ;
V_65 -> V_290 = & V_66 -> V_15 ;
F_115 ( & V_65 -> V_158 -> V_291 ) ;
V_2 -> V_10 = F_116 ( V_66 , & V_292 ) ;
if ( F_117 ( V_2 -> V_10 ) ) {
V_13 = F_118 ( V_2 -> V_10 ) ;
F_24 ( & V_66 -> V_15 , L_35 ,
V_13 ) ;
...
if ( V_13 )
goto V_293;
V_13 = F_10 ( V_2 , V_55 , 0xff , 0 , & V_286 ) ;
if ( V_13 )
goto V_293;
V_217 = F_95 ( V_66 -> V_134 ) ;
if ( ! V_217 )
V_217 = V_294 ;
V_13 = F_121 ( & V_66 -> V_15 , V_66 -> V_134 , F_62 ,
V_295 | V_217 , F_107 ( & V_66 -> V_15 ) , V_2 ) ;
if ( V_13 )
goto V_293;
F_75 ( V_66 -> V_134 ) ;
F_1 ( V_2 ) ;
...
static int F_124 ( struct V_234 * V_66 )
{
struct V_1 * V_2 = F_125 ( V_66 ) ;
F_11 ( V_2 , V_226 , 0 ) ;
F_126 ( V_2 -> V_65 ) ;
F_123 ( V_2 -> V_65 ) ;
F_110 () ;
F_127 ( & V_66 -> V_15 , L_36 ) ;
return 0 ;
}
