...
V_24 = V_2 -> V_32 ;
V_25 = V_2 -> V_33 ;
V_31 = F_3 ( F_17 ( V_25 ) * sizeof( long ) ,
V_8 ) ;
if ( ! V_31 ) {
V_11 = - V_9 ;
goto V_34;
...
if ( F_24 ( V_2 , V_38 -> V_14 , V_40 , V_37 ) ) {
F_19 ( V_38 -> V_14 ) ;
goto V_43;
}
V_38 -> V_12 = V_38 -> V_14 ;
...
static int F_26 ( struct V_1 * V_2 , unsigned int V_44 ,
unsigned int V_45 )
{
struct V_4 * * V_24 ;
unsigned int V_46 ;
...
V_24 = V_2 -> V_32 ;
V_26 = V_44 ;
F_27 (i, lzo_blocks[0]->sync_bmp,
lzo_blocks[0]->sync_bmp_nbits) {
if ( V_26 > V_45 )
continue;
V_11 = F_28 ( V_2 , V_26 , & V_46 ) ;
if ( V_11 )
return V_11 ;
V_11 = F_29 ( V_2 , V_26 ) ;
