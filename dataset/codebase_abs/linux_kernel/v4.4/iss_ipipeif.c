...
struct V_1 * V_2 = F_32 ( V_107 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_151 -> V_132 | F_50 ( V_152 -> V_114 ) ) {
case V_36 | V_154 :
if ( ! ( V_153 & V_155 ) ) {
V_2 -> V_34 = V_156 ;
break;
...
if ( V_2 -> V_34 != V_156 )
return - V_157 ;
if ( V_152 -> V_114 == & V_4 -> V_158 . V_122 . V_114 )
V_2 -> V_34 = V_159 ;
else if ( V_152 -> V_114 == & V_4 -> V_160 . V_122 . V_114 )
V_2 -> V_34 = V_161 ;
break;
case V_87 | V_162 :
if ( V_153 & V_155 ) {
...
struct V_150 * V_164 = V_2 -> V_164 ;
struct V_149 * V_165 = & V_107 -> V_114 ;
int V_108 ;
V_2 -> V_34 = V_156 ;
F_52 ( V_107 , & V_166 ) ;
V_107 -> V_167 = & V_168 ;
F_53 ( V_107 -> V_169 , L_3 , sizeof( V_107 -> V_169 ) ) ;
V_107 -> V_170 = 1 << 16 ;
F_54 ( V_107 , V_2 ) ;
V_107 -> V_153 |= V_171 ;
V_164 [ V_36 ] . V_153 = V_172 ;
V_164 [ V_87 ] . V_153 = V_173 ;
V_164 [ V_126 ] . V_153 = V_173 ;
V_165 -> V_174 = & V_175 ;
V_108 = F_55 ( V_165 , V_176 , V_164 , 0 ) ;
if ( V_108 < 0 )
return V_108 ;
F_47 ( V_107 , NULL ) ;
V_2 -> V_89 . type = V_177 ;
V_2 -> V_89 . V_174 = & V_178 ;
V_2 -> V_89 . V_4 = F_2 ( V_2 ) ;
V_2 -> V_89 . V_179 = F_56 ( 4096 * 4096 ) * 3 ;
V_2 -> V_89 . V_180 = 32 ;
V_2 -> V_89 . V_181 = 1 ;
V_2 -> V_89 . V_182 = 0x1ffe0 ;
V_108 = F_57 ( & V_2 -> V_89 , L_4 ) ;
if ( V_108 < 0 )
return V_108 ;
V_108 = F_58 ( & V_2 -> V_122 . V_114 ,
V_87 ,
...
{
int V_108 ;
V_108 = F_63 ( V_184 , & V_2 -> V_122 ) ;
if ( V_108 < 0 )
goto error;
V_108 = F_64 ( & V_2 -> V_89 , V_184 ) ;
if ( V_108 < 0 )
goto error;
return 0 ;
error:
