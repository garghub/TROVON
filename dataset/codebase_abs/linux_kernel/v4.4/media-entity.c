...
if ( V_2 -> V_42 > 1 )
continue;
if ( ! V_2 -> V_43 || ! V_2 -> V_43 -> V_44 )
continue;
F_10 ( V_39 , V_2 -> V_3 ) ;
F_19 ( V_41 , V_2 -> V_3 ) ;
for ( V_10 = 0 ; V_10 < V_2 -> V_14 ; V_10 ++ ) {
struct V_7 * V_17 = & V_2 -> V_8 [ V_10 ] ;
struct V_4 * V_45 = V_17 -> V_19 -> V_2 == V_2
? V_17 -> V_19 : V_17 -> V_18 ;
F_20 ( V_41 , V_45 -> V_16 , 1 ) ;
if ( ! ( V_45 -> V_29 & V_46 ) ||
V_17 -> V_29 & V_30 )
F_21 ( V_39 , V_45 -> V_16 , 1 ) ;
if ( V_17 -> V_19 != V_45 ||
! ( V_17 -> V_29 & V_30 ) )
continue;
V_37 = V_2 -> V_43 -> V_44 ( V_17 ) ;
if ( V_37 < 0 && V_37 != - V_47 ) {
F_22 ( V_2 -> V_35 -> V_48 ,
L_1 ,
V_17 -> V_18 -> V_2 -> V_49 ,
V_17 -> V_18 -> V_16 ,
V_2 -> V_49 , V_17 -> V_19 -> V_16 , V_37 ) ;
goto error;
}
}
F_23 ( V_39 , V_39 , V_41 , V_2 -> V_3 ) ;
...
int
F_34 ( struct V_1 * V_18 , T_1 V_54 ,
struct V_1 * V_19 , T_1 V_55 , T_3 V_29 )
{
struct V_7 * V_17 ;
struct V_7 * V_56 ;
...
if ( V_17 == NULL )
return - V_12 ;
V_17 -> V_18 = & V_18 -> V_5 [ V_54 ] ;
V_17 -> V_19 = & V_19 -> V_5 [ V_55 ] ;
V_17 -> V_29 = V_29 ;
V_56 = F_32 ( V_19 ) ;
if ( V_56 == NULL ) {
V_18 -> V_14 -- ;
...
V_56 -> V_18 = & V_18 -> V_5 [ V_54 ] ;
V_56 -> V_19 = & V_19 -> V_5 [ V_55 ] ;
V_56 -> V_29 = V_29 ;
V_17 -> V_53 = V_56 ;
V_56 -> V_53 = V_17 ;
V_19 -> V_15 ++ ;
...
V_57 = V_17 -> V_18 -> V_2 ;
while ( V_58 < V_57 -> V_14 ) {
struct V_7 * V_59 = & V_57 -> V_8 [ V_58 ] ;
if ( V_59 != V_17 -> V_53 ) {
V_58 ++ ;
continue;
}
...
{
int V_37 ;
V_37 = F_39 ( V_17 -> V_18 -> V_2 , V_60 ,
V_17 -> V_18 , V_17 -> V_19 , V_29 ) ;
if ( V_37 < 0 && V_37 != - V_47 )
return V_37 ;
V_37 = F_39 ( V_17 -> V_19 -> V_2 , V_60 ,
V_17 -> V_19 , V_17 -> V_18 , V_29 ) ;
if ( V_37 < 0 && V_37 != - V_47 ) {
F_39 ( V_17 -> V_18 -> V_2 , V_60 ,
V_17 -> V_18 , V_17 -> V_19 , V_17 -> V_29 ) ;
return V_37 ;
}
V_17 -> V_29 = V_29 ;
V_17 -> V_53 -> V_29 = V_17 -> V_29 ;
return 0 ;
}
...
if ( V_17 == NULL )
return - V_63 ;
if ( ( V_17 -> V_29 & ~ V_61 ) != ( V_29 & ~ V_61 ) )
return - V_63 ;
if ( V_17 -> V_29 & V_64 )
return V_17 -> V_29 == V_29 ? 0 : - V_63 ;
if ( V_17 -> V_29 == V_29 )
return 0 ;
V_18 = V_17 -> V_18 -> V_2 ;
V_19 = V_17 -> V_19 -> V_2 ;
...
struct V_4 * F_43 ( struct V_4 * V_45 )
{
unsigned int V_10 ;
for ( V_10 = 0 ; V_10 < V_45 -> V_2 -> V_14 ; V_10 ++ ) {
struct V_7 * V_17 = & V_45 -> V_2 -> V_8 [ V_10 ] ;
if ( ! ( V_17 -> V_29 & V_30 ) )
continue;
if ( V_17 -> V_18 == V_45 )
return V_17 -> V_19 ;
