...
static T_1 F_60 ( struct V_9 * V_10 ,
struct V_11 * V_12 ,
char * V_13 )
{
struct V_2 * V_3 = F_26 ( V_10 ) ;
...
F_63 ( V_3 ) ;
F_67 ( V_3 -> V_142 ) ;
F_68 ( & V_143 , V_3 -> V_144 ) ;
F_47 ( V_3 ) ;
}
struct V_2 * F_69 ( int V_145 )
{
struct V_2 * V_10 ;
T_5 V_146 ;
V_146 = sizeof( struct V_2 ) ;
if ( V_145 ) {
V_146 = F_70 ( V_146 , V_147 ) ;
V_146 += V_145 ;
}
V_146 += V_147 - 1 ;
V_10 = F_50 ( V_146 , V_92 ) ;
if ( V_10 ) {
V_10 -> V_10 . V_137 = V_10 -> V_137 ;
V_10 -> V_10 . type = & V_148 ;
V_10 -> V_10 . V_149 = & V_15 ;
F_71 ( & V_10 -> V_10 ) ;
F_72 ( & V_10 -> V_10 , ( void * ) V_10 ) ;
F_73 ( & V_10 -> V_150 ) ;
F_73 ( & V_10 -> V_151 ) ;
F_74 ( & V_10 -> V_122 ) ;
V_10 -> V_144 = F_75 ( & V_143 , 0 , 0 , V_92 ) ;
if ( V_10 -> V_144 < 0 ) {
F_6 ( L_29 ) ;
F_47 ( V_10 ) ;
return NULL ;
}
F_76 ( & V_10 -> V_10 , L_30 , V_10 -> V_144 ) ;
F_74 ( & V_10 -> V_152 ) ;
}
return V_10 ;
}
void F_77 ( struct V_2 * V_10 )
{
if ( V_10 )
F_78 ( & V_10 -> V_10 ) ;
}
static void F_79 ( struct V_9 * V_10 , void * V_153 )
{
F_77 ( * (struct V_2 * * ) V_153 ) ;
}
static int F_80 ( struct V_9 * V_10 , void * V_153 , void * V_154 )
{
...
struct V_2 * F_82 ( struct V_9 * V_10 , int V_145 )
{
struct V_2 * * V_156 , * V_2 ;
V_156 = F_83 ( F_79 , sizeof( * V_156 ) ,
V_92 ) ;
if ( ! V_156 )
return NULL ;
V_2 = F_69 ( V_145 ) ;
...
void F_86 ( struct V_9 * V_10 , struct V_2 * V_2 )
{
int V_157 ;
V_157 = F_87 ( V_10 , F_79 ,
F_80 , V_2 ) ;
F_81 ( V_157 ) ;
}
static int F_88 ( struct V_158 * V_158 , struct V_21 * V_159 )
{
struct V_2 * V_3 = F_89 ( V_158 -> V_160 ,
struct V_2 , V_161 ) ;
if ( F_90 ( V_162 , & V_3 -> V_163 ) )
return - V_116 ;
F_91 ( V_3 ) ;
V_159 -> V_25 = V_3 ;
return 0 ;
}
static int F_92 ( struct V_158 * V_158 , struct V_21 * V_159 )
{
struct V_2 * V_3 = F_89 ( V_158 -> V_160 ,
struct V_2 , V_161 ) ;
F_93 ( V_162 , & V_3 -> V_163 ) ;
F_94 ( V_3 ) ;
return 0 ;
}
static long F_95 ( struct V_21 * V_159 , unsigned int V_164 , unsigned long V_165 )
{
...
if ( V_167 < 0 )
return V_167 ;
if ( F_97 ( V_166 , & V_167 , sizeof( V_167 ) ) )
return - V_34 ;
return 0 ;
}
return - V_35 ;
...
if ( V_14 < 0 )
return V_14 ;
V_3 -> V_10 . V_173 = F_100 ( F_101 ( V_17 ) , V_3 -> V_144 ) ;
V_14 = F_21 ( V_3 ) ;
if ( V_14 ) {
F_14 ( V_3 -> V_10 . V_31 ,
L_32 ) ;
...
static void F_117 ( struct V_9 * V_10 , void * V_153 )
{
F_110 ( * (struct V_2 * * ) V_153 ) ;
}
int F_118 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
struct V_2 * * V_156 ;
int V_14 ;
V_156 = F_83 ( F_117 , sizeof( * V_156 ) , V_92 ) ;
if ( ! V_156 )
return - V_40 ;
* V_156 = V_3 ;
V_14 = F_99 ( V_3 ) ;
...
void F_119 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
int V_157 ;
V_157 = F_87 ( V_10 , F_117 ,
F_80 , V_3 ) ;
F_81 ( V_157 ) ;
}
