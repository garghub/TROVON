...
{
F_9 ( L_11 , V_27 , V_66 -> V_67 , V_66 -> V_68 ) ;
F_42 ( V_65 -> V_69 ) ;
}
static void F_43 ( int V_27 , struct V_64 * V_65 )
{
...
static void F_49 ( int V_27 , struct V_64 * V_65 , int V_62 )
{
if ( V_62 ) {
int V_77 ;
int V_78 = 0 ;
...
static void F_57 ( int V_27 , int V_62 , struct V_64 * V_65 )
{
if ( V_62 ) {
F_58 ( L_22 , V_27 ) ;
F_59 ( V_65 ) ;
...
static inline void F_57 ( int V_27 , int V_62 , struct V_64 * V_65 )
{
if ( V_62 )
F_62 ( L_26 ) ;
F_15 ( & V_83 , 1 ) ;
...
static void F_64 ( int V_27 , struct V_64 * V_65 , int V_62 )
{
if ( V_62 ) {
int V_86 = F_63 () ;
int V_87 ;
...
static inline void F_64 ( int V_27 , struct V_64 * V_65 , int V_62 )
{
F_62 ( L_30 ) ;
}
int F_67 ( unsigned int V_86 , struct V_64 * V_65 )
{
struct V_23 * V_24 = V_41 ;
int V_27 = F_17 () ;
int V_62 = 0 ;
...
static int F_70 ( unsigned int V_86 , struct V_64 * V_65 )
{
int V_87 ;
F_19 ( V_36 . V_37 ) ;
if ( ! F_51 ( V_36 . V_42 ) ) {
...
{
if ( F_72 ( V_97 , F_67 , 0 , L_33 ) )
F_73 ( L_34 ) ;
if ( F_72 ( V_98 , F_70 , 0 , L_35 ) )
F_73 ( L_36 ) ;
}
void F_74 ( void )
{
unsigned int V_99 ;
V_99 = F_75 ( V_100 ) | V_46 ;
V_99 &= ~ V_101 ;
F_76 ( V_100 , V_99 ) ;
}
void F_77 ( void )
...
V_104 = F_81 ( V_27 ) ;
if ( V_105 [ V_104 ] == NULL ) {
V_105 [ V_104 ] = F_82 ( V_102 ,
V_106 , V_104 ) ;
F_79 ( ! V_105 [ V_104 ] ) ;
F_83 ( & ( V_105 [ V_104 ] -> V_38 ) ) ;
F_15 ( & V_105 [ V_104 ] -> V_30 , - 1 ) ;
}
F_84 ( V_27 ) = V_105 [ V_104 ] ;
}
F_79 ( ! F_85 ( & V_45 , V_106 ) ) ;
F_71 () ;
}
