...
( V_59 . V_80 == V_81 ||
V_59 . V_80 == V_82 ) ||
( F_137 ( V_9 ) && F_127 ( & V_59 ) ) ) ) {
if ( V_168 || F_138 ( V_11 ) ) {
if ( V_169 == V_43 )
F_139 ( V_11 , V_169 ) ;
error = F_140 ( V_11 , V_40 , V_41 ,
& V_59 , V_67 ) ;
if ( error )
return error ;
V_170 = 1 ;
...
V_170 = 1 ;
error = F_141 ( V_11 , V_40 , V_41 , & V_59 ) ;
if ( error )
goto V_171;
F_21 ( V_11 , V_169 ) ;
}
...
int V_167 )
{
return F_135 ( V_9 , V_164 , V_162 , V_167 , false , false ) ;
}
int
F_149 (
struct V_9 * V_9 ,
...
int V_167 )
{
return F_135 ( V_9 , V_164 , V_162 , V_167 , true , false ) ;
}
int
F_150 (
struct V_9 * V_9 ,
...
int V_167 )
{
return F_135 ( V_9 , V_164 , V_162 , V_167 , true , true ) ;
}
static void
F_151 (
struct V_9 * V_9 ,
...
void * V_176 )
{
struct V_9 * V_9 = F_156 ( V_175 -> V_177 ) ;
struct V_25 * V_18 = V_176 ;
F_157 ( F_6 ( V_9 ) , V_40 , V_41 ,
V_18 ? V_18 -> V_46 : 0 , NULL ) ;
if ( ! V_18 ) {
ASSERT ( V_40 + V_41 <= F_116 ( V_9 ) ) ;
return;
}
F_151 ( V_9 , V_18 , V_40 , V_41 ) ;
}
static inline T_6
F_158 (
struct V_9 * V_9 ,
...
struct V_8 * V_180 ;
if ( F_137 ( V_9 ) )
return F_160 ( V_175 , V_9 , V_179 , V_40 ,
F_149 , F_159 , 0 ) ;
V_180 = F_5 ( V_9 ) ;
return F_161 ( V_175 , V_9 , V_180 , V_179 , V_40 ,
F_149 , F_159 , NULL , V_152 ) ;
}
STATIC T_6
F_162 (
struct V_174 * V_175 ,
...
if ( F_163 ( V_179 ) == V_94 )
return F_158 ( V_9 , V_175 , V_179 , V_40 ,
F_155 , V_182 ) ;
return F_158 ( V_9 , V_175 , V_179 , V_40 , NULL , 0 ) ;
}
STATIC void
F_164 (
struct V_9 * V_9 ,
...
int V_194 ;
ASSERT ( V_125 <= V_131 ) ;
V_1 = F_171 ( V_119 , V_128 , V_152 ) ;
if ( ! V_1 )
return - V_195 ;
V_194 = F_172 ( V_1 , V_185 , V_125 , F_148 ) ;
if ( F_173 ( V_194 ) ) {
struct V_9 * V_9 = V_119 -> V_141 ;
T_3 V_42 = F_116 ( V_9 ) ;
F_165 ( V_9 , V_1 , V_185 , V_125 ) ;
F_71 ( V_1 ) ;
if ( V_185 + V_125 > V_42 ) {
T_6 V_183 = F_174 ( T_6 , V_185 , V_42 ) ;
F_175 ( V_9 , V_183 , V_185 + V_125 ) ;
}
F_176 ( V_1 ) ;
V_1 = NULL ;
}
...
int V_197 ;
ASSERT ( V_125 <= V_131 ) ;
V_197 = F_178 ( V_191 , V_119 , V_185 , V_125 , V_196 , V_1 , V_193 ) ;
if ( F_173 ( V_197 < V_125 ) ) {
struct V_9 * V_9 = V_119 -> V_141 ;
T_3 V_42 = F_116 ( V_9 ) ;
...
if ( V_185 > V_42 )
V_42 = V_185 ;
F_164 ( V_9 , V_42 , V_190 ) ;
F_175 ( V_9 , V_42 , V_190 ) ;
}
}
return V_197 ;
}
...
F_181 ( V_119 ) ;
F_21 ( V_11 , V_199 ) ;
return F_182 ( V_119 , V_198 , F_148 ) ;
}
STATIC int
F_183 (
struct V_191 * V_200 ,
...
unsigned V_202 )
{
return F_186 ( V_119 , V_139 , V_202 , F_148 ) ;
}
STATIC int
F_187 (
struct V_1 * V_1 )
...
if ( V_203 ) {
unsigned long V_152 ;
F_191 ( & V_119 -> V_207 , V_152 ) ;
if ( V_1 -> V_119 ) {
F_115 ( ! F_98 ( V_1 ) ) ;
F_192 ( V_1 , V_119 , V_205 ) ;
F_193 ( & V_119 -> V_208 ,
F_194 ( V_1 ) , V_209 ) ;
}
