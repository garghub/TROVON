...
struct V_1 * V_2 ;
int V_64 = - V_70 ;
V_58 = F_14 ( & V_67 -> V_71 , sizeof( struct V_1 ) ) ;
if ( ! V_58 )
return - V_72 ;
V_2 = F_9 ( V_58 ) ;
F_15 ( V_67 , V_58 ) ;
V_69 = F_16 ( V_67 , V_73 , 0 ) ;
if ( V_69 == NULL ) {
F_17 ( & V_67 -> V_71 , L_1 ) ;
V_64 = - V_74 ;
goto V_75;
}
if ( ! F_18 ( & V_67 -> V_71 , V_69 -> V_76 ,
F_19 ( V_69 ) , V_69 -> V_77 ) ) {
F_17 ( & V_67 -> V_71 , L_2 ) ;
goto V_75;
}
V_2 -> V_7 = ( V_6 ) F_20 ( & V_67 -> V_71 , V_69 -> V_76 ,
F_19 ( V_69 ) ) ;
V_58 -> V_78 = 4 ;
V_58 -> V_79 = V_31 |
V_32 |
...
V_58 -> V_81 = F_21 ( 8 ) ;
V_58 -> V_82 = V_83 ;
V_58 -> V_71 . V_84 = V_67 -> V_71 . V_84 ;
V_64 = F_22 ( & V_67 -> V_71 , V_58 ) ;
if ( V_64 ) {
F_17 ( & V_67 -> V_71 , L_3 , V_64 ) ;
goto V_75;
}
F_23 ( & V_67 -> V_71 , L_4 ) ;
return 0 ;
