...
static int F_210 ( struct V_223 * V_323 ,
T_8 V_324 , void * V_325 )
{
...
struct V_3 * V_4 ;
int V_328 ;
if ( V_327 -> V_329 . V_330 != V_331 )
return V_231 ;
V_4 = F_211 ( & V_332 , V_327 -> V_333 ) ;
if ( ! V_4 )
return V_231 ;
V_2 = F_209 ( V_4 ) ;
F_24 ( V_4 ) ;
...
return V_231 ;
V_47 = F_2 ( V_2 ) ;
if ( V_327 -> V_334 & V_335 )
V_328 = F_212 ( V_327 -> V_329 . V_290 ) - 1 ;
else
V_328 = V_327 -> V_329 . V_290 ;
if ( V_328 < 0 )
return V_231 ;
if ( V_327 -> V_329 . V_289 == V_42 ||
V_327 -> V_329 . V_289 == V_38 )
V_47 -> V_290 = V_328 ;
if ( V_327 -> V_329 . V_289 == V_38 )
V_2 -> V_290 = V_328 ;
return V_231 ;
}
static int F_213 ( struct V_223 * V_323 ,
T_8 V_324 , void * V_325 )
{
struct V_45 * V_56 ;
struct V_77 * V_76 = NULL ;
struct V_3 * V_4 = F_214 ( V_325 ) ;
struct V_5 * V_47 ;
struct V_1 * V_2 ;
struct V_72 * V_73 ;
struct V_268 * V_262 ;
...
static void V_199 ( struct V_357 * V_358 )
{
struct V_45 * V_56 ;
struct V_5 * V_47 ;
struct V_72 * V_73 ;
...
struct V_191 * V_117 ;
struct V_191 * V_361 ;
V_73 = F_35 ( V_358 , struct V_72 , V_198 ) ;
V_190 = V_73 -> V_76 -> V_66 ;
V_360 = F_227 ( V_190 ) ;
F_228 ( V_190 -> V_362 , V_18 ) ;
F_229 (vport, next_vport, &fc_host->vports, peers) {
if ( V_117 -> V_18 & ( V_363 | V_364 ) ) {
continue;
} else {
V_117 -> V_18 |= V_365 ;
F_216 ( F_230 ( V_190 ) ,
...
V_334 = V_4 -> V_370 -> V_371 ( V_4 ) ;
if ( V_334 & V_372 ) {
V_329 . V_330 = V_373 ;
V_368 = F_236 ( V_4 , & V_329 ) ;
V_329 . V_289 = V_42 ;
V_367 = F_236 ( V_4 , & V_329 ) ;
} else {
V_329 . V_330 = V_331 ;
V_368 = F_237 ( V_4 , & V_329 ) ;
V_329 . V_289 = V_42 ;
V_367 = F_237 ( V_4 , & V_329 ) ;
}
V_2 -> V_290 = F_212 ( V_368 ) ? F_212 ( V_368 ) - 1 : 0 ;
V_47 -> V_290 = F_212 ( V_367 ) ? F_212 ( V_367 ) - 1 : V_2 -> V_290 ;
}
#endif
}
...
{
return F_238 ( V_4 , V_44 , V_380 ) ;
}
static int F_243 ( struct V_3 * V_4 )
{
return F_238 ( V_4 , V_381 ,
V_382 ) ;
}
...
unsigned int V_208 ;
F_245 (cpu) {
V_383 = & F_116 ( V_213 , V_208 ) ;
if ( ! V_383 -> V_212 || ! F_246 ( V_208 ) )
continue;
V_68 = F_247 ( 0 ) ;
if ( ! V_68 )
continue;
V_68 -> V_312 = F_180 ;
F_123 ( & V_383 -> V_215 . V_216 ) ;
F_129 ( & V_383 -> V_215 , V_68 ) ;
if ( V_383 -> V_215 . V_75 == 1 )
F_122 ( V_383 -> V_212 ) ;
F_124 ( & V_383 -> V_215 . V_216 ) ;
F_248 ( & V_303 ) ;
}
}
...
static void F_262 ( struct V_388 * V_389 , struct V_153 * V_154 , void * V_316 )
{
struct V_5 * V_6 = V_316 ;
struct V_390 * V_391 = F_263 ( V_389 ) ;
struct V_77 * V_76 = V_391 -> V_65 ;
T_1 * V_392 ;
if ( F_120 ( V_154 ) )
goto V_393;
V_392 = F_264 ( V_154 ) -> V_394 ;
if ( F_42 ( V_392 ) )
F_265 ( V_6 , V_76 , V_154 ) ;
if ( ! F_42 ( V_392 ) )
V_60 ( V_76 , V_392 ) ;
V_393:
F_266 ( V_389 , V_154 , V_76 ) ;
}
static void F_267 ( struct V_388 * V_389 , struct V_153 * V_154 , void * V_316 )
{
struct V_77 * V_76 = V_316 ;
static T_1 V_395 [ V_11 ] = { 0 } ;
if ( ! F_120 ( V_154 ) )
V_60 ( V_76 , V_395 ) ;
F_268 ( V_389 , V_154 , V_76 ) ;
}
static struct V_388 * F_269 ( struct V_77 * V_76 , T_2 V_396 ,
struct V_153 * V_154 , unsigned int V_397 ,
void (* F_270)( struct V_388 * ,
struct V_153 * ,
void * ) ,
void * V_316 , T_2 V_398 )
{
struct V_72 * V_73 = F_41 ( V_76 ) ;
struct V_1 * V_2 = V_73 -> V_78 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
if ( V_76 -> V_401 )
break;
return F_271 ( V_76 , V_396 , V_154 , V_397 , F_262 ,
V_6 , V_398 ) ;
case V_307 :
if ( F_148 ( V_156 -> V_253 ) != V_309 )
break;
return F_271 ( V_76 , V_396 , V_154 , V_397 , F_267 ,
V_76 , V_398 ) ;
}
return F_271 ( V_76 , V_396 , V_154 , V_397 , F_270 , V_316 , V_398 ) ;
}
static int F_272 ( struct V_191 * V_117 , bool V_402 )
{
...
V_121 = F_273 ( V_117 ) ;
if ( V_121 ) {
F_274 ( V_117 -> V_202 , V_404 , sizeof( V_404 ) ) ;
F_65 ( V_177 L_65
L_66 ,
V_404 ) ;
return V_121 ;
...
static int F_278 ( struct V_191 * V_117 , bool V_407 )
{
struct V_77 * V_76 = V_117 -> V_406 ;
if ( V_407 ) {
F_275 ( V_117 , V_405 ) ;
F_87 ( V_76 ) ;
} else {
...
if ( ! V_154 )
return;
V_76 -> V_412 . V_413 ( V_76 , V_414 , V_154 , V_415 ,
NULL , NULL , 3 * V_76 -> V_85 ) ;
}
static void F_282 ( struct V_416 * V_417 )
{
struct V_45 * V_46 =
F_283 ( V_417 ) ;
struct V_5 * V_47 = F_18 ( V_46 ) ;
struct V_1 * V_2 = F_19 ( V_47 ) ;
V_417 -> V_418 = F_177 ( V_2 -> V_4 ) ;
}
static void F_284 ( struct V_77 * V_76 ,
T_2 V_419 , struct V_153 * V_154 )
{
struct V_72 * V_73 = F_41 ( V_76 ) ;
struct V_1 * V_2 = V_73 -> V_78 ;
struct V_5 * V_47 = F_2 ( V_2 ) ;
if ( V_154 && F_184 ( V_154 ) == V_399 )
