...
if ( V_7 -> V_4 )
F_25 ( V_9 , V_7 -> V_4 , & V_7 -> V_17 -> V_18 ) ;
F_26 ( V_2 ) ;
return 0 ;
}
...
static int F_37 ( struct V_59 * V_60 , void * V_61 )
{
struct V_62 * V_63 = (struct V_62 * ) V_60 -> V_64 ;
struct V_65 * V_13 = V_63 -> V_66 -> V_13 ;
struct V_8 * V_9 = V_13 -> V_67 ;
F_38 ( & V_9 -> V_11 , V_60 ) ;
return 0 ;
}
