...
int F_122 ( struct V_1 * V_2 , struct V_175 * V_176 , int V_288 , int * V_105 )
{
if ( V_2 -> V_308 == V_114 )
return F_123 ( V_2 , V_176 , V_288 , V_105 ) ;
#if F_124 ( V_309 )
if ( V_2 -> V_308 == V_310 )
return V_311 . V_312 ( V_2 , V_176 , V_288 , V_105 ) ;
#endif
return - V_28 ;
}
static int F_125 ( struct V_252 * V_253 , int V_261 )
{
T_6 V_313 = F_17 ( V_253 -> V_288 - V_261 ) ;
...
if ( V_253 -> V_280 )
F_126 ( V_253 , V_261 ) ;
F_127 ( & V_260 -> V_315 , V_260 -> V_289 , V_313 ) ;
V_260 -> V_289 = V_313 ;
F_24 () ;
V_64 = F_93 ( V_282 [ V_49 ] ) ;
if ( F_7 ( ! V_64 || ! V_64 -> V_283 . V_316 ) )
goto V_298;
V_27 = V_64 -> V_283 . V_316 ( V_253 , V_261 + sizeof( * V_260 ) ) ;
V_298:
F_27 () ;
return V_27 ;
}
int F_128 ( struct V_1 * * V_2 , unsigned short V_317 ,
unsigned short type , unsigned char V_45 ,
struct V_44 * V_44 )
{
struct V_24 * V_1 ;
int V_318 = F_129 ( V_44 , V_317 , type , V_45 , & V_1 ) ;
if ( V_318 == 0 ) {
* V_2 = V_1 -> V_2 ;
( * V_2 ) -> V_319 = V_320 ;
( * V_2 ) -> V_20 -> V_321 ( * V_2 ) ;
...
T_7 F_130 ( void T_8 * V_322 , int V_323 , int V_324 )
{
return * ( ( ( unsigned long * ) F_131 ( V_322 , V_323 ) ) + V_324 ) ;
}
unsigned long F_132 ( void T_8 * V_322 , int V_324 )
{
unsigned long V_325 = 0 ;
int V_326 ;
F_133 (i)
V_325 += F_130 ( V_322 , V_326 , V_324 ) ;
return V_325 ;
}
T_7 F_134 ( void T_8 * V_322 , int V_323 , int V_324 ,
T_3 V_327 )
{
void * V_328 ;
struct V_329 * V_330 ;
T_7 V_331 ;
unsigned int V_332 ;
V_328 = F_131 ( V_322 , V_323 ) ;
V_330 = (struct V_329 * ) ( V_328 + V_327 ) ;
do {
V_332 = F_135 ( V_330 ) ;
V_331 = * ( ( ( T_7 * ) V_328 ) + V_324 ) ;
} while ( F_136 ( V_330 , V_332 ) );
return V_331 ;
}
T_7 F_137 ( void T_8 * V_322 , int V_324 , T_3 V_327 )
{
T_7 V_325 = 0 ;
int V_323 ;
F_133 (cpu) {
V_325 += F_134 ( V_322 , V_323 , V_324 , V_327 ) ;
}
return V_325 ;
}
static T_9 int F_138 ( struct V_44 * V_44 )
{
int V_326 ;
V_44 -> V_322 . V_333 = F_139 ( struct V_334 ) ;
if ( ! V_44 -> V_322 . V_333 )
goto V_335;
V_44 -> V_322 . V_336 = F_139 ( struct V_337 ) ;
if ( ! V_44 -> V_322 . V_336 )
goto V_338;
F_133 (i) {
struct V_337 * V_339 ;
V_339 = F_131 ( V_44 -> V_322 . V_336 , V_326 ) ;
F_140 ( & V_339 -> V_330 ) ;
}
V_44 -> V_322 . V_340 = F_139 ( struct V_341 ) ;
if ( ! V_44 -> V_322 . V_340 )
goto V_342;
V_44 -> V_322 . V_343 = F_139 ( struct V_344 ) ;
if ( ! V_44 -> V_322 . V_343 )
goto V_345;
V_44 -> V_322 . V_346 = F_139 ( struct V_344 ) ;
if ( ! V_44 -> V_322 . V_346 )
goto V_347;
V_44 -> V_322 . V_348 = F_139 ( struct V_349 ) ;
if ( ! V_44 -> V_322 . V_348 )
goto V_350;
V_44 -> V_322 . V_351 = F_141 ( sizeof( struct V_352 ) ,
V_69 ) ;
if ( ! V_44 -> V_322 . V_351 )
goto V_353;
F_142 ( V_44 ) ;
return 0 ;
V_353:
F_143 ( V_44 -> V_322 . V_348 ) ;
V_350:
F_143 ( V_44 -> V_322 . V_346 ) ;
V_347:
F_143 ( V_44 -> V_322 . V_343 ) ;
V_345:
F_143 ( V_44 -> V_322 . V_340 ) ;
V_342:
F_143 ( V_44 -> V_322 . V_336 ) ;
V_338:
F_143 ( V_44 -> V_322 . V_333 ) ;
V_335:
return - V_354 ;
}
static T_10 void F_144 ( struct V_44 * V_44 )
{
F_9 ( V_44 -> V_322 . V_351 ) ;
F_143 ( V_44 -> V_322 . V_348 ) ;
F_143 ( V_44 -> V_322 . V_346 ) ;
F_143 ( V_44 -> V_322 . V_343 ) ;
F_143 ( V_44 -> V_322 . V_340 ) ;
...
static T_9 int F_147 ( struct V_44 * V_44 )
{
F_148 ( & V_44 -> V_78 . V_356 . V_357 ) ;
V_44 -> V_78 . V_356 . V_358 [ 0 ] = 32768 ;
V_44 -> V_78 . V_356 . V_358 [ 1 ] = 60999 ;
F_148 ( & V_44 -> V_78 . V_359 . V_357 ) ;
V_44 -> V_78 . V_359 . V_358 [ 0 ] = F_149 ( & V_360 , 1 ) ;
V_44 -> V_78 . V_359 . V_358 [ 1 ] = F_149 ( & V_360 , 0 ) ;
return 0 ;
}
...
F_163 () ;
#endif
if ( F_164 ( & V_376 , V_377 ) < 0 )
F_154 ( L_11 , V_249 ) ;
if ( F_164 ( & V_378 , V_281 ) < 0 )
F_154 ( L_12 , V_249 ) ;
if ( F_164 ( & V_379 , V_159 ) < 0 )
F_154 ( L_13 , V_249 ) ;
#ifdef F_165
if ( F_164 ( & V_380 , V_381 ) < 0 )
F_154 ( L_14 , V_249 ) ;
#endif
for ( V_366 = & V_227 [ 0 ] ; V_366 < & V_227 [ V_225 ] ; ++ V_366 )
F_166 ( V_366 ) ;
for ( V_365 = V_382 ; V_365 < & V_382 [ V_383 ] ; ++ V_365 )
F_73 ( V_365 ) ;
F_167 () ;
F_168 () ;
F_169 () ;
