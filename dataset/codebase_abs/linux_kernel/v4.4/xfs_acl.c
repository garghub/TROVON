...
static int
F_33 ( struct V_36 * V_36 , unsigned char * V_61 )
{
int V_4 = F_19 ( F_34 ( V_36 -> V_59 ) ) ;
return ( F_21 ( F_16 ( V_36 ) , V_61 , NULL , & V_4 ,
V_46 | V_62 ) == 0 ) ;
}
int
F_35 ( struct V_36 * V_36 )
{
return F_33 ( V_36 , V_41 ) ;
}
int
F_36 ( struct V_36 * V_36 )
{
if ( ! F_27 ( V_36 -> V_50 ) )
return 0 ;
return F_33 ( V_36 , V_43 ) ;
}
int
F_37 ( struct V_36 * V_36 , struct V_1 * V_8 , int type )
{
int error = 0 ;
if ( ! V_8 )
goto V_63;
