...
static const char * F_27 ( struct V_46 * V_47 ,
unsigned V_79 )
{
struct V_1 * V_7 = F_19 ( V_47 ) ;
...
static int F_29 ( struct V_46 * V_47 , unsigned V_79 ,
unsigned V_85 )
{
struct V_1 * V_7 = F_19 ( V_47 ) ;
...
static const char * F_33 ( struct V_46 * V_47 ,
unsigned V_99 )
{
struct V_1 * V_7 = F_19 ( V_47 ) ;
...
if ( * V_104 == * V_103 )
return - V_105 ;
V_111 = F_38 ( V_109 , V_110 * sizeof( * V_111 ) ,
V_112 ) ;
if ( ! V_111 )
return - V_113 ;
...
static const char * F_39 ( struct V_46 * V_47 ,
const char * V_116 )
{
int V_36 , V_117 ;
...
struct V_123 * V_124 ;
V_10 = F_41 ( V_121 , L_33 , & V_79 ) ;
if ( V_10 >= 0 ) {
const char * V_85 ;
V_10 = F_42 ( V_121 , L_34 ) ;
if ( V_10 < 0 )
goto exit;
V_10 = F_43 ( V_47 , V_102 , V_103 ,
V_104 , V_10 ) ;
if ( V_10 < 0 )
goto exit;
F_44 (np, L_34 , prop, group) {
...
V_10 = F_45 ( V_121 , V_47 , & V_109 , & V_122 ) ;
if ( V_122 ) {
const char * V_125 ;
const char * V_126 ;
V_10 = F_42 ( V_121 , L_35 ) ;
if ( V_10 < 0 )
goto exit;
V_10 = F_43 ( V_47 , V_102 ,
V_103 ,
V_104 , V_10 ) ;
if ( V_10 < 0 )
goto exit;
F_44 (np, L_35 , prop, pin) {
V_125 = F_39 ( V_47 , V_126 ) ;
V_10 = F_37 ( V_102 , V_103 ,
V_104 , V_125 , V_109 , 1 ) ;
if ( V_10 < 0 )
goto exit;
}
...
* V_104 = 0 ;
F_47 (np_config, np) {
V_10 = F_40 ( V_47 , V_121 , V_102 ,
& V_103 , V_104 ) ;
if ( V_10 < 0 ) {
F_48 ( V_47 , * V_102 , * V_104 ) ;
return V_10 ;
}
}
return 0 ;
...
V_131 = F_51 ( V_109 [ V_36 ] ) ;
V_132 = F_52 ( V_109 [ V_36 ] ) ;
F_20 ( V_3 -> V_11 , L_36 ,
V_126 , V_109 [ V_36 ] ,
...
static int F_53 ( struct V_137 * V_23 )
{
...
V_7 = F_55 ( & V_143 -> V_11 , sizeof( struct V_1 ) ,
V_112 ) ;
if ( V_7 == NULL ) {
F_6 ( & V_143 -> V_11 ,
L_43 ) ;
...
V_7 -> V_11 = & V_143 -> V_11 ;
V_7 -> V_44 = F_56 ( V_143 -> V_11 . V_44 ) ;
V_7 -> V_3 = V_148 ;
V_7 -> V_3 . V_11 = & V_143 -> V_11 ;
V_7 -> V_3 . V_76 = - 1 ;
V_146 = F_57 ( V_149 , & V_143 -> V_11 ) ;
if ( ! V_146 ) {
F_6 ( & V_143 -> V_11 , L_44 ) ;
return - V_97 ;
}
...
F_63 ( & V_143 -> V_11 , L_48 ) ;
V_156 . V_90 = V_7 -> V_23 -> V_90 ;
V_156 . V_89 = V_7 -> V_23 -> V_89 ;
V_7 -> V_47 = F_64 ( & V_156 , & V_143 -> V_11 , V_7 ) ;
if ( F_65 ( V_7 -> V_47 ) ) {
F_6 ( & V_143 -> V_11 ,
L_49 ) ;
V_10 = F_66 ( V_7 -> V_47 ) ;
