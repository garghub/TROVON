...
static int F_32 ( struct V_1 * V_2 , T_4 * V_87 )
{
T_1 * V_4 ;
int V_32 ;
F_13 ( L_8 ) ;
...
V_4 -> V_43 . V_51 = F_39 ( V_87 -> V_138 / 8 ) ;
...
int F_46 ( struct V_1 * V_2 , void * V_38 , struct V_156 * V_157 )
{
T_4 * V_87 = V_38 ;
F_13 ( L_8 ) ;
F_47 ( V_2 , V_157 ) ;
...
int F_48 ( struct V_1 * V_2 , void * V_38 , struct V_156 * V_157 )
{
T_1 * V_4 = V_2 -> V_5 ;
F_13 ( L_8 ) ;
F_47 ( V_2 , V_157 ) ;
...
int F_54 ( struct V_1 * V_2 , void * V_38 , struct V_156 * V_157 )
{
return - V_36 ;
}
static struct V_164 * F_55 ( struct V_1 * V_2 )
{
...
return - V_181 ;
V_168 -> V_157 = V_157 ;
if ( F_59 ( & V_178 -> V_182 [ V_15 ] , & V_168 -> V_183 ,
sizeof( V_168 -> V_183 ) ) )
return - V_184 ;
if ( F_59 ( & V_178 -> V_185 [ V_15 ] , & V_168 -> V_186 ,
sizeof( V_168 -> V_186 ) ) )
return - V_184 ;
V_178 -> V_179 ++ ;
}
...
int F_60 ( struct V_1 * V_2 , void * V_38 , struct V_156 * V_157 )
{
struct V_165 * V_166 = V_2 -> V_166 ;
int V_25 = 0 ;
