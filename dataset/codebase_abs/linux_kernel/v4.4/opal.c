...
static T_6 F_29 ( int V_51 , void * V_6 )
{
F_24 () ;
return V_52 ;
}
...
int F_36 ( T_3 V_55 , char * V_56 , int V_57 )
{
T_4 V_58 ;
T_7 V_59 , V_60 ;
if ( ! V_13 . V_15 )
...
return 0 ;
V_60 = F_39 ( V_57 ) ;
V_58 = F_40 ( V_55 , & V_60 , V_56 ) ;
if ( V_58 == V_62 )
return F_38 ( V_60 ) ;
return 0 ;
}
int F_41 ( T_3 V_55 , const char * V_6 , int V_63 )
{
int V_64 = 0 ;
T_7 V_65 ;
T_4 V_60 , V_58 ;
...
V_75 = 1 ;
} else if ( V_76 && ! F_49 ( V_76 ) ) {
if ( F_50 ( V_73 ) && ! F_51 ( V_81 ) ) {
F_52 ( V_82 , V_73 , V_83 , V_73 -> V_84 ) ;
V_75 = 1 ;
} else
V_75 = 0 ;
} else if ( F_50 ( V_73 ) && ! F_51 ( V_81 ) &&
V_59 -> V_85 == V_86 ) {
F_52 ( V_82 , V_73 , V_83 , V_73 -> V_84 ) ;
V_75 = 1 ;
}
...
static T_9 F_68 ( struct V_98 * V_99 , struct V_100 * V_101 ,
struct V_102 * V_103 ,
char * V_56 , T_10 V_104 , T_11 V_57 )
{
return F_69 ( V_56 , V_57 , & V_104 , V_103 -> V_105 ,
V_103 -> V_16 ) ;
}
...
if ( ! V_108 )
return;
V_106 = F_72 ( V_108 , L_30 , & V_16 ) ;
if ( ! V_106 || V_16 != 2 * sizeof( T_7 ) )
return;
V_109 . V_105 = F_11 ( F_38 ( V_106 [ 0 ] ) ) ;
V_109 . V_16 = F_38 ( V_106 [ 1 ] ) ;
V_58 = F_73 ( V_95 , & V_109 ) ;
if ( V_58 )
F_67 ( L_31 , V_58 ) ;
}
...
static void F_78 ( struct V_107 * V_113 ,
const char * V_114 )
{
struct V_107 * V_115 ;
F_79 (opal_node, np)
...
struct V_123 * F_108 ( void * V_124 ,
unsigned long V_125 )
{
struct V_123 * V_126 , * V_127 = NULL ;
unsigned long V_23 = 0 ;
V_126 = F_109 ( V_128 , V_129 ) ;
if ( ! V_126 )
goto V_130;
V_127 = V_126 ;
while ( V_125 > 0 ) {
T_8 V_6 = F_110 ( V_124 ) << V_131 ;
T_8 V_132 = F_111 ( V_125 , V_128 ) ;
V_126 -> V_15 [ V_23 ] . V_6 = F_39 ( V_6 ) ;
V_126 -> V_15 [ V_23 ] . V_132 = F_39 ( V_132 ) ;
V_23 ++ ;
if ( V_23 >= V_133 ) {
struct V_123 * V_134 ;
V_134 = F_109 ( V_128 , V_129 ) ;
if ( ! V_134 )
goto V_130;
V_126 -> V_132 = F_39 (
V_23 * sizeof( struct V_135 ) + 16 ) ;
V_23 = 0 ;
V_126 -> V_134 = F_39 ( F_26 ( V_134 ) ) ;
V_126 = V_134 ;
}
V_124 += V_132 ;
V_125 -= V_132 ;
}
V_126 -> V_132 = F_39 ( V_23 * sizeof( struct V_135 ) + 16 ) ;
return V_127 ;
V_130:
F_34 ( L_46 , V_44 ) ;
F_112 ( V_127 ) ;
...
void F_112 ( struct V_123 * V_126 )
{
while ( V_126 ) {
T_8 V_134 = F_38 ( V_126 -> V_134 ) ;
F_113 ( V_126 ) ;
if ( V_134 )
V_126 = F_11 ( V_134 ) ;
else
