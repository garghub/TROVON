...
int F_17 ( T_1 V_8 , struct V_29 * V_30 , unsigned * V_2 ,
int * V_12 )
{
T_5 * V_19 , * V_31 ;
T_4 V_20 , V_32 ;
unsigned int V_21 = F_9 ( V_8 ) ;
int V_4 , V_33 , V_34 = 0 , V_22 = 0 , V_18 ;
if ( ! V_2 || * V_2 < V_21 )
return - V_23 ;
if ( V_12 )
* V_12 = V_8 -> V_12 ;
...
V_19 = V_19 - ( sizeof( V_20 ) - V_34 ) ;
for ( V_33 = 0 ; V_33 < sizeof( V_20 ) - V_34 ; V_33 ++ ) {
if ( ! V_18 ) {
V_30 = F_19 ( V_30 ) ;
if ( ! V_30 )
return - V_23 ;
...
T_1 F_20 ( struct V_29 * V_30 , unsigned int V_36 )
{
struct V_29 * V_37 ;
int V_33 , V_4 , V_5 , V_38 , V_22 , V_39 ;
...
V_33 %= V_11 ;
F_22 (sgl, sg, ents, i) {
const T_5 * V_3 = F_18 ( V_37 ) + V_22 ;
int V_36 = V_37 -> V_35 - V_22 ;
int V_41 = V_33 ;
if ( F_23 ( V_37 ) && ( V_36 % V_11 ) )
V_36 += V_11 - ( V_36 % V_11 ) ;
for (; V_33 < V_36 + V_41 ; V_33 ++ ) {
V_8 <<= 8 ;
V_8 |= * V_3 ++ ;
if ( ( ( V_38 + V_33 + 1 ) % V_11 ) == 0 ) {
V_9 -> V_13 [ V_5 -- ] = V_8 ;
V_8 = 0 ;
}
}
