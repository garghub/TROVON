...
static int F_32 ( struct V_61 * V_45 , int V_64 ,
struct V_65 * V_66 ,
...
V_71 = V_66 -> V_78 == V_79 ? & V_32 -> V_42 : & V_32 -> V_44 ;
if ( V_71 -> V_43 ) {
F_2 ( L_8 ) ;
return - V_16 ;
}
...
if ( ! V_32 )
return - V_16 ;
if ( V_32 -> V_44 . V_43 && V_64 == V_32 -> V_44 . V_46 )
V_71 = & V_32 -> V_44 ;
else if ( V_32 -> V_42 . V_43 && V_64 == V_32 -> V_42 . V_46 )
V_71 = & V_32 -> V_42 ;
else
return - V_16 ;
V_71 -> V_43 = false ;
...
struct V_31 * V_32 ;
V_32 = F_28 ( V_45 ) ;
if ( ! V_32 || ! V_32 -> V_40 || V_32 -> V_42 . V_46 != V_64 )
return 0 ;
if ( ! V_32 -> V_29 )
return 0 ;
F_14 ( V_32 -> V_29 ) ;
...
struct V_28 * V_29 ;
V_32 = F_28 ( V_3 -> V_84 ) ;
if ( ! V_32 || ! V_32 -> V_40 || V_32 -> V_44 . V_46 != V_3 -> V_85 )
return - V_86 ;
V_29 = V_32 -> V_29 ;
if ( ! V_29 ) {
F_42 ( L_12 ) ;
...
V_2 -> V_29 = V_29 ;
if ( V_32 -> V_35 ) {
F_46 ( F_47 ( V_2 , V_87 ) , V_29 -> V_36 ) ;
memcpy ( F_47 ( V_2 , 4 ) , & V_81 , 4 ) ;
memcpy ( F_47 ( V_2 , 2 ) , V_82 + 5 , 2 ) ;
memcpy ( F_47 ( V_2 , 2 ) , V_82 + 10 , 2 ) ;
V_82 += V_14 ;
V_11 -= V_14 ;
} else {
V_82 += V_24 ;
...
memcpy ( F_47 ( V_2 , V_11 ) , V_82 , V_11 ) ;
V_2 -> V_90 = F_48 ( V_2 , V_29 ) ;
V_29 -> V_52 . V_91 ++ ;
V_29 -> V_52 . V_92 += V_2 -> V_11 ;
F_49 ( V_2 ) ;
V_89:
F_19 ( V_3 ) ;
return 0 ;
...
unsigned char V_49 , unsigned char * V_93 )
{
struct V_31 * V_32 ;
struct V_28 * V_29 ;
F_25 ( L_16 , V_45 -> V_94 ) ;
