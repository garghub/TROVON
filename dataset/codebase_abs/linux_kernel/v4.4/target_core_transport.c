...
V_94 -> V_131 = V_211 ;
if ( V_94 -> V_37 &&
V_94 -> V_97 -> V_166 . V_269 == 2 ) {
F_135 ( V_94 -> V_37 -> V_54 ,
V_94 -> V_270 , 0x2C ,
V_271 ) ;
}
F_136 ( V_94 ) ;
V_33 = V_94 -> V_86 -> V_272 ( V_94 ) ;
if ( V_33 == - V_273 || V_33 == - V_28 )
goto V_274;
goto V_275;
default:
F_4 ( L_107 ,
...
T_5 V_33 ;
if ( V_94 -> V_276 ) {
V_33 = V_94 -> V_276 ( V_94 ) ;
if ( V_33 ) {
F_32 ( & V_94 -> V_105 ) ;
V_94 -> V_98 &= ~ ( V_99 | V_253 ) ;
F_34 ( & V_94 -> V_105 ) ;
F_72 ( V_94 , V_33 ) ;
}
}
...
break;
case V_279 :
if ( V_94 -> V_37 -> V_36 & V_279 )
break;
V_192 = V_94 -> V_146 >> F_141 ( V_94 -> V_97 -> V_166 . V_167 ) ;
V_94 -> V_280 = F_142 ( V_94 , V_94 -> V_281 ,
V_192 , 0 , V_94 -> V_236 , 0 ) ;
if ( F_143 ( V_94 -> V_280 ) ) {
F_32 ( & V_94 -> V_105 ) ;
V_94 -> V_98 &= ~ ( V_99 | V_253 ) ;
F_34 ( & V_94 -> V_105 ) ;
F_72 ( V_94 , V_94 -> V_280 ) ;
return - 1 ;
}
break;
default:
...
if ( F_146 ( & V_96 -> V_284 ) == 0 )
return false ;
F_11 ( & V_96 -> V_286 ) ;
F_33 ( & V_94 -> V_198 , & V_96 -> V_287 ) ;
F_12 ( & V_96 -> V_286 ) ;
F_35 ( L_110 ,
...
if ( V_94 -> V_255 ) {
T_5 V_47 ;
bool V_294 = ( V_94 -> V_118 & V_254 ) ;
bool V_295 = ! ( V_94 -> V_146 ) ;
int V_251 = 0 ;
V_47 = V_94 -> V_255 ( V_94 , true , & V_251 ) ;
if ( ! V_47 && ! V_251 ) {
if ( V_294 && V_295 )
goto V_296;
return;
...
static inline void F_153 ( struct V_218 * V_219 , int V_299 )
{
struct V_218 * V_300 ;
int V_301 ;
...
return;
F_61 ( V_94 -> V_136 ) ;
V_94 -> V_136 = V_94 -> V_302 ;
V_94 -> V_302 = NULL ;
V_94 -> V_223 = V_94 -> V_303 ;
V_94 -> V_303 = 0 ;
}
...
F_10 ( ! V_300 ) ;
if ( V_94 -> V_223 == 1 )
return F_121 ( F_122 ( V_300 ) ) + V_300 -> V_239 ;
V_305 = F_160 ( sizeof( * V_305 ) * V_94 -> V_223 , V_38 ) ;
if ( ! V_305 )
return NULL ;
F_154 (cmd->t_data_sg, sg, cmd->t_data_nents, i) {
V_305 [ V_184 ] = F_122 ( V_300 ) ;
}
V_94 -> V_306 = F_161 ( V_305 , V_94 -> V_223 , V_307 , V_308 ) ;
F_61 ( V_305 ) ;
if ( ! V_94 -> V_306 )
return NULL ;
return V_94 -> V_306 + V_94 -> V_136 [ 0 ] . V_239 ;
}
...
int
F_164 ( struct V_218 * * V_219 , unsigned int * V_299 , T_1 V_144 ,
bool V_309 )
{
struct V_218 * V_300 ;
struct V_77 * V_77 ;
T_7 V_310 = ( V_309 ) ? V_311 : 0 ;
unsigned int V_312 ;
int V_184 = 0 ;
V_312 = F_165 ( V_144 , V_81 ) ;
V_300 = F_160 ( sizeof( struct V_218 ) * V_312 , V_38 ) ;
if ( ! V_300 )
return - V_28 ;
F_166 ( V_300 , V_312 ) ;
while ( V_144 ) {
T_1 V_313 = F_167 ( T_1 , V_144 , V_81 ) ;
V_77 = F_168 ( V_38 | V_310 ) ;
if ( ! V_77 )
goto V_3;
F_169 ( & V_300 [ V_184 ] , V_77 , V_313 , 0 ) ;
V_144 -= V_313 ;
V_184 ++ ;
}
* V_219 = V_300 ;
...
if ( V_33 < 0 )
return V_123 ;
} else if ( ( V_94 -> V_118 & V_254 ) &&
V_94 -> V_146 ) {
T_1 V_317 = V_94 -> V_316 *
V_94 -> V_97 -> V_166 . V_167 ;
V_33 = F_164 ( & V_94 -> V_224 ,
& V_94 -> V_225 ,
V_317 , V_310 ) ;
...
int F_170 ( struct V_93 * V_94 , int V_318 )
{
unsigned long V_73 ;
int V_33 = 0 ;
if ( ! ( V_94 -> V_118 & V_119 ) ) {
if ( V_318 && ( V_94 -> V_118 & V_304 ) )
F_171 ( V_94 ) ;
V_33 = F_158 ( V_94 ) ;
} else {
if ( V_318 )
...
int F_117 ( struct V_93 * V_93 , bool V_319 )
{
...
{
struct V_93 * V_93 = F_40 ( V_75 , struct V_93 , V_201 ) ;
struct V_2 * V_37 = V_93 -> V_37 ;
unsigned long V_73 ;
F_37 ( & V_37 -> V_43 , V_73 ) ;
if ( F_53 ( & V_93 -> V_199 ) ) {
F_38 ( & V_37 -> V_43 , V_73 ) ;
V_93 -> V_86 -> V_322 ( V_93 ) ;
return;
}
if ( V_37 -> V_320 && V_93 -> V_323 ) {
F_38 ( & V_37 -> V_43 , V_73 ) ;
F_49 ( & V_93 -> V_200 ) ;
return;
}
...
V_94 -> V_98 |= V_109 ;
F_35 ( L_121 ,
V_94 , V_94 -> V_111 , V_94 -> V_86 -> V_252 ( V_94 ) , V_94 -> V_106 ) ;
F_38 ( & V_94 -> V_105 , V_73 ) ;
F_175 ( & V_94 -> V_112 ) ;
F_37 ( & V_94 -> V_105 , V_73 ) ;
...
static int F_178 ( struct V_93 * V_94 , T_5 V_326 )
{
const struct V_327 * V_328 ;
T_4 * V_329 = V_94 -> V_132 ;
int V_330 = ( V_331 int ) V_326 ;
T_4 V_332 , V_333 ;
bool V_334 = F_179 ( V_94 -> V_97 ) ;
if ( V_330 < F_180 ( V_335 ) && V_335 [ V_330 ] . V_336 )
V_328 = & V_335 [ V_330 ] ;
else
V_328 = & V_335 [ ( V_331 int )
V_123 ] ;
if ( V_326 == V_263 ) {
F_181 ( V_94 , & V_332 , & V_333 ) ;
F_182 ( V_332 == 0 ) ;
} else if ( V_328 -> V_332 == 0 ) {
F_182 ( V_94 -> V_337 == 0 ) ;
V_332 = V_94 -> V_337 ;
V_333 = V_94 -> V_338 ;
} else {
...
F_183 ( V_334 , V_329 , V_328 -> V_336 , V_332 , V_333 ) ;
if ( V_328 -> V_339 )
return F_184 ( V_329 ,
V_94 -> V_125 ,
V_94 -> V_340 ) ;
...
V_94 -> V_131 = V_343 ;
V_94 -> V_125 = V_126 ;
V_47 = F_178 ( V_94 , V_326 ) ;
if ( V_47 )
return V_47 ;
}
F_136 ( V_94 ) ;
return V_94 -> V_86 -> V_272 ( V_94 ) ;
}
int F_148 ( struct V_93 * V_94 , int V_344 )
{
if ( ! ( V_94 -> V_98 & V_140 ) )
return 0 ;
if ( ! V_344 || ! ( V_94 -> V_118 & V_345 ) )
return 1 ;
F_35 ( L_123 ,
...
V_94 -> V_131 = V_346 ;
F_136 ( V_94 ) ;
V_94 -> V_86 -> V_272 ( V_94 ) ;
return 1 ;
}
void F_185 ( struct V_93 * V_94 )
{
unsigned long V_73 ;
F_37 ( & V_94 -> V_105 , V_73 ) ;
if ( V_94 -> V_118 & ( V_124 ) ) {
...
static void F_186 ( struct V_121 * V_122 )
{
struct V_93 * V_94 = F_40 ( V_122 , struct V_93 , V_122 ) ;
struct V_95 * V_96 = V_94 -> V_97 ;
struct V_240 * V_348 = V_94 -> V_240 ;
int V_33 ;
switch ( V_348 -> V_349 ) {
case V_248 :
F_187 ( V_96 , V_348 , V_94 -> V_37 ) ;
break;
case V_350 :
case V_351 :
case V_352 :
...
break;
case V_354 :
V_33 = F_188 ( V_96 , V_348 , NULL , NULL ) ;
V_348 -> V_241 = ( ! V_33 ) ? V_355 :
V_356 ;
if ( V_348 -> V_241 == V_355 ) {
F_135 ( V_94 -> V_37 -> V_54 ,
V_94 -> V_270 , 0x29 ,
V_357 ) ;
}
...
V_94 -> V_98 |= V_113 ;
F_38 ( & V_94 -> V_105 , V_73 ) ;
F_76 ( & V_94 -> V_122 , F_186 ) ;
F_77 ( V_94 -> V_97 -> V_361 , & V_94 -> V_122 ) ;
return 0 ;
}
bool
F_189 ( struct V_95 * V_96 )
{
bool V_362 = false ;
if ( V_96 -> V_129 -> V_363 )
V_362 = V_96 -> V_129 -> V_363 ( V_96 ) ;
else if ( V_96 -> V_166 . V_364 > 0 )
V_362 = true ;
return V_362 ;
}
bool
...
{
return F_189 ( V_96 ) && V_96 -> V_166 . V_365 > 0 ;
}
