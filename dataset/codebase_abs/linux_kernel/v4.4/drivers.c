...
static void * F_49 ( struct V_128 * V_129 , const char * V_130 )
{
...
int F_61 ( struct V_1 * V_2 , struct V_140 * V_141 )
{
struct V_128 * V_129 ;
int V_54 ;
if ( V_2 -> V_41 )
...
continue;
if ( V_129 -> V_132 ) {
V_2 -> V_30 = F_49 ( V_129 , V_141 -> V_29 ) ;
if ( V_2 -> V_30 )
break;
...
void F_73 ( struct V_3 * V_148 )
{
if ( ! V_148 )
return;
F_71 ( V_148 ) ;
}
int F_74 ( struct V_128 * V_28 )
{
F_62 ( & V_142 ) ;
V_28 -> V_144 = V_143 ;
V_143 = V_28 ;
...
for ( V_151 = V_143 ; V_151 -> V_144 ; V_151 = V_151 -> V_144 ) {
if ( V_151 -> V_144 == V_28 ) {
V_151 -> V_144 = V_28 -> V_144 ;
break;
}
}
}
F_65 ( & V_142 ) ;
for ( V_12 = 0 ; V_12 < V_152 ; V_12 ++ ) {
