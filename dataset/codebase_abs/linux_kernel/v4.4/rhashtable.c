...
V_38 = - V_48 ;
if ( V_62 && F_62 ( V_2 , V_62 , V_2 -> V_7 ) )
goto exit;
V_38 = - V_64 ;
if ( F_63 ( F_64 ( V_2 , V_4 ) ) )
goto exit;
V_38 = - V_51 ;
...
int F_68 ( struct V_1 * V_2 , struct V_65 * V_66 )
{
V_66 -> V_2 = V_2 ;
V_66 -> V_7 = NULL ;
V_66 -> V_67 = 0 ;
V_66 -> V_68 = 0 ;
V_66 -> V_50 = F_69 ( sizeof( * V_66 -> V_50 ) , V_19 ) ;
if ( ! V_66 -> V_50 )
return - V_21 ;
F_44 ( & V_2 -> V_11 ) ;
V_66 -> V_50 -> V_4 =
F_70 ( V_2 -> V_4 , F_4 ( & V_2 -> V_11 ) ) ;
F_71 ( & V_66 -> V_50 -> V_69 , & V_66 -> V_50 -> V_4 -> V_31 ) ;
F_36 ( & V_2 -> V_11 ) ;
return 0 ;
}
...
if ( V_7 ) {
V_7 = F_78 ( V_7 -> V_40 , V_4 , V_66 -> V_67 ) ;
goto V_40;
}
for (; V_66 -> V_67 < V_4 -> V_14 ; V_66 -> V_67 ++ ) {
int V_68 = V_66 -> V_68 ;
F_79 (p, tbl, iter->slot) {
if ( ! V_68 )
break;
V_68 -- ;
}
...
static T_4 F_84 ( const struct V_70 * V_71 )
{
return F_85 ( F_11 ( V_71 -> V_72 * 4 / 3 ) ,
( unsigned long ) V_71 -> V_53 ) ;
}
static T_1 F_86 ( const void * V_62 , T_1 V_73 , T_1 V_74 )
{
return F_87 ( V_62 , V_73 , V_74 ) ;
}
...
if ( V_71 -> V_82 )
V_2 -> V_7 . V_82 = F_90 ( V_71 -> V_82 ) ;
if ( V_71 -> V_83 )
V_2 -> V_7 . V_83 =
F_90 ( V_71 -> V_83 ) ;
else
V_2 -> V_7 . V_83 = V_2 -> V_7 . V_82 * 2 ;
V_2 -> V_7 . V_53 = F_85 ( V_2 -> V_7 . V_53 , V_84 ) ;
if ( V_71 -> V_72 )
V_14 = F_84 ( & V_2 -> V_7 ) ;
if ( ! V_71 -> V_85 )
V_2 -> V_58 = 16 ;
