...
{
struct V_1 * V_2 = F_35 ( V_52 , struct V_1 , V_30 ) ;
...
static struct V_60 * F_47 ( struct V_61 * V_62 ,
struct V_1 * V_2 )
{
struct V_60 * V_63 ;
...
{
struct V_60 * V_63 = F_35 ( V_52 , struct V_60 , V_30 ) ;
...
F_50 ( V_63 ) ;
F_29 ( & V_2 -> V_47 ) ;
F_51 ( & V_62 -> V_64 , V_63 -> V_65 ) ;
if ( ! F_52 ( & V_63 -> V_14 ) )
F_36 ( & V_63 -> V_14 , & V_62 -> V_66 ) ;
F_43 ( V_2 ) ;
F_40 ( V_2 ) ;
F_30 ( V_63 ) ;
}
struct V_1 * F_53 ( struct V_60 * V_63 )
{
return V_63 -> V_2 ;
}
static void F_54 ( struct V_60 * V_63 )
{
F_39 ( & V_63 -> V_30 ) ;
}
static int F_55 ( struct V_60 * V_63 )
{
struct V_61 * V_62 = V_63 -> V_62 ;
int V_27 ;
F_28 ( & V_62 -> V_47 ) ;
V_27 = F_41 ( & V_63 -> V_30 , F_49 ) ;
F_29 ( & V_62 -> V_47 ) ;
return V_27 ;
}
static struct V_60 * F_56 ( struct V_61 * V_62 ,
struct V_1 * V_2 )
{
...
struct V_60 * V_63 ;
F_28 ( & V_62 -> V_47 ) ;
V_63 = F_58 ( & V_62 -> V_64 , V_65 ) ;
if ( V_63 )
F_54 ( V_63 ) ;
F_29 ( & V_62 -> V_47 ) ;
return V_63 ? V_63 : F_15 ( - V_37 ) ;
}
static bool F_59 ( struct V_61 * V_62 ,
struct V_60 * V_63 )
{
F_32 ( ! F_60 ( & V_62 -> V_47 ) ) ;
return F_58 ( & V_62 -> V_64 , V_63 -> V_65 ) == V_63 ;
}
static int F_61 ( struct V_61 * V_62 , struct V_60 * V_63 )
{
int V_65 ;
struct V_9 * * V_10 = & V_62 -> V_66 . V_9 ;
struct V_9 * V_12 = NULL ;
struct V_60 * V_13 ;
V_65 = F_62 ( & V_62 -> V_64 , V_63 , 1 , 0 , V_28 ) ;
if ( V_65 < 0 )
return V_65 ;
V_63 -> V_65 = V_65 ;
while ( * V_10 ) {
...
struct V_60 * F_64 ( struct V_61 * V_62 , T_1 V_20 ,
...
static void F_50 ( struct V_60 * V_63 )
{
struct V_1 * V_2 = V_63 -> V_2 ;
if ( ! V_63 -> V_50 ) {
F_63 ( 1 , L_7 , V_17 ) ;
...
int V_27 ;
F_28 ( & V_2 -> V_47 ) ;
F_5 ( V_2 -> V_43 + V_118 -> V_121 ) ;
F_44 ( ! V_2 -> V_43 || ! V_2 -> V_43 [ V_118 -> V_121 ] ) ;
V_120 = F_113 ( F_3 ( V_2 -> V_43 [ V_118 -> V_121 ] ) ) ;
...
{
struct V_60 * V_63 ;
V_63 = F_64 ( V_62 , V_163 . V_159 . V_20 ,
V_163 . V_159 . V_21 ,
V_163 . V_159 . V_68 ,
V_163 . V_159 . V_3 ) ;
if ( F_19 ( V_63 ) )
...
{
struct V_60 * V_63 ;
V_63 = F_57 ( V_62 , V_163 . V_63 . V_63 ) ;
if ( F_19 ( V_63 ) )
return F_133 ( V_63 ) ;
F_70 ( V_62 , V_63 ) ;
F_55 ( V_63 ) ;
...
struct V_7 * V_8 = F_35 ( V_174 , struct V_7 , V_8 ) ;
struct V_61 * V_62 ;
char V_175 [ 64 ] ;
F_65 ( L_17 , V_17 , __LINE__ ) ;
snprintf ( V_175 , 64 , L_30 , F_46 ( V_56 -> V_57 ) ) ;
V_62 = F_85 ( V_8 , V_175 ) ;
if ( F_19 ( V_62 ) )
return F_133 ( V_62 ) ;
V_84 -> V_155 = V_62 ;
...
V_19 -> V_188 . V_190 ( & V_19 -> V_188 , & V_184 ) ;
return 0 ;
}
...
if ( V_19 -> V_3 & V_33 )
F_156 ( V_19 ) ;
if ( ( V_19 -> V_3 & V_33 ) || V_19 -> V_31 -> V_194 )
F_157 ( V_19 ) ;
V_19 -> V_8 = V_8 ;
F_92 ( & V_8 -> V_47 ) ;
F_158 ( & V_19 -> V_14 , - V_19 -> V_65 ) ;
F_159 ( & V_19 -> V_14 , & V_8 -> V_195 ) ;
V_192 = F_95 ( V_19 -> V_73 , 0664 ,
V_8 -> V_196 , V_19 ,
& V_197 ) ;
if ( ! V_192 ) {
char V_100 [ 256 ] , * V_101 ;
V_101 = F_96 ( V_8 -> V_196 , V_100 , 256 ) ;
F_9 ( L_44 ,
V_101 , V_19 -> V_73 ) ;
}
if ( V_19 -> V_188 . V_189 && V_19 -> V_188 . V_190 ) {
char V_175 [ 64 ] ;
snprintf ( V_175 , 64 , L_45 , V_19 -> V_73 ) ;
V_192 = F_95 (
V_175 , 0644 , V_8 -> V_196 , V_19 ,
& V_198 ) ;
if ( ! V_192 ) {
char V_100 [ 256 ] , * V_101 ;
V_101 = F_96 ( V_8 -> V_196 , V_100 , 256 ) ;
...
struct V_7 * V_199 ;
int V_27 ;
V_199 = F_14 ( sizeof( struct V_7 ) , V_28 ) ;
if ( ! V_199 )
return F_15 ( - V_29 ) ;
V_199 -> V_8 . V_200 = V_201 ;
V_199 -> V_8 . V_73 = L_47 ;
V_199 -> V_8 . V_202 = & V_203 ;
V_199 -> V_8 . V_12 = NULL ;
V_27 = F_161 ( & V_199 -> V_8 ) ;
if ( V_27 ) {
F_9 ( L_48 ) ;
F_30 ( V_199 ) ;
return F_15 ( V_27 ) ;
}
V_199 -> V_97 = F_162 ( L_47 , NULL ) ;
if ( ! V_199 -> V_97 ) {
F_9 ( L_49 ) ;
goto V_204;
}
V_199 -> V_196 = F_162 ( L_50 , V_199 -> V_97 ) ;
if ( ! V_199 -> V_196 ) {
F_9 ( L_51 ) ;
goto V_204;
}
V_199 -> V_98 = F_162 ( L_52 ,
V_199 -> V_97 ) ;
if ( ! V_199 -> V_98 )
F_9 ( L_53 ) ;
V_204:
...
void T_5 F_167 ( struct V_205 * V_163 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_163 -> V_206 ; V_26 ++ ) {
if ( V_163 -> V_195 [ V_26 ] . V_35 == 0 )
continue;
if ( V_163 -> V_195 [ V_26 ] . V_207 == 0 ) {
T_6 V_208 ;
V_208 = F_168 ( V_163 -> V_195 [ V_26 ] . V_35 ,
V_163 -> V_195 [ V_26 ] . V_21 ,
V_209 ) ;
if ( ! V_208 ) {
F_9 ( L_54 ,
V_17 , V_26 ) ;
...
V_163 -> V_195 [ V_26 ] . V_207 = V_208 ;
} else {
int V_27 = F_169 ( V_163 -> V_195 [ V_26 ] . V_207 ,
V_163 -> V_195 [ V_26 ] . V_35 ) ;
if ( V_27 )
F_9 ( L_55 ,
V_163 -> V_195 [ V_26 ] . V_35 ,
V_163 -> V_195 [ V_26 ] . V_207 ) ;
}
F_170 ( L_56 , V_17 ,
V_163 -> V_195 [ V_26 ] . V_73 ,
V_163 -> V_195 [ V_26 ] . V_207 ,
V_163 -> V_195 [ V_26 ] . V_35 ) ;
}
}
