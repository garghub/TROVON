...
void F_77 ( struct V_128 * V_129 , struct V_41 * V_42 ,
struct V_191 * V_192 ,
const struct V_43 * V_11 , struct V_59 * V_152 )
{
struct V_131 * V_131 = F_50 ( V_42 -> V_13 ) ;
int V_203 , V_204 , V_205 , V_206 ;
V_36 V_207 = V_11 -> V_207 ;
if ( V_207 & V_208 )
V_207 |= V_209 ;
V_205 = V_192 -> args [ 1 ] ;
V_206 = V_204 = V_192 -> args [ 2 ] ;
if ( V_192 -> args [ 0 ] == 0 ) {
if ( ! ( V_207 & V_76 ) )
goto V_210;
for ( V_203 = V_205 ; V_203 < V_211 ; V_203 ++ ) {
struct V_212 * V_213 ;
struct V_214 * V_215 ;
struct V_12 * V_13 ;
V_204 = 0 ;
V_213 = & V_129 -> V_216 [ V_203 ] ;
F_78 ( & V_213 -> V_217 ) ;
F_79 (sk, node, &ilb->head) {
struct V_52 * V_53 = F_14 ( V_13 ) ;
if ( ! F_80 ( F_50 ( V_13 ) , V_131 ) )
continue;
if ( V_204 < V_206 ) {
V_204 ++ ;
continue;
...
if ( ! ( V_207 & ~ V_76 ) )
goto V_91;
for ( V_203 = V_205 ; V_203 <= V_129 -> V_221 ; V_203 ++ ) {
struct V_222 * V_223 = & V_129 -> V_224 [ V_203 ] ;
T_5 * V_217 = F_82 ( V_129 , V_203 ) ;
struct V_214 * V_215 ;
struct V_12 * V_13 ;
V_204 = 0 ;
if ( F_83 ( & V_223 -> V_225 ) )
...
V_206 = 0 ;
F_78 ( V_217 ) ;
F_79 (sk, node, &head->chain) {
int V_226 , V_227 ;
if ( ! F_80 ( F_50 ( V_13 ) , V_131 ) )
continue;
if ( V_204 < V_206 )
goto V_228;
V_226 = ( V_13 -> V_66 == V_109 ) ?
...
static int F_84 ( struct V_41 * V_42 , struct V_191 * V_192 ,
const struct V_43 * V_11 ,
struct V_59 * V_152 )
{
const struct V_1 * V_9 ;
...
V_9 = F_1 ( V_11 -> V_62 ) ;
if ( ! F_62 ( V_9 ) )
V_9 -> V_229 ( V_42 , V_192 , V_11 , V_152 ) ;
else
V_106 = F_63 ( V_9 ) ;
F_5 ( V_9 ) ;
return V_106 ? : V_42 -> V_153 ;
}
static int F_85 ( struct V_41 * V_42 , struct V_191 * V_192 )
{
int V_230 = sizeof( struct V_43 ) ;
struct V_59 * V_152 = NULL ;
if ( F_86 ( V_192 -> V_58 , V_230 ) )
V_152 = F_87 ( V_192 -> V_58 , V_230 , V_231 ) ;
return F_84 ( V_42 , V_192 , F_17 ( V_192 -> V_58 ) , V_152 ) ;
}
static int F_88 ( int type )
{
switch ( type ) {
case V_232 :
return V_233 ;
...
struct V_191 * V_192 )
{
struct V_236 * V_237 = F_17 ( V_192 -> V_58 ) ;
int V_230 = sizeof( struct V_236 ) ;
struct V_43 V_44 ;
struct V_59 * V_152 = NULL ;
V_44 . V_134 = V_179 ;
V_44 . V_62 = F_88 ( V_192 -> V_58 -> V_63 ) ;
V_44 . V_57 = V_237 -> V_57 ;
V_44 . V_207 = V_237 -> V_207 ;
V_44 . V_16 = V_237 -> V_16 ;
if ( F_86 ( V_192 -> V_58 , V_230 ) )
V_152 = F_87 ( V_192 -> V_58 , V_230 , V_231 ) ;
return F_84 ( V_42 , V_192 , & V_44 , V_152 ) ;
}
static int F_90 ( struct V_41 * V_130 ,
const struct V_50 * V_58 )
{
struct V_236 * V_237 = F_17 ( V_58 ) ;
struct V_43 V_44 ;
V_44 . V_134 = V_237 -> V_14 ;
V_44 . V_62 = F_88 ( V_58 -> V_63 ) ;
V_44 . V_57 = V_237 -> V_57 ;
V_44 . V_207 = V_237 -> V_207 ;
V_44 . V_16 = V_237 -> V_16 ;
return F_61 ( V_130 , V_58 , & V_44 ) ;
}
static int F_91 ( struct V_41 * V_42 , struct V_50 * V_58 )
{
int V_230 = sizeof( struct V_236 ) ;
struct V_131 * V_131 = F_50 ( V_42 -> V_13 ) ;
if ( V_58 -> V_63 >= V_238 ||
...
return F_93 ( V_131 -> V_139 , V_42 , V_58 , & V_241 ) ;
}
}
return F_90 ( V_42 , V_58 ) ;
}
static int F_94 ( struct V_41 * V_42 , struct V_50 * V_242 )
{
int V_230 = sizeof( struct V_43 ) ;
struct V_131 * V_131 = F_50 ( V_42 -> V_13 ) ;
if ( F_92 ( V_242 ) < V_230 )
...
return F_93 ( V_131 -> V_139 , V_42 , V_242 , & V_241 ) ;
}
}
return F_61 ( V_42 , V_242 , F_17 ( V_242 ) ) ;
}
static
int F_95 ( struct V_41 * V_42 , struct V_12 * V_13 )
{
const struct V_1 * V_9 ;
struct V_50 * V_58 ;
struct V_59 * V_60 ;
...
void * V_61 = NULL ;
int V_106 = 0 ;
V_58 = F_16 ( V_42 , 0 , 0 , V_243 , sizeof( * V_11 ) , 0 ) ;
if ( ! V_58 )
return - V_137 ;
V_11 = F_17 ( V_58 ) ;
memset ( V_11 , 0 , sizeof( * V_11 ) ) ;
F_7 ( V_11 , V_13 ) ;
if ( V_13 -> V_244 == V_245 || V_13 -> V_244 == V_246 )
V_11 -> V_16 . V_17 = F_14 ( V_13 ) -> V_219 ;
V_11 -> V_65 = V_13 -> V_66 ;
if ( ( V_106 = F_19 ( V_42 , V_247 , V_13 -> V_248 ) ) ) {
F_38 ( V_42 , V_58 ) ;
return V_106 ;
}
V_9 = F_1 ( V_13 -> V_248 ) ;
...
int F_96 ( const struct V_1 * V_242 )
{
const T_6 type = V_242 -> V_249 ;
int V_106 = - V_133 ;
if ( type >= V_250 )
goto V_91;
F_3 ( & V_7 ) ;
...
void F_97 ( const struct V_1 * V_242 )
{
const T_6 type = V_242 -> V_249 ;
if ( type >= V_250 )
return;
