...
int V_3 ;
V_2 -> V_59 = F_26 ( V_58 , L_1 ) ;
if ( F_27 ( V_2 -> V_59 ) )
return F_28 ( V_2 -> V_59 ) ;
V_2 -> V_60 = F_26 ( V_58 , L_2 ) ;
if ( F_27 ( V_2 -> V_60 ) )
...
V_2 -> V_4 = V_23 [ 2 ] . V_62 ;
V_2 -> V_39 = F_30 ( V_58 , L_6 ) ;
if ( F_27 ( V_2 -> V_39 ) )
return F_28 ( V_2 -> V_39 ) ;
V_2 -> V_27 = F_31 ( V_58 , L_7 ,
V_63 ) ;
if ( F_27 ( V_2 -> V_27 ) )
...
struct V_15 * V_16 ;
int V_3 ;
V_2 = F_34 ( & V_69 -> V_58 , sizeof( * V_2 ) , V_72 ) ;
if ( ! V_2 )
return - V_73 ;
F_35 ( V_69 , V_2 ) ;
V_71 = F_36 ( V_69 , V_74 , 0 ) ;
if ( ! V_71 )
return - V_75 ;
V_2 -> V_23 = F_37 ( & V_69 -> V_58 , V_71 -> V_76 , F_38 ( V_71 ) ) ;
if ( ! V_2 -> V_23 )
return - V_73 ;
V_16 = & V_2 -> V_16 ;
V_16 -> V_58 = & V_69 -> V_58 ;
V_16 -> V_77 = F_39 ( & V_69 -> V_58 ) ;
V_16 -> V_34 = F_18 ;
V_16 -> V_78 = F_24 ;
V_16 -> V_79 = F_6 ;
V_16 -> V_80 = F_12 ;
V_16 -> V_81 = V_2 -> V_23 + V_82 ;
V_16 -> V_83 = & V_84 ;
V_16 -> type = V_85 ;
V_3 = F_25 ( V_2 ) ;
if ( V_3 < 0 )
return V_3 ;
V_2 -> V_50 = F_40 ( V_16 -> V_58 , 0 ) ;
if ( F_27 ( V_2 -> V_50 ) )
return F_28 ( V_2 -> V_50 ) ;
V_3 = F_41 ( V_2 -> V_59 , V_86 ) ;
if ( V_3 < 0 )
F_42 ( V_16 -> V_58 , L_8 ) ;
V_3 = F_43 ( V_2 -> V_59 ) ;
if ( V_3 < 0 )
