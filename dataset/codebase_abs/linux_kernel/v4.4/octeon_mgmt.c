...
struct V_318 * V_319 )
{
F_102 ( V_319 -> V_320 , V_321 , sizeof( V_319 -> V_320 ) ) ;
F_102 ( V_319 -> V_322 , V_323 , sizeof( V_319 -> V_322 ) ) ;
F_102 ( V_319 -> V_324 , L_12 , sizeof( V_319 -> V_324 ) ) ;
F_102 ( V_319 -> V_325 , L_12 , sizeof( V_319 -> V_325 ) ) ;
}
...
return - V_329 ;
if ( V_2 -> V_208 )
return F_107 ( V_2 -> V_208 , V_167 ) ;
return - V_327 ;
}
static int F_108 ( struct V_16 * V_31 )
{
...
static int F_109 ( struct V_330 * V_331 )
{
struct V_16 * V_17 ;
struct V_1 * V_2 ;
const T_2 * V_32 ;
...
int V_29 ;
int V_337 ;
V_17 = F_110 ( sizeof( struct V_1 ) ) ;
if ( V_17 == NULL )
return - V_250 ;
F_111 ( V_17 , & V_331 -> V_31 ) ;
F_112 ( V_331 , V_17 ) ;
V_2 = F_14 ( V_17 ) ;
F_113 ( V_17 , & V_2 -> V_103 , F_47 ,
V_338 ) ;
V_2 -> V_17 = V_17 ;
V_2 -> V_31 = & V_331 -> V_31 ;
V_2 -> V_90 = false ;
V_32 = F_114 ( V_331 -> V_31 . V_339 , L_13 , & V_29 ) ;
if ( V_32 && V_29 == sizeof( * V_32 ) ) {
V_2 -> V_55 = F_115 ( V_32 ) ;
} else {
F_84 ( & V_331 -> V_31 , L_14 ) ;
V_337 = - V_340 ;
goto V_341;
}
snprintf ( V_17 -> V_232 , V_342 , L_15 , V_2 -> V_55 ) ;
V_337 = F_116 ( V_331 , 0 ) ;
if ( V_337 < 0 )
goto V_341;
V_2 -> V_292 = V_337 ;
V_334 = F_117 ( V_331 , V_343 , 0 ) ;
if ( V_334 == NULL ) {
F_84 ( & V_331 -> V_31 , L_16 ) ;
V_337 = - V_340 ;
goto V_341;
}
V_335 = F_117 ( V_331 , V_343 , 1 ) ;
if ( V_335 == NULL ) {
F_84 ( & V_331 -> V_31 , L_16 ) ;
V_337 = - V_340 ;
goto V_341;
}
V_336 = F_117 ( V_331 , V_343 , 3 ) ;
if ( V_336 == NULL ) {
F_84 ( & V_331 -> V_31 , L_16 ) ;
V_337 = - V_340 ;
goto V_341;
...
V_2 -> V_346 = F_118 ( V_334 ) ;
V_2 -> V_347 = V_335 -> V_345 ;
V_2 -> V_348 = F_118 ( V_335 ) ;
V_2 -> V_349 = V_336 -> V_345 ;
V_2 -> V_350 = F_118 ( V_336 ) ;
if ( ! F_119 ( & V_331 -> V_31 , V_2 -> V_344 , V_2 -> V_346 ,
V_334 -> V_232 ) ) {
...
if ( ! F_119 ( & V_331 -> V_31 , V_2 -> V_347 , V_2 -> V_348 ,
V_335 -> V_232 ) ) {
V_337 = - V_340 ;
F_84 ( & V_331 -> V_31 , L_17 ,
V_335 -> V_232 ) ;
...
if ( ! F_119 ( & V_331 -> V_31 , V_2 -> V_349 ,
V_2 -> V_350 , V_336 -> V_232 ) ) {
V_337 = - V_340 ;
F_84 ( & V_331 -> V_31 , L_17 ,
V_336 -> V_232 ) ;
goto V_341;
}
V_2 -> V_9 = ( V_8 ) F_120 ( & V_331 -> V_31 , V_2 -> V_344 , V_2 -> V_346 ) ;
V_2 -> V_60 = ( V_8 ) F_120 ( & V_331 -> V_31 , V_2 -> V_347 , V_2 -> V_348 ) ;
V_2 -> V_224 = ( V_8 ) F_120 ( & V_331 -> V_31 , V_2 -> V_349 ,
V_2 -> V_350 ) ;
F_121 ( & V_2 -> V_7 ) ;
F_122 ( & V_2 -> V_44 ) ;
F_122 ( & V_2 -> V_27 ) ;
...
V_17 -> V_353 = & V_354 ;
V_17 -> V_355 = & V_356 ;
V_332 = F_124 ( V_331 -> V_31 . V_339 ) ;
if ( V_332 )
memcpy ( V_17 -> V_137 , V_332 , V_273 ) ;
else
F_125 ( V_17 ) ;
V_2 -> V_234 = F_126 ( V_331 -> V_31 . V_339 , L_18 , 0 ) ;
V_337 = F_127 ( & V_331 -> V_31 , F_128 ( 64 ) ) ;
if ( V_337 )
goto V_341;
F_88 ( V_17 ) ;
V_337 = F_129 ( V_17 ) ;
if ( V_337 )
goto V_341;
F_130 ( & V_331 -> V_31 , L_19 V_323 L_20 ) ;
return 0 ;
V_341:
F_131 ( V_17 ) ;
return V_337 ;
}
static int F_132 ( struct V_330 * V_331 )
{
struct V_16 * V_17 = F_133 ( V_331 ) ;
F_134 ( V_17 ) ;
F_131 ( V_17 ) ;
return 0 ;
}
