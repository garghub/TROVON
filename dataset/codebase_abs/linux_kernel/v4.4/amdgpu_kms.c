...
V_160 . V_163 = V_4 -> V_107 . V_164 ;
V_160 . V_163 -= V_4 -> V_165 ;
V_160 . V_166 = V_4 -> V_107 . V_166 ;
V_160 . V_166 -= V_4 -> V_167 ;
...
T_2 * V_171 ;
unsigned V_172 = ( V_22 -> V_173 . V_72 >>
V_174 ) &
V_175 ;
unsigned V_176 = ( V_22 -> V_173 . V_72 >>
V_177 ) &
V_178 ;
if ( V_172 == V_175 )
V_172 = 0xffffffff ;
if ( V_176 == V_178 )
V_176 = 0xffffffff ;
V_171 = F_31 ( V_22 -> V_173 . V_93 , sizeof( * V_171 ) , V_11 ) ;
if ( ! V_171 )
return - V_12 ;
V_170 = V_22 -> V_173 . V_93 * sizeof( * V_171 ) ;
for ( V_33 = 0 ; V_33 < V_22 -> V_173 . V_93 ; V_33 ++ )
if ( F_32 ( V_4 , V_172 , V_176 ,
V_22 -> V_173 . V_179 + V_33 ,
& V_171 [ V_33 ] ) ) {
F_28 ( L_4 ,
V_22 -> V_173 . V_179 + V_33 ) ;
F_7 ( V_171 ) ;
...
V_169 = F_25 ( V_17 , V_171 , F_26 ( V_27 , V_170 ) ) ;
F_7 ( V_171 ) ;
return V_169 ? - V_39 : 0 ;
}
case V_180 : {
struct V_181 V_182 = {} ;
struct V_183 V_184 ;
V_182 . V_185 = V_2 -> V_16 -> V_186 ;
V_182 . V_187 = V_4 -> V_188 ;
V_182 . V_189 = V_4 -> V_190 ;
V_182 . V_191 = V_2 -> V_16 -> V_192 ;
V_182 . V_193 = V_4 -> V_193 ;
V_182 . V_194 = V_4 -> V_60 . V_195 . V_196 ;
V_182 . V_197 = V_4 -> V_60 . V_195 . V_198 ;
V_182 . V_199 = F_33 ( V_4 ) * 10 ;
if ( V_4 -> V_127 . V_200 ) {
V_182 . V_201 =
V_4 -> V_127 . V_202 . V_203 . V_204 . V_205 * 10 ;
V_182 . V_206 =
V_4 -> V_127 . V_202 . V_203 . V_204 . V_207 * 10 ;
} else {
V_182 . V_201 = V_4 -> V_127 . V_208 * 10 ;
V_182 . V_206 = V_4 -> V_127 . V_209 * 10 ;
}
V_182 . V_210 = V_4 -> V_60 . V_195 . V_211 ;
V_182 . V_212 = V_4 -> V_60 . V_195 . V_213 *
V_4 -> V_60 . V_195 . V_196 ;
V_182 . V_214 = V_4 -> V_60 . V_195 . V_215 ;
V_182 . V_216 = 0 ;
V_182 . V_217 = 0 ;
if ( V_4 -> V_8 & V_14 )
V_182 . V_217 |= V_218 ;
V_182 . V_219 = V_220 ;
V_182 . V_221 = ( T_3 ) V_4 -> V_222 . V_223 * V_64 ;
V_182 . V_224 = F_34 ( ( int ) V_225 , V_64 ) ;
V_182 . V_226 = ( 1 << V_227 ) *
V_64 ;
V_182 . V_228 = V_64 ;
F_35 ( V_4 , & V_184 ) ;
V_182 . V_229 = V_184 . V_230 ;
V_182 . V_231 = V_184 . V_232 ;
V_182 . V_233 = V_4 -> V_60 . V_233 ;
memcpy ( & V_182 . V_234 [ 0 ] , & V_184 . V_235 [ 0 ] , sizeof( V_184 . V_235 ) ) ;
V_182 . V_236 = V_4 -> V_107 . V_236 ;
V_182 . V_237 = V_4 -> V_107 . V_238 ;
V_182 . V_239 = V_4 -> V_80 . V_240 ;
return F_25 ( V_17 , & V_182 ,
F_26 ( ( V_91 ) V_27 , sizeof( V_182 ) ) ) ? - V_39 : 0 ;
}
default:
F_28 ( L_5 , V_22 -> V_36 ) ;
return - V_35 ;
...
int F_39 ( struct V_1 * V_2 , struct V_19 * V_241 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_242 * V_243 ;
int V_9 ;
...
T_4 F_55 ( struct V_1 * V_2 , unsigned int V_253 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
int F_60 ( struct V_1 * V_2 , unsigned int V_253 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_261 = F_61 ( V_4 , V_253 ) ;
return F_62 ( V_4 , & V_4 -> V_262 , V_261 ) ;
}
void F_63 ( struct V_1 * V_2 , unsigned int V_253 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_261 = F_61 ( V_4 , V_253 ) ;
F_64 ( V_4 , & V_4 -> V_262 , V_261 ) ;
}
int F_65 ( struct V_1 * V_2 , unsigned int V_253 ,
int * V_263 ,
struct V_264 * V_265 ,
unsigned V_8 )
{
