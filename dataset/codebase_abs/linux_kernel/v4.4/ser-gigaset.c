...
int V_50 ;
struct V_51 * V_52 ;
V_52 = F_35 ( sizeof( struct V_51 ) , V_53 ) ;
if ( ! V_52 ) {
F_36 ( L_11 ) ;
return - V_54 ;
}
...
F_33 ( & V_2 -> V_5 . V_6 -> V_48 . V_48 , V_2 ) ;
F_38 ( & V_2 -> V_45 ,
F_14 , ( unsigned long ) V_2 ) ;
return 0 ;
}
static int F_39 ( struct V_1 * V_2 , unsigned V_60 ,
unsigned V_61 )
{
struct V_3 * V_4 = V_2 -> V_5 . V_6 -> V_4 ;
...
static int F_41 ( struct V_1 * V_2 , unsigned V_66 )
{
return - V_16 ;
}
...
F_43 ( & V_2 -> V_5 . V_6 -> V_69 ) ;
return V_2 ;
}
static void F_44 ( struct V_1 * V_2 )
{
if ( F_45 ( & V_2 -> V_5 . V_6 -> V_69 ) )
F_46 ( & V_2 -> V_5 . V_6 -> V_70 ) ;
}
static int
F_47 ( struct V_3 * V_4 )
{
...
V_2 -> V_5 . V_6 -> V_4 = V_4 ;
F_50 ( & V_2 -> V_5 . V_6 -> V_69 , 1 ) ;
F_51 ( & V_2 -> V_5 . V_6 -> V_70 ) ;
V_4 -> V_67 = V_2 ;
V_4 -> V_76 = V_77 / 2 ;
if ( V_78 == V_79 )
V_2 -> V_39 = V_40 ;
...
static int
F_58 ( struct V_3 * V_4 , struct V_80 * V_80 ,
...
static void
F_61 ( struct V_3 * V_4 , const unsigned char * V_27 ,
char * V_91 , int V_92 )
{
struct V_1 * V_2 = F_42 ( V_4 ) ;
...
V_94 , V_93 , V_92 ) ;
if ( V_94 <= V_93 ) {
V_95 = F_63 ( unsigned , V_92 , V_77 - V_93 ) ;
...
V_73 = F_69 ( V_99 , V_100 ,
V_56 , V_101 ,
& V_14 , V_102 ) ;
if ( ! V_73 )
goto error;
V_50 = F_70 ( V_103 , & V_104 ) ;
if ( V_50 != 0 ) {
F_36 ( L_29 , V_50 ) ;
goto error;
}
