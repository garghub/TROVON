...
static int F_28 ( struct V_80 * V_85 ,
struct V_86 * V_87 , int V_88 )
{
struct V_50 * V_51 = F_22 ( V_85 -> V_61 ) ;
switch ( V_88 ) {
case V_89 :
F_26 ( V_51 , V_94 , 0x38 , 0x08 ) ;
break;
case V_91 :
F_26 ( V_51 , V_94 , 0x38 , 0x30 ) ;
break;
default:
return 0 ;
}
...
static int F_29 ( struct V_80 * V_85 ,
struct V_86 * V_87 , int V_88 )
{
struct V_50 * V_51 = F_22 ( V_85 -> V_61 ) ;
switch ( V_88 ) {
...
F_35 ( V_51 -> V_2 , L_7 , V_62 ) ;
F_26 ( V_51 , V_39 , 0x407f , V_62 ) ;
F_26 ( V_51 , V_40 , 0x407f , V_62 ) ;
return 0 ;
}
static int F_36 ( struct V_102 * V_103 , unsigned int V_107 )
{
struct V_50 * V_51 = V_103 -> V_51 ;
switch ( V_107 & V_108 ) {
case V_109 :
...
static int F_38 ( struct V_102 * V_103 , unsigned int V_123 )
{
struct V_50 * V_51 = V_103 -> V_51 ;
F_35 ( V_51 -> V_2 , L_11 , V_118 , V_123 ) ;
if ( 50 == V_123 )
F_26 ( V_51 ,
V_106 , 0x1000 , 0x1000 ) ;
else
...
{
struct V_52 * V_53 = F_6 ( V_51 ) ;
F_50 ( V_53 -> V_67 , false ) ;
F_5 ( V_51 ) ;
F_53 ( V_53 -> V_67 ) ;
return 0 ;
}
static int F_54 ( struct V_135 * V_133 ,
const struct V_136 * V_137 )
{
struct V_138 * V_65 = F_55 ( & V_133 -> V_2 ) ;
struct V_52 * V_53 ;
int V_54 , V_139 , V_62 ;
V_53 = F_56 ( & V_133 -> V_2 , sizeof( * V_53 ) ,
V_140 ) ;
if ( NULL == V_53 )
return - V_141 ;
V_53 -> V_67 = F_57 ( & V_133 -> V_2 , NULL , V_133 , & V_142 ) ;
if ( F_58 ( V_53 -> V_67 ) ) {
V_139 = F_59 ( V_53 -> V_67 ) ;
F_32 ( & V_133 -> V_2 , L_12 ,
V_139 ) ;
return V_139 ;
}
...
V_53 -> V_56 = F_60 ( & V_133 -> V_2 , V_146 ,
sizeof( V_146 ) , V_140 ) ;
if ( ! V_53 -> V_56 )
return - V_141 ;
V_53 -> V_147 = V_55 ;
...
V_53 -> V_56 [ V_54 ] . V_57 ) ;
for ( V_54 = 0 ; V_54 < F_62 ( V_148 ) ; V_54 ++ )
...
if ( V_53 -> V_133 -> V_131 ) {
V_139 = F_64 ( V_53 -> V_133 -> V_131 , NULL , F_41 ,
...
V_139 = F_65 ( & V_133 -> V_2 , & V_167 ,
V_168 , F_62 ( V_168 ) ) ;
return V_139 ;
}
static int F_66 ( struct V_135 * V_133 )
{
struct V_52 * V_53 = F_67 ( V_133 ) ;
if ( V_133 -> V_131 )
F_68 ( V_133 -> V_131 , V_53 ) ;
F_69 ( & V_133 -> V_2 ) ;
return 0 ;
}
