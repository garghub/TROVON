...
V_2 = F_101 ( V_8 , sizeof( * V_2 ) , V_199 ) ;
if ( ! V_2 ) {
V_56 = - V_180 ;
goto V_68;
}
...
V_2 -> V_16 = V_198 -> V_202 ;
V_2 -> V_92 = F_103 ( V_8 , V_198 ) ;
if ( ! V_2 -> V_92 ) {
F_13 ( V_8 , L_44 , V_42 ) ;
V_56 = - V_180 ;
goto V_68;
...
static void F_121 ( struct V_195 * V_196 )
{
struct V_1 * V_2 ;
V_2 = F_116 ( V_196 ) ;
if ( ! V_2 ) {
...
static int F_124 ( struct V_5 * V_8 )
{
int V_56 = 0 ;
struct V_1 * V_2 ;
struct V_30 * V_207 = NULL ;
