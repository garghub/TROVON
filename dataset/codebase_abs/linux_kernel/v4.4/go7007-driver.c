...
{
if ( V_94 && V_94 -> V_94 . V_96 . V_97 [ 0 ] . V_98 < V_99 ) {
T_2 * V_100 = F_44 ( & V_94 -> V_94 . V_96 , 0 ) ;
V_100 [ V_94 -> V_94 . V_96 . V_97 [ 0 ] . V_98 ++ ] = V_95 ;
}
}
...
. V_106 . V_107 = {
. V_49 = V_108 ,
. V_109 = V_94 -> V_94 . V_110 ,
. V_111 = V_101 ,
} ,
} ;
F_46 ( & V_2 -> V_112 , & V_104 ) ;
V_2 -> V_102 = V_101 ;
}
}
static void F_47 ( struct V_1 * V_2 , struct V_93 * V_94 )
{
T_3 * V_98 = & V_94 -> V_94 . V_96 . V_97 [ 0 ] . V_98 ;
...
V_98 = & V_94 -> V_94 . V_96 . V_97 [ 0 ] . V_98 ;
V_94 -> V_94 . V_110 = V_2 -> V_121 ++ ;
if ( V_94 -> V_122 && * V_98 + 216 < V_99 )
F_47 ( V_2 , V_94 ) ;
else
F_45 ( V_2 , V_94 , 0 ) ;
F_53 ( & V_94 -> V_94 . V_123 ) ;
V_116 = V_94 ;
F_49 ( & V_2 -> V_117 ) ;
F_54 ( & V_94 -> V_120 ) ;
if ( F_50 ( & V_2 -> V_118 ) )
...
if ( V_94 && V_94 -> V_94 . V_96 . V_97 [ 0 ] . V_98 >=
V_99 - 3 ) {
F_58 ( & V_2 -> V_10 , L_11 ) ;
V_94 -> V_94 . V_96 . V_97 [ 0 ] . V_98 = 0 ;
V_94 -> V_135 = 0 ;
V_94 -> V_122 = 0 ;
V_94 = V_2 -> V_119 = NULL ;
}
