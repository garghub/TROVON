...
V_2 -> V_24 . V_115 = V_87 -> V_115 ;
V_2 -> V_24 . V_116 = V_87 -> V_116 ;
V_2 -> V_117 = V_87 -> V_117 ;
V_2 -> V_25 = ( T_1 V_22 ) V_106 ;
V_2 -> V_11 = V_2 -> V_25 ;
V_2 -> V_29 = V_84 -> V_92 ;
V_2 -> V_26 = V_87 -> V_26 ;
V_2 -> V_19 = V_87 -> V_19 ? : V_118 ;
V_2 -> V_17 = V_87 -> V_17 ? : V_119 ;
V_2 -> V_24 . V_120 = F_5 ;
V_2 -> V_24 . V_121 = F_32 ;
V_2 -> V_24 . V_122 = F_24 ;
V_2 -> V_24 . V_123 = F_28 ;
...
V_2 -> V_24 . V_44 . V_129 = V_87 -> V_97 ;
break;
default:
return - V_67 ;
}
V_2 -> V_24 . V_44 . V_30 = V_93 ;
V_2 -> V_130 = F_53 ( & V_84 -> V_85 , L_17 ) ;
if ( F_43 ( V_2 -> V_130 ) ) {
V_107 = F_44 ( V_2 -> V_130 ) ;
F_54 ( & V_84 -> V_85 , L_18 , V_107 ) ;
return V_107 ;
}
V_107 = F_55 ( V_2 -> V_130 ) ;
if ( V_107 < 0 ) {
F_54 ( & V_84 -> V_85 , L_19 ,
V_107 ) ;
goto V_131;
...
F_3 ( V_2 , V_34 , V_46 ) ;
F_52 ( & V_33 ) ;
V_107 = F_56 ( & V_2 -> V_7 , V_87 -> V_26 ? 2 : 1 , NULL ) ;
if ( V_107 < 0 ) {
F_54 ( & V_84 -> V_85 , L_20 ) ;
goto V_132;
}
if ( V_87 -> V_97 == 4 ) {
int V_133 = V_2 -> V_7 . V_134 / 512 ;
if ( ! V_133 || V_2 -> V_7 . V_135 < 16 ) {
F_54 ( & V_84 -> V_85 , L_21 ) ;
V_107 = - V_67 ;
goto V_132;
}
if ( V_133 == 1 ) {
V_2 -> V_136 = V_137 ;
V_2 -> V_136 . V_138 [ 1 ] . V_139 =
V_2 -> V_7 . V_135 - 16 ;
goto V_140;
}
if ( V_133 == 4 ) {
V_2 -> V_136 = V_141 ;
V_2 -> V_24 . V_44 . V_30 = V_142 ;
goto V_140;
}
if ( V_133 == 8 ) {
V_2 -> V_136 = V_143 ;
...
goto V_132;
V_140:
V_2 -> V_24 . V_44 . V_144 = & V_2 -> V_136 ;
}
V_107 = F_57 ( & V_2 -> V_7 ) ;
if ( V_107 < 0 )
goto V_132;
if ( V_87 -> V_145 )
V_107 = F_58 ( & V_2 -> V_7 , NULL , NULL ,
V_87 -> V_145 , V_87 -> V_146 ) ;
else {
struct V_147 V_148 ;
V_148 . V_86 = V_84 -> V_85 . V_86 ;
V_107 = F_58 ( & V_2 -> V_7 , NULL , & V_148 ,
NULL , 0 ) ;
}
if ( V_107 < 0 )
goto V_132;
...
{
struct V_1 * V_2 = F_62 ( V_84 ) ;
F_51 ( & V_33 ) ;
if ( V_2 -> V_24 . V_44 . V_30 == V_150 )
V_124 = false ;
F_52 ( & V_33 ) ;
F_63 ( & V_2 -> V_7 ) ;
F_60 ( V_2 -> V_130 ) ;
