...
static int F_186 ( struct V_208 * V_209 , struct V_5 * V_6 ,
struct V_160 * V_161 [] , struct V_160 * V_86 [] )
{
return F_173 ( V_209 , V_6 , V_161 , V_86 ) ;
}
void F_187 ( struct V_5 * V_6 , struct V_217 * V_206 )
{
struct V_8 * V_10 = F_71 ( V_6 ) ;
if ( V_10 -> V_41 == V_196 )
F_57 ( V_10 -> V_9 , V_10 ) ;
...
static T_9 F_192 ( const struct V_8 * V_10 )
{
if ( V_10 -> V_21 == 0 )
return 0 ;
return F_193 ( 0 )
+ V_10 -> V_21 * F_193 ( sizeof( V_221 ) * V_25 ) ;
}
static T_9 F_194 ( const struct V_5 * V_6 )
{
struct V_8 * V_10 = F_71 ( V_6 ) ;
return ( 0
+ F_193 ( 4 )
...
if ( V_14 -> V_10 != V_10 )
continue;
if ( F_196 ( V_27 , V_202 , V_25 , V_14 -> V_1 ) )
return 1 ;
}
return 0 ;
}
...
int V_43 ;
struct V_160 * V_222 ;
if ( F_198 ( V_27 , V_195 , V_10 -> V_41 ) )
goto V_223;
if ( F_199 ( V_27 , V_194 , V_10 -> V_72 ) )
goto V_223;
if ( F_198 ( V_27 , V_203 , V_10 -> V_21 ) )
goto V_223;
if ( V_10 -> V_21 > 0 ) {
V_222 = F_200 ( V_27 , V_207 ) ;
if ( V_222 == NULL )
goto V_223;
for ( V_43 = 0 ; V_43 < V_48 ; V_43 ++ ) {
if ( F_195 ( V_27 , V_10 , V_43 ) )
goto V_223;
}
F_201 ( V_27 , V_222 ) ;
}
...
static struct V_208 * F_204 ( const struct V_5 * V_6 )
{
return F_67 ( F_176 ( V_6 ) ) ;
}
static int F_205 ( struct V_235 * V_236 ,
unsigned long V_237 , void * V_238 )
{
struct V_5 * V_6 = F_206 ( V_238 ) ;
...
if ( V_6 -> V_248 != V_249 )
break;
F_212 (vlan, next, &port->vlans, list)
