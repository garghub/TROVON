...
V_60 = 0 ;
return F_91 ( (struct V_26 * ) ( V_10 -> V_27 ) + V_60 ) ;
}
...
struct V_103 * V_104 ;
struct V_103 * V_105 ;
struct V_106 * V_46 = F_93 ( V_10 ) ;
struct V_107 * V_108 ;
struct V_55 * V_56 = & V_100 -> V_56 ;
int V_109 , V_110 ;
if ( ! V_102 )
return;
V_104 = F_8 ( V_10 ) ;
...
V_110 = 0 ;
F_96 (src_node, np) {
V_108 [ V_110 ] . V_74 = F_97 ( V_105 , 0 ) ;
V_110 ++ ;
}
V_111:
F_98 ( V_104 ) ;
}
int F_99 ( struct V_99 * V_100 ,
const struct V_101 * V_102 ,
struct V_9 * V_10 )
{
struct V_106 * V_46 = F_93 ( V_10 ) ;
...
F_92 ( V_100 , V_102 , V_10 ) ;
V_109 = V_46 -> V_113 ;
if ( ! V_109 )
return 0 ;
V_27 = F_95 ( V_56 , sizeof( * V_27 ) * V_109 , V_112 ) ;
if ( ! V_27 )
return - V_121 ;
V_10 -> V_122 = V_109 ;
V_10 -> V_27 = V_27 ;
F_101 (src, priv, i) {
snprintf ( V_117 , V_118 , L_14 ,
V_123 , V_110 ) ;
V_116 = F_102 ( V_56 , V_117 ) ;
if ( F_103 ( V_116 ) )
return F_104 ( V_116 ) ;
V_27 -> V_46 = & V_46 -> V_108 [ V_110 ] ;
V_63 = F_105 ( V_10 , F_91 ( V_27 ) , V_115 , V_116 , V_124 , V_110 ) ;
if ( V_63 )
return V_63 ;
}
return 0 ;
}
void F_106 ( struct V_99 * V_100 ,
struct V_9 * V_10 )
{
struct V_26 * V_27 ;
int V_110 ;
