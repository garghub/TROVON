...
static int
F_193 ( struct V_16 * V_321 , struct V_348 * V_349 )
{
V_37 V_100 ;
V_37 V_103 ;
struct V_19 * V_20 = F_32 ( V_321 ) ;
V_100 = V_20 -> V_100 ;
V_103 = V_20 -> V_103 ;
V_349 -> V_350 = F_194 ( V_100 ) * V_351 ;
V_349 -> V_352 =
( ( F_189 ( V_100 ) * V_339 ) / sizeof( struct V_190 ) ) ;
V_349 -> V_353 = F_194 ( V_103 ) * V_351 ;
V_349 -> V_354 =
( ( F_189 ( V_103 ) * V_339 ) / V_286 ) ;
return 0 ;
}
static int
F_195 ( struct V_16 * V_321 , struct V_348 * V_349 )
{
V_37 V_100 ;
V_37 V_103 ;
struct V_19 * V_20 = F_32 ( V_321 ) ;
...
int V_357 ;
int V_358 ;
V_355 = V_349 -> V_350 / V_351 ;
V_356 = V_349 -> V_353 / V_351 ;
V_357 = V_349 -> V_352 ;
V_358 = V_349 -> V_354 ;
V_357 =
( ( ( V_357 * sizeof( struct V_190 ) ) + V_339 - 1 )
/ V_339 ) ;
V_358 =
( ( ( V_358 * V_286 ) + V_339 - 1 )
/ V_339 ) ;
if ( ( V_355 > 0x7FFF ) || ( V_356 > 0x7FFF ) ||
( V_357 > 0xF ) || ( V_358 > 0xF ) )
return - V_127 ;
V_100 = F_179 ( V_355 , F_196 ( V_20 -> V_100 ) ,
F_197 ( V_20 -> V_100 ) , V_357 ) ;
V_103 = F_179 ( V_356 , F_196 ( V_20 -> V_103 ) , 0 ,
V_358 ) ;
V_20 -> V_100 = V_100 ;
V_20 -> V_103 = V_103 ;
...
static inline int F_198 ( int V_359 )
{
return ( V_29 * ( 1 << V_359 ) ) / sizeof( struct V_190 ) ;
}
static inline int F_199 ( int V_360 )
{
return ( V_29 * ( 1 << V_360 ) ) / V_286 ;
}
static void
F_200 ( struct V_16 * V_321 , struct V_361 * V_362 )
{
struct V_19 * V_20 = F_32 ( V_321 ) ;
V_362 -> V_363 = F_198 ( 3 ) ;
V_362 -> V_364 = F_199 ( 3 ) ;
V_362 -> V_365 = F_198 ( V_20 -> V_185 ) ;
V_362 -> V_366 = F_199 ( V_20 -> V_250 ) ;
}
static int
F_201 ( struct V_16 * V_321 , struct V_361 * V_362 )
{
struct V_19 * V_20 = F_32 ( V_321 ) ;
int V_359 = 0 ;
int V_360 = 0 ;
for (; V_359 < 4 ; V_359 ++ ) {
if ( F_198 ( V_359 ) >= V_362 -> V_365 )
break;
}
if ( V_359 == 4 )
V_359 = 3 ;
for (; V_360 < 4 ; V_360 ++ ) {
if ( F_199 ( V_360 ) >= V_362 -> V_366 )
break;
}
if ( V_360 == 4 )
V_360 = 3 ;
...
static void F_202 ( struct V_16 * V_321 , V_37 V_367 , T_6 * V_74 )
{
switch ( V_367 ) {
case V_368 :
memcpy ( V_74 , * V_369 , sizeof( V_369 ) ) ;
break;
}
}
static int F_203 ( struct V_16 * V_321 , int V_367 )
{
struct V_19 * V_20 = F_32 ( V_321 ) ;
switch ( V_367 ) {
case V_368 :
...
return ( V_20 -> V_318 ) ? F_204 ( V_369 ) : 0 ;
}
return - V_127 ;
}
static void F_205 ( struct V_16 * V_321 ,
struct V_370 * V_170 , T_7 * V_74 )
{
struct V_19 * V_20 = F_32 ( V_321 ) ;
if ( V_20 -> V_318 ) {
F_88 ( V_20 ) ;
...
{
static const struct V_371 V_372 = {
. V_373 = F_187 ,
. V_374 = F_190 ,
. V_375 = V_376 ,
. V_377 = F_193 ,
