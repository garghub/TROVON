...
static struct V_43 * T_2 F_34 (
struct V_43 * V_44 )
{
T_1 V_45 ;
if ( F_35 ( V_44 , L_1 , & V_45 ) )
return NULL ;
return F_36 ( V_45 ) ;
}
static int T_2 F_37 ( struct V_43 * V_44 ,
unsigned int * V_46 )
{
struct V_1 * V_2 ;
T_1 V_47 , V_48 ;
...
V_2 = F_41 ( sizeof( * V_2 ) , V_53 ) ;
if ( ! V_2 )
return - V_54 ;
if ( F_35 ( V_44 , L_8 , & V_2 -> V_23 ) ||
! F_42 ( V_2 -> V_23 ) ) {
F_39 ( L_9 ,
* V_46 ) ;
V_50 = - V_52 ;
...
V_2 -> V_31 = F_43 ( V_44 , 0 ) ;
if ( ! V_2 -> V_31 ) {
F_39 ( L_14 , * V_46 ) ;
V_50 = - V_54 ;
goto V_55;
}
V_2 -> V_57 = F_43 ( V_44 , 1 ) ;
if ( ! V_2 -> V_57 ) {
F_39 ( L_15 , * V_46 ) ;
V_50 = - V_54 ;
goto V_55;
...
unsigned int V_46 ;
int V_50 = 0 ;
while ( ( V_44 = F_51 ( V_44 , V_51 ) ) )
if ( ! F_35 ( V_44 , L_3 , & V_46 ) &&
V_46 == 2 )
break;
if ( ! V_44 )
return - V_61 ;
