...
if ( F_31 ( V_48 , V_194 , V_172 -> V_195 ) )
return - V_53 ;
}
return 0 ;
}
...
struct V_197 V_198 ;
int V_156 ;
V_156 = F_54 ( V_7 , V_1 , & V_198 ) ;
if ( V_156 < 0 )
return V_156 ;
if ( F_31 ( V_48 , V_199 , V_198 . V_200 ) ||
F_28 ( V_48 , V_201 , V_198 . V_202 ) ||
F_55 ( V_48 , V_203 ,
V_198 . V_204 ) )
return - V_53 ;
V_196 = F_24 ( V_48 , V_205 ) ;
if ( ! V_196 )
return - V_53 ;
V_156 = F_49 ( V_48 , & V_198 . V_206 ) ;
if ( V_156 < 0 )
return V_156 ;
F_26 ( V_48 , V_196 ) ;
return 0 ;
...
return - 1 ;
if ( V_207 &&
( F_28 ( V_48 , V_10 , V_207 -> V_18 ) ||
F_34 ( V_48 , V_209 , V_207 -> V_210 ) ) )
goto V_108;
if ( F_28 ( V_48 , V_24 , V_7 -> V_14 ) ||
F_28 ( V_48 , V_211 , V_1 -> V_212 ) ||
F_57 ( V_48 , V_12 , V_13 ( V_1 ) ) ||
F_28 ( V_48 , V_106 ,
V_7 -> V_213 ^
( V_107 << 2 ) ) )
goto V_108;
...
F_50 ( V_48 , V_215 ,
V_1 -> V_183 ) ||
F_50 ( V_48 , V_216 , V_1 -> V_179 ) )
goto V_108;
if ( F_32 ( V_48 , V_217 ,
V_1 -> V_218 ) ||
F_31 ( V_48 , V_219 , V_1 -> V_220 ) ||
F_31 ( V_48 , V_221 ,
V_1 -> V_222 ) ||
F_31 ( V_48 , V_223 , V_1 -> V_224 ) )
goto V_108;
if ( F_31 ( V_48 , V_225 , V_1 -> V_101 ) )
goto V_108;
if ( F_31 ( V_48 , V_226 , V_1 -> V_227 ) )
goto V_108;
#ifdef F_58
...
int V_228 = 0 ;
int V_229 = 0 ;
int V_230 = V_33 -> args [ 0 ] ;
int V_231 = V_33 -> args [ 1 ] ;
struct V_6 * V_7 ;
struct V_1 * V_1 ;
F_13 () ;
F_6 (rdev, &cfg802154_rdev_list, list) {
...
return - V_16 ;
if ( V_29 -> V_5 [ V_211 ] ) {
type = F_4 ( V_29 -> V_5 [ V_211 ] ) ;
if ( type > V_236 ||
! ( V_7 -> V_27 . V_59 . V_99 & F_63 ( type ) ) )
return - V_16 ;
}
if ( V_29 -> V_5 [ V_214 ] )
V_186 = F_64 ( V_29 -> V_5 [ V_214 ] ) ;
if ( ! V_7 -> V_237 -> V_126 )
return - V_238 ;
return F_65 ( V_7 ,
F_66 ( V_29 -> V_5 [ V_209 ] ) ,
...
V_240 = F_70 ( V_29 -> V_5 [ V_113 ] ) ;
if ( V_55 > V_57 || V_240 > V_241 ||
! ( V_7 -> V_27 . V_59 . V_60 [ V_55 ] & F_63 ( V_240 ) ) )
return - V_16 ;
return F_71 ( V_7 , V_55 , V_240 ) ;
}
...
if ( ! V_29 -> V_5 [ V_123 ] )
return - V_16 ;
V_246 = F_75 ( V_29 -> V_5 [ V_123 ] ) ;
for ( V_52 = 0 ; V_52 < V_7 -> V_27 . V_59 . V_70 ; V_52 ++ ) {
if ( V_246 == V_7 -> V_27 . V_59 . V_71 [ V_52 ] )
return F_76 ( V_7 , V_246 ) ;
}
return - V_16 ;
}
...
if ( ! V_29 -> V_5 [ V_121 ] )
return - V_16 ;
V_247 = F_75 ( V_29 -> V_5 [ V_121 ] ) ;
for ( V_52 = 0 ; V_52 < V_7 -> V_27 . V_59 . V_75 ; V_52 ++ ) {
if ( V_247 == V_7 -> V_27 . V_59 . V_76 [ V_52 ] )
return F_78 ( V_7 , V_247 ) ;
}
return - V_16 ;
}
...
{
struct V_6 * V_7 = V_29 -> V_167 [ 0 ] ;
struct V_23 * V_207 = V_29 -> V_167 [ 1 ] ;
struct V_1 * V_1 = V_207 -> V_26 ;
T_7 V_179 ;
if ( F_80 ( V_207 ) )
return - V_248 ;
if ( V_1 -> V_212 == V_249 ||
...
! V_29 -> V_5 [ V_219 ] )
return - V_16 ;
V_224 = F_70 ( V_29 -> V_5 [ V_223 ] ) ;
V_220 = F_70 ( V_29 -> V_5 [ V_219 ] ) ;
if ( V_224 < V_7 -> V_27 . V_59 . V_83 ||
V_224 > V_7 -> V_27 . V_59 . V_85 ||
V_220 < V_7 -> V_27 . V_59 . V_87 ||
V_220 > V_7 -> V_27 . V_59 . V_89 ||
V_224 > V_220 )
return - V_16 ;
return F_87 ( V_7 , V_1 , V_224 , V_220 ) ;
}
static int
...
if ( V_227 != 0 && V_227 != 1 )
return - V_16 ;
return F_97 ( V_7 , V_1 , V_227 ) ;
}
static int
F_98 ( struct V_4 * V_253 ,
struct V_254 * V_255 )
{
struct V_4 * V_5 [ V_256 + 1 ] ;
if ( ! V_253 || F_99 ( V_5 , V_256 , V_253 ,
V_257 ) )
return - V_16 ;
if ( ! V_5 [ V_177 ] &&
! V_5 [ V_180 ] &&
...
V_5 [ V_185 ] ) )
return - V_16 ;
V_255 -> V_179 = F_81 ( V_5 [ V_177 ] ) ;
V_255 -> V_117 = F_4 ( V_5 [ V_180 ] ) ;
switch ( V_255 -> V_117 ) {
case V_181 :
V_255 -> V_183 = F_81 ( V_5 [ V_182 ] ) ;
break;
case V_184 :
V_255 -> V_186 = F_64 ( V_5 [ V_185 ] ) ;
break;
default:
return - V_16 ;
}
...
static int
F_100 ( struct V_4 * V_253 ,
struct V_171 * V_172 )
{
struct V_4 * V_5 [ V_258 + 1 ] ;
if ( ! V_253 || F_99 ( V_5 , V_258 , V_253 ,
V_259 ) )
return - V_16 ;
if ( ! V_5 [ V_174 ] )
return - V_16 ;
...
if ( ! V_5 [ V_189 ] )
return - V_16 ;
V_172 -> V_190 = F_101 ( V_5 [ V_189 ] ) ;
break;
case V_191 :
if ( ! V_5 [ V_192 ] )
return - V_16 ;
V_172 -> V_193 = F_64 ( V_5 [ V_192 ] ) ;
break;
default:
return - V_16 ;
}
...
if ( V_29 -> V_5 [ V_199 ] ) {
T_2 V_200 ;
V_200 = F_70 ( V_29 -> V_5 [ V_199 ] ) ;
if ( V_200 != 0 && V_200 != 1 )
return - V_16 ;
V_198 . V_200 = F_70 ( V_29 -> V_5 [ V_199 ] ) ;
V_260 |= V_261 ;
}
if ( V_29 -> V_5 [ V_205 ] ) {
V_156 = F_100 ( V_29 -> V_5 [ V_205 ] ,
& V_198 . V_206 ) ;
if ( V_156 < 0 )
return V_156 ;
V_260 |= V_262 ;
...
if ( V_29 -> V_5 [ V_201 ] ) {
V_198 . V_202 = F_4 ( V_29 -> V_5 [ V_201 ] ) ;
if ( V_198 . V_202 > V_263 )
return - V_16 ;
V_260 |= V_264 ;
}
if ( V_29 -> V_5 [ V_203 ] ) {
V_198 . V_204 = F_103 ( V_29 -> V_5 [ V_203 ] ) ;
V_260 |= V_265 ;
}
return F_104 ( V_7 , V_1 , & V_198 , V_260 ) ;
}
...
void * V_104 ;
V_20 V_268 [ V_269 / 32 ] ;
struct V_4 * V_270 , * V_196 ;
V_104 = F_21 ( V_48 , V_44 , V_45 , V_46 , V_47 ) ;
if ( ! V_104 )
return - 1 ;
if ( F_28 ( V_48 , V_10 , V_207 -> V_18 ) )
goto V_108;
V_270 = F_24 ( V_48 , V_271 ) ;
if ( ! V_270 )
goto V_108;
V_196 = F_24 ( V_48 , V_272 ) ;
if ( ! V_196 )
goto V_108;
if ( F_49 ( V_48 , & V_267 -> V_195 ) < 0 )
goto V_108;
F_26 ( V_48 , V_196 ) ;
if ( F_31 ( V_48 , V_273 ,
V_267 -> V_267 -> V_274 ) )
goto V_108;
if ( V_267 -> V_267 -> V_274 & F_63 ( V_275 ) ) {
memset ( V_268 , 0 , sizeof( V_268 ) ) ;
V_268 [ 7 ] = V_267 -> V_267 -> V_276 ;
if ( F_106 ( V_48 , V_277 ,
sizeof( V_268 ) , V_268 ) )
goto V_108;
}
if ( F_106 ( V_48 , V_278 , V_279 ,
V_267 -> V_267 -> V_267 ) )
goto V_108;
F_26 ( V_48 , V_270 ) ;
F_37 ( V_48 , V_104 ) ;
...
! V_5 [ V_278 ] )
return - V_16 ;
if ( F_100 ( V_5 [ V_272 ] , & V_195 ) < 0 )
return - V_53 ;
V_267 . V_274 = F_70 ( V_5 [ V_273 ] ) ;
if ( V_267 . V_274 > F_63 ( V_288 ) ||
( ( V_267 . V_274 & F_63 ( V_275 ) ) &&
! V_5 [ V_277 ] ) )
return - V_16 ;
if ( V_5 [ V_277 ] ) {
F_112 ( V_268 , V_5 [ V_277 ] ,
V_269 / 8 ) ;
if ( V_268 [ 0 ] || V_268 [ 1 ] || V_268 [ 2 ] || V_268 [ 3 ] ||
V_268 [ 4 ] || V_268 [ 5 ] || V_268 [ 6 ] ||
V_268 [ 7 ] > F_63 ( V_289 ) )
return - V_16 ;
V_267 . V_276 = V_268 [ 7 ] ;
} else {
...
F_112 ( V_267 . V_267 , V_5 [ V_278 ] , V_279 ) ;
if ( F_100 ( V_5 [ V_272 ] , & V_195 ) < 0 )
return - V_53 ;
return F_113 ( V_7 , V_1 , & V_195 , & V_267 ) ;
}
...
if ( F_28 ( V_48 , V_10 , V_207 -> V_18 ) )
goto V_108;
V_292 = F_24 ( V_48 , V_293 ) ;
if ( ! V_292 )
goto V_108;
if ( F_28 ( V_48 , V_294 ,
V_291 -> V_204 ) ||
F_50 ( V_48 , V_295 , V_291 -> V_179 ) ||
F_50 ( V_48 , V_296 ,
V_291 -> V_183 ) ||
F_51 ( V_48 , V_297 ,
V_291 -> V_298 ) ||
...
static int
F_118 ( struct V_4 * V_253 ,
struct V_290 * V_207 )
{
struct V_4 * V_5 [ V_304 + 1 ] ;
if ( ! V_253 || F_99 ( V_5 , V_304 , V_253 ,
V_305 ) )
return - V_16 ;
...
! V_5 [ V_301 ] )
return - V_16 ;
V_207 -> V_204 = F_4 ( V_5 [ V_294 ] ) ;
V_207 -> V_179 = F_81 ( V_5 [ V_295 ] ) ;
V_207 -> V_183 = F_81 ( V_5 [ V_296 ] ) ;
V_207 -> V_298 = F_64 ( V_5 [ V_297 ] ) ;
V_207 -> V_300 = F_70 ( V_5 [ V_299 ] ) ;
V_207 -> V_302 = F_4 ( V_5 [ V_301 ] ) ;
if ( V_207 -> V_302 > V_306 ||
( V_207 -> V_300 != 0 && V_207 -> V_300 != 1 ) )
return - V_16 ;
return 0 ;
}
...
struct V_1 * V_1 = V_207 -> V_26 ;
struct V_290 V_291 ;
if ( F_118 ( V_29 -> V_5 [ V_293 ] ,
& V_291 ) < 0 )
return - V_16 ;
return F_120 ( V_7 , V_1 , & V_291 ) ;
}
...
V_308 -> V_204 ) )
goto V_108;
V_196 = F_24 ( V_48 , V_313 ) ;
if ( ! V_196 )
goto V_108;
if ( F_49 ( V_48 , & V_308 -> V_314 ) < 0 )
goto V_108;
F_26 ( V_48 , V_196 ) ;
F_26 ( V_48 , V_309 ) ;
F_37 ( V_48 , V_104 ) ;
...
& V_267 . V_314 ) < 0 )
return - V_53 ;
V_267 . V_204 = F_4 ( V_5 [ V_312 ] ) ;
V_186 = F_64 ( V_5 [ V_311 ] ) ;
return F_126 ( V_7 , V_1 , V_186 , & V_267 ) ;
}
...
return - V_53 ;
V_186 = F_64 ( V_5 [ V_311 ] ) ;
return F_128 ( V_7 , V_1 , V_186 , & V_267 ) ;
}
...
if ( F_28 ( V_48 , V_10 , V_207 -> V_18 ) )
goto V_108;
V_321 = F_24 ( V_48 , V_322 ) ;
if ( ! V_321 )
goto V_108;
if ( F_28 ( V_48 , V_323 , V_320 -> V_324 ) ||
F_28 ( V_48 , V_325 , V_320 -> V_326 ) ||
F_31 ( V_48 , V_327 ,
V_320 -> V_328 ) )
goto V_108;
if ( V_320 -> V_324 == V_275 ) {
if ( F_28 ( V_48 , V_329 ,
V_320 -> V_330 ) )
goto V_108;
}
...
static int
F_131 ( struct V_4 * V_253 , struct V_319 * V_320 )
{
struct V_4 * V_5 [ V_331 + 1 ] ;
if ( ! V_253 || F_99 ( V_5 , V_331 , V_253 ,
V_332 ) )
return - V_16 ;
...
! V_5 [ V_327 ] )
return - V_16 ;
V_320 -> V_326 = F_70 ( V_5 [ V_325 ] ) ;
V_320 -> V_324 = F_4 ( V_5 [ V_323 ] ) ;
V_320 -> V_328 = F_70 ( V_5 [ V_327 ] ) ;
if ( V_320 -> V_324 > V_288 ||
( V_320 -> V_328 != 0 && V_320 -> V_328 != 1 ) )
return - V_16 ;
if ( V_320 -> V_324 == V_275 ) {
if ( ! V_5 [ V_329 ] )
return - V_16 ;
V_320 -> V_330 = F_4 ( V_5 [ V_329 ] ) ;
if ( V_320 -> V_330 > V_289 )
return - V_16 ;
}
return 0 ;
}
...
struct V_1 * V_1 = V_207 -> V_26 ;
struct V_319 V_320 ;
if ( F_131 ( V_29 -> V_5 [ V_322 ] ,
& V_320 ) < 0 )
return - V_16 ;
return F_133 ( V_7 , V_1 , & V_320 ) ;
}
...
struct V_319 V_320 ;
if ( ! V_29 -> V_5 [ V_322 ] ||
F_131 ( V_29 -> V_5 [ V_322 ] ,
& V_320 ) < 0 )
return - V_16 ;
return F_135 ( V_7 , V_1 , & V_320 ) ;
}
static int F_136 ( const struct V_333 * V_237 , struct V_30 * V_31 ,
struct V_28 * V_29 )
{
struct V_6 * V_7 ;
struct V_1 * V_1 ;
struct V_23 * V_207 ;
bool V_334 = V_237 -> V_335 & V_336 ;
if ( V_334 )
F_13 () ;
if ( V_237 -> V_335 & V_337 ) {
...
static void F_139 ( const struct V_333 * V_237 , struct V_30 * V_31 ,
struct V_28 * V_29 )
{
if ( V_29 -> V_167 [ 1 ] ) {
if ( V_237 -> V_335 & V_339 ) {
struct V_1 * V_1 = V_29 -> V_167 [ 1 ] ;
if ( V_1 -> V_17 )
F_140 ( V_1 -> V_17 ) ;
} else {
...
if ( V_237 -> V_335 & V_336 )
F_19 () ;
}
int F_141 ( void )
{
return F_142 ( & V_37 , V_342 ,
V_343 ) ;
}
void F_143 ( void )
{
