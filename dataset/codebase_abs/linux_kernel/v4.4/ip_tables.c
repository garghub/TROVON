...
V_94 = 0 ;
V_6 = F_22 ( V_38 ) ;
V_7 = V_87 -> V_71 ? V_87 -> V_71 -> V_59 : V_89 ;
V_8 = V_87 -> V_72 ? V_87 -> V_72 -> V_59 : V_89 ;
...
= ( void * ) F_13 ( V_48 ) ;
int V_133 = V_48 -> V_134 & ( 1 << V_69 ) ;
if ( V_48 -> V_134 & ( 1 << V_130 ) ) {
F_42 ( L_20 ,
V_69 , V_131 , V_48 -> V_134 ) ;
return 0 ;
}
V_48 -> V_134 |= ( ( 1 << V_69 ) | ( 1 << V_130 ) ) ;
...
V_40 -> V_116 = V_141 -> V_57 . V_58 . V_116 ;
V_40 -> V_117 = V_141 -> V_61 ;
V_12 = F_48 ( V_40 , V_141 -> V_57 . V_149 - sizeof( * V_141 ) ,
...
struct V_150 * V_116 ;
int V_12 ;
V_116 = F_50 ( V_104 , V_141 -> V_57 . V_135 . V_59 ,
...
return 0 ;
V_152:
F_45 ( V_141 -> V_57 . V_58 . V_116 -> V_144 ) ;
return V_12 ;
}
static int F_53 ( struct V_43 * V_48 , struct V_68 * V_68 , const char * V_59 )
{
...
int V_12 ;
V_12 = F_54 ( & V_40 , V_55 -> V_57 . V_146 - sizeof( * V_55 ) ,
...
static int
F_55 ( struct V_43 * V_48 , struct V_68 * V_68 , const char * V_59 ,
unsigned int V_137 )
{
struct V_47 * V_55 ;
struct V_155 * V_56 ;
...
if ( V_12 )
return V_12 ;
V_48 -> V_118 . V_132 = F_56 () ;
if ( F_57 ( V_48 -> V_118 . V_132 ) )
return - V_158 ;
V_156 = 0 ;
V_157 . V_68 = V_68 ;
V_157 . V_88 = V_59 ;
...
V_55 = F_14 ( V_48 ) ;
V_56 = F_58 ( V_104 , V_55 -> V_57 . V_135 . V_59 ,
...
V_12 = F_53 ( V_48 , V_68 , V_59 ) ;
if ( V_12 )
goto V_152;
return 0 ;
V_152:
F_45 ( V_55 -> V_57 . V_58 . V_56 -> V_144 ) ;
V_159:
F_33 (ematch, e) {
if ( V_156 -- == 0 )
break;
...
static void
F_63 ( struct V_43 * V_48 , struct V_68 * V_68 )
{
struct V_164 V_40 ;
struct V_47 * V_55 ;
struct V_111 * V_112 ;
...
return V_12 ;
++ V_167 ;
if ( strcmp ( F_14 ( V_77 ) -> V_57 . V_135 . V_59 ,
V_60 ) == 0 )
++ V_128 -> V_108 ;
}
...
V_167 = 0 ;
F_17 (iter, entry0, newinfo->size) {
V_12 = F_55 ( V_77 , V_68 , V_166 -> V_59 , V_166 -> V_137 ) ;
if ( V_12 != 0 )
break;
++ V_167 ;
}
...
F_33 (ematch, e)
V_178 += F_82 ( V_112 -> V_57 . V_58 . V_116 ) ;
V_55 = F_13 ( V_48 ) ;
V_178 += F_83 ( V_55 -> V_57 . V_58 . V_56 ) ;
V_128 -> V_137 -= V_178 ;
...
if ( F_88 ( V_59 , V_135 , sizeof( V_59 ) ) != 0 )
return - V_181 ;
V_59 [ V_189 - 1 ] = '\0' ;
#ifdef F_89
if ( V_188 )
F_90 ( V_82 ) ;
#endif
V_55 = F_91 ( F_92 ( V_68 , V_82 , V_59 ) ,
L_44 , V_59 ) ;
if ( ! F_93 ( V_55 ) ) {
struct V_190 V_2 ;
const struct V_74 * V_75 = V_55 -> V_75 ;
#ifdef F_89
struct V_74 V_172 ;
if ( V_188 ) {
...
V_55 = F_92 ( V_68 , V_82 , V_194 . V_59 ) ;
if ( ! F_93 ( V_55 ) ) {
const struct V_74 * V_75 = V_55 -> V_75 ;
F_8 ( L_47 , V_75 -> V_168 ) ;
...
static int
F_98 ( struct V_68 * V_68 , const char * V_59 , unsigned int V_106 ,
...
V_199 = F_99 ( V_55 , V_197 , V_128 , & V_12 ) ;
if ( ! V_199 )
goto V_201;
F_8 ( L_50 ,
...
goto V_203;
F_8 ( L_52 ) ;
V_12 = F_98 ( V_68 , V_172 . V_59 , V_172 . V_106 , V_128 ,
...
static int
F_106 ( struct V_43 * V_48 , void T_4 * * V_211 ,
...
if ( F_75 ( V_212 , V_48 , sizeof( struct V_43 ) ) != 0 ||
...
V_55 = F_14 ( V_48 ) ;
V_12 = F_108 ( V_55 , V_211 , V_137 ) ;
if ( V_12 )
return V_12 ;
V_85 = V_48 -> V_85 - ( V_213 - * V_137 ) ;
if ( F_109 ( V_62 , & V_212 -> V_62 ) != 0 ||
...
static void F_111 ( struct V_186 * V_48 )
{
struct V_47 * V_55 ;
struct V_111 * V_112 ;
F_33 (ematch, e)
F_45 ( V_112 -> V_57 . V_58 . V_116 -> V_144 ) ;
V_55 = F_112 ( V_48 ) ;
F_45 ( V_55 -> V_57 . V_58 . V_56 -> V_144 ) ;
}
static int
F_113 ( struct V_186 * V_48 ,
struct V_74 * V_128 ,
unsigned int * V_137 ,
const unsigned char * V_44 ,
const unsigned char * V_160 ,
...
F_8 ( L_54 , V_48 ) ;
if ( ( unsigned long ) V_48 % F_62 ( struct V_186 ) != 0 ||
...
V_156 = 0 ;
F_33 (ematch, e) {
V_12 = F_110 ( V_112 , V_59 , & V_48 -> V_6 , & V_178 ) ;
if ( V_12 != 0 )
goto V_215;
++ V_156 ;
}
...
static int
F_114 ( struct V_186 * V_48 , void * * V_211 ,
...
static int
F_117 ( struct V_43 * V_48 , struct V_68 * V_68 , const char * V_59 )
{
struct V_111 * V_112 ;
struct V_147 V_157 ;
unsigned int V_156 ;
...
V_12 = F_118 ( V_68 , V_172 . V_59 , V_172 . V_106 ,
...
struct V_1 * F_131 ( struct V_68 * V_68 ,
const struct V_1 * V_88 ,
const struct V_165 * V_166 )
{
int V_12 ;
...
if ( V_12 != 0 )
goto V_242;
V_241 = F_132 ( V_68 , V_88 , & V_240 , V_128 ) ;
if ( F_51 ( V_241 ) ) {
V_12 = F_52 ( V_241 ) ;
goto V_242;
}
...
void F_133 ( struct V_68 * V_68 , struct V_1 * V_88 )
{
struct V_74 * V_75 ;
void * V_180 ;
...
static inline bool
F_135 ( T_7 V_245 , T_7 V_246 , T_7 V_247 ,
T_7 type , T_7 V_248 ,
bool V_249 )
{
return ( ( V_245 == 0xFF ) ||
...
if ( V_40 -> V_98 != 0 )
return false ;
V_251 = F_137 ( V_38 , V_40 -> V_101 , sizeof( V_252 ) , & V_252 ) ;
if ( V_251 == NULL ) {
F_8 ( L_66 ) ;
V_40 -> V_102 = true ;
return false ;
}
return F_135 ( V_254 -> type ,
V_254 -> V_248 [ 0 ] ,
V_254 -> V_248 [ 1 ] ,
V_251 -> type , V_251 -> V_248 ,
! ! ( V_254 -> V_22 & V_255 ) ) ;
}
static int F_138 ( const struct V_147 * V_40 )
{
const struct V_253 * V_254 = V_40 -> V_117 ;
return ( V_254 -> V_22 & ~ V_255 ) ? - V_145 : 0 ;
}
static int T_8 F_139 ( struct V_68 * V_68 )
{
return F_140 ( V_68 , V_104 ) ;
}
static void T_9 F_141 ( struct V_68 * V_68 )
{
F_142 ( V_68 , V_104 ) ;
}
...
if ( V_12 < 0 )
goto V_257;
V_12 = F_145 ( V_258 , F_146 ( V_258 ) ) ;
if ( V_12 < 0 )
goto V_259;
V_12 = F_147 ( V_260 , F_146 ( V_260 ) ) ;
if ( V_12 < 0 )
goto V_261;
V_12 = F_148 ( & V_262 ) ;
if ( V_12 < 0 )
...
return 0 ;
V_263:
F_150 ( V_260 , F_146 ( V_260 ) ) ;
V_261:
F_151 ( V_258 , F_146 ( V_258 ) ) ;
V_259:
F_152 ( & V_256 ) ;
V_257:
return V_12 ;
