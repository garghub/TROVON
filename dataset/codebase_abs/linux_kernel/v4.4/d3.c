...
V_8 -> V_78 = V_40 -> V_79 ;
V_8 -> V_80 = V_40 -> V_81 ;
V_53 = F_24 ( V_8 , V_4 , V_38 , V_40 , 0 ) ;
} else {
V_8 -> V_82 = V_40 -> V_79 ;
V_8 -> V_83 = V_40 -> V_81 ;
V_53 = F_24 ( V_8 , V_4 , V_38 , V_40 , 1 ) ;
}
V_6 -> error = V_53 != 0 ;
V_84:
F_7 ( & V_8 -> V_13 ) ;
...
V_118 = F_26 ( V_120 . V_126 [ 0 ] , V_128 ) ;
if ( ! V_118 )
return - V_129 ;
V_118 -> V_125 = F_16 ( V_116 -> V_125 ) ;
for ( V_35 = 0 ; V_35 < V_116 -> V_125 ; V_35 ++ ) {
int V_130 = F_27 ( V_116 -> V_131 [ V_35 ] . V_132 , 8 ) ;
...
V_120 . V_6 [ 0 ] = V_118 ;
V_124 = F_28 ( V_8 , & V_120 ) ;
F_29 ( V_118 ) ;
return V_124 ;
}
static T_2 F_30 ( int V_126 , T_6 V_137 , T_6 V_138 )
{
T_7 V_139 = F_31 ( V_126 , V_137 , V_138 , 0 ) ;
return F_14 ( F_32 ( ( V_140 V_141 ) V_139 ) ) ;
}
...
V_153 -> V_143 . V_171 = F_34 ( V_143 -> V_172 ) ;
V_153 -> V_143 . V_173 = F_34 ( V_143 -> V_174 ) ;
V_153 -> V_143 . V_175 = sizeof( struct V_152 ) / 4 ;
V_153 -> V_143 . V_176 = F_34 ( 65000 ) ;
break;
case V_177 :
case V_178 :
case V_179 :
...
V_153 -> V_143 . V_171 = F_34 ( V_143 -> V_174 ) ;
V_153 -> V_143 . V_173 = F_34 ( V_143 -> V_172 ) ;
break;
default:
F_35 ( 1 ) ;
return;
...
case V_162 :
case V_163 :
V_153 -> V_151 . V_188 = F_34 ( V_154 ) ;
V_153 -> V_151 . V_139 = F_36 ( & V_153 -> V_151 , V_153 -> V_151 . V_158 ) ;
break;
case V_179 :
for ( V_35 = 0 ; V_35 < F_27 ( V_143 -> V_186 , 8 ) ; V_35 ++ ) {
T_3 V_189 = V_143 -> V_190 [ V_35 ] ;
V_133 [ V_35 + 6 ] |= V_189 << 6 ;
if ( V_35 + 1 < F_27 ( V_143 -> V_186 , 8 ) )
...
* V_145 = F_30 ( V_154 - sizeof( struct V_150 ) ,
...
V_227 = V_225 -> V_240 ;
F_42 () ;
V_53 = F_43 ( V_8 , V_10 -> V_235 , & V_229 ,
V_226 , V_227 ) ;
if ( V_53 )
return V_53 ;
V_10 -> V_241 = false ;
if ( F_35 ( ! V_4 -> V_104 . V_242 ) )
return - V_236 ;
V_53 = F_44 ( V_8 , V_4 ) ;
if ( V_53 )
return V_53 ;
...
V_53 = F_47 ( V_8 , V_223 , false ) ;
if ( V_53 )
return V_53 ;
F_48 ( V_8 -> V_252 [ V_10 -> V_253 ] , V_223 ) ;
...
if ( V_124 )
return V_124 ;
V_266 = F_53 ( V_120 . V_267 ) ;
if ( V_266 < sizeof( T_2 ) ) {
V_124 = - V_236 ;
} else {
V_124 = F_54 ( ( T_2 * ) V_120 . V_267 -> V_6 ) ;
...
if ( V_53 )
return V_53 ;
V_53 = F_39 ( V_8 , V_4 , V_223 ) ;
if ( V_53 )
return V_53 ;
V_305 . V_87 = F_38 ( sizeof( * V_305 . V_87 ) , V_128 ) ;
if ( ! V_305 . V_87 )
return - V_129 ;
if ( ! V_11 . V_12 ) {
F_7 ( & V_8 -> V_13 ) ;
...
if ( V_53 )
return V_53 ;
V_53 = F_69 ( V_8 , V_4 , V_314 , & V_8 -> V_315 ,
V_316 ) ;
if ( V_53 )
return V_53 ;
if ( F_35 ( V_8 -> V_317 || V_8 -> V_318 ) )
return - V_319 ;
if ( V_314 -> V_320 ) {
V_8 -> V_317 = F_70 ( V_314 -> V_321 ,
sizeof( * V_314 -> V_321 ) *
V_314 -> V_320 ,
V_128 ) ;
if ( V_8 -> V_317 )
V_8 -> V_322 = V_314 -> V_320 ;
}
V_8 -> V_318 = F_70 ( V_314 -> V_323 ,
sizeof( * V_314 -> V_323 ) *
V_314 -> V_324 ,
V_128 ) ;
if ( V_8 -> V_318 )
V_8 -> V_325 = V_314 -> V_324 ;
return 0 ;
}
...
goto V_34;
#ifdef F_79
V_126 = F_53 ( V_330 . V_267 ) ;
if ( V_126 >= sizeof( T_4 ) ) {
V_8 -> V_339 =
F_80 ( ( V_340 * ) V_330 . V_267 -> V_6 ) ;
}
#endif
F_55 ( & V_330 ) ;
F_81 ( V_274 , & V_8 -> V_234 ) ;
F_82 ( V_8 -> V_273 , V_326 ) ;
V_34:
if ( V_53 < 0 ) {
F_83 ( V_8 , V_341 ) ;
F_84 ( V_8 -> V_2 ) ;
...
{
struct V_342 V_343 ;
static const T_1 V_344 [] = { V_331 } ;
int V_53 ;
F_86 ( & V_8 -> V_345 , & V_343 ,
V_344 , F_87 ( V_344 ) ,
NULL , NULL ) ;
V_53 = F_88 ( V_8 -> V_2 -> V_346 ) ;
if ( V_53 )
goto V_347;
V_53 = F_89 ( & V_8 -> V_345 , & V_343 , V_348 ) ;
F_90 ( V_53 ) ;
return V_53 ;
V_347:
F_91 ( & V_8 -> V_345 , & V_343 ) ;
return V_53 ;
}
int F_92 ( struct V_1 * V_2 , struct V_115 * V_116 )
{
struct V_7 * V_8 = F_2 ( V_2 ) ;
int V_53 ;
F_93 ( & V_8 -> V_349 ) ;
...
F_4 ( & V_8 -> V_354 ) ;
F_95 ( V_355 , & V_8 -> V_356 ) ;
F_7 ( & V_8 -> V_354 ) ;
F_82 ( V_8 -> V_273 , false ) ;
return 0 ;
}
return F_72 ( V_2 , V_116 , false ) ;
}
...
V_390 = 0 ;
if ( F_97 ( V_389 -> V_391 ) ) {
int V_392 = F_98 ( V_389 -> V_391 ) ;
int V_393 = 0 , V_394 = 4 ;
V_153 = F_99 ( V_383 , V_128 ) ;
if ( ! V_153 )
goto V_366;
memcpy ( F_100 ( V_153 , V_392 ) , V_386 , V_392 ) ;
V_386 += V_392 ;
V_383 -= V_392 ;
if ( F_101 ( V_389 -> V_391 ) ) {
if ( F_102 ( V_389 -> V_395 ) ) {
V_393 = V_8 -> V_82 ;
V_394 += V_8 -> V_83 ;
} else {
V_393 = V_8 -> V_78 ;
...
V_383 -= V_393 + V_394 ;
V_386 += V_393 ;
memcpy ( F_100 ( V_153 , V_383 ) , V_386 , V_383 ) ;
if ( F_103 ( V_153 , V_4 -> V_29 , V_4 -> type ) )
goto V_366;
...
V_366:
F_104 ( V_4 , V_362 , V_128 ) ;
F_105 ( V_153 ) ;
}
static void F_106 ( struct V_43 * V_401 ,
struct V_50 * V_51 )
{
T_5 V_113 ;
V_113 = F_107 ( V_401 -> V_113 ) ;
...
static void F_108 ( struct V_45 * V_401 ,
struct V_50 * V_51 )
{
V_51 -> V_89 . V_94 = F_109 ( V_401 -> V_94 ) ;
V_51 -> V_89 . V_93 = F_110 ( V_401 -> V_93 ) ;
}
static void F_111 ( struct V_43 * V_402 ,
struct V_39 * V_40 )
{
int V_403 ;
F_112 ( V_103 != V_404 ) ;
...
F_113 ( V_40 , V_403 , & V_51 ) ;
}
}
static void F_114 ( struct V_45 * V_402 ,
struct V_39 * V_40 )
{
int V_403 ;
F_112 ( V_103 != V_404 ) ;
...
switch ( V_40 -> V_54 ) {
case V_109 :
F_111 ( V_407 -> V_111 . V_100 , V_40 ) ;
break;
case V_86 :
F_114 ( V_407 -> V_89 . V_100 , V_40 ) ;
break;
default:
F_35 ( 1 ) ;
}
...
switch ( V_40 -> V_54 ) {
case V_109 :
F_111 ( V_401 -> V_111 . V_90 , V_40 ) ;
F_117 ( & V_40 -> V_112 , F_107 ( V_401 -> V_111 . V_91 . V_113 ) ) ;
break;
case V_86 :
F_108 ( & V_401 -> V_89 . V_91 , & V_51 ) ;
F_114 ( V_401 -> V_89 . V_90 , V_40 ) ;
F_118 ( V_40 , & V_51 ) ;
break;
}
return;
...
F_115 ( V_40 , V_6 -> V_234 ) ;
}
static bool F_120 ( struct V_7 * V_8 ,
struct V_3 * V_4 ,
struct V_405 * V_234 )
{
struct V_9 * V_10 = F_3 ( V_4 ) ;
...
if ( V_234 -> V_413 ) {
V_20 V_19 =
F_123 ( F_107 ( V_234 -> V_19 ) ) ;
F_124 ( V_4 , V_4 -> V_104 . V_105 ,
( void * ) & V_19 , V_128 ) ;
}
V_34:
V_10 -> V_271 = true ;
V_10 -> V_270 = F_110 ( V_234 -> V_421 ) + 0x10 ;
return true ;
}
static struct V_405 *
F_125 ( struct V_7 * V_8 , struct V_3 * V_4 )
{
T_4 V_422 = V_8 -> V_423 ;
struct V_424 {
T_4 V_21 ;
...
if ( V_126 != ( V_429 +
F_129 ( F_109 ( V_234 -> V_382 ) , 4 ) ) ) {
F_46 ( V_8 , L_9 ) ;
V_428 = F_128 ( - V_251 ) ;
goto V_433;
}
V_428 = F_70 ( V_234 , V_126 , V_128 ) ;
V_433:
F_55 ( & V_120 ) ;
return V_428 ;
}
static bool F_130 ( struct V_7 * V_8 ,
struct V_3 * V_4 )
{
struct V_357 V_234 ;
struct V_405 * V_428 ;
...
if ( F_74 ( V_428 ) )
goto V_84;
V_234 . V_369 = F_110 ( V_428 -> V_369 ) ;
for ( V_35 = 0 ; V_35 < 8 ; V_35 ++ )
V_234 . V_435 [ V_35 ] =
F_110 ( V_428 -> V_435 [ V_35 ] ) ;
V_234 . V_364 = F_109 ( V_428 -> V_364 ) ;
V_234 . V_385 =
F_109 ( V_428 -> V_385 ) ;
V_234 . V_382 =
F_109 ( V_428 -> V_382 ) ;
...
V_51 += 0x10 ;
V_278 -> V_438 [ V_35 ] . V_439 = V_51 ;
}
F_7 ( & V_8 -> V_13 ) ;
F_96 ( V_8 , V_4 , & V_234 ) ;
V_434 = F_120 ( V_8 , V_4 , V_428 ) ;
F_29 ( V_428 ) ;
return V_434 ;
V_436:
F_29 ( V_428 ) ;
...
V_441 -> V_445 = F_109 ( V_443 -> V_445 ) ;
memcpy ( V_441 -> V_446 , V_443 -> V_446 , sizeof( V_441 -> V_446 ) ) ;
#ifdef F_79
V_8 -> V_447 = F_109 ( V_443 -> V_448 ) ;
#endif
V_433:
F_55 ( & V_120 ) ;
return V_53 ;
...
V_335 = F_38 ( sizeof( * V_335 ) +
( V_451 * sizeof( V_335 -> V_446 [ 0 ] ) ) ,
V_128 ) ;
if ( ! V_335 || ! V_451 )
goto V_452;
F_134 (i, &matched_profiles, mvm->n_nd_match_sets) {
struct V_453 * V_454 ;
struct V_455 * V_456 ;
int V_26 , V_324 = 0 ;
V_454 = & V_443 . V_446 [ V_35 ] ;
for ( V_450 = 0 ; V_450 < V_457 ; V_450 ++ )
V_324 += F_135 ( V_454 -> V_458 [ V_450 ] ) ;
V_456 = F_38 ( sizeof( * V_456 ) +
( V_324 * sizeof( * V_456 -> V_323 ) ) ,
V_128 ) ;
if ( ! V_456 )
goto V_452;
V_335 -> V_446 [ V_335 -> V_451 ++ ] = V_456 ;
V_26 = V_8 -> V_322 - V_35 - 1 ;
V_456 -> V_459 . V_460 = V_8 -> V_317 [ V_26 ] . V_459 . V_460 ;
memcpy ( V_456 -> V_459 . V_459 , V_8 -> V_317 [ V_26 ] . V_459 . V_459 ,
V_456 -> V_459 . V_460 ) ;
if ( V_8 -> V_325 < V_324 )
continue;
for ( V_450 = 0 ; V_450 < V_457 * 8 ; V_450 ++ )
if ( V_454 -> V_458 [ V_450 / 8 ] & ( F_136 ( V_450 % 8 ) ) )
V_456 -> V_323 [ V_456 -> V_324 ++ ] =
V_8 -> V_318 [ V_450 ] -> V_461 ;
}
V_452:
V_360 . V_335 = V_335 ;
V_34:
...
F_104 ( V_4 , V_362 , V_128 ) ;
if ( V_335 ) {
for ( V_35 = 0 ; V_35 < V_335 -> V_451 ; V_35 ++ )
F_29 ( V_335 -> V_446 [ V_35 ] ) ;
F_29 ( V_335 ) ;
}
}
...
return;
if ( ! V_8 -> V_470 ) {
V_8 -> V_470 = F_38 ( V_126 , V_128 ) ;
if ( ! V_8 -> V_470 )
return;
}
F_126 ( V_8 -> V_273 , V_468 , V_8 -> V_470 , V_126 ) ;
#endif
}
static void F_138 ( void * V_6 , T_3 * V_471 ,
struct V_3 * V_4 )
{
if ( V_6 == V_4 )
return;
...
static int F_140 ( struct V_7 * V_8 , bool V_326 )
{
struct V_3 * V_4 = NULL ;
int V_53 ;
enum V_473 V_474 ;
...
if ( F_74 ( V_4 ) )
goto V_124;
V_53 = F_141 ( V_8 -> V_273 , & V_474 , V_326 ) ;
if ( V_53 )
goto V_124;
if ( V_474 != V_475 ) {
F_127 ( V_8 , L_13 ) ;
...
F_143 ( V_8 -> V_2 ,
V_478 ,
F_138 , V_434 ? V_4 : NULL ) ;
V_34:
F_60 ( V_274 , & V_8 -> V_234 ) ;
F_60 ( V_479 , & V_8 -> V_234 ) ;
F_83 ( V_8 , V_341 ) ;
return 1 ;
}
...
{
F_145 ( V_8 -> V_273 ) ;
return F_140 ( V_8 , false ) ;
}
static int F_146 ( struct V_7 * V_8 )
{
bool V_480 ;
enum V_473 V_474 ;
F_141 ( V_8 -> V_273 , & V_474 , false ) ;
F_4 ( & V_8 -> V_354 ) ;
F_147 ( V_355 , & V_8 -> V_356 ) ;
V_480 = F_148 ( V_481 ,
& V_8 -> V_356 ) ;
F_7 ( & V_8 -> V_354 ) ;
if ( V_480 ) {
...
{
struct V_7 * V_8 = F_2 ( V_2 ) ;
if ( V_2 -> V_482 -> V_483 -> V_351 )
return F_146 ( V_8 ) ;
else
return F_144 ( V_8 ) ;
}
void F_153 ( struct V_1 * V_2 , bool V_484 )
{
struct V_7 * V_8 = F_2 ( V_2 ) ;
F_154 ( V_8 -> V_273 -> V_485 , V_484 ) ;
}
static int F_155 ( struct V_486 * V_486 , struct V_487 * V_487 )
{
struct V_7 * V_8 = V_486 -> V_488 ;
int V_124 ;
if ( V_8 -> V_489 )
return - V_319 ;
V_487 -> V_490 = V_486 -> V_488 ;
F_156 ( V_8 -> V_2 ) ;
F_157 () ;
F_158 () ;
V_124 = F_72 ( V_8 -> V_2 , V_8 -> V_2 -> V_482 -> V_483 , true ) ;
F_159 () ;
if ( V_124 > 0 )
V_124 = - V_236 ;
if ( V_124 ) {
...
static T_8 F_161 ( struct V_487 * V_487 , char T_9 * V_491 ,
T_10 V_492 , T_11 * V_493 )
{
struct V_7 * V_8 = V_487 -> V_490 ;
T_4 V_494 ;
while ( true ) {
if ( V_8 -> V_339 ) {
V_494 = F_162 ( V_8 -> V_273 ,
V_8 -> V_339 ) ;
if ( V_494 )
break;
}
...
static void F_164 ( void * V_41 , T_3 * V_471 ,
struct V_3 * V_4 )
{
if ( V_41 == V_4 )
return;
...
static int F_166 ( struct V_486 * V_486 , struct V_487 * V_487 )
{
struct V_7 * V_8 = V_486 -> V_488 ;
int V_495 = 10 ;
V_8 -> V_489 = false ;
