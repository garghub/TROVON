...
V_65 , V_65 -> V_7 ) ;
F_52 ( & V_62 -> V_75 ) ;
F_53 ( & V_65 -> V_6 , & V_64 -> V_76 ) ;
V_64 -> V_77 ++ ;
F_54 ( & V_62 -> V_75 ) ;
V_43 = F_55 ( V_64 -> V_78 , V_17 ,
& V_65 -> V_5 ) ;
if ( V_43 ) {
V_43 = - V_59 ;
goto V_69;
...
int F_58 ( struct V_61 * V_62 , char * V_17 )
{
struct V_63 * V_64 ;
struct V_1 * V_2 ;
V_64 = & ( V_62 -> V_66 . V_64 ) ;
V_2 = F_59 ( V_64 -> V_78 , V_17 ) ;
if ( V_2 == NULL )
return - V_80 ;
if ( ! F_50 ( V_2 -> V_7 ) ) {
F_2 ( V_3 , L_8 , V_2 -> V_7 ) ;
...
int F_60 ( struct V_61 * V_62 , char * V_17 , char * V_81 )
{
struct V_82 V_83 ;
struct V_63 * V_64 ;
struct V_1 * V_2 ;
...
int F_66 ( struct V_61 * V_62 , char * V_17 , char * V_81 )
{
struct V_82 V_83 ;
struct V_63 * V_64 ;
struct V_1 * V_2 ;
...
int F_67 ( T_1 V_34 , struct V_1 * V_2 )
{
int V_15 , V_43 ;
F_1 ( V_2 ) ;
F_24 ( & F_25 ( V_2 ) ) ;
for ( V_15 = 0 ; V_15 < F_23 ( V_2 ) ; V_15 ++ ) {
if ( F_68 ( V_2 ) [ V_15 ] == V_34 ) {
V_43 = 0 ;
goto V_58;
}
}
...
struct V_1 * F_69 ( struct V_63 * V_64 , char * V_17 )
{
struct V_1 * V_2 ;
V_2 = NULL ;
if ( V_17 [ 0 ] != '\0' ) {
