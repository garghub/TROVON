...
static int
F_37 ( struct V_35 * V_36 , int V_76 )
{
struct V_33 * V_34 = V_36 -> V_59 ;
switch ( V_76 ) {
case V_77 :
...
static int
F_39 ( struct V_35 * V_36 , int V_76 )
{
struct V_33 * V_34 = V_36 -> V_59 ;
switch ( V_76 ) {
case V_77 :
...
static T_1
F_40 ( struct V_35 * V_80 )
{
struct V_33 * V_34 = V_80 -> V_59 ;
return F_41 ( & V_34 -> V_53 ) ;
}
static T_1
F_42 ( struct V_35 * V_80 )
{
struct V_33 * V_34 = V_80 -> V_59 ;
...
struct V_81 * V_19 ;
int V_41 ;
V_41 = F_44 ( V_34 -> V_82 , V_34 -> V_82 -> V_83 , 0 , 1 , 1 , & V_19 ) ;
if ( V_41 < 0 )
goto V_58;
V_19 -> V_59 = V_34 ;
