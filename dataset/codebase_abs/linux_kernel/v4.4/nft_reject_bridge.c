...
const unsigned char * V_70 = F_5 ( V_67 -> V_47 ) -> V_8 ;
if ( F_45 ( V_70 ) ||
F_46 ( V_70 ) )
goto V_71;
...
switch ( V_69 -> type ) {
case V_73 :
F_18 ( V_67 -> V_47 , V_67 -> V_74 ,
V_67 -> V_12 ,
V_69 -> V_75 ) ;
break;
case V_76 :
F_7 ( V_67 -> V_47 , V_67 -> V_74 ,
V_67 -> V_12 ) ;
break;
case V_77 :
F_18 ( V_67 -> V_47 , V_67 -> V_74 ,
...
switch ( V_69 -> type ) {
case V_73 :
F_41 ( V_67 -> V_39 , V_67 -> V_47 ,
V_67 -> V_74 , V_67 -> V_12 ,
V_69 -> V_75 ) ;
break;
case V_76 :
F_32 ( V_67 -> V_39 , V_67 -> V_47 ,
V_67 -> V_74 , V_67 -> V_12 ) ;
break;
case V_77 :
F_41 ( V_67 -> V_39 , V_67 -> V_47 ,
...
static int F_49 ( const struct V_81 * V_82 ,
const struct V_62 * V_63 ,
const struct V_83 * * V_52 )
{
return F_50 ( V_82 -> V_84 , ( 1 << V_85 ) |
( 1 << V_86 ) ) ;
}
static int F_51 ( const struct V_81 * V_82 ,
const struct V_62 * V_63 ,
const struct V_87 * const V_88 [] )
{
struct V_68 * V_69 = F_44 ( V_63 ) ;
int V_75 , V_89 ;
V_89 = F_49 ( V_82 , V_63 , NULL ) ;
if ( V_89 < 0 )
return V_89 ;
if ( V_88 [ V_90 ] == NULL )
return - V_91 ;
V_69 -> type = F_52 ( F_53 ( V_88 [ V_90 ] ) ) ;
switch ( V_69 -> type ) {
case V_73 :
case V_77 :
if ( V_88 [ V_92 ] == NULL )
...
if ( F_56 ( V_47 , V_90 , F_57 ( V_69 -> type ) ) )
goto V_94;
switch ( V_69 -> type ) {
case V_73 :
case V_77 :
if ( F_58 ( V_47 , V_92 , V_69 -> V_75 ) )
goto V_94;
break;
default:
break;
