...
if ( V_5 -> V_17 & V_18 ) {
for ( V_9 = 0 ; V_9 < V_19 ; V_9 ++ ) {
V_8 = ( char * ) V_5 + V_20 [ V_9 ] . V_50 ;
* ( V_3 ++ ) = ( V_20 [ V_9 ] . V_51 ==
sizeof( T_4 ) ) ? * ( T_4 * ) V_8 : * ( T_2 * ) V_8 ;
}
}
for ( V_9 = 0 ; V_9 < V_21 ; V_9 ++ ) {
V_8 = ( char * ) & V_5 -> V_23 . V_52 + V_22 [ V_9 ] . V_50 ;
* ( V_3 ++ ) = ( V_22 [ V_9 ] . V_51 ==
sizeof( T_4 ) ) ? * ( T_4 * ) V_8 : * ( T_2 * ) V_8 ;
}
if ( V_5 -> V_23 . V_24 . type != V_25 ) {
...
for ( V_10 = 0 ; V_10 < V_21 ; V_10 ++ ) {
V_8 = ( char * ) & V_54 -> V_52 + V_22 [ V_10 ] . V_50 ;
* ( V_3 ++ ) = ( V_22 [ V_10 ] . V_51 ==
sizeof( T_4 ) ) ? * ( T_4 * ) V_8 : * ( T_2 * ) V_8 ;
}
}
...
V_128 -> V_129 =
! ! ( V_5 -> V_130 & V_131 ) ;
V_128 -> V_132 = V_5 -> V_130 & ~ V_131 ;
V_128 -> V_133 =
! ! ( V_5 -> V_134 & V_131 ) ;
V_128 -> V_135 = V_5 -> V_134 & ~ V_131 ;
return 0 ;
}
...
static int F_78 ( struct V_1 * V_2 , struct V_146 * V_147 ,
T_2 T_3 * V_169 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
int V_170 = - V_42 ;
...
static int F_83 ( struct V_4 * V_5 , T_4 * V_3 )
{
struct V_39 * V_23 = & V_5 -> V_23 ;
...
if ( F_83 ( V_5 , & V_3 [ V_201 ] ) )
V_199 -> V_17 |= V_200 ;
}
static T_2 F_91 ( struct V_1 * V_43 )
{
struct V_4 * V_5 = F_2 ( V_43 ) ;
T_2 V_202 = 0 ;
if ( V_5 -> V_17 & V_18 )
...
static int F_92 ( struct V_1 * V_43 , T_2 V_202 )
{
struct V_4 * V_5 = F_2 ( V_43 ) ;
if ( V_202 >= ( 1 << V_37 ) )
return - V_96 ;
...
static T_2 F_93 ( struct V_1 T_3 * V_43 )
{
return V_204 * V_205 ;
}
static int F_94 ( struct V_1 * V_43 , T_2 * V_206 )
{
struct V_4 * V_5 = F_2 ( V_43 ) ;
int V_9 ;
if ( ! V_206 )
...
static int F_95 ( struct V_1 * V_43 , const T_2 * V_206 )
{
struct V_4 * V_5 = F_2 ( V_43 ) ;
struct V_39 * V_23 = & V_5 -> V_23 ;
int V_9 ;
...
continue;
V_5 -> V_207 [ V_9 ] = V_207 ;
F_81 ( V_23 , F_43 ( 0 , V_9 ) , V_207 ) ;
}
return 0 ;
}
static T_2 F_96 ( struct V_1 T_3 * V_43 )
{
return V_212 * V_213 ;
}
static int F_97 ( struct V_1 * V_43 , T_2 * V_206 , T_1 * V_214 ,
T_1 * V_215 )
{
struct V_4 * V_5 = F_2 ( V_43 ) ;
int V_9 , V_112 ;
if ( V_215 )
* V_215 = V_216 ;
V_112 = F_94 ( V_43 , V_206 ) ;
if ( V_112 || ! V_214 )
return V_112 ;
for ( V_9 = 0 ; V_9 < V_212 ; V_9 ++ , V_214 += 4 )
* ( V_217 * ) V_214 = F_98 ( V_5 -> V_218 [ V_9 ] ) ;
return 0 ;
}
static int F_99 ( struct V_1 * V_43 , const T_2 * V_206 ,
...
return V_112 ;
for ( V_9 = 0 ; V_9 < V_212 ; V_9 ++ , V_214 += 4 ) {
T_2 V_218 = F_100 ( * ( V_217 * ) V_214 ) ;
if ( V_5 -> V_218 [ V_9 ] == V_218 )
continue;
V_5 -> V_218 [ V_9 ] = V_218 ;
F_81 ( V_23 , F_42 ( 0 , V_9 ) , V_218 ) ;
}
return 0 ;
}
...
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_39 * V_23 = & V_5 -> V_23 ;
V_223 -> V_220 = F_101 ( V_2 ) ;
V_223 -> V_224 = F_105 ( V_23 ) ;
...
return - V_96 ;
if ( V_223 -> V_225 != F_105 ( V_23 ) )
return - V_96 ;
if ( V_122 > F_101 ( V_2 ) )
return - V_96 ;
V_5 -> V_209 [ V_210 ] . V_229 = V_122 ;
return F_107 ( V_2 , F_102 ( V_2 ) ) ;
}
