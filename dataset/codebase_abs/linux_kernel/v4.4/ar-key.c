...
return - V_4 ;
V_110 = F_15 ( V_114 + 1 , V_19 ) ;
if ( ! V_110 )
return - V_20 ;
if ( F_41 ( V_110 , V_113 , V_114 ) ) {
F_8 ( V_110 ) ;
return - V_116 ;
}
V_110 [ V_114 ] = 0 ;
V_107 = F_42 ( & V_117 , V_110 , NULL ) ;
if ( F_31 ( V_107 ) ) {
F_8 ( V_110 ) ;
F_9 ( L_34 , F_32 ( V_107 ) ) ;
return F_32 ( V_107 ) ;
...
int F_44 ( struct V_121 * V_122 ,
const void * V_29 ,
T_7 V_27 ,
T_3 V_25 )
{
const struct V_123 * V_123 = F_45 () ;
struct V_107 * V_107 ;
int V_68 ;
struct {
T_3 V_100 ;
...
V_134 += F_54 ( strlen ( V_35 -> V_37 [ V_36 ] ) ) ;
V_134 += 4 + F_54 ( strlen ( V_35 -> V_39 ) ) ;
V_134 += 8 + F_54 ( V_11 -> V_74 -> V_46 . V_62 ) ;
V_134 += 4 * 8 + 2 * 4 ;
V_134 += 4 + V_11 -> V_74 -> V_48 * 8 ;
for ( V_36 = 0 ; V_36 < V_11 -> V_74 -> V_48 ; V_36 ++ )
V_134 += F_54 ( V_11 -> V_74 -> V_47 [ V_36 ] . V_62 ) ;
V_134 += 4 + F_54 ( V_11 -> V_74 -> V_23 ) ;
V_134 += 4 + F_54 ( V_11 -> V_74 -> V_85 ) ;
V_134 += 4 + V_11 -> V_74 -> V_50 * 8 ;
for ( V_36 = 0 ; V_36 < V_11 -> V_74 -> V_50 ; V_36 ++ )
V_134 += F_54 ( V_11 -> V_74 -> V_49 [ V_36 ] . V_62 ) ;
break;
default:
F_27 () ;
continue;
