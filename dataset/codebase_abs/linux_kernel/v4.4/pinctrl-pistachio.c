...
return ! ( F_9 ( V_11 , V_73 ) & F_41 ( V_13 ) ) ;
}
static int F_42 ( struct V_7 * V_72 , unsigned V_13 )
{
struct V_6 * V_11 = F_5 ( V_72 ) ;
T_1 V_3 ;
if ( F_9 ( V_11 , V_73 ) & F_41 ( V_13 ) )
V_3 = V_74 ;
else
V_3 = V_75 ;
return ! ! ( F_9 ( V_11 , V_3 ) & F_41 ( V_13 ) ) ;
}
static void F_43 ( struct V_7 * V_72 , unsigned V_13 ,
int V_76 )
{
struct V_6 * V_11 = F_5 ( V_72 ) ;
F_11 ( V_11 , V_74 , V_13 , ! ! V_76 ) ;
}
static int F_44 ( struct V_7 * V_72 ,
unsigned V_13 )
{
struct V_6 * V_11 = F_5 ( V_72 ) ;
...
static int F_45 ( struct V_7 * V_72 ,
...
static void F_46 ( struct V_9 * V_77 )
{
struct V_6 * V_11 = F_7 ( V_77 ) ;
F_11 ( V_11 , V_78 , V_77 -> V_79 , 0 ) ;
}
static void F_47 ( struct V_9 * V_77 )
{
struct V_6 * V_11 = F_7 ( V_77 ) ;
F_11 ( V_11 , V_80 , V_77 -> V_79 , 0 ) ;
}
static void F_48 ( struct V_9 * V_77 )
{
struct V_6 * V_11 = F_7 ( V_77 ) ;
F_11 ( V_11 , V_80 , V_77 -> V_79 , 1 ) ;
}
static unsigned int F_49 ( struct V_9 * V_77 )
{
...
static int F_50 ( struct V_9 * V_77 , unsigned int type )
{
struct V_6 * V_11 = F_7 ( V_77 ) ;
switch ( type & V_81 ) {
case V_82 :
...
{
struct V_7 * V_8 = F_53 ( V_98 ) ;
struct V_6 * V_11 = F_5 ( V_8 ) ;
struct V_99 * V_72 = F_54 ( V_98 ) ;
unsigned long V_100 ;
unsigned int V_23 ;
F_55 ( V_72 , V_98 ) ;
V_100 = F_9 ( V_11 , V_78 ) &
F_9 ( V_11 , V_80 ) ;
F_56 (pin, &pending, 16 )
F_57 ( F_58 ( V_8 -> V_101 , V_23 ) ) ;
F_59 ( V_72 , V_98 ) ;
}
static int F_60 ( struct V_1 * V_2 )
{
struct V_102 * V_103 = V_2 -> V_37 -> V_104 ;
struct V_6 * V_11 ;
unsigned int V_34 ;
int V_105 , V_106 = 0 ;
...
V_109 = F_61 ( V_103 , V_108 ) ;
if ( ! V_109 ) {
F_23 ( V_2 -> V_37 , L_6 , V_34 ) ;
V_106 = - V_110 ;
goto V_111;
}
if ( ! F_62 ( V_109 , L_7 , NULL ) ) {
F_23 ( V_2 -> V_37 ,
L_8 , V_34 ) ;
V_106 = - V_110 ;
goto V_111;
...
V_105 = F_63 ( V_109 , 0 ) ;
if ( V_105 < 0 ) {
F_23 ( V_2 -> V_37 , L_9 , V_34 , V_105 ) ;
V_106 = V_105 ;
goto V_111;
}
V_11 = & V_2 -> V_112 [ V_34 ] ;
V_11 -> V_2 = V_2 ;
V_11 -> V_4 = V_2 -> V_4 + F_64 ( V_34 ) ;
V_11 -> V_7 . V_37 = V_2 -> V_37 ;
V_11 -> V_7 . V_104 = V_109 ;
V_106 = F_65 ( & V_11 -> V_7 ) ;
if ( V_106 < 0 ) {
F_23 ( V_2 -> V_37 , L_10 ,
V_34 , V_106 ) ;
...
struct V_117 * V_118 ;
int V_106 ;
V_2 = F_72 ( & V_116 -> V_37 , sizeof( * V_2 ) , V_119 ) ;
if ( ! V_2 )
return - V_120 ;
V_2 -> V_37 = & V_116 -> V_37 ;
F_73 ( & V_116 -> V_37 , V_2 ) ;
V_118 = F_74 ( V_116 , V_121 , 0 ) ;
V_2 -> V_4 = F_75 ( & V_116 -> V_37 , V_118 ) ;
if ( F_76 ( V_2 -> V_4 ) )
return F_77 ( V_2 -> V_4 ) ;
V_2 -> V_21 = V_122 ;
...
V_2 -> V_16 = F_78 ( & V_126 , & V_116 -> V_37 ,
V_2 ) ;
if ( F_76 ( V_2 -> V_16 ) ) {
F_23 ( & V_116 -> V_37 , L_13 ) ;
return F_77 ( V_2 -> V_16 ) ;
}
V_106 = F_60 ( V_2 ) ;
if ( V_106 < 0 ) {
F_79 ( V_2 -> V_16 ) ;
