...
{
F_9 ( V_22 , V_16 , V_23 ) ;
return F_52 ( V_22 -> V_149 + V_16 ) ;
}
static int F_53 ( struct V_21 * V_22 , unsigned V_16 )
{
unsigned int V_18 ;
unsigned int V_19 ;
...
static int F_56 ( struct V_21 * V_22 , unsigned V_16 )
{
const struct V_106 * V_4 ;
struct V_2 * V_3 = F_10 ( V_22 -> V_24 ) ;
int V_152 ;
...
return - V_32 ;
V_152 = F_57 ( V_3 -> V_154 , V_4 -> V_146 . V_147 ) ;
if ( ! V_152 )
return - V_32 ;
return V_152 ;
}
static int F_58 ( struct V_155 * V_156 )
{
struct V_2 * V_3 = F_59 ( V_156 ) ;
const struct V_106 * V_4 ;
int V_85 ;
...
V_85 = F_60 ( V_3 -> V_22 , V_4 -> V_4 . V_112 ) ;
if ( V_85 ) {
F_18 ( V_3 -> V_24 , L_9 ,
F_61 ( V_156 ) ) ;
return V_85 ;
...
F_63 ( V_3 -> V_22 , V_4 -> V_4 . V_112 ) ;
}
static void T_2 * F_64 ( struct V_2 * V_3 ,
...
void T_2 * V_161 = F_64 ( V_3 , V_145 ,
V_166 -> V_50 ) ;
return ! ! ( F_66 ( V_161 ) & V_19 ) ;
}
static int F_68 ( struct V_2 * V_3 , int V_157 )
{
int V_170 , V_171 ;
unsigned int V_172 ;
const struct V_165 * V_166 = & ( V_3 -> V_5 -> V_166 ) ;
T_1 V_50 = F_5 ( V_157 & 0x1f ) ;
T_1 V_173 = ( V_157 >> 5 ) & V_166 -> V_10 ;
void T_2 * V_161 = V_3 -> V_163 + ( V_173 << 2 ) ;
const struct V_106 * V_4 ;
V_4 = F_47 ( V_3 , V_157 ) ;
V_171 = F_55 ( V_3 -> V_22 , V_4 -> V_4 . V_112 ) ;
do {
V_170 = V_171 ;
if ( V_170 )
V_172 = V_166 -> V_174 ;
...
void T_2 * V_161 = F_64 ( V_3 , V_156 -> V_157 ,
V_166 -> V_176 ) ;
F_69 ( V_50 , V_161 ) ;
}
static void F_71 ( struct V_155 * V_156 )
{
struct V_2 * V_3 = F_59 ( V_156 ) ;
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
...
F_68 ( V_3 , V_156 -> V_157 ) ;
}
static int F_72 ( struct V_21 * V_22 , unsigned V_16 ,
unsigned V_179 )
{
struct V_2 * V_3 = F_10 ( V_22 -> V_24 ) ;
...
V_183 = 0xff << V_181 ;
F_69 ( V_183 , V_3 -> V_163 + V_184 ) ;
V_19 = ( ( V_187 << V_192 ) | V_193 ) <<
V_181 ;
V_185 = V_194 << V_181 ;
F_69 ( V_185 | V_19 , V_3 -> V_163 + V_182 ) ;
F_74 ( 1 ) ;
if ( V_186 == 1 )
F_71 ( V_156 ) ;
return 0 ;
...
static int F_76 ( struct V_155 * V_156 , unsigned int V_202 )
{
struct V_2 * V_3 = F_59 ( V_156 ) ;
...
static void F_77 ( const struct V_165 * V_22 ,
...
V_161 = V_163 + ( V_173 << 2 ) ;
F_78 ( ~ V_204 [ V_173 ] , V_161 + V_22 -> V_176 ) ;
F_78 ( V_204 [ V_173 ] , V_161 + V_22 -> V_177 ) ;
}
}
static void F_79 ( const struct V_165 * V_22 ,
void T_2 * V_163 , T_1 * V_204 )
{
int V_173 ;
void T_2 * V_161 ;
...
V_204 [ V_173 ] = ~ F_80 ( V_161 ) ;
}
}
static int F_81 ( struct V_206 * V_206 )
{
void T_2 * V_161 ;
...
& V_3 -> V_5 -> V_166 ;
V_161 = V_3 -> V_163 ;
F_79 ( V_166 , V_161 , V_3 -> V_207 ) ;
F_77 ( V_166 , V_161 , V_3 -> V_203 ) ;
return 0 ;
}
static int F_82 ( struct V_206 * V_206 )
{
struct V_2 * V_3 = F_10 ( V_206 ) ;
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
...
static void F_83 ( struct V_155 * V_156 )
{
struct V_2 * V_3 = F_59 ( V_156 ) ;
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
...
static unsigned int F_84 ( struct V_2 * V_3 )
{
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
...
F_69 ( 0xffffffff , V_161 ) ;
V_161 += 4 ;
}
return 0 ;
}
static inline void
F_85 ( struct V_2 * V_3 , int V_210 )
{
...
V_187 = F_66 ( V_3 -> V_163 + V_211 ) ;
V_19 = V_193 << ( ( V_210 % 4 ) * 8 ) ;
if ( ( V_19 & V_187 ) > 0 ) {
V_211 = ( V_210 / 4 ) * 4 + V_166 -> V_189 ;
V_185 = V_194 << ( ( V_210 % 4 ) * 8 ) ;
F_69 ( V_185 , V_3 -> V_163 + V_211 ) ;
}
}
static void F_86 ( struct V_213 * V_148 )
{
struct V_214 * V_22 = F_87 ( V_148 ) ;
struct V_2 * V_3 = F_88 ( V_148 ) ;
unsigned int V_215 , V_145 ;
int V_16 , V_210 , V_180 ;
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
void T_2 * V_161 = F_64 ( V_3 , 0 , V_166 -> V_216 ) ;
...
V_16 = F_90 ( V_215 ) ;
V_210 = V_145 + V_16 ;
V_180 = F_57 ( V_3 -> V_154 , V_210 ) ;
V_215 &= ~ F_5 ( V_16 ) ;
V_217 = V_3 -> V_178 [ V_210 ] ;
if ( V_217 ) {
F_69 ( F_5 ( V_16 ) , V_161 - V_166 -> V_216 +
V_166 -> V_218 ) ;
V_4 = F_47 ( V_3 , V_210 ) ;
V_170 = F_55 ( V_3 -> V_22 ,
V_4 -> V_4 . V_112 ) ;
...
{
struct V_2 * V_3 = F_94 ( V_221 ) ;
int V_40 ;
V_3 -> V_102 = V_3 -> V_5 -> V_54 ;
V_3 -> V_97 = F_95 ( & V_221 -> V_24 , V_3 -> V_102 ,
sizeof( * V_3 -> V_97 ) , V_222 ) ;
if ( ! V_3 -> V_97 )
return - V_223 ;
V_3 -> V_140 = F_95 ( & V_221 -> V_24 , V_3 -> V_102 ,
...
V_3 = F_97 ( & V_221 -> V_24 , sizeof( * V_3 ) , V_222 ) ;
if ( ! V_3 )
return - V_223 ;
F_98 ( V_221 , V_3 ) ;
...
V_124 = F_99 ( V_137 , L_13 , 0 ) ;
if ( V_124 ) {
V_3 -> V_9 = F_100 ( V_124 ) ;
if ( F_101 ( V_3 -> V_9 ) )
return F_102 ( V_3 -> V_9 ) ;
} else if ( V_1 ) {
V_3 -> V_9 = V_1 ;
} else {
...
V_107 = F_95 ( & V_221 -> V_24 , V_3 -> V_5 -> V_54 , sizeof( * V_107 ) ,
V_222 ) ;
if ( ! V_107 )
return - V_223 ;
for ( V_40 = 0 ; V_40 < V_3 -> V_5 -> V_54 ; V_40 ++ )
V_107 [ V_40 ] = V_3 -> V_5 -> V_107 [ V_40 ] . V_4 ;
V_3 -> V_231 . V_110 = F_103 ( & V_221 -> V_24 ) ;
...
V_3 -> V_24 = & V_221 -> V_24 ;
V_3 -> V_158 = F_104 ( & V_3 -> V_231 , & V_221 -> V_24 , V_3 ) ;
if ( F_101 ( V_3 -> V_158 ) ) {
F_18 ( & V_221 -> V_24 , L_16 ) ;
return F_102 ( V_3 -> V_158 ) ;
}
V_3 -> V_22 = F_97 ( & V_221 -> V_24 , sizeof( * V_3 -> V_22 ) , V_222 ) ;
if ( ! V_3 -> V_22 ) {
V_85 = - V_223 ;
goto V_240;
}
...
V_3 -> V_22 -> V_243 = F_103 ( & V_221 -> V_24 ) ;
...
V_85 = F_106 ( V_3 -> V_22 , F_103 ( & V_221 -> V_24 ) ,
0 , 0 , V_3 -> V_5 -> V_54 ) ;
if ( V_85 ) {
V_85 = - V_32 ;
goto V_244;
...
if ( ! F_107 ( V_137 , L_17 ) )
return 0 ;
V_229 = F_108 ( V_221 , V_245 , 0 ) ;
if ( ! V_229 ) {
F_18 ( & V_221 -> V_24 , L_18 ) ;
V_85 = - V_32 ;
goto V_244;
}
V_3 -> V_163 = F_109 ( & V_221 -> V_24 , V_229 ) ;
if ( F_101 ( V_3 -> V_163 ) ) {
V_85 = - V_32 ;
goto V_244;
}
V_230 = V_3 -> V_5 -> V_166 . V_205 ;
V_3 -> V_203 = F_95 ( & V_221 -> V_24 , V_230 ,
sizeof( * V_3 -> V_203 ) , V_222 ) ;
if ( ! V_3 -> V_203 ) {
V_85 = - V_223 ;
goto V_244;
}
V_3 -> V_207 = F_95 ( & V_221 -> V_24 , V_230 ,
sizeof( * V_3 -> V_207 ) , V_222 ) ;
if ( ! V_3 -> V_207 ) {
V_85 = - V_223 ;
goto V_244;
}
V_3 -> V_178 = F_95 ( & V_221 -> V_24 , V_3 -> V_5 -> V_162 ,
sizeof( int ) , V_222 ) ;
if ( ! V_3 -> V_178 ) {
V_85 = - V_223 ;
goto V_244;
...
int V_180 = F_112 ( V_3 -> V_154 , V_40 ) ;
F_113 ( V_180 , & V_247 ,
V_248 ) ;
F_114 ( V_180 , V_3 ) ;
}
F_115 ( V_152 , F_86 , V_3 ) ;
return 0 ;
V_244:
F_116 ( V_3 -> V_22 ) ;
V_240:
