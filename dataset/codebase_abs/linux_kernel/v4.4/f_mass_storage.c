...
{
#define F_147 32
if ( V_244 >= 2 && V_244 <= F_147 )
return 0 ;
F_148 ( L_65 ,
V_244 , 2 , F_147 ) ;
return - V_97 ;
}
static struct V_1 * F_149 ( struct V_1 * V_2 )
{
if ( ! V_2 ) {
V_2 = F_150 ( sizeof( * V_2 ) , V_78 ) ;
if ( ! V_2 )
return F_151 ( - V_240 ) ;
V_2 -> V_282 = 1 ;
} else {
...
void F_157 ( struct V_1 * V_2 , bool V_283 )
{
V_2 -> V_283 = V_283 ;
}
static void F_158 ( struct V_11 * V_245 , unsigned V_284 )
{
if ( V_245 ) {
...
int F_160 ( struct V_1 * V_2 , unsigned int V_284 )
{
struct V_11 * V_12 , * V_245 ;
int V_51 , V_33 ;
V_33 = F_146 ( V_284 ) ;
if ( V_33 != 0 )
return V_33 ;
V_245 = F_161 ( V_284 , sizeof( * V_245 ) , V_78 ) ;
if ( ! V_245 )
return - V_240 ;
V_12 = V_245 ;
V_51 = V_284 ;
...
++ V_12 ;
V_285:
V_12 -> V_48 = F_162 ( V_103 , V_78 ) ;
if ( F_48 ( ! V_12 -> V_48 ) )
goto V_286;
} while ( -- V_51 );
V_12 -> V_114 = V_245 ;
F_158 ( V_2 -> V_245 , V_2 -> V_244 ) ;
V_2 -> V_244 = V_284 ;
V_2 -> V_245 = V_245 ;
return 0 ;
V_286:
...
void F_163 ( struct V_85 * V_197 )
{
if ( F_164 ( & V_197 -> V_275 ) )
F_165 ( & V_197 -> V_275 ) ;
F_79 ( V_197 ) ;
F_159 ( V_197 ) ;
}
static void F_166 ( struct V_1 * V_2 , int V_284 )
{
int V_51 ;
...
static T_6 F_175 ( struct V_297 * V_298 ,
struct V_299 * V_277 , int V_300 )
{
struct V_274 * V_275 = F_176 ( V_298 ) ;
...
int F_177 ( struct V_1 * V_2 , struct V_306 * V_307 ,
...
F_178 ( & V_197 -> V_275 , & V_2 -> V_169 ) ;
F_179 ( & V_197 -> V_275 , L_67 , V_20 ) ;
V_197 -> V_20 = F_180 ( & V_197 -> V_275 ) ;
V_33 = F_181 ( & V_197 -> V_275 ) ;
if ( V_33 ) {
F_182 ( L_68 , V_296 , V_33 ) ;
F_183 ( & V_197 -> V_275 ) ;
goto V_319;
}
}
...
if ( V_307 -> V_313 ) {
V_33 = F_184 ( V_197 , V_307 -> V_313 ) ;
if ( V_33 )
goto V_320;
}
V_309 = F_162 ( V_321 , V_78 ) ;
V_310 = L_69 ;
if ( F_76 ( V_197 ) ) {
V_310 = L_70 ;
if ( V_309 ) {
V_310 = F_185 ( V_197 -> V_108 , V_309 , V_321 ) ;
if ( F_172 ( V_310 ) )
V_310 = L_70 ;
}
}
...
int F_186 ( struct V_1 * V_2 , struct V_322 * V_307 )
{
char V_48 [ 8 ] ;
int V_51 , V_33 ;
F_167 ( V_2 ) ;
...
V_33 = F_177 ( V_2 , & V_307 -> V_52 [ V_51 ] , V_51 , V_48 , NULL ) ;
if ( V_33 )
goto V_324;
}
F_182 ( L_77 , V_307 -> V_323 ) ;
return 0 ;
V_324:
F_166 ( V_2 , V_51 ) ;
return V_33 ;
}
void F_187 ( struct V_1 * V_2 , const char * V_325 ,
const char * V_326 )
{
int V_51 ;
V_51 = F_188 () ;
...
if ( F_172 ( V_2 -> V_24 ) ) {
V_2 -> V_9 = V_262 ;
return F_173 ( V_2 -> V_24 ) ;
}
F_8 ( V_2 , L_83 , F_191 ( V_2 -> V_24 ) ) ;
F_12 ( V_2 -> V_24 ) ;
return 0 ;
}
...
static int F_193 ( struct V_328 * V_329 , struct V_6 * V_7 )
{
struct V_5 * V_4 = F_3 ( V_7 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
V_334 = F_194 ( V_7 -> V_335 ) ;
if ( ! V_334 -> V_336 ) {
V_332 = F_170 ( V_4 -> V_2 , V_329 -> V_261 ,
V_4 -> V_2 -> V_176 ) ;
if ( V_332 )
return V_332 ;
F_187 ( V_4 -> V_2 , NULL , NULL ) ;
V_332 = F_189 ( V_4 -> V_2 ) ;
if ( V_332 )
return V_332 ;
}
V_4 -> V_249 = V_249 ;
V_51 = F_195 ( V_329 , V_7 ) ;
if ( V_51 < 0 )
goto V_324;
V_293 . V_337 = V_51 ;
V_4 -> V_69 = V_51 ;
V_19 = F_196 ( V_249 , & V_338 ) ;
if ( ! V_19 )
goto V_339;
V_4 -> V_21 = V_19 ;
V_19 = F_196 ( V_249 , & V_340 ) ;
if ( ! V_19 )
goto V_339;
V_4 -> V_22 = V_19 ;
V_341 . V_342 =
...
V_343 . V_342 =
V_340 . V_342 ;
V_331 = F_197 ( unsigned , V_103 / 1024 , 15 ) ;
V_344 . V_342 =
V_338 . V_342 ;
V_345 . V_346 = V_331 ;
V_347 . V_342 =
...
static void F_199 ( struct V_328 * V_329 , struct V_6 * V_7 )
{
struct V_5 * V_4 = F_3 ( V_7 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
F_8 ( V_4 , L_86 ) ;
...
V_4 -> V_2 -> V_241 = NULL ;
F_13 ( V_4 -> V_2 , V_255 ) ;
F_200 ( V_2 -> V_248 , V_2 -> V_4 != V_4 ) ;
}
F_201 ( & V_4 -> V_8 ) ;
}
static inline struct V_353 * F_202 ( struct V_354 * V_355 )
{
return F_4 ( F_203 ( V_355 ) , struct V_353 , V_356 ) ;
}
static inline struct V_333 * F_204 ( struct V_354 * V_355 )
{
return F_4 ( F_203 ( V_355 ) , struct V_333 ,
V_357 . V_356 ) ;
}
static void F_205 ( struct V_354 * V_355 )
{
struct V_353 * V_358 ;
V_358 = F_202 ( V_355 ) ;
F_159 ( V_358 ) ;
...
{
struct V_353 * V_334 = F_202 ( V_355 ) ;
struct V_333 * V_333 = F_204 ( V_334 -> V_356 . V_360 . V_361 ) ;
...
static T_4 F_208 ( struct V_354 * V_355 , char * V_359 )
{
return F_129 ( F_202 ( V_355 ) -> V_197 , V_359 ) ;
}
...
char * V_359 )
{
return F_211 ( F_202 ( V_355 ) -> V_197 , V_359 ) ;
}
static T_4 F_212 ( struct V_354 * V_355 ,
const char * V_359 , T_5 V_159 )
{
return F_213 ( F_202 ( V_355 ) -> V_197 , V_359 , V_159 ) ;
}
static T_4 F_214 ( struct V_354 * V_355 , char * V_359 )
{
return F_215 ( F_202 ( V_355 ) -> V_197 , V_359 ) ;
}
...
struct V_353 * V_334 = F_202 ( V_355 ) ;
struct V_333 * V_333 = F_204 ( V_334 -> V_356 . V_360 . V_361 ) ;
return F_217 ( V_334 -> V_197 , & V_333 -> V_2 -> V_169 , V_359 ,
V_159 ) ;
}
static T_4 F_218 ( struct V_354 * V_355 , char * V_359 )
{
return F_131 ( F_202 ( V_355 ) -> V_197 , V_359 ) ;
}
static T_4 F_219 ( struct V_354 * V_355 ,
const char * V_359 , T_5 V_159 )
{
return F_138 ( F_202 ( V_355 ) -> V_197 , V_359 , V_159 ) ;
}
static struct V_362 * F_220 ( struct V_362 * V_356 ,
const char * V_20 )
{
struct V_353 * V_334 ;
struct V_333 * V_333 ;
...
V_364 ++ ;
V_332 = F_221 ( V_364 , 0 , & V_365 ) ;
if ( V_332 )
return F_151 ( V_332 ) ;
V_333 = F_204 ( & V_356 -> V_360 ) ;
if ( V_365 >= V_366 )
return F_151 ( - V_367 ) ;
F_222 ( & V_333 -> V_28 ) ;
...
V_363 . V_142 = true ;
V_332 = F_177 ( V_333 -> V_2 , & V_363 , V_365 , V_20 ,
...
V_334 -> V_371 = V_365 ;
F_223 ( & V_333 -> V_28 ) ;
F_224 ( & V_334 -> V_356 , V_20 , & V_372 ) ;
return & V_334 -> V_356 ;
V_369:
F_223 ( & V_333 -> V_28 ) ;
return F_151 ( V_332 ) ;
}
static void F_225 ( struct V_362 * V_356 , struct V_354 * V_355 )
{
struct V_353 * V_358 ;
struct V_333 * V_333 ;
V_358 = F_202 ( V_355 ) ;
...
static void F_228 ( struct V_354 * V_355 )
{
struct V_333 * V_334 = F_204 ( V_355 ) ;
F_229 ( & V_334 -> V_357 ) ;
}
...
int V_373 ;
F_222 ( & V_334 -> V_28 ) ;
V_373 = sprintf ( V_359 , L_88 , V_334 -> V_2 -> V_176 ) ;
F_223 ( & V_334 -> V_28 ) ;
return V_373 ;
}
static T_4 F_231 ( struct V_354 * V_355 , const char * V_359 ,
T_5 V_159 )
{
struct V_333 * V_334 = F_204 ( V_355 ) ;
int V_332 ;
...
static T_4 F_233 ( struct V_354 * V_355 , char * V_359 )
{
struct V_333 * V_334 = F_204 ( V_355 ) ;
int V_373 ;
F_222 ( & V_334 -> V_28 ) ;
V_373 = sprintf ( V_359 , L_88 , V_334 -> V_2 -> V_244 ) ;
F_223 ( & V_334 -> V_28 ) ;
return V_373 ;
}
static T_4 F_234 ( struct V_354 * V_355 ,
const char * V_359 , T_5 V_159 )
{
struct V_333 * V_334 = F_204 ( V_355 ) ;
int V_332 ;
...
V_332 = F_221 ( V_359 , 0 , & V_365 ) ;
if ( V_332 )
goto V_375;
V_332 = F_146 ( V_365 ) ;
if ( V_332 )
goto V_375;
F_160 ( V_334 -> V_2 , V_365 ) ;
V_332 = V_159 ;
V_375:
F_223 ( & V_334 -> V_28 ) ;
return V_332 ;
}
static void F_235 ( struct V_376 * V_335 )
{
struct V_333 * V_334 ;
V_334 = F_194 ( V_335 ) ;
F_144 ( V_334 -> V_2 ) ;
...
static struct V_376 * F_236 ( void )
{
struct V_333 * V_334 ;
struct V_306 V_363 ;
int V_33 ;
...
return F_151 ( - V_240 ) ;
F_237 ( & V_334 -> V_28 ) ;
V_334 -> V_357 . V_377 = F_235 ;
V_334 -> V_2 = F_149 ( V_334 -> V_2 ) ;
if ( F_172 ( V_334 -> V_2 ) ) {
V_33 = F_173 ( V_334 -> V_2 ) ;
goto V_378;
}
V_33 = F_160 ( V_334 -> V_2 ,
V_379 ) ;
if ( V_33 )
goto V_378;
F_182 ( V_380 L_89 V_381 L_90 ) ;
memset ( & V_363 , 0 , sizeof( V_363 ) ) ;
V_363 . V_142 = true ;
V_33 = F_177 ( V_334 -> V_2 , & V_363 , 0 , L_91 ,
( const char * * ) & V_334 -> V_357 . V_356 . V_360 . V_370 ) ;
if ( V_33 )
goto V_382;
V_334 -> V_383 . V_197 = V_334 -> V_2 -> V_52 [ 0 ] ;
V_334 -> V_383 . V_371 = 0 ;
F_224 ( & V_334 -> V_383 . V_356 , L_91 , & V_372 ) ;
V_334 -> V_384 [ 0 ] = & V_334 -> V_383 . V_356 ;
V_334 -> V_357 . V_356 . V_384 = V_334 -> V_384 ;
F_224 ( & V_334 -> V_357 . V_356 , L_73 , & V_385 ) ;
return & V_334 -> V_357 ;
V_382:
F_169 ( V_334 -> V_2 ) ;
V_378:
...
static struct V_6 * F_239 ( struct V_376 * V_335 )
{
struct V_333 * V_334 = F_194 ( V_335 ) ;
struct V_1 * V_2 = V_334 -> V_2 ;
struct V_5 * V_4 ;
V_4 = F_150 ( sizeof( * V_4 ) , V_78 ) ;
if ( F_48 ( ! V_4 ) )
return F_151 ( - V_240 ) ;
F_222 ( & V_334 -> V_28 ) ;
V_334 -> V_368 ++ ;
...
unsigned V_51 ;
V_307 -> V_323 =
F_32 ( V_393 -> V_52 ? : ( V_393 -> V_394 ? : 1u ) ,
( unsigned ) V_366 ) ;
for ( V_51 = 0 , V_197 = V_307 -> V_52 ; V_51 < V_307 -> V_323 ; ++ V_51 , ++ V_197 ) {
V_197 -> V_120 = ! ! V_393 -> V_120 [ V_51 ] ;
V_197 -> V_139 = ! ! V_393 -> V_139 [ V_51 ] ;
V_197 -> V_142 = ! ! V_393 -> V_142 [ V_51 ] ;
V_197 -> V_313 =
V_393 -> V_394 > V_51 && V_393 -> V_133 [ V_51 ] [ 0 ]
? V_393 -> V_133 [ V_51 ]
: NULL ;
}
V_307 -> V_395 = NULL ;
