...
if ( ! V_86 )
goto V_98;
if ( ( V_8 -> V_99 & V_100 ) && V_89 )
V_4 = false ;
if ( ! V_85 )
V_85 = V_101 ;
V_88 = V_102 + F_35 ( V_85 ) ;
do {
if ( V_87 ) {
V_5 = F_1 ( V_2 , & V_3 , V_4 ) ;
if ( V_5 )
...
int F_41 ( struct V_20 * V_8 , T_1 V_9 , int * V_105 )
{
struct V_47 V_48 = { NULL } ;
struct V_6 V_7 = { 0 } ;
struct V_49 V_50 = { 0 } ;
struct V_51 V_52 ;
struct V_106 * V_107 = & V_8 -> V_107 ;
const T_2 * V_108 ;
int V_109 , V_5 = 0 ;
T_2 * V_110 ;
...
V_108 = V_113 ;
V_109 = sizeof( V_113 ) ;
} else if ( V_107 -> V_111 == V_114 ) {
V_108 = V_115 ;
V_109 = sizeof( V_115 ) ;
} else
return - V_68 ;
V_110 = F_22 ( V_109 , V_65 ) ;
if ( ! V_110 )
return - V_66 ;
V_48 . V_7 = & V_7 ;
V_48 . V_50 = & V_50 ;
...
T_2 * V_118 ;
int V_33 , V_5 ;
static T_2 V_119 [ 8 ] = { 0x55 , 0xaa , 0 , 0 , 0 , 0 , 0 , 0 } ;
static T_2 V_120 [ 4 ] = { 0x5a , 0 , 0 , 0 } ;
V_110 = F_43 ( V_46 , V_65 ) ;
if ( ! V_110 )
return - V_66 ;
if ( V_46 == 8 )
V_118 = V_119 ;
...
V_50 . V_57 = 1 ;
F_19 ( & V_50 , V_2 ) ;
F_18 ( & V_52 , V_110 , V_46 ) ;
F_20 ( V_8 , & V_48 ) ;
V_5 = 0 ;
if ( V_9 == V_122 ) {
for ( V_33 = 0 ; V_33 < V_46 / 4 ; V_33 ++ )
if ( ( V_118 [ V_33 ] ^ V_110 [ V_33 ] ) != 0xff ) {
V_5 = - V_117 ;
break;
}
}
...
int F_44 ( struct V_1 * V_2 , T_2 V_111 )
{
int V_5 , V_124 ;
if ( V_111 == V_112 )
V_124 = 8 ;
...
return - V_68 ;
F_42 ( V_2 , V_2 -> V_8 , V_121 , V_124 ) ;
V_5 = F_42 ( V_2 , V_2 -> V_8 , V_122 , V_124 ) ;
return V_5 ;
}
...
{
return ( V_2 && V_2 -> V_62 . V_129 > V_130 ) ;
}
