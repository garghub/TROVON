...
{
struct V_2 * V_3 = V_40 -> V_42 -> V_43 ;
int V_33 = F_28 ( V_3 , V_1 , V_60 , 0 , V_31 , V_4 ) ;
F_39 ( V_1 , V_31 & V_61 , V_33 ) ;
return V_33 ;
}
static long F_40 ( struct V_39 * V_40 , T_1 V_4 ,
void T_6 * * V_62 , unsigned long * V_63 )
{
struct V_2 * V_3 = V_40 -> V_42 -> V_43 ;
struct V_1 * V_1 ;
if ( ! V_3 )
...
if ( ! V_1 )
return - V_26 ;
* V_62 = ( void T_6 * ) F_41 ( V_1 ) ;
* V_63 = F_42 ( V_1 ) ;
return V_25 ;
}
static int F_43 ( struct V_39 * V_40 , T_7 V_65 ,
...
static struct V_104 * F_73 ( T_9 V_105 , int * V_106 , void * V_107 )
{
struct V_2 * V_3 ;
struct V_104 * V_108 ;
bool V_101 ;
