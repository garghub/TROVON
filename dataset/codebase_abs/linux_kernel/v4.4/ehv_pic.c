...
enum V_44 V_45 )
{
struct V_42 * V_46 = F_25 ( V_41 ) ;
return V_46 == NULL || V_46 == V_43 ;
}
static int F_26 ( struct V_40 * V_41 , unsigned int V_47 ,
T_1 V_48 )
{
...
static int F_30 ( struct V_40 * V_41 , struct V_42 * V_58 ,
...
struct V_49 * V_49 ;
int V_36 = 1 ;
V_64 = F_32 ( NULL , NULL , L_1 ) ;
if ( ! V_64 ) {
F_33 ( L_2 ) ;
return;
}
if ( ! F_34 ( V_64 , L_3 , NULL ) )
V_36 = 0 ;
V_49 = F_35 ( sizeof( struct V_49 ) , V_66 ) ;
if ( ! V_49 ) {
F_36 ( V_64 ) ;
return;
}
V_49 -> V_39 = F_37 ( V_64 , V_67 ,
& V_68 , V_49 ) ;
if ( ! V_49 -> V_39 ) {
F_36 ( V_64 ) ;
F_38 ( V_49 ) ;
