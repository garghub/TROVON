...
{
struct V_176 * V_177 = V_2 -> V_31 -> V_178 ;
struct V_176 * V_179 = F_40 ( V_177 , L_16 ) ;
struct V_175 * V_180 ;
const char * V_181 ;
T_4 V_182 ;
if ( ! V_179 )
return NULL ;
V_180 = F_41 ( V_2 -> V_31 , sizeof( * V_180 ) , V_183 ) ;
if ( ! V_180 )
goto V_184;
V_180 -> V_106 = F_42 ( V_177 , 0 ) ;
if ( F_43 ( V_179 , L_17 ,
& V_182 ) >= 0 )
V_180 -> V_32 =
F_31 ( V_2 , V_182 ) ;
...
& V_182 ) >= 0 )
V_180 -> V_33 = V_182 ;
if ( F_43 ( V_179 , L_19 , & V_182 ) >= 0 )
V_180 -> V_37 = F_32 ( V_2 , V_182 ) ;
else
V_180 -> V_37 = V_135 ;
if ( F_43 ( V_179 , L_20 , & V_182 ) >= 0 )
V_180 -> V_185 =
F_33 ( V_2 , V_182 ) ;
else
V_180 -> V_185 = V_142 ;
if ( F_43 ( V_179 , L_21 , & V_182 ) >= 0 )
V_180 -> V_186 =
F_34 ( V_2 , V_182 ) ;
else
V_180 -> V_186 = V_148 ;
if ( ! F_44 ( V_179 , L_22 , & V_181 ) )
V_180 -> V_187 =
F_35 ( V_2 , V_181 ) ;
else
V_180 -> V_187 = V_159 ;
if ( F_43 ( V_179 , L_23 , & V_182 ) >= 0 )
V_180 -> V_188 =
F_36 ( V_2 , V_182 ) ;
else
V_180 -> V_188 = V_161 ;
if ( F_43 ( V_179 , L_24 , & V_182 ) >= 0 )
V_180 -> V_189 = ( T_1 ) V_182 ;
else
V_180 -> V_189 = 0xA ;
if ( F_43 ( V_179 , L_25 , & V_182 ) >= 0 )
V_180 -> V_190 = ( T_1 ) V_182 ;
else
V_180 -> V_190 = 0x16 ;
if ( F_43 ( V_179 , L_26 , & V_182 ) >= 0 )
V_180 -> V_191 = ( T_1 ) V_182 ;
else
V_180 -> V_191 = 0x21 ;
if ( F_43 ( V_179 , L_27 , & V_182 ) >= 0 )
V_180 -> V_192 = ( T_1 ) V_182 ;
else
V_180 -> V_192 = 0x3E ;
if ( F_43 ( V_179 , L_28 , & V_182 ) >= 0 )
V_180 -> V_193 = F_37 ( V_2 , V_182 ) ;
else
V_180 -> V_193 = V_167 ;
if ( F_43 ( V_179 , L_29 , & V_182 ) >= 0 )
V_180 -> V_194 =
F_38 ( V_2 , V_182 ) ;
else
V_180 -> V_194 = V_171 ;
...
if ( ( V_196 ) && ( V_196 -> V_180 ) ) {
struct V_175 * V_180 = V_196 -> V_180 ;
T_1 V_197 , V_111 ;
V_15 -> V_106 = V_180 -> V_106 ;
switch ( V_180 -> V_32 ) {
case V_129 :
case V_130 :
V_15 -> V_32 =
...
T_1 V_111 [ V_109 ] ;
int V_218 ;
V_15 = F_41 ( V_2 -> V_31 , sizeof( * V_15 ) , V_183 ) ;
if ( ! V_15 )
return - V_219 ;
V_6 -> V_7 = V_15 ;
V_15 -> V_2 = V_2 ;
if ( ( V_2 -> V_31 -> V_178 ) && ( V_6 -> V_196 ) )
V_6 -> V_196 -> V_180 = F_39 ( V_2 ) ;
F_46 ( V_2 ) ;
F_4 ( V_2 , V_10 ,
V_36 , 0 ) ;
F_48 ( & V_15 -> V_16 , F_5 ) ;
F_48 ( & V_15 -> V_38 , F_14 ) ;
V_218 = F_49 ( V_15 -> V_106 , NULL ,
F_24 ,
V_220 | V_221 ,
L_30 , V_15 ) ;
if ( V_218 ) {
F_50 ( V_2 -> V_31 , L_31 , V_218 ) ;
return V_218 ;
}
