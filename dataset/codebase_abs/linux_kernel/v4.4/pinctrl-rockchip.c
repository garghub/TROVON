...
if ( ! V_48 -> V_167 )
return - V_168 ;
V_166 = F_82 ( V_48 -> V_167 , V_65 ) ;
return ( V_166 ) ? : - V_168 ;
}
static void F_83 ( struct V_169 * V_170 )
{
struct V_171 * V_113 = F_84 ( V_170 ) ;
struct V_1 * V_48 = F_85 ( V_170 ) ;
T_2 V_172 ;
...
static int F_91 ( struct V_179 * V_180 , unsigned int type )
{
struct V_181 * V_3 = F_92 ( V_180 ) ;
...
static void F_96 ( struct V_179 * V_180 )
{
struct V_181 * V_3 = F_92 ( V_180 ) ;
struct V_1 * V_48 = V_3 -> V_182 ;
F_44 ( V_48 -> V_115 ) ;
V_48 -> V_193 = F_97 ( V_3 , V_194 ) ;
F_98 ( V_3 , ~ V_3 -> V_195 , V_194 ) ;
F_47 ( V_48 -> V_115 ) ;
}
...
V_48 -> V_167 = F_106 ( V_48 -> V_141 , 32 ,
& V_201 , NULL ) ;
if ( ! V_48 -> V_167 ) {
F_105 ( & V_139 -> V_35 , L_33 ,
V_48 -> V_7 ) ;
F_47 ( V_48 -> V_115 ) ;
continue;
}
V_54 = F_107 ( V_48 -> V_167 , 32 , 1 ,
L_34 , V_187 ,
V_196 , 0 , V_202 ) ;
if ( V_54 ) {
...
V_3 = F_109 ( V_48 -> V_167 , 0 ) ;
V_3 -> V_116 = V_48 -> V_116 ;
V_3 -> V_182 = V_48 ;
V_3 -> V_204 [ 0 ] . V_205 . V_55 = V_194 ;
V_3 -> V_204 [ 0 ] . V_205 . V_206 = V_207 ;
V_3 -> V_204 [ 0 ] . V_113 . V_208 = V_209 ;
V_3 -> V_204 [ 0 ] . V_113 . V_210 = F_102 ;
V_3 -> V_204 [ 0 ] . V_113 . V_211 =
F_100 ;
V_3 -> V_204 [ 0 ] . V_113 . V_212 = V_213 ;
V_3 -> V_204 [ 0 ] . V_113 . V_214 = F_96 ;
V_3 -> V_204 [ 0 ] . V_113 . V_215 = F_99 ;
V_3 -> V_204 [ 0 ] . V_113 . V_216 = F_91 ;
V_3 -> V_217 = F_110 ( V_48 -> V_16 ) ;
F_111 ( V_48 -> V_174 ,
F_83 , V_48 ) ;
for ( V_133 = 0 ; V_133 < 32 ; V_133 ++ )
F_82 ( V_48 -> V_167 , V_133 ) ;
F_47 ( V_48 -> V_115 ) ;
}
return 0 ;
}
static int F_112 ( struct V_138 * V_139 ,
struct V_5 * V_6 )
{
struct V_90 * V_13 = V_6 -> V_13 ;
struct V_1 * V_48 = V_13 -> V_14 ;
...
static int F_116 ( struct V_1 * V_48 ,
struct V_5 * V_6 )
{
struct V_221 V_222 ;
void T_5 * V_120 ;
if ( F_117 ( V_48 -> V_141 , 0 , & V_222 ) ) {
F_12 ( V_6 -> V_35 , L_37 ) ;
return - V_223 ;
}
V_48 -> V_116 = F_118 ( V_6 -> V_35 , & V_222 ) ;
if ( F_64 ( V_48 -> V_116 ) )
return F_65 ( V_48 -> V_116 ) ;
if ( F_119 ( V_48 -> V_141 ,
L_38 ) ) {
struct V_26 * V_224 ;
V_224 = F_120 ( V_48 -> V_141 -> V_33 ,
L_39 , 0 ) ;
if ( ! V_224 ) {
if ( F_117 ( V_48 -> V_141 , 1 , & V_222 ) ) {
F_12 ( V_6 -> V_35 , L_37 ) ;
return - V_223 ;
}
V_120 = F_118 ( V_6 -> V_35 , & V_222 ) ;
if ( F_64 ( V_120 ) )
return F_65 ( V_120 ) ;
V_225 . V_226 =
F_121 ( & V_222 ) - 4 ;
V_225 . V_7 =
L_40 ;
V_48 -> V_74 = F_122 ( V_6 -> V_35 ,
V_120 ,
& V_225 ) ;
}
}
V_48 -> V_174 = F_123 ( V_48 -> V_141 , 0 ) ;
V_48 -> V_115 = F_124 ( V_48 -> V_141 , 0 ) ;
if ( F_64 ( V_48 -> V_115 ) )
return F_65 ( V_48 -> V_115 ) ;
return F_125 ( V_48 -> V_115 ) ;
}
static struct V_90 * F_126 (
struct V_5 * V_180 ,
struct V_138 * V_139 )
{
...
static int T_6 F_129 ( struct V_140 * V_35 )
{
struct V_5 * V_6 = F_130 ( V_35 ) ;
int V_54 = F_131 ( V_6 -> V_159 ) ;
if ( V_54 )
return V_54 ;
...
if ( V_54 )
return V_54 ;
return F_132 ( V_6 -> V_159 ) ;
}
static int F_134 ( struct V_138 * V_139 )
{
struct V_5 * V_6 ;
struct V_140 * V_35 = & V_139 -> V_35 ;
struct V_90 * V_13 ;
...
return - V_37 ;
V_6 -> V_35 = V_35 ;
V_13 = F_126 ( V_6 , V_139 ) ;
if ( ! V_13 ) {
F_12 ( V_35 , L_44 ) ;
return - V_20 ;
}
V_6 -> V_13 = V_13 ;
V_224 = F_120 ( V_27 , L_45 , 0 ) ;
if ( V_224 ) {
V_6 -> V_63 = F_135 ( V_224 ) ;
if ( F_64 ( V_6 -> V_63 ) )
return F_65 ( V_6 -> V_63 ) ;
} else {
V_222 = F_136 ( V_139 , V_242 , 0 ) ;
V_120 = F_118 ( & V_139 -> V_35 , V_222 ) ;
if ( F_64 ( V_120 ) )
return F_65 ( V_120 ) ;
V_225 . V_226 = F_121 ( V_222 ) - 4 ;
V_225 . V_7 = L_46 ;
V_6 -> V_63 = F_122 ( & V_139 -> V_35 , V_120 ,
& V_225 ) ;
V_6 -> V_243 = F_121 ( V_222 ) ;
if ( V_13 -> type == V_99 && V_6 -> V_243 < 0x200 ) {
V_222 = F_136 ( V_139 , V_242 , 1 ) ;
V_120 = F_118 ( & V_139 -> V_35 , V_222 ) ;
if ( F_64 ( V_120 ) )
return F_65 ( V_120 ) ;
V_225 . V_226 =
F_121 ( V_222 ) - 4 ;
V_225 . V_7 = L_47 ;
V_6 -> V_74 = F_122 ( & V_139 -> V_35 ,
V_120 ,
& V_225 ) ;
}
}
V_224 = F_120 ( V_27 , L_39 , 0 ) ;
if ( V_224 ) {
V_6 -> V_62 = F_135 ( V_224 ) ;
if ( F_64 ( V_6 -> V_62 ) )
return F_65 ( V_6 -> V_62 ) ;
}
V_54 = F_112 ( V_139 , V_6 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_71 ( V_139 , V_6 ) ;
if ( V_54 ) {
