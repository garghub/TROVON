...
int F_15 ( T_2 * V_86 , int V_57 , int * V_78 ,
int * V_79 )
{
int V_2 ;
int V_80 , V_81 ;
...
int F_16 ( T_2 * V_87 , T_1 V_88 , T_2 * V_86 , V_32 * V_89 ,
T_2 * V_77 , V_32 * V_90 )
{
T_2 V_91 ;
T_2 V_92 [ 4 ] = { 0x0 , 0x50 , 0xf2 , 0x01 } ;
T_1 V_93 ;
V_93 = ( V_94 + V_95 + V_96 ) ;
while ( V_93 < V_88 ) {
V_91 = V_87 [ V_93 ] ;
if ( ( V_91 == V_55 ) &&
( ! memcmp ( & V_87 [ V_93 + 2 ] , & V_92 [ 0 ] , 4 ) ) ) {
memcpy ( V_77 , & V_87 [ V_93 ] , V_87 [ V_93 + 1 ] + 2 ) ;
* V_90 = V_87 [ V_93 + 1 ] + 2 ;
V_93 += V_87 [ V_93 + 1 ] + 2 ;
} else {
if ( V_91 == V_58 ) {
memcpy ( V_86 , & V_87 [ V_93 ] ,
V_87 [ V_93 + 1 ] + 2 ) ;
* V_89 = V_87 [ V_93 + 1 ] + 2 ;
V_93 += V_87 [ V_93 + 1 ] + 2 ;
} else {
...
int F_17 ( T_2 * V_87 , T_1 V_88 , T_2 * V_97 , T_1 * V_98 )
{
int V_99 ;
T_1 V_93 ;
T_2 V_100 , V_101 [ 4 ] = { 0x0 , 0x50 , 0xf2 , 0x04 } ;
V_93 = 12 ;
V_99 = false ;
while ( V_93 < V_88 ) {
V_100 = V_87 [ V_93 ] ;
if ( ( V_100 == V_55 ) &&
( ! memcmp ( & V_87 [ V_93 + 2 ] , V_101 , 4 ) ) ) {
memcpy ( V_97 , & V_87 [ V_93 ] , V_87 [ V_93 + 1 ] + 2 ) ;
* V_98 = V_87 [ V_93 + 1 ] + 2 ;
V_93 += V_87 [ V_93 + 1 ] + 2 ;
V_99 = true ;
break;
