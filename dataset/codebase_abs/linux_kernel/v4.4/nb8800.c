...
F_49 ( & V_22 -> V_22 , V_52 , V_42 , V_48 ) ;
memcpy ( F_47 ( V_54 , V_56 ) , V_46 , V_56 ) ;
F_50 ( V_54 , F_51 ( V_54 ) -> V_59 , V_44 ,
V_45 + V_56 , V_51 - V_56 ,
V_42 ) ;
}
V_54 -> V_60 = F_52 ( V_54 , V_22 ) ;
F_53 ( & V_2 -> V_34 , V_54 ) ;
}
static void F_54 ( struct V_21 * V_22 , T_2 V_61 )
{
if ( V_61 & V_62 )
V_22 -> V_57 . V_63 ++ ;
if ( V_61 & V_64 )
...
static int F_55 ( struct V_71 * V_34 , int V_72 )
{
...
static int F_68 ( struct V_53 * V_54 , struct V_21 * V_22 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
struct V_98 * V_99 ;
struct V_87 * V_88 ;
...
unsigned int V_102 ;
unsigned int V_75 ;
if ( F_69 ( & V_2 -> V_103 ) <= V_104 ) {
F_70 ( V_22 ) ;
return V_105 ;
}
V_102 = ( 8 - ( V_106 ) V_54 -> V_46 ) & 7 ;
V_101 = V_54 -> V_51 - V_102 ;
V_43 = F_71 ( & V_22 -> V_22 , V_54 -> V_46 + V_102 ,
V_101 , V_107 ) ;
if ( F_41 ( & V_22 -> V_22 , V_43 ) ) {
F_45 ( V_22 , L_3 ) ;
F_72 ( V_54 ) ;
...
V_49 -> V_50 =
V_88 -> V_94 + F_74 ( struct V_98 , V_113 ) ;
V_49 -> V_114 = V_88 -> V_94 + sizeof( V_99 -> V_49 [ 0 ] ) ;
V_49 -> V_83 = F_75 ( 2 ) | V_115 | V_102 ;
V_49 ++ ;
}
V_49 -> V_50 = V_43 ;
V_49 -> V_114 = V_2 -> V_90 [ V_75 ] . V_94 ;
V_49 -> V_83 = F_75 ( 2 ) | V_115 | V_116 | V_101 ;
if ( ! V_54 -> V_110 )
V_49 -> V_83 |= V_84 ;
V_88 -> V_54 = V_54 ;
V_88 -> V_43 = V_43 ;
...
static void F_78 ( struct V_21 * V_22 , T_2 V_61 )
{
if ( V_61 & V_118 )
V_22 -> V_57 . V_119 ++ ;
if ( V_61 & V_120 )
...
V_54 = V_88 -> V_54 ;
V_51 += V_54 -> V_51 ;
F_79 ( & V_22 -> V_22 , V_88 -> V_43 , V_88 -> V_101 ,
V_107 ) ;
if ( F_80 ( V_99 -> V_61 ) ) {
F_78 ( V_22 , V_99 -> V_61 ) ;
F_72 ( V_54 ) ;
...
V_22 -> V_57 . V_128 ++ ;
V_22 -> V_57 . V_129 += F_82 ( V_99 -> V_61 ) ;
V_22 -> V_57 . V_119 += F_83 ( V_99 -> V_61 ) ;
V_88 -> V_54 = NULL ;
V_88 -> V_92 = false ;
V_99 -> V_61 = 0 ;
V_125 = ( V_125 + 1 ) % V_96 ;
...
if ( V_127 ) {
F_84 () ;
F_85 ( V_127 , & V_2 -> V_103 ) ;
F_86 ( V_22 , V_127 , V_51 ) ;
F_87 ( V_22 ) ;
V_2 -> V_126 = V_125 ;
}
}
static T_5 F_88 ( int V_130 , void * V_131 )
{
...
V_156 = F_93 ( V_155 , F_94 ( V_2 -> V_160 ) ) ;
F_5 ( V_2 , V_161 , V_156 ) ;
F_5 ( V_2 , V_162 , V_154 ) ;
...
F_5 ( V_2 , F_105 ( V_33 ) , V_22 -> V_177 [ V_33 ] ) ;
for ( V_33 = 0 ; V_33 < V_176 ; V_33 ++ )
F_5 ( V_2 , F_106 ( V_33 ) , V_22 -> V_177 [ V_33 ] ) ;
}
static int F_107 ( struct V_21 * V_22 , void * V_178 )
{
struct V_179 * V_180 = V_178 ;
if ( F_96 ( V_22 ) )
return - V_181 ;
F_108 ( V_22 -> V_177 , V_180 -> V_182 ) ;
F_104 ( V_22 ) ;
return 0 ;
}
static void F_109 ( struct V_21 * V_22 , int V_5 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
F_5 ( V_2 , V_183 , V_5 ) ;
F_110 ( V_2 -> V_4 + V_183 , V_5 , ! V_5 ,
1 , 1000 ) ;
}
...
F_112 (ha, dev) {
for ( V_33 = 0 ; V_33 < V_176 ; V_33 ++ )
F_5 ( V_2 , F_113 ( V_33 ) , V_185 -> V_178 [ V_33 ] ) ;
F_109 ( V_22 , 0xff ) ;
}
}
...
F_115 ( V_2 -> V_40 [ V_33 ] . V_44 ) ;
F_116 ( V_2 -> V_40 ) ;
V_2 -> V_40 = NULL ;
}
if ( V_2 -> V_90 ) {
for ( V_33 = 0 ; V_33 < V_96 ; V_33 ++ )
F_72 ( V_2 -> V_90 [ V_33 ] . V_54 ) ;
F_116 ( V_2 -> V_90 ) ;
V_2 -> V_90 = NULL ;
}
if ( V_2 -> V_37 ) {
F_117 ( V_22 -> V_22 . V_189 , V_190 , V_2 -> V_37 ,
V_2 -> V_191 ) ;
V_2 -> V_37 = NULL ;
}
if ( V_2 -> V_112 ) {
F_117 ( V_22 -> V_22 . V_189 , V_192 , V_2 -> V_112 ,
V_2 -> V_193 ) ;
V_2 -> V_112 = NULL ;
}
}
...
unsigned int V_33 ;
int V_16 ;
V_2 -> V_37 = F_121 ( V_22 -> V_22 . V_189 , V_190 ,
& V_2 -> V_191 , V_201 ) ;
if ( ! V_2 -> V_37 )
goto V_202;
V_2 -> V_40 = F_122 ( V_199 , sizeof( * V_2 -> V_40 ) , V_201 ) ;
if ( ! V_2 -> V_40 )
goto V_202;
...
V_2 -> V_112 = F_121 ( V_22 -> V_22 . V_189 , V_192 ,
& V_2 -> V_193 , V_201 ) ;
if ( ! V_2 -> V_112 )
goto V_202;
V_2 -> V_90 = F_122 ( V_200 , sizeof( * V_2 -> V_90 ) , V_201 ) ;
if ( ! V_2 -> V_90 )
goto V_202;
...
V_99 -> V_49 [ 0 ] . V_50 =
V_88 -> V_94 + F_74 ( struct V_98 , V_113 ) ;
V_99 -> V_49 [ 0 ] . V_83 = F_75 ( 2 ) | V_115 | V_116 | V_84 | 8 ;
...
if ( V_16 )
return V_16 ;
V_16 = F_125 ( V_22 -> V_130 , F_88 , 0 , F_126 ( & V_22 -> V_22 ) , V_22 ) ;
if ( V_16 )
goto V_212;
F_31 ( V_22 , true ) ;
F_28 ( V_22 , true ) ;
V_2 -> V_165 = F_127 ( V_22 , V_2 -> V_213 ,
F_102 , 0 ,
V_2 -> V_158 ) ;
if ( ! V_2 -> V_165 )
goto V_214;
...
static int F_135 ( struct V_21 * V_22 , struct V_215 * V_216 , int V_15 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
return F_136 ( V_2 -> V_165 , V_216 , V_15 ) ;
}
static int F_137 ( struct V_21 * V_22 , struct V_217 * V_15 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
if ( ! V_2 -> V_165 )
return - V_218 ;
return F_138 ( V_2 -> V_165 , V_15 ) ;
}
static int F_139 ( struct V_21 * V_22 , struct V_217 * V_15 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
if ( ! V_2 -> V_165 )
return - V_218 ;
return F_140 ( V_2 -> V_165 , V_15 ) ;
}
...
static int F_146 ( struct V_21 * V_22 , int V_224 )
{
if ( V_224 == V_225 )
return V_226 ;
return - V_227 ;
}
static void F_147 ( struct V_21 * V_22 , T_2 V_224 , T_1 * V_113 )
{
if ( V_224 == V_225 )
memcpy ( V_113 , & V_228 , sizeof( V_228 ) ) ;
}
static T_2 F_148 ( struct V_21 * V_22 , int V_229 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
F_5 ( V_2 , V_230 , V_229 ) ;
...
V_235 = F_148 ( V_22 , V_33 ) ;
V_236 = F_148 ( V_22 , V_33 | 0x80 ) ;
V_234 [ V_33 ] = V_235 ;
...
V_5 |= F_154 ( 2 ) ;
F_9 ( V_2 , V_31 , V_5 ) ;
V_2 -> V_86 = F_94 ( V_2 -> V_160 ) / 20000 ;
V_2 -> V_143 = F_94 ( V_2 -> V_160 ) / 100 ;
F_9 ( V_2 , V_85 , V_2 -> V_86 ) ;
V_2 -> V_196 = V_42 | F_75 ( 2 ) | V_115 | V_116 ;
V_5 = 100000 / 512 ;
F_5 ( V_2 , V_256 , V_5 >> 8 ) ;
...
F_5 ( V_2 , V_268 , 1 ) ;
F_59 () ;
V_267 = F_93 ( F_94 ( V_2 -> V_160 ) , 2 * V_269 ) ;
F_7 ( V_2 , V_270 , V_267 ) ;
return 0 ;
}
...
if ( V_16 )
return V_16 ;
F_18 ( V_2 , V_31 , F_153 ( 7 ) ) ;
V_2 -> V_196 |= V_271 ;
return 0 ;
}
static int F_161 ( struct V_272 * V_273 )
{
...
int V_130 ;
int V_132 ;
V_275 = F_162 ( V_281 , & V_273 -> V_22 ) ;
if ( V_275 )
V_277 = V_275 -> V_46 ;
V_130 = F_163 ( V_273 , 0 ) ;
if ( V_130 <= 0 ) {
F_156 ( & V_273 -> V_22 , L_9 ) ;
return - V_265 ;
}
V_279 = F_164 ( V_273 , V_282 , 0 ) ;
V_4 = F_165 ( & V_273 -> V_22 , V_279 ) ;
if ( F_166 ( V_4 ) )
return F_167 ( V_4 ) ;
F_168 ( & V_273 -> V_22 , L_10 , & V_279 -> V_283 ) ;
V_22 = F_169 ( sizeof( * V_2 ) ) ;
if ( ! V_22 )
return - V_47 ;
F_170 ( V_273 , V_22 ) ;
F_171 ( V_22 , & V_273 -> V_22 ) ;
V_2 = F_29 ( V_22 ) ;
V_2 -> V_4 = V_4 ;
V_2 -> V_158 = F_172 ( V_273 -> V_22 . V_284 ) ;
if ( V_2 -> V_158 < 0 )
V_2 -> V_158 = V_159 ;
V_2 -> V_160 = F_173 ( & V_273 -> V_22 , NULL ) ;
if ( F_166 ( V_2 -> V_160 ) ) {
F_156 ( & V_273 -> V_22 , L_11 ) ;
V_132 = F_167 ( V_2 -> V_160 ) ;
goto V_285;
}
V_132 = F_174 ( V_2 -> V_160 ) ;
if ( V_132 )
goto V_285;
F_175 ( & V_2 -> V_97 ) ;
...
V_12 -> V_2 = V_2 ;
V_132 = F_177 ( V_12 , V_273 -> V_22 . V_284 ) ;
if ( V_132 ) {
F_156 ( & V_273 -> V_22 , L_14 ) ;
goto V_287;
}
V_2 -> V_213 = F_178 ( V_273 -> V_22 . V_284 , L_15 , 0 ) ;
if ( ! V_2 -> V_213 ) {
F_156 ( & V_273 -> V_22 , L_16 ) ;
V_132 = - V_218 ;
goto V_293;
}
V_2 -> V_11 = V_12 ;
...
V_22 -> V_186 |= V_299 ;
V_22 -> V_130 = V_130 ;
V_280 = F_179 ( V_273 -> V_22 . V_284 ) ;
if ( V_280 )
F_108 ( V_22 -> V_177 , V_280 ) ;
if ( ! F_180 ( V_22 -> V_177 ) )
F_181 ( V_22 ) ;
F_104 ( V_22 ) ;
F_182 ( V_22 ) ;
...
F_184 ( V_22 , & V_2 -> V_34 , F_55 , V_300 ) ;
F_185 ( V_22 , L_18 , V_22 -> V_177 ) ;
return 0 ;
V_212:
F_114 ( V_22 ) ;
V_293:
...
static int F_189 ( struct V_272 * V_273 )
{
struct V_21 * V_301 = F_190 ( V_273 ) ;
