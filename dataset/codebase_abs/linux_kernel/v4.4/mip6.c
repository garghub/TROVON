...
static int F_29 ( struct V_29 * V_30 , struct V_7 * V_8 ,
const struct V_58 * V_59 )
{
struct V_60 * V_60 = F_30 ( V_30 ) ;
...
T_3 V_52 ;
int V_35 = 0 ;
if ( F_31 ( V_65 -> V_71 == V_72 &&
V_65 -> V_73 <= V_74 ) )
goto V_75;
if ( F_32 ( V_62 -> V_76 ) ) {
V_70 = F_33 ( V_8 , V_62 -> V_76 , V_46 ) ;
if ( F_32 ( V_70 >= 0 ) )
V_44 = (struct V_43 * )
( F_34 ( V_8 ) + V_70 ) ;
}
...
V_69 . V_81 = V_82 ;
V_69 . V_83 = V_65 -> V_71 ;
V_69 . V_84 = F_36 ( V_59 , & V_65 -> V_85 ) ;
if ( V_69 . V_84 )
V_69 . V_86 = F_37 ( ~ 0 ) ;
V_69 . V_87 = F_38 ( V_59 , & V_65 -> V_85 ) ;
if ( V_69 . V_87 )
V_69 . V_88 = F_37 ( ~ 0 ) ;
V_69 . V_89 = V_65 -> V_90 ;
V_35 = F_39 ( V_60 , V_45 , & V_69 ,
( V_44 ? ( V_78 * ) & V_44 -> V_48 : NULL ) ) ;
V_75:
return V_35 ;
}
static int F_40 ( struct V_29 * V_30 , struct V_7 * V_8 ,
T_2 * * V_36 )
{
T_4 V_70 = sizeof( struct V_31 ) ;
struct V_91 * V_92 =
(struct V_91 * ) ( F_13 ( V_8 ) + 1 ) ;
const unsigned char * V_93 = F_34 ( V_8 ) ;
unsigned int V_94 = F_41 ( V_8 ) -
F_34 ( V_8 ) ;
int V_95 = 0 ;
* V_36 = & F_13 ( V_8 ) -> V_36 ;
while ( V_70 + 1 <= V_94 ) {
...
{
if ( V_30 -> V_99 . V_100 ) {
F_44 ( L_4 , V_101 , V_30 -> V_99 . V_100 ) ;
return - V_102 ;
}
...
static int F_48 ( struct V_29 * V_30 , struct V_7 * V_8 ,
T_2 * * V_36 )
{
T_4 V_70 = sizeof( struct V_31 ) ;
struct V_91 * V_92 =
...
{
F_44 ( L_6 ) ;
if ( F_52 ( & V_114 , V_82 ) < 0 ) {
F_44 ( L_7 , V_101 ) ;
goto V_115;
}
if ( F_52 ( & V_116 , V_82 ) < 0 ) {
F_44 ( L_8 , V_101 ) ;
goto V_117;
}
if ( F_53 ( F_6 ) < 0 ) {
...
if ( F_56 ( F_6 ) < 0 )
F_44 ( L_10 , V_101 ) ;
if ( F_54 ( & V_116 , V_82 ) < 0 )
F_44 ( L_11 , V_101 ) ;
if ( F_54 ( & V_114 , V_82 ) < 0 )
F_44 ( L_12 , V_101 ) ;
}
