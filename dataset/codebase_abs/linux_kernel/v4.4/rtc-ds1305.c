...
V_23 = F_33 ( V_18 , & V_75 ) ;
if ( V_23 < 0 )
F_34 ( & V_18 -> V_7 , L_18 , L_2 , V_23 ) ;
return ( V_23 < 0 ) ? V_23 : V_78 ;
}
static T_4
F_35 ( struct V_84 * V_85 , struct V_86 * V_87 ,
struct V_88 * V_89 ,
char * V_10 , T_5 V_90 , T_3 V_78 )
{
struct V_40 * V_18 ;
...
V_23 = F_33 ( V_18 , & V_75 ) ;
if ( V_23 < 0 )
F_34 ( & V_18 -> V_7 , L_18 , L_5 , V_23 ) ;
return ( V_23 < 0 ) ? V_23 : V_78 ;
}
static int F_36 ( struct V_40 * V_18 )
{
struct V_9 * V_9 ;
int V_23 ;
T_1 V_20 , V_92 ;
struct V_93 * V_94 = F_37 ( & V_18 -> V_7 ) ;
bool V_95 = false ;
if ( ( V_18 -> V_96 && V_18 -> V_96 != 8 )
|| ( V_18 -> V_97 > 2000000 )
|| ! ( V_18 -> V_98 & V_99 ) )
return - V_12 ;
V_9 = F_38 ( & V_18 -> V_7 , sizeof( * V_9 ) , V_100 ) ;
if ( ! V_9 )
return - V_101 ;
V_9 -> V_18 = V_18 ;
F_39 ( V_18 , V_9 ) ;
...
if ( V_18 -> V_69 ) {
F_44 ( & V_9 -> V_61 , F_19 ) ;
V_23 = F_45 ( & V_18 -> V_7 , V_18 -> V_69 , F_26 ,
...
V_23 = F_48 ( & V_18 -> V_7 . V_87 , & V_111 ) ;
if ( V_23 < 0 ) {
F_34 ( & V_18 -> V_7 , L_30 , V_23 ) ;
}
return 0 ;
}
static int F_49 ( struct V_40 * V_18 )
{
struct V_9 * V_9 = F_50 ( V_18 ) ;
F_51 ( & V_18 -> V_7 . V_87 , & V_111 ) ;
if ( V_18 -> V_69 ) {
F_52 ( V_67 , & V_9 -> V_68 ) ;
F_53 ( & V_18 -> V_7 , V_18 -> V_69 , V_9 ) ;
F_54 ( & V_9 -> V_61 ) ;
}
return 0 ;
}
