...
static int F_169 ( struct V_336 * V_318 , struct V_9 * V_10 )
{
struct V_1 * V_2 ;
int line = V_10 -> V_337 ;
if ( line >= V_338 ) {
...
static inline void F_172 ( struct V_345 * V_346 , struct V_1 * V_2 )
{
char V_347 [ 30 ] ;
unsigned long V_12 ;
if ( V_2 -> V_348 == V_349 ) {
...
if ( V_2 -> V_54 . V_76 )
F_173 ( V_346 , L_106 , V_2 -> V_54 . V_76 ) ;
if ( V_2 -> V_54 . V_77 )
F_173 ( V_346 , L_107 , V_2 -> V_54 . V_77 ) ;
if ( V_2 -> V_54 . V_354 )
F_173 ( V_346 , L_108 , V_2 -> V_54 . V_354 ) ;
if ( V_2 -> V_54 . V_355 )
F_173 ( V_346 , L_109 , V_2 -> V_54 . V_355 ) ;
if ( V_2 -> V_54 . V_66 )
F_173 ( V_346 , L_110 , V_2 -> V_54 . V_66 ) ;
if ( V_2 -> V_54 . V_356 )
F_173 ( V_346 , L_111 , V_2 -> V_54 . V_356 ) ;
} else {
F_173 ( V_346 , L_112 ,
V_2 -> V_54 . V_298 , V_2 -> V_54 . V_143 ) ;
if ( V_2 -> V_54 . V_146 )
F_173 ( V_346 , L_113 , V_2 -> V_54 . V_146 ) ;
if ( V_2 -> V_54 . V_145 )
F_173 ( V_346 , L_114 , V_2 -> V_54 . V_145 ) ;
if ( V_2 -> V_54 . V_144 )
F_173 ( V_346 , L_115 , V_2 -> V_54 . V_144 ) ;
if ( V_2 -> V_54 . V_148 )
F_173 ( V_346 , L_116 , V_2 -> V_54 . V_148 ) ;
}
F_173 ( V_346 , L_117 , V_347 + 1 ) ;
F_173 ( V_346 , L_118 ,
...
static int F_174 ( struct V_345 * V_346 , void * V_373 )
{
struct V_1 * V_2 ;
F_173 ( V_346 , L_121 , V_374 ) ;
V_2 = V_339 ;
while( V_2 ) {
F_172 ( V_346 , V_2 ) ;
V_2 = V_2 -> V_340 ;
...
static int F_175 ( struct V_375 * V_375 , struct V_320 * V_320 )
{
...
if ( F_178 ( V_2 ) < 0 ||
F_179 ( V_2 , V_2 -> V_383 , V_2 -> V_381 ) < 0 ||
F_179 ( V_2 , V_2 -> V_384 , V_2 -> V_379 ) < 0 ||
F_180 ( V_2 ) < 0 ||
F_181 ( V_2 ) < 0 ) {
...
V_2 -> V_386 = F_184 ( NULL , V_389 , & V_2 -> V_390 , V_187 ) ;
if ( V_2 -> V_386 == NULL )
return - V_188 ;
...
F_186 ( NULL , V_389 , V_2 -> V_386 , V_2 -> V_390 ) ;
V_2 -> V_386 = NULL ;
V_2 -> V_383 = NULL ;
V_2 -> V_384 = NULL ;
}
static int F_179 ( struct V_1 * V_2 , V_392 * V_395 , int V_396 )
{
int V_385 ;
V_391 V_397 ;
...
V_395 [ V_385 ] . V_398 = F_184 ( NULL , V_378 , & V_395 [ V_385 ] . V_399 , V_187 ) ;
...
static void F_187 ( struct V_1 * V_2 , V_392 * V_395 , int V_396 )
{
int V_385 ;
if ( V_395 ) {
for ( V_385 = 0 ; V_385 < V_396 ; V_385 ++ ) {
...
if ( V_2 -> V_348 != V_349 )
F_186 ( NULL , V_378 , V_395 [ V_385 ] . V_398 , V_395 [ V_385 ] . V_399 ) ;
...
{
F_187 ( V_2 , V_2 -> V_383 , V_2 -> V_381 ) ;
F_187 ( V_2 , V_2 -> V_384 , V_2 -> V_379 ) ;
F_185 ( V_2 ) ;
}
static int F_180 ( struct V_1 * V_2 )
{
V_2 -> V_400 = F_189 ( V_2 -> V_238 , V_187 | V_401 ) ;
if ( V_2 -> V_400 == NULL )
return - V_188 ;
V_2 -> V_402 = F_190 ( V_2 -> V_238 , V_187 ) ;
if ( ! V_2 -> V_402 ) {
F_191 ( V_2 -> V_400 ) ;
V_2 -> V_400 = NULL ;
return - V_188 ;
...
V_2 -> V_405 = 0 ;
F_195 ( & V_2 -> V_81 , V_324 + F_196 ( 5000 ) ) ;
V_228 = true ;
}
}
return V_228 ;
...
{
if ( F_197 ( V_2 -> V_136 , V_2 -> V_414 , L_125 ) == NULL ) {
F_4 ( L_126 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_136 ) ;
return - V_300 ;
}
V_2 -> V_415 = true ;
if ( F_198 ( V_2 -> V_176 , F_67 , V_2 -> V_416 ,
V_2 -> V_21 , V_2 ) < 0 ) {
F_4 ( L_127 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_176 ) ;
goto V_417;
...
V_2 -> V_418 = true ;
if ( V_2 -> V_348 == V_349 ) {
if ( F_199 ( V_2 -> V_350 , 0x40000 , L_125 ) == NULL ) {
F_4 ( L_128 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_350 ) ;
goto V_417;
}
V_2 -> V_419 = true ;
if ( F_199 ( V_2 -> V_351 + V_2 -> V_420 , 128 , L_125 ) == NULL ) {
F_4 ( L_129 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_351 + V_2 -> V_420 ) ;
goto V_417;
}
V_2 -> V_421 = true ;
V_2 -> V_387 = F_200 ( V_2 -> V_350 ,
0x40000 ) ;
if ( ! V_2 -> V_387 ) {
F_4 ( L_130 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_350 ) ;
...
F_193 ( V_2 ) ;
if ( V_2 -> V_415 ) {
F_208 ( V_2 -> V_136 , V_2 -> V_414 ) ;
V_2 -> V_415 = false ;
}
if ( V_2 -> V_419 ) {
F_209 ( V_2 -> V_350 , 0x40000 ) ;
V_2 -> V_419 = false ;
}
if ( V_2 -> V_421 ) {
F_209 ( V_2 -> V_351 + V_2 -> V_420 , 128 ) ;
V_2 -> V_421 = false ;
}
if ( V_2 -> V_387 ) {
F_210 ( V_2 -> V_387 ) ;
...
static struct V_1 * F_213 ( void )
{
struct V_1 * V_2 ;
V_2 = F_190 ( sizeof( struct V_1 ) ,
V_187 ) ;
if ( ! V_2 ) {
F_4 ( L_140 ) ;
} else {
...
static void F_236 ( struct V_1 * V_2 , int V_248 )
{
if ( V_248 ) {
...
static void F_237 ( struct V_1 * V_2 , V_391 V_221 )
{
V_391 V_508 ;
T_2 V_510 ;
if ( V_221 ) {
...
static void F_243 ( struct V_1 * V_2 , V_391 V_221 )
{
if ( V_221 ) {
F_27 ( V_2 , V_507 , 0x0f64 ) ;
if ( V_2 -> V_348 == V_349 )
...
static void F_245 ( struct V_1 * V_2 , unsigned int V_598 , unsigned int V_599 )
{
bool V_600 = false ;
V_392 * V_601 ;
unsigned int V_602 ;
...
if ( V_19 >= V_614 )
F_246 ( V_2 , V_2 -> V_383 [ V_598 ] . V_398 ,
...
#if V_85
if ( V_2 -> V_86 )
F_247 ( V_2 , V_2 -> V_400 , V_603 ) ;
else
#endif
F_5 ( V_10 , V_2 -> V_400 , V_2 -> V_402 , V_603 ) ;
}
}
F_245 ( V_2 , V_598 , V_599 ) ;
V_604 = true ;
V_606:
...
__FILE__ , __LINE__ , V_2 -> V_21 , V_49 , V_603 ) ;
if ( V_19 >= V_614 )
F_246 ( V_2 , V_2 -> V_383 [ V_620 ] . V_398 ,
F_105 ( int , V_603 , V_378 ) , 0 ) ;
if ( V_603 ) {
...
V_392 * V_601 ;
if ( V_19 >= V_614 )
F_246 ( V_2 , V_412 , F_105 ( int , V_413 , V_378 ) , 1 ) ;
if ( V_2 -> V_36 . V_12 & V_236 ) {
V_2 -> V_56 |= V_57 ;
}
V_385 = V_2 -> V_597 ;
...
static unsigned int V_624 = F_250 ( V_623 ) ;
unsigned int V_385 ;
bool V_24 = true ;
unsigned long V_12 ;
F_9 ( & V_2 -> V_22 , V_12 ) ;
...
F_11 ( & V_2 -> V_22 , V_12 ) ;
V_626 = V_324 + F_196 ( 100 ) ;
for(; ; ) {
if ( F_158 ( V_324 , V_626 ) ) {
V_24 = false ;
break;
}
F_9 ( & V_2 -> V_22 , V_12 ) ;
...
unsigned long V_624 = F_250 ( V_623 ) ;
unsigned long V_385 ;
...
static void F_248 ( char * V_636 , const char * V_637 ,
unsigned short V_13 )
{
#define F_254 64
unsigned short V_638 = V_13 / F_254 ;
unsigned short V_602 ;
unsigned long V_639 ;
for ( V_602 = 0 ; V_602 < V_638 ; V_602 ++ )
{
memcpy ( V_636 , V_637 , F_254 ) ;
V_639 = * ( ( volatile unsigned long * ) V_636 ) ;
V_636 += F_254 ;
V_637 += F_254 ;
}
memcpy ( V_636 , V_637 , V_13 % F_254 ) ;
}
static void F_246 ( struct V_1 * V_2 , const char * V_11 , int V_13 , int V_640 )
{
int V_385 ;
int V_641 ;
if ( V_640 )
...
static int F_255 ( struct V_644 * V_645 , unsigned short V_481 ,
unsigned short V_145 )
{
struct V_1 * V_2 = F_256 ( V_645 ) ;
unsigned char V_646 ;
...
static T_9 F_257 ( struct V_657 * V_658 ,
struct V_644 * V_645 )
{
struct V_1 * V_2 = F_256 ( V_645 ) ;
unsigned long V_12 ;
...
static int F_260 ( struct V_644 * V_645 )
{
struct V_1 * V_2 = F_256 ( V_645 ) ;
int V_24 ;
unsigned long V_12 ;
...
static int F_263 ( struct V_644 * V_645 )
{
struct V_1 * V_2 = F_256 ( V_645 ) ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
...
static int F_265 ( struct V_644 * V_645 , struct V_666 * V_667 , int V_299 )
{
...
return - V_344 ;
if ( V_299 != V_674 )
return F_266 ( V_645 , V_667 , V_299 ) ;
...
if ( F_267 ( line , & V_670 , V_668 ) )
return - V_243 ;
return 0 ;
case V_676 :
if( ! F_79 ( V_687 ) )
return - V_688 ;
if ( F_268 ( & V_670 , line , V_668 ) )
return - V_243 ;
switch ( V_670 . V_680 )
{
...
static void F_269 ( struct V_644 * V_645 )
{
struct V_1 * V_2 = F_256 ( V_645 ) ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
...
static void F_247 ( struct V_1 * V_2 , char * V_231 , int V_668 )
{
struct V_657 * V_658 = F_272 ( V_668 ) ;
...
memcpy ( F_273 ( V_658 , V_668 ) , V_231 , V_668 ) ;
V_658 -> V_693 = F_274 ( V_658 , V_645 ) ;
V_645 -> V_611 . V_694 ++ ;
...
static int F_281 ( struct V_703 * V_645 ,
...
V_2 -> V_136 = F_283 ( V_645 , 2 ) ;
V_2 -> V_176 = V_645 -> V_455 ;
V_2 -> V_350 = F_283 ( V_645 , 3 ) ;
V_2 -> V_351 = F_283 ( V_645 , 0 ) ;
...
static void F_284 ( struct V_703 * V_645 )
{
}
