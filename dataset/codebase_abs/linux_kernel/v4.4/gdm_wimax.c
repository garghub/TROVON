...
if ( ! V_79 -> V_3 )
return - V_81 ;
if ( F_61 ( V_79 -> V_3 , V_80 -> V_3 , V_38 ) )
return - V_82 ;
}
return 0 ;
}
...
F_59 ( & V_79 -> V_3 ) ;
V_79 -> V_3 = F_10 ( V_80 -> V_38 , V_83 ) ;
if ( ! V_79 -> V_3 )
return - V_9 ;
}
if ( F_63 ( V_79 -> V_3 , V_80 -> V_3 , V_80 -> V_38 ) ) {
F_59 ( & V_79 -> V_3 ) ;
return - V_82 ;
}
V_79 -> V_38 = V_80 -> V_38 ;
...
static void F_66 ( struct V_23 * V_24 , struct V_72 * V_87 )
{
struct V_26 * V_26 = F_21 ( V_24 ) ;
struct V_72 * V_88 =
V_26 -> V_74 [ V_75 ] . V_3 ;
if ( ! V_88 )
return;
if ( V_88 -> V_76 != V_87 -> V_76 ||
V_88 -> V_89 != V_87 -> V_89 ) {
if ( V_87 -> V_76 == V_90 ) {
F_67 ( V_24 ) ;
} else if ( V_88 -> V_76 == V_90 ) {
F_68 ( V_24 ) ;
#if F_48 ( V_52 )
F_69 ( V_26 ) ;
#endif
...
if ( V_95 -> V_93 == V_98 ) {
V_47 = F_60 (
& V_95 -> V_15 , & V_26 -> V_74 [ V_95 -> V_100 ] ) ;
if ( V_47 < 0 )
return V_47 ;
...
V_47 = F_62 (
& V_26 -> V_74 [ V_95 -> V_100 ] , & V_95 -> V_15 ) ;
if ( V_47 < 0 )
return V_47 ;
}
break;
default:
F_38 ( V_24 , L_7 , V_44 , V_93 ) ;
return - V_97 ;
}
return 0 ;
}
...
F_75 ( V_24 , L_12 ,
V_24 -> V_59 , V_113 ) ;
memcpy ( V_24 -> V_59 , V_113 , V_24 -> V_60 ) ;
return 1 ;
}
}
F_37 ( V_24 , V_3 , V_14 ) ;
...
V_24 -> V_133 = & V_134 ;
V_24 -> V_32 &= ~ V_135 ;
memcpy ( V_24 -> V_59 , V_136 , sizeof( V_136 ) ) ;
V_26 = F_21 ( V_24 ) ;
V_26 -> V_46 = V_24 ;
V_26 -> V_127 = V_127 ;
V_127 -> V_46 = V_24 ;
...
{
struct V_26 * V_26 = F_21 ( V_127 -> V_46 ) ;
struct V_72 * V_73 = V_26 -> V_74 [ V_75 ] . V_3 ;
if ( V_73 )
V_73 -> V_76 = V_77 ;
F_105 ( V_26 -> V_46 ) ;
