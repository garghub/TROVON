...
struct V_110 * V_110 = F_58 ( V_74 ) ;
struct V_111 * V_112 ;
int V_113 , V_67 = V_114 ;
struct V_115 V_116 = {
. V_117 = V_74 -> V_118 ,
. V_119 = F_59 ( V_46 -> V_120 ) ,
. V_121 = V_122 ,
. V_99 = V_46 -> V_99 ,
. V_53 = V_46 -> V_53 ,
} ;
V_112 = F_60 ( V_110 , & V_116 , NULL ) ;
if ( F_61 ( V_112 ) )
goto V_113;
if ( V_112 -> V_123 != V_124 && V_112 -> V_123 != V_125 ) {
F_62 ( V_112 ) ;
goto V_113;
}
F_63 ( V_36 ) ;
F_64 ( V_36 , & V_112 -> V_126 ) ;
V_113 = F_65 ( V_110 , V_36 -> V_127 , V_36 ) ;
if ( F_27 ( F_66 ( V_113 ) ) )
V_74 -> V_128 . V_129 ++ ;
else
V_67 = V_130 ;
...
F_63 ( V_36 ) ;
F_64 ( V_36 , V_126 ) ;
V_113 = F_71 ( V_110 , V_36 -> V_127 , V_36 ) ;
if ( F_27 ( F_66 ( V_113 ) ) )
V_74 -> V_128 . V_129 ++ ;
else
V_67 = V_130 ;
...
static int F_72 ( struct V_35 * V_36 ,
...
struct V_35 * V_36 )
{
if ( V_36 -> V_38 == F_26 ( V_141 ) ) {
F_53 ( V_36 ) ;
return;
}
F_80 ( & V_24 -> V_71 . V_72 ) ;
if ( F_81 ( & V_24 -> V_71 ) < V_142 ) {
F_82 ( & V_24 -> V_71 , V_36 ) ;
F_83 ( & V_24 -> V_71 . V_72 ) ;
F_84 ( & V_24 -> V_60 ) ;
} else {
F_83 ( & V_24 -> V_71 . V_72 ) ;
F_85 ( & V_36 -> V_74 -> V_143 ) ;
F_53 ( V_36 ) ;
}
}
...
V_93:
V_36 -> V_74 = V_3 -> V_144 ;
return F_72 ( V_36 , V_3 ) ;
}
static int F_88 ( struct V_35 * V_36 , struct V_89 * V_74 )
{
const struct V_2 * V_3 = F_87 ( V_74 ) ;
struct V_61 * V_145 = F_43 ( V_36 ) ;
struct V_22 * V_26 ;
void * V_37 ;
int V_96 ;
if ( F_44 ( V_145 -> V_76 , V_145 -> V_73 ) ) {
V_37 = F_25 ( V_36 , & V_96 ) ;
if ( V_37 ) {
V_26 = F_56 ( V_3 -> V_24 , V_37 , V_96 , true ) ;
if ( V_26 )
...
if ( ! V_36 )
return V_114 ;
return F_49 ( V_3 -> V_144 , V_36 ) ;
} else if ( F_73 ( V_145 -> V_76 ) ) {
F_79 ( V_3 -> V_24 , V_36 ) ;
return V_130 ;
}
V_36 -> V_74 = V_3 -> V_144 ;
...
int F_89 ( struct V_35 * V_36 , struct V_89 * V_74 )
{
struct V_2 * V_3 = F_87 ( V_74 ) ;
struct V_23 * V_24 = F_90 ( V_3 -> V_144 ) ;
if ( ! V_24 )
goto V_93;
...
static bool F_92 ( struct V_35 * V_36 , struct V_23 * V_24 )
{
struct V_61 * V_145 = F_43 ( V_36 ) ;
struct V_22 * V_26 ;
void * V_37 ;
int V_96 ;
if ( F_44 ( V_145 -> V_73 , V_36 -> V_74 -> V_75 ) ) {
V_37 = F_25 ( V_36 , & V_96 ) ;
if ( ! V_37 )
return true ;
...
static T_3 F_93 ( struct V_35 * * V_86 ,
struct V_23 * V_24 )
{
void * V_37 ;
int V_96 ;
...
T_3 F_95 ( struct V_35 * * V_86 )
{
struct V_35 * V_36 = * V_86 ;
struct V_23 * V_24 = F_96 ( V_36 -> V_74 ) ;
if ( ! V_24 )
return V_149 ;
switch ( V_24 -> V_146 ) {
case V_147 :
