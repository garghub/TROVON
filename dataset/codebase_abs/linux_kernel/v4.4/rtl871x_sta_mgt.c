...
struct V_1 * F_17 ( struct V_11 * V_12 , V_3 * V_33 )
{
T_2 V_34 ;
struct V_29 * V_35 ;
struct V_1 * V_2 ;
...
void F_23 ( struct V_51 * V_46 , struct V_1 * V_2 )
{
int V_13 ;
unsigned long V_52 ;
struct V_36 * V_37 ;
...
struct V_1 * F_29 ( struct V_51 * V_46 )
{
struct V_11 * V_12 = & V_46 -> V_58 ;
V_3 V_72 [ V_42 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
return F_30 ( V_12 , V_72 ) ;
}
V_3 F_32 ( struct V_73 * V_74 , V_3 * V_75 )
{
return true ;
}
