...
V_40 = 0 ;
return F_32 ( (struct V_8 * ) ( V_31 -> V_9 ) + V_40 ) ;
}
...
struct V_45 * V_46 ;
struct V_47 * V_48 ;
struct V_49 * V_50 = F_34 ( V_31 ) ;
struct V_51 * V_52 = & V_42 -> V_52 ;
int V_53 ;
if ( ! V_44 )
return;
V_46 = F_35 ( V_52 -> V_54 , L_12 ) ;
if ( ! V_46 )
return;
V_53 = F_36 ( V_46 ) ;
if ( ! V_53 )
...
if ( ! V_53 )
return 0 ;
V_9 = F_37 ( V_52 , sizeof( * V_9 ) * V_53 , V_56 ) ;
if ( ! V_9 )
return - V_61 ;
V_31 -> V_62 = V_53 ;
V_31 -> V_9 = V_9 ;
F_43 (dvc, priv, i) {
snprintf ( V_59 , V_60 , L_14 ,
V_63 , V_14 ) ;
V_58 = F_44 ( V_52 , V_59 ) ;
if ( F_45 ( V_58 ) )
return F_46 ( V_58 ) ;
V_9 -> V_50 = & V_50 -> V_48 [ V_14 ] ;
V_37 = F_47 ( V_31 , F_32 ( V_9 ) , & V_64 ,
V_58 , V_65 , V_14 ) ;
if ( V_37 )
return V_37 ;
}
