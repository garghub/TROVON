...
static void F_76 ( T_2 V_27 , void * V_56 )
{
struct V_19 V_169 = { V_48 , NULL } ;
union V_49 * V_50 ;
struct V_170 V_82 ;
T_3 V_22 ;
T_5 V_171 ;
...
T_2 V_174 ;
V_22 = F_77 ( V_27 , & V_169 ) ;
if ( V_22 != V_30 ) {
F_30 ( L_15 , V_22 ) ;
return;
}
V_50 = (union V_49 * ) V_169 . V_24 ;
if ( ! V_50 )
return;
if ( V_50 -> type != V_51 ) {
F_30 ( L_16 , V_50 -> type ) ;
...
V_82 = * ( (struct V_170 * ) V_50 -> V_52 . V_24 ) ;
F_16 ( V_50 ) ;
switch ( V_82 . V_175 ) {
case V_176 :
V_171 = V_82 . V_171 ;
...
default:
F_30 ( L_19 ,
V_82 . V_175 , V_82 . V_178 ) ;
break;
}
}
static T_3 T_1
F_81 ( struct V_187 * V_84 ,
struct V_188 * V_82 )
{
T_3 V_22 ;
union V_49 * V_50 ;
struct V_19 V_21 = { sizeof( struct V_187 ) , V_84 } ;
struct V_19 V_89 = { V_48 , NULL } ;
...
* V_82 = * ( (struct V_188 * ) V_50 -> V_52 . V_24 ) ;
F_16 ( V_50 ) ;
return V_22 ;
}
...
static T_3 T_1 F_84 ( T_4 V_191 , T_2 V_55 ,
void * V_192 , void * * V_57 )
{
* ( T_4 * ) V_57 = V_191 ;
return V_30 ;
}
static int T_1 F_85 ( const char * V_157 , const char * V_193 ,
T_4 * V_191 )
{
T_3 V_22 ;
T_4 V_54 ;
...
V_137 -> V_157 = L_25 ;
V_137 -> V_195 = L_26 ;
V_137 -> V_60 . V_196 = V_197 ;
V_137 -> V_198 [ 0 ] = F_89 ( V_199 ) ;
F_90 ( V_137 , V_138 , - 16384 , 16384 , 0 , 0 ) ;
F_90 ( V_137 , V_141 , - 16384 , 16384 , 0 , 0 ) ;
F_90 ( V_137 , V_142 , - 16384 , 16384 , 0 , 0 ) ;
V_28 = F_91 ( V_137 ) ;
if ( V_28 )
goto V_200;
return 0 ;
...
V_177 -> V_157 = L_27 ;
V_177 -> V_195 = L_28 ;
V_177 -> V_60 . V_196 = V_197 ;
V_28 = F_96 ( V_177 , V_201 , NULL ) ;
if ( V_28 )
goto V_200;
V_22 = F_97 ( V_168 ,
F_76 , NULL ) ;
...
static int F_102 ( struct V_205 * V_80 )
{
int V_28 ;
if ( F_7 ( V_5 ) ) {
...
static int F_103 ( struct V_205 * V_80 )
{
if ( F_7 ( V_5 ) )
F_43 () ;
if ( F_7 ( V_7 ) )
...
static int F_104 ( struct V_80 * V_117 )
{
T_2 V_27 ;
struct V_209 * V_151 = & V_1 -> V_151 ;
if ( ! V_151 )
return - V_160 ;
if ( F_7 ( V_5 ) ) {
F_37 ( & V_27 , V_5 ) ;
...
static int F_105 ( struct V_80 * V_117 )
{
struct V_209 * V_151 = & V_1 -> V_151 ;
if ( ! V_151 )
return - V_160 ;
...
static void F_106 ( struct V_205 * V_80 )
{
struct V_209 * V_151 = & V_1 -> V_151 ;
if ( ! V_151 )
return;
...
{
F_108 ( V_1 -> V_210 . V_88 ) ;
F_108 ( V_1 -> V_210 . V_211 ) ;
}
static int T_1 F_109 ( void )
{
V_1 -> V_210 . V_211 = F_110 ( L_8 , NULL ) ;
if ( ! V_1 -> V_210 . V_211 ) {
F_50 ( L_29 ) ;
return - V_160 ;
}
V_1 -> V_210 . V_88 = F_111 ( L_30 , V_212 ,
V_1 -> V_210 . V_211 ,
& V_1 -> V_210 . V_213 ) ;
if ( ! V_1 -> V_210 . V_88 )
goto V_214;
