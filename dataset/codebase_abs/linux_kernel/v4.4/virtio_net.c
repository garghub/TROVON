...
if ( V_19 -> V_35 )
V_30 -> V_48 = 0 ;
F_53 ( V_129 -> V_96 , F_27 ( V_8 ) -> V_41 + ( V_138 ? 1 : 2 ) ) ;
if ( V_138 ) {
F_99 ( V_8 , V_32 ) ;
...
F_25 ( ! F_115 ( V_19 -> V_20 , V_156 ) ) ;
V_19 -> V_157 = ~ 0 ;
V_19 -> V_158 . V_148 = V_148 ;
V_19 -> V_158 . V_149 = V_149 ;
F_64 ( & V_30 , & V_19 -> V_158 , sizeof( V_19 -> V_158 ) ) ;
V_152 [ V_154 ++ ] = & V_30 ;
if ( V_151 )
V_152 [ V_154 ++ ] = V_151 ;
F_64 ( & V_153 , & V_19 -> V_157 , sizeof( V_19 -> V_157 ) ) ;
V_152 [ V_154 ] = & V_153 ;
F_25 ( V_154 + 1 > F_116 ( V_152 ) ) ;
F_117 ( V_19 -> V_159 , V_152 , V_154 , 1 , V_19 , V_56 ) ;
...
void * V_26 ;
int V_99 ;
if ( ! F_115 ( V_19 -> V_20 , V_200 ) )
return;
V_19 -> V_201 = ( ( V_22 -> V_68 & V_202 ) != 0 ) ;
V_19 -> V_203 = ( ( V_22 -> V_68 & V_204 ) != 0 ) ;
F_64 ( V_96 , & V_19 -> V_201 , sizeof( V_19 -> V_201 ) ) ;
if ( ! F_114 ( V_19 , V_205 ,
V_206 , V_96 ) )
F_107 ( & V_22 -> V_22 , L_16 ,
V_19 -> V_201 ? L_17 : L_18 ) ;
F_64 ( V_96 , & V_19 -> V_203 , sizeof( V_19 -> V_203 ) ) ;
if ( ! F_114 ( V_19 , V_205 ,
V_207 , V_96 ) )
...
V_198 = F_138 ( V_22 ) ;
V_199 = F_139 ( V_22 ) ;
V_26 = F_140 ( ( ( V_198 + V_199 ) * V_208 ) +
( 2 * sizeof( V_195 -> V_209 ) ) , V_56 ) ;
V_195 = V_26 ;
if ( ! V_26 )
return;
F_53 ( V_96 , 2 ) ;
V_195 -> V_209 = F_141 ( V_19 -> V_20 , V_198 ) ;
V_99 = 0 ;
F_142 (ha, dev)
...
V_195 -> V_209 = F_141 ( V_19 -> V_20 , V_199 ) ;
V_99 = 0 ;
F_143 (ha, dev)
memcpy ( & V_195 -> V_210 [ V_99 ++ ] [ 0 ] , V_197 -> V_164 , V_208 ) ;
F_54 ( & V_96 [ 1 ] , V_195 ,
...
static T_9 F_192 ( struct V_276 * V_277 ,
struct V_278 * V_279 , char * V_26 )
{
struct V_18 * V_19 = F_87 ( V_277 -> V_22 ) ;
unsigned int V_280 = F_193 ( V_277 ) ;
struct V_100 * V_281 ;
F_25 ( V_280 >= V_19 -> V_127 ) ;
V_281 = & V_19 -> V_11 [ V_280 ] . V_60 ;
return sprintf ( V_26 , L_26 , F_58 ( V_281 ) ) ;
}
static bool F_194 ( struct V_161 * V_20 ,
unsigned int V_282 ,
const char * V_283 , const char * V_284 )
{
if ( ! F_115 ( V_20 , V_282 ) )
return false ;
...
if ( V_303 )
V_22 -> V_270 |= V_301 | V_302 ;
if ( F_115 ( V_20 , V_304 ) ) {
V_22 -> V_300 |= V_305 | V_306
| V_307 | V_308 ;
}
if ( F_115 ( V_20 , V_309 ) )
V_22 -> V_300 |= V_305 ;
...
V_22 -> V_270 |= V_313 ;
if ( V_314 )
V_22 -> V_270 |= V_22 -> V_300 & ( V_315 | V_306 ) ;
}
if ( F_115 ( V_20 , V_316 ) )
V_22 -> V_270 |= V_317 ;
V_22 -> V_318 = V_22 -> V_270 ;
if ( F_115 ( V_20 , V_171 ) )
F_201 ( V_20 ,
F_123 ( struct V_173 , V_174 ) ,
V_22 -> V_319 , V_22 -> V_167 ) ;
else
F_202 ( V_22 ) ;
V_19 = F_87 ( V_22 ) ;
V_19 -> V_22 = V_22 ;
...
{
V_19 -> V_20 -> V_258 -> V_334 ( V_19 -> V_20 ) ;
F_181 ( V_19 ) ;
F_178 ( V_19 ) ;
F_180 ( V_19 ) ;
F_183 ( V_19 ) ;
