...
struct V_94 *
F_75 ( struct V_79 * V_80 , bool V_119 ,
bool V_63 , bool V_64 )
{
struct V_17 * V_18 = F_53 ( V_80 , V_119 ) ;
struct V_1 * V_2 ;
...
return F_77 ( V_52 , struct V_94 , V_96 ) ;
}
}
return NULL ;
}
bool F_78 ( struct V_79 * V_80 , bool V_119 )
{
struct V_17 * V_18 = F_53 ( V_80 , V_119 ) ;
return V_18 -> V_69 > 0 ;
}
int F_79 ( const struct V_105 * V_106 ,
enum V_110 V_111 , char * V_43 ,
enum V_9 V_10 , bool V_145 , void * V_11 )
{
struct V_79 * V_80 ;
int V_62 ;
int V_36 = 0 ;
