...
V_86 = F_66 ( V_89 , & V_132 , 0 ,
V_133 , V_103 ) ;
if ( V_86 ) {
F_64 ( V_2 -> V_42 , L_12 ) ;
goto V_131;
}
F_67 ( V_89 , & V_132 , V_122 ,
F_53 ) ;
return 0 ;
V_131:
F_68 ( V_89 ) ;
...
struct V_138 * V_139 ;
int V_86 , V_122 , V_41 ;
V_137 = F_70 ( & V_135 -> V_42 ) ;
if ( ! V_137 )
return - V_140 ;
V_2 = F_71 ( & V_135 -> V_42 , sizeof( * V_2 ) , V_141 ) ;
if ( ! V_2 )
return - V_142 ;
...
V_2 -> V_42 = & V_135 -> V_42 ;
#ifdef F_73
V_2 -> V_147 = F_74 ( V_2 -> V_42 ,
V_2 -> V_17 -> V_23 , sizeof( * V_2 -> V_147 ) ,
V_141 ) ;
if ( ! V_2 -> V_147 )
return - V_142 ;
#endif
V_139 = F_75 ( V_135 , V_148 , 0 ) ;
V_2 -> V_11 = F_76 ( & V_135 -> V_42 , V_139 ) ;
if ( F_77 ( V_2 -> V_11 ) )
return F_78 ( V_2 -> V_11 ) ;
V_122 = F_79 ( V_135 , 0 ) ;
if ( V_122 < 0 ) {
F_64 ( & V_135 -> V_42 , L_13 ) ;
return V_122 ;
}
V_2 -> V_149 = V_150 ;
V_2 -> V_149 . V_21 = F_62 ( & V_135 -> V_42 ) ;
V_2 -> V_149 . V_22 = V_2 -> V_17 -> V_22 ;
V_2 -> V_149 . V_23 = V_2 -> V_17 -> V_23 ;
V_2 -> V_16 = F_80 ( & V_2 -> V_149 , & V_135 -> V_42 , V_2 ) ;
if ( F_77 ( V_2 -> V_16 ) ) {
F_64 ( & V_135 -> V_42 , L_14 ) ;
...
static int F_85 ( struct V_151 * V_42 )
{
struct V_134 * V_135 = F_86 ( V_42 ) ;
struct V_1 * V_2 = F_84 ( V_135 ) ;
int V_41 ;
V_2 -> V_152 = F_4 ( V_2 -> V_11 + V_102 ) ;
for ( V_41 = 0 ; V_41 < V_2 -> V_17 -> V_23 ; V_41 ++ ) {
const struct V_153 * V_119 ;
struct V_154 * V_155 ;
void T_1 * V_4 ;
...
V_155 -> V_156 = F_4 ( V_4 ) & ~ V_91 ;
V_4 = F_1 ( V_2 , V_119 -> V_87 , V_13 ) ;
V_155 -> V_157 = F_4 ( V_4 ) ;
}
return 0 ;
}
static int F_87 ( struct V_151 * V_42 )
{
struct V_134 * V_135 = F_86 ( V_42 ) ;
struct V_1 * V_2 = F_84 ( V_135 ) ;
int V_41 ;
