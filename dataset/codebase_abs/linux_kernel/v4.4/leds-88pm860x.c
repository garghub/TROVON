...
int V_17 = 0 ;
if ( ! V_34 -> V_27 . V_38 -> V_39 )
return - V_40 ;
V_36 = F_14 ( V_34 -> V_27 . V_38 -> V_39 , L_2 ) ;
if ( ! V_36 ) {
F_15 ( & V_34 -> V_27 , L_3 ) ;
return - V_40 ;
}
F_16 (nproot, np) {
if ( ! F_17 ( V_37 -> V_41 , V_32 -> V_41 ) ) {
F_18 ( V_37 , L_4 ,
& V_17 ) ;
V_32 -> V_17 = F_19 ( V_17 ) ;
F_20 ( V_37 ) ;
...
{
struct V_1 * V_2 = F_22 ( V_34 -> V_27 . V_38 ) ;
struct V_42 * V_43 = F_23 ( & V_34 -> V_27 ) ;
struct V_11 * V_32 ;
struct V_44 * V_45 ;
int V_5 = 0 ;
V_32 = F_24 ( & V_34 -> V_27 , sizeof( struct V_11 ) , V_46 ) ;
if ( V_32 == NULL )
return - V_47 ;
V_45 = F_25 ( V_34 , V_48 , L_5 ) ;
if ( ! V_45 ) {
F_15 ( & V_34 -> V_27 , L_6 ) ;
return - V_49 ;
}
V_32 -> V_19 = V_45 -> V_50 ;
V_45 = F_25 ( V_34 , V_48 , L_7 ) ;
if ( ! V_45 ) {
F_15 ( & V_34 -> V_27 , L_8 ) ;
return - V_49 ;
}
V_32 -> V_21 = V_45 -> V_50 ;
memset ( V_32 -> V_41 , 0 , V_51 ) ;
switch ( V_34 -> V_52 ) {
case 0 :
V_32 -> V_25 = V_53 ;
...
F_26 ( V_34 , V_32 ) ;
V_32 -> V_2 = V_2 ;
V_32 -> V_18 = ( V_2 -> V_52 == V_55 ) ? V_2 -> V_56 : V_2 -> V_57 ;
V_32 -> V_3 = V_34 -> V_52 ;
if ( F_13 ( V_34 , V_32 ) )
if ( V_43 )
V_32 -> V_17 = V_43 -> V_17 ;
