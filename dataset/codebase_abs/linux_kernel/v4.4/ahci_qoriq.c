...
if ( ! V_64 )
return - V_68 ;
V_20 = F_18 ( V_61 , sizeof( * V_20 ) , V_69 ) ;
if ( ! V_20 )
return - V_70 ;
V_20 -> type = (enum V_71 ) V_64 -> V_72 ;
if ( V_20 -> type == V_30 ) {
V_66 = F_19 ( V_58 , V_73 ,
L_3 ) ;
V_20 -> V_42 = F_20 ( V_61 , V_66 ) ;
if ( F_15 ( V_20 -> V_42 ) )
...
static int F_24 ( struct V_33 * V_61 )
{
struct V_80 * V_18 = F_25 ( V_61 ) ;
