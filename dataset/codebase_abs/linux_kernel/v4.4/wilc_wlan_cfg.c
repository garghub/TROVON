...
int F_11 ( T_1 * V_1 , T_2 V_2 , T_3 V_3 , T_1 * V_5 , int V_10 )
{
T_1 type = ( V_3 >> 12 ) & 0xf ;
int V_36 = 0 ;
if ( type == 0 ) {
...
int F_12 ( T_1 * V_1 , T_2 V_2 , T_3 V_3 )
{
T_1 * V_5 ;
if ( ( V_2 + 2 ) >= V_6 )
return 0 ;
...
int F_13 ( T_3 V_15 , T_1 * V_39 , T_2 V_40 )
{
...
int F_14 ( T_1 * V_1 , int V_10 , T_5 * V_41 )
{
int V_36 = 1 ;
T_1 V_42 ;
T_1 V_43 ;
