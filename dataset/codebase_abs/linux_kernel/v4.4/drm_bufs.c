...
int F_52 ( struct V_2 * V_3 , void * V_83 ,
struct V_84 * V_85 )
{
struct V_103 * V_104 = V_3 -> V_104 ;
...
int F_56 ( struct V_2 * V_3 , void * V_83 ,
struct V_84 * V_85 )
{
struct V_103 * V_104 = V_3 -> V_104 ;
...
if ( F_57 ( & V_125 , & V_94 -> V_37 [ V_96 ] , sizeof( V_125 ) ) )
return - V_154 ;
...
V_74 = F_62 ( V_85 -> V_164 , 0 , V_5 -> V_33 ,
V_165 | V_166 ,
V_167 ,
V_161 ) ;
} else {
V_74 = F_62 ( V_85 -> V_164 , 0 , V_104 -> V_114 ,
V_165 | V_166 ,
V_167 , 0 ) ;
}
if ( V_74 > - 1024UL ) {
...
int F_63 ( struct V_2 * V_3 , void * V_83 ,
struct V_84 * V_85 )
{
if ( F_48 ( V_3 , V_143 ) )
return - V_28 ;
