...
V_155 = V_280 ;
V_282 = V_155 ;
if ( V_43 -> V_143 + V_282 > V_43 -> V_53 )
V_282 = V_43 -> V_53 - V_43 -> V_143 ;
F_93 ( V_22 , V_43 -> V_53 ) ;
if ( V_282 > F_143 ( V_22 ) )
V_282 = F_143 ( V_22 ) ;
if ( V_282 < V_155 )
...
V_282 = F_77 ( V_43 -> V_293 + V_43 -> V_143 ,
V_57 , V_155 ) ;
if ( V_282 ) {
V_155 -= V_282 ;
V_44 = - V_88 ;
...
static T_1 F_145 ( struct V_32 * V_32 , char T_3 * V_57 , T_2 V_280 ,
T_5 * V_281 )
{
struct V_21 * V_22 ;
struct V_42 * V_43 ;
...
F_140 ( & V_43 -> V_79 , & V_273 ) ;
while ( V_61 == 0 && ! V_44 ) {
unsigned int V_296 , V_297 , V_298 ;
F_141 ( V_287 ) ;
V_282 = F_92 ( V_22 ) ;
V_155 = F_146 ( T_2 , V_282 , V_280 ) ;
if ( V_155 == 0 ) {
unsigned V_66 = F_58 ( V_22 ) ;
if ( ! F_59 ( V_66 ) ) {
if ( F_60 ( V_66 ) )
...
V_296 = V_43 -> V_144 ;
V_297 = F_147 ( V_155 , V_43 -> V_53 - V_296 ) ;
V_298 = V_155 - V_297 ;
V_282 = F_81 ( V_57 , V_43 -> V_293 + V_296 , V_297 ) ;
if ( V_282 )
V_282 += V_298 ;
else if ( V_298 )
V_282 = F_81 ( V_57 + V_297 , V_43 -> V_293 , V_298 ) ;
if ( V_282 ) {
V_155 -= V_282 ;
V_44 = - V_88 ;
}
...
V_22 == V_288 && V_288 -> V_43 == V_43 && V_22 -> V_47 == V_32 &&
! ( V_43 -> V_77 . V_68 & V_151 ) &&
! F_61 ( V_22 ) &&
F_92 ( V_22 ) == 0 )
F_68 ( V_2 , V_22 ) ;
