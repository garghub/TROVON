...
V_85 = F_24 ( V_85 , V_2 -> V_67 [ V_28 -> V_86 ] . V_78 ) ;
if ( V_28 -> V_86 == V_71 )
V_85 += V_2 -> V_67 [ V_28 -> V_86 ] . V_69 ;
if ( V_85 < 0 )
V_85 = 0 ;
V_84 = & V_87 [ V_28 -> V_84 ] ;
V_85 = V_85 * V_84 -> V_88 ;
return F_24 ( V_85 , V_84 -> V_54 ) ;
}
static int F_25 ( T_5 V_89 )
{
if ( ! F_26 ( V_89 ) || V_89 < V_90 ||
V_89 > V_91 )
return - V_77 ;
return F_27 ( V_89 / V_90 ) ;
}
static int F_28 ( T_5 V_54 , T_5 V_88 )
{
unsigned int V_92 ;
for ( V_92 = 0 ; V_92 < F_29 ( V_87 ) ; V_92 ++ )
...
static int F_31 ( T_5 V_89 )
{
if ( ! F_26 ( V_89 ) || V_89 > V_93 )
return - V_77 ;
return F_27 ( V_89 ) ;
}
...
static int F_35 ( struct V_110 * V_26 ,
struct V_27 * V_28 ,
struct V_111 * V_112 )
{
const char * V_113 = V_112 -> V_113 ;
T_5 V_17 , V_89 , V_114 [ 2 ] ;
int V_7 ;
V_7 = F_36 ( V_112 , L_5 , & V_17 ) ;
if ( V_7 ) {
F_8 ( V_26 , L_6 , V_113 ) ;
return V_7 ;
}
...
V_7 = F_37 ( V_112 , L_10 , V_114 , 2 ) ;
if ( ! V_7 ) {
V_7 = F_28 ( V_114 [ 0 ] , V_114 [ 1 ] ) ;
if ( V_7 < 0 ) {
F_8 ( V_26 , L_11 ,
...
static int F_39 ( struct V_1 * V_2 , struct V_111 * V_112 )
{
...
if ( ! V_2 -> V_56 )
return - V_77 ;
V_2 -> V_109 = F_41 ( V_2 -> V_26 , V_2 -> V_56 ,
sizeof( * V_2 -> V_109 ) , V_127 ) ;
if ( ! V_2 -> V_109 )
return - V_128 ;
V_2 -> V_57 = F_41 ( V_2 -> V_26 , V_2 -> V_56 ,
sizeof( * V_2 -> V_57 ) , V_127 ) ;
if ( ! V_2 -> V_57 )
return - V_128 ;
V_124 = V_2 -> V_109 ;
F_42 (node, child) {
V_7 = F_35 ( V_2 -> V_26 , & V_28 , V_125 ) ;
if ( V_7 ) {
F_43 ( V_125 ) ;
return V_7 ;
}
...
static T_6 F_44 ( int V_134 , void * V_135 )
{
...
int V_7 , V_146 ;
T_5 V_147 ;
V_5 = F_47 ( V_26 -> V_148 , NULL ) ;
if ( ! V_5 )
return - V_133 ;
V_7 = F_36 ( V_112 , L_5 , & V_147 ) ;
if ( V_7 < 0 )
return V_7 ;
V_95 = F_48 ( V_26 , sizeof( * V_2 ) ) ;
if ( ! V_95 )
return - V_128 ;
V_2 = F_33 ( V_95 ) ;
V_2 -> V_5 = V_5 ;
