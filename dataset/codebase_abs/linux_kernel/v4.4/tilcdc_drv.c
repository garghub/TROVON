...
static int F_76 ( struct V_9 * V_10 , unsigned int V_98 )
{
F_75 ( V_10 , true ) ;
return 0 ;
}
static void F_77 ( struct V_9 * V_10 , unsigned int V_98 )
{
F_75 ( V_10 , false ) ;
}
static int F_78 ( struct V_99 * V_100 , void * V_83 )
{
...
unsigned V_104 ;
F_26 ( V_10 -> V_10 ) ;
F_79 ( V_100 , L_24 , V_16 -> V_68 ) ;
for ( V_104 = 0 ; V_104 < F_80 ( V_105 ) ; V_104 ++ )
if ( V_16 -> V_68 >= V_105 [ V_104 ] . V_68 )
F_79 ( V_100 , L_25 , V_105 [ V_104 ] . V_3 ,
F_51 ( V_10 , V_105 [ V_104 ] . V_96 ) ) ;
F_28 ( V_10 -> V_10 ) ;
return 0 ;
}
static int F_81 ( struct V_99 * V_100 , void * V_83 )
{
struct V_101 * V_42 = (struct V_101 * ) V_100 -> V_102 ;
struct V_9 * V_10 = V_42 -> V_103 -> V_10 ;
return F_82 ( V_100 , & V_10 -> V_106 -> V_107 ) ;
}
static int F_83 ( struct V_108 * V_103 )
{
...
static void F_85 ( struct V_108 * V_103 )
{
struct V_1 * V_2 ;
F_86 ( V_109 ,
F_80 ( V_109 ) , V_103 ) ;
...
static int F_87 ( struct V_113 * V_10 )
{
struct V_9 * V_114 = F_88 ( V_10 ) ;
...
for ( V_104 = 0 ; V_104 < F_80 ( V_105 ) ; V_104 ++ )
if ( V_105 [ V_104 ] . V_116 && ( V_16 -> V_68 >= V_105 [ V_104 ] . V_68 ) )
F_91 ( V_114 , V_105 [ V_104 ] . V_96 , V_16 -> V_117 [ V_115 ++ ] ) ;
F_92 ( V_114 ) ;
return 0 ;
}
static int F_93 ( struct V_113 * V_10 )
{
return F_94 ( & V_118 , F_95 ( V_10 ) ) ;
}
static void F_96 ( struct V_113 * V_10 )
{
F_97 ( F_88 ( V_10 ) ) ;
}
...
{
struct V_9 * V_114 = F_88 ( & V_39 -> V_10 ) ;
struct V_15 * V_16 = V_114 -> V_17 ;
if ( ! V_16 )
return 0 ;
if ( V_16 -> V_50 )
F_101 ( & V_39 -> V_10 , & V_121 ) ;
else
F_97 ( F_102 ( V_39 ) ) ;
return 0 ;
}
