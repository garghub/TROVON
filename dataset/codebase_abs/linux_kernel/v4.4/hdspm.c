...
V_87 = F_234 ( V_461 , V_467 , sizeof( struct V_466 ) ) ;
if ( 0 != V_87 ) {
return - V_491 ;
}
break;
...
V_87 = F_234 ( V_461 , & V_352 , sizeof( struct V_468 ) ) ;
if ( 0 != V_87 ) {
return - V_491 ;
}
break;
...
V_447 -> V_530 . V_531 = F_232 ;
V_447 -> V_530 . V_532 = F_235 ;
V_447 -> V_530 . V_533 = F_235 ;
V_447 -> V_530 . V_534 = F_232 ;
return 0 ;
}
...
struct V_535 * V_536 ;
int V_180 ;
V_180 = F_245 ( V_106 , V_3 -> V_362 , 0 , 1 , 1 , & V_536 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_536 = V_536 ;
V_536 -> V_175 = V_3 ;
...
return V_180 ;
F_253 ( V_3 -> V_539 ) ;
V_180 = F_254 ( V_539 , L_151 ) ;
if ( V_180 < 0 )
return V_180 ;
V_3 -> V_369 = F_255 ( V_539 , 0 ) ;
V_546 = F_256 ( V_539 , 0 ) ;
F_202 ( V_106 -> V_107 , L_185 ,
V_3 -> V_369 , V_3 -> V_369 + V_546 - 1 ) ;
V_3 -> V_9 = F_257 ( V_3 -> V_369 , V_546 ) ;
if ( ! V_3 -> V_9 ) {
...
sizeof( struct V_528 ) ) ;
V_3 -> V_13 = F_259 ( sizeof( struct V_528 ) , V_556 ) ;
if ( ! V_3 -> V_13 ) {
F_46 ( V_106 -> V_107 ,
L_191 ,
...
V_595 ) {
V_3 -> V_216 ++ ;
V_3 -> V_234 = F_259 ( sizeof( struct V_596 ) ,
V_556 ) ;
if ( NULL != V_3 -> V_234 ) {
F_148 ( V_3 ) ;
}
...
static int F_269 ( struct V_545 * V_539 ,
...
V_180 = F_270 ( & V_539 -> V_107 , V_236 [ V_107 ] , V_156 [ V_107 ] ,
...
static void F_273 ( struct V_545 * V_539 )
{
F_271 ( F_274 ( V_539 ) ) ;
}
