...
if ( V_132 )
F_95 ( V_132 ) ;
V_132 = F_96 ( V_40 [ V_41 / V_167 ] -> V_3 ) ;
}
V_10 = V_41 % V_167 ;
V_63 -> V_132 [ V_41 ] -> V_32 = V_132 [ V_10 ] . V_32 ;
V_165 = F_97 ( V_132 [ V_10 ] . V_165 ) ;
V_166 = F_97 ( V_132 [ V_10 ] . V_166 ) ;
if ( V_166 >= ( V_168 >> 9 ) || V_166 < V_165 ) {
V_74 = - V_28 ;
goto V_38;
}
V_156 [ V_41 ] . V_169 = V_166 - V_165 + 1 ;
V_156 [ V_41 ] . V_170 = V_165 << 9 ;
V_157 -> V_79 += V_156 [ V_41 ] . V_169 ;
}
V_38:
if ( V_132 )
F_95 ( V_132 ) ;
...
V_181 : 0 ;
V_87 = F_99 ( V_84 , V_64 -> V_163 . V_174 . V_81 ,
...
static void F_104 ( struct V_63 * V_63 , int error )
{
if ( ( V_63 -> V_72 == V_188 ) &&
( error == - V_182 ) ) {
F_42 ( L_27 ) ;
...
static void F_107 ( struct V_192 * V_192 )
{
F_104 ( V_192 -> V_193 , V_192 -> V_194 ) ;
F_108 ( V_192 ) ;
}
static int
...
switch ( V_2 -> V_204 ) {
case V_205 :
memcpy ( & V_64 , F_113 ( & V_196 -> V_206 , V_74 ) , sizeof( V_64 ) ) ;
break;
case V_207 :
F_114 ( & V_64 , F_113 ( & V_196 -> V_208 , V_74 ) ) ;
break;
case V_209 :
F_115 ( & V_64 , F_113 ( & V_196 -> V_210 , V_74 ) ) ;
break;
default:
F_116 () ;
}
...
V_156 [ V_10 ] . V_169 = V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_166 -
V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_165 + 1 ;
V_156 [ V_10 ] . V_170 = ( V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_165 << 9 ) ;
if ( ( V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_166 >= ( V_168 >> 9 ) ) ||
( V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_166 <
V_64 -> V_163 . V_223 . V_156 [ V_10 ] . V_165 ) )
goto V_177;
V_157 . V_79 += V_156 [ V_10 ] . V_169 ;
}
} else {
...
for ( V_10 = 0 ; V_10 < V_160 ; V_10 ++ ) {
if ( ( ( int ) V_157 . V_81 | ( int ) V_156 [ V_10 ] . V_169 ) &
( ( F_121 ( V_157 . V_84 ) >> 9 ) - 1 ) ) {
F_42 ( L_37 ,
V_2 -> V_91 ) ;
goto V_177;
}
...
V_156 [ V_10 ] . V_169 << 9 ,
V_156 [ V_10 ] . V_170 ) == 0 ) ) {
int V_226 = F_123 ( int , ( V_160 - V_10 ) , V_227 ) ;
V_192 = F_124 ( V_149 , V_226 ) ;
if ( F_50 ( V_192 == NULL ) )
goto V_228;
V_214 [ V_215 ++ ] = V_192 ;
...
F_102 ( & V_63 -> V_191 , V_215 ) ;
F_125 ( & V_217 ) ;
for ( V_10 = 0 ; V_10 < V_215 ; V_10 ++ )
F_126 ( V_72 , V_214 [ V_10 ] ) ;
F_127 ( & V_217 ) ;
if ( V_72 == V_76 )
...
static void F_80 ( struct V_1 * V_2 , T_8 V_126 ,
...
switch ( V_2 -> V_204 ) {
case V_205 :
memcpy ( F_129 ( & V_196 -> V_206 , V_196 -> V_206 . V_203 ) ,
& V_238 , sizeof( V_238 ) ) ;
break;
case V_207 :
memcpy ( F_129 ( & V_196 -> V_208 , V_196 -> V_208 . V_203 ) ,
& V_238 , sizeof( V_238 ) ) ;
break;
case V_209 :
memcpy ( F_129 ( & V_196 -> V_210 , V_196 -> V_210 . V_203 ) ,
& V_238 , sizeof( V_238 ) ) ;
break;
default:
F_116 () ;
