...
int V_35 = F_22 ( V_9 -> V_10 ) ;
if ( V_35 < 0 ) {
F_23 ( V_34 -> V_36 . V_37 , L_2 ) ;
return;
}
V_35 = ( V_35 ? 1 : 0 ) ^ V_9 -> V_38 ;
if ( type == V_39 ) {
if ( V_35 )
F_24 ( V_34 , type , V_9 -> V_26 , V_9 -> V_40 ) ;
} else {
F_24 ( V_34 , type , V_9 -> V_26 , ! ! V_35 ) ;
}
F_25 ( V_34 ) ;
}
static void F_26 ( struct V_41 * V_11 )
{
struct V_5 * V_6 =
F_27 ( V_11 , struct V_5 , V_11 . V_11 ) ;
F_21 ( V_6 ) ;
if ( V_6 -> V_9 -> V_42 )
F_28 ( V_6 -> V_34 -> V_36 . V_37 ) ;
}
static T_2 F_29 ( int V_8 , void * V_43 )
{
struct V_5 * V_6 = V_43 ;
F_2 ( V_8 != V_6 -> V_8 ) ;
if ( V_6 -> V_9 -> V_42 )
F_30 ( V_6 -> V_34 -> V_36 . V_37 ) ;
F_31 ( V_44 ,
& V_6 -> V_11 ,
F_32 ( V_6 -> V_45 ) ) ;
return V_46 ;
...
F_34 ( & V_6 -> V_49 , V_48 ) ;
if ( V_6 -> V_50 ) {
F_24 ( V_34 , V_2 , V_6 -> V_9 -> V_26 , 0 ) ;
F_25 ( V_34 ) ;
V_6 -> V_50 = false ;
}
F_35 ( & V_6 -> V_49 , V_48 ) ;
}
static T_2 F_36 ( int V_8 , void * V_43 )
{
struct V_5 * V_6 = V_43 ;
const struct V_32 * V_9 = V_6 -> V_9 ;
struct V_33 * V_34 = V_6 -> V_34 ;
...
if ( ! V_6 -> V_50 ) {
if ( V_6 -> V_9 -> V_42 )
F_37 ( V_6 -> V_34 -> V_36 . V_37 , 0 ) ;
F_24 ( V_34 , V_2 , V_9 -> V_26 , 1 ) ;
F_25 ( V_34 ) ;
if ( ! V_6 -> V_51 ) {
F_24 ( V_34 , V_2 , V_9 -> V_26 , 0 ) ;
F_25 ( V_34 ) ;
goto V_28;
}
V_6 -> V_50 = true ;
...
{
const char * V_55 = V_9 -> V_55 ? V_9 -> V_55 : L_3 ;
struct V_56 * V_36 = & V_54 -> V_36 ;
T_3 V_57 ;
unsigned long V_58 ;
int V_8 ;
int error ;
...
V_6 -> V_51 = V_9 -> V_60 ;
F_46 ( & V_6 -> V_12 ,
F_33 , ( unsigned long ) V_6 ) ;
V_57 = F_36 ;
V_58 = 0 ;
}
F_47 ( V_34 , V_9 -> type ? : V_2 , V_9 -> V_26 ) ;
error = F_48 ( & V_54 -> V_36 , F_39 , V_6 ) ;
if ( error ) {
F_23 ( & V_54 -> V_36 ,
L_8 ,
error ) ;
...
int error ;
if ( V_23 -> V_65 ) {
error = V_23 -> V_65 ( V_34 -> V_36 . V_37 ) ;
if ( error )
return error ;
}
F_50 ( V_14 ) ;
...
const struct V_64 * V_23 = V_14 -> V_23 ;
if ( V_23 -> V_66 )
V_23 -> V_66 ( V_34 -> V_36 . V_37 ) ;
}
static struct V_64 *
F_54 ( struct V_56 * V_36 )
{
...
if ( F_62 ( V_69 , L_13 , & V_9 -> V_26 ) ) {
F_23 ( V_36 , L_14 ,
V_9 -> V_10 ) ;
return F_55 ( - V_30 ) ;
}
V_9 -> V_55 = F_58 ( V_69 , L_15 , NULL ) ;
if ( F_62 ( V_69 , L_16 , & V_9 -> type ) )
V_9 -> type = V_2 ;
V_9 -> V_42 = F_63 ( V_69 , L_17 ) ||
F_63 ( V_69 , L_18 ) ;
V_9 -> V_29 = ! ! F_58 ( V_69 , L_19 , NULL ) ;
if ( F_62 ( V_69 , L_20 ,
& V_9 -> V_60 ) )
V_9 -> V_60 = 5 ;
}
...
{
struct V_56 * V_36 = & V_54 -> V_36 ;
const struct V_64 * V_23 = F_65 ( V_36 ) ;
struct V_13 * V_14 ;
struct V_33 * V_34 ;
T_4 V_78 ;
int V_20 , error ;
...
struct V_5 * V_6 = & V_14 -> V_25 [ V_20 ] ;
error = F_40 ( V_54 , V_34 , V_6 , V_9 ) ;
if ( error )
return error ;
if ( V_9 -> V_42 )
V_42 = 1 ;
}
error = F_72 ( & V_54 -> V_36 . V_91 , & V_92 ) ;
if ( error ) {
F_23 ( V_36 , L_24 ,
error ) ;
return error ;
...
static int F_77 ( struct V_56 * V_36 )
{
struct V_13 * V_14 = F_78 ( V_36 ) ;
struct V_33 * V_34 = V_14 -> V_34 ;
int V_20 ;
if ( F_79 ( V_36 ) ) {
for ( V_20 = 0 ; V_20 < V_14 -> V_23 -> V_24 ; V_20 ++ ) {
...
static int F_81 ( struct V_56 * V_36 )
{
struct V_13 * V_14 = F_78 ( V_36 ) ;
struct V_33 * V_34 = V_14 -> V_34 ;
int error = 0 ;
