...
static T_12 F_199 ( struct V_117 * V_118 , struct V_95 * V_95 )
{
struct V_2 * V_3 ;
char V_339 [ V_340 ] ;
struct V_95 * V_341 ;
...
T_1 V_345 = F_1 ( F_106 ( V_95 ) - 1 , V_3 ) ;
if ( V_345 != V_190 ) {
F_53 ( V_345 != V_190 + V_3 -> V_5 . V_6 ) ;
V_341 = V_342 ( V_95 , V_345 -
V_95 -> V_111 . V_112 ,
V_335 , V_346 ) ;
F_203 ( V_341 , V_95 ) ;
} else {
...
{
struct V_2 * V_3 = V_69 -> V_347 ;
char * V_348 ;
char V_349 [ V_340 ] ;
int V_218 [ V_219 ] ;
F_208 ( V_69 , L_97 , V_3 -> V_8 ,
F_202 ( V_3 -> V_52 , V_349 ) ) ;
F_208 ( V_69 , L_98 ) ;
...
static int F_211 ( struct V_2 * V_3 , T_13 V_37 )
{
int V_85 ;
int V_61 = 0 ;
char V_339 [ V_340 ] ;
...
struct V_2 * V_350 = V_50 [ V_85 ] ;
if ( ! V_350 )
continue;
if ( V_350 -> V_52 -> V_53 == V_37 ) {
F_95 ( V_3 , L_129 ,
F_202 ( V_350 -> V_52 , V_339 ) ) ;
return - V_327 ;
}
if ( V_350 -> V_51 == V_37 ) {
F_95 ( V_3 , L_130 ) ;
...
if ( ! V_52 )
return - V_62 ;
V_61 = F_178 ( V_52 , V_313 | V_351 , NULL ) ;
if ( V_61 )
return V_61 ;
F_212 ( V_58 ) ;
V_3 -> V_52 = V_52 ;
...
V_3 -> V_78 . V_352 = F_213 ( F_144 , V_3 , L_1 , V_3 -> V_8 ) ;
if ( F_21 ( V_3 -> V_78 . V_352 ) ) {
F_95 ( V_3 , L_131 ) ;
V_61 = - V_62 ;
goto V_353;
}
F_214 ( V_3 -> V_8 , 0 , V_354 , & V_355 , V_3 ) ;
F_56 ( 1 , V_3 , L_132 , F_202 ( V_52 , V_339 ) ) ;
return 0 ;
V_353:
F_184 ( V_52 , V_313 | V_351 ) ;
F_33 ( V_58 ) ;
return V_61 ;
}
static int F_215 ( struct V_322 * V_52 , T_11 V_323 , unsigned int V_130 , unsigned long V_356 )
{
...
case V_361 :
case V_362 :
V_61 = F_216 ( V_3 -> V_52 , V_323 , V_130 , V_356 ) ;
break;
default:
...
if ( ! V_3 -> V_52 )
return 0 ;
V_365 = V_3 -> V_52 -> V_137 ;
if ( ! V_365 || ! V_365 -> V_366 -> V_367 )
return 0 ;
return V_365 -> V_366 -> V_367 ( V_365 , V_364 ) ;
}
static char * F_218 ( struct V_329 * V_368 , T_14 * V_323 )
{
return F_219 ( V_14 , L_135 , V_368 -> V_369 ) ;
}
...
V_202 -> V_366 = & V_375 ;
V_202 -> V_165 = V_376 ;
strcpy ( V_202 -> V_369 , V_3 -> V_8 ) ;
V_202 -> V_377 = F_218 ;
V_202 -> V_330 = V_3 ;
V_202 -> V_203 = F_223 ( V_14 ) ;
if ( ! V_202 -> V_203 )
goto V_378;
V_3 -> V_51 = F_20 ( V_373 , V_46 ) ;
V_61 = F_211 ( V_3 , V_37 ) ;
if ( V_61 )
goto V_379;
...
if ( ! F_21 ( V_3 -> V_78 . V_352 ) )
F_229 ( V_3 -> V_78 . V_352 ) ;
V_50 [ V_46 ] = NULL ;
F_48 ( V_3 ) ;
F_22 ( V_3 ) ;
F_184 ( V_3 -> V_52 , V_313 | V_351 ) ;
F_230 ( V_3 -> V_8 , V_354 ) ;
F_56 ( 1 , V_3 , L_139 ) ;
F_231 ( V_3 -> V_202 ) ;
...
static void F_232 ( struct V_382 * V_383 )
{
struct V_2 * V_3 ;
F_26 ( & V_47 , V_48 ) ;
V_3 = F_186 ( V_383 -> V_384 ) ;
if ( V_3 ) {
V_383 -> V_37 = F_233 ( V_3 -> V_52 -> V_53 ) ;
V_383 -> V_51 = F_233 ( V_3 -> V_51 ) ;
} else {
V_383 -> V_37 = 0 ;
V_383 -> V_51 = 0 ;
}
...
static long F_234 ( struct V_71 * V_71 , unsigned int V_130 , unsigned long V_356 )
{
void T_15 * V_386 = ( void T_15 * ) V_356 ;
struct V_382 V_383 ;
int V_61 = 0 ;
T_13 V_51 = 0 ;
if ( V_130 != V_387 )
return - V_363 ;
if ( F_235 ( & V_383 , V_386 , sizeof( struct V_382 ) ) )
return - V_388 ;
switch ( V_383 . V_389 ) {
case V_390 :
if ( ! F_236 ( V_391 ) )
return - V_392 ;
V_61 = F_32 ( F_237 ( V_383 . V_37 ) , & V_51 ) ;
V_383 . V_51 = F_233 ( V_51 ) ;
break;
case V_393 :
if ( ! F_236 ( V_391 ) )
return - V_392 ;
V_61 = F_35 ( F_237 ( V_383 . V_51 ) ) ;
break;
case V_394 :
F_232 ( & V_383 ) ;
break;
...
if ( F_238 ( V_386 , & V_383 , sizeof( struct V_382 ) ) )
return - V_388 ;
return V_61 ;
}
static long F_239 ( struct V_71 * V_71 , unsigned int V_130 , unsigned long V_356 )
{
return F_234 ( V_71 , V_130 , ( unsigned long ) F_240 ( V_356 ) ) ;
}
