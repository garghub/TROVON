...
V_218 = F_36 ( V_212 ) ;
V_217 = V_173 ;
for ( V_109 = 0 ; V_109 < V_218 ; V_109 ++ )
V_172 [ V_173 ++ ] = V_216 [ V_109 ] ;
F_54 ( V_172 [ V_217 ] , ( V_214 ) ) ;
V_217 ++ ;
F_54 ( V_172 [ V_217 ] , 0 ) ;
V_217 ++ ;
F_55 ( V_172 [ V_217 ] , ( V_215 >> 0 ) ) ;
V_217 ++ ;
F_55 ( V_172 [ V_217 ] , ( V_215 >> 0x10 ) ) ;
return V_173 - V_219 ;
}
...
{
int V_221 = 0 ;
unsigned int V_222 = 0 , V_223 = 0 , V_224 = 0 ;
unsigned int V_225 = 0 , V_226 = 0 ;
if ( * V_220 ) {
F_50 ( V_2 , V_3 , V_13 , V_45 , 0 , & V_222 ) ;
F_50 ( V_2 , V_3 , V_13 , V_45 , 0x1 , & V_223 ) ;
F_50 ( V_2 , V_3 , V_13 , V_45 , 0x2 , & V_224 ) ;
F_50 ( V_2 , V_3 , V_13 , V_46 , 0 , & V_225 ) ;
F_50 ( V_2 , V_3 , V_13 , V_46 , 0x1 , & V_226 ) ;
* V_220 = 0 ;
}
V_221 = F_49 ( V_2 , V_3 , V_13 , V_172 , V_173 , 1 ,
V_173 * 0x5 , NULL ) ;
if ( V_221 != 0 )
return - V_12 ;
F_51 ( V_2 , V_3 , V_13 , V_45 , 0 , V_222 ) ;
F_51 ( V_2 , V_3 , V_13 , V_45 , 0x1 , V_223 ) ;
F_51 ( V_2 , V_3 , V_13 , V_45 , 0x2 , V_224 ) ;
F_51 ( V_2 , V_3 , V_13 , V_46 , 0 , V_225 ) ;
F_51 ( V_2 , V_3 , V_13 , V_46 , 0x1 , V_226 ) ;
return 0 ;
}
...
V_229 = V_228 -> V_234 ;
V_232 = V_228 -> V_213 ;
if ( ( unsigned int ) V_232 > V_2 -> V_60 -> V_161 )
V_232 = V_2 -> V_60 -> V_161 ;
V_230 = F_58 ( V_232 , sizeof( T_2 ) ,
V_146 ) ;
if ( ! V_230 )
return - V_147 ;
V_231 = 0 ;
...
if ( V_230 && ( V_231 > 0 ) ) {
V_230 [ V_231 ++ ] = 0x0E000010000ull ;
V_221 = F_56 ( V_2 , V_3 , 0 , & V_233 ,
V_230 ,
V_231 ) ;
}
F_41 ( V_230 ) ;
...
unsigned char V_3 , unsigned char V_13 ,
enum V_35 V_198 ,
unsigned short V_41 , unsigned int V_235 )
{
int V_200 = 0 ;
unsigned int V_42 ;
unsigned int V_191 ;
unsigned short V_236 ;
unsigned short V_237 = 0x10 ;
...
case V_47 :
case V_49 :
F_60 ( V_2 , V_3 , V_42 , V_235 ) ;
break;
case V_51 :
case V_53 :
F_60 ( V_2 , V_3 , ( V_42 + V_237 ) , V_235 ) ;
break;
default:
V_200 = - V_30 ;
break;
...
unsigned short V_41 , unsigned int V_171 )
{
unsigned int V_238 , V_191 ;
unsigned short V_204 , V_205 , V_239 , V_240 , V_207 ,
V_241 ;
...
const unsigned short V_243 = 0 , V_244 = V_209 * 0x5 ;
F_3 ( V_2 , V_3 , V_31 , & V_191 ) ;
if ( V_117 & V_191 ) {
if ( V_13 & 0x1 ) {
F_5 ( L_15 , V_13 ) ;
...
V_242 = ( unsigned short ) ~ 0x1f ;
} else {
V_242 = ( unsigned short ) ~ 0xf ;
}
if ( V_41 & V_242 )
return - V_30 ;
V_240 = F_15 ( V_198 , V_41 ) ;
if ( V_240 == V_57 ) {
F_5 ( L_16 , V_240 ) ;
return - V_30 ;
}
F_50 ( V_2 , V_3 , V_13 , V_46 , V_243 , & V_238 ) ;
V_239 = F_15 ( V_46 , V_243 ) ;
V_241 = 0xffff & V_171 ;
V_207 = 0xffff & ( V_171 >> 0x10 ) ;
V_204 = F_15 ( V_56 ,
( unsigned short ) ( 0xff & V_207 ) ) ;
V_205 = F_15 ( V_56 ,
( unsigned short ) ( 0xff & V_241 ) ) ;
V_172 [ 0 ] = V_172 [ 0x0 ] | ( ( V_207 >> 8 ) << 20 ) |
( ( V_239 & 0x3ff ) << 10 ) | ( V_204 & 0x3ff ) ;
V_172 [ 1 ] = V_172 [ 0x1 ] | ( ( V_241 >> 8 ) << 20 ) |
( ( V_239 & 0x3ff ) << 10 ) | ( V_205 & 0x3ff ) ;
V_172 [ 0x2 ] = V_172 [ 0x2 ] |
( ( V_240 & 0x3ff ) << 20 ) | ( ( V_239 & 0x3ff ) << 10 ) ;
V_200 = F_49 ( V_2 , V_3 , V_13 , V_172 , V_209 ,
V_174 , V_244 , NULL ) ;
F_51 ( V_2 , V_3 , V_13 , V_46 , V_243 , V_238 ) ;
return V_200 ;
}
static int F_62 ( struct V_1 * V_2 ,
unsigned char V_3 , unsigned char V_13 ,
unsigned short V_245 , unsigned int V_235 )
{
unsigned int V_191 ;
int V_221 = 0 ;
F_3 ( V_2 , V_3 , V_31 , & V_191 ) ;
...
V_221 = F_61 ( V_2 , V_3 , V_13 , V_55 , V_245 , V_235 ) ;
F_6 ( V_2 , V_3 , V_31 , V_191 ) ;
return V_221 ;
}
...
enum V_35 V_198 ,
unsigned short V_41 , unsigned int V_248 )
{
int V_221 = 0 ;
unsigned short V_118 ;
...
V_221 = F_51 ( V_2 , V_3 , V_13 , type , V_118 , V_248 ) ;
if ( V_221 ) {
F_5 ( L_17 ) ;
return - V_30 ;
}
...
V_221 = F_61 ( V_2 , V_3 , V_13 , type , V_118 ,
V_248 ) ;
if ( V_221 ) {
F_5 ( L_18 ) ;
return - V_30 ;
...
V_221 = F_59 ( V_2 , V_3 , V_13 , type , V_118 ,
V_248 ) ;
if ( V_221 ) {
F_5 ( L_19 ) ;
return - V_30 ;
...
if ( ! F_65 ( V_13 , ( unsigned long * ) & V_4 ) )
continue;
V_221 = F_62 ( V_2 , V_3 , V_13 , V_41 , V_248 ) ;
if ( V_221 ) {
F_5 ( L_20 ) ;
return - V_30 ;
}
