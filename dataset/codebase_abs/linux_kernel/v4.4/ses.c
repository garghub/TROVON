...
return;
V_32 = V_4 -> V_94 + 4 ;
while ( V_32 < V_4 -> V_94 + V_4 -> V_93 ) {
enum V_62 V_63 = V_32 [ 0 ] >> 4 ;
T_3 V_95 = V_32 [ 0 ] & 0x0f ;
T_3 V_96 = V_32 [ 1 ] & 0x80 ;
T_3 V_97 = ( V_32 [ 1 ] & 0x30 ) >> 4 ;
T_3 type = V_32 [ 1 ] & 0x0f ;
T_3 V_80 = V_32 [ 3 ] ;
if ( V_96 && V_95 == 1 && V_97 == 1
&& V_63 == V_70 && type == 3 && V_80 == 8 )
V_72 . V_64 = F_19 ( & V_32 [ 4 ] ) ;
V_32 += V_80 + 4 ;
}
if ( V_72 . V_64 ) {
V_72 . V_2 = & V_4 -> V_98 ;
...
static int F_34 ( struct V_1 * V_99 ,
struct V_100 * V_101 )
{
struct V_3 * V_4 = F_2 ( V_99 -> V_38 ) ;
struct V_3 * V_102 ;
...
while ( ( V_31 = F_36 ( & V_4 -> V_106 -> V_107 , V_105 ) ) != NULL ) {
F_32 ( V_31 , V_4 ) ;
V_105 = V_31 ;
}
return - V_6 ;
...
V_104 = V_16 [ 1 ] + 1 ;
V_42 = V_16 + 8 ;
for ( V_33 = 0 ; V_33 < V_104 && V_42 < V_16 + V_80 ; V_33 ++ ) {
V_81 += V_42 [ 2 ] ;
V_42 += V_42 [ 3 ] + 4 ;
}
V_40 -> V_43 = V_42 ;
...
if ( ! V_67 )
goto V_110;
V_31 = F_37 ( V_99 -> V_38 , F_38 ( & V_4 -> V_98 ) ,
V_74 , & V_112 ) ;
if ( F_30 ( V_31 ) ) {
V_5 = F_39 ( V_31 ) ;
goto V_110;
...
static void F_47 ( struct V_1 * V_99 ,
struct V_100 * V_101 )
{
struct V_3 * V_4 = F_2 ( V_99 -> V_38 ) ;
if ( ! F_35 ( V_4 ) )
