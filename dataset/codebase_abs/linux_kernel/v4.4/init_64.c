...
return 0 ;
if ( F_79 ( * V_12 ) )
return F_151 ( F_152 ( * V_12 ) ) ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_43 ( * V_7 ) )
return 0 ;
if ( F_71 ( * V_7 ) )
return F_151 ( F_153 ( * V_7 ) ) ;
V_47 = F_45 ( V_7 , V_3 ) ;
if ( F_154 ( * V_47 ) )
return 0 ;
return F_151 ( F_155 ( * V_47 ) ) ;
}
static unsigned long F_156 ( void )
{
...
unsigned long F_158 ( void )
{
if ( ! V_139 )
V_139 = F_156 () ;
return V_139 ;
}
static int T_9 F_159 ( unsigned long V_30 ,
...
for ( V_3 = V_30 ; V_3 < V_4 ; V_3 = V_11 ) {
V_11 = F_116 ( V_3 , V_4 ) ;
V_24 = F_160 ( V_3 , V_140 ) ;
if ( ! V_24 )
return - V_17 ;
V_12 = F_161 ( V_24 , V_3 , V_140 ) ;
if ( ! V_12 )
return - V_17 ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_43 ( * V_7 ) ) {
void * V_141 ;
V_141 = F_162 ( V_6 , V_140 ) ;
if ( V_141 ) {
T_7 V_142 ;
...
F_163 ( ( T_7 * ) V_7 , V_140 , V_3 , V_11 ) ;
continue;
}
F_164 ( L_22 ) ;
if ( F_165 ( V_3 , V_11 , V_140 ) )
return - V_17 ;
}
return 0 ;
}
int T_9 F_166 ( unsigned long V_30 , unsigned long V_4 , int V_140 )
{
int V_148 ;
if ( V_149 )
V_148 = F_159 ( V_30 , V_4 , V_140 ) ;
else
V_148 = F_165 ( V_30 , V_4 , V_140 ) ;
if ( ! V_148 )
F_20 ( V_30 , V_4 - 1 , 0 ) ;
return V_148 ;
}
void F_167 ( unsigned long V_150 ,
...
F_168 ( V_150 , V_19 ( * V_24 ) , V_109 ) ;
V_12 = F_16 ( V_24 , V_3 ) ;
if ( F_40 ( * V_12 ) ) {
V_11 = ( V_3 + V_42 ) & V_43 ;
continue;
}
F_168 ( V_150 , V_10 ( * V_12 ) , V_109 ) ;
if ( ! V_149 ) {
V_11 = ( V_3 + V_42 ) & V_43 ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_43 ( * V_7 ) )
