...
if ( V_79 -> V_79 . V_82 . V_45 > 1 )
F_3 ( V_2 , V_83 , V_79 -> V_81 [ 1 ] ) ;
if ( V_79 -> V_79 . V_82 . V_45 > 2 )
F_3 ( V_2 , V_84 , V_79 -> V_81 [ 2 ] ) ;
}
...
unsigned int V_85 ;
int V_31 ;
V_2 = F_21 ( V_5 -> V_86 , sizeof( * V_2 ) , V_87 ) ;
if ( V_2 == NULL )
return F_22 ( - V_88 ) ;
V_2 -> V_89 = V_90 ;
V_2 -> V_91 = V_92 ;
...
V_21 -> V_4 . V_95 = & V_96 ;
V_21 -> V_97 = & V_98 ;
snprintf ( V_21 -> V_99 , sizeof( V_21 -> V_99 ) , L_1 ,
F_25 ( V_5 -> V_86 ) , V_6 ) ;
F_26 ( V_21 , V_2 ) ;
V_21 -> V_85 |= V_100 ;
F_27 ( V_21 , NULL ) ;
F_28 ( & V_2 -> V_12 , 1 ) ;
F_29 ( & V_2 -> V_12 , & V_101 , V_15 ,
0 , 255 , 1 , 255 ) ;
V_2 -> V_4 . V_21 . V_102 = & V_2 -> V_12 ;
if ( V_2 -> V_12 . error ) {
F_30 ( V_5 -> V_86 , L_2 ,
V_6 ) ;
V_31 = V_2 -> V_12 . error ;
...
V_2 -> V_4 . V_41 = V_41 ;
V_85 = V_105 ;
if ( ! ( V_5 -> V_106 . V_107 & V_108 ) || V_6 != 0 )
V_85 |= V_109 ;
V_31 = F_32 ( & V_2 -> V_4 . V_21 . V_4 ,
V_71 ,
& V_2 -> V_41 . V_41 . V_4 , 0 , V_85 ) ;
if ( V_31 < 0 )
goto error;
V_2 -> V_4 . V_110 = & V_2 -> V_41 . V_41 . V_4 ;
return V_2 ;
error:
F_33 ( & V_2 -> V_4 ) ;
return F_22 ( V_31 ) ;
