...
static bool F_97 ( struct V_3 * V_4 , T_1 V_174 )
{
unsigned int V_175 = F_24 ( V_4 , V_174 ) ;
return F_25 ( V_175 ) != V_86 &&
( F_98 ( V_175 ) == V_176 ||
F_98 ( V_175 ) == V_177 ) ;
}
static void F_99 ( struct V_3 * V_4 , T_1 V_174 )
{
unsigned int V_175 = F_24 ( V_4 , V_174 ) ;
V_175 = ( V_175 & ( ~ V_178 ) ) |
( V_177 << V_179 ) ;
V_175 = ( V_175 & ( ~ ( V_180 | V_181 ) ) ) |
0x1f ;
F_73 ( V_4 , V_174 , V_175 ) ;
}
...
if ( V_9 -> V_166 )
V_192 |= V_193 ;
V_191 = F_114 ( V_4 , & V_9 -> V_15 . V_108 , NULL , V_192 ) ;
if ( V_191 < 0 )
return V_191 ;
V_9 -> V_15 . V_194 = F_1 ;
V_9 -> V_15 . V_195 = F_3 ;
V_9 -> V_15 . V_196 = F_16 ;
V_191 = F_115 ( V_4 , & V_9 -> V_15 . V_108 ) ;
if ( V_191 < 0 )
return V_191 ;
if ( V_9 -> V_63 ) {
V_191 = F_116 ( V_4 , V_9 -> V_63 ) ;
if ( V_191 < 0 )
return V_191 ;
}
if ( V_9 -> V_126 > 0 ) {
...
struct V_3 * V_4 , T_1 V_18 )
{
F_123 ( V_206 , V_4 , V_18 ) ;
if ( V_18 == V_4 -> V_31 . V_32 )
F_125 ( V_206 , V_4 , 0xfa0 ) ;
}
static void F_127 ( struct V_205 * V_206 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 . V_32 )
F_125 ( V_206 , V_4 , 0xfe0 ) ;
}
static void F_128 ( struct V_205 * V_206 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 . V_32 )
F_125 ( V_206 , V_4 , 0xfeb ) ;
}
...
return V_191 ;
V_9 = V_4 -> V_9 ;
if ( ( V_4 -> V_31 . V_95 & 0xfffffff0 ) != 0x111d7670 )
V_4 -> V_226 = 1 ;
V_9 -> V_199 = 0 ;
V_9 -> V_15 . V_227 = 0x1d ;
V_9 -> V_204 = 1 ;
...
if ( F_143 ( F_144 ( V_4 , 0x28 ) ) == V_252 )
F_71 ( V_4 , V_253 ) ;
if ( F_144 ( V_4 , 0xa ) & V_254 ) {
const T_1 * V_255 ;
for ( V_255 = V_249 ; * V_255 ; V_255 ++ )
F_145 ( V_4 , * V_255 , V_256 , 0 ,
0xff , 0x00 ) ;
}
V_9 -> V_202 = & V_257 ;
V_9 -> V_90 = 0x50 ;
...
V_9 -> V_14 = 1 ;
V_9 -> V_15 . V_197 = 0x26 ;
V_9 -> V_76 = F_138 ( V_258 ) ;
V_9 -> V_77 = V_258 ;
F_102 ( V_4 , V_259 , V_260 ,
V_261 ) ;
F_103 ( V_4 , V_153 ) ;
F_139 ( V_4 ) ;
V_191 = F_113 ( V_4 ) ;
...
V_9 -> V_15 . V_214 = 1 ;
F_71 ( V_4 , V_262 ) ;
F_147 ( V_4 , 0x12 , V_117 ,
( 0 << V_263 ) |
( 2 << V_129 ) |
( 0x27 << V_264 ) |
( 0 << V_124 ) ) ;
F_102 ( V_4 , V_265 , V_266 ,
V_185 ) ;
F_103 ( V_4 , V_153 ) ;
V_191 = F_113 ( V_4 ) ;
if ( V_191 < 0 ) {
