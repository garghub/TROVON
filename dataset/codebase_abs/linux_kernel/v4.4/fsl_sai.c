...
bool V_35 = V_95 -> V_98 == V_99 ;
T_2 V_9 , V_110 = 100 ;
F_8 ( V_4 -> V_15 , V_93 , V_111 ,
V_4 -> V_88 [ V_89 ] ? V_111 : 0 ) ;
...
F_8 ( V_4 -> V_15 , F_38 ( V_35 ) , V_123 ,
V_123 ) ;
V_49 = F_39 ( V_95 -> V_124 , 0 ,
V_125 , & V_126 ) ;
return V_49 ;
}
...
struct V_3 * V_4 = F_7 ( V_31 ) ;
bool V_35 = V_95 -> V_98 == V_99 ;
F_8 ( V_4 -> V_15 , F_38 ( V_35 ) , V_123 , 0 ) ;
F_33 ( V_4 -> V_122 ) ;
}
static int F_41 ( struct V_30 * V_31 )
{
struct V_3 * V_4 = F_42 ( V_31 -> V_6 ) ;
F_5 ( V_4 -> V_15 , V_16 , V_121 ) ;
F_5 ( V_4 -> V_15 , V_26 , V_121 ) ;
F_5 ( V_4 -> V_15 , V_16 , 0 ) ;
F_5 ( V_4 -> V_15 , V_26 , 0 ) ;
...
V_4 -> V_122 = F_57 ( & V_7 -> V_6 , L_21 ) ;
if ( F_54 ( V_4 -> V_122 ) ) {
F_11 ( & V_7 -> V_6 , L_24 ,
F_55 ( V_4 -> V_122 ) ) ;
V_4 -> V_122 = NULL ;
}
V_4 -> V_86 [ 0 ] = V_4 -> V_122 ;
