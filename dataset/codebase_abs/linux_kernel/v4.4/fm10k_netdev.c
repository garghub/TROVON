...
T_1 V_106 = V_23 -> V_96 & ( V_98 - 1 ) ;
if ( F_83 ( V_106 , V_17 -> V_105 ) )
V_23 -> V_96 |= V_107 ;
else
V_23 -> V_96 &= ~ V_107 ;
}
if ( ! V_97 && V_96 == V_43 -> V_45 . V_108 )
return 0 ;
if ( F_83 ( V_109 , & V_17 -> V_110 ) )
return 0 ;
F_84 ( V_17 ) ;
if ( ! ( V_21 -> V_111 & V_112 ) ) {
V_9 = V_43 -> V_45 . V_99 . V_113 ( V_43 , V_96 , 0 , V_97 ) ;
if ( V_9 )
goto V_114;
}
V_9 = V_43 -> V_45 . V_99 . V_100 ( V_43 , V_17 -> V_48 , V_43 -> V_45 . V_115 ,
V_96 , V_97 , 0 ) ;
if ( V_9 )
goto V_114;
...
static T_1 F_90 ( struct V_16 * V_17 , T_1 V_96 )
{
struct V_42 * V_43 = & V_17 -> V_43 ;
T_1 V_108 = V_43 -> V_45 . V_108 ;
T_1 V_116 = V_96 < V_108 ? V_108 : V_98 ;
V_96 = F_91 ( V_17 -> V_105 , V_116 , ++ V_96 ) ;
return V_96 ;
}
...
for ( V_96 = 0 , V_117 = 0 ;
V_117 < V_98 ;
V_117 = V_96 + 1 , V_96 = F_90 ( V_17 , V_96 ) ) {
if ( V_117 == V_96 )
continue;
V_117 += ( V_96 - V_117 - 1 ) << V_118 ;
V_43 -> V_45 . V_99 . V_113 ( V_43 , V_117 , 0 , false ) ;
}
}
...
if ( ! F_94 ( V_115 ) )
return - V_120 ;
for ( V_96 = V_43 -> V_45 . V_108 ? F_90 ( V_17 , 0 ) : 0 ;
V_96 < V_98 ;
V_96 = F_90 ( V_17 , V_96 ) ) {
V_9 = V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_115 ,
V_96 , V_119 , 0 ) ;
if ( V_9 )
return V_9 ;
}
...
{
return F_93 ( V_4 , V_115 , true ) ;
}
static int F_96 ( struct V_61 * V_4 ,
const unsigned char * V_115 )
{
return F_93 ( V_4 , V_115 , false ) ;
}
static int F_97 ( struct V_61 * V_4 , void * V_121 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
struct V_42 * V_43 = & V_17 -> V_43 ;
...
if ( V_4 -> V_111 & V_124 ) {
F_84 ( V_17 ) ;
V_9 = F_95 ( V_4 , V_115 -> V_123 ) ;
if ( ! V_9 )
F_96 ( V_4 , V_43 -> V_45 . V_115 ) ;
F_87 ( V_17 ) ;
}
if ( ! V_9 ) {
F_98 ( V_4 -> V_125 , V_115 -> V_123 ) ;
F_98 ( V_43 -> V_45 . V_115 , V_115 -> V_123 ) ;
V_4 -> V_126 &= ~ V_127 ;
}
return V_9 ? - V_128 : 0 ;
}
...
V_96 < V_98 ;
V_96 = F_90 ( V_17 , V_96 ) ) {
V_43 -> V_45 . V_99 . V_102 ( V_43 , V_48 , V_115 , V_96 , V_119 ) ;
}
return 0 ;
}
...
const unsigned char * V_115 )
{
return F_99 ( V_4 , V_115 , true ) ;
}
static int F_101 ( struct V_61 * V_4 ,
const unsigned char * V_115 )
{
return F_99 ( V_4 , V_115 , false ) ;
}
...
if ( V_17 -> V_129 != V_129 ) {
if ( V_129 == V_130 )
V_43 -> V_45 . V_99 . V_113 ( V_43 , V_137 , 0 , true ) ;
if ( V_17 -> V_129 == V_130 )
F_92 ( V_17 ) ;
V_43 -> V_45 . V_99 . V_138 ( V_43 , V_17 -> V_48 , V_129 ) ;
V_17 -> V_129 = V_129 ;
}
if ( V_129 != V_130 ) {
F_103 ( V_4 , F_95 , F_96 ) ;
...
V_43 -> V_45 . V_99 . V_113 ( V_43 , V_137 , 0 ,
V_129 == V_130 ) ;
V_43 -> V_45 . V_99 . V_113 ( V_43 , 0 , 0 , true ) ;
for ( V_96 = V_43 -> V_45 . V_108 ? F_90 ( V_17 , 0 ) : 0 ;
V_96 < V_98 ;
V_96 = F_90 ( V_17 , V_96 ) ) {
V_43 -> V_45 . V_99 . V_113 ( V_43 , V_96 , 0 , true ) ;
V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_43 -> V_45 . V_115 ,
V_96 , true , 0 ) ;
}
V_43 -> V_45 . V_99 . V_138 ( V_43 , V_48 , V_129 ) ;
if ( V_129 != V_130 ) {
...
V_43 -> V_45 . V_99 . V_138 ( V_43 , V_48 , V_135 ) ;
V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_160 -> V_125 , 0 , true , 0 ) ;
F_87 ( V_17 ) ;
return V_160 ;
}
...
F_84 ( V_17 ) ;
V_48 = V_159 -> V_163 + 1 + V_18 ;
V_43 -> V_45 . V_99 . V_138 ( V_43 , V_48 , V_136 ) ;
V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_160 -> V_125 , 0 , false , 0 ) ;
F_87 ( V_17 ) ;
...
struct V_16 * V_17 ;
struct V_61 * V_4 ;
V_4 = F_136 ( sizeof( struct V_16 ) , V_183 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_184 = & V_185 ;
F_137 ( V_4 ) ;
V_17 = F_41 ( V_4 ) ;
V_17 -> V_186 = ( 1 << V_187 ) - 1 ;
V_4 -> V_179 |= V_188 |
V_189 |
V_190 |
V_191 |
