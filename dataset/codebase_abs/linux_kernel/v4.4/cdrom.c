...
static int F_135 ( struct V_1 * V_2 , unsigned int V_12 ,
unsigned long V_348 )
{
struct V_3 V_4 ;
...
static int F_138 ( const char * V_142 , int V_454 , char * V_197 ,
int * V_455 , enum V_456 V_457 )
{
const int V_458 = sizeof( V_459 . V_197 ) ;
struct V_1 * V_2 ;
int V_21 ;
V_21 = F_139 ( V_197 + * V_455 , V_458 - * V_455 , V_142 ) ;
if ( ! V_21 )
return 1 ;
* V_455 += V_21 ;
F_140 (cdi, &cdrom_list, list) {
switch ( V_457 ) {
case V_460 :
V_21 = F_139 ( V_197 + * V_455 , V_458 - * V_455 ,
L_110 , V_2 -> V_54 ) ;
break;
case V_461 :
V_21 = F_139 ( V_197 + * V_455 , V_458 - * V_455 ,
...
static int F_141 ( struct V_465 * V_466 , int V_31 ,
...
if ( F_138 ( L_114 , 0 , V_197 , & V_455 , V_460 ) )
goto V_470;
if ( F_138 ( L_115 , 0 , V_197 , & V_455 , V_461 ) )
goto V_470;
if ( F_138 ( L_116 , 0 , V_197 , & V_455 , V_463 ) )
goto V_470;
if ( F_138 ( L_117 ,
...
goto V_470;
if ( ! F_139 ( V_197 + V_455 , V_458 - V_455 , L_134 ) )
goto V_470;
V_471:
F_24 ( & V_102 ) ;
return F_142 ( V_466 , V_31 , V_27 , V_467 , V_468 ) ;
V_470:
F_10 ( L_135 ) ;
goto V_471;
}
...
static int F_144 ( struct V_465 * V_466 , int V_31 ,
void T_10 * V_27 , T_16 * V_467 , T_17 * V_468 )
{
int V_21 ;
V_21 = F_145 ( V_466 , V_31 , V_27 , V_467 , V_468 ) ;
if ( V_31 ) {
V_88 = ! ! V_459 . V_88 ;
V_90 = ! ! V_459 . V_90 ;
V_352 = ! ! V_459 . V_352 ;
...
static int T_18 F_149 ( void )
{
F_19 () ;
return 0 ;
}
static void T_19 F_150 ( void )
{
F_10 ( L_136 ) ;
F_147 () ;
}
