...
static int F_39 ( void * V_174 , int V_8 )
{
...
return - V_69 ;
V_3 -> V_110 = F_60 ( V_44 -> V_97 . V_203 , L_28 ) ;
if ( V_3 -> V_110 < 0 )
V_3 -> V_110 = 0 ;
V_3 -> V_184 = F_61 ( V_44 -> V_97 . V_203 , 0 ) ;
if ( V_3 -> V_184 <= 0 ) {
F_62 ( & V_44 -> V_97 , L_29 ) ;
return - V_69 ;
}
if ( F_63 ( V_44 -> V_97 . V_203 , 0 , & V_202 ) ) {
F_62 ( & V_44 -> V_97 , L_30 ) ;
return - V_69 ;
}
V_3 -> V_71 = F_64 ( & V_44 -> V_97 , V_202 . V_204 , F_65 ( & V_202 ) ) ;
if ( ! V_3 -> V_71 ) {
F_62 ( & V_44 -> V_97 , L_31 ) ;
return - V_205 ;
}
...
V_3 -> V_50 != V_156 )
return 0 ;
if ( F_63 ( V_44 -> V_97 . V_203 , 1 , & V_202 ) ) {
F_62 ( & V_44 -> V_97 , L_33 ) ;
return - V_69 ;
}
V_3 -> V_86 = F_64 ( & V_44 -> V_97 , V_202 . V_204 ,
F_65 ( & V_202 ) ) ;
if ( ! V_3 -> V_86 ) {
F_62 ( & V_44 -> V_97 , L_31 ) ;
return - V_207 ;
...
struct V_1 * V_3 ;
int V_45 ;
V_3 = F_66 ( & V_44 -> V_97 , sizeof( struct V_1 ) ,
V_206 ) ;
if ( ! V_3 )
return - V_207 ;
F_68 ( V_44 , V_3 ) ;
F_69 ( & V_3 -> V_10 ) ;
V_3 -> V_208 = F_70 ( & V_44 -> V_97 , L_34 ) ;
if ( ! F_16 ( V_3 -> V_208 ) ) {
V_45 = F_71 ( V_3 -> V_208 ) ;
if ( V_45 ) {
F_62 ( & V_44 -> V_97 , L_35 ) ;
...
goto V_209;
F_72 ( & V_3 -> V_181 , F_45 ) ;
V_3 -> V_46 = F_73 ( & V_44 -> V_97 , L_37 ) ;
if ( F_16 ( V_3 -> V_46 ) ) {
F_62 ( & V_44 -> V_97 , L_38 ) ;
V_45 = F_74 ( V_3 -> V_46 ) ;
goto V_209;
}
V_3 -> V_47 = F_73 ( & V_44 -> V_97 , L_39 ) ;
if ( F_16 ( V_3 -> V_47 ) ) {
if ( V_3 -> V_50 == V_85 ) {
F_62 ( & V_44 -> V_97 , L_40 ) ;
V_45 = F_74 ( V_3 -> V_47 ) ;
...
V_3 -> V_7 = F_77 ( & V_44 -> V_97 , 0 , V_3 ,
& V_213 ) ;
if ( F_16 ( V_3 -> V_7 ) ) {
V_45 = F_74 ( V_3 -> V_7 ) ;
F_62 ( & V_44 -> V_97 , L_44 , V_45 ) ;
goto V_214;
}
V_45 = F_13 ( V_44 ) ;
if ( V_45 ) {
...
V_216 | V_217 , F_79 ( & V_44 -> V_97 ) , V_3 ) ;
if ( V_45 ) {
...
static int F_85 ( struct V_14 * V_97 )
{
F_19 ( F_86 ( V_97 ) , false ) ;
return 0 ;
}
static int F_87 ( struct V_14 * V_97 )
{
struct V_43 * V_44 = F_86 ( V_97 ) ;
F_13 ( V_44 ) ;
F_19 ( V_44 , true ) ;
return 0 ;
}
