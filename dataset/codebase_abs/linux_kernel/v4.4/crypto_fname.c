...
if ( V_17 -> V_40 <= 0 || V_17 -> V_40 > V_39 )
return - V_41 ;
V_50 [ 0 ] . V_48 = V_17 -> V_48 ;
V_50 [ 0 ] . V_40 = V_17 -> V_40 ;
V_51 [ 0 ] . V_48 = V_19 -> V_48 ;
V_2 = F_11 ( V_26 , V_42 ) ;
if ( ! V_2 ) {
F_12 (
V_44 L_1 , V_45 ) ;
...
V_19 -> V_40 = F_22 ( V_19 -> V_48 , V_17 -> V_40 ) ;
return V_19 -> V_40 ;
}
static int F_23 ( const char * V_52 , int V_40 , char * V_53 )
{
int V_54 = 0 , V_55 = 0 , V_56 = 0 ;
char * V_57 = V_53 ;
while ( V_54 < V_40 ) {
V_56 += ( ( ( unsigned char ) V_52 [ V_54 ] ) << V_55 ) ;
V_55 += 8 ;
do {
* V_57 ++ = V_58 [ V_56 & 0x3f ] ;
V_56 >>= 6 ;
...
static int F_24 ( const char * V_52 , int V_40 , char * V_53 )
{
int V_54 = 0 , V_55 = 0 , V_56 = 0 ;
const char * V_59 ;
char * V_57 = V_53 ;
while ( V_54 < V_40 ) {
V_59 = strchr ( V_58 , V_52 [ V_54 ] ) ;
if ( V_59 == NULL || V_52 [ V_54 ] == 0 )
return - 2 ;
V_56 += ( V_59 - V_58 ) << V_55 ;
V_55 += 6 ;
if ( V_55 >= 8 ) {
...
T_2 F_9 ( T_2 V_60 , T_2 V_61 )
{
return ( ( V_60 + V_61 - 1 ) / V_61 ) * V_61 ;
}
unsigned F_25 ( struct V_11 * V_11 , T_2 V_62 )
{
struct V_22 * V_23 = F_8 ( V_11 ) -> V_24 ;
int V_33 = 32 ;
if ( V_23 )
...
if ( V_62 < V_29 )
V_62 = V_29 ;
return F_9 ( V_62 , V_33 ) ;
}
int F_26 ( struct V_11 * V_11 ,
T_2 V_62 , struct V_18 * V_63 )
{
unsigned int V_64 = F_25 ( V_11 , V_62 ) ;
V_63 -> V_40 = V_64 ;
if ( V_64 < V_65 * 2 )
V_64 = V_65 * 2 ;
V_63 -> V_48 = F_10 ( V_64 + 1 , V_42 ) ;
if ( ! ( V_63 -> V_48 ) )
return - V_43 ;
return 0 ;
}
void F_27 ( struct V_18 * V_63 )
{
if ( ! V_63 )
return;
F_13 ( V_63 -> V_48 ) ;
...
if ( F_8 ( V_11 ) -> V_24 )
return F_20 ( V_11 , V_17 , V_19 ) ;
if ( V_17 -> V_40 <= V_65 ) {
V_68 = F_23 ( V_17 -> V_48 , V_17 -> V_40 , V_19 -> V_48 ) ;
V_19 -> V_40 = V_68 ;
return V_68 ;
}
if ( V_67 ) {
memcpy ( V_37 , & V_67 -> V_70 , 4 ) ;
memcpy ( V_37 + 4 , & V_67 -> V_71 , 4 ) ;
} else
memset ( V_37 , 0 , 8 ) ;
memcpy ( V_37 + 8 , V_17 -> V_48 + V_17 -> V_40 - 16 , 16 ) ;
V_19 -> V_48 [ 0 ] = '_' ;
V_68 = F_23 ( V_37 , 24 , V_19 -> V_48 + 1 ) ;
V_19 -> V_40 = V_68 + 1 ;
return V_68 + 1 ;
}
...
. V_40 = V_73 -> V_74 } ;
return F_28 ( V_11 , V_67 , & V_17 , V_19 ) ;
}
...
V_23 = F_8 ( V_76 ) -> V_24 ;
if ( V_23 ) {
V_68 = F_26 ( V_76 , V_17 -> V_40 ,
& V_79 -> V_83 ) ;
if ( V_68 < 0 )
return V_68 ;
V_68 = F_6 ( V_76 , V_17 , & V_79 -> V_83 ) ;
if ( V_68 < 0 )
goto V_84;
...
return - V_43 ;
V_68 = F_24 ( V_17 -> V_48 + V_80 , V_17 -> V_40 - V_80 ,
V_79 -> V_83 . V_48 ) ;
if ( V_68 < 0 ) {
V_68 = - V_85 ;
goto V_84;
...
V_79 -> V_83 . V_40 = V_68 ;
if ( V_80 ) {
memcpy ( & V_79 -> V_67 . V_70 , V_79 -> V_83 . V_48 , 4 ) ;
memcpy ( & V_79 -> V_67 . V_71 , V_79 -> V_83 . V_48 + 4 , 4 ) ;
} else {
V_79 -> V_82 . V_48 = V_79 -> V_83 . V_48 ;
V_79 -> V_82 . V_40 = V_79 -> V_83 . V_40 ;
}
