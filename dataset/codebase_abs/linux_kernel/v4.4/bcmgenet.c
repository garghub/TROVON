...
for ( V_70 = 0 ; V_70 < V_2 -> V_8 -> V_80 ; ++ V_70 ) {
V_30 = & V_2 -> V_325 [ V_70 ] ;
F_162 ( V_2 -> V_23 , & V_30 -> V_188 , F_143 , 64 ) ;
}
V_30 = & V_2 -> V_325 [ V_65 ] ;
F_162 ( V_2 -> V_23 , & V_30 -> V_188 , F_143 , 64 ) ;
}
...
static int F_176 ( struct V_34 * V_23 )
{
struct V_1 * V_2 = F_23 ( V_23 ) ;
T_2 V_70 ;
T_2 V_332 ;
...
V_2 -> V_285 = V_344 ;
V_2 -> V_263 = F_182 ( V_2 -> V_285 , sizeof( struct V_148 ) ,
V_357 ) ;
if ( ! V_2 -> V_263 )
return - V_284 ;
for ( V_70 = 0 ; V_70 < V_2 -> V_285 ; V_70 ++ ) {
...
V_2 -> V_354 = V_344 ;
V_2 -> V_175 = F_182 ( V_2 -> V_354 , sizeof( struct V_148 ) ,
V_357 ) ;
if ( ! V_2 -> V_175 ) {
F_180 ( V_2 -> V_263 ) ;
return - V_284 ;
...
static void F_183 ( struct V_363 * V_364 )
{
...
static T_9 F_185 ( int V_371 , void * V_372 )
{
...
static T_9 F_189 ( int V_371 , void * V_372 )
{
struct V_1 * V_2 = V_372 ;
struct V_158 * V_373 ;
struct V_149 * V_374 ;
...
static T_9 F_193 ( int V_371 , void * V_372 )
{
struct V_1 * V_2 = V_372 ;
F_194 ( & V_2 -> V_196 -> V_23 , 0 ) ;
return V_378 ;
}
static void F_195 ( struct V_34 * V_23 )
{
struct V_1 * V_2 = F_23 ( V_23 ) ;
F_196 ( V_2 -> V_384 ) ;
F_189 ( V_2 -> V_384 , V_2 ) ;
...
static void F_201 ( struct V_1 * V_2 , T_2 V_333 )
{
T_2 V_71 ;
V_71 = F_27 ( V_2 , V_336 ) ;
V_71 |= V_333 ;
...
static void F_204 ( struct V_1 * V_2 , T_2 V_389 )
{
T_2 V_97 ;
T_2 V_71 ;
V_97 = V_390 + ( V_389 < 32 ) * sizeof( T_2 ) ;
...
int F_209 ( struct V_1 * V_2 , T_2 * V_396 ,
T_2 V_393 , T_2 V_391 )
{
int V_389 ;
T_2 V_70 ;
...
F_210 ( V_2 , V_396 [ V_70 ] ,
( V_389 * V_2 -> V_8 -> V_397 + V_70 ) *
sizeof( T_2 ) ) ;
F_207 ( V_2 , V_389 , 2 * V_393 ) ;
F_206 ( V_2 , V_389 , V_391 ) ;
F_204 ( V_2 , V_389 ) ;
F_205 ( V_2 , 0x1 , V_398 ) ;
return 0 ;
}
...
F_201 ( V_2 , V_333 ) ;
F_212 ( V_2 ) ;
V_59 = F_217 ( V_2 -> V_384 , F_189 , V_408 ,
V_23 -> V_409 , V_2 ) ;
if ( V_59 < 0 ) {
F_131 ( V_23 , L_27 , V_2 -> V_384 ) ;
goto V_410;
}
V_59 = F_217 ( V_2 -> V_385 , F_185 , V_408 ,
V_23 -> V_409 , V_2 ) ;
if ( V_59 < 0 ) {
...
static void F_226 ( struct V_149 * V_30 )
{
struct V_1 * V_2 = V_30 -> V_2 ;
...
F_101 ( & V_30 -> V_186 , V_9 ) ;
if ( V_30 -> V_163 == V_65 ) {
V_418 = ~ F_190 ( V_2 , V_377 ) ;
V_419 = V_164 | V_421 ;
} else {
V_418 = ~ F_186 ( V_2 , V_377 ) ;
V_419 = 1 << V_30 -> V_163 ;
}
V_168 = F_29 ( V_2 , V_30 -> V_163 , V_171 ) ;
...
F_226 ( & V_2 -> V_192 [ V_422 ] ) ;
F_226 ( & V_2 -> V_192 [ V_65 ] ) ;
F_106 ( V_23 ) ;
for ( V_422 = 0 ; V_422 < V_2 -> V_8 -> V_79 ; V_422 ++ )
V_299 |= ( 1 << V_422 ) ;
V_292 = V_164 ;
...
static inline void F_230 ( struct V_1 * V_2 ,
unsigned char * V_6 ,
int * V_70 ,
int * V_426 )
{
...
V_70 = 0 ;
V_426 = 0 ;
F_230 ( V_2 , V_23 -> V_435 , & V_70 , & V_426 ) ;
F_230 ( V_2 , V_23 -> V_406 , & V_70 , & V_426 ) ;
if ( F_232 ( V_23 ) > ( V_429 - V_426 ) )
return;
if ( ! F_233 ( V_23 ) )
F_234 (ha, dev)
F_230 ( V_2 , V_431 -> V_6 , & V_70 , & V_426 ) ;
if ( F_235 ( V_23 ) || F_236 ( V_23 ) >= ( V_429 - V_426 ) )
return;
F_237 (ha, dev)
F_230 ( V_2 , V_431 -> V_6 , & V_70 , & V_426 ) ;
}
static int F_238 ( struct V_34 * V_23 , void * V_98 )
{
struct V_436 * V_6 = V_98 ;
if ( F_34 ( V_23 ) )
return - V_437 ;
F_239 ( V_23 -> V_406 , V_6 -> V_438 ) ;
return 0 ;
}
...
F_243 ( & V_2 -> V_196 -> V_23 , L_45 V_455 ,
...
static int F_246 ( struct V_458 * V_196 )
{
...
if ( V_463 ) {
V_466 = F_248 ( V_472 , V_463 ) ;
if ( ! V_466 )
return - V_37 ;
}
V_2 = F_23 ( V_23 ) ;
V_2 -> V_384 = F_249 ( V_196 , 0 ) ;
V_2 -> V_385 = F_249 ( V_196 , 1 ) ;
V_2 -> V_473 = F_249 ( V_196 , 2 ) ;
...
V_25 = F_251 ( V_196 , V_475 , 0 ) ;
V_2 -> V_17 = F_252 ( & V_196 -> V_23 , V_25 ) ;
if ( F_253 ( V_2 -> V_17 ) ) {
V_469 = F_254 ( V_2 -> V_17 ) ;
goto V_469;
}
F_255 ( V_23 , & V_196 -> V_23 ) ;
F_256 ( & V_196 -> V_23 , V_23 ) ;
F_239 ( V_23 -> V_406 , V_467 ) ;
V_23 -> V_476 = 2 * V_477 ;
V_23 -> V_478 = & V_479 ;
V_23 -> V_480 = & V_481 ;
V_2 -> V_60 = F_257 ( - 1 , V_482 ) ;
V_23 -> V_483 |= V_484 | V_53 |
V_54 | V_43 ;
V_2 -> V_485 = true ;
V_469 = F_258 ( & V_196 -> V_23 , V_2 -> V_473 , F_193 , 0 ,
V_23 -> V_409 , V_2 ) ;
if ( ! V_469 )
F_259 ( & V_196 -> V_23 , 1 ) ;
V_23 -> V_486 += 64 ;
...
V_2 -> V_403 = F_261 ( & V_2 -> V_196 -> V_23 , L_58 ) ;
if ( F_253 ( V_2 -> V_403 ) ) {
F_262 ( & V_2 -> V_196 -> V_23 , L_59 ) ;
V_2 -> V_403 = NULL ;
}
F_55 ( V_2 -> V_403 ) ;
F_240 ( V_2 ) ;
F_263 ( & V_2 -> V_383 ) ;
V_2 -> V_243 = V_319 ;
F_264 ( & V_2 -> V_365 , F_183 ) ;
V_2 -> V_489 = F_261 ( & V_2 -> V_196 -> V_23 , L_60 ) ;
if ( F_253 ( V_2 -> V_489 ) ) {
F_262 ( & V_2 -> V_196 -> V_23 , L_61 ) ;
V_2 -> V_489 = NULL ;
}
V_2 -> V_116 = F_261 ( & V_2 -> V_196 -> V_23 , L_62 ) ;
if ( F_253 ( V_2 -> V_116 ) ) {
F_262 ( & V_2 -> V_196 -> V_23 , L_63 ) ;
V_2 -> V_116 = NULL ;
}
V_469 = F_148 ( V_2 ) ;
if ( V_469 )
...
if ( V_469 )
goto V_404;
F_266 ( V_2 -> V_23 , V_2 -> V_8 -> V_79 + 1 ) ;
F_267 ( V_2 -> V_23 , V_2 -> V_8 -> V_80 + 1 ) ;
F_268 ( V_23 ) ;
F_56 ( V_2 -> V_403 ) ;
V_469 = F_269 ( V_23 ) ;
if ( V_469 )
...
static int F_271 ( struct V_458 * V_196 )
{
struct V_1 * V_2 = F_22 ( & V_196 -> V_23 ) ;
F_256 ( & V_196 -> V_23 , NULL ) ;
F_272 ( V_2 -> V_23 ) ;
F_273 ( V_2 -> V_23 ) ;
F_270 ( V_2 -> V_23 ) ;
return 0 ;
...
static int F_278 ( struct V_22 * V_3 )
{
struct V_34 * V_23 = F_24 ( V_3 ) ;
struct V_1 * V_2 = F_23 ( V_23 ) ;
unsigned long V_333 ;
