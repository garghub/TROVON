...
if ( ! F_100 ( V_56 , V_58 , & V_79 ) )
return - V_80 ;
for ( V_40 = 0 ; V_40 < F_101 ( V_69 ) ; V_40 ++ ) {
V_4 . V_8 = V_69 [ V_40 ] ;
if ( strcmp ( V_56 , V_4 . V_8 -> V_81 ) == 0 )
break;
}
if ( V_40 == F_101 ( V_69 ) ) {
F_86 ( L_20 ,
...
V_64 = F_110 ( V_4 . V_5 * sizeof( V_64 [ 0 ] ) ,
V_48 ) ;
if ( V_64 == NULL ) {
F_111 ( L_31 ) ;
V_68 = - V_86 ;
...
if ( V_4 . V_8 -> V_33 ) {
V_65 = F_110 ( V_4 . V_9 * sizeof( V_65 [ 0 ] ) ,
V_48 ) ;
if ( V_65 == NULL ) {
F_111 ( L_32 ) ;
V_68 = - V_86 ;
...
for ( V_40 = 0 , V_67 = 0 ; V_40 < V_4 . V_5 ||
V_67 < V_4 . V_9 ; V_40 ++ , V_67 ++ ) {
if ( V_40 >= V_4 . V_5 )
goto V_88;
V_68 = F_112 ( F_71 , & V_4 . V_49 [ V_40 ] ,
V_64 [ V_40 ] ) ;
if ( V_68 )
goto V_83;
V_88:
if ( V_4 . V_8 -> V_33 == NULL || ( V_67 >= V_4 . V_9 ) )
continue;
V_68 = F_112 ( F_80 , & V_4 . V_50 [ V_67 ] ,
V_65 [ V_67 ] ) ;
if ( V_68 )
goto V_83;
}
if ( V_51 > 0 ) {
V_68 = F_112 ( F_88 , NULL ,
V_66 ) ;
if ( V_68 )
goto V_83;
}
