...
V_16 = - V_156 ;
F_88 () ;
V_26 = F_89 ( F_84 ( V_7 ) , V_136 ) ;
if ( ! V_26 ) {
F_90 () ;
goto V_25;
}
V_2 -> V_105 = F_91 ( V_26 , V_105 ) ;
V_137 = V_26 -> V_137 ;
F_90 () ;
V_2 -> V_106 = V_106 ;
...
static int F_94 ( struct V_54 * V_6 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
struct V_1 * V_2 = F_11 ( V_7 , struct V_1 , V_7 ) ;
if ( ! V_7 )
...
static unsigned int F_103 ( struct V_161 * V_161 ,
struct V_54 * V_6 , T_3 * V_67 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
unsigned int V_162 ;
struct V_1 * V_2 = F_11 ( V_7 , struct V_1 , V_7 ) ;
F_104 ( V_161 , F_47 ( V_7 ) , V_67 ) ;
V_162 = 0 ;
if ( V_7 -> V_47 )
V_162 |= V_159 ;
if ( V_7 -> V_43 == V_49 )
...
static int F_107 ( struct V_170 * V_170 , struct V_54 * V_6 , int V_171 ,
int V_172 )
{
struct V_6 * V_7 = NULL ;
struct V_1 * V_2 = NULL ;
...
return - V_189 ;
V_7 = F_109 ( V_170 , V_190 , V_191 , & V_174 , V_172 ) ;
if ( ! V_7 )
return - V_107 ;
V_2 = F_11 ( V_7 , struct V_1 , V_7 ) ;
