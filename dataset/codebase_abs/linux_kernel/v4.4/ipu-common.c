...
struct V_117 * V_118 ;
V_118 = F_95 ( V_83 -> V_171 , V_166 ++ ) ;
if ( ! V_118 ) {
V_123 = - V_172 ;
goto V_173;
}
V_118 -> V_73 . V_174 = V_73 ;
V_118 -> V_73 . V_175 = F_96 ( V_73 -> V_175 , V_88 ) ;
if ( ! V_118 -> V_73 . V_175 ) {
F_72 ( V_73 , L_13 , V_88 ,
V_73 -> V_175 -> V_176 ) ;
V_123 = - V_75 ;
...
int V_123 , V_88 ;
V_2 -> V_156 = F_101 ( V_2 -> V_73 -> V_175 , V_182 ,
& V_183 , V_2 ) ;
if ( ! V_2 -> V_156 ) {
F_72 ( V_2 -> V_73 , L_14 ) ;
return - V_75 ;
}
V_123 = F_102 ( V_2 -> V_156 , 32 , 1 , L_15 ,
V_184 , 0 , 0 , 0 ) ;
if ( V_123 < 0 ) {
F_72 ( V_2 -> V_73 , L_16 ) ;
F_103 ( V_2 -> V_156 ) ;
...
for ( V_88 = 0 ; V_88 < V_182 ; V_88 += 32 )
F_3 ( V_2 , 0 , F_74 ( V_88 / 32 ) ) ;
for ( V_88 = 0 ; V_88 < V_182 ; V_88 += 32 ) {
V_179 = F_104 ( V_2 -> V_156 , V_88 ) ;
V_179 -> V_185 = V_2 -> V_4 ;
V_179 -> V_165 = V_165 [ V_88 / 32 ] ;
V_181 = V_179 -> V_186 ;
V_181 -> V_160 . V_187 = V_188 ;
V_181 -> V_160 . V_189 = V_190 ;
V_181 -> V_160 . V_191 = V_192 ;
V_181 -> V_152 . V_193 = F_49 ( V_88 / 32 ) ;
V_181 -> V_152 . V_92 = F_74 ( V_88 / 32 ) ;
}
F_105 ( V_2 -> V_194 , F_78 , V_2 ) ;
F_105 ( V_2 -> V_195 , F_83 ,
V_2 ) ;
return 0 ;
}
...
{
int V_88 , V_106 ;
F_105 ( V_2 -> V_195 , NULL , NULL ) ;
F_105 ( V_2 -> V_194 , NULL , NULL ) ;
for ( V_88 = 0 ; V_88 < V_182 ; V_88 ++ ) {
...
F_14 ( V_2 -> V_73 , L_31 , V_88 ,
F_1 ( V_2 , F_74 ( V_88 ) ) ) ;
}
static int F_111 ( struct V_117 * V_118 )
{
const struct V_201 * V_202 =
F_112 ( V_203 , & V_118 -> V_73 ) ;
struct V_1 * V_2 ;
struct V_204 * V_205 ;
unsigned long V_119 ;
int V_88 , V_123 , V_194 , V_195 ;
const struct V_125 * V_126 ;
V_126 = V_202 -> V_206 ;
V_194 = F_113 ( V_118 , 0 ) ;
V_195 = F_113 ( V_118 , 1 ) ;
V_205 = F_114 ( V_118 , V_207 , 0 ) ;
F_14 ( & V_118 -> V_73 , L_32 ,
V_194 , V_195 ) ;
if ( ! V_205 || V_194 < 0 || V_195 < 0 )
return - V_75 ;
V_119 = V_205 -> V_208 ;
V_2 = F_115 ( & V_118 -> V_73 , sizeof( * V_2 ) , V_209 ) ;
if ( ! V_2 )
return - V_75 ;
for ( V_88 = 0 ; V_88 < 64 ; V_88 ++ )
V_2 -> V_72 [ V_88 ] . V_2 = V_2 ;
V_2 -> V_126 = V_126 ;
V_2 -> V_210 = V_126 -> type ;
F_116 ( & V_2 -> V_84 ) ;
F_117 ( & V_2 -> V_76 ) ;
F_14 ( & V_118 -> V_73 , L_33 ,
V_119 + V_126 -> V_142 ) ;
F_14 ( & V_118 -> V_73 , L_34 ,
V_119 + V_126 -> V_142 + V_211 ) ;
...
V_119 + V_126 -> V_213 ) ;
V_2 -> V_4 = F_118 ( & V_118 -> V_73 ,
V_119 + V_126 -> V_142 , V_214 ) ;
V_2 -> V_215 = F_118 ( & V_118 -> V_73 ,
V_119 + V_126 -> V_142 + V_211 ,
V_214 ) ;
if ( ! V_2 -> V_4 || ! V_2 -> V_215 )
return - V_172 ;
V_2 -> V_120 = F_119 ( & V_118 -> V_73 , L_47 ) ;
if ( F_120 ( V_2 -> V_120 ) ) {
V_123 = F_121 ( V_2 -> V_120 ) ;
F_72 ( & V_118 -> V_73 , L_48 , V_123 ) ;
return V_123 ;
}
F_122 ( V_118 , V_2 ) ;
V_123 = F_123 ( V_2 -> V_120 ) ;
if ( V_123 ) {
F_72 ( & V_118 -> V_73 , L_49 , V_123 ) ;
return V_123 ;
}
V_2 -> V_73 = & V_118 -> V_73 ;
V_2 -> V_194 = V_194 ;
...
if ( V_123 ) {
F_72 ( & V_118 -> V_73 , L_51 ,
V_123 ) ;
goto V_220;
}
F_125 ( & V_118 -> V_73 , L_52 , V_126 -> V_171 ) ;
return 0 ;
V_220:
F_87 ( V_2 ) ;
V_219:
