...
static T_2 F_25 ( int V_38 , void * V_39 )
{
struct V_1 * V_2 = V_39 ;
F_23 ( V_2 ) ;
return V_40 ;
}
static int F_26 ( struct V_41 * V_42 , struct V_9 * V_43 , int V_44 )
{
...
F_21 ( V_2 , V_16 , V_34 ) ;
if ( F_28 ( V_2 -> V_18 , ( V_2 -> V_13 == V_15 ) ||
( V_2 -> V_13 == V_14 ) , V_45 ) )
return ( V_2 -> V_13 == V_14 ) ? V_44 : - V_46 ;
else
return - V_47 ;
}
static int F_29 ( struct V_48 * V_49 , struct V_1 * V_2 )
{
int V_50 ;
int V_51 ;
...
static T_3 F_32 ( struct V_41 * V_42 )
{
return V_61 | V_62 ;
}
static T_1 F_33 ( struct V_1 * V_2 , int V_3 )
{
T_3 V_63 ;
int V_64 = V_3 ;
if ( V_3 != V_59 )
...
static void F_34 ( struct V_1 * V_2 , int V_3 , T_1 V_4 )
{
T_3 V_65 , V_66 ;
int V_64 = V_3 ;
if ( V_3 != V_59 )
...
T_3 V_75 ;
bool V_76 ;
if ( F_36 ( V_70 , L_2 , & V_2 -> V_6 ) ) {
if ( ! F_36 ( V_70 , L_3 , & V_74 ) ) {
if ( ! F_37 ( V_74 ) ) {
F_31 ( & V_68 -> V_49 , L_4 ,
V_74 ) ;
return - V_58 ;
...
& V_75 ) ;
V_2 -> V_57 = 100 ;
V_2 -> V_77 = F_40 ( & V_68 -> V_49 , NULL ) ;
if ( ! F_41 ( V_2 -> V_77 ) ) {
int V_78 = F_42 ( V_2 -> V_77 ) ;
if ( V_78 ) {
F_31 ( & V_68 -> V_49 ,
L_7 , V_78 ) ;
return V_78 ;
}
V_2 -> V_56 = F_43 ( V_2 -> V_77 ) / 1000 ;
if ( V_76 )
V_2 -> V_57 = V_75 / 1000 ;
}
if ( V_2 -> V_56 == 0 ) {
...
F_36 ( V_68 -> V_49 . V_71 , L_11 ,
& V_2 -> V_80 ) ;
V_73 = F_44 ( V_81 , V_68 -> V_49 . V_71 ) ;
...
if ( V_38 < 0 )
return V_38 ;
V_2 = F_48 ( & V_68 -> V_49 , sizeof( * V_2 ) , V_89 ) ;
if ( ! V_2 )
return - V_90 ;
V_87 = F_49 ( V_68 , V_91 , 0 ) ;
V_2 -> V_5 = F_50 ( & V_68 -> V_49 , V_87 ) ;
if ( F_41 ( V_2 -> V_5 ) )
return F_51 ( V_2 -> V_5 ) ;
V_85 = F_52 ( & V_68 -> V_49 ) ;
if ( V_85 ) {
...
V_78 = F_29 ( & V_68 -> V_49 , V_2 ) ;
if ( V_78 )
return V_78 ;
F_54 ( & V_2 -> V_18 ) ;
V_78 = F_55 ( & V_68 -> V_49 , V_38 , F_25 , 0 ,
V_68 -> V_95 , V_2 ) ;
if ( V_78 ) {
F_31 ( & V_68 -> V_49 , L_14 ) ;
return V_78 ;
...
F_59 ( & V_2 -> V_42 , V_85 -> V_99 + V_88 ) ;
}
return 0 ;
}
static int F_60 ( struct V_67 * V_68 )
{
struct V_1 * V_2 = F_61 ( V_68 ) ;
...
V_100 = F_43 ( V_2 -> V_77 ) / 1000 ;
if ( V_100 )
V_2 -> V_56 = V_100 ;
}
return F_29 ( V_49 , V_2 ) ;
}
