...
static struct V_28 * F_20 ( struct V_2 * V_3 )
{
...
static int F_23 ( struct V_20 * V_62 ,
int V_65 )
{
struct V_45 * V_46 = V_62 -> V_46 ;
T_1 V_48 , V_49 ;
V_48 = V_66 | V_67 ;
if ( V_65 )
V_49 = V_48 ;
...
for ( V_69 = 1 ; V_69 < F_26 ( V_73 ) ; V_69 ++ ) {
...
F_12 ( V_26 -> V_64 ) ;
F_12 ( V_26 -> V_63 ) ;
V_9 = F_28 ( V_26 -> V_63 , V_73 [ V_70 ] . V_75 ) ;
if ( V_9 )
return V_9 ;
V_48 = V_76 | V_77 ;
V_49 = ( V_73 [ V_70 ] . V_78 << V_79 )
| ( V_73 [ V_70 ] . V_80 << V_81 ) ;
F_18 ( V_46 , V_82 , V_48 , V_49 ) ;
V_9 = F_10 ( V_26 -> V_63 ) ;
if ( V_9 )
return V_9 ;
return F_10 ( V_26 -> V_64 ) ;
...
static int F_34 ( struct V_106 * V_107 )
{
...
return - V_12 ;
V_26 -> V_7 = V_7 ;
V_26 -> V_111 = F_38 ( V_107 , 0 ) ;
if ( V_26 -> V_111 < 0 ) {
V_9 = V_26 -> V_111 ;
F_2 ( V_3 , L_14 , V_9 ) ;
return V_9 ;
}
V_26 -> V_30 = F_39 ( V_3 , L_15 ) ;
if ( F_36 ( V_26 -> V_30 ) ) {
V_9 = F_37 ( V_26 -> V_30 ) ;
F_2 ( V_3 , L_16 , V_9 ) ;
return V_9 ;
}
V_26 -> V_64 = F_39 ( V_3 , L_17 ) ;
if ( F_36 ( V_26 -> V_64 ) ) {
V_9 = F_37 ( V_26 -> V_64 ) ;
F_2 ( V_3 , L_18 , V_9 ) ;
return V_9 ;
}
V_26 -> V_63 = F_39 ( V_3 , L_19 ) ;
if ( F_36 ( V_26 -> V_63 ) ) {
V_9 = F_37 ( V_26 -> V_63 ) ;
F_2 ( V_3 , L_20 , V_9 ) ;
return V_9 ;
}
V_109 = F_40 ( V_107 , V_112 , 0 ) ;
if ( ! V_109 ) {
F_2 ( V_3 , L_21 ) ;
return - V_113 ;
}
V_110 = F_41 ( V_3 , V_109 ) ;
if ( F_36 ( V_110 ) ) {
V_9 = F_37 ( V_110 ) ;
F_2 ( V_3 , L_22 , V_9 ) ;
return V_9 ;
}
V_26 -> V_39 = V_109 -> V_114 ;
V_26 -> V_28 = F_42 ( V_3 , V_110 ,
& V_115 ) ;
if ( F_36 ( V_26 -> V_28 ) ) {
V_9 = F_37 ( V_26 -> V_28 ) ;
F_2 ( V_3 , L_23 , V_9 ) ;
