...
struct V_1 * V_2 )
{
return F_27 ( V_71 , V_49 , V_2 , 0 , NULL , NULL , 0 ) ;
}
int
F_55 (
struct V_7 * args ,
...
int error ;
F_56 ( args , V_111 ) ;
V_114 = F_57 ( V_14 , V_111 * V_115 ) ;
V_57 = args -> V_76 -> V_35 ;
error = F_58 ( args , & V_114 , V_57 ) ;
if ( error )
return error ;
* V_112 = F_59 ( args -> V_76 , ( V_116 ) V_114 ) ;
if ( V_111 == V_117 ) {
T_15 V_118 ;
V_118 = F_60 ( V_14 , V_114 + V_57 ) ;
if ( V_118 > V_49 -> V_51 . V_53 ) {
V_49 -> V_51 . V_53 = V_118 ;
F_61 ( args -> V_78 , V_49 , V_119 ) ;
}
}
return 0 ;
}
...
T_14 V_121 ;
int V_83 ;
if ( ( V_83 = F_62 ( args -> V_49 , & V_121 , V_92 ) ) )
return V_83 ;
V_83 = F_60 ( args -> V_49 -> V_77 , V_121 ) == args -> V_76 -> V_34 ;
...
V_14 = V_49 -> V_77 ;
V_71 = args -> V_78 ;
V_125 = F_65 ( args -> V_76 , V_122 ) ;
error = F_66 ( V_71 , V_49 , V_125 , args -> V_76 -> V_35 , 0 , 0 ,
...
ASSERT ( V_126 ) ;
F_67 ( V_71 , V_124 ) ;
if ( V_122 >= F_68 ( args -> V_76 , V_39 ) )
return 0 ;
if ( V_49 -> V_51 . V_53 > F_69 ( args -> V_76 , V_122 + 1 , 0 ) )
return 0 ;
V_114 = V_125 ;
if ( ( error = F_70 ( V_71 , V_49 , & V_114 , V_92 ) ) ) {
return error ;
}
...
ASSERT ( V_114 > 0 ) ;
V_49 -> V_51 . V_53 = F_60 ( V_14 , V_114 ) ;
F_61 ( V_71 , V_49 , V_119 ) ;
return 0 ;
}
