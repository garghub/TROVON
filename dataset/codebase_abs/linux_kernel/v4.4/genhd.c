...
struct V_2 * F_87 ( T_3 V_49 , int * V_4 )
{
struct V_2 * V_3 = NULL ;
if ( F_41 ( V_49 ) != V_57 ) {
struct V_63 * V_65 ;
V_65 = F_88 ( V_62 , V_49 , V_4 ) ;
if ( V_65 )
V_3 = F_89 ( F_90 ( V_65 ) ) ;
} else {
struct V_1 * V_5 ;
F_36 ( & V_52 ) ;
V_5 = F_91 ( & V_53 , F_30 ( F_43 ( V_49 ) ) ) ;
...
struct V_89 V_90 ;
struct V_66 * V_87 ;
F_95 ( & V_90 , & V_91 , NULL , & V_92 ) ;
while ( ( V_87 = F_96 ( & V_90 ) ) ) {
struct V_2 * V_3 = F_89 ( V_87 ) ;
struct V_10 V_11 ;
struct V_1 * V_5 ;
char V_93 [ V_94 ] ;
char V_95 [ V_60 ] ;
...
static void * F_100 ( struct V_27 * V_28 , void * V_104 , T_5 * V_101 )
{
struct V_66 * V_87 ;
( * V_101 ) ++ ;
V_87 = F_96 ( V_28 -> V_103 ) ;
if ( V_87 )
return F_89 ( V_87 ) ;
return NULL ;
}
static void F_101 ( struct V_27 * V_28 , void * V_104 )
{
...
static void * F_102 ( struct V_27 * V_28 , T_5 * V_101 )
{
void * V_37 ;
V_37 = F_98 ( V_28 , V_101 ) ;
if ( ! F_103 ( V_37 ) && ! * V_101 )
F_104 ( V_28 , L_17 ) ;
return V_37 ;
}
static int F_105 ( struct V_27 * V_28 , void * V_104 )
{
struct V_2 * V_105 = V_104 ;
struct V_10 V_11 ;
struct V_1 * V_5 ;
char V_58 [ V_94 ] ;
if ( ! F_61 ( V_105 ) || ( ! F_106 ( V_105 ) &&
( V_105 -> V_12 & V_106 ) ) )
return 0 ;
if ( V_105 -> V_12 & V_96 )
return 0 ;
...
while ( ( V_5 = F_10 ( & V_11 ) ) )
F_20 ( V_28 , L_18 ,
F_41 ( F_93 ( V_5 ) ) , F_43 ( F_93 ( V_5 ) ) ,
( unsigned long long ) F_12 ( V_5 ) >> 1 ,
V_73 ( V_105 , V_5 -> V_4 , V_58 ) ) ;
F_13 ( & V_11 ) ;
return 0 ;
}
static int F_107 ( struct V_107 * V_107 , struct V_108 * V_108 )
{
return F_108 ( V_108 , & V_109 ) ;
}
static struct V_63 * F_109 ( T_3 V_49 , int * V_4 , void * V_64 )
{
if ( F_110 ( L_19 , F_41 ( V_49 ) , F_43 ( V_49 ) ) > 0 )
F_110 ( L_20 , F_41 ( V_49 ) ) ;
return NULL ;
}
...
{
struct V_2 * V_3 = F_89 ( V_87 ) ;
return sprintf ( V_58 , L_23 , F_106 ( V_3 ) ) ;
}
...
{
struct V_2 * V_3 = F_89 ( V_87 ) ;
return sprintf ( V_58 , L_23 , F_119 ( V_3 ) ? 1 : 0 ) ;
}
...
static T_6 F_123 ( struct V_66 * V_87 ,
struct V_112 * V_113 ,
char * V_58 )
{
struct V_2 * V_3 = F_89 ( V_87 ) ;
return sprintf ( V_58 , L_23 , F_124 ( V_3 -> V_86 ) ) ;
}
...
int F_127 ( struct V_2 * V_3 , int V_4 )
{
struct V_6 * V_115 = V_3 -> V_8 ;
struct V_6 * V_114 ;
...
if ( V_117 < 0 )
return - V_119 ;
if ( F_106 ( V_3 ) && V_117 > F_106 ( V_3 ) )
return - V_119 ;
if ( V_117 <= V_9 )
return 0 ;
V_118 = sizeof( * V_114 ) + V_117 * sizeof( V_114 -> V_5 [ 0 ] ) ;
V_114 = F_128 ( V_118 , V_42 , V_3 -> V_120 ) ;
if ( ! V_114 )
return - V_43 ;
V_114 -> V_9 = V_117 ;
...
static void F_129 ( struct V_66 * V_87 )
{
struct V_2 * V_3 = F_89 ( V_87 ) ;
F_40 ( V_87 -> V_49 ) ;
F_130 ( V_3 ) ;
...
F_20 ( V_28 , L_25
L_26 ,
F_41 ( F_93 ( V_127 ) ) , F_43 ( F_93 ( V_127 ) ) ,
...
{
struct V_2 * V_3 ;
V_3 = F_128 ( sizeof( struct V_2 ) , V_42 , V_120 ) ;
if ( V_3 ) {
if ( ! F_147 ( & V_3 -> V_24 ) ) {
F_27 ( V_3 ) ;
return NULL ;
...
if ( V_144 && ! F_153 ( V_144 ) )
return NULL ;
V_65 = F_154 ( & F_48 ( V_3 ) -> V_65 ) ;
if ( V_65 == NULL ) {
F_155 ( V_144 ) ;
return NULL ;
}
...
static void F_157 ( struct V_2 * V_146 , int V_147 )
{
char V_148 [] = L_29 ;
char * V_149 [] = { V_148 , NULL } ;
if ( ! V_147 )
V_148 [ 8 ] = '0' ;
F_158 ( & F_48 ( V_146 ) -> V_65 , V_150 , V_149 ) ;
}
void F_159 ( struct V_68 * V_69 , int V_151 )
{
V_69 -> V_152 -> V_153 = V_151 ;
}
void F_160 ( struct V_2 * V_3 , int V_151 )
{
struct V_10 V_11 ;
struct V_1 * V_5 ;
...
if ( V_69 ) {
F_162 ( V_69 ) ;
V_154 = F_163 ( V_69 , true ) ;
F_164 ( V_69 ) ;
}
return V_154 ;
}
static unsigned long F_165 ( struct V_2 * V_3 )
{
...
V_162 = ! V_156 -> V_165 ++ ;
F_169 ( & V_156 -> V_164 , V_12 ) ;
if ( V_162 )
F_170 ( & V_3 -> V_156 -> V_166 ) ;
F_21 ( & V_156 -> V_163 ) ;
}
static void F_171 ( struct V_2 * V_3 , bool V_167 )
{
struct V_155 * V_156 = V_3 -> V_156 ;
unsigned long V_168 ;
unsigned long V_12 ;
...
goto V_169;
V_168 = F_165 ( V_3 ) ;
F_172 ( & V_156 -> V_166 . V_170 , V_168 / 4 ) ;
if ( V_167 )
F_173 ( V_171 ,
& V_156 -> V_166 , 0 ) ;
else if ( V_168 )
...
void F_175 ( struct V_2 * V_3 , unsigned int V_172 )
{
struct V_155 * V_156 = V_3 -> V_156 ;
if ( ! V_156 )
return;
...
unsigned int F_179 ( struct V_2 * V_3 , unsigned int V_172 )
{
...
F_178 ( & V_156 -> V_164 ) ;
F_180 ( V_156 , & V_173 ) ;
F_171 ( V_3 , V_156 -> V_173 ? true : false ) ;
F_176 ( & V_156 -> V_164 ) ;
...
static void F_181 ( struct V_179 * V_180 )
{
struct V_181 * V_166 = F_182 ( V_180 ) ;
struct V_155 * V_156 = F_183 ( V_166 , struct V_155 , V_166 ) ;
F_180 ( V_156 , & V_156 -> V_173 ) ;
}
static void F_180 ( struct V_155 * V_156 ,
unsigned int * V_182 )
{
...
if ( V_184 )
F_158 ( & F_48 ( V_3 ) -> V_65 , V_150 , V_149 ) ;
}
static T_6 F_184 ( unsigned int V_159 , char * V_58 )
{
...
{
struct V_2 * V_3 = F_89 ( V_87 ) ;
return F_184 ( V_3 -> V_159 , V_58 ) ;
}
static T_6 F_186 ( struct V_66 * V_87 ,
struct V_112 * V_113 , char * V_58 )
{
struct V_2 * V_3 = F_89 ( V_87 ) ;
return F_184 ( V_3 -> V_160 , V_58 ) ;
}
...
static T_6 F_188 ( struct V_66 * V_87 ,
struct V_112 * V_113 ,
...
static int F_189 ( const char * V_189 ,
const struct V_190 * V_191 )
{
struct V_155 * V_156 ;
int V_39 ;
V_39 = F_190 ( V_189 , V_191 ) ;
if ( V_39 < 0 )
return V_39 ;
F_19 ( & V_192 ) ;
F_191 (ev, &disk_events, node)
F_175 ( V_156 -> V_3 , 0 ) ;
F_21 ( & V_192 ) ;
return 0 ;
}
...
if ( ! V_3 -> V_156 )
return;
if ( F_198 ( & F_48 ( V_3 ) -> V_65 , V_194 ) < 0 )
F_193 ( L_35 ,
V_3 -> V_73 ) ;
F_19 ( & V_192 ) ;
F_199 ( & V_3 -> V_156 -> V_193 , & V_155 ) ;
F_21 ( & V_192 ) ;
F_171 ( V_3 , true ) ;
}
...
F_167 ( V_3 ) ;
F_19 ( & V_192 ) ;
F_200 ( & V_3 -> V_156 -> V_193 ) ;
F_21 ( & V_192 ) ;
F_201 ( & F_48 ( V_3 ) -> V_65 , V_194 ) ;
}
