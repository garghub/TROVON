...
void F_22 ( struct V_12 * V_13 , void * V_7 )
{
F_23 ( F_24 ( V_13 , F_14 ,
F_15 , V_7 ) ) ;
}
static void F_25 ( struct V_12 * V_13 , void * V_14 )
{
struct V_19 * V_19 = V_14 ;
F_26 ( V_19 -> V_14 . V_20 , F_27 ( & V_19 -> V_14 ) ) ;
}
void * F_28 ( struct V_12 * V_13 , struct V_21 * V_14 )
{
int V_6 = F_8 ( V_14 -> V_20 , F_27 ( V_14 ) ,
L_1 ) ;
struct V_19 * V_19 ;
int error , V_22 ;
if ( V_6 == V_8 ) {
...
if ( V_6 == V_10 )
return F_6 ( V_14 -> V_20 ) ;
V_19 = F_17 ( F_25 ,
sizeof( * V_19 ) , V_17 , F_18 ( V_13 ) ) ;
if ( ! V_19 )
return F_19 ( - V_18 ) ;
memcpy ( & V_19 -> V_14 , V_14 , sizeof( * V_14 ) ) ;
V_22 = F_18 ( V_13 ) ;
if ( V_22 < 0 )
V_22 = F_29 () ;
error = F_30 ( V_22 , V_14 -> V_20 , F_27 ( V_14 ) , true ) ;
if ( error ) {
F_21 ( V_19 ) ;
return F_19 ( error ) ;
}
