...
static int F_28 ( T_4 V_24 , unsigned long V_7 , unsigned long V_8 ,
...
static T_2 int F_36 ( T_4 V_24 , unsigned long V_7 ,
unsigned long V_8 , int V_9 , struct V_10 * * V_11 , int * V_12 )
{
unsigned long V_13 ;
struct V_10 * V_20 , * V_10 ;
...
static int F_40 ( T_5 V_28 , unsigned long V_7 , unsigned long V_8 ,
int V_9 , struct V_10 * * V_11 , int * V_12 )
{
unsigned long V_25 ;
T_4 * V_29 ;
...
return 0 ;
if ( F_5 ( F_44 ( V_24 ) ) ) {
if ( ! F_36 ( V_24 , V_7 , V_25 , V_9 , V_11 , V_12 ) )
return 0 ;
} else {
if ( ! F_28 ( V_24 , V_7 , V_25 , V_9 , V_11 , V_12 ) )
return 0 ;
}
} while ( V_29 ++ , V_7 = V_25 , V_7 != V_8 );
return 1 ;
}
int F_45 ( unsigned long V_30 , int V_31 , int V_9 ,
struct V_10 * * V_11 )
{
...
if ( F_50 ( V_28 ) )
break;
if ( ! F_40 ( V_28 , V_7 , V_25 , V_9 , V_11 , & V_12 ) )
break;
} while ( V_37 ++ , V_7 = V_25 , V_7 != V_8 );
F_51 ( V_36 ) ;
return V_12 ;
}
int F_52 ( unsigned long V_30 , int V_31 , int V_9 ,
struct V_10 * * V_11 )
{
struct V_32 * V_33 = V_34 -> V_33 ;
unsigned long V_7 , V_35 , V_8 ;
