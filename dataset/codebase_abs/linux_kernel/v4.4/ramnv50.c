...
{
struct V_104 * V_105 ;
while ( ! F_35 ( & V_103 -> V_106 ) ) {
V_105 = F_36 ( & V_103 -> V_106 , F_37 ( * V_105 ) , V_107 ) ;
F_38 ( & V_105 -> V_107 ) ;
F_39 ( & V_2 -> V_108 , & V_105 ) ;
}
F_39 ( & V_2 -> V_109 , & V_103 -> V_42 ) ;
}
void
F_40 ( struct V_53 * V_2 , struct V_102 * * V_110 )
{
struct V_102 * V_103 = * V_110 ;
* V_110 = NULL ;
if ( F_41 ( V_103 == NULL ) )
return;
F_42 ( & V_2 -> V_11 -> V_10 . V_111 ) ;
F_34 ( V_2 , V_103 ) ;
F_43 ( & V_2 -> V_11 -> V_10 . V_111 ) ;
F_44 ( V_103 ) ;
}
int
F_45 ( struct V_53 * V_2 , T_3 V_66 , T_1 V_112 , T_1 V_113 ,
T_1 V_114 , struct V_102 * * V_110 )
{
struct V_115 * V_116 = & V_2 -> V_108 ;
struct V_115 * V_109 = & V_2 -> V_109 ;
struct V_104 * V_117 ;
struct V_102 * V_103 ;
int V_118 = ( V_114 & 0x300 ) >> 8 ;
int type = ( V_114 & 0x07f ) ;
int V_119 = ( V_114 & 0x800 ) ;
int V_120 , V_121 , V_51 ;
V_121 = ( V_66 >> V_122 ) ;
V_120 = V_113 ? ( V_113 >> V_122 ) : V_121 ;
V_112 >>= V_122 ;
V_103 = F_46 ( sizeof( * V_103 ) , V_123 ) ;
if ( ! V_103 )
return - V_124 ;
F_42 ( & V_2 -> V_11 -> V_10 . V_111 ) ;
if ( V_118 ) {
if ( V_112 == ( 1 << ( 16 - V_122 ) ) ) {
int V_125 = ( V_121 >> 4 ) * V_118 ;
V_51 = F_47 ( V_109 , 0 , 1 , V_125 , V_125 , 1 , & V_103 -> V_42 ) ;
if ( V_51 )
V_103 -> V_42 = NULL ;
}
if ( F_41 ( ! V_103 -> V_42 ) )
...
F_48 ( & V_103 -> V_106 ) ;
V_103 -> V_114 = ( V_118 << 7 ) | type ;
V_103 -> V_66 = V_121 ;
type = V_126 [ type ] ;
do {
if ( V_119 )
V_51 = F_49 ( V_116 , 0 , type , V_121 , V_120 , V_112 , & V_117 ) ;
else
V_51 = F_47 ( V_116 , 0 , type , V_121 , V_120 , V_112 , & V_117 ) ;
if ( V_51 ) {
F_43 ( & V_2 -> V_11 -> V_10 . V_111 ) ;
V_2 -> V_47 -> V_127 ( V_2 , & V_103 ) ;
return V_51 ;
}
F_50 ( & V_117 -> V_107 , & V_103 -> V_106 ) ;
V_121 -= V_117 -> V_128 ;
} while ( V_121 );
F_43 ( & V_2 -> V_11 -> V_10 . V_111 ) ;
V_117 = F_36 ( & V_103 -> V_106 , struct V_104 , V_107 ) ;
V_103 -> V_129 = ( T_3 ) V_117 -> V_129 << V_122 ;
* V_110 = V_103 ;
return 0 ;
}
static T_1
F_51 ( struct V_53 * V_2 )
{
struct V_9 * V_10 = & V_2 -> V_11 -> V_10 ;
struct V_12 * V_13 = V_10 -> V_13 ;
int V_130 , V_131 , V_132 , V_133 ;
T_3 V_134 , V_135 ;
T_1 V_136 , V_137 , V_138 , V_139 ;
V_136 = F_2 ( V_13 , 0x100200 ) ;
V_137 = F_2 ( V_13 , 0x100204 ) ;
V_138 = F_2 ( V_13 , 0x100250 ) ;
F_5 ( V_10 , L_11 ,
V_136 , V_137 , V_138 , F_2 ( V_13 , 0x001540 ) ) ;
V_130 = ( V_137 & 0x0000f000 ) >> 12 ;
V_131 = ( ( V_137 & 0x000f0000 ) >> 16 ) + 8 ;
V_132 = ( ( V_137 & 0x00f00000 ) >> 20 ) + 8 ;
V_133 = 1 << ( ( ( V_137 & 0x03000000 ) >> 24 ) + 2 ) ;
V_134 = V_2 -> V_140 * V_133 * ( 1 << V_130 ) * 8 ;
V_135 = V_134 << V_131 ;
if ( V_136 & 0x00000004 )
V_135 += V_134 << V_132 ;
if ( V_135 != V_2 -> V_66 ) {
...
int
F_53 ( const struct V_141 * V_47 ,
struct V_142 * V_11 , struct V_53 * V_2 )
{
struct V_12 * V_13 = V_11 -> V_10 . V_13 ;
struct V_55 * V_8 = V_13 -> V_8 ;
const T_1 V_143 = ( 256 * 1024 ) ;
const T_1 V_144 = ( 1024 * 1024 ) ;
T_3 V_66 = F_2 ( V_13 , 0x10020c ) ;
T_1 V_109 = F_2 ( V_13 , 0x100320 ) ;
enum V_145 type = V_146 ;
int V_51 ;
switch ( F_2 ( V_13 , 0x100714 ) & 0x00000007 ) {
case 0 : type = V_147 ; break;
case 1 :
if ( F_54 ( V_8 ) == V_148 )
type = V_148 ;
else
...
case 3 : type = V_149 ; break;
case 4 : type = V_150 ; break;
default:
break;
}
V_66 = ( V_66 & 0x000000ff ) << 32 | ( V_66 & 0xffffff00 ) ;
V_51 = F_55 ( V_47 , V_11 , type , V_66 , V_109 , V_2 ) ;
if ( V_51 )
return V_51 ;
V_2 -> V_151 = ( F_2 ( V_13 , 0x001540 ) & 0x00ff0000 ) >> 16 ;
V_2 -> V_140 = F_56 ( V_2 -> V_151 ) ;
V_2 -> V_152 = ( F_2 ( V_13 , 0x100200 ) & 0x4 ) ? 2 : 1 ;
F_57 ( & V_2 -> V_108 ) ;
return F_58 ( & V_2 -> V_108 , V_143 >> V_122 ,
( V_66 - V_143 - V_144 ) >> V_122 ,
F_51 ( V_2 ) >> V_122 ) ;
}
int
F_59 ( struct V_142 * V_11 , struct V_53 * * V_153 )
{
struct V_1 * V_2 ;
int V_51 , V_36 ;
if ( ! ( V_2 = F_46 ( sizeof( * V_2 ) , V_123 ) ) )
return - V_124 ;
* V_153 = & V_2 -> V_6 ;
V_51 = F_53 ( & V_154 , V_11 , & V_2 -> V_6 ) ;
if ( V_51 )
return V_51 ;
V_2 -> V_40 . V_155 = F_60 ( 0x002504 ) ;
V_2 -> V_40 . V_156 = F_60 ( 0x00c040 ) ;
V_2 -> V_40 . V_157 = F_60 ( 0x004008 ) ;
V_2 -> V_40 . V_158 = F_60 ( 0x00400c ) ;
V_2 -> V_40 . V_159 = F_60 ( 0x100200 ) ;
V_2 -> V_40 . V_160 = F_60 ( 0x100210 ) ;
V_2 -> V_40 . V_161 = F_60 ( 0x10021c ) ;
V_2 -> V_40 . V_162 = F_60 ( 0x1002d0 ) ;
V_2 -> V_40 . V_163 = F_60 ( 0x1002d4 ) ;
V_2 -> V_40 . V_164 = F_60 ( 0x1002dc ) ;
V_2 -> V_40 . V_165 = F_60 ( 0x10053c ) ;
V_2 -> V_40 . V_166 = F_60 ( 0x1005a0 ) ;
V_2 -> V_40 . V_167 = F_60 ( 0x1005a4 ) ;
V_2 -> V_40 . V_168 = F_60 ( 0x100710 ) ;
V_2 -> V_40 . V_169 = F_60 ( 0x100714 ) ;
V_2 -> V_40 . V_170 = F_60 ( 0x100718 ) ;
V_2 -> V_40 . V_171 = F_60 ( 0x10071c ) ;
V_2 -> V_40 . V_172 = F_61 ( 0x100da0 , 4 , V_2 -> V_6 . V_151 ) ;
V_2 -> V_40 . V_173 = F_60 ( 0x100e20 ) ;
V_2 -> V_40 . V_174 = F_60 ( 0x100e24 ) ;
V_2 -> V_40 . V_175 = F_60 ( 0x611200 ) ;
for ( V_36 = 0 ; V_36 < 9 ; V_36 ++ )
V_2 -> V_40 . V_176 [ V_36 ] = F_60 ( 0x100220 + ( V_36 * 0x04 ) ) ;
if ( V_2 -> V_6 . V_152 > 1 ) {
V_2 -> V_40 . V_177 [ 0 ] = F_62 ( 0x1002c0 , 0x1002c8 ) ;
V_2 -> V_40 . V_177 [ 1 ] = F_62 ( 0x1002c4 , 0x1002cc ) ;
V_2 -> V_40 . V_177 [ 2 ] = F_62 ( 0x1002e0 , 0x1002e8 ) ;
V_2 -> V_40 . V_177 [ 3 ] = F_62 ( 0x1002e4 , 0x1002ec ) ;
} else {
V_2 -> V_40 . V_177 [ 0 ] = F_60 ( 0x1002c0 ) ;
V_2 -> V_40 . V_177 [ 1 ] = F_60 ( 0x1002c4 ) ;
V_2 -> V_40 . V_177 [ 2 ] = F_60 ( 0x1002e0 ) ;
V_2 -> V_40 . V_177 [ 3 ] = F_60 ( 0x1002e4 ) ;
}
V_2 -> V_40 . V_178 [ 0 ] = F_60 ( 0x00e104 ) ;
V_2 -> V_40 . V_178 [ 1 ] = F_60 ( 0x00e108 ) ;
V_2 -> V_40 . V_178 [ 2 ] = F_60 ( 0x00e120 ) ;
V_2 -> V_40 . V_178 [ 3 ] = F_60 ( 0x00e124 ) ;
return 0 ;
}
