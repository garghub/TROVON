...
void F_37 ( struct V_4 * V_4 , struct V_4 * V_61 )
{
F_38 ( V_4 -> V_62 || V_4 -> V_65 ) ;
V_4 -> V_62 = V_61 ;
V_4 -> V_65 = F_30 ;
F_33 ( V_61 ) ;
}
...
{
struct V_23 * V_24 = F_40 ( V_67 , struct V_23 , V_68 ) ;
struct V_4 * V_4 ;
while ( 1 ) {
F_41 ( & V_24 -> V_69 ) ;
V_4 = F_42 ( & V_24 -> V_70 ) ;
...
F_46 ( & V_72 ) ;
F_46 ( & V_73 ) ;
while ( ( V_4 = F_42 ( V_74 -> V_71 ) ) )
F_47 ( V_4 -> V_48 == V_24 ? & V_72 : & V_73 , V_4 ) ;
* V_74 -> V_71 = V_73 ;
F_41 ( & V_24 -> V_69 ) ;
F_48 ( & V_24 -> V_70 , & V_72 ) ;
F_43 ( & V_24 -> V_69 ) ;
F_49 ( V_24 -> V_75 , & V_24 -> V_68 ) ;
}
struct V_4 * F_50 ( T_2 V_37 , int V_76 , struct V_23 * V_24 )
{
T_2 V_77 = V_37 ;
unsigned V_53 ;
unsigned V_78 ;
...
if ( V_76 > V_80 )
return NULL ;
V_49 = F_51 ( sizeof( struct V_4 ) +
V_76 * sizeof( struct V_31 ) ,
V_37 ) ;
V_53 = 0 ;
V_78 = V_76 ;
} else {
if ( F_52 ( ! V_24 -> V_51 && V_76 > 0 ) )
return NULL ;
if ( V_74 -> V_71 && ! F_53 ( V_74 -> V_71 ) )
V_37 &= ~ V_43 ;
...
void F_54 ( struct V_4 * V_4 )
{
unsigned long V_57 ;
struct V_31 V_32 ;
struct V_86 V_87 ;
F_55 (bv, bio, iter) {
char * V_88 = F_56 ( & V_32 , & V_57 ) ;
...
inline int F_61 ( struct V_92 * V_93 , struct V_4 * V_4 )
{
if ( F_18 ( ! F_24 ( V_4 , V_94 ) ) )
F_62 ( V_93 , V_4 ) ;
return V_4 -> V_95 ;
}
void F_63 ( struct V_4 * V_4 , struct V_4 * V_96 )
{
F_38 ( V_4 -> V_48 && F_25 ( V_4 ) != V_79 ) ;
V_4 -> V_97 = V_96 -> V_97 ;
F_34 ( V_4 , V_98 ) ;
V_4 -> V_99 = V_96 -> V_99 ;
...
{
struct V_4 * V_101 ;
V_101 = F_50 ( V_37 , 0 , V_24 ) ;
if ( ! V_101 )
return NULL ;
F_63 ( V_101 , V_4 ) ;
if ( F_21 ( V_4 ) ) {
int V_102 ;
V_102 = F_65 ( V_101 , V_4 , V_37 ) ;
if ( V_102 < 0 ) {
F_32 ( V_101 ) ;
return NULL ;
}
...
struct V_4 * F_66 ( struct V_4 * V_96 , T_2 V_37 ,
struct V_23 * V_24 )
{
struct V_86 V_87 ;
struct V_31 V_32 ;
struct V_4 * V_4 ;
V_4 = F_50 ( V_37 , F_67 ( V_96 ) , V_24 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_97 = V_96 -> V_97 ;
V_4 -> V_99 = V_96 -> V_99 ;
...
F_55 (bv, bio_src, iter)
V_4 -> V_52 [ V_4 -> V_108 ++ ] = V_32 ;
V_106:
if ( F_21 ( V_96 ) ) {
int V_102 ;
V_102 = F_65 ( V_4 , V_96 , V_37 ) ;
if ( V_102 < 0 ) {
F_32 ( V_4 ) ;
return NULL ;
}
...
int F_68 ( struct V_92 * V_93 , struct V_4 * V_4 , struct V_109
...
return 0 ;
if ( ( ( V_4 -> V_100 . V_104 + V_110 ) >> 9 ) > F_69 ( V_93 ) )
return 0 ;
if ( V_4 -> V_108 > 0 ) {
...
V_4 -> V_95 ++ ;
V_4 -> V_100 . V_104 += V_110 ;
while ( V_4 -> V_95 > F_71 ( V_93 ) ) {
if ( V_112 )
goto V_117;
V_112 = 1 ;
F_62 ( V_93 , V_4 ) ;
}
if ( V_4 -> V_108 > 1 && ( F_72 ( V_113 - 1 , V_113 ) ) )
F_73 ( V_4 , V_94 ) ;
V_116:
return V_110 ;
V_117:
...
int F_74 ( struct V_4 * V_4 , struct V_109 * V_109 ,
unsigned int V_110 , unsigned int V_111 )
{
struct V_31 * V_32 ;
if ( F_52 ( F_24 ( V_4 , V_98 ) ) )
return 0 ;
if ( V_4 -> V_108 > 0 ) {
...
static void F_75 ( struct V_4 * V_4 )
{
struct V_118 * V_102 = V_4 -> V_62 ;
V_102 -> error = V_4 -> V_63 ;
F_76 ( & V_102 -> V_119 ) ;
}
int F_77 ( int V_120 , struct V_4 * V_4 )
{
struct V_118 V_102 ;
V_120 |= V_121 ;
F_78 ( & V_102 . V_119 ) ;
...
void F_81 ( struct V_4 * V_4 , unsigned V_122 )
{
if ( F_21 ( V_4 ) )
F_82 ( V_4 , V_122 ) ;
F_83 ( V_4 , & V_4 -> V_100 , V_122 ) ;
}
...
void F_88 ( struct V_4 * V_124 , struct V_4 * V_125 )
{
...
V_128 = F_89 ( V_125 , V_126 ) ;
V_129 = F_89 ( V_124 , V_127 ) ;
V_122 = F_90 ( V_128 . V_89 , V_129 . V_89 ) ;
V_130 = F_91 ( V_128 . V_90 ) ;
V_131 = F_91 ( V_129 . V_90 ) ;
memcpy ( V_131 + V_129 . V_115 ,
V_130 + V_128 . V_115 ,
V_122 ) ;
F_92 ( V_131 ) ;
F_92 ( V_130 ) ;
F_83 ( V_125 , & V_126 , V_122 ) ;
F_83 ( V_124 , & V_127 , V_122 ) ;
}
}
static struct V_133 * F_93 ( unsigned int V_134 ,
T_2 V_37 )
{
if ( V_134 > V_80 )
return NULL ;
return F_51 ( sizeof( struct V_133 ) +
sizeof( struct V_135 ) * V_134 , V_37 ) ;
}
static int F_94 ( struct V_4 * V_4 , struct V_136 V_87 )
{
int V_10 ;
struct V_31 * V_113 ;
F_85 (bvec, bio, i) {
T_3 V_102 ;
V_102 = F_95 ( V_113 -> V_90 ,
V_113 -> V_115 ,
V_113 -> V_89 ,
& V_87 ) ;
if ( ! F_96 ( & V_87 ) )
...
static int F_97 ( struct V_4 * V_4 , struct V_136 V_87 )
{
int V_10 ;
struct V_31 * V_113 ;
F_85 (bvec, bio, i) {
T_3 V_102 ;
V_102 = F_98 ( V_113 -> V_90 ,
V_113 -> V_115 ,
V_113 -> V_89 ,
& V_87 ) ;
if ( ! F_96 ( & V_87 ) )
...
int V_102 = 0 ;
if ( ! F_24 ( V_4 , V_139 ) ) {
if ( V_74 -> V_140 && F_101 ( V_4 ) == V_141 )
V_102 = F_97 ( V_4 , V_138 -> V_87 ) ;
if ( V_138 -> V_142 )
F_99 ( V_4 ) ;
}
F_26 ( V_138 ) ;
...
struct V_4 * F_102 ( struct V_92 * V_93 ,
struct V_143 * V_144 ,
...
int V_10 , V_102 ;
int V_145 = 0 ;
unsigned int V_110 = V_87 -> V_146 ;
unsigned int V_111 = V_144 ? V_144 -> V_111 & ~ V_147 : 0 ;
...
if ( V_111 )
V_145 ++ ;
V_138 = F_93 ( V_87 -> V_148 , V_37 ) ;
if ( ! V_138 )
return F_103 ( - V_123 ) ;
V_138 -> V_142 = V_144 ? 0 : 1 ;
memcpy ( V_138 -> V_152 , V_87 -> V_152 , sizeof( struct V_135 ) * V_87 -> V_148 ) ;
F_104 ( & V_138 -> V_87 , V_87 -> type , V_138 -> V_152 ,
V_87 -> V_148 , V_87 -> V_146 ) ;
V_102 = - V_123 ;
...
V_122 = V_110 ;
if ( V_144 ) {
if ( V_10 == V_144 -> V_162 * V_145 ) {
V_102 = - V_123 ;
break;
}
V_109 = V_144 -> V_163 [ V_10 / V_145 ] ;
V_109 += ( V_10 % V_145 ) ;
V_10 ++ ;
} else {
V_109 = F_86 ( V_93 -> V_164 | V_37 ) ;
if ( ! V_109 ) {
V_102 = - V_123 ;
break;
}
}
if ( F_68 ( V_93 , V_4 , V_109 , V_122 , V_111 ) < V_122 )
break;
V_110 -= V_122 ;
V_111 = 0 ;
}
if ( V_102 )
goto V_165;
if ( ( ( V_87 -> type & V_159 ) && ( ! V_144 || ! V_144 -> V_166 ) ) ||
( V_144 && V_144 -> V_167 ) ) {
V_102 = F_94 ( V_4 , * V_87 ) ;
if ( V_102 )
goto V_165;
...
return F_103 ( - V_123 ) ;
V_102 = - V_123 ;
V_163 = F_109 ( V_145 , sizeof( struct V_109 * ) , V_37 ) ;
if ( ! V_163 )
goto V_26;
F_107 (iov, i, *iter) {
unsigned long V_149 = ( unsigned long ) V_152 . V_153 ;
...
if ( V_122 > V_110 )
V_122 = V_110 ;
if ( F_68 ( V_93 , V_4 , V_163 [ V_168 ] , V_122 , V_111 ) <
V_122 )
break;
V_110 -= V_122 ;
V_111 = 0 ;
...
if ( V_122 > V_110 )
V_122 = V_110 ;
if ( F_68 ( V_93 , V_4 , F_119 ( V_88 ) , V_122 ,
V_111 ) < V_122 ) {
F_32 ( V_4 ) ;
return F_103 ( - V_157 ) ;
}
...
int V_10 ;
F_85 (bvec, bio, i) {
memcpy ( V_49 , F_122 ( V_113 -> V_90 ) , V_113 -> V_89 ) ;
V_49 += V_113 -> V_89 ;
}
F_120 ( V_4 ) ;
}
struct V_4 * F_123 ( struct V_92 * V_93 , void * V_88 , unsigned int V_110 ,
T_2 V_37 , int V_175 )
{
unsigned long V_174 = ( unsigned long ) V_88 ;
unsigned long V_150 = ( V_174 + V_110 + V_155 - 1 ) >> V_156 ;
...
goto V_165;
if ( ! V_175 )
memcpy ( F_122 ( V_109 ) , V_49 , V_122 ) ;
if ( F_68 ( V_93 , V_4 , V_109 , V_122 , 0 ) < V_122 )
break;
V_110 -= V_122 ;
V_49 += V_122 ;
}
...
T_2 V_191 , struct V_23 * V_24 )
{
struct V_4 * V_192 = NULL ;
F_38 ( V_181 <= 0 ) ;
F_38 ( V_181 >= F_146 ( V_4 ) ) ;
if ( V_4 -> V_99 & V_105 )
V_192 = F_66 ( V_4 , V_191 , V_24 ) ;
else
V_192 = F_64 ( V_4 , V_191 , V_24 ) ;
if ( ! V_192 )
return NULL ;
V_192 -> V_100 . V_104 = V_181 << 9 ;
if ( F_21 ( V_192 ) )
F_147 ( V_192 , 0 , V_181 ) ;
F_81 ( V_4 , V_192 -> V_100 . V_104 ) ;
return V_192 ;
}
void F_148 ( struct V_4 * V_4 , int V_111 , int V_193 )
{
V_193 <<= 9 ;
if ( V_111 == 0 && V_193 == V_4 -> V_100 . V_104 )
return;
F_73 ( V_4 , V_94 ) ;
F_81 ( V_4 , V_111 << 9 ) ;
V_4 -> V_100 . V_104 = V_193 ;
}
T_1 * F_149 ( int V_194 )
{
struct V_35 * V_195 = V_28 + V_34 ;
return F_150 ( V_194 , V_195 -> V_5 ) ;
}
...
static struct V_23 * F_155 ( unsigned int V_196 ,
unsigned int V_53 ,
bool V_197 )
{
unsigned int V_198 = V_81 * sizeof( struct V_31 ) ;
struct V_23 * V_24 ;
...
F_157 ( & V_24 -> V_69 ) ;
F_46 ( & V_24 -> V_70 ) ;
F_158 ( & V_24 -> V_68 , F_39 ) ;
V_24 -> V_6 = F_1 ( V_53 + V_198 ) ;
if ( ! V_24 -> V_6 ) {
F_26 ( V_24 ) ;
return NULL ;
}
V_24 -> V_54 = F_150 ( V_196 , V_24 -> V_6 ) ;
if ( ! V_24 -> V_54 )
goto V_199;
if ( V_197 ) {
V_24 -> V_51 = F_149 ( V_196 ) ;
if ( ! V_24 -> V_51 )
goto V_199;
}
V_24 -> V_75 = F_159 ( L_3 , V_200 , 0 ) ;
if ( ! V_24 -> V_75 )
goto V_199;
return V_24 ;
V_199:
...
struct V_23 * F_160 ( unsigned int V_196 , unsigned int V_53 )
{
return F_155 ( V_196 , V_53 , true ) ;
}
struct V_23 * F_161 ( unsigned int V_196 , unsigned int V_53 )
{
return F_155 ( V_196 , V_53 , false ) ;
}
int F_162 ( struct V_4 * V_4 , struct V_201 * V_202 )
{
if ( F_18 ( V_4 -> V_203 ) )
return - V_204 ;
F_163 ( V_202 ) ;
...
V_193 = V_36 -> V_29 * sizeof( struct V_31 ) ;
V_36 -> V_5 = F_4 ( V_36 -> V_20 , V_193 , 0 ,
V_22 | V_210 , NULL ) ;
}
}
