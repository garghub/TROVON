...
return - V_127 ;
F_55 ( V_9 -> V_13 ) ;
V_117 = F_56 ( V_115 , V_128 , 0 ) ;
V_9 -> V_5 = F_57 ( & V_115 -> V_9 , V_117 ) ;
if ( F_54 ( V_9 -> V_5 ) ) {
V_118 = F_58 ( V_9 -> V_5 ) ;
goto V_129;
}
...
V_30 -> V_131 = V_132 ;
V_30 -> V_133 = V_134 ;
F_61 ( V_30 -> V_130 , L_25 , sizeof( V_30 -> V_130 ) ) ;
V_30 -> V_135 = & V_136 ;
V_30 -> V_9 . V_137 = & V_115 -> V_9 ;
V_30 -> V_42 = V_138 ;
...
V_30 -> V_139 = & V_142 ;
V_30 -> V_139 -> V_143 = V_9 -> V_11 -> V_141 ;
V_30 -> V_139 -> V_144 = V_9 -> V_11 -> V_145 ;
}
V_30 -> V_146 = V_115 -> V_147 ;
V_118 = F_62 ( V_30 ) ;
if ( V_118 ) {
F_28 ( & V_115 -> V_9 , L_26 ) ;
goto V_129;
...
static int F_67 ( struct V_148 * V_9 )
{
struct V_114 * V_115 = F_68 ( V_9 ) ;
struct V_1 * V_2 = F_65 ( V_115 ) ;
F_5 ( V_2 , 0 ) ;
F_63 ( V_2 -> V_13 ) ;
return 0 ;
}
static int F_69 ( struct V_148 * V_9 )
{
struct V_114 * V_115 = F_68 ( V_9 ) ;
struct V_1 * V_2 = F_65 ( V_115 ) ;
F_55 ( V_2 -> V_13 ) ;
