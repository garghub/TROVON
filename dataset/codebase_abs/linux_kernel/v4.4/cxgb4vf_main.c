...
static inline unsigned int F_93 ( const struct V_1 * V_1 )
{
return F_94 ( V_1 -> V_96 . V_168 ) | ( 0x3f << 10 ) ;
}
static int F_95 ( struct V_4 * V_5 , struct V_169 * V_170 , int V_171 )
{
int V_23 = 0 ;
switch ( V_171 ) {
default:
...
static int F_96 ( struct V_4 * V_5 , int V_173 )
{
int V_23 ;
struct V_9 * V_10 = F_4 ( V_5 ) ;
if ( V_173 < 81 )
return - V_174 ;
V_23 = F_12 ( V_10 -> V_1 , V_10 -> V_24 , V_173 ,
- 1 , - 1 , - 1 , - 1 , true ) ;
if ( ! V_23 )
V_5 -> V_25 = V_173 ;
return V_23 ;
}
static T_6 F_97 ( struct V_4 * V_5 ,
T_6 V_175 )
{
if ( V_175 & V_176 )
V_175 |= V_177 ;
...
{
struct V_9 * V_10 = F_4 ( V_5 ) ;
T_6 V_178 = V_5 -> V_175 ^ V_175 ;
if ( V_178 & V_176 )
F_12 ( V_10 -> V_1 , V_10 -> V_24 , - 1 , - 1 , - 1 , - 1 ,
V_175 & V_177 , 0 ) ;
return 0 ;
}
static int F_99 ( struct V_4 * V_5 , void * V_179 )
{
int V_23 ;
struct V_180 * V_139 = V_179 ;
struct V_9 * V_10 = F_4 ( V_5 ) ;
...
if ( V_23 < 0 )
return V_23 ;
memcpy ( V_5 -> V_27 , V_139 -> V_181 , V_5 -> V_183 ) ;
V_10 -> V_26 = V_23 ;
return 0 ;
}
...
static unsigned int F_102 ( enum V_184 type ,
unsigned int V_185 )
{
...
static int F_103 ( struct V_4 * V_5 , struct V_217 * V_171 )
{
...
V_67 -> V_218 == V_188 )
V_171 -> V_6 = V_219 ;
else if ( V_67 -> V_218 == V_206 ||
V_67 -> V_218 == V_207 )
V_171 -> V_6 = V_220 ;
else if ( V_67 -> V_218 == V_208 ||
V_67 -> V_218 == V_209 ||
V_67 -> V_218 == V_210 ||
V_67 -> V_218 == V_213 ) {
if ( V_67 -> V_16 == V_221 ||
...
V_171 -> V_6 = V_228 ;
if ( V_67 -> V_229 >= 0 ) {
V_171 -> V_230 = V_67 -> V_229 ;
V_171 -> V_231 = V_232 ;
V_171 -> V_233 = V_67 -> V_218 == V_186 ?
V_234 : V_235 ;
} else {
V_171 -> V_230 = 0 ;
V_171 -> V_231 = V_236 ;
...
V_171 -> V_237 = F_102 ( V_67 -> V_218 ,
V_67 -> V_11 . V_237 ) ;
V_171 -> V_238 = F_102 ( V_67 -> V_218 ,
V_67 -> V_11 . V_238 ) ;
F_104 ( V_171 ,
F_3 ( V_5 ) ? V_67 -> V_11 . V_12 : 0 ) ;
V_171 -> V_239 = V_240 ;
V_171 -> V_241 = V_67 -> V_11 . V_241 ;
V_171 -> V_242 = 0 ;
V_171 -> V_243 = 0 ;
return 0 ;
}
...
struct V_244 * V_245 )
{
struct V_1 * V_1 = F_106 ( V_5 ) ;
F_107 ( V_245 -> V_246 , V_247 , sizeof( V_245 -> V_246 ) ) ;
F_107 ( V_245 -> V_248 , V_249 , sizeof( V_245 -> V_248 ) ) ;
F_107 ( V_245 -> V_250 , F_108 ( F_109 ( V_5 -> V_5 . V_251 ) ) ,
sizeof( V_245 -> V_250 ) ) ;
snprintf ( V_245 -> V_252 , sizeof( V_245 -> V_252 ) ,
L_35 ,
F_110 ( V_1 -> V_96 . V_5 . V_253 ) ,
F_111 ( V_1 -> V_96 . V_5 . V_253 ) ,
F_112 ( V_1 -> V_96 . V_5 . V_253 ) ,
F_113 ( V_1 -> V_96 . V_5 . V_253 ) ,
F_110 ( V_1 -> V_96 . V_5 . V_254 ) ,
F_111 ( V_1 -> V_96 . V_5 . V_254 ) ,
F_112 ( V_1 -> V_96 . V_5 . V_254 ) ,
F_113 ( V_1 -> V_96 . V_5 . V_254 ) ) ;
}
static T_5 F_114 ( struct V_4 * V_5 )
{
return F_106 ( V_5 ) -> V_255 ;
}
static void F_115 ( struct V_4 * V_5 , T_5 V_256 )
{
...
V_258 -> V_263 = 0 ;
V_258 -> V_264 = V_265 ;
V_258 -> V_266 = V_7 -> V_42 [ V_10 -> V_85 ] . V_87 . V_267 - V_268 ;
V_258 -> V_269 = V_7 -> V_42 [ V_10 -> V_85 ] . V_43 . V_267 ;
V_258 -> V_270 = 0 ;
V_258 -> V_271 = V_7 -> V_86 [ V_10 -> V_85 ] . V_78 . V_267 ;
}
...
V_7 -> V_42 [ V_32 ] . V_87 . V_267 = V_258 -> V_266 + V_268 ;
V_7 -> V_42 [ V_32 ] . V_43 . V_267 = V_258 -> V_269 ;
V_7 -> V_86 [ V_32 ] . V_78 . V_267 = V_258 -> V_271 ;
}
return 0 ;
}
...
{
struct V_9 * V_10 = F_4 ( V_5 ) ;
V_282 -> V_241 = ( V_10 -> V_11 . V_283 & V_284 ) != 0 ;
...
return - V_174 ;
return F_122 ( V_10 -> V_1 , V_10 -> V_24 , V_289 ) ;
}
static int F_123 ( struct V_4 * V_5 , int V_292 )
{
switch ( V_292 ) {
case V_293 :
return F_10 ( V_294 ) ;
...
static void F_125 ( const struct V_1 * V_1 ,
...
F_125 ( V_1 , V_10 , (struct V_295 * ) V_64 ) ;
}
static int F_127 ( struct V_4 * V_5 )
{
return V_306 ;
}
static void F_128 ( struct V_1 * V_1 , void * V_307 ,
...
static int F_133 ( struct V_334 * V_335 , void * V_164 )
{
struct V_1 * V_1 = V_335 -> V_336 ;
int V_337 = F_134 ( V_1 -> V_36 . V_338 , V_339 ) ;
int V_32 , V_340 = ( V_341 ) V_164 - 1 ;
if ( V_340 )
F_135 ( V_335 , '\n' ) ;
#define F_136 ( T_7 , V_7 , V_164 ) \
do {\
...
#define F_137 ( V_7 , V_164 ) S3("s", s, v)
#define F_138 ( V_7 , V_164 ) S3("u", s, txq[qs].v)
#define F_139 ( V_7 , V_164 ) S3("u", s, rxq[qs].v)
if ( V_340 < V_337 ) {
const struct V_84 * V_37 = & V_1 -> V_36 . V_42 [ V_340 * V_339 ] ;
const struct V_73 * V_74 = & V_1 -> V_36 . V_86 [ V_340 * V_339 ] ;
int V_342 = F_140 ( V_339 , V_1 -> V_36 . V_338 - V_339 * V_340 ) ;
F_137 ( L_36 , L_37 ) ;
F_137 ( L_38 ,
...
: - 1 ) ) ;
F_138 ( L_42 , V_78 . V_79 ) ;
F_138 ( L_43 , V_78 . V_267 ) ;
F_138 ( L_44 , V_78 . V_344 ) ;
F_138 ( L_45 , V_78 . V_2 ) ;
F_138 ( L_46 , V_78 . V_345 ) ;
F_139 ( L_47 , V_43 . V_79 ) ;
F_139 ( L_48 , V_43 . V_267 ) ;
F_139 ( L_49 , V_43 . V_346 ) ;
F_136 ( L_50 , L_51 , F_84 ( V_1 , & V_37 [ V_32 ] . V_43 ) ) ;
F_136 ( L_50 , L_52 ,
V_1 -> V_36 . V_161 [ V_37 [ V_32 ] . V_43 . V_160 ] ) ;
F_139 ( L_53 , V_43 . V_345 ) ;
F_139 ( L_54 , V_43 . V_347 ) ;
F_139 ( L_55 , V_87 . V_79 ) ;
F_139 ( L_56 , V_87 . V_267 - V_268 ) ;
F_139 ( L_57 , V_87 . V_348 ) ;
F_139 ( L_58 , V_87 . V_2 ) ;
F_139 ( L_59 , V_87 . V_345 ) ;
return 0 ;
}
V_340 -= V_337 ;
if ( V_340 == 0 ) {
const struct V_45 * V_349 = & V_1 -> V_36 . V_41 ;
F_141 ( V_335 , L_60 , L_36 , L_61 ) ;
F_141 ( V_335 , L_62 , L_47 , V_349 -> V_79 ) ;
F_141 ( V_335 , L_62 , L_51 ,
F_84 ( V_1 , V_349 ) ) ;
F_141 ( V_335 , L_62 , L_52 ,
V_1 -> V_36 . V_161 [ V_349 -> V_160 ] ) ;
F_141 ( V_335 , L_62 , L_63 , V_349 -> V_345 ) ;
F_141 ( V_335 , L_62 , L_54 , V_349 -> V_347 ) ;
} else if ( V_340 == 1 ) {
const struct V_45 * V_53 = & V_1 -> V_36 . V_53 ;
F_141 ( V_335 , L_60 , L_36 , L_64 ) ;
F_141 ( V_335 , L_62 , L_47 , V_53 -> V_79 ) ;
F_141 ( V_335 , L_62 , L_51 ,
F_84 ( V_1 , V_53 ) ) ;
F_141 ( V_335 , L_62 , L_52 ,
V_1 -> V_36 . V_161 [ V_53 -> V_160 ] ) ;
F_141 ( V_335 , L_62 , L_63 , V_53 -> V_345 ) ;
F_141 ( V_335 , L_62 , L_54 , V_53 -> V_347 ) ;
}
#undef F_139
#undef F_138
#undef F_137
...
{
return F_134 ( V_1 -> V_36 . V_338 , V_339 ) + 1 +
( ( V_1 -> V_51 & V_52 ) != 0 ) ;
}
static void * F_143 ( struct V_334 * V_335 , T_8 * V_350 )
{
int V_351 = F_142 ( V_335 -> V_336 ) ;
return * V_350 < V_351 ? ( void * ) ( ( V_341 ) * V_350 + 1 ) : NULL ;
}
static void F_144 ( struct V_334 * V_335 , void * V_164 )
{
}
static void * F_145 ( struct V_334 * V_335 , void * V_164 , T_8 * V_350 )
{
int V_351 = F_142 ( V_335 -> V_336 ) ;
++ * V_350 ;
return * V_350 < V_351 ? ( void * ) ( ( V_341 ) * V_350 + 1 ) : NULL ;
}
static int F_146 ( struct V_352 * V_352 , struct V_353 * V_353 )
{
int V_354 = F_147 ( V_353 , & V_355 ) ;
if ( ! V_354 ) {
...
static int F_148 ( struct V_334 * V_335 , void * V_164 )
{
struct V_1 * V_1 = V_335 -> V_336 ;
int V_337 = F_134 ( V_1 -> V_36 . V_338 , V_339 ) ;
int V_32 , V_340 = ( V_341 ) V_164 - 1 ;
...
#define F_137 ( V_7 , V_164 ) S3("s", s, v)
#define F_149 ( T_9 , V_7 , V_164 ) S3(fmt, s, txq[qs].v)
#define F_138 ( V_7 , V_164 ) T3("lu", s, v)
#define F_150 ( T_9 , V_7 , V_164 ) S3(fmt, s, rxq[qs].v)
#define F_139 ( V_7 , V_164 ) R3("lu", s, v)
if ( V_340 < V_337 ) {
const struct V_84 * V_37 = & V_1 -> V_36 . V_42 [ V_340 * V_339 ] ;
const struct V_73 * V_74 = & V_1 -> V_36 . V_86 [ V_340 * V_339 ] ;
int V_342 = F_140 ( V_339 , V_1 -> V_36 . V_338 - V_339 * V_340 ) ;
...
? V_37 [ V_32 ] . V_43 . V_343 -> V_19
: L_39 ) ) ;
F_150 ( L_50 , L_65 , V_43 . V_358 ) ;
F_139 ( L_66 , V_90 . V_359 ) ;
F_139 ( L_67 , V_90 . V_300 ) ;
F_139 ( L_68 , V_90 . V_301 ) ;
F_139 ( L_69 , V_90 . V_304 ) ;
F_139 ( L_70 , V_90 . V_303 ) ;
F_139 ( L_71 , V_90 . V_360 ) ;
F_138 ( L_72 , V_296 ) ;
F_138 ( L_73 , V_298 ) ;
F_138 ( L_74 , V_302 ) ;
F_138 ( L_75 , V_78 . V_361 ) ;
F_138 ( L_76 , V_78 . V_80 ) ;
F_138 ( L_77 , V_362 ) ;
F_139 ( L_78 , V_87 . V_363 ) ;
F_139 ( L_79 , V_87 . V_364 ) ;
F_139 ( L_80 , V_87 . V_365 ) ;
return 0 ;
}
V_340 -= V_337 ;
if ( V_340 == 0 ) {
const struct V_45 * V_349 = & V_1 -> V_36 . V_41 ;
F_141 ( V_335 , L_81 , L_36 , L_61 ) ;
F_141 ( V_335 , L_82 , L_65 ,
V_349 -> V_358 ) ;
F_141 ( V_335 , L_82 , L_53 , V_349 -> V_345 ) ;
F_141 ( V_335 , L_82 , L_54 , V_349 -> V_347 ) ;
} else if ( V_340 == 1 ) {
const struct V_45 * V_53 = & V_1 -> V_36 . V_53 ;
F_141 ( V_335 , L_81 , L_36 , L_64 ) ;
F_141 ( V_335 , L_82 , L_65 ,
V_53 -> V_358 ) ;
F_141 ( V_335 , L_82 , L_53 , V_53 -> V_345 ) ;
F_141 ( V_335 , L_82 , L_54 , V_53 -> V_347 ) ;
}
#undef F_139
#undef F_138
#undef F_137
...
static void * F_152 ( struct V_334 * V_335 , T_8 * V_350 )
{
int V_351 = F_151 ( V_335 -> V_336 ) ;
return * V_350 < V_351 ? ( void * ) ( ( V_341 ) * V_350 + 1 ) : NULL ;
}
static void F_153 ( struct V_334 * V_335 , void * V_164 )
{
}
static void * F_154 ( struct V_334 * V_335 , void * V_164 , T_8 * V_350 )
{
int V_351 = F_151 ( V_335 -> V_336 ) ;
( * V_350 ) ++ ;
return * V_350 < V_351 ? ( void * ) ( ( V_341 ) * V_350 + 1 ) : NULL ;
}
static int F_155 ( struct V_352 * V_352 , struct V_353 * V_353 )
{
int V_354 = F_147 ( V_353 , & V_366 ) ;
if ( V_354 == 0 ) {
struct V_334 * V_335 = V_353 -> V_356 ;
V_335 -> V_336 = V_352 -> V_357 ;
}
...
static int F_156 ( struct V_334 * V_335 , void * V_164 )
{
struct V_1 * V_1 = V_335 -> V_336 ;
struct V_367 * V_368 = & V_1 -> V_96 . V_368 ;
#define F_137 ( V_30 , T_9 , T_10 ) \
seq_printf(seq, "%-60s " fmt "\n", \
desc " (" #var "):", vfres->var)
F_137 ( L_83 , L_84 , V_369 ) ;
F_137 ( L_85 , L_84 , V_370 ) ;
F_137 ( L_86 , L_84 , V_371 ) ;
F_137 ( L_87 , L_84 , V_372 ) ;
F_137 ( L_88 , L_84 , V_373 ) ;
F_137 ( L_89 , L_84 , V_374 ) ;
F_137 ( L_90 , L_91 , V_375 ) ;
F_137 ( L_92 , L_84 , V_376 ) ;
F_137 ( L_93 , L_91 , V_377 ) ;
F_137 ( L_94 , L_91 , V_378 ) ;
#undef F_137
return 0 ;
}
static int F_157 ( struct V_352 * V_352 , struct V_353 * V_353 )
{
return F_158 ( V_353 , F_156 , V_352 -> V_357 ) ;
}
static int F_159 ( struct V_334 * V_335 , void * V_164 )
{
if ( V_164 == V_379 ) {
F_160 ( V_335 , L_95 ) ;
} else {
...
static inline void * F_161 ( struct V_1 * V_1 , T_8 V_350 )
{
return V_350 <= V_1 -> V_96 . V_380
? ( void * ) ( V_341 ) ( V_350 + 1 )
: NULL ;
}
static void * F_162 ( struct V_334 * V_335 , T_8 * V_350 )
{
return * V_350
? F_161 ( V_335 -> V_336 , * V_350 )
: V_379 ;
}
static void * F_163 ( struct V_334 * V_335 , void * V_164 , T_8 * V_350 )
{
( * V_350 ) ++ ;
return F_161 ( V_335 -> V_336 , * V_350 ) ;
}
static void F_164 ( struct V_334 * V_335 , void * V_164 )
{
}
static int F_165 ( struct V_352 * V_352 , struct V_353 * V_353 )
{
int V_354 = F_147 ( V_353 , & V_381 ) ;
if ( V_354 == 0 ) {
struct V_334 * V_335 = V_353 -> V_356 ;
V_335 -> V_336 = V_352 -> V_357 ;
}
...
{
int V_153 ;
F_56 ( F_167 ( V_1 -> V_382 ) ) ;
for ( V_153 = 0 ; V_153 < F_10 ( V_383 ) ; V_153 ++ )
( void ) F_168 ( V_383 [ V_153 ] . V_19 ,
V_383 [ V_153 ] . V_97 ,
V_1 -> V_382 ,
( void * ) V_1 ,
V_383 [ V_153 ] . V_384 ) ;
...
V_7 -> V_157 [ 0 ] = F_178 ( V_1 ,
F_179 ( V_385 -> V_389 ) ) ;
V_7 -> V_157 [ 1 ] = F_178 ( V_1 ,
F_180 ( V_385 -> V_389 ) ) ;
V_7 -> V_157 [ 2 ] = F_178 ( V_1 ,
F_179 ( V_385 -> V_390 ) ) ;
V_7 -> V_157 [ 3 ] = F_178 ( V_1 ,
F_180 ( V_385 -> V_390 ) ) ;
V_7 -> V_157 [ 4 ] = F_178 ( V_1 ,
F_179 ( V_385 -> V_391 ) ) ;
V_7 -> V_157 [ 5 ] = F_178 ( V_1 ,
F_180 ( V_385 -> V_391 ) ) ;
V_7 -> V_161 [ 0 ] = F_181 ( V_385 -> V_392 ) ;
V_7 -> V_161 [ 1 ] = F_182 ( V_385 -> V_392 ) ;
V_7 -> V_161 [ 2 ] = F_183 ( V_385 -> V_392 ) ;
V_7 -> V_161 [ 3 ] = F_184 ( V_385 -> V_392 ) ;
V_38 = F_185 ( V_1 ) ;
if ( V_38 ) {
F_35 ( V_1 -> V_18 , L_108
L_109 , V_38 ) ;
...
static inline void F_187 ( struct V_45 * V_43 , T_2 V_154 ,
T_2 V_397 , unsigned int V_267 ,
unsigned int V_398 )
{
V_43 -> V_49 = ( F_91 ( V_154 ) |
( V_397 < V_399 ?
...
struct V_9 * V_10 = F_51 ( V_1 , V_2 ) ;
V_10 -> V_85 = V_402 ;
V_10 -> V_35 = F_189 ( & V_10 -> V_11 ) ? V_400 : 1 ;
V_402 += V_10 -> V_35 ;
}
V_7 -> V_338 = V_402 ;
V_398 = 64 ;
...
F_187 ( & V_37 -> V_43 , 0 , 0 , 1024 , V_398 ) ;
V_37 -> V_87 . V_267 = 72 ;
V_74 -> V_78 . V_267 = 1024 ;
}
F_187 ( & V_7 -> V_41 , V_167 , 0 , 512 , V_398 ) ;
F_187 ( & V_7 -> V_53 , V_167 , 0 , V_404 + 1 ,
V_398 ) ;
}
static void F_191 ( struct V_1 * V_1 , int V_342 )
{
int V_153 ;
struct V_9 * V_10 ;
...
V_405 = F_193 ( V_1 -> V_107 , V_351 , V_406 , V_405 ) ;
if ( V_405 < 0 )
return V_405 ;
V_35 = V_405 - V_409 ;
if ( V_35 < V_7 -> V_396 ) {
F_186 ( V_1 -> V_18 , L_125
L_126 , V_35 ) ;
V_7 -> V_396 = V_35 ;
if ( V_35 < V_7 -> V_338 )
F_191 ( V_1 , V_35 ) ;
...
static int F_194 ( struct V_411 * V_107 ,
...
struct V_9 * V_10 ;
struct V_4 * V_343 ;
F_195 ( L_127 , V_415 , V_249 ) ;
V_38 = F_196 ( V_107 ) ;
if ( V_38 ) {
F_35 ( & V_107 -> V_5 , L_128 ) ;
return V_38 ;
}
V_38 = F_197 ( V_107 , V_247 ) ;
if ( V_38 ) {
F_35 ( & V_107 -> V_5 , L_129 ) ;
goto V_416;
}
V_38 = F_198 ( V_107 , F_199 ( 64 ) ) ;
if ( V_38 == 0 ) {
V_38 = F_200 ( V_107 , F_199 ( 64 ) ) ;
if ( V_38 ) {
...
if ( ! F_131 ( V_1 -> V_96 . V_168 ) ) {
V_1 -> V_422 = F_207 ( F_208 ( V_107 , 2 ) ,
F_209 ( V_107 , 2 ) ) ;
if ( ! V_1 -> V_422 ) {
F_35 ( V_1 -> V_18 , L_134 ) ;
V_38 = - V_419 ;
...
V_441 ) ;
if ( F_167 ( V_1 -> V_382 ) )
F_186 ( & V_107 -> V_5 , L_140
L_141 ) ;
else
F_166 ( V_1 ) ;
}
if ( V_33 == V_442 && F_192 ( V_1 ) == 0 )
V_1 -> V_51 |= V_106 ;
else {
V_38 = F_218 ( V_107 ) ;
if ( V_38 ) {
...
static void F_228 ( struct V_411 * V_107 )
{
struct V_1 * V_1 = F_229 ( V_107 ) ;
if ( V_1 ) {
int V_2 ;
F_16 (adapter, pidx)
if ( F_220 ( V_2 , & V_1 -> V_440 ) )
...
static void F_233 ( struct V_411 * V_107 )
{
struct V_1 * V_1 ;
int V_2 ;
V_1 = F_229 ( V_107 ) ;
...
V_441 = F_217 ( V_247 , NULL ) ;
if ( F_167 ( V_441 ) )
F_235 ( L_149 ) ;
V_23 = F_236 ( & V_445 ) ;
if ( V_23 < 0 && ! F_167 ( V_441 ) )
F_237 ( V_441 ) ;
return V_23 ;
}
