...
V_75 = F_61 ( V_45 -> V_45 , V_77 ) ;
if ( ! V_75 )
return - V_15 ;
return F_62 ( V_77 , V_75 , V_72 , V_73 ) ;
}
...
T_3 * V_73 )
{
return F_64 ( & V_2 -> V_78 -> V_38 , V_72 ,
V_73 ) ;
}
void F_65 ( void )
{
...
struct V_1 * F_69 ( struct V_20 * V_21 ,
struct V_76 * V_77 , enum V_7 V_4 , int V_17 )
{
struct V_1 * V_2 = NULL ;
struct V_3 * V_3 ;
int V_26 ;
F_24 ( L_4 , V_80 [ V_4 ] ) ;
V_3 = F_70 ( sizeof( * V_3 ) , V_81 ) ;
if ( ! V_3 )
return NULL ;
V_2 = & V_3 -> V_38 ;
F_71 ( & V_3 -> V_8 ) ;
