...
F_76 ( F_77 ( V_3 ) , & V_183 , V_187 ) ;
F_130 ( V_326 , V_3 ) ;
F_131 ( V_3 , & V_181 , F_128 ( V_3 , V_313 , V_194 , V_306 ) ) ;
F_132 ( V_326 , V_3 ) ;
F_82 ( F_77 ( V_3 ) , & V_183 ) ;
}
F_133 (queue, skb, n) {
unsigned int V_327 = V_38 -> V_29 ;
V_40 = F_30 ( V_38 ) ;
if ( ( V_327 + V_314 ) > V_32 )
V_327 = V_32 - V_314 ;
if ( F_134 ( V_312 , V_38 -> V_30 , V_327 ) ) {
V_16 = - V_274 ;
break;
}
V_314 += V_327 ;
...
V_19:
if ( V_16 == 0 )
V_16 = ( V_194 & V_320 ) ? - V_3 -> V_322 : F_79 ( V_3 ) ;
if ( ( V_16 >= 0 ) && V_312 -> V_330 ) {
F_137 ( sizeof( struct V_21 ) ) ;
memcpy ( V_312 -> V_330 , & V_5 -> V_42 , sizeof( struct V_21 ) ) ;
V_312 -> V_331 = sizeof( struct V_21 ) ;
}
F_59 ( V_3 ) ;
return V_16 ;
}
static inline int F_138 ( struct V_4 * V_5 , struct V_304 * V_313 , int V_194 )
{
unsigned char V_332 = V_5 -> V_86 & V_232 ;
if ( F_139 ( V_313 ) >= V_5 -> V_104 )
return 1 ;
if ( V_332 != V_88 ) {
if ( V_194 & V_307 ) {
if ( V_5 -> V_83 == 0 )
...
unsigned int F_140 ( struct V_169 * V_170 , int V_333 )
{
unsigned int V_334 = 230 - V_92 ;
if ( V_170 ) {
struct V_335 * V_336 = F_141 ( V_170 -> V_175 ) ;
V_333 -= F_142 ( V_170 ) ;
if ( V_336 -> V_337 )
V_333 -= 21 ;
else
...
static inline unsigned int F_143 ( struct V_2 * V_3 , int V_194 )
{
struct V_198 * V_199 = F_74 ( V_3 ) ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
int V_338 = F_144 ( int , V_5 -> V_186 , V_5 -> V_91 ) ;
if ( V_194 & V_307 )
return 16 ;
if ( V_199 ) {
T_7 V_333 = F_145 ( V_199 ) ;
V_338 = F_144 ( int , F_140 ( V_199 -> V_170 , V_333 ) , V_338 ) ;
}
return V_338 ;
}
static inline struct V_37 * F_146 ( struct V_2 * V_3 ,
unsigned long V_339 , int V_340 ,
int * V_341 )
{
struct V_37 * V_38 = F_147 ( V_3 , V_339 ,
V_340 , V_341 ) ;
if ( V_38 ) {
V_38 -> V_153 = F_148 ( V_342 ) ;
V_38 -> V_343 = V_344 ;
}
return V_38 ;
}
static int F_149 ( struct V_53 * V_2 , struct V_311 * V_312 , T_6 V_32 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
T_6 V_334 ;
struct V_304 * V_313 = & V_5 -> V_47 ;
int V_194 = V_312 -> V_323 ;
int V_184 = 0 ;
T_6 V_345 = 0 ;
int V_167 = V_312 -> V_331 ;
F_150 ( struct V_21 * , V_6 , V_312 -> V_330 ) ;
struct V_37 * V_38 = NULL ;
struct V_39 * V_40 ;
T_6 V_29 ;
unsigned char V_332 ;
long V_181 ;
if ( V_194 & ~ ( V_346 | V_307 | V_317 | V_329 | V_321 | V_347 | V_319 ) )
return - V_251 ;
...
if ( ( V_194 & V_346 ) && V_3 -> V_50 )
F_152 ( V_3 ) ;
V_334 = V_5 -> V_91 ;
V_332 = V_5 -> V_86 & V_232 ;
V_334 = F_143 ( V_3 , V_194 ) ;
if ( V_194 & V_307 ) {
V_313 = & V_5 -> V_48 ;
if ( V_32 > V_334 ) {
V_184 = - V_352 ;
...
V_40 = F_30 ( V_38 ) ;
F_153 ( V_38 , 64 + V_92 ) ;
if ( F_154 ( F_155 ( V_38 , V_29 ) , V_312 , V_29 ) ) {
V_184 = - V_274 ;
goto V_19;
}
if ( V_194 & V_307 ) {
...
V_40 -> V_308 |= 0x20 ;
V_5 -> V_354 += V_29 ;
if ( ( ( V_345 + V_29 ) == V_32 ) && ( V_194 & V_329 ) ) {
V_40 -> V_308 |= 0x40 ;
V_5 -> V_354 = 0 ;
if ( V_332 == V_355 )
V_5 -> V_82 -- ;
...
V_345 += V_29 ;
F_156 ( V_3 , V_38 , V_3 -> V_66 , V_194 & V_307 ) ;
V_38 = NULL ;
V_5 -> V_111 = F_46 ( V_3 ) ;
}
V_19:
F_102 ( V_38 ) ;
F_59 ( V_3 ) ;
return V_345 ? V_345 : V_184 ;
V_348:
V_184 = F_157 ( V_3 , V_194 , V_184 ) ;
F_59 ( V_3 ) ;
return V_184 ;
}
static int F_158 ( struct V_357 * V_358 , unsigned long V_359 ,
void * V_214 )
{
struct V_169 * V_170 = F_159 ( V_214 ) ;
if ( ! F_55 ( F_160 ( V_170 ) , & V_156 ) )
return V_360 ;
switch ( V_359 ) {
case V_361 :
F_161 ( V_170 ) ;
...
static struct V_2 * F_163 ( struct V_363 * V_364 )
{
struct V_365 * V_71 = V_364 -> V_366 ;
struct V_2 * V_315 = NULL ;
for( V_71 -> V_367 = 0 ;
V_71 -> V_367 < V_368 ;
++ V_71 -> V_367 ) {
V_315 = F_28 ( & V_10 [ V_71 -> V_367 ] ) ;
if ( V_315 )
break;
}
return V_315 ;
}
static struct V_2 * F_164 ( struct V_363 * V_364 ,
struct V_2 * V_315 )
{
struct V_365 * V_71 = V_364 -> V_366 ;
V_315 = F_165 ( V_315 ) ;
...
static struct V_2 * F_166 ( struct V_363 * V_364 , T_8 * V_370 )
{
struct V_2 * V_3 = F_163 ( V_364 ) ;
if ( V_3 ) {
while( * V_370 && ( V_3 = F_164 ( V_364 , V_3 ) ) )
-- * V_370 ;
}
return * V_370 ? NULL : V_3 ;
}
static void * F_167 ( struct V_363 * V_364 , T_8 V_370 )
{
void * V_371 ;
F_168 ( & V_18 ) ;
V_371 = F_166 ( V_364 , & V_370 ) ;
if ( ! V_371 ) {
F_169 ( & V_18 ) ;
}
return V_371 ;
}
static void * F_170 ( struct V_363 * V_364 , T_8 * V_370 )
{
return * V_370 ? F_167 ( V_364 , * V_370 - 1 ) : V_372 ;
}
static void * F_171 ( struct V_363 * V_364 , void * V_373 , T_8 * V_370 )
{
void * V_371 ;
if ( V_373 == V_372 ) {
V_371 = F_167 ( V_364 , 0 ) ;
...
static void F_172 ( struct V_363 * V_364 , void * V_373 )
{
if ( V_373 && V_373 != V_372 )
F_169 ( & V_18 ) ;
}
static void F_173 ( struct V_21 * V_374 , unsigned char * V_28 )
{
int V_22 ;
switch ( F_4 ( V_374 -> V_25 ) ) {
case 0 :
sprintf ( V_28 , L_4 , V_374 -> V_24 ) ;
break;
default:
for ( V_22 = 0 ; V_22 < F_4 ( V_374 -> V_25 ) ; V_22 ++ ) {
V_28 [ V_22 ] = V_374 -> V_26 [ V_22 ] ;
if ( F_174 ( V_28 [ V_22 ] ) )
V_28 [ V_22 ] = '.' ;
}
V_28 [ V_22 ] = 0 ;
...
static inline void F_176 ( struct V_363 * V_364 , struct V_2 * V_3 )
{
struct V_4 * V_5 = F_2 ( V_3 ) ;
char V_376 [ V_377 ] ;
char V_378 [ V_377 ] ;
...
char V_380 [ V_34 + 3 ] ;
F_173 ( & V_5 -> V_6 , V_379 ) ;
F_173 ( & V_5 -> V_42 , V_380 ) ;
F_177 ( V_364 ,
L_22
L_23 ,
F_53 ( F_4 ( F_31 ( & V_5 -> V_6 ) ) , V_376 ) ,
V_5 -> V_11 ,
V_5 -> V_73 ,
V_5 -> V_74 ,
V_5 -> V_75 ,
...
static int F_178 ( struct V_363 * V_364 , void * V_373 )
{
if ( V_373 == V_372 ) {
F_179 ( V_364 , L_26 ) ;
} else {
...
static int F_180 ( struct V_383 * V_383 , struct V_246 * V_246 )
{
return F_181 ( V_246 , & V_384 ,
sizeof( struct V_365 ) ) ;
}
...
F_189 ( & V_387 ) ;
F_190 ( & V_388 ) ;
F_191 ( L_27 , V_389 , V_156 . V_390 , & V_391 ) ;
F_192 () ;
V_19:
return V_371 ;
}
