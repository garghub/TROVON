...
if ( ! F_124 ( & V_3 -> V_151 ) )
goto V_159;
if ( F_96 ( F_125 ( V_160 , & V_3 -> V_26 ) ) ) {
F_126 ( & V_3 -> V_156 . V_157 ) ;
break;
}
F_127 ( V_161 ) ;
F_128 ( & V_3 -> V_156 , & V_154 ) ;
F_126 ( & V_3 -> V_156 . V_157 ) ;
F_129 () ;
F_123 ( & V_3 -> V_156 . V_157 ) ;
...
V_3 -> V_151 = V_162 ;
F_126 ( & V_3 -> V_156 . V_157 ) ;
F_104 ( F_131 ( V_151 . V_163 ) ) ;
F_132 ( & V_153 ) ;
do {
V_107 = F_133 ( F_134 ( & V_151 ) ) ;
F_135 ( & V_107 -> V_163 , & V_151 ) ;
F_120 ( V_107 ) ;
} while ( ! F_124 ( & V_151 ) );
F_136 ( & V_153 ) ;
}
...
static void F_137 ( struct V_106 * V_107 , int V_164 )
{
struct V_81 * V_114 = V_107 -> V_63 . V_82 ;
struct V_2 * V_3 = V_107 -> V_3 ;
unsigned long V_26 ;
...
V_114 -> V_84 . V_145 = V_3 -> V_146 + V_107 -> V_77 ;
if ( F_138 ( ! V_164 ) && F_125 ( V_167 , & V_3 -> V_26 ) ) {
F_114 ( V_114 ) ;
return;
}
F_139 ( & V_3 -> V_156 . V_157 , V_26 ) ;
V_165 = & V_3 -> V_151 . V_163 ;
V_166 = NULL ;
V_77 = V_107 -> V_77 ;
while ( * V_165 ) {
V_166 = * V_165 ;
if ( V_77 < F_133 ( V_166 ) -> V_77 )
V_165 = & ( * V_165 ) -> V_168 ;
else
V_165 = & ( * V_165 ) -> V_169 ;
}
F_140 ( & V_107 -> V_163 , V_166 , V_165 ) ;
F_141 ( & V_107 -> V_163 , & V_3 -> V_151 ) ;
F_142 ( & V_3 -> V_156 ) ;
F_143 ( & V_3 -> V_156 . V_157 , V_26 ) ;
}
...
static void F_149 ( struct V_147 * V_148 )
{
struct V_106 * V_107 = F_116 ( V_148 , struct V_106 , V_148 ) ;
if ( F_51 ( V_107 -> V_105 ) == V_138 )
F_147 ( V_107 ) ;
...
{
struct V_2 * V_3 = V_107 -> V_3 ;
F_118 ( & V_107 -> V_148 , F_149 ) ;
F_119 ( V_3 -> V_175 , & V_107 -> V_148 ) ;
}
static int F_150 ( T_1 * V_22 , char * V_176 , unsigned int V_113 )
{
char V_177 [ 3 ] ;
unsigned int V_59 ;
V_177 [ 2 ] = '\0' ;
...
static int F_154 ( struct V_2 * V_3 , char * V_178 )
{
unsigned V_59 ;
int V_21 ;
V_3 -> V_4 = F_155 ( V_3 -> V_52 * sizeof( struct V_1 * ) ,
V_41 ) ;
if ( ! V_3 -> V_4 )
return - V_42 ;
for ( V_59 = 0 ; V_59 < V_3 -> V_52 ; V_59 ++ ) {
V_3 -> V_4 [ V_59 ] = F_156 ( V_178 , 0 , 0 ) ;
...
static int F_159 ( struct V_2 * V_3 , char * V_22 )
{
int V_31 = - V_37 ;
...
goto V_78;
if ( V_3 -> V_23 && F_150 ( V_3 -> V_22 , V_22 , V_3 -> V_23 ) < 0 )
goto V_78;
F_160 ( V_181 , & V_3 -> V_26 ) ;
V_31 = F_157 ( V_3 ) ;
V_78:
memset ( V_22 , '0' , V_180 ) ;
return V_31 ;
...
V_3 -> V_185 = F_170 ( V_186 , V_41 ) ;
if ( ! V_3 -> V_185 )
goto V_195;
V_187 = V_186 ;
V_191 = F_171 ( & V_187 , L_17 ) ;
V_35 = F_171 ( & V_191 , L_19 ) ;
if ( ! V_191 )
V_3 -> V_52 = 1 ;
...
V_3 -> V_51 = V_3 -> V_52 ;
V_3 -> V_179 = 0 ;
V_3 -> V_35 = F_170 ( V_35 , V_41 ) ;
if ( ! V_3 -> V_35 )
goto V_195;
V_188 = F_171 ( & V_187 , L_17 ) ;
V_190 = F_171 ( & V_187 , L_17 ) ;
V_189 = F_171 ( & V_190 , L_19 ) ;
if ( V_187 )
F_173 ( L_22 ) ;
...
static int F_175 ( struct V_32 * V_33 , unsigned int V_206 , char * * V_207 )
{
struct V_2 * V_3 ;
...
V_3 -> V_23 = V_23 ;
V_33 -> V_182 = V_3 ;
V_193 = F_169 ( V_33 , V_207 [ 0 ] , V_207 [ 1 ] ) ;
if ( V_193 < 0 )
goto V_40;
V_3 -> V_91 = sizeof( struct V_89 ) ;
V_3 -> V_91 += F_176 ( F_1 ( V_3 ) ) ;
V_3 -> V_91 = F_71 ( V_3 -> V_91 , F_177 ( struct V_6 ) ) ;
...
V_193 = - V_42 ;
V_3 -> V_101 = F_178 ( V_217 , V_3 -> V_91 +
...
sizeof( struct V_6 ) + V_210 + V_3 -> V_8 ,
V_218 ) ;
V_3 -> V_129 = F_179 ( V_219 , 0 ) ;
if ( ! V_3 -> V_129 ) {
V_33 -> error = L_45 ;
goto V_40;
}
V_3 -> V_43 = F_180 ( V_217 , 0 ) ;
if ( ! V_3 -> V_43 ) {
V_33 -> error = L_46 ;
goto V_40;
}
...
V_3 -> V_87 = V_209 ;
V_193 = F_182 ( V_33 , V_207 [ 3 ] , F_183 ( V_33 -> V_220 ) , & V_3 -> V_141 ) ;
if ( V_193 ) {
V_33 -> error = L_49 ;
goto V_40;
}
...
V_212 . V_206 = V_206 ;
V_212 . V_207 = V_207 ;
V_193 = F_184 ( V_215 , & V_212 , & V_208 , & V_33 -> error ) ;
if ( V_193 )
goto V_40;
V_193 = - V_37 ;
while ( V_208 -- ) {
...
F_160 ( V_222 , & V_3 -> V_26 ) ;
else if ( ! strcasecmp ( V_213 , L_54 ) )
F_160 ( V_167 , & V_3 -> V_26 ) ;
else {
V_33 -> error = L_55 ;
goto V_40;
}
...
V_193 = - V_42 ;
V_3 -> V_149 = F_186 ( L_56 , V_223 , 1 ) ;
if ( ! V_3 -> V_149 ) {
V_33 -> error = L_57 ;
goto V_40;
}
if ( F_125 ( V_222 , & V_3 -> V_26 ) )
V_3 -> V_175 = F_186 ( L_58 , V_224 | V_223 , 1 ) ;
else
V_3 -> V_175 = F_186 ( L_58 , V_224 | V_223 | V_225 ,
F_187 () ) ;
if ( ! V_3 -> V_175 ) {
V_33 -> error = L_59 ;
goto V_40;
...
F_188 ( & V_3 -> V_156 ) ;
V_3 -> V_151 = V_162 ;
V_3 -> V_183 = F_189 ( F_121 , V_3 , L_60 ) ;
if ( F_14 ( V_3 -> V_183 ) ) {
...
static int F_191 ( struct V_32 * V_33 , struct V_81 * V_81 )
{
struct V_106 * V_107 ;
struct V_2 * V_3 = V_33 -> V_182 ;
...
F_192 ( V_33 , V_81 -> V_84 . V_145 ) ;
return V_230 ;
}
V_107 = F_86 ( V_81 , V_3 -> V_108 ) ;
F_105 ( V_107 , V_3 , V_81 , F_192 ( V_33 , V_81 -> V_84 . V_145 ) ) ;
...
static void F_193 ( struct V_32 * V_33 , T_6 type ,
...
break;
case V_238 :
F_194 ( L_62 , V_3 -> V_185 ) ;
if ( V_3 -> V_23 > 0 )
for ( V_59 = 0 ; V_59 < V_3 -> V_23 ; V_59 ++ )
F_194 ( L_63 , V_3 -> V_22 [ V_59 ] ) ;
else
F_194 ( L_17 ) ;
F_194 ( L_64 , ( unsigned long long ) V_3 -> V_87 ,
V_3 -> V_141 -> V_239 , ( unsigned long long ) V_3 -> V_146 ) ;
V_236 += ! ! V_33 -> V_221 ;
V_236 += F_125 ( V_222 , & V_3 -> V_26 ) ;
V_236 += F_125 ( V_167 , & V_3 -> V_26 ) ;
if ( V_236 ) {
F_194 ( L_65 , V_236 ) ;
if ( V_33 -> V_221 )
F_194 ( L_66 ) ;
if ( F_125 ( V_222 , & V_3 -> V_26 ) )
F_194 ( L_67 ) ;
if ( F_125 ( V_167 , & V_3 -> V_26 ) )
F_194 ( L_68 ) ;
}
break;
}
}
static void F_195 ( struct V_32 * V_33 )
{
struct V_2 * V_3 = V_33 -> V_182 ;
F_160 ( V_240 , & V_3 -> V_26 ) ;
}
static int F_196 ( struct V_32 * V_33 )
{
struct V_2 * V_3 = V_33 -> V_182 ;
if ( ! F_125 ( V_181 , & V_3 -> V_26 ) ) {
F_197 ( L_69 ) ;
return - V_241 ;
}
return 0 ;
...
{
struct V_2 * V_3 = V_33 -> V_182 ;
F_162 ( V_240 , & V_3 -> V_26 ) ;
}
static int F_199 ( struct V_32 * V_33 , unsigned V_206 , char * * V_207 )
{
struct V_2 * V_3 = V_33 -> V_182 ;
int V_193 = - V_37 ;
if ( V_206 < 2 )
...
if ( ! F_125 ( V_240 , & V_3 -> V_26 ) ) {
F_173 ( L_71 ) ;
return - V_37 ;
}
if ( V_206 == 3 && ! strcasecmp ( V_207 [ 1 ] , L_72 ) ) {
V_193 = F_159 ( V_3 , V_207 [ 2 ] ) ;
if ( V_193 )
return V_193 ;
if ( V_3 -> V_97 && V_3 -> V_97 -> V_205 )
V_193 = V_3 -> V_97 -> V_205 ( V_3 ) ;
...
static void F_201 ( struct V_32 * V_33 , struct V_244 * V_245 )
{
V_245 -> V_246 = V_116 ;
}
