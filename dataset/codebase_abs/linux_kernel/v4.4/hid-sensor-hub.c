...
V_55 = F_19 ( V_51 , sizeof( T_3 ) ) ;
if ( V_51 ) {
for ( V_7 = 0 ; V_7 < V_51 ; ++ V_7 ) {
F_20 ( V_6 -> V_19 [ V_50 ] , V_7 ,
( V_62 T_3 ) F_21 ( * V_54 ) ) ;
++ V_54 ;
}
}
...
F_22 ( V_33 -> V_4 , V_6 , V_64 ) ;
F_23 ( V_33 -> V_4 ) ;
V_61:
F_24 ( & V_53 -> V_58 ) ;
return V_57 ;
}
int F_25 ( struct V_32 * V_33 , T_2 V_17 ,
T_2 V_50 , int V_51 , void * V_52 )
{
struct V_1 * V_6 ;
struct V_37 * V_53 = F_7 ( V_33 -> V_4 ) ;
...
F_22 ( V_33 -> V_4 , V_6 , V_65 ) ;
F_23 ( V_33 -> V_4 ) ;
V_25 = F_26 ( V_6 -> V_19 [ V_50 ] -> V_25 ,
8 ) *
V_6 -> V_19 [ V_50 ] -> V_26 ;
if ( ! V_25 ) {
V_57 = - V_45 ;
...
static int F_33 ( struct V_3 * V_4 , T_4 V_90 )
{
struct V_37 * V_38 = F_7 ( V_4 ) ;
struct V_35 * V_36 ;
unsigned long V_39 ;
...
V_6 -> V_19 [ V_7 ] -> V_89 ) ) {
F_34 ( V_4 , L_8 ) ;
V_33 -> V_73 . V_79 = F_38 ( V_93 , V_94 , V_46 ) ;
if ( V_33 -> V_73 . V_79 )
V_33 -> V_73 . V_75 = V_94 ;
else
V_33 -> V_73 . V_75 = 0 ;
...
static T_5 * F_45 ( struct V_3 * V_4 , T_5 * V_99 ,
unsigned int * V_100 )
{
int V_16 ;
...
V_101 = F_47 ( & V_4 -> V_113 , sizeof( * V_101 ) , V_114 ) ;
if ( ! V_101 ) {
F_42 ( V_4 , L_11 ) ;
return - V_47 ;
}
...
V_101 -> V_120 = F_47 ( & V_4 -> V_113 , V_110 *
sizeof( struct V_121 ) ,
V_114 ) ;
if ( V_101 -> V_120 == NULL ) {
F_42 ( V_4 , L_15 ) ;
...
if ( V_11 -> type == V_12 ||
V_11 -> type == V_13 ) {
V_33 = F_47 ( & V_4 -> V_113 , sizeof( * V_33 ) ,
V_114 ) ;
if ( ! V_33 ) {
F_42 ( V_4 , L_16 ) ;
V_57 = - V_47 ;
