...
F_12 ( V_12 ) ;
if ( F_69 ( V_12 , V_192 ) && V_12 -> V_193 &&
! ( V_74 -> V_42 & V_194 ) )
V_18 = F_22 ( V_12 , V_195 ,
V_12 -> V_193 ) ;
V_189:
F_71 ( V_14 ) ;
F_73 ( V_12 ) ;
...
static void F_92 ( struct V_2 * V_198 )
{
struct V_2 * V_12 ;
F_7 ( L_11 , V_198 ,
F_70 ( V_198 -> V_25 ) ) ;
while ( ( V_12 = F_32 ( V_198 , NULL ) ) ) {
struct V_13 * V_14 = F_6 ( V_12 ) -> V_14 ;
F_7 ( L_12 , V_14 ,
F_70 ( V_14 -> V_47 ) ) ;
F_57 ( V_14 ) ;
...
static struct V_13 * F_94 ( struct V_13 * V_14 )
{
struct V_2 * V_12 , * V_198 = V_14 -> V_200 ;
F_12 ( V_198 ) ;
if ( F_95 ( V_198 ) ) {
F_7 ( L_13 , V_198 -> V_64 ) ;
F_18 ( V_198 ) ;
...
V_12 = F_96 ( F_97 ( V_198 ) , NULL , V_201 ,
V_202 , 0 ) ;
if ( ! V_12 ) {
F_18 ( V_198 ) ;
return NULL ;
...
static int F_101 ( struct V_13 * V_14 , struct V_203 * V_204 )
{
struct V_2 * V_12 = V_14 -> V_200 ;
int V_18 ;
F_12 ( V_12 ) ;
if ( F_6 ( V_12 ) -> V_173 ) {
V_18 = - V_205 ;
...
V_18 = F_65 ( V_12 , V_204 ) ;
if ( V_18 < 0 && V_14 -> V_45 == V_59 ) {
F_6 ( V_12 ) -> V_173 = V_204 ;
F_67 ( V_14 , 1 ) ;
V_18 = 0 ;
}
V_28:
...
static void F_103 ( struct V_13 * V_14 , int V_18 )
{
struct V_2 * V_12 = V_14 -> V_200 ;
struct V_2 * V_198 ;
F_7 ( L_9 , V_14 , F_70 ( V_14 -> V_47 ) ) ;
F_28 ( V_12 , F_66 ( & V_14 -> V_65 ) ) ;
V_198 = F_43 ( V_12 ) -> V_198 ;
F_72 ( V_12 , V_176 ) ;
switch ( V_14 -> V_47 ) {
case V_26 :
case V_48 :
...
static void F_105 ( struct V_13 * V_14 , int V_47 ,
int V_18 )
{
struct V_2 * V_12 = V_14 -> V_200 ;
V_12 -> V_25 = V_47 ;
...
static struct V_203 * F_106 ( struct V_13 * V_14 ,
unsigned long V_207 ,
unsigned long V_17 , int V_208 )
{
struct V_2 * V_12 = V_14 -> V_200 ;
struct V_203 * V_204 ;
int V_18 ;
F_59 ( V_14 ) ;
V_204 = F_107 ( V_12 , V_207 + V_17 , V_208 , & V_18 ) ;
F_57 ( V_14 ) ;
if ( ! V_204 )
return F_108 ( V_18 ) ;
V_204 -> V_209 = V_12 -> V_210 ;
F_109 ( V_204 ) -> V_211 . V_14 = V_14 ;
return V_204 ;
}
...
{
struct V_2 * V_198 , * V_12 = V_14 -> V_200 ;
F_12 ( V_12 ) ;
V_198 = F_43 ( V_12 ) -> V_198 ;
if ( V_198 )
V_198 -> V_206 ( V_198 ) ;
...
static long F_115 ( struct V_13 * V_14 )
{
struct V_2 * V_12 = V_14 -> V_200 ;
return V_12 -> V_212 ;
}
...
static void F_117 ( struct V_2 * V_12 )
{
F_7 ( L_1 , V_12 ) ;
if ( F_6 ( V_12 ) -> V_14 )
F_71 ( F_6 ( V_12 ) -> V_14 ) ;
if ( F_6 ( V_12 ) -> V_173 ) {
F_118 ( F_6 ( V_12 ) -> V_173 ) ;
F_6 ( V_12 ) -> V_173 = NULL ;
}
F_119 ( & V_12 -> V_213 ) ;
F_119 ( & V_12 -> V_214 ) ;
}
static void F_120 ( struct V_203 * V_204 , void * V_215 ,
int * V_216 )
{
F_121 ( struct V_15 * , V_16 , V_215 ) ;
memset ( V_16 , 0 , sizeof( struct V_15 ) ) ;
V_16 -> V_217 = V_20 ;
V_16 -> V_22 = F_109 ( V_204 ) -> V_211 . V_5 ;
F_17 ( & V_16 -> V_30 , & F_109 ( V_204 ) -> V_211 . V_218 ) ;
* V_216 = sizeof( struct V_15 ) ;
}
static void F_99 ( struct V_2 * V_12 , struct V_2 * V_198 )
{
struct V_13 * V_14 = F_6 ( V_12 ) -> V_14 ;
F_7 ( L_1 , V_12 ) ;
if ( V_198 ) {
struct V_13 * V_219 = F_6 ( V_198 ) -> V_14 ;
V_12 -> V_55 = V_198 -> V_55 ;
F_43 ( V_12 ) -> V_42 = F_43 ( V_198 ) -> V_42 ;
V_14 -> V_31 = V_219 -> V_31 ;
V_14 -> V_95 = V_219 -> V_95 ;
V_14 -> V_96 = V_219 -> V_96 ;
V_14 -> V_149 = V_219 -> V_149 ;
V_14 -> V_45 = V_219 -> V_45 ;
V_14 -> V_98 = V_219 -> V_98 ;
V_14 -> V_99 = V_219 -> V_99 ;
V_14 -> V_101 = V_219 -> V_101 ;
V_14 -> V_220 = V_219 -> V_220 ;
V_14 -> V_34 = V_219 -> V_34 ;
V_14 -> V_42 = V_219 -> V_42 ;
V_14 -> V_221 = V_219 -> V_221 ;
V_14 -> V_222 = V_219 -> V_222 ;
if ( V_14 -> V_31 == V_40 ) {
V_14 -> V_50 = V_219 -> V_50 ;
V_14 -> V_83 = V_219 -> V_50 ;
}
F_122 ( V_198 , V_12 ) ;
} else {
switch ( V_12 -> V_55 ) {
...
static struct V_2 * F_96 ( struct V_228 * V_228 , struct V_1 * V_2 ,
int V_229 , T_6 V_230 , int V_231 )
{
struct V_2 * V_12 ;
struct V_13 * V_14 ;
V_12 = F_124 ( V_228 , V_232 , V_230 , & V_233 , V_231 ) ;
if ( ! V_12 )
return NULL ;
F_125 ( V_2 , V_12 ) ;
F_126 ( & F_43 ( V_12 ) -> V_234 ) ;
V_12 -> V_235 = F_117 ;
V_12 -> V_212 = V_236 ;
F_127 ( V_12 , V_176 ) ;
V_12 -> V_237 = V_229 ;
...
static int F_130 ( struct V_228 * V_228 , struct V_1 * V_2 , int V_238 ,
int V_231 )
{
struct V_2 * V_12 ;
F_7 ( L_15 , V_2 ) ;
...
V_2 -> type != V_223 && V_2 -> type != V_137 )
return - V_240 ;
if ( V_2 -> type == V_137 && ! V_231 && ! F_3 ( V_241 ) )
return - V_163 ;
V_2 -> V_3 = & V_4 ;
V_12 = F_96 ( V_228 , V_2 , V_238 , V_202 , V_231 ) ;
if ( ! V_12 )
return - V_205 ;
F_99 ( V_12 , NULL ) ;
F_131 ( & V_197 , V_12 ) ;
...
{
int V_18 ;
F_133 ( sizeof( struct V_15 ) > sizeof( struct V_9 ) ) ;
V_18 = F_134 ( & V_233 , 0 ) ;
if ( V_18 < 0 )
return V_18 ;
V_18 = F_135 ( V_201 , & V_242 ) ;
if ( V_18 < 0 ) {
F_136 ( L_16 ) ;
goto error;
}
V_18 = F_137 ( & V_243 , L_17 , & V_197 ,
NULL ) ;
if ( V_18 < 0 ) {
F_136 ( L_18 ) ;
F_138 ( V_201 ) ;
