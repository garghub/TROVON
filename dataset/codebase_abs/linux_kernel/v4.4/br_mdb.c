...
return - V_91 ;
V_106 = F_64 ( V_10 ) ;
if ( F_65 ( V_8 ) && V_106 && V_69 -> V_43 == 0 ) {
F_66 (v, &vg->vlan_list, vlist) {
V_69 -> V_43 = V_108 -> V_43 ;
...
F_68 ( & V_10 -> V_111 ) ;
F_69 ( & V_10 -> V_99 ) ;
F_70 ( & V_10 -> V_112 , V_113 ) ;
V_24 = 0 ;
if ( ! V_31 -> V_38 && ! V_31 -> V_111 &&
F_59 ( V_8 -> V_6 ) )
F_57 ( & V_31 -> V_99 , V_96 ) ;
break;
}
...
void F_72 ( void )
{
F_73 ( V_115 , V_66 , NULL , F_14 , NULL ) ;
F_73 ( V_115 , V_109 , F_63 , NULL , NULL ) ;
F_73 ( V_115 , V_114 , F_71 , NULL , NULL ) ;
}
void F_74 ( void )
{
F_75 ( V_115 , V_66 ) ;
