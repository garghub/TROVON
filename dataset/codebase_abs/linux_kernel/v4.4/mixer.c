...
for ( V_152 = 0 ; V_152 < F_76 ( V_191 ) ; V_152 ++ ) {
unsigned int V_209 = 0 ;
...
T_1 * V_170 = F_80 ( V_183 , V_3 -> V_55 -> V_78 ) ;
...
V_59 = F_74 ( V_3 , V_183 -> V_138 [ V_216 ] ) ;
if ( V_59 < 0 )
continue;
...
V_183 -> V_30 < V_215 + F_86 ( V_183 , V_3 -> V_55 -> V_78 ) ) {
F_25 ( V_3 -> V_37 , L_51 , V_11 , V_4 ) ;
return - V_65 ;
}
for ( V_152 = 0 ; V_152 < V_215 ; V_152 ++ ) {
if ( ( V_59 = F_74 ( V_3 , V_183 -> V_138 [ V_152 ] ) ) < 0 )
return V_59 ;
}
...
T_1 * V_226 = F_87 ( V_183 , V_3 -> V_55 -> V_78 ) ;
...
T_1 * V_229 = F_88 ( V_183 , V_3 -> V_55 -> V_78 ) ;
V_14 -> V_16 = 1 ;
V_14 -> V_18 = V_229 [ 0 ] ;
V_14 -> V_47 = 1 ;
V_14 -> V_19 = 1 ;
...
if ( F_92 ( ! V_236 ) )
return - V_65 ;
return F_93 ( V_160 , 1 , V_14 -> V_18 , V_236 ) ;
}
...
V_241 : V_242 ;
V_240 = F_98 ( sizeof( char * ) * V_183 -> V_143 , V_190 ) ;
if ( ! V_240 ) {
F_53 ( V_14 ) ;
return - V_98 ;
}
...
V_36 = F_41 ( V_3 , & V_112 , V_240 [ V_152 ] , F_99 , 0 ) ;
if ( ! V_36 )
...
static void F_101 ( struct V_107 * V_55 )
{
F_53 ( V_55 -> V_110 ) ;
if ( V_55 -> V_245 ) {
...
static int F_104 ( struct V_107 * V_55 )
{
struct V_2 V_3 ;
int V_59 ;
...
V_6 = NULL ;
while ( ( V_6 = F_105 ( V_55 -> V_253 -> V_254 ,
V_55 -> V_253 -> V_255 ,
V_6 , V_257 ) ) != NULL ) {
if ( V_55 -> V_78 == V_79 ) {
...
void F_107 ( struct V_107 * V_55 , int V_4 )
{
struct V_104 * V_105 ;
...
static void F_108 ( struct V_262 * V_28 ,
struct V_104 * V_105 )
{
...
static void F_110 ( struct V_264 * V_265 ,
struct V_262 * V_28 )
{
...
V_55 -> V_84 ) ;
F_109 ( V_28 , L_75 , V_37 -> V_108 -> V_266 ) ;
...
static void F_112 ( struct V_107 * V_55 ,
...
static void F_113 ( struct V_245 * V_245 )
{
...
F_115 ( V_55 , V_274 -> V_278 ) ;
else
F_107 ( V_55 , V_274 -> V_278 ) ;
}
} else {
struct V_282 * V_283 ;
...
static int F_117 ( struct V_107 * V_55 )
{
struct V_294 * V_295 ;
void * V_246 ;
int V_296 ;
unsigned int V_297 ;
if ( F_118 ( V_55 -> V_253 ) -> V_298 < 1 )
return 0 ;
V_295 = F_119 ( V_55 -> V_253 , 0 ) ;
if ( ! F_120 ( V_295 ) || ! F_121 ( V_295 ) )
return 0 ;
V_297 = F_122 ( V_295 ) ;
V_296 = F_43 ( V_295 -> V_299 ) ;
V_246 = F_98 ( V_296 , V_190 ) ;
if ( ! V_246 )
return - V_98 ;
V_55 -> V_245 = F_123 ( 0 , V_190 ) ;
if ( ! V_55 -> V_245 ) {
F_53 ( V_246 ) ;
return - V_98 ;
}
F_124 ( V_55 -> V_245 , V_55 -> V_37 -> V_38 ,
F_125 ( V_55 -> V_37 -> V_38 , V_297 ) ,
V_246 , V_296 ,
F_113 , V_55 , V_295 -> V_300 ) ;
F_116 ( V_55 -> V_245 , V_190 ) ;
return 0 ;
}
int F_126 ( struct V_53 * V_37 , int V_301 ,
int V_302 )
{
...
V_55 -> V_37 = V_37 ;
V_55 -> V_84 = V_302 ;
V_55 -> V_110 = F_127 ( V_267 , sizeof( * V_55 -> V_110 ) ,
V_190 ) ;
if ( ! V_55 -> V_110 ) {
F_53 ( V_55 ) ;
return - V_98 ;
}
V_55 -> V_253 = & F_128 ( V_37 -> V_38 , V_301 ) -> V_307 [ 0 ] ;
switch ( F_118 ( V_55 -> V_253 ) -> V_308 ) {
case V_79 :
default:
V_55 -> V_78 = V_79 ;
break;
...
if ( ( V_59 = F_104 ( V_55 ) ) < 0 ||
( V_59 = F_117 ( V_55 ) ) < 0 )
goto V_309;
F_129 ( V_55 ) ;
V_59 = F_130 ( V_37 -> V_108 , V_310 , V_55 , & V_304 ) ;
if ( V_59 < 0 )
goto V_309;
if ( F_131 ( & V_37 -> V_311 ) &&
! F_132 ( V_37 -> V_108 , L_82 , & V_265 ) )
F_133 ( V_265 , V_37 , F_110 ) ;
F_134 ( & V_55 -> V_105 , & V_37 -> V_311 ) ;
return 0 ;
V_309:
F_101 ( V_55 ) ;
return V_59 ;
}
void F_135 ( struct V_107 * V_55 )
{
F_136 ( V_55 -> V_245 ) ;
F_136 ( V_55 -> V_247 ) ;
}
static void F_137 ( struct V_107 * V_55 )
{
F_136 ( V_55 -> V_245 ) ;
F_136 ( V_55 -> V_247 ) ;
}
static int F_138 ( struct V_107 * V_55 )
{
int V_59 ;
if ( V_55 -> V_245 ) {
V_59 = F_116 ( V_55 -> V_245 , V_312 ) ;
if ( V_59 < 0 )
return V_59 ;
}
return 0 ;
}
int F_139 ( struct V_107 * V_55 )
{
F_137 ( V_55 ) ;
return 0 ;
}
...
int F_141 ( struct V_107 * V_55 , bool V_313 )
{
struct V_104 * V_105 ;
int V_8 , V_59 ;
if ( V_313 ) {
