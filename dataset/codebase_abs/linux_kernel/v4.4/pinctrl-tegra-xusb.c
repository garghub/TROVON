...
static const char * F_33 ( const char * V_53 )
{
...
continue;
V_3 = F_32 ( V_24 ) ;
F_35 ( V_53 , L_4 , F_33 ( V_31 [ V_21 ] . V_12 ) ,
V_3 ) ;
}
}
static void
...
static int F_43 ( struct V_62 * V_62 )
{
...
static int F_49 ( struct V_62 * V_62 )
{
struct V_1 * V_2 = F_44 ( V_62 ) ;
T_1 V_3 ;
V_3 = F_3 ( V_2 , V_65 ) ;
...
static struct V_62 * F_52 ( struct V_83 * V_50 ,
struct V_84 * args )
{
...
struct V_62 * V_62 ;
int V_29 ;
V_2 = F_56 ( & V_89 -> V_50 , sizeof( * V_2 ) , V_94 ) ;
if ( ! V_2 )
return - V_95 ;
F_57 ( V_89 , V_2 ) ;
F_58 ( & V_2 -> V_56 ) ;
V_2 -> V_50 = & V_89 -> V_50 ;
V_91 = F_59 ( V_96 , V_89 -> V_50 . V_97 ) ;
V_2 -> V_8 = V_91 -> V_98 ;
V_93 = F_60 ( V_89 , V_99 , 0 ) ;
V_2 -> V_5 = F_61 ( & V_89 -> V_50 , V_93 ) ;
if ( F_62 ( V_2 -> V_5 ) )
return F_63 ( V_2 -> V_5 ) ;
V_2 -> V_100 = F_64 ( & V_89 -> V_50 , NULL ) ;
if ( F_62 ( V_2 -> V_100 ) )
return F_63 ( V_2 -> V_100 ) ;
V_29 = F_65 ( V_2 -> V_100 ) ;
if ( V_29 < 0 )
return V_29 ;
memset ( & V_2 -> V_13 , 0 , sizeof( V_2 -> V_13 ) ) ;
V_2 -> V_13 . V_12 = F_66 ( V_2 -> V_50 ) ;
V_2 -> V_13 . V_11 = V_101 ;
...
V_2 -> V_7 = F_67 ( & V_2 -> V_13 , & V_89 -> V_50 , V_2 ) ;
if ( F_62 ( V_2 -> V_7 ) ) {
F_30 ( & V_89 -> V_50 , L_7 ) ;
V_29 = F_63 ( V_2 -> V_7 ) ;
goto V_111;
}
V_62 = F_68 ( & V_89 -> V_50 , NULL , & V_112 ) ;
if ( F_62 ( V_62 ) ) {
V_29 = F_63 ( V_62 ) ;
goto V_113;
}
V_2 -> V_87 [ V_114 ] = V_62 ;
F_69 ( V_62 , V_2 ) ;
V_62 = F_68 ( & V_89 -> V_50 , NULL , & V_115 ) ;
if ( F_62 ( V_62 ) ) {
V_29 = F_63 ( V_62 ) ;
goto V_113;
}
V_2 -> V_87 [ V_116 ] = V_62 ;
F_69 ( V_62 , V_2 ) ;
V_2 -> V_117 = F_70 ( & V_89 -> V_50 ,
F_52 ) ;
if ( F_62 ( V_2 -> V_117 ) ) {
V_29 = F_63 ( V_2 -> V_117 ) ;
F_30 ( & V_89 -> V_50 , L_8 , V_29 ) ;
goto V_113;
}
return 0 ;
V_113:
