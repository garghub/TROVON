...
static int
F_90 ( struct V_85 * V_195 , struct V_53 * V_42 ,
...
static int
F_91 ( struct V_85 * V_195 , struct V_53 * V_42 ,
const struct V_58 * V_59 ,
...
if ( V_198 [ V_218 ] ) {
T_6 V_50 = F_107 ( V_198 [ V_218 ] ) ;
F_41 ( V_9 , F_106 ( V_50 ) ) ;
}
if ( V_198 [ V_219 ] ) {
T_6 V_35 = F_107 ( V_198 [ V_219 ] ) ;
F_40 ( V_9 , F_106 ( V_35 ) ) ;
}
if ( V_198 [ V_220 ] ) {
T_6 V_51 = F_107 ( V_198 [ V_220 ] ) ;
F_42 ( V_9 , F_106 ( V_51 ) ) ;
}
if ( V_198 [ V_209 ] )
F_43 ( V_9 , V_52 ) ;
...
static struct V_192 * F_108 ( struct V_2 * V_2 , struct V_221 * V_222 )
{
struct V_1 * log ;
if ( ! V_222 )
return NULL ;
...
static struct V_192 * F_112 ( struct V_2 * V_2 , struct V_221 * V_222 ,
struct V_192 * V_224 )
{
V_224 = F_110 ( F_113 ( V_224 ) ) ;
while ( ! V_224 ) {
struct V_1 * log ;
struct V_7 * V_8 ;
if ( ++ V_222 -> V_223 >= V_5 )
...
V_224 = F_110 ( F_111 ( V_8 ) ) ;
}
return V_224 ;
}
static struct V_192 * F_114 ( struct V_2 * V_2 , struct V_221 * V_222 ,
T_9 V_225 )
{
struct V_192 * V_8 ;
V_8 = F_108 ( V_2 , V_222 ) ;
if ( V_8 )
while ( V_225 && ( V_8 = F_112 ( V_2 , V_222 , V_8 ) ) )
V_225 -- ;
return V_225 ? NULL : V_8 ;
}
static void * F_115 ( struct V_226 * V_227 , T_9 * V_225 )
__acquires( T_10 )
{
F_9 () ;
return F_114 ( F_116 ( V_227 ) , V_227 -> V_228 , * V_225 ) ;
}
static void * F_117 ( struct V_226 * V_227 , void * V_229 , T_9 * V_225 )
{
( * V_225 ) ++ ;
return F_112 ( F_116 ( V_227 ) , V_227 -> V_228 , V_229 ) ;
}
static void F_118 ( struct V_226 * V_227 , void * V_229 )
__releases( T_10 )
{
F_11 () ;
}
static int F_119 ( struct V_226 * V_227 , void * V_229 )
{
...
static int F_122 ( struct V_230 * V_230 , struct V_140 * V_140 )
{
return F_123 ( V_230 , V_140 , & V_231 ,
sizeof( struct V_221 ) ) ;
}
...
static void T_12 F_128 ( struct V_2 * V_2 )
{
#ifdef F_126
F_129 ( L_5 , V_2 -> V_232 . V_233 ) ;
#endif
F_130 ( V_2 , & V_205 ) ;
}
