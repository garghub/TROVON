...
static void F_68 ( struct V_210 * V_207 )
{
struct V_42 * V_43 = F_69 ( V_207 ) ;
...
int V_116 ;
V_116 = F_77 ( & V_43 -> V_212 , V_43 -> type , ! V_213 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_78 ( V_43 ) ;
if ( V_116 < 0 ) {
...
if ( F_89 ( & V_35 -> V_208 ) < 0 )
goto error;
V_35 -> V_207 . V_208 = & V_35 -> V_208 ;
#endif
if ( F_90 ( & V_53 -> V_35 , & V_35 -> V_207 ) < 0 )
goto error;
if ( F_91 ( V_35 ) < 0 )
goto error;
if ( F_54 ( V_35 ) < 0 )
...
static void F_95 ( struct V_52 * V_53 )
{
struct V_34 * V_35 = F_96 ( V_53 ) ;
F_92 ( V_53 , NULL ) ;
if ( V_53 -> V_54 -> V_7 . V_117 ==
V_118 )
return;
...
static int F_97 ( struct V_52 * V_53 , T_7 V_243 )
{
struct V_34 * V_35 = F_96 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_244 , L_113 ,
...
static int F_102 ( struct V_52 * V_53 , int V_247 )
{
struct V_34 * V_35 = F_96 ( V_53 ) ;
struct V_42 * V_43 ;
int V_116 = 0 ;
...
F_98 ( & V_35 -> V_231 ) ;
if ( V_35 -> V_246 )
V_116 = F_104 ( V_35 , V_248 ) ;
F_100 ( & V_35 -> V_231 ) ;
return V_116 ;
}
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 ) {
V_116 = F_105 ( V_43 , V_247 ) ;
if ( V_116 < 0 )
F_106 ( & V_43 -> V_212 ,
...
static int F_109 ( char * V_50 , struct V_249 * V_250 )
{
if ( V_251 == V_252 )
...
static int F_110 ( const char * V_253 , struct V_249 * V_250 )
{
