...
return F_55 ( V_3 -> V_101 , V_96 ) ;
}
static int F_56 ( struct V_102 * V_103 )
{
struct V_2 * V_3 = F_57 ( V_103 ) ;
struct V_14 * V_11 ;
int V_36 ;
V_11 = F_4 ( V_3 ,
...
static int F_62 ( struct V_102 * V_103 , unsigned int type )
{
struct V_2 * V_3 = F_57 ( V_103 ) ;
T_2 V_79 = F_63 ( V_103 -> V_105 ) ;
T_3 V_80 = F_64 ( V_103 -> V_105 ) ;
unsigned long V_61 ;
T_2 V_89 ;
T_3 V_106 ;
switch ( type ) {
...
{
struct V_2 * V_3 = F_57 ( V_103 ) ;
T_2 V_123 = F_67 ( V_103 -> V_105 ) ;
T_3 V_124 = F_68 ( V_103 -> V_105 ) ;
F_30 ( 1 << V_124 , V_3 -> V_66 + V_123 ) ;
}
static void F_69 ( struct V_102 * V_103 )
{
struct V_2 * V_3 = F_57 ( V_103 ) ;
T_2 V_79 = F_70 ( V_103 -> V_105 ) ;
T_3 V_125 = F_71 ( V_103 -> V_105 ) ;
unsigned long V_61 ;
T_2 V_38 ;
F_23 ( & V_3 -> V_65 , V_61 ) ;
...
static int F_74 ( struct V_126 * V_103 ,
struct V_27 * V_28 ,
const T_2 * V_127 ,
unsigned int V_128 ,
unsigned long * V_129 ,
unsigned int * V_130 )
{
struct V_2 * V_3 = V_103 -> V_131 ;
struct V_14 * V_17 ;
int V_20 , V_78 ;
if ( V_128 < 3 )
return - V_40 ;
V_78 = V_93 * V_127 [ 0 ] ;
V_20 = V_3 -> V_17 -> V_62 + V_78 + V_127 [ 1 ] ;
...
static void F_75 ( struct V_132 * V_17 )
{
unsigned int V_133 = F_76 ( V_17 ) ;
struct V_134 * V_77 = F_77 ( V_17 ) ;
...
static int F_85 ( struct V_140 * V_141 )
{
struct V_2 * V_3 = F_86 ( V_141 ) ;
int V_5 ;
V_3 -> V_6 = V_3 -> V_17 -> V_18 ;
V_3 -> V_8 = F_87 ( & V_141 -> V_39 ,
...
int V_5 , V_36 , V_151 ;
struct V_152 * V_152 ;
V_3 = F_87 ( & V_141 -> V_39 , sizeof( * V_3 ) , V_41 ) ;
if ( ! V_3 )
return - V_42 ;
F_90 ( V_141 , V_3 ) ;
F_91 ( & V_3 -> V_65 ) ;
V_150 = F_92 ( V_141 , V_153 , 0 ) ;
V_3 -> V_66 = F_93 ( & V_141 -> V_39 , V_150 ) ;
if ( F_94 ( V_3 -> V_66 ) )
return F_95 ( V_3 -> V_66 ) ;
V_3 -> V_39 = & V_141 -> V_39 ;
V_3 -> V_17 = V_17 ;
V_3 -> V_104 = F_96 ( & V_141 -> V_39 ,
V_99 * V_3 -> V_17 -> V_136 ,
sizeof( * V_3 -> V_104 ) ,
V_41 ) ;
if ( ! V_3 -> V_104 )
...
V_147 = F_87 ( & V_141 -> V_39 ,
sizeof( * V_147 ) ,
V_41 ) ;
if ( ! V_147 )
return - V_42 ;
V_147 -> V_9 = F_97 ( & V_141 -> V_39 ) ;
V_147 -> V_154 = V_155 ;
V_147 -> V_21 = V_21 ;
...
V_3 -> V_77 = F_87 ( & V_141 -> V_39 , sizeof( * V_3 -> V_77 ) , V_41 ) ;
if ( ! V_3 -> V_77 ) {
V_36 = - V_42 ;
goto V_162;
}
...
V_3 -> V_77 -> V_171 = F_53 ,
V_3 -> V_77 -> V_172 = 3 ,
V_3 -> V_77 -> V_173 = false ,
V_3 -> V_77 -> V_94 = F_99 ( V_151 , V_93 ) -
V_3 -> V_17 -> V_62 ;
V_3 -> V_77 -> V_100 = F_97 ( & V_141 -> V_39 ) ;
...
for ( V_5 = 0 ; V_5 < V_3 -> V_17 -> V_18 ; V_5 ++ ) {
const struct V_19 * V_20 = V_3 -> V_17 -> V_21 + V_5 ;
V_36 = F_101 ( V_3 -> V_77 , F_97 ( & V_141 -> V_39 ) ,
V_20 -> V_20 . V_23 - V_3 -> V_17 -> V_62 ,
V_20 -> V_20 . V_23 , 1 ) ;
if ( V_36 )
goto V_174;
}
V_152 = F_102 ( & V_141 -> V_39 , NULL ) ;
if ( F_94 ( V_152 ) ) {
V_36 = F_95 ( V_152 ) ;
goto V_174;
}
...
V_3 -> V_133 [ V_5 ] = F_104 ( V_141 , V_5 ) ;
if ( V_3 -> V_133 [ V_5 ] < 0 ) {
V_36 = V_3 -> V_133 [ V_5 ] ;
goto V_175;
}
}
V_3 -> V_101 = F_105 ( V_28 ,
V_3 -> V_17 -> V_136 * V_99 ,
& V_176 ,
V_3 ) ;
if ( ! V_3 -> V_101 ) {
