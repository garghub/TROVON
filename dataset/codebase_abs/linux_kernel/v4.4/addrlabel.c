...
{
struct V_1 * V_1 = F_53 ( V_46 -> V_49 ) ;
struct V_50 * V_51 ;
struct V_52 * V_53 [ V_54 + 1 ] ;
struct V_10 * V_55 ;
T_1 V_16 ;
int V_41 = 0 ;
V_41 = F_54 ( V_48 , sizeof( * V_51 ) , V_53 , V_54 , V_56 ) ;
if ( V_41 < 0 )
return V_41 ;
V_51 = F_55 ( V_48 ) ;
if ( V_51 -> V_57 != V_58 ||
...
! F_58 ( V_1 , V_51 -> V_64 ) )
return - V_24 ;
V_41 = F_36 ( V_1 , V_55 , V_51 -> V_59 ,
V_51 -> V_64 , V_16 ,
V_48 -> V_65 & V_66 ) ;
break;
case V_67 :
V_41 = F_43 ( V_1 , V_55 , V_51 -> V_59 ,
V_51 -> V_64 ) ;
break;
default:
V_41 = - V_68 ;
...
unsigned int V_74 )
{
struct V_47 * V_48 = F_61 ( V_46 , V_72 , V_37 , V_73 ,
sizeof( struct V_50 ) , V_74 ) ;
if ( ! V_48 )
return - V_75 ;
F_59 ( V_48 , V_5 -> V_15 , V_5 -> V_13 , V_69 ) ;
if ( F_62 ( V_46 , V_60 , & V_5 -> V_14 ) < 0 ||
F_63 ( V_46 , V_61 , V_5 -> V_16 ) < 0 ) {
F_64 ( V_46 , V_48 ) ;
return - V_75 ;
}
F_65 ( V_46 , V_48 ) ;
...
static int F_66 ( struct V_45 * V_46 , struct V_76 * V_77 )
{
struct V_1 * V_1 = F_53 ( V_46 -> V_49 ) ;
struct V_2 * V_5 ;
...
{
return F_69 ( sizeof( struct V_50 ) )
+ F_70 ( 16 )
+ F_70 ( 4 ) ;
}
static int F_71 ( struct V_45 * V_83 , struct V_47 * V_48 )
{
struct V_1 * V_1 = F_53 ( V_83 -> V_49 ) ;
struct V_50 * V_51 ;
struct V_52 * V_53 [ V_54 + 1 ] ;
struct V_10 * V_11 ;
T_1 V_69 ;
...
V_11 = F_56 ( V_53 [ V_60 ] ) ;
F_18 () ;
V_5 = F_15 ( V_1 , V_11 , F_22 ( V_11 ) , V_51 -> V_64 ) ;
if ( V_5 && ! F_7 ( V_5 ) )
V_5 = NULL ;
V_69 = V_35 . V_37 ;
F_19 () ;
...
V_41 = F_60 ( V_46 , V_5 , V_69 ,
F_67 ( V_83 ) . V_72 , V_48 -> V_80 ,
V_63 , 0 ) ;
F_9 ( V_5 ) ;
if ( V_41 < 0 ) {
F_73 ( V_41 == - V_75 ) ;
...
V_41 = F_75 ( V_46 , V_1 , F_67 ( V_83 ) . V_72 ) ;
V_34:
return V_41 ;
}
void T_4 F_76 ( void )
