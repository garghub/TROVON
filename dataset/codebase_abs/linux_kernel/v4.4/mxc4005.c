...
return - V_24 ;
V_2 = & V_60 -> V_2 ;
V_62 = F_29 ( V_2 , L_7 , 0 , V_63 ) ;
if ( F_30 ( V_62 ) ) {
F_5 ( V_2 , L_8 ) ;
return F_31 ( V_62 ) ;
}
V_16 = F_32 ( V_62 ) ;
F_33 ( V_2 , L_9 , F_34 ( V_62 ) , V_16 ) ;
return V_16 ;
}
...
struct V_17 * V_17 ;
int V_16 ;
V_29 = F_37 ( & V_60 -> V_2 , sizeof( * V_15 ) ) ;
if ( ! V_29 )
return - V_66 ;
V_17 = F_38 ( V_60 , & V_67 ) ;
if ( F_30 ( V_17 ) ) {
...
if ( V_60 -> V_44 < 0 )
V_60 -> V_44 = F_28 ( V_60 , V_15 ) ;
if ( V_60 -> V_44 > 0 ) {
V_15 -> V_58 = F_42 ( & V_60 -> V_2 ,
L_15 ,
V_29 -> V_74 ,
V_29 -> V_65 ) ;
if ( ! V_15 -> V_58 )
return - V_66 ;
V_16 = F_43 ( & V_60 -> V_2 , V_60 -> V_44 ,
V_81 ,
NULL ,
V_82 |
V_83 ,
