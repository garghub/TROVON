...
if ( ! ( V_6 = V_1 ( V_3 ) ) )
return - V_76 ;
if ( args -> V_105 . V_110 != ~ 0ULL ) {
if ( ! ( V_35 = V_34 ( V_6 , args -> V_105 . V_110 ) ) )
return - V_73 ;
args -> V_105 . V_12 = F_45 ( & V_35 -> V_35 -> V_111 ) ;
args -> V_105 . V_112 = V_113 ;
return 0 ;
}
...
if ( F_34 ( ! V_6 ) )
return - V_76 ;
V_35 = V_34 ( V_6 , V_115 -> V_77 ) ;
if ( ! V_35 )
return F_8 ( V_6 , - V_116 ) ;
F_14 ( V_6 , V_35 ) ;
return F_8 ( V_6 , 0 ) ;
}
int
...
if ( ! V_35 )
return F_8 ( V_6 , - V_116 ) ;
V_15 = F_48 ( & V_35 -> V_35 -> V_111 , & V_120 ) ;
if ( V_15 < 0 )
return F_8 ( V_6 , V_15 ) ;
if ( ( V_75 -> V_123 & 0x00ff ) == 0x006e ) {
for ( V_122 = 0 ; ! V_121 && V_122 < V_15 ; V_122 ++ ) {
switch ( V_120 [ V_122 ] . V_121 ) {
case V_22 :
case V_27 :
case V_29 :
case V_33 :
V_121 = V_120 [ V_122 ] . V_121 ;
break;
default:
break;
}
...
if ( ( V_75 -> V_123 & 0x00ff ) == 0x00b1 ) {
for ( V_122 = 0 ; V_122 < V_15 ; V_122 ++ ) {
if ( ( V_120 [ V_122 ] . V_121 & 0x00ff ) == 0x00b1 ) {
V_121 = V_120 [ V_122 ] . V_121 ;
break;
}
}
} else
if ( ( V_75 -> V_123 & 0x00ff ) == 0x00b2 ) {
for ( V_122 = 0 ; V_122 < V_15 ; V_122 ++ ) {
if ( ( V_120 [ V_122 ] . V_121 & 0x00ff ) == 0x00b2 ) {
V_121 = V_120 [ V_122 ] . V_121 ;
break;
}
}
} else
if ( ( V_75 -> V_123 & 0x00ff ) == 0x00b3 ) {
for ( V_122 = 0 ; V_122 < V_15 ; V_122 ++ ) {
if ( ( V_120 [ V_122 ] . V_121 & 0x00ff ) == 0x00b3 ) {
V_121 = V_120 [ V_122 ] . V_121 ;
break;
}
}
...
V_16 -> V_124 = V_125 ;
V_15 = F_50 ( & V_35 -> V_35 -> V_111 , V_75 -> V_95 , V_121 ,
NULL , 0 , & V_37 -> V_12 ) ;
V_16 -> V_124 = V_126 ;
if ( V_15 )
F_10 ( V_35 , V_37 ) ;
...
if ( V_15 )
goto V_83;
args . V_129 = V_37 -> V_39 -> V_130 ;
args . V_131 = V_37 -> V_39 -> V_130 + V_37 -> V_39 -> V_132 - 1 ;
if ( V_9 -> V_19 . V_20 >= V_28 ) {
args . V_133 = V_134 ;
args . V_135 = V_136 ;
args . V_129 += V_35 -> V_42 . V_130 ;
args . V_131 += V_35 -> V_42 . V_130 ;
} else
if ( V_18 -> V_137 . V_138 ) {
args . V_133 = V_139 ;
args . V_135 = V_140 ;
args . V_129 += V_18 -> V_137 . V_11 + V_35 -> V_37 -> V_90 . V_130 ;
args . V_131 += V_18 -> V_137 . V_11 + V_35 -> V_37 -> V_90 . V_130 ;
} else {
args . V_133 = V_134 ;
args . V_135 = V_140 ;
args . V_129 += V_35 -> V_37 -> V_90 . V_130 ;
args . V_131 += V_35 -> V_37 -> V_90 . V_130 ;
}
V_16 -> V_124 = V_125 ;
V_16 -> V_141 = true ;
V_15 = F_50 ( & V_35 -> V_35 -> V_111 , V_19 -> V_95 ,
V_142 , & args , sizeof( args ) ,
& V_37 -> V_12 ) ;
V_16 -> V_141 = false ;
V_16 -> V_124 = V_126 ;
if ( V_15 )
goto V_83;
V_19 -> V_130 = V_37 -> V_39 -> V_130 ;
V_83:
if ( V_15 )
F_10 ( V_35 , V_37 ) ;
return F_8 ( V_6 , V_15 ) ;
...
if ( F_34 ( ! V_6 ) )
return - V_76 ;
V_35 = V_34 ( V_6 , V_144 -> V_77 ) ;
if ( ! V_35 )
return F_8 ( V_6 , - V_73 ) ;
F_15 ( V_35 -> V_35 ) ;
F_42 (ntfy, &chan->notifiers, head) {
if ( V_37 -> V_12 . V_95 == V_144 -> V_95 ) {
F_10 ( V_35 , V_37 ) ;
V_15 = 0 ;
break;
}
