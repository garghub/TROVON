...
const struct V_47 * V_48 , enum V_64 type ,
...
const struct V_47 * V_48 , enum V_64 type ,
enum V_65 V_66 , enum V_68 V_69 , int * V_4 ,
int * V_49 )
{
int V_11 ;
switch ( V_48 -> type ) {
...
static int F_25 ( struct V_70 * V_9 )
{
struct V_71 * V_72 = F_26 ( & V_9 -> V_73 ) ;
struct V_1 * V_2 ;
struct V_5 * V_6 ;
int V_11 ;
V_2 = F_27 ( & V_9 -> V_73 , sizeof( * V_6 ) ) ;
if ( V_2 == NULL ) {
F_28 ( & V_9 -> V_73 , L_1 ) ;
return - V_74 ;
}
