...
static void F_65 ( struct V_126 * V_123 ,
struct V_126 * V_127 , void * V_50 )
{
}
static int F_66 ( struct V_141 * V_142 )
{
struct V_126 * V_123 = & V_142 -> V_123 ;
struct V_1 * V_2 ;
struct V_143 * V_144 = V_123 -> V_145 ;
struct V_146 * V_147 ;
struct V_143 * V_148 ;
int V_70 ;
F_33 ( L_25 , V_149 ) ;
...
if ( ! V_2 )
return - V_150 ;
V_148 = F_67 ( V_142 -> V_123 . V_145 , L_26 , 0 ) ;
if ( V_148 ) {
V_2 -> V_107 = F_68 ( V_148 ) ;
F_69 ( V_148 ) ;
if ( ! V_2 -> V_107 )
return - V_151 ;
}
V_2 -> V_123 = V_142 -> V_123 ;
V_147 = F_70 ( V_142 , V_152 , L_27 ) ;
if ( ! V_147 ) {
F_18 ( L_28 ) ;
V_70 = - V_150 ;
goto V_153;
}
V_2 -> V_4 = F_71 ( V_123 , V_147 -> V_97 , F_72 ( V_147 ) ) ;
if ( ! V_2 -> V_4 ) {
V_70 = - V_150 ;
goto V_153;
}
if ( F_73 ( V_144 , L_29 ) ) {
V_147 = F_70 ( V_142 , V_152 ,
L_30 ) ;
if ( ! V_147 ) {
F_18 ( L_31 ) ;
V_70 = - V_150 ;
...
V_2 -> V_154 = F_71 ( V_123 , V_147 -> V_97 ,
F_72 ( V_147 ) ) ;
if ( ! V_2 -> V_154 ) {
V_70 = - V_150 ;
goto V_153;
...
F_74 ( V_156 , V_144 ) -> V_50 ;
V_2 -> V_96 = F_75 ( V_123 , L_32 ) ;
if ( F_76 ( V_2 -> V_96 ) ) {
F_18 ( L_33 ) ;
V_70 = F_77 ( V_2 -> V_96 ) ;
goto V_153;
}
V_2 -> V_95 = F_75 ( V_123 , L_34 ) ;
if ( F_76 ( V_2 -> V_95 ) ) {
F_18 ( L_35 ) ;
V_70 = F_77 ( V_2 -> V_95 ) ;
goto V_153;
}
V_2 -> V_94 = F_75 ( V_123 , L_36 ) ;
if ( F_76 ( V_2 -> V_94 ) ) {
F_18 ( L_37 ) ;
V_70 = F_77 ( V_2 -> V_94 ) ;
goto V_153;
}
V_2 -> V_81 = F_75 ( V_123 , L_38 ) ;
if ( F_76 ( V_2 -> V_81 ) ) {
F_18 ( L_39 ) ;
V_70 = F_77 ( V_2 -> V_81 ) ;
goto V_153;
...
V_2 -> V_10 = F_2 ( V_2 -> V_4 + V_11 ) & V_12 ;
F_78 ( & V_2 -> V_17 ) ;
V_2 -> V_6 = F_79 ( V_142 , L_40 ) ;
V_70 = F_80 ( V_123 , V_2 -> V_6 , F_8 ,
F_5 , V_157 , F_81 ( V_123 ) , V_2 ) ;
if ( V_70 ) {
F_18 ( L_41 ) ;
goto V_153;
}
V_2 -> V_158 = F_82 ( V_123 , L_42 ) ;
if ( ! F_76 ( V_2 -> V_158 ) )
F_83 ( V_2 -> V_158 ) ;
F_84 ( V_142 , V_2 ) ;
return F_85 ( & V_142 -> V_123 , & V_159 ) ;
V_153:
F_86 ( V_2 -> V_107 ) ;
return V_70 ;
}
...
{
struct V_1 * V_2 = F_58 ( & V_142 -> V_123 ) ;
F_86 ( V_2 -> V_107 ) ;
F_88 ( & V_142 -> V_123 , & V_159 ) ;
return 0 ;
}
