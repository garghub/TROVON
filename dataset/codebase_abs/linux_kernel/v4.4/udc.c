...
if ( ! F_82 ( V_4 ) )
return;
F_118 ( & V_4 -> V_241 . V_126 ) ;
if ( V_4 -> V_241 . V_243 -> V_244 == V_245 ) {
V_4 -> V_241 . V_246 = 1 ;
F_116 ( V_4 ) ;
} else if ( V_4 -> V_241 . V_243 -> V_244 == V_247 ) {
V_4 -> V_241 . V_248 = V_249 ;
V_4 -> V_241 . V_243 -> V_244 = V_250 ;
}
F_119 ( & V_4 -> V_241 . V_126 ) ;
}
static int F_120 ( struct V_137 * V_93 )
{
struct V_3 * V_4 = F_55 ( V_93 , struct V_3 , V_93 ) ;
unsigned long V_133 ;
F_57 ( & V_4 -> V_126 , V_133 ) ;
...
static T_5 F_122 ( struct V_3 * V_4 )
{
T_5 V_132 ;
T_1 V_251 ;
if ( V_4 == NULL )
...
V_258 : V_259 ;
if ( V_4 -> V_141 && V_4 -> V_144 -> V_260 ) {
F_51 ( & V_4 -> V_126 ) ;
V_4 -> V_144 -> V_260 ( & V_4 -> V_93 ) ;
F_53 ( & V_4 -> V_126 ) ;
V_4 -> V_141 = 0 ;
}
}
...
{
struct V_263 * V_145 = V_4 -> V_145 ;
struct V_264 * V_265 = & V_4 -> V_210 -> V_266 ;
int V_132 = 0 ;
F_124 ( & V_4 -> V_126 ) ;
V_4 -> V_93 . V_225 = & V_267 ;
V_4 -> V_93 . V_138 = V_139 ;
V_4 -> V_93 . V_268 = V_258 ;
V_4 -> V_93 . V_224 = V_4 -> V_210 -> V_224 ;
V_4 -> V_93 . V_265 = V_265 ;
if ( V_4 -> V_269 && ( V_265 -> V_270 || V_265 -> V_271 ||
V_265 -> V_272 ) )
V_4 -> V_93 . V_269 = 1 ;
F_34 ( & V_4 -> V_93 . V_237 ) ;
V_4 -> V_234 = F_125 ( L_14 , V_145 ,
sizeof( struct V_273 ) ,
64 , V_80 ) ;
if ( V_4 -> V_234 == NULL )
return - V_63 ;
V_4 -> V_65 = F_125 ( L_15 , V_145 ,
sizeof( struct V_66 ) ,
64 , V_80 ) ;
if ( V_4 -> V_65 == NULL ) {
V_132 = - V_63 ;
...
if ( V_132 )
goto V_275;
V_4 -> V_93 . V_276 = & V_4 -> V_143 -> V_74 ;
V_132 = F_126 ( V_145 , & V_4 -> V_93 ) ;
if ( V_132 )
goto F_113;
F_127 ( & V_4 -> V_93 . V_145 ) ;
F_128 ( & V_4 -> V_93 . V_145 ) ;
return V_132 ;
F_113:
F_113 ( V_4 ) ;
V_275:
...
return - V_285 ;
V_282 = F_136 ( V_4 -> V_145 , sizeof( struct V_281 ) , V_235 ) ;
if ( ! V_282 )
return - V_63 ;
V_282 -> V_286 = F_132 ;
V_282 -> V_287 = F_134 ;
