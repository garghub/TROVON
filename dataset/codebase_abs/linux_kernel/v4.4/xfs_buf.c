...
{
ASSERT ( ! ( V_29 & V_107 ) ) ;
ASSERT ( V_2 -> V_19 [ 0 ] . V_41 != V_108 ) ;
V_2 -> V_7 &= ~ ( V_107 | V_34 | V_35 ) ;
V_2 -> V_7 |= V_29 & ( V_109 | V_34 | V_35 ) ;
if ( V_29 & V_34 ) {
F_72 ( V_2 ) ;
return 0 ;
}
...
int error , V_30 ;
struct V_1 * V_2 ;
F_88 ( V_27 , V_108 , V_89 ) ;
V_2 = F_15 ( V_26 , & V_27 , 1 , 0 ) ;
if ( F_17 ( V_2 == NULL ) )
goto V_123;
V_50 = F_86 ( V_89 << V_124 ) >> V_65 ;
error = F_28 ( V_2 , V_50 ) ;
if ( error )
goto V_125;
...
struct V_1 * V_2 )
{
bool V_131 = V_2 -> V_7 & V_109 ;
F_115 ( V_2 , V_49 ) ;
V_2 -> V_7 &= ~ ( V_109 | V_107 | V_35 ) ;
...
if ( ! V_2 -> V_116 && F_1 ( V_2 ) && ( V_2 -> V_7 & V_109 ) )
...
char V_214 [ V_215 ] ;
F_173 ( V_80 -> V_158 , V_214 ) ;
F_68 ( V_80 -> V_47 ,
L_9 ,
V_213 , V_214 ) ;
return - V_216 ;
}
V_80 -> V_217 = F_174 ( V_80 -> V_158 ) ;
V_80 -> V_218 = F_174 ( V_80 -> V_158 ) - 1 ;
return 0 ;
}
STATIC int
F_175 (
...
{
T_11 * V_80 ;
V_80 = F_12 ( sizeof( * V_80 ) , V_221 | V_23 ) ;
V_80 -> V_47 = V_178 ;
V_80 -> V_222 = V_220 -> V_223 ;
V_80 -> V_158 = V_220 ;
V_80 -> V_113 = F_177 ( V_220 ) ;
if ( F_175 ( V_80 , V_220 ) )
goto error;
if ( F_178 ( & V_80 -> V_15 ) )
goto error;
V_80 -> V_209 . V_224 = F_165 ;
V_80 -> V_209 . V_225 = F_163 ;
V_80 -> V_209 . V_226 = V_227 ;
V_80 -> V_209 . V_29 = V_228 ;
F_179 ( & V_80 -> V_209 ) ;
return V_80 ;
error:
F_14 ( V_80 ) ;
...
struct V_193 * V_232 )
{
struct V_1 * V_233 = F_119 ( V_231 , struct V_1 , V_37 ) ;
struct V_1 * V_2 = F_119 ( V_232 , struct V_1 , V_37 ) ;
T_7 V_234 ;
...
F_188 ( & V_2 -> V_37 , V_236 ) ;
F_189 ( V_2 , V_49 ) ;
}
F_190 ( NULL , V_236 , F_184 ) ;
F_140 ( & V_166 ) ;
...
{
F_155 ( V_236 ) ;
return F_185 ( V_235 , & V_236 , false ) ;
}
int
F_192 (
struct V_193 * V_235 )
...
int error = 0 , V_239 ;
struct V_1 * V_2 ;
F_185 ( V_235 , & V_236 , true ) ;
while ( ! F_33 ( & V_236 ) ) {
V_2 = F_158 ( & V_236 , struct V_1 , V_37 ) ;
F_159 ( & V_2 -> V_37 ) ;
F_64 ( V_2 ) ;
V_239 = V_2 -> V_116 ;
F_69 ( V_2 ) ;
