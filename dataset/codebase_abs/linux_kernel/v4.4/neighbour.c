...
T_2 V_261 , T_2 V_179 , int type , int V_160 )
{
struct V_212 * V_213 ;
struct V_262 * V_262 ;
V_213 = F_193 ( V_4 , V_261 , V_179 , type , sizeof( * V_262 ) , V_160 ) ;
if ( V_213 == NULL )
return - V_260 ;
V_262 = F_176 ( V_213 ) ;
F_78 ( & V_11 -> V_17 ) ;
V_262 -> V_263 = V_11 -> V_205 ;
V_262 -> V_264 = 0 ;
V_262 -> V_265 = 0 ;
if ( F_194 ( V_4 , V_266 , V_11 -> V_49 ) ||
F_189 ( V_4 , V_267 , V_11 -> V_268 ) ||
F_187 ( V_4 , V_269 , V_11 -> V_122 ) ||
F_187 ( V_4 , V_270 , V_11 -> V_47 ) ||
F_187 ( V_4 , V_271 , V_11 -> V_46 ) )
goto V_259;
{
unsigned long V_44 = V_28 ;
unsigned int V_272 = V_44 - V_11 -> V_27 ;
unsigned int V_273 = V_44 - V_11 -> V_119 ;
struct V_14 * V_15 ;
struct V_274 V_275 = {
. V_276 = V_11 -> V_85 ,
. V_277 = V_11 -> V_52 ,
. V_278 = F_14 ( & V_11 -> V_45 ) ,
. V_279 = F_195 ( V_272 ) ,
. V_280 = F_195 ( V_273 ) ,
. V_281 = V_11 -> V_43 . V_186 ,
} ;
F_61 () ;
V_15 = F_66 ( V_11 -> V_15 ) ;
V_275 . V_282 = V_15 -> V_71 [ 0 ] ;
V_275 . V_283 = ( ( 1 << V_15 -> V_18 ) - 1 ) ;
F_64 () ;
if ( F_196 ( V_4 , V_284 , sizeof( V_275 ) , & V_275 ) )
goto V_259;
}
{
int V_285 ;
...
F_197 (cpu) {
struct V_199 * V_288 ;
V_288 = F_198 ( V_11 -> V_198 , V_285 ) ;
V_287 . V_289 += V_288 -> V_61 ;
V_287 . V_290 += V_288 -> V_111 ;
V_287 . V_291 += V_288 -> V_79 ;
V_287 . V_292 += V_288 -> V_133 ;
V_287 . V_293 += V_288 -> V_82 ;
V_287 . V_294 += V_288 -> V_83 ;
V_287 . V_295 += V_288 -> V_296 ;
V_287 . V_297 += V_288 -> V_298 ;
V_287 . V_299 += V_288 -> V_118 ;
V_287 . V_300 += V_288 -> V_16 ;
V_287 . V_301 += V_288 -> V_50 ;
}
if ( F_196 ( V_4 , V_302 , sizeof( V_287 ) , & V_287 ) )
goto V_259;
}
F_199 ( V_11 -> V_6 . V_34 ) ;
...
V_262 -> V_264 = 0 ;
V_262 -> V_265 = 0 ;
if ( F_194 ( V_4 , V_266 , V_11 -> V_49 ) < 0 ||
F_185 ( V_4 , V_6 ) < 0 )
goto V_303;
F_79 ( & V_11 -> V_17 ) ;
F_200 ( V_4 , V_213 ) ;
...
static int F_203 ( struct V_3 * V_4 , struct V_212 * V_213 )
{
struct V_84 * V_84 = F_173 ( V_4 -> V_214 ) ;
struct V_10 * V_11 ;
struct V_262 * V_262 ;
struct V_217 * V_226 [ V_304 + 1 ] ;
bool V_305 = false ;
int V_162 , V_306 ;
V_162 = F_181 ( V_213 , sizeof( * V_262 ) , V_226 , V_304 ,
V_307 ) ;
if ( V_162 < 0 )
goto V_303;
if ( V_226 [ V_266 ] == NULL ) {
...
if ( ! V_11 )
continue;
if ( V_262 -> V_263 && V_11 -> V_205 != V_262 -> V_263 )
continue;
if ( F_204 ( V_226 [ V_266 ] , V_11 -> V_49 ) == 0 ) {
V_305 = true ;
break;
}
}
...
F_10 ( & V_11 -> V_17 ) ;
if ( V_226 [ V_238 ] ) {
struct V_217 * V_309 [ V_310 + 1 ] ;
struct V_110 * V_120 ;
int V_13 , V_190 = 0 ;
V_162 = F_205 ( V_309 , V_310 , V_226 [ V_238 ] ,
V_311 ) ;
if ( V_162 < 0 )
goto V_312;
if ( V_309 [ V_239 ] )
V_190 = F_206 ( V_309 [ V_239 ] ) ;
V_120 = F_145 ( V_11 , V_84 , V_190 ) ;
if ( V_120 == NULL ) {
V_162 = - V_108 ;
goto V_312;
}
for ( V_13 = 1 ; V_13 <= V_310 ; V_13 ++ ) {
if ( V_309 [ V_13 ] == NULL )
continue;
switch ( V_13 ) {
case V_242 :
...
V_162 = - V_108 ;
if ( ( V_226 [ V_269 ] || V_226 [ V_270 ] ||
V_226 [ V_271 ] || V_226 [ V_267 ] ) &&
! F_67 ( V_84 , & V_191 ) )
goto V_312;
if ( V_226 [ V_269 ] )
V_11 -> V_122 = F_206 ( V_226 [ V_269 ] ) ;
if ( V_226 [ V_270 ] )
V_11 -> V_47 = F_206 ( V_226 [ V_270 ] ) ;
if ( V_226 [ V_271 ] )
V_11 -> V_46 = F_206 ( V_226 [ V_271 ] ) ;
if ( V_226 [ V_267 ] )
V_11 -> V_268 = F_208 ( V_226 [ V_267 ] ) ;
V_162 = 0 ;
V_312:
F_17 ( & V_11 -> V_17 ) ;
V_303:
...
static int F_209 ( struct V_3 * V_4 , struct V_313 * V_314 )
{
struct V_84 * V_84 = F_173 ( V_4 -> V_214 ) ;
int V_205 , V_306 , V_315 = 0 ;
int V_316 = V_314 -> args [ 0 ] ;
int V_317 = V_314 -> args [ 1 ] ;
struct V_10 * V_11 ;
V_205 = ( (struct V_318 * ) F_176 ( V_314 -> V_213 ) ) -> V_319 ;
for ( V_306 = 0 ; V_306 < V_308 ; V_306 ++ ) {
struct V_110 * V_120 ;
V_11 = V_204 [ V_306 ] ;
if ( ! V_11 )
continue;
if ( V_306 < V_316 || ( V_205 && V_11 -> V_205 != V_205 ) )
continue;
if ( F_192 ( V_4 , V_11 , F_210 ( V_314 -> V_4 ) . V_320 ,
V_314 -> V_213 -> V_321 , V_322 ,
V_323 ) < 0 )
break;
V_315 = 0 ;
V_120 = F_211 ( & V_11 -> V_6 , V_33 ) ;
F_212 (p, &tbl->parms_list, list) {
if ( ! F_67 ( F_146 ( V_120 ) , V_84 ) )
continue;
if ( V_315 < V_317 )
goto V_25;
if ( F_202 ( V_4 , V_11 , V_120 ,
F_210 ( V_314 -> V_4 ) . V_320 ,
V_314 -> V_213 -> V_321 ,
V_322 ,
V_323 ) < 0 )
goto V_62;
...
static int F_213 ( struct V_3 * V_4 , struct V_1 * V_2 ,
T_2 V_261 , T_2 V_179 , int type , unsigned int V_160 )
{
unsigned long V_44 = V_28 ;
struct V_324 V_325 ;
struct V_212 * V_213 ;
struct V_215 * V_216 ;
V_213 = F_193 ( V_4 , V_261 , V_179 , type , sizeof( * V_216 ) , V_160 ) ;
if ( V_213 == NULL )
return - V_260 ;
V_216 = F_176 ( V_213 ) ;
...
if ( V_2 -> V_23 & V_39 ) {
char V_329 [ V_330 ] ;
F_214 ( V_329 , V_2 , V_2 -> V_34 ) ;
if ( F_196 ( V_4 , V_228 , V_2 -> V_34 -> V_166 , V_329 ) < 0 ) {
F_79 ( & V_2 -> V_17 ) ;
goto V_259;
}
}
V_325 . V_331 = F_215 ( V_44 - V_2 -> V_57 ) ;
V_325 . V_332 = F_215 ( V_44 - V_2 -> V_96 ) ;
V_325 . V_333 = F_215 ( V_44 - V_2 -> V_56 ) ;
V_325 . V_334 = F_14 ( & V_2 -> V_22 ) - 1 ;
F_79 ( & V_2 -> V_17 ) ;
if ( F_187 ( V_4 , V_335 , F_14 ( & V_2 -> V_136 ) ) ||
F_196 ( V_4 , V_336 , sizeof( V_325 ) , & V_325 ) )
goto V_259;
F_200 ( V_4 , V_213 ) ;
return 0 ;
V_259:
...
static int F_216 ( struct V_3 * V_4 , struct V_101 * V_229 ,
T_2 V_261 , T_2 V_179 , int type , unsigned int V_160 ,
struct V_10 * V_11 )
{
struct V_212 * V_213 ;
...
static bool F_218 ( struct V_35 * V_34 , int V_340 )
{
struct V_35 * V_341 ;
if ( ! V_340 )
return false ;
V_341 = F_219 ( V_34 ) ;
if ( ! V_341 || V_341 -> V_190 != V_340 )
return true ;
return false ;
}
static bool F_220 ( struct V_35 * V_34 , int V_342 )
{
if ( V_342 && V_34 -> V_190 != V_342 )
return true ;
return false ;
}
...
{
struct V_84 * V_84 = F_173 ( V_4 -> V_214 ) ;
const struct V_212 * V_213 = V_314 -> V_213 ;
struct V_217 * V_226 [ V_227 + 1 ] ;
struct V_1 * V_19 ;
int V_89 , V_109 , V_343 = V_314 -> args [ 1 ] ;
int V_344 , V_345 = V_344 = V_314 -> args [ 2 ] ;
struct V_14 * V_15 ;
int V_346 = 0 , V_342 = 0 ;
unsigned int V_160 = V_323 ;
int V_162 ;
V_162 = F_181 ( V_213 , sizeof( struct V_215 ) , V_226 , V_227 , NULL ) ;
if ( ! V_162 ) {
if ( V_226 [ V_347 ] )
V_342 = F_206 ( V_226 [ V_347 ] ) ;
if ( V_226 [ V_348 ] )
V_346 = F_206 ( V_226 [ V_348 ] ) ;
if ( V_342 || V_346 )
V_160 |= V_349 ;
}
F_61 () ;
V_15 = F_66 ( V_11 -> V_15 ) ;
for ( V_109 = V_343 ; V_109 < ( 1 << V_15 -> V_18 ) ; V_109 ++ ) {
if ( V_109 > V_343 )
V_345 = 0 ;
for ( V_19 = F_66 ( V_15 -> V_21 [ V_109 ] ) , V_344 = 0 ;
V_19 != NULL ;
V_19 = F_66 ( V_19 -> V_25 ) ) {
if ( ! F_67 ( F_68 ( V_19 -> V_34 ) , V_84 ) )
continue;
if ( F_220 ( V_19 -> V_34 , V_342 ) )
continue;
if ( F_218 ( V_19 -> V_34 , V_346 ) )
continue;
if ( V_344 < V_345 )
goto V_25;
if ( F_213 ( V_4 , V_19 , F_210 ( V_314 -> V_4 ) . V_320 ,
V_314 -> V_213 -> V_321 ,
V_339 ,
V_160 ) < 0 ) {
V_89 = - 1 ;
...
struct V_101 * V_19 ;
struct V_84 * V_84 = F_173 ( V_4 -> V_214 ) ;
int V_89 , V_109 , V_343 = V_314 -> args [ 3 ] ;
int V_344 , V_345 = V_344 = V_314 -> args [ 4 ] ;
F_78 ( & V_11 -> V_17 ) ;
for ( V_109 = V_343 ; V_109 <= V_100 ; V_109 ++ ) {
if ( V_109 > V_343 )
V_345 = 0 ;
for ( V_19 = V_11 -> V_103 [ V_109 ] , V_344 = 0 ; V_19 ; V_19 = V_19 -> V_25 ) {
if ( F_75 ( V_19 ) != V_84 )
continue;
if ( V_344 < V_345 )
goto V_25;
if ( F_216 ( V_4 , V_19 , F_210 ( V_314 -> V_4 ) . V_320 ,
V_314 -> V_213 -> V_321 ,
V_339 ,
V_323 , V_11 ) < 0 ) {
F_79 ( & V_11 -> V_17 ) ;
...
static int F_223 ( struct V_3 * V_4 , struct V_313 * V_314 )
{
struct V_10 * V_11 ;
int V_350 , V_205 , V_351 ;
int V_352 = 0 ;
int V_162 ;
V_205 = ( (struct V_318 * ) F_176 ( V_314 -> V_213 ) ) -> V_319 ;
if ( F_174 ( V_314 -> V_213 ) >= sizeof( struct V_215 ) &&
( (struct V_215 * ) F_176 ( V_314 -> V_213 ) ) -> V_224 == V_225 )
V_352 = 1 ;
V_351 = V_314 -> args [ 0 ] ;
for ( V_350 = 0 ; V_350 < V_308 ; V_350 ++ ) {
V_11 = V_204 [ V_350 ] ;
if ( ! V_11 )
continue;
if ( V_350 < V_351 || ( V_205 && V_11 -> V_205 != V_205 ) )
continue;
if ( V_350 > V_351 )
memset ( & V_314 -> args [ 1 ] , 0 , sizeof( V_314 -> args ) -
sizeof( V_314 -> args [ 0 ] ) ) ;
if ( V_352 )
V_162 = F_222 ( V_11 , V_4 , V_314 ) ;
else
V_162 = F_221 ( V_11 , V_4 , V_314 ) ;
if ( V_162 < 0 )
break;
}
V_314 -> args [ 0 ] = V_350 ;
...
void F_224 ( struct V_10 * V_11 , void (* V_314)( struct V_1 * , void * ) , void * V_353 )
{
int V_354 ;
struct V_14 * V_15 ;
F_61 () ;
V_15 = F_66 ( V_11 -> V_15 ) ;
F_225 ( & V_11 -> V_17 ) ;
for ( V_354 = 0 ; V_354 < ( 1 << V_15 -> V_18 ) ; V_354 ++ ) {
struct V_1 * V_19 ;
for ( V_19 = F_66 ( V_15 -> V_21 [ V_354 ] ) ;
V_19 != NULL ;
V_19 = F_66 ( V_19 -> V_25 ) )
V_314 ( V_19 , V_353 ) ;
}
...
int F_228 ( int V_195 , struct V_35 * V_34 ,
const void * V_356 , struct V_3 * V_4 )
{
int V_162 = - V_223 ;
if ( F_229 ( V_195 < V_308 ) ) {
struct V_10 * V_11 ;
struct V_1 * V_2 ;
V_11 = V_204 [ V_195 ] ;
if ( ! V_11 )
goto V_62;
V_2 = F_62 ( V_11 , V_356 , V_34 ) ;
if ( ! V_2 )
V_2 = F_69 ( V_11 , V_356 , V_34 , false ) ;
V_162 = F_184 ( V_2 ) ;
if ( F_183 ( V_2 ) )
goto V_181;
...
static struct V_1 * F_230 ( struct V_358 * V_179 )
{
struct V_359 * V_123 = V_179 -> V_360 ;
struct V_84 * V_84 = F_231 ( V_179 ) ;
struct V_14 * V_15 = V_123 -> V_15 ;
struct V_1 * V_19 = NULL ;
int V_361 = V_123 -> V_361 ;
V_123 -> V_160 &= ~ V_362 ;
for ( V_361 = 0 ; V_361 < ( 1 << V_15 -> V_18 ) ; V_361 ++ ) {
V_19 = F_66 ( V_15 -> V_21 [ V_361 ] ) ;
while ( V_19 ) {
if ( ! F_67 ( F_68 ( V_19 -> V_34 ) , V_84 ) )
goto V_25;
if ( V_123 -> V_363 ) {
T_7 V_364 = 0 ;
void * V_365 ;
V_365 = V_123 -> V_363 ( V_123 , V_19 , & V_364 ) ;
if ( ! V_365 )
goto V_25;
}
if ( ! ( V_123 -> V_160 & V_366 ) )
break;
if ( V_19 -> V_23 & ~ V_40 )
break;
V_25:
...
static struct V_1 * F_232 ( struct V_358 * V_179 ,
struct V_1 * V_19 ,
T_7 * V_367 )
{
struct V_359 * V_123 = V_179 -> V_360 ;
...
struct V_14 * V_15 = V_123 -> V_15 ;
if ( V_123 -> V_363 ) {
void * V_365 = V_123 -> V_363 ( V_123 , V_19 , V_367 ) ;
if ( V_365 )
return V_19 ;
}
V_19 = F_66 ( V_19 -> V_25 ) ;
...
if ( V_19 )
break;
if ( ++ V_123 -> V_361 >= ( 1 << V_15 -> V_18 ) )
break;
V_19 = F_66 ( V_15 -> V_21 [ V_123 -> V_361 ] ) ;
}
if ( V_19 && V_367 )
-- ( * V_367 ) ;
return V_19 ;
}
static struct V_1 * F_233 ( struct V_358 * V_179 , T_7 * V_367 )
{
struct V_1 * V_19 = F_230 ( V_179 ) ;
if ( V_19 ) {
-- ( * V_367 ) ;
while ( * V_367 ) {
V_19 = F_232 ( V_179 , V_19 , V_367 ) ;
if ( ! V_19 )
break;
}
}
return * V_367 ? NULL : V_19 ;
}
static struct V_101 * F_234 ( struct V_358 * V_179 )
{
struct V_359 * V_123 = V_179 -> V_360 ;
struct V_84 * V_84 = F_231 ( V_179 ) ;
...
int V_361 = V_123 -> V_361 ;
V_123 -> V_160 |= V_362 ;
for ( V_361 = 0 ; V_361 <= V_100 ; V_361 ++ ) {
V_229 = V_11 -> V_103 [ V_361 ] ;
...
static struct V_101 * F_235 ( struct V_358 * V_179 ,
struct V_101 * V_229 ,
T_7 * V_367 )
{
struct V_359 * V_123 = V_179 -> V_360 ;
...
while ( ! V_229 ) {
if ( ++ V_123 -> V_361 > V_100 )
break;
V_229 = V_11 -> V_103 [ V_123 -> V_361 ] ;
while ( V_229 && ! F_67 ( F_75 ( V_229 ) , V_84 ) )
V_229 = V_229 -> V_25 ;
if ( V_229 )
break;
...
static struct V_101 * F_236 ( struct V_358 * V_179 , T_7 * V_367 )
{
struct V_101 * V_229 = F_234 ( V_179 ) ;
if ( V_229 ) {
-- ( * V_367 ) ;
while ( * V_367 ) {
V_229 = F_235 ( V_179 , V_229 , V_367 ) ;
if ( ! V_229 )
break;
}
}
return * V_367 ? NULL : V_229 ;
}
static void * F_237 ( struct V_358 * V_179 , T_7 * V_367 )
{
struct V_359 * V_123 = V_179 -> V_360 ;
void * V_89 ;
T_7 V_368 = * V_367 ;
V_89 = F_233 ( V_179 , & V_368 ) ;
if ( ! V_89 && ! ( V_123 -> V_160 & V_369 ) )
V_89 = F_236 ( V_179 , & V_368 ) ;
return V_89 ;
}
void * F_238 ( struct V_358 * V_179 , T_7 * V_367 , struct V_10 * V_11 , unsigned int V_370 )
__acquires( T_8 )
{
struct V_359 * V_123 = V_179 -> V_360 ;
V_123 -> V_11 = V_11 ;
V_123 -> V_361 = 0 ;
V_123 -> V_160 = ( V_370 & ~ V_362 ) ;
F_61 () ;
V_123 -> V_15 = F_66 ( V_11 -> V_15 ) ;
return * V_367 ? F_237 ( V_179 , V_367 ) : V_371 ;
}
void * F_239 ( struct V_358 * V_179 , void * V_365 , T_7 * V_367 )
{
struct V_359 * V_123 ;
void * V_89 ;
if ( V_365 == V_371 ) {
...
V_123 = V_179 -> V_360 ;
if ( ! ( V_123 -> V_160 & V_362 ) ) {
V_89 = F_232 ( V_179 , V_365 , NULL ) ;
if ( V_89 )
goto V_62;
if ( ! ( V_123 -> V_160 & V_369 ) )
V_89 = F_234 ( V_179 ) ;
} else {
F_199 ( V_123 -> V_160 & V_369 ) ;
V_89 = F_235 ( V_179 , V_365 , NULL ) ;
}
V_62:
++ ( * V_367 ) ;
return V_89 ;
}
void F_240 ( struct V_358 * V_179 , void * V_365 )
__releases( T_8 )
{
F_64 () ;
}
static void * F_241 ( struct V_358 * V_179 , T_7 * V_367 )
{
struct V_10 * V_11 = V_179 -> V_360 ;
int V_285 ;
if ( * V_367 == 0 )
return V_371 ;
for ( V_285 = * V_367 - 1 ; V_285 < V_372 ; ++ V_285 ) {
if ( ! F_242 ( V_285 ) )
continue;
* V_367 = V_285 + 1 ;
return F_198 ( V_11 -> V_198 , V_285 ) ;
}
return NULL ;
}
static void * F_243 ( struct V_358 * V_179 , void * V_365 , T_7 * V_367 )
{
struct V_10 * V_11 = V_179 -> V_360 ;
int V_285 ;
for ( V_285 = * V_367 ; V_285 < V_372 ; ++ V_285 ) {
if ( ! F_242 ( V_285 ) )
continue;
* V_367 = V_285 + 1 ;
return F_198 ( V_11 -> V_198 , V_285 ) ;
...
static void F_244 ( struct V_358 * V_179 , void * V_365 )
{
}
static int F_245 ( struct V_358 * V_179 , void * V_365 )
{
struct V_10 * V_11 = V_179 -> V_360 ;
struct V_199 * V_288 = V_365 ;
if ( V_365 == V_371 ) {
F_246 ( V_179 , L_19 ) ;
return 0 ;
}
...
static int F_247 ( struct V_373 * V_373 , struct V_374 * V_374 )
{
int V_66 = F_248 ( V_374 , & V_375 ) ;
if ( ! V_66 ) {
struct V_358 * V_376 = V_374 -> V_377 ;
V_376 -> V_360 = F_249 ( V_373 ) ;
}
return V_66 ;
}
static inline T_3 F_250 ( void )
{
return F_251 ( sizeof( struct V_215 ) )
+ F_252 ( V_330 )
+ F_252 ( V_330 )
+ F_252 ( sizeof( struct V_324 ) )
+ F_252 ( 4 ) ;
}
...
struct V_3 * V_4 ;
int V_162 = - V_90 ;
V_4 = F_253 ( F_250 () , V_54 ) ;
if ( V_4 == NULL )
goto V_303;
V_162 = F_213 ( V_4 , V_19 , 0 , 0 , type , V_160 ) ;
if ( V_162 < 0 ) {
F_163 ( V_162 == - V_260 ) ;
F_2 ( V_4 ) ;
goto V_303;
}
F_254 ( V_4 , V_84 , 0 , V_378 , NULL , V_54 ) ;
return;
V_303:
if ( V_162 < 0 )
F_255 ( V_84 , V_378 , V_162 ) ;
}
void F_256 ( struct V_1 * V_19 )
{
F_4 ( V_19 , V_379 , V_380 ) ;
}
static int F_257 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 , T_3 * V_385 , T_7 * V_386 )
{
int V_65 , V_66 ;
struct V_381 V_387 = * V_382 ;
V_387 . V_388 = & V_389 ;
V_387 . V_390 = & V_391 ;
V_387 . V_392 = & V_65 ;
V_65 = * ( int * ) V_382 -> V_392 / F_188 ( V_243 ) ;
V_66 = F_258 ( & V_387 , V_383 , V_384 , V_385 , V_386 ) ;
if ( V_383 && ! V_66 )
* ( int * ) V_382 -> V_392 = V_65 * F_188 ( V_243 ) ;
return V_66 ;
}
static struct V_110 * F_259 ( struct V_35 * V_34 ,
int V_205 )
{
switch ( V_205 ) {
case V_206 :
...
static void F_262 ( struct V_84 * V_84 , struct V_110 * V_120 ,
int V_195 )
{
struct V_35 * V_34 ;
int V_205 = F_263 ( V_120 ) ;
F_118 () ;
F_264 (net, dev) {
struct V_110 * V_393 =
F_259 ( V_34 , V_205 ) ;
if ( V_393 && ! F_265 ( V_195 , V_393 -> V_394 ) )
V_393 -> V_392 [ V_195 ] = V_120 -> V_392 [ V_195 ] ;
}
F_120 () ;
}
static void F_266 ( struct V_381 * V_382 , int V_383 )
{
struct V_35 * V_34 = V_382 -> V_388 ;
struct V_110 * V_120 = V_382 -> V_390 ;
struct V_84 * V_84 = F_146 ( V_120 ) ;
int V_195 = ( int * ) V_382 -> V_392 - V_120 -> V_392 ;
if ( ! V_383 )
return;
F_267 ( V_195 , V_120 -> V_394 ) ;
if ( ! V_34 )
F_262 ( V_84 , V_120 , V_195 ) ;
}
static int F_268 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 ,
T_3 * V_385 , T_7 * V_386 )
{
struct V_381 V_387 = * V_382 ;
...
int F_269 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 , T_3 * V_385 , T_7 * V_386 )
{
int V_66 = F_270 ( V_382 , V_383 , V_384 , V_385 , V_386 ) ;
F_266 ( V_382 , V_383 ) ;
return V_66 ;
}
int F_271 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 ,
T_3 * V_385 , T_7 * V_386 )
{
int V_66 = F_272 ( V_382 , V_383 , V_384 , V_385 , V_386 ) ;
F_266 ( V_382 , V_383 ) ;
return V_66 ;
}
static int F_273 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 ,
T_3 * V_385 , T_7 * V_386 )
{
int V_66 = F_274 ( V_382 , V_383 , V_384 , V_385 , V_386 ) ;
F_266 ( V_382 , V_383 ) ;
return V_66 ;
}
int F_275 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 ,
T_3 * V_385 , T_7 * V_386 )
{
int V_66 = F_276 ( V_382 , V_383 , V_384 , V_385 , V_386 ) ;
F_266 ( V_382 , V_383 ) ;
return V_66 ;
}
static int F_277 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 ,
T_3 * V_385 , T_7 * V_386 )
{
int V_66 = F_257 ( V_382 , V_383 , V_384 , V_385 , V_386 ) ;
F_266 ( V_382 , V_383 ) ;
return V_66 ;
}
static int F_278 ( struct V_381 * V_382 , int V_383 ,
void T_9 * V_384 ,
T_3 * V_385 , T_7 * V_386 )
{
struct V_110 * V_120 = V_382 -> V_390 ;
int V_66 ;
if ( strcmp ( V_382 -> V_396 , L_22 ) == 0 )
V_66 = F_271 ( V_382 , V_383 , V_384 , V_385 , V_386 ) ;
else if ( strcmp ( V_382 -> V_396 , L_23 ) == 0 )
V_66 = F_275 ( V_382 , V_383 , V_384 , V_385 , V_386 ) ;
else
V_66 = - 1 ;
if ( V_383 && V_66 == 0 ) {
V_120 -> V_121 =
...
int F_279 ( struct V_35 * V_34 , struct V_110 * V_120 ,
T_10 * V_397 )
{
int V_13 ;
struct V_398 * V_350 ;
const char * V_399 ;
char V_400 [ sizeof( L_24 ) + V_401 + V_401 ] ;
char * V_402 ;
V_350 = F_148 ( & V_403 , sizeof( * V_350 ) , V_105 ) ;
if ( ! V_350 )
goto V_162;
for ( V_13 = 0 ; V_13 < V_404 ; V_13 ++ ) {
V_350 -> V_405 [ V_13 ] . V_392 += ( long ) V_120 ;
V_350 -> V_405 [ V_13 ] . V_388 = V_34 ;
V_350 -> V_405 [ V_13 ] . V_390 = V_120 ;
}
if ( V_34 ) {
V_399 = V_34 -> V_406 ;
memset ( & V_350 -> V_405 [ V_404 ] , 0 ,
sizeof( V_350 -> V_405 [ V_404 ] ) ) ;
} else {
struct V_10 * V_11 = V_120 -> V_11 ;
V_399 = L_25 ;
V_350 -> V_405 [ V_404 ] . V_392 = & V_11 -> V_268 ;
V_350 -> V_405 [ V_407 ] . V_392 = & V_11 -> V_122 ;
V_350 -> V_405 [ V_408 ] . V_392 = & V_11 -> V_47 ;
V_350 -> V_405 [ V_409 ] . V_392 = & V_11 -> V_46 ;
}
if ( V_397 ) {
V_350 -> V_405 [ V_410 ] . T_10 = V_397 ;
V_350 -> V_405 [ V_411 ] . T_10 = V_397 ;
V_350 -> V_405 [ V_412 ] . T_10 = V_397 ;
V_350 -> V_405 [ V_413 ] . T_10 = V_397 ;
} else {
V_350 -> V_405 [ V_411 ] . T_10 =
F_278 ;
V_350 -> V_405 [ V_413 ] . T_10 =
F_278 ;
}
if ( F_146 ( V_120 ) -> V_414 != & V_415 )
V_350 -> V_405 [ 0 ] . V_396 = NULL ;
switch ( F_263 ( V_120 ) ) {
case V_206 :
V_402 = L_26 ;
break;
...
snprintf ( V_400 , sizeof( V_400 ) , L_28 ,
V_402 , V_399 ) ;
V_350 -> V_416 =
F_281 ( F_146 ( V_120 ) , V_400 , V_350 -> V_405 ) ;
if ( ! V_350 -> V_416 )
goto free;
V_120 -> V_193 = V_350 ;
return 0 ;
...
void F_282 ( struct V_110 * V_120 )
{
if ( V_120 -> V_193 ) {
struct V_398 * V_350 = V_120 -> V_193 ;
V_120 -> V_193 = NULL ;
F_283 ( V_350 -> V_416 ) ;
F_54 ( V_350 ) ;
}
...
{
F_285 ( V_417 , V_339 , F_180 , NULL , NULL ) ;
F_285 ( V_417 , V_8 , F_172 , NULL , NULL ) ;
F_285 ( V_417 , V_379 , NULL , F_223 , NULL ) ;
F_285 ( V_417 , V_418 , NULL , F_209 ,
NULL ) ;
F_285 ( V_417 , V_419 , F_203 , NULL , NULL ) ;
return 0 ;
}
