...
if ( ( V_3 -> V_104 & V_121 ) && ( V_3 -> V_122 == true ) )
V_3 -> V_25 |= F_43 ( 3 ) ;
else
V_3 -> V_25 &= ~ F_43 ( 3 ) ;
if ( ( V_3 -> V_104 & V_123 ) &&
...
V_3 -> V_25 &= ~ F_43 ( 4 ) ;
if ( ( V_3 -> V_104 & V_125 ) && ( V_3 -> V_126 ) )
V_3 -> V_25 |= F_43 ( 6 ) ;
else
V_3 -> V_25 &= ~ F_43 ( 6 ) ;
if ( ( V_3 -> V_104 & V_127 ) && ( V_3 -> V_128 ) )
V_3 -> V_25 |= F_43 ( 7 ) ;
else
V_3 -> V_25 &= ~ F_43 ( 7 ) ;
...
if ( ( V_104 & F_43 ( 0 ) ) && ( V_3 -> V_134 & F_43 ( 0 ) ) )
V_3 -> V_25 |= F_43 ( 13 ) ;
if ( ( V_104 & F_43 ( 1 ) ) && ( V_3 -> V_134 & F_43 ( 1 ) ) )
V_3 -> V_25 |= F_43 ( 14 ) ;
if ( ( V_3 -> V_104 & V_135 ) &&
( V_3 -> V_136 == true ) )
V_3 -> V_30 |= F_43 ( 11 ) ;
...
V_161 = ( unsigned long ) V_3 -> V_69 [ V_89 ] ;
V_162 = ( unsigned long ) V_3 -> V_69 [ V_89 + 1 ] ;
F_34 ( & V_3 -> V_16 ) ;
return F_45 ( V_98 , V_101 , L_14 , V_161 , V_162 ) ;
}
...
unsigned long V_161 , V_162 ;
struct V_2 * V_3 = F_6 ( V_10 -> V_11 ) ;
if ( sscanf ( V_98 , L_15 , & V_161 , & V_162 ) != 2 )
return - V_92 ;
if ( V_161 > V_162 )
return - V_92 ;
F_32 ( & V_3 -> V_16 ) ;
...
V_3 -> V_69 [ V_89 ] = ( V_160 ) V_161 ;
V_3 -> V_93 [ V_89 ] = V_94 ;
V_3 -> V_69 [ V_89 + 1 ] = ( V_160 ) V_162 ;
V_3 -> V_93 [ V_89 + 1 ] = V_94 ;
if ( V_3 -> V_104 & V_118 )
F_41 ( V_3 , true ) ;
else
...
V_154 = F_45 ( V_98 , V_101 , L_7 , V_99 == V_165 ? L_16 :
( V_99 == V_166 ? L_17 :
( V_99 == V_167 ? L_18 : L_19 ) ) ) ;
F_34 ( & V_3 -> V_16 ) ;
return V_154 ;
}
...
F_32 ( & V_3 -> V_16 ) ;
V_89 = V_3 -> V_90 ;
if ( ! strcmp ( V_157 , L_16 ) )
V_3 -> V_70 [ V_89 ] &= ~ ( F_43 ( 2 ) | F_43 ( 3 ) ) ;
else if ( ! strcmp ( V_157 , L_17 ) ) {
if ( V_3 -> V_71 ) {
...
F_32 ( & V_3 -> V_16 ) ;
V_89 = V_3 -> V_114 ;
V_99 = ( unsigned long ) V_3 -> V_115 [ V_89 ] ;
F_34 ( & V_3 -> V_16 ) ;
return F_45 ( V_98 , V_101 , L_6 , V_99 ) ;
}
...
struct V_2 * V_3 = F_6 ( V_10 -> V_11 ) ;
if ( ! V_3 -> V_126 || ! V_3 -> V_71 )
return - V_92 ;
if ( F_55 ( V_98 , 16 , & V_170 ) )
return - V_92 ;
V_171 = F_120 ( V_170 ) ;
F_32 ( & V_3 -> V_16 ) ;
V_89 = V_3 -> V_114 ;
V_3 -> V_72 [ V_89 ] = ( V_160 ) V_171 ;
V_3 -> V_115 [ V_89 ] = ( V_160 ) V_170 ;
F_34 ( & V_3 -> V_16 ) ;
return V_103 ;
}
...
const char * V_98 , T_4 V_103 )
{
T_1 V_19 , V_172 , V_173 ;
unsigned long V_161 , V_162 , V_174 ;
struct V_2 * V_3 = F_6 ( V_10 -> V_11 ) ;
if ( ! V_3 -> V_126 || ! V_3 -> V_71 )
return - V_92 ;
if ( sscanf ( V_98 , L_15 , & V_161 , & V_162 ) != 2 )
...
break;
case 0x2 :
V_3 -> V_73 = V_161 & 0xFFFF ;
break;
case 0x3 :
V_3 -> V_73 = V_161 & 0xFFFFFF ;
break;
case 0x4 :
V_3 -> V_73 = V_161 ;
break;
...
case 0x6 :
V_3 -> V_73 = V_161 ;
V_3 -> V_75 = V_162 & 0xFFFF ;
break;
case 0x7 :
V_3 -> V_73 = V_161 ;
V_3 -> V_75 = V_162 & 0xFFFFFF ;
break;
case 0x8 :
V_3 -> V_73 = V_161 ;
V_3 -> V_75 = V_162 ;
...
unsigned long V_99 ;
struct V_2 * V_3 = F_6 ( V_10 -> V_11 ) ;
V_99 = ( unsigned long ) V_3 -> V_78 [ V_3 -> V_116 ] ;
return F_45 ( V_98 , V_101 , L_6 , V_99 ) ;
}
...
unsigned long V_99 ;
struct V_2 * V_3 = F_6 ( V_10 -> V_11 ) ;
if ( ! V_3 -> V_128 || ! V_3 -> V_77 )
return - V_92 ;
if ( F_55 ( V_98 , 16 , & V_99 ) )
return - V_92 ;
F_32 ( & V_3 -> V_16 ) ;
V_3 -> V_78 [ V_3 -> V_116 ] = ( V_160 ) V_99 ;
F_34 ( & V_3 -> V_16 ) ;
return V_103 ;
}
...
break;
case 0x2 :
V_3 -> V_79 = V_161 & 0xFFFF ;
break;
case 0x3 :
V_3 -> V_79 = V_161 & 0xFFFFFF ;
break;
case 0x4 :
V_3 -> V_79 = V_161 ;
break;
...
case 0x6 :
V_3 -> V_79 = V_161 ;
V_3 -> V_81 = V_162 & 0xFFFF ;
break;
case 0x7 :
V_3 -> V_79 = V_161 ;
V_3 -> V_81 = V_162 & 0xFFFFFF ;
break;
case 0x8 :
V_3 -> V_79 = V_161 ;
V_3 -> V_81 = V_162 ;
...
static T_3 F_129 ( struct V_95 * V_10 ,
struct V_96 * V_97 , char * V_98 )
{
int V_99 ;
struct V_2 * V_3 = F_6 ( V_10 -> V_11 ) ;
...
struct V_2 * V_3 = V_1 ;
F_9 ( V_3 -> V_4 ) ;
V_175 = F_10 ( V_3 -> V_4 + V_181 ) ;
if ( F_42 ( V_175 , 1 , 1 ) && F_42 ( V_175 , 2 , 2 ) )
V_3 -> V_119 = true ;
else
V_3 -> V_119 = false ;
if ( F_42 ( V_175 , 5 , 5 ) )
...
V_3 -> V_133 = false ;
V_3 -> V_147 = F_42 ( V_175 , 10 , 11 ) ;
V_3 -> V_134 = F_42 ( V_175 , 15 , 16 ) ;
V_3 -> V_131 = F_42 ( V_175 , 24 , 28 ) ;
V_176 = F_10 ( V_3 -> V_4 + V_182 ) ;
V_3 -> V_6 = F_42 ( V_176 , 4 , 11 ) ;
V_177 = F_10 ( V_3 -> V_4 + V_183 ) ;
V_3 -> V_126 = F_42 ( V_177 , 5 , 9 ) ;
V_3 -> V_128 = F_42 ( V_177 , 10 , 14 ) ;
V_3 -> V_184 = F_42 ( V_177 , 25 , 28 ) ;
V_178 = F_10 ( V_3 -> V_4 + V_185 ) ;
V_3 -> V_150 = F_42 ( V_178 , 0 , 11 ) ;
V_3 -> V_152 = F_42 ( V_178 , 16 , 19 ) ;
V_3 -> V_153 = F_42 ( V_178 , 20 , 23 ) ;
if ( F_42 ( V_178 , 24 , 24 ) )
V_3 -> V_145 = true ;
else
V_3 -> V_145 = false ;
...
V_3 -> V_187 = false ;
V_3 -> V_146 = F_42 ( V_178 , 28 , 30 ) ;
if ( F_42 ( V_178 , 31 , 31 ) )
V_3 -> V_142 = true ;
else
V_3 -> V_142 = false ;
V_179 = F_10 ( V_3 -> V_4 + V_188 ) ;
V_3 -> V_68 = F_42 ( V_179 , 0 , 3 ) ;
V_3 -> V_100 = F_42 ( V_179 , 12 , 15 ) ;
V_3 -> V_62 = F_42 ( V_179 , 16 , 19 ) + 1 ;
V_3 -> V_64 = F_42 ( V_179 , 20 , 23 ) ;
V_3 -> V_71 = F_42 ( V_179 , 24 , 27 ) ;
V_3 -> V_77 = F_42 ( V_179 , 28 , 31 ) ;
V_180 = F_10 ( V_3 -> V_4 + V_189 ) ;
V_3 -> V_102 = F_42 ( V_180 , 0 , 8 ) ;
V_3 -> V_190 = F_42 ( V_180 , 16 , 21 ) ;
if ( F_42 ( V_180 , 22 , 22 ) )
V_3 -> V_136 = true ;
else
V_3 -> V_136 = false ;
...
V_3 -> V_138 = false ;
V_3 -> V_50 = F_42 ( V_180 , 25 , 27 ) ;
V_3 -> V_58 = F_42 ( V_180 , 28 , 30 ) ;
F_11 ( V_3 -> V_4 ) ;
}
...
if ( V_3 -> V_68 >= 1 ) {
V_3 -> V_69 [ 0 ] = ( unsigned long ) V_191 ;
V_3 -> V_69 [ 1 ] = ( unsigned long ) V_192 ;
V_3 -> V_93 [ 0 ] = V_94 ;
V_3 -> V_93 [ 1 ] = V_94 ;
}
for ( V_19 = 0 ; V_19 < V_3 -> V_71 ; V_19 ++ ) {
...
static int F_132 ( struct V_193 * V_194 , unsigned long V_195 ,
void * V_196 )
{
unsigned int V_83 = ( unsigned long ) V_196 ;
if ( ! V_197 [ V_83 ] )
goto V_198;
switch ( V_195 & ( ~ V_199 ) ) {
case V_200 :
F_32 ( & V_197 [ V_83 ] -> V_16 ) ;
if ( ! V_197 [ V_83 ] -> V_201 ) {
F_1 ( V_197 [ V_83 ] ) ;
V_197 [ V_83 ] -> V_201 = true ;
}
if ( V_197 [ V_83 ] -> V_14 )
F_14 ( V_197 [ V_83 ] ) ;
F_34 ( & V_197 [ V_83 ] -> V_16 ) ;
break;
case V_202 :
if ( V_197 [ V_83 ] -> V_203 &&
! V_197 [ V_83 ] -> V_86 )
F_133 ( V_197 [ V_83 ] -> V_9 ) ;
break;
case V_204 :
F_32 ( & V_197 [ V_83 ] -> V_16 ) ;
if ( V_197 [ V_83 ] -> V_14 )
...
static int F_134 ( struct V_206 * V_207 , const struct V_208 * V_209 )
{
int V_84 ;
void T_5 * V_4 ;
struct V_95 * V_10 = & V_207 -> V_10 ;
struct V_210 * V_211 = NULL ;
struct V_2 * V_3 ;
struct V_212 * V_213 = & V_207 -> V_213 ;
struct V_214 * V_215 ;
struct V_216 * V_217 = V_207 -> V_10 . V_218 ;
V_215 = F_135 ( V_10 , sizeof( * V_215 ) , V_219 ) ;
if ( ! V_215 )
return - V_220 ;
V_3 = F_135 ( V_10 , sizeof( * V_3 ) , V_219 ) ;
if ( ! V_3 )
return - V_220 ;
if ( V_217 ) {
V_211 = F_136 ( V_10 , V_217 ) ;
if ( F_137 ( V_211 ) )
return F_138 ( V_211 ) ;
V_207 -> V_10 . V_221 = V_211 ;
}
V_3 -> V_10 = & V_207 -> V_10 ;
F_139 ( V_10 , V_3 ) ;
V_4 = F_140 ( V_10 , V_213 ) ;
if ( F_137 ( V_4 ) )
return F_138 ( V_4 ) ;
V_3 -> V_4 = V_4 ;
F_141 ( & V_3 -> V_16 ) ;
V_3 -> V_83 = V_211 ? V_211 -> V_83 : 0 ;
F_39 () ;
V_197 [ V_3 -> V_83 ] = V_3 ;
...
F_35 ( V_10 , L_22 , ( char * ) V_209 -> V_234 ) ;
if ( V_203 ) {
F_133 ( V_3 -> V_9 ) ;
V_3 -> V_203 = true ;
}
