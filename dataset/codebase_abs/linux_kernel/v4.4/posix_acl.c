...
static int
F_62 ( const struct V_97 * V_98 ,
struct V_99 * V_99 , const char * V_100 ,
void * V_77 , T_2 V_19 )
{
struct V_1 * V_8 ;
int error ;
if ( strcmp ( V_100 , L_1 ) != 0 )
return - V_31 ;
if ( ! F_16 ( F_63 ( V_99 ) ) )
return - V_67 ;
if ( F_64 ( V_99 ) )
return - V_67 ;
V_8 = F_15 ( F_63 ( V_99 ) , V_98 -> V_18 ) ;
if ( F_44 ( V_8 ) )
return F_40 ( V_8 ) ;
if ( V_8 == NULL )
return - V_101 ;
...
static int
F_65 ( const struct V_97 * V_98 ,
struct V_99 * V_99 , const char * V_100 ,
const void * V_77 , T_2 V_19 , int V_18 )
{
...
if ( ! V_2 -> V_14 -> V_66 )
return - V_67 ;
if ( V_98 -> V_18 == V_5 && ! F_45 ( V_2 -> V_102 ) )
return V_77 ? - V_60 : 0 ;
if ( ! F_66 ( V_2 ) )
return - V_103 ;
if ( V_77 ) {
...
V_65 = V_2 -> V_14 -> V_66 ( V_2 , V_8 , V_98 -> V_18 ) ;
V_104:
F_12 ( V_8 ) ;
return V_65 ;
}
static T_2
F_67 ( const struct V_97 * V_98 ,
struct V_99 * V_99 , char * V_105 , T_2 V_106 ,
const char * V_100 , T_2 V_107 )
{
const char * V_108 = V_98 -> V_109 ;
T_2 V_19 ;
if ( ! F_16 ( F_63 ( V_99 ) ) )
return 0 ;
V_19 = strlen ( V_108 ) + 1 ;
