...
const void * V_122 , unsigned int * V_123 ,
unsigned int * V_124 , unsigned int V_125 [] , void * V_126 [] )
{
const struct V_113 * V_114 = V_122 ;
struct V_1 * V_1 = F_50 ( V_121 ) ;
unsigned V_45 = V_13 * V_1 -> V_12 * 2 * sizeof( T_3 ) ;
if ( V_121 -> V_127 + * V_123 < 2 )
* V_123 = 2 - V_121 -> V_127 ;
* V_124 = 1 ;
if ( V_114 && V_114 -> V_114 . V_115 . V_117 < V_45 )
return - V_14 ;
V_125 [ 0 ] = V_114 ? V_114 -> V_114 . V_115 . V_117 : V_45 ;
return 0 ;
}
...
static int F_55 ( struct V_120 * V_121 , unsigned int V_131 )
{
struct V_1 * V_1 = F_50 ( V_121 ) ;
if ( V_1 -> V_75 == NULL )
return - V_58 ;
...
V_4 = F_65 ( V_1 -> V_62 , & V_1 -> V_133 ) ;
if ( V_4 < 0 ) {
F_24 ( V_1 -> V_62 , L_8 ) ;
goto V_152;
}
F_40 ( V_1 -> V_106 . V_103 , L_3 , sizeof( V_1 -> V_106 . V_103 ) ) ;
V_1 -> V_106 . V_133 = & V_1 -> V_133 ;
V_1 -> V_106 . V_151 = V_153 ;
V_1 -> V_106 . V_154 = & V_155 ;
V_1 -> V_106 . V_156 = & V_157 ;
V_1 -> V_106 . V_107 = V_158 ;
V_1 -> V_106 . V_159 = & V_1 -> V_134 ;
V_1 -> V_106 . V_150 = & V_1 -> V_135 ;
F_66 ( & V_1 -> V_106 , V_1 ) ;
V_4 = F_67 ( & V_1 -> V_106 , V_160 , - 1 ) ;
if ( V_4 < 0 ) {
F_24 ( V_1 -> V_62 , L_9 ) ;
goto V_161;
}
