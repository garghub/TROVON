...
V_48 = V_2 -> V_48 ;
F_53 ( V_2 , V_8 -> V_44 , V_8 -> V_25 , V_42 >> V_56 ) ;
if ( F_54 ( V_2 , V_11 , V_41 ) < 0 ) {
F_55 ( V_47 >> V_56 ) ;
V_47 = 0 ;
}
V_2 -> V_48 = V_48 ;
...
V_71 = F_60 ( V_72 ) ;
V_43 += V_42 - V_41 ;
if ( V_43 > V_71 && ! F_61 ( V_73 ) )
return F_58 ( - V_74 ) ;
}
if ( ! F_62 ( V_2 , ( V_42 - V_41 ) >> V_56 ) )
return F_58 ( - V_52 ) ;
if ( V_8 -> V_44 & V_59 ) {
...
static unsigned long F_64 ( unsigned long V_3 , unsigned long V_41 ,
unsigned long V_15 , unsigned long V_42 , bool * V_43 )
{
struct V_1 * V_2 = V_65 -> V_2 ;
struct V_7 * V_8 ;
unsigned long V_76 = - V_68 ;
unsigned long V_75 = 0 ;
unsigned long V_77 ;
if ( F_65 ( V_15 ) )
goto V_78;
if ( V_42 > V_79 || V_15 > V_79 - V_42 )
goto V_78;
if ( V_3 + V_41 > V_15 && V_15 + V_42 > V_3 )
goto V_78;
V_76 = F_54 ( V_2 , V_15 , V_42 ) ;
if ( V_76 )
goto V_78;
if ( V_41 >= V_42 ) {
V_76 = F_54 ( V_2 , V_3 + V_42 , V_41 - V_42 ) ;
if ( V_76 && V_41 != V_42 )
goto V_78;
V_41 = V_42 ;
}
V_8 = F_56 ( V_3 , V_41 , V_42 , & V_75 ) ;
if ( F_66 ( V_8 ) ) {
V_76 = F_67 ( V_8 ) ;
goto V_78;
}
...
if ( V_8 -> V_44 & V_81 )
V_77 |= V_82 ;
V_76 = F_68 ( V_8 -> V_25 , V_15 , V_42 , V_8 -> V_54 +
( ( V_3 - V_8 -> V_55 ) >> V_56 ) ,
V_77 ) ;
if ( F_65 ( V_76 ) )
goto V_83;
...
static int F_69 ( struct V_7 * V_8 , unsigned long V_84 )
{
unsigned long V_85 = V_8 -> V_60 + V_84 ;
if ( V_85 < V_8 -> V_60 )
return 0 ;
if ( V_8 -> V_61 && V_8 -> V_61 -> V_55 < V_85 )
return 0 ;
if ( F_68 ( NULL , V_8 -> V_55 , V_85 - V_8 -> V_55 ,
0 , V_80 ) & ~ V_86 )
return 0 ;
return 1 ;
}
