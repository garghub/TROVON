...
if ( ! V_297 )
return - V_300 ;
V_299 = V_152 -> V_20 -> V_20 . V_301 ;
if ( V_299 != V_302 )
V_299 = F_107 ( V_299 ) / 10 ;
memset ( & V_298 , 0 , sizeof( V_298 ) ) ;
V_298 . type = V_303 ;
V_298 . line = V_152 -> V_20 -> V_304 ;
V_298 . V_20 = V_152 -> V_20 -> V_22 ;
V_298 . V_305 = 0 ;
V_298 . V_227 = V_306 | V_307 ;
V_298 . V_308 = V_152 -> V_20 -> V_232 ;
V_298 . V_309 = 9600 ;
V_298 . V_310 = 5 * V_311 ;
V_298 . V_301 = V_299 ;
...
V_324 = F_24 (
V_181 -> V_23 -> V_2 -> V_137 . V_325 ) ;
if ( V_181 -> V_121 > V_326 ) {
if ( V_324 == V_327 ||
V_324 == V_328 ) {
V_181 -> V_319 = true ;
}
}
F_119 ( & V_181 -> V_320 , F_113 ) ;
F_111 ( V_181 ) ;
return 0 ;
}
...
static void F_121 ( struct V_107 * V_23 )
{
...
struct V_45 * V_152 = F_61 ( V_20 ) ;
return sprintf ( V_338 , L_64 , V_152 -> V_250 ) ;
}
static T_8 F_132 ( struct V_42 * V_2 ,
struct V_336 * V_337 , const char * V_339 , T_9 V_230 )
{
struct V_19 * V_20 = F_131 ( V_2 ) ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
unsigned int V_340 = F_133 ( V_339 , NULL , 0 ) ;
...
{
return F_134 ( & V_20 -> V_2 , & V_341 ) ;
}
static int F_129 ( struct V_19 * V_20 )
{
F_135 ( & V_20 -> V_2 , & V_341 ) ;
return 0 ;
}
static int F_136 ( struct V_107 * V_23 , T_10 V_342 )
{
struct V_34 * V_181 = F_79 ( V_23 ) ;
F_122 ( & V_181 -> V_320 ) ;
return 0 ;
