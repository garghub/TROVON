...
static void F_47 ( struct V_64 * V_19 )
{
...
if ( F_49 ( V_66 ) )
break;
V_14 = F_50 ( V_66 -> V_67 , struct V_13 , V_18 ) ;
F_51 ( V_66 -> V_67 ) ;
F_11 ( & V_2 -> V_17 , V_10 ) ;
V_21 = & V_14 -> V_21 ;
...
static T_1 F_52 ( struct V_15 * V_15 , T_1 V_69 , int V_5 )
{
F_53 ( V_69 || V_5 ,
L_23 , V_70 ) ;
return V_15 -> V_71 ;
...
V_2 = F_57 ( sizeof( struct V_1 ) , V_79 ) ;
V_15 -> V_16 = V_2 ;
if ( ! V_2 ) {
F_7 ( V_12
L_25 ,
...
V_2 -> V_8 = F_57 ( sizeof( struct V_34 ) * V_15 -> V_5 ,
V_79 ) ;
if ( ! V_2 -> V_8 ) {
F_7 ( V_12
L_25 ,
...
static void F_66 ( struct V_15 * V_15 , void * V_83 )
{
struct V_1 * V_2 = V_83 ;
F_64 ( V_2 -> V_24 ) ;
F_65 ( V_2 -> V_8 ) ;
