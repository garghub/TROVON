...
if ( V_3 ) {
F_126 ( & V_13 -> signal -> V_121 ) ;
F_127 ( V_13 -> signal ) ;
if ( V_13 -> V_69 )
F_128 ( & V_13 -> signal -> V_122 , V_13 -> V_69 ) ;
}
F_129 ( V_114 , V_3 ) ;
if ( V_3 )
F_130 () ;
...
F_156 ( V_13 -> V_129 ) ;
if ( V_13 -> V_130 . V_131 )
F_157 ( V_13 -> V_130 . V_131 ) ;
F_114 ( V_13 ) ;
F_100 () ;
F_146 () ;
if ( V_13 -> V_132 )
F_158 ( V_133 , V_13 -> V_132 ) ;
F_159 () ;
F_106 ( F_160 ( & V_125 , V_124 ) ) ;
F_119 () ;
F_120 ( & V_13 -> V_118 ) ;
V_13 -> V_134 = V_135 ;
V_13 -> V_62 |= V_136 ;
...
void F_163 ( struct V_137 * V_138 , long V_114 )
{
if ( V_138 )
F_75 ( V_138 ) ;
F_105 ( V_114 ) ;
...
static inline
struct V_56 * F_169 ( struct V_1 * V_81 , enum V_141 type )
{
if ( type != V_5 )
V_81 = V_81 -> V_51 ;
return V_81 -> V_142 [ type ] . V_56 ;
}
static int F_170 ( struct V_143 * V_144 , struct V_1 * V_2 )
{
return V_144 -> V_145 == V_146 ||
F_169 ( V_2 , V_144 -> V_145 ) == V_144 -> V_147 ;
}
static int F_171 ( struct V_143 * V_144 , struct V_1 * V_2 )
{
if ( ! F_170 ( V_144 , V_2 ) )
return 0 ;
if ( ( ( V_2 -> V_54 != V_101 ) ^ ! ! ( V_144 -> V_148 & V_149 ) )
&& ! ( V_144 -> V_148 & V_150 ) )
return 0 ;
return 1 ;
}
static int F_172 ( struct V_143 * V_144 , struct V_1 * V_2 ,
T_2 V_56 , T_3 V_151 , int V_152 , int V_153 )
{
struct V_154 T_4 * V_155 ;
int V_60 = V_144 -> V_156
? F_173 ( V_2 , V_157 , V_144 -> V_156 ) : 0 ;
F_33 ( V_2 ) ;
V_155 = V_144 -> V_158 ;
if ( V_155 ) {
if ( ! V_60 )
V_60 = F_174 ( V_101 , & V_155 -> V_159 ) ;
if ( ! V_60 )
V_60 = F_174 ( 0 , & V_155 -> V_160 ) ;
if ( ! V_60 )
V_60 = F_174 ( ( short ) V_152 , & V_155 -> V_161 ) ;
if ( ! V_60 )
V_60 = F_174 ( V_56 , & V_155 -> V_162 ) ;
if ( ! V_60 )
V_60 = F_174 ( V_151 , & V_155 -> V_163 ) ;
if ( ! V_60 )
V_60 = F_174 ( V_153 , & V_155 -> V_164 ) ;
}
if ( ! V_60 )
V_60 = V_56 ;
return V_60 ;
}
static int F_175 ( struct V_143 * V_144 , struct V_1 * V_2 )
{
int V_134 , V_60 , V_153 ;
T_2 V_56 = F_176 ( V_2 ) ;
T_3 V_151 = F_177 ( F_178 () , F_179 ( V_2 ) ) ;
struct V_154 T_4 * V_155 ;
...
return F_172 ( V_144 , V_2 , V_56 , V_151 , V_152 , V_153 ) ;
}
V_134 = ( F_98 ( V_2 ) && F_7 ( V_2 ) ) ?
V_170 : V_55 ;
if ( F_181 ( & V_2 -> V_52 , V_53 , V_134 ) != V_53 )
return 0 ;
F_55 ( & V_50 ) ;
F_180 () ;
...
V_122 = F_183 ( V_15 -> V_122 , V_15 -> V_183 ) ;
...
F_180 () ;
if ( F_13 ( V_144 -> V_148 & V_166 ) )
return F_172 ( V_144 , V_2 , V_56 , V_151 , V_152 , V_123 ) ;
V_60 = V_144 -> V_156
? F_173 ( V_2 , V_157 , V_144 -> V_156 ) : 0 ;
if ( ! V_60 && V_144 -> V_184 )
V_60 = F_174 ( ( V_123 << 8 ) | 0x7f , V_144 -> V_184 ) ;
V_155 = V_144 -> V_158 ;
if ( ! V_60 && V_155 )
V_60 = F_174 ( V_101 , & V_155 -> V_159 ) ;
if ( ! V_60 && V_155 )
...
static int F_188 ( struct V_143 * V_144 , struct V_1 * V_2 )
{
int V_60 ;
T_2 V_56 ;
T_3 V_151 ;
...
F_33 ( V_2 ) ;
if ( ! V_60 && V_144 -> V_184 )
V_60 = F_174 ( 0xffff , V_144 -> V_184 ) ;
if ( ! V_60 )
V_60 = V_56 ;
} else {
V_60 = F_172 ( V_144 , V_2 , V_56 , V_151 ,
V_194 , V_67 ) ;
F_64 ( V_60 == 0 ) ;
}
return V_60 ;
}
static int F_189 ( struct V_143 * V_144 , int V_102 ,
struct V_1 * V_2 )
{
...
V_195 = F_187 ( V_144 , V_102 , V_2 ) ;
if ( V_195 )
return V_195 ;
return F_188 ( V_144 , V_2 ) ;
}
static int F_193 ( struct V_143 * V_144 , struct V_1 * V_13 )
{
struct V_1 * V_2 ;
F_61 (p, &tsk->children, sibling) {
int V_195 = F_189 ( V_144 , 0 , V_2 ) ;
if ( V_195 )
return V_195 ;
}
return 0 ;
...
int V_195 = F_189 ( V_144 , 1 , V_2 ) ;
if ( V_195 )
return V_195 ;
}
return 0 ;
}
static int F_195 ( T_5 * V_197 , unsigned V_198 ,
...
return 0 ;
return F_196 ( V_197 , V_198 , V_199 , V_200 ) ;
}
void F_197 ( struct V_1 * V_2 , struct V_1 * V_64 )
{
F_198 ( & V_64 -> signal -> V_204 ,
V_205 , 1 , V_2 ) ;
}
static long F_199 ( struct V_143 * V_144 )
{
struct V_1 * V_13 ;
int V_60 ;
F_200 ( V_144 -> V_147 ) ;
F_201 ( & V_144 -> V_201 , F_195 ) ;
V_144 -> V_201 . V_203 = V_61 ;
F_202 ( & V_61 -> signal -> V_204 , & V_144 -> V_201 ) ;
V_47:
V_144 -> V_196 = - V_206 ;
if ( ( V_144 -> V_145 < V_146 ) &&
( ! V_144 -> V_147 || F_203 ( & V_144 -> V_147 -> V_8 [ V_144 -> V_145 ] ) ) )
goto V_207;
F_116 ( V_205 ) ;
F_54 ( & V_50 ) ;
V_13 = V_61 ;
do {
V_60 = F_193 ( V_144 , V_13 ) ;
if ( V_60 )
goto V_208;
