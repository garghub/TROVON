...
if ( type != V_69 )
V_59 = V_59 -> V_71 ;
V_17 = F_70 ( F_71 ( V_59 -> V_62 [ type ] . V_17 ) ) ;
F_72 () ;
return V_17 ;
}
struct V_58 * F_73 ( struct V_17 * V_17 , enum V_47 type )
{
struct V_58 * V_66 ;
F_69 () ;
V_66 = F_59 ( V_17 , type ) ;
...
T_1 F_76 ( struct V_17 * V_17 , struct V_1 * V_9 )
{
struct V_7 * V_7 ;
T_1 V_8 = 0 ;
...
T_1 F_77 ( struct V_17 * V_17 )
{
return F_76 ( V_17 , F_51 ( V_57 ) ) ;
}
T_1 F_78 ( struct V_58 * V_59 , enum V_47 type ,
struct V_1 * V_9 )
{
T_1 V_8 = 0 ;
F_69 () ;
...
if ( type != V_69 )
V_59 = V_59 -> V_71 ;
V_8 = F_76 ( F_71 ( V_59 -> V_62 [ type ] . V_17 ) , V_9 ) ;
}
F_72 () ;
return V_8 ;
}
T_1 F_80 ( struct V_58 * V_72 , struct V_1 * V_9 )
{
return F_76 ( F_81 ( V_72 ) , V_9 ) ;
}
struct V_1 * F_51 ( struct V_58 * V_72 )
{
return F_82 ( F_83 ( V_72 ) ) ;
}
struct V_17 * F_84 ( int V_8 , struct V_1 * V_9 )
{
struct V_17 * V_17 ;
do {
V_17 = F_48 ( V_8 , V_9 ) ;
...
V_55 = F_86 ( L_2 , sizeof( * V_55 ) , 0 , 18 ,
V_74 | V_75 ,
& V_76 , NULL ,
0 , 4096 ) ;
V_73 = 1U << V_76 ;
...
{
F_88 ( V_32 >= V_45 ) ;
V_24 = F_89 ( V_77 , F_90 ( int , V_24 ,
V_78 * F_91 () ) ) ;
V_79 = F_90 ( int , V_79 ,
V_80 * F_91 () ) ;
F_92 ( L_3 , V_24 , V_79 ) ;
V_81 . V_3 [ 0 ] . V_12 = F_11 ( V_26 , V_27 ) ;
F_93 ( 0 , V_81 . V_3 [ 0 ] . V_12 ) ;
