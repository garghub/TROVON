...
memcpy ( F_56 ( V_57 , V_64 ) , V_72 , V_64 ) ;
if ( V_61 )
F_58 ( V_57 , F_29 ( V_83 ) , V_61 ) ;
V_42:
return V_57 ;
}
static int F_59 ( struct V_1 * V_2 , struct V_56 * V_102 )
{
struct V_56 * V_57 ;
struct V_4 * V_5 = ( void * ) & V_2 -> V_6 ;
struct V_36 * V_37 = V_5 -> V_37 ;
...
T_3 * V_63 ;
T_2 V_61 ;
V_110 = F_60 ( V_37 , V_102 ) ;
if ( V_110 < 0 )
goto error;
V_113:
V_103 = F_61 ( V_102 , V_110 ) ;
if ( V_103 < 0 )
goto error;
...
static int F_65 ( struct V_12 * V_8 , T_8 V_123 )
{
int V_28 = - V_34 ;
struct V_1 * V_2 = F_9 ( V_8 ) ;
struct V_4 * V_5 = ( void * ) & V_2 -> V_6 ;
...
static int F_68 ( struct V_12 * V_8 )
{
int V_28 = 0 ;
struct V_1 * V_2 = F_9 ( V_8 ) ;
struct V_4 * V_5 = ( void * ) & V_2 -> V_6 ;
