...
static int
F_115 ( struct V_58 * V_230 , struct V_46 * V_57 ,
...
if ( V_222 [ V_145 ] )
V_37 -> V_57 -> V_144 = F_113 ( F_123 ( V_222 [ V_145 ] ) ) ;
F_33 ( V_37 , V_224 ) ;
}
return 0 ;
}
static struct V_93 * F_124 ( struct V_98 * V_99 ,
const struct V_85 * V_86 ,
const struct V_81 * const V_222 [] ,
struct V_36 * V_37 ,
enum V_95 * V_97 )
...
F_119 ( V_37 -> V_57 ) . V_12 ,
F_125 ( V_86 ) ) ;
return V_94 ;
}
static int
F_126 ( struct V_58 * V_230 , struct V_46 * V_57 ,
const struct V_85 * V_86 ,
const struct V_81 * const V_222 [] )
{
struct V_87 * V_88 = F_60 ( V_86 ) ;
...
if ( V_222 [ V_163 ] ) {
if ( V_99 != NULL )
V_94 = F_124 ( V_99 , V_86 , V_222 , V_37 , & V_97 ) ;
}
if ( V_222 [ V_167 ] ) {
...
static int
F_127 ( struct V_58 * V_230 , struct V_46 * V_57 ,
const struct V_85 * V_86 ,
const struct V_81 * const V_222 [] )
{
return - V_240 ;
...
static int
F_128 ( struct V_58 * V_230 , struct V_46 * V_57 ,
const struct V_85 * V_86 ,
const struct V_81 * const V_222 [] )
{
struct V_87 * V_88 = F_60 ( V_86 ) ;
...
F_102 () ;
V_35 = F_4 ( V_7 , V_4 ) ;
if ( V_35 && V_35 -> V_20 != F_119 ( V_57 ) . V_12 ) {
V_184 = - V_220 ;
goto V_180;
}
if ( V_242 != NULL ) {
...
V_252 = F_63 ( V_222 [ V_250 ] ) ;
F_99 ( V_35 , V_252 -> V_25 ,
F_113 ( V_252 -> V_23 ) ) ;
}
if ( V_222 [ V_253 ] ) {
T_6 * V_21 ;
...
V_50 = F_113 ( F_123 ( V_222 [ V_254 ] ) ) ;
V_255 = F_113 ( F_123 ( V_222 [ V_256 ] ) ) ;
if ( V_50 >= V_257 ) {
V_184 = - V_258 ;
goto V_180;
}
...
static struct V_216 * F_129 ( struct V_259 * V_260 )
{
...
if ( ! F_131 ( & V_7 -> V_11 [ V_262 -> V_264 ] ) )
return V_7 -> V_11 [ V_262 -> V_264 ] . V_265 ;
}
return NULL ;
}
static struct V_216 * F_132 ( struct V_259 * V_260 , struct V_216 * V_13 )
{
struct V_261 * V_262 = V_260 -> V_263 ;
struct V_2 * V_2 = F_130 ( V_260 ) ;
V_13 = V_13 -> V_44 ;
while ( ! V_13 ) {
struct V_1 * V_7 ;
if ( ++ V_262 -> V_264 >= V_5 )
...
static struct V_216 * F_133 ( struct V_259 * V_260 , T_9 V_266 )
{
struct V_216 * V_9 ;
V_9 = F_129 ( V_260 ) ;
if ( V_9 )
while ( V_266 && ( V_9 = F_132 ( V_260 , V_9 ) ) )
V_266 -- ;
return V_266 ? NULL : V_9 ;
}
static void * F_134 ( struct V_259 * V_267 , T_9 * V_266 )
__acquires( nfnl_queue_pernet( seq_file_net( V_267 )
static void * F_135 ( struct V_259 * V_267 , void * V_268 , T_9 * V_266 )
{
( * V_266 ) ++ ;
return F_132 ( V_267 , V_268 ) ;
}
static void F_136 ( struct V_259 * V_267 , void * V_268 )
__releases( nfnl_queue_pernet( seq_file_net( V_267 )
static int F_137 ( struct V_259 * V_267 , void * V_268 )
{
...
static int F_139 ( struct V_269 * V_269 , struct V_63 * V_63 )
{
return F_140 ( V_269 , V_63 , & V_270 ,
sizeof( struct V_261 ) ) ;
}
