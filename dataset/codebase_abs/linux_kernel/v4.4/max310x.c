...
{
unsigned int V_7 ;
struct V_4 * V_5 = F_44 ( V_197 , struct V_4 , V_199 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
V_7 = F_1 ( V_2 , V_40 ) ;
return ! ! ( ( V_7 >> 4 ) & ( 1 << ( V_198 % 4 ) ) ) ;
}
static void F_71 ( struct V_196 * V_197 , unsigned V_198 , int V_200 )
{
struct V_4 * V_5 = F_44 ( V_197 , struct V_4 , V_199 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
...
static int F_72 ( struct V_196 * V_197 , unsigned V_198 )
{
struct V_4 * V_5 = F_44 ( V_197 , struct V_4 , V_199 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
F_6 ( V_2 , V_201 , 1 << ( V_198 % 4 ) , 0 ) ;
return 0 ;
}
static int F_73 ( struct V_196 * V_197 ,
unsigned V_198 , int V_200 )
{
struct V_4 * V_5 = F_44 ( V_197 , struct V_4 , V_199 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
F_6 ( V_2 , V_40 , 1 << ( V_198 % 4 ) ,
V_200 ? 1 << ( V_198 % 4 ) : 0 ) ;
F_6 ( V_2 , V_201 , 1 << ( V_198 % 4 ) ,
1 << ( V_198 % 4 ) ) ;
return 0 ;
}
static int F_74 ( struct V_11 * V_6 , struct V_202 * V_16 ,
struct V_8 * V_8 , int V_107 , unsigned long V_178 )
{
int V_195 , V_12 , V_203 , V_204 , V_54 , V_47 ;
struct V_46 * V_205 , * V_206 ;
struct V_4 * V_5 ;
bool V_55 = false ;
if ( F_75 ( V_8 ) )
return F_76 ( V_8 ) ;
V_5 = F_77 ( V_6 , sizeof( * V_5 ) +
sizeof( struct V_115 ) * V_16 -> V_110 , V_207 ) ;
if ( ! V_5 ) {
F_9 ( V_6 , L_4 ) ;
return - V_208 ;
}
...
unsigned int V_212 = V_195 << 5 ;
F_5 ( V_5 -> V_8 , V_123 + V_212 ,
V_213 ) ;
F_5 ( V_5 -> V_8 , V_123 + V_212 , 0 ) ;
do {
F_3 ( V_5 -> V_8 ,
V_41 + V_212 , & V_12 ) ;
} while ( V_12 != 0x01 );
F_7 ( V_5 -> V_8 , V_28 + V_212 ,
V_214 ,
V_214 ) ;
}
V_47 = F_22 ( V_5 , V_54 , V_55 ) ;
F_82 ( V_6 , L_8 , V_47 ) ;
V_5 -> V_109 . V_215 = V_216 ;
V_5 -> V_109 . V_217 = L_9 ;
V_5 -> V_109 . V_218 = V_219 ;
V_5 -> V_109 . V_220 = V_221 ;
...
#ifdef F_84
V_5 -> V_199 . V_215 = V_216 ;
V_5 -> V_199 . V_6 = V_6 ;
V_5 -> V_199 . V_222 = V_217 ( V_6 ) ;
V_5 -> V_199 . V_223 = F_72 ;
V_5 -> V_199 . V_224 = F_70 ;
V_5 -> V_199 . V_225 = F_73 ;
V_5 -> V_199 . V_226 = F_71 ;
V_5 -> V_199 . V_227 = - 1 ;
V_5 -> V_199 . V_228 = V_16 -> V_110 * 4 ;
V_5 -> V_199 . V_229 = 1 ;
V_12 = F_85 ( & V_5 -> V_199 ) ;
if ( V_12 )
goto V_230;
...
V_5 -> V_100 [ V_195 ] . V_2 . V_68 = V_231 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_178 = V_232 | V_233 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_234 = V_235 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_9 = V_195 * 0x20 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_236 = ( void V_237 * ) ~ 0 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_47 = V_47 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_238 = F_56 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_239 = & V_240 ;
F_4 ( & V_5 -> V_100 [ V_195 ] . V_2 , V_189 , 0 ) ;
F_1 ( & V_5 -> V_100 [ V_195 ] . V_2 , V_33 ) ;
F_6 ( & V_5 -> V_100 [ V_195 ] . V_2 , V_28 ,
V_241 ,
V_241 ) ;
F_87 ( & V_5 -> V_100 [ V_195 ] . V_117 , F_43 ) ;
F_87 ( & V_5 -> V_100 [ V_195 ] . V_122 , F_50 ) ;
F_88 ( & V_5 -> V_109 , & V_5 -> V_100 [ V_195 ] . V_2 ) ;
V_16 -> V_184 ( & V_5 -> V_100 [ V_195 ] . V_2 , 0 ) ;
}
V_12 = F_89 ( V_6 , V_107 , NULL , F_40 ,
V_242 | V_178 , V_217 ( V_6 ) , V_5 ) ;
if ( ! V_12 )
return 0 ;
F_9 ( V_6 , L_11 , V_107 ) ;
F_90 ( & V_5 -> V_106 ) ;
...
#endif
for ( V_195 = 0 ; V_195 < V_5 -> V_109 . V_110 ; V_195 ++ ) {
F_95 ( & V_5 -> V_100 [ V_195 ] . V_117 ) ;
F_95 ( & V_5 -> V_100 [ V_195 ] . V_122 ) ;
F_96 ( & V_5 -> V_109 , & V_5 -> V_100 [ V_195 ] . V_2 ) ;
V_5 -> V_16 -> V_184 ( & V_5 -> V_100 [ V_195 ] . V_2 , 0 ) ;
}
F_90 ( & V_5 -> V_106 ) ;
F_92 ( & V_5 -> V_109 ) ;
...
static int F_97 ( struct V_243 * V_244 )
{
struct V_202 * V_16 ;
...
int V_12 ;
V_244 -> V_245 = 8 ;
V_244 -> V_45 = V_244 -> V_45 ? : V_246 ;
V_244 -> V_247 = V_244 -> V_247 ? : 26000000 ;
V_12 = F_98 ( V_244 ) ;
if ( V_12 )
return V_12 ;
if ( V_244 -> V_6 . V_248 ) {
const struct V_249 * V_250 =
F_99 ( V_251 , & V_244 -> V_6 ) ;
V_16 = (struct V_202 * ) V_250 -> V_252 ;
} else {
const struct V_253 * V_254 = F_100 ( V_244 ) ;
V_16 = (struct V_202 * ) V_254 -> V_255 ;
V_178 = V_256 ;
}
V_257 . V_258 = V_16 -> V_110 * 0x20 - 1 ;
V_8 = F_101 ( V_244 , & V_257 ) ;
return F_74 ( & V_244 -> V_6 , V_16 , V_8 , V_244 -> V_107 , V_178 ) ;
}
static int F_102 ( struct V_243 * V_244 )
{
return F_94 ( & V_244 -> V_6 ) ;
}
