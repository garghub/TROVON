...
! F_1 ( V_2 , V_3 ) ;
if ( V_73 )
F_38 ( V_69 , V_73 , sizeof( V_69 ) ) ;
else
F_39 ( V_2 , V_3 , V_72 , V_69 , sizeof( V_69 ) , NULL ) ;
if ( V_32 )
...
if ( F_41 ( V_72 ) == 1 )
V_41 = F_36 ( V_2 , F_42 ( V_72 ) [ 0 ] ,
V_72 , L_2 ) ;
else
V_41 = F_36 ( V_2 , V_72 -> V_80 [ V_21 ] . V_82 ,
V_72 , L_2 ) ;
} else
V_41 = F_36 ( V_2 , V_72 -> V_80 [ V_21 ] . V_82 , V_72 ,
NULL ) ;
if ( V_41 < 0 )
return V_41 ;
}
for ( V_21 = 0 , V_78 = V_72 -> V_83 ; V_21 < V_72 -> V_84 ; V_21 ++ , V_78 ++ ) {
V_41 = F_36 ( V_2 , * V_78 , V_72 , NULL ) ;
if ( V_41 < 0 )
return V_41 ;
}
...
V_41 = F_36 ( V_2 , V_72 -> V_91 , V_72 , NULL ) ;
if ( V_41 < 0 )
return V_41 ;
V_41 = F_36 ( V_2 , V_72 -> V_92 , V_72 , NULL ) ;
if ( V_41 < 0 )
return V_41 ;
return 0 ;
}
...
void F_44 ( struct V_1 * V_2 , unsigned int V_93 )
{
struct V_17 * V_94 ;
