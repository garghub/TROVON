...
V_4 -> V_47 = 1 ;
F_5 ( & V_4 -> V_6 ) ;
V_2 = F_31 ( sizeof( struct V_46 ) , V_48 ) ;
if ( ! V_2 ) {
F_4 ( & V_4 -> V_6 ) ;
V_4 -> V_47 = 0 ;
F_5 ( & V_4 -> V_6 ) ;
...
int F_33 ( struct V_3 * V_4 , struct V_8 * V_52 ,
int V_53 , int V_54 )
{
struct V_8 * V_13 ;
...
F_5 ( & V_4 -> V_6 ) ;
V_55 = V_53 ? V_57 : V_58 ;
return F_34 ( V_4 , V_13 , V_55 , V_53 , V_54 ) ;
}
int F_35 ( struct V_46 * V_2 )
{
...
F_38 ( V_4 -> V_60 -> V_13 [ V_22 ] ) ;
}
F_38 ( V_4 -> V_60 ) ;
}
static struct V_8 * F_39 ( struct V_3 * V_4 ,
struct V_8 * V_13 ,
struct V_9 * V_10 ) {
if ( V_13 && ! V_4 -> V_62 && ! V_4 -> V_60 &&
V_13 -> V_17 < V_18 )
V_13 = F_40 ( F_41 ( V_10 -> V_11 ) ,
