...
if ( F_27 ( ( void V_51 * ) V_83 , & V_92 , sizeof( V_92 ) ) ) {
F_45 ( L_8 ) ;
F_46 ( V_83 , V_84 ) ;
return;
}
...
if ( V_46 == NULL )
return - V_118 ;
V_120 = snprintf ( V_46 , V_84 , L_24 ) ;
for ( V_29 = 0 ; V_29 < F_12 ( V_30 ) ; V_29 ++ )
V_120 += snprintf ( V_46 + V_120 , V_84 - V_120 , L_25 , V_30 [ V_29 ] ) ;
V_46 [ V_120 ] = '\0' ;
