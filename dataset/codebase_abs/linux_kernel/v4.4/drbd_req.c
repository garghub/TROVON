...
{
F_85 ( & V_2 -> V_182 -> V_183 ) ;
F_103 ( & V_4 -> V_25 , & V_2 -> V_209 . V_210 ) ;
F_103 ( & V_4 -> V_28 ,
& V_2 -> V_211 [ 1 ] ) ;
F_83 ( & V_2 -> V_182 -> V_183 ) ;
F_104 ( V_2 -> V_209 . V_212 , & V_2 -> V_209 . V_213 ) ;
F_15 ( & V_2 -> V_214 ) ;
}
static struct V_3 *
...
static void F_114 ( struct V_1 * V_2 , struct V_225 * V_226 )
{
...
F_85 ( & V_2 -> V_232 ) ;
F_115 (req, tmp, incoming, tl_requests) {
V_231 = F_118 ( V_2 , & V_4 -> V_6 ) ;
if ( V_231 == - V_233 )
break;
if ( V_231 == - V_234 )
V_230 = 1 ;
if ( V_231 )
F_119 ( & V_4 -> V_25 , V_229 ) ;
else
F_119 ( & V_4 -> V_25 , V_228 ) ;
}
F_83 ( & V_2 -> V_232 ) ;
if ( V_230 )
F_15 ( & V_2 -> V_214 ) ;
...
void F_120 ( struct V_1 * V_2 , struct V_225 * V_228 )
{
struct V_3 * V_4 , * V_227 ;
...
break;
F_85 ( & V_2 -> V_182 -> V_183 ) ;
F_123 ( & V_2 -> V_209 . V_210 , & V_239 ) ;
F_83 ( & V_2 -> V_182 -> V_183 ) ;
if ( F_40 ( & V_239 ) )
break;
V_240 = F_117 ( V_2 , & V_239 , & V_238 , & V_237 ) ;
F_123 ( & V_238 , & V_228 ) ;
F_123 ( & V_239 , & V_226 ) ;
if ( ! V_240 )
break;
...
T_2 F_126 ( struct V_241 * V_242 , struct V_11 * V_11 )
{
struct V_1 * V_2 = (struct V_1 * ) V_242 -> V_243 ;
unsigned long V_10 ;
F_127 ( V_242 , & V_11 , V_242 -> V_244 ) ;
V_10 = V_84 ;
...
void F_130 ( unsigned long V_246 )
{
struct V_1 * V_2 = (struct V_1 * ) V_246 ;
struct V_50 * V_51 = F_39 ( V_2 ) -> V_51 ;
struct V_3 * V_247 , * V_248 , * V_249 ;
struct V_96 * V_97 ;
unsigned long V_250 ;
unsigned long V_251 = 0 , V_252 = 0 , V_253 , V_254 ;
unsigned long V_255 ;
F_64 () ;
V_97 = F_65 ( V_51 -> V_96 ) ;
if ( V_97 && V_2 -> V_153 . V_190 >= V_256 )
V_251 = V_97 -> V_257 * V_258 / 10 * V_97 -> V_259 ;
if ( F_71 ( V_2 ) ) {
V_252 = F_65 ( V_2 -> V_90 -> V_198 ) -> V_260 * V_258 / 10 ;
F_26 ( V_2 ) ;
}
F_66 () ;
V_253 = F_131 ( V_252 , V_251 ) ;
if ( ! V_253 )
return;
V_255 = V_84 ;
V_254 = V_255 + V_253 ;
F_85 ( & V_2 -> V_182 -> V_183 ) ;
V_247 = F_132 ( & V_2 -> V_224 [ 0 ] , struct V_3 , V_29 ) ;
V_248 = F_132 ( & V_2 -> V_224 [ 1 ] , struct V_3 , V_29 ) ;
V_249 = V_51 -> V_76 ;
if ( ! V_249 && V_51 -> V_72 && V_51 -> V_72 -> V_261 )
V_249 = V_51 -> V_72 ;
if ( V_249 && V_249 -> V_2 != V_2 )
V_249 = NULL ;
if ( V_249 == NULL && V_248 == NULL && V_247 == NULL )
goto V_222;
V_250 =
( V_248 && V_247 )
? ( F_133 ( V_248 -> V_205 , V_247 -> V_205 )
? V_248 -> V_205 : V_247 -> V_205 )
: V_248 ? V_248 -> V_205
: V_247 ? V_247 -> V_205 : V_255 ;
if ( V_251 && V_249 &&
F_134 ( V_255 , V_249 -> V_261 + V_251 ) &&
! F_135 ( V_255 , V_51 -> V_262 , V_51 -> V_262 + V_251 ) ) {
F_28 ( V_2 , L_17 ) ;
F_136 ( V_51 , F_137 ( V_190 , V_263 ) , V_264 | V_265 ) ;
}
if ( V_252 && V_250 != V_255 &&
F_134 ( V_255 , V_250 + V_252 ) &&
! F_135 ( V_255 , V_2 -> V_266 , V_2 -> V_266 + V_252 ) ) {
F_28 ( V_2 , L_18 ) ;
F_67 ( V_2 , V_267 ) ;
}
V_251 = ( V_251 && V_249 && F_133 ( V_255 , V_249 -> V_261 + V_251 ) )
? V_249 -> V_261 + V_251 : V_255 + V_253 ;
V_252 = ( V_252 && V_250 != V_255 && F_133 ( V_255 , V_250 + V_252 ) )
? V_250 + V_252 : V_255 + V_253 ;
V_254 = F_133 ( V_251 , V_252 ) ? V_251 : V_252 ;
V_222:
F_83 ( & V_2 -> V_182 -> V_183 ) ;
F_138 ( & V_2 -> V_268 , V_254 ) ;
}
