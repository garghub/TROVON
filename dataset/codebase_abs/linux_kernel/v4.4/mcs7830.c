...
static void F_43 ( struct V_14 * V_52 , struct V_73 * V_74 , void * V_5 )
{
struct V_1 * V_2 = F_10 ( V_52 ) ;
V_74 -> V_75 = F_22 ( V_2 ) ;
F_1 ( V_2 , 0 , V_74 -> V_76 , V_5 ) ;
}
static int F_44 ( struct V_1 * V_2 , struct V_77 * V_35 )
{
...
static int F_47 ( struct V_1 * V_2 , struct V_89 * V_90 )
{
T_2 V_91 ;
if ( V_90 -> V_76 < V_2 -> V_52 -> V_92 ) {
F_48 ( & V_2 -> V_35 -> V_2 , L_7 ) ;
return 0 ;
}
F_49 ( V_90 , V_90 -> V_76 - 1 ) ;
V_91 = V_90 -> V_5 [ V_90 -> V_76 ] ;
if ( V_91 != V_93 ) {
F_17 ( & V_2 -> V_35 -> V_2 , L_8 , V_91 ) ;
V_2 -> V_52 -> V_94 . V_95 ++ ;
if ( V_91 & ( V_96
| V_97
| V_98 ) )
...
static int F_54 ( struct V_77 * V_110 )
{
struct V_1 * V_2 = F_55 ( V_110 ) ;
F_38 ( V_2 ) ;
F_56 ( V_110 ) ;
return 0 ;
}
