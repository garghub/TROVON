...
static bool F_81 ( struct V_16 * V_17 , struct V_31 * V_20 )
{
struct V_16 * V_260 ;
if ( V_20 == NULL )
return false ;
V_260 = F_41 ( & V_20 -> V_174 , struct V_16 ,
V_176 ) ;
return ( V_260 == V_17 ) ;
}
static void F_82 ( struct V_1 * V_2 , int V_44 )
{
struct V_16 * V_17 ;
struct V_14 * V_15 ;
T_2 V_201 , V_252 ;
V_15 = V_2 -> V_51 [ V_44 ] ;
V_201 = F_18 ( V_2 -> V_41 + F_83 ( V_44 ) ) ;
V_252 = F_18 ( V_2 -> V_41 + F_78 ( V_44 ) ) ;
if ( ! V_15 ) {
F_19 ( V_2 -> V_13 , L_102 ) ;
F_15 ( V_201 , V_2 -> V_41 + F_83 ( V_44 ) ) ;
return;
}
if ( F_45 ( V_15 ) ) {
F_8 ( V_2 -> V_13 , L_103 ,
...
T_2 V_262 ;
int V_12 ;
V_262 = F_18 ( V_2 -> V_41 + V_263 ) ;
if ( F_17 () ) {
F_8 ( V_2 -> V_13 , L_38 , V_78 ) ;
F_8 ( V_2 -> V_13 , L_106 , V_262 ) ;
}
for ( V_12 = 0 ; V_12 < V_2 -> V_71 -> V_264 ; V_12 ++ ) {
if ( V_262 & ( 1 << V_12 ) )
F_82 ( V_2 , V_12 ) ;
}
}
T_3 F_86 ( struct V_1 * V_2 )
{
T_2 V_265 , V_266 ;
T_3 V_267 = V_268 ;
if ( ! F_87 ( V_2 ) ) {
