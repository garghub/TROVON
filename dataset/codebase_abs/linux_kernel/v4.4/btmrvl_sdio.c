...
T_1 V_144 = 0 , V_145 , V_121 , V_146 , V_132 = 0 ;
T_3 V_147 , V_148 = 0 ;
F_59 ( V_72 ) ;
if ( ! V_2 -> V_149 ) {
F_7 ( L_66 ) ;
...
F_27 ( L_71 , V_152 -> V_157 , V_147 ) ;
V_152 -> V_153 = F_66 ( V_147 + 1 ) ;
V_152 -> V_154 = V_147 ;
if ( ! V_152 -> V_153 ) {
F_7 ( L_72 , V_152 -> V_157 ) ;
goto V_38;
}
V_148 += ( strlen ( L_73 ) +
strlen ( V_152 -> V_157 ) +
...
strcpy ( V_143 , L_73 ) ;
V_143 += strlen ( L_73 ) ;
strcpy ( V_143 , V_152 -> V_157 ) ;
V_143 += strlen ( V_152 -> V_157 ) ;
strcpy ( V_143 , L_74 ) ;
V_143 += strlen ( L_74 ) ;
...
F_67 ( & V_2 -> V_5 -> V_36 , V_142 , V_148 , V_44 ) ;
F_27 ( L_82 ) ;
}
...
struct V_1 * V_2 = NULL ;
F_27 ( L_83 ,
V_161 -> V_162 , V_161 -> V_163 , V_161 -> V_164 , V_5 -> V_114 ) ;
V_2 = F_69 ( & V_5 -> V_36 , sizeof( * V_2 ) , V_44 ) ;
if ( ! V_2 )
return - V_45 ;
V_2 -> V_5 = V_5 ;
if ( V_161 -> V_165 ) {
struct V_166 * V_39 = ( void * ) V_161 -> V_165 ;
V_2 -> V_29 = V_39 -> V_29 ;
V_2 -> V_27 = V_39 -> V_27 ;
V_2 -> V_3 = V_39 -> V_3 ;
V_2 -> V_61 = V_39 -> V_61 ;
V_2 -> V_167 = V_39 -> V_167 ;
...
static int F_75 ( struct V_163 * V_36 )
{
...
F_79 ( V_82 ) ;
F_80 ( & V_72 -> V_102 -> V_181 ) ;
if ( V_72 -> V_102 -> V_182 != V_183 ) {
if ( F_81 ( V_72 ) ) {
F_7 ( L_94 ) ;
return - V_184 ;
}
}
V_72 -> V_102 -> V_185 = true ;
if ( V_72 -> V_102 -> V_182 == V_183 ) {
F_17 ( L_95 ) ;
return F_82 ( V_5 , V_178 ) ;
} else {
F_17 ( L_96 ) ;
return 0 ;
}
}
static int F_83 ( struct V_163 * V_36 )
{
struct V_105 * V_5 = F_76 ( V_36 ) ;
struct V_1 * V_2 ;
struct V_71 * V_72 ;
...
V_72 -> V_172 ( V_72 ) ;
V_72 -> V_102 -> V_182 = V_186 ;
V_82 = V_72 -> V_81 . V_82 ;
F_17 ( L_99 , V_82 -> V_180 ) ;
V_72 -> V_102 -> V_185 = false ;
