...
V_46 = V_13 -> V_46 ;
V_260 = V_46 -> V_261 ;
for ( V_256 = 0 ; V_256 < V_13 -> V_262 ; V_256 ++ ) {
V_258 = & V_260 -> V_263 [ V_256 ] ;
F_86 ( & V_258 -> V_264 ) ;
F_87 ( V_258 ) ;
F_88 ( & V_258 -> V_264 ) ;
}
}
static int F_89 ( struct V_9 * V_10 , int V_265 )
{
int V_71 = 0 ;
unsigned int V_131 ;
struct V_12 * V_13 = V_10 -> V_13 ;
V_131 = F_90 ( V_13 , V_10 -> V_51 , V_265 ) ;
if ( ! V_131 ) {
F_3 ( V_13 , V_25 , V_24 ,
L_67 ,
V_10 -> V_51 ) ;
