...
V_10 -> V_45 = F_31 ( & V_8 -> V_47 , NULL , 0 , V_8 -> V_23 ,
V_25 ) ;
V_10 -> V_44 = ( T_2 ) V_14 -> args [ 0 ] ;
V_14 -> args [ 0 ] = V_10 -> V_45 + V_8 -> V_49 ;
F_5 ( & V_18 -> V_5 , L_14 ,
V_10 -> V_44 , V_10 -> V_45 ) ;
...
F_14 ( V_31 ) ;
if ( F_18 ( V_28 , L_9 , & V_8 -> V_48 ) ) {
F_19 ( & V_18 -> V_5 ,
L_11 ,
V_52 ) ;
V_8 -> V_48 = V_52 ;
}
if ( ! F_18 ( V_28 , L_15 , & V_46 ) )
V_8 -> V_46 = ( T_2 ) V_46 ;
V_33 = F_20 ( V_18 , V_39 , 0 ) ;
V_1 = F_21 ( & V_18 -> V_5 , V_33 ) ;
if ( F_22 ( V_1 ) )
...
const struct V_29 * V_30 ;
int V_35 ;
V_30 = F_17 ( V_54 , V_18 -> V_5 . V_19 ) ;
if ( F_35 ( ! V_30 ) )
return - V_21 ;
switch ( ( T_3 ) V_30 -> V_53 ) {
case V_55 :
V_35 = F_32 ( V_18 ) ;
break;
case V_56 :
