...
static int F_56 ( struct V_144 * V_7 ,
enum V_145 V_52 )
{
...
if ( V_148 == NULL )
return 0 ;
V_151 = F_57 ( & V_7 -> V_8 , sizeof( * V_151 ) , V_155 ) ;
if ( ! V_151 )
return - V_156 ;
...
if ( ! F_61 ( V_147 , L_19 , & V_4 ) ) {
switch ( V_4 ) {
case 0 :
V_151 -> V_161 [ V_12 ] . V_163 =
V_94 ;
break;
case 1 :
V_151 -> V_161 [ V_12 ] . V_163 =
...
if ( ! F_61 ( V_147 , L_25 , & V_4 ) )
V_151 -> V_161 [ V_12 ] . V_35 = V_4 ;
V_151 -> V_161 [ V_12 ] . V_165 =
F_62 ( V_147 , L_26 ) ;
}
V_7 -> V_8 . V_166 = V_151 ;
return 0 ;
...
static int F_56 ( struct V_144 * V_7 , enum V_145 V_52 )
{
return 0 ;
}
static int F_64 ( struct V_144 * V_7 ,
const struct V_167 * V_168 )
{
enum V_145 V_52 = (enum V_145 ) V_168 -> V_169 ;
struct V_150 * V_151 ;
struct V_1 * V_2 ;
struct V_170 V_171 ;
struct V_172 * V_172 ;
...
if ( ! V_151 )
return - V_51 ;
V_2 = F_57 ( & V_7 -> V_8 , sizeof( * V_2 ) , V_155 ) ;
if ( V_2 == NULL ) {
F_3 ( & V_7 -> V_8 , L_27 ) ;
return - V_156 ;
}
...
V_2 -> V_7 = V_7 ;
V_2 -> V_52 = V_52 ;
V_2 -> V_177 = F_66 ( & V_7 -> V_8 , L_28 ) ;
V_2 -> V_178 = F_66 ( & V_7 -> V_8 , L_29 ) ;
if ( F_67 ( V_2 -> V_177 ) == - V_179 ||
F_67 ( V_2 -> V_178 ) == - V_179 )
return - V_179 ;
if ( F_68 ( V_2 -> V_177 ) &&
( V_2 -> V_52 != V_53 || F_68 ( V_2 -> V_178 ) ) ) {
F_3 ( & V_7 -> V_8 , L_30 ) ;
return - V_51 ;
}
V_2 -> V_6 = F_69 ( V_7 , & V_180 ) ;
if ( F_68 ( V_2 -> V_6 ) ) {
F_3 ( & V_7 -> V_8 , L_31 ) ;
return F_67 ( V_2 -> V_6 ) ;
}
...
V_5 = F_29 ( V_2 , V_176 , V_151 -> V_157 [ V_176 ] ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_32 ,
V_176 , V_151 -> V_157 [ V_176 ] ) ;
return V_5 ;
}
}
for ( V_176 = 0 ; V_176 < 8 ; V_176 ++ ) {
V_5 = F_38 ( V_2 , V_176 ,
V_151 -> V_161 [ V_176 ] . V_162 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_33 ,
V_176 , V_151 -> V_161 [ V_176 ] . V_162 ) ;
return V_5 ;
}
V_5 = F_46 ( V_2 , V_176 ,
V_151 -> V_161 [ V_176 ] . V_163 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_34 ,
V_176 , V_151 -> V_161 [ V_176 ] . V_163 ) ;
return V_5 ;
}
V_5 = F_47 ( V_2 , V_176 ,
V_151 -> V_161 [ V_176 ] . V_104 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_35 ,
V_176 , V_151 -> V_161 [ V_176 ] . V_104 ) ;
return V_5 ;
}
V_5 = F_48 ( V_2 , V_176 ,
V_151 -> V_161 [ V_176 ] . V_164 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_36 ,
V_176 , V_151 -> V_161 [ V_176 ] . V_164 ) ;
return V_5 ;
}
}
if ( ! F_68 ( V_2 -> V_177 ) )
...
V_171 . V_185 = 0 ;
if ( ! F_68 ( V_2 -> V_177 ) ) {
V_2 -> V_186 = F_71 ( V_2 -> V_177 ) ;
V_171 . V_173 = & V_2 -> V_186 ;
V_171 . V_174 = 1 ;
}
V_2 -> V_29 . V_171 = & V_171 ;
V_172 = F_72 ( & V_7 -> V_8 , & V_2 -> V_29 ) ;
if ( F_68 ( V_172 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_171 . V_158 ) ;
V_5 = F_67 ( V_172 ) ;
goto V_187;
}
if ( V_2 -> V_52 == V_53 ) {
...
V_171 . V_183 = & V_188 ;
if ( ! F_68 ( V_2 -> V_178 ) ) {
V_2 -> V_189 = F_71 ( V_2 -> V_178 ) ;
V_171 . V_173 = & V_2 -> V_189 ;
V_171 . V_174 = 1 ;
}
V_2 -> V_32 . V_171 = & V_171 ;
V_172 = F_72 ( & V_7 -> V_8 , & V_2 -> V_32 ) ;
if ( F_68 ( V_172 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_171 . V_158 ) ;
V_5 = F_67 ( V_172 ) ;
...
V_174 = ( V_2 -> V_52 == V_53 ) ? 2 : 1 ;
V_173 [ 0 ] = V_182 [ 0 ] ;
V_173 [ 1 ] = V_182 [ 1 ] ;
V_2 -> V_190 [ 0 ] . V_12 = 0 ;
V_2 -> V_190 [ 0 ] . V_2 = V_2 ;
V_2 -> V_190 [ 0 ] . V_28 . V_171 = & V_171 ;
memset ( & V_171 , 0 , sizeof( V_171 ) ) ;
V_171 . V_158 = V_191 [ 0 ] ;
V_171 . V_183 = & V_192 ;
V_171 . V_185 = 0 ;
V_171 . V_173 = V_173 ;
V_171 . V_174 = V_174 ;
V_172 = F_72 ( & V_7 -> V_8 , & V_2 -> V_190 [ 0 ] . V_28 ) ;
if ( F_68 ( V_172 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_171 . V_158 ) ;
V_5 = F_67 ( V_172 ) ;
goto V_187;
...
V_172 = F_72 ( & V_7 -> V_8 , & V_2 -> V_190 [ 1 ] . V_28 ) ;
if ( F_68 ( V_172 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_171 . V_158 ) ;
V_5 = F_67 ( V_172 ) ;
goto V_187;
}
V_175 = ( V_2 -> V_52 == V_160 ) ? 3 : 8 ;
V_173 [ 0 ] = V_191 [ 0 ] ;
if ( V_2 -> V_52 == V_193 )
V_173 [ 1 ] = V_191 [ 2 ] ;
else
V_173 [ 1 ] = V_191 [ 1 ] ;
V_2 -> V_196 = F_57 ( & V_7 -> V_8 , V_175 *
sizeof( * V_2 -> V_196 ) , V_155 ) ;
V_2 -> V_161 = F_57 ( & V_7 -> V_8 , V_175 *
sizeof( * V_2 -> V_161 ) , V_155 ) ;
V_2 -> V_197 . V_198 = V_175 ;
V_2 -> V_197 . V_199 = F_57 ( & V_7 -> V_8 ,
V_175 * sizeof( * V_2 -> V_197 . V_199 ) , V_155 ) ;
if ( F_73 ( ! V_2 -> V_196 || ! V_2 -> V_161 ||
! V_2 -> V_197 . V_199 ) ) {
V_5 = - V_156 ;
goto V_187;
}
for ( V_176 = 0 ; V_176 < V_175 ; V_176 ++ ) {
V_2 -> V_196 [ V_176 ] . V_12 = V_176 ;
V_2 -> V_196 [ V_176 ] . V_2 = V_2 ;
V_2 -> V_196 [ V_176 ] . V_28 . V_171 = & V_171 ;
memset ( & V_171 , 0 , sizeof( V_171 ) ) ;
V_171 . V_158 = V_200 [ V_176 ] ;
V_171 . V_183 = & V_201 ;
V_171 . V_185 = 0 ;
if ( V_151 -> V_161 [ V_176 ] . V_165 )
V_171 . V_185 |= V_87 ;
V_171 . V_173 = V_173 ;
V_171 . V_174 = 2 ;
V_172 = F_72 ( & V_7 -> V_8 , & V_2 -> V_196 [ V_176 ] . V_28 ) ;
if ( F_68 ( V_172 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_171 . V_158 ) ;
V_5 = F_67 ( V_172 ) ;
...
V_174 = ( V_2 -> V_52 == V_53 ) ? 4 : 3 ;
V_173 [ 2 ] = V_182 [ 0 ] ;
V_173 [ 3 ] = V_182 [ 1 ] ;
for ( V_176 = 0 ; V_176 < V_175 ; V_176 ++ ) {
V_173 [ 0 ] = V_200 [ V_176 ] ;
V_173 [ 1 ] = ( V_176 < 4 ) ? V_200 [ 0 ] :
V_200 [ 4 ] ;
V_2 -> V_161 [ V_176 ] . V_12 = V_176 ;
V_2 -> V_161 [ V_176 ] . V_2 = V_2 ;
V_2 -> V_161 [ V_176 ] . V_28 . V_171 = & V_171 ;
memset ( & V_171 , 0 , sizeof( V_171 ) ) ;
V_171 . V_158 = V_202 [ V_176 ] ;
V_171 . V_183 = & V_203 ;
V_171 . V_185 = 0 ;
if ( V_151 -> V_161 [ V_176 ] . V_163 == V_94 )
V_171 . V_185 |= V_87 ;
V_171 . V_173 = V_173 ;
V_171 . V_174 = V_174 ;
V_172 = F_72 ( & V_7 -> V_8 , & V_2 -> V_161 [ V_176 ] . V_28 ) ;
if ( F_68 ( V_172 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_171 . V_158 ) ;
V_5 = F_67 ( V_172 ) ;
...
V_2 -> V_197 . V_199 [ V_176 ] = V_172 ;
if ( V_151 -> V_161 [ V_176 ] . V_35 != 0 ) {
int V_5 ;
V_5 = F_74 ( V_172 , V_151 -> V_161 [ V_176 ] . V_35 ) ;
if ( V_5 != 0 ) {
F_3 ( & V_7 -> V_8 , L_38 ,
V_5 ) ;
}
