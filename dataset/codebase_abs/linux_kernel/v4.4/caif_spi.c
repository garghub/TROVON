...
F_70 ( & V_10 -> V_70 ) ;
F_70 ( & V_10 -> V_61 ) ;
V_10 -> V_76 . V_132 = V_133 ;
V_10 -> V_76 . V_134 = false ;
V_10 -> V_76 . V_135 = false ;
V_10 -> V_76 . V_136 = false ;
V_10 -> V_64 = V_89 ;
}
int F_71 ( struct V_137 * V_41 )
{
struct V_10 * V_10 = NULL ;
struct V_88 * V_64 ;
struct V_138 * V_89 ;
int V_94 ;
V_89 = (struct V_138 * ) V_41 -> V_89 . V_139 ;
if ( ! V_89 )
return - V_105 ;
V_64 = F_72 ( sizeof( struct V_10 ) , L_24 ,
V_140 , F_69 ) ;
if ( ! V_64 )
return - V_141 ;
V_10 = F_44 ( V_64 ) ;
...
V_10 = F_77 ( V_145 , struct V_10 , V_117 ) ;
F_78 ( V_10 -> V_64 ) ;
}
F_79 ( & V_7 . V_8 ,
& V_147 ) ;
