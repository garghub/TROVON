...
V_2 -> V_36 = V_172 ;
F_83 ( V_6 , & V_2 -> V_11 , V_2 -> type , V_2 -> V_12 ,
V_102 ) ;
F_48 ( V_2 , V_102 ) ;
F_49 ( V_2 ) ;
F_7 ( V_6 ) ;
...
static void F_85 ( struct V_5 * V_6 , T_2 V_102 , T_5 V_173 )
{
struct V_1 * V_2 ;
F_19 ( V_6 ) ;
V_2 = F_86 ( V_6 ) ;
...
T_2 V_178 ;
memset ( & V_35 , 0 , sizeof( V_35 ) ) ;
if ( F_89 ( V_176 , false , & V_178 ) )
return;
V_35 . V_179 = F_32 ( V_6 -> V_180 ) ;
...
V_35 . V_94 = F_32 ( 0x0000 ) ;
V_35 . V_95 = F_32 ( 0x0000 ) ;
F_90 ( V_176 , V_190 , sizeof( V_35 ) , & V_35 ) ;
V_2 -> V_36 = V_37 ;
F_91 ( V_107 , & V_2 -> V_24 ) ;
}
...
struct V_1 * V_2 )
{
struct V_5 * V_6 = V_176 -> V_6 ;
struct V_191 V_35 ;
T_2 V_178 ;
T_2 V_127 ;
F_93 ( V_6 , V_192 ) ;
if ( F_89 ( V_176 , false , & V_178 ) < 0 )
return;
memset ( & V_35 , 0 , sizeof( V_35 ) ) ;
V_35 . type = V_193 ;
V_35 . V_185 = V_178 ;
...
F_90 ( V_176 , V_198 , sizeof( V_35 ) , & V_35 ) ;
V_127 = 0x01 ;
F_90 ( V_176 , V_128 , sizeof( V_127 ) , & V_127 ) ;
V_2 -> V_36 = V_37 ;
}
...
static void F_104 ( struct V_5 * V_6 , T_2 V_102 ,
T_5 V_173 )
{
struct V_1 * V_2 ;
if ( ! V_102 )
...
V_102 ) ;
F_19 ( V_6 ) ;
V_2 = F_105 ( V_6 , V_106 , V_37 ) ;
if ( V_2 )
F_61 ( V_2 , V_102 ) ;
F_23 ( V_6 ) ;
}
static bool F_106 ( struct V_5 * V_6 , T_1 * V_218 , T_2 type )
{
struct V_1 * V_2 ;
V_2 = F_97 ( V_6 , V_218 , type ) ;
if ( ! V_2 )
return false ;
if ( V_2 -> V_36 != V_58 )
return false ;
...
static int F_107 ( struct V_175 * V_176 ,
T_1 * V_218 , T_2 V_13 )
{
struct V_5 * V_6 = V_176 -> V_6 ;
struct V_3 * V_4 ;
if ( F_106 ( V_6 , V_218 , V_13 ) )
return - V_219 ;
V_4 = F_45 ( V_6 , V_218 , V_13 ) ;
if ( ! V_4 ) {
V_4 = F_108 ( V_6 , V_218 , V_13 ) ;
if ( ! V_4 )
return - V_210 ;
V_4 -> V_17 = V_18 ;
}
...
return F_96 ( - V_210 ) ;
F_99 ( & V_176 , V_6 ) ;
if ( F_107 ( & V_176 , V_11 , V_12 ) < 0 )
return F_96 ( - V_207 ) ;
V_2 -> V_36 = V_37 ;
F_33 ( V_107 , & V_2 -> V_24 ) ;
V_202 = F_102 ( & V_176 , F_104 ) ;
if ( V_202 && V_202 != - V_221 ) {
F_49 ( V_2 ) ;
return F_96 ( V_202 ) ;
}
V_2 -> V_12 = V_12 ;
...
struct V_1 * F_111 ( struct V_5 * V_6 , T_1 * V_11 ,
T_2 V_199 , T_2 V_134 )
{
struct V_1 * V_162 ;
if ( ! F_81 ( V_6 , V_222 ) ) {
...
struct V_1 * F_114 ( struct V_5 * V_6 , int type , T_1 * V_11 ,
T_4 V_72 )
{
struct V_1 * V_162 ;
struct V_1 * V_103 ;
V_162 = F_111 ( V_6 , V_11 , V_211 , V_223 ) ;
if ( F_115 ( V_162 ) )
return V_162 ;
V_103 = F_113 ( V_6 , type , V_11 ) ;
if ( ! V_103 ) {
...
static int F_120 ( struct V_1 * V_2 , T_3 V_199 , T_3 V_134 )
{
F_18 ( L_2 , V_2 ) ;
if ( V_2 -> V_206 > V_199 )
V_199 = V_2 -> V_206 ;
if ( V_199 > V_2 -> V_199 )
V_2 -> V_206 = V_199 ;
else if ( F_9 ( V_230 , & V_2 -> V_24 ) )
return 1 ;
V_134 |= ( V_2 -> V_134 & 0x01 ) ;
V_2 -> V_134 = V_134 ;
if ( ! F_58 ( V_231 , & V_2 -> V_24 ) ) {
struct V_232 V_35 ;
V_35 . V_62 = F_32 ( V_2 -> V_62 ) ;
F_35 ( V_2 -> V_6 , V_233 ,
sizeof( V_35 ) , & V_35 ) ;
...
{
F_18 ( L_2 , V_2 ) ;
if ( ! F_58 ( V_235 , & V_2 -> V_24 ) ) {
struct V_236 V_35 ;
V_35 . V_62 = F_32 ( V_2 -> V_62 ) ;
V_35 . V_237 = 0x01 ;
F_35 ( V_2 -> V_6 , V_238 , sizeof( V_35 ) ,
& V_35 ) ;
}
}
int F_122 ( struct V_1 * V_2 , T_3 V_199 , T_3 V_134 ,
bool V_239 )
{
F_18 ( L_2 , V_2 ) ;
if ( V_2 -> type == V_106 )
return F_123 ( V_2 , V_199 ) ;
if ( V_199 == V_240 )
return 1 ;
if ( V_199 == V_211 && ! F_119 ( V_2 ) )
return 1 ;
if ( ! F_9 ( V_230 , & V_2 -> V_24 ) )
goto V_241;
if ( V_2 -> V_138 == V_228 &&
V_199 == V_242 )
goto V_237;
...
int F_124 ( struct V_1 * V_2 , T_3 V_199 )
{
F_18 ( L_2 , V_2 ) ;
if ( V_199 != V_244 && V_199 != V_242 )
return 1 ;
if ( V_2 -> V_199 == V_244 ||
V_2 -> V_199 == V_242 )
return 1 ;
...
int F_125 ( struct V_1 * V_2 , T_3 V_39 )
{
F_18 ( L_2 , V_2 ) ;
if ( V_39 == V_2 -> V_39 )
return 1 ;
if ( ! F_58 ( V_251 , & V_2 -> V_24 ) ) {
struct V_252 V_35 ;
F_29 ( & V_35 . V_9 , & V_2 -> V_11 ) ;
V_35 . V_39 = V_39 ;
F_35 ( V_2 -> V_6 , V_253 , sizeof( V_35 ) , & V_35 ) ;
}
return 0 ;
}
void F_116 ( struct V_1 * V_2 , T_3 V_254 )
{
struct V_5 * V_6 = V_2 -> V_6 ;
F_18 ( L_4 , V_2 , V_2 -> V_109 ) ;
if ( V_2 -> V_109 != V_255 )
goto V_256;
if ( ! F_9 ( V_144 , & V_2 -> V_24 ) && ! V_254 )
goto V_256;
if ( ! F_58 ( V_116 , & V_2 -> V_24 ) ) {
struct V_257 V_35 ;
V_35 . V_62 = F_32 ( V_2 -> V_62 ) ;
F_35 ( V_6 , V_258 , sizeof( V_35 ) , & V_35 ) ;
}
V_256:
if ( V_6 -> V_259 > 0 )
F_126 ( V_6 -> V_260 , & V_2 -> V_108 ,
F_127 ( V_6 -> V_259 ) ) ;
}
void F_128 ( struct V_5 * V_6 )
{
struct V_261 * V_262 = & V_6 -> V_263 ;
struct V_1 * V_30 , * V_264 ;
F_18 ( L_14 , V_6 -> V_31 ) ;
F_129 (c, n, &h->list, list) {
V_30 -> V_36 = V_172 ;
F_130 ( V_30 , V_265 ) ;
F_49 ( V_30 ) ;
}
}
void F_131 ( struct V_5 * V_6 )
{
struct V_1 * V_2 ;
F_18 ( L_14 , V_6 -> V_31 ) ;
F_19 ( V_6 ) ;
V_2 = F_105 ( V_6 , V_57 , V_266 ) ;
if ( V_2 )
F_28 ( V_2 ) ;
F_23 ( V_6 ) ;
}
static T_8 F_132 ( struct V_1 * V_2 )
{
T_8 V_52 = 0 ;
if ( V_2 -> V_39 == V_40 )
V_52 |= V_53 ;
...
V_52 |= V_270 ;
if ( F_9 ( V_271 , & V_2 -> V_24 ) )
V_52 |= V_272 ;
return V_52 ;
}
int F_133 ( void T_9 * V_273 )
{
struct V_1 * V_30 ;
struct V_274 V_176 , * V_275 ;
struct V_276 * V_277 ;
struct V_5 * V_6 ;
int V_264 = 0 , V_278 , V_202 ;
if ( F_134 ( & V_176 , V_273 , sizeof( V_176 ) ) )
return - V_279 ;
if ( ! V_176 . V_280 || V_176 . V_280 > ( V_281 * 2 ) / sizeof( * V_277 ) )
return - V_282 ;
V_278 = sizeof( V_176 ) + V_176 . V_280 * sizeof( * V_277 ) ;
V_275 = F_135 ( V_278 , V_131 ) ;
if ( ! V_275 )
return - V_210 ;
V_6 = F_136 ( V_176 . V_283 ) ;
if ( ! V_6 ) {
F_137 ( V_275 ) ;
return - V_284 ;
}
...
F_29 ( & ( V_277 + V_264 ) -> V_9 , & V_30 -> V_11 ) ;
( V_277 + V_264 ) -> V_62 = V_30 -> V_62 ;
( V_277 + V_264 ) -> type = V_30 -> type ;
( V_277 + V_264 ) -> V_38 = V_30 -> V_38 ;
( V_277 + V_264 ) -> V_36 = V_30 -> V_36 ;
( V_277 + V_264 ) -> V_52 = F_132 ( V_30 ) ;
if ( ++ V_264 >= V_176 . V_280 )
break;
}
F_23 ( V_6 ) ;
V_275 -> V_283 = V_6 -> V_286 ;
V_275 -> V_280 = V_264 ;
V_278 = sizeof( V_176 ) + V_264 * sizeof( * V_277 ) ;
F_14 ( V_6 ) ;
V_202 = F_138 ( V_273 , V_275 , V_278 ) ;
F_137 ( V_275 ) ;
return V_202 ? - V_279 : 0 ;
}
int F_139 ( struct V_5 * V_6 , void T_9 * V_273 )
{
struct V_287 V_176 ;
struct V_276 V_277 ;
struct V_1 * V_2 ;
char T_9 * V_288 = V_273 + sizeof( V_176 ) ;
if ( F_134 ( & V_176 , V_273 , sizeof( V_176 ) ) )
return - V_279 ;
F_19 ( V_6 ) ;
V_2 = F_113 ( V_6 , V_176 . type , & V_176 . V_9 ) ;
if ( V_2 ) {
F_29 ( & V_277 . V_9 , & V_2 -> V_11 ) ;
V_277 . V_62 = V_2 -> V_62 ;
V_277 . type = V_2 -> type ;
V_277 . V_38 = V_2 -> V_38 ;
V_277 . V_36 = V_2 -> V_36 ;
V_277 . V_52 = F_132 ( V_2 ) ;
}
F_23 ( V_6 ) ;
if ( ! V_2 )
return - V_289 ;
return F_138 ( V_288 , & V_277 , sizeof( V_277 ) ) ? - V_279 : 0 ;
}
int F_140 ( struct V_5 * V_6 , void T_9 * V_273 )
{
struct V_290 V_176 ;
struct V_1 * V_2 ;
if ( F_134 ( & V_176 , V_273 , sizeof( V_176 ) ) )
return - V_279 ;
F_19 ( V_6 ) ;
V_2 = F_113 ( V_6 , V_57 , & V_176 . V_9 ) ;
if ( V_2 )
V_176 . type = V_2 -> V_134 ;
F_23 ( V_6 ) ;
if ( ! V_2 )
return - V_289 ;
return F_138 ( V_273 , & V_176 , sizeof( V_176 ) ) ? - V_279 : 0 ;
}
struct V_291 * F_141 ( struct V_1 * V_2 )
{
struct V_5 * V_6 = V_2 -> V_6 ;
struct V_291 * V_292 ;
F_18 ( L_1 , V_6 -> V_31 , V_2 ) ;
if ( F_9 ( V_293 , & V_2 -> V_24 ) ) {
F_18 ( L_15 ) ;
return NULL ;
}
V_292 = F_63 ( sizeof( * V_292 ) , V_131 ) ;
if ( ! V_292 )
return NULL ;
V_292 -> V_2 = F_26 ( V_2 ) ;
F_65 ( & V_292 -> V_155 ) ;
V_292 -> V_36 = V_58 ;
F_142 ( & V_292 -> V_294 , & V_2 -> V_156 ) ;
return V_292 ;
}
void F_143 ( struct V_291 * V_292 )
{
struct V_1 * V_2 = V_292 -> V_2 ;
struct V_5 * V_6 = V_2 -> V_6 ;
F_18 ( L_16 , V_6 -> V_31 , V_2 , V_292 ) ;
F_144 ( & V_292 -> V_294 ) ;
F_145 () ;
F_33 ( V_293 , & V_2 -> V_24 ) ;
F_15 ( V_2 ) ;
...
{
struct V_291 * V_292 , * V_264 ;
F_18 ( L_2 , V_2 ) ;
F_129 (chan, n, &conn->chan_list, list)
F_143 ( V_292 ) ;
}
static struct V_291 * F_146 ( struct V_1 * V_295 ,
T_4 V_62 )
{
struct V_291 * V_296 ;
...
struct V_291 * F_147 ( struct V_5 * V_6 , T_4 V_62 )
{
struct V_261 * V_262 = & V_6 -> V_263 ;
struct V_1 * V_295 ;
struct V_291 * V_296 = NULL ;
F_20 () ;
F_21 (hcon, &h->list, list) {
V_296 = F_146 ( V_295 , V_62 ) ;
if ( V_296 )
break;
}
F_22 () ;
