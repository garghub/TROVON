...
F_62 ( V_89 , V_239 , V_240 ) ;
F_62 ( V_89 , V_241 , V_242 ) ;
}
if ( V_91 || V_93 ) {
if ( V_89 -> V_243 )
F_9 ( F_63 ( V_244 ) , V_86 ) ;
F_62 ( V_89 , V_245 , V_243 ) ;
...
F_62 ( V_89 , V_274 , V_275 ) ;
F_62 ( V_89 , V_276 , V_277 ) ;
}
if ( V_89 -> V_278 || ( V_7 -> V_14 == V_92 &&
V_89 -> V_247 ) )
F_9 ( F_63 ( V_279 ) , V_86 ) ;
...
F_62 ( V_89 , V_288 , V_289 ) ;
F_62 ( V_89 , V_290 , V_291 ) ;
}
if ( V_101 && ( V_95 || V_96 ) ) {
F_62 ( V_89 , V_292 , V_140 ) ;
F_62 ( V_89 , V_293 , V_294 ) ;
}
if ( V_98 ) {
F_62 ( V_89 , V_295 , V_139 ) ;
F_62 ( V_89 , V_296 , V_297 ) ;
F_62 ( V_89 , V_298 , V_299 ) ;
}
F_65 ( V_7 -> V_86 , V_86 , V_7 -> V_86 ,
V_87 ) ;
}
int F_66 ( struct V_6 * V_7 , int type , int V_300 ,
...
V_52 = F_71 ( V_7 -> V_28 , F_72 ( V_316 , V_7 -> V_27 ) , 1 ) ;
if ( V_52 < 0 ) {
F_46 ( V_309 L_18 , V_310 ) ;
F_17 ( V_7 -> V_28 ) ;
V_7 -> V_28 = NULL ;
goto V_314;
}
V_7 -> V_23 . V_317 = & V_318 ;
V_7 -> V_23 . V_319 = F_72 ( V_316 , V_7 -> V_27 ) ;
V_7 -> V_23 . V_320 = V_7 -> V_311 ;
F_73 ( & V_7 -> V_23 , L_19 , V_306 , V_7 -> V_19 ) ;
V_52 = F_74 ( & V_7 -> V_23 ) ;
if ( V_52 < 0 ) {
F_46 ( V_309 L_20 , V_310 ) ;
goto V_314;
}
V_7 -> V_23 . V_33 = F_23 ;
if ( V_300 != - 1 && V_300 != V_7 -> V_19 && V_301 )
F_46 ( V_321 L_21 , V_310 ,
V_306 , V_300 , F_47 ( V_7 ) ) ;
F_75 ( V_7 -> V_25 ) ;
#if F_28 ( V_29 )
if ( V_7 -> V_25 -> V_30 &&
V_7 -> V_14 != V_31 ) {
...
V_7 -> V_32 . V_323 . V_23 . V_324 = V_316 ;
V_7 -> V_32 . V_323 . V_23 . V_27 = V_7 -> V_27 ;
...
{
T_7 V_23 = F_72 ( V_316 , 0 ) ;
int V_52 ;
F_46 ( V_326 L_23 ) ;
V_52 = F_80 ( V_23 , V_84 , V_327 ) ;
if ( V_52 < 0 ) {
F_46 ( V_321 L_24 ,
V_316 ) ;
return V_52 ;
