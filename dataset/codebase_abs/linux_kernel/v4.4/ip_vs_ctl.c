...
V_15 -> V_489 = F_261 ( V_2 , L_62 , V_457 ) ;
if ( V_15 -> V_489 == NULL ) {
if ( ! F_255 ( V_2 , & V_458 ) )
F_47 ( V_457 ) ;
return - V_148 ;
...
F_270 ( L_63 , 0 , V_2 -> V_493 , & V_494 ) ;
F_270 ( L_64 , 0 , V_2 -> V_493 , & V_495 ) ;
F_270 ( L_65 , 0 , V_2 -> V_493 ,
& V_496 ) ;
if ( F_254 ( V_15 ) )
goto V_497;
return 0 ;
...
F_73 ( V_15 ) ;
F_263 ( V_15 ) ;
F_272 ( L_65 , V_2 -> V_493 ) ;
F_272 ( L_64 , V_2 -> V_493 ) ;
F_272 ( L_63 , V_2 -> V_493 ) ;
F_46 ( V_15 -> V_202 . V_77 ) ;
}
int T_11 F_273 ( void )
{
