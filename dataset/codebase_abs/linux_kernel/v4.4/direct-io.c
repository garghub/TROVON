...
if ( F_84 ( V_28 ) )
V_5 -> V_20 = false ;
else if ( ! ( V_5 -> V_30 & V_148 ) &&
F_78 ( V_7 ) == V_14 && V_121 > F_50 ( V_32 ) )
V_5 -> V_20 = false ;
else
V_5 -> V_20 = true ;
V_5 -> V_32 = V_32 ;
V_5 -> V_13 = F_78 ( V_7 ) == V_14 ? V_149 : V_24 ;
if ( V_5 -> V_20 && F_78 ( V_7 ) == V_14 &&
( ( V_28 -> V_34 -> V_150 & V_151 ) ||
F_85 ( V_28 -> V_34 -> V_146 -> V_152 ) ) ) {
V_137 = F_48 ( V_5 ) ;
if ( V_137 ) {
F_13 ( V_36 , V_5 ) ;
goto V_105;
...
F_87 ( & V_5 -> V_44 ) ;
V_5 -> V_45 = 1 ;
V_5 -> V_62 = ( V_7 -> type == V_153 ) ;
V_2 . V_7 = V_7 ;
V_2 . V_96 =
( V_19 + F_74 ( V_7 ) ) >> V_93 ;
if ( F_69 ( V_2 . V_94 ) )
V_2 . V_106 = 2 ;
V_2 . V_106 += F_88 ( V_7 , V_154 ) ;
F_89 ( & V_141 ) ;
...
int V_30 )
{
F_92 ( & V_52 -> V_155 -> V_156 ) ;
F_92 ( V_52 -> V_157 ) ;
F_92 ( ( char * ) V_52 -> V_157 + V_158 ) ;
