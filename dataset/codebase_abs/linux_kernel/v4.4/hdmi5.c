...
static void F_64 ( struct V_64 * V_65 )
{
F_63 ( & V_65 -> V_9 , false ) ;
F_62 ( & V_65 -> V_9 , false ) ;
...
if ( V_2 . V_70 ) {
V_1 = F_66 ( & V_2 . V_49 , & V_2 . V_9 , & V_2 . V_71 ,
V_2 . V_37 . V_38 . V_42 ) ;
if ( V_1 ) {
F_18 ( L_13 , V_1 ) ;
...
static void F_82 ( struct V_87 * V_3 )
{
struct V_24 * V_53 = & V_2 . V_33 ;
V_53 -> V_4 = & V_3 -> V_4 ;
V_53 -> V_88 = V_89 ;
...
static void F_84 ( struct V_87 * V_3 )
{
struct V_24 * V_53 = & V_2 . V_33 ;
F_85 ( V_53 ) ;
}
static int F_86 ( struct V_87 * V_3 )
{
...
void (* F_91)( struct V_102 * V_4 ) )
{
struct V_64 * V_65 = F_92 ( V_4 ) ;
int V_103 = 0 ;
F_48 ( & V_65 -> V_57 ) ;
if ( ! F_93 ( & V_65 -> V_37 ) || ! V_65 -> V_75 ) {
V_103 = - V_104 ;
goto V_53;
}
V_65 -> V_72 = F_91 ;
...
static int F_95 ( struct V_102 * V_4 )
{
struct V_64 * V_65 = F_92 ( V_4 ) ;
unsigned long V_67 ;
F_4 ( ! F_93 ( & V_65 -> V_37 ) ) ;
...
static void F_96 ( struct V_102 * V_4 )
{
struct V_64 * V_65 = F_92 ( V_4 ) ;
unsigned long V_67 ;
F_4 ( ! F_93 ( & V_65 -> V_37 ) ) ;
...
static int F_97 ( struct V_102 * V_4 ,
struct V_105 * V_106 )
{
struct V_64 * V_65 = F_92 ( V_4 ) ;
int V_103 ;
...
V_103 = F_66 ( & V_65 -> V_49 , & V_65 -> V_9 , V_106 ,
V_65 -> V_37 . V_38 . V_42 ) ;
if ( ! V_103 ) {
V_65 -> V_70 = true ;
V_65 -> V_71 = * V_106 ;
...
static int F_98 ( struct V_102 * V_4 )
{
struct V_107 V_108 = {
. V_4 = V_4 ,
. V_109 = F_99 () ,
...
F_1 () ;
V_2 . V_66 =
F_59 ( V_2 . V_9 . V_16 , V_63 , 3 , 2 ) ;
F_5 () ;
return 0 ;
}
static int F_102 ( struct V_102 * V_4 , struct V_102 * V_114 , void * V_7 )
{
struct V_87 * V_3 = F_103 ( V_4 ) ;
int V_1 ;
int V_6 ;
V_2 . V_3 = V_3 ;
F_104 ( & V_3 -> V_4 , & V_2 ) ;
...
V_1 = F_107 ( V_3 , & V_2 . V_9 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_108 ( V_3 , & V_2 . V_41 , & V_2 . V_9 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_109 ( V_3 , & V_2 . V_15 ) ;
if ( V_1 )
goto V_101;
V_1 = F_110 ( V_3 , & V_2 . V_49 ) ;
if ( V_1 )
goto V_101;
V_6 = F_111 ( V_3 , 0 ) ;
if ( V_6 < 0 ) {
...
static void F_117 ( struct V_102 * V_4 , struct V_102 * V_114 , void * V_7 )
{
struct V_87 * V_3 = F_103 ( V_4 ) ;
if ( V_2 . V_112 )
F_118 ( V_2 . V_112 ) ;
...
static int F_119 ( struct V_87 * V_3 )
{
return F_120 ( & V_3 -> V_4 , & V_116 ) ;
}
static int F_121 ( struct V_87 * V_3 )
{
F_122 ( & V_3 -> V_4 , & V_116 ) ;
return 0 ;
}
static int F_123 ( struct V_102 * V_4 )
{
F_124 () ;
return 0 ;
}
static int F_125 ( struct V_102 * V_4 )
{
int V_1 ;
V_1 = F_126 () ;
if ( V_1 < 0 )
