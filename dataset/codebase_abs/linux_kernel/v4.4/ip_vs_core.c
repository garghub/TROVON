...
goto V_192;
if ( V_40 -> V_193 && ! V_40 -> V_193 ( V_15 , V_40 , V_13 , V_57 ) )
goto V_192;
#ifdef F_2
if ( V_50 == V_68 )
...
return V_111 ;
V_196 = F_99 ( V_15 ) ;
if ( F_46 ( V_196 && V_119 == V_197 &&
V_50 == V_143 ) ) {
if ( V_196 -> V_198 == V_199 && F_100 ( V_196 ) -> V_200 )
return V_111 ;
}
if ( F_46 ( ! F_64 ( V_15 ) ) )
return V_111 ;
...
static unsigned int
F_104 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_97 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_143 ) ;
}
static unsigned int
F_106 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_97 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_143 ) ;
}
static unsigned int
F_107 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_97 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_68 ) ;
}
static unsigned int
F_108 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_97 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_68 ) ;
}
...
struct V_38 * V_39 ,
int * V_153 , struct V_12 * * V_205 ,
struct V_56 * V_57 )
{
struct V_86 * V_40 = V_39 -> V_40 ;
if ( ! V_57 -> V_147 ) {
if ( ! V_40 -> V_206 ( V_19 , V_50 , V_15 , V_39 , V_153 , V_205 , V_57 ) )
return 0 ;
}
if ( F_46 ( ! * V_205 ) ) {
F_35 ( 12 , V_50 , V_40 , V_15 , V_57 -> V_90 ,
...
struct V_86 * V_40 ;
struct V_38 * V_39 ;
unsigned int V_117 , V_207 , V_135 , V_153 ;
bool V_208 , V_209 = false ;
* V_158 = 1 ;
if ( F_82 ( F_62 ( V_15 ) ) ) {
if ( F_57 ( V_19 , V_15 , F_56 ( V_119 ) ) )
return V_163 ;
...
L_39 ) ;
V_207 = V_117 ;
F_87 ( V_143 , V_15 , V_117 , ! V_208 , & V_138 ) ;
V_117 = V_138 . V_32 ;
...
if ( ! F_112 ( V_19 ) )
return V_111 ;
if ( ! F_109 ( V_19 , V_143 , V_15 , V_39 , & V_211 , & V_13 , & V_138 ) )
return V_211 ;
V_209 = true ;
}
V_153 = V_102 ;
...
if ( V_208 ) {
T_6 V_212 = V_160 -> V_213 . V_214 ;
T_4 type = V_160 -> type ;
T_4 V_215 = V_160 -> V_215 ;
if ( V_160 -> type == V_115 &&
V_160 -> V_215 == V_216 ) {
struct V_16 * V_17 = V_13 -> V_17 ;
T_7 V_217 = F_24 ( V_160 -> V_213 . V_218 . V_217 ) ;
T_1 V_166 = V_162 -> V_166 ;
if ( F_113 ( V_15 , V_135 + sizeof( V_159 ) ) == NULL )
goto V_219;
V_207 -= V_135 + sizeof( V_159 ) ;
F_114 ( V_15 ) ;
F_28 ( 12 , L_41 ,
& F_62 ( V_15 ) -> V_66 , & F_62 ( V_15 ) -> V_67 , V_217 ) ;
...
struct V_221 * V_222 ;
F_9 () ;
V_222 = F_10 ( V_17 -> V_222 ) ;
if ( V_222 )
V_217 = F_116 ( V_222 -> V_223 ) ;
F_11 () ;
}
if ( V_217 > 68 + sizeof( struct V_133 ) )
V_217 -= sizeof( struct V_133 ) ;
V_212 = F_19 ( V_217 ) ;
}
if ( F_113 ( V_15 , V_207 ) == NULL )
goto V_219;
F_114 ( V_15 ) ;
F_28 ( 12 , L_42 ,
& F_62 ( V_15 ) -> V_66 , & F_62 ( V_15 ) -> V_67 ,
type , V_215 , F_117 ( V_212 ) ) ;
F_49 ( V_15 , type , V_215 , V_212 ) ;
F_12 ( V_13 , V_15 ) ;
V_219:
F_118 ( V_15 ) ;
V_153 = V_163 ;
...
if ( ! F_112 ( V_19 ) )
return V_111 ;
if ( ! F_109 ( V_19 , V_68 , V_15 , V_39 , & V_211 , & V_13 , & V_138 ) )
return V_211 ;
V_209 = true ;
}
if ( ( V_119 == V_197 ) &&
...
if ( V_15 -> V_156 )
return V_111 ;
if ( F_46 ( ( V_15 -> V_226 != V_227 &&
V_119 != V_197 ) ||
! F_64 ( V_15 ) ) ) {
F_101 ( V_50 , V_15 , false , & V_57 ) ;
F_22 ( 12 , L_45
L_46 ,
V_15 -> V_226 , V_57 . V_42 ,
F_23 ( V_50 , & V_57 . V_67 ) , V_119 ) ;
return V_111 ;
}
if ( F_46 ( F_123 ( V_19 ) || ! V_19 -> V_201 ) )
return V_111 ;
F_101 ( V_50 , V_15 , false , & V_57 ) ;
V_196 = F_99 ( V_15 ) ;
if ( F_46 ( V_196 && V_119 == V_197 &&
...
if ( V_185 && ! V_57 . V_147 &&
F_92 ( V_15 , & V_57 ) && V_13 &&
( ( F_46 ( F_52 ( V_19 ) ) && V_13 -> V_17 &&
F_46 ( ! F_39 ( & V_13 -> V_17 -> V_228 ) ) ) ||
F_46 ( F_93 ( V_13 , V_185 ) ) ) ) {
if ( ! F_39 ( & V_13 -> V_229 ) )
F_126 ( V_13 ) ;
F_36 ( V_13 ) ;
V_13 = NULL ;
...
if ( F_46 ( ! V_13 ) ) {
int V_211 ;
if ( ! F_109 ( V_19 , V_50 , V_15 , V_39 , & V_211 , & V_13 , & V_57 ) )
return V_211 ;
}
...
V_225 = F_128 ( 1 , & V_13 -> V_110 ) ;
if ( V_19 -> V_230 & V_231 )
F_129 ( V_19 , V_13 , V_225 ) ;
F_31 ( V_13 ) ;
return V_104 ;
}
static unsigned int
F_130 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_122 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_143 ) ;
}
static unsigned int
F_131 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_122 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_143 ) ;
}
static unsigned int
F_132 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_122 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_68 ) ;
}
static unsigned int
F_133 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
return F_122 ( F_105 ( V_187 -> V_99 ) , V_187 -> V_204 , V_15 , V_68 ) ;
}
static unsigned int
F_134 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
int V_232 ;
...
if ( F_46 ( F_123 ( V_19 ) || ! V_19 -> V_201 ) )
return V_111 ;
return F_111 ( V_19 , V_15 , & V_232 , V_187 -> V_204 ) ;
}
static unsigned int
F_135 ( void * V_202 , struct V_14 * V_15 ,
const struct V_203 * V_187 )
{
int V_232 ;
struct V_18 * V_19 = F_105 ( V_187 -> V_99 ) ;
...
if ( F_46 ( F_123 ( V_19 ) || ! V_19 -> V_201 ) )
return V_111 ;
return F_120 ( V_19 , V_15 , & V_232 , V_187 -> V_204 , & V_133 ) ;
}
static int T_8 F_136 ( struct V_99 * V_99 )
{
struct V_18 * V_19 ;
V_19 = F_137 ( V_99 , V_233 ) ;
if ( V_19 == NULL )
return - V_234 ;
V_19 -> V_201 = 0 ;
V_19 -> V_99 = V_99 ;
V_19 -> V_235 = F_39 ( & V_236 ) ;
F_45 ( & V_236 ) ;
V_99 -> V_19 = V_19 ;
if ( F_138 ( V_19 ) < 0 )
goto V_237;
...
static void T_9 F_150 ( struct V_99 * V_99 )
{
...
F_148 ( V_19 ) ;
F_149 ( V_19 ) ;
F_28 ( 2 , L_50 , V_19 -> V_235 ) ;
V_99 -> V_19 = NULL ;
}
static void T_9 F_152 ( struct V_99 * V_99 )
{
struct V_18 * V_19 = F_105 ( V_99 ) ;
F_98 ( 2 ) ;
V_19 -> V_201 = 0 ;
