...
static int F_92 ( struct V_123 * V_124 ,
struct V_20 * V_21 ,
union V_3 * V_4 , char * V_224 )
{
if ( V_224 ) {
...
static int F_93 ( struct V_123 * V_124 , struct V_20 * V_232 ,
union V_3 * V_4 , char * V_233 )
{
return - 1 ;
}
static int F_94 ( struct V_123 * V_124 , T_4 V_64 , T_3 V_89 )
{
T_5 V_125 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
switch ( V_64 ) {
...
static int F_95 ( struct V_123 * V_124 , T_3 V_436 , T_3 V_323 )
{
int V_125 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
switch ( V_436 ) {
...
static int F_96 ( struct V_123 * V_124 , struct V_388 * V_33 )
{
struct V_142 * V_143 ;
T_5 V_125 = 0 ;
...
if ( F_97 ( V_143 , V_33 -> V_439 , V_33 -> V_49 ) ) {
F_35 ( V_143 ) ;
V_125 = - V_441 ;
goto V_440;
}
switch ( V_143 -> V_43 ) {
case V_442 :
V_125 = F_94 ( V_124 , V_143 -> V_44 . V_443 . V_64 , V_143 -> V_44 . V_443 . V_89 ) ;
break;
case V_444 :
...
break;
case V_445 :
V_125 = F_95 ( V_124 , V_143 -> V_44 . V_325 . V_436 , V_143 -> V_44 . V_325 . V_327 ) ;
break;
default:
...
if ( V_125 == 0 && F_98 ( V_33 -> V_439 , V_143 , V_33 -> V_49 ) )
V_125 = - V_441 ;
F_35 ( V_143 ) ;
V_440:
return V_125 ;
}
static T_4 F_99 ( struct V_1 * V_2 , struct V_178 * V_179 )
{
struct V_446 * V_447 ;
struct V_448 * V_449 ;
struct V_450 * V_451 = & V_2 -> V_452 ;
T_4 V_453 = V_207 ;
V_447 = F_100 ( sizeof( struct V_446 ) , V_204 ) ;
if ( V_447 == NULL ) {
V_453 = V_172 ;
goto exit;
}
V_449 = F_100 ( sizeof( struct V_448 ) , V_204 ) ;
if ( V_449 == NULL ) {
F_35 ( V_447 ) ;
V_453 = V_172 ;
goto exit;
}
F_101 ( V_447 , V_449 , V_454 ) ;
V_449 -> V_455 = ( T_4 ) V_179 -> V_189 ;
memcpy ( V_449 -> V_456 , V_179 -> V_457 , V_17 ) ;
memcpy ( V_449 -> V_156 , & V_179 -> V_190 , 16 ) ;
V_453 = F_102 ( V_451 , V_447 ) ;
exit:
return V_453 ;
}
static int F_103 ( struct V_1 * V_2 , T_4 * V_156 , T_4 V_154 , int V_458 )
{
T_4 V_459 ;
struct V_446 * V_460 ;
struct V_461 * V_462 ;
...
int V_453 = V_207 ;
F_25 ( L_57 , V_326 ) ;
V_460 = F_100 ( sizeof( struct V_446 ) , V_204 ) ;
if ( V_460 == NULL ) {
V_453 = V_172 ;
goto exit;
}
V_462 = F_100 ( sizeof( struct V_461 ) , V_204 ) ;
if ( V_462 == NULL ) {
F_35 ( V_460 ) ;
V_453 = V_172 ;
goto exit;
...
V_460 -> V_469 = 0 ;
F_104 ( & V_460 -> V_321 ) ;
V_453 = F_102 ( V_451 , V_460 ) ;
exit:
return V_453 ;
}
static int F_105 ( struct V_1 * V_2 , T_4 * V_156 , T_4 V_459 , int V_458 )
{
T_4 V_154 ;
switch ( V_459 ) {
case 5 :
...
return F_103 ( V_2 , V_156 , V_154 , V_458 ) ;
}
static int F_106 ( struct V_123 * V_124 , struct V_142 * V_143 , T_3 V_144 )
{
int V_125 = 0 ;
T_3 V_145 , V_146 , V_147 ;
struct V_148 * V_149 = NULL ;
...
memcpy ( & ( V_151 -> V_174 [ V_145 ] . V_175 [ 0 ] ) , V_149 -> V_166 , V_149 -> V_167 ) ;
V_151 -> V_176 [ V_145 ] = V_149 -> V_167 ;
F_105 ( V_2 , V_149 -> V_166 , V_149 -> V_167 , V_145 ) ;
} else {
F_25 ( L_31 ) ;
memcpy ( & ( V_151 -> V_174 [ V_145 ] . V_175 [ 0 ] ) , V_149 -> V_166 , V_149 -> V_167 ) ;
V_151 -> V_176 [ V_145 ] = V_149 -> V_167 ;
...
F_103 ( V_2 , V_143 -> V_44 . V_152 . V_156 , V_151 -> V_165 , V_143 -> V_44 . V_152 . V_159 ) ;
V_180 = F_34 ( V_2 ) ;
if ( V_180 ) {
V_180 -> V_186 = false ;
...
static int F_107 ( struct V_123 * V_124 , struct V_142 * V_143 , int V_344 )
{
int V_125 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
V_182 -> V_472 = V_474 ;
if ( F_108 ( V_2 , V_470 , ( V_344 - 12 - 2 ) ) == V_207 )
V_125 = 0 ;
else
V_125 = - V_141 ;
return V_125 ;
}
static int F_109 ( struct V_123 * V_124 )
{
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
F_25 ( L_57 , V_326 ) ;
F_110 ( V_2 ) ;
...
static int F_112 ( struct V_123 * V_124 , struct V_142 * V_143 )
{
int V_125 = 0 ;
...
static int F_114 ( struct V_123 * V_124 , struct V_142 * V_143 )
{
int V_125 = 0 ;
struct V_178 * V_179 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
...
if ( V_179 ) {
F_55 ( & V_182 -> V_485 ) ;
if ( ! F_115 ( & V_179 -> V_486 ) ) {
F_116 ( & V_179 -> V_486 ) ;
V_182 -> V_487 -- ;
V_109 = F_117 ( V_2 , V_179 , true , V_488 ) ;
}
F_58 ( & V_182 -> V_485 ) ;
F_118 ( V_2 , V_109 ) ;
V_179 = NULL ;
...
static int F_119 ( struct V_123 * V_124 , struct V_142 * V_143 , int V_344 )
{
int V_125 = 0 ;
struct V_178 * V_179 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
...
static int F_120 ( struct V_123 * V_124 , struct V_142 * V_143 )
{
int V_125 = 0 ;
struct V_178 * V_179 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
...
static int F_121 ( struct V_123 * V_124 , struct V_142 * V_143 , int V_344 )
{
int V_125 = 0 ;
...
F_122 ( V_2 , V_221 , V_220 , true ) ;
V_270 -> V_518 = true ;
}
return V_125 ;
}
static int F_123 ( struct V_123 * V_124 , struct V_142 * V_143 , int V_344 )
{
int V_125 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
V_143 -> V_158 [ 4 ] == 0xff && V_143 -> V_158 [ 5 ] == 0xff )
return - V_141 ;
return F_127 ( V_2 , V_143 -> V_158 ) ;
}
static int F_128 ( struct V_123 * V_124 , struct V_142 * V_143 , int V_344 )
{
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
if ( F_21 ( V_8 , V_246 ) != true )
...
V_143 -> V_158 [ 4 ] == 0xff && V_143 -> V_158 [ 5 ] == 0xff )
return - V_141 ;
return F_129 ( V_2 , V_143 -> V_158 ) ;
}
static int F_130 ( struct V_123 * V_124 , struct V_142 * V_143 , int V_344 )
{
int V_125 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
if ( F_21 ( V_8 , V_246 ) != true )
return - V_141 ;
F_131 ( V_2 , V_143 -> V_44 . V_325 . V_436 ) ;
return V_125 ;
}
static int F_132 ( struct V_123 * V_124 , struct V_388 * V_33 )
{
struct V_142 * V_143 ;
int V_125 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
...
break;
case V_528 :
V_125 = F_112 ( V_124 , V_143 ) ;
break;
case V_529 :
V_125 = F_114 ( V_124 , V_143 ) ;
break;
case V_530 :
V_125 = F_107 ( V_124 , V_143 , V_33 -> V_49 ) ;
break;
case V_531 :
V_125 = F_106 ( V_124 , V_143 , V_33 -> V_49 ) ;
break;
case V_532 :
V_125 = F_120 ( V_124 , V_143 ) ;
break;
case V_533 :
V_125 = F_121 ( V_124 , V_143 , V_33 -> V_49 ) ;
break;
case V_534 :
V_125 = F_123 ( V_124 , V_143 , V_33 -> V_49 ) ;
break;
case V_535 :
...
break;
case V_537 :
V_125 = F_119 ( V_124 , V_143 , V_33 -> V_49 ) ;
break;
case V_538 :
V_125 = F_130 ( V_124 , V_143 , V_33 -> V_49 ) ;
break;
case V_539 :
V_125 = F_128 ( V_124 , V_143 , V_33 -> V_49 ) ;
break;
case V_540 :
...
static int F_133 ( struct V_123 * V_124 ,
struct V_20 * V_21 ,
union V_3 * V_305 ,
char * V_224 )
{
...
if ( ! V_541 )
return - V_205 ;
if ( F_97 ( V_541 , V_542 -> V_439 , V_344 ) ) {
F_135 ( V_541 ) ;
return - V_441 ;
}
...
static struct V_550 * F_137 ( struct V_123 * V_124 )
{
struct V_1 * V_2 = (struct V_1 * ) F_24 ( V_124 ) ;
...
int F_138 ( struct V_123 * V_124 , struct V_557 * V_558 , int V_43 )
{
struct V_559 * V_560 = (struct V_559 * ) V_558 ;
int V_125 = 0 ;
switch ( V_43 ) {
case V_561 :
V_125 = F_96 ( V_124 , & V_560 -> V_44 . V_47 ) ;
break;
#ifdef F_139
case V_562 :
V_125 = F_132 ( V_124 , & V_560 -> V_44 . V_47 ) ;
break;
#endif
case ( V_563 + 1 ) :
V_125 = F_140 ( V_124 , V_558 , V_43 ) ;
break;
default:
V_125 = - V_173 ;
break;
