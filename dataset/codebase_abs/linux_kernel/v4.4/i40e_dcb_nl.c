...
V_80 = F_12 ( V_13 -> V_57 [ V_79 ] , V_69 ) ;
F_15 ( & V_13 -> V_82 -> V_9 , L_1 ,
V_13 -> V_57 [ V_79 ] -> V_83 , V_80 , V_69 -> V_73 ,
V_69 -> V_75 , V_69 -> V_70 ) ;
}
}
}
static bool F_16 ( struct V_14 * V_84 ,
struct V_78 * V_69 )
{
int V_38 ;
for ( V_38 = 0 ; V_38 < V_84 -> V_68 ; V_38 ++ ) {
if ( V_69 -> V_73 == V_84 -> V_69 [ V_38 ] . V_73 &&
V_69 -> V_75 == V_84 -> V_69 [ V_38 ] . V_75 &&
V_69 -> V_70 == V_84 -> V_69 [ V_38 ] . V_70 )
return true ;
}
return false ;
}
