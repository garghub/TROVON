...
enum V_180 V_181 ,
struct V_126 * V_127 ,
T_3 V_182 , T_3 * V_327 , T_1 V_328 , bool V_329 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_131 * V_132 ;
int V_10 = 0 ;
...
static int F_142 ( struct V_81 * V_36 , T_4 V_339 )
{
return 0 ;
}
...
V_343 . V_118 = V_129 -> V_99 ;
V_343 . V_153 = V_344 ;
V_343 . V_43 = F_55 ( V_43 -> V_219 [ V_344 ] . V_345 ) ;
F_37 ( V_346 , & V_343 ) ;
if ( V_10 ) {
F_33 ( V_45 ,
L_53
...
V_343 . V_153 = V_347 ;
V_343 . V_43 = F_55 ( V_43 -> V_219 [ V_347 ] . V_345 ) ;
F_37 ( V_346 , & V_343 ) ;
if ( V_10 ) {
F_33 ( V_45 ,
L_55
...
F_44 ( V_45 , V_90 , L_56 ,
V_43 -> V_219 [ V_344 ] . V_345 ,
V_43 -> V_219 [ V_347 ] . V_345 ) ;
V_247:
return V_10 ;
}
...
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_55 * V_12 = V_3 -> V_12 ;
struct V_350 * V_351 = & V_12 -> V_352 ;
V_349 -> V_353 = V_351 -> V_354 ;
V_349 -> V_355 = V_351 -> V_356 ;
V_349 -> V_357 = V_351 -> V_358 ;
V_349 -> V_359 = V_351 -> V_360 ;
return 0 ;
}
struct V_361 * F_146 ( struct V_2 * V_3 )
{
struct V_361 * V_362 = NULL ;
if ( F_147 ( V_3 -> V_12 ) )
V_362 = (struct V_361 * )
& V_3 -> V_12 -> V_363 . V_364 . V_365 ;
else if ( V_3 -> V_12 -> V_366 . V_367 == V_368 )
V_362 = (struct V_361 * )
& V_3 -> V_12 -> V_363 . V_369 . V_365 ;
else if ( V_3 -> V_12 -> V_366 . V_367 == V_370 )
V_362 = (struct V_361 * )
& V_3 -> V_12 -> V_363 . V_371 . V_365 ;
return V_362 ;
}
static int F_148 ( struct V_81 * V_36 , T_4 * V_372 ,
T_4 * V_373 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_361 * V_362 = F_146 ( V_3 ) ;
if ( V_362 ) {
* V_372 = V_362 -> V_374 ;
* V_373 = V_362 -> V_375 ;
} else {
