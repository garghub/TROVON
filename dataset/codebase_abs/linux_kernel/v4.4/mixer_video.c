...
static int F_85 ( struct V_178 * V_179 , const void * V_180 ,
...
{
struct V_187 * V_188 = F_88 ( V_186 ) ;
struct V_189 * V_190 = F_89 ( V_188 , struct V_189 , V_186 ) ;
struct V_41 * V_42 = F_86 ( V_186 -> V_178 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
F_90 ( & V_42 -> V_191 , V_132 ) ;
F_91 ( & V_190 -> V_192 , & V_42 -> V_193 ) ;
F_92 ( & V_42 -> V_191 , V_132 ) ;
F_24 ( V_7 , L_28 ) ;
}
static int F_93 ( struct V_178 * V_179 , unsigned int V_194 )
{
struct V_41 * V_42 = F_86 ( V_179 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
...
F_94 ( V_7 ) ;
F_28 ( V_42 ) ;
V_42 -> V_70 . V_195 ( V_42 ) ;
F_90 ( & V_42 -> V_191 , V_132 ) ;
V_42 -> V_196 = V_197 ;
F_92 ( & V_42 -> V_191 , V_132 ) ;
V_42 -> V_70 . V_198 ( V_42 , V_199 ) ;
F_95 ( V_7 ) ;
return 0 ;
}
static void F_96 ( unsigned long V_200 )
{
struct V_41 * V_42 = (struct V_41 * ) V_200 ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
F_12 ( V_7 , L_29 , V_42 -> V_47 . V_15 ) ;
F_90 ( & V_42 -> V_191 , V_132 ) ;
if ( V_42 -> V_201 == V_42 -> V_202 )
V_42 -> V_201 = NULL ;
if ( V_42 -> V_201 ) {
F_97 ( & V_42 -> V_201 -> V_186 . V_203 ,
V_204 ) ;
V_42 -> V_201 = NULL ;
}
if ( V_42 -> V_202 ) {
F_97 ( & V_42 -> V_202 -> V_186 . V_203 ,
V_204 ) ;
V_42 -> V_202 = NULL ;
}
F_92 ( & V_42 -> V_191 , V_132 ) ;
...
F_100 ( & V_207 -> V_192 ) ;
F_97 ( & V_207 -> V_186 . V_203 , V_204 ) ;
}
F_92 ( & V_42 -> V_191 , V_132 ) ;
F_101 ( & V_206 , F_96 ,
( unsigned long ) V_42 ) ;
F_102 ( & V_206 , V_210 + F_103 ( 1000 ) ) ;
F_104 ( V_179 ) ;
F_105 ( & V_206 ) ;
F_106 ( & V_206 ) ;
F_90 ( & V_42 -> V_191 , V_132 ) ;
...
struct V_6 * V_7 = V_42 -> V_7 ;
int V_11 ;
V_11 = F_110 ( & V_42 -> V_47 , V_213 , - 1 ) ;
if ( V_11 )
F_12 ( V_7 , L_30 ) ;
else
F_17 ( V_7 , L_31 ,
V_42 -> V_47 . V_15 , V_42 -> V_47 . V_214 ) ;
return V_11 ;
}
...
{
if ( V_42 -> V_70 . V_215 )
V_42 -> V_70 . V_215 ( V_42 ) ;
}
void F_114 ( struct V_41 * V_42 )
{
F_18 ( V_42 ) ;
}
static void F_115 ( struct V_158 * V_216 )
{
F_116 ( L_32 ) ;
}
struct V_41 * F_117 ( struct V_6 * V_7 ,
int V_49 , char * V_15 , struct V_217 * V_70 )
{
struct V_41 * V_42 ;
...
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_42 -> V_236 ; ++ V_20 )
