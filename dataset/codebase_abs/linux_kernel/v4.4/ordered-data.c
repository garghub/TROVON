...
F_27 ( & V_7 -> V_53 ) ;
F_81 ( & V_7 -> V_54 , & V_98 ) ;
while ( ! F_30 ( & V_98 ) && V_97 ) {
V_74 = F_50 ( & V_98 , struct V_1 ,
V_46 ) ;
F_82 ( & V_74 -> V_46 ,
& V_7 -> V_54 ) ;
F_44 ( & V_74 -> V_43 ) ;
...
F_54 ( & V_98 , & V_7 -> V_54 ) ;
F_31 ( & V_7 -> V_53 ) ;
F_86 (ordered, next, &works, work_list) {
F_51 ( & V_74 -> V_47 ) ;
F_87 ( & V_74 -> V_48 ) ;
F_52 ( V_74 ) ;
F_85 () ;
...
void F_89 ( struct V_16 * V_17 , int V_97 )
{
struct V_32 * V_7 ;
struct V_71 V_98 ;
int V_104 ;
...
int F_93 ( struct V_13 * V_13 , T_1 V_28 , T_1 V_4 )
{
int V_26 = 0 ;
int V_106 = 0 ;
T_1 V_73 ;
...
V_26 = F_95 ( V_13 , V_28 , V_107 ) ;
if ( V_26 )
return V_26 ;
V_106 = F_96 ( V_13 -> V_82 , V_28 , V_107 ) ;
V_73 = V_107 ;
while ( 1 ) {
V_74 = F_97 ( V_13 , V_73 ) ;
if ( ! V_74 )
...
bool F_100 ( struct V_13 * V_13 ,
T_1 V_3 ,
T_1 V_4 )
{
struct V_1 * V_109 ;
V_109 = F_99 ( V_13 , V_3 , V_4 ) ;
if ( V_109 ) {
F_52 ( V_109 ) ;
return true ;
}
...
int F_101 ( struct V_13 * V_13 , T_1 V_15 ,
struct V_1 * V_74 )
{
struct V_24 * V_25 = & F_16 ( V_13 ) -> V_33 ;
T_1 V_110 ;
T_1 V_111 ;
T_1 V_112 = F_102 ( V_13 ) ;
struct V_5 * V_8 ;
struct V_5 * V_21 = NULL ;
struct V_1 * V_22 ;
int V_26 = 1 ;
...
if ( V_74 ) {
V_15 = F_1 ( V_74 ) ;
if ( F_56 ( V_113 , & V_74 -> V_41 ) )
V_15 = F_39 ( V_15 ,
V_74 -> V_3 +
V_74 -> V_38 ) ;
} else {
V_15 = F_103 ( V_15 , F_16 ( V_13 ) -> V_7 -> V_114 ) ;
}
V_110 = F_16 ( V_13 ) -> V_110 ;
if ( V_110 > V_112 ) {
F_16 ( V_13 ) -> V_110 = V_112 ;
V_26 = 0 ;
goto V_68;
}
if ( V_110 == V_112 )
...
if ( F_56 ( V_116 , & V_22 -> V_41 ) )
continue;
if ( V_22 -> V_3 + V_22 -> V_4 <= V_110 )
break;
if ( V_22 -> V_3 >= V_112 )
break;
if ( F_1 ( V_22 ) > V_110 ) {
...
V_111 = F_104 ( T_1 , V_15 , V_112 ) ;
if ( V_74 && V_74 -> V_115 > V_111 )
V_111 = F_104 ( T_1 , V_74 -> V_115 , V_112 ) ;
F_16 ( V_13 ) -> V_110 = V_111 ;
V_26 = 0 ;
V_68:
if ( V_74 )
F_19 ( V_116 , & V_74 -> V_41 ) ;
F_26 ( & V_25 -> V_51 ) ;
return V_26 ;
}
int F_105 ( struct V_13 * V_13 , T_1 V_15 , T_1 V_117 ,
T_3 * V_61 , int V_4 )
{
struct V_60 * V_118 ;
struct V_1 * V_74 ;
...
unsigned long V_119 ;
unsigned long V_120 ;
T_3 V_114 = F_16 ( V_13 ) -> V_7 -> V_114 ;
int V_76 = 0 ;
V_74 = F_98 ( V_13 , V_15 ) ;
if ( ! V_74 )
return 0 ;
F_25 ( & V_25 -> V_51 ) ;
F_106 (ordered_sum, &ordered->list, list) {
if ( V_117 >= V_118 -> V_121 &&
V_117 < V_118 -> V_121 + V_118 -> V_4 ) {
V_120 = ( V_117 - V_118 -> V_121 ) >>
V_13 -> V_18 -> V_122 ;
V_119 = V_118 -> V_4 >>
V_13 -> V_18 -> V_122 ;
V_119 = F_104 ( int , V_4 - V_76 , V_119 - V_120 ) ;
memcpy ( V_61 + V_76 , V_118 -> V_123 + V_120 ,
V_119 ) ;
V_76 += ( int ) V_119 ;
if ( V_76 == V_4 )
goto V_68;
