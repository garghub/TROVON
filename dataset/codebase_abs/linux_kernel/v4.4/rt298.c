...
V_56 -> V_59 = F_62 ( & V_139 -> V_2 , V_152 ,
sizeof( V_152 ) , V_147 ) ;
if ( ! V_56 -> V_59 )
return - V_148 ;
V_56 -> V_153 = V_58 ;
...
V_56 -> V_59 [ V_57 ] . V_60 ) ;
for ( V_57 = 0 ; V_57 < F_64 ( V_154 ) ; V_57 ++ )
F_15 ( V_56 -> V_70 , V_154 [ V_57 ] . V_3 ,
V_154 [ V_57 ] . V_60 ) ;
if ( V_68 )
V_56 -> V_68 = * V_68 ;
V_146 = F_65 ( V_2 -> V_155 -> V_156 , V_2 ) ;
if ( V_146 ) {
...
V_56 -> V_71 = - 1 ;
if ( V_56 -> V_139 -> V_135 ) {
V_137 = F_66 ( V_56 -> V_139 -> V_135 , NULL , F_43 ,
...
V_137 = F_67 ( & V_139 -> V_2 , & V_167 ,
V_168 , F_64 ( V_168 ) ) ;
return V_137 ;
}
static int F_68 ( struct V_141 * V_139 )
{
struct V_55 * V_56 = F_69 ( V_139 ) ;
if ( V_139 -> V_135 )
F_70 ( V_139 -> V_135 , V_56 ) ;
F_71 ( & V_139 -> V_2 ) ;
return 0 ;
}
