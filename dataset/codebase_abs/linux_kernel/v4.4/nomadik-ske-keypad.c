...
V_56 = F_22 ( V_51 , V_57 , 0 ) ;
if ( ! V_56 ) {
F_20 ( & V_51 -> V_54 , L_3 ) ;
return - V_14 ;
}
V_2 = F_23 ( sizeof( struct V_1 ) , V_58 ) ;
V_32 = F_24 () ;
if ( ! V_2 || ! V_32 ) {
F_20 ( & V_51 -> V_54 , L_4 ) ;
error = - V_59 ;
...
V_2 -> V_32 = V_32 ;
F_25 ( & V_2 -> V_7 ) ;
if ( ! F_26 ( V_56 -> V_61 , F_27 ( V_56 ) , V_51 -> V_62 ) ) {
F_20 ( & V_51 -> V_54 , L_5 ) ;
error = - V_63 ;
goto V_60;
}
V_2 -> V_8 = F_28 ( V_56 -> V_61 , F_27 ( V_56 ) ) ;
if ( ! V_2 -> V_8 ) {
F_20 ( & V_51 -> V_54 , L_6 ) ;
error = - V_64 ;
goto V_65;
}
V_2 -> V_66 = F_29 ( & V_51 -> V_54 , L_7 ) ;
if ( F_30 ( V_2 -> V_66 ) ) {
F_20 ( & V_51 -> V_54 , L_8 ) ;
error = F_31 ( V_2 -> V_66 ) ;
goto V_67;
}
V_2 -> V_68 = F_29 ( & V_51 -> V_54 , NULL ) ;
if ( F_30 ( V_2 -> V_68 ) ) {
F_20 ( & V_51 -> V_54 , L_9 ) ;
error = F_31 ( V_2 -> V_68 ) ;
goto V_69;
...
V_32 -> V_70 . V_71 = V_72 ;
V_32 -> V_62 = L_10 ;
V_32 -> V_54 . V_73 = & V_51 -> V_54 ;
error = F_32 ( V_53 -> V_74 , NULL ,
V_75 , V_76 ,
V_2 -> V_40 , V_32 ) ;
if ( error ) {
F_20 ( & V_51 -> V_54 , L_11 ) ;
...
error = F_36 ( V_2 -> V_45 , NULL , F_16 ,
V_84 , L_15 , V_2 ) ;
if ( error ) {
F_20 ( & V_51 -> V_54 , L_16 , V_2 -> V_45 ) ;
goto V_83;
}
error = F_37 ( V_32 ) ;
if ( error ) {
...
struct V_55 * V_56 = F_22 ( V_51 , V_57 , 0 ) ;
F_40 ( V_2 -> V_45 , V_2 ) ;
F_49 ( V_2 -> V_32 ) ;
F_41 ( V_2 -> V_68 ) ;
F_42 ( V_2 -> V_68 ) ;
...
static int F_50 ( struct V_87 * V_54 )
{
struct V_50 * V_51 = F_51 ( V_54 ) ;
struct V_1 * V_2 = F_48 ( V_51 ) ;
int V_45 = F_21 ( V_51 , 0 ) ;
if ( F_52 ( V_54 ) )
F_53 ( V_45 ) ;
else
F_1 ( V_2 , V_23 , ~ V_24 , 0x0 ) ;
...
static int F_54 ( struct V_87 * V_54 )
{
struct V_50 * V_51 = F_51 ( V_54 ) ;
struct V_1 * V_2 = F_48 ( V_51 ) ;
int V_45 = F_21 ( V_51 , 0 ) ;
