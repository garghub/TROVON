...
V_24 -> V_29 = V_29 ;
F_25 ( V_24 -> V_6 , V_32 ) ;
V_26 = F_26 ( V_24 -> V_6 , V_30 , 0 , V_24 -> V_33 , V_24 ) ;
if ( V_26 ) {
F_19 ( V_24 -> V_33 ) ;
F_20 ( V_29 ) ;
V_24 -> V_29 = NULL ;
...
{
int (* F_29)( struct V_9 * V_10 , unsigned V_11 ,
...
if ( ! F_29 )
return - V_41 ;
return F_29 ( V_10 , V_11 , V_12 , V_13 , V_3 , V_14 ) ;
}
...
V_42 ++ ;
V_10 -> V_16 = F_31 ( V_42 , sizeof( struct V_1 ) , V_34 ) ;
if ( ! V_10 -> V_16 )
return - V_35 ;
