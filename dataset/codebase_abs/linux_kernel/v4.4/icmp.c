...
goto V_136;
F_95 ( & V_153 ) ;
V_49 . V_52 . V_154 [ 1 ] = F_96 ( ( V_153 . V_155 % 86400 ) * V_156 +
V_153 . V_157 / V_158 ) ;
V_49 . V_52 . V_154 [ 2 ] = V_49 . V_52 . V_154 [ 1 ] ;
if ( F_97 ( V_47 , 0 , & V_49 . V_52 . V_154 [ 0 ] , 4 ) )
F_98 () ;
V_49 . V_52 . V_53 = * F_33 ( V_47 ) ;
...
V_160 = V_51 [ V_53 -> type ] . F_108 ( V_47 ) ;
if ( V_160 ) {
F_109 ( V_47 ) ;
return 0 ;
}
...
void F_111 ( struct V_46 * V_47 , T_1 V_103 )
{
...
if ( V_53 -> type != V_151 ) {
F_112 ( V_47 , V_43 , V_103 ) ;
return;
}
if ( type == V_28 && V_23 == V_29 )
F_113 ( V_47 , V_2 , V_103 , 0 , 0 , V_83 , 0 ) ;
else if ( type == V_177 )
F_114 ( V_47 , V_2 , 0 , 0 , V_83 , 0 ) ;
}
static void T_5 F_115 ( struct V_2 * V_2 )
{
int V_178 ;
F_116 (i)
F_117 ( * F_118 ( V_2 -> V_3 . F_1 , V_178 ) ) ;
F_119 ( V_2 -> V_3 . F_1 ) ;
V_2 -> V_3 . F_1 = NULL ;
}
...
F_116 (i) {
struct V_1 * V_4 ;
V_92 = F_122 ( & V_4 , V_180 ,
V_181 , V_83 , V_2 ) ;
if ( V_92 < 0 )
goto V_182;
* F_118 ( V_2 -> V_3 . F_1 , V_178 ) = V_4 ;
V_4 -> V_183 = 2 * F_123 ( 64 * 1024 ) ;
F_124 ( V_4 , V_184 ) ;
