...
static T_5 F_108 ( struct V_250 * V_251 , char * V_252 )
{
return sprintf ( V_252 , L_27 ) ;
}
static T_5 F_109 ( struct V_250 * V_251 , char * V_252 )
{
struct V_220 * V_189 = F_110 ( V_251 ) ;
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
return snprintf ( V_252 , V_253 , L_28 , V_97 -> V_254 ) ;
}
static T_5 F_111 ( struct V_250 * V_251 ,
const char * V_252 , T_6 V_255 )
{
struct V_220 * V_189 = F_110 ( V_251 ) ;
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
unsigned long V_256 ;
T_5 V_10 ;
V_10 = F_98 ( V_252 , 0 , & V_256 ) ;
if ( V_10 < 0 )
return - V_61 ;
if ( V_256 > 1 )
return - V_61 ;
...
static T_5 F_114 ( struct V_250 * V_251 , char * V_252 )
{
struct V_220 * V_189 = F_110 ( V_251 ) ;
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
struct V_182 * V_183 ;
...
V_10 = snprintf ( V_252 , V_253 , L_29 ,
V_183 -> V_188 -> V_228 -> V_258 ) ;
V_123:
F_116 ( & V_97 -> V_243 ) ;
return V_10 ;
}
static int F_117 ( struct V_184 * V_97 , char * V_230 )
{
struct V_220 * V_189 ;
struct V_182 * V_183 ;
int V_10 ;
...
if ( ! V_183 )
goto V_260;
V_183 -> V_188 = F_119 ( V_261 ) ;
if ( F_120 ( V_183 -> V_188 ) )
goto V_262;
V_183 -> V_188 -> V_228 = F_121 (
V_189 , V_230 ) ;
...
static int F_124 ( struct V_184 * V_97 )
{
struct V_226 * V_227 ;
struct V_182 * V_183 ;
int V_10 = - V_257 ;
...
static T_5 F_126 ( struct V_250 * V_251 ,
const char * V_252 , T_6 V_255 )
{
struct V_220 * V_189 = F_110 ( V_251 ) ;
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
unsigned char V_265 [ V_232 ] , * V_266 ;
int V_10 ;
if ( ! strncmp ( V_252 , L_36 , 4 ) ) {
V_10 = F_124 ( V_97 ) ;
return ( ! V_10 ) ? V_255 : V_10 ;
}
if ( strlen ( V_252 ) >= V_232 ) {
F_8 ( L_37
L_38 , V_252 , V_232 ) ;
return - V_61 ;
}
snprintf ( V_265 , V_232 , L_26 , V_252 ) ;
V_266 = strstr ( V_265 , L_21 ) ;
if ( ! V_266 ) {
F_8 ( L_39 ) ;
return - V_61 ;
}
if ( V_265 [ strlen ( V_265 ) - 1 ] == '\n' )
V_265 [ strlen ( V_265 ) - 1 ] = '\0' ;
V_10 = F_117 ( V_97 , & V_265 [ 4 ] ) ;
if ( V_10 < 0 )
return V_10 ;
return V_255 ;
}
static int F_127 ( struct V_220 * V_189 , struct V_267 * V_209 )
{
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
F_128 ( & V_97 -> V_98 ) ;
F_129 () ;
...
static void F_130 ( struct V_220 * V_189 ,
struct V_267 * V_267 )
{
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
F_131 ( & V_97 -> V_98 ) ;
...
static int F_132 ( struct V_44 * V_44 )
{
struct V_5 * V_6 = F_2 ( V_44 , struct V_5 ,
V_44 ) ;
F_4 ( & V_6 -> V_7 , V_8 ) ;
...
static int F_133 ( struct V_83 * V_76 )
{
return 0 ;
}
...
static int F_112 ( struct V_184 * V_97 )
{
return F_152 ( & V_324 ) ;
}
static void F_113 ( struct V_184 * V_97 )
{
F_153 ( & V_324 ) ;
}
