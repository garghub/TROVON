...
{
T_2 V_213 ;
T_2 * V_214 = ( T_2 * ) V_11 -> V_215 ;
struct V_2 * V_2 = F_102 ( V_11 -> V_3 , struct V_2 ,
V_3 ) ;
F_33 ( V_2 , 0x40 + 8 * * V_214 + 7 , & V_213 ) ;
if ( ! V_212 )
V_212 = & V_11 -> V_212 ;
else if ( V_212 -> V_30 & V_216 )
memset ( V_212 -> V_217 , 0 , sizeof( V_212 -> V_217 ) ) ;
else
memset ( V_212 , 0 , sizeof( * V_212 ) ) ;
V_212 -> V_30 &= V_216 | V_218 ;
if ( V_212 -> V_30 & V_216 ) {
V_213 |= V_219 ;
if ( V_212 -> V_30 & V_218 ) {
V_213 &= ~ V_220 ;
...
T_2 V_223 ;
T_4 V_22 ;
V_223 = 0x40 + 0x08 * V_28 ;
F_104 ( V_181 , V_223 + 4 , & V_22 ) ;
F_15 ( & V_181 -> V_3 , L_21 , V_224 , V_28 , V_22 ) ;
V_11 -> V_11 . V_20 = V_25 ;
V_11 -> V_11 . V_22 = V_22 ;
V_11 -> V_11 . V_225 = F_101 ;
V_55 = F_95 ( & V_181 -> V_3 , sizeof( T_2 ) , V_186 ) ;
if ( ! V_55 )
return - V_19 ;
* V_55 = V_28 ;
V_11 -> V_11 . V_215 = V_55 ;
return 0 ;
}
...
F_14 ( V_3 , 0x24 , & V_227 [ 0 ] ) ;
F_14 ( V_3 , 0x20 , & V_227 [ 1 ] ) ;
F_14 ( V_3 , 0x1c , & V_227 [ 2 ] ) ;
for ( V_61 = 0 ; V_61 < V_226 ; ++ V_61 ) {
V_223 = 0x40 + 0x08 * V_61 ;
V_22 = ( V_227 [ V_61 / 4 ] & 0xffffffe0 ) + ( V_61 % 4 ) * 8 ;
F_34 ( V_3 , V_223 + 0x00 , 0x01 ) ;
F_34 ( V_3 , V_223 + 0x01 , 0x33 ) ;
F_34 ( V_3 , V_223 + 0x04 ,
( T_2 ) ( V_22 & 0xff ) ) ;
F_34 ( V_3 , V_223 + 0x05 ,
( T_2 ) ( ( V_22 & 0xff00 ) >> 8 ) ) ;
F_34 ( V_3 , V_223 + 0x06 , V_3 -> V_228 ) ;
if ( V_9 ) {
V_11 = F_107 ( V_9 -> line [ V_61 ] ) ;
F_101 ( & V_11 -> V_11 , NULL ) ;
} else {
F_34 ( V_3 , V_223 + 0x07 , 0x01 ) ;
}
}
return V_226 ;
}
...
struct V_10 * V_11 , int V_28 )
{
V_11 -> V_11 . V_30 |= V_233 ;
V_11 -> V_11 . V_234 = F_112 ;
V_11 -> V_11 . V_235 = F_109 ;
return F_108 ( V_9 , V_27 , V_11 , V_28 ) ;
}
static int F_114 ( struct V_2 * V_3 )
{
#if F_115 ( V_236 ) || F_115 ( V_237 )
return - V_43 ;
#else
return 0 ;
#endif
...
struct V_10 * V_11 , int V_28 )
{
V_11 -> V_11 . V_30 |= V_238 ;
return F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
}
static inline int
F_117 ( struct V_8 * V_9 )
{
const int V_239 = V_9 -> V_3 -> V_5 ;
return ( ( V_239 == V_240 ) ||
( V_239 == V_241 ) ) ;
}
static int
...
F_26 ( 0x00 , V_45 + V_242 ) ;
F_26 ( V_243 , V_45 + V_244 ) ;
F_26 ( 128 , V_45 + V_245 ) ;
F_26 ( 128 , V_45 + V_246 ) ;
F_20 ( V_45 ) ;
return F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
...
{
V_11 -> V_11 . V_30 |= V_154 ;
V_11 -> V_11 . type = V_251 ;
return F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
}
static inline int F_122 ( T_1 V_252 , T_1 V_239 )
{
return V_252 == V_253 || V_252 == V_239 ;
}
static struct V_254 * F_123 ( struct V_2 * V_3 )
{
struct V_254 * V_255 ;
for ( V_255 = V_256 ; ; V_255 ++ )
if ( F_122 ( V_255 -> V_4 , V_3 -> V_4 ) &&
F_122 ( V_255 -> V_5 , V_3 -> V_5 ) &&
F_122 ( V_255 -> V_257 , V_3 -> V_6 ) &&
F_122 ( V_255 -> V_258 , V_3 -> V_7 ) )
break;
return V_255 ;
}
...
int V_262 , V_263 , V_264 = - 1 , V_61 ;
if ( ( ( ( V_3 -> V_85 >> 8 ) != V_265 ) &&
( ( V_3 -> V_85 >> 8 ) != V_266 ) ) ||
( V_3 -> V_85 & 0xff ) > 6 )
return - V_43 ;
for ( V_261 = V_267 ;
V_261 < V_267 + F_40 ( V_267 ) ;
V_261 ++ ) {
if ( V_3 -> V_4 == V_261 -> V_4 &&
V_3 -> V_5 == V_261 -> V_5 )
return - V_43 ;
}
V_262 = V_263 = 0 ;
for ( V_61 = 0 ; V_61 < V_15 ; V_61 ++ ) {
if ( F_5 ( V_3 , V_61 ) & V_268 ) {
V_263 ++ ;
if ( V_264 == - 1 )
V_264 = V_61 ;
}
...
const struct V_26 * V_269 )
{
return
V_27 -> V_80 == V_269 -> V_80 &&
V_27 -> V_270 == V_269 -> V_270 &&
V_27 -> V_31 == V_269 -> V_31 &&
V_27 -> V_32 == V_269 -> V_32 &&
V_27 -> V_29 == V_269 -> V_29 ;
}
struct V_8 *
...
V_271 . V_11 . V_30 = V_276 | V_277 | V_278 ;
V_271 . V_11 . V_147 = V_27 -> V_270 * 16 ;
V_271 . V_11 . V_228 = F_124 ( V_3 , V_27 ) ;
V_271 . V_11 . V_3 = & V_3 -> V_3 ;
for ( V_61 = 0 ; V_61 < V_272 ; V_61 ++ ) {
if ( V_255 -> V_279 ( V_9 , V_27 , & V_271 , V_61 ) )
break;
F_15 ( & V_3 -> V_3 , L_23 ,
V_271 . V_11 . V_22 , V_271 . V_11 . V_228 , V_271 . V_11 . V_20 ) ;
V_9 -> line [ V_61 ] = F_130 ( & V_271 ) ;
if ( V_9 -> line [ V_61 ] < 0 ) {
F_2 ( & V_3 -> V_3 ,
L_24 ,
V_271 . V_11 . V_22 , V_271 . V_11 . V_228 ,
V_271 . V_11 . V_20 , V_9 -> line [ V_61 ] ) ;
break;
}
}
V_9 -> V_280 = V_61 ;
...
struct V_254 * V_255 ;
int V_61 ;
for ( V_61 = 0 ; V_61 < V_9 -> V_280 ; V_61 ++ )
F_132 ( V_9 -> line [ V_61 ] ) ;
for ( V_61 = 0 ; V_61 < V_15 ; V_61 ++ ) {
if ( V_9 -> V_18 [ V_61 ] )
F_20 ( V_9 -> V_18 [ V_61 ] ) ;
...
F_135 ( V_9 -> line [ V_61 ] ) ;
if ( V_9 -> V_255 -> exit )
V_9 -> V_255 -> exit ( V_9 -> V_3 ) ;
}
void F_136 ( struct V_8 * V_9 )
{
int V_61 ;
if ( V_9 -> V_255 -> V_273 )
V_9 -> V_255 -> V_273 ( V_9 -> V_3 ) ;
for ( V_61 = 0 ; V_61 < V_9 -> V_280 ; V_61 ++ )
if ( V_9 -> line [ V_61 ] >= 0 )
F_137 ( V_9 -> line [ V_61 ] ) ;
}
static int
F_138 ( struct V_2 * V_3 , const struct V_260 * V_281 )
{
struct V_254 * V_255 ;
struct V_8 * V_9 ;
const struct V_26 * V_27 ;
...
V_255 = F_123 ( V_3 ) ;
if ( V_255 -> V_282 ) {
V_33 = V_255 -> V_282 ( V_3 ) ;
if ( V_33 )
return V_33 ;
}
if ( V_281 -> V_283 >= F_40 ( V_284 ) ) {
F_2 ( & V_3 -> V_3 , L_25 ,
V_281 -> V_283 ) ;
return - V_16 ;
}
V_27 = & V_284 [ V_281 -> V_283 ] ;
V_33 = F_139 ( V_3 ) ;
F_140 ( V_3 ) ;
if ( V_33 )
return V_33 ;
if ( V_281 -> V_283 == V_285 ) {
