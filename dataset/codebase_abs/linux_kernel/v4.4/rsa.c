...
if ( V_15 )
goto V_23;
V_15 = F_16 ( V_3 , V_13 -> V_24 , & V_13 -> V_19 , & V_16 ) ;
if ( V_15 )
goto V_23;
if ( V_16 < 0 )
V_15 = - V_25 ;
...
if ( V_15 )
goto V_18;
V_15 = F_16 ( V_4 , V_13 -> V_24 , & V_13 -> V_19 , & V_16 ) ;
if ( V_15 )
goto V_18;
if ( V_16 < 0 )
V_15 = - V_25 ;
...
if ( V_15 )
goto V_23;
V_15 = F_16 ( V_9 , V_13 -> V_24 , & V_13 -> V_19 , & V_16 ) ;
if ( V_15 )
goto V_23;
if ( V_16 < 0 )
V_15 = - V_25 ;
...
static int F_21 ( unsigned int V_27 )
{
switch ( V_27 ) {
case 512 :
case 1024 :
...
int V_15 ;
V_15 = F_23 ( V_14 , V_2 , V_28 ) ;
if ( V_15 )
return V_15 ;
if ( F_21 ( F_14 ( V_14 -> V_5 ) << 3 ) ) {
F_24 ( V_14 ) ;
V_15 = - V_6 ;
}
return V_15 ;
}
static int F_25 ( struct V_10 * V_11 , const void * V_2 ,
unsigned int V_28 )
{
struct V_1 * V_14 = F_9 ( V_11 ) ;
int V_15 ;
V_15 = F_26 ( V_14 , V_2 , V_28 ) ;
if ( V_15 )
return V_15 ;
if ( F_21 ( F_14 ( V_14 -> V_5 ) << 3 ) ) {
F_24 ( V_14 ) ;
...
{
struct V_1 * V_14 = F_9 ( V_11 ) ;
return V_14 -> V_5 ? F_14 ( V_14 -> V_5 ) : - V_6 ;
}
