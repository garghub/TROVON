...
for (; V_90 < V_123 ; V_90 ++ ) {
int V_128 = F_47 ( V_124 , V_123 - V_90 ) ;
int V_129 = F_47 ( V_125 , V_123 - V_90 ) ;
V_126 = F_29 ( V_2 , V_123 , V_90 ,
V_129 , V_92 ,
V_128 , V_94 ) ;
if ( V_126 )
...
void F_60 ( struct V_83 * V_20 , T_3 V_142 ,
...
V_144 |= V_149 | V_150 ;
V_147 -> V_142 = F_62 ( V_142 ) ;
V_147 -> V_151 = F_62 ( V_143 ) ;
V_147 -> V_152 = F_62 ( V_144 ) ;
V_147 -> V_145 = F_62 ( V_145 ) ;
}
