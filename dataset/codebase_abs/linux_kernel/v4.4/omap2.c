...
const T_9 * V_31 , int V_212 , int V_67 )
{
int V_49 ;
...
V_22 = & V_7 -> V_22 ;
V_22 -> V_35 = & V_7 -> V_34 ;
V_22 -> V_74 . V_257 = & V_75 -> V_74 ;
V_33 = & V_7 -> V_34 ;
V_33 -> V_116 . V_35 = NULL ;
V_250 = F_99 ( V_75 , V_258 , 0 ) ;
V_33 -> V_36 = F_100 ( & V_75 -> V_74 , V_250 ) ;
if ( F_101 ( V_33 -> V_36 ) )
return F_102 ( V_33 -> V_36 ) ;
V_7 -> V_259 = V_250 -> V_260 ;
V_33 -> V_261 = & V_262 ;
V_33 -> V_39 = V_33 -> V_36 ;
V_33 -> V_263 = F_6 ;
if ( V_237 -> V_264 ) {
...
if ( V_237 -> V_267 )
V_33 -> V_268 |= V_269 | V_270 ;
else
V_33 -> V_44 |= V_271 ;
V_33 -> V_44 |= V_237 -> V_272 & V_45 ;
if ( F_103 ( V_22 , 1 , NULL ) ) {
...
F_105 ( V_279 , V_246 ) ;
V_247 = V_280 ;
V_7 -> V_72 = F_106 ( V_246 , V_281 , & V_247 ) ;
if ( ! V_7 -> V_72 ) {
F_31 ( & V_75 -> V_74 , L_20 ) ;
V_201 = - V_273 ;
goto V_274;
...
V_283 . V_284 = V_7 -> V_259 ;
V_283 . V_285 = V_7 -> V_259 ;
V_283 . V_286 = V_287 ;
V_283 . V_288 = V_287 ;
V_283 . V_289 = 16 ;
V_283 . V_290 = 16 ;
V_201 = F_107 ( V_7 -> V_72 , & V_283 ) ;
if ( V_201 ) {
F_31 ( & V_75 -> V_74 , L_21 ,
V_201 ) ;
goto V_274;
...
break;
case V_291 :
V_7 -> V_93 = F_108 ( V_75 , 0 ) ;
if ( V_7 -> V_93 <= 0 ) {
F_31 ( & V_75 -> V_74 , L_22 ) ;
V_201 = - V_253 ;
goto V_274;
}
V_201 = F_109 ( & V_75 -> V_74 , V_7 -> V_93 ,
F_40 , V_292 ,
L_23 , V_7 ) ;
if ( V_201 ) {
F_31 ( & V_75 -> V_74 , L_24 ,
...
V_7 -> V_89 = F_108 ( V_75 , 1 ) ;
if ( V_7 -> V_89 <= 0 ) {
F_31 ( & V_75 -> V_74 , L_25 ) ;
V_201 = - V_253 ;
goto V_274;
}
V_201 = F_109 ( & V_75 -> V_74 , V_7 -> V_89 ,
F_40 , V_292 ,
L_26 , V_7 ) ;
if ( V_201 ) {
F_31 ( & V_75 -> V_74 , L_24 ,
...
V_33 -> V_116 . V_220 = F_83 ;
V_33 -> V_116 . V_301 = F_89 ;
V_33 -> V_116 . V_302 = F_88 ;
V_245 -> V_165 = V_33 -> V_116 . V_86 *
( V_22 -> V_219 /
V_33 -> V_116 . V_119 ) ;
V_248 = V_297 ;
...
if ( V_7 -> V_145 == V_294 )
goto V_306;
V_245 -> V_298 -> V_307 = V_22 -> V_84 - V_245 -> V_298 -> V_299 ;
if ( V_22 -> V_84 < ( V_245 -> V_165 + V_297 ) ) {
F_31 ( & V_7 -> V_75 -> V_74 ,
L_36 ,
...
F_114 ( V_22 , NULL , & V_252 , V_237 -> V_308 ,
V_237 -> V_309 ) ;
F_98 ( V_75 , V_22 ) ;
return 0 ;
V_274:
...
F_115 ( V_7 -> V_72 ) ;
if ( V_33 -> V_116 . V_35 ) {
F_116 ( V_33 -> V_116 . V_35 ) ;
V_33 -> V_116 . V_35 = NULL ;
}
return V_201 ;
}
static int F_117 ( struct V_235 * V_75 )
{
struct V_21 * V_22 = F_118 ( V_75 ) ;
