...
static int F_34 ( struct V_59 * V_46 , unsigned int V_90 )
{
struct V_1 * V_2 = V_46 -> V_60 ;
F_35 ( V_2 , true ) ;
return 0 ;
}
static void F_36 ( struct V_59 * V_46 , unsigned int V_90 )
{
struct V_1 * V_2 = V_46 -> V_60 ;
F_35 ( V_2 , false ) ;
}
static int F_37 ( struct V_91 * V_46 )
{
...
static int F_41 ( struct V_91 * V_46 )
{
struct V_1 * V_2 = F_38 ( V_46 ) ;
F_42 ( V_2 -> V_74 ) ;
F_43 ( & V_2 -> V_82 ) ;
