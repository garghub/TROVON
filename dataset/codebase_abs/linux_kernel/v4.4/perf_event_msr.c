...
V_31 = F_12 ( V_31 , 31 ) ;
F_13 ( V_29 - V_30 , & V_11 -> V_35 ) ;
}
static void F_14 ( struct V_10 * V_11 , int V_36 )
{
T_1 V_29 ;
V_29 = F_5 ( V_11 ) ;
F_15 ( & V_11 -> V_27 . V_33 , V_29 ) ;
}
static void F_16 ( struct V_10 * V_11 , int V_36 )
{
F_8 ( V_11 ) ;
}
static void F_17 ( struct V_10 * V_11 , int V_36 )
{
F_16 ( V_11 , V_37 ) ;
}
static int F_18 ( struct V_10 * V_11 , int V_36 )
{
if ( V_36 & V_38 )
F_14 ( V_11 , V_36 ) ;
return 0 ;
...
T_1 V_43 ;
if ( ! V_26 [ V_39 ] . F_21 ( V_39 ) || F_22 ( V_26 [ V_39 ] . V_26 , & V_43 ) )
V_26 [ V_39 ] . V_13 = NULL ;
}
