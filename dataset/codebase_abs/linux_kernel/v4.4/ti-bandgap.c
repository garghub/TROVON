...
T_1 V_5 ;
V_18 = V_2 -> V_10 -> V_20 [ V_7 ] . V_21 ;
V_5 = F_1 ( V_2 , V_18 -> V_129 ) ;
if ( V_57 || ! V_5 )
F_67 ( & V_103 -> V_39 ,
L_25 ) ;
}
V_79 = F_68 ( V_2 -> V_127 ,
V_2 -> V_10 -> V_20 [ 0 ] . V_61 -> V_130 ) ;
if ( V_79 < V_2 -> V_10 -> V_20 [ 0 ] . V_61 -> V_131 ||
V_79 <= 0 ) {
V_57 = - V_132 ;
...
for ( V_7 = 0 ; V_7 < V_2 -> V_10 -> V_11 ; V_7 ++ ) {
char * V_41 ;
if ( V_2 -> V_10 -> V_20 [ V_7 ] . V_141 ) {
V_57 = V_2 -> V_10 -> V_20 [ V_7 ] . V_141 ( V_2 , V_7 ) ;
if ( V_57 )
goto V_142;
}
if ( V_2 -> V_10 -> V_143 ) {
V_41 = V_2 -> V_10 -> V_20 [ V_7 ] . V_41 ;
V_57 = V_2 -> V_10 -> V_143 ( V_2 , V_7 , V_41 ) ;
if ( V_57 )
goto V_144;
}
}
...
return 0 ;
V_144:
if ( V_2 -> V_10 -> V_20 [ V_7 ] . V_146 )
V_2 -> V_10 -> V_20 [ V_7 ] . V_146 ( V_2 , V_7 ) ;
V_142:
for ( V_7 -- ; V_7 >= 0 ; V_7 -- ) {
if ( V_2 -> V_10 -> V_20 [ V_7 ] . V_146 )
V_2 -> V_10 -> V_20 [ V_7 ] . V_146 ( V_2 , V_7 ) ;
if ( V_2 -> V_10 -> V_147 )
V_2 -> V_10 -> V_147 ( V_2 , V_7 ) ;
}
F_5 ( V_2 , false ) ;
V_145:
if ( F_6 ( V_2 , V_134 ) )
...
static int F_80 ( struct V_153 * V_39 )
{
...
static int F_82 ( struct V_153 * V_39 )
{
struct V_1 * V_2 = F_81 ( V_39 ) ;
if ( F_6 ( V_2 , V_134 ) )
F_70 ( V_2 -> V_124 ) ;
