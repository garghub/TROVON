...
if ( V_5 < 0 )
goto V_33;
V_5 = F_27 ( V_2 -> V_10 , F_21 ) ;
if ( V_5 < 0 ) {
F_28 ( V_2 -> V_10 ) ;
goto V_33;
}
if ( V_2 -> V_10 -> V_34 == V_35 )
F_7 ( V_2 -> V_10 , 0x00 , V_36 , NULL ) ;
F_7 ( V_2 -> V_10 , 0x01 , V_37 , NULL ) ;
V_33:
F_14 ( V_2 -> V_10 ) ;
return V_5 ;
}
static int F_29 ( struct V_32 * V_6 )
{
struct V_1 * V_2 = F_25 ( V_6 ) ;
F_2 ( L_1 , V_6 -> V_7 ) ;
F_11 ( V_2 -> V_10 ) ;
F_7 ( V_2 -> V_10 , 0x00 , V_37 , NULL ) ;
F_30 ( V_2 -> V_10 ) ;
F_28 ( V_2 -> V_10 ) ;
F_14 ( V_2 -> V_10 ) ;
return 0 ;
...
static int F_33 ( struct V_32 * V_6 , struct V_3 * V_4 )
{
struct V_1 * V_2 = F_25 ( V_6 ) ;
F_2 ( L_1 , V_6 -> V_7 ) ;
switch ( F_4 ( V_4 ) -> V_9 ) {
...
static int F_36 ( struct V_27 * V_10 ,
...
int V_5 ;
F_2 ( L_2 , V_10 , V_45 , V_10 -> V_34 ) ;
while ( V_47 ) {
F_2 ( L_3 , V_47 -> V_49 , V_47 -> V_50 ) ;
V_47 = V_47 -> V_51 ;
}
V_2 = F_37 ( & V_10 -> V_52 , sizeof( * V_2 ) , V_23 ) ;
if ( ! V_2 )
return - V_24 ;
V_2 -> V_10 = V_10 ;
F_38 ( & V_2 -> V_16 , F_9 ) ;
...
V_6 -> V_61 = F_31 ;
V_6 -> V_62 = F_33 ;
if ( V_10 -> V_63 == 0x0104 && V_10 -> V_64 == 0x00c5 )
F_43 ( V_65 , & V_6 -> V_66 ) ;
V_5 = F_44 ( V_6 ) ;
if ( V_5 < 0 ) {
F_45 ( V_6 ) ;
...
static void F_47 ( struct V_27 * V_10 )
{
struct V_1 * V_2 = F_22 ( V_10 ) ;
struct V_32 * V_6 ;
F_2 ( L_4 , V_10 ) ;
