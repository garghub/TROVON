...
static int
F_9 ( struct V_16 * V_27 , unsigned V_24 , unsigned V_25 ,
...
static int
F_12 ( char * V_38 , int V_39 , struct V_29 * V_30 ,
bool V_28 )
{
int V_9 ;
char V_40 [] = L_4 ;
...
V_9 = F_13 ( V_38 , V_39 , L_6 , V_30 -> V_34 ) ;
else if ( V_30 -> V_36 == 1 )
V_9 = F_13 ( V_38 , V_39 , L_7 ,
V_40 , V_30 -> V_34 , V_30 -> V_35 , V_41 ) ;
else
V_9 = F_13 ( V_38 , V_39 , L_8 ,
V_40 , V_30 -> V_34 , V_30 -> V_35 ,
V_30 -> V_36 , V_41 ) ;
return V_9 ;
}
int
F_14 ( char * V_38 , int V_39 , struct V_42 * V_43 )
{
struct V_29 * V_30 ;
int V_9 = 0 , V_44 = 0 ;
int V_45 = 0 ;
...
V_45 ++ ;
if ( V_45 > 1 )
V_9 += F_13 ( V_38 + V_9 , V_39 - V_9 , L_4 ) ;
F_15 (expr, &expr_list->el_exprs, re_link) {
if ( V_44 ++ != 0 )
V_9 += F_13 ( V_38 + V_9 , V_39 - V_9 , L_9 ) ;
V_9 += F_12 ( V_38 + V_9 , V_39 - V_9 , V_30 ,
V_45 > 1 ) ;
}
if ( V_45 > 1 )
V_9 += F_13 ( V_38 + V_9 , V_39 - V_9 , L_5 ) ;
return V_9 ;
}
int
F_16 ( T_2 V_46 , struct V_42 * V_43 )
{
struct V_29 * V_30 ;
F_15 (expr, &expr_list->el_exprs, re_link) {
if ( V_46 >= V_30 -> V_34 && V_46 <= V_30 -> V_35 &&
( ( V_46 - V_30 -> V_34 ) % V_30 -> V_36 ) == 0 )
return 1 ;
}
return 0 ;
}
int
F_17 ( struct V_42 * V_43 , int V_25 , T_2 * * V_47 )
{
struct V_29 * V_30 ;
T_2 * V_48 ;
int V_39 = 0 ;
...
{
while ( ! F_20 ( & V_43 -> V_49 ) ) {
struct V_29 * V_30 ;
V_30 = F_21 ( V_43 -> V_49 . V_17 ,
struct V_29 , V_50 ) ;
F_22 ( & V_30 -> V_50 ) ;
F_11 ( V_30 , sizeof( * V_30 ) ) ;
}
...
V_52 = F_9 ( & V_32 , V_24 , V_25 , 1 , & V_30 ) ;
if ( V_52 != 0 )
break;
F_25 ( & V_30 -> V_50 ,
& V_43 -> V_49 ) ;
...
V_52 = F_9 ( & V_27 , V_24 , V_25 , 0 , & V_30 ) ;
if ( V_52 == 0 ) {
F_25 ( & V_30 -> V_50 ,
& V_43 -> V_49 ) ;
}
