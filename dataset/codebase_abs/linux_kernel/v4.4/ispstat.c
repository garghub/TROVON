...
int F_47 ( struct V_1 * V_2 , void * V_72 )
{
int V_19 ;
unsigned long V_73 ;
struct V_74 * V_75 = V_72 ;
T_1 V_5 = V_75 -> V_5 ;
if ( ! V_72 ) {
...
F_24 ( & V_2 -> V_9 -> V_45 , V_73 ) ;
V_2 -> V_76 -> V_81 ( V_2 , V_72 ) ;
F_25 ( & V_2 -> V_9 -> V_45 , V_73 ) ;
V_75 -> V_42 = V_2 -> V_42 + V_2 -> V_82 ;
V_2 -> V_83 = 1 ;
...
static int F_50 ( struct V_1 * V_2 , int V_84 )
{
int V_19 = V_40 ;
if ( ! F_51 ( & V_2 -> V_68 , - 1 , 0 ) &&
V_84 == V_43 && V_2 -> V_56 == V_70 ) {
V_19 = F_20 ( V_2 ) ;
F_22 ( V_2 ) ;
}
return V_19 ;
...
static void F_54 ( struct V_1 * V_2 , T_4 V_86 )
{
if ( ( V_2 -> V_56 != V_87 &&
V_2 -> V_56 != V_70 ) && V_86 )
return;
V_2 -> V_76 -> V_88 ( V_2 , V_86 ) ;
if ( V_2 -> V_56 == V_89 && ! V_86 )
V_2 -> V_56 = V_57 ;
else if ( V_2 -> V_56 == V_87 && V_86 )
V_2 -> V_56 = V_70 ;
}
...
return;
F_24 ( & V_2 -> V_9 -> V_45 , V_73 ) ;
if ( V_2 -> V_56 == V_87 && ! V_2 -> V_58 &&
V_2 -> V_51 ) {
V_2 -> V_92 = 1 ;
F_22 ( V_2 ) ;
V_2 -> V_76 -> V_93 ( V_2 , V_2 -> V_91 ) ;
F_11 ( V_2 , V_2 -> V_37 ) ;
if ( ! F_48 ( V_2 ) )
F_58 ( & V_2 -> V_68 , 0 ) ;
F_54 ( V_2 , 1 ) ;
...
int F_61 ( struct V_1 * V_2 , T_4 V_88 )
{
unsigned long V_73 ;
F_9 ( V_2 -> V_9 -> V_10 , L_29 ,
V_2 -> V_24 . V_25 , V_88 ? L_30 : L_31 ) ;
F_43 ( & V_2 -> V_71 ) ;
F_24 ( & V_2 -> V_9 -> V_45 , V_73 ) ;
if ( ! V_2 -> V_83 && V_88 ) {
F_25 ( & V_2 -> V_9 -> V_45 , V_73 ) ;
...
int F_62 ( struct V_95 * V_24 , int V_88 )
{
...
static void F_65 ( struct V_1 * V_2 , int V_96 )
{
int V_19 = V_43 ;
int V_58 ;
unsigned long V_73 ;
...
F_25 ( & V_2 -> V_9 -> V_45 , V_73 ) ;
if ( ! F_52 ( V_2 ) ) {
if ( ! V_96 && V_2 -> V_76 -> V_100 )
V_19 = V_2 -> V_76 -> V_100 ( V_2 ) ;
if ( V_19 == V_101 )
return;
F_24 ( & V_2 -> V_9 -> V_45 , V_73 ) ;
if ( V_2 -> V_56 == V_89 ) {
...
V_98 = F_66 ( & V_2 -> V_24 . V_102 ) ;
V_2 -> V_39 = F_67 ( & V_98 -> V_39 ) ;
V_19 = F_50 ( V_2 , V_19 ) ;
if ( F_8 ( ! V_2 -> V_94 ) ) {
V_2 -> V_76 -> V_93 ( V_2 , V_2 -> V_91 ) ;
} else {
V_2 -> V_92 = 1 ;
V_2 -> V_76 -> V_93 ( V_2 , V_2 -> V_79 ) ;
V_2 -> V_94 = 0 ;
V_2 -> V_92 = 1 ;
}
F_11 ( V_2 , V_2 -> V_37 ) ;
...
int F_69 ( struct V_95 * V_24 ,
struct V_103 * V_104 ,
struct V_105 * V_106 )
{
struct V_1 * V_2 = F_63 ( V_24 ) ;
if ( V_106 -> type != V_2 -> V_69 )
return - V_20 ;
return F_70 ( V_104 , V_106 , V_107 , NULL ) ;
}
int F_71 ( struct V_95 * V_24 ,
struct V_103 * V_104 ,
struct V_105 * V_106 )
{
return F_72 ( V_104 , V_106 ) ;
}
...
{
struct V_95 * V_24 = & V_2 -> V_24 ;
struct V_111 * V_112 = & V_24 -> V_102 ;
F_78 ( V_24 , V_110 ) ;
snprintf ( V_24 -> V_25 , V_113 , L_39 , V_25 ) ;
V_24 -> V_114 = 1 << 16 ;
V_24 -> V_44 |= V_115 | V_116 ;
F_79 ( V_24 , V_2 ) ;
V_2 -> V_117 . V_44 = V_118 | V_119 ;
V_112 -> V_76 = NULL ;
return F_80 ( V_112 , 1 , & V_2 -> V_117 , 0 ) ;
}
