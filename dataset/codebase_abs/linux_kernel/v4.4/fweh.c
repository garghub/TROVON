...
F_11 ( V_28 , L_9 ,
F_1 ( V_9 -> V_2 ) , V_9 -> V_2 ,
V_9 -> V_18 . V_30 , V_9 -> V_18 . V_50 ,
V_9 -> V_18 . V_41 ) ;
V_49 = & V_9 -> V_18 ;
V_18 . V_51 = F_24 ( V_49 -> V_51 ) ;
V_18 . V_10 = F_24 ( V_49 -> V_10 ) ;
V_18 . V_44 = V_9 -> V_2 ;
V_18 . V_52 = F_25 ( V_49 -> V_52 ) ;
V_18 . V_53 = F_25 ( V_49 -> V_53 ) ;
V_18 . V_54 = F_25 ( V_49 -> V_54 ) ;
V_18 . V_55 = F_25 ( V_49 -> V_55 ) ;
memcpy ( V_18 . V_41 , V_49 -> V_41 , V_56 ) ;
memcpy ( V_18 . V_40 , V_49 -> V_40 , sizeof( V_18 . V_40 ) ) ;
V_18 . V_30 = V_49 -> V_30 ;
V_18 . V_50 = V_49 -> V_50 ;
F_11 ( V_28 , L_10 ,
V_18 . V_51 , V_18 . V_10 , V_18 . V_52 , V_18 . V_53 ) ;
F_26 ( F_27 () , V_9 -> V_19 ,
F_28 ( V_57 , V_18 . V_55 , 64 ) ,
L_11 , V_18 . V_55 ) ;
if ( V_9 -> V_2 == V_42 ) {
...
void F_30 ( struct V_15 * V_16 , bool V_60 )
{
V_16 -> V_22 -> V_7 . V_36 = V_60 ;
}
...
void * V_19 ;
V_57 V_55 ;
V_2 = F_45 ( & V_68 -> V_71 . V_72 ) ;
V_55 = F_45 ( & V_68 -> V_71 . V_55 ) ;
V_19 = & V_68 [ 1 ] ;
if ( V_2 >= V_66 )
return;
...
if ( F_46 () )
V_69 = V_73 ;
V_9 = F_47 ( sizeof( * V_9 ) + V_55 , V_69 ) ;
if ( ! V_9 )
return;
V_9 -> V_2 = V_2 ;
V_9 -> V_30 = V_68 -> V_71 . V_30 ;
memcpy ( & V_9 -> V_18 , & V_68 -> V_71 , sizeof( V_9 -> V_18 ) ) ;
memcpy ( V_9 -> V_19 , V_19 , V_55 ) ;
memcpy ( V_9 -> V_74 , V_68 -> V_75 . V_76 , V_56 ) ;
F_3 ( V_7 , V_9 ) ;
}
