...
static int F_22 ( struct V_19 * V_20 , void * * V_25 )
{
struct V_2 * V_3 ;
struct V_1 * V_4 ;
V_3 = F_23 ( V_26 , V_24 , true ) ;
V_4 = F_1 ( V_3 ) ;
return F_16 ( V_4 , 1 ) ;
}
static void F_24 ( struct V_19 * V_20 , void * V_27 )
{
struct V_2 * V_3 ;
struct V_1 * V_4 ;
V_3 = F_23 ( V_26 , V_24 , true ) ;
...
static T_2 F_26 ( struct V_28 * V_29 , char * V_30 ,
T_3 V_31 , T_4 V_32 )
{
...
static int F_30 ( struct V_37 * V_38 , void * V_39 )
{
struct V_2 * V_3 = F_31 ( V_38 ) ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
T_1 V_8 = V_4 -> V_8 ;
if ( V_8 >= V_9 )
F_32 ( V_38 , L_1 , V_34 ) ;
