...
{
V_50 -> V_34 . V_52 = V_139 ;
V_50 -> V_34 . V_35 = V_140 ;
V_50 -> V_34 . V_107 = V_141 ;
V_50 -> V_34 . V_37 = V_62 ;
}
...
if ( ! V_84 )
return 0 ;
V_101 = ( void * ) F_70 ( V_144 ) ;
if ( ! V_101 )
return - V_91 ;
if ( ! V_60 )
V_145 . V_46 . V_25 = V_26 ;
V_59 = F_32 ( & V_146 -> V_44 , & V_147 ) ;
if ( V_59 )
return V_59 ;
F_67 ( V_101 ) ;
if ( V_39 . type == V_8 ) {
...
{
int V_59 ;
V_102 = ( void * ) F_70 ( V_144 ) ;
if ( ! V_102 )
return - V_91 ;
if ( V_84 ) {
if ( ! V_60 )
V_149 . V_46 . V_25 = V_26 ;
V_59 = F_32 ( & V_146 -> V_44 ,
& V_150 ) ;
} else {
if( ! V_60 )
...
if ( V_39 . type == V_4 ) {
F_6 ( V_153 ) ;
V_154 . V_46 . V_25 = V_26 ;
} else
return 0 ;
}
V_103 = ( void * ) F_70 ( V_144 ) ;
if ( ! V_103 )
return - V_91 ;
V_155 = F_31 ( V_5 , NULL ,
& V_146 -> V_44 ) ;
...
{
int V_59 ;
V_146 = F_31 ( L_14 , NULL , V_90 ) ;
if ( ! V_146 )
return - V_91 ;
V_59 = F_78 ( & V_146 -> V_44 , & V_159 . V_46 ) ;
if ( V_59 ) {
F_74 ( V_146 ) ;
return V_59 ;
}
...
static void F_82 ( void * V_167 )
{
F_4 ( V_138 , V_167 ) ;
while ( 1 ) {
if ( F_4 ( V_168 , NULL ) != 0x302 )
break;
F_83 ( V_169 ) ;
}
}
...
switch ( V_161 ) {
case V_164 :
V_136 . V_137 = V_170 -> V_39 . V_54 . V_137 ;
V_136 . V_72 = V_170 -> V_39 . V_54 . V_72 ;
F_27 ( & V_136 ) ;
break;
case V_163 :
sprintf ( V_65 , L_15 ) ;
F_26 ( V_65 , NULL , 0 , NULL ) ;
sprintf ( V_65 , L_16 , V_170 -> V_39 . V_54 . V_72 ) ;
F_26 ( V_65 , NULL , 0 , NULL ) ;
break;
case V_162 :
F_82 ( V_170 ) ;
...
{
int V_59 ;
V_170 = ( void * ) F_70 ( V_144 ) ;
if ( ! V_170 )
return - V_91 ;
V_59 = F_32 ( & V_172 -> V_44 , & V_173 ) ;
if ( V_59 ) {
F_73 ( ( unsigned long ) V_170 ) ;
return V_59 ;
}
V_170 -> V_34 . V_52 = V_139 ;
V_170 -> V_34 . V_35 = V_140 ;
V_170 -> V_34 . V_107 = V_141 ;
V_170 -> V_34 . V_37 = V_62 ;
V_160 |= V_15 ;
return 0 ;
}
...
if ( ! V_60 )
return 0 ;
V_171 = ( void * ) F_70 ( V_144 ) ;
if ( ! V_171 )
return - V_91 ;
V_59 = F_32 ( & V_172 -> V_44 , & V_175 ) ;
if ( V_59 ) {
F_73 ( ( unsigned long ) V_171 ) ;
return V_59 ;
}
V_171 -> V_34 . V_52 = V_106 ;
V_171 -> V_34 . V_35 = V_140 ;
V_171 -> V_34 . V_107 = V_108 ;
V_171 -> V_34 . V_37 = V_38 ;
V_171 -> V_39 . V_40 . V_41 = V_42 ;
V_160 |= V_17 ;
return 0 ;
}
...
{
int V_59 ;
V_172 = F_31 ( L_17 , NULL , V_90 ) ;
if ( ! V_172 )
return - V_91 ;
V_59 = F_78 ( & V_172 -> V_44 , & V_176 . V_46 ) ;
if ( V_59 ) {
F_74 ( V_172 ) ;
return V_59 ;
}
...
unsigned int V_178 ;
V_178 = F_91 ( V_117 , V_117 -> V_34 . V_52 , 0 ) ;
F_92 ( V_179 . V_177 , V_177 ) ;
F_92 ( V_179 . V_180 , V_178 ) ;
F_85 ( V_88 ) ;
}
...
{
char * V_182 ;
if ( strcmp ( V_88 -> V_183 , V_184 ) == 0 )
V_182 = V_185 ;
else if ( strcmp ( V_88 -> V_183 , V_186 ) == 0 )
V_182 = V_187 ;
else if ( strcmp ( V_88 -> V_183 , V_188 ) == 0 )
V_182 = V_189 ;
else if ( strcmp ( V_88 -> V_183 , V_190 ) == 0 )
V_182 = V_191 ;
else if ( strcmp ( V_88 -> V_183 , V_192 ) == 0 )
V_182 = V_193 ;
else
return;
if ( strlen ( V_182 ) == 0 )
return;
F_26 ( V_182 , NULL , 0 , NULL ) ;
}
static int F_95 ( void )
{
if ( ! V_84 )
return - V_181 ;
V_194 = F_31 ( L_18 , NULL , V_90 ) ;
if ( ! V_194 )
return - V_91 ;
return F_32 ( & V_194 -> V_44 , & V_195 ) ;
}
static void F_96 ( struct V_87 * V_88 )
{
if ( strcmp ( V_88 -> V_183 , V_186 ) == 0 ||
strcmp ( V_88 -> V_183 , V_192 ) == 0 )
F_64 ( ( unsigned long ) F_65 ( 0 ) ) ;
F_97 () ;
}
...
if ( F_99 ( V_65 , V_197 [ V_51 ] -> V_183 ) ) {
if ( V_197 [ V_51 ] -> V_198 ) {
return V_197 [ V_51 ] -> V_198 ;
} else {
V_88 -> V_199 = V_197 [ V_51 ] ;
return V_52 ;
}
}
}
...
struct V_45 * V_46 , char * V_47 )
{
return sprintf ( V_47 , L_3 , V_200 . V_199 -> V_183 ) ;
}
static T_4 F_101 ( struct V_43 * V_44 ,
struct V_45 * V_46 ,
const char * V_65 , T_5 V_52 )
{
return F_98 ( V_65 , & V_200 , V_52 ) ;
}
static void F_102 ( char * V_201 )
{
F_86 () ;
...
struct V_45 * V_46 , char * V_47 )
{
return sprintf ( V_47 , L_3 , V_203 . V_199 -> V_183 ) ;
}
static T_4 F_104 ( struct V_43 * V_44 ,
struct V_45 * V_46 ,
const char * V_65 , T_5 V_52 )
{
return F_98 ( V_65 , & V_203 , V_52 ) ;
}
...
struct V_45 * V_46 , char * V_47 )
{
return sprintf ( V_47 , L_3 , V_204 . V_199 -> V_183 ) ;
}
...
struct V_45 * V_46 , char * V_47 )
{
return sprintf ( V_47 , L_3 , V_206 . V_199 -> V_183 ) ;
}
...
struct V_45 * V_46 , char * V_47 )
{
return sprintf ( V_47 , L_3 , V_207 . V_199 -> V_183 ) ;
}
...
F_126 ( & V_80 ) ;
if ( memcmp ( V_80 . V_78 , V_212 , sizeof( V_212 ) ) == 0 &&
V_60 )
...
static void T_3 F_127 ( char * V_111 , char * V_213 , int V_214 )
{
int V_215 , V_216 ;
V_216 = 0 ;
...
if ( ! V_84 )
return 1 ;
F_127 ( V_187 , V_212 , 127 ) ;
V_187 [ 127 ] = 0 ;
V_203 . V_199 = & V_217 ;
return 1 ;
}
static int T_3 F_130 ( char * V_212 )
{
if ( ! V_84 )
return 1 ;
F_127 ( V_189 , V_212 , 127 ) ;
V_189 [ 127 ] = 0 ;
V_206 . V_199 = & V_217 ;
return 1 ;
}
static int T_3 F_131 ( char * V_212 )
{
if ( ! V_84 )
return 1 ;
F_127 ( V_191 , V_212 , 127 ) ;
V_191 [ 127 ] = 0 ;
V_207 . V_199 = & V_217 ;
return 1 ;
}
static int F_132 ( struct V_218 * V_219 ,
unsigned long V_220 , void * V_85 )
{
F_105 () ;
return V_221 ;
}
...
V_29 -> V_39 . V_40 . V_72 ;
V_39 . V_85 . V_40 . V_222 = V_29 -> V_39 . V_40 . V_222 ;
V_39 . V_85 . V_40 . V_223 = V_29 -> V_39 . V_40 . V_223 ;
break;
case V_8 :
strncpy ( V_39 . V_85 . V_224 . V_183 , V_148 ,
sizeof( V_39 . V_85 . V_224 . V_183 ) ) ;
break;
case V_10 :
break;
}
...
void F_147 ( void (* F_148)( void ) ,
void (* F_149)( void * ) , void * V_85 )
{
struct V_240 * V_241 ;
V_241 = (struct V_240 * ) ( unsigned long ) F_150 () ;
