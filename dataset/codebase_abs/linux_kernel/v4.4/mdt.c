...
int F_50 ( struct V_1 * V_1 , unsigned long V_2 )
{
struct V_3 * V_4 ;
int V_20 ;
V_20 = F_35 ( V_1 , V_2 , 0 , & V_4 ) ;
if ( F_5 ( V_20 ) )
return V_20 ;
F_12 ( V_4 ) ;
F_13 ( V_1 ) ;
...
return F_54 ( V_58 , & V_6 -> V_59 ) ;
}
static int
F_55 ( struct V_55 * V_55 , struct V_60 * V_61 )
{
...
int F_60 ( struct V_1 * V_1 , T_3 V_70 , T_4 V_71 )
{
struct V_72 * V_73 ;
V_73 = F_61 ( F_62 ( sizeof( * V_73 ) , V_71 ) , V_74 ) ;
if ( ! V_73 )
return - V_21 ;
F_63 ( & V_73 -> V_75 ) ;
V_1 -> V_76 = V_73 ;
...
void F_65 ( struct V_1 * V_1 , unsigned V_85 ,
unsigned V_86 )
{
struct V_72 * V_73 = F_66 ( V_1 ) ;
V_73 -> V_87 = V_85 ;
V_73 -> V_88 = ( 1 << V_1 -> V_12 ) / V_85 ;
V_73 -> V_89 = F_67 ( V_86 , V_85 ) ;
}
...
if ( V_8 )
goto V_32;
F_74 ( V_6 -> V_10 , & V_91 -> V_97 ) ;
V_32:
return V_8 ;
}
int F_75 ( struct V_1 * V_1 , struct V_3 * V_4 )
{
struct V_90 * V_91 = F_66 ( V_1 ) -> V_95 ;
struct V_3 * V_98 ;
struct V_55 * V_55 ;
int V_99 = V_1 -> V_12 ;
V_55 = F_76 ( & V_91 -> V_93 , V_4 -> V_11 -> V_53 ) ;
if ( ! V_55 )
return - V_21 ;
if ( ! F_45 ( V_55 ) )
F_77 ( V_55 , 1 << V_99 , 0 ) ;
V_98 = F_46 ( V_55 , F_8 ( V_4 ) >> V_99 ) ;
if ( ! F_18 ( V_98 ) )
F_78 ( V_98 , V_4 ) ;
if ( F_79 ( & V_98 -> V_100 ) ) {
F_80 ( & V_98 -> V_100 ,
...
struct V_3 *
F_82 ( struct V_1 * V_1 , struct V_3 * V_4 )
{
struct V_90 * V_91 = F_66 ( V_1 ) -> V_95 ;
struct V_3 * V_98 = NULL ;
struct V_55 * V_55 ;
int V_101 ;
V_55 = F_43 ( & V_91 -> V_93 , V_4 -> V_11 -> V_53 ) ;
if ( V_55 ) {
if ( F_45 ( V_55 ) ) {
V_101 = F_8 ( V_4 ) >> V_1 -> V_12 ;
V_98 = F_46 ( V_55 , V_101 ) ;
}
F_22 ( V_55 ) ;
F_23 ( V_55 ) ;
}
...
F_88 ( V_1 ) ;
F_89 ( V_1 -> V_22 , true ) ;
F_90 ( V_1 -> V_22 , & V_91 -> V_93 ) ;
F_89 ( & V_6 -> V_96 , true ) ;
F_90 ( & V_6 -> V_96 , & V_91 -> V_94 ) ;
F_91 ( V_6 -> V_10 , & V_91 -> V_97 ) ;
F_92 ( & V_73 -> V_75 ) ;
}
