...
{
struct V_33 * V_34 = V_40 -> V_49 . V_10 [ V_50 ] ;
struct V_13 * V_14 = V_40 -> V_49 . V_10 [ V_51 ] ;
F_25 ( L_4 , V_43 ) ;
if ( V_34 ) {
V_34 -> V_52 ( V_40 -> V_49 . V_10 [ V_53 ] ) ;
F_32 ( V_34 -> V_54 ) ;
}
F_30 ( V_14 ) ;
F_12 ( V_40 -> V_37 ) ;
...
struct V_13 * V_14 = V_22 -> V_49 . V_10 [ V_51 ] ;
void * V_10 = V_22 -> V_49 . V_10 [ V_53 ] ;
V_22 -> V_49 . V_10 [ V_53 ] = NULL ;
V_22 -> V_49 . V_10 [ V_50 ] = NULL ;
V_22 -> V_49 . V_10 [ V_51 ] = NULL ;
if ( V_34 ) {
V_34 -> V_52 ( V_10 ) ;
F_32 ( V_34 -> V_54 ) ;
}
...
if ( strcmp ( V_55 -> V_47 , V_42 -> V_47 ) == 0 ) {
F_36 ( L_8 ,
V_42 -> V_47 ) ;
V_20 = - V_56 ;
goto V_57;
