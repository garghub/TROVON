...
const struct V_54 * V_43 = F_16 ( V_39 ) ;
bool V_13 = true ;
if ( V_41 -> V_44 )
...
static bool
F_17 ( const struct V_38 * V_39 , struct V_50 * V_51 )
{
struct V_1 * V_1 = V_51 -> V_1 ;
...
static int F_19 ( const struct V_63 * V_51 )
{
...
if ( ( V_41 -> V_44 | V_41 -> V_48 ) >= V_71 ) {
F_21 ( L_8 ) ;
return - V_64 ;
}
if ( ( V_41 -> V_44 | V_41 -> V_48 ) & V_72 ) {
F_21 ( L_9 ) ;
return - V_64 ;
}
}
