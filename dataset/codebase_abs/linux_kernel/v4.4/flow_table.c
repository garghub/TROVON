...
return F_59 ( F_60 ( struct V_5 , V_86 ) ,
sizeof( long ) ) ;
}
static bool F_61 ( const struct V_5 * V_87 ,
const struct V_5 * V_88 ,
int V_81 , int V_82 )
{
const long * V_89 = ( const long * ) ( ( const V_13 * ) V_87 + V_81 ) ;
const long * V_90 = ( const long * ) ( ( const V_13 * ) V_88 + V_81 ) ;
long V_91 = 0 ;
int V_17 ;
...
{
struct V_5 * V_14 = V_93 -> V_14 ;
int V_81 = F_58 ( V_14 ) ;
int V_82 = V_93 -> V_2 . V_3 ;
F_37 ( F_40 ( & V_19 -> V_27 ) ) ;
...
V_54 V_71 ;
struct V_5 V_95 ;
F_2 ( & V_95 , V_94 , false , V_10 ) ;
V_71 = F_55 ( & V_95 , & V_10 -> V_2 ) ;
V_63 = F_45 ( V_49 , V_71 ) ;
F_44 (flow, head, flow_table.node[ti->node_ver]) {
if ( V_19 -> V_10 == V_10 && V_19 -> V_36 . V_71 == V_71 &&
F_62 ( V_19 , & V_95 , & V_10 -> V_2 ) )
return V_19 ;
}
return NULL ;
}
struct V_18 * F_65 ( struct V_36 * V_96 ,
const struct V_5 * V_14 ,
V_54 * V_97 )
{
struct V_48 * V_49 = F_66 ( V_96 -> V_49 ) ;
struct V_9 * V_10 ;
struct V_18 * V_19 ;
* V_97 = 0 ;
...
struct V_18 * F_68 ( struct V_36 * V_96 ,
const struct V_5 * V_14 )
{
V_54 T_2 V_97 ;
return F_65 ( V_96 , V_14 , & V_97 ) ;
}
struct V_18 * F_69 ( struct V_36 * V_96 ,
const struct V_92 * V_93 )
{
struct V_48 * V_49 = F_66 ( V_96 -> V_49 ) ;
struct V_9 * V_10 ;
...
static V_54 F_71 ( const struct V_98 * V_99 )
{
return F_72 ( V_99 -> V_74 , V_99 -> V_29 , 0 ) ;
}
static bool F_73 ( const struct V_18 * V_19 ,
const struct V_98 * V_99 )
{
if ( V_19 -> V_27 . V_29 != V_99 -> V_29 )
return false ;
return ! memcmp ( V_19 -> V_27 . V_74 , V_99 -> V_74 , V_99 -> V_29 ) ;
}
bool F_74 ( const struct V_18 * V_19 , const struct V_92 * V_93 )
{
if ( F_40 ( & V_19 -> V_27 ) )
return F_62 ( V_19 , V_93 -> V_14 , & V_93 -> V_2 ) ;
return F_63 ( V_19 , V_93 ) ;
}
struct V_18 * F_75 ( struct V_36 * V_96 ,
const struct V_98 * V_74 )
{
struct V_48 * V_49 = F_66 ( V_96 -> V_55 ) ;
struct V_18 * V_19 ;
struct V_42 * V_63 ;
V_54 V_71 ;
V_71 = F_71 ( V_74 ) ;
...
static void F_78 ( struct V_36 * V_96 , struct V_9 * V_10 )
{
if ( V_10 ) {
F_79 () ;
F_37 ( ! V_10 -> V_101 ) ;
...
static bool F_84 ( const struct V_9 * V_103 ,
const struct V_9 * V_104 )
{
const V_13 * V_105 = ( const V_13 * ) & V_103 -> V_14 + V_103 -> V_2 . V_4 ;
const V_13 * V_106 = ( const V_13 * ) & V_104 -> V_14 + V_104 -> V_2 . V_4 ;
return ( V_103 -> V_2 . V_3 == V_104 -> V_2 . V_3 )
&& ( V_103 -> V_2 . V_4 == V_104 -> V_2 . V_4 )
&& ( memcmp ( V_105 , V_106 , F_1 ( & V_103 -> V_2 ) ) == 0 ) ;
}
static struct V_9 * F_85 ( const struct V_36 * V_96 ,
const struct V_9 * V_10 )
{
struct V_107 * V_108 ;
F_86 (ml, &tbl->mask_list) {
struct V_9 * V_12 ;
V_12 = F_24 ( V_108 , struct V_9 , V_102 ) ;
if ( F_84 ( V_10 , V_12 ) )
return V_12 ;
}
return NULL ;
}
static int F_87 ( struct V_36 * V_96 , struct V_18 * V_19 ,
...
else if ( F_90 ( V_60 , V_37 -> V_59 + V_109 ) )
