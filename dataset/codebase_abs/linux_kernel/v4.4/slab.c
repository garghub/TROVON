...
static void F_236 ( const void * V_1 )
{
if ( ! F_237 ( V_1 ) ) {
F_27 ( V_53 L_28 ,
( unsigned long ) V_1 ) ;
...
static inline void F_238 ( struct V_14 * V_32 , void * V_31 )
{
...
static void * F_239 ( struct V_14 * V_15 , void * V_1 ,
unsigned long V_205 )
{
unsigned int V_216 ;
struct V_22 * V_22 ;
...
static void * F_240 ( struct V_14 * V_15 , T_4 V_16 ,
bool V_87 )
{
int V_79 ;
struct V_3 * V_84 ;
...
int V_263 ;
V_257:
V_263 = F_229 ( V_15 , F_75 ( V_16 ) , V_64 , NULL ) ;
V_75 = F_19 ( V_15 ) ;
V_64 = F_56 () ;
...
static inline void F_244 ( struct V_14 * V_15 ,
T_4 V_16 )
{
F_245 ( F_231 ( V_16 ) ) ;
#if V_178
...
static void * F_246 ( struct V_14 * V_15 ,
...
static bool F_247 ( struct V_14 * V_15 , T_4 V_16 )
{
if ( F_41 ( V_15 == V_14 ) )
return false ;
return F_248 ( V_15 -> V_206 , V_16 , V_15 -> V_16 ) ;
}
static inline void * F_249 ( struct V_14 * V_15 , T_4 V_16 )
{
void * V_1 ;
struct V_36 * V_75 ;
bool V_87 = false ;
...
F_251 ( V_15 ) ;
V_1 = F_240 ( V_15 , V_16 , V_87 ) ;
V_75 = F_19 ( V_15 ) ;
V_86:
if ( V_1 )
F_252 ( & V_75 -> V_89 [ V_75 -> V_78 ] ) ;
return V_1 ;
}
...
static void * F_257 ( struct V_14 * V_32 , T_4 V_16 )
{
struct V_271 * V_271 ;
T_4 V_247 ;
struct V_272 * V_273 ;
struct V_274 * V_274 ;
enum V_275 V_276 = F_258 ( V_16 ) ;
void * V_31 = NULL ;
int V_143 ;
unsigned int V_277 ;
if ( V_16 & V_105 )
...
V_278:
V_277 = F_259 () ;
V_271 = F_260 ( F_256 () , V_16 ) ;
V_258:
F_261 (zone, z, zonelist, high_zoneidx) {
V_143 = F_262 ( V_274 ) ;
if ( F_263 ( V_274 , V_16 ) &&
F_55 ( V_32 , V_143 ) &&
...
V_262:
F_84 ( & V_84 -> V_11 ) ;
V_263 = F_229 ( V_15 , F_75 ( V_16 ) , V_97 , NULL ) ;
if ( V_263 )
goto V_258;
return F_257 ( V_15 , V_16 ) ;
V_279:
return V_31 ;
}
static T_9 void *
F_267 ( struct V_14 * V_15 , T_4 V_16 , int V_97 ,
unsigned long V_205 )
{
unsigned long V_280 ;
void * V_151 ;
...
if ( F_247 ( V_15 , V_16 ) )
return NULL ;
V_15 = F_269 ( V_15 , V_16 ) ;
F_244 ( V_15 , V_16 ) ;
F_270 ( V_280 ) ;
if ( V_97 == V_283 )
V_97 = V_281 ;
if ( F_41 ( ! F_55 ( V_15 , V_97 ) ) ) {
V_151 = F_257 ( V_15 , V_16 ) ;
goto V_86;
}
if ( V_97 == V_281 ) {
V_151 = F_249 ( V_15 , V_16 ) ;
if ( V_151 )
goto V_86;
}
...
V_86:
F_271 ( V_280 ) ;
V_151 = F_246 ( V_15 , V_16 , V_151 , V_205 ) ;
F_272 ( V_151 , V_15 -> V_206 , 1 , V_15 -> V_16 ,
V_16 ) ;
if ( F_97 ( V_151 ) ) {
F_273 ( V_15 , V_16 , V_151 , V_15 -> V_206 ) ;
if ( F_41 ( V_16 & V_284 ) )
...
static T_9 void *
F_275 ( struct V_14 * V_32 , T_4 V_16 )
{
void * V_1 ;
if ( V_200 -> V_270 || F_254 () ) {
V_1 = F_73 ( V_32 , V_16 ) ;
if ( V_1 )
goto V_86;
}
...
static T_9 void *
F_275 ( struct V_14 * V_15 , T_4 V_16 )
{
return F_249 ( V_15 , V_16 ) ;
}
static T_9 void *
F_276 ( struct V_14 * V_15 , T_4 V_16 , unsigned long V_205 )
{
unsigned long V_280 ;
void * V_1 ;
V_16 &= V_282 ;
...
V_1 = F_275 ( V_15 , V_16 ) ;
F_271 ( V_280 ) ;
V_1 = F_246 ( V_15 , V_16 , V_1 , V_205 ) ;
F_272 ( V_1 , V_15 -> V_206 , 1 , V_15 -> V_16 ,
V_16 ) ;
F_277 ( V_1 ) ;
if ( F_97 ( V_1 ) ) {
F_273 ( V_15 , V_16 , V_1 , V_15 -> V_206 ) ;
if ( F_41 ( V_16 & V_284 ) )
...
V_84 -> V_12 -= V_15 -> V_28 ;
F_234 ( & V_22 -> V_155 , V_103 ) ;
} else {
F_125 ( & V_22 -> V_155 , & V_84 -> V_7 ) ;
}
} else {
F_234 ( & V_22 -> V_155 , & V_84 -> V_6 ) ;
}
}
}
static void F_279 ( struct V_14 * V_15 , struct V_36 * V_75 )
{
int V_79 ;
struct V_3 * V_84 ;
int V_64 = F_56 () ;
...
static inline void F_281 ( struct V_14 * V_15 , void * V_1 ,
unsigned long V_205 )
{
struct V_36 * V_75 = F_19 ( V_15 ) ;
F_204 () ;
F_282 ( V_1 , V_15 -> V_16 ) ;
V_1 = F_239 ( V_15 , V_1 , V_205 ) ;
F_283 ( V_15 , V_1 , V_15 -> V_206 ) ;
...
void * F_286 ( struct V_14 * V_15 , T_4 V_16 )
{
void * V_137 = F_276 ( V_15 , V_16 , V_291 ) ;
F_287 ( V_291 , V_137 ,
V_15 -> V_206 , V_15 -> V_19 , V_16 ) ;
return V_137 ;
}
void F_288 ( struct V_14 * V_57 , T_2 V_19 , void * * V_243 )
{
F_289 ( V_57 , V_19 , V_243 ) ;
}
int F_290 ( struct V_14 * V_57 , T_4 V_16 , T_2 V_19 ,
void * * V_243 )
{
return F_291 ( V_57 , V_16 , V_19 , V_243 ) ;
}
void *
F_292 ( struct V_14 * V_15 , T_4 V_16 , T_2 V_19 )
{
void * V_137 ;
V_137 = F_276 ( V_15 , V_16 , V_291 ) ;
F_293 ( V_291 , V_137 ,
V_19 , V_15 -> V_19 , V_16 ) ;
return V_137 ;
}
...
{
void * V_137 = F_267 ( V_15 , V_16 , V_97 , V_291 ) ;
F_294 ( V_291 , V_137 ,
...
{
void * V_137 ;
V_137 = F_267 ( V_15 , V_16 , V_97 , V_291 ) ;
F_296 ( V_291 , V_137 ,
V_19 , V_15 -> V_19 ,
V_16 , V_97 ) ;
return V_137 ;
...
static T_9 void *
F_297 ( T_2 V_19 , T_4 V_16 , int V_64 , unsigned long V_205 )
{
struct V_14 * V_15 ;
V_15 = F_201 ( V_19 , V_16 ) ;
if ( F_41 ( F_202 ( V_15 ) ) )
return V_15 ;
return F_295 ( V_15 , V_16 , V_64 , V_19 ) ;
}
void * F_298 ( T_2 V_19 , T_4 V_16 , int V_64 )
{
return F_297 ( V_19 , V_16 , V_64 , V_291 ) ;
}
void * F_299 ( T_2 V_19 , T_4 V_16 ,
int V_64 , unsigned long V_205 )
{
return F_297 ( V_19 , V_16 , V_64 , V_205 ) ;
}
static T_9 void * F_300 ( T_2 V_19 , T_4 V_16 ,
unsigned long V_205 )
{
struct V_14 * V_15 ;
void * V_137 ;
...
if ( F_41 ( F_202 ( V_15 ) ) )
return V_15 ;
V_137 = F_276 ( V_15 , V_16 , V_205 ) ;
F_293 ( V_205 , V_137 ,
V_19 , V_15 -> V_19 , V_16 ) ;
return V_137 ;
}
void * F_301 ( T_2 V_19 , T_4 V_16 )
{
return F_300 ( V_19 , V_16 , V_291 ) ;
}
void * F_302 ( T_2 V_19 , T_4 V_16 , unsigned long V_205 )
{
return F_300 ( V_19 , V_16 , V_205 ) ;
}
...
return;
F_270 ( V_16 ) ;
F_304 ( V_1 , V_15 -> V_206 ) ;
if ( ! ( V_15 -> V_16 & V_292 ) )
F_305 ( V_1 , V_15 -> V_206 ) ;
F_281 ( V_15 , V_1 , V_291 ) ;
F_271 ( V_16 ) ;
F_306 ( V_291 , V_1 ) ;
}
...
F_236 ( V_1 ) ;
V_293 = F_14 ( V_1 ) ;
F_304 ( V_1 , V_293 -> V_206 ) ;
F_305 ( V_1 , V_293 -> V_206 ) ;
F_281 ( V_293 , ( void * ) V_1 , V_291 ) ;
F_271 ( V_16 ) ;
}
static int F_308 ( struct V_14 * V_15 , T_4 V_82 )
{
int V_64 ;
struct V_3 * V_84 ;
struct V_36 * V_294 ;
...
static int F_309 ( struct V_14 * V_15 , int V_76 ,
...
F_217 ( V_244 ) ;
V_297:
return F_308 ( V_15 , V_82 ) ;
}
static int F_311 ( struct V_14 * V_15 , int V_76 ,
int V_79 , int V_8 , T_4 V_82 )
{
int V_137 ;
struct V_14 * V_293 ;
V_137 = F_309 ( V_15 , V_76 , V_79 , V_8 , V_82 ) ;
if ( V_164 < V_174 )
return V_137 ;
if ( ( V_137 < 0 ) || ! F_312 ( V_15 ) )
return V_137 ;
F_313 ( & V_126 ) ;
F_314 (c, cachep) {
F_309 ( V_293 , V_76 , V_79 , V_8 , V_82 ) ;
}
return V_137 ;
}
...
V_79 = ( V_76 + 1 ) / 2 ;
V_299:
V_118 = F_311 ( V_15 , V_76 , V_79 , V_8 , V_82 ) ;
if ( V_118 )
F_27 ( V_53 L_36 ,
V_15 -> V_54 , - V_118 ) ;
return V_118 ;
...
F_85 ( V_303 , V_84 ) ;
F_214 ( V_303 , V_84 , F_19 ( V_303 ) , 0 , V_64 ) ;
if ( F_319 ( V_84 -> V_110 , V_111 ) )
goto V_261;
V_84 -> V_110 = V_111 + V_112 ;
F_214 ( V_303 , V_84 , V_84 -> V_8 , 0 , V_64 ) ;
if ( V_84 -> V_13 )
V_84 -> V_13 = 0 ;
else {
int V_304 ;
...
F_39 () ;
V_86:
F_322 ( V_71 , F_323 ( V_305 ) ) ;
}
void F_324 ( struct V_14 * V_15 , struct V_306 * V_307 )
{
struct V_22 * V_22 ;
unsigned long V_183 ;
unsigned long V_184 ;
...
void F_325 ( struct V_311 * V_312 , struct V_14 * V_15 )
{
#if V_289
{
...
{
unsigned long V_325 = F_327 ( & V_15 -> V_325 ) ;
unsigned long V_326 = F_327 ( & V_15 -> V_326 ) ;
unsigned long V_327 = F_327 ( & V_15 -> V_327 ) ;
unsigned long V_328 = F_327 ( & V_15 -> V_328 ) ;
F_326 ( V_312 , L_44 ,
V_325 , V_326 , V_327 , V_328 ) ;
}
#endif
}
T_10 F_328 ( struct V_329 * V_329 , const char T_11 * V_330 ,
...
static inline int F_330 ( unsigned long * V_84 , unsigned long V_339 )
{
unsigned long * V_243 ;
int V_340 ;
if ( ! V_339 )
...
static void F_331 ( unsigned long * V_84 , struct V_14 * V_293 ,
struct V_22 * V_22 )
{
void * V_243 ;
int V_88 ;
...
continue;
if ( ! F_330 ( V_84 , ( unsigned long ) * F_11 ( V_293 , V_243 ) ) )
return;
}
}
static void F_332 ( struct V_311 * V_312 , unsigned long V_342 )
{
#ifdef F_333
unsigned long V_34 , V_19 ;
char V_343 [ V_344 ] , V_54 [ V_345 ] ;
if ( F_334 ( V_342 , & V_19 , & V_34 , V_343 , V_54 ) == 0 ) {
F_326 ( V_312 , L_46 , V_54 , V_34 , V_19 ) ;
if ( V_343 [ 0 ] )
F_326 ( V_312 , L_47 , V_343 ) ;
return;
}
#endif
F_326 ( V_312 , L_48 , ( void * ) V_342 ) ;
}
static int F_335 ( struct V_311 * V_312 , void * V_243 )
{
...
if ( V_263 [ 0 ] == V_263 [ 1 ] ) {
F_111 ( & V_126 ) ;
V_312 -> V_346 = F_336 ( V_263 [ 0 ] * 4 * sizeof( unsigned long ) , V_108 ) ;
if ( ! V_312 -> V_346 ) {
V_312 -> V_346 = V_263 ;
F_110 ( & V_126 ) ;
return - V_109 ;
...
F_326 ( V_312 , L_49 , V_54 , V_263 [ 2 * V_88 + 3 ] ) ;
F_332 ( V_312 , V_263 [ 2 * V_88 + 2 ] ) ;
F_337 ( V_312 , '\n' ) ;
}
return 0 ;
}
static int F_338 ( struct V_347 * V_347 , struct V_329 * V_329 )
{
unsigned long * V_84 ;
V_84 = F_339 ( V_329 , & V_348 , V_49 ) ;
if ( ! V_84 )
return - V_109 ;
* V_84 = V_49 / ( 2 * sizeof( unsigned long ) ) ;
return 0 ;
}
static int T_3 F_340 ( void )
{
#ifdef V_40
F_341 ( L_50 , 0 , NULL , & V_349 ) ;
#endif
return 0 ;
}
T_2 F_342 ( const void * V_1 )
{
F_9 ( ! V_1 ) ;
if ( F_41 ( V_1 == V_350 ) )
return 0 ;
