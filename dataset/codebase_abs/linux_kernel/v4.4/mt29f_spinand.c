...
static int F_8 ( struct V_10 * V_26 , T_1 * V_32 )
{
struct F_2 V_12 = { 0 } ;
int V_33 ;
V_12 . V_12 = V_34 ;
...
static int F_17 ( struct V_10 * V_26 , T_2 V_45 )
{
struct F_2 V_12 = { 0 } ;
T_2 V_46 ;
V_46 = V_45 ;
...
static int F_18 ( struct V_10 * V_26 , T_2 V_45 ,
...
static int F_22 ( struct V_10 * V_26 , T_2 V_45 )
{
struct F_2 V_12 = { 0 } ;
T_2 V_46 ;
V_46 = V_45 ;
...
static int F_25 ( struct V_10 * V_26 , T_2 V_69 )
{
struct F_2 V_12 = { 0 } ;
T_2 V_46 ;
V_46 = V_69 ;
...
static int F_26 ( struct V_10 * V_26 , T_2 V_69 )
{
int V_28 ;
T_1 V_32 = 0 ;
V_28 = F_16 ( V_26 ) ;
...
static void F_34 ( struct V_2 * V_3 , const T_1 * V_61 , int V_18 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
memcpy ( V_9 -> V_61 + V_9 -> V_90 , V_61 , V_18 ) ;
V_9 -> V_90 += V_18 ;
}
static void F_35 ( struct V_2 * V_3 , T_1 * V_61 , int V_18 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
...
case V_97 :
V_9 -> V_90 = 0 ;
F_19 ( V_8 -> V_11 , V_74 , 0x0 , 0x840 , V_9 -> V_61 ) ;
break;
case V_98 :
V_9 -> V_90 = 0 ;
F_19 ( V_8 -> V_11 , V_74 , 0x800 , 0x40 , V_9 -> V_61 ) ;
break;
case V_99 :
V_9 -> V_90 = V_50 ;
break;
...
return - V_113 ;
#ifdef F_20
V_5 -> V_77 . V_116 = V_117 ;
V_5 -> V_77 . V_78 = 0x200 ;
V_5 -> V_77 . V_118 = 0x6 ;
V_5 -> V_77 . V_80 = 0x4 ;
V_5 -> V_77 . V_119 = 1 ;
V_5 -> V_77 . V_120 = V_5 -> V_77 . V_80 * V_5 -> V_77 . V_118 ;
V_5 -> V_77 . V_121 = & V_122 ;
V_5 -> V_77 . V_123 = F_28 ;
V_5 -> V_77 . V_124 = F_27 ;
#else
V_5 -> V_77 . V_116 = V_125 ;
if ( F_15 ( V_26 ) < 0 )
F_29 ( L_22 , V_126 ) ;
#endif
V_5 -> V_6 = V_8 ;
...
F_41 ( & V_26 -> V_31 , V_3 ) ;
V_3 -> V_6 = V_5 ;
V_3 -> V_31 . V_133 = & V_26 -> V_31 ;
V_3 -> V_84 = 64 ;
if ( F_42 ( V_3 , 1 ) )
return - V_134 ;
V_112 . V_135 = V_26 -> V_31 . V_135 ;
return F_43 ( V_3 , NULL , & V_112 , NULL , 0 ) ;
}
