...
if ( V_4 . V_9 ) {
F_3 ( L_106 ) ;
F_60 ( V_61 , V_62 , L_107 , true ) ;
F_60 ( NULL , V_62 , L_108 , true ) ;
return - V_16 ;
}
V_7 = F_61 ( V_4 . V_15 ) ;
if ( V_7 < 0 )
...
int F_66 ( int V_20 , const char * * V_21 , const char * T_2 )
{
int V_7 ;
V_7 = F_22 () ;
if ( ! V_7 ) {
