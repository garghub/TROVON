...
F_29 ( ! ( V_81 -> V_82 & ( V_118 | V_119 ) ) ) ;
F_29 ( ( V_81 -> V_82 & ( V_118 | V_119 ) ) ==
( V_118 | V_119 ) ) ;
F_29 ( ( V_81 -> V_82 & V_118 ) && F_124 ( V_81 -> V_82 ) ) ;
F_29 ( ( V_81 -> V_82 & V_119 ) && F_125 ( V_114 ) ) ;
...
if ( F_69 ( F_90 ( V_150 , V_87 , V_151 , & V_92 ) ) ) {
F_91 ( V_150 ) ;
if ( V_16 ) {
F_179 ( V_16 ) ;
F_148 ( V_16 ) ;
...
bool V_170 ;
int V_90 = 0 ;
F_29 ( ! ( V_81 -> V_82 & ( V_171 | V_172 | V_83 ) ) ) ;
V_94 = F_96 ( V_87 , V_163 ) ;
if ( F_69 ( ! F_142 ( V_79 , * V_163 ) ) )
goto V_131;
if ( F_69 ( F_193 ( * V_163 ) ) ) {
V_16 = F_134 ( * V_163 ) ;
F_98 ( V_94 ) ;
...
F_240 ( V_205 , F_196 ( V_16 ) ) ;
F_29 ( ! F_241 ( V_205 ) ) ;
F_29 ( ! F_242 ( V_205 ) ) ;
F_29 ( ! F_243 ( V_205 ) ) ;
F_29 ( ! F_244 ( V_205 ) ) ;
F_245 ( V_16 , V_205 , V_202 , V_201 ) ;
}
F_246 ( V_203 , & V_16 -> V_138 ) ;
F_29 ( F_32 ( & V_16 -> V_138 ) <= 0 ) ;
F_247 ( V_1 , V_216 , - 1 ) ;
F_248 ( V_16 ) ;
F_249 ( V_16 ) ;
F_250 ( & V_1 -> V_204 ) ;
...
static int F_252 ( struct V_16 * V_16 ,
struct V_80 * V_81 ,
unsigned long V_88 )
{
struct V_86 * V_87 = V_81 -> V_116 ;
...
static void F_257 ( struct V_16 * V_16 ,
struct V_132 * V_132 ,
struct V_200 * V_201 )
{
int V_217 , V_218 ;
...
F_29 ( F_258 ( V_16 ) ) ;
V_217 = 0 ;
F_259 (avc, &anon_vma->rb_root, pgoff, pgoff) {
struct V_80 * V_81 = V_222 -> V_81 ;
unsigned long V_113 = F_260 ( V_16 , V_81 ) ;
F_29 ( F_261 ( V_81 ) ) ;
...
int F_263 ( struct V_16 * V_16 , struct V_200 * V_201 )
{
struct V_132 * V_132 ;
int V_45 = 1 ;
F_29 ( F_195 ( V_16 ) ) ;
...
static inline struct V_230 * F_275 ( void )
{
if ( ! V_229 )
return NULL ;
return F_276 ( V_229 , V_143 ) ;
}
static inline void F_277 ( struct V_230 * V_230 )
{
F_278 ( V_229 , V_230 ) ;
}
static struct V_230 * F_279 ( struct V_86 * V_87 )
{
struct V_230 * V_230 ;
F_280 (mm_slots_hash, mm_slot, hash, (unsigned long)mm)
if ( V_87 == V_230 -> V_87 )
return V_230 ;
return NULL ;
}
static void F_281 ( struct V_86 * V_87 ,
struct V_230 * V_230 )
{
V_230 -> V_87 = V_87 ;
F_282 ( V_231 , & V_230 -> V_232 , ( long ) V_87 ) ;
}
static inline int F_283 ( struct V_86 * V_87 )
{
return F_32 ( & V_87 -> V_233 ) == 0 ;
}
int F_284 ( struct V_86 * V_87 )
{
struct V_230 * V_230 ;
int V_234 ;
V_230 = F_275 () ;
if ( ! V_230 )
return - V_66 ;
F_285 ( F_283 ( V_87 ) , V_87 ) ;
if ( F_69 ( F_286 ( V_235 , & V_87 -> V_90 ) ) ) {
F_277 ( V_230 ) ;
return 0 ;
}
F_174 ( & V_236 ) ;
F_281 ( V_87 , V_230 ) ;
V_234 = F_13 ( & V_13 . V_14 ) ;
F_287 ( & V_230 -> V_237 , & V_13 . V_14 ) ;
F_98 ( & V_236 ) ;
F_288 ( & V_87 -> V_238 ) ;
if ( V_234 )
F_14 ( & V_15 ) ;
...
static void F_295 ( struct V_16 * V_16 )
{
F_296 ( V_16 , V_243 + 0 ) ;
F_189 ( V_16 ) ;
F_297 ( V_16 ) ;
}
static void F_298 ( T_9 * V_148 , T_9 * V_244 )
{
while ( -- V_244 >= V_148 ) {
T_9 V_245 = * V_244 ;
if ( ! F_166 ( V_245 ) && ! F_299 ( F_300 ( V_245 ) ) )
F_295 ( F_301 ( V_245 ) ) ;
}
}
static int F_302 ( struct V_80 * V_81 ,
unsigned long V_88 ,
T_9 * V_148 )
{
struct V_16 * V_16 ;
...
if ( ! F_303 ( V_245 ) )
goto V_78;
V_16 = F_305 ( V_81 , V_88 , V_245 ) ;
if ( F_69 ( ! V_16 ) )
goto V_78;
F_88 ( F_89 ( V_16 ) , V_16 ) ;
F_88 ( ! F_241 ( V_16 ) , V_16 ) ;
F_88 ( ! F_244 ( V_16 ) , V_16 ) ;
if ( ! F_186 ( V_16 ) )
goto V_78;
if ( F_251 ( V_16 ) != 1 + ! ! F_306 ( V_16 ) ) {
F_189 ( V_16 ) ;
goto V_78;
}
if ( F_307 ( V_245 ) ) {
...
F_88 ( F_311 ( V_16 ) , V_16 ) ;
if ( F_312 ( V_245 ) ||
F_236 ( V_16 ) || F_313 ( V_16 ) ||
F_314 ( V_81 -> V_116 , V_88 ) )
V_247 = true ;
}
if ( F_17 ( V_247 && V_248 ) )
return 1 ;
...
static void F_315 ( T_9 * V_148 , struct V_16 * V_16 ,
struct V_80 * V_81 ,
unsigned long V_88 ,
T_8 * V_94 )
{
...
if ( F_299 ( F_300 ( V_245 ) ) ) {
F_174 ( V_94 ) ;
F_317 ( V_81 -> V_116 , V_88 , V_244 ) ;
F_98 ( V_94 ) ;
}
} else {
V_128 = F_301 ( V_245 ) ;
...
static bool F_328 ( struct V_16 * * V_259 , bool * V_249 )
{
if ( F_10 ( * V_259 ) ) {
if ( ! * V_249 )
return false ;
...
static struct V_16 *
F_329 ( struct V_16 * * V_259 , T_6 V_89 , struct V_86 * V_87 ,
unsigned long V_88 , int V_260 )
{
F_88 ( * V_259 , * V_259 ) ;
F_330 ( & V_87 -> V_242 ) ;
* V_259 = F_331 ( V_260 , V_89 , V_24 ) ;
if ( F_69 ( ! * V_259 ) ) {
F_21 ( V_261 ) ;
* V_259 = F_184 ( - V_66 ) ;
return NULL ;
...
static inline struct V_16 * F_332 ( int V_105 )
{
return F_20 ( F_110 ( V_105 , 0 ) ,
V_24 ) ;
}
static struct V_16 * F_333 ( bool * V_249 )
{
struct V_16 * V_259 ;
do {
V_259 = F_332 ( F_334 () ) ;
...
static bool F_335 ( struct V_80 * V_81 )
{
if ( ( ! ( V_81 -> V_82 & V_227 ) && ! F_336 () ) ||
( V_81 -> V_82 & V_191 ) )
return false ;
...
if ( F_261 ( V_81 ) )
return false ;
F_173 ( V_81 -> V_82 & V_226 , V_81 ) ;
return true ;
}
static void F_337 ( struct V_86 * V_87 ,
unsigned long V_88 ,
struct V_16 * * V_259 ,
struct V_80 * V_81 ,
int V_260 )
...
T_6 V_89 ;
F_38 ( V_88 & ~ V_96 ) ;
V_89 = F_110 ( F_334 () , V_145 ) |
V_266 ;
V_150 = F_329 ( V_259 , V_89 , V_87 , V_88 , V_260 ) ;
if ( ! V_150 )
return;
if ( F_69 ( F_90 ( V_150 , V_87 ,
V_89 , & V_92 ) ) )
return;
F_293 ( & V_87 -> V_242 ) ;
if ( F_69 ( F_283 ( V_87 ) ) )
goto V_78;
V_81 = F_338 ( V_87 , V_88 ) ;
if ( ! V_81 )
goto V_78;
V_239 = ( V_81 -> V_108 + ~ V_96 ) & V_96 ;
V_240 = V_81 -> V_110 & V_96 ;
...
if ( ! F_335 ( V_81 ) )
goto V_78;
V_79 = F_339 ( V_87 , V_88 ) ;
if ( ! V_79 )
goto V_78;
F_265 ( V_81 -> V_132 ) ;
V_148 = F_165 ( V_79 , V_88 ) ;
V_264 = F_340 ( V_87 , V_79 ) ;
V_141 = V_88 ;
V_142 = V_88 + V_109 ;
F_158 ( V_87 , V_141 , V_142 ) ;
V_263 = F_96 ( V_87 , V_79 ) ;
V_139 = F_341 ( V_81 , V_88 , V_79 ) ;
F_98 ( V_263 ) ;
F_171 ( V_87 , V_141 , V_142 ) ;
F_174 ( V_264 ) ;
V_265 = F_302 ( V_81 , V_88 , V_148 ) ;
F_98 ( V_264 ) ;
if ( F_69 ( ! V_265 ) ) {
F_168 ( V_148 ) ;
F_174 ( V_263 ) ;
F_29 ( ! F_97 ( * V_79 ) ) ;
F_161 ( V_87 , V_79 , F_342 ( V_139 ) ) ;
F_98 ( V_263 ) ;
F_266 ( V_81 -> V_132 ) ;
goto V_78;
}
F_266 ( V_81 -> V_132 ) ;
F_315 ( V_148 , V_150 , V_81 , V_88 , V_264 ) ;
F_168 ( V_148 ) ;
F_95 ( V_150 ) ;
V_93 = F_342 ( V_139 ) ;
...
static int F_343 ( struct V_86 * V_87 ,
struct V_80 * V_81 ,
unsigned long V_88 ,
struct V_16 * * V_259 )
{
...
V_148 = F_344 ( V_87 , V_79 , V_88 , & V_94 ) ;
...
V_252 [ V_260 ] ++ ;
F_88 ( F_89 ( V_16 ) , V_16 ) ;
if ( ! F_311 ( V_16 ) || F_201 ( V_16 ) || ! F_241 ( V_16 ) )
goto V_269;
if ( F_251 ( V_16 ) != 1 + ! ! F_306 ( V_16 ) )
goto V_269;
if ( F_312 ( V_245 ) ||
...
if ( V_45 ) {
V_260 = F_327 () ;
F_337 ( V_87 , V_88 , V_259 , V_81 , V_260 ) ;
}
V_78:
return V_45 ;
}
static void F_346 ( struct V_230 * V_230 )
{
struct V_86 * V_87 = V_230 -> V_87 ;
F_38 ( V_270 != 1 && ! F_347 ( & V_236 ) ) ;
if ( F_283 ( V_87 ) ) {
F_290 ( & V_230 -> V_232 ) ;
F_291 ( & V_230 -> V_237 ) ;
F_277 ( V_230 ) ;
...
static unsigned int F_348 ( unsigned int V_58 ,
struct V_16 * * V_259 )
...
static void F_361 ( struct V_80 * V_81 ,
...
for ( V_140 = 0 ; V_140 < V_31 ; V_140 ++ , V_95 += V_146 ) {
T_9 * V_148 , V_85 ;
V_85 = F_362 ( F_363 ( V_95 ) , V_81 -> V_101 ) ;
V_85 = F_364 ( V_85 ) ;
V_148 = F_165 ( & V_139 , V_95 ) ;
F_38 ( ! F_166 ( * V_148 ) ) ;
F_167 ( V_87 , V_95 , V_148 , V_85 ) ;
...
void F_365 ( struct V_80 * V_81 , unsigned long V_88 ,
T_4 * V_79 )
{
T_8 * V_94 ;
struct V_16 * V_16 = NULL ;
...
unsigned long V_141 ;
unsigned long V_142 ;
F_29 ( V_81 -> V_108 > V_95 || V_81 -> V_110 < V_95 + V_109 ) ;
V_141 = V_95 ;
V_142 = V_95 + V_109 ;
V_276:
F_158 ( V_87 , V_141 , V_142 ) ;
...
F_361 ( V_81 , V_95 , V_79 ) ;
} else {
V_16 = F_134 ( * V_79 ) ;
F_88 ( ! F_251 ( V_16 ) , V_16 ) ;
F_136 ( V_16 ) ;
}
V_135:
F_98 ( V_94 ) ;
...
void F_366 ( struct V_86 * V_87 , unsigned long V_88 ,
T_4 * V_79 )
{
struct V_80 * V_81 ;
V_81 = F_338 ( V_87 , V_88 ) ;
...
static void F_367 ( struct V_86 * V_87 ,
unsigned long V_88 )
{
T_10 * V_196 ;
T_11 * V_197 ;
...
if ( ! F_225 ( * V_79 ) )
return;
F_366 ( V_87 , V_88 , V_79 ) ;
}
void F_368 ( struct V_80 * V_81 ,
unsigned long V_277 ,
unsigned long V_278 ,
long V_279 )
{
