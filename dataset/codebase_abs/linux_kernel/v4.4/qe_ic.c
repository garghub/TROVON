...
V_41 = F_29 ( V_19 , 0 , & V_40 ) ;
if ( V_41 )
return;
V_4 = F_30 ( sizeof( * V_4 ) , V_43 ) ;
if ( V_4 == NULL )
return;
V_4 -> V_35 = F_31 ( V_19 , V_44 ,
& V_45 , V_4 ) ;
if ( V_4 -> V_35 == NULL ) {
F_32 ( V_4 ) ;
return;
}
V_4 -> V_12 = F_33 ( V_40 . V_46 , F_34 ( & V_40 ) ) ;
V_4 -> V_29 = V_47 ;
V_4 -> V_48 = F_35 ( V_19 , 0 ) ;
V_4 -> V_49 = F_35 ( V_19 , 1 ) ;
if ( V_4 -> V_49 == V_34 ) {
F_18 ( V_27 L_2 ) ;
F_32 ( V_4 ) ;
return;
...
void F_38 ( unsigned int V_5 , int V_66 )
{
...
int F_40 ( unsigned int V_5 , unsigned int V_71 )
{
struct V_4 * V_4 = F_5 ( V_5 ) ;
unsigned int V_8 = F_39 ( V_5 ) ;
T_1 V_10 ;
...
int F_41 ( unsigned int V_5 , unsigned int V_71 , int V_66 )
{
struct V_4 * V_4 = F_5 ( V_5 ) ;
unsigned int V_8 = F_39 ( V_5 ) ;
