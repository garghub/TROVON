...
V_5 -> V_2 = V_2 ;
V_5 -> V_112 = 64 ;
V_5 -> V_200 = F_131 ( V_201 , 0xff ) ;
memcpy ( V_2 -> V_104 , V_89 -> V_104 , sizeof( V_89 -> V_104 ) ) ;
snprintf ( V_5 -> V_202 , V_186 , V_203 ,
V_185 , V_22 ) ;
V_5 -> V_137 = F_132 ( V_2 , V_5 -> V_202 , F_100 ,
V_204 ) ;
if ( F_18 ( V_5 -> V_137 ) ) {
if ( F_49 ( V_5 ) )
F_125 ( & V_90 -> V_2 , L_43 ) ;
V_184 = F_133 ( V_5 -> V_137 ) ;
goto V_195;
}
V_184 = F_134 ( V_2 ) ;
if ( V_184 ) {
...
static int F_138 ( struct V_183 * V_90 )
{
