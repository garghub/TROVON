...
static enum V_105 F_39 ( struct V_103 * V_104 )
{
struct V_85 * V_36 = V_104 -> V_36 -> V_106 ;
struct V_5 * V_6 = F_38 ( V_36 , struct V_5 , V_36 ) ;
struct V_11 * V_12 = F_9 ( V_6 ) ;
...
static T_2 F_40 ( struct V_5 * V_6 , const T_2 V_112 , const T_2 V_113 )
{
T_3 V_114 ;
int V_81 ;
for ( V_81 = 1 ; V_81 < F_41 ( V_92 ) ; V_81 ++ ) {
...
return 0 ;
V_114 = F_25 ( V_81 ) ;
for ( V_81 = 0 ; V_81 < F_41 ( V_115 ) ; V_81 ++ ) {
...
static int F_42 ( struct V_5 * V_6 , T_2 * V_28 , const T_2 V_113 )
{
const T_2 V_112 = V_6 -> V_119 ;
int V_95 ;
* V_28 = F_40 ( V_6 , V_112 , V_113 ) ;
if ( ! * V_28 ) {
* V_28 = V_112 ;
F_18 ( L_22 ) ;
return V_120 ;
...
struct V_51 * V_52 = & V_6 -> V_53 [ V_54 ] . V_52 ;
struct V_55 * V_43 = F_15 ( V_52 -> V_56 , struct V_55 , V_57 ) ;
const struct V_125 * V_126 = & ( F_44 ( V_6 ) -> V_127 ) ;
const T_2 V_113 = F_45 ( V_126 -> V_113 ) ;
...
V_14 = F_47 ( sizeof( * V_14 ) , V_97 ) ;
if ( ! V_14 )
return - V_98 ;
F_48 ( & V_14 -> V_48 ) ;
V_14 -> V_43 = V_43 ;
V_12 -> V_15 = V_14 ;
V_128 = F_42 ( V_6 , & V_28 , V_113 ) ;
if ( V_128 == V_122 )
return 0 ;
else if ( V_128 < 0 ) {
F_4 ( V_6 , L_26 , V_128 ) ;
...
for ( V_81 = 0 ; V_81 < F_41 ( V_131 ) ; V_81 ++ ) {
...
if ( V_128 == V_121 ) {
for ( V_129 = 0 ; V_129 < F_41 ( V_132 ) ; V_129 ++ ) {
...
F_49 ( V_131 [ V_81 ] . V_133 [ V_83 ] , V_36 -> V_134 ) ;
...
char * V_94 ;
F_36 ( V_6 , 0 ) ;
V_143 = strlen ( F_56 ( & V_6 -> V_36 ) ) + 8 ;
for ( V_83 = 0 ; V_83 < 5 ; V_83 ++ ) {
V_108 = F_47 ( sizeof( struct V_103 ) + V_143 , V_97 ) ;
if ( ! V_108 ) {
F_4 ( V_6 , L_36 , V_83 ) ;
goto V_144;
}
V_94 = ( void * ) ( & V_108 [ 1 ] ) ;
snprintf ( V_94 , V_143 , L_37 , F_56 ( & V_6 -> V_36 ) , V_83 + 1 ) ;
V_108 -> V_94 = V_94 ;
V_108 -> V_145 = 0 ;
V_108 -> V_146 = 1 ;
V_108 -> V_147 = F_39 ;
