...
V_137 ) ;
V_106 = F_35 ( V_104 -> V_107 [ V_138 ] . V_109 ) ;
if ( V_106 != V_110 ) {
unsigned long V_139 = F_91 ( V_131 ) ;
unsigned long V_111 =
F_35 ( V_104 -> V_107 [ V_138 ] . V_112 ) ;
T_1 V_140 ;
if ( V_139 >= V_111 ) {
F_84 ( V_116 , V_117 , V_48 ) ;
return;
...
if ( V_106 < V_111 ) {
V_106 ++ ;
V_104 -> V_107 [ V_138 ] . V_109 = V_106 ;
}
}
V_140 = F_2 ( V_106 ) ;
if ( ! V_133 || V_140 < V_133 ) {
V_133 = V_140 ;
}
}
...
V_24 -> V_29 . V_30 . V_21 = 0 ;
goto V_93;
} else if ( F_48 ( V_9 -> V_141 ) && F_92 ( V_9 ) ) {
F_51 ( V_9 , & V_57 ) ;
goto V_93;
}
F_69 ( V_24 -> V_54 , V_9 , & V_25 ) ;
...
if ( ! F_22 ( & V_48 -> V_69 ) ) {
struct V_32 V_142 ;
V_32 ( V_48 , & V_142 . V_33 , & V_142 . V_34 ) ;
V_142 . V_35 = V_48 -> V_65 . V_35 ;
if ( F_93 ( & V_142 , & V_48 -> V_69 ) )
return 1 ;
}
V_104 = V_48 -> signal ;
if ( F_35 ( V_104 -> V_49 . V_50 ) &&
! F_35 ( V_104 -> V_49 . V_136 ) ) {
struct V_32 V_143 ;
F_33 ( & V_143 , & V_104 -> V_49 . V_44 ) ;
if ( F_93 ( & V_143 , & V_104 -> V_69 ) )
return 1 ;
}
return 0 ;
}
...
void F_4 ( struct V_1 * V_48 , unsigned int V_146 ,
T_1 * V_147 , T_1 * V_148 )
{
unsigned long long V_25 ;
F_46 ( V_146 == V_17 ) ;
F_69 ( V_146 , V_48 , & V_25 ) ;
if ( V_148 ) {
if ( * V_148 ) {
if ( * V_148 <= V_25 ) {
* V_148 = V_126 ;
...
switch ( V_146 ) {
case V_7 :
if ( F_60 ( V_48 -> signal -> V_69 . V_71 , * V_147 ) )
V_48 -> signal -> V_69 . V_71 = * V_147 ;
break;
case V_39 :
if ( F_60 ( V_48 -> signal -> V_69 . V_72 , * V_147 ) )
V_48 -> signal -> V_69 . V_72 = * V_147 ;
break;
}
V_93:
F_72 () ;
...
struct V_14 * V_149 , struct V_84 * V_29 )
{
struct V_23 V_24 ;
int error ;
...
F_18 ( V_8 , V_24 . V_29 . V_30 . V_21 , V_149 ) ;
error = F_76 ( & V_24 , 0 , & V_150 , V_29 ) ;
if ( ! error ) {
F_45 ( & V_24 ) ;
}
F_5 ( & V_24 . V_145 ) ;
...
struct V_14 * V_149 , struct V_14 T_6 * V_153 )
{
struct V_154 * V_154 = & V_13 -> V_154 ;
struct V_84 V_29 ;
int error ;
if ( F_11 ( V_8 ) &&
( F_7 ( V_8 ) == 0 ||
F_7 ( V_8 ) == V_13 -> V_10 ) )
return - V_12 ;
error = F_100 ( V_8 , V_57 , V_149 , & V_29 ) ;
if ( error == - V_152 ) {
if ( V_57 & V_94 )
return - V_155 ;
if ( V_153 && F_106 ( V_153 , & V_29 . V_91 , sizeof *V_153 ) )
return - V_156 ;
V_154 -> V_157 = V_158 ;
V_154 -> V_159 . V_160 = V_8 ;
V_154 -> V_159 . V_153 = V_153 ;
V_154 -> V_159 . V_21 = F_107 ( V_149 ) ;
}
return error ;
}
static long V_158 ( struct V_154 * V_154 )
{
T_2 V_8 = V_154 -> V_159 . V_160 ;
struct V_14 V_102 ;
struct V_84 V_29 ;
int error ;
V_102 = F_19 ( V_154 -> V_159 . V_21 ) ;
error = F_100 ( V_8 , V_94 , & V_102 , & V_29 ) ;
if ( error == - V_152 ) {
struct V_14 T_6 * V_153 = V_154 -> V_159 . V_153 ;
if ( V_153 && F_106 ( V_153 , & V_29 . V_91 , sizeof *V_153 ) )
return - V_156 ;
V_154 -> V_159 . V_21 = F_107 ( & V_102 ) ;
}
return error ;
}
...
struct V_14 * V_149 ,
struct V_14 T_6 * V_153 )
{
return F_105 ( V_161 , V_57 , V_149 , V_153 ) ;
}
static long F_112 ( struct V_154 * V_154 )
{
return - V_12 ;
}
...
struct V_14 * V_15 )
{
return F_25 ( V_162 , V_15 ) ;
}
static int F_114 ( const T_2 V_8 ,
struct V_14 * V_15 )
{
return F_41 ( V_162 , V_15 ) ;
}
