...
if ( V_92 )
F_27 ( V_71 ) -> V_86 = F_38 ( V_92 -> V_94 . V_95 ) ;
F_39 ( V_71 , V_87 ) ;
}
STATIC int
F_40 (
...
F_42 ( V_60 , V_97 , F_43 ( V_60 ) ) ,
F_44 ( V_60 , 1 ) , 0 , & V_71 , & V_101 ) ;
if ( error )
return error ;
F_45 ( V_71 , V_102 ) ;
* V_98 = V_71 ;
...
F_47 ( & V_43 -> V_46 , V_4 ) ;
F_48 ( V_96 , V_4 ) ;
if ( F_49 ( F_10 ( V_43 -> V_46 ) >
F_10 ( V_43 -> V_108 ) ) )
return - V_89 ;
F_50 ( V_96 , V_45 , V_109 ) ;
return 0 ;
}
STATIC int
F_51 (
...
if ( ! args -> V_110 ) {
error = F_46 ( args -> V_96 , args -> V_105 ,
args -> V_45 ,
- ( ( long ) ( args -> V_4 ) ) ) ;
if ( error )
return error ;
ASSERT ( ! F_55 ( args -> V_60 , args -> V_97 ,
args -> V_47 , args -> V_4 ) ) ;
}
if ( ! args -> V_114 ) {
F_56 ( args -> V_96 , args -> V_115 ?
V_116 :
V_117 ,
- ( ( long ) ( args -> V_4 ) ) ) ;
}
F_57 ( args -> V_60 , V_118 ) ;
F_58 ( args -> V_60 , V_119 , args -> V_4 ) ;
return error ;
}
STATIC int
F_54 (
...
int V_54 ;
ASSERT ( args -> V_22 == 1 ) ;
V_49 = F_59 ( args -> V_60 , args -> V_96 , args -> V_45 ,
args -> V_97 , V_123 ) ;
...
goto V_125;
args -> V_4 = F_61 ( V_122 , args -> V_47 + args -> V_42 )
- args -> V_47 ;
F_17 ( args ) ;
if ( ! F_18 ( args ) )
goto V_125;
ASSERT ( args -> V_47 + args -> V_4 <= V_122 ) ;
V_48 = F_59 ( args -> V_60 , args -> V_96 , args -> V_45 ,
args -> V_97 , V_126 ) ;
...
if ( ! V_137 )
error = F_67 ( * V_131 , 0 , & V_54 ) ;
else
error = F_68 ( * V_131 , 0 , & V_54 ) ;
if ( error )
goto V_124;
} while ( V_54 );
V_140:
...
V_144 = F_59 ( args -> V_60 , args -> V_96 ,
...
V_144 = F_59 ( args -> V_60 , args -> V_96 , args -> V_45 ,
args -> V_97 , V_123 ) ;
...
else if ( ( error = F_75 ( V_144 , & V_143 ) ) )
goto V_124;
if ( ( error = F_67 ( V_143 , 0 , & V_54 ) ) )
goto V_124;
if ( ! V_54 ) {
F_62 ( V_143 , V_128 ) ;
V_143 = NULL ;
...
goto V_171;
V_39 = args -> V_4 ;
F_60 ( args -> V_60 , V_39 <= V_51 , V_124 ) ;
V_49 = F_59 ( args -> V_60 , args -> V_96 , args -> V_45 ,
args -> V_97 , V_123 ) ;
...
> args -> V_44 ) ) {
error = F_87 ( args -> V_96 , args -> V_45 , & V_50 , 0 ) ;
if ( error )
goto V_124;
if ( V_50 != V_37 ) {
F_88 ( args -> V_60 , args -> V_97 , V_50 , 1 ,
args -> V_27 ) ;
if ( args -> V_27 ) {
T_9 * V_71 ;
V_71 = F_89 ( args -> V_60 , args -> V_96 ,
args -> V_97 , V_50 , 0 ) ;
F_90 ( args -> V_96 , V_71 ) ;
}
args -> V_4 = 1 ;
...
T_10 * V_105 ;
V_60 = V_96 -> V_180 ;
V_49 = F_59 ( V_60 , V_96 , V_45 , V_97 , V_123 ) ;
V_48 = NULL ;
...
F_60 ( V_60 , V_145 >= V_3 + V_4 , V_124 ) ;
}
}
V_48 = F_59 ( V_60 , V_96 , V_45 , V_97 , V_126 ) ;
if ( V_176 && V_177 ) {
...
goto V_124;
F_60 ( V_60 , V_54 == 0 , V_124 ) ;
if ( ( error = F_25 ( V_48 , & V_54 ) ) )
goto V_124;
F_60 ( V_60 , V_54 == 1 , V_124 ) ;
F_62 ( V_48 , V_128 ) ;
V_48 = NULL ;
V_105 = F_96 ( V_60 , V_97 ) ;
error = F_46 ( V_96 , V_105 , V_45 , V_4 ) ;
F_97 ( V_105 ) ;
if ( error )
goto V_124;
if ( ! V_114 )
F_56 ( V_96 , V_117 , ( long ) V_4 ) ;
F_57 ( V_60 , V_183 ) ;
F_58 ( V_60 , V_184 , V_4 ) ;
F_98 ( V_60 , V_97 , V_3 , V_4 , V_114 , V_176 , V_177 ) ;
return 0 ;
V_124:
F_98 ( V_60 , V_97 , V_3 , V_4 , V_114 , - 1 , - 1 ) ;
if ( V_49 )
F_62 ( V_49 , V_127 ) ;
if ( V_48 )
F_62 ( V_48 , V_127 ) ;
...
{
unsigned int V_196 ;
V_196 = F_102 (unsigned int, pag->pagf_levels[XFS_BTNUM_BNOi] + 1 ,
mp->m_ag_maxlevels) ;
V_196 += F_102 (unsigned int, pag->pagf_levels[XFS_BTNUM_CNTi] + 1 ,
mp->m_ag_maxlevels) ;
return V_196 ;
}
static bool
...
if ( V_53 & V_199 )
return true ;
V_197 = F_100 ( args -> V_60 , V_105 , V_196 ) ;
...
int error = 0 ;
if ( ! V_105 -> V_204 ) {
error = F_105 ( V_60 , V_96 , args -> V_97 , V_53 , & V_45 ) ;
if ( error )
goto V_205;
if ( ! V_105 -> V_204 ) {
ASSERT ( V_53 & V_206 ) ;
...
V_192 = F_101 ( V_60 , V_105 ) ;
if ( ! F_103 ( args , V_192 , V_53 ) )
goto V_207;
if ( ! V_45 ) {
error = F_105 ( V_60 , V_96 , args -> V_97 , V_53 , & V_45 ) ;
if ( error )
...
struct V_70 * V_71 ;
error = F_87 ( V_96 , V_45 , & V_3 , 0 ) ;
if ( error )
goto V_207;
error = F_95 ( V_96 , V_45 , args -> V_97 , V_3 , 1 , 1 ) ;
if ( error )
goto V_207;
V_71 = F_89 ( V_60 , V_96 , args -> V_97 , V_3 , 0 ) ;
F_90 ( V_96 , V_71 ) ;
}
...
V_203 . type = V_111 ;
V_203 . V_105 = V_105 ;
error = F_40 ( V_60 , V_96 , V_203 . V_97 , & V_202 ) ;
if ( error )
goto V_207;
while ( V_105 -> V_194 < V_192 ) {
V_203 . V_47 = 0 ;
...
error = F_40 ( V_60 , V_96 , F_10 ( V_43 -> V_213 ) ,
& V_202 ) ;
if ( error )
return error ;
V_84 = F_108 ( V_60 , V_202 ) ;
V_3 = F_10 ( V_84 [ F_10 ( V_43 -> V_214 ) ] ) ;
F_47 ( & V_43 -> V_214 , 1 ) ;
F_107 ( V_96 , V_202 ) ;
if ( F_10 ( V_43 -> V_214 ) == F_29 ( V_60 ) )
V_43 -> V_214 = 0 ;
V_105 = F_96 ( V_60 , F_10 ( V_43 -> V_213 ) ) ;
F_47 ( & V_43 -> V_175 , - 1 ) ;
F_109 ( V_96 , - 1 ) ;
V_105 -> V_194 -- ;
F_97 ( V_105 ) ;
...
F_111 ( V_96 -> V_180 , F_19 ( V_71 ) , V_220 , V_231 ) ;
F_112 ( V_96 , V_71 , V_232 ) ;
F_113 ( V_220 , V_223 , V_233 , & V_221 , & V_222 ) ;
F_114 ( V_96 , V_71 , ( T_11 ) V_221 , ( T_11 ) V_222 ) ;
}
int
F_115 (
T_6 * V_60 ,
...
T_9 * V_71 ;
int error ;
if ( ( error = F_105 ( V_60 , V_96 , V_97 , V_53 , & V_71 ) ) )
return error ;
if ( V_71 )
F_107 ( V_96 , V_71 ) ;
return 0 ;
...
F_50 ( V_96 , V_45 , V_212 ) ;
F_112 ( V_96 , V_202 , V_238 ) ;
F_114 ( V_96 , V_202 , V_235 ,
V_235 + sizeof( T_1 ) - 1 ) ;
return 0 ;
}
static bool
...
if ( F_33 ( & V_60 -> V_77 ) ) {
if ( ! F_28 ( & V_43 -> V_230 , & V_60 -> V_77 . V_78 ) )
return false ;
if ( ! F_30 ( V_60 ,
F_31 ( F_19 ( V_71 ) -> V_239 ) ) )
return false ;
}
if ( ! ( V_43 -> V_224 == F_6 ( V_240 ) &&
F_117 ( F_10 ( V_43 -> V_225 ) ) &&
F_10 ( V_43 -> V_46 ) <= F_10 ( V_43 -> V_108 ) &&
F_10 ( V_43 -> V_214 ) < F_29 ( V_60 ) &&
F_10 ( V_43 -> V_228 ) < F_29 ( V_60 ) &&
F_10 ( V_43 -> V_175 ) <= F_29 ( V_60 ) ) )
return false ;
if ( F_10 ( V_43 -> V_227 [ V_123 ] ) > V_241 ||
F_10 ( V_43 -> V_227 [ V_126 ] ) > V_241 )
return false ;
...
! F_34 ( V_71 , V_242 ) )
F_35 ( V_71 , - V_88 ) ;
else if ( F_120 ( ! F_116 ( V_60 , V_71 ) , V_60 ,
V_243 ,
V_244 ) )
F_35 ( V_71 , - V_89 ) ;
if ( V_71 -> V_90 )
...
return;
if ( V_92 )
F_19 ( V_71 ) -> V_239 = F_38 ( V_92 -> V_94 . V_95 ) ;
F_39 ( V_71 , V_242 ) ;
}
int
F_122 (
...
error = F_41 (
V_60 , V_96 , V_60 -> V_100 ,
F_42 ( V_60 , V_97 , F_124 ( V_60 ) ) ,
F_44 ( V_60 , 1 ) , V_53 , V_98 , & V_245 ) ;
if ( error )
return error ;
if ( ! * V_98 )
return 0 ;
...
if ( args -> V_22 == 0 )
args -> V_22 = 1 ;
ASSERT ( F_129 ( V_60 , args -> V_262 ) < V_60 -> V_77 . V_263 ) ;
ASSERT ( F_130 ( V_60 , args -> V_262 ) < V_255 ) ;
ASSERT ( args -> V_23 <= args -> V_42 ) ;
ASSERT ( args -> V_23 <= V_255 ) ;
ASSERT ( args -> V_40 < args -> V_41 ) ;
if ( F_129 ( V_60 , args -> V_262 ) >= V_60 -> V_77 . V_263 ||
F_130 ( V_60 , args -> V_262 ) >= V_255 ||
...
case V_112 :
case V_113 :
args -> V_97 = F_129 ( V_60 , args -> V_262 ) ;
args -> V_105 = F_96 ( V_60 , args -> V_97 ) ;
args -> V_44 = 0 ;
error = F_104 ( args , 0 ) ;
args -> V_44 = V_44 ;
if ( error ) {
...
args -> V_47 = F_130 ( V_60 , args -> V_262 ) ;
if ( ( error = F_51 ( args ) ) )
goto V_124;
break;
case V_265 :
...
if ( type == V_271 )
args -> type = V_111 ;
args -> V_97 = V_256 = F_129 ( V_60 , args -> V_262 ) ;
V_53 = V_206 ;
}
for (; ; ) {
args -> V_105 = F_96 ( V_60 , args -> V_97 ) ;
if ( V_258 ) args -> V_44 = 0 ;
error = F_104 ( args , V_53 ) ;
args -> V_44 = V_44 ;
if ( error ) {
F_132 ( args ) ;
goto V_124;
...
args -> V_262 = F_134 ( V_60 , args -> V_97 , args -> V_47 ) ;
#ifdef F_21
ASSERT ( args -> V_4 >= args -> V_23 ) ;
ASSERT ( args -> V_4 <= args -> V_42 ) ;
ASSERT ( args -> V_47 % args -> V_22 == 0 ) ;
F_137 ( V_60 , F_138 ( V_60 , args -> V_262 ) ,
args -> V_4 ) ;
#endif
if ( args -> V_27 & V_274 ) {
error = F_139 ( args -> V_275 , args -> V_262 , args -> V_4 ) ;
if ( error )
goto V_124;
}
}
...
args . V_97 = F_129 ( args . V_60 , V_3 ) ;
if ( args . V_97 >= args . V_60 -> V_77 . V_263 )
return - V_89 ;
args . V_47 = F_130 ( args . V_60 , V_3 ) ;
if ( args . V_47 >= args . V_60 -> V_77 . V_85 )
return - V_89 ;
args . V_105 = F_96 ( args . V_60 , args . V_97 ) ;
ASSERT ( args . V_105 ) ;
error = F_104 ( & args , V_199 ) ;
if ( error )
goto V_124;
if ( args . V_47 + V_4 >
F_10 ( F_19 ( args . V_45 ) -> V_108 ) ) {
...
error = F_95 ( V_96 , args . V_45 , args . V_97 , args . V_47 , V_4 , 0 ) ;
if ( ! error )
F_141 ( V_96 , args . V_97 , args . V_47 , V_4 , 0 ) ;
V_124:
F_97 ( args . V_105 ) ;
return error ;
}
