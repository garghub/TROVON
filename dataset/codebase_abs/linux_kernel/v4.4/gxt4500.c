...
if ( V_34 != V_40 ) {
V_19 -> V_44 . V_46 = 0 ;
V_19 -> V_37 . V_46 = V_19 -> V_44 . V_33 ;
V_19 -> V_42 . V_46 = V_19 -> V_37 . V_46 + V_19 -> V_37 . V_33 ;
if ( V_19 -> V_32 . V_33 )
V_19 -> V_32 . V_46 =
V_19 -> V_42 . V_46 + V_19 -> V_42 . V_33 ;
}
}
...
V_48 -> V_159 = F_24 ( V_138 , 1 ) ;
if ( ! V_48 -> V_159 ) {
F_17 ( & V_138 -> V_145 , L_8 ) ;
goto V_160;
}
F_25 ( V_138 , V_48 ) ;
V_3 -> V_161 = F_26 ( V_48 -> V_114 . V_157 ,
V_48 -> V_114 . V_158 ) ;
#ifdef F_27
F_28 ( V_138 , V_162 , 0x333300 ) ;
#else
F_28 ( V_138 , V_162 , 0x2300 ) ;
F_28 ( V_138 , V_162 + 8 , 0x98530000 ) ;
#endif
V_48 -> V_163 = & V_164 ;
V_48 -> V_165 = V_166 | V_167 |
V_168 ;
V_49 = F_29 ( & V_48 -> V_169 , 256 , 0 ) ;
if ( V_49 ) {
F_17 ( & V_138 -> V_145 , L_9 ) ;
goto V_170;
}
F_14 ( V_133 , V_48 ) ;
if ( ! F_30 ( & V_19 , V_48 , V_171 , NULL , 0 , & V_172 , 8 ) ) {
...
V_47 ( V_48 , L_13 , V_48 -> V_114 . V_152 ) ;
return 0 ;
V_173:
F_33 ( & V_48 -> V_169 ) ;
V_170:
...
F_35 ( V_48 ) ;
V_148:
F_36 ( V_142 , F_20 ( V_138 , 1 ) ) ;
V_147:
F_36 ( V_141 , F_20 ( V_138 , 0 ) ) ;
V_146:
return - V_175 ;
}
static void F_37 ( struct V_137 * V_138 )
{
struct V_47 * V_48 = F_38 ( V_138 ) ;
struct V_2 * V_3 ;
if ( ! V_48 )
return;
V_3 = V_48 -> V_3 ;
