...
V_18 = ( ( V_17 -> V_19 + 1 ) & 0xfffe ) + sizeof( V_20 ) ;
...
F_24 ( V_15 , 4 ) ;
F_25 ( & V_38 ) ;
F_26 ( V_15 , & V_38 , sizeof( V_38 ) ) ;
if ( V_35 ) {
F_25 ( & V_39 ) ;
memcpy ( F_27 ( V_15 ) , & V_39 , sizeof( V_39 ) ) ;
F_13 ( V_15 , sizeof( V_39 ) ) ;
}
F_28 ( V_15 , 1 , 0 ) ;
return V_15 ;
}
...
int F_31 ( struct V_1 * V_2 , int V_45 )
{
int V_18 = ( V_45 ? 1 : 0 ) ;
T_1 V_46 [ 2 ] ;
