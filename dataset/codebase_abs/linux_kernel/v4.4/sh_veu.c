...
struct V_72 V_156 = * V_61 ;
if ( V_62 -> V_2 != V_74 -> V_68 )
return - V_45 ;
F_29 ( & V_156 , V_62 ) ;
if ( V_156 . V_62 . V_74 . V_77 != V_74 -> V_77 ||
V_156 . V_62 . V_74 . V_79 != V_74 -> V_79 )
return - V_45 ;
V_154 = V_74 -> V_83 ? V_74 -> V_83 * V_74 -> V_79 * V_62 -> V_85 / V_62 -> V_86 :
V_74 -> V_77 * V_74 -> V_79 * V_62 -> V_85 / V_62 -> V_86 ;
} else {
V_76 = F_25 ( V_14 , V_105 -> type ) ;
V_154 = V_76 -> V_83 * V_76 -> V_78 . V_79 * V_76 -> V_62 -> V_85 / V_76 -> V_62 -> V_86 ;
}
if ( V_155 < 2 )
* V_150 = V_155 = 2 ;
...
V_152 [ 0 ] = V_154 ;
V_153 [ 0 ] = V_14 -> V_158 ;
F_10 ( V_14 -> V_29 , L_12 , V_155 , V_154 ) ;
return 0 ;
}
static int F_61 ( struct V_20 * V_159 )
{
struct V_13 * V_14 = F_60 ( V_159 -> V_104 ) ;
struct V_71 * V_76 ;
unsigned int V_84 ;
V_76 = F_25 ( V_14 , V_159 -> V_104 -> type ) ;
V_84 = V_76 -> V_83 * V_76 -> V_78 . V_79 *
V_76 -> V_62 -> V_85 / V_76 -> V_62 -> V_86 ;
if ( F_62 ( V_159 , 0 ) < V_84 ) {
F_10 ( V_14 -> V_29 , L_13 ,
V_30 , F_62 ( V_159 , 0 ) , V_84 ) ;
return - V_45 ;
}
F_63 ( V_159 , 0 , V_84 ) ;
return 0 ;
}
static void F_64 ( struct V_20 * V_159 )
{
struct V_160 * V_161 = F_65 ( V_159 ) ;
struct V_13 * V_14 = F_60 ( V_159 -> V_104 ) ;
F_10 ( V_14 -> V_29 , L_11 , V_30 , V_159 -> type ) ;
F_66 ( V_14 -> V_36 , V_161 ) ;
}
static int V_48 ( void * V_18 , struct V_104 * V_162 ,
struct V_104 * V_163 )
{
struct V_13 * V_14 = V_18 ;
int V_106 ;
...
{
struct V_37 * V_38 = V_49 -> V_180 ;
return F_78 ( V_49 , V_38 -> V_75 -> V_36 , V_182 ) ;
}
static int F_79 ( struct V_49 * V_49 , struct V_183 * V_184 )
{
struct V_37 * V_38 = V_49 -> V_180 ;
return F_80 ( V_49 , V_38 -> V_75 -> V_36 , V_184 ) ;
}
static T_3 F_81 ( int V_185 , void * V_186 )
{
struct V_13 * V_14 = V_186 ;
if ( V_14 -> V_148 == V_187 || V_14 -> V_19 ) {
...
struct V_160 * V_189 ;
struct V_160 * V_190 ;
T_1 V_191 = F_3 ( V_14 , V_192 ) ;
if ( ! ( V_191 & 1 ) )
return V_193 ;
F_5 ( V_14 , V_35 , 0 ) ;
F_5 ( V_14 , V_34 , 0 ) ;
F_5 ( V_14 , V_192 , V_191 & ~ 1 ) ;
V_189 = F_84 ( V_14 -> V_36 ) ;
V_190 = F_85 ( V_14 -> V_36 ) ;
if ( ! V_190 || ! V_189 )
return V_193 ;
V_189 -> V_194 = V_190 -> V_194 ;
V_189 -> V_195 &= ~ V_196 ;
V_189 -> V_195 |=
V_190 -> V_195 & V_196 ;
V_189 -> V_197 = V_190 -> V_197 ;
F_86 ( & V_14 -> V_174 ) ;
F_87 ( V_190 , V_198 ) ;
F_87 ( V_189 , V_198 ) ;
F_88 ( & V_14 -> V_174 ) ;
...
static int F_89 ( struct V_200 * V_201 )
{
struct V_13 * V_14 ;
struct V_202 * V_203 ;
struct V_204 * V_205 ;
int V_185 , V_106 ;
V_203 = F_90 ( V_201 , V_206 , 0 ) ;
V_185 = F_91 ( V_201 , 0 ) ;
if ( ! V_203 || V_185 <= 0 ) {
F_92 ( & V_201 -> V_29 , L_16 ) ;
return - V_207 ;
}
V_14 = F_93 ( & V_201 -> V_29 , sizeof( * V_14 ) , V_178 ) ;
if ( ! V_14 )
return - V_179 ;
V_14 -> V_120 = F_94 ( V_203 ) == 0x22c ;
V_14 -> V_16 = F_95 ( & V_201 -> V_29 , V_203 ) ;
if ( F_96 ( V_14 -> V_16 ) )
return F_97 ( V_14 -> V_16 ) ;
V_106 = F_98 ( & V_201 -> V_29 , V_185 , F_83 , F_81 ,
0 , L_17 , V_14 ) ;
if ( V_106 < 0 )
return V_106 ;
V_106 = F_99 ( & V_201 -> V_29 , & V_14 -> V_107 ) ;
if ( V_106 < 0 ) {
F_92 ( & V_201 -> V_29 , L_18 ) ;
return V_106 ;
}
V_205 = & V_14 -> V_205 ;
V_14 -> V_158 = F_100 ( & V_201 -> V_29 ) ;
if ( F_96 ( V_14 -> V_158 ) ) {
V_106 = F_97 ( V_14 -> V_158 ) ;
goto V_208;
}
* V_205 = V_209 ;
V_205 -> V_107 = & V_14 -> V_107 ;
F_101 ( & V_14 -> V_174 ) ;
F_102 ( & V_14 -> V_175 ) ;
V_205 -> V_174 = & V_14 -> V_175 ;
F_103 ( V_205 , V_14 ) ;
V_14 -> V_29 = & V_201 -> V_29 ;
V_14 -> V_25 = V_210 ;
V_14 -> V_32 = V_211 ;
V_14 -> V_47 = F_104 ( & V_212 ) ;
if ( F_96 ( V_14 -> V_47 ) ) {
...
{
struct V_216 * V_107 = F_114 ( V_201 ) ;
