...
{
return F_85 ( V_25 ) -> V_137 -> V_201 ;
}
static void F_101 ( struct V_60 * V_202 )
{
struct V_114 * V_115 = F_2 ( V_202 , struct V_114 ,
V_60 ) ;
struct V_24 * V_25 = V_202 -> V_25 ;
struct V_13 * V_14 = F_2 ( V_25 ,
struct V_13 , V_54 ) ;
V_115 -> V_203 . V_204 = V_115 ;
F_102 ( V_115 , V_14 ) ;
}
