...
struct V_1 * F_214 ( struct V_1 * V_236 ,
T_9 V_237 )
{
...
unsigned int V_240 = V_236 -> V_8 - F_215 ( V_236 ) ;
struct V_1 * V_241 = V_236 ;
unsigned int V_139 = V_240 ;
unsigned int V_242 = F_216 ( V_236 ) ;
unsigned int V_124 ;
unsigned int V_6 ;
T_10 V_243 ;
bool V_179 ;
...
V_97 -> V_100 = V_9 ;
if ( V_236 -> V_92 == V_256 ) {
F_226 ( V_9 -> V_27 , V_236 -> V_27 ) ;
F_226 ( V_9 -> V_92 , V_236 -> V_92 ) ;
F_226 ( V_9 -> V_101 , V_236 -> V_101 ) ;
}
return V_97 ;
V_135:
F_51 ( V_97 ) ;
...
int F_227 ( struct V_1 * * V_7 , struct V_1 * V_2 )
{
struct V_32 * V_257 , * V_258 = F_23 ( V_2 ) ;
unsigned int V_139 = F_228 ( V_2 ) ;
unsigned int V_259 = F_113 ( V_2 ) ;
unsigned int V_6 = F_229 ( V_2 ) ;
struct V_1 * V_260 , * V_261 = * V_7 ;
unsigned int V_262 ;
if ( F_42 ( V_261 -> V_6 + V_6 >= 65536 ) )
return - V_263 ;
V_260 = F_230 ( V_261 ) -> V_264 ;
V_257 = F_23 ( V_260 ) ;
if ( V_259 <= V_139 ) {
T_4 * V_75 ;
T_4 * V_265 ;
...
F_212 ( V_2 , V_139 ) ;
if ( F_230 ( V_261 ) -> V_264 == V_261 )
F_23 ( V_261 ) -> V_78 = V_2 ;
else
F_230 ( V_261 ) -> V_264 -> V_98 = V_2 ;
F_230 ( V_261 ) -> V_264 = V_2 ;
F_231 ( V_2 ) ;
V_260 = V_261 ;
V_142:
F_230 ( V_261 ) -> V_270 ++ ;
...
static bool F_256 ( struct V_158 * V_101 , bool V_310 )
{
bool V_171 ;
if ( F_74 ( V_311 || V_310 ) )
return true ;
...
F_258 ( V_101 -> V_313 -> V_314 , & V_315 , V_316 ) ;
F_259 ( & V_101 -> V_312 ) ;
return V_171 ;
}
...
F_261 ( V_101 ) ;
* F_262 ( V_2 ) = * V_318 ;
F_255 ( V_2 , V_101 , V_319 ) ;
F_254 ( V_101 ) ;
}
void F_263 ( struct V_1 * V_320 ,
struct V_317 * V_318 ,
...
void F_266 ( struct V_1 * V_320 ,
struct V_317 * V_318 )
{
return F_263 ( V_320 , V_318 , V_320 -> V_101 ,
V_319 ) ;
}
void F_267 ( struct V_1 * V_2 , bool V_323 )
{
struct V_158 * V_101 = V_2 -> V_101 ;
struct V_295 * V_296 ;
int V_135 ;
...
static int F_271 ( struct V_1 * V_2 , bool V_329 )
{
unsigned int V_73 ;
bool V_330 ;
V_193 * V_179 ;
...
if ( V_135 < 0 )
goto V_23;
if ( F_272 ( V_2 ) -> V_333 & F_273 ( V_334 | V_335 ) )
V_330 = true ;
V_73 = F_274 ( V_2 ) ;
V_135 = - V_328 ;
if ( V_330 )
goto V_23;
V_179 = F_275 ( V_2 , F_272 ( V_2 ) -> V_336 , V_73 ) ;
if ( F_276 ( V_179 ) )
return F_277 ( V_179 ) ;
if ( V_329 )
* V_179 = ~ F_278 ( F_272 ( V_2 ) -> V_337 ,
F_272 ( V_2 ) -> V_338 ,
V_2 -> V_6 - V_73 ,
F_272 ( V_2 ) -> V_336 , 0 ) ;
V_135 = 0 ;
...
static int F_279 ( struct V_1 * V_2 , bool V_329 )
{
int V_135 ;
T_3 V_339 ;
unsigned int V_73 ;
...
V_135 = F_270 ( V_2 , V_73 , V_341 ) ;
if ( V_135 < 0 )
goto V_23;
V_339 = F_280 ( V_2 ) -> V_339 ;
V_6 = sizeof( struct V_340 ) + F_281 ( F_280 ( V_2 ) -> V_342 ) ;
...
if ( V_135 < 0 )
goto V_23;
V_347 = F_282 ( struct V_346 , V_2 , V_73 ) ;
V_339 = V_347 -> V_339 ;
V_73 += F_283 ( V_347 ) ;
break;
}
...
if ( V_135 < 0 )
goto V_23;
V_347 = F_282 ( struct V_349 , V_2 , V_73 ) ;
V_339 = V_347 -> V_339 ;
V_73 += F_284 ( V_347 ) ;
break;
}
...
if ( V_135 < 0 )
goto V_23;
V_347 = F_282 ( struct V_351 , V_2 , V_73 ) ;
if ( V_347 -> V_333 & F_273 ( V_352 | V_353 ) )
V_330 = true ;
V_339 = V_347 -> V_339 ;
...
if ( ! V_142 || V_330 )
goto V_23;
V_179 = F_275 ( V_2 , V_339 , V_73 ) ;
if ( F_276 ( V_179 ) )
return F_277 ( V_179 ) ;
if ( V_329 )
* V_179 = ~ F_285 ( & F_280 ( V_2 ) -> V_337 ,
& F_280 ( V_2 ) -> V_338 ,
...
int F_286 ( struct V_1 * V_2 , bool V_329 )
{
int V_135 ;
switch ( V_2 -> V_336 ) {
case F_273 ( V_354 ) :
V_135 = F_271 ( V_2 , V_329 ) ;
break;
case F_273 ( V_355 ) :
V_135 = F_279 ( V_2 , V_329 ) ;
break;
default:
V_135 = - V_328 ;
break;
...
{
struct V_1 * V_357 ;
unsigned int V_6 = F_288 ( V_2 ) + V_356 ;
int V_171 ;
if ( V_2 -> V_6 < V_6 )
return NULL ;
else if ( V_2 -> V_6 == V_6 )
...
V_193 V_171 ;
V_357 = F_287 ( V_2 , V_356 ) ;
if ( ! V_357 )
goto V_135;
if ( ! F_292 ( V_357 , V_139 ) )
goto V_135;
F_212 ( V_357 , V_139 ) ;
V_171 = F_291 ( V_357 ) ;
F_217 ( V_357 , V_139 ) ;
...
void F_294 ( struct V_1 * V_2 , bool V_358 )
{
if ( V_358 ) {
F_64 ( V_2 ) ;
F_27 ( V_25 , V_2 ) ;
...
void F_297 ( struct V_1 * V_2 , bool V_360 )
{
V_2 -> V_322 . V_361 = 0 ;
V_2 -> V_362 = V_363 ;
V_2 -> V_364 = 0 ;
...
V_376 = F_281 ( V_375 -> V_378 ) ;
F_312 ( V_2 , V_2 -> V_336 , V_376 ) ;
F_211 ( V_2 , V_372 ) ;
F_313 ( V_2 , V_375 ) ;
V_2 = F_307 ( V_2 ) ;
if ( F_42 ( ! V_2 ) )
...
int F_316 ( struct V_1 * V_2 , int V_379 )
{
if ( ! F_292 ( V_2 , V_379 ) )
return - V_109 ;
if ( ! F_121 ( V_2 ) || F_317 ( V_2 , V_379 ) )
return 0 ;
return F_117 ( V_2 , 0 , 0 , V_52 ) ;
}
static int F_318 ( struct V_1 * V_2 , T_12 * V_376 )
{
struct V_374 * V_375 ;
unsigned int V_139 = V_2 -> V_8 - F_215 ( V_2 ) ;
int V_135 ;
F_217 ( V_2 , V_139 ) ;
V_135 = F_316 ( V_2 , V_380 ) ;
if ( F_42 ( V_135 ) )
goto V_381;
F_213 ( V_2 , V_2 -> V_8 + ( 2 * V_373 ) , V_372 ) ;
...
if ( F_42 ( ( V_2 -> V_336 != F_273 ( V_383 ) &&
V_2 -> V_336 != F_273 ( V_384 ) ) ||
V_2 -> V_6 < V_380 ) )
return 0 ;
V_135 = F_318 ( V_2 , & V_376 ) ;
if ( V_135 )
return V_135 ;
}
if ( F_74 ( ( V_2 -> V_336 != F_273 ( V_383 ) &&
V_2 -> V_336 != F_273 ( V_384 ) ) ||
V_2 -> V_6 < V_380 ) )
return 0 ;
V_382 = V_2 -> V_336 ;
...
if ( F_42 ( V_135 ) )
return V_135 ;
F_312 ( V_2 , V_382 , V_376 ) ;
return 0 ;
}
int F_322 ( struct V_1 * V_2 , T_10 V_382 , T_12 V_376 )
{
if ( F_310 ( V_2 ) ) {
unsigned int V_139 = V_2 -> V_8 - F_215 ( V_2 ) ;
int V_135 ;
F_217 ( V_2 , V_139 ) ;
V_135 = F_323 ( V_2 , V_2 -> V_382 ,
F_324 ( V_2 ) ) ;
if ( V_135 )
return V_135 ;
V_2 -> V_336 = V_2 -> V_382 ;
...
struct V_1 * F_327 ( unsigned long V_386 ,
unsigned long V_74 ,
int V_387 ,
int * V_388 ,
T_2 V_24 )
