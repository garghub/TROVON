...
F_25 ( & V_6 -> V_46 ) ;
F_37 ( & V_6 -> V_26 ) ;
V_41 = F_6 ( V_6 , V_6 -> V_27 ) ;
V_40 = F_6 ( V_6 , V_6 -> V_28 ) ;
if ( V_41 < V_40 ) {
memcpy ( V_59 + V_40 , V_6 -> V_2 + V_40 , ( V_6 -> V_8 - V_40 ) * sizeof( * V_6 -> V_2 ) ) ;
memcpy ( V_59 + V_6 -> V_8 , V_6 -> V_2 , V_41 * sizeof( * V_6 -> V_2 ) ) ;
} else
memcpy ( V_59 + V_40 , V_6 -> V_2 + V_40 , ( V_41 - V_40 ) * sizeof( * V_6 -> V_2 ) ) ;
V_6 -> V_2 = V_59 ;
V_6 -> V_8 = V_58 ;
F_38 ( & V_6 -> V_26 ) ;
F_26 ( & V_6 -> V_46 ) ;
...
struct V_9 * V_10 ;
V_39 = - V_52 ;
if ( F_32 ( & V_95 , V_68 , sizeof( V_95 ) ) )
break;
V_39 = - V_96 ;
if ( V_95 . V_18 >= F_49 () )
break;
V_39 = - V_97 ;
V_10 = F_15 ( V_6 , V_95 . V_18 ) ;
if ( ! V_10 )
break;
F_50 ( F_34 ( V_95 . V_18 ) ) ;
F_45 ( V_6 , V_10 ) ;
...
struct V_9 * V_10 ;
V_39 = - V_52 ;
if ( F_32 ( & V_100 , V_68 , sizeof( V_100 ) ) )
break;
V_39 = - V_97 ;
V_10 = F_15 ( V_6 , V_100 . V_18 ) ;
if ( V_10 ) {
F_51 ( V_100 . V_18 ) ;
V_39 = 0 ;
}
...
static unsigned int F_52 ( struct V_35 * V_35 , T_7 * V_103 )
{
unsigned int V_104 = V_105 | V_106 ;
struct V_5 * V_6 = V_35 -> V_44 ;
F_53 ( V_35 , & V_6 -> V_29 , V_103 ) ;
if ( V_6 -> V_28 != V_6 -> V_27 )
V_104 |= V_107 | V_108 ;
if ( V_6 -> V_33 )
V_104 = V_109 ;
...
static int F_54 ( int V_110 , struct V_35 * V_111 , int V_112 )
{
struct V_5 * V_6 = V_111 -> V_44 ;
return F_55 ( V_110 , V_111 , V_112 , & V_6 -> V_30 ) ;
}
static int F_56 ( struct V_113 * V_113 , struct V_35 * V_111 )
{
struct V_5 * V_6 ;
V_6 = F_40 ( sizeof( * V_6 ) , V_4 ) ;
if ( V_6 == NULL )
return - V_55 ;
V_6 -> V_64 = F_57 ( V_4 , L_2 , V_114 -> V_115 ) ;
if ( V_6 -> V_64 == NULL ) {
F_14 ( V_6 ) ;
return - V_55 ;
}
...
F_60 ( & V_6 -> V_26 ) ;
V_111 -> V_44 = V_6 ;
return F_61 ( V_113 , V_111 ) ;
}
static int F_62 ( struct V_113 * V_113 , struct V_35 * V_111 )
{
struct V_5 * V_6 = V_111 -> V_44 ;
struct V_11 * V_17 ;
while ( ( V_17 = V_6 -> V_13 . V_11 ) ) {
struct V_9 * V_10 ;
V_10 = F_63 ( V_17 , struct V_9 , V_17 ) ;
F_50 ( F_34 ( V_10 -> V_18 ) ) ;
F_45 ( V_6 , V_10 ) ;
}
F_4 ( V_6 -> V_2 ) ;
