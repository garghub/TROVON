...
V_69 = F_138 ( T_1 -> V_91 , L_51 , 0 ) ;
if ( V_69 )
goto V_351;
if ( F_139 ( T_1 -> V_91 , T_1 -> V_35 ) ) {
V_69 = - V_44 ;
goto V_351;
}
T_1 -> V_278 . V_352 = F_106 ;
T_1 -> V_278 . V_353 = F_116 ;
T_1 -> V_278 . V_354 = F_109 ;
T_1 -> V_278 . V_355 = F_110 ;
...
if ( V_42 -> V_356 && V_42 -> V_356 -> V_357 ) {
T_1 -> V_128 = * V_42 -> V_356 ;
} else {
F_140 ( & T_1 -> V_128 ) ;
if ( V_358 != - 1 ) {
...
F_141 () ;
if ( T_1 -> V_122 . V_123 ) {
T_4 V_359 = F_49 ( T_1 , 1000000000 ) ;
T_1 -> V_145 = ( V_359 + 50000000 ) / 100000000 ;
F_9 ( L_54 V_268 L_15 , V_359 ) ;
F_9 ( L_55 ,
T_1 -> V_145 ) ;
}
if ( T_1 -> V_128 . V_360 )
...
T_1 -> V_209 |= V_362 |
V_174 ;
if ( T_1 -> V_128 . V_129 && ! V_363 . V_364 ) {
V_363 . V_364 = true ;
if ( F_142 ( & V_365 ) < 0 ) {
V_363 . V_364 = false ;
