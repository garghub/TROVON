...
if ( V_5 <= F_42 ) {
memcpy ( F_44 ( V_72 , V_5 ) , V_73 + 1 , V_5 ) ;
} else {
memcpy ( F_44 ( V_72 , F_42 ) , V_73 + 1 , F_42 ) ;
F_1 ( V_2 , V_29 ,
F_44 ( V_72 , V_5 - F_42 ) ,
V_5 - F_42 ) ;
}
F_38 ( V_2 ) ;
F_44 ( V_72 , 4 ) ;
if ( F_45 ( V_2 -> V_74 , V_72 ) == 0 )
F_46 ( V_72 ) ;
return 0 ;
}
static T_7 F_47 ( int V_75 , void * V_76 )
{
struct V_77 * V_14 = V_76 ;
struct V_1 * V_2 = F_48 ( V_14 ) ;
F_49 ( V_2 -> V_74 , & V_2 -> V_78 ) ;
return V_79 ;
}
static int F_50 ( struct V_1 * V_2 , struct V_71 * V_72 )
{
...
F_54 ( & V_2 -> V_92 , V_91 ) ;
while ( ! F_55 ( & V_2 -> V_93 ) ) {
V_85 = F_56 ( V_2 -> V_93 . V_94 ,
struct V_84 , V_95 ) ;
F_57 ( & V_85 -> V_95 ) ;
F_58 ( & V_2 -> V_92 , V_91 ) ;
V_90 = F_59 ( ( void * ) V_85 , struct V_84 ,
V_95 ) ;
V_89 = F_59 ( ( void * ) V_90 , struct V_88 ,
V_35 ) ;
V_87 = F_59 ( ( void * ) V_89 , struct V_86 ,
V_96 ) ;
V_72 = F_59 ( ( void * ) V_87 , struct V_71 , V_97 ) ;
V_31 = F_50 ( V_2 , V_72 ) ;
if ( V_31 < 0 ) {
F_52 ( V_2 -> V_74 , V_72 ) ;
return V_31 ;
...
static void F_60 ( struct V_30 * V_24 , struct V_71 * V_72 )
{
struct V_1 * V_2 = V_24 -> V_2 ;
struct V_86 * V_87 = F_61 ( V_72 ) ;
struct V_88 * V_98 = (struct V_88 * ) V_87 -> V_96 ;
struct V_84 * V_99 = (struct V_84 * ) V_98 -> V_35 ;
unsigned long V_91 ;
F_62 ( sizeof( * V_99 ) > sizeof( ( V_98 -> V_35 ) ) ) ;
F_54 ( & V_2 -> V_92 , V_91 ) ;
F_63 ( & V_99 -> V_95 , & V_2 -> V_93 ) ;
F_58 ( & V_2 -> V_92 , V_91 ) ;
F_49 ( V_2 -> V_74 , & V_2 -> V_78 ) ;
}
static void F_64 ( struct V_100 * V_78 )
{
struct V_1 * V_2 = F_59 ( V_78 , struct V_1 , V_78 ) ;
T_4 V_101 ;
int V_31 ;
F_65 ( & V_2 -> V_102 ) ;
if ( V_2 -> V_66 == V_103 )
...
static int F_67 ( struct V_30 * V_24 )
{
struct V_1 * V_2 = V_24 -> V_2 ;
unsigned long V_104 ;
int V_31 = 0 ;
...
static void F_72 ( struct V_30 * V_24 )
{
struct V_1 * V_2 = V_24 -> V_2 ;
unsigned long V_91 ;
F_65 ( & V_2 -> V_102 ) ;
...
static int F_75 ( struct V_77 * V_14 )
{
struct V_1 * V_2 = NULL ;
struct V_30 * V_74 ;
int V_31 = - V_107 ;
V_74 = F_76 ( sizeof( * V_2 ) ) ;
if ( ! V_74 ) {
F_13 ( & V_14 -> V_24 , L_14 ) ;
return - V_43 ;
}
...
F_87 ( & V_2 -> V_92 ) ;
F_88 ( V_74 , & V_14 -> V_24 ) ;
V_2 -> V_114 . V_115 = F_67 ;
V_2 -> V_114 . V_116 = F_72 ;
V_2 -> V_114 . V_117 = F_60 ;
V_31 = F_14 ( V_74 ) ;
if ( V_31 < 0 )
goto V_118;
V_31 = F_18 ( V_74 ) ;
...
static int F_93 ( struct V_77 * V_14 )
{
struct V_1 * V_2 = F_48 ( V_14 ) ;
F_94 ( V_2 -> V_74 ) ;
F_90 ( F_32 ( V_55 ) , V_14 ) ;
