...
int F_56 ( struct V_1 * V_64 , int V_131 )
{
struct V_10 * V_11 = F_4 ( V_64 ) ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
int V_132 = V_13 -> V_32 - F_39 ( V_11 ) ;
if ( V_131 <= 0 || V_131 > V_132 )
return - V_48 ;
V_64 -> V_107 = V_131 ;
return 0 ;
}
int F_57 ( struct V_10 * V_11 , struct V_115 * V_30 , T_3 V_133 , int V_134 )
{
struct V_12 * V_13 ;
struct V_135 * V_136 ;
T_3 * V_41 ;
...
T_3 V_54 ;
struct V_138 V_139 ;
V_13 = F_58 ( sizeof( * V_13 ) , V_140 ) ;
if ( ! V_13 )
return - V_141 ;
F_59 ( & V_13 -> V_142 , V_143 , V_144 ) ;
V_13 -> V_142 . V_145 = & V_146 ;
V_13 -> V_147 . V_9 = ( unsigned long ) V_11 ;
V_13 -> V_147 . V_148 = V_149 ;
F_60 ( & V_13 -> V_150 , 0 ) ;
F_61 ( & V_13 -> V_52 ) ;
V_11 -> V_9 [ 0 ] = ( unsigned long ) V_13 ;
V_13 -> V_55 = V_30 ;
V_136 = F_62 ( V_30 ) ;
V_41 = V_30 -> V_56 -> V_151 ;
V_47 = V_30 -> V_56 -> V_152 ;
F_63 ( & V_139 , V_30 , V_41 , V_47 ) ;
if ( V_139 . V_153 )
V_13 -> V_9 = F_64 ( V_11 -> V_65 ,
V_139 . V_153 -> V_154 ) ;
V_13 -> V_78 = V_139 . V_155 ;
V_13 -> V_73 = V_139 . V_156 ;
V_13 -> V_71 = V_139 . V_157 ;
V_13 -> V_108 = V_139 . V_158 ;
if ( ! V_139 . V_153 && V_30 -> V_159 && V_30 -> V_159 -> V_160 == 2 ) {
V_13 -> V_9 = F_64 ( V_11 -> V_65 , V_30 -> V_56 -> V_57 . V_58 + 1 ) ;
F_11 ( & V_30 -> V_11 , L_19 ) ;
}
if ( ! V_13 -> V_9 ) {
F_11 ( & V_30 -> V_11 , L_20 ) ;
...
V_137 = F_65 ( V_136 , V_13 -> V_9 , V_11 ) ;
if ( V_137 ) {
F_11 ( & V_30 -> V_11 , L_23 ) ;
goto error;
}
...
if ( F_43 ( V_11 ) )
goto V_161;
V_137 = F_66 ( V_11 -> V_65 , V_54 , V_133 ) ;
if ( V_137 ) {
F_11 ( & V_30 -> V_11 , L_24 ) ;
goto V_161;
}
...
F_67 ( V_13 -> V_55 , V_11 ) ;
if ( V_13 -> V_78 ) {
V_137 = F_68 ( V_11 , V_13 -> V_78 -> V_162 ) ;
if ( V_137 ) {
F_11 ( & V_30 -> V_11 , L_26 ) ;
goto V_161;
}
F_27 ( & V_30 -> V_11 , L_27 , V_11 -> V_64 -> V_163 ) ;
}
F_49 ( V_11 ) ;
V_13 -> V_134 = V_134 ;
if ( V_13 -> V_134 & V_164 ) {
V_13 -> V_130 = F_58 ( V_13 -> V_33 , V_140 ) ;
if ( ! V_13 -> V_130 )
goto V_161;
F_27 ( & V_30 -> V_11 , L_28 ) ;
}
V_11 -> V_64 -> V_165 = & V_166 ;
V_11 -> V_64 -> V_167 [ 0 ] = & V_168 ;
V_11 -> V_64 -> V_169 = & V_170 ;
return 0 ;
V_161:
F_67 ( V_13 -> V_55 , NULL ) ;
F_67 ( V_13 -> V_9 , NULL ) ;
...
void F_70 ( struct V_10 * V_11 , struct V_115 * V_30 )
{
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
struct V_135 * V_136 = F_62 ( V_30 ) ;
if ( V_13 == NULL )
return;
F_60 ( & V_13 -> V_150 , 1 ) ;
if ( F_71 ( & V_13 -> V_142 ) )
...
F_67 ( V_13 -> V_55 , NULL ) ;
F_69 ( V_136 , V_13 -> V_55 ) ;
V_13 -> V_55 = NULL ;
}
F_67 ( V_30 , NULL ) ;
F_54 ( V_13 ) ;
}
T_3 F_74 ( struct V_115 * V_30 )
{
struct V_172 * V_173 ;
if ( V_30 -> V_174 < 2 )
return V_30 -> V_56 -> V_57 . V_175 ;
if ( V_176 ) {
V_173 = F_75 ( V_30 , V_177 ) ;
if ( V_173 && F_38 ( V_173 ) )
return V_177 ;
}
return V_178 ;
}
static int F_76 ( struct V_10 * V_11 , struct V_115 * V_30 )
{
int V_49 ;
if ( F_74 ( V_30 ) != V_178 )
return - V_171 ;
V_49 = F_57 ( V_11 , V_30 , V_179 , 0 ) ;
F_77 ( V_11 , 0 , 0 ) ;
return V_49 ;
}
static void F_78 ( struct V_180 * V_181 , T_5 V_182 , T_5 V_183 , T_5 V_24 )
{
T_5 V_184 = F_79 ( V_181 -> V_47 , V_182 ) - V_181 -> V_47 + V_183 ;
if ( V_181 -> V_47 + V_184 > V_24 )
V_184 = V_24 - V_181 -> V_47 ;
if ( V_184 && F_80 ( V_181 ) >= V_184 )
memset ( F_81 ( V_181 , V_184 ) , 0 , V_184 ) ;
}
static struct V_99 * F_82 ( struct V_12 * V_13 , struct V_180 * V_181 , T_6 V_185 , T_5 V_186 )
{
struct V_99 * V_187 = NULL ;
struct V_34 * V_188 = ( void * ) V_181 -> V_9 ;
T_5 V_189 = F_42 ( V_188 -> V_190 ) ;
if ( V_13 -> V_134 & V_164 ) {
if ( V_13 -> V_130 -> V_191 == V_185 )
return V_13 -> V_130 ;
else if ( V_13 -> V_130 -> V_191 )
return NULL ;
}
while ( V_189 ) {
...
if ( ! ( V_13 -> V_134 & V_164 ) )
F_78 ( V_181 , V_13 -> V_94 , 0 , V_13 -> V_44 ) ;
...
if ( ! ( V_13 -> V_134 & V_164 ) )
V_187 = (struct V_99 * ) memset ( F_81 ( V_181 , V_13 -> V_33 ) , 0 , V_13 -> V_33 ) ;
else
V_187 = V_13 -> V_130 ;
V_187 -> V_191 = V_185 ;
...
struct V_180 *
F_83 ( struct V_10 * V_11 , struct V_180 * V_181 , T_6 V_185 )
{
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
struct V_34 * V_188 ;
struct V_99 * V_187 ;
...
V_199 = 0 ;
if ( V_181 != NULL ) {
F_84 ( V_181 , V_13 -> V_129 ) ;
F_84 ( V_185 , V_13 -> V_200 ) ;
} else {
V_198 = 1 ;
}
V_194 = V_13 -> V_67 ;
if ( ! V_194 ) {
V_194 = F_85 ( V_13 -> V_44 , V_201 ) ;
if ( V_194 == NULL ) {
if ( V_181 != NULL ) {
F_34 ( V_181 ) ;
V_11 -> V_64 -> V_8 . V_202 ++ ;
...
V_188 = (struct V_34 * ) memset ( F_81 ( V_194 , sizeof( struct V_34 ) ) , 0 , sizeof( struct V_34 ) ) ;
V_188 -> V_191 = F_26 ( V_204 ) ;
V_188 -> V_205 = F_47 ( sizeof( struct V_34 ) ) ;
V_188 -> V_206 = F_47 ( V_13 -> V_207 ++ ) ;
V_13 -> V_208 = 0 ;
V_13 -> V_209 = 0 ;
}
for ( V_195 = V_13 -> V_208 ; V_195 < V_13 -> V_96 ; V_195 ++ ) {
if ( V_181 == NULL ) {
V_181 = V_13 -> V_129 ;
V_185 = V_13 -> V_200 ;
V_13 -> V_129 = NULL ;
...
V_187 = F_82 ( V_13 , V_194 , V_185 , V_181 -> V_47 + V_13 -> V_92 + V_13 -> V_90 ) ;
F_78 ( V_194 , V_13 -> V_92 , V_13 -> V_90 , V_13 -> V_44 ) ;
if ( ! V_187 || V_194 -> V_47 + V_181 -> V_47 + V_199 > V_13 -> V_44 ) {
if ( V_195 == 0 ) {
F_34 ( V_181 ) ;
V_181 = NULL ;
V_11 -> V_64 -> V_8 . V_202 ++ ;
...
V_187 -> V_211 [ V_196 ] . V_212 = F_47 ( V_181 -> V_47 ) ;
V_187 -> V_211 [ V_196 ] . V_213 = F_47 ( V_194 -> V_47 ) ;
V_187 -> V_193 = F_47 ( V_197 + sizeof( struct V_100 ) ) ;
memcpy ( F_81 ( V_194 , V_181 -> V_47 ) , V_181 -> V_9 , V_181 -> V_47 ) ;
V_13 -> V_209 += V_181 -> V_47 ;
F_34 ( V_181 ) ;
V_181 = NULL ;
if ( V_196 >= V_98 ) {
V_198 = 1 ;
...
F_78 ( V_194 , V_13 -> V_94 , 0 , V_13 -> V_44 ) ;
V_188 -> V_190 = F_47 ( V_194 -> V_47 ) ;
memcpy ( F_81 ( V_194 , V_13 -> V_33 ) , V_13 -> V_130 , V_13 -> V_33 ) ;
V_187 = memset ( V_13 -> V_130 , 0 , V_13 -> V_33 ) ;
}
if ( ! ( V_11 -> V_218 -> V_219 & V_220 ) &&
V_194 -> V_47 > V_13 -> V_42 )
memset ( F_81 ( V_194 , V_13 -> V_44 - V_194 -> V_47 ) , 0 ,
V_13 -> V_44 - V_194 -> V_47 ) ;
else if ( V_194 -> V_47 < V_13 -> V_44 && ( V_194 -> V_47 % V_11 -> V_221 ) == 0 )
* F_81 ( V_194 , 1 ) = 0 ;
V_188 = (struct V_34 * ) V_194 -> V_9 ;
V_188 -> V_222 = F_47 ( V_194 -> V_47 ) ;
V_13 -> V_67 = NULL ;
V_13 -> V_223 += V_194 -> V_47 - V_13 -> V_209 ;
V_13 -> V_224 ++ ;
F_86 ( V_194 , V_195 ,
( long ) V_13 -> V_209 - V_194 -> V_47 ) ;
return V_194 ;
V_203:
...
{
if ( ! ( F_71 ( & V_13 -> V_142 ) || F_88 ( & V_13 -> V_150 ) ) )
F_89 ( & V_13 -> V_142 ,
F_90 ( 0 , V_13 -> V_45 ) ,
V_144 ) ;
}
static enum V_225 V_146 ( struct V_226 * V_227 )
{
struct V_12 * V_13 =
F_91 ( V_227 , struct V_12 , V_142 ) ;
if ( ! F_88 ( & V_13 -> V_150 ) )
F_92 ( & V_13 -> V_147 ) ;
return V_228 ;
}
static void V_149 ( unsigned long V_229 )
{
struct V_10 * V_11 = (struct V_10 * ) V_229 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
F_24 ( & V_13 -> V_52 ) ;
if ( V_13 -> V_53 != 0 ) {
V_13 -> V_53 -- ;
...
struct V_180 *
F_93 ( struct V_10 * V_11 , struct V_180 * V_181 , T_8 V_219 )
{
struct V_180 * V_194 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
if ( V_13 == NULL )
goto error;
F_24 ( & V_13 -> V_52 ) ;
V_194 = F_83 ( V_11 , V_181 , F_26 ( V_231 ) ) ;
F_25 ( & V_13 -> V_52 ) ;
return V_194 ;
error:
if ( V_181 != NULL )
...
int F_94 ( struct V_12 * V_13 , struct V_180 * V_232 )
{
struct V_10 * V_11 = F_4 ( V_232 -> V_11 ) ;
struct V_34 * V_188 ;
int V_47 ;
int V_49 = - V_48 ;
if ( V_13 == NULL )
goto error;
if ( V_232 -> V_47 < ( sizeof( struct V_34 ) +
sizeof( struct V_99 ) ) ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 , L_30 ) ;
goto error;
}
V_188 = (struct V_34 * ) V_232 -> V_9 ;
if ( V_188 -> V_191 != F_26 ( V_204 ) ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 ,
L_31 ,
F_8 ( V_188 -> V_191 ) ) ;
goto error;
}
V_47 = F_42 ( V_188 -> V_222 ) ;
if ( V_47 > V_13 -> V_43 ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 ,
L_32 , V_47 ,
V_13 -> V_43 ) ;
...
if ( ( V_13 -> V_234 + 1 ) != F_42 ( V_188 -> V_206 ) &&
( V_13 -> V_234 || F_42 ( V_188 -> V_206 ) ) &&
! ( ( V_13 -> V_234 == 0xffff ) && ! F_42 ( V_188 -> V_206 ) ) ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 ,
L_33 ,
V_13 -> V_234 , F_42 ( V_188 -> V_206 ) ) ;
}
...
int F_96 ( struct V_180 * V_232 , int V_189 )
{
struct V_10 * V_11 = F_4 ( V_232 -> V_11 ) ;
struct V_99 * V_187 ;
int V_49 = - V_48 ;
if ( ( V_189 + sizeof( struct V_99 ) ) > V_232 -> V_47 ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 , L_34 ,
V_189 ) ;
goto error;
}
V_187 = (struct V_99 * ) ( V_232 -> V_9 + V_189 ) ;
if ( F_42 ( V_187 -> V_193 ) < V_235 ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 , L_35 ,
F_42 ( V_187 -> V_193 ) ) ;
goto error;
}
...
V_49 * ( sizeof( struct V_100 ) ) ) > V_232 -> V_47 ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 , L_36 , V_49 ) ;
V_49 = - V_48 ;
}
error:
return V_49 ;
}
int F_97 ( struct V_10 * V_11 , struct V_180 * V_232 )
{
struct V_180 * V_181 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
int V_47 ;
...
int V_239 = 50 ;
V_18 V_240 = 0 ;
V_189 = F_94 ( V_13 , V_232 ) ;
if ( V_189 < 0 )
goto error;
V_241:
V_236 = F_96 ( V_232 , V_189 ) ;
if ( V_236 < 0 )
goto error;
V_187 = (struct V_99 * ) ( V_232 -> V_9 + V_189 ) ;
if ( V_187 -> V_191 != F_26 ( V_231 ) ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 ,
L_37 ,
F_8 ( V_187 -> V_191 ) ) ;
goto V_242;
...
V_211 = V_187 -> V_211 ;
for ( V_237 = 0 ; V_237 < V_236 ; V_237 ++ , V_211 ++ ) {
V_238 = F_42 ( V_211 -> V_213 ) ;
V_47 = F_42 ( V_211 -> V_212 ) ;
if ( ( V_238 == 0 ) || ( V_47 == 0 ) ) {
if ( ! V_237 )
goto V_242;
break;
}
if ( ( ( V_238 + V_47 ) > V_232 -> V_47 ) ||
( V_47 > V_13 -> V_43 ) || ( V_47 < V_74 ) ) {
F_95 ( V_11 , V_233 , V_11 -> V_64 ,
L_38 ,
V_237 , V_238 , V_47 , V_232 ) ;
if ( ! V_237 )
goto V_242;
break;
} else {
V_181 = F_98 ( V_11 -> V_64 , V_47 ) ;
if ( ! V_181 )
goto error;
memcpy ( F_81 ( V_181 , V_47 ) , V_232 -> V_9 + V_238 , V_47 ) ;
F_99 ( V_11 , V_181 ) ;
V_240 += V_47 ;
}
}
...
struct V_245 * V_9 )
{
T_9 V_246 = F_8 ( V_9 -> V_247 ) ;
T_9 V_248 = F_8 ( V_9 -> V_249 ) ;
if ( ( V_248 > 1000000 ) && ( V_246 > 1000000 ) ) {
F_101 ( V_11 , V_250 , V_11 -> V_64 ,
L_39 ,
( unsigned int ) ( V_246 / 1000000U ) ,
( unsigned int ) ( V_248 / 1000000U ) ) ;
} else {
F_101 ( V_11 , V_250 , V_11 -> V_64 ,
L_40 ,
( unsigned int ) ( V_246 / 1000U ) ,
( unsigned int ) ( V_248 / 1000U ) ) ;
}
}
static void F_102 ( struct V_10 * V_11 , struct V_251 * V_251 )
{
struct V_12 * V_13 ;
struct V_252 * V_253 ;
V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
if ( V_251 -> V_254 < sizeof( * V_253 ) )
return;
if ( F_103 ( V_255 , & V_11 -> V_219 ) ) {
F_100 ( V_11 ,
(struct V_245 * ) V_251 -> V_256 ) ;
return;
}
V_253 = V_251 -> V_256 ;
switch ( V_253 -> V_257 ) {
...
F_101 ( V_11 , V_250 , V_11 -> V_64 ,
L_41 ,
! ! V_253 -> V_259 ? L_42 : L_43 ) ;
F_77 ( V_11 , ! ! V_253 -> V_259 , 0 ) ;
break;
case V_260 :
if ( V_251 -> V_254 < ( sizeof( * V_253 ) +
sizeof( struct V_245 ) ) )
F_104 ( V_255 , & V_11 -> V_219 ) ;
else
F_100 ( V_11 ,
(struct V_245 * ) & V_253 [ 1 ] ) ;
break;
default:
F_11 ( & V_11 -> V_65 -> V_11 ,
L_44 ,
