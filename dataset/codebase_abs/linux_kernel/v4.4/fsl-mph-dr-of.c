...
* V_23 -> V_30 . V_33 = * V_18 -> V_30 . V_33 ;
V_28 = F_8 ( V_23 , V_20 , sizeof( * V_20 ) ) ;
if ( V_28 )
goto error;
if ( V_26 ) {
V_28 = F_9 ( V_23 , V_25 , V_26 ) ;
if ( V_28 )
goto error;
}
V_28 = F_10 ( V_23 ) ;
...
static enum V_34 F_13 ( struct V_2 * V_3 )
{
enum V_34 V_35 = V_36 ;
if ( F_14 ( V_3 , L_8 ) ) {
if ( F_14 ( V_3 , L_9 ) )
...
V_20 -> V_59 = F_5 ( V_4 ) ;
V_20 -> V_60 = F_13 ( V_3 ) ;
if ( F_2 ( V_3 , L_24 , NULL ) )
V_20 -> V_61 = 1 ;
else
V_20 -> V_61 = 0 ;
if ( F_2 ( V_3 , L_25 , NULL ) )
V_20 -> V_62 = 1 ;
else
V_20 -> V_62 = 0 ;
if ( F_2 ( V_3 , L_26 , NULL ) )
V_20 -> V_63 = 1 ;
else
V_20 -> V_63 = 0 ;
if ( V_20 -> V_64 ) {
...
static int F_22 ( struct V_66 * V_30 , void * V_67 )
{
F_23 ( F_24 ( V_30 ) ) ;
return 0 ;
}
...
{
F_26 ( & V_18 -> V_30 , NULL , F_22 ) ;
return 0 ;
}
int F_27 ( struct V_17 * V_23 )
{
struct V_19 * V_20 = F_28 ( & V_23 -> V_30 ) ;
struct V_68 * V_68 ;
int V_69 ;
V_68 = F_29 ( V_23 -> V_30 . V_31 , L_29 ) ;
if ( F_19 ( V_68 ) ) {
F_20 ( & V_23 -> V_30 , L_30 ) ;
return F_21 ( V_68 ) ;
}
...
if ( V_20 -> V_57 )
V_70 |= V_72 ;
F_31 ( V_20 -> V_73 + V_74 , V_75 | V_76 ) ;
F_31 ( V_20 -> V_73 + V_77 , V_70 ) ;
}
return 0 ;
}
static void F_32 ( struct V_17 * V_23 )
{
struct V_19 * V_20 = F_28 ( & V_23 -> V_30 ) ;
V_20 -> V_73 = NULL ;
if ( V_20 -> V_68 )
