...
{
struct V_1 * V_1 = F_34 ( V_56 ) ;
unsigned V_101 = F_63 ( * V_100 ) , V_102 = 0 ;
...
unsigned V_101 = F_63 ( V_86 [ V_66 ] ) ;
unsigned V_102 = F_66 ( V_86 [ V_66 ] ) ;
F_61 ( V_56 -> V_43 , L_8 ,
...
F_61 ( V_56 -> V_43 , L_10 , V_115 , V_59 ) ;
F_36 ( V_56 , V_57 , V_59 ) ;
return 0 ;
}
...
V_59 = F_33 ( V_56 , V_57 ) ;
if ( V_59 & V_105 )
F_69 ( V_121 , L_12 , L_13 ) ;
if ( V_59 & V_107 )
F_69 ( V_121 , L_12 , L_14 ) ;
if ( V_59 & V_117 )
F_69 ( V_121 , L_12 , L_15 ) ;
if ( V_59 & V_110 )
F_69 ( V_121 , L_12 , L_16 ) ;
if ( V_59 & V_112 )
F_69 ( V_121 , L_12 , L_17 ) ;
}
static int F_70 ( struct V_79 * V_43 )
{
struct V_122 * V_123 = F_71 ( V_43 ) ;
struct V_1 * V_1 = F_72 ( V_123 ) ;
int V_66 ;
...
static int F_73 ( struct V_79 * V_43 )
{
struct V_122 * V_123 = F_71 ( V_43 ) ;
struct V_1 * V_1 = F_72 ( V_123 ) ;
int V_66 ;
...
struct V_1 * V_1 ;
struct V_130 * V_130 ;
V_1 = F_75 ( V_43 , sizeof( * V_1 ) , V_131 ) ;
if ( ! V_1 )
return - V_132 ;
V_1 -> V_43 = V_43 ;
V_1 -> V_78 = V_43 -> V_133 ;
F_76 ( V_123 , V_1 ) ;
V_128 = F_77 ( V_134 , V_43 -> V_133 ) ;
if ( ! V_128 ) {
F_20 ( V_43 , L_18 ) ;
return - V_135 ;
}
...
V_103 = F_78 ( V_123 , V_137 , 0 ) ;
if ( ! V_103 ) {
F_20 ( V_43 , L_19 ) ;
return - V_29 ;
}
V_1 -> V_4 = F_79 ( V_43 , V_103 ) ;
if ( F_80 ( V_1 -> V_4 ) )
return - V_29 ;
V_1 -> V_138 = F_81 ( V_43 , NULL ) ;
if ( F_80 ( V_1 -> V_138 ) ) {
F_20 ( V_43 , L_20 ) ;
return F_82 ( V_1 -> V_138 ) ;
}
V_1 -> V_11 = F_75 ( V_43 , sizeof( * V_1 -> V_11 )
* V_1 -> V_60 , V_131 ) ;
if ( ! V_1 -> V_11 )
return - V_132 ;
V_126 = F_75 ( V_43 , sizeof( * V_126 )
* V_1 -> V_60 , V_131 ) ;
if ( ! V_126 )
return - V_132 ;
V_139 . V_11 = V_126 ;
V_139 . V_60 = V_1 -> V_60 ;
V_97 = F_75 ( V_43 , sizeof( * V_97 )
* V_1 -> V_60 , V_131 ) ;
if ( ! V_97 )
return - V_132 ;
V_1 -> V_97 = V_97 ;
V_1 -> V_62 = F_75 ( & V_123 -> V_43 ,
...
V_126 [ V_66 ] . V_63 = F_83 ( V_131 , L_21 ,
V_2 + 'A' , line ) ;
...
F_85 ( V_103 -> V_146 , F_16 ) ;
F_86 ( V_103 -> V_146 , V_1 ) ;
F_61 ( V_43 , L_24 , V_66 , V_103 -> V_146 ) ;
}
V_1 -> V_54 = F_87 ( V_43 -> V_133 ,
V_1 -> V_47 -> V_142 ,
& V_147 , NULL ) ;
if ( ! V_1 -> V_54 ) {
F_20 ( V_43 , L_25 ) ;
