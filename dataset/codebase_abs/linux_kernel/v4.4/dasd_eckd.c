...
static int F_92 ( struct V_167 * V_308 )
{
char * V_309 ;
...
static void F_94 ( struct V_167 * V_308 ,
void * V_29 )
{
struct V_32 * V_33 ;
struct V_30 * V_31 ;
...
static int
F_107 ( struct V_274 * V_178 , struct V_329 * V_22 )
{
struct V_32 * V_33 ;
V_33 = (struct V_32 * ) V_178 -> V_289 -> V_33 ;
if ( F_99 ( V_178 -> V_319 ) == 0 ) {
...
V_168 = F_108 ( V_289 , V_333 , V_252 ) ;
F_113 ( & V_168 -> V_354 , & V_349 ) ;
V_333 -> V_345 = V_350 ;
V_333 -> V_346 ++ ;
if ( V_333 -> V_346 > V_333 -> V_345 )
goto V_355;
...
V_355:
V_353 = F_114 ( & V_349 ) ;
F_115 (cqr, n, &format_queue, blocklist) {
V_31 = V_168 -> V_119 ;
V_33 = (struct V_32 * ) V_31 -> V_33 ;
...
V_168 -> V_170 = V_168 -> V_178 -> V_289 -> V_215 . V_212 ;
}
}
static T_5
...
static T_5
F_120 ( struct V_167 * V_168 )
{
return V_360 ;
}
static void F_121 ( struct V_30 * V_31 ,
struct V_167 * V_168 ,
struct V_313 * V_313 )
{
char V_66 ;
...
if ( ( F_122 ( & V_313 -> V_364 ) & V_66 ) == V_66 ) {
...
if ( F_128 ( V_373 ) == V_389 )
V_48 = V_60 ;
else if ( F_128 ( V_373 ) == V_390 )
V_48 = V_72 ;
else
return F_110 ( - V_128 ) ;
V_42 = 0 ;
...
if ( F_130 ( F_131 ( V_384 . V_392 ) , V_384 . V_391 ) )
...
F_129 (bv, req, iter) {
V_385 = F_131 ( V_384 . V_392 ) + V_384 . V_393 ;
if ( V_394 ) {
char * V_395 = F_132 ( V_394 ,
V_196 | V_396 ) ;
if ( V_395 && F_128 ( V_373 ) == V_390 )
...
T_6 V_397 = V_146 ;
unsigned int V_398 = F_133 ( V_397 , V_145 ) ;
V_388 = V_48 ;
V_42 = V_121 ;
...
V_45 -> V_54 = V_388 ;
V_45 -> V_42 = V_42 ;
if ( F_130 ( V_385 , V_121 ) ) {
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_380 ;
V_45 -> V_43 = V_399 ;
V_380 = F_134 ( V_380 , V_385 , V_121 ) ;
} else {
...
if ( V_408 ) {
V_397 = V_146 ;
V_398 = F_133 ( V_397 , V_145 ) ;
V_403 = V_145 - V_398 ;
V_42 = F_137 ( ( V_375 - V_146 + 1 ) ,
( T_6 ) V_403 ) ;
V_407 = V_42 * V_121 ;
V_45 [ - 1 ] . V_43 |= V_250 ;
V_45 -> V_54 = V_48 ;
...
static int F_138 ( struct V_412 * V_412 ,
unsigned int V_46 , unsigned int V_47 , int V_48 ,
struct V_30 * V_118 ,
struct V_30 * V_119 ,
...
V_414 = F_139 ( V_412 , V_415 , 0 ,
& V_94 , sizeof( V_94 ) , V_413 ) ;
return F_140 ( V_414 ) ;
}
static struct V_167 * F_141 (
struct V_30 * V_119 ,
struct V_274 * V_178 ,
struct V_372 * V_373 ,
T_6 V_374 ,
...
if ( F_128 ( V_373 ) == V_390 )
V_423 += ( V_377 - V_376 ) ;
V_427 = F_142 ( 0 , V_423 , 0 ) ;
...
V_100 = V_379 + 1 ;
V_100 *= V_121 ;
V_412 = F_143 ( V_168 -> V_29 , V_427 , V_426 , 0 , V_423 , 0 ) ;
if ( F_44 ( V_412 ) ) {
V_3 = - V_128 ;
goto V_194;
}
V_168 -> V_171 = F_144 ( V_412 ) ;
if ( F_138 ( V_412 , V_376 , V_377 ,
V_48 , V_118 , V_119 ,
V_378 + 1 ,
V_402 , V_121 ,
( V_375 - V_374 + 1 ) * V_121 ,
...
static struct V_167 * F_147 ( struct V_30 * V_119 ,
struct V_274 * V_178 ,
struct V_372 * V_373 )
{
int V_435 , V_436 ;
...
if ( V_145 == 0 )
return F_110 ( - V_128 ) ;
V_374 = V_376 = F_148 ( V_373 ) >> V_178 -> V_322 ;
V_378 = F_133 ( V_376 , V_145 ) ;
V_375 = V_377 =
( F_148 ( V_373 ) + F_149 ( V_373 ) - 1 ) >> V_178 -> V_322 ;
V_379 = F_133 ( V_377 , V_145 ) ;
...
( ( ( F_128 ( V_373 ) == V_389 ) && V_435 ) ||
( ( F_128 ( V_373 ) == V_390 ) && V_436 ) ) ) {
V_168 = F_136 ( V_119 , V_178 , V_373 ,
V_374 , V_375 ,
V_376 , V_377 ,
V_378 , V_379 ,
V_145 , V_121 ) ;
...
static struct V_167 * F_151 ( struct V_30 * V_119 ,
struct V_274 * V_178 ,
struct V_372 * V_373 )
{
unsigned long * V_380 ;
...
unsigned int V_443 ;
V_440 = F_148 ( V_373 ) % V_444 ;
V_441 = ( F_148 ( V_373 ) + F_149 ( V_373 ) ) %
V_444 ;
V_442 = ( V_444 - V_441 ) %
V_444 ;
V_118 = V_178 -> V_289 ;
...
V_376 = F_148 ( V_373 ) / V_444 ;
V_377 = ( F_148 ( V_373 ) + F_149 ( V_373 ) - 1 ) /
V_444 ;
V_402 = V_377 - V_376 + 1 ;
V_378 = 0 ;
if ( F_128 ( V_373 ) == V_389 )
...
static int
F_152 ( struct V_167 * V_168 , struct V_372 * V_373 )
{
struct V_32 * V_33 ;
struct V_26 * V_45 ;
struct V_381 V_382 ;
...
V_145 = F_9 ( & V_33 -> V_35 , 0 , V_121 ) ;
V_146 = F_148 ( V_373 ) >> V_168 -> V_178 -> V_322 ;
V_45 = V_168 -> V_171 ;
V_45 ++ ;
if ( V_33 -> V_85 == 0 || V_146 > 2 * V_145 )
V_45 ++ ;
...
static struct V_167 * F_155 ( struct V_30 * V_289 ,
struct V_274 * V_178 ,
struct V_372 * V_373 )
{
struct V_32 * V_33 ;
...
V_168 = F_151 ( V_119 , V_178 , V_373 ) ;
else
V_168 = F_147 ( V_119 , V_178 , V_373 ) ;
if ( F_44 ( V_168 ) )
V_33 -> V_42 -- ;
...
sizeof( struct V_14 ) ) ;
V_456 -> V_463 = F_137 ( ( unsigned long ) V_33 -> V_200 ,
sizeof( V_456 -> V_464 ) ) ;
...
static int F_163 ( struct V_30 * V_31 ,
void T_9 * V_472 )
{
struct V_167 * V_168 ;
int V_34 ;
...
if ( ! F_159 ( V_466 ) )
return - V_41 ;
if ( F_164 ( & V_474 , V_472 , sizeof( V_474 ) ) )
return - V_475 ;
V_465 = 0 ;
V_168 = F_43 ( V_176 , 1 ,
...
if ( F_165 ( V_472 , & V_474 , sizeof( V_474 ) ) )
V_34 = - V_475 ;
}
if ( V_465 )
F_65 ( & V_467 ) ;
...
return - V_128 ;
V_34 = 0 ;
if ( F_165 ( V_472 , ( long * ) & V_70 ,
sizeof( struct V_482 ) ) )
V_34 = - V_475 ;
return V_34 ;
}
static int
F_168 ( struct V_30 * V_31 , void T_9 * V_472 )
{
struct V_32 * V_33 =
(struct V_32 * ) V_31 -> V_33 ;
struct V_482 V_70 ;
...
if ( ! V_472 )
return - V_128 ;
if ( F_164 ( & V_70 , V_472 , sizeof( struct V_482 ) ) )
return - V_475 ;
V_33 -> V_70 = V_70 ;
F_83 ( & V_31 -> V_2 -> V_82 ,
L_78 ,
...
static int F_169 ( struct V_30 * V_31 , void T_9 * V_472 )
{
struct V_483 V_474 ;
char * V_484 , * V_485 ;
struct V_167 * V_168 ;
...
goto V_492;
V_34 = - V_475 ;
if ( F_165 ( ( void T_9 * ) ( unsigned long ) V_474 . V_485 ,
V_485 , V_474 . V_490 ) )
goto V_492;
V_34 = 0 ;
V_492:
...
static int
F_171 ( struct V_274 * V_178 , unsigned int V_48 , void T_9 * V_472 )
{
...
return F_162 ( V_31 ) ;
case V_499 :
return F_163 ( V_31 , V_472 ) ;
case V_500 :
return F_169 ( V_31 , V_472 ) ;
default:
return - V_501 ;
}
}
static int
F_172 ( struct V_26 * V_502 , struct V_26 * V_503 , char * V_504 )
{
int V_505 , V_42 ;
char * V_506 ;
V_505 = 0 ;
...
static void
F_173 ( struct V_30 * V_31 , struct V_313 * V_313 ,
char * V_508 )
{
T_10 * V_309 ;
T_10 * V_509 ;
V_309 = ( T_10 * ) F_93 ( V_313 ) ;
...
L_89
L_90 ,
V_373 , F_177 ( & V_313 -> V_364 ) , F_178 ( & V_313 -> V_364 ) ,
F_179 ( & V_313 -> V_364 ) , F_180 ( & V_313 -> V_364 ) ,
F_122 ( & V_313 -> V_364 ) , F_181 ( & V_313 -> V_364 ) ,
V_373 ? V_373 -> V_257 : 0 ) ;
V_505 += sprintf ( V_504 + V_505 , V_507
L_91 ,
F_176 ( & V_31 -> V_2 -> V_82 ) ,
...
F_182 ( V_522 L_1 , V_504 ) ;
if ( V_373 ) {
V_511 = V_373 -> V_171 ;
for ( V_512 = V_511 ; V_512 -> V_43 & ( V_250 | V_523 ) ; V_512 ++ ) ;
V_503 = F_137 ( V_511 + 6 , V_512 ) ;
V_505 = sprintf ( V_504 , V_507
L_100 , V_373 ) ;
F_172 ( V_511 , V_503 , V_504 + V_505 ) ;
F_182 ( V_522 L_1 , V_504 ) ;
V_505 = 0 ;
V_502 = ++ V_503 ;
...
V_503 = F_137 ( V_513 + 1 , V_512 ) ;
V_505 += F_172 ( V_502 , V_503 , V_504 + V_505 ) ;
V_502 = F_183 ( V_502 , ++ V_503 ) ;
if ( V_502 < V_512 - 1 ) {
V_502 = V_512 - 1 ;
V_505 += sprintf ( V_504 + V_505 , V_507 L_101 ) ;
}
V_505 += F_172 ( V_502 , V_512 , V_504 + V_505 ) ;
if ( V_505 > 0 )
F_182 ( V_522 L_1 , V_504 ) ;
}
F_184 ( ( unsigned long ) V_504 ) ;
}
...
static void F_187 ( struct V_30 * V_31 ,
struct V_167 * V_373 , struct V_313 * V_313 )
{
if ( F_188 ( & V_313 -> V_364 ) )
F_185 ( V_31 , V_373 , V_313 ) ;
else
F_174 ( V_31 , V_373 , V_313 ) ;
}
...
static int F_191 ( struct V_30 * V_31 )
{
struct V_32 * V_33 ;
int V_34 , V_542 ;
char V_232 [ 60 ] ;
...
static int
F_194 ( struct V_30 * V_31 , int V_547 ,
T_1 V_548 ,
struct V_549 * V_550 ,
struct V_551 V_552 )
{
...
static struct V_218 * F_195 ( struct V_30 * V_31 ,
T_2 V_545 ,
struct V_559 * V_560 )
{
struct V_32 * V_33 ;
...
if ( V_560 -> V_562 == 0 )
goto V_445;
for ( V_561 = 0x80 , V_211 = 0 ; V_561 ; V_561 >>= 1 , V_211 ++ ) {
...
V_445:
return V_33 -> V_208 [ F_53 ( V_545 ) ] ;
}
static int F_196 ( struct V_30 * V_31 , T_2 V_545 ,
struct V_559 * V_560 )
{
struct V_218 * V_563 ;
...
return V_545 ;
V_33 = (struct V_32 * ) V_31 -> V_33 ;
V_563 = F_195 ( V_31 , V_545 , V_560 ) ;
V_211 = 8 - F_197 ( V_560 -> V_568 ) ;
V_566 = ( char * ) & V_563 -> V_570 [ V_211 ] ;
...
V_201 = V_33 -> V_208 [ V_211 ] ;
V_211 = 8 - F_197 ( V_560 -> V_568 ) ;
V_130 = ( char * ) & V_201 -> V_570 [ V_211 ] ;
if ( memcmp ( V_566 , V_130 , sizeof( * V_130 ) ) != 0 )
continue;
V_155 = ( char * ) & V_201 -> V_155 ;
while ( V_564 ) {
V_211 = F_197 ( V_564 ) - 1 ;
if ( memcmp ( & V_565 [ 31 - V_211 ] , & V_155 [ 31 - V_211 ] , 1 )
!= 0 )
break;
F_39 ( V_211 , & V_564 ) ;
}
...
{
unsigned long V_567 ;
V_567 = F_196 ( V_31 , V_545 , V_560 ) ;
if ( ! ( V_31 -> V_215 . V_212 & V_567 ) )
return 0 ;
if ( ! ( V_31 -> V_215 . V_212 & ~ V_567 ) ) {
return - V_128 ;
}
V_31 -> V_215 . V_212 &= ~ V_567 ;
V_31 -> V_215 . V_223 |= V_567 ;
return V_567 ;
}
static int F_203 ( struct V_30 * V_31 , T_2 V_545 ,
struct V_551 V_552 ,
struct V_559 * V_560 )
{
...
int V_567 ;
V_33 = (struct V_32 * ) V_31 -> V_33 ;
F_115 (dev, n, &private->lcu->active_devices,
alias_list) {
F_27 ( F_28 ( V_82 -> V_2 ) , V_43 ) ;
V_567 = F_202 ( V_82 , V_545 , V_560 ) ;
F_29 ( F_28 ( V_82 -> V_2 ) , V_43 ) ;
if ( V_567 < 0 )
goto V_541;
V_571 |= V_567 ;
}
F_115 (dev, n, &private->lcu->inactive_devices,
alias_list) {
F_27 ( F_28 ( V_82 -> V_2 ) , V_43 ) ;
V_567 = F_202 ( V_82 , V_545 , V_560 ) ;
F_29 ( F_28 ( V_82 -> V_2 ) , V_43 ) ;
...
F_115 (pavgroup, tempgroup,
&private->lcu->grouplist, group) {
F_115 (dev, n, &pavgroup->baselist,
alias_list) {
F_27 ( F_28 ( V_82 -> V_2 ) , V_43 ) ;
V_567 = F_202 ( V_82 , V_545 , V_560 ) ;
F_29 (
...
F_115 (dev, n, &pavgroup->aliaslist,
alias_list) {
F_27 ( F_28 ( V_82 -> V_2 ) , V_43 ) ;
V_567 = F_202 ( V_82 , V_545 , V_560 ) ;
F_29 (
...
F_198 ( V_31 , V_571 , V_552 , V_573 ) ;
return 0 ;
V_541:
return V_567 ;
}
static int F_204 ( struct V_30 * V_31 , T_2 V_545 ,
struct V_551 V_552 ,
struct V_559 * V_560 )
{
struct V_575 * V_576 , * V_577 ;
...
alias_list) {
V_567 = F_196 ( V_82 , V_545 , V_560 ) ;
V_571 |= V_567 ;
if ( ! ( V_82 -> V_215 . V_212 & V_567 ) ) {
V_82 -> V_215 . V_236 |= V_567 ;
F_205 ( V_82 ) ;
}
}
F_115 (dev, n,
...
F_198 ( V_31 , V_571 , V_552 , V_574 ) ;
return 0 ;
}
static void F_206 ( struct V_30 * V_31 , void * V_544 ,
T_2 V_545 )
{
...
( ( T_3 * ) V_560 ) [ 3 ] ) ;
F_207 ( V_31 -> V_2 , & V_552 ) ;
V_211 = F_53 ( V_545 ) ;
V_550 = F_199 ( V_31 -> V_2 , V_211 ) ;
if ( V_560 -> V_578 == V_573 ) {
if ( F_203 ( V_31 , V_545 , V_552 , V_560 ) )
V_547 = V_579 ;
else
V_547 = V_580 ;
} else if ( V_560 -> V_578 == V_574 ) {
F_204 ( V_31 , V_545 , V_552 , V_560 ) ;
V_547 = V_580 ;
} else
V_547 = V_581 ;
F_194 ( V_31 , V_547 ,
...
static void F_208 ( struct V_228 * V_229 )
{
struct V_584 * V_29 ;
struct V_543 * V_544 ;
struct V_30 * V_31 ;
int V_34 ;
V_29 = F_60 ( V_229 , struct V_584 , V_233 ) ;
V_31 = V_29 -> V_31 ;
...
V_34 = F_193 ( V_31 , V_544 , V_29 -> V_545 ) ;
if ( V_34 )
goto V_445;
if ( V_544 -> V_106 == V_585 &&
V_544 -> V_120 == V_586 )
F_206 ( V_31 , V_544 , V_29 -> V_545 ) ;
V_445:
F_64 ( V_31 ) ;
F_47 ( V_544 ) ;
F_47 ( V_29 ) ;
}
static int F_209 ( struct V_30 * V_31 , T_2 V_545 )
{
struct V_584 * V_29 ;
V_29 = F_42 ( sizeof( * V_29 ) , V_240 ) ;
if ( ! V_29 )
return - V_197 ;
F_69 ( & V_29 -> V_233 , F_208 ) ;
F_70 ( V_31 ) ;
V_29 -> V_31 = V_31 ;
V_29 -> V_545 = V_545 ;
F_62 ( & V_29 -> V_233 ) ;
