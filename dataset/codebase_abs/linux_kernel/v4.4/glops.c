...
return 0 ;
if ( ! F_48 ( & V_2 -> V_80 ) ) {
V_78 = F_49 ( V_2 -> V_80 . V_81 , struct V_77 , V_82 ) ;
if ( V_78 -> V_82 . V_81 != & V_2 -> V_80 )
return 0 ;
}
return 1 ;
}
static void F_50 ( struct V_83 * V_83 , T_1 V_84 )
{
...
static int F_53 ( struct V_66 * V_67 , const void * V_86 )
{
const struct V_87 * V_88 = V_86 ;
struct V_89 V_90 ;
T_2 V_91 , V_92 ;
if ( F_54 ( V_67 -> V_93 != F_55 ( V_88 -> V_94 . V_95 ) ) )
goto V_96;
V_67 -> V_97 = F_55 ( V_88 -> V_94 . V_98 ) ;
V_67 -> V_69 . V_70 = F_56 ( V_88 -> V_99 ) ;
V_67 -> V_69 . V_100 = 0 ;
switch ( V_67 -> V_69 . V_70 & V_101 ) {
case V_102 :
case V_103 :
V_67 -> V_69 . V_100 = F_57 ( F_56 ( V_88 -> V_104 ) ,
F_56 ( V_88 -> V_105 ) ) ;
break;
} ;
F_58 ( & V_67 -> V_69 , F_56 ( V_88 -> V_106 ) ) ;
F_59 ( & V_67 -> V_69 , F_56 ( V_88 -> V_107 ) ) ;
F_50 ( & V_67 -> V_69 , F_56 ( V_88 -> V_108 ) ) ;
F_60 ( & V_67 -> V_69 , F_55 ( V_88 -> V_109 ) ) ;
F_61 ( & V_67 -> V_69 , F_55 ( V_88 -> V_110 ) ) ;
V_90 . V_111 = F_55 ( V_88 -> V_112 ) ;
V_90 . V_113 = F_56 ( V_88 -> V_114 ) ;
if ( F_62 ( & V_67 -> V_69 . V_115 , & V_90 ) < 0 )
V_67 -> V_69 . V_115 = V_90 ;
V_67 -> V_69 . V_116 . V_111 = F_55 ( V_88 -> V_117 ) ;
V_67 -> V_69 . V_116 . V_113 = F_56 ( V_88 -> V_118 ) ;
V_67 -> V_69 . V_119 . V_111 = F_55 ( V_88 -> V_120 ) ;
V_67 -> V_69 . V_119 . V_113 = F_56 ( V_88 -> V_121 ) ;
V_67 -> V_122 = F_55 ( V_88 -> V_123 ) ;
V_67 -> V_124 = F_55 ( V_88 -> V_125 ) ;
V_67 -> V_126 = F_56 ( V_88 -> V_127 ) ;
V_67 -> V_128 = F_55 ( V_88 -> V_129 ) ;
F_63 ( & V_67 -> V_69 ) ;
V_91 = F_64 ( V_88 -> V_130 ) ;
if ( F_54 ( V_91 > V_131 ) )
goto V_96;
V_67 -> V_132 = ( V_133 ) V_91 ;
V_92 = F_64 ( V_88 -> V_134 ) ;
if ( F_54 ( V_92 > V_135 ) )
goto V_96;
V_67 -> V_136 = ( V_133 ) V_92 ;
V_67 -> V_137 = F_56 ( V_88 -> V_138 ) ;
...
struct V_3 * V_140 ;
int error ;
error = F_68 ( V_67 , & V_140 ) ;
if ( error )
return error ;
error = F_53 ( V_67 , V_140 -> V_141 ) ;
F_69 ( V_140 ) ;
F_40 ( V_74 , & V_67 -> V_72 ) ;
return error ;
}
...
static void F_74 ( struct V_152 * V_153 , const struct V_1 * V_2 )
{
...
struct V_16 * V_17 = V_2 -> V_5 . V_6 ;
if ( V_2 -> V_58 == V_154 &&
F_71 ( V_155 , & V_17 -> V_156 ) ) {
F_79 ( & V_17 -> V_157 , V_158 ) ;
error = F_80 ( V_17 -> V_159 ) ;
if ( error ) {
F_81 ( V_160 L_6 , error ) ;
F_31 ( V_17 , 0 ) ;
}
F_82 ( V_161 , & V_17 -> V_162 ) ;
F_20 ( V_17 , NULL , V_163 ) ;
}
}
static int F_83 ( struct V_1 * V_2 , struct V_77 * V_78 )
{
struct V_16 * V_17 = V_2 -> V_5 . V_6 ;
struct V_66 * V_67 = F_46 ( V_17 -> V_164 -> V_165 ) ;
struct V_1 * V_166 = V_67 -> V_167 ;
struct V_168 V_19 ;
int error ;
if ( F_71 ( V_155 , & V_17 -> V_156 ) ) {
V_166 -> V_169 -> V_170 ( V_166 , V_63 ) ;
error = F_84 ( V_17 -> V_164 , & V_19 ) ;
if ( error )
F_85 ( V_17 ) ;
if ( ! ( V_19 . V_171 & V_172 ) )
F_85 ( V_17 ) ;
if ( ! F_71 ( V_173 , & V_17 -> V_156 ) ) {
V_17 -> V_174 = V_19 . V_175 + 1 ;
F_86 ( V_17 , V_19 . V_176 ) ;
}
}
return 0 ;
}
