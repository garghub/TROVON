...
return F_127 ( V_10 , V_257 , V_258 , V_124 , V_61 ,
V_109 , false ) ;
if ( F_131 ( F_3 ( V_124 -> V_269 ) ) != 0 ) {
V_257 -> V_74 -> V_275 =
V_257 -> V_74 -> V_276 -
...
{
if ( V_38 != 0 )
F_156 ( & V_74 -> V_75 -> V_75 , L_116
L_117 , V_248 ,
V_74 -> V_61 -> V_76 . V_297 , V_38 ) ;
if ( V_334 != V_74 -> V_276 )
F_156 ( & V_74 -> V_75 -> V_75 , L_118
L_119 ,
V_248 ,
...
V_250 = & V_82 -> V_20 -> V_29 ;
V_339 = V_82 -> V_26 ;
V_363 = (struct V_362 * ) V_74 -> V_364 ;
V_30 = 0 ;
V_30 |= V_365 | F_39 ( V_366 ) ;
if ( V_339 == 0 )
V_30 |= 0x1 ;
if ( V_10 -> V_351 >= 0x100 ) {
if ( V_74 -> V_276 > 0 ) {
...
V_363 -> V_367 | V_363 -> V_371 << 8 | F_175 ( V_363 -> V_372 ) << 16 ,
F_175 ( V_363 -> V_373 ) | F_175 ( V_363 -> V_374 ) << 16 ,
F_134 ( 8 ) | F_169 ( 0 ) ,
V_30 ) ;
if ( F_167 ( V_74 ) )
V_30 = V_359 | F_39 ( V_375 ) ;
else
V_30 = F_39 ( V_375 ) ;
V_357 = F_162 ( V_10 , 0 ,
V_74 -> V_276 ,
...
V_257 -> F_4 = V_82 -> V_20 ;
if ( V_74 -> V_276 > 0 && V_363 -> V_367 & V_368 )
V_30 = 0 ;
else
V_30 = V_376 ;
...
0 ,
F_169 ( 0 ) ,
V_30 | V_358 | F_39 ( V_377 ) | V_82 -> V_26 ) ;
...
int V_38 = 0 ;
T_3 V_85 , V_378 ;
V_85 = ( T_3 ) ( V_74 -> V_361 + V_74 -> V_288 [ V_134 ] . V_379 ) ;
V_378 = V_74 -> V_288 [ V_134 ] . V_116 ;
V_38 = F_165 ( V_378 + ( V_85 & ( V_338 - 1 ) ) ,
V_338 ) ;
if ( V_38 == 0 )
V_38 ++ ;
return V_38 ;
...
{
unsigned int V_380 ;
if ( V_10 -> V_351 < 0x100 || V_218 -> V_215 != V_381 )
return 0 ;
V_380 = V_74 -> V_61 -> V_382 . V_383 ;
return F_165 ( V_350 , V_380 + 1 ) - 1 ;
}
...
struct V_74 * V_74 , int V_385 )
{
int V_386 , V_387 , V_47 = 0 ;
int V_388 , V_389 , V_390 ;
if ( V_74 -> V_75 -> V_215 == V_343 ||
V_74 -> V_75 -> V_215 == V_344 )
V_386 = V_74 -> V_386 + V_385 * V_74 -> V_342 ;
else
V_386 = ( V_74 -> V_386 + V_385 * V_74 -> V_342 ) >> 3 ;
V_387 = F_180 ( V_10 -> V_391 ) & 0x7 ;
if ( F_180 ( V_10 -> V_391 ) & ( 1 << 3 ) )
V_387 <<= 3 ;
V_390 = F_17 ( & V_10 -> V_392 -> V_393 ) ;
V_388 = F_181 ( V_390 + V_387 + 1 , 8 ) ;
V_389 = F_182 ( V_390 + 895 * 8 , 8 ) ;
V_386 &= 0x7ff ;
V_388 = ( V_388 >> 3 ) & 0x7ff ;
V_389 = ( V_389 >> 3 ) & 0x7ff ;
F_15 ( V_10 , L_126 ,
V_248 , V_385 , F_17 ( & V_10 -> V_392 -> V_393 ) ,
V_388 , V_389 , V_386 ) ;
if ( V_388 < V_389 ) {
if ( V_386 > V_389 ||
V_386 < V_388 )
...
int V_339 ;
T_2 V_30 , V_356 ;
int V_334 , V_346 , V_378 , V_396 , V_47 ;
T_3 V_397 , V_85 ;
int V_134 , V_135 ;
bool V_27 ;
struct V_60 * V_398 ;
V_398 = & V_10 -> V_62 [ V_56 ] -> V_63 [ V_57 ] ;
...
V_397 = ( T_3 ) V_74 -> V_361 ;
V_250 = & V_82 -> V_20 -> V_29 ;
V_339 = V_82 -> V_26 ;
V_112 = V_74 -> V_113 ;
for ( V_134 = 0 ; V_134 < V_394 ; V_134 ++ ) {
unsigned int V_350 ;
unsigned int V_400 ;
unsigned int V_384 ;
V_105 = true ;
V_334 = 0 ;
V_85 = V_397 + V_74 -> V_288 [ V_134 ] . V_379 ;
V_378 = V_74 -> V_288 [ V_134 ] . V_116 ;
V_396 = V_378 ;
V_350 = F_165 ( V_378 ,
F_163 (
...
if ( V_350 == 0 )
V_350 ++ ;
V_400 = F_177 ( V_10 , V_74 -> V_75 , V_74 ,
V_350 ) ;
V_384 = F_178 ( V_10 ,
V_74 -> V_75 , V_74 , V_350 ) ;
V_395 = F_176 ( V_10 , V_74 , V_134 ) ;
V_47 = F_146 ( V_10 , V_10 -> V_62 [ V_56 ] , V_57 ,
V_74 -> V_58 , V_395 , V_74 , V_134 , V_322 ) ;
if ( V_47 < 0 ) {
if ( V_134 == 0 )
return V_47 ;
goto V_146;
...
if ( F_186 ( V_10 -> V_404 ) )
V_398 -> V_409 = V_74 -> V_386 + V_394 * V_74 -> V_342 ;
if ( F_45 ( V_10 ) -> V_119 . V_120 == 0 ) {
if ( V_10 -> V_35 & V_121 )
F_188 () ;
}
...
if ( F_186 ( V_10 -> V_404 ) && ! F_29 ( & V_82 -> V_69 ) ) {
if ( ( F_3 ( V_95 -> V_151 ) & V_152 ) ==
V_329 ) {
V_74 -> V_386 = V_398 -> V_409 ;
goto V_410;
}
}
V_386 = F_17 ( & V_10 -> V_392 -> V_393 ) ;
V_386 &= 0x3fff ;
V_387 = F_180 ( V_10 -> V_391 ) & 0x7 ;
if ( F_180 ( V_10 -> V_391 ) & ( 1 << 3 ) )
V_387 <<= 3 ;
...
if ( V_74 -> V_75 -> V_215 == V_343 ||
V_74 -> V_75 -> V_215 == V_344 ) {
V_386 = F_181 ( V_386 , V_74 -> V_342 << 3 ) ;
V_74 -> V_386 = V_386 >> 3 ;
} else {
V_386 = F_181 ( V_386 , V_74 -> V_342 ) ;
V_74 -> V_386 = V_386 ;
}
V_410:
...
T_1 V_415 , T_2 V_56 , enum V_416 V_363 )
{
return F_190 ( V_10 , V_174 , F_170 ( V_415 ) ,
F_171 ( V_415 ) , 0 ,
F_39 ( V_201 ) | F_193 ( V_56 )
| ( V_363 == V_417 ? V_418 : 0 ) , false ) ;
}
