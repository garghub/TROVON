...
if ( ! V_245 )
return - V_247 ;
V_97 = (struct V_200 * ) V_245 -> V_248 ;
} else {
const struct V_249 * V_250 = F_107 ( V_238 ) ;
V_97 = (struct V_200 * ) V_250 -> V_251 ;
V_105 = V_252 ;
}
V_253 . V_254 = ( 0xf << V_11 ) |
( V_97 -> V_98 - 1 ) ;
V_10 = F_108 ( V_238 , & V_253 ) ;
...
static int F_110 ( struct V_255 * V_256 ,
...
if ( V_256 -> V_8 . V_243 ) {
const struct V_244 * V_245 =
F_106 ( V_246 , & V_256 -> V_8 ) ;
if ( ! V_245 )
return - V_247 ;
V_97 = (struct V_200 * ) V_245 -> V_248 ;
} else {
V_97 = (struct V_200 * ) V_258 -> V_251 ;
V_105 = V_252 ;
}
V_253 . V_254 = ( 0xf << V_11 ) |
( V_97 -> V_98 - 1 ) ;
V_10 = F_111 ( V_256 , & V_253 ) ;
return F_80 ( & V_256 -> V_8 , V_97 , V_10 , V_256 -> V_99 , V_105 ) ;
}
static int F_112 ( struct V_255 * V_259 )
{
return F_103 ( & V_259 -> V_8 ) ;
}
