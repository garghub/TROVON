...
static int F_60 ( struct V_78 * V_79 , unsigned long V_80 , void * V_81 )
{
struct V_82 * V_83 ;
struct V_17 * V_17 ;
struct V_7 * V_8 ;
...
int V_27 ;
V_83 = V_81 ;
V_47 = V_83 -> V_47 & 0x1ff ;
V_51 = ( V_83 -> V_47 >> 9 ) & 1 ;
V_27 = V_84 ;
V_8 = F_4 ( V_83 -> F_1 ) ;
if ( V_8 == NULL )
goto V_76;
V_17 = F_22 ( V_8 , V_83 -> V_18 ) ;
if ( V_17 == NULL || V_17 -> V_32 ) {
F_51 ( V_8 -> V_2 , V_83 -> V_18 ,
V_56 , V_47 ) ;
goto V_85;
}
F_5 ( & V_17 -> V_28 , V_9 ) ;
...
int F_75 ( struct V_1 * V_2 , int V_98 )
{
struct V_7 * V_8 ;
struct V_12 * V_13 ;
unsigned long V_9 ;
...
if ( ! F_65 () )
return - V_89 ;
if ( V_98 <= 0 || V_98 > ( V_100 + 1 ) )
return - V_90 ;
V_3 = F_1 ( V_2 ) ;
V_8 = F_61 ( sizeof( * V_8 ) , V_91 ) ;
if ( V_8 == NULL )
return - V_29 ;
F_68 ( & V_8 -> V_28 ) ;
F_67 ( & V_8 -> V_16 ) ;
...
V_8 -> V_3 = V_3 ;
V_99 = V_98 ;
for ( V_8 -> V_24 = 0 ; ( V_99 - 1 ) & ~ 0x1ff ; V_99 >>= 9 )
V_8 -> V_24 += 1 ;
F_66 ( & V_8 -> V_11 , 1 ) ;
V_8 -> V_36 = V_98 ;
V_27 = - V_29 ;
V_8 -> V_25 = ( void * ) F_19 ( V_91 ) ;
if ( V_8 -> V_25 == NULL )
goto V_101;
V_8 -> V_15 = F_76 ( & V_102 ) ;
if ( V_8 -> V_15 == NULL )
