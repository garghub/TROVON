...
V_61 -> V_200 . type = V_246 ;
V_17 = F_110 ( & V_61 -> V_200 , V_168 ,
V_31 -> V_244 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
F_111 ( V_193 , V_13 , & V_247 ) ;
strcpy ( V_193 -> V_178 , L_49 ) ;
V_193 -> V_241 = & V_248 ;
V_193 -> V_25 |= V_243 ;
V_31 -> V_249 [ V_131 ] . V_25 = V_250 ;
V_31 -> V_249 [ V_134 ] . V_25 = V_250 ;
V_31 -> V_249 [ V_135 ] . V_25 = V_245 ;
V_193 -> V_200 . type = V_246 ;
V_17 = F_110 ( & V_193 -> V_200 , V_251 ,
V_31 -> V_249 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
V_17 = F_89 ( V_31 ) ;
...
goto V_252;
for ( V_100 = 0 ; V_100 < V_188 ; V_100 ++ )
V_31 -> V_189 [ V_100 ] . V_198 = V_253 [ V_100 ] ;
