...
static void F_35 ( struct V_10 * V_53 , struct V_10 * V_54 )
{
struct V_10 * V_55 ;
...
V_57 = F_36 ( V_56 -> V_60 . V_61 -> V_20 ) ;
F_37 (pos, head) {
V_29 = F_5 ( V_55 , struct V_3 , V_34 ) ;
V_58 = F_36 ( V_29 -> V_60 . V_61 -> V_20 ) ;
if ( F_13 ( V_57 , V_58 ) ) {
F_2 ( V_54 , V_55 -> V_62 ) ;
V_59 = 1 ;
break;
...
F_38 ( V_2 , V_15 , V_63 ) ;
if ( V_63 == V_80 )
F_45 ( V_2 , V_2 -> V_24 -> V_94 ) ;
if ( V_63 != V_70 )
error = F_34 ( V_2 , 1 ) ;
if ( error )
V_2 -> V_24 -> V_36 . V_37 -> V_95 = - error ;
}
static int F_46 ( struct V_1 * V_2 , struct V_96 * V_97 ,
int V_98 , int * V_99 )
{
struct V_10 * V_100 ;
...
static int F_34 ( struct V_1 * V_2 , int V_98 )
{
struct V_96 * V_113 ;
struct V_96 V_114 ;
...
V_38 , V_2 , V_31 , V_31 && V_31 -> V_39 ?
F_29 ( F_30 ( V_31 -> V_39 -> type ) ) :
L_2 , F_36 ( V_31 -> V_60 . V_61 -> V_20 ) ,
V_31 -> V_8 ? V_31 -> V_8 -> V_53 : NULL , V_31 -> V_8 ?
F_59 ( & V_31 -> V_8 -> V_164 ) : - 1 ) ;
V_101 = F_56 ( V_113 , V_31 , 0 ) ;
switch ( V_101 ) {
case V_105 :
case V_108 :
case V_109 :
F_28 ( L_8 ,
V_38 , F_36 ( V_31 -> V_60 . V_61 -> V_20 ) ,
V_101 ) ;
F_1 ( V_2 , V_31 ) ;
goto V_156;
case V_154 :
...
static void F_62 ( struct V_23 * V_169 ,
struct V_170 * V_171 )
{
T_6 * V_172 ;
T_5 V_85 ;
...
V_172 = V_171 -> V_174 ;
for ( V_120 = 0 ; V_120 < F_63 ( V_171 -> V_175 ) ; V_120 ++ ) {
V_85 -= ( ( F_63 ( V_172 [ V_120 ] . V_176 . V_177 ) -
F_63 ( V_172 [ V_120 ] . V_176 . V_178 ) + 1 ) ) ;
}
V_169 -> V_85 = V_85 ;
}
int F_64 ( struct V_1 * V_2 , struct V_3 * V_31 )
{
struct V_23 * V_24 = V_2 -> V_24 ;
...
V_181 = F_36 ( V_171 -> V_191 ) ;
V_188 = F_63 ( V_171 -> V_175 ) ;
V_24 -> V_111 . V_192 += V_188 ;
if ( V_14 -> V_17 . V_22 ) {
T_7 V_193 = 0 ;
if ( F_65 ( V_14 -> V_17 . V_21 , V_181 ) ) {
V_14 -> V_17 . V_22 = 0 ;
V_193 = 1 ;
}
if ( V_193 || V_188 ) {
...
V_183 = V_181 ;
if ( V_188 )
V_183 += F_63 ( V_172 [ V_188 - 1 ] . V_176 . V_177 ) ;
if ( F_13 ( V_24 -> V_194 , V_183 ) )
V_24 -> V_194 = V_183 ;
V_184 = V_181 ;
F_66 ( V_2 , & V_2 -> V_26 , NULL , NULL , V_171 , & V_184 ) ;
...
V_34 ) ;
V_20 = F_36 ( V_180 -> V_60 . V_61 -> V_20 ) ;
if ( F_65 ( V_20 , V_182 ) ) {
F_6 ( & V_180 -> V_34 ) ;
F_21 ( V_180 ) ;
}
}
V_185 = F_36 ( V_171 -> V_197 ) ;
V_24 -> V_68 . V_198 = ! V_185 ;
V_186 = V_2 -> V_67 ;
if ( V_186 < V_185 )
V_185 -= V_186 ;
else
...
static int F_69 ( struct V_170 * V_171 , T_1 V_20 )
{
int V_120 ;
T_6 * V_172 ;
T_5 V_223 ;
T_1 V_182 = F_36 ( V_171 -> V_191 ) ;
if ( F_65 ( V_20 , V_182 ) )
goto V_224;
V_172 = V_171 -> V_174 ;
V_223 = V_20 - V_182 ;
for ( V_120 = 0 ; V_120 < F_63 ( V_171 -> V_175 ) ; ++ V_120 ) {
if ( F_65 ( F_63 ( V_172 [ V_120 ] . V_176 . V_178 ) , V_223 ) &&
F_65 ( V_223 , F_63 ( V_172 [ V_120 ] . V_176 . V_177 ) ) )
goto V_224;
}
return 0 ;
V_224:
...
static inline int F_80 ( struct V_225 * V_226 ,
int V_227 , T_8 V_228 )
{
int V_120 ;
...
static void F_45 ( struct V_1 * V_2 , T_1 V_182 )
{
struct V_23 * V_24 = V_2 -> V_24 ;
...
V_231 = F_80 ( & V_230 [ 0 ] ,
V_227 ,
V_31 -> V_60 . V_61 -> V_228 ) ;
V_230 [ V_231 ] . V_228 =
V_31 -> V_60 . V_61 -> V_228 ;
V_230 [ V_231 ] . V_233 =
V_31 -> V_60 . V_61 -> V_233 ;
if ( V_231 == V_227 )
V_227 ++ ;
if ( V_227 == 10 )
break;
...
if ( V_24 -> V_199 > V_182 )
V_229 = F_81 ( V_24 , V_24 -> V_199 ,
V_227 , & V_230 [ 0 ] ) ;
if ( V_229 ) {
F_8 ( & V_229 -> V_5 , & V_2 -> V_25 ) ;
F_33 ( F_27 ( V_24 -> V_36 . V_37 ) , V_51 ) ;
}
}
