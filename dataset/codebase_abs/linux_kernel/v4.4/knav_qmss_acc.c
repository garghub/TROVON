...
T_1 V_63 ;
F_3 ( V_6 -> V_17 , L_22 ,
V_74 -> V_75 , V_74 -> V_76 , V_74 -> V_77 ,
V_74 -> V_78 , V_74 -> V_79 ) ;
F_10 ( V_74 -> V_79 , & V_24 -> V_80 -> V_79 ) ;
F_10 ( V_74 -> V_78 , & V_24 -> V_80 -> V_78 ) ;
F_10 ( V_74 -> V_77 , & V_24 -> V_80 -> V_77 ) ;
F_10 ( V_74 -> V_76 , & V_24 -> V_80 -> V_76 ) ;
F_10 ( V_74 -> V_75 , & V_24 -> V_80 -> V_75 ) ;
do {
V_63 = F_14 ( & V_24 -> V_80 -> V_75 ) ;
} while ( ( V_63 >> 8 ) & 0xff );
return ( V_63 >> 24 ) & 0xff ;
}
...
V_74 -> V_75 = V_4 -> V_18 ;
V_74 -> V_76 = V_76 ;
V_74 -> V_77 = V_4 -> V_40 [ 0 ] ;
V_74 -> V_78 = V_34 -> V_81 << 16 ;
V_74 -> V_78 |= V_12 ;
V_74 -> V_79 = V_82 << 18 ;
if ( V_2 -> V_13 & V_14 )
V_74 -> V_79 |= V_83 ;
V_74 -> V_79 |= V_34 -> V_84 << 16 ;
V_74 -> V_79 |= V_34 -> V_85 ;
}
...
struct V_7 * V_21 )
{
unsigned V_89 = V_21 -> V_89 - V_2 -> V_12 ;
V_21 -> V_55 = F_35 ( V_2 -> V_6 -> V_17 ,
V_52 * sizeof( T_1 ) , V_90 ) ;
if ( ! V_21 -> V_55 )
return - V_91 ;
V_21 -> V_4 = V_2 -> V_4 ;
if ( ( V_2 -> V_13 & V_14 ) == 0 )
...
{
unsigned V_89 = V_8 -> V_89 - V_2 -> V_12 ;
return F_20 ( V_2 , V_89 , true ) ;
}
static int F_37 ( struct V_1 * V_2 ,
struct V_7 * V_8 )
{
unsigned V_89 = V_8 -> V_89 - V_2 -> V_12 ;
return F_20 ( V_2 , V_89 , false ) ;
}
...
V_93 = F_46 ( V_47 * 2 ) ;
V_34 -> V_93 = V_93 ;
V_2 -> V_4 = F_35 ( V_6 -> V_17 , V_92 * sizeof( * V_2 -> V_4 ) ,
V_90 ) ;
if ( ! V_2 -> V_4 )
return - V_91 ;
for ( V_18 = 0 ; V_18 < V_92 ; V_18 ++ ) {
...
V_97 = F_47 ( V_93 , V_90 | V_106 ) ;
if ( ! V_97 )
return - V_91 ;
V_40 = F_48 ( V_6 -> V_17 , V_97 , V_93 ,
V_94 ) ;
...
memset ( V_97 , 0 , V_93 ) ;
F_19 ( V_6 -> V_17 , V_40 , V_93 ,
V_56 ) ;
F_50 ( V_4 -> V_29 , sizeof( V_4 -> V_29 ) , L_33 ,
V_4 -> V_18 ) ;
V_4 -> V_36 [ 0 ] = V_97 ;
V_4 -> V_36 [ 1 ] = V_97 + V_47 ;
V_4 -> V_40 [ 0 ] = V_40 ;
V_4 -> V_40 [ 1 ] = V_40 + V_47 ;
F_3 ( V_6 -> V_17 , L_34 ,
V_4 -> V_29 , V_4 -> V_18 , V_40 , V_97 ) ;
}
V_2 -> V_107 = & V_108 ;
return 0 ;
}
