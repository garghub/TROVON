...
static T_3 F_46 ( struct V_116 * V_117 ,
...
V_2 -> V_8 -> V_2 . V_128 = & V_2 -> V_36 -> V_2 ;
if ( V_2 -> V_122 )
V_2 -> V_10 -> V_129 |= V_130 ;
F_41 ( V_2 ) ;
if ( F_51 ( V_2 -> V_8 , V_2 -> V_121 ) )
goto V_131;
if ( F_52 ( & V_2 -> V_8 -> V_2 , & V_132 ) ) {
F_14 ( L_19 ) ;
goto V_133;
}
V_2 -> V_127 = 1 ;
...
{
struct V_1 * V_2 =
F_47 ( V_135 , struct V_1 , V_136 . V_135 ) ;
F_44 ( V_2 ) ;
F_45 ( V_2 ) ;
V_2 -> V_51 = 0 ;
...
static T_4 F_59 ( int V_140 , void * V_120 )
{
...
V_141 = F_1 ( V_2 , V_139 ) ;
F_3 ( V_2 , V_139 , V_141 ) ;
if ( V_141 & ( V_114 | V_113 ) ) {
V_143 = V_145 ;
V_2 -> V_109 = ! ! ( V_141 & V_114 ) ;
F_17 ( V_2 -> V_51 ) ;
F_58 ( V_2 ) ;
if ( V_2 -> V_51 )
goto V_146;
...
static int F_63 ( struct V_36 * V_36 , const struct V_150 * V_151 )
{
int error ;
struct V_9 * V_10 ;
struct V_1 * V_2 ;
...
V_10 -> V_102 = F_31 ;
V_10 -> V_157 = F_30 ;
V_10 -> V_158 . V_80 = V_159 ;
V_10 -> V_158 . V_160 = V_37 ;
V_10 -> V_158 . V_161 = V_162 ;
V_10 -> V_158 . V_163 = 2 ;
V_10 -> V_158 . V_164 = F_37 ;
V_10 -> V_158 . V_165 = F_38 ;
V_10 -> V_158 . V_166 = F_39 ;
V_10 -> V_158 . V_167 = F_40 ;
...
goto V_171;
error = - V_153 ;
V_2 -> V_172 = F_50 ( V_173 , V_125 ) ;
if ( ! V_2 -> V_172 )
goto V_174;
F_72 ( & V_2 -> V_41 ) ;
V_2 -> V_147 = F_73 ( V_152 ) ;
if ( ! V_2 -> V_147 )
goto V_175;
F_74 ( & V_2 -> V_136 , F_57 ) ;
F_43 ( V_2 ) ;
F_58 ( V_2 ) ;
F_13 ( V_2 ) ;
V_2 -> V_140 = V_36 -> V_140 ;
F_75 ( & V_2 -> V_49 ) ;
V_2 -> V_109 = 0 ;
F_44 ( V_2 ) ;
error = - V_170 ;
if ( F_76 ( V_36 -> V_140 , & F_59 , V_176 ,
V_152 , V_2 ) )
goto V_177;
F_60 ( V_2 -> V_147 ,
& V_2 -> V_136 , 0 ) ;
...
if ( V_2 -> V_127 ) {
F_41 ( V_2 ) ;
V_2 -> V_10 -> V_179 ( V_2 -> V_8 , 0 ) ;
V_2 -> V_10 -> V_74 ( V_2 -> V_8 , V_180 , - 1 , - 1 ) ;
V_2 -> V_10 -> V_179 ( V_2 -> V_8 , - 1 ) ;
}
F_45 ( V_2 ) ;
return 0 ;
}
