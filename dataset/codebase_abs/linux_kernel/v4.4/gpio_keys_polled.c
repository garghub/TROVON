...
static struct V_24 * F_13 ( struct V_33 * V_2 )
{
struct V_24 * V_25 ;
struct V_3 * V_4 ;
struct V_34 * V_35 ;
...
if ( V_27 == 0 )
return NULL ;
V_25 = F_15 ( V_2 , sizeof( * V_25 ) + V_27 * sizeof( * V_4 ) ,
V_36 ) ;
if ( ! V_25 )
return F_16 ( - V_37 ) ;
V_25 -> V_30 = (struct V_3 * ) ( V_25 + 1 ) ;
V_25 -> V_38 = F_17 ( V_2 , L_1 ) ;
F_18 ( V_2 , L_2 , & V_25 -> V_39 ) ;
F_19 (dev, child) {
struct V_40 * V_41 ;
V_41 = F_20 ( V_2 , NULL , V_35 ) ;
if ( F_21 ( V_41 ) ) {
error = F_22 ( V_41 ) ;
if ( error != - V_42 )
F_23 ( V_2 ,
...
V_4 = & V_25 -> V_30 [ V_25 -> V_27 ++ ] ;
V_4 -> V_21 = V_41 ;
if ( F_25 ( V_35 , L_4 , & V_4 -> V_13 ) ) {
F_23 ( V_2 , L_5 ,
V_25 -> V_27 - 1 ) ;
F_24 ( V_35 ) ;
return F_16 ( - V_43 ) ;
}
F_26 ( V_35 , L_6 , & V_4 -> V_41 ) ;
if ( F_25 ( V_35 , L_7 ,
& V_4 -> type ) )
V_4 -> type = V_11 ;
if ( F_25 ( V_35 , L_8 ,
...
{
int V_26 , V_47 = 0 , V_48 = 0 ;
for ( V_26 = 0 ; V_26 < V_25 -> V_27 ; V_26 ++ ) {
struct V_3 * V_4 = & V_25 -> V_30 [ V_26 ] ;
...
F_29 ( V_10 , V_13 , V_47 , V_48 , 0 , 0 ) ;
}
static int F_30 ( struct V_49 * V_50 )
{
struct V_33 * V_2 = & V_50 -> V_2 ;
const struct V_24 * V_25 = F_31 ( V_2 ) ;
struct V_6 * V_7 ;
struct V_1 * V_51 ;
struct V_9 * V_10 ;
T_1 V_52 ;
...
V_10 -> V_57 = V_58 L_16 ;
V_10 -> V_59 . V_60 = V_61 ;
V_10 -> V_59 . V_62 = 0x0001 ;
V_10 -> V_59 . V_63 = 0x0001 ;
V_10 -> V_59 . V_64 = 0x0100 ;
F_3 ( V_11 , V_10 -> V_65 ) ;
if ( V_25 -> V_38 )
F_3 ( V_66 , V_10 -> V_65 ) ;
for ( V_26 = 0 ; V_26 < V_25 -> V_27 ; V_26 ++ ) {
...
if ( ! V_4 -> V_21 && F_33 ( V_4 -> V_67 ) ) {
unsigned V_68 = V_69 ;
if ( V_4 -> V_70 )
V_68 |= V_71 ;
error = F_34 ( & V_50 -> V_2 , V_4 -> V_67 ,
V_68 , V_4 -> V_41 ? : V_58 ) ;
if ( error ) {
F_23 ( V_2 , L_18 ,
V_4 -> V_67 , error ) ;
...
V_4 -> V_21 = F_35 ( V_4 -> V_67 ) ;
}
if ( F_21 ( V_4 -> V_21 ) )
return F_22 ( V_4 -> V_21 ) ;
V_19 -> V_20 = F_36 ( V_4 -> V_21 ) ;
V_19 -> V_22 = - 1 ;
V_19 -> V_29 = F_37 ( V_4 -> V_46 ,
V_25 -> V_39 ) ;
F_38 ( V_10 , type , V_4 -> V_13 ) ;
if ( type == V_16 )
F_28 ( V_10 , V_25 ,
V_4 -> V_13 ) ;
}
