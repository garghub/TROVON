...
static int
F_97 ( struct V_137 * V_138 , struct V_84 * V_85 ,
...
static int
F_98 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_2 * V_2 = F_99 ( V_138 ) ;
struct V_1 * V_92 = F_1 ( V_2 ) ;
...
return - V_149 ;
F_100 ( & V_53 -> V_104 ) ;
F_101 ( V_53 -> V_6 , V_6 , V_150 ) ;
V_53 -> V_7 = V_7 ;
V_53 -> V_8 = V_8 ;
V_22 = F_102 ( V_143 , V_7 , V_8 , & V_53 -> type ) ;
if ( V_22 )
goto V_151;
if ( V_139 [ V_148 ] &&
...
goto V_156;
V_26 = F_103 ( V_113 , sizeof( struct V_52 * ) , V_31 ) ;
if ( ! V_26 )
goto V_156;
V_157 = F_104 ( V_92 -> V_93 ) ;
memcpy ( V_26 , V_157 , sizeof( struct V_52 * ) * V_92 -> V_116 ) ;
F_105 ( V_92 -> V_93 , V_26 ) ;
F_106 () ;
V_91 = V_92 -> V_116 ;
V_92 -> V_116 = V_113 ;
F_107 ( V_157 ) ;
...
static int
F_110 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
struct V_52 * V_115 ;
T_6 V_113 ;
int V_22 = 0 ;
if ( F_34 ( F_88 ( V_139 ) ) )
...
static int
F_114 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
...
static int
F_115 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
...
static int
F_116 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
...
static inline void
F_119 ( struct V_119 * V_120 )
{
const struct V_33 * V_139 ;
int V_179 ;
F_11 ( L_20 ) ;
F_120 (attr, nlh, sizeof(struct nfgenmsg), rem) {
F_11 ( L_21 , V_35 ( V_139 ) , V_139 -> V_180 ) ;
}
}
static int
F_121 ( struct V_173 * V_174 , struct V_1 * V_92 )
{
struct V_119 * V_120 = F_122 ( V_174 -> V_85 ) ;
int V_181 = F_123 ( sizeof( struct V_128 ) ) ;
...
static int
F_125 ( struct V_84 * V_85 , struct V_173 * V_174 )
{
T_6 V_91 = V_114 , V_21 ;
struct V_52 * V_53 = NULL ;
struct V_119 * V_120 = NULL ;
unsigned int V_48 = F_126 ( V_174 -> V_85 ) . V_124 ? V_192 : 0 ;
struct V_1 * V_92 = F_1 ( F_99 ( V_85 -> V_193 ) ) ;
T_4 V_184 , V_194 ;
bool V_161 ;
int V_22 = 0 ;
if ( ! V_174 -> args [ V_191 ] ) {
V_22 = F_121 ( V_174 , V_92 ) ;
if ( V_22 < 0 ) {
V_120 = F_122 ( V_174 -> V_85 ) ;
...
F_70 ( & V_89 ) ;
V_120 = F_91 ( V_85 , F_126 ( V_174 -> V_85 ) . V_124 ,
...
static int
F_133 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
if ( F_34 ( F_88 ( V_139 ) ) )
...
return 0 ;
if ( V_214 && V_213 ) {
struct V_119 * V_220 , * V_120 = F_122 ( V_85 ) ;
struct V_84 * V_221 ;
struct V_222 * V_223 ;
...
if ( ! V_221 )
return - V_149 ;
V_220 = F_137 ( V_221 , F_126 ( V_85 ) . V_124 ,
...
* V_227 = V_214 ;
F_138 ( V_138 , V_221 , F_126 ( V_85 ) . V_124 ,
V_232 ) ;
return - V_233 ;
}
return V_22 ;
...
static int
F_139 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
...
static int
F_141 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
...
static int
F_142 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
...
static int
F_143 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_1 * V_92 = F_1 ( F_99 ( V_138 ) ) ;
...
if ( ! V_221 )
return - V_149 ;
V_238 = F_91 ( V_221 , F_126 ( V_85 ) . V_124 , V_120 -> V_198 , 0 ,
V_240 ) ;
if ( ! V_238 )
goto V_241;
...
goto V_201;
F_132 ( V_221 , V_238 ) ;
V_22 = F_138 ( V_138 , V_221 , F_126 ( V_85 ) . V_124 , V_232 ) ;
if ( V_22 < 0 )
return V_22 ;
return 0 ;
V_201:
...
static int
V_5 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_84 * V_221 ;
...
static int
F_147 ( struct V_137 * V_138 , struct V_84 * V_85 ,
const struct V_119 * V_120 ,
const struct V_33 * const V_139 [] )
{
struct V_84 * V_221 ;
...
if ( V_92 -> V_116 >= V_114 )
V_92 -> V_116 = V_114 - 1 ;
V_26 = F_103 ( V_92 -> V_116 , sizeof( struct V_52 * ) , V_31 ) ;
if ( ! V_26 )
return - V_149 ;
V_92 -> V_117 = false ;
V_92 -> V_161 = false ;
