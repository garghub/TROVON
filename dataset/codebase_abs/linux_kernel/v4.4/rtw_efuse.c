...
void F_16 ( struct V_1 * V_24 , T_2 V_51 , T_1 V_57 )
{
T_1 V_53 = { 0x00 } ;
T_1 V_54 = { 0x00 } ;
T_3 V_55 = 0 ;
...
int F_17 ( struct V_1 * V_19 , T_2 V_58 , T_1 * V_52 )
{
T_1 V_59 = 0 ;
int V_60 ;
...
int F_18 ( struct V_1 * V_19 , T_2 V_58 , T_1 V_52 )
{
T_1 V_59 = 0 ;
int V_60 ;
F_2 ( V_19 , V_30 + 1 , ( T_1 ) ( V_58 & 0xff ) ) ;
...
void F_19 ( T_1 V_23 , T_1 * V_63 , T_1 * V_64 )
{
if ( ! ( V_23 & F_20 ( 0 ) ) ) {
V_64 [ 0 ] = V_63 [ 0 ] ;
V_64 [ 1 ] = V_63 [ 1 ] ;
...
void F_29 ( struct V_1 * V_19 , T_1 V_20 , T_1 * V_76 )
{
T_2 V_74 = 0 ;
F_1 ( V_19 , false , true ) ;
F_14 ( V_19 , V_20 , V_46 ,
...
static void F_30 ( struct V_1 * V_19 , T_2 V_77 ,
T_1 * V_57 )
{
struct V_78 * V_79 = F_31 ( V_19 ) ;
* V_57 = V_79 -> V_80 [ V_77 ] ;
}
static void F_32 ( struct V_1 * V_19 , T_2 V_77 ,
T_2 * V_57 )
{
struct V_78 * V_79 = F_31 ( V_19 ) ;
* V_57 = V_79 -> V_80 [ V_77 ] ;
...
static void F_33 ( struct V_1 * V_19 , T_2 V_77 ,
T_3 * V_57 )
{
struct V_78 * V_79 = F_31 ( V_19 ) ;
* V_57 = V_79 -> V_80 [ V_77 ] ;
...
void F_35 ( struct V_1 * V_19 , T_1 Type ,
T_2 V_77 , T_3 * V_57 )
{
if ( Type == 1 )
