...
V_2 -> V_37 = 0 ;
V_2 -> V_80 = 0 ;
F_39 ( V_2 , V_2 -> V_30 -> V_103 ,
V_2 -> V_92 ) ;
V_101 = V_2 -> V_32 ;
V_101 |= 1 << 18 ;
F_39 ( V_2 , V_2 -> V_30 -> V_81 , V_101 ) ;
F_39 ( V_2 , V_2 -> V_30 -> V_57 ,
V_2 -> V_77 ) ;
F_39 ( V_2 , V_2 -> V_30 -> V_104 ,
V_2 -> V_97 ) ;
V_100 = V_2 -> V_105 + V_2 -> V_106 ;
V_99 = V_2 -> V_107 + V_2 -> V_108 ;
F_50 ( V_2 , V_99 , V_100 - V_99 , 0 ) ;
for (; V_99 < V_100 ; ++ V_99 ) {
unsigned V_109 = V_99 / 64 ;
unsigned V_110 = V_99 & 63 ;
F_51 ( V_109 >= 3 ) ;
V_102 [ V_109 ] |= 1ULL << V_110 ;
}
...
F_27 ( & V_2 -> V_46 , V_35 ) ;
V_2 -> V_86 = 0 ;
F_39 ( V_2 , V_2 -> V_30 -> V_103 , 0 ) ;
F_39 ( V_2 , V_2 -> V_30 -> V_81 , 0 ) ;
F_39 ( V_2 , V_2 -> V_30 -> V_57 , 0 ) ;
F_39 ( V_2 , V_2 -> V_30 -> V_104 , 0 ) ;
...
T_2 * V_123 , T_2 V_15 , T_2 V_124 , T_2 V_125 )
{
F_58 ( V_15 & 3 ) ;
V_123 [ 1 ] = V_15 >> 32 ;
V_123 [ 0 ] = ( V_15 & 0xfffffffcULL ) << 32 ;
V_123 [ 0 ] |= ( V_2 -> V_79 & 3ULL ) << 30 ;
V_123 [ 0 ] |= ( V_124 & 0x7ffULL ) << 16 ;
V_123 [ 0 ] |= V_125 & 0x7ffULL ;
}
int F_59 ( struct V_1 * V_2 ,
struct V_126 * V_127 , T_6 V_128 ,
struct V_129 * V_130 )
{
unsigned long V_35 ;
struct V_131 * V_132 ;
...
T_6 V_125 ;
T_3 V_15 ;
if ( ( V_130 -> V_134 + ( V_128 << 2 ) ) > V_2 -> V_135 ) {
F_10 ( L_20 ,
V_130 -> V_134 + ( V_128 << 2 ) , V_2 -> V_135 ) ;
V_90 = - V_136 ;
goto V_137;
}
F_27 ( & V_2 -> V_46 , V_35 ) ;
V_138:
if ( F_60 ( F_32 ( V_117 , & V_2 -> V_49 ) ) ) {
V_90 = - V_139 ;
goto V_61;
}
if ( V_130 -> V_140 . V_141 > F_61 ( V_2 ) ) {
if ( F_16 ( V_2 ) )
goto V_138;
V_90 = - V_142 ;
goto V_61;
}
V_15 = F_62 ( & V_2 -> V_17 -> V_18 , V_130 -> V_140 . V_143 ,
V_130 -> V_134 , V_19 ) ;
if ( F_63 ( & V_2 -> V_17 -> V_18 , V_15 ) )
goto V_144;
V_125 = V_130 -> V_134 >> 2 ;
F_57 ( V_2 , V_123 , ( T_2 ) V_15 , V_125 , 0 ) ;
V_123 [ 0 ] |= 1ULL << 12 ;
if ( V_130 -> V_140 . V_35 & V_145 )
V_123 [ 0 ] |= 1ULL << 14 ;
V_133 = V_2 -> V_77 ;
V_11 = & V_2 -> V_12 [ V_133 ] . V_13 [ 0 ] ;
* V_11 ++ = F_64 ( V_123 [ 0 ] ) ;
* V_11 ++ = F_64 ( V_123 [ 1 ] ) ;
if ( V_130 -> V_140 . V_35 & V_36 )
V_130 -> V_140 . V_25 = V_133 ;
if ( ++ V_133 == V_2 -> V_32 ) {
V_133 = 0 ;
...
F_51 ( V_16 == 0 ) ;
V_146 = ( V_16 + 3 ) >> 2 ;
V_15 = F_62 ( & V_2 -> V_17 -> V_18 , V_132 -> V_149 , V_146 << 2 ,
V_19 ) ;
if ( F_63 ( & V_2 -> V_17 -> V_18 , V_15 ) )
goto V_150;
F_57 ( V_2 , V_123 , ( T_2 ) V_15 , V_146 , V_125 ) ;
if ( V_130 -> V_140 . V_35 & V_145 )
V_123 [ 0 ] |= 1ULL << 14 ;
* V_11 ++ = F_64 ( V_123 [ 0 ] ) ;
* V_11 ++ = F_64 ( V_123 [ 1 ] ) ;
...
if ( -- V_127 -> V_151 )
* V_132 = * V_127 -> V_152 ++ ;
} else if ( V_132 -> V_147 == 0 && V_132 -> V_153 != NULL ) {
if ( ++ V_132 -> V_100 >= V_154 ) {
if ( ++ V_132 -> V_155 >= V_132 -> V_153 -> V_156 )
break;
V_132 -> V_100 = 0 ;
}
V_132 -> V_149 =
V_132 -> V_153 -> V_157 [ V_132 -> V_155 ] -> V_158 [ V_132 -> V_100 ] . V_149 ;
V_132 -> V_147 =
V_132 -> V_153 -> V_157 [ V_132 -> V_155 ] -> V_158 [ V_132 -> V_100 ] . V_147 ;
}
V_125 += V_146 ;
V_128 -= V_146 ;
}
...
V_11 -= 2 ;
V_11 [ 0 ] |= F_64 ( 1ULL << 11 ) ;
if ( V_130 -> V_140 . V_35 & V_159 ) {
V_11 [ 0 ] |= F_64 ( 1ULL << 15 ) ;
}
F_65 () ;
F_39 ( V_2 , V_2 -> V_30 -> V_57 , V_133 ) ;
V_130 -> V_140 . V_38 = V_133 ;
V_130 -> V_140 . V_45 = V_160 ;
V_2 -> V_77 = V_133 ;
V_2 -> V_80 += V_130 -> V_140 . V_141 ;
F_66 ( & V_130 -> V_140 . V_29 , & V_2 -> V_27 ) ;
if ( V_130 -> V_140 . V_35 & V_39 )
F_1 ( V_2 ) ;
goto V_61;
V_150:
while ( V_133 != V_2 -> V_77 ) {
if ( ! V_133 )
V_133 = V_2 -> V_32 - 1 ;
else
V_133 -- ;
