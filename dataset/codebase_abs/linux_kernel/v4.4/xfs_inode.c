...
if ( error )
return error ;
error = F_181 ( V_116 , V_2 -> V_69 , V_333 , & V_293 ) ;
if ( error )
return error ;
V_2 -> V_3 . V_133 = 0 ;
V_2 -> V_3 . V_4 = 0 ;
...
F_183 ( V_2 , V_21 ) ;
F_184 ( V_2 -> V_7 , V_2 -> V_58 -> V_336 , 0 ) ;
}
static void
F_185 (
struct V_1 * V_2 )
{
T_5 * V_70 = F_32 ( & V_2 -> V_71 , V_337 ) ;
F_33 ( V_73 , & V_2 -> V_71 , V_337 ) ;
F_182 ( V_2 ) ;
do {
...
V_116 = F_86 ( V_125 , V_339 ) ;
V_212 = F_191 ( V_125 ) ;
error = F_88 ( V_116 , & F_85 ( V_125 ) -> V_340 , V_212 , 0 ) ;
if ( error == - V_195 ) {
V_212 = 0 ;
error = F_88 ( V_116 , & F_85 ( V_125 ) -> V_340 , 0 , 0 ) ;
}
if ( error ) {
ASSERT ( error != - V_195 ) ;
goto V_220;
...
int V_53 , V_54 ;
ASSERT ( * V_348 == V_349 ) ;
memset ( V_347 , 0 , * V_348 * sizeof( struct V_1 * ) ) ;
V_53 = 0 ;
V_347 [ V_53 ++ ] = V_343 ;
V_347 [ V_53 ++ ] = V_344 ;
V_347 [ V_53 ++ ] = V_67 ;
...
V_347 [ V_53 ++ ] = V_346 ;
* V_348 = V_53 ;
for ( V_53 = 0 ; V_53 < * V_348 ; V_53 ++ ) {
for ( V_54 = 1 ; V_54 < * V_348 ; V_54 ++ ) {
if ( V_347 [ V_54 ] -> V_69 < V_347 [ V_54 - 1 ] -> V_69 ) {
struct V_1 * V_68 = V_347 [ V_54 ] ;
V_347 [ V_54 ] = V_347 [ V_54 - 1 ] ;
V_347 [ V_54 - 1 ] = V_68 ;
}
}
}
...
if ( V_343 != V_344 ) {
V_356 = V_221 | V_198 ;
if ( F_59 ( V_345 -> V_3 . V_133 ) ) {
error = F_199 ( V_116 , V_345 , & V_358 ,
V_343 -> V_69 , V_204 ,
V_203 , V_353 ) ;
if ( error )
goto V_357;
if ( ! F_59 ( V_67 -> V_3 . V_133 ) ) {
error = F_73 ( V_116 , V_344 ) ;
if ( error )
goto V_357;
...
if ( V_354 ) {
F_74 ( V_116 , V_67 , V_354 ) ;
F_66 ( V_116 , V_67 , V_164 ) ;
}
if ( V_355 ) {
F_74 ( V_116 , V_345 , V_355 ) ;
F_66 ( V_116 , V_345 , V_164 ) ;
}
if ( V_356 ) {
F_74 ( V_116 , V_344 , V_356 ) ;
F_66 ( V_116 , V_344 , V_164 ) ;
}
F_74 ( V_116 , V_343 , V_221 | V_198 ) ;
...
struct V_1 * tmpfile ;
int error ;
error = F_105 ( V_107 , NULL , V_167 | V_359 , & tmpfile ) ;
if ( error )
return error ;
F_75 ( F_76 ( tmpfile ) ) ;
F_103 ( tmpfile ) ;
...
unsigned int V_75 )
{
struct V_124 * V_125 = V_360 -> V_7 ;
struct V_202 * V_116 ;
struct V_350 V_203 ;
T_17 V_204 ;
struct V_1 * V_346 = NULL ;
struct V_1 * V_51 [ V_349 ] ;
int V_348 = V_349 ;
bool V_365 = ( V_360 != V_363 ) ;
bool V_366 = F_59 ( V_362 -> V_3 . V_133 ) ;
int V_353 ;
int error ;
F_202 ( V_360 , V_363 , V_361 , V_232 ) ;
if ( ( V_75 & V_367 ) && ! V_364 )
return - V_368 ;
if ( V_75 & V_369 ) {
ASSERT ( ! ( V_75 & ( V_370 | V_367 ) ) ) ;
error = F_200 ( V_363 , & V_346 ) ;
if ( error )
return error ;
V_361 -> type = V_371 ;
}
F_196 ( V_360 , V_363 , V_362 , V_364 , V_346 ,
V_51 , & V_348 ) ;
V_116 = F_86 ( V_125 , V_372 ) ;
V_353 = F_203 ( V_125 , V_232 -> V_215 ) ;
error = F_88 ( V_116 , & F_85 ( V_125 ) -> V_373 , V_353 , 0 ) ;
if ( error == - V_195 ) {
V_353 = 0 ;
error = F_88 ( V_116 , & F_85 ( V_125 ) -> V_373 , 0 , 0 ) ;
}
if ( error )
goto V_220;
error = F_204 ( V_51 ) ;
...
F_30 ( V_360 , V_363 ,
V_23 | V_45 ) ;
F_27 ( V_51 , V_348 , V_17 ) ;
F_65 ( V_116 , V_360 , V_23 | V_17 ) ;
if ( V_365 )
F_65 ( V_116 , V_363 , V_23 | V_17 ) ;
F_65 ( V_116 , V_362 , V_17 ) ;
if ( V_364 )
F_65 ( V_116 , V_364 , V_17 ) ;
if ( V_346 )
F_65 ( V_116 , V_346 , V_17 ) ;
if ( F_110 ( ( V_363 -> V_3 . V_4 & V_93 ) &&
( F_111 ( V_363 ) != F_111 ( V_362 ) ) ) ) {
error = - V_237 ;
goto V_220;
}
F_90 ( & V_203 , & V_204 ) ;
if ( V_75 & V_367 )
return F_198 ( V_116 , V_360 , V_361 , V_362 ,
V_363 , V_232 , V_364 ,
& V_203 , & V_204 , V_353 ) ;
if ( V_364 == NULL ) {
if ( ! V_353 ) {
error = F_92 ( V_116 , V_363 , V_232 ) ;
if ( error )
goto V_220;
}
error = F_93 ( V_116 , V_363 , V_232 ,
V_362 -> V_69 , & V_204 ,
& V_203 , V_353 ) ;
if ( error )
goto V_222;
...
V_221 | V_198 ) ;
if ( V_365 && V_366 ) {
error = F_78 ( V_116 , V_363 ) ;
if ( error )
goto V_222;
}
} else {
if ( F_59 ( V_364 -> V_3 . V_133 ) ) {
if ( ! ( F_192 ( V_364 ) ) ||
( V_364 -> V_3 . V_135 > 2 ) ) {
error = - V_374 ;
goto V_220;
...
F_74 ( V_116 , V_362 , V_198 ) ;
F_66 ( V_116 , V_362 , V_164 ) ;
if ( V_366 && ( V_365 || V_364 != NULL ) ) {
error = F_73 ( V_116 , V_360 ) ;
if ( error )
goto V_222;
}
if ( V_346 ) {
error = F_199 ( V_116 , V_360 , V_361 , V_346 -> V_69 ,
& V_204 , & V_203 , V_353 ) ;
} else
error = F_193 ( V_116 , V_360 , V_361 , V_362 -> V_69 ,
& V_204 , & V_203 , V_353 ) ;
if ( error )
goto V_222;
if ( V_346 ) {
ASSERT ( F_76 ( V_346 ) -> V_375 == 0 && V_346 -> V_3 . V_135 == 0 ) ;
error = F_78 ( V_116 , V_346 ) ;
if ( error )
goto V_222;
error = F_112 ( V_116 , V_346 ) ;
if ( error )
goto V_222;
F_66 ( V_116 , V_346 , V_164 ) ;
F_76 ( V_346 ) -> V_199 &= ~ V_200 ;
}
F_74 ( V_116 , V_360 , V_221 | V_198 ) ;
F_66 ( V_116 , V_360 , V_164 ) ;
if ( V_365 )
F_66 ( V_116 , V_363 , V_164 ) ;
...
V_295 = V_125 -> V_384 >> V_125 -> V_8 . V_385 ;
V_378 = V_295 * sizeof( T_3 * ) ;
V_379 = F_206 ( V_378 , V_386 | V_387 ) ;
if ( ! V_379 )
goto V_388;
V_377 = ~ ( ( ( V_125 -> V_384 >> V_125 -> V_8 . V_385 ) ) - 1 ) ;
V_376 = F_146 ( V_125 , V_2 -> V_69 ) & V_377 ;
F_168 () ;
V_381 = F_207 ( & V_303 -> V_328 , ( void * * ) V_379 ,
V_376 , V_295 ) ;
if ( V_381 == 0 )
goto V_389;
for ( V_53 = 0 ; V_53 < V_381 ; V_53 ++ ) {
V_380 = V_379 [ V_53 ] ;
if ( V_380 == V_2 )
continue;
F_171 ( & V_2 -> V_329 ) ;
if ( ! V_2 -> V_69 ||
( F_146 ( V_125 , V_380 -> V_69 ) & V_377 ) != V_376 ) {
F_173 ( & V_2 -> V_329 ) ;
continue;
}
F_173 ( & V_2 -> V_329 ) ;
if ( F_175 ( V_380 ) && F_187 ( V_380 ) == 0 )
continue;
if ( ! F_12 ( V_380 , V_11 ) )
continue;
if ( ! F_37 ( V_380 ) ) {
...
error = F_149 ( V_125 , NULL , & V_2 -> V_278 , & V_106 , & V_299 , V_403 ,
0 ) ;
if ( error || ! V_299 ) {
F_176 ( V_2 ) ;
return error ;
...
if ( F_221 ( V_106 -> V_406 != F_222 ( V_407 ) ,
V_125 , V_408 , V_409 ) ) {
F_223 ( V_125 , V_410 ,
L_9 ,
V_263 , V_2 -> V_69 , F_43 ( V_106 -> V_406 ) , V_106 ) ;
goto V_404;
}
if ( F_221 ( V_2 -> V_3 . V_406 != V_407 ,
V_125 , V_411 , V_412 ) ) {
F_223 ( V_125 , V_410 ,
L_10 ,
V_263 , V_2 -> V_69 , V_2 , V_2 -> V_3 . V_406 ) ;
goto V_404;
}
if ( F_64 ( V_2 -> V_3 . V_133 ) ) {
if ( F_221 (
...
if ( F_221 ( V_2 -> V_3 . V_268 > V_125 -> V_8 . V_420 ,
V_125 , V_421 , V_422 ) ) {
F_223 ( V_125 , V_410 ,
L_15 ,
...
V_2 -> V_3 . V_423 ++ ;
F_224 ( V_106 , & V_2 -> V_3 ) ;
if ( V_2 -> V_3 . V_423 == V_424 )
V_2 -> V_3 . V_423 = 0 ;
F_225 ( V_2 , V_106 , V_300 , V_258 ) ;
if ( F_41 ( V_2 ) )
F_225 ( V_2 , V_106 , V_300 , V_425 ) ;
F_154 ( V_125 , V_299 ) ;
V_300 -> V_330 = V_300 -> V_331 ;
V_300 -> V_331 = 0 ;
V_300 -> V_332 = 0 ;
