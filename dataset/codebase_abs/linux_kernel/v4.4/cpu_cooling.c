...
V_75 = F_20 ( V_78 , sizeof( * V_75 ) , V_5 ) ;
}
F_16 (cpu, &cpufreq_device->allowed_cpus) {
T_1 V_50 ;
if ( F_49 ( V_13 ) )
...
static unsigned int F_56 ( struct V_85 * V_86 ,
unsigned int V_87 )
{
struct V_85 * V_88 ;
unsigned int V_26 = 0 ;
...
struct V_66 *
F_70 ( const struct V_60 * V_91 )
{
return F_58 ( NULL , V_91 , 0 , NULL ) ;
}
struct V_66 *
F_71 ( struct V_89 * V_90 ,
const struct V_60 * V_91 )
{
if ( ! V_90 )
return F_62 ( - V_38 ) ;
return F_58 ( V_90 , V_91 , 0 , NULL ) ;
}
struct V_66 *
F_72 ( const struct V_60 * V_91 , T_1 V_29 ,
T_5 V_92 )
{
return F_58 ( NULL , V_91 , V_29 ,
V_92 ) ;
}
struct V_66 *
