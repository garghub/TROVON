...
F_56 ( & V_102 -> V_116 ) ;
F_57 ( & V_102 -> V_106 , F_53 , ( unsigned long ) V_102 ) ;
V_102 -> V_2 = V_2 ;
F_58 ( & V_102 -> V_110 , F_45 ) ;
F_33 ( V_102 -> V_68 . V_67 , V_68 . V_67 , V_69 ) ;
F_59 ( & V_102 -> V_116 , & V_2 -> V_120 ) ;
...
{
return F_65 ( & V_2 -> V_12 . V_121 , & V_26 -> V_121 ) == 0 ;
}
...
V_128 = V_77 -> V_129 ;
for (; ; ) {
V_127 = F_69 ( & V_128 , & V_124 ) ;
if ( ! V_127 )
break;
switch ( V_127 -> V_130 ) {
case V_131 :
F_67 ( V_2 , V_125 , (struct V_40 * ) V_127 ) ;
break;
case V_132 :
F_66 ( V_2 , V_77 , V_125 , (struct V_41 * ) V_127 ) ;
break;
default:
F_38 ( V_13 , L_6 ) ;
break;
...
int F_70 ( struct V_133 * V_134 )
{
struct V_84 * V_13 = & V_134 -> V_2 -> V_12 . V_13 ;
struct V_1 * V_2 = V_134 -> V_2 ;
struct V_76 * V_77 ;
T_3 V_135 , V_136 ;
struct V_137 V_138 ;
struct V_12 * V_125 ;
if ( V_134 -> V_139 . V_140 < sizeof( * V_77 ) ) {
F_2 ( V_13 , L_8
L_9 ,
V_134 -> V_139 . V_140 , sizeof( * V_77 ) ) ;
return 0 ;
}
V_136 = V_134 -> V_139 . V_140 - sizeof( * V_77 ) ;
V_77 = F_46 ( V_134 -> V_139 . V_141 , struct V_76 , V_141 ) ;
V_135 = F_71 ( V_77 -> V_142 ) ;
if ( V_136 != V_135 ) {
F_2 ( V_13 , L_10
L_11 ,
V_136 , V_135 ) ;
...
memcpy ( V_138 . V_143 , & V_77 -> V_138 , sizeof( V_138 ) ) ;
V_125 = F_72 ( V_2 , & V_138 ) ;
if ( ! V_125 ) {
return 0 ;
}
F_47 ( & V_2 -> V_115 ) ;
F_68 ( V_2 , V_77 , V_135 , V_125 ) ;
F_52 ( & V_2 -> V_115 ) ;
F_73 ( V_125 ) ;
return 0 ;
}
