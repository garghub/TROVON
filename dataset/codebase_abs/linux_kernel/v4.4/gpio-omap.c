...
V_6 -> V_5 . V_115 = L_3 ;
if ( V_6 -> V_12 -> V_43 )
V_6 -> V_5 . V_74 = & V_97 . V_74 ;
V_6 -> V_5 . V_10 = F_80 ( 0 ) ;
} else {
V_6 -> V_5 . V_115 = L_4 ;
V_6 -> V_5 . V_10 = V_7 ;
}
V_6 -> V_5 . V_116 = V_6 -> V_68 ;
V_75 = F_81 ( & V_6 -> V_5 ) ;
if ( V_75 ) {
...
struct V_106 * V_107 ;
int V_75 ;
V_126 = F_90 ( F_91 ( V_131 ) , V_74 ) ;
V_128 = V_126 ? V_126 -> V_90 : F_92 ( V_74 ) ;
if ( ! V_128 )
return - V_51 ;
V_6 = F_93 ( V_74 , sizeof( struct V_1 ) , V_132 ) ;
if ( ! V_6 ) {
F_41 ( V_74 , L_8 ) ;
return - V_133 ;
}
V_107 = F_93 ( V_74 , sizeof( * V_107 ) , V_132 ) ;
if ( ! V_107 )
return - V_133 ;
V_107 -> V_134 = F_53 ,
V_107 -> V_135 = F_55 ,
...
V_6 -> V_5 . V_144 = V_145 ;
V_6 -> V_31 = V_128 -> V_31 ;
V_6 -> V_96 = V_128 -> V_146 ;
V_6 -> V_68 = V_128 -> V_147 ;
V_6 -> V_105 = V_128 -> V_105 ;
V_6 -> V_42 = V_128 -> V_42 ;
V_6 -> V_12 = V_128 -> V_12 ;
#ifdef F_95
V_6 -> V_5 . V_124 = F_96 ( V_123 ) ;
#endif
if ( V_123 ) {
if ( ! F_97 ( V_123 , L_10 ) )
V_6 -> V_148 = true ;
} else {
V_6 -> V_148 = V_128 -> V_148 ;
if ( V_6 -> V_148 )
V_6 -> V_149 =
V_128 -> V_149 ;
}
...
F_98 ( & V_6 -> V_62 ) ;
F_98 ( & V_6 -> V_85 ) ;
V_130 = F_99 ( V_93 , V_150 , 0 ) ;
V_6 -> V_10 = F_100 ( V_74 , V_130 ) ;
if ( F_101 ( V_6 -> V_10 ) ) {
...
T_2 V_154 , V_155 ;
F_31 ( & V_6 -> V_62 , V_60 ) ;
V_154 = V_6 -> V_14 . V_34 & V_6 -> V_14 . V_44 ;
if ( V_154 )
F_7 ( V_154 | V_6 -> V_14 . V_40 ,
V_6 -> V_10 + V_6 -> V_12 -> V_40 ) ;
V_155 = V_6 -> V_14 . V_36 & V_6 -> V_14 . V_44 ;
if ( V_155 )
F_7 ( V_155 | V_6 -> V_14 . V_38 ,
...
V_6 -> V_159 = F_5 ( V_6 -> V_10 +
V_6 -> V_12 -> V_22 ) ;
V_152 = V_6 -> V_14 . V_40 ;
V_153 = V_6 -> V_14 . V_38 ;
V_152 &= ~ V_6 -> V_47 ;
V_153 &= ~ V_6 -> V_47 ;
F_7 ( V_152 , V_6 -> V_10 + V_6 -> V_12 -> V_40 ) ;
F_7 ( V_153 , V_6 -> V_10 + V_6 -> V_12 -> V_38 ) ;
V_6 -> V_160 = true ;
V_156:
if ( V_6 -> V_149 )
V_6 -> V_161 =
...
struct V_92 * V_93 = F_62 ( V_74 ) ;
struct V_1 * V_6 = F_63 ( V_93 ) ;
T_2 V_11 = 0 , V_162 , V_163 , V_164 ;
unsigned long V_60 ;
int V_165 ;
F_31 ( & V_6 -> V_62 , V_60 ) ;
if ( V_6 -> V_148 && ! V_6 -> V_166 ) {
F_115 ( V_6 ) ;
if ( V_6 -> V_149 )
V_6 -> V_161 =
V_6 -> V_149 ( V_6 -> V_74 ) ;
...
if ( V_162 ) {
T_2 V_167 , V_168 ;
V_167 = F_5 ( V_6 -> V_10 + V_6 -> V_12 -> V_34 ) ;
V_168 = F_5 ( V_6 -> V_10 + V_6 -> V_12 -> V_36 ) ;
if ( ! V_6 -> V_12 -> V_169 ) {
F_7 ( V_167 | V_162 , V_6 -> V_10 +
V_6 -> V_12 -> V_34 ) ;
F_7 ( V_168 | V_162 , V_6 -> V_10 +
V_6 -> V_12 -> V_36 ) ;
}
if ( V_6 -> V_12 -> V_169 ) {
...
F_7 ( V_167 , V_6 -> V_10 + V_6 -> V_12 -> V_34 ) ;
F_7 ( V_168 , V_6 -> V_10 + V_6 -> V_12 -> V_36 ) ;
}
V_6 -> V_160 = false ;
F_32 ( & V_6 -> V_62 , V_60 ) ;
return 0 ;
}
void F_117 ( int V_170 )
{
struct V_1 * V_6 ;
F_118 (bank, &omap_gpio_list, node) {
if ( ! F_25 ( V_6 ) || ! V_6 -> V_148 )
continue;
V_6 -> V_157 = V_170 ;
F_119 ( V_6 -> V_74 ) ;
}
...
static void F_115 ( struct V_1 * V_171 )
{
struct V_172 * V_12 = V_171 -> V_12 ;
void T_1 * V_10 = V_171 -> V_10 ;
V_171 -> V_14 . V_55 = F_5 ( V_10 + V_12 -> V_55 ) ;
V_171 -> V_14 . V_15 = F_5 ( V_10 + V_12 -> V_13 ) ;
V_171 -> V_14 . V_44 = F_5 ( V_10 + V_12 -> V_43 ) ;
V_171 -> V_14 . V_34 = F_5 ( V_10 + V_12 -> V_34 ) ;
V_171 -> V_14 . V_36 = F_5 ( V_10 + V_12 -> V_36 ) ;
V_171 -> V_14 . V_38 = F_5 ( V_10 + V_12 -> V_38 ) ;
V_171 -> V_14 . V_40 = F_5 ( V_10 + V_12 -> V_40 ) ;
V_171 -> V_14 . V_72 = F_5 ( V_10 + V_12 -> V_69 ) ;
V_171 -> V_14 . V_173 = F_5 ( V_10 + V_12 -> V_173 ) ;
if ( V_12 -> V_18 && V_171 -> V_12 -> V_20 )
V_171 -> V_14 . V_19 = F_5 ( V_10 + V_12 -> V_18 ) ;
else
V_171 -> V_14 . V_19 = F_5 ( V_10 + V_12 -> V_19 ) ;
V_171 -> V_166 = true ;
}
...
F_7 ( V_6 -> V_14 . V_173 ,
V_6 -> V_10 + V_6 -> V_12 -> V_173 ) ;
}
static inline void F_115 ( struct V_1 * V_171 ) {}
