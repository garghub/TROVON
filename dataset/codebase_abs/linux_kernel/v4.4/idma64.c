...
struct V_26 * V_27 = & V_25 -> V_27 [ V_25 -> V_56 - 1 ] ;
struct V_65 * V_59 = V_27 -> V_59 ;
T_3 V_35 = 0 ;
unsigned int V_50 = V_25 -> V_56 ;
do {
V_27 = & V_25 -> V_27 [ -- V_50 ] ;
V_35 = F_40 ( V_27 , V_62 , V_25 -> V_64 , V_35 ) ;
V_25 -> V_87 += V_27 -> V_69 ;
} while ( V_50 );
V_59 -> V_70 |= V_88 ;
}
...
unsigned short V_50 ;
F_94 ( & V_5 -> V_51 ) ;
F_95 ( V_111 -> V_4 , V_111 -> V_48 , V_5 ) ;
for ( V_50 = 0 ; V_50 < V_5 -> V_51 . V_54 ; V_50 ++ ) {
struct V_14 * V_15 = & V_5 -> V_3 [ V_50 ] ;
F_96 ( & V_15 -> V_36 . V_140 ) ;
}
return 0 ;
}
...
{
struct V_110 * V_111 ;
struct V_1 * V_4 = & V_142 -> V_4 ;
struct V_143 * V_144 ;
int V_114 ;
V_111 = F_84 ( V_4 , sizeof( * V_111 ) , V_115 ) ;
if ( ! V_111 )
return - V_109 ;
V_111 -> V_48 = F_98 ( V_142 , 0 ) ;
if ( V_111 -> V_48 < 0 )
return V_111 -> V_48 ;
V_144 = F_99 ( V_142 , V_145 , 0 ) ;
V_111 -> V_116 = F_100 ( V_4 , V_144 ) ;
if ( F_101 ( V_111 -> V_116 ) )
return F_102 ( V_111 -> V_116 ) ;
V_114 = F_103 ( & V_142 -> V_4 , F_104 ( 64 ) ) ;
if ( V_114 )
return V_114 ;
V_111 -> V_4 = V_4 ;
V_114 = F_83 ( V_111 ) ;
...
{
struct V_110 * V_111 = F_107 ( V_142 ) ;
return F_93 ( V_111 ) ;
}
static int F_108 ( struct V_1 * V_4 )
{
struct V_141 * V_142 = F_109 ( V_4 ) ;
struct V_110 * V_111 = F_107 ( V_142 ) ;
F_2 ( V_111 -> V_5 ) ;
return 0 ;
}
