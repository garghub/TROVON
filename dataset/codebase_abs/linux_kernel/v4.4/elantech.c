...
struct V_9 * V_10 = V_1 -> V_11 ;
int V_63 ;
if ( V_1 -> V_100 < V_1 -> V_25 )
return V_101 ;
if ( V_10 -> V_69 > 1 )
F_11 ( V_1 ) ;
switch ( V_10 -> V_18 ) {
case 1 :
if ( V_10 -> V_102 && ! F_33 ( V_1 ) )
return V_103 ;
F_14 ( V_1 ) ;
break;
case 2 :
...
unsigned int * V_118 , unsigned int * V_36 ,
unsigned int * V_57 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
unsigned char V_3 [ 3 ] ;
...
return - 1 ;
V_127 = V_3 [ 1 ] & 0x10 ;
if ( ( ( V_10 -> V_30 >> 16 ) == 0x14 ) && V_127 ) {
if ( V_10 -> V_128 ( V_1 , V_130 , V_3 ) )
return - 1 ;
* V_118 = ( V_10 -> V_42 [ 1 ] - V_23 ) * V_3 [ 1 ] / 2 ;
...
return - 1 ;
* V_131 = F_42 ( V_3 [ 1 ] & 0x0f ) ;
* V_132 = F_42 ( ( V_3 [ 1 ] & 0xf0 ) >> 4 ) ;
return 0 ;
}
...
struct V_9 * V_10 = V_1 -> V_11 ;
if ( V_10 -> V_30 & 0x001000 ) {
F_45 ( V_134 , V_28 -> V_135 ) ;
F_46 ( V_41 , V_28 -> V_136 ) ;
}
}
...
struct V_27 * V_28 = V_1 -> V_28 ;
struct V_9 * V_10 = V_1 -> V_11 ;
unsigned int V_116 = 0 , V_117 = 0 , V_118 = 0 , V_36 = 0 , V_57 = 0 ;
unsigned int V_131 = 31 , V_132 = 31 ;
if ( F_41 ( V_1 , & V_116 , & V_117 , & V_118 , & V_36 , & V_57 ) )
return - 1 ;
F_45 ( V_137 , V_28 -> V_135 ) ;
F_45 ( V_138 , V_28 -> V_139 ) ;
F_45 ( V_140 , V_28 -> V_139 ) ;
F_46 ( V_141 , V_28 -> V_139 ) ;
F_45 ( V_40 , V_28 -> V_136 ) ;
if ( F_48 ( V_142 ) )
F_45 ( V_66 , V_28 -> V_136 ) ;
F_45 ( V_41 , V_28 -> V_136 ) ;
F_45 ( V_33 , V_28 -> V_136 ) ;
F_45 ( V_37 , V_28 -> V_136 ) ;
F_45 ( V_38 , V_28 -> V_136 ) ;
F_45 ( V_39 , V_28 -> V_136 ) ;
switch ( V_10 -> V_18 ) {
case 1 :
if ( V_10 -> V_30 < 0x020000 &&
( V_10 -> V_42 [ 0 ] & V_43 ) ) {
F_45 ( V_44 , V_28 -> V_136 ) ;
F_45 ( V_45 , V_28 -> V_136 ) ;
}
F_49 ( V_28 , V_34 , V_116 , V_118 , 0 , 0 ) ;
F_49 ( V_28 , V_35 , V_117 , V_36 , 0 , 0 ) ;
break;
case 2 :
F_45 ( V_59 , V_28 -> V_136 ) ;
F_45 ( V_143 , V_28 -> V_135 ) ;
case 3 :
if ( V_10 -> V_18 == 3 )
F_44 ( V_1 ) ;
F_49 ( V_28 , V_34 , V_116 , V_118 , 0 , 0 ) ;
F_49 ( V_28 , V_35 , V_117 , V_36 , 0 , 0 ) ;
if ( V_10 -> V_60 ) {
F_49 ( V_28 , V_61 , V_144 ,
V_145 , 0 , 0 ) ;
F_49 ( V_28 , V_62 , V_146 ,
V_147 , 0 , 0 ) ;
}
F_50 ( V_28 , 2 , 0 ) ;
F_49 ( V_28 , V_51 , V_116 , V_118 , 0 , 0 ) ;
F_49 ( V_28 , V_52 , V_117 , V_36 , 0 , 0 ) ;
break;
case 4 :
if ( F_43 ( V_1 , & V_131 , & V_132 ) ) {
F_51 ( V_1 , L_17 ) ;
}
F_44 ( V_1 ) ;
F_45 ( V_59 , V_28 -> V_136 ) ;
...
F_49 ( V_28 , V_51 , V_116 , V_118 , 0 , 0 ) ;
F_49 ( V_28 , V_52 , V_117 , V_36 , 0 , 0 ) ;
F_49 ( V_28 , V_75 , V_144 ,
V_145 , 0 , 0 ) ;
F_49 ( V_28 , V_76 , 0 ,
V_147 * V_57 , 0 , 0 ) ;
break;
}
F_52 ( V_28 , V_34 , V_131 ) ;
F_52 ( V_28 , V_35 , V_132 ) ;
if ( V_10 -> V_18 > 1 ) {
F_52 ( V_28 , V_51 , V_131 ) ;
F_52 ( V_28 , V_52 , V_132 ) ;
}
V_10 -> V_36 = V_36 ;
V_10 -> V_57 = V_57 ;
return 0 ;
}
static T_4 F_53 ( struct V_1 * V_1 , void * V_148 ,
char * V_149 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_150 * V_151 = V_148 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_151 -> V_152 ;
int V_12 = 0 ;
if ( V_151 -> V_16 )
V_12 = F_9 ( V_1 , V_151 -> V_16 , V_16 ) ;
return sprintf ( V_149 , L_18 , ( V_151 -> V_16 && V_12 ) ? - 1 : * V_16 ) ;
}
static T_4 F_54 ( struct V_1 * V_1 ,
void * V_148 , const char * V_149 , T_5 V_153 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_150 * V_151 = V_148 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_151 -> V_152 ;
unsigned char V_154 ;
int V_155 ;
V_155 = F_55 ( V_149 , 16 , & V_154 ) ;
if ( V_155 )
return V_155 ;
if ( V_10 -> V_18 == 1 ) {
if ( V_151 -> V_16 == 0x10 )
V_154 |= V_115 ;
else if ( V_151 -> V_16 == 0x11 )
V_154 |= V_156 ;
}
if ( ! V_151 -> V_16 || F_10 ( V_1 , V_151 -> V_16 , V_154 ) == 0 )
* V_16 = V_154 ;
return V_153 ;
}
static bool F_56 ( const unsigned char * V_3 )
{
static const unsigned char V_157 [] = { 200 , 100 , 80 , 60 , 40 , 20 , 10 } ;
int V_23 ;
if ( V_3 [ 0 ] == 0 )
return false ;
if ( V_3 [ 1 ] == 0 )
...
V_3 [ 2 ] < 40 )
return true ;
for ( V_23 = 0 ; V_23 < F_57 ( V_157 ) ; V_23 ++ )
if ( V_3 [ 2 ] == V_157 [ V_23 ] )
return false ;
return true ;
}
int F_58 ( struct V_1 * V_1 , bool V_158 )
{
struct V_4 * V_4 = & V_1 -> V_4 ;
unsigned char V_3 [ 3 ] ;
F_3 ( & V_1 -> V_4 , NULL , V_159 ) ;
if ( F_3 ( V_4 , NULL , V_160 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , V_3 , V_5 ) ) {
...
{
int V_167 = ( V_10 -> V_30 & 0x0f0000 ) >> 16 ;
...
unsigned char V_3 [ 3 ] ;
struct V_27 * V_64 ;
V_1 -> V_11 = V_10 = F_68 ( sizeof( struct V_9 ) , V_171 ) ;
if ( ! V_10 )
return - V_172 ;
F_65 ( V_1 ) ;
V_10 -> V_91 [ 0 ] = 1 ;
...
error = F_70 ( & V_1 -> V_4 . V_164 -> V_28 . V_165 ,
& V_166 ) ;
if ( error ) {
F_4 ( V_1 ,
L_35 ,
...
V_10 -> V_64 = V_64 ;
snprintf ( V_10 -> V_177 , sizeof( V_10 -> V_177 ) , L_36 ,
V_1 -> V_4 . V_164 -> V_178 ) ;
V_64 -> V_178 = V_10 -> V_177 ;
V_64 -> V_163 = L_37 ;
V_64 -> V_73 . V_179 = V_180 ;
V_64 -> V_73 . V_162 = 0x0002 ;
V_64 -> V_73 . V_181 = V_182 ;
V_64 -> V_73 . V_183 = 0x0000 ;
V_64 -> V_28 . V_184 = & V_1 -> V_4 . V_164 -> V_28 ;
V_64 -> V_139 [ 0 ] = F_72 ( V_138 ) | F_72 ( V_141 ) ;
V_64 -> V_185 [ F_73 ( V_67 ) ] =
F_72 ( V_67 ) | F_72 ( V_68 ) ;
V_64 -> V_136 [ F_73 ( V_40 ) ] =
F_72 ( V_40 ) | F_72 ( V_66 ) |
F_72 ( V_41 ) ;
F_45 ( V_137 , V_64 -> V_135 ) ;
F_45 ( V_186 , V_64 -> V_135 ) ;
