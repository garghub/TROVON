...
static void F_290 ( struct V_6 * V_7 , T_1 V_21 )
{
F_262 ( V_7 , V_21 ) ;
if ( V_7 -> V_103 ) {
const T_1 * V_295 ;
...
unsigned int F_300 ( struct V_6 * V_7 , T_1 V_61 )
{
unsigned int V_417 ;
unsigned int V_145 ;
...
unsigned int F_301 ( struct V_6 * V_7 ,
...
int F_302 ( struct V_6 * V_7 , T_1 V_61 ,
unsigned int V_74 , bool V_441 )
{
V_74 = F_301 ( V_7 , V_61 , V_74 ) ;
F_51 ( V_7 , V_61 , V_74 ) ;
if ( V_441 )
return F_303 ( V_7 , V_61 , 0 ,
V_77 , V_74 ) ;
else
...
F_305 ( V_386 -> V_226 [ V_386 -> V_388 ] . V_389 , V_389 ,
sizeof( V_386 -> V_226 [ V_386 -> V_388 ] . V_389 ) ) ;
...
void F_307 ( int V_87 , char * V_445 , int V_446 )
{
