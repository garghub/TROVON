...
F_127 ( void )
{
return (struct V_3 * ) F_119 ( V_120 , V_104 ) ;
}
struct V_3 * F_128 ( const struct V_112 * V_121 )
{
...
{
F_130 ( F_117 ( V_99 , struct V_3 , V_7 . V_55 ) ) ;
}
...
{
if ( V_15 != NULL ) {
F_69 ( & V_4 -> V_7 . V_55 , F_131 ) ;
F_70 ( V_15 , & V_4 -> V_7 . V_55 ) ;
} else
F_130 ( V_4 ) ;
}
static void F_136 ( struct V_3 * V_4 , struct V_126 * V_15 )
{
if ( F_59 ( & V_4 -> V_50 ) ) {
F_132 ( V_4 ) ;
F_135 ( V_4 , V_15 ) ;
