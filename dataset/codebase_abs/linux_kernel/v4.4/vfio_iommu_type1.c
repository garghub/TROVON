...
T_2 V_64 = 0 ;
int V_37 = 0 ;
V_76 = ( ( T_4 ) 1 << F_55 ( F_50 ( V_3 ) ) ) - 1 ;
if ( V_75 -> V_10 & V_76 )
return - V_77 ;
if ( ! V_75 -> V_5 || V_75 -> V_5 & V_76 )
return - V_77 ;
F_48 ( V_76 & V_73 ) ;
F_51 ( & V_3 -> V_70 ) ;
if ( V_3 -> V_78 ) {
V_9 = F_1 ( V_3 , V_75 -> V_10 , 0 ) ;
if ( V_9 && V_9 -> V_10 != V_75 -> V_10 ) {
V_37 = - V_77 ;
goto V_79;
}
V_9 = F_1 ( V_3 , V_75 -> V_10 + V_75 -> V_5 - 1 , 0 ) ;
if ( V_9 && V_9 -> V_10 + V_9 -> V_5 != V_75 -> V_10 + V_75 -> V_5 ) {
V_37 = - V_77 ;
goto V_79;
}
}
while ( ( V_9 = F_1 ( V_3 , V_75 -> V_10 , V_75 -> V_5 ) ) ) {
if ( ! V_3 -> V_78 && V_75 -> V_10 > V_9 -> V_10 )
break;
V_64 += V_9 -> V_5 ;
F_49 ( V_3 , V_9 ) ;
}
...
struct V_1 * V_9 ;
unsigned long V_27 ;
if ( V_83 -> V_5 != V_5 || V_83 -> V_34 != V_34 || V_83 -> V_10 != V_10 )
return - V_77 ;
V_76 = ( ( T_4 ) 1 << F_55 ( F_50 ( V_3 ) ) ) - 1 ;
F_48 ( V_76 & V_73 ) ;
if ( V_83 -> V_84 & V_85 )
...
if ( V_83 -> V_84 & V_86 )
V_32 |= V_87 ;
if ( ! V_32 || ! V_5 || ( V_5 | V_10 | V_34 ) & V_76 )
return - V_77 ;
...
static int F_62 ( struct V_89 * V_90 , void * V_91 )
{
struct V_92 * * V_93 = V_91 ;
if ( * V_93 && * V_93 != V_90 -> V_93 )
return - V_77 ;
* V_93 = V_90 -> V_93 ;
return 0 ;
}
...
if ( F_48 ( V_94 && ! V_61 ) )
return - V_77 ;
for (; V_94 ; V_94 = F_65 ( V_94 ) ) {
struct V_1 * V_9 ;
T_1 V_10 ;
V_9 = F_2 ( V_94 , struct V_1 , V_7 ) ;
V_10 = V_9 -> V_10 ;
...
{
struct V_29 * V_95 ;
int V_37 , V_96 = F_67 ( V_55 * 2 ) ;
V_95 = F_68 ( V_26 | V_97 , V_96 ) ;
if ( ! V_95 )
return;
V_37 = F_57 ( V_60 -> V_60 , 0 , F_69 ( V_95 ) , V_55 * 2 ,
V_87 | V_33 | V_60 -> V_32 ) ;
if ( ! V_37 ) {
...
if ( V_3 -> V_105 ) {
int V_106 = 1 ;
V_37 = F_74 ( V_60 -> V_60 , V_107 ,
& V_106 ) ;
if ( V_37 )
goto V_108;
}
V_37 = F_75 ( V_60 -> V_60 , V_99 ) ;
if ( V_37 )
goto V_108;
F_76 ( & V_60 -> V_109 ) ;
F_77 ( & V_101 -> V_63 , & V_60 -> V_109 ) ;
if ( ! V_110 &&
! F_78 ( V_93 , V_111 ) ) {
F_39 ( L_2 ,
V_52 ) ;
...
V_60 -> V_32 |= V_115 ;
F_52 (d, &iommu->domain_list, next) {
if ( V_61 -> V_60 -> V_71 == V_60 -> V_60 -> V_71 &&
V_61 -> V_32 == V_60 -> V_32 ) {
F_79 ( V_60 -> V_60 , V_99 ) ;
if ( ! F_75 ( V_61 -> V_60 , V_99 ) ) {
F_77 ( & V_101 -> V_63 , & V_61 -> V_109 ) ;
F_80 ( V_60 -> V_60 ) ;
F_13 ( V_60 ) ;
F_53 ( & V_3 -> V_70 ) ;
return 0 ;
...
static void F_89 ( void * V_98 )
{
struct V_2 * V_3 = V_98 ;
struct V_59 * V_60 , * V_122 ;
struct V_100 * V_101 , * V_123 ;
F_81 ( V_3 ) ;
F_90 (domain, domain_tmp,
&iommu->domain_list, next) {
F_90 (group, group_tmp,
&domain->group_list, next) {
F_79 ( V_60 -> V_60 , V_101 -> V_99 ) ;
F_83 ( & V_101 -> V_63 ) ;
F_13 ( V_101 ) ;
}
F_80 ( V_60 -> V_60 ) ;
...
T_5 V_76 = V_86 |
V_85 ;
V_125 = F_93 ( struct V_82 , V_5 ) ;
if ( F_94 ( & V_83 , ( void V_132 * ) V_117 , V_125 ) )
return - V_38 ;
if ( V_83 . V_133 < V_125 || V_83 . V_84 & ~ V_76 )
return - V_77 ;
return F_60 ( V_3 , & V_83 ) ;
} else if ( V_124 == V_135 ) {
struct V_74 V_75 ;
long V_37 ;
V_125 = F_93 ( struct V_74 , V_5 ) ;
if ( F_94 ( & V_75 , ( void V_132 * ) V_117 , V_125 ) )
return - V_38 ;
if ( V_75 . V_133 < V_125 || V_75 . V_84 )
return - V_77 ;
V_37 = F_54 ( V_3 , & V_75 ) ;
if ( V_37 )
return V_37 ;
return F_95 ( ( void V_132 * ) V_117 , & V_75 , V_125 ) ;
}
return - V_136 ;
}
