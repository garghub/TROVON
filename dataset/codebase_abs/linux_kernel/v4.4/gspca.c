...
static struct V_128 * F_50 ( struct V_63 * V_124 ,
int V_129 , int V_130 )
{
struct V_128 * V_43 ;
int V_65 , V_131 ;
...
if ( V_1 -> V_124 != 0 ) {
V_1 -> V_124 -- ;
V_43 = F_50 ( & V_62 -> V_155 [ V_1 -> V_124 ] , V_129 ,
V_1 -> V_130 ) ;
if ( V_43 == NULL ) {
F_8 ( L_35 , V_1 -> V_124 ) ;
return - V_174 ;
...
static int F_63 ( struct V_106 * V_106 , void * V_190 ,
struct V_191 * V_192 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
V_1 -> V_125 = 0 ;
if ( V_1 -> V_20 -> V_193 )
return V_1 -> V_20 -> V_193 ( V_1 , V_192 ) ;
return V_192 -> V_194 . V_195 ? - V_48 : 0 ;
}
static int F_65 ( struct V_106 * V_106 , void * V_190 ,
struct V_196 * V_197 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
V_1 -> V_125 = 0 ;
...
static int F_69 ( struct V_106 * V_106 , void * V_190 ,
struct V_205 * V_206 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
...
static int F_71 ( struct V_106 * V_106 ,
void * V_190 ,
struct V_205 * V_206 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
...
static int F_72 ( struct V_106 * V_106 , void * V_190 ,
struct V_205 * V_206 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
int V_18 ;
...
static int F_75 ( struct V_106 * V_106 , void * V_190 ,
struct V_213 * V_214 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
int V_65 ;
...
static int F_76 ( struct V_106 * V_219 , void * V_190 ,
struct V_220 * V_221 )
{
struct V_1 * V_1 = F_64 ( V_219 ) ;
int V_186 = F_61 ( V_1 , V_221 -> V_136 , V_221 -> V_137 ) ;
T_1 V_65 ;
...
static void F_77 ( struct V_225 * V_225 )
{
struct V_1 * V_1 =
F_78 ( V_225 , struct V_1 , V_226 ) ;
F_79 ( V_1 -> V_180 . V_181 ) ;
F_80 ( & V_1 -> V_226 ) ;
F_81 ( V_1 -> V_227 ) ;
F_81 ( V_1 ) ;
}
static int F_82 ( struct V_106 * V_106 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
int V_18 ;
...
static int F_88 ( struct V_106 * V_106 , void * V_190 ,
struct V_232 * V_233 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
F_89 ( ( char * ) V_233 -> V_234 , V_1 -> V_20 -> V_35 ,
sizeof V_233 -> V_234 ) ;
if ( V_1 -> V_29 -> V_235 != NULL ) {
F_89 ( ( char * ) V_233 -> V_236 , V_1 -> V_29 -> V_235 ,
sizeof V_233 -> V_236 ) ;
} else {
...
static int F_90 ( struct V_106 * V_106 , void * V_190 ,
struct V_247 * V_248 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
if ( V_248 -> V_115 != 0 )
...
F_89 ( V_248 -> V_35 , V_1 -> V_20 -> V_35 ,
sizeof V_248 -> V_35 ) ;
return 0 ;
}
static int F_91 ( struct V_106 * V_106 , void * V_190 , unsigned int * V_65 )
{
* V_65 = 0 ;
return 0 ;
}
...
static int F_93 ( struct V_106 * V_106 , void * V_190 ,
struct V_251 * V_252 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
...
if ( V_252 -> V_109 == 0 )
goto V_177;
V_18 = F_41 ( V_1 , V_106 , V_252 -> V_108 , V_252 -> V_109 ) ;
if ( V_18 == 0 ) {
...
static int F_99 ( struct V_106 * V_219 , void * V_190 ,
struct V_139 * V_140 )
{
struct V_1 * V_1 = F_64 ( V_219 ) ;
...
static int F_101 ( struct V_106 * V_106 , struct V_7 * V_8 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
struct V_9 * V_10 ;
struct V_267 * V_267 ;
...
while ( V_268 > 0 ) {
V_267 = F_102 ( ( void * ) V_195 ) ;
V_18 = F_103 ( V_8 , V_179 , V_267 ) ;
if ( V_18 < 0 )
goto V_177;
V_179 += V_275 ;
V_195 += V_275 ;
...
static int F_104 ( struct V_1 * V_1 , struct V_106 * V_106 ,
enum V_107 V_108 )
{
if ( ! V_1 -> V_278 )
return - V_26 ;
...
if ( F_73 ( & V_1 -> V_210 ) )
return - V_211 ;
V_18 = F_104 ( V_1 , V_106 , V_108 ) ;
F_74 ( & V_1 -> V_210 ) ;
return V_18 ;
}
static int F_106 ( struct V_106 * V_106 , void * V_190 ,
struct V_256 * V_13 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
struct V_9 * V_10 ;
...
return - V_211 ;
for (; ; ) {
V_18 = F_104 ( V_1 , V_106 , V_13 -> V_108 ) ;
if ( V_18 < 0 )
goto V_177;
if ( V_18 > 0 )
break;
...
return - V_281 ;
V_18 = F_107 ( V_1 -> V_104 ,
F_105 ( V_1 , V_106 , V_13 -> V_108 ) ,
F_108 ( 3000 ) ) ;
if ( V_18 < 0 )
return V_18 ;
if ( V_18 == 0 )
...
V_18 = 0 ;
if ( V_1 -> V_108 == V_255 ) {
if ( F_109 ( ( V_282 V_283 * ) V_10 -> V_13 . V_120 . V_284 ,
V_10 -> V_71 ,
V_10 -> V_13 . V_100 ) ) {
F_6 ( L_54 ) ;
V_18 = - V_285 ;
...
static int F_111 ( struct V_106 * V_106 , void * V_190 ,
struct V_256 * V_13 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
struct V_9 * V_10 ;
...
static unsigned int F_113 ( struct V_106 * V_106 , T_5 * V_287 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
unsigned long V_288 = F_114 ( V_287 ) ;
int V_18 = 0 ;
F_2 ( V_105 , L_63 ) ;
if ( V_288 & V_289 )
V_18 |= F_115 ( V_106 , V_287 ) ;
if ( V_288 & ( V_290 | V_291 ) ) {
if ( V_1 -> V_108 == V_122 ) {
if ( F_112 ( V_1 , V_106 ) != 0 ) {
V_18 |= V_292 ;
goto V_177;
}
}
F_116 ( V_106 , & V_1 -> V_104 , V_287 ) ;
if ( F_73 ( & V_1 -> V_210 ) != 0 ) {
V_18 |= V_292 ;
goto V_177;
}
...
static T_6 F_117 ( struct V_106 * V_106 , char V_283 * V_71 ,
T_7 V_109 , T_8 * V_294 )
{
struct V_1 * V_1 = F_64 ( V_106 ) ;
struct V_9 * V_10 ;
...
V_18 = F_109 ( V_71 , V_10 -> V_71 , V_109 ) ;
if ( V_18 != 0 ) {
F_6 ( L_67 , V_18 , V_109 ) ;
V_18 = - V_285 ;
goto V_177;
...
{
struct V_1 * V_1 ;
struct V_46 * V_29 = F_119 ( V_62 ) ;
int V_18 ;
F_120 ( L_68 V_300 L_69 ,
V_20 -> V_35 , V_36 -> V_238 , V_36 -> V_239 ) ;
if ( V_299 < sizeof *V_1 )
V_299 = sizeof *V_1 ;
V_1 = F_121 ( V_299 , V_53 ) ;
if ( ! V_1 ) {
F_8 ( L_70 ) ;
return - V_33 ;
}
V_1 -> V_227 = F_122 ( V_301 , V_53 ) ;
if ( ! V_1 -> V_227 ) {
F_8 ( L_71 ) ;
V_18 = - V_33 ;
goto V_177;
...
V_1 -> V_226 . V_309 = F_77 ;
V_18 = F_123 ( & V_62 -> V_29 , & V_1 -> V_226 ) ;
if ( V_18 )
goto V_177;
V_1 -> V_20 = V_20 ;
V_1 -> V_265 = 2 ;
...
if ( V_18 )
goto V_177;
F_127 ( & V_1 -> V_180 , V_315 ) ;
F_127 ( & V_1 -> V_180 , V_316 ) ;
F_127 ( & V_1 -> V_180 , V_317 ) ;
#ifdef F_128
if ( ! V_1 -> V_20 -> V_198 )
F_129 ( & V_1 -> V_180 , V_318 ) ;
if ( ! V_1 -> V_20 -> V_199 )
F_129 ( & V_1 -> V_180 , V_319 ) ;
#endif
if ( ! V_1 -> V_20 -> V_262 )
F_129 ( & V_1 -> V_180 , V_320 ) ;
if ( ! V_1 -> V_20 -> V_263 )
F_129 ( & V_1 -> V_180 , V_321 ) ;
V_18 = F_130 ( & V_1 -> V_180 ,
V_322 ,
- 1 ) ;
if ( V_18 < 0 ) {
F_8 ( L_72 , V_18 ) ;
...
F_131 ( V_62 , V_1 ) ;
F_2 ( V_323 , L_73 , F_132 ( & V_1 -> V_180 ) ) ;
F_26 ( V_1 ) ;
return 0 ;
V_177:
#if F_133 ( V_324 )
...
return - V_26 ;
return F_118 ( V_62 , V_36 , V_20 , V_299 , V_230 ) ;
}
void F_136 ( struct V_61 * V_62 )
{
struct V_1 * V_1 = F_137 ( V_62 ) ;
#if F_133 ( V_324 )
struct V_30 * V_30 ;
#endif
F_2 ( V_323 , L_75 ,
...
int F_141 ( struct V_61 * V_62 , T_9 V_326 )
{
struct V_1 * V_1 = F_137 ( V_62 ) ;
F_30 ( V_1 ) ;
if ( ! V_1 -> V_84 )
