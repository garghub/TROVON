...
{
const unsigned long V_26 = F_21 ( V_33 ) ;
...
static int F_25 ( const struct V_36 * V_37 ,
struct V_16 * V_24 ,
...
F_22 ( & V_37 -> V_50 -> V_3 , V_7 , V_24 , V_64 ) ;
V_9:
return V_41 ;
}
static int F_28 ( const struct V_36 * V_37 ,
struct V_1 * V_7 ,
struct V_16 * V_24 ,
const struct V_38 * V_39 ,
...
{
int V_41 = 0 ;
if ( V_59 >= F_29 ( V_24 -> V_33 ) )
V_41 = F_11 ( V_37 , V_24 , V_39 , V_40 ) ;
else
V_41 = F_27 ( V_37 , V_7 , V_24 , V_39 , V_40 ) ;
return V_41 ;
}
...
F_31 (pkt, pkt_next, list, list) {
int V_25 ;
for ( V_25 = 0 ; V_25 < V_24 -> V_35 ; V_25 ++ )
F_22 ( V_3 , V_7 , V_24 , V_25 ) ;
F_32 ( V_7 -> V_15 , V_24 ) ;
}
}
static int F_33 ( const struct V_36 * V_37 ,
struct V_1 * V_7 ,
struct V_66 * V_67 ,
const struct V_38 * V_39 ,
unsigned long V_40 ,
...
V_84:
if ( V_29 )
F_23 ( & V_37 -> V_50 -> V_3 , V_32 , V_27 , V_51 ) ;
V_80:
if ( V_30 ) {
F_17 ( V_30 ) ;
F_18 ( V_30 ) ;
} else
F_24 ( V_7 -> V_19 , V_71 , V_32 ) ;
V_65:
F_32 ( V_7 -> V_15 , V_24 ) ;
V_77:
F_30 ( & V_37 -> V_50 -> V_3 , V_7 , V_67 ) ;
V_9:
return V_41 ;
}
...
static int F_39 ( const struct V_36 * V_37 ,
struct V_1 * V_7 )
{
struct V_66 V_77 ;
struct V_16 * V_24 ;
...
int V_41 = 0 ;
F_3 ( & V_77 ) ;
F_31 (pkt, pkt_prev, &pq->sent, list) {
...
static inline T_6 F_55 ( struct V_36 * V_37 ,
...
{
return V_97 | F_56 ( 1ULL << 12 ) ;
}
static inline T_6 F_58 ( T_6 V_97 )
{
return V_97 | F_56 ( 1ULL << 11 | 1ULL << 13 ) ;
}
static inline T_6 F_59 ( T_7 V_33 )
{
return F_56 ( V_33 >> 32 ) ;
}
...
V_101 = F_55 ( V_37 , V_33 , V_94 , V_98 ) ;
if ( V_64 == 0 )
V_101 = F_57 ( V_101 ) ;
if ( V_64 == V_24 -> V_35 - 1 )
V_101 = F_58 ( V_101 ) ;
...
if ( F_41 ( V_104 ) )
return 0 ;
if ( F_62 ( ! ( V_37 -> V_105 & V_106 ) ) )
return - V_107 ;
F_46 ( & V_37 -> V_92 , V_91 ) ;
if ( F_62 ( V_37 -> V_108 & V_109 ) ) {
V_41 = - V_107 ;
goto V_110;
}
V_99 = V_37 -> V_111 ;
while ( ! F_41 ( V_104 ) ) {
struct V_16 * V_24 =
F_42 ( V_104 -> V_112 , struct V_16 ,
V_67 ) ;
int V_25 ;
unsigned V_98 = 0 ;
T_8 V_113 = V_99 ;
if ( V_24 -> V_35 > F_63 ( V_37 ) )
goto V_114;
for ( V_25 = 0 ; V_25 < V_24 -> V_35 ; V_25 ++ ) {
F_60 ( V_37 , V_24 , V_25 , V_98 , V_99 ) ;
...
F_40 ( & V_24 -> V_67 , & V_7 -> V_12 ) ;
V_41 ++ ;
}
V_114:
if ( V_37 -> V_111 != V_99 ) {
F_65 () ;
F_66 ( V_37 , V_37 -> V_120 -> V_121 , V_99 ) ;
V_37 -> V_111 = V_99 ;
}
V_110:
F_48 ( & V_37 -> V_92 , V_91 ) ;
...
while ( V_122 ) {
const int V_123 = 8 ;
V_41 = F_33 ( V_37 , V_7 , & V_67 , V_39 , V_122 , V_123 ) ;
if ( V_41 <= 0 )
goto V_124;
else {
V_122 -= V_41 ;
