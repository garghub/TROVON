...
return;
V_96 = (struct V_102 * ) F_46 ( V_2 , sizeof( * V_96 ) ) ;
V_96 -> V_98 = 0x28 ;
V_96 -> V_99 = V_6 -> V_68 ;
V_96 -> V_105 = V_6 -> V_69 ;
...
* F_46 ( V_2 , 1 ) = V_66 ;
if ( V_66 > 0 )
memcpy ( F_46 ( V_2 , V_66 ) , V_6 -> V_103 . V_112 , V_66 ) ;
F_1 ( V_2 ) ;
V_6 -> V_64 = F_17 ( V_4 ) ;
V_6 -> V_113 = F_48 ;
}
static T_4 void F_51 ( struct V_3 * V_4 , unsigned char V_98 ,
...
void F_54 ( struct V_3 * V_4 , unsigned char V_98 ,
unsigned short V_114 , T_1 V_49 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
int V_115 = 0 ;
...
F_51 ( V_4 , V_98 , V_114 , V_49 , F_55 ( V_4 ) , V_115 ,
V_6 -> V_120 . V_112 , V_6 -> V_68 , V_6 -> V_69 ) ;
}
void F_56 ( struct V_1 * V_2 , unsigned char V_98 ,
unsigned short V_114 )
{
struct V_50 * V_51 = F_20 ( V_2 ) ;
int V_115 = 0 ;
T_1 V_49 = V_57 ;
F_51 ( NULL , V_98 , V_114 , V_49 , F_57 ( V_2 ) , V_115 ,
NULL , V_51 -> V_122 , V_51 -> V_123 ) ;
}
void F_58 ( struct V_3 * V_4 , unsigned char V_124 , char V_125 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_2 ;
unsigned char * V_67 ;
...
void F_60 ( struct V_3 * V_4 , unsigned char V_98 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_102 * V_96 ;
unsigned char V_129 ;
...
if ( V_6 -> V_20 . V_133 )
type = 0 ;
F_46 ( V_2 , F_61 ( & V_6 -> V_20 ,
F_62 ( V_2 ) , type ) ) ;
F_46 ( V_2 , F_61 ( & V_6 -> V_18 ,
F_62 ( V_2 ) , 2 ) ) ;
V_130 = V_134 | V_135 ;
...
* F_46 ( V_2 , 1 ) = V_129 ;
if ( V_129 > 0 )
memcpy ( F_46 ( V_2 , V_129 ) , V_6 -> V_141 . V_143 , V_129 ) ;
V_129 = V_6 -> V_141 . V_144 ;
* F_46 ( V_2 , 1 ) = V_129 ;
if ( V_129 > 0 )
memcpy ( F_46 ( V_2 , V_129 ) , V_6 -> V_141 . V_145 , V_129 ) ;
V_129 = V_6 -> V_141 . V_146 ;
* F_46 ( V_2 , 1 ) = V_129 ;
if ( V_129 > 0 )
memcpy ( F_46 ( V_2 , V_129 ) , V_6 -> V_141 . V_147 , V_129 ) ;
V_129 = ( T_3 ) F_50 ( V_6 -> V_103 . V_104 ) ;
* F_46 ( V_2 , 1 ) = V_129 ;
if ( V_129 > 0 )
memcpy ( F_46 ( V_2 , V_129 ) , V_6 -> V_103 . V_112 , V_129 ) ;
V_6 -> V_64 = F_17 ( V_4 ) ;
V_6 -> V_113 = F_59 ;
V_51 -> V_148 = V_149 ;
F_1 ( V_2 ) ;
