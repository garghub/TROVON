...
V_43 -> V_55 ) )
return - V_60 ;
V_44 = F_19 ( sizeof( struct V_25 ) * V_43 -> V_61 , V_62 ) ;
if ( ! V_44 )
return - V_20 ;
V_11 = F_20 ( V_7 ,
sizeof( union V_57 ) +
...
if ( V_72 . V_79 ) {
V_11 = F_11 ( V_7 , V_5 , V_72 . V_79 , V_38 ,
& V_44 [ V_48 ] . V_28 ) ;
if ( V_11 )
goto V_75;
...
V_11 = F_11 ( V_7 , V_5 , V_72 . V_80 , V_38 ,
& V_44 [ V_48 ] . V_32 ) ;
if ( V_11 )
goto V_75;
