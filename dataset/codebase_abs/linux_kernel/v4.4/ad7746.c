...
F_9 ( V_8 ) ;
V_7 = F_27 ( V_6 -> V_19 ,
V_4 -> V_12 >> 8 , 3 , & V_6 -> V_42 . V_61 [ 1 ] ) ;
if ( V_7 < 0 )
goto V_50;
* V_45 = ( F_28 ( V_6 -> V_42 . V_62 ) & 0xFFFFFF ) - 0x800000 ;
switch ( V_4 -> type ) {
case V_24 :
* V_45 = ( * V_45 * 125 ) / 256 ;
break;
...
static int F_30 ( struct V_68 * V_19 ,
const struct V_69 * V_70 )
{
struct V_71 * V_72 = V_19 -> V_29 . V_73 ;
struct V_5 * V_6 ;
struct V_1 * V_2 ;
int V_7 = 0 ;
unsigned char V_34 = 0 ;
V_2 = F_31 ( & V_19 -> V_29 , sizeof( * V_6 ) ) ;
if ( ! V_2 )
return - V_74 ;
V_6 = F_2 ( V_2 ) ;
F_32 ( V_19 , V_2 ) ;
...
V_6 -> V_17 = - 1 ;
V_2 -> V_75 = V_70 -> V_75 ;
V_2 -> V_29 . V_76 = & V_19 -> V_29 ;
V_2 -> V_77 = & V_78 ;
V_2 -> V_79 = V_39 ;
if ( V_70 -> V_80 == 7746 )
V_2 -> V_81 = F_17 ( V_39 ) ;
else
V_2 -> V_81 = F_17 ( V_39 ) - 2 ;
V_2 -> V_81 = F_17 ( V_39 ) ;
V_2 -> V_82 = V_83 ;
if ( V_72 ) {
if ( V_72 -> V_84 ) {
