...
static int F_30 ( struct V_1 * V_2 , void * V_27 , struct V_21 * V_28 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
if ( F_43 ( V_35 , ( char * ) V_24 , V_36 ) ) {
F_32 ( L_14 , V_55 , __LINE__ ) ;
return - V_56 ;
}
return 0 ;
}
...
int F_47 ( struct V_1 * V_2 , struct V_21 * V_168 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
V_168 -> V_169 = NULL ;
...
V_9 = F_50 ( V_4 -> V_174 . V_175 , false ) ;
if ( V_9 ) {
F_51 ( V_4 , V_173 ) ;
F_8 ( V_171 ) ;
return V_9 ;
}
V_173 -> V_176 = F_52 ( V_4 , V_173 ,
V_4 -> V_174 . V_175 ) ;
V_9 = F_53 ( V_4 , V_173 -> V_176 ,
V_177 ,
V_178 |
V_179 ) ;
if ( V_9 ) {
...
if ( ! V_9 ) {
if ( V_173 -> V_176 )
F_55 ( V_4 , V_173 -> V_176 ) ;
F_56 ( V_4 -> V_174 . V_175 ) ;
}
F_51 ( V_4 , V_173 ) ;
}
F_8 ( V_171 ) ;
...
T_3 F_60 ( struct V_1 * V_2 , int V_39 )
{
...
if ( V_4 -> V_33 . V_58 [ V_39 ] ) {
do {
V_183 = F_61 ( V_4 , V_39 ) ;
V_182 = F_62 (
V_2 , V_39 , V_184 ,
& V_180 , & V_181 , NULL , NULL ,
& V_4 -> V_33 . V_58 [ V_39 ] -> V_59 . V_185 ) ;
} while ( V_183 != F_61 ( V_4 , V_39 ) );
...
int F_64 ( struct V_1 * V_2 , int V_39 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_188 ;
int V_9 ;
...
F_65 ( & V_4 -> V_189 . V_190 , V_188 ) ;
V_4 -> V_189 . V_191 [ V_39 ] = true ;
V_9 = F_66 ( V_4 ) ;
F_67 ( & V_4 -> V_189 . V_190 , V_188 ) ;
return V_9 ;
}
void F_68 ( struct V_1 * V_2 , int V_39 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_188 ;
if ( V_39 < 0 || V_39 >= V_4 -> V_57 ) {
...
F_65 ( & V_4 -> V_189 . V_190 , V_188 ) ;
V_4 -> V_189 . V_191 [ V_39 ] = false ;
F_66 ( V_4 ) ;
F_67 ( & V_4 -> V_189 . V_190 , V_188 ) ;
}
int F_69 ( struct V_1 * V_2 , int V_39 ,
int * V_192 ,
struct V_193 * V_194 ,
unsigned V_8 )
{
struct V_38 * V_195 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_39 < 0 || V_39 >= V_2 -> V_196 ) {
F_32 ( L_15 , V_39 ) ;
return - V_63 ;
}
V_195 = & V_4 -> V_33 . V_58 [ V_39 ] -> V_59 ;
if ( ! V_195 )
return - V_63 ;
return F_70 ( V_2 , V_39 , V_192 ,
V_194 , V_8 ,
& V_195 -> V_185 ) ;
}
