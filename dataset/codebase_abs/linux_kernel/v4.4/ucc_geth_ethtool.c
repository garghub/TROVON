...
static void F_25 ( struct V_1 * V_2 , struct V_91 * V_92 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
if ( V_8 && V_8 -> V_93 )
...
static int F_27 ( struct V_1 * V_2 , struct V_91 * V_92 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
if ( V_92 -> V_97 & ~ ( V_95 | V_96 ) )
return - V_55 ;
else if ( V_92 -> V_97 & V_95 && ( ! V_8 || ! V_8 -> V_93 ) )
return - V_55 ;
else if ( V_92 -> V_97 & V_96 && ! F_26 () )
return - V_55 ;
V_6 -> V_98 = V_92 -> V_97 ;
F_28 ( & V_2 -> V_99 , V_6 -> V_98 ) ;
return 0 ;
}
