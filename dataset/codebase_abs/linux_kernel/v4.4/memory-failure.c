...
F_116 ( V_1 ) ;
F_88 ( V_1 ) ;
if ( V_135 && ! ( V_20 == F_145 ( 0 ) && F_82 ( V_2 ) == 1 ) )
F_88 ( V_1 ) ;
return 0 ;
}
static struct V_1 * F_146 ( struct V_1 * V_2 , unsigned long V_139 , int * * V_140 )
{
int V_141 = F_25 ( V_2 ) ;
if ( F_76 ( V_2 ) )
return F_147 ( F_148 ( F_15 ( V_2 ) ) ,
V_141 ) ;
else
return F_149 ( V_141 , V_142 , 0 ) ;
}
static int F_150 ( struct V_1 * V_2 , unsigned long V_20 , int V_21 )
{
int V_24 ;
if ( V_21 & V_109 )
return 1 ;
...
static int F_151 ( struct V_1 * V_1 , unsigned long V_20 , int V_21 )
{
int V_24 = F_150 ( V_1 , V_20 , V_21 ) ;
if ( V_24 == 1 && ! F_76 ( V_1 ) && ! F_20 ( V_1 ) ) {
F_88 ( V_1 ) ;
F_18 ( V_1 , 1 ) ;
V_24 = F_150 ( V_1 , V_20 , 0 ) ;
if ( ! F_20 ( V_1 ) ) {
F_88 ( V_1 ) ;
F_29 ( L_35 ,
V_20 , V_1 -> V_21 ) ;
...
F_116 ( V_80 ) ;
V_24 = F_153 ( V_80 , & V_144 ) ;
F_88 ( V_80 ) ;
if ( ! V_24 ) {
F_29 ( L_37 , V_20 ) ;
return - V_90 ;
}
V_24 = F_154 ( & V_144 , F_146 , NULL , V_145 ,
V_146 , V_147 ) ;
if ( V_24 ) {
F_29 ( L_38 ,
V_20 , V_24 , V_1 -> V_21 ) ;
...
static int F_157 ( struct V_1 * V_1 , int V_21 )
{
int V_24 ;
unsigned long V_20 = F_30 ( V_1 ) ;
F_112 ( V_1 ) ;
