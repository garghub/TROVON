...
struct V_299 * V_300 ;
struct V_5 * V_6 = NULL ;
struct V_301 * V_302 = V_294 -> V_302 ;
while ( ! F_105 ( V_302 ) )
V_302 = V_302 -> V_303 ;
V_9 = F_106 ( V_302 -> V_304 -> V_303 -> V_9 , L_36 , 0 ) ;
if ( ! V_9 )
return NULL ;
V_300 = F_107 ( V_9 ) ;
if ( V_300 )
...
static int F_111 ( struct V_275 * V_8 )
{
int V_7 , V_19 ;
T_1 V_44 , * V_282 ;
struct V_293 * V_294 ;
...
V_278 -> V_281 ++ ;
V_282 = F_119 ( V_278 -> V_282 , V_278 -> V_281 * sizeof( * V_282 ) ,
V_187 ) ;
if ( ! V_282 ) {
V_278 -> V_281 -- ;
V_19 = - V_188 ;
...
static void F_120 ( struct V_275 * V_8 )
{
F_121 ( V_8 ) ;
}
...
V_15 -> V_219 = F_125 ( V_6 -> V_8 , V_316 , & V_15 -> V_318 , V_187 ) ;
if ( ! V_15 -> V_219 ) {
F_33 ( V_6 -> V_8 , L_37 ,
V_316 ) ;
return - V_188 ;
...
{
F_126 ( V_6 , & V_6 -> V_94 . V_15 ) ;
F_126 ( V_6 , & V_6 -> V_190 . V_15 ) ;
if ( V_6 -> V_99 & V_325 )
F_126 ( V_6 , & V_6 -> V_199 . V_15 ) ;
}
static int F_128 ( struct V_5 * V_6 )
{
int V_19 ;
F_70 ( & V_6 -> V_94 . V_101 ) ;
V_19 = F_124 ( V_6 , & V_6 -> V_94 . V_15 , V_326 ,
V_327 , V_36 ) ;
if ( V_19 )
goto V_328;
V_19 = F_124 ( V_6 , & V_6 -> V_190 . V_15 , V_329 ,
V_330 , V_192 ) ;
if ( V_19 )
goto V_331;
if ( ! ( V_6 -> V_99 & V_325 ) )
return 0 ;
V_19 = F_124 ( V_6 , & V_6 -> V_199 . V_15 , V_332 ,
V_333 , V_200 ) ;
if ( V_19 )
goto V_334;
return 0 ;
...
V_114 -> V_183 = F_131 ( V_6 -> V_8 , V_46 , V_187 ) ;
if ( ! V_114 -> V_183 ) {
F_33 ( V_6 -> V_8 , L_38 ) ;
return - V_188 ;
}
...
V_46 = F_133 ( V_46 , V_6 -> V_337 - V_184 ) ;
}
V_114 -> V_306 = 1 << V_46 ;
V_46 += V_184 ;
if ( V_46 < V_6 -> V_337 )
...
static int F_140 ( struct V_5 * V_6 , T_1 V_103 ,
unsigned int V_352 , unsigned int V_353 )
{
T_1 V_335 ;
F_141 ( V_103 , V_6 -> V_219 + V_352 ) ;
return F_142 ( V_6 -> V_219 + V_353 , V_335 , V_335 == V_103 ,
1 , V_25 ) ;
}
static void F_143 ( void * V_297 )
{
struct V_275 * V_8 = V_297 ;
F_144 ( V_8 ) ;
}
static void F_145 ( struct V_354 * V_130 , struct V_355 * V_356 )
{
T_9 V_357 ;
struct V_275 * V_8 = F_146 ( V_130 ) ;
struct V_5 * V_6 = F_147 ( V_8 ) ;
T_9 * V_114 = V_358 [ V_130 -> V_359 . V_360 ] ;
V_357 = ( ( ( T_4 ) V_356 -> V_361 ) << 32 ) | V_356 -> V_362 ;
V_357 &= V_363 << V_364 ;
F_148 ( V_357 , V_6 -> V_219 + V_114 [ 0 ] ) ;
F_141 ( V_356 -> V_297 , V_6 -> V_219 + V_114 [ 1 ] ) ;
F_141 ( V_365 , V_6 -> V_219 + V_114 [ 2 ] ) ;
}
static void F_149 ( struct V_5 * V_6 )
{
struct V_354 * V_130 ;
int V_19 , V_366 = V_367 ;
struct V_275 * V_8 = V_6 -> V_8 ;
F_148 ( 0 , V_6 -> V_219 + V_368 ) ;
F_148 ( 0 , V_6 -> V_219 + V_369 ) ;
if ( V_6 -> V_99 & V_325 )
F_148 ( 0 , V_6 -> V_219 + V_370 ) ;
else
V_366 -- ;
if ( ! ( V_6 -> V_99 & V_371 ) )
return;
V_19 = F_150 ( V_8 , V_366 , F_145 ) ;
if ( V_19 ) {
F_36 ( V_8 , L_42 ) ;
return;
}
F_151 (desc, dev) {
switch ( V_130 -> V_359 . V_360 ) {
case V_372 :
V_6 -> V_190 . V_15 . V_189 = V_130 -> V_189 ;
break;
case V_373 :
V_6 -> V_374 = V_130 -> V_189 ;
break;
case V_375 :
V_6 -> V_199 . V_15 . V_189 = V_130 -> V_189 ;
break;
default:
continue;
}
...
( V_388 << V_392 ) |
( V_388 << V_393 ) ;
F_141 ( V_335 , V_6 -> V_219 + V_394 ) ;
V_335 = V_395 | V_396 | V_397 ;
F_141 ( V_335 , V_6 -> V_219 + V_398 ) ;
F_148 ( V_6 -> V_182 . V_350 ,
V_6 -> V_219 + V_399 ) ;
F_141 ( V_6 -> V_182 . V_345 ,
V_6 -> V_219 + V_400 ) ;
F_148 ( V_6 -> V_94 . V_15 . V_319 , V_6 -> V_219 + V_401 ) ;
F_141 ( V_6 -> V_94 . V_15 . V_16 , V_6 -> V_219 + V_326 ) ;
F_141 ( V_6 -> V_94 . V_15 . V_17 , V_6 -> V_219 + V_327 ) ;
V_384 = V_402 ;
V_19 = F_140 ( V_6 , V_384 , V_382 ,
V_383 ) ;
if ( V_19 ) {
F_33 ( V_6 -> V_8 , L_55 ) ;
return V_19 ;
...
V_34 . V_37 = V_87 ;
F_35 ( V_6 , & V_34 ) ;
F_148 ( V_6 -> V_190 . V_15 . V_319 , V_6 -> V_219 + V_404 ) ;
F_141 ( V_6 -> V_190 . V_15 . V_16 , V_6 -> V_219 + V_329 ) ;
F_141 ( V_6 -> V_190 . V_15 . V_17 , V_6 -> V_219 + V_330 ) ;
V_384 |= V_405 ;
V_19 = F_140 ( V_6 , V_384 , V_382 ,
V_383 ) ;
if ( V_19 ) {
...
if ( V_6 -> V_99 & V_325 ) {
F_148 ( V_6 -> V_199 . V_15 . V_319 ,
V_6 -> V_219 + V_406 ) ;
F_141 ( V_6 -> V_199 . V_15 . V_16 ,
V_6 -> V_219 + V_332 ) ;
F_141 ( V_6 -> V_199 . V_15 . V_17 ,
V_6 -> V_219 + V_333 ) ;
V_384 |= V_407 ;
V_19 = F_140 ( V_6 , V_384 , V_382 ,
V_383 ) ;
...
V_335 = F_11 ( V_6 -> V_219 + V_409 ) ;
if ( ( V_335 & V_410 << V_411 ) == V_412 )
V_6 -> V_99 |= V_280 ;
if ( V_335 & V_413 )
V_6 -> V_99 |= V_414 ;
switch ( V_335 & V_415 << V_416 ) {
case V_417 :
V_6 -> V_99 |= V_418 | V_419 ;
break;
#ifdef F_43
case V_420 :
V_6 -> V_99 |= V_419 ;
...
if ( F_158 ( V_422 ) && V_335 & V_423 )
V_6 -> V_99 |= V_325 ;
if ( F_158 ( F_49 ) && V_335 & V_424 )
V_6 -> V_99 |= V_425 ;
if ( V_335 & V_426 )
V_6 -> V_99 |= V_100 ;
if ( V_335 & V_427 )
...
if ( V_335 & V_428 )
V_6 -> V_99 |= V_403 ;
V_408 = F_159 ( V_6 -> V_8 -> V_9 ) ;
if ( V_408 )
V_6 -> V_99 |= V_429 ;
if ( ! ! ( V_335 & V_430 ) != V_408 )
F_36 ( V_6 -> V_8 , L_61 ,
V_408 ? L_62 : L_63 ) ;
if ( V_335 & V_431 )
V_6 -> V_99 |= V_432 ;
...
if ( V_335 & V_434 )
V_6 -> V_99 |= V_264 ;
if ( ! ( V_335 & ( V_433 | V_434 ) ) ) {
F_33 ( V_6 -> V_8 , L_64 ) ;
return - V_285 ;
}
switch ( V_335 & V_435 << V_436 ) {
case V_437 :
V_6 -> V_257 = 40 ;
case V_438 :
break;
...
V_6 -> V_252 = V_335 & V_439 ? 16 : 8 ;
V_6 -> V_255 = V_335 & V_440 ? 16 : 8 ;
V_335 = F_11 ( V_6 -> V_219 + V_441 ) ;
if ( V_335 & ( V_442 | V_443 | V_444 ) ) {
F_33 ( V_6 -> V_8 , L_66 ) ;
return - V_285 ;
}
V_6 -> V_94 . V_15 . V_317 = F_133 ( ( T_1 ) V_445 ,
V_335 >> V_446 & V_447 ) ;
if ( ! V_6 -> V_94 . V_15 . V_317 ) {
F_33 ( V_6 -> V_8 , L_67 ) ;
return - V_285 ;
}
V_6 -> V_190 . V_15 . V_317 = F_133 ( ( T_1 ) V_448 ,
V_335 >> V_449 & V_450 ) ;
V_6 -> V_199 . V_15 . V_317 = F_133 ( ( T_1 ) V_451 ,
V_335 >> V_452 & V_453 ) ;
V_6 -> V_454 = V_335 >> V_455 & V_456 ;
V_6 -> V_337 = V_335 >> V_457 & V_458 ;
V_335 = F_11 ( V_6 -> V_219 + V_459 ) ;
V_6 -> V_190 . V_460 = V_335 >> V_461
& V_462 ;
if ( V_335 & V_463 )
V_269 |= V_464 | V_465 ;
if ( V_335 & V_466 )
V_269 |= V_467 | V_468 ;
if ( V_335 & V_469 )
V_269 |= V_470 | V_471 | V_472 ;
V_270 . V_269 &= V_269 ;
switch ( V_335 & V_473 << V_474 ) {
case V_475 :
V_6 -> V_258 = 32 ;
break;
case V_476 :
...
if ( F_160 ( V_6 -> V_8 , F_161 ( V_6 -> V_258 ) ) )
F_36 ( V_6 -> V_8 ,
L_69 ) ;
V_6 -> V_257 = F_162 ( V_6 -> V_257 , V_6 -> V_258 ) ;
F_55 ( V_6 -> V_8 , L_70 ,
V_6 -> V_257 , V_6 -> V_258 , V_6 -> V_99 ) ;
return 0 ;
}
static int F_163 ( struct V_299 * V_294 )
{
int V_189 , V_19 ;
struct V_481 * V_482 ;
struct V_5 * V_6 ;
struct V_275 * V_8 = & V_294 -> V_8 ;
V_6 = F_131 ( V_8 , sizeof( * V_6 ) , V_187 ) ;
if ( ! V_6 ) {
F_33 ( V_8 , L_71 ) ;
return - V_188 ;
}
V_6 -> V_8 = V_8 ;
V_482 = F_164 ( V_294 , V_483 , 0 ) ;
if ( F_165 ( V_482 ) + 1 < V_484 ) {
F_33 ( V_8 , L_72 , V_482 ) ;
return - V_86 ;
}
V_6 -> V_219 = F_166 ( V_8 , V_482 ) ;
if ( F_115 ( V_6 -> V_219 ) )
return F_116 ( V_6 -> V_219 ) ;
V_189 = F_167 ( V_294 , L_73 ) ;
if ( V_189 > 0 )
V_6 -> V_190 . V_15 . V_189 = V_189 ;
V_189 = F_167 ( V_294 , L_74 ) ;
if ( V_189 > 0 )
V_6 -> V_199 . V_15 . V_189 = V_189 ;
V_189 = F_167 ( V_294 , L_75 ) ;
if ( V_189 > 0 )
V_6 -> V_94 . V_15 . V_189 = V_189 ;
V_189 = F_167 ( V_294 , L_76 ) ;
if ( V_189 > 0 )
V_6 -> V_374 = V_189 ;
F_3 ( V_6 ) ;
V_19 = F_157 ( V_6 ) ;
...
static int F_169 ( struct V_299 * V_294 )
{
struct V_5 * V_6 = F_108 ( V_294 ) ;
F_61 ( V_6 ) ;
F_139 ( V_6 ) ;
return 0 ;
}
