...
F_85 ( V_60 , NULL , V_140 , V_186 , 0 , V_147 , V_137 ) ;
F_98 ( V_140 , V_147 & V_167 , 0 ) ;
return 0 ;
}
static int F_99 ( struct V_182 * V_187 , struct V_188 * V_189 )
{
V_189 -> V_190 = 1 << 6 ;
V_189 -> V_191 = 1 << 5 ;
V_189 -> V_192 = F_100 ( V_187 -> V_184 ) >> 11 ;
return 0 ;
}
...
F_105 ( V_8 , V_60 -> V_194 -> V_195 ) ;
V_60 -> V_194 -> V_196 = & V_60 -> V_6 -> V_62 ;
V_60 -> V_194 -> V_197 = V_198 ;
V_60 -> V_194 -> V_199 = 0 ;
V_60 -> V_194 -> V_200 = & V_201 ;
V_60 -> V_194 -> V_185 = V_60 ;
V_60 -> V_194 -> V_202 = V_60 -> V_193 ;
V_60 -> V_194 -> V_59 = V_203 ;
F_106 ( V_60 -> V_193 , F_87 ) ;
F_107 ( V_60 -> V_193 , V_60 -> V_136 ) ;
F_108 ( V_60 -> V_193 , V_204 ) ;
F_109 ( V_60 -> V_193 , V_205 ) ;
F_110 ( V_206 , V_60 -> V_193 ) ;
V_60 -> V_193 -> V_172 = V_60 ;
F_111 ( V_60 -> V_194 , 0 ) ;
F_112 ( V_60 -> V_194 ) ;
if ( F_66 ( V_60 ) ) {
int V_207 = F_113 ( V_60 -> V_194 , F_66 ( V_60 ) ) ;
if ( V_207 ) {
F_114 ( V_60 -> V_194 ) ;
F_115 ( V_60 -> V_194 ) ;
F_104 ( V_60 -> V_193 ) ;
...
F_111 ( V_60 -> V_194 , V_60 -> V_119 * V_60 -> V_136 >> 9 ) ;
F_116 ( V_60 -> V_194 ) ;
return 0 ;
}
...
if ( V_60 -> V_115 != V_120 && V_158 -> V_209 ) {
F_28 ( V_62 , L_26 ,
F_23 ( & V_158 -> V_62 ) ) ;
goto V_208;
...
{
struct V_6 * V_6 = F_125 ( V_8 -> V_210 ) ;
struct V_158 * V_158 ;
struct V_60 * V_60 ;
T_2 V_109 ;
