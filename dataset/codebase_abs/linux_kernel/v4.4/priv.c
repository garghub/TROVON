...
if ( V_2 -> V_7 . V_8 -> V_9 . V_10 & V_11 )
return F_2 ( V_2 , V_12 ) ;
V_64 = * V_2 -> V_14 -> V_7 . V_66 . V_64 -> V_67 >> 32 ;
...
F_86 ( V_2 ) ;
V_151 = F_87 ( V_2 , V_147 , V_4 , & V_150 , 1 ) ;
if ( V_151 == V_156 ) {
V_152 = 1 ;
V_151 = F_87 ( V_2 , V_147 , V_4 , & V_150 , 0 ) ;
}
if ( V_151 ) {
if ( V_151 == V_19 || V_151 == V_157 ) {
V_151 = F_2 ( V_2 , V_151 ) ;
} else if ( V_151 > 0 ) {
F_8 ( V_2 , 3 ) ;
V_151 = 0 ;
...
return F_2 ( V_2 ,
V_13 ) ;
V_159 = V_2 -> V_34 -> V_35 . V_36 . V_37 [ 0 ] & 0x000000000000ffff ;
V_2 -> V_7 . V_8 -> V_160 = V_159 ;
return 0 ;
}
int F_92 ( struct V_1 * V_2 )
{
T_9 V_106 ;
V_106 = V_161 [ V_2 -> V_7 . V_8 -> V_62 & 0x00ff ] ;
if ( V_106 )
return V_106 ( V_2 ) ;
return - V_63 ;
}
