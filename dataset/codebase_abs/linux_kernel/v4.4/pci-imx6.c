...
int V_10 ;
if ( F_31 ( V_68 ) ) {
V_24 -> V_82 = F_36 ( V_81 , L_12 ) ;
if ( V_24 -> V_82 <= 0 ) {
F_15 ( & V_81 -> V_38 , L_13 ) ;
return - V_83 ;
}
V_10 = F_37 ( & V_81 -> V_38 , V_24 -> V_82 ,
F_26 ,
V_84 , L_14 , V_24 ) ;
if ( V_10 ) {
F_15 ( & V_81 -> V_38 , L_15 ) ;
...
static int T_4 F_39 ( struct V_80 * V_81 )
{
struct V_25 * V_25 ;
struct V_23 * V_24 ;
struct V_88 * V_89 = V_81 -> V_38 . V_90 ;
struct V_91 * V_1 ;
int V_10 ;
V_25 = F_40 ( & V_81 -> V_38 , sizeof( * V_25 ) , V_92 ) ;
if ( ! V_25 )
return - V_93 ;
V_24 = & V_25 -> V_24 ;
V_24 -> V_38 = & V_81 -> V_38 ;
F_41 ( 16 + 6 , F_8 , V_94 , 0 ,
L_17 ) ;
V_1 = F_42 ( V_81 , V_95 , 0 ) ;
V_24 -> V_1 = F_43 ( & V_81 -> V_38 , V_1 ) ;
if ( F_44 ( V_24 -> V_1 ) )
return F_45 ( V_24 -> V_1 ) ;
V_25 -> V_44 = F_46 ( V_89 , L_18 , 0 ) ;
if ( F_17 ( V_25 -> V_44 ) ) {
V_10 = F_47 ( & V_81 -> V_38 , V_25 -> V_44 ,
V_96 , L_19 ) ;
if ( V_10 ) {
F_15 ( & V_81 -> V_38 , L_20 ) ;
return V_10 ;
...
V_25 -> V_37 = F_48 ( & V_81 -> V_38 , L_21 ) ;
if ( F_44 ( V_25 -> V_37 ) ) {
F_15 ( & V_81 -> V_38 ,
L_22 ) ;
return F_45 ( V_25 -> V_37 ) ;
}
V_25 -> V_40 = F_48 ( & V_81 -> V_38 , L_23 ) ;
if ( F_44 ( V_25 -> V_40 ) ) {
F_15 ( & V_81 -> V_38 ,
L_24 ) ;
return F_45 ( V_25 -> V_40 ) ;
}
V_25 -> V_42 = F_48 ( & V_81 -> V_38 , L_25 ) ;
if ( F_44 ( V_25 -> V_42 ) ) {
F_15 ( & V_81 -> V_38 ,
L_26 ) ;
...
{
struct V_25 * V_25 = F_52 ( V_81 ) ;
F_9 ( & V_25 -> V_24 ) ;
}
static int T_4 F_53 ( void )
{
return F_54 ( & V_97 , F_39 ) ;
}
