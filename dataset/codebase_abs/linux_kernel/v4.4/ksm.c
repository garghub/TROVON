...
{
struct V_5 * V_5 ;
struct V_73 * V_74 , * V_42 ;
int V_50 ;
int V_68 = 0 ;
for ( V_50 = 0 ; V_50 < V_75 ; V_50 ++ ) {
while ( V_49 [ V_50 ] . V_76 ) {
V_5 = F_69 ( V_49 [ V_50 ] . V_76 ,
struct V_5 , V_48 ) ;
if ( F_64 ( V_5 ) ) {
V_68 = - V_72 ;
break;
...
F_70 (this, next, &migrate_nodes) {
V_5 = F_71 ( V_74 , struct V_5 , V_47 ) ;
if ( F_64 ( V_5 ) )
V_68 = - V_72 ;
F_21 () ;
}
...
static T_2 F_78 ( struct V_22 * V_22 )
{
T_2 V_85 ;
void * V_21 = F_79 ( V_22 ) ;
V_85 = F_80 ( V_21 , V_69 / 4 , 17 ) ;
F_81 ( V_21 ) ;
return V_85 ;
}
static int F_82 ( struct V_22 * V_86 , struct V_22 * V_87 )
{
char * V_88 , * V_89 ;
int V_23 ;
V_88 = F_79 ( V_86 ) ;
...
static inline int F_83 ( struct V_22 * V_86 , struct V_22 * V_87 )
{
return ! F_82 ( V_86 , V_87 ) ;
}
static int F_84 ( struct V_19 * V_20 , struct V_22 * V_22 ,
T_3 * V_90 )
{
...
V_96 = V_21 + V_69 ;
F_86 ( V_13 , V_95 , V_96 ) ;
V_91 = F_87 ( V_22 , V_13 , V_21 , & V_92 , 0 ) ;
if ( ! V_91 )
goto V_97;
if ( F_88 ( * V_91 ) || F_89 ( * V_91 ) ) {
T_3 V_98 ;
V_93 = F_52 ( V_22 ) ;
F_90 ( V_20 , V_21 , F_91 ( V_22 ) ) ;
V_98 = F_92 ( V_20 , V_21 , V_91 ) ;
if ( F_93 ( V_22 ) + 1 + V_93 != F_94 ( V_22 ) ) {
F_95 ( V_13 , V_21 , V_91 , V_98 ) ;
goto V_99;
}
if ( F_89 ( V_98 ) )
F_96 ( V_22 ) ;
V_98 = F_97 ( F_98 ( V_98 ) ) ;
F_99 ( V_13 , V_21 , V_91 , V_98 ) ;
}
* V_90 = * V_91 ;
V_68 = 0 ;
V_99:
F_100 ( V_91 , V_92 ) ;
V_97:
F_101 ( V_13 , V_95 , V_96 ) ;
V_3:
return V_68 ;
}
static int F_102 ( struct V_19 * V_20 , struct V_22 * V_22 ,
...
F_90 ( V_20 , V_21 , F_108 ( * V_91 ) ) ;
F_92 ( V_20 , V_21 , V_91 ) ;
F_99 ( V_13 , V_21 , V_91 , F_109 ( V_100 , V_20 -> V_102 ) ) ;
F_110 ( V_22 ) ;
if ( ! F_66 ( V_22 ) )
F_111 ( V_22 ) ;
F_26 ( V_22 ) ;
...
if ( ! F_116 ( V_22 ) )
goto V_3;
if ( F_84 ( V_20 , V_22 , & V_90 ) == 0 ) {
if ( ! V_100 ) {
F_67 ( V_22 , NULL ) ;
F_117 ( V_22 ) ;
V_68 = 0 ;
} else if ( F_83 ( V_22 , V_100 ) )
V_68 = F_102 ( V_20 , V_22 , V_100 , V_90 ) ;
}
if ( ( V_20 -> V_33 & V_104 ) && V_100 && ! V_68 ) {
F_118 ( V_22 ) ;
if ( ! F_119 ( V_100 ) ) {
F_55 ( V_22 ) ;
F_54 ( V_100 ) ;
...
int V_23 ;
F_21 () ;
V_5 = F_69 ( * V_109 , struct V_5 , V_48 ) ;
V_106 = F_47 ( V_5 , false ) ;
if ( ! V_106 ) {
goto V_55;
}
V_23 = F_82 ( V_22 , V_106 ) ;
F_26 ( V_106 ) ;
V_110 = * V_109 ;
if ( V_23 < 0 )
V_109 = & V_110 -> V_112 ;
...
return NULL ;
F_45 ( & V_111 -> V_47 ) ;
F_126 ( V_111 -> V_50 = V_50 ) ;
F_127 ( & V_111 -> V_48 , V_110 , V_109 ) ;
F_128 ( & V_111 -> V_48 , V_108 ) ;
F_106 ( V_22 ) ;
return V_22 ;
V_114:
if ( V_111 ) {
F_45 ( & V_111 -> V_47 ) ;
F_126 ( V_111 -> V_50 = V_50 ) ;
F_129 ( & V_5 -> V_48 , & V_111 -> V_48 , V_108 ) ;
F_106 ( V_22 ) ;
} else {
F_46 ( & V_5 -> V_48 , V_108 ) ;
V_22 = NULL ;
...
F_67 ( V_100 , V_5 ) ;
F_126 ( V_5 -> V_50 = V_50 ) ;
F_127 ( & V_5 -> V_48 , V_110 , V_109 ) ;
F_128 ( & V_5 -> V_48 , V_108 ) ;
return V_5 ;
}
static
...
int V_23 ;
F_21 () ;
V_105 = F_69 ( * V_109 , struct V_2 , V_48 ) ;
V_106 = F_37 ( V_105 ) ;
if ( ! V_106 )
return NULL ;
if ( V_22 == V_106 ) {
...
V_2 -> V_36 |= V_59 ;
V_2 -> V_36 |= ( V_61 . V_62 & V_116 ) ;
F_126 ( V_2 -> V_50 = V_50 ) ;
F_127 ( & V_2 -> V_48 , V_110 , V_109 ) ;
F_128 ( & V_2 -> V_48 , V_108 ) ;
V_64 ++ ;
return NULL ;
}
...
V_63 [ V_50 ] = V_118 ;
F_73 ( & V_77 ) ;
V_15 = F_71 ( V_15 -> V_79 . V_42 , struct V_8 , V_79 ) ;
V_61 . V_8 = V_15 ;
F_74 ( & V_77 ) ;
if ( V_15 == & V_78 )
return NULL ;
...
unsigned long V_67 , int V_129 , unsigned long * V_33 )
{
struct V_14 * V_13 = V_20 -> V_26 ;
int V_68 ;
switch ( V_129 ) {
case V_130 :
if ( * V_33 & ( V_34 | V_131 | V_132 |
V_133 | V_134 | V_135 |
V_136 | V_137 ) )
return 0 ;
#ifdef F_158
...
return V_22 ;
} else if ( V_35 -> V_108 == V_20 -> V_35 -> V_108 &&
V_22 -> V_144 == F_171 ( V_20 , V_36 ) ) {
return V_22 ;
}
if ( ! F_172 ( V_22 ) )
return V_22 ;
V_143 = F_173 ( V_145 , V_20 , V_36 ) ;
if ( V_143 ) {
F_174 ( V_143 , V_22 , V_36 , V_20 ) ;
F_175 ( V_143 ) ;
F_176 ( V_143 ) ;
F_177 ( V_143 ) ;
}
...
int F_178 ( struct V_22 * V_22 , struct V_146 * V_147 )
{
struct V_5 * V_5 ;
struct V_2 * V_2 ;
int V_23 = V_148 ;
...
V_2 -> V_36 >= V_20 -> V_82 )
continue;
if ( ( V_2 -> V_13 == V_20 -> V_26 ) == V_149 )
continue;
if ( V_147 -> V_152 && V_147 -> V_152 ( V_20 , V_147 -> V_153 ) )
continue;
V_23 = V_147 -> V_154 ( V_22 , V_20 ,
V_2 -> V_36 , V_147 -> V_153 ) ;
if ( V_23 != V_148 ) {
F_183 ( V_35 ) ;
goto V_3;
}
if ( V_147 -> V_155 && V_147 -> V_155 ( V_22 ) ) {
F_183 ( V_35 ) ;
goto V_3;
}
}
...
void F_184 ( struct V_22 * V_156 , struct V_22 * V_157 )
{
struct V_5 * V_5 ;
F_179 ( ! F_180 ( V_157 ) , V_157 ) ;
F_179 ( ! F_180 ( V_156 ) , V_156 ) ;
F_179 ( V_156 -> V_56 != V_157 -> V_56 , V_156 ) ;
V_5 = F_125 ( V_156 ) ;
if ( V_5 ) {
F_179 ( V_5 -> V_39 != F_91 ( V_157 ) , V_157 ) ;
V_5 -> V_39 = F_91 ( V_156 ) ;
F_185 () ;
F_67 ( V_157 , NULL ) ;
}
...
while ( V_122 & V_158 ) {
F_152 ( & V_125 ) ;
F_186 ( & V_122 , F_187 ( V_158 ) ,
V_159 ) ;
F_150 ( & V_125 ) ;
}
}
static void F_188 ( unsigned long V_160 ,
unsigned long V_161 )
{
struct V_5 * V_5 ;
struct V_73 * V_74 , * V_42 ;
...
int V_50 ;
for ( V_50 = 0 ; V_50 < V_75 ; V_50 ++ ) {
V_48 = F_189 ( V_49 + V_50 ) ;
while ( V_48 ) {
V_5 = F_69 ( V_48 , struct V_5 , V_48 ) ;
if ( V_5 -> V_39 >= V_160 &&
V_5 -> V_39 < V_161 ) {
F_43 ( V_5 ) ;
V_48 = F_189 ( V_49 + V_50 ) ;
...
static int F_191 ( struct V_162 * V_163 ,
...
static T_6 F_194 ( struct V_172 * V_173 ,
...
unsigned long V_178 ;
int V_68 ;
V_68 = F_196 ( V_176 , 10 , & V_178 ) ;
if ( V_68 || V_178 > V_179 )
return - V_180 ;
V_127 = V_178 ;
return V_177 ;
}
static T_6 F_197 ( struct V_172 * V_173 ,
struct V_174 * V_175 , char * V_176 )
{
return sprintf ( V_176 , L_1 , V_126 ) ;
}
static T_6 F_198 ( struct V_172 * V_173 ,
struct V_174 * V_175 ,
const char * V_176 , T_7 V_177 )
{
int V_68 ;
unsigned long V_169 ;
V_68 = F_196 ( V_176 , 10 , & V_169 ) ;
if ( V_68 || V_169 > V_179 )
return - V_180 ;
V_126 = V_169 ;
return V_177 ;
}
static T_6 F_199 ( struct V_172 * V_173 , struct V_174 * V_175 ,
char * V_176 )
{
return sprintf ( V_176 , L_2 , V_122 ) ;
}
static T_6 F_200 ( struct V_172 * V_173 , struct V_174 * V_175 ,
const char * V_176 , T_7 V_177 )
{
int V_68 ;
unsigned long V_84 ;
V_68 = F_196 ( V_176 , 10 , & V_84 ) ;
if ( V_68 || V_84 > V_179 )
return - V_180 ;
if ( V_84 > V_140 )
return - V_180 ;
...
static T_6 F_203 ( struct V_172 * V_173 ,
struct V_174 * V_175 , char * V_176 )
{
return sprintf ( V_176 , L_1 , V_40 ) ;
}
...
struct V_107 * V_176 ;
V_176 = F_205 ( V_184 + V_184 , sizeof( * V_176 ) ,
V_11 ) ;
if ( ! V_176 )
V_68 = - V_10 ;
else {
...
F_152 ( & V_125 ) ;
return V_68 ? V_68 : V_177 ;
}
static T_6 F_206 ( struct V_172 * V_173 ,
struct V_174 * V_175 , char * V_176 )
{
return sprintf ( V_176 , L_2 , V_44 ) ;
}
static T_6 F_207 ( struct V_172 * V_173 ,
struct V_174 * V_175 , char * V_176 )
{
return sprintf ( V_176 , L_2 , V_43 ) ;
}
static T_6 F_208 ( struct V_172 * V_173 ,
struct V_174 * V_175 , char * V_176 )
{
return sprintf ( V_176 , L_2 , V_64 ) ;
}
static T_6 F_209 ( struct V_172 * V_173 ,
struct V_174 * V_175 , char * V_176 )
{
long V_186 ;
V_186 = V_12 - V_44
...
static T_6 F_210 ( struct V_172 * V_173 ,
struct V_174 * V_175 , char * V_176 )
{
return sprintf ( V_176 , L_2 , V_61 . V_62 ) ;
}
