...
struct V_40 * F_76 ( struct V_3 * V_3 , struct V_40 * V_74 , V_13 V_23 )
{
struct V_43 V_22 ;
int V_124 ;
V_13 V_71 ;
...
return V_74 ;
V_124 = F_49 ( V_74 ) ;
if ( F_77 ( V_74 , V_124 , & V_22 , sizeof( V_22 ) ) < 0 )
return V_74 ;
...
return V_74 ;
if ( F_78 ( & V_22 ) ) {
V_74 = F_79 ( V_74 , V_106 ) ;
if ( V_74 ) {
if ( ! F_80 ( V_74 , V_124 + V_22 . V_79 * 4 ) )
return V_74 ;
...
static int T_4 F_82 ( struct V_3 * V_3 )
{
struct V_128 * V_129 ;
struct V_130 * V_131 ;
V_129 = V_132 ;
if ( ! F_83 ( V_3 , & V_133 ) ) {
V_129 = F_84 ( V_129 , sizeof( V_132 ) , V_134 ) ;
if ( ! V_129 )
goto V_135;
...
static void T_5 F_87 ( struct V_3 * V_3 )
{
struct V_128 * V_129 ;
...
static void T_5 F_93 ( struct V_3 * V_3 )
{
F_87 ( V_3 ) ;
F_94 ( & V_3 -> V_4 . V_5 , & V_10 ) ;
}
void T_6 F_95 ( void )
{
F_89 () ;
