...
V_10 ) ;
V_82 = 0 ;
V_2 = F_45 ( sizeof( struct V_1 ) , V_42 ) ;
if ( ! V_2 ) {
V_82 = 1 ;
goto V_88;
}
V_5 = F_45 ( sizeof( struct V_76 ) , V_42 ) ;
if ( ! V_5 ) {
V_82 = 2 ;
goto V_88;
}
V_6 = F_46 ( sizeof( struct V_77 ) , V_42 ) ;
if ( ! V_6 ) {
V_82 = 3 ;
goto V_88;
}
if ( F_47 ( V_6 , V_89 , V_90 ) ) {
F_7 ( & V_14 -> V_9 ,
L_33 , V_10 ) ;
V_82 = 4 ;
goto V_88;
...
F_8 ( & V_14 -> V_9 ,
L_40 ,
V_10 , V_9 -> V_103 -> V_104 , V_9 -> V_105 ) ;
V_101:
F_15 ( & V_2 -> V_19 ) ;
V_88:
switch ( V_82 ) {
