...
struct V_3 * V_145 = NULL ;
struct V_16 * V_20 = F_10 () ;
const struct V_1 * V_4 ;
T_1 V_83 ;
V_145 = F_88 ( V_20 -> V_146 ) ;
V_77 = V_143 -> V_147 ;
...
( int ) F_90 ( V_102 -> V_107 ) ;
V_143 -> V_155 = V_143 -> V_156 = V_143 -> V_157 =
( int ) F_91 ( V_102 -> V_106 ) ;
if ( V_143 -> V_77 & V_121 ) {
V_143 -> V_108 = V_158 ;
if ( V_84 -> V_108 )
...
F_90 ( V_102 -> V_107 ) ) ;
V_143 -> V_155 = ( int ) F_91 ( V_102 -> V_106 ) ;
if ( V_143 -> V_77 & V_121 ) {
if ( V_84 -> V_108 )
V_143 -> V_108 = V_84 -> V_108 ;
else
...
F_87 ( V_3 , V_62 , & V_166 -> V_168 [ V_32 ] ) ;
}
static bool F_93 ( struct V_16 * V_18 )
{
if ( V_18 -> V_62 != V_64 )
return false ;
...
static void F_100 ( struct V_3 * V_3 , unsigned int V_183 ,
struct V_184 * V_184 )
{
struct V_165 * V_166 ;
struct V_142 * V_143 ;
...
if ( F_101 ( V_143 -> V_132 != V_184 -> V_143 . V_132 ) )
return;
if ( V_143 -> V_163 )
return;
V_143 -> V_163 = true ;
...
struct V_165 * V_166 ;
struct V_184 * V_184 ;
F_105 (reg_beacon, &reg_beacon_list, list) {
if ( ! V_3 -> V_187 [ V_184 -> V_143 . V_188 ] )
continue;
V_166 = V_3 -> V_187 [ V_184 -> V_143 . V_188 ] ;
for ( V_32 = 0 ; V_32 < V_166 -> V_167 ; V_32 ++ )
...
static bool F_107 ( struct V_142 * V_143 )
{
if ( ! V_143 )
return false ;
if ( V_143 -> V_77 & V_150 )
return false ;
if ( ( V_143 -> V_77 & V_153 ) == V_153 )
return false ;
return true ;
}
...
static bool F_112 ( struct V_3 * V_3 , struct V_197 * V_198 )
{
struct V_199 V_200 ;
struct V_201 * V_202 = F_113 ( V_3 ) ;
enum V_203 V_204 ;
F_114 ( V_198 ) ;
V_204 = V_198 -> V_204 ;
if ( ! V_198 -> V_205 || ! F_115 ( V_198 -> V_205 ) )
goto V_206;
switch ( V_204 ) {
case V_207 :
case V_208 :
...
case V_208 :
case V_210 :
return F_119 ( V_3 , & V_200 , V_204 ) ;
case V_212 :
case V_213 :
return F_120 ( V_3 , & V_200 ,
V_150 ) ;
default:
break;
}
...
struct V_201 * V_202 = F_113 ( V_3 ) ;
F_18 () ;
F_105 (wdev, &rdev->wdev_list, list)
if ( ! F_112 ( V_3 , V_198 ) )
F_122 ( V_202 , V_198 ) ;
}
...
F_6 ( L_35 ) ;
F_34 () ;
F_105 (rdev, &cfg80211_rdev_list, list)
if ( ! ( V_202 -> V_3 . V_148 &
V_222 ) )
F_121 ( & V_202 -> V_3 ) ;
F_41 () ;
...
V_20 -> V_6 = F_1 () -> V_6 ;
for ( V_188 = 0 ; V_188 < V_195 ; V_188 ++ )
F_92 ( V_3 , V_62 , V_3 -> V_187 [ V_188 ] ) ;
F_106 ( V_3 ) ;
F_110 ( V_3 ) ;
F_111 ( V_3 , V_20 ) ;
}
static void F_127 ( enum V_139 V_62 )
{
struct V_201 * V_202 ;
struct V_3 * V_3 ;
F_18 () ;
...
static void F_128 ( struct V_3 * V_3 ,
struct V_142 * V_143 ,
const struct V_1 * V_4 )
{
T_1 V_144 = 0 ;
...
V_143 -> V_163 = false ;
if ( V_3 -> V_148 & V_180 )
V_143 -> V_77 = V_143 -> V_147 | V_144 |
F_78 ( V_84 -> V_77 ) ;
else
V_143 -> V_77 |= F_78 ( V_84 -> V_77 ) | V_144 ;
V_143 -> V_107 = ( int ) F_90 ( V_102 -> V_107 ) ;
...
return;
for ( V_32 = 0 ; V_32 < V_166 -> V_167 ; V_32 ++ )
F_128 ( V_3 , & V_166 -> V_168 [ V_32 ] , V_4 ) ;
}
...
F_29 ( ! ( V_3 -> V_148 & V_179 ) ,
L_37 ) ;
V_3 -> V_148 |= V_179 ;
for ( V_188 = 0 ; V_188 < V_195 ; V_188 ++ ) {
if ( ! V_3 -> V_187 [ V_188 ] )
continue;
F_129 ( V_3 , V_3 -> V_187 [ V_188 ] , V_4 ) ;
V_225 ++ ;
}
F_20 ( ! V_225 ) ;
}
...
if ( F_141 ( ! F_25 ( V_236 -> V_26 ) ) )
return - V_56 ;
if ( V_20 -> V_62 != V_63 )
return V_176 ;
V_237 = F_88 ( V_20 -> V_146 ) ;
if ( V_237 != V_3 ) {
if ( F_27 ( V_236 -> V_26 ) )
return V_174 ;
return V_175 ;
...
static enum V_171
F_142 ( struct V_3 * V_3 ,
struct V_16 * V_236 )
{
enum V_171 V_234 ;
V_234 = F_140 ( V_3 , V_236 ) ;
switch ( V_234 ) {
case V_176 :
break;
case V_174 :
...
static void F_143 ( struct V_16 * V_239 )
{
struct V_3 * V_3 = NULL ;
enum V_171 V_234 ;
if ( V_239 -> V_146 != V_240 )
V_3 = F_88 ( V_239 -> V_146 ) ;
switch ( V_239 -> V_62 ) {
case V_140 :
V_234 = F_134 ( V_239 ) ;
break;
...
if ( ! V_3 )
goto V_241;
V_234 = F_138 ( V_3 , V_239 ) ;
break;
case V_63 :
if ( ! V_3 )
goto V_241;
V_234 = F_142 ( V_3 , V_239 ) ;
break;
default:
...
F_148 ( & V_244 ) ;
F_149 (pending_beacon, tmp,
&reg_pending_beacons, list) {
F_146 ( & V_243 -> V_43 ) ;
F_105 (rdev, &cfg80211_rdev_list, list)
F_103 ( & V_202 -> V_3 , V_243 ) ;
...
static void F_155 ( struct V_16 * V_18 )
{
...
static int F_156 ( const char * V_26 )
{
struct V_16 * V_18 ;
...
int F_158 ( bool V_248 , T_1 V_249 )
{
F_132 ( & V_250 ) ;
V_251 = V_248 ;
if ( V_251 ) {
...
int F_160 ( struct V_3 * V_3 , const char * V_26 )
{
struct V_16 * V_18 ;
if ( F_20 ( ! V_26 || ! V_3 ) )
return - V_56 ;
...
void F_161 ( struct V_3 * V_3 , enum V_194 V_188 ,
const T_2 * V_253 , T_2 V_254 )
{
char V_26 [ 2 ] ;
...
static void F_164 ( char * V_26 , bool V_261 )
{
V_26 [ 0 ] = '9' ;
V_26 [ 1 ] = '7' ;
if ( F_28 () ) {
...
static void F_165 ( struct V_3 * V_3 )
{
struct V_165 * V_166 ;
enum V_194 V_188 ;
struct V_142 * V_143 ;
...
F_133 ( & V_227 ) ;
F_148 ( & V_244 ) ;
F_149 (reg_beacon, btmp, &reg_pending_beacons, list) {
F_38 ( & V_184 -> V_43 ) ;
F_13 ( V_184 ) ;
}
F_150 ( & V_244 ) ;
F_149 (reg_beacon, btmp, &reg_beacon_list, list) {
F_38 ( & V_184 -> V_43 ) ;
F_13 ( V_184 ) ;
}
V_263 [ 0 ] = V_23 -> V_26 [ 0 ] ;
V_263 [ 1 ] = V_23 -> V_26 [ 1 ] ;
F_105 (rdev, &cfg80211_rdev_list, list) {
if ( V_202 -> V_3 . V_148 & V_180 )
continue;
if ( V_202 -> V_3 . V_148 & V_179 )
F_165 ( & V_202 -> V_3 ) ;
}
F_156 ( V_263 ) ;
if ( F_25 ( V_26 ) )
...
static bool F_169 ( T_3 V_267 )
{
if ( V_267 == F_170 ( 12 , V_268 ) ||
V_267 == F_170 ( 13 , V_268 ) ||
V_267 == F_170 ( 14 , V_268 ) )
return true ;
return false ;
}
static bool F_171 ( struct V_142 * V_269 )
{
struct V_184 * V_243 ;
F_105 (pending_beacon, &reg_pending_beacons, list)
if ( V_269 -> V_132 ==
V_243 -> V_143 . V_132 )
return true ;
return false ;
}
int F_172 ( struct V_3 * V_3 ,
struct V_142 * V_269 ,
T_4 V_270 )
{
struct V_184 * V_184 ;
...
F_176 ( L_59 , F_4 ( V_25 -> V_6 ) ) ;
F_175 ( V_25 ) ;
}
static void F_181 ( const struct V_1 * V_25 )
{
F_176 ( L_60 , V_25 -> V_26 [ 0 ] , V_25 -> V_26 [ 1 ] ) ;
F_175 ( V_25 ) ;
}
...
F_149 (reg_request, tmp, &reg_requests_list, list) {
F_38 ( & V_239 -> V_43 ) ;
F_13 ( V_239 ) ;
}
}
