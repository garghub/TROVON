...
struct V_90 , V_91 ) ;
F_33 ( & V_3 -> V_87 -> V_91 ) ;
V_3 -> V_87 -> V_92 . V_93 . V_55 = V_94 ;
return F_34 ( & V_3 -> V_87 -> V_92 . V_93 , 0 ) ;
}
...
F_33 ( & V_3 -> V_87 -> V_91 ) ;
V_3 -> V_87 -> V_92 . V_93 . V_55 = V_94 ;
V_95 = F_34 ( & V_3 -> V_87 -> V_92 . V_93 , 0 ) ;
...
struct V_4 * V_5 = V_3 -> V_5 ;
unsigned long V_95 ;
V_95 = F_34 ( & V_3 -> V_86 -> V_92 . V_93 , 0 ) ;
V_95 += V_3 -> V_98 ;
V_3 -> V_96 -> V_97 ( V_5 , V_95 ) ;
}
...
{
struct V_43 * V_44 = & V_3 -> V_44 ;
F_39 ( & V_3 -> V_86 -> V_92 . V_99 ) ;
F_40 ( & V_3 -> V_86 -> V_92 . V_93 , V_100 ) ;
if ( V_44 -> V_55 == V_56 )
V_3 -> V_86 = V_3 -> V_87 ;
}
...
static int
F_74 ( struct V_167 * V_168 , const void * V_169 ,
...
{
struct V_179 * V_180 = F_83 ( V_92 ) ;
struct V_76 * V_102 = F_75 ( V_92 -> V_167 ) ;
struct V_2 * V_3 = V_102 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_43 * V_44 = & V_3 -> V_44 ;
struct V_90 * V_181 = F_43 ( V_180 ,
struct V_90 , V_92 ) ;
unsigned long V_66 ;
unsigned long V_182 ;
unsigned long V_95 ;
F_84 ( & V_3 -> V_183 , V_66 ) ;
V_182 = F_36 ( & V_3 -> V_88 ) ;
F_85 ( & V_181 -> V_91 , & V_3 -> V_88 ) ;
F_86 ( & V_3 -> V_183 , V_66 ) ;
if ( V_182 && V_3 -> V_61 && V_44 -> V_55 ==
V_57 &&
V_3 -> V_55 == V_184 ) {
F_87 ( & V_3 -> V_183 ) ;
V_95 = F_31 ( V_3 ) ;
...
static int F_90 ( struct V_167 * V_168 , unsigned int V_185 )
{
struct V_76 * V_102 = F_75 ( V_168 ) ;
struct V_2 * V_3 = V_102 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_33 = F_89 ( V_3 ) ;
if ( V_33 ) {
struct V_90 * V_181 , * V_188 ;
F_40 ( & V_3 -> V_86 -> V_92 . V_93 ,
V_189 ) ;
F_91 (buf, tmp, &video->dma_queue, list) {
F_33 ( & V_181 -> V_91 ) ;
F_40 ( & V_181 -> V_92 . V_93 ,
V_189 ) ;
}
goto V_144;
}
...
static void F_95 ( struct V_177 * V_92 )
{
struct V_179 * V_180 = F_83 ( V_92 ) ;
struct V_76 * V_102 = F_75 ( V_92 -> V_167 ) ;
struct V_2 * V_3 = V_102 -> V_3 ;
...
static int F_97 ( struct V_75 * V_75 , void * V_111 ,
struct V_191 * V_192 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_3 -> V_107 = F_98 ( V_5 -> V_17 ) ;
if ( F_99 ( V_3 -> V_107 ) ) {
F_59 ( & V_5 -> V_104 , L_39 ) ;
return F_100 ( V_3 -> V_107 ) ;
}
V_193 = & V_3 -> V_105 ;
...
V_193 -> V_96 = & V_200 ;
V_193 -> V_201 = & V_202 ;
V_193 -> V_203 = sizeof( struct V_90 ) ;
V_193 -> V_204 = V_205 ;
V_33 = F_101 ( V_193 ) ;
if ( V_33 ) {
F_59 ( & V_5 -> V_104 , L_40 ) ;
...
V_3 -> V_106 = 1 ;
F_93 ( & V_3 -> V_88 ) ;
V_33 = F_102 ( & V_3 -> V_105 , V_192 ) ;
V_144:
F_18 ( & V_3 -> V_81 ) ;
return V_33 ;
}
static int F_103 ( struct V_75 * V_75 , void * V_111 ,
struct V_206 * V_181 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_104 ( & V_3 -> V_105 , V_181 ) ;
}
static int F_105 ( struct V_75 * V_75 , void * V_111 ,
struct V_206 * V_208 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_106 ( & V_3 -> V_105 , V_208 ) ;
}
static int F_107 ( struct V_75 * V_75 , void * V_111 ,
struct V_206 * V_181 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_108 ( & V_3 -> V_105 ,
V_181 , ( V_75 -> V_210 & V_211 ) ) ;
}
static int F_109 ( struct V_75 * V_75 , void * V_111 ,
enum V_212 V_213 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_110 ( & V_3 -> V_105 , V_213 ) ;
}
static int F_111 ( struct V_75 * V_75 , void * V_111 ,
enum V_212 V_213 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_3 -> V_39 . V_220 = & V_221 ;
V_3 -> V_39 . V_222 = & V_223 ;
V_3 -> V_39 . V_224 = - 1 ;
V_3 -> V_39 . V_152 = 0 ;
...
{
int V_33 ;
V_3 -> V_39 . V_104 = V_227 ;
V_33 = F_118 ( & V_3 -> V_39 , V_228 , - 1 ) ;
if ( V_33 < 0 )
F_3 ( L_54 ,
V_229 , V_33 ) ;
return V_33 ;
