...
V_14 -> V_22 = V_22 ;
V_14 -> V_24 = V_24 ;
V_14 -> V_25 = F_15 ( V_16 ) . V_25 ;
V_14 -> V_26 = F_16 ( V_18 ) ;
V_14 -> V_27 = V_18 -> V_28 ;
}
static struct V_29 * F_17 ( struct V_13 * V_14 , int V_30 ,
T_1 V_31 )
{
struct V_29 * V_32 ;
V_32 = F_18 ( sizeof( struct V_29 ) + V_31 , V_33 ) ;
if ( V_32 == NULL )
return NULL ;
V_32 -> V_30 = V_30 ;
V_32 -> V_14 = * V_14 ;
...
unsigned int V_36 )
{
struct V_1 * V_1 = F_23 ( & V_35 -> V_37 ) ;
if ( V_35 -> V_38 & V_39 )
return 0 ;
return F_24 ( V_1 , V_35 -> V_40 , V_36 ) ;
}
...
{
struct V_29 * V_32 ;
V_32 = F_17 ( V_14 , V_30 , sizeof( struct V_43 ) ) ;
if ( V_32 == NULL )
return - V_44 ;
if ( V_30 == V_45 )
V_14 -> V_20 -> V_38 |= V_46 ;
F_30 ( & V_32 -> V_6 , & V_14 -> V_1 -> V_7 . V_47 ) ;
return 0 ;
}
...
static int F_32 ( struct V_13 * V_14 , int V_30 )
{
struct V_29 * V_32 ;
V_32 = F_17 ( V_14 , V_30 , sizeof( struct V_50 ) ) ;
if ( V_32 == NULL )
return - V_44 ;
if ( V_30 == V_51 )
V_14 -> V_22 -> V_38 |= V_52 ;
...
static struct V_29 * F_42 ( struct V_13 * V_14 , int V_30 ,
struct V_55 * V_56 )
{
struct V_29 * V_32 ;
V_32 = F_17 ( V_14 , V_30 , sizeof( struct V_59 ) ) ;
if ( V_32 == NULL )
return NULL ;
V_59 ( V_32 ) = V_56 ;
F_30 ( & V_32 -> V_6 , & V_14 -> V_1 -> V_7 . V_47 ) ;
...
{
struct V_29 * V_32 ;
V_32 = F_17 ( V_14 , V_30 , sizeof( struct V_63 ) ) ;
if ( V_32 == NULL )
return - V_44 ;
...
struct V_76 * V_77 ;
V_75 |= V_5 << 8 ;
V_18 = F_59 ( V_16 , V_25 , V_27 , V_75 , sizeof( struct V_76 ) , V_38 ) ;
if ( V_18 == NULL )
goto V_78;
V_77 = F_60 ( V_18 ) ;
V_77 -> V_79 = V_9 ;
...
if ( V_16 == NULL )
goto V_48;
V_48 = F_58 ( V_16 , V_14 -> V_1 , V_14 -> V_25 , V_14 -> V_27 ,
V_75 , 0 , V_14 -> V_3 -> V_9 , V_14 -> V_20 ) ;
if ( V_48 < 0 ) {
F_70 ( V_16 ) ;
goto V_48;
}
V_48 = F_71 ( V_16 , V_14 -> V_1 , V_14 -> V_25 , V_87 ,
V_14 -> V_26 , V_33 ) ;
V_48:
if ( V_48 < 0 ) {
F_72 ( V_14 -> V_1 , V_14 -> V_25 , V_87 ,
V_48 ) ;
}
return V_48 ;
}
...
if ( V_20 -> V_38 & V_46 )
return - V_58 ;
V_102 = F_84 ( V_89 , V_33 ) ;
if ( ! V_102 )
return - V_44 ;
V_48 = F_58 ( V_102 , V_1 , F_15 ( V_16 ) . V_25 ,
V_18 -> V_28 , V_45 , 0 ,
V_9 , V_20 ) ;
if ( V_48 < 0 )
goto V_48;
return F_85 ( V_101 , V_102 , F_15 ( V_16 ) . V_25 ) ;
V_48:
F_70 ( V_102 ) ;
return V_48 ;
}
...
static int F_91 ( struct V_1 * V_1 , struct V_100 * V_101 ,
...
if ( V_18 -> V_103 & V_112 )
return - V_113 ;
F_14 ( & V_14 , V_1 , V_16 , V_18 , V_3 , V_20 , NULL , V_24 ) ;
return F_88 ( & V_14 ) ;
}
if ( V_24 [ V_85 ] ) {
...
goto V_115;
V_48 = - V_44 ;
V_20 = F_18 ( sizeof( * V_20 ) , V_33 ) ;
if ( V_20 == NULL )
goto V_116;
F_93 ( V_20 -> V_68 , V_68 , V_117 ) ;
F_2 ( & V_20 -> V_118 ) ;
F_2 ( & V_20 -> V_119 ) ;
V_20 -> V_38 = V_38 ;
F_14 ( & V_14 , V_1 , V_16 , V_18 , V_3 , V_20 , NULL , V_24 ) ;
...
static int F_99 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_76 * V_77 = F_60 ( V_18 ) ;
...
int V_9 = V_77 -> V_79 ;
struct V_13 V_14 ;
F_14 ( & V_14 , V_1 , V_16 , V_18 , NULL , NULL , NULL , V_24 ) ;
...
{
F_101 ( V_14 -> V_20 -> V_54 > 0 ) ;
F_21 ( V_14 -> V_20 ) ;
F_94 ( V_14 -> V_3 -> V_114 ) ;
}
int F_102 ( const struct V_71 * V_128 )
{
int V_48 = 0 ;
F_3 ( V_5 ) ;
...
void F_103 ( const struct V_71 * V_128 )
{
F_3 ( V_5 ) ;
...
do {
V_27 = F_109 ( & V_133 -> V_139 ) ;
V_136 = V_133 -> V_136 ;
V_137 = V_133 -> V_137 ;
} while ( F_110 ( & V_133 -> V_139 , V_27 ) );
V_134 . V_136 += V_136 ;
V_134 . V_137 += V_137 ;
}
...
V_77 -> V_80 = V_81 ;
V_77 -> V_82 = F_61 ( V_1 -> V_7 . V_83 & 0xffff ) ;
if ( F_62 ( V_16 , V_144 , V_20 -> V_68 ) )
goto V_78;
if ( F_112 ( V_16 , V_145 , F_113 ( V_22 -> V_130 ) ) )
goto V_78;
if ( F_62 ( V_16 , V_146 , V_22 -> V_68 ) )
goto V_78;
if ( V_22 -> V_38 & V_42 ) {
...
if ( V_135 == NULL )
goto V_78;
if ( F_63 ( V_16 , V_149 , F_64 ( V_40 -> V_150 ) ) )
goto V_78;
if ( F_63 ( V_16 , V_151 , F_64 ( V_40 -> V_152 ) ) )
goto V_78;
if ( V_35 -> V_153 [ 0 ] &&
F_62 ( V_16 , V_154 , V_35 -> V_153 ) )
goto V_78;
F_114 ( V_16 , V_135 ) ;
if ( F_63 ( V_16 , V_155 ,
F_64 ( V_35 -> V_156 ) ) )
goto V_78;
if ( F_62 ( V_16 , V_157 , V_35 -> type -> V_68 ) )
goto V_78;
if ( F_106 ( V_16 , V_34 ( V_22 ) -> V_132 ) )
goto V_78;
}
if ( F_63 ( V_16 , V_158 , F_64 ( V_22 -> V_54 ) ) )
goto V_78;
F_65 ( V_16 , V_18 ) ;
return 0 ;
V_78:
...
static int F_116 ( const struct V_13 * V_14 , int V_75 )
{
struct V_15 * V_16 ;
int V_48 ;
if ( ! V_14 -> V_26 &&
...
if ( V_16 == NULL )
goto V_48;
V_48 = F_115 ( V_16 , V_14 -> V_1 , V_14 -> V_25 , V_14 -> V_27 ,
V_75 , 0 , V_14 -> V_3 -> V_9 , V_14 -> V_20 ,
V_14 -> V_22 ) ;
if ( V_48 < 0 ) {
F_70 ( V_16 ) ;
...
if ( ! V_102 )
return - V_44 ;
V_48 = F_115 ( V_102 , V_1 , F_15 ( V_16 ) . V_25 ,
V_18 -> V_28 , V_51 , 0 ,
V_9 , V_20 , V_22 ) ;
if ( V_48 < 0 )
goto V_48;
...
struct V_131 * V_132 ;
int V_48 ;
V_48 = F_120 ( V_160 , V_161 , V_159 , V_163 ) ;
if ( V_48 < 0 )
return F_13 ( V_48 ) ;
...
static void F_127 ( struct V_34 * V_22 ,
struct V_131 T_3 * V_162 )
{
if ( V_162 == NULL )
return;
...
F_94 ( V_35 -> type -> V_114 ) ;
F_131 ( V_35 -> V_132 ) ;
if ( V_35 -> V_40 [ 0 ] . V_165 != NULL )
F_133 ( V_35 -> V_40 [ 0 ] . V_165 ) ;
F_21 ( V_35 ) ;
} else {
F_21 ( V_22 ) ;
}
}
static int F_134 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_76 * V_77 = F_60 ( V_18 ) ;
...
F_14 ( & V_14 , V_1 , V_16 , V_18 , V_3 , V_20 , V_22 , V_24 ) ;
V_32 = F_17 ( & V_14 , V_51 ,
sizeof( struct V_50 ) ) ;
if ( V_32 == NULL ) {
F_131 ( V_132 ) ;
...
F_137 ( V_32 ) = - 1 ;
if ( V_24 [ V_145 ] && V_68 ) {
F_93 ( F_138 ( V_32 ) , V_68 ,
V_174 ) ;
}
F_30 ( & V_32 -> V_6 , & V_1 -> V_7 . V_47 ) ;
return 0 ;
}
if ( V_20 -> V_54 == V_175 )
return - V_176 ;
...
V_48 = F_120 ( V_167 , V_168 , V_24 [ V_148 ] ,
V_179 ) ;
if ( V_48 < 0 )
return V_48 ;
if ( V_167 [ V_149 ] == NULL ||
V_167 [ V_151 ] == NULL )
return - V_69 ;
V_150 = F_47 ( F_48 ( V_167 [ V_149 ] ) ) ;
if ( V_150 >= V_3 -> V_180 )
return - V_69 ;
V_152 = F_47 ( F_48 ( V_167 [ V_151 ] ) ) ;
...
V_22 = F_18 ( sizeof( * V_22 ) , V_33 ) ;
if ( V_22 == NULL )
return - V_44 ;
}
F_2 ( & V_22 -> V_190 ) ;
V_22 -> V_130 = F_53 ( V_20 ) ;
V_22 -> V_20 = V_20 ;
F_93 ( V_22 -> V_68 , V_68 , V_174 ) ;
V_48 = F_27 ( V_20 , V_22 , V_3 -> V_108 ) ;
if ( V_48 < 0 )
goto V_115;
F_14 ( & V_14 , V_1 , V_16 , V_18 , V_3 , V_20 , V_22 , V_24 ) ;
V_48 = F_32 ( & V_14 , V_51 ) ;
...
return 0 ;
V_116:
F_28 ( V_20 , V_22 , V_3 -> V_108 ) ;
V_115:
F_132 ( V_22 ) ;
return V_48 ;
}
static int F_141 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_76 * V_77 = F_60 ( V_18 ) ;
...
int V_48 ;
V_48 = F_120 ( V_160 , V_201 , V_24 , V_202 ) ;
if ( V_48 < 0 )
return V_48 ;
...
return F_83 ( type ) ;
if ( V_160 [ V_197 ] ) {
V_48 = F_120 ( V_199 -> V_160 , type -> V_203 ,
...
struct V_193 * V_194 ;
int V_48 ;
V_48 = F_149 ( V_14 , V_24 , & V_199 ) ;
if ( V_48 < 0 )
goto V_115;
V_48 = - V_44 ;
V_194 = F_18 ( V_199 . V_40 -> V_31 , V_33 ) ;
if ( V_194 == NULL )
goto V_116;
V_48 = F_150 ( V_14 , & V_199 , V_194 ) ;
if ( V_48 < 0 )
goto V_116;
return V_194 ;
V_116:
F_94 ( V_199 . V_40 -> type -> V_114 ) ;
V_115:
return F_13 ( V_48 ) ;
}
...
int type = V_75 | V_5 << 8 ;
V_18 = F_59 ( V_16 , V_25 , V_27 , type , sizeof( struct V_76 ) ,
V_38 ) ;
if ( V_18 == NULL )
goto V_78;
V_77 = F_60 ( V_18 ) ;
...
goto V_78;
if ( F_112 ( V_16 , V_211 , F_113 ( V_56 -> V_130 ) ) )
goto V_78;
if ( ( V_75 != V_60 ) && ( V_56 -> V_6 . V_212 != & V_22 -> V_190 ) ) {
V_208 = F_157 ( V_56 -> V_6 . V_212 , struct V_55 , V_6 ) ;
if ( F_112 ( V_16 , V_213 ,
F_113 ( V_208 -> V_130 ) ) )
goto V_78;
}
...
if ( V_16 == NULL )
goto V_48;
V_48 = F_156 ( V_16 , V_14 -> V_1 , V_14 -> V_25 , V_14 -> V_27 ,
V_75 , 0 , V_14 -> V_3 -> V_9 , V_14 -> V_20 ,
V_14 -> V_22 , V_56 ) ;
if ( V_48 < 0 ) {
F_70 ( V_16 ) ;
...
memset ( & V_91 -> args [ 1 ] , 0 ,
sizeof( V_91 -> args ) - sizeof( V_91 -> args [ 0 ] ) ) ;
if ( F_156 ( V_16 , V_1 , F_15 ( V_91 -> V_16 ) . V_25 ,
V_91 -> V_18 -> V_28 ,
V_219 ,
V_97 | V_220 ,
...
if ( V_22 -> V_38 & V_52 )
return - V_58 ;
V_56 = F_155 ( V_22 , V_24 [ V_211 ] ) ;
if ( F_82 ( V_56 ) )
return F_83 ( V_56 ) ;
V_102 = F_84 ( V_89 , V_33 ) ;
if ( ! V_102 )
return - V_44 ;
V_48 = F_156 ( V_102 , V_1 , F_15 ( V_16 ) . V_25 ,
V_18 -> V_28 , V_219 , 0 ,
V_9 , V_20 , V_22 , V_56 ) ;
if ( V_48 < 0 )
goto V_48;
...
struct V_193 * V_194 ;
V_194 = F_164 ( V_56 ) ;
while ( V_194 -> V_40 && V_194 != F_165 ( V_56 ) ) {
F_151 ( V_14 , V_194 ) ;
V_194 = F_166 ( V_194 ) ;
}
F_21 ( V_56 ) ;
}
static int F_167 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_76 * V_77 = F_60 ( V_18 ) ;
...
if ( V_223 == V_228 )
goto V_115;
V_48 = F_149 ( & V_14 , V_222 , & V_199 [ V_223 ] ) ;
if ( V_48 < 0 )
goto V_115;
...
V_48 = - V_44 ;
V_56 = F_18 ( sizeof( * V_56 ) + V_31 + V_225 , V_33 ) ;
if ( V_56 == NULL )
goto V_115;
F_38 ( V_1 , V_56 ) ;
V_56 -> V_130 = V_130 ;
...
V_48 = F_150 ( & V_14 , & V_199 [ V_72 ] , V_194 ) ;
if ( V_48 < 0 )
goto V_116;
...
F_94 ( V_199 [ V_72 ] . V_40 -> type -> V_114 ) ;
}
return V_48 ;
}
...
static int F_175 ( struct V_13 * V_14 , struct V_1 * V_1 ,
const struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
...
struct V_61 * F_176 ( const struct V_19 * V_20 ,
const struct V_23 * V_24 )
{
struct V_61 * V_62 ;
if ( V_24 == NULL )
...
struct V_61 * F_177 ( const struct V_1 * V_1 ,
const struct V_23 * V_24 )
{
struct V_29 * V_32 ;
...
static int F_178 ( struct V_13 * V_14 , struct V_61 * V_62 ,
const char * V_68 )
{
...
V_251 = F_179 ( V_68 , V_185 , '%' ) ;
if ( V_251 != NULL ) {
if ( V_251 [ 1 ] != 'd' || strchr ( V_251 + 2 , '%' ) )
return - V_69 ;
V_252 = ( unsigned long * ) F_180 ( V_33 ) ;
if ( V_252 == NULL )
return - V_44 ;
V_96:
...
T_1 V_27 = V_14 -> V_27 ;
V_75 |= V_5 << 8 ;
V_18 = F_59 ( V_16 , V_25 , V_27 , V_75 , sizeof( struct V_76 ) ,
V_38 ) ;
if ( V_18 == NULL )
goto V_78;
V_77 = F_60 ( V_18 ) ;
...
if ( V_62 -> V_265 &&
F_112 ( V_16 , V_266 , F_113 ( V_62 -> V_265 ) ) )
goto V_78;
if ( V_62 -> V_267 &&
F_63 ( V_16 , V_268 , F_64 ( V_62 -> V_267 ) ) )
goto V_78;
if ( V_62 -> V_156 != V_247 ) {
if ( F_63 ( V_16 , V_269 , F_64 ( V_62 -> V_156 ) ) )
goto V_78;
}
...
goto V_78;
if ( V_62 -> V_31 &&
F_63 ( V_16 , V_271 , F_64 ( V_62 -> V_31 ) ) )
goto V_78;
F_114 ( V_16 , V_234 ) ;
F_65 ( V_16 , V_18 ) ;
return 0 ;
...
if ( V_16 == NULL )
goto V_48;
V_48 = F_184 ( V_16 , V_14 , V_62 , V_75 , 0 ) ;
if ( V_48 < 0 ) {
F_70 ( V_16 ) ;
goto V_48;
}
V_48 = F_71 ( V_16 , V_14 -> V_1 , V_25 , V_87 ,
V_14 -> V_26 , V_272 ) ;
V_48:
if ( V_48 < 0 )
F_72 ( V_14 -> V_1 , V_25 , V_87 , V_48 ) ;
return V_48 ;
}
static int F_186 ( struct V_15 * V_16 , struct V_90 * V_91 )
{
const struct V_61 * V_62 ;
...
const struct V_76 * V_77 = F_60 ( V_18 ) ;
int V_48 ;
V_48 = F_175 ( & V_14 , V_1 , V_16 , V_18 , V_24 ) ;
if ( V_48 < 0 )
return V_48 ;
if ( V_18 -> V_103 & V_104 ) {
struct V_105 V_106 = {
...
if ( V_77 -> V_79 == V_95 )
return - V_12 ;
V_62 = F_176 ( V_14 . V_20 , V_24 [ V_257 ] ) ;
if ( F_82 ( V_62 ) )
return F_83 ( V_62 ) ;
if ( V_62 -> V_38 & V_66 )
return - V_58 ;
...
if ( V_102 == NULL )
return - V_44 ;
V_48 = F_184 ( V_102 , & V_14 , V_62 , V_64 , 0 ) ;
if ( V_48 < 0 )
goto V_48;
return F_85 ( V_101 , V_102 , F_15 ( V_16 ) . V_25 ) ;
V_48:
...
int V_48 ;
V_48 = F_120 ( V_277 , V_278 , V_24 , V_279 ) ;
if ( V_48 < 0 )
return V_48 ;
if ( V_277 [ V_271 ] != NULL )
V_234 -> V_31 = F_47 ( F_48 ( V_277 [ V_271 ] ) ) ;
return 0 ;
}
static int F_191 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_76 * V_77 = F_60 ( V_18 ) ;
...
V_156 = V_247 ;
if ( V_24 [ V_269 ] != NULL )
V_156 = F_47 ( F_48 ( V_24 [ V_269 ] ) ) ;
if ( V_24 [ V_270 ] != NULL ) {
V_48 = F_190 ( & V_14 , & V_234 , V_24 [ V_270 ] ) ;
if ( V_48 < 0 )
return V_48 ;
}
V_171 = V_18 -> V_103 & V_172 ? true : false ;
...
if ( ! ( V_18 -> V_103 & V_172 ) )
return - V_58 ;
V_40 = F_174 ( V_24 , & V_234 , V_156 ) ;
if ( F_82 ( V_40 ) )
return F_83 ( V_40 ) ;
V_31 = 0 ;
if ( V_40 -> V_287 != NULL )
V_31 = V_40 -> V_287 ( V_24 ) ;
V_48 = - V_44 ;
V_62 = F_18 ( sizeof( * V_62 ) + V_31 , V_33 ) ;
if ( V_62 == NULL )
goto V_115;
F_93 ( V_68 , V_24 [ V_257 ] , sizeof( V_62 -> V_68 ) ) ;
V_48 = F_178 ( & V_14 , V_62 , V_68 ) ;
if ( V_48 < 0 )
goto V_116;
F_2 ( & V_62 -> V_125 ) ;
F_140 ( & V_62 -> V_37 , V_1 ) ;
...
F_94 ( V_62 -> V_40 -> V_114 ) ;
F_21 ( V_62 ) ;
}
static void F_193 ( const struct V_13 * V_14 , struct V_61 * V_62 )
{
F_7 ( & V_62 -> V_6 ) ;
F_185 ( V_14 , V_62 , V_67 , V_288 ) ;
F_192 ( V_62 ) ;
}
static int F_194 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_76 * V_77 = F_60 ( V_18 ) ;
...
{
const struct V_293 * V_294 = F_196 ( V_62 , V_292 -> V_187 ) ;
enum V_295 V_296 ;
V_296 = F_197 ( V_62 -> V_263 ) ;
return F_198 ( V_14 , V_296 , F_199 ( V_294 ) ,
V_62 -> V_263 == V_285 ?
V_285 : V_280 ,
V_62 -> V_230 ) ;
}
int F_200 ( const struct V_13 * V_14 , struct V_61 * V_62 ,
struct V_297 * V_298 )
{
struct V_297 * V_72 ;
struct V_289 V_290 ;
if ( ! F_97 ( & V_62 -> V_125 ) && V_62 -> V_38 & V_124 )
return - V_129 ;
if ( V_298 -> V_38 & V_243 ) {
...
F_4 ( & V_298 -> V_6 , & V_62 -> V_125 ) ;
return 0 ;
}
void F_201 ( const struct V_13 * V_14 , struct V_61 * V_62 ,
struct V_297 * V_298 )
{
F_7 ( & V_298 -> V_6 ) ;
if ( F_97 ( & V_62 -> V_125 ) && V_62 -> V_38 & V_124 &&
...
static int F_202 ( struct V_13 * V_14 , struct V_1 * V_1 ,
const struct V_15 * V_16 ,
const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] ,
bool V_32 )
...
return F_203 ( args -> V_16 , V_62 , V_292 ) ;
}
static int F_217 ( struct V_15 * V_16 , struct V_90 * V_91 )
{
struct V_1 * V_1 = F_74 ( V_16 -> V_94 ) ;
const struct V_61 * V_62 ;
struct V_323 args ;
...
T_1 V_25 , V_27 ;
int V_75 , V_48 ;
V_48 = F_218 ( V_91 -> V_18 , sizeof( struct V_76 ) , V_24 ,
V_324 , V_325 ) ;
if ( V_48 < 0 )
return V_48 ;
V_48 = F_202 ( & V_14 , V_1 , V_91 -> V_16 , V_91 -> V_18 ,
( void * ) V_24 , false ) ;
if ( V_48 < 0 )
return V_48 ;
V_62 = F_176 ( V_14 . V_20 , V_24 [ V_326 ] ) ;
if ( F_82 ( V_62 ) )
return F_83 ( V_62 ) ;
if ( V_62 -> V_38 & V_66 )
return - V_58 ;
...
struct V_13 V_14 ;
int V_48 ;
V_48 = F_202 ( & V_14 , V_1 , V_16 , V_18 , V_24 , false ) ;
if ( V_48 < 0 )
return V_48 ;
V_62 = F_176 ( V_14 . V_20 , V_24 [ V_326 ] ) ;
if ( F_82 ( V_62 ) )
...
struct V_15 * V_16 ;
int V_48 ;
if ( ! V_14 -> V_26 && ! F_68 ( V_1 , V_87 ) )
return 0 ;
V_48 = - V_88 ;
V_16 = F_69 ( V_89 , V_33 ) ;
if ( V_16 == NULL )
goto V_48;
V_48 = F_220 ( V_16 , V_14 , 0 , V_25 , V_75 , V_38 ,
V_62 , V_292 ) ;
if ( V_48 < 0 ) {
F_70 ( V_16 ) ;
goto V_48;
}
V_48 = F_71 ( V_16 , V_1 , V_25 , V_87 , V_14 -> V_26 ,
V_33 ) ;
V_48:
if ( V_48 < 0 )
F_72 ( V_1 , V_25 , V_87 , V_48 ) ;
return V_48 ;
}
static struct V_29 * F_222 ( struct V_13 * V_14 ,
int V_30 ,
struct V_61 * V_62 )
{
struct V_29 * V_32 ;
V_32 = F_17 ( V_14 , V_30 , sizeof( struct V_329 ) ) ;
if ( V_32 == NULL )
return NULL ;
F_223 ( V_32 ) = V_62 ;
return V_32 ;
}
void * F_224 ( const struct V_61 * V_62 ,
...
struct V_293 * V_294 ;
void * V_292 ;
V_292 = F_18 ( V_62 -> V_40 -> V_334 + V_331 -> V_99 , V_333 ) ;
if ( V_292 == NULL )
return NULL ;
V_294 = F_196 ( V_62 , V_292 ) ;
F_225 ( V_294 , V_331 ) ;
memcpy ( F_206 ( V_294 ) , V_332 , V_62 -> V_261 ) ;
if ( F_207 ( V_294 , V_307 ) )
memcpy ( F_199 ( V_294 ) , V_196 , V_62 -> V_230 ) ;
if ( F_207 ( V_294 , V_315 ) )
* F_211 ( V_294 ) =
V_318 + F_226 ( V_265 ) ;
if ( F_207 ( V_294 , V_313 ) )
...
void F_227 ( const struct V_61 * V_62 , void * V_292 )
{
struct V_293 * V_294 = F_196 ( V_62 , V_292 ) ;
F_228 ( F_206 ( V_294 ) , V_280 ) ;
if ( F_207 ( V_294 , V_307 ) )
F_228 ( F_199 ( V_294 ) , V_62 -> V_263 ) ;
if ( F_207 ( V_294 , V_309 ) )
F_151 ( NULL , F_208 ( V_294 ) ) ;
F_21 ( V_292 ) ;
}
static int F_229 ( struct V_13 * V_14 , struct V_61 * V_62 ,
...
V_48 = F_232 ( V_14 , & V_292 . V_332 . V_342 , sizeof( V_292 . V_332 ) , & V_337 ,
V_24 [ V_306 ] ) ;
if ( V_48 < 0 )
goto V_115;
V_48 = - V_69 ;
if ( V_337 . type != V_280 || V_337 . V_99 != V_62 -> V_261 )
goto V_116;
...
if ( V_24 [ V_308 ] != NULL ) {
V_48 = F_232 ( V_14 , & V_196 , sizeof( V_196 ) , & V_338 ,
V_24 [ V_308 ] ) ;
if ( V_48 < 0 )
goto V_116;
V_48 = - V_69 ;
if ( V_62 -> V_263 != V_285 && V_338 . V_99 != V_62 -> V_230 )
goto V_120;
V_296 = F_197 ( V_62 -> V_263 ) ;
...
V_48 = - V_44 ;
V_292 . V_187 = F_224 ( V_62 , & V_331 , V_292 . V_332 . V_342 . V_196 , V_196 . V_196 ,
V_265 , V_33 ) ;
if ( V_292 . V_187 == NULL )
goto V_120;
V_294 = F_196 ( V_62 , V_292 . V_187 ) ;
if ( V_38 )
* F_209 ( V_294 ) = V_38 ;
if ( V_224 > 0 ) {
V_216 = F_214 ( V_294 ) ;
...
static int F_234 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_23 * V_159 ;
...
if ( V_24 [ V_328 ] == NULL )
return - V_69 ;
V_48 = F_202 ( & V_14 , V_1 , V_16 , V_18 , V_24 , true ) ;
if ( V_48 < 0 )
return V_48 ;
V_62 = F_176 ( V_14 . V_20 , V_24 [ V_326 ] ) ;
if ( F_82 ( V_62 ) ) {
...
if ( ! F_97 ( & V_62 -> V_125 ) && V_62 -> V_38 & V_283 )
return - V_129 ;
F_168 (attr, nla[NFTA_SET_ELEM_LIST_ELEMENTS], rem) {
if ( V_62 -> V_31 &&
! F_235 ( & V_62 -> V_350 , 1 , V_62 -> V_31 + V_62 -> V_351 ) )
return - V_256 ;
V_48 = F_229 ( & V_14 , V_62 , V_159 ) ;
if ( V_48 < 0 ) {
F_236 ( & V_62 -> V_350 ) ;
break;
}
...
static int F_237 ( struct V_13 * V_14 , struct V_61 * V_62 ,
const struct V_23 * V_159 )
{
struct V_23 * V_24 [ V_335 + 1 ] ;
struct V_336 V_234 ;
...
if ( V_24 [ V_306 ] == NULL )
goto V_115;
V_48 = F_232 ( V_14 , & V_292 . V_332 . V_342 , sizeof( V_292 . V_332 ) , & V_234 ,
V_24 [ V_306 ] ) ;
if ( V_48 < 0 )
goto V_115;
V_48 = - V_69 ;
if ( V_234 . type != V_280 || V_234 . V_99 != V_62 -> V_261 )
goto V_116;
V_32 = F_222 ( V_14 , V_352 , V_62 ) ;
if ( V_32 == NULL ) {
V_48 = - V_44 ;
goto V_116;
}
...
static int F_238 ( struct V_1 * V_1 , struct V_100 * V_101 ,
struct V_15 * V_16 , const struct V_17 * V_18 ,
const struct V_23 * const V_24 [] )
{
const struct V_23 * V_159 ;
...
F_227 ( V_357 -> V_358 . V_62 , V_357 -> V_360 [ V_72 ] ) ;
F_21 ( V_357 ) ;
}
struct V_356 * F_240 ( const struct V_61 * V_62 ,
T_7 V_333 )
{
struct V_356 * V_357 ;
V_357 = F_18 ( sizeof( * V_357 ) , V_333 ) ;
if ( V_357 == NULL )
return V_357 ;
...
V_18 = F_59 ( V_16 , V_25 , V_27 , V_75 , sizeof( struct V_76 ) , 0 ) ;
if ( V_18 == NULL )
goto V_78;
V_77 = F_60 ( V_18 ) ;
V_77 -> V_79 = V_127 ;
...
static int F_242 ( struct V_1 * V_1 , struct V_15 * V_16 , int V_75 )
{
...
return 0 ;
V_48 = - V_88 ;
V_102 = F_69 ( V_89 , V_33 ) ;
if ( V_102 == NULL )
goto V_48;
V_48 = F_241 ( V_102 , V_1 , F_15 ( V_16 ) . V_25 ,
V_18 -> V_28 ) ;
if ( V_48 < 0 ) {
F_70 ( V_102 ) ;
goto V_48;
}
V_48 = F_71 ( V_102 , V_1 , F_15 ( V_16 ) . V_25 ,
V_87 , F_16 ( V_18 ) , V_33 ) ;
V_48:
if ( V_48 < 0 ) {
F_72 ( V_1 , F_15 ( V_16 ) . V_25 , V_87 ,
V_48 ) ;
}
return V_48 ;
}
...
struct V_34 * V_35 ;
if ( F_138 ( V_32 ) [ 0 ] )
strcpy ( V_32 -> V_14 . V_22 -> V_68 , F_138 ( V_32 ) ) ;
if ( ! ( V_32 -> V_14 . V_22 -> V_38 & V_42 ) )
return;
V_35 = V_34 ( V_32 -> V_14 . V_22 ) ;
F_127 ( V_35 , F_135 ( V_32 ) ) ;
switch ( F_137 ( V_32 ) ) {
case V_173 :
case V_170 :
V_35 -> V_156 = F_137 ( V_32 ) ;
break;
}
}
...
break;
case V_53 :
F_132 ( V_32 -> V_14 . V_22 ) ;
break;
case V_60 :
F_163 ( & V_32 -> V_14 , V_59 ( V_32 ) ) ;
break;
case V_67 :
F_192 ( V_63 ( V_32 ) ) ;
break;
...
F_116 ( & V_32 -> V_14 , V_51 ) ;
F_19 ( V_32 ) ;
break;
case V_53 :
F_116 ( & V_32 -> V_14 , V_53 ) ;
F_28 ( V_32 -> V_14 . V_20 ,
V_32 -> V_14 . V_22 ,
V_32 -> V_14 . V_3 -> V_108 ) ;
break;
case V_219 :
F_40 ( V_32 -> V_14 . V_1 , V_59 ( V_32 ) ) ;
F_160 ( & V_32 -> V_14 ,
V_59 ( V_32 ) ,
V_219 ) ;
F_19 ( V_32 ) ;
...
! F_97 ( & V_63 ( V_32 ) -> V_125 ) )
V_32 -> V_14 . V_20 -> V_54 -- ;
F_185 ( & V_32 -> V_14 , V_63 ( V_32 ) ,
V_64 , V_33 ) ;
F_19 ( V_32 ) ;
break;
case V_67 :
...
break;
case V_327 :
V_363 = (struct V_329 * ) V_32 -> V_196 ;
V_363 -> V_62 -> V_40 -> V_365 ( V_363 -> V_62 , & V_363 -> V_292 ) ;
F_221 ( & V_32 -> V_14 , V_363 -> V_62 ,
& V_363 -> V_292 ,
V_327 , 0 ) ;
F_19 ( V_32 ) ;
break;
...
static void F_248 ( struct V_29 * V_32 )
{
switch ( V_32 -> V_30 ) {
case V_45 :
F_100 ( & V_32 -> V_14 ) ;
...
struct V_29 * V_32 , * V_207 ;
struct V_329 * V_363 ;
F_250 (trans, next, &net->nft.commit_list,
list) {
switch ( V_32 -> V_30 ) {
case V_45 :
if ( F_90 ( V_32 ) ) {
...
return F_63 ( V_16 , V_159 , F_64 ( V_375 ) ) ;
}
...
V_48 = F_254 ( V_14 , V_196 -> V_368 . V_22 ) ;
if ( V_48 < 0 )
return V_48 ;
...
struct V_21 * V_22 ;
int V_48 ;
V_48 = F_120 ( V_160 , V_388 , V_24 , V_389 ) ;
if ( V_48 < 0 )
return V_48 ;
if ( ! V_160 [ V_390 ] )
return - V_69 ;
V_196 -> V_368 . V_369 = F_47 ( F_48 ( V_160 [ V_390 ] ) ) ;
switch ( V_196 -> V_368 . V_369 ) {
default:
...
struct V_339 * V_196 , unsigned int V_31 ,
struct V_336 * V_234 , const struct V_23 * V_24 )
{
unsigned int V_99 ;
V_99 = F_56 ( V_24 ) ;
...
int V_48 ;
V_48 = F_120 ( V_160 , V_399 , V_24 , V_400 ) ;
if ( V_48 < 0 )
return V_48 ;
if ( V_160 [ V_398 ] )
return F_262 ( V_14 , V_196 , V_31 , V_234 ,
V_160 [ V_398 ] ) ;
...
switch ( type ) {
case V_280 :
V_48 = F_263 ( V_16 , V_196 , V_99 ) ;
break;
case V_285 :
V_48 = F_261 ( V_16 , V_196 ) ;
break;
default:
V_48 = - V_69 ;
F_264 ( 1 ) ;
