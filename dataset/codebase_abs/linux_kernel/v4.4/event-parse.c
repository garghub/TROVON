...
static void F_144 ( struct V_208 * V_209 , void * V_189 ,
int V_2 V_161 ,
struct V_52 * V_53 )
{
struct V_126 * V_71 ;
...
while ( V_71 ) {
F_122 ( V_209 , L_141 , V_71 -> V_72 ) ;
if ( V_71 -> V_74 & V_127 ) {
V_146 = V_71 -> V_146 ;
V_140 = V_71 -> V_2 ;
if ( V_71 -> V_74 & V_143 ) {
V_170 = F_100 ( V_53 -> V_14 , V_189 + V_146 , V_140 ) ;
V_146 = V_170 ;
V_140 = V_146 >> 16 ;
V_146 &= 0xffff ;
}
...
V_170 = F_100 ( V_53 -> V_14 , V_189 + V_71 -> V_146 ,
V_71 -> V_2 ) ;
if ( V_71 -> V_74 & V_133 ) {
F_122 ( V_209 , L_144 , V_170 ) ;
...
F_122 ( V_209 , L_146 , ( int ) V_170 ) ;
break;
case 2 :
F_122 ( V_209 , L_147 , ( short ) V_170 ) ;
break;
case 1 :
F_122 ( V_209 , L_148 , ( char ) V_170 ) ;
break;
default:
...
F_122 ( V_209 , L_149 , V_170 ) ;
}
}
V_71 = V_71 -> V_22 ;
}
}
static void F_145 ( struct V_208 * V_209 , void * V_189 , int V_2 , struct V_52 * V_53 )
{
struct V_14 * V_14 = V_53 -> V_14 ;
...
F_122 ( V_209 , L_146 , V_301 ) ;
}
if ( V_296 ) {
if ( V_300 < 0 )
F_126 ( V_209 , '.' ) ;
else
F_122 ( V_209 , L_146 , V_300 ) ;
}
F_127 ( V_209 ) ;
}
int F_147 ( struct V_14 * V_14 , struct V_292 * V_309 )
{
return F_107 ( V_14 , V_309 -> V_189 ) ;
}
struct V_52 * F_148 ( struct V_14 * V_14 , int type )
{
return F_113 ( V_14 , type ) ;
}
int F_149 ( struct V_14 * V_14 , struct V_292 * V_309 )
{
return F_108 ( V_14 , V_309 -> V_189 ) ;
}
const char * F_150 ( struct V_14 * V_14 , int V_13 )
{
const char * V_21 ;
V_21 = F_9 ( V_14 , V_13 ) ;
return V_21 ;
...
static struct V_10 *
F_151 ( struct V_14 * V_14 , const char * V_21 , struct V_10 * V_22 )
{
...
struct V_10 * F_152 ( struct V_14 * V_14 , const char * V_21 ,
struct V_10 * V_22 )
{
struct V_10 * V_10 ;
if ( ! V_14 -> V_18 )
return F_151 ( V_14 , V_21 , V_22 ) ;
if ( V_22 ) {
if ( V_22 < V_14 -> V_18 ||
...
int F_153 ( struct V_14 * V_14 , struct V_10 * V_10 )
{
...
void F_154 ( struct V_208 * V_209 , struct V_52 * V_53 ,
struct V_292 * V_293 )
{
int V_310 = 1 ;
if ( V_53 -> V_14 -> V_311 || ( V_53 -> V_74 & V_312 ) )
F_144 ( V_209 , V_293 -> V_189 , V_293 -> V_2 , V_53 ) ;
else {
...
static bool F_155 ( char * V_27 , bool V_316 )
{
if ( ! V_316 )
return true ;
...
void F_156 ( struct V_14 * V_14 , struct V_208 * V_209 ,
...
struct V_52 * * F_159 ( struct V_14 * V_14 , enum V_331 V_332 )
{
struct V_52 * * V_54 ;
int (* F_160)( const void * V_8 , const void * V_9 );
V_54 = V_14 -> V_333 ;
...
qsort ( V_54 , V_14 -> V_55 , sizeof( * V_54 ) , F_160 ) ;
V_14 -> V_137 = V_332 ;
return V_54 ;
}
static struct V_126 * *
F_161 ( const char * type , const char * V_72 ,
...
struct V_126 * * F_162 ( struct V_52 * V_53 )
{
return F_161 ( L_173 , V_53 -> V_72 ,
V_53 -> V_150 . V_152 ,
V_53 -> V_150 . V_151 ) ;
}
struct V_126 * * F_163 ( struct V_52 * V_53 )
{
return F_161 ( L_174 , V_53 -> V_72 ,
V_53 -> V_150 . V_153 ,
V_53 -> V_150 . V_129 ) ;
}
static void F_164 ( struct V_208 * V_209 , struct V_62 * V_71 )
{
F_122 ( V_209 , L_175 , V_71 -> V_64 , V_71 -> V_65 ) ;
if ( V_71 -> V_22 ) {
F_125 ( V_209 , L_143 ) ;
F_164 ( V_209 , V_71 -> V_22 ) ;
}
}
static void F_165 ( struct V_7 * args )
{
int V_337 = 1 ;
struct V_208 V_209 ;
switch ( args -> type ) {
...
case V_73 :
printf ( L_178 ) ;
F_165 ( args -> V_74 . V_71 ) ;
printf ( L_179 , args -> V_74 . V_75 ) ;
F_117 ( & V_209 ) ;
F_164 ( & V_209 , args -> V_74 . V_74 ) ;
F_166 ( & V_209 ) ;
F_119 ( & V_209 ) ;
printf ( L_69 ) ;
break;
case V_76 :
printf ( L_180 ) ;
F_165 ( args -> V_77 . V_71 ) ;
printf ( L_143 ) ;
F_117 ( & V_209 ) ;
F_164 ( & V_209 , args -> V_77 . V_78 ) ;
F_166 ( & V_209 ) ;
F_119 ( & V_209 ) ;
printf ( L_69 ) ;
break;
...
case V_81 :
printf ( L_182 ) ;
F_165 ( args -> V_82 . V_71 ) ;
printf ( L_143 ) ;
F_165 ( args -> V_82 . V_83 ) ;
printf ( L_143 ) ;
F_165 ( args -> V_82 . V_84 ) ;
printf ( L_69 ) ;
break;
case V_87 :
case V_88 :
...
if ( V_337 )
printf ( L_84 ) ;
F_165 ( args -> V_96 . V_97 ) ;
printf ( L_186 , args -> V_96 . V_96 ) ;
F_165 ( args -> V_96 . V_98 ) ;
if ( V_337 )
printf ( L_69 ) ;
break;
default:
...
static void F_167 ( const char * V_71 ,
...
int F_168 ( struct V_14 * V_14 , char * V_1 , unsigned long V_2 ,
int V_149 )
{
int V_340 ;
if ( ! V_2 ) {
...
F_1 ( V_1 , V_2 ) ;
F_167 ( L_187 , & V_14 -> V_345 ,
& V_14 -> V_341 , 1 ) ;
F_167 ( L_188 , & V_14 -> V_346 ,
& V_14 -> V_342 , 1 ) ;
F_167 ( L_189 , & V_14 -> V_347 ,
& V_340 , 0 ) ;
F_167 ( L_190 , & V_14 -> V_343 ,
& V_14 -> V_348 , 1 ) ;
return 0 ;
}
static int F_169 ( struct V_52 * V_53 ,
...
static void F_170 ( struct V_351 * V_352 )
{
free ( ( void * ) V_352 -> V_349 ) ;
free ( ( void * ) V_352 -> V_350 ) ;
free ( V_352 ) ;
}
static int F_171 ( struct V_14 * V_14 , struct V_52 * V_53 )
{
struct V_351 * V_352 , * * V_22 ;
for ( V_22 = & V_14 -> V_353 ; * V_22 ;
V_22 = & ( * V_22 ) -> V_22 ) {
V_352 = * V_22 ;
if ( F_169 ( V_53 , V_352 -> V_56 ,
V_352 -> V_349 ,
V_352 -> V_350 ) )
break;
}
...
enum V_354 F_173 ( struct V_52 * * V_355 ,
...
static enum V_354
F_174 ( struct V_14 * V_14 ,
struct V_52 * * V_355 ,
const char * V_1 , unsigned long V_2 ,
const char * V_203 )
{
int V_124 = F_173 ( V_355 , V_14 , V_1 , V_2 , V_203 ) ;
...
#define F_175 0
if ( F_175 && V_53 -> V_186 . args )
F_165 ( V_53 -> V_186 . args ) ;
return 0 ;
V_364:
F_176 ( V_53 ) ;
return V_124 ;
}
enum V_354 F_177 ( struct V_14 * V_14 ,
struct V_52 * * V_355 ,
const char * V_1 ,
unsigned long V_2 , const char * V_203 )
{
return F_174 ( V_14 , V_355 , V_1 , V_2 , V_203 ) ;
}
enum V_354 F_178 ( struct V_14 * V_14 , const char * V_1 ,
unsigned long V_2 , const char * V_203 )
{
struct V_52 * V_53 = NULL ;
return F_174 ( V_14 , & V_53 , V_1 , V_2 , V_203 ) ;
}
int F_179 ( struct V_14 * V_14 V_161 ,
enum V_354 V_365 , char * V_1 , T_2 V_366 )
{
int V_367 ;
const char * V_368 ;
if ( V_365 >= 0 ) {
V_368 = F_180 ( V_365 , V_1 , V_366 ) ;
if ( V_368 != V_1 ) {
T_2 V_140 = strlen ( V_368 ) ;
memcpy ( V_1 , V_368 , F_181 ( V_366 - 1 , V_140 ) ) ;
* ( V_1 + F_181 ( V_366 - 1 , V_140 ) ) = '\0' ;
}
return 0 ;
}
if ( V_365 <= V_369 ||
...
int F_182 ( struct V_208 * V_209 , struct V_126 * V_71 ,
...
void * F_183 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
int * V_140 , int V_185 )
{
struct V_126 * V_71 ;
...
int F_184 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
unsigned long long * V_170 , int V_185 )
{
struct V_126 * V_71 ;
...
return - 1 ;
V_71 = F_87 ( V_53 , V_72 ) ;
return F_182 ( V_209 , V_71 , V_72 , V_293 , V_170 , V_185 ) ;
}
...
int F_187 ( struct V_208 * V_209 , const char * V_50 ,
...
static struct V_52 * F_191 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 ,
const char * V_350 )
{
struct V_52 * V_53 ;
...
int F_192 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
struct V_52 * V_53 ;
struct V_351 * V_352 ;
V_53 = F_191 ( V_14 , V_56 , V_349 , V_350 ) ;
if ( V_53 == NULL )
goto V_381;
F_172 ( L_191 ,
V_53 -> V_56 , V_53 -> system , V_53 -> V_72 ) ;
...
static int F_193 ( struct V_351 * V_313 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
...
int F_194 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
struct V_52 * V_53 ;
...
V_352 = * V_22 ;
if ( F_193 ( V_352 , V_56 , V_349 , V_350 ,
V_35 , V_315 ) )
break;
}
if ( ! ( * V_22 ) )
...
static void F_198 ( struct V_126 * V_71 )
{
struct V_126 * V_22 ;
while ( V_71 ) {
V_22 = V_71 -> V_22 ;
...
static void F_199 ( struct V_150 * V_150 )
{
F_198 ( V_150 -> V_151 ) ;
F_198 ( V_150 -> V_129 ) ;
}
void F_176 ( struct V_52 * V_53 )
{
free ( V_53 -> V_72 ) ;
free ( V_53 -> system ) ;
F_199 ( & V_53 -> V_150 ) ;
