...
unsigned char * F_87 ( struct V_6 * V_7 , T_4 V_106 , T_5 * V_16 )
{
struct V_107 * V_108 = V_7 -> V_109 -> V_110 ;
struct V_111 * V_111 ;
V_111 = F_88 ( V_108 , ( V_112 ) ( V_106 >> ( V_113 - 9 ) ) ,
NULL ) ;
if ( ! F_76 ( V_111 ) ) {
if ( F_89 ( V_111 ) )
goto V_114;
V_16 -> V_115 = V_111 ;
return ( unsigned char * ) F_90 ( V_111 ) + ( ( V_106 & ( ( 1 << ( V_113 - 9 ) ) - 1 ) ) << 9 ) ;
V_114:
F_91 ( V_111 ) ;
}
V_16 -> V_115 = NULL ;
