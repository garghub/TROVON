...
{
const struct V_4 * V_6 = V_119 ;
struct V_13 * V_18 = F_48 ( V_96 ) ;
struct V_17 * V_21 ;
unsigned int V_124 , V_125 = * V_120 ;
V_21 = F_5 ( V_18 , V_96 -> type ) ;
V_124 = V_21 -> V_37 * V_21 -> V_38 * V_21 -> V_6 -> V_40 >> 3 ;
if ( V_6 ) {
if ( V_6 -> V_6 . V_11 . V_98 < V_124 )
return - V_44 ;
V_124 = V_6 -> V_6 . V_11 . V_98 ;
}
...
* V_120 = V_125 ;
V_122 [ 0 ] = V_124 ;
F_12 ( V_18 -> V_2 , L_12 , V_125 , V_124 ) ;
return 0 ;
}
static int F_49 ( struct V_127 * V_128 )
{
struct V_25 * V_129 = F_50 ( V_128 ) ;
struct V_13 * V_18 = F_48 ( V_128 -> V_95 ) ;
struct V_17 * V_21 ;
F_12 ( V_18 -> V_2 , L_13 , V_128 -> V_95 -> type ) ;
V_21 = F_5 ( V_18 , V_128 -> V_95 -> type ) ;
if ( F_51 ( V_128 -> V_95 -> type ) ) {
if ( V_129 -> V_51 == V_130 )
V_129 -> V_51 = V_97 ;
if ( V_129 -> V_51 != V_97 ) {
F_12 ( V_18 -> V_2 , L_14 ,
...
if ( F_10 ( V_128 , 0 ) < V_21 -> V_98 ) {
F_12 ( V_18 -> V_2 , L_15 ,
V_106 , F_10 ( V_128 , 0 ) , ( long ) V_21 -> V_98 ) ;
return - V_44 ;
}
F_52 ( V_128 , 0 , V_21 -> V_98 ) ;
return 0 ;
}
static void F_53 ( struct V_127 * V_128 )
{
struct V_25 * V_129 = F_50 ( V_128 ) ;
struct V_13 * V_18 = F_48 ( V_128 -> V_95 ) ;
F_54 ( V_18 -> V_16 . V_64 , V_129 ) ;
}
static int F_55 ( struct V_95 * V_131 , unsigned V_125 )
{
struct V_13 * V_18 = F_48 ( V_131 ) ;
struct V_17 * V_21 = F_5 ( V_18 , V_131 -> type ) ;
V_21 -> V_46 = 0 ;
return 0 ;
}
static void F_56 ( struct V_95 * V_131 )
{
struct V_13 * V_18 = F_48 ( V_131 ) ;
struct V_25 * V_129 ;
unsigned long V_48 ;
for (; ; ) {
if ( F_51 ( V_131 -> type ) )
V_129 = F_25 ( V_18 -> V_16 . V_64 ) ;
else
V_129 = F_26 ( V_18 -> V_16 . V_64 ) ;
if ( V_129 == NULL )
return;
...
static int F_57 ( void * V_63 , struct V_95 * V_133 , struct V_95 * V_134 )
{
struct V_13 * V_18 = V_63 ;
int V_108 ;
V_133 -> type = V_20 ;
V_133 -> V_135 = V_136 | V_137 | V_138 ;
V_133 -> V_139 = V_18 ;
V_133 -> V_140 = sizeof( struct V_141 ) ;
V_133 -> V_142 = & V_143 ;
V_133 -> V_144 = & V_145 ;
V_133 -> V_146 = V_147 ;
V_133 -> V_148 = & V_18 -> V_2 -> V_149 ;
V_108 = F_58 ( V_133 ) ;
if ( V_108 )
return V_108 ;
V_134 -> type = V_23 ;
V_134 -> V_135 = V_136 | V_137 | V_138 ;
V_134 -> V_139 = V_18 ;
V_134 -> V_140 = sizeof( struct V_141 ) ;
V_134 -> V_142 = & V_143 ;
V_134 -> V_144 = & V_145 ;
V_134 -> V_146 = V_147 ;
V_134 -> V_148 = & V_18 -> V_2 -> V_149 ;
return F_58 ( V_134 ) ;
}
...
V_112 = & V_18 -> V_112 ;
F_65 ( V_112 , 4 ) ;
F_66 ( V_112 , & V_156 , V_114 , 0 , 1 , 1 , 0 ) ;
F_66 ( V_112 , & V_156 , V_116 , 0 , 1 , 1 , 0 ) ;
F_67 ( V_112 , & V_157 , NULL ) ;
F_67 ( V_112 , & V_158 , NULL ) ;
if ( V_112 -> error ) {
V_151 = V_112 -> error ;
F_68 ( V_112 ) ;
goto V_155;
}
V_18 -> V_16 . V_159 = V_112 ;
F_69 ( V_112 ) ;
...
struct V_163 * V_164 ;
int V_108 ;
V_2 = F_84 ( & V_162 -> V_2 , sizeof( * V_2 ) , V_153 ) ;
if ( ! V_2 )
return - V_154 ;
F_85 ( & V_2 -> V_75 ) ;
V_108 = F_86 ( & V_162 -> V_2 , & V_2 -> V_42 ) ;
if ( V_108 )
return V_108 ;
F_87 ( & V_2 -> V_160 , 0 ) ;
F_88 ( & V_2 -> V_149 ) ;
V_2 -> V_164 = V_165 ;
V_164 = & V_2 -> V_164 ;
V_164 -> V_148 = & V_2 -> V_149 ;
V_164 -> V_42 = & V_2 -> V_42 ;
V_108 = F_89 ( V_164 , V_166 , 0 ) ;
if ( V_108 ) {
F_9 ( & V_2 -> V_42 , L_18 ) ;
goto V_167;
}
F_90 ( V_164 , V_2 ) ;
snprintf ( V_164 -> V_168 , sizeof( V_164 -> V_168 ) , L_19 , V_165 . V_168 ) ;
F_91 ( & V_2 -> V_42 ,
L_20 , V_164 -> V_90 ) ;
