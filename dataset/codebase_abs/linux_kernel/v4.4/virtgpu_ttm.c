...
static void F_41 ( struct V_40 * V_93 ,
struct V_44 * V_88 )
{
struct V_94 * V_41 ;
struct V_1 * V_6 ;
V_41 = F_2 ( V_93 , struct V_94 , V_93 ) ;
V_6 = (struct V_1 * ) V_41 -> V_95 . V_34 -> V_35 ;
if ( ! V_88 || ( V_88 -> V_59 & V_63 ) ) {
if ( V_41 -> V_96 )
F_42 ( V_6 ,
V_41 -> V_96 ) ;
} else if ( V_88 -> V_59 & V_97 ) {
if ( V_41 -> V_96 ) {
F_43 ( V_6 , V_41 , V_41 -> V_96 ,
NULL ) ;
}
}
}
static void F_44 ( struct V_40 * V_93 )
{
struct V_94 * V_41 ;
struct V_1 * V_6 ;
V_41 = F_2 ( V_93 , struct V_94 , V_93 ) ;
...
if ( V_11 )
return V_11 ;
V_11 = F_47 ( & V_6 -> V_5 . V_3 ,
V_6 -> V_5 . V_20 . V_8 . V_9 ,
& V_99 ,
V_6 -> V_100 -> V_101 -> V_102 ,
V_103 , 0 ) ;
if ( V_11 ) {
F_9 ( L_7 , V_11 ) ;
goto V_104;
}
V_11 = F_48 ( & V_6 -> V_5 . V_3 , V_55 , 0 ) ;
if ( V_11 ) {
F_9 ( L_8 ) ;
goto V_105;
}
