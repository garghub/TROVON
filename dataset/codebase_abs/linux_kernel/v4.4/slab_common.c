...
static inline int F_90 ( T_2 V_76 )
{
return ( V_76 - 1 ) / 8 ;
}
...
static void T_1 F_98 ( int V_65 , unsigned long V_15 )
{
V_83 [ V_65 ] = F_89 ( V_87 [ V_65 ] . V_6 ,
V_87 [ V_65 ] . V_7 , V_15 ) ;
}
...
void * F_101 ( T_2 V_7 , T_3 V_15 , unsigned int V_91 )
{
void * V_36 ;
struct V_92 * V_92 ;
V_15 |= V_93 ;
V_92 = F_102 ( V_15 , V_91 ) ;
V_36 = V_92 ? F_103 ( V_92 ) : NULL ;
F_104 ( V_36 , V_7 , 1 , V_15 ) ;
F_105 ( V_36 , V_7 ) ;
return V_36 ;
}
void * F_106 ( T_2 V_7 , T_3 V_15 , unsigned int V_91 )
{
void * V_36 = F_101 ( V_7 , V_15 , V_91 ) ;
F_107 ( V_94 , V_36 , V_7 , V_95 << V_91 , V_15 ) ;
return V_36 ;
}
static void F_108 ( struct V_96 * V_97 )
{
#ifdef F_109
F_110 ( V_97 , L_11 ) ;
#else
...
void * F_112 ( struct V_96 * V_97 , T_4 * V_98 )
{
F_27 ( & V_32 ) ;
return F_113 ( & V_49 , * V_98 ) ;
}
void * F_114 ( struct V_96 * V_97 , void * V_13 , T_4 * V_98 )
{
return F_115 ( V_13 , & V_49 , V_98 ) ;
}
void F_116 ( struct V_96 * V_97 , void * V_13 )
{
F_28 ( & V_32 ) ;
}
static void
F_117 ( struct V_3 * V_4 , struct V_99 * V_100 )
{
struct V_3 * V_68 ;
struct V_99 V_101 ;
if ( ! V_18 ( V_4 ) )
...
static void F_120 ( struct V_3 * V_4 , struct V_96 * V_97 )
{
struct V_99 V_101 ;
memset ( & V_101 , 0 , sizeof( V_101 ) ) ;
F_119 ( V_4 , & V_101 ) ;
...
static int F_123 ( struct V_96 * V_97 , void * V_13 )
{
...
int F_125 ( struct V_96 * V_97 , void * V_13 )
{
struct V_3 * V_4 = F_124 ( V_13 , struct V_3 , V_19 ) ;
struct V_21 * V_22 = F_126 ( F_127 ( V_97 ) ) ;
if ( V_13 == V_49 . V_112 )
F_108 ( V_97 ) ;
if ( ! V_18 ( V_4 ) && V_4 -> V_17 . V_22 == V_22 )
F_120 ( V_4 , V_97 ) ;
...
static int F_128 ( struct V_113 * V_113 , struct V_114 * V_114 )
{
return F_129 ( V_114 , & V_115 ) ;
}
static int T_1 F_130 ( void )
{
F_131 ( L_23 , V_116 , NULL ,
& V_117 ) ;
return 0 ;
}
static T_5 void * F_132 ( const void * V_13 , T_2 V_118 ,
T_3 V_15 )
{
void * V_36 ;
T_2 V_119 = 0 ;
...
V_119 = F_133 ( V_13 ) ;
if ( V_119 >= V_118 ) {
F_134 ( ( void * ) V_13 , V_118 ) ;
return ( void * ) V_13 ;
}
V_36 = F_135 ( V_118 , V_15 ) ;
if ( V_36 && V_13 )
memcpy ( V_36 , V_13 , V_119 ) ;
return V_36 ;
}
void * F_136 ( const void * V_13 , T_2 V_118 , T_3 V_15 )
{
if ( F_85 ( ! V_118 ) )
return V_79 ;
return F_132 ( V_13 , V_118 , V_15 ) ;
}
