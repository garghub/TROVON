...
static T_1 F_11 ( struct V_22 * V_23 , struct V_24 * V_24 )
{
struct V_7 * V_8 = V_23 -> V_25 ;
struct V_26 V_27 ;
struct V_28 V_29 ;
T_2 V_9 = V_24 -> V_30 . V_31 ;
F_12 (bvec, bio, iter) {
...
static int F_17 ( struct V_36 * V_37 , T_3 V_38 )
{
...
static void F_19 ( struct V_42 * V_43 , T_3 V_38 )
{
...
F_23 ( V_8 -> V_52 , V_8 -> V_16 >> V_14 ) ;
V_8 -> V_5 = V_5 ;
F_24 ( L_6 , V_8 -> V_52 -> V_53 , V_8 -> V_5 ) ;
V_48:
if ( V_44 )
F_25 ( V_5 ) ;
F_10 ( & V_8 -> V_17 ) ;
...
static T_4 F_28 ( struct V_55 * V_55 , char T_5 * V_56 ,
T_6 V_16 , T_7 * V_57 )
{
struct V_7 * V_8 = F_29 ( F_30 ( V_55 ) ) ;
const char * V_58 = V_8 -> V_5 ;
if ( V_58 ) {
T_4 V_59 = F_31 ( V_56 , V_16 , V_57 ,
V_58 , strlen ( V_58 ) ) ;
if ( V_59 < 0 )
return V_59 ;
V_56 += V_59 ;
...
return F_31 ( V_56 , V_16 , V_57 , L_9 , 1 ) ;
}
static T_4 F_32 ( struct V_55 * V_55 , const char T_5 * V_56 ,
T_6 V_60 , T_7 * V_57 )
{
char * V_61 = F_33 ( V_60 + 1 , V_45 ) ;
struct V_7 * V_8 = F_29 ( F_30 ( V_55 ) ) ;
int V_44 ;
if ( V_61 == NULL )
return - V_46 ;
if ( F_34 ( V_61 , V_56 , V_60 ) ) {
V_44 = - V_62 ;
goto V_63;
}
V_44 = F_26 ( V_8 ) ;
...
static int T_8 F_35 ( struct V_7 * V_8 , int V_64 ,
struct V_65 * V_66 )
{
...
F_23 ( V_8 -> V_52 , 0 ) ;
F_40 ( V_8 -> V_52 ) ;
V_8 -> V_76 = F_41 ( V_61 , 0644 , V_66 , & V_74 , V_8 ) ;
return 0 ;
V_70:
F_42 ( V_8 -> V_67 ) ;
V_8 -> V_67 = NULL ;
...
if ( V_78 > V_79 )
V_78 = V_79 ;
V_80 = F_33 ( V_78 * sizeof( struct V_7 ) ,
V_45 ) ;
if ( V_80 == NULL )
goto V_81;
V_82 = F_45 ( L_13 , 0 ) ;
...
if ( F_35 ( V_80 + V_77 , V_77 , V_82 ) == 0 ) {
if ( V_5 [ V_77 ] != NULL && V_5 [ V_77 ] [ 0 ] != 0 &&
( V_4 == 0 || V_77 < V_4 ) )
F_20 ( V_80 + V_77 , V_5 [ V_77 ] ) ;
}
}
return 0 ;
V_83:
...
static void F_47 ( struct V_7 * V_8 , int V_64 ,
struct V_65 * V_66 )
{
char V_61 [ 2 ] = { '0' + V_64 , 0 } ;
F_26 ( V_8 ) ;
