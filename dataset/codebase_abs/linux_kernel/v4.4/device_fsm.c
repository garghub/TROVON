...
static void
F_68 ( struct V_3 * V_4 , enum V_96 V_96 )
{
struct V_88 * V_88 ;
int V_138 ;
V_88 = F_69 ( & V_139 ) ;
V_138 = ! F_22 ( & V_88 -> V_42 ) ;
if ( ! F_70 ( & V_88 -> V_42 ) ) {
if ( V_138 && ( V_88 -> V_42 . V_24 . V_140 & V_141 ) &&
! V_88 -> V_142 . V_143 . V_144 . V_145 ) {
if ( F_71 ( V_4 , V_88 ) != 0 )
goto V_146;
...
F_72 ( V_4 , V_88 ) ;
if ( V_138 && V_4 -> V_9 -> V_30 . V_147 ) {
if ( F_71 ( V_4 , V_88 ) == 0 ) {
V_4 -> V_9 -> V_29 = V_129 ;
}
return;
}
if ( F_67 ( V_4 ) && V_4 -> V_9 -> V_30 . V_120 )
F_64 ( V_4 , 0 ) ;
}
static void
...
if ( F_77 ( & V_88 -> V_42 ) &
( V_151 | V_152 ) ) {
V_4 -> V_9 -> V_30 . V_147 = 0 ;
memset ( & V_4 -> V_9 -> V_88 , 0 , sizeof( struct V_88 ) ) ;
F_72 ( V_4 , V_88 ) ;
goto V_153;
}
F_78 ( V_4 , V_88 ) ;
if ( V_4 -> V_9 -> V_30 . V_147 ) {
F_71 ( V_4 , V_88 ) ;
return;
}
V_153:
