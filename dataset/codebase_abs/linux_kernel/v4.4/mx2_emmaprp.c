...
{
struct V_12 * V_13 = F_59 ( V_132 -> V_99 ) ;
struct V_11 * V_16 ;
F_5 ( V_13 -> V_23 , L_18 , V_132 -> V_99 -> type ) ;
V_16 = F_2 ( V_13 , V_132 -> V_99 -> type ) ;
if ( F_61 ( V_132 , 0 ) < V_16 -> V_105 ) {
F_5 ( V_13 -> V_23 , L_19
L_20 , V_117 ,
F_61 ( V_132 , 0 ) ,
( long ) V_16 -> V_105 ) ;
...
static int F_66 ( void * V_20 , struct V_99 * V_134 ,
struct V_99 * V_135 )
{
struct V_12 * V_13 = V_20 ;
int V_116 ;
...
static int F_68 ( struct V_78 * V_78 )
{
struct V_21 * V_22 = F_69 ( V_78 ) ;
struct V_12 * V_13 ;
...
static int F_77 ( struct V_78 * V_78 )
{
struct V_21 * V_22 = F_69 ( V_78 ) ;
struct V_12 * V_13 = V_78 -> V_150 ;
F_5 ( V_22 , L_22 , V_13 ) ;
F_8 ( & V_22 -> V_27 ) ;
F_78 ( V_22 -> V_153 ) ;
F_78 ( V_22 -> V_152 ) ;
...
static unsigned int F_80 ( struct V_78 * V_78 ,
struct V_154 * V_155 )
{
struct V_21 * V_22 = F_69 ( V_78 ) ;
struct V_12 * V_13 = V_78 -> V_150 ;
unsigned int V_156 ;
F_8 ( & V_22 -> V_27 ) ;
V_156 = F_81 ( V_78 , V_13 -> V_26 , V_155 ) ;
F_10 ( & V_22 -> V_27 ) ;
return V_156 ;
}
static int F_82 ( struct V_78 * V_78 , struct V_157 * V_158 )
{
struct V_21 * V_22 = F_69 ( V_78 ) ;
struct V_12 * V_13 = V_78 -> V_150 ;
int V_116 ;
if ( F_71 ( & V_22 -> V_27 ) )
return - V_151 ;
V_116 = F_83 ( V_78 , V_13 -> V_26 , V_158 ) ;
F_10 ( & V_22 -> V_27 ) ;
return V_116 ;
}
...
V_116 = F_90 ( & V_160 -> V_23 , & V_22 -> V_51 ) ;
if ( V_116 )
return V_116 ;
F_91 ( & V_22 -> V_27 ) ;
V_162 = F_92 () ;
...
F_93 ( V_162 , V_22 ) ;
snprintf ( V_162 -> V_95 , sizeof( V_162 -> V_95 ) , L_26 , V_167 . V_95 ) ;
V_22 -> V_162 = V_162 ;
F_94 ( & V_22 -> V_51 , V_169
L_27 , V_162 -> V_91 ) ;
F_95 ( V_160 , V_22 ) ;
V_164 = F_96 ( V_160 , 0 ) ;
V_116 = F_97 ( & V_160 -> V_23 , V_164 , F_21 , 0 ,
...
if ( F_74 ( V_22 -> V_131 ) ) {
F_17 ( & V_22 -> V_51 , L_28 ) ;
V_116 = F_75 ( V_22 -> V_131 ) ;
goto V_170;
}
V_22 -> V_25 = F_100 ( & V_171 ) ;
if ( F_74 ( V_22 -> V_25 ) ) {
F_17 ( & V_22 -> V_51 , L_29 ) ;
V_116 = F_75 ( V_22 -> V_25 ) ;
goto V_172;
}
V_116 = F_101 ( V_162 , V_173 , 0 ) ;
if ( V_116 ) {
F_17 ( & V_22 -> V_51 , L_30 ) ;
goto V_174;
}
