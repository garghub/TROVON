...
V_25 -> V_27 -> V_98 |= V_99 ;
if ( ! V_25 -> V_27 -> V_100 )
V_25 -> V_27 -> V_100 = F_44 ( V_2 -> V_94 ,
V_58 -> V_91 ) ;
F_4 ( V_101 ) ;
F_45 ( V_25 ) ;
return NULL ;
}
static int F_46 ( struct V_26 * V_27 , int V_102 )
{
...
V_105 = F_47 ( V_4 -> V_115 , V_27 -> V_30 , V_104 ) ;
if ( V_105 != V_116 ) {
F_3 ( L_12 ,
...
if ( V_4 -> V_118 )
return V_4 -> V_118 ( V_4 , V_27 -> V_30 , V_104 ) ;
V_105 = F_48 ( V_4 -> V_115 , V_27 -> V_30 , V_104 ) ;
if ( V_105 != V_116 ) {
F_3 ( L_13 ,
V_6 , V_105 , V_102 , V_4 -> V_2 -> V_94 ,
V_27 -> V_30 ) ;
return - V_117 ;
}
return 0 ;
...
T_9 V_105 ;
V_105 = F_51 ( V_4 -> V_115 , V_27 -> V_17 ,
V_119 ) ;
if ( V_105 != V_116 )
F_3 ( L_14 ,
...
static int F_59 ( struct V_26 * V_27 , int * V_142 )
{
int V_33 ;
if ( V_27 -> type & V_143 )
V_33 = F_52 ( V_27 ) ;
...
int F_64 ( struct V_1 * V_2 , int V_102 )
{
struct V_3 * V_4 = V_2 -> V_9 ;
T_9 V_105 = V_144 ;
F_65 ( L_18 ,
...
static int F_67 ( struct V_1 * V_2 , int V_102 )
{
struct V_3 * V_4 = V_2 -> V_9 ;
T_9 V_105 = V_144 ;
F_65 ( L_18 ,
...
static int F_68 ( struct V_157 * V_158 , int V_102 )
{
struct V_57 * V_58 = F_69 ( V_158 -> V_100 , V_158 -> V_92 ) ;
struct V_24 * V_25 = F_37 ( V_58 ) ;
int V_159 = V_25 ? V_25 -> V_80 : 0 ;
T_7 V_160 ;
F_65 ( L_19 ,
V_6 , F_70 ( V_158 -> V_100 ) ,
...
void F_71 ( struct V_157 * V_158 )
{
struct V_1 * V_2 ;
if ( F_72 ( V_158 -> V_100 ) ) {
V_2 = F_73 ( V_158 -> V_100 ) ;
F_67 ( V_2 , V_148 ) ;
F_67 ( V_2 , V_151 ) ;
} else {
F_68 ( V_158 , V_148 ) ;
...
static int F_74 ( struct V_26 * V_27 , int V_102 )
{
struct V_1 * V_2 = V_27 -> V_4 ;
struct V_169 * V_100 ;
int V_33 ;
...
V_33 = F_68 ( V_100 -> V_172 , V_102 ) ;
}
return V_33 ;
}
static int F_76 ( struct V_26 * V_27 , int V_173 )
{
int V_33 ;
int V_174 ;
while ( 1 ) {
V_33 = F_59 ( V_27 , & V_174 ) ;
if ( V_33 != V_140 )
return V_33 ;
if ( V_173 <= 0 ) {
F_3 ( L_22 ,
...
static int F_77 ( struct V_26 * V_27 , int V_175 ,
...
V_105 = F_81 ( V_4 -> V_115 , V_27 -> V_30 ,
type , V_29 , V_30 , V_31 ) ;
if ( V_105 != V_116 ) {
F_3 ( L_26
L_27 ,
...
if ( F_82 ( V_58 ) )
return V_188 ;
return F_85 ( V_58 , V_185 , V_186 , V_43 ) ;
}
static void F_86 ( struct V_189 * V_17 )
{
...
long V_105 ;
V_105 = F_90 ( V_4 -> V_202 , V_17 , sizeof( * V_17 ) ) ;
if ( V_105 != V_116 ) {
F_3 ( L_30 ,
V_6 , V_4 -> V_202 , V_105 ) ;
return;
...
F_87 ( L_32 ,
F_88 ( V_17 -> V_204 . V_205 ) ,
F_88 ( V_17 -> V_204 . V_206 ) ) ;
break;
case V_207 :
F_87 ( L_33 ,
V_17 -> V_208 . V_209 ? L_34 : L_35 ) ;
F_86 ( V_17 ) ;
if ( V_17 -> V_208 . V_210 || V_17 -> V_208 . V_211 ||
V_17 -> V_208 . V_212 || V_17 -> V_208 . V_213 )
F_87 ( L_36 ,
F_88 ( V_17 -> V_208 . V_210 ) ,
F_88 ( V_17 -> V_208 . V_211 ) ,
F_88 ( V_17 -> V_208 . V_212 ) ,
F_88 ( V_17 -> V_208 . V_213 ) ) ;
break;
case V_214 :
F_87 ( L_37 ,
V_17 -> V_215 . V_216 ) ;
...
F_87 ( L_38 ,
F_88 ( V_17 -> V_215 . V_217 ) ,
F_88 ( V_17 -> V_215 . V_218 ) ) ;
break;
case V_219 :
F_87 ( L_39 ) ;
F_86 ( V_17 ) ;
