...
int F_96 ( struct V_1 * V_2 , struct V_102 * V_103 ,
const char * V_104 )
{
...
struct V_1 * F_102 ( const struct V_32 * V_38 )
{
if ( V_38 -> V_19 )
return V_38 -> V_19 ;
else {
...
static int F_103 ( struct V_4 * V_38 , struct V_21 * V_2 )
{
struct V_32 * V_32 = F_34 ( V_38 ) ;
struct V_1 * V_46 ;
...
static int F_106 ( struct V_4 * V_38 , struct V_114 * V_115 )
{
struct V_32 * V_33 ;
if ( ! V_38 )
return - V_37 ;
V_33 = F_34 ( V_38 ) ;
if ( F_107 ( V_115 , L_9 , V_33 -> V_7 ) )
return - V_13 ;
if ( F_107 ( V_115 , L_10 , V_33 -> V_3 , V_33 -> V_4 ) )
return - V_13 ;
if ( F_107 ( V_115 , L_11 , V_33 -> V_34 ,
V_33 -> V_35 ) )
return - V_13 ;
if ( F_107 ( V_115 , L_12 , F_108 ( V_33 ) ) )
return - V_13 ;
if ( F_107 ( V_115 , L_13 ,
V_33 -> V_3 , V_33 -> V_4 ,
V_33 -> V_34 , V_33 -> V_35 ,
