...
static void F_34 ( struct V_6 * V_40 , struct V_6 * V_41 )
{
struct V_6 * V_42 , * V_43 ;
F_35 ( V_41 -> V_23 != V_40 || V_40 -> V_23 != V_41 ,
L_15 ,
...
static int F_36 ( struct V_14 * V_50 , void * V_51 )
{
int V_24 ;
...
struct V_52 * V_53 = F_37 ( V_15 -> V_56 ) ;
...
struct V_6 * V_7 ;
int V_26 ;
V_7 = F_41 ( sizeof( * V_7 ) , V_64 ) ;
if ( ! V_7 )
return - V_65 ;
V_7 -> V_13 = F_41 ( sizeof( * ( V_7 -> V_13 ) ) , V_64 ) ;
if ( ! V_7 -> V_13 ) {
F_4 ( V_7 ) ;
return - V_65 ;
}
...
if ( F_17 ( V_20 -> V_15 ) )
V_7 -> V_30 = 1 ;
F_42 ( & V_7 -> V_2 , L_16 , F_28 ( & V_20 -> V_15 -> V_2 ) ,
V_24 ) ;
F_43 ( & V_7 -> V_72 ) ;
V_26 = F_44 ( & V_7 -> V_2 ) ;
if ( V_26 ) {
