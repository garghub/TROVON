...
if ( V_129 != sizeof( T_2 ) )
goto V_148;
V_2 -> V_12 . V_183 = F_39 ( ( V_150 * ) V_133 ) ;
...
struct V_1 * F_67 ( struct V_288 * V_34 ,
const struct V_231 * V_24 )
{
struct V_1 * V_2 ;
int V_289 ;
...
V_2 -> V_34 -> V_240 = F_52 ( L_62 , V_2 -> V_244 ) ;
if ( ! V_2 -> V_34 -> V_240 ) {
F_11 ( V_2 , L_63 ) ;
V_289 = - V_20 ;
goto V_292;
