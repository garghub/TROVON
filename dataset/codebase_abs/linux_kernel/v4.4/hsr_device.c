...
{
return ( V_2 -> V_74 -> V_90 == F_32 ) ;
}
int F_64 ( struct V_1 * V_16 , struct V_1 * V_91 [ 2 ] ,
unsigned char V_92 )
{
struct V_18 * V_19 ;
struct V_8 * V_14 ;
...
F_65 ( & V_19 -> V_95 ) ;
F_65 ( & V_19 -> V_96 ) ;
F_48 ( V_16 -> V_59 , V_91 [ 0 ] -> V_59 ) ;
V_93 = F_66 ( & V_19 -> V_96 , V_16 -> V_59 ,
V_91 [ 1 ] -> V_59 ) ;
if ( V_93 < 0 )
return V_93 ;
F_67 ( & V_19 -> V_62 ) ;
...
F_48 ( V_19 -> V_58 , V_100 ) ;
V_19 -> V_58 [ V_101 - 1 ] = V_92 ;
F_14 ( V_16 ) ;
V_93 = F_69 ( V_19 , V_16 , V_15 ) ;
if ( V_93 )
return V_93 ;
V_93 = F_70 ( V_16 ) ;
if ( V_93 )
goto V_102;
V_93 = F_69 ( V_19 , V_91 [ 0 ] , V_32 ) ;
if ( V_93 )
goto V_102;
V_93 = F_69 ( V_19 , V_91 [ 1 ] , V_33 ) ;
if ( V_93 )
goto V_102;
V_19 -> V_71 . V_22 = V_23 + F_17 ( V_103 ) ;
F_18 ( & V_19 -> V_71 ) ;
return 0 ;
V_102:
F_11 (hsr, port)
