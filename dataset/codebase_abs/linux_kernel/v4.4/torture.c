...
bool F_71 ( char * V_74 , bool V_75 , int * V_76 )
{
F_28 ( & V_65 ) ;
if ( V_10 != NULL ) {
F_11 ( L_30 ,
...
int F_78 ( int (* F_79)( void * V_1 ) , void * V_1 , char * V_72 , char * V_79 ,
char * V_80 , struct V_34 * * V_35 )
{
int V_5 = 0 ;
F_3 ( V_79 ) ;
* V_35 = F_80 ( F_79 , V_1 , L_4 , V_72 ) ;
if ( F_81 ( * V_35 ) ) {
V_5 = F_82 ( * V_35 ) ;
F_48 ( V_80 ) ;
* V_35 = NULL ;
...
void F_83 ( char * V_79 , struct V_34 * * V_35 )
{
if ( * V_35 == NULL )
return;
F_3 ( V_79 ) ;
