...
if ( V_14 ) {
F_4 ( V_6 , L_42 , V_10 -> V_61 , V_14 ) ;
goto V_90;
}
V_10 -> V_44 = V_87 ;
V_10 -> V_95 = V_96 ;
F_45 ( V_6 , L_43 , V_10 -> V_61 ) ;
return 0 ;
V_90:
F_39 ( V_10 ) ;
F_12 ( V_10 ) ;
...
if ( V_10 -> V_127 < 0 ) {
F_4 ( V_6 , L_61 , V_10 -> V_127 ) ;
F_91 ( & V_10 -> V_6 ) ;
return NULL ;
}
F_92 ( & V_10 -> V_6 , L_62 , V_10 -> V_127 ) ;
F_93 ( & V_10 -> V_118 , 0 ) ;
V_10 -> V_134 = & V_135 ;
F_94 ( & V_10 -> V_109 ) ;
F_95 ( & V_10 -> V_43 ) ;
