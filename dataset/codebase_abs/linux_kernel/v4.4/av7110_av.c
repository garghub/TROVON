...
int F_18 ( struct V_15 * V_15 , int V_49 , int V_50 )
{
...
return 0 ;
case V_61 :
V_52 = ( V_49 > V_50 ) ? V_49 : V_50 ;
V_53 = ( V_52 * 0x73 / 255 ) << 8 ;
if ( V_52 > 0 )
V_54 = ( ( V_50 - V_49 ) * 127 ) / V_52 ;
F_21 ( V_15 , V_62 , 0x0001 , V_54 << 8 ) ;
F_21 ( V_15 , V_62 , 0x0000 , V_53 ) ;
F_21 ( V_15 , V_62 , 0x0006 , V_53 ) ;
return 0 ;
case V_63 :
V_52 = ( V_49 > V_50 ) ? V_49 : V_50 ;
V_53 = ( V_52 * 0x73 / 255 ) << 8 ;
