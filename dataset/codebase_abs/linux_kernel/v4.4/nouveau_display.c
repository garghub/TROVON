...
struct V_67 * V_56 ;
int V_31 = - V_68 ;
V_56 = F_35 ( V_7 , V_58 , V_62 -> V_69 [ 0 ] ) ;
if ( ! V_56 )
return F_36 ( - V_70 ) ;
...
V_84 = 2 ;
F_46 ( V_29 -> V_88 , V_84 , L_1 , V_89 ) ;
F_46 ( V_29 -> V_90 , V_84 , L_2 , V_91 ) ;
F_46 ( V_29 -> V_92 , V_84 , L_3 , V_93 ) ;
V_29 -> V_94 =
F_47 ( V_7 , 0 , L_4 , 0 , 128 ) ;
V_29 -> V_95 =
F_47 ( V_7 , 0 , L_5 , 0 , 128 ) ;
if ( V_84 < 1 )
return;
V_29 -> V_96 =
F_47 ( V_7 , 0 , L_6 , 0 , 180 ) ;
V_29 -> V_97 =
F_47 ( V_7 , 0 , L_7 , 0 , 200 ) ;
}
int
F_48 ( struct V_10 * V_7 )
{
struct V_74 * V_75 = V_74 ( V_7 ) ;
struct V_98 * V_99 = F_49 ( & V_75 -> V_99 ) ;
struct V_28 * V_29 ;
int V_31 ;
...
int V_132 ;
for ( V_132 = 0 , V_31 = - V_133 ; V_31 && V_132 < F_54 ( V_85 ) ; V_132 ++ ) {
V_31 = F_55 ( & V_75 -> V_99 . V_134 , 0 ,
...
int
F_64 ( struct V_10 * V_7 , bool V_138 )
{
struct V_12 * V_13 ;
F_42 ( V_7 ) ;
F_6 (crtc, &dev->mode_config.crtc_list, head) {
...
void
F_67 ( struct V_10 * V_7 , bool V_138 )
{
struct V_74 * V_75 = V_74 ( V_7 ) ;
struct V_12 * V_13 ;
int V_31 , V_27 ;
...
if ( ! V_66 || ! V_66 -> V_55 )
continue;
V_31 = F_68 ( V_66 -> V_55 , V_142 , true ) ;
if ( V_31 )
F_69 ( V_75 , L_8 ) ;
}
F_6 (crtc, &dev->mode_config.crtc_list, head) {
...
if ( ! V_4 -> V_140 . V_55 )
continue;
V_31 = F_68 ( V_4 -> V_140 . V_55 , V_142 , true ) ;
if ( ! V_31 && V_4 -> V_140 . V_141 )
V_31 = F_70 ( V_4 -> V_140 . V_55 ) ;
if ( V_31 )
F_69 ( V_75 , L_9 ) ;
}
F_40 ( V_7 ) ;
...
int V_31 ;
F_74 ( & V_7 -> V_161 , V_42 ) ;
F_75 ( & V_155 -> V_27 , & V_159 -> V_82 ) ;
F_76 ( & V_7 -> V_161 , V_42 ) ;
V_31 = F_77 ( V_152 , V_151 , false , false ) ;
if ( V_31 )
goto V_162;
V_31 = F_78 ( V_151 , 2 ) ;
if ( V_31 )
goto V_162;
if ( V_75 -> V_99 . V_108 . V_109 < V_114 )
F_79 ( V_151 , V_163 , V_164 , 1 ) ;
else
F_80 ( V_151 , V_165 , V_164 , 1 ) ;
F_81 ( V_151 , 0x00000000 ) ;
F_82 ( V_151 ) ;
V_31 = F_83 ( V_151 , false , V_157 ) ;
if ( V_31 )
goto V_162;
return 0 ;
V_162:
...
int
F_85 ( struct V_12 * V_13 , struct V_50 * V_53 ,
...
return - V_68 ;
if ( V_153 != V_152 ) {
V_31 = F_68 ( V_153 , V_142 , true ) ;
if ( V_31 )
goto V_175;
}
F_86 ( & V_171 -> V_176 ) ;
V_31 = F_87 ( & V_153 -> V_145 , true , false , false , NULL ) ;
if ( V_31 )
goto V_177;
V_31 = F_77 ( V_153 , V_151 , false , true ) ;
if ( V_31 ) {
F_88 ( & V_153 -> V_145 ) ;
goto V_177;
}
if ( V_153 != V_152 ) {
F_88 ( & V_153 -> V_145 ) ;
V_31 = F_87 ( & V_152 -> V_145 , true , false , false , NULL ) ;
if ( V_31 )
goto V_177;
}
* V_155 = (struct V_154 )
...
V_153 -> V_145 . V_146 } ;
F_89 ( V_7 , V_3 ( V_13 ) -> V_8 ) ;
if ( V_75 -> V_99 . V_108 . V_109 >= V_113 ) {
V_31 = F_90 ( V_13 , V_53 , V_151 , V_168 ) ;
if ( V_31 )
goto V_182;
} else {
...
if ( V_31 )
goto V_182;
F_79 ( V_151 , V_185 , 0x012c , 1 ) ;
F_81 ( V_151 , 0 ) ;
F_79 ( V_151 , V_185 , 0x0134 , 1 ) ;
F_81 ( V_151 , V_27 ) ;
F_79 ( V_151 , V_185 , 0x0100 , 1 ) ;
F_81 ( V_151 , 0 ) ;
F_79 ( V_151 , V_185 , 0x0130 , 1 ) ;
F_81 ( V_151 , 0 ) ;
}
F_91 ( V_153 , & V_184 -> V_186 [ V_27 ] ) ;
}
V_31 = F_73 ( V_151 , V_152 , V_153 , V_155 , & V_160 ) ;
if ( V_31 )
goto V_182;
F_92 ( & V_171 -> V_176 ) ;
V_13 -> V_139 -> V_53 = V_53 ;
F_93 ( V_152 , V_160 , false ) ;
F_88 ( & V_152 -> V_145 ) ;
if ( V_152 != V_153 )
F_65 ( V_152 ) ;
F_94 ( & V_160 ) ;
...
V_155 = F_98 ( & V_159 -> V_82 , struct V_154 , V_27 ) ;
if ( V_155 -> V_167 ) {
if ( V_75 -> V_99 . V_108 . V_109 < V_113 ) {
F_99 ( V_7 , V_155 -> V_13 , V_155 -> V_167 ) ;
} else {
F_100 ( V_7 , V_155 -> V_13 , V_155 -> V_167 ) ;
F_95 ( V_7 , V_155 -> V_13 ) ;
}
}
else {
...
if ( ! F_96 ( V_151 , & V_188 ) ) {
if ( V_75 -> V_99 . V_108 . V_109 < V_113 ) {
F_102 ( V_75 -> V_7 , V_188 . V_13 , V_188 . V_146 +
...
int
F_103 ( struct V_57 * V_58 , struct V_10 * V_7 ,
struct V_191 * args )
{
struct V_63 * V_145 ;
T_4 V_192 ;
int V_31 ;
args -> V_189 = F_104 ( args -> V_193 * ( args -> V_190 / 8 ) , 256 ) ;
args -> V_194 = args -> V_189 * args -> V_195 ;
args -> V_194 = F_104 ( args -> V_194 , V_196 ) ;
if ( V_74 ( V_7 ) -> V_99 . V_108 . V_197 != 0 )
V_192 = V_198 ;
else
V_192 = V_199 ;
V_31 = F_105 ( V_7 , args -> V_194 , 0 , V_192 , 0 , 0 , & V_145 ) ;
if ( V_31 )
return V_31 ;
...
{
struct V_67 * V_56 ;
V_56 = F_35 ( V_7 , V_58 , V_59 ) ;
if ( V_56 ) {
struct V_63 * V_145 = F_38 ( V_56 ) ;
* V_200 = F_107 ( & V_145 -> V_145 . V_201 ) ;
F_26 ( V_56 ) ;
return 0 ;
}
return - V_70 ;
