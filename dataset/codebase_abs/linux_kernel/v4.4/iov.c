...
static int F_16 ( struct V_1 * V_2 , int V_33 , int V_34 )
{
int V_35 ;
int V_20 = - V_36 ;
T_2 V_37 ;
...
static void F_33 ( struct V_1 * V_2 , int V_33 , int V_34 )
{
char V_38 [ V_39 ] ;
struct V_1 * V_40 ;
struct V_13 * V_14 = V_2 -> V_9 ;
...
F_5 ( V_2 , V_15 + V_89 , & V_84 ) ;
if ( ! V_84 )
return 0 ;
F_51 ( V_2 , V_15 + V_90 , & V_83 ) ;
V_35 = V_91 > 12 ? V_91 - 12 : 0 ;
V_83 &= ~ ( ( 1 << V_35 ) - 1 ) ;
if ( ! V_83 )
return - V_22 ;
V_83 &= ~ ( V_83 - 1 ) ;
...
V_42 = & V_2 -> V_41 [ V_35 + V_32 ] ;
if ( V_42 -> V_55 & V_94 )
V_82 = ( V_42 -> V_55 & V_95 ) ? 1 : 0 ;
else
V_82 = F_54 ( V_2 , V_96 , V_42 ,
V_15 + V_97 + V_35 * 4 ) ;
if ( ! V_42 -> V_55 )
continue;
if ( F_55 ( V_42 ) & ( V_98 - 1 ) ) {
...
V_14 -> V_31 [ V_35 ] = F_55 ( V_42 ) ;
V_42 -> V_57 = V_42 -> V_56 + F_55 ( V_42 ) * V_84 - 1 ;
F_56 ( & V_2 -> V_2 , L_8 ,
V_35 , V_42 , V_35 , V_84 ) ;
V_35 += V_82 ;
V_65 ++ ;
...
V_14 -> V_83 = V_83 ;
V_14 -> V_99 = V_2 ;
F_51 ( V_2 , V_15 + V_100 , & V_14 -> V_70 ) ;
F_57 ( V_2 , V_15 + V_101 , & V_14 -> V_73 ) ;
if ( F_48 ( V_2 ) == V_85 )
...
{
if ( V_30 < V_32 || V_30 > V_103 )
return 0 ;
F_23 ( ! V_2 -> V_4 ) ;
return V_2 -> V_9 -> V_15 + V_97 +
4 * ( V_30 - V_32 ) ;
}
...
if ( ! V_2 -> V_4 )
continue;
if ( V_2 -> V_9 -> V_24 > V_105 )
V_105 = V_2 -> V_9 -> V_24 ;
}
return V_105 ? V_105 - V_6 -> V_7 : 0 ;
}
...
if ( ! V_2 -> V_4 )
return 0 ;
F_5 ( V_2 , V_2 -> V_9 -> V_15 + V_47 , & V_108 ) ;
V_106 = F_80 ( V_2 -> V_46 , V_108 , NULL ) ;
while ( V_106 ) {
if ( V_106 -> V_51 && ( V_106 -> V_50 == V_2 ) &&
F_81 ( V_106 ) )
V_107 ++ ;
V_106 = F_80 ( V_2 -> V_46 , V_108 , V_106 ) ;
}
return V_107 ;
}
int F_82 ( struct V_1 * V_2 , T_3 V_109 )
{
if ( ! V_2 -> V_4 )
return - V_75 ;
if ( V_109 > V_2 -> V_9 -> V_21 )
return - V_5 ;
