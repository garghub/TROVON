...
static int F_12 ( struct V_9 * V_11 )
{
struct V_8 * V_12 = F_7 ( V_11 ) ;
void T_3 * V_13 = V_12 -> V_13 ;
if ( F_13 ( V_11 ) || F_14 ( V_11 ) )
F_9 ( V_11 ) ;
F_15 ( V_12 -> V_17 ) ;
F_10 ( V_18 | V_19 | V_20 |
...
static int F_16 ( struct V_9 * V_11 )
{
struct V_8 * V_12 = F_7 ( V_11 ) ;
void T_3 * V_13 = V_12 -> V_13 ;
if ( F_13 ( V_11 ) || F_14 ( V_11 ) )
...
static int F_17 ( unsigned long V_29 , struct V_9 * V_11 )
{
...
static T_4 F_18 ( int V_30 , void * V_31 )
{
...
static int T_5 F_19 ( struct V_38 * V_39 , int V_40 )
{
int V_41 ;
...
V_10 . V_17 = V_42 ;
V_18 = V_40 ;
V_10 . V_10 . V_44 = F_22 ( 0 ) ;
V_41 = F_23 ( V_30 , F_18 , V_45 , L_1 , & V_10 ) ;
if ( V_41 ) {
F_24 ( V_42 ) ;
F_21 ( V_39 -> V_43 ) ;
return V_41 ;
}
F_25 ( & V_10 . V_10 , 32768 , 1 , 0xffff ) ;
return V_41 ;
}
static int T_5 F_19 ( struct V_38 * V_39 , int V_40 )
{
...
static void T_5 F_26 ( struct V_38 * V_39 , int V_46 )
{
F_10 ( V_46
| V_20
| V_47
