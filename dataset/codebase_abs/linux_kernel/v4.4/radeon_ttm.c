...
return F_20 ( & V_63 -> V_83 . V_84 , V_82 ) ;
}
...
V_94 = F_25 ( V_6 , V_91 , V_92 , V_95 , V_54 -> V_99 ) ;
if ( F_26 ( V_94 ) )
return F_27 ( V_94 ) ;
V_11 = F_28 ( V_54 , & V_94 -> V_100 ,
V_89 , V_90 , V_86 ) ;
F_29 ( & V_94 ) ;
return V_11 ;
}
...
V_11 = F_31 ( V_54 , & V_56 , & V_102 ,
V_101 , V_90 ) ;
if ( F_32 ( V_11 ) ) {
return V_11 ;
}
V_11 = F_33 ( V_54 -> V_104 , V_102 . V_56 ) ;
if ( F_32 ( V_11 ) ) {
goto V_105;
}
V_11 = F_34 ( V_54 -> V_104 , & V_102 ) ;
if ( F_32 ( V_11 ) ) {
goto V_105;
}
V_11 = F_23 ( V_54 , true , V_90 , & V_102 , V_87 ) ;
if ( F_32 ( V_11 ) ) {
goto V_105;
}
V_11 = F_35 ( V_54 , true , V_90 , V_86 ) ;
V_105:
F_36 ( V_54 , & V_102 ) ;
return V_11 ;
}
...
V_11 = F_35 ( V_54 , true , V_90 , & V_102 ) ;
if ( F_32 ( V_11 ) ) {
goto V_105;
}
V_11 = F_23 ( V_54 , true , V_90 , V_86 , V_87 ) ;
if ( F_32 ( V_11 ) ) {
goto V_105;
}
V_105:
...
if ( V_87 -> V_69 == V_50 &&
V_86 -> V_69 == V_29 ) {
V_11 = F_30 ( V_54 , V_89 , V_101 ,
V_90 , V_86 ) ;
} else if ( V_87 -> V_69 == V_29 &&
V_86 -> V_69 == V_50 ) {
V_11 = F_37 ( V_54 , V_89 , V_101 ,
V_90 , V_86 ) ;
} else {
V_11 = F_23 ( V_54 , V_89 , V_90 , V_86 , V_87 ) ;
}
if ( V_11 ) {
memcpy:
V_11 = F_39 ( V_54 , V_89 , V_90 , V_86 ) ;
if ( V_11 ) {
return V_11 ;
}
}
F_40 ( ( V_108 ) V_54 -> V_95 << V_76 , & V_6 -> V_109 ) ;
return 0 ;
}
static int F_41 ( struct V_2 * V_3 , struct V_85 * V_68 )
{
...
V_68 -> V_110 . V_111 =
F_44 ( V_68 -> V_110 . V_100 + V_68 -> V_110 . V_112 ,
V_68 -> V_110 . V_16 ) ;
...
static void F_45 ( struct V_2 * V_3 , struct V_85 * V_68 )
{
}
static int F_46 ( struct V_118 * V_104 )
{
...
struct V_137 * V_138 ;
V_138 = F_47 ( V_120 -> V_132 , V_120 -> V_136 ) ;
...
V_11 = F_48 ( V_130 , V_130 -> V_131 , V_136 , V_95 ,
V_123 , 0 , V_142 , NULL ) ;
if ( V_11 < 0 )
goto V_143;
V_121 += V_11 ;
} while ( V_121 < V_104 -> V_95 );
V_11 = F_49 ( V_104 -> V_144 , V_104 -> V_142 , V_104 -> V_95 , 0 ,
V_104 -> V_95 << V_76 ,
V_145 ) ;
if ( V_11 )
goto V_146;
V_11 = - V_147 ;
V_122 = F_50 ( V_6 -> V_148 , V_104 -> V_144 -> V_149 , V_104 -> V_144 -> V_122 , V_127 ) ;
if ( V_122 != V_104 -> V_144 -> V_122 )
goto V_146;
F_51 ( V_104 -> V_144 , V_104 -> V_142 ,
...
static void F_53 ( struct V_118 * V_104 )
{
struct V_1 * V_6 = F_1 ( V_104 -> V_3 ) ;
struct V_119 * V_120 = ( void * ) V_104 ;
struct V_151 V_152 ;
...
enum V_126 V_127 = V_123 ?
V_128 : V_129 ;
if ( ! V_104 -> V_144 -> V_149 )
return;
F_54 ( V_6 -> V_148 , V_104 -> V_144 -> V_149 , V_104 -> V_144 -> V_122 , V_127 ) ;
F_55 (ttm->sg->sgl, &sg_iter, ttm->sg->nents, 0 ) {
struct V_141 * V_141 = F_56 ( & V_152 ) ;
...
static int F_61 ( struct V_118 * V_104 ,
struct V_85 * V_153 )
{
struct V_119 * V_120 = ( void * ) V_104 ;
T_1 V_26 = V_154 | V_155 |
V_156 ;
int V_11 ;
if ( V_120 -> V_136 ) {
F_46 ( V_104 ) ;
...
V_120 -> V_112 = ( unsigned long ) ( V_153 -> V_75 << V_76 ) ;
if ( ! V_104 -> V_95 ) {
F_62 ( 1 , L_8 ,
V_104 -> V_95 , V_153 , V_104 ) ;
}
if ( V_104 -> V_157 == V_158 )
V_26 |= V_159 ;
V_11 = F_63 ( V_120 -> V_6 , V_120 -> V_112 , V_104 -> V_95 ,
...
static int F_64 ( struct V_118 * V_104 )
{
struct V_119 * V_120 = ( void * ) V_104 ;
F_65 ( V_120 -> V_6 , V_120 -> V_112 , V_104 -> V_95 ) ;
if ( V_120 -> V_136 )
F_53 ( V_104 ) ;
return 0 ;
}
static void F_66 ( struct V_118 * V_104 )
{
struct V_119 * V_120 = ( void * ) V_104 ;
F_67 ( & V_120 -> V_104 ) ;
F_52 ( V_120 ) ;
}
static struct V_118 * F_68 ( struct V_2 * V_3 ,
unsigned long V_16 , T_1 V_160 ,
struct V_141 * V_161 )
{
struct V_1 * V_6 ;
struct V_119 * V_120 ;
...
#if F_14 ( V_42 )
if ( V_6 -> V_26 & V_43 ) {
return F_69 ( V_3 , V_6 -> V_44 -> V_45 -> V_162 ,
V_16 , V_160 , V_161 ) ;
}
#endif
V_120 = F_70 ( sizeof( struct V_119 ) , V_145 ) ;
if ( V_120 == NULL ) {
return NULL ;
}
V_120 -> V_104 . V_104 . V_36 = & V_163 ;
V_120 -> V_6 = V_6 ;
if ( F_71 ( & V_120 -> V_104 , V_3 , V_16 , V_160 , V_161 ) ) {
F_52 ( V_120 ) ;
return NULL ;
}
return & V_120 -> V_104 . V_104 ;
}
static struct V_119 * F_72 ( struct V_118 * V_104 )
{
if ( ! V_104 || V_104 -> V_36 != & V_163 )
return NULL ;
return (struct V_119 * ) V_104 ;
}
static int F_73 ( struct V_118 * V_104 )
{
struct V_119 * V_120 = F_72 ( V_104 ) ;
struct V_1 * V_6 ;
unsigned V_77 ;
int V_11 ;
bool V_164 = ! ! ( V_104 -> V_160 & V_165 ) ;
if ( V_104 -> V_166 != V_167 )
return 0 ;
if ( V_120 && V_120 -> V_136 ) {
V_104 -> V_144 = F_70 ( sizeof( struct V_168 ) , V_145 ) ;
if ( ! V_104 -> V_144 )
return - V_147 ;
V_104 -> V_160 |= V_165 ;
V_104 -> V_166 = V_169 ;
...
V_120 -> V_104 . V_150 [ V_77 ] = F_79 ( V_6 -> V_170 , V_104 -> V_142 [ V_77 ] ,
0 , V_97 ,
V_171 ) ;
if ( F_80 ( V_6 -> V_170 , V_120 -> V_104 . V_150 [ V_77 ] ) ) {
while ( -- V_77 ) {
F_81 ( V_6 -> V_170 , V_120 -> V_104 . V_150 [ V_77 ] ,
V_97 , V_171 ) ;
...
V_11 = F_94 ( V_6 -> V_179 , false ) ;
if ( V_11 )
return V_11 ;
V_11 = F_95 ( V_6 -> V_179 , V_78 , NULL ) ;
F_96 ( V_6 -> V_179 ) ;
if ( V_11 ) {
F_97 ( & V_6 -> V_179 ) ;
return V_11 ;
...
F_98 ( L_14 ,
( unsigned ) ( V_6 -> V_39 . V_180 / ( 1024 * 1024 ) ) ) ;
V_11 = F_99 ( V_6 ) ;
if ( V_11 ) {
F_9 ( L_15 ) ;
return V_11 ;
...
static int F_106 ( struct V_137 * V_138 , struct V_181 * V_182 )
{
struct V_53 * V_54 ;
struct V_1 * V_6 ;
int V_11 ;
V_54 = (struct V_53 * ) V_138 -> V_183 ;
if ( V_54 == NULL ) {
return V_184 ;
}
V_6 = F_1 ( V_54 -> V_3 ) ;
F_107 ( & V_6 -> V_185 . V_186 ) ;
V_11 = V_187 -> V_188 ( V_138 , V_182 ) ;
F_108 ( & V_6 -> V_185 . V_186 ) ;
return V_11 ;
}
...
struct V_1 * V_6 ;
int V_11 ;
if ( F_32 ( V_138 -> V_191 < V_176 ) ) {
return - V_46 ;
}
V_190 = V_82 -> V_192 ;
V_6 = V_190 -> V_193 -> V_148 -> V_194 ;
if ( V_6 == NULL ) {
return - V_46 ;
}
...
static int F_111 ( struct V_197 * V_198 , void * V_199 )
{
struct V_200 * V_201 = (struct V_200 * ) V_198 -> V_202 ;
unsigned V_203 = * ( int * ) V_201 -> V_204 -> V_199 ;
struct V_205 * V_148 = V_201 -> V_193 -> V_148 ;
struct V_1 * V_6 = V_148 -> V_194 ;
struct V_206 * V_131 = (struct V_206 * ) V_6 -> V_5 . V_3 . V_28 [ V_203 ] . V_207 ;
int V_208 ;
struct V_23 * V_209 = V_6 -> V_5 . V_3 . V_209 ;
F_112 ( & V_209 -> V_210 ) ;
V_208 = F_113 ( V_198 , V_131 ) ;
F_114 ( & V_209 -> V_210 ) ;
return V_208 ;
}
...
V_212 -> V_192 = V_211 -> V_213 ;
return 0 ;
}
static T_3 F_117 ( struct V_81 * V_215 , char T_4 * V_216 ,
T_5 V_16 , T_6 * V_217 )
{
struct V_1 * V_6 = V_215 -> V_192 ;
T_3 V_218 = 0 ;
int V_11 ;
...
int V_11 ;
while ( V_16 ) {
T_6 V_226 = * V_217 / V_97 ;
unsigned V_227 = * V_217 & ~ V_228 ;
T_5 V_229 = F_125 ( T_5 , V_16 , V_97 - V_227 ) ;
struct V_141 * V_141 ;
void * V_230 ;
if ( V_226 >= V_6 -> V_231 . V_232 )
return V_218 ;
V_141 = V_6 -> V_231 . V_142 [ V_226 ] ;
if ( V_141 ) {
V_230 = F_126 ( V_141 ) ;
V_230 += V_227 ;
V_11 = F_127 ( V_216 , V_230 , V_229 ) ;
F_128 ( V_6 -> V_231 . V_142 [ V_226 ] ) ;
} else
V_11 = F_129 ( V_216 , V_229 ) ;
if ( V_11 )
return - V_172 ;
V_218 += V_229 ;
V_216 += V_229 ;
...
#if F_130 ( V_233 )
unsigned V_234 ;
struct V_235 * V_193 = V_6 -> V_44 -> V_236 ;
struct V_237 * V_238 , * V_239 = V_193 -> V_240 ;
V_238 = F_131 ( L_17 , V_241 | V_242 , V_239 ,
V_6 , & V_243 ) ;
if ( F_26 ( V_238 ) )
return F_27 ( V_238 ) ;
V_6 -> V_5 . V_244 = V_238 ;
V_238 = F_131 ( L_18 , V_241 | V_242 , V_239 ,
V_6 , & V_245 ) ;
if ( F_26 ( V_238 ) )
return F_27 ( V_238 ) ;
V_6 -> V_5 . V_120 = V_238 ;
