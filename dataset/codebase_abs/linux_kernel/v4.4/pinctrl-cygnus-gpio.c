...
V_98 = F_59 ( V_101 , V_41 ) ;
if ( ! V_98 )
return - V_102 ;
V_100 = V_98 -> V_103 ;
V_95 = V_100 -> V_104 ;
V_5 = F_60 ( V_41 , sizeof( * V_5 ) , V_80 ) ;
if ( ! V_5 )
return - V_81 ;
V_5 -> V_41 = V_41 ;
F_61 ( V_91 , V_5 ) ;
V_94 = F_62 ( V_91 , V_105 , 0 ) ;
V_5 -> V_12 = F_63 ( V_41 , V_94 ) ;
if ( F_54 ( V_5 -> V_12 ) ) {
F_27 ( V_41 , L_12 ) ;
return F_55 ( V_5 -> V_12 ) ;
}
V_94 = F_62 ( V_91 , V_105 , 1 ) ;
if ( V_94 ) {
V_5 -> V_59 = F_63 ( V_41 , V_94 ) ;
if ( F_54 ( V_5 -> V_59 ) ) {
F_27 ( V_41 , L_12 ) ;
