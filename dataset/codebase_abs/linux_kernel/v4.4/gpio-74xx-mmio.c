...
void T_1 * V_22 ;
int V_23 ;
V_19 = F_8 ( V_24 , & V_17 -> V_25 ) ;
if ( ! V_19 )
return - V_26 ;
V_7 = F_9 ( & V_17 -> V_25 , sizeof( * V_7 ) , V_27 ) ;
if ( ! V_7 )
return - V_28 ;
V_21 = F_10 ( V_17 , V_29 , 0 ) ;
V_22 = F_11 ( & V_17 -> V_25 , V_21 ) ;
if ( F_12 ( V_22 ) )
return F_13 ( V_22 ) ;
V_7 -> V_8 = ( V_30 ) V_19 -> V_31 ;
V_23 = F_14 ( & V_7 -> V_5 , & V_17 -> V_25 ,
F_15 ( F_16 ( V_7 -> V_8 ) , 8 ) ,
V_22 , NULL , NULL , NULL , NULL , 0 ) ;
if ( V_23 )
return V_23 ;
V_7 -> V_5 . V_3 . V_32 = F_5 ;
V_7 -> V_5 . V_3 . V_33 = F_6 ;
V_7 -> V_5 . V_3 . V_34 = F_4 ;
V_7 -> V_5 . V_3 . V_35 = F_16 ( V_7 -> V_8 ) ;
V_7 -> V_5 . V_3 . V_36 = V_37 ;
F_17 ( V_17 , V_7 ) ;
