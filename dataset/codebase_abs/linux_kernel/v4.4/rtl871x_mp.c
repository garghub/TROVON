...
static void F_39 ( struct V_39 * V_42 )
{
F_24 ( V_42 , V_106 , V_141 , V_142 , 0x60 ) ;
}
static T_1 F_40 ( struct V_39 * V_42 )
{
return F_23 ( V_42 , V_106 , V_141 , 0x1F ) ;
}
void F_41 ( struct V_39 * V_42 , T_1 * V_50 )
{
F_39 ( V_42 ) ;
F_15 ( 1000 ) ;
* V_50 = F_40 ( V_42 ) ;
}
void F_42 ( struct V_39 * V_42 , T_2 V_143 )
{
if ( V_143 ) {
if ( ! F_21 ( V_42 , V_112 , V_144 ) )
F_22 ( V_42 , V_112 , V_144 , V_145 ) ;
F_22 ( V_42 , V_117 , V_146 , V_147 ) ;
F_22 ( V_42 , V_117 , V_148 , V_145 ) ;
F_22 ( V_42 , V_120 , V_149 , V_147 ) ;
F_22 ( V_42 , V_120 , V_150 , V_145 ) ;
F_22 ( V_42 , V_120 , V_151 , V_147 ) ;
} else {
F_22 ( V_42 , V_120 , V_149 , V_147 ) ;
F_22 ( V_42 , V_120 , V_150 ,
V_147 ) ;
F_22 ( V_42 , V_120 , V_151 , V_147 ) ;
F_15 ( 20 ) ;
F_22 ( V_42 , V_152 , V_153 , 0x0 ) ;
F_22 ( V_42 , V_152 , V_153 , 0x1 ) ;
}
}
void F_43 ( struct V_39 * V_42 , T_2 V_143 )
{
T_2 V_154 = V_42 -> V_41 . V_155 ;
switch ( V_42 -> V_41 . V_10 ) {
case V_132 :
V_154 = V_156 ;
break;
...
if ( V_143 ) {
F_22 ( V_42 , V_112 , V_157 , V_147 ) ;
F_22 ( V_42 , V_112 , V_144 , V_147 ) ;
F_24 ( V_42 , V_154 , V_158 , V_142 ,
0xd4000 ) ;
F_15 ( 100 ) ;
F_24 ( V_42 , V_154 , V_159 , V_142 , 0x2001f ) ;
F_15 ( 100 ) ;
} else {
F_22 ( V_42 , V_112 , V_157 , V_145 ) ;
F_22 ( V_42 , V_112 , V_144 , V_145 ) ;
F_24 ( V_42 , V_154 , V_158 , V_142 ,
0x54000 ) ;
F_15 ( 100 ) ;
F_24 ( V_42 , V_154 , V_159 , V_142 , 0x30000 ) ;
F_15 ( 100 ) ;
}
}
void F_44 ( struct V_39 * V_42 , T_2 V_143 )
{
if ( V_143 ) {
if ( V_42 -> V_41 . V_8 <= V_160 ) {
if ( ! F_21 ( V_42 , V_112 , V_157 ) ) {
F_22 ( V_42 , V_112 , V_157 ,
V_145 ) ;
}
F_22 ( V_42 , V_120 , V_149 ,
V_147 ) ;
F_22 ( V_42 , V_120 , V_150 ,
V_147 ) ;
F_22 ( V_42 , V_120 , V_151 ,
V_147 ) ;
F_22 ( V_42 , V_117 , V_146 , 0x2 ) ;
F_22 ( V_42 , V_117 , V_148 ,
V_147 ) ;
F_22 ( V_42 , V_117 , V_161 , 0x0 ) ;
}
} else {
if ( V_42 -> V_41 . V_8 <= V_160 ) {
F_22 ( V_42 , V_117 , V_146 , 0x0 ) ;
F_22 ( V_42 , V_117 , V_148 ,
V_145 ) ;
F_22 ( V_42 , V_152 , V_153 , 0x0 ) ;
F_22 ( V_42 , V_152 , V_153 , 0x1 ) ;
...
static void F_45 ( struct V_39 * V_42 , T_2 V_143 )
{
T_1 V_162 ;
if ( V_143 ) {
if ( ! F_21 ( V_42 , V_112 , V_157 ) ) {
...
F_22 ( V_42 , V_120 , V_149 , V_147 ) ;
F_22 ( V_42 , V_120 , V_150 , V_147 ) ;
F_22 ( V_42 , V_120 , V_151 , V_147 ) ;
V_162 = V_42 -> V_41 . V_8 ;
F_22 ( V_42 , V_117 , V_161 , V_162 ) ;
F_22 ( V_42 , V_117 , V_146 , 0x2 ) ;
F_22 ( V_42 , V_117 , V_148 , V_145 ) ;
} else {
F_22 ( V_42 , V_117 , V_146 , 0x0 ) ;
...
static void F_46 ( struct V_39 * V_42 , T_2 V_143 )
{
if ( V_143 ) {
if ( ! F_21 ( V_42 , V_112 , V_144 ) ) {
F_22 ( V_42 , V_112 , V_144 , V_145 ) ;
...
void F_47 ( struct V_39 * V_42 , T_2 V_143 )
{
if ( V_143 ) {
F_17 ( V_42 , V_163 ,
F_16 ( V_42 ,
...
void F_48 ( struct V_39 * V_42 )
{
T_1 V_18 , V_166 = 0 ;
for ( V_18 = V_167 ; V_18 <= V_168 ; V_18 ++ ) {
V_166 = 0 ;
V_166 |= ( V_18 << 28 ) ;
V_166 |= 0x08000000 ;
F_49 ( V_42 , V_169 , V_166 ) ;
}
}
static T_1 F_50 ( struct V_39 * V_42 , T_1 V_170 )
{
T_1 V_166 = 0 , V_171 = 0 ;
T_1 V_172 ;
V_172 = V_170 << 28 ;
V_166 |= ( V_172 & 0xF0000000 ) ;
F_49 ( V_42 , V_169 , V_166 ) ;
V_171 = F_51 ( V_42 , V_169 ) & V_173 ;
return V_171 ;
}
T_1 F_52 ( struct V_39 * V_42 )
{
T_1 V_174 = 0 , V_175 = 0 , V_176 = 0 ;
V_174 = F_50 ( V_42 , V_177 ) ;
V_175 = F_50 ( V_42 , V_178 ) ;
V_176 = F_50 ( V_42 , V_179 ) ;
return V_174 + V_175 + V_176 ;
}
T_1 F_53 ( struct V_39 * V_42 )
{
T_1 V_174 = 0 , V_175 = 0 , V_176 = 0 ;
V_174 = F_50 ( V_42 , V_180 ) ;
V_175 = F_50 ( V_42 , V_181 ) ;
V_176 = F_50 ( V_42 , V_168 ) ;
return V_174 + V_175 + V_176 ;
}
