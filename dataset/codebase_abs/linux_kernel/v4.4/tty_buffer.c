...
F_8 ( & V_11 -> V_12 ) ;
F_9 ( & V_11 -> V_13 ) ;
while ( ( V_27 = F_34 ( & V_11 -> V_15 -> V_27 ) ) != NULL ) {
F_29 ( V_9 , V_11 -> V_15 ) ;
V_11 -> V_15 = V_27 ;
}
...
static int F_35 ( struct V_8 * V_9 , T_1 V_25 ,
int V_3 )
{
struct V_10 * V_11 = & V_9 -> V_11 ;
...
int F_37 ( struct V_8 * V_9 , T_1 V_25 )
{
return F_35 ( V_9 , V_25 , 0 ) ;
}
...
int V_47 = 0 ;
do {
int V_48 = F_39 ( T_1 , V_25 - V_47 , V_49 ) ;
int V_3 = ( V_46 == V_50 ) ? V_44 : 0 ;
int V_20 = F_35 ( V_9 , V_48 , V_3 ) ;
struct V_23 * V_51 = V_9 -> V_11 . V_31 ;
if ( F_40 ( V_20 == 0 ) )
break;
memcpy ( F_41 ( V_51 , V_51 -> V_26 ) , V_45 , V_20 ) ;
if ( ~ V_51 -> V_3 & V_44 )
memset ( F_42 ( V_51 , V_51 -> V_26 ) , V_46 , V_20 ) ;
V_51 -> V_26 += V_20 ;
V_47 += V_20 ;
V_45 += V_20 ;
} while ( F_40 ( V_25 > V_47 ) );
return V_47 ;
}
...
do {
int V_48 = F_39 ( T_1 , V_25 - V_47 , V_49 ) ;
int V_20 = F_37 ( V_9 , V_48 ) ;
struct V_23 * V_51 = V_9 -> V_11 . V_31 ;
if ( F_40 ( V_20 == 0 ) )
break;
memcpy ( F_41 ( V_51 , V_51 -> V_26 ) , V_45 , V_20 ) ;
memcpy ( F_42 ( V_51 , V_51 -> V_26 ) , V_3 , V_20 ) ;
V_51 -> V_26 += V_20 ;
V_47 += V_20 ;
V_45 += V_20 ;
V_3 += V_20 ;
...
{
struct V_10 * V_11 = & V_9 -> V_11 ;
F_36 ( & V_11 -> V_31 -> V_16 , V_11 -> V_31 -> V_26 ) ;
F_13 ( V_18 , & V_11 -> V_19 ) ;
}
int F_45 ( struct V_8 * V_9 , unsigned char * * V_45 ,
T_1 V_25 )
{
int V_20 = F_35 ( V_9 , V_25 , V_44 ) ;
if ( F_46 ( V_20 ) ) {
struct V_23 * V_51 = V_9 -> V_11 . V_31 ;
* V_45 = F_41 ( V_51 , V_51 -> V_26 ) ;
if ( ~ V_51 -> V_3 & V_44 )
memset ( F_42 ( V_51 , V_51 -> V_26 ) , V_50 , V_20 ) ;
V_51 -> V_26 += V_20 ;
}
return V_20 ;
}
...
unsigned char * V_24 = F_41 ( V_15 , V_15 -> V_17 ) ;
char * V_55 = NULL ;
if ( ~ V_15 -> V_3 & V_44 )
V_55 = F_42 ( V_15 , V_15 -> V_17 ) ;
if ( V_53 -> V_39 -> V_56 )
V_52 = V_53 -> V_39 -> V_56 ( V_2 , V_24 , V_55 , V_52 ) ;
else {
V_52 = F_39 ( int , V_52 , V_2 -> V_57 ) ;
if ( V_52 && V_53 -> V_39 -> F_47 )
...
{
return F_13 ( V_18 , & V_9 -> V_11 . V_19 ) ;
}
bool F_62 ( struct V_8 * V_9 )
{
return F_63 ( & V_9 -> V_11 . V_19 ) ;
}
