...
V_50 -> V_3 . V_5 . V_112 = & V_27 -> V_5 ;
V_50 -> V_3 . type = V_113 ;
V_50 -> V_3 . V_114 = 1 ;
V_50 -> V_3 . V_115 = V_116 ;
V_50 -> V_3 . V_101 = V_99 -> V_101 ;
V_50 -> V_3 . V_70 = V_44 [ V_108 ] . V_117 ;
V_50 -> V_82 = V_44 [ V_108 ] . V_118 ;
V_50 -> V_3 . V_119 = V_50 -> V_82 ;
...
{
struct V_91 * V_92 = V_27 -> V_5 . V_125 ;
...
V_127 = F_48 ( V_27 , V_130 , 0 ) ;
V_5 -> V_11 = F_49 ( & V_27 -> V_5 , V_127 ) ;
if ( F_50 ( V_5 -> V_11 ) ) {
V_7 = F_51 ( V_5 -> V_11 ) ;
goto V_128;
}
...
static int F_60 ( struct V_134 * V_5 )
{
struct V_4 * V_135 = F_61 ( V_5 ) ;
if ( V_135 && V_135 -> V_37 )
F_57 ( V_135 -> V_37 ) ;
return 0 ;
}
static int F_62 ( struct V_134 * V_5 )
{
struct V_4 * V_135 = F_61 ( V_5 ) ;
int V_7 = - V_136 ;
if ( V_135 && V_135 -> V_37 )
