...
{
struct V_31 * V_32 = F_8 ( V_30 ) ;
struct V_1 V_47 , * V_48 = & V_46 -> time ;
unsigned long V_49 , V_50 ;
T_1 V_3 [ V_51 ] ;
unsigned int V_52 ;
int V_26 ;
F_16 ( & V_32 -> V_44 ) ;
V_26 = F_6 ( V_32 -> V_23 , V_53 , V_3 ,
V_51 ) ;
if ( V_26 ) {
F_10 ( V_30 , L_5 ,
V_35 , V_26 ) ;
...
V_48 -> V_4 = F_2 ( V_3 [ 0 ] & 0x7f ) ;
V_48 -> V_6 = F_2 ( V_3 [ 1 ] & 0x7f ) ;
V_48 -> V_10 = F_2 ( V_3 [ 2 ] & 0x3f ) ;
V_48 -> V_12 = F_2 ( V_3 [ 3 ] & 0x3f ) ;
V_48 -> V_14 = - 1 ;
V_26 = F_12 ( V_30 , & V_47 ) ;
if ( V_26 )
goto V_54;
...
static int F_20 ( struct V_29 * V_30 , struct V_45 * V_46 )
{
struct V_31 * V_32 = F_8 ( V_30 ) ;
struct V_1 * V_48 = & V_46 -> time ;
unsigned long V_49 , V_50 ;
T_1 V_3 [ V_51 ] ;
struct V_1 V_47 ;
int V_26 , V_36 = 1 ;
...
V_3 [ 0 ] = F_4 ( V_48 -> V_4 ) & 0x7f ;
V_3 [ 1 ] = F_4 ( V_48 -> V_6 ) & 0x7f ;
V_3 [ 2 ] = F_4 ( V_48 -> V_10 ) & 0x3f ;
V_3 [ 3 ] = F_4 ( V_48 -> V_12 ) & 0x3f ;
V_26 = F_21 ( V_32 -> V_23 , V_53 , V_3 ,
V_51 ) ;
if ( V_26 < 0 ) {
F_10 ( V_30 , L_9 ,
V_35 , V_26 ) ;
