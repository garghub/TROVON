...
static int F_56 ( struct V_69 * V_69 , struct V_12 * V_2 , int V_70 )
{
int error = - V_51 ;
struct V_2 * V_3 ;
V_3 = F_57 ( V_69 , V_71 , V_55 , & V_72 , V_70 ) ;
if ( ! V_3 )
goto V_6;
F_58 ( V_2 , V_3 ) ;
V_2 -> V_73 = V_74 ;
...
static void F_59 ( struct V_85 * V_36 , void * V_86 )
{
struct V_1 * V_4 = V_86 ;
struct V_26 * V_27 = F_14 ( V_4 ) ;
if ( V_27 ) {
...
static int F_62 ( struct V_12 * V_2 , struct V_87 * V_88 ,
int V_89 , int V_16 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
...
error = F_65 ( F_64 ( V_3 ) , V_101 , V_100 , V_96 , V_97 , & V_117 , & V_40 ) ;
if ( error < 0 )
goto V_21;
}
} else {
...
static int F_73 ( struct V_69 * V_69 , T_3 V_96 , T_3 V_98 , T_3 V_99 , struct V_94 * V_95 )
{
int error ;
struct V_39 * V_40 ;
struct V_1 * V_4 ;
...
static int F_74 ( struct V_12 * V_2 , struct V_87 * V_141 ,
int * V_142 , int V_143 )
{
int V_15 = 0 ;
int error = 0 ;
...
struct V_167 * V_34 )
{
V_166 -> V_168 = F_78 ( & V_34 -> V_168 ) ;
V_166 -> V_169 = F_78 ( & V_34 -> V_169 ) ;
V_166 -> V_170 = F_78 ( & V_34 -> V_170 ) ;
V_166 -> V_171 = F_78 ( & V_34 -> V_171 ) ;
V_166 -> V_172 = F_78 ( & V_34 -> V_172 ) ;
V_166 -> V_173 = F_78 ( & V_34 -> V_173 ) ;
V_166 -> V_174 = F_78 ( & V_34 -> V_174 ) ;
V_166 -> V_35 = F_78 ( & V_34 -> V_35 ) ;
}
...
break;
V_17 = - V_181 ;
if ( F_80 ( & V_177 , ( void V_182 * ) V_86 , sizeof( struct V_176 ) ) )
break;
V_177 . V_183 = V_4 -> V_121 ;
if ( F_81 ( ( void V_182 * ) V_86 , & V_177 , sizeof( struct V_176 ) ) )
break;
F_23 ( V_4 , V_140 , L_7 ,
V_4 -> V_32 , V_4 -> V_121 ) ;
V_17 = 0 ;
...
break;
V_17 = - V_181 ;
if ( F_82 ( V_4 -> V_122 , ( int V_182 * ) V_86 ) )
break;
F_23 ( V_4 , V_140 , L_9 ,
V_4 -> V_32 , V_4 -> V_122 ) ;
V_17 = 0 ;
...
case V_187 :
V_17 = - V_181 ;
if ( F_82 ( V_27 -> V_16 , ( int V_182 * ) V_86 ) )
break;
F_23 ( V_4 , V_140 , L_11 ,
V_4 -> V_32 , V_27 -> V_16 ) ;
V_17 = 0 ;
...
if ( V_34 . V_98 != 0 ) {
struct V_1 * V_4 =
F_66 ( F_64 ( V_3 ) , V_40 , V_34 . V_98 ) ;
if ( V_4 != NULL )
V_17 = F_79 ( V_4 , V_175 , V_86 ) ;
else
V_17 = - V_191 ;
break;
}
...
#endif
F_77 ( & V_34 , & V_40 -> V_34 ) ;
if ( F_81 ( ( void V_182 * ) V_86 , & V_34 , sizeof( V_34 ) ) ) {
V_17 = - V_181 ;
break;
}
F_23 ( V_40 , V_140 , L_13 ,
V_40 -> V_32 ) ;
V_17 = 0 ;
break;
default:
...
static int F_86 ( struct V_12 * V_2 , unsigned int V_175 ,
unsigned long V_86 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_1 * V_4 ;
...
struct V_29 * V_30 = F_19 ( V_201 ) ;
V_30 -> V_33 . V_137 = V_178 ? V_202 :
V_138 ;
}
F_89 ( V_4 , V_4 -> V_40 -> V_148 ) ;
F_23 ( V_4 , V_140 ,
L_17 ,
V_4 -> V_32 , V_4 -> V_200 ) ;
break;
...
static int F_91 ( struct V_12 * V_2 , int V_207 , int V_194 ,
...
if ( V_40 == NULL )
goto V_147;
V_17 = F_87 ( V_3 , V_40 , V_194 , V_178 ) ;
F_3 ( V_27 -> V_46 ) ;
} else
V_17 = F_88 ( V_3 , V_4 , V_194 , V_178 ) ;
V_17 = 0 ;
V_147:
F_3 ( V_3 ) ;
V_21:
...
static int F_95 ( struct V_12 * V_2 , int V_207 , int V_194 ,
...
if ( V_40 == NULL )
goto V_147;
V_17 = F_92 ( V_3 , V_40 , V_194 , & V_178 ) ;
F_3 ( V_27 -> V_46 ) ;
} else
V_17 = F_93 ( V_3 , V_4 , V_194 , & V_178 ) ;
V_17 = - V_181 ;
if ( F_82 ( V_15 , V_209 ) )
goto V_147;
if ( F_81 ( ( void V_182 * ) V_208 , & V_178 , V_15 ) )
goto V_147;
V_17 = 0 ;
V_147:
F_3 ( V_3 ) ;
...
static void F_97 ( struct V_69 * V_69 , struct V_211 * V_212 )
{
for (; ; ) {
V_212 -> V_40 = F_98 ( V_69 , V_212 -> V_213 ) ;
V_212 -> V_213 ++ ;
if ( V_212 -> V_40 == NULL )
break;
...
static void F_99 ( struct V_69 * V_69 , struct V_211 * V_212 )
{
V_212 -> V_4 = F_100 ( V_212 -> V_40 , V_212 -> V_214 ) ;
V_212 -> V_214 ++ ;
if ( V_212 -> V_4 == NULL ) {
V_212 -> V_214 = 0 ;
F_97 ( V_69 , V_212 ) ;
...
static void * F_101 ( struct V_85 * V_36 , T_4 * V_215 )
{
...
static void * F_103 ( struct V_85 * V_36 , void * V_218 , T_4 * V_217 )
{
( * V_217 ) ++ ;
return NULL ;
}
static void F_104 ( struct V_85 * V_219 , void * V_218 )
{
}
static void F_105 ( struct V_85 * V_36 , void * V_218 )
{
...
F_78 ( & V_40 -> V_34 . V_172 ) ,
F_78 ( & V_40 -> V_34 . V_35 ) ) ;
}
static void F_107 ( struct V_85 * V_36 , void * V_218 )
{
...
T_5 V_222 = 0 ;
if ( V_40 -> V_2 ) {
struct V_144 * V_145 = F_75 ( V_40 -> V_2 ) ;
V_221 = F_108 ( V_145 -> V_223 ) ;
V_222 = F_109 ( V_145 -> V_224 ) ;
}
F_60 ( V_36 , L_28
L_29 ,
...
static int F_110 ( struct V_85 * V_36 , void * V_218 )
{
struct V_211 * V_212 = V_218 ;
if ( V_218 == V_216 ) {
F_111 ( V_36 , L_34 V_227 L_35 ) ;
F_111 ( V_36 , L_36 ) ;
F_111 ( V_36 , L_37 ) ;
F_111 ( V_36 , L_38
L_39 ) ;
...
if ( V_212 -> V_4 == NULL )
F_105 ( V_36 , V_212 -> V_40 ) ;
else
F_107 ( V_36 , V_212 -> V_4 ) ;
V_6:
return 0 ;
}
static int F_112 ( struct V_228 * V_228 , struct V_229 * V_229 )
{
return F_113 ( V_228 , V_229 , & V_230 ,
sizeof( struct V_211 ) ) ;
}
...
struct V_231 * V_232 ;
int V_17 = 0 ;
V_232 = F_115 ( L_42 , V_233 , V_69 -> V_234 ,
& V_235 ) ;
if ( ! V_232 ) {
V_17 = - V_51 ;
goto V_6;
...
if ( V_17 )
goto V_237;
V_17 = F_121 ( V_79 , & V_238 ) ;
if ( V_17 )
goto V_239;
#ifdef F_122
V_17 = F_123 ( V_240 , & V_241 ) ;
if ( V_17 )
goto V_242;
#endif
F_124 ( L_43 , V_227 ) ;
