...
V_69 = V_50 -> V_60 - V_50 -> V_75 ;
for ( V_70 = 0 ; V_70 < V_69 ; ++ V_70 ) {
struct V_46 * V_51 ;
V_47 = V_50 -> V_62 [ V_70 ] . V_47 ;
...
struct V_46 * V_51 = V_13 -> V_76 [ V_9 ] ;
F_45 ( & V_51 -> V_59 -> V_80 , V_18 ) ;
}
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_70 ; ++ V_9 ) {
struct V_46 * V_51 = V_13 -> V_76 [ V_9 ] ;
...
static void V_56 ( struct V_81 * V_81 )
{
struct V_46 * V_51 = F_47 ( V_81 , struct V_46 , V_24 ) ;
F_45 ( & V_51 -> V_59 -> V_55 ,
V_51 -> V_54 >> V_19 ) ;
F_20 ( V_51 ) ;
}
static void V_42 ( struct V_81 * V_81 )
{
struct V_35 * V_36 = F_47 ( V_81 , struct V_35 ,
V_24 ) ;
F_20 ( V_36 ) ;
}
...
struct V_46 * V_83 ;
V_83 = F_4 ( & V_51 -> V_61 [ V_9 ] -> V_55 , V_18 ) ;
if ( V_83 && V_83 -> V_59 != V_51 -> V_59 )
V_83 -> V_58 = V_25 ;
}
}
static int F_51 ( struct V_20 * V_47 )
{
struct V_46 * V_84 = NULL ;
struct V_46 * V_85 = NULL ;
T_1 V_86 = 0 ;
T_1 V_87 = 0 ;
...
V_45 = F_30 ( & V_47 -> V_80 , ( void * * ) & V_13 ,
V_47 -> V_89 >> V_19 , 1 ) ;
if ( V_45 == 0 || V_13 -> V_48 >= V_47 -> V_88 -> V_54 ) {
V_45 = F_51 ( V_47 ) ;
if ( ! V_45 ) {
F_5 ( & V_15 -> V_22 ) ;
return 0 ;
...
V_47 -> V_89 = V_13 -> V_48 + V_15 -> V_92 -> V_72 ;
V_13 -> V_24 ++ ;
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_70 ; ++ V_9 ) {
if ( V_13 -> V_76 [ V_9 ] -> V_59 == V_47 ) {
V_90 = V_9 + 1 ;
break;
}
}
...
return 0 ;
F_48 ( & V_47 -> V_44 ) ;
V_45 = F_53 ( V_15 -> V_93 , V_48 ,
V_90 , & V_4 ) ;
if ( V_45 )
F_1 ( V_15 -> V_93 , NULL , V_48 , V_45 ) ;
else if ( V_4 )
F_1 ( V_15 -> V_93 , V_4 , V_4 -> V_5 , V_45 ) ;
if ( V_4 )
F_54 ( V_4 ) ;
return 1 ;
}
...
struct V_14 * V_15 ;
int V_98 ;
V_97 = F_47 ( V_95 , struct V_96 , V_95 ) ;
V_15 = V_97 -> V_15 ;
F_20 ( V_97 ) ;
V_98 = F_56 ( F_57 ( V_99 ) ,
F_58 ( V_99 ) ) ;
...
{
struct V_96 * V_97 ;
V_97 = F_33 ( sizeof( * V_97 ) , V_57 ) ;
if ( ! V_97 ) {
F_62 () ;
}
F_63 ( & V_97 -> V_95 , V_106 ,
F_55 , NULL , NULL ) ;
V_97 -> V_15 = V_15 ;
F_64 ( V_15 -> V_107 , & V_97 -> V_95 ) ;
}
static void F_65 ( struct V_14 * V_15 , int V_108 )
{
struct V_20 * V_59 ;
struct V_101 * V_102 = V_15 -> V_102 ;
unsigned long V_18 ;
...
V_51 -> V_58 ) ;
for ( V_109 = 0 ; V_109 < V_51 -> V_63 ; ++ V_109 ) {
F_66 ( V_113 L_6 ,
V_51 -> V_61 [ V_109 ] -> V_112 ) ;
}
if ( V_59 -> V_88 == V_51 )
F_66 ( V_113 L_7 ,
V_59 -> V_89 - V_51 -> V_5 ) ;
...
V_13 -> V_76 [ V_9 ] -> V_5 ,
V_13 -> V_76 [ V_9 ] -> V_54 ) ;
for ( V_109 = 0 ; V_109 < V_13 -> V_76 [ V_9 ] -> V_63 ; ++ V_109 ) {
F_66 ( V_113 L_6 ,
V_13 -> V_76 [ V_9 ] -> V_61 [ V_109 ] -> V_112 ) ;
}
}
F_66 ( V_113 L_8 ) ;
...
V_11 = F_8 ( V_114 ) ;
F_54 ( V_114 ) ;
V_45 = F_16 ( V_36 , V_5 , & V_115 , V_7 , V_11 ) ;
if ( V_45 ) {
F_20 ( V_36 ) ;
return F_68 ( V_45 ) ;
}
