...
F_67 ( struct V_6 * V_136 ,
struct V_111 * V_112 )
{
int V_129 ;
const struct V_137 * V_138 ;
struct V_40 * V_139 = V_112 -> V_15 . V_108 ;
struct V_40 * V_41 ;
const struct V_140 * V_141 ;
const struct V_135 * V_142 ;
struct V_1 * V_60 ;
int V_38 ;
V_129 = F_68 ( V_139 , L_19 ) ;
if ( V_129 < 0 ) {
F_9 ( & V_112 -> V_15 , L_20 ) ;
return F_52 ( - V_143 ) ;
}
V_138 = F_69 ( V_144 , V_139 ) ;
V_142 = (struct V_135 * ) V_138 -> V_29 + V_129 ;
V_136 -> V_145 = V_142 -> V_145 ;
V_136 -> V_146 = V_142 -> V_146 ;
V_136 -> V_126 = V_142 -> V_126 ;
V_136 -> V_62 = F_70 ( & V_112 -> V_15 , V_136 -> V_126 ,
sizeof( * V_136 -> V_62 ) , V_24 ) ;
if ( ! V_136 -> V_62 )
return F_52 ( - V_25 ) ;
V_60 = V_136 -> V_62 ;
V_141 = V_142 -> V_62 ;
for ( V_38 = 0 ; V_38 < V_142 -> V_126 ; ++ V_38 , ++ V_141 , ++ V_60 ) {
V_60 -> type = V_141 -> type ;
V_60 -> V_66 = V_141 -> V_66 ;
V_60 -> V_64 = V_141 -> V_64 ;
V_60 -> V_147 = V_141 -> V_147 ;
V_60 -> V_148 = V_141 -> V_148 ;
V_60 -> V_149 = V_141 -> V_149 ;
V_60 -> V_150 = V_141 -> V_150 ;
V_60 -> V_11 = V_141 -> V_11 ;
F_71 ( & V_60 -> V_79 ) ;
V_60 -> V_39 = V_136 ;
V_60 -> V_63 = V_136 -> V_64 ;
V_136 -> V_64 += V_60 -> V_64 ;
}
F_25 (node, np) {
if ( ! F_56 ( V_41 , L_21 , NULL ) )
continue;
V_60 = V_136 -> V_62 ;
for ( V_38 = 0 ; V_38 < V_136 -> V_126 ; ++ V_38 , ++ V_60 ) {
...
V_142 = F_67 ( V_39 , V_112 ) ;
if ( F_58 ( V_142 ) ) {
F_9 ( & V_112 -> V_15 , L_25 ) ;
return F_59 ( V_142 ) ;
}
V_39 -> V_15 = V_15 ;
V_152 = F_73 ( V_112 , V_154 , 0 ) ;
V_39 -> V_65 = F_74 ( & V_112 -> V_15 , V_152 ) ;
if ( F_58 ( V_39 -> V_65 ) )
return F_59 ( V_39 -> V_65 ) ;
V_152 = F_73 ( V_112 , V_155 , 0 ) ;
if ( V_152 )
V_39 -> V_156 = V_152 -> V_157 ;
V_42 = F_63 ( V_112 , V_39 ) ;
if ( V_42 )
return V_42 ;
...
const T_3 * V_161 = V_60 -> type -> V_80 ;
const T_3 * V_162 = V_60 -> type -> V_77 ;
enum V_83 type ;
if ( ! V_162 [ V_163 ] )
continue;
for ( type = 0 ; type < V_88 ; type ++ )
if ( V_162 [ type ] )
V_60 -> V_164 [ type ] = F_32 ( V_58 + V_161 [ type ] ) ;
if ( V_162 [ V_78 ] * V_60 -> V_64 > 32 ) {
V_60 -> V_164 [ V_88 ] =
F_32 ( V_58 + V_161 [ V_78 ] + 4 ) ;
F_78 ( L_26 ,
V_60 -> V_11 , V_58 ,
V_60 -> V_164 [ V_78 ] ,
V_60 -> V_164 [ V_88 ] ) ;
...
F_78 ( L_27 , V_60 -> V_11 ,
V_58 , V_60 -> V_164 [ V_78 ] ) ;
}
}
if ( V_39 -> V_145 )
V_39 -> V_145 ( V_39 ) ;
}
static void F_79 ( struct V_6 * V_39 )
{
void T_2 * V_65 = V_39 -> V_65 ;
int V_38 ;
if ( V_39 -> V_146 )
...
F_78 ( L_28 ,
V_60 -> V_11 , V_58 ,
F_32 ( V_58 + V_161 [ V_78 ] ) ,
F_32 ( V_58 + V_161 [ V_78 ] + 4 ) ,
V_60 -> V_164 [ V_78 ] ,
V_60 -> V_164 [ V_88 ] ) ;
F_33 ( V_60 -> V_164 [ V_88 ] ,
V_58 + V_161 [ V_78 ] + 4 ) ;
} else {
F_78 ( L_29 , V_60 -> V_11 ,
V_58 , F_32 ( V_58 + V_161 [ V_78 ] ) ,
V_60 -> V_164 [ V_78 ] ) ;
}
for ( type = 0 ; type < V_88 ; type ++ )
if ( V_162 [ type ] )
F_33 ( V_60 -> V_164 [ type ] , V_58 + V_161 [ type ] ) ;
}
}
