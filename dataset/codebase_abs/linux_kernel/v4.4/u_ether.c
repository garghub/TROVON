...
V_34 -> V_56 = F_42 ;
if ( V_12 -> V_16 -> V_49 &&
V_55 == V_12 -> V_16 -> V_114 &&
( V_55 % V_104 -> V_48 ) == 0 )
V_34 -> V_115 = 0 ;
else
V_34 -> V_115 = 1 ;
if ( V_34 -> V_115 && ! V_12 -> V_116 && ( V_55 % V_104 -> V_48 ) == 0 )
V_55 ++ ;
V_34 -> V_55 = V_55 ;
if ( F_2 ( V_12 -> V_2 ) )
V_34 -> V_117 = ( V_12 -> V_2 -> V_4 == V_5 ||
V_12 -> V_2 -> V_4 == V_6 )
? ( ( F_51 ( & V_12 -> V_101 ) % V_12 -> V_3 ) != 0 )
: 0 ;
...
const struct V_123 * V_104 ;
const struct V_123 * V_42 ;
if ( V_91 -> V_124 )
V_91 -> V_124 ( V_91 ) ;
V_104 = V_91 -> V_93 -> V_125 ;
V_42 = V_91 -> V_43 -> V_125 ;
F_60 ( V_91 -> V_93 ) ;
F_60 ( V_91 -> V_43 ) ;
if ( F_44 ( V_9 ) ) {
F_13 ( V_12 , L_16 ) ;
V_91 -> V_93 -> V_125 = V_104 ;
V_91 -> V_43 -> V_125 = V_42 ;
F_61 ( V_91 -> V_93 ) ;
F_61 ( V_91 -> V_43 ) ;
}
}
...
static int F_62 ( const char * V_126 , T_5 * V_127 )
{
if ( V_126 ) {
unsigned V_87 ;
...
static int F_66 ( T_5 V_127 [ V_129 ] , char * V_126 , int V_69 )
{
if ( V_69 < 18 )
return - V_130 ;
snprintf ( V_126 , V_69 , L_17 , V_127 ) ;
return 18 ;
}
struct V_11 * F_67 ( struct V_1 * V_131 ,
const char * V_127 , const char * V_132 ,
T_5 V_133 [ V_129 ] , unsigned V_3 , const char * V_134 )
{
struct V_11 * V_12 ;
struct V_8 * V_9 ;
int V_14 ;
...
V_12 -> V_9 = V_9 ;
V_12 -> V_3 = V_3 ;
snprintf ( V_9 -> V_28 , sizeof( V_9 -> V_28 ) , L_18 , V_134 ) ;
if ( F_62 ( V_127 , V_9 -> V_127 ) )
F_74 ( & V_131 -> V_12 ,
L_19 , L_20 ) ;
if ( F_62 ( V_132 , V_12 -> V_135 ) )
F_74 ( & V_131 -> V_12 ,
L_19 , L_21 ) ;
if ( V_133 )
memcpy ( V_133 , V_12 -> V_135 , V_129 ) ;
V_9 -> V_136 = & V_137 ;
V_9 -> V_138 = & V_139 ;
V_12 -> V_2 = V_131 ;
F_75 ( V_9 , & V_131 -> V_12 ) ;
...
V_14 = F_77 ( V_9 ) ;
if ( V_14 < 0 ) {
F_78 ( & V_131 -> V_12 , L_22 , V_14 ) ;
F_79 ( V_9 ) ;
V_12 = F_69 ( V_14 ) ;
} else {
F_80 ( V_12 , L_23 , V_9 -> V_127 ) ;
F_80 ( V_12 , L_24 , V_12 -> V_135 ) ;
F_81 ( V_9 ) ;
}
return V_12 ;
}
struct V_8 * F_82 ( const char * V_134 )
{
struct V_8 * V_9 ;
struct V_11 * V_12 ;
V_9 = F_68 ( sizeof( * V_12 ) ) ;
...
V_144 . V_146 = V_9 -> type ;
memcpy ( V_144 . V_147 , V_12 -> V_142 , V_129 ) ;
F_85 () ;
V_14 = F_86 ( V_9 , & V_144 ) ;
F_87 () ;
if ( V_14 )
...
F_80 ( V_12 , L_23 , V_12 -> V_142 ) ;
return V_14 ;
}
void F_88 ( struct V_8 * V_9 , struct V_1 * V_131 )
{
struct V_11 * V_12 ;
V_12 = F_4 ( V_9 ) ;
V_12 -> V_2 = V_131 ;
...
int F_89 ( struct V_8 * V_9 , const char * V_127 )
{
struct V_11 * V_12 ;
T_5 V_148 [ V_129 ] ;
V_12 = F_4 ( V_9 ) ;
if ( F_62 ( V_127 , V_148 ) )
return - V_130 ;
memcpy ( V_12 -> V_142 , V_148 , V_129 ) ;
return 0 ;
}
int F_90 ( struct V_8 * V_9 , char * V_127 , int V_69 )
{
struct V_11 * V_12 ;
V_12 = F_4 ( V_9 ) ;
return F_66 ( V_12 -> V_142 , V_127 , V_69 ) ;
}
int F_91 ( struct V_8 * V_9 , const char * V_132 )
{
struct V_11 * V_12 ;
T_5 V_148 [ V_129 ] ;
V_12 = F_4 ( V_9 ) ;
if ( F_62 ( V_132 , V_148 ) )
return - V_130 ;
memcpy ( V_12 -> V_135 , V_148 , V_129 ) ;
return 0 ;
}
int F_92 ( struct V_8 * V_9 , char * V_132 , int V_69 )
{
struct V_11 * V_12 ;
V_12 = F_4 ( V_9 ) ;
return F_66 ( V_12 -> V_135 , V_132 , V_69 ) ;
}
int F_93 ( struct V_8 * V_9 , char * V_132 , int V_69 )
{
struct V_11 * V_12 ;
if ( V_69 < 13 )
return - V_130 ;
V_12 = F_4 ( V_9 ) ;
snprintf ( V_132 , V_69 , L_26 , V_12 -> V_135 ) ;
return strlen ( V_132 ) ;
}
void F_94 ( struct V_8 * V_9 , T_5 V_135 [ V_129 ] )
{
struct V_11 * V_12 ;
V_12 = F_4 ( V_9 ) ;
memcpy ( V_135 , V_12 -> V_135 , V_129 ) ;
}
...
struct V_8 * F_102 ( struct V_90 * V_91 )
{
struct V_11 * V_12 = V_91 -> V_149 ;
int V_150 = 0 ;
if ( ! V_12 )
return F_69 ( - V_130 ) ;
V_91 -> V_93 -> V_65 = V_12 ;
V_150 = F_61 ( V_91 -> V_93 ) ;
if ( V_150 != 0 ) {
F_13 ( V_12 , L_27 ,
V_91 -> V_93 -> V_28 , V_150 ) ;
goto V_151;
}
V_91 -> V_43 -> V_65 = V_12 ;
V_150 = F_61 ( V_91 -> V_43 ) ;
if ( V_150 != 0 ) {
F_13 ( V_12 , L_27 ,
V_91 -> V_43 -> V_28 , V_150 ) ;
goto V_152;
}
if ( V_150 == 0 )
V_150 = F_37 ( V_12 , V_91 , F_1 ( V_12 -> V_2 ,
V_12 -> V_3 ) ) ;
if ( V_150 == 0 ) {
V_12 -> V_116 = V_91 -> V_153 ;
