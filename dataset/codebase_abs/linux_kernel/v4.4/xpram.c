...
static int T_3 F_15 ( unsigned long V_46 )
{
unsigned long V_47 ;
unsigned long V_48 ;
...
V_31 = 0 ;
for ( V_51 = 0 ; V_51 < V_55 ; V_51 ++ ) {
struct V_65 * V_66 = V_58 [ V_51 ] ;
V_67 [ V_51 ] . V_30 = V_57 [ V_51 ] / 4 ;
V_67 [ V_51 ] . V_31 = V_31 ;
V_31 += V_67 [ V_51 ] . V_30 ;
V_66 -> V_68 = V_63 ;
V_66 -> V_69 = V_51 ;
...
V_66 -> V_18 = & V_67 [ V_51 ] ;
V_66 -> V_72 = V_60 [ V_51 ] ;
sprintf ( V_66 -> V_73 , L_11 , V_51 ) ;
F_28 ( V_66 , V_57 [ V_51 ] << 1 ) ;
F_29 ( V_66 ) ;
}
return 0 ;
V_59:
...
static void F_31 ( const char * V_74 )
{
F_16 ( L_12 , V_74 ) ;
F_32 ( L_13 ) ;
}
