...
T_3 V_62 ;
int V_21 ;
F_27 ( V_22 , V_23 , sizeof( V_11 ) + 1 , V_63 ) ;
type = F_11 ( V_22 ) ;
...
V_21 = F_32 ( & V_57 , & V_44 , V_45 ) ;
if ( V_21 )
goto V_64;
F_33 ( & V_44 , & V_56 , sizeof( V_56 ) ) ;
F_34 ( & V_49 , & V_56 ) ;
V_60 = F_35 () + V_49 . V_65 ;
V_61 = V_60 - ( V_49 . V_65 / 4 ) ;
F_3 ( L_7 , V_60 ,
V_61 ) ;
F_36 ( V_22 , V_23 , V_47 , V_63 ) ;
if ( V_47 ) {
F_3 ( L_8 ) ;
...
F_37 ( V_54 , V_53 , V_46 , V_63 ) ;
F_3 ( L_9 , V_46 ) ;
F_27 ( V_54 , V_53 , 1 + sizeof( T_3 ) , V_63 ) ;
V_42 = F_29 ( V_54 ) ;
V_62 = F_38 ( V_54 ) ;
V_21 = F_39 ( & V_59 , V_54 , V_53 ) ;
if ( V_21 )
goto V_64;
F_23 ( & V_32 -> V_39 ) ;
if ( V_32 -> V_40 )
...
V_11 V_73 ;
int V_21 ;
F_36 ( & V_22 , V_23 , V_72 , V_63 ) ;
if ( V_72 != 1 )
return - V_25 ;
F_37 ( & V_22 , V_23 , V_73 , V_63 ) ;
F_3 ( L_11 , V_73 ) ;
while ( V_73 -- ) {
...
V_78 -> V_86 = F_45 ( V_32 -> V_31 ) ;
V_78 -> V_40 . V_18 = 1 ;
V_78 -> V_40 . V_66 = F_7 ( V_32 -> V_66 ) ;
V_78 -> V_40 . V_87 = F_45 ( V_81 ) ;
if ( V_81 ) {
memcpy ( V_78 -> V_40 . V_88 , V_32 -> V_40 -> V_69 . V_84 ,
V_32 -> V_40 -> V_69 . V_70 ) ;
}
F_3 ( L_14 , V_32 , V_32 -> V_66 ,
F_14 ( V_78 -> V_40 . V_66 ) ) ;
V_22 = V_78 + 1 ;
V_22 += V_81 ;
V_23 = V_75 -> V_71 -> V_69 . V_84 + V_75 -> V_71 -> V_69 . V_70 ;
F_46 ( & V_75 -> V_89 , sizeof( V_75 -> V_89 ) ) ;
V_80 . V_18 = 1 ;
...
F_47 ( V_75 -> V_71 -> V_69 . V_70 > V_76 ) ;
return 0 ;
V_82:
F_41 ( V_75 ) ;
return V_21 ;
}
static int F_48 ( struct V_30 * V_32 ,
void * * V_22 , void * V_23 )
{
F_27 ( V_22 , V_23 , 1 + sizeof( T_3 ) , V_63 ) ;
F_49 ( V_22 , 1 ) ;
F_50 ( V_22 , V_32 -> V_66 ) ;
if ( V_32 -> V_40 ) {
const char * V_71 = V_32 -> V_40 -> V_69 . V_84 ;
V_11 V_20 = V_32 -> V_40 -> V_69 . V_70 ;
F_51 ( V_22 , V_23 , V_20 , V_63 ) ;
F_52 ( V_22 , V_23 , V_71 , V_20 , V_63 ) ;
} else {
F_51 ( V_22 , V_23 , 0 , V_63 ) ;
}
return 0 ;
V_63:
return - V_90 ;
...
if ( ! V_75 )
return - V_27 ;
V_21 = F_42 ( V_2 , V_32 , V_75 ) ;
if ( V_21 ) {
F_25 ( V_75 ) ;
return V_21 ;
}
V_96 -> V_120 = (struct V_121 * ) V_75 ;
V_96 -> V_122 = V_75 -> V_71 -> V_69 . V_84 ;
V_96 -> V_123 = V_75 -> V_71 -> V_69 . V_70 ;
V_96 -> V_124 = V_75 -> V_125 ;
V_96 -> V_126 = sizeof ( V_75 -> V_125 ) ;
V_96 -> V_127 = V_2 -> V_128 -> V_127 ;
V_96 -> V_129 = V_2 -> V_128 -> V_129 ;
return 0 ;
}
static int F_60 (
struct V_1 * V_2 , int V_118 ,
...
if ( F_30 ( V_32 ) )
return F_31 ( V_32 ) ;
V_75 = (struct V_74 * ) V_96 -> V_120 ;
if ( V_75 -> V_66 < V_32 -> V_66 ) {
F_3 ( L_21 ,
V_75 -> V_31 , V_75 -> V_66 , V_32 -> V_66 ) ;
return F_42 ( V_2 , V_32 , V_75 ) ;
}
return 0 ;
}
static int F_61 ( struct V_1 * V_2 ,
struct V_121 * V_130 , T_1 V_20 )
{
struct V_74 * V_75 = ( void * ) V_130 ;
int V_21 = 0 ;
struct V_131 V_132 ;
void * V_133 = & V_132 ;
void * V_22 = V_75 -> V_125 ;
void * V_23 = V_22 + sizeof( V_75 -> V_125 ) ;
V_21 = F_10 ( & V_75 -> V_39 , & V_22 , V_23 , & V_133 , sizeof( V_132 ) ) ;
if ( V_21 < 0 )
return V_21 ;
if ( V_21 != sizeof( V_132 ) )
return - V_29 ;
if ( V_75 -> V_89 + 1 != F_14 ( V_132 . V_134 ) )
V_21 = - V_29 ;
else
V_21 = 0 ;
F_3 ( L_22 ,
V_75 -> V_89 , F_14 ( V_132 . V_134 ) , V_21 ) ;
return V_21 ;
}
...
struct V_135 * V_136 , V_106 * V_137 )
{
int V_21 ;
char V_99 [ 40 ] ;
T_4 V_98 [ 5 ] = {
F_45 ( 16 ) , V_136 -> V_138 . V_139 , V_136 -> V_140 . V_141 ,
V_136 -> V_140 . V_142 , V_136 -> V_140 . V_143 ,
} ;
...
static int F_68 ( struct V_119 * V_96 ,
struct V_135 * V_136 )
{
int V_21 ;
if ( F_69 ( F_70 ( V_136 -> V_144 -> V_145 ) , V_146 ) )
return 0 ;
V_21 = F_67 ( (struct V_74 * ) V_96 -> V_120 ,
V_136 , & V_136 -> V_140 . V_137 ) ;
if ( V_21 < 0 )
return V_21 ;
V_136 -> V_140 . V_147 |= V_148 ;
return 0 ;
}
static int F_71 ( struct V_119 * V_96 ,
struct V_135 * V_136 )
{
V_106 V_149 ;
int V_21 ;
...
if ( V_21 < 0 )
return V_21 ;
if ( V_149 == V_136 -> V_140 . V_137 )
return 0 ;
if ( V_136 -> V_140 . V_147 & V_148 )
F_3 ( L_25
L_26 , V_136 , V_136 -> V_140 . V_137 , V_149 ) ;
else
F_3 ( L_27
L_28 , V_136 ) ;
return - V_150 ;
