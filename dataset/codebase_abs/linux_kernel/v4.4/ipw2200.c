...
static void inline F_273 ( struct V_571 * V_572 )
{
...
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) + V_1064 ) >
F_379 ( V_774 -> V_501 ) ) ) {
V_166 -> V_674 . V_1065 ++ ;
...
F_381 ( V_774 -> V_501 , F_382 ( struct V_1060 , V_538 . V_1063 . V_3 ) ) ;
F_383 ( V_774 -> V_501 , F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) ) ;
F_384 ( L_375 , V_774 -> V_501 -> V_4 ) ;
...
unsigned short V_4 = F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) ;
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) + V_1064 ) >
F_379 ( V_774 -> V_501 ) ) ) {
V_166 -> V_674 . V_1065 ++ ;
...
V_1078 -> V_1079 . V_1083 = F_174 ( sizeof( struct V_1077 ) ) ;
V_1078 -> V_1079 . V_1084 = F_180 (
( 1 << V_1085 ) |
( 1 << V_1086 ) |
( 1 << V_1087 ) |
( 1 << V_1088 ) |
...
V_1078 -> V_1097 = ( T_7 ) F_223 ( V_1063 -> V_737 ) ;
V_1078 -> V_1098 = F_174 ( F_387 ( V_1072 ) ) ;
if ( V_1072 > 14 ) {
V_1078 -> V_1099 =
F_174 ( ( V_1100 | V_1101 ) ) ;
} else if ( V_1073 & 32 ) {
...
F_383 ( V_774 -> V_501 , V_4 + sizeof( struct V_1077 ) ) ;
F_384 ( L_375 , V_774 -> V_501 -> V_4 ) ;
if ( ! F_385 ( V_23 -> V_163 , V_774 -> V_501 , V_674 ) )
V_166 -> V_674 . V_1065 ++ ;
else {
...
T_7 V_737 = ( T_7 ) F_223 ( V_1063 -> V_737 ) ;
...
return;
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( V_4 + V_1064 ) > F_379 ( V_774 -> V_501 ) ) ) {
V_166 -> V_674 . V_1065 ++ ;
F_380 ( L_373 ) ;
return;
}
...
if ( F_389 ( F_223 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1110 )
return;
if ( V_161 & V_1111 )
V_1108 = 1 ;
} else if ( F_390 ( F_223 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1112 )
return;
if ( V_161 & V_1113 )
V_1108 = 1 ;
...
if ( V_1108 )
V_4 = F_393 ( F_223 ( V_1054 -> V_1056 ) ) ;
memcpy ( V_1078 -> V_142 , V_1054 , V_4 ) ;
V_1078 -> V_1079 . V_1080 = V_1081 ;
V_1078 -> V_1079 . V_1082 = 0 ;
V_1078 -> V_1079 . V_1083 = F_174 ( sizeof( * V_1078 ) ) ;
F_383 ( V_501 , sizeof( * V_1078 ) + V_4 ) ;
V_1078 -> V_1079 . V_1084 = F_180 (
( 1 << V_1085 ) |
( 1 << V_1086 ) |
( 1 << V_1087 ) |
...
V_1078 -> V_1097 = V_737 ;
V_1078 -> V_1098 = F_174 ( F_387 ( V_197 ) ) ;
if ( V_197 > 14 ) {
V_1078 -> V_1099 =
F_174 ( ( V_1100 | V_1101 ) ) ;
} else if ( V_1107 & ( 1 << 5 ) ) {
...
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
if ( F_214 ( V_1116 -> V_1117 , V_23 -> V_167 -> V_1118 ) )
return 0 ;
if ( F_365 ( V_1116 -> V_1070 ) )
return F_214 ( V_1116 -> V_1119 , V_23 -> V_216 ) ;
return F_214 ( V_1116 -> V_1070 ,
V_23 -> V_167 -> V_1118 ) ;
case V_516 :
if ( F_214 ( V_1116 -> V_1119 , V_23 -> V_167 -> V_1118 ) )
return 0 ;
if ( F_365 ( V_1116 -> V_1070 ) )
return F_214 ( V_1116 -> V_1117 , V_23 -> V_216 ) ;
return F_214 ( V_1116 -> V_1070 ,
V_23 -> V_167 -> V_1118 ) ;
}
return 1 ;
...
struct V_675 * V_1116 )
{
T_4 V_1120 = F_223 ( V_1116 -> V_1121 ) ;
T_4 V_1122 = F_397 ( V_1120 ) ;
T_4 V_359 = F_398 ( V_1120 ) ;
T_4 * V_1123 , * V_1124 ;
...
V_545 =
F_213 ( V_134 , struct V_1126 , V_442 ) ;
...
( V_501 -> V_3 + V_1064 ) ;
F_295 ( V_23 -> V_163 , V_1116 , V_674 ) ;
if ( V_23 -> V_163 -> V_513 == V_514 &&
( ( F_402 ( F_223 ( V_1116 -> V_1136 ) ) ==
V_1137 ) ||
( F_402 ( F_223 ( V_1116 -> V_1136 ) ) ==
V_1138 ) ) ) {
if ( F_214 ( V_1116 -> V_1119 , V_23 -> V_216 ) )
F_263 ( V_23 , V_1116 -> V_1117 ) ;
}
if ( V_23 -> V_59 & V_200 ) {
F_143 ( L_379 ) ;
F_383 ( V_501 , F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) +
V_1064 ) ;
F_403 ( V_501 , V_1064 ) ;
...
V_1045 + 0x100 ,
. V_737 =
F_223 ( V_1061 -> V_538 . V_1063 . V_737 ) ,
...
V_820 :
V_819 ,
. V_4 = F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) ,
} ;
if ( V_674 . V_632 != 0 )
V_674 . V_36 |= V_1150 ;
if ( V_674 . signal != 0 )
...
F_384 ( L_382 ,
F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) ) ;
if ( F_223 ( V_1061 -> V_538 . V_1063 . V_415 ) <
F_393 ( F_223 (
V_1116 -> V_1136 ) ) ) {
F_380
( L_383
...
F_223 ( V_1061 -> V_538 . V_1159 . V_15 ) ) ;
F_291 ( V_23 , & V_1061 -> V_538 . V_1159 ) ;
break;
}
default:
F_384 ( L_389 ,
...
static int F_411 ( struct V_17 * V_23 , int V_1160 )
{
int V_881 , V_804 ;
...
if ( V_1183 -> V_1185 == 1 ) {
V_197 = F_414 ( V_23 -> V_163 , V_1183 -> V_1184 ) ;
if ( V_197 == 0 )
return - V_75 ;
} else
V_197 = V_1183 -> V_1184 ;
...
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
return F_442 ( V_23 -> V_163 , V_902 , V_211 , V_903 ) ;
}
...
F_59 ( & V_23 -> V_109 ) ;
V_432 = F_444 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
...
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
return F_446 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
}
...
if ( F_448 ( V_23 -> V_1180 ) == V_365 )
V_23 -> V_1180 = V_1251 | V_363 ;
else
V_23 -> V_1180 = V_1251 | V_23 -> V_1180 ;
V_557 = F_185 ( V_23 , F_448 ( V_23 -> V_1180 ) ) ;
if ( V_557 ) {
F_326 ( L_446 ) ;
F_60 ( & V_23 -> V_109 ) ;
return V_557 ;
}
F_326 ( L_449 , V_23 -> V_1180 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
F_60 ( & V_23 -> V_109 ) ;
F_444 ( V_23 -> V_163 , V_902 , & V_1259 , NULL ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( ! ( V_23 -> V_37 & V_99 ) ) {
F_266 ( L_476
L_477 ) ;
...
static struct V_1262 * F_460 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
...
static int F_466 ( struct V_17 * V_23 , struct V_1288 * V_532 ,
int V_1289 )
{
...
if ( ! ( V_23 -> V_37 & V_103 ) )
goto V_1135;
V_1294 = F_393 ( F_223 ( V_1054 -> V_1136 ) ) ;
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
V_1007 = ! F_365 ( V_1054 -> V_1070 ) ;
V_1293 = F_264 ( V_23 , V_1054 -> V_1070 ) ;
if ( V_1293 == V_552 ) {
...
V_768 -> V_538 . V_3 . V_4 = F_174 ( V_532 -> V_1298 ) ;
if ( V_23 -> V_559 . V_347 == V_352 )
...
V_1055 = F_223 ( V_1054 -> V_1136 ) ;
V_1054 -> V_1136 = F_174 ( V_1055 & ~ V_1301 ) ;
...
#ifdef F_292
if ( V_1055 & V_1308 )
F_366 ( V_23 , V_1289 , & ( V_768 -> V_538 . V_3 ) ) ;
#endif
V_768 -> V_538 . V_3 . V_539 = F_180 ( F_3 ( ( T_2 ) ( V_540 - 2 ) ,
V_532 -> V_1309 ) ) ;
F_468 ( L_482 ,
V_532 -> V_1309 , F_228 ( V_768 -> V_538 . V_3 . V_539 ) ) ;
...
F_174 ( V_532 -> V_1291 [ V_7 ] -> V_4 - V_1294 ) ;
}
if ( V_7 != V_532 -> V_1309 ) {
struct V_1005 * V_501 ;
T_4 V_1311 = 0 ;
...
if ( V_501 != NULL ) {
V_768 -> V_538 . V_3 . V_478 [ V_7 ] = F_174 ( V_1311 ) ;
for ( V_8 = V_7 ; V_8 < V_532 -> V_1309 ; V_8 ++ ) {
...
static int F_470 ( struct V_165 * V_166 , int V_1289 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
#ifdef F_292
int V_1292 = F_363 ( V_23 , V_1289 ) ;
...
if ( ! V_1316 )
continue;
V_1079 = ( void * ) F_383 ( V_1316 , sizeof( * V_1079 ) ) ;
V_1079 -> V_1080 = V_1081 ;
V_1079 -> V_1082 = 0 ;
V_1079 -> V_1084 = 0 ;
V_1079 -> V_1084 |= F_180 ( 1 << V_1088 ) ;
* ( T_8 * ) F_383 ( V_1316 , sizeof( T_4 ) ) = F_174 (
F_387 ( V_23 -> V_197 ) ) ;
if ( V_23 -> V_197 > 14 )
* ( T_8 * ) F_383 ( V_1316 , sizeof( T_4 ) ) =
F_174 ( V_1100 |
V_1101 ) ;
...
F_174 ( V_1100 |
V_1103 ) ;
V_1079 -> V_1083 = F_174 ( V_1316 -> V_4 ) ;
F_472 ( V_803 , F_383 ( V_1316 , V_4 ) , V_4 ) ;
if ( ! F_385 ( V_23 -> V_159 -> V_163 , V_1316 , & V_1314 ) )
F_394 ( V_1316 ) ;
}
}
static T_12 F_473 ( struct V_1288 * V_532 ,
struct V_165 * V_166 , int V_1289 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
unsigned long V_41 ;
T_12 V_432 ;
F_146 ( L_488 , V_532 -> V_1298 ) ;
F_41 ( & V_23 -> V_98 , V_41 ) ;
#ifdef F_271
if ( V_156 && F_92 ( V_23 -> V_157 ) )
F_471 ( V_23 , V_532 ) ;
#endif
V_432 = F_466 ( V_23 , V_532 , V_1289 ) ;
if ( V_432 == V_1313 )
F_63 ( V_23 ) ;
F_42 ( & V_23 -> V_98 , V_41 ) ;
return V_432 ;
...
char V_1323 [ 32 ] ;
T_3 V_4 ;
F_478 ( V_902 -> V_1324 , V_1325 , sizeof( V_902 -> V_1324 ) ) ;
F_478 ( V_902 -> V_983 , V_1326 , sizeof( V_902 -> V_983 ) ) ;
V_4 = sizeof( V_1322 ) ;
...
V_1322 , V_1323 ) ;
F_478 ( V_902 -> V_1330 , F_479 ( V_134 -> V_477 ) ,
sizeof( V_902 -> V_1330 ) ) ;
}
...
return - V_75 ;
F_59 ( & V_134 -> V_109 ) ;
memcpy ( V_1332 , & V_134 -> V_123 [ V_123 -> V_468 ] , V_123 -> V_4 ) ;
F_60 ( & V_134 -> V_109 ) ;
return 0 ;
}
...
return - V_75 ;
F_59 ( & V_134 -> V_109 ) ;
memcpy ( & V_134 -> V_123 [ V_123 -> V_468 ] , V_1332 , V_123 -> V_4 ) ;
for ( V_7 = 0 ; V_7 < V_386 ; V_7 ++ )
F_198 ( V_134 , V_7 + V_387 , V_134 -> V_123 [ V_7 ] ) ;
F_60 ( & V_134 -> V_109 ) ;
return 0 ;
}
static T_13 F_484 ( int V_1333 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
F_496 ( & V_23 -> V_228 ) ;
F_496 ( & V_23 -> V_486 ) ;
F_497 ( & V_23 -> V_669 , F_323 ) ;
F_498 ( & V_23 -> V_333 , F_375 ) ;
F_498 ( & V_23 -> V_558 , F_269 ) ;
F_498 ( & V_23 -> V_564 , F_270 ) ;
F_498 ( & V_23 -> V_780 , F_301 ) ;
F_498 ( & V_23 -> V_246 , F_165 ) ;
F_497 ( & V_23 -> V_191 , F_489 ) ;
F_498 ( & V_23 -> V_193 , V_1339 ) ;
F_498 ( & V_23 -> V_190 , V_1340 ) ;
F_497 ( & V_23 -> V_186 , F_333 ) ;
F_497 ( & V_23 -> V_187 , F_334 ) ;
F_497 ( & V_23 -> V_188 , F_332 ) ;
F_497 ( & V_23 -> V_189 , F_287 ) ;
F_497 ( & V_23 -> V_644 , F_283 ) ;
F_498 ( & V_23 -> V_653 , F_335 ) ;
F_498 ( & V_23 -> V_706 , F_374 ) ;
F_497 ( & V_23 -> V_322 , F_170 ) ;
F_498 ( & V_23 -> V_676 , F_492 ) ;
F_498 ( & V_23 -> V_241 , F_494 ) ;
F_497 ( & V_23 -> V_108 , F_57 ) ;
F_497 ( & V_23 -> V_104 , F_62 ) ;
F_497 ( & V_23 -> V_114 , F_66 ) ;
F_498 ( & V_23 -> V_815 , F_312 ) ;
#ifdef F_292
F_498 ( & V_23 -> V_961 , F_367 ) ;
#endif
F_499 ( & V_23 -> V_1336 , ( void (*) ( unsigned long ) )
...
if ( ! V_23 -> V_163 -> V_842 && ( V_244 -> V_41 & V_1342 ) )
F_321 ( V_23 ) ;
#if 0
...
if ( F_182 ( V_23 ) )
goto error;
if ( F_160 ( V_23 , V_23 -> V_167 -> V_1118 ) )
goto error;
F_461 ( & V_23 -> V_310 ) ;
if ( V_1346 ) {
...
{
int V_8 ;
for ( V_8 = 0 ; V_8 < F_224 ( V_1353 ) ; V_8 ++ ) {
if ( ! memcmp ( & V_23 -> V_123 [ V_1354 ] ,
V_1353 [ V_8 ] . V_158 , 3 ) )
break;
}
if ( V_8 == F_224 ( V_1353 ) ) {
...
F_503 ( V_23 -> V_163 , & V_1353 [ V_8 ] ) ;
}
static int F_164 ( struct V_17 * V_23 )
{
int V_155 , V_7 ;
if ( V_23 -> V_1355 ) {
F_504 ( V_23 -> V_163 , V_23 -> V_1355 ) ;
V_23 -> V_1355 = 0 ;
}
if ( V_23 -> V_37 & V_701 )
return - V_306 ;
...
struct V_17 * V_23 = F_341 ( V_166 ) ;
const struct V_201 * V_202 = F_137 ( V_23 -> V_163 ) ;
struct V_1358 * V_182 = & V_23 -> V_163 -> V_182 ;
memcpy ( V_182 -> V_183 -> V_1359 , V_23 -> V_543 , V_217 ) ;
if ( V_202 -> V_203 ) {
struct V_1360 * V_1361 = & V_23 -> V_163 -> V_1361 ;
V_1361 -> V_881 = V_1362 ;
V_1361 -> V_1363 = V_202 -> V_203 ;
V_1361 -> V_869 = F_505 ( V_202 -> V_203 ,
...
for ( V_7 = 0 ; V_7 < V_202 -> V_203 ; V_7 ++ ) {
V_1361 -> V_869 [ V_7 ] . V_881 = V_1362 ;
V_1361 -> V_869 [ V_7 ] . V_1365 = V_202 -> V_204 [ V_7 ] . V_1149 ;
V_1361 -> V_869 [ V_7 ] . V_1366 = V_202 -> V_204 [ V_7 ] . V_197 ;
V_1361 -> V_869 [ V_7 ] . V_346 = V_202 -> V_204 [ V_7 ] . V_346 ;
if ( V_202 -> V_204 [ V_7 ] . V_41 & V_207 )
V_1361 -> V_869 [ V_7 ] . V_41 |=
V_1367 ;
...
V_1361 -> V_1369 = V_1370 ;
V_1361 -> V_1371 = V_1372 ;
V_182 -> V_183 -> V_1373 [ V_1362 ] = V_1361 ;
}
if ( V_202 -> V_209 ) {
struct V_1360 * V_1374 = & V_23 -> V_163 -> V_1374 ;
V_1374 -> V_881 = V_1375 ;
V_1374 -> V_1363 = V_202 -> V_209 ;
V_1374 -> V_869 = F_505 ( V_202 -> V_209 ,
sizeof( struct V_1364 ) ,
V_148 ) ;
if ( ! V_1374 -> V_869 ) {
V_155 = - V_476 ;
...
for ( V_7 = 0 ; V_7 < V_202 -> V_209 ; V_7 ++ ) {
V_1374 -> V_869 [ V_7 ] . V_881 = V_1375 ;
V_1374 -> V_869 [ V_7 ] . V_1365 = V_202 -> V_18 [ V_7 ] . V_1149 ;
V_1374 -> V_869 [ V_7 ] . V_1366 = V_202 -> V_18 [ V_7 ] . V_197 ;
V_1374 -> V_869 [ V_7 ] . V_346 = V_202 -> V_18 [ V_7 ] . V_346 ;
if ( V_202 -> V_18 [ V_7 ] . V_41 & V_207 )
V_1374 -> V_869 [ V_7 ] . V_41 |=
V_1367 ;
...
V_1374 -> V_1369 = V_1376 ;
V_1374 -> V_1371 = V_1377 ;
V_182 -> V_183 -> V_1373 [ V_1375 ] = V_1374 ;
}
V_182 -> V_183 -> V_1378 = V_1379 ;
V_182 -> V_183 -> V_1380 = F_224 ( V_1379 ) ;
...
{
struct V_1381 * V_159 = F_341 ( V_166 ) ;
...
static T_12 F_512 ( struct V_1005 * V_501 ,
struct V_165 * V_166 )
{
F_74 ( L_513 ) ;
F_241 ( V_501 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_513 ( sizeof( struct V_1381 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
...
static int F_519 ( struct V_477 * V_1384 ,
const struct V_1385 * V_1386 )
{
int V_557 = 0 ;
struct V_165 * V_167 ;
void T_14 * V_137 ;
...
F_522 ( V_1384 ) ;
V_557 = F_523 ( V_1384 , F_524 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_525 ( V_1384 , F_524 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_515 ) ;
goto V_1390;
}
F_526 ( V_1384 , V_23 ) ;
V_557 = F_527 ( V_1384 , V_1325 ) ;
if ( V_557 )
goto V_1390;
F_528 ( V_1384 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_529 ( V_1384 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_530 ( V_1384 , 0 ) ;
V_23 -> V_1391 = V_415 ;
V_137 = F_531 ( V_1384 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1388 ;
goto V_1392;
}
...
F_411 ( V_23 , 1 ) ;
V_557 = F_532 ( V_1384 -> V_1333 , F_484 , V_1394 , V_1325 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_519 , V_1384 -> V_1333 ) ;
goto V_1393;
}
F_515 ( V_167 , & V_1384 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1395 = F_473 ;
V_23 -> V_163 -> V_896 = F_500 ;
V_23 -> V_163 -> V_1396 = F_470 ;
#ifdef F_292
V_23 -> V_163 -> V_1397 = F_364 ;
V_23 -> V_163 -> V_1398 = F_369 ;
...
V_23 -> V_163 -> V_643 = - 85 ;
V_167 -> V_1382 = & V_1401 ;
V_23 -> V_1402 . V_1403 = & V_23 -> V_163 -> V_1403 ;
V_167 -> V_1402 = & V_23 -> V_1402 ;
V_167 -> V_1404 = & V_1405 ;
V_167 -> V_1406 = & V_1407 ;
V_557 = F_533 ( & V_1384 -> V_166 . V_1408 , & V_1409 ) ;
if ( V_557 ) {
F_46 ( L_520 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1410;
...
F_87 ( V_23 -> V_163 -> V_1374 . V_869 ) ;
F_87 ( V_23 -> V_163 -> V_1361 . V_869 ) ;
V_1411:
F_535 ( & V_1384 -> V_166 . V_1408 , & V_1409 ) ;
V_1410:
F_536 ( V_1384 -> V_1333 , V_23 ) ;
V_1393:
F_537 ( V_23 -> V_22 ) ;
V_1392:
F_538 ( V_1384 ) ;
...
static void F_540 ( struct V_477 * V_1384 )
{
struct V_17 * V_23 = F_541 ( V_1384 ) ;
...
F_215 ( V_134 ) ;
F_87 ( F_213 ( V_134 , struct V_1126 , V_442 ) ) ;
}
}
F_87 ( V_23 -> error ) ;
V_23 -> error = NULL ;
...
static int F_544 ( struct V_477 * V_1384 , T_15 V_665 )
{
struct V_17 * V_23 = F_541 ( V_1384 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_546 ( V_1384 ) ;
F_539 ( V_1384 ) ;
F_547 ( V_1384 , F_548 ( V_1384 , V_665 ) ) ;
V_23 -> V_1413 = F_549 () ;
return 0 ;
}
static int F_550 ( struct V_477 * V_1384 )
{
struct V_17 * V_23 = F_541 ( V_1384 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_529 ( V_1384 , 0x40 , V_21 & 0xffff00ff ) ;
F_552 ( V_166 ) ;
V_23 -> V_1355 = F_549 () - V_23 -> V_1413 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_553 ( struct V_477 * V_1384 )
{
struct V_17 * V_23 = F_541 ( V_1384 ) ;
F_162 ( V_23 ) ;
F_539 ( V_1384 ) ;
...
V_432 = F_556 ( & V_1415 . V_1324 , & V_1416 ) ;
if ( V_432 ) {
F_46 ( L_531 ) ;
F_557 ( & V_1415 ) ;
return V_432 ;
