...
static int T_1 F_39 ( char * V_86 )
{
V_3 . V_43 &= ~ V_85 ;
F_40 ( 0 , 17 ) ;
return 1 ;
}
static int T_1 F_41 ( char * V_86 )
{
int V_87 ;
F_42 ( & V_86 , & V_87 ) ;
if ( V_87 && F_23 ( 128 ) )
...
{
#ifdef F_6
unsigned long V_90 = ( unsigned long ) V_27 + ( 4UL << 20 ) ;
if ( ! V_28 || ! V_29 )
return;
if ( V_28 >= V_90 )
return;
memmove ( ( void * ) V_90 , ( void * ) V_28 , V_29 ) ;
V_28 = V_90 ;
#endif
}
static void T_1 F_45 ( T_4 (* F_46)( char * , T_4 ) )
{
char * V_91 , * V_92 ;
T_4 V_74 , V_14 ;
V_14 = strlen ( V_21 ) ;
V_92 = V_21 + V_14 ;
V_91 = V_21 + V_14 + 1 ;
V_74 = F_46 ( V_91 , V_93 - V_14 - 1 ) ;
if ( V_74 ) {
if ( * V_91 == '=' )
memmove ( V_21 , V_91 + 1 , V_74 ) ;
else
* V_92 = ' ' ;
}
}
static inline int F_47 ( const char * V_86 )
{
int V_5 ;
for ( V_5 = 0 ; V_86 [ V_5 ] ; V_5 ++ )
if ( V_86 [ V_5 ] & 0x80 )
return 1 ;
return 0 ;
}
