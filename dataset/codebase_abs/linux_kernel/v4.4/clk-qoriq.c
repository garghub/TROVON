...
static struct V_15 * F_39 ( struct V_62 * V_64 , const char * V_48 )
{
T_1 V_51 ;
if ( F_40 ( V_64 , L_6 , & V_51 ) )
return F_41 ( - V_70 ) ;
return F_42 ( NULL , V_48 , NULL , V_71 , V_51 ) ;
}
...
T_1 T_2 * V_4 ;
T_1 V_74 ;
struct V_75 * V_12 = & V_2 -> V_12 [ V_25 ] ;
int V_49 ;
if ( ! ( V_2 -> V_5 . V_76 & ( 1 << V_25 ) ) )
return;
if ( V_2 -> V_5 . V_6 & V_77 ) {
switch ( V_25 ) {
case V_16 :
...
if ( ( V_2 -> V_5 . V_6 & V_77 ) ||
( ( V_2 -> V_5 . V_6 & V_82 ) && V_25 != V_16 ) )
V_74 = ( V_74 & F_53 ( 8 , 1 ) ) >> 1 ;
else
V_74 = ( V_74 & F_53 ( 6 , 1 ) ) >> 1 ;
for ( V_49 = 0 ; V_49 < F_31 ( V_12 -> div ) ; V_49 ++ ) {
struct V_15 * V_15 ;
snprintf ( V_12 -> div [ V_49 ] . V_48 , sizeof( V_12 -> div [ V_49 ] . V_48 ) ,
L_11 , V_25 , V_49 + 1 ) ;
V_15 = F_46 ( NULL ,
V_12 -> div [ V_49 ] . V_48 , L_12 , 0 , V_74 , V_49 + 1 ) ;
if ( F_23 ( V_15 ) ) {
F_18 ( L_13 ,
...
V_85 = F_58 ( 4 , sizeof( struct V_15 * ) , V_54 ) ;
if ( ! V_85 )
return;
V_84 = F_59 ( sizeof( * V_84 ) , V_54 ) ;
if ( ! V_84 )
goto V_87;
if ( V_86 <= 3 ) {
V_85 [ 0 ] = V_12 -> div [ 0 ] . V_15 ;
V_85 [ 1 ] = V_12 -> div [ 1 ] . V_15 ;
V_85 [ 2 ] = V_12 -> div [ 3 ] . V_15 ;
} else {
V_85 [ 0 ] = V_12 -> div [ 0 ] . V_15 ;
V_85 [ 1 ] = V_12 -> div [ 1 ] . V_15 ;
V_85 [ 2 ] = V_12 -> div [ 2 ] . V_15 ;
V_85 [ 3 ] = V_12 -> div [ 3 ] . V_15 ;
}
V_84 -> V_88 = V_85 ;
V_84 -> V_89 = V_86 ;
V_67 = F_38 ( V_63 , V_90 , V_84 ) ;
if ( V_67 ) {
F_18 ( L_5 ,
V_36 , V_63 -> V_48 , V_67 ) ;
goto V_91;
...
static struct V_15 * F_62 ( struct V_92 * V_93 , void * V_94 )
{
struct V_1 * V_2 = V_94 ;
struct V_15 * V_15 ;
struct V_75 * V_12 ;
...
int V_49 ;
V_98 &= ~ V_100 ;
for ( V_49 = 0 ; V_49 < F_31 ( V_101 ) ; V_49 ++ ) {
if ( V_98 == V_101 [ V_49 ] )
return true ;
}
return false ;
...
for ( V_49 = 0 ; V_49 < F_31 ( V_104 ) ; V_49 ++ ) {
if ( F_66 ( V_63 , V_104 [ V_49 ] . V_105 ) )
break;
if ( V_102 &&
! strcmp ( V_104 [ V_49 ] . V_105 , L_19 ) )
break;
}
if ( V_49 == F_31 ( V_104 ) ) {
F_18 ( L_20 , V_36 ,
