...
V_51 = V_30 -> V_31 ;
V_30 -> V_31 = V_32 ;
if ( V_6 -> V_46 == V_30 -> V_58 ) {
V_13 = F_25 ( V_14 , V_53 , V_30 -> V_58 ,
V_51 & V_59 ) ;
if ( V_13 ) {
V_53 -> V_60 = 0 ;
if ( V_13 != - V_61 )
...
F_26 ( V_30 , V_53 , V_53 -> V_60 ) ;
}
V_13 = F_27 ( F_11 ( V_14 ) -> V_62 , V_30 ,
...
if ( V_41 == NULL )
goto V_44;
V_13 = F_37 ( F_11 ( V_14 ) -> V_62 , V_30 , NULL ) ;
if ( V_13 == - V_65 )
V_13 = F_23 ( V_14 , V_30 ) ;
else if ( V_13 )
F_18 ( L_8 ,
...
F_3 ( & V_19 -> V_24 ) ;
if ( ! F_4 ( & V_19 -> V_27 ) ) {
V_6 = F_42 ( V_19 -> V_27 . V_66 , struct V_5 ,
V_25 ) ;
F_8 ( & V_6 -> V_25 ) ;
} else if ( F_43 ( & V_19 -> V_67 ) )
V_6 = F_44 ( - V_68 ) ;
F_6 ( & V_19 -> V_24 ) ;
return V_6 ;
}
static int F_45 ( void * V_69 )
{
struct V_18 * V_19 = V_69 ;
F_46 ( & V_19 -> V_70 ) ;
while ( 1 ) {
struct V_71 V_72 = { 0 } ;
struct V_5 * V_6 ;
