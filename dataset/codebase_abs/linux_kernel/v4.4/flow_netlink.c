...
static bool F_112 ( T_3 * V_284 , int V_67 )
{
T_3 * V_10 = V_284 + V_67 ;
while ( V_67 -- )
if ( * V_284 ++ & ~ * V_10 ++ )
...
static int F_113 ( const struct V_56 * V_58 ,
const struct V_247 * V_308 ,
struct V_261 * * V_262 ,
bool * V_309 , T_5 V_160 , bool V_310 , bool log )
{
const struct V_56 * V_265 = F_18 ( V_58 ) ;
int V_311 = F_16 ( V_265 ) ;
T_1 V_312 ;
...
V_312 /= 2 ;
if ( V_311 > V_64 ||
! F_12 ( V_312 , V_66 [ V_311 ] . V_67 ) )
return - V_65 ;
if ( V_310 && ! F_112 ( F_18 ( V_265 ) , V_312 ) )
return - V_65 ;
switch ( V_311 ) {
const struct V_163 * V_164 ;
const struct V_173 * V_174 ;
...
if ( V_164 -> V_167 != V_308 -> V_35 . V_38 )
return - V_65 ;
if ( V_164 -> V_165 != V_308 -> V_35 . V_36 )
return - V_65 ;
}
break;
case V_17 :
...
if ( V_174 -> V_178 != V_308 -> V_35 . V_38 )
return - V_65 ;
if ( V_174 -> V_175 != V_308 -> V_35 . V_36 )
return - V_65 ;
}
...
if ( ( V_160 != F_5 ( V_34 ) &&
V_160 != F_5 ( V_43 ) ) ||
V_308 -> V_35 . V_38 != V_41 )
return - V_65 ;
break;
case V_20 :
if ( ( V_160 != F_5 ( V_34 ) &&
V_160 != F_5 ( V_43 ) ) ||
V_308 -> V_35 . V_38 != V_39 )
return - V_65 ;
break;
case V_26 :
if ( ! F_6 ( V_160 ) )
...
if ( V_8 < 0 )
return V_8 ;
V_313 = F_97 ( V_262 , V_311 , NULL , V_67 , log ) ;
if ( F_96 ( V_313 ) )
return F_110 ( V_313 ) ;
memcpy ( F_18 ( V_313 ) , F_18 ( V_265 ) , V_312 ) ;
memset ( F_18 ( V_313 ) + V_312 , 0xff , V_312 ) ;
if ( V_311 == V_17 ) {
struct V_173 * V_10 = F_18 ( V_313 ) + V_312 ;
...
static int F_114 ( const struct V_56 * V_57 )
{
static const struct V_315 V_316 [ V_317 + 1 ] = {
[ V_318 ] = { . type = V_319 } ,
[ V_320 ] = { . type = V_321 } ,
[ V_322 ] = { . type = V_319 } ,
} ;
struct V_56 * V_58 [ V_317 + 1 ] ;
int error ;
error = F_115 ( V_58 , V_317 ,
V_57 , V_316 ) ;
if ( error )
return error ;
if ( ! V_58 [ V_318 ] ||
...
static int F_116 ( const struct V_56 * V_323 ,
struct V_261 * * V_262 , bool log )
{
int V_324 = F_93 ( V_323 -> F_17 ) ;
struct V_56 * V_325 ;
V_325 = F_92 ( V_262 , V_323 -> F_17 , log ) ;
if ( F_96 ( V_325 ) )
return F_110 ( V_325 ) ;
memcpy ( V_325 , V_323 , V_324 ) ;
return 0 ;
}
...
return - V_327 ;
F_15 (a, attr, rem) {
static const T_6 V_328 [ V_329 + 1 ] = {
[ V_330 ] = sizeof( T_6 ) ,
[ V_331 ] = sizeof( T_6 ) ,
[ V_332 ] = ( T_6 ) - 1 ,
[ V_333 ] = sizeof( struct V_334 ) ,
[ V_335 ] = sizeof( T_5 ) ,
[ V_336 ] = sizeof( struct V_337 ) ,
[ V_338 ] = 0 ,
[ V_271 ] = ( T_6 ) - 1 ,
[ V_339 ] = ( T_6 ) - 1 ,
[ V_295 ] = ( T_6 ) - 1 ,
...
const struct V_337 * V_342 ;
int type = F_16 ( V_58 ) ;
bool V_309 ;
if ( type > V_329 ||
( V_328 [ type ] != F_17 ( V_58 ) &&
V_328 [ type ] != ( T_6 ) - 1 ) )
return - V_65 ;
V_309 = false ;
switch ( type ) {
...
break;
case V_340 : {
const struct V_341 * V_344 = F_18 ( V_58 ) ;
switch ( V_344 -> V_345 ) {
case V_346 :
break;
default:
...
case V_336 :
V_342 = F_18 ( V_58 ) ;
if ( V_342 -> V_347 != F_5 ( V_237 ) )
return - V_65 ;
if ( ! ( V_342 -> V_288 & F_5 ( V_159 ) ) )
return - V_65 ;
V_288 = V_342 -> V_288 ;
break;
case V_331 :
break;
case V_333 : {
const struct V_334 * V_195 = F_18 ( V_58 ) ;
if ( ! F_6 ( V_195 -> V_348 ) )
return - V_65 ;
if ( V_288 & F_5 ( V_159 ) ||
( V_160 != F_5 ( V_34 ) &&
...
break;
case V_271 :
V_82 = F_113 ( V_58 , V_30 , V_262 ,
& V_309 , V_160 , false , log ) ;
if ( V_82 )
return V_82 ;
break;
case V_339 :
V_82 = F_113 ( V_58 , V_30 , V_262 ,
& V_309 , V_160 , true , log ) ;
if ( V_82 )
return V_82 ;
break;
case V_295 :
...
break;
case V_272 :
V_82 = F_117 ( V_124 , V_58 , V_30 , V_262 , log ) ;
if ( V_82 )
return V_82 ;
V_309 = true ;
break;
...
int F_118 ( struct V_124 * V_124 , const struct V_56 * V_57 ,
const struct V_247 * V_30 ,
struct V_261 * * V_262 , bool log )
{
int V_82 ;
...
static int F_119 ( const struct V_56 * V_57 , struct V_115 * V_116 )
{
const struct V_56 * V_58 ;
struct V_56 * V_8 ;
int V_82 = 0 , V_63 ;
...
break;
case V_293 :
V_349 = F_36 ( V_116 , V_293 ) ;
if ( ! V_349 )
return - V_118 ;
V_82 = F_120 ( F_18 ( V_58 ) , F_17 ( V_58 ) , V_116 ) ;
if ( V_82 )
return V_82 ;
F_38 ( V_116 , V_349 ) ;
break;
...
static int F_121 ( const struct V_56 * V_58 , struct V_115 * V_116 )
{
const struct V_56 * V_265 = F_18 ( V_58 ) ;
int V_311 = F_16 ( V_265 ) ;
struct V_56 * V_8 ;
...
static int F_122 ( const struct V_56 * V_58 ,
struct V_115 * V_116 )
{
const struct V_56 * V_265 = F_18 ( V_58 ) ;
struct V_56 * V_61 ;
T_1 V_312 = F_17 ( V_265 ) / 2 ;
V_61 = F_36 ( V_116 , V_271 ) ;
if ( ! V_61 )
return - V_118 ;
if ( F_46 ( V_116 , F_16 ( V_265 ) , V_312 , F_18 ( V_265 ) ) )
return - V_118 ;
F_38 ( V_116 , V_61 ) ;
return 0 ;
}
int F_120 ( const struct V_56 * V_57 , int V_67 , struct V_115 * V_116 )
{
const struct V_56 * V_58 ;
int V_63 , V_82 ;
F_86 (a, attr, len, rem) {
...
break;
case V_295 :
V_82 = F_119 ( V_58 , V_116 ) ;
if ( V_82 )
return V_82 ;
break;
case V_272 :
V_82 = F_123 ( F_18 ( V_58 ) , V_116 ) ;
if ( V_82 )
return V_82 ;
break;
default:
