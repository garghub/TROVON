...
V_3 -> V_7 = V_9 ;
V_9 -> V_2 . V_7 = V_3 ;
V_9 -> V_2 . V_57 . V_58 = & V_9 -> V_59 -> V_57 ;
V_35 = F_14 ( V_34 , NULL ) ;
if ( ! V_35 )
return - V_60 ;
V_37 . V_61 = V_35 ;
V_9 -> V_2 . V_62 = F_15 ( V_63 , L_1 ,
F_16 ( & V_9 -> V_59 -> V_57 ) , V_35 -> V_62 ) ;
if ( ! V_9 -> V_2 . V_62 ) {
V_38 = - V_64 ;
goto V_65;
}
...
static int F_21 ( struct V_66 * V_59 )
{
struct V_8 * V_9 ;
const T_4 * V_67 ;
T_5 V_4 ;
T_5 V_68 ;
int V_65 , V_31 ;
V_67 = F_22 ( V_59 -> V_57 . V_61 , L_2 , & V_31 ) ;
if ( V_67 == NULL || V_31 != 12 ) {
F_23 ( & V_59 -> V_57 , L_3 , V_31 ) ;
return - V_69 ;
}
V_68 = F_24 ( V_67 [ 0 ] ) ;
if ( V_68 >= V_70 ) {
F_23 ( & V_59 -> V_57 , L_4 , V_68 ) ;
return - V_71 ;
}
V_9 = & V_72 [ V_68 ] ;
V_9 -> V_13 = V_68 ;
...
V_9 -> V_59 = V_59 ;
F_27 ( & V_59 -> V_57 , V_9 ) ;
V_9 -> V_10 = F_28 ( V_59 -> V_57 . V_61 , 0 ) ;
if ( ! V_9 -> V_10 ) {
F_23 ( & V_59 -> V_57 , L_5 ) ;
return - V_75 ;
}
V_4 = F_3 ( V_9 -> V_13 ) ;
V_67 = F_22 ( V_59 -> V_57 . V_61 , L_6 , NULL ) ;
if ( V_67 )
V_4 |= F_29 ( V_67 ) ;
F_4 ( V_9 -> V_10 + V_11 , V_4 ) ;
V_67 = F_22 ( V_59 -> V_57 . V_61 , L_7 , NULL ) ;
if ( V_67 ) {
int V_76 = V_77 + ( V_9 -> V_13 << 2 ) ;
F_4 ( V_9 -> V_10 + V_76 , F_29 ( V_67 ) ) ;
}
V_65 = F_13 ( V_9 , V_59 -> V_57 . V_61 ) ;
if ( V_65 ) {
F_30 ( V_9 -> V_10 ) ;
return V_65 ;
}
...
static int F_31 ( struct V_66 * V_59 )
{
struct V_8 * V_9 = F_32 ( & V_59 -> V_57 ) ;
F_33 ( & V_9 -> V_2 ) ;
F_20 ( V_9 -> V_2 . V_62 ) ;
return 0 ;
}
