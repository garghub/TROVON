...
void T_6 * * V_112 , unsigned long * V_113 )
{
struct V_3 * V_4 ;
...
V_114 = V_111 * 512 ;
V_116 = ( void * ) ( V_4 -> V_23 + V_114 ) ;
* V_113 = F_75 ( V_116 ) >> V_117 ;
* V_112 = ( void T_6 * ) V_116 ;
return V_115 - V_114 ;
}
static void
F_76 ( void )
