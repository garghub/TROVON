...
static int F_44 ( struct V_20 * V_58 ,
...
int T_3 F_53 ( struct V_70 * V_71 )
{
if ( V_3 || V_17 )
return - V_72 ;
V_56 = V_71 -> V_73 [ 1 ] . V_74 ;
V_3 = F_54 ( V_71 -> V_73 [ 0 ] . V_74 , F_55 ( & V_71 -> V_73 [ 0 ] ) ) ;
if ( ! V_3 )
return - V_64 ;
return F_45 ( NULL ) ;
}
static void T_3 F_56 ( struct V_43 * V_44 )
{
int V_45 ;
V_56 = F_57 ( V_44 , 0 ) ;
if ( ! V_56 ) {
