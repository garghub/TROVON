...
sizeof( V_64 -> V_67 ) ) ;
sprintf ( V_64 -> V_70 , L_9 , F_32 ( V_4 -> V_71 ) ) ;
V_64 -> V_72 =
V_73 |
V_74 |
V_75 ;
...
return NULL ;
* V_137 = * V_136 ;
snprintf ( V_137 -> V_66 , sizeof( V_137 -> V_66 ) , L_38 , V_4 -> V_66 ,
