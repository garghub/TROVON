...
T_1 V_3 = V_20 -> V_3 ;
struct V_202 * V_203 = V_201 -> V_203 ;
struct V_254 * V_255 = V_2 -> V_74 -> V_245 . V_256 ;
bool V_94 ;
int V_175 ;
if ( F_66 ( V_2 ) || F_92 ( V_2 ) ) {
F_85 ( V_2 , V_20 ) ;
...
if ( V_255 && V_255 -> V_92 && V_255 -> V_92 -> V_257 )
V_255 -> V_92 -> V_257 ( V_255 -> V_258 ,
F_123 ( V_3 ) ,
V_203 -> V_259 ) ;
V_94 = F_121 ( V_2 , V_12 ) ;
F_10 ( & V_20 -> V_26 ) ;
...
return V_5 -> V_92 . V_260 ( V_2 , V_12 , V_3 , V_182 , V_183 ) ;
}
static int F_125 ( struct V_9 * V_10 ,
struct V_1 * V_2 ,
struct V_200 * V_201 )
{
F_126 ( V_2 , V_10 -> V_146 ) ;
return 0 ;
}
...
struct V_17 * V_18 )
{
struct V_261 * V_89 = F_9 ( V_16 ) ;
struct V_1 * V_2 = V_89 -> V_63 ;
struct V_4 * V_5 = V_2 -> V_5 ;
V_18 -> type = V_262 ;
V_18 -> V_27 = V_5 -> V_205 ;
V_18 -> V_32 . integer . V_263 = 0 ;
V_18 -> V_32 . integer . V_264 = V_265 ;
return 0 ;
}
static int F_129 ( struct V_78 * V_266 ,
int V_81 )
{
if ( V_266 -> V_81 != V_81 )
return - 1 ;
...
static void F_130 ( struct V_78 * V_266 ,
unsigned int * V_144 , int V_81 )
{
int V_27 = 0 ;
int V_68 ;
for ( V_68 = 7 ; V_68 >= 0 ; V_68 -- ) {
int V_109 = V_266 -> V_83 [ V_68 ] ;
if ( ! V_109 )
continue;
...
static int F_131 ( struct V_15 * V_16 , int V_268 ,
unsigned int V_121 , unsigned int T_4 * V_269 )
{
struct V_261 * V_89 = F_9 ( V_16 ) ;
struct V_1 * V_2 = V_89 -> V_63 ;
struct V_4 * V_5 = V_2 -> V_5 ;
...
struct V_78 * V_266 ;
V_266 = V_80 ;
for ( V_76 = 0 ; V_76 < F_13 ( V_80 ) ; V_76 ++ , V_266 ++ ) {
int V_273 = V_57 * 4 ;
int type = V_5 -> V_92 . V_274 ( V_266 , V_57 ) ;
...
V_121 -= V_273 ;
V_27 += V_273 ;
V_5 -> V_92 . V_276 ( V_266 , V_275 , V_57 ) ;
if ( F_133 ( V_270 , V_275 , V_273 ) )
return - V_272 ;
V_270 += V_57 ;
}
}
if ( F_132 ( V_27 , V_269 + 1 ) )
return - V_272 ;
return 0 ;
}
...
int V_76 , V_38 , V_84 , V_278 = 0 ;
V_277 = F_136 ( V_16 , & V_31 -> V_41 ) ;
V_201 = F_137 ( V_89 , V_277 ) ;
if ( ! V_201 || ! V_201 -> V_203 )
return 0 ;
switch ( V_201 -> V_203 -> V_252 -> V_279 ) {
case V_280 :
case V_281 :
break;
case V_282 :
...
return - V_8 ;
if ( V_5 -> V_92 . V_284 ) {
V_38 = V_5 -> V_92 . V_284 ( V_84 , F_13 ( V_144 ) , V_144 ) ;
if ( V_38 )
return V_38 ;
}
F_10 ( & V_20 -> V_26 ) ;
...
struct V_285 * V_89 ;
struct V_9 * V_286 ;
V_89 = F_139 ( V_2 , L_26 , V_6 ) ;
if ( ! V_89 )
return - V_40 ;
V_5 -> V_287 [ V_6 ] = V_89 ;
V_89 -> V_288 = V_289 ;
V_89 -> V_290 = true ;
V_286 = & V_89 -> V_11 [ V_291 ] ;
V_286 -> V_292 = 1 ;
V_286 -> V_92 = V_293 ;
}
return 0 ;
}
static int F_140 ( struct V_1 * V_2 , int V_6 )
{
char V_294 [ 32 ] = L_27 ;
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_19 * V_20 = F_2 ( V_5 , V_6 ) ;
int V_295 = F_5 ( V_5 , V_6 ) -> V_36 ;
bool V_296 ;
if ( V_295 > 0 )
sprintf ( V_294 + strlen ( V_294 ) , L_28 , V_295 ) ;
V_296 = ! F_141 ( V_2 , V_20 -> V_3 ) ;
if ( V_296 )
strncat ( V_294 , L_29 ,
sizeof( V_294 ) - strlen ( V_294 ) - 1 ) ;
return F_142 ( V_2 , V_20 -> V_3 , V_294 ,
V_296 ) ;
}
...
int V_76 ;
V_297 = V_5 -> V_287 [ V_6 ] ;
if ( ! V_297 || ! V_297 -> V_297 )
break;
V_38 = F_145 ( V_297 -> V_297 ,
V_291 ,
NULL , 0 , V_6 , & V_144 ) ;
if ( V_38 < 0 )
return V_38 ;
...
static void F_151 ( struct V_4 * V_5 , int V_304 )
{
F_152 ( & V_5 -> V_240 , sizeof( struct V_19 ) , V_304 ) ;
F_152 ( & V_5 -> V_242 , sizeof( struct V_187 ) , V_304 ) ;
}
...
T_1 V_308 [ 4 ] ;
int V_309 ;
V_309 = F_98 ( V_2 , V_146 , V_308 , F_13 ( V_308 ) ) ;
if ( V_309 == V_5 -> V_14 &&
! memcmp ( V_308 , V_5 -> V_243 , V_5 -> V_14 * sizeof( T_1 ) ) )
return;
F_40 ( V_2 , L_30 , V_146 ) ;
F_161 ( V_2 , V_146 , V_5 -> V_14 , V_5 -> V_243 ) ;
}
static void F_162 ( struct V_1 * V_2 ,
bool V_310 )
{
unsigned int V_311 ;
V_311 = F_19 ( V_2 , V_312 , 0 ,
V_313 , 0 ) ;
...
return;
V_311 |= V_316 ;
F_165 ( & V_2 -> V_245 , V_315 ) ;
F_86 ( V_2 , V_312 , 0 ,
V_315 , V_311 ) ;
}
static void F_166 ( struct V_1 * V_2 , T_1 V_317 ,
unsigned int V_318 )
{
if ( V_318 == V_169 ) {
F_162 ( V_2 , false ) ;
...
F_19 ( V_2 , V_317 , 0 , V_170 , V_318 ) ;
F_167 ( V_2 , V_317 , V_318 ) ;
}
static void F_168 ( void * V_319 , int V_320 )
{
struct V_1 * V_2 = V_319 ;
int V_3 = V_320 + 0x04 ;
if ( F_169 ( V_2 -> V_67 ) != V_321 )
return;
F_67 ( V_2 , V_3 ) ;
}
...
if ( F_92 ( V_2 ) || F_172 ( V_2 ) ||
F_173 ( V_2 ) )
V_2 -> V_245 . V_324 = 1 ;
if ( F_66 ( V_2 ) || F_92 ( V_2 ) ) {
V_2 -> V_325 = 0 ;
V_5 -> V_326 . V_319 = V_2 ;
V_5 -> V_326 . V_327 = F_168 ;
F_156 ( & V_5 -> V_326 ) ;
}
if ( F_119 ( V_2 ) < 0 ) {
V_2 -> V_5 = NULL ;
...
V_286 = & V_89 -> V_11 [ V_291 ] ;
* V_286 = V_5 -> V_332 ;
V_286 -> V_146 = V_188 -> V_12 ;
if ( V_286 -> V_205 <= 2 && V_241 && V_241 <= 16 )
V_286 -> V_205 = V_241 ;
return 0 ;
}
...
F_21 ( V_2 , V_333 , 0 ,
V_55 , V_54 ) ;
if ( F_24 ( V_2 , V_333 ) & V_50 )
F_21 ( V_2 , V_333 , 0 , V_51 ,
V_52 ) ;
F_180 ( V_2 , V_333 ) ;
return 0 ;
}
...
V_356 = 0x2 ;
if ( V_2 -> V_358 && ( V_250 -> V_359 & V_360 ) )
F_21 ( V_2 ,
V_352 ,
0 ,
V_361 ,
V_250 -> V_359 & ~ V_360 & 0xff ) ;
F_21 ( V_2 , V_352 , 0 ,
V_353 , ( V_182 << 4 ) | 0x0 ) ;
F_21 ( V_2 , V_352 , 0 ,
V_355 , V_183 ) ;
...
{
struct V_4 * V_5 ;
int V_38 = F_191 ( V_2 , V_352 ,
V_363 ) ;
if ( V_38 < 0 )
return V_38 ;
V_2 -> V_305 . V_306 = F_182 ;
V_5 = V_2 -> V_5 ;
V_5 -> V_332 . V_206 = V_364 ;
V_5 -> V_332 . V_208 = V_365 ;
V_5 -> V_332 . V_207 = V_366 ;
return 0 ;
}
...
case 0x10de0005 :
case 0x10de0006 :
V_144 -> V_368 = ( 1U << 2 ) | ( 1U << 8 ) ;
break;
case 0x10de0007 :
V_144 -> V_368 = ( 1U << 2 ) | ( 1U << 6 ) | ( 1U << 8 ) ;
}
return 0 ;
}
...
V_5 -> V_342 . V_344 = 8 ;
V_5 -> V_332 = V_369 ;
V_2 -> V_305 . V_306 = F_184 ;
V_2 -> V_305 . V_370 = F_196 ;
V_2 -> V_305 . V_371 = F_197 ;
F_192 ( V_2 , 8 ) ;
return 0 ;
}
static int F_199 ( struct V_78 * V_266 ,
int V_81 )
{
if ( V_266 -> V_85 == 0x00 && V_81 == 2 )
return V_372 ;
return F_129 ( V_266 , V_81 ) ;
}
static int F_200 ( int V_84 , int V_57 , unsigned char * V_105 )
{
if ( V_84 == 0x00 && ( V_105 [ 0 ] != V_373 || V_105 [ 1 ] != V_374 ) )
return - V_8 ;
return 0 ;
}
...
V_5 -> V_92 . V_274 =
F_199 ;
V_5 -> V_92 . V_284 = F_200 ;
return 0 ;
}
static void F_202 ( struct V_1 * V_2 , unsigned int V_183 )
{
unsigned int V_32 ;
V_32 = F_19 ( V_2 , V_375 , 0 ,
V_376 , 0 ) ;
V_32 = ( V_32 >> 24 ) & 0xff ;
F_21 ( V_2 , V_375 , 0 ,
V_377 ,
...
{
F_202 ( V_2 , 0 ) ;
return F_125 ( V_10 , V_2 , V_201 ) ;
}
static struct V_285 * F_205 ( struct V_1 * V_2 , int type )
{
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned int V_76 ;
for ( V_76 = 0 ; V_76 < V_5 -> V_7 ; V_76 ++ ) {
struct V_285 * V_297 = F_5 ( V_5 , V_76 ) ;
if ( V_297 -> V_288 == type )
return V_297 ;
}
return NULL ;
...
if ( V_38 < 0 )
return V_38 ;
V_297 = F_205 ( V_2 , V_289 ) ;
if ( ! V_297 )
return - V_193 ;
V_11 = & V_297 -> V_11 [ V_291 ] ;
V_11 -> V_92 . V_383 = F_203 ;
V_11 -> V_92 . V_384 = F_204 ;
return 0 ;
}
...
if ( V_38 )
return V_38 ;
V_2 -> V_305 . V_370 = F_206 ;
return 0 ;
}
static int F_208 ( struct V_1 * V_2 , T_1 V_146 ,
unsigned char * V_86 , int * V_29 )
{
return F_209 ( V_2 , V_146 , V_86 , V_29 ,
F_210 ( V_2 ) ) ;
}
static void F_211 ( struct V_1 * V_2 , T_1 V_3 , int V_84 ,
int V_132 , int V_133 )
{
F_21 ( V_2 , V_3 , 0 , V_385 , V_84 ) ;
}
static int F_212 ( int V_107 )
{
switch ( V_107 ) {
case 2 : return 3 ;
case 3 : return 2 ;
...
static int F_213 ( int V_84 , int V_57 , unsigned char * V_105 )
{
struct V_78 * V_266 ;
int V_76 , V_77 ;
V_266 = & V_80 [ F_37 ( V_84 ) ] ;
for ( V_76 = 0 ; V_76 < V_57 ; ++ V_76 ) {
int V_108 = F_45 ( V_105 [ V_76 ] ) ;
bool V_386 = false ;
bool V_387 = false ;
...
int V_388 = 7 - F_212 ( V_77 ) ;
if ( V_266 -> V_83 [ V_388 ] == V_108 ) {
V_386 = true ;
if ( V_76 % 2 == 0 && V_76 + 1 < V_57 ) {
int V_389 = 7 - F_212 ( V_77 + 1 ) ;
int V_390 = F_45 ( V_105 [ V_76 + 1 ] ) ;
int V_391 = V_266 -> V_83 [ V_389 ] ;
if ( V_390 == V_391 )
V_387 = true ;
else
return - V_8 ;
...
if ( ! F_215 ( V_2 ) ) {
V_99 = F_212 ( V_99 ) ;
if ( V_99 % 2 != 0 && V_392 == 0xf )
return 0 ;
V_99 -= V_99 % 2 ;
if ( V_392 != 0xf )
V_392 -= V_392 % 2 ;
}
V_393 = V_395 + V_99 / 2 + ( V_99 % 2 ) * 0x00e ;
if ( V_392 != 0xf )
V_394 = ( V_392 << 4 ) | V_396 ;
return F_21 ( V_2 , V_3 , 0 , V_393 , V_394 ) ;
}
...
V_393 = V_399 + V_398 / 2 + ( V_398 % 2 ) * 0x00e ;
V_394 = F_19 ( V_2 , V_3 , 0 , V_393 , 0 ) ;
if ( ! ( V_394 & V_396 ) )
return 0xf ;
return ( ( V_394 & 0xf0 ) >> 4 ) + ! ! V_397 ;
}
static int F_217 ( struct V_78 * V_266 ,
int V_81 )
{
int V_68 ;
int V_400 = 0 ;
...
if ( V_266 -> V_83 [ V_68 ] || V_266 -> V_83 [ V_68 + 1 ] )
V_400 ++ ;
}
if ( V_400 * 2 != V_81 )
return - 1 ;
...
static void F_218 ( struct V_78 * V_266 ,
unsigned int * V_144 , int V_81 )
{
int V_27 = 0 ;
int V_68 ;
for ( V_68 = 7 ; V_68 >= 0 ; V_68 -- ) {
int V_349 = 7 - F_212 ( 7 - V_68 ) ;
int V_109 = V_266 -> V_83 [ V_349 ] ;
if ( ! V_109 ) {
if ( V_266 -> V_83 [ V_349 + ( V_349 % 2 ? - 1 : 1 ) ] )
V_144 [ V_27 ++ ] = V_402 ;
continue;
}
V_144 [ V_27 ++ ] = F_47 ( V_109 ) ;
...
static int F_219 ( struct V_1 * V_2 , T_1 V_3 ,
bool V_174 )
{
int V_403 , V_404 ;
V_403 = F_19 ( V_2 , V_3 , 0 , V_405 , 0 ) ;
if ( V_403 >= 0 && ( V_403 & V_406 ) ) {
if ( V_174 )
V_404 = V_403 | V_407 ;
else
V_404 = V_403 & ~ V_407 ;
...
static int F_220 ( struct V_1 * V_2 , T_1 V_12 ,
T_1 V_3 , T_3 V_182 , int V_183 )
{
if ( F_210 ( V_2 ) ) {
int V_409 = 180 ;
...
if ( V_38 )
return V_38 ;
V_2 -> V_305 . V_306 = F_221 ;
V_5 = V_2 -> V_5 ;
V_5 -> V_92 . V_224 = F_208 ;
V_5 -> V_92 . V_93 = F_216 ;
V_5 -> V_92 . V_101 = F_214 ;
V_5 -> V_92 . V_145 = F_211 ;
V_5 -> V_92 . V_184 = F_219 ;
V_5 -> V_92 . V_260 = F_220 ;
if ( ! F_215 ( V_2 ) ) {
V_5 -> V_92 . V_274 =
F_217 ;
V_5 -> V_92 . V_276 = F_218 ;
V_5 -> V_92 . V_284 = F_213 ;
}
for ( V_13 = 0 ; V_13 < V_5 -> V_14 ; V_13 ++ ) {
V_188 = F_7 ( V_5 , V_13 ) ;
V_188 -> V_205 = V_264 ( V_188 -> V_205 , 8u ) ;
V_188 -> V_206 |= V_364 ;
V_188 -> V_207 |= V_366 ;
V_188 -> V_208 = V_264 ( V_188 -> V_208 , 24u ) ;
}
V_5 -> V_205 = V_264 ( V_5 -> V_205 , 8u ) ;
return 0 ;
}
static int F_223 ( struct V_1 * V_2 )
{
return F_191 ( V_2 , V_415 , V_416 ) ;
}
