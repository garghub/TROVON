...
if ( V_12 < 0 )
return V_12 ;
V_30 = F_35 ( V_30 , ( unsigned long )
V_9 -> V_21 . V_32 >> 1 ) ;
if ( V_20 > V_30 || V_20 < V_31 )
return - V_7 ;
F_36 ( V_9 -> V_33 ) ;
V_9 -> V_21 . V_34 = V_20 << 1 ;
F_37 ( V_9 -> V_33 ) ;
return V_12 ;
}
...
{
bool V_38 = F_46 ( V_39 , & V_9 -> V_40 ) ;
bool V_41 = F_46 ( V_42 , & V_9 -> V_40 ) ;
return F_1 ( V_38 << V_41 , V_2 ) ;
}
static T_1
...
{
return F_1 ( F_46 ( V_43 , & V_9 -> V_40 ) , V_2 ) ;
}
