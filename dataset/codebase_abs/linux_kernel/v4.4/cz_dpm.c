...
{
int V_327 = 0 ;
T_6 V_328 = F_29 ( 0xC0300E0C ) ;
if ( V_328 )
V_327 = 1000 * ( ( V_328 / 8 ) - 49 ) ;
return V_327 ;
}
...
static T_6 F_111 ( struct V_7 * V_8 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
if ( ! V_9 -> V_337 ) {
F_55 ( V_8 , V_266 ) ;
V_9 -> V_337 = F_56 ( V_8 ) + 1 ;
}
if ( V_9 -> V_337 > V_152 ) {
F_8 ( L_41 ) ;
return - V_42 ;
...
static T_6 F_116 ( struct V_7 * V_8 , bool V_341 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
struct V_1 * V_342 = F_1 ( & V_9 -> V_310 ) ;
if ( V_341 )
return V_342 -> V_93 [ 0 ] . V_22 ;
else
return V_342 -> V_93 [ V_342 -> V_92 - 1 ] . V_22 ;
}
static T_6 F_117 ( struct V_7 * V_8 , bool V_341 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
return V_9 -> V_28 . V_46 ;
}
static int F_118 ( struct V_7 * V_8 , bool V_295 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
int V_156 = 0 ;
if ( V_295 && V_9 -> V_187 ) {
...
static int F_119 ( struct V_7 * V_8 , bool V_346 )
{
return F_118 ( V_8 , ! V_346 ) ;
}
static void F_40 ( struct V_7 * V_8 , bool V_346 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
int V_156 ;
if ( V_9 -> V_223 == V_346 )
...
if ( V_346 ) {
if ( V_9 -> V_184 ) {
V_156 = F_120 ( V_8 , V_347 ,
V_348 ) ;
V_156 = F_121 ( V_8 , V_347 ,
V_349 ) ;
}
F_119 ( V_8 , V_346 ) ;
if ( V_9 -> V_184 )
...
static int F_122 ( struct V_7 * V_8 , bool V_295 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
int V_156 = 0 ;
if ( V_295 && V_9 -> V_190 ) {
...
static void F_41 ( struct V_7 * V_8 , bool V_346 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
if ( V_9 -> V_188 ) {
if ( V_9 -> V_224 != V_346 ) {
