...
{
long V_41 , V_7 = F_31 ( V_2 -> V_7 ) ;
while ( true ) {
if ( ! ( V_7 == 0 || V_7 == V_33 ) )
return false ;
V_41 = F_27 ( & V_2 -> V_7 , V_7 ,
V_7 + V_40 ) ;
if ( V_41 == V_7 ) {
F_29 ( V_2 ) ;
return true ;
...
T_1
struct V_1 T_2 * F_47 ( struct V_1 * V_2 )
{
long V_7 ;
bool V_46 = true ;
struct V_15 V_16 ;
