...
if ( ! V_70 )
return - V_72 ;
memcpy ( F_4 ( V_70 , V_3 -> V_17 . V_74 ) ,
( ( T_1 * ) V_3 -> V_17 . V_18 -> V_33 ) +
V_3 -> V_17 . V_68 ,
V_3 -> V_17 . V_74 ) ;
F_27 ( V_3 -> V_8 , V_70 ) ;
V_3 -> V_17 . V_66 = V_80 ;
...
static int F_29 ( struct V_2 * V_3 , struct V_1 * V_5 )
{
...
static void F_30 ( struct V_90 * V_91 )
{
int V_92 ;
struct V_1 * V_5 ;
struct V_93 * V_17 = F_31 ( V_91 ,
struct V_93 ,
V_94 ) ;
struct V_2 * V_3 = F_31 ( V_17 ,
struct V_2 ,
V_17 ) ;
while ( ( V_5 = F_32 ( & V_17 -> V_95 ) ) ) {
F_33 ( V_3 -> V_8 -> V_25 , V_5 ,
V_96 , V_97 ) ;
switch ( V_17 -> V_28 ) {
case V_29 :
V_92 = F_17 ( V_3 , V_5 ) ;
...
{
char V_26 [ 32 ] ;
F_36 ( & V_3 -> V_17 . V_94 , F_30 ) ;
snprintf ( V_26 , sizeof( V_26 ) , L_11 ,
F_37 ( V_3 -> V_24 ) ) ;
V_3 -> V_17 . V_99 = F_38 ( V_26 ) ;
if ( ! V_3 -> V_17 . V_99 )
return - V_72 ;
F_39 ( & V_3 -> V_17 . V_95 ) ;
return 0 ;
...
F_11 ( & V_3 -> V_8 -> V_22 ) ;
F_9 ( & V_3 -> V_8 -> V_21 , 1 ) ;
F_43 ( & V_3 -> V_17 . V_95 , V_5 ) ;
F_44 ( V_3 -> V_17 . V_99 , & V_3 -> V_17 . V_94 ) ;
}
void F_45 ( struct V_2 * V_3 )
{
F_7 ( V_3 , - V_100 ) ;
}
int F_46 ( struct V_101 * V_8 , const char * V_102 )
{
struct V_2 * V_3 = F_47 ( V_8 ) ;
...
if ( F_48 ( & V_17 -> V_18 , V_102 , V_3 -> V_24 ) < 0 ) {
F_16 ( V_3 -> V_24 , L_12 , V_102 ) ;
return - V_105 ;
}
V_17 -> V_19 = ( const struct V_106 * ) V_3 -> V_17 . V_18 -> V_33 ;
if ( V_17 -> V_19 -> V_107 != V_108 ||
V_17 -> V_19 -> V_53 != V_3 -> V_53 ) {
F_16 ( V_3 -> V_24 , L_13 ,
V_102 , V_17 -> V_19 -> V_107 ,
V_17 -> V_19 -> V_53 ) ;
F_8 ( V_17 -> V_18 ) ;
V_17 -> V_19 = NULL ;
return - V_34 ;
...
F_49 ( & V_3 -> V_17 . V_23 , F_15 ,
( unsigned long ) V_3 ) ;
F_50 ( & V_3 -> V_17 . V_23 ,
V_109 + F_51 ( V_110 ) ) ;
V_3 -> V_85 -> V_86 ( V_3 ,
& V_17 -> V_19 -> V_111 . V_87 ) ;
F_9 ( & V_3 -> V_8 -> V_21 , 1 ) ;
V_3 -> V_17 . V_28 = V_29 ;
F_52 ( V_3 ) ;
return 0 ;
