...
{
struct V_5 * V_6 = V_28 -> V_22 ;
V_28 -> V_49 = V_6 -> V_13 -> V_177 [ V_3 ] ;
if ( ! V_28 -> V_49 ) {
F_96 ( V_176 , L_11 , V_3 ) ;
return - V_178 ;
}
if ( V_28 -> V_179 == V_180 )
V_28 -> V_179 = V_28 -> V_49 -> V_181 ;
F_97 ( V_176 , V_28 -> V_49 , F_92 ,
V_28 -> V_179 ) ;
return 0 ;
}
...
{
struct V_5 * V_6 = V_28 -> V_22 ;
struct V_182 * V_183 = V_6 -> V_20 ;
struct V_184 * V_185 , * V_186 ;
bool V_187 = false ;
T_4 V_188 = 0 ;
int V_189 , V_87 ;
V_186 = V_183 -> V_186 [ V_28 -> V_48 ] ;
V_189 = F_99 ( V_186 ) ;
if ( V_189 < 0 )
V_189 = V_180 ;
V_28 -> V_179 = V_189 ;
V_185 = F_100 ( V_186 , L_12 , 0 ) ;
if ( F_101 ( V_186 ) ) {
V_87 = F_102 ( V_186 ) ;
if ( V_87 ) {
F_96 ( V_176 , L_13 , V_87 ) ;
return V_87 ;
}
V_187 = true ;
V_185 = V_186 ;
...
if ( V_6 -> V_9 -> V_190 )
V_188 = V_6 -> V_9 -> V_190 ( V_6 , V_28 -> V_48 ) ;
if ( V_185 ) {
int V_191 = F_103 ( & V_176 -> V_26 , V_185 ) ;
if ( ! V_187 && V_191 >= 0 &&
( V_6 -> V_8 & ( 1 << V_191 ) ) ) {
V_87 = F_95 ( V_28 , V_176 , V_191 ) ;
if ( V_87 ) {
F_96 ( V_176 , L_14 , V_191 , V_87 ) ;
return V_87 ;
}
} else {
V_28 -> V_49 = F_104 ( V_176 , V_185 ,
F_92 ,
V_188 ,
V_28 -> V_179 ) ;
}
...
if ( V_28 -> V_49 && V_187 )
F_105 ( V_28 -> V_49 , F_94 ) ;
if ( ! V_28 -> V_49 ) {
V_87 = F_95 ( V_28 , V_176 , V_28 -> V_48 ) ;
if ( V_87 ) {
F_96 ( V_176 , L_15 , V_28 -> V_48 , V_87 ) ;
return V_87 ;
}
} else {
F_106 ( V_176 , L_16 ,
...
int F_114 ( struct V_5 * V_6 , struct V_197 * V_22 ,
int V_48 , char * V_14 )
{
struct V_25 * V_33 = V_6 -> V_29 -> V_30 ;
struct V_25 * V_176 ;
struct V_27 * V_28 ;
int V_87 ;
V_176 = F_115 ( sizeof( struct V_27 ) , V_14 ,
V_198 , V_199 ) ;
if ( V_176 == NULL )
return - V_165 ;
V_176 -> V_200 = V_33 -> V_201 ;
V_176 -> V_202 = & V_203 ;
F_116 ( V_176 , V_33 ) ;
V_176 -> V_96 |= V_204 ;
V_176 -> V_205 = & V_206 ;
...
NULL ) ;
F_119 ( V_176 , V_22 ) ;
V_176 -> V_26 . V_210 = V_6 -> V_20 -> V_186 [ V_48 ] ;
V_176 -> V_201 = V_33 -> V_201 ;
V_28 = F_5 ( V_176 ) ;
V_28 -> V_26 = V_176 ;
V_28 -> V_22 = V_6 ;
V_28 -> V_48 = V_48 ;
switch ( V_6 -> V_29 -> V_211 ) {
#ifdef F_120
case V_212 :
V_28 -> V_121 = V_213 . V_121 ;
break;
#endif
#ifdef F_121
case V_214 :
V_28 -> V_121 = V_215 . V_121 ;
break;
#endif
#ifdef F_122
case V_216 :
V_28 -> V_121 = V_217 . V_121 ;
break;
#endif
#ifdef F_123
case V_218 :
V_28 -> V_121 = V_219 . V_121 ;
break;
#endif
default:
V_28 -> V_121 = F_59 ;
...
static bool F_128 ( struct V_25 * V_26 )
{
return V_26 -> V_205 == & V_206 ;
}
static int F_129 ( struct V_25 * V_26 )
{
struct V_25 * V_33 = F_130 ( V_26 ) ;
struct V_27 * V_28 = F_5 ( V_26 ) ;
int V_37 = 0 ;
if ( V_33 && V_33 -> V_220 &&
! strcmp ( V_33 -> V_220 -> V_221 , L_19 ) )
V_37 = F_48 ( V_26 , V_33 ) ;
else if ( F_6 ( V_28 ) )
V_37 = F_49 ( V_26 ) ;
return V_37 ;
}
int F_131 ( struct V_222 * V_223 ,
