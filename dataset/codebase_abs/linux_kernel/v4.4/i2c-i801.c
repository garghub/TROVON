...
for ( V_36 = 0 ; V_36 < F_43 ( V_193 ) ; V_36 ++ ) {
if ( V_2 -> V_27 & V_194 & ( 1 << V_36 ) )
F_73 ( & V_6 -> V_6 , L_25 ,
V_193 [ V_36 ] ) ;
}
V_2 -> V_27 &= ~ V_194 ;
...
F_75 ( V_6 ) ;
V_2 -> V_195 = F_76 ( V_6 , V_196 ) ;
if ( ! V_2 -> V_195 ) {
F_4 ( & V_6 -> V_6 ,
L_27 ) ;
return - V_197 ;
}
V_116 = F_77 ( & V_6 -> V_137 [ V_196 ] ) ;
if ( V_116 ) {
return - V_197 ;
}
V_116 = F_78 ( V_6 , 1 << V_196 ,
F_79 ( & V_6 -> V_6 ) ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 ,
L_28 ,
V_2 -> V_195 ,
( unsigned long long ) F_80 ( V_6 , V_196 ) ) ;
return V_116 ;
}
...
F_6 ( F_2 ( F_26 ( V_2 ) ) &
~ ( V_84 | V_60 ) , F_26 ( V_2 ) ) ;
V_2 -> V_26 . V_18 = V_201 / 5 ;
if ( V_2 -> V_27 & V_28 ) {
T_2 V_202 , V_51 ;
F_22 ( V_2 -> V_5 , V_52 , & V_51 ) ;
if ( V_51 & V_53 )
F_15 ( & V_6 -> V_6 , L_31 ) ;
F_22 ( V_2 -> V_5 , V_203 , & V_202 ) ;
if ( V_202 & V_204 ) {
F_81 ( & V_6 -> V_6 , L_32 ) ;
V_2 -> V_27 &= ~ V_28 ;
}
...
F_54 ( V_2 ) ;
F_88 ( & V_2 -> V_26 ) ;
F_29 ( V_6 , V_62 , V_2 -> V_198 ) ;
F_55 ( V_2 -> V_169 ) ;
}
static int F_89 ( struct V_5 * V_6 , T_10 V_206 )
{
struct V_1 * V_2 = F_87 ( V_6 ) ;
F_90 ( V_6 ) ;
F_29 ( V_6 , V_62 , V_2 -> V_198 ) ;
F_91 ( V_6 , F_92 ( V_6 , V_206 ) ) ;
return 0 ;
}
