...
static int F_26 ( struct V_1 * V_2 , const T_1 * V_3 ,
unsigned int V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_19 ) ;
}
static int F_27 ( struct V_1 * V_2 , const T_1 * V_3 ,
unsigned int V_4 , T_1 * V_12 )
{
return F_10 ( V_2 , V_3 , V_4 , V_12 , V_19 ) ;
}
static int F_28 ( struct V_1 * V_2 , T_1 * V_12 )
{
return F_27 ( V_2 , NULL , 0 , V_12 ) ;
}
