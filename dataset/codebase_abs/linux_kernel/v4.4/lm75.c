...
F_29 ( V_5 -> V_63 , V_5 -> V_66 ) ;
F_30 ( V_5 -> V_63 ) ;
F_14 ( V_15 , V_61 , V_5 -> V_62 ) ;
return 0 ;
}
static int F_31 ( struct V_14 * V_68 ,
struct V_69 * V_70 )
{
struct V_71 * V_31 = V_68 -> V_31 ;
int V_72 ;
int V_73 , V_74 , V_75 ;
bool V_76 = 0 ;
if ( ! F_17 ( V_31 , V_32 |
...
if ( V_74 == 0 && V_75 == 0 )
return - V_77 ;
for ( V_72 = 8 ; V_72 <= 248 ; V_72 += 40 ) {
if ( F_32 ( V_68 , V_72 + 1 ) != V_73
|| F_32 ( V_68 , V_72 + 2 ) != V_74
|| F_32 ( V_68 , V_72 + 3 ) != V_75 )
return - V_77 ;
if ( V_76 && F_32 ( V_68 , V_72 + 7 )
!= V_78 )
return - V_77 ;
}
F_33 ( V_70 -> type , V_76 ? L_5 : L_6 , V_79 ) ;
return 0 ;
}
...
static int F_21 ( struct V_14 * V_15 , T_2 V_80 )
{
if ( V_80 == V_61 )
return F_32 ( V_15 , V_80 ) ;
else
return F_37 ( V_15 , V_80 ) ;
}
static int F_14 ( struct V_14 * V_15 , T_2 V_80 , T_5 V_81 )
{
if ( V_80 == V_61 )
return F_38 ( V_15 , V_80 , V_81 ) ;
else
return F_39 ( V_15 , V_80 , V_81 ) ;
}
...
struct V_4 * V_82 = V_5 ;
F_11 ( & V_5 -> V_18 ) ;
if ( F_40 ( V_83 , V_5 -> V_84 + V_5 -> V_39 )
|| ! V_5 -> V_85 ) {
int V_72 ;
F_22 ( & V_15 -> V_3 , L_7 ) ;
for ( V_72 = 0 ; V_72 < F_41 ( V_5 -> V_1 ) ; V_72 ++ ) {
int V_24 ;
V_24 = F_21 ( V_15 , V_21 [ V_72 ] ) ;
if ( F_42 ( V_24 < 0 ) ) {
F_22 ( V_3 ,
L_8 ,
V_21 [ V_72 ] , V_24 ) ;
