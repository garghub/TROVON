...
V_6 = F_22 ( V_2 , V_23 , V_4 ) ;
V_28:
if ( V_4 == & V_26 )
F_19 ( V_4 ) ;
return V_6 ;
}
int F_23 ( struct V_29 * V_30 , T_2 V_23 )
{
int V_6 ;
struct V_3 V_4 ;
if ( V_23 != V_31 )
...
void F_25 ( struct V_10 * V_11 , T_2 V_23 )
{
struct V_12 * V_13 = V_11 -> V_14 ;
if ( V_23 == V_31 )
V_13 -> V_21 = V_33 ;
...
int F_26 ( struct V_10 * V_11 , T_2 V_23 )
{
int V_6 ;
struct V_12 * V_13 = V_11 -> V_14 ;
struct V_3 * V_4 ;
...
V_6 = F_29 ( V_13 -> V_5 , V_38 , V_13 -> V_41 , V_39 , V_37 ) ;
if ( V_6 == 0 )
return 0 ;
if ( V_38 != V_40 )
F_12 ( V_2 , V_6 , 0 ) ;
...
int F_34 ( struct V_10 * V_11 , struct V_55 * V_56 )
{
int V_6 ;
struct V_12 * V_13 = V_11 -> V_14 ;
struct V_3 * V_4 ;
