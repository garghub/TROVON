...
V_2 -> V_6 = true ;
V_150 = V_153 [ 0 ] ;
for ( V_133 = 0 ; V_133 < F_10 ( V_153 ) ; V_133 ++ ) {
if ( V_2 -> V_154 <= V_153 [ V_133 ] . V_155 ) {
V_150 = V_153 [ V_133 ] ;
break;
}
}
if ( V_2 -> V_154 > V_153 [ F_10 ( V_153 ) - 1 ] . V_155 ) {
F_54 ( V_2 -> V_33 . V_34 . V_35 ,
L_12 ,
V_2 -> V_154 ,
V_153 [ F_10 ( V_153 ) - 1 ] . V_155 ) ;
V_150 = V_153 [ F_10 ( V_153 ) - 1 ] ;
V_2 -> V_154 = V_150 . V_155 ;
}
V_140 = V_2 -> V_154 / 1000 ;
V_139 = F_55 ( V_2 -> V_136 ) / 1000 ;
V_145 = V_156 * V_139 / ( 256 * 16 * V_140 ) ;
V_145 = F_56 (unsigned int, prescale, 1 , 8 ) ;
V_139 /= V_145 ;
...
V_148 = ( 64000 / ( ( V_139 / 1000 ) * V_159 ) ) ;
if ( 64000 % ( ( V_139 / 1000 ) * V_159 ) )
V_146 ++ ;
if ( V_148 > V_160 )
V_148 = V_160 ;
V_148 = ( V_148 & V_160 ) << V_161 ;
}
V_27 = V_148 | ( ( V_146 & V_162 ) << V_163 ) | ( V_145 - 1 ) ;
F_1 ( V_2 , V_164 , V_27 ) ;
...
F_1 ( V_2 , V_167 , V_27 ) ;
V_144 = V_27 ;
V_27 = V_150 . V_168 / V_141 ;
if ( V_27 > 0 )
-- V_27 ;
F_1 ( V_2 , V_169 , V_27 ) ;
V_27 = V_150 . V_170 / V_141 ;
if ( V_27 > 0 )
-- V_27 ;
F_1 ( V_2 , V_171 , V_27 ) ;
F_1 ( V_2 , V_172 , V_27 + V_144 + 2 ) ;
V_27 = V_150 . V_173 / V_141 ;
if ( V_27 > 0 )
-- V_27 ;
F_1 ( V_2 , V_174 , V_27 ) ;
F_1 ( V_2 , V_175 , V_176 ) ;
...
static int F_58 ( struct V_181 * V_182 )
{
...
int V_107 , V_134 ;
T_1 V_46 ;
V_2 = F_59 ( & V_182 -> V_34 , sizeof( struct V_1 ) , V_188 ) ;
if ( ! V_2 )
return - V_189 ;
V_187 = F_60 ( V_182 , V_190 , 0 ) ;
V_2 -> V_5 = F_61 ( & V_182 -> V_34 , V_187 ) ;
if ( F_62 ( V_2 -> V_5 ) )
return F_63 ( V_2 -> V_5 ) ;
V_107 = F_64 ( V_182 , 0 ) ;
if ( V_107 < 0 ) {
...
V_2 -> V_191 = F_65 ( & V_182 -> V_34 , L_14 ) ;
if ( F_62 ( V_2 -> V_191 ) ) {
F_31 ( & V_182 -> V_34 , L_15 ) ;
return F_63 ( V_2 -> V_191 ) ;
}
V_2 -> V_136 = F_65 ( & V_182 -> V_34 , L_16 ) ;
if ( F_62 ( V_2 -> V_136 ) ) {
F_31 ( & V_182 -> V_34 , L_17 ) ;
return F_63 ( V_2 -> V_136 ) ;
}
V_134 = F_66 ( & V_182 -> V_34 , V_107 , F_36 , 0 ,
V_182 -> V_192 , V_2 ) ;
if ( V_134 ) {
...
V_2 -> V_154 = V_153 [ 0 ] . V_155 ;
if ( ! F_68 ( V_184 , L_19 , & V_46 ) )
V_2 -> V_154 = V_46 ;
F_69 ( & V_2 -> V_33 , V_2 ) ;
...
static int F_74 ( struct V_181 * V_34 )
{
...
static int F_79 ( struct V_202 * V_34 )
{
struct V_1 * V_2 = F_78 ( V_34 ) ;
int V_134 ;
V_134 = F_48 ( V_2 -> V_191 ) ;
