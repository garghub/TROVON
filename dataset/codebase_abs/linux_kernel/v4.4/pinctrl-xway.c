...
struct V_45 * V_46 ;
int V_26 , V_24 ;
V_46 = F_29 ( V_40 , V_47 , 0 ) ;
V_48 . V_14 [ 0 ] = F_30 ( & V_40 -> V_19 , V_46 ) ;
if ( F_31 ( V_48 . V_14 [ 0 ] ) )
return F_32 ( V_48 . V_14 [ 0 ] ) ;
V_42 = F_33 ( V_49 , & V_40 -> V_19 ) ;
if ( V_42 )
V_44 = ( const struct V_43 * ) V_42 -> V_50 ;
else
V_44 = & V_51 [ 0 ] ;
V_52 . V_53 = V_44 -> V_54 ;
V_48 . V_55 = F_34 ( & V_40 -> V_19 ,
sizeof( struct V_56 ) * V_52 . V_53 ,
V_57 ) ;
if ( ! V_48 . V_55 ) {
F_12 ( & V_40 -> V_19 , L_3 ) ;
return - V_58 ;
}
for ( V_24 = 0 ; V_24 < V_52 . V_53 ; V_24 ++ ) {
char * V_59 = F_34 ( & V_40 -> V_19 , 5 , V_57 ) ;
if ( ! V_59 ) {
F_12 ( & V_40 -> V_19 , L_4 ) ;
return - V_58 ;
}
snprintf ( V_59 , 5 , L_5 , V_24 ) ;
V_48 . V_55 [ V_24 ] . V_60 = V_61 + V_24 ;
V_48 . V_55 [ V_24 ] . V_59 = V_59 ;
}
V_62 . V_29 = V_48 . V_55 ;
V_52 . V_19 = & V_40 -> V_19 ;
V_26 = F_35 ( & V_52 ) ;
