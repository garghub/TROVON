...
ASSERT ( V_2 -> V_151 -> V_10 . V_11 [ 0 ] != NULL ) ;
F_16 ( ( unsigned long ) V_120 & 7UL , == , 0 ) ;
memcpy ( & V_33 , & V_2 -> V_151 -> V_10 . V_11 [ 2 ] , sizeof( V_33 ) ) ;
V_29 . V_37 = V_2 -> V_151 -> V_10 . V_11 [ 0 ] ;
V_29 . V_38 = V_33 . V_34 ;
V_29 . V_39 = 0 ;
...
goto V_72;
V_131 = V_165 ;
if ( V_121 < 4 || V_121 > V_166 )
goto V_72;
V_131 = V_167 ;
if ( V_139 >= V_168 )
goto V_72;
V_120 = F_34 ( V_121 , V_169 ) ;
if ( ! V_120 )
return - V_61 ;
V_131 = V_133 ;
...
goto V_170;
if ( F_19 ( V_122 . V_126 . V_80 [ 0 ] ) > V_171 ||
F_19 ( V_122 . V_126 . V_80 [ 1 ] ) > V_171 ||
F_19 ( V_122 . V_126 . V_80 [ 2 ] ) > V_171 ||
F_19 ( V_122 . V_126 . V_80 [ 3 ] ) > V_171 )
goto V_170;
V_131 = V_172 ;
