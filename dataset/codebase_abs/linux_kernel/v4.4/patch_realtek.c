...
{
F_56 ( V_2 , V_2 -> V_40 . V_107 , V_108 ) ;
F_2 ( V_2 , V_2 -> V_40 . V_107 , 0 ,
V_109 , V_108 ) ;
F_29 ( 10 ) ;
}
...
for ( V_47 = V_117 ; V_47 -> V_41 ; V_47 ++ ) {
if ( V_47 -> V_41 != V_2 -> V_40 . V_41 )
continue;
if ( ( F_6 ( V_2 ) & V_47 -> V_118 ) == V_47 -> V_119 )
return F_63 ( V_2 , V_47 -> V_99 ) ;
}
if ( ! V_2 -> V_71 -> V_72 )
return 0 ;
for ( V_116 = V_120 ; V_116 -> V_121 ; V_116 ++ ) {
if ( V_116 -> V_121 != V_2 -> V_40 . V_41 )
continue;
if ( V_116 -> V_122 != V_2 -> V_71 -> V_72 -> V_123 )
continue;
if ( ! V_116 -> V_124 ||
V_116 -> V_124 == V_2 -> V_71 -> V_72 -> V_74 )
return F_63 ( V_2 , V_116 -> V_99 ) ;
}
return 0 ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
const struct V_125 * V_116 ;
V_116 = F_65 ( V_2 -> V_71 -> V_72 , V_126 ) ;
if ( V_116 )
return V_116 -> V_36 ;
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_129 * V_130 = & V_13 -> V_87 . V_88 ;
int V_95 ;
V_95 = F_67 ( V_2 , V_130 , V_127 ,
V_13 -> V_131 ) ;
if ( V_95 < 0 )
return V_95 ;
if ( V_128 )
...
static int F_69 ( struct V_1 * V_2 , T_1 V_132 )
{
...
{
static const T_1 V_137 [] = { 0x1d , 0 } ;
static const T_1 V_138 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
return F_66 ( V_2 , V_137 , V_138 ) ;
}
...
V_13 = V_2 -> V_13 ;
V_13 -> V_87 . V_139 = 1 ;
V_13 -> V_87 . V_140 = 0x01 ;
V_2 -> V_111 . V_141 = F_18 ;
F_75 ( V_2 , V_142 , V_143 ,
V_144 ) ;
F_50 ( V_2 , V_59 ) ;
V_95 = F_71 ( V_2 ) ;
if ( V_95 < 0 )
...
{
static const T_1 V_147 [] = { 0x17 , 0 } ;
static const T_1 V_148 [] = { 0x10 , 0x15 , 0x0f , 0 } ;
return F_66 ( V_2 , V_147 , V_148 ) ;
}
...
static void F_88 ( struct V_1 * V_2 , int V_164 , int V_165 )
{
unsigned int V_166 , V_167 , V_168 ;
V_166 = F_3 ( V_2 , V_2 -> V_40 . V_107 , 0 ,
V_169 , 0 ) ;
if ( ! V_165 )
V_166 |= ( 1 << V_164 ) ;
else
V_166 &= ~ ( 1 << V_164 ) ;
V_167 = F_3 ( V_2 , V_2 -> V_40 . V_107 , 0 ,
V_170 , 0 ) ;
V_167 |= ( 1 << V_164 ) ;
V_168 = F_3 ( V_2 , V_2 -> V_40 . V_107 , 0 ,
V_171 , 0 ) ;
V_168 |= ( 1 << V_164 ) ;
F_2 ( V_2 , V_2 -> V_40 . V_107 , 0 ,
V_172 , V_167 ) ;
...
{
if ( V_58 == V_59 ) {
T_1 V_174 [ 2 ] = { 0x0c , 0x0d } ;
T_1 V_175 [ 2 ] = { 0x0e , 0x0f } ;
F_91 ( V_2 , 0x14 , 2 , V_174 ) ;
F_91 ( V_2 , 0x15 , 2 , V_174 ) ;
F_91 ( V_2 , 0x18 , 2 , V_175 ) ;
F_91 ( V_2 , 0x1a , 2 , V_175 ) ;
} else if ( V_58 == V_64 ) {
T_1 V_176 [ 5 ] = { 0x0c , 0x0d , 0x0e , 0x0f , 0x26 } ;
F_91 ( V_2 , 0x14 , 5 , V_176 ) ;
F_91 ( V_2 , 0x15 , 5 , V_176 ) ;
F_91 ( V_2 , 0x18 , 5 , V_176 ) ;
F_91 ( V_2 , 0x1a , 5 , V_176 ) ;
}
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
static T_1 V_177 [ 3 ] = { 0x14 , 0x15 , 0x19 } ;
int V_68 ;
if ( V_58 != V_104 )
return;
for ( V_68 = 0 ; V_68 < F_11 ( V_177 ) ; V_68 ++ ) {
unsigned int V_5 = F_36 ( V_2 , V_177 [ V_68 ] ) ;
if ( F_93 ( V_5 ) != V_178 )
continue;
V_5 = F_94 ( V_2 , V_177 [ V_68 ] ) ;
V_5 |= V_179 ;
F_95 ( V_2 , V_177 [ V_68 ] , V_5 ) ;
V_13 -> V_87 . V_180 = 1 ;
break;
}
}
static void F_96 ( struct V_1 * V_2 ,
const T_1 * V_177 , int V_181 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
int V_68 ;
for ( V_68 = 0 ; V_68 < V_181 ; V_68 ++ ) {
unsigned int V_5 ;
V_5 = F_94 ( V_2 , V_177 [ V_68 ] ) ;
V_5 |= V_182 ;
F_95 ( V_2 , V_177 [ V_68 ] , V_5 ) ;
...
const struct V_56 * V_57 , int V_58 )
{
static T_1 V_177 [ 2 ] = { 0x18 , 0x1a } ;
if ( V_58 == V_104 )
F_96 ( V_2 , V_177 , F_11 ( V_177 ) ) ;
}
static void F_98 ( struct V_1 * V_2 ,
const struct V_56 * V_57 , int V_58 )
{
static T_1 V_177 [ 1 ] = { 0x18 } ;
if ( V_58 == V_104 )
F_96 ( V_2 , V_177 , F_11 ( V_177 ) ) ;
}
...
if ( V_95 < 0 )
goto error;
if ( ! V_13 -> V_87 . V_145 && V_13 -> V_87 . V_140 )
F_76 ( V_13 , 0x0b , 0x05 , V_146 ) ;
F_50 ( V_2 , V_64 ) ;
return 0 ;
error:
...
{
static const T_1 V_190 [] = { 0x1d , 0 } ;
static const T_1 V_191 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
return F_66 ( V_2 , V_190 , V_191 ) ;
}
...
return V_95 ;
V_13 = V_2 -> V_13 ;
V_13 -> V_87 . V_192 = 0x18 ;
V_13 -> V_105 = F_28 ;
#if 0
alc_update_coefex_idx(codec, 0x1a, 7, 0, 0x80);
#endif
F_13 ( V_2 , 0x20 , 0x0a , 10 ) ;
F_75 ( V_2 , V_193 , V_194 ,
V_195 ) ;
F_50 ( V_2 , V_59 ) ;
F_35 ( V_2 ) ;
if ( F_64 ( V_2 ) )
...
{
static const T_1 V_196 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
return F_66 ( V_2 , NULL , V_196 ) ;
}
...
V_13 -> V_87 . V_140 = 0x01 ;
V_13 -> V_105 = F_28 ;
F_75 ( V_2 , V_197 , V_198 , V_199 ) ;
F_50 ( V_2 , V_59 ) ;
V_95 = F_105 ( V_2 ) ;
if ( V_95 < 0 )
goto error;
if ( V_95 > 0 && ! V_13 -> V_87 . V_145 &&
V_13 -> V_87 . V_88 . V_200 [ 0 ] != 0x1d ) {
F_9 ( V_13 , V_201 ) ;
F_81 ( V_2 , V_202 ) ;
if ( ! F_107 ( V_2 , 0x1d , V_146 ) )
F_108 ( V_2 , 0x1d , V_146 ,
( 0x0c << V_203 ) |
( 0x0c << V_204 ) |
( 0x07 << V_205 ) |
( 0 << V_206 ) ) ;
...
{
static const T_1 V_207 [] = { 0x1d , 0 } ;
static const T_1 V_208 [] = { 0 , 0x1b , 0x14 , 0x21 } ;
...
if ( V_2 -> V_71 -> V_226 )
return;
for ( V_68 = 0 ; V_68 < V_2 -> V_227 . V_228 ; V_68 ++ ) {
struct V_229 * V_164 = F_112 ( & V_2 -> V_227 , V_68 ) ;
if ( V_164 -> V_3 != V_225 )
F_3 ( V_2 , V_164 -> V_3 , 0 ,
V_230 , 0 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
T_1 V_234 = V_13 -> V_87 . V_88 . V_89 [ 0 ] ;
bool V_235 ;
int V_236 ;
F_115 ( V_2 ) ;
if ( ! V_234 )
...
T_1 V_234 = V_13 -> V_87 . V_88 . V_89 [ 0 ] ;
bool V_235 ;
if ( ! V_13 -> V_87 . V_88 . V_241 ) {
if ( V_13 -> V_87 . V_88 . V_91 == V_178 )
V_234 = V_13 -> V_87 . V_88 . V_90 [ 0 ] ;
}
F_120 ( V_2 ) ;
if ( ! V_234 )
return;
...
F_61 ( V_2 , 0x01 ) ;
if ( V_13 -> V_245 )
F_2 ( V_2 , V_2 -> V_40 . V_107 , 0 , V_149 ,
V_13 -> V_245 ) ;
if ( V_13 -> V_244 )
F_132 ( V_2 ) ;
return 0 ;
...
if ( V_58 != V_64 )
return;
V_13 -> V_87 . V_251 = & V_252 ;
V_13 -> V_87 . V_253 = & V_254 ;
}
...
int V_270 , V_164 ;
if ( sscanf ( V_268 -> V_99 , L_17 , & V_270 , & V_164 ) != 2 )
continue;
if ( V_164 < 0x0a || V_164 >= 0x10 )
break;
V_13 -> V_261 = V_270 ;
V_13 -> V_262 = V_164 - 0x0a + 0x18 ;
V_13 -> V_87 . V_271 . V_272 = F_145 ;
V_13 -> V_87 . V_273 = 1 ;
V_2 -> V_274 = F_147 ;
F_38 ( V_2 ,
L_18 , V_13 -> V_262 ,
...
V_278 -> V_36 . integer . V_36 [ 0 ] ||
V_278 -> V_36 . integer . V_36 [ 1 ] ) ;
}
...
if ( V_58 == V_59 ) {
V_13 -> V_87 . V_271 . V_272 = F_154 ;
V_13 -> V_87 . V_281 = F_155 ;
V_13 -> V_245 = 0 ;
V_13 -> V_261 = 0 ;
V_13 -> V_276 = 0x08 ;
V_13 -> V_279 = 0x10 ;
...
for ( V_68 = 0 ; V_68 < F_11 ( V_13 -> V_286 ) ; V_68 ++ )
F_168 ( V_13 -> V_286 [ V_68 ] , V_13 -> V_285 -> V_294 ) ;
if ( F_169 ( V_13 -> V_285 ) ) {
F_166 ( V_2 , L_21 ) ;
F_170 ( V_13 -> V_285 ) ;
V_13 -> V_285 = NULL ;
...
return;
F_81 ( V_2 , V_280 ) ;
F_172 ( V_2 , V_2 -> V_40 . V_107 , 0 ,
V_295 , 0x04 ) ;
F_73 ( V_2 , V_2 -> V_40 . V_107 ,
F_161 ) ;
V_13 -> V_87 . V_271 . V_272 = F_154 ;
V_13 -> V_87 . V_281 = F_155 ;
V_13 -> V_245 = 0 ;
...
F_29 ( 300 ) ;
V_5 = F_7 ( V_2 , 0xbe ) ;
V_305 = ( V_5 & 0x1c02 ) == 0x1c02 ;
break;
}
F_38 ( V_2 , L_27 ,
V_305 ? L_28 : L_29 ) ;
V_13 -> V_306 = V_305 ? V_307 : V_308 ;
}
static void F_186 ( struct V_1 * V_2 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
T_1 V_309 = V_13 -> V_87 . V_310 [ V_13 -> V_87 . V_311 [ 0 ] ] ;
T_1 V_234 = V_13 -> V_87 . V_88 . V_89 [ 0 ] ;
int V_312 ;
if ( ! F_117 ( V_2 , V_234 ) )
V_312 = V_313 ;
else if ( V_309 == V_13 -> V_314 )
V_312 = V_315 ;
else if ( V_309 == V_13 -> V_316 )
V_312 = V_317 ;
else
V_312 = V_318 ;
if ( V_312 == V_13 -> V_319 ) {
...
if ( V_13 -> V_306 == V_307 )
F_183 ( V_2 ) ;
else if ( V_13 -> V_306 == V_308 )
F_184 ( V_2 ) ;
V_13 -> V_87 . V_150 = true ;
break;
case V_317 :
F_181 ( V_2 , V_234 , V_13 -> V_316 ) ;
V_13 -> V_87 . V_150 = false ;
break;
case V_318 :
F_182 ( V_2 ) ;
...
F_146 ( V_2 , V_234 ,
V_321 | V_322 ) ;
if ( V_13 -> V_316 && V_13 -> V_316 != V_234 )
F_146 ( V_2 , V_13 -> V_316 ,
V_323 ) ;
}
V_13 -> V_319 = V_312 ;
F_141 ( V_2 ) ;
...
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_129 * V_130 = & V_13 -> V_87 . V_88 ;
for ( V_68 = 0 ; V_68 < V_130 -> V_324 ; V_68 ++ ) {
if ( V_130 -> V_325 [ V_68 ] . V_326 && ! V_13 -> V_314 )
V_13 -> V_314 = V_130 -> V_325 [ V_68 ] . V_164 ;
if ( V_130 -> V_325 [ V_68 ] . V_327 && ! V_13 -> V_316 )
V_13 -> V_316 = V_130 -> V_325 [ V_68 ] . V_164 ;
}
V_13 -> V_87 . V_281 = F_187 ;
V_13 -> V_87 . V_151 = F_186 ;
V_13 -> V_87 . V_257 = F_188 ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
int V_234 = V_13 -> V_87 . V_88 . V_89 [ 0 ] ;
F_2 ( V_2 , V_234 , 0 ,
V_237 , V_238 ) ;
F_29 ( 20 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_332 * V_333 = & V_13 -> V_87 . V_334 ;
int V_68 ;
switch ( V_58 ) {
case V_59 :
F_204 ( V_2 , 0x19 , V_323 ) ;
break;
case V_64 :
V_13 -> V_105 = F_202 ;
for ( V_68 = 0 ; V_68 < V_333 -> V_335 ; V_68 ++ ) {
if ( V_13 -> V_87 . V_310 [ V_68 ] == 0x12 ) {
V_13 -> V_87 . V_311 [ 0 ] = V_68 ;
break;
}
}
break;
...
F_206 ( V_2 , 0x1b , F_25 ( V_2 , 0x1b ) & ~ V_336 ) ;
} else
F_190 ( V_2 , V_57 , V_58 ) ;
}
...
int V_68 ;
for ( V_68 = 0 ; V_68 < V_130 -> V_324 ; V_68 ++ ) {
if ( V_130 -> V_325 [ V_68 ] . type != V_338 )
continue;
V_3 = V_130 -> V_325 [ V_68 ] . V_164 ;
V_337 = F_36 ( V_2 , V_3 ) ;
if ( F_208 ( V_337 ) == V_339 )
continue;
return V_3 ;
}
return 0 ;
...
return;
for ( V_68 = 0 ; V_68 < V_130 -> V_324 ; V_68 ++ ) {
T_1 V_3 = V_130 -> V_325 [ V_68 ] . V_164 ;
unsigned int V_337 ;
if ( V_130 -> V_325 [ V_68 ] . type != V_338 )
continue;
V_337 = F_36 ( V_2 , V_3 ) ;
...
F_141 ( V_2 ) ;
if ( F_117 ( V_2 , 0x1b ) )
V_13 -> V_87 . V_340 |= ( 1ULL << 0x14 ) ;
}
static void F_216 ( struct V_1 * V_2 ,
const struct V_56 * V_57 , int V_58 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
static const struct V_248 V_341 [] = {
{ 0x01 , V_172 , 0x04 } ,
{ 0x01 , V_173 , 0x04 } ,
{ 0x01 , V_149 , 0x04 } ,
{}
} ;
static const struct V_155 V_342 [] = {
{ 0x1b , 0x21114000 } ,
{}
} ;
struct V_28 * V_29 ;
...
V_29 = F_15 ( V_2 , L_30 ) ;
if ( V_29 )
strcpy ( V_29 -> V_343 . V_99 , L_31 ) ;
V_29 = F_15 ( V_2 , L_32 ) ;
if ( V_29 )
strcpy ( V_29 -> V_343 . V_99 , L_30 ) ;
break;
}
}
...
if ( V_58 == V_59 ) {
T_1 V_174 [ 2 ] = { 0x0c } ;
F_91 ( V_2 , 0x14 , 1 , V_174 ) ;
F_91 ( V_2 , 0x15 , 1 , V_174 ) ;
}
}
...
struct V_12 * V_13 = V_2 -> V_13 ;
V_154 ( V_2 , V_27 ) ;
F_153 ( V_2 , 0x10 , ! V_13 -> V_87 . V_150 ) ;
}
...
V_2 -> V_331 = 1 ;
#ifdef F_222
V_2 -> V_111 . V_344 = F_129 ;
V_2 -> V_111 . V_345 = F_131 ;
#endif
V_13 -> V_105 = F_114 ;
F_75 ( V_2 , V_346 ,
V_347 , V_348 ) ;
F_223 ( V_2 , V_349 , V_348 ) ;
F_75 ( V_2 , NULL , V_350 ,
V_348 ) ;
F_50 ( V_2 , V_59 ) ;
F_35 ( V_2 ) ;
...
if ( F_3 ( V_2 , 0x51 , 0 , V_351 , 0 ) == 0x10ec5505 ) {
V_13 -> V_244 = 1 ;
V_13 -> V_103 = F_127 ;
}
V_95 = F_109 ( V_2 ) ;
if ( V_95 < 0 )
goto error;
if ( ! V_13 -> V_87 . V_145 && V_13 -> V_87 . V_140 && V_13 -> V_87 . V_132 )
F_76 ( V_13 , V_13 -> V_87 . V_132 , 0x04 , V_146 ) ;
F_50 ( V_2 , V_64 ) ;
return 0 ;
error:
F_77 ( V_2 ) ;
...
static const T_1 V_353 [] = { 0x0e , 0x0f , 0x0b , 0 } ;
return F_66 ( V_2 , V_352 , V_353 ) ;
}
...
return V_95 ;
V_13 = V_2 -> V_13 ;
V_13 -> V_87 . V_140 = 0x23 ;
#ifdef F_222
V_13 -> V_110 = F_57 ;
#endif
F_75 ( V_2 , NULL , V_356 , V_357 ) ;
F_50 ( V_2 , V_59 ) ;
V_95 = F_224 ( V_2 ) ;
if ( V_95 < 0 )
goto error;
if ( ! V_13 -> V_87 . V_145 )
F_76 ( V_13 , 0x23 , 0 , V_358 ) ;
F_50 ( V_2 , V_64 ) ;
return 0 ;
error:
F_77 ( V_2 ) ;
...
{
static const T_1 V_363 [] = { 0x1d , 0 } ;
static const T_1 V_364 [] = { 0x15 , 0x1b , 0x14 , 0x21 } ;
static const T_1 V_365 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
const T_1 * V_210 ;
...
if ( V_58 == V_102 ) {
struct V_12 * V_13 = V_2 -> V_13 ;
V_13 -> V_87 . V_366 [ 0 ] -> V_367 [ 0 ] . V_368 = V_369 ;
}
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
if ( V_3 == V_2 -> V_40 . V_107 && V_265 == V_108 && V_13 -> V_245 )
return V_370 ;
return V_265 ;
}
...
F_75 ( V_2 , V_372 ,
V_373 , V_374 ) ;
F_223 ( V_2 , V_375 , V_374 ) ;
F_50 ( V_2 , V_59 ) ;
F_35 ( V_2 ) ;
if ( F_64 ( V_2 ) )
V_13 -> V_87 . V_140 = 0x01 ;
if ( ( F_6 ( V_2 ) & ( 1 << 14 ) ) &&
V_2 -> V_71 -> V_72 && V_2 -> V_71 -> V_72 -> V_123 == 0x1025 &&
V_13 -> V_60 . V_80 == 1 ) {
V_95 = F_63 ( V_2 , L_35 ) ;
if ( V_95 < 0 )
goto error;
...
case 0x10ec0665 :
case 0x10ec0668 :
F_76 ( V_13 , 0x0b , 0x04 , V_146 ) ;
break;
case 0x10ec0273 :
F_76 ( V_13 , 0x0b , 0x03 , V_146 ) ;
break;
}
}
F_50 ( V_2 , V_64 ) ;
