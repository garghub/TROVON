...
F_107 ( V_27 , V_161 , sizeof( V_27 ) ) ;
V_160 = F_108 ( V_27 , 0440 , V_102 -> V_162 , & V_163 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_160 )
goto V_119;
F_106 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_107 ( V_27 , V_164 , sizeof( V_27 ) ) ;
V_160 = F_108 ( V_27 , 0440 , V_102 -> V_162 , & V_165 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_160 )
goto V_166;
F_106 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_107 ( V_27 , V_167 , sizeof( V_27 ) ) ;
V_160 = F_108 ( V_27 , 0440 , V_102 -> V_162 , & V_168 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_160 )
goto V_169;
#endif
...
int V_171 ;
F_50 (i) {
F_114 ( & F_115 ( V_172 , V_9 ) ) ;
}
V_5 = F_48 ( sizeof( struct V_54 ) * V_170 , V_96 ) ;
if ( ! V_5 )
return - V_59 ;
for ( V_9 = 0 ; V_9 < V_170 ; V_9 ++ ) {
F_116 ( & V_5 [ V_9 ] . V_6 ) ;
