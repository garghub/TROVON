...
if ( F_16 ( V_2 , V_93 , 0x1 ) ||
F_16 ( V_2 , V_94 , 0xffff ) ) {
F_22 ( V_2 -> V_35 , L_9 ) ;
return - V_65 ;
}
} else {
...
static T_2 F_31 ( int V_100 , void * V_101 )
{
T_1 V_21 ;
...
int V_19 , V_107 ;
struct V_1 * V_2 ;
struct V_108 * V_109 = V_106 -> V_35 . V_110 ;
const struct V_111 * V_112 =
F_33 ( V_113 , & V_106 -> V_35 ) ;
const struct V_114 * type ;
struct V_115 * V_116 ;
V_2 = F_34 ( & V_106 -> V_35 , sizeof( * V_2 ) , V_117 ) ;
if ( ! V_2 )
return - V_118 ;
F_35 ( V_106 , V_2 ) ;
type = V_112 -> V_119 ;
...
V_2 -> V_70 = type -> V_70 ;
V_2 -> V_35 = & V_106 -> V_35 ;
V_116 = F_36 ( V_106 , V_120 , L_11 ) ;
V_2 -> V_7 = F_37 ( V_2 -> V_35 , V_116 ) ;
if ( F_38 ( V_2 -> V_7 ) )
return F_39 ( V_2 -> V_7 ) ;
...
if ( F_1 ( V_2 ) ) {
V_116 = F_36 ( V_106 , V_120 ,
L_13 ) ;
V_2 -> V_85 = F_37 ( V_2 -> V_35 , V_116 ) ;
if ( F_38 ( V_2 -> V_85 ) )
...
V_2 -> V_121 = F_41 ( V_2 -> V_35 , L_15 ) ;
if ( F_38 ( V_2 -> V_121 ) ) {
F_24 ( V_2 -> V_35 , L_16 , F_39 ( V_2 -> V_121 ) ) ;
return F_39 ( V_2 -> V_121 ) ;
}
V_2 -> V_122 = F_41 ( V_2 -> V_35 , L_17 ) ;
if ( F_38 ( V_2 -> V_122 ) ) {
F_24 ( V_2 -> V_35 , L_16 , F_39 ( V_2 -> V_122 ) ) ;
...
if ( ! ( F_3 ( V_2 , V_10 ) & V_125 ) ) {
F_24 ( V_2 -> V_35 , L_19 ) ;
return - V_126 ;
}
F_5 ( V_2 , 0xf , V_127 ) ;
F_5 ( V_2 , 0xffffffff , V_128 ) ;
F_5 ( V_2 , 0x1 , V_129 ) ;
F_5 ( V_2 , ~ ( ( 1 << 31 ) | ( 1 << 1 ) ) , V_130 ) ;
V_107 = F_43 ( V_106 , 0 ) ;
V_19 = F_44 ( V_2 -> V_35 , V_107 , F_31 , V_131 ,
L_20 , V_2 ) ;
if ( V_19 )
goto V_124;
...
V_19 = F_46 ( V_109 , NULL , NULL , V_2 -> V_35 ) ;
if ( V_19 ) {
F_24 ( V_2 -> V_35 , L_21 ,
V_109 -> V_134 ) ;
goto V_124;
