...
{
struct V_1 * V_2 = F_35 ( V_57 , struct V_1 , V_58 ) ;
int V_45 ;
F_6 ( & V_2 -> V_14 ) ;
if ( ! V_2 -> V_15 || V_2 -> V_59 != V_60 || ! F_36 ( V_2 -> V_22 ) ) {
F_7 ( & V_2 -> V_14 ) ;
return;
}
if ( V_2 -> V_19 <= 0 ) {
V_2 -> V_22 -> V_34 . V_61 ++ ;
F_33 ( V_48 , & V_2 -> V_15 -> V_49 ) ;
F_7 ( & V_2 -> V_14 ) ;
F_15 ( V_2 ) ;
return;
}
...
static void F_37 ( struct V_62 * V_15 )
{
struct V_1 * V_2 = V_15 -> V_63 ;
F_38 ( & V_2 -> V_58 ) ;
}
static void F_39 ( struct V_23 * V_22 )
{
...
goto V_64;
#ifdef F_31
if ( F_43 ( V_53 , F_44 ( V_22 ) + 20 * V_65 ) ) {
goto V_64;
}
F_18 ( V_32 L_5 ,
V_22 -> V_33 ,
( F_45 ( V_2 -> V_15 ) || V_2 -> V_19 ) ?
L_6 : L_7 ) ;
V_2 -> V_19 = 0 ;
F_33 ( V_48 , & V_2 -> V_15 -> V_49 ) ;
F_15 ( V_2 ) ;
...
static T_1
F_47 ( struct V_24 * V_25 , struct V_23 * V_22 )
{
struct V_1 * V_2 = F_40 ( V_22 ) ;
F_41 ( & V_2 -> V_14 ) ;
if ( ! F_36 ( V_22 ) ) {
...
F_26 ( V_2 , V_25 -> V_68 , V_25 -> V_6 ) ;
F_46 ( & V_2 -> V_14 ) ;
F_48 ( V_25 ) ;
return V_66 ;
}
static int
F_49 ( struct V_23 * V_22 )
{
struct V_1 * V_2 = F_40 ( V_22 ) ;
F_6 ( & V_2 -> V_14 ) ;
if ( V_2 -> V_15 )
...
static int F_50 ( struct V_23 * V_22 )
{
struct V_1 * V_2 = F_40 ( V_22 ) ;
if ( V_2 -> V_15 == NULL )
return - V_16 ;
...
static int F_52 ( struct V_23 * V_22 , int V_70 )
{
struct V_1 * V_2 = F_40 ( V_22 ) ;
if ( V_70 < 68 || V_70 > 65534 )
return - V_71 ;
if ( V_70 != V_22 -> V_3 )
return F_53 ( V_2 , V_70 ) ;
return 0 ;
}
static struct V_72 *
F_54 ( struct V_23 * V_22 , struct V_72 * V_34 )
{
...
static int F_55 ( struct V_23 * V_22 )
{
struct V_1 * V_2 = F_40 ( V_22 ) ;
V_22 -> V_3 = V_2 -> V_3 ;
...
static void F_60 ( struct V_62 * V_15 , const unsigned char * V_101 ,
char * V_102 , int V_26 )
{
struct V_1 * V_2 = V_15 -> V_63 ;
if ( ! V_2 || V_2 -> V_59 != V_60 || ! F_36 ( V_2 -> V_22 ) )
return;
while ( V_26 -- ) {
if ( V_102 && * V_102 ++ ) {
if ( ! F_61 ( V_103 , & V_2 -> V_49 ) )
V_2 -> V_22 -> V_34 . V_77 ++ ;
V_101 ++ ;
continue;
}
...
V_22 = F_67 ( sizeof( * V_2 ) , V_33 , V_108 , F_59 ) ;
if ( ! V_22 )
return NULL ;
V_22 -> V_90 = V_89 ;
V_2 = F_40 ( V_22 ) ;
...
#ifdef F_32
F_70 ( & V_2 -> V_110 ) ;
V_2 -> V_110 . V_68 = ( unsigned long ) V_2 ;
V_2 -> V_110 . V_111 = V_112 ;
F_70 ( & V_2 -> V_113 ) ;
V_2 -> V_113 . V_68 = ( unsigned long ) V_2 ;
V_2 -> V_113 . V_111 = V_114 ;
#endif
V_91 [ V_89 ] = V_22 ;
return V_2 ;
}
static int F_71 ( struct V_62 * V_15 )
{
struct V_1 * V_2 ;
int V_4 ;
if ( ! F_72 ( V_115 ) )
...
#ifdef F_32
if ( V_2 -> V_125 ) {
V_2 -> V_110 . V_126 = V_53 + V_2 -> V_125 * V_65 ;
F_77 ( & V_2 -> V_110 ) ;
}
if ( V_2 -> V_127 ) {
V_2 -> V_113 . V_126 = V_53 + V_2 -> V_127 * V_65 ;
F_77 ( & V_2 -> V_113 ) ;
}
#endif
F_78 () ;
...
static void F_79 ( struct V_62 * V_15 )
{
struct V_1 * V_2 = V_15 -> V_63 ;
...
static int F_83 ( struct V_62 * V_15 )
{
F_79 ( V_15 ) ;
return 0 ;
}
...
case V_132 :
#ifdef F_32
if ( F_75 ( V_136 , & V_2 -> V_49 ) )
F_33 ( V_136 , & V_2 -> V_49 ) ;
#endif
if ( ! F_84 ( V_103 , & V_2 -> V_49 ) &&
( V_2 -> V_18 > 2 ) )
F_17 ( V_2 ) ;
F_33 ( V_137 , & V_2 -> V_49 ) ;
V_2 -> V_18 = 0 ;
...
static void F_62 ( struct V_1 * V_2 , unsigned char V_129 )
{
unsigned char V_30 ;
if ( V_129 == 0x70 ) {
#ifdef F_32
...
static int F_85 ( struct V_62 * V_15 , struct V_140 * V_140 ,
...
if ( F_86 ( ( void T_3 * ) V_142 , V_2 -> V_22 -> V_33 , V_143 ) )
return - V_145 ;
return 0 ;
case V_146 :
...
return 0 ;
case V_153 :
if ( F_87 ( V_2 -> V_127 , V_44 ) )
return - V_145 ;
return 0 ;
#endif
default:
return F_91 ( V_15 , V_140 , V_141 , V_142 ) ;
}
}
static long F_92 ( struct V_62 * V_15 , struct V_140 * V_140 ,
unsigned int V_141 , unsigned long V_142 )
{
switch ( V_141 ) {
case V_144 :
...
case V_152 :
case V_153 :
return F_85 ( V_15 , V_140 , V_141 ,
( unsigned long ) F_93 ( V_142 ) ) ;
}
return - V_154 ;
}
static int F_94 ( struct V_23 * V_22 , struct V_155 * V_156 , int V_141 )
{
struct V_1 * V_2 = F_40 ( V_22 ) ;
unsigned long * V_44 = ( unsigned long * ) & V_156 -> V_157 ;
if ( V_2 == NULL )
return - V_16 ;
F_6 ( & V_2 -> V_14 ) ;
if ( ! V_2 -> V_15 ) {
...
F_18 ( V_37 L_14 ) ;
#endif
V_91 = F_97 ( sizeof( struct V_23 * ) * V_104 ,
V_12 ) ;
if ( ! V_91 )
return - V_162 ;
V_160 = F_98 ( V_163 , & V_164 ) ;
if ( V_160 != 0 ) {
F_18 ( V_165 L_15 , V_160 ) ;
F_10 ( V_91 ) ;
}
return V_160 ;
}
...
V_89 = F_102 ( V_163 ) ;
if ( V_89 != 0 )
F_18 ( V_165 L_17 , V_89 ) ;
}
static void V_114 ( unsigned long V_168 )
{
...
F_30 ( V_55 , & V_2 -> V_49 ) ;
F_89 ( & V_2 -> V_113 , V_53 + V_2 -> V_127 * V_65 ) ;
}
V_64:
F_46 ( & V_2 -> V_14 ) ;
}
static void V_112 ( unsigned long V_168 )
{
struct V_1 * V_2 = (struct V_1 * ) V_168 ;
F_41 ( & V_2 -> V_14 ) ;
if ( V_2 -> V_15 == NULL )
...
if ( V_2 -> V_127 )
( void ) F_90 ( & V_2 -> V_113 ) ;
F_18 ( V_169 L_18 , V_2 -> V_22 -> V_33 ) ;
F_101 ( V_2 -> V_15 ) ;
goto V_64;
} else
F_30 ( V_136 , & V_2 -> V_49 ) ;
F_89 ( & V_2 -> V_110 , V_53 + V_2 -> V_125 * V_65 ) ;
}
V_64:
F_46 ( & V_2 -> V_14 ) ;
}
