...
{
struct V_72 * V_73 = V_2 -> V_14 . V_74 ;
struct V_27 * V_28 = F_9 ( & V_2 -> V_14 ) ;
struct V_24 * V_48 ;
int V_75 ;
V_75 = F_43 ( V_73 , L_6 , 0 ) ;
if ( ! F_23 ( V_75 ) ) {
F_41 ( & V_2 -> V_14 , L_7 ) ;
return V_75 ;
}
...
struct V_24 * V_25 ;
int V_10 ;
F_48 ( & V_2 -> V_14 , L_9 , V_76 ) ;
V_2 -> V_12 = 16 ;
V_2 -> V_38 = V_77 ;
V_10 = F_49 ( V_2 ) ;
if ( V_10 < 0 ) {
F_41 ( & V_2 -> V_14 , L_10 , V_10 ) ;
return V_10 ;
}
V_28 = F_50 ( & V_2 -> V_14 , sizeof( * V_28 ) , V_78 ) ;
if ( V_28 == NULL )
return - V_79 ;
F_51 ( & V_2 -> V_14 , V_28 ) ;
V_28 -> V_2 = V_2 ;
...
V_28 -> V_38 = V_80 ;
memcpy ( V_28 -> gamma , V_81 , sizeof( V_28 -> gamma ) ) ;
V_28 -> V_43 = F_52 ( & V_2 -> V_14 , L_11 ) ;
if ( F_45 ( V_28 -> V_43 ) ) {
F_41 ( & V_2 -> V_14 , L_12 ) ;
V_10 = F_46 ( V_28 -> V_43 ) ;
goto V_82;
