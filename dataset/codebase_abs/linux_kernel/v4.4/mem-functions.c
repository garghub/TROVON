...
V_15 = ( double ) V_14 * V_35 ;
if ( ( V_36 ) V_14 <= 0 ) {
fprintf ( V_37 , L_6 , V_25 ) ;
return 1 ;
}
if ( ! strncmp ( V_38 , L_7 , 3 ) ) {
...
if ( strcmp ( V_38 , L_8 ) && strcmp ( V_38 , L_9 ) )
printf ( L_10 , V_38 ) ;
printf ( L_11 ) ;
for ( V_32 = 0 ; V_12 -> V_18 [ V_32 ] . V_21 ; V_32 ++ ) {
printf ( L_12 ,
...
static T_1 F_17 ( const struct V_16 * V_17 , T_2 V_14 )
{
...
free ( V_40 ) ;
free ( V_39 ) ;
return ( double ) ( ( ( double ) V_14 * V_35 ) / F_9 ( & V_46 ) ) ;
}
int F_21 ( int V_30 , const char * * V_31 , const char * T_4 V_47 )
{
struct V_11 V_12 = {
. V_18 = V_48 ,
. V_27 = F_17 ,
...
static void F_22 ( void * * V_39 , T_2 V_14 )
{
* V_39 = F_16 ( V_14 ) ;
if ( ! * V_39 )
F_5 ( L_13 ) ;
}
static T_1 F_23 ( const struct V_16 * V_17 , T_2 V_14 )
{
T_1 V_41 = 0ULL , V_42 = 0ULL ;
...
int F_25 ( int V_30 , const char * * V_31 , const char * T_4 V_47 )
{
struct V_11 V_12 = {
. V_18 = V_50 ,
. V_27 = F_23 ,
