...
F_83 ( * V_141 ) ;
while ( ( V_140 = F_113 ( & V_6 -> V_94 ) ) ) {
struct V_86 * V_80 =
F_114 ( V_140 , struct V_86 , V_88 ) ;
F_71 ( V_140 , & V_6 -> V_94 ) ;
V_80 -> V_6 = NULL ;
}
F_75 ( & V_93 ) ;
...
{
int V_51 ;
V_6 -> V_143 = F_64 ( sizeof( * V_6 -> V_143 ) , V_135 ) ;
if ( ! V_6 -> V_143 )
return - V_57 ;
...
return 0 ;
va_start ( args , V_149 ) ;
V_35 = F_124 ( V_47 , V_90 , F_125 ( 0 , 0 ) , V_6 , V_149 , args ) ;
va_end ( args ) ;
if ( F_31 ( V_35 ) )
return F_32 ( V_35 ) ;
V_6 -> V_35 = V_35 ;
...
void F_140 ( struct V_86 * V_80 , int V_153 )
{
T_8 * V_154 = & V_155 [ V_153 ] ;
enum V_156 V_157 ;
V_157 = V_153 ? V_158 : V_159 ;
if ( F_53 ( V_157 , & V_80 -> V_27 ) )
F_115 ( & V_160 [ V_153 ] ) ;
F_141 () ;
if ( F_142 ( V_154 ) )
F_143 ( V_154 ) ;
}
void F_144 ( struct V_86 * V_80 , int V_153 )
{
enum V_156 V_157 ;
V_157 = V_153 ? V_158 : V_159 ;
if ( ! F_145 ( V_157 , & V_80 -> V_27 ) )
F_66 ( & V_160 [ V_153 ] ) ;
}
long F_146 ( int V_153 , long V_59 )
{
long V_41 ;
unsigned long V_161 = V_68 ;
F_147 ( V_162 ) ;
T_8 * V_154 = & V_155 [ V_153 ] ;
F_148 ( V_154 , & V_162 , V_163 ) ;
V_41 = F_149 ( V_59 ) ;
F_150 ( V_154 , & V_162 ) ;
F_151 ( F_152 ( V_59 ) ,
F_152 ( V_68 - V_161 ) ) ;
...
long F_153 ( struct V_164 * V_164 , int V_153 , long V_59 )
{
long V_41 ;
unsigned long V_161 = V_68 ;
F_147 ( V_162 ) ;
T_8 * V_154 = & V_155 [ V_153 ] ;
if ( F_117 ( & V_160 [ V_153 ] ) == 0 ||
! F_39 ( V_165 , & V_164 -> V_91 ) ) {
if ( V_166 -> V_91 & V_167 )
F_154 ( 1 ) ;
else
F_155 () ;
V_41 = V_59 - ( V_68 - V_161 ) ;
if ( V_41 < 0 )
V_41 = 0 ;
goto V_168;
}
...
int F_157 ( struct V_169 * V_170 , int V_171 ,
void T_9 * V_172 , T_3 * V_173 , T_10 * V_174 )
{
char V_175 [] = L_21 ;
if ( * V_174 || * V_173 < sizeof( V_175 ) ) {
* V_173 = 0 ;
return 0 ;
}
if ( F_158 ( V_172 , V_175 , sizeof( V_175 ) ) )
return - V_176 ;
F_159 ( V_177 L_22 ,
V_170 -> V_178 ) ;
* V_173 = 2 ;
