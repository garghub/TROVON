...
{
#define F_89 ( V_147 ) (fbdev->ctrl->x != NULL)
#define F_90 ( V_147 ) (fbdev->panel->x != NULL)
F_53 ( V_4 -> V_20 == NULL || V_4 -> V_15 == NULL ) ;
F_53 ( ! ( F_89 ( V_21 ) && F_89 ( V_24 ) && F_89 ( V_190 ) &&
F_89 ( V_187 ) && F_89 ( V_39 ) && F_89 ( V_160 ) &&
F_90 ( V_21 ) && F_90 ( V_24 ) && F_90 ( V_89 ) && F_90 ( V_94 ) &&
F_90 ( V_190 ) ) ) ;
#undef F_90
#undef F_89
}
static int F_91 ( struct V_270 * V_271 ,
struct V_14 * V_15 )
{
struct V_3 * V_4 = NULL ;
int V_272 ;
...
if ( F_87 ( & V_271 -> V_2 ) == NULL ) {
F_8 ( & V_271 -> V_2 , L_19 ) ;
V_6 = - V_278 ;
goto V_24;
}
V_4 = F_92 ( sizeof( struct V_3 ) , V_279 ) ;
if ( V_4 == NULL ) {
F_8 ( & V_271 -> V_2 ,
L_20 ) ;
V_6 = - V_261 ;
...
static int F_106 ( struct V_270 * V_271 , T_7 V_295 )
{
struct V_3 * V_4 = F_104 ( V_271 ) ;
if ( V_4 != NULL )
...
static int F_107 ( struct V_270 * V_271 )
{
struct V_3 * V_4 = F_104 ( V_271 ) ;
if ( V_4 != NULL )
...
static int T_8 F_108 ( char * V_296 )
{
char * V_297 = NULL ;
int V_6 = 0 ;
F_109 ( L_29 , V_296 ) ;
if ( ! V_296 || ! * V_296 )
return 0 ;
while ( ! V_6 && ( V_297 = F_110 ( & V_296 , L_30 ) ) != NULL ) {
if ( ! strncmp ( V_297 , L_31 , 5 ) )
V_258 = 1 ;
else if ( ! strncmp ( V_297 , L_32 , 5 ) ) {
char * V_298 ;
unsigned long V_276 ;
V_276 = ( F_111 ( V_297 + 5 , & V_298 , 0 ) ) ;
switch ( V_298 [ 0 ] ) {
case '\0' :
break;
case 'm' :
...
V_18 = F_111 ( V_297 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_297 , L_35 , 6 ) )
V_19 = F_111 ( V_297 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_297 , L_36 , 7 ) )
V_260 = ( F_111 ( V_297 + 7 , NULL , 0 ) ) ;
else if ( ! strncmp ( V_297 , L_37 , 7 ) )
V_262 = ( F_111 ( V_297 + 7 , NULL , 0 ) ) ;
