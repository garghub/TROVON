...
static void F_35 ( struct V_2 * V_6 , int V_87 )
{
switch ( V_87 ) {
case V_88 :
F_7 ( V_6 -> V_27 , V_53 , V_54 ) ;
...
static void F_37 ( unsigned long V_111 )
{
T_1 V_112 ;
V_112 = F_38 ( ( T_1 * ) ( V_111 + V_113 ) ) ;
V_1 = 1 << ( 1 + F_39 ( V_112 ) ) ;
}
static int F_40 ( unsigned long V_111 , unsigned long V_114 ,
T_2 V_115 , T_2 V_116 ,
T_2 V_117 )
{
T_1 * V_118 ;
...
static T_3 F_46 ( int V_146 , void * V_147 )
{
...
void T_4 * V_154 = V_149 -> V_111 + V_81 * V_155 ;
...
static int F_50 ( T_2 V_150 , T_5 V_34 , T_1 V_171 )
{
struct V_76 * V_172 ;
const T_6 * V_173 ;
void T_4 * V_174 = NULL ;
struct V_175 T_4 * V_176 ;
void T_4 * V_177 = NULL ;
T_1 T_4 * V_178 ;
...
static int F_56 ( struct V_195 * V_196 )
{
struct V_68 * V_69 = & V_196 -> V_69 ;
void T_4 * V_120 = NULL ;
struct V_197 T_4 * V_198 = NULL ;
T_1 V_199 , V_200 ;
unsigned long V_201 ;
unsigned long V_111 ;
