...
struct V_10 * V_11 =
F_45 ( V_84 ) ;
struct V_77 * V_57 = NULL ;
int V_85 , V_19 , V_20 ;
V_19 = F_46 ( V_11 -> V_86 . V_87 . V_19 ) ;
V_20 = F_46 ( V_11 -> V_86 . V_87 . V_20 ) ;
V_85 = F_47 ( V_84 , V_88 , V_89 ) ;
if ( V_19 == 0 || V_20 == 0 ) {
V_19 = V_90 ;
V_20 = V_91 ;
F_48 ( V_84 , V_90 , V_91 ) ;
...
F_19 ( L_4 , V_19 , V_20 ) ;
V_57 = F_49 ( V_84 -> V_23 , V_19 , V_20 , 60 ,
false , false , false ) ;
V_57 -> type |= V_92 ;
F_50 ( V_84 , V_57 ) ;
V_85 ++ ;
...
if ( ! ( V_57 -> type & V_92 ) )
return V_93 ;
if ( V_57 -> V_58 == V_90 && V_57 -> V_59 == V_91 )
return V_93 ;
...
static int F_59 ( struct V_8 * V_9 , int V_60 )
{
struct V_67 * V_23 = V_9 -> V_101 ;
struct V_10 * V_11 = V_9 -> V_102 + V_60 ;
struct V_83 * V_84 = & V_11 -> V_103 ;
struct V_81 * V_82 = & V_11 -> V_95 ;
struct V_1 * V_2 = & V_11 -> V_2 ;
struct V_48 * V_49 ;
V_11 -> V_60 = V_60 ;
if ( V_60 == 0 ) {
V_11 -> V_86 . V_98 = F_3 ( true ) ;
V_11 -> V_86 . V_87 . V_19 = F_3 ( V_90 ) ;
V_11 -> V_86 . V_87 . V_20 = F_3 ( V_91 ) ;
}
V_49 = F_60 ( V_9 , V_60 ) ;
if ( F_61 ( V_49 ) )
return F_62 ( V_49 ) ;
F_63 ( V_23 , V_2 , V_49 , NULL ,
& V_104 ) ;
F_64 ( V_2 , 256 ) ;
F_65 ( V_2 , & V_105 ) ;
V_49 -> V_2 = V_2 ;
F_66 ( V_23 , V_84 , & V_106 ,
V_107 ) ;
F_67 ( V_84 , & V_108 ) ;
F_68 ( V_23 , V_82 , & V_109 ,
V_110 ) ;
F_69 ( V_82 , & V_111 ) ;
V_82 -> V_112 = 1 << V_60 ;
F_70 ( V_84 , V_82 ) ;
...
struct V_51 * V_62 ;
int V_31 ;
V_55 = F_7 ( V_23 , V_17 , V_69 -> V_113 [ 0 ] ) ;
if ( ! V_55 )
return F_73 ( - V_34 ) ;
V_62 = F_74 ( sizeof( * V_62 ) , V_114 ) ;
if ( V_62 == NULL )
return F_73 ( - V_115 ) ;
...
int V_116 ;
F_76 ( V_9 -> V_101 ) ;
V_9 -> V_101 -> V_117 . V_118 = ( void * ) & V_119 ;
V_9 -> V_101 -> V_117 . V_120 = V_121 ;
V_9 -> V_101 -> V_117 . V_122 = V_123 ;
V_9 -> V_101 -> V_117 . V_124 = V_88 ;
V_9 -> V_101 -> V_117 . V_125 = V_89 ;
for ( V_116 = 0 ; V_116 < V_9 -> V_126 ; ++ V_116 )
F_59 ( V_9 , V_116 ) ;
F_77 ( V_9 -> V_101 ) ;
return 0 ;
}
