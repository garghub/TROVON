...
static struct V_24 * F_36 ( struct V_1 * V_6 , T_1 V_22 )
{
struct V_25 * V_26 ;
struct V_24 * V_27 ;
V_26 = & V_6 -> V_13 [ F_18 ( V_22 ) ] ;
...
int F_39 ( struct V_40 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_41 ;
F_26 ( L_4 , V_27 -> V_22 ) ;
return 1 ;
}
void F_40 ( struct V_40 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_41 ;
T_1 V_22 ;
F_14 ( & V_10 ) ;
...
T_1 F_43 ( struct V_40 * V_32 ,
unsigned char * V_42 , T_1 V_43 )
{
struct V_24 * V_27 = V_32 -> V_41 ;
return F_44 ( V_42 , V_43 , V_27 -> V_44 ) ;
}
static int F_45 ( struct V_45 * V_46 , T_1 V_47 ,
...
if ( ! ( V_51 & V_60 ) )
return V_64 ;
V_27 = F_27 ( V_6 , V_46 -> V_65 . V_22 , V_31 ) ;
if ( ! V_27 )
return V_66 ;
if ( ! V_27 -> V_39 )
V_46 -> V_67 ++ ;
...
static int F_49 ( struct V_45 * V_46 , T_1 V_47 ,
const struct V_48 * V_49 , struct V_48 * V_50 )
{
int V_72 ;
F_14 ( & V_10 ) ;
V_72 = F_45 ( V_46 , V_47 , V_49 , V_50 ) ;
F_15 ( & V_10 ) ;
F_26 ( L_5 ,
V_46 -> V_65 . V_22 , V_49 ? V_49 -> V_55 : 0 , V_72 ) ;
return V_72 ;
}
static void F_50 ( struct V_29 * V_29 )
{
struct V_24 * V_27 = F_51 ( V_29 , struct V_24 , V_29 ) ;
F_52 ( V_27 -> V_32 ) ;
F_12 ( V_27 , V_14 ) ;
}
void F_38 ( struct V_24 * V_27 )
{
int V_73 = F_53 ( & V_27 -> V_29 . V_74 ) ;
F_10 ( ! V_73 ) ;
F_54 ( & V_27 -> V_29 , F_50 ) ;
}
...
static void F_56 ( struct V_2 * V_3 , struct V_75 * V_76 )
{
struct V_24 * V_27 ;
T_1 V_77 = F_57 ( V_76 ) ;
F_26 ( L_6 , V_77 ) ;
