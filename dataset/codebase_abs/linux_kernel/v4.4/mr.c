...
static int F_76 ( struct V_19 * V_20 , struct V_38 * V_39 ,
...
if ( ! V_111 )
return - V_18 ;
F_77 ( & V_20 -> V_113 -> V_114 -> V_20 , V_112 ,
...
int F_79 ( struct V_19 * V_20 , struct V_38 * V_39 ,
int V_109 , int V_36 , T_2 * V_110 )
{
int V_30 = 0 ;
int V_117 ;
...
% V_118 ;
V_117 = F_80 ( int , V_119 , V_36 ) ;
while ( V_36 > 0 ) {
V_30 = F_76 ( V_20 , V_39 , V_109 , V_117 , V_110 ) ;
if ( V_30 )
return V_30 ;
V_36 -= V_117 ;
V_109 += V_117 ;
V_110 += V_117 ;
V_117 = F_80 ( int , V_118 , V_36 ) ;
}
return V_30 ;
}
...
V_121 = V_48 -> V_66 ;
while ( V_36 > 0 ) {
V_117 = F_80 ( int , V_122 / sizeof( T_2 ) - 2 ,
V_36 ) ;
...
return F_79 ( V_20 , V_39 , V_109 , V_36 , V_110 ) ;
}
...
int V_30 ;
int V_12 ;
V_110 = F_83 ( V_66 -> V_36 * sizeof *V_110 ,
V_91 ) ;
if ( ! V_110 )
return - V_18 ;
...
V_30 = F_81 ( V_20 , V_39 , 0 , V_66 -> V_36 , V_110 ) ;
F_15 ( V_110 ) ;
return V_30 ;
}
int F_84 ( struct V_19 * V_20 , T_1 V_69 , enum V_127 type ,
struct V_128 * V_129 )
{
T_1 V_89 ;
if ( ( type == V_130 &&
...
int F_85 ( struct V_19 * V_20 , struct V_128 * V_129 )
{
struct V_47 * V_48 ;
struct V_56 * V_57 ;
int V_30 ;
...
void F_86 ( struct V_19 * V_20 , struct V_128 * V_129 )
{
int V_30 ;
if ( V_129 -> V_59 == V_60 ) {
V_30 = F_38 ( V_20 , NULL ,
...
if ( F_88 ( V_20 ) )
return 0 ;
if ( ! F_89 ( V_20 -> V_43 . V_58 ) )
return - V_61 ;
V_30 = F_90 ( & V_22 -> V_86 , V_20 -> V_43 . V_58 ,
~ 0 , V_20 -> V_43 . V_138 , 0 ) ;
if ( V_30 )
return V_30 ;
V_30 = F_9 ( & V_22 -> V_26 ,
F_91 ( ( T_1 ) V_20 -> V_43 . V_139 /
( 1 << V_25 ) ) ) ;
if ( V_30 )
goto V_140;
if ( V_20 -> V_43 . V_141 ) {
...
static inline int F_95 ( struct V_143 * V_144 , T_2 * V_110 ,
int V_36 , T_2 V_79 )
{
int V_12 , V_145 ;
if ( V_36 > V_144 -> V_146 )
...
int F_96 ( struct V_19 * V_20 , struct V_143 * V_144 , T_2 * V_110 ,
int V_36 , T_2 V_79 , T_1 * V_149 , T_1 * V_150 )
{
T_1 V_46 ;
int V_12 , V_30 ;
V_30 = F_95 ( V_144 , V_110 , V_36 , V_79 ) ;
if ( V_30 )
return V_30 ;
++ V_144 -> V_147 ;
...
F_47 () ;
F_77 ( & V_20 -> V_113 -> V_114 -> V_20 , V_144 -> V_112 ,
V_36 * sizeof( T_2 ) , V_115 ) ;
for ( V_12 = 0 ; V_12 < V_36 ; ++ V_12 )
...
int F_97 ( struct V_19 * V_20 , T_1 V_69 , T_1 V_75 , int V_146 ,
...
return - V_61 ;
if ( V_37 < ( F_98 ( V_20 -> V_43 . V_154 ) - 1 ) || V_37 >= 32 )
return - V_61 ;
...
int F_99 ( struct V_19 * V_20 , struct V_143 * V_144 )
{
struct F_18 * V_85 = F_18 ( V_20 ) ;
int V_30 ;
...
void F_100 ( struct V_19 * V_20 , struct V_143 * V_144 ,
T_1 * V_149 , T_1 * V_150 )
{
struct V_47 * V_48 ;
int V_30 ;
...
int F_102 ( struct V_19 * V_20 , struct V_143 * V_144 )
{
int V_94 ;
if ( V_144 -> V_147 )
return - V_156 ;
