...
V_51 = F_44 ( V_2 ) ;
if ( V_51 -> V_67 == V_68 ) {
F_45 ( V_10 , V_69 , V_2 -> V_64 ) ;
} else if ( V_51 -> V_67 == V_70 )
F_45 ( V_10 , V_71 , V_2 -> V_64 ) ;
return F_46 ( V_2 ) ;
V_41:
F_18 ( V_2 ) ;
return V_72 ;
}
int F_47 ( struct V_1 * V_2 , struct V_8 * V_9 , struct V_73 * V_74 , struct V_8 * V_75 )
{
const struct V_38 * V_39 ;
struct V_10 * V_10 ;
T_2 V_64 ;
...
F_51 ( V_10 ,
V_82 + ( V_39 -> V_55 & V_88 ) ,
F_52 (unsigned short, 1 , skb_shinfo(skb)->gso_segs) ) ;
if ( ! F_49 ( V_2 , V_39 -> V_43 * 4 ) )
goto V_79;
V_39 = F_2 ( V_2 ) ;
if ( F_31 ( F_53 ( ( T_1 * ) V_39 , V_39 -> V_43 ) ) )
goto V_89;
V_64 = F_54 ( V_39 -> V_90 ) ;
if ( V_2 -> V_64 < V_64 ) {
F_20 ( V_10 , V_91 ) ;
...
V_2 -> V_92 = V_2 -> V_93 + V_39 -> V_43 * 4 ;
memset ( F_29 ( V_2 ) , 0 , sizeof( struct V_94 ) ) ;
F_56 ( V_2 ) ;
return F_25 ( V_34 , V_95 ,
