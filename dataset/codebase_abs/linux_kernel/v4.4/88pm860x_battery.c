...
V_2 -> V_42 = 300 ;
V_2 -> V_146 = F_36 ( & V_130 -> V_43 ,
& V_147 ,
NULL ) ;
if ( F_37 ( V_2 -> V_146 ) )
return F_38 ( V_2 -> V_146 ) ;
V_2 -> V_146 -> V_43 . V_112 = & V_130 -> V_43 ;
V_6 = F_39 ( V_132 -> V_43 , V_2 -> V_137 , NULL ,
F_17 , V_148 ,
L_17 , V_2 ) ;
if ( V_6 < 0 ) {
...
V_6 = F_39 ( V_132 -> V_43 , V_2 -> V_138 , NULL ,
F_18 ,
V_148 , L_19 , V_2 ) ;
if ( V_6 < 0 ) {
F_33 ( V_132 -> V_43 , L_18 ,
...
static int F_40 ( struct V_149 * V_43 )
{
struct V_129 * V_130 = F_41 ( V_43 ) ;
struct V_131 * V_132 = F_27 ( V_130 -> V_43 . V_112 ) ;
if ( F_42 ( V_43 ) )
V_132 -> V_150 |= 1 << V_151 ;
return 0 ;
}
static int F_43 ( struct V_149 * V_43 )
{
struct V_129 * V_130 = F_41 ( V_43 ) ;
struct V_131 * V_132 = F_27 ( V_130 -> V_43 . V_112 ) ;
if ( F_42 ( V_43 ) )
