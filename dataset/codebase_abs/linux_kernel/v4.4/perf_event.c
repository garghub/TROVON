...
static void F_67 ( struct V_68 * V_68 , unsigned int V_125 )
{
...
static inline int
F_92 ( const void T_7 * V_166 , unsigned long V_183 )
{
if ( ( ( unsigned long ) V_166 ) & 3 )
return 0 ;
return ( F_93 ( V_166 , V_183 , V_184 ) == 0 ) ;
}
static void F_94 ( struct V_163 * V_164 ,
struct V_150 * V_151 )
{
unsigned long V_185 ;
V_185 = V_151 -> V_169 [ V_186 ] + V_171 ;
do {
struct V_172 T_7 * V_187 ;
struct V_172 V_173 ;
unsigned long V_174 ;
V_187 = (struct V_172 T_7 * ) V_185 ;
if ( ! F_92 ( V_187 , sizeof( V_173 ) ) )
break;
if ( F_95 ( & V_173 , V_187 , sizeof( V_173 ) ) )
break;
V_174 = V_173 . V_175 ;
V_185 = ( unsigned long ) V_173 . V_166 + V_171 ;
F_87 ( V_164 , V_174 ) ;
} while ( V_164 -> V_181 < V_182 );
}
...
{
unsigned long V_185 ;
V_185 = V_151 -> V_169 [ V_186 ] & 0xffffffffUL ;
do {
unsigned long V_174 ;
if ( F_97 ( V_185 ) ) {
struct V_172 T_7 * V_187 ;
...
V_185 = ( ( unsigned long ) V_173 . V_166 ) & 0xffffffff ;
} else {
struct V_188 T_7 * V_187 ;
struct V_188 V_173 ;
V_187 = (struct V_188 T_7 * ) V_185 ;
if ( F_95 ( & V_173 , V_187 , sizeof( V_173 ) ) )
break;
V_174 = V_173 . V_175 ;
V_185 = ( unsigned long ) V_173 . V_166 ;
}
F_87 ( V_164 , V_174 ) ;
} while ( V_164 -> V_181 < V_182 );
}
void
F_98 ( struct V_163 * V_164 , struct V_150 * V_151 )
{
T_2 V_189 = F_89 () -> V_190 ;
T_1 V_191 = F_99 () ;
T_8 V_192 ;
F_87 ( V_164 , V_151 -> V_168 ) ;
if ( ! V_178 -> V_193 )
