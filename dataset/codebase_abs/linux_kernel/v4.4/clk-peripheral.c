...
return 0 ;
F_19 ( V_6 ) ;
F_3 ( V_6 , V_39 , ( V_4 -> V_9 & V_40 ) ) ;
V_38 = F_7 ( V_6 , V_39 ) & ~ V_41 ;
F_3 ( V_6 , V_39 , V_38 | F_20 ( V_4 -> div )
| V_42
| V_43 ) ;
F_21 ( V_6 ) ;
return 0 ;
...
F_19 ( V_6 ) ;
F_3 ( V_6 , V_39 , ( V_4 -> V_9 & V_40 ) ) ;
V_38 = F_7 ( V_6 , V_39 ) & ~ V_43 ;
F_3 ( V_6 , V_39 , V_38 | V_42 ) ;
F_21 ( V_6 ) ;
}
...
if ( V_4 -> V_35 . V_36 && V_45 > V_4 -> V_35 . V_36 )
return - V_22 ;
...
static void T_2
F_29 ( struct V_52 * V_53 , struct V_5 * V_6 , T_3 type )
{
int V_54 ;
T_1 V_9 ;
struct V_17 * V_17 ;
...
return;
F_32 (np, periphclknp) {
if ( F_33 ( V_55 , L_1 , & V_9 ) )
continue;
if ( V_9 >= V_56 )
continue;
if ( F_34 ( V_53 , L_2 , & V_18 ) )
V_18 = V_55 -> V_18 ;
if ( type == V_57 ) {
V_17 = F_8 ( V_6 , V_18 ,
V_19 , V_9 ) ;
} else {
struct V_50 V_35 = F_35 ( 0 , 0 ) ;
F_36 ( V_55 ,
L_3 ,
& V_35 ) ;
V_17 = F_28 ( V_6 , V_18 ,
...
void T_2 F_38 ( struct V_52 * V_53 ,
struct V_5 * V_6 )
{
F_29 ( V_53 , V_6 , V_57 ) ;
}
void T_2 F_39 ( struct V_52 * V_53 ,
struct V_5 * V_6 )
{
F_29 ( V_53 , V_6 , V_59 ) ;
}
