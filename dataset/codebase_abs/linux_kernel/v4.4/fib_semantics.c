...
return 1 ;
if ( V_124 -> V_145 || V_124 -> V_163 ) {
if ( V_124 -> V_164 ) {
if ( F_71 ( V_125 , V_124 -> V_165 ,
V_124 -> V_164 , V_124 -> V_145 ,
V_23 -> V_5 , V_124 ) )
return 1 ;
}
...
F_78 () ;
V_95 = - V_174 ;
V_150 = F_85 ( V_125 , V_6 -> V_47 ) ;
if ( ! V_150 )
goto V_192;
V_95 = - V_177 ;
if ( ! ( V_150 -> V_71 -> V_175 & V_176 ) )
goto V_192;
V_6 -> V_26 = V_150 -> V_71 ;
F_77 ( V_6 -> V_26 ) ;
V_6 -> V_49 = V_195 ;
...
if ( type == V_222 ) {
char V_223 [ V_77 ] ;
F_104 ( V_223 , V_135 , sizeof( V_223 ) ) ;
...
int V_122 = 1 ;
struct V_125 * V_125 = V_124 -> V_126 . V_104 ;
if ( V_124 -> V_215 > V_230 )
goto V_144;
if ( V_231 [ V_124 -> V_215 ] . V_193 > V_124 -> V_172 )
goto V_144;
#ifdef F_27
if ( V_124 -> V_166 ) {
...
goto V_144;
#ifdef F_18
if ( V_124 -> V_235 && V_23 -> V_5 -> V_35 != V_124 -> V_235 )
goto V_144;
#endif
#else
goto V_144;
...
if ( V_231 [ V_124 -> V_215 ] . error ) {
if ( V_124 -> V_163 || V_124 -> V_145 || V_124 -> V_166 )
goto V_144;
goto V_236;
} else {
switch ( V_124 -> V_215 ) {
...
V_31 V_86 , T_6 type , T_3 V_4 , int V_85 , T_6 V_243 ,
struct V_22 * V_23 , unsigned int V_175 )
{
struct V_244 * V_93 ;
struct V_76 * V_245 ;
V_93 = F_111 ( V_91 , V_100 , V_92 , V_81 , sizeof( * V_245 ) , V_175 ) ;
if ( ! V_93 )
return - V_103 ;
V_245 = F_112 ( V_93 ) ;
V_245 -> V_246 = V_146 ;
...
V_245 -> V_250 = V_251 ;
if ( F_113 ( V_91 , V_252 , V_86 ) )
goto V_253;
V_245 -> V_254 = type ;
V_245 -> V_255 = V_23 -> V_68 ;
V_245 -> V_256 = V_23 -> V_60 ;
V_245 -> V_257 = V_23 -> V_59 ;
if ( V_245 -> V_247 &&
F_114 ( V_91 , V_258 , V_4 ) )
goto V_253;
if ( V_23 -> V_62 &&
F_113 ( V_91 , V_259 , V_23 -> V_62 ) )
goto V_253;
if ( F_115 ( V_91 , V_23 -> V_30 ) < 0 )
goto V_253;
if ( V_23 -> V_42 &&
F_114 ( V_91 , V_260 , V_23 -> V_42 ) )
goto V_253;
if ( V_23 -> V_58 == 1 ) {
struct V_149 * V_150 ;
if ( V_23 -> V_5 -> V_48 &&
F_114 ( V_91 , V_137 , V_23 -> V_5 -> V_48 ) )
goto V_253;
if ( V_23 -> V_5 -> V_47 &&
F_113 ( V_91 , V_261 , V_23 -> V_5 -> V_47 ) )
goto V_253;
if ( V_23 -> V_5 -> V_51 & V_151 ) {
V_150 = F_65 ( V_23 -> V_5 -> V_26 ) ;
if ( V_150 &&
F_66 ( V_150 ) )
V_245 -> V_255 |= V_74 ;
}
#ifdef F_18
if ( V_23 -> V_5 [ 0 ] . V_35 &&
F_113 ( V_91 , V_138 , V_23 -> V_5 [ 0 ] . V_35 ) )
goto V_253;
#endif
if ( V_23 -> V_5 -> V_27 )
...
if ( V_6 -> V_48 &&
F_114 ( V_91 , V_137 , V_6 -> V_48 ) )
goto V_253;
#ifdef F_18
if ( V_6 -> V_35 &&
F_113 ( V_91 , V_138 , V_6 -> V_35 ) )
goto V_253;
#endif
if ( V_6 -> V_27 )
F_116 ( V_91 , V_6 -> V_27 ) ;
V_120 -> V_264 = F_119 ( V_91 ) - ( void * ) V_120 ;
} F_15 ( V_23 ) ;
F_120 ( V_91 , V_262 ) ;
}
#endif
...
int F_123 ( struct V_125 * V_125 , T_3 V_265 )
{
int V_127 = 0 ;
unsigned int V_8 = F_86 ( V_265 ) ;
...
int F_124 ( struct V_70 * V_71 , unsigned long V_81 , bool V_266 )
{
int V_127 = 0 ;
int V_193 = V_240 ;
struct V_22 * V_267 = NULL ;
...
void F_126 ( const struct V_181 * V_272 , struct V_168 * V_169 )
{
struct V_22 * V_23 = NULL , * V_107 = NULL ;
struct V_64 * V_273 = V_169 -> V_273 ;
struct V_179 * V_274 = V_169 -> V_275 ;
T_6 V_276 = 32 - V_169 -> V_277 ;
int V_106 = - 1 , V_108 = - 1 ;
struct V_83 * V_84 , * V_278 = NULL ;
V_31 V_279 = V_169 -> V_23 -> V_62 ;
T_6 V_280 = 0 ;
F_127 (fa, fa_head, fa_list) {
struct V_22 * V_281 = V_84 -> V_97 ;
if ( V_84 -> V_282 != V_276 )
continue;
if ( V_84 -> V_102 && V_84 -> V_102 != V_272 -> V_283 )
continue;
if ( V_84 -> V_86 != V_274 -> V_86 )
continue;
if ( V_281 -> V_62 > V_279 &&
V_84 -> V_102 == V_280 ) {
if ( V_280 )
...
V_280 = V_84 -> V_102 ;
V_279 = V_281 -> V_62 ;
if ( V_281 -> V_60 != V_169 -> V_193 ||
V_84 -> V_101 != V_178 )
continue;
if ( ! V_281 -> V_5 [ 0 ] . V_48 ||
V_281 -> V_5 [ 0 ] . V_49 != V_173 )
continue;
F_128 ( V_84 ) ;
if ( ! V_23 ) {
if ( V_281 != V_169 -> V_23 )
...
int F_130 ( struct V_70 * V_71 , unsigned int V_51 )
{
struct V_22 * V_267 ;
unsigned int V_8 ;
struct V_64 * V_21 ;
...
return 0 ;
if ( V_51 & V_74 ) {
unsigned int V_175 = F_131 ( V_71 ) ;
if ( V_175 & ( V_285 | V_286 ) )
V_51 |= V_151 ;
}
V_267 = NULL ;
V_8 = F_29 ( V_71 -> V_72 ) ;
...
void F_132 ( struct V_168 * V_169 , int V_8 )
{
...
void F_133 ( struct V_125 * V_125 , struct V_168 * V_169 ,
struct V_181 * V_182 , int V_290 )
{
#ifdef F_27
