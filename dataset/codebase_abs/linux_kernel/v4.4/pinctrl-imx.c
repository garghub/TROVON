...
V_85 -> V_8 = F_32 ( V_3 -> V_21 ,
V_85 -> V_66 * sizeof( char * ) , V_33 ) ;
F_36 (np, child) {
V_85 -> V_8 [ V_6 ] = V_83 -> V_4 ;
V_5 = & V_3 -> V_8 [ V_3 -> V_86 ++ ] ;
F_30 ( V_83 , V_5 , V_3 , V_6 ++ ) ;
}
return 0 ;
}
static bool F_37 ( struct V_22 * V_23 )
{
struct V_22 * V_87 ;
struct V_22 * V_88 ;
F_36 (np, function_np) {
...
V_3 -> V_65 = V_92 ;
V_3 -> V_48 = F_32 ( & V_90 -> V_21 , V_92 * sizeof( struct V_84 ) ,
V_33 ) ;
if ( ! V_3 -> V_48 )
return - V_34 ;
if ( V_93 ) {
...
V_3 -> V_8 = F_32 ( & V_90 -> V_21 , V_3 -> V_7 * sizeof( struct V_1 ) ,
V_33 ) ;
if ( ! V_3 -> V_8 )
return - V_34 ;
if ( V_93 ) {
...
int F_40 ( struct V_89 * V_90 ,
struct V_2 * V_3 )
{
struct V_22 * V_95 = V_90 -> V_21 . V_91 ;
struct V_22 * V_23 ;
struct V_11 * V_12 ;
struct V_96 * V_97 ;
int V_72 , V_6 ;
...
V_3 -> V_21 = & V_90 -> V_21 ;
V_12 = F_32 ( & V_90 -> V_21 , sizeof( * V_12 ) , V_33 ) ;
if ( ! V_12 )
return - V_34 ;
V_3 -> V_50 = F_41 ( & V_90 -> V_21 , sizeof( * V_3 -> V_50 ) *
V_3 -> V_15 , V_33 ) ;
if ( ! V_3 -> V_50 )
return - V_34 ;
...
V_97 = F_42 ( V_90 , V_98 , 0 ) ;
V_12 -> V_55 = F_43 ( & V_90 -> V_21 , V_97 ) ;
if ( F_44 ( V_12 -> V_55 ) )
return F_45 ( V_12 -> V_55 ) ;
if ( F_38 ( V_95 , L_24 ) ) {
V_23 = F_46 ( V_95 , L_24 , 0 ) ;
if ( V_23 ) {
V_12 -> V_64 = F_47 ( V_23 , 0 ) ;
if ( F_44 ( V_12 -> V_64 ) ) {
F_14 ( V_23 ) ;
F_10 ( & V_90 -> V_21 ,
L_25 ) ;
return F_45 ( V_12 -> V_64 ) ;
}
} else {
F_10 ( & V_90 -> V_21 , L_26 ) ;
return - V_16 ;
...
V_12 -> V_21 = V_3 -> V_21 ;
F_48 ( V_90 , V_12 ) ;
V_12 -> V_100 = F_49 ( & V_99 , & V_90 -> V_21 , V_12 ) ;
if ( F_44 ( V_12 -> V_100 ) ) {
F_10 ( & V_90 -> V_21 , L_28 ) ;
return F_45 ( V_12 -> V_100 ) ;
}
F_50 ( & V_90 -> V_21 , L_29 ) ;
return 0 ;
}
int F_51 ( struct V_89 * V_90 )
{
struct V_11 * V_12 = F_52 ( V_90 ) ;
F_53 ( V_12 -> V_100 ) ;
return 0 ;
}
