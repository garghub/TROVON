...
{
struct V_41 * V_42 = (struct V_41 * ) ( long ) V_7 ;
struct V_28 * V_29 = (struct V_28 * ) ( long ) V_8 ;
struct V_30 * V_31 = F_19 ( V_29 , struct V_30 , V_29 ) ;
void * V_43 = ( void * ) ( long ) V_10 ;
struct V_44 V_45 ;
struct V_32 * V_33 ;
struct V_46 V_47 = {
. V_13 = V_13 ,
...
if ( F_4 ( ! V_33 ) )
return - V_37 ;
if ( F_4 ( V_33 -> V_48 . type != V_49 ||
V_33 -> V_48 . V_50 != V_51 ) )
return - V_23 ;
if ( F_4 ( V_33 -> V_38 != F_20 () ) )
return - V_52 ;
F_23 ( & V_45 , 0 , 0 ) ;
V_45 . V_47 = & V_47 ;
F_24 ( V_33 , & V_45 , V_42 ) ;
...
static const struct V_25 * F_25 ( enum V_53 V_54 )
{
switch ( V_54 ) {
case V_55 :
return & V_56 ;
...
static bool F_26 ( int V_80 , int V_13 , enum V_81 type )
{
if ( V_80 < 0 || V_80 >= sizeof( struct V_41 ) )
return false ;
if ( type != V_82 )
return false ;
if ( V_80 % V_13 != 0 )
