...
static int F_42 ( struct V_9 * V_9 , struct V_62 * V_63 )
{
return F_38 ( V_9 , V_63 , F_30 ) ;
}
static struct V_26 * F_43 ( struct V_25 * V_47 , struct V_26 * V_26 ,
unsigned int V_27 )
{
return F_35 ( V_47 , V_26 , F_30 ) ;
}
int F_44 ( struct V_25 * V_25 , int V_71 )
{
struct V_10 * V_64 ;
int V_72 ;
V_72 = F_45 ( V_25 , V_71 ) ;
...
return V_72 ;
F_22 () ;
V_64 = F_46 ( F_47 ( V_25 ) , V_73 ) ;
if ( V_64 && F_48 ( V_64 , V_74 ) )
V_72 = 0 ;
F_23 () ;
return V_72 ;
}
static int
F_49 ( struct V_25 * V_47 , struct V_26 * V_26 ,
struct V_10 * V_11 , const void * V_48 )
{
unsigned V_13 = ( unsigned long ) V_48 ;
struct V_49 * V_50 ;
...
static struct V_26 *
F_50 ( struct V_25 * V_47 , struct V_26 * V_26 , unsigned int V_27 )
{
return F_35 ( V_47 , V_26 , F_49 ) ;
}
static int F_51 ( struct V_9 * V_9 , struct V_62 * V_63 )
{
