...
if ( ! V_109 )
return - V_115 ;
V_112 = F_56 ( V_110 , V_111 , V_109 , V_116 ) ;
if ( V_112 < 0 )
return V_112 ;
F_53 ( V_59 ) ;
V_114 = V_8 -> V_50 ;
if ( V_110 [ V_117 ] ) {
V_49 V_118 = F_57 ( V_110 [ V_117 ] ) ;
if ( V_118 >= 1 && V_118 <= F_58 ( 256 * 1024 ) )
V_114 = V_118 ;
else
V_112 = - V_115 ;
}
if ( V_110 [ V_119 ] )
V_59 -> V_63 = F_57 ( V_110 [ V_119 ] ) ;
if ( V_110 [ V_120 ] )
V_8 -> V_64 = F_57 ( V_110 [ V_120 ] ) ;
if ( V_110 [ V_121 ] ) {
V_49 V_69 = F_57 ( V_110 [ V_121 ] ) ;
if ( V_69 > 0 )
V_8 -> V_69 = V_69 ;
else
V_112 = - V_115 ;
...
if ( V_110 [ V_122 ] )
V_8 -> V_54 = F_57 ( V_110 [ V_122 ] ) ;
if ( V_110 [ V_123 ] )
F_59 ( L_1 ,
F_57 ( V_110 [ V_123 ] ) ) ;
if ( V_110 [ V_124 ] )
V_8 -> V_80 = F_57 ( V_110 [ V_124 ] ) ;
if ( V_110 [ V_125 ] ) {
V_49 V_126 = F_57 ( V_110 [ V_125 ] ) ;
if ( V_126 <= 1 )
V_8 -> V_79 = V_126 ;
else
V_112 = - V_115 ;
...
if ( V_110 [ V_127 ] ) {
V_49 V_128 = F_57 ( V_110 [ V_127 ] ) ;
V_8 -> V_68 = F_60 ( V_128 ) ;
}
if ( V_110 [ V_129 ] )
V_8 -> V_47 = F_57 ( V_110 [ V_129 ] ) ;
if ( ! V_112 ) {
F_54 ( V_59 ) ;
V_112 = F_51 ( V_59 , V_114 ) ;
F_53 ( V_59 ) ;
}
...
struct V_7 * V_8 = F_26 ( V_59 ) ;
struct V_108 * V_130 ;
V_130 = F_70 ( V_41 , V_131 ) ;
if ( V_130 == NULL )
goto V_132;
if ( F_71 ( V_41 , V_119 , V_59 -> V_63 ) ||
F_71 ( V_41 , V_120 , V_8 -> V_64 ) ||
F_71 ( V_41 , V_121 , V_8 -> V_69 ) ||
F_71 ( V_41 , V_122 , V_8 -> V_54 ) ||
F_71 ( V_41 , V_125 , V_8 -> V_79 ) ||
F_71 ( V_41 , V_124 , V_8 -> V_80 ) ||
F_71 ( V_41 , V_127 ,
F_72 ( V_8 -> V_68 ) ) ||
F_71 ( V_41 , V_129 , V_8 -> V_47 ) ||
F_71 ( V_41 , V_117 , V_8 -> V_50 ) )
goto V_132;
return F_73 ( V_41 , V_130 ) ;
V_132:
return - 1 ;
}
static int F_74 ( struct V_58 * V_59 , struct V_133 * V_134 )
{
struct V_7 * V_8 = F_26 ( V_59 ) ;
T_1 V_72 = F_33 () ;
struct V_135 V_136 = {
...
return F_75 ( V_134 , & V_136 , sizeof( V_136 ) ) ;
}
