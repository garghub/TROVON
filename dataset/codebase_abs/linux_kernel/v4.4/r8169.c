...
static bool F_140 ( struct V_53 * V_18 , T_2 V_273 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
T_6 V_274 = V_2 -> V_275 ;
...
static bool F_142 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
if ( V_2 -> V_70 < V_280 )
return true ;
return F_140 ( V_18 , V_281 ) ;
}
...
static void F_145 ( struct V_53 * V_18 ,
...
F_146 () ;
F_143 ( V_18 ) ;
V_22 [ 0 ] = F_147 ( V_285 -> V_293 ) ;
V_22 [ 1 ] = F_147 ( V_285 -> V_294 ) ;
V_22 [ 2 ] = F_147 ( V_285 -> V_288 ) ;
V_22 [ 3 ] = F_127 ( V_285 -> V_295 ) ;
V_22 [ 4 ] = F_148 ( V_285 -> V_296 ) ;
V_22 [ 5 ] = F_148 ( V_285 -> V_297 ) ;
V_22 [ 6 ] = F_127 ( V_285 -> V_298 ) ;
V_22 [ 7 ] = F_127 ( V_285 -> V_289 ) ;
V_22 [ 8 ] = F_147 ( V_285 -> V_299 ) ;
V_22 [ 9 ] = F_147 ( V_285 -> V_300 ) ;
V_22 [ 10 ] = F_127 ( V_285 -> V_301 ) ;
V_22 [ 11 ] = F_148 ( V_285 -> V_290 ) ;
V_22 [ 12 ] = F_148 ( V_285 -> V_302 ) ;
}
static void F_149 ( struct V_53 * V_18 , T_2 V_303 , T_4 * V_22 )
{
switch( V_303 ) {
case V_271 :
...
static bool F_155 ( struct V_1 * V_2 , struct V_171 * V_171 )
{
...
if ( V_347 != 0 )
goto V_216;
V_346 = F_127 ( V_339 -> V_348 ) ;
if ( V_346 > V_338 -> V_343 )
goto V_216;
V_343 = F_127 ( V_339 -> V_349 ) ;
...
static bool F_156 ( struct V_1 * V_2 , struct V_53 * V_18 ,
struct V_340 * V_341 )
{
bool V_195 = false ;
T_7 V_353 ;
for ( V_353 = 0 ; V_353 < V_341 -> V_343 ; V_353 ++ ) {
T_2 V_354 = F_127 ( V_341 -> V_351 [ V_353 ] ) ;
...
static int F_157 ( struct V_1 * V_2 , struct V_171 * V_171 )
{
struct V_53 * V_18 = V_2 -> V_18 ;
int V_195 = - V_196 ;
if ( ! F_155 ( V_2 , V_171 ) ) {
...
if ( F_156 ( V_2 , V_18 , & V_171 -> V_342 ) )
V_195 = 0 ;
V_216:
return V_195 ;
}
static void F_158 ( struct V_1 * V_2 , struct V_171 * V_171 )
{
struct V_340 * V_341 = & V_171 -> V_342 ;
...
static void F_163 ( struct V_1 * V_2 , T_4 V_21 , T_1 V_46 )
{
...
static void F_182 ( struct V_1 * V_2 , T_4 * V_61 )
{
const T_1 V_382 [] = {
V_61 [ 0 ] | ( V_61 [ 1 ] << 8 ) ,
V_61 [ 2 ] | ( V_61 [ 3 ] << 8 ) ,
...
static void F_198 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_152 ( V_2 ) ;
switch ( V_2 -> V_70 ) {
...
if ( V_2 -> V_120 ( V_23 ) )
return;
F_200 ( V_2 , V_190 , V_2 -> V_18 , L_13 ) ;
V_2 -> V_396 ( V_2 ) ;
V_395:
F_115 ( V_227 , V_228 + V_392 ) ;
}
static void F_201 ( struct V_1 * V_2 , enum V_397 V_398 )
{
if ( ! F_202 ( V_398 , V_2 -> V_3 . V_399 ) )
F_203 ( & V_2 -> V_3 . V_400 ) ;
}
static void F_204 ( unsigned long V_401 )
{
struct V_53 * V_18 = (struct V_53 * ) V_401 ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_201 ( V_2 , V_402 ) ;
}
static void F_205 ( struct V_5 * V_6 , struct V_53 * V_18 ,
void T_3 * V_23 )
{
F_206 ( V_23 ) ;
F_207 ( V_6 ) ;
...
static void F_211 ( struct V_53 * V_18 ,
struct V_1 * V_2 )
{
V_2 -> V_396 ( V_2 ) ;
...
static void F_213 ( struct V_53 * V_18 , struct V_1 * V_2 )
{
void T_3 * V_23 = V_2 -> V_24 ;
F_198 ( V_18 ) ;
if ( V_2 -> V_70 <= V_330 ) {
...
F_214 ( V_2 -> V_5 , V_405 , 0x40 ) ;
if ( V_2 -> V_70 <= V_330 )
F_214 ( V_2 -> V_5 , V_406 , 0x08 ) ;
if ( V_2 -> V_70 == V_223 ) {
F_153 ( L_14 ) ;
F_60 ( 0x82 , 0x01 ) ;
F_153 ( L_15 ) ;
...
static void F_215 ( struct V_1 * V_2 , T_4 * V_61 )
{
void T_3 * V_23 = V_2 -> V_24 ;
F_1 ( V_2 ) ;
F_60 ( V_157 , V_158 ) ;
...
static int F_216 ( struct V_53 * V_18 , void * V_51 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
F_215 ( V_2 , V_18 -> V_384 ) ;
return 0 ;
}
static int F_218 ( struct V_53 * V_18 , struct V_413 * V_414 , int V_78 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
struct V_415 * V_22 = F_219 ( V_414 ) ;
...
static int F_221 ( struct V_1 * V_2 , struct V_415 * V_22 , int V_78 )
{
return - V_191 ;
}
static void F_222 ( struct V_5 * V_6 , struct V_1 * V_2 )
{
if ( V_2 -> V_165 & V_424 ) {
F_223 ( V_6 ) ;
V_2 -> V_165 &= ~ V_424 ;
...
{
F_236 ( V_2 , V_2 -> V_437 . V_438 ) ;
}
static void F_239 ( struct V_1 * V_2 )
{
F_236 ( V_2 , V_2 -> V_437 . V_439 ) ;
}
...
if ( ! V_460 )
goto V_462;
V_171 = F_258 ( sizeof( * V_171 ) , V_463 ) ;
if ( ! V_171 )
goto V_464;
V_195 = F_259 ( & V_171 -> V_338 , V_460 , & V_2 -> V_5 -> V_18 ) ;
if ( V_195 < 0 )
goto V_465;
V_195 = F_157 ( V_2 , V_171 ) ;
if ( V_195 < 0 )
goto V_466;
V_2 -> V_171 = V_171 ;
V_216:
...
static void F_265 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
V_2 -> V_475 ( V_18 ) ;
F_80 ( V_2 ) ;
...
F_18 ( V_478 , ( ( V_277 ) V_2 -> V_477 ) & F_141 ( 32 ) ) ;
F_18 ( V_479 , ( ( V_277 ) V_2 -> V_480 ) >> 32 ) ;
F_18 ( V_481 , ( ( V_277 ) V_2 -> V_480 ) & F_141 ( 32 ) ) ;
}
static T_1 F_267 ( void T_3 * V_23 )
{
T_1 V_78 ;
V_78 = F_74 ( V_247 ) ;
F_76 ( V_247 , V_78 ) ;
...
static void F_268 ( void T_3 * V_23 , unsigned int V_482 )
{
F_76 ( V_483 , V_482 + 1 ) ;
}
static void F_269 ( void T_3 * V_23 , unsigned V_70 )
{
...
static void F_270 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
T_2 V_489 [ 2 ] ;
...
T_2 V_153 = 0 ;
if ( V_18 -> V_399 & V_491 ) {
F_151 ( V_2 , V_190 , V_18 , L_18 ) ;
V_490 =
V_431 | V_432 | V_433 |
V_492 ;
V_489 [ 1 ] = V_489 [ 0 ] = 0xffffffff ;
} else if ( ( F_271 ( V_18 ) > V_493 ) ||
( V_18 -> V_399 & V_494 ) ) {
...
V_489 [ 1 ] = V_489 [ 0 ] = 0 ;
F_272 (ha, dev) {
int V_497 = F_273 ( V_498 , V_496 -> V_61 ) >> 26 ;
...
static void F_275 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
...
static void F_276 ( struct V_1 * V_2 , int V_61 , int V_29 )
{
if ( V_2 -> V_507 . V_48 )
V_2 -> V_507 . V_48 ( V_2 , V_61 , V_29 ) ;
}
static T_2 F_277 ( struct V_1 * V_2 , int V_61 )
{
return V_2 -> V_507 . V_49 ? V_2 -> V_507 . V_49 ( V_2 , V_61 ) : ~ 0 ;
}
static void F_278 ( struct V_1 * V_2 , T_2 V_98 )
{
T_2 V_508 ;
V_508 = F_277 ( V_2 , 0x070c ) & 0x00ffffff ;
F_276 ( V_2 , 0x070c , V_508 | V_98 ) ;
}
static void F_279 ( struct V_1 * V_2 )
{
F_278 ( V_2 , 0x17000000 ) ;
}
static void F_280 ( struct V_1 * V_2 )
{
F_278 ( V_2 , 0x27000000 ) ;
}
static void F_281 ( struct V_1 * V_2 , int V_61 , int V_29 )
{
void T_3 * V_23 = V_2 -> V_24 ;
F_18 ( V_509 , V_29 ) ;
...
static T_2 F_282 ( struct V_1 * V_2 , int V_61 )
{
void T_3 * V_23 = V_2 -> V_24 ;
...
static void F_283 ( struct V_1 * V_2 , int V_61 , int V_29 )
{
void T_3 * V_23 = V_2 -> V_24 ;
F_18 ( V_509 , V_29 ) ;
F_18 ( V_510 , V_511 | ( V_61 & V_512 ) |
...
static T_2 F_284 ( struct V_1 * V_2 , int V_61 )
{
void T_3 * V_23 = V_2 -> V_24 ;
...
static void F_285 ( struct V_1 * V_2 , int V_61 , int V_29 )
{
void T_3 * V_23 = V_2 -> V_24 ;
F_18 ( V_509 , V_29 ) ;
F_18 ( V_510 , V_511 | ( V_61 & V_512 ) |
...
static T_2 F_286 ( struct V_1 * V_2 , int V_61 )
{
void T_3 * V_23 = V_2 -> V_24 ;
...
static void F_288 ( struct V_1 * V_2 , const struct V_518 * V_383 ,
int V_91 )
{
T_1 V_382 ;
while ( V_91 -- > 0 ) {
...
static void F_289 ( struct V_5 * V_6 )
{
F_290 ( V_6 , V_520 ,
V_521 ) ;
}
...
static void F_293 ( struct V_1 * V_2 , bool V_449 )
{
void T_3 * V_23 = V_2 -> V_24 ;
T_4 V_22 ;
V_22 = F_61 ( V_127 ) ;
...
F_5 ( V_6 , 0x5 << V_455 ) ;
F_60 ( V_456 , V_526 ) ;
for ( V_15 = 0 ; V_15 < F_101 ( V_534 ) ; V_15 ++ ) {
const struct V_518 * V_383 = V_534 + V_15 ;
T_1 V_382 ;
V_382 = F_45 ( V_2 , V_383 -> V_519 ) ;
F_44 ( V_2 , 0x03 , ( V_382 & V_383 -> V_62 ) | V_383 -> V_98 ) ;
}
F_291 ( V_6 ) ;
}
...
static void F_321 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
F_60 ( V_157 , V_158 ) ;
...
static void F_330 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
...
static int F_331 ( struct V_53 * V_18 , int V_585 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
if ( V_585 < V_586 ||
...
static inline void F_333 ( struct V_251 * V_252 )
{
V_252 -> V_61 = F_334 ( 0x0badbadbadbadbadull ) ;
V_252 -> V_588 &= ~ F_335 ( V_589 | V_590 ) ;
}
static void F_336 ( struct V_1 * V_2 ,
void * * V_591 , struct V_251 * V_252 )
{
F_337 ( & V_2 -> V_5 -> V_18 , F_147 ( V_252 -> V_61 ) , V_482 ,
V_592 ) ;
F_161 ( * V_591 ) ;
* V_591 = NULL ;
F_333 ( V_252 ) ;
}
static inline void F_338 ( struct V_251 * V_252 , T_2 V_482 )
{
T_2 V_593 = F_127 ( V_252 -> V_588 ) & V_594 ;
F_339 () ;
V_252 -> V_588 = F_335 ( V_589 | V_593 | V_482 ) ;
}
static inline void F_340 ( struct V_251 * V_252 , T_6 V_595 ,
T_2 V_482 )
{
V_252 -> V_61 = F_334 ( V_595 ) ;
F_338 ( V_252 , V_482 ) ;
}
static inline void * F_341 ( void * V_22 )
{
return ( void * ) F_342 ( ( long ) V_22 , 16 ) ;
}
static struct V_248 * F_343 ( struct V_1 * V_2 ,
struct V_251 * V_252 )
{
void * V_22 ;
T_6 V_595 ;
...
struct V_53 * V_18 = V_2 -> V_18 ;
int V_597 = V_18 -> V_18 . V_598 ? F_344 ( V_18 -> V_18 . V_598 ) : - 1 ;
V_22 = F_345 ( V_482 , V_463 , V_597 ) ;
if ( ! V_22 )
return NULL ;
if ( F_341 ( V_22 ) != V_22 ) {
F_161 ( V_22 ) ;
V_22 = F_345 ( V_482 + 15 , V_463 , V_597 ) ;
if ( ! V_22 )
return NULL ;
}
V_595 = F_346 ( V_10 , F_341 ( V_22 ) , V_482 ,
V_592 ) ;
if ( F_347 ( F_348 ( V_10 , V_595 ) ) ) {
if ( F_93 () )
F_11 ( V_2 , V_17 , V_2 -> V_18 , L_22 ) ;
goto V_599;
}
F_340 ( V_252 , V_595 , V_482 ) ;
return V_22 ;
V_599:
F_161 ( V_22 ) ;
return NULL ;
...
if ( V_2 -> V_601 [ V_15 ] ) {
F_336 ( V_2 , V_2 -> V_601 + V_15 ,
V_2 -> V_602 + V_15 ) ;
}
}
}
static inline void F_350 ( struct V_251 * V_252 )
{
V_252 -> V_588 |= F_335 ( V_594 ) ;
}
...
if ( V_2 -> V_601 [ V_15 ] )
continue;
V_22 = F_343 ( V_2 , V_2 -> V_602 + V_15 ) ;
if ( ! V_22 ) {
F_333 ( V_2 -> V_602 + V_15 ) ;
goto V_599;
}
V_2 -> V_601 [ V_15 ] = V_22 ;
}
F_350 ( V_2 -> V_602 + V_600 - 1 ) ;
return 0 ;
V_599:
F_349 ( V_2 ) ;
return - V_461 ;
}
static int F_352 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_242 ( V_2 ) ;
...
static void F_353 ( struct V_596 * V_10 , struct V_605 * V_603 ,
struct V_606 * V_252 )
{
unsigned int V_91 = V_603 -> V_91 ;
F_337 ( V_10 , F_147 ( V_252 -> V_61 ) , V_91 , V_607 ) ;
V_252 -> V_588 = 0x00 ;
V_252 -> V_253 = 0x00 ;
V_252 -> V_61 = 0x00 ;
V_603 -> V_91 = 0 ;
}
static void F_354 ( struct V_1 * V_2 , T_2 V_346 ,
unsigned int V_13 )
{
unsigned int V_15 ;
for ( V_15 = 0 ; V_15 < V_13 ; V_15 ++ ) {
...
static void F_363 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_201 ( V_2 , V_612 ) ;
}
static int F_364 ( struct V_1 * V_2 , struct V_248 * V_249 ,
T_2 * V_613 )
{
struct V_614 * V_170 = F_365 ( V_249 ) ;
...
V_91 = F_366 ( V_619 ) ;
V_61 = F_367 ( V_619 ) ;
V_595 = F_346 ( V_10 , V_61 , V_91 , V_607 ) ;
if ( F_347 ( F_348 ( V_10 , V_595 ) ) ) {
if ( F_93 () )
...
V_256 = V_613 [ 0 ] | V_91 |
( V_594 * ! ( ( V_608 + 1 ) % V_604 ) ) ;
V_617 -> V_588 = F_335 ( V_256 ) ;
V_617 -> V_253 = F_335 ( V_613 [ 1 ] ) ;
V_617 -> V_61 = F_334 ( V_595 ) ;
V_2 -> V_603 [ V_608 ] . V_91 = V_91 ;
}
if ( V_615 ) {
V_2 -> V_603 [ V_608 ] . V_249 = V_249 ;
V_617 -> V_588 |= F_335 ( V_621 ) ;
}
return V_615 ;
V_599:
F_354 ( V_2 , V_2 -> V_446 + 1 , V_615 ) ;
return - V_622 ;
}
static bool F_368 ( struct V_1 * V_2 , struct V_248 * V_249 )
{
...
struct V_248 * V_249 )
{
if ( F_365 ( V_249 ) -> V_623 ) {
T_5 V_165 = V_2 -> V_18 -> V_165 ;
struct V_248 * V_624 , * V_625 ;
V_165 &= ~ ( V_626 | V_627 | V_628 ) ;
V_624 = F_370 ( V_249 , V_165 ) ;
if ( F_261 ( V_624 ) || ! V_624 )
goto V_629;
do {
V_625 = V_624 ;
V_624 = V_624 -> V_630 ;
V_625 -> V_630 = NULL ;
F_371 ( V_625 , V_2 -> V_18 ) ;
} while ( V_624 );
F_372 ( V_249 ) ;
} else if ( V_249 -> V_631 == V_632 ) {
if ( F_373 ( V_249 ) < 0 )
goto V_629;
F_371 ( V_249 , V_2 -> V_18 ) ;
} else {
struct V_633 * V_292 ;
V_629:
...
static int F_374 ( struct V_248 * V_249 )
{
...
V_637 = F_377 ( V_249 ) ;
V_637 -> V_16 = 0 ;
V_637 -> V_16 = ~ F_378 ( 0 , & V_635 -> V_638 , & V_635 -> V_639 , 0 ) ;
return V_183 ;
}
static inline T_9 F_379 ( struct V_248 * V_249 )
{
T_9 V_640 ;
if ( V_249 -> V_640 == F_129 ( V_255 ) )
V_640 = F_380 ( V_249 ) -> V_641 ;
else
V_640 = V_249 -> V_640 ;
return V_640 ;
}
...
{
T_2 V_642 = F_365 ( V_249 ) -> V_623 ;
if ( V_642 ) {
V_613 [ 0 ] |= V_643 ;
V_613 [ 0 ] |= F_382 ( V_642 , V_232 ) << V_644 ;
} else if ( V_249 -> V_631 == V_632 ) {
const struct V_645 * V_646 = F_383 ( V_249 ) ;
...
static bool F_385 ( struct V_1 * V_2 ,
struct V_248 * V_249 , T_2 * V_613 )
{
T_2 V_652 = ( T_2 ) F_386 ( V_249 ) ;
T_2 V_642 = F_365 ( V_249 ) -> V_623 ;
if ( V_642 ) {
if ( V_652 > V_653 ) {
...
V_613 [ 0 ] |= V_652 << V_659 ;
V_613 [ 1 ] |= F_382 ( V_642 , V_232 ) << V_660 ;
} else if ( V_249 -> V_631 == V_632 ) {
T_4 V_661 ;
if ( F_347 ( F_368 ( V_2 , V_249 ) ) )
return ! ( F_373 ( V_249 ) || F_387 ( V_249 ) ) ;
if ( V_652 > V_662 ) {
F_112 ( V_2 , V_654 , V_2 -> V_18 ,
L_25 ,
V_652 ) ;
...
case F_129 ( V_655 ) :
V_613 [ 1 ] |= V_663 ;
V_661 = F_383 ( V_249 ) -> V_640 ;
break;
case F_129 ( V_657 ) :
V_613 [ 1 ] |= V_664 ;
V_661 = F_376 ( V_249 ) -> V_665 ;
break;
default:
V_661 = V_666 ;
break;
...
static T_10 F_371 ( struct V_248 * V_249 ,
struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
T_2 V_613 [ 2 ] ;
int V_620 ;
if ( F_347 ( ! F_388 ( V_2 , F_365 ( V_249 ) -> V_618 ) ) ) {
F_11 ( V_2 , V_17 , V_18 , L_26 ) ;
goto V_670;
}
if ( F_347 ( F_127 ( V_617 -> V_588 ) & V_589 ) )
goto V_670;
V_613 [ 1 ] = F_335 ( F_122 ( V_249 ) ) ;
V_613 [ 0 ] = V_589 ;
...
V_91 = F_389 ( V_249 ) ;
V_595 = F_346 ( V_10 , V_249 -> V_22 , V_91 , V_607 ) ;
if ( F_347 ( F_348 ( V_10 , V_595 ) ) ) {
if ( F_93 () )
...
return V_672 ;
V_674:
F_353 ( V_10 , V_2 -> V_603 + V_608 , V_617 ) ;
V_673:
F_355 ( V_249 ) ;
V_18 -> V_292 . V_610 ++ ;
return V_672 ;
...
struct V_5 * V_6 = V_2 -> V_5 ;
T_1 V_680 , V_681 ;
F_395 ( V_6 , V_682 , & V_681 ) ;
F_395 ( V_6 , V_683 , & V_680 ) ;
...
struct V_605 * V_603 = V_2 -> V_603 + V_608 ;
T_2 V_256 ;
V_256 = F_127 ( V_2 -> V_609 [ V_608 ] . V_588 ) ;
if ( V_256 & V_589 )
break;
F_399 () ;
F_353 ( & V_2 -> V_5 -> V_18 , V_603 ,
...
static inline int F_403 ( T_2 V_256 )
{
return ( V_256 & ( V_675 | V_621 ) ) != ( V_675 | V_621 ) ;
}
static inline void F_404 ( struct V_248 * V_249 , T_2 V_588 )
{
...
static struct V_248 * F_406 ( void * V_22 ,
struct V_1 * V_2 ,
int V_706 ,
T_6 V_61 )
{
...
struct V_596 * V_10 = & V_2 -> V_5 -> V_18 ;
V_22 = F_341 ( V_22 ) ;
F_407 ( V_10 , V_61 , V_706 , V_592 ) ;
F_408 ( V_22 ) ;
V_249 = F_409 ( & V_2 -> V_611 , V_706 ) ;
if ( V_249 )
memcpy ( V_249 -> V_22 , V_22 , V_706 ) ;
F_410 ( V_10 , V_61 , V_706 , V_592 ) ;
return V_249 ;
}
static int F_411 ( struct V_53 * V_18 , struct V_1 * V_2 , T_2 V_707 )
{
unsigned int V_447 , V_708 ;
unsigned int V_372 ;
V_447 = V_2 -> V_447 ;
for ( V_708 = F_382 ( V_707 , V_600 ) ; V_708 > 0 ; V_708 -- , V_447 ++ ) {
unsigned int V_608 = V_447 % V_600 ;
struct V_251 * V_252 = V_2 -> V_602 + V_608 ;
T_2 V_256 ;
V_256 = F_127 ( V_252 -> V_588 ) & V_2 -> V_709 ;
if ( V_256 & V_589 )
break;
F_399 () ;
if ( F_347 ( V_256 & V_710 ) ) {
...
int V_706 ;
V_719:
V_61 = F_147 ( V_252 -> V_61 ) ;
if ( F_412 ( ! ( V_18 -> V_165 & V_720 ) ) )
V_706 = ( V_256 & 0x00003fff ) - 4 ;
else
V_706 = V_256 & 0x00003fff ;
if ( F_347 ( F_403 ( V_256 ) ) ) {
V_18 -> V_292 . V_721 ++ ;
V_18 -> V_292 . V_714 ++ ;
goto V_722;
}
V_249 = F_406 ( V_2 -> V_601 [ V_608 ] ,
V_2 , V_706 , V_61 ) ;
if ( ! V_249 ) {
V_18 -> V_292 . V_721 ++ ;
goto V_722;
...
F_404 ( V_249 , V_256 ) ;
F_413 ( V_249 , V_706 ) ;
V_249 -> V_640 = F_414 ( V_249 , V_18 ) ;
F_126 ( V_252 , V_249 ) ;
if ( V_249 -> V_723 == V_724 )
V_18 -> V_292 . V_725 ++ ;
F_415 ( & V_2 -> V_611 , V_249 ) ;
F_400 ( & V_2 -> V_726 . V_697 ) ;
V_2 -> V_726 . V_698 ++ ;
...
static T_11 F_416 ( int V_727 , void * V_728 )
{
...
F_75 ( V_2 , V_256 ) ;
if ( F_347 ( V_256 & V_567 ) ) {
switch ( V_2 -> V_70 ) {
case V_318 :
F_359 ( V_18 ) ;
F_420 ( V_612 , V_2 -> V_3 . V_399 ) ;
default:
break;
}
}
if ( F_347 ( V_256 & V_730 ) )
F_394 ( V_18 ) ;
if ( V_256 & V_731 )
F_90 ( V_18 , V_2 , V_2 -> V_24 , true ) ;
F_80 ( V_2 ) ;
}
static void F_421 ( struct V_732 * V_400 )
{
static const struct {
int V_733 ;
...
struct V_1 * V_2 =
F_422 ( V_400 , struct V_1 , V_3 . V_400 ) ;
struct V_53 * V_18 = V_2 -> V_18 ;
int V_15 ;
F_1 ( V_2 ) ;
if ( ! F_89 ( V_18 ) ||
! F_423 ( V_736 , V_2 -> V_3 . V_399 ) )
goto V_737;
for ( V_15 = 0 ; V_15 < F_101 ( V_734 ) ; V_15 ++ ) {
bool V_738 ;
V_738 = F_424 ( V_734 [ V_15 ] . V_733 , V_2 -> V_3 . V_399 ) ;
if ( V_738 )
...
static int F_425 ( struct V_739 * V_611 , int V_707 )
{
struct V_1 * V_2 = F_422 ( V_611 , struct V_1 , V_611 ) ;
struct V_53 * V_18 = V_2 -> V_18 ;
...
if ( V_256 & V_742 )
V_741 = F_411 ( V_18 , V_2 , ( T_2 ) V_707 ) ;
if ( V_256 & V_743 )
F_397 ( V_18 , V_2 ) ;
if ( V_256 & V_2 -> V_101 ) {
V_740 &= ~ V_2 -> V_101 ;
...
F_143 ( V_18 ) ;
F_1 ( V_2 ) ;
F_431 ( V_736 , V_2 -> V_3 . V_399 ) ;
F_428 ( V_18 ) ;
F_3 ( V_2 ) ;
F_432 ( & V_2 -> V_3 . V_400 ) ;
F_433 ( V_6 -> V_727 , V_18 ) ;
F_434 ( & V_6 -> V_18 , V_745 , V_2 -> V_602 ,
V_2 -> V_480 ) ;
F_434 ( & V_6 -> V_18 , V_746 , V_2 -> V_609 ,
V_2 -> V_477 ) ;
V_2 -> V_609 = NULL ;
V_2 -> V_602 = NULL ;
F_435 ( & V_6 -> V_18 ) ;
...
static void F_436 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_416 ( V_2 -> V_5 -> V_727 , V_18 ) ;
}
static int F_437 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
int V_747 = - V_461 ;
F_430 ( & V_6 -> V_18 ) ;
V_2 -> V_609 = F_438 ( & V_6 -> V_18 , V_746 ,
& V_2 -> V_477 , V_463 ) ;
if ( ! V_2 -> V_609 )
goto V_748;
V_2 -> V_602 = F_438 ( & V_6 -> V_18 , V_745 ,
& V_2 -> V_480 , V_463 ) ;
if ( ! V_2 -> V_602 )
goto V_749;
V_747 = F_352 ( V_18 ) ;
if ( V_747 < 0 )
goto V_750;
F_439 ( & V_2 -> V_3 . V_400 , F_421 ) ;
F_393 () ;
F_260 ( V_2 ) ;
V_747 = F_440 ( V_6 -> V_727 , F_416 ,
( V_2 -> V_165 & V_424 ) ? 0 : V_751 ,
V_18 -> V_460 , V_18 ) ;
if ( V_747 < 0 )
goto V_752;
F_1 ( V_2 ) ;
F_420 ( V_736 , V_2 -> V_3 . V_399 ) ;
F_361 ( & V_2 -> V_611 ) ;
F_213 ( V_18 , V_2 ) ;
...
static struct V_754 *
F_443 ( struct V_53 * V_18 , struct V_754 * V_292 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_284 * V_285 = V_2 -> V_285 ;
...
F_427 ( V_18 , V_23 ) ;
do {
V_346 = F_444 ( & V_2 -> V_726 . V_697 ) ;
V_292 -> V_294 = V_2 -> V_726 . V_698 ;
V_292 -> V_755 = V_2 -> V_726 . V_699 ;
} while ( F_445 ( & V_2 -> V_726 . V_697 , V_346 ) );
do {
V_346 = F_444 ( & V_2 -> V_696 . V_697 ) ;
V_292 -> V_293 = V_2 -> V_696 . V_698 ;
V_292 -> V_756 = V_2 -> V_696 . V_699 ;
} while ( F_445 ( & V_2 -> V_696 . V_697 , V_346 ) );
...
F_143 ( V_18 ) ;
V_292 -> V_288 = F_147 ( V_285 -> V_288 ) -
F_147 ( V_2 -> V_286 . V_288 ) ;
V_292 -> V_757 = F_127 ( V_285 -> V_289 ) -
F_127 ( V_2 -> V_286 . V_289 ) ;
V_292 -> V_758 = F_148 ( V_285 -> V_290 ) -
F_148 ( V_2 -> V_286 . V_290 ) ;
return V_292 ;
}
static void F_446 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
if ( ! F_89 ( V_18 ) )
return;
...
static int F_448 ( struct V_596 * V_596 )
{
struct V_5 * V_6 = F_449 ( V_596 ) ;
struct V_53 * V_18 = F_450 ( V_6 ) ;
F_446 ( V_18 ) ;
return 0 ;
}
...
static int F_453 ( struct V_596 * V_596 )
{
struct V_5 * V_6 = F_449 ( V_596 ) ;
struct V_53 * V_18 = F_450 ( V_6 ) ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
static int F_454 ( struct V_596 * V_596 )
{
struct V_5 * V_6 = F_449 ( V_596 ) ;
struct V_53 * V_18 = F_450 ( V_6 ) ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
static int F_455 ( struct V_596 * V_596 )
{
struct V_5 * V_6 = F_449 ( V_596 ) ;
struct V_53 * V_18 = F_450 ( V_6 ) ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
F_463 ( & V_2 -> V_611 ) ;
F_464 ( V_18 ) ;
F_434 ( & V_2 -> V_5 -> V_18 , sizeof( * V_2 -> V_285 ) ,
V_2 -> V_285 , V_2 -> V_275 ) ;
F_159 ( V_2 ) ;
if ( F_465 ( V_6 ) )
F_466 ( & V_6 -> V_18 ) ;
F_215 ( V_2 , V_18 -> V_760 ) ;
F_222 ( V_6 , V_2 ) ;
F_205 ( V_6 , V_18 , V_2 -> V_24 ) ;
}
static unsigned F_467 ( struct V_1 * V_2 ,
...
static int F_472 ( struct V_5 * V_6 , const struct V_770 * V_771 )
{
...
V_2 -> V_18 = V_18 ;
V_2 -> V_5 = V_6 ;
V_2 -> V_269 = F_476 ( V_777 . V_269 , V_781 ) ;
V_212 = & V_2 -> V_212 ;
V_212 -> V_18 = V_18 ;
V_212 -> V_782 = F_43 ;
V_212 -> V_783 = F_41 ;
...
if ( F_481 ( V_6 , V_774 ) < V_178 ) {
F_11 ( V_2 , V_335 , V_18 ,
L_37 ) ;
V_195 = - V_417 ;
goto V_792;
}
V_195 = F_482 ( V_6 , V_173 ) ;
if ( V_195 < 0 ) {
...
V_2 -> V_243 = 0 ;
if ( ( sizeof( T_6 ) > 4 ) &&
! F_483 ( V_6 , F_141 ( 64 ) ) && V_793 ) {
V_2 -> V_243 |= V_693 ;
V_18 -> V_165 |= V_694 ;
} else {
V_195 = F_483 ( V_6 , F_141 ( 32 ) ) ;
if ( V_195 < 0 ) {
F_11 ( V_2 , V_335 , V_18 , L_39 ) ;
goto V_794;
}
}
V_23 = F_484 ( F_485 ( V_6 , V_774 ) , V_178 ) ;
if ( ! V_23 ) {
F_11 ( V_2 , V_335 , V_18 , L_40 ) ;
V_195 = - V_622 ;
goto V_794;
}
V_2 -> V_24 = V_23 ;
if ( ! F_486 ( V_6 ) )
F_94 ( V_2 , V_335 , V_18 , L_41 ) ;
F_150 ( V_2 , V_18 , V_155 -> V_795 ) ;
F_241 ( V_2 ) ;
F_78 ( V_2 ) ;
F_471 ( V_2 ) ;
F_256 ( V_2 ) ;
...
F_152 ( V_2 ) ;
V_776 = V_2 -> V_70 ;
V_2 -> V_796 = V_167 [ V_776 ] . V_796 ;
F_60 ( V_157 , V_158 ) ;
F_60 ( V_125 , F_61 ( V_125 ) | V_126 ) ;
F_60 ( V_142 , F_61 ( V_142 ) & ( V_145 | V_147 | V_143 | V_156 | V_797 ) ) ;
switch ( V_2 -> V_70 ) {
case V_110 :
case V_114 :
case V_115 :
...
F_488 ( & V_2 -> V_3 . V_4 ) ;
F_489 ( & V_2 -> V_726 . V_697 ) ;
F_489 ( & V_2 -> V_696 . V_697 ) ;
if ( V_2 -> V_70 == V_114 ||
V_2 -> V_70 == V_115 ||
V_2 -> V_70 == V_116 ||
V_2 -> V_70 == V_111 ||
...
V_18 -> V_799 = & V_800 ;
V_18 -> V_801 = V_802 ;
F_490 ( V_18 , & V_2 -> V_611 , F_425 , V_803 ) ;
V_18 -> V_165 |= V_242 |
V_804 | V_245 ;
V_18 -> V_805 = V_626 | V_236 | V_806 |
V_242 | V_804 |
V_245 ;
V_18 -> V_807 = V_626 | V_236 | V_806 |
V_694 ;
...
V_2 -> V_227 . V_811 = F_204 ;
V_2 -> V_171 = V_373 ;
V_2 -> V_285 = F_438 ( & V_6 -> V_18 , sizeof( * V_2 -> V_285 ) ,
& V_2 -> V_275 , V_463 ) ;
if ( ! V_2 -> V_285 ) {
V_195 = - V_461 ;
goto V_812;
...
return V_195 ;
V_813:
F_434 ( & V_6 -> V_18 , sizeof( * V_2 -> V_285 ) , V_2 -> V_285 ,
V_2 -> V_275 ) ;
V_812:
F_463 ( & V_2 -> V_611 ) ;
F_222 ( V_6 , V_2 ) ;
