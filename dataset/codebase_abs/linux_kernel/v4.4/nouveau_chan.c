...
args . V_78 . V_79 = 0 ;
args . V_78 . V_65 = V_65 ;
args . V_78 . V_80 = 0x02000 ;
args . V_78 . V_81 = 0x10000 + V_2 -> V_19 . V_22 . V_40 ;
args . V_78 . V_45 = 0 ;
V_27 = sizeof( args . V_78 ) ;
} else
if ( V_72 [ 0 ] >= V_69 ) {
args . V_76 . V_79 = 0 ;
args . V_76 . V_80 = 0x02000 ;
args . V_76 . V_81 = 0x10000 + V_2 -> V_19 . V_22 . V_40 ;
args . V_76 . V_45 = 0 ;
V_27 = sizeof( args . V_76 ) ;
} else {
args . V_74 . V_79 = 0 ;
args . V_74 . V_80 = 0x02000 ;
args . V_74 . V_81 = 0x10000 + V_2 -> V_19 . V_22 . V_40 ;
args . V_74 . V_82 = F_26 ( & V_2 -> V_19 . V_20 ) ;
args . V_74 . V_45 = 0 ;
V_27 = sizeof( args . V_74 ) ;
}
V_9 = F_24 ( & V_26 -> V_28 , 0 , * V_72 ++ ,
& args , V_27 , & V_2 -> V_6 ) ;
if ( V_9 == 0 ) {
if ( V_2 -> V_6 . V_72 >= V_68 )
V_2 -> V_11 = args . V_78 . V_11 ;
else
if ( V_2 -> V_6 . V_72 >= V_69 )
V_2 -> V_11 = args . V_76 . V_11 ;
else
V_2 -> V_11 = args . V_74 . V_11 ;
return V_9 ;
}
} while ( * V_72 );
F_8 ( V_14 ) ;
...
V_9 = F_24 ( & V_2 -> V_6 , V_17 , V_90 ,
& args , sizeof( args ) , & V_2 -> V_17 ) ;
if ( V_9 )
return V_9 ;
}
switch ( V_2 -> V_6 . V_72 & 0x00ff ) {
case 0x006b :
case 0x006e :
V_2 -> V_91 = 0x40 ;
V_2 -> V_92 = 0x44 ;
...
T_1 V_107 , T_1 V_108 , struct V_1 * * V_14 )
{
struct V_4 * V_5 = ( void * ) V_26 -> V_28 . V_7 ;
bool V_109 ;
int V_9 ;
V_109 = V_5 -> V_12 . V_109 ;
V_5 -> V_12 . V_109 = true ;
V_9 = F_25 ( V_15 , V_26 , V_107 , V_14 ) ;
if ( V_9 ) {
F_6 ( V_110 , V_5 , L_2 , V_9 ) ;
V_9 = F_27 ( V_15 , V_26 , V_14 ) ;
if ( V_9 ) {
F_6 ( V_110 , V_5 , L_3 , V_9 ) ;
goto V_111;
}
}
V_9 = F_28 ( * V_14 , V_107 , V_108 ) ;
if ( V_9 ) {
F_6 ( V_10 , V_5 , L_4 , V_9 ) ;
F_8 ( V_14 ) ;
}
V_111:
V_5 -> V_12 . V_109 = V_109 ;
return V_9 ;
}
