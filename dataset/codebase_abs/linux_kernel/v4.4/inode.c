...
static void F_55 ( void * V_63 , struct V_21 * V_21 )
{
struct V_7 * V_8 = V_63 ;
...
F_63 ( V_72 , & V_21 -> V_28 -> V_73 ) ;
F_29 ( V_21 ) ;
return V_25 ;
}
static int F_64 ( struct V_61 * V_28 ,
struct V_70 * V_74 )
{
struct V_7 V_8 ;
long V_75 , V_76 , V_3 ;
...
static void F_67 ( struct V_9 * V_9 , T_2 V_83 )
{
if ( V_83 > V_9 -> V_54 )
F_68 ( V_9 , V_9 -> V_54 ) ;
}
int F_69 ( struct V_60 * V_60 , struct V_61 * V_28 ,
...
V_21 = * V_85 ;
if ( V_21 == NULL ) {
V_25 = F_70 ( V_60 , V_28 , V_84 , V_24 , V_73 , V_85 ,
V_86 ) ;
if ( V_25 ) {
F_20 ( L_46 ) ;
goto V_87;
...
{
* V_85 = NULL ;
return F_69 ( V_60 , V_28 , V_84 , V_24 , V_73 , V_85 ,
V_86 ) ;
}
static int F_72 ( struct V_60 * V_60 , struct V_61 * V_28 ,
...
T_2 V_54 = V_9 -> V_54 ;
int V_25 ;
V_25 = F_73 ( V_60 , V_28 , V_84 , V_24 , V_89 , V_21 , V_86 ) ;
if ( F_14 ( V_25 ) )
F_67 ( V_9 , V_84 + V_24 ) ;
if ( V_54 != V_9 -> V_54 )
F_74 ( V_9 ) ;
...
static int F_75 ( struct V_21 * V_21 , T_5 V_90 )
{
F_20 ( L_48 , V_21 -> V_34 ) ;
F_76 ( 1 ) ;
return 0 ;
...
static T_6 F_78 ( struct V_91 * V_92 , struct V_93 * V_94 ,
T_2 V_52 )
{
return 0 ;
}
...
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
return F_80 ( V_9 -> V_95 ) && ( V_45 -> V_96 [ 0 ] != 0 ) ;
}
static int F_81 ( struct V_9 * V_9 , T_2 V_97 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
struct V_10 * V_11 = V_9 -> V_12 -> V_13 ;
int V_25 ;
V_9 -> V_98 = V_9 -> V_99 = V_100 ;
V_25 = F_82 ( & V_11 -> V_2 , & V_45 -> V_47 , ( T_1 ) V_97 ) ;
if ( F_8 ( ! V_25 ) )
F_83 ( V_9 , V_97 ) ;
F_27 ( L_50 ,
V_9 -> V_31 , V_97 , V_25 ) ;
...
int F_84 ( struct V_101 * V_101 , struct V_102 * V_102 )
{
struct V_9 * V_9 = F_85 ( V_101 ) ;
int error ;
error = F_60 ( F_36 ( V_9 ) ) ;
if ( F_14 ( error ) )
return error ;
...
static int F_88 ( struct V_106 * V_107 , struct V_44 * V_45 ,
struct V_108 * V_9 )
{
...
V_110 [ 1 ] . V_24 = F_90 ( V_11 -> V_47 . V_116 ) ;
V_110 [ 2 ] . V_24 = F_90 ( V_11 -> V_47 . V_116 ) ;
V_14 -> V_117 = V_110 ;
V_14 -> V_118 = F_91 ( V_110 ) ;
V_25 = F_38 ( V_14 ) ;
if ( F_14 ( V_25 ) ) {
F_9 ( L_52 ,
...
V_25 = F_92 ( V_14 , & V_110 [ 0 ] ) ;
if ( V_25 ) {
F_9 ( L_53 , V_115 ) ;
goto V_87;
}
F_76 ( V_110 [ 0 ] . V_24 != V_122 ) ;
memcpy ( V_9 , V_110 [ 0 ] . V_123 , V_122 ) ;
V_25 = F_92 ( V_14 , & V_110 [ 1 ] ) ;
if ( V_25 ) {
F_9 ( L_54 , V_115 ) ;
goto V_87;
}
...
struct V_9 * F_96 ( struct V_106 * V_107 , unsigned long V_129 )
{
struct V_44 * V_45 ;
struct V_108 V_130 ;
struct V_9 * V_9 ;
int V_25 ;
V_9 = F_97 ( V_107 , V_129 ) ;
if ( ! V_9 )
return F_98 ( - V_23 ) ;
if ( ! ( V_9 -> V_131 & V_132 ) )
return V_9 ;
V_45 = F_36 ( V_9 ) ;
F_94 ( V_45 ) ;
F_99 ( & V_45 -> V_47 , & V_45 -> V_119 , V_107 -> V_13 ,
F_100 ( V_45 ) ) ;
V_25 = F_88 ( V_107 , V_45 , & V_130 ) ;
if ( V_25 )
goto V_133;
F_101 ( V_45 ) ;
V_9 -> V_95 = F_102 ( V_130 . V_95 ) ;
F_103 ( V_9 , F_104 ( V_130 . V_134 ) ) ;
F_105 ( V_9 , F_104 ( V_130 . V_135 ) ) ;
F_106 ( V_9 , F_102 ( V_130 . V_136 ) ) ;
V_9 -> V_99 . V_137 = ( signed ) F_104 ( V_130 . V_99 ) ;
V_9 -> V_138 . V_137 = ( signed ) F_104 ( V_130 . V_138 ) ;
V_9 -> V_98 . V_137 = ( signed ) F_104 ( V_130 . V_98 ) ;
V_9 -> V_99 . V_139 =
V_9 -> V_138 . V_139 = V_9 -> V_98 . V_139 = 0 ;
V_45 -> V_140 = F_107 ( V_130 . V_54 ) ;
F_108 ( V_9 , V_45 -> V_140 ) ;
V_9 -> V_141 = V_142 ;
V_9 -> V_143 = F_104 ( V_130 . V_143 ) ;
V_45 -> V_144 = 0 ;
...
if ( V_130 . V_96 [ 0 ] )
V_9 -> V_147 =
F_111 ( F_104 ( V_130 . V_96 [ 0 ] ) ) ;
else
V_9 -> V_147 =
F_112 ( F_104 ( V_130 . V_96 [ 1 ] ) ) ;
} else {
...
V_130 = & args -> V_130 ;
V_130 -> V_95 = F_93 ( V_9 -> V_95 ) ;
V_130 -> V_134 = F_136 ( F_137 ( V_9 ) ) ;
V_130 -> V_135 = F_136 ( F_138 ( V_9 ) ) ;
V_130 -> V_136 = F_93 ( V_9 -> V_145 ) ;
V_130 -> V_99 = F_136 ( V_9 -> V_99 . V_137 ) ;
V_130 -> V_138 = F_136 ( V_9 -> V_138 . V_137 ) ;
V_130 -> V_98 = F_136 ( V_9 -> V_98 . V_137 ) ;
V_45 -> V_140 = F_41 ( V_9 ) ;
V_130 -> V_54 = F_139 ( V_45 -> V_140 ) ;
V_130 -> V_143 = F_136 ( V_9 -> V_143 ) ;
if ( F_109 ( V_9 -> V_95 ) || F_110 ( V_9 -> V_95 ) ) {
if ( F_140 ( V_9 -> V_147 ) ) {
V_130 -> V_96 [ 0 ] =
F_136 ( F_141 ( V_9 -> V_147 ) ) ;
V_130 -> V_96 [ 1 ] = 0 ;
} else {
V_130 -> V_96 [ 0 ] = 0 ;
V_130 -> V_96 [ 1 ] =
F_136 ( F_142 ( V_9 -> V_147 ) ) ;
V_130 -> V_96 [ 2 ] = 0 ;
}
} else
