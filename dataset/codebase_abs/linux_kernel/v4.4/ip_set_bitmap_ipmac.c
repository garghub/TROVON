...
V_6 . V_11 = F_1 ( V_7 , V_3 ) ;
if ( V_57 [ V_35 ] ) {
memcpy ( V_6 . V_17 , F_34 ( V_57 [ V_35 ] ) , V_36 ) ;
V_6 . V_14 = 1 ;
}
V_60 = V_46 ( V_23 , & V_6 , & V_21 , & V_21 , V_27 ) ;
return F_35 ( V_60 , V_27 ) ? 0 : V_60 ;
}
static bool
F_36 ( const struct V_22 * V_63 , const struct V_22 * V_64 )
{
...
static bool
F_37 ( struct V_22 * V_23 , struct V_1 * V_7 ,
T_1 V_4 , T_1 V_38 , T_1 V_67 )
{
V_7 -> V_12 = F_38 ( V_7 -> V_68 ) ;
if ( ! V_7 -> V_12 )
return false ;
V_7 -> V_4 = V_4 ;
V_7 -> V_38 = V_38 ;
...
static int
F_39 ( struct V_72 * V_72 , struct V_22 * V_23 , struct V_56 * V_57 [] ,
T_1 V_27 )
{
T_1 V_4 = 0 , V_38 = 0 ;
T_5 V_67 ;
...
if ( V_67 > V_80 + 1 )
return - V_81 ;
V_23 -> V_8 = F_43 ( V_23 , V_57 ,
sizeof( struct V_9 ) ,
F_44 ( struct V_9 ) ) ;
V_7 = F_38 ( sizeof( * V_7 ) + V_67 * V_23 -> V_8 ) ;
if ( ! V_7 )
return - V_82 ;
V_7 -> V_68 = F_45 ( 0 , V_67 - 1 ) ;
V_23 -> V_47 = & V_1 ;
if ( ! F_37 ( V_23 , V_7 , V_4 , V_38 , V_67 ) ) {
F_46 ( V_7 ) ;
return - V_82 ;
}
if ( V_57 [ V_73 ] ) {
V_23 -> V_19 = F_47 ( V_57 [ V_73 ] ) ;
F_48 ( V_23 , V_83 ) ;
}
return 0 ;
}
