...
if ( V_126 ) {
if ( V_123 ) {
memcpy ( * V_127 , V_123 , F_49 ( (struct V_109 * ) V_123 ) ) ;
* V_57 = (struct V_109 * ) * V_127 ;
* V_127 += F_56 ( F_49 ( * V_57 ) ) ;
}
} else {
if ( V_124 ) {
if ( F_57 ( * V_127 , V_124 , V_125 ) )
return - V_128 ;
* V_57 = (struct V_109 * ) * V_127 ;
if ( F_49 ( * V_57 ) > V_125 )
return - V_129 ;
...
struct V_111 *
F_58 ( struct V_117 * V_118 , struct V_111 * V_22 ,
int V_130 ,
struct V_109 T_5 * V_124 , int V_125 )
{
int V_120 = 0 ;
...
V_120 += F_56 ( F_49 ( V_22 -> V_114 ) ) ;
if ( V_130 != V_133 && V_22 -> V_112 )
V_120 += F_56 ( F_49 ( V_22 -> V_112 ) ) ;
if ( V_130 != V_134 && V_22 -> V_71 )
V_120 += F_56 ( F_49 ( V_22 -> V_71 ) ) ;
if ( V_130 != V_135 && V_22 -> V_116 )
V_120 += F_56 ( F_49 ( V_22 -> V_116 ) ) ;
}
if ( V_124 && V_125 )
V_120 += F_56 ( V_125 ) ;
if ( ! V_120 )
...
V_119 -> V_120 = V_120 ;
V_127 = ( char * ) ( V_119 + 1 ) ;
V_131 = F_55 ( V_22 ? V_22 -> V_114 : NULL , V_124 , V_125 ,
V_130 != V_132 ,
& V_119 -> V_114 , & V_127 ) ;
if ( V_131 )
goto V_86;
V_131 = F_55 ( V_22 ? V_22 -> V_112 : NULL , V_124 , V_125 ,
V_130 != V_133 ,
& V_119 -> V_112 , & V_127 ) ;
if ( V_131 )
goto V_86;
V_131 = F_55 ( V_22 ? V_22 -> V_71 : NULL , V_124 , V_125 ,
V_130 != V_134 ,
(struct V_109 * * ) & V_119 -> V_71 , & V_127 ) ;
if ( V_131 )
goto V_86;
V_131 = F_55 ( V_22 ? V_22 -> V_116 : NULL , V_124 , V_125 ,
V_130 != V_135 ,
& V_119 -> V_116 , & V_127 ) ;
if ( V_131 )
goto V_86;
V_119 -> V_137 = ( V_119 -> V_114 ? F_49 ( V_119 -> V_114 ) : 0 ) +
( V_119 -> V_112 ? F_49 ( V_119 -> V_112 ) : 0 ) +
( V_119 -> V_71 ? F_49 ( V_119 -> V_71 ) : 0 ) ;
V_119 -> V_138 = ( V_119 -> V_116 ? F_49 ( V_119 -> V_116 ) : 0 ) ;
return V_119 ;
V_86:
F_60 ( V_118 , V_119 , V_119 -> V_120 ) ;
return F_59 ( V_131 ) ;
}
struct V_111 * F_61 ( struct V_111 * V_139 ,
struct V_111 * V_22 )
{
...
V_22 -> V_137 -= F_49 ( V_22 -> V_112 ) ;
V_22 -> V_112 = NULL ;
}
return V_22 ;
}
struct V_25 * F_62 ( struct V_140 * V_141 ,
...
return NULL ;
* V_142 = V_141 -> V_4 ;
V_141 -> V_4 = * ( (struct V_58 * ) V_22 -> V_71 ) -> V_32 ;
return V_142 ;
}
