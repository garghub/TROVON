...
V_75 -> V_63 = F_47 ( sizeof( struct V_62 ) , V_97 ) ;
if ( V_75 -> V_63 == NULL ) {
F_48 ( V_73 -> V_21 ) ;
return - V_98 ;
}
...
static void F_49 ( struct V_44 * V_100 )
{
struct V_30 * V_13 ;
struct V_46 * V_49 ;
struct V_40 * V_41 ;
...
static void F_51 ( const struct V_101 * V_73 )
{
const struct V_74 * V_75 = V_73 -> V_76 ;
unsigned int V_9 ;
F_48 ( V_73 -> V_21 ) ;
for ( V_9 = 0 ; V_9 < F_4 ( V_75 -> V_63 -> V_67 ) ; ++ V_9 )
F_49 ( & V_75 -> V_63 -> V_67 [ V_9 ] ) ;
for ( V_9 = 0 ; V_9 < F_4 ( V_75 -> V_63 -> V_66 ) ; ++ V_9 )
F_49 ( & V_75 -> V_63 -> V_66 [ V_9 ] ) ;
F_52 ( V_75 -> V_63 ) ;
}
