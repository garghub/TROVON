...
return - V_16 ;
if ( V_1 == V_181 )
error = F_77 ( V_82 , & V_175 , & V_174 ,
V_173 . V_180 , V_182 ) ;
else if ( V_1 == V_183 )
error = F_78 ( V_82 , V_175 , V_173 . V_180 ,
sizeof( V_184 ) , NULL , & V_176 ) ;
else
error = F_79 ( V_82 , & V_175 , & V_174 , F_78 ,
...
int V_267 ;
F_104 ( V_10 ) ;
V_267 = F_100 ( V_10 , V_208 ) ;
if ( V_267 )
return V_267 ;
if ( F_105 ( V_82 ) ) {
V_267 = F_106 ( V_10 , V_10 -> V_32 . V_268 ,
...
if ( F_107 ( V_82 ) && F_108 ( V_82 ) &&
F_87 ( V_10 ) != V_208 -> V_214 ) {
V_267 = F_109 ( V_83 , V_10 , V_264 , NULL , V_265 ,
F_22 ( V_272 ) ? V_273 : 0 ) ;
if ( V_267 )
goto V_274;
}
...
if ( V_267 )
goto V_274;
V_267 = F_91 ( V_83 , V_10 , V_208 ) ;
if ( V_267 )
goto V_274;
if ( ( V_10 -> V_32 . V_229 & ( V_275 | V_276 ) ) &&
! F_110 ( F_90 ( V_10 ) , V_277 ) )
V_10 -> V_32 . V_229 &= ~ ( V_275 | V_276 ) ;
if ( F_87 ( V_10 ) != V_208 -> V_214 ) {
if ( F_107 ( V_82 ) && F_108 ( V_82 ) ) {
V_266 = F_111 ( V_83 , V_10 ,
& V_10 -> V_278 , V_265 ) ;
}
ASSERT ( V_10 -> V_32 . V_279 > 1 ) ;
F_112 ( V_10 , V_208 -> V_214 ) ;
}
...
STATIC int
F_117 ( void * * V_282 , struct V_283 * V_284 , int * V_285 )
{
...
STATIC int
F_120 ( void * * V_282 , struct V_283 * V_284 , int * V_285 )
{
...
return - V_36 ;
return F_66 ( V_10 , V_5 , V_57 , V_137 , V_1 , & V_138 ) ;
}
case V_306 : {
struct V_307 V_308 ;
T_26 * V_309 =
...
case V_316 :
case V_181 :
return F_76 ( V_82 , V_1 , V_91 ) ;
case V_317 :
return F_80 ( V_82 , V_91 ) ;
case V_318 :
return F_82 ( V_82 , V_91 ) ;
case V_319 :
return F_128 ( V_5 -> V_320 , ( int V_14 * ) V_91 ) ;
case V_321 :
return F_85 ( V_10 , 0 , V_91 ) ;
case V_322 :
return F_85 ( V_10 , 1 , V_91 ) ;
case V_323 :
return F_114 ( V_10 , V_57 , V_91 ) ;
case V_324 :
return F_115 ( V_10 , V_91 ) ;
case V_325 :
return F_116 ( V_10 , V_57 , V_91 ) ;
case V_326 : {
struct V_92 V_327 ;
...
case V_328 :
case V_291 :
return F_118 ( V_10 , V_137 , V_1 , V_91 ) ;
case V_329 :
return F_121 ( V_10 , V_91 ) ;
case V_11 :
case V_330 :
case V_26 : {
T_1 V_2 ;
...
if ( ! F_22 ( V_59 ) )
return - V_60 ;
if ( F_134 ( V_341 , ( T_14 V_14 * ) V_91 ) )
return - V_36 ;
return F_135 ( V_82 , V_341 ) ;
}
case V_348 : {
T_33 V_341 ;
if ( ! F_22 ( V_59 ) )
...
return - V_36 ;
error = F_138 ( & V_353 , & V_355 ) ;
if ( error )
return error ;
return F_139 ( V_82 , & V_355 ) ;
}
default:
return - V_356 ;
}
