...
static int F_68 ( struct V_136 * V_137 , const void * V_138 ,
unsigned int * V_139 , unsigned int * V_140 ,
unsigned int V_141 [] , void * V_142 [] )
{
const struct V_143 * V_144 = V_138 ;
struct V_1 * V_17 = F_69 ( V_137 ) ;
if ( V_137 -> V_145 + * V_139 < 3 )
* V_139 = 3 - V_137 -> V_145 ;
if ( V_144 && V_144 -> V_144 . V_146 . V_75 < V_74 . V_75 )
return - V_147 ;
* V_140 = 1 ;
V_141 [ 0 ] = V_144 ? V_144 -> V_144 . V_146 . V_75 : V_74 . V_75 ;
V_142 [ 0 ] = V_17 -> V_129 ;
return 0 ;
}
static int F_70 ( struct V_148 * V_76 )
{
...
static void F_73 ( struct V_148 * V_76 )
{
struct V_1 * V_17 = F_69 ( V_76 -> V_136 ) ;
struct V_59 * V_149 = (struct V_59 * ) V_76 ;
F_25 ( & V_17 -> V_66 ) ;
F_74 ( & V_149 -> V_69 , & V_17 -> V_67 ) ;
F_27 ( & V_17 -> V_66 ) ;
}
static void F_75 ( struct V_1 * V_17 ,
enum V_150 V_151 )
{
struct V_59 * V_149 , * V_152 ;
F_25 ( & V_17 -> V_66 ) ;
F_76 (buf, node, &sur40->buf_list, list) {
F_34 ( & V_149 -> V_76 . V_77 , V_151 ) ;
F_29 ( & V_149 -> V_69 ) ;
}
F_27 ( & V_17 -> V_66 ) ;
}
static int F_77 ( struct V_136 * V_153 , unsigned int V_56 )
{
struct V_1 * V_17 = F_69 ( V_153 ) ;
V_17 -> V_81 = 0 ;
return 0 ;
}
static void F_78 ( struct V_136 * V_153 )
{
struct V_1 * V_17 = F_69 ( V_153 ) ;
V_17 -> V_81 = - 1 ;
F_75 ( V_17 , V_86 ) ;
}
static int F_79 ( struct V_154 * V_154 , void * V_155 ,
struct V_156 * V_157 )
{
struct V_1 * V_17 = F_80 ( V_154 ) ;
F_81 ( V_157 -> V_158 , V_159 , sizeof( V_157 -> V_158 ) ) ;
F_81 ( V_157 -> V_160 , V_120 , sizeof( V_157 -> V_160 ) ) ;
F_47 ( V_17 -> V_7 , V_157 -> V_161 , sizeof( V_157 -> V_161 ) ) ;
V_157 -> V_162 = V_163 |
V_164 |
V_165 ;
V_157 -> V_166 = V_157 -> V_162 | V_167 ;
return 0 ;
}
static int F_82 ( struct V_154 * V_154 , void * V_155 ,
struct V_168 * V_46 )
{
if ( V_46 -> V_4 != 0 )
return - V_147 ;
...
static int F_83 ( struct V_154 * V_154 , void * V_155 , unsigned int V_46 )
{
return ( V_46 == 0 ) ? 0 : - V_147 ;
}
static int F_84 ( struct V_154 * V_154 , void * V_155 , unsigned int * V_46 )
{
* V_46 = 0 ;
return 0 ;
}
static int F_85 ( struct V_154 * V_154 , void * V_155 ,
struct V_143 * V_172 )
{
V_172 -> V_144 . V_146 = V_74 ;
return 0 ;
}
static int F_86 ( struct V_154 * V_154 , void * V_155 ,
struct V_173 * V_172 )
{
if ( V_172 -> V_4 != 0 )
return - V_147 ;
F_81 ( V_172 -> V_174 , L_32 , sizeof( V_172 -> V_174 ) ) ;
V_172 -> V_175 = V_176 ;
V_172 -> V_177 = 0 ;
return 0 ;
}
static int F_87 ( struct V_154 * V_154 , void * V_155 ,
struct V_178 * V_172 )
{
if ( ( V_172 -> V_4 != 0 ) || ( V_172 -> V_179 != V_176 ) )
return - V_147 ;
V_172 -> type = V_180 ;
V_172 -> V_181 . V_182 = V_74 . V_182 ;
V_172 -> V_181 . V_183 = V_74 . V_183 ;
return 0 ;
}
static int F_88 ( struct V_154 * V_154 , void * V_155 ,
struct V_184 * V_172 )
{
if ( ( V_172 -> V_4 > 1 ) || ( V_172 -> V_179 != V_176 )
|| ( V_172 -> V_182 != V_74 . V_182 )
|| ( V_172 -> V_183 != V_74 . V_183 ) )
return - V_147 ;
V_172 -> type = V_185 ;
V_172 -> V_181 . V_186 = 60 / ( V_172 -> V_4 + 1 ) ;
V_172 -> V_181 . V_187 = 1 ;
return 0 ;
}
