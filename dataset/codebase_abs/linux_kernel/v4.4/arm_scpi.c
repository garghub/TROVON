...
int F_53 ( T_3 V_101 , T_1 * V_102 )
{
struct V_103 V_81 ;
int V_36 ;
V_36 = F_27 ( V_104 , & V_101 , sizeof( V_101 ) ,
& V_81 , sizeof( V_81 ) ) ;
if ( ! V_36 )
* V_102 = F_12 ( V_81 . V_102 ) ;
return V_36 ;
}
struct V_105 * F_54 ( void )
{
return V_38 ? V_38 -> V_105 : NULL ;
}
static int F_55 ( struct V_106 * V_78 )
{
int V_36 ;
struct V_107 V_108 ;
V_36 = F_27 ( V_109 , NULL , 0 ,
& V_108 , sizeof( V_108 ) ) ;
if ( ! V_36 ) {
V_78 -> V_48 = F_12 ( V_108 . V_48 ) ;
V_78 -> V_110 = F_12 ( V_108 . V_111 ) ;
}
return V_36 ;
}
static T_5 F_56 ( struct V_112 * V_113 ,
struct V_114 * V_115 , char * V_81 )
{
struct V_106 * V_38 = F_57 ( V_113 ) ;
return sprintf ( V_81 , L_1 ,
F_58 ( V_38 -> V_48 ) ,
F_59 ( V_38 -> V_48 ) ) ;
}
static T_5 F_60 ( struct V_112 * V_113 ,
struct V_114 * V_115 , char * V_81 )
{
struct V_106 * V_38 = F_57 ( V_113 ) ;
...
static void
F_64 ( struct V_112 * V_113 , struct V_6 * V_116 , int V_87 )
{
int V_82 ;
for ( V_82 = 0 ; V_82 < V_87 && V_116 -> V_37 ; V_82 ++ , V_116 ++ ) {
F_65 ( V_116 -> V_37 ) ;
F_66 ( V_113 , V_116 -> V_117 ) ;
F_67 ( V_113 , V_116 -> V_19 ) ;
}
}
static int F_68 ( struct V_118 * V_119 )
{
int V_82 ;
struct V_112 * V_113 = & V_119 -> V_113 ;
struct V_106 * V_78 = F_69 ( V_119 ) ;
V_38 = NULL ;
F_70 ( V_113 ) ;
F_71 ( & V_113 -> V_120 , V_121 ) ;
F_64 ( V_113 , V_78 -> V_41 , V_78 -> V_40 ) ;
F_72 ( V_119 , NULL ) ;
for ( V_82 = 0 ; V_82 < V_83 && V_78 -> V_66 [ V_82 ] ; V_82 ++ ) {
F_48 ( V_78 -> V_66 [ V_82 ] -> V_90 ) ;
F_48 ( V_78 -> V_66 [ V_82 ] ) ;
}
F_66 ( V_113 , V_78 -> V_41 ) ;
F_66 ( V_113 , V_78 ) ;
return 0 ;
}
static int F_73 ( struct V_112 * V_113 , struct V_6 * V_7 )
{
int V_82 ;
struct V_10 * V_117 ;
V_117 = F_74 ( V_113 , V_122 * sizeof( * V_117 ) , V_86 ) ;
if ( ! V_117 )
return - V_42 ;
V_7 -> V_117 = V_117 ;
for ( V_82 = 0 ; V_82 < V_122 ; V_82 ++ , V_117 ++ )
F_20 ( & V_117 -> V_15 , & V_7 -> V_35 ) ;
return 0 ;
}
...
struct V_6 * V_6 ;
struct V_112 * V_113 = & V_119 -> V_113 ;
struct V_126 * V_127 = V_113 -> V_128 ;
V_38 = F_74 ( V_113 , sizeof( * V_38 ) , V_86 ) ;
if ( ! V_38 )
return - V_42 ;
V_87 = F_76 ( V_127 , L_3 , L_4 ) ;
if ( V_87 < 0 ) {
F_77 ( V_113 , L_5 , V_127 -> V_129 ) ;
return - V_130 ;
}
V_6 = F_78 ( V_113 , V_87 , sizeof( * V_6 ) , V_86 ) ;
if ( ! V_6 )
return - V_42 ;
for ( V_123 = 0 ; V_123 < V_87 ; V_123 ++ ) {
T_6 V_131 ;
struct V_6 * V_116 = V_6 + V_123 ;
struct V_25 * V_28 = & V_116 -> V_28 ;
struct V_126 * V_132 = F_79 ( V_127 , L_6 , V_123 ) ;
if ( F_80 ( V_132 , 0 , & V_125 ) ) {
F_77 ( V_113 , L_7 ) ;
V_36 = - V_84 ;
goto V_133;
}
V_131 = F_81 ( & V_125 ) ;
V_116 -> V_19 = F_82 ( V_113 , V_125 . V_134 , V_131 ) ;
if ( ! V_116 -> V_19 ) {
F_77 ( V_113 , L_8 ) ;
V_36 = - V_135 ;
goto V_133;
}
V_116 -> V_30 = V_116 -> V_19 + ( V_131 >> 1 ) ;
V_28 -> V_113 = V_113 ;
V_28 -> V_136 = F_15 ;
V_28 -> V_137 = F_17 ;
V_28 -> V_138 = true ;
...
F_84 ( & V_116 -> V_13 ) ;
F_85 ( & V_116 -> V_34 ) ;
V_36 = F_73 ( V_113 , V_116 ) ;
if ( ! V_36 ) {
V_116 -> V_37 = F_86 ( V_28 , V_123 ) ;
if ( ! F_87 ( V_116 -> V_37 ) )
continue;
V_36 = F_88 ( V_116 -> V_37 ) ;
if ( V_36 != - V_141 )
F_77 ( V_113 , L_9 ,
V_123 , V_36 ) ;
}
V_133:
F_64 ( V_113 , V_6 , V_123 ) ;
V_38 = NULL ;
return V_36 ;
}
V_38 -> V_41 = V_6 ;
...
F_63 ( V_38 -> V_110 ) ) ;
V_38 -> V_105 = & V_105 ;
V_36 = F_90 ( & V_113 -> V_120 , V_121 ) ;
if ( V_36 )
F_77 ( V_113 , L_12 ) ;
return F_91 ( V_113 -> V_128 , NULL , NULL , V_113 ) ;
}
