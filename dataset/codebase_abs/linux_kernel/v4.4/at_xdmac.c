...
V_65 -> V_41 . V_160 = F_69 ( V_146 , V_148 ) ;
V_65 -> V_41 . V_161 = F_70 ( V_146 , V_148 ) ;
V_65 -> V_41 . V_42 = V_43
| V_131
| V_132
| V_149 ;
...
V_171 = F_70 ( V_146 , V_148 ) ;
V_170 = F_69 ( V_146 , V_148 ) ;
...
static struct V_16 *
F_72 ( struct V_7 * V_9 , T_6 V_173 , T_6 V_143 ,
...
static struct V_15 * F_73 ( struct V_7 * V_9 ,
struct V_6 * V_19 ,
T_6 V_128 ,
T_7 V_122 ,
int V_175 )
...
struct V_16 *
F_74 ( struct V_7 * V_9 , T_6 V_173 , int V_175 ,
T_7 V_122 , unsigned long V_116 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_15 * V_65 ;
...
if ( F_62 ( ! V_122 ) )
return NULL ;
V_65 = F_73 ( V_9 , V_19 , V_173 , V_122 , V_175 ) ;
...
static struct V_16 *
F_75 ( struct V_7 * V_9 , struct V_113 * V_114 ,
...
enum V_184 V_120 ;
int V_189 ;
T_2 V_190 , V_30 , V_175 ;
T_3 V_93 = 0 ;
unsigned long V_116 ;
V_120 = F_77 ( V_9 , V_66 , V_186 ) ;
if ( V_120 == V_191 )
return V_120 ;
if ( ! V_186 )
return V_120 ;
...
F_16 ( V_2 , V_194 , V_19 -> V_30 ) ;
while ( ! ( F_14 ( V_19 , V_195 ) & V_196 ) )
F_18 () ;
}
V_190 = F_14 ( V_19 , V_39 ) & 0xfffffffc ;
V_73 = & V_65 -> V_73 ;
F_79 (desc, _desc, descs_list, desc_node) {
V_93 = F_12 ( V_65 -> V_41 . V_47 ) ;
V_189 -= ( V_65 -> V_41 . V_42 & 0xffffff ) << V_93 ;
if ( ( V_65 -> V_41 . V_82 & 0xfffffffc ) == V_190 )
break;
}
V_189 += F_14 ( V_19 , V_54 ) << V_93 ;
F_78 ( V_186 , V_189 ) ;
F_41 ( F_4 ( V_9 ) ,
L_46 ,
...
static void F_81 ( struct V_6 * V_19 )
{
struct V_15 * V_65 ;
unsigned long V_116 ;
F_26 ( & V_19 -> V_68 , V_116 ) ;
...
V_65 = F_38 ( & V_19 -> V_70 , struct V_15 , V_69 ) ;
V_17 = & V_65 -> V_18 ;
if ( V_17 -> V_197 && ( V_17 -> V_116 & V_198 ) )
V_17 -> V_197 ( V_17 -> V_199 ) ;
}
static void F_83 ( unsigned long V_200 )
{
struct V_6 * V_19 = (struct V_6 * ) V_200 ;
struct V_15 * V_65 ;
T_2 V_201 ;
...
static T_8 F_89 ( int V_206 , void * V_207 )
{
struct V_1 * V_2 = (struct V_1 * ) V_207 ;
struct V_6 * V_19 ;
T_2 V_208 , V_21 , V_209 ;
T_2 V_210 , V_211 ;
int V_119 , V_120 = V_212 ;
do {
V_208 = F_17 ( V_2 , V_213 ) ;
V_21 = F_17 ( V_2 , V_214 ) ;
V_209 = V_21 & V_208 ;
F_20 ( V_2 -> V_14 . V_11 ,
L_51 ,
V_35 , V_21 , V_208 , V_209 ) ;
if ( ! V_209 )
break;
for ( V_119 = 0 ; V_119 < V_2 -> V_14 . V_215 ; V_119 ++ ) {
if ( ! ( ( 1 << V_119 ) & V_209 ) )
continue;
V_19 = & V_2 -> V_9 [ V_119 ] ;
V_210 = F_14 ( V_19 , V_216 ) ;
V_211 = F_14 ( V_19 , V_195 ) ;
V_19 -> V_21 = V_211 & V_210 ;
F_20 ( V_2 -> V_14 . V_11 ,
L_52 ,
V_35 , V_119 , V_210 , V_211 ) ;
F_20 ( F_4 ( & V_19 -> V_9 ) ,
L_2 ,
V_35 ,
F_14 ( V_19 , V_46 ) ,
...
F_26 ( & V_19 -> V_68 , V_116 ) ;
V_120 = F_56 ( V_9 , V_219 ) ;
F_30 ( & V_19 -> V_68 , V_116 ) ;
return V_120 ;
}
static int F_93 ( struct V_7 * V_9 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_1 * V_2 = F_5 ( V_19 -> V_9 . V_10 ) ;
unsigned long V_116 ;
...
F_18 () ;
F_79 (desc, _desc, &atchan->xfers_list, xfer_node)
F_80 ( V_19 , V_65 ) ;
F_95 ( V_20 , & V_19 -> V_21 ) ;
F_30 ( & V_19 -> V_68 , V_116 ) ;
return 0 ;
...
static void F_100 ( struct V_7 * V_9 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_1 * V_2 = F_5 ( V_9 -> V_10 ) ;
struct V_15 * V_65 , * V_187 ;
F_79 (desc, _desc, &atchan->free_descs_list, desc_node) {
F_41 ( F_4 ( V_9 ) , L_58 , V_35 , V_65 ) ;
F_39 ( & V_65 -> V_80 ) ;
F_101 ( V_2 -> V_72 , V_65 , V_65 -> V_18 . V_37 ) ;
}
return;
}
static int F_102 ( struct V_10 * V_11 )
{
struct V_227 * V_228 = F_103 ( V_11 ) ;
struct V_1 * V_2 = F_104 ( V_228 ) ;
struct V_7 * V_9 , * V_229 ;
F_79 (chan, _chan, &atxdmac->dma.channels, device_node) {
struct V_6 * V_19 = F_2 ( V_9 ) ;
...
F_79 (chan, _chan, &atxdmac->dma.channels, device_node) {
struct V_6 * V_19 = F_2 ( V_9 ) ;
V_19 -> V_231 = F_14 ( V_19 , V_46 ) ;
if ( F_7 ( V_19 ) ) {
if ( ! F_9 ( V_19 ) )
F_93 ( V_9 ) ;
V_19 -> V_232 = F_14 ( V_19 , V_216 ) ;
V_19 -> V_233 = F_14 ( V_19 , V_39 ) ;
V_19 -> V_234 = F_14 ( V_19 , V_51 ) ;
}
}
V_2 -> V_235 = F_17 ( V_2 , V_213 ) ;
F_15 ( V_2 ) ;
F_106 ( V_2 -> V_236 ) ;
return 0 ;
}
...
for ( V_119 = 0 ; V_119 < V_2 -> V_14 . V_215 ; V_119 ++ ) {
V_19 = & V_2 -> V_9 [ V_119 ] ;
while ( F_14 ( V_19 , V_195 ) )
F_18 () ;
}
F_16 ( V_2 , V_62 , V_2 -> V_235 ) ;
F_16 ( V_2 , V_63 , V_2 -> V_237 ) ;
F_79 (chan, _chan, &atxdmac->dma.channels, device_node) {
V_19 = F_2 ( V_9 ) ;
F_23 ( V_19 , V_46 , V_19 -> V_231 ) ;
if ( F_7 ( V_19 ) ) {
F_23 ( V_19 , V_39 , V_19 -> V_233 ) ;
F_23 ( V_19 , V_51 , V_19 -> V_234 ) ;
F_23 ( V_19 , V_59 , V_19 -> V_232 ) ;
F_24 () ;
F_16 ( V_2 , V_63 , V_19 -> V_30 ) ;
}
}
...
struct V_238 * V_239 ;
struct V_1 * V_2 ;
int V_206 , V_152 , V_240 , V_119 , V_120 ;
void T_1 * V_241 ;
T_2 V_34 ;
V_239 = F_110 ( V_228 , V_242 , 0 ) ;
if ( ! V_239 )
return - V_25 ;
V_206 = F_111 ( V_228 , 0 ) ;
if ( V_206 < 0 )
return V_206 ;
V_241 = F_112 ( & V_228 -> V_11 , V_239 ) ;
if ( F_113 ( V_241 ) )
return F_114 ( V_241 ) ;
V_34 = F_115 ( V_241 + V_243 ) ;
V_240 = F_116 ( V_34 ) ;
if ( V_240 > V_244 ) {
F_44 ( & V_228 -> V_11 , L_59 ,
V_240 ) ;
return - V_25 ;
}
V_152 = sizeof( * V_2 ) ;
V_152 += V_240 * sizeof( struct V_6 ) ;
V_2 = F_117 ( & V_228 -> V_11 , V_152 , V_245 ) ;
if ( ! V_2 ) {
F_44 ( & V_228 -> V_11 , L_60 ) ;
return - V_246 ;
}
V_2 -> V_4 = V_241 ;
V_2 -> V_206 = V_206 ;
V_2 -> V_236 = F_118 ( & V_228 -> V_11 , L_61 ) ;
if ( F_113 ( V_2 -> V_236 ) ) {
F_44 ( & V_228 -> V_11 , L_62 ) ;
return F_114 ( V_2 -> V_236 ) ;
}
V_120 = F_119 ( V_2 -> V_206 , F_89 , 0 , L_63 , V_2 ) ;
if ( V_120 ) {
F_44 ( & V_228 -> V_11 , L_64 ) ;
return V_120 ;
}
V_120 = F_108 ( V_2 -> V_236 ) ;
if ( V_120 ) {
F_44 ( & V_228 -> V_11 , L_65 ) ;
goto V_247;
}
V_2 -> V_72 =
F_120 ( F_121 ( & V_228 -> V_11 ) , & V_228 -> V_11 ,
sizeof( struct V_15 ) , 4 , 0 ) ;
if ( ! V_2 -> V_72 ) {
F_44 ( & V_228 -> V_11 , L_66 ) ;
V_120 = - V_246 ;
goto V_248;
}
F_122 ( V_249 , V_2 -> V_14 . V_250 ) ;
F_122 ( V_251 , V_2 -> V_14 . V_250 ) ;
F_122 ( V_252 , V_2 -> V_14 . V_250 ) ;
F_122 ( V_253 , V_2 -> V_14 . V_250 ) ;
F_122 ( V_254 , V_2 -> V_14 . V_250 ) ;
F_122 ( V_255 , V_2 -> V_14 . V_250 ) ;
F_122 ( V_256 , V_2 -> V_14 . V_250 ) ;
V_2 -> V_14 . V_11 = & V_228 -> V_11 ;
V_2 -> V_14 . V_257 = F_97 ;
V_2 -> V_14 . V_258 = F_100 ;
V_2 -> V_14 . V_259 = F_76 ;
V_2 -> V_14 . V_260 = F_91 ;
V_2 -> V_14 . V_261 = F_65 ;
V_2 -> V_14 . V_262 = F_71 ;
...
V_2 -> V_14 . V_269 = F_94 ;
V_2 -> V_14 . V_270 = F_96 ;
V_2 -> V_14 . V_271 = V_272 ;
V_2 -> V_14 . V_273 = V_272 ;
V_2 -> V_14 . V_274 = F_123 ( V_94 ) | F_123 ( V_104 ) ;
V_2 -> V_14 . V_275 = V_276 ;
F_15 ( V_2 ) ;
F_33 ( & V_2 -> V_14 . V_277 ) ;
for ( V_119 = 0 ; V_119 < V_240 ; V_119 ++ ) {
struct V_6 * V_19 = & V_2 -> V_9 [ V_119 ] ;
V_19 -> V_9 . V_10 = & V_2 -> V_14 ;
F_28 ( & V_19 -> V_9 . V_278 ,
& V_2 -> V_14 . V_277 ) ;
V_19 -> V_279 = F_1 ( V_2 , V_119 ) ;
V_19 -> V_30 = 1 << V_119 ;
F_124 ( & V_19 -> V_68 ) ;
F_33 ( & V_19 -> V_70 ) ;
F_33 ( & V_19 -> V_78 ) ;
F_125 ( & V_19 -> V_217 , F_83 ,
( unsigned long ) V_19 ) ;
while ( F_14 ( V_19 , V_195 ) )
F_18 () ;
}
F_126 ( V_228 , V_2 ) ;
V_120 = F_127 ( & V_2 -> V_14 ) ;
if ( V_120 ) {
F_44 ( & V_228 -> V_11 , L_67 ) ;
goto V_248;
}
V_120 = F_128 ( V_228 -> V_11 . V_280 ,
F_43 , V_2 ) ;
if ( V_120 ) {
F_44 ( & V_228 -> V_11 , L_68 ) ;
goto V_281;
}
F_129 ( & V_228 -> V_11 , L_69 ,
V_240 , V_2 -> V_4 ) ;
return 0 ;
V_281:
F_130 ( & V_2 -> V_14 ) ;
...
F_106 ( V_2 -> V_236 ) ;
V_247:
F_131 ( V_2 -> V_206 , V_2 -> V_14 . V_11 ) ;
return V_120 ;
}
static int F_132 ( struct V_227 * V_228 )
{
struct V_1 * V_2 = (struct V_1 * ) F_104 ( V_228 ) ;
int V_119 ;
F_15 ( V_2 ) ;
F_133 ( V_228 -> V_11 . V_280 ) ;
F_130 ( & V_2 -> V_14 ) ;
F_106 ( V_2 -> V_236 ) ;
F_134 ( V_2 -> V_206 ) ;
F_131 ( V_2 -> V_206 , V_2 -> V_14 . V_11 ) ;
