...
F_19 ( V_2 -> V_25 , L_18 , * V_98 ) ;
if ( V_96 -> V_102 + * V_98 < 8 )
* V_98 = 8 - V_96 -> V_102 ;
* V_99 = 1 ;
V_100 [ 0 ] = F_54 ( V_2 -> V_103 ) ;
F_19 ( V_2 -> V_25 , L_19 , * V_98 , V_100 [ 0 ] ) ;
return 0 ;
}
static void F_55 ( struct V_104 * V_63 )
{
struct V_105 * V_106 = F_56 ( V_63 ) ;
struct V_1 * V_2 = F_53 ( V_63 -> V_95 ) ;
struct V_29 * V_28 =
F_46 ( V_106 , struct V_29 , V_63 ) ;
unsigned long V_30 ;
if ( F_14 ( ! V_2 -> V_13 ) ) {
F_28 ( & V_28 -> V_63 . V_64 , V_86 ) ;
return;
...
static int F_58 ( struct V_95 * V_96 , unsigned int V_107 )
{
struct V_1 * V_2 = F_53 ( V_96 ) ;
int V_8 ;
F_19 ( V_2 -> V_25 , L_17 ) ;
...
static int F_63 ( struct V_117 * V_117 , void * V_118 ,
struct V_119 * V_120 )
{
struct V_1 * V_2 = F_64 ( V_117 ) ;
F_65 ( V_120 -> V_121 , V_122 , sizeof( V_120 -> V_121 ) ) ;
F_65 ( V_120 -> V_123 , V_2 -> V_94 . V_124 , sizeof( V_120 -> V_123 ) ) ;
F_66 ( V_2 -> V_13 , V_120 -> V_125 , sizeof( V_120 -> V_125 ) ) ;
V_120 -> V_126 = V_127 | V_128 |
V_129 | V_130 ;
V_120 -> V_131 = V_120 -> V_126 | V_132 ;
return 0 ;
}
static int F_67 ( struct V_117 * V_117 , void * V_133 ,
struct V_134 * V_135 )
{
if ( V_135 -> V_5 >= V_136 )
return - V_26 ;
F_65 ( V_135 -> V_137 , V_138 [ V_135 -> V_5 ] . V_124 , sizeof( V_135 -> V_137 ) ) ;
...
static int F_71 ( struct V_117 * V_117 , void * V_133 ,
struct V_139 * V_135 )
{
int V_70 ;
memset ( V_135 -> V_140 . V_141 . V_142 , 0 , sizeof( V_135 -> V_140 . V_141 . V_142 ) ) ;
...
static int F_73 ( struct V_117 * V_117 , void * V_133 , struct V_146 * V_90 )
{
int V_8 ;
if ( V_90 -> V_5 == 0 ) {
F_65 ( V_90 -> V_124 , L_20 , sizeof( V_90 -> V_124 ) ) ;
V_90 -> type = V_147 ;
...
F_65 ( V_90 -> V_124 , L_21 , sizeof( V_90 -> V_124 ) ) ;
V_90 -> type = V_154 ;
V_90 -> V_148 = V_149 | V_150 ;
...
static int F_74 ( struct V_117 * V_117 , void * V_133 ,
struct V_156 * V_135 )
{
struct V_1 * V_2 = F_64 ( V_117 ) ;
int V_8 ;
...
V_2 -> V_160 = F_76 (unsigned int, f->frequency,
bands_rf[0].rangelow,
...
static int F_77 ( struct V_117 * V_117 , void * V_133 ,
struct V_161 * V_162 )
{
int V_8 ;
if ( V_162 -> V_157 == 0 ) {
if ( V_162 -> V_5 >= F_78 ( V_152 ) ) {
V_8 = - V_26 ;
} else {
...
static int F_86 ( struct V_172 * V_173 )
{
struct V_1 * V_2 = F_46 ( V_173 -> V_174 , struct V_1 , V_163 ) ;
int V_8 ;
switch ( V_173 -> V_175 ) {
case V_176 :
case V_177 :
...
V_2 = F_88 ( sizeof( struct V_1 ) , V_183 ) ;
if ( V_2 == NULL ) {
F_4 ( & V_88 -> V_25 , L_29 ) ;
return - V_81 ;
}
...
F_97 ( & V_2 -> V_163 , 5 ) ;
V_2 -> V_165 = F_98 ( & V_2 -> V_163 , & V_202 ,
V_176 , 0 , 1 , 1 , 0 ) ;
V_2 -> V_168 = F_98 ( & V_2 -> V_163 , & V_202 ,
V_177 , 0 , 14 , 1 , 8 ) ;
F_99 ( 2 , & V_2 -> V_165 , 0 , false ) ;
V_2 -> V_169 = F_98 ( & V_2 -> V_163 , & V_202 ,
V_178 , 0 , 1 , 1 , 0 ) ;
V_2 -> V_170 = F_98 ( & V_2 -> V_163 , & V_202 ,
V_179 , 0 , 15 , 1 , 8 ) ;
F_99 ( 2 , & V_2 -> V_169 , 0 , false ) ;
V_2 -> V_171 = F_98 ( & V_2 -> V_163 , & V_202 ,
V_180 , 0 , 15 , 1 , 0 ) ;
if ( V_2 -> V_163 . error ) {
V_8 = V_2 -> V_163 . error ;
F_4 ( V_2 -> V_25 , L_35 ) ;
