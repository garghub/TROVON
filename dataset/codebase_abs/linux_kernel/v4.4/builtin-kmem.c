...
static int F_111 ( const char * V_206 , const char * V_207 , void * V_208 )
{
...
return F_112 ( V_206 , V_207 , V_208 ) ;
}
int F_113 ( int V_198 , const char * * V_199 , const char * T_10 V_139 )
{
const char * const V_210 = L_110 ;
const char * const V_211 = L_111 ;
struct V_212 V_213 = {
. V_214 = V_215 ,
} ;
const struct V_194 V_216 [] = {
F_114 ( 'i' , L_112 , & V_217 , L_113 , L_114 ) ,
F_115 ( 'v' , L_115 , & V_218 ,
L_116 ) ,
F_116 ( 0 , L_117 , NULL , NULL ,
L_118 , F_104 ) ,
F_116 ( 0 , L_119 , NULL , NULL ,
L_120 , F_105 ) ,
F_117 ( 's' , L_121 , NULL , L_122 ,
L_123
L_124 , F_103 ) ,
F_117 ( 'l' , L_125 , NULL , L_126 , L_127 , F_108 ) ,
F_118 ( 0 , L_128 , & V_154 , L_129 ) ,
F_118 ( 'f' , L_130 , & V_213 . V_219 , L_131 ) ,
F_116 ( 0 , L_108 , NULL , NULL , L_132 ,
F_106 ) ,
F_116 ( 0 , L_21 , NULL , NULL , L_133 ,
F_107 ) ,
F_118 ( 0 , L_134 , & V_130 , L_135 ) ,
F_119 ()
} ;
const char * const V_220 [] = { L_100 , L_136 , NULL } ;
const char * V_221 [] = {
NULL ,
NULL
} ;
struct V_147 * V_148 ;
int V_26 = - 1 ;
const char V_222 [] = L_137 ;
F_120 ( F_111 , NULL ) ;
V_198 = F_121 ( V_198 , V_199 , V_216 ,
V_220 , V_221 , 0 ) ;
if ( ! V_198 )
F_122 ( V_221 , V_216 ) ;
if ( V_174 == 0 && V_175 == 0 ) {
...
V_213 . V_223 = V_217 ;
V_52 = V_148 = F_124 ( & V_213 , false , & V_224 ) ;
if ( V_148 == NULL )
return - 1 ;
if ( V_174 ) {
if ( ! F_125 ( V_148 -> V_225 ,
L_84 ) ) {
F_3 ( V_222 , L_108 , L_108 ) ;
goto V_226;
}
}
if ( V_175 ) {
struct V_19 * V_20 ;
V_20 = F_125 ( V_148 -> V_225 ,
L_90 ) ;
if ( V_20 == NULL ) {
F_3 ( V_222 , L_21 , L_21 ) ;
goto V_226;
}
V_122 = F_126 ( V_20 -> V_118 -> V_227 ) ;
V_228 . V_229 = true ;
}
F_123 ( & V_148 -> V_142 . V_230 ) ;
if ( ! strcmp ( V_199 [ 0 ] , L_136 ) ) {
setlocale ( V_231 , L_32 ) ;
if ( F_127 () )
goto V_226;
if ( F_128 ( & V_180 ) )
F_100 ( & V_180 , V_210 ) ;
