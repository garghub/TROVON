...
T_1 V_46 = F_6 ( V_1 + V_6 ) ;
* F_19 ( V_13 -> V_29 , 1 ) = V_46 ;
F_6 ( V_1 + V_7 ) ;
V_13 -> V_32 -- ;
if ( V_13 -> V_32 == 0 ) {
int V_47 ;
...
static T_2 F_22 ( int V_56 , void * V_57 )
{
...
if ( V_24 & 0x0020 ) {
int V_63 = F_7 ( V_1 , 0x7002 ) & 0x10 ;
F_24 ( L_6 , V_13 -> V_23 -> V_64 ,
V_63 ? L_7 : L_8 ) ;
}
if ( V_24 & 0x0001 )
F_16 ( V_13 ) ;
...
static int F_26 ( struct V_66 * V_23 )
{
struct V_12 * V_13 = F_27 ( V_23 ) ;
F_28 ( & ( V_13 -> V_21 ) ) ;
return 0 ;
}
static int F_29 ( struct V_66 * V_23 )
{
return 0 ;
}
static int F_30 ( struct V_66 * V_23 )
{
F_26 ( V_23 ) ;
return 0 ;
}
static int F_31 ( struct V_66 * V_23 , struct V_19 * V_20 )
{
struct V_12 * V_13 = F_27 ( V_23 ) ;
unsigned long V_67 ;
...
memcpy ( F_32 ( V_20 , 1 ) , & F_18 ( V_20 ) -> V_35 , 1 ) ;
F_33 ( & ( V_13 -> V_21 ) , V_20 ) ;
F_34 ( & ( V_13 -> V_61 ) , V_67 ) ;
F_9 ( V_13 ) ;
F_35 ( & ( V_13 -> V_61 ) , V_67 ) ;
...
char * V_74 = ( char * ) V_72 ;
char V_75 [ 9 ] ;
unsigned int V_1 , V_76 ;
unsigned long V_26 , V_2 , V_77 ;
int V_78 , V_79 = 0 ;
V_1 = V_13 -> V_16 -> V_17 [ 0 ] -> V_18 ;
...
if ( F_38 ( V_75 , 16 , & V_26 ) < 0 )
return - V_81 ;
memset ( V_75 , 0 , sizeof( V_75 ) ) ;
memcpy ( V_75 , V_74 + 4 , 8 ) ;
if ( F_38 ( V_75 , 16 , & V_2 ) < 0 )
return - V_81 ;
memset ( V_75 , 0 , sizeof( V_75 ) ) ;
memcpy ( V_75 , V_74 + ( V_26 * 2 ) + 2 , 2 ) ;
if ( F_38 ( V_75 , 16 , & V_77 ) < 0 )
return - V_81 ;
memset ( V_75 , 0 , sizeof( V_75 ) ) ;
for ( V_76 = 0 , V_78 = 0 ; V_78 < V_26 ; V_78 ++ ) {
memcpy ( V_75 , V_74 + ( V_78 * 2 ) + 2 , 2 ) ;
V_76 += F_39 ( V_75 , NULL , 16 ) ;
}
if ( ( ( V_76 + V_77 ) & 0xff ) != 0xff ) {
F_10 ( L_10 ) ;
V_79 = - V_82 ;
goto error;
}
...
F_37 ( 17 ) ;
F_1 ( V_1 , 0x3000 ) ;
F_2 ( F_6 ( V_1 + V_62 ) | 0x40 , V_1 + V_62 ) ;
error:
F_37 ( 17 ) ;
F_4 ( V_1 , 0x7006 , 0x0000 ) ;
...
V_23 -> V_84 = V_85 ;
F_45 ( V_23 , V_13 ) ;
F_46 ( V_23 , & V_13 -> V_16 -> V_86 ) ;
V_23 -> V_87 = F_29 ;
V_23 -> V_88 = F_30 ;
V_23 -> V_89 = F_26 ;
V_23 -> V_90 = F_31 ;
V_79 = F_47 ( & V_72 , L_12 , & V_13 -> V_16 -> V_86 ) ;
if ( V_79 < 0 ) {
F_10 ( L_13 ) ;
goto error;
}
V_79 = F_36 ( V_13 , V_72 -> V_22 , V_72 -> V_26 ) ;
F_48 ( V_72 ) ;
if ( V_79 < 0 ) {
F_10 ( L_14 ) ;
goto error;
...
{
struct V_12 * V_13 ;
V_13 = F_55 ( & V_93 -> V_86 , sizeof( * V_13 ) , V_94 ) ;
if ( ! V_13 )
return - V_83 ;
V_13 -> V_16 = V_93 ;
V_93 -> V_95 = V_13 ;
...
static int F_59 ( struct V_92 * V_16 , void * V_100 )
{
int * V_101 = V_100 ;
if ( ! V_101 )
V_16 -> V_102 = 16 ;
...
return - V_81 ;
V_16 -> V_17 [ 0 ] -> V_103 = 8 ;
V_16 -> V_17 [ 0 ] -> V_67 &= ~ V_104 ;
V_16 -> V_17 [ 0 ] -> V_67 |= V_105 ;
return F_60 ( V_16 ) ;
}
static int F_61 ( struct V_92 * V_16 ,
void * V_100 )
{
...
V_16 -> V_17 [ 0 ] -> V_18 = V_106 [ V_107 ] ;
V_16 -> V_102 = V_106 [ V_107 ] ? 16 : 3 ;
if ( ! F_60 ( V_16 ) )
return 0 ;
}
return - V_91 ;
...
if ( ! F_62 ( V_93 , F_59 , ( void * ) V_101 ) )
goto V_108;
if ( ! F_62 ( V_93 , F_61 , NULL ) )
goto V_108;
F_10 ( L_16 ) ;
goto V_109;
V_108:
