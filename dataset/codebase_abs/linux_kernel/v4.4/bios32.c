...
F_35 ( & V_61 -> V_73 ) ;
if ( V_87 -> V_93 )
V_61 -> V_93 = V_87 -> V_93 [ V_90 ] ;
V_70 = V_87 -> V_94 ( V_90 , V_61 ) ;
if ( V_70 > 0 ) {
struct V_95 * V_96 ;
V_70 = F_25 ( V_90 , V_61 ) ;
if ( V_70 ) {
...
if ( V_87 -> V_97 )
V_61 -> V_2 = V_87 -> V_97 ( V_90 , V_61 ) ;
else
V_61 -> V_2 = F_37 ( V_85 ,
V_61 -> V_69 , V_87 -> V_98 , V_61 ,
& V_61 -> V_73 , V_87 -> V_99 ) ;
if ( F_34 ( ! V_61 -> V_2 , L_10 ) ) {
F_36 ( V_61 ) ;
break;
}
V_69 = V_61 -> V_2 -> V_100 . V_17 + 1 ;
F_38 ( & V_61 -> V_101 , V_89 ) ;
V_96 = F_39 ( V_61 -> V_2 ) ;
...
void F_40 ( struct V_32 * V_85 , struct V_86 * V_87 )
{
struct V_60 * V_61 ;
F_41 ( V_89 ) ;
F_42 ( V_103 ) ;
...
T_6 F_51 ( void * V_109 , const struct V_16 * V_76 ,
T_6 V_110 , T_6 V_111 )
{
...
V_18 = ( V_18 + V_111 - 1 ) & ~ ( V_111 - 1 ) ;
V_96 = F_39 ( V_6 -> V_2 ) ;
if ( V_96 -> V_102 )
return V_96 -> V_102 ( V_6 , V_76 ,
V_18 , V_110 , V_111 ) ;
return V_18 ;
}
int F_52 ( struct V_5 * V_6 , int V_112 )
{
if ( F_44 ( V_106 ) )
return 0 ;
return F_53 ( V_6 , V_112 ) ;
}
int F_54 ( struct V_5 * V_6 , struct V_113 * V_114 ,
enum V_115 V_116 , int V_117 )
{
if ( V_116 == V_118 )
return - V_119 ;
V_114 -> V_120 = F_55 ( V_114 -> V_120 ) ;
if ( F_56 ( V_114 , V_114 -> V_121 , V_114 -> V_122 ,
V_114 -> V_123 - V_114 -> V_121 ,
V_114 -> V_120 ) )
return - V_124 ;
return 0 ;
}
void T_5 F_57 ( unsigned long V_125 )
{
struct V_126 V_127 = {
. V_128 = V_129 ,
. type = V_130 ,
