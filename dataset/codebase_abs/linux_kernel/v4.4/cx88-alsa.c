...
V_136 . V_112 = 0 != V_112 -> V_112 . integer . V_112 [ 0 ] ;
V_136 . V_137 = V_134 ;
F_72 ( V_5 , V_138 , V_5 , V_139 , & V_136 ) ;
return 0 ;
}
...
if ( V_1 -> V_38 >= 0 )
F_74 ( V_1 -> V_38 , V_1 ) ;
F_75 ( V_1 -> V_5 , V_1 -> V_60 ) ;
F_76 ( V_1 -> V_60 ) ;
return 0 ;
}
static void F_77 ( struct V_140 * V_103 )
{
T_1 * V_1 = V_103 -> V_104 ;
F_73 ( V_1 ) ;
}
static int F_78 ( struct V_140 * V_103 , struct V_141 * V_60 ,
T_1 * * V_142 ,
struct V_4 * * V_143 )
{
T_1 * V_1 ;
...
F_84 ( & V_1 -> V_93 ) ;
V_1 -> V_5 = V_5 ;
V_70 = F_85 ( V_1 -> V_60 -> V_38 , F_16 ,
V_145 , V_1 -> V_5 -> V_33 , V_1 ) ;
if ( V_70 < 0 ) {
F_6 ( 0 , L_17 ,
V_1 -> V_5 -> V_33 , V_1 -> V_60 -> V_38 ) ;
return V_70 ;
}
F_86 ( V_60 , V_146 , & V_144 ) ;
F_6 ( 1 , L_18
L_19 , V_5 -> V_33 , V_147 ,
F_87 ( V_60 ) , V_60 -> V_148 , V_60 -> V_38 ,
V_144 , ( unsigned long long ) F_88 ( V_60 , 0 ) ) ;
V_1 -> V_38 = V_60 -> V_38 ;
F_89 ( V_1 -> V_38 ) ;
* V_142 = V_1 ;
* V_143 = V_5 ;
...
static int F_90 ( struct V_141 * V_60 ,
...
V_70 = F_91 ( & V_60 -> V_58 , V_154 [ V_147 ] , V_137 [ V_147 ] , V_155 ,
sizeof( T_1 ) , & V_103 ) ;
if ( V_70 < 0 )
return V_70 ;
V_103 -> V_156 = F_77 ;
V_70 = F_78 ( V_103 , V_60 , & V_1 , & V_5 ) ;
if ( V_70 < 0 )
goto error;
V_70 = F_55 ( V_1 , 0 , L_20 ) ;
if ( V_70 < 0 )
goto error;
V_70 = F_92 ( V_103 , F_93 ( & V_157 , V_1 ) ) ;
if ( V_70 < 0 )
goto error;
V_70 = F_92 ( V_103 , F_93 ( & V_158 , V_1 ) ) ;
if ( V_70 < 0 )
goto error;
V_70 = F_92 ( V_103 , F_93 ( & V_159 , V_1 ) ) ;
if ( V_70 < 0 )
goto error;
if ( V_5 -> V_128 )
F_92 ( V_103 , F_93 ( & V_160 , V_1 ) ) ;
strcpy ( V_103 -> V_161 , L_21 ) ;
sprintf ( V_103 -> V_162 , L_22 , V_60 -> V_100 ) ;
sprintf ( V_103 -> V_163 , L_23 ,
V_103 -> V_162 , ( unsigned long long ) F_88 ( V_60 , 0 ) ) ;
strcpy ( V_103 -> V_164 , L_24 ) ;
F_6 ( 0 , L_25 ,
V_103 -> V_161 , V_147 ) ;
V_70 = F_94 ( V_103 ) ;
if ( V_70 < 0 )
...
static void F_97 ( struct V_141 * V_60 )
{
struct V_140 * V_103 = F_98 ( V_60 ) ;
F_96 ( V_103 ) ;
V_147 -- ;
}
