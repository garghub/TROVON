...
T_1 F_96 ( const struct V_60 * V_222 )
{
T_1 V_73 ;
if ( ! V_222 -> clock )
return 0 ;
...
V_224 = V_221 -> clock ;
V_225 = F_94 ( V_221 ) ;
if ( ( F_97 ( V_222 -> clock ) == F_97 ( V_224 ) ||
F_97 ( V_222 -> clock ) == F_97 ( V_225 ) ) &&
F_98 ( V_222 , V_221 ) )
return V_73 + 1 ;
}
return 0 ;
}
enum V_226 F_99 ( const T_1 V_227 )
{
return V_223 [ V_227 - 1 ] . V_228 ;
}
static unsigned int
F_100 ( const struct V_60 * V_229 )
{
if ( V_229 -> V_79 == 4096 && V_229 -> V_75 == 2160 )
return V_229 -> clock ;
return F_94 ( V_229 ) ;
}
static T_1 F_101 ( const struct V_60 * V_222 )
{
T_1 V_73 ;
if ( ! V_222 -> clock )
return 0 ;
...
static int
F_102 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
struct V_80 * V_52 = V_41 -> V_52 ;
...
static int
F_107 ( struct V_40 * V_41 , const T_1 * V_238 , T_1 V_23 )
{
int V_2 , V_182 = 0 ;
for ( V_2 = 0 ; V_2 < V_23 ; V_2 ++ ) {
struct V_60 * V_73 ;
V_73 = F_106 ( V_41 , V_238 , V_23 , V_2 ) ;
if ( V_73 ) {
F_73 ( V_41 , V_73 ) ;
V_182 ++ ;
}
...
F_104 ( & V_246 -> V_70 , & V_243 ) ;
V_182 ++ ;
}
}
F_111 ( & V_243 , & V_41 -> V_67 ) ;
return V_182 ;
}
static int F_112 ( struct V_40 * V_41 , T_1 V_247 )
{
struct V_80 * V_52 = V_41 -> V_52 ;
struct V_60 * V_183 ;
V_247 -- ;
...
static int F_113 ( struct V_40 * V_41 , T_5 V_248 ,
const T_1 * V_235 , T_1 V_236 , T_1 V_237 )
{
struct V_60 * V_183 ;
int V_182 = 0 ;
if ( V_248 & ( 1 << 0 ) ) {
V_183 = F_106 ( V_41 , V_235 ,
V_236 ,
V_237 ) ;
if ( V_183 ) {
V_183 -> V_35 |= V_249 ;
...
static int
F_114 ( struct V_40 * V_41 , const T_1 * V_238 , T_1 V_23 ,
const T_1 * V_235 , T_1 V_236 )
{
...
static int
F_116 ( const T_1 * V_238 )
{
return V_238 [ 0 ] >> 5 ;
}
static int
F_117 ( const T_1 * V_262 )
{
return V_262 [ 1 ] ;
}
static int
F_118 ( const T_1 * V_262 , int * V_26 , int * V_263 )
{
* V_26 = 4 ;
* V_263 = V_262 [ 2 ] ;
if ( * V_263 == 0 )
...
static bool F_119 ( const T_1 * V_238 )
{
int V_265 ;
if ( F_116 ( V_238 ) != V_266 )
return false ;
if ( F_115 ( V_238 ) < 5 )
return false ;
...
static int
F_120 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
const T_1 * V_262 = F_92 ( V_12 ) ;
const T_1 * V_238 , * V_268 = NULL , * V_269 = NULL ;
T_1 V_270 , V_271 , V_236 = 0 ;
int V_182 = 0 ;
if ( V_262 && F_117 ( V_262 ) >= 3 ) {
int V_2 , V_26 , V_263 ;
if ( F_118 ( V_262 , & V_26 , & V_263 ) )
return 0 ;
F_121 (cea, i, start, end) {
V_238 = & V_262 [ V_2 ] ;
V_270 = F_115 ( V_238 ) ;
if ( F_116 ( V_238 ) == V_272 ) {
V_269 = V_238 + 1 ;
V_236 = V_270 ;
V_182 += F_107 ( V_41 , V_269 , V_270 ) ;
}
else if ( F_119 ( V_238 ) ) {
V_268 = V_238 ;
V_271 = V_270 ;
...
if ( V_268 )
V_182 += F_114 ( V_41 , V_268 , V_271 , V_269 ,
V_236 ) ;
return V_182 ;
}
...
if ( abs ( V_73 -> clock - V_224 ) < abs ( V_73 -> clock - V_225 ) )
clock = V_224 ;
else
clock = V_225 ;
if ( V_73 -> clock == clock )
return;
F_7 ( L_18 ,
type , V_233 + 1 , V_73 -> clock , clock ) ;
V_73 -> clock = clock ;
}
static void
F_122 ( struct V_40 * V_41 , const T_1 * V_238 )
{
T_1 V_23 = F_115 ( V_238 ) ;
if ( V_23 >= 6 ) {
...
static void
F_123 ( struct V_93 * V_61 , void * V_21 )
{
if ( V_61 -> V_21 . V_189 . type == V_279 )
* ( T_1 * * ) V_21 = V_61 -> V_21 . V_189 . V_21 . V_280 . V_280 ;
}
void F_124 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
...
int F_128 ( struct V_12 * V_12 , struct V_287 * * V_288 )
{
int V_289 = 0 ;
...
F_121 (cea, i, start, end) {
T_1 * V_238 = & V_262 [ V_2 ] ;
if ( F_116 ( V_238 ) == V_284 ) {
int V_42 ;
V_270 = F_115 ( V_238 ) ;
V_289 = V_270 / 3 ;
* V_288 = F_129 ( V_289 , sizeof( * * V_288 ) , V_48 ) ;
if ( ! * V_288 )
return - V_293 ;
...
int F_130 ( struct V_12 * V_12 , T_1 * * V_299 )
{
int V_289 = 0 ;
int V_2 , V_26 , V_263 , V_270 ;
const T_1 * V_262 ;
...
return F_132 ( V_300 - V_108 , 0 ) ;
}
struct V_40 * F_133 ( struct V_301 * V_302 )
{
struct V_40 * V_41 ;
struct V_80 * V_52 = V_302 -> V_52 ;
F_6 ( ! F_134 ( & V_52 -> V_303 . V_304 ) ) ;
F_6 ( ! F_135 ( & V_52 -> V_303 . V_305 ) ) ;
F_136 (connector, dev)
...
if ( ! V_219 )
return false ;
if ( F_118 ( V_219 , & V_306 , & V_307 ) )
return false ;
F_121 (edid_ext, i, start_offset, end_offset) {
if ( F_119 ( & V_219 [ V_2 ] ) )
return true ;
}
return false ;
}
bool F_138 ( struct V_12 * V_12 )
{
T_1 * V_219 ;
int V_2 , V_42 ;
bool V_308 = false ;
...
goto V_263;
F_121 (edid_ext, i, start_offset, end_offset) {
if ( F_116 ( & V_219 [ V_2 ] ) == V_284 ) {
V_308 = true ;
for ( V_42 = 1 ; V_42 < F_115 ( & V_219 [ V_2 ] ) + 1 ; V_42 += 3 )
F_14 ( L_31 ,
...
if ( ! V_219 )
return false ;
if ( F_118 ( V_219 , & V_26 , & V_263 ) )
return false ;
F_121 (edid_ext, i, start, end) {
if ( F_116 ( & V_219 [ V_2 ] ) == V_310 &&
F_115 ( & V_219 [ V_2 ] ) == 2 ) {
...
static bool F_140 ( struct V_12 * V_12 ,
struct V_312 * V_313 ,
struct V_40 * V_41 )
{
T_1 * V_219 , * V_268 ;
...
static void F_141 ( struct V_12 * V_12 ,
struct V_312 * V_313 ,
struct V_40 * V_41 )
{
T_1 * V_219 ;
...
int F_142 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
int V_338 = 0 ;
T_3 V_59 ;
if ( V_12 == NULL ) {
...
V_338 += F_120 ( V_41 , V_12 ) ;
V_338 += F_102 ( V_41 , V_12 ) ;
if ( V_12 -> V_102 & V_103 )
V_338 += F_79 ( V_41 , V_12 ) ;
if ( V_59 & ( V_68 | V_69 ) )
F_30 ( V_41 , V_59 ) ;
F_141 ( V_12 , & V_41 -> V_339 , V_41 ) ;
if ( V_59 & V_340 )
V_41 -> V_339 . V_315 = 8 ;
if ( V_59 & V_341 )
V_41 -> V_339 . V_315 = 12 ;
...
V_345 -> V_376 = F_147 ( V_73 ) ;
return 0 ;
}
static int F_150 ( struct V_40 * V_41 ,
T_1 * V_377 , int V_8 ,
bool V_378 )
{
int V_379 = 0 ;
...
V_397 = F_151 ( V_41 -> V_52 , V_391 -> V_405 ) ;
if ( ! V_397 ) {
V_397 = F_152 ( V_41 -> V_52 , V_391 -> V_405 ) ;
}
if ( ! V_397 )
return - V_293 ;
if ( V_41 -> V_406 != V_397 ) {
if ( V_41 -> V_406 ) {
F_153 ( V_41 -> V_52 , V_41 -> V_406 ) ;
}
V_41 -> V_406 = V_397 ;
} else
F_153 ( V_41 -> V_52 , V_397 ) ;
}
break;
default:
F_9 ( L_49 , V_9 -> V_387 ) ;
...
V_29 = F_150 ( V_41 , V_377 , V_6 , true ) ;
if ( V_29 < 0 )
goto V_407;
if ( ! V_41 -> V_400 )
goto V_407;
