...
F_14 ( V_13 , V_24 -> V_53 + V_28 ) ;
F_14 ( V_13 , 0xc0c0c0c0 ) ;
F_14 ( V_13 ,
F_20 ( V_9 -> V_37 [ 0 ] , V_54 ) ) ;
V_13 -> V_16 [ V_25 ] |=
F_20 ( V_13 -> V_17 , V_55 ) ;
return 0 ;
}
...
struct V_11 * F_29 ( struct V_57 * V_58 ,
enum V_59 type )
{
...
int V_62 = 0 ;
unsigned V_6 ;
V_60 = F_30 ( V_58 -> V_58 , sizeof( * V_60 ) ,
V_14 ) ;
if ( ! V_60 ) {
V_62 = - V_63 ;
goto V_64;
...
for ( V_6 = 0 ; V_6 < F_3 ( V_7 ) ; V_6 ++ )
V_61 [ V_6 ] = V_7 [ V_6 ] . V_8 ;
V_12 = & V_60 -> V_15 ;
V_62 = F_31 ( V_58 , V_12 , 0xff ,
& V_65 ,
V_61 , F_3 ( V_61 ) ,
type ) ;
F_32 ( V_12 , & V_66 ) ;
