...
static int F_43 ( struct V_58 * V_17 ,
...
if ( V_69 ) {
F_47 ( V_33 , V_36 , 0 , V_69 -> V_79 , 0 , 0 ) ;
F_47 ( V_33 , V_37 , 0 , V_69 -> V_80 , 0 , 0 ) ;
} else {
F_48 ( V_33 , V_35 , V_36 ) ;
F_48 ( V_33 , V_35 , V_37 ) ;
F_49 ( V_33 , true ) ;
