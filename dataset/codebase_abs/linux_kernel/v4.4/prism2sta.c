...
void F_73 ( T_1 * V_1 , struct V_2 * V_3 )
{
F_74 ( V_1 , V_3 ) ;
}
void F_75 ( T_1 * V_1 )
...
static T_1 * F_77 ( void )
{
T_1 * V_1 = NULL ;
T_2 * V_7 = NULL ;
V_1 = F_78 ( sizeof( T_1 ) , V_246 ) ;
V_7 = F_78 ( sizeof( T_2 ) , V_246 ) ;
if ( ! V_1 || ! V_7 ) {
F_79 ( L_77 , V_247 ) ;
F_45 ( V_1 ) ;
F_45 ( V_7 ) ;
...
F_55 ( (struct V_187 * ) & V_177 ,
( V_188 * ) & V_1 -> V_177 ) ;
F_81 ( & V_7 -> V_272 , V_273 + V_274 ) ;
}
void F_82 ( unsigned long V_33 )
{
T_2 * V_7 = ( T_2 * ) V_33 ;
F_61 ( & V_7 -> V_193 ) ;
}
