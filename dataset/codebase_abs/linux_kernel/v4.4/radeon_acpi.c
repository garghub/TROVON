...
if ( V_130 -> V_77 . V_123 && V_130 -> V_77 . V_125 )
return true ;
return false ;
}
...
if ( ! V_130 -> V_77 . V_123 )
return - V_72 ;
V_137 . V_67 = sizeof( struct V_136 ) ;
V_137 . V_141 = V_94 -> V_101 -> V_142 | ( V_94 -> V_101 -> V_143 -> V_144 << 8 ) ;
V_137 . V_145 = V_146 ;
V_137 . V_82 = V_147 ;
if ( V_135 )
V_137 . V_82 |= V_148 ;
V_137 . V_149 = V_150 ;
V_137 . V_134 = V_134 ;
V_5 . V_17 = sizeof( struct V_136 ) ;
V_5 . V_13 = & V_137 ;
while ( V_140 -- ) {
V_64 = F_20 ( V_2 , V_151 , & V_5 ) ;
if ( ! V_64 )
return - V_70 ;
...
V_67 = F_11 ( sizeof( V_139 ) , V_67 ) ;
memcpy ( & V_139 , V_64 -> V_10 . V_13 , V_67 ) ;
F_6 ( V_64 ) ;
switch ( V_139 . V_152 ) {
case V_153 :
default:
...
static int F_27 ( struct V_156 * V_157 ,
unsigned long V_158 ,
void * V_159 )
{
struct V_93 * V_94 = F_28 ( V_157 , struct V_93 , V_160 ) ;
struct V_95 * V_161 = (struct V_95 * ) V_159 ;
if ( strcmp ( V_161 -> V_97 , V_162 ) == 0 ) {
if ( F_29 () > 0 )
F_4 ( L_17 ) ;
else
F_4 ( L_18 ) ;
...
int V_163 ;
V_2 = F_16 ( & V_94 -> V_101 -> V_102 ) ;
if ( ! F_32 ( V_94 ) || ! V_94 -> V_164 || ! V_2 )
return 0 ;
V_163 = F_22 ( V_2 , V_130 ) ;
if ( V_163 ) {
F_4 ( L_19 , V_163 ) ;
}
V_163 = F_9 ( V_2 , V_63 ) ;
...
if ( V_63 -> V_75 . V_36 ) {
struct V_165 * V_166 ;
struct V_104 * V_167 = NULL ;
F_33 (tmp, &rdev->ddev->mode_config.encoder_list,
head) {
struct V_104 * V_105 = F_34 ( V_166 ) ;
if ( ( V_105 -> V_168 & ( V_169 ) ) &&
V_105 -> V_113 ) {
if ( V_94 -> V_110 ) {
struct V_111 * V_112 = V_105 -> V_113 ;
if ( V_112 -> V_114 ) {
...
V_73:
V_94 -> V_160 . V_170 = F_27 ;
F_36 ( & V_94 -> V_160 ) ;
return V_163 ;
}
void F_37 ( struct V_93 * V_94 )
{
F_38 ( & V_94 -> V_160 ) ;
}
