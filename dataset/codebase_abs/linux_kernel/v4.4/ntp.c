...
int __weak F_27 ( struct V_98 V_99 )
{
struct V_95 V_96 ;
V_96 = F_28 ( V_99 ) ;
return F_26 ( V_96 ) ;
...
F_30 ( & V_96 ) ;
if ( abs ( V_96 . V_13 - ( V_104 / 2 ) ) <= V_51 * 5 ) {
struct V_98 V_105 = V_96 ;
V_103 = - V_97 ;
if ( V_106 )
V_105 . V_12 -= ( V_107 . V_108 * 60 ) ;
#ifdef F_31
V_103 = F_27 ( V_105 ) ;
#endif
#ifdef F_32
...
V_102 . V_13 = ( V_104 / 2 ) - V_96 . V_13 - ( V_109 / 2 ) ;
if ( V_102 . V_13 <= 0 )
V_102 . V_13 += V_104 ;
if ( ! V_103 || V_103 == - V_97 )
V_102 . V_12 = 659 ;
...
void F_36 ( void ) { }
static inline void F_37 ( struct V_24 * V_25 , struct V_98 * V_112 )
{
...
int F_41 ( struct V_24 * V_25 , struct V_98 * V_112 , T_4 * V_114 )
{
int V_142 ;
if ( V_25 -> V_115 & V_132 ) {
long V_143 = V_70 ;
...
static inline struct V_150 F_42 ( struct V_98 V_112 )
{
struct V_150 V_151 = {
. V_152 = V_112 . V_12 ,
. V_153 = V_112 . V_13
} ;
if ( V_151 . V_153 > ( V_104 >> 1 ) ) {
V_151 . V_153 -= V_104 ;
V_151 . V_152 ++ ;
}
return V_151 ;
...
void F_50 ( const struct V_98 * V_166 , const struct V_98 * V_167 )
{
