...
V_72 -> V_25 = V_25 ;
#ifdef F_56
V_6 -> V_104 = F_57 ( & V_24 -> V_25 , V_72 -> V_28 ,
sizeof( * V_6 -> V_104 ) , V_88 ) ;
#endif
V_86 = F_58 ( V_72 ) ;
if ( V_86 ) {
F_44 ( & V_24 -> V_25 , L_30 ) ;
...
V_80 = F_50 ( V_24 , V_105 , 0 ) ;
if ( V_80 && V_80 -> V_106 ) {
F_42 ( V_6 ) ;
V_86 = F_59 ( V_72 , & V_107 , 0 ,
V_108 , V_109 ) ;
if ( V_86 ) {
F_44 ( V_25 , L_31 ) ;
F_60 ( V_72 ) ;
...
V_14 = F_5 ( V_4 ) & V_110 ;
V_6 -> V_104 [ V_47 ] . V_48 = V_14 ;
V_4 = F_1 ( & V_6 -> V_2 , V_47 , V_35 ) ;
V_14 = F_5 ( V_4 ) & V_111 ;
V_6 -> V_104 [ V_47 ] . V_36 = V_14 ;
}
return 0 ;
}
