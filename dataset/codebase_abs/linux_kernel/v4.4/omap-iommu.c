...
if ( ! V_128 -> V_158 )
goto V_161;
F_115 ( ! F_13 ( ( long ) V_128 -> V_158 , V_160 ) ) ;
F_105 ( V_128 -> V_158 , V_160 ) ;
F_91 ( & V_128 -> V_157 ) ;
V_128 -> V_4 . V_162 . V_163 = 0 ;
V_128 -> V_4 . V_162 . V_164 = ( 1ULL << 32 ) - 1 ;
V_128 -> V_4 . V_162 . V_165 = true ;
return & V_128 -> V_4 ;
V_161:
F_44 ( V_128 ) ;
V_90:
...
static T_4 F_117 ( struct V_2 * V_4 ,
T_5 V_62 )
{
struct V_1 * V_128 = F_1 ( V_4 ) ;
struct V_7 * V_150 = V_128 -> V_129 ;
...
T_1 * V_166 , * V_167 ;
T_4 V_140 = 0 ;
F_68 ( V_150 , V_62 , & V_166 , & V_167 ) ;
if ( V_167 ) {
if ( F_118 ( * V_167 ) )
V_140 = F_119 ( * V_167 , V_62 , V_168 ) ;
else if ( F_120 ( * V_167 ) )
V_140 = F_119 ( * V_167 , V_62 , V_112 ) ;
else
F_20 ( V_6 , L_35 , * V_167 ,
( unsigned long long ) V_62 ) ;
} else {
if ( F_121 ( * V_166 ) )
V_140 = F_119 ( * V_166 , V_62 , V_104 ) ;
else if ( F_122 ( * V_166 ) )
V_140 = F_119 ( * V_166 , V_62 , V_107 ) ;
else
F_20 ( V_6 , L_36 , * V_166 ,
( unsigned long long ) V_62 ) ;
}
...
V_154 -> V_35 = F_128 ( F_88 ( & V_42 -> V_6 ) , V_83 ) ;
...
{
struct V_169 * V_9 ;
const unsigned long V_170 = V_171 ;
T_2 V_172 = 1 << 10 ;
struct V_137 * V_138 ;
V_138 = F_131 ( NULL , V_173 ) ;
if ( ! V_138 )
return 0 ;
F_127 ( V_138 ) ;
V_9 = F_132 ( L_38 , V_147 , V_172 , V_170 ,
F_104 ) ;
if ( ! V_9 )
return - V_84 ;
V_99 = V_9 ;
