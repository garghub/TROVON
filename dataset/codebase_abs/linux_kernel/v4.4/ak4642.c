...
static struct V_86 * F_26 ( struct V_87 * V_85 )
{
...
T_2 V_78 ;
if ( F_27 ( V_89 , L_1 , & V_78 ) )
return NULL ;
if ( F_28 ( V_89 , L_2 ) )
V_93 = F_29 ( V_89 , 0 ) ;
F_30 ( V_89 , L_3 , & V_91 ) ;
V_86 = F_31 ( V_85 , V_91 , V_93 ,
( V_93 ) ? 0 : V_94 ,
V_78 ) ;
if ( ! F_32 ( V_86 ) )
F_33 ( V_89 , V_95 , V_86 ) ;
...
{
struct V_87 * V_85 = & V_97 -> V_85 ;
struct V_88 * V_89 = V_85 -> V_90 ;
const struct V_100 * V_48 = NULL ;
struct V_84 * V_84 ;
struct V_39 * V_40 ;
...
if ( F_32 ( V_79 ) )
V_79 = NULL ;
V_102 = F_35 ( V_103 , V_85 ) ;
if ( V_102 )
V_48 = V_102 -> V_53 ;
} else {
V_48 = ( const struct V_100 * ) V_99 -> V_104 ;
}
if ( ! V_48 ) {
F_36 ( V_85 , L_4 ) ;
return - V_47 ;
}
V_40 = F_37 ( V_85 , sizeof( * V_40 ) , V_105 ) ;
if ( ! V_40 )
return - V_106 ;
V_40 -> V_48 = V_48 ;
V_40 -> V_79 = V_79 ;
F_38 ( V_97 , V_40 ) ;
V_84 = F_39 ( V_97 , V_48 -> V_107 ) ;
if ( F_32 ( V_84 ) )
return F_40 ( V_84 ) ;
return F_41 ( V_85 ,
& V_108 , & V_109 , 1 ) ;
}
static int F_42 ( struct V_96 * V_110 )
{
F_43 ( & V_110 -> V_85 ) ;
return 0 ;
}
