...
if ( ! V_2 -> V_28 )
return 0 ;
if ( ! ( V_30 -> V_89 & F_48 ( V_2 -> V_28 ) ) ) {
F_6 ( L_13 ) ;
return - V_53 ;
}
V_34 = F_49 ( V_30 , V_2 -> V_67 -> V_90 ) ;
if ( V_34 ) {
F_6 ( L_14 ,
F_50 ( V_2 -> V_67 -> V_90 ) ) ;
return V_34 ;
...
F_32 ( ! F_58 ( & V_10 -> V_13 . V_99 ) ) ;
V_34 = F_55 ( V_25 ,
V_25 -> V_2 , V_55 , V_56 ) ;
break;
}
case V_106 : {
struct V_27 * V_28 = F_59 ( V_104 ) ;
F_32 ( ! F_58 ( & V_28 -> V_37 ) ) ;
V_34 = F_29 ( V_28 ,
V_28 -> V_2 , V_55 , V_56 ) ;
break;
...
struct V_29 * V_30 ;
F_32 ( ! F_14 ( V_2 , V_28 ) ) ;
F_65 (plane, state->dev, crtc->state->plane_mask) {
struct V_63 * V_64 =
F_33 ( V_2 , V_30 ) ;
if ( F_21 ( V_64 ) )
return F_22 ( V_64 ) ;
...
struct V_97 * V_109 ;
int V_23 , V_110 = 0 ;
F_67 (state, connector, conn_state, i) {
if ( V_109 -> V_28 == V_28 )
V_110 ++ ;
}
F_6 ( L_28 ,
...
int V_23 , V_34 = 0 ;
F_6 ( L_29 , V_2 ) ;
F_72 (state, plane, plane_state, i) {
V_34 = F_47 ( V_30 , V_64 ) ;
if ( V_34 ) {
F_6 ( L_30 ,
V_30 -> V_40 . V_41 ) ;
...
{
struct V_29 * V_30 ;
F_65 (plane, dev, plane_mask) {
if ( V_34 == 0 ) {
struct V_66 * V_130 = V_30 -> V_2 -> V_67 ;
if ( V_130 )
F_61 ( V_130 ) ;
V_30 -> V_67 = V_130 ;
...
int F_85 ( struct V_9 * V_10 ,
void * V_52 , struct V_115 * V_116 )
{
struct V_132 * V_133 = V_52 ;
T_2 T_3 * V_134 = ( T_2 T_3 * ) ( unsigned long ) ( V_133 -> V_134 ) ;
T_2 T_3 * V_135 = ( T_2 T_3 * ) ( unsigned long ) ( V_133 -> V_135 ) ;
T_2 T_3 * V_136 = ( T_2 T_3 * ) ( unsigned long ) ( V_133 -> V_136 ) ;
T_1 T_3 * V_137 = ( T_1 T_3 * ) ( unsigned long ) ( V_133 -> V_137 ) ;
...
unsigned V_108 ;
int V_34 = 0 ;
unsigned int V_23 , V_142 ;
if ( ! F_31 ( V_10 , V_62 ) )
return - V_53 ;
if ( ! V_116 -> V_143 )
return - V_53 ;
if ( V_133 -> V_119 & ~ V_144 )
return - V_53 ;
if ( V_133 -> V_145 )
return - V_53 ;
if ( ( V_133 -> V_119 & V_146 ) &&
! V_10 -> V_13 . V_147 )
return - V_53 ;
if ( ( V_133 -> V_119 & V_148 ) &&
( V_133 -> V_119 & V_149 ) )
return - V_53 ;
F_86 ( & V_141 , 0 ) ;
V_2 = F_7 ( V_10 ) ;
...
return - V_18 ;
V_2 -> V_38 = & V_141 ;
V_2 -> V_11 = ! ! ( V_133 -> V_119 & V_150 ) ;
V_111:
V_108 = 0 ;
V_138 = 0 ;
V_139 = 0 ;
for ( V_23 = 0 ; V_23 < V_133 -> V_151 ; V_23 ++ ) {
T_2 V_152 , V_153 ;
struct V_103 * V_104 ;
if ( F_87 ( V_152 , V_134 + V_138 ) ) {
V_34 = - V_154 ;
goto V_123;
}
V_104 = F_88 ( V_10 , V_152 , V_155 ) ;
if ( ! V_104 || ! V_104 -> V_156 ) {
V_34 = - V_157 ;
goto V_123;
}
if ( F_87 ( V_153 , V_135 + V_138 ) ) {
V_34 = - V_154 ;
goto V_123;
}
V_138 ++ ;
for ( V_142 = 0 ; V_142 < V_153 ; V_142 ++ ) {
T_2 V_158 ;
T_1 V_128 ;
struct V_54 * V_127 ;
if ( F_87 ( V_158 , V_136 + V_139 ) ) {
V_34 = - V_154 ;
goto V_123;
}
V_127 = F_89 ( V_10 , V_158 ) ;
if ( ! V_127 ) {
V_34 = - V_157 ;
goto V_123;
}
...
V_34 = F_81 ( V_2 , V_104 , V_127 , V_128 ) ;
if ( V_34 )
goto V_123;
V_139 ++ ;
}
if ( V_104 -> type == V_107 && V_153 &&
! ( V_133 -> V_119 & V_148 ) ) {
V_30 = F_60 ( V_104 ) ;
V_108 |= ( 1 << F_34 ( V_30 ) ) ;
V_30 -> V_131 = V_30 -> V_67 ;
}
}
if ( V_133 -> V_119 & V_149 ) {
F_73 (state, crtc, crtc_state, i) {
struct V_114 * V_118 ;
V_118 = F_77 ( V_10 , V_116 , V_133 -> V_117 ) ;
if ( ! V_118 ) {
V_34 = - V_18 ;
goto V_123;
}
...
if ( V_133 -> V_119 & V_148 ) {
V_34 = F_71 ( V_2 ) ;
} else if ( V_133 -> V_119 & V_159 ) {
V_34 = F_76 ( V_2 ) ;
} else {
V_34 = F_75 ( V_2 ) ;
}
V_123:
F_84 ( V_10 , V_108 , V_34 ) ;
if ( V_34 && V_133 -> V_119 & V_149 ) {
F_73 (state, crtc, crtc_state, i) {
if ( ! V_36 -> V_122 )
continue;
F_80 ( V_10 , V_116 ,
