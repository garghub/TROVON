...
static int F_27 ( struct V_43 * V_43 , struct V_7 * V_8 , struct V_3 * V_4 )
{
struct V_1 * V_2 = F_13 ( V_4 ) -> V_44 ;
return V_2 -> V_39 -> V_45 -> V_46 ( V_8 , V_4 ) ;
}
static int F_28 ( struct V_43 * V_43 , struct V_7 * V_8 , struct V_3 * V_4 )
{
struct V_28 * V_29 = F_13 ( V_4 ) ;
struct V_1 * V_2 = V_29 -> V_44 ;
int V_15 ;
bool V_47 ;
#ifdef F_25
if ( ! V_2 ) {
F_24 ( V_4 ) -> V_41 |= V_48 ;
return F_29 ( V_43 , V_8 , V_4 ) ;
}
#endif
...
V_15 = F_14 ( F_13 ( V_4 ) ) ;
V_47 = V_4 -> V_32 > V_15 && ! F_31 ( V_4 ) ;
if ( V_47 && F_3 ( V_4 ) ) {
F_5 ( V_4 , V_15 ) ;
return - V_26 ;
} else if ( ! V_4 -> V_31 && V_47 && V_4 -> V_8 ) {
F_16 ( V_4 , V_15 ) ;
return - V_26 ;
}
if ( V_47 || F_32 ( F_13 ( V_4 ) ) )
return F_33 ( V_43 , V_8 , V_4 ,
F_27 ) ;
V_52:
return V_2 -> V_39 -> V_45 -> V_46 ( V_8 , V_4 ) ;
}
int F_34 ( struct V_43 * V_43 , struct V_7 * V_8 , struct V_3 * V_4 )
{
return F_35 ( V_53 , V_54 ,
V_43 , V_8 , V_4 , NULL , F_13 ( V_4 ) -> V_33 ,
F_28 ,
! ( F_24 ( V_4 ) -> V_41 & V_48 ) ) ;
}
