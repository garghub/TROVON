...
{
struct V_22 * V_28 = F_21 ( & V_51 -> V_2 ) ;
struct V_24 * V_25 = V_51 -> V_2 . V_52 ;
struct V_3 * V_53 ;
struct V_54 V_55 = { } ;
int V_5 , V_32 , V_9 ;
V_53 = F_8 ( & V_51 -> V_2 , sizeof( struct V_3 ) ,
V_33 ) ;
if ( V_53 == NULL )
return - V_34 ;
if ( V_25 ) {
V_28 = F_7 ( & V_51 -> V_2 , V_25 ,
& V_53 -> V_27 ) ;
if ( F_22 ( V_28 ) )
return F_23 ( V_28 ) ;
}
V_53 -> V_27 . V_38 = F_24 ( V_28 -> V_36 , V_33 ) ;
if ( V_53 -> V_27 . V_38 == NULL ) {
F_18 ( & V_51 -> V_2 , L_14 ) ;
V_32 = - V_34 ;
goto V_56;
}
if ( V_28 -> V_18 != 0 ) {
V_53 -> V_8 = F_25 ( V_28 -> V_8 ,
...
V_53 -> V_6 = V_28 -> V_6 ;
V_53 -> V_27 . V_60 = V_61 ;
V_53 -> V_27 . V_62 = V_28 -> V_41 ;
switch ( V_28 -> type ) {
case V_48 :
V_53 -> V_27 . type = V_48 ;
V_53 -> V_27 . V_63 = & V_64 ;
V_53 -> V_27 . V_65 = V_28 -> V_6 ;
break;
case V_49 :
V_53 -> V_27 . type = V_49 ;
V_53 -> V_27 . V_63 = & V_66 ;
...
V_9 = 0 ;
for ( V_5 = 0 ; V_5 < V_53 -> V_18 ; V_5 ++ ) {
if ( V_28 -> V_8 [ V_5 ] . V_45 & V_46 )
V_9 |= ( 1 << V_5 ) ;
}
V_53 -> V_9 = V_9 ;
V_55 . V_2 = & V_51 -> V_2 ;
...
V_53 -> V_2 = F_28 ( & V_53 -> V_27 , & V_55 ) ;
if ( F_22 ( V_53 -> V_2 ) ) {
V_32 = F_23 ( V_53 -> V_2 ) ;
F_18 ( & V_51 -> V_2 , L_19 , V_32 ) ;
goto V_73;
}
F_29 ( V_51 , V_53 ) ;
return 0 ;
V_73:
F_30 ( V_53 -> V_8 , V_53 -> V_18 ) ;
V_58:
F_31 ( V_53 -> V_7 ) ;
V_59:
F_31 ( V_53 -> V_8 ) ;
