...
int V_29 ;
V_62 = 0 ;
for ( V_29 = 0 ; V_60 [ V_29 ] ; V_29 ++ ) {
if ( ! isspace ( V_60 [ V_29 ] ) )
V_60 [ V_62 ++ ] = V_60 [ V_29 ] ;
}
V_60 [ V_62 ] = '\0' ;
}
...
struct V_1 * V_2 = V_53 -> V_2 ;
F_10 ( V_2 , L_10 ,
V_56 -> V_63 . V_64 , V_56 -> V_63 . V_65 ,
V_56 -> V_63 . V_66 ) ;
snprintf ( V_49 -> V_61 , sizeof( V_49 -> V_61 ) , L_11 ,
V_49 -> V_67 , V_56 -> V_63 . V_64 , V_56 -> V_63 . V_65 ,
V_56 -> V_63 . V_66 , L_12 ) ;
F_15 ( V_49 ) ;
return 0 ;
}
