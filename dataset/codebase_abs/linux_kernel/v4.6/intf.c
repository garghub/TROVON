...
void * F_29 ( struct V_21 * V_10 , enum V_38 V_39 , int V_40 )
{
struct V_3 * V_4 = V_3 ( V_10 ) ;
struct V_5 * V_6 ;
unsigned long V_18 ;
...
F_21 ( & V_4 -> V_11 , V_18 ) ;
F_8 (dev_ctx, &priv->ctx_list, list)
if ( V_6 -> V_2 -> V_20 == V_39 && V_6 -> V_2 -> V_42 ) {
V_41 = V_6 -> V_2 -> V_42 ( V_10 , V_6 -> V_8 , V_40 ) ;
break;
}
F_23 ( & V_4 -> V_11 , V_18 ) ;
return V_41 ;
}
struct V_43 * F_30 ( struct V_21 * V_10 , int V_40 )
{
struct V_44 * V_45 = & V_3 ( V_10 ) -> V_40 [ V_40 ] ;
return & V_45 -> V_43 ;
}
