...
V_173:
V_10 = F_108 ( & V_35 , V_2 , F_109 ( V_14 ) ,
V_14 -> V_19 , V_14 -> V_18 ,
F_16 ( V_2 ) ) ;
if ( ! V_10 ) {
F_110 ( L_2
...
if ( V_10 -> V_36 == V_38 ) {
struct V_63 * V_64 = F_111 ( V_10 ) ;
struct V_9 * V_175 ;
V_10 = V_64 -> V_176 ;
if ( F_112 ( V_10 -> V_36 != V_177 ) ) {
F_113 ( V_10 , V_64 ) ;
goto V_173;
}
F_114 ( V_10 ) ;
V_175 = F_115 ( V_10 , V_2 , V_64 ) ;
if ( ! V_175 ) {
F_116 ( V_64 ) ;
goto V_178;
}
...
if ( ! F_118 ( V_10 , V_181 , V_2 ) )
goto V_178;
return F_119 ( V_10 , V_2 , 1 ) ? - 1 : 0 ;
V_174:
if ( ! F_118 ( NULL , V_181 , V_2 ) )
goto V_169;
if ( V_14 -> V_90 != V_91 ) {
F_66 ( V_2 ) -> V_102 =
V_182 ;
...
static int F_120 ( struct V_9 * V_10 , struct V_183 * V_184 ,
int V_185 )
{
...
if ( V_70 . V_74 & V_201 ) {
struct V_202 * V_74 ;
V_74 = F_122 ( V_10 , V_70 . V_74 ) ;
if ( V_74 == NULL )
return - V_195 ;
F_123 ( V_74 ) ;
}
}
if ( F_124 ( & V_187 -> V_203 ) )
...
V_189 -> V_138 = & V_139 ;
V_10 -> V_140 = V_141 ;
V_30 = F_127 ( V_10 , (struct V_183 * ) & sin , sizeof( sin ) ) ;
if ( V_30 ) {
V_189 -> V_154 = V_210 ;
V_189 -> V_138 = & V_218 ;
V_10 -> V_140 = F_98 ;
...
F_128 ( V_10 , F_42 ( & V_70 ) ) ;
V_21 = F_129 ( V_12 -> V_21 , F_22 ( V_10 ) ) ;
...
static int T_7 F_139 ( struct V_32 * V_32 )
{
if ( V_35 . V_226 == NULL )
return - V_227 ;
return F_140 ( & V_32 -> V_88 . V_89 , V_228 ,
V_229 , V_7 , V_32 ) ;
}
static void T_8 F_141 ( struct V_32 * V_32 )
{
F_142 ( V_32 -> V_88 . V_89 ) ;
}
static int T_9 F_143 ( void )
{
int V_30 = F_144 ( & V_230 , 1 ) ;
if ( V_30 != 0 )
goto V_41;
V_30 = F_145 ( & V_231 , V_7 ) ;
if ( V_30 != 0 )
goto V_232;
F_146 ( & V_233 ) ;
V_30 = F_147 ( & V_234 ) ;
