...
struct V_42 V_43 = { } ;
int error ;
V_6 = F_16 ( & V_35 -> V_39 , sizeof( struct V_5 ) , V_44 ) ;
if ( ! V_6 )
return - V_45 ;
V_6 -> V_11 = F_17 ( V_35 , & V_46 ) ;
if ( F_18 ( V_6 -> V_11 ) ) {
error = F_19 ( V_6 -> V_11 ) ;
F_12 ( & V_35 -> V_39 , L_2 ,
error ) ;
...
V_43 . V_39 = & V_35 -> V_39 ;
V_43 . V_47 = V_41 ? & V_41 -> V_48 :
F_20 ( V_39 , V_39 -> V_49 , & V_50 ) ;
V_43 . V_51 = V_6 ;
V_43 . V_11 = V_6 -> V_11 ;
V_43 . V_49 = V_39 -> V_49 ;
error = F_11 ( V_6 -> V_11 , V_52 , ~ 0 ) ;
if ( ! error )
error = F_11 ( V_6 -> V_11 , V_53 , ~ 0 ) ;
if ( error ) {
F_12 ( & V_35 -> V_39 , L_3 , error ) ;
return error ;
}
V_2 = F_21 ( & V_35 -> V_39 , & V_50 , & V_43 ) ;
if ( F_18 ( V_2 ) ) {
F_12 ( & V_35 -> V_39 , L_4 ) ;
return F_19 ( V_2 ) ;
}
V_6 -> V_2 = V_2 ;
if ( V_35 -> V_17 ) {
error = F_22 ( & V_35 -> V_39 , V_35 -> V_17 , NULL ,
F_7 ,
V_54 |
V_55 | V_56 ,
L_5 , V_6 ) ;
