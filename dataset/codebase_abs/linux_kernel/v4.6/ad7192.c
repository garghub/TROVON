...
{
const struct V_14 * V_15 = F_42 ( & V_18 -> V_28 ) ;
struct V_1 * V_5 ;
struct V_16 * V_17 ;
int V_21 , V_93 = 0 ;
if ( ! V_15 ) {
...
V_17 = F_43 ( & V_18 -> V_28 , sizeof( * V_5 ) ) ;
if ( ! V_17 )
return - V_96 ;
V_5 = F_24 ( V_17 ) ;
V_5 -> V_97 = F_44 ( & V_18 -> V_28 , L_8 ) ;
if ( ! F_45 ( V_5 -> V_97 ) ) {
V_21 = F_46 ( V_5 -> V_97 ) ;
if ( V_21 )
return V_21 ;
...
F_16 ( & V_18 -> V_28 , L_9 ) ;
F_48 ( V_18 , V_17 ) ;
V_5 -> V_27 = F_49 ( V_18 ) -> V_99 ;
V_17 -> V_28 . V_100 = & V_18 -> V_28 ;
V_17 -> V_101 = F_49 ( V_18 ) -> V_101 ;
V_17 -> V_102 = V_103 ;
switch ( V_5 -> V_27 ) {
case V_104 :
V_17 -> V_58 = V_105 ;
