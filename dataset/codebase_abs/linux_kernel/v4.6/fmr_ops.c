...
if ( ! V_27 )
goto V_38;
V_27 -> V_39 . V_40 = F_10 ( V_18 *
sizeof( V_41 ) , V_37 ) ;
if ( ! V_27 -> V_39 . V_40 )
goto V_42;
V_27 -> V_39 . V_39 = F_11 ( V_23 , V_12 , & V_16 ) ;
if ( F_12 ( V_27 -> V_39 . V_39 ) )
goto V_43;
...
V_29 = F_24 ( V_60 -> V_39 . V_39 , V_60 -> V_39 . V_40 ,
V_28 , V_57 -> V_64 ) ;
if ( V_29 )
goto V_65;
V_57 -> V_61 = V_60 ;
V_57 -> V_66 = V_60 -> V_39 . V_39 -> V_67 ;
...
{
struct V_52 * V_53 = V_8 -> V_24 . V_54 ;
struct V_26 * V_60 = V_49 -> V_61 ;
int V_50 = V_49 -> V_69 ;
V_49 -> V_61 = NULL ;
while ( V_50 -- )
F_25 ( V_53 , V_49 ++ ) ;
...
static void
F_28 ( struct V_7 * V_8 , struct V_70 * V_71 )
{
struct V_48 * V_49 ;
unsigned int V_28 , V_72 ;
struct V_26 * V_60 ;
F_17 ( V_73 ) ;
int V_29 ;
F_8 ( L_4 , V_35 , V_71 ) ;
for ( V_28 = 0 , V_72 = V_71 -> V_74 ; V_72 ; V_72 -- ) {
V_49 = & V_71 -> V_75 [ V_28 ] ;
V_60 = V_49 -> V_61 ;
F_13 ( & V_60 -> V_39 . V_39 -> V_47 , & V_73 ) ;
V_28 += V_49 -> V_69 ;
}
V_29 = F_18 ( & V_73 ) ;
if ( V_29 )
...
static int
F_30 ( struct V_7 * V_8 , struct V_48 * V_49 )
{
struct V_1 * V_2 = & V_8 -> V_24 ;
struct V_48 * V_57 = V_49 ;
...
struct V_26 * V_27 ;
int V_29 ;
while ( ! F_32 ( & V_10 -> V_32 ) ) {
V_27 = F_33 ( V_10 -> V_32 . V_77 , struct V_26 , V_45 ) ;
F_34 ( & V_27 -> V_45 ) ;
F_15 ( V_27 -> V_39 . V_40 ) ;
V_29 = F_35 ( V_27 -> V_39 . V_39 ) ;
if ( V_29 )
F_8 ( L_8 ,
V_35 , V_29 ) ;
F_15 ( V_27 ) ;
