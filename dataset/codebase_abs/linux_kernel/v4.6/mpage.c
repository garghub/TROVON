...
static void F_41 ( struct V_5 * V_5 , unsigned V_72 )
{
unsigned V_73 = 0 ;
...
static int F_44 ( struct V_5 * V_5 , struct V_75 * V_76 ,
void * V_77 )
{
...
T_4 V_84 = F_18 ( V_24 ) ;
int V_85 = 0 ;
int V_86 = ( V_76 -> V_87 == V_88 ? V_89 : V_90 ) ;
if ( F_12 ( V_5 ) ) {
...
V_80 = V_84 >> V_31 ;
if ( V_5 -> V_57 >= V_80 ) {
unsigned V_92 = V_84 & ( V_44 - 1 ) ;
if ( V_5 -> V_57 > V_80 || ! V_92 )
goto V_56;
F_21 ( V_5 , V_92 , V_44 ) ;
}
if ( V_1 && V_79 -> V_37 != V_49 [ 0 ] - 1 )
V_1 = F_6 ( V_86 , V_1 ) ;
V_64:
if ( V_1 == NULL ) {
if ( V_72 == V_43 ) {
...
V_85 = F_59 ( V_25 , V_76 , F_44 , & V_79 ) ;
if ( V_79 . V_1 ) {
int V_86 = ( V_76 -> V_87 == V_88 ?
V_89 : V_90 ) ;
F_6 ( V_86 , V_79 . V_1 ) ;
}
}
