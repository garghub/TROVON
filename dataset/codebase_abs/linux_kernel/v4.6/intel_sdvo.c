...
static bool F_100 ( struct V_1 * V_1 , struct V_266 * V_267 )
{
F_35 ( sizeof( * V_267 ) != 8 ) ;
if ( ! F_32 ( V_1 ,
V_268 ,
...
{
return F_105 ( V_1 -> V_267 . V_280 ) > 1 ;
}
static struct V_285 *
F_106 ( struct V_5 * V_6 )
{
struct V_1 * V_286 = F_3 ( V_6 ) ;
return F_107 ( V_6 , & V_286 -> V_287 ) ;
}
static struct V_285 *
...
V_39 = V_295 ;
if ( V_1 -> V_209 ) {
V_1 -> V_205 = F_111 ( V_285 ) ;
V_1 -> V_233 = F_112 ( V_285 ) ;
V_1 -> V_170 =
F_113 ( V_285 ) ;
}
} else
...
static bool
F_114 ( struct V_7 * V_286 ,
struct V_285 * V_285 )
{
bool V_300 = ! ! ( V_285 -> V_293 & V_294 ) ;
bool V_301 = ! ! F_115 ( V_286 ) ;
F_15 ( L_37 ,
V_301 , V_300 ) ;
return V_301 == V_300 ;
}
static enum V_290
F_116 ( struct V_5 * V_6 , bool V_302 )
{
T_4 V_45 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
F_138 ( V_1 -> V_4 . V_4 . V_165 ) ;
return 0 ;
#undef F_136
}
static void F_139 ( struct V_356 * V_3 )
{
struct V_1 * V_1 = F_1 ( F_140 ( V_3 ) ) ;
if ( V_1 -> V_105 != NULL )
F_141 ( V_3 -> V_10 ,
V_1 -> V_105 ) ;
F_142 ( & V_1 -> V_287 ) ;
...
V_367 = & V_12 -> V_368 [ 1 ] ;
if ( V_367 -> V_369 &&
F_147 ( V_12 , V_367 -> V_372 ) )
V_371 = V_367 -> V_372 ;
else
V_371 = V_373 ;
V_286 -> V_32 = F_109 ( V_12 , V_371 ) ;
F_148 ( V_286 -> V_32 , true ) ;
}
static void
F_149 ( struct V_1 * V_286 )
{
F_148 ( V_286 -> V_32 , false ) ;
}
static bool
F_150 ( struct V_1 * V_1 , int V_374 )
{
return F_53 ( V_1 ) ;
}
static T_2
F_151 ( struct V_9 * V_10 , struct V_1 * V_286 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
...
static void
F_152 ( struct V_238 * V_238 )
{
struct V_5 * V_5 ;
struct V_1 * V_377 ;
V_5 = & V_238 -> V_4 ;
V_377 = F_3 ( & V_238 -> V_4 ) ;
F_153 ( & V_5 -> V_378 -> V_379 ,
V_377 -> V_287 . V_10 . V_379 . V_38 ) ;
F_154 ( V_238 ) ;
}
static int
F_155 ( struct V_7 * V_6 ,
struct V_1 * V_3 )
{
struct V_5 * V_5 ;
int V_31 ;
V_5 = & V_6 -> V_4 . V_4 ;
V_31 = F_156 ( V_3 -> V_4 . V_4 . V_10 ,
V_5 ,
& V_380 ,
V_6 -> V_4 . V_4 . V_381 ) ;
if ( V_31 < 0 )
...
V_6 -> V_4 . V_388 = F_80 ;
V_6 -> V_4 . V_389 = F_152 ;
F_158 ( & V_6 -> V_4 , & V_3 -> V_4 ) ;
V_31 = F_159 ( V_5 ) ;
if ( V_31 < 0 )
goto V_390;
V_31 = F_160 ( & V_5 -> V_378 -> V_379 ,
...
F_163 ( & V_6 -> V_4 . V_4 ) ;
if ( F_73 ( V_10 ) -> V_225 >= 4 && F_164 ( V_10 ) ) {
F_165 ( & V_6 -> V_4 . V_4 ) ;
V_1 -> V_206 = true ;
}
F_166 ( & V_6 -> V_4 . V_4 ) ;
...
static bool
F_169 ( struct V_1 * V_1 , int V_374 )
{
struct V_356 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_2 * V_2 = F_140 ( V_3 ) ;
struct V_238 * V_238 ;
struct V_7 * V_7 ;
F_15 ( L_40 , V_374 ) ;
V_7 = F_167 () ;
...
static bool
F_174 ( struct V_1 * V_1 , int V_374 )
{
struct V_356 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_238 * V_238 ;
...
if ( F_128 ( V_7 ) )
return F_181 ( V_1 , V_7 , V_421 . V_309 ) ;
else if ( F_129 ( V_7 ) )
return F_184 ( V_1 , V_7 , V_421 . V_309 ) ;
else
return true ;
}
static int F_185 ( struct V_458 * V_459 ,
struct V_24 * V_25 ,
int V_460 )
{
...
static T_1 F_186 ( struct V_458 * V_459 )
{
struct V_1 * V_286 = V_459 -> V_461 ;
...
V_1 -> V_17 = V_17 ;
V_1 -> V_18 = V_18 ;
V_1 -> V_26 = F_151 ( V_10 , V_1 ) >> 1 ;
F_146 ( V_12 , V_1 ) ;
if ( ! F_187 ( V_1 , V_10 ) )
goto V_474;
V_2 = & V_1 -> V_4 ;
V_2 -> type = V_475 ;
F_192 ( V_10 , & V_2 -> V_4 , & V_476 , 0 ,
NULL ) ;
