...
static struct V_1 * * F_42 ( struct V_1 * * V_53 ,
struct V_1 * V_2 )
{
if ( F_36 ( V_2 ) -> V_71 ) {
F_36 ( V_2 ) -> V_64 = 1 ;
...
F_36 ( V_2 ) -> V_71 = 1 ;
return F_23 ( V_53 , V_2 ) ;
}
static int F_43 ( struct V_1 * V_2 , int V_27 )
{
const struct V_4 * V_5 ;
...
if ( F_45 ( ! V_5 || ! V_5 -> V_48 . V_74 ) )
goto V_66;
V_72 = V_5 -> V_48 . V_74 ( V_2 , V_27 ) ;
V_66:
F_41 () ;
return V_72 ;
}
static int F_46 ( struct V_1 * V_2 , int V_27 )
{
V_2 -> V_46 = 1 ;
F_9 ( V_2 ) -> V_28 |= V_36 ;
return F_43 ( V_2 , V_27 ) ;
}
