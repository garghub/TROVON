...
static int F_30 ( struct V_2 * V_4 , struct V_1 * V_1 , T_2 V_12 )
{
struct V_2 * V_2 ;
int V_3 ;
F_28 ( V_4 ) ;
...
struct V_48 * V_48 ;
int V_3 = - V_49 ;
V_47 = F_33 ( V_4 , & V_1 -> V_7 , & V_48 ) ;
if ( ! V_47 )
goto V_50;
V_3 = F_34 ( V_4 , V_47 , V_48 ) ;
if ( V_3 )
goto V_50;
V_2 -> V_40 = V_4 -> V_40 ;
F_5 ( V_2 ) ;
...
static int F_37 ( struct V_2 * V_52 , struct V_1 * V_39 ,
struct V_2 * V_53 , struct V_1 * V_54 )
{
struct V_2 * V_55 = F_27 ( V_39 ) ;
struct V_2 * V_56 = F_27 ( V_54 ) ;
struct V_48 * V_57 = NULL ;
struct V_46 * V_58 = NULL ;
struct V_48 * V_59 ;
struct V_46 * V_60 ;
int V_3 = - V_49 ;
V_60 = F_33 ( V_52 , & V_39 -> V_7 , & V_59 ) ;
if ( ! V_60 )
goto V_50;
if ( F_38 ( V_55 -> V_61 ) ) {
V_3 = - V_62 ;
...
goto V_43;
V_3 = - V_49 ;
V_65 = F_33 ( V_53 , & V_54 -> V_7 , & V_64 ) ;
if ( ! V_65 )
goto V_43;
F_40 ( V_53 , V_65 , V_64 , V_55 , 1 ) ;
V_56 -> V_40 = V_41 ;
if ( V_58 )
F_41 ( V_56 ) ;
F_5 ( V_56 ) ;
