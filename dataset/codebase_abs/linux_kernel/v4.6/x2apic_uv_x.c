...
int F_92 ( struct V_189 * V_190 , bool V_191 ,
...
if ( ( V_192 & V_199 ) == 0 )
return 0 ;
V_194 = F_94 ( V_190 -> V_195 ) ;
V_195 = V_190 -> V_195 -> V_200 ;
V_196 = F_95 ( V_191 , V_194 , V_195 ) ;
F_93 ( L_28 , V_191 , V_194 , V_195 , V_196 ) ;
return V_196 ;
}
void F_96 ( void )
{
...
int V_117 , V_123 , V_74 , V_205 , V_22 , V_93 , V_107 , V_206 , V_95 , V_207 ;
int V_208 , V_133 = 999999 , V_115 = - 1 ;
unsigned long V_209 , V_210 , V_118 ;
unsigned short V_211 ;
unsigned char V_212 ;
char * V_213 = ( F_10 () ? L_29 :
( F_54 () ? L_30 :
( F_68 () ? L_31 : NULL ) ) ) ;
if ( ! V_213 ) {
F_14 ( L_32 ) ;
...
V_202 = ( ( unsigned long ) V_208 << V_95 ) ;
F_13 ( L_34 ,
V_207 , V_95 , V_211 , V_202 , V_208 ,
V_212 ) ;
F_13 ( L_35 , V_209 ) ;
for( V_107 = 0 ; V_107 < V_215 ; V_107 ++ )
V_216 +=
F_99 ( F_55 ( V_217 + V_107 * 8 ) ) ;
F_13 ( L_36 ,
F_10 () ? F_52 () :
( F_52 () + 1 ) / 2 ,
F_52 () ) ;
V_117 = sizeof( struct V_94 ) * F_52 () ;
V_94 = F_100 ( V_117 , V_218 ) ;
F_101 ( ! V_94 ) ;
for ( V_93 = 0 ; V_93 < F_52 () ; V_93 ++ )
V_94 [ V_93 ] . V_219 = - 1 ;
F_56 ( & V_203 , & V_204 ) ;
V_117 = sizeof( V_220 [ 0 ] ) * F_102 () ;
V_220 = F_103 ( V_117 , V_218 ) ;
F_101 ( ! V_220 ) ;
memset ( V_220 , 255 , V_117 ) ;
V_117 = sizeof( V_221 [ 0 ] ) * F_104 () ;
V_221 = F_103 ( V_117 , V_218 ) ;
F_101 ( ! V_221 ) ;
memset ( V_221 , 255 , V_117 ) ;
V_93 = 0 ;
for ( V_107 = 0 ; V_107 < V_215 ; V_107 ++ ) {
V_210 = F_55 ( V_217 + V_107 * 8 ) ;
for ( V_206 = 0 ; V_206 < 64 ; V_206 ++ ) {
if ( ! F_105 ( V_206 , & V_210 ) )
continue;
V_22 = ( V_107 * 64 + V_206 ) & V_211 ;
V_94 [ V_93 ] . V_22 = V_22 ;
V_94 [ V_93 ] . V_222 = 0 ;
V_94 [ V_93 ] . V_201 = 0 ;
F_106 ( & V_94 [ V_93 ] . V_223 ) ;
...
F_107 () ;
F_108 ( 0 , & V_224 , & V_225 , & V_226 ,
& V_227 , & V_228 ) ;
F_73 () ;
F_109 (cpu) {
int V_76 = F_22 ( V_77 , V_74 ) ;
V_123 = F_110 ( V_74 ) ;
F_82 ( V_74 ) -> V_211 = V_211 ;
F_82 ( V_74 ) -> V_229 = V_39 . V_27 . V_41 ;
F_82 ( V_74 ) -> V_37 = V_36 -> V_37 ;
F_82 ( V_74 ) -> V_230 = 64 - V_95 ;
F_82 ( V_74 ) -> V_212 = V_212 ;
V_22 = F_19 ( V_76 ) ;
V_93 = F_51 ( V_22 ) ;
V_205 = V_94 [ V_93 ] . V_222 ;
V_94 [ V_93 ] . V_222 ++ ;
V_94 [ V_93 ] . V_219 = V_123 ;
F_82 ( V_74 ) -> V_231 = V_203 ;
F_82 ( V_74 ) -> V_232 = V_204 ;
F_82 ( V_74 ) -> V_95 = V_95 ;
F_82 ( V_74 ) -> V_207 = V_207 ;
F_82 ( V_74 ) -> V_233 = V_93 ;
F_82 ( V_74 ) -> V_234 = V_205 ;
F_82 ( V_74 ) -> V_22 = V_22 ;
F_82 ( V_74 ) -> V_235 = ( 1UL << ( V_95 + V_207 ) ) - 1 ;
F_82 ( V_74 ) -> V_202 = V_202 ;
F_82 ( V_74 ) -> V_208 = V_208 ;
F_82 ( V_74 ) -> V_236 = V_209 ;
F_82 ( V_74 ) -> V_237 = V_226 ;
F_82 ( V_74 ) -> V_171 . V_238 = F_111 ( V_76 ) ;
V_220 [ V_123 ] = V_93 ;
V_221 [ V_74 ] = V_93 ;
}
F_63 (nid) {
