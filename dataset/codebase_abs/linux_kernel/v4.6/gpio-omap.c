...
{
struct V_93 * V_94 = F_62 ( V_92 ) ;
struct V_1 * V_6 = F_63 ( V_94 ) ;
void T_1 * V_95 = V_6 -> V_10 +
V_96 / V_6 -> V_97 ;
unsigned long V_60 ;
F_31 ( & V_6 -> V_62 , V_60 ) ;
F_7 ( 0xffff & ~ V_6 -> V_14 . V_44 , V_95 ) ;
F_32 ( & V_6 -> V_62 , V_60 ) ;
return 0 ;
}
...
static int F_72 ( struct V_4 * V_5 , unsigned V_16 , int V_101 )
{
struct V_1 * V_6 ;
unsigned long V_60 ;
V_6 = F_3 ( V_5 ) ;
...
static void F_74 ( struct V_4 * V_5 , unsigned V_16 , int V_101 )
{
struct V_1 * V_6 ;
unsigned long V_60 ;
V_6 = F_3 ( V_5 ) ;
...
static bool V_102 ;
T_2 V_103 ;
if ( V_102 || V_6 -> V_12 -> V_104 == V_105 )
return;
V_103 = F_76 ( V_6 -> V_10 + V_6 -> V_12 -> V_104 ) ;
F_77 ( L_2 ,
( V_103 >> 4 ) & 0x0f , V_103 & 0x0f ) ;
V_102 = true ;
}
...
static int F_79 ( struct V_1 * V_6 , struct V_107 * V_108 )
{
static int V_7 ;
int V_109 = 0 ;
int V_75 ;
...
V_7 += V_6 -> V_68 ;
#ifdef F_82
V_109 = F_83 ( - 1 , 0 , V_6 -> V_68 , 0 ) ;
if ( V_109 < 0 ) {
F_41 ( V_6 -> V_5 . V_74 , L_6 ) ;
return - V_118 ;
}
#endif
if ( V_6 -> V_106 ) {
V_108 -> V_119 = V_120 . V_119 ;
if ( ! V_6 -> V_12 -> V_43 )
V_108 -> V_121 = NULL ;
}
V_75 = F_84 ( & V_6 -> V_5 , V_108 ,
V_109 , V_122 ,
V_89 ) ;
if ( V_75 ) {
F_41 ( V_6 -> V_5 . V_74 ,
...
F_86 ( & V_6 -> V_5 , V_108 , V_6 -> V_76 , NULL ) ;
V_75 = F_87 ( V_6 -> V_5 . V_74 , V_6 -> V_76 ,
F_48 ,
0 , F_88 ( V_6 -> V_5 . V_74 ) , V_6 ) ;
if ( V_75 )
F_85 ( & V_6 -> V_5 ) ;
return V_75 ;
}
...
struct V_107 * V_108 ;
int V_75 ;
V_127 = F_90 ( F_91 ( V_132 ) , V_92 ) ;
V_129 = V_127 ? V_127 -> V_90 : F_92 ( V_92 ) ;
if ( ! V_129 )
return - V_51 ;
V_6 = F_93 ( V_92 , sizeof( struct V_1 ) , V_133 ) ;
if ( ! V_6 ) {
F_41 ( V_92 , L_8 ) ;
return - V_134 ;
}
V_108 = F_93 ( V_92 , sizeof( * V_108 ) , V_133 ) ;
if ( ! V_108 )
return - V_134 ;
V_108 -> V_135 = F_53 ,
V_108 -> V_136 = F_55 ,
...
V_108 -> V_140 = F_56 ,
V_108 -> V_141 = F_57 ,
V_108 -> V_142 = F_88 ( & V_94 -> V_92 ) ;
V_6 -> V_76 = F_94 ( V_94 , 0 ) ;
if ( V_6 -> V_76 <= 0 ) {
if ( ! V_6 -> V_76 )
V_6 -> V_76 = - V_143 ;
if ( V_6 -> V_76 != - V_144 )
...
V_6 -> V_5 . V_145 = V_146 ;
V_6 -> V_31 = V_129 -> V_31 ;
V_6 -> V_97 = V_129 -> V_147 ;
V_6 -> V_68 = V_129 -> V_148 ;
V_6 -> V_106 = V_129 -> V_106 ;
V_6 -> V_42 = V_129 -> V_42 ;
V_6 -> V_12 = V_129 -> V_12 ;
#ifdef F_95
...
F_98 ( & V_6 -> V_62 ) ;
F_98 ( & V_6 -> V_85 ) ;
V_131 = F_99 ( V_94 , V_151 , 0 ) ;
V_6 -> V_10 = F_100 ( V_92 , V_131 ) ;
if ( F_101 ( V_6 -> V_10 ) ) {
return F_102 ( V_6 -> V_10 ) ;
}
if ( V_6 -> V_31 ) {
V_6 -> V_27 = F_103 ( V_92 , L_11 ) ;
if ( F_101 ( V_6 -> V_27 ) ) {
F_41 ( V_92 ,
L_12 ) ;
V_6 -> V_31 = false ;
...
static int F_110 ( struct V_93 * V_94 )
{
struct V_1 * V_6 = F_63 ( V_94 ) ;
F_111 ( & V_6 -> V_124 ) ;
F_85 ( & V_6 -> V_5 ) ;
...
static int F_113 ( struct V_91 * V_92 )
{
struct V_93 * V_94 = F_62 ( V_92 ) ;
struct V_1 * V_6 = F_63 ( V_94 ) ;
T_2 V_153 = 0 , V_154 = 0 ;
