...
static int F_173 ( struct V_282 * V_196 )
{
struct V_158 * V_159 = F_161 ( V_196 ) ;
struct V_2 * V_284 = F_102 ( V_159 ) ;
...
F_174 ( V_34 -> V_3 ) ;
F_175 ( V_35 ) ;
F_176 ( V_239 , & V_34 -> V_298 ) ;
return 0 ;
}
static int F_177 ( struct V_282 * V_196 , bool V_299 )
{
...
static void F_190 ( struct V_310 * V_310 )
{
struct V_10 * V_11 ;
struct V_4 * V_35 ;
struct V_12 * V_13 ;
...
static struct V_36 * F_202 ( struct V_315 * V_316 )
{
struct V_36 * V_37 ;
struct V_317 * V_318 ;
int V_32 ;
V_37 = F_203 ( sizeof( * V_37 ) , V_319 ) ;
if ( ! V_37 ) {
F_65 (KERN_ERR PFX L_45 ) ;
return NULL ;
}
F_204 ( & V_37 -> V_43 ) ;
F_205 ( & V_37 -> V_42 ) ;
...
struct V_5 * V_34 ;
struct V_158 * V_159 ;
struct V_282 * V_196 = F_214 ( V_349 ) ;
struct V_292 * V_293 ;
struct V_36 * V_37 = V_35 -> V_37 ;
int V_32 = 0 ;
V_293 = F_203 ( sizeof( struct V_292 ) , V_319 ) ;
if ( ! V_293 ) {
F_34 ( V_13 -> V_16 , L_50 ) ;
return NULL ;
}
...
if ( ! V_350 )
V_3 = F_215 ( & V_351 , sizeof( * V_34 ) ) ;
else
V_3 = F_216 ( V_196 , sizeof( * V_34 ) ) ;
if ( ! V_3 ) {
...
static void F_258 ( struct V_315 * V_99 )
{
struct V_36 * V_37 ;
int V_32 = 0 ;
F_19 ( L_1 , V_41 ) ;
...
V_37 = F_202 ( V_99 ) ;
if ( ! V_37 ) {
F_65 (KERN_ERR PFX L_79 ) ;
return;
}
F_20 ( & V_237 ) ;
F_219 ( & V_37 -> V_22 , & V_405 ) ;
V_406 ++ ;
F_23 ( & V_237 ) ;
...
static T_6 F_261 ( struct V_2 * V_3 ,
struct V_411 * V_412 )
{
struct V_413 V_414 ;
T_6 V_40 , V_415 = 0 ;
if ( V_412 -> V_416 > V_417 ) {
F_34 ( V_3 , L_83 ) ;
goto V_418;
}
if ( F_262 ( V_412 -> V_211 [ 0 ] ) == 0 &&
F_262 ( V_412 -> V_212 [ 0 ] ) == 0 ) {
F_34 ( V_3 , L_84 ) ;
goto V_418;
}
V_414 . V_419 = V_420 ;
V_414 . V_421 = V_422 ;
V_414 . V_299 = false ;
for ( V_40 = 0 ; V_40 < V_412 -> V_416 ; V_40 ++ ) {
V_414 . V_357 = F_262 ( V_412 -> V_211 [ V_40 ] ) ;
V_414 . V_286 = F_262 ( V_412 -> V_212 [ V_40 ] ) ;
F_263 ( V_414 . V_423 , sizeof( V_414 . V_423 ) ,
L_85 ,
V_415 , V_414 . V_286 , V_414 . V_357 ) ;
if ( F_264 ( V_3 -> V_188 , 0 , & V_414 ) )
V_415 ++ ;
else
F_34 ( V_3 , L_86 ) ;
}
...
static int F_265 ( struct V_12 * V_13 )
{
struct V_4 * V_35 = F_6 ( V_13 ) ;
struct V_36 * V_37 ;
struct V_411 * V_412 ;
...
if ( ! V_37 -> V_316 -> V_424 )
goto V_418;
V_412 = F_203 ( sizeof( struct V_411 ) , V_319 ) ;
if ( ! V_412 )
goto V_418;
if ( V_37 -> V_316 -> V_424 ( V_37 -> V_316 , V_412 ) )
goto V_425;
F_261 ( V_3 , V_412 ) ;
V_425:
F_100 ( V_412 ) ;
...
static int F_267 ( struct V_10 * V_226 )
{
...
if ( V_7 -> V_433 & V_434 )
V_205 = F_270 ( V_7 ) ;
if ( V_205 -> V_213 && V_205 -> V_213 -> V_435 ) {
memset ( & V_430 , 0 , sizeof( V_430 ) ) ;
V_205 -> V_213 -> V_435 ( V_205 , & V_430 ) ;
if ( strncmp ( V_430 . V_436 , L_91 , strlen ( L_91 ) ) ) {
F_65 (KERN_ERR PFX L_92 ) ;
V_32 = - V_82 ;
goto V_361;
}
} else {
F_65 (KERN_ERR PFX L_93 ) ;
V_32 = - V_82 ;
goto V_361;
}
V_37 = F_271 ( V_205 ) ;
...
static int F_274 ( struct V_1 * V_7 , enum V_342 V_343 )
{
return F_268 ( V_7 , V_343 , V_442 ) ;
}
static int F_275 ( struct V_1 * V_7 )
{
return F_268 ( V_7 , V_431 ,
V_443 ) ;
}
static struct V_36 * F_276 ( struct V_315 * V_316 )
{
struct V_36 * V_37 ;
...
static struct V_36 * F_271 ( struct V_1
* V_205 )
{
struct V_36 * V_37 ;
F_131 (hba, &adapter_list, list) {
...
static void F_277 ( struct V_315 * V_99 )
{
struct V_36 * V_37 ;
struct V_4 * V_35 , * V_153 ;
F_19 ( L_101 ) ;
...
F_130 ( V_239 ) ;
F_256 ( V_37 ) ;
if ( F_191 ( V_407 , & V_37 -> V_408 ) )
V_37 -> V_316 -> V_444 ( V_37 -> V_316 , V_410 ) ;
F_199 ( V_37 ) ;
}
static int F_278 ( struct V_158 * V_159 )
{
struct V_2 * V_3 = F_102 ( V_159 ) ;
F_279 ( V_3 ) ;
return 0 ;
}
static bool F_280 ( struct V_1 * V_7 )
{
struct V_1 * V_205 = V_7 ;
F_20 ( & V_237 ) ;
if ( V_7 -> V_433 & V_434 )
...
static void F_281 ( unsigned int V_445 )
{
struct V_149 * V_150 ;
struct V_446 * V_130 ;
V_150 = & F_282 ( V_447 , V_445 ) ;
V_130 = F_283 ( F_93 ,
( void * ) V_150 , F_284 ( V_445 ) ,
L_104 , V_445 ) ;
if ( F_285 ( ! F_286 ( V_130 ) ) ) {
F_287 ( V_130 , V_445 ) ;
V_150 -> V_448 = V_130 ;
F_71 ( V_130 ) ;
}
}
static void F_288 ( unsigned int V_445 )
{
struct V_149 * V_150 ;
struct V_446 * V_130 ;
struct V_151 * V_152 , * V_153 ;
...
static int F_290 ( struct V_449 * V_450 ,
unsigned long V_451 , void * V_452 )
{
unsigned V_445 = ( unsigned long ) V_452 ;
switch ( V_451 ) {
case V_453 :
case V_454 :
F_65 ( V_384 L_106 , V_445 ) ;
F_281 ( V_445 ) ;
break;
case V_455 :
case V_456 :
F_65 ( V_384 L_107 , V_445 ) ;
F_288 ( V_445 ) ;
break;
default:
break;
...
struct V_149 * V_150 ;
F_65 (KERN_INFO PFX L_108 , version) ;
V_32 = F_292 ( & V_459 ) ;
if ( V_32 ) {
F_65 ( V_232 L_109
L_110 ) ;
...
F_98 ( & V_37 -> V_22 ) ;
F_65 (KERN_ERR PFX L_113 ,
hba) ;
F_256 ( V_37 ) ;
if ( F_191 ( V_407 ,
& V_37 -> V_408 ) )
V_37 -> V_316 -> V_444 ( V_37 -> V_316 ,
V_410 ) ;
F_199 ( V_37 ) ;
}
F_305 ( V_410 ) ;
