...
F_63 ( F_64 ( F_65 ( V_5 ) , V_3 -> V_46 ) ) ;
if ( V_3 -> V_58 )
return;
V_3 -> V_46 = F_65 ( V_5 ) + V_57 -> V_59 ;
V_3 -> V_13 = V_57 -> V_16 ;
}
...
if ( V_3 -> V_60 && V_3 -> V_13 > 0 )
V_3 -> V_13 = 0 ;
while ( V_3 -> V_13 <= 0 ) {
V_3 -> V_46 += V_57 -> V_15 ;
V_3 -> V_13 += V_57 -> V_16 ;
}
if ( F_64 ( V_3 -> V_46 , F_65 ( V_5 ) ) ) {
F_67 ( L_1 ) ;
V_3 -> V_46 = F_65 ( V_5 ) + V_57 -> V_59 ;
V_3 -> V_13 = V_57 -> V_16 ;
}
...
struct V_2 * V_57 , T_1 V_61 )
{
T_1 V_62 , V_63 ;
V_62 = ( V_57 -> V_15 >> V_64 ) * ( V_3 -> V_13 >> V_64 ) ;
V_63 = ( ( V_3 -> V_46 - V_61 ) >> V_64 ) *
( V_57 -> V_16 >> V_64 ) ;
return F_64 ( V_63 , V_62 ) ;
}
...
static enum V_72 F_80 ( struct V_65 * V_66 )
{
struct V_2 * V_3 = F_2 ( V_66 ,
struct V_2 ,
V_67 ) ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
unsigned long V_73 ;
...
if ( F_98 ( V_5 ) == F_99 () )
F_100 ( F_65 ( V_5 ) ) ;
V_81 = F_101 ( V_5 ) - V_26 -> V_82 . V_83 ;
if ( F_88 ( ( T_3 ) V_81 <= 0 ) ) {
if ( F_88 ( V_3 -> V_60 ) )
goto V_84;
return;
}
F_102 ( V_26 -> V_82 . V_85 . V_86 ,
F_103 ( V_26 -> V_82 . V_85 . V_86 , V_81 ) ) ;
V_26 -> V_82 . V_87 += V_81 ;
F_104 ( V_26 , V_81 ) ;
V_26 -> V_82 . V_83 = F_101 ( V_5 ) ;
F_105 ( V_26 , V_81 ) ;
F_106 ( V_5 , V_81 ) ;
V_3 -> V_13 -= V_81 ;
V_84:
if ( F_96 ( V_3 ) || V_3 -> V_60 ) {
V_3 -> V_58 = 1 ;
F_107 ( V_5 , V_26 , 0 ) ;
if ( F_88 ( V_3 -> V_75 || ! F_70 ( V_26 ) ) )
F_86 ( V_5 , V_26 , V_76 ) ;
if ( ! F_8 ( V_26 , & V_5 -> V_4 ) )
F_60 ( V_5 ) ;
}
...
static void F_110 ( struct V_6 * V_6 , T_1 V_46 )
{
struct V_5 * V_5 = F_3 ( V_6 ) ;
if ( V_6 -> V_25 . V_26 == 0 ||
F_64 ( V_46 , V_6 -> V_25 . V_26 ) ) {
V_6 -> V_25 . V_26 = V_46 ;
F_111 ( & V_5 -> V_31 -> V_92 , V_5 -> V_34 , V_46 , 1 ) ;
}
}
static void F_112 ( struct V_6 * V_6 , T_1 V_46 )
{
struct V_5 * V_5 = F_3 ( V_6 ) ;
if ( ! V_6 -> V_36 ) {
V_6 -> V_25 . V_26 = 0 ;
V_6 -> V_25 . V_27 = 0 ;
F_111 ( & V_5 -> V_31 -> V_92 , V_5 -> V_34 , 0 , 0 ) ;
} else {
struct V_8 * V_41 = V_6 -> V_9 ;
struct V_2 * V_40 ;
V_40 = F_33 ( V_41 , struct V_2 , V_8 ) ;
V_6 -> V_25 . V_26 = V_40 -> V_46 ;
F_111 ( & V_5 -> V_31 -> V_92 , V_5 -> V_34 , V_40 -> V_46 , 1 ) ;
}
}
static inline void F_110 ( struct V_6 * V_6 , T_1 V_46 ) {}
static inline void F_112 ( struct V_6 * V_6 , T_1 V_46 ) {}
static inline
...
static void F_86 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_73 )
{
struct V_1 * V_95 = F_122 ( V_7 ) ;
struct V_2 * V_57 = & V_7 -> V_4 ;
if ( V_95 && V_7 -> V_4 . V_75 && F_114 ( V_95 -> V_96 ) ) {
V_57 = & V_95 -> V_4 ;
} else if ( ! F_114 ( V_7 -> V_96 ) ) {
F_32 ( ! V_7 -> V_4 . V_75 || V_73 != V_76 ) ;
return;
}
if ( V_7 -> V_4 . V_58 && ! ( V_73 & V_76 ) )
return;
F_120 ( & V_7 -> V_4 , V_57 , V_73 ) ;
if ( ! F_123 ( V_5 , V_7 ) && V_7 -> V_37 > 1 )
F_31 ( V_5 , V_7 ) ;
}
static void F_107 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_73 )
{
F_121 ( & V_7 -> V_4 ) ;
F_37 ( V_5 , V_7 ) ;
}
static void F_124 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_73 )
{
F_97 ( V_5 ) ;
F_107 ( V_5 , V_7 , V_73 ) ;
}
...
static int
F_127 ( struct V_1 * V_7 , int V_34 , int V_97 , int V_73 )
{
struct V_1 * V_26 ;
struct V_5 * V_5 ;
if ( V_97 != V_98 )
...
{
if ( V_5 -> V_26 -> V_37 == 1 ||
F_133 ( & V_5 -> V_31 -> V_92 , V_5 -> V_26 , NULL ) == - 1 )
return;
if ( V_7 -> V_37 != 1 &&
F_133 ( & V_5 -> V_31 -> V_92 , V_7 , NULL ) != - 1 )
return;
F_60 ( V_5 ) ;
}
...
{
F_136 ( V_5 , V_7 -> V_4 . V_13 ) ;
}
static void F_135 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
}
static struct V_2 * F_137 ( struct V_5 * V_5 ,
struct V_6 * V_6 )
{
struct V_8 * V_62 = V_6 -> V_9 ;
if ( ! V_62 )
return NULL ;
return F_33 ( V_62 , struct V_2 , V_8 ) ;
}
struct V_1 * F_138 ( struct V_5 * V_5 , struct V_1 * V_48 )
{
struct V_2 * V_3 ;
struct V_1 * V_7 ;
struct V_6 * V_6 ;
...
static void F_141 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
F_97 ( V_5 ) ;
if ( F_6 ( & V_7 -> V_4 ) && V_7 -> V_37 > 1 )
F_31 ( V_5 , V_7 ) ;
}
static void F_142 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_105 )
{
F_97 ( V_5 ) ;
if ( F_140 ( V_5 ) && V_105 && V_7 -> V_4 . V_13 > 0 &&
F_8 ( V_7 , & V_5 -> V_4 ) )
F_135 ( V_5 , V_7 ) ;
}
...
{
struct V_17 * V_11 = F_145 ( F_146 ( V_7 ) ) ;
F_147 ( & V_11 -> V_18 ) ;
...
static int F_150 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_34 )
{
if ( ! F_151 ( V_5 , V_7 ) &&
F_152 ( V_34 , F_52 ( V_7 ) ) )
return 1 ;
...
static struct V_1 * F_153 ( struct V_5 * V_5 , int V_34 )
{
...
static int F_130 ( struct V_1 * V_106 )
{
struct V_107 * V_108 ;
struct V_109 * V_110 = F_154 ( V_111 ) ;
int V_112 = F_99 () ;
int V_113 , V_34 = F_146 ( V_106 ) ;
if ( F_88 ( ! V_110 ) )
return - 1 ;
if ( V_106 -> V_37 == 1 )
return - 1 ;
V_113 = F_133 ( & F_5 ( V_106 ) -> V_31 -> V_92 ,
V_106 , V_110 ) ;
if ( V_113 == - 1 )
return - 1 ;
if ( F_152 ( V_34 , V_110 ) )
return V_34 ;
if ( ! F_152 ( V_112 , V_110 ) )
V_112 = - 1 ;
F_128 () ;
F_155 (cpu, sd) {
if ( V_108 -> V_73 & V_114 ) {
if ( V_112 != - 1 &&
F_152 ( V_112 , F_156 ( V_108 ) ) ) {
F_131 () ;
return V_112 ;
}
if ( V_113 < V_56 &&
F_152 ( V_113 , F_156 ( V_108 ) ) ) {
F_131 () ;
return V_113 ;
}
}
...
if ( F_44 ( V_5 -> V_26 ) &&
F_64 ( V_118 -> V_4 . V_46 , V_5 -> V_26 -> V_4 . V_46 ) &&
V_5 -> V_26 -> V_37 > 1 ) {
F_60 ( V_5 ) ;
return 0 ;
}
...
struct V_1 * V_106 ;
V_106 = F_157 ( V_5 ) ;
if ( F_146 ( V_118 ) == V_5 -> V_34 && V_106 == V_118 ) {
goto V_99;
}
if ( ! V_106 )
goto V_99;
...
V_123 = F_55 ( V_34 ) ;
if ( V_121 -> V_4 . V_36 &&
F_64 ( V_121 -> V_4 . V_25 . V_26 ,
V_123 -> V_4 . V_25 . V_27 ) )
continue;
F_56 ( V_121 , V_123 ) ;
if ( V_123 -> V_4 . V_36 <= 1 )
goto V_126;
V_7 = F_153 ( V_123 , V_112 ) ;
if ( V_7 && F_64 ( V_7 -> V_4 . V_46 , V_124 ) &&
( ! V_121 -> V_4 . V_36 ||
F_64 ( V_7 -> V_4 . V_46 ,
V_121 -> V_4 . V_25 . V_26 ) ) ) {
F_63 ( V_7 == V_123 -> V_26 ) ;
F_63 ( ! F_85 ( V_7 ) ) ;
if ( F_64 ( V_7 -> V_4 . V_46 ,
V_123 -> V_26 -> V_4 . V_46 ) )
goto V_126;
V_122 = true ;
F_57 ( V_123 , V_7 , 0 ) ;
...
struct V_17 * V_131 ;
V_131 = F_145 ( F_98 ( V_5 ) ) ;
F_12 ( & V_131 -> V_18 ) ;
F_164 ( V_131 , V_7 -> V_4 . V_17 ) ;
F_16 ( & V_131 -> V_18 ) ;
}
F_165 ( V_7 , V_127 ) ;
}
...
if ( V_5 -> V_4 . V_29 )
F_21 ( V_5 ) ;
F_167 ( & V_5 -> V_31 -> V_92 , V_5 -> V_34 ) ;
if ( V_5 -> V_4 . V_36 > 0 )
F_111 ( & V_5 -> V_31 -> V_92 , V_5 -> V_34 , V_5 -> V_4 . V_25 . V_26 , 1 ) ;
}
...
F_25 ( V_5 ) ;
F_111 ( & V_5 -> V_31 -> V_92 , V_5 -> V_34 , 0 , 0 ) ;
F_169 ( & V_5 -> V_31 -> V_92 , V_5 -> V_34 ) ;
}
void T_4 F_170 ( void )
{
unsigned int V_132 ;
F_171 (i)
F_172 ( & F_47 ( V_111 , V_132 ) ,
V_133 , F_173 ( V_132 ) ) ;
}
...
{
if ( F_64 ( V_7 -> V_4 . V_46 , F_65 ( V_5 ) ) )
F_62 ( & V_7 -> V_4 , & V_7 -> V_4 ) ;
...
if ( ! V_5 -> V_4 . V_29 )
F_48 ( V_5 ) ;
if ( F_64 ( V_5 -> V_4 . V_25 . V_26 , V_7 -> V_4 . V_46 ) )
F_60 ( V_5 ) ;
#else
F_60 ( V_5 ) ;
#endif
...
void F_177 ( struct V_135 * V_136 , int V_34 )
{
F_178 ( V_136 , V_34 , & F_55 ( V_34 ) -> V_4 ) ;
}
