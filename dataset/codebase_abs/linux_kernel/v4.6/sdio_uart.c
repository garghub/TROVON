...
if ( ! ( V_172 & V_96 ) || ! F_86 ( V_174 , & V_127 -> V_154 ) )
V_173 |= V_37 ;
F_54 ( V_2 , V_173 ) ;
}
...
static int F_87 ( struct V_126 * V_127 , int V_175 )
{
struct V_1 * V_2 = V_127 -> V_166 ;
int V_176 ;
V_176 = F_20 ( V_2 ) ;
...
static int F_90 ( struct V_177 * V_178 , void * V_179 )
{
int V_180 ;
F_91 ( V_178 , L_1 ,
L_2 , L_2 , L_2 ) ;
...
static int F_94 ( struct V_182 * V_182 , struct V_167 * V_167 )
{
...
F_100 ( L_15 ,
F_99 ( V_16 ) , V_190 -> V_195 [ 2 ] , V_190 -> V_195 [ 3 ] ) ;
