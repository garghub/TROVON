...
{
int V_80 = F_97 () ;
unsigned int V_136 = F_98 () ;
int V_15 = - V_107 ;
F_99 ( L_8 , V_80 ) ;
for (; V_135 -> V_137 != NULL ; V_135 ++ ) {
if ( ( V_136 & V_135 -> V_138 ) != V_135 -> V_136 )
continue;
V_15 = V_135 -> V_137 ( V_7 ) ;
break;
}
F_100 () ;
return V_15 ;
...
int * V_100 , V_99 = 0 ;
bool V_139 = false ;
struct V_56 * V_140 = V_7 -> V_57 ;
V_100 = F_102 ( V_140 -> V_102 , sizeof( * V_100 ) , V_141 ) ;
if ( ! V_100 )
return - V_128 ;
do {
struct V_142 * V_143 ;
int V_80 , V_54 ;
V_143 = F_103 ( V_140 -> V_55 . V_144 , L_9 , V_99 ) ;
if ( ! V_143 )
break;
V_54 = F_63 ( V_140 , V_99 ) ;
if ( V_54 >= 0 ) {
bool V_145 = ! F_64 ( V_54 ) ;
if ( V_99 > 0 && V_145 != V_139 ) {
F_72 ( L_10 ,
V_143 -> V_94 ) ;
F_104 ( V_100 ) ;
return - V_53 ;
...
if ( F_108 ( & V_7 -> V_41 ) == 0 )
F_107 ( & V_7 -> V_41 ) ;
if ( V_139 && V_99 == V_140 -> V_102 )
V_7 -> V_104 = V_100 ;
else
F_104 ( V_100 ) ;
return 0 ;
}
int F_109 ( struct V_56 * V_140 ,
const struct V_148 * V_149 ,
const struct V_134 * V_150 )
{
const struct V_148 * V_151 ;
const int (* F_110)( struct V_5 * );
struct V_142 * V_152 = V_140 -> V_55 . V_144 ;
struct V_5 * V_7 ;
int V_15 = - V_107 ;
V_7 = F_111 ( sizeof( struct V_5 ) , V_141 ) ;
if ( ! V_7 ) {
F_99 ( L_12 ) ;
return - V_128 ;
}
...
V_93 = V_7 ;
V_7 -> V_57 = V_140 ;
if ( V_152 && ( V_151 = F_112 ( V_149 , V_140 -> V_55 . V_144 ) ) ) {
F_110 = V_151 -> V_96 ;
V_7 -> V_153 = F_113 ( V_140 -> V_55 . V_144 ,
L_13 ) ;
if ( F_114 ( V_154 ) && V_7 -> V_153 ) {
F_75 ( L_14 ) ;
V_7 -> V_153 = false ;
}
V_15 = F_101 ( V_7 ) ;
