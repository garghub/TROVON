...
{
memcpy ( & V_67 -> V_68 . V_11 , V_11 , V_367 ) ;
}
...
T_1 F_45 (
T_2 V_73 , unsigned * V_74 , int V_368 , int V_369 )
{
T_2 V_370 = - 1 , V_371 , V_372 ;
T_1 V_373 ;
int V_374 ;
* V_74 = 0 ;
if ( ! V_73 )
return 0 ;
for ( V_374 = V_368 ; V_374 < V_369 ; ++ V_374 ) {
V_370 = V_73 >> V_374 ;
if ( V_370 < ( 1 << V_375 ) )
break;
}
...
V_370 |= ( ( V_374 - 8 ) & 0xf ) << 28 ;
V_373 = F_31 ( ( T_7 ) V_370 ) ;
F_25 ( L_64 ,
F_18 ( V_73 ) , F_18 ( V_370 & 0x0FFFFFFF ) , V_374 ,
V_373 , * V_74 ) ;
return V_373 ;
}
