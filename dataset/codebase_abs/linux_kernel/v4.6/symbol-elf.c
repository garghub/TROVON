...
V_28 = V_153 -> V_124 ;
V_24 = V_153 -> V_137 ;
if ( F_19 ( V_4 , & V_7 , & V_161 , L_22 , NULL ) )
...
T_19 V_180 = V_9 . V_170 - V_153 -> V_141 . V_30 ;
...
|| ( ! V_176 && V_153 -> V_145 ) ) {
F_84 ( L_25 V_198 L_26
L_27 V_198 L_28 V_198 L_29 , V_75 ,
...
static int F_90 ( T_2 * V_4 , bool V_207 , T_20 V_208 , void * V_79 )
{
T_21 V_209 ;
T_3 V_3 , V_210 ;
int V_59 ;
...
int F_92 ( int V_94 , bool V_207 , T_20 V_208 , void * V_79 ,
bool * V_135 )
{
int V_59 ;
T_2 * V_4 ;
...
static int F_94 ( int V_227 , T_22 V_228 , int V_229 , T_22 V_230 , T_13 V_231 )
{
V_100 V_232 ;
T_3 V_101 ;
int V_59 = - 1 ;
...
static int F_104 ( struct V_236 * V_236 , int V_35 , T_22 V_180 ,
...
static T_22 F_106 ( struct V_236 * V_236 )
{
...
T_13 V_279 , T_13 V_280 )
{
if ( V_278 -> V_27 || V_279 < V_172 || V_279 >= V_187 )
return;
V_278 -> V_27 = V_279 ;
V_278 -> V_180 = ( V_279 - V_172 ) + V_188 ;
V_278 -> V_231 = V_280 < V_187 ? V_280 - V_279 : V_187 - V_279 ;
}
static int F_118 ( T_13 V_172 , T_13 V_231 , T_13 V_188 , void * V_79 )
{
struct V_266 * V_267 = V_79 ;
T_13 V_187 = V_172 + V_231 ;
F_117 ( & V_267 -> V_281 , V_172 , V_187 , V_188 , V_267 -> V_271 ,
V_267 -> V_272 ) ;
F_117 ( & V_267 -> V_282 , V_172 , V_187 , V_188 , V_267 -> V_275 ,
V_267 -> V_268 ) ;
return 0 ;
}
...
static int F_123 ( const char * V_283 , const char * V_284 ,
const char * V_34 )
{
char V_285 [ V_183 ] ;
char V_286 [ V_183 ] ;
F_111 ( V_285 , V_183 , L_36 , V_283 , V_34 ) ;
F_111 ( V_286 , V_183 , L_36 , V_284 , V_34 ) ;
return F_124 ( V_285 , V_286 , 0400 ) ;
}
static int F_125 ( const char * V_273 , const char * V_34 )
{
char V_93 [ V_183 ] ;
F_111 ( V_93 , V_183 , L_36 , V_273 , V_34 ) ;
return F_52 ( V_93 ) ;
}
...
goto V_83;
while ( 1 ) {
V_289 = F_45 ( V_227 , V_287 , V_234 ) ;
if ( V_289 < 0 )
goto V_83;
if ( ! V_289 )
break;
V_231 = V_289 ;
if ( F_127 ( V_229 , V_288 , V_231 ) != ( int ) V_231 )
goto V_83;
if ( memcmp ( V_287 , V_288 , V_231 ) )
goto V_83;
}
V_59 = 0 ;
V_83:
...
static int F_128 ( const char * V_285 ,
const char * V_286 )
{
int V_227 , V_229 , V_59 = - 1 ;
V_227 = F_39 ( V_285 , V_95 ) ;
if ( V_227 < 0 )
return - 1 ;
V_229 = F_39 ( V_286 , V_95 ) ;
if ( V_229 < 0 )
goto V_290;
...
static int F_129 ( const char * V_283 , const char * V_284 ,
const char * V_34 )
{
char V_285 [ V_183 ] ;
char V_286 [ V_183 ] ;
F_111 ( V_285 , V_183 , L_36 , V_283 , V_34 ) ;
F_111 ( V_286 , V_183 , L_36 , V_284 , V_34 ) ;
return F_128 ( V_285 , V_286 ) ;
}
int F_130 ( const char * V_283 , const char * V_284 )
{
struct V_236 V_236 ;
struct V_236 V_291 ;
T_3 V_245 = 2 ;
int V_35 = 0 , V_59 = - 1 ;
T_22 V_180 = V_234 , V_92 , V_292 = 0 ;
struct V_266 V_267 = { . V_271 = 0 , } ;
char V_293 [ V_183 ] ;
char V_294 [ V_183 ] ;
if ( F_123 ( V_283 , V_284 , L_37 ) )
return - 1 ;
if ( F_123 ( V_283 , V_284 , L_38 ) )
goto V_295;
F_111 ( V_293 , V_183 , L_39 , V_283 ) ;
F_111 ( V_294 , V_183 , L_39 , V_284 ) ;
if ( F_97 ( & V_236 , V_293 ) )
goto V_296;
if ( F_120 ( & V_267 , V_283 , V_236 . V_4 ) )
goto V_297;
if ( F_98 ( & V_291 , V_294 , V_236 . V_238 , false ) )
goto V_297;
if ( ! V_267 . V_282 . V_27 )
V_245 -= 1 ;
if ( F_101 ( & V_236 , & V_291 , V_245 ) )
goto V_298;
if ( F_104 ( & V_291 , V_35 ++ , V_180 , V_267 . V_281 . V_27 ,
V_267 . V_281 . V_231 ) )
goto V_298;
if ( V_267 . V_282 . V_27 ) {
V_292 = V_180 + V_267 . V_281 . V_231 ;
if ( F_104 ( & V_291 , V_35 , V_292 ,
V_267 . V_282 . V_27 , V_267 . V_282 . V_231 ) )
goto V_298;
}
V_92 = F_106 ( & V_291 ) ;
if ( V_92 < 0 || V_92 > V_180 )
goto V_298;
if ( F_94 ( V_236 . V_94 , V_267 . V_281 . V_180 , V_291 . V_94 , V_180 ,
V_267 . V_281 . V_231 ) )
goto V_298;
if ( V_292 && F_94 ( V_236 . V_94 , V_267 . V_282 . V_180 ,
V_291 . V_94 , V_292 ,
V_267 . V_282 . V_231 ) )
goto V_298;
if ( F_129 ( V_283 , V_284 , L_38 ) )
goto V_298;
if ( F_129 ( V_283 , V_284 , L_37 ) )
goto V_298;
V_59 = 0 ;
V_298:
F_100 ( & V_291 ) ;
...
int F_131 ( struct V_299 * V_300 )
{
struct V_236 V_236 ;
struct V_236 V_291 ;
T_3 V_245 = 1 ;
int V_35 = 0 , V_59 = - 1 ;
T_22 V_180 = V_234 , V_92 ;
if ( F_97 ( & V_236 , V_300 -> V_293 ) )
return - 1 ;
strcpy ( V_300 -> V_294 , V_301 ) ;
if ( F_98 ( & V_291 , V_300 -> V_294 , V_236 . V_238 , true ) )
goto V_297;
if ( F_101 ( & V_236 , & V_291 , V_245 ) )
goto V_298;
if ( F_104 ( & V_291 , V_35 , V_180 , V_300 -> V_27 , V_300 -> V_231 ) )
goto V_298;
V_92 = F_106 ( & V_291 ) ;
if ( V_92 < 0 || V_92 > V_180 )
goto V_298;
if ( F_94 ( V_236 . V_94 , V_300 -> V_302 , V_291 . V_94 , V_180 , V_300 -> V_231 ) )
goto V_298;
V_59 = 0 ;
V_298:
F_100 ( & V_291 ) ;
