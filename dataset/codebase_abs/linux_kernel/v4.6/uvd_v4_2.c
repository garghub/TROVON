...
T_4 V_60 ;
T_1 V_77 ;
V_60 = ( V_4 -> V_10 . V_57 + V_78 ) >> 3 ;
V_77 = F_47 ( V_4 -> V_10 . V_79 -> V_77 + 4 ) >> 3 ;
F_5 ( V_80 , V_60 ) ;
F_5 ( V_81 , V_77 ) ;
V_60 += V_77 ;
V_77 = V_82 >> 3 ;
...
F_5 ( V_88 , ( V_60 << 12 ) | ( V_60 << 0 ) ) ;
V_60 = ( V_4 -> V_10 . V_57 >> 32 ) & 0xFF ;
F_5 ( V_56 , V_60 | ( 0x9 << 16 ) | ( 0x1 << 31 ) ) ;
F_5 ( V_89 , V_4 -> V_90 . V_91 . V_92 ) ;
F_5 ( V_93 , V_4 -> V_90 . V_91 . V_92 ) ;
F_5 ( V_94 , V_4 -> V_90 . V_91 . V_92 ) ;
F_48 ( V_4 ) ;
}
