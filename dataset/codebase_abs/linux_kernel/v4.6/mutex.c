...
static T_3 int T_1
F_87 ( struct V_11 * V_2 , struct V_13 * V_15 )
{
return F_50 ( & V_2 -> V_23 , V_51 , 0 ,
NULL , V_52 , V_15 , 1 ) ;
}
static T_3 int T_1
F_88 ( struct V_11 * V_2 ,
struct V_13 * V_15 )
{
return F_50 ( & V_2 -> V_23 , V_55 , 0 ,
NULL , V_52 , V_15 , 1 ) ;
}
static inline int F_89 ( T_5 * V_63 )
{
struct V_1 * V_2 = F_39 ( V_63 , struct V_1 , V_6 ) ;
unsigned long V_20 ;
int V_64 ;
...
int F_93 ( T_5 * V_65 , struct V_1 * V_2 )
{
if ( F_94 ( V_65 , - 1 , 1 ) )
return 0 ;
F_9 ( V_2 ) ;
