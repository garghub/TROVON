...
int F_81 ( struct V_3 * V_4 , unsigned int * V_149 , void * V_83 ,
bool V_143 )
{
struct V_1 * V_2 = NULL ;
int V_40 ;
V_40 = F_75 ( V_4 , & V_2 , V_83 , V_143 ) ;
if ( V_40 < 0 )
return V_40 ;
switch ( V_2 -> V_43 ) {
case V_114 :
...
static int F_89 ( struct V_3 * V_4 , unsigned long V_29 ,
...
int F_90 ( struct V_3 * V_4 , int * V_133 , unsigned int type ,
...
int F_92 ( struct V_3 * V_4 , struct V_158 * V_159 )
{
unsigned long V_29 = V_159 -> V_160 << V_161 ;
struct V_1 * V_2 ;
...
V_40 = F_89 ( V_4 , V_29 , & V_39 , & V_11 ) ;
if ( V_40 )
return V_40 ;
V_2 = V_4 -> V_31 [ V_39 ] ;
V_15 = F_2 ( V_2 -> V_14 [ V_11 ] . V_15 ) ;
if ( V_15 < ( V_159 -> V_166 - V_159 -> V_167 ) ) {
F_7 ( 1 ,
L_84 ) ;
return - V_89 ;
}
F_34 ( & V_4 -> V_100 ) ;
V_40 = F_24 ( V_2 , V_91 , V_2 -> V_14 [ V_11 ] . V_10 , V_159 ) ;
F_35 ( & V_4 -> V_100 ) ;
if ( V_40 )
return V_40 ;
...
unsigned long V_112 )
{
unsigned long V_29 = V_170 << V_161 ;
struct V_1 * V_2 ;
unsigned int V_39 , V_11 ;
void * V_109 ;
int V_40 ;
...
F_45 ( ! V_4 -> type ) ||
F_45 ( ! V_4 -> V_85 ) ||
F_45 ( ! V_4 -> V_171 -> V_101 ) ||
F_45 ( ! V_4 -> V_171 -> V_135 ) )
return - V_89 ;
F_22 ( & V_4 -> V_81 ) ;
F_22 ( & V_4 -> V_121 ) ;
F_95 ( & V_4 -> V_119 ) ;
...
unsigned int F_100 ( struct V_3 * V_4 , struct V_172 * V_172 ,
T_1 * V_173 )
{
unsigned long V_174 = F_101 ( V_173 ) ;
struct V_1 * V_2 = NULL ;
unsigned long V_112 ;
if ( ! V_4 -> V_7 && ! ( V_174 & ( V_175 | V_176 ) ) )
return 0 ;
if ( V_4 -> V_7 && ! ( V_174 & ( V_177 | V_178 ) ) )
return 0 ;
if ( V_4 -> V_36 == 0 && ! F_32 ( V_4 ) ) {
if ( ! V_4 -> V_7 && ( V_4 -> V_85 & V_179 ) &&
( V_174 & ( V_175 | V_176 ) ) ) {
if ( F_102 ( V_4 , 1 ) )
return V_180 ;
}
if ( V_4 -> V_7 && ( V_4 -> V_85 & V_181 ) &&
( V_174 & ( V_177 | V_178 ) ) ) {
if ( F_102 ( V_4 , 0 ) )
return V_180 ;
return V_177 | V_178 ;
...
return V_180 ;
if ( V_4 -> V_182 &&
V_4 -> V_103 && ( V_174 & ( V_175 | V_176 ) ) )
return V_180 ;
if ( V_4 -> V_7 && V_4 -> V_183 && V_4 -> V_141 < V_4 -> V_36 )
return V_177 | V_178 ;
if ( F_69 ( & V_4 -> V_121 ) ) {
if ( V_4 -> V_144 )
return V_175 | V_176 ;
F_104 ( V_172 , & V_4 -> V_124 , V_173 ) ;
}
F_46 ( & V_4 -> V_119 , V_112 ) ;
if ( ! F_69 ( & V_4 -> V_121 ) )
...
static int F_102 ( struct V_3 * V_4 , int V_184 )
{
struct V_185 * V_183 ;
int V_139 , V_40 ;
unsigned int V_97 = 0 ;
if ( F_45 ( ( V_184 && ! ( V_4 -> V_85 & V_179 ) ) ||
( ! V_184 && ! ( V_4 -> V_85 & V_181 ) ) ) )
return - V_89 ;
if ( ! V_4 -> V_87 -> V_109 )
return - V_96 ;
...
V_97 = 1 ;
F_7 ( 3 , L_86 ,
( V_184 ) ? L_87 : L_88 , V_97 , V_4 -> V_186 ,
V_4 -> V_187 ) ;
V_183 = F_14 ( sizeof( * V_183 ) , V_42 ) ;
if ( V_183 == NULL )
return - V_20 ;
V_183 -> V_188 = V_4 -> V_186 ;
V_183 -> V_189 = V_4 -> V_187 ;
V_183 -> V_97 = V_97 ;
V_183 -> V_35 = V_46 ;
V_183 -> type = V_4 -> type ;
V_4 -> V_183 = V_183 ;
V_40 = F_33 ( V_4 , V_183 -> V_35 , & V_183 -> V_97 ) ;
if ( V_40 )
goto V_190;
...
for ( V_139 = 0 ; V_139 < V_4 -> V_36 ; V_139 ++ ) {
V_183 -> V_31 [ V_139 ] . V_109 = F_42 ( V_4 -> V_31 [ V_139 ] , 0 ) ;
if ( V_183 -> V_31 [ V_139 ] . V_109 == NULL ) {
V_40 = - V_89 ;
goto V_191;
}
V_183 -> V_31 [ V_139 ] . V_13 = F_105 ( V_4 -> V_31 [ V_139 ] , 0 ) ;
}
if ( V_184 ) {
for ( V_139 = 0 ; V_139 < V_4 -> V_36 ; V_139 ++ ) {
...
if ( V_40 )
goto V_191;
V_183 -> V_31 [ V_139 ] . V_192 = 1 ;
}
V_183 -> V_193 = V_4 -> V_36 ;
V_183 -> V_194 = V_4 -> V_36 ;
}
...
V_191:
V_183 -> V_97 = 0 ;
F_33 ( V_4 , V_183 -> V_35 , & V_183 -> V_97 ) ;
V_190:
V_4 -> V_183 = NULL ;
F_15 ( V_183 ) ;
return V_40 ;
...
static T_2 F_106 ( struct V_3 * V_4 , char T_3 * V_195 , T_2 V_97 ,
T_4 * V_196 , int V_197 , int V_184 )
{
struct V_185 * V_183 ;
struct V_198 * V_199 ;
bool V_200 = V_4 -> V_200 ;
bool V_142 = ! V_184 && V_4 -> V_142 ;
unsigned V_21 ;
int V_40 ;
F_7 ( 3 , L_90 ,
V_184 ? L_87 : L_88 , ( long ) * V_196 , V_97 ,
V_197 ? L_91 : L_12 ) ;
if ( ! V_195 )
return - V_89 ;
if ( ! F_32 ( V_4 ) ) {
V_40 = F_102 ( V_4 , V_184 ) ;
F_7 ( 3 , L_92 , V_40 ) ;
if ( V_40 )
return V_40 ;
}
...
if ( V_21 >= V_4 -> V_36 ) {
struct V_1 * V_201 ;
V_40 = F_81 ( V_4 , & V_21 , NULL , V_197 ) ;
F_7 ( 5 , L_93 , V_40 ) ;
if ( V_40 )
return V_40 ;
V_183 -> V_202 += 1 ;
V_183 -> V_194 = V_21 ;
V_199 = & V_183 -> V_31 [ V_21 ] ;
V_201 = V_4 -> V_31 [ V_21 ] ;
V_199 -> V_203 = 0 ;
V_199 -> V_192 = 0 ;
V_199 -> V_13 = V_184 ? F_107 ( V_4 -> V_31 [ V_21 ] , 0 )
: F_105 ( V_4 -> V_31 [ V_21 ] , 0 ) ;
if ( V_200 && V_184 &&
V_201 -> V_14 [ 0 ] . V_131 < V_199 -> V_13 ) {
V_199 -> V_203 = V_201 -> V_14 [ 0 ] . V_131 ;
V_199 -> V_13 -= V_199 -> V_203 ;
}
} else {
V_199 = & V_183 -> V_31 [ V_21 ] ;
}
if ( V_199 -> V_203 + V_97 > V_199 -> V_13 ) {
V_97 = V_199 -> V_13 - V_199 -> V_203 ;
F_7 ( 5 , L_94 , V_97 ) ;
}
F_7 ( 3 , L_95 ,
V_97 , V_21 , V_199 -> V_203 ) ;
if ( V_184 )
V_40 = F_108 ( V_195 , V_199 -> V_109 + V_199 -> V_203 , V_97 ) ;
else
V_40 = F_109 ( V_199 -> V_109 + V_199 -> V_203 , V_195 , V_97 ) ;
if ( V_40 ) {
F_7 ( 3 , L_96 ) ;
return - V_204 ;
}
V_199 -> V_203 += V_97 ;
* V_196 += V_97 ;
if ( V_199 -> V_203 == V_199 -> V_13 || ( ! V_184 && V_183 -> V_189 ) ) {
struct V_1 * V_201 = V_4 -> V_31 [ V_21 ] ;
if ( V_184 && V_183 -> V_188 && V_183 -> V_202 == 1 ) {
F_7 ( 3 , L_97 ) ;
return F_99 ( V_4 ) ;
}
V_201 -> V_14 [ 0 ] . V_130 = V_199 -> V_203 ;
if ( V_142 )
V_201 -> V_205 = F_110 () ;
...
V_199 -> V_203 = 0 ;
V_199 -> V_192 = 1 ;
V_199 -> V_13 = F_105 ( V_4 -> V_31 [ V_21 ] , 0 ) ;
V_183 -> V_206 += 1 ;
if ( V_183 -> V_193 < V_4 -> V_36 )
V_183 -> V_193 ++ ;
V_183 -> V_194 = V_183 -> V_193 ;
}
if ( V_40 == 0 )
V_40 = V_97 ;
return V_40 ;
}
T_2 F_111 ( struct V_3 * V_4 , char T_3 * V_195 , T_2 V_97 ,
T_4 * V_196 , int V_143 )
{
return F_106 ( V_4 , V_195 , V_97 , V_196 , V_143 , 1 ) ;
}
T_2 F_112 ( struct V_3 * V_4 , const char T_3 * V_195 , T_2 V_97 ,
T_4 * V_196 , int V_143 )
{
return F_106 ( V_4 , ( char T_3 * ) V_195 , V_97 ,
V_196 , V_143 , 0 ) ;
}
static int F_113 ( void * V_195 )
{
struct V_3 * V_4 = V_195 ;
struct V_207 * V_208 = V_4 -> V_208 ;
bool V_142 = false ;
unsigned V_209 = 0 ;
unsigned V_21 = 0 ;
int V_40 = 0 ;
...
F_115 () ;
if ( V_2 -> V_43 != V_115 )
if ( V_208 -> V_211 ( V_2 , V_208 -> V_212 ) )
break;
F_73 ( V_4 , V_147 , V_4 ) ;
if ( V_142 )
V_2 -> V_205 = F_110 () ; ;
...
int F_119 ( struct V_3 * V_4 , T_5 V_211 , void * V_212 ,
const char * V_214 )
{
struct V_207 * V_208 ;
int V_40 = 0 ;
...
if ( F_45 ( V_4 -> V_183 ) )
return - V_96 ;
V_208 = F_14 ( sizeof( * V_208 ) , V_42 ) ;
if ( V_208 == NULL )
return - V_20 ;
V_208 -> V_211 = V_211 ;
V_208 -> V_212 = V_212 ;
V_40 = F_102 ( V_4 , ! V_4 -> V_7 ) ;
F_7 ( 3 , L_100 , V_40 ) ;
if ( V_40 )
goto V_215;
V_4 -> V_208 = V_208 ;
V_208 -> V_216 = F_121 ( F_113 , V_4 , L_101 , V_214 ) ;
if ( F_61 ( V_208 -> V_216 ) ) {
V_40 = F_58 ( V_208 -> V_216 ) ;
V_208 -> V_216 = NULL ;
goto V_217;
}
return 0 ;
