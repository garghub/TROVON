...
static int F_21 ( struct V_1 * V_2 , T_1 V_111 )
{
T_15 * V_13 ;
T_3 * V_6 ;
if ( V_2 -> V_78 == V_112 )
...
{
V_2 -> V_33 = V_116 ;
return F_21 ( V_2 , V_117 ) ;
}
int F_23 ( struct V_1 * V_2 )
{
V_2 -> V_33 = V_34 ;
return F_21 ( V_2 , V_118 ) ;
}
...
return;
V_2 -> V_78 = V_112 ;
while ( ( V_4 = F_25 ( V_2 , & V_9 ) ) )
F_26 ( V_2 , V_4 ) ;
}
void F_27 ( struct V_1 * V_2 , const T_2 * V_119 )
{
V_2 -> V_66 = V_119 ;
}
...
{
return F_31 ( & V_130 , 0 , 0 , V_131 ) ;
}
static inline void F_32 ( int V_132 )
{
F_33 ( & V_130 , V_132 ) ;
}
...
struct V_135 * V_136 ;
char V_137 [ 20 ] ;
sprintf ( V_137 , V_138 , V_11 ) ;
V_136 = F_38 ( V_137 , 0660 , NULL ,
& V_139 , V_2 ) ;
if ( ! V_136 ) {
F_39 ( V_2 ) ;
F_32 ( V_11 ) ;
...
if ( ! V_146 )
return;
V_147 = ( void * ) F_47 ( V_146 , sizeof( * V_147 ) ) ;
memset ( V_147 , 0 , sizeof *V_147 ) ;
V_147 -> V_81 = F_4 ( V_148 ) ;
V_147 -> V_76 = F_4 ( V_146 -> V_149 ) ;
V_147 -> V_150 = F_4 ( 36 ) ;
V_147 -> V_151 = F_4 ( V_146 -> V_149 - sizeof( * V_147 ) ) ;
}
void F_26 ( struct V_1 * V_2 , T_2 * V_4 )
{
T_3 * V_6 , * V_152 ;
...
T_2 * F_25 ( struct V_1 * V_2 , T_1 * V_9 )
{
T_3 * V_6 , * V_152 ;
if ( ! V_9 ) return NULL ;
F_48 (r, n, &params->resp_queue, list) {
...
{
T_3 * V_6 ;
V_6 = F_50 ( sizeof( T_3 ) + V_9 , V_155 ) ;
if ( ! V_6 ) return NULL ;
V_6 -> V_4 = ( T_2 * ) ( V_6 + 1 ) ;
V_6 -> V_9 = V_9 ;
V_6 -> V_154 = 0 ;
F_51 ( & V_6 -> V_153 , & V_2 -> V_143 ) ;
return V_6 ;
}
int F_52 ( struct V_156 * V_157 ,
struct V_145 * V_146 ,
struct V_158 * V_153 )
{
T_4 * V_122 = ( void * ) V_146 -> V_159 ;
if ( F_4 ( V_148 )
!= F_53 ( V_122 ++ ) ) {
F_54 ( V_146 ) ;
return - V_133 ;
...
V_122 ++ ;
if ( ! F_55 ( V_146 , F_3 ( V_122 ++ ) + 8 ) ) {
F_54 ( V_146 ) ;
return - V_160 ;
}
F_56 ( V_146 , F_3 ( V_122 ++ ) ) ;
F_57 ( V_153 , V_146 ) ;
return 0 ;
}
static int F_58 ( struct V_161 * V_162 , void * V_102 )
{
V_1 * V_163 = V_162 -> V_164 ;
F_59 (m,
L_50
L_51
L_52
...
static T_16 F_60 ( struct V_165 * V_165 , const char T_17 * V_166 ,
T_18 V_12 , T_19 * V_167 )
{
V_1 * V_168 = F_61 ( F_62 ( V_165 ) ) ;
T_1 V_35 = 0 ;
int V_11 , V_169 = 0 ;
for ( V_11 = 0 ; V_11 < V_12 ; V_11 ++ ) {
char V_170 ;
...
static int F_64 ( struct V_172 * V_172 , struct V_165 * V_165 )
{
return F_65 ( V_165 , F_58 , F_61 ( V_172 ) ) ;
}
