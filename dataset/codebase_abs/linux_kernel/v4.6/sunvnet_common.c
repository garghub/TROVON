...
V_170 = ( V_5 -> V_171 & V_174 ) ;
V_5 -> V_171 &= ~ ( V_172 | V_174 ) ;
if ( V_170 == V_174 )
goto V_173;
V_170 = V_5 -> V_171 ;
if ( ! ( V_170 & V_175 ) )
...
V_22 = F_90 ( V_12 -> V_13 , & V_155 , sizeof( V_155 ) ) ;
if ( F_24 ( V_22 < 0 ) ) {
if ( V_22 == - V_14 )
F_91 ( V_12 ) ;
break;
...
if ( V_155 . V_23 . V_10 == V_177 )
V_22 = F_78 ( V_5 , & V_155 ) ;
else
V_22 = F_93 ( V_12 , & V_155 ) ;
if ( V_22 )
break;
} else {
V_22 = F_3 ( V_5 , & V_155 ) ;
...
int F_94 ( struct V_178 * V_113 , int V_148 )
{
struct V_4 * V_5 = F_95 ( V_113 , struct V_4 , V_113 ) ;
struct V_15 * V_12 = & V_5 -> V_12 ;
int V_179 = F_86 ( V_5 , V_148 ) ;
if ( V_179 < V_148 ) {
F_96 ( V_113 ) ;
V_5 -> V_171 &= ~ V_175 ;
F_97 ( V_12 -> V_180 -> V_181 , V_182 ) ;
}
return V_179 ;
}
void F_98 ( void * V_6 , int V_170 )
{
struct V_4 * V_5 = V_6 ;
struct V_15 * V_12 = & V_5 -> V_12 ;
V_5 -> V_171 |= V_170 ;
F_97 ( V_12 -> V_180 -> V_181 , V_183 ) ;
F_99 ( & V_5 -> V_113 ) ;
}
...
static struct V_60 * F_102 ( struct V_4 * V_5 ,
unsigned * V_184 )
{
struct V_1 * V_2 = & V_5 -> V_12 . V_55 [ V_59 ] ;
...
if ( V_185 < 0 )
V_185 = V_3 - 1 ;
V_186 = F_72 ( V_2 , V_185 ) ;
if ( V_186 -> V_118 . V_125 == V_139 ) {
( * V_184 ) ++ ;
continue;
}
if ( V_5 -> V_187 [ V_185 ] . V_62 ) {
if ( V_186 -> V_118 . V_125 != V_146 )
F_103 ( L_21 ,
V_186 -> V_118 . V_125 ) ;
F_56 ( V_5 -> V_187 [ V_185 ] . V_62 -> V_188 ) ;
V_5 -> V_187 [ V_185 ] . V_62 -> V_188 = V_62 ;
V_62 = V_5 -> V_187 [ V_185 ] . V_62 ;
V_5 -> V_187 [ V_185 ] . V_62 = NULL ;
F_104 ( V_5 -> V_12 . V_13 ,
V_5 -> V_187 [ V_185 ] . V_97 ,
V_5 -> V_187 [ V_185 ] . V_98 ) ;
} else if ( V_186 -> V_118 . V_125 == V_189 ) {
break;
}
V_186 -> V_118 . V_125 = V_189 ;
}
return V_62 ;
}
static inline void F_105 ( struct V_60 * V_62 )
{
struct V_60 * V_188 ;
while ( V_62 ) {
V_188 = V_62 -> V_188 ;
...
void F_107 ( unsigned long V_190 )
{
struct V_4 * V_5 = (struct V_4 * ) V_190 ;
struct V_60 * V_191 ;
unsigned V_184 ;
F_69 ( F_8 ( V_5 ) ) ;
V_191 = F_102 ( V_5 , & V_184 ) ;
F_70 ( F_8 ( V_5 ) ) ;
F_105 ( V_191 ) ;
if ( V_184 )
( void ) F_108 ( & V_5 -> V_192 ,
V_193 + V_194 ) ;
else
F_109 ( & V_5 -> V_192 ) ;
}
static inline int F_110 ( struct V_195 * V_13 , struct V_60 * V_62 ,
struct V_196 * V_97 , int V_98 ,
unsigned int V_197 )
{
int V_21 , V_198 , V_22 , V_199 ;
V_199 = F_111 ( V_62 ) ;
if ( V_199 < V_90 )
V_199 = V_90 ;
V_199 += V_64 ;
V_199 += 8 - ( V_199 & 7 ) ;
V_22 = F_112 ( V_13 , V_62 -> V_65 - V_64 , V_199 , V_97 ,
V_98 , V_197 ) ;
if ( V_22 < 0 )
return V_22 ;
V_198 = V_22 ;
for ( V_21 = 0 ; V_21 < F_113 ( V_62 ) -> V_200 ; V_21 ++ ) {
T_3 * V_201 = & F_113 ( V_62 ) -> V_202 [ V_21 ] ;
T_2 * V_203 ;
if ( V_198 < V_98 ) {
V_203 = F_114 ( F_115 ( V_201 ) ) ;
V_199 = F_116 ( V_201 ) ;
V_199 += 8 - ( V_199 & 7 ) ;
V_22 = F_112 ( V_13 , V_203 + V_201 -> V_204 ,
V_199 , V_97 + V_198 , V_98 - V_198 ,
V_197 ) ;
F_117 ( V_203 ) ;
} else {
V_22 = - V_89 ;
...
static inline struct V_60 * F_118 ( struct V_60 * V_62 , int V_98 )
{
struct V_60 * V_205 ;
int V_21 , V_61 , V_206 , V_207 ;
V_61 = V_62 -> V_61 ;
V_206 = 0 ;
if ( V_61 < V_90 ) {
V_206 += V_90 - V_62 -> V_61 ;
V_61 += V_206 ;
}
V_61 += V_64 ;
V_206 += 8 - ( V_61 & 7 ) ;
V_207 = F_113 ( V_62 ) -> V_200 >= V_98 ;
for ( V_21 = 0 ; V_21 < F_113 ( V_62 ) -> V_200 ; V_21 ++ ) {
T_3 * V_201 = & F_113 ( V_62 ) -> V_202 [ V_21 ] ;
V_207 |= V_201 -> V_204 & 7 ;
}
...
F_119 ( V_62 ) < V_206 ||
F_120 ( V_62 ) < V_64 || V_207 ) {
int V_115 = 0 , V_68 ;
T_4 V_76 ;
V_61 = V_62 -> V_61 > V_90 ? V_62 -> V_61 : V_90 ;
V_205 = F_22 ( V_62 -> V_17 , V_61 ) ;
if ( ! V_205 ) {
F_106 ( V_62 ) ;
return NULL ;
}
F_25 ( V_205 , V_64 ) ;
V_205 -> V_69 = V_62 -> V_69 ;
V_68 = F_121 ( V_62 ) - V_62 -> V_65 ;
F_122 ( V_205 , V_68 ) ;
V_68 = F_123 ( V_62 ) - V_62 -> V_65 ;
F_124 ( V_205 , V_68 ) ;
V_68 = F_125 ( V_62 ) - V_62 -> V_65 ;
F_44 ( V_205 , V_68 ) ;
V_68 = 0 ;
V_205 -> V_208 = V_62 -> V_208 ;
V_205 -> V_73 = V_62 -> V_73 ;
if ( V_62 -> V_73 == V_108 )
V_115 = F_126 ( V_62 ) ;
if ( V_115 ) {
struct V_66 * V_67 = F_27 ( V_205 ) ;
int V_68 = V_115 + V_205 -> V_208 ;
if ( F_127 ( V_62 , 0 , V_205 -> V_65 , V_115 ) ) {
F_106 ( V_205 ) ;
F_106 ( V_62 ) ;
return NULL ;
}
* ( V_209 * ) ( V_62 -> V_65 + V_68 ) = 0 ;
V_76 = F_128 ( V_62 , V_115 ,
V_205 -> V_65 + V_115 ,
V_62 -> V_61 - V_115 , 0 ) ;
if ( V_67 -> V_69 == V_71 ||
V_67 -> V_69 == V_72 ) {
...
* ( V_209 * ) ( V_205 -> V_65 + V_68 ) = V_76 ;
V_205 -> V_73 = V_74 ;
} else if ( F_127 ( V_62 , 0 , V_205 -> V_65 , V_62 -> V_61 ) ) {
F_106 ( V_205 ) ;
F_106 ( V_62 ) ;
return NULL ;
}
( void ) F_35 ( V_205 , V_62 -> V_61 ) ;
if ( F_129 ( V_62 ) ) {
F_113 ( V_205 ) -> V_210 = F_113 ( V_62 ) -> V_210 ;
F_113 ( V_205 ) -> V_211 = F_113 ( V_62 ) -> V_211 ;
}
V_205 -> V_212 = V_62 -> V_212 ;
F_106 ( V_62 ) ;
V_62 = V_205 ;
}
return V_62 ;
}
void F_130 ( struct V_16 * V_17 )
{
}
int F_131 ( struct V_16 * V_17 )
{
F_132 ( V_17 ) ;
F_133 ( V_17 ) ;
return 0 ;
}
int F_134 ( struct V_16 * V_17 )
{
F_135 ( V_17 ) ;
F_136 ( V_17 ) ;
return 0 ;
}
static struct V_213 * F_137 ( struct V_166 * V_214 , T_2 * V_33 )
{
struct V_213 * V_215 ;
for ( V_215 = V_214 -> V_216 ; V_215 ; V_215 = V_215 -> V_188 ) {
if ( F_138 ( V_215 -> V_33 , V_33 ) )
return V_215 ;
}
return NULL ;
}
static void F_139 ( struct V_166 * V_214 , struct V_16 * V_17 )
{
struct V_217 * V_218 ;
F_140 (ha, dev) {
struct V_213 * V_215 ;
V_215 = F_137 ( V_214 , V_218 -> V_33 ) ;
if ( V_215 ) {
V_215 -> V_219 = 1 ;
continue;
}
if ( ! V_215 ) {
V_215 = F_141 ( sizeof( * V_215 ) , V_220 ) ;
if ( ! V_215 )
continue;
memcpy ( V_215 -> V_33 , V_218 -> V_33 , V_221 ) ;
V_215 -> V_219 = 1 ;
V_215 -> V_188 = V_214 -> V_216 ;
V_214 -> V_216 = V_215 ;
}
}
}
static void F_142 ( struct V_166 * V_214 , struct V_4 * V_5 )
{
struct V_164 V_222 ;
struct V_213 * V_215 , * * V_223 ;
int V_224 ;
memset ( & V_222 , 0 , sizeof( V_222 ) ) ;
V_222 . V_23 . type = V_24 ;
V_222 . V_23 . V_9 = V_25 ;
V_222 . V_23 . V_10 = V_177 ;
V_222 . V_23 . V_11 = F_10 ( & V_5 -> V_12 ) ;
V_222 . V_225 = 1 ;
V_224 = 0 ;
for ( V_215 = V_214 -> V_216 ; V_215 ; V_215 = V_215 -> V_188 ) {
if ( V_215 -> V_226 )
continue;
V_215 -> V_226 = 1 ;
memcpy ( & V_222 . V_227 [ V_224 * V_221 ] ,
V_215 -> V_33 , V_221 ) ;
if ( ++ V_224 == V_228 ) {
V_222 . V_229 = V_224 ;
( void ) F_16 ( & V_5 -> V_12 , & V_222 ,
sizeof( V_222 ) ) ;
V_224 = 0 ;
}
}
if ( V_224 ) {
V_222 . V_229 = V_224 ;
( void ) F_16 ( & V_5 -> V_12 , & V_222 , sizeof( V_222 ) ) ;
}
V_222 . V_225 = 0 ;
V_224 = 0 ;
V_223 = & V_214 -> V_216 ;
while ( ( V_215 = * V_223 ) != NULL ) {
if ( V_215 -> V_219 ) {
V_215 -> V_219 = 0 ;
V_223 = & V_215 -> V_188 ;
continue;
...
void F_144 ( struct V_16 * V_17 , struct V_166 * V_214 )
{
struct V_4 * V_5 ;
F_145 () ;
F_146 (port, &vp->port_list, list) {
if ( V_5 -> V_110 ) {
F_139 ( V_214 , V_17 ) ;
F_142 ( V_214 , V_5 ) ;
break;
...
int F_148 ( struct V_16 * V_17 , int V_230 )
{
if ( V_230 < 68 || V_230 > 65535 )
return - V_231 ;
V_17 -> V_38 = V_230 ;
return 0 ;
}
int F_149 ( struct V_16 * V_17 , void * V_232 )
{
return - V_231 ;
}
...
V_5 -> V_187 [ V_21 ] . V_98 ) ;
F_106 ( V_62 ) ;
V_5 -> V_187 [ V_21 ] . V_62 = NULL ;
V_186 -> V_118 . V_125 = V_189 ;
}
F_151 ( V_5 -> V_12 . V_13 , V_2 -> V_233 ,
( V_2 -> V_137 * V_2 -> V_234 ) ,
V_2 -> V_97 , V_2 -> V_98 ) ;
V_2 -> V_233 = NULL ;
V_2 -> V_137 = 0 ;
...
{
struct V_1 * V_2 ;
unsigned long V_61 , V_235 ;
int V_21 , V_22 , V_98 ;
void * V_236 ;
V_2 = & V_5 -> V_12 . V_55 [ V_59 ] ;
V_235 = sizeof( struct V_84 ) +
sizeof( struct V_196 ) * 2 ;
if ( F_14 ( & V_5 -> V_12 , 1 , 7 ) )
V_235 += sizeof( struct V_101 ) ;
V_61 = V_3 * V_235 ;
V_98 = V_237 ;
V_236 = F_152 ( V_5 -> V_12 . V_13 , V_61 ,
V_2 -> V_97 , & V_98 ,
( V_238 |
V_239 |
V_240 ) ) ;
...
void F_153 ( struct V_16 * V_17 , struct V_166 * V_214 )
{
struct V_4 * V_5 ;
unsigned long V_103 ;
F_154 ( & V_214 -> V_242 , V_103 ) ;
if ( ! F_155 ( & V_214 -> V_243 ) ) {
V_5 = F_156 ( V_214 -> V_243 . V_188 , struct V_4 , V_244 ) ;
F_99 ( & V_5 -> V_113 ) ;
}
F_157 ( & V_214 -> V_242 , V_103 ) ;
}
void F_158 ( struct V_4 * V_5 )
{
struct V_166 * V_214 = V_5 -> V_214 ;
int V_245 ;
V_245 = V_214 -> V_246 ++ ;
V_245 = V_245 & ( V_247 - 1 ) ;
V_5 -> V_163 = V_245 ;
