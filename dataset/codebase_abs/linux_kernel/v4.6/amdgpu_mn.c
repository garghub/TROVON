...
if ( V_22 )
goto V_41;
F_34 ( V_6 -> V_42 , & V_4 -> V_8 , ( unsigned long ) V_17 ) ;
V_35:
F_35 ( & V_17 -> V_34 ) ;
F_9 ( & V_6 -> V_13 ) ;
return V_4 ;
...
int F_36 ( struct V_10 * V_11 , unsigned long V_43 )
{
unsigned long V_21 = V_43 + F_37 ( V_11 ) - 1 ;
...
F_40 ( & V_45 ) ;
F_3 ( & V_4 -> V_14 ) ;
while ( ( V_31 = F_24 ( & V_4 -> V_32 , V_43 , V_21 ) ) ) {
F_8 ( V_8 ) ;
V_8 = F_2 ( V_31 , struct V_7 , V_31 ) ;
F_41 ( & V_8 -> V_31 , & V_4 -> V_32 ) ;
V_43 = F_42 ( V_31 -> V_20 , V_43 ) ;
V_21 = F_43 ( V_31 -> V_46 , V_21 ) ;
F_44 ( & V_8 -> V_45 , & V_45 ) ;
}
if ( ! V_8 ) {
