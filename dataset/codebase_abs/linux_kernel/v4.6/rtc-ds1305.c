...
int V_23 ;
T_1 V_20 , V_92 ;
struct V_93 * V_94 = F_39 ( & V_18 -> V_7 ) ;
bool V_95 = false ;
if ( ( V_18 -> V_96 && V_18 -> V_96 != 8 )
|| ( V_18 -> V_97 > 2000000 )
|| ! ( V_18 -> V_98 & V_99 ) )
return - V_12 ;
V_9 = F_40 ( & V_18 -> V_7 , sizeof( * V_9 ) , V_100 ) ;
if ( ! V_9 )
return - V_101 ;
V_9 -> V_18 = V_18 ;
F_41 ( V_18 , V_9 ) ;
...
if ( V_18 -> V_69 ) {
F_46 ( & V_9 -> V_61 , F_19 ) ;
V_23 = F_47 ( & V_18 -> V_7 , V_18 -> V_69 , F_26 ,
0 , F_48 ( & V_9 -> V_64 -> V_7 ) , V_9 ) ;
if ( V_23 < 0 ) {
F_36 ( & V_18 -> V_7 , L_29 ,
V_18 -> V_69 , V_23 ) ;
} else {
...
F_53 ( & V_18 -> V_7 . V_87 , & V_111 ) ;
if ( V_18 -> V_69 ) {
F_54 ( V_67 , & V_9 -> V_68 ) ;
F_55 ( & V_18 -> V_7 , V_18 -> V_69 , V_9 ) ;
F_56 ( & V_9 -> V_61 ) ;
}
return 0 ;
}
