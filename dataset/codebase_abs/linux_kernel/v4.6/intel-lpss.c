...
if ( ! V_4 -> V_43 -> V_59 )
return 0 ;
V_53 = F_35 ( NULL , F_7 ( V_4 -> V_12 ) , NULL ,
V_60 , V_4 -> V_43 -> V_59 ) ;
if ( F_8 ( V_53 ) )
return F_9 ( V_53 ) ;
snprintf ( V_55 , sizeof( V_55 ) , L_8 , V_29 -> V_1 , V_4 -> V_61 ) ;
if ( V_4 -> type != V_32 ) {
...
V_58 = - V_40 ;
V_4 -> clock = F_36 ( V_53 , V_4 -> V_43 -> V_63 , L_1 , V_55 ) ;
if ( ! V_4 -> clock )
goto V_62;
V_4 -> V_53 = V_53 ;
return 0 ;
...
const struct V_64 * V_43 )
{
struct V_3 * V_4 ;
int V_58 ;
if ( ! V_43 || ! V_43 -> V_44 || V_43 -> V_65 <= 0 )
return - V_66 ;
V_4 = F_41 ( V_12 , sizeof( * V_4 ) , V_39 ) ;
if ( ! V_4 )
return - V_40 ;
V_4 -> V_6 = F_42 ( V_12 , V_43 -> V_44 -> V_45 + V_67 ,
V_68 ) ;
if ( ! V_4 -> V_6 )
return - V_40 ;
V_4 -> V_43 = V_43 ;
...
if ( V_58 )
return V_58 ;
V_4 -> V_29 -> V_70 = V_43 -> V_70 ;
F_26 ( V_4 ) ;
V_4 -> V_61 = F_44 ( & V_71 , 0 , 0 , V_39 ) ;
if ( V_4 -> V_61 < 0 )
return V_4 -> V_61 ;
V_58 = F_34 ( V_4 ) ;
if ( V_58 )
...
if ( F_22 ( V_4 ) ) {
F_1 ( V_72 ) ;
V_58 = F_46 ( V_12 , V_4 -> V_61 , & V_73 ,
1 , V_43 -> V_44 , V_43 -> V_65 , NULL ) ;
if ( V_58 )
F_45 ( V_12 , L_10 ,
V_72 ) ;
}
V_58 = F_46 ( V_12 , V_4 -> V_61 , V_4 -> V_29 ,
1 , V_43 -> V_44 , V_43 -> V_65 , NULL ) ;
if ( V_58 )
goto V_74;
return 0 ;
...
static int F_50 ( struct V_17 * V_12 , void * V_75 )
{
F_51 ( V_12 ) ;
return 0 ;
}
