...
{
struct V_300 * V_76 ;
struct V_301 * V_302 = (struct V_301 * ) & V_165 -> V_303 ;
...
struct V_75 * V_82 ;
int V_188 = 0 ;
struct V_301 * V_304 = (struct V_301 * ) & V_165 -> V_305 ;
struct V_301 * V_302 = (struct V_301 * ) & V_165 -> V_303 ;
if ( V_165 -> V_303 . V_306 != V_261 ) {
V_188 = - V_307 ;
goto V_210;
}
if ( F_151 ( V_165 ) ) {
...
V_2 -> V_5 . V_168 , V_165 ) ;
V_2 -> V_116 = F_155 ( V_292 -> V_21 . V_308 , & V_156 , V_2 ) ;
if ( V_2 -> V_116 == - 1 ) {
F_63 (KERN_ERR MOD L_61 , __func__) ;
V_188 = - V_35 ;
goto V_309;
}
V_82 = F_57 ( V_292 -> V_21 . V_308 , V_304 -> V_120 . V_121 ,
V_302 -> V_120 . V_121 , V_304 -> V_118 ,
V_302 -> V_118 , V_310 ) ;
if ( ! V_82 ) {
...
F_36 ( & V_2 -> V_5 , V_259 ) ;
V_2 -> V_81 = V_310 ;
memcpy ( & V_2 -> V_5 . V_117 , & V_165 -> V_305 ,
sizeof( V_2 -> V_5 . V_117 ) ) ;
memcpy ( & V_2 -> V_5 . V_119 , & V_165 -> V_303 ,
sizeof( V_2 -> V_5 . V_119 ) ) ;
V_188 = F_69 ( V_2 ) ;
if ( ! V_188 )
goto V_210;
F_47 ( V_292 -> V_21 . V_308 , V_2 -> V_62 ) ;
V_312:
F_46 ( V_2 -> V_61 ) ;
V_311:
F_101 ( V_2 -> V_5 . V_15 , V_2 -> V_116 ) ;
...
int F_156 ( struct V_287 * V_165 , int V_313 )
{
int V_188 = 0 ;
struct V_291 * V_292 = F_148 ( V_165 -> V_293 ) ;
struct V_227 * V_2 ;
F_157 () ;
if ( V_165 -> V_305 . V_306 != V_261 ) {
V_188 = - V_307 ;
goto V_314;
}
V_2 = F_37 ( sizeof( * V_2 ) , V_27 ) ;
...
memcpy ( & V_2 -> V_5 . V_117 , & V_165 -> V_305 ,
sizeof( V_2 -> V_5 . V_117 ) ) ;
V_2 -> V_230 = F_158 ( V_292 -> V_21 . V_308 , & V_156 , V_2 ) ;
if ( V_2 -> V_230 == - 1 ) {
F_63 (KERN_ERR MOD L_61 , __func__) ;
V_188 = - V_35 ;
goto V_309;
...
int F_163 ( void * V_153 , struct V_248 * V_320 , struct V_248 * V_54 ,
struct V_18 * V_62 )
{
struct V_1 * V_2 = V_153 ;
if ( V_2 -> V_61 != V_320 )
...
V_273 = V_325 [ F_167 ( F_99 ( ( V_326 T_4 ) V_17 -> V_327 ) ) ] ( V_15 , V_17 , V_2 ) ;
if ( V_273 & V_217 )
F_12 ( V_17 ) ;
F_9 ( (struct V_50 * ) V_2 ) ;
}
