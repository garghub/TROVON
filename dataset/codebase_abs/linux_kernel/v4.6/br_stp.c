...
static void F_29 ( struct V_20 * V_16 )
{
struct V_1 * V_2 ;
F_14 (p, &br->port_list, list) {
if ( V_2 -> V_3 != V_24 &&
...
static void F_32 ( struct V_20 * V_16 )
{
V_16 -> V_61 = 0 ;
F_17 ( & V_16 -> V_44 ) ;
}
...
int F_44 ( struct V_20 * V_16 , unsigned long V_71 )
{
unsigned long V_23 = F_45 ( V_71 ) ;
...
int F_48 ( struct V_20 * V_16 , unsigned long V_71 )
{
unsigned long V_23 = F_45 ( V_71 ) ;
...
int F_49 ( struct V_20 * V_16 , T_2 V_78 )
{
struct V_4 V_5 = {
. V_6 = V_16 -> V_7 ,
. V_8 = V_79 ,
...
unsigned long V_23 = F_45 ( V_78 ) ;
int V_14 ;
V_14 = F_2 ( V_16 -> V_7 , & V_5 ) ;
if ( V_14 && V_14 != - V_15 )
return V_14 ;
V_16 -> V_78 = V_23 ;
F_12 ( & V_16 -> V_81 , V_36 ) ;
...
void F_50 ( struct V_20 * V_16 , unsigned long V_23 )
{
V_16 -> V_43 = V_23 ;
if ( F_21 ( V_16 ) )
V_16 -> V_34 = V_16 -> V_43 ;
}
int F_51 ( struct V_20 * V_16 , unsigned long V_71 )
{
unsigned long V_23 = F_45 ( V_71 ) ;
int V_14 = - V_74 ;
F_46 ( & V_16 -> V_75 ) ;
