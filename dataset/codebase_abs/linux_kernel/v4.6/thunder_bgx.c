...
static int F_41 ( struct V_168 * V_74 , struct V_170 * V_171 ,
T_2 * V_172 )
{
T_2 V_29 [ V_173 ] ;
int V_174 ;
...
if ( F_46 ( V_177 , & V_171 ) )
goto V_175;
F_41 ( V_74 , V_171 , V_1 -> V_2 [ V_1 -> V_19 ] . V_29 ) ;
...
V_194 = F_60 ( V_13 , L_27 , 0 ) ;
if ( V_194 &&
! F_61 ( V_194 , L_28 ) ) {
V_193 = F_62 ( V_194 ) ;
if ( ! V_193 )
goto V_195;
V_1 -> V_2 [ V_2 ] . V_52 = V_193 ;
}
V_2 ++ ;
if ( V_2 == V_196 ) {
F_63 ( V_13 ) ;
...
while ( V_2 ) {
if ( V_1 -> V_2 [ V_2 ] . V_52 ) {
F_64 ( & V_1 -> V_2 [ V_2 ] . V_52 -> V_197 . V_74 ) ;
...
static int F_66 ( struct V_200 * V_73 , const struct V_201 * V_202 )
{
int V_203 ;
struct V_168 * V_74 = & V_73 -> V_74 ;
struct V_1 * V_1 = NULL ;
T_2 V_2 ;
V_1 = F_67 ( V_74 , sizeof( * V_1 ) , V_204 ) ;
if ( ! V_1 )
return - V_144 ;
V_1 -> V_73 = V_73 ;
F_68 ( V_73 , V_1 ) ;
...
V_203 = F_70 ( V_73 , V_205 ) ;
if ( V_203 ) {
F_24 ( V_74 , L_30 , V_203 ) ;
goto V_206;
}
V_1 -> V_5 = F_71 ( V_73 , V_207 , 0 ) ;
if ( ! V_1 -> V_5 ) {
F_24 ( V_74 , L_31 ) ;
V_203 = - V_144 ;
goto V_208;
}
V_1 -> V_160 = ( F_72 ( V_73 , V_207 ) >> 24 ) & 1 ;
V_1 -> V_160 += F_73 ( V_73 ) * V_16 ;
V_17 [ V_1 -> V_160 ] = V_1 ;
F_39 ( V_1 ) ;
V_203 = F_65 ( V_1 ) ;
if ( V_203 )
...
static void F_76 ( struct V_200 * V_73 )
{
