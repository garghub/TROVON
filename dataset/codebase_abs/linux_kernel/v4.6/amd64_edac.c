...
{
V_9 -> V_12 = F_60 ( V_9 -> V_17 -> V_132 , V_257 , V_9 -> V_17 ) ;
if ( ! V_9 -> V_12 ) {
F_118 ( L_77
L_78 ,
V_259 , V_257 ) ;
...
V_9 -> V_25 = F_60 ( V_9 -> V_17 -> V_132 , V_258 , V_9 -> V_17 ) ;
if ( ! V_9 -> V_25 ) {
F_69 ( V_9 -> V_12 ) ;
V_9 -> V_12 = NULL ;
F_118 ( L_79
...
static int F_142 ( struct V_1 * V_17 )
{
struct V_8 * V_9 = NULL ;
struct V_320 * V_335 = NULL ;
...
T_4 V_34 = F_143 ( V_17 ) ;
V_64 = - V_350 ;
V_9 = F_144 ( sizeof( struct V_8 ) , V_297 ) ;
if ( ! V_9 )
goto V_351;
V_9 -> V_57 = V_34 ;
V_9 -> V_17 = V_17 ;
...
V_349 [ 1 ] . V_356 = 2 ;
V_349 [ 1 ] . V_357 = false ;
V_28 = F_145 ( V_34 , F_13 ( V_349 ) , V_349 , 0 ) ;
if ( ! V_28 )
goto V_354;
V_28 -> V_30 = V_9 ;
V_28 -> V_2 = & V_9 -> V_17 -> V_135 ;
F_140 ( V_28 , V_335 ) ;
if ( F_124 ( V_28 ) )
V_28 -> V_74 = V_75 ;
V_64 = - V_260 ;
...
V_64 = - V_350 ;
V_238 = F_144 ( sizeof( struct V_305 ) , V_297 ) ;
if ( ! V_238 )
goto V_366;
V_367 [ V_34 ] = V_238 ;
if ( ! F_138 ( V_25 , V_34 ) ) {
...
T_4 V_34 = F_143 ( V_2 ) ;
struct V_1 * V_25 = F_66 ( V_34 ) -> V_156 ;
struct V_305 * V_238 = V_367 [ V_34 ] ;
V_28 = F_155 ( & V_2 -> V_135 ) ;
F_68 ( ! V_28 ) ;
V_28 = F_156 ( & V_2 -> V_135 ) ;
if ( ! V_28 )
return;
V_9 = V_28 -> V_30 ;
F_137 ( V_238 , V_34 , V_25 ) ;
...
return;
V_9 = V_28 -> V_30 ;
V_370 = F_159 ( & V_9 -> V_17 -> V_135 , V_327 ) ;
if ( ! V_370 ) {
F_160 ( L_122 , V_42 ) ;
F_160 ( L_123 , V_42 ) ;
}
...
{
int V_6 = - V_260 ;
F_162 ( V_371 L_124 , V_329 ) ;
F_163 () ;
if ( F_164 () < 0 )
goto V_351;
V_6 = - V_350 ;
V_367 = F_144 ( F_165 () * sizeof( V_367 [ 0 ] ) , V_297 ) ;
if ( ! V_367 )
goto V_352;
V_299 = F_166 () ;
if ( ! V_299 )
