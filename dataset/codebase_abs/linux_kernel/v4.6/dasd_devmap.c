...
if ( strncmp ( L_9 , V_31 , V_34 ) == 0 ) {
V_35 = 1 ;
F_9 ( L_10 ) ;
return V_33 ;
}
if ( strncmp ( L_11 , V_31 , V_34 ) == 0 ) {
V_36 = 1 ;
F_9 ( L_12 ) ;
return V_33 ;
}
if ( strncmp ( L_13 , V_31 , V_34 ) == 0 ) {
if ( V_37 )
F_9 ( L_14 ) ;
else {
V_38 = 1 ;
...
if ( strncmp ( L_16 , V_31 , V_34 ) == 0 ) {
V_39 = 1 ;
F_9 ( L_17
L_18 ) ;
return V_33 ;
}
if ( strncmp ( L_19 , V_31 , V_34 ) == 0 ) {
if ( V_40 )
return V_33 ;
V_40 =
F_10 ( L_20 , V_41 ,
...
V_82 = ( V_25 & V_30 ) != 0 ;
return snprintf ( V_81 , V_41 , V_82 ? L_29 : L_30 ) ;
}
...
V_83 = ( V_25 & V_26 ) != 0 ;
return snprintf ( V_81 , V_41 , V_83 ? L_29 : L_30 ) ;
}
static T_2
...
V_86 = ( V_25 & V_29 ) != 0 ;
return snprintf ( V_81 , V_41 , V_86 ? L_29 : L_30 ) ;
}
static T_2
...
V_87 = ( V_25 & V_27 ) != 0 ;
return sprintf ( V_81 , V_87 ? L_29 : L_30 ) ;
}
static T_2
...
V_89 = ( V_25 & V_28 ) != 0 ;
return sprintf ( V_81 , V_89 ? L_29 : L_30 ) ;
}
static T_2
...
V_108 = L_41 ;
if ( F_15 ( V_62 ) )
return snprintf ( V_81 , V_41 , L_31 , V_108 ) ;
if ( V_62 -> V_94 && V_62 -> V_94 -> V_105 &&
! V_62 -> V_94 -> V_105 ( V_62 , & V_104 ) )
V_108 = V_104 . V_108 ;
F_45 ( V_62 ) ;
...
V_109 [ 0 ] = 0 ;
if ( F_15 ( V_62 ) )
return snprintf ( V_81 , V_41 , L_31 , V_109 ) ;
if ( V_62 -> V_94 && V_62 -> V_94 -> V_105 &&
! V_62 -> V_94 -> V_105 ( V_62 , & V_104 ) ) {
switch ( V_104 . type ) {
case V_112 :
snprintf ( V_111 , sizeof( V_111 ) , L_42 ,
V_104 . V_113 ) ;
break;
case V_106 :
snprintf ( V_111 , sizeof( V_111 ) , L_42 ,
...
V_117 = 0 ;
return snprintf ( V_81 , V_41 , V_117 ? L_29 : L_30 ) ;
}
static T_2
...
if ( F_15 ( V_62 ) )
return - V_65 ;
V_23 = snprintf ( V_81 , V_41 , L_46 , V_62 -> V_118 ) ;
F_45 ( V_62 ) ;
return V_23 ;
}
static T_2
...
if ( F_15 ( V_62 ) )
return - V_65 ;
V_23 = snprintf ( V_81 , V_41 , L_46 , V_62 -> V_120 ) ;
F_45 ( V_62 ) ;
return V_23 ;
}
static T_2
...
if ( F_15 ( V_62 ) )
return - V_65 ;
V_23 = snprintf ( V_81 , V_41 , L_46 , V_62 -> V_122 ) ;
F_45 ( V_62 ) ;
return V_23 ;
}
static T_2
...
V_62 = F_54 ( F_59 ( V_71 ) ) ;
if ( F_15 ( V_62 ) )
return snprintf ( V_81 , V_41 , L_32 ) ;
if ( F_62 ( V_130 , & V_62 -> V_72 ) )
V_24 = snprintf ( V_81 , V_41 , L_51 ) ;
else if ( F_62 ( V_131 , & V_62 -> V_72 ) )
V_24 = snprintf ( V_81 , V_41 , L_52 ) ;
else
V_24 = snprintf ( V_81 , V_41 , L_32 ) ;
F_45 ( V_62 ) ;
return V_24 ;
}
...
static T_2 F_98 ( struct V_62 * V_71 ,
struct V_79 * V_80 , char * V_81 )
{
struct V_68 * V_62 ;
T_4 V_132 , V_133 , V_134 , V_135 , V_136 ;
V_62 = F_54 ( F_59 ( V_71 ) ) ;
if ( F_15 ( V_62 ) )
return sprintf ( V_81 , L_30 ) ;
V_132 = V_62 -> V_137 . V_132 ;
V_133 = V_62 -> V_137 . V_138 ;
V_134 = V_62 -> V_137 . V_134 ;
V_135 = V_62 -> V_137 . V_135 ;
V_136 = V_62 -> V_137 . V_136 ;
F_45 ( V_62 ) ;
return sprintf ( V_81 , L_54 , V_132 , V_133 ,
V_134 , V_135 , V_136 ) ;
}
int
F_99 ( struct V_69 * V_70 , int V_139 )
{
struct V_45 * V_46 ;
V_46 = F_25 ( F_34 ( & V_70 -> V_71 ) ) ;
if ( F_15 ( V_46 ) )
return F_18 ( V_46 ) ;
return ( ( V_46 -> V_22 & V_139 ) != 0 ) ;
}
int
F_100 ( struct V_69 * V_70 , int V_139 , int V_140 )
{
struct V_45 * V_46 ;
V_46 = F_25 ( F_34 ( & V_70 -> V_71 ) ) ;
if ( F_15 ( V_46 ) )
...
int
F_101 ( struct V_69 * V_70 )
{
return F_102 ( & V_70 -> V_71 . V_141 , & V_142 ) ;
}
void
F_103 ( struct V_69 * V_70 )
{
F_104 ( & V_70 -> V_71 . V_141 , & V_142 ) ;
}
int
F_105 ( void )
{
