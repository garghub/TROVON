...
static void T_5 F_48 ( struct V_91 * V_92 , void T_7 * V_64 )
{
int V_93 , V_68 ;
struct V_59 * V_60 = F_47 ( & V_88 ) ;
struct V_94 * V_95 , * V_96 ;
V_96 = V_92 ? F_49 ( V_92 , L_5 ) :
F_50 ( NULL , L_5 ) ;
if ( F_51 ( V_96 ) )
F_6 ( L_6 , V_97 ) ;
V_33 = F_52 ( V_96 ) ;
V_95 = V_92 ? F_49 ( V_92 , L_7 ) : F_50 ( NULL , L_7 ) ;
if ( F_51 ( V_95 ) )
F_6 ( L_8 , V_97 ) ;
F_53 ( V_95 ) ;
V_6 = V_64 ;
...
static void T_5 F_63 ( struct V_91 * V_92 , unsigned int V_106 )
{
T_1 V_107 , V_5 ;
V_78 = V_106 ;
V_56 [ V_57 ] = F_64 ( V_92 , V_57 ) ;
#ifdef F_65
V_107 = F_66 ( V_92 ) ;
#else
V_107 = 0 ;
#endif
for ( V_5 = V_81 ; V_5 < V_107 ; V_5 ++ )
V_56 [ V_5 ] = F_64 ( V_92 , V_5 ) ;
F_48 ( V_92 , F_67 ( V_92 , 0 ) ) ;
F_15 () ;
F_25 () ;
}
static void T_5 F_68 ( struct V_91 * V_92 )
{
return F_63 ( V_92 , V_79 ) ;
}
static void T_5 F_69 ( struct V_91 * V_92 )
{
return F_63 ( V_92 , V_98 ) ;
}
