...
static int F_170 ( struct V_194 * V_36 , T_2 V_284 , T_9 V_278 ,
struct V_285 * V_286 )
{
int V_13 ;
F_171 () ;
...
return - V_62 ;
if ( ( V_36 -> V_288 <= 1 ) ||
( V_36 -> V_288 < V_286 -> V_286 ) )
return - V_62 ;
if ( V_286 -> V_286 ) {
F_172 ( V_36 , V_286 -> V_286 ) ;
for ( V_13 = 0 ; V_13 < V_286 -> V_286 ; V_13 ++ )
...
V_28 -> V_30 = V_30 ;
V_28 -> V_94 = & V_30 -> V_36 ;
V_28 -> V_303 = F_179 ( V_304 , V_305 ) ;
V_28 -> V_202 = V_306 ;
V_28 -> V_157 = V_28 -> V_202 ;
V_28 -> V_56 = V_56 ;
V_29 = F_180 ( V_56 , L_63 , & V_19 ) ;
if ( V_19 ) {
if ( F_181 ( V_25 , V_307 , & V_291 ) ) {
F_20 ( V_36 , L_64 ) ;
V_29 = - V_61 ;
goto V_308;
}
V_289 = F_182 ( & V_291 ) ;
if ( ! F_183 ( V_36 , V_291 . V_309 , V_289 ,
F_128 ( V_36 ) ) ) {
F_20 ( V_36 , L_65 ) ;
V_29 = - V_47 ;
goto V_308;
}
V_292 = F_184 ( V_36 , V_291 . V_309 , V_289 ) ;
if ( ! V_292 ) {
F_20 ( V_36 , L_66 ) ;
F_185 ( V_36 , V_291 . V_309 , V_289 ) ;
V_29 = - V_47 ;
goto V_308;
}
F_12 ( V_294 , V_292 , V_19 ) ;
if ( F_186 ( V_294 ) )
F_136 ( V_30 -> V_310 , V_294 ) ;
else
F_187 ( V_30 -> V_310 ) ;
F_188 ( V_36 , V_292 ) ;
F_185 ( V_36 , V_291 . V_309 , V_289 ) ;
...
F_191 ( V_30 , & V_28 -> V_149 , F_94 , V_312 ) ;
F_192 ( V_30 , & V_28 -> V_161 , F_107 , V_312 ) ;
V_30 -> V_313 = 0 ;
V_30 -> V_314 = V_315 ;
V_30 -> V_316 = & V_317 ;
F_193 ( V_30 , V_36 ) ;
F_25 ( & V_28 -> V_318 , & V_32 -> V_319 ) ;
return 0 ;
V_308:
F_194 ( V_30 ) ;
return V_29 ;
...
static int F_199 ( struct V_320 * V_321 )
{
struct V_24 * V_25 = V_321 -> V_36 . V_39 ;
struct V_27 * V_27 , * V_69 ;
struct V_24 * V_40 , * V_322 ;
struct V_32 * V_32 ;
struct V_35 * V_36 = & V_321 -> V_36 ;
int V_29 ;
if ( ! V_25 ) {
F_20 ( V_36 , L_83 ) ;
return - V_61 ;
...
static int F_205 ( struct V_320 * V_321 )
{
struct V_32 * V_32 = F_206 ( V_321 ) ;
struct V_27 * V_27 , * V_69 ;
...
inst_list) {
V_34 = V_42 -> V_33 ;
F_31 ( & V_321 -> V_36 , L_88 , V_34 -> V_26 ) ;
