...
struct V_1 * V_2 = V_89 -> V_90 ;
F_2 ( L_12 , V_17 ) ;
if ( V_89 -> V_101 . V_102 . V_103 ) {
V_89 -> V_101 . V_102 . V_103 ( V_89 ) ;
if ( V_89 -> V_101 . V_104 )
V_89 -> V_101 . V_104 ( V_89 , 0 ) ;
}
F_19 ( V_2 ) ;
F_6 ( 10 ) ;
V_99 -> V_105 = 8000000 ;
...
static int F_33 ( struct V_1 * V_2 , T_5 * signal )
{
T_5 V_128 ;
T_1 V_129 [ 2 ] , V_130 ;
F_2 ( L_21 , V_17 ) ;
F_4 ( V_2 , 0x3F , & V_129 [ 0 ] ) ;
F_4 ( V_2 , 0x3E , & V_129 [ 1 ] ) ;
V_128 = V_129 [ 0 ] ;
V_128 <<= 8 ;
V_128 |= V_129 [ 1 ] ;
F_2 ( L_22 , V_128 ) ;
...
V_130 = 0 ;
* signal = V_130 * 65535 / 5 ;
return 0 ;
}
static int F_34 ( struct V_1 * V_2 , T_5 * signal )
{
T_1 V_28 ; T_4 V_5 ;
T_6 V_131 = 0 ;
T_1 V_132 ;
T_5 V_29 , V_50 = V_2 -> V_69 ;
F_2 ( L_12 , V_17 ) ;
V_5 = F_4 ( V_2 , 0x4B , & V_28 ) ;
if ( V_5 != 0 )
return - V_95 ;
...
static int F_35 ( struct V_1 * V_2 , T_5 * signal )
{
T_1 V_28 ;
T_6 V_128 = 0 ;
F_2 ( L_12 , V_17 ) ;
...
static int F_36 ( struct V_88 * V_89 , T_5 * signal )
{
struct V_1 * V_2 = V_89 -> V_90 ;
if ( V_2 -> V_12 -> V_14 == V_43 )
...
return F_33 ( V_2 , signal ) ;
}
static int F_37 ( struct V_88 * V_89 , T_5 * V_134 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
T_1 V_28 ;
* V_134 = 0 ;
...
static int F_38 ( struct V_88 * V_89 , T_2 * V_135 )
{
* V_135 = 0 ;
F_2 ( L_29 , V_17 , * V_135 ) ;
return 0 ;
...
static int F_41 ( struct V_88 * V_89 , T_2 * V_137 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
T_1 V_138 , V_139 , V_28 ;
T_2 V_140 = 0 , V_141 = 0 ;
int V_29 ;
F_2 ( L_12 , V_17 ) ;
F_39 ( V_2 ) ;
...
F_40 ( V_2 ) ;
if ( V_2 -> V_12 -> V_14 == V_15 ) {
V_139 = 0x28 ; V_138 = 0x2C ;
} else {
V_139 = 0xD0 ; V_138 = 0xD4 ;
}
for ( V_29 = 0 ; V_29 < 4 ; V_29 ++ ) {
V_140 <<= 8 ;
...
for ( V_29 = 0 ; V_29 < 4 ; V_29 ++ ) {
V_141 <<= 8 ;
F_4 ( V_2 , V_138 + 3 - V_29 , & V_28 ) ;
V_141 |= V_28 ;
}
F_2 ( L_30 , V_141 , V_140 ) ;
if ( V_140 == 0 )
* V_137 = 0 ;
else
* V_137 = V_141 * 100 / V_140 ;
F_2 ( L_31 , V_17 , * V_137 ) ;
return 0 ;
}
static int F_42 ( struct V_88 * V_89 , int V_142 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
if ( V_2 -> V_12 -> V_143 == 0 )
return 0 ;
if ( V_142 ) {
T_1 V_128 = 0x80 | V_2 -> V_12 -> V_143 ;
return F_1 ( V_2 , 0x01 , V_128 ) ;
}
return F_1 ( V_2 , 0x01 , 0 ) ;
}
struct V_88 * F_43 ( const struct V_30 * V_12 ,
struct V_144 * V_18 )
{
struct V_1 * V_2 = NULL ;
T_1 V_4 = 0 ;
...
return NULL ;
V_2 = F_44 ( sizeof( struct V_1 ) , V_145 ) ;
if ( V_2 == NULL )
goto V_146;
V_2 -> V_12 = V_12 ;
V_2 -> V_18 = V_18 ;
