...
goto V_273;
if ( V_179 ) {
V_193 -> V_359 = F_7 ( V_317 , struct V_192 ,
V_28 ) ;
F_95 ( & V_193 -> V_359 -> V_208 ) ;
F_46 ( V_317 ) ;
}
if ( V_27 )
F_34 ( V_27 ) ;
...
V_193 -> V_359 = F_7 ( V_317 , struct V_192 , V_28 ) ;
F_95 ( & V_193 -> V_359 -> V_208 ) ;
F_46 ( V_317 ) ;
F_49 ( & V_49 -> V_9 ) ;
F_74 ( & V_193 -> V_325 . V_28 . V_172 , & V_49 -> V_60 -> V_73 ) ;
...
V_16 = F_144 ( V_40 , V_101 , V_55 . V_367 , V_366 ) ;
F_41 ( V_40 ) ;
if ( V_16 )
goto V_210;
memset ( & V_57 , 0 , sizeof V_57 ) ;
...
memcpy ( V_57 . V_282 . V_387 , V_101 -> V_388 . V_389 . V_387 . V_390 , 16 ) ;
V_57 . V_282 . V_391 = V_101 -> V_388 . V_389 . V_391 ;
V_57 . V_282 . V_392 = V_101 -> V_388 . V_389 . V_392 ;
V_57 . V_282 . V_393 = V_101 -> V_388 . V_389 . V_393 ;
V_57 . V_282 . V_394 = V_101 -> V_388 . V_389 . V_394 ;
V_57 . V_282 . V_395 = V_101 -> V_388 . V_395 ;
V_57 . V_282 . V_301 = V_101 -> V_388 . V_301 ;
V_57 . V_282 . V_396 = V_101 -> V_388 . V_396 ;
V_57 . V_282 . V_397 = V_101 -> V_388 . V_397 ;
V_57 . V_282 . V_398 = ! ! ( V_101 -> V_388 . V_399 & V_400 ) ;
V_57 . V_282 . V_143 = V_101 -> V_388 . V_143 ;
...
V_57 . V_401 . V_301 = V_101 -> V_402 . V_301 ;
...
V_57 . V_346 = V_366 -> V_345 . V_346 ;
V_57 . V_329 = V_366 -> V_345 . V_329 ;
V_57 . V_347 = V_366 -> V_345 . V_347 ;
V_57 . V_330 = V_366 -> V_345 . V_330 ;
V_57 . V_348 = V_366 -> V_345 . V_348 ;
V_57 . V_341 = V_366 -> V_340 == V_342 ;
if ( F_58 ( ( void T_3 * ) ( unsigned long ) V_55 . V_66 ,
& V_57 , sizeof V_57 ) )
V_16 = - V_63 ;
V_210:
...
static int F_145 ( enum V_403 V_321 , int V_404 )
{
switch ( V_321 ) {
case V_328 :
...
memcpy ( V_101 -> V_388 . V_389 . V_387 . V_390 , V_55 . V_282 . V_387 , 16 ) ;
V_101 -> V_388 . V_389 . V_391 = V_55 . V_282 . V_391 ;
V_101 -> V_388 . V_389 . V_392 = V_55 . V_282 . V_392 ;
V_101 -> V_388 . V_389 . V_393 = V_55 . V_282 . V_393 ;
V_101 -> V_388 . V_389 . V_394 = V_55 . V_282 . V_394 ;
V_101 -> V_388 . V_395 = V_55 . V_282 . V_395 ;
V_101 -> V_388 . V_301 = V_55 . V_282 . V_301 ;
V_101 -> V_388 . V_396 = V_55 . V_282 . V_396 ;
V_101 -> V_388 . V_397 = V_55 . V_282 . V_397 ;
V_101 -> V_388 . V_399 = V_55 . V_282 . V_398 ? V_400 : 0 ;
V_101 -> V_388 . V_143 = V_55 . V_282 . V_143 ;
...
V_101 -> V_402 . V_301 = V_55 . V_401 . V_301 ;
...
if ( V_40 -> V_356 == V_40 ) {
V_16 = F_147 ( V_40 , V_101 , & V_55 . V_367 ) ;
if ( V_16 )
goto V_411;
V_16 = V_40 -> V_68 -> V_412 ( V_40 , V_101 ,
F_145 ( V_40 -> V_321 , V_55 . V_367 ) , & V_59 ) ;
} else {
V_16 = F_148 ( V_40 , V_101 , F_145 ( V_40 -> V_321 , V_55 . V_367 ) ) ;
}
if ( V_16 )
goto V_411;
V_16 = V_53 ;
...
static void * F_152 ( T_4 V_414 , V_294 V_415 )
{
return F_72 ( F_153 ( V_414 , sizeof ( struct V_416 ) ) +
...
return - V_64 ;
V_419 = F_72 ( V_55 . V_429 , V_17 ) ;
if ( ! V_419 )
return - V_165 ;
V_40 = F_39 ( V_55 . V_38 , V_49 -> V_60 ) ;
if ( ! V_40 )
goto V_210;
V_427 = V_40 -> V_321 == V_433 ;
V_426 = 0 ;
V_422 = NULL ;
...
if ( V_427 ) {
struct V_434 * V_435 ;
if ( V_419 -> V_289 != V_436 &&
V_419 -> V_289 != V_437 ) {
V_16 = - V_64 ;
goto V_308;
}
V_428 = sizeof( * V_435 ) ;
V_435 = F_152 ( V_428 , V_419 -> V_415 ) ;
if ( ! V_435 ) {
V_16 = - V_165 ;
goto V_308;
}
...
V_423 = & V_435 -> V_421 ;
} else if ( V_419 -> V_289 == V_440 ||
V_419 -> V_289 == V_441 ||
V_419 -> V_289 == V_442 ) {
struct V_443 * V_444 ;
V_428 = sizeof( * V_444 ) ;
V_444 = F_152 ( V_428 , V_419 -> V_415 ) ;
if ( ! V_444 ) {
V_16 = - V_165 ;
goto V_308;
}
...
V_423 = & V_444 -> V_421 ;
} else if ( V_419 -> V_289 == V_446 ||
V_419 -> V_289 == V_447 ) {
struct V_448 * V_449 ;
V_428 = sizeof( * V_449 ) ;
V_449 = F_152 ( V_428 , V_419 -> V_415 ) ;
if ( ! V_449 ) {
V_16 = - V_165 ;
goto V_308;
}
...
V_423 = & V_449 -> V_421 ;
} else if ( V_419 -> V_289 == V_436 ||
V_419 -> V_289 == V_437 ||
V_419 -> V_289 == V_452 ) {
V_428 = sizeof( * V_423 ) ;
V_423 = F_152 ( V_428 , V_419 -> V_415 ) ;
if ( ! V_423 ) {
V_16 = - V_165 ;
goto V_308;
}
...
if ( V_419 -> V_289 == V_437 ||
V_419 -> V_289 == V_440 ) {
V_423 -> V_292 . V_293 =
( V_453 V_295 ) V_419 -> V_292 . V_293 ;
} else if ( V_419 -> V_289 == V_452 ) {
V_423 -> V_292 . V_454 = V_419 -> V_292 . V_454 ;
}
if ( ! V_422 )
V_421 = V_423 ;
else
...
V_422 = V_423 ;
V_423 -> V_423 = NULL ;
V_423 -> V_287 = V_419 -> V_287 ;
V_423 -> V_415 = V_419 -> V_415 ;
V_423 -> V_289 = V_419 -> V_289 ;
V_423 -> V_455 = V_419 -> V_455 ;
if ( V_423 -> V_415 ) {
V_423 -> V_456 = ( void * ) V_423 +
F_153 ( V_428 , sizeof( struct V_416 ) ) ;
if ( F_48 ( V_423 -> V_456 ,
V_52 + sizeof V_55 +
...
V_57 . V_424 = 0 ;
V_16 = V_40 -> V_68 -> V_457 ( V_40 -> V_356 , V_421 , & V_424 ) ;
if ( V_16 )
...
F_41 ( V_40 ) ;
while ( V_421 ) {
if ( V_427 && F_155 ( V_421 ) -> V_36 )
F_38 ( F_155 ( V_421 ) -> V_36 ) ;
V_423 = V_421 -> V_423 ;
F_82 ( V_421 ) ;
V_421 = V_423 ;
}
...
static struct V_458 * F_156 ( const char T_3 * V_52 ,
int V_53 ,
T_6 V_430 ,
T_6 V_431 ,
T_6 V_429 )
...
V_423 = F_72 ( F_153 ( sizeof *V_423 , sizeof ( struct V_416 ) ) +
...
if ( V_423 -> V_415 ) {
V_423 -> V_456 = ( void * ) V_423 +
F_153 ( sizeof *V_423 , sizeof ( struct V_416 ) ) ;
if ( F_48 ( V_423 -> V_456 ,
V_52 + V_430 * V_429 +
V_426 * sizeof ( struct V_416 ) ,
V_423 -> V_415 * sizeof ( struct V_416 ) ) ) {
...
goto V_210;
V_57 . V_424 = 0 ;
V_16 = V_40 -> V_68 -> V_461 ( V_40 -> V_356 , V_421 , & V_424 ) ;
F_41 ( V_40 ) ;
if ( V_16 )
for ( V_423 = V_421 ; V_423 ; V_423 = V_423 -> V_423 ) {
++ V_57 . V_424 ;
...
V_16 = F_165 ( V_40 , & V_469 -> V_471 , V_55 . V_470 ) ;
if ( ! V_16 )
F_74 ( & V_469 -> V_172 , & V_193 -> V_351 ) ;
else
F_82 ( V_469 ) ;
V_308:
F_42 ( V_40 ) ;
...
if ( ! V_40 )
return - V_64 ;
V_16 = F_167 ( V_40 , (union V_472 * ) V_55 . V_471 , V_55 . V_470 ) ;
if ( V_16 )
goto V_308;
V_193 = F_7 ( V_40 -> V_28 , struct V_315 , V_325 . V_28 ) ;
F_164 (mcast, &obj->mcast_list, list)
...
static int F_168 ( struct V_473 * V_474 ,
union V_475 * V_476 )
{
if ( V_474 -> V_278 )
return - V_64 ;
...
if ( V_65 )
return V_65 ;
V_249 -> V_500 += sizeof( V_55 ) ;
V_249 -> V_276 -= sizeof( V_55 ) ;
if ( V_55 . V_277 )
return - V_64 ;
if ( ( V_55 . V_499 . type == V_501 &&
! F_134 ( V_502 ) ) || ! F_134 ( V_323 ) )
return - V_324 ;
if ( V_55 . V_499 . V_229 >= V_503 )
return - V_64 ;
if ( ( V_55 . V_499 . V_229 & V_504 ) &&
( ( V_55 . V_499 . type == V_505 ) ||
( V_55 . V_499 . type == V_506 ) ) )
return - V_64 ;
if ( V_55 . V_499 . V_507 > V_508 )
return - V_64 ;
if ( V_55 . V_499 . V_479 > V_249 -> V_276 ||
V_55 . V_499 . V_479 >
( V_55 . V_499 . V_507 * sizeof( struct V_473 ) ) )
return - V_64 ;
if ( V_55 . V_499 . V_278 [ 0 ] ||
V_55 . V_499 . V_278 [ 1 ] )
return - V_64 ;
if ( V_55 . V_499 . V_507 ) {
V_497 = F_72 ( sizeof( * V_497 ) + V_55 . V_499 . V_479 ,
V_17 ) ;
if ( ! V_497 )
return - V_165 ;
memcpy ( V_497 , & V_55 . V_499 , sizeof( * V_497 ) ) ;
V_65 = F_124 ( V_497 + 1 , V_249 ,
V_55 . V_499 . V_479 ) ;
if ( V_65 )
goto V_509;
} else {
...
V_499 = F_72 ( sizeof( * V_499 ) + V_55 . V_499 . V_479 , V_17 ) ;
if ( ! V_499 ) {
V_65 = - V_165 ;
goto V_174;
}
V_499 -> type = V_497 -> type ;
V_499 -> V_512 = V_497 -> V_512 ;
V_499 -> V_507 = V_497 -> V_507 ;
V_499 -> V_513 = V_497 -> V_513 ;
V_499 -> V_229 = V_497 -> V_229 ;
V_499 -> V_479 = sizeof( * V_499 ) ;
V_474 = V_497 + 1 ;
V_476 = V_499 + 1 ;
for ( V_425 = 0 ; V_425 < V_499 -> V_507 &&
V_55 . V_499 . V_479 > F_116 ( struct V_473 , V_278 ) &&
V_55 . V_499 . V_479 >=
( (struct V_473 * ) V_474 ) -> V_479 ; V_425 ++ ) {
V_65 = F_168 ( V_474 , V_476 ) ;
if ( V_65 )
goto V_94;
V_499 -> V_479 +=
...
if ( V_55 . V_499 . V_479 || ( V_425 != V_499 -> V_507 ) ) {
F_170 ( L_3 ,
V_425 , V_55 . V_499 . V_479 ) ;
V_65 = - V_64 ;
goto V_94;
}
V_495 = F_171 ( V_40 , V_499 , V_514 ) ;
if ( F_51 ( V_495 ) ) {
V_65 = F_52 ( V_495 ) ;
goto V_94;
}
...
if ( ! V_193 )
return - V_165 ;
F_1 ( & V_193 -> V_325 . V_28 , V_55 -> V_3 , V_49 -> V_60 , & V_523 ) ;
F_31 ( & V_193 -> V_325 . V_28 . V_9 ) ;
if ( V_55 -> V_332 == V_524 ) {
V_101 . V_525 . V_526 . V_179 = F_45 ( V_55 -> V_46 , V_49 -> V_60 , & V_317 ) ;
if ( ! V_101 . V_525 . V_526 . V_179 ) {
V_16 = - V_64 ;
goto V_65;
}
V_193 -> V_359 = F_7 ( V_317 , struct V_192 , V_28 ) ;
F_95 ( & V_193 -> V_359 -> V_208 ) ;
V_101 . V_525 . V_526 . V_32 = F_35 ( V_55 -> V_30 , V_49 -> V_60 , 0 ) ;
if ( ! V_101 . V_525 . V_526 . V_32 ) {
V_16 = - V_64 ;
goto V_527;
}
}
...
V_101 . V_101 . V_532 = V_55 -> V_532 ;
V_193 -> V_325 . V_349 = 0 ;
F_53 ( & V_193 -> V_325 . V_350 ) ;
V_44 = V_27 -> V_68 -> V_533 ( V_27 , & V_101 , V_59 ) ;
if ( F_51 ( V_44 ) ) {
V_16 = F_52 ( V_44 ) ;
goto V_174;
}
...
V_44 -> V_530 = V_101 . V_530 ;
if ( V_55 -> V_332 == V_524 ) {
V_44 -> V_525 . V_526 . V_32 = V_101 . V_525 . V_526 . V_32 ;
V_44 -> V_525 . V_526 . V_179 = V_101 . V_525 . V_526 . V_179 ;
F_95 ( & V_101 . V_525 . V_526 . V_32 -> V_169 ) ;
F_95 ( & V_101 . V_525 . V_526 . V_179 -> V_169 ) ;
}
F_95 ( & V_27 -> V_169 ) ;
F_73 ( & V_44 -> V_169 , 0 ) ;
...
V_57 . V_531 = V_101 . V_101 . V_531 ;
V_57 . V_112 = V_101 . V_101 . V_112 ;
if ( V_55 -> V_332 == V_524 )
V_57 . V_534 = V_44 -> V_525 . V_526 . V_535 ;
if ( F_58 ( ( void T_3 * ) ( unsigned long ) V_55 -> V_66 ,
& V_57 , sizeof V_57 ) ) {
V_16 = - V_63 ;
goto V_171;
...
if ( F_48 ( & V_55 , V_52 , sizeof V_55 ) )
return - V_63 ;
V_536 . V_66 = V_55 . V_66 ;
V_536 . V_3 = V_55 . V_3 ;
V_536 . V_332 = V_333 ;
V_536 . V_25 = V_55 . V_25 ;
V_536 . V_531 = V_55 . V_531 ;
V_536 . V_112 = V_55 . V_112 ;
V_536 . V_532 = V_55 . V_532 ;
F_50 ( & V_59 , V_52 + sizeof V_55 ,
( unsigned long ) V_55 . V_66 + sizeof V_57 ,
V_53 - sizeof V_55 - sizeof( struct V_241 ) ,
V_54 - sizeof V_57 ) ;
V_16 = F_174 ( V_49 , V_51 , & V_536 , & V_59 ) ;
if ( V_16 )
return V_16 ;
return V_53 ;
}
T_2 V_519 ( struct V_48 * V_49 ,
struct V_50 * V_51 ,
const char T_3 * V_52 , int V_53 , int V_54 )
{
struct V_519 V_55 ;
...
V_101 . V_532 = V_55 . V_532 ;
V_16 = V_44 -> V_68 -> V_538 ( V_44 , & V_101 , V_55 . V_367 , & V_59 ) ;
F_44 ( V_44 ) ;
return V_16 ? V_16 : V_53 ;
}
...
return - V_64 ;
V_44 = V_2 -> V_23 ;
V_193 = F_7 ( V_2 , struct V_541 , V_28 ) ;
V_332 = V_44 -> V_332 ;
V_16 = F_175 ( V_44 ) ;
if ( ! V_16 )
V_2 -> V_12 = 0 ;
...
return V_16 ;
if ( V_332 == V_524 ) {
V_542 = F_7 ( V_193 , struct V_521 , V_325 ) ;
F_97 ( & V_542 -> V_359 -> V_208 ) ;
}
F_20 ( & V_43 , V_2 ) ;
F_49 ( & V_49 -> V_9 ) ;
F_79 ( & V_2 -> V_172 ) ;
...
if ( V_55 . V_278 )
return - V_64 ;
V_57 . V_272 = F_116 ( F_117 ( V_57 ) , V_545 ) ;
if ( V_249 -> V_279 < V_57 . V_272 )
return - V_62 ;
V_65 = V_51 -> V_546 ( V_51 , & V_101 , V_250 ) ;
if ( V_65 )
return V_65 ;
F_65 ( V_49 , V_51 , & V_57 . V_271 , & V_101 ) ;
if ( V_249 -> V_279 < V_57 . V_272 + sizeof( V_57 . V_545 ) )
goto V_547;
#ifdef F_55
V_57 . V_545 . V_548 = V_101 . V_545 . V_548 ;
V_57 . V_545 . V_549 . V_550 =
V_101 . V_545 . V_549 . V_550 ;
V_57 . V_545 . V_549 . V_551 =
V_101 . V_545 . V_549 . V_551 ;
V_57 . V_545 . V_549 . V_552 =
V_101 . V_545 . V_549 . V_552 ;
#endif
V_57 . V_272 += sizeof( V_57 . V_545 ) ;
