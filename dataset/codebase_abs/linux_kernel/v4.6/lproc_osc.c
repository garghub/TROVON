...
static int F_51 ( struct V_38 * V_79 , void * V_40 )
{
struct V_80 V_81 ;
...
F_53 ( V_79 , L_20 ) ;
F_53 ( V_79 , L_17 ) ;
V_82 = F_54 ( & V_10 -> V_101 ) ;
V_83 = F_54 ( & V_10 -> V_102 ) ;
V_84 = 0 ;
V_85 = 0 ;
for ( V_60 = 0 ; V_60 < V_95 ; V_60 ++ ) {
...
F_18 ( V_79 , L_18 ,
( V_60 == 0 ) ? 0 : 1 << ( V_60 - 1 ) ,
V_96 , F_55 ( V_96 , V_82 ) , F_55 ( V_84 , V_82 ) ,
V_98 , F_55 ( V_98 , V_83 ) , F_55 ( V_85 , V_83 ) ) ;
if ( V_84 == V_82 && V_85 == V_83 )
break;
}
F_12 ( & V_10 -> V_29 ) ;
...
static T_1 F_56 ( struct V_45 * V_45 ,
const char T_3 * V_5 ,
T_2 V_51 , T_4 * V_46 )
{
...
static int F_58 ( struct V_38 * V_79 , void * V_40 )
{
struct V_80 V_81 ;
struct V_6 * V_7 = V_79 -> V_41 ;
...
static T_1 F_59 ( struct V_45 * V_45 ,
const char T_3 * V_5 ,
T_2 V_51 , T_4 * V_46 )
{
struct V_38 * V_79 = V_45 -> V_47 ;
...
{
int V_15 ;
V_15 = F_61 ( V_7 -> V_109 , L_24 , 0644 ,
& V_110 , V_7 ) ;
if ( V_15 == 0 )
V_15 = F_62 ( V_7 , L_25 , 0644 ,
& V_111 , V_7 ) ;
return V_15 ;
}
void F_63 ( struct V_112 * V_113 )
{
V_113 -> V_114 = & V_115 ;
V_113 -> V_116 = V_117 ;
}
