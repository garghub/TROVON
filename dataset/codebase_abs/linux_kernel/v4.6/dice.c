...
{
struct V_57 * V_57 = F_5 ( V_28 -> V_2 ) -> V_37 ;
T_2 V_58 , V_59 ;
V_58 = F_34 () ;
V_59 = V_57 -> V_60 + F_35 ( V_61 ) ;
if ( F_36 ( V_59 , V_58 ) )
V_59 -= V_58 ;
else
V_59 = 0 ;
F_37 ( V_62 , & V_28 -> V_52 , V_59 ) ;
}
static int F_38 ( struct V_1 * V_2 , const struct V_63 * V_64 )
{
struct V_27 * V_28 ;
int V_6 ;
V_6 = F_4 ( V_2 ) ;
if ( V_6 < 0 )
return - V_26 ;
V_28 = F_39 ( sizeof( struct V_27 ) , V_65 ) ;
if ( V_28 == NULL )
return - V_66 ;
V_28 -> V_2 = F_40 ( V_2 ) ;
F_41 ( & V_2 -> V_10 , V_28 ) ;
...
{
struct V_27 * V_28 = F_49 ( & V_2 -> V_10 ) ;
F_50 ( & V_28 -> V_52 ) ;
if ( V_28 -> V_53 ) {
F_51 ( V_28 -> V_37 ) ;
} else {
