...
int V_78 , int V_40 )
{
struct V_79 * V_80 = F_46 ( V_76 , V_81 ) ;
struct V_29 * V_62 [ V_82 + 1 ] ;
struct V_63 V_64 , V_83 ;
struct V_43 * V_84 ;
struct F_1 * V_7 ;
bool V_85 , V_73 ;
int V_53 , V_6 = 0 ;
if ( ! V_30 )
return - V_70 ;
V_53 = F_47 ( V_62 , V_82 , V_30 , V_86 ) ;
if ( V_53 < 0 )
return V_53 ;
if ( ! V_62 [ V_54 ] )
return - V_70 ;
V_84 = F_19 ( V_62 [ V_54 ] ) ;
if ( ! F_48 ( V_80 , V_84 -> V_45 , V_4 , V_40 ) ) {
V_53 = F_49 ( V_80 , V_84 -> V_45 , V_77 , V_4 ,
...
V_85 = V_62 [ V_31 ] && V_62 [ V_34 ] ;
V_73 = V_62 [ V_36 ] ;
if ( ( ! V_85 && ! V_73 ) || ( V_85 && V_73 ) ) {
V_53 = - V_70 ;
goto V_89;
}
memset ( & V_64 , 0 , sizeof( V_64 ) ) ;
V_53 = V_85 ? F_29 ( V_62 , & V_64 ) :
F_34 ( V_62 , & V_64 ) ;
if ( V_53 < 0 )
goto V_89;
V_7 = F_51 ( V_4 ) ;
...
static int F_58 ( struct V_76 * V_76 , struct V_1 * V_2 ,
struct V_91 * V_92 , int type ,
struct V_3 * V_93 )
{
struct V_79 * V_80 = F_46 ( V_76 , V_81 ) ;
return F_59 ( V_80 , V_2 , V_92 , type , V_93 ) ;
}
static int F_60 ( struct V_76 * V_76 , struct V_3 * V_93 , T_2 V_45 )
{
struct V_79 * V_80 = F_46 ( V_76 , V_81 ) ;
return F_61 ( V_80 , V_93 , V_45 ) ;
}
static T_3 int F_62 ( struct V_76 * V_76 )
{
struct V_79 * V_80 = F_46 ( V_76 , V_81 ) ;
return F_63 ( V_80 , & V_94 , V_95 ) ;
}
static void T_4 F_64 ( struct V_76 * V_76 )
{
struct V_79 * V_80 = F_46 ( V_76 , V_81 ) ;
F_65 ( V_80 ) ;
}
