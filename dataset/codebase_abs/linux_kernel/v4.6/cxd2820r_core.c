...
static int F_26 ( struct V_26 * V_27 , T_2 * V_49 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static int F_30 ( struct V_26 * V_27 , T_3 * V_50 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static int F_34 ( struct V_26 * V_27 , T_3 * V_51 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static int F_38 ( struct V_26 * V_27 , T_2 * V_52 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
int V_7 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_5 , V_33 ,
...
static enum V_55 F_51 ( struct V_26 * V_27 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
struct V_39 * V_40 = & V_27 -> V_34 ;
int V_7 , V_30 ;
...
static int F_58 ( struct V_26 * V_27 , int V_64 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_12 , V_33 , V_64 ) ;
return F_9 ( V_2 , 0xdb , V_64 ? 1 : 0 , 0x1 ) ;
}
static int F_59 ( struct V_62 * V_65 , unsigned V_66 ,
int V_5 )
{
struct V_1 * V_2 = F_60 ( V_65 ) ;
T_1 V_28 [ V_67 ] ;
F_11 ( & V_2 -> V_3 -> V_14 , L_13 , V_33 , V_66 , V_5 ) ;
memcpy ( V_28 , V_2 -> V_28 , sizeof( V_28 ) ) ;
V_28 [ V_66 ] = V_36 | V_68 | ( V_5 << 2 ) ;
return F_10 ( & V_2 -> V_27 , V_28 ) ;
}
static void F_61 ( struct V_62 * V_65 , unsigned V_66 , int V_5 )
{
struct V_1 * V_2 = F_60 ( V_65 ) ;
T_1 V_28 [ V_67 ] ;
F_11 ( & V_2 -> V_3 -> V_14 , L_13 , V_33 , V_66 , V_5 ) ;
...
{
struct V_1 * V_2 = F_60 ( V_65 ) ;
F_11 ( & V_2 -> V_3 -> V_14 , L_14 , V_33 , V_66 ) ;
return ( V_2 -> V_28 [ V_66 ] >> 2 ) & 0x01 ;
}
struct V_26 * F_63 ( const struct V_69 * V_22 ,
...
int V_7 ;
T_1 V_25 ;
V_2 = F_64 ( sizeof( struct V_1 ) , V_72 ) ;
if ( ! V_2 ) {
V_7 = - V_73 ;
F_65 ( & V_3 -> V_14 , L_15 ,
V_15 ) ;
...
V_2 -> V_3 = V_3 ;
memcpy ( & V_2 -> V_22 , V_22 , sizeof( struct V_69 ) ) ;
memcpy ( & V_2 -> V_27 . V_74 , & V_75 , sizeof( struct V_76 ) ) ;
V_2 -> V_27 . V_29 = V_2 ;
