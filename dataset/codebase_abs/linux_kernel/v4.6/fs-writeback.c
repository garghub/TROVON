...
F_120 ( V_6 , V_22 ) ;
if ( V_22 -> V_136 )
V_190 = F_150 ( V_22 -> V_136 , V_6 , V_22 ) ;
else
V_190 = F_156 ( V_6 , V_22 ) ;
F_166 ( V_6 , V_22 ) ;
F_167 ( V_6 , V_188 ) ;
if ( V_190 )
continue;
...
struct V_5 , V_20 ) ;
long V_200 ;
F_181 ( L_2 , F_182 ( V_6 -> V_10 -> V_201 ) ) ;
V_35 -> V_130 |= V_202 ;
if ( F_49 ( ! F_183 () ||
! F_19 ( V_18 , & V_6 -> V_8 ) ) ) {
do {
...
V_200 = F_159 ( V_6 , 1024 ,
V_203 ) ;
F_184 ( V_200 ) ;
}
if ( ! F_9 ( & V_6 -> V_27 ) )
F_20 ( V_19 , & V_6 -> V_20 , 0 ) ;
else if ( F_4 ( V_6 ) && V_196 )
F_185 ( V_6 ) ;
V_35 -> V_130 &= ~ V_202 ;
}
...
static void F_189 ( struct V_38 * V_204 )
{
struct V_28 * V_10 ;
F_67 () ;
F_187 (bdi, &bdi_list, bdi_list) {
...
int F_192 ( struct V_206 * V_207 , int V_208 ,
void T_5 * V_209 , T_2 * V_210 , T_6 * V_211 )
{
int V_127 ;
V_127 = F_193 ( V_207 , V_208 , V_209 , V_210 , V_211 ) ;
if ( V_127 == 0 && V_208 )
F_20 ( V_212 , & V_205 , 0 ) ;
return V_127 ;
}
...
{
if ( V_1 -> V_213 || strcmp ( V_1 -> V_71 -> V_214 , L_3 ) ) {
struct V_215 * V_215 ;
const char * V_216 = L_4 ;
V_215 = F_195 ( V_1 ) ;
if ( V_215 ) {
F_44 ( & V_215 -> V_217 ) ;
V_216 = ( const char * ) V_215 -> V_218 . V_216 ;
}
F_196 ( V_219
L_5 ,
V_35 -> V_220 , F_197 ( V_35 ) , V_1 -> V_213 ,
V_216 , V_1 -> V_71 -> V_214 ) ;
if ( V_215 ) {
F_59 ( & V_215 -> V_217 ) ;
F_198 ( V_215 ) ;
}
...
F_202 ( V_1 , V_130 ) ;
if ( V_136 -> V_145 -> V_222 )
V_136 -> V_145 -> V_222 ( V_1 , V_130 ) ;
F_203 ( V_1 , V_130 ) ;
}
if ( V_130 & F_200 )
V_130 &= ~ V_158 ;
...
( V_221 && ( V_1 -> V_53 & F_200 ) ) )
return;
if ( F_37 ( V_223 ) )
F_194 ( V_1 ) ;
F_44 ( & V_1 -> V_51 ) ;
if ( V_221 && ( V_1 -> V_53 & F_200 ) )
goto V_224;
if ( ( V_1 -> V_53 & V_130 ) != V_130 ) {
const int V_225 = V_1 -> V_53 & V_152 ;
F_204 ( V_1 , NULL ) ;
if ( V_130 & F_200 )
V_1 -> V_53 &= ~ V_158 ;
V_1 -> V_53 |= V_130 ;
...
{
struct V_1 * V_1 , * V_229 = NULL ;
F_140 ( ! F_211 ( & V_136 -> V_185 ) ) ;
F_212 ( & V_136 -> V_230 ) ;
F_44 ( & V_136 -> V_231 ) ;
F_55 (inode, &sb->s_inodes, i_sb_list) {
struct V_41 * V_42 = V_1 -> V_43 ;
F_44 ( & V_1 -> V_51 ) ;
if ( ( V_1 -> V_53 & ( V_54 | V_167 | V_184 ) ) ||
( V_42 -> V_232 == 0 ) ) {
F_59 ( & V_1 -> V_51 ) ;
continue;
}
...
static void F_216 ( struct V_135 * V_136 , unsigned long V_233 ,
...
struct V_28 * V_10 = V_136 -> V_234 ;
if ( ! F_188 ( V_10 ) || V_10 == & V_235 )
return;
F_140 ( ! F_211 ( & V_136 -> V_185 ) ) ;
F_88 ( V_136 -> V_234 , & V_22 , V_107 ) ;
F_26 ( V_10 , & V_24 ) ;
}
...
enum V_119 V_120 )
{
F_216 ( V_136 , V_233 , V_120 , false ) ;
}
void F_218 ( struct V_135 * V_136 , enum V_119 V_120 )
{
return F_217 ( V_136 , F_170 () , V_120 ) ;
}
bool F_219 ( struct V_135 * V_136 , unsigned long V_233 ,
enum V_119 V_120 )
{
if ( ! F_220 ( & V_136 -> V_185 ) )
return false ;
F_216 ( V_136 , V_233 , V_120 , true ) ;
F_158 ( & V_136 -> V_185 ) ;
return true ;
}
...
int F_223 ( struct V_1 * V_1 , int V_237 )
{
struct V_74 V_75 = {
. V_157 = V_104 ,
. V_114 = V_237 ? V_153 : V_115 ,
. V_177 = 0 ,
. V_178 = V_179 ,
} ;
if ( ! F_224 ( V_1 -> V_43 ) )
