...
* V_92 = F_54 ( V_102 ) ;
V_97 = F_53 ( V_102 , L_24 , NULL ) ;
if ( V_97 )
* V_93 = F_55 ( V_97 ) ;
else
* V_93 = * V_92 ;
V_97 = F_53 ( V_102 , L_25 , NULL ) ;
if ( V_97 )
* V_94 = F_55 ( V_97 ) ;
else
* V_94 = F_56 ( V_102 ) ;
...
V_56 -> V_48 = F_59 ( V_105 , 1 ) ;
V_56 -> V_58 = F_59 ( V_105 + 1 ,
V_93 - 1 ) ;
V_105 += V_93 ;
V_56 -> V_60 = F_59 ( V_105 , V_92 ) ;
V_105 += V_92 ;
V_56 -> V_59 = V_56 -> V_58 +
F_59 ( V_105 , V_94 ) ;
V_105 += V_94 ;
...
return - V_71 ;
F_62 ( V_107 , V_53 ) ;
error = F_63 ( V_107 -> V_2 . V_103 , 0 , & V_111 ) ;
if ( error < 0 ) {
F_12 ( & V_107 -> V_2 ,
L_28 ,
...
V_108 = V_111 . V_78 ;
V_109 = F_64 ( & V_111 ) ;
error = F_65 ( & V_107 -> V_2 , V_108 ,
V_109 , NULL ,
V_113 , & V_40 ) ;
if ( error < 0 )
return error ;
error = F_66 ( V_40 , 0 , & V_110 ) ;
if ( error != 0 ) {
F_12 ( & V_107 -> V_2 ,
L_29 , error ) ;
goto V_114;
...
F_61 ( & V_107 -> V_2 ,
L_30 ,
V_110 . V_115 , V_110 . V_116 , V_110 . V_117 ) ;
if ( V_110 . V_115 < V_118 ) {
F_12 ( & V_107 -> V_2 ,
L_31 ,
V_118 , V_119 ) ;
error = - V_120 ;
...
error = F_57 ( & V_107 -> V_2 ,
& V_53 -> V_57 ,
& V_53 -> V_54 ) ;
if ( error < 0 )
goto V_114;
error = F_67 ( V_40 , 0 , & V_41 ) ;
if ( error < 0 ) {
F_12 ( & V_107 -> V_2 ,
L_33 , error ) ;
goto V_114;
...
{
struct V_52 * V_53 = F_69 ( V_107 ) ;
if ( F_4 ( ! F_6 ( & V_53 -> V_125 -> V_2 ) ) )
return - V_27 ;
F_46 ( V_53 -> V_125 ) ;
F_61 ( & V_107 -> V_2 , L_34 ) ;
return 0 ;
