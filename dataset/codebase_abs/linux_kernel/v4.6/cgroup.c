...
static inline void F_64 ( struct V_44 * V_45 )
{
F_65 ( & V_45 -> V_70 ) ;
}
static bool F_66 ( struct V_44 * V_45 ,
struct V_44 * V_77 ,
struct V_5 * V_78 ,
struct V_18 * V_79 [] )
{
...
V_84 = F_68 ( V_81 , struct V_53 , V_75 ) ;
V_85 = F_68 ( V_82 , struct V_53 , V_75 ) ;
V_86 = V_84 -> V_6 ;
V_87 = V_85 -> V_6 ;
F_67 ( V_86 -> V_7 != V_87 -> V_7 ) ;
...
static struct V_44 * F_69 ( struct V_44 * V_77 ,
struct V_5 * V_6 ,
struct V_18 * V_79 [] )
{
...
V_67 = F_52 ( V_79 ) ;
F_70 (css_set_table, cset, hlist, key) {
if ( ! F_66 ( V_45 , V_77 , V_6 , V_79 ) )
continue;
return V_45 ;
}
return NULL ;
}
static void F_71 ( struct V_80 * V_90 )
{
struct V_53 * V_54 , * V_69 ;
...
static int F_72 ( int V_91 , struct V_80 * V_92 )
{
struct V_53 * V_54 ;
int V_68 ;
F_73 ( V_92 ) ;
for ( V_68 = 0 ; V_68 < V_91 ; V_68 ++ ) {
V_54 = F_74 ( sizeof( * V_54 ) , V_93 ) ;
if ( ! V_54 ) {
F_71 ( V_92 ) ;
return - V_94 ;
}
...
static void F_76 ( struct V_80 * V_92 , struct V_44 * V_45 ,
struct V_5 * V_6 )
{
struct V_53 * V_54 ;
F_67 ( F_40 ( V_92 ) ) ;
if ( F_4 ( V_6 ) )
V_45 -> V_95 = V_6 ;
V_54 = F_77 ( V_92 , struct V_53 , V_74 ) ;
V_54 -> V_45 = V_45 ;
V_54 -> V_6 = V_6 ;
F_78 ( & V_54 -> V_74 , & V_6 -> V_96 ) ;
F_51 ( & V_54 -> V_75 , & V_45 -> V_83 ) ;
if ( F_15 ( V_6 ) )
F_30 ( V_6 ) ;
}
static struct V_44 * F_79 ( struct V_44 * V_77 ,
struct V_5 * V_6 )
{
...
F_23 ( & V_31 ) ;
F_7 ( & V_46 ) ;
V_45 = F_69 ( V_77 , V_6 , V_79 ) ;
if ( V_45 )
F_64 ( V_45 ) ;
F_9 ( & V_46 ) ;
if ( V_45 )
return V_45 ;
V_45 = F_74 ( sizeof( * V_45 ) , V_93 ) ;
if ( ! V_45 )
return NULL ;
if ( F_72 ( V_97 , & V_92 ) < 0 ) {
F_60 ( V_45 ) ;
...
V_101 = V_6 ;
F_76 ( & V_92 , V_45 , V_101 ) ;
}
F_67 ( ! F_40 ( & V_92 ) ) ;
V_73 ++ ;
V_67 = F_52 ( V_45 -> V_30 ) ;
F_82 ( V_102 , & V_45 -> V_72 , V_67 ) ;
F_53 (ss, ssid) {
...
static struct V_89 * F_83 ( struct V_104 * V_105 )
{
struct V_5 * V_106 = V_105 -> V_39 -> V_40 ;
return V_106 -> V_7 ;
}
static int F_84 ( struct V_89 * V_7 )
{
int V_17 ;
F_23 ( & V_31 ) ;
V_17 = F_85 ( & V_107 , V_7 , 0 , 0 , V_93 ) ;
if ( V_17 < 0 )
return V_17 ;
V_7 -> V_108 = V_17 ;
return 0 ;
}
static void F_86 ( struct V_89 * V_7 )
{
F_23 ( & V_31 ) ;
if ( V_7 -> V_108 ) {
...
static void F_87 ( struct V_89 * V_7 )
{
if ( V_7 ) {
F_31 ( V_7 -> V_108 ) ;
F_88 ( & V_7 -> V_109 ) ;
...
static void F_89 ( struct V_89 * V_7 )
{
struct V_5 * V_6 = & V_7 -> V_6 ;
struct V_53 * V_54 , * V_69 ;
F_90 ( & V_8 . V_6 ) ;
F_67 ( F_91 ( & V_7 -> V_110 ) ) ;
F_67 ( ! F_40 ( & V_6 -> V_20 . V_111 ) ) ;
F_92 ( F_93 ( & V_8 , V_7 -> V_23 ) ) ;
F_7 ( & V_46 ) ;
...
static struct V_5 * F_97 ( struct V_44 * V_45 ,
struct V_89 * V_7 )
{
struct V_5 * V_113 = NULL ;
F_23 ( & V_31 ) ;
...
static struct V_5 * F_98 ( struct V_55 * V_56 ,
struct V_89 * V_7 )
{
return F_97 ( F_99 ( V_56 ) , V_7 ) ;
}
static char * F_100 ( struct V_5 * V_6 , const struct V_41 * V_42 ,
char * V_118 )
{
...
static T_3 F_101 ( const struct V_41 * V_42 )
{
T_3 V_124 = 0 ;
...
static T_2 F_102 ( T_2 V_24 , T_2 V_135 )
{
T_2 V_136 = V_24 ;
struct V_28 * V_29 ;
int V_1 ;
...
static void F_105 ( struct V_139 * V_39 )
{
struct V_5 * V_6 ;
if ( F_106 ( V_39 ) == V_140 )
V_6 = V_39 -> V_40 ;
...
static struct V_5 * F_108 ( struct V_139 * V_39 ,
bool V_141 )
{
struct V_5 * V_6 ;
if ( F_106 ( V_39 ) == V_140 )
...
static void F_111 ( struct V_5 * V_6 , const struct V_41 * V_42 )
{
char V_122 [ V_121 ] ;
F_23 ( & V_31 ) ;
if ( V_42 -> V_142 ) {
...
F_114 ( V_6 -> V_39 , F_100 ( V_6 , V_42 , V_122 ) ) ;
}
static void F_115 ( struct V_18 * V_32 )
{
...
F_116 ( V_32 , V_6 , V_146 , false ) ;
}
static int F_117 ( struct V_18 * V_32 )
{
struct V_5 * V_6 = V_32 -> V_5 ;
...
V_146 = V_150 ;
return F_116 ( & V_6 -> V_20 , V_6 , V_146 , true ) ;
}
F_45 (cfts, &css->ss->cfts, node) {
V_14 = F_116 ( V_32 , V_6 , V_146 , true ) ;
if ( V_14 < 0 ) {
V_148 = V_146 ;
goto V_151;
}
...
static int F_93 ( struct V_89 * V_152 , T_2 V_153 )
{
struct V_5 * V_154 = & V_152 -> V_6 ;
struct V_28 * V_29 ;
int V_1 , V_68 , V_14 ;
F_23 ( & V_31 ) ;
F_103 (ss, ssid, ss_mask) {
if ( F_118 ( NULL , F_19 ( & V_29 -> V_7 -> V_6 , V_29 ) ) &&
! V_29 -> V_155 )
return - V_156 ;
...
struct V_44 * V_45 ;
F_92 ( ! V_32 || F_19 ( V_154 , V_29 ) ) ;
V_157 -> V_23 &= ~ ( 1 << V_1 ) ;
F_92 ( F_119 ( V_158 ) ) ;
F_120 ( V_158 , 0 ) ;
F_121 ( V_158 -> V_30 [ V_1 ] , NULL ) ;
F_50 ( V_154 -> V_30 [ V_1 ] , V_32 ) ;
V_29 -> V_7 = V_152 ;
V_32 -> V_5 = V_154 ;
F_7 ( & V_46 ) ;
F_122 (css_set_table, i, cset, hlist)
F_78 ( & V_45 -> V_71 [ V_29 -> V_17 ] ,
...
static int F_127 ( struct V_161 * V_162 , struct V_139 * V_163 ,
struct V_104 * V_105 )
{
int V_164 = 0 ;
char * V_118 = NULL ;
struct V_89 * V_165 = F_83 ( V_105 ) ;
struct V_5 * V_166 ;
V_118 = F_128 ( V_167 , V_93 ) ;
if ( ! V_118 )
return - V_94 ;
F_7 ( & V_46 ) ;
V_166 = F_96 ( V_165 ) ;
V_164 = F_129 ( V_163 , V_166 -> V_39 , V_118 , V_167 ) ;
F_9 ( & V_46 ) ;
if ( V_164 >= V_167 )
V_164 = - V_168 ;
else if ( V_164 > 0 ) {
F_130 ( V_162 , V_118 , L_3 ) ;
V_164 = 0 ;
}
F_60 ( V_118 ) ;
return V_164 ;
}
static int F_131 ( struct V_161 * V_169 ,
struct V_104 * V_105 )
{
struct V_89 * V_7 = F_83 ( V_105 ) ;
struct V_28 * V_29 ;
int V_1 ;
if ( V_7 != & V_8 )
F_53 (ss, ssid)
if ( V_7 -> V_23 & ( 1 << V_1 ) )
F_132 ( V_169 , V_29 -> V_123 , NULL ) ;
if ( V_7 -> V_35 & V_120 )
F_133 ( V_169 , L_4 ) ;
if ( V_7 -> V_35 & V_170 )
F_133 ( V_169 , L_5 ) ;
...
F_133 ( V_169 , L_7 ) ;
if ( strlen ( V_7 -> V_122 ) )
F_132 ( V_169 , L_8 , V_7 -> V_122 ) ;
return 0 ;
}
static int F_136 ( char * V_174 , struct V_175 * V_176 )
{
...
while ( ( V_177 = F_138 ( & V_178 , L_9 ) ) != NULL ) {
V_183 ++ ;
if ( ! * V_177 )
return - V_185 ;
...
static int F_140 ( struct V_104 * V_105 , int * V_35 , char * V_174 )
{
int V_14 = 0 ;
struct V_89 * V_7 = F_83 ( V_105 ) ;
struct V_175 V_176 ;
...
F_90 ( & V_8 . V_6 ) ;
V_14 = F_136 ( V_174 , & V_176 ) ;
if ( V_14 )
goto V_33;
if ( V_176 . V_23 != V_7 -> V_23 || V_176 . V_188 )
F_125 ( L_18 ,
F_142 ( V_114 ) , V_114 -> V_193 ) ;
...
F_99 ( V_194 ) != & V_34 ) ;
F_112 ( & V_194 -> V_198 -> V_199 ) ;
if ( ! ( V_194 -> V_35 & V_65 ) ) {
struct V_44 * V_45 = F_99 ( V_194 ) ;
if ( ! F_39 ( V_45 ) )
F_44 ( V_45 , true ) ;
F_51 ( & V_194 -> V_63 , & V_45 -> V_47 ) ;
F_64 ( V_45 ) ;
}
F_113 ( & V_194 -> V_198 -> V_199 ) ;
} F_146 ( V_195 , V_194 ) ;
F_147 ( & V_197 ) ;
V_33:
F_9 ( & V_46 ) ;
...
F_73 ( & V_6 -> V_103 [ V_1 ] ) ;
F_150 ( & V_6 -> V_203 ) ;
F_151 ( & V_6 -> V_204 , V_205 ) ;
}
static void F_152 ( struct V_89 * V_7 ,
struct V_175 * V_176 )
{
struct V_5 * V_6 = & V_7 -> V_6 ;
F_73 ( & V_7 -> V_112 ) ;
...
if ( V_176 -> V_187 )
F_154 ( V_173 , & V_7 -> V_6 . V_35 ) ;
}
static int F_155 ( struct V_89 * V_7 , T_2 V_153 )
{
F_156 ( V_92 ) ;
...
V_106 -> V_17 = V_14 ;
V_106 -> V_207 [ 0 ] = V_14 ;
V_14 = F_157 ( & V_106 -> V_20 . V_208 , V_209 , 0 ,
V_93 ) ;
if ( V_14 )
goto V_206;
V_14 = F_72 ( 2 * V_73 , & V_92 ) ;
if ( V_14 )
goto V_210;
V_14 = F_84 ( V_7 ) ;
if ( V_14 )
goto V_210;
V_7 -> V_105 = F_158 ( & V_211 ,
V_212 ,
V_106 ) ;
if ( F_159 ( V_7 -> V_105 ) ) {
V_14 = F_160 ( V_7 -> V_105 ) ;
goto V_213;
}
V_106 -> V_39 = V_7 -> V_105 -> V_39 ;
V_14 = F_117 ( & V_106 -> V_20 ) ;
if ( V_14 )
goto V_214;
V_14 = F_93 ( V_7 , V_153 ) ;
if ( V_14 )
goto V_214;
F_75 ( & V_7 -> V_112 , & V_215 ) ;
V_97 ++ ;
F_7 ( & V_46 ) ;
F_122 (css_set_table, i, cset, hlist) {
F_76 ( & V_92 , V_45 , V_106 ) ;
if ( F_39 ( V_45 ) )
F_41 ( V_106 , true ) ;
}
F_9 ( & V_46 ) ;
F_67 ( ! F_40 ( & V_106 -> V_20 . V_111 ) ) ;
F_67 ( F_91 ( & V_7 -> V_110 ) != 1 ) ;
F_126 ( V_106 -> V_39 ) ;
V_14 = 0 ;
goto V_206;
V_214:
...
F_86 ( V_7 ) ;
V_210:
F_161 ( & V_106 -> V_20 . V_208 ) ;
V_206:
F_71 ( & V_92 ) ;
return V_14 ;
}
static struct V_216 * F_162 ( struct V_217 * V_218 ,
...
V_29 -> V_7 == & V_8 )
continue;
if ( ! F_167 ( & V_29 -> V_7 -> V_6 . V_20 . V_208 ) ) {
F_94 ( & V_31 ) ;
F_168 ( 10 ) ;
V_14 = F_169 () ;
goto V_232;
...
F_125 ( L_22 ) ;
V_223 = F_171 ( V_7 -> V_105 , NULL ) ;
if ( F_159 ( V_223 ) ||
! F_167 ( & V_7 -> V_6 . V_20 . V_208 ) ) {
F_94 ( & V_31 ) ;
if ( ! F_172 ( V_223 ) )
F_173 ( V_223 ) ;
F_168 ( 10 ) ;
...
if ( ! V_176 . V_186 && ! F_174 ( V_228 ) ) {
V_14 = - V_229 ;
goto V_33;
}
V_7 = F_74 ( sizeof( * V_7 ) , V_93 ) ;
if ( ! V_7 ) {
V_14 = - V_94 ;
goto V_33;
}
F_152 ( V_7 , & V_176 ) ;
V_14 = F_155 ( V_7 , V_176 . V_23 ) ;
if ( V_14 )
F_87 ( V_7 ) ;
V_33:
F_94 ( & V_31 ) ;
...
V_231:
V_216 = F_175 ( V_218 , V_35 , V_7 -> V_105 ,
V_220 ? V_234 : V_235 ,
& V_226 ) ;
if ( ! F_159 ( V_216 ) && V_225 != & V_236 ) {
struct V_216 * V_237 ;
struct V_5 * V_6 ;
F_110 ( & V_31 ) ;
F_7 ( & V_46 ) ;
V_6 = F_97 ( V_225 -> V_117 , V_7 ) ;
F_9 ( & V_46 ) ;
F_94 ( & V_31 ) ;
V_237 = F_176 ( V_6 -> V_39 , V_216 -> V_238 ) ;
F_177 ( V_216 ) ;
V_216 = V_237 ;
}
if ( F_159 ( V_216 ) || ! V_226 )
F_59 ( & V_7 -> V_6 ) ;
if ( V_223 ) {
F_92 ( V_226 ) ;
F_173 ( V_223 ) ;
...
static void F_178 ( struct V_222 * V_239 )
{
struct V_104 * V_105 = F_179 ( V_239 ) ;
struct V_89 * V_7 = F_83 ( V_105 ) ;
if ( ! F_40 ( & V_7 -> V_6 . V_20 . V_111 ) ||
V_7 == & V_8 )
F_59 ( & V_7 -> V_6 ) ;
else
F_180 ( & V_7 -> V_6 . V_20 . V_208 ) ;
F_181 ( V_239 ) ;
}
static char * F_182 ( struct V_5 * V_6 , char * V_118 , T_4 V_240 ,
struct V_224 * V_225 )
{
struct V_5 * V_7 = F_97 ( V_225 -> V_117 , V_6 -> V_7 ) ;
int V_14 ;
V_14 = F_129 ( V_6 -> V_39 , V_7 -> V_39 , V_118 , V_240 ) ;
if ( V_14 < 0 || V_14 >= V_240 )
return NULL ;
return V_118 ;
}
char * F_183 ( struct V_5 * V_6 , char * V_118 , T_4 V_240 ,
struct V_224 * V_225 )
{
char * V_14 ;
F_110 ( & V_31 ) ;
F_7 ( & V_46 ) ;
V_14 = F_182 ( V_6 , V_118 , V_240 , V_225 ) ;
F_9 ( & V_46 ) ;
F_94 ( & V_31 ) ;
return V_14 ;
}
char * F_184 ( struct V_55 * V_56 , char * V_118 , T_4 V_240 )
{
struct V_89 * V_7 ;
struct V_5 * V_6 ;
int V_108 = 1 ;
...
F_110 ( & V_31 ) ;
F_7 ( & V_46 ) ;
V_7 = F_185 ( & V_107 , & V_108 ) ;
if ( V_7 ) {
V_6 = F_98 ( V_56 , V_7 ) ;
V_241 = F_182 ( V_6 , V_118 , V_240 , & V_236 ) ;
} else {
if ( F_186 ( V_118 , L_23 , V_240 ) < V_240 )
V_241 = V_118 ;
}
F_9 ( & V_46 ) ;
F_94 ( & V_31 ) ;
...
static void F_187 ( struct V_55 * V_56 ,
struct V_242 * V_243 )
{
struct V_44 * V_45 ;
F_23 ( & V_46 ) ;
...
if ( ! V_45 -> V_244 )
return;
F_78 ( & V_56 -> V_63 , & V_45 -> V_48 ) ;
if ( F_40 ( & V_45 -> V_99 ) )
F_51 ( & V_45 -> V_99 , & V_243 -> V_245 ) ;
if ( F_40 ( & V_45 -> V_246 -> V_99 ) )
F_78 ( & V_45 -> V_246 -> V_99 ,
& V_243 -> V_247 ) ;
}
struct V_55 * F_188 ( struct V_242 * V_243 ,
struct V_18 * * V_248 )
{
V_243 -> V_249 = F_77 ( V_243 -> V_250 , struct V_44 , V_99 ) ;
V_243 -> V_251 = NULL ;
return F_189 ( V_243 , V_248 ) ;
}
struct V_55 * F_189 ( struct V_242 * V_243 ,
struct V_18 * * V_248 )
{
...
V_45 = F_190 ( V_45 , V_99 ) ;
V_56 = NULL ;
}
return NULL ;
}
static int F_191 ( struct V_242 * V_243 ,
struct V_89 * V_7 )
{
struct V_28 * V_29 ;
...
if ( F_40 ( & V_243 -> V_245 ) )
return 0 ;
F_103 (ss, ssid, root->subsys_mask) {
if ( V_29 -> V_255 ) {
V_243 -> V_1 = V_1 ;
...
V_258:
F_7 ( & V_46 ) ;
F_192 ( & V_243 -> V_247 , & V_243 -> V_245 ) ;
F_47 (cset, tmp_cset, &tset->src_csets, mg_node) {
F_193 ( & V_45 -> V_48 , & V_45 -> V_47 ) ;
F_49 ( & V_45 -> V_99 ) ;
}
F_9 ( & V_46 ) ;
return V_14 ;
}
static bool F_194 ( struct V_5 * V_260 )
{
return ! F_4 ( V_260 ) || ! F_15 ( V_260 ) ||
! V_260 -> V_24 ;
}
static void F_195 ( struct V_80 * V_261 )
{
struct V_44 * V_45 , * V_253 ;
F_23 ( & V_31 ) ;
F_7 ( & V_46 ) ;
...
static void F_196 ( struct V_44 * V_263 ,
struct V_5 * V_260 ,
struct V_80 * V_261 )
{
struct V_5 * V_264 ;
...
if ( V_263 -> V_265 )
return;
V_264 = F_97 ( V_263 , V_260 -> V_7 ) ;
if ( ! F_40 ( & V_263 -> V_98 ) )
return;
F_92 ( V_263 -> V_244 ) ;
F_92 ( V_263 -> V_262 ) ;
F_92 ( ! F_40 ( & V_263 -> V_48 ) ) ;
F_92 ( ! F_40 ( & V_263 -> V_99 ) ) ;
V_263 -> V_244 = V_264 ;
V_263 -> V_262 = V_260 ;
F_64 ( V_263 ) ;
F_75 ( & V_263 -> V_98 , V_261 ) ;
}
static int F_197 ( struct V_80 * V_261 )
{
F_156 ( V_250 ) ;
...
static int F_199 ( struct V_55 * V_267 , bool V_268 ,
struct V_89 * V_7 )
{
struct V_242 V_243 = F_200 ( V_243 ) ;
struct V_55 * V_56 ;
F_7 ( & V_46 ) ;
F_25 () ;
V_56 = V_267 ;
...
V_56 = V_267 ;
do {
F_196 ( F_99 ( V_56 ) , V_260 ,
& V_261 ) ;
if ( ! V_268 )
break;
} while_each_thread(leader, task) ;
int F_202 ( struct V_55 * V_56 ,
struct V_5 * V_260 ,
struct V_37 * V_38 )
{
const struct V_269 * V_269 = F_203 () ;
const struct V_269 * V_270 = F_204 ( V_56 ) ;
int V_14 = 0 ;
if ( ! F_205 ( V_269 -> V_271 , V_272 ) &&
! F_205 ( V_269 -> V_271 , V_270 -> V_273 ) &&
! F_205 ( V_269 -> V_271 , V_270 -> V_274 ) )
V_14 = - V_275 ;
if ( ! V_14 && F_4 ( V_260 ) ) {
...
V_6 = F_98 ( V_56 , & V_8 ) ;
F_9 ( & V_46 ) ;
while ( ! F_206 ( V_260 , V_6 ) )
V_6 = F_15 ( V_6 ) ;
V_14 = - V_94 ;
V_278 = F_207 ( V_239 , V_6 -> V_279 . V_39 ) ;
if ( V_278 ) {
V_14 = F_208 ( V_278 , V_280 ) ;
F_209 ( V_278 ) ;
}
}
F_210 ( V_270 ) ;
...
static T_5 F_211 ( struct V_37 * V_38 , char * V_118 ,
...
T_7 V_284 ;
int V_1 , V_14 ;
if ( F_212 ( F_213 ( V_118 ) , 0 , & V_284 ) || V_284 < 0 )
return - V_185 ;
V_6 = F_108 ( V_38 -> V_39 , false ) ;
if ( ! V_6 )
return - V_285 ;
F_214 ( & V_286 ) ;
F_25 () ;
...
F_216 ( V_283 ) ;
F_28 () ;
V_14 = F_202 ( V_283 , V_6 , V_38 ) ;
if ( ! V_14 )
V_14 = F_201 ( V_6 , V_283 , V_268 ) ;
F_217 ( V_283 ) ;
goto V_292;
V_288:
F_28 () ;
...
int F_219 ( struct V_55 * V_294 , struct V_55 * V_283 )
{
struct V_89 * V_7 ;
int V_295 = 0 ;
F_110 ( & V_31 ) ;
...
continue;
F_7 ( & V_46 ) ;
V_296 = F_98 ( V_294 , V_7 ) ;
F_9 ( & V_46 ) ;
V_295 = F_201 ( V_296 , V_283 , false ) ;
if ( V_295 )
break;
}
F_94 ( & V_31 ) ;
...
static T_5 F_220 ( struct V_37 * V_38 ,
char * V_118 , T_4 V_281 , T_6 V_282 )
{
return F_211 ( V_38 , V_118 , V_281 , V_282 , false ) ;
}
static T_5 F_221 ( struct V_37 * V_38 ,
char * V_118 , T_4 V_281 , T_6 V_282 )
{
return F_211 ( V_38 , V_118 , V_281 , V_282 , true ) ;
}
static T_5 F_222 ( struct V_37 * V_38 ,
char * V_118 , T_4 V_281 , T_6 V_282 )
{
struct V_5 * V_6 ;
F_223 ( sizeof( V_6 -> V_7 -> V_172 ) < V_167 ) ;
V_6 = F_108 ( V_38 -> V_39 , false ) ;
if ( ! V_6 )
return - V_285 ;
F_134 ( & V_171 ) ;
F_186 ( V_6 -> V_7 -> V_172 , F_213 ( V_118 ) ,
sizeof( V_6 -> V_7 -> V_172 ) ) ;
F_135 ( & V_171 ) ;
F_105 ( V_38 -> V_39 ) ;
return V_281 ;
}
static int F_224 ( struct V_161 * V_169 , void * V_297 )
{
struct V_5 * V_6 = F_225 ( V_169 ) -> V_5 ;
F_134 ( & V_171 ) ;
F_133 ( V_169 , V_6 -> V_7 -> V_172 ) ;
F_135 ( & V_171 ) ;
F_226 ( V_169 , '\n' ) ;
return 0 ;
}
static int F_227 ( struct V_161 * V_169 , void * V_297 )
{
F_133 ( V_169 , L_24 ) ;
return 0 ;
}
static void F_228 ( struct V_161 * V_169 , T_2 V_153 )
{
struct V_28 * V_29 ;
bool V_298 = false ;
int V_1 ;
...
if ( V_298 )
F_226 ( V_169 , ' ' ) ;
F_229 ( V_169 , L_25 , V_29 -> V_122 ) ;
V_298 = true ;
} F_104 () ;
if ( V_298 )
F_226 ( V_169 , '\n' ) ;
}
static int F_230 ( struct V_161 * V_169 , void * V_297 )
{
struct V_5 * V_6 = F_225 ( V_169 ) -> V_5 ;
F_228 ( V_169 , F_17 ( V_6 ) ) ;
return 0 ;
}
static int F_231 ( struct V_161 * V_169 , void * V_297 )
{
struct V_5 * V_6 = F_225 ( V_169 ) -> V_5 ;
F_228 ( V_169 , V_6 -> V_24 ) ;
return 0 ;
}
...
F_214 ( & V_286 ) ;
F_7 ( & V_46 ) ;
F_233 (dsct, d_css, cgrp) {
struct V_53 * V_54 ;
F_45 (link, &dsct->cset_links, cset_link)
F_196 ( V_54 -> V_45 , V_300 ,
& V_261 ) ;
}
F_9 ( & V_46 ) ;
V_14 = F_197 ( & V_261 ) ;
...
static bool F_238 ( struct V_18 * V_32 )
{
...
F_31 ( V_32 && F_240 ( & V_32 -> V_208 ) ) ;
if ( ! ( F_18 ( V_300 ) & ( 1 << V_29 -> V_17 ) ) )
continue;
if ( ! V_32 ) {
V_32 = F_241 ( V_300 , V_29 ) ;
if ( F_159 ( V_32 ) )
return F_160 ( V_32 ) ;
}
if ( F_238 ( V_32 ) ) {
...
static void F_120 ( struct V_5 * V_6 , int V_14 )
{
if ( V_14 ) {
F_236 ( V_6 ) ;
F_235 ( V_6 ) ;
...
static T_5 F_244 ( struct V_37 * V_38 ,
...
int V_1 , V_14 ;
V_118 = F_213 ( V_118 ) ;
while ( ( V_309 = F_138 ( & V_118 , L_26 ) ) ) {
if ( V_309 [ 0 ] == '\0' )
continue;
F_103 (ss, ssid, ~cgrp_dfl_inhibit_ss_mask) {
if ( ! F_1 ( V_1 ) ||
...
static int F_246 ( struct V_161 * V_169 , void * V_297 )
{
F_229 ( V_169 , L_27 ,
F_247 ( F_225 ( V_169 ) -> V_5 ) ) ;
return 0 ;
}
static T_5 F_248 ( struct V_37 * V_38 , char * V_118 ,
T_4 V_281 , T_6 V_282 )
{
struct V_5 * V_6 = V_38 -> V_39 -> V_21 -> V_40 ;
...
V_14 = F_249 ( V_118 , 0 , & V_297 ) ;
if ( ! V_14 )
V_14 = V_42 -> V_129 ( V_32 , V_42 , V_297 ) ;
} else if ( V_42 -> V_130 ) {
long long V_297 ;
V_14 = F_250 ( V_118 , 0 , & V_297 ) ;
if ( ! V_14 )
...
static void * F_251 ( struct V_161 * V_169 , T_6 * V_310 )
{
return F_252 ( V_169 ) -> F_253 ( V_169 , V_310 ) ;
}
static void * F_254 ( struct V_161 * V_169 , void * V_297 , T_6 * V_310 )
{
return F_252 ( V_169 ) -> F_255 ( V_169 , V_297 , V_310 ) ;
}
static void F_256 ( struct V_161 * V_169 , void * V_297 )
{
F_252 ( V_169 ) -> F_257 ( V_169 , V_297 ) ;
}
static int F_258 ( struct V_161 * V_311 , void * V_312 )
{
struct V_41 * V_42 = F_252 ( V_311 ) ;
struct V_18 * V_32 = F_225 ( V_311 ) ;
if ( V_42 -> V_127 )
return V_42 -> V_127 ( V_311 , V_312 ) ;
if ( V_42 -> V_125 )
F_229 ( V_311 , L_28 , V_42 -> V_125 ( V_32 , V_42 ) ) ;
else if ( V_42 -> V_126 )
F_229 ( V_311 , L_29 , V_42 -> V_126 ( V_32 , V_42 ) ) ;
else
return - V_185 ;
return 0 ;
}
static int F_259 ( struct V_139 * V_39 , struct V_139 * V_313 ,
const char * V_314 )
{
...
F_109 ( V_39 ) ;
F_110 ( & V_31 ) ;
V_14 = F_260 ( V_39 , V_313 , V_314 ) ;
F_94 ( & V_31 ) ;
F_107 ( V_39 ) ;
F_107 ( V_313 ) ;
return V_14 ;
}
static int F_261 ( struct V_139 * V_39 )
{
struct V_317 V_317 = { . V_318 = V_319 | V_320 ,
. V_321 = F_262 () ,
. V_322 = F_263 () , } ;
if ( F_205 ( V_317 . V_321 , V_272 ) &&
F_264 ( V_317 . V_322 , V_323 ) )
return 0 ;
return F_265 ( V_39 , & V_317 ) ;
}
static int F_266 ( struct V_18 * V_32 , struct V_5 * V_6 ,
struct V_41 * V_42 )
{
char V_122 [ V_121 ] ;
struct V_139 * V_39 ;
...
V_67 = & V_42 -> V_325 ;
#endif
V_39 = F_268 ( V_6 -> V_39 , F_100 ( V_6 , V_42 , V_122 ) ,
F_101 ( V_42 ) , 0 , V_42 -> V_326 , V_42 ,
NULL , V_67 ) ;
if ( F_159 ( V_39 ) )
return F_160 ( V_39 ) ;
V_14 = F_261 ( V_39 ) ;
...
static int F_116 ( struct V_18 * V_32 ,
...
static int F_270 ( struct V_41 * V_146 , bool V_327 )
{
F_156 ( V_335 ) ;
...
int V_14 = 0 ;
F_23 ( & V_31 ) ;
F_271 (css, cgroup_css(root, ss)) {
struct V_5 * V_6 = V_32 -> V_5 ;
if ( ! ( V_32 -> V_35 & V_147 ) )
continue;
V_14 = F_116 ( V_32 , V_6 , V_146 , V_327 ) ;
if ( V_14 )
break;
}
if ( V_327 && ! V_14 )
...
static void F_272 ( struct V_41 * V_146 )
{
struct V_41 * V_42 ;
...
static int F_273 ( struct V_28 * V_29 , struct V_41 * V_146 )
{
struct V_41 * V_42 ;
for ( V_42 = V_146 ; V_42 -> V_122 [ 0 ] != '\0' ; V_42 ++ ) {
struct V_338 * V_326 ;
F_92 ( V_42 -> V_29 || V_42 -> V_326 ) ;
if ( V_42 -> F_253 )
V_326 = & V_339 ;
else
V_326 = & V_340 ;
if ( V_42 -> V_336 && V_42 -> V_336 != V_337 ) {
V_326 = F_274 ( V_326 , sizeof( * V_326 ) , V_93 ) ;
if ( ! V_326 ) {
F_272 ( V_146 ) ;
return - V_94 ;
}
...
static int F_275 ( struct V_41 * V_146 )
{
F_23 ( & V_31 ) ;
...
static int F_277 ( struct V_28 * V_29 , struct V_41 * V_146 )
{
int V_14 ;
if ( ! F_1 ( V_29 -> V_17 ) )
return 0 ;
...
return 0 ;
V_14 = F_273 ( V_29 , V_146 ) ;
if ( V_14 )
return V_14 ;
F_110 ( & V_31 ) ;
F_51 ( & V_146 -> V_342 , & V_29 -> V_146 ) ;
V_14 = F_270 ( V_146 , true ) ;
if ( V_14 )
F_275 ( V_146 ) ;
F_94 ( & V_31 ) ;
return V_14 ;
}
int F_278 ( struct V_28 * V_29 , struct V_41 * V_146 )
{
struct V_41 * V_42 ;
for ( V_42 = V_146 ; V_42 && V_42 -> V_122 [ 0 ] != '\0' ; V_42 ++ )
V_42 -> V_35 |= V_330 ;
return F_277 ( V_29 , V_146 ) ;
}
int F_279 ( struct V_28 * V_29 , struct V_41 * V_146 )
{
struct V_41 * V_42 ;
for ( V_42 = V_146 ; V_42 && V_42 -> V_122 [ 0 ] != '\0' ; V_42 ++ )
V_42 -> V_35 |= V_331 ;
...
V_91 += F_91 ( & V_54 -> V_45 -> V_70 ) ;
F_9 ( & V_46 ) ;
return V_91 ;
}
struct V_18 * F_118 ( struct V_18 * V_62 ,
struct V_18 * V_21 )
{
struct V_18 * V_88 ;
F_284 () ;
...
if ( ! V_62 )
return V_7 ;
V_88 = F_118 ( NULL , V_62 ) ;
if ( V_88 )
return V_88 ;
while ( V_62 != V_7 ) {
V_88 = F_118 ( V_62 , V_62 -> V_21 ) ;
if ( V_88 )
return V_88 ;
V_62 = V_62 -> V_21 ;
}
...
V_54 = F_68 ( V_347 , struct V_53 , V_74 ) ;
V_45 = V_54 -> V_45 ;
}
} while ( ! F_39 ( V_45 ) );
V_61 -> V_348 = V_347 ;
...
F_7 ( & V_46 ) ;
if ( V_61 -> V_64 ) {
V_61 -> V_251 = F_68 ( V_61 -> V_64 , struct V_55 ,
V_63 ) ;
F_216 ( V_61 -> V_251 ) ;
F_48 ( V_61 ) ;
}
...
F_297 ( & V_61 ) ;
if ( V_56 ) {
V_14 = F_199 ( V_56 , false , V_353 -> V_7 ) ;
F_217 ( V_56 ) ;
}
} while ( V_56 && ! V_14 );
V_354:
...
return F_128 ( V_91 * sizeof( T_7 ) , V_93 ) ;
}
...
if ( V_347 )
return V_347 ;
V_347 = F_74 ( sizeof( struct V_355 ) , V_93 ) ;
if ( ! V_347 )
return V_347 ;
...
struct V_5 * V_6 = F_225 ( V_393 ) -> V_5 ;
struct V_355 * V_347 ;
enum V_373 type = F_252 ( V_393 ) -> V_394 ;
...
* V_62 = F_313 ( F_225 ( V_393 ) -> V_5 , * V_194 ) ;
return V_194 ;
}
}
static int F_333 ( struct V_161 * V_393 , void * V_297 )
{
F_229 ( V_393 , L_31 , * ( int * ) V_297 ) ;
return 0 ;
}
...
V_6 -> V_17 = - 1 ;
if ( V_6 -> V_39 )
F_121 ( * ( void V_405 V_406 * * ) & V_6 -> V_39 -> V_40 ,
NULL ) ;
}
F_94 ( & V_31 ) ;
...
V_29 -> V_412 ( V_32 ) ;
V_32 -> V_35 &= ~ V_36 ;
F_121 ( V_32 -> V_5 -> V_30 [ V_29 -> V_17 ] , NULL ) ;
F_351 ( & V_32 -> V_5 -> V_203 ) ;
}
static struct V_18 * F_241 ( struct V_5 * V_6 ,
struct V_28 * V_29 )
{
struct V_5 * V_21 = F_15 ( V_6 ) ;
...
return V_32 ;
F_348 ( V_32 , V_29 , V_6 ) ;
V_151 = F_157 ( & V_32 -> V_208 , V_209 , 0 , V_93 ) ;
if ( V_151 )
goto V_414;
...
struct V_5 * V_6 , * V_419 ;
int V_420 = V_21 -> V_420 + 1 ;
int V_14 ;
V_6 = F_74 ( sizeof( * V_6 ) +
sizeof( V_6 -> V_207 [ 0 ] ) * ( V_420 + 1 ) , V_93 ) ;
if ( ! V_6 )
return F_166 ( - V_94 ) ;
V_14 = F_157 ( & V_6 -> V_20 . V_208 , V_209 , 0 , V_93 ) ;
if ( V_14 )
goto V_421;
...
V_6 -> V_7 = V_7 ;
V_6 -> V_420 = V_420 ;
for ( V_419 = V_6 ; V_419 ; V_419 = F_15 ( V_419 ) )
V_6 -> V_207 [ V_419 -> V_420 ] = V_419 -> V_17 ;
if ( F_37 ( V_21 ) )
F_154 ( V_43 , & V_6 -> V_35 ) ;
if ( F_38 ( V_173 , & V_21 -> V_35 ) )
F_154 ( V_173 , & V_6 -> V_35 ) ;
...
static int F_355 ( struct V_139 * V_424 , const char * V_122 ,
T_3 V_124 )
{
struct V_5 * V_21 , * V_6 ;
struct V_139 * V_39 ;
...
F_16 ( V_408 , struct V_18 , V_208 ) ;
if ( F_55 ( & V_32 -> V_410 ) ) {
F_151 ( & V_32 -> V_400 , F_358 ) ;
F_344 ( V_403 , & V_32 -> V_400 ) ;
}
}
static void F_243 ( struct V_18 * V_32 )
{
F_23 ( & V_31 ) ;
F_115 ( V_32 ) ;
F_27 ( V_32 ) ;
...
static void T_9 F_362 ( struct V_28 * V_29 , bool V_425 )
{
struct V_18 * V_32 ;
...
V_427 |= ( bool ) V_29 -> V_428 << V_29 -> V_17 ;
V_429 |= ( bool ) V_29 -> exit << V_29 -> V_17 ;
V_430 |= ( bool ) V_29 -> free << V_29 -> V_17 ;
V_431 |= ( bool ) V_29 -> V_432 << V_29 -> V_17 ;
F_67 ( ! F_40 ( & V_433 . V_47 ) ) ;
F_67 ( F_349 ( V_32 ) ) ;
F_94 ( & V_31 ) ;
}
int T_9 F_364 ( void )
...
int V_68 ;
F_152 ( & V_8 , & V_176 ) ;
V_8 . V_6 . V_20 . V_35 |= V_426 ;
F_121 ( V_433 . V_66 , & V_34 ) ;
F_53 (ss, i) {
F_365 ( ! V_29 -> V_413 || ! V_29 -> V_401 || V_29 -> V_122 || V_29 -> V_17 ,
L_36 ,
V_68 , V_434 [ V_68 ] , V_29 -> V_413 , V_29 -> V_401 ,
V_29 -> V_17 , V_29 -> V_122 ) ;
F_365 ( strlen ( V_434 [ V_68 ] ) > V_435 ,
L_37 , V_434 [ V_68 ] ) ;
V_29 -> V_17 = V_68 ;
V_29 -> V_122 = V_434 [ V_68 ] ;
if ( ! V_29 -> V_123 )
V_29 -> V_123 = V_434 [ V_68 ] ;
if ( V_29 -> V_436 )
F_362 ( V_29 , true ) ;
}
return 0 ;
...
F_223 ( V_2 > 16 ) ;
F_67 ( F_367 ( & V_286 ) ) ;
F_67 ( F_273 ( NULL , V_149 ) ) ;
F_67 ( F_273 ( NULL , V_150 ) ) ;
F_368 ( V_236 . V_227 ) ;
F_110 ( & V_31 ) ;
F_82 ( V_102 , & V_34 . V_72 ,
F_52 ( V_34 . V_30 ) ) ;
F_67 ( F_155 ( & V_8 , 0 ) ) ;
F_94 ( & V_31 ) ;
F_53 (ss, ssid) {
...
V_25 |= 1 << V_29 -> V_17 ;
if ( V_29 -> V_439 == V_29 -> V_440 ) {
F_92 ( F_277 ( V_29 , V_29 -> V_439 ) ) ;
} else {
F_92 ( F_278 ( V_29 , V_29 -> V_439 ) ) ;
F_92 ( F_279 ( V_29 , V_29 -> V_440 ) ) ;
}
if ( V_29 -> V_160 )
...
F_82 ( V_102 , & V_34 . V_72 ,
F_52 ( V_34 . V_30 ) ) ;
F_92 ( F_370 ( V_441 , L_40 ) ) ;
F_92 ( F_371 ( & V_382 ) ) ;
F_92 ( F_371 ( & V_221 ) ) ;
F_92 ( ! F_372 ( L_41 , 0 , NULL , & V_442 ) ) ;
return 0 ;
}
...
if ( V_7 == & V_8 && ! V_230 )
continue;
F_229 ( V_311 , L_44 , V_7 -> V_108 ) ;
if ( V_7 != & V_8 )
F_53 (ss, ssid)
if ( V_7 -> V_23 & ( 1 << V_1 ) )
F_229 ( V_311 , L_45 , V_91 ++ ? L_9 : L_20 ,
V_29 -> V_123 ) ;
if ( strlen ( V_7 -> V_122 ) )
F_229 ( V_311 , L_46 , V_91 ? L_9 : L_20 ,
V_7 -> V_122 ) ;
F_226 ( V_311 , ':' ) ;
V_6 = F_98 ( V_283 , V_7 ) ;
if ( F_4 ( V_6 ) || ! ( V_283 -> V_35 & V_65 ) ) {
V_241 = F_182 ( V_6 , V_118 , V_167 ,
V_114 -> V_115 -> V_116 ) ;
if ( ! V_241 ) {
V_295 = - V_443 ;
goto V_33;
...
struct V_28 * V_29 ;
int V_68 , V_444 , V_14 ;
F_103 (ss, i, have_canfork_callback) {
V_14 = V_29 -> V_432 ( V_308 ) ;
if ( V_14 )
goto V_445;
} F_104 () ;
return 0 ;
...
F_103 (ss, i, have_exit_callback) {
V_29 -> exit ( V_283 ) ;
} F_104 () ;
}
void F_384 ( struct V_55 * V_56 )
{
struct V_44 * V_45 = F_99 ( V_56 ) ;
struct V_28 * V_29 ;
int V_1 ;
F_103 (ss, ssid, have_free_callback) {
V_29 -> free ( V_56 ) ;
} F_104 () ;
F_62 ( V_45 ) ;
}
...
char * V_447 = NULL , * V_448 = NULL , * V_241 ;
char * V_449 [ 3 ] , * V_450 [ 3 ] ;
F_110 ( & V_31 ) ;
V_447 = F_128 ( V_167 , V_93 ) ;
V_448 = F_386 ( V_6 -> V_7 -> V_172 , V_93 ) ;
if ( ! V_447 || ! V_448 )
goto V_206;
F_7 ( & V_46 ) ;
V_241 = F_182 ( V_6 , V_447 , V_167 , & V_236 ) ;
F_9 ( & V_46 ) ;
if ( ! V_241 )
goto V_206;
V_449 [ 0 ] = V_448 ;
...
V_450 [ 2 ] = NULL ;
F_94 ( & V_31 ) ;
F_387 ( V_449 [ 0 ] , V_449 , V_450 , V_451 ) ;
goto V_232;
V_206:
F_94 ( & V_31 ) ;
V_232:
...
static int T_9 F_388 ( char * V_452 )
{
struct V_28 * V_29 ;
char * V_177 ;
int V_68 ;
while ( ( V_177 = F_138 ( & V_452 , L_9 ) ) != NULL ) {
if ( ! * V_177 )
continue;
F_53 (ss, i) {
...
static int T_9 F_389 ( char * V_452 )
{
struct V_28 * V_29 ;
char * V_177 ;
int V_68 ;
...
V_456 -> V_399 = ( unsigned long ) V_45 -> V_95 ;
break;
}
F_399 () ;
}
...
struct V_224 * V_457 ;
int V_14 ;
V_457 = F_74 ( sizeof( struct V_224 ) , V_93 ) ;
if ( ! V_457 )
return F_166 ( - V_94 ) ;
V_14 = F_403 ( & V_457 -> V_225 ) ;
if ( V_14 ) {
F_60 ( V_457 ) ;
return F_166 ( V_14 ) ;
}
F_80 ( & V_457 -> V_91 , 1 ) ;
V_457 -> V_225 . V_458 = & V_459 ;
return V_457 ;
}
...
V_457 -> V_227 = F_368 ( V_227 ) ;
V_457 -> V_117 = V_45 ;
return V_457 ;
}
static inline struct V_224 * F_408 ( struct V_463 * V_225 )
{
return F_16 ( V_225 , struct V_224 , V_225 ) ;
}
static int F_409 ( struct V_115 * V_115 , struct V_463 * V_225 )
{
struct V_224 * V_116 = F_408 ( V_225 ) ;
if ( ! F_164 ( F_410 () , V_228 ) ||
! F_164 ( V_116 -> V_227 , V_228 ) )
return - V_229 ;
...
static struct V_463 * F_411 ( struct V_55 * V_56 )
{
...
static void F_414 ( struct V_463 * V_225 )
{
F_165 ( F_408 ( V_225 ) ) ;
}
...
{
struct V_18 * V_32 = F_74 ( sizeof( * V_32 ) , V_93 ) ;
if ( ! V_32 )
return F_166 ( - V_94 ) ;
return V_32 ;
}
...
F_45 (link, &cset->cgrp_links, cgrp_link) {
struct V_5 * V_101 = V_54 -> V_6 ;
F_422 ( V_101 , V_464 , V_465 + 1 ) ;
F_229 ( V_169 , L_53 ,
V_101 -> V_7 -> V_108 , V_464 ) ;
}
F_28 () ;
F_9 ( & V_46 ) ;
F_60 ( V_464 ) ;
...
struct V_55 * V_56 ;
int V_91 = 0 ;
F_229 ( V_169 , L_54 , V_45 ) ;
F_45 (task, &cset->tasks, cg_list) {
if ( V_91 ++ > V_466 )
goto V_467;
F_229 ( V_169 , L_55 , F_324 ( V_56 ) ) ;
}
