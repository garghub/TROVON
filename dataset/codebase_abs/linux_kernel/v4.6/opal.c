...
struct V_121 * F_108 ( void * V_122 ,
unsigned long V_123 )
{
struct V_121 * V_124 , * V_125 = NULL ;
unsigned long V_21 = 0 ;
V_124 = F_109 ( V_126 , V_127 ) ;
if ( ! V_124 )
goto V_128;
V_125 = V_124 ;
while ( V_123 > 0 ) {
T_8 V_6 = F_110 ( V_122 ) << V_129 ;
T_8 V_130 = F_111 ( V_123 , V_126 ) ;
V_124 -> V_15 [ V_21 ] . V_6 = F_40 ( V_6 ) ;
V_124 -> V_15 [ V_21 ] . V_130 = F_40 ( V_130 ) ;
V_21 ++ ;
if ( V_21 >= V_131 ) {
struct V_121 * V_132 ;
V_132 = F_109 ( V_126 , V_127 ) ;
if ( ! V_132 )
goto V_128;
V_124 -> V_130 = F_40 (
