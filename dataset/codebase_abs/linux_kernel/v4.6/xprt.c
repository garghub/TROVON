...
static inline T_2 F_126 ( struct V_15 * V_16 )
{
return ( V_159 T_2 ) V_16 -> V_105 ++ ;
}
static inline void F_127 ( struct V_15 * V_16 )
{
V_16 -> V_105 = F_128 () ;
}
...
F_141 ( & V_16 -> V_133 , L_34 ) ;
F_127 ( V_16 ) ;
V_16 -> V_155 = F_142 ( V_148 ) ;
}
...
V_16 -> V_103 = F_148 ( args -> V_103 , V_153 ) ;
if ( V_16 -> V_103 == NULL ) {
F_147 ( V_16 ) ;
return F_101 ( - V_142 ) ;
}
