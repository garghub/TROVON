...
static void F_95 ( T_1 * V_1 , struct V_9 * V_10 )
{
unsigned long V_12 ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
F_92 ( V_1 ) ;
...
F_98 ( V_1 , ( unsigned char ) V_167 | V_172 ) ;
F_59 ( V_1 ) ;
if ( V_1 -> V_141 || ( V_10 && F_99 ( V_10 ) ) )
F_100 ( V_1 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
}
...
V_1 -> V_39 . V_225 = 1 ;
V_1 -> V_39 . V_121 = V_226 ;
if ( V_213 & V_227 ) {
if ( V_213 & V_228 )
V_1 -> V_39 . V_121 = V_229 ;
else
V_1 -> V_39 . V_121 = V_230 ;
#ifdef F_101
if ( V_213 & F_101 )
V_1 -> V_39 . V_121 = V_231 ;
#endif
}
V_214 = V_1 -> V_39 . V_220 +
V_1 -> V_39 . V_225 + 1 ;
if ( V_1 -> V_39 . V_232 <= 460800 ) {
V_1 -> V_39 . V_232 = F_102 ( V_10 ) ;
}
if ( V_1 -> V_39 . V_232 ) {
V_1 -> V_233 = ( 32 * V_33 * V_214 ) /
V_1 -> V_39 . V_232 ;
}
V_1 -> V_233 += V_33 / 50 ;
if ( V_213 & V_234 )
...
static int F_105 ( struct V_9 * V_10 , unsigned char V_237 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_75 ;
unsigned long V_12 ;
if ( V_21 >= V_22 ) {
F_9 ( L_36 ,
__FILE__ , __LINE__ , V_237 , V_1 -> V_76 ) ;
}
...
static void F_111 ( struct V_9 * V_10 , char V_237 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_75 ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
F_9 ( L_51 ,
__FILE__ , __LINE__ , V_1 -> V_76 , V_237 ) ;
...
static int F_118 ( T_1 * V_1 , struct V_115 T_5 * V_243 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_57 , V_1 -> V_76 ) ;
...
F_119 ( V_244 , V_243 , & V_1 -> V_106 , sizeof( struct V_115 ) ) ;
if ( V_244 )
return - V_245 ;
}
return 0 ;
}
static int F_120 ( T_1 * V_1 , V_41 T_5 * V_246 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_57 , V_1 -> V_76 ) ;
F_119 ( V_244 , V_246 , & V_1 -> V_39 , sizeof( V_41 ) ) ;
if ( V_244 )
return - V_245 ;
return 0 ;
}
static int F_121 ( T_1 * V_1 , V_41 T_5 * V_247 , struct V_9 * V_10 )
{
unsigned long V_12 ;
V_41 V_248 ;
int V_244 ;
...
V_1 -> V_76 ) ;
F_122 ( V_244 , & V_248 , V_247 , sizeof( V_41 ) ) ;
if ( V_244 ) {
if ( V_21 >= V_22 )
F_9 ( L_59 ,
__FILE__ , __LINE__ , V_1 -> V_76 ) ;
...
static int F_123 ( T_1 * V_1 , int T_5 * V_42 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_60 , V_1 -> V_76 , V_1 -> V_42 ) ;
F_119 ( V_244 , V_42 , & V_1 -> V_42 , sizeof( int ) ) ;
if ( V_244 )
return - V_245 ;
return 0 ;
}
static int F_124 ( T_1 * V_1 , int V_42 )
{
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
static int F_126 ( T_1 * V_1 , int T_5 * V_249 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_62 , V_1 -> V_76 , V_1 -> V_249 ) ;
F_119 ( V_244 , V_249 , & V_1 -> V_249 , sizeof( int ) ) ;
if ( V_244 )
return - V_245 ;
return 0 ;
}
static int F_127 ( T_1 * V_1 , int V_249 )
{
unsigned long V_12 ;
unsigned char V_250 ;
if ( V_21 >= V_22 )
F_9 ( L_63 , V_1 -> V_76 , V_249 ) ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
V_1 -> V_249 = V_249 ;
V_250 = F_33 ( V_1 , V_251 ) & 0x0f ;
switch ( V_1 -> V_249 )
{
...
F_36 ( V_1 , V_251 , V_250 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
return 0 ;
}
static int F_128 ( T_1 * V_1 , int V_258 , struct V_9 * V_10 )
{
unsigned long V_12 ;
if ( V_21 >= V_22 )
F_9 ( L_64 , V_1 -> V_76 , V_258 ) ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
if ( V_258 ) {
if ( ! V_1 -> V_77 )
F_42 ( V_1 , V_10 ) ;
...
static int F_130 ( T_1 * V_1 , int V_258 )
{
unsigned long V_12 ;
if ( V_21 >= V_22 )
F_9 ( L_66 , V_1 -> V_76 , V_258 ) ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
if ( V_258 ) {
if ( ! V_1 -> V_101 )
F_100 ( V_1 ) ;
...
static int F_131 ( T_1 * V_1 , int T_5 * V_259 )
{
unsigned long V_12 ;
int V_260 ;
int V_78 = 0 ;
struct V_115 V_261 , V_262 ;
int V_263 ;
int V_3 ;
struct V_264 V_265 , V_266 ;
F_132 ( V_267 , V_268 ) ;
F_122 ( V_78 , & V_3 , V_259 , sizeof( int ) ) ;
if ( V_78 )
return - V_245 ;
if ( V_21 >= V_22 )
...
V_260 = V_1 -> V_138 ;
V_263 = V_3 &
( ( ( V_260 & V_169 ) ? V_269 : V_270 ) +
( ( V_260 & V_161 ) ? V_271 : V_272 ) +
( ( V_260 & V_155 ) ? V_273 : V_274 ) +
( ( V_260 & V_174 ) ? V_275 : V_276 ) ) ;
if ( V_263 ) {
F_40 ( & V_1 -> V_37 , V_12 ) ;
goto exit;
}
...
F_133 ( V_278 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
if ( V_266 . V_170 == V_265 . V_170 &&
V_266 . V_171 == V_265 . V_171 &&
V_266 . V_162 == V_265 . V_162 &&
V_266 . V_163 == V_265 . V_163 &&
V_266 . V_157 == V_265 . V_157 &&
V_266 . V_158 == V_265 . V_158 &&
V_266 . V_175 == V_265 . V_175 &&
V_266 . V_176 == V_265 . V_176 &&
V_262 . V_192 == V_261 . V_192 &&
V_262 . V_280 == V_261 . V_280 ) {
V_78 = - V_239 ;
break;
}
V_263 = V_3 &
( ( V_266 . V_170 != V_265 . V_170 ? V_269 : 0 ) +
( V_266 . V_171 != V_265 . V_171 ? V_270 : 0 ) +
( V_266 . V_162 != V_265 . V_162 ? V_271 : 0 ) +
( V_266 . V_163 != V_265 . V_163 ? V_272 : 0 ) +
( V_266 . V_157 != V_265 . V_157 ? V_273 : 0 ) +
( V_266 . V_158 != V_265 . V_158 ? V_274 : 0 ) +
( V_266 . V_175 != V_265 . V_175 ? V_275 : 0 ) +
( V_266 . V_176 != V_265 . V_176 ? V_276 : 0 ) +
( V_262 . V_192 != V_261 . V_192 ? V_277 : 0 ) +
...
exit:
if ( V_78 == 0 )
F_139 ( V_78 , V_263 , V_259 ) ;
return V_78 ;
}
static int F_140 ( T_1 * V_1 , int V_64 )
{
unsigned long V_12 ;
int V_78 ;
struct V_115 V_261 , V_262 ;
...
F_133 ( V_278 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
if ( V_262 . V_173 == V_261 . V_173 && V_262 . V_168 == V_261 . V_168 &&
V_262 . V_160 == V_261 . V_160 && V_262 . V_154 == V_261 . V_154 ) {
V_78 = - V_239 ;
break;
}
if ( ( V_64 & V_283 && V_262 . V_173 != V_261 . V_173 ) ||
( V_64 & V_284 && V_262 . V_168 != V_261 . V_168 ) ||
( V_64 & V_285 && V_262 . V_160 != V_261 . V_160 ) ||
( V_64 & V_286 && V_262 . V_154 != V_261 . V_154 ) ) {
V_78 = 0 ;
break;
}
V_261 = V_262 ;
}
F_137 ( & V_1 -> V_35 , & V_267 ) ;
F_133 ( V_282 ) ;
return V_78 ;
}
...
F_59 ( V_1 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
V_287 = ( ( V_1 -> V_138 & V_139 ) ? V_288 : 0 ) +
( ( V_1 -> V_138 & V_212 ) ? V_289 : 0 ) +
( ( V_1 -> V_138 & V_161 ) ? V_290 : 0 ) +
( ( V_1 -> V_138 & V_174 ) ? V_283 : 0 ) +
( ( V_1 -> V_138 & V_169 ) ? V_284 : 0 ) +
( ( V_1 -> V_138 & V_155 ) ? V_286 : 0 ) ;
if ( V_21 >= V_22 )
F_9 ( L_68 ,
__FILE__ , __LINE__ , V_1 -> V_76 , V_287 ) ;
return V_287 ;
}
...
if ( V_21 >= V_22 )
F_9 ( L_69 ,
__FILE__ , __LINE__ , V_1 -> V_76 , V_291 , V_292 ) ;
if ( V_291 & V_288 )
V_1 -> V_138 |= V_139 ;
if ( V_291 & V_289 )
V_1 -> V_138 |= V_212 ;
...
if ( V_21 >= V_22 )
F_9 ( L_70 ,
__FILE__ , __LINE__ , V_1 -> V_76 , V_293 ) ;
if ( F_30 ( V_1 , V_10 -> V_66 , L_71 ) )
return - V_294 ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
if ( V_293 == - 1 )
F_144 ( V_1 , V_4 + V_295 , V_120 ) ;
else
F_145 ( V_1 , V_4 + V_295 , V_120 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
return 0 ;
}
...
V_262 = V_1 -> V_106 ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
V_106 -> V_154 = V_262 . V_154 ;
V_106 -> V_168 = V_262 . V_168 ;
V_106 -> V_173 = V_262 . V_173 ;
V_106 -> V_160 = V_262 . V_160 ;
V_106 -> V_117 = V_262 . V_117 ;
V_106 -> V_297 = V_262 . V_297 ;
V_106 -> V_122 = V_262 . V_122 ;
V_106 -> V_128 = V_262 . V_128 ;
V_106 -> V_121 = V_262 . V_121 ;
V_106 -> V_127 = V_262 . V_127 ;
V_106 -> V_107 = V_262 . V_107 ;
return 0 ;
}
...
switch ( V_73 ) {
case V_302 :
return F_120 ( V_1 , V_298 ) ;
case V_303 :
return F_121 ( V_1 , V_298 , V_10 ) ;
case V_304 :
return F_123 ( V_1 , V_298 ) ;
case V_305 :
...
case V_308 :
return F_128 ( V_1 , ( int ) V_64 , V_10 ) ;
case V_309 :
return F_130 ( V_1 , ( int ) V_64 ) ;
case V_310 :
return F_129 ( V_1 ) ;
case V_311 :
return F_118 ( V_1 , V_298 ) ;
case V_312 :
return F_131 ( V_1 , V_298 ) ;
case V_301 :
return F_140 ( V_1 , ( int ) V_64 ) ;
default:
return - V_313 ;
}
return 0 ;
}
static void F_148 ( struct V_9 * V_10 , struct V_314 * V_315 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_75 ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
V_10 -> V_316 -> V_66 ) ;
if ( ( V_10 -> V_215 . V_216 == V_315 -> V_216 )
&& ( F_149 ( V_10 -> V_215 . V_317 )
== F_149 ( V_315 -> V_317 ) ) )
return;
F_87 ( V_1 , V_10 ) ;
if ( ( V_315 -> V_216 & V_217 ) && ! F_150 ( V_10 ) ) {
V_1 -> V_138 &= ~ ( V_139 | V_212 ) ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
F_60 ( V_1 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
...
if ( ! ( V_315 -> V_216 & V_217 ) && F_150 ( V_10 ) ) {
V_1 -> V_138 |= V_212 ;
if ( ! F_115 ( V_10 ) || ! F_151 ( V_318 , & V_10 -> V_12 ) )
V_1 -> V_138 |= V_139 ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
F_60 ( V_1 ) ;
F_40 ( & V_1 -> V_37 , V_12 ) ;
}
if ( V_315 -> V_216 & V_234 && ! F_115 ( V_10 ) ) {
V_10 -> V_143 = 0 ;
F_41 ( V_10 ) ;
}
}
static void F_152 ( struct V_9 * V_10 , struct V_319 * V_320 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_75 ;
struct V_113 * V_27 = & V_1 -> V_27 ;
...
if ( F_153 ( V_27 , V_10 , V_320 ) == 0 )
goto V_238;
if ( V_27 -> V_12 & V_207 )
F_154 ( V_10 , V_1 -> V_233 ) ;
F_110 ( V_10 ) ;
F_155 ( V_10 ) ;
F_89 ( V_1 , V_10 ) ;
F_156 ( V_27 , V_10 ) ;
...
V_10 -> V_316 -> V_66 , V_27 -> V_13 ) ;
}
static void F_154 ( struct V_9 * V_10 , int V_233 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_75 ;
...
V_321 = V_323 ;
if ( V_1 -> V_39 . V_232 ) {
V_322 = V_1 -> V_233 / ( 32 * 5 ) ;
if ( ! V_322 )
V_322 ++ ;
} else
V_322 = 1 ;
if ( V_233 )
V_322 = F_64 (unsigned long, char_time, timeout) ;
if ( V_1 -> V_39 . V_131 == V_145 ) {
while ( V_1 -> V_129 ) {
F_158 ( F_159 ( V_322 ) ) ;
if ( F_136 ( V_268 ) )
break;
if ( V_233 && F_160 ( V_323 , V_321 + V_233 ) )
break;
}
} else {
...
static int F_163 ( struct V_113 * V_27 )
{
...
static void F_164 ( struct V_113 * V_27 , int V_324 )
{
T_1 * V_1 = F_44 ( V_27 , T_1 , V_27 ) ;
unsigned long V_12 ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
...
static int F_165 ( struct V_9 * V_10 , struct V_319 * V_320 )
{
T_1 * V_1 ;
struct V_113 * V_27 ;
int V_206 , line ;
...
if ( V_21 >= V_22 )
F_9 ( L_85 ,
__FILE__ , __LINE__ , V_10 -> V_316 -> V_66 , V_27 -> V_13 ) ;
V_27 -> V_329 = ( V_27 -> V_12 & V_330 ) ? 1 : 0 ;
F_38 ( & V_1 -> V_38 , V_12 ) ;
if ( V_1 -> V_141 ) {
V_206 = - V_331 ;
F_40 ( & V_1 -> V_38 , V_12 ) ;
...
V_206 = F_166 ( & V_1 -> V_27 , V_10 , V_320 ) ;
if ( V_206 ) {
if ( V_21 >= V_22 )
F_9 ( L_86 ,
...
static inline void F_167 ( struct V_332 * V_333 , T_1 * V_1 )
{
char V_334 [ 30 ] ;
unsigned long V_12 ;
F_168 ( V_333 , L_88 ,
...
if ( V_1 -> V_39 . V_131 == V_145 ) {
F_168 ( V_333 , L_95 ,
V_1 -> V_106 . V_203 , V_1 -> V_106 . V_335 ) ;
if ( V_1 -> V_106 . V_201 )
F_168 ( V_333 , L_96 , V_1 -> V_106 . V_201 ) ;
if ( V_1 -> V_106 . V_200 )
F_168 ( V_333 , L_97 , V_1 -> V_106 . V_200 ) ;
if ( V_1 -> V_106 . V_336 )
F_168 ( V_333 , L_98 , V_1 -> V_106 . V_336 ) ;
if ( V_1 -> V_106 . V_337 )
F_168 ( V_333 , L_99 , V_1 -> V_106 . V_337 ) ;
if ( V_1 -> V_106 . V_338 )
F_168 ( V_333 , L_100 , V_1 -> V_106 . V_338 ) ;
if ( V_1 -> V_106 . V_339 )
F_168 ( V_333 , L_101 , V_1 -> V_106 . V_339 ) ;
} else {
F_168 ( V_333 , L_102 ,
V_1 -> V_106 . V_297 , V_1 -> V_106 . V_117 ) ;
if ( V_1 -> V_106 . V_122 )
F_168 ( V_333 , L_103 , V_1 -> V_106 . V_122 ) ;
if ( V_1 -> V_106 . V_121 )
F_168 ( V_333 , L_104 , V_1 -> V_106 . V_121 ) ;
if ( V_1 -> V_106 . V_127 )
F_168 ( V_333 , L_105 , V_1 -> V_106 . V_127 ) ;
if ( V_1 -> V_106 . V_128 )
F_168 ( V_333 , L_106 , V_1 -> V_106 . V_128 ) ;
}
F_168 ( V_333 , L_107 , V_334 + 1 ) ;
F_168 ( V_333 , L_108 ,
V_1 -> V_129 , V_1 -> V_84 , V_1 -> V_83 ,
V_1 -> V_79 ) ;
}
static int F_169 ( struct V_332 * V_333 , void * V_340 )
{
T_1 * V_1 ;
F_168 ( V_333 , L_109 , V_341 ) ;
V_1 = V_327 ;
while ( V_1 ) {
F_167 ( V_333 , V_1 ) ;
V_1 = V_1 -> V_328 ;
...
static int F_170 ( struct V_342 * V_342 , struct V_319 * V_319 )
{
return F_171 ( V_319 , F_169 , NULL ) ;
}
static int F_172 ( T_1 * V_1 )
{
V_1 -> V_99 = sizeof( T_3 ) + V_1 -> V_31 ;
V_1 -> V_343 = V_1 -> V_99 * 8 ;
if ( V_1 -> V_343 > 0x10000 )
V_1 -> V_343 = 0x10000 ;
V_1 -> V_103 = V_1 -> V_343 / V_1 -> V_99 ;
V_1 -> V_97 = F_173 ( V_1 -> V_343 , V_23 ) ;
if ( V_1 -> V_97 == NULL )
return - V_24 ;
V_1 -> V_344 = F_10 ( V_1 -> V_31 , V_23 ) ;
if ( ! V_1 -> V_344 ) {
F_19 ( V_1 -> V_97 ) ;
V_1 -> V_97 = NULL ;
return - V_24 ;
...
goto V_47;
#endif
V_347 = F_177 ( & V_1 -> V_27 , V_350 , V_1 -> line ,
& V_1 -> V_45 -> V_351 ) ;
if ( F_178 ( V_347 ) ) {
V_20 = F_179 ( V_347 ) ;
#if V_140
...
if ( V_1 == V_352 ) {
if ( V_353 )
V_353 -> V_328 = V_1 -> V_328 ;
else
V_327 = V_1 -> V_328 ;
F_181 ( V_350 , V_1 -> line ) ;
#if V_140
F_180 ( V_1 ) ;
#endif
F_86 ( V_1 ) ;
...
static void F_192 ( T_1 * V_1 , unsigned char V_2 , unsigned int V_374 )
{
...
V_250 = F_33 ( V_1 , ( unsigned char ) ( V_2 + V_378 ) ) & 0x3f ;
V_250 |= ( ( V_375 << 4 ) & 0xc0 ) ;
F_36 ( V_1 , ( unsigned char ) ( V_2 + V_378 ) , V_250 ) ;
}
}
...
if ( V_1 -> V_39 . V_131 == V_145 && V_1 -> V_39 . V_379 )
F_192 ( V_1 , V_8 , V_1 -> V_39 . V_379 ) ;
else
F_192 ( V_1 , V_8 , 921600 ) ;
}
static void F_194 ( T_1 * V_1 )
{
unsigned char V_250 ;
V_250 = F_33 ( V_1 , V_4 + V_382 ) | ( V_72 | V_185 | V_186 ) ;
F_36 ( V_1 , V_4 + V_382 , V_250 ) ;
V_250 = F_33 ( V_1 , V_4 + V_378 ) | ( V_384 | V_116 ) ;
F_36 ( V_1 , V_4 + V_378 , V_250 ) ;
if ( V_1 -> V_39 . V_379 )
F_192 ( V_1 , V_4 , V_1 -> V_39 . V_379 ) ;
else
F_192 ( V_1 , V_4 , 1843200 ) ;
V_250 = F_33 ( V_1 , V_4 + V_380 ) | V_186 ;
F_36 ( V_1 , V_4 + V_380 , V_250 ) ;
}
...
F_36 ( V_1 , V_4 + V_412 , V_250 ) ;
V_250 = 0x50 ;
F_36 ( V_1 , V_4 + V_383 , V_250 ) ;
if ( V_1 -> V_39 . V_12 & V_387 )
F_192 ( V_1 , V_4 , V_1 -> V_39 . V_379 * 16 ) ;
else
F_192 ( V_1 , V_4 , V_1 -> V_39 . V_379 ) ;
...
{
F_3 ( V_1 , V_8 , V_153 ) ;
F_144 ( V_1 , V_4 + V_251 , V_188 ) ;
} else
F_145 ( V_1 , V_4 + V_251 , V_188 ) ;
F_3 ( V_1 , V_4 ,
V_197 | V_198 | V_202 |
V_199 | V_204 ) ;
...
F_192 ( V_1 , V_4 , V_1 -> V_39 . V_232 * 16 ) ;
V_250 = 0x00 ;
if ( V_1 -> V_39 . V_220 != 8 )
V_250 |= V_186 ;
if ( V_1 -> V_39 . V_225 != 1 )
V_250 |= V_116 ;
if ( V_1 -> V_39 . V_121 != V_226 )
{
V_250 |= V_72 ;
if ( V_1 -> V_39 . V_121 == V_229 )
V_250 |= V_188 ;
else
V_250 |= V_384 ;
}
F_36 ( V_1 , V_4 + V_295 , V_250 ) ;
...
{
if ( V_1 -> V_42 == V_43 )
F_144 ( V_1 , V_4 + V_382 , V_188 ) ;
else
F_145 ( V_1 , V_4 + V_382 , V_188 ) ;
}
...
F_36 ( V_1 , V_4 + V_380 , V_250 ) ;
if ( V_1 -> V_138 & V_212 )
F_145 ( V_1 , V_4 + V_251 , V_424 ) ;
else
F_144 ( V_1 , V_4 + V_251 , V_424 ) ;
}
...
#if V_140
if ( V_1 -> V_141 )
F_198 ( V_1 , V_96 -> V_11 , V_426 ) ;
else
#endif
F_5 ( V_10 , V_96 -> V_11 , V_1 -> V_344 , V_426 ) ;
}
}
F_38 ( & V_1 -> V_37 , V_12 ) ;
V_96 -> V_110 = V_96 -> V_13 = 0 ;
...
static unsigned int V_13 = F_200 ( V_436 ) ;
unsigned int V_70 ;
bool V_78 = true ;
unsigned long V_12 ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
...
static void F_197 ( T_1 * V_1 , const char * V_11 , int V_13 , int V_445 )
{
int V_70 ;
int V_446 ;
if ( V_445 )
...
static int F_202 ( struct V_449 * V_351 , unsigned short V_392 ,
...
static T_8 F_204 ( struct V_463 * V_464 ,
struct V_449 * V_351 )
{
T_1 * V_1 = F_203 ( V_351 ) ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
F_9 ( V_373 L_134 , __FILE__ , V_351 -> V_66 ) ;
F_205 ( V_351 ) ;
F_206 ( V_464 , V_1 -> V_148 , V_464 -> V_465 ) ;
V_1 -> V_135 = 0 ;
V_1 -> V_134 = V_1 -> V_133 = V_464 -> V_465 ;
V_351 -> V_430 . V_466 ++ ;
V_351 -> V_430 . V_467 += V_464 -> V_465 ;
F_207 ( V_464 ) ;
V_351 -> V_468 = V_323 ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
if ( ! V_1 -> V_129 ) {
...
static int F_208 ( struct V_449 * V_351 )
{
T_1 * V_1 = F_203 ( V_351 ) ;
struct V_9 * V_10 ;
int V_78 ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
F_9 ( L_135 , __FILE__ , V_351 -> V_66 ) ;
V_78 = F_209 ( V_351 ) ;
if ( V_78 != 0 )
return V_78 ;
F_38 ( & V_1 -> V_38 , V_12 ) ;
if ( V_1 -> V_27 . V_13 != 0 || V_1 -> V_141 != 0 ) {
F_9 ( V_470 L_136 , V_351 -> V_66 ) ;
F_40 ( & V_1 -> V_38 , V_12 ) ;
return - V_331 ;
}
V_1 -> V_141 = 1 ;
...
static int F_211 ( struct V_449 * V_351 )
{
T_1 * V_1 = F_203 ( V_351 ) ;
struct V_9 * V_10 = F_45 ( & V_1 -> V_27 ) ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
F_9 ( L_137 , __FILE__ , V_351 -> V_66 ) ;
F_205 ( V_351 ) ;
F_89 ( V_1 , V_10 ) ;
F_49 ( V_10 ) ;
F_212 ( V_351 ) ;
...
static int F_213 ( struct V_449 * V_351 , struct V_471 * V_472 , int V_73 )
{
...
unsigned int V_12 ;
if ( V_21 >= V_22 )
F_9 ( L_138 , __FILE__ , V_351 -> V_66 ) ;
if ( V_1 -> V_27 . V_13 )
return - V_331 ;
if ( V_73 != V_479 )
return F_214 ( V_351 , V_472 , V_73 ) ;
...
if ( F_215 ( line , & V_475 , V_473 ) )
return - V_245 ;
return 0 ;
case V_481 :
if( ! F_84 ( V_494 ) )
return - V_495 ;
if ( F_216 ( & V_475 , line , V_473 ) )
return - V_245 ;
switch ( V_475 . V_487 )
{
...
static void F_217 ( struct V_449 * V_351 )
{
T_1 * V_1 = F_203 ( V_351 ) ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
F_9 ( L_139 , V_351 -> V_66 ) ;
V_351 -> V_430 . V_496 ++ ;
V_351 -> V_430 . V_497 ++ ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
F_39 ( V_1 ) ;
...
static void F_198 ( T_1 * V_1 , char * V_96 , int V_473 )
{
struct V_463 * V_464 = F_220 ( V_473 ) ;
struct V_449 * V_351 = V_1 -> V_164 ;
if ( V_21 >= V_22 )
F_9 ( L_140 , V_351 -> V_66 ) ;
if ( V_464 == NULL ) {
F_9 ( V_498 L_141 , V_351 -> V_66 ) ;
V_351 -> V_430 . V_499 ++ ;
return;
}
memcpy ( F_221 ( V_464 , V_473 ) , V_96 , V_473 ) ;
V_464 -> V_500 = F_222 ( V_464 , V_351 ) ;
V_351 -> V_430 . V_501 ++ ;
V_351 -> V_430 . V_502 += V_473 ;
F_223 ( V_464 ) ;
}
static int F_176 ( T_1 * V_1 )
{
int V_78 ;
struct V_449 * V_351 ;
T_10 * V_503 ;
