...
struct V_53 * V_59 = & V_6 -> V_59 [ V_57 ] ;
if ( V_59 -> V_60 ) {
F_48 ( V_59 -> V_60 , V_59 ) ;
V_59 -> V_60 = NULL ;
}
}
V_6 -> V_61 -> V_27 . V_62 = false ;
}
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_15 * V_64 = V_6 -> V_61 ;
int V_57 ;
if ( V_64 -> V_27 . V_28 ) {
F_61 ( V_2 ) ;
F_12 ( ! V_6 -> V_59 [ V_56 ] . V_60 ) ;
F_46 ( V_64 -> V_27 . V_28 ) ;
}
...
const int V_77 =
F_75 ( V_59 -> V_2 ) ?
F_76 ( F_4 ( V_59 -> V_2 ) -> V_78 ) - 1 :
0 ;
int V_79 , V_57 , V_8 ;
if ( F_2 ( V_59 -> V_2 ) ) {
V_8 = V_59 -> V_80 ( V_66 , V_81 , 0 ) ;
if ( V_8 )
return V_8 ;
}
if ( F_7 ( V_59 -> V_2 ) || F_4 ( V_59 -> V_2 ) -> V_10 >= 8 )
V_75 |= ( V_82 | V_83 ) ;
else if ( F_4 ( V_59 -> V_2 ) -> V_10 < 8 )
V_75 |= ( V_84 | V_85 ) ;
V_79 = 4 ;
if ( F_4 ( V_59 -> V_2 ) -> V_10 >= 7 )
...
struct V_53 * V_88 ;
F_78 ( V_59 , F_79 ( V_77 ) ) ;
F_80 (signaller, to_i915(ring->dev), i) {
if ( V_88 == V_59 )
continue;
F_81 ( V_59 , F_82 ( V_88 -> V_89 ) ) ;
F_78 ( V_59 , F_83 ( V_90 ) ) ;
}
}
}
F_78 ( V_59 , V_91 ) ;
F_78 ( V_59 , V_92 ) ;
F_78 ( V_59 , F_84 ( V_66 -> V_16 -> V_27 . V_28 ) |
V_75 ) ;
F_78 ( V_59 , V_91 ) ;
if ( F_4 ( V_59 -> V_2 ) -> V_10 >= 7 ) {
if ( V_77 ) {
...
static inline bool F_87 ( struct V_53 * V_59 ,
struct V_15 * V_94 ,
struct V_15 * V_95 )
{
if ( V_95 -> V_45 )
...
! ( F_88 ( V_59 ) & V_95 -> V_18 -> V_96 ) )
return true ;
return false ;
}
static bool
F_89 ( struct V_53 * V_59 , struct V_15 * V_95 )
{
struct V_5 * V_6 = V_59 -> V_2 -> V_7 ;
if ( ! V_95 -> V_18 )
return false ;
if ( F_4 ( V_59 -> V_2 ) -> V_10 < 8 )
return true ;
if ( V_59 != & V_6 -> V_59 [ V_56 ] )
return true ;
return false ;
}
static bool
F_90 ( struct V_53 * V_59 , struct V_15 * V_95 ,
T_2 V_74 )
{
struct V_5 * V_6 = V_59 -> V_2 -> V_7 ;
if ( ! V_95 -> V_18 )
...
{
struct V_15 * V_95 = V_66 -> V_16 ;
struct V_53 * V_59 = V_66 -> V_59 ;
struct V_5 * V_6 = V_59 -> V_2 -> V_7 ;
struct V_15 * V_94 = V_59 -> V_60 ;
T_2 V_74 = 0 ;
bool V_98 = false ;
int V_8 , V_57 ;
if ( V_94 != NULL && V_59 == & V_6 -> V_59 [ V_56 ] ) {
F_38 ( V_94 -> V_27 . V_28 == NULL ) ;
F_38 ( ! F_93 ( V_94 -> V_27 . V_28 ) ) ;
}
if ( F_87 ( V_59 , V_94 , V_95 ) )
return 0 ;
if ( V_59 == & V_6 -> V_59 [ V_56 ] ) {
...
if ( F_89 ( V_59 , V_95 ) ) {
F_94 ( V_59 , V_95 ) ;
V_8 = V_95 -> V_18 -> V_99 ( V_95 -> V_18 , V_66 ) ;
if ( V_8 )
goto V_100;
V_95 -> V_18 -> V_96 &= ~ F_88 ( V_59 ) ;
}
if ( V_59 != & V_6 -> V_59 [ V_56 ] ) {
if ( V_94 )
F_36 ( V_94 ) ;
...
V_8 = F_95 ( V_95 -> V_27 . V_28 , false ) ;
if ( V_8 )
goto V_100;
if ( ! V_95 -> V_27 . V_62 || F_96 ( V_95 ) ) {
V_74 |= V_97 ;
} else if ( V_95 -> V_18 &&
( F_88 ( V_59 ) & V_95 -> V_18 -> V_96 ) ) {
V_74 |= V_102 ;
...
if ( V_94 != NULL ) {
V_94 -> V_27 . V_28 -> V_29 . V_104 = V_105 ;
F_98 ( F_99 ( V_94 -> V_27 . V_28 ) , V_66 ) ;
V_94 -> V_27 . V_28 -> V_106 = 1 ;
F_46 ( V_94 -> V_27 . V_28 ) ;
F_36 ( V_94 ) ;
}
V_98 = ! V_95 -> V_27 . V_62 ;
...
{
return V_25 . V_26 || F_102 ( V_2 ) -> V_40 ;
}
int F_103 ( struct V_1 * V_2 , void * V_69 ,
struct V_70 * V_71 )
{
struct V_107 * args = V_69 ;
struct V_36 * V_37 = V_71 -> V_72 ;
struct V_15 * V_16 ;
int V_8 ;
if ( ! F_101 ( V_2 ) )
...
else if ( F_102 ( V_2 ) -> V_120 . V_121 )
args -> V_115 = F_102 ( V_2 ) -> V_120 . V_121 -> V_29 . V_119 ;
else
args -> V_115 = F_102 ( V_2 ) -> V_122 . V_29 . V_119 ;
break;
default:
V_8 = - V_63 ;
break;
...
int F_107 ( struct V_1 * V_2 , void * V_69 ,
struct V_70 * V_71 )
{
struct V_36 * V_37 = V_71 -> V_72 ;
struct V_112 * args = V_69 ;
