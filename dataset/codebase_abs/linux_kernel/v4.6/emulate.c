...
{
register void * T_6 V_520 ( V_521 ) ;
T_1 V_122 = ( V_2 -> V_189 & V_124 ) | V_125 ;
if ( ! ( V_2 -> V_45 & V_145 ) )
F_55 += F_218 ( V_2 -> V_25 . V_27 ) * V_522 ;
...
const struct V_196 * V_6 = V_2 -> V_6 ;
int V_92 = V_91 ;
int V_523 = V_2 -> V_25 . type ;
V_2 -> V_177 . V_178 = 0 ;
if ( V_2 -> V_223 && ( ! ( V_2 -> V_45 & V_524 ) || V_2 -> V_25 . type != V_157 ) ) {
V_92 = F_27 ( V_2 ) ;
goto V_171;
}
if ( ( V_2 -> V_45 & V_525 ) == V_526 && V_2 -> V_22 . type != V_157 ) {
V_92 = F_27 ( V_2 ) ;
goto V_171;
}
if ( F_46 ( V_2 -> V_45 &
( V_527 | V_528 | V_137 | V_141 | V_505 | V_506 | V_529 | V_530 | String ) ) ) {
if ( ( V_2 -> V_41 == V_42 && ( V_2 -> V_45 & V_527 ) ) ||
( V_2 -> V_45 & V_528 ) ) {
V_92 = F_27 ( V_2 ) ;
goto V_171;
}
if ( ( ( V_2 -> V_45 & ( V_137 | V_141 ) ) && ( ( V_6 -> V_130 ( V_2 , 0 ) & V_132 ) ) )
|| ( ( V_2 -> V_45 & V_137 ) && ! ( V_6 -> V_130 ( V_2 , 4 ) & V_531 ) ) ) {
V_92 = F_27 ( V_2 ) ;
goto V_171;
}
...
if ( F_46 ( V_2 -> V_296 & V_533 ) && V_2 -> V_12 ) {
V_92 = F_7 ( V_2 , V_2 -> V_12 ,
V_534 ) ;
if ( V_92 != V_91 )
goto V_171;
}
if ( ( V_2 -> V_45 & V_530 ) && V_2 -> V_41 < V_97 ) {
V_92 = F_27 ( V_2 ) ;
goto V_171;
}
if ( ( V_2 -> V_45 & V_529 ) && V_6 -> V_201 ( V_2 ) ) {
if ( V_2 -> V_45 & V_535 )
V_92 = F_27 ( V_2 ) ;
else
V_92 = F_25 ( V_2 , 0 ) ;
...
if ( F_46 ( V_2 -> V_296 & V_533 ) && ( V_2 -> V_45 & V_505 ) ) {
V_92 = F_7 ( V_2 , V_2 -> V_12 ,
V_536 ) ;
if ( V_92 != V_91 )
goto V_171;
...
if ( ( V_2 -> V_22 . type == V_157 ) && ! ( V_2 -> V_45 & V_537 ) ) {
...
if ( ( V_2 -> V_45 & V_538 ) == V_539 )
goto V_540;
if ( ( V_2 -> V_25 . type == V_157 ) && ! ( V_2 -> V_45 & V_532 ) ) {
...
V_2 -> V_25 . type = V_523 ;
if ( ( V_2 -> V_45 & V_525 ) == V_551 )
F_145 ( V_2 , V_162 , & V_2 -> V_22 ) ;
if ( ( V_2 -> V_45 & V_538 ) == V_552 )
