...
static bool F_136 ( struct V_246 * V_247 )
{
struct V_106 * V_107 = V_247 -> V_7 -> V_18 ;
T_6 * V_239 = V_107 -> V_239 ;
if ( V_107 -> V_213 )
V_239 += V_247 -> V_8 -> V_97 -> V_139 * V_321 ;
if ( V_247 -> V_186 . V_258 == V_322 && V_247 -> V_323 == V_324 &&
! ( V_247 -> V_29 & V_325 ) ) {
F_137 ( V_239 + V_326 , & V_247 -> V_327 ) ;
V_247 -> V_327 . V_242 = ( V_239 + V_326 ) [ 15 ] ;
} else
F_137 ( V_239 + V_240 , & V_247 -> V_327 ) ;
return true ;
}
...
F_141 ( V_7 ) ;
if ( ! F_142 ( V_7 -> V_97 . V_9 ) )
F_33 ( V_7 ) ;
}
static void F_143 ( struct V_246 * V_247 )
{
struct V_6 * V_7 = V_247 -> V_7 ;
if ( V_247 -> V_29 & V_325 )
F_72 ( V_7 ) ;
}
static void F_42 ( struct V_6 * V_7 , bool V_329 )
{
struct V_15 * V_16 = V_7 -> V_17 -> V_18 ;
void T_1 * V_22 = F_16 ( V_7 ) ;
struct V_169 * V_8 = V_7 -> V_97 . V_9 ;
T_2 V_330 , V_331 , V_332 , V_333 , V_334 ;
int V_136 ;
unsigned int V_286 ;
V_330 = F_2 ( V_22 + V_335 ) ;
if ( ! ( V_330 & V_336 ) ) {
...
if ( V_136 )
return;
V_331 = ( V_330 & V_340 ) >> V_341 ;
V_332 = V_342 / ( V_331 + 1 ) ;
if ( V_332 > 0x3ff )
V_332 = 0x3ff ;
if ( V_8 -> V_343 [ V_344 ] &
V_345 ) {
V_333 = V_8 -> V_343 [ V_346 ] &
V_347 ;
if ( ! V_333 )
V_333 = 10 ;
V_334 = V_8 -> V_343 [ V_348 ] ;
if ( ! V_334 )
V_334 = 20 ;
} else {
V_333 = 10 ;
...
static int F_149 ( struct V_6 * V_7 , T_10 V_356 )
{
const char * V_145 = NULL ;
int V_136 ;
V_136 = F_47 ( V_7 , & V_145 ) ;
...
T_5 V_358 ;
T_4 V_359 , V_360 ;
V_107 = F_152 ( V_8 , sizeof( * V_107 ) , V_361 ) ;
if ( ! V_107 )
return - V_362 ;
if ( V_7 -> V_17 -> V_180 > 1 ) {
V_107 -> V_363 = F_152 ( V_8 , 8 , V_361 ) ;
if ( ! V_107 -> V_363 ) {
F_153 ( V_8 , V_107 ) ;
return - V_362 ;
}
snprintf ( V_107 -> V_363 , 8 ,
L_64 , F_154 ( V_8 ) , V_7 -> V_156 ) ;
}
if ( ( V_16 -> V_19 & V_72 ) && F_155 ( V_7 ) ) {
void T_1 * V_22 = F_16 ( V_7 ) ;
T_2 V_116 = F_2 ( V_22 + V_24 ) ;
if ( V_116 & V_364 )
V_107 -> V_353 = true ;
...
V_357 = F_156 ( V_8 , V_359 , & V_358 , V_361 ) ;
if ( ! V_357 )
return - V_362 ;
memset ( V_357 , 0 , V_359 ) ;
V_107 -> V_196 = V_357 ;
V_107 -> V_108 = V_358 ;
V_357 += V_367 ;
V_358 += V_367 ;
...
void F_159 ( struct V_83 * V_17 , const char * V_370 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
...
static int F_161 ( struct V_83 * V_17 ,
struct V_393 * V_394 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
int V_2 , V_136 ;
...
int V_314 = F_163 ( V_16 , V_2 ) ;
if ( ! V_107 ) {
F_164 ( V_314 + V_2 ) ;
continue;
}
V_136 = F_165 ( V_17 -> V_8 , V_314 , F_129 ,
0 , V_107 -> V_363 , V_17 -> V_181 [ V_2 ] ) ;
if ( V_136 )
return V_136 ;
...
int V_136 ;
if ( V_16 -> V_29 & ( V_369 | V_395 ) ) {
if ( V_16 -> V_81 )
F_26 ( V_17 -> V_8 , L_99 ) ;
V_136 = F_161 ( V_17 , V_394 ) ;
} else {
