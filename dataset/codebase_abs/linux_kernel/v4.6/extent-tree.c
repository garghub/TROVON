...
for ( V_43 = 0 ; V_43 < V_347 ; V_43 ++ ) {
struct V_703 * V_360 ;
V_360 = V_96 -> V_704 [ V_43 ] ;
V_96 -> V_704 [ V_43 ] = NULL ;
if ( V_360 ) {
F_524 ( V_360 ) ;
F_525 ( V_360 ) ;
}
...
struct V_705 * V_706 ;
int V_29 ;
V_706 = F_61 ( sizeof( * V_706 ) , V_40 ) ;
if ( ! V_706 )
goto V_707;
V_706 -> V_381 = V_589 ;
F_527 ( & V_706 -> V_360 , & V_708 ) ;
V_29 = F_528 ( & V_706 -> V_360 , & V_96 -> V_360 ,
L_8 , F_419 ( V_589 ) ) ;
if ( V_29 ) {
F_525 ( & V_706 -> V_360 ) ;
goto V_707;
}
V_96 -> V_704 [ V_589 ] = & V_706 -> V_360 ;
}
return;
V_707:
F_529 ( L_45 ) ;
...
return - V_75 ;
V_67 -> V_78 = V_79 ;
V_714 = F_535 ( V_35 -> V_37 -> V_261 ) ;
if ( F_259 ( V_35 , V_312 ) &&
F_536 ( V_35 -> V_37 -> V_261 ) != V_714 )
V_713 = 1 ;
if ( F_259 ( V_35 , V_715 ) )
V_713 = 1 ;
while ( 1 ) {
...
V_2 = F_530 ( V_35 , V_718 , V_61 ) ;
if ( ! V_2 )
return - V_75 ;
F_387 ( & V_2 -> V_97 , V_95 ) ;
F_545 ( & V_2 -> V_97 , V_717 ) ;
F_546 ( & V_2 -> V_97 , type ) ;
V_2 -> V_7 = type ;
V_2 -> V_106 = ( T_2 ) - 1 ;
V_2 -> V_3 = V_4 ;
...
V_360 = V_14 -> V_96 -> V_704 [ V_589 ] ;
V_14 -> V_96 -> V_704 [ V_589 ] = NULL ;
...
F_11 ( & V_14 -> V_52 ) ;
V_14 -> V_726 = 1 ;
V_724 = ( F_209 ( & V_14 -> V_711 ) == 0 ) ;
if ( ! V_724 ) {
F_553 ( & V_723 -> V_99 , & V_35 -> V_37 -> V_727 ) ;
}
F_13 ( & V_14 -> V_52 ) ;
if ( V_724 ) {
struct V_728 * V_729 ;
V_729 = & V_35 -> V_37 -> V_48 . V_730 ;
F_554 ( & V_729 -> V_52 ) ;
F_555 ( V_729 , V_723 ) ;
F_556 ( & V_729 -> V_52 ) ;
F_552 ( V_723 ) ;
...
const T_2 V_718 )
{
struct V_728 * V_729 = & V_37 -> V_48 . V_730 ;
struct V_722 * V_723 ;
struct V_731 * V_732 ;
unsigned int V_733 ;
F_559 ( & V_729 -> V_52 ) ;
V_723 = F_560 ( V_729 , V_718 , 1 ) ;
F_561 ( & V_729 -> V_52 ) ;
ASSERT ( V_723 && V_723 -> V_32 == V_718 ) ;
V_732 = V_723 -> V_731 ;
V_733 = 3 + V_732 -> V_211 ;
F_552 ( V_723 ) ;
...
F_5 ( & V_118 -> V_746 ) ;
F_13 ( & V_37 -> V_744 ) ;
V_29 = F_574 ( V_118 , V_696 , V_742 , V_32 ,
& V_32 , & V_49 ) ;
if ( V_118 )
F_575 ( V_118 ) ;
if ( V_29 ) {
...
int F_577 ( struct V_34 * V_35 , struct V_748 * V_749 )
{
struct V_12 * V_37 = V_35 -> V_37 ;
struct V_1 * V_2 = NULL ;
struct V_695 * V_696 ;
...
while ( V_2 ) {
if ( V_2 -> V_21 . V_22 >= ( V_749 -> V_32 + V_749 -> V_49 ) ) {
F_6 ( V_2 ) ;
break;
}
V_32 = F_426 ( V_749 -> V_32 , V_2 -> V_21 . V_22 ) ;
V_31 = F_330 ( V_749 -> V_32 + V_749 -> V_49 ,
V_2 -> V_21 . V_22 + V_2 -> V_21 . V_33 ) ;
...
F_49 ( & V_35 -> V_37 -> V_379 -> V_752 ) ;
V_750 = & V_35 -> V_37 -> V_379 -> V_753 ;
F_181 (device, devices, dev_alloc_list) {
V_29 = F_572 ( V_696 , V_749 -> V_742 ,
& V_751 ) ;
if ( V_29 )
break;
V_555 += V_751 ;
}
F_47 ( & V_35 -> V_37 -> V_379 -> V_752 ) ;
V_749 -> V_49 = V_555 ;
return V_29 ;
}
void F_579 ( struct V_34 * V_35 )
{
F_580 ( & V_35 -> V_754 -> V_755 ) ;
F_2 () ;
if ( F_581 ( & V_35 -> V_754 -> V_91 ) )
F_52 ( & V_35 -> V_754 -> V_91 ) ;
}
int F_582 ( struct V_34 * V_35 )
{
if ( F_209 ( & V_35 -> V_756 ) )
return 0 ;
F_583 ( & V_35 -> V_754 -> V_755 ) ;
F_2 () ;
if ( F_209 ( & V_35 -> V_756 ) ) {
F_579 ( V_35 ) ;
return 0 ;
