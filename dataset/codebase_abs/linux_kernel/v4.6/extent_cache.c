...
if ( ! V_41 || ! V_41 -> V_34 )
return false ;
F_39 ( & V_7 , F_40 ( V_41 -> V_31 ) ,
F_40 ( V_41 -> V_42 ) , F_40 ( V_41 -> V_34 ) ) ;
F_41 ( & V_5 -> V_28 ) ;
if ( F_33 ( & V_5 -> V_16 ) )
goto V_43;
...
static bool F_44 ( struct V_20 * V_20 , T_2 V_45 ,
struct V_6 * V_7 )
{
struct V_2 * V_3 = F_18 ( V_20 ) ;
...
F_45 ( V_20 , V_45 ) ;
F_46 ( & V_5 -> V_28 ) ;
if ( V_5 -> V_37 . V_31 <= V_45 &&
V_5 -> V_37 . V_31 + V_5 -> V_37 . V_34 > V_45 ) {
* V_7 = V_5 -> V_37 ;
V_46 = true ;
F_47 ( V_3 ) ;
goto V_43;
}
V_11 = F_27 ( V_3 , V_5 , V_45 ) ;
if ( V_11 ) {
* V_7 = V_11 -> V_7 ;
F_12 ( & V_3 -> V_19 ) ;
if ( ! F_14 ( & V_11 -> V_14 ) ) {
F_48 ( & V_11 -> V_14 , & V_3 -> V_44 ) ;
V_5 -> V_18 = V_11 ;
}
F_16 ( & V_3 -> V_19 ) ;
V_46 = true ;
...
struct V_8 * * V_50 )
{
struct V_8 * * V_51 = & V_5 -> V_15 . V_8 ;
struct V_8 * V_9 = NULL , * V_52 ;
struct V_1 * V_11 = V_5 -> V_18 ;
* V_49 = NULL ;
* V_50 = NULL ;
* V_47 = NULL ;
...
static struct V_1 * F_55 ( struct V_2 * V_3 ,
struct V_4 * V_5 , struct V_6 * V_7 ,
struct V_1 * V_47 ,
struct V_1 * V_48 )
{
...
if ( V_48 && F_57 ( V_7 , & V_48 -> V_7 ) ) {
if ( V_11 )
F_11 ( V_3 , V_5 , V_47 ) ;
V_48 -> V_7 . V_31 = V_7 -> V_31 ;
V_48 -> V_7 . V_42 = V_7 -> V_42 ;
V_48 -> V_7 . V_34 += V_7 -> V_34 ;
V_11 = V_48 ;
}
if ( ! V_11 )
return NULL ;
...
static struct V_1 * F_59 ( struct V_2 * V_3 ,
struct V_4 * V_5 , struct V_6 * V_7 ,
struct V_8 * * V_49 ,
struct V_8 * V_50 )
{
...
struct V_8 * * V_49 = NULL , * V_50 = NULL ;
...
if ( V_65 ) {
F_39 ( & V_7 , V_61 ,
V_61 - V_59 . V_31 + V_59 . V_42 ,
V_64 - V_61 ) ;
V_56 = F_59 ( V_3 , V_5 , & V_7 ,
NULL , NULL ) ;
V_58 = V_56 ;
} else {
V_11 -> V_7 . V_31 = V_61 ;
V_11 -> V_7 . V_42 += V_61 - V_59 . V_31 ;
...
if ( V_55 ) {
F_39 ( & V_7 , V_31 , V_55 , V_34 ) ;
if ( ! F_55 ( V_3 , V_5 , & V_7 , V_57 , V_58 ) )
F_59 ( V_3 , V_5 , & V_7 ,
V_49 , V_50 ) ;
if ( V_59 . V_34 >= 1 &&
V_60 . V_34 < V_66 &&
...
bool F_78 ( struct V_20 * V_20 , T_2 V_45 ,
struct V_6 * V_7 )
{
if ( ! F_38 ( V_20 ) )
return false ;
return F_44 ( V_20 , V_45 , V_7 ) ;
}
...
if ( ! F_38 ( V_76 -> V_20 ) )
return;
if ( F_60 ( V_76 -> V_20 , V_31 , V_55 , V_34 ) )
F_82 ( V_76 ) ;
}
