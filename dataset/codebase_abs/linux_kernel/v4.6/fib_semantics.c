...
struct V_245 * V_93 ;
struct V_76 * V_246 ;
V_93 = F_111 ( V_91 , V_100 , V_92 , V_81 , sizeof( * V_246 ) , V_175 ) ;
if ( ! V_93 )
return - V_103 ;
V_246 = F_112 ( V_93 ) ;
V_246 -> V_247 = V_146 ;
...
int F_123 ( struct V_125 * V_125 , T_3 V_266 )
{
int V_127 = 0 ;
...
int F_124 ( struct V_70 * V_71 , unsigned long V_81 , bool V_267 )
{
int V_127 = 0 ;
int V_193 = V_241 ;
struct V_22 * V_268 = NULL ;
...
void F_126 ( const struct V_181 * V_273 , struct V_168 * V_169 )
{
struct V_22 * V_23 = NULL , * V_107 = NULL ;
struct V_64 * V_274 = V_169 -> V_274 ;
struct V_179 * V_275 = V_169 -> V_276 ;
T_6 V_277 = 32 - V_169 -> V_278 ;
int V_106 = - 1 , V_108 = - 1 ;
struct V_83 * V_84 , * V_279 = NULL ;
V_31 V_280 = V_169 -> V_23 -> V_62 ;
T_6 V_281 = 0 ;
F_127 (fa, fa_head, fa_list) {
struct V_22 * V_282 = V_84 -> V_97 ;
if ( V_84 -> V_283 != V_277 )
continue;
if ( V_84 -> V_102 && V_84 -> V_102 != V_273 -> V_284 )
continue;
if ( V_84 -> V_86 != V_275 -> V_86 )
continue;
if ( V_282 -> V_62 > V_280 &&
V_84 -> V_102 == V_281 ) {
if ( V_281 )
...
V_281 = V_84 -> V_102 ;
V_280 = V_282 -> V_62 ;
if ( V_282 -> V_60 != V_169 -> V_193 ||
V_84 -> V_101 != V_178 )
continue;
if ( ! V_282 -> V_5 [ 0 ] . V_48 ||
V_282 -> V_5 [ 0 ] . V_49 != V_173 )
continue;
F_128 ( V_84 ) ;
if ( ! V_23 ) {
if ( V_282 != V_169 -> V_23 )
