...
return 1 ;
case V_98 :
F_23 ( V_59 , V_34 , V_66 , V_67 , V_99 , V_100 ) ;
F_24 ( V_59 -> V_51 , V_99 , V_100 ) ;
F_21 ( V_34 , V_2 , V_59 ) ;
return 1 ;
case V_101 :
F_21 ( V_34 , V_2 , V_59 ) ;
V_2 -> V_102 ++ ;
V_2 -> V_103 = V_32 -> V_21 -> V_28 ;
return 1 ;
case V_104 :
F_23 ( V_59 , V_34 , V_66 , V_67 ,
V_84 , V_105 ) ;
if ( ! ( V_69 -> V_14 & V_106 ) )
F_17 ( V_59 -> V_51 , V_105 , V_32 ,
V_69 -> V_107 ) ;
F_21 ( V_34 , V_2 , V_59 ) ;
return 1 ;
case V_108 :
...
F_23 ( V_59 , V_34 , V_66 , V_67 ,
V_84 , V_113 ) ;
F_17 ( V_59 -> V_51 , V_113 , V_32 ,
V_69 -> V_114 ) ;
F_21 ( V_34 , V_2 , V_59 ) ;
return 1 ;
case V_115 :
if ( V_32 -> V_116 >= V_32 -> V_21 -> V_117 ||
V_34 -> V_37 >= V_32 -> V_38 )
return 1 ;
V_2 -> V_18 = V_32 -> V_116 ;
V_2 -> V_118 = V_34 -> V_37 ;
...
return 0 ;
case V_77 :
V_52 = V_120 + ( ( V_34 -> V_35 - 1 ) & V_121 ) ;
F_23 ( V_59 , V_34 , V_66 , V_67 , V_99 , V_52 ) ;
F_24 ( V_59 -> V_51 , V_99 , V_52 ) ;
return 1 ;
case 0xff000000 :
return - 1 ;
}
...
unsigned long * * V_66 , int * V_67 )
{
if ( V_34 -> type == V_99 || V_34 -> type == V_84 )
F_26 ( V_34 -> type , V_59 -> V_51 -> V_122 ) ;
return - 1 ;
}
...
V_2 -> V_5 >= V_2 -> V_127 )
return;
if ( V_2 -> V_128 || ( V_2 -> V_13 . V_14 & V_96 ) ) {
int V_129 = F_27 ( V_2 , V_51 ) ;
struct V_130 * V_131 = & V_2 -> V_3 ;
struct V_132 * V_133 = V_51 -> V_133 ;
if ( V_129 < 0 || V_129 >= V_2 -> V_43 )
return;
if ( ( V_2 -> V_13 . V_14 & V_134 ) && V_133 ) {
struct V_135 * V_136 = & V_133 -> V_137 [ V_129 ] ;
if ( F_30 ( V_136 ) &&
F_31 ( V_133 , V_136 ) )
return;
}
...
if ( V_131 -> V_139 || V_131 -> V_140 ) {
int V_141 = ( V_131 -> V_142 > V_131 -> V_143 ) ;
int V_144 = V_67 ( V_131 -> V_142 , V_131 -> V_143 ) >> 1 ;
int V_145 = F_33 ( V_131 -> V_142 , V_131 -> V_143 ) >> 1 ;
F_34 ( V_51 , V_84 , V_87 , V_131 -> V_146 ) ;
F_34 ( V_51 , V_84 , V_90 , V_131 -> V_147 ) ;
F_34 ( V_51 , V_84 , V_85 , V_131 -> V_148 ) ;
F_34 ( V_51 , V_84 , V_89 , V_131 -> V_149 ) ;
F_34 ( V_51 , V_84 , V_94 ,
! V_131 -> V_139 ) ;
F_34 ( V_51 , V_84 , V_111 , V_141 ) ;
F_34 ( V_51 , V_84 , V_113 , V_131 -> V_150 ) ;
F_34 ( V_51 , V_84 , V_105 , V_144 ) ;
F_34 ( V_51 , V_84 , V_109 , V_145 ) ;
}
}
V_2 -> V_5 ++ ;
}
...
{
if ( V_35 -> V_151 & V_152 && V_35 -> V_153 )
V_35 -> V_153 ( V_35 , V_32 , V_34 , V_44 ) ;
return 1 ;
}
...
T_4 V_14 = V_2 -> V_13 . V_14 ;
struct V_50 * V_51 = V_32 -> V_154 -> V_51 ;
if ( V_35 -> V_151 & V_155 ) {
switch ( V_34 -> V_35 ) {
case V_92 :
if ( V_14 & V_156 )
...
int V_44 = V_32 -> V_44 [ V_2 -> V_118 ] ;
if ( V_44 )
V_2 -> V_127 = V_44 ;
}
for ( V_159 = 0 ; V_159 < V_21 -> V_117 ; V_159 ++ ) {
V_32 = V_21 -> V_32 [ V_159 ] ;
V_15 = V_32 -> V_38 ;
if ( ! ( V_161 & V_32 -> V_162 ) )
continue;
for ( V_160 = 0 ; V_160 < V_15 ; V_160 ++ )
F_39 ( V_35 , V_32 , & V_32 -> V_34 [ V_160 ] ,
V_32 -> V_44 [ V_160 ] ) ;
}
if ( V_2 -> V_5 >= V_2 -> V_127 )
F_35 ( V_2 , V_21 -> V_32 [ 0 ] -> V_154 -> V_51 ) ;
}
...
if ( ! ( V_35 -> V_151 & V_155 ) )
return;
if ( V_21 -> V_28 == V_2 -> V_103 )
return F_40 ( V_35 , V_21 ) ;
if ( V_32 && V_32 -> V_154 && V_32 -> V_154 -> V_51 )
F_37 ( V_32 -> V_154 -> V_51 ) ;
}
...
V_27 ) ;
if ( V_25 ) {
sprintf ( V_25 , L_16 , V_12 -> V_25 , V_182 ) ;
V_59 -> V_51 -> V_25 = V_25 ;
}
}
return 0 ;
}
static int F_56 ( struct V_11 * V_12 , const struct V_190 * V_28 )
{
int V_22 , V_191 ;
struct V_1 * V_2 ;
...
if ( V_22 != 0 )
return V_22 ;
V_22 = F_59 ( V_12 , V_204 ) ;
if ( V_22 )
return V_22 ;
V_22 = F_60 ( & V_12 -> V_7 . V_205 , & V_206 ) ;
if ( V_22 )
F_11 ( & V_12 -> V_7 , L_19 ,
V_12 -> V_25 ) ;
F_53 ( V_12 ) ;
...
struct V_50 * V_50 = V_154 -> V_51 ;
struct V_132 * V_133 = V_50 -> V_133 ;
int V_191 ;
if ( V_133 ) {
for ( V_191 = 0 ; V_191 < V_133 -> V_207 ; V_191 ++ ) {
V_135 ( V_50 , V_191 ) ;
F_32 ( V_50 ,
V_138 ,
false ) ;
