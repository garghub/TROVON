...
int T_1 F_142 ( unsigned long V_205 )
{
T_2 V_136 , V_135 ;
if ( V_163 )
return - 1 ;
...
void T_1 F_122 ( unsigned long V_212 )
{
V_189 = V_212 ;
if ( ! V_121 ) {
F_144 ( V_213 , V_212 ) ;
...
while ( V_25 ) {
if ( V_25 & 0x1 )
F_64 ( V_140 , V_219 L_73 , V_217 [ V_157 ] ) ;
V_157 ++ ;
V_25 >>= 1 ;
}
F_64 ( V_140 , V_219 L_74 ) ;
}
...
V_151 | V_35 ) ;
V_131 |= V_224 | V_222 ;
V_131 = F_159 ( V_131 , V_226 ) ;
F_25 ( V_126 , V_131 ) ;
}
int F_160 ( int V_181 , int V_227 )
{
int V_114 , V_228 = V_229 ;
bool V_230 = F_161 ( V_209 ,
V_231 ) ;
if ( V_232 != V_167 &&
V_232 != F_120 () &&
V_232 == V_181 ) {
...
if ( ! V_230 && V_234 >= V_229 - 1 &&
V_181 != V_209 ) {
int V_233 = V_228 + V_235 - 1 ;
F_67 (
L_81
L_82
L_83 , V_228 , V_233 , V_181 ) ;
V_235 ++ ;
return - V_236 ;
}
if ( V_234 >= V_229 ) {
int V_233 = V_228 + V_235 ;
F_67 (
L_84
L_83 , V_228 , V_233 , V_181 ) ;
V_235 ++ ;
...
V_211 [ V_181 ] = V_227 ;
if ( V_227 != V_211 [ V_209 ] ) {
F_67 ( L_87 ,
V_211 [ V_209 ] , V_114 , V_227 ) ;
}
F_164 ( V_181 , V_231 ) ;
if ( V_181 > V_193 )
V_193 = V_181 ;
#if F_165 ( F_53 ) || F_165 ( F_13 )
F_103 ( V_239 , V_114 ) = V_181 ;
F_103 ( V_240 , V_114 ) = V_181 ;
#endif
#ifdef V_2
F_103 ( V_166 , V_114 ) =
V_12 -> V_241 ( V_114 ) ;
...
unsigned long V_242 ;
F_25 ( V_243 , V_244 ) ;
V_242 = F_11 ( V_245 ) & ~ V_246 ;
V_242 |= F_170 ( 1UL << F_43 () ) ;
F_25 ( V_245 , V_242 ) ;
}
int F_171 ( const struct V_68 * V_68 ,
const struct V_68 * V_247 ,
unsigned int * V_181 )
{
unsigned int V_114 ;
F_172 (cpu, cpumask, andmask) {
if ( F_173 ( V_114 , V_248 ) )
break;
}
if ( F_174 ( V_114 < V_229 ) ) {
* V_181 = F_78 ( V_239 , V_114 ) ;
return 0 ;
}
return - V_57 ;
}
...
return 0 ;
V_120 = F_30 () ;
V_256 . V_258 = F_11 ( V_182 ) ;
V_256 . V_259 = F_11 ( V_168 ) ;
V_256 . V_260 = F_11 ( V_245 ) ;
V_256 . V_261 = F_11 ( V_243 ) ;
V_256 . V_262 = F_11 ( V_132 ) ;
V_256 . V_263 = F_11 ( V_36 ) ;
if ( V_120 >= 4 )
V_256 . V_264 = F_11 ( V_127 ) ;
V_256 . V_265 = F_11 ( V_125 ) ;
V_256 . V_266 = F_11 ( V_126 ) ;
V_256 . V_267 = F_11 ( V_124 ) ;
V_256 . V_268 = F_11 ( V_42 ) ;
V_256 . V_269 = F_11 ( V_38 ) ;
#ifdef F_88
if ( V_120 >= 5 )
V_256 . V_270 = F_11 ( V_128 ) ;
#endif
#ifdef F_89
if ( V_120 >= 6 )
V_256 . V_271 = F_11 ( V_129 ) ;
#endif
F_24 ( V_21 ) ;
F_90 () ;
F_190 () ;
...
F_25 ( V_182 , V_256 . V_258 ) ;
F_25 ( V_243 , V_256 . V_261 ) ;
F_25 ( V_245 , V_256 . V_260 ) ;
F_25 ( V_168 , V_256 . V_259 ) ;
F_25 ( V_132 , V_256 . V_262 ) ;
F_25 ( V_125 , V_256 . V_265 ) ;
F_25 ( V_126 , V_256 . V_266 ) ;
#ifdef F_88
if ( V_120 >= 5 )
F_25 ( V_128 , V_256 . V_270 ) ;
#endif
#ifdef F_89
if ( V_120 >= 6 )
F_25 ( V_129 , V_256 . V_271 ) ;
#endif
if ( V_120 >= 4 )
F_25 ( V_127 , V_256 . V_264 ) ;
F_25 ( V_36 , V_256 . V_263 ) ;
F_25 ( V_38 , V_256 . V_269 ) ;
F_25 ( V_42 , V_256 . V_268 ) ;
F_25 ( V_130 , 0 ) ;
F_11 ( V_130 ) ;
F_25 ( V_124 , V_256 . V_267 ) ;
F_25 ( V_130 , 0 ) ;
F_11 ( V_130 ) ;
F_192 ( V_121 ) ;
F_27 ( V_21 ) ;
...
static void F_110 ( void ) { }
static int F_195 ( const struct V_273 * V_274 )
{
if ( V_275 )
return 0 ;
F_17 ( L_91 , V_274 -> V_276 ) ;
V_275 = 1 ;
return 0 ;
}
