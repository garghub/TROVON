...
F_12 ( V_56 -> V_70 ,
V_163 , 0x0082 , 0x0082 ) ;
F_15 ( V_56 -> V_70 , V_164 , 0x81 ) ;
F_15 ( V_56 -> V_70 , V_165 , 0x82 ) ;
F_15 ( V_56 -> V_70 , V_166 , 0x84 ) ;
F_12 ( V_56 -> V_70 , V_167 , 0x2 , 0x2 ) ;
V_56 -> V_71 = - 1 ;
if ( V_56 -> V_138 -> V_134 ) {
V_136 = F_66 ( V_56 -> V_138 -> V_134 , NULL , F_43 ,
V_168 | V_169 , L_15 , V_56 ) ;
if ( V_136 != 0 ) {
F_34 ( & V_138 -> V_2 ,
L_16 , V_136 ) ;
return V_136 ;
