...
struct V_42 * V_81 [] ,
T_9 * V_82 [] ,
const char * const V_83 [] )
{
struct V_21 * V_22 = F_22 ( V_20 ) ;
struct V_42 * V_46 ;
int V_84 = F_53 ( V_20 , V_80 , V_81 , V_82 , V_83 ) ;
if ( V_84 )
return V_84 ;
...
static inline int F_56 ( struct V_6 * V_7 , T_1 V_86 ,
T_4 V_87 , int * V_88 )
{
int V_89 ;
for ( V_89 = F_57 ( V_7 , V_90 ) ;
V_89 > 0 ;
V_89 = F_58 ( V_7 , V_89 , V_90 ) ) {
T_1 type , V_14 ;
F_15 ( V_7 , V_89 + F_16 ( struct V_18 ,
V_86 ) ,
& type ) ;
F_15 ( V_7 , V_89 + F_16 ( struct V_18 ,
V_14 ) ,
...
{
F_61 ( V_91 !=
F_16 ( struct V_18 , V_92 ) ) ;
F_61 ( V_93 !=
F_16 ( struct V_18 , V_94 ) ) ;
F_61 ( V_95 !=
F_16 ( struct V_18 , V_96 ) ) ;
F_61 ( V_97 !=
F_16 ( struct V_18 , V_86 ) ) ;
F_61 ( V_98 !=
...
int V_52 , V_24 , V_123 , V_124 , V_36 ;
T_4 V_125 ;
T_4 V_126 ;
F_60 () ;
...
return - V_127 ;
if ( V_6 -> V_36 < 0x1040 ) {
V_22 -> V_20 . V_128 . V_36 = V_6 -> V_129 ;
} else {
V_22 -> V_20 . V_128 . V_36 = V_6 -> V_36 - 0x1040 ;
}
V_22 -> V_20 . V_128 . V_130 = V_6 -> V_131 ;
V_24 = F_56 ( V_6 , V_132 ,
V_133 | V_134 ,
& V_22 -> V_135 ) ;
if ( ! V_24 ) {
...
V_123 = F_56 ( V_6 , V_136 ,
V_133 | V_134 ,
& V_22 -> V_135 ) ;
V_124 = F_56 ( V_6 , V_137 ,
V_133 | V_134 ,
& V_22 -> V_135 ) ;
if ( ! V_123 || ! V_124 ) {
F_18 ( & V_6 -> V_7 ,
...
if ( ! V_22 -> V_24 )
goto V_139;
V_22 -> V_123 = F_14 ( V_6 , V_123 , sizeof( T_1 ) , 1 ,
0 , 1 ,
NULL ) ;
if ( ! V_22 -> V_123 )
goto V_140;
F_17 ( V_6 ,
V_124 + F_16 ( struct V_102 ,
V_103 ) ,
& V_22 -> V_70 ) ;
F_17 ( V_6 ,
V_124 + F_16 ( struct V_102 ,
...
V_141 . V_15 ) ,
& V_126 ) ;
if ( ( T_5 ) V_125 + ( V_126 % V_142 ) <= V_142 ) {
V_22 -> V_69 = F_14 ( V_6 , V_124 , 2 , 2 ,
0 , V_125 ,
& V_22 -> V_71 ) ;
if ( ! V_22 -> V_69 )
goto V_72;
...
if ( ! V_22 -> V_36 )
goto V_143;
V_22 -> V_20 . V_144 = & V_145 ;
} else {
V_22 -> V_20 . V_144 = & V_146 ;
}
V_22 -> V_147 = F_40 ;
V_22 -> F_41 = F_41 ;
V_22 -> F_55 = F_55 ;
