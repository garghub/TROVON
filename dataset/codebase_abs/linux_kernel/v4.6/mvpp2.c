...
if ( V_519 -> V_523 )
V_64 |= V_526 ;
if ( V_519 -> V_383 == V_529 )
V_64 |= V_525 ;
else if ( V_519 -> V_383 == V_530 )
V_64 |= V_524 ;
F_2 ( V_64 , V_19 -> V_5 + V_376 ) ;
V_19 -> V_523 = V_519 -> V_523 ;
...
static void F_242 ( struct V_533 * V_534 )
{
T_7 V_535 ;
if ( ! V_534 -> V_536 ) {
V_534 -> V_536 = true ;
V_535 = F_243 ( 0 , V_537 ) ;
F_244 ( & V_534 -> V_538 , V_535 ,
V_539 ) ;
}
}
...
struct V_18 * V_19 = F_86 ( V_233 ) ;
struct V_533 * V_534 = F_216 ( V_19 -> V_452 ) ;
...
static enum V_540 F_247 ( struct V_541 * V_542 )
{
struct V_533 * V_534 = F_248 ( V_542 ,
struct V_533 ,
V_538 ) ;
F_249 ( & V_534 -> V_543 ) ;
return V_544 ;
...
return 0 ;
V_11 = F_125 ( V_19 , V_302 , & V_305 , V_561 ) ;
if ( ! V_11 )
return - V_148 ;
F_136 ( V_19 , V_337 , ( T_1 ) V_305 , ( T_1 ) V_11 ) ;
F_254 ( & V_302 -> V_311 ) ;
...
int V_457 = 0 ;
T_3 V_458 ;
if ( V_11 -> V_563 == F_256 ( V_218 ) ) {
struct V_163 * V_564 = F_257 ( V_11 ) ;
V_457 = V_564 -> V_565 ;
V_458 = V_564 -> V_563 ;
} else if ( V_11 -> V_563 == F_256 ( V_225 ) ) {
struct V_182 * V_566 = F_258 ( V_11 ) ;
if ( F_259 ( V_11 ) > 0 )
V_457 = ( F_259 ( V_11 ) >> 2 ) ;
V_458 = V_566 -> V_567 ;
} else {
...
V_569 = (struct V_568 * ) V_11 -> V_334 ;
V_341 = F_262 ( V_569 -> V_576 ) ;
V_573 = V_569 -> V_577 ;
V_574 = V_569 -> V_578 ;
F_135 ( V_19 , V_575 , V_571 ,
V_572 , V_341 ) ;
V_571 = V_573 ;
V_572 = V_574 ;
} while ( ! F_263 ( V_569 -> V_576 ) );
}
static int F_264 ( struct V_18 * V_19 , int V_579 ,
struct V_427 * V_355 )
{
...
T_4 V_305 ;
T_1 V_337 , V_570 ;
int V_336 , V_583 , V_232 ;
V_580 ++ ;
V_570 = V_428 -> V_432 ;
V_583 = V_428 -> V_547 - V_194 ;
V_305 = V_428 -> V_17 ;
V_337 = F_184 ( V_428 ) ;
V_336 = F_132 ( V_337 ) ;
...
F_266 ( V_11 , V_194 ) ;
F_267 ( V_11 , V_583 ) ;
V_11 -> V_563 = F_268 ( V_11 , V_233 ) ;
F_251 ( V_19 , V_570 , V_11 ) ;
F_269 ( & V_19 -> V_516 , V_11 ) ;
}
if ( V_581 ) {
struct V_589 * V_587 = F_216 ( V_19 -> V_587 ) ;
F_270 ( & V_587 -> V_590 ) ;
V_587 -> V_591 += V_581 ;
V_587 -> V_583 += V_582 ;
F_271 ( & V_587 -> V_590 ) ;
...
F_272 () ;
F_178 ( V_19 , V_355 -> V_21 , V_580 , V_580 ) ;
return V_579 ;
}
static inline void
...
int V_26 ;
T_4 V_17 ;
for ( V_26 = 0 ; V_26 < F_275 ( V_11 ) -> V_592 ; V_26 ++ ) {
T_8 * V_593 = & F_275 ( V_11 ) -> V_594 [ V_26 ] ;
void * V_595 = F_276 ( V_593 -> V_596 . V_597 ) + V_593 -> V_598 ;
V_13 = F_187 ( V_441 ) ;
V_13 -> V_599 = V_22 -> V_21 ;
V_13 -> V_547 = V_593 -> V_9 ;
V_17 = F_127 ( V_19 -> V_233 -> V_233 . V_333 , V_595 ,
V_13 -> V_547 ,
V_479 ) ;
...
T_1 V_604 ;
V_603 = F_278 ( V_11 ) ;
V_22 = V_19 -> V_413 [ V_603 ] ;
V_7 = F_216 ( V_22 -> V_452 ) ;
V_441 = & V_19 -> V_2 -> V_605 [ F_185 () ] ;
V_594 = F_275 ( V_11 ) -> V_592 + 1 ;
if ( F_189 ( V_19 -> V_2 , V_441 , V_594 ) ||
F_192 ( V_19 -> V_2 , V_22 ,
V_7 , V_594 ) ) {
V_594 = 0 ;
goto V_606;
...
F_188 ( V_19 , V_594 ) ;
if ( V_7 -> V_9 - V_7 -> V_442 < V_485 + 1 ) {
struct V_481 * V_482 = F_212 ( V_233 , V_603 ) ;
F_279 ( V_482 ) ;
}
V_606:
if ( V_594 > 0 ) {
...
F_270 ( & V_587 -> V_590 ) ;
V_587 -> V_609 ++ ;
V_587 -> V_610 += V_11 -> V_264 ;
F_271 ( & V_587 -> V_590 ) ;
} else {
V_233 -> V_587 . V_611 ++ ;
F_115 ( V_11 ) ;
}
if ( V_7 -> V_442 >= V_22 -> V_612 )
F_211 ( V_19 , V_22 , V_7 ) ;
if ( V_7 -> V_442 <= V_594 && V_7 -> V_442 > 0 ) {
struct V_533 * V_534 = F_216 ( V_19 -> V_452 ) ;
F_242 ( V_534 ) ;
}
return V_613 ;
...
static int F_281 ( struct V_617 * V_516 , int V_618 )
{
...
V_621 = V_619 & V_367 ;
if ( V_621 ) {
F_280 ( V_19 -> V_233 , V_621 ) ;
F_1 ( V_19 -> V_2 , V_623 , 0 ) ;
...
int V_442 ;
struct V_427 * V_355 ;
V_355 = F_208 ( V_19 , V_620 ) ;
if ( ! V_355 )
break;
V_442 = F_264 ( V_19 , V_618 , V_355 ) ;
V_580 += V_442 ;
V_618 -= V_442 ;
if ( V_618 > 0 ) {
V_620 &= ~ ( 1 << V_355 -> V_625 ) ;
...
static void F_296 ( struct V_18 * V_19 , unsigned char * V_595 )
{
T_1 V_634 , V_635 , V_636 ;
V_634 = F_4 ( V_19 -> V_5 + V_381 ) ;
V_635 = F_4 ( V_19 -> V_2 -> V_637 + V_638 ) ;
V_636 = F_4 ( V_19 -> V_2 -> V_637 + V_639 ) ;
V_595 [ 0 ] = ( V_636 >> 24 ) & 0xFF ;
V_595 [ 1 ] = ( V_636 >> 16 ) & 0xFF ;
V_595 [ 2 ] = ( V_636 >> 8 ) & 0xFF ;
V_595 [ 3 ] = V_636 & 0xFF ;
V_595 [ 4 ] = V_635 & 0xFF ;
V_595 [ 5 ] = ( V_634 >> V_640 ) & 0xFF ;
}
static int F_297 ( struct V_18 * V_19 )
{
struct V_518 * V_520 ;
V_520 = F_298 ( V_19 -> V_233 , V_19 -> V_641 , F_240 , 0 ,
V_19 -> V_370 ) ;
if ( ! V_520 ) {
...
V_232 = F_302 ( V_19 -> V_514 , F_238 , 0 , V_233 -> V_648 , V_19 ) ;
if ( V_232 ) {
...
struct V_651 * V_652 ;
int V_21 = V_19 -> V_21 ;
bool V_653 = V_233 -> V_392 & V_654 ;
F_46 ( V_2 , V_21 , V_233 -> V_392 & V_655 ) ;
F_47 ( V_2 , V_21 , V_114 , V_653 ) ;
F_47 ( V_2 , V_21 , V_196 , V_653 ) ;
F_88 ( V_2 , V_21 ) ;
if ( V_653 && ! F_308 ( V_233 ) ) {
F_309 (ha, dev)
F_82 ( V_2 , V_21 , V_652 -> V_595 , true ) ;
}
}
static int F_310 ( struct V_269 * V_233 , void * V_597 )
{
struct V_18 * V_19 = F_86 ( V_233 ) ;
const struct V_656 * V_595 = V_597 ;
int V_232 ;
if ( ! F_311 ( V_595 -> V_657 ) ) {
V_232 = - V_658 ;
goto error;
}
if ( ! F_246 ( V_233 ) ) {
V_232 = F_85 ( V_233 , V_595 -> V_657 ) ;
if ( ! V_232 )
return 0 ;
...
static struct V_660 *
F_313 ( struct V_269 * V_233 , struct V_660 * V_587 )
{
struct V_18 * V_19 = F_86 ( V_233 ) ;
unsigned int V_101 ;
int V_364 ;
...
T_9 V_609 ;
T_9 V_610 ;
V_661 = F_193 ( V_19 -> V_587 , V_364 ) ;
do {
V_101 = F_315 ( & V_661 -> V_590 ) ;
V_591 = V_661 -> V_591 ;
V_583 = V_661 -> V_583 ;
V_609 = V_661 -> V_609 ;
V_610 = V_661 -> V_610 ;
} while ( F_316 ( & V_661 -> V_590 , V_101 ) );
V_587 -> V_591 += V_591 ;
V_587 -> V_583 += V_583 ;
V_587 -> V_609 += V_609 ;
V_587 -> V_610 += V_610 ;
}
V_587 -> V_588 = V_233 -> V_587 . V_588 ;
V_587 -> V_662 = V_233 -> V_587 . V_662 ;
V_587 -> V_611 = V_233 -> V_587 . V_611 ;
return V_587 ;
}
...
if ( ! V_19 -> V_520 )
return - V_666 ;
V_147 = F_318 ( V_19 -> V_520 , V_664 , V_665 ) ;
if ( ! V_147 )
F_240 ( V_233 ) ;
return V_147 ;
}
...
for ( V_390 = 0 ; V_390 < V_411 ; V_390 ++ ) {
struct V_412 * V_22 = V_19 -> V_413 [ V_390 ] ;
V_22 -> V_612 = V_669 -> V_672 ;
}
return 0 ;
}
static int F_324 ( struct V_269 * V_233 ,
struct V_668 * V_669 )
{
struct V_18 * V_19 = F_86 ( V_233 ) ;
V_669 -> V_670 = V_19 -> V_326 [ 0 ] -> V_478 ;
V_669 -> V_671 = V_19 -> V_326 [ 0 ] -> V_476 ;
V_669 -> V_672 = V_19 -> V_413 [ 0 ] -> V_612 ;
return 0 ;
}
static void F_325 ( struct V_269 * V_233 ,
struct V_673 * V_674 )
{
F_326 ( V_674 -> V_675 , V_676 ,
sizeof( V_674 -> V_675 ) ) ;
F_326 ( V_674 -> V_677 , V_678 ,
sizeof( V_674 -> V_677 ) ) ;
F_326 ( V_674 -> V_679 , F_327 ( & V_233 -> V_233 ) ,
sizeof( V_674 -> V_679 ) ) ;
}
static void F_328 ( struct V_269 * V_233 ,
struct V_626 * V_627 )
{
struct V_18 * V_19 = F_86 ( V_233 ) ;
V_627 -> V_680 = V_632 ;
...
static int F_329 ( struct V_269 * V_233 ,
struct V_626 * V_627 )
{
struct V_18 * V_19 = F_86 ( V_233 ) ;
...
static void F_330 ( struct V_18 * V_19 )
{
F_156 ( V_19 ) ;
F_160 ( V_19 ) ;
F_157 ( V_19 ) ;
...
static int F_331 ( struct V_18 * V_19 )
{
...
struct V_412 * V_22 ;
V_22 = F_332 ( V_233 , sizeof( * V_22 ) , V_98 ) ;
if ( ! V_22 )
return - V_148 ;
V_22 -> V_452 = F_333 ( struct V_6 ) ;
if ( ! V_22 -> V_452 ) {
V_232 = - V_148 ;
goto V_688;
}
...
for ( V_390 = 0 ; V_390 < V_357 ; V_390 ++ ) {
struct V_427 * V_355 ;
V_355 = F_332 ( V_233 , sizeof( * V_355 ) , V_98 ) ;
if ( ! V_355 ) {
V_232 = - V_148 ;
goto V_688;
}
...
if ( ! V_19 -> V_413 [ V_390 ] )
continue;
F_335 ( V_19 -> V_413 [ V_390 ] -> V_452 ) ;
}
return V_232 ;
}
static int F_336 ( struct V_230 * V_231 ,
struct V_692 * V_693 ,
struct V_1 * V_2 ,
int * V_694 )
{
...
V_233 = F_337 ( sizeof( struct V_18 ) , V_411 ,
V_357 ) ;
if ( ! V_233 )
return - V_148 ;
V_641 = F_338 ( V_693 , L_37 , 0 ) ;
if ( ! V_641 ) {
...
V_19 -> V_641 = V_641 ;
V_19 -> V_370 = V_701 ;
V_696 = F_343 ( V_231 , V_711 ,
V_702 + V_21 ) ;
V_19 -> V_5 = F_344 ( & V_231 -> V_233 , V_696 ) ;
if ( F_345 ( V_19 -> V_5 ) ) {
V_232 = F_346 ( V_19 -> V_5 ) ;
goto V_650;
}
V_19 -> V_587 = F_347 ( struct V_589 ) ;
if ( ! V_19 -> V_587 ) {
V_232 = - V_148 ;
goto V_650;
}
...
F_148 (cpu) {
V_534 = F_193 ( V_19 -> V_452 , V_364 ) ;
F_351 ( & V_534 -> V_538 , V_714 ,
V_539 ) ;
V_534 -> V_538 . V_715 = F_247 ;
V_534 -> V_536 = false ;
F_352 ( & V_534 -> V_543 , F_245 ,
( unsigned long ) V_233 ) ;
}
F_353 ( V_233 , & V_19 -> V_516 , F_281 , V_716 ) ;
V_700 = V_717 | V_718 ;
...
static void F_357 ( struct V_18 * V_19 )
{
int V_26 ;
F_358 ( V_19 -> V_233 ) ;
F_335 ( V_19 -> V_452 ) ;
...
static void F_359 ( const struct V_725 * V_726 ,
struct V_1 * V_2 )
{
T_1 V_727 ;
int V_26 ;
for ( V_26 = 0 ; V_26 < 6 ; V_26 ++ ) {
F_1 ( V_2 , F_360 ( V_26 ) , 0 ) ;
F_1 ( V_2 , F_361 ( V_26 ) , 0 ) ;
if ( V_26 < 4 )
...
static int F_366 ( struct V_230 * V_231 , struct V_1 * V_2 )
{
...
V_2 -> V_605 = F_75 ( & V_231 -> V_233 , F_195 () ,
sizeof( struct V_412 ) ,
V_98 ) ;
if ( ! V_2 -> V_605 )
return - V_148 ;
...
static int F_368 ( struct V_230 * V_231 )
{
...
int V_749 , V_296 ;
int V_232 ;
V_2 = F_332 ( & V_231 -> V_233 , sizeof( struct V_1 ) , V_98 ) ;
if ( ! V_2 )
return - V_148 ;
V_696 = F_343 ( V_231 , V_711 , 0 ) ;
V_2 -> V_5 = F_344 ( & V_231 -> V_233 , V_696 ) ;
if ( F_345 ( V_2 -> V_5 ) )
return F_346 ( V_2 -> V_5 ) ;
V_696 = F_343 ( V_231 , V_711 , 1 ) ;
V_2 -> V_637 = F_344 ( & V_231 -> V_233 , V_696 ) ;
if ( F_345 ( V_2 -> V_637 ) )
return F_346 ( V_2 -> V_637 ) ;
V_2 -> V_750 = F_369 ( & V_231 -> V_233 , L_50 ) ;
if ( F_345 ( V_2 -> V_750 ) )
return F_346 ( V_2 -> V_750 ) ;
V_232 = F_370 ( V_2 -> V_750 ) ;
if ( V_232 < 0 )
return V_232 ;
V_2 -> V_751 = F_369 ( & V_231 -> V_233 , L_51 ) ;
if ( F_345 ( V_2 -> V_751 ) ) {
V_232 = F_346 ( V_2 -> V_751 ) ;
goto V_752;
}
V_232 = F_370 ( V_2 -> V_751 ) ;
if ( V_232 < 0 )
goto V_752;
V_2 -> V_399 = F_371 ( V_2 -> V_750 ) ;
V_232 = F_366 ( V_231 , V_2 ) ;
if ( V_232 < 0 ) {
...
V_296 = 0 ;
F_373 (dn, port_node) {
V_232 = F_336 ( V_231 , V_693 , V_2 , & V_296 ) ;
if ( V_232 < 0 )
goto V_753;
}
F_374 ( V_231 , V_2 ) ;
...
static int F_376 ( struct V_230 * V_231 )
{
struct V_1 * V_2 = F_377 ( V_231 ) ;
struct V_692 * V_747 = V_231 -> V_233 . V_748 ;
struct V_692 * V_693 ;
int V_26 = 0 ;
F_373 (dn, port_node) {
if ( V_2 -> V_724 [ V_26 ] )
F_357 ( V_2 -> V_724 [ V_26 ] ) ;
V_26 ++ ;
}
for ( V_26 = 0 ; V_26 < V_320 ; V_26 ++ ) {
...
F_148 (i) {
struct V_412 * V_441 = & V_2 -> V_605 [ V_26 ] ;
F_103 ( & V_231 -> V_233 ,
V_743 * V_488 ,
V_441 -> V_414 ,
V_441 -> V_489 ) ;
