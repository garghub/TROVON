...
struct V_5 * V_6 ;
struct V_99 * V_23 = F_9 ( V_96 -> V_68 . V_69 ) ;
struct V_100 V_101 = {} ;
V_6 = F_17 ( & V_96 -> V_68 , sizeof( struct V_5 ) , V_102 ) ;
if ( ! V_6 )
return - V_103 ;
F_18 ( & V_96 -> V_68 , V_6 ) ;
V_6 -> V_23 = V_23 ;
...
if ( V_96 -> V_104 == V_111 )
F_4 ( V_6 ) ;
* V_63 = F_21 ( & V_96 -> V_68 , V_98 , & V_101 ) ;
return F_22 ( * V_63 ) ;
}
static int F_23 ( struct V_95 * V_96 )
{
struct V_5 * V_6 = F_24 ( V_96 ) ;
F_25 ( & V_6 -> V_92 ) ;
F_26 ( V_6 -> V_23 , & V_6 -> V_7 ) ;
switch ( V_96 -> V_104 ) {
case V_105 :
F_27 ( V_15 ) ;
break;
