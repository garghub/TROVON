...
V_2 -> V_31 -> V_1222 = 7 ;
V_2 -> V_31 -> V_1223 = 1 ;
V_1211 -> V_1224 = V_1225 | V_1226 ;
switch ( V_2 -> V_78 . V_463 ) {
case V_1195 :
case V_1179 :
V_1211 -> V_1227 = 14 ;
V_1211 -> V_1228 = V_1229 ;
break;
case V_1196 :
case V_1194 :
V_1211 -> V_1227 = F_170 ( V_1229 ) ;
V_1211 -> V_1228 = V_1229 ;
break;
case V_627 :
case V_4 :
...
case V_639 :
V_1211 -> V_1227 = 14 ;
V_1211 -> V_1228 = V_1230 ;
break;
case V_629 :
case V_630 :
V_1211 -> V_1227 = F_170 ( V_1230 ) ;
V_1211 -> V_1228 = V_1230 ;
break;
case V_640 :
F_31 ( V_2 , V_1231 , & V_9 ) ;
if ( F_13 ( V_9 , V_1232 ) ) {
V_1211 -> V_1227 = F_170 ( V_1233 ) ;
V_1211 -> V_1228 = V_1233 ;
} else {
V_1211 -> V_1227 = F_170 ( V_1234 ) ;
V_1211 -> V_1228 = V_1234 ;
}
break;
}
if ( F_71 ( ! V_1211 -> V_1228 ) )
return - V_1197 ;
V_1211 -> V_1235 = V_1236 ;
if ( V_1211 -> V_1227 > 14 )
V_1211 -> V_1235 |= V_1237 ;
if ( ! F_4 ( V_2 , V_627 ) )
V_1211 -> V_129 . V_1238 = true ;
else
V_1211 -> V_129 . V_1238 = false ;
V_1211 -> V_129 . V_1239 =
V_1240 |
V_1241 |
V_1242 |
V_1243 ;
if ( V_2 -> V_456 . V_448 >= 2 )
V_1211 -> V_129 . V_1239 |= V_1244 ;
V_1211 -> V_129 . V_1239 |= V_2 -> V_456 . V_450 <<
V_1245 ;
V_1211 -> V_129 . V_1246 = 3 ;
V_1211 -> V_129 . V_1247 = 4 ;
V_1211 -> V_129 . V_134 . V_1248 =
V_1249 |
V_1250 |
( ( V_2 -> V_456 . V_448 - 1 ) <<
V_1251 ) ;
switch ( V_2 -> V_456 . V_450 ) {
case 3 :
V_1211 -> V_129 . V_134 . V_1252 [ 2 ] = 0xff ;
case 2 :
V_1211 -> V_129 . V_134 . V_1252 [ 1 ] = 0xff ;
case 1 :
V_1211 -> V_129 . V_134 . V_1252 [ 0 ] = 0xff ;
V_1211 -> V_129 . V_134 . V_1252 [ 4 ] = 0x1 ;
break;
}
V_483 = F_227 ( V_1211 -> V_1227 , sizeof( * V_483 ) , V_1253 ) ;
if ( ! V_483 )
return - V_1254 ;
V_1211 -> V_1255 = V_483 ;
V_492 = F_23 ( V_2 , V_1256 ) ;
V_495 = F_23 ( V_2 , V_1257 ) ;
if ( V_2 -> V_456 . V_448 > 2 )
V_548 = F_23 ( V_2 ,
V_1258 ) ;
else
...
V_548 = NULL ;
for ( V_40 = 14 ; V_40 < V_1211 -> V_1227 ; V_40 ++ ) {
...
F_31 ( V_2 , V_67 , & V_9 ) ;
V_79 = F_13 ( V_9 , V_1265 ) ;
V_1263 = F_13 ( V_9 , V_1266 ) ;
switch ( V_79 ) {
case V_93 :
case V_3 :
case V_848 :
...
void F_232 ( struct V_1282 * V_31 ,
struct V_285 * V_286 ,
struct V_1283 * V_1284 )
{
struct V_1 * V_2 = V_31 -> V_1285 ;
struct V_287 V_288 ;
T_2 V_39 ;
if ( V_286 -> V_189 != V_1286 )
return;
V_39 = F_92 ( V_286 -> V_289 ) ;
F_233 ( V_2 , V_39 ,
& V_288 , sizeof( V_288 ) ) ;
memcpy ( & V_1284 -> V_1287 . V_1288 , & V_288 . V_300 [ 0 ] , 2 ) ;
memcpy ( & V_1284 -> V_1287 . V_1289 , & V_288 . V_300 [ 4 ] , 4 ) ;
}
int F_234 ( struct V_1282 * V_31 , T_2 V_8 )
{
struct V_1 * V_2 = V_31 -> V_1285 ;
T_2 V_9 ;
...
int F_235 ( struct V_1282 * V_31 ,
struct V_312 * V_313 , T_3 V_1290 ,
const struct V_1291 * V_1292 )
{
struct V_1 * V_2 = V_31 -> V_1285 ;
struct V_220 * V_156 ;
struct V_304 V_305 ;
...
T_2 V_9 ;
T_2 V_39 ;
V_98 = F_236 ( V_31 , V_313 , V_1290 , V_1292 ) ;
if ( V_98 )
return V_98 ;
if ( V_1290 >= 4 )
return 0 ;
V_156 = F_237 ( V_2 , V_1290 ) ;
V_39 = V_1293 + ( sizeof( T_2 ) * ( ! ! ( V_1290 & 2 ) ) ) ;
V_305 . V_308 = ( V_1290 & 1 ) * 16 ;
V_305 . V_309 = 0xffff << V_305 . V_308 ;
F_31 ( V_2 , V_39 , & V_9 ) ;
F_9 ( & V_9 , V_305 , V_156 -> V_132 ) ;
F_32 ( V_2 , V_39 , V_9 ) ;
V_305 . V_308 = V_1290 * 4 ;
V_305 . V_309 = 0xf << V_305 . V_308 ;
F_31 ( V_2 , V_1294 , & V_9 ) ;
F_9 ( & V_9 , V_305 , V_156 -> V_1295 ) ;
F_32 ( V_2 , V_1294 , V_9 ) ;
F_31 ( V_2 , V_1296 , & V_9 ) ;
F_9 ( & V_9 , V_305 , V_156 -> V_1297 ) ;
F_32 ( V_2 , V_1296 , V_9 ) ;
F_31 ( V_2 , V_1298 , & V_9 ) ;
F_9 ( & V_9 , V_305 , V_156 -> V_1299 ) ;
F_32 ( V_2 , V_1298 , V_9 ) ;
V_39 = V_1300 + ( sizeof( T_2 ) * V_1290 ) ;
F_31 ( V_2 , V_39 , & V_9 ) ;
F_9 ( & V_9 , V_1301 , V_156 -> V_132 ) ;
F_9 ( & V_9 , V_1302 , V_156 -> V_1295 ) ;
F_9 ( & V_9 , V_1303 , V_156 -> V_1297 ) ;
F_9 ( & V_9 , V_1304 , V_156 -> V_1299 ) ;
F_32 ( V_2 , V_39 , V_9 ) ;
return 0 ;
}
T_7 F_238 ( struct V_1282 * V_31 , struct V_312 * V_313 )
{
struct V_1 * V_2 = V_31 -> V_1285 ;
T_7 V_1305 ;
T_2 V_9 ;
F_31 ( V_2 , V_1306 , & V_9 ) ;
V_1305 = ( T_7 ) F_13 ( V_9 , V_1307 ) << 32 ;
F_31 ( V_2 , V_1308 , & V_9 ) ;
V_1305 |= F_13 ( V_9 , V_1309 ) ;
return V_1305 ;
}
int F_239 ( struct V_1282 * V_31 , struct V_312 * V_313 ,
struct V_1310 * V_1292 )
{
struct V_314 * V_315 = V_1292 -> V_315 ;
enum V_1311 V_1312 = V_1292 -> V_1312 ;
T_3 V_1313 = V_1292 -> V_1313 ;
...
break;
case V_1317 :
F_240 ( V_313 , V_315 -> V_323 , V_1313 ) ;
break;
case V_1318 :
case V_1319 :
case V_1320 :
F_241 ( V_313 , V_315 -> V_323 , V_1313 ) ;
break;
case V_1321 :
break;
default:
F_5 ( (struct V_1 * ) V_31 -> V_1285 ,
L_20 ) ;
}
return V_888 ;
}
int F_242 ( struct V_1282 * V_31 , int V_576 ,
...
if ( V_576 != 0 )
return - V_1327 ;
V_1323 -> V_464 = V_352 -> V_856 . V_732 ;
F_31 ( V_2 , V_667 , & V_1324 ) ;
F_31 ( V_2 , V_668 , & V_1325 ) ;
F_31 ( V_2 , V_669 , & V_1326 ) ;
if ( V_1324 || V_1325 ) {
