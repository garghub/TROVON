...
F_27 ( & V_6 -> V_55 , V_56 ) ;
V_6 -> V_1 . V_57 = true ;
V_51 = F_28 ( V_6 -> V_13 , V_6 -> V_13 -> V_41 -> V_1 ) ;
if ( V_51 ) {
V_6 -> V_1 . V_57 = false ;
F_29 ( & V_6 -> V_12 ) ;
return V_51 ;
...
void F_35 ( struct V_5 * V_6 , int V_58 )
{
unsigned long V_23 ;
if ( ! V_6 -> V_13 -> V_59 )
return;
if ( F_36 ( & V_6 -> V_1 . V_27 [ V_58 ] ) == 1 ) {
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
}
bool F_37 ( struct V_5 * V_6 , int V_58 )
{
return F_36 ( & V_6 -> V_1 . V_27 [ V_58 ] ) == 1 ;
}
void F_38 ( struct V_5 * V_6 , int V_58 )
{
unsigned long V_23 ;
if ( ! V_6 -> V_13 -> V_59 )
return;
if ( F_39 ( & V_6 -> V_1 . V_27 [ V_58 ] ) ) {
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
}
void F_40 ( struct V_5 * V_6 , int V_60 )
{
unsigned long V_23 ;
if ( V_60 < 0 || V_60 >= V_6 -> V_52 )
return;
if ( ! V_6 -> V_13 -> V_59 )
return;
if ( F_36 ( & V_6 -> V_1 . V_33 [ V_60 ] ) == 1 ) {
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
...
if ( ! V_6 -> V_13 -> V_59 )
return;
if ( F_39 ( & V_6 -> V_1 . V_33 [ V_60 ] ) ) {
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
}
void F_42 ( struct V_5 * V_6 , int V_61 )
{
unsigned long V_23 ;
if ( ! V_6 -> V_13 -> V_59 )
return;
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
V_6 -> V_1 . V_34 [ V_61 ] = true ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
void F_43 ( struct V_5 * V_6 , int V_61 )
{
unsigned long V_23 ;
if ( ! V_6 -> V_13 -> V_59 )
return;
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
V_6 -> V_1 . V_34 [ V_61 ] = false ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
void F_44 ( struct V_5 * V_6 , unsigned V_62 )
{
unsigned long V_23 ;
int V_24 ;
if ( ! V_6 -> V_13 -> V_59 )
...
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
for ( V_24 = 0 ; V_24 < V_29 ; ++ V_24 )
V_6 -> V_1 . V_30 [ V_24 ] |= ! ! ( V_62 & ( 1 << V_24 ) ) ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
void F_45 ( struct V_5 * V_6 , unsigned V_62 )
{
unsigned long V_23 ;
int V_24 ;
if ( ! V_6 -> V_13 -> V_59 )
