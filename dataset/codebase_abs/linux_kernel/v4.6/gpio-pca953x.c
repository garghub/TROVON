...
static bool F_32 ( struct V_1 * V_2 , T_2 * V_67 )
{
T_2 V_68 [ V_32 ] ;
T_2 V_69 [ V_32 ] ;
bool V_70 = false ;
...
static T_3 F_33 ( int V_63 , void * V_74 )
{
struct V_1 * V_2 = V_74 ;
T_2 V_67 [ V_32 ] ;
T_2 V_57 ;
...
static int F_43 ( struct V_1 * V_2 , T_1 V_89 )
{
int V_6 ;
T_2 V_4 [ V_32 ] ;
...
static int F_44 ( struct V_1 * V_2 , T_1 V_89 )
{
int V_6 ;
T_2 V_4 [ V_32 ] ;
...
static int F_45 ( struct V_80 * V_12 ,
...
V_103 = F_48 ( V_104 , & V_12 -> V_13 ) ;
if ( V_103 ) {
V_2 -> V_81 = ( int ) ( V_105 ) V_103 -> V_106 ;
} else {
V_95 = F_49 ( V_107 , & V_12 -> V_13 ) ;
if ( ! V_95 )
return - V_108 ;
V_2 -> V_81 = V_95 -> V_81 ;
}
}
V_2 -> V_15 = F_50 ( V_2 -> V_81 ) ;
F_37 ( & V_2 -> V_21 ) ;
F_24 ( V_2 , V_2 -> V_81 & V_109 ) ;
if ( V_2 -> V_15 == V_16 )
V_6 = F_43 ( V_2 , V_89 ) ;
else
V_6 = F_44 ( V_2 , V_89 ) ;
...
{
struct V_96 * V_97 = F_47 ( & V_12 -> V_13 ) ;
