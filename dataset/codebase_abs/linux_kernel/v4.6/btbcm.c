...
int F_20 ( struct V_1 * V_2 , char * V_37 , T_3 V_11 )
{
T_4 V_38 , V_39 ;
...
snprintf ( V_37 , V_11 , L_18 , V_40 ? : L_19 ) ;
break;
default:
return 0 ;
}
F_8 ( L_20 , V_2 -> V_10 ,
V_40 ? : L_19 , ( V_38 & 0xe000 ) >> 13 ,
...
if ( F_3 ( V_6 ) )
return F_4 ( V_6 ) ;
F_8 ( L_22 , V_2 -> V_10 , ( char * ) ( V_6 -> V_13 + 1 ) ) ;
F_6 ( V_6 ) ;
switch ( ( V_39 & 0xf000 ) >> 12 ) {
case 0 :
case 3 :
...
snprintf ( V_37 , sizeof( V_37 ) , L_18 ,
V_40 ? : L_19 ) ;
break;
case 1 :
case 2 :
...
if ( F_3 ( V_6 ) )
return F_4 ( V_6 ) ;
V_48 = F_23 ( V_6 -> V_13 + 1 ) ;
V_47 = F_23 ( V_6 -> V_13 + 3 ) ;
F_6 ( V_6 ) ;
...
snprintf ( V_37 , sizeof( V_37 ) , L_23 ,
V_40 ? : L_19 , V_48 , V_47 ) ;
break;
default:
return 0 ;
...
V_40 ? : L_19 , ( V_38 & 0xe000 ) >> 13 ,
( V_38 & 0x1f00 ) >> 8 , ( V_38 & 0x00ff ) , V_39 & 0x0fff ) ;
V_9 = F_24 ( & V_21 , V_37 , & V_2 -> V_50 ) ;
if ( V_9 < 0 ) {
F_8 ( L_24 , V_2 -> V_10 , V_37 ) ;
goto V_27;
}
F_11 ( V_2 , V_21 ) ;
F_25 ( V_21 ) ;
