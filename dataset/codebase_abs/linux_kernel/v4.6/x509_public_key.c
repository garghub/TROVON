...
if ( V_32 -> V_42 . V_43 )
return 0 ;
V_32 -> V_42 . V_43 = F_21 ( V_32 -> V_44 , V_32 -> V_45 ,
V_19 ) ;
if ( ! V_32 -> V_42 . V_43 )
return - V_20 ;
V_32 -> V_42 . V_46 = V_32 -> V_45 ;
V_34 = F_22 ( V_32 -> V_42 . V_47 , 0 , 0 ) ;
if ( F_11 ( V_34 ) ) {
if ( F_12 ( V_34 ) == - V_48 ) {
V_32 -> V_40 = true ;
return - V_41 ;
...
goto error;
F_30 () ;
V_7 = F_31 ( V_36 , V_32 -> V_51 , V_32 -> V_52 , V_39 ) ;
error:
F_32 ( V_34 ) ;
F_17 ( L_11 , V_29 , V_7 ) ;
return V_7 ;
}
int F_33 ( const struct V_53 * V_54 ,
struct V_31 * V_32 )
{
int V_7 ;
F_17 ( L_10 , V_29 ) ;
...
F_17 ( L_15 , V_32 -> V_54 -> V_71 ) ;
F_17 ( L_16 , V_32 -> V_73 , V_32 -> V_74 ) ;
F_17 ( L_17 ,
V_32 -> V_42 . V_71 ,
V_32 -> V_42 . V_47 ) ;
V_32 -> V_54 -> V_75 = L_18 ;
if ( ( ! V_32 -> V_57 && ! V_32 -> V_59 ) ||
F_16 ( V_32 -> V_13 , V_32 -> V_57 ) ||
F_16 ( V_32 -> V_5 , V_32 -> V_59 ) ) {
V_7 = F_33 ( V_32 -> V_54 , V_32 ) ;
if ( V_7 < 0 )
goto V_72;
} else if ( ! V_64 -> V_76 ) {
V_7 = F_35 ( V_32 , F_40 () ) ;
...
V_7 = - V_20 ;
V_36 = F_5 ( V_67 + 2 + V_66 * 2 + 1 , V_19 ) ;
if ( ! V_36 )
goto V_72;
V_3 = memcpy ( V_36 , V_32 -> V_70 , V_67 ) ;
V_3 += V_67 ;
* V_3 ++ = ':' ;
* V_3 ++ = ' ' ;
V_3 = F_7 ( V_3 , V_65 , V_66 ) ;
* V_3 = 0 ;
...
F_42 ( V_82 . V_83 ) ;
V_64 -> V_61 . V_8 [ V_84 ] = & V_82 ;
V_64 -> V_61 . V_8 [ V_85 ] = V_27 ;
V_64 -> V_61 . V_8 [ V_62 ] = V_32 -> V_54 ;
V_64 -> V_86 = V_36 ;
V_64 -> V_87 = 100 ;
V_32 -> V_54 = NULL ;
V_32 -> V_5 = NULL ;
