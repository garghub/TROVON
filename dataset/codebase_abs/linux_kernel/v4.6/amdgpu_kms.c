...
struct V_182 V_183 = {} ;
struct V_184 V_185 ;
V_183 . V_186 = V_2 -> V_16 -> V_187 ;
V_183 . V_188 = V_4 -> V_189 ;
V_183 . V_190 = V_4 -> V_191 ;
V_183 . V_192 = V_2 -> V_16 -> V_193 ;
V_183 . V_194 = V_4 -> V_194 ;
V_183 . V_195 = V_4 -> V_60 . V_196 . V_197 ;
V_183 . V_198 = V_4 -> V_60 . V_196 . V_199 ;
V_183 . V_200 = F_33 ( V_4 ) * 10 ;
if ( V_4 -> V_127 . V_201 ) {
V_183 . V_202 =
V_4 -> V_127 . V_203 . V_204 . V_205 . V_206 * 10 ;
V_183 . V_207 =
V_4 -> V_127 . V_203 . V_204 . V_205 . V_208 * 10 ;
} else {
V_183 . V_202 = V_4 -> V_127 . V_209 * 10 ;
V_183 . V_207 = V_4 -> V_127 . V_210 * 10 ;
}
V_183 . V_211 = V_4 -> V_60 . V_196 . V_212 ;
V_183 . V_213 = V_4 -> V_60 . V_196 . V_214 ;
V_183 . V_215 = V_4 -> V_60 . V_196 . V_216 ;
V_183 . V_217 = 0 ;
V_183 . V_218 = 0 ;
if ( V_4 -> V_8 & V_14 )
V_183 . V_218 |= V_219 ;
V_183 . V_220 = V_221 ;
V_183 . V_222 = ( T_3 ) V_4 -> V_223 . V_224 * V_64 ;
V_183 . V_225 = F_34 ( ( int ) V_226 , V_64 ) ;
V_183 . V_227 = ( 1 << V_228 ) *
V_64 ;
V_183 . V_229 = V_64 ;
F_35 ( V_4 , & V_185 ) ;
V_183 . V_230 = V_185 . V_231 ;
V_183 . V_232 = V_185 . V_233 ;
V_183 . V_234 = V_4 -> V_60 . V_234 ;
memcpy ( & V_183 . V_235 [ 0 ] , & V_185 . V_236 [ 0 ] , sizeof( V_185 . V_236 ) ) ;
V_183 . V_237 = V_4 -> V_107 . V_237 ;
V_183 . V_238 = V_4 -> V_107 . V_239 ;
V_183 . V_240 = V_4 -> V_80 . V_241 ;
...
int F_39 ( struct V_1 * V_2 , struct V_19 * V_242 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_243 * V_244 ;
int V_9 ;
...
if ( V_9 < 0 )
return V_9 ;
V_244 = F_9 ( sizeof( * V_244 ) , V_11 ) ;
if ( F_40 ( ! V_244 ) )
return - V_12 ;
V_9 = F_41 ( V_4 , & V_244 -> V_246 ) ;
if ( V_9 )
goto V_247;
F_42 ( & V_244 -> V_248 ) ;
F_43 ( & V_244 -> V_249 ) ;
...
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_243 * V_244 = V_242 -> V_245 ;
struct V_251 * V_252 ;
int V_253 ;
if ( ! V_244 )
return;
F_46 ( & V_244 -> V_250 ) ;
F_47 ( V_4 , & V_244 -> V_246 ) ;
...
T_4 F_55 ( struct V_1 * V_2 , unsigned int V_254 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_255 , V_256 , V_257 ;
T_4 V_93 ;
if ( V_254 >= V_4 -> V_25 . V_41 ) {
F_56 ( L_6 , V_254 ) ;
return - V_35 ;
}
if ( V_4 -> V_25 . V_42 [ V_254 ] ) {
do {
V_93 = F_57 ( V_4 , V_254 ) ;
V_257 = F_58 (
V_2 , V_254 , V_258 ,
& V_255 , & V_256 , NULL , NULL ,
& V_4 -> V_25 . V_42 [ V_254 ] -> V_43 . V_259 ) ;
} while ( V_93 != F_57 ( V_4 , V_254 ) );
...
int F_60 ( struct V_1 * V_2 , unsigned int V_254 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_262 = F_61 ( V_4 , V_254 ) ;
return F_62 ( V_4 , & V_4 -> V_263 , V_262 ) ;
}
void F_63 ( struct V_1 * V_2 , unsigned int V_254 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_262 = F_61 ( V_4 , V_254 ) ;
F_64 ( V_4 , & V_4 -> V_263 , V_262 ) ;
}
int F_65 ( struct V_1 * V_2 , unsigned int V_254 ,
int * V_264 ,
struct V_265 * V_266 ,
unsigned V_8 )
{
...
V_30 = & V_4 -> V_25 . V_42 [ V_254 ] -> V_43 ;
if ( ! V_30 ) {
F_56 ( L_10 , V_254 ) ;
return - V_35 ;
}
return F_66 ( V_2 , V_254 , V_264 ,
V_266 , V_8 ,
& V_30 -> V_259 ) ;
}
