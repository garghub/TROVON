...
V_2 -> V_243 = 0 ;
if ( ( sizeof( T_6 ) > 4 ) &&
! F_485 ( V_6 , F_142 ( 64 ) ) && V_793 ) {
V_2 -> V_243 |= V_693 ;
V_18 -> V_165 |= V_694 ;
} else {
V_195 = F_485 ( V_6 , F_142 ( 32 ) ) ;
if ( V_195 < 0 ) {
F_11 ( V_2 , V_335 , V_18 , L_39 ) ;
goto V_794;
}
}
V_23 = F_486 ( F_487 ( V_6 , V_774 ) , V_178 ) ;
if ( ! V_23 ) {
...
V_18 -> V_799 = & V_800 ;
V_18 -> V_801 = V_802 ;
F_491 ( V_18 , & V_2 -> V_611 , F_426 , V_803 ) ;
V_18 -> V_165 |= V_242 |
V_804 | V_245 ;
