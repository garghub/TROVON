...
static int F_84 ( struct V_1 * V_237 ,
struct V_257 * V_258 )
{
int V_65 ;
struct V_5 * V_6 = V_237 -> V_6 ;
...
V_252 = F_87 ( V_267 , & V_258 , V_237 ) ;
if ( ! V_252 )
return - V_192 ;
V_277 . V_276 = V_258 . V_276 ;
V_237 -> V_252 = V_252 ;
V_19 = F_86 ( V_237 , & V_258 ) ;
if ( F_83 ( V_19 ) )
F_80 ( V_252 ) ;
return V_19 ;
}
static struct V_281 * F_88 ( struct V_282 * V_8 )
{
struct V_283 * V_284 ;
struct V_281 * V_285 ;
V_284 = F_89 ( V_8 ) ;
...
static T_3 * F_92 ( struct V_5 * V_6 , T_1 V_44 )
{
T_3 * V_286 ;
struct V_184 * V_114 = & V_6 -> V_185 ;
if ( V_6 -> V_99 & V_287 ) {
...
V_286 = & V_186 -> V_188 [ V_95 ] ;
} else {
V_286 = & V_114 -> V_181 [ V_44 * V_183 ] ;
}
return V_286 ;
}
static int F_93 ( struct V_281 * V_285 )
{
int V_7 ;
struct V_1 * V_237 = V_285 -> V_4 ;
struct V_137 * V_138 = & V_285 -> V_138 ;
struct V_5 * V_6 = V_285 -> V_6 ;
if ( V_237 -> V_238 == V_239 ) {
...
for ( V_7 = 0 ; V_7 < V_285 -> V_288 ; ++ V_7 ) {
T_1 V_44 = V_285 -> V_289 [ V_7 ] ;
T_3 * V_286 = F_92 ( V_6 , V_44 ) ;
F_46 ( V_6 , V_44 , V_286 , V_138 ) ;
}
return 0 ;
}
static void F_94 ( struct V_282 * V_8 )
{
struct V_281 * V_285 = F_88 ( V_8 ) ;
V_285 -> V_138 . V_148 = true ;
if ( F_83 ( F_93 ( V_285 ) ) )
F_36 ( V_8 , L_35 ) ;
V_285 -> V_4 = NULL ;
}
static int F_95 ( struct V_2 * V_4 , struct V_282 * V_8 )
{
int V_19 = 0 ;
struct V_5 * V_6 ;
struct V_1 * V_237 = F_1 ( V_4 ) ;
...
goto V_290;
V_285 -> V_4 = V_237 ;
V_285 -> V_138 . V_148 = V_4 -> type == V_248 ;
V_19 = F_93 ( V_285 ) ;
if ( F_83 ( V_19 ) )
V_285 -> V_4 = NULL ;
V_290:
...
static int F_99 ( struct V_2 * V_4 , unsigned long V_240 ,
T_9 V_292 , T_5 V_46 , int V_293 )
{
int V_19 ;
unsigned long V_294 ;
struct V_1 * V_237 = F_1 ( V_4 ) ;
struct V_268 * V_295 = V_237 -> V_252 ;
if ( ! V_295 )
return - V_296 ;
F_100 ( & V_237 -> V_250 , V_294 ) ;
V_19 = V_295 -> V_251 ( V_295 , V_240 , V_292 , V_46 , V_293 ) ;
F_101 ( & V_237 -> V_250 , V_294 ) ;
return V_19 ;
}
static T_5
F_102 ( struct V_2 * V_4 , unsigned long V_240 , T_5 V_46 )
{
T_5 V_19 ;
unsigned long V_294 ;
struct V_1 * V_237 = F_1 ( V_4 ) ;
...
static T_9
F_103 ( struct V_2 * V_4 , T_10 V_240 )
{
T_9 V_19 ;
unsigned long V_294 ;
struct V_1 * V_237 = F_1 ( V_4 ) ;
...
static int F_104 ( struct V_299 * V_300 , T_8 V_301 , void * V_302 )
{
* ( T_1 * ) V_302 = V_301 ;
return 0 ;
}
static void F_105 ( void * V_303 )
{
F_70 ( V_303 ) ;
}
static struct V_5 * F_106 ( struct V_299 * V_300 )
{
struct V_304 * V_9 ;
struct V_305 * V_306 ;
struct V_5 * V_6 = NULL ;
...
while ( ! F_107 ( V_308 ) )
V_308 = V_308 -> V_309 ;
V_9 = F_108 ( V_308 -> V_310 -> V_309 -> V_9 , L_37 , 0 ) ;
if ( ! V_9 )
return NULL ;
V_306 = F_109 ( V_9 ) ;
if ( V_306 )
...
static bool F_112 ( struct V_5 * V_6 , T_1 V_44 )
{
...
static int F_113 ( struct V_282 * V_8 )
{
int V_7 , V_19 ;
T_1 V_44 , * V_289 ;
struct V_299 * V_300 ;
...
V_285 = F_68 ( sizeof( * V_285 ) , V_190 ) ;
if ( ! V_285 ) {
V_19 = - V_192 ;
goto V_313;
}
V_285 -> V_138 . V_147 = true ;
V_285 -> V_6 = V_6 ;
F_119 ( V_284 , V_285 ,
F_105 ) ;
} else {
...
F_120 ( V_300 , F_104 , & V_44 ) ;
for ( V_7 = 0 ; V_7 < V_285 -> V_288 ; ++ V_7 ) {
if ( V_285 -> V_289 [ V_7 ] == V_44 )
goto V_314;
}
if ( ! F_112 ( V_6 , V_44 ) ) {
V_19 = - V_315 ;
...
V_285 -> V_288 ++ ;
V_289 = F_121 ( V_285 -> V_289 , V_285 -> V_288 * sizeof( * V_289 ) ,
V_190 ) ;
if ( ! V_289 ) {
V_285 -> V_288 -- ;
V_19 = - V_192 ;
...
static void F_123 ( struct V_282 * V_8 )
{
F_122 ( V_8 ) ;
}
...
int V_19 ;
F_72 ( & V_6 -> V_94 . V_101 ) ;
V_19 = F_126 ( V_6 , & V_6 -> V_94 . V_15 , V_332 ,
V_333 , V_36 ) ;
if ( V_19 )
return V_19 ;
V_19 = F_126 ( V_6 , & V_6 -> V_194 . V_15 , V_334 ,
V_335 , V_196 ) ;
if ( V_19 )
return V_19 ;
if ( ! ( V_6 -> V_99 & V_336 ) )
return 0 ;
return F_126 ( V_6 , & V_6 -> V_203 . V_15 , V_337 ,
V_338 , V_204 ) ;
}
...
V_114 -> V_186 = F_129 ( V_6 -> V_8 , V_46 , V_190 ) ;
if ( ! V_114 -> V_186 ) {
F_33 ( V_6 -> V_8 , L_39 ) ;
return - V_192 ;
}
...
V_46 = F_131 ( V_46 , V_6 -> V_341 - V_187 ) ;
}
V_114 -> V_312 = 1 << V_46 ;
V_46 += V_187 ;
if ( V_46 < V_6 -> V_341 )
...
static int F_136 ( struct V_5 * V_6 , T_1 V_103 ,
unsigned int V_355 , unsigned int V_356 )
{
T_1 V_339 ;
F_137 ( V_103 , V_6 -> V_224 + V_355 ) ;
return F_138 ( V_6 -> V_224 + V_356 , V_339 , V_339 == V_103 ,
1 , V_25 ) ;
}
static void F_139 ( void * V_303 )
{
struct V_282 * V_8 = V_303 ;
F_140 ( V_8 ) ;
}
static void F_141 ( struct V_357 * V_130 , struct V_358 * V_359 )
{
T_9 V_360 ;
struct V_282 * V_8 = F_142 ( V_130 ) ;
struct V_5 * V_6 = F_143 ( V_8 ) ;
T_9 * V_114 = V_361 [ V_130 -> V_362 . V_363 ] ;
V_360 = ( ( ( T_4 ) V_359 -> V_364 ) << 32 ) | V_359 -> V_365 ;
V_360 &= V_366 << V_367 ;
F_144 ( V_360 , V_6 -> V_224 + V_114 [ 0 ] ) ;
F_137 ( V_359 -> V_303 , V_6 -> V_224 + V_114 [ 1 ] ) ;
F_137 ( V_368 , V_6 -> V_224 + V_114 [ 2 ] ) ;
}
static void F_145 ( struct V_5 * V_6 )
{
struct V_357 * V_130 ;
int V_19 , V_369 = V_370 ;
struct V_282 * V_8 = V_6 -> V_8 ;
F_144 ( 0 , V_6 -> V_224 + V_371 ) ;
F_144 ( 0 , V_6 -> V_224 + V_372 ) ;
if ( V_6 -> V_99 & V_336 )
F_144 ( 0 , V_6 -> V_224 + V_373 ) ;
else
V_369 -- ;
if ( ! ( V_6 -> V_99 & V_374 ) )
return;
V_19 = F_146 ( V_8 , V_369 , F_141 ) ;
if ( V_19 ) {
F_36 ( V_8 , L_43 ) ;
return;
}
...
( V_391 << V_395 ) |
( V_391 << V_396 ) ;
F_137 ( V_339 , V_6 -> V_224 + V_397 ) ;
V_339 = V_398 | V_399 | V_400 ;
F_137 ( V_339 , V_6 -> V_224 + V_401 ) ;
F_144 ( V_6 -> V_185 . V_354 ,
V_6 -> V_224 + V_402 ) ;
F_137 ( V_6 -> V_185 . V_349 ,
V_6 -> V_224 + V_403 ) ;
F_144 ( V_6 -> V_94 . V_15 . V_326 , V_6 -> V_224 + V_404 ) ;
F_137 ( V_6 -> V_94 . V_15 . V_16 , V_6 -> V_224 + V_332 ) ;
F_137 ( V_6 -> V_94 . V_15 . V_17 , V_6 -> V_224 + V_333 ) ;
V_387 = V_405 ;
V_19 = F_136 ( V_6 , V_387 , V_385 ,
V_386 ) ;
if ( V_19 ) {
F_33 ( V_6 -> V_8 , L_56 ) ;
return V_19 ;
...
V_34 . V_37 = V_87 ;
F_35 ( V_6 , & V_34 ) ;
F_144 ( V_6 -> V_194 . V_15 . V_326 , V_6 -> V_224 + V_407 ) ;
F_137 ( V_6 -> V_194 . V_15 . V_16 , V_6 -> V_224 + V_334 ) ;
F_137 ( V_6 -> V_194 . V_15 . V_17 , V_6 -> V_224 + V_335 ) ;
V_387 |= V_408 ;
V_19 = F_136 ( V_6 , V_387 , V_385 ,
V_386 ) ;
if ( V_19 ) {
...
if ( V_6 -> V_99 & V_336 ) {
F_144 ( V_6 -> V_203 . V_15 . V_326 ,
V_6 -> V_224 + V_409 ) ;
F_137 ( V_6 -> V_203 . V_15 . V_16 ,
V_6 -> V_224 + V_337 ) ;
F_137 ( V_6 -> V_203 . V_15 . V_17 ,
V_6 -> V_224 + V_338 ) ;
V_387 |= V_410 ;
V_19 = F_136 ( V_6 , V_387 , V_385 ,
V_386 ) ;
...
if ( F_154 ( V_425 ) && V_339 & V_426 )
V_6 -> V_99 |= V_336 ;
if ( F_154 ( F_49 ) && V_339 & V_427 )
V_6 -> V_99 |= V_428 ;
if ( V_339 & V_429 )
V_6 -> V_99 |= V_100 ;
if ( V_339 & V_430 )
...
V_6 -> V_259 = V_339 & V_444 ? 16 : 8 ;
V_6 -> V_262 = V_339 & V_445 ? 16 : 8 ;
V_339 = F_11 ( V_6 -> V_224 + V_446 ) ;
if ( V_339 & ( V_447 | V_448 | V_449 ) ) {
F_33 ( V_6 -> V_8 , L_67 ) ;
return - V_291 ;
}
V_6 -> V_94 . V_15 . V_324 = F_131 ( ( T_1 ) V_450 ,
V_339 >> V_451 & V_452 ) ;
if ( ! V_6 -> V_94 . V_15 . V_324 ) {
F_33 ( V_6 -> V_8 , L_68 ) ;
return - V_291 ;
}
V_6 -> V_194 . V_15 . V_324 = F_131 ( ( T_1 ) V_453 ,
V_339 >> V_454 & V_455 ) ;
V_6 -> V_203 . V_15 . V_324 = F_131 ( ( T_1 ) V_456 ,
V_339 >> V_457 & V_458 ) ;
...
if ( F_156 ( V_6 -> V_8 , F_157 ( V_6 -> V_265 ) ) )
F_36 ( V_6 -> V_8 ,
L_70 ) ;
V_6 -> V_264 = F_158 ( V_6 -> V_264 , V_6 -> V_265 ) ;
F_55 ( V_6 -> V_8 , L_71 ,
V_6 -> V_264 , V_6 -> V_265 , V_6 -> V_99 ) ;
return 0 ;
}
static int F_159 ( struct V_305 * V_300 )
{
int V_193 , V_19 ;
struct V_486 * V_487 ;
struct V_5 * V_6 ;
struct V_282 * V_8 = & V_300 -> V_8 ;
...
V_6 -> V_8 = V_8 ;
V_487 = F_160 ( V_300 , V_488 , 0 ) ;
if ( F_161 ( V_487 ) + 1 < V_489 ) {
F_33 ( V_8 , L_73 , V_487 ) ;
return - V_86 ;
}
V_6 -> V_224 = F_162 ( V_8 , V_487 ) ;
if ( F_117 ( V_6 -> V_224 ) )
return F_118 ( V_6 -> V_224 ) ;
V_193 = F_163 ( V_300 , L_74 ) ;
if ( V_193 > 0 )
V_6 -> V_194 . V_15 . V_193 = V_193 ;
V_193 = F_163 ( V_300 , L_75 ) ;
if ( V_193 > 0 )
V_6 -> V_203 . V_15 . V_193 = V_193 ;
V_193 = F_163 ( V_300 , L_76 ) ;
if ( V_193 > 0 )
V_6 -> V_94 . V_15 . V_193 = V_193 ;
V_193 = F_163 ( V_300 , L_77 ) ;
if ( V_193 > 0 )
V_6 -> V_377 = V_193 ;
F_3 ( V_6 ) ;
V_19 = F_153 ( V_6 ) ;
...
static int F_165 ( struct V_305 * V_300 )
{
struct V_5 * V_6 = F_110 ( V_300 ) ;
F_61 ( V_6 ) ;
return 0 ;
}
...
if ( V_19 )
return V_19 ;
return F_169 ( & V_493 , & V_277 ) ;
}
static void T_12 F_170 ( void )
{
return F_171 ( & V_492 ) ;
}
