...
V_8 -> V_123 , V_8 -> V_122 ) ;
F_12 ( V_8 , V_139 , 4 , 0 ) ;
F_12 ( V_8 , V_140 , 2 , V_141 ) ;
F_11 ( V_8 , V_142 , 4 , & V_3 ) ;
V_3 |= V_143 ;
F_12 ( V_8 , V_142 , 4 , V_3 ) ;
V_8 -> V_144 = V_8 -> V_126 -> V_111 ;
if ( F_63 ( F_36 ) ) {
V_73 = F_66 ( V_8 -> V_78 , V_8 -> V_144 ,
& V_145 , V_8 , & V_44 ,
& V_133 ) ;
V_133 . V_78 = V_8 -> V_78 ;
} else
V_73 = F_67 ( V_8 -> V_78 , V_8 -> V_144 , & V_145 ,
V_8 , & V_44 ) ;
if ( ! V_73 )
return - V_127 ;
if ( V_8 -> V_10 -> V_146 )
...
T_2 V_149 , int V_14 , int V_2 , T_2 * V_3 )
{
int V_33 , type ;
T_2 V_150 , V_151 ;
T_3 V_18 ;
void T_1 * V_152 ;
if ( V_8 -> V_10 -> V_136 )
return V_8 -> V_10 -> V_136 ( V_8 , V_73 , V_149 , V_14 , V_2 , V_3 ) ;
V_150 = F_76 ( V_73 -> V_153 ) | F_77 ( F_78 ( V_149 ) ) |
F_79 ( F_80 ( V_149 ) ) ;
if ( V_73 -> V_154 -> V_153 == V_8 -> V_144 ) {
type = V_155 ;
V_18 = V_8 -> V_110 ;
V_151 = V_8 -> V_108 ;
V_152 = V_8 -> V_113 ;
...
void T_1 * V_152 ;
if ( V_8 -> V_10 -> V_159 )
return V_8 -> V_10 -> V_159 ( V_8 , V_73 , V_149 , V_14 , V_2 , V_3 ) ;
V_150 = F_76 ( V_73 -> V_153 ) | F_77 ( F_78 ( V_149 ) ) |
F_79 ( F_80 ( V_149 ) ) ;
if ( V_73 -> V_154 -> V_153 == V_8 -> V_144 ) {
type = V_155 ;
...
{
if ( V_73 -> V_153 != V_8 -> V_144 ) {
if ( ! F_44 ( V_8 ) )
return 0 ;
}
if ( V_73 -> V_153 == V_8 -> V_144 && V_78 > 0 )
return 0 ;
if ( V_73 -> V_160 == V_8 -> V_144 && V_78 > 0 )
return 0 ;
return 1 ;
}
static int F_83 ( struct V_101 * V_73 , T_2 V_149 , int V_14 ,
int V_2 , T_2 * V_3 )
{
struct V_7 * V_8 = V_73 -> V_74 ;
if ( F_82 ( V_8 , V_73 , F_78 ( V_149 ) ) == 0 ) {
* V_3 = 0xffffffff ;
return V_161 ;
}
if ( V_73 -> V_153 == V_8 -> V_144 )
return F_11 ( V_8 , V_14 , V_2 , V_3 ) ;
return F_75 ( V_8 , V_73 , V_149 , V_14 , V_2 , V_3 ) ;
}
static int F_84 ( struct V_101 * V_73 , T_2 V_149 ,
...
return F_81 ( V_8 , V_73 , V_149 , V_14 , V_2 , V_3 ) ;
}
...
F_10 ( V_8 , V_3 , V_142 ) ;
F_10 ( V_8 , 0x00000004 , V_139 ) ;
F_10 ( V_8 , 0x00000000 , V_175 ) ;
F_9 ( V_8 , V_176 , & V_3 ) ;
V_3 &= 0xffff00ff ;
V_3 |= 0x00000100 ;
F_10 ( V_8 , V_3 , V_176 ) ;
...
V_3 |= 0x00010100 ;
F_10 ( V_8 , V_3 , V_177 ) ;
V_162 = ( ( T_2 ) V_8 -> V_128 & 0xfff00000 ) >> 16 ;
V_163 = ( V_8 -> V_122 + ( T_2 ) V_8 -> V_128 ) & 0xfff00000 ;
V_3 = V_163 | V_162 ;
F_10 ( V_8 , V_3 , V_178 ) ;
F_9 ( V_8 , V_179 , & V_3 ) ;
V_3 &= 0xffff0000 ;
