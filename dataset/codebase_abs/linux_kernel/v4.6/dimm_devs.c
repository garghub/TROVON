...
void * F_41 ( struct V_3 * V_3 )
{
if ( V_3 )
return V_3 -> V_53 ;
return NULL ;
}
static T_3 F_42 ( struct V_40 * V_5 ,
...
F_43 (cmd, nvdimm->dsm_mask, BITS_PER_LONG)
V_34 += sprintf ( V_33 + V_34 , L_6 , F_44 ( V_12 ) ) ;
V_34 += sprintf ( V_33 + V_34 , L_5 ) ;
return V_34 ;
}
static T_3 F_45 ( struct V_40 * V_5 , struct V_54 * V_55 ,
char * V_33 )
{
struct V_3 * V_3 = F_2 ( V_5 ) ;
F_29 ( V_5 ) ;
F_32 ( V_5 ) ;
return sprintf ( V_33 , L_4 , F_46 ( & V_3 -> V_56 )
? L_7 : L_8 ) ;
}
static T_3 F_47 ( struct V_40 * V_5 ,
struct V_54 * V_55 , char * V_33 )
{
...
struct V_3 * F_50 ( struct V_14 * V_14 , void * V_53 ,
...
F_52 ( & V_3 -> V_56 , 0 ) ;
V_5 = & V_3 -> V_5 ;
F_53 ( V_5 , L_11 , V_3 -> V_42 ) ;
V_5 -> V_61 = & V_14 -> V_5 ;
V_5 -> type = & V_43 ;
V_5 -> V_62 = F_54 ( V_63 , V_3 -> V_42 ) ;
V_5 -> V_59 = V_59 ;
F_55 ( V_5 ) ;
return V_3 ;
}
T_4 F_56 ( struct V_47 * V_47 )
{
struct V_1 * V_2 = F_23 ( V_47 ) ;
T_4 V_64 , V_56 = 0 , V_65 ;
struct V_50 * V_51 ;
if ( ! V_2 )
return 0 ;
V_64 = V_47 -> V_66 + V_47 -> V_67 - 1 ;
F_57 (ndd, res)
if ( V_51 -> V_66 >= V_47 -> V_66 && V_51 -> V_66 < V_64 ) {
T_4 V_68 = F_14 ( V_64 , V_51 -> V_68 ) ;
V_56 += V_68 - V_51 -> V_66 + 1 ;
} else if ( V_51 -> V_68 >= V_47 -> V_66
&& V_51 -> V_68 <= V_64 ) {
V_56 += V_51 -> V_68 - V_47 -> V_66 ;
} else if ( V_47 -> V_66 > V_51 -> V_66
&& V_47 -> V_66 < V_51 -> V_68 ) {
V_56 += V_47 -> V_67 ;
}
V_65 = V_64 - V_47 -> V_66 + 1 ;
if ( V_56 < V_65 )
return V_65 - V_56 ;
return 0 ;
}
T_4 F_58 ( struct V_46 * V_46 ,
struct V_47 * V_47 , T_4 * V_69 )
{
T_4 V_70 , V_64 , V_56 = 0 , V_65 , V_71 ;
struct V_1 * V_2 = F_23 ( V_47 ) ;
struct V_50 * V_51 ;
const char * V_72 ;
if ( ! V_2 )
return 0 ;
V_70 = V_47 -> V_66 ;
V_64 = V_70 + V_47 -> V_67 - 1 ;
V_71 = F_59 ( V_70 , V_64 + 1 - * V_69 ) ;
F_57 (ndd, res)
if ( V_51 -> V_66 >= V_70 && V_51 -> V_66 < V_64 ) {
if ( strncmp ( V_51 -> V_73 , L_12 , 3 ) == 0 )
V_71 = F_14 ( V_71 , V_51 -> V_66 ) ;
else if ( V_51 -> V_66 != V_70 ) {
V_72 = L_13 ;
goto V_74;
} else {
if ( V_56 ) {
...
} else if ( V_51 -> V_68 >= V_70 && V_51 -> V_68 <= V_64 ) {
if ( strncmp ( V_51 -> V_73 , L_12 , 3 ) == 0 ) {
V_71 = V_70 ;
} else {
V_72 = L_13 ;
...
} else if ( V_70 > V_51 -> V_66 && V_70 < V_51 -> V_68 ) {
V_56 += V_47 -> V_67 ;
V_71 = V_70 ;
}
* V_69 = V_64 + 1 - V_71 ;
...
F_24 ( ! F_25 ( V_2 -> V_5 ) ) ;
F_15 ( V_51 -> V_73 ) ;
F_62 ( & V_2 -> V_75 , V_51 -> V_66 , F_60 ( V_51 ) ) ;
}
struct V_50 * F_63 ( struct V_1 * V_2 ,
struct V_76 * V_77 , T_4 V_66 ,
T_4 V_78 )
{
char * V_73 = F_64 ( V_77 , sizeof( * V_77 ) , V_27 ) ;
struct V_50 * V_51 ;
if ( ! V_73 )
return NULL ;
F_24 ( ! F_25 ( V_2 -> V_5 ) ) ;
V_51 = F_65 ( & V_2 -> V_75 , V_66 , V_78 , V_73 , 0 ) ;
if ( ! V_51 )
F_15 ( V_73 ) ;
return V_51 ;
}
T_4 F_66 ( struct V_1 * V_2 ,
struct V_76 * V_77 )
{
T_4 V_79 = 0 ;
struct V_50 * V_51 ;
F_57 (ndd, res)
if ( strcmp ( V_51 -> V_73 , V_77 -> V_42 ) == 0 )
V_79 += F_60 ( V_51 ) ;
return V_79 ;
}
static int F_67 ( struct V_40 * V_5 , void * V_80 )
{
int * V_81 = V_80 ;
if ( F_19 ( V_5 ) )
( * V_81 ) ++ ;
...
int F_68 ( struct V_14 * V_14 , int V_82 )
{
int V_81 = 0 ;
F_69 () ;
F_70 ( & V_14 -> V_5 , & V_81 , F_67 ) ;
F_5 ( & V_14 -> V_5 , L_15 , V_10 , V_81 ) ;
if ( V_81 != V_82 )
return - V_7 ;
return 0 ;
}
