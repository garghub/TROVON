...
static int F_55 ( const void * V_84 , T_2 V_78 ,
struct V_41 * V_42 ,
struct V_29 * V_18 )
{
struct V_50 * V_32 ;
...
static int F_56 ( const void * V_84 , T_2 V_78 ,
struct V_41 * V_42 )
{
struct V_29 * V_18 ;
int V_11 ;
...
if ( F_6 ( V_18 ) )
return F_7 ( V_18 ) ;
V_11 = F_55 ( V_84 , V_78 , V_42 , V_18 ) ;
F_19 ( V_18 ) ;
return V_11 ;
}
static int F_57 ( const void * V_84 , T_2 V_4 ,
struct V_41 * V_42 ,
struct V_15 * V_18 )
{
F_44 ( V_64 , V_18 ) ;
...
static int F_58 ( const void * V_84 , T_2 V_78 ,
struct V_41 * V_42 )
{
struct V_15 * V_18 ;
int V_11 ;
...
if ( F_6 ( V_18 ) )
return F_7 ( V_18 ) ;
V_11 = F_57 ( V_84 , V_78 , V_42 , V_18 ) ;
F_10 ( V_18 ) ;
return V_11 ;
}
int F_59 ( const void * V_84 , T_2 V_78 ,
struct V_41 * V_42 )
{
int V_11 ;
if ( V_67 && V_78 >= V_67 ) {
V_11 = F_56 ( V_84 , V_78 , V_42 ) ;
if ( ! V_11 )
return 0 ;
}
return F_58 ( V_84 , V_78 , V_42 ) ;
}
static void T_1 F_60 ( int V_85 , T_5 * V_86 )
{
if ( ! V_87 )
return;
if ( F_61 ( V_88 , V_85 , V_86 ) != 0 )
F_8 ( L_5 ) ;
}
static int T_1 F_62 ( char * V_63 ,
struct V_15 * V_18 )
{
T_5 V_89 [ V_90 ] ;
int V_11 , V_73 ;
...
if ( V_11 != 0 )
return V_11 ;
for ( V_73 = V_91 ; V_73 < V_92 ; V_73 ++ ) {
F_60 ( V_73 , V_89 ) ;
V_11 = F_48 ( V_64 , V_89 , V_90 ) ;
}
if ( ! V_11 )
F_50 ( V_64 , V_63 ) ;
return V_11 ;
}
int T_1 F_63 ( struct V_41 * V_42 )
{
struct V_15 * V_18 ;
int V_11 ;
V_18 = F_9 ( V_42 -> V_17 ) ;
