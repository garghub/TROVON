...
V_10 -> V_2 -> V_3 -> V_82 == V_92 )
V_10 -> V_11 -> V_93 . V_94 = F_35 ;
return 0 ;
}
static int F_46 ( struct V_9 * V_10 )
{
if ( ( F_47 ( V_10 -> V_2 -> V_3 -> V_95 ) != V_96 ) &&
( F_47 ( V_10 -> V_2 -> V_3 -> V_95 ) != V_97 ) )
return - V_98 ;
V_10 -> V_11 -> V_21 -> V_12 |= V_22 | V_38 |
V_78 ;
return 0 ;
}
static int F_48 ( struct V_1 * V_2 , int V_99 )
{
T_2 V_100 ;
int V_72 ;
V_72 = F_49 ( V_2 -> V_3 , 0xAE , & V_100 ) ;
if ( V_72 )
return V_72 ;
if ( V_99 )
V_100 |= 0x47 ;
...
V_100 &= ~ 0x47 ;
return F_50 ( V_2 -> V_3 , 0xAE , V_100 ) ;
}
...
V_101 = V_109 ;
else if ( V_2 -> V_3 -> V_82 == V_110 )
V_101 = V_111 ;
if ( V_101 ) {
struct V_112 * V_113 ;
V_113 = NULL ;
while ( ( V_113 = F_52 ( V_114 ,
V_101 , V_113 ) ) != NULL ) {
if ( ( F_53 ( V_2 -> V_3 -> V_95 ) ==
F_53 ( V_113 -> V_95 ) ) &&
( V_2 -> V_3 -> V_115 == V_113 -> V_115 ) )
break;
}
if ( V_113 ) {
F_54 ( V_113 ) ;
...
if ( V_2 -> V_3 -> V_82 == V_110 ||
V_2 -> V_3 -> V_82 == V_111 )
V_2 -> V_7 |= V_116 ;
return 0 ;
}
static void F_57 ( struct V_26 * V_11 , int V_99 )
{
T_2 V_100 ;
V_100 = F_58 ( V_11 -> V_117 + 0xC0 ) ;
if ( V_99 )
V_100 |= 0x01 ;
else
V_100 &= ~ 0x01 ;
F_59 ( V_100 , V_11 -> V_117 + 0xC0 ) ;
}
static int F_60 ( struct V_9 * V_10 )
{
if ( V_10 -> V_2 -> V_3 -> V_102 == 0 ) {
T_4 V_118 ;
V_118 = F_61 ( V_10 -> V_11 -> V_117 + V_119 ) ;
V_118 = ( V_118 & V_120 ) >>
V_121 ;
if ( V_118 < 0xAC )
V_10 -> V_11 -> V_7 |= V_122 ;
}
if ( V_10 -> V_2 -> V_3 -> V_82 == V_111 ) {
V_10 -> V_11 -> V_123 = V_124 | V_125 |
V_126 | V_127 |
V_128 ;
V_10 -> V_11 -> V_129 = V_124 | V_125 |
V_126 | V_127 ;
}
if ( V_10 -> V_2 -> V_3 -> V_82 == V_109 ||
V_10 -> V_2 -> V_3 -> V_82 == V_111 )
F_57 ( V_10 -> V_11 , 1 ) ;
V_10 -> V_11 -> V_21 -> V_12 |= V_79 ;
return 0 ;
}
static void F_62 ( struct V_9 * V_10 , int V_130 )
{
if ( V_130 )
return;
if ( V_10 -> V_2 -> V_3 -> V_82 == V_109 ||
...
{
int V_135 , V_136 ;
T_2 V_137 = F_58 ( V_10 -> V_11 -> V_117 + V_138 ) ;
T_2 V_139 = F_58 ( V_10 -> V_11 -> V_117 + V_140 ) ;
...
if ( V_139 >= 0x20 )
V_10 -> V_11 -> V_7 |= V_141 ;
F_59 ( V_142 , V_10 -> V_11 -> V_117 + V_143 ) ;
F_59 ( V_144 , V_10 -> V_11 -> V_117 + V_145 ) ;
F_26 ( 50 ) ;
V_135 = 10 ;
do {
V_136 = F_67 ( V_10 -> V_11 -> V_117 + V_146 ) ;
if ( V_136 & V_147 )
break;
F_26 ( 100 ) ;
} while ( -- V_135 );
...
static void F_74 ( struct V_26 * V_11 , int V_165 )
{
T_2 V_166 ;
...
static int F_78 ( struct V_26 * V_11 ,
struct V_45 * V_46 ,
...
static int F_79 ( struct V_82 * V_37 )
{
struct V_112 * V_3 = F_80 ( V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
T_5 V_173 ;
T_5 V_174 = 0 ;
...
V_175:
while ( -- V_54 >= 0 )
F_85 ( V_2 -> V_131 [ V_54 ] -> V_11 ) ;
return V_72 ;
}
static int F_86 ( struct V_82 * V_37 )
{
struct V_112 * V_3 = F_80 ( V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
...
static int F_87 ( struct V_82 * V_37 )
{
struct V_112 * V_3 = F_80 ( V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
...
V_181:
while ( -- V_54 >= 0 )
F_89 ( V_2 -> V_131 [ V_54 ] -> V_11 ) ;
return V_72 ;
}
static int F_90 ( struct V_82 * V_37 )
{
struct V_112 * V_3 = F_80 ( V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
...
static struct V_9 * F_91 (
struct V_112 * V_3 , struct V_1 * V_2 , int V_182 ,
int V_183 )
{
struct V_9 * V_10 ;
struct V_26 * V_11 ;
int V_72 , V_184 = V_182 + V_183 ;
if ( ! ( F_92 ( V_3 , V_184 ) & V_185 ) ) {
F_56 ( & V_3 -> V_37 , L_11 , V_184 ) ;
return F_93 ( - V_98 ) ;
}
if ( F_94 ( V_3 , V_184 ) < 0x100 ) {
F_56 ( & V_3 -> V_37 , L_12
L_13 ) ;
}
...
V_11 = F_95 ( & V_3 -> V_37 , sizeof( struct V_9 ) ) ;
if ( F_96 ( V_11 ) ) {
F_56 ( & V_3 -> V_37 , L_16 ) ;
return F_97 ( V_11 ) ;
}
...
V_11 -> V_24 = V_3 -> V_24 ;
V_72 = F_98 ( V_3 , V_184 , F_99 ( V_11 -> V_21 ) ) ;
if ( V_72 ) {
F_56 ( & V_3 -> V_37 , L_19 ) ;
goto V_193;
}
V_11 -> V_117 = F_100 ( V_3 , V_184 ) ;
if ( ! V_11 -> V_117 ) {
F_56 ( & V_3 -> V_37 , L_20 ) ;
V_72 = - V_194 ;
goto V_195;
...
if ( V_10 -> V_88 >= 0 &&
F_102 ( V_11 -> V_21 , V_10 -> V_87 , V_10 -> V_88 ,
V_10 -> V_89 , 0 , NULL ) ) {
F_18 ( & V_3 -> V_37 , L_23 ) ;
V_10 -> V_88 = - 1 ;
}
...
F_19 ( V_10 ) ;
V_130 = 0 ;
V_100 = F_61 ( V_10 -> V_11 -> V_117 + V_67 ) ;
if ( V_100 == ( T_3 ) - 1 )
V_130 = 1 ;
F_108 ( V_10 -> V_11 , V_130 ) ;
if ( F_12 ( V_10 -> V_172 ) )
F_17 ( V_10 -> V_172 ) ;
...
if ( V_10 -> V_188 && V_10 -> V_188 -> V_193 )
V_10 -> V_188 -> V_193 ( V_10 -> V_188 ) ;
F_105 ( V_10 -> V_2 -> V_3 , V_10 -> V_186 ) ;
F_106 ( V_10 -> V_11 ) ;
}
static void F_109 ( struct V_82 * V_37 )
{
F_110 ( V_37 ) ;
F_111 ( V_37 ) ;
F_112 ( V_37 , 50 ) ;
...
static void F_115 ( struct V_82 * V_37 )
{
F_116 ( V_37 ) ;
F_117 ( V_37 ) ;
}
static int F_118 ( struct V_112 * V_3 ,
...
F_119 ( V_204 == NULL ) ;
F_55 ( & V_3 -> V_37 , L_24 ,
( int ) V_3 -> V_205 , ( int ) V_3 -> V_82 , ( int ) V_3 -> V_102 ) ;
V_72 = F_49 ( V_3 , V_206 , & V_131 ) ;
if ( V_72 )
return V_72 ;
V_131 = F_120 ( V_131 ) + 1 ;
F_121 ( & V_3 -> V_37 , L_25 , V_131 ) ;
if ( V_131 == 0 )
return - V_98 ;
F_119 ( V_131 > V_207 ) ;
V_72 = F_49 ( V_3 , V_206 , & V_182 ) ;
if ( V_72 )
return V_72 ;
V_182 &= V_208 ;
if ( V_182 > 5 ) {
...
if ( V_72 )
return V_72 ;
V_2 = F_123 ( sizeof( struct V_1 ) , V_209 ) ;
if ( ! V_2 ) {
V_72 = - V_194 ;
goto V_28;
}
...
V_10 = F_91 ( V_3 , V_2 , V_182 , V_54 ) ;
if ( F_96 ( V_10 ) ) {
for ( V_54 -- ; V_54 >= 0 ; V_54 -- )
F_107 ( V_2 -> V_131 [ V_54 ] ) ;
V_72 = F_125 ( V_10 ) ;
goto free;
}
V_2 -> V_131 [ V_54 ] = V_10 ;
...
static void F_128 ( struct V_112 * V_3 )
{
int V_54 ;
struct V_1 * V_2 ;
V_2 = F_81 ( V_3 ) ;
