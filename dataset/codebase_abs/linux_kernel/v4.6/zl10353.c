...
static int F_17 ( struct V_1 * V_2 , enum V_104 * V_105 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
int V_94 , V_106 , V_107 ;
if ( ( V_94 = F_5 ( V_6 , V_97 ) ) < 0 )
return - V_99 ;
if ( ( V_106 = F_5 ( V_6 , V_108 ) ) < 0 )
return - V_99 ;
if ( ( V_107 = F_5 ( V_6 , V_109 ) ) < 0 )
return - V_99 ;
* V_105 = 0 ;
if ( V_94 & ( 1 << 2 ) )
* V_105 |= V_110 ;
...
if ( V_107 & ( 1 << 6 ) )
* V_105 |= V_114 ;
if ( ( * V_105 & ( V_110 | V_111 | V_113 ) ) !=
( V_110 | V_111 | V_113 ) )
* V_105 &= ~ V_112 ;
return 0 ;
}
static int F_18 ( struct V_1 * V_2 , T_2 * V_115 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
* V_115 = F_5 ( V_6 , V_116 ) << 16 |
F_5 ( V_6 , V_117 ) << 8 |
F_5 ( V_6 , V_118 ) ;
return 0 ;
}
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_3 signal = F_5 ( V_6 , V_120 ) << 10 |
F_5 ( V_6 , V_121 ) << 2 | 3 ;
* V_119 = ~ signal ;
return 0 ;
}
static int F_20 ( struct V_1 * V_2 , T_3 * V_122 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_1 V_123 ;
if ( V_124 )
...
static int F_21 ( struct V_1 * V_2 , T_2 * V_126 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_2 V_127 = 0 ;
V_127 = F_5 ( V_6 , V_128 ) << 8 |
F_5 ( V_6 , V_129 ) ;
V_6 -> V_126 += V_127 ;
* V_126 = V_6 -> V_126 ;
return 0 ;
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_1 V_135 [ 6 ] = { 0x50 , 0x03 , 0x64 , 0x46 , 0x15 , 0x0F } ;
if ( V_124 )
F_6 ( V_2 ) ;
if ( V_6 -> V_12 . V_136 )
V_135 [ 2 ] &= ~ 0x20 ;
if ( V_6 -> V_12 . V_137 )
V_135 [ 3 ] = V_6 -> V_12 . V_137 ;
if ( V_6 -> V_12 . V_138 )
V_135 [ 4 ] = V_6 -> V_12 . V_138 ;
if ( F_5 ( V_6 , 0x50 ) != V_135 [ 1 ] ||
F_5 ( V_6 , 0x51 ) != V_135 [ 2 ] ) {
F_4 ( V_2 , V_135 ,
sizeof( V_135 ) ) ;
if ( V_124 )
F_6 ( V_2 ) ;
