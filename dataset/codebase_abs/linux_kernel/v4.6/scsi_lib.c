...
V_329 [ V_328 ++ ] = NULL ;
F_241 ( & V_20 -> V_24 . V_338 , V_339 , V_329 ) ;
}
void F_242 ( struct V_79 * V_80 )
{
struct V_7 * V_20 ;
enum V_340 V_330 ;
F_47 ( V_341 ) ;
...
if ( F_243 ( V_330 , V_20 -> V_345 ) )
F_244 ( V_20 , V_330 , V_257 ) ;
while ( 1 ) {
struct V_326 * V_327 ;
...
void F_247 ( struct V_7 * V_20 , struct V_326 * V_327 )
{
unsigned long V_26 ;
#if 0
...
struct V_326 * F_249 ( enum V_340 V_330 ,
T_2 V_349 )
{
...
void F_244 ( struct V_7 * V_20 ,
enum V_340 V_330 , T_2 V_349 )
{
struct V_326 * V_327 = F_249 ( V_330 , V_349 ) ;
if ( ! V_327 ) {
...
static void
F_253 ( struct V_7 * V_20 , void * V_253 )
{
F_250 ( V_20 ) ;
}
void
...
{
F_255 ( V_9 , NULL , F_253 ) ;
}
static void
F_256 ( struct V_7 * V_20 , void * V_253 )
{
F_252 ( V_20 ) ;
}
void
F_257 ( struct V_8 * V_9 )
{
F_255 ( V_9 , NULL , F_256 ) ;
}
int
...
static void
F_263 ( struct V_7 * V_20 , void * V_253 )
{
F_258 ( V_20 ) ;
}
static int
F_264 ( struct V_6 * V_267 , void * V_253 )
{
if ( F_265 ( V_267 ) )
F_255 ( F_266 ( V_267 ) , NULL ,
F_263 ) ;
return 0 ;
}
void
F_267 ( struct V_6 * V_267 )
{
if ( F_265 ( V_267 ) )
F_255 ( F_266 ( V_267 ) , NULL ,
F_263 ) ;
else
F_268 ( V_267 , NULL , F_264 ) ;
}
static void
F_269 ( struct V_7 * V_20 , void * V_253 )
{
F_261 ( V_20 , * (enum V_320 * ) V_253 ) ;
}
static int
F_270 ( struct V_6 * V_267 , void * V_253 )
{
if ( F_265 ( V_267 ) )
F_255 ( F_266 ( V_267 ) , V_253 ,
F_269 ) ;
return 0 ;
}
void
F_271 ( struct V_6 * V_267 , enum V_320 V_351 )
{
if ( F_265 ( V_267 ) )
F_255 ( F_266 ( V_267 ) , & V_351 ,
F_269 ) ;
else
F_268 ( V_267 , & V_351 , F_270 ) ;
}
void * F_272 ( struct V_85 * V_86 , int V_352 ,
T_5 * V_353 , T_5 * V_139 )
{
int V_289 ;
T_5 V_354 = 0 , V_355 = 0 ;
...
V_356 = F_276 ( F_277 ( V_236 ) , ( * V_353 >> V_266 ) ) ;
* V_353 &= ~ V_357 ;
V_354 = V_358 - * V_353 ;
if ( * V_139 > V_354 )
* V_139 = V_354 ;
...
void F_282 ( struct V_7 * V_20 )
{
if ( F_120 ( F_43 ( & V_20 -> V_360 ) <= 0 ) )
return;
F_32 ( & V_20 -> V_360 ) ;
}
int F_283 ( struct V_7 * V_20 , char * V_361 , T_5 V_362 )
{
T_6 V_363 = 0xff ;
T_6 V_364 = 0 ;
...
int F_287 ( struct V_7 * V_20 , int * V_372 )
{
unsigned char * V_365 ;
unsigned char T_7 * V_367 ;
