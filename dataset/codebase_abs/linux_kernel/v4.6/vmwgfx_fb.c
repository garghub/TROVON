...
if ( ! V_9 -> V_61 ) {
V_94 = V_119 -> V_125 ( V_119 ) ;
if ( V_94 ) {
F_2 ( L_10 ) ;
return V_94 ;
}
V_94 = F_46 ( & V_9 -> V_93 -> V_124 , 0 ,
V_9 -> V_93 -> V_124 . V_126 , & V_9 -> V_115 ) ;
if ( V_94 ) {
V_119 -> V_127 ( V_119 ) ;
F_2 ( L_11 ) ;
return V_94 ;
}
V_9 -> V_61 = F_47 ( & V_9 -> V_115 , & V_9 -> V_128 ) ;
}
return 0 ;
}
...
int V_94 ;
V_131 = V_9 -> V_103 ;
V_109 = F_50 ( V_18 -> V_114 , & V_130 ) ;
if ( ! V_109 ) {
F_2 ( L_13 ) ;
return - V_97 ;
}
V_109 -> V_132 = V_16 -> V_23 ;
V_109 -> V_133 = V_16 -> V_26 ;
F_51 ( V_109 ) ;
if ( V_131 && F_52 ( V_131 , V_109 ) ) {
...
V_141 = V_136 * V_138 / 8 ;
V_142 = V_141 * V_137 ;
V_140 = F_57 ( V_18 , V_146 ) ;
V_7 = F_58 ( sizeof( * V_9 ) , V_134 ) ;
if ( ! V_7 )
return - V_97 ;
V_18 -> V_6 = V_7 ;
V_9 = V_7 -> V_9 ;
...
V_7 -> V_16 . V_23 = V_143 -> V_132 ;
V_7 -> V_16 . V_26 = V_143 -> V_133 ;
F_55 ( V_18 -> V_114 ) ;
V_9 -> V_63 = F_61 ( V_142 ) ;
