...
return F_31 ( & V_20 -> V_4 , & V_61 -> V_81 , V_47 ) ;
V_68:
F_32 ( V_61 ) ;
return NULL ;
}
...
F_18 ( & V_20 -> V_4 . V_21 , V_51 ) ;
if ( V_20 -> V_48 ) {
F_35 ( & V_20 -> V_48 -> V_81 . V_82 , & V_20 -> V_4 . V_83 ) ;
V_20 -> V_48 = NULL ;
}
F_36 ( & V_20 -> V_4 , & V_41 ) ;
F_19 ( & V_20 -> V_4 . V_21 , V_51 ) ;
...
V_20 = & V_7 -> V_91 [ V_63 ] ;
F_18 ( & V_20 -> V_4 . V_21 , V_47 ) ;
if ( ! F_55 ( & V_20 -> V_4 . V_83 ) && ! V_20 -> V_48 )
F_50 ( V_20 ) ;
F_19 ( & V_20 -> V_4 . V_21 , V_47 ) ;
}
}
...
static int F_64 ( struct V_147 * V_148 )
{
struct V_6 * V_7 ;
const struct V_149 * V_150 ;
struct V_151 * V_152 ;
int V_109 , V_63 ;
V_7 = F_65 ( & V_148 -> V_44 , sizeof( * V_7 ) , V_45 ) ;
if ( ! V_7 )
return - V_46 ;
V_7 -> V_44 = & V_148 -> V_44 ;
V_150 = F_66 ( V_153 , V_148 -> V_44 . V_154 ) ;
if ( ! V_150 ) {
F_14 ( & V_148 -> V_44 , L_4 ) ;
return - V_155 ;
}
V_7 -> V_13 = V_150 -> V_97 ;
V_152 = F_67 ( V_148 , V_156 , 0 ) ;
V_7 -> V_14 = F_68 ( & V_148 -> V_44 , V_152 ) ;
if ( F_69 ( V_7 -> V_14 ) )
return F_70 ( V_7 -> V_14 ) ;
V_7 -> V_96 = F_71 ( V_148 , 0 ) ;
if ( V_7 -> V_96 < 0 )
return V_7 -> V_96 ;
V_109 = F_72 ( V_148 -> V_44 . V_154 , L_5 , & V_7 -> V_19 ) ;
if ( V_109 ) {
F_14 ( V_7 -> V_44 , L_6 ) ;
return V_109 ;
}
V_7 -> V_157 = F_73 ( V_7 -> V_44 , L_7 ) ;
if ( F_69 ( V_7 -> V_157 ) )
return F_70 ( V_7 -> V_157 ) ;
V_109 = F_74 ( V_7 -> V_157 ) ;
if ( V_109 ) {
F_14 ( V_7 -> V_44 , L_8 ) ;
return V_109 ;
}
...
if ( V_109 )
goto V_158;
F_75 ( & V_7 -> V_99 , F_54 , ( unsigned long ) V_7 ) ;
V_7 -> V_91 = F_76 ( V_7 -> V_44 , V_7 -> V_90 ,
...
F_77 ( & V_7 -> V_3 . V_91 ) ;
for ( V_63 = 0 ; V_63 < V_7 -> V_90 ; V_63 ++ )
F_62 ( V_7 , & V_7 -> V_91 [ V_63 ] , V_63 ) ;
V_109 = F_78 ( V_7 -> V_44 , V_7 -> V_96 , F_42 ,
V_160 , L_9 , V_7 ) ;
if ( V_109 )
goto V_161;
V_7 -> V_3 . V_44 = V_7 -> V_44 ;
V_7 -> V_3 . V_44 -> V_162 = & V_7 -> V_162 ;
V_109 = F_79 ( V_7 -> V_3 . V_44 , V_66 ) ;
if ( V_109 ) {
F_14 ( V_7 -> V_44 , L_10 ) ;
goto V_161;
}
F_80 ( V_148 , V_7 ) ;
F_81 ( V_7 -> V_3 . V_163 ) ;
F_82 ( V_164 , V_7 -> V_3 . V_163 ) ;
V_7 -> V_3 . V_165 = F_11 ( V_38 ) | F_11 ( V_166 ) ;
V_7 -> V_3 . V_167 = V_168 ;
V_7 -> V_3 . V_169 = V_170 ;
V_7 -> V_3 . V_171 = V_170 ;
V_7 -> V_3 . V_172 = F_12 ;
...
V_109 = F_84 ( V_148 -> V_44 . V_154 , F_59 ,
& V_7 -> V_3 ) ;
if ( V_109 )
goto V_181;
return 0 ;
...
{
struct V_6 * V_7 = F_89 ( V_148 ) ;
T_2 V_63 ;
F_90 ( V_148 -> V_44 . V_154 ) ;
F_85 ( & V_7 -> V_3 ) ;
F_6 ( 0 , F_3 ( V_7 , 0 , V_35 ) ) ;
F_91 ( V_7 -> V_44 , V_7 -> V_96 , V_7 ) ;
for ( V_63 = 0 ; V_63 < V_7 -> V_90 ; V_63 ++ ) {
F_33 ( & V_7 -> V_91 [ V_63 ] . V_4 . V_5 ) ;
F_86 ( & V_7 -> V_91 [ V_63 ] . V_4 . V_99 ) ;
F_20 ( V_7 -> V_44 , V_31 ,
V_7 -> V_91 [ V_63 ] . V_43 ,
V_7 -> V_91 [ V_63 ] . V_28 ) ;
