...
F_5 ( V_2 , V_126 , V_127 ) ;
F_5 ( V_2 , V_128 , 0x0000 ) ;
F_5 ( V_2 , V_129 , 0xFFFF ) ;
F_5 ( V_2 , V_130 , V_131 ) ;
F_5 ( V_2 , V_26 , V_132 | V_27 |
V_133 ) ;
F_5 ( V_2 , V_134 , V_2 -> V_70 >> 1 ) ;
F_67 ( & V_7 -> V_28 ) ;
...
if ( F_69 ( V_2 , F_70 ( V_100 ) ) ) {
F_43 ( V_33 , L_26 ) ;
V_102 = - V_105 ;
goto error;
}
switch ( V_2 -> V_135 / V_2 -> V_37 ) {
case 32 :
F_7 ( V_2 , V_26 , V_136 ) ;
break;
case 64 :
