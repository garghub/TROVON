...
if ( F_38 ( V_66 , V_106 , sizeof ( V_94 ) , & V_94 ) )
goto V_97;
F_10 ( V_2 ) ;
return V_66 -> V_107 ;
V_97:
...
static int F_43 ( struct V_62 * V_62 , struct V_65 * V_66 ,
struct V_108 * V_109 , int type ,
struct V_26 * V_27 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_63 ) ;
return F_44 ( V_34 , V_66 , V_109 , type , V_27 ) ;
}
static int F_45 ( struct V_62 * V_62 , struct V_26 * V_27 , T_1 V_45 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_63 ) ;
return F_46 ( V_34 , V_27 , V_45 ) ;
}
static T_2 int F_47 ( struct V_62 * V_62 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_63 ) ;
return F_48 ( V_34 , & V_110 , V_111 ) ;
}
static void T_3 F_49 ( struct V_62 * V_62 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_63 ) ;
F_50 ( V_34 ) ;
}
static int F_51 ( struct V_62 * V_62 , struct V_65 * V_66 ,
struct V_108 * V_109 , int type ,
struct V_26 * V_27 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_64 ) ;
...
static int F_52 ( struct V_62 * V_62 , struct V_26 * V_27 , T_1 V_45 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_64 ) ;
return F_46 ( V_34 , V_27 , V_45 ) ;
}
static T_2 int F_53 ( struct V_62 * V_62 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_64 ) ;
return F_48 ( V_34 , & V_112 , V_111 ) ;
}
static void T_3 F_54 ( struct V_62 * V_62 )
{
struct V_33 * V_34 = F_28 ( V_62 , V_64 ) ;
F_50 ( V_34 ) ;
}
...
{
int V_113 , V_114 ;
V_113 = F_56 ( & V_112 , & V_115 ) ;
if ( V_113 < 0 )
F_57 ( L_3 ) ;
V_114 = F_56 ( & V_110 , & V_116 ) ;
if ( V_114 < 0 )
F_57 ( L_4 ) ;
if ( V_113 < 0 && V_114 < 0 ) {
return V_113 ;
