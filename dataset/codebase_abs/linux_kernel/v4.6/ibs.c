...
if ( V_13 -> V_27 . V_88 & V_89 ) {
V_74 . V_79 = sizeof( V_97 ) + V_77 . V_79 ;
V_74 . V_72 = V_77 . V_72 ;
V_72 . V_74 = & V_74 ;
}
...
static int
F_40 ( unsigned int V_98 , struct V_69 * V_75 )
{
T_1 V_99 = F_41 () ;
int V_100 = 0 ;
V_100 += F_35 ( & V_23 , V_75 ) ;
V_100 += F_35 ( & V_25 , V_75 ) ;
if ( V_100 )
F_42 ( V_101 ) ;
F_43 ( F_41 () - V_99 ) ;
return V_100 ;
}
static T_3 int F_44 ( struct V_22 * V_22 , char * V_102 )
{
...
V_22 -> V_55 = V_55 ;
if ( V_22 -> V_104 [ 0 ] ) {
memset ( & V_22 -> V_105 , 0 , sizeof( V_22 -> V_105 ) ) ;
V_22 -> V_105 . V_102 = L_1 ;
V_22 -> V_105 . V_106 = V_22 -> V_104 ;
memset ( & V_22 -> V_107 , 0 , sizeof( V_22 -> V_107 ) ) ;
V_22 -> V_107 [ 0 ] = & V_22 -> V_105 ;
V_22 -> V_24 . V_107 = V_22 -> V_107 ;
}
V_36 = F_46 ( & V_22 -> V_24 , V_102 , - 1 ) ;
if ( V_36 ) {
V_22 -> V_55 = NULL ;
F_47 ( V_55 ) ;
}
...
static T_3 int F_48 ( void ) { return 0 ; }
static T_3 V_97 F_51 ( void )
{
V_97 V_86 ;
unsigned int V_114 ;
if ( ! F_52 ( V_115 ) )
...
static int
F_79 ( struct V_141 * V_142 , unsigned long V_143 , void * V_144 )
{
switch ( V_143 & ~ V_145 ) {
case V_146 :
F_72 ( NULL ) ;
