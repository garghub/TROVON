...
static void F_18 ( struct V_34 * V_35 , unsigned V_36 )
{
struct V_10 * V_20 ;
char V_37 [ 32 ] ;
snprintf ( V_37 , sizeof( V_37 ) , L_9 , F_11 ( & V_35 -> V_20 ) , V_36 ) ;
V_20 = F_19 ( & V_27 , NULL , V_37 ) ;
if ( V_20 ) {
if ( V_38 )
F_10 ( V_20 , L_10 , V_37 ) ;
F_20 ( V_20 ) ;
...
F_33 ( L_25 ) ;
for ( V_6 = 0 ; V_6 < F_34 ( V_61 ) ; V_6 ++ )
F_33 ( L_26 , V_61 [ V_6 ] . V_30 ) ;
return - V_62 ;
}
if ( V_63 ) {
V_6 = F_34 ( V_61 ) - 1 ;
