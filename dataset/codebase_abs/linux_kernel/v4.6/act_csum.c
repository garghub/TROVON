...
if ( F_47 ( V_31 , V_125 , sizeof( V_121 ) , & V_121 ) )
goto V_122;
return V_31 -> V_63 ;
V_122:
F_49 ( V_31 , V_113 ) ;
...
static int F_50 ( struct V_1 * V_1 , struct V_30 * V_31 ,
struct V_126 * V_127 , int type ,
struct V_5 * V_6 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_51 ( V_10 , V_31 , V_127 , type , V_6 ) ;
}
static int F_52 ( struct V_1 * V_1 , struct V_5 * V_6 , T_2 V_23 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_53 ( V_10 , V_6 , V_23 ) ;
}
static T_4 int F_54 ( struct V_1 * V_1 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_55 ( V_10 , & V_128 , V_129 ) ;
}
static void T_5 F_56 ( struct V_1 * V_1 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
F_57 ( V_10 ) ;
}
