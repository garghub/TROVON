...
V_51 = V_30 -> V_31 ;
V_30 -> V_31 = V_32 ;
if ( V_6 -> V_46 == V_30 -> V_57 ) {
V_13 = F_25 ( V_14 , V_53 , V_30 -> V_57 ,
V_51 & V_58 ) ;
if ( V_13 ) {
V_53 -> V_59 = 0 ;
if ( V_13 != - V_60 )
...
F_14 ( V_26 , L_7 V_45 L_4 ,
F_22 ( & V_6 -> V_47 ) ) ;
}
F_26 ( V_30 , V_53 , V_53 -> V_59 ) ;
}
V_13 = F_27 ( F_11 ( V_14 ) -> V_61 , V_30 ,
...
int V_13 ;
F_13 ( F_34 ( F_35 ( V_14 ) ) ) ;
V_30 = F_36 ( sizeof( * V_30 ) , V_55 ) ;
if ( ! V_30 )
return;
F_30 ( V_14 , V_30 , & V_41 ) ;
if ( ! V_41 )
goto V_44;
V_13 = F_37 ( F_11 ( V_14 ) -> V_61 , V_30 , NULL ) ;
if ( V_13 == - V_64 )
V_13 = F_23 ( V_14 , V_30 ) ;
else if ( V_13 )
F_18 ( L_8 ,
...
F_3 ( & V_19 -> V_24 ) ;
if ( ! F_4 ( & V_19 -> V_27 ) ) {
V_6 = F_42 ( V_19 -> V_27 . V_65 , struct V_5 ,
V_25 ) ;
F_8 ( & V_6 -> V_25 ) ;
} else if ( F_43 ( & V_19 -> V_66 ) )
V_6 = F_44 ( - V_67 ) ;
F_6 ( & V_19 -> V_24 ) ;
return V_6 ;
}
...
int F_51 ( struct V_18 * * V_73 )
{
struct V_18 * V_19 ;
struct V_74 * V_75 ;
if ( F_52 ( V_76 ) )
return - V_77 ;
V_19 = F_36 ( sizeof( * V_19 ) , V_55 ) ;
if ( ! V_19 )
return - V_56 ;
F_53 ( & V_19 -> V_24 ) ;
F_54 ( & V_19 -> V_27 ) ;
