...
F_168 ( V_98 , V_1 , 0 , V_286 , NULL , V_284 ) ;
return;
V_105:
if ( V_38 < 0 )
F_169 ( V_1 , V_286 , V_38 ) ;
}
static int F_185 ( struct V_97 * V_287 ,
struct V_56 * V_57 )
{
struct V_1 * V_1 = F_82 ( V_287 -> V_89 ) ;
struct V_99 * V_100 [ V_288 + 1 ] ;
struct V_267 * V_277 ;
struct V_97 * V_98 ;
struct V_275 * V_276 ;
struct V_26 * V_37 ;
...
int V_85 ;
int V_38 ;
V_38 = F_83 ( V_57 , sizeof( * V_277 ) , V_100 , V_288 ,
V_289 ) ;
if ( V_38 < 0 )
goto V_105;
V_38 = - V_80 ;
...
V_38 = F_187 ( V_98 , V_1 , F_88 ( V_287 ) . V_58 ) ;
V_105:
return V_38 ;
}
...
struct V_26 * V_37 ;
V_37 = F_126 ( V_14 ) ;
if ( V_37 && ! F_190 ( V_122 , V_37 -> V_41 . V_293 ) )
...
{
struct V_11 * V_14 ;
int V_294 = F_192 ( V_1 , V_48 ) ;
F_192 ( V_1 , V_295 ) = ! V_294 ;
F_193 ( V_1 , V_48 ) = V_294 ;
F_184 ( V_1 , V_270 ,
V_290 ,
V_1 -> V_42 . V_291 ) ;
F_184 ( V_1 , V_270 ,
...
static int F_196 ( struct V_296 * V_297 , int V_298 ,
void T_4 * V_299 ,
T_5 * V_300 , T_6 * V_301 )
{
int V_302 = * ( int * ) V_297 -> V_260 ;
int V_96 = F_197 ( V_297 , V_298 , V_299 , V_300 , V_301 ) ;
int V_303 = * ( int * ) V_297 -> V_260 ;
if ( V_298 ) {
struct V_275 * V_41 = V_297 -> V_304 ;
struct V_1 * V_1 = V_297 -> V_305 ;
int V_122 = ( int * ) V_297 -> V_260 - V_41 -> V_260 ;
int V_85 ;
F_198 ( V_122 , V_41 -> V_293 ) ;
if ( V_41 == V_1 -> V_42 . V_43 )
F_189 ( V_1 , V_122 ) ;
if ( V_122 == V_306 - 1 ||
V_122 == V_307 - 1 )
...
static int F_200 ( struct V_296 * V_297 , int V_298 ,
void T_4 * V_299 ,
T_5 * V_300 , T_6 * V_301 )
{
int * V_311 = V_297 -> V_260 ;
int V_3 = * V_311 ;
T_6 V_312 = * V_301 ;
int V_96 = F_197 ( V_297 , V_298 , V_299 , V_300 , V_301 ) ;
if ( V_298 && * V_311 != V_3 ) {
struct V_1 * V_1 = V_297 -> V_305 ;
if ( V_311 != & F_193 ( V_1 , V_48 ) ) {
if ( ! F_201 () ) {
* V_311 = V_3 ;
* V_301 = V_312 ;
return F_202 () ;
}
if ( V_311 == & F_192 ( V_1 , V_48 ) ) {
F_191 ( V_1 ) ;
} else {
struct V_275 * V_41 = V_297 -> V_304 ;
struct V_26 * V_27 =
...
static int F_203 ( struct V_296 * V_297 , int V_298 ,
void T_4 * V_299 ,
T_5 * V_300 , T_6 * V_301 )
{
int * V_311 = V_297 -> V_260 ;
...
static int F_204 ( struct V_1 * V_1 , char * V_313 ,
struct V_275 * V_314 )
{
int V_122 ;
struct V_315 * V_316 ;
char V_317 [ sizeof( L_6 ) + V_147 ] ;
V_316 = F_205 ( & V_318 , sizeof( * V_316 ) , V_28 ) ;
if ( ! V_316 )
goto V_40;
for ( V_122 = 0 ; V_122 < F_206 ( V_316 -> V_319 ) - 1 ; V_122 ++ ) {
V_316 -> V_319 [ V_122 ] . V_260 += ( char * ) V_314 - ( char * ) & V_275 ;
V_316 -> V_319 [ V_122 ] . V_304 = V_314 ;
V_316 -> V_319 [ V_122 ] . V_305 = V_1 ;
}
snprintf ( V_317 , sizeof( V_317 ) , L_7 , V_313 ) ;
V_316 -> V_320 = F_207 ( V_1 , V_317 , V_316 -> V_319 ) ;
if ( ! V_316 -> V_320 )
goto free;
V_314 -> V_44 = V_316 ;
return 0 ;
...
{
int V_38 ;
struct V_275 * V_268 , * V_321 ;
#ifdef F_214
struct V_296 * V_322 = V_323 ;
struct V_324 * V_325 ;
#endif
V_38 = - V_39 ;
V_268 = & V_275 ;
...
if ( ! V_268 )
goto V_328;
V_321 = F_205 ( V_321 , sizeof( V_326 ) , V_28 ) ;
if ( ! V_321 )
goto V_329;
#ifdef F_214
V_322 = F_205 ( V_322 , sizeof( V_323 ) , V_28 ) ;
if ( ! V_322 )
goto V_330;
V_322 [ 0 ] . V_260 = & V_268 -> V_260 [ V_331 - 1 ] ;
V_322 [ 0 ] . V_304 = V_268 ;
V_322 [ 0 ] . V_305 = V_1 ;
#endif
}
#ifdef F_214
V_38 = F_204 ( V_1 , L_8 , V_268 ) ;
if ( V_38 < 0 )
goto V_332;
V_38 = F_204 ( V_1 , L_9 , V_321 ) ;
if ( V_38 < 0 )
goto V_333;
V_38 = - V_39 ;
V_325 = F_207 ( V_1 , L_10 , V_322 ) ;
if ( ! V_325 )
goto V_334;
V_1 -> V_42 . V_325 = V_325 ;
#endif
V_1 -> V_42 . V_291 = V_268 ;
V_1 -> V_42 . V_43 = V_321 ;
return 0 ;
#ifdef F_214
V_334:
...
#ifdef F_214
struct V_296 * V_322 ;
V_322 = V_1 -> V_42 . V_325 -> V_335 ;
F_209 ( V_1 -> V_42 . V_325 ) ;
F_208 ( V_1 -> V_42 . V_43 ) ;
F_208 ( V_1 -> V_42 . V_291 ) ;
F_26 ( V_322 ) ;
#endif
F_26 ( V_1 -> V_42 . V_43 ) ;
F_26 ( V_1 -> V_42 . V_291 ) ;
...
F_65 ( V_82 , & V_81 , 0 ) ;
F_221 ( & V_339 ) ;
F_222 ( V_337 , V_76 , F_106 , NULL , NULL ) ;
F_222 ( V_337 , V_72 , F_81 , NULL , NULL ) ;
F_222 ( V_337 , V_340 , NULL , F_162 , NULL ) ;
F_222 ( V_337 , V_341 , F_185 ,
F_188 , NULL ) ;
}
