...
unsigned V_58 )
{
struct V_1 * V_2 = F_35 ( V_57 , struct V_1 , V_59 ) ;
int V_60 ;
F_27 ( & V_2 -> V_51 ) ;
...
{
const struct V_67 * V_68 = F_44 ( V_2 -> V_6 ) ;
if ( V_68 && V_68 -> V_70 )
F_45 ( & V_2 -> V_59 ) ;
}
...
F_63 ( V_2 -> V_85 ) |
F_64 ( V_2 -> V_88 ) ;
V_60 = F_65 ( V_6 , V_2 -> V_35 , NULL , F_14 ,
V_128 | V_129 ,
F_55 ( V_6 ) , V_2 ) ;
if ( V_60 ) {
F_42 ( V_6 , L_20 , V_60 ) ;
