...
struct V_12 * V_13 ;
if ( V_44 -> V_131 == V_6 )
V_13 = F_50 ( V_128 , V_130 , NULL , 0 , V_44 -> V_16 . V_29 [ 0 ] ,
...
V_13 = F_50 ( V_128 , V_130 , NULL , 0 , V_44 -> V_16 . V_29 [ 3 ] ,
V_44 -> V_16 . V_19 , V_44 -> V_16 . V_27 [ 3 ] ,
V_44 -> V_16 . V_17 , V_44 -> V_16 . V_21 ) ;
else
V_13 = F_52 ( V_128 , V_130 , NULL , 0 ,
...
static int F_88 ( struct V_41 * V_42 , struct V_195 * V_196 )
{
int V_234 = sizeof( struct V_43 ) ;
struct V_59 * V_156 = NULL ;
if ( F_89 ( V_196 -> V_58 , V_234 ) )
V_156 = F_90 ( V_196 -> V_58 , V_234 , V_235 ) ;
return F_87 ( V_42 , V_196 , F_17 ( V_196 -> V_58 ) , V_156 ) ;
}
...
struct V_59 * V_156 = NULL ;
V_44 . V_131 = V_183 ;
V_44 . V_62 = F_91 ( V_196 -> V_58 -> V_63 ) ;
V_44 . V_57 = V_241 -> V_57 ;
V_44 . V_211 = V_241 -> V_211 ;
V_44 . V_16 = V_241 -> V_16 ;
if ( F_89 ( V_196 -> V_58 , V_234 ) )
V_156 = F_90 ( V_196 -> V_58 , V_234 , V_235 ) ;
return F_87 ( V_42 , V_196 , & V_44 , V_156 ) ;
}
static int F_93 ( struct V_41 * V_133 ,
const struct V_50 * V_58 )
{
...
return F_96 ( V_128 -> V_138 , V_42 , V_58 , & V_245 ) ;
}
}
return F_93 ( V_42 , V_58 ) ;
}
static int F_97 ( struct V_41 * V_42 , struct V_50 * V_246 )
{
int V_234 = sizeof( struct V_43 ) ;
struct V_128 * V_128 = F_56 ( V_42 -> V_13 ) ;
if ( F_95 ( V_246 ) < V_234 )
...
return F_96 ( V_128 -> V_138 , V_42 , V_246 , & V_245 ) ;
}
}
return F_65 ( V_246 -> V_63 , V_42 , V_246 , F_17 ( V_246 ) ) ;
}
static
int F_98 ( struct V_41 * V_42 , struct V_12 * V_13 )
{
const struct V_1 * V_9 ;
struct V_50 * V_58 ;
struct V_59 * V_60 ;
...
int F_99 ( const struct V_1 * V_246 )
{
...
void F_100 ( const struct V_1 * V_246 )
{
const T_6 type = V_246 -> V_252 ;
if ( type >= V_253 )
return;
