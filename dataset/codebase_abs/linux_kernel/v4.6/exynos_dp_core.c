...
F_113 ( & V_3 -> V_127 , V_126 ) ;
V_122 -> V_128 . V_129 = V_126 -> V_129 ;
V_122 -> V_128 . V_130 = V_126 -> V_130 ;
V_126 -> type = V_131 | V_132 ;
F_114 ( V_126 ) ;
F_115 ( V_122 , V_126 ) ;
return 1 ;
}
...
{
int V_117 ;
V_4 -> V_133 -> V_134 = V_3 -> V_135 ;
V_3 -> V_135 -> V_4 = V_4 ;
V_117 = F_118 ( V_4 -> V_10 , V_3 -> V_135 ) ;
if ( V_117 ) {
F_101 ( L_33 ) ;
return V_117 ;
}
...
static int F_119 ( struct V_136 * V_133 )
{
struct V_2 * V_3 = V_133 -> V_137 ;
...
static void F_125 ( struct V_136 * V_133 )
{
struct V_2 * V_3 = V_133 -> V_137 ;
...
static void F_130 ( struct V_136 * V_133 )
{
struct V_2 * V_3 = V_133 -> V_137 ;
struct V_1 * V_5 = F_1 ( V_3 ) ;
if ( V_3 -> V_143 != V_144 )
...
static void F_136 ( struct V_136 * V_133 )
{
}
static int F_137 ( struct V_6 * V_4 )
{
struct V_2 * V_3 = F_3 ( V_4 ) ;
struct V_149 * V_116 = V_3 -> V_116 ;
struct V_136 * V_133 ;
int V_117 ;
V_133 = F_138 ( V_116 -> V_10 , sizeof( * V_133 ) , V_150 ) ;
if ( ! V_133 ) {
F_101 ( L_37 ) ;
return - V_151 ;
}
...
static void F_139 ( struct V_6 * V_4 ,
struct V_125 * V_126 ,
struct V_125 * V_154 )
{
}
...
static struct V_119 * F_142 ( struct V_155 * V_10 )
{
struct V_156 * V_157 = V_10 -> V_158 ;
struct V_119 * V_159 ;
V_159 = F_138 ( V_10 ,
sizeof( * V_159 ) , V_150 ) ;
if ( ! V_159 )
...
{
int V_117 ;
V_117 = F_147 ( V_3 -> V_10 -> V_158 , & V_3 -> V_127 , V_167 ) ;
if ( V_117 ) {
F_101 ( L_54 , V_117 ) ;
return V_117 ;
}
...
static int F_148 ( struct V_155 * V_10 , struct V_155 * V_168 , void * V_33 )
{
struct V_2 * V_3 = F_149 ( V_10 ) ;
struct V_169 * V_170 = F_150 ( V_10 ) ;
struct V_149 * V_116 = V_33 ;
struct V_6 * V_4 = & V_3 -> V_4 ;
struct V_171 * V_172 ;
unsigned int V_173 ;
int V_174 , V_117 = 0 ;
V_3 -> V_10 = & V_170 -> V_10 ;
V_3 -> V_143 = V_148 ;
V_3 -> V_119 = F_142 ( & V_170 -> V_10 ) ;
if ( F_151 ( V_3 -> V_119 ) )
return F_152 ( V_3 -> V_119 ) ;
V_3 -> V_147 = F_153 ( V_3 -> V_10 , L_55 ) ;
if ( F_151 ( V_3 -> V_147 ) ) {
F_17 ( V_3 -> V_10 , L_56 ) ;
V_117 = F_152 ( V_3 -> V_147 ) ;
if ( V_117 ) {
if ( V_117 == - V_175 || V_117 == - V_176 )
V_3 -> V_147 = NULL ;
else
return V_117 ;
}
}
if ( ! V_3 -> V_118 && ! V_3 -> V_135 ) {
V_117 = F_146 ( V_3 ) ;
if ( V_117 )
return V_117 ;
}
V_3 -> clock = F_154 ( & V_170 -> V_10 , L_55 ) ;
if ( F_151 ( V_3 -> clock ) ) {
F_17 ( & V_170 -> V_10 , L_57 ) ;
return F_152 ( V_3 -> clock ) ;
}
F_155 ( V_3 -> clock ) ;
V_172 = F_156 ( V_170 , V_177 , 0 ) ;
V_3 -> V_178 = F_157 ( & V_170 -> V_10 , V_172 ) ;
if ( F_151 ( V_3 -> V_178 ) )
return F_152 ( V_3 -> V_178 ) ;
V_3 -> V_179 = F_158 ( V_10 -> V_158 , L_58 , 0 ) ;
if ( F_159 ( V_3 -> V_179 ) ) {
V_117 = F_160 ( & V_170 -> V_10 , V_3 -> V_179 , V_180 ,
L_59 ) ;
if ( V_117 ) {
F_17 ( & V_170 -> V_10 , L_60 ) ;
return V_117 ;
}
V_3 -> V_105 = F_161 ( V_3 -> V_179 ) ;
V_173 = V_181 | V_182 ;
} else {
V_3 -> V_179 = - V_176 ;
V_3 -> V_105 = F_162 ( V_170 , 0 ) ;
V_173 = 0 ;
}
if ( V_3 -> V_105 == - V_183 ) {
F_17 ( & V_170 -> V_10 , L_61 ) ;
return - V_176 ;
}
F_163 ( & V_3 -> V_110 , F_97 ) ;
V_117 = F_164 ( & V_170 -> V_10 , V_3 -> V_105 , F_93 ,
V_173 , L_62 , V_3 ) ;
if ( V_117 ) {
F_17 ( & V_170 -> V_10 , L_63 ) ;
return V_117 ;
}
F_131 ( V_3 -> V_105 ) ;
V_3 -> V_116 = V_116 ;
...
return V_174 ;
V_4 -> V_185 = 1 << V_174 ;
F_166 ( L_64 , V_4 -> V_185 ) ;
F_167 ( V_116 , V_4 , & V_186 ,
V_187 , NULL ) ;
F_168 ( V_4 , & V_188 ) ;
V_117 = F_137 ( V_4 ) ;
if ( V_117 ) {
...
static void F_170 ( struct V_155 * V_10 , struct V_155 * V_168 ,
void * V_33 )
{
struct V_2 * V_3 = F_149 ( V_10 ) ;
F_141 ( & V_3 -> V_4 ) ;
}
static int F_171 ( struct V_169 * V_170 )
{
struct V_155 * V_10 = & V_170 -> V_10 ;
struct V_156 * V_189 = NULL , * V_190 = NULL ;
struct V_2 * V_3 ;
int V_117 ;
V_3 = F_138 ( & V_170 -> V_10 , sizeof( struct V_2 ) ,
V_150 ) ;
if ( ! V_3 )
return - V_151 ;
F_172 ( V_170 , V_3 ) ;
V_189 = F_173 ( V_10 -> V_158 , L_66 , 0 ) ;
if ( V_189 ) {
V_3 -> V_118 = F_174 ( V_189 ) ;
F_175 ( V_189 ) ;
if ( ! V_3 -> V_118 )
return - V_191 ;
goto V_192;
}
V_190 = F_176 ( V_10 -> V_158 , NULL ) ;
if ( V_190 ) {
V_189 = F_177 ( V_190 ) ;
if ( V_189 ) {
V_3 -> V_118 = F_174 ( V_189 ) ;
if ( ! V_3 -> V_118 ) {
V_3 -> V_135 = F_178 ( V_189 ) ;
if ( ! V_3 -> V_135 ) {
F_175 ( V_189 ) ;
return - V_191 ;
}
...
static int F_182 ( struct V_169 * V_170 )
{
F_181 ( & V_170 -> V_10 ) ;
F_183 ( & V_170 -> V_10 , & V_193 ) ;
return 0 ;
}
static int F_184 ( struct V_155 * V_10 )
{
struct V_2 * V_3 = F_149 ( V_10 ) ;
F_185 ( V_3 -> clock ) ;
return 0 ;
}
static int F_186 ( struct V_155 * V_10 )
{
struct V_2 * V_3 = F_149 ( V_10 ) ;
int V_117 ;
V_117 = F_155 ( V_3 -> clock ) ;
if ( V_117 < 0 ) {
F_101 ( L_69 , V_117 ) ;
return V_117 ;
}
