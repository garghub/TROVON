...
{
struct V_170 * V_206 ;
V_206 = F_92 ( sizeof( struct V_170 ) , V_30 ) ;
if ( ! V_206 )
return NULL ;
...
void * F_96 ( int V_8 , int V_4 , T_1 V_30 , char * * V_208 )
{
struct V_10 * V_12 ;
struct V_170 * V_171 ;
int V_174 = 0 ;
...
return NULL ;
F_27 ( & V_12 -> V_19 ) ;
V_171 = F_97 ( V_12 -> V_18 . V_209 , struct V_170 , V_15 ) ;
...
V_171 -> V_207 += V_4 ;
V_171 -> V_175 ++ ;
F_98 ( & V_171 -> V_15 , & V_12 -> V_18 ) ;
F_28 ( & V_12 -> V_19 ) ;
goto V_210;
}
return NULL ;
}
void F_99 ( void * V_211 )
{
...
static void F_100 ( struct V_10 * V_12 )
{
int V_128 = 0 ;
...
F_27 ( & V_12 -> V_19 ) ;
for (; ; ) {
V_171 = F_97 ( V_12 -> V_18 . V_215 , struct V_170 ,
V_15 ) ;
if ( (struct V_216 * ) V_171 == & V_12 -> V_18 )
break;
V_4 = V_171 -> V_4 ;
V_174 = V_171 -> V_174 ;
F_101 ( V_4 == 0 && V_171 -> V_175 == 0 ) ;
F_28 ( & V_12 -> V_19 ) ;
V_128 = 0 ;
if ( V_4 ) {
V_128 = F_102 ( V_12 -> V_76 , V_171 -> V_172 , V_174 , V_4 ,
V_212 ) ;
...
{
struct V_10 * V_12 = F_107 ( V_221 , struct V_10 , V_22 ) ;
int V_222 ;
F_39 ( V_78 , & V_12 -> V_79 ) ;
do {
...
{
struct V_10 * V_12 = F_107 ( V_221 , struct V_10 , V_20 ) ;
...
error = - V_72 ;
V_14 = F_121 ( L_45 , sizeof( struct V_10 ) ,
F_122 ( struct V_10 ) , 0 ,
NULL ) ;
if ( ! V_14 )
goto V_225;
