...
int V_86 = 32 ;
int V_13 ;
if ( F_48 ( & V_2 -> V_54 -> V_77 . V_87 ) )
return 0 ;
if ( F_49 ( V_2 ) || V_2 -> V_66 . V_88 <= ( 32 * 1024 * 1024 ) )
V_86 = 8 ;
V_15 = F_50 ( sizeof( struct V_14 ) , V_89 ) ;
if ( ! V_15 )
return - V_32 ;
V_15 -> V_2 = V_2 ;
V_2 -> V_82 . V_15 = V_15 ;
...
{
if ( V_2 -> V_82 . V_15 )
F_58 ( V_2 -> V_82 . V_15 -> V_40 . V_95 , V_94 ) ;
}
bool F_59 ( struct V_1 * V_2 , struct V_11 * V_96 )
{
if ( ! V_2 -> V_82 . V_15 )
return false ;
if ( V_96 == F_4 ( V_2 -> V_82 . V_15 -> V_55 . V_85 ) )
return true ;
return false ;
}
void F_60 ( struct V_1 * V_2 , struct V_97 * V_98 )
{
if ( V_2 -> V_82 . V_15 )
F_61 ( & V_2 -> V_82 . V_15 -> V_40 , V_98 ) ;
}
void F_62 ( struct V_1 * V_2 , struct V_97 * V_98 )
{
if ( V_2 -> V_82 . V_15 )
F_63 ( & V_2 -> V_82 . V_15 -> V_40 , V_98 ) ;
}
