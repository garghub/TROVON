...
if ( F_40 ( V_84 -> V_89 [ V_74 ] ) &&
F_41 ( V_81 -> V_90 , V_74 ,
V_78 , V_79 , & V_76 , & V_77 ) )
V_75 ++ ;
}
F_10 ( V_75 > 0 ) ;
V_28 -> V_39 = F_42 ( V_75 * sizeof( V_28 -> V_39 [ 0 ] ) , V_51 ) ;
if ( ! V_28 -> V_39 )
return - V_55 ;
V_28 -> V_38 = V_75 ;
for ( V_74 = 0 , V_75 = 0 ; V_74 < V_84 -> V_88 ; ++ V_74 ) {
