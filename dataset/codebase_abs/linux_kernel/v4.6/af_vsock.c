...
static int F_94 ( struct V_64 * V_5 , struct V_64 * V_155 , int V_136 )
{
struct V_5 * V_26 ;
int V_93 ;
struct V_5 * V_31 ;
...
V_144 = F_95 ( V_6 , V_127 -> V_129 & V_189 ) ;
V_93 = V_1 -> V_190 ( V_4 , & V_186 ) ;
if ( V_93 < 0 )
goto V_42;
while ( V_184 < V_128 ) {
T_9 V_191 ;
...
static int F_110 ( struct V_63 * V_63 , struct V_64 * V_5 ,
int V_212 , int V_67 )
{
if ( ! V_5 )
return - V_59 ;
...
static long F_111 ( struct V_108 * V_220 ,
...
static long F_113 ( struct V_108 * V_220 ,
unsigned int V_221 , unsigned long V_225 )
{
return F_111 ( V_220 , V_221 , ( void T_6 * ) V_225 ) ;
}
static long F_114 ( struct V_108 * V_220 ,
unsigned int V_221 , unsigned long V_225 )
{
return F_111 ( V_220 , V_221 , F_115 ( V_225 ) ) ;
}
int F_116 ( const struct V_226 * V_227 , struct V_228 * V_81 )
{
int V_93 = F_117 ( & V_229 ) ;
if ( V_93 )
return V_93 ;
if ( V_1 ) {
V_93 = - V_230 ;
