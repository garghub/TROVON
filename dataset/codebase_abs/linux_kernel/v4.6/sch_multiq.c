...
if ( V_33 == NULL )
return - V_38 ;
V_7 -> V_40 = F_15 ( V_4 ) -> V_49 ;
V_7 -> V_22 = F_35 ( V_7 -> V_40 , sizeof( struct V_1 * ) , V_50 ) ;
if ( ! V_7 -> V_22 )
return - V_51 ;
...
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
unsigned char * V_52 = F_37 ( V_3 ) ;
struct V_34 V_33 ;
V_33 . V_21 = V_7 -> V_21 ;
V_33 . V_40 = V_7 -> V_40 ;
if ( F_38 ( V_3 , V_53 , sizeof( V_33 ) , & V_33 ) )
goto V_54;
return V_3 -> V_30 ;
V_54:
F_39 ( V_3 , V_52 ) ;
...
static int F_40 ( struct V_1 * V_4 , unsigned long V_55 , struct V_1 * V_56 ,
struct V_1 * * V_45 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
...
if ( V_56 == NULL )
V_56 = & V_41 ;
* V_45 = F_41 ( V_4 , V_56 , & V_7 -> V_22 [ V_8 ] ) ;
return 0 ;
}
static struct V_1 *
F_42 ( struct V_1 * V_4 , unsigned long V_55 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
unsigned long V_8 = V_55 - 1 ;
return V_7 -> V_22 [ V_8 ] ;
}
static unsigned long F_43 ( struct V_1 * V_4 , T_1 V_57 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
unsigned long V_8 = F_44 ( V_57 ) ;
if ( V_8 - 1 >= V_7 -> V_21 )
return 0 ;
return V_8 ;
}
static unsigned long F_45 ( struct V_1 * V_4 , unsigned long V_58 ,
T_1 V_57 )
{
return F_43 ( V_4 , V_57 ) ;
}
static void F_46 ( struct V_1 * V_7 , unsigned long V_59 )
{
}
...
struct V_6 * V_7 = F_2 ( V_4 ) ;
V_61 -> V_62 |= F_44 ( V_59 ) ;
V_61 -> V_63 = V_7 -> V_22 [ V_59 - 1 ] -> V_48 ;
return 0 ;
}
static int F_48 ( struct V_1 * V_4 , unsigned long V_59 ,
struct V_64 * V_65 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
struct V_1 * V_66 ;
V_66 = V_7 -> V_22 [ V_59 - 1 ] ;
if ( F_49 ( V_65 , NULL , & V_66 -> V_67 ) < 0 ||
F_50 ( V_65 , NULL , & V_66 -> V_43 , V_66 -> V_7 . V_25 ) < 0 )
return - 1 ;
return 0 ;
}
