...
V_71 ;
F_47 ( & V_2 -> V_10 . V_11 , 0 , V_2 -> V_16 . V_17 ) ;
return 0 ;
}
static struct V_77 *
...
struct V_80 * V_81 ;
F_49 ( L_8 , V_78 , V_5 ) ;
F_50 ( V_78 > V_2 -> V_16 . V_34 - V_5 ) ;
V_79 = F_51 ( sizeof( * V_79 ) , V_82 ) ;
if ( V_79 == NULL )
return NULL ;
if ( F_52 ( V_79 , 1 , V_82 ) ) {
F_53 ( V_79 ) ;
...
V_81 -> V_78 = 0 ;
V_81 -> V_84 = V_5 ;
F_54 ( V_81 ) = ( V_85 ) V_2 -> V_10 . V_52 + V_78 ;
F_55 ( V_81 ) = V_5 ;
return V_79 ;
}
...
static void
F_60 ( struct V_86 * V_87 )
{
struct V_1 * V_2 = V_87 -> V_23 . V_19 -> V_20 ;
if ( V_87 -> V_11 ) {
F_8 ( V_2 , V_87 -> V_11 ) ;
F_53 ( V_87 -> V_11 ) ;
V_87 -> V_11 = NULL ;
...
if ( V_87 == NULL )
return NULL ;
F_63 ( V_19 , & V_87 -> V_23 , V_11 -> V_5 ) ;
F_64 ( V_87 , & V_90 ) ;
V_87 -> V_89 = F_48 ( V_19 ,
V_11 -> V_7 , V_11 -> V_5 ) ;
if ( V_87 -> V_89 == NULL )
goto V_91;
V_87 -> V_92 . V_81 = V_87 -> V_89 -> V_83 ;
V_87 -> V_92 . V_93 = 0 ;
F_65 ( V_87 ) ;
V_87 -> V_11 = V_11 ;
V_87 -> V_23 . V_94 = V_95 | V_96 ;
V_87 -> V_97 = F_66 ( V_19 ) ? V_98 : V_99 ;
return V_87 ;
V_91:
F_67 ( V_87 ) ;
return NULL ;
...
{
struct V_1 * V_2 = V_19 -> V_20 ;
struct V_102 * V_103 = & V_2 -> V_16 . V_23 ;
struct V_86 * V_87 ;
struct V_3 * V_11 ;
struct V_104 * V_105 ;
int V_9 ;
...
V_105 -> V_109 |= V_110 ;
F_76 ( V_105 ) ;
F_77 ( & V_105 -> V_111 , & V_103 -> V_112 ) ;
}
F_77 ( & V_87 -> V_113 , & V_2 -> V_10 . V_114 ) ;
F_65 ( V_87 ) ;
return V_87 ;
V_108:
F_78 ( & V_87 -> V_23 ) ;
