...
V_49 -> V_7 . V_69 = V_70 ;
V_49 -> V_7 . V_8 = V_8 ;
V_62 = F_43 ( & V_49 -> V_7 , L_7 , F_47 ( & V_8 -> V_50 ) ) ;
if ( V_62 )
goto V_71;
V_49 -> V_2 = V_2 ;
V_2 -> V_49 = V_49 ;
...
F_24 ( V_2 , V_76 ) ;
V_49 -> V_53 = true ;
F_51 (driver, &gadget_driver_pending_list, pending) {
...
char * V_25 = NULL ;
F_48 ( & V_72 ) ;
F_51 (udc, &udc_list, list) {
if ( ! V_49 -> V_55 ) {
V_25 = F_58 ( V_49 -> V_2 -> V_25 , V_64 ) ;
break;
}
}
F_54 ( & V_72 ) ;
...
F_35 ( & V_49 -> V_7 , L_8 ,
V_49 -> V_55 -> V_80 ) ;
F_61 ( & V_49 -> V_7 . V_50 , V_81 ) ;
F_28 ( V_49 -> V_2 ) ;
V_49 -> V_55 -> V_82 ( V_49 -> V_2 ) ;
V_49 -> V_55 -> V_83 ( V_49 -> V_2 ) ;
F_32 ( V_49 ) ;
V_49 -> V_55 = NULL ;
V_49 -> V_7 . V_55 = NULL ;
...
F_54 ( & V_72 ) ;
F_61 ( & V_49 -> V_7 . V_50 , V_85 ) ;
F_64 ( & V_2 -> V_47 ) ;
F_65 ( & V_49 -> V_7 ) ;
F_65 ( & V_2 -> V_7 ) ;
}
static int F_52 ( struct V_48 * V_49 , struct V_54 * V_55 )
{
int V_62 ;
F_35 ( & V_49 -> V_7 , L_10 ,
V_55 -> V_80 ) ;
...
if ( V_55 -> V_77 ) {
F_51 (udc, &udc_list, list) {
V_62 = strcmp ( V_55 -> V_77 , F_36 ( & V_49 -> V_7 ) ) ;
if ( ! V_62 )
break;
}
if ( ! V_62 && ! V_49 -> V_55 )
...
struct V_92 * V_93 , const char * V_18 , T_4 V_94 )
{
...
static T_3 F_73 ( struct V_6 * V_7 , struct V_92 * V_93 ,
char * V_18 )
{
struct V_48 * V_49 = F_34 ( V_7 , struct V_48 , V_7 ) ;
...
static int F_75 ( struct V_6 * V_7 , struct V_96 * V_97 )
{
struct V_48 * V_49 = F_34 ( V_7 , struct V_48 , V_7 ) ;
int V_62 ;
V_62 = F_76 ( V_97 , L_18 , V_49 -> V_2 -> V_25 ) ;
if ( V_62 ) {
F_3 ( V_7 , L_19 ) ;
return V_62 ;
}
