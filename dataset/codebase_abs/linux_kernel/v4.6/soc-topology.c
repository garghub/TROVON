...
if ( V_48 == NULL )
return - V_63 ;
V_48 -> V_34 = V_208 -> V_209 ;
V_48 -> V_20 = V_208 -> V_210 ;
if ( V_208 -> V_211 ) {
V_197 = & V_48 -> V_211 ;
V_199 = & V_208 -> V_199 [ V_212 ] ;
F_65 ( V_197 , V_199 ) ;
}
if ( V_208 -> V_213 ) {
V_197 = & V_48 -> V_213 ;
V_199 = & V_208 -> V_199 [ V_214 ] ;
F_65 ( V_197 , V_199 ) ;
}
V_36 = F_15 ( V_2 , V_48 ) ;
if ( V_36 < 0 ) {
F_2 ( V_2 -> V_37 -> V_12 , L_40 ) ;
F_26 ( V_48 ) ;
return V_36 ;
}
V_48 -> V_67 . V_29 = V_2 -> V_29 ;
V_48 -> V_67 . V_30 = V_2 -> V_30 ;
V_48 -> V_67 . type = V_215 ;
F_44 ( & V_48 -> V_67 . V_75 , & V_2 -> V_37 -> V_139 ) ;
return F_67 ( V_2 -> V_37 , V_48 ) ;
}
...
if ( V_51 == NULL )
return - V_63 ;
V_51 -> V_34 = V_208 -> V_216 ;
V_51 -> V_200 = V_208 -> V_216 ;
V_36 = F_16 ( V_2 , V_51 ) ;
if ( V_36 < 0 ) {
F_2 ( V_2 -> V_37 -> V_12 , L_41 ) ;
F_26 ( V_51 ) ;
return V_36 ;
}
V_51 -> V_67 . V_29 = V_2 -> V_29 ;
V_51 -> V_67 . V_30 = V_2 -> V_30 ;
V_51 -> V_67 . type = V_217 ;
F_44 ( & V_51 -> V_67 . V_75 , & V_2 -> V_37 -> V_139 ) ;
F_69 ( V_2 -> V_37 -> V_55 , V_51 ) ;
return 0 ;
}
...
F_39 ( V_2 -> V_12 , L_44 , V_4 ) ;
V_2 -> V_8 += sizeof( struct V_207 ) * V_4 ;
return 0 ;
}
...
if ( V_2 -> V_40 != V_220 )
return 0 ;
V_219 = (struct V_218 * ) V_2 -> V_8 ;
V_2 -> V_8 += sizeof( struct V_218 ) ;
if ( V_2 -> V_37 && V_2 -> V_30 && V_2 -> V_30 -> V_219 )
return V_2 -> V_30 -> V_219 ( V_2 -> V_37 , V_219 ) ;
F_2 ( V_2 -> V_12 , L_45 ) ;
return 0 ;
}
...
F_39 ( V_2 -> V_12 ,
L_50 ,
V_28 -> V_165 , V_28 -> type , V_28 -> V_225 ,
V_28 -> V_39 , V_2 -> V_40 ) ;
return 1 ;
}
...
int F_78 ( struct V_65 * V_37 ,
struct V_237 * V_30 , const struct V_238 * V_9 , V_154 V_20 )
{
struct V_1 V_2 ;
...
void F_79 ( struct V_42 * V_43 )
{
if ( V_43 -> V_67 . type != V_195 )
return;
F_29 ( V_43 -> V_174 -> V_239 , & V_43 -> V_67 , V_83 ) ;
}
void F_80 ( struct V_173 * V_174 ,
V_154 V_29 )
{
struct V_42 * V_43 , * V_240 ;
F_81 (w, next_w, &dapm->card->widgets, list) {
if ( V_43 -> V_67 . type != V_195 || V_43 -> V_174 != V_174 )
continue;
if ( V_43 -> V_67 . V_29 != V_29 &&
V_43 -> V_67 . V_29 != V_227 )
continue;
F_79 ( V_43 ) ;
F_82 ( V_43 ) ;
}
...
int F_84 ( struct V_65 * V_37 , V_154 V_29 )
{
struct V_66 * V_67 , * V_241 ;
int V_40 = V_236 ;
while ( V_40 >= V_235 ) {
F_81 (dobj, next_dobj, &comp->dobj_list,
list) {
if ( V_67 -> V_29 != V_29 &&
V_67 -> V_29 != V_227 )
continue;
