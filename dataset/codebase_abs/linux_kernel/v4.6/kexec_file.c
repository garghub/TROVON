...
if ( V_21 ) {
V_2 -> V_15 = F_16 ( V_21 , V_33 ) ;
if ( ! V_2 -> V_15 ) {
V_23 = - V_34 ;
goto V_29;
}
V_23 = F_17 ( V_2 -> V_15 , V_20 ,
V_21 ) ;
if ( V_23 ) {
V_23 = - V_35 ;
goto V_29;
...
static int F_26 ( unsigned long V_43 , unsigned long V_52 ,
struct V_53 * V_54 )
{
struct V_1 * V_2 = V_54 -> V_2 ;
unsigned long V_55 , V_56 ;
V_56 = F_27 ( V_52 , V_54 -> V_57 ) ;
V_55 = V_56 - V_54 -> V_58 ;
do {
...
static int F_29 ( unsigned long V_43 , unsigned long V_52 ,
struct V_53 * V_54 )
{
struct V_1 * V_2 = V_54 -> V_2 ;
unsigned long V_55 , V_56 ;
V_55 = F_30 ( V_43 , V_54 -> V_60 ) ;
do {
V_55 = F_31 ( V_55 , V_54 -> V_59 ) ;
V_56 = V_55 + V_54 -> V_58 - 1 ;
...
static int F_32 ( T_5 V_43 , T_5 V_52 , void * V_63 )
{
...
return 0 ;
if ( V_54 -> V_65 )
return F_26 ( V_43 , V_52 , V_54 ) ;
return F_29 ( V_43 , V_52 , V_54 ) ;
}
int F_33 ( struct V_1 * V_2 , char * V_66 , unsigned long V_67 ,
unsigned long V_58 , unsigned long V_59 ,
unsigned long V_60 , unsigned long V_57 ,
bool V_65 , unsigned long * V_68 )
{
struct V_69 * V_70 ;
struct V_53 V_3 , * V_54 ;
int V_23 ;
if ( ! V_2 -> V_40 )
return - V_6 ;
if ( V_2 -> V_71 >= V_72 )
...
memset ( & V_3 , 0 , sizeof( struct V_53 ) ) ;
V_54 = & V_3 ;
V_54 -> V_2 = V_2 ;
V_54 -> V_66 = V_66 ;
V_54 -> V_67 = V_67 ;
V_54 -> V_58 = F_31 ( V_58 , V_61 ) ;
V_54 -> V_59 = F_30 ( V_59 , V_61 ) ;
V_54 -> V_60 = V_60 ;
V_54 -> V_57 = V_57 ;
V_54 -> V_65 = V_65 ;
if ( V_2 -> type == V_44 )
...
V_85 = F_43 ( V_79 ) + sizeof( * V_73 ) ;
V_73 = F_16 ( V_85 , V_33 ) ;
if ( ! V_73 ) {
V_23 = - V_34 ;
goto V_92;
}
V_84 = V_72 * sizeof( struct V_89 ) ;
V_90 = F_44 ( V_84 ) ;
if ( ! V_90 )
goto V_93;
V_73 -> V_79 = V_79 ;
...
for ( V_82 = V_81 = 0 ; V_81 < V_2 -> V_71 ; V_81 ++ ) {
struct V_69 * V_70 ;
V_70 = & V_2 -> V_77 [ V_81 ] ;
if ( V_70 -> V_54 == V_12 -> V_16 )
continue;
V_23 = F_46 ( V_73 , V_70 -> V_54 ,
V_70 -> V_67 ) ;
if ( V_23 )
break;
V_86 = V_70 -> V_58 - V_70 -> V_67 ;
while ( V_86 ) {
unsigned long V_96 = V_86 ;
if ( V_96 > V_83 )
V_96 = V_83 ;
V_23 = F_46 ( V_73 , V_88 , V_96 ) ;
if ( V_23 )
break;
V_86 -= V_96 ;
}
if ( V_23 )
break;
V_90 [ V_82 ] . V_43 = V_70 -> V_62 ;
V_90 [ V_82 ] . V_97 = V_70 -> V_58 ;
V_82 ++ ;
}
if ( ! V_23 ) {
V_23 = F_47 ( V_73 , V_87 ) ;
...
static int F_49 ( struct V_1 * V_2 , unsigned long F_27 ,
unsigned long F_30 , int V_65 )
{
struct V_11 * V_12 = & V_2 -> V_11 ;
unsigned long V_99 , V_59 , V_100 , V_101 , V_102 , V_103 ;
unsigned long V_58 , V_104 , V_68 , V_105 , V_106 , V_107 ;
...
V_9 = F_44 ( V_12 -> V_8 -> V_113 * sizeof( T_2 ) ) ;
if ( ! V_9 )
return - V_34 ;
...
if ( V_59 < V_99 )
V_59 = V_99 ;
V_101 = F_31 ( V_101 , V_99 ) ;
V_101 += V_9 [ V_81 ] . V_122 ;
} else {
if ( V_100 < V_99 )
V_100 = V_99 ;
V_102 = F_31 ( V_102 , V_99 ) ;
V_102 += V_9 [ V_81 ] . V_122 ;
}
}
V_103 = 0 ;
if ( V_101 & ( V_100 - 1 ) )
V_103 = V_100 - ( V_101 & ( V_100 - 1 ) ) ;
V_58 = V_101 + V_103 + V_102 ;
V_16 = F_44 ( V_101 ) ;
if ( ! V_16 ) {
V_23 = - V_34 ;
goto V_29;
...
if ( V_59 < V_100 )
V_59 = V_100 ;
V_23 = F_33 ( V_2 , V_16 , V_101 , V_58 ,
V_59 , F_27 , F_30 , V_65 ,
& V_12 -> V_124 ) ;
if ( V_23 )
goto V_29;
V_108 = V_16 ;
V_68 = V_105 = V_12 -> V_124 ;
V_106 = V_68 + V_101 + V_103 ;
for ( V_81 = 0 ; V_81 < V_12 -> V_8 -> V_113 ; V_81 ++ ) {
if ( ! ( V_9 [ V_81 ] . V_118 & V_119 ) )
continue;
V_99 = V_9 [ V_81 ] . V_123 ;
if ( V_9 [ V_81 ] . V_114 != V_115 ) {
V_105 = F_31 ( V_105 , V_99 ) ;
V_107 = V_105 - V_68 ;
...
V_106 = F_31 ( V_106 , V_99 ) ;
V_9 [ V_81 ] . V_121 = V_106 ;
V_106 += V_9 [ V_81 ] . V_122 ;
}
}
if ( V_110 >= 0 )
V_104 += V_9 [ V_110 ] . V_121 ;
V_2 -> V_43 = V_104 ;
V_12 -> V_9 = V_9 ;
V_12 -> V_16 = V_16 ;
return V_23 ;
...
int F_51 ( struct V_1 * V_2 , unsigned long F_27 ,
unsigned long F_30 , int V_65 ,
unsigned long * V_68 )
{
struct V_11 * V_12 = & V_2 -> V_11 ;
...
static T_7 * F_53 ( struct V_11 * V_12 ,
const char * V_139 )
{
T_7 * V_140 ;
T_2 * V_9 ;
...
if ( F_54 ( V_140 [ V_141 ] . V_144 ) != V_145 )
continue;
...
void * F_55 ( struct V_1 * V_2 , const char * V_139 )
{
struct V_11 * V_12 = & V_2 -> V_11 ;
T_7 * V_149 ;
T_2 * V_150 ;
V_149 = F_53 ( V_12 , V_139 ) ;
if ( ! V_149 )
return F_3 ( - V_6 ) ;
V_150 = & V_12 -> V_9 [ V_149 -> V_147 ] ;
return ( void * ) ( V_150 -> V_121 + V_149 -> V_151 ) ;
}
int F_48 ( struct V_1 * V_2 , const char * V_139 ,
