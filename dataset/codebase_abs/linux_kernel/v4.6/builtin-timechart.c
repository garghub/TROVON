...
struct V_144 * V_145 = malloc ( sizeof( * V_145 ) ) ;
if ( ! V_145 )
return;
V_145 -> V_101 = F_4 ( string ) ;
V_145 -> V_4 = V_4 ;
V_145 -> V_7 = V_144 ;
V_144 = V_145 ;
}
...
V_145 = V_144 ;
while ( V_145 ) {
if ( V_145 -> V_4 && V_9 -> V_4 == V_145 -> V_4 )
return 1 ;
if ( strcmp ( V_145 -> V_101 , V_11 -> V_8 ) == 0 )
return 1 ;
V_145 = V_145 -> V_7 ;
}
return 0 ;
...
static int F_73 ( struct V_2 * V_3 , T_1 V_147 )
{
struct V_1 * V_9 ;
struct V_10 * V_11 ;
int V_146 = 0 ;
...
static int F_74 ( struct V_2 * V_2 , T_1 V_147 )
{
struct V_1 * V_9 ;
struct V_10 * V_11 ;
int V_146 = 0 ;
...
static void F_75 ( struct V_2 * V_3 , const char * V_148 )
{
T_1 V_70 ;
int V_146 ;
int V_149 = V_3 -> V_130 ? V_150 : V_151 ;
if ( V_3 -> V_152 )
V_3 -> V_153 = 0 ;
do {
if ( V_144 )
...
V_146 = F_74 ( V_3 , V_149 ) ;
else
V_146 = F_73 ( V_3 , V_149 ) ;
V_149 /= 10 ;
} while ( ! V_144 && V_149 && V_146 < V_3 -> V_153 );
if ( ! V_3 -> V_153 )
V_146 = 0 ;
if ( V_3 -> V_130 ) {
F_76 ( V_148 , 0 , V_146 , V_3 -> V_49 , V_3 -> V_107 ) ;
F_77 ( 0.5 ) ;
F_78 () ;
F_59 ( V_3 ) ;
} else {
F_76 ( V_148 , V_3 -> V_112 , V_146 , V_3 -> V_49 , V_3 -> V_107 ) ;
F_77 ( 0 ) ;
F_79 () ;
...
static int F_82 ( struct V_155 * T_7 V_34 ,
struct V_156 * V_157 ,
int V_158 ,
int V_113 V_34 ,
void * V_159 )
...
switch ( V_158 ) {
case V_160 :
V_3 -> V_112 = V_157 -> V_161 . V_162 ;
break;
case V_163 :
if ( ! V_3 -> V_164 )
break;
if ( F_83 ( V_157 -> V_161 . V_165 ,
V_157 -> V_161 . V_166 ,
V_157 -> V_161 . V_167 ,
V_157 -> V_161 . V_168 ) )
fprintf ( V_79 , L_40 ) ;
...
static int F_84 ( struct V_2 * V_3 , const char * V_169 )
{
...
struct V_179 * V_180 = F_86 ( & V_173 , false ,
& V_3 -> V_30 ) ;
int V_118 = - V_181 ;
if ( V_180 == NULL )
return - 1 ;
F_87 ( & V_180 -> V_80 . V_161 ) ;
( void ) F_88 ( & V_180 -> V_80 ,
F_89 ( V_180 -> V_173 ) ,
V_3 ,
F_82 ) ;
if ( ! F_90 ( V_180 , L_96 ) )
...
F_75 ( V_3 , V_169 ) ;
F_94 ( L_98 ,
( V_3 -> V_107 - V_3 -> V_49 ) / 1000000000.0 , V_169 ) ;
V_182:
F_95 ( V_180 ) ;
return V_118 ;
}
static int F_96 ( int V_183 , const char * * V_184 )
{
unsigned int V_185 , V_70 ;
const char * * V_186 ;
const char * * V_9 ;
char * V_187 = NULL ;
...
V_195 * 4 +
V_183 ;
V_186 = calloc ( V_185 + 1 , sizeof( char * ) ) ;
if ( V_186 == NULL )
return - V_116 ;
if ( F_98 ( & V_187 , L_104 , F_99 () ) < 0 )
return - V_116 ;
V_9 = V_186 ;
...
for ( V_70 = 0 ; V_70 < ( unsigned int ) V_183 ; V_70 ++ )
* V_9 ++ = V_184 [ V_70 ] ;
return F_101 ( V_185 , V_186 , NULL ) ;
}
static int F_102 ( struct V_2 * V_3 , int V_183 , const char * * V_184 )
{
unsigned int V_185 , V_70 , V_196 ;
const char * * V_186 ;
const char * * V_9 ;
unsigned int V_197 ;
const char * const V_188 [] = {
...
* V_9 ++ = F_4 ( V_202 [ V_70 ] ) ;
for ( V_196 = 0 ; V_196 < ( unsigned int ) V_183 ; V_196 ++ )
* V_9 ++ = V_184 [ V_196 ] ;
return F_101 ( V_185 , V_186 , NULL ) ;
}
static int
F_103 ( const struct V_208 * T_8 V_34 , const char * V_209 ,
int V_34 V_210 )
{
if ( V_209 )
F_69 ( V_209 ) ;
...
static int
F_104 ( const struct V_208 * T_8 V_34 , const char * V_209 ,
int V_34 V_210 )
{
unsigned long V_211 = strtoul ( V_209 , NULL , 0 ) ;
if ( V_212 || V_213 )
return - 1 ;
if ( V_211 )
V_212 = V_211 ;
...
static int
F_105 ( const struct V_208 * T_8 , const char * V_209 , int V_34 V_210 )
{
char V_214 = 'n' ;
T_1 * V_111 = T_8 -> V_111 ;
if ( sscanf ( V_209 , L_4 V_215 L_108 , V_111 , & V_214 ) > 0 ) {
switch ( V_214 ) {
case 'm' :
* V_111 *= 1000000 ;
break;
...
int F_106 ( int V_183 , const char * * V_184 ,
const char * T_9 V_34 )
{
struct V_2 V_3 = {
. V_30 = {
...
const char * V_169 = L_109 ;
const struct V_208 V_217 [] = {
F_107 ( 'i' , L_110 , & V_175 , L_111 , L_112 ) ,
F_107 ( 'o' , L_113 , & V_169 , L_111 , L_114 ) ,
F_108 ( 'w' , L_115 , & V_218 , L_116 ) ,
F_109 ( 0 , L_117 , NULL , L_118 ,
L_119 ,
F_104 ) ,
F_110 ( 'P' , L_120 , & V_3 . V_152 , L_121 ) ,
F_110 ( 'T' , L_122 , & V_3 . V_154 ,
L_123 ) ,
F_109 ( 'p' , L_37 , NULL , L_37 ,
L_124 ,
F_103 ) ,
F_107 ( 0 , L_125 , & V_219 . V_220 , L_126 ,
L_127 ) ,
F_108 ( 'n' , L_128 , & V_3 . V_153 ,
L_129 ) ,
F_110 ( 't' , L_130 , & V_3 . V_164 ,
L_131 ) ,
...
L_138 ,
F_105 ) ,
F_110 ( 'f' , L_139 , & V_3 . V_178 , L_140 ) ,
F_111 ()
} ;
const char * const V_221 [] = { L_99 , NULL } ;
const char * V_222 [] = {
L_141 ,
NULL
} ;
const struct V_208 V_223 [] = {
F_110 ( 'P' , L_120 , & V_3 . V_152 , L_121 ) ,
F_110 ( 'T' , L_122 , & V_3 . V_154 ,
L_123 ) ,
F_110 ( 'I' , L_142 , & V_3 . V_224 ,
L_143 ) ,
F_110 ( 'g' , L_144 , & V_3 . V_207 , L_145 ) ,
F_111 ()
} ;
const char * const V_225 [] = {
L_146 ,
NULL
} ;
V_183 = F_112 ( V_183 , V_184 , V_217 , V_221 ,
V_222 , V_226 ) ;
if ( V_3 . V_152 && V_3 . V_154 ) {
F_92 ( L_147 ) ;
return - 1 ;
}
if ( V_183 && ! strncmp ( V_184 [ 0 ] , L_148 , 3 ) ) {
V_183 = F_113 ( V_183 , V_184 , V_223 ,
V_225 ,
V_226 ) ;
if ( V_3 . V_152 && V_3 . V_154 ) {
F_92 ( L_147 ) ;
...
if ( V_3 . V_224 )
return F_96 ( V_183 , V_184 ) ;
else
return F_102 ( & V_3 , V_183 , V_184 ) ;
} else if ( V_183 )
F_114 ( V_222 , V_217 ) ;
F_115 () ;
return F_84 ( & V_3 , V_169 ) ;
}
