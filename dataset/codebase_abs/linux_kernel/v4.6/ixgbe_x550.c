...
static T_1 F_28 ( struct V_1 * V_2 , T_2 V_58 ,
T_2 V_59 , T_2 * V_77 )
{
T_2 V_78 = V_79 | V_80 ;
T_2 V_73 , error ;
...
static T_1 F_29 ( struct V_1 * V_2 , T_3 V_88 ,
T_3 * V_77 )
{
T_1 V_25 ;
struct V_89 V_90 ;
...
V_90 . V_100 = F_30 ( V_88 * 2 ) ;
V_90 . V_101 = F_31 ( sizeof( T_3 ) ) ;
V_25 = F_32 ( V_2 , ( T_2 * ) & V_90 ,
sizeof( V_90 ) ,
V_102 , false ) ;
if ( V_25 )
return V_25 ;
* V_77 = ( T_3 ) F_33 ( V_2 , V_103 ,
V_104 ) ;
return 0 ;
}
...
V_90 . V_91 . V_92 . V_96 = V_97 ;
V_90 . V_91 . V_92 . V_98 = V_99 ;
V_90 . V_100 = F_30 ( ( V_88 + V_106 ) * 2 ) ;
V_90 . V_101 = F_31 ( V_107 * 2 ) ;
V_25 = F_32 ( V_2 , ( T_2 * ) & V_90 ,
sizeof( V_90 ) ,
V_102 ,
false ) ;
...
static T_1 F_35 ( struct V_1 * V_2 , T_3 V_110 ,
...
if ( ! V_90 ) {
V_25 = F_34 ( V_2 , V_110 , V_115 , V_114 ) ;
if ( V_25 ) {
F_25 ( V_2 , L_12 ) ;
return V_25 ;
}
...
static T_1 F_36 ( struct V_1 * V_2 , T_3 * V_90 ,
T_2 V_113 )
{
T_3 V_119 [ V_120 + 1 ] ;
T_3 * V_117 ;
...
V_25 = F_35 ( V_2 , V_121 , V_111 , & V_98 ,
V_90 , V_113 ) ;
if ( V_25 )
return V_25 ;
}
...
{
return F_36 ( V_2 , NULL , 0 ) ;
}
static T_1 F_38 ( struct V_1 * V_2 , T_3 V_88 , T_3 * V_77 )
{
T_1 V_25 = 0 ;
if ( V_2 -> V_4 . V_7 . V_41 ( V_2 , V_108 ) == 0 ) {
V_25 = F_29 ( V_2 , V_88 , V_77 ) ;
V_2 -> V_4 . V_7 . V_46 ( V_2 , V_108 ) ;
} else {
V_25 = V_134 ;
}
...
static T_1 F_40 ( struct V_1 * V_2 , T_3 V_88 ,
T_3 V_77 )
{
T_1 V_25 ;
struct V_140 V_90 ;
...
static T_1 F_41 ( struct V_1 * V_2 , T_3 V_88 , T_3 V_77 )
{
T_1 V_25 = 0 ;
if ( V_2 -> V_4 . V_7 . V_41 ( V_2 , V_108 ) == 0 ) {
V_25 = F_40 ( V_2 , V_88 , V_77 ) ;
V_2 -> V_4 . V_7 . V_46 ( V_2 , V_108 ) ;
} else {
F_25 ( V_2 , L_15 ) ;
V_25 = V_134 ;
...
static T_1 F_47 ( struct V_1 * V_2 , T_2 V_58 ,
T_2 V_59 , T_2 V_77 )
{
T_2 V_78 = V_79 | V_80 ;
T_2 V_73 , error ;
...
static T_1 F_48 ( struct V_1 * V_2 , T_5 * V_149 )
{
T_1 V_25 ;
T_2 V_165 ;
V_25 = F_28 ( V_2 ,
...
static T_1 F_54 ( struct V_1 * V_2 , bool * V_183 )
{
...
{
return F_57 ( V_2 , V_2 -> V_6 . V_274 ) ;
}
static T_1 F_70 ( struct V_1 * V_2 , bool * V_218 )
{
T_2 V_81 ;
T_3 V_220 ;
* V_218 = false ;
...
static enum V_310 F_80 ( struct V_1 * V_2 )
{
enum V_310 V_238 ;
switch ( V_2 -> V_49 ) {
case V_54 :
