...
int F_11 ( struct V_5 * V_6 , struct V_1 * V_2 ,
struct V_7 * V_8 )
{
struct V_17 * V_18 ;
if ( ! V_8 )
...
if ( F_13 ( V_18 -> V_7 -> V_20 != V_8 -> V_20 ) )
continue;
F_7 ( & V_18 -> V_7 , V_8 ) ;
return 0 ;
}
...
if ( ! V_18 )
return - V_23 ;
F_15 ( V_2 -> V_3 , & V_18 -> V_24 , V_8 -> V_20 ) ;
V_18 -> V_7 = F_10 ( V_8 ) ;
return 0 ;
}
...
return - V_32 ;
V_8 = F_17 ( V_26 ) ;
V_31 = F_11 ( V_6 , V_2 , V_8 ) ;
V_28 = F_18 ( V_26 ) ;
if ( ! V_28 || V_31 )
return V_31 ;
for ( V_30 = 0 ; V_30 < V_28 -> V_33 ; ++ V_30 ) {
V_8 = F_19 ( V_28 -> V_34 [ V_30 ] ,
F_20 ( V_26 ) ) ;
if ( F_3 ( V_6 , V_8 ) ) {
V_29 = F_6 ( V_8 ) ;
if ( ( V_14 != V_15 ) &&
...
struct V_7 * F_21 ( struct V_1 * V_2 )
{
struct V_17 * V_18 ;
struct V_35 * V_36 ;
struct V_7 * V_8 ;
int V_30 ;
F_22 (sync->fences, i, tmp, e, node) {
V_8 = V_18 -> V_7 ;
F_23 ( & V_18 -> V_24 ) ;
F_24 ( V_21 , V_18 ) ;
if ( ! F_25 ( V_8 ) )
