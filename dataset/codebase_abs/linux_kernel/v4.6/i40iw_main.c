...
static void F_27 ( struct V_21 * V_22 , bool V_47 )
{
enum V_35 V_36 = V_48 ;
struct V_11 * V_12 = & V_22 -> V_25 ;
...
static void F_30 ( struct V_21 * V_22 , bool V_47 )
{
struct V_11 * V_12 = & V_22 -> V_25 ;
...
F_31 ( V_12 , V_80 [ V_60 ] , V_70 , V_18 , V_47 ) ;
}
...
static enum V_35 F_34 ( struct V_11 * V_12 ,
struct V_81 * V_72 )
{
return V_12 -> V_77 -> V_82 ( V_12 , V_72 ) ;
}
static enum V_35 F_35 ( struct V_21 * V_22 ,
bool V_18 )
{
struct V_11 * V_12 = & V_22 -> V_25 ;
struct V_81 V_72 ;
...
enum V_35 F_36 ( struct V_21 * V_22 ,
struct V_88 * V_89 ,
T_1 V_90 ,
T_1 V_91 )
{
...
static enum V_35 F_38 ( struct V_21 * V_22 )
{
enum V_35 V_36 ;
T_1 V_100 = V_101 ;
struct V_88 V_55 ;
...
T_3 V_104 , V_105 ;
int V_60 ;
V_38 -> V_43 = F_39 ( V_100 , sizeof( * V_38 -> V_43 ) , V_106 ) ;
if ( ! V_38 -> V_43 )
return V_99 ;
V_38 -> V_42 = F_39 ( V_100 , sizeof( * V_38 -> V_42 ) , V_106 ) ;
if ( ! V_38 -> V_42 ) {
F_23 ( V_38 -> V_43 ) ;
return V_99 ;
}
...
V_36 = F_40 ( V_12 -> V_19 , & V_38 -> V_41 ,
( sizeof( struct V_108 ) * V_100 ) ,
V_109 ) ;
if ( V_36 )
goto exit;
V_36 = F_36 ( V_22 , & V_55 , sizeof( struct V_110 ) ,
V_111 ) ;
if ( V_36 )
goto exit;
...
F_43 ( & V_38 -> V_43 [ V_60 ] . V_125 ) ;
F_44 ( & V_38 -> V_43 [ V_60 ] . V_9 , & V_38 -> V_123 ) ;
}
return 0 ;
exit:
F_20 ( V_22 , false ) ;
...
V_36 = F_40 ( V_12 -> V_19 , & V_63 -> V_66 ,
V_63 -> V_66 . V_90 , V_132 ) ;
if ( V_36 )
goto exit;
V_36 = F_36 ( V_22 , & V_55 , V_63 -> V_128 . V_90 ,
V_133 ) ;
if ( V_36 )
goto exit;
...
static enum V_35 F_46 ( struct V_21 * V_22 ,
struct V_28 * V_29 ,
T_1 V_144 ,
struct V_44 * V_45 )
{
...
V_36 = F_48 ( V_45 -> V_31 , F_18 , 0 , L_11 , V_22 ) ;
} else {
F_47 ( & V_29 -> V_32 , F_17 , ( unsigned long ) V_29 ) ;
V_36 = F_48 ( V_45 -> V_31 , F_33 , 0 , L_12 , V_29 ) ;
}
if ( V_36 ) {
F_21 ( L_13 ) ;
return V_145 ;
...
static enum V_35 F_49 ( struct V_21 * V_22 ,
struct V_28 * V_29 ,
T_1 V_144 )
{
enum V_35 V_36 ;
...
V_36 = F_40 ( V_12 -> V_19 , & V_29 -> V_55 , V_29 -> V_55 . V_90 ,
V_151 ) ;
if ( V_36 )
goto exit;
V_72 . V_144 = V_144 ;
...
static enum V_35 F_51 ( struct V_21 * V_22 ,
struct V_2 * V_3 )
{
T_1 V_60 ;
T_1 V_144 ;
...
V_161 = F_52 ( V_22 -> V_166 , V_22 -> V_25 . V_167 . V_168 ) ;
...
V_29 -> V_31 = V_45 -> V_31 ;
V_29 -> V_30 = V_45 -> V_27 ;
V_36 = F_46 ( V_22 , V_29 , V_144 , V_45 ) ;
if ( V_36 ) {
...
if ( ! V_22 -> V_23 ) {
F_47 ( & V_22 -> V_32 , F_14 , ( unsigned long ) V_22 ) ;
V_169 = F_48 ( V_45 -> V_31 , F_18 , 0 , L_15 , V_22 ) ;
}
if ( V_169 ) {
F_21 ( L_16 ) ;
return V_145 ;
...
V_36 = F_40 ( V_12 -> V_19 , & V_50 -> V_55 , V_50 -> V_55 . V_90 ,
V_174 ) ;
if ( V_36 )
goto exit;
...
static enum V_35 F_56 ( struct V_21 * V_22 )
{
struct V_180 V_72 ;
enum V_35 V_36 ;
V_72 . type = V_181 ;
...
static enum V_35 F_59 ( struct V_21 * V_22 )
{
enum V_35 V_36 ;
V_22 -> V_84 = V_195 ;
V_36 = F_60 ( & V_22 -> V_25 , V_196 ) ;
if ( V_36 )
goto exit;
V_36 = F_35 ( V_22 , true ) ;
if ( V_36 )
...
static void F_62 ( struct V_21 * V_22 , V_96 V_27 )
{
struct V_37 * V_203 = & V_22 -> V_38 ;
struct V_204 * V_205 ;
struct V_206 * V_207 ;
enum V_35 V_36 = 0 ;
V_205 = F_63 ( V_203 , true ) ;
if ( ! V_205 ) {
F_21 ( L_19 ) ;
return;
}
...
V_36 = F_64 ( V_22 , V_205 ) ;
if ( V_36 )
F_21 ( L_20 ) ;
}
static enum V_35 F_65 ( struct V_21 * V_22 ,
V_96 * V_216 ,
V_96 V_27 )
{
struct V_217 * V_72 ;
...
static enum V_35 F_67 ( struct V_21 * V_22 ,
T_3 * V_220 )
{
struct V_37 * V_203 = & V_22 -> V_38 ;
struct V_204 * V_205 ;
...
static enum V_35 F_70 ( struct V_21 * V_22 ,
V_96 * V_226 )
{
enum V_35 V_36 ;
V_36 = F_67 ( V_22 , & V_22 -> V_227 ) ;
if ( ! V_36 ) {
V_36 = F_65 ( V_22 , V_226 ,
( V_96 ) V_22 -> V_227 ) ;
if ( ! V_36 )
V_36 = F_65 ( V_22 , V_226 ,
( V_96 ) V_22 -> V_227 ) ;
else
F_62 ( V_22 , ( V_96 ) V_22 -> V_227 ) ;
}
return V_36 ;
}
...
T_5 V_233 [ 4 ] ;
F_72 () ;
F_73 (&init_net, ip_dev) {
if ( ( ( ( F_74 ( V_228 ) < 0xFFFF ) &&
( F_75 ( V_228 ) == V_22 -> V_7 ) ) ||
...
F_77 ( L_24 , & V_232 -> V_235 ,
F_74 ( V_228 ) , V_228 -> V_236 ) ;
F_78 ( V_233 ,
...
V_230 = F_84 ( V_12 ) ;
F_85 (idev) {
F_86 ( & V_22 -> V_25 , V_243 ,
L_25 , & V_244 -> V_245 ,
F_74 ( V_12 ) , V_12 -> V_236 ) ;
V_242 = F_87 ( V_244 -> V_245 ) ;
F_79 ( V_22 ,
V_12 -> V_236 ,
& V_242 ,
true ,
...
static enum V_35 F_91 ( struct V_21 * V_22 )
{
struct V_8 * V_7 = V_22 -> V_7 ;
enum V_35 V_36 ;
V_36 = F_70 ( V_22 , ( V_96 * ) V_7 -> V_236 ) ;
if ( V_36 )
return V_36 ;
F_81 ( V_22 ) ;
F_71 ( V_22 ) ;
...
static void F_92 ( struct V_246 * V_19 )
{
T_1 V_247 ;
T_1 V_248 ;
T_1 V_249 ;
...
T_1 V_251 = 0 ;
do {
V_247 = F_93 ( V_19 , V_252 ) ;
F_77 ( L_26 , __LINE__ , V_247 ) ;
V_248 = F_93 ( V_19 , V_253 ) ;
F_77 ( L_27 , __LINE__ , V_248 ) ;
V_249 = F_93 ( V_19 , V_254 ) ;
F_77 ( L_28 ,
__LINE__ , V_249 ) ;
V_250 = F_93 ( V_19 , V_255 ) ;
F_77 ( L_29 ,
__LINE__ , V_250 ) ;
...
static enum V_35 F_95 ( struct V_21 * V_22 ,
struct V_2 * V_3 )
{
enum V_35 V_36 ;
struct V_11 * V_12 = & V_22 -> V_25 ;
...
V_36 = F_36 ( V_22 , & V_55 , V_262 ,
V_263 ) ;
if ( V_36 )
goto exit;
V_72 . V_264 = V_55 . V_97 ;
V_72 . V_265 = V_55 . V_92 ;
V_36 = F_36 ( V_22 , & V_55 , V_266 ,
V_267 ) ;
if ( V_36 )
goto exit;
...
F_27 ( V_22 , V_47 ) ;
case V_307 :
F_110 ( V_12 , V_193 , V_47 ) ;
case V_308 :
F_110 ( V_12 , V_181 , V_47 ) ;
case V_309 :
F_30 ( V_22 , V_47 ) ;
case V_310 :
F_111 ( V_12 , V_22 -> V_260 ) ;
case V_198 :
F_32 ( V_12 , V_12 -> V_70 , true , V_47 ) ;
case V_311 :
F_20 ( V_22 , ! V_47 ) ;
case V_312 :
F_112 ( & V_22 -> V_313 ) ;
...
static enum V_35 F_114 ( struct V_1 * V_4 ,
struct V_2 * V_3 ,
struct V_315 * V_160 )
{
...
V_22 -> V_7 = V_3 -> V_7 ;
V_4 -> V_160 = V_160 ;
V_22 -> V_188 = ( ! V_3 -> V_277 . V_320 ) ? V_321 : V_3 -> V_277 . V_320 - V_322 ;
if ( ! V_3 -> V_271 )
V_22 -> V_323 = F_115 ( V_3 -> V_324 , 0 ) + V_325 ;
else
V_22 -> V_323 = F_115 ( V_3 -> V_324 , 0 ) + V_326 ;
V_36 = F_102 ( V_22 , V_3 ) ;
if ( V_36 )
goto exit;
V_22 -> V_19 . V_327 = ( void * ) V_3 -> V_324 ;
...
static int F_116 ( struct V_2 * V_3 , struct V_315 * V_160 )
{
struct V_21 * V_22 ;
struct V_11 * V_12 ;
enum V_35 V_36 ;
struct V_1 * V_4 ;
V_4 = F_96 ( sizeof( * V_4 ) , V_106 ) ;
if ( ! V_4 )
return - V_330 ;
V_22 = & V_4 -> V_316 ;
V_22 -> V_4 = V_4 ;
V_12 = & V_22 -> V_25 ;
F_117 ( V_22 ) ;
V_12 -> V_331 = ( void * ) V_22 ;
V_22 -> V_3 = & V_4 -> V_3 ;
V_22 -> V_160 = V_160 ;
F_118 ( & V_22 -> V_332 ) ;
F_6 ( V_4 ) ;
do {
V_36 = F_114 ( V_4 , V_3 , V_160 ) ;
if ( V_36 )
break;
V_22 -> V_197 = V_312 ;
if ( V_12 -> V_18 )
...
if ( V_36 )
break;
V_12 -> V_64 -> V_333 ( V_12 -> V_63 ) ;
V_36 = F_120 ( & V_22 -> V_25 , V_22 -> V_260 ) ;
if ( V_36 )
break;
V_22 -> V_334 = F_121 ( L_33 ) ;
F_98 () ;
V_22 -> V_197 = V_304 ;
V_36 = F_91 ( V_22 ) ;
if ( V_36 )
...
V_22 = & V_4 -> V_316 ;
if ( V_277 -> V_320 )
V_22 -> V_188 = V_277 -> V_320 - V_322 ;
}
static void F_124 ( struct V_2 * V_3 , struct V_315 * V_160 , bool V_47 )
{
struct V_21 * V_22 ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_3 ) ;
...
static void F_126 ( struct V_2 * V_3 , struct V_315 * V_160 , T_1 V_337 )
{
struct V_1 * V_4 ;
struct V_11 * V_12 ;
struct V_338 V_339 ;
...
if ( ! V_12 -> V_345 [ V_60 ] || ( V_12 -> V_345 [ V_60 ] -> V_337 != V_337 ) )
continue;
V_343 = V_12 -> V_345 [ V_60 ] ;
F_2 ( & V_12 -> V_346 . V_347 , V_5 ) ;
V_12 -> V_345 [ V_60 ] = NULL ;
F_4 ( & V_12 -> V_346 . V_347 , V_5 ) ;
F_32 ( V_12 , & V_343 -> V_70 , false , false ) ;
memset ( & V_339 , 0 , sizeof( V_339 ) ) ;
V_339 . V_337 = V_337 ;
V_339 . V_348 = V_343 -> V_348 ;
V_339 . V_349 = true ;
F_127 ( V_12 , & V_339 ) ;
V_341 . V_92 = V_343 ;
V_341 . V_90 = sizeof( struct V_342 ) +
sizeof( struct V_258 ) * V_259 ;
F_128 ( V_12 -> V_19 , & V_341 ) ;
break;
}
}
...
return;
if ( V_350 > V_344 )
V_4 -> V_316 . V_351 = V_344 ;
else
V_4 -> V_316 . V_351 = V_350 ;
}
...
return 0 ;
V_12 = & V_4 -> V_316 . V_25 ;
for ( V_60 = 0 ; V_60 < V_4 -> V_316 . V_351 ; V_60 ++ ) {
if ( ! V_12 -> V_345 [ V_60 ] || ( V_12 -> V_345 [ V_60 ] -> V_337 == V_337 ) )
return 1 ;
}
return 0 ;
...
V_12 = & V_4 -> V_316 . V_25 ;
V_22 = V_12 -> V_331 ;
F_86 ( V_12 , V_357 , L_37 , V_352 , V_353 ) ;
if ( V_12 -> V_358 . V_359 ) {
V_354 = V_12 -> V_358 . V_359 ( V_12 , V_337 , V_352 , V_353 ) ;
if ( ! V_12 -> V_18 ) {
F_132 ( & V_22 -> V_360 ) ;
F_133 ( & V_22 -> V_329 ) ;
}
...
struct V_21 * V_22 ;
struct V_2 * V_3 ;
enum V_35 V_354 = V_165 ;
if ( ! V_12 || ! V_12 -> V_331 )
return V_354 ;
V_22 = V_12 -> V_331 ;
V_3 = V_22 -> V_3 ;
if ( V_3 && V_3 -> V_158 && V_3 -> V_158 -> V_361 )
V_354 = V_3 -> V_158 -> V_361 ( V_3 , & V_163 , V_337 , V_352 , V_353 ) ;
return V_354 ;
}
...
V_163 . V_362 . V_363 = V_364 ;
V_163 . V_362 . V_365 = V_366 ;
V_163 . V_362 . V_367 = V_368 ;
V_163 . V_158 = & V_369 ;
memcpy ( V_163 . V_370 , V_371 , V_372 ) ;
V_163 . type = V_373 ;
F_41 ( & V_6 ) ;
V_169 = F_135 ( & V_163 ) ;
return V_169 ;
