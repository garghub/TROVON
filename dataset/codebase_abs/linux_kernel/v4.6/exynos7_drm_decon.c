...
F_71 ( & V_4 -> V_2 -> V_31 ) ;
for ( V_9 = 0 ; V_9 < V_11 ; V_9 ++ ) {
struct V_112 * V_113 = & V_4 -> V_136 [ V_9 ] ;
if ( ! V_113 -> V_144 )
continue;
F_72 ( V_4 -> V_2 , V_113 ) ;
}
...
static int F_74 ( struct V_146 * V_22 , struct V_146 * V_147 , void * V_148 )
{
struct V_3 * V_4 = F_75 ( V_22 ) ;
struct V_15 * V_16 = V_148 ;
struct V_112 * V_149 ;
unsigned int V_111 ;
int V_20 ;
V_20 = F_10 ( V_4 , V_16 ) ;
...
for ( V_111 = 0 ; V_111 < V_11 ; V_111 ++ ) {
V_4 -> V_150 [ V_111 ] . V_151 = V_152 ;
V_4 -> V_150 [ V_111 ] . V_153 = F_77 ( V_152 ) ;
V_4 -> V_150 [ V_111 ] . V_154 = V_111 ;
V_4 -> V_150 [ V_111 ] . type = V_155 [ V_111 ] ;
V_20 = F_78 ( V_16 , & V_4 -> V_136 [ V_111 ] , V_111 ,
1 << V_4 -> V_21 , & V_4 -> V_150 [ V_111 ] ) ;
if ( V_20 )
return V_20 ;
}
V_149 = & V_4 -> V_136 [ V_156 ] ;
V_4 -> V_2 = F_79 ( V_16 , & V_149 -> V_31 ,
V_4 -> V_21 , V_157 ,
& V_158 , V_4 ) ;
if ( F_80 ( V_4 -> V_2 ) ) {
F_12 ( V_4 ) ;
...
static void F_83 ( struct V_146 * V_22 , struct V_146 * V_147 ,
void * V_148 )
{
struct V_3 * V_4 = F_75 ( V_22 ) ;
F_68 ( V_4 -> V_2 ) ;
...
if ( ! V_22 -> V_166 )
return - V_167 ;
V_4 = F_86 ( V_22 , sizeof( * V_4 ) , V_168 ) ;
if ( ! V_4 )
return - V_169 ;
V_4 -> V_22 = V_22 ;
V_4 -> V_5 = true ;
V_163 = F_87 ( V_22 -> V_166 , L_9 ) ;
if ( V_163 )
V_4 -> V_34 = true ;
F_88 ( V_163 ) ;
V_4 -> V_13 = F_89 ( V_22 -> V_166 , 0 ) ;
if ( ! V_4 -> V_13 )
return - V_169 ;
V_4 -> V_170 = F_90 ( V_22 , L_10 ) ;
if ( F_80 ( V_4 -> V_170 ) ) {
F_91 ( V_22 , L_11 ) ;
V_20 = F_81 ( V_4 -> V_170 ) ;
goto V_171;
}
V_4 -> V_172 = F_90 ( V_22 , L_12 ) ;
if ( F_80 ( V_4 -> V_172 ) ) {
F_91 ( V_22 , L_13 ) ;
V_20 = F_81 ( V_4 -> V_172 ) ;
goto V_171;
}
V_4 -> V_173 = F_90 ( V_22 , L_14 ) ;
if ( F_80 ( V_4 -> V_173 ) ) {
F_91 ( V_22 , L_15 ) ;
V_20 = F_81 ( V_4 -> V_173 ) ;
goto V_171;
...
V_20 = F_93 ( V_22 , V_165 -> V_176 , F_70 ,
0 , L_21 , V_4 ) ;
if ( V_20 ) {
F_91 ( V_22 , L_20 ) ;
goto V_171;
...
{
struct V_3 * V_4 = F_75 ( & V_161 -> V_22 ) ;
F_99 ( & V_161 -> V_22 ) ;
F_100 ( V_4 -> V_13 ) ;
F_102 ( & V_161 -> V_22 , & V_177 ) ;
return 0 ;
}
static int F_103 ( struct V_146 * V_22 )
{
struct V_3 * V_4 = F_75 ( V_22 ) ;
F_104 ( V_4 -> V_30 ) ;
F_104 ( V_4 -> V_173 ) ;
...
static int F_105 ( struct V_146 * V_22 )
{
struct V_3 * V_4 = F_75 ( V_22 ) ;
int V_20 ;
V_20 = F_106 ( V_4 -> V_170 ) ;
if ( V_20 < 0 ) {
F_76 ( L_22 , V_20 ) ;
return V_20 ;
}
