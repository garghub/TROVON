...
V_8 -> V_9 = F_9 ( sizeof( bool ) * V_7 ,
V_25 ) ;
if ( ! V_8 -> V_9 )
return - V_26 ;
V_8 -> V_12 = F_9 ( sizeof( T_1 ) * V_7 ,
V_25 ) ;
if ( ! V_8 -> V_12 ) {
F_10 ( V_8 -> V_9 ) ;
return - V_26 ;
...
bool V_29 )
{
T_1 V_30 = F_16 ( V_37 -> V_30 ) ;
T_1 V_17 = F_17 ( V_30 , V_38 ) << 2 ;
T_1 V_39 = F_16 ( V_37 -> args . V_40 ) ;
...
V_39 ) ;
V_30 = F_16 ( V_46 -> V_50 . V_30 ) ;
switch ( F_17 ( V_30 , V_51 ) ) {
case V_52 :
V_41 = V_39 + 1 ;
V_43 = F_17 ( V_30 ,
V_53 ) ;
...
case V_70 :
if ( V_18 ||
( V_29 && ( F_16 ( V_66 -> V_71 ) >= 64 ) ) )
V_22 = F_13 ( V_5 , V_16 , V_17 , 0 ,
F_16 ( V_66 -> V_71 ) ) ;
else
F_14 ( V_5 , V_16 , V_17 , 0 ,
F_16 ( V_66 -> V_71 ) ) ;
break;
case V_72 :
V_22 = F_15 ( V_5 , V_16 , V_37 ,
V_18 , V_29 ) ;
break;
case V_73 :
F_5 ( V_5 , V_16 , V_17 ,
...
static inline bool F_22 ( T_1 V_11 , T_1 V_75 )
{
return V_11 == V_75 ;
}
...
struct V_76 * V_37 )
{
bool (* F_26)( T_1 V_11 , T_1 V_75 );
T_1 V_77 = V_78 , V_11 ;
T_1 V_30 , V_17 , V_79 ;
int V_6 ;
V_30 = F_16 ( V_37 -> V_80 ) ;
V_17 = F_17 ( V_30 , V_81 ) << 2 ;
V_79 = F_17 ( V_30 , V_82 ) ;
V_11 = F_27 ( V_5 , V_16 , V_17 ) ;
if ( V_79 == V_83 )
return;
switch ( V_79 ) {
case V_84 :
...
static V_56 F_31 ( struct V_4 * V_5 ,
T_3 * V_41 ,
int V_90 )
{
struct V_1 * V_2 = V_5 -> V_2 ;
...
switch ( V_94 ) {
case V_95 :
return F_31 ( V_5 , V_41 , V_90 ) ^ 1 ;
case V_96 :
V_92 = F_31 ( V_5 , V_41 , V_90 ) ;
V_93 = F_31 ( V_5 , V_41 , V_90 ) ;
return V_92 | V_93 ;
case V_97 :
V_92 = F_31 ( V_5 , V_41 , V_90 ) ;
V_93 = F_31 ( V_5 , V_41 , V_90 ) ;
...
int V_90 )
{
T_3 V_41 = F_21 ( V_89 -> V_100 ) ;
if ( F_31 ( V_5 , & V_41 , V_90 ) )
return 0 ;
else
return F_17 ( F_16 ( V_89 -> V_80 ) ,
V_101 ) ;
}
...
T_1 V_104 )
{
T_1 V_30 = F_16 ( V_89 -> V_105 ) ;
T_1 V_80 = F_16 ( V_89 -> V_80 ) ;
if ( ! ( F_17 ( V_30 , V_106 ) == V_103 &&
( F_17 ( V_30 , V_107 ) == V_108 ||
F_17 ( V_30 , V_107 ) == V_104 ) ) )
return F_17 ( V_80 , V_109 ) ;
else
return 0 ;
}
...
T_1 V_30 = F_16 ( V_37 -> V_50 . V_80 ) ;
switch ( F_17 ( V_30 , V_117 ) ) {
case V_118 :
V_22 = F_20 ( V_5 , V_16 , & V_37 -> V_119 ,
V_114 ) ;
break;
case V_120 :
F_25 ( V_5 , V_16 , & V_37 -> V_121 ) ;
break;
case V_122 :
V_110 += F_32 ( V_5 , & V_37 -> V_123 ,
V_90 ) ;
break;
case V_124 :
V_110 += F_33 ( V_5 , & V_37 -> V_125 ,
V_103 , V_104 ) ;
V_114 = F_17 ( V_30 , V_126 ) ;
break;
case V_127 :
F_29 ( F_16 ( V_37 -> V_77 . V_77 ) ) ;
break;
case V_128 :
F_30 ( V_5 , V_16 , & V_37 -> V_129 ) ;
break;
}
if ( V_22 )
break;
...
T_1 V_6 ;
V_130 = V_131 + V_132 ;
for ( V_6 = 0 ; V_6 < F_36 ( V_133 ) ; V_6 ++ )
if ( V_133 [ V_6 ] )
F_37 ( V_5 , V_130 + V_6 * V_134 ,
V_133 [ V_6 ] ) ;
}
