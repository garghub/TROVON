...
F_30 ( V_62 -> V_82 ) ;
F_30 ( V_62 -> V_88 ) ;
V_62 -> V_82 = F_27 ( V_109 * sizeof( int ) , V_79 ) ;
V_62 -> V_88 = F_27 ( V_109 * sizeof( int ) , V_79 ) ;
...
if ( V_62 -> V_88 [ V_8 + V_11 ] != V_115 ) {
if ( V_120 >= 1000 )
V_62 -> V_88 [ V_8 + V_11 ] = V_121 ;
else
V_120 ++ ;
}
}
...
static int F_46 ( struct V_128 * V_83 , struct V_20 * V_21 )
{
int V_129 ;
F_16 ( V_21 , L_65 , ( V_130 ) V_83 -> V_131 -> V_132 ) ;
switch ( V_83 -> V_131 -> V_132 ) {
case 0 :
V_129 = F_47 ( V_83 , V_21 ) ;
break;
case 1 :
V_83 -> V_131 -> V_132 = 0 ;
V_129 = F_48 ( V_83 , V_21 ) ;
V_83 -> V_131 -> V_132 = 1 ;
break;
default:
F_16 ( V_21 , L_66 , ( V_130 ) V_83 -> V_131 -> V_132 ) ;
V_129 = V_133 ;
break;
}
return V_129 ;
}
static int F_48 ( struct V_128 * V_83 , struct V_20 * V_21 )
{
...
V_136 = 1 ;
if ( V_83 -> V_139 [ 0 ] == V_142 ) {
memcpy ( V_89 , V_137 , 8 ) ;
F_50 ( V_21 , V_89 , 36 ) ;
return V_141 ;
}
if ( V_83 -> V_139 [ 0 ] == V_143 ) {
struct V_6 * V_106 ;
F_36 ( V_21 , V_62 ) ;
...
( ( V_146 * ) V_89 ) [ 0 ] = F_51 ( V_76 ) ;
( ( V_146 * ) V_89 ) [ 1 ] = F_51 ( V_62 -> V_78 ) ;
F_49 ( V_89 , 8 , V_83 ) ;
return V_141 ;
}
if ( V_83 -> V_139 [ 0 ] == V_147 ) {
int V_148 = ( V_83 -> V_139 [ 2 ] & 0x3F ) ;
if ( V_148 == 0x01 || V_148 == 0x3F ) {
F_16 ( V_21 , L_67 ,
V_148 ) ;
memcpy ( V_89 , V_138 , sizeof( V_138 ) ) ;
( ( V_149 * ) V_89 ) [ 0 ] = F_52 ( sizeof( V_138 ) - 2 ) ;
V_89 [ 3 ] = ( V_62 -> V_104 & V_105 ) ? 0x80 : 0 ;
F_49 ( V_89 , sizeof( V_138 ) , V_83 ) ;
return V_141 ;
}
V_134 = 0x05 ;
V_135 = 0x24 ;
...
if ( V_83 -> V_139 [ 0 ] == V_150 )
return V_141 ;
V_136 = 0 ;
if ( V_83 -> V_139 [ 0 ] == V_151 ) {
V_68 = F_40 ( V_83 -> V_139 [ 3 ] , V_83 -> V_139 [ 2 ] ) ;
V_68 <<= 16 ;
V_68 |= F_40 ( V_83 -> V_139 [ 5 ] , V_83 -> V_139 [ 4 ] ) ;
V_69 = F_40 ( V_83 -> V_139 [ 8 ] , V_83 -> V_139 [ 7 ] ) ;
F_16 ( V_21 , L_68 ,
V_68 , V_69 ) ;
...
for (; V_83 -> V_154 < 12 ; V_83 -> V_154 ++ )
V_83 -> V_139 [ V_83 -> V_154 ] = 0 ;
V_83 -> V_139 [ 1 ] = V_43 ;
V_89 [ 0 ] = 0 ;
for ( V_8 = 0 ; V_8 < 12 ; V_8 ++ )
sprintf ( V_89 + strlen ( V_89 ) , L_70 , V_83 -> V_139 [ V_8 ] ) ;
F_16 ( V_21 , L_71 , V_89 ) ;
V_42 = F_10 ( V_21 , V_83 -> V_139 , 12 ) ;
if ( V_42 ) {
F_16 ( V_21 , L_72 ,
V_42 ) ;
return V_133 ;
...
if ( V_83 -> V_155 == V_156 ||
V_83 -> V_155 == V_157 ) {
unsigned int V_26 = ( V_83 -> V_155 == V_156 )
? V_21 -> V_57 : V_21 -> V_44 ;
F_16 ( V_21 , L_73 ,
( V_83 -> V_155 == V_156 ) ?
L_74 : L_75 ,
