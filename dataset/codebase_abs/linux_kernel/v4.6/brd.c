...
static int F_43 ( struct V_39 * V_40 , T_8 V_64 ,
...
static int T_9 F_47 ( char * V_73 )
{
V_74 = F_48 ( V_73 , NULL , 0 ) ;
return 1 ;
}
...
F_58 ( V_3 -> V_80 , V_85 ) ;
V_3 -> V_80 -> V_83 . V_86 = 1 ;
F_59 ( V_87 , V_3 -> V_80 ) ;
V_76 = V_3 -> V_88 = F_60 ( V_89 ) ;
if ( ! V_76 )
goto V_90;
V_76 -> V_91 = V_92 ;
V_76 -> V_93 = V_18 * V_89 ;
...
static struct V_2 * F_66 ( int V_18 , bool * V_100 )
{
struct V_2 * V_3 ;
* V_100 = false ;
...
static struct V_103 * F_73 ( T_10 V_104 , int * V_105 , void * V_106 )
{
struct V_2 * V_3 ;
struct V_103 * V_107 ;
bool V_100 ;
F_44 ( & V_108 ) ;
V_3 = F_66 ( F_74 ( V_104 ) / V_89 , & V_100 ) ;
V_107 = V_3 ? F_75 ( V_3 -> V_88 ) : NULL ;
F_46 ( & V_108 ) ;
if ( V_100 )
* V_105 = 0 ;
return V_107 ;
...
F_67 (brd, &brd_devices, brd_list)
F_68 ( V_3 -> V_88 ) ;
F_78 ( F_79 ( V_92 , 0 ) , 1UL << V_113 ,
V_114 , F_73 , NULL , NULL ) ;
F_80 ( L_3 ) ;
return 0 ;
V_112:
