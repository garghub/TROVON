...
static T_3
F_37 ( struct V_45 * V_46 , struct V_12 * V_47 , T_2 V_48 )
{
struct V_20 * V_20 = V_46 -> V_49 ;
T_3 V_50 ;
int V_15 = 0 ;
if ( F_38 ( V_47 ) == V_40 ) {
V_50 = F_28 ( V_20 -> V_22 , V_48 , V_47 , & V_15 ) ;
if ( V_50 ) {
struct V_4 * V_4 = F_39 ( V_20 ) ;
T_2 V_51 = F_26 ( V_4 ) ;
if ( V_48 + V_50 > V_51 )
F_40 ( V_4 , V_48 + V_50 - V_51 ) ;
}
} else {
V_50 = F_7 ( V_20 -> V_22 , V_48 , V_47 , & V_15 ) ;
}
return V_50 ? V_50 : V_15 ;
}
static int F_41 ( struct V_20 * V_21 , struct V_23 * V_5 ,
T_2 V_48 , unsigned V_35 , unsigned V_52 ,
struct V_3 * * V_53 , void * * V_54 )
{
int V_14 = 0 ;
struct V_3 * V_3 ;
struct V_31 * V_32 ;
...
T_2 V_48 , unsigned V_35 , unsigned V_58 ,
struct V_3 * V_3 , void * V_54 )
{
T_2 V_59 = V_48 + V_58 ;
struct V_4 * V_4 = V_3 -> V_5 -> V_6 ;
F_2 ( V_16 , L_5 , V_21 , V_5 ) ;
if ( F_46 ( V_58 < V_35 ) ) {
unsigned V_34 = V_48 & ( V_11 - 1 ) ;
F_10 ( V_3 , V_34 + V_58 , V_35 - V_58 ) ;
F_11 ( V_3 ) ;
}
if ( ! F_43 ( V_3 ) )
F_12 ( V_3 ) ;
if ( V_59 > V_4 -> V_51 ) {
F_40 ( V_4 , V_59 - V_4 -> V_51 ) ;
F_47 ( V_4 , V_59 ) ;
}
F_48 ( V_3 ) ;
F_14 ( V_3 ) ;
