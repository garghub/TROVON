...
static unsigned int F_16 ( T_1 V_28 , unsigned int * V_37 ,
unsigned int V_30 )
{
...
static void F_17 ( unsigned int * V_28 , unsigned int V_30 )
{
unsigned int V_37 ;
unsigned int V_38 ;
V_38 = F_16 ( * V_28 , & V_37 , V_30 ) ;
* V_28 = V_37 * V_41 [ V_38 ] ;
}
...
unsigned int V_38 ;
unsigned int V_37 ;
F_19 ( V_2 -> V_45 , V_43 , V_44 ) ;
V_38 = F_16 ( V_28 , & V_37 , V_30 ) ;
F_20 ( F_21 ( V_43 , V_38 ) , V_2 -> V_46 + V_47 ) ;
if ( V_37 >= 65536 )
V_37 = 0 ;
F_22 ( V_2 -> V_45 , V_43 , V_37 ) ;
}
static void F_23 ( struct V_1 * V_2 , unsigned int V_43 )
{
F_19 ( V_2 -> V_45 , V_43 , V_48 ) ;
}
...
V_62 = V_71 | V_72 ;
F_19 ( V_2 -> V_45 , 2 , V_73 ) ;
V_7 -> V_12 = F_30 ( V_50 , V_59 ) ;
if ( V_60 == V_66 ) {
V_61 = V_17 * 2 ;
if ( V_7 -> V_74 == 0 ) {
V_63 = 3 << V_61 ;
...
F_19 ( V_2 -> V_45 , 2 , V_73 ) ;
F_19 ( V_2 -> V_45 , 2 , V_48 ) ;
V_64 = F_31 ( V_2 , V_50 , V_52 , F_24 , 0 ) ;
if ( V_64 )
return V_64 ;
V_9 [ V_58 ] = F_1 ( V_2 ) ;
}
...
{
struct V_6 * V_7 = V_2 -> V_8 ;
unsigned int V_17 = F_26 ( V_52 -> V_65 ) ;
unsigned int V_59 = F_27 ( V_52 -> V_65 ) ;
unsigned int V_84 = V_50 -> V_85 [ V_17 ] ;
int V_86 ;
V_7 -> V_16 = F_30 ( V_50 , V_59 ) ;
...
struct V_88 * V_89 )
{
unsigned int V_90 = F_26 ( V_89 -> V_91 [ 0 ] ) ;
unsigned int V_92 = F_27 ( V_89 -> V_91 [ 0 ] ) ;
int V_86 ;
for ( V_86 = 1 ; V_86 < V_89 -> V_93 ; V_86 ++ ) {
unsigned int V_17 = F_26 ( V_89 -> V_91 [ V_86 ] ) ;
unsigned int V_59 = F_27 ( V_89 -> V_91 [ V_86 ] ) ;
if ( V_17 < V_90 ) {
F_29 ( V_2 -> V_68 ,
L_2 ,
V_69 ) ;
...
int V_94 = 0 ;
unsigned int V_95 ;
V_94 |= F_35 ( & V_89 -> V_96 , V_97 ) ;
V_95 = V_98 | V_97 ;
if ( V_4 -> V_99 > 0 && V_7 -> V_74 >= 2 ) {
V_95 |= V_100 ;
}
V_94 |= F_35 ( & V_89 -> V_101 , V_95 ) ;
V_94 |= F_35 ( & V_89 -> V_102 , V_103 ) ;
V_94 |= F_35 ( & V_89 -> V_104 , V_105 ) ;
V_94 |= F_35 ( & V_89 -> V_106 , V_105 | V_107 ) ;
if ( V_94 )
return 1 ;
V_94 |= F_36 ( V_89 -> V_101 ) ;
V_94 |= F_36 ( V_89 -> V_106 ) ;
if ( V_94 )
return 2 ;
V_94 |= F_37 ( & V_89 -> V_108 , 0 ) ;
#define F_38 8000
#define F_39 4294967295u
switch ( V_89 -> V_101 ) {
case V_98 :
V_94 |= F_40 ( & V_89 -> V_109 ,
F_38 ) ;
V_94 |= F_41 ( & V_89 -> V_109 ,
F_39 ) ;
break;
case V_100 :
if ( V_89 -> V_109 & ~ V_110 ) {
V_89 -> V_109 = F_42 ( V_89 -> V_109 , 0 ,
~ V_110 ) ;
V_94 |= - V_70 ;
}
if ( V_89 -> V_109 & V_110 &
...
break;
default:
V_94 |= F_37 ( & V_89 -> V_109 , 0 ) ;
break;
}
V_94 |= F_37 ( & V_89 -> V_113 ,
V_89 -> V_93 ) ;
if ( V_89 -> V_106 == V_105 )
V_94 |= F_40 ( & V_89 -> V_114 , 1 ) ;
else
V_94 |= F_37 ( & V_89 -> V_114 , 0 ) ;
if ( V_94 )
return 3 ;
if ( V_89 -> V_101 == V_98 ) {
V_95 = V_89 -> V_109 ;
F_17 ( & V_89 -> V_109 , V_89 -> V_30 ) ;
if ( V_95 != V_89 -> V_109 )
V_94 ++ ;
}
if ( V_94 )
...
struct V_133 * V_119 = V_50 -> V_119 ;
struct V_88 * V_89 = & V_119 -> V_89 ;
unsigned int V_138 = F_47 ( V_50 , 0 ) ;
unsigned int V_139 ;
...
F_20 ( F_53 ( 1 , V_163 ) , V_2 -> V_46 + V_164 ) ;
break;
case V_97 :
V_119 -> V_165 = F_49 ;
break;
...
static int F_55 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
...
V_131 ) ;
if ( V_89 -> V_101 == V_98 ) {
F_20 ( F_53 ( 1 , V_173 ) , V_2 -> V_46 + V_164 ) ;
F_18 ( V_2 , 1 , V_174 ,
V_89 -> V_109 ,
V_89 -> V_30 ) ;
}
V_50 -> V_119 -> V_165 = F_54 ;
return 0 ;
}
...
unsigned int V_17 = F_26 ( V_65 ) ;
unsigned int V_59 = F_27 ( V_65 ) ;
unsigned int V_60 = F_28 ( V_65 ) ;
bool V_182 = F_30 ( V_50 , V_59 ) ;
...
int V_94 = 0 ;
unsigned int V_95 ;
V_94 |= F_35 ( & V_89 -> V_96 , V_103 | V_97 ) ;
V_95 = V_183 | V_98 | V_97 ;
if ( V_4 -> V_184 || V_4 -> V_99 > 0 ) {
V_95 |= V_100 ;
}
V_94 |= F_35 ( & V_89 -> V_101 , V_95 ) ;
V_94 |= F_35 ( & V_89 -> V_102 ,
V_98 | V_97 | V_100 ) ;
V_94 |= F_35 ( & V_89 -> V_104 , V_105 ) ;
V_94 |= F_35 ( & V_89 -> V_106 , V_105 | V_107 ) ;
if ( V_94 )
...
V_94 |= F_40 ( & V_89 -> V_176 ,
V_185 ) ;
V_94 |= F_41 ( & V_89 -> V_176 ,
F_64 ) ;
} else if ( V_89 -> V_102 == V_100 ) {
if ( V_89 -> V_176 & V_110 ) {
if ( V_89 -> V_176 & ~ V_110 ) {
V_89 -> V_176 = F_42 ( V_89 -> V_176 , 0 ,
~ V_110 ) ;
V_94 |= - V_70 ;
}
...
static int F_74 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
...
for ( V_86 = 0 ; V_86 < V_89 -> V_93 ; V_86 ++ ) {
unsigned int V_61 ;
V_17 = F_26 ( V_89 -> V_91 [ V_86 ] ) ;
V_59 = F_27 ( V_89 -> V_91 [ V_86 ] ) ;
if ( V_219 ) {
V_61 = 2 * V_17 ;
if ( V_7 -> V_74 == 0 ) {
V_63 |= 3 << V_61 ;
...
static T_2 F_77 ( int V_222 , void * V_223 )
{
...
unsigned long V_24 ;
V_224 = F_78 ( V_2 -> V_46 + V_231 ) ;
if ( V_224 == V_232 )
return V_233 ;
F_8 ( & V_7 -> V_122 , V_24 ) ;
V_225 = V_7 -> V_123 & V_224 ;
V_226 = V_7 -> V_123 & ~ V_224 ;
F_20 ( V_226 , V_2 -> V_46 + V_127 ) ;
V_7 -> V_124 = true ;
V_7 -> V_125 = V_126 ;
F_9 ( & V_7 -> V_122 , V_24 ) ;
if ( V_225 & V_120 )
...
static bool F_79 ( const struct V_3 * V_4 ,
struct V_235 * V_235 )
{
if ( V_4 -> V_236 != V_235 -> V_237 )
return false ;
if ( V_4 -> V_99 == 0 )
return true ;
if ( F_80 ( V_235 , 3 ) < 32 )
...
static const struct V_3 * F_81 ( struct V_235 * V_235 )
{
unsigned int V_86 ;
for ( V_86 = 0 ; V_86 < F_82 ( V_238 ) ; V_86 ++ )
if ( F_79 ( & V_238 [ V_86 ] , V_235 ) )
return & V_238 [ V_86 ] ;
return NULL ;
}
...
if ( V_240 )
return V_240 ;
V_2 -> V_46 = F_89 ( V_235 , 2 ) ;
V_7 -> V_10 = F_89 ( V_235 , 3 ) ;
F_29 ( V_2 -> V_68 ,
L_15 ,
V_2 -> V_242 , V_2 -> V_46 , V_7 -> V_10 ) ;
V_7 -> V_128 = F_2 ( V_7 -> V_10 + V_87 ) &
V_129 ;
if ( F_80 ( V_235 , 3 ) >= 32 ) {
unsigned short V_244 = 0 ;
V_7 -> V_74 = F_2 ( V_7 -> V_10 + V_245 ) ;
...
V_7 -> V_10 + V_55 ) ;
if ( V_235 -> V_222 ) {
V_240 = F_90 ( V_235 -> V_222 , F_77 , V_250 ,
V_2 -> V_242 , V_2 ) ;
if ( V_240 == 0 )
V_2 -> V_222 = V_235 -> V_222 ;
}
V_2 -> V_45 = F_91 ( V_2 -> V_46 + V_251 ,
0 , V_252 , 0 ) ;
if ( ! V_2 -> V_45 )
return - V_241 ;
V_240 = F_92 ( V_2 , 3 ) ;
...
V_50 = & V_2 -> V_253 [ 0 ] ;
V_50 -> type = V_254 ;
V_50 -> V_255 = V_256 | V_257 | V_258 ;
V_50 -> V_67 = 16 ;
V_50 -> V_259 = ( 1 << V_4 -> V_13 ) - 1 ;
V_50 -> V_260 = & V_261 ;
V_50 -> V_262 = F_25 ;
V_50 -> V_263 = 256 ;
if ( V_2 -> V_222 ) {
...
if ( V_4 -> V_15 ) {
V_50 -> type = V_268 ;
V_50 -> V_255 = V_269 | V_258 ;
V_50 -> V_67 = 2 ;
V_50 -> V_259 = ( 1 << V_4 -> V_15 ) - 1 ;
V_50 -> V_260 = & V_270 ;
V_50 -> V_271 = F_32 ;
V_50 -> V_263 = 2 ;
if ( V_2 -> V_222 ) {
...
V_50 = & V_2 -> V_253 [ 2 ] ;
if ( V_4 -> V_184 ) {
V_240 = F_94 ( V_2 , V_50 , NULL , V_274 ) ;
if ( V_240 )
return V_240 ;
} else {
V_50 -> type = V_273 ;
...
static int F_95 ( struct V_235 * V_2 ,
const struct V_275 * V_236 )
{
return F_96 ( V_2 , & V_276 ,
V_236 -> V_277 ) ;
}
