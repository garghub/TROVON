...
static void F_21 ( struct V_9 * V_10 , struct V_17 * V_18 )
{
F_22 ( & V_18 -> V_27 ) ;
if ( F_16 ( V_18 ) )
F_23 ( V_18 -> V_24 ) ;
...
{
struct V_17 * V_18 = F_27 ( V_34 , struct V_17 , V_34 ) ;
F_21 ( V_18 -> V_10 , V_18 ) ;
}
static int F_28 ( struct V_9 * V_10 , unsigned long V_35 )
{
...
static bool F_32 ( struct V_9 * V_10 , bool V_37 )
{
struct V_13 * V_14 = F_33 ( V_10 -> V_15 ) ;
struct V_17 * V_18 , * V_38 ;
if ( ! V_37 && ! F_34 ( & V_14 -> V_31 ) )
return false ;
...
static unsigned long F_38 ( struct V_9 * V_10 , T_1 V_39 )
{
struct V_13 * V_14 = F_33 ( V_10 -> V_15 ) ;
struct V_17 * V_18 ;
...
static int F_40 ( struct V_40 * * V_41 , struct V_17 * V_18 )
{
struct V_42 * V_28 ;
struct V_43 V_44 ;
struct V_45 * V_46 ;
...
if ( V_47 != F_42 ( V_41 [ V_52 ] ) )
return - V_51 ;
V_28 = F_18 ( V_47 , V_29 ) ;
if ( V_28 == NULL )
return - V_53 ;
memcpy ( V_28 , F_43 ( V_41 [ V_52 ] ) , V_47 ) ;
V_44 . V_54 = V_48 ;
V_44 . V_24 = V_28 ;
V_19 = F_44 ( & V_46 , & V_44 ) ;
if ( V_19 < 0 ) {
...
static int F_45 ( struct V_40 * * V_41 , struct V_17 * V_18 ,
...
return - V_51 ;
F_54 ( & V_27 , V_72 , V_73 ) ;
V_19 = F_55 ( V_64 , V_10 , V_41 , V_66 , & V_27 , V_67 ) ;
if ( V_19 < 0 )
return V_19 ;
if ( V_41 [ V_74 ] ) {
T_1 V_75 = F_46 ( V_41 [ V_74 ] ) ;
if ( V_75 & ~ V_76 ) {
F_22 ( & V_27 ) ;
return - V_51 ;
}
...
if ( V_41 [ V_77 ] ) {
V_18 -> V_12 . V_22 = F_46 ( V_41 [ V_77 ] ) ;
F_56 ( V_10 , & V_18 -> V_12 , V_65 ) ;
}
F_57 ( V_10 , & V_18 -> V_27 , & V_27 ) ;
return 0 ;
}
...
if ( V_81 [ V_84 ] == NULL )
return - V_51 ;
V_19 = F_61 ( V_41 , V_83 , V_81 [ V_84 ] , V_85 ) ;
if ( V_19 < 0 )
return V_19 ;
V_18 = F_18 ( sizeof( * V_18 ) , V_29 ) ;
if ( ! V_18 )
return - V_30 ;
F_54 ( & V_18 -> V_27 , V_72 , V_73 ) ;
if ( V_82 ) {
...
V_19 = F_53 ( V_64 , V_10 , V_18 , V_65 , V_41 , V_81 [ V_87 ] , V_67 ) ;
if ( V_19 < 0 )
goto V_86;
if ( V_82 ) {
F_62 ( & V_82 -> V_36 , & V_18 -> V_36 ) ;
F_30 ( V_10 , & V_82 -> V_12 ) ;
F_31 ( & V_82 -> V_34 , F_26 ) ;
} else {
F_63 ( & V_18 -> V_36 , & V_14 -> V_31 ) ;
}
...
static int F_64 ( const struct V_17 * V_18 ,
struct V_7 * V_8 )
{
struct V_40 * V_88 ;
if ( F_65 ( V_8 , V_49 , V_18 -> V_48 ) )
return - V_89 ;
V_88 = F_66 ( V_8 , V_52 , V_18 -> V_48 *
sizeof( struct V_42 ) ) ;
if ( V_88 == NULL )
return - V_89 ;
memcpy ( F_43 ( V_88 ) , V_18 -> V_28 , F_42 ( V_88 ) ) ;
return 0 ;
}
static int F_67 ( const struct V_17 * V_18 ,
struct V_7 * V_8 )
{
if ( F_68 ( V_8 , V_57 , V_18 -> V_56 ) )
return - V_89 ;
if ( V_18 -> V_32 &&
F_69 ( V_8 , V_59 , V_18 -> V_32 ) )
return - V_89 ;
return 0 ;
}
...
static void F_76 ( struct V_9 * V_10 , struct V_96 * V_35 )
{
struct V_13 * V_14 = F_33 ( V_10 -> V_15 ) ;
struct V_17 * V_18 ;
F_39 (prog, &head->plist, link) {
