...
static struct V_5 *
F_15 ( struct V_45 * V_46 , void * V_40 )
{
struct V_4 * V_31 ;
...
static int F_17 ( struct V_27 * V_28 , struct V_50 * V_51 ,
...
V_19 = F_18 ( V_51 , L_1 ) ;
if ( V_19 < 0 ) {
F_19 ( V_28 , L_2 , V_51 -> V_32 ) ;
return - V_23 ;
}
V_48 = F_20 ( V_28 , sizeof( * V_48 ) , V_53 ) ;
if ( ! V_48 )
return - V_54 ;
V_48 -> V_49 = V_19 ;
V_48 -> V_5 = F_21 ( V_28 , V_19 , sizeof( * V_48 -> V_5 ) ,
V_53 ) ;
if ( ! V_48 -> V_5 )
return - V_54 ;
V_52 = F_21 ( V_28 , V_19 , sizeof( * V_52 ) , V_53 ) ;
if ( ! V_52 )
return - V_54 ;
...
const char * V_32 ;
T_1 V_55 ;
V_31 = F_22 ( V_28 , sizeof( * V_31 ) , V_53 ) ;
if ( ! V_31 )
return - V_54 ;
if ( F_23 ( V_51 , L_1 ,
V_11 , & V_32 ) ) {
F_19 ( V_28 , L_3 , V_51 -> V_32 ) ;
return - V_23 ;
}
if ( F_24 ( V_51 , L_4 ,
V_11 , & V_55 ) ) {
F_19 ( V_28 , L_5 , V_51 -> V_32 ) ;
return - V_23 ;
}
V_31 -> V_8 = V_55 ;
V_52 [ V_11 ] = F_10 ( V_28 , V_30 , V_31 , V_32 ) ;
if ( F_25 ( V_52 [ V_11 ] ) )
F_19 ( V_28 , L_6 , V_32 ) ;
else
F_26 ( V_28 , L_7 , V_32 ) ;
