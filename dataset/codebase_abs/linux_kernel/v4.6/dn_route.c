...
static int F_54 ( struct V_93 * V_93 , struct V_34 * V_35 , struct V_36 * V_37 )
{
struct V_76 * V_77 ;
int V_94 ;
if ( ( V_94 = F_55 ( V_37 ) ) == 0 )
...
static int F_68 ( struct V_93 * V_93 , struct V_34 * V_35 , struct V_36 * V_37 )
{
F_69 ( V_37 ) ;
F_70 ( V_37 ) ;
return V_87 ;
}
int F_71 ( struct V_36 * V_37 , struct V_6 * V_7 , struct V_110 * V_111 , struct V_6 * V_112 )
{
struct V_76 * V_77 ;
unsigned char V_113 = 0 ;
T_3 V_99 = F_58 ( * ( T_2 * ) V_37 -> V_79 ) ;
struct V_40 * V_41 = F_72 ( V_7 -> V_42 ) ;
unsigned char V_92 = 0 ;
if ( ! F_73 ( F_5 ( V_7 ) , & V_109 ) )
goto V_114;
if ( V_41 == NULL )
goto V_114;
...
switch ( V_113 & V_121 ) {
case V_127 :
return F_65 ( V_107 , V_128 ,
& V_109 , NULL , V_37 , V_37 -> V_7 , NULL ,
F_68 ) ;
case V_129 :
case V_130 :
return F_65 ( V_107 , V_131 ,
& V_109 , NULL , V_37 , V_37 -> V_7 , NULL ,
F_67 ) ;
case V_132 :
return F_65 ( V_107 , V_128 ,
...
static int F_81 ( struct V_93 * V_93 , struct V_34 * V_35 , struct V_36 * V_37 )
{
...
struct V_76 * V_77 = F_50 ( V_37 ) ;
struct V_1 * V_2 = F_82 ( V_37 ) ;
struct V_40 * V_142 = F_72 ( V_2 -> V_7 -> V_42 ) ;
struct V_3 * V_4 ;
int V_143 ;
...
if ( F_85 ( V_37 , F_86 ( V_4 -> V_2 . V_7 ) + V_143 ) )
goto V_144;
if ( ++ V_77 -> V_106 > 30 )
goto V_144;
...
static int F_87 ( struct V_93 * V_93 , struct V_34 * V_35 , struct V_36 * V_37 )
{
struct V_76 * V_77 = F_50 ( V_37 ) ;
F_83 ( L_5 ,
F_58 ( V_77 -> V_11 ) , F_58 ( V_77 -> V_2 ) ) ;
...
static struct V_9 * F_93 ( const struct V_1 * V_2 ,
struct V_36 * V_37 ,
const void * V_54 )
{
return F_94 ( & V_147 , V_54 , V_2 -> V_7 ) ;
}
static int F_95 ( struct V_3 * V_4 , struct V_148 * V_149 )
{
...
if ( V_151 ) {
if ( F_96 ( * V_149 ) &&
F_97 ( * V_149 ) . V_153 == V_154 )
V_4 -> V_155 = F_96 ( * V_149 ) ;
F_98 ( & V_4 -> V_2 , V_151 -> V_156 , true ) ;
}
V_4 -> V_157 = V_149 -> type ;
if ( V_7 != NULL && V_4 -> V_5 == NULL ) {
V_5 = F_94 ( & V_147 , & V_4 -> V_155 , V_7 ) ;
if ( F_99 ( V_5 ) )
return F_100 ( V_5 ) ;
V_4 -> V_5 = V_5 ;
}
...
V_152 = F_29 ( & V_4 -> V_2 , V_46 ) ;
if ( V_152 ) {
unsigned int V_47 = F_90 ( V_7 , F_91 ( & V_4 -> V_2 ) ) ;
if ( V_152 > V_47 )
F_27 ( & V_4 -> V_2 , V_46 , V_47 ) ;
}
return 0 ;
}
static inline int F_101 ( T_2 V_158 , T_2 V_159 )
{
T_3 V_12 = F_58 ( V_158 ) ^ F_58 ( V_159 ) ;
int V_160 = 16 ;
while( V_12 ) {
V_12 >>= 1 ;
V_160 -- ;
...
static T_2 F_102 ( const struct V_6 * V_7 , T_2 V_54 , int V_161 )
{
T_2 V_55 = 0 ;
struct V_40 * V_142 ;
struct V_162 * V_163 ;
...
F_103 () ;
V_142 = F_72 ( V_7 -> V_42 ) ;
for ( V_163 = F_72 ( V_142 -> V_166 ) ;
V_163 != NULL ;
V_163 = F_72 ( V_163 -> V_167 ) ) {
...
static inline T_2 F_105 ( struct V_148 * V_149 )
{
return F_102 ( F_106 ( * V_149 ) , F_96 ( * V_149 ) , V_149 -> V_161 ) ;
}
static inline T_2 F_107 ( T_2 V_54 , struct V_148 * V_149 )
{
T_2 V_170 = F_108 ( V_149 -> V_171 ) ;
return ( V_54 & ~ V_170 ) | V_149 -> V_151 -> V_172 -> V_173 ;
}
static int F_109 ( struct V_1 * * V_174 , const struct V_51 * V_175 , int V_176 )
{
struct V_51 V_64 = {
. V_54 = V_175 -> V_54 ,
. V_55 = V_175 -> V_55 ,
...
if ( ! V_7 -> V_42 )
continue;
if ( ! F_111 ( V_7 , V_175 -> V_55 ) )
continue;
if ( ( V_7 -> V_113 & V_187 ) &&
V_175 -> V_54 &&
! F_111 ( V_7 , V_175 -> V_54 ) )
continue;
V_179 = V_7 ;
break;
}
...
V_64 . V_58 , V_176 ) ;
V_94 = - V_191 ;
if ( V_176 || ( V_94 = F_113 ( & V_64 , & V_149 ) ) != 0 ) {
struct V_40 * V_142 ;
if ( V_94 != - V_191 )
goto V_115;
if ( ! V_176 ) {
V_180 = F_114 ( & V_147 , & V_109 , & V_64 . V_54 ) ;
if ( V_180 ) {
if ( ( V_175 -> V_58 &&
...
if ( V_179 == NULL )
goto V_115;
V_142 = F_24 ( V_179 -> V_42 ) ;
if ( ! V_142 )
goto V_193;
if ( F_111 ( V_179 , V_64 . V_54 ) ) {
F_7 ( V_179 ) ;
V_179 = V_109 . V_10 ;
F_6 ( V_179 ) ;
V_149 . type = V_189 ;
...
V_180 = F_116 ( V_142 -> V_194 ) ;
F_117 ( V_180 && V_180 -> V_7 != V_179 ) ;
V_192:
if ( V_180 )
...
V_113 |= V_200 ;
V_4 = F_121 ( & V_201 , V_179 , 1 , V_202 , V_203 ) ;
if ( V_4 == NULL )
goto V_204;
...
F_35 ( V_4 , V_60 , (struct V_3 * * ) V_174 ) ;
V_212:
if ( V_180 )
F_2 ( V_180 ) ;
if ( V_182 )
...
static int F_123 ( struct V_1 * * V_174 , const struct V_51 * V_214 , int V_113 )
{
unsigned int V_60 = F_8 ( V_214 -> V_55 , V_214 -> V_54 ) ;
struct V_3 * V_4 = NULL ;
if ( ! ( V_113 & V_215 ) ) {
F_124 () ;
for ( V_4 = F_125 ( V_24 [ V_60 ] . V_25 ) ; V_4 ;
V_4 = F_125 ( V_4 -> V_2 . V_29 ) ) {
...
return F_109 ( V_174 , V_214 , V_113 ) ;
}
static int F_128 ( struct V_1 * * V_174 , struct V_51 * V_214 , int V_113 )
{
int V_94 ;
V_94 = F_123 ( V_174 , V_214 , V_113 ) ;
if ( V_94 == 0 && V_214 -> V_216 ) {
* V_174 = F_129 ( & V_109 , * V_174 ,
F_130 ( V_214 ) , NULL , 0 ) ;
if ( F_99 ( * V_174 ) ) {
V_94 = F_100 ( * V_174 ) ;
* V_174 = NULL ;
...
int F_131 ( struct V_1 T_4 * * V_174 , struct V_51 * V_217 , struct V_34 * V_35 , int V_113 )
{
int V_94 ;
V_94 = F_123 ( V_174 , V_217 , V_113 & V_215 ) ;
...
int V_182 = 0 ;
F_6 ( V_218 ) ;
if ( ( V_142 = F_72 ( V_218 -> V_42 ) ) == NULL )
goto V_115;
if ( V_64 . V_55 == 0 )
goto V_115;
V_94 = - V_223 ;
if ( F_111 ( V_218 , V_77 -> V_11 ) )
goto V_115;
V_94 = F_113 ( & V_64 , & V_149 ) ;
if ( V_94 ) {
if ( V_94 != - V_191 )
goto V_115;
if ( ! F_111 ( V_218 , V_77 -> V_2 ) )
goto V_193;
V_149 . type = V_189 ;
} else {
T_2 V_224 = V_64 . V_55 ;
...
V_183 = F_96 ( V_149 ) ;
if ( V_149 . type == V_198 ) {
V_64 . V_54 = F_107 ( V_64 . V_54 , & V_149 ) ;
F_122 ( & V_149 ) ;
V_182 = 0 ;
if ( F_113 ( & V_64 , & V_149 ) )
goto V_193;
...
V_190:
V_4 = F_121 ( & V_201 , V_219 , 0 , V_202 , V_203 ) ;
if ( V_4 == NULL )
goto V_204;
memset ( & V_4 -> V_64 , 0 , sizeof( V_4 -> V_64 ) ) ;
V_4 -> V_137 = V_64 . V_55 ;
...
static int F_135 ( struct V_36 * V_37 , T_5 V_231 , T_5 V_232 ,
...
struct V_236 * V_237 ;
long V_75 ;
V_237 = F_136 ( V_37 , V_231 , V_232 , V_233 , sizeof( * V_225 ) , V_113 ) ;
if ( ! V_237 )
return - V_238 ;
V_225 = F_137 ( V_237 ) ;
V_225 -> V_239 = V_240 ;
...
if ( V_4 -> V_82 & V_252 )
V_225 -> V_247 |= V_253 ;
if ( F_138 ( V_37 , V_254 , V_245 ) < 0 ||
F_139 ( V_37 , V_255 , V_4 -> V_138 ) < 0 )
goto V_256;
if ( V_4 -> V_64 . V_55 ) {
V_225 -> V_242 = 16 ;
if ( F_139 ( V_37 , V_257 , V_4 -> V_64 . V_55 ) < 0 )
goto V_256;
}
if ( V_4 -> V_2 . V_7 &&
F_138 ( V_37 , V_258 , V_4 -> V_2 . V_7 -> V_118 ) < 0 )
goto V_256;
if ( F_139 ( V_37 , V_259 , V_4 -> V_205 ) < 0 )
goto V_256;
if ( V_4 -> V_138 != V_4 -> V_155 &&
F_139 ( V_37 , V_260 , V_4 -> V_155 ) < 0 )
goto V_256;
if ( F_140 ( V_37 , F_141 ( & V_4 -> V_2 ) ) < 0 )
goto V_256;
V_75 = V_4 -> V_2 . V_75 ? V_4 -> V_2 . V_75 - V_21 : 0 ;
if ( F_142 ( V_37 , & V_4 -> V_2 , 0 , V_75 ,
V_4 -> V_2 . error ) < 0 )
goto V_256;
if ( F_143 ( V_4 ) &&
F_138 ( V_37 , V_261 , V_4 -> V_64 . V_59 ) < 0 )
goto V_256;
F_144 ( V_37 , V_237 ) ;
return 0 ;
V_256:
...
static int F_146 ( struct V_36 * V_262 , struct V_236 * V_237 )
{
struct V_93 * V_93 = F_147 ( V_262 -> V_35 ) ;
struct V_235 * V_263 = F_137 ( V_237 ) ;
struct V_3 * V_4 = NULL ;
struct V_76 * V_77 ;
int V_94 ;
struct V_36 * V_37 ;
...
if ( ! F_73 ( V_93 , & V_109 ) )
return - V_136 ;
V_94 = F_148 ( V_237 , sizeof( * V_263 ) , V_265 , V_266 , V_267 ) ;
if ( V_94 < 0 )
return V_94 ;
...
V_77 = F_50 ( V_37 ) ;
if ( V_265 [ V_257 ] )
V_64 . V_55 = F_151 ( V_265 [ V_257 ] ) ;
if ( V_265 [ V_255 ] )
V_64 . V_54 = F_151 ( V_265 [ V_255 ] ) ;
if ( V_265 [ V_261 ] )
V_64 . V_59 = F_152 ( V_265 [ V_261 ] ) ;
if ( V_64 . V_59 ) {
struct V_6 * V_7 ;
V_7 = F_153 ( & V_109 , V_64 . V_59 ) ;
if ( ! V_7 || ! V_7 -> V_42 ) {
F_59 ( V_37 ) ;
return - V_184 ;
}
V_37 -> V_271 = F_154 ( V_272 ) ;
V_37 -> V_7 = V_7 ;
V_77 -> V_11 = V_64 . V_55 ;
V_77 -> V_2 = V_64 . V_54 ;
F_155 () ;
...
if ( V_265 [ V_258 ] )
V_64 . V_58 = F_152 ( V_265 [ V_258 ] ) ;
V_94 = F_128 ( (struct V_1 * * ) & V_4 , & V_64 , 0 ) ;
}
V_37 -> V_7 = NULL ;
if ( V_94 )
goto V_273;
F_134 ( V_37 , & V_4 -> V_2 ) ;
if ( V_263 -> V_247 & V_253 )
V_4 -> V_82 |= V_252 ;
V_94 = F_135 ( V_37 , F_157 ( V_262 ) . V_231 , V_237 -> V_274 , V_275 , 0 , 0 ) ;
if ( V_94 < 0 ) {
V_94 = - V_238 ;
goto V_273;
}
return F_158 ( V_37 , & V_109 , F_157 ( V_262 ) . V_231 ) ;
V_273:
F_59 ( V_37 ) ;
return V_94 ;
}
int F_159 ( struct V_36 * V_37 , struct V_276 * V_77 )
{
struct V_93 * V_93 = F_147 ( V_37 -> V_35 ) ;
struct V_3 * V_4 ;
int V_277 , V_278 ;
int V_279 , V_280 ;
struct V_235 * V_263 ;
if ( ! F_73 ( V_93 , & V_109 ) )
return 0 ;
if ( F_160 ( V_77 -> V_237 ) < sizeof( struct V_235 ) )
return - V_136 ;
V_263 = F_137 ( V_77 -> V_237 ) ;
if ( ! ( V_263 -> V_247 & V_248 ) )
return 0 ;
V_278 = V_77 -> args [ 0 ] ;
...
V_280 = 0 ;
F_124 () ;
for( V_4 = F_125 ( V_24 [ V_277 ] . V_25 ) , V_279 = 0 ;
V_4 ;
V_4 = F_125 ( V_4 -> V_2 . V_29 ) , V_279 ++ ) {
if ( V_279 < V_280 )
continue;
F_134 ( V_37 , F_161 ( & V_4 -> V_2 ) ) ;
if ( F_135 ( V_37 , F_157 ( V_77 -> V_37 ) . V_231 ,
V_77 -> V_237 -> V_274 , V_275 ,
1 , V_281 ) < 0 ) {
F_162 ( V_37 ) ;
F_127 () ;
goto V_212;
...
static struct V_3 * F_163 ( struct V_282 * V_232 )
{
struct V_3 * V_4 = NULL ;
struct V_283 * V_284 = V_232 -> V_285 ;
for( V_284 -> V_286 = V_14 ; V_284 -> V_286 >= 0 ; -- V_284 -> V_286 ) {
F_124 () ;
V_4 = F_125 ( V_24 [ V_284 -> V_286 ] . V_25 ) ;
if ( V_4 )
break;
F_127 () ;
}
...
static struct V_3 * F_164 ( struct V_282 * V_232 , struct V_3 * V_4 )
{
struct V_283 * V_284 = V_232 -> V_285 ;
V_4 = F_125 ( V_4 -> V_2 . V_29 ) ;
while ( ! V_4 ) {
...
static void * F_165 ( struct V_282 * V_232 , T_7 * V_287 )
{
struct V_3 * V_4 = F_163 ( V_232 ) ;
if ( V_4 ) {
while( * V_287 && ( V_4 = F_164 ( V_232 , V_4 ) ) )
-- * V_287 ;
}
return * V_287 ? NULL : V_4 ;
}
static void * F_166 ( struct V_282 * V_232 , void * V_288 , T_7 * V_287 )
{
struct V_3 * V_4 = F_164 ( V_232 , V_288 ) ;
++ * V_287 ;
return V_4 ;
}
static void F_167 ( struct V_282 * V_232 , void * V_288 )
{
if ( V_288 )
F_127 () ;
}
static int F_168 ( struct V_282 * V_232 , void * V_288 )
{
struct V_3 * V_4 = V_288 ;
char V_289 [ V_290 ] , V_291 [ V_290 ] ;
F_169 ( V_232 , L_11 ,
V_4 -> V_2 . V_7 ? V_4 -> V_2 . V_7 -> V_97 : L_12 ,
F_170 ( F_58 ( V_4 -> V_138 ) , V_289 ) ,
F_170 ( F_58 ( V_4 -> V_137 ) , V_291 ) ,
F_17 ( & V_4 -> V_2 . V_27 ) ,
V_4 -> V_2 . V_292 , 0 ) ;
return 0 ;
}
static int F_171 ( struct V_293 * V_293 , struct V_294 * V_294 )
{
return F_172 ( V_294 , & V_295 ,
sizeof( struct V_283 ) ) ;
}
void T_8 F_173 ( void )
{
...
V_201 . V_298 =
F_174 ( L_13 , sizeof( struct V_3 ) , 0 ,
V_299 | V_300 , NULL ) ;
F_175 ( & V_201 ) ;
F_176 ( & V_30 , F_13 , 0 ) ;
...
V_14 -- ;
for( V_18 = 0 ; V_18 <= V_14 ; V_18 ++ ) {
F_179 ( & V_24 [ V_18 ] . V_26 ) ;
V_24 [ V_18 ] . V_25 = NULL ;
}
V_201 . V_306 = ( V_14 + 1 ) ;
F_180 ( L_16 , V_307 , V_109 . V_308 ,
& V_309 ) ;
#ifdef F_181
F_182 ( V_310 , V_311 , F_146 ,
V_312 , NULL ) ;
#else
F_182 ( V_310 , V_311 , F_146 ,
F_159 , NULL ) ;
