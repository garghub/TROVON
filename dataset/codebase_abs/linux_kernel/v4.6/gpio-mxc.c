...
goto V_96;
V_6 -> V_4 . V_97 = F_30 ;
V_6 -> V_4 . V_13 = ( V_65 -> V_98 < 0 ) ? F_42 ( V_84 , L_7 ) * 32 :
V_65 -> V_98 * 32 ;
V_88 = F_43 ( & V_65 -> V_69 , & V_6 -> V_4 , V_6 ) ;
if ( V_88 )
goto V_96;
V_43 = F_44 ( - 1 , 0 , 32 , F_45 () ) ;
if ( V_43 < 0 ) {
V_88 = V_43 ;
goto V_96;
}
V_6 -> V_33 = F_46 ( V_84 , 32 , V_43 , 0 ,
& V_99 , NULL ) ;
if ( ! V_6 -> V_33 ) {
V_88 = - V_100 ;
goto V_101;
