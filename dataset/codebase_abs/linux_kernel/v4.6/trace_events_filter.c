...
static bool F_60 ( struct V_115 * V_116 , int V_17 )
{
if ( F_61 ( V_116 ) &&
( V_17 != V_18 && V_17 != V_117 && V_17 != V_36 ) )
return false ;
if ( ! F_61 ( V_116 ) && V_17 == V_36 )
return false ;
return true ;
}
static T_3 F_62 ( int V_17 , int V_118 ,
int V_119 )
{
T_3 V_62 = NULL ;
switch ( V_118 ) {
case 8 :
if ( V_17 == V_18 || V_17 == V_117 )
V_62 = V_120 ;
else if ( V_119 )
V_62 = V_121 ;
else
...
F_14 ( V_2 ) ;
if ( V_116 -> V_133 == V_113 ) {
V_62 = F_1 ;
V_2 -> V_8 . V_9 = V_116 -> V_136 ;
} else if ( V_116 -> V_133 == V_112 )
V_62 = F_3 ;
else
V_62 = F_2 ;
} else if ( F_64 ( V_116 ) ) {
if ( strcmp ( V_116 -> V_137 , L_7 ) ) {
F_23 ( V_70 , V_138 , 0 ) ;
return - V_50 ;
}
} else {
...
V_2 -> V_16 = V_16 ;
if ( V_116 -> V_133 == V_141 )
V_62 = F_4 ;
else
V_62 = F_62 ( V_2 -> V_17 , V_116 -> V_136 ,
V_116 -> V_139 ) ;
if ( ! V_62 ) {
F_23 ( V_70 , V_142 , 0 ) ;
return - V_50 ;
...
V_2 . V_116 = V_116 ;
return F_63 ( V_70 , V_116 , & V_2 ) ? NULL : & V_2 ;
}
...
if ( V_214 ) {
if ( ( V_2 -> V_17 != V_18 ) && ( V_2 -> V_17 != V_117 ) )
return - V_50 ;
if ( strcmp ( V_116 -> V_137 , L_7 ) )
return - V_50 ;
} else {
