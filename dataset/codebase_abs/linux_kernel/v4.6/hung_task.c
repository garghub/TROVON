...
static long F_25 ( unsigned long V_35 ,
unsigned long V_12 )
{
return V_12 ? V_35 - V_36 + V_12 * V_37 :
V_38 ;
}
int F_26 ( struct V_39 * V_40 , int V_41 ,
void T_2 * V_42 ,
T_3 * V_43 , T_4 * V_44 )
{
int V_45 ;
V_45 = F_27 ( V_40 , V_41 , V_42 , V_43 , V_44 ) ;
if ( V_45 || ! V_41 )
goto V_46;
F_28 ( V_47 ) ;
V_46:
...
static int F_31 ( void * V_49 )
{
unsigned long V_50 = V_36 ;
F_32 ( V_51 , 0 ) ;
for ( ; ; ) {
unsigned long V_12 = V_52 ;
long V_11 = F_25 ( V_50 , V_12 ) ;
if ( V_11 <= 0 ) {
if ( ! F_33 ( & V_48 , 0 ) )
F_22 ( V_12 ) ;
V_50 = V_36 ;
