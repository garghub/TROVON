...
V_3 -> V_27 = F_81 ( & V_3 -> V_147 , & V_139 -> V_11 , V_3 ) ;
if ( F_77 ( V_3 -> V_27 ) ) {
...
int F_84 ( struct V_138 * V_139 )
{
struct V_2 * V_3 = F_85 ( V_139 ) ;
F_68 ( & V_3 -> V_84 ) ;
F_82 ( V_3 -> V_27 ) ;
return 0 ;
}
int F_86 ( struct V_149 * V_11 )
{
struct V_138 * V_139 = F_87 ( V_11 ) ;
struct V_2 * V_3 = F_85 ( V_139 ) ;
struct V_131 * V_8 ;
struct V_132 * V_133 ;
int V_6 ;
