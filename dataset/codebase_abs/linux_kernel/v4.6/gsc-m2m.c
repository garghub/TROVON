...
struct V_33 * V_48 ;
int V_49 ;
V_48 = F_53 ( V_2 , V_43 -> type ) ;
if ( F_54 ( V_48 ) )
return F_55 ( V_48 ) ;
if ( ! V_48 -> V_50 )
return - V_51 ;
* V_45 = V_48 -> V_50 -> V_45 ;
for ( V_49 = 0 ; V_49 < V_48 -> V_50 -> V_45 ; V_49 ++ ) {
V_46 [ V_49 ] = V_48 -> V_52 [ V_49 ] ;
V_47 [ V_49 ] = V_2 -> V_4 -> V_53 ;
}
return 0 ;
}
...
struct V_33 * V_48 ;
int V_49 ;
V_48 = F_53 ( V_2 , V_55 -> V_16 -> type ) ;
if ( F_54 ( V_48 ) )
return F_55 ( V_48 ) ;
if ( ! F_57 ( V_55 -> V_16 -> type ) ) {
for ( V_49 = 0 ; V_49 < V_48 -> V_50 -> V_45 ; V_49 ++ )
F_58 ( V_55 , V_49 , V_48 -> V_52 [ V_49 ] ) ;
}
return 0 ;
}
...
V_48 = & V_2 -> V_35 ;
V_76 = & V_73 -> V_50 . V_78 ;
V_48 -> V_50 = F_74 ( & V_76 -> V_79 , NULL , 0 ) ;
V_48 -> V_80 = V_76 -> V_80 ;
if ( ! V_48 -> V_50 )
return - V_51 ;
for ( V_49 = 0 ; V_49 < V_48 -> V_50 -> V_45 ; V_49 ++ )
V_48 -> V_52 [ V_49 ] = V_76 -> V_81 [ V_49 ] . V_82 ;
F_75 ( V_48 , V_76 -> V_83 , V_76 -> V_84 ) ;
if ( V_73 -> type == V_85 )
F_4 ( V_40 | V_86 , V_2 ) ;
else
F_4 ( V_40 | V_87 , V_2 ) ;
F_27 ( L_8 , V_48 -> V_88 , V_48 -> V_89 ) ;
return 0 ;
}
...
V_108 -> V_114 . V_105 = 0 ;
V_108 -> V_114 . V_106 = 0 ;
V_108 -> V_114 . V_83 = V_48 -> V_88 ;
V_108 -> V_114 . V_84 = V_48 -> V_89 ;
return 0 ;
case V_115 :
case V_116 :
V_108 -> V_114 . V_105 = V_48 -> V_117 . V_105 ;
V_108 -> V_114 . V_106 = V_48 -> V_117 . V_106 ;
V_108 -> V_114 . V_83 = V_48 -> V_117 . V_83 ;
V_108 -> V_114 . V_84 = V_48 -> V_117 . V_84 ;
return 0 ;
}
return - V_51 ;
}
...
F_104 ( & V_2 -> V_58 ) ;
V_2 -> V_4 = V_5 ;
V_2 -> V_34 . V_50 = F_105 ( 0 ) ;
V_2 -> V_35 . V_50 = F_105 ( 0 ) ;
V_2 -> V_13 = V_153 ;
V_2 -> V_30 = 0 ;
V_2 -> V_154 = V_155 ;
V_2 -> V_128 = V_155 ;
