...
struct V_7 * V_8 ;
T_2 V_9 , V_10 , V_11 ;
if ( ( V_6 -> V_12 & V_13 ) && * V_4 >= 91 && V_3 [ 83 ] == 0x26 &&
...
struct V_35 * V_36 , T_4 V_123 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ( V_6 -> V_12 & V_124 ) && V_36 -> V_113 == V_125 ) {
F_18 ( V_96 -> V_126 -> V_43 , V_36 -> type , V_36 -> V_113 ,
- V_123 ) ;
return 1 ;
}
if ( V_6 -> V_12 & V_127 ) {
return F_19 ( V_2 , V_96 , V_36 , V_123 , V_6 ) ;
}
return 0 ;
}
static int F_20 ( struct V_1 * V_2 , const struct V_128 * V_129 )
{
struct V_130 * V_131 = F_21 ( V_2 -> V_132 . V_133 ) ;
T_1 V_134 = V_131 -> V_135 -> V_136 . V_137 ;
unsigned int V_138 = V_139 ;
struct V_5 * V_6 ;
int V_140 ;
if ( ( V_2 -> V_15 == V_118 ) &&
( V_134 != 0 ) ) {
F_22 ( L_10 , V_141 , V_134 ) ;
return - V_142 ;
}
V_6 = F_23 ( sizeof( struct V_5 ) , V_143 ) ;
if ( ! V_6 ) {
F_5 ( V_2 , L_11 ) ;
return - V_144 ;
}
V_6 -> V_12 = V_129 -> V_145 ;
F_24 ( V_2 , ( void * ) V_6 ) ;
if ( V_6 -> V_12 & V_146 )
V_2 -> V_12 |= V_147 ;
V_140 = F_25 ( V_2 ) ;
...
if ( V_6 -> V_12 & ( V_149 | V_150 | V_151 | V_127 ) )
V_138 &= ~ V_152 ;
V_140 = F_26 ( V_2 , V_138 ) ;
if ( V_140 ) {
F_5 ( V_2 , L_13 ) ;
goto V_148;
}
if ( V_2 -> V_15 == V_32 ) {
unsigned char V_153 [] = { 0x00 , 0xAF , 0x01 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 } ;
V_140 = F_27 ( V_2 , V_153 [ 0 ] , V_153 , sizeof( V_153 ) ,
V_154 , V_155 ) ;
if ( V_140 >= 0 ) {
T_5 V_156 ;
F_28 ( & V_156 ) ;
...
if ( V_6 -> V_12 & V_149 )
V_140 = F_32 ( V_2 ) ;
else if ( V_6 -> V_12 & V_150 )
V_140 = F_33 ( V_2 ) ;
else if ( V_6 -> V_12 & V_151 )
V_140 = F_34 ( V_2 ) ;
else if ( V_6 -> V_12 & V_127 )
V_140 = F_35 ( V_2 ) ;
if ( V_140 )
goto V_148;
return 0 ;
