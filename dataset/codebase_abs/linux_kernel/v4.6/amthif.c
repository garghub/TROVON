...
void F_36 ( struct V_11 * V_12 , struct V_20 * V_21 )
{
struct V_1 * V_2 = V_12 -> V_2 ;
if ( V_21 -> V_60 == V_61 ) {
if ( ! V_21 -> V_33 ) {
...
static bool F_41 ( struct V_1 * V_2 , const struct V_15 * V_15 )
{
bool V_66 = false ;
struct V_11 * V_12 = & V_2 -> V_13 ;
F_38 ( V_2 , V_15 , & V_2 -> V_50 . V_35 ) ;
if ( F_38 ( V_2 , V_15 , & V_12 -> V_29 ) )
V_66 = true ;
F_38 ( V_2 , V_15 , & V_2 -> V_67 . V_35 ) ;
if ( F_38 ( V_2 , V_15 , & V_2 -> V_43 . V_35 ) )
V_66 = true ;
if ( F_38 ( V_2 , V_15 , & V_2 -> V_68 . V_35 ) )
V_66 = true ;
if ( F_38 ( V_2 , V_15 , & V_2 -> V_69 . V_35 ) )
V_66 = true ;
if ( V_2 -> V_3 && ! V_66 ) {
...
int F_42 ( struct V_1 * V_2 , struct V_15 * V_15 )
{
if ( V_2 -> V_8 > 0 )
V_2 -> V_8 -- ;
if ( V_2 -> V_45 == V_15 &&
