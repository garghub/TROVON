...
if ( V_93 -> V_104 [ V_16 ] . V_107 )
V_38 = & V_93 -> V_104 [ V_16 ] . V_38 ;
...
static struct V_110 * F_90 ( struct V_6 * V_7 , T_4 V_111 )
{
struct V_112 * V_113 = V_7 -> V_114 -> V_115 ;
return F_91 ( V_113 , ( V_116 ) ( V_111 >> ( V_117 - 9 ) ) ,
NULL ) ;
}
unsigned char * F_92 ( struct V_6 * V_7 , T_4 V_111 , T_5 * V_16 )
{
struct V_110 * V_110 ;
if ( F_93 ( V_7 -> V_114 ) )
V_110 = F_94 ( V_7 , V_111 ) ;
else
V_110 = F_90 ( V_7 , V_111 ) ;
if ( ! F_79 ( V_110 ) ) {
if ( F_95 ( V_110 ) )
goto V_118;
V_16 -> V_119 = V_110 ;
return ( unsigned char * ) F_96 ( V_110 ) + ( ( V_111 & ( ( 1 << ( V_117 - 9 ) ) - 1 ) ) << 9 ) ;
V_118:
F_97 ( V_110 ) ;
}
V_16 -> V_119 = NULL ;
