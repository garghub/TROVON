...
V_28 = V_29 * V_7 ;
V_20 = V_2 -> V_5 + V_64 * V_7 ;
if ( V_20 + V_28 > V_2 -> V_68 ) {
V_65 = - V_69 ;
goto V_70;
}
if ( V_61 == V_71 || V_61 == V_72 )
V_25 |= V_26 ;
V_65 = F_28 ( V_2 , V_27 , V_20 , V_28 , V_25 ) ;
if ( V_65 )
goto V_70;
F_48 ( V_29 , & V_2 -> V_73 ) ;
...
unsigned long V_64 ;
int V_75 , V_65 ;
V_75 = F_47 ( V_20 , V_28 , V_7 ) ;
V_20 = V_20 & V_31 ;
V_65 = F_28 ( V_2 , 0 , V_20 , V_75 * V_7 ,
V_16 ) ;
if ( V_65 ) {
F_49 ( L_2 ) ;
F_43 ( V_65 , V_20 ) ;
...
T_1 V_79 ;
V_28 = F_29 ( V_28 ) ;
V_59 = F_52 ( V_78 , F_53 ( V_28 ) ) ;
if ( ! V_59 )
return NULL ;
V_27 = F_46 ( V_59 ) ;
memset ( ( void * ) V_27 , 0 , V_28 ) ;
V_79 = F_45 ( V_47 , V_59 , 0 , V_28 , V_80 , NULL ) ;
if ( F_54 ( V_47 , V_79 ) ) {
F_55 ( V_27 , F_53 ( V_28 ) ) ;
return NULL ;
}
F_48 ( V_28 / V_7 , & V_2 -> V_81 ) ;
if ( V_77 )
* V_77 = V_79 ;
return ( void * ) V_27 ;
}
...
struct V_1 * V_2 = F_35 ( F_36 ( V_47 ) ) ;
V_28 = F_29 ( V_28 ) ;
F_57 ( V_28 / V_7 , & V_2 -> V_81 ) ;
F_50 ( V_47 , V_77 , V_28 , V_80 , NULL ) ;
F_55 ( ( unsigned long ) V_27 , F_53 ( V_28 ) ) ;
}
static int F_58 ( struct V_46 * V_47 , struct V_82 * V_83 ,
int V_84 , enum V_60 V_85 ,
struct V_62 * V_63 )
{
int V_86 = 0 ;
struct V_82 * V_87 ;
...
struct V_59 * V_59 = F_60 ( V_87 ) ;
V_87 -> V_88 = F_45 ( V_47 , V_59 , V_87 -> V_51 ,
V_87 -> V_89 , V_85 , NULL ) ;
if ( ! F_54 ( V_47 , V_87 -> V_88 ) ) {
V_87 -> V_90 = V_87 -> V_89 ;
V_86 ++ ;
} else
goto V_91;
...
static void F_61 ( struct V_46 * V_47 , struct V_82 * V_83 ,
int V_84 , enum V_60 V_85 ,
struct V_62 * V_63 )
{
struct V_82 * V_87 ;
int V_34 ;
F_59 (sg, s, nr_elements, i) {
F_50 ( V_47 , V_87 -> V_88 , V_87 -> V_90 , V_85 , NULL ) ;
V_87 -> V_88 = 0 ;
V_87 -> V_90 = 0 ;
}
}
...
V_2 -> V_93 = F_65 ( ( V_3 ) V_94 ,
V_95 - V_2 -> V_5 ,
V_2 -> V_68 - V_2 -> V_5 + 1 ) ;
V_2 -> V_68 = V_2 -> V_5 + V_2 -> V_93 - 1 ;
...
V_35 = F_67 ( V_2 , 0 , V_2 -> V_5 , V_2 -> V_68 ,
( V_3 ) V_2 -> V_38 ) ;
if ( V_35 )
goto V_97;
return 0 ;
...
static int T_5 F_78 ( char * V_103 )
{
if ( ! strncmp ( V_103 , L_5 , 6 ) )
V_43 = 1 ;
return 0 ;
}
