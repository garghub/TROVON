...
F_15 ( & V_18 -> V_24 -> V_41 , V_22 ) ;
} else {
F_16 ( & V_18 -> V_24 -> V_43 -> V_44 ,
L_1 ) ;
}
}
static void F_17 ( struct V_17 * V_18 , int V_19 ,
int V_20 , T_1 V_21 )
{
unsigned long V_22 ;
void T_2 * V_23 = V_18 -> V_24 -> V_25 + V_26 + V_19 ;
...
static int F_20 ( struct V_45 * V_46 , unsigned int V_10 ,
int V_19 , int V_20 , T_1 * V_21 )
{
struct V_47 * V_24 =
F_21 ( V_46 -> V_48 , struct V_47 , V_48 ) ;
struct V_17 * V_18 ;
V_18 = F_22 ( V_24 , F_4 ( V_10 ) ) ;
if ( ! V_18 )
return V_49 ;
...
static int F_24 ( struct V_45 * V_46 , unsigned int V_10 ,
int V_19 , int V_20 , T_1 V_21 )
{
struct V_47 * V_24 =
F_21 ( V_46 -> V_48 , struct V_47 , V_48 ) ;
...
V_55 -> V_53 = * V_53 ;
F_26 ( V_18 -> V_24 -> V_43 -> V_64 , V_55 , sizeof( * V_55 ) ,
( unsigned long ) & V_60 . V_57 , V_65 , 0 ) ;
F_27 ( V_53 ) ;
}
static void F_28 ( struct V_66 * V_67 , struct V_68 * V_69 ,
unsigned int V_70 )
{
struct V_47 * V_24 ;
struct V_17 * V_18 ;
struct V_71 * V_72 ;
struct V_52 * V_53 ;
struct V_73 * V_73 = F_29 ( V_67 , V_70 ) ;
struct V_74 * V_75 = F_30 ( V_73 ) ;
V_72 = F_31 ( V_75 ) ;
V_24 = V_69 -> V_76 ;
V_18 = F_22 ( V_24 , F_4 ( V_72 -> V_10 ) ) ;
if ( ! V_18 )
return;
V_53 = F_32 ( V_73 ) ;
if ( V_53 ) {
...
static int F_33 ( struct V_73 * V_76 , const struct V_78 * V_79 ,
bool V_80 )
{
struct V_73 * V_81 = V_76 -> V_82 ;
return V_81 -> V_83 -> V_84 ( V_81 , V_79 , V_80 ) ;
}
void F_34 ( struct V_73 * V_76 )
{
F_35 ( V_76 ) ;
}
void F_36 ( struct V_73 * V_76 )
{
struct V_74 * V_74 = F_30 ( V_76 ) ;
struct V_85 * V_86 = F_37 ( V_76 ) ;
struct V_87 V_88 ;
struct V_47 * V_24 ;
struct V_78 * V_79 ;
struct V_45 * V_89 ;
...
V_72 = F_31 ( V_74 ) ;
V_89 = V_72 -> V_46 ;
V_24 = F_21 ( V_89 -> V_48 , struct V_47 , V_48 ) ;
...
F_39 (cpu, dest, cpu_online_mask)
V_88 . V_101 |= ( 1ULL << F_40 ( V_90 ) ) ;
F_41 ( V_102 , & V_88 , NULL ) ;
F_42 ( V_76 ) ;
}
static void F_43 ( void * V_1 , struct V_2 * V_3 ,
int V_4 )
{
...
static void F_44 ( struct V_73 * V_76 , struct V_106 * V_95 )
{
struct V_85 * V_86 = F_37 ( V_76 ) ;
struct V_47 * V_24 ;
struct V_17 * V_18 ;
...
V_53 = F_45 ( sizeof( * V_53 ) , V_112 ) ;
if ( ! V_53 )
goto V_113;
memset ( & V_60 , 0 , sizeof( V_60 ) ) ;
F_46 ( & V_108 . V_6 . V_9 ) ;
V_60 . V_57 . V_114 = F_43 ;
...
V_109 = F_38 ( V_76 ) ;
F_39 (cpu, affinity, cpu_online_mask) {
V_55 -> V_53 . V_122 |=
( 1ULL << F_40 ( V_90 ) ) ;
}
V_110 = F_26 ( V_18 -> V_24 -> V_43 -> V_64 , V_55 ,
...
static T_3 F_48 ( struct V_68 * V_69 ,
T_4 * V_126 )
{
return V_126 -> V_127 ;
}
static int F_49 ( struct V_47 * V_24 )
{
...
V_24 -> V_66 = F_50 ( V_24 -> V_48 . V_139 ,
& V_24 -> V_128 ,
V_140 ) ;
if ( ! V_24 -> V_66 ) {
F_16 ( & V_24 -> V_43 -> V_44 ,
...
static T_5 F_51 ( T_5 V_142 )
{
return F_52 ( ( 1 + ~ ( V_142 & V_143 ) ) ,
V_144 ) ;
}
static void F_53 ( struct V_47 * V_24 )
{
struct V_145 * V_146 ;
struct V_17 * V_18 ;
T_6 V_147 = 0 ;
...
F_55 (iter, &hbus->children) {
V_18 = F_21 ( V_146 , struct V_17 , V_155 ) ;
...
F_15 ( & V_24 -> V_154 , V_22 ) ;
F_3 ( V_149 ) ;
}
static void F_56 ( struct V_47 * V_24 )
{
T_6 V_159 = 0 ;
T_6 V_160 = 0 ;
T_6 V_161 = 0 ;
...
static int F_58 ( struct V_47 * V_24 )
{
V_24 -> V_45 = F_59 ( & V_24 -> V_43 -> V_44 ,
0 ,
& V_170 ,
& V_24 -> V_48 ,
& V_24 -> V_171 ) ;
...
static void F_63 ( void * V_1 , struct V_2 * V_3 ,
int V_4 )
{
...
int V_150 ;
if ( V_3 -> V_7 < 0 ) {
F_16 ( & V_148 -> V_18 -> V_24 -> V_43 -> V_44 ,
L_7 ,
V_3 -> V_7 ) ;
} else {
for ( V_150 = 0 ; V_150 < 6 ; V_150 ++ ) {
...
static struct V_17 * F_67 ( struct V_47 * V_24 ,
struct V_182 * V_29 )
{
struct V_17 * V_18 ;
struct V_183 * V_184 ;
...
static struct V_17 * F_22 ( struct V_47 * V_24 ,
T_1 V_12 )
{
unsigned long V_22 ;
struct V_17 * V_146 , * V_18 = NULL ;
F_10 ( & V_24 -> V_154 , V_22 ) ;
F_69 (iter, &hbus->children, list_entry) {
...
static void F_70 ( struct V_191 * V_192 )
{
T_1 V_193 ;
bool V_194 ;
struct V_145 * V_146 ;
...
unsigned long V_22 ;
V_198 = F_21 ( V_192 , struct V_197 , V_201 ) ;
V_24 = V_198 -> V_46 ;
F_27 ( V_198 ) ;
F_71 ( & V_196 ) ;
if ( F_72 ( & V_24 -> V_202 ) ) {
...
F_10 ( & V_24 -> V_154 , V_22 ) ;
while ( ! F_74 ( & V_24 -> V_203 ) ) {
V_200 = F_75 ( & V_24 -> V_203 , struct V_199 ,
V_155 ) ;
F_76 ( & V_200 -> V_155 ) ;
if ( ! F_74 ( & V_24 -> V_203 ) ) {
F_27 ( V_200 ) ;
...
static void F_80 ( struct V_47 * V_24 ,
struct V_208 * V_209 )
{
struct V_199 * V_200 ;
struct V_197 * V_198 ;
unsigned long V_22 ;
V_198 = F_45 ( sizeof( * V_198 ) , V_210 ) ;
if ( ! V_198 )
return;
V_200 = F_45 ( F_81 ( struct V_199 , V_15 ) +
( sizeof( struct V_182 ) *
( V_209 -> V_205 ) ) , V_210 ) ;
if ( ! V_200 ) {
F_27 ( V_198 ) ;
...
F_10 ( & V_24 -> V_154 , V_22 ) ;
F_68 ( & V_200 -> V_155 , & V_24 -> V_203 ) ;
F_15 ( & V_24 -> V_154 , V_22 ) ;
F_83 ( V_24 ) ;
F_84 ( & V_198 -> V_201 ) ;
}
static void F_85 ( struct V_191 * V_192 )
{
struct V_211 * V_212 ;
struct V_17 * V_18 ;
struct V_71 * V_72 ;
...
V_18 = F_21 ( V_192 , struct V_17 , V_201 ) ;
if ( V_18 -> V_174 != V_213 ) {
F_23 ( V_18 , V_214 ) ;
return;
}
V_12 = F_7 ( V_18 -> V_29 . V_42 . V_13 ) ;
V_72 = F_86 ( V_18 -> V_24 -> V_48 . V_67 , 0 ,
V_12 ) ;
if ( V_72 ) {
F_87 ( V_72 ) ;
F_88 ( V_72 ) ;
...
V_18 -> V_174 = V_213 ;
F_64 ( V_18 , V_214 ) ;
F_82 ( & V_18 -> V_201 , F_85 ) ;
F_83 ( V_18 -> V_24 ) ;
F_84 ( & V_18 -> V_201 ) ;
}
static void F_90 ( void * V_1 )
{
...
struct V_226 * V_227 ;
struct V_17 * V_18 ;
V_58 = F_91 ( V_220 , V_186 ) ;
if ( ! V_58 )
return;
while ( 1 ) {
V_110 = F_92 ( V_24 -> V_43 -> V_64 , V_58 ,
V_220 , & V_217 , & V_218 ) ;
if ( V_110 == - V_228 ) {
F_27 ( V_58 ) ;
V_220 = V_217 ;
V_58 = F_91 ( V_217 , V_186 ) ;
if ( ! V_58 )
return;
continue;
}
...
static int F_94 ( struct V_232 * V_43 )
{
struct V_233 * V_234 ;
struct V_5 V_6 ;
struct V_56 * V_57 ;
int V_110 ;
V_57 = F_45 ( sizeof( * V_57 ) + sizeof( * V_234 ) , V_112 ) ;
if ( ! V_57 )
return - V_235 ;
F_46 ( & V_6 . V_9 ) ;
V_57 -> V_114 = F_1 ;
...
static void F_95 ( struct V_47 * V_24 )
{
if ( V_24 -> V_152 && V_24 -> V_165 ) {
V_24 -> V_165 -> V_22 |= V_240 ;
F_96 ( V_24 -> V_165 -> V_166 ,
F_97 ( V_24 -> V_165 ) ) ;
}
if ( V_24 -> V_153 && V_24 -> V_167 ) {
V_24 -> V_167 -> V_22 |= V_240 ;
F_96 ( V_24 -> V_167 -> V_166 ,
F_97 ( V_24 -> V_167 ) ) ;
}
}
static int F_98 ( struct V_47 * V_24 )
{
T_6 V_241 ;
int V_110 ;
if ( V_24 -> V_152 ) {
V_241 = 1ULL << ( 63 - F_57 ( V_24 -> V_152 ) ) ;
V_110 = F_99 ( & V_24 -> V_165 , V_24 -> V_43 , 0 ,
( T_5 ) ( T_1 ) 0xffffffff ,
V_24 -> V_152 ,
V_241 , false ) ;
if ( V_110 ) {
...
if ( V_24 -> V_153 ) {
V_241 = 1ULL << ( 63 - F_57 ( V_24 -> V_153 ) ) ;
V_110 = F_99 ( & V_24 -> V_167 , V_24 -> V_43 ,
0x100000000 , - 1 ,
V_24 -> V_153 , V_241 ,
false ) ;
if ( V_110 ) {
...
{
int V_110 ;
V_110 = F_99 ( & V_24 -> V_244 , V_24 -> V_43 , 0 , - 1 ,
V_245 , 0x1000 , false ) ;
if ( V_110 )
return V_110 ;
...
static void F_102 ( struct V_47 * V_24 )
{
F_96 ( V_24 -> V_244 -> V_166 , V_245 ) ;
}
static int F_103 ( struct V_232 * V_43 )
{
struct V_47 * V_24 = F_104 ( V_43 ) ;
struct V_246 * V_247 ;
struct V_5 V_6 ;
struct V_56 * V_57 ;
int V_110 ;
V_57 = F_45 ( sizeof( * V_57 ) + sizeof( * V_247 ) , V_112 ) ;
if ( ! V_57 )
return - V_235 ;
F_46 ( & V_6 . V_9 ) ;
V_57 -> V_114 = F_1 ;
...
V_110 = F_26 ( V_43 -> V_64 , V_247 , sizeof( * V_247 ) ,
( unsigned long ) V_57 , V_65 ,
V_123 ) ;
if ( V_110 )
goto exit;
...
int V_110 ;
F_46 ( & V_108 ) ;
if ( F_106 ( & V_24 -> V_151 , NULL , & V_108 ) )
return - V_250 ;
memset ( & V_61 , 0 , sizeof( V_61 ) ) ;
V_61 . V_62 = V_251 ;
V_110 = F_26 ( V_43 -> V_64 , & V_61 , sizeof( V_61 ) ,
0 , V_65 , 0 ) ;
if ( V_110 )
return V_110 ;
F_47 ( & V_108 ) ;
...
T_1 V_12 ;
int V_110 ;
V_57 = F_91 ( sizeof( * V_57 ) + sizeof( * V_253 ) , V_112 ) ;
if ( ! V_57 )
return - V_235 ;
V_110 = 0 ;
...
static int F_108 ( struct V_232 * V_43 )
{
struct V_47 * V_24 = F_104 ( V_43 ) ;
struct V_183 V_57 ;
struct V_17 * V_18 ;
...
F_23 ( V_18 , V_50 ) ;
V_110 = F_26 ( V_43 -> V_64 , & V_57 , sizeof( V_57 ) , 0 ,
V_65 , 0 ) ;
if ( V_110 )
return V_110 ;
}
...
static void F_73 ( struct V_47 * V_24 )
{
if ( F_66 ( & V_24 -> V_256 ) )
F_3 ( & V_24 -> V_257 ) ;
}
...
F_111 ( & V_24 -> V_202 , 1 ) ;
F_46 ( & V_24 -> V_257 ) ;
V_110 = F_112 ( V_43 -> V_64 , V_260 , V_260 , NULL , 0 ,
F_90 , V_24 ) ;
if ( V_110 )
goto V_261;
F_113 ( V_43 , V_24 ) ;
...
if ( V_110 )
goto V_262;
V_24 -> V_25 = F_114 ( V_24 -> V_244 -> V_166 ,
V_245 ) ;
if ( ! V_24 -> V_25 ) {
F_16 ( & V_43 -> V_44 ,
L_17 ) ;
...
static int F_120 ( struct V_232 * V_43 )
{
int V_110 ;
struct V_47 * V_24 ;
union {
...
V_110 = F_26 ( V_43 -> V_64 , & V_57 . V_269 . V_61 ,
sizeof( struct V_59 ) ,
( unsigned long ) & V_57 . V_269 ,
V_65 ,
V_123 ) ;
if ( ! V_110 )
F_121 ( & V_6 . V_9 , 10 * V_271 ) ;
if ( V_24 -> V_174 == V_175 ) {
F_78 () ;
F_122 ( V_24 -> V_45 ) ;
F_123 ( V_24 -> V_45 ) ;
