...
static void F_152 ( struct V_18 * V_85 , struct V_34 * V_103 )
{
struct V_27 * V_28 ;
int V_5 = V_85 -> V_5 ;
while ( ! F_116 ( V_103 ) ) {
...
V_85 = F_155 ( & V_6 ) ;
F_113 ( & V_85 -> V_80 ) ;
F_156 ( & V_136 -> V_80 , V_137 ) ;
F_81 ( V_136 -> V_87 ) ;
for ( V_37 = 0 ; V_37 < V_36 ; V_37 ++ )
F_152 ( V_85 , V_136 -> V_39 . V_35 + V_37 ) ;
for ( V_37 = 0 ; V_37 < V_113 ; V_37 ++ ) {
F_152 ( V_85 , V_136 -> V_43 . V_35 + V_37 ) ;
F_152 ( V_85 , V_136 -> V_44 . V_35 + V_37 ) ;
F_152 ( V_85 , V_136 -> V_45 . V_35 + V_37 ) ;
F_152 ( V_85 , V_136 -> V_47 . V_35 + V_37 ) ;
}
V_136 -> V_52 = 0 ;
V_136 -> V_49 = 0 ;
F_82 ( & V_136 -> V_80 ) ;
...
void F_167 ( unsigned int V_145 )
{
unsigned long V_126 = F_168 ( V_145 ) + 1 ;
while ( V_126 )
V_126 = F_150 ( V_126 ) ;
}
unsigned long F_169 ( unsigned int V_145 )
{
unsigned long V_126 = F_168 ( V_145 ) + 1 ;
while ( V_126 && ! F_170 ( V_57 ) )
V_126 = F_147 ( V_126 ) ;
return F_171 ( V_126 ) ;
}
static void T_6 F_172 ( unsigned long V_146 , unsigned long V_147 )
{
T_8 V_148 ;
T_5 V_93 ;
V_148 = F_173 ( 0 , V_146 * V_149 ) ;
V_93 = ( T_5 ) ( V_147 - V_146 ) * V_149 ;
F_174 ( & V_148 , V_93 , V_150 ) ;
}
void T_6 F_175 ( unsigned long V_146 , unsigned long V_147 )
{
F_148 ( V_134 ) ;
F_172 ( V_146 , V_147 ) ;
}
