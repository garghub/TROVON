...
if ( V_7 )
goto V_32;
V_27 = V_4 . args [ 1 ] << 24 | V_4 . args [ 2 ] << 16 | V_4 . args [ 3 ] << 8 |
V_4 . args [ 4 ] << 0 ;
...
F_19 ( & V_2 -> V_6 , L_11 ,
V_26 ) ;
for ( V_23 = V_25 -> V_36 ; V_23 > 0 ; V_23 -= 17 ) {
V_22 = V_25 -> V_38 [ V_25 -> V_36 - V_23 ] ;
if ( V_22 > V_39 ) {
F_18 ( & V_2 -> V_6 , L_12 ) ;
V_7 = - V_34 ;
goto V_37;
}
memcpy ( V_4 . args , & V_25 -> V_38 [ ( V_25 -> V_36 - V_23 ) + 1 ] , V_22 ) ;
V_4 . V_10 = V_22 ;
V_4 . V_13 = 1 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
if ( V_7 ) {
...
V_29:
V_20 -> V_40 . V_22 = 1 ;
V_20 -> V_40 . V_41 [ 0 ] . V_42 = V_43 ;
F_22 ( & V_6 -> V_44 , F_6 ( 1000 ) ) ;
V_6 -> V_45 = true ;
return 0 ;
V_37:
F_21 ( V_25 ) ;
...
V_4 . args [ 4 ] = ( V_48 / 1000 ) & 0xff ;
V_4 . args [ 5 ] = ( ( V_48 / 1000 ) >> 8 ) & 0xff ;
V_4 . V_10 = 6 ;
V_4 . V_13 = 4 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
if ( V_7 )
...
{
struct V_5 * V_6 = F_28 ( V_60 , struct V_5 , V_44 . V_60 ) ;
...
int V_7 ;
F_9 ( & V_2 -> V_6 , L_3 ) ;
memcpy ( V_4 . args , L_24 , 2 ) ;
V_4 . V_10 = 2 ;
V_4 . V_13 = 12 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
if ( V_7 )
goto V_32;
V_20 -> V_40 . V_41 [ 0 ] . V_42 = V_61 ;
V_20 -> V_40 . V_41 [ 0 ] . V_62 = ( V_63 ) V_4 . args [ 3 ] * 1000 ;
F_22 ( & V_6 -> V_44 , F_6 ( 2000 ) ) ;
return;
V_32:
V_20 -> V_40 . V_41 [ 0 ] . V_42 = V_43 ;
F_9 ( & V_2 -> V_6 , L_2 , V_7 ) ;
