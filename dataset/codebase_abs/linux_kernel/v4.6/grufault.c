...
* V_35 = V_38 ;
#endif
if ( F_30 ( V_5 , 1 , V_34 , 0 , & V_36 , NULL ) <= 0 )
return - V_39 ;
* V_1 = F_31 ( V_36 ) ;
F_32 ( V_36 ) ;
return 0 ;
...
switch ( V_168 . V_178 ) {
case V_180 :
if ( V_168 . V_181 < - 1 || V_168 . V_181 >= V_182 ||
V_168 . V_179 < - 1 || V_168 . V_179 >= V_183 ||
( V_168 . V_179 >= 0 && ! V_118 [ V_168 . V_179 ] ) ) {
V_48 = - V_17 ;
} else {
V_14 -> V_184 = V_168 . V_179 ;
V_14 -> V_185 = V_168 . V_181 ;
F_85 ( V_14 ) ;
}
break;
case V_186 :
