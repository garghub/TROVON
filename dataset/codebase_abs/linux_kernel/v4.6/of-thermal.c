...
static void F_34 ( struct V_58 * V_59 , void * V_69 )
{
F_33 ( V_59 ,
* (struct V_1 * * ) V_69 ) ;
}
static int F_35 ( struct V_58 * V_59 , void * V_69 ,
void * V_5 )
{
struct V_1 * * V_20 = V_69 ;
if ( F_36 ( ! V_20 || ! * V_20 ) )
return 0 ;
return * V_20 == V_5 ;
}
...
{
struct V_1 * * V_70 , * V_55 ;
V_70 = F_38 ( F_34 , sizeof( * V_70 ) ,
V_71 ) ;
if ( ! V_70 )
return F_25 ( - V_72 ) ;
V_55 = F_26 ( V_59 , V_60 , V_5 , V_7 ) ;
if ( F_3 ( V_55 ) ) {
F_39 ( V_70 ) ;
return V_55 ;
}
...
static int F_43 ( struct V_51 * V_34 ,
struct V_30 * V_73 ,
struct V_14 * V_15 ,
int V_12 )
{
...
V_73 -> V_33 = V_74 . V_34 ;
if ( V_74 . V_67 >= 2 ) {
V_73 -> V_38 = V_74 . args [ 0 ] ;
V_73 -> V_37 = V_74 . args [ 1 ] ;
} else {
F_46 ( L_11 ) ;
}
V_77:
...
static int F_47 ( struct V_51 * V_34 ,
enum V_45 * type )
{
const char * V_78 ;
int V_79 , V_28 ;
V_79 = F_48 ( V_34 , L_12 , & V_78 ) ;
if ( V_79 < 0 )
return V_79 ;
for ( V_28 = 0 ; V_28 < F_49 ( V_80 ) ; V_28 ++ )
if ( ! strcasecmp ( V_78 , V_80 [ V_28 ] ) ) {
* type = V_28 ;
return 0 ;
}
return - V_11 ;
}
static int F_50 ( struct V_51 * V_34 ,
struct V_14 * V_13 )
{
int V_75 ;
int V_35 ;
V_35 = F_44 ( V_34 , L_13 , & V_75 ) ;
if ( V_35 < 0 ) {
F_46 ( L_14 ) ;
return V_35 ;
}
V_13 -> V_47 = V_75 ;
V_35 = F_44 ( V_34 , L_15 , & V_75 ) ;
if ( V_35 < 0 ) {
F_46 ( L_16 ) ;
return V_35 ;
}
...
static struct V_4
T_2 * F_51 ( struct V_51 * V_34 )
{
struct V_51 * V_61 = NULL , * V_81 ;
struct V_4 * V_2 ;
int V_35 , V_28 ;
T_1 V_75 , V_82 [ 2 ] ;
if ( ! V_34 ) {
...
if ( ! V_2 )
return F_25 ( - V_72 ) ;
V_35 = F_44 ( V_34 , L_19 , & V_75 ) ;
if ( V_35 < 0 ) {
F_46 ( L_20 ) ;
goto V_83;
}
V_2 -> V_84 = V_75 ;
V_35 = F_44 ( V_34 , L_21 , & V_75 ) ;
if ( V_35 < 0 ) {
F_46 ( L_22 ) ;
goto V_83;
}
V_2 -> V_44 = V_75 ;
V_35 = F_53 ( V_34 , L_23 , V_82 , 2 ) ;
if ( V_35 == 0 ) {
V_2 -> V_85 = V_82 [ 0 ] ;
V_2 -> V_86 = V_82 [ 1 ] ;
} else {
...
if ( V_2 -> V_12 == 0 )
goto V_87;
V_2 -> V_15 = F_52 ( V_2 -> V_12 * sizeof( * V_2 -> V_15 ) , V_71 ) ;
if ( ! V_2 -> V_15 ) {
V_35 = - V_72 ;
goto V_83;
}
...
if ( V_2 -> V_29 == 0 )
goto V_87;
V_2 -> V_32 = F_52 ( V_2 -> V_29 * sizeof( * V_2 -> V_32 ) , V_71 ) ;
if ( ! V_2 -> V_32 ) {
V_35 = - V_72 ;
goto V_88;
}
...
V_7 = F_62 ( & V_95 , sizeof( * V_7 ) , V_71 ) ;
if ( ! V_7 )
goto V_96;
V_93 = F_52 ( sizeof( * V_93 ) , V_71 ) ;
if ( ! V_93 ) {
F_57 ( V_7 ) ;
goto V_96;
}
V_93 -> V_97 = true ;
if ( ! F_44 ( V_61 , L_28 , & V_75 ) )
V_93 -> V_98 = V_75 ;
for ( V_28 = 0 ; V_28 < V_2 -> V_12 ; V_28 ++ )
V_94 |= 1 << V_28 ;
V_93 -> V_85 = V_2 -> V_85 ;
V_93 -> V_86 = V_2 -> V_86 ;
V_52 = F_63 ( V_61 -> V_56 , V_2 -> V_12 ,
V_94 , V_2 ,
V_7 , V_93 ,
V_2 -> V_84 ,
V_2 -> V_44 ) ;
