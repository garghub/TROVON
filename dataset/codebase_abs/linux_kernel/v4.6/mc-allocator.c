...
V_61 = & V_60 [ V_32 ] ;
V_61 -> V_10 . type = V_8 -> type ;
V_61 -> V_10 . V_25 = V_61 ;
V_61 -> V_10 . V_26 = V_8 ;
F_7 ( & V_61 -> V_10 . V_27 ) ;
F_8 ( & V_61 -> V_10 . V_27 , & V_8 -> V_28 ) ;
}
F_33 (msi_desc, &mc_bus_dev->dev) {
V_61 = & V_60 [ V_58 -> V_65 . V_66 ] ;
V_61 -> V_58 = V_58 ;
V_61 -> V_10 . V_24 = V_58 -> V_67 ;
}
V_8 -> V_19 = V_57 ;
V_8 -> V_20 = V_57 ;
V_2 -> V_60 = V_60 ;
...
V_69 = F_5 ( & V_6 -> V_21 , V_57 * sizeof( V_69 [ 0 ] ) ,
V_22 ) ;
if ( ! V_69 )
return - V_23 ;
for ( V_32 = 0 ; V_32 < V_57 ; V_32 ++ ) {
