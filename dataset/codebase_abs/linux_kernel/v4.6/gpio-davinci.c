...
static int F_38 ( struct V_5 * V_6 , unsigned V_70 )
{
if ( V_70 & ~ ( V_66 | V_67 ) )
return - V_44 ;
return 0 ;
...
{
unsigned int V_73 = F_40 ( V_72 ) ;
struct V_1 T_1 * V_7 ;
T_2 V_18 = 0xffff ;
struct V_14 * V_6 ;
V_6 = (struct V_14 * ) F_41 ( V_72 ) ;
...
struct V_14 * V_6 = F_5 ( V_10 ) ;
if ( V_6 -> V_76 )
return F_50 ( V_6 -> V_76 , V_6 -> V_10 . V_46 + V_11 ) ;
else
return - V_62 ;
}
...
static int F_52 ( struct V_5 * V_79 , unsigned V_70 )
{
struct V_14 * V_6 ;
struct V_1 T_1 * V_7 ;
T_2 V_18 ;
...
static int
F_54 ( struct V_76 * V_6 , unsigned int V_73 ,
T_3 V_80 )
{
...
L_7 ) ;
F_56 ( V_73 , V_83 ) ;
F_57 ( V_73 , ( V_8 void * ) V_7 ) ;
F_58 ( V_73 , ( void * ) F_53 ( V_80 ) ) ;
return 0 ;
}
static struct V_84 * F_59 ( unsigned int V_73 )
{
static struct V_85 V_38 ;
V_38 = * F_60 ( F_61 ( V_73 ) ) ;
return & V_38 . V_10 ;
}
static struct V_84 * F_62 ( unsigned int V_73 )
{
...
F_69 ( V_87 ) ;
if ( ! V_31 -> V_38 ) {
V_73 = F_70 ( - 1 , 0 , V_37 , 0 ) ;
if ( V_73 < 0 ) {
F_19 ( V_29 , L_11 ) ;
return V_73 ;
}
V_76 = F_71 ( V_29 -> V_30 , V_37 , V_73 , 0 ,
& V_98 ,
V_42 ) ;
if ( ! V_76 ) {
F_19 ( V_29 , L_12 ) ;
...
F_8 ( ~ 0 , & V_7 -> V_68 ) ;
F_8 ( ~ 0 , & V_7 -> V_69 ) ;
for ( V_2 = 0 ; V_2 < V_31 -> V_38 ; V_2 ++ , V_73 ++ ) {
F_73 ( V_73 , V_84 ) ;
F_58 ( V_73 , & V_42 [ V_2 / 32 ] ) ;
F_74 ( V_73 , V_102 ) ;
}
goto V_103;
}
