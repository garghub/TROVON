...
struct V_47 * V_47 ;
int V_9 ;
V_2 = F_23 ( & V_42 -> V_35 , sizeof( * V_2 ) , V_48 ) ;
if ( ! V_2 )
return - V_49 ;
V_46 . V_50 = & V_51 ;
V_46 . V_52 = 0 ;
...
V_2 -> V_32 . V_46 = & V_46 ;
V_2 -> V_34 = V_42 ;
if ( F_24 ( V_42 -> V_35 . V_54 , L_2 ,
& V_46 . V_55 ) )
V_46 . V_55 = V_42 -> V_35 . V_54 -> V_55 ;
V_2 -> V_4 = F_25 ( V_42 , & V_56 ) ;
if ( F_26 ( V_2 -> V_4 ) ) {
F_16 ( & V_42 -> V_35 , L_3 ) ;
return F_27 ( V_2 -> V_4 ) ;
}
F_28 ( V_42 , V_2 ) ;
V_47 = F_29 ( & V_42 -> V_35 , & V_2 -> V_32 ) ;
if ( F_26 ( V_47 ) ) {
F_16 ( & V_42 -> V_35 , L_4 ) ;
return F_27 ( V_47 ) ;
}
V_9 = F_30 ( V_42 -> V_35 . V_54 , V_57 ,
V_47 ) ;
if ( V_9 ) {
F_16 ( & V_42 -> V_35 , L_5 ) ;
return V_9 ;
