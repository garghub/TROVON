...
T_5 int F_58 ( unsigned long V_50 , unsigned long V_51 ,
unsigned long V_52 , unsigned long V_53 )
{
int V_57 = 0 ;
unsigned long V_7 ;
...
F_62 () ;
if ( V_63 ) {
if ( V_63 > 1 && V_63 <= V_12 . V_15 ) {
int V_54 = V_12 . V_15 - V_63 ;
F_55 ( V_54 ) ;
F_12 ( V_54 - 1 ) ;
F_59 ( L_4 , V_63 ) ;
} else
...
static int F_68 ( struct V_72 * V_73 , unsigned long V_74 ,
void * V_75 )
{
switch ( V_74 ) {
case V_76 :
