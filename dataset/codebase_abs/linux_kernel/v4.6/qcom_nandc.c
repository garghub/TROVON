...
V_182 = V_133 -> V_62 - ( ( V_133 -> V_136 - 1 ) << 2 ) ;
V_183 = V_133 -> V_136 << 2 ;
V_196 = V_133 -> V_197 -> V_198 [ 0 ] . V_7 ;
memcpy ( V_6 -> V_117 + V_182 , V_195 + V_196 , V_183 ) ;
F_11 ( V_43 , V_43 -> V_187 * ( V_133 -> V_136 - 1 ) , V_45 ) ;
F_12 ( V_43 , 1 , false ) ;
F_27 ( V_6 ) ;
...
V_3 -> V_200 ( V_147 , V_135 , - 1 , - 1 ) ;
V_139 = V_3 -> V_201 ( V_147 , V_3 ) ;
return V_139 & V_143 ? - V_199 : 0 ;
}
static int F_64 ( struct V_146 * V_147 , T_7 V_202 )
{
struct V_2 * V_3 = F_47 ( V_147 ) ;
struct V_1 * V_43 = F_1 ( V_3 ) ;
struct V_4 * V_6 = F_3 ( V_3 ) ;
struct V_132 * V_133 = & V_3 -> V_133 ;
int V_45 , V_74 , V_203 , V_204 = 0 ;
T_1 V_137 ;
V_45 = ( int ) ( V_202 >> V_3 -> V_205 ) & V_3 -> V_206 ;
V_43 -> V_50 = false ;
V_74 = F_57 ( V_43 , V_45 ) ;
if ( V_74 )
goto V_83;
...
V_203 = V_147 -> V_194 - V_43 -> V_187 * ( V_133 -> V_136 - 1 ) ;
V_204 = V_6 -> V_117 [ V_203 ] != 0xff ;
if ( V_3 -> V_46 & V_47 )
V_204 = V_204 || ( V_6 -> V_117 [ V_203 + 1 ] != 0xff ) ;
V_83:
return V_204 ;
}
static int F_66 ( struct V_146 * V_147 , T_7 V_202 )
{
struct V_2 * V_3 = F_47 ( V_147 ) ;
struct V_1 * V_43 = F_1 ( V_3 ) ;
struct V_4 * V_6 = F_3 ( V_3 ) ;
...
static T_6 F_67 ( struct V_146 * V_147 )
{
struct V_2 * V_3 = F_47 ( V_147 ) ;
struct V_1 * V_43 = F_1 ( V_3 ) ;
struct V_4 * V_6 = F_3 ( V_3 ) ;
...
static void F_68 ( struct V_146 * V_147 , T_6 * V_161 , int V_208 )
{
struct V_2 * V_3 = F_47 ( V_147 ) ;
struct V_4 * V_6 = F_3 ( V_3 ) ;
int V_209 = F_69 ( V_210 , V_208 , V_6 -> V_116 - V_6 -> V_130 ) ;
memcpy ( V_161 , V_6 -> V_117 + V_6 -> V_130 , V_209 ) ;
V_6 -> V_130 += V_209 ;
}
static void F_70 ( struct V_146 * V_147 , const T_6 * V_161 ,
int V_208 )
{
struct V_2 * V_3 = F_47 ( V_147 ) ;
struct V_4 * V_6 = F_3 ( V_3 ) ;
int V_209 = F_69 ( V_210 , V_208 , V_6 -> V_116 - V_6 -> V_130 ) ;
memcpy ( V_6 -> V_117 + V_6 -> V_130 , V_161 , V_209 ) ;
V_6 -> V_130 += V_209 ;
}
static void F_71 ( struct V_146 * V_147 , int V_211 )
{
struct V_2 * V_3 = F_47 ( V_147 ) ;
struct V_4 * V_6 = F_3 ( V_3 ) ;
if ( V_211 <= 0 )
...
struct V_132 * V_133 = & V_3 -> V_133 ;
struct V_212 * V_197 ;
int V_134 , V_185 , V_136 , V_213 = 0 , V_214 = 0 ;
V_197 = F_73 ( V_6 -> V_82 , sizeof( * V_197 ) , V_75 ) ;
if ( ! V_197 )
return NULL ;
V_136 = V_147 -> V_194 / V_133 -> V_62 ;
V_197 -> V_215 = V_136 * V_133 -> V_170 ;
V_197 -> V_198 [ 0 ] . V_7 = ( V_136 - 1 ) * V_133 -> V_170 + V_43 -> V_186 ;
V_197 -> V_198 [ 0 ] . V_216 = V_136 << 2 ;
for ( V_134 = 0 ; V_134 < V_136 - 1 ; V_134 ++ ) {
for ( V_185 = 0 ; V_185 < V_133 -> V_170 ; V_185 ++ )
V_197 -> V_217 [ V_213 ++ ] = V_134 * V_133 -> V_170 + V_185 ;
}
for ( V_185 = 0 ; V_185 < V_43 -> V_186 ; V_185 ++ )
V_197 -> V_217 [ V_213 ++ ] = V_134 * V_133 -> V_170 + V_185 ;
V_214 = V_197 -> V_198 [ 0 ] . V_216 + V_43 -> V_186 ;
for ( V_185 = 0 ; V_185 < ( V_43 -> V_175 + V_43 -> V_184 ) ; V_185 ++ )
V_197 -> V_217 [ V_213 ++ ] = V_134 * V_133 -> V_170 + V_214 + V_185 ;
return V_197 ;
}
static int F_74 ( struct V_1 * V_43 )
{
struct V_2 * V_3 = & V_43 -> V_3 ;
struct V_146 * V_147 = F_52 ( V_3 ) ;
struct V_132 * V_133 = & V_3 -> V_133 ;
...
V_220 = V_3 -> V_46 & V_47 ? true : false ;
if ( V_133 -> V_176 >= 8 ) {
V_43 -> V_168 = true ;
V_221 = 1 ;
if ( V_220 ) {
...
V_133 -> V_230 = F_63 ;
V_133 -> V_231 = V_232 ;
V_133 -> V_197 = F_72 ( V_43 ) ;
if ( ! V_133 -> V_197 )
return - V_76 ;
V_218 = V_147 -> V_194 / V_133 -> V_62 ;
V_43 -> V_166 = 516 ;
V_43 -> V_187 = V_43 -> V_166 + V_133 -> V_170 ;
if ( V_133 -> V_170 * ( V_147 -> V_194 / V_133 -> V_62 ) > V_147 -> V_233 ) {
F_18 ( V_6 -> V_82 , L_17 ) ;
return - V_94 ;
}
V_219 = V_147 -> V_194 - V_43 -> V_187 * ( V_218 - 1 ) + 1 ;
V_43 -> V_25 = ( V_218 - 1 ) << V_56
| V_43 -> V_166 << V_103
| 0 << V_234
| 5 << V_104
| V_43 -> V_175 << V_235
...
static int F_76 ( struct V_4 * V_6 )
{
int V_74 ;
V_74 = F_77 ( V_6 -> V_82 , F_78 ( 32 ) ) ;
if ( V_74 ) {
F_18 ( V_6 -> V_82 , L_19 ) ;
return V_74 ;
}
V_6 -> V_246 = 532 ;
V_6 -> V_117 = F_73 ( V_6 -> V_82 , V_6 -> V_246 ,
V_75 ) ;
if ( ! V_6 -> V_117 )
return - V_76 ;
V_6 -> V_11 = F_73 ( V_6 -> V_82 , sizeof( * V_6 -> V_11 ) ,
V_75 ) ;
if ( ! V_6 -> V_11 )
return - V_76 ;
V_6 -> V_100 = F_73 ( V_6 -> V_82 ,
V_128 * sizeof( * V_6 -> V_100 ) ,
V_75 ) ;
if ( ! V_6 -> V_100 )
return - V_76 ;
V_6 -> V_93 = F_79 ( V_6 -> V_82 , L_20 ) ;
if ( ! V_6 -> V_93 ) {
F_18 ( V_6 -> V_82 , L_21 ) ;
return - V_247 ;
}
...
static void F_83 ( struct V_4 * V_6 )
{
F_84 ( V_6 -> V_93 ) ;
}
static int F_85 ( struct V_4 * V_6 )
{
F_6 ( V_6 , V_251 , 0 ) ;
F_6 ( V_6 , V_18 , V_122 ) ;
...
static int F_86 ( struct V_4 * V_6 ,
struct V_1 * V_43 ,
struct V_252 * V_253 )
{
struct V_2 * V_3 = & V_43 -> V_3 ;
struct V_146 * V_147 = F_52 ( V_3 ) ;
struct V_254 * V_82 = V_6 -> V_82 ;
int V_74 ;
V_74 = F_87 ( V_253 , L_22 , & V_43 -> V_255 ) ;
if ( V_74 ) {
F_18 ( V_82 , L_23 ) ;
return - V_256 ;
}
F_88 ( V_3 , V_253 ) ;
V_147 -> V_257 = F_89 ( V_82 , V_75 , L_24 , V_43 -> V_255 ) ;
V_147 -> V_258 = V_259 ;
V_147 -> V_82 . V_260 = V_82 ;
V_3 -> V_200 = F_46 ;
V_3 -> V_261 = F_71 ;
V_3 -> V_262 = F_67 ;
V_3 -> V_263 = F_68 ;
...
V_3 -> V_266 = F_66 ;
V_3 -> V_5 = & V_6 -> V_5 ;
V_3 -> V_46 |= V_267 | V_268 |
V_269 ;
V_43 -> V_139 = V_207 | V_140 ;
V_74 = F_90 ( V_147 , 1 , NULL ) ;
if ( V_74 )
return V_74 ;
V_74 = F_74 ( V_43 ) ;
if ( V_74 )
...
if ( V_74 )
return V_74 ;
return F_92 ( V_147 , NULL , 0 ) ;
}
static int F_93 ( struct V_270 * V_271 )
{
struct V_4 * V_6 = F_94 ( V_271 ) ;
struct V_252 * V_272 = V_6 -> V_82 -> V_273 ;
int V_74 ;
V_74 = F_87 ( V_272 , L_25 , & V_6 -> V_92 ) ;
if ( V_74 ) {
F_18 ( V_6 -> V_82 , L_26 ) ;
return V_74 ;
}
V_74 = F_87 ( V_272 , L_27 , & V_6 -> V_89 ) ;
if ( V_74 ) {
F_18 ( V_6 -> V_82 , L_28 ) ;
return V_74 ;
}
...
static int F_95 ( struct V_270 * V_271 )
{
struct V_4 * V_6 ;
struct V_1 * V_43 ;
const void * V_274 ;
struct V_254 * V_82 = & V_271 -> V_82 ;
struct V_252 * V_253 = V_82 -> V_273 , * V_275 ;
struct V_276 * V_277 ;
int V_74 ;
V_6 = F_73 ( & V_271 -> V_82 , sizeof( * V_6 ) , V_75 ) ;
if ( ! V_6 )
return - V_76 ;
F_96 ( V_271 , V_6 ) ;
V_6 -> V_82 = V_82 ;
V_274 = F_97 ( V_82 ) ;
if ( ! V_274 ) {
F_18 ( & V_271 -> V_82 , L_29 ) ;
return - V_247 ;
}
V_6 -> V_223 = ( unsigned long ) V_274 ;
V_277 = F_98 ( V_271 , V_278 , 0 ) ;
V_6 -> V_8 = F_99 ( V_82 , V_277 ) ;
if ( F_100 ( V_6 -> V_8 ) )
return F_101 ( V_6 -> V_8 ) ;
V_6 -> V_87 = F_102 ( V_82 , ( V_279 ) V_277 -> V_280 ) ;
V_6 -> V_281 = F_103 ( V_82 , L_30 ) ;
if ( F_100 ( V_6 -> V_281 ) )
return F_101 ( V_6 -> V_281 ) ;
V_6 -> V_282 = F_103 ( V_82 , L_31 ) ;
if ( F_100 ( V_6 -> V_282 ) )
return F_101 ( V_6 -> V_282 ) ;
V_74 = F_93 ( V_271 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_76 ( V_6 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_104 ( V_6 -> V_281 ) ;
if ( V_74 )
goto V_283;
V_74 = F_104 ( V_6 -> V_282 ) ;
if ( V_74 )
goto V_284;
V_74 = F_85 ( V_6 ) ;
if ( V_74 )
...
F_105 (dn, child) {
if ( F_106 ( V_275 , L_32 ) ) {
V_43 = F_73 ( V_82 , sizeof( * V_43 ) , V_75 ) ;
if ( ! V_43 ) {
F_107 ( V_275 ) ;
V_74 = - V_76 ;
goto V_286;
}
V_74 = F_86 ( V_6 , V_43 , V_275 ) ;
if ( V_74 ) {
F_108 ( V_82 , V_43 ) ;
continue;
}
F_20 ( & V_43 -> V_95 , & V_6 -> V_248 ) ;
}
}
if ( F_109 ( & V_6 -> V_248 ) ) {
V_74 = - V_247 ;
...
static int F_112 ( struct V_270 * V_271 )
{
struct V_4 * V_6 = F_94 ( V_271 ) ;
struct V_1 * V_43 ;
F_34 (host, &nandc->host_list, node)
