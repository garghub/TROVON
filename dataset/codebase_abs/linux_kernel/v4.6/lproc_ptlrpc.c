...
if ( F_83 ( V_36 -> V_207 ) )
return;
F_84 ( V_36 -> V_207 , V_189 , NULL ) ;
V_17 = F_85 ( V_36 -> V_207 , L_46 ,
0400 , & V_197 , V_36 ) ;
if ( V_17 )
F_51 ( L_47 ) ;
}
void F_86 ( struct V_209 * V_210 )
{
F_6 ( V_210 -> V_211 , NULL , L_45 ,
& V_210 -> V_212 ,
& V_210 -> V_213 ) ;
}
void F_87 ( struct V_130 * V_131 , long V_214 )
{
struct V_12 * V_15 ;
T_1 V_215 = F_88 ( V_131 -> V_216 ) ;
int V_217 = F_2 ( V_215 ) ;
...
F_89 ( V_15 , V_217 + V_21 , V_214 ) ;
}
void F_90 ( struct V_130 * V_131 , int V_222 )
{
struct V_12 * V_15 ;
int V_223 ;
if ( ! V_131 -> V_218 )
