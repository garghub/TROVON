...
{
const T_7 V_479 [] = { V_480 , 0x01 , 0x00 } ;
struct V_10 * V_11 ;
V_11 = F_250 ( 3 , V_481 ) ;
if ( ! V_11 )
return - V_219 ;
F_251 ( V_11 ) = V_482 ;
memcpy ( F_252 ( V_11 , 3 ) , V_479 , 3 ) ;
return F_253 ( V_6 , V_11 ) ;
}
int F_253 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
...
F_254 ( V_11 ) -> V_486 = 1 ;
F_255 ( V_11 ) ;
F_256 ( & V_6 -> V_244 , V_11 ) ;
F_187 ( V_6 -> V_267 , & V_6 -> V_242 ) ;
return 0 ;
}
int F_257 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
F_251 ( V_11 ) = V_487 ;
F_255 ( V_11 ) ;
F_256 ( & V_6 -> V_244 , V_11 ) ;
...
int F_258 ( struct V_488 * V_489 )
{
F_23 ( L_32 , V_489 , V_489 -> V_36 ) ;
F_259 ( & V_490 ) ;
F_260 ( & V_489 -> V_171 , & V_491 ) ;
F_261 ( & V_490 ) ;
return 0 ;
}
int F_262 ( struct V_488 * V_489 )
{
F_23 ( L_32 , V_489 , V_489 -> V_36 ) ;
F_259 ( & V_490 ) ;
F_86 ( & V_489 -> V_171 ) ;
...
static void F_263 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
int V_24 ;
F_23 ( L_33 , V_6 -> V_36 , F_251 ( V_11 ) ,
V_11 -> V_492 ) ;
F_255 ( V_11 ) ;
F_264 ( V_6 , V_11 ) ;
if ( F_265 ( & V_6 -> V_493 ) ) {
...
int F_268 ( struct V_5 * V_6 , T_11 V_371 , T_13 V_494 ,
const void * V_54 )
{
struct V_10 * V_11 ;
F_23 ( L_35 , V_6 -> V_36 , V_371 , V_494 ) ;
V_11 = F_269 ( V_6 , V_371 , V_494 , V_54 ) ;
if ( ! V_11 ) {
F_30 ( L_36 , V_6 -> V_36 ) ;
return - V_219 ;
}
F_254 ( V_11 ) -> V_495 . V_496 |= V_497 ;
F_256 ( & V_6 -> V_243 , V_11 ) ;
F_187 ( V_6 -> V_267 , & V_6 -> V_241 ) ;
return 0 ;
}
void * F_270 ( struct V_5 * V_6 , T_11 V_371 )
{
struct V_369 * V_498 ;
if ( ! V_6 -> V_246 )
return NULL ;
V_498 = ( void * ) V_6 -> V_246 -> V_166 ;
if ( V_498 -> V_371 != F_32 ( V_371 ) )
return NULL ;
F_23 ( L_37 , V_6 -> V_36 , V_371 ) ;
return V_6 -> V_246 -> V_166 + V_499 ;
}
struct V_10 * F_271 ( struct V_5 * V_6 , T_8 V_371 , T_10 V_494 ,
const void * V_54 , T_10 V_391 )
{
struct V_10 * V_11 ;
if ( ! F_6 ( V_14 , & V_6 -> V_15 ) )
return F_272 ( - V_16 ) ;
F_273 ( V_6 , L_38 , V_371 , V_494 ) ;
F_9 ( V_6 ) ;
V_11 = F_10 ( V_6 , V_371 , V_494 , V_54 , V_391 ) ;
F_11 ( V_6 ) ;
return V_11 ;
}
static void F_274 ( struct V_10 * V_11 , T_11 V_500 , T_11 V_15 )
{
struct V_501 * V_498 ;
int V_492 = V_11 -> V_492 ;
F_275 ( V_11 , V_502 ) ;
F_276 ( V_11 ) ;
V_498 = (struct V_501 * ) F_277 ( V_11 ) ;
V_498 -> V_500 = F_32 ( F_278 ( V_500 , V_15 ) ) ;
V_498 -> V_503 = F_32 ( V_492 ) ;
}
static void F_279 ( struct V_504 * V_505 , struct V_506 * V_507 ,
struct V_10 * V_11 , T_11 V_15 )
{
struct V_334 * V_256 = V_505 -> V_256 ;
struct V_5 * V_6 = V_256 -> V_6 ;
struct V_10 * V_171 ;
V_11 -> V_492 = F_280 ( V_11 ) ;
V_11 -> V_508 = 0 ;
F_251 ( V_11 ) = V_484 ;
switch ( V_6 -> V_51 ) {
case V_52 :
F_274 ( V_11 , V_256 -> V_500 , V_15 ) ;
break;
case V_53 :
F_274 ( V_11 , V_505 -> V_500 , V_15 ) ;
break;
default:
F_30 ( L_39 , V_6 -> V_36 , V_6 -> V_51 ) ;
return;
}
V_171 = F_281 ( V_11 ) -> V_509 ;
if ( ! V_171 ) {
F_23 ( L_40 , V_6 -> V_36 , V_11 , V_11 -> V_492 ) ;
F_256 ( V_507 , V_11 ) ;
} else {
F_23 ( L_41 , V_6 -> V_36 , V_11 , V_11 -> V_492 ) ;
F_281 ( V_11 ) -> V_509 = NULL ;
F_282 ( & V_507 -> V_450 ) ;
F_283 ( V_507 , V_11 ) ;
V_15 &= ~ V_510 ;
V_15 |= V_511 ;
do {
V_11 = V_171 ; V_171 = V_171 -> V_512 ;
F_251 ( V_11 ) = V_484 ;
F_274 ( V_11 , V_256 -> V_500 , V_15 ) ;
F_23 ( L_41 , V_6 -> V_36 , V_11 , V_11 -> V_492 ) ;
F_283 ( V_507 , V_11 ) ;
...
void F_285 ( struct V_504 * V_505 , struct V_10 * V_11 , T_11 V_15 )
{
struct V_5 * V_6 = V_505 -> V_256 -> V_6 ;
F_23 ( L_42 , V_6 -> V_36 , V_505 , V_15 ) ;
F_279 ( V_505 , & V_505 -> V_513 , V_11 , V_15 ) ;
F_187 ( V_6 -> V_267 , & V_6 -> V_240 ) ;
}
void F_286 ( struct V_334 * V_256 , struct V_10 * V_11 )
{
struct V_5 * V_6 = V_256 -> V_6 ;
struct V_514 V_498 ;
F_23 ( L_43 , V_6 -> V_36 , V_11 -> V_492 ) ;
V_498 . V_500 = F_32 ( V_256 -> V_500 ) ;
V_498 . V_503 = V_11 -> V_492 ;
F_275 ( V_11 , V_515 ) ;
F_276 ( V_11 ) ;
memcpy ( F_277 ( V_11 ) , & V_498 , V_515 ) ;
F_251 ( V_11 ) = V_485 ;
F_256 ( & V_256 -> V_513 , V_11 ) ;
F_187 ( V_6 -> V_267 , & V_6 -> V_240 ) ;
}
static struct V_334 * F_287 ( struct V_5 * V_6 , T_6 type ,
int * V_516 )
{
struct V_517 * V_518 = & V_6 -> V_459 ;
struct V_334 * V_256 = NULL , * V_519 ;
unsigned int V_187 = 0 , F_5 = ~ 0 ;
F_167 () ;
F_161 (c, &h->list, list) {
if ( V_519 -> type != type || F_288 ( & V_519 -> V_513 ) )
continue;
if ( V_519 -> V_152 != V_520 && V_519 -> V_152 != V_521 )
continue;
V_187 ++ ;
if ( V_519 -> V_370 < F_5 ) {
F_5 = V_519 -> V_370 ;
...
break;
case V_339 :
V_522 = V_6 -> V_314 ? V_6 -> V_275 : V_6 -> V_273 ;
break;
default:
V_522 = 0 ;
F_30 ( L_44 ) ;
...
* V_516 = 0 ;
F_23 ( L_45 , V_256 , * V_516 ) ;
return V_256 ;
}
static void F_290 ( struct V_5 * V_6 , T_6 type )
{
struct V_517 * V_518 = & V_6 -> V_459 ;
struct V_334 * V_519 ;
F_30 ( L_46 , V_6 -> V_36 ) ;
F_167 () ;
F_161 (c, &h->list, list) {
if ( V_519 -> type == type && V_519 -> V_370 ) {
F_30 ( L_47 ,
V_6 -> V_36 , & V_519 -> V_527 ) ;
F_291 ( V_519 , V_528 ) ;
}
}
F_168 () ;
}
static struct V_504 * F_292 ( struct V_5 * V_6 , T_6 type ,
int * V_516 )
{
struct V_517 * V_518 = & V_6 -> V_459 ;
struct V_504 * V_505 = NULL ;
unsigned int V_187 = 0 , F_5 = ~ 0 , V_529 = 0 ;
struct V_334 * V_256 ;
...
if ( V_256 -> type != type )
continue;
if ( V_256 -> V_152 != V_520 && V_256 -> V_152 != V_521 )
continue;
V_530 ++ ;
F_161 (tmp, &conn->chan_list, list) {
struct V_10 * V_11 ;
if ( F_288 ( & V_327 -> V_513 ) )
continue;
V_11 = F_293 ( & V_327 -> V_513 ) ;
if ( V_11 -> V_531 < V_529 )
continue;
if ( V_11 -> V_531 > V_529 ) {
V_187 = 0 ;
...
if ( F_289 ( V_6 , type ) == V_530 )
break;
}
F_168 () ;
if ( ! V_505 )
return NULL ;
switch ( V_505 -> V_256 -> type ) {
case V_524 :
V_522 = V_6 -> V_273 ;
break;
case V_532 :
...
if ( F_288 ( & V_505 -> V_513 ) )
continue;
V_11 = F_293 ( & V_505 -> V_513 ) ;
if ( V_11 -> V_531 >= V_534 - 1 )
continue;
V_11 -> V_531 = V_534 - 1 ;
F_23 ( L_49 , V_505 , V_11 ,
V_11 -> V_531 ) ;
}
if ( F_289 ( V_6 , type ) == V_187 )
break;
...
static inline int F_295 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
return F_296 ( V_11 -> V_492 - V_502 , V_6 -> V_535 ) ;
}
static void F_297 ( struct V_5 * V_6 , unsigned int V_522 )
{
if ( ! F_2 ( V_6 , V_213 ) ) {
if ( ! V_522 && F_298 ( V_186 , V_6 -> V_536 +
V_537 ) )
F_290 ( V_6 , V_524 ) ;
}
}
...
{
unsigned int V_522 = V_6 -> V_273 ;
struct V_504 * V_505 ;
struct V_10 * V_11 ;
int V_516 ;
F_297 ( V_6 , V_522 ) ;
while ( V_6 -> V_273 &&
( V_505 = F_292 ( V_6 , V_524 , & V_516 ) ) ) {
T_10 V_531 = ( F_293 ( & V_505 -> V_513 ) ) -> V_531 ;
while ( V_516 -- && ( V_11 = F_293 ( & V_505 -> V_513 ) ) ) {
F_23 ( L_50 , V_505 , V_11 ,
V_11 -> V_492 , V_11 -> V_531 ) ;
if ( V_11 -> V_531 < V_531 )
break;
V_11 = F_300 ( & V_505 -> V_513 ) ;
F_301 ( V_505 -> V_256 ,
F_254 ( V_11 ) -> V_538 ) ;
F_263 ( V_6 , V_11 ) ;
V_6 -> V_536 = V_186 ;
...
type = V_524 ;
while ( V_6 -> V_533 > 0 &&
( V_505 = F_292 ( V_6 , type , & V_516 ) ) ) {
T_10 V_531 = ( F_293 ( & V_505 -> V_513 ) ) -> V_531 ;
while ( V_516 > 0 && ( V_11 = F_293 ( & V_505 -> V_513 ) ) ) {
int V_539 ;
F_23 ( L_50 , V_505 , V_11 ,
V_11 -> V_492 , V_11 -> V_531 ) ;
if ( V_11 -> V_531 < V_531 )
...
{
F_23 ( L_11 , V_6 -> V_36 ) ;
if ( ! F_289 ( V_6 , V_524 ) && V_6 -> V_51 == V_52 )
return;
if ( ! F_289 ( V_6 , V_532 ) && V_6 -> V_51 == V_53 )
return;
switch ( V_6 -> V_38 ) {
case V_39 :
F_299 ( V_6 ) ;
...
if ( ! F_289 ( V_6 , V_525 ) )
return;
while ( V_6 -> V_274 && ( V_256 = F_287 ( V_6 , V_525 , & V_516 ) ) ) {
while ( V_516 -- && ( V_11 = F_300 ( & V_256 -> V_513 ) ) ) {
F_23 ( L_51 , V_11 , V_11 -> V_492 ) ;
F_263 ( V_6 , V_11 ) ;
V_256 -> V_370 ++ ;
if ( V_256 -> V_370 == ~ 0 )
V_256 -> V_370 = 0 ;
...
if ( ! F_289 ( V_6 , V_526 ) )
return;
while ( V_6 -> V_274 && ( V_256 = F_287 ( V_6 , V_526 ,
& V_516 ) ) ) {
while ( V_516 -- && ( V_11 = F_300 ( & V_256 -> V_513 ) ) ) {
F_23 ( L_51 , V_11 , V_11 -> V_492 ) ;
F_263 ( V_6 , V_11 ) ;
...
struct V_504 * V_505 ;
struct V_10 * V_11 ;
int V_516 , V_522 , V_327 ;
F_23 ( L_11 , V_6 -> V_36 ) ;
if ( ! F_289 ( V_6 , V_339 ) )
return;
if ( ! F_2 ( V_6 , V_213 ) ) {
if ( ! V_6 -> V_275 && V_6 -> V_315 &&
F_298 ( V_186 , V_6 -> V_540 + V_541 * 45 ) )
F_290 ( V_6 , V_339 ) ;
}
V_522 = V_6 -> V_315 ? V_6 -> V_275 : V_6 -> V_273 ;
V_327 = V_522 ;
while ( V_522 && ( V_505 = F_292 ( V_6 , V_339 , & V_516 ) ) ) {
T_10 V_531 = ( F_293 ( & V_505 -> V_513 ) ) -> V_531 ;
while ( V_516 -- && ( V_11 = F_293 ( & V_505 -> V_513 ) ) ) {
F_23 ( L_50 , V_505 , V_11 ,
V_11 -> V_492 , V_11 -> V_531 ) ;
...
while ( ( V_11 = F_300 ( & V_6 -> V_269 ) ) )
F_263 ( V_6 , V_11 ) ;
}
static void F_307 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
struct V_501 * V_498 = ( void * ) V_11 -> V_166 ;
struct V_334 * V_256 ;
T_11 V_500 , V_15 ;
F_308 ( V_11 , V_502 ) ;
V_500 = F_186 ( V_498 -> V_500 ) ;
V_15 = F_309 ( V_500 ) ;
V_500 = F_310 ( V_500 ) ;
F_23 ( L_53 , V_6 -> V_36 , V_11 -> V_492 ,
V_500 , V_15 ) ;
V_6 -> V_276 . V_542 ++ ;
F_101 ( V_6 ) ;
V_256 = F_311 ( V_6 , V_500 ) ;
F_104 ( V_6 ) ;
if ( V_256 ) {
F_301 ( V_256 , V_543 ) ;
F_312 ( V_256 , V_11 , V_15 ) ;
return;
} else {
F_30 ( L_54 ,
V_6 -> V_36 , V_500 ) ;
...
static void F_313 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
struct V_514 * V_498 = ( void * ) V_11 -> V_166 ;
struct V_334 * V_256 ;
T_11 V_500 ;
F_308 ( V_11 , V_515 ) ;
V_500 = F_186 ( V_498 -> V_500 ) ;
F_23 ( L_55 , V_6 -> V_36 , V_11 -> V_492 , V_500 ) ;
V_6 -> V_276 . V_544 ++ ;
F_101 ( V_6 ) ;
V_256 = F_311 ( V_6 , V_500 ) ;
F_104 ( V_6 ) ;
...
static bool F_315 ( struct V_5 * V_6 )
{
struct V_10 * V_11 ;
V_11 = F_293 ( & V_6 -> V_243 ) ;
if ( ! V_11 )
return true ;
return ( F_254 ( V_11 ) -> V_495 . V_496 & V_497 ) ;
}
static void F_316 ( struct V_5 * V_6 )
{
struct V_369 * V_370 ;
struct V_10 * V_11 ;
T_8 V_371 ;
...
if ( V_371 == V_22 )
return;
V_11 = F_317 ( V_6 -> V_246 , V_181 ) ;
if ( ! V_11 )
return;
F_318 ( & V_6 -> V_243 , V_11 ) ;
F_187 ( V_6 -> V_267 , & V_6 -> V_241 ) ;
}
void F_319 ( struct V_5 * V_6 , T_8 V_371 , T_7 V_545 ,
T_14 * V_546 ,
T_15 * V_547 )
{
struct V_10 * V_11 ;
unsigned long V_15 ;
F_23 ( L_57 , V_371 , V_545 ) ;
if ( ! F_270 ( V_6 , V_371 ) ) {
...
if ( ! V_545 && ! F_315 ( V_6 ) )
return;
if ( F_254 ( V_6 -> V_246 ) -> V_495 . V_496 & V_548 ) {
* V_547 = F_254 ( V_6 -> V_246 ) -> V_495 . V_547 ;
return;
}
if ( F_254 ( V_6 -> V_246 ) -> V_495 . V_546 ) {
* V_546 = F_254 ( V_6 -> V_246 ) -> V_495 . V_546 ;
return;
}
F_320 ( & V_6 -> V_243 . V_450 , V_15 ) ;
while ( ( V_11 = F_321 ( & V_6 -> V_243 ) ) ) {
if ( F_254 ( V_11 ) -> V_495 . V_496 & V_497 ) {
F_322 ( & V_6 -> V_243 , V_11 ) ;
break;
}
if ( F_254 ( V_11 ) -> V_495 . V_496 & V_548 )
* V_547 = F_254 ( V_11 ) -> V_495 . V_547 ;
else
* V_546 = F_254 ( V_11 ) -> V_495 . V_546 ;
F_14 ( V_11 ) ;
}
F_323 ( & V_6 -> V_243 . V_450 , V_15 ) ;
}
...
struct V_10 * V_11 ;
F_23 ( L_61 , V_6 -> V_36 ,
F_265 ( & V_6 -> V_229 ) , F_325 ( & V_6 -> V_243 ) ) ;
if ( F_265 ( & V_6 -> V_229 ) ) {
V_11 = F_300 ( & V_6 -> V_243 ) ;
if ( ! V_11 )
return;
F_14 ( V_6 -> V_246 ) ;
V_6 -> V_246 = F_317 ( V_11 , V_181 ) ;
if ( V_6 -> V_246 ) {
F_326 ( & V_6 -> V_229 ) ;
F_263 ( V_6 , V_11 ) ;
