...
static struct V_18 * F_75 ( T_7 V_128 )
{
struct V_18 * V_129 ;
int V_69 ;
V_129 = F_31 ( sizeof( struct V_18 ) , V_87 ) ;
if ( ! V_129 )
return NULL ;
F_32 ( & V_89 ) ;
V_69 = F_76 ( V_129 , V_128 ) ;
F_36 ( & V_89 ) ;
if ( ! V_69 ) {
return V_129 ;
} else {
...
static void * F_77 ( struct V_130 * V_131 , T_7 * V_128 )
{
if ( * V_128 == 0 ) {
++ * V_128 ;
F_78 ( V_131 , L_23 ) ;
...
static void * F_79 ( struct V_130 * V_131 , void * V_132 , T_7 * V_128 )
{
++ * V_128 ;
return F_75 ( * V_128 ) ;
}
static void F_80 ( struct V_130 * V_131 , void * V_132 )
{
}
static int F_81 ( struct V_130 * V_131 , void * V_132 )
{
struct V_18 * V_129 = (struct V_18 * ) V_132 ;
F_82 ( V_131 , L_24 , F_34 ( V_129 -> type ) ,
V_129 -> V_55 , V_129 -> V_56 ) ;
F_35 ( V_129 ) ;
return 0 ;
}
static int F_83 ( struct V_133 * V_133 , struct V_99 * V_99 )
{
return F_84 ( V_99 , & V_134 ) ;
}
