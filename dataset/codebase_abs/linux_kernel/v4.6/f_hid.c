...
V_9 -> V_31 = V_34 ;
V_36 = - V_42 ;
V_9 -> V_14 = F_49 ( V_9 -> V_49 , V_32 ) ;
if ( ! V_9 -> V_14 )
goto V_98;
V_9 -> V_14 -> V_26 = F_50 ( V_9 -> V_30 , V_32 ) ;
if ( ! V_9 -> V_14 -> V_26 )
goto V_98;
...
F_55 ( & V_9 -> V_25 ) ;
F_56 ( & V_9 -> V_38 , & V_125 ) ;
V_106 = F_57 ( V_126 , V_9 -> V_127 ) ;
V_36 = F_58 ( & V_9 -> V_38 , V_106 , 1 ) ;
if ( V_36 )
goto V_128;
V_105 = F_59 ( V_129 , NULL , V_106 , NULL ,
L_18 , L_19 , V_9 -> V_127 ) ;
if ( F_45 ( V_105 ) ) {
V_36 = F_46 ( V_105 ) ;
goto V_130;
...
static inline struct V_133 * F_66 ( struct V_134 * V_135 )
{
return F_2 ( F_67 ( V_135 ) , struct V_133 ,
V_136 . V_137 ) ;
}
static void F_68 ( struct V_134 * V_135 )
{
struct V_133 * V_138 = F_66 ( V_135 ) ;
F_69 ( & V_138 -> V_136 ) ;
}
static T_1 F_70 ( struct V_134 * V_135 , char * V_139 )
{
struct V_133 * V_138 = F_66 ( V_135 ) ;
int V_140 ;
F_18 ( & V_138 -> V_44 ) ;
...
static T_1 F_71 ( struct V_134 * V_135 ,
...
static inline void F_73 ( int V_127 )
{
F_65 ( & V_131 , V_127 ) ;
}
static void F_74 ( struct V_149 * V_3 )
{
struct V_133 * V_138 ;
...
return F_78 ( - V_42 ) ;
F_52 ( & V_138 -> V_44 ) ;
V_138 -> V_136 . V_152 = F_74 ;
V_16 = & V_138 -> V_136 ;
F_18 ( & V_150 ) ;
if ( F_75 ( & V_131 . V_151 ) ) {
V_36 = F_79 ( NULL , V_132 ) ;
if ( V_36 ) {
V_16 = F_78 ( V_36 ) ;
F_13 ( V_138 ) ;
goto V_153;
...
V_138 -> V_127 = F_63 () ;
if ( V_138 -> V_127 < 0 ) {
V_16 = F_78 ( V_138 -> V_127 ) ;
F_13 ( V_138 ) ;
if ( F_75 ( & V_131 . V_151 ) )
F_76 () ;
goto V_153;
}
F_80 ( & V_138 -> V_136 . V_137 , L_21 , & V_154 ) ;
V_153:
F_20 ( & V_150 ) ;
return V_16 ;
}
...
static void F_82 ( struct V_101 * V_102 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_83 ( V_129 , F_57 ( V_126 , V_9 -> V_127 ) ) ;
F_60 ( & V_9 -> V_38 ) ;
F_37 ( V_9 -> V_49 ) ;
F_13 ( V_9 -> V_14 -> V_26 ) ;
F_62 ( V_9 -> V_49 , V_9 -> V_14 ) ;
...
static struct V_2 * F_84 ( struct V_149 * V_155 )
{
struct V_1 * V_9 ;
struct V_133 * V_138 ;
...
int F_79 ( struct V_164 * V_165 , int V_7 )
{
int V_36 ;
T_7 V_106 ;
V_129 = F_85 ( V_166 , L_19 ) ;
if ( F_45 ( V_129 ) ) {
V_36 = F_46 ( V_129 ) ;
V_129 = NULL ;
return V_36 ;
}
V_36 = F_86 ( & V_106 , 0 , V_7 , L_19 ) ;
if ( V_36 ) {
F_87 ( V_129 ) ;
V_129 = NULL ;
return V_36 ;
