...
V_2 -> V_137 [ V_112 ] . V_113 , 0 ) ;
F_46 ( V_2 -> V_136 ) ;
V_8 = F_52 ( V_2 -> V_96 , 0xffffffff , 0 ) ;
if ( V_8 != 0 )
F_18 ( V_4 -> V_21 , L_59 ,
V_8 ) ;
F_2 ( V_4 -> V_18 ,
...
static void F_53 ( struct V_4 * V_4 , int V_162 ,
unsigned int V_163 )
{
int V_164 ;
unsigned int V_5 ;
...
F_2 ( V_4 -> V_18 , V_164 , V_5 , V_163 ) ;
}
static int F_54 ( struct V_166 * V_21 ,
struct V_4 * V_4 )
{
const char * const V_167 = L_60 ;
const int V_168 = 3 ;
struct V_169 * V_170 ;
int V_171 , V_8 ;
int V_112 , V_172 ;
T_2 * V_173 ;
V_171 = F_55 ( V_4 -> V_21 , V_167 , NULL , 0 ) ;
if ( V_171 <= 0 )
return 0 ;
V_173 = F_56 ( V_171 , sizeof( T_2 ) , V_174 ) ;
if ( ! V_173 )
return - V_175 ;
V_8 = F_55 ( V_4 -> V_21 , V_167 , V_173 , V_171 ) ;
if ( V_8 < 0 )
goto V_98;
V_171 /= V_168 ;
V_170 = F_57 ( V_21 ,
...
for ( V_112 = 0 , V_172 = 0 ; V_112 < V_171 ; ++ V_112 ) {
V_170 [ V_112 ] . V_43 = V_173 [ V_172 ++ ] ? V_42 : 0 ;
V_170 [ V_112 ] . V_39 = V_173 [ V_172 ++ ] ;
V_170 [ V_112 ] . V_36 = V_173 [ V_172 ++ ] ;
}
V_4 -> V_33 . V_170 = V_170 ;
V_4 -> V_33 . V_177 = V_171 ;
V_98:
F_58 ( V_173 ) ;
return V_8 ;
}
static int F_59 ( struct V_166 * V_21 ,
struct V_4 * V_4 )
{
struct V_178 * V_33 = & V_4 -> V_33 ;
unsigned int V_6 = V_179 ;
int V_8 ;
...
F_60 ( V_4 -> V_21 , L_67 ,
& V_33 -> V_139 ) ;
V_33 -> V_47 = F_61 ( V_4 -> V_21 ,
L_68 ) ;
V_33 -> V_52 = F_61 ( V_4 -> V_21 ,
L_69 ) ;
V_33 -> V_149 = F_61 ( V_4 -> V_21 ,
L_70 ) ;
F_60 ( V_4 -> V_21 , L_71 , & V_33 -> V_183 ) ;
V_33 -> V_184 = F_61 ( V_4 -> V_21 ,
L_72 ) ;
V_33 -> V_185 = F_61 ( V_4 -> V_21 ,
L_73 ) ;
V_8 = F_54 ( V_21 , V_4 ) ;
if ( V_8 < 0 )
...
{
struct V_4 * V_4 = F_63 ( V_187 -> V_21 . V_188 ) ;
struct V_178 * V_33 = & V_4 -> V_33 ;
struct V_1 * V_2 ;
unsigned int V_6 ;
unsigned int V_189 ;
int V_190 , V_191 ;
int V_8 , V_31 , V_112 , V_172 ;
if ( ! V_4 -> V_23 || ! V_4 -> V_23 -> V_192 )
return - V_193 ;
V_2 = F_57 ( & V_187 -> V_21 , sizeof( * V_2 ) , V_174 ) ;
if ( ! V_2 )
return - V_175 ;
if ( ! F_64 ( V_4 -> V_21 ) )
F_59 ( & V_187 -> V_21 , V_4 ) ;
V_2 -> V_50 = F_65 ( & V_187 -> V_21 , L_9 ) ;
if ( F_66 ( V_2 -> V_50 ) ) {
V_8 = F_67 ( V_2 -> V_50 ) ;
...
V_2 -> V_96 = F_71 ( & V_187 -> V_21 , V_196 ) ;
if ( F_66 ( V_2 -> V_96 ) ) {
F_18 ( & V_187 -> V_21 , L_76 ) ;
return - V_175 ;
}
V_8 = F_72 ( & V_187 -> V_21 , V_2 -> V_96 ) ;
if ( V_8 < 0 ) {
F_18 ( V_4 -> V_21 , L_77 ,
V_8 ) ;
return V_8 ;
}
V_2 -> V_136 = F_73 ( & V_187 -> V_21 ) ;
if ( ! V_2 -> V_136 ) {
F_18 ( V_4 -> V_21 , L_78 ) ;
V_8 = - V_175 ;
goto V_197;
...
V_220 , 0x81 ) ;
for ( V_112 = 0 ; V_112 < V_2 -> V_135 ; V_112 ++ ) {
for ( V_172 = 0 ; V_172 < V_216 ; V_172 ++ )
if ( V_116 [ V_172 ] >= V_2 -> V_137 [ V_112 ] . V_76 )
break;
if ( V_172 == V_216 ) {
F_18 ( V_4 -> V_21 , L_88 ,
V_2 -> V_137 [ V_112 ] . V_76 ) ;
...
F_9 ( V_4 -> V_21 , L_89 ,
V_116 [ V_172 ] , V_112 ) ;
F_53 ( V_4 , V_112 , V_172 ) ;
F_77 ( V_2 -> V_136 , V_221 ,
...
L_90 , F_51 , V_2 ) ;
if ( V_8 != 0 ) {
F_18 ( & V_187 -> V_21 , L_91 ,
V_8 ) ;
goto V_207;
}
V_8 = F_81 ( V_4 , V_191 , 1 ) ;
if ( V_8 != 0 ) {
F_18 ( & V_187 -> V_21 , L_92 ,
V_8 ) ;
goto V_234;
}
V_8 = F_80 ( V_4 , V_190 ,
L_93 , F_51 , V_2 ) ;
if ( V_8 != 0 ) {
F_18 ( & V_187 -> V_21 , L_94 , V_8 ) ;
goto V_235;
}
V_8 = F_81 ( V_4 , V_190 , 1 ) ;
if ( V_8 != 0 ) {
F_18 ( & V_187 -> V_21 , L_95 ,
V_8 ) ;
goto V_236;
}
V_8 = F_80 ( V_4 , V_237 ,
L_96 , F_49 , V_2 ) ;
if ( V_8 != 0 ) {
F_18 ( & V_187 -> V_21 , L_97 , V_8 ) ;
goto V_238;
}
V_8 = F_80 ( V_4 , V_239 ,
L_85 , F_32 , V_2 ) ;
if ( V_8 != 0 ) {
F_18 ( & V_187 -> V_21 , L_98 , V_8 ) ;
goto V_240;
}
F_82 ( V_4 ) ;
F_2 ( V_4 -> V_18 , V_153 ,
