...
F_40 ( V_2 , true ) ;
F_78 ( & V_2 -> V_68 , & V_106 ) ;
V_86 = F_79 ( V_40 , V_107 , V_71 ,
V_72 , & V_2 -> V_68 ) ;
if ( V_86 < 0 )
goto V_108;
if ( V_61 & V_109 ) {
F_78 ( & V_2 -> V_69 , & V_110 ) ;
V_86 = F_79 ( V_40 , V_107 ,
V_87 , 4 ,
& V_2 -> V_69 ) ;
if ( V_86 < 0 )
goto V_111;
...
void F_84 ( struct V_40 * V_40 )
{
struct V_1 * V_2 = V_40 -> V_41 . V_42 ;
if ( V_2 ) {
F_80 ( V_40 , V_107 , & V_2 -> V_68 ) ;
F_80 ( V_40 , V_107 , & V_2 -> V_69 ) ;
F_40 ( V_2 , false ) ;
F_25 ( & V_2 -> V_7 . V_17 ) ;
F_29 ( & V_2 -> V_37 ) ;
F_81 ( V_2 -> V_98 ) ;
