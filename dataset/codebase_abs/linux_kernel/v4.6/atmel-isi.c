...
struct V_104 * V_105 = F_26 ( V_49 -> V_106 ) ;
struct V_5 * V_6 = V_105 -> V_107 ;
unsigned long V_108 ;
V_108 = V_49 -> V_109 ;
if ( ! * V_100 || * V_100 > V_110 )
* V_100 = V_110 ;
if ( V_108 * * V_100 > V_111 )
* V_100 = V_111 / V_108 ;
* V_101 = 1 ;
V_102 [ 0 ] = V_108 ;
V_103 [ 0 ] = V_6 -> V_112 ;
...
struct V_115 * V_116 ;
V_108 = V_49 -> V_109 ;
if ( F_33 ( V_58 , 0 ) < V_108 ) {
F_34 ( V_49 -> V_106 , L_2 ,
V_113 , F_33 ( V_58 , 0 ) , V_108 ) ;
return - V_117 ;
}
F_35 ( V_58 , 0 , V_108 ) ;
if ( ! V_60 -> V_69 ) {
...
struct V_5 * V_6 = V_105 -> V_107 ;
int V_85 ;
F_46 ( V_105 -> V_135 . V_136 ) ;
V_85 = F_20 ( V_6 , V_137 ) ;
if ( V_85 < 0 ) {
F_34 ( V_49 -> V_106 , L_5 ) ;
F_47 ( V_105 -> V_135 . V_136 ) ;
return V_85 ;
}
...
{
F_27 ( V_49 -> V_106 , L_17 ,
V_49 -> V_211 ) ;
return 0 ;
}
static void F_70 ( struct V_48 * V_49 )
{
F_27 ( V_49 -> V_106 , L_18 ,
V_49 -> V_211 ) ;
}
...
{
struct V_104 * V_127 = F_26 ( & V_244 -> V_136 ) ;
struct V_5 * V_6 = F_30 ( V_127 ,
struct V_5 , V_127 ) ;
F_76 ( V_127 ) ;
F_77 ( V_6 -> V_112 ) ;
F_78 ( & V_244 -> V_136 ,
sizeof( struct V_1 ) * V_110 ,
V_6 -> V_245 ,
V_6 -> V_246 ) ;
F_79 ( & V_244 -> V_136 ) ;
return 0 ;
...
V_248 = F_81 ( V_248 , NULL ) ;
if ( ! V_248 ) {
F_34 ( & V_244 -> V_136 , L_28 ) ;
return - V_117 ;
}
V_252 = F_82 ( V_248 , & V_251 ) ;
F_83 ( V_248 ) ;
if ( V_252 ) {
...
int V_85 , V_204 ;
struct V_104 * V_127 ;
V_6 = F_85 ( & V_244 -> V_136 , sizeof( struct V_5 ) , V_263 ) ;
if ( ! V_6 ) {
F_34 ( & V_244 -> V_136 , L_31 ) ;
return - V_264 ;
}
V_6 -> V_265 = F_86 ( & V_244 -> V_136 , L_32 ) ;
if ( F_87 ( V_6 -> V_265 ) )
return F_88 ( V_6 -> V_265 ) ;
V_85 = F_80 ( V_6 , V_244 ) ;
if ( V_85 )
return V_85 ;
V_6 -> V_55 = NULL ;
...
V_6 -> V_112 = F_91 ( & V_244 -> V_136 ) ;
if ( F_87 ( V_6 -> V_112 ) ) {
V_85 = F_88 ( V_6 -> V_112 ) ;
goto V_267;
}
V_9 = F_92 ( V_244 , V_268 , 0 ) ;
V_6 -> V_9 = F_93 ( & V_244 -> V_136 , V_9 ) ;
if ( F_87 ( V_6 -> V_9 ) ) {
V_85 = F_88 ( V_6 -> V_9 ) ;
goto V_269;
}
...
V_85 = F_95 ( & V_244 -> V_136 , V_80 , F_15 , 0 , L_34 , V_6 ) ;
if ( V_85 ) {
...
V_127 -> V_273 = V_244 -> V_274 ;
F_96 ( & V_244 -> V_136 , true ) ;
F_97 ( & V_244 -> V_136 ) ;
V_85 = F_98 ( V_127 ) ;
if ( V_85 ) {
...
static int F_99 ( struct V_276 * V_136 )
{
struct V_104 * V_127 = F_26 ( V_136 ) ;
struct V_5 * V_6 = F_30 ( V_127 ,
struct V_5 , V_127 ) ;
F_100 ( V_6 -> V_265 ) ;
return 0 ;
}
static int F_101 ( struct V_276 * V_136 )
{
struct V_104 * V_127 = F_26 ( V_136 ) ;
struct V_5 * V_6 = F_30 ( V_127 ,
struct V_5 , V_127 ) ;
return F_102 ( V_6 -> V_265 ) ;
}
