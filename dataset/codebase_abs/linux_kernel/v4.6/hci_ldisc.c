...
if ( ! F_18 ( V_49 , & V_10 -> V_37 ) )
return;
V_10 -> V_24 -> V_112 ( V_10 , V_40 , V_111 ) ;
if ( V_10 -> V_13 )
V_10 -> V_13 -> V_15 . V_113 += V_111 ;
F_56 ( V_33 ) ;
}
...
V_13 -> V_118 = F_31 ;
V_13 -> V_97 = F_38 ;
F_60 ( V_13 , V_10 -> V_33 -> V_119 ) ;
if ( F_18 ( V_120 , & V_10 -> V_45 ) )
F_9 ( V_121 , & V_13 -> V_122 ) ;
if ( F_18 ( V_123 , & V_10 -> V_45 ) )
F_9 ( V_124 , & V_13 -> V_122 ) ;
if ( ! F_18 ( V_125 , & V_10 -> V_45 ) )
F_9 ( V_126 , & V_13 -> V_122 ) ;
...
{
unsigned long V_133 = F_63 ( V_120 ) |
F_63 ( V_125 ) |
F_63 ( V_127 ) |
F_63 ( V_44 ) |
F_63 ( V_123 ) |
...
static int F_64 ( struct V_32 * V_33 , struct V_134 * V_134 ,
...
return V_10 -> V_45 ;
default:
V_43 = F_65 ( V_33 , V_134 , V_135 , V_136 ) ;
break;
}
return V_43 ;
}
static T_2 F_66 ( struct V_32 * V_33 , struct V_134 * V_134 ,
unsigned char T_3 * V_145 , T_4 V_146 )
{
return 0 ;
}
static T_2 F_67 ( struct V_32 * V_33 , struct V_134 * V_134 ,
const unsigned char * V_40 , T_4 V_111 )
{
return 0 ;
}
static unsigned int F_68 ( struct V_32 * V_33 ,
struct V_134 * V_147 , T_5 * V_148 )
{
return 0 ;
}
