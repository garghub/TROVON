...
F_93 ( & V_179 , & V_30 . V_180 ) ;
while ( ! F_17 ( & V_30 . V_180 ) ) {
F_94 (rcd, tmp, &the_lnet.ln_rcd_zombie,
rcd_list) {
if ( F_71 ( V_121 -> V_140 ) )
F_95 ( & V_121 -> V_34 , & V_179 ) ;
}
V_178 = V_178 &&
! F_17 ( & V_30 . V_180 ) ;
F_8 ( V_76 ) ;
...
void
F_102 ( T_16 * V_188 , int V_189 )
{
int V_190 = F_103 ( T_16 , V_191 [ V_189 ] ) ;
while ( -- V_189 >= 0 )
F_104 ( V_188 -> V_191 [ V_189 ] . V_192 ) ;
F_37 ( V_188 , V_190 ) ;
}
static T_16 *
F_105 ( T_7 * V_99 , int V_83 )
{
...
F_38 ( & V_38 ) ;
F_9 ( V_83 ) ;
F_111 ( & V_99 -> V_201 , V_83 ) ;
F_93 ( & V_99 -> V_202 , & V_38 ) ;
V_99 -> V_203 = 0 ;
V_99 -> V_104 = 0 ;
V_99 -> V_106 = 0 ;
V_99 -> V_108 = 0 ;
F_8 ( V_83 ) ;
F_94 (rb, temp, &tmp, rb_list) {
F_18 ( & V_188 -> V_204 ) ;
F_102 ( V_188 , V_189 ) ;
}
}
static int
F_112 ( T_7 * V_99 , int V_205 , int V_83 )
{
struct V_26 V_204 ;
T_16 * V_188 ;
int V_206 ;
...
F_110 ( & V_211 [ V_212 ] , V_84 ) ;
F_110 ( & V_211 [ V_213 ] , V_84 ) ;
F_110 ( & V_211 [ V_214 ] , V_84 ) ;
}
if ( ! V_210 ) {
F_117 ( V_30 . V_97 ) ;
V_30 . V_97 = NULL ;
...
F_47 (rtrp, i, the_lnet.ln_rtrpools) {
F_115 ( & V_211 [ V_212 ] , 0 ) ;
V_66 = F_112 ( & V_211 [ V_212 ] ,
V_227 , V_84 ) ;
if ( V_66 )
goto V_209;
F_115 ( & V_211 [ V_213 ] ,
V_231 ) ;
V_66 = F_112 ( & V_211 [ V_213 ] ,
V_228 , V_84 ) ;
if ( V_66 )
goto V_209;
F_115 ( & V_211 [ V_214 ] ,
V_232 ) ;
V_66 = F_112 ( & V_211 [ V_214 ] ,
V_229 , V_84 ) ;
if ( V_66 )
goto V_209;
}
...
static int
F_123 ( int V_233 , int V_234 , int V_235 )
{
int V_236 = 0 ;
int V_66 = 0 ;
int V_84 ;
...
int
F_124 ( int V_233 , int V_234 , int V_235 )
{
if ( ! V_30 . V_110 )
return 0 ;
return F_123 ( V_233 , V_234 , V_235 ) ;
}
int
F_125 ( void )
{
...
int
F_127 ( T_1 * V_1 , T_6 V_133 , int V_8 , unsigned long V_9 )
{
struct V_90 * V_6 = NULL ;
unsigned long V_152 = F_59 () ;
int V_83 = F_128 ( V_133 ) ;
F_11 ( ! F_129 () ) ;
F_5 ( V_11 , L_31 ,
...
V_6 = F_133 ( V_30 . V_240 [ V_83 ] , V_133 ) ;
if ( ! V_6 ) {
F_8 ( V_83 ) ;
