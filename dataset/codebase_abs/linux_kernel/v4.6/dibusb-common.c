...
{
if ( F_20 ( V_2 -> V_25 -> V_54 -> V_55 . V_56 ) == V_57 &&
F_20 ( V_2 -> V_25 -> V_54 -> V_55 . V_58 ) ==
V_59 ) {
F_7 ( 1000 ) ;
}
V_2 -> V_9 [ 0 ] . V_10 = F_21 ( V_60 ,
& V_2 -> V_25 -> V_61 ,
V_62 ,
& V_63 ) ;
...
struct V_40 * V_69 ;
if ( F_20 ( V_2 -> V_25 -> V_54 -> V_55 . V_56 ) == V_57 &&
F_20 ( V_2 -> V_25 -> V_54 -> V_55 . V_58 ) == V_59 ) {
...
F_11 ( L_4 , V_67 , V_18 ) ;
} else if ( F_20 ( V_2 -> V_25 -> V_54 -> V_55 . V_56 ) == V_70 &&
F_20 ( V_2 -> V_25 -> V_54 -> V_55 . V_58 ) == V_71 ) {
T_2 V_72 ;
...
V_69 = F_23 ( V_2 -> V_9 [ 0 ] . V_10 , 1 ) ;
if ( F_21 ( V_73 , V_2 -> V_9 [ 0 ] . V_10 , V_69 , & V_74 , V_68 ) == NULL ) {
if ( F_21 ( V_75 , V_2 -> V_9 [ 0 ] . V_10 , 0x60 , V_69 , V_76 ) == NULL )
return - V_77 ;
} else {
V_6 -> V_78 = 1 ;
F_24 ( V_2 -> V_9 [ 0 ] . V_10 , & V_79 ) ;
}
return 0 ;
}
int F_25 ( struct V_16 * V_17 , T_3 * V_80 , int * V_81 )
{
T_2 V_82 [ 5 ] , V_83 = V_84 ;
F_12 ( V_17 , & V_83 , 1 , V_82 , 5 , 0 ) ;
F_26 ( V_17 , V_82 , V_80 , V_81 ) ;
if ( V_82 [ 0 ] != 0 )
F_27 ( L_5 , 5 , V_82 ) ;
return 0 ;
}
