...
V_36 -> V_37 = F_25 ;
V_36 -> remove = F_26 ;
error = F_32 ( & V_30 -> V_36 ) ;
if ( error ) {
F_33 ( L_8 ,
V_30 -> V_36 . V_42 , error ) ;
return error ;
}
return 0 ;
}
...
if ( V_43 != F_37 ( V_28 ) )
return 0 ;
return V_43 || F_21 ( V_3 , V_28 ) ;
}
static void F_38 ( int V_44 )
{
int V_45 ;
for ( V_45 = V_44 ; V_45 >= 0 ; V_45 -- )
F_34 ( V_46 [ V_45 ] ) ;
}
...
int V_47 ;
int V_45 ;
for ( V_45 = 0 ; V_45 < F_40 ( V_46 ) ; V_45 ++ ) {
V_47 = F_42 ( V_46 [ V_45 ] ) ;
if ( V_47 ) {
F_33 ( L_9 ,
V_23 , V_46 [ V_45 ] -> V_33 , V_47 ) ;
goto V_48;
}
}
return 0 ;
...
int F_43 ( struct V_2 * V_3 , T_3 * V_49 ,
const char * V_50 , bool V_51 )
{
int V_52 ;
T_3 V_53 = 0 ;
V_52 = F_44 ( V_3 -> V_35 , V_50 , & V_53 ) ;
if ( V_52 && ( ! V_51 && V_52 == - V_54 ) ) {
F_28 ( V_3 , L_10 ,
V_50 , V_52 ) ;
return V_52 ;
}
