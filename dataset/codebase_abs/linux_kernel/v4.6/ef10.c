...
F_21 ( V_421 , V_427 ,
V_333 ) ;
F_13 ( F_159 ( V_2 -> V_428 ) !=
V_429 ) ;
for ( V_67 = 0 ; V_67 < F_159 ( V_2 -> V_428 ) ; ++ V_67 )
...
static int F_163 ( struct V_1 * V_2 , bool V_435 ,
const T_6 * V_196 )
{
int V_18 ;
if ( V_2 -> V_408 == 1 )
...
bool V_436 = false ;
T_2 V_67 ;
for ( V_67 = 0 ; V_67 < F_159 ( V_2 -> V_196 ) && ! V_436 ;
V_67 ++ )
V_436 = V_196 [ V_67 ] !=
...
static int F_166 ( struct V_437 * V_438 )
{
...
static void F_167 ( struct V_437 * V_438 )
{
F_8 ( V_47 ,
F_168 ( V_357 * 8 /
V_358 ) ) ;
struct V_123 * V_124 = F_169 ( V_438 ) ;
...
F_170 ( V_438 ) , V_361 , ( T_7 ) V_297 ) ;
for ( V_67 = 0 ; V_67 < V_361 ; ++ V_67 ) {
F_142 ( V_47 , V_452 , V_67 , V_297 ) ;
V_297 += V_358 ;
}
V_363 = F_168 ( V_361 ) ;
...
static void F_171 ( struct V_437 * V_438 )
{
F_8 ( V_47 , V_454 ) ;
F_50 ( V_13 ) ;
struct V_1 * V_2 = V_438 -> V_2 ;
...
static inline void
F_173 ( struct V_437 * V_438 , unsigned int V_128 )
{
struct V_457 * V_458 ;
V_351 * V_439 ;
V_439 = F_174 ( V_438 , V_128 ) ;
V_458 = V_457 ( V_438 , V_128 ) ;
F_175 ( * V_439 ,
V_459 , V_458 -> V_362 ,
V_460 , V_458 -> V_297 ) ;
}
static void F_176 ( struct V_437 * V_438 )
{
struct V_1 * V_2 = V_438 -> V_2 ;
unsigned int V_353 ;
T_1 V_3 ;
...
static void F_188 ( struct V_437 * V_438 )
{
unsigned int V_513 ;
...
bool V_521 ;
T_12 V_204 = 0 ;
if ( F_151 ( F_130 ( V_2 -> V_522 ) ) )
return 0 ;
V_245 = F_191 ( * V_466 , V_523 ) ;
V_517 = F_191 ( * V_466 , V_524 ) ;
V_508 = F_191 ( * V_466 , V_525 ) ;
V_518 = F_191 ( * V_466 , V_526 ) ;
V_521 = F_191 ( * V_466 , V_527 ) ;
if ( F_191 ( * V_466 , V_528 ) )
F_145 ( V_2 -> V_28 , L_44
V_529 L_26 ,
F_192 ( * V_466 ) ) ;
V_438 = F_193 ( V_124 ) ;
if ( F_151 ( V_508 != F_170 ( V_438 ) ) )
F_185 ( V_438 , V_508 ) ;
V_519 = ( ( V_517 - V_438 -> V_514 ) &
( ( 1 << V_530 ) - 1 ) ) ;
if ( V_519 != V_438 -> V_441 + 1 ) {
struct V_15 * V_16 = V_2 -> V_16 ;
if ( F_151 ( V_519 == V_438 -> V_441 ) ) {
...
if ( F_151 ( F_191 ( * V_466 , V_534 ) ) )
V_204 |= V_515 ;
if ( F_151 ( F_191 ( * V_466 , V_535 ) ) ) {
V_124 -> V_536 += V_520 ;
} else if ( F_151 ( F_191 ( * V_466 ,
V_537 ) ) ) {
V_124 -> V_538 += V_520 ;
} else if ( V_518 == V_539 ||
V_518 == V_540 ) {
...
static int
F_194 ( struct V_123 * V_124 , V_351 * V_466 )
{
struct V_1 * V_2 = V_124 -> V_2 ;
struct V_125 * V_126 ;
unsigned int V_544 ;
...
if ( F_151 ( F_130 ( V_2 -> V_522 ) ) )
return 0 ;
if ( F_151 ( F_191 ( * V_466 , V_547 ) ) )
return 0 ;
V_544 = F_191 ( * V_466 , V_548 ) ;
V_545 = F_191 ( * V_466 , V_549 ) ;
V_126 = F_195 ( V_124 ,
V_545 % V_184 ) ;
V_546 = ( ( V_544 + 1 - V_126 -> V_550 ) &
V_126 -> V_350 ) ;
F_196 ( V_126 , V_544 & V_126 -> V_350 ) ;
return V_546 ;
}
static void
F_197 ( struct V_123 * V_124 , V_351 * V_466 )
{
struct V_1 * V_2 = V_124 -> V_2 ;
int V_551 ;
V_551 = F_191 ( * V_466 , V_552 ) ;
switch ( V_551 ) {
case V_553 :
case V_554 :
break;
...
struct V_1 * V_2 = V_124 -> V_2 ;
T_6 V_551 ;
V_551 = F_191 ( * V_466 , V_556 ) ;
switch ( V_551 ) {
case V_557 :
V_124 -> V_558 = F_128 () ;
break;
case V_470 :
F_199 ( & V_124 -> V_438 , true ) ;
break;
default:
F_14 ( V_2 , V_374 , V_2 -> V_28 ,
L_49
...
static int F_200 ( struct V_123 * V_124 , int V_559 )
{
struct V_1 * V_2 = V_124 -> V_2 ;
V_351 V_466 , * V_560 ;
unsigned int V_561 ;
...
V_561 = V_124 -> V_564 ;
for (; ; ) {
V_560 = F_201 ( V_124 , V_561 ) ;
V_466 = * V_560 ;
if ( ! F_202 ( & V_466 ) )
break;
F_203 ( * V_560 ) ;
++ V_561 ;
V_562 = F_191 ( V_466 , V_467 ) ;
F_127 ( V_2 , V_27 , V_2 -> V_28 ,
L_50 V_529 L_26 ,
V_124 -> V_124 , F_192 ( V_466 ) ) ;
switch ( V_562 ) {
case V_565 :
F_204 ( V_124 , & V_466 ) ;
break;
case V_566 :
V_563 += F_190 ( V_124 , & V_466 ) ;
if ( V_563 >= V_559 ) {
V_563 = V_559 ;
goto V_304;
}
...
V_124 -> V_564 &
V_124 -> V_478 ) ;
F_114 ( V_2 , & V_570 , V_578 , V_124 -> V_124 ) ;
}
}
...
static bool F_216 ( const struct V_585 * V_586 ,
...
sizeof( struct V_585 ) -
F_217 ( struct V_585 , V_591 ) ) == 0 ;
}
static unsigned int F_218 ( const struct V_585 * V_592 )
{
F_13 ( F_217 ( struct V_585 , V_591 ) & 3 ) ;
return F_219 ( ( const T_6 * ) & V_592 -> V_591 ,
( sizeof( struct V_585 ) -
F_217 ( struct V_585 , V_591 ) ) / 4 ,
0 ) ;
}
static bool F_220 ( const struct V_585 * V_592 )
{
...
( V_595 | V_596 ) ) ==
( V_595 | V_596 ) ) {
if ( V_592 -> V_597 == F_222 ( V_598 ) &&
! F_223 ( V_592 -> V_599 [ 0 ] ) )
return true ;
if ( V_592 -> V_597 == F_222 ( V_600 ) &&
...
static struct V_585 *
F_224 ( const struct V_601 * V_602 ,
unsigned int V_603 )
{
...
F_228 ( V_621 , V_622 , V_623 ) ;
F_228 ( V_624 , V_599 , V_625 ) ;
F_228 ( V_626 , V_627 , V_628 ) ;
F_228 ( V_629 , V_630 , V_631 ) ;
F_228 ( V_632 , V_594 , V_633 ) ;
F_228 ( V_634 , V_635 , V_636 ) ;
F_228 ( V_637 , V_597 , V_637 ) ;
F_228 ( V_638 , V_639 , V_640 ) ;
F_228 ( V_641 , V_591 , V_642 ) ;
F_228 ( V_643 , V_644 , V_643 ) ;
#undef F_228
F_21 ( V_47 , V_645 ,
V_615 ) ;
}
...
F_8 ( V_13 , V_660 ) ;
int V_18 ;
F_227 ( V_2 , V_592 , V_47 , * V_606 , V_607 ) ;
V_18 = F_9 ( V_2 , V_661 , V_47 , sizeof( V_47 ) ,
V_13 , sizeof( V_13 ) , NULL ) ;
if ( V_18 == 0 )
* V_606 = F_230 ( V_13 , V_662 ) ;
if ( V_18 == - V_119 )
V_18 = - V_169 ;
return V_18 ;
}
static int F_231 ( struct V_601 * V_602 ,
enum V_663 V_588 )
{
unsigned int V_664 ;
for ( V_664 = 0 ;
...
V_672 = F_224 ( V_602 , V_67 ) ;
if ( ! V_672 ) {
if ( V_675 < 0 )
V_675 = V_67 ;
} else if ( F_216 ( V_592 , V_672 ) ) {
...
F_237 ( & V_602 -> V_687 , & V_676 , V_688 ) ;
F_103 ( & V_2 -> V_679 ) ;
F_238 () ;
}
V_686:
V_672 = F_224 ( V_602 , V_675 ) ;
if ( V_672 ) {
...
V_607 = true ;
V_674 = F_225 ( V_602 , V_675 ) ;
} else {
V_672 = F_239 ( sizeof( * V_592 ) , V_295 ) ;
if ( ! V_672 ) {
V_18 = - V_71 ;
goto V_684;
}
...
F_226 ( V_602 , V_675 , V_672 ,
V_674 | V_681 ) ;
if ( V_677 ) {
unsigned int V_678 , V_67 ;
for ( V_678 = 0 ; V_678 < V_671 ; V_678 ++ ) {
V_67 = ( V_673 + V_678 ) & ( V_680 - 1 ) ;
if ( F_240 ( V_678 , V_670 ) )
V_602 -> V_604 [ V_67 ] . V_592 |=
V_681 ;
}
}
F_103 ( & V_2 -> V_679 ) ;
V_18 = F_229 ( V_2 , V_592 , & V_602 -> V_604 [ V_675 ] . V_606 ,
V_607 ) ;
F_105 ( & V_2 -> V_679 ) ;
if ( V_18 == 0 ) {
if ( V_607 ) {
...
V_592 = F_224 ( V_602 , V_603 ) ;
if ( ! V_592 ||
( ! V_694 &&
F_231 ( V_602 , V_592 -> V_588 ) !=
V_693 / V_680 ) ) {
V_18 = - V_101 ;
goto V_684;
}
...
T_6 V_693 )
{
return F_244 ( V_2 , 1U << V_682 ,
V_693 , false ) ;
}
static T_6 F_247 ( struct V_1 * V_2 , T_6 V_693 )
{
return V_693 % V_680 ;
}
...
int V_18 ;
F_105 ( & V_2 -> V_679 ) ;
V_672 = F_224 ( V_602 , V_603 ) ;
if ( V_672 && V_672 -> V_682 == V_682 &&
F_231 ( V_602 , V_672 -> V_588 ) ==
V_693 / V_680 ) {
* V_592 = * V_672 ;
V_18 = 0 ;
} else {
...
F_227 ( V_2 , V_592 , V_47 ,
V_602 -> V_604 [ V_675 ] . V_606 , V_607 ) ;
F_178 ( V_2 , V_661 , V_47 , sizeof( V_47 ) ,
V_660 ,
V_706 , V_475 ) ;
return V_675 ;
V_705:
...
F_226 ( V_602 , V_675 , V_592 , 0 ) ;
F_103 ( & V_2 -> V_679 ) ;
F_241 ( & V_602 -> V_687 ) ;
}
static bool F_256 ( struct V_1 * V_2 , T_6 V_707 ,
unsigned int V_603 )
{
struct V_601 * V_602 = V_2 -> V_669 ;
struct V_585 * V_592 =
...
F_106 ( V_47 , V_614 ,
V_602 -> V_604 [ V_603 ] . V_606 ) ;
if ( F_178 ( V_2 , V_661 , V_47 , sizeof( V_47 ) , 0 ,
V_708 , V_603 ) )
return false ;
V_602 -> V_604 [ V_603 ] . V_592 |= V_681 ;
return true ;
...
V_602 -> V_604 = F_263 ( V_680 * sizeof( * V_602 -> V_604 ) ) ;
if ( ! V_602 -> V_604 ) {
V_18 = - V_71 ;
goto V_135;
}
...
F_270 ( V_602 -> V_728 [ V_67 ] . V_729 ) ;
for ( V_67 = 0 ; V_67 < V_602 -> V_730 ; V_67 ++ )
F_270 ( V_602 -> V_731 [ V_67 ] . V_729 ) ;
F_270 ( V_602 -> V_721 ) ;
F_270 ( V_602 -> V_723 ) ;
F_270 ( V_602 -> V_724 ) ;
F_103 ( & V_2 -> V_679 ) ;
}
static void F_271 ( struct V_1 * V_2 , bool * V_732 )
{
struct V_601 * V_602 = V_2 -> V_669 ;
struct V_66 * V_28 = V_2 -> V_28 ;
struct V_733 * V_734 ;
...
static void F_274 ( struct V_1 * V_2 , bool * V_732 )
{
struct V_601 * V_602 = V_2 -> V_669 ;
struct V_66 * V_28 = V_2 -> V_28 ;
struct V_733 * V_739 ;
...
V_746 = F_245 ( V_2 ) ? V_609 : 0 ;
for ( V_67 = 0 ; V_67 < V_735 ; V_67 ++ ) {
F_278 ( & V_592 , V_683 , V_746 , 0 ) ;
F_279 ( & V_592 , V_750 ,
V_744 [ V_67 ] . V_281 ) ;
V_18 = F_232 ( V_2 , & V_592 , true ) ;
if ( V_18 < 0 ) {
if ( V_742 ) {
F_62 ( V_2 , V_27 , V_2 -> V_28 ,
L_57 ,
...
V_744 [ V_67 ] . V_729 = F_247 ( V_2 , V_18 ) ;
}
if ( V_256 && V_742 ) {
F_278 ( & V_592 , V_683 , V_746 , 0 ) ;
F_280 ( V_747 ) ;
F_279 ( & V_592 , V_750 , V_747 ) ;
V_18 = F_232 ( V_2 , & V_592 , true ) ;
if ( V_18 < 0 ) {
...
V_18 = F_232 ( V_2 , & V_592 , true ) ;
if ( V_18 < 0 ) {
F_284 ( V_2 , V_27 , V_18 == - V_97 ? V_751 : V_752 ,
V_2 -> V_28 ,
L_59 ,
V_256 ? L_60 : L_61 , V_18 ) ;
} else if ( V_256 ) {
V_602 -> V_724 = F_247 ( V_2 , V_18 ) ;
if ( ! V_16 -> V_504 ) {
F_278 ( & V_592 , V_683 ,
V_746 , 0 ) ;
F_280 ( V_747 ) ;
...
int V_67 ;
for ( V_67 = 0 ; V_67 < V_680 ; V_67 ++ ) {
if ( F_130 ( V_602 -> V_604 [ V_67 ] . V_592 ) &
V_690 ) {
V_18 = F_244 ( V_2 ,
1U << V_683 , V_67 , true ) ;
if ( V_18 == - V_101 )
...
V_756 = F_70 ( V_2 , V_16 -> V_79 , V_755 ) ;
if ( V_756 ) {
F_292 ( V_16 -> V_757 ) ;
goto V_760;
}
...
static int F_304 ( struct V_1 * V_2 , T_6 V_769 )
{
F_8 ( V_47 , V_770 ) ;
...
static int F_306 ( struct V_1 * V_2 , T_6 V_769 )
{
int V_18 ;
F_41 ( V_2 , V_27 , V_2 -> V_28 , L_71 , V_769 ) ;
V_18 = F_304 ( V_2 , V_769 ) ;
if ( V_18 != 0 )
return V_18 ;
return F_305 ( V_2 ) ;
}
static int
F_307 ( struct V_1 * V_2 , struct V_780 * V_781 )
{
int V_18 , V_756 ;
F_308 ( V_2 , V_214 ) ;
V_18 = F_9 ( V_2 , V_782 ,
...
if ( V_18 != 0 )
goto V_304;
V_781 -> V_783 = F_306 ( V_2 , V_784 ) ? - 1 : 1 ;
V_781 -> V_785 = F_306 ( V_2 , V_786 ) ? - 1 : 1 ;
V_18 = F_35 ( V_2 , V_214 ) ;
V_304:
if ( V_18 == - V_97 )
V_18 = 0 ;
V_756 = F_309 ( V_2 , V_214 , V_18 == 0 ) ;
return V_18 ? V_18 : V_756 ;
}
...
if ( V_792 -> V_797 != F_311 ( V_2 ) )
return - V_37 ;
V_18 = F_312 ( V_2 , type , & V_701 , & V_793 , & V_794 ) ;
if ( V_18 )
return V_18 ;
if ( V_794 )
return - V_37 ;
...
F_261 ( V_17 , V_821 ) )
return - V_7 ;
V_814 = F_315 ( V_815 , sizeof( * V_814 ) , V_70 ) ;
if ( ! V_814 )
return - V_71 ;
V_816 = 0 ;
for ( V_67 = 0 ; V_67 < V_815 ; V_67 ++ ) {
type = F_262 ( V_13 , V_821 ,
V_67 ) ;
V_18 = F_310 ( V_2 , & V_814 [ V_816 ] , type ) ;
if ( V_18 == 0 )
V_816 ++ ;
else if ( V_18 != - V_37 )
goto V_135;
}
V_18 = F_316 ( V_2 , & V_814 [ 0 ] . V_806 , V_816 , sizeof( * V_814 ) ) ;
V_135:
if ( V_18 )
F_48 ( V_814 ) ;
return V_18 ;
}
static void F_317 ( struct V_1 * V_2 , T_6 V_822 )
{
...
static int F_321 ( struct V_1 * V_2 , bool V_840 ,
bool V_823 )
{
int (* F_322)( struct V_123 * V_124 , bool V_823 );
struct V_123 * V_124 ;
F_322 = V_840 ?
F_319 :
F_320 ;
F_58 (channel, efx) {
int V_18 = F_322 ( V_124 , V_823 ) ;
if ( V_840 && V_18 != 0 ) {
F_321 ( V_2 , false , V_823 ) ;
return V_18 ;
}
}
return 0 ;
