...
static int F_42 ( struct V_11 * V_12 , const struct V_131 * V_132 )
{
T_1 V_133 = V_134 ;
T_1 V_117 ;
int V_135 ;
F_10 ( V_12 , L_1 ) ;
V_135 = F_43 ( V_12 , & V_133 , sizeof( V_133 ) ) ;
if ( V_135 < 0 )
goto V_136;
V_135 = F_44 ( V_12 , & V_117 , sizeof( V_117 ) ) ;
if ( V_135 < 0 )
goto V_136;
F_45 ( V_12 , L_3 , V_117 ) ;
F_28 ( V_12 , 0x3d , 0x0 ) ;
...
static int F_48 ( struct V_138 * V_7 )
{
...
V_5 -> V_107 = 50 ;
V_5 -> V_15 = - 1 ;
V_5 -> V_146 = F_30 ( V_12 , V_134 ) ;
if ( V_147 ) {
for ( V_140 = 0 ; V_140 < V_99 ; V_140 ++ ) {
if ( ! strcmp ( V_100 [ V_140 ] , V_147 ) ) {
V_5 -> V_26 = V_140 ;
break;
}
}
