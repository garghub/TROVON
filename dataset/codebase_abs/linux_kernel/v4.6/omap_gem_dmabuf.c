...
if ( F_34 ( ! V_7 -> V_27 ) )
return - V_28 ;
V_12 = F_35 ( V_7 , F_36 ( V_7 ) , V_26 ) ;
if ( V_12 < 0 )
return V_12 ;
return F_37 ( V_7 , V_26 ) ;
}
struct V_18 * F_38 ( struct V_29 * V_30 ,
...
struct V_6 * F_41 ( struct V_29 * V_30 ,
struct V_18 * V_18 )
{
struct V_2 * V_35 ;
struct V_6 * V_7 ;
