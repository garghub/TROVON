...
static void F_31 ( struct V_1 * V_2 , struct V_122 * V_123 )
{
V_123 -> V_124 = V_125 ;
V_123 -> V_126 = 0 ;
if ( F_4 ( V_2 , V_39 ,
...
static void F_35 ( struct V_1 * V_2 , T_3 * V_144 )
{
int V_31 ;
for ( V_31 = 0 ; V_31 < F_34 ( V_143 ) ; V_31 ++ ) {
memcpy ( V_144 + V_31 * V_145 ,
V_143 [ V_31 ] . string , V_145 ) ;
}
}
static T_4 F_36 ( struct V_1 * V_2 , int V_31 )
{
...
int V_31 ;
for ( V_31 = 0 ; V_31 < F_34 ( V_143 ) ; V_31 ++ )
V_144 [ V_31 ] = F_36 ( V_2 , V_31 ) ;
}
static int F_38 ( struct V_1 * V_2 )
{
struct V_148 * V_149 ;
V_149 = F_39 ( & V_2 -> V_36 . V_37 , sizeof( * V_149 ) , V_155 ) ;
if ( ! V_149 )
return - V_156 ;
V_2 -> V_149 = V_149 ;
return 0 ;
