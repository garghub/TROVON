...
static int F_36 ( struct V_8 * V_9 , struct V_65 * V_66 )
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
...
if ( ! V_66 )
return - V_70 ;
V_69 = F_37 ( V_67 , V_68 , V_66 , V_71 ) ;
if ( V_69 < 0 )
return V_69 ;
if ( V_67 [ V_72 ] ) {
if ( V_2 -> V_36 )
return - V_70 ;
V_2 -> V_7 = F_38 ( V_67 [ V_72 ] ) ;
if ( ! V_2 -> V_7 ||
V_2 -> V_7 > 65536 )
return - V_70 ;
}
F_39 ( V_9 ) ;
if ( V_67 [ V_73 ] ) {
T_2 V_74 = F_38 ( V_67 [ V_73 ] ) ;
V_2 -> V_63 . V_74 = ( V_74 * V_75 ) >> V_76 ;
}
if ( V_67 [ V_77 ] ) {
T_2 V_78 = F_38 ( V_67 [ V_77 ] ) ;
V_2 -> V_63 . V_79 = ( V_78 * V_75 ) >> V_76 ;
}
if ( V_67 [ V_80 ] ) {
T_2 V_81 = F_38 ( V_67 [ V_80 ] ) ;
V_2 -> V_63 . V_81 = ( V_81 * V_75 ) >> V_76 ;
}
if ( V_67 [ V_82 ] )
V_9 -> V_49 = F_38 ( V_67 [ V_82 ] ) ;
if ( V_67 [ V_83 ] )
V_2 -> V_63 . V_84 = ! ! F_38 ( V_67 [ V_83 ] ) ;
if ( V_67 [ V_85 ] )
V_2 -> V_48 = F_40 ( 256U , F_38 ( V_67 [ V_85 ] ) ) ;
while ( V_9 -> V_2 . V_37 > V_9 -> V_49 ) {
struct V_3 * V_4 = F_27 ( V_9 ) ;
V_2 -> V_60 . V_64 += F_14 ( V_4 ) ;
F_17 ( V_4 ) ;
V_2 -> V_60 . V_61 ++ ;
}
F_24 ( V_9 , V_2 -> V_60 . V_61 , V_2 -> V_60 . V_64 ) ;
V_2 -> V_60 . V_61 = 0 ;
V_2 -> V_60 . V_64 = 0 ;
F_41 ( V_9 ) ;
return 0 ;
}
static void * F_42 ( T_3 V_86 )
{
void * V_87 = F_43 ( V_86 , V_88 | V_89 ) ;
if ( ! V_87 )
V_87 = F_44 ( V_86 ) ;
return V_87 ;
}
static void F_45 ( void * V_90 )
{
F_46 ( V_90 ) ;
}
...
static int F_49 ( struct V_8 * V_9 , struct V_65 * V_66 )
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
int V_33 ;
V_9 -> V_49 = 10 * 1024 ;
...
V_2 -> V_7 ) )
goto V_96;
if ( V_2 -> V_63 . V_79 != V_97 &&
F_57 ( V_4 , V_77 ,
F_58 ( V_2 -> V_63 . V_79 ) ) )
goto V_96;
return F_59 ( V_4 , V_94 ) ;
V_96:
return - 1 ;
}
static int F_60 ( struct V_8 * V_9 , struct V_98 * V_99 )
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
struct V_100 V_101 = {
. type = V_102 ,
...
struct V_55 * V_103 ;
V_101 . V_104 . V_105 = V_2 -> V_60 . V_105 ;
V_101 . V_104 . V_50 = V_2 -> V_50 ;
V_101 . V_104 . V_62 = V_2 -> V_60 . V_62 ;
V_101 . V_104 . V_46 = V_2 -> V_46 ;
V_101 . V_104 . V_106 = V_2 -> V_60 . V_106 ;
...
static struct V_8 * F_63 ( struct V_8 * V_9 , unsigned long V_109 )
{
return NULL ;
}
...
static unsigned long F_65 ( struct V_8 * V_9 , unsigned long V_110 ,
T_1 V_25 )
{
V_9 -> V_92 &= ~ V_93 ;
return 0 ;
}
static void F_66 ( struct V_8 * V_2 , unsigned long V_111 )
{
}
...
static int F_68 ( struct V_8 * V_9 , unsigned long V_111 ,
struct V_3 * V_4 , struct V_112 * V_113 )
{
V_113 -> V_114 |= F_7 ( V_111 ) ;
return 0 ;
}
static int F_69 ( struct V_8 * V_9 , unsigned long V_111 ,
struct V_98 * V_99 )
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
T_1 V_32 = V_111 - 1 ;
...
V_117 . type = V_118 ;
V_117 . V_119 . V_47 = V_27 -> V_47 ;
V_117 . V_119 . V_120 =
F_58 ( V_27 -> V_54 . V_120 ) ;
V_117 . V_119 . V_121 = V_27 -> V_54 . V_121 ;
V_117 . V_119 . V_122 = V_27 -> V_54 . V_122 ;
V_117 . V_119 . V_123 = V_27 -> V_54 . V_123 ;
if ( V_27 -> V_54 . V_123 ) {
T_5 V_124 = V_27 -> V_54 . V_125 -
F_70 () ;
V_117 . V_119 . V_125 = ( V_124 >= 0 ) ?
F_58 ( V_124 ) :
- F_58 ( - V_124 ) ;
}
while ( V_4 ) {
...
V_116 . V_41 = V_2 -> V_35 [ V_32 ] ;
V_116 . V_126 = V_27 -> V_38 ;
}
if ( F_71 ( V_99 , NULL , & V_116 , 0 ) < 0 )
return - 1 ;
if ( V_32 < V_2 -> V_7 )
return F_62 ( V_99 , & V_117 , sizeof( V_117 ) ) ;
return 0 ;
}
static void F_72 ( struct V_8 * V_9 , struct V_127 * V_109 )
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
unsigned int V_33 ;
if ( V_109 -> V_128 )
...
V_109 -> V_121 < V_109 -> V_129 ) {
V_109 -> V_121 ++ ;
continue;
}
if ( V_109 -> V_130 ( V_9 , V_33 + 1 , V_109 ) < 0 ) {
V_109 -> V_128 = 1 ;
break;
}
V_109 -> V_121 ++ ;
