...
unsigned int V_99 = V_98 -> V_99 . integer . V_99 [ 0 ] ;
...
return 0 ;
V_96 -> V_100 &= ~ ( 0xff << 24 ) ;
V_96 -> V_100 |= ( unsigned int ) V_138 << 24 ;
V_35 = F_64 ( V_41 ) ;
return V_35 < 0 ? V_35 : 1 ;
}
...
if ( ! V_77 || V_77 -> V_169 < 2 )
return - V_63 ;
V_164 = & V_77 -> V_170 [ 1 ] ;
if ( F_95 ( V_164 ) -> V_171 < 1 )
return - V_63 ;
V_165 = F_96 ( V_164 , 0 ) -> V_172 ;
V_35 = F_34 ( V_73 -> V_94 ,
F_29 ( V_73 -> V_94 , 0 ) ,
V_147 ,
V_87 | V_130 | V_86 ,
...
static int F_97 ( struct V_39 * V_41 )
{
struct V_102 * V_73 = V_41 -> V_2 -> V_73 ;
unsigned int V_135 = V_41 -> V_13 -> V_100 ;
V_95 V_177 ;
...
{
struct V_39 * V_41 = F_38 ( V_96 ) ;
unsigned int V_135 , V_179 ;
int V_35 ;
V_135 = V_179 = V_96 -> V_100 ;
V_135 &= 0xfffff0f0 ;
...
static int F_100 ( struct V_12 * V_96 ,
struct V_97 * V_98 )
{
V_98 -> V_99 . integer . V_99 [ 0 ] = ! ( V_96 -> V_100 & 0x02 ) ;
return 0 ;
}
static int F_101 ( struct V_39 * V_41 )
{
struct V_102 * V_73 = V_41 -> V_2 -> V_73 ;
V_95 V_177 = V_41 -> V_13 -> V_100 ;
int V_35 ;
V_35 = F_32 ( V_73 ) ;
if ( V_35 < 0 )
return V_35 ;
...
static int F_102 ( struct V_12 * V_96 ,
struct V_97 * V_98 )
{
struct V_39 * V_41 = F_38 ( V_96 ) ;
V_95 V_177 ;
int V_35 ;
V_177 = V_98 -> V_99 . integer . V_99 [ 0 ] ? 0x28 : 0x2a ;
if ( V_177 != V_41 -> V_13 -> V_100 )
return 0 ;
V_96 -> V_100 = V_177 ;
V_35 = F_101 ( V_41 ) ;
return V_35 < 0 ? V_35 : 1 ;
...
for ( V_70 = 0 ; V_70 < F_21 ( V_181 ) ; ++ V_70 ) {
V_35 = F_9 ( V_2 , 0 ,
V_180 [ V_70 ] ,
& V_181 [ V_70 ] ,
NULL ) ;
...
if ( V_35 < 0 )
break;
if ( ! F_105 ( V_2 -> V_73 -> V_75 , L_39 , & V_111 ) )
F_106 ( V_111 , V_2 ,
F_41 ) ;
break;
...
struct V_12 * V_13 )
{
static const F_112 ( V_186 ,
0 , 1 , F_113 ( - 5300 , - 4970 ) ,
2 , 5 , F_113 ( - 4710 , - 4160 ) ,
6 , 7 , F_113 ( - 3884 , - 3710 ) ,
8 , 14 , F_113 ( - 3443 , - 2560 ) ,
15 , 16 , F_113 ( - 2475 , - 2324 ) ,
17 , 19 , F_113 ( - 2228 , - 2031 ) ,
20 , 26 , F_113 ( - 1910 , - 1393 ) ,
27 , 31 , F_113 ( - 1322 , - 1032 ) ,
32 , 40 , F_113 ( - 968 , - 490 ) ,
41 , 50 , F_113 ( - 441 , 0 ) ,
) ;
F_114 ( V_2 -> V_73 , L_41 ) ;
V_13 -> V_27 . V_187 = V_186 ;
V_13 -> V_29 [ 0 ] . V_30 |= V_31 ;
V_13 -> V_29 [ 0 ] . V_30 &= ~ V_32 ;
}
void F_115 ( struct V_1 * V_2 ,
struct V_10 * V_11 , int V_3 ,
struct V_12 * V_13 )
{
switch ( V_2 -> V_73 -> V_72 ) {
case F_33 ( 0x21b4 , 0x0081 ) :
if ( V_3 == 7 && V_11 -> V_18 == 0 && V_11 -> V_19 == 50 )
F_111 ( V_2 , V_13 ) ;
break;
}
}
