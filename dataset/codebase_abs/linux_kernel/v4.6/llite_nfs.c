...
static int F_32 ( struct V_8 * V_8 , T_1 * V_43 , int * V_44 ,
struct V_8 * V_34 )
{
int V_45 = sizeof( struct V_46 ) / 4 ;
struct V_46 * V_47 = ( void * ) V_43 ;
F_10 ( V_24 , L_7 V_25 L_8 ,
V_8 -> V_48 , F_11 ( F_33 ( V_8 ) ) , * V_44 , V_45 ) ;
if ( * V_44 < V_45 ) {
* V_44 = V_45 ;
return V_49 ;
}
...
if ( V_75 != V_52 )
return F_14 ( - V_76 ) ;
return F_21 ( V_12 , & V_47 -> V_50 , & V_47 -> V_51 ) ;
}
...
if ( V_75 != V_52 )
return F_14 ( - V_76 ) ;
return F_21 ( V_12 , & V_47 -> V_51 , NULL ) ;
}
...
F_51 ( V_22 ) ;
if ( V_23 ) {
F_18 ( L_11 , V_23 , V_67 -> V_48 ) ;
return F_14 ( V_23 ) ;
}
V_79 = F_52 ( & V_18 -> V_84 , & V_85 ) ;
F_48 ( V_79 -> V_86 & V_87 ) ;
F_10 ( V_24 , L_12 V_25 L_13 V_25 L_6 ,
F_11 ( F_33 ( V_67 ) ) , F_11 ( & V_79 -> V_88 ) ) ;
V_35 = F_21 ( V_67 -> V_82 , & V_79 -> V_88 , NULL ) ;
F_20 ( V_18 ) ;
return V_35 ;
}
