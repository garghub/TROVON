...
if ( F_110 ( V_10 ) )
goto V_320;
V_241 = F_111 ( V_10 -> V_19 ) ;
V_231 -> V_321 . V_322 ++ ;
}
if ( F_112 ( V_231 , V_241 + 4 + 1 ) ) {
V_231 -> V_321 . V_323 ++ ;
return V_324 ;
}
if ( F_113 ( V_10 , V_231 , & V_281 ) )
goto V_320;
V_301 = & V_231 -> V_325 [ V_231 -> V_238 ] ;
...
static int F_115 ( struct V_56 * V_57 , int V_331 )
{
F_116 ( V_57 , L_35 ) ;
return - V_114 ;
}
static int F_117 ( struct V_56 * V_57 ,
T_8 V_332 )
{
struct V_58 * V_59 = F_26 ( V_57 ) ;
struct V_109 * V_60 = V_59 -> V_60 ;
...
void F_120 ( struct V_56 * V_57 , struct V_109 * V_60 )
{
...
V_57 -> V_332 |= V_338 ;
V_57 -> V_336 |= V_338 ;
V_57 -> V_339 |= V_57 -> V_332 ;
V_57 -> V_340 |= V_341 ;
V_57 -> V_340 |= V_342 ;
F_121 ( V_57 -> V_343 , L_36 , V_344 - 1 ) ;
V_57 -> V_345 = V_88 ;
F_122 ( V_57 , & V_28 -> V_34 -> V_35 ) ;
F_123 ( V_57 , & V_346 ) ;
V_57 -> V_347 = 1 ;
F_124 ( & V_60 -> V_348 ) ;
F_125 ( V_60 , V_67 -> V_349 . V_350 , 0 , false , false ) ;
F_125 ( V_60 , ( T_2 [ 6 ] ) V_351 , 0 , false , false ) ;
F_125 ( V_60 , V_352 , 0 , false , false ) ;
F_125 ( V_60 , V_353 , 0 , false , false ) ;
F_126 ( & V_60 -> V_348 ) ;
F_127 ( V_57 -> V_354 , V_67 -> V_349 . V_350 ) ;
F_127 ( V_57 -> V_355 , V_67 -> V_349 . V_350 ) ;
V_57 -> V_356 = & V_357 ;
}
void F_128 ( struct V_27 * V_28 )
{
struct V_109 * V_60 ;
T_1 V_148 ;
int V_97 ;
if ( ! ( V_28 -> V_32 & V_69 ) )
return;
for ( V_97 = 0 ; V_97 < V_28 -> V_358 ; V_97 ++ ) {
V_60 = V_28 -> V_60 [ V_97 ] ;
...
V_148 = V_28 -> V_60 [ V_28 -> V_359 ] -> V_148 ;
V_60 = F_129 ( V_28 , V_135 , V_148 , 0 ) ;
if ( V_60 ) {
F_29 ( & V_28 -> V_34 -> V_35 ,
L_38 ,
