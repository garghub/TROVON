...
struct V_52 *
F_157 ( struct V_14 * V_14 , struct V_292 * V_293 )
{
int type ;
if ( V_293 -> V_2 < 0 ) {
...
void F_158 ( struct V_14 * V_14 , struct V_208 * V_209 ,
struct V_52 * V_53 ,
struct V_292 * V_293 )
{
void * V_189 = V_293 -> V_189 ;
...
void F_159 ( struct V_14 * V_14 , struct V_208 * V_209 ,
struct V_52 * V_53 ,
struct V_292 * V_293 ,
bool V_316 )
{
...
struct V_292 * V_293 )
{
static const char * V_327 = L_168 ;
int V_140 ;
F_122 ( V_209 , L_169 , V_53 -> V_72 ) ;
V_140 = strlen ( V_53 -> V_72 ) ;
if ( V_140 < 20 )
F_122 ( V_209 , L_170 , 20 - V_140 , V_327 ) ;
...
{
struct V_52 * V_53 ;
V_53 = F_157 ( V_14 , V_293 ) ;
if ( ! V_53 ) {
F_50 ( L_171 ,
F_107 ( V_14 , V_293 -> V_189 ) ) ;
return;
}
F_158 ( V_14 , V_209 , V_53 , V_293 ) ;
F_159 ( V_14 , V_209 , V_53 , V_293 , V_316 ) ;
...
static int F_162 ( const void * V_8 , const void * V_9 )
{
struct V_52 * const * V_328 = V_8 ;
struct V_52 * const * V_329 = V_9 ;
int V_330 ;
...
static int F_163 ( const void * V_8 , const void * V_9 )
{
struct V_52 * const * V_328 = V_8 ;
struct V_52 * const * V_329 = V_9 ;
int V_330 ;
...
struct V_52 * * F_164 ( struct V_14 * V_14 , enum V_331 V_332 )
{
struct V_52 * * V_54 ;
int (* F_165)( const void * V_8 , const void * V_9 );
V_54 = V_14 -> V_333 ;
...
qsort ( V_54 , V_14 -> V_55 , sizeof( * V_54 ) , F_165 ) ;
V_14 -> V_137 = V_332 ;
return V_54 ;
}
static struct V_126 * *
F_166 ( const char * type , const char * V_72 ,
...
struct V_126 * * F_167 ( struct V_52 * V_53 )
{
return F_166 ( L_174 , V_53 -> V_72 ,
V_53 -> V_150 . V_152 ,
V_53 -> V_150 . V_151 ) ;
}
struct V_126 * * F_168 ( struct V_52 * V_53 )
{
return F_166 ( L_175 , V_53 -> V_72 ,
V_53 -> V_150 . V_153 ,
V_53 -> V_150 . V_129 ) ;
}
static void F_169 ( struct V_208 * V_209 , struct V_62 * V_71 )
{
F_122 ( V_209 , L_176 , V_71 -> V_64 , V_71 -> V_65 ) ;
if ( V_71 -> V_22 ) {
F_125 ( V_209 , L_142 ) ;
F_169 ( V_209 , V_71 -> V_22 ) ;
}
}
static void F_170 ( struct V_7 * args )
{
int V_337 = 1 ;
struct V_208 V_209 ;
switch ( args -> type ) {
...
case V_73 :
printf ( L_179 ) ;
F_170 ( args -> V_74 . V_71 ) ;
printf ( L_180 , args -> V_74 . V_75 ) ;
F_117 ( & V_209 ) ;
F_169 ( & V_209 , args -> V_74 . V_74 ) ;
F_171 ( & V_209 ) ;
F_119 ( & V_209 ) ;
printf ( L_70 ) ;
break;
case V_76 :
printf ( L_181 ) ;
F_170 ( args -> V_77 . V_71 ) ;
printf ( L_142 ) ;
F_117 ( & V_209 ) ;
F_169 ( & V_209 , args -> V_77 . V_78 ) ;
F_171 ( & V_209 ) ;
F_119 ( & V_209 ) ;
printf ( L_70 ) ;
break;
...
case V_81 :
printf ( L_183 ) ;
F_170 ( args -> V_82 . V_71 ) ;
printf ( L_142 ) ;
F_170 ( args -> V_82 . V_83 ) ;
printf ( L_142 ) ;
F_170 ( args -> V_82 . V_84 ) ;
printf ( L_70 ) ;
break;
case V_87 :
case V_88 :
...
if ( V_337 )
printf ( L_85 ) ;
F_170 ( args -> V_96 . V_97 ) ;
printf ( L_187 , args -> V_96 . V_96 ) ;
F_170 ( args -> V_96 . V_98 ) ;
if ( V_337 )
printf ( L_70 ) ;
break;
default:
...
static void F_172 ( const char * V_71 ,
...
int F_173 ( struct V_14 * V_14 , char * V_1 , unsigned long V_2 ,
int V_149 )
{
int V_340 ;
if ( ! V_2 ) {
...
F_1 ( V_1 , V_2 ) ;
F_172 ( L_188 , & V_14 -> V_345 ,
& V_14 -> V_341 , 1 ) ;
F_172 ( L_189 , & V_14 -> V_346 ,
& V_14 -> V_342 , 1 ) ;
F_172 ( L_190 , & V_14 -> V_347 ,
& V_340 , 0 ) ;
F_172 ( L_191 , & V_14 -> V_343 ,
& V_14 -> V_348 , 1 ) ;
return 0 ;
}
static int F_174 ( struct V_52 * V_53 ,
...
static void F_175 ( struct V_351 * V_352 )
{
free ( ( void * ) V_352 -> V_349 ) ;
free ( ( void * ) V_352 -> V_350 ) ;
free ( V_352 ) ;
}
static int F_176 ( struct V_14 * V_14 , struct V_52 * V_53 )
{
struct V_351 * V_352 , * * V_22 ;
for ( V_22 = & V_14 -> V_353 ; * V_22 ;
V_22 = & ( * V_22 ) -> V_22 ) {
V_352 = * V_22 ;
if ( F_174 ( V_53 , V_352 -> V_56 ,
V_352 -> V_349 ,
V_352 -> V_350 ) )
break;
}
...
enum V_354 F_178 ( struct V_52 * * V_355 ,
...
static enum V_354
F_179 ( struct V_14 * V_14 ,
struct V_52 * * V_355 ,
const char * V_1 , unsigned long V_2 ,
const char * V_203 )
{
int V_124 = F_178 ( V_355 , V_14 , V_1 , V_2 , V_203 ) ;
...
#define F_180 0
if ( F_180 && V_53 -> V_186 . args )
F_170 ( V_53 -> V_186 . args ) ;
return 0 ;
V_364:
F_181 ( V_53 ) ;
return V_124 ;
}
enum V_354 F_182 ( struct V_14 * V_14 ,
struct V_52 * * V_355 ,
const char * V_1 ,
unsigned long V_2 , const char * V_203 )
{
return F_179 ( V_14 , V_355 , V_1 , V_2 , V_203 ) ;
}
enum V_354 F_183 ( struct V_14 * V_14 , const char * V_1 ,
unsigned long V_2 , const char * V_203 )
{
struct V_52 * V_53 = NULL ;
return F_179 ( V_14 , & V_53 , V_1 , V_2 , V_203 ) ;
}
int F_184 ( struct V_14 * V_14 V_161 ,
enum V_354 V_365 , char * V_1 , T_2 V_366 )
{
int V_367 ;
const char * V_368 ;
if ( V_365 >= 0 ) {
V_368 = F_185 ( V_365 , V_1 , V_366 ) ;
if ( V_368 != V_1 ) {
T_2 V_140 = strlen ( V_368 ) ;
memcpy ( V_1 , V_368 , F_186 ( V_366 - 1 , V_140 ) ) ;
* ( V_1 + F_186 ( V_366 - 1 , V_140 ) ) = '\0' ;
}
return 0 ;
}
if ( V_365 <= V_369 ||
...
int F_187 ( struct V_208 * V_209 , struct V_126 * V_71 ,
...
void * F_188 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
int * V_140 , int V_185 )
{
struct V_126 * V_71 ;
...
int F_189 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
unsigned long long * V_170 , int V_185 )
{
struct V_126 * V_71 ;
...
return - 1 ;
V_71 = F_87 ( V_53 , V_72 ) ;
return F_187 ( V_209 , V_71 , V_72 , V_293 , V_170 , V_185 ) ;
}
...
int F_192 ( struct V_208 * V_209 , const char * V_50 ,
...
static struct V_52 * F_196 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 ,
const char * V_350 )
{
struct V_52 * V_53 ;
...
int F_197 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
struct V_52 * V_53 ;
struct V_351 * V_352 ;
V_53 = F_196 ( V_14 , V_56 , V_349 , V_350 ) ;
if ( V_53 == NULL )
goto V_381;
F_177 ( L_192 ,
V_53 -> V_56 , V_53 -> system , V_53 -> V_72 ) ;
...
static int F_198 ( struct V_351 * V_313 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
...
int F_199 ( struct V_14 * V_14 , int V_56 ,
const char * V_349 , const char * V_350 ,
T_5 V_35 , void * V_315 )
{
struct V_52 * V_53 ;
...
V_352 = * V_22 ;
if ( F_198 ( V_352 , V_56 , V_349 , V_350 ,
V_35 , V_315 ) )
break;
}
if ( ! ( * V_22 ) )
...
static void F_203 ( struct V_126 * V_71 )
{
struct V_126 * V_22 ;
while ( V_71 ) {
V_22 = V_71 -> V_22 ;
...
static void F_204 ( struct V_150 * V_150 )
{
F_203 ( V_150 -> V_151 ) ;
F_203 ( V_150 -> V_129 ) ;
}
void F_181 ( struct V_52 * V_53 )
{
free ( V_53 -> V_72 ) ;
free ( V_53 -> system ) ;
F_204 ( & V_53 -> V_150 ) ;
