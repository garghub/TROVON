...
case 50 : V_75 = V_81 ; break;
case 75 : V_75 = V_82 ; break;
case 110 : V_75 = V_83 ; break;
case 150 : V_75 = V_84 ; break;
case 200 : V_75 = V_85 ; break;
case 300 : V_75 = V_86 ; break;
case 600 : V_75 = V_87 ; break;
case 1200 : V_75 = V_88 ; break;
case 1800 : V_75 = V_89 ; break;
case 2400 : V_75 = V_90 ; break;
case 4800 : V_75 = V_91 ; break;
case 9600 : V_75 = V_92 ; break;
case 19200 : V_75 = V_93 ; break;
case 38400 : V_75 = V_94 ; break;
case 57600 : V_75 = V_95 ; break;
case 115200 : V_75 = V_96 ; break;
case 230400 : V_75 = V_97 ; break;
case 460800 : V_75 = V_98 ; break;
default:
V_75 = V_92 ;
V_77 = 9600 ;
break;
...
V_60 -> V_69 . V_72 &= ~ V_100 ;
if ( ( V_71 & ( V_101 | V_102 ) ) != ( V_74 & ( V_101 | V_102 ) ) ) {
if ( V_71 & V_101 ) {
if ( V_71 & V_102 )
V_75 = V_103 ;
else
...
if ( ( V_71 & V_107 ) != ( V_74 & V_107 ) ) {
V_75 = - 1 ;
switch ( V_71 & V_107 ) {
case V_108 : V_75 = V_109 ; break;
case V_110 : V_75 = V_111 ; break;
case V_112 : V_75 = V_113 ; break;
case V_114 : V_75 = V_115 ; break;
default:
F_14 ( V_26 ,
L_7 ,
( V_71 & V_107 ) ) ;
...
if ( ( V_68 & V_121 ) != ( V_73 & V_121 )
|| ( V_71 & V_122 ) != ( V_74 & V_122 ) ) {
V_75 = 0 ;
if ( V_68 & V_121 )
V_75 |= V_123 ;
else
...
static void F_33 ( struct V_59 * V_60 , int V_134 )
{
struct V_12 * V_13 = V_60 -> V_61 ;
...
static void F_39 ( struct V_142 * V_142 )
{
...
static void F_45 ( struct V_12 * V_13 , int V_150 )
{
...
F_41 ( & V_10 -> V_161 ) ;
F_52 ( & V_10 -> V_15 ) ;
F_53 ( & V_13 -> V_23 -> V_157 ) ;
}
static int F_47 ( struct V_144 * V_23 )
{
int V_76 , V_19 = 0 ;
...
static int F_54 ( struct V_12 * V_13 , unsigned V_166 )
{
struct V_9 * V_10 ;
V_10 = F_55 ( sizeof( * V_10 ) , V_165 ) ;
if ( ! V_10 )
return - V_167 ;
F_56 ( & V_10 -> V_15 ) ;
V_10 -> V_27 = V_166 ;
...
static int F_60 ( struct V_144 * V_23 )
{
struct V_67 * V_26 = & V_23 -> V_168 -> V_26 ;
struct V_22 * V_145 ;
int V_19 ;
int V_76 ;
if ( V_23 -> V_169 < V_23 -> type -> V_164 + 1 ) {
F_18 ( V_26 , L_18 ) ;
return - V_170 ;
}
for ( V_76 = 0 ; V_76 < V_23 -> type -> V_164 + 1 ; V_76 ++ ) {
...
static void F_64 ( struct V_144 * V_23 )
{
struct V_22 * V_145 ;
struct V_9 * V_10 ;
V_145 = F_12 ( V_23 ) ;
...
static void F_67 ( struct V_142 * V_142 )
{
struct V_12 * V_13 = V_142 -> V_143 ;
struct V_9 * V_10 ;
struct V_22 * V_145 ;
...
static int F_69 ( struct V_142 * V_142 )
{
struct V_12 * V_13 = V_142 -> V_143 ;
struct V_9 * V_10 = F_13 ( V_13 ) ;
int V_172 = ( ( unsigned char * ) V_142 -> V_35 ) [ 0 ] ;
int V_20 = ( ( unsigned char * ) V_142 -> V_35 ) [ 1 ] ;
int V_173 = ( ( unsigned char * ) V_142 -> V_35 ) [ 2 ] ;
unsigned char * V_39 = ( ( unsigned char * ) V_142 -> V_35 ) + 3 ;
int V_174 , V_175 ;
int V_146 = V_142 -> V_146 ;
if ( V_142 -> V_146 == - V_176 )
return 0 ;
if ( V_142 -> V_177 != V_20 + 2 ) {
F_18 ( & V_13 -> V_26 , L_26
L_27
L_28 , V_38 , V_146 ,
V_10 -> V_27 , V_172 , V_20 , V_142 -> V_177 ,
V_173 ) ;
return - 1 ;
}
F_22 ( & V_10 -> V_15 ) ;
...
F_14 ( & V_13 -> V_26 , L_30 , V_38 , V_172 ) ;
return V_175 ? 1 : 0 ;
}
...
struct V_59 * V_60 ;
struct V_9 * V_10 = F_13 ( V_13 ) ;
int V_172 , line , V_146 , V_136 ;
int V_76 ;
unsigned int V_188 ;
for ( V_76 = 0 ; V_76 < V_142 -> V_177 - 3 ; ) {
V_172 = ( ( unsigned char * ) V_142 -> V_35 ) [ V_76 ++ ] ;
line = ( ( unsigned char * ) V_142 -> V_35 ) [ V_76 ++ ] ;
V_146 = ( ( unsigned char * ) V_142 -> V_35 ) [ V_76 ++ ] ;
V_136 = ( ( unsigned char * ) V_142 -> V_35 ) [ V_76 ++ ] ;
F_14 ( & V_13 -> V_26 , L_31 ,
V_172 , line , V_146 , V_136 ) ;
