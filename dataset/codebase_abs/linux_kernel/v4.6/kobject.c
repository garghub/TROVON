...
int F_40 ( struct V_1 * V_2 , const char * V_37 , ... )
{
T_2 V_38 ;
int V_42 ;
va_start ( V_38 , V_37 ) ;
...
void F_41 ( struct V_1 * V_2 , struct V_8 * V_6 )
{
char * V_43 ;
if ( ! V_2 ) {
V_43 = L_11 ;
...
F_41 ( V_2 , V_6 ) ;
va_start ( args , V_37 ) ;
V_42 = F_45 ( V_2 , V_18 , V_37 , args ) ;
va_end ( args ) ;
return V_42 ;
}
int F_46 ( struct V_1 * V_2 , const char * V_45 )
{
int error = 0 ;
...
V_49 [ 0 ] = V_48 ;
V_49 [ 1 ] = NULL ;
V_34 = V_47 = F_48 ( V_45 , V_40 ) ;
if ( ! V_34 ) {
error = - V_41 ;
goto V_50;
}
error = F_49 ( V_2 , V_45 , F_1 ( V_2 ) ) ;
if ( error )
goto V_50;
V_47 = V_2 -> V_34 ;
V_2 -> V_34 = V_34 ;
...
int F_52 ( struct V_1 * V_2 , struct V_1 * V_52 )
{
int error ;
struct V_1 * V_53 ;
const char * V_46 = NULL ;
...
static struct V_1 * T_3 F_57 ( struct V_1 * V_2 )
{
if ( ! F_58 ( & V_2 -> V_28 ) )
V_2 = NULL ;
return V_2 ;
...
static void F_64 ( struct V_28 * V_28 )
{
struct V_1 * V_2 = F_62 ( V_28 , struct V_1 , V_28 ) ;
#ifdef F_65
unsigned long V_60 = V_61 + V_61 * ( F_66 () & 0x3 ) ;
F_67 ( L_27 ,
...
struct V_1 * F_73 ( const char * V_34 , struct V_1 * V_18 )
{
struct V_1 * V_2 ;
int V_42 ;
V_2 = F_72 () ;
...
void F_75 ( struct V_24 * V_63 )
{
F_28 ( & V_63 -> V_2 ) ;
F_30 ( & V_63 -> V_27 ) ;
F_76 ( & V_63 -> V_25 ) ;
}
static T_4 F_77 ( struct V_1 * V_2 , struct V_10 * V_11 ,
char * V_64 )
{
struct V_65 * V_66 ;
T_4 V_67 = - V_68 ;
V_66 = F_62 ( V_11 , struct V_65 , V_11 ) ;
if ( V_66 -> V_69 )
V_67 = V_66 -> V_69 ( V_2 , V_66 , V_64 ) ;
return V_67 ;
}
static T_4 F_78 ( struct V_1 * V_2 , struct V_10 * V_11 ,
...
struct V_1 * F_81 ( struct V_24 * V_24 , const char * V_34 )
{
struct V_1 * V_63 ;
struct V_1 * V_67 = NULL ;
F_22 ( & V_24 -> V_25 ) ;
F_82 (k, &kset->list, entry) {
...
{
struct V_24 * V_24 = F_62 ( V_2 , struct V_24 , V_2 ) ;
F_17 ( L_32 ,
F_15 ( V_2 ) , V_2 , V_21 ) ;
F_51 ( V_24 ) ;
}
static struct V_24 * F_84 ( const char * V_34 ,
...
struct V_24 * F_85 ( const char * V_34 ,
const struct V_74 * V_75 ,
struct V_1 * V_76 )
{
struct V_24 * V_24 ;
int error ;
V_24 = F_84 ( V_34 , V_75 , V_76 ) ;
if ( ! V_24 )
return NULL ;
error = F_79 ( V_24 ) ;
if ( error ) {
...
int F_86 ( const struct V_3 * V_14 )
{
...
const void * F_91 ( enum V_78 type , struct V_86 * V_87 )
{
const void * V_85 = NULL ;
F_22 ( & V_79 ) ;
if ( ( type > V_5 ) && ( type < V_16 ) &&
V_81 [ type ] )
V_85 = V_81 [ type ] -> F_92 ( V_87 ) ;
F_24 ( & V_79 ) ;
return V_85 ;
}
const void * F_93 ( enum V_78 type )
{
const void * V_85 = NULL ;
F_22 ( & V_79 ) ;
if ( ( type > V_5 ) && ( type < V_16 ) &&
...
void F_95 ( enum V_78 type , void * V_85 )
{
F_22 ( & V_79 ) ;
if ( ( type > V_5 ) && ( type < V_16 ) &&
