...
static void F_223 ( struct V_13 * V_14 , void * V_107 , bool V_474 )
{
struct V_4 * V_5 = (struct V_4 * ) V_107 ;
struct V_12 * V_16 ;
if ( F_45 ( ! V_474 ) )
...
F_226 ( V_5 -> V_7 ) ;
F_64 ( V_5 -> V_7 ) ;
F_151 ( V_5 -> V_21 . V_21 [ 0 ] , F_223 , V_5 ) ;
if ( V_5 -> V_470 ) {
F_217 ( V_5 -> V_470 ) ;
V_5 -> V_470 = NULL ;
}
...
static void F_230 ( int V_475 )
{
V_476 [ V_475 ] -- ;
}
static int F_231 ( int V_477 )
{
...
F_47 ( & V_2 -> V_10 , L_137 ,
V_501 , F_242 ( V_2 -> V_492 ) , F_244 ( & V_2 -> V_10 ) ,
F_245 ( F_246 () ) , F_246 () ) ;
...
F_259 ( & V_5 -> V_117 [ 0 ] . V_117 , V_510 ) ;
F_259 ( & V_5 -> V_117 [ 1 ] . V_117 , V_511 ) ;
F_259 ( & V_5 -> V_117 [ 2 ] . V_117 , V_512 ) ;
F_259 ( & V_5 -> V_117 [ 3 ] . V_117 , V_513 ) ;
F_259 ( & V_5 -> V_117 [ 4 ] . V_117 , V_514 ) ;
F_259 ( & V_5 -> V_117 [ 5 ] . V_117 , V_515 ) ;
F_259 ( & V_5 -> V_117 [ 6 ] . V_117 , V_516 ) ;
F_259 ( & V_5 -> V_117 [ 7 ] . V_117 , V_517 ) ;
F_260 ( V_2 ) ;
V_61 = F_261 ( V_2 ) ;
if ( V_61 ) {
F_5 ( & V_2 -> V_10 ,
...
static int F_272 ( struct V_1 * V_2 , T_15 V_521 )
{
int V_61 = 0 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( ! V_5 ) {
