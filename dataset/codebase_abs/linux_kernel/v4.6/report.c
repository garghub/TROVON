...
static bool F_21 ( const void * V_54 , const void * V_55 )
{
return ( V_54 <= V_55 ) && ( V_55 < V_54 + V_56 ) ;
}
static int F_22 ( const void * V_54 , const void * V_57 )
{
return 3 + ( V_58 / 8 ) * 2 + ( V_57 - V_54 ) * 2 +
( V_57 - V_54 ) / V_59 + 1 ;
}
static void F_23 ( const void * V_1 )
{
int V_60 ;
const void * V_57 = F_2 ( V_1 ) ;
const void * V_61 ;
V_61 = ( void * ) F_24 ( ( unsigned long ) V_57 ,
V_56 )
- V_62 * V_56 ;
F_4 ( L_21 ) ;
for ( V_60 = - V_62 ; V_60 <= V_62 ; V_60 ++ ) {
const void * V_63 = F_25 ( V_61 ) ;
char V_64 [ 4 + ( V_58 / 8 ) * 2 ] ;
char V_65 [ V_56 ] ;
snprintf ( V_64 , sizeof( V_64 ) ,
( V_60 == 0 ) ? L_22 : L_23 , V_63 ) ;
memcpy ( V_65 , V_61 , V_56 ) ;
F_26 ( V_66 , V_64 ,
V_67 , V_56 , 1 ,
V_65 , V_56 , 0 ) ;
if ( F_21 ( V_61 , V_57 ) )
...
if ( V_7 -> V_10 <
F_25 ( ( void * ) V_69 ) ) {
if ( ( unsigned long ) V_7 -> V_10 < V_70 )
V_8 = L_26 ;
else if ( ( unsigned long ) V_7 -> V_10 < V_71 )
V_8 = L_27 ;
else
V_8 = L_28 ;
F_4 ( L_29 ,
...
{
F_33 ( V_1 , V_2 , false , V_74 ) ;
}
void F_37 ( unsigned long V_1 , T_1 V_2 )
{
F_33 ( V_1 , V_2 , true , V_74 ) ;
}
