...
static inline bool F_31 ( const struct V_77 * V_78 )
{
static const struct V_25 V_121 ;
return V_78 -> V_122 == sizeof( struct V_77 ) &&
memcmp ( & V_78 -> V_66 , & V_121 , sizeof( V_121 ) ) == 0 ;
}
static int F_32 ( const struct V_94 * V_123 ,
unsigned int V_124 , void * V_125 )
{
unsigned int V_86 ;
for ( V_86 = 0 ; V_86 < V_126 ; V_86 ++ ) {
unsigned int V_127 = V_123 -> V_102 [ V_86 ] ;
struct V_77 * V_78
= (struct V_77 * ) ( V_125 + V_127 ) ;
if ( ! ( V_124 & ( 1 << V_86 ) ) )
continue;
V_78 -> V_111 . V_128 = V_127 ;
for (; ; ) {
const struct V_116 * V_108
= ( void * ) F_14 ( V_78 ) ;
int V_129 = V_78 -> V_130 & ( 1 << V_86 ) ;
if ( V_78 -> V_130 & ( 1 << V_126 ) ) {
F_33 ( L_20 ,
V_86 , V_127 , V_78 -> V_130 ) ;
return 0 ;
}
V_78 -> V_130
|= ( ( 1 << V_86 ) | ( 1 << V_126 ) ) ;
...
V_78 -> V_130 ^= ( 1 << V_126 ) ;
V_133 = V_127 ;
V_127 = V_78 -> V_111 . V_128 ;
V_78 -> V_111 . V_128 = 0 ;
if ( V_127 == V_133 )
goto V_136;
V_78 = (struct V_77 * )
( V_125 + V_127 ) ;
} while ( V_133 == V_127 + V_78 -> V_82 );
V_134 = V_78 -> V_82 ;
V_78 = (struct V_77 * )
( V_125 + V_127 + V_134 ) ;
V_78 -> V_111 . V_128 = V_127 ;
...
static inline int F_34 ( const struct V_77 * V_78 )
{
const struct V_76 * V_108 ;
if ( ! F_10 ( & V_78 -> V_66 ) )
return - V_138 ;
if ( V_78 -> V_122 + sizeof( struct V_76 ) > V_78 -> V_82 )
return - V_138 ;
V_108 = F_14 ( V_78 ) ;
if ( V_78 -> V_122 + V_108 -> V_112 . V_139 > V_78 -> V_82 )
return - V_138 ;
return 0 ;
}
...
struct V_143 * V_114 ;
int V_10 ;
V_78 -> V_111 . V_128 = F_38 () ;
if ( F_39 ( V_78 -> V_111 . V_128 ) )
return - V_144 ;
V_108 = F_15 ( V_78 ) ;
V_114 = F_40 ( V_106 , V_108 -> V_112 . V_131 . V_99 ,
V_108 -> V_112 . V_131 . V_145 ) ;
if ( F_41 ( V_114 ) ) {
F_11 ( L_28 , V_108 -> V_112 . V_131 . V_99 ) ;
V_10 = F_42 ( V_114 ) ;
goto V_100;
}
...
if ( V_146 )
return V_146 ;
for ( V_152 = 0 ; V_152 < V_126 ; V_152 ++ ) {
if ( ! ( V_124 & ( 1 << V_152 ) ) )
continue;
if ( ( unsigned char * ) V_78 - V_79 == V_150 [ V_152 ] )
V_123 -> V_102 [ V_152 ] = V_150 [ V_152 ] ;
...
static int F_50 ( struct V_94 * V_123 , void * V_125 ,
const struct V_155 * V_156 )
{
struct V_77 * V_157 ;
unsigned int V_9 ;
int V_10 = 0 ;
V_123 -> V_134 = V_156 -> V_134 ;
V_123 -> V_158 = V_156 -> V_159 ;
for ( V_9 = 0 ; V_9 < V_126 ; V_9 ++ ) {
V_123 -> V_102 [ V_9 ] = 0xFFFFFFFF ;
V_123 -> V_118 [ V_9 ] = 0xFFFFFFFF ;
}
F_11 ( L_34 , V_123 -> V_134 ) ;
V_9 = 0 ;
F_51 (iter, entry0, newinfo->size) {
V_10 = F_46 ( V_157 , V_123 , V_125 ,
V_125 + V_156 -> V_134 ,
V_156 -> V_102 ,
V_156 -> V_118 ,
V_156 -> V_124 ) ;
...
if ( ! F_32 ( V_123 , V_156 -> V_124 , V_125 ) ) {
F_11 ( L_39 ) ;
return - V_162 ;
}
V_9 = 0 ;
...
V_108 = F_14 ( V_78 ) ;
if ( F_62 ( V_170 + V_171 + V_78 -> V_122
+ F_63 ( struct V_76 ,
V_112 . V_131 . V_99 ) ,
V_108 -> V_112 . V_113 . V_114 -> V_99 ,
...
V_123 -> V_102 [ V_9 ] -= V_171 ;
if ( V_2 -> V_118 [ V_9 ] &&
( V_78 < (struct V_77 * ) ( V_79 + V_2 -> V_118 [ V_9 ] ) ) )
V_123 -> V_118 [ V_9 ] -= V_171 ;
}
return 0 ;
}
...
if ( ! V_123 || ! V_2 )
return - V_138 ;
memcpy ( V_123 , V_2 , F_63 ( struct V_94 , V_101 ) ) ;
V_123 -> V_181 = 0 ;
V_173 = V_2 -> V_101 ;
F_72 ( V_106 , V_2 -> V_158 ) ;
F_51 (iter, loc_cpu_entry, info->size) {
V_10 = F_68 ( V_157 , V_2 , V_173 , V_123 ) ;
if ( V_10 != 0 )
return V_10 ;
}
return 0 ;
...
V_188 . V_99 [ sizeof( V_188 . V_99 ) - 1 ] = '\0' ;
...
V_193 = F_85 ( V_108 , V_191 , V_123 , & V_10 ) ;
if ( ! V_193 )
goto V_196;
F_11 ( L_47 ,
V_193 -> V_158 , V_193 -> V_181 , V_123 -> V_158 ) ;
if ( ( V_193 -> V_158 > V_193 -> V_181 ) ||
( V_123 -> V_158 <= V_193 -> V_181 ) )
F_43 ( V_108 -> V_147 ) ;
if ( ( V_193 -> V_158 > V_193 -> V_181 ) &&
( V_123 -> V_158 <= V_193 -> V_181 ) )
F_43 ( V_108 -> V_147 ) ;
...
V_10 = F_50 ( V_123 , V_173 , & V_165 ) ;
if ( V_10 != 0 )
goto V_198;
F_11 ( L_49 ) ;
V_10 = F_84 ( V_103 , V_165 . V_99 , V_165 . V_124 , V_123 ,
...
F_28 ( * V_165 , V_201 [ V_9 ] . V_166 , V_201 [ V_9 ] . V_128 ) ;
++ V_9 ;
}
F_29 ( V_97 ) ;
V_205:
...
V_209 -> V_122 = V_78 -> V_122 - ( V_210 - * V_134 ) ;
V_108 = F_93 ( V_78 ) ;
V_114 = V_108 -> V_112 . V_113 . V_114 ;
F_96 ( V_108 , V_208 , V_134 ) ;
V_209 -> V_82 = V_78 -> V_82 - ( V_210 - * V_134 ) ;
for ( V_152 = 0 ; V_152 < V_126 ; V_152 ++ ) {
if ( ( unsigned char * ) V_209 - V_79 < V_123 -> V_102 [ V_152 ] )
V_123 -> V_102 [ V_152 ] -= V_210 - * V_134 ;
if ( ( unsigned char * ) V_209 - V_79 < V_123 -> V_118 [ V_152 ] )
V_123 -> V_118 [ V_152 ] -= V_210 - * V_134 ;
}
return V_10 ;
}
...
goto V_198;
V_10 = - V_162 ;
if ( ! F_32 ( V_123 , V_124 , V_214 ) )
goto V_198;
V_9 = 0 ;
F_51 (iter1, entry1, newinfo->size) {
V_216 -> V_111 . V_128 = F_38 () ;
if ( F_39 ( V_216 -> V_111 . V_128 ) ) {
V_10 = - V_144 ;
break;
}
V_10 = F_35 ( V_216 , V_99 ) ;
if ( V_10 != 0 ) {
F_44 ( V_216 -> V_111 . V_128 ) ;
break;
}
++ V_9 ;
...
V_10 = F_97 ( V_165 . V_99 , V_165 . V_124 ,
& V_123 , & V_173 , V_165 . V_134 ,
...
* V_134 -= sizeof( struct V_77 ) - sizeof( struct V_180 ) ;
V_122 = V_78 -> V_122 - ( V_210 - * V_134 ) ;
V_108 = F_15 ( V_78 ) ;
V_10 = F_105 ( V_108 , V_208 , V_134 ) ;
if ( V_10 )
return V_10 ;
V_82 = V_78 -> V_82 - ( V_210 - * V_134 ) ;
if ( F_106 ( V_122 , & V_228 -> V_122 ) != 0 ||
...
static void F_113 ( struct V_1 * V_85 )
{
struct V_94 * V_95 ;
void * V_173 ;
struct V_235 * V_236 = V_85 -> V_147 ;
struct V_77 * V_157 ;
V_95 = F_114 ( V_85 ) ;
V_173 = V_95 -> V_101 ;
...
void * V_173 ;
struct V_1 * V_241 ;
V_123 = F_89 ( V_156 -> V_134 ) ;
if ( ! V_123 )
return - V_144 ;
V_173 = V_123 -> V_101 ;
memcpy ( V_173 , V_156 -> V_101 , V_156 -> V_134 ) ;
V_10 = F_50 ( V_123 , V_173 , V_156 ) ;
F_11 ( L_62 , V_10 ) ;
if ( V_10 != 0 )
goto V_242;
V_241 = F_116 ( V_103 , V_85 , & V_240 , V_123 ) ;
if ( F_41 ( V_241 ) ) {
V_10 = F_42 ( V_241 ) ;
goto V_242;
}
F_117 ( * V_239 , V_241 ) ;
V_10 = F_118 ( V_103 , V_238 , F_119 ( V_85 -> V_124 ) ) ;
if ( V_10 != 0 ) {
F_113 ( V_241 ) ;
* V_239 = NULL ;
}
...
void F_120 ( struct V_103 * V_103 , struct V_1 * V_85 ,
const struct V_237 * V_238 )
{
F_121 ( V_103 , V_238 , F_119 ( V_85 -> V_124 ) ) ;
F_113 ( V_85 ) ;
}
static int T_9 F_122 ( struct V_103 * V_103 )
{
return F_123 ( V_103 , V_106 ) ;
}
static void T_10 F_124 ( struct V_103 * V_103 )
{
F_125 ( V_103 , V_106 ) ;
}
