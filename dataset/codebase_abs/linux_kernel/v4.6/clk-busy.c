...
{
struct V_9 * div = F_6 ( V_8 ) ;
return F_7 ( div , struct V_6 , div ) ;
}
...
static long F_9 ( struct V_7 * V_8 , unsigned long V_14 ,
unsigned long * V_15 )
{
struct V_6 * V_11 = F_5 ( V_8 ) ;
return V_11 -> V_12 -> V_16 ( & V_11 -> div . V_8 , V_14 , V_15 ) ;
}
static int F_10 ( struct V_7 * V_8 , unsigned long V_14 ,
unsigned long V_10 )
{
struct V_6 * V_11 = F_5 ( V_8 ) ;
int V_17 ;
...
V_19 = F_14 ( NULL , & V_11 -> div . V_8 ) ;
if ( F_15 ( V_19 ) )
F_16 ( V_11 ) ;
return V_19 ;
}
static inline struct V_38 * F_17 ( struct V_7 * V_8 )
{
struct V_39 * V_40 = F_18 ( V_8 ) ;
return F_7 ( V_40 , struct V_38 , V_40 ) ;
}
static T_2 F_19 ( struct V_7 * V_8 )
{
struct V_38 * V_11 = F_17 ( V_8 ) ;
return V_11 -> V_41 -> V_42 ( & V_11 -> V_40 . V_8 ) ;
}
static int F_20 ( struct V_7 * V_8 , T_2 V_43 )
{
struct V_38 * V_11 = F_17 ( V_8 ) ;
int V_17 ;
...
struct V_19 * F_21 ( const char * V_20 , void T_1 * V_1 , T_2 V_2 ,
