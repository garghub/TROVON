...
{
V_110 -> V_112 . V_113 = V_111 ;
V_110 -> V_112 . V_103 = V_105 -> V_103 ;
V_110 -> V_112 . V_104 = V_105 -> V_104 ;
F_62 ( V_2 , & V_110 -> V_82 ) ;
F_63 ( V_110 -> V_82 . V_114 , V_110 -> V_3 ,
V_110 -> V_112 . V_113 ) ;
}
void F_64 ( struct V_1 * V_2 , unsigned int V_3 ,
struct V_109 * V_110 )
{
F_2 ( & V_2 -> V_115 ) ;
V_110 -> V_3 = V_3 ;
V_110 -> V_112 . V_113 = F_56 ( V_2 , V_3 ) ;
F_65 ( & V_110 -> V_82 . V_116 , & V_2 -> V_117 ) ;
}
void F_66 ( struct V_71 * V_72 ,
struct V_109 * V_110 )
{
F_64 ( V_72 -> V_2 , F_43 ( V_72 ) , V_110 ) ;
}
...
V_110 -> V_3 = V_3 ;
V_110 -> V_82 . V_114 = V_131 -> V_114 ;
V_110 -> V_112 . V_82 . type = V_132 ;
V_110 -> V_112 . V_82 . V_133 = sizeof( V_110 -> V_112 ) ;
V_110 -> V_112 . V_134 = V_129 -> V_135 . signal ;
F_16 ( & V_2 -> V_115 , V_18 ) ;
if ( ! V_9 -> V_28 ) {
V_36 = - V_54 ;
goto V_136;
}
V_36 = F_97 ( V_2 , V_64 , & V_110 -> V_82 ,
& V_110 -> V_112 . V_82 ) ;
if ( V_36 )
goto V_136;
V_111 = F_58 ( V_2 , V_3 , & V_105 ) ;
if ( ( V_129 -> V_135 . type & V_137 ) &&
( V_111 - V_129 -> V_135 . V_113 ) <= ( 1 << 23 ) ) {
V_129 -> V_135 . V_113 = V_111 + 1 ;
V_129 -> V_138 . V_113 = V_129 -> V_135 . V_113 ;
}
F_19 ( L_31 ,
V_129 -> V_135 . V_113 , V_111 , V_3 ) ;
F_98 ( V_131 -> V_114 , V_3 ,
V_129 -> V_135 . V_113 ) ;
V_110 -> V_112 . V_113 = V_129 -> V_135 . V_113 ;
if ( ( V_111 - V_129 -> V_135 . V_113 ) <= ( 1 << 23 ) ) {
F_74 ( V_2 , V_3 ) ;
F_61 ( V_2 , V_110 , V_111 , & V_105 ) ;
V_129 -> V_138 . V_113 = V_111 ;
} else {
F_65 ( & V_110 -> V_82 . V_116 , & V_2 -> V_117 ) ;
V_129 -> V_138 . V_113 = V_129 -> V_135 . V_113 ;
}
...
int V_36 ;
unsigned int V_18 , V_111 , V_3 , V_139 ;
if ( ! V_2 -> V_47 )
return - V_54 ;
if ( V_129 -> V_135 . type & V_140 )
return - V_54 ;
if ( V_129 -> V_135 . type &
~ ( V_141 | V_142 |
V_143 ) ) {
...
V_18 = V_129 -> V_135 . type & V_142 ;
V_139 = ( V_129 -> V_135 . type & V_143 ) ;
if ( V_139 )
V_3 = V_139 >> V_144 ;
else
V_3 = V_18 & V_145 ? 1 : 0 ;
...
V_111 = F_56 ( V_2 , V_3 ) ;
switch ( V_129 -> V_135 . type & V_141 ) {
case V_146 :
V_129 -> V_135 . V_113 += V_111 ;
V_129 -> V_135 . type &= ~ V_146 ;
case V_147 :
break;
default:
V_36 = - V_54 ;
...
if ( V_18 & V_149 ) {
return F_95 ( V_2 , V_3 , V_129 , V_64 ) ;
}
if ( ( V_18 & V_137 ) &&
( V_111 - V_129 -> V_135 . V_113 ) <= ( 1 << 23 ) ) {
V_129 -> V_135 . V_113 = V_111 + 1 ;
...
V_9 -> V_150 = V_129 -> V_135 . V_113 ;
F_99 ( V_36 , V_9 -> V_41 , 3 * V_121 ,
( ( ( F_56 ( V_2 , V_3 ) -
...
if ( V_36 != - V_151 ) {
struct V_5 V_105 ;
V_129 -> V_138 . V_113 = F_58 ( V_2 , V_3 , & V_105 ) ;
V_129 -> V_138 . V_152 = V_105 . V_103 ;
V_129 -> V_138 . V_153 = V_105 . V_104 ;
F_19 ( L_35 ,
V_129 -> V_138 . V_113 ) ;
} else {
F_19 ( L_36 ) ;
...
if ( V_110 -> V_3 != V_3 )
continue;
if ( ( V_111 - V_110 -> V_112 . V_113 ) > ( 1 << 23 ) )
continue;
F_19 ( L_37 ,
V_110 -> V_112 . V_113 , V_111 ) ;
F_86 ( & V_110 -> V_82 . V_116 ) ;
...
bool F_103 ( struct V_71 * V_72 )
{
return F_102 ( V_72 -> V_2 , F_43 ( V_72 ) ) ;
}
