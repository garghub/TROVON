...
V_2 -> V_83 = V_204 -> V_83 ;
if ( ( V_123 = F_155 ( V_17 , V_368 , V_2 , & V_233 ) ) < 0 ) {
F_112 ( V_2 ) ;
return V_123 ;
}
* V_334 = V_2 ;
...
int V_123 ;
struct V_373 * V_196 ;
V_123 = F_160 ( & V_204 -> V_18 , V_374 , V_375 , V_376 , 0 , & V_17 ) ;
if ( V_123 < 0 )
return V_123 ;
if ( V_218 < 0 )
V_218 = F_156 ( V_204 ) ;
...
if ( ( V_123 = F_146 ( V_17 , V_204 , V_372 -> V_378 ,
& V_2 ) ) < 0 ) {
F_161 ( V_17 ) ;
return V_123 ;
}
