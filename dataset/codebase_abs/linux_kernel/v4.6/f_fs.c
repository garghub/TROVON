...
F_188 ( V_275 , struct V_235 * , V_391 ,
V_385 ? V_7 -> V_211 + 1 : 0 ) ;
F_188 ( V_275 , struct V_235 * , V_392 ,
V_386 ? V_7 -> V_212 + 1 : 0 ) ;
F_188 ( V_275 , struct V_235 * , V_393 ,
V_387 ? V_7 -> V_213 + 1 : 0 ) ;
F_188 ( V_275 , short , V_394 , V_7 -> V_215 ) ;
F_188 ( V_275 , struct V_355 , V_356 ,
V_377 -> V_217 -> V_395 ? V_7 -> V_215 : 0 ) ;
F_188 ( V_275 , char [ 16 ] , V_396 ,
V_377 -> V_217 -> V_395 ? V_7 -> V_215 : 0 ) ;
F_188 ( V_275 , struct V_397 , V_358 ,
V_377 -> V_217 -> V_395 ? V_7 -> V_215 : 0 ) ;
...
V_7 -> V_210 ) ;
memset ( F_165 ( V_325 , V_275 , V_394 ) , 0xff , V_398 ) ;
for ( V_20 = V_7 -> V_205 ; V_20 ; -- V_20 ) {
struct V_89 * V_39 ;
V_39 = F_165 ( V_325 , V_275 , V_231 ) ;
V_39 [ V_20 ] . V_133 = - 1 ;
}
V_77 -> V_231 = F_165 ( V_325 , V_275 , V_231 ) ;
V_77 -> V_353 = F_165 ( V_325 , V_275 , V_394 ) ;
if ( F_39 ( V_385 ) ) {
V_77 -> V_4 . V_347 = F_165 ( V_325 , V_275 , V_391 ) ;
...
if ( F_39 ( V_386 ) ) {
V_77 -> V_4 . V_346 = F_165 ( V_325 , V_275 , V_392 ) ;
...
if ( F_39 ( V_387 ) ) {
V_77 -> V_4 . V_345 = F_165 ( V_325 , V_275 , V_393 ) ;
...
unsigned V_300 , unsigned V_402 )
{
struct V_1 * V_77 = F_1 ( V_3 ) ;
struct V_6 * V_7 = V_77 -> V_7 ;
int V_20 = 0 , V_403 ;
if ( V_402 != ( unsigned ) - 1 ) {
V_403 = F_46 ( V_77 , V_300 ) ;
if ( F_12 ( V_403 < 0 ) )
return V_403 ;
}
if ( V_7 -> V_77 )
...
int V_20 ;
F_20 () ;
F_16 ( L_53 , V_405 -> V_53 ) ;
F_16 ( L_54 , V_405 -> V_406 ) ;
F_16 ( L_55 , F_8 ( V_405 -> V_407 ) ) ;
F_16 ( L_56 , F_8 ( V_405 -> V_285 ) ) ;
F_16 ( L_57 , F_8 ( V_405 -> V_24 ) ) ;
if ( V_7 -> V_45 != V_50 )
return - V_78 ;
switch ( V_405 -> V_53 & V_408 ) {
case V_409 :
V_20 = F_46 ( V_77 , F_8 ( V_405 -> V_285 ) ) ;
if ( F_12 ( V_20 < 0 ) )
return V_20 ;
break;
case V_410 :
V_20 = F_195 ( V_77 , F_8 ( V_405 -> V_285 ) ) ;
if ( F_12 ( V_20 < 0 ) )
return V_20 ;
if ( V_77 -> V_7 -> V_227 & V_228 )
...
return V_133 ? V_133 : - V_412 ;
}
static int F_46 ( struct V_1 * V_77 , T_8 V_403 )
{
short * V_413 = V_77 -> V_353 ;
unsigned V_64 = V_77 -> V_7 -> V_215 ;
for (; V_64 ; -- V_64 , ++ V_413 ) {
if ( * V_413 >= 0 && * V_413 == V_403 )
return V_413 - V_77 -> V_353 ;
}
return - V_412 ;
}
...
struct V_200 * V_382 ;
if ( F_202 ( & V_414 ) ) {
V_382 = F_203 ( & V_414 , struct V_200 , V_374 ) ;
if ( V_382 -> V_415 )
return V_382 ;
}
return NULL ;
...
static inline struct V_375 * F_205 ( struct V_416 * V_417 )
{
return F_2 ( F_206 ( V_417 ) , struct V_375 ,
V_380 . V_418 ) ;
}
static void F_207 ( struct V_416 * V_417 )
{
struct V_375 * V_186 = F_205 ( V_417 ) ;
F_208 ( & V_186 -> V_380 ) ;
}
static void F_209 ( struct V_419 * V_3 )
{
struct V_375 * V_186 ;
V_186 = F_210 ( V_3 ) ;
F_183 () ;
...
static int F_212 ( struct V_419 * V_379 , const char * V_166 )
{
struct V_375 * V_186 ;
char * V_39 ;
const char * V_420 ;
...
V_420 = NULL ;
F_183 () ;
V_420 = V_186 -> V_382 -> V_423 ? V_186 -> V_382 -> V_166 : NULL ;
...
V_186 -> V_382 -> V_423 = true ;
F_184 () ;
F_33 ( V_420 ) ;
return 0 ;
}
static struct V_419 * F_215 ( void )
{
struct V_375 * V_186 ;
struct V_200 * V_382 ;
...
if ( ! V_186 )
return F_99 ( - V_69 ) ;
V_186 -> V_380 . V_424 = F_212 ;
V_186 -> V_380 . V_425 = F_209 ;
F_183 () ;
V_382 = F_216 () ;
F_184 () ;
if ( F_23 ( V_382 ) ) {
...
static struct V_2 * F_220 ( struct V_419 * V_379 )
{
struct V_1 * V_77 ;
F_20 () ;
...
return F_99 ( - V_69 ) ;
V_77 -> V_4 . V_166 = L_59 ;
V_77 -> V_4 . V_427 = F_190 ;
V_77 -> V_4 . V_428 = F_219 ;
V_77 -> V_4 . V_429 = F_192 ;
V_77 -> V_4 . V_430 = F_193 ;
V_77 -> V_4 . V_23 = F_194 ;
V_77 -> V_4 . V_431 = F_197 ;
V_77 -> V_4 . V_432 = F_198 ;
V_77 -> V_4 . V_433 = F_218 ;
return & V_77 -> V_4 ;
}
...
V_438 -> V_6 = V_7 ;
if ( V_438 -> V_439 ) {
V_20 = V_438 -> V_439 ( V_7 ) ;
if ( V_20 )
goto V_116;
}
F_226 ( V_440 , & V_7 -> V_195 ) ;
V_116:
F_184 () ;
return V_20 ;
}
...
goto V_116;
if ( V_186 -> V_381 || ! V_186 -> V_380 . V_418 . V_442 . V_443
|| ! F_122 ( & V_186 -> V_380 . V_418 . V_442 . V_444 . V_445 ) )
goto V_116;
F_228 ( V_438 -> V_186 ->
V_380 . V_418 . V_442 . V_443 -> V_443 ) ;
V_116:
F_184 () ;
}
static int F_21 ( struct V_42 * V_42 , unsigned V_446 )
{
return V_446
