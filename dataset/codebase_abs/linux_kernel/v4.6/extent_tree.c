...
static T_2 F_34 ( struct V_36 * V_37 , T_2 V_57 )
{
if ( V_37 -> V_58 )
return sizeof( V_59 ) + V_60 * V_57 ;
else
return sizeof( V_59 ) + V_61 * V_57 ;
}
static void F_35 ( struct V_62 * V_63 ,
T_2 V_64 )
{
if ( V_63 -> V_65 != & V_63 -> V_66 ) {
int V_67 = F_36 ( V_64 , V_68 ) , V_69 ;
...
static V_59 * F_39 ( struct V_1 * V_7 , V_59 * V_25 )
{
V_25 = F_40 ( V_25 , V_7 -> V_16 -> V_71 . V_72 ,
V_73 ) ;
V_25 = F_41 ( V_25 , V_7 -> V_8 << V_74 ) ;
V_25 = F_41 ( V_25 , V_7 -> V_9 << V_74 ) ;
V_25 = F_41 ( V_25 , 0LL ) ;
* V_25 ++ = F_42 ( V_39 ) ;
return V_25 ;
}
static V_59 * F_43 ( struct V_1 * V_7 , V_59 * V_25 )
{
V_25 = F_41 ( V_25 , V_7 -> V_8 << V_74 ) ;
return F_41 ( V_25 , V_7 -> V_9 << V_74 ) ;
}
static int F_44 ( struct V_36 * V_37 , V_59 * V_25 ,
T_2 V_64 , T_2 * V_57 )
{
struct V_1 * V_7 ;
int V_51 = 0 ;
...
{
struct V_36 * V_37 = F_46 ( F_47 ( V_63 -> V_77 ) -> V_78 ) ;
T_2 V_57 = 0 , V_64 = V_68 ;
V_59 * V_70 ;
int V_51 ;
F_25 ( L_2 , V_79 ) ;
V_63 -> V_66 = F_48 ( V_80 ) ;
...
V_63 -> V_65 = & V_63 -> V_66 ;
V_45:
V_51 = F_44 ( V_37 , V_70 + 1 , V_64 , & V_57 ) ;
if ( F_50 ( V_51 ) ) {
F_35 ( V_63 , V_64 ) ;
V_64 = F_34 ( V_37 , V_57 ) ;
V_57 = 0 ;
...
* V_70 = F_42 ( V_57 ) ;
V_63 -> V_83 = F_34 ( V_37 , V_57 ) ;
if ( F_50 ( V_63 -> V_65 != & V_63 -> V_66 ) ) {
void * V_25 = V_70 , * V_28 = V_25 + V_63 -> V_83 ;
struct V_81 * V_81 = NULL ;
int V_69 = 0 ;
V_63 -> V_70 = V_70 ;
for ( ; V_25 < V_28 ; V_25 += V_68 ) {
V_81 = F_53 ( V_25 ) ;
V_63 -> V_65 [ V_69 ++ ] = V_81 ;
F_54 ( V_81 ) ;
}
...
void
F_55 ( struct V_62 * V_63 , int V_84 )
{
struct V_36 * V_37 = F_46 ( F_47 ( V_63 -> V_77 ) -> V_78 ) ;
struct V_5 * V_6 = & V_37 -> V_40 ;
struct V_1 * V_7 ;
