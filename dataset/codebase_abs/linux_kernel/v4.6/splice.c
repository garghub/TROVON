...
if ( ! V_39 )
break;
V_69 = F_43 (unsigned long, len, PAGE_SIZE - loff) ;
V_5 = V_21 . V_36 [ V_26 ] ;
if ( F_44 ( V_5 ) )
...
V_82 = F_55 () ;
F_56 ( F_57 () ) ;
V_84 = F_58 ( V_54 , ( const struct V_79 V_85 * ) V_80 , V_81 , & V_83 , 0 ) ;
F_56 ( V_82 ) ;
return V_84 ;
}
...
T_3 V_39 ;
int V_49 , V_10 , V_98 ;
V_137 = F_90 ( V_55 ) -> V_137 ;
if ( F_42 ( ! F_91 ( V_137 ) && ! F_92 ( V_137 ) ) )
return - V_101 ;
V_2 = V_29 -> V_138 ;
if ( F_42 ( ! V_2 ) ) {
V_2 = F_93 () ;
...
{
struct V_54 * V_54 = V_96 -> V_97 . V_54 ;
return F_84 ( V_2 , V_54 , V_96 -> V_141 , V_96 -> V_104 ,
V_96 -> V_10 ) ;
}
long F_95 ( struct V_54 * V_55 , T_2 * V_56 , struct V_54 * V_115 ,
T_2 * V_141 , T_3 V_39 , unsigned int V_10 )
{
struct V_95 V_96 = {
. V_39 = V_39 ,
. V_104 = V_39 ,
...
long V_24 ;
if ( F_42 ( ! ( V_115 -> V_131 & V_142 ) ) )
return - V_133 ;
if ( F_42 ( V_115 -> V_143 & V_144 ) )
return - V_101 ;
V_24 = F_88 ( V_128 , V_115 , V_141 , V_39 ) ;
if ( F_42 ( V_24 < 0 ) )
return V_24 ;
...
static long F_96 ( struct V_54 * V_55 , T_2 V_85 * V_145 ,
struct V_54 * V_115 , T_2 V_85 * V_146 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_1 * V_147 ;
struct V_1 * V_148 ;
...
if ( ! ( V_55 -> V_131 & V_132 ) )
return - V_133 ;
if ( ! ( V_115 -> V_131 & V_142 ) )
return - V_133 ;
if ( V_147 == V_148 )
return - V_101 ;
return F_98 ( V_147 , V_148 , V_39 , V_10 ) ;
}
if ( V_147 ) {
if ( V_145 )
return - V_149 ;
if ( V_146 ) {
if ( ! ( V_115 -> V_131 & V_150 ) )
return - V_101 ;
if ( F_99 ( & V_37 , V_146 , sizeof( T_2 ) ) )
return - V_151 ;
} else {
V_37 = V_115 -> V_152 ;
}
...
return V_24 ;
F_100 ( V_115 ) ;
V_24 = F_84 ( V_147 , V_115 , & V_37 , V_39 , V_10 ) ;
F_101 ( V_115 ) ;
if ( ! V_146 )
V_115 -> V_152 = V_37 ;
else if ( F_102 ( V_146 , & V_37 , sizeof( T_2 ) ) )
V_24 = - V_151 ;
return V_24 ;
}
if ( V_148 ) {
...
V_24 = F_86 ( V_55 , & V_37 , V_148 , V_39 , V_10 ) ;
if ( ! V_145 )
V_55 -> V_152 = V_37 ;
...
static int F_103 ( const struct V_79 V_85 * V_154 ,
unsigned int V_155 , struct V_5 * * V_36 ,
struct V_52 * V_38 , bool V_156 ,
unsigned int V_157 )
{
int V_32 = 0 , error = 0 ;
while ( V_155 ) {
...
int V_49 ;
error = - V_151 ;
if ( F_99 ( & V_160 , V_154 , sizeof( V_160 ) ) )
break;
V_161 = V_160 . V_93 ;
V_39 = V_160 . V_94 ;
error = 0 ;
...
break;
error = - V_151 ;
if ( ! F_104 ( V_162 , V_161 , V_39 ) )
break;
V_158 = ( unsigned long ) V_161 & ~ V_65 ;
error = - V_101 ;
if ( V_156 && ( V_158 || V_39 & ~ V_65 ) )
break;
V_159 = ( V_158 + V_39 + V_66 - 1 ) >> V_64 ;
if ( V_159 > V_157 - V_32 )
V_159 = V_157 - V_32 ;
error = F_105 ( ( unsigned long ) V_161 , V_159 ,
0 , & V_36 [ V_32 ] ) ;
if ( F_42 ( error <= 0 ) )
break;
for ( V_49 = 0 ; V_49 < error ; V_49 ++ ) {
const int V_76 = F_43 ( T_3 , V_39 , V_66 - V_158 ) ;
V_38 [ V_32 ] . V_37 = V_158 ;
V_38 [ V_32 ] . V_39 = V_76 ;
V_158 = 0 ;
V_39 -= V_76 ;
V_32 ++ ;
...
return V_121 == V_96 -> V_39 ? V_121 : - V_151 ;
}
static long F_108 ( struct V_54 * V_54 , const struct V_79 V_85 * V_163 ,
unsigned long V_164 , unsigned int V_10 )
{
struct V_1 * V_2 ;
struct V_95 V_96 ;
long V_24 ;
struct V_79 V_165 [ V_166 ] ;
struct V_79 * V_154 = V_165 ;
struct V_119 V_167 ;
V_2 = F_97 ( V_54 ) ;
if ( ! V_2 )
return - V_133 ;
V_24 = F_109 ( V_134 , V_163 , V_164 ,
F_110 ( V_165 ) , & V_154 , & V_167 ) ;
if ( V_24 < 0 )
return V_24 ;
V_96 . V_104 = F_111 ( & V_167 ) ;
V_96 . V_39 = 0 ;
V_96 . V_10 = V_10 ;
V_96 . V_97 . V_129 = & V_167 ;
V_96 . V_83 = 0 ;
if ( V_96 . V_104 ) {
F_22 ( V_2 ) ;
...
static long F_112 ( struct V_54 * V_54 , const struct V_79 V_85 * V_154 ,
unsigned long V_164 , unsigned int V_10 )
{
struct V_1 * V_2 ;
struct V_5 * V_36 [ V_51 ] ;
...
if ( F_29 ( V_2 , & V_21 ) )
return - V_53 ;
V_21 . V_23 = F_103 ( V_154 , V_164 , V_21 . V_36 ,
V_21 . V_38 , false ,
V_21 . V_50 ) ;
if ( V_21 . V_23 <= 0 )
V_24 = V_21 . V_23 ;
...
static int F_98 ( struct V_1 * V_147 ,
struct V_1 * V_148 ,
T_3 V_39 , unsigned int V_10 )
{
...
bool V_172 = false ;
V_173:
V_24 = F_113 ( V_147 , V_10 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_114 ( V_148 , V_10 ) ;
if ( V_24 )
return V_24 ;
F_115 ( V_147 , V_148 ) ;
do {
...
if ( ! V_147 -> V_31 && ! V_147 -> V_114 )
break;
if ( ! V_147 -> V_31 || V_148 -> V_31 >= V_148 -> V_32 ) {
if ( V_24 )
break;
if ( V_10 & V_44 ) {
V_24 = - V_45 ;
...
V_169 = V_147 -> V_35 + V_147 -> V_34 ;
V_171 = ( V_148 -> V_34 + V_148 -> V_31 ) & ( V_148 -> V_32 - 1 ) ;
V_170 = V_148 -> V_35 + V_171 ;
if ( V_39 >= V_169 -> V_39 ) {
* V_170 = * V_169 ;
V_169 -> V_41 = NULL ;
V_148 -> V_31 ++ ;
V_147 -> V_34 = ( V_147 -> V_34 + 1 ) & ( V_147 -> V_32 - 1 ) ;
V_147 -> V_31 -- ;
V_172 = true ;
} else {
V_169 -> V_41 -> V_174 ( V_147 , V_169 ) ;
* V_170 = * V_169 ;
V_170 -> V_10 &= ~ V_15 ;
V_170 -> V_39 = V_39 ;
V_148 -> V_31 ++ ;
V_169 -> V_37 += V_170 -> V_39 ;
V_169 -> V_39 -= V_170 -> V_39 ;
}
V_24 += V_170 -> V_39 ;
V_39 -= V_170 -> V_39 ;
} while ( V_39 );
...
static int F_116 ( struct V_1 * V_147 ,
struct V_1 * V_148 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_3 * V_169 , * V_170 ;
int V_24 = 0 , V_49 = 0 , V_171 ;
F_115 ( V_147 , V_148 ) ;
do {
if ( ! V_148 -> V_27 ) {
F_23 ( V_28 , V_29 , 0 ) ;
...
if ( V_49 >= V_147 -> V_31 || V_148 -> V_31 >= V_148 -> V_32 )
break;
V_169 = V_147 -> V_35 + ( ( V_147 -> V_34 + V_49 ) & ( V_147 -> V_32 - 1 ) ) ;
V_171 = ( V_148 -> V_34 + V_148 -> V_31 ) & ( V_148 -> V_32 - 1 ) ;
V_169 -> V_41 -> V_174 ( V_147 , V_169 ) ;
V_170 = V_148 -> V_35 + V_171 ;
* V_170 = * V_169 ;
...
unsigned int V_10 )
{
struct V_1 * V_147 = F_97 ( V_55 ) ;
struct V_1 * V_148 = F_97 ( V_115 ) ;
int V_24 = - V_101 ;
if ( V_147 && V_148 && V_147 != V_148 ) {
V_24 = F_113 ( V_147 , V_10 ) ;
if ( ! V_24 ) {
V_24 = F_114 ( V_148 , V_10 ) ;
if ( ! V_24 )
V_24 = F_116 ( V_147 , V_148 , V_39 , V_10 ) ;
}
}
return V_24 ;
}
