...
static int F_110 ( struct V_54 * V_55 , unsigned long V_185 ,
struct V_1 * V_6 , struct V_186 * V_187 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
if ( V_185 != 1 || ! V_15 -> V_108 )
return - V_188 ;
V_187 -> V_189 |= F_111 ( 1 ) ;
V_187 -> V_190 = V_15 -> V_108 -> V_191 ;
return 0 ;
}
static int F_112 ( struct V_54 * V_55 , unsigned long V_192 , struct V_54 * V_193 ,
struct V_54 * * V_194 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
* V_194 = F_113 ( V_55 , V_193 , & V_15 -> V_108 ) ;
return 0 ;
}
static struct V_54 * F_114 ( struct V_54 * V_55 , unsigned long V_192 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
return V_15 -> V_108 ;
}
static unsigned long F_115 ( struct V_54 * V_55 , T_1 V_195 )
{
return 1 ;
}
static void F_116 ( struct V_54 * V_55 , unsigned long V_192 )
{
}
static void F_117 ( struct V_54 * V_55 , struct V_196 * V_197 )
{
if ( ! V_197 -> V_198 ) {
if ( V_197 -> V_75 >= V_197 -> V_199 )
if ( V_197 -> V_200 ( V_55 , 1 , V_197 ) < 0 ) {
V_197 -> V_198 = 1 ;
return;
}
V_197 -> V_75 ++ ;
