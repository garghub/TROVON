...
{
struct V_2 * V_63 = F_81 ( V_140 ) ;
struct V_1 * V_36 = F_1 ( V_63 ) ;
F_21 ( V_36 -> V_112 ) ;
F_21 ( V_36 -> V_73 ) ;
F_21 ( V_36 ) ;
}
static int F_82 ( struct V_141 * V_141 )
{
if ( F_83 ( & V_141 -> V_142 ) != 0 )
return 1 ;
if ( F_84 ( & V_141 -> V_142 ) & ~ ( V_143 | V_144 ) )
return 1 ;
if ( F_85 ( & V_141 -> V_142 ) != 0 )
return 1 ;
return 0 ;
}
static struct V_4 * F_86 ( struct V_1 * V_36 ,
int V_72 )
{
struct V_37 * V_7 ;
unsigned long V_9 ;
...
static void F_87 ( struct V_1 * V_36 ,
T_2 V_145 )
{
if ( V_36 -> V_42 & V_145 ) {
switch ( V_145 ) {
...
static void F_90 ( struct V_147 * V_40 ,
unsigned long V_45 ,
struct V_141 * V_141 )
{
T_2 V_145 = V_45 & V_46 ;
struct V_1 * V_36 = F_91 ( & V_40 -> V_63 ) ;
int V_8 ;
struct V_4 * V_5 ;
if ( ! V_36 )
return;
...
if ( F_96 ( 0 , & V_36 -> V_109 ) ) {
F_97 ( & V_36 -> V_3 ) ;
F_94 ( 0 , & V_36 -> V_109 ) ;
}
}
static int F_98 ( struct V_147 * V_40 )
{
struct V_154 V_155 ;
F_99 ( V_40 , & V_155 ) ;
if ( F_96 ( V_155 . V_156 , V_157 [ V_155 . V_158 ] ) )
return 0 ;
return 1 ;
}
static void F_100 ( void * V_159 , T_10 V_67 )
{
...
static int F_102 ( struct V_147 * V_40 )
{
V_40 -> V_22 = F_90 ;
if ( F_98 ( V_40 ) )
F_103 ( F_100 , V_40 ) ;
...
static struct V_1 * F_104 ( struct V_147 * V_40 )
{
unsigned long V_9 ;
struct V_1 * V_36 ;
F_31 ( F_32 ( V_40 ) , V_9 ) ;
...
static void F_105 ( struct V_147 * V_40 )
{
unsigned long V_9 ;
struct V_1 * V_36 = F_104 ( V_40 ) ;
if ( V_36 && V_40 -> V_161 ) {
if ( V_36 -> V_162 )
F_106 ( & V_36 -> V_3 ) ;
F_107 ( & V_36 -> V_3 ) ;
F_31 ( F_32 ( V_40 ) , V_9 ) ;
F_108 ( & V_40 -> V_63 , NULL ) ;
F_33 ( F_32 ( V_40 ) , V_9 ) ;
}
V_40 -> V_22 = NULL ;
}
static int F_109 ( struct V_147 * V_40 )
{
unsigned long V_9 ;
struct V_1 * V_36 = F_104 ( V_40 ) ;
if ( ! V_36 )
...
static int F_110 ( struct V_1 * V_36 )
{
struct V_163 * V_164 ;
struct V_43 * V_44 ;
int V_39 ;
...
static int F_111 ( struct V_147 * V_40 )
{
int V_39 ;
struct V_1 * V_36 ;
unsigned long V_9 ;
...
static int F_117 ( struct V_147 * V_40 , int V_175 )
{
int V_17 ;
struct V_1 * V_36 = F_91 ( & V_40 -> V_63 ) ;
if ( ! V_36 )
...
static int T_11 F_118 ( char * * V_178 , unsigned int * V_179 , int V_180 ,
int V_181 , int V_182 )
{
int V_183 ;
V_183 = 0 ;
...
static int T_11 F_120 ( char * V_185 , unsigned int * V_186 ,
...
goto V_100;
V_187 = V_185 ;
V_39 = F_118 ( & V_187 , V_186 , 1 , 2 , V_188 ) ;
if ( V_39 || ( V_187 [ 0 ] != '.' ) )
goto V_100;
V_187 ++ ;
V_39 = F_118 ( & V_187 , V_158 , 1 , 1 , V_189 ) ;
if ( V_39 || ( V_187 [ 0 ] != '.' ) )
goto V_100;
V_187 ++ ;
V_39 = F_118 ( & V_187 , V_156 , 4 , 4 , V_190 ) ;
if ( V_39 || ( V_187 [ 0 ] != '\0' ) )
goto V_100;
V_17 = 0 ;
V_100:
...
int V_17 ;
V_185 = V_198 ;
while ( ( V_197 = F_122 ( & V_185 , L_20 ) ) ) {
V_17 = F_120 ( F_122 ( & V_197 , L_21 ) , & V_191 ,
& V_193 , & V_195 ) ;
if ( V_17 )
continue;
if ( V_197 != NULL ) {
V_17 = F_120 ( V_197 , & V_192 ,
& V_194 , & V_196 ) ;
if ( ( V_193 > V_194 ) ||
