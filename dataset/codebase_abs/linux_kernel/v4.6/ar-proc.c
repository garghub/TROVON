...
static int F_14 ( struct V_31 * V_31 , struct V_32 * V_32 )
{
return F_15 ( V_32 , & V_33 ) ;
}
...
V_15 = F_10 ( V_6 , struct V_36 , V_14 ) ;
V_9 = V_15 -> V_9 ;
sprintf ( V_12 , L_4 ,
& V_9 -> V_16 -> V_17 . V_18 . sin . V_19 ,
F_11 ( V_9 -> V_16 -> V_17 . V_18 . sin . V_20 ) ) ;
...
static int F_21 ( struct V_31 * V_31 , struct V_32 * V_32 )
{
return F_15 ( V_32 , & V_42 ) ;
}
