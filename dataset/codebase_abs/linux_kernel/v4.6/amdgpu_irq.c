...
F_27 ( & V_4 -> V_15 , F_8 ) ;
V_4 -> V_20 . V_42 = true ;
V_19 = F_28 ( V_4 -> V_8 , V_4 -> V_8 -> V_41 -> V_20 ) ;
if ( V_19 ) {
V_4 -> V_20 . V_42 = false ;
F_29 ( & V_4 -> V_5 ) ;
return V_19 ;
...
int F_36 ( struct V_3 * V_4 , unsigned V_44 ,
struct V_23 * V_45 )
{
if ( V_44 >= V_22 )
return - V_46 ;
if ( V_4 -> V_20 . V_25 [ V_44 ] != NULL )
return - V_46 ;
if ( ! V_45 -> V_26 )
return - V_46 ;
if ( V_45 -> V_28 && ! V_45 -> V_29 ) {
T_2 * V_47 ;
V_47 = F_37 ( V_45 -> V_28 , sizeof( T_2 ) ,
V_48 ) ;
if ( ! V_47 )
return - V_49 ;
V_45 -> V_29 = V_47 ;
}
V_4 -> V_20 . V_25 [ V_44 ] = V_45 ;
return 0 ;
}
void F_38 ( struct V_3 * V_4 ,
struct V_50 * V_51 )
{
unsigned V_44 = V_51 -> V_44 ;
struct V_23 * V_24 ;
int V_19 ;
if ( V_44 >= V_22 ) {
F_39 ( L_4 , V_44 ) ;
...
if ( V_4 -> V_20 . V_52 [ V_44 ] ) {
F_40 ( F_41 ( V_4 -> V_20 . V_53 , V_44 ) ) ;
} else {
V_24 = V_4 -> V_20 . V_25 [ V_44 ] ;
if ( ! V_24 ) {
F_39 ( L_5 , V_44 ) ;
return;
}
V_19 = V_24 -> V_26 -> V_54 ( V_4 , V_24 , V_51 ) ;
if ( V_19 )
F_13 ( L_6 , V_19 ) ;
}
}
...
V_56 = V_30 ;
V_19 = V_24 -> V_26 -> V_27 ( V_4 , V_24 , type , V_56 ) ;
F_14 ( & V_4 -> V_20 . V_21 , V_16 ) ;
return V_19 ;
}
...
unsigned F_58 ( struct V_3 * V_4 , unsigned V_44 )
{
V_4 -> V_20 . V_52 [ V_44 ] = F_59 ( V_4 -> V_20 . V_53 , V_44 ) ;
return V_4 -> V_20 . V_52 [ V_44 ] ;
}
