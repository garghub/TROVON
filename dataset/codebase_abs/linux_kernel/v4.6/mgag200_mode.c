...
static void F_20 ( struct V_1 * V_2 , unsigned V_107 )
{
struct V_6 * V_7 = V_2 -> V_5 -> V_8 ;
T_2 V_108 ;
int V_109 ;
...
F_21 ( V_108 > 0x1fffff ) ;
V_110 |= ( ! ! ( V_108 & ( 1 << 20 ) ) ) << 6 ;
F_22 ( 0x0d , ( T_1 ) ( V_108 & 0xff ) ) ;
F_22 ( 0x0c , ( T_1 ) ( V_108 >> 8 ) & 0xff ) ;
F_23 ( 0x0 , ( ( T_1 ) ( V_108 >> 16 ) & 0xf ) | V_110 ) ;
}
...
V_115 = V_117 -> V_115 ;
V_119 = F_26 ( V_115 ) ;
V_120 = F_27 ( V_119 , false ) ;
if ( V_120 )
return V_120 ;
F_28 ( V_119 ) ;
F_29 ( V_119 ) ;
}
V_117 = F_25 ( V_2 -> V_11 -> V_10 ) ;
V_115 = V_117 -> V_115 ;
V_119 = F_26 ( V_115 ) ;
V_120 = F_27 ( V_119 , false ) ;
if ( V_120 )
return V_120 ;
V_120 = F_30 ( V_119 , V_122 , & V_121 ) ;
if ( V_120 ) {
F_29 ( V_119 ) ;
return V_120 ;
}
if ( & V_7 -> V_123 -> V_124 == V_117 ) {
V_120 = F_31 ( & V_119 -> V_119 , 0 , V_119 -> V_119 . V_125 , & V_119 -> V_126 ) ;
if ( V_120 )
F_32 ( L_2 ) ;
}
F_29 ( V_119 ) ;
...
static int F_33 ( struct V_1 * V_2 , int V_111 , int V_112 ,
struct V_9 * V_127 )
{
return F_24 ( V_2 , V_127 , V_111 , V_112 , 0 ) ;
}
...
F_11 ( 0x90 , 0 ) ;
if ( V_140 )
F_36 ( V_5 -> V_161 , V_162 , V_140 ) ;
if ( V_141 )
F_36 ( V_5 -> V_161 , V_163 , V_141 ) ;
F_37 ( 2 , 0xf ) ;
F_37 ( 3 , 0 ) ;
F_37 ( 4 , 0xe ) ;
...
F_22 ( 1 , V_131 ) ;
F_22 ( 2 , V_131 ) ;
F_22 ( 3 , ( V_134 & 0x1F ) | 0x80 ) ;
F_22 ( 4 , V_132 ) ;
F_22 ( 5 , ( ( V_134 & 0x20 ) << 2 ) | ( V_133 & 0x1F ) ) ;
F_22 ( 6 , V_138 & 0xFF ) ;
F_22 ( 7 , ( ( V_138 & 0x100 ) >> 8 ) |
( ( V_135 & 0x100 ) >> 7 ) |
( ( V_136 & 0x100 ) >> 6 ) |
( ( V_135 & 0x100 ) >> 5 ) |
( ( V_135 & 0x100 ) >> 4 ) |
...
F_22 ( 15 , 0 ) ;
F_22 ( 16 , V_136 & 0xFF ) ;
F_22 ( 17 , ( V_137 & 0x0F ) | 0x20 ) ;
F_22 ( 18 , V_135 & 0xFF ) ;
F_22 ( 19 , V_139 & 0xFF ) ;
F_22 ( 20 , 0 ) ;
F_22 ( 21 , V_135 & 0xFF ) ;
F_22 ( 22 , ( V_138 + 1 ) & 0xFF ) ;
F_22 ( 23 , 0xc3 ) ;
F_22 ( 24 , V_135 & 0xFF ) ;
V_143 [ 0 ] = 0 ;
V_143 [ 5 ] = 0 ;
...
V_142 = 0x2d ;
F_3 ( V_169 , V_142 ) ;
F_17 ( V_7 , V_129 -> clock ) ;
for ( V_12 = 0 ; V_12 < 6 ; V_12 ++ ) {
F_23 ( V_12 , V_143 [ V_12 ] ) ;
}
if ( V_7 -> type == V_99 )
F_23 ( 0x24 , 0x5 ) ;
if ( V_7 -> type == V_58 )
...
static void F_40 ( struct V_1 * V_2 , int V_129 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_6 * V_7 = V_5 -> V_8 ;
T_1 V_172 = 0 , V_176 = 0 ;
...
static void F_44 ( struct V_1 * V_2 , T_4 * V_185 , T_4 * V_186 ,
...
F_40 ( V_2 , V_180 ) ;
if ( V_2 -> V_11 -> V_10 ) {
struct V_116 * V_117 = F_25 ( V_2 -> V_11 -> V_10 ) ;
struct V_114 * V_115 = V_117 -> V_115 ;
struct V_118 * V_119 = F_26 ( V_115 ) ;
V_120 = F_27 ( V_119 , false ) ;
if ( V_120 )
return;
F_28 ( V_119 ) ;
...
return 0 ;
V_214 = V_129 -> V_131 * V_129 -> V_135 ;
V_212 = V_129 -> V_134 * V_129 -> V_138 ;
V_215 = V_214 * V_129 -> clock * 1000 ;
F_73 ( V_215 , V_212 ) ;
...
if ( V_129 -> V_222 > 2048 || V_129 -> V_223 > 4096 ||
V_129 -> V_224 > 4096 || V_129 -> V_225 > 4096 ||
V_129 -> V_226 > 2048 || V_129 -> V_227 > 4096 ||
V_129 -> V_228 > 4096 || V_129 -> V_229 > 4096 ) {
return V_230 ;
}
...
if ( ( V_129 -> V_131 * V_129 -> V_135 * ( V_174 / 8 ) ) > V_7 -> V_234 . V_235 ) {
if ( V_207 -> V_231 . V_232 )
...
if ( V_237 )
return F_76 ( V_207 -> V_5 , V_237 ) ;
return NULL ;
}
static enum V_239 F_77 ( struct V_192
* V_207 , bool V_240 )
{
return V_241 ;
}
static void F_78 ( struct V_192 * V_207 )
{
struct V_208 * V_208 = F_68 ( V_207 ) ;
F_79 ( V_208 -> V_210 ) ;
F_80 ( V_207 ) ;
...
static struct V_192 * F_81 ( struct V_4 * V_5 )
{
struct V_192 * V_207 ;
struct V_208 * V_208 ;
