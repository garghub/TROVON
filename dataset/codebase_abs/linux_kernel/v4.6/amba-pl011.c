...
V_125 = F_186 ( & V_334 , & V_4 -> V_8 ) ;
if ( V_125 )
F_179 ( V_4 ) ;
return V_125 ;
}
static int F_187 ( struct V_1 * V_2 , const struct V_340 * V_341 )
{
struct V_3 * V_4 ;
...
V_125 = F_182 ( & V_2 -> V_2 , V_4 , & V_2 -> V_348 , V_343 ) ;
if ( V_125 )
return V_125 ;
F_190 ( V_2 , V_4 ) ;
return F_184 ( V_4 ) ;
...
if ( ! V_4 )
return - V_300 ;
return F_198 ( & V_334 , & V_4 -> V_8 ) ;
}
static int F_199 ( struct V_349 * V_350 )
{
struct V_3 * V_4 ;
struct V_335 * V_351 ;
int V_343 , V_125 ;
...
if ( V_343 < 0 )
return V_343 ;
V_4 = F_188 ( & V_350 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_4 -> V_6 = V_353 . V_6 ;
...
V_4 -> V_8 . V_195 = F_200 ( V_350 , 0 ) ;
V_4 -> V_8 . V_252 = & V_354 ;
V_4 -> V_291 = V_352 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_32 ) ;
V_351 = F_201 ( V_350 , V_355 , 0 ) ;
V_125 = F_182 ( & V_350 -> V_2 , V_4 , V_351 , V_343 ) ;
if ( V_125 )
return V_125 ;
F_202 ( V_350 , V_4 ) ;
return F_184 ( V_4 ) ;
}
static int F_203 ( struct V_349 * V_350 )
{
struct V_3 * V_4 = F_204 ( V_350 ) ;
F_193 ( & V_334 , & V_4 -> V_8 ) ;
F_179 ( V_4 ) ;
return 0 ;
}
