...
return F_30 ( V_7 , V_38 , V_23 , V_5 , & V_69 ) ;
}
static T_3 F_51 ( struct V_70 * V_71 , struct V_72 * V_73 ,
T_4 V_46 )
{
struct V_6 * V_7 ;
struct V_37 * V_38 ;
struct V_74 * V_74 = V_71 -> V_75 ;
struct V_5 * V_5 = V_74 -> V_76 -> V_14 ;
struct V_77 * V_10 = F_52 ( V_5 ) ;
T_3 V_78 = F_53 ( V_73 ) ;
T_3 V_79 = 0 , V_22 = 0 ;
struct V_80 * V_81 = F_7 ( V_5 ) ;
long V_25 = V_82 ;
int V_11 ;
if ( ! V_81 -> V_83 )
return - V_84 ;
if ( ( V_46 & ~ V_85 ) || ( V_78 & ~ V_85 ) )
return - V_86 ;
F_54 ( V_87 ,
L_2 ,
V_5 -> V_88 , V_5 -> V_89 , V_5 , V_78 , V_82 ,
V_46 , V_46 , V_78 >> V_31 ,
V_82 >> V_31 ) ;
if ( F_55 ( V_73 ) & ~ V_85 )
return - V_86 ;
...
struct V_1 * * V_26 ;
T_2 V_93 ;
V_78 = F_59 ( T_2 , F_53 ( V_73 ) , V_25 ) ;
if ( F_57 ( V_73 ) == V_33 ) {
if ( V_46 >= F_60 ( V_5 ) )
break;
if ( V_46 + V_78 > F_60 ( V_5 ) )
V_78 = F_60 ( V_5 ) - V_46 ;
}
V_22 = F_61 ( V_73 , & V_26 , V_78 , & V_93 ) ;
if ( F_43 ( V_22 > 0 ) ) {
int V_94 = F_62 ( V_22 + V_93 , V_12 ) ;
V_22 = F_50 ( V_7 , V_38 , F_57 ( V_73 ) ,
V_5 , V_74 -> V_76 ,
V_22 , V_46 , V_26 ,
V_94 ) ;
F_27 ( V_26 , V_94 , F_57 ( V_73 ) == V_33 ) ;
}
if ( F_25 ( V_22 <= 0 ) ) {
if ( V_22 == - V_28 &&
...
static int F_71 ( struct V_74 * V_74 , struct V_21 * V_13 ,
...
V_1 = F_72 ( V_13 , V_103 , V_100 ) ;
if ( ! V_1 )
return - V_28 ;
* V_101 = V_1 ;
V_45 = F_73 ( V_74 , V_1 , V_104 , V_104 + V_99 ) ;
if ( V_45 ) {
F_74 ( V_1 ) ;
F_29 ( V_1 ) ;
}
...
static int F_75 ( struct V_74 * V_74 , struct V_21 * V_13 ,
T_4 V_98 , unsigned V_99 , unsigned V_105 ,
struct V_1 * V_1 , void * V_102 )
{
unsigned V_104 = V_98 & ( V_12 - 1 ) ;
int V_45 ;
V_45 = F_76 ( V_74 , V_1 , V_104 , V_104 + V_105 ) ;
F_74 ( V_1 ) ;
F_29 ( V_1 ) ;
return V_45 ? : V_105 ;
}
