...
if ( ! F_69 ( V_122 ,
& F_70 ( V_6 -> V_123 . V_124 ) -> V_125 ) ) {
T_3 time = F_71 ( V_116 ) ;
F_72 ( V_6 -> V_123 . V_124 ) ;
F_73 ( & V_6 -> V_123 . V_126 , time ,
V_127 ) ;
}
} else {
F_74 ( & V_6 -> V_128 ) ;
...
static unsigned int F_75 ( struct V_3 * V_4 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
int V_35 ;
...
F_79 (cl, &q->clhash.hash[i], common.hnode) {
if ( V_14 -> V_22 )
memset ( & V_14 -> V_63 . V_64 , 0 , sizeof( V_14 -> V_63 . V_64 ) ) ;
else {
if ( V_14 -> V_63 . V_79 . V_6 )
F_80 ( V_14 -> V_63 . V_79 . V_6 ) ;
F_81 ( & V_14 -> V_63 . V_79 . V_81 ) ;
}
V_14 -> V_60 = 0 ;
V_14 -> V_61 = V_67 ;
}
...
static void F_84 ( struct V_136 * V_128 )
{
struct V_5 * V_6 = F_4 ( V_128 , struct V_5 , V_128 ) ;
struct V_3 * V_4 = V_6 -> V_123 . V_124 ;
F_85 ( F_86 ( V_4 ) ) ;
}
static int F_87 ( struct V_3 * V_4 , struct V_137 * V_138 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
...
if ( ! V_138 )
return - V_144 ;
V_143 = F_88 ( V_139 , V_140 , V_138 , V_145 ) ;
if ( V_143 < 0 )
return V_143 ;
if ( ! V_139 [ V_146 ] )
return - V_144 ;
V_142 = F_89 ( V_139 [ V_146 ] ) ;
...
F_93 ( & V_6 -> V_85 ) ;
if ( V_139 [ V_149 ] )
V_6 -> V_86 = F_94 ( V_139 [ V_149 ] ) ;
else
V_6 -> V_86 = F_95 ( V_4 ) -> V_150 ;
if ( ( V_6 -> V_151 = V_142 -> V_151 ) < 1 )
V_6 -> V_151 = 1 ;
V_6 -> V_32 = V_142 -> V_32 ;
return 0 ;
}
static int F_96 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_137 * V_152 ;
struct V_141 V_142 ;
...
V_142 . V_32 = V_6 -> V_32 ;
V_142 . V_153 = 0 ;
V_152 = F_97 ( V_12 , V_154 ) ;
if ( V_152 == NULL )
goto V_155;
if ( F_98 ( V_12 , V_146 , sizeof( V_142 ) , & V_142 ) ||
F_99 ( V_12 , V_149 , V_6 -> V_86 ) )
goto V_155;
return F_100 ( V_12 , V_152 ) ;
V_155:
F_101 ( V_12 , V_152 ) ;
return - 1 ;
}
static int F_102 ( struct V_3 * V_4 , unsigned long V_156 ,
...
F_103 ( & V_138 . V_90 , & V_14 -> V_90 ) ;
V_138 . V_72 = F_104 ( V_14 -> V_72 ) ;
F_103 ( & V_138 . ceil , & V_14 -> ceil ) ;
V_138 . V_71 = F_104 ( V_14 -> V_71 ) ;
V_138 . V_115 = V_14 -> V_115 ;
V_138 . V_35 = V_14 -> V_35 ;
V_138 . V_22 = V_14 -> V_22 ;
if ( F_98 ( V_12 , V_164 , sizeof( V_138 ) , & V_138 ) )
goto V_155;
if ( ( V_14 -> V_90 . V_165 >= ( 1ULL << 32 ) ) &&
F_105 ( V_12 , V_166 , V_14 -> V_90 . V_165 ) )
goto V_155;
if ( ( V_14 -> ceil . V_165 >= ( 1ULL << 32 ) ) &&
F_105 ( V_12 , V_167 , V_14 -> ceil . V_165 ) )
goto V_155;
return F_100 ( V_12 , V_152 ) ;
V_155:
F_101 ( V_12 , V_152 ) ;
...
static int
F_106 ( struct V_3 * V_4 , unsigned long V_156 , struct V_168 * V_169 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
T_4 V_80 = 0 ;
if ( ! V_14 -> V_22 && V_14 -> V_63 . V_79 . V_6 )
V_80 = V_14 -> V_63 . V_79 . V_6 -> V_6 . V_80 ;
V_14 -> V_94 . V_77 = F_104 ( V_14 -> V_77 ) ;
V_14 -> V_94 . V_76 = F_104 ( V_14 -> V_76 ) ;
if ( F_107 ( V_169 , NULL , & V_14 -> V_97 ) < 0 ||
F_108 ( V_169 , NULL , & V_14 -> V_170 ) < 0 ||
F_109 ( V_169 , NULL , & V_14 -> V_88 , V_80 ) < 0 )
return - 1 ;
return F_110 ( V_169 , & V_14 -> V_94 , sizeof( V_14 -> V_94 ) ) ;
}
static int F_111 ( struct V_3 * V_4 , unsigned long V_156 , struct V_3 * V_171 ,
struct V_3 * * V_172 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
if ( V_14 -> V_22 )
return - V_144 ;
if ( V_171 == NULL &&
( V_171 = F_112 ( V_4 -> V_173 , & V_174 ,
V_14 -> V_10 . V_31 ) ) == NULL )
return - V_175 ;
* V_172 = F_113 ( V_4 , V_171 , & V_14 -> V_63 . V_79 . V_6 ) ;
return 0 ;
}
static struct V_3 * F_114 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
return ! V_14 -> V_22 ? V_14 -> V_63 . V_79 . V_6 : NULL ;
}
static void F_115 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
...
static int F_128 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
...
unsigned int V_134 = V_14 -> V_63 . V_79 . V_6 -> V_88 . V_134 ;
F_80 ( V_14 -> V_63 . V_79 . V_6 ) ;
F_130 ( V_14 -> V_63 . V_79 . V_6 , V_80 , V_134 ) ;
}
F_131 ( & V_6 -> V_9 , & V_14 -> V_10 ) ;
if ( V_14 -> V_38 )
V_14 -> V_38 -> V_177 -- ;
if ( V_14 -> V_60 )
F_34 ( V_6 , V_14 ) ;
...
if ( V_181 )
F_118 ( V_6 , V_14 , V_178 ) ;
F_57 ( -- V_14 -> V_176 == 0 ) ;
F_132 ( V_4 ) ;
return 0 ;
}
static void F_133 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
if ( -- V_14 -> V_176 == 0 )
F_119 ( V_4 , V_14 ) ;
}
static int F_134 ( struct V_3 * V_4 , T_1 V_31 ,
...
V_186 = F_89 ( V_139 [ V_164 ] ) ;
if ( ! V_186 -> V_90 . V_90 || ! V_186 -> ceil . V_90 )
goto V_189;
if ( V_186 -> V_90 . V_190 == V_191 )
F_135 ( F_136 ( & V_186 -> V_90 , V_139 [ V_192 ] ) ) ;
if ( V_186 -> ceil . V_190 == V_191 )
F_135 ( F_136 ( & V_186 -> ceil , V_139 [ V_193 ] ) ) ;
if ( ! V_14 ) {
struct V_3 * V_178 ;
int V_35 ;
struct {
...
. V_194 = {
. V_197 = F_137 ( sizeof( V_196 . V_138 ) ) ,
. V_198 = V_199 ,
} ,
. V_138 = {
. V_200 = 2 ,
...
V_143 = - V_175 ;
V_14 = F_139 ( sizeof( * V_14 ) , V_202 ) ;
if ( ! V_14 )
goto V_189;
if ( V_203 || V_185 [ V_199 ] ) {
V_143 = F_140 ( & V_14 -> V_97 , NULL ,
& V_14 -> V_170 ,
F_141 ( V_4 ) ,
...
F_24 ( & V_14 -> V_40 [ V_35 ] ) ;
V_178 = F_112 ( V_4 -> V_173 ,
& V_174 , V_31 ) ;
F_129 ( V_4 ) ;
if ( V_38 && ! V_38 -> V_22 ) {
unsigned int V_80 = V_38 -> V_63 . V_79 . V_6 -> V_6 . V_80 ;
unsigned int V_134 = V_38 -> V_63 . V_79 . V_6 -> V_88 . V_134 ;
F_80 ( V_38 -> V_63 . V_79 . V_6 ) ;
F_130 ( V_38 -> V_63 . V_79 . V_6 , V_80 , V_134 ) ;
...
V_14 -> V_10 . V_31 = V_31 ;
V_14 -> V_38 = V_38 ;
V_14 -> V_77 = F_142 ( V_186 -> V_72 ) ;
V_14 -> V_76 = F_142 ( V_186 -> V_71 ) ;
V_14 -> V_91 = 60ULL * V_120 ;
V_14 -> V_93 = F_67 () ;
V_14 -> V_61 = V_67 ;
F_143 ( & V_6 -> V_9 , & V_14 -> V_10 ) ;
if ( V_38 )
V_38 -> V_177 ++ ;
} else {
if ( V_185 [ V_199 ] ) {
T_6 * V_204 = F_141 ( V_4 ) ;
V_143 = F_144 ( & V_14 -> V_97 , NULL ,
& V_14 -> V_170 ,
V_204 ,
V_185 [ V_199 ] ) ;
if ( V_143 )
...
V_187 = V_139 [ V_166 ] ? F_145 ( V_139 [ V_166 ] ) : 0 ;
V_188 = V_139 [ V_167 ] ? F_145 ( V_139 [ V_167 ] ) : 0 ;
F_146 ( & V_14 -> V_90 , & V_186 -> V_90 , V_187 ) ;
F_146 ( & V_14 -> ceil , & V_186 -> ceil , V_188 ) ;
if ( ! V_14 -> V_22 ) {
T_5 V_115 = V_14 -> V_90 . V_165 ;
F_147 ( V_115 , V_6 -> V_151 ) ;
V_14 -> V_115 = F_49 ( T_5 , V_115 , V_205 ) ;
...
if ( ( V_14 -> V_35 = V_186 -> V_35 ) >= V_129 )
V_14 -> V_35 = V_129 - 1 ;
}
V_14 -> V_72 = F_142 ( V_186 -> V_72 ) ;
V_14 -> V_71 = F_142 ( V_186 -> V_71 ) ;
F_132 ( V_4 ) ;
F_148 ( V_4 , & V_6 -> V_9 ) ;
...
static struct V_17 T_7 * * F_149 ( struct V_3 * V_4 ,
unsigned long V_156 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
struct V_17 T_7 * * V_206 = V_14 ? & V_14 -> V_23 : & V_6 -> V_23 ;
return V_206 ;
}
static unsigned long F_150 ( struct V_3 * V_4 , unsigned long V_38 ,
T_1 V_31 )
{
struct V_1 * V_14 = F_1 ( V_31 , V_4 ) ;
if ( V_14 )
...
static void F_151 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
if ( V_14 )
V_14 -> V_182 -- ;
}
static void F_152 ( struct V_3 * V_4 , struct V_207 * V_156 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 ;
unsigned int V_105 ;
...
for ( V_105 = 0 ; V_105 < V_6 -> V_9 . V_135 ; V_105 ++ ) {
F_79 (cl, &q->clhash.hash[i], common.hnode) {
if ( V_156 -> V_209 < V_156 -> V_210 ) {
V_156 -> V_209 ++ ;
continue;
}
if ( V_156 -> V_211 ( V_4 , ( unsigned long ) V_14 , V_156 ) < 0 ) {
V_156 -> V_208 = 1 ;
return;
}
V_156 -> V_209 ++ ;
