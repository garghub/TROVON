...
static int F_155 ( struct V_14 * V_14 , struct V_2 * V_6 )
{
struct V_2 * V_3 = V_14 -> V_3 ;
struct V_1 * V_5 ;
char * V_157 = V_6 -> V_27 ;
...
static int F_158 ( struct V_14 * V_14 , struct V_52 * V_53 )
{
V_53 -> V_176 . V_177 = V_14 -> V_62 -> V_60 ;
return 0 ;
}
static int F_159 ( struct V_14 * V_14 , struct V_52 * V_53 )
{
...
void * V_184 )
{
F_180 ( & V_183 -> V_185 , & V_186 ) ;
}
static void F_181 ( struct V_2 * V_3 )
{
F_180 ( & V_3 -> V_187 , & V_188 ) ;
F_182 ( V_3 , F_179 , NULL ) ;
V_3 -> V_189 = & V_190 ;
}
static int F_183 ( struct V_2 * V_3 )
{
struct V_14 * V_14 = F_184 ( V_3 ) ;
int V_33 ;
int V_34 ;
V_14 -> V_3 = V_3 ;
F_185 ( & V_14 -> V_145 ) ;
F_60 ( V_14 ) ;
V_14 -> V_102 = F_186 ( struct V_101 ) ;
if ( ! V_14 -> V_102 )
return - V_36 ;
for ( V_33 = 0 ; V_33 < V_191 ; V_33 ++ )
F_187 ( & V_14 -> V_192 [ V_33 ] ) ;
F_94 ( & V_14 -> V_83 ) ;
V_34 = F_93 ( V_14 ) ;
if ( V_34 )
goto V_193;
...
F_79 ( V_14 ) ;
F_85 ( V_14 ) ;
V_34 = F_36 ( V_14 , V_194 , F_188 ( V_194 ) ) ;
if ( V_34 )
goto V_195;
F_189 ( V_3 ) ;
F_181 ( V_3 ) ;
...
{
T_3 V_183 = F_198 ( V_72 ) ? F_199 ( V_72 ) : 0 ;
F_200 ( V_72 ) -> V_203 = V_72 -> V_120 ;
if ( F_201 ( V_183 >= V_3 -> V_181 ) ) {
do {
V_183 -= V_3 -> V_181 ;
...
static void F_202 ( struct V_2 * V_3 , int V_204 )
{
struct V_14 * V_14 = F_184 ( V_3 ) ;
struct V_1 * V_5 ;
int V_205 ;
...
static int F_208 ( struct V_2 * V_3 , void * V_208 )
{
struct V_8 * V_9 = V_208 ;
struct V_14 * V_14 = F_184 ( V_3 ) ;
struct V_1 * V_5 ;
if ( V_3 -> type == V_209 && ! F_209 ( V_9 -> V_10 ) )
return - V_210 ;
...
static int F_210 ( struct V_2 * V_3 , int V_212 )
{
struct V_14 * V_14 = F_184 ( V_3 ) ;
struct V_1 * V_5 ;
int V_34 ;
...
static struct V_215 *
F_212 ( struct V_2 * V_3 , struct V_215 * V_216 )
{
struct V_14 * V_14 = F_184 ( V_3 ) ;
struct V_101 * V_208 ;
...
int V_33 ;
F_213 (i) {
V_208 = F_214 ( V_14 -> V_102 , V_33 ) ;
do {
V_217 = F_215 ( & V_208 -> V_103 ) ;
V_104 = V_208 -> V_104 ;
V_105 = V_208 -> V_105 ;
V_109 = V_208 -> V_109 ;
V_197 = V_208 -> V_197 ;
V_198 = V_208 -> V_198 ;
} while ( F_216 ( & V_208 -> V_103 , V_217 ) );
V_216 -> V_104 += V_104 ;
V_216 -> V_105 += V_105 ;
V_216 -> V_218 += V_109 ;
V_216 -> V_197 += V_197 ;
...
static int F_217 ( struct V_2 * V_3 , T_10 V_219 , T_3 V_220 )
{
struct V_14 * V_14 = F_184 ( V_3 ) ;
struct V_1 * V_5 ;
int V_34 ;
F_123 ( & V_14 -> V_145 ) ;
F_17 (port, &team->port_list, list) {
V_34 = F_218 ( V_5 -> V_3 , V_219 , V_220 ) ;
if ( V_34 )
goto V_214;
}
F_124 ( & V_14 -> V_145 ) ;
...
F_206 () ;
V_160 = F_228 ( V_160 , V_223 ) ;
return V_160 ;
}
static int F_229 ( struct V_2 * V_3 , bool V_225 )
{
struct V_14 * V_14 = F_184 ( V_3 ) ;
V_14 -> V_75 = true ;
if ( V_225 )
...
struct V_226 * V_227 )
{
F_232 ( V_227 -> V_228 , V_229 , sizeof( V_227 -> V_228 ) ) ;
F_232 ( V_227 -> V_230 , V_231 , sizeof( V_227 -> V_230 ) ) ;
}
...
static int F_243 ( struct V_255 * V_256 [] , struct V_255 * V_176 [] )
{
if ( V_256 [ V_257 ] ) {
...
goto V_278;
if ( F_264 ( V_72 , V_284 , V_53 . V_176 . V_178 ) )
goto V_278;
break;
case V_285 :
...
goto V_278;
if ( F_266 ( V_72 , V_284 , V_53 . V_176 . V_289 . V_106 ,
...
goto V_278;
if ( F_268 ( V_72 , V_284 , V_53 . V_176 . V_180 ) )
goto V_278;
break;
default:
F_269 () ;
...
if ( V_34 )
return V_34 ;
V_263 = F_250 ( V_72 , V_274 , V_299 , & V_267 , V_158 | V_306 ,
V_307 ) ;
if ( ! V_263 )
return - V_269 ;
...
goto V_305;
V_311:
V_302 = F_277 ( V_72 , V_274 , V_299 , V_312 , 0 , V_158 | V_306 ) ;
if ( ! V_302 ) {
V_34 = F_272 ( & V_72 , V_14 , V_274 , V_297 ) ;
if ( V_34 )
goto V_310;
...
V_53 . V_176 . V_177 = F_245 ( V_320 ) ;
break;
case V_287 :
V_53 . V_176 . V_289 . V_106 = F_244 ( V_320 ) ;
V_53 . V_176 . V_289 . V_290 = F_245 ( V_320 ) ;
break;
case V_291 :
V_53 . V_176 . V_179 = V_320 ? true : false ;
break;
case V_293 :
V_53 . V_176 . V_180 = F_287 ( V_320 ) ;
break;
default:
F_269 () ;
}
...
static void F_172 ( struct V_14 * V_14 )
{
struct V_1 * V_5 ;
bool V_350 ;
if ( V_14 -> V_75 )
...
static void F_148 ( struct V_1 * V_5 , bool V_18 )
{
F_302 ( V_5 , V_18 ) ;
F_172 ( V_5 -> V_14 ) ;
}
...
static int F_306 ( struct V_351 * V_184 ,
unsigned long V_352 , void * V_290 )
{
struct V_2 * V_3 = F_307 ( V_290 ) ;
struct V_1 * V_5 ;
V_5 = F_3 ( V_3 ) ;
if ( ! V_5 )
return V_353 ;
