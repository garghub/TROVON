...
V_81 -> V_165 = V_166 ;
V_81 -> V_167 = F_56 ( V_80 ) -> V_109 ;
F_104 ( & V_81 -> V_168 ,
F_105 ( & F_56 ( V_80 ) -> V_169 ) ) ;
V_160 -> V_170 = 0 ;
V_160 -> V_171 = 0 ;
V_160 -> V_172 = 0 ;
...
{
F_27 ( V_10 -> V_21 != V_173 ) ;
F_27 ( ! F_108 ( V_10 , V_174 ) ) ;
F_27 ( ! F_109 ( V_10 ) ) ;
F_27 ( F_69 ( V_10 ) -> V_163 && ! F_21 ( V_10 ) -> V_65 ) ;
V_10 -> V_29 -> V_175 ( V_10 ) ;
F_110 ( V_10 ) ;
F_111 ( V_10 ) ;
F_112 ( V_10 ) ;
F_113 ( V_10 -> V_29 -> V_176 ) ;
F_114 ( V_10 ) ;
}
void F_115 ( struct V_9 * V_10 )
__releases( &sk->sk_lock.slock
int F_116 ( struct V_9 * V_10 , int V_177 )
{
struct V_67 * V_68 = F_21 ( V_10 ) ;
struct V_123 * V_178 = F_69 ( V_10 ) ;
int V_70 = - V_179 ;
F_117 ( & V_68 -> V_72 ) ;
V_10 -> V_152 = V_177 ;
V_10 -> V_180 = 0 ;
F_118 ( V_10 ) ;
F_119 ( V_10 , V_22 ) ;
if ( ! V_10 -> V_29 -> V_181 ( V_10 , V_178 -> V_163 ) ) {
V_178 -> V_164 = F_61 ( V_178 -> V_163 ) ;
F_120 ( V_10 ) ;
V_70 = V_10 -> V_29 -> V_182 ( V_10 ) ;
if ( F_17 ( ! V_70 ) )
return 0 ;
}
V_10 -> V_21 = V_173 ;
...
static void F_121 ( struct V_9 * V_10 , struct V_79 * V_80 ,
struct V_9 * V_183 )
{
V_10 -> V_29 -> V_184 ( V_183 , V_83 ) ;
F_122 ( V_183 ) ;
F_123 ( V_10 -> V_29 -> V_176 ) ;
if ( V_10 -> V_84 == V_85 && F_43 ( V_80 ) -> V_86 ) {
F_124 ( F_125 ( V_183 ) -> V_185 != V_80 ) ;
F_124 ( V_10 != V_80 -> V_146 ) ;
F_125 ( V_183 ) -> V_185 = NULL ;
}
F_107 ( V_183 ) ;
F_44 ( V_80 ) ;
}
struct V_9 * F_126 ( struct V_9 * V_10 ,
struct V_79 * V_80 ,
struct V_9 * V_183 )
{
...
struct V_9 * F_128 ( struct V_9 * V_10 , struct V_9 * V_183 ,
struct V_79 * V_80 , bool V_190 )
{
if ( V_190 ) {
F_84 ( V_10 , V_80 ) ;
F_85 ( & F_21 ( V_10 ) -> V_72 , V_80 ) ;
if ( F_126 ( V_10 , V_80 , V_183 ) )
return V_183 ;
}
F_129 ( V_183 ) ;
F_114 ( V_183 ) ;
...
struct V_67 * V_68 = F_21 ( V_10 ) ;
struct V_77 * V_78 = & V_68 -> V_72 ;
struct V_79 * V_191 , * V_80 ;
while ( ( V_80 = F_42 ( V_78 , V_10 ) ) != NULL ) {
struct V_9 * V_183 = V_80 -> V_10 ;
F_131 () ;
F_132 ( V_183 ) ;
F_27 ( F_133 ( V_183 ) ) ;
F_134 ( V_183 ) ;
...
if ( V_78 -> V_87 . V_192 ) {
F_13 ( & V_78 -> V_87 . V_7 ) ;
V_80 = V_78 -> V_87 . V_192 ;
V_78 -> V_87 . V_192 = NULL ;
F_22 ( & V_78 -> V_87 . V_7 ) ;
while ( V_80 != NULL ) {
V_191 = V_80 -> V_187 ;
F_44 ( V_80 ) ;
...
void F_137 ( struct V_9 * V_10 , struct V_193 * V_194 )
{
struct V_195 * sin = (struct V_195 * ) V_194 ;
const struct V_123 * V_178 = F_69 ( V_10 ) ;
sin -> V_196 = V_197 ;
sin -> V_198 . V_199 = V_178 -> V_200 ;
sin -> V_201 = V_178 -> V_162 ;
}
int F_138 ( struct V_9 * V_10 , int V_202 , int V_203 ,
char T_6 * V_204 , int T_6 * V_205 )
{
const struct V_67 * V_68 = F_21 ( V_10 ) ;
if ( V_68 -> V_57 -> V_206 )
return V_68 -> V_57 -> V_206 ( V_10 , V_202 , V_203 ,
V_204 , V_205 ) ;
return V_68 -> V_57 -> V_207 ( V_10 , V_202 , V_203 ,
V_204 , V_205 ) ;
}
int F_139 ( struct V_9 * V_10 , int V_202 , int V_203 ,
char T_6 * V_204 , unsigned int V_205 )
{
const struct V_67 * V_68 = F_21 ( V_10 ) ;
if ( V_68 -> V_57 -> V_208 )
return V_68 -> V_57 -> V_208 ( V_10 , V_202 , V_203 ,
V_204 , V_205 ) ;
return V_68 -> V_57 -> V_209 ( V_10 , V_202 , V_203 ,
V_204 , V_205 ) ;
}
static struct V_98 * F_140 ( struct V_9 * V_10 , struct V_210 * V_126 )
{
const struct V_123 * V_178 = F_69 ( V_10 ) ;
const struct V_104 * V_129 ;
T_7 V_211 = V_178 -> V_200 ;
struct V_99 * V_100 ;
struct V_106 * V_107 ;
F_70 () ;
V_129 = F_71 ( V_178 -> V_129 ) ;
if ( V_129 && V_129 -> V_105 . V_111 )
V_211 = V_129 -> V_105 . V_112 ;
V_100 = & V_126 -> V_127 . V_128 ;
V_107 = F_141 ( F_11 ( V_10 ) , V_100 , V_10 , V_211 ,
V_178 -> V_212 , V_178 -> V_162 ,
V_178 -> V_164 , V_10 -> V_84 ,
F_59 ( V_10 ) , V_10 -> V_20 ) ;
if ( F_65 ( V_107 ) )
V_107 = NULL ;
if ( V_107 )
F_142 ( V_10 , & V_107 -> V_121 ) ;
F_72 () ;
return & V_107 -> V_121 ;
}
struct V_98 * F_143 ( struct V_9 * V_10 , T_2 V_213 )
{
struct V_98 * V_121 = F_144 ( V_10 , 0 ) ;
struct V_123 * V_178 = F_69 ( V_10 ) ;
if ( ! V_121 ) {
V_121 = F_140 ( V_10 , & V_178 -> V_125 . V_126 ) ;
if ( ! V_121 )
goto V_88;
}
V_121 -> V_214 -> V_215 ( V_121 , V_10 , NULL , V_213 ) ;
V_121 = F_144 ( V_10 , 0 ) ;
if ( ! V_121 )
V_121 = F_140 ( V_10 , & V_178 -> V_125 . V_126 ) ;
V_88:
