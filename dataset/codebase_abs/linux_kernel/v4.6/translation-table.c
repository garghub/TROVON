...
V_94 = V_87 -> V_30 . V_55 & V_115 ;
if ( F_67 ( V_88 ) )
V_87 -> V_30 . V_55 |= V_108 ;
else
V_87 -> V_30 . V_55 &= ~ V_108 ;
V_95 = ( V_86 & V_26 -> V_116 ) ;
if ( V_26 -> V_116 &&
V_95 == V_26 -> V_117 )
V_87 -> V_30 . V_55 |= V_118 ;
else
V_87 -> V_30 . V_55 &= ~ V_118 ;
if ( V_94 ^ ( V_87 -> V_30 . V_55 & V_115 ) )
F_42 ( V_26 , V_87 , V_112 ) ;
V_92 = true ;
V_105:
if ( V_88 )
...
T_3 F_87 ( struct V_25 * V_26 , const T_2 * V_14 ,
...
struct V_5 * V_27 ;
struct V_1 * V_157 ;
F_89 (tt_common_entry, node_tmp, head,
hash_entry) {
V_28 = F_2 ( V_27 ,
struct V_24 ,
V_30 ) ;
...
static bool F_102 ( struct V_25 * V_26 ,
struct V_43 * V_44 ,
...
V_27 = & V_32 -> V_30 ;
V_55 = V_27 -> V_55 ;
V_175 = F_106 ( V_26 , V_32 ) ;
if ( V_175 ) {
V_36 = F_110 ( V_175 -> V_44 ,
V_27 -> V_9 ) ;
if ( ! V_36 ) {
F_83 ( V_140 ,
L_20 ,
...
int F_111 ( struct V_139 * V_140 , void * V_141 )
{
struct V_83 * V_142 = (struct V_83 * ) V_140 -> V_143 ;
struct V_25 * V_26 = F_62 ( V_142 ) ;
...
F_32 ( & V_32 -> V_158 ) ;
V_18 = & V_32 -> V_113 ;
F_89 (orig_entry, safe, head, list)
F_112 ( V_32 , V_49 ) ;
F_36 ( & V_32 -> V_158 ) ;
}
static void
...
F_119 ( V_182 , & V_44 -> V_183 ) ;
}
static bool F_120 ( struct V_31 * V_80 ,
char * * V_184 )
{
bool V_185 = false ;
...
F_90 ( V_80 -> V_114 , V_186 ) ) {
V_185 = true ;
* V_184 = L_30 ;
}
if ( ( V_80 -> V_30 . V_55 & V_166 ) &&
F_90 ( V_80 -> V_30 . V_109 , V_188 ) ) {
V_185 = true ;
* V_184 = L_31 ;
}
return V_185 ;
}
static void F_121 ( struct V_25 * V_26 )
{
struct V_16 * V_13 = V_26 -> V_12 . V_33 ;
struct V_17 * V_18 ;
struct V_1 * V_157 ;
...
struct V_43 * F_124 ( struct V_25 * V_26 ,
const T_2 * V_191 ,
const T_2 * V_14 ,
unsigned short V_9 )
{
...
static T_1 F_126 ( struct V_25 * V_26 ,
struct V_43 * V_44 ,
unsigned short V_9 )
{
struct V_16 * V_13 = V_26 -> V_12 . V_33 ;
...
V_192 = F_127 ( 0 , & V_193 , sizeof( V_193 ) ) ;
V_55 = V_190 -> V_55 & V_194 ;
V_192 = F_127 ( V_192 , & V_55 , sizeof( V_55 ) ) ;
V_127 ^= F_127 ( V_192 , V_190 -> V_14 , V_15 ) ;
}
F_11 () ;
}
return V_127 ;
}
static T_1 F_128 ( struct V_25 * V_26 ,
unsigned short V_9 )
{
struct V_16 * V_13 = V_26 -> V_12 . V_29 ;
struct V_5 * V_190 ;
...
static void F_129 ( struct V_25 * V_26 )
{
struct V_195 * V_2 ;
struct V_1 * V_54 ;
F_32 ( & V_26 -> V_12 . V_196 ) ;
F_89 (node, safe, &bat_priv->tt.req_list, list) {
F_130 ( & V_2 -> V_47 ) ;
F_47 ( V_2 ) ;
}
F_36 ( & V_26 -> V_12 . V_196 ) ;
}
...
F_47 ( V_44 -> V_197 ) ;
V_44 -> V_198 = 0 ;
V_44 -> V_197 = F_43 ( V_198 , V_59 ) ;
if ( V_44 -> V_197 ) {
memcpy ( V_44 -> V_197 , V_197 , V_198 ) ;
V_44 -> V_198 = V_198 ;
}
}
F_36 ( & V_44 -> V_199 ) ;
...
static struct V_195 *
F_133 ( struct V_25 * V_26 ,
struct V_43 * V_44 )
{
struct V_195 * V_202 , * V_203 = NULL ;
F_32 ( & V_26 -> V_12 . V_196 ) ;
F_134 (tt_req_node_tmp, &bat_priv->tt.req_list, list) {
if ( F_3 ( V_202 , V_44 ) &&
! F_90 ( V_202 -> V_200 ,
V_201 ) )
goto V_65;
}
V_203 = F_43 ( sizeof( * V_203 ) , V_59 ) ;
if ( ! V_203 )
goto V_65;
F_7 ( V_203 -> V_14 , V_44 -> V_165 ) ;
V_203 -> V_200 = V_99 ;
F_135 ( & V_203 -> V_47 , & V_26 -> V_12 . V_204 ) ;
V_65:
F_36 ( & V_26 -> V_12 . V_196 ) ;
return V_203 ;
}
static int F_136 ( const void * V_205 , const void * V_206 )
{
...
static int F_137 ( const void * V_205 ,
const void * V_206 )
{
const struct V_5 * V_27 = V_205 ;
...
struct V_31 ,
V_30 ) ;
return F_98 ( V_32 , V_44 ) ;
}
static void F_138 ( struct V_25 * V_26 ,
struct V_16 * V_13 ,
void * V_207 , T_3 V_70 ,
int (* F_139)( const void * , const void * ) ,
void * V_208 )
{
struct V_5 * V_27 ;
struct V_69 * V_120 ;
...
static bool F_140 ( struct V_43 * V_44 ,
struct V_77 * V_123 ,
T_3 V_71 )
{
struct V_77 * V_211 ;
...
F_8 () ;
F_9 (vlan, &bat_priv->softif_vlan_list, list) {
V_36 -> V_12 . V_127 = F_128 ( V_26 , V_36 -> V_9 ) ;
}
F_11 () ;
}
...
F_8 () ;
F_9 (vlan, &orig_node->vlan_list, list) {
if ( F_103 ( V_26 , V_44 -> V_165 ,
V_36 -> V_9 ) )
continue;
V_127 = F_126 ( V_26 , V_44 , V_36 -> V_9 ) ;
...
( ( V_119 -> V_55 & V_218 ) ? 'F' : '.' ) ) ;
V_222 = F_150 ( V_26 , V_221 ) ;
if ( ! V_222 )
goto V_105;
V_223 = F_150 ( V_26 , V_220 ) ;
if ( ! V_223 )
goto V_105;
...
if ( ! V_70 )
goto V_105;
F_138 ( V_26 , V_26 -> V_12 . V_33 ,
V_120 , V_70 ,
F_137 ,
V_222 ) ;
}
V_70 = sizeof( struct V_74 ) + V_122 ;
if ( V_70 > F_23 ( & V_26 -> V_91 ) ) {
F_65 ( V_104 , V_26 -> V_84 ,
L_34 ,
V_223 -> V_165 ) ;
goto V_105;
}
...
static bool F_151 ( struct V_25 * V_26 ,
struct V_76 * V_119 ,
T_2 * V_220 )
{
struct V_76 * V_215 = NULL ;
...
{
if ( F_153 ( V_26 , V_221 ) )
return F_151 ( V_26 , V_119 , V_220 ) ;
return F_149 ( V_26 , V_119 , V_220 ,
V_221 ) ;
}
...
{
struct V_43 * V_44 ;
V_44 = F_150 ( V_26 , V_232 ) ;
if ( ! V_44 )
goto V_105;
F_118 ( V_26 , V_44 , - 1 ,
L_39 ) ;
F_154 ( V_26 , V_44 , V_120 , V_42 ,
V_125 ) ;
F_32 ( & V_44 -> V_199 ) ;
F_47 ( V_44 -> V_197 ) ;
V_44 -> V_198 = 0 ;
...
struct V_69 * V_120 )
{
F_154 ( V_26 , V_44 , V_120 ,
V_230 , V_125 ) ;
F_131 ( V_26 , V_44 , V_120 ,
F_51 ( V_230 ) ) ;
F_78 ( & V_44 -> V_126 , V_125 ) ;
}
bool F_158 ( struct V_25 * V_26 , const T_2 * V_14 ,
unsigned short V_9 )
{
struct V_24 * V_28 ;
bool V_92 = false ;
...
V_121 *= F_141 ( V_119 -> V_71 ) ;
V_121 += sizeof( * V_119 ) ;
V_233 += V_121 ;
V_120 = (struct V_69 * ) V_233 ;
if ( V_119 -> V_55 & V_218 ) {
F_156 ( V_26 , V_120 , V_119 -> V_125 ,
V_232 , V_42 ) ;
} else {
F_157 ( V_26 , V_44 , V_42 ,
V_119 -> V_125 , V_120 ) ;
}
F_144 ( V_26 , V_44 ) ;
F_36 ( & V_44 -> V_234 ) ;
...
static bool F_162 ( struct V_25 * V_26 , T_2 * V_239 )
{
struct V_235 * V_240 ;
bool V_92 = false ;
F_32 ( & V_26 -> V_12 . V_236 ) ;
F_163 (tt_roam_node, &bat_priv->tt.roam_list, list) {
if ( ! F_3 ( V_240 -> V_14 , V_239 ) )
continue;
if ( F_90 ( V_240 -> V_237 ,
V_238 ) )
continue;
if ( ! F_164 ( & V_240 -> V_241 ) )
goto V_65;
V_92 = true ;
break;
}
...
F_165 ( & V_240 -> V_47 , & V_26 -> V_12 . V_243 ) ;
V_92 = true ;
}
V_65:
F_36 ( & V_26 -> V_12 . V_236 ) ;
...
static void F_166 ( struct V_248 * V_249 )
{
struct V_250 * V_250 ;
struct V_251 * V_252 ;
struct V_25 * V_26 ;
V_250 = F_2 ( V_249 , struct V_250 , V_249 ) ;
...
F_132 ( V_26 ) ;
F_161 ( V_26 ) ;
F_167 ( V_254 , & V_26 -> V_12 . V_249 ,
F_168 ( V_255 ) ) ;
}
void F_169 ( struct V_25 * V_26 )
{
F_170 ( V_26 , V_138 , 1 ) ;
F_171 ( V_26 , V_138 , 1 ) ;
F_172 ( & V_26 -> V_12 . V_249 ) ;
F_92 ( V_26 ) ;
F_122 ( V_26 ) ;
F_129 ( V_26 ) ;
F_96 ( V_26 ) ;
...
static void F_173 ( struct V_25 * V_26 , T_3 V_55 ,
...
{
F_113 ( & V_26 -> V_12 . V_229 ) ;
F_176 ( V_26 ) ;
if ( F_23 ( & V_26 -> V_12 . V_67 ) < 1 ) {
if ( ! F_164 ( & V_26 -> V_12 . V_258 ) )
F_77 ( V_26 ) ;
return;
}
F_173 ( V_26 , V_107 , false , true ) ;
F_174 ( V_26 ) ;
F_143 ( V_26 ) ;
...
void F_177 ( struct V_25 * V_26 )
{
F_32 ( & V_26 -> V_12 . V_229 ) ;
F_175 ( V_26 ) ;
F_36 ( & V_26 -> V_12 . V_229 ) ;
}
bool F_178 ( struct V_25 * V_26 , T_2 * V_191 , T_2 * V_260 ,
unsigned short V_9 )
{
struct V_24 * V_28 = NULL ;
struct V_31 * V_32 = NULL ;
...
if ( ! V_32 )
goto V_105;
V_92 = V_32 -> V_30 . V_55 & V_102 ;
F_21 ( V_32 ) ;
V_105:
return V_92 ;
}
bool F_182 ( struct V_25 * V_26 ,
T_2 * V_14 , unsigned short V_9 )
{
struct V_24 * V_28 ;
bool V_92 = false ;
...
if ( ! V_28 )
goto V_105;
V_92 = V_28 -> V_30 . V_55 & V_102 ;
F_17 ( V_28 ) ;
V_105:
return V_92 ;
}
bool F_183 ( struct V_25 * V_26 ,
struct V_43 * V_44 ,
const unsigned char * V_14 ,
unsigned short V_9 )
{
bool V_92 = false ;
if ( ! F_102 ( V_26 , V_44 , V_14 , V_9 ,
V_166 ,
F_23 ( & V_44 -> V_126 ) ) )
goto V_105;
F_58 ( V_82 , V_26 ,
...
{
struct V_25 * V_26 = F_62 ( V_84 ) ;
int V_91 = F_23 ( & V_26 -> V_91 ) ;
int V_90 , V_156 = V_253 / 2 ;
bool V_265 = false ;
F_32 ( & V_26 -> V_12 . V_229 ) ;
while ( true ) {
V_90 = F_53 ( V_26 ) ;
...
V_42 = F_52 ( V_267 ) ;
F_179 ( V_26 , V_165 , V_123 , V_71 , V_120 ,
V_42 , V_119 -> V_125 ) ;
}
static int F_186 ( struct V_25 * V_26 ,
T_2 * V_191 , T_2 * V_260 ,
void * V_266 ,
T_3 V_267 )
{
...
case V_217 :
F_147 ( V_26 , V_272 ) ;
V_92 = F_152 ( V_26 , V_119 , V_191 , V_260 ) ;
if ( ! V_92 ) {
if ( V_119 -> V_55 & V_218 )
V_269 = 'F' ;
else
...
static int F_187 ( struct V_25 * V_26 ,
T_2 * V_191 , T_2 * V_260 ,
void * V_266 ,
T_3 V_267 )
{
...
L_49 ,
V_191 , V_275 -> V_239 ) ;
F_102 ( V_26 , V_44 , V_275 -> V_239 ,
F_141 ( V_275 -> V_9 ) , V_102 ,
F_23 ( & V_44 -> V_126 ) + 1 ) ;
V_105:
if ( V_44 )
F_40 ( V_44 ) ;
...
F_187 ,
V_247 , 1 , V_112 ) ;
F_191 ( & V_26 -> V_12 . V_249 , F_166 ) ;
F_167 ( V_254 , & V_26 -> V_12 . V_249 ,
F_168 ( V_255 ) ) ;
return 1 ;
}
bool F_192 ( struct V_25 * V_26 ,
const T_2 * V_14 , unsigned short V_9 )
{
struct V_31 * V_12 ;
bool V_92 ;
