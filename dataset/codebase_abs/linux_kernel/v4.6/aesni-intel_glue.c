...
static void
F_93 ( struct V_78 * V_58 , int V_30 )
{
...
static int
F_95 ( T_1 * V_6 , const T_1 * V_51 , unsigned int V_27 )
{
struct V_84 * V_85 ;
struct V_86 * V_58 ;
int V_64 = - V_34 ;
...
if ( ! V_58 )
goto V_89;
V_88 = F_99 ( sizeof( * V_88 ) , V_91 ) ;
if ( ! V_88 )
goto V_92;
memset ( V_88 -> V_5 , 0 , sizeof( V_88 -> V_5 ) ) ;
memset ( V_6 , 0 , V_93 ) ;
F_100 ( & V_88 -> V_80 . V_83 ) ;
F_101 ( & V_88 -> V_94 , V_6 , V_93 ) ;
F_102 ( V_58 , V_85 ) ;
F_103 ( V_58 , V_43 |
V_95 ,
F_93 ,
& V_88 -> V_80 ) ;
F_104 ( V_58 , & V_88 -> V_94 ,
...
static int F_110 ( struct V_19 * V_73 , const T_1 * V_51 ,
unsigned int V_27 )
{
...
return F_18 ( F_112 ( V_73 ) ,
& V_1 -> V_98 , V_51 , V_27 ) ? :
F_95 ( V_1 -> V_6 , V_51 , V_27 ) ;
}
static int F_113 ( struct V_19 * V_99 , const T_1 * V_51 ,
unsigned int V_27 )
{
struct V_74 * * V_1 = F_16 ( V_99 ) ;
struct V_74 * V_75 = * V_1 ;
return F_114 ( & V_75 -> V_77 , V_51 , V_27 ) ;
}
static int F_115 ( struct V_19 * V_73 ,
unsigned int V_100 )
{
switch ( V_100 ) {
case 8 :
...
static int F_116 ( struct V_19 * V_99 ,
unsigned int V_100 )
{
struct V_74 * * V_1 = F_16 ( V_99 ) ;
struct V_74 * V_75 = * V_1 ;
return F_117 ( & V_75 -> V_77 , V_100 ) ;
}
static int F_118 ( struct V_101 * V_58 )
{
T_1 V_102 = 0 ;
T_1 * V_36 , * V_35 , * V_103 ;
T_6 V_104 = F_119 ( 1 ) ;
...
T_1 V_5 [ 16 ] V_105 ( ( F_122 ( V_22 ) ) ) ;
struct V_106 V_107 ;
struct V_106 V_108 ;
unsigned int V_109 ;
if ( F_123 ( V_58 -> V_110 != 16 && V_58 -> V_110 != 20 ) )
return - V_34 ;
...
V_102 = 1 ;
F_125 ( & V_107 , V_58 -> V_36 ) ;
V_103 = F_126 ( & V_107 ) ;
V_36 = V_103 + V_58 -> V_110 ;
V_35 = V_36 ;
if ( F_123 ( V_58 -> V_36 != V_58 -> V_35 ) ) {
F_125 ( & V_108 , V_58 -> V_35 ) ;
V_35 = F_126 ( & V_108 ) + V_58 -> V_110 ;
}
} else {
V_103 = F_99 ( V_58 -> V_114 + V_10 + V_58 -> V_110 ,
V_115 ) ;
if ( F_123 ( ! V_103 ) )
return - V_90 ;
F_127 ( V_103 , V_58 -> V_36 , 0 ,
V_58 -> V_110 + V_58 -> V_114 , 0 ) ;
V_36 = V_103 + V_58 -> V_110 ;
V_35 = V_36 ;
}
F_21 () ;
F_128 ( V_12 , V_35 , V_36 , V_58 -> V_114 , V_5 ,
V_1 -> V_6 , V_103 , V_58 -> V_110 - 8 ,
V_35 + V_58 -> V_114 , V_10 ) ;
F_23 () ;
if ( V_102 ) {
if ( F_123 ( V_58 -> V_36 != V_58 -> V_35 ) ) {
F_129 ( V_35 - V_58 -> V_110 ) ;
F_130 ( & V_108 , V_58 -> V_35 -> V_112 ) ;
F_131 ( & V_108 , 1 , 0 ) ;
}
F_129 ( V_103 ) ;
F_130 ( & V_107 , V_58 -> V_36 -> V_112 ) ;
F_131 ( & V_107 , V_58 -> V_36 == V_58 -> V_35 , 0 ) ;
} else {
F_127 ( V_35 , V_58 -> V_35 , V_58 -> V_110 ,
V_58 -> V_114 + V_10 , 1 ) ;
F_107 ( V_103 ) ;
}
return 0 ;
}
static int F_132 ( struct V_101 * V_58 )
{
T_1 V_102 = 0 ;
T_1 * V_36 , * V_35 , * V_103 ;
...
V_103 = F_99 ( V_58 -> V_114 + V_58 -> V_110 , V_115 ) ;
if ( ! V_103 )
return - V_90 ;
F_127 ( V_103 , V_58 -> V_36 , 0 ,
V_58 -> V_110 + V_58 -> V_114 , 0 ) ;
...
F_21 () ;
F_133 ( V_12 , V_35 , V_36 , V_116 , V_5 ,
V_1 -> V_6 , V_103 , V_58 -> V_110 - 8 ,
V_118 , V_10 ) ;
F_23 () ;
V_117 = F_134 ( V_36 + V_116 , V_118 , V_10 ) ?
- V_119 : 0 ;
if ( V_102 ) {
if ( F_123 ( V_58 -> V_36 != V_58 -> V_35 ) ) {
F_129 ( V_35 - V_58 -> V_110 ) ;
...
static int F_135 ( struct V_101 * V_58 )
{
struct V_19 * V_20 = F_120 ( V_58 ) ;
...
static int F_139 ( struct V_101 * V_58 )
{
struct V_19 * V_20 = F_120 ( V_58 ) ;
struct V_74 * * V_1 = F_16 ( V_20 ) ;
struct V_74 * V_75 = * V_1 ;
