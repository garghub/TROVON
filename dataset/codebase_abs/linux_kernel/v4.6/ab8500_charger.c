...
int V_8 ;
struct V_1 * V_2 ;
if ( V_145 -> V_15 -> V_184 -> type == V_185 )
V_2 = F_45 ( V_145 ) ;
else if ( V_145 -> V_15 -> V_184 -> type == V_186 )
V_2 = F_52 ( V_145 ) ;
else
return - V_78 ;
V_8 = F_6 ( V_2 -> V_9 , V_35 ,
...
int V_8 ;
struct V_1 * V_2 ;
if ( V_145 -> V_15 -> V_184 -> type == V_186 )
V_2 = F_52 ( V_145 ) ;
else
return - V_78 ;
V_8 = F_56 ( V_2 -> V_9 ,
...
{
struct V_14 * V_15 ;
struct V_14 * V_193 = F_63 ( V_9 ) ;
const char * * V_194 = ( const char * * ) V_193 -> V_195 ;
struct V_1 * V_2 ;
union V_196 V_8 ;
int V_197 ;
struct V_144 * V_24 ;
...
V_15 = V_24 -> V_15 ;
V_2 = F_52 ( V_24 ) ;
V_197 = F_64 ( V_194 , V_193 -> V_198 , V_15 -> V_184 -> V_199 ) ;
if ( V_197 < 0 )
return 0 ;
for ( V_197 = 0 ; V_197 < V_193 -> V_184 -> V_200 ; V_197 ++ ) {
enum V_201 V_202 ;
V_202 = V_193 -> V_184 -> V_203 [ V_197 ] ;
if ( F_65 ( V_193 , V_202 , & V_8 ) )
continue;
switch ( V_202 ) {
case V_204 :
switch ( V_193 -> V_184 -> type ) {
case V_205 :
...
{
struct V_1 * V_2 =
F_67 ( V_208 , struct V_1 , V_232 . V_208 ) ;
int V_8 ;
if ( ! V_2 -> V_17 . V_34 ) {
V_8 = F_38 ( V_2 ,
V_2 -> V_58 . V_59 ) ;
...
static void F_82 ( struct V_207 * V_208 )
{
int V_8 ;
T_1 V_116 ;
bool V_250 ;
...
static void F_90 ( struct V_207 * V_208 )
{
struct V_1 * V_2 = F_67 ( V_208 ,
...
static T_3 F_98 ( int V_260 , void * V_261 )
{
struct V_1 * V_2 = V_261 ;
F_2 ( V_2 -> V_9 , L_90 ) ;
V_2 -> V_22 . V_23 = true ;
...
static T_3 F_99 ( int V_260 , void * V_261 )
{
struct V_1 * V_2 = V_261 ;
F_2 ( V_2 -> V_9 , L_91 ) ;
V_2 -> V_22 . V_216 = true ;
...
if ( F_104 ( V_2 -> V_10 ) || F_105 ( V_2 -> V_10 )
|| F_106 ( V_2 -> V_10 ) || F_35 ( V_2 -> V_10 ) )
V_8 = F_56 ( V_2 -> V_9 ,
V_35 ,
V_292 ,
V_293 ,
...
static int F_108 ( struct V_171 * V_319 ,
unsigned long V_173 , void * V_320 )
{
struct V_1 * V_2 =
F_67 ( V_319 , struct V_1 , V_319 ) ;
enum V_321 V_322 ;
...
F_2 ( V_2 -> V_9 , L_105 ,
V_33 , V_322 , V_323 ) ;
F_109 ( & V_2 -> V_105 . V_240 ) ;
V_2 -> V_105 . V_242 = V_322 ;
V_2 -> V_105 . V_243 = V_323 ;
F_110 ( & V_2 -> V_105 . V_240 ) ;
...
static int F_113 ( struct V_327 * V_328 ,
T_4 V_241 )
{
struct V_1 * V_2 = F_112 ( V_328 ) ;
F_53 ( & V_2 -> V_212 ) ;
...
static int F_117 ( struct V_327 * V_328 )
{
struct V_1 * V_2 = F_112 ( V_328 ) ;
int V_95 , V_260 , V_8 ;
...
V_260 = F_118 ( V_328 , V_330 [ V_95 ] . V_199 ) ;
F_119 ( V_260 , V_2 ) ;
}
V_8 = F_56 ( V_2 -> V_9 ,
V_310 , V_314 , V_315 , 0 ) ;
...
F_125 ( V_2 -> V_165 . V_15 ) ;
return 0 ;
}
static int F_126 ( struct V_327 * V_328 )
{
struct V_335 * V_336 = V_328 -> V_9 . V_337 ;
struct V_338 * V_339 = V_328 -> V_9 . V_340 ;
struct V_341 V_342 = {} , V_343 = {} ;
struct V_1 * V_2 ;
int V_260 , V_95 , V_344 , V_8 = 0 , V_345 ;
V_2 = F_127 ( & V_328 -> V_9 , sizeof( * V_2 ) , V_346 ) ;
if ( ! V_2 ) {
...
V_2 -> V_100 = V_339 ;
if ( V_336 ) {
V_8 = F_128 ( & V_328 -> V_9 , V_336 , V_2 -> V_100 ) ;
if ( V_8 ) {
F_5 ( & V_328 -> V_9 , L_108 ) ;
return V_8 ;
}
V_2 -> V_16 = F_129 ( V_336 , L_109 ) ;
} else
V_2 -> V_16 = false ;
V_2 -> V_9 = & V_328 -> V_9 ;
V_2 -> V_10 = F_63 ( V_328 -> V_9 . V_10 ) ;
V_2 -> V_31 = F_130 ( L_110 ) ;
F_131 ( & V_2 -> V_105 . V_240 ) ;
F_132 ( & V_2 -> V_135 ) ;
V_2 -> V_20 = false ;
V_2 -> V_235 = 0 ;
V_342 . V_195 = V_348 ;
V_342 . V_198 = F_28 ( V_348 ) ;
V_342 . V_349 = & V_2 -> V_165 ;
V_343 . V_195 = V_348 ;
V_343 . V_198 = F_28 ( V_348 ) ;
V_343 . V_349 = & V_2 -> V_24 ;
V_2 -> V_165 . V_350 . V_146 = & F_44 ;
V_2 -> V_165 . V_350 . V_351 = & F_57 ;
V_2 -> V_165 . V_350 . V_352 = & F_58 ;
V_2 -> V_165 . V_350 . V_353 = & F_59 ;
V_2 -> V_165 . V_354 = V_97 [
F_28 ( V_97 ) - 1 ] ;
V_2 -> V_165 . V_355 =
V_2 -> V_100 -> V_101 [ V_2 -> V_100 -> V_102 - 1 ] ;
V_2 -> V_165 . V_356 = V_357 ;
V_2 -> V_165 . V_332 = V_2 -> V_100 -> V_358 ;
V_2 -> V_165 . V_334 = false ;
if ( ! V_2 -> V_165 . V_332 )
F_133 (
& V_333 , & V_172 ) ;
V_2 -> V_24 . V_350 . V_146 = & F_51 ;
V_2 -> V_24 . V_350 . V_351 = & F_55 ;
V_2 -> V_24 . V_350 . V_352 = & F_58 ;
V_2 -> V_24 . V_350 . V_353 = & F_59 ;
V_2 -> V_24 . V_350 . V_359 = & F_60 ;
V_2 -> V_24 . V_350 . V_360 = & F_61 ;
V_2 -> V_24 . V_354 = V_97 [
F_28 ( V_97 ) - 1 ] ;
V_2 -> V_24 . V_355 =
V_2 -> V_100 -> V_101 [ V_2 -> V_100 -> V_102 - 1 ] ;
V_2 -> V_24 . V_356 = V_357 ;
V_2 -> V_24 . V_332 = V_2 -> V_100 -> V_361 ;
V_2 -> V_24 . V_334 = false ;
V_2 -> V_24 . V_362 = V_2 -> V_100 -> V_363 ;
V_2 -> V_105 . V_106 = - 1 ;
V_2 -> V_27 =
F_134 ( L_111 ) ;
if ( V_2 -> V_27 == NULL ) {
...
if ( V_2 -> V_165 . V_332 ) {
V_2 -> V_165 . V_15 = F_141 ( V_2 -> V_9 ,
& V_365 ,
& V_342 ) ;
if ( F_139 ( V_2 -> V_165 . V_15 ) ) {
F_5 ( V_2 -> V_9 , L_116 ) ;
V_8 = F_140 ( V_2 -> V_165 . V_15 ) ;
goto V_364;
}
}
if ( V_2 -> V_24 . V_332 ) {
V_2 -> V_24 . V_15 = F_141 ( V_2 -> V_9 ,
& V_366 ,
& V_343 ) ;
if ( F_139 ( V_2 -> V_24 . V_15 ) ) {
F_5 ( V_2 -> V_9 , L_117 ) ;
V_8 = F_140 ( V_2 -> V_24 . V_15 ) ;
goto V_367;
}
}
V_2 -> V_331 = F_142 ( V_368 ) ;
if ( F_143 ( V_2 -> V_331 ) ) {
F_5 ( V_2 -> V_9 , L_118 ) ;
V_8 = - V_282 ;
goto V_369;
}
V_2 -> V_319 . V_370 = F_108 ;
V_8 = F_144 ( V_2 -> V_331 , & V_2 -> V_319 ) ;
if ( V_8 ) {
F_5 ( V_2 -> V_9 , L_119 ) ;
goto V_371;
}
...
for ( V_95 = 0 ; V_95 < F_28 ( V_330 ) ; V_95 ++ ) {
V_260 = F_118 ( V_328 , V_330 [ V_95 ] . V_199 ) ;
V_8 = F_145 ( V_260 , NULL , V_330 [ V_95 ] . V_372 ,
V_373 | V_374 ,
V_330 [ V_95 ] . V_199 , V_2 ) ;
if ( V_8 != 0 ) {
F_5 ( V_2 -> V_9 , L_120
, V_330 [ V_95 ] . V_199 , V_260 , V_8 ) ;
goto F_119;
}
F_2 ( V_2 -> V_9 , L_121 ,
V_330 [ V_95 ] . V_199 , V_260 , V_8 ) ;
