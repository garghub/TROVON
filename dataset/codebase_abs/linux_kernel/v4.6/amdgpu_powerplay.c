...
V_2 -> V_6 . V_17 ) ;
#ifdef F_2
if ( V_2 -> V_7 && V_2 -> V_40 . V_41 ) {
F_10 ( V_2 ) ;
F_11 ( V_2 , V_42 , NULL , NULL ) ;
}
#endif
return V_3 ;
}
...
int V_3 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) V_36 ;
if ( V_2 -> V_6 . V_20 -> V_43 )
V_3 = V_2 -> V_6 . V_20 -> V_43 (
V_2 -> V_6 . V_17 ) ;
#ifdef F_2
if ( V_2 -> V_7 )
V_2 -> V_40 . V_41 = true ;
...
int V_3 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) V_36 ;
if ( V_2 -> V_6 . V_20 -> V_44 )
V_3 = V_2 -> V_6 . V_20 -> V_44 (
V_2 -> V_6 . V_17 ) ;
if ( V_3 )
return V_3 ;
#ifdef F_2
...
F_17 ( V_2 ) ;
if ( V_2 -> V_6 . V_20 -> V_47 )
V_3 = V_2 -> V_6 . V_20 -> V_47 (
V_2 -> V_6 . V_17 ) ;
return V_3 ;
}
...
int V_3 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) V_36 ;
if ( V_2 -> V_6 . V_20 -> V_55 )
V_3 = V_2 -> V_6 . V_20 -> V_55 (
V_2 -> V_6 . V_17 , V_52 ) ;
return V_3 ;
}
