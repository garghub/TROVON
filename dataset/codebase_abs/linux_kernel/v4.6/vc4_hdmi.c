...
struct V_5 * V_40 ;
int V_35 = 0 ;
V_40 = F_24 ( V_15 -> V_15 , sizeof( * V_40 ) ,
V_41 ) ;
if ( ! V_40 ) {
V_35 = - V_42 ;
goto V_43;
...
T_1 V_61 = ( V_54 -> V_62 >>
( ( V_54 -> V_57 & V_63 ) ? 1 : 0 ) ) ;
T_1 V_64 = ( F_32 ( V_54 -> V_65 - V_54 -> V_66 ,
V_67 ) |
F_32 ( V_54 -> V_66 - V_54 -> V_62 ,
V_68 ) |
F_32 ( V_61 , V_69 ) ) ;
T_1 V_70 = ( F_32 ( 0 , V_71 ) |
F_32 ( V_54 -> V_72 - V_54 -> V_65 ,
V_73 ) ) ;
if ( V_55 ) {
F_11 ( L_3 ) ;
F_10 ( V_15 ) ;
...
F_33 ( V_74 , 0 ) ;
F_34 ( V_18 -> V_26 -> V_75 , V_54 -> clock * 1000 ) ;
F_35 ( V_76 ,
F_8 ( V_76 ) |
V_77 |
V_78 ) ;
...
F_32 ( V_54 -> V_82 , V_83 ) ) ;
F_35 ( V_84 ,
F_32 ( V_54 -> V_85 - V_54 -> V_86 ,
V_87 ) |
F_32 ( V_54 -> V_86 - V_54 -> V_88 ,
V_89 ) |
F_32 ( V_54 -> V_88 - V_54 -> V_82 ,
V_90 ) ) ;
F_35 ( V_91 , V_64 ) ;
F_35 ( V_92 , V_64 ) ;
F_35 ( V_93 , V_70 ) ;
...
static int F_42 ( struct V_115 * V_15 , struct V_115 * V_116 , void * V_117 )
{
struct V_118 * V_119 = F_43 ( V_15 ) ;
struct V_14 * V_120 = F_44 ( V_116 ) ;
...
T_1 V_125 ;
int V_35 ;
V_26 = F_24 ( V_15 , sizeof( * V_26 ) , V_41 ) ;
if ( ! V_26 )
return - V_42 ;
...
V_26 -> V_119 = V_119 ;
V_26 -> V_127 = F_45 ( V_119 , 0 ) ;
if ( F_46 ( V_26 -> V_127 ) )
return F_47 ( V_26 -> V_127 ) ;
V_26 -> V_23 = F_45 ( V_119 , 1 ) ;
if ( F_46 ( V_26 -> V_23 ) )
return F_47 ( V_26 -> V_23 ) ;
V_124 = F_48 ( V_15 -> V_128 , L_9 , 0 ) ;
if ( ! V_124 ) {
F_49 ( L_10 ) ;
return - V_38 ;
}
V_26 -> V_75 = F_50 ( V_15 , L_11 ) ;
if ( F_46 ( V_26 -> V_75 ) ) {
F_49 ( L_12 ) ;
return F_47 ( V_26 -> V_75 ) ;
}
V_26 -> V_129 = F_50 ( V_15 , L_13 ) ;
if ( F_46 ( V_26 -> V_129 ) ) {
F_49 ( L_14 ) ;
return F_47 ( V_26 -> V_129 ) ;
}
V_26 -> V_37 = F_51 ( V_124 ) ;
if ( ! V_26 -> V_37 ) {
F_52 ( L_15 ) ;
return - V_130 ;
}
...
V_35 = F_34 ( V_26 -> V_129 , 163682864 ) ;
if ( V_35 ) {
F_49 ( L_17 , V_35 ) ;
goto V_132;
}
V_35 = F_53 ( V_26 -> V_129 ) ;
if ( V_35 ) {
F_49 ( L_18 ,
V_35 ) ;
goto V_132;
}
if ( F_54 ( V_15 -> V_128 , L_19 , & V_125 ) ) {
enum V_133 V_134 ;
V_26 -> V_27 = F_55 ( V_15 -> V_128 ,
L_19 , 0 ,
& V_134 ) ;
if ( V_26 -> V_27 < 0 ) {
V_35 = V_26 -> V_27 ;
