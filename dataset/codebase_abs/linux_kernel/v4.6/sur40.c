...
if ( error )
goto V_126;
V_19 -> V_129 = F_55 ( V_19 -> V_2 ) ;
if ( F_56 ( V_19 -> V_129 ) ) {
F_21 ( V_19 -> V_2 , L_26 ) ;
error = F_57 ( V_19 -> V_129 ) ;
goto V_126;
}
V_19 -> V_130 = V_131 ;
...
F_58 ( & V_19 -> V_130 , V_19 ) ;
error = F_59 ( & V_19 -> V_130 , V_133 , - 1 ) ;
if ( error ) {
F_21 ( & V_97 -> V_2 ,
L_27 ) ;
goto V_134;
...
F_6 ( V_19 ) ;
F_60 ( V_97 , NULL ) ;
F_8 ( & V_97 -> V_2 , L_29 , V_135 ) ;
}
static int F_68 ( struct V_136 * V_137 ,
unsigned int * V_138 , unsigned int * V_139 ,
unsigned int V_140 [] , void * V_141 [] )
{
struct V_1 * V_19 = F_69 ( V_137 ) ;
if ( V_137 -> V_142 + * V_138 < 3 )
* V_138 = 3 - V_137 -> V_142 ;
V_141 [ 0 ] = V_19 -> V_129 ;
if ( * V_139 )
return V_140 [ 0 ] < V_76 . V_77 ? - V_143 : 0 ;
* V_139 = 1 ;
V_140 [ 0 ] = V_76 . V_77 ;
return 0 ;
}
static int F_70 ( struct V_144 * V_78 )
{
struct V_1 * V_19 = F_69 ( V_78 -> V_136 ) ;
unsigned long V_6 = V_76 . V_77 ;
if ( F_71 ( V_78 , 0 ) < V_6 ) {
F_21 ( & V_19 -> V_7 -> V_2 , L_30 ,
F_71 ( V_78 , 0 ) , V_6 ) ;
return - V_143 ;
}
F_72 ( V_78 , 0 , V_6 ) ;
...
static void F_73 ( struct V_144 * V_78 )
{
struct V_1 * V_19 = F_69 ( V_78 -> V_136 ) ;
struct V_61 * V_145 = (struct V_61 * ) V_78 ;
F_27 ( & V_19 -> V_68 ) ;
F_74 ( & V_145 -> V_71 , & V_19 -> V_69 ) ;
F_29 ( & V_19 -> V_68 ) ;
}
static void F_75 ( struct V_1 * V_19 ,
enum V_146 V_147 )
{
...
static int F_77 ( struct V_136 * V_149 , unsigned int V_58 )
{
struct V_1 * V_19 = F_69 ( V_149 ) ;
V_19 -> V_83 = 0 ;
return 0 ;
}
...
V_48 -> type = V_165 ;
V_48 -> V_166 = V_167 ;
F_81 ( V_48 -> V_119 , L_31 , sizeof( V_48 -> V_119 ) ) ;
V_48 -> V_162 = 0 ;
return 0 ;
}
static int F_83 ( struct V_150 * V_150 , void * V_151 , unsigned int V_48 )
{
return ( V_48 == 0 ) ? 0 : - V_143 ;
}
static int F_84 ( struct V_150 * V_150 , void * V_151 , unsigned int * V_48 )
{
* V_48 = 0 ;
return 0 ;
}
...
return - V_143 ;
V_169 -> type = V_179 ;
V_169 -> V_180 . V_181 = V_76 . V_181 ;
V_169 -> V_180 . V_182 = V_76 . V_182 ;
return 0 ;
}
