...
if ( error )
return error ;
V_30 -> V_117 = F_40 ( & V_240 . V_112 ) ;
V_30 -> V_118 = F_40 ( & V_240 . V_113 ) ;
error = F_18 ( V_32 ,
V_86 -> V_103 + V_243 ,
1 , & V_241 ) ;
if ( error )
return error ;
V_30 -> V_244 = V_241 & V_245 ;
return 0 ;
}
...
if ( error )
return error ;
V_30 -> V_117 = F_40 ( & V_246 ) ;
error = F_18 ( V_32 ,
V_86 -> V_103 + V_251 ,
sizeof( V_247 ) , & V_247 ) ;
if ( error )
return error ;
V_30 -> V_118 = F_40 ( & V_247 ) ;
error = F_18 ( V_32 ,
V_86 -> V_103 + V_252 ,
1 , & V_203 ) ;
if ( error )
return error ;
V_30 -> V_244 = V_203 & V_253 ;
error = F_18 ( V_32 ,
V_86 -> V_103 + V_254 ,
1 , & V_248 ) ;
if ( error )
...
int V_87 ;
V_104 -> V_258 = L_65 ;
F_73 ( V_259 , V_104 -> V_260 ) ;
F_74 ( V_104 , V_261 , V_262 ) ;
F_74 ( V_104 , V_263 , V_262 ) ;
F_74 ( V_104 , V_128 ,
V_262 ) ;
F_74 ( V_104 , V_129 ,
V_262 ) ;
...
V_104 -> V_271 = V_272 ;
V_104 -> V_273 = V_274 ;
F_75 ( V_104 , V_264 , V_275 ) ;
F_79 ( V_104 , V_261 , 0 , V_30 -> V_117 , 0 , 0 ) ;
F_79 ( V_104 , V_263 , 0 , V_30 -> V_118 , 0 , 0 ) ;
if ( V_30 -> V_235 == V_9 ||
( V_30 -> V_235 == V_237 &&
V_30 -> V_148 ) ) {
F_79 ( V_104 , V_276 , 0 , 255 , 0 , 0 ) ;
}
if ( V_107 -> V_108 ) {
F_72 ( V_104 , V_30 ) ;
V_266 |= V_277 ;
...
static void F_84 ( const struct V_202 * V_203 , void * V_283 )
{
F_85 ( V_283 , V_203 ) ;
F_86 ( V_203 ) ;
}
...
static int F_89 ( struct V_29 * V_30 , T_2 V_289 )
{
struct V_38 * V_33 = & V_30 -> V_32 -> V_33 ;
int error ;
struct V_290 * V_291 ;
struct V_290 V_292 = { . V_293 = 0 , . V_294 = 0 } ;
if ( V_289 == V_295 )
V_291 = & V_292 ;
else
V_291 = & V_30 -> V_296 ;
error = F_19 ( V_30 -> V_32 , V_30 -> V_224 ,
sizeof( V_30 -> V_296 ) , V_291 ) ;
if ( error )
return error ;
F_5 ( V_33 , L_77 ,
V_291 -> V_293 , V_291 -> V_294 ) ;
return 0 ;
}
...
sizeof( V_30 -> V_296 ) , & V_30 -> V_296 ) ;
if ( error )
return error ;
if ( V_30 -> V_296 . V_293 == 0 || V_30 -> V_296 . V_294 == 0 ) {
if ( ! V_56 ) {
F_5 ( V_33 , L_78 ) ;
F_51 ( V_30 ) ;
V_56 = true ;
...
F_5 ( V_33 , L_79 ) ;
V_30 -> V_296 . V_293 = 20 ;
V_30 -> V_296 . V_294 = 100 ;
return F_89 ( V_30 , V_297 ) ;
}
}
F_5 ( V_33 , L_80 ,
V_30 -> V_296 . V_293 , V_30 -> V_296 . V_294 ) ;
return 0 ;
}
...
V_59 -> V_234 & 0xf , V_59 -> V_298 , V_59 -> V_88 ) ;
return 0 ;
}
static T_7 F_90 ( struct V_38 * V_33 ,
struct V_299 * V_300 , char * V_52 )
{
struct V_29 * V_30 = F_91 ( V_33 ) ;
struct V_213 * V_59 = & V_30 -> V_59 ;
return F_92 ( V_52 , V_301 , L_85 ,
V_59 -> V_234 >> 4 , V_59 -> V_234 & 0xf , V_59 -> V_298 ) ;
}
static T_7 F_93 ( struct V_38 * V_33 ,
struct V_299 * V_300 , char * V_52 )
{
struct V_29 * V_30 = F_91 ( V_33 ) ;
struct V_213 * V_59 = & V_30 -> V_59 ;
return F_92 ( V_52 , V_301 , L_86 ,
V_59 -> V_60 , V_59 -> V_219 ) ;
}
static T_7 F_94 ( char * V_52 , int V_43 ,
struct V_1 * V_86 , int V_208 ,
const T_2 * V_42 )
{
int V_87 ;
if ( F_2 ( V_86 ) > 1 )
V_43 += F_92 ( V_52 + V_43 , V_301 - V_43 ,
L_87 , V_208 ) ;
for ( V_87 = 0 ; V_87 < F_1 ( V_86 ) ; V_87 ++ )
V_43 += F_92 ( V_52 + V_43 , V_301 - V_43 ,
L_88 , V_87 , V_42 [ V_87 ] , V_42 [ V_87 ] ) ;
V_43 += F_92 ( V_52 + V_43 , V_301 - V_43 , L_89 ) ;
return V_43 ;
}
...
V_43 += F_92 ( V_52 + V_43 , V_301 - V_43 ,
L_90 , V_86 -> type ) ;
for ( V_302 = 0 ; V_302 < F_2 ( V_86 ) ; V_302 ++ ) {
T_3 V_209 = F_1 ( V_86 ) ;
T_3 V_46 = V_86 -> V_103 + V_302 * V_209 ;
error = F_18 ( V_30 -> V_32 , V_46 , V_209 , V_303 ) ;
if ( error )
goto V_304;
V_43 = F_94 ( V_52 , V_43 , V_86 , V_302 , V_303 ) ;
}
}
V_304:
F_22 ( V_303 ) ;
...
static int F_96 ( struct V_38 * V_33 ,
const struct V_202 * V_305 )
{
unsigned int V_306 = 0 ;
char V_307 ;
while ( V_306 < V_305 -> V_209 ) {
V_307 = * ( V_305 -> V_30 + V_306 ) ;
if ( V_307 < '0' || ( V_307 > '9' && V_307 < 'A' ) || V_307 > 'F' )
return 0 ;
V_306 ++ ;
}
F_9 ( V_33 , L_91 ) ;
...
static int F_97 ( struct V_38 * V_33 , const char * V_308 )
{
struct V_29 * V_30 = F_91 ( V_33 ) ;
const struct V_202 * V_305 = NULL ;
unsigned int V_309 ;
unsigned int V_306 = 0 ;
unsigned int V_56 = 0 ;
unsigned int V_310 = 0 ;
int V_40 ;
V_40 = F_98 ( & V_305 , V_308 , V_33 ) ;
if ( V_40 ) {
F_9 ( V_33 , L_92 , V_308 ) ;
return V_40 ;
}
V_40 = F_96 ( V_33 , V_305 ) ;
if ( V_40 )
goto F_86;
if ( ! V_30 -> V_181 ) {
V_30 -> V_181 = true ;
...
if ( V_40 )
goto F_53;
V_309 = ( ( * ( V_305 -> V_30 + V_306 ) << 8 ) | * ( V_305 -> V_30 + V_306 + 1 ) ) ;
V_309 += 2 ;
V_40 = F_12 ( V_30 , V_305 -> V_30 + V_306 , V_309 ) ;
if ( V_40 )
goto F_53;
...
if ( V_310 % 50 == 0 )
F_5 ( V_33 , L_95 ,
V_310 , V_306 , V_305 -> V_209 ) ;
}
V_40 = F_6 ( V_30 , & V_30 -> V_71 ,
V_285 ) ;
if ( V_40 )
goto F_53;
F_5 ( V_33 , L_96 , V_310 , V_306 ) ;
...
static T_7 F_99 ( struct V_38 * V_33 ,
struct V_299 * V_300 ,
const char * V_52 , T_1 V_43 )
{
struct V_29 * V_30 = F_91 ( V_33 ) ;
int error ;
error = F_97 ( V_33 , V_313 ) ;
if ( error ) {
F_9 ( V_33 , L_97 , error ) ;
V_43 = error ;
} else {
...
{
struct V_106 * V_107 ;
struct V_319 * V_320 = V_32 -> V_33 . V_321 ;
T_4 * V_322 ;
int V_323 , V_40 ;
if ( ! V_320 )
return F_104 ( - V_324 ) ;
V_107 = F_105 ( & V_32 -> V_33 , sizeof( * V_107 ) , V_84 ) ;
if ( ! V_107 )
return F_104 ( - V_85 ) ;
if ( F_106 ( V_320 , L_99 , & V_323 ) ) {
V_107 -> V_108 = V_323 / sizeof( T_4 ) ;
V_322 = F_105 ( & V_32 -> V_33 ,
V_107 -> V_108 * sizeof( V_322 [ 0 ] ) ,
V_84 ) ;
if ( ! V_322 )
return F_104 ( - V_85 ) ;
V_40 = F_107 ( V_320 , L_99 ,
V_322 , V_107 -> V_108 ) ;
if ( V_40 )
F_25 ( & V_32 -> V_33 ,
L_100 , V_40 ) ;
...
static const struct V_106 * F_108 ( struct V_81 * V_32 )
{
struct V_325 * V_326 ;
...
return F_104 ( - V_324 ) ;
while ( V_330 -> V_334 ) {
if ( ! strcmp ( F_111 ( V_326 ) , V_330 -> V_334 ) )
return & V_330 -> V_107 ;
V_330 ++ ;
}
return F_104 ( - V_324 ) ;
...
F_112 ( struct V_81 * V_32 )
{
const struct V_106 * V_107 ;
V_107 = F_113 ( & V_32 -> V_33 ) ;
if ( V_107 )
return V_107 ;
V_107 = F_103 ( V_32 ) ;
if ( ! F_114 ( V_107 ) || F_115 ( V_107 ) != - V_324 )
return V_107 ;
V_107 = F_108 ( V_32 ) ;
if ( ! F_114 ( V_107 ) || F_115 ( V_107 ) != - V_324 )
return V_107 ;
...
static int F_116 ( struct V_81 * V_32 , const struct V_335 * V_111 )
{
struct V_29 * V_30 ;
const struct V_106 * V_107 ;
int error ;
...
snprintf ( V_30 -> V_267 , sizeof( V_30 -> V_267 ) , L_102 ,
V_32 -> V_53 -> V_336 , V_32 -> V_46 ) ;
V_30 -> V_32 = V_32 ;
V_30 -> V_107 = V_107 ;
...
F_118 ( & V_30 -> V_95 ) ;
F_118 ( & V_30 -> V_92 ) ;
error = F_119 ( V_32 -> V_179 , NULL , F_46 ,
V_107 -> V_337 | V_338 ,
V_32 -> V_258 , V_30 ) ;
if ( error ) {
F_9 ( & V_32 -> V_33 , L_103 ) ;
...
if ( error )
goto V_339;
error = F_120 ( & V_32 -> V_33 . V_340 , & V_341 ) ;
if ( error ) {
F_9 ( & V_32 -> V_33 , L_104 ,
error ) ;
goto V_342;
...
F_66 ( V_30 ) ;
V_339:
F_121 ( V_32 -> V_179 , V_30 ) ;
V_279:
F_22 ( V_30 ) ;
return error ;
}
static int F_122 ( struct V_81 * V_32 )
{
struct V_29 * V_30 = F_123 ( V_32 ) ;
F_124 ( & V_32 -> V_33 . V_340 , & V_341 ) ;
F_121 ( V_30 -> V_179 , V_30 ) ;
F_64 ( V_30 ) ;
F_66 ( V_30 ) ;
F_22 ( V_30 ) ;
return 0 ;
...
static int T_8 F_129 ( struct V_38 * V_33 )
{
struct V_81 * V_32 = F_126 ( V_33 ) ;
struct V_29 * V_30 = F_123 ( V_32 ) ;
struct V_104 * V_104 = V_30 -> V_104 ;
