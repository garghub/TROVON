...
if ( ( V_2 -> V_7 == V_8 ) ||
( V_2 -> V_7 == V_9 ) ) {
V_20 = F_16 ( V_2 -> V_18 , F_13 ,
0 , L_2 , V_2 ) ;
if ( V_20 )
goto V_21;
V_20 = F_16 ( V_2 -> V_19 , F_13 ,
0 , L_3 , V_2 ) ;
if ( V_20 ) {
F_17 ( V_2 -> V_18 , V_2 ) ;
goto V_21;
...
V_43 |= F_27 ( V_41 , V_2 -> V_5 ) ? V_48 : 0 ;
if ( ( V_2 -> V_7 == V_9 ) && ( V_43 & V_15 ) )
V_43 = V_48 | V_46 | V_15 ;
V_43 |= ( F_28 ( V_41 , V_2 -> V_5 ) ) ? V_49 : V_38 ;
* V_40 = V_43 ;
return 0 ;
}
...
struct V_65 * V_66 ;
int V_20 , V_67 ;
V_2 = F_34 ( sizeof( struct V_1 ) , V_68 ) ;
if ( ! V_2 )
return - V_69 ;
V_2 -> V_5 = V_64 -> V_70 ;
V_67 = F_35 ( F_2 ( V_71 ) ) ;
...
V_66 = F_36 ( V_64 , V_83 , L_9 ) ;
V_2 -> V_84 = V_66 ? V_66 -> V_52 : 0 ;
V_66 = F_36 ( V_64 , V_83 , L_10 ) ;
V_2 -> V_18 = V_66 ? V_66 -> V_52 : - 1 ;
if ( V_2 -> V_7 == V_77 ) {
V_2 -> V_6 = V_66 ? V_66 -> V_52 : - 1 ;
V_2 -> V_18 = V_66 ? F_37 ( V_66 -> V_52 ) : - 1 ;
}
V_66 = F_36 ( V_64 , V_83 , L_11 ) ;
V_2 -> V_11 = V_66 ? V_66 -> V_52 : - 1 ;
V_66 = F_36 ( V_64 , V_83 , L_12 ) ;
V_2 -> V_19 = V_66 ? V_66 -> V_52 : - 1 ;
V_20 = - V_81 ;
V_66 = F_36 ( V_64 , V_85 , L_13 ) ;
if ( ! V_66 ) {
F_22 ( V_86 L_14 ,
V_2 -> V_5 ) ;
goto V_82;
