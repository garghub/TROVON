...
V_118 . V_65 = V_6 -> V_65 ;
V_118 . V_121 = V_6 -> V_135 ;
V_118 . V_209 = V_6 -> V_148 . V_209 ;
V_118 . V_210 = V_6 -> V_148 . V_210 ;
V_118 . V_211 = V_6 -> V_148 . V_211 ;
...
T_1 V_26 ;
F_9 ( & V_2 -> V_14 -> V_6 , L_4 ) ;
V_8 = F_13 ( V_2 , V_214 , & V_26 ) ;
if ( V_8 )
goto V_62;
V_26 |= 0x09 ;
V_8 = F_12 ( V_2 , V_214 , V_26 ) ;
if ( V_8 )
goto V_62;
V_8 = F_10 ( V_2 , V_215 , L_46 , 4 ) ;
if ( V_8 )
goto V_62;
V_8 = F_10 ( V_2 , V_216 , L_47 , 4 ) ;
if ( V_8 )
goto V_62;
return V_8 ;
V_62:
...
static int F_52 ( struct V_1 * V_2 , int V_217 )
{
int V_8 ;
T_1 V_218 , V_219 , V_220 [ 2 ] ;
F_9 ( & V_2 -> V_14 -> V_6 , L_48 , V_217 ) ;
V_8 = F_13 ( V_2 , V_221 , & V_219 ) ;
if ( V_8 )
goto V_62;
V_8 = F_13 ( V_2 , V_100 , & V_218 ) ;
if ( V_8 )
goto V_62;
F_9 ( & V_2 -> V_14 -> V_6 , L_49 , V_219 , V_218 ) ;
if ( V_217 ) {
V_218 |= 0x01 ;
V_218 &= ( ~ 0x10 ) ;
V_218 |= 0x04 ;
...
F_9 ( & V_2 -> V_14 -> V_6 , L_50 , V_219 , V_218 ) ;
V_8 = F_12 ( V_2 , V_221 , V_219 ) ;
if ( V_8 )
goto V_62;
V_8 = F_12 ( V_2 , V_100 , V_218 ) ;
if ( V_8 )
goto V_62;
V_8 = F_10 ( V_2 , V_222 , V_220 , 2 ) ;
if ( V_8 )
goto V_62;
if ( V_217 )
...
static int F_55 ( struct V_1 * V_2 , int V_217 )
{
int V_8 ;
F_9 ( & V_2 -> V_14 -> V_6 , L_48 , V_217 ) ;
if ( V_217 ) {
...
if ( V_8 )
goto V_62;
V_8 = F_14 ( V_2 , V_223 , 0x00 , 0x10 ) ;
if ( V_8 )
goto V_62;
V_8 = F_14 ( V_2 , V_224 , 0x80 , 0x80 ) ;
if ( V_8 )
goto V_62;
V_8 = F_14 ( V_2 , V_224 , 0x20 , 0x20 ) ;
if ( V_8 )
goto V_62;
V_8 = F_10 ( V_2 , V_222 , L_51 , 2 ) ;
if ( V_8 )
goto V_62;
...
if ( V_8 )
goto V_62;
V_8 = F_14 ( V_2 , V_224 , 0x00 , 0x80 ) ;
if ( V_8 )
goto V_62;
V_8 = F_10 ( V_2 , V_222 , L_52 , 2 ) ;
if ( V_8 )
goto V_62;
}
return V_8 ;
...
static int F_56 ( struct V_1 * V_2 , int V_217 )
{
struct V_5 * V_6 = F_20 ( V_2 ) ;
if ( V_6 -> V_107 == V_108 )
return F_52 ( V_2 , V_217 ) ;
else
return F_55 ( V_2 , V_217 ) ;
}
static int F_57 ( struct V_173 * V_131 , int V_217 )
{
...
int V_8 ;
T_1 V_26 ;
F_9 ( & V_2 -> V_14 -> V_6 , L_53 , V_131 -> V_225 , V_217 ) ;
if ( V_6 -> V_107 == V_108 )
return 0 ;
if ( V_131 -> V_225 == 0 ) {
if ( V_217 )
...
V_26 = 0x00 ;
V_8 = F_14 ( V_2 , V_224 , V_26 , 0x48 ) ;
if ( V_8 )
goto V_62;
} else if ( V_131 -> V_225 == 1 ) {
V_8 = V_118 -> V_226 ( V_6 -> V_135 , V_217 ) ;
if ( V_8 )
goto V_62;
}
return 0 ;
...
if ( ! V_6 -> V_231 ) {
for ( V_227 = 0 ; V_227 < F_61 ( V_230 ) ; V_227 ++ ) {
V_8 = F_12 ( V_2 , V_230 [ V_227 ] . V_25 ,
V_230 [ V_227 ] . V_26 ) ;
if ( V_8 )
goto V_62;
}
...
V_8 = F_11 ( V_2 , V_232 , V_13 , 5 ) ;
if ( V_8 )
goto V_62;
if ( V_13 [ 4 ] & 0x01 ) {
if ( V_13 [ 2 ] == ( T_1 ) ~ V_13 [ 3 ] ) {
if ( V_13 [ 0 ] == ( T_1 ) ~ V_13 [ 1 ] ) {
V_228 = F_62 ( V_13 [ 0 ] , V_13 [ 2 ] ) ;
} else {
V_228 = F_63 ( V_13 [ 0 ] << 8 | V_13 [ 1 ] ,
V_13 [ 2 ] ) ;
}
} else {
V_228 = F_64 ( V_13 [ 0 ] << 24 | V_13 [ 1 ] << 16 |
V_13 [ 2 ] << 8 | V_13 [ 3 ] ) ;
}
F_65 ( V_2 -> V_233 , V_234 , V_228 , 0 ) ;
V_8 = F_12 ( V_2 , V_235 , 1 ) ;
if ( V_8 )
goto V_62;
V_8 = F_12 ( V_2 , V_235 , 1 ) ;
if ( V_8 )
...
if ( ! V_6 -> V_231 ) {
static const struct V_246 V_251 [] = {
{ V_223 , 0x00 , 0x04 } ,
{ V_223 , 0x00 , 0x08 } ,
{ V_252 , 0x20 , 0x20 } ,
{ V_61 , 0x00 , 0x08 } ,
...
for ( V_227 = 0 ; V_227 < F_61 ( V_251 ) ; V_227 ++ ) {
V_8 = F_14 ( V_2 , V_251 [ V_227 ] . V_25 ,
V_251 [ V_227 ] . V_26 , V_251 [ V_227 ] . V_34 ) ;
if ( V_8 )
goto V_62;
}
V_6 -> V_231 = true ;
}
V_8 = F_13 ( V_2 , V_248 , & V_13 [ 0 ] ) ;
if ( V_8 )
goto V_62;
if ( V_13 [ 0 ] != 0x83 )
goto exit;
V_8 = F_13 ( V_2 , V_262 , & V_13 [ 0 ] ) ;
if ( V_8 )
goto V_62;
V_27 = V_13 [ 0 ] ;
V_8 = F_11 ( V_2 , V_263 , V_13 , V_27 ) ;
if ( V_8 )
goto V_62;
for ( V_227 = 0 ; V_227 < F_61 ( V_247 ) ; V_227 ++ ) {
V_8 = F_14 ( V_2 , V_247 [ V_227 ] . V_25 ,
V_247 [ V_227 ] . V_26 , V_247 [ V_227 ] . V_34 ) ;
if ( V_8 )
goto V_62;
}
F_68 ( & V_245 ) ;
for ( V_227 = 0 ; V_227 < V_27 ; V_227 ++ ) {
V_245 . V_264 = V_13 [ V_227 ] >> 7 ;
V_245 . V_265 = 50800 * ( V_13 [ V_227 ] & 0x7f ) ;
F_69 ( V_2 -> V_233 , & V_245 ) ;
}
F_70 ( V_2 -> V_233 , true ) ;
F_71 ( V_2 -> V_233 ) ;
exit:
...
struct V_5 * V_6 = F_20 ( V_2 ) ;
if ( V_6 -> V_107 == V_108 )
return F_66 ( V_2 , V_237 ) ;
else
return F_72 ( V_2 , V_237 ) ;
}
static int F_74 ( struct V_116 * V_37 , int V_217 )
{
struct V_5 * V_6 = F_39 ( V_37 ) ;
if ( V_6 -> V_107 == V_108 ) {
struct V_117 * V_118 = & V_6 -> V_117 ;
return V_118 -> V_271 ( V_37 -> V_131 [ 0 ] , V_217 ) ;
} else {
struct V_148 * V_118 = & V_6 -> V_148 ;
return V_118 -> V_271 ( V_37 -> V_131 [ 0 ] , V_217 ) ;
}
...
if ( V_6 -> V_107 == V_108 ) {
struct V_117 * V_118 = & V_6 -> V_117 ;
return V_118 -> V_273 ( V_37 -> V_131 [ 0 ] , V_17 , V_272 , V_217 ) ;
} else {
struct V_148 * V_118 = & V_6 -> V_148 ;
return V_118 -> V_273 ( V_37 -> V_131 [ 0 ] , V_17 , V_272 , V_217 ) ;
}
