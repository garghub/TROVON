...
static int F_74 ( struct V_65 * V_66 ,
struct V_117 * * V_34 , T_4 * V_118 )
{
struct V_1 * V_2 = V_66 -> V_87 ;
struct V_119 * V_77 = V_2 -> V_77 ;
* V_34 = V_77 -> V_34 ;
...
{
struct V_1 * V_2 = V_66 -> V_87 ;
return V_121 ( V_66 , V_2 -> V_77 , 0 , V_66 -> V_120 , V_20 ) ;
}
static int F_76 ( struct V_65 * V_66 , unsigned V_67 , char * * V_68 )
{
int V_122 = - V_73 ;
struct V_1 * V_2 = V_66 -> V_87 ;
if ( V_67 != 2 ) {
...
V_122 = F_53 ( V_2 , V_68 [ 1 ] ) ;
else
F_77 ( L_23 , V_68 [ 0 ] ) ;
return V_122 ;
}
static void F_78 ( struct V_65 * V_66 , struct V_123 * V_124 )
{
struct V_1 * V_2 = V_66 -> V_87 ;
struct V_125 * V_126 = F_79 ( V_2 -> V_77 -> V_34 ) ;
if ( ! V_126 || ! F_80 ( V_126 ) ) {
V_2 -> V_80 = false ;
V_124 -> V_127 = 1 << V_44 ;
