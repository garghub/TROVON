...
static void F_64 ( struct V_20 * V_21 , struct V_121 * V_153 [] ,
int V_154 , unsigned long V_155 )
{
if ( V_153 [ V_154 ] ) {
V_29 V_156 = F_65 ( V_153 [ V_154 ] ) ;
if ( V_156 )
V_21 -> V_9 |= V_155 ;
else
V_21 -> V_9 &= ~ V_155 ;
...
static int F_66 ( struct V_20 * V_21 , struct V_121 * V_153 [] )
{
int V_92 ;
unsigned long V_157 = V_21 -> V_9 ;
F_64 ( V_21 , V_153 , V_45 , V_37 ) ;
F_64 ( V_21 , V_153 , V_46 , V_47 ) ;
F_64 ( V_21 , V_153 , V_50 , V_51 ) ;
F_64 ( V_21 , V_153 , V_48 , V_49 ) ;
F_64 ( V_21 , V_153 , V_52 , V_53 ) ;
F_64 ( V_21 , V_153 , V_54 , V_55 ) ;
F_64 ( V_21 , V_153 , V_56 , V_57 ) ;
F_64 ( V_21 , V_153 , V_58 , V_59 ) ;
if ( V_153 [ V_43 ] ) {
V_92 = F_67 ( V_21 , F_68 ( V_153 [ V_43 ] ) ) ;
if ( V_92 )
return V_92 ;
}
if ( V_153 [ V_41 ] ) {
V_92 = F_69 ( V_21 , F_70 ( V_153 [ V_41 ] ) ) ;
if ( V_92 )
return V_92 ;
}
if ( V_153 [ V_39 ] ) {
V_92 = F_60 ( V_21 , F_65 ( V_153 [ V_39 ] ) ) ;
if ( V_92 )
return V_92 ;
}
if ( V_153 [ V_158 ] )
F_71 ( V_21 -> V_23 , V_21 , 0 , 0 ) ;
#ifdef F_16
if ( V_153 [ V_83 ] ) {
V_29 V_159 = F_65 ( V_153 [ V_83 ] ) ;
V_92 = F_72 ( V_21 , V_159 ) ;
if ( V_92 )
return V_92 ;
}
#endif
F_73 ( V_21 , V_157 ^ V_21 -> V_9 ) ;
return 0 ;
}
int F_74 ( struct V_18 * V_19 , struct V_98 * V_99 , T_2 V_9 )
{
struct V_121 * V_160 ;
struct V_121 * V_161 ;
struct V_20 * V_21 ;
...
int V_92 = 0 ;
V_160 = F_75 ( V_99 , sizeof( struct V_31 ) , V_123 ) ;
V_161 = F_75 ( V_99 , sizeof( struct V_31 ) , V_127 ) ;
if ( ! V_160 && ! V_161 )
return 0 ;
V_21 = F_49 ( V_19 ) ;
if ( ! V_21 && ! V_161 )
...
if ( V_21 && V_160 ) {
if ( V_160 -> F_57 & V_124 ) {
V_92 = F_76 ( V_153 , V_162 ,
V_160 , V_163 ) ;
if ( V_92 )
return V_92 ;
F_77 ( & V_21 -> V_23 -> V_164 ) ;
V_92 = F_66 ( V_21 , V_153 ) ;
F_78 ( & V_21 -> V_23 -> V_164 ) ;
} else {
if ( F_58 ( V_160 ) < sizeof( V_29 ) )
return - V_144 ;
F_77 ( & V_21 -> V_23 -> V_164 ) ;
V_92 = F_60 ( V_21 , F_65 ( V_160 ) ) ;
F_78 ( & V_21 -> V_23 -> V_164 ) ;
}
if ( V_92 )
goto V_165;
...
int F_79 ( struct V_18 * V_19 , struct V_98 * V_99 , T_2 V_9 )
{
struct V_121 * V_161 ;
struct V_20 * V_21 ;
int V_92 = 0 ;
...
static int F_80 ( struct V_121 * V_153 [] , struct V_121 * V_166 [] )
{
if ( V_153 [ V_117 ] ) {
if ( F_58 ( V_153 [ V_117 ] ) != V_167 )
return - V_144 ;
if ( ! F_81 ( F_59 ( V_153 [ V_117 ] ) ) )
return - V_168 ;
}
if ( ! V_166 )
return 0 ;
...
static int F_85 ( struct V_128 * V_173 , struct V_18 * V_19 ,
struct V_121 * V_153 [] , struct V_121 * V_166 [] )
{
struct V_22 * V_23 = F_12 ( V_19 ) ;
if ( V_153 [ V_117 ] ) {
F_77 ( & V_23 -> V_164 ) ;
F_86 ( V_23 , F_59 ( V_153 [ V_117 ] ) ) ;
F_78 ( & V_23 -> V_164 ) ;
}
return F_87 ( V_19 ) ;
}
static int F_88 ( struct V_18 * V_174 ,
struct V_18 * V_19 ,
struct V_121 * V_153 [] ,
struct V_121 * V_166 [] )
{
...
static T_3 F_90 ( const struct V_18 * V_174 ,
const struct V_18 * V_19 )
{
return F_15 () ;
}
static int F_91 ( struct V_18 * V_174 , struct V_121 * V_153 [] ,
struct V_121 * V_166 [] )
{
struct V_22 * V_23 = F_12 ( V_174 ) ;
int V_92 ;
...
return 0 ;
if ( V_166 [ V_176 ] ) {
V_92 = F_92 ( V_23 , F_68 ( V_166 [ V_176 ] ) ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_177 ] ) {
V_92 = F_93 ( V_23 , F_68 ( V_166 [ V_177 ] ) ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_178 ] ) {
V_92 = F_94 ( V_23 , F_68 ( V_166 [ V_178 ] ) ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_179 ] ) {
V_92 = F_95 ( V_23 , F_68 ( V_166 [ V_179 ] ) ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_180 ] ) {
T_1 V_148 = F_68 ( V_166 [ V_180 ] ) ;
F_96 ( V_23 , V_148 ) ;
}
if ( V_166 [ V_181 ] ) {
T_1 V_42 = F_70 ( V_166 [ V_181 ] ) ;
F_97 ( V_23 , V_42 ) ;
}
if ( V_166 [ V_182 ] ) {
V_29 V_183 = F_65 ( V_166 [ V_182 ] ) ;
V_92 = F_98 ( V_23 , V_183 ) ;
if ( V_92 )
return V_92 ;
}
#ifdef F_82
if ( V_166 [ V_169 ] ) {
T_4 V_184 = F_83 ( V_166 [ V_169 ] ) ;
V_92 = F_99 ( V_23 , V_184 ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_185 ] ) {
T_5 V_186 = F_70 ( V_166 [ V_185 ] ) ;
V_92 = F_100 ( V_23 , V_186 ) ;
if ( V_92 )
return V_92 ;
}
#endif
if ( V_166 [ V_187 ] ) {
T_2 V_188 = F_70 ( V_166 [ V_187 ] ) ;
if ( V_188 & V_189 )
return - V_144 ;
V_23 -> V_190 = V_188 ;
}
...
#ifdef F_16
if ( V_166 [ V_196 ] ) {
V_29 V_84 = F_65 ( V_166 [ V_196 ] ) ;
V_92 = F_104 ( V_23 , V_84 ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_197 ] ) {
V_29 V_198 = F_65 ( V_166 [ V_197 ] ) ;
V_92 = F_105 ( V_23 , V_198 ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_199 ] ) {
V_29 V_200 ;
V_200 = F_65 ( V_166 [ V_199 ] ) ;
V_23 -> V_201 = ! ! V_200 ;
}
if ( V_166 [ V_202 ] ) {
V_29 V_203 = F_65 ( V_166 [ V_202 ] ) ;
V_92 = F_106 ( V_23 , V_203 ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_204 ] ) {
T_1 V_200 = F_68 ( V_166 [ V_204 ] ) ;
V_23 -> V_205 = V_200 ;
}
if ( V_166 [ V_206 ] ) {
T_1 V_207 = F_68 ( V_166 [ V_206 ] ) ;
V_92 = F_107 ( V_23 , V_207 ) ;
if ( V_92 )
return V_92 ;
}
if ( V_166 [ V_208 ] ) {
T_1 V_200 = F_68 ( V_166 [ V_208 ] ) ;
V_23 -> V_209 = V_200 ;
}
if ( V_166 [ V_210 ] ) {
T_1 V_200 = F_68 ( V_166 [ V_210 ] ) ;
V_23 -> V_211 = V_200 ;
}
if ( V_166 [ V_212 ] ) {
V_30 V_200 = F_108 ( V_166 [ V_212 ] ) ;
V_23 -> V_213 = F_109 ( V_200 ) ;
}
if ( V_166 [ V_214 ] ) {
V_30 V_200 = F_108 ( V_166 [ V_214 ] ) ;
V_23 -> V_215 = F_109 ( V_200 ) ;
}
if ( V_166 [ V_216 ] ) {
V_30 V_200 = F_108 ( V_166 [ V_216 ] ) ;
V_23 -> V_217 = F_109 ( V_200 ) ;
}
if ( V_166 [ V_218 ] ) {
V_30 V_200 = F_108 ( V_166 [ V_218 ] ) ;
V_23 -> V_219 = F_109 ( V_200 ) ;
}
if ( V_166 [ V_220 ] ) {
V_30 V_200 = F_108 ( V_166 [ V_220 ] ) ;
V_23 -> V_221 = F_109 ( V_200 ) ;
}
if ( V_166 [ V_222 ] ) {
V_30 V_200 = F_108 ( V_166 [ V_222 ] ) ;
V_23 -> V_223 = F_109 ( V_200 ) ;
}
#endif
#if F_110 ( V_224 )
if ( V_166 [ V_225 ] ) {
V_29 V_200 = F_65 ( V_166 [ V_225 ] ) ;
V_23 -> V_226 = V_200 ? true : false ;
}
if ( V_166 [ V_227 ] ) {
V_29 V_200 = F_65 ( V_166 [ V_227 ] ) ;
V_23 -> V_228 = V_200 ? true : false ;
}
if ( V_166 [ V_229 ] ) {
V_29 V_200 = F_65 ( V_166 [ V_229 ] ) ;
V_23 -> V_230 = V_200 ? true : false ;
}
#endif
return 0 ;
}
static T_3 F_111 ( const struct V_18 * V_174 )
{
...
static int F_112 ( struct V_34 * V_35 , const struct V_18 * V_174 )
{
struct V_22 * V_23 = F_12 ( V_174 ) ;
T_1 V_231 = F_113 ( V_23 -> V_231 ) ;
T_1 V_232 = F_113 ( V_23 -> V_232 ) ;
T_1 V_233 = F_113 ( V_23 -> V_234 ) ;
T_1 V_235 = F_113 ( V_23 -> V_235 ) ;
T_1 V_148 = V_23 -> V_148 ;
T_2 V_42 = ( V_23 -> V_236 . V_237 [ 0 ] << 8 ) | V_23 -> V_236 . V_237 [ 1 ] ;
V_29 V_238 = F_114 ( V_23 ) ;
V_30 V_239 ;
...
return - V_76 ;
#ifdef F_82
if ( F_115 ( V_35 , V_169 , V_23 -> V_184 ) ||
...
V_23 -> V_211 ) )
return - V_76 ;
V_239 = F_113 ( V_23 -> V_213 ) ;
if ( F_25 ( V_35 , V_212 , V_239 ) )
return - V_76 ;
V_239 = F_113 ( V_23 -> V_215 ) ;
if ( F_25 ( V_35 , V_214 , V_239 ) )
return - V_76 ;
V_239 = F_113 ( V_23 -> V_217 ) ;
if ( F_25 ( V_35 , V_216 , V_239 ) )
return - V_76 ;
V_239 = F_113 ( V_23 -> V_219 ) ;
if ( F_25 ( V_35 , V_218 , V_239 ) )
return - V_76 ;
V_239 = F_113 ( V_23 -> V_221 ) ;
if ( F_25 ( V_35 , V_220 , V_239 ) )
return - V_76 ;
V_239 = F_113 ( V_23 -> V_223 ) ;
