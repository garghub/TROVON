...
static int F_141 ( struct V_67 * V_134 )
{
return 0 ;
}
static void F_142 ( struct V_67 * V_134 )
{
}
static T_5 F_143 ( struct V_67 * V_134 )
{
return 0 ;
}
...
static void F_147 ( struct V_242 * V_243 )
{
}
...
static void F_152 ( struct V_64 * V_64 )
{
}
static T_12 F_153 ( struct V_250 * V_251 ,
char * V_5 )
{
struct V_223 * V_181 = F_154 ( V_251 ) ;
...
static T_12 F_155 ( struct V_250 * V_251 ,
...
static int F_156 ( struct V_223 * V_181 ,
...
static T_12 F_161 ( struct V_250 * V_251 , char * V_5 )
{
struct V_223 * V_181 = F_162 ( V_251 ) ;
struct V_23 * V_24 = F_34 ( V_181 ,
struct V_23 , V_181 ) ;
struct V_112 * V_255 ;
T_12 V_186 ;
...
static T_12 F_163 ( struct V_250 * V_251 ,
const char * V_5 , T_13 V_253 )
{
struct V_223 * V_181 = F_162 ( V_251 ) ;
struct V_23 * V_24 = F_34 ( V_181 ,
...
V_186 = F_157 ( V_24 , V_263 ) ;
if ( V_186 < 0 )
return V_186 ;
return V_253 ;
}
static T_12
F_164 ( struct V_250 * V_251 , char * V_5 )
{
return sprintf ( V_5 , L_60
V_265 L_61 ,
V_266 , F_165 () -> V_267 , F_165 () -> V_268 ) ;
}
static char * F_166 ( void )
{
return L_62 ;
}
static int F_167 ( struct V_223 * V_181 ,
struct V_177 * V_28 )
{
struct V_23 * V_24 = F_34 ( V_181 ,
struct V_23 , V_181 ) ;
...
static void F_168 ( struct V_223 * V_181 ,
struct V_177 * V_28 )
{
struct V_23 * V_24 = F_34 ( V_181 ,
struct V_23 , V_181 ) ;
...
V_24 -> V_26 = V_26 ;
V_24 -> V_224 = V_269 ;
V_186 = F_172 ( V_237 , & V_24 -> V_181 , V_26 -> V_219 ) ;
if ( V_186 < 0 ) {
F_28 ( V_24 ) ;
return NULL ;
}
...
static void F_173 ( struct V_223 * V_181 )
{
struct V_23 * V_24 = F_34 ( V_181 ,
struct V_23 , V_181 ) ;
F_35 ( & V_179 ) ;
...
static int F_175 ( struct V_223 * V_181 )
{
return 1 ;
}
static int F_176 ( struct V_223 * V_181 )
{
return 0 ;
}
static int T_14 F_177 ( void )
{
int V_186 ;
if ( ! F_178 () )
return - V_148 ;
