...
static int F_23 ( void * V_16 , int * V_49 )
{
...
F_38 ( V_12 , V_33 ) ;
V_8 = F_39 ( & V_33 -> V_16 -> V_73 , & V_74 ) ;
if ( V_8 ) {
F_33 ( V_33 -> V_16 , L_14 ) ;
return V_8 ;
}
V_33 -> V_75 = F_40 ( V_33 -> V_16 ) ;
if ( F_9 ( V_33 -> V_75 ) ) {
F_33 ( V_33 -> V_16 , L_15 ) ;
V_8 = F_31 ( V_33 -> V_75 ) ;
goto V_76;
...
F_41 ( & V_12 -> V_16 , L_16 ,
V_61 -> V_56 ) ;
V_33 -> V_77 = F_42 ( V_33 -> V_16 , 0 , V_33 -> V_16 ,
& V_78 ) ;
if ( F_9 ( V_33 -> V_77 ) ) {
F_43 ( & V_12 -> V_16 , L_17 ) ;
V_33 -> V_77 = NULL ;
