...
case V_30 :
if ( V_17 >= sizeof( int ) ) {
if ( F_76 ( V_64 , ( int T_7 * ) V_156 ) )
return - V_174 ;
} else if ( V_17 >= sizeof( char ) ) {
unsigned char V_175 ;
if ( F_76 ( V_175 , ( unsigned char T_7 * ) V_156 ) )
return - V_174 ;
V_64 = ( int ) V_175 ;
}
}
if ( F_77 ( V_140 ) )
return F_78 ( V_49 , V_140 , V_156 , V_17 ) ;
V_34 = 0 ;
if ( V_157 )
F_79 () ;
F_80 ( V_49 ) ;
...
V_123 = F_94 ( F_75 ( V_49 ) , V_214 . V_217 . V_8 ) ;
if ( V_123 )
V_214 . V_218 = V_123 -> V_125 ;
} else
V_123 = F_90 ( F_75 ( V_49 ) , V_214 . V_218 ) ;
V_34 = - V_210 ;
if ( ! V_123 )
break;
F_91 ( V_123 ) ;
...
struct V_229 V_230 ;
int V_231 , V_232 ;
if ( V_17 != sizeof( struct V_229 ) )
goto V_179;
if ( F_92 ( & V_230 , V_156 , sizeof( V_230 ) ) ) {
V_34 = - V_174 ;
break;
}
if ( V_140 == V_143 ) {
...
struct V_213 V_214 ;
V_214 . V_234 . V_8 = V_230 . V_234 ;
V_214 . V_217 . V_8 = V_230 . V_235 ;
V_214 . V_218 = 0 ;
V_34 = F_95 ( V_49 , & V_214 ) ;
if ( V_34 && V_34 != - V_101 )
break;
...
V_34 = F_99 ( V_232 , V_231 , V_49 , & V_230 , 0 ) ;
break;
}
case V_150 :
case V_152 :
...
goto V_179;
V_34 = - V_174 ;
if ( F_92 ( & V_238 , V_156 , sizeof( V_238 ) ) )
break;
V_239 = (struct V_36 * ) & V_238 . V_240 ;
if ( V_239 -> V_41 != V_42 )
goto V_179;
memset ( & V_214 , 0 , sizeof( V_214 ) ) ;
V_214 . V_234 = V_239 -> V_43 ;
V_214 . V_218 = V_238 . V_241 ;
if ( V_140 == V_150 )
V_34 = F_95 ( V_49 , & V_214 ) ;
else
V_34 = F_96 ( V_49 , & V_214 ) ;
...
struct V_36 * V_239 ;
int V_231 , V_232 ;
if ( V_17 != sizeof( struct V_242 ) )
goto V_179;
if ( F_92 ( & V_243 , V_156 , sizeof( V_243 ) ) ) {
V_34 = - V_174 ;
break;
}
if ( V_243 . V_244 . V_245 != V_42 ||
V_243 . V_246 . V_245 != V_42 ) {
V_34 = - V_210 ;
break;
}
V_239 = (struct V_36 * ) & V_243 . V_244 ;
V_230 . V_234 = V_239 -> V_43 . V_8 ;
V_239 = (struct V_36 * ) & V_243 . V_246 ;
V_230 . V_247 = V_239 -> V_43 . V_8 ;
V_230 . V_235 = 0 ;
if ( V_140 == V_148 ) {
V_231 = V_233 ;
V_232 = 1 ;
...
V_214 . V_234 = V_239 -> V_43 ;
V_214 . V_217 . V_8 = 0 ;
V_214 . V_218 = V_243 . V_248 ;
V_34 = F_95 ( V_49 , & V_214 ) ;
if ( V_34 && V_34 != - V_101 )
break;
V_243 . V_248 = V_214 . V_218 ;
V_231 = V_236 ;
V_232 = 1 ;
} else {
V_231 = V_236 ;
...
V_34 = F_99 ( V_232 , V_231 , V_49 , & V_230 ,
V_243 . V_248 ) ;
break;
}
case V_149 :
...
V_250 = F_40 ( V_17 , V_98 ) ;
if ( ! V_250 ) {
V_34 = - V_102 ;
break;
}
V_34 = - V_174 ;
if ( F_92 ( V_250 , V_156 , V_17 ) )
goto V_253;
if ( V_250 -> V_254 >= 0x1ffffff ||
V_250 -> V_254 > V_60 -> V_227 . V_228 ) {
V_34 = - V_102 ;
goto V_253;
}
if ( F_100 ( V_250 -> V_254 ) > V_17 ) {
V_34 = - V_67 ;
goto V_253;
}
V_251 = F_97 ( V_250 -> V_254 ) ;
V_224 = F_40 ( V_251 , V_98 ) ;
if ( ! V_224 ) {
V_34 = - V_102 ;
goto V_253;
}
V_125 = V_250 -> V_255 ;
V_239 = (struct V_36 * ) & V_250 -> V_256 ;
if ( V_239 -> V_41 != V_42 ) {
V_34 = - V_210 ;
goto V_253;
}
V_224 -> V_257 = V_239 -> V_43 . V_8 ;
V_224 -> V_258 = 0 ;
V_224 -> V_259 = V_250 -> V_260 ;
V_224 -> V_226 = V_250 -> V_254 ;
V_34 = - V_210 ;
for ( V_252 = 0 ; V_252 < V_250 -> V_254 ; ++ V_252 ) {
V_239 = (struct V_36 * ) & V_250 -> V_261 [ V_252 ] ;
if ( V_239 -> V_41 != V_42 )
goto V_253;
V_224 -> V_262 [ V_252 ] = V_239 -> V_43 . V_8 ;
}
F_37 ( V_250 ) ;
V_250 = NULL ;
...
case V_266 :
V_34 = - V_267 ;
if ( ! F_101 ( F_75 ( V_49 ) -> V_268 , V_269 ) )
break;
V_34 = F_102 ( V_49 , V_140 , V_156 , V_17 ) ;
break;
case V_165 :
if ( ! ! V_64 && ! F_101 ( F_75 ( V_49 ) -> V_268 , V_270 ) &&
! F_101 ( F_75 ( V_49 ) -> V_268 , V_269 ) ) {
V_34 = - V_267 ;
break;
}
if ( V_17 < 1 )
...
{
struct V_5 * V_273 = F_2 ( V_4 ) ;
bool V_274 = ( F_23 ( V_49 ) -> V_51 & V_52 ) ||
F_106 ( V_49 ) ;
if ( V_274 && F_107 ( V_4 ) ) {
V_273 -> V_81 = F_108 ( V_4 ) ;
V_273 -> V_82 . V_8 = F_109 ( V_4 ) ;
} else {
V_273 -> V_81 = 0 ;
V_273 -> V_82 . V_8 = 0 ;
}
...
break;
case V_169 :
V_64 = ( V_208 int ) F_93 ( ( V_281 ) V_48 -> V_209 ) ;
break;
case V_212 :
{
struct V_215 V_79 ;
...
if ( F_92 ( & V_250 , V_156 , F_100 ( 0 ) ) ) {
V_34 = - V_174 ;
goto V_135;
}
V_34 = F_127 ( V_49 , & V_250 ,
(struct V_249 T_7 * ) V_156 ,
V_17 ) ;
goto V_135;
}
case V_171 :
...
if ( V_49 -> V_94 != V_193 )
return - V_197 ;
V_2 . V_283 = ( V_208 void * ) V_156 ;
V_2 . V_284 = V_40 ;
V_2 . V_21 = V_50 ;
if ( V_48 -> V_51 & V_52 ) {
struct V_5 V_6 ;
V_6 . V_7 . V_8 = V_48 -> V_285 ;
V_6 . V_82 . V_8 = V_48 -> V_285 ;
V_6 . V_81 = V_48 -> V_220 ;
F_4 ( & V_2 , V_10 , V_11 , sizeof( V_6 ) , & V_6 ) ;
}
if ( V_48 -> V_51 & V_53 ) {
int V_286 = V_48 -> V_205 ;
F_4 ( & V_2 , V_10 , V_13 , sizeof( V_286 ) , & V_286 ) ;
}
if ( V_48 -> V_51 & V_54 ) {
int V_15 = V_48 -> V_287 ;
