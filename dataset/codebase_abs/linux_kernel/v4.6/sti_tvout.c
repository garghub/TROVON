...
struct V_89 * V_46 = V_45 -> V_90 -> V_46 ;
struct V_91 * V_92 ;
int V_93 ;
V_93 = F_22 ( & V_46 -> V_94 ) ;
if ( V_93 )
...
static void F_26 ( struct V_1 * V_2 , struct V_112 * V_90 )
{
F_27 ( V_113 ,
F_28 ( V_113 ) ,
V_90 ) ;
}
static int F_29 ( struct V_1 * V_2 , struct V_112 * V_90 )
{
unsigned int V_36 ;
for ( V_36 = 0 ; V_36 < F_28 ( V_113 ) ; V_36 ++ )
V_113 [ V_36 ] . V_85 = V_2 ;
return F_30 ( V_113 ,
F_28 ( V_113 ) ,
V_90 -> V_114 , V_90 ) ;
}
static void F_31 ( struct V_115 * V_116 , int V_35 )
{
}
...
{
struct V_118 * V_119 = F_34 ( V_116 ) ;
F_35 ( V_116 ) ;
F_36 ( V_119 ) ;
}
static void F_37 ( struct V_115 * V_116 )
{
struct V_1 * V_2 = F_38 ( V_116 ) ;
F_10 ( V_2 , & V_116 -> V_92 -> V_35 ) ;
F_11 ( V_2 , F_23 ( V_116 -> V_92 ) ) ;
}
...
static struct V_115 *
F_40 ( struct V_89 * V_46 ,
struct V_1 * V_2 )
{
struct V_118 * V_116 ;
struct V_115 * V_115 ;
V_116 = F_41 ( V_2 -> V_46 , sizeof( * V_116 ) , V_120 ) ;
if ( ! V_116 )
return NULL ;
V_116 -> V_2 = V_2 ;
V_115 = (struct V_115 * ) V_116 ;
V_115 -> V_121 = V_122 ;
V_115 -> V_123 = 1 << 0 ;
F_42 ( V_46 , V_115 ,
& V_124 , V_125 ,
...
struct V_1 * V_2 = F_38 ( V_116 ) ;
F_10 ( V_2 , & V_116 -> V_92 -> V_35 ) ;
F_16 ( V_2 , F_23 ( V_116 -> V_92 ) ) ;
}
static void F_45 ( struct V_115 * V_116 )
{
struct V_1 * V_2 = F_38 ( V_116 ) ;
F_3 ( V_2 , 0x0 , V_72 ) ;
F_3 ( V_2 , 1 , V_74 ) ;
}
static struct V_115 * F_46 ( struct V_89 * V_46 ,
struct V_1 * V_2 )
{
struct V_118 * V_116 ;
struct V_115 * V_115 ;
...
static void F_47 ( struct V_115 * V_116 )
{
struct V_1 * V_2 = F_38 ( V_116 ) ;
F_10 ( V_2 , & V_116 -> V_92 -> V_35 ) ;
F_15 ( V_2 , F_23 ( V_116 -> V_92 ) ) ;
}
...
static struct V_115 * F_49 ( struct V_89 * V_46 ,
struct V_1 * V_2 )
{
struct V_118 * V_116 ;
struct V_115 * V_115 ;
...
static void F_50 ( struct V_89 * V_46 ,
struct V_1 * V_2 )
{
V_2 -> V_95 = F_49 ( V_46 , V_2 ) ;
V_2 -> V_98 = F_46 ( V_46 , V_2 ) ;
V_2 -> V_96 = F_40 ( V_46 , V_2 ) ;
}
...
static int F_52 ( struct V_131 * V_46 , struct V_131 * V_132 , void * V_85 )
{
struct V_1 * V_2 = F_53 ( V_46 ) ;
struct V_89 * V_133 = V_85 ;
V_2 -> V_133 = V_133 ;
F_50 ( V_133 , V_2 ) ;
if ( F_29 ( V_2 , V_133 -> V_134 ) )
F_54 ( L_50 ) ;
return 0 ;
}
static void F_55 ( struct V_131 * V_46 , struct V_131 * V_132 ,
void * V_85 )
{
struct V_1 * V_2 = F_53 ( V_46 ) ;
struct V_89 * V_133 = V_85 ;
F_51 ( V_2 ) ;
F_26 ( V_2 , V_133 -> V_134 ) ;
}
static int F_56 ( struct V_135 * V_136 )
{
struct V_131 * V_46 = & V_136 -> V_46 ;
...
if ( ! V_45 )
return - V_139 ;
V_2 = F_41 ( V_46 , sizeof( * V_2 ) , V_120 ) ;
if ( ! V_2 )
return - V_140 ;
V_2 -> V_46 = V_46 ;
V_138 = F_58 ( V_136 , V_141 , L_51 ) ;
if ( ! V_138 ) {
F_54 ( L_52 ) ;
return - V_140 ;
}
