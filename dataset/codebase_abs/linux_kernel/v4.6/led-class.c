...
static void F_44 ( struct V_1 * V_2 , void * V_38 )
{
F_37 ( * (struct V_6 * * ) V_38 ) ;
}
...
struct V_6 * * V_39 ;
int V_40 ;
V_39 = F_46 ( F_44 , sizeof( * V_39 ) , V_41 ) ;
if ( ! V_39 )
return - V_27 ;
V_40 = F_23 ( V_28 , V_7 ) ;
if ( V_40 ) {
...
static int F_49 ( struct V_1 * V_2 , void * V_38 , void * V_21 )
{
struct V_7 * * V_42 = V_38 ;
if ( F_50 ( ! V_42 || ! * V_42 ) )
return 0 ;
return * V_42 == V_21 ;
}
