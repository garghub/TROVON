...
struct V_78 * V_132 ;
struct V_133 * V_134 ;
V_134 = F_41 ( V_26 , V_131 , V_73 -> V_135 [ 0 ] ) ;
if ( V_134 == NULL )
return F_21 ( - V_136 ) ;
V_132 = F_42 ( V_134 , struct V_78 , V_88 ) ;
return F_19 ( V_26 , V_73 , V_132 ) ;
}
static void F_43 ( struct V_137 * V_138 , T_3 V_2 , T_3 V_3 ,
T_3 V_4 , int V_1 )
{
struct V_139 * V_139 = F_44 ( V_138 ) ;
V_139 -> V_140 [ V_1 ] = V_2 >> 8 ;
V_139 -> V_141 [ V_1 ] = V_3 >> 8 ;
V_139 -> V_142 [ V_1 ] = V_4 >> 8 ;
}
static void F_45 ( struct V_137 * V_138 , T_3 * V_2 ,
...
if ( V_145 == 3 )
V_145 = 4 ;
if ( F_27 ( V_90 -> V_124 * V_145 , 64 ) * V_90 -> V_125 >
V_40 -> V_146 ) {
V_90 -> V_98 = 16 ;
V_90 -> V_99 = 16 ;
}
...
struct V_78 * V_132 = V_23 -> V_28 ;
return F_63 ( V_151 , & V_132 -> V_88 , V_152 ) ;
}
...
F_66 ( V_26 ) ;
if ( ! V_40 -> V_155 )
V_40 -> V_155 = F_67 ( V_26 , 0 ,
L_6 , 0 , 100 ) ;
V_40 -> V_106 -> V_156 ( V_26 ) ;
F_68 (connector, &dev->mode_config.connector_list,
head) {
struct V_157 * V_157 = F_69 ( V_154 ) ;
struct V_158 * V_159 = & V_157 -> V_27 ;
int V_160 = 0 , V_161 = 0 ;
switch ( V_157 -> type ) {
case V_162 :
V_160 = ( 1 << 0 ) ;
...
break;
case V_163 :
V_160 = V_40 -> V_106 -> V_164 ;
V_161 = ( 1 << V_163 ) ;
break;
case V_165 :
V_160 = V_40 -> V_106 -> V_166 ;
V_161 = ( 1 << V_165 ) ;
break;
case V_167 :
V_160 = ( 1 << 0 ) ;
...
{
struct V_39 * V_40 = V_26 -> V_41 ;
struct V_175 * V_176 = & V_40 -> V_176 ;
int V_43 ;
F_72 ( V_26 ) ;
V_26 -> V_114 . V_177 = 0 ;
V_26 -> V_114 . V_178 = 0 ;
V_26 -> V_114 . V_179 = & V_180 ;
F_73 ( V_26 -> V_127 , V_181 , ( T_2 * )
& ( V_26 -> V_114 . V_115 ) ) ;
for ( V_43 = 0 ; V_43 < V_40 -> V_182 ; V_43 ++ )
F_74 ( V_26 , V_43 , V_176 ) ;
V_26 -> V_114 . V_183 = 4096 ;
V_26 -> V_114 . V_184 = 4096 ;
F_65 ( V_26 ) ;
if ( V_40 -> V_106 -> V_185 )
V_40 -> V_106 -> V_185 ( V_26 ) ;
V_40 -> V_186 = true ;
}
