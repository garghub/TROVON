...
static T_3 F_141 ( struct V_18 * V_19 )
{
return 0 ;
}
...
static int F_147 ( struct V_127 * V_127 )
{
struct V_44 * V_3 = F_70 ( V_127 ,
struct V_44 , V_127 ) ;
int V_4 ;
...
static int F_148 ( struct V_127 * V_127 )
{
struct V_44 * V_3 = F_70 ( V_127 ,
struct V_44 , V_127 ) ;
return F_122 ( V_3 ) ;
}
static void F_149 ( struct V_127 * V_127 )
{
}
static void F_150 ( struct V_127 * V_127 )
{
return;
}
static int F_151 ( struct V_127 * V_127 )
{
struct V_44 * V_3 = F_70 ( V_127 ,
struct V_44 , V_127 ) ;
return F_152 ( & V_3 -> V_127 , 0 ) ;
}
static int F_153 ( struct V_35 * V_17 )
{
struct V_36 * V_207 ;
int V_32 = 0 ;
F_12 () ;
...
static int F_154 ( struct V_52 * V_53 )
{
struct V_36 * V_207 ;
int V_208 , V_209 , V_153 = 0 , V_210 , V_4 ;
T_3 * V_94 ;
if ( V_53 -> V_211 . V_94 ) {
F_155 ( & V_53 -> V_211 ) ;
F_25 ( V_53 -> V_211 . V_94 ) ;
V_53 -> V_211 . V_94 = NULL ;
}
if ( ! V_53 -> V_200 || ! V_53 -> V_17 )
return 0 ;
V_208 = F_153 ( & V_53 -> V_17 -> V_22 ) ;
V_209 = F_156 ( V_212 ) + 4 + V_208 ;
if ( V_53 -> V_213 != - 1 )
V_209 ++ ;
V_94 = F_157 ( ( V_209 + 4 ) , sizeof( T_3 ) , V_39 ) ;
if ( ! V_94 )
return - V_40 ;
V_94 [ V_153 ++ ] = V_209 << 16 ;
if ( V_53 -> V_213 != - 1 )
V_94 [ V_153 ++ ] = ( V_214 << 24 ) | V_53 -> V_213 ;
memcpy ( & V_94 [ V_153 ] , V_212 ,
sizeof( V_212 ) ) ;
V_153 += F_156 ( V_212 ) ;
V_210 = ( V_53 -> V_215 -> V_76 . V_77 - V_12 ) / 4 ;
V_94 [ V_153 ++ ] = 0x54000000 | ( V_210 & 0x00ffffff ) ;
V_94 [ V_153 ++ ] = 0x3a000000 |
( ( ( V_53 -> V_216 * 2 ) << 8 ) & 0xff00 ) |
V_217 ;
V_94 [ V_153 ++ ] = 0x3d000000 | ( V_53 -> V_72 & 0xffff ) ;
V_94 [ V_153 ++ ] = 0x8d000000 | ( V_208 + 1 ) ;
F_12 () ;
F_13 (lun, &tport->tpg->se_tpg.tpg_lun_hlist, link) {
struct V_218 * V_219 ;
int type ;
V_219 = F_158 ( V_207 -> V_220 ) ;
type = V_219 -> V_221 -> V_222 ( V_219 ) ;
...
V_94 [ V_153 ++ ] = V_53 -> V_1 ;
V_53 -> V_211 . V_75 = V_153 ;
V_53 -> V_211 . V_223 = ( V_224 | V_225 ) << 24 ;
V_53 -> V_211 . V_94 = V_94 ;
V_4 = F_159 ( & V_53 -> V_211 ) ;
if ( V_4 < 0 ) {
F_25 ( V_53 -> V_211 . V_94 ) ;
V_53 -> V_211 . V_94 = NULL ;
}
...
static T_7 F_160 ( const char * V_226 , T_1 * V_227 )
{
const char * V_228 ;
char V_229 , V_230 ;
int V_231 = 0 , V_34 ;
* V_227 = 0 ;
for ( V_228 = V_226 ; V_228 < & V_226 [ V_232 - 1 ] ; V_228 ++ ) {
V_229 = * V_228 ;
if ( V_229 == '\n' && V_228 [ 1 ] == '\0' )
continue;
if ( V_229 == '\0' ) {
...
if ( isdigit ( V_229 ) )
V_230 = V_229 - '0' ;
else if ( isxdigit ( V_229 ) )
V_230 = tolower ( V_229 ) - 'a' + 10 ;
else
goto V_233;
* V_227 = ( * V_227 << 4 ) | V_230 ;
V_231 ++ ;
...
V_233:
F_161 ( V_234 L_57 ,
V_34 , V_228 - V_226 , V_231 ) ;
return - 1 ;
}
static T_7 F_162 ( char * V_235 , T_4 V_236 , T_1 V_227 )
{
return snprintf ( V_235 , V_236 , L_1 , V_227 ) ;
}
static int F_163 ( struct V_205 * V_237 , const char * V_226 )
{
T_1 V_1 = 0 ;
if ( F_160 ( V_226 , & V_1 ) < 0 )
return - V_238 ;
return 0 ;
}
static int F_164 (
...
struct V_52 * V_53 = V_17 -> V_53 ;
int V_4 ;
if ( F_153 ( & V_17 -> V_22 ) == 0 )
V_53 -> V_200 = 0 ;
V_4 = F_154 ( V_53 ) ;
if ( V_4 < 0 )
F_17 ( L_58 ) ;
}
static struct V_35 * F_166 (
struct V_239 * V_227 ,
struct V_240 * V_241 ,
const char * V_226 )
{
struct V_52 * V_53 =
F_70 ( V_227 , struct V_52 , V_242 ) ;
struct V_16 * V_17 ;
unsigned long V_243 ;
int V_4 ;
if ( strstr ( V_226 , L_59 ) != V_226 )
return F_18 ( - V_238 ) ;
if ( F_167 ( V_226 + 5 , 10 , & V_243 ) || V_243 > V_244 )
return F_18 ( - V_238 ) ;
if ( V_53 -> V_17 ) {
F_17 ( L_60 ) ;
return F_18 ( - V_245 ) ;
...
V_53 -> V_72 = 5 ;
V_53 -> V_66 = 1 ;
V_53 -> V_215 = F_130 ( V_53 ) ;
if ( F_23 ( V_53 -> V_215 ) ) {
V_4 = F_24 ( V_53 -> V_215 ) ;
goto V_246;
}
V_4 = F_168 ( V_227 , & V_17 -> V_22 , V_247 ) ;
if ( V_4 < 0 )
goto V_248;
return & V_17 -> V_22 ;
V_248:
...
static void F_169 ( struct V_35 * V_22 )
{
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
F_170 ( V_22 ) ;
...
V_53 -> V_1 = V_1 ;
F_162 ( V_53 -> V_203 , V_232 , V_1 ) ;
return & V_53 -> V_242 ;
}
static void F_172 ( struct V_239 * V_227 )
{
struct V_52 * V_53 =
F_70 ( V_227 , struct V_52 , V_242 ) ;
F_25 ( V_53 ) ;
}
static T_7 F_173 ( struct V_251 * V_252 , char * V_253 )
{
return sprintf ( V_253 , L_63 , V_254 ) ;
}
static T_7 F_174 ( struct V_251 * V_252 , char * V_253 )
{
struct V_35 * V_22 = F_175 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
if ( V_53 -> V_213 == - 1 )
return sprintf ( V_253 , L_64 ) ;
else
return sprintf ( V_253 , L_65 , V_53 -> V_213 ) ;
}
static T_7 F_176 ( struct V_251 * V_252 ,
const char * V_253 , T_4 V_32 )
{
struct V_35 * V_22 = F_175 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
...
if ( strstr ( V_253 , L_67 ) == V_253 ) {
V_53 -> V_213 = - 1 ;
} else {
if ( F_167 ( V_253 , 16 , & V_255 ) < 0 )
return - V_238 ;
if ( V_255 > 0xffffff )
return - V_238 ;
V_53 -> V_213 = V_255 ;
...
static T_7 F_177 ( struct V_251 * V_252 , char * V_253 )
{
struct V_35 * V_22 = F_175 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
return sprintf ( V_253 , L_68 , V_53 -> V_200 ) ;
}
static T_7 F_178 ( struct V_251 * V_252 ,
const char * V_253 , T_4 V_32 )
{
struct V_35 * V_22 = F_175 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
...
static T_7 F_179 ( struct V_251 * V_252 ,
char * V_253 )
{
struct V_35 * V_22 = F_180 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
return sprintf ( V_253 , L_68 , V_53 -> V_216 ) ;
}
static T_7 F_181 ( struct V_251 * V_252 ,
const char * V_253 , T_4 V_32 )
{
struct V_35 * V_22 = F_180 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
...
static T_7 F_182 ( struct V_251 * V_252 ,
char * V_253 )
{
struct V_35 * V_22 = F_180 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
return sprintf ( V_253 , L_68 , V_53 -> V_72 ) ;
}
static T_7 F_183 ( struct V_251 * V_252 ,
const char * V_253 , T_4 V_32 )
{
struct V_35 * V_22 = F_180 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
...
static T_7 F_184 ( struct V_251 * V_252 ,
char * V_253 )
{
struct V_35 * V_22 = F_180 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
return sprintf ( V_253 , L_68 , V_53 -> V_66 ) ;
}
static T_7 F_185 ( struct V_251 * V_252 ,
const char * V_253 , T_4 V_32 )
{
struct V_35 * V_22 = F_180 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
