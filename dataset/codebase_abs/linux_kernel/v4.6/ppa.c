...
static inline T_1 * F_68 ( void )
{
T_1 * V_4 , * V_101 = NULL ;
unsigned int V_102 = 0 ;
if ( F_69 ( & V_103 ) )
return NULL ;
F_70 (dev, &ppa_hosts, list) {
if ( V_4 -> V_104 != V_102 )
return V_101 ;
V_102 ++ ;
V_101 = V_4 ;
...
V_108 = F_68 () ;
if ( V_108 )
V_4 -> V_104 = V_108 -> V_104 + 1 ;
memset ( & V_114 , 0 , sizeof( V_114 ) ) ;
V_114 . V_118 = V_4 ;
V_114 . V_119 = F_4 ;
V_4 -> V_4 = F_76 ( V_106 , L_28 , & V_114 , V_4 -> V_104 ) ;
if ( ! V_4 -> V_4 )
goto V_120;
V_111 = - V_121 ;
V_4 -> V_10 = & V_10 ;
F_77 ( & V_10 , & V_107 , V_122 ) ;
if ( F_8 ( V_4 ) )
F_78 ( 3 * V_90 ) ;
if ( V_4 -> V_14 ) {
F_14 ( V_46 L_29
...
F_81 ( & V_4 -> V_77 , F_53 ) ;
V_111 = - V_112 ;
V_2 = F_82 ( & V_128 , sizeof( T_1 * ) ) ;
if ( ! V_2 )
goto V_124;
V_2 -> V_129 = V_106 -> V_5 ;
V_2 -> V_130 = V_109 ;
V_2 -> V_131 = - 1 ;
V_2 -> V_132 = V_106 -> V_123 ;
* ( T_1 * * ) & V_2 -> V_3 = V_4 ;
V_4 -> V_2 = V_2 ;
F_83 ( & V_4 -> V_133 , & V_103 ) ;
V_111 = F_84 ( V_2 , NULL ) ;
if ( V_111 )
goto V_134;
F_85 ( V_2 ) ;
...
static void F_90 ( struct V_105 * V_106 )
{
F_71 ( V_106 ) ;
}
