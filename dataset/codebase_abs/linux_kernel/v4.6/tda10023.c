...
static int F_17 ( struct V_40 * V_41 , T_2 * V_87 )
{
struct V_1 * V_2 = V_41 -> V_42 ;
T_1 V_88 , V_89 , V_52 ;
V_88 = F_1 ( V_2 , 0x14 ) ;
...
* V_87 = V_88 | ( V_89 << 8 ) | ( V_52 << 16 ) ;
return 0 ;
}
static int F_18 ( struct V_40 * V_41 , T_5 * V_90 )
{
struct V_1 * V_2 = V_41 -> V_42 ;
T_1 V_91 = F_1 ( V_2 , 0x2f ) ;
T_5 V_92 = ( ( 255 - F_1 ( V_2 , 0x17 ) ) ) + ( 255 - V_91 ) / 16 ;
if ( V_92 > 0x90 )
V_92 = V_92 + 2 * ( V_92 - 0x90 ) ;
if ( V_92 > 255 )
V_92 = 255 ;
* V_90 = ( V_92 << 8 ) | V_92 ;
return 0 ;
}
static int F_19 ( struct V_40 * V_41 , T_5 * V_93 )
{
struct V_1 * V_2 = V_41 -> V_42 ;
T_1 V_94 = ~ F_1 ( V_2 , 0x18 ) ;
* V_93 = ( V_94 << 8 ) | V_94 ;
return 0 ;
}
static int F_20 ( struct V_40 * V_41 , T_2 * V_95 )
{
struct V_1 * V_2 = V_41 -> V_42 ;
T_1 V_88 , V_89 , V_52 , V_96 ;
V_88 = F_1 ( V_2 , 0x74 ) ;
V_89 = F_1 ( V_2 , 0x75 ) ;
V_52 = F_1 ( V_2 , 0x76 ) ;
V_96 = F_1 ( V_2 , 0x77 ) ;
* V_95 = V_88 | ( V_89 << 8 ) | ( V_52 << 16 ) | ( V_96 << 24 ) ;
...
F_3 ( V_81 & 2 ? L_9 :
L_10 ,
V_2 -> V_18 . V_19 -> V_17 , V_99 ,
- ( ( T_3 ) V_97 -> V_73 * V_99 ) >> 10 ) ;
}
V_97 -> V_101 = ( V_98 & 0x20 ? 0 : 1 ) ;
V_97 -> V_57 = ( ( V_2 -> V_31 >> 2 ) & 7 ) + V_61 ;
V_97 -> V_102 = V_103 ;
V_97 -> V_104 = ( ( V_97 -> V_104 + 31250 ) / 62500 ) * 62500 ;
if ( V_81 & 2 )
V_97 -> V_104 -= ( ( T_3 ) V_97 -> V_73 * V_99 ) >> 10 ;
return 0 ;
}
...
static int F_23 ( struct V_40 * V_41 , int V_105 )
{
struct V_1 * V_2 = V_41 -> V_42 ;
if ( V_105 ) {
F_8 ( V_2 ) ;
...
struct V_40 * F_26 ( const struct V_106 * V_9 ,
struct V_107 * V_16 ,
T_1 V_108 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_27 ( sizeof( struct V_1 ) , V_109 ) ;
if ( V_2 == NULL ) goto error;
V_2 -> V_9 = V_9 ;
V_2 -> V_16 = V_16 ;
F_4 ( V_2 , 0x00 , 0x33 ) ;
if ( ( F_1 ( V_2 , 0x1a ) & 0xf0 ) != 0x70 ) goto error;
memcpy ( & V_2 -> V_18 . V_69 , & V_110 , sizeof( struct V_111 ) ) ;
V_2 -> V_108 = V_108 ;
V_2 -> V_31 = V_47 ;
if ( V_2 -> V_9 -> V_112 ) {
V_2 -> V_112 = V_2 -> V_9 -> V_112 ;
...
V_2 -> V_38 = ( V_2 -> V_112 * V_2 -> V_44 / \
( V_2 -> V_46 * V_2 -> V_45 ) ) ;
V_2 -> V_18 . V_69 . V_113 . V_114 = ( V_2 -> V_38 / 2 ) / 64 ;
V_2 -> V_18 . V_69 . V_113 . V_115 = ( V_2 -> V_38 / 2 ) / 4 ;
F_13 ( L_11 ,
V_21 , V_2 -> V_112 , V_2 -> V_44 , V_2 -> V_45 ,
V_2 -> V_46 ) ;
V_2 -> V_18 . V_42 = V_2 ;
return & V_2 -> V_18 ;
error:
