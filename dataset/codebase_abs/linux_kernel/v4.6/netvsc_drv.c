...
return;
V_192 = F_6 ( V_20 ) ;
V_194 = F_65 ( sizeof( * V_194 ) , V_201 ) ;
if ( ! V_194 )
return;
V_194 -> V_194 = V_190 -> V_195 ;
F_66 ( & V_192 -> V_202 , V_13 ) ;
F_67 ( & V_194 -> V_203 , & V_192 -> V_204 ) ;
F_68 ( & V_192 -> V_202 , V_13 ) ;
F_69 ( & V_192 -> V_205 , 0 ) ;
}
...
V_54 = F_71 ( V_20 , V_77 -> V_127 ) ;
if ( F_72 ( ! V_54 ) ) {
++ V_20 -> V_184 . V_209 ;
return V_208 ;
}
memcpy ( F_73 ( V_54 , V_77 -> V_127 ) , * V_80 ,
V_77 -> V_127 ) ;
V_54 -> V_98 = F_74 ( V_54 , V_20 ) ;
if ( V_112 ) {
...
struct V_216 * V_217 )
{
F_79 ( V_217 -> V_218 , V_219 , sizeof( V_217 -> V_218 ) ) ;
F_79 ( V_217 -> V_220 , L_7 , sizeof( V_217 -> V_220 ) ) ;
}
...
static bool F_90 ( const struct V_244 * V_245 )
{
...
V_246 . V_245 = 0 ;
V_247 . V_250 = V_251 ;
return ! memcmp ( & V_246 , & V_247 , sizeof( V_246 ) ) ;
}
static void F_92 ( struct V_19 * V_222 )
{
struct V_3 * V_252 = F_6 ( V_222 ) ;
V_252 -> V_253 = V_254 ;
V_252 -> V_248 = V_255 ;
}
static int F_93 ( struct V_19 * V_222 , struct V_244 * V_245 )
{
struct V_3 * V_252 = F_6 ( V_222 ) ;
F_91 ( V_245 , V_252 -> V_253 ) ;
V_245 -> V_248 = V_252 -> V_248 ;
V_245 -> V_250 = V_251 ;
return 0 ;
}
static int F_94 ( struct V_19 * V_222 , struct V_244 * V_245 )
{
struct V_3 * V_252 = F_6 ( V_222 ) ;
T_1 V_253 ;
V_253 = F_95 ( V_245 ) ;
...
return - V_234 ;
V_252 -> V_253 = V_253 ;
V_252 -> V_248 = V_245 -> V_248 ;
return 0 ;
}
static int F_98 ( struct V_19 * V_11 , int V_256 )
{
...
static struct V_263 * F_99 ( struct V_19 * V_20 ,
struct V_263 * V_264 )
{
struct V_3 * V_192 = F_6 ( V_20 ) ;
int V_265 ;
F_100 (cpu) {
struct V_119 * V_120 = F_101 ( V_192 -> V_120 ,
V_265 ) ;
struct V_119 * V_207 = F_101 ( V_192 -> V_207 ,
V_265 ) ;
T_5 V_266 , V_267 , V_268 , V_269 ;
unsigned int V_270 ;
do {
V_270 = F_102 ( & V_120 -> V_181 ) ;
V_266 = V_120 -> V_182 ;
V_267 = V_120 -> V_72 ;
} while ( F_103 ( & V_120 -> V_181 , V_270 ) );
do {
V_270 = F_102 ( & V_207 -> V_181 ) ;
V_268 = V_207 -> V_182 ;
V_269 = V_207 -> V_72 ;
} while ( F_103 ( & V_207 -> V_181 , V_270 ) );
V_264 -> V_267 += V_267 ;
V_264 -> V_266 += V_266 ;
V_264 -> V_269 += V_269 ;
V_264 -> V_268 += V_268 ;
}
V_264 -> V_185 = V_20 -> V_184 . V_185 ;
V_264 -> V_271 = V_20 -> V_184 . V_185 ;
V_264 -> V_209 = V_20 -> V_184 . V_209 ;
V_264 -> V_272 = V_20 -> V_184 . V_272 ;
return V_264 ;
}
static int F_104 ( struct V_19 * V_11 , void * V_273 )
{
struct V_3 * V_4 = F_6 ( V_11 ) ;
struct V_22 * V_57 = V_4 -> V_10 ;
...
unsigned char V_278 ;
int V_279 ;
memcpy ( V_276 , V_11 -> V_280 , V_277 ) ;
V_278 = V_11 -> V_281 ;
V_279 = F_105 ( V_11 , V_273 ) ;
if ( V_279 != 0 )
return V_279 ;
V_279 = F_106 ( V_57 , V_275 -> V_282 ) ;
if ( V_279 != 0 ) {
memcpy ( V_11 -> V_280 , V_276 , V_277 ) ;
V_11 -> V_281 = V_278 ;
}
return V_279 ;
}
...
unsigned long V_13 , V_285 , V_286 ;
V_192 = F_2 ( V_2 , struct V_3 , V_205 . V_5 ) ;
V_19 = F_3 ( V_192 -> V_10 ) ;
V_9 = V_19 -> V_12 ;
V_20 = V_19 -> V_11 ;
V_285 = V_192 -> V_287 + V_288 ;
if ( F_109 ( V_285 ) ) {
V_286 = V_285 - V_289 ;
V_286 = V_286 < V_288 ? V_286 : V_288 ;
F_69 ( & V_192 -> V_205 , V_286 ) ;
return;
}
V_192 -> V_287 = V_289 ;
F_66 ( & V_192 -> V_202 , V_13 ) ;
if ( ! F_110 ( & V_192 -> V_204 ) ) {
V_194 = F_111 ( & V_192 -> V_204 ,
struct V_193 , V_203 ) ;
F_112 ( & V_194 -> V_203 ) ;
V_284 = ! F_110 ( & V_192 -> V_204 ) ;
}
F_68 ( & V_192 -> V_202 , V_13 ) ;
if ( ! V_194 )
return;
...
F_117 ( V_20 ) ;
if ( V_284 )
F_69 ( & V_192 -> V_205 , V_288 ) ;
}
static void F_118 ( struct V_19 * V_290 )
{
struct V_3 * V_21 = F_6 ( V_290 ) ;
F_119 ( V_21 -> V_120 ) ;
F_119 ( V_21 -> V_207 ) ;
F_120 ( V_290 ) ;
}
static int F_121 ( struct V_22 * V_222 ,
...
V_21 = F_6 ( V_20 ) ;
V_21 -> V_10 = V_222 ;
V_21 -> V_293 = F_123 ( V_294 , V_295 ) ;
if ( F_124 ( V_21 ) )
F_125 ( V_20 , L_14 ,
V_21 -> V_293 ) ;
V_21 -> V_120 = F_126 ( struct V_119 ) ;
if ( ! V_21 -> V_120 ) {
F_120 ( V_20 ) ;
return - V_124 ;
}
V_21 -> V_207 = F_126 ( struct V_119 ) ;
if ( ! V_21 -> V_207 ) {
F_119 ( V_21 -> V_120 ) ;
F_120 ( V_20 ) ;
return - V_124 ;
...
F_86 ( V_222 , V_20 ) ;
F_127 ( & V_21 -> V_205 , F_108 ) ;
F_128 ( & V_21 -> V_5 , F_1 ) ;
F_129 ( & V_21 -> V_202 ) ;
F_130 ( & V_21 -> V_204 ) ;
V_20 -> V_296 = & V_297 ;
V_20 -> V_298 = V_299 ;
V_20 -> V_300 = V_299 | V_301 ;
V_20 -> V_302 = & V_302 ;
F_131 ( V_20 , & V_222 -> V_303 ) ;
V_20 -> V_304 = V_125 ;
memset ( & V_228 , 0 , sizeof( V_228 ) ) ;
V_228 . V_241 = V_241 ;
V_228 . V_242 = V_242 ;
...
memcpy ( V_20 -> V_280 , V_228 . V_305 , V_277 ) ;
V_7 = F_3 ( V_222 ) ;
F_88 ( V_20 , V_7 -> V_34 ) ;
F_89 ( V_20 , V_7 -> V_34 ) ;
F_92 ( V_20 ) ;
...
static int F_134 ( struct V_22 * V_222 )
{
struct V_19 * V_20 ;
struct V_3 * V_192 ;
struct V_6 * V_19 ;
