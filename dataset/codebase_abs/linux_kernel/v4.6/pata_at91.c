...
static unsigned int F_27 ( struct V_26 * V_10 ,
...
F_12 ( V_42 . V_36 , V_29 -> V_43 , ( V_36 & ~ V_57 ) |
V_58 ) ;
V_55 = F_30 ( V_10 , V_51 , V_52 , V_53 ) ;
F_12 ( V_42 . V_36 , V_29 -> V_43 , ( V_36 & ~ V_57 ) |
V_59 ) ;
F_31 ( V_56 ) ;
return V_55 ;
...
{
struct V_60 V_61 = F_33 ( 0 , 0 , 31 ) ;
V_61 . V_62 = 8 ;
V_61 . V_63 = V_64 ;
V_61 . V_65 = F_34 ( V_66 ) ;
V_42 . V_11 = F_35 ( V_10 , V_67 , V_61 ) ;
if ( F_36 ( V_42 . V_11 ) )
return F_37 ( V_42 . V_11 ) ;
V_61 . V_65 = F_38 ( V_66 ) ;
V_42 . V_12 = F_35 ( V_10 , V_67 , V_61 ) ;
if ( F_36 ( V_42 . V_12 ) )
return F_37 ( V_42 . V_12 ) ;
V_61 . V_65 = F_39 ( V_66 ) ;
V_42 . V_13 = F_35 ( V_10 , V_67 , V_61 ) ;
if ( F_36 ( V_42 . V_13 ) )
return F_37 ( V_42 . V_13 ) ;
V_61 . V_65 = F_40 ( V_66 ) ;
V_42 . V_36 = F_35 ( V_10 , V_67 , V_61 ) ;
if ( F_36 ( V_42 . V_36 ) )
return F_37 ( V_42 . V_36 ) ;
return 0 ;
}
static int F_41 ( struct V_68 * V_69 )
{
struct V_70 * V_71 = F_42 ( & V_69 -> V_10 ) ;
...
V_73 = F_43 ( V_69 , V_79 , 0 ) ;
if ( ! V_73 ) {
F_5 ( V_10 , L_14 ) ;
return - V_78 ;
}
V_76 = V_71 -> V_80 ;
V_67 = F_44 ( V_69 -> V_10 . V_81 , L_15 ) ;
if ( F_36 ( V_67 ) )
return F_37 ( V_67 ) ;
V_32 = F_32 ( V_10 ) ;
if ( V_32 < 0 )
...
V_29 = F_48 ( V_10 , sizeof( * V_29 ) , V_90 ) ;
if ( ! V_29 ) {
F_5 ( V_10 , L_17 ) ;
return - V_82 ;
}
V_29 -> V_38 = F_49 ( NULL , L_18 ) ;
if ( F_36 ( V_29 -> V_38 ) ) {
F_5 ( V_10 , L_19 ) ;
return - V_91 ;
}
...
V_29 -> V_101 = F_50 ( V_10 ,
V_73 -> V_97 + V_102 , V_99 ) ;
if ( ! V_29 -> V_101 ) {
F_5 ( V_10 , L_21 ) ;
V_32 = - V_82 ;
goto V_100;
}
V_45 -> V_103 . V_104 = V_29 -> V_96 ;
V_45 -> V_103 . V_105 = V_29 -> V_101 + 0x06 ;
V_45 -> V_103 . V_106 = V_45 -> V_103 . V_105 ;
F_51 ( & V_45 -> V_103 ) ;
F_47 ( V_45 , L_22 ,
( unsigned long long ) V_73 -> V_97 + V_98 ,
( unsigned long long ) V_73 -> V_97 + V_102 ) ;
V_46 -> V_47 = V_29 ;
V_32 = F_52 ( V_46 , F_46 ( V_76 ) ? F_53 ( V_76 ) : 0 ,
F_46 ( V_76 ) ? V_107 : NULL ,
V_75 , & V_108 ) ;
if ( V_32 )
goto V_100;
return 0 ;
