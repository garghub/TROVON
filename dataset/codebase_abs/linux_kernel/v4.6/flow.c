...
F_7 ( V_26 , V_14 ) ;
F_16 ( & V_14 -> V_31 ) ;
F_17 ( F_6 ( & V_14 -> V_31 ) < 0 ) ;
}
}
static void F_18 ( struct V_32 * V_33 ,
int V_34 , struct V_24 * V_25 ,
struct V_13 * V_14 )
{
if ( V_34 ) {
F_19 ( V_34 , & V_14 -> V_31 ) ;
...
V_34 ++ ;
F_26 ( & V_12 -> V_41 . V_42 ) ;
F_27 ( & V_12 -> V_41 . V_25 , & V_25 ) ;
}
}
}
F_18 ( V_33 , V_34 , & V_25 , V_14 ) ;
}
static void F_28 ( struct V_2 * V_3 ,
struct V_32 * V_33 )
{
int V_36 = V_3 -> V_43 / F_24 ( V_3 ) ;
F_22 ( V_3 , V_33 , V_36 ) ;
}
static void F_29 ( struct V_2 * V_3 ,
struct V_32 * V_33 )
{
F_30 ( & V_33 -> V_44 , sizeof( V_45 ) ) ;
V_33 -> V_6 = 0 ;
F_22 ( V_3 , V_33 , 0 ) ;
}
static V_45 F_31 ( struct V_2 * V_3 ,
struct V_32 * V_33 ,
...
return F_32 ( V_49 , V_50 , V_33 -> V_44 )
& ( F_24 ( V_3 ) - 1 ) ;
}
static int F_33 ( const struct V_46 * V_52 , const struct V_46 * V_53 ,
T_1 V_48 )
{
...
struct V_57 *
F_34 ( struct V_58 * V_58 , const struct V_46 * V_47 , T_2 V_59 , T_3 V_60 ,
T_4 V_61 , void * V_62 )
{
...
if ( V_33 -> V_6 )
F_29 ( V_3 , V_33 ) ;
V_65 = F_31 ( V_3 , V_33 , V_47 , V_48 ) ;
F_38 (tfle, &fcp->hash_table[hash], u.hlist) {
if ( V_63 -> V_58 == V_58 &&
V_63 -> V_59 == V_59 &&
V_63 -> V_60 == V_60 &&
F_33 ( V_47 , & V_63 -> V_47 , V_48 ) == 0 ) {
V_12 = V_63 ;
break;
}
}
...
F_28 ( V_3 , V_33 ) ;
if ( V_33 -> V_35 > 2 * V_3 -> V_68 ||
F_6 ( & V_58 -> V_14 . V_31 ) > V_3 -> V_68 ) {
F_40 ( & V_58 -> V_14 . V_15 ) ;
V_64 = F_41 ( - V_69 ) ;
goto V_70;
}
...
V_12 -> V_17 = NULL ;
F_43 ( & V_12 -> V_41 . V_42 , & V_33 -> V_67 [ V_65 ] ) ;
V_33 -> V_35 ++ ;
}
} else if ( F_44 ( V_12 -> V_16 == F_6 ( & V_58 -> V_14 . V_15 ) ) ) {
V_64 = V_12 -> V_17 ;
if ( ! V_64 )
goto V_70;
...
static int F_51 ( struct V_2 * V_3 , int V_79 )
{
struct V_32 * V_33 ;
int V_4 ;
V_33 = F_3 ( V_3 -> V_5 , V_79 ) ;
for ( V_4 = 0 ; V_4 < F_24 ( V_3 ) ; V_4 ++ )
if ( ! F_52 ( & V_33 -> V_67 [ V_4 ] ) )
return 0 ;
return 1 ;
}
static void F_53 ( void * V_73 )
{
struct V_74 * V_75 = V_73 ;
struct V_80 * V_81 ;
V_81 = & F_36 ( V_75 -> V_76 -> V_5 ) -> V_82 ;
V_81 -> V_73 = ( unsigned long ) V_75 ;
F_54 ( V_81 ) ;
}
void F_55 ( struct V_58 * V_58 )
{
struct V_74 V_75 ;
T_5 V_83 ;
int V_4 , V_84 ;
...
F_60 (i)
if ( ! F_51 ( V_75 . V_76 , V_4 ) )
F_61 ( V_4 , V_83 ) ;
F_62 ( & V_75 . V_77 , F_63 ( V_83 ) ) ;
if ( F_6 ( & V_75 . V_77 ) == 0 )
goto V_87;
F_64 ( & V_75 . V_78 ) ;
F_35 () ;
V_84 = F_65 ( F_66 () , V_83 ) ;
F_67 ( V_83 , F_53 , & V_75 , 0 ) ;
if ( V_84 )
F_48 ( ( unsigned long ) & V_75 ) ;
F_47 () ;
F_68 ( & V_75 . V_78 ) ;
V_87:
F_69 ( & V_58 -> V_14 . V_86 ) ;
...
void F_73 ( struct V_58 * V_58 )
{
F_21 ( & V_58 -> V_14 . V_88 ) ;
}
static int F_74 ( struct V_2 * V_3 , int V_79 )
{
struct V_32 * V_33 = F_3 ( V_3 -> V_5 , V_79 ) ;
T_1 V_89 = sizeof( struct V_90 ) * F_24 ( V_3 ) ;
if ( ! V_33 -> V_67 ) {
V_33 -> V_67 = F_75 ( V_89 , V_85 , F_76 ( V_79 ) ) ;
if ( ! V_33 -> V_67 ) {
F_77 ( L_1 , V_89 ) ;
return - V_91 ;
}
...
void * V_95 )
{
struct V_2 * V_3 = F_10 ( V_93 , struct V_2 ,
V_96 ) ;
int V_97 , V_79 = ( unsigned long ) V_95 ;
struct V_32 * V_33 = F_3 ( V_3 -> V_5 , V_79 ) ;
switch ( V_94 ) {
case V_98 :
case V_99 :
...
F_84 ( & V_58 -> V_14 . V_88 , F_72 ) ;
F_85 ( & V_58 -> V_14 . V_86 ) ;
F_62 ( & V_58 -> V_14 . V_31 , 0 ) ;
V_3 -> V_104 = 10 ;
V_3 -> V_43 = 2 * F_24 ( V_3 ) ;
V_3 -> V_68 = 4 * F_24 ( V_3 ) ;
