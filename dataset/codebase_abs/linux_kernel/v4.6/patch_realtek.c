...
if ( V_2 -> V_70 -> V_226 )
return;
for ( V_67 = 0 ; V_67 < V_2 -> V_227 . V_228 ; V_67 ++ ) {
struct V_229 * V_163 = F_112 ( & V_2 -> V_227 , V_67 ) ;
if ( V_163 -> V_3 != V_225 )
F_3 ( V_2 , V_163 -> V_3 , 0 ,
V_230 , 0 ) ;
}
...
static void F_113 ( struct V_1 * V_2 , int V_232 )
{
F_21 ( V_2 , 0x04 , 1 << 11 , V_232 ? ( 1 << 11 ) : 0 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
T_1 V_234 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
bool V_235 ;
int V_236 ;
F_115 ( V_2 ) ;
if ( ! V_234 )
return;
V_235 = F_117 ( V_2 , V_234 ) ;
V_236 = F_7 ( V_2 , 0x78 ) ;
...
T_1 V_234 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
bool V_235 ;
if ( ! V_13 -> V_86 . V_87 . V_241 ) {
if ( V_13 -> V_86 . V_87 . V_90 == V_177 )
V_234 = V_13 -> V_86 . V_87 . V_89 [ 0 ] ;
}
F_120 ( V_2 ) ;
if ( ! V_234 )
return;
...
static void F_123 ( struct V_1 * V_2 , unsigned int V_242 ,
unsigned int V_5 )
{
F_2 ( V_2 , 0x51 , 0 , V_6 , V_242 >> 1 ) ;
F_2 ( V_2 , 0x51 , 0 , V_9 , V_5 & 0xffff ) ;
F_2 ( V_2 , 0x51 , 0 , V_9 , V_5 >> 16 ) ;
}
static int F_124 ( struct V_1 * V_2 , unsigned int V_242 )
{
unsigned int V_5 ;
F_2 ( V_2 , 0x51 , 0 , V_6 , V_242 >> 1 ) ;
...
F_29 ( 200 ) ;
V_153 ( V_2 , V_27 ) ;
V_255 = V_13 -> V_86 . V_149 ? V_256 : 0 ;
F_29 ( 100 ) ;
F_2 ( V_2 , 0x18 , 0 , V_230 ,
V_255 ) ;
F_29 ( 500 ) ;
F_2 ( V_2 , 0x18 , 0 , V_230 ,
V_255 ) ;
...
if ( V_57 == V_58 ) {
V_13 -> V_130 |= V_247 ;
V_13 -> V_86 . V_257 = F_143 ;
}
}
static void F_145 ( void * V_258 , int V_259 )
{
...
if ( V_13 -> V_261 )
V_259 = ! V_259 ;
V_260 = F_94 ( V_2 , V_13 -> V_262 ) ;
V_260 &= ~ V_263 ;
V_260 |= V_259 ? V_264 : V_178 ;
if ( V_13 -> V_262 )
F_146 ( V_2 , V_13 -> V_262 , V_260 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
if ( V_265 != V_107 || V_3 == 0 ||
( V_3 != V_13 -> V_262 && V_3 != V_13 -> V_266 ) )
return V_265 ;
F_95 ( V_2 , V_3 ,
F_94 ( V_2 , V_3 ) ) ;
return F_148 ( V_2 , V_3 , V_265 ) ;
}
static void F_149 ( struct V_1 * V_2 ,
const struct V_55 * V_56 , int V_57 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
const struct V_267 * V_268 = NULL ;
if ( V_57 != V_58 )
return;
while ( ( V_268 = F_150 ( V_269 , NULL , V_268 ) ) ) {
int V_270 , V_163 ;
if ( sscanf ( V_268 -> V_98 , L_17 , & V_270 , & V_163 ) != 2 )
continue;
if ( V_163 < 0x0a || V_163 >= 0x10 )
break;
V_13 -> V_261 = V_270 ;
V_13 -> V_262 = V_163 - 0x0a + 0x18 ;
V_13 -> V_86 . V_271 . V_272 = F_145 ;
V_13 -> V_86 . V_273 = 1 ;
V_2 -> V_274 = F_147 ;
F_38 ( V_2 ,
L_18 , V_13 -> V_262 ,
...
static void F_154 ( void * V_258 , int V_259 )
{
struct V_1 * V_2 = V_258 ;
struct V_12 * V_13 = V_2 -> V_13 ;
F_153 ( V_2 , V_13 -> V_276 , V_259 ) ;
}
...
struct V_12 * V_13 = V_2 -> V_13 ;
if ( V_278 )
F_153 ( V_2 , V_13 -> V_279 ,
V_278 -> V_35 . integer . V_35 [ 0 ] ||
V_278 -> V_35 . integer . V_35 [ 1 ] ) ;
}
static void F_156 ( struct V_1 * V_2 ,
const struct V_55 * V_56 , int V_57 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
static const struct V_248 V_280 [] = {
{ 0x01 , V_171 , 0x18 } ,
{ 0x01 , V_172 , 0x18 } ,
{}
} ;
if ( V_57 == V_58 ) {
V_13 -> V_86 . V_271 . V_272 = F_154 ;
V_13 -> V_86 . V_281 = F_155 ;
V_13 -> V_245 = 0 ;
V_13 -> V_261 = 0 ;
V_13 -> V_276 = 0x08 ;
V_13 -> V_279 = 0x10 ;
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
unsigned int V_260 , V_282 , V_283 ;
V_260 = F_94 ( V_2 , V_13 -> V_266 ) ;
V_260 &= ~ V_263 ;
V_282 = V_260 | V_178 ;
V_283 = V_260 | V_264 ;
if ( ! V_278 )
return;
if ( V_278 -> V_35 . integer . V_35 [ 0 ] ||
V_278 -> V_35 . integer . V_35 [ 1 ] )
V_260 = V_283 ;
else
V_260 = V_282 ;
if ( V_13 -> V_266 )
F_146 ( V_2 , V_13 -> V_266 , V_260 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
F_162 ( V_13 -> V_285 , V_13 -> V_286 [ V_287 ] , 1 ) ;
F_163 ( V_13 -> V_285 ) ;
F_162 ( V_13 -> V_285 , V_13 -> V_286 [ V_287 ] , 0 ) ;
F_163 ( V_13 -> V_285 ) ;
}
...
V_13 -> V_286 [ V_287 ] = V_288 ;
V_13 -> V_285 -> V_98 = L_20 ;
V_13 -> V_285 -> V_289 [ 0 ] = F_167 ( V_290 ) ;
V_13 -> V_285 -> V_291 = sizeof( V_13 -> V_286 [ 0 ] ) ;
V_13 -> V_285 -> V_292 = F_11 ( V_13 -> V_286 ) ;
V_13 -> V_285 -> V_293 = V_13 -> V_286 ;
for ( V_67 = 0 ; V_67 < F_11 ( V_13 -> V_286 ) ; V_67 ++ )
F_168 ( V_13 -> V_286 [ V_67 ] , V_13 -> V_285 -> V_294 ) ;
if ( F_169 ( V_13 -> V_285 ) ) {
F_166 ( V_2 , L_21 ) ;
F_170 ( V_13 -> V_285 ) ;
V_13 -> V_285 = NULL ;
...
static void F_181 ( struct V_1 * V_2 , T_1 V_234 ,
T_1 V_225 )
{
static struct V_15 V_297 [] = {
F_179 ( 0x57 , 0x03 , 0x8aa6 ) ,
...
F_29 ( 300 ) ;
V_5 = F_7 ( V_2 , 0xbe ) ;
V_306 = ( V_5 & 0x1c02 ) == 0x1c02 ;
break;
case 0x10ec0225 :
F_8 ( V_2 , V_303 ) ;
F_29 ( 800 ) ;
V_5 = F_7 ( V_2 , 0x46 ) ;
V_306 = ( V_5 & 0x00f0 ) == 0x00f0 ;
break;
}
F_38 ( V_2 , L_27 ,
V_306 ? L_28 : L_29 ) ;
V_13 -> V_307 = V_306 ? V_308 : V_309 ;
}
static void F_186 ( struct V_1 * V_2 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
T_1 V_310 = V_13 -> V_86 . V_311 [ V_13 -> V_86 . V_312 [ 0 ] ] ;
T_1 V_234 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
int V_313 ;
if ( ! F_117 ( V_2 , V_234 ) )
V_313 = V_314 ;
else if ( V_310 == V_13 -> V_315 )
V_313 = V_316 ;
else if ( V_310 == V_13 -> V_317 )
V_313 = V_318 ;
else
V_313 = V_319 ;
if ( V_313 == V_13 -> V_320 ) {
...
if ( V_13 -> V_307 == V_308 )
F_183 ( V_2 ) ;
else if ( V_13 -> V_307 == V_309 )
F_184 ( V_2 ) ;
V_13 -> V_86 . V_149 = true ;
break;
case V_318 :
F_181 ( V_2 , V_234 , V_13 -> V_317 ) ;
V_13 -> V_86 . V_149 = false ;
break;
case V_319 :
F_182 ( V_2 ) ;
...
F_146 ( V_2 , V_234 ,
V_322 | V_323 ) ;
if ( V_13 -> V_317 && V_13 -> V_317 != V_234 )
F_146 ( V_2 , V_13 -> V_317 ,
V_324 ) ;
}
V_13 -> V_320 = V_313 ;
F_141 ( V_2 ) ;
...
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_128 * V_129 = & V_13 -> V_86 . V_87 ;
for ( V_67 = 0 ; V_67 < V_129 -> V_325 ; V_67 ++ ) {
if ( V_129 -> V_326 [ V_67 ] . V_327 && ! V_13 -> V_315 )
V_13 -> V_315 = V_129 -> V_326 [ V_67 ] . V_163 ;
if ( V_129 -> V_326 [ V_67 ] . V_328 && ! V_13 -> V_317 )
V_13 -> V_317 = V_129 -> V_326 [ V_67 ] . V_163 ;
}
V_13 -> V_86 . V_281 = F_187 ;
V_13 -> V_86 . V_150 = F_186 ;
V_13 -> V_86 . V_257 = F_188 ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
int V_234 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
F_2 ( V_2 , V_234 , 0 ,
V_237 , V_238 ) ;
F_29 ( 20 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_333 * V_334 = & V_13 -> V_86 . V_335 ;
int V_67 ;
switch ( V_57 ) {
case V_58 :
F_204 ( V_2 , 0x19 , V_324 ) ;
break;
case V_63 :
V_13 -> V_104 = F_202 ;
for ( V_67 = 0 ; V_67 < V_334 -> V_336 ; V_67 ++ ) {
if ( V_13 -> V_86 . V_311 [ V_67 ] == 0x12 ) {
V_13 -> V_86 . V_312 [ 0 ] = V_67 ;
break;
}
}
break;
...
V_13 -> V_130 |= V_247 ;
V_13 -> V_86 . V_158 = 1 ;
F_2 ( V_2 , 0x1b , 0 , V_237 , 0x7000 ) ;
F_206 ( V_2 , 0x1b , F_25 ( V_2 , 0x1b ) & ~ V_337 ) ;
} else
F_190 ( V_2 , V_56 , V_57 ) ;
}
...
int V_67 ;
for ( V_67 = 0 ; V_67 < V_129 -> V_325 ; V_67 ++ ) {
if ( V_129 -> V_326 [ V_67 ] . type != V_339 )
continue;
V_3 = V_129 -> V_326 [ V_67 ] . V_163 ;
V_338 = F_36 ( V_2 , V_3 ) ;
if ( F_208 ( V_338 ) == V_340 )
continue;
return V_3 ;
}
return 0 ;
...
return;
for ( V_67 = 0 ; V_67 < V_129 -> V_325 ; V_67 ++ ) {
T_1 V_3 = V_129 -> V_326 [ V_67 ] . V_163 ;
unsigned int V_338 ;
if ( V_129 -> V_326 [ V_67 ] . type != V_339 )
continue;
V_338 = F_36 ( V_2 , V_3 ) ;
...
F_141 ( V_2 ) ;
if ( F_117 ( V_2 , 0x1b ) )
V_13 -> V_86 . V_341 |= ( 1ULL << 0x14 ) ;
}
static void F_216 ( struct V_1 * V_2 ,
const struct V_55 * V_56 , int V_57 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
static const struct V_248 V_342 [] = {
{ 0x01 , V_171 , 0x04 } ,
{ 0x01 , V_172 , 0x04 } ,
{ 0x01 , V_148 , 0x04 } ,
{}
} ;
static const struct V_154 V_343 [] = {
{ 0x1b , 0x21114000 } ,
{}
} ;
struct V_28 * V_29 ;
...
V_29 = F_15 ( V_2 , L_30 ) ;
if ( V_29 )
strcpy ( V_29 -> V_344 . V_98 , L_31 ) ;
V_29 = F_15 ( V_2 , L_32 ) ;
if ( V_29 )
strcpy ( V_29 -> V_344 . V_98 , L_30 ) ;
break;
}
}
...
V_2 -> V_332 = 1 ;
#ifdef F_222
V_2 -> V_110 . V_345 = F_129 ;
V_2 -> V_110 . V_346 = F_131 ;
#endif
V_13 -> V_104 = F_114 ;
F_75 ( V_2 , V_347 ,
V_348 , V_349 ) ;
F_223 ( V_2 , V_350 , V_349 ) ;
F_75 ( V_2 , NULL , V_351 ,
V_349 ) ;
F_50 ( V_2 , V_58 ) ;
F_35 ( V_2 ) ;
...
if ( F_3 ( V_2 , 0x51 , 0 , V_352 , 0 ) == 0x10ec5505 ) {
V_13 -> V_244 = 1 ;
V_13 -> V_102 = F_127 ;
}
V_94 = F_109 ( V_2 ) ;
...
{
static const T_1 V_353 [] = { 0x1d , 0 } ;
static const T_1 V_354 [] = { 0x0e , 0x0f , 0x0b , 0 } ;
return F_66 ( V_2 , V_353 , V_354 ) ;
}
...
{
static const T_1 V_360 [] = { 0x1d , 0 } ;
static const T_1 V_361 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
return F_66 ( V_2 , V_360 , V_361 ) ;
}
...
{
static const T_1 V_364 [] = { 0x1d , 0 } ;
static const T_1 V_365 [] = { 0x15 , 0x1b , 0x14 , 0x21 } ;
static const T_1 V_366 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
const T_1 * V_209 ;
...
if ( V_57 == V_101 ) {
struct V_12 * V_13 = V_2 -> V_13 ;
V_13 -> V_86 . V_367 [ 0 ] -> V_368 [ 0 ] . V_369 = V_370 ;
}
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
if ( V_3 == V_2 -> V_39 . V_106 && V_265 == V_107 && V_13 -> V_245 )
return V_371 ;
return V_265 ;
}
