...
static void
F_39 ( struct V_79 * V_80 , void * V_131 )
{
struct V_123 * V_124 = & V_80 -> V_87 ;
...
void * V_136 ;
T_2 V_137 ;
if ( ( F_40 ( V_124 -> V_2 . V_9 , V_124 -> V_87 + 0xc08 ) >> 20 ) & 0x1 ) {
...
static int
F_42 ( struct V_79 * V_80 , const char * V_6 ,
struct V_117 * * V_7 ,
...
static void
F_46 ( struct V_79 * V_80 , void * V_12 , T_2 V_77 )
{
struct V_125 * V_9 = V_80 -> V_87 . V_2 . V_9 ;
struct V_19 * V_161 = V_80 -> V_156 ;
struct V_21 * V_162 = V_80 -> V_156 + V_161 -> V_23 ;
void * V_163 = V_80 -> V_156 + V_161 -> V_25 ;
void * V_164 = V_163 + V_162 -> V_165 ;
void * V_166 = V_163 + V_162 -> V_167 ;
T_2 V_30 = F_8 ( V_162 -> V_30 , 256 ) ;
const T_2 V_87 = V_80 -> V_87 . V_87 ;
T_2 V_168 ;
T_2 V_169 ;
int V_170 ;
F_47 ( V_9 , V_87 + 0x1c0 , ( 0x00000000 | ( 0x1 << 24 ) ) ) ;
for ( V_170 = 0 ; V_170 < V_162 -> V_77 / 4 ; V_170 ++ )
F_47 ( V_9 , V_87 + 0x1c4 , ( ( T_2 * ) V_166 ) [ V_170 ] ) ;
F_47 ( V_9 , V_87 + 0x1c0 ,
( V_162 -> V_171 | ( 0x1 << 24 ) ) ) ;
for ( V_170 = 0 ; V_170 < V_77 / 4 ; V_170 ++ )
F_47 ( V_9 , V_87 + 0x1c4 , ( ( T_2 * ) V_12 ) [ V_170 ] ) ;
V_168 = ( F_40 ( V_9 , V_87 + 0x108 ) & 0x1ff ) - ( V_30 >> 8 ) ;
V_169 = V_162 -> V_32 ;
F_47 ( V_9 , V_87 + 0x180 , ( ( V_168 & 0xff ) << 8 ) | ( 0x1 << 24 ) ) ;
for ( V_170 = 0 ; V_170 < V_30 / 4 ; V_170 ++ ) {
if ( ( V_170 & 0x3f ) == 0 ) {
F_47 ( V_9 , V_87 + 0x188 , V_169 & 0xffff ) ;
V_169 ++ ;
}
F_47 ( V_9 , V_87 + 0x184 , ( ( T_2 * ) V_164 ) [ V_170 ] ) ;
}
F_47 ( V_9 , V_87 + 0x188 , 0 ) ;
}
static int
...
struct V_19 * V_161 = V_80 -> V_156 ;
struct V_21 * V_162 = V_80 -> V_156 + V_161 -> V_23 ;
T_2 V_172 = V_162 -> V_32 << 8 ;
const T_2 V_87 = V_80 -> V_87 . V_87 ;
const T_2 V_173 = V_87 + 0xe00 ;
T_2 V_174 ;
int V_8 ;
V_8 = F_49 ( & V_80 -> V_87 ) ;
if ( V_8 )
return V_8 ;
F_47 ( V_9 , V_173 + 4 * ( V_71 ) , 0x4 ) ;
F_47 ( V_9 , V_173 + 4 * ( V_147 ) , 0x0 ) ;
F_47 ( V_9 , V_173 + 4 * ( V_175 ) , 0x4 ) ;
F_47 ( V_9 , V_173 + 4 * ( V_176 ) ,
0x4 | 0x1 ) ;
F_47 ( V_9 , V_173 + 4 * ( V_177 ) ,
0x4 | 0x2 ) ;
if ( F_50 ( V_80 -> V_178 -> V_179 ) == V_180 )
V_174 = 0x0 ;
else
V_174 = 0x3 ;
F_51 ( V_9 , V_87 + 0x048 , 0x1 , 0x1 ) ;
F_47 ( V_9 , V_87 + 0x480 ,
( ( V_80 -> V_178 -> V_130 >> 12 ) & 0xfffffff ) |
( V_174 << 28 ) | ( 1 << 30 ) ) ;
F_47 ( V_9 , V_87 + 0x104 , V_172 ) ;
return 0 ;
}
static int
F_52 ( struct V_79 * V_80 , struct V_117 * V_7 ,
struct V_66 * V_18 )
{
struct V_181 V_182 ;
T_4 V_183 ;
...
T_5 V_22 [ V_119 ] ;
int V_8 ;
V_8 = F_53 ( V_7 , V_80 -> V_184 , V_185 , & V_182 ) ;
if ( V_8 )
return V_8 ;
V_183 = F_54 ( V_18 -> V_72 ) + V_182 . V_81 ;
V_18 -> V_72 . V_73 = F_18 ( V_183 ) ;
V_18 -> V_72 . V_74 = F_19 ( V_183 ) ;
V_183 = F_54 ( V_18 -> V_76 ) + V_182 . V_81 ;
V_18 -> V_76 . V_73 = F_18 ( V_183 ) ;
V_18 -> V_76 . V_74 = F_19 ( V_183 ) ;
V_80 -> V_89 -> V_121 ( V_18 , & V_22 ) ;
V_8 = F_48 ( V_80 ) ;
if ( V_8 )
goto V_186;
F_46 ( V_80 , & V_22 , V_119 ) ;
V_8 = F_55 ( & V_80 -> V_87 ) ;
if ( V_8 )
goto V_186;
V_186:
...
int
F_57 ( struct V_123 * V_124 , enum V_187 V_188 )
{
struct V_79 * V_80 = V_79 ( V_124 ) ;
int V_8 ;
if ( V_188 != V_62 )
goto V_189;
if ( V_80 -> V_159 &&
V_80 -> V_190 [ V_62 ] != V_191 ) {
V_8 = F_52 ( V_80 , V_80 -> V_159 ,
& V_80 -> V_160 ) ;
if ( V_8 )
return V_8 ;
}
V_8 = F_52 ( V_80 , V_80 -> V_157 ,
& V_80 -> V_158 ) ;
if ( V_8 )
return V_8 ;
V_189:
V_80 -> V_190 [ V_188 ] = V_192 ;
return 0 ;
}
int
F_58 ( struct V_123 * V_124 , enum V_187 V_188 )
{
struct V_79 * V_80 = V_79 ( V_124 ) ;
int V_87 ;
switch ( V_188 ) {
...
F_47 ( V_124 -> V_2 . V_9 , V_87 + 0x130 , 0x00000002 ) ;
V_80 -> V_190 [ V_188 ] = V_193 ;
return 0 ;
}
int
F_59 ( struct V_123 * V_124 )
{
struct V_79 * V_80 = V_79 ( V_124 ) ;
struct V_125 * V_9 = V_124 -> V_2 . V_9 ;
struct V_194 * V_184 ;
const T_4 V_195 = 600 * 1024 ;
int V_8 ;
V_8 = F_37 ( V_9 , 0x1000 , 0 , true , NULL , & V_80 -> V_178 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_37 ( V_9 , 0x8000 , 0 , true , NULL , & V_80 -> V_196 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_60 ( V_9 , 0 , V_195 , 0 , NULL , & V_184 ) ;
if ( V_8 )
return V_8 ;
F_61 ( & V_184 -> V_197 [ V_198 ] ) ;
V_8 = F_62 ( V_184 , & V_80 -> V_184 , V_80 -> V_196 ) ;
F_62 ( NULL , & V_184 , NULL ) ;
if ( V_8 )
return V_8 ;
F_31 ( V_80 -> V_178 ) ;
F_33 ( V_80 -> V_178 , 0x200 , F_18 ( V_80 -> V_196 -> V_130 ) ) ;
F_33 ( V_80 -> V_178 , 0x204 , F_19 ( V_80 -> V_196 -> V_130 ) ) ;
F_33 ( V_80 -> V_178 , 0x208 , F_18 ( V_195 - 1 ) ) ;
F_33 ( V_80 -> V_178 , 0x20c , F_19 ( V_195 - 1 ) ) ;
F_34 ( V_80 -> V_178 ) ;
return 0 ;
}
int
F_63 ( struct V_123 * V_124 , bool V_199 )
{
struct V_79 * V_80 = V_79 ( V_124 ) ;
int V_8 = 0 ;
int V_170 ;
...
V_8 = F_52 ( V_80 , V_80 -> V_159 ,
& V_80 -> V_160 ) ;
for ( V_170 = 0 ; V_170 < V_200 ; V_170 ++ )
V_80 -> V_190 [ V_170 ] = V_191 ;
return V_8 ;
}
void *
F_64 ( struct V_123 * V_124 )
{
struct V_79 * V_80 = V_79 ( V_124 ) ;
F_65 ( & V_80 -> V_159 ) ;
F_13 ( V_80 -> V_156 ) ;
F_65 ( & V_80 -> V_157 ) ;
F_65 ( & V_80 -> V_129 ) ;
F_62 ( NULL , & V_80 -> V_184 , V_80 -> V_196 ) ;
F_65 ( & V_80 -> V_196 ) ;
F_65 ( & V_80 -> V_178 ) ;
return V_80 ;
}
static void
F_66 ( const struct V_66 * V_18 , void * V_8 )
{
...
struct V_154 * V_18 )
{
V_18 -> V_201 = V_80 -> V_129 -> V_130 ;
V_18 -> V_202 = V_80 -> V_129 -> V_10 ;
V_18 -> V_203 = 0 ;
V_18 -> V_204 = 1 ;
V_18 -> V_205 . V_206 = 1 ;
V_18 -> V_205 . V_207 [ 0 ] . V_208 = 1 ;
V_18 -> V_205 . V_207 [ 0 ] . V_209 = V_80 -> V_65 >> 8 ;
V_18 -> V_205 . V_207 [ 0 ] . V_210 =
( V_80 -> V_65 + V_80 -> V_116 ) >> 8 ;
}
int
F_68 ( struct V_125 * V_9 , int V_211 ,
struct V_123 * * V_212 )
{
int V_8 ;
struct V_79 * V_80 ;
...
* V_212 = & V_80 -> V_87 ;
V_8 = F_69 ( & V_79 , V_9 , V_211 , & V_80 -> V_87 ) ;
if ( V_8 )
return V_8 ;
V_80 -> V_89 = & V_213 ;
return 0 ;
