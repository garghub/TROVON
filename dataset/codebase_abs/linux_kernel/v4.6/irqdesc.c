...
if ( V_5 -> V_75 )
return - V_56 ;
V_5 -> V_75 = F_91 ( sizeof( * V_5 -> V_75 ) , V_34 ) ;
if ( ! V_5 -> V_75 )
return - V_10 ;
F_92 ( V_12 ) ;
return 0 ;
}
void F_93 ( unsigned int V_12 )
{
F_94 ( F_25 ( V_12 ) ) ;
}
unsigned int F_95 ( unsigned int V_12 , int V_15 )
{
struct V_4 * V_5 = F_25 ( V_12 ) ;
return V_5 && V_5 -> V_31 ?
* F_22 ( V_5 -> V_31 , V_15 ) : 0 ;
...
return 0 ;
F_21 (cpu)
V_76 += * F_22 ( V_5 -> V_31 , V_15 ) ;
return V_76 ;
}
unsigned int F_96 ( unsigned int V_12 )
{
unsigned int V_76 ;
F_30 () ;
V_76 = V_31 ( V_12 ) ;
