...
struct V_1 * V_5 = F_52 ( V_122 ) ;
int V_43 , V_83 ;
for ( V_43 = 0 ; V_43 < F_55 ( V_124 ) ; V_43 ++ ) {
V_83 = F_56 ( V_122 , V_124 [ V_43 ] . V_105 ) ;
F_57 ( V_83 , V_5 ) ;
}
F_58 ( V_5 -> V_81 ) ;
F_59 () ;
...
T_1 V_100 ;
V_5 = F_62 ( & V_122 -> V_19 , sizeof( * V_5 ) , V_133 ) ;
if ( ! V_5 ) {
...
V_5 -> V_10 = V_129 ;
if ( V_126 ) {
V_23 = F_63 ( & V_122 -> V_19 , V_126 , V_5 -> V_10 ) ;
if ( V_23 ) {
F_7 ( & V_122 -> V_19 , L_40 ) ;
return V_23 ;
}
...
for ( V_43 = 0 ; V_43 < F_55 ( V_124 ) ; V_43 ++ ) {
V_83 = F_56 ( V_122 , V_124 [ V_43 ] . V_105 ) ;
V_23 = F_71 ( V_83 , NULL , V_124 [ V_43 ] . V_148 ,
V_149 | V_150 ,
