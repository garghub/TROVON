...
int V_51 = 0 ;
unsigned int V_52 ;
V_51 |= F_17 ( & V_50 -> V_53 , V_54 ) ;
V_51 |= F_17 ( & V_50 -> V_55 , V_56 ) ;
V_51 |= F_17 ( & V_50 -> V_57 , V_58 ) ;
V_51 |= F_17 ( & V_50 -> V_59 , V_60 ) ;
V_51 |= F_17 ( & V_50 -> V_61 , V_60 | V_62 ) ;
if ( V_51 )
return 1 ;
V_51 |= F_18 ( V_50 -> V_61 ) ;
if ( V_51 )
return 2 ;
V_51 |= F_19 ( & V_50 -> V_63 , 0 ) ;
V_51 |= F_19 ( & V_50 -> V_64 , 0 ) ;
V_51 |= F_20 ( & V_50 -> V_65 ,
V_33 -> V_66 ) ;
V_51 |= F_19 ( & V_50 -> V_67 ,
V_50 -> V_68 ) ;
if ( V_50 -> V_61 == V_60 )
V_51 |= F_20 ( & V_50 -> V_69 , 1 ) ;
else
V_51 |= F_19 ( & V_50 -> V_69 , 0 ) ;
if ( V_51 )
return 3 ;
V_52 = V_50 -> V_65 ;
V_51 |= F_14 ( V_4 , & V_52 , V_50 -> V_31 ) ;
V_51 |= F_19 ( & V_50 -> V_65 , V_52 ) ;
if ( V_51 )
return 4 ;
return 0 ;
}
...
unsigned int * V_26 )
{
V_6 -> V_73 = F_26 ( V_4 -> V_72 + 48 ) & 0xf ;
if ( F_28 ( V_6 , V_26 ) )
F_29 ( V_6 -> V_73 , V_4 -> V_72 + 48 ) ;
V_26 [ 1 ] = V_6 -> V_73 ;
return V_24 -> V_29 ;
}
...
V_27 = F_31 ( V_4 , V_6 , V_24 , V_26 , V_74 ) ;
if ( V_27 )
return V_27 ;
F_29 ( ( V_6 -> V_76 >> 24 ) & 0xff , V_4 -> V_72 + 224 ) ;
return V_24 -> V_29 ;
}
...
if ( V_74 ) {
if ( V_74 & 0xff )
F_29 ( V_6 -> V_73 & 0xff , V_4 -> V_72 + 80 ) ;
if ( V_74 & 0xff0000 )
F_29 ( ( V_6 -> V_73 >> 16 ) & 0xff , V_4 -> V_72 + 112 ) ;
}
V_9 = F_26 ( V_4 -> V_72 + 80 ) ;
V_9 |= ( F_26 ( V_4 -> V_72 + 64 ) << 8 ) ;
if ( V_6 -> V_76 & 0xff0000 )
V_9 |= ( F_26 ( V_4 -> V_72 + 112 ) << 16 ) ;
else
V_9 |= ( F_26 ( V_4 -> V_72 + 96 ) << 16 ) ;
V_26 [ 1 ] = V_9 ;
return V_24 -> V_29 ;
}
...
V_4 -> V_34 = V_33 ;
V_4 -> V_83 = V_33 -> V_84 ;
V_36 = F_39 ( V_4 , sizeof( * V_36 ) ) ;
if ( ! V_36 )
return - V_85 ;
V_27 = F_40 ( V_4 ) ;
if ( V_27 )
return V_27 ;
V_4 -> V_72 = F_41 ( V_78 , 2 ) ;
V_4 -> V_10 = F_42 ( V_78 , 3 ) ;
if ( V_78 -> V_1 > 0 ) {
V_27 = F_43 ( V_78 -> V_1 , F_1 ,
V_86 , V_4 -> V_83 , V_4 ) ;
if ( V_27 == 0 )
V_4 -> V_1 = V_78 -> V_1 ;
}
...
static int F_48 ( struct V_77 * V_4 ,
const struct V_120 * V_121 )
{
return F_49 ( V_4 , & V_122 , V_121 -> V_123 ) ;
}
