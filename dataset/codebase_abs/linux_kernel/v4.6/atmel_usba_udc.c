...
while ( ( V_288 = F_151 ( V_284 , V_288 ) ) ) {
V_4 = & V_289 [ V_38 ] ;
V_40 = F_153 ( V_288 , L_68 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_69 , V_40 ) ;
goto V_277;
}
V_4 -> V_119 = V_73 ;
V_40 = F_153 ( V_288 , L_70 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_71 , V_40 ) ;
goto V_277;
}
V_4 -> V_122 = V_73 ;
V_40 = F_153 ( V_288 , L_72 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_73 , V_40 ) ;
goto V_277;
}
V_4 -> V_138 = V_73 ;
V_4 -> V_53 = F_154 ( V_288 , L_74 ) ;
V_4 -> V_136 = F_154 ( V_288 , L_75 ) ;
V_40 = F_155 ( V_288 , L_76 , & V_46 ) ;
if ( V_40 ) {
...
if ( V_246 < 0 )
return V_246 ;
V_268 = F_164 ( & V_60 -> V_61 , L_79 ) ;
if ( F_34 ( V_268 ) )
return F_165 ( V_268 ) ;
V_269 = F_164 ( & V_60 -> V_61 , L_80 ) ;
if ( F_34 ( V_269 ) )
return F_165 ( V_269 ) ;
F_166 ( & V_13 -> V_14 ) ;
F_167 ( & V_13 -> V_273 ) ;
...
V_13 -> V_246 = V_246 ;
if ( F_44 ( V_13 -> V_75 ) ) {
if ( ! F_171 ( & V_60 -> V_61 , V_13 -> V_75 , L_86 ) ) {
