...
int V_40 )
{
unsigned int V_42 , V_41 ;
V_42 = F_37 ( V_38 , V_46 ) | V_40 ;
if ( F_40 ( V_4 , V_42 , & V_41 ) < 0 )
return - 1 ;
return V_41 ;
}
...
int F_62 ( struct V_3 * V_4 , bool V_87 )
{
if ( ! V_4 -> V_88 )
return 0 ;
...
unsigned int F_63 ( unsigned int V_95 ,
unsigned int V_96 ,
unsigned int V_97 ,
unsigned int V_98 ,
unsigned short V_99 )
...
static unsigned int F_65 ( struct V_3 * V_4 , T_1 V_38 )
{
unsigned int V_41 = 0 ;
if ( V_38 != V_4 -> V_25 &&
( F_46 ( V_4 , V_38 ) & V_111 ) )
...
static unsigned int F_66 ( struct V_3 * V_4 , T_1 V_38 )
{
...
int F_67 ( struct V_3 * V_4 , T_1 V_38 ,
...
bool F_68 ( struct V_3 * V_4 , T_1 V_38 ,
unsigned int V_97 )
{
int V_52 ;
...
static unsigned int F_69 ( struct V_3 * V_136 , T_1 V_38 ,
...
static int F_70 ( struct V_3 * V_136 , T_1 V_38 ,
int V_43 , unsigned int V_39 , unsigned int V_40 )
{
unsigned int V_42 = F_33 ( V_136 , V_38 , V_39 , V_40 ) ;
return F_34 ( V_136 , V_42 , V_43 , NULL ) ;
}
int F_71 ( struct V_3 * V_136 , T_1 V_38 ,
int V_43 , unsigned int V_39 , unsigned int V_40 )
{
return F_69 ( V_136 , V_38 , V_43 , V_39 , V_40 ) ;
}
int F_72 ( struct V_3 * V_136 , T_1 V_38 ,
int V_43 , unsigned int V_39 , unsigned int V_40 )
{
return F_70 ( V_136 , V_38 , V_43 , V_39 , V_40 ) ;
}
bool F_73 ( struct V_3 * V_136 ,
T_1 V_38 , unsigned int V_137 )
{
unsigned int V_138 = F_69 ( V_136 , V_38 , 0 ,
V_139 , 0 ) ;
if ( V_138 & V_140 )
return true ;
V_138 = ( V_138 >> 4 ) & 0x0f ;
