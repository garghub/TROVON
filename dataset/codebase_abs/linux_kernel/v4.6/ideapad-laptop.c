...
unsigned long V_99 )
{
F_54 ( V_25 -> V_90 , V_99 , 1 , true ) ;
}
static void F_55 ( struct V_24 * V_25 )
{
unsigned long V_100 ;
if ( F_7 ( V_25 -> V_28 -> V_1 , V_101 , & V_100 ) )
return;
if ( V_100 )
F_53 ( V_25 , 17 ) ;
else
...
{
struct V_24 * V_25 = F_59 ( V_105 ) ;
unsigned long V_106 ;
if ( ! V_25 )
return - V_27 ;
if ( F_7 ( V_25 -> V_28 -> V_1 , V_30 , & V_106 ) )
return - V_61 ;
return V_106 ;
}
...
if ( ! V_25 )
return - V_27 ;
if ( F_11 ( V_25 -> V_28 -> V_1 , V_107 ,
V_105 -> V_108 . V_109 ) )
return - V_61 ;
if ( F_11 ( V_25 -> V_28 -> V_1 , V_110 ,
...
if ( F_7 ( V_25 -> V_28 -> V_1 , V_29 , & V_114 ) )
return - V_61 ;
if ( F_7 ( V_25 -> V_28 -> V_1 , V_30 , & V_106 ) )
return - V_61 ;
if ( F_7 ( V_25 -> V_28 -> V_1 , V_31 , & V_111 ) )
return - V_61 ;
...
unsigned long V_106 ;
if ( V_25 -> V_105 == NULL ) {
F_7 ( V_25 -> V_28 -> V_1 , V_30 , & V_106 ) ;
return;
}
F_70 ( V_25 -> V_105 , V_119 ) ;
}
...
static void F_74 ( T_6 V_15 , void * V_129 )
{
switch ( V_15 ) {
case 128 :
F_53 ( V_129 , V_15 ) ;
...
static int F_75 ( struct V_86 * V_130 )
{
int V_7 , V_77 ;
int V_41 ;
struct V_24 * V_25 ;
struct V_131 * V_28 ;
V_7 = F_76 ( F_77 ( & V_130 -> V_55 ) , & V_28 ) ;
if ( V_7 )
return - V_132 ;
if ( F_1 ( V_28 -> V_1 , L_47 , & V_41 ) )
return - V_132 ;
V_25 = F_78 ( & V_130 -> V_55 , sizeof( * V_25 ) , V_133 ) ;
if ( ! V_25 )
return - V_53 ;
F_79 ( & V_130 -> V_55 , V_25 ) ;
V_25 -> V_41 = V_41 ;
V_25 -> V_28 = V_28 ;
V_25 -> V_86 = V_130 ;
V_25 -> V_78 = ! F_80 ( V_134 ) ;
V_7 = F_41 ( V_25 ) ;
if ( V_7 )
return V_7 ;
V_7 = F_19 ( V_25 ) ;
...
goto V_136;
if ( ! V_25 -> V_78 )
F_11 ( V_25 -> V_28 -> V_1 , V_137 , 1 ) ;
for ( V_77 = 0 ; V_77 < V_79 ; V_77 ++ )
if ( F_17 ( V_75 [ V_77 ] . V_138 , & V_25 -> V_41 ) )
F_34 ( V_25 , V_77 ) ;
F_32 ( V_25 ) ;
F_71 ( V_25 ) ;
if ( F_81 () == V_139 ) {
...
static int F_86 ( struct V_86 * V_130 )
{
struct V_24 * V_25 = F_25 ( & V_130 -> V_55 ) ;
int V_77 ;
#if F_83 ( V_143 )
F_87 ( V_144 ) ;
#endif
