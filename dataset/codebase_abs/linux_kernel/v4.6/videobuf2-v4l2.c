...
unsigned int F_43 ( struct V_20 * V_21 , struct V_118 * V_118 , T_1 * V_119 )
{
struct V_120 * V_121 = F_44 ( V_118 ) ;
unsigned long V_122 = F_45 ( V_119 ) ;
unsigned int V_123 = 0 ;
if ( F_46 ( V_124 , & V_121 -> V_25 ) ) {
struct V_125 * V_126 = V_118 -> V_127 ;
if ( F_47 ( V_126 ) )
V_123 = V_128 ;
else if ( V_122 & V_128 )
F_48 ( V_118 , & V_126 -> V_119 , V_119 ) ;
}
return V_123 | F_49 ( V_21 , V_118 , V_119 ) ;
}
static inline bool F_50 ( struct V_120 * V_129 , struct V_118 * V_118 )
{
...
struct V_71 * V_133 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
int V_123 = F_20 ( V_129 -> V_130 , V_133 -> V_13 , V_133 -> type ) ;
if ( V_123 )
return V_123 ;
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
V_123 = F_21 ( V_129 -> V_130 , V_133 -> V_13 , & V_133 -> V_73 ) ;
if ( V_123 == 0 )
...
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
int V_123 = F_20 ( V_129 -> V_130 , V_133 -> V_13 ,
V_133 -> V_82 . type ) ;
...
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
V_123 = F_25 ( V_129 -> V_130 , V_133 ) ;
if ( V_123 == 0 )
V_129 -> V_130 -> V_131 = V_118 -> V_127 ;
return V_123 ;
}
int F_53 ( struct V_118 * V_118 , void * V_132 ,
struct V_3 * V_133 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
return F_22 ( V_129 -> V_130 , V_133 ) ;
}
int F_54 ( struct V_118 * V_118 , void * V_132 , struct V_3 * V_133 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
return F_17 ( V_129 -> V_130 , V_133 ) ;
}
...
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
return F_29 ( V_129 -> V_130 , V_133 ) ;
}
int F_56 ( struct V_118 * V_118 , void * V_132 , struct V_3 * V_133 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
return F_32 ( V_129 -> V_130 , V_133 , V_118 -> V_134 & V_135 ) ;
}
...
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
return F_33 ( V_129 -> V_130 , V_83 ) ;
}
int F_58 ( struct V_118 * V_118 , void * V_132 , enum V_106 V_83 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
return F_35 ( V_129 -> V_130 , V_83 ) ;
}
int F_59 ( struct V_118 * V_118 , void * V_132 , struct V_107 * V_133 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
if ( F_50 ( V_129 , V_118 ) )
return - V_74 ;
return F_37 ( V_129 -> V_130 , V_133 ) ;
}
int F_60 ( struct V_118 * V_118 , struct V_136 * V_137 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
return F_61 ( V_129 -> V_130 , V_137 ) ;
}
int F_62 ( struct V_118 * V_118 , struct V_138 * V_139 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
if ( V_139 )
F_63 ( V_139 ) ;
...
int F_66 ( struct V_118 * V_118 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
struct V_138 * V_139 = V_129 -> V_130 -> V_139 ? V_129 -> V_130 -> V_139 : V_129 -> V_139 ;
return F_62 ( V_118 , V_139 ) ;
}
T_2 F_67 ( struct V_118 * V_118 , const char T_3 * V_140 ,
T_4 V_73 , T_5 * V_141 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
struct V_138 * V_139 = V_129 -> V_130 -> V_139 ? V_129 -> V_130 -> V_139 : V_129 -> V_139 ;
...
if ( F_50 ( V_129 , V_118 ) )
goto exit;
V_142 = F_69 ( V_129 -> V_130 , V_140 , V_73 , V_141 ,
V_118 -> V_134 & V_135 ) ;
...
T_2 F_70 ( struct V_118 * V_118 , char T_3 * V_140 ,
T_4 V_73 , T_5 * V_141 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
struct V_138 * V_139 = V_129 -> V_130 -> V_139 ? V_129 -> V_130 -> V_139 : V_129 -> V_139 ;
...
if ( F_50 ( V_129 , V_118 ) )
goto exit;
V_142 = F_71 ( V_129 -> V_130 , V_140 , V_73 , V_141 ,
V_118 -> V_134 & V_135 ) ;
if ( V_129 -> V_130 -> V_146 )
V_129 -> V_130 -> V_131 = V_118 -> V_127 ;
exit:
...
unsigned int F_72 ( struct V_118 * V_118 , T_1 * V_119 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
...
return V_148 ;
V_146 = V_21 -> V_146 ;
V_123 = F_43 ( V_129 -> V_130 , V_118 , V_119 ) ;
if ( ! V_146 && V_21 -> V_146 )
...
unsigned long F_73 ( struct V_118 * V_118 , unsigned long V_149 ,
unsigned long V_150 , unsigned long V_151 , unsigned long V_25 )
{
struct V_120 * V_129 = F_44 ( V_118 ) ;
return F_74 ( V_129 -> V_130 , V_149 , V_150 , V_151 , V_25 ) ;
}
void F_75 ( struct V_20 * V_152 )
{
F_64 ( V_152 -> V_139 ) ;
}
void F_76 ( struct V_20 * V_152 )
{
F_63 ( V_152 -> V_139 ) ;
}
