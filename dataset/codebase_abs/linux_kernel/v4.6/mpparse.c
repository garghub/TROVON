...
static unsigned long T_1 F_33 ( unsigned long V_108 )
{
struct V_55 * V_56 ;
unsigned long V_66 ;
V_56 = F_34 ( V_108 , V_109 ) ;
V_66 = V_56 -> V_60 ;
F_35 ( V_56 , V_109 ) ;
F_7 ( V_20 , L_27 , V_108 , V_108 + V_66 ) ;
return V_66 ;
}
static int T_1 F_36 ( struct V_110 * V_111 , unsigned int V_70 )
{
struct V_55 * V_56 ;
unsigned long V_66 ;
V_66 = F_33 ( V_111 -> V_108 ) ;
V_56 = F_34 ( V_111 -> V_108 , V_66 ) ;
if ( ! F_24 ( V_56 , V_70 ) ) {
#ifdef F_37
V_112 = 0 ;
#endif
...
static void T_1 F_42 ( struct V_110 * V_111 )
{
F_43 ( V_111 -> V_108 , F_33 ( V_111 -> V_108 ) ) ;
}
static int T_1 F_44 ( unsigned long V_121 , unsigned long V_60 )
{
unsigned int * V_122 = F_45 ( V_121 ) ;
struct V_110 * V_111 ;
unsigned long V_123 ;
F_7 ( V_20 , L_36 ,
V_121 , V_121 + V_60 - 1 ) ;
F_46 ( sizeof( * V_111 ) != 16 ) ;
while ( V_60 > 0 ) {
V_111 = (struct V_110 * ) V_122 ;
if ( ( * V_122 == V_124 ) &&
( V_111 -> V_60 == 1 ) &&
! F_1 ( ( unsigned char * ) V_122 , 16 ) &&
( ( V_111 -> V_116 == 1 )
|| ( V_111 -> V_116 == 4 ) ) ) {
#ifdef F_37
V_112 = 1 ;
...
V_114 = V_111 ;
F_4 ( L_37 ,
( unsigned long long ) F_47 ( V_111 ) ,
( unsigned long long ) F_47 ( V_111 ) +
sizeof( * V_111 ) - 1 , V_111 ) ;
V_123 = F_47 ( V_111 ) ;
F_43 ( V_123 , sizeof( * V_111 ) ) ;
if ( V_111 -> V_108 )
F_42 ( V_111 ) ;
return 1 ;
}
...
if ( V_126 [ V_85 ] . V_45 != V_87 )
continue;
if ( V_126 [ V_85 ] . V_46 != 0x0f )
continue;
if ( V_126 [ V_85 ] . V_47 != V_5 -> V_47 )
continue;
if ( V_126 [ V_85 ] . V_48 != V_5 -> V_48 )
continue;
if ( V_127 [ V_85 ] ) {
return - 2 ;
}
...
static void T_1 F_51 ( struct V_43 * V_5 , int * V_128 )
{
int V_85 ;
F_7 ( V_20 , L_38 ) ;
F_15 ( V_5 ) ;
V_85 = F_50 ( V_5 ) ;
if ( V_85 > 0 ) {
memcpy ( V_5 , & V_126 [ V_85 ] , sizeof( * V_5 ) ) ;
F_7 ( V_20 , L_39 ) ;
F_15 ( & V_126 [ V_85 ] ) ;
return;
}
...
static int T_1
F_52 ( unsigned long V_131 , unsigned long V_132 , int V_65 )
{
if ( ! V_131 || V_65 <= V_132 ) {
F_53 ( 1 , L_40 , V_65 ) ;
return - 1 ;
...
static
inline void T_1 F_51 ( struct V_43 * V_5 , int * V_128 ) {}
...
F_7 ( V_20 , L_42 ) ;
V_128 -- ;
memcpy ( V_130 [ V_128 ] , & V_126 [ V_85 ] , sizeof( V_126 [ V_85 ] ) ) ;
V_130 [ V_128 ] = NULL ;
} else {
struct V_43 * V_5 = (struct V_43 * ) V_67 ;
V_65 += sizeof( struct V_43 ) ;
if ( F_52 ( V_131 , V_132 , V_65 ) < 0 )
goto V_133;
memcpy ( V_5 , & V_126 [ V_85 ] , sizeof( * V_5 ) ) ;
V_56 -> V_60 = V_65 ;
...
V_133:
V_56 -> V_134 = 0 ;
V_56 -> V_134 -= F_1 ( ( unsigned char * ) V_56 , V_56 -> V_60 ) ;
return 0 ;
}
...
static int T_1 F_57 ( char * V_137 )
{
V_135 = 1 ;
#ifdef F_56
V_136 = 1 ;
...
if ( ! V_111 -> V_108 )
return 0 ;
V_56 = F_45 ( V_111 -> V_108 ) ;
if ( ! F_17 ( V_56 , V_57 , V_18 ) )
return 0 ;
F_4 ( L_43 , ( V_140 ) F_47 ( V_111 ) ) ;
F_4 ( L_44 , V_111 -> V_108 ) ;
if ( V_131 && V_56 -> V_60 > V_132 ) {
V_131 = 0 ;
F_4 ( L_45 ,
V_132 ) ;
}
...
V_56 -> V_134 = 0xff ;
V_142 = F_1 ( ( unsigned char * ) V_56 , V_56 -> V_60 ) ;
if ( V_141 == V_142 ) {
F_4 ( L_46 ) ;
return 0 ;
}
...
F_4 ( L_49 , V_111 -> V_108 ) ;
}
F_54 ( V_56 , V_131 , V_132 ) ;
return 0 ;
}
