...
if ( ! V_31 )
return false ;
V_50 = F_17 ( V_5 , F_18 ( V_5 ) , sizeof( struct V_49 ) , & V_51 ) ;
if ( ! V_50 )
return false ;
if ( ! V_50 -> V_64 )
return false ;
V_58 = F_19 ( V_34 -> V_65 ) ;
V_27 = F_19 ( V_34 -> V_66 ) & V_67 ;
V_57 = F_19 ( V_50 -> V_57 ) ;
if ( V_50 -> V_68 * 4 > sizeof( struct V_49 ) ) {
V_55 = V_50 -> V_68 * 4 - sizeof( struct V_49 ) ;
V_61 = V_60 = F_17 ( V_5 , F_18 ( V_5 ) +
...
V_54 ++ ;
if ( V_31 -> V_35 & V_71 )
F_24 ( V_1 , V_47 -> V_94 , V_47 -> V_95 , V_5 ,
V_47 -> V_96 , V_47 -> V_97 , NULL ,
L_1 ,
V_11 -> V_72 , V_11 -> V_98 , V_11 -> V_99 ,
& V_34 -> V_44 , F_19 ( V_50 -> V_100 ) ,
& V_34 -> V_101 , F_19 ( V_50 -> V_102 ) ,
V_11 -> V_37 - V_34 -> V_37 ) ;
if ( ( V_31 -> V_35 & V_71 ) &&
V_31 -> V_103 == V_104 )
break;
...
F_24 ( V_1 , V_47 -> V_94 , V_47 -> V_95 , V_5 , V_47 -> V_96 ,
V_47 -> V_97 , NULL ,
L_2 ,
& V_34 -> V_44 , F_19 ( V_50 -> V_100 ) ,
& V_34 -> V_101 , F_19 ( V_50 -> V_102 ) ) ;
...
int V_15 = - V_17 ;
int V_105 ;
for ( V_105 = 0 ; V_105 < F_27 ( V_26 ) ; ++ V_105 )
F_28 ( & V_26 [ V_105 ] ) ;
V_15 = F_29 ( & V_106 ) ;
if ( V_15 < 0 ) {
F_30 ( L_3 , V_15 ) ;
