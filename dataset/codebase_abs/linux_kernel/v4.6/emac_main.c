...
unsigned int V_31 ;
for ( V_31 = 0 ; V_31 < V_4 ; V_31 ++ ) {
struct V_32 * V_33 = & V_2 -> V_33 [ V_31 ] ;
struct V_34 * V_35 = & V_2 -> V_35 [ V_31 ] ;
if ( V_35 -> V_37 ) {
F_18 ( & V_7 -> V_53 ,
F_19 ( V_35 , V_54 ) ,
F_20 ( V_35 , V_52 ) ,
...
unsigned int V_31 ;
for ( V_31 = 0 ; V_31 < V_63 ; V_31 ++ ) {
struct V_32 * V_60 = & V_2 -> V_60 [ V_31 ] ;
struct V_34 * V_59 = & V_2 -> V_59 [ V_31 ] ;
if ( V_59 -> V_37 ) {
F_18 ( & V_7 -> V_53 ,
F_19 ( V_59 , V_54 ) ,
F_20 ( V_59 , V_52 ) ,
...
static struct V_29 * F_61 ( struct V_6 * V_7 )
{
struct V_1 * V_2 = F_3 ( V_7 ) ;
struct V_29 * V_30 = & V_7 -> V_30 ;
...
static int F_62 ( struct V_36 * V_37 , struct V_6 * V_7 )
{
struct V_1 * V_2 = F_3 ( V_7 ) ;
...
if ( F_63 ( V_37 , V_124 ) )
return V_125 ;
V_52 = F_64 (unsigned int, ETH_ZLEN, skb->len) ;
if ( F_16 ( ! F_1 ( V_2 ) ) ) {
F_60 ( V_7 ) ;
F_27 ( V_7 , L_3 ) ;
return V_126 ;
...
V_129 = F_67 ( * ( V_131 * ) & V_7 -> V_130 [ 4 ] ) ;
F_5 ( V_2 , V_132 , V_128 ) ;
F_5 ( V_2 , V_133 , V_129 ) ;
}
static int F_68 ( struct V_6 * V_7 , void * V_134 )
{
...
int F_71 ( struct V_6 * V_7 , int V_140 )
{
...
int V_150 ;
V_146 = F_72 ( V_53 -> V_151 , L_4 , 0 ) ;
if ( ! V_146 ) {
F_73 ( V_53 , L_5 ) ;
return - V_152 ;
}
V_150 = F_74 ( V_53 -> V_151 , 0 , & V_144 ) ;
if ( V_150 ) {
F_73 ( V_53 , L_6 ) ;
return - V_152 ;
}
V_78 = F_75 ( V_53 -> V_151 , 0 ) ;
if ( ! V_78 ) {
F_73 ( V_53 , L_7 ) ;
return - V_152 ;
}
...
V_2 = F_3 ( V_7 ) ;
V_2 -> V_53 = V_53 ;
V_2 -> V_160 = F_76 ( V_53 , & V_144 ) ;
if ( F_77 ( V_2 -> V_160 ) )
return F_78 ( V_2 -> V_160 ) ;
F_79 ( V_53 , L_8 , V_2 -> V_160 ) ;
if ( V_2 -> V_161 ) {
V_150 = F_80 ( V_2 -> V_161 ) ;
if ( V_150 ) {
F_73 ( V_53 , L_9 ) ;
return V_150 ;
}
V_149 = F_81 ( V_2 -> V_161 ) ;
} else {
if ( F_82 ( V_53 -> V_151 , L_10 ,
& V_149 ) ) {
F_73 ( V_53 , L_11 ) ;
return - V_162 ;
}
...
F_73 ( V_53 , L_12 , V_148 ) ;
V_150 = - V_152 ;
goto V_164;
}
F_83 ( V_53 , L_13 , V_148 ) ;
F_5 ( V_2 , V_165 , V_149 / 1000000 ) ;
V_7 -> V_78 = V_78 ;
F_83 ( V_53 , L_14 , V_7 -> V_78 ) ;
V_150 = F_84 ( V_53 , V_7 -> V_78 , F_42 , 0 ,
V_7 -> V_166 , V_7 ) ;
if ( V_150 ) {
F_73 ( V_53 , L_15 ) ;
goto V_164;
}
V_147 = F_85 ( V_53 -> V_151 ) ;
if ( V_147 )
memcpy ( V_7 -> V_130 , V_147 , V_116 ) ;
else
F_86 ( V_7 ) ;
F_66 ( V_7 ) ;
F_83 ( V_53 , L_16 , V_7 -> V_130 ) ;
V_2 -> V_60 = F_87 ( V_53 , V_167 + V_98 ,
& V_2 -> V_102 , V_168 ) ;
if ( ! V_2 -> V_60 ) {
F_73 ( V_53 , L_17 ) ;
V_150 = - V_97 ;
