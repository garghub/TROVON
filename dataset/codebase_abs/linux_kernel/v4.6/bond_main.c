...
if ( F_34 ( V_11 ) && V_11 -> V_52 . V_241 [ 0 ] ) {
...
V_15 -> V_59 ) ;
V_250 = F_159 ( V_11 -> V_69 ) ;
F_170 ( V_11 -> V_254 , NULL ) ;
...
struct V_22 * V_22 ;
bool V_261 ;
V_261 = ! F_67 ( V_11 -> V_69 ) ;
F_89 (bond, slave, iter) {
V_22 -> V_262 = V_263 ;
V_259 = F_28 ( V_11 , V_22 -> V_16 , 0 ) ;
switch ( V_22 -> V_29 ) {
case V_30 :
if ( V_259 )
continue;
...
struct V_14 * V_15 )
{
struct V_22 * V_22 = F_244 ( V_15 ) , * V_241 ;
struct V_10 * V_11 ;
struct V_14 * V_19 ;
if ( ! V_22 )
return V_325 ;
...
struct V_22 * V_22 ;
F_272 ( & V_11 -> V_384 ) ;
memcpy ( V_382 , & V_11 -> V_253 , sizeof( * V_382 ) ) ;
F_66 () ;
F_89 (bond, slave, iter) {
...
F_68 () ;
memcpy ( & V_11 -> V_253 , V_382 , sizeof( * V_382 ) ) ;
F_273 ( & V_11 -> V_384 ) ;
return V_382 ;
}
...
static void F_290 ( struct V_10 * V_11 , struct V_12 * V_13 , int V_258 )
{
struct V_24 * V_25 ;
struct V_22 * V_22 ;
int V_212 = V_258 ;
