...
T_11 * V_81 =
F_28 ( V_41 , V_17 ) ;
int V_29 = F_21 ( V_81 -> V_29 ) ;
if ( V_7 -> V_82 ) {
T_12 args ;
memset ( ( char * ) & args , 0 , sizeof( args ) ) ;
args . V_83 = V_7 -> V_13 -> V_34 -> V_64 ;
args . V_13 = V_7 -> V_13 ;
args . V_84 = V_54 ;
args . V_29 = V_29 ;
args . V_85 = V_29 ;
args . V_86 = F_7 ( V_29 , V_31 | V_32 ) ;
args . V_87 = F_21 ( V_81 -> V_88 ) ;
args . V_89 = F_29 (
args . V_13 -> V_34 , V_29 ) ;
V_75 = F_30 ( & args ) ;
if ( ! V_75 )
...
if ( ! F_38 ( V_13 ) ) {
error = 0 ;
} else if ( V_13 -> V_93 . V_94 == V_95 ) {
error = F_2 ( V_7 ) ;
} else if ( F_39 ( V_13 , V_54 ) ) {
error = F_32 ( V_7 ) ;
} else {
error = F_13 ( V_7 ) ;
}
...
unsigned char * V_86 )
{
struct V_96 * V_97 = (struct V_96 * ) V_7 -> V_97 ;
T_14 * V_98 ;
int V_99 ;
ASSERT ( ! ( V_7 -> V_26 & V_100 ) ) ;
ASSERT ( V_7 -> V_16 >= 0 ) ;
ASSERT ( V_7 -> V_16 < ( V_101 / 8 ) ) ;
ASSERT ( V_7 -> V_102 >= sizeof( * V_97 ) ) ;
ASSERT ( V_7 -> V_102 <= V_7 -> V_22 ) ;
if ( ( ( V_7 -> V_26 & V_103 ) == 0 ) !=
( ( V_26 & V_104 ) == 0 ) )
return 0 ;
if ( ( ( V_7 -> V_26 & V_105 ) == 0 ) !=
...
V_98 = ( T_14 * ) & V_7 -> V_97 [ V_7 -> V_102 ] ;
V_98 -> V_109 = V_29 ;
memcpy ( V_98 -> V_110 , V_36 , V_28 ) ;
V_98 -> V_110 [ V_28 ] = 0 ;
V_97 -> V_107 [ V_7 -> V_16 ++ ] = V_7 -> V_102 ;
V_97 -> V_111 = V_7 -> V_16 ;
F_44 ( V_7 ) ;
return 0 ;
}
...
V_7 . V_102 = V_7 . V_22 ;
V_7 . V_25 = F_41 ;
V_97 = (struct V_96 * ) V_7 . V_97 ;
V_97 -> V_111 = 0 ;
V_97 -> V_108 = 0 ;
V_97 -> V_107 [ 0 ] = V_7 . V_22 ;
error = F_34 ( & V_7 ) ;
ASSERT ( error <= 0 ) ;
return error ;
}
