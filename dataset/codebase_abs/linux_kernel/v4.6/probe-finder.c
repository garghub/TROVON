...
F_122 ( V_187 . V_190 [ V_187 . V_191 ] . V_163 ) ;
}
F_12 ( V_190 ) ;
return V_36 ;
}
...
V_200 = F_127 ( V_2 -> V_8 , V_169 , & V_197 ) ;
if ( strcmp ( V_200 , L_73 ) == 0 ) {
V_198 = F_128 ( V_156 , V_197 ) ;
if ( ! V_198 )
return - V_10 ;
V_158 = F_129 ( V_198 , & V_199 ) ;
if ( ! V_158 )
return - V_10 ;
* V_21 = V_158 -> V_201 ;
}
...
bool V_211 = false ;
V_212:
if ( ! F_131 ( V_2 -> V_2 , ( T_2 ) V_25 , & V_203 ) ) {
if ( ! V_211 && F_124 ( V_2 , & V_207 ) == 0 ) {
V_25 += V_207 ;
V_211 = true ;
goto V_212;
}
...
static int F_136 ( const char * V_214 , unsigned int V_121 ,
struct V_215 * V_216 )
{
if ( ! V_216 -> V_3 ) {
...
return 0 ;
V_221 = F_136 ( V_119 , V_121 , V_220 -> V_216 ) ;
if ( V_221 < 0 && V_221 != - V_224 )
return V_221 ;
return 0 ;
}
static int F_138 ( T_1 * V_27 , struct V_219 * V_220 )
{
int V_36 ;
V_36 = F_70 ( V_27 ? : & V_220 -> V_90 , F_137 , V_220 ) ;
if ( V_36 >= 0 )
...
F_13 ( L_75 , V_220 -> V_119 , V_216 -> V_23 ) ;
...
if ( V_220 -> V_223 < 0 )
V_220 -> V_223 = V_120 ;
F_13 ( L_76 , V_220 -> V_222 , V_220 -> V_223 ) ;
...
F_87 ( & V_220 -> V_90 , F_140 , & V_139 , 0 ) ;
return V_139 . V_141 ;
}
int F_142 ( struct V_1 * V_2 , struct V_215 * V_216 )
{
...
return - V_51 ;
for (; ; ) {
sprintf ( * V_228 , L_78 , V_229 , V_227 ) ;
if ( F_143 ( * V_228 , V_232 ) == 0 )
return 0 ;
if ( ! V_230 . V_231 ) {
F_12 ( V_228 ) ;
return - V_130 ;
