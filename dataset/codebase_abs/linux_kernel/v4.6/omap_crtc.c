...
struct V_67 * V_68 )
{
struct V_69 * V_70 = V_18 -> V_71 ;
return V_68 == V_70 -> V_72 ||
V_68 == V_18 -> V_73 . V_74 ;
}
...
V_77 = F_61 ( V_44 -> V_44 , V_79 ) ;
if ( F_62 ( V_77 ) )
return F_63 ( V_77 ) ;
return F_64 ( V_79 , V_77 ,
V_68 , V_75 ) ;
}
return - V_13 ;
}
...
struct V_1 * F_71 ( struct V_17 * V_18 ,
struct V_78 * V_79 , enum V_7 V_4 , int V_14 )
{
struct V_1 * V_2 = NULL ;
struct V_3 * V_3 ;
int V_23 ;
F_25 ( L_4 , V_82 [ V_4 ] ) ;
V_3 = F_72 ( sizeof( * V_3 ) , V_83 ) ;
if ( ! V_3 )
return NULL ;
V_2 = & V_3 -> V_37 ;
F_73 ( & V_3 -> V_8 ) ;
V_3 -> V_4 = V_4 ;
V_3 -> V_28 = V_82 [ V_4 ] ;
V_3 -> V_51 . V_84 = F_1 ( V_2 ) ;
V_3 -> V_51 . V_47 = F_38 ;
V_3 -> V_49 . V_84 =
F_74 ( V_4 ) ;
V_3 -> V_49 . V_47 = F_35 ;
F_50 ( V_18 , & V_3 -> V_49 ) ;
V_23 = F_75 ( V_18 , V_2 , V_79 , NULL ,
& V_85 , NULL ) ;
if ( V_23 < 0 ) {
F_48 ( V_3 ) ;
return NULL ;
