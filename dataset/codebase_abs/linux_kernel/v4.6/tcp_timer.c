...
goto V_69;
if ( F_29 ( V_26 -> V_66 . V_38 , V_70 ) ) {
F_30 ( V_2 , & V_26 -> V_71 , V_26 -> V_66 . V_38 ) ;
goto V_69;
}
V_26 -> V_66 . V_67 &= ~ V_68 ;
if ( ! F_31 ( & V_10 -> V_72 . V_73 ) ) {
struct V_74 * V_75 ;
F_3 ( F_4 ( V_2 ) , V_76 ) ;
while ( ( V_75 = F_32 ( & V_10 -> V_72 . V_73 ) ) != NULL )
F_33 ( V_2 , V_75 ) ;
V_10 -> V_72 . V_77 = 0 ;
}
if ( F_34 ( V_2 ) ) {
...
static void F_38 ( unsigned long V_82 )
{
...
F_55 ( F_56 ( V_2 ) ) ;
V_10 -> V_102 = 0 ;
if ( ! V_10 -> V_17 && ! F_26 ( V_2 , V_62 ) &&
! ( ( 1 << V_2 -> V_48 ) & ( V_49 | V_50 ) ) ) {
struct V_103 * V_104 = F_57 ( V_2 ) ;
if ( V_2 -> V_105 == V_106 ) {
F_58 ( L_1 ,
& V_104 -> V_107 ,
F_59 ( V_104 -> V_108 ) ,
...
V_26 -> V_45 <= V_133 ) {
V_26 -> V_90 = 0 ;
V_26 -> V_63 = F_13 ( F_66 ( V_10 ) , V_15 ) ;
} else {
V_26 -> V_63 = F_13 ( V_26 -> V_63 << 1 , V_15 ) ;
}
F_52 ( V_2 , V_99 , V_26 -> V_63 , V_15 ) ;
...
goto V_69;
if ( F_29 ( V_26 -> V_136 , V_70 ) ) {
F_30 ( V_2 , & V_26 -> V_137 , V_26 -> V_136 ) ;
goto V_69;
}
V_134 = V_26 -> V_135 ;
switch ( V_134 ) {
...
static void F_70 ( unsigned long V_82 )
{
struct V_1 * V_2 = (struct V_1 * ) V_82 ;
F_39 ( V_2 ) ;
if ( ! F_40 ( V_2 ) ) {
...
if ( ! F_41 ( V_141 , & F_6 ( V_2 ) -> V_86 ) )
F_42 ( V_2 ) ;
}
F_43 ( V_2 ) ;
F_44 ( V_2 ) ;
}
void F_71 ( const struct V_93 * V_94 )
{
struct V_27 * V_27 = F_72 ( & F_73 ( V_94 ) -> V_142 ) ;
F_3 ( V_27 , V_128 ) ;
}
void F_74 ( struct V_1 * V_2 , int V_143 )
{
if ( ( 1 << V_2 -> V_48 ) & ( V_144 | V_145 ) )
return;
if ( V_143 && ! F_26 ( V_2 , V_146 ) )
F_75 ( V_2 , F_76 ( F_6 ( V_2 ) ) ) ;
else if ( ! V_143 )
F_77 ( V_2 ) ;
}
static void F_78 ( unsigned long V_82 )
{
struct V_1 * V_2 = (struct V_1 * ) V_82 ;
struct V_25 * V_26 = F_17 ( V_2 ) ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
...
if ( V_2 -> V_48 == V_150 && F_26 ( V_2 , V_62 ) ) {
if ( V_10 -> V_151 >= 0 ) {
const int V_152 = F_80 ( V_2 ) - V_16 ;
if ( V_152 > 0 ) {
F_81 ( V_2 , V_150 , V_152 ) ;
goto V_69;
}
}
F_8 ( V_2 , V_19 ) ;
...
if ( ! F_26 ( V_2 , V_146 ) || V_2 -> V_48 == V_65 )
goto V_69;
V_147 = F_76 ( V_10 ) ;
if ( V_10 -> V_18 || F_46 ( V_2 ) )
goto V_154;
