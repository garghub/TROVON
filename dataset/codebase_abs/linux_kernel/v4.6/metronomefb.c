...
memset ( & V_11 -> V_46 -> args [ V_5 ] , 0 ,
( F_8 ( V_11 -> V_46 -> args ) - V_5 ) * 2 ) ;
V_11 -> V_46 -> V_47 = V_43 ;
F_9 ( 1 ) ;
...
memset ( & V_11 -> V_46 -> args [ 4 ] , 0 ,
( F_8 ( V_11 -> V_46 -> args ) - 4 ) * 2 ) ;
...
static T_2 F_14 ( struct V_10 * V_11 , int V_63 )
{
int V_5 ;
T_2 V_47 = 0 ;
...
static void F_15 ( struct V_66 * V_27 ,
struct V_67 * V_68 )
{
T_2 V_16 ;
struct V_69 * V_70 ;
...
static void F_17 ( struct V_66 * V_27 ,
...
static void F_19 ( struct V_66 * V_27 ,
...
static void F_21 ( struct V_66 * V_27 ,
...
static T_4 F_23 ( struct V_66 * V_27 , const char T_5 * V_57 ,
T_3 V_82 , T_6 * V_83 )
{
struct V_10 * V_11 = V_27 -> V_11 ;
...
static int F_25 ( struct V_94 * V_26 )
{
struct V_66 * V_27 ;
struct V_95 * V_48 ;
int V_96 = - V_97 ;
...
if ( ! F_26 ( V_48 -> V_107 ) )
return - V_108 ;
V_27 = F_27 ( sizeof( struct V_10 ) , & V_26 -> V_26 ) ;
if ( ! V_27 )
goto V_86;
V_102 = V_48 -> V_109 () ;
switch ( V_102 ) {
...
V_96 = F_31 ( & V_101 , L_14 , & V_26 -> V_26 ) ;
if ( V_96 < 0 ) {
F_4 ( & V_26 -> V_26 , L_15 ) ;
goto V_125;
}
...
static int F_42 ( struct V_94 * V_26 )
{
struct V_66 * V_27 = F_43 ( V_26 ) ;
if ( V_27 ) {
struct V_10 * V_11 = V_27 -> V_11 ;
F_44 ( V_27 ) ;
F_45 ( V_27 ) ;
...
F_39 ( V_11 -> V_75 ) ;
F_39 ( ( void V_58 * ) V_27 -> V_59 ) ;
F_41 ( V_11 -> V_48 -> V_107 ) ;
F_37 ( & V_26 -> V_26 , L_20 ) ;
F_40 ( V_27 ) ;
}
return 0 ;
