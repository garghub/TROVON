...
static void F_74 ( struct V_1 * V_32 )
{
V_32 -> V_49 -> V_84 [ V_91 ] . V_92 = & V_32 -> V_93 [ 1 ] ;
V_32 -> V_49 -> V_84 [ V_94 ] . V_92 = & V_32 -> V_93 [ 2 ] ;
}
static void F_75 ( struct V_1 * V_32 )
{
V_32 -> V_49 -> V_84 [ V_91 ] . V_92 = NULL ;
V_32 -> V_49 -> V_84 [ V_94 ] . V_92 = NULL ;
}
static int F_76 ( void )
{
int V_39 = 0xffff ;
struct V_2 * V_3 = NULL ;
while ( ( V_3 = F_77 ( V_3 ) ) != NULL )
V_39 = F_78 ( int , V_39 , F_79 ( V_3 ) ) ;
return V_39 + 1 ;
}
static int F_80 ( struct V_1 * V_32 )
{
struct V_95 * V_96 = & V_32 -> V_4 ;
struct V_84 * V_97 ;
T_8 V_98 ;
unsigned long V_87 ;
F_81 ( V_93 ) ;
V_97 = & V_32 -> V_49 -> V_84 [ V_85 ] ;
V_32 -> V_93 [ 0 ] = (struct V_84 ) {
. V_99 = L_1 ,
. V_100 = 0 ,
. V_101 = ( F_63 ( V_97 ) >> 20 ) - 1 ,
. V_87 = V_102 | V_103 ,
} ;
V_97 = & V_32 -> V_49 -> V_84 [ V_91 ] ;
V_98 = F_82 ( V_97 -> V_101 ) ;
V_87 = V_97 -> V_87 & ~ V_104 ;
if ( ! V_98 )
V_87 &= ~ V_105 ;
V_32 -> V_93 [ 1 ] = (struct V_84 ) {
. V_99 = L_2 ,
. V_100 = V_97 -> V_100 ,
. V_101 = V_97 -> V_101 ,
. V_87 = V_87 ,
...
V_97 = & V_32 -> V_49 -> V_84 [ V_94 ] ;
V_98 = F_82 ( V_97 -> V_101 ) ;
V_87 = V_97 -> V_87 & ~ V_104 ;
if ( ! V_98 )
V_87 &= ~ V_105 ;
V_32 -> V_93 [ 2 ] = (struct V_84 ) {
. V_99 = L_3 ,
. V_100 = V_97 -> V_100 + 0x2000 ,
. V_101 = V_97 -> V_101 ,
. V_87 = V_87 ,
. V_106 = V_97 ,
} ;
...
if ( V_96 -> V_39 < 0 )
return V_96 -> V_39 ;
V_96 -> V_20 = F_83 ( V_32 -> V_49 -> V_3 ) ;
V_32 -> V_38 = F_84 ( NULL , & V_107 ,
NULL ) ;
if ( ! V_32 -> V_38 )
return - V_108 ;
F_85 ( & V_93 , & V_32 -> V_93 [ 0 ] ) ;
F_85 ( & V_93 , & V_32 -> V_93 [ 1 ] ) ;
F_85 ( & V_93 , & V_32 -> V_93 [ 2 ] ) ;
V_32 -> V_3 = F_86 ( & V_32 -> V_49 -> V_49 , 0 , & V_109 , V_96 ,
& V_93 ) ;
if ( ! V_32 -> V_3 ) {
F_87 ( & V_93 ) ;
F_88 ( V_32 -> V_38 ) ;
...
F_74 ( V_32 ) ;
F_58 ( V_32 ) ;
F_89 ( & V_32 -> V_3 -> V_49 , V_32 -> V_38 ) ;
F_90 ( V_32 -> V_3 ) ;
F_91 ( F_92 ( & V_32 -> V_49 -> V_49 . V_110 , & V_32 -> V_3 -> V_49 . V_110 ,
L_4 ) , L_5 ) ;
return 0 ;
}
...
struct V_9 * V_10 ;
F_93 () ;
F_94 (vmdirq, &irqs->irq_list, node)
F_95 ( V_10 -> V_40 ) ;
F_96 () ;
return V_111 ;
}
static int F_97 ( struct V_51 * V_49 , const struct V_112 * V_113 )
{
struct V_1 * V_32 ;
int V_33 , V_114 ;
if ( F_63 ( & V_49 -> V_84 [ V_85 ] ) < ( 1 << 20 ) )
return - V_44 ;
V_32 = F_98 ( & V_49 -> V_49 , sizeof( * V_32 ) , V_43 ) ;
if ( ! V_32 )
return - V_44 ;
V_32 -> V_49 = V_49 ;
V_114 = F_99 ( V_49 ) ;
if ( V_114 < 0 )
return V_114 ;
V_32 -> V_82 = F_100 ( V_49 , V_85 , 0 ) ;
if ( ! V_32 -> V_82 )
return - V_44 ;
F_101 ( V_49 ) ;
if ( F_102 ( & V_49 -> V_49 , F_103 ( 64 ) ) &&
F_102 ( & V_49 -> V_49 , F_103 ( 32 ) ) )
return - V_108 ;
V_32 -> V_35 = F_104 ( V_49 ) ;
if ( V_32 -> V_35 < 0 )
return - V_108 ;
V_32 -> V_36 = F_105 ( & V_49 -> V_49 , V_32 -> V_35 , sizeof( * V_32 -> V_36 ) ,
V_43 ) ;
if ( ! V_32 -> V_36 )
return - V_44 ;
V_32 -> V_115 = F_105 ( & V_49 -> V_49 , V_32 -> V_35 ,
sizeof( * V_32 -> V_115 ) ,
V_43 ) ;
if ( ! V_32 -> V_115 )
return - V_44 ;
for ( V_33 = 0 ; V_33 < V_32 -> V_35 ; V_33 ++ )
V_32 -> V_115 [ V_33 ] . V_116 = V_33 ;
V_32 -> V_35 = F_106 ( V_32 -> V_49 , V_32 -> V_115 , 1 ,
V_32 -> V_35 ) ;
if ( V_32 -> V_35 < 0 )
return V_32 -> V_35 ;
for ( V_33 = 0 ; V_33 < V_32 -> V_35 ; V_33 ++ ) {
F_17 ( & V_32 -> V_36 [ V_33 ] . V_21 ) ;
V_32 -> V_36 [ V_33 ] . V_45 = V_32 -> V_115 [ V_33 ] . V_117 ;
V_32 -> V_36 [ V_33 ] . V_18 = V_33 ;
V_114 = F_107 ( & V_49 -> V_49 , V_32 -> V_36 [ V_33 ] . V_45 ,
...
if ( V_114 )
return V_114 ;
F_110 ( & V_32 -> V_49 -> V_49 , L_7 ,
V_32 -> V_4 . V_39 ) ;
return 0 ;
}
static void F_111 ( struct V_51 * V_49 )
{
struct V_1 * V_32 = F_112 ( V_49 ) ;
F_75 ( V_32 ) ;
F_109 ( V_49 , NULL ) ;
F_113 ( & V_32 -> V_49 -> V_49 . V_110 , L_4 ) ;
F_114 ( V_32 -> V_3 ) ;
F_115 ( V_32 -> V_3 ) ;
F_56 ( V_32 ) ;
F_88 ( V_32 -> V_38 ) ;
...
static int F_118 ( struct V_48 * V_49 )
{
struct V_51 * V_52 = F_23 ( V_49 ) ;
F_119 ( V_52 ) ;
return 0 ;
