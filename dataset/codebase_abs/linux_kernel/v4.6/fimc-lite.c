...
V_71 = F_126 ( & V_217 -> V_97 , 1 , & V_14 -> V_237 ) ;
if ( V_71 < 0 )
return V_71 ;
F_127 ( V_217 , V_14 ) ;
V_14 -> V_44 . V_182 = F_4 ( V_171 ) ;
V_71 = F_128 ( V_217 , V_238 , - 1 ) ;
if ( V_71 < 0 ) {
F_129 ( & V_217 -> V_97 ) ;
...
static int F_135 ( struct V_239 * V_240 )
{
...
V_71 = F_126 ( & V_171 -> V_97 , V_250 ,
V_14 -> V_248 ) ;
if ( V_71 )
return V_71 ;
F_139 ( V_241 , 1 ) ;
V_14 -> V_24 = F_140 ( V_241 , & V_251 ,
NULL ) ;
if ( V_241 -> error ) {
F_129 ( & V_171 -> V_97 ) ;
return V_241 -> error ;
...
{
int V_71 ;
V_14 -> clock = F_151 ( & V_14 -> V_102 -> V_103 , V_257 ) ;
if ( F_146 ( V_14 -> clock ) )
...
static int F_154 ( struct V_258 * V_102 )
{
...
if ( ! V_103 -> V_265 )
return - V_266 ;
V_14 = F_155 ( V_103 , sizeof( * V_14 ) , V_267 ) ;
if ( ! V_14 )
return - V_268 ;
V_262 = F_156 ( V_269 , V_103 -> V_265 ) ;
if ( V_262 )
V_259 = (struct V_115 * ) V_262 -> V_270 ;
V_14 -> V_5 = F_157 ( V_103 -> V_265 , L_14 ) ;
...
F_160 ( & V_14 -> V_23 ) ;
F_161 ( & V_14 -> V_98 ) ;
V_264 = F_162 ( V_102 , V_273 , 0 ) ;
V_14 -> V_274 = F_163 ( V_103 , V_264 ) ;
if ( F_146 ( V_14 -> V_274 ) )
return F_152 ( V_14 -> V_274 ) ;
V_264 = F_162 ( V_102 , V_275 , 0 ) ;
if ( V_264 == NULL ) {
F_158 ( V_103 , L_16 ) ;
return - V_19 ;
}
...
if ( V_71 )
return V_71 ;
V_71 = F_164 ( V_103 , V_264 -> V_276 , F_32 ,
0 , F_85 ( V_103 ) , V_14 ) ;
if ( V_71 ) {
F_158 ( V_103 , L_17 , V_71 ) ;
goto V_277;
}
V_71 = F_137 ( V_14 ) ;
if ( V_71 )
...
V_14 -> V_85 = F_169 ( V_103 ) ;
if ( F_146 ( V_14 -> V_85 ) ) {
V_71 = F_152 ( V_14 -> V_85 ) ;
goto V_279;
}
F_136 ( V_14 ) ;
F_170 ( V_103 , L_18 ,
...
static int F_172 ( struct V_260 * V_103 )
{
struct V_13 * V_14 = F_173 ( V_103 ) ;
F_168 ( V_14 -> clock ) ;
return 0 ;
}
static int F_174 ( struct V_260 * V_103 )
{
struct V_13 * V_14 = F_173 ( V_103 ) ;
F_171 ( V_14 -> clock ) ;
return 0 ;
...
static int F_177 ( struct V_258 * V_102 )
{
struct V_13 * V_14 = F_178 ( V_102 ) ;
struct V_260 * V_103 = & V_102 -> V_103 ;
F_179 ( V_103 ) ;
F_180 ( V_103 ) ;
F_142 ( V_14 ) ;
