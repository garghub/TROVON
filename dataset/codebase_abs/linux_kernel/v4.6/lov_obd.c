...
V_25 -> V_324 -> V_330 &&
F_158 ( & V_179 -> V_182 , V_326 ) ) {
* V_329 = V_10 ;
V_32 = 0 ;
goto V_69;
}
}
F_159 ( V_25 -> V_324 , L_67 ) ;
F_160 ( V_331 , V_170 ) ;
V_32 = - V_332 ;
goto V_69;
} else if ( F_157 ( V_333 ) ) {
...
V_32 = F_153 ( V_51 , V_12 -> V_46 , V_291 , V_292 ,
...
continue;
V_194 = F_166 ( V_4 -> V_17 [ V_10 ] -> V_46 , V_254 ) ;
if ( V_194 && ! V_32 )
V_32 = V_194 ;
}
V_69:
