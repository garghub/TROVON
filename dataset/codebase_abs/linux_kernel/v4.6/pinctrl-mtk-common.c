...
const struct V_107 * V_4 ;
F_94 ( V_23 , V_149 ) ;
for ( V_146 = 0 ; V_146 < V_3 -> V_5 -> V_164 ; V_146 += 32 ) {
V_218 = F_70 ( V_163 ) ;
V_163 += 4 ;
while ( V_218 ) {
V_16 = F_95 ( V_218 ) ;
...
V_3 -> V_87 = & V_224 -> V_87 ;
V_3 -> V_160 = F_109 ( & V_3 -> V_234 , & V_224 -> V_87 , V_3 ) ;
if ( F_106 ( V_3 -> V_160 ) ) {
...
* V_3 -> V_23 = V_244 ;
V_3 -> V_23 -> V_245 = V_3 -> V_5 -> V_54 ;
V_3 -> V_23 -> V_246 = F_108 ( & V_224 -> V_87 ) ;
