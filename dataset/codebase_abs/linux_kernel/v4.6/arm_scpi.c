...
int V_36 ;
struct V_65 V_66 ;
V_36 = F_27 ( V_67 , & V_64 , sizeof( V_64 ) ,
& V_66 , sizeof( V_66 ) ) ;
return V_36 ? V_36 : V_66 . V_68 ;
}
static int F_40 ( T_2 V_64 , T_2 V_68 )
{
int V_60 ;
struct V_69 V_66 = { V_64 , V_68 } ;
return F_27 ( V_70 , & V_66 , sizeof( V_66 ) ,
& V_60 , sizeof( V_60 ) ) ;
}
...
struct V_107 * F_54 ( void )
{
return V_38 ? V_38 -> V_107 : NULL ;
}
static int F_55 ( struct V_108 * V_78 )
{
int V_36 ;
struct V_109 V_110 ;
V_36 = F_27 ( V_111 , NULL , 0 ,
& V_110 , sizeof( V_110 ) ) ;
if ( ! V_36 ) {
V_78 -> V_48 = F_12 ( V_110 . V_48 ) ;
V_78 -> V_112 = F_12 ( V_110 . V_113 ) ;
}
return V_36 ;
}
static T_6 F_56 ( struct V_114 * V_115 ,
struct V_116 * V_117 , char * V_81 )
{
struct V_108 * V_38 = F_57 ( V_115 ) ;
return sprintf ( V_81 , L_1 ,
F_58 ( V_38 -> V_48 ) ,
F_59 ( V_38 -> V_48 ) ) ;
}
static T_6 F_60 ( struct V_114 * V_115 ,
struct V_116 * V_117 , char * V_81 )
{
struct V_108 * V_38 = F_57 ( V_115 ) ;
...
static void
F_64 ( struct V_114 * V_115 , struct V_6 * V_118 , int V_87 )
{
int V_82 ;
for ( V_82 = 0 ; V_82 < V_87 && V_118 -> V_37 ; V_82 ++ , V_118 ++ ) {
F_65 ( V_118 -> V_37 ) ;
F_66 ( V_115 , V_118 -> V_119 ) ;
F_67 ( V_115 , V_118 -> V_19 ) ;
}
}
static int F_68 ( struct V_120 * V_121 )
{
int V_82 ;
struct V_114 * V_115 = & V_121 -> V_115 ;
struct V_108 * V_78 = F_69 ( V_121 ) ;
V_38 = NULL ;
F_70 ( V_115 ) ;
F_71 ( & V_115 -> V_122 , V_123 ) ;
F_64 ( V_115 , V_78 -> V_41 , V_78 -> V_40 ) ;
F_72 ( V_121 , NULL ) ;
for ( V_82 = 0 ; V_82 < V_83 && V_78 -> V_66 [ V_82 ] ; V_82 ++ ) {
F_48 ( V_78 -> V_66 [ V_82 ] -> V_90 ) ;
F_48 ( V_78 -> V_66 [ V_82 ] ) ;
}
F_66 ( V_115 , V_78 -> V_41 ) ;
F_66 ( V_115 , V_78 ) ;
return 0 ;
}
static int F_73 ( struct V_114 * V_115 , struct V_6 * V_7 )
{
int V_82 ;
struct V_10 * V_119 ;
V_119 = F_74 ( V_115 , V_124 * sizeof( * V_119 ) , V_86 ) ;
if ( ! V_119 )
return - V_42 ;
V_7 -> V_119 = V_119 ;
for ( V_82 = 0 ; V_82 < V_124 ; V_82 ++ , V_119 ++ )
F_20 ( & V_119 -> V_15 , & V_7 -> V_35 ) ;
return 0 ;
}
...
struct V_6 * V_6 ;
struct V_114 * V_115 = & V_121 -> V_115 ;
struct V_128 * V_129 = V_115 -> V_130 ;
V_38 = F_74 ( V_115 , sizeof( * V_38 ) , V_86 ) ;
if ( ! V_38 )
return - V_42 ;
V_87 = F_76 ( V_129 , L_3 , L_4 ) ;
if ( V_87 < 0 ) {
F_77 ( V_115 , L_5 , V_129 -> V_131 ) ;
return - V_132 ;
}
V_6 = F_78 ( V_115 , V_87 , sizeof( * V_6 ) , V_86 ) ;
if ( ! V_6 )
return - V_42 ;
for ( V_125 = 0 ; V_125 < V_87 ; V_125 ++ ) {
T_7 V_133 ;
struct V_6 * V_118 = V_6 + V_125 ;
struct V_25 * V_28 = & V_118 -> V_28 ;
struct V_128 * V_134 = F_79 ( V_129 , L_6 , V_125 ) ;
if ( F_80 ( V_134 , 0 , & V_127 ) ) {
F_77 ( V_115 , L_7 ) ;
V_36 = - V_84 ;
goto V_135;
}
V_133 = F_81 ( & V_127 ) ;
V_118 -> V_19 = F_82 ( V_115 , V_127 . V_136 , V_133 ) ;
if ( ! V_118 -> V_19 ) {
F_77 ( V_115 , L_8 ) ;
V_36 = - V_137 ;
goto V_135;
}
V_118 -> V_30 = V_118 -> V_19 + ( V_133 >> 1 ) ;
V_28 -> V_115 = V_115 ;
V_28 -> V_138 = F_15 ;
V_28 -> V_139 = F_17 ;
V_28 -> V_140 = true ;
...
F_84 ( & V_118 -> V_13 ) ;
F_85 ( & V_118 -> V_34 ) ;
V_36 = F_73 ( V_115 , V_118 ) ;
if ( ! V_36 ) {
V_118 -> V_37 = F_86 ( V_28 , V_125 ) ;
if ( ! F_87 ( V_118 -> V_37 ) )
continue;
V_36 = F_88 ( V_118 -> V_37 ) ;
if ( V_36 != - V_143 )
F_77 ( V_115 , L_9 ,
V_125 , V_36 ) ;
}
V_135:
F_64 ( V_115 , V_6 , V_125 ) ;
V_38 = NULL ;
return V_36 ;
}
V_38 -> V_41 = V_6 ;
...
F_63 ( V_38 -> V_112 ) ) ;
V_38 -> V_107 = & V_107 ;
V_36 = F_90 ( & V_115 -> V_122 , V_123 ) ;
if ( V_36 )
F_77 ( V_115 , L_12 ) ;
return F_91 ( V_115 -> V_130 , NULL , NULL , V_115 ) ;
}
