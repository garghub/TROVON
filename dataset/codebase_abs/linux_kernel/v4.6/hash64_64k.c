...
if ( V_10 & V_34 )
V_24 |= V_35 ;
} while ( V_23 != F_7 ( ( unsigned long * ) V_12 ,
V_23 , V_24 ) );
V_25 = V_24 & ~ V_16 ;
V_20 = F_8 ( V_25 ) ;
if ( ! F_9 ( V_36 ) &&
! F_9 ( V_37 ) ) {
V_20 = F_10 ( V_20 , F_11 ( V_23 ) , V_13 ) ;
}
V_19 = ( V_9 & ( V_38 - 1 ) ) >> V_29 ;
V_26 = F_12 ( V_9 , V_11 , V_15 ) ;
V_1 = F_13 ( F_11 ( V_23 ) , V_12 ) ;
if ( ! ( V_23 & V_39 ) )
goto V_40;
if ( ! ( V_23 & V_8 ) ) {
F_14 ( V_26 , V_1 , V_41 , V_15 , V_14 ) ;
V_23 &= ~ ( V_39 | V_42 | V_43 ) ;
V_24 &= ~ ( V_39 | V_42 | V_43 ) ;
goto V_40;
}
...
V_40:
if ( V_23 & V_51 ) {
V_21 = F_17 ( F_11 ( V_23 ) ) << V_52 ;
} else {
V_21 = F_17 ( F_11 ( V_23 ) ) << V_53 ;
V_21 += ( V_19 << V_29 ) ;
}
V_27 = F_15 ( V_26 , V_29 , V_15 ) ;
V_54:
...
int F_21 ( unsigned long V_9 , unsigned long V_10 ,
