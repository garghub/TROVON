...
static int F_5 ( void )
{
int V_12 , V_13 = - V_14 , V_15 = F_6 ( V_16 ) ;
if ( V_15 < 0 || V_15 > V_17 )
return - V_11 ;
for ( V_12 = 0 ; V_12 < V_15 ; V_12 ++ ) {
V_18 [ V_12 ] . V_19 = F_7 ( V_20 , L_2 , V_12 ) ;
if ( ! V_18 [ V_12 ] . V_19 )
goto V_21;
V_18 [ V_12 ] . V_22 = 0x0000 ;
V_18 [ V_12 ] . V_23 = 0xffff ;
V_18 [ V_12 ] . V_24 = 0xffff ;
V_18 [ V_12 ] . V_4 = F_1 ;
V_18 [ V_12 ] . V_25 = F_4 ;
V_13 = F_8 ( NULL , & V_18 [ V_12 ] , V_26 ) ;
if ( V_13 )
goto V_27;
}
V_28 = V_15 ;
