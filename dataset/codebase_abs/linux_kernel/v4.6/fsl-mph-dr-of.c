...
static int F_24 ( struct V_66 * V_30 , void * V_67 )
{
F_25 ( F_26 ( V_30 ) ) ;
return 0 ;
}
...
{
F_28 ( & V_18 -> V_30 , NULL , F_24 ) ;
return 0 ;
}
int F_29 ( struct V_17 * V_23 )
{
struct V_19 * V_20 = F_30 ( & V_23 -> V_30 ) ;
struct V_68 * V_68 ;
int V_69 ;
V_68 = F_31 ( V_23 -> V_30 . V_31 , L_29 ) ;
if ( F_21 ( V_68 ) ) {
F_22 ( & V_23 -> V_30 , L_30 ) ;
return F_23 ( V_68 ) ;
}
...
if ( V_20 -> V_57 )
V_70 |= V_72 ;
F_33 ( V_20 -> V_73 + V_74 , V_75 | V_76 ) ;
F_33 ( V_20 -> V_73 + V_77 , V_70 ) ;
}
return 0 ;
}
static void F_34 ( struct V_17 * V_23 )
{
struct V_19 * V_20 = F_30 ( & V_23 -> V_30 ) ;
V_20 -> V_73 = NULL ;
if ( V_20 -> V_68 )
