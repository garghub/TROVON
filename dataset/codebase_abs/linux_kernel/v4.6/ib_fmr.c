...
int F_14 ( struct V_2 * V_3 , struct V_1 * V_7 ,
...
unsigned int V_46 = F_17 ( V_34 , & V_35 [ V_41 ] ) ;
T_1 V_47 = F_18 ( V_34 , & V_35 [ V_41 ] ) ;
if ( V_47 & ~ V_48 ) {
if ( V_41 > 0 )
return - V_49 ;
else
...
void F_32 ( struct V_1 * V_7 )
{
struct V_5 * V_6 = V_7 -> V_6 ;
if ( V_7 -> V_56 >= V_6 -> V_23 . V_70 )
F_33 ( & V_7 -> V_74 , & V_6 -> V_75 ) ;
else
F_33 ( & V_7 -> V_74 , & V_6 -> V_76 ) ;
}
