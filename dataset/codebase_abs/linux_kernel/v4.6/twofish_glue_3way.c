...
T_5 * V_39 = & V_23 -> V_28 ;
int V_27 ;
V_27 = F_36 ( V_23 , V_24 , V_25 ) ;
if ( V_27 )
return V_27 ;
V_27 = F_27 ( & V_2 -> V_36 , V_24 , V_25 / 2 , V_39 ) ;
if ( V_27 )
return V_27 ;
return F_27 ( & V_2 -> V_40 , V_24 + V_25 / 2 , V_25 / 2 ,
V_39 ) ;
}
static int F_37 ( struct V_9 * V_10 , struct V_11 * V_3 ,
struct V_11 * V_4 , unsigned int V_12 )
{
...
return F_39 ( V_10 , V_3 , V_4 , V_12 , & V_32 ) ;
}
static int F_40 ( struct V_9 * V_10 , struct V_11 * V_3 ,
struct V_11 * V_4 , unsigned int V_12 )
{
struct V_38 * V_2 = F_30 ( V_10 -> V_23 ) ;
T_4 V_30 [ 3 ] ;
