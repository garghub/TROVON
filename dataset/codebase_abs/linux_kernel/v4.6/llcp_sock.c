...
static int F_62 ( struct V_12 * V_1 , struct V_13 * V_117 ,
int V_24 , int V_83 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
...
static int F_68 ( struct V_12 * V_1 , struct V_129 * V_130 ,
T_4 V_24 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
...
F_9 ( V_2 ) ;
return F_70 ( V_17 , V_130 , V_24 ) ;
}
static int F_71 ( struct V_12 * V_1 , struct V_129 * V_130 ,
T_4 V_24 , int V_83 )
{
...
V_142 = V_144 -> V_24 ;
V_141 = F_16 (unsigned int, rlen, len) ;
V_145 = V_144 ;
if ( F_74 ( V_145 , 0 , V_130 , V_141 ) ) {
if ( ! ( V_83 & V_146 ) )
F_75 ( & V_2 -> V_103 , V_144 ) ;
return - V_61 ;
}
F_76 ( V_130 , V_2 , V_144 ) ;
if ( V_2 -> V_134 == V_135 && V_130 -> V_136 ) {
struct V_147 * V_148 = F_77 ( V_144 ) ;
...
struct V_1 * F_83 ( struct V_12 * V_1 , int type , T_5 V_153 , int V_154 )
{
struct V_1 * V_2 ;
struct V_16 * V_17 ;
V_2 = F_84 ( & V_155 , V_156 , V_153 , & V_157 , V_154 ) ;
if ( ! V_2 )
return NULL ;
V_17 = V_16 ( V_2 ) ;
F_85 ( V_1 , V_2 ) ;
...
const struct V_35 * V_170 , int V_154 )
{
struct V_1 * V_2 ;
F_3 ( L_13 , V_1 ) ;
if ( V_1 -> type != V_48 &&
...
V_1 -> V_172 = & V_174 ;
V_2 = F_83 ( V_1 , V_1 -> type , V_175 , V_154 ) ;
if ( V_2 == NULL )
return - V_124 ;
return 0 ;
}
