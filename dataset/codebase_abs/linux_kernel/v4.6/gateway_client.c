...
struct V_3 * V_16 ;
F_14 ( & V_9 -> V_10 . V_17 ) ;
if ( V_15 && ! F_10 ( & V_15 -> V_5 ) )
V_15 = NULL ;
V_16 = F_15 ( V_9 -> V_10 . V_11 , 1 ) ;
F_16 ( V_9 -> V_10 . V_11 , V_15 ) ;
if ( V_16 )
F_5 ( V_16 ) ;
F_17 ( & V_9 -> V_10 . V_17 ) ;
}
...
struct V_13 * V_6 ;
F_8 () ;
F_21 (gw_node, &bat_priv->gw.list, list) {
V_6 = V_4 -> V_6 ;
V_20 = F_22 ( V_6 , V_27 ) ;
if ( ! V_20 )
continue;
...
F_8 () ;
F_21 (gw_node_tmp, &bat_priv->gw.list, list) {
if ( V_54 -> V_6 != V_6 )
continue;
if ( ! F_10 ( & V_54 -> V_5 ) )
continue;
