...
F_5 ( V_9 -> V_87 , & V_11 -> V_87 ) )
return - V_17 ;
if ( F_35 ( V_9 -> type ) )
if ( F_5 ( V_9 -> V_88 , & V_11 -> V_88 ) ||
F_5 ( V_9 -> V_14 , & V_11 -> V_14 ) ||
F_5 ( V_9 -> V_89 . V_90 , & V_11 -> V_89 . V_90 ) ||
F_5 ( V_9 -> V_89 . V_91 ,
& V_11 -> V_89 . V_91 ) )
return - V_17 ;
if ( F_36 ( V_9 -> type ) ) {
...
return - V_17 ;
if ( F_9 ( V_9 -> V_88 , & V_11 -> V_88 ) ||
F_9 ( V_9 -> V_14 , & V_11 -> V_14 ) ||
F_9 ( V_9 -> V_89 . V_90 , & V_11 -> V_89 . V_90 ) ||
F_9 ( V_9 -> V_89 . V_91 , & V_11 -> V_89 . V_91 ) ||
F_11 ( & V_11 -> V_97 , & V_9 -> V_97 , sizeof( struct V_98 ) ) ||
F_9 ( V_9 -> V_99 , & V_11 -> V_99 ) ||
F_9 ( V_9 -> V_100 , & V_11 -> V_100 ) ||
F_9 ( V_9 -> V_65 , & V_11 -> V_65 ) ||
F_9 ( V_9 -> V_87 , & V_11 -> V_87 ) )
return - V_17 ;
if ( F_36 ( V_9 -> type ) ) {
V_85 = V_9 -> V_87 ;
if ( V_85 == 0 )
