...
static void T_3 F_92 ( struct V_77 * type , int V_29 )
{
...
static void T_3 F_95 ( void * V_158 )
{
struct V_77 * * V_159 ;
...
static void T_3 F_97 ( struct V_77 * type )
{
struct V_27 * V_28 = type -> V_156 ;
int V_13 ;
if ( V_28 ) {
...
static void T_3 F_98 ( struct V_77 * * V_159 )
{
for (; * V_159 ; V_159 ++ )
F_97 ( * V_159 ) ;
}
...
static void F_128 ( int V_29 , bool V_193 )
{
struct V_77 * type , * * V_159 = V_160 ;
struct V_27 * V_28 ;
struct V_26 * V_31 ;
...
if ( ! V_31 )
continue;
if ( F_131 ( V_194 , & V_31 -> V_183 ) == V_194 )
F_108 ( V_31 ) ;
}
}
}
static int F_132 ( int V_29 )
{
struct V_77 * type , * * V_159 = V_160 ;
struct V_27 * V_28 ;
struct V_26 * V_31 ;
...
static void F_134 ( struct V_77 * type , int V_195 ,
int V_196 )
{
struct V_27 * V_28 = type -> V_156 ;
struct V_26 * V_31 ;
...
continue;
F_50 ( V_31 ) ;
F_135 ( & V_28 -> V_28 , V_195 , V_196 ) ;
V_31 -> V_29 = V_196 ;
}
}
static void F_136 ( struct V_77 * * V_197 ,
int V_195 , int V_196 )
{
for (; * V_197 ; V_197 ++ )
F_134 ( * V_197 , V_195 , V_196 ) ;
}
static void F_137 ( int V_29 )
{
int V_198 ;
if ( ! F_138 ( V_29 , & V_144 ) )
return;
V_198 = F_139 ( F_130 ( V_29 ) , V_29 ) ;
if ( V_198 < V_199 )
F_140 ( V_198 , & V_144 ) ;
else
V_198 = - 1 ;
F_136 ( V_160 , V_29 , V_198 ) ;
F_136 ( V_179 , V_29 , V_198 ) ;
}
static void F_141 ( int V_29 )
{
int V_198 ;
V_198 = F_142 ( & V_144 , F_130 ( V_29 ) ) ;
if ( V_198 < V_199 )
return;
F_140 ( V_29 , & V_144 ) ;
F_136 ( V_160 , - 1 , V_29 ) ;
...
static int F_143 ( struct V_200 * V_201 ,
unsigned long V_202 , void * V_203 )
{
unsigned int V_29 = ( long ) V_203 ;
switch ( V_202 & ~ V_204 ) {
case V_205 :
return F_144 ( F_132 ( V_29 ) ) ;
case V_206 :
F_128 ( V_29 , false ) ;
case V_207 :
F_141 ( V_29 ) ;
...
static int T_3 F_145 ( struct V_77 * type )
{
int V_13 , V_114 ;
for ( V_13 = 0 ; V_13 < type -> V_153 ; V_13 ++ ) {
...
static void T_3 F_156 ( void * V_158 )
{
F_128 ( F_42 () , true ) ;
}
static int T_3 F_157 ( bool V_212 )
{
unsigned int V_29 ;
F_158 (cpu) {
unsigned int V_157 = F_17 ( V_29 ) ;
int V_114 ;
if ( F_159 ( V_157 , V_213 ) )
continue;
if ( V_212 ) {
V_114 = F_132 ( V_29 ) ;
if ( V_114 )
