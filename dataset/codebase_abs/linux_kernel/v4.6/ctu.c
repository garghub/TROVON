...
struct V_1 * F_25 ( struct V_10 * V_11 , int V_76 )
{
if ( F_26 ( V_76 < 0 || V_76 >= F_27 ( V_11 ) ) )
V_76 = 0 ;
return F_28 ( F_29 ( V_11 , V_76 ) ) ;
}
...
V_6 = F_34 ( V_68 , sizeof( * V_6 ) * V_83 , V_86 ) ;
if ( ! V_6 ) {
V_75 = - V_87 ;
goto V_85;
}
