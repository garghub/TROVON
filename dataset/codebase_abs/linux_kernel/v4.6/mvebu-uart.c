...
if ( V_68 )
F_29 ( V_67 , V_68 ) ;
V_69 = F_30 ( V_2 , V_67 , V_68 , 0 , 460800 ) ;
F_31 ( V_2 , V_67 -> V_73 , V_69 ) ;
F_4 ( & V_2 -> V_5 , V_3 ) ;
}
...
static void F_36 ( struct V_1 * V_2 , unsigned char V_78 )
{
unsigned int V_4 ;
for (; ; ) {
V_4 = F_3 ( V_2 -> V_6 + V_7 ) ;
...
static void F_37 ( struct V_1 * V_2 , int V_78 )
{
unsigned int V_4 ;
for (; ; ) {
V_4 = F_3 ( V_2 -> V_6 + V_7 ) ;
...
F_39 ( & V_65 -> V_2 , V_81 , V_82 , F_37 ) ;
}
static int T_2
F_40 ( struct V_83 * V_85 ,
const char * V_86 )
{
if ( ! V_85 -> V_2 . V_6 )
return - V_87 ;
...
{
T_3 V_89 ;
F_42 ( V_2 -> V_6 + V_7 , V_89 ,
( V_89 & V_90 ) , 1 , 10000 ) ;
}
static void F_43 ( struct V_1 * V_2 , int V_24 )
{
F_41 ( V_2 ) ;
F_8 ( V_24 , V_2 -> V_6 + V_49 ) ;
}
static void F_44 ( struct V_79 * V_91 , const char * V_81 ,
unsigned int V_47 )
{
...
int V_95 = 1 ;
if ( V_96 )
V_95 = F_45 ( & V_2 -> V_5 , V_3 ) ;
else
F_2 ( & V_2 -> V_5 , V_3 ) ;
V_94 = F_3 ( V_2 -> V_6 + V_15 ) &
( V_17 | V_16 ) ;
F_8 ( 0 , V_2 -> V_6 + V_15 ) ;
F_39 ( V_2 , V_81 , V_47 , F_43 ) ;
F_41 ( V_2 ) ;
if ( V_94 )
...
static int F_46 ( struct V_79 * V_91 , char * V_97 )
{
struct V_1 * V_2 ;
int V_69 = 9600 ;
int V_98 = 8 ;
...
if ( V_97 )
F_48 ( V_97 , & V_69 , & V_32 , & V_98 , & V_99 ) ;
return F_49 ( V_2 , V_91 , V_69 , V_32 , V_98 , V_99 ) ;
}
...
{
struct V_106 * V_107 = F_53 ( V_105 , V_108 , 0 ) ;
struct V_106 * V_57 = F_53 ( V_105 , V_109 , 0 ) ;
struct V_1 * V_2 ;
struct V_110 * V_84 ;
int V_61 ;
if ( ! V_107 || ! V_57 ) {
...
V_2 -> V_6 = F_55 ( & V_105 -> V_65 , V_107 ) ;
if ( F_56 ( V_2 -> V_6 ) )
return - F_57 ( V_2 -> V_6 ) ;
V_84 = F_58 ( & V_105 -> V_65 , sizeof( struct V_110 ) ,
V_119 ) ;
if ( ! V_84 )
return - V_120 ;
V_84 -> V_2 = V_2 ;
