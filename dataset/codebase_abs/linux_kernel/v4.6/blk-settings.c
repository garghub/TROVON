...
{
V_2 -> V_47 . V_36 =
V_63 & ( V_2 -> V_47 . V_31 - 1 ) ;
V_2 -> V_47 . V_38 = 0 ;
}
void F_29 ( struct V_8 * V_47 , unsigned int V_64 )
{
V_47 -> V_32 = V_64 ;
...
void F_31 ( struct V_8 * V_47 , unsigned int V_65 )
{
V_47 -> V_37 = V_65 ;
}
...
{
F_34 ( & V_66 -> V_47 , & V_67 -> V_47 , 0 ) ;
}
int F_34 ( struct V_8 * V_66 , struct V_8 * V_67 ,
T_8 V_68 )
{
unsigned int V_69 , V_70 , V_71 , V_72 = 0 ;
V_66 -> V_18 = F_18 ( V_66 -> V_18 , V_67 -> V_18 ) ;
V_66 -> V_19 = F_18 ( V_66 -> V_19 , V_67 -> V_19 ) ;
V_66 -> V_21 = F_18 ( V_66 -> V_21 , V_67 -> V_21 ) ;
V_66 -> V_23 = V_64 ( V_66 -> V_23 ,
V_67 -> V_23 ) ;
V_66 -> V_33 = F_18 ( V_66 -> V_33 , V_67 -> V_33 ) ;
V_66 -> V_13 = F_18 ( V_66 -> V_13 ,
V_67 -> V_13 ) ;
V_66 -> V_15 = F_18 ( V_66 -> V_15 ,
V_67 -> V_15 ) ;
V_66 -> V_10 = F_18 ( V_66 -> V_10 , V_67 -> V_10 ) ;
V_66 -> V_12 = F_18 ( V_66 -> V_12 ,
V_67 -> V_12 ) ;
V_66 -> V_16 = F_18 ( V_66 -> V_16 ,
V_67 -> V_16 ) ;
V_66 -> V_38 |= V_67 -> V_38 ;
V_71 = F_35 ( V_67 , V_68 ) ;
if ( V_66 -> V_36 != V_71 ) {
V_69 = F_14 ( V_66 -> V_31 , V_66 -> V_32 )
+ V_66 -> V_36 ;
V_70 = F_14 ( V_67 -> V_31 , V_67 -> V_32 ) + V_71 ;
...
V_67 -> V_30 ) ;
V_66 -> V_31 = F_14 ( V_66 -> V_31 ,
V_67 -> V_31 ) ;
V_66 -> V_32 = F_14 ( V_66 -> V_32 , V_67 -> V_32 ) ;
V_66 -> V_37 = F_36 ( V_66 -> V_37 , V_67 -> V_37 ) ;
V_66 -> V_39 &= V_67 -> V_39 ;
V_66 -> V_29 &= V_67 -> V_29 ;
...
if ( V_66 -> V_32 & ( V_66 -> V_31 - 1 ) ) {
V_66 -> V_32 = V_66 -> V_31 ;
V_66 -> V_38 = 1 ;
V_72 = - 1 ;
}
if ( V_66 -> V_37 & ( V_66 -> V_31 - 1 ) ) {
V_66 -> V_37 = 0 ;
V_66 -> V_38 = 1 ;
V_72 = - 1 ;
}
...
F_14 ( V_66 -> V_73 ,
V_67 -> V_73 ) ;
V_66 -> V_36 = F_36 ( V_66 -> V_36 , V_71 )
% F_14 ( V_66 -> V_31 , V_66 -> V_32 ) ;
...
if ( V_66 -> V_26 != 0 &&
V_66 -> V_27 != V_71 ) {
V_69 = V_66 -> V_26 + V_66 -> V_27 ;
V_70 = V_67 -> V_26 + V_71 ;
if ( ( F_14 ( V_69 , V_70 ) % V_64 ( V_69 , V_70 ) ) != 0 )
V_66 -> V_28 = 1 ;
}
V_66 -> V_24 = F_18 ( V_66 -> V_24 ,
V_67 -> V_24 ) ;
V_66 -> V_25 = F_18 ( V_66 -> V_25 ,
V_67 -> V_25 ) ;
V_66 -> V_26 = F_14 ( V_66 -> V_26 ,
V_67 -> V_26 ) ;
V_66 -> V_27 = F_36 ( V_66 -> V_27 , V_71 ) %
V_66 -> V_26 ;
}
return V_72 ;
}
int F_38 ( struct V_8 * V_66 , struct V_74 * V_75 ,
T_8 V_68 )
{
struct V_1 * V_76 = F_39 ( V_75 ) ;
V_68 += F_40 ( V_75 ) ;
return F_34 ( V_66 , & V_76 -> V_47 , V_68 ) ;
}
void F_41 ( struct V_77 * V_78 , struct V_74 * V_75 ,
T_8 V_63 )
{
struct V_1 * V_66 = V_78 -> V_79 ;
if ( F_38 ( & V_66 -> V_47 , V_75 , V_63 >> 9 ) < 0 ) {
...
void F_44 ( struct V_1 * V_2 , unsigned int V_82 )
{
V_2 -> V_83 = V_82 ;
}
...
void F_48 ( struct V_1 * V_2 , unsigned long V_82 )
{
if ( V_82 < V_58 - 1 ) {
V_82 = V_58 - 1 ;
F_17 ( V_59 L_3 ,
...
void F_50 ( struct V_1 * V_2 , int V_82 )
{
F_20 ( V_82 > V_58 ) ;
if ( V_82 > V_2 -> V_89 )
V_2 -> V_89 = V_82 ;
}
void F_51 ( struct V_1 * V_2 , unsigned int V_90 )
{
F_52 ( V_90 & ~ ( V_91 | V_92 ) ) ;
if ( F_52 ( ! ( V_90 & V_91 ) && ( V_90 & V_92 ) ) )
V_90 &= ~ V_92 ;
V_2 -> V_93 = V_90 & ( V_91 | V_92 ) ;
}
void F_53 ( struct V_1 * V_2 , bool V_94 )
{
V_2 -> V_95 = ! V_94 ;
}
