...
F_22 ( V_44 , L_13 , V_47 -> V_19 , V_47 -> V_20 ) ;
return 0 ;
}
V_47 -> V_50 = 1 ;
F_22 ( V_44 , L_14 , V_47 -> V_19 , V_47 -> V_20 ) ;
return 0 ;
}
if ( ( V_47 -> V_20 == V_9 ) ||
! F_13 ( V_47 -> V_19 , V_47 -> V_20 + 1 ) ) {
...
{
struct V_60 * V_61 ;
V_61 = F_30 ( L_15 , V_62 | V_63 | V_64 , NULL ,
& V_65 ) ;
if ( ! V_61 )
return - V_66 ;
return 0 ;
