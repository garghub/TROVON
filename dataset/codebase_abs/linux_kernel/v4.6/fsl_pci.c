...
V_21 = V_10 -> V_22 = F_54 ( V_133 . V_48 , F_19 ( & V_133 ) ) ;
if ( ! V_10 -> V_22 )
goto V_142;
F_55 ( V_10 , V_133 . V_48 , V_133 . V_48 + 0x4 ,
V_143 ) ;
...
static int F_60 ( struct V_27 * V_28 , unsigned int V_29 )
{
struct V_9 * V_10 = F_8 ( V_28 ) ;
if ( V_10 -> V_12 & V_32 )
return V_153 ;
...
static void T_3 * F_61 ( struct V_27 * V_28 ,
...
V_11 &= 0xffffff00 ;
return F_64 ( V_28 , V_29 , V_30 , V_31 , V_11 ) ;
}
static int T_6 F_65 ( struct V_9 * V_10 ,
struct V_45 * V_83 )
{
struct V_158 * V_159 ;
T_2 V_168 ;
int V_162 = - V_139 ;
V_159 = F_66 ( sizeof( * V_159 ) , V_169 ) ;
if ( ! V_159 )
return V_162 ;
V_159 -> V_163 = F_54 ( V_83 -> V_48 , F_19 ( V_83 ) ) ;
if ( ! V_159 -> V_163 )
goto V_170;
V_168 = F_67 ( V_159 -> V_163 + V_171 ) ;
if ( ! V_168 ) {
V_162 = - V_137 ;
goto V_172;
}
V_159 -> V_166 = F_54 ( V_168 , 0x1000 ) ;
if ( ! V_159 -> V_166 )
goto V_172;
F_68 ( V_10 -> V_81 -> V_160 ) ;
V_10 -> V_81 -> V_160 = V_159 ;
V_10 -> V_14 = & V_173 ;
V_10 -> V_12 |= V_13 ;
F_62 ( V_159 -> V_163 + V_174 , 0 ) ;
F_62 ( V_159 -> V_163 + V_165 , 0 ) ;
if ( F_4 ( V_10 ) )
V_10 -> V_12 |= V_32 ;
return 0 ;
V_172:
...
V_10 -> V_141 = V_134 ? V_134 [ 1 ] : 0xff ;
if ( F_30 ( V_2 , L_41 ) ) {
V_162 = F_65 ( V_10 , & V_175 ) ;
if ( V_162 )
goto V_170;
} else {
F_55 ( V_10 , V_176 . V_48 ,
V_176 . V_48 + 4 , 0 ) ;
}
F_51 ( V_149 L_34
L_35 ,
...
if ( ! ( F_67 ( & V_179 [ V_52 ] . V_181 ) & V_182 ) )
continue;
if ( F_73 () == F_67 ( & V_179 [ V_52 ] . V_183 ) )
return ( T_4 ) F_67 ( & V_179 [ V_52 ] . V_184 ) << 32 |
F_67 ( & V_179 [ V_52 ] . V_185 ) ;
}
F_51 ( V_138 L_42 ) ;
}
#endif
...
if ( V_224 )
return;
V_223 = F_26 ( NULL , L_43 ) ;
while ( ( V_224 = F_95 ( V_223 ) ) ) {
F_96 ( V_223 ) ;
V_223 = V_224 ;
if ( F_97 ( V_225 , V_223 ) && F_49 ( V_223 ) )
return;
}
F_98 (np, pci_ids) {
if ( F_49 ( V_223 ) ) {
...
struct V_130 * V_251 ;
struct V_252 V_253 = {
. V_136 = V_131 -> V_2 . V_136
} ;
V_251 = F_121 ( & V_131 -> V_2 ,
L_47 ,
V_254 ,
V_131 -> V_45 ,
V_131 -> V_255 ,
...
static int F_124 ( struct V_130 * V_131 )
{
struct V_59 * V_60 ;
int V_162 ;
V_60 = V_131 -> V_2 . V_136 ;
V_162 = F_48 ( V_131 , V_224 == V_60 ) ;
if ( V_162 )
return V_162 ;
V_162 = F_120 ( V_131 ) ;
if ( V_162 )
F_106 ( & V_131 -> V_2 , L_48 ,
V_162 ) ;
return 0 ;
}
