...
if ( V_88 )
F_38 ( L_44 ) ;
V_90 = F_39 ( V_81 , V_41 -> V_82 , L_45 , NULL ) ;
if ( F_40 ( V_90 ) ) {
V_88 = F_18 ( V_90 ) ;
F_34 ( V_41 , V_88 , L_46 ) ;
goto V_93;
...
if ( ! V_77 )
return 0 ;
if ( F_44 ( V_101 , L_49 , V_77 -> V_83 ) )
return - V_92 ;
if ( ! V_77 -> V_40 )
return 0 ;
return F_44 ( V_101 , L_50 , V_77 -> V_40 -> V_41 -> V_68 ) ;
}
...
if ( V_77 -> V_40 != NULL )
return 0 ;
V_88 = F_45 ( V_81 , V_41 -> V_82 , L_51 , L_52 , & V_102 ) ;
if ( V_88 != 1 ) {
F_34 ( V_41 , V_88 , L_53 ) ;
...
{
struct V_76 * V_77 = F_23 ( & V_41 -> V_41 ) ;
F_38 ( L_55 , V_41 -> V_110 , F_53 ( V_109 ) ) ;
V_77 -> V_109 = V_109 ;
switch ( V_109 ) {
case V_111 :
F_24 ( V_77 , V_98 ) ;
...
* V_114 = ~ 0UL ;
* V_115 = 0 ;
V_120 = F_39 ( V_81 , V_41 -> V_82 , L_57 , NULL ) ;
if ( F_40 ( V_120 ) )
return;
V_116 = V_120 ;
V_118 = F_59 ( V_116 , & V_117 , 10 ) ;
if ( ( V_116 == V_117 ) || ( * V_117 != ',' ) )
goto V_93;
V_116 = V_117 + 1 ;
V_119 = F_59 ( V_116 , & V_117 , 10 ) ;
...
static int F_60 ( struct V_75 * V_41 , T_5 V_121 [] )
{
char * V_116 , * V_117 , * V_122 ;
int V_65 ;
V_122 = V_116 = F_39 ( V_81 , V_41 -> V_82 , L_59 , NULL ) ;
if ( F_40 ( V_122 ) )
return F_18 ( V_122 ) ;
for ( V_65 = 0 ; V_65 < V_123 ; V_65 ++ ) {
V_121 [ V_65 ] = F_59 ( V_116 , & V_117 , 16 ) ;
...
{
struct V_62 * V_40 = F_62 ( V_126 , struct V_62 , V_128 ) ;
struct V_75 * V_41 = F_63 ( V_40 ) ;
unsigned long V_35 ;
unsigned long V_36 ;
unsigned int V_129 ;
F_58 ( V_41 , & V_35 , & V_36 ) ;
...
V_5 -> V_35 = V_35 ;
V_5 -> V_36 = V_36 ;
if ( ! F_64 ( & V_5 -> V_34 , V_39 ) &&
V_5 -> V_37 > V_5 -> V_35 ) {
V_5 -> V_37 = V_5 -> V_35 ;
}
}
}
static int F_65 ( struct V_75 * V_41 ,
struct V_62 * V_40 )
{
int V_88 = 0 ;
char * V_130 ;
unsigned V_131 = strlen ( V_41 -> V_82 ) + sizeof( L_60 ) ;
if ( V_40 -> V_128 . V_130 )
return - V_132 ;
V_130 = F_66 ( V_131 , V_91 ) ;
if ( ! V_130 )
return - V_92 ;
snprintf ( V_130 , V_131 , L_61 , V_41 -> V_82 ) ;
V_40 -> V_128 . V_130 = V_130 ;
V_40 -> V_128 . V_133 = F_61 ;
V_88 = F_67 ( & V_40 -> V_128 ) ;
if ( V_88 ) {
F_68 ( L_62 , V_40 -> V_128 . V_130 ) ;
F_30 ( V_130 ) ;
...
static void F_69 ( struct V_62 * V_40 )
{
if ( V_40 -> V_128 . V_130 ) {
F_70 ( & V_40 -> V_128 ) ;
...
const char * * V_127 , unsigned int V_51 )
{
struct V_62 * V_40 = F_62 ( V_126 , struct V_62 ,
V_134 ) ;
struct V_75 * V_41 = F_63 ( V_40 ) ;
int V_135 ;
...
static int F_72 ( struct V_75 * V_41 ,
struct V_62 * V_40 )
{
int V_88 = 0 ;
char * V_130 ;
...
snprintf ( V_130 , V_131 , L_67 ,
V_41 -> V_110 ) ;
V_40 -> V_134 . V_130 = V_130 ;
V_40 -> V_134 . V_133 = F_71 ;
V_88 = F_67 ( & V_40 -> V_134 ) ;
if ( V_88 ) {
F_68 ( L_62 ,
V_40 -> V_134 . V_130 ) ;
F_30 ( V_130 ) ;
...
static void F_74 ( struct V_62 * V_40 )
{
if ( V_40 -> V_134 . V_130 ) {
F_70 ( & V_40 -> V_134 ) ;
...
static void F_75 ( struct V_75 * V_41 ,
struct V_62 * V_40 )
{
F_65 ( V_41 , V_40 ) ;
F_72 ( V_41 , V_40 ) ;
...
if ( F_40 ( V_139 ) )
return;
if ( V_51 == sizeof( L_68 ) - 1 && ! memcmp ( V_139 , L_68 , V_51 ) ) {
...
V_88 = F_60 ( V_41 , V_77 -> V_40 -> V_141 ) ;
if ( V_88 ) {
F_34 ( V_41 , V_88 , L_71 , V_41 -> V_82 ) ;
return;
}
F_58 ( V_41 , & V_35 , & V_36 ) ;
F_27 ( V_77 -> V_40 ) ;
...
V_77 -> V_40 -> V_69 = V_140 ;
V_77 -> V_40 -> V_142 = V_140 ;
for ( V_129 = 0 ; V_129 < V_140 ; ++ V_129 ) {
V_5 = & V_77 -> V_40 -> V_73 [ V_129 ] ;
V_5 -> V_40 = V_77 -> V_40 ;
V_5 -> V_17 = V_129 ;
snprintf ( V_5 -> V_68 , sizeof( V_5 -> V_68 ) , L_73 ,
...
#endif
F_82 () ;
F_83 ( V_77 -> V_40 -> V_41 , V_140 ) ;
F_84 ( V_77 -> V_40 -> V_41 , V_140 ) ;
F_85 () ;
F_86 ( V_77 -> V_40 ) ;
F_25 ( V_77 ) ;
V_88 = F_87 ( V_41 , & V_77 -> V_137 ,
F_76 ,
L_74 , V_41 -> V_82 , L_19 ) ;
if ( ! V_88 )
V_77 -> V_106 = 1 ;
...
static int F_80 ( struct V_76 * V_77 , struct V_4 * V_5 )
{
struct V_75 * V_41 = V_77 -> V_41 ;
...
const T_3 V_149 = 11 ;
if ( V_69 == 1 ) {
V_147 = F_33 ( strlen ( V_41 -> V_110 ) + 1 , V_91 ) ;
if ( ! V_147 ) {
F_34 ( V_41 , - V_92 ,
L_75 ) ;
return - V_92 ;
}
strcpy ( V_147 , V_41 -> V_110 ) ;
} else {
V_148 = strlen ( V_41 -> V_110 ) + V_149 ;
V_147 = F_33 ( V_148 , V_91 ) ;
if ( ! V_147 ) {
F_34 ( V_41 , - V_92 ,
L_75 ) ;
return - V_92 ;
}
snprintf ( V_147 , V_148 , L_76 , V_41 -> V_110 ,
V_5 -> V_17 ) ;
}
V_88 = F_90 ( V_81 , V_147 ,
L_77 , L_78 , & V_143 ,
L_79 , L_78 , & V_144 , NULL ) ;
if ( V_88 ) {
F_34 ( V_41 , V_88 ,
L_80 ,
V_147 ) ;
...
V_88 = F_90 ( V_81 , V_147 ,
L_81 , L_41 , & V_145 ,
L_82 , L_41 , & V_146 , NULL ) ;
if ( V_88 < 0 ) {
V_88 = F_45 ( V_81 , V_147 ,
L_83 , L_41 , & V_145 ) ;
if ( V_88 < 0 ) {
F_34 ( V_41 , V_88 ,
L_84 ,
...
unsigned int V_150 ;
int V_88 , V_135 ;
V_88 = F_45 ( V_81 , V_41 -> V_110 , L_86 , L_41 ,
& V_150 ) ;
if ( V_88 == - V_124 ) {
V_88 = 0 ;
V_150 = 0 ;
...
V_135 = 0 ;
if ( V_135 )
V_40 -> V_155 |= F_93 ( V_157 ) ;
if ( F_45 ( V_81 , V_41 -> V_110 , L_89 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
if ( V_135 )
V_40 -> V_156 |= F_93 ( V_157 ) ;
if ( F_45 ( V_81 , V_41 -> V_110 , L_27 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
if ( V_135 )
V_40 -> V_155 |= F_93 ( V_158 ) ;
if ( F_45 ( V_81 , V_41 -> V_110 , L_90 ,
L_23 , & V_135 ) < 0 )
V_135 = 0 ;
if ( V_135 )
V_40 -> V_156 |= F_93 ( V_158 ) ;
if ( V_40 -> V_155 & V_40 -> V_156 ) {
F_34 ( V_41 , V_88 ,
L_91
L_92 ,
V_41 -> V_110 ) ;
