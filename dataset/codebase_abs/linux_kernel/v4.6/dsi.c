...
V_462 = F_95 ( V_16 -> V_388 . V_390 * V_385 , 8 ) ;
...
static enum V_459 F_258 ( int V_181 )
{
switch ( F_259 () ) {
case V_572 :
case V_573 :
...
if ( V_155 )
return V_155 ;
V_155 = F_267 ( V_460 , V_6 ) ;
if ( V_155 )
return V_155 ;
V_155 = F_268 ( V_6 , V_587 ) ;
if ( V_155 ) {
F_44 ( L_166 ,
V_6 -> V_45 ) ;
F_269 ( V_460 , V_6 ) ;
...
V_8 -> V_460 = F_258 ( V_16 -> V_181 ) ;
V_8 -> V_590 . V_16 = & V_591 ;
V_8 -> V_592 = V_593 ;
F_273 ( V_8 ) ;
}
...
static int F_276 ( struct V_2 * V_157 )
{
struct V_594 * V_595 = V_157 -> V_4 . V_596 ;
...
if ( ! V_600 )
return 0 ;
V_598 = F_278 ( V_600 , L_169 , & V_344 ) ;
if ( V_598 == NULL ) {
F_279 ( & V_157 -> V_4 , L_170 ) ;
V_155 = - V_153 ;
goto V_333;
}
...
V_451 > V_16 -> V_274 * 2 ) {
F_279 ( & V_157 -> V_4 , L_171 ) ;
V_155 = - V_153 ;
goto V_333;
}
V_155 = F_280 ( V_600 , L_169 , V_599 , V_451 ) ;
if ( V_155 ) {
F_279 ( & V_157 -> V_4 , L_172 ) ;
goto V_333;
}
V_450 . V_451 = V_451 ;
for ( V_109 = 0 ; V_109 < V_451 ; ++ V_109 )
V_450 . V_452 [ V_109 ] = ( int ) V_599 [ V_109 ] ;
V_155 = F_198 ( & V_16 -> V_461 , & V_450 ) ;
if ( V_155 ) {
F_279 ( & V_157 -> V_4 , L_173 ) ;
goto V_333;
}
F_281 ( V_600 ) ;
return 0 ;
...
struct V_586 * V_586 ;
int V_155 ;
V_586 = F_265 ( & V_3 -> V_4 , L_174 ) ;
if ( F_78 ( V_586 ) ) {
F_44 ( L_175 ) ;
return F_79 ( V_586 ) ;
}
V_175 -> V_45 = V_16 -> V_181 == 0 ? L_176 : L_177 ;
V_175 -> V_10 = V_16 -> V_181 == 0 ? V_601 : V_602 ;
V_175 -> V_220 = V_586 ;
...
static int F_284 ( struct V_608 * V_4 , struct V_608 * V_609 , void * V_26 )
{
...
struct V_611 * V_613 ;
struct V_611 V_614 ;
V_16 = F_285 ( & V_3 -> V_4 , sizeof( * V_16 ) , V_615 ) ;
if ( ! V_16 )
return - V_616 ;
V_16 -> V_157 = V_3 ;
F_286 ( & V_3 -> V_4 , V_16 ) ;
...
V_16 -> V_141 . V_26 = 0 ;
#endif
V_613 = F_293 ( V_3 , V_617 , L_178 ) ;
if ( ! V_613 ) {
V_613 = F_294 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_179 ) ;
return - V_153 ;
}
V_614 . T_9 = V_613 -> T_9 ;
V_614 . T_10 = V_614 . T_9 + V_618 - 1 ;
V_613 = & V_614 ;
}
V_612 = V_613 ;
V_16 -> V_19 = F_295 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_296 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_180 ) ;
return - V_616 ;
}
V_613 = F_293 ( V_3 , V_617 , L_181 ) ;
if ( ! V_613 ) {
V_613 = F_294 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_179 ) ;
...
V_614 . T_9 = V_613 -> T_9 + V_619 ;
V_614 . T_10 = V_614 . T_9 + V_620 - 1 ;
V_613 = & V_614 ;
}
V_16 -> V_21 = F_295 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_296 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_182 ) ;
return - V_616 ;
}
V_613 = F_293 ( V_3 , V_617 , L_183 ) ;
if ( ! V_613 ) {
V_613 = F_294 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_179 ) ;
...
V_614 . T_9 = V_613 -> T_9 + V_621 ;
V_614 . T_10 = V_614 . T_9 + V_622 - 1 ;
V_613 = & V_614 ;
}
V_16 -> V_23 = F_295 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_296 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_184 ) ;
return - V_616 ;
}
V_16 -> V_133 = F_297 ( V_16 -> V_157 , 0 ) ;
if ( V_16 -> V_133 < 0 ) {
F_44 ( L_185 ) ;
return - V_202 ;
}
V_155 = F_298 ( & V_3 -> V_4 , V_16 -> V_133 , F_48 ,
V_623 , F_299 ( & V_3 -> V_4 ) , V_16 -> V_157 ) ;
if ( V_155 < 0 ) {
F_44 ( L_186 ) ;
return V_155 ;
}
...
V_625 = F_300 ( V_628 , V_3 -> V_4 . V_596 ) ;
if ( ! V_625 ) {
F_44 ( L_187 ) ;
return - V_202 ;
}
V_627 = V_625 -> V_26 ;
while ( V_627 -> V_629 != 0 && V_627 -> V_629 != V_612 -> T_9 )
V_627 ++ ;
if ( V_627 -> V_629 == 0 ) {
F_44 ( L_187 ) ;
return - V_202 ;
}
V_16 -> V_181 = V_627 -> V_10 ;
} else {
V_16 -> V_181 = V_3 -> V_10 ;
}
for ( V_109 = 0 ; V_109 < F_47 ( V_16 -> V_149 ) ; V_109 ++ ) {
...
V_610 = F_9 ( V_3 , V_232 ) ;
F_302 ( & V_3 -> V_4 , L_188 ,
F_101 ( V_610 , 7 , 4 ) , F_101 ( V_610 , 3 , 0 ) ) ;
if ( F_84 ( V_260 ) )
...
V_155 = F_303 ( V_3 -> V_4 . V_596 , NULL , NULL ,
& V_3 -> V_4 ) ;
if ( V_155 )
F_44 ( L_190 , V_155 ) ;
}
...
static void F_306 ( struct V_608 * V_4 , struct V_608 * V_609 , void * V_26 )
{
struct V_2 * V_3 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
F_307 ( & V_3 -> V_4 ) ;
...
{
return F_310 ( & V_157 -> V_4 , & V_632 ) ;
}
static int F_311 ( struct V_2 * V_157 )
{
F_312 ( & V_157 -> V_4 , & V_632 ) ;
return 0 ;
}
static int F_313 ( struct V_608 * V_4 )
{
...
static int F_317 ( struct V_608 * V_4 )
{
struct V_2 * V_157 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_157 ) ;
int V_155 ;
