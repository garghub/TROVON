...
V_30 = V_33 -> V_28 . V_37 ;
V_3 = 0 ;
F_27 (obj, &top->loh_layers, co_lu.lo_linkage) {
if ( V_33 -> V_38 -> V_41 ) {
...
static int F_39 ( const struct V_56 * V_57 ,
struct V_63 * V_64 , int V_2 )
{
int V_59 ;
if ( V_2 ) {
...
struct V_18 * V_19 ;
struct V_92 * V_93 ;
V_93 = F_71 ( V_125 , V_126 ) ;
if ( V_93 ) {
int V_114 ;
F_6 ( & V_93 -> V_127 ) ;
V_93 -> V_96 = & F_49 ;
V_19 = & V_93 -> V_128 ;
V_114 = F_72 ( V_19 , V_123 | V_129 ) ;
if ( V_114 == 0 ) {
V_114 = F_73 ( & V_93 -> V_130 ,
V_124 | V_131 ) ;
if ( V_114 == 0 ) {
F_74 ( & V_93 -> V_130 ) ;
V_19 -> V_132 = & V_93 -> V_130 ;
F_49 ( V_93 , V_94 ) ;
} else
F_75 ( V_19 ) ;
}
...
{
F_79 ( V_134 ) ;
F_80 ( & V_93 -> V_128 . V_135 ) ;
F_80 ( & V_93 -> V_130 ) ;
F_76 ( V_125 , V_93 ) ;
}
static inline struct V_92 * F_81 ( struct V_18 * V_19 )
{
return F_82 ( V_19 , struct V_92 , V_128 ) ;
}
static struct V_18 * F_83 ( int * V_136 )
{
struct V_18 * V_19 ;
struct V_92 * V_93 ;
F_50 ( V_137 ) ;
...
F_19 ( V_139 , L_25 , V_93 ? V_93 -> V_95 : 0 , V_93 ) ;
return V_19 ;
}
struct V_18 * F_86 ( int * V_136 )
{
struct V_18 * V_19 ;
V_19 = F_83 ( V_136 ) ;
if ( ! V_19 ) {
...
F_61 ( V_93 ) ;
* V_136 = V_93 -> V_95 ;
F_19 ( V_139 , L_25 , V_93 -> V_95 , V_93 ) ;
}
}
return V_19 ;
}
struct V_18 * F_89 ( int * V_136 , V_106 V_142 )
{
struct V_18 * V_19 ;
F_32 ( ! F_83 ( V_136 ) ) ;
V_19 = F_70 ( V_142 , V_142 , F_87 ( 0 ) ) ;
if ( ! F_88 ( V_19 ) ) {
struct V_92 * V_93 ;
V_93 = F_81 ( V_19 ) ;
* V_136 = V_93 -> V_95 ;
...
{
F_32 ( ! V_93 -> V_98 ) ;
F_91 ( & V_93 -> V_128 . V_135 ) ;
F_91 ( & V_93 -> V_130 ) ;
}
void F_92 ( struct V_18 * V_19 , int * V_136 )
{
struct V_92 * V_93 ;
V_93 = F_81 ( V_19 ) ;
F_32 ( V_93 -> V_95 > 0 ) ;
F_32 ( F_60 ( V_136 , V_93 -> V_95 == * V_136 ) ) ;
F_19 ( V_139 , L_25 , V_93 -> V_95 , V_93 ) ;
if ( -- V_93 -> V_95 == 0 ) {
F_79 ( V_99 ) ;
F_69 ( V_93 ) ;
...
void F_95 ( struct V_18 * V_19 , int * V_136 )
{
...
void F_96 ( struct V_18 * V_19 , int * V_136 )
{
struct V_92 * V_93 = F_81 ( V_19 ) ;
F_32 ( V_93 -> V_95 > 1 ) ;
F_19 ( V_139 , L_25 , V_93 -> V_95 , V_93 ) ;
...
struct V_18 * F_97 ( struct V_143 * V_144 )
{
struct V_18 * V_19 ;
V_144 -> V_145 = NULL ;
V_19 = F_83 ( & V_144 -> V_146 ) ;
if ( V_19 ) {
if ( ! F_98 ( V_19 ) )
return V_19 ;
F_92 ( V_19 , & V_144 -> V_146 ) ;
V_144 -> V_145 = F_93 () ;
}
V_19 = F_86 ( & V_144 -> V_146 ) ;
if ( F_88 ( V_19 ) ) {
F_94 ( V_144 -> V_145 ) ;
return V_19 ;
}
...
void F_99 ( struct V_143 * V_144 , struct V_18 * V_19 )
{
F_92 ( V_19 , & V_144 -> V_146 ) ;
F_94 ( V_144 -> V_145 ) ;
}
...
{
V_35 -> V_147 = V_43 -> V_46 ;
V_35 -> V_148 = V_43 -> V_47 ;
V_35 -> V_149 = V_43 -> V_48 ;
V_35 -> V_150 = V_43 -> V_49 ;
V_35 -> V_151 = V_43 -> V_50 ;
}
struct V_20 * F_101 ( const struct V_18 * V_19 , struct V_152 * V_76 ,
struct V_153 * V_154 ,
struct V_155 * V_156 )
{
const char * V_157 ;
struct V_155 * V_69 ;
V_157 = V_154 -> V_158 ;
V_69 = V_154 -> V_159 -> V_160 ( V_19 , V_154 , NULL ) ;
if ( ! F_88 ( V_69 ) ) {
int V_114 ;
if ( V_76 )
V_69 -> V_161 = V_76 ;
V_114 = V_154 -> V_159 -> V_162 ( V_19 , V_69 , V_157 , V_156 ) ;
if ( V_114 == 0 ) {
F_102 ( V_69 ) ;
F_103 ( & V_69 -> V_163 ,
L_26 , & F_43 ) ;
} else {
V_154 -> V_159 -> V_164 ( V_19 , V_69 ) ;
F_104 ( L_27 , V_157 , V_114 ) ;
V_69 = F_77 ( V_114 ) ;
}
} else
F_104 ( L_28 , V_157 ) ;
...
void F_106 ( const struct V_18 * V_19 , struct V_20 * V_165 )
{
F_107 ( V_19 , F_12 ( V_165 ) ) ;
}
struct V_166 * F_108 ( const struct V_18 * V_19 )
{
return F_109 ( & V_19 -> V_135 , & V_167 ) ;
}
static void * F_110 ( const struct V_168 * V_169 ,
struct V_170 * V_102 )
{
struct V_166 * V_171 ;
V_171 = F_111 ( V_169 , V_102 ) ;
if ( ! F_88 ( V_171 ) ) {
int V_59 ;
for ( V_59 = 0 ; V_59 < F_44 ( V_171 -> V_172 ) ; ++ V_59 )
F_112 ( & V_171 -> V_172 [ V_59 ] . V_173 ) ;
}
return V_171 ;
}
static void F_113 ( const struct V_168 * V_169 ,
struct V_170 * V_102 , void * V_174 )
{
struct V_166 * V_171 ;
int V_59 ;
V_171 = V_174 ;
for ( V_59 = 0 ; V_59 < F_44 ( V_171 -> V_172 ) ; ++ V_59 )
F_114 ( & V_171 -> V_172 [ V_59 ] . V_173 ) ;
F_115 ( V_169 , V_102 , V_174 ) ;
}
static void F_116 ( const struct V_168 * V_169 ,
struct V_170 * V_102 , void * V_174 )
{
struct V_166 * V_171 = V_174 ;
int V_59 ;
for ( V_59 = 0 ; V_59 < F_44 ( V_171 -> V_172 ) ; ++ V_59 ) {
F_32 ( V_171 -> V_172 [ V_59 ] . V_175 == 0 ) ;
F_32 ( V_171 -> V_172 [ V_59 ] . V_176 == 0 ) ;
F_32 ( V_171 -> V_172 [ V_59 ] . V_177 == 0 ) ;
F_32 ( V_171 -> V_172 [ V_59 ] . V_178 == 0 ) ;
F_114 ( & V_171 -> V_172 [ V_59 ] . V_173 ) ;
F_112 ( & V_171 -> V_172 [ V_59 ] . V_173 ) ;
}
}
