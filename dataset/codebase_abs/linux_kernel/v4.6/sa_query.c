...
break;
case V_269 :
V_2 -> V_91 ( V_2 , - V_270 , NULL ) ;
break;
case V_108 :
V_2 -> V_91 ( V_2 , - V_271 , NULL ) ;
break;
default:
...
static void F_127 ( struct V_183 * V_105 ,
struct V_126 * V_103 ,
struct V_272 * V_273 )
{
struct V_1 * V_2 ;
...
V_2 = V_103 -> V_11 [ 0 ] ;
if ( V_2 -> V_91 ) {
if ( V_273 -> V_274 -> V_90 == V_104 )
V_2 -> V_91 ( V_2 ,
V_273 -> V_275 . V_13 -> V_99 . V_90 ?
- V_219 : 0 ,
(struct V_12 * ) V_273 -> V_275 . V_13 ) ;
else
V_2 -> V_91 ( V_2 , - V_78 , NULL ) ;
}
F_128 ( V_273 ) ;
}
static void F_129 ( struct V_186 * V_23 )
{
struct V_172 * V_173 ;
...
( V_277 - V_276 + 1 ) * sizeof ( struct V_135 ) ,
V_142 ) ;
if ( ! V_173 )
return;
V_173 -> V_176 = V_276 ;
V_173 -> V_280 = V_277 ;
for ( V_278 = 0 ; V_278 <= V_277 - V_276 ; ++ V_278 ) {
F_132 ( & V_173 -> V_21 [ V_278 ] . V_161 ) ;
if ( ! F_67 ( V_23 , V_278 + 1 ) )
continue;
V_173 -> V_21 [ V_278 ] . V_132 = NULL ;
V_173 -> V_21 [ V_278 ] . V_26 = V_278 + V_276 ;
V_173 -> V_21 [ V_278 ] . V_22 =
F_133 ( V_23 , V_278 + V_276 , V_281 ,
NULL , 0 , F_36 ,
F_127 , V_173 , 0 ) ;
if ( F_61 ( V_173 -> V_21 [ V_278 ] . V_22 ) )
goto V_282;
F_134 ( & V_173 -> V_21 [ V_278 ] . V_136 , F_52 ) ;
V_279 ++ ;
}
if ( ! V_279 )
goto free;
F_135 ( V_23 , & V_187 , V_173 ) ;
F_136 ( & V_173 -> V_174 , V_23 , F_65 ) ;
if ( F_137 ( & V_173 -> V_174 ) )
goto V_282;
for ( V_278 = 0 ; V_278 <= V_277 - V_276 ; ++ V_278 ) {
if ( F_67 ( V_23 , V_278 + 1 ) )
F_52 ( & V_173 -> V_21 [ V_278 ] . V_136 ) ;
}
return;
V_282:
while ( -- V_278 >= 0 ) {
if ( F_67 ( V_23 , V_278 + 1 ) )
F_138 ( V_173 -> V_21 [ V_278 ] . V_22 ) ;
}
free:
F_51 ( V_173 ) ;
return;
}
static void F_139 ( struct V_186 * V_23 , void * V_283 )
{
struct V_172 * V_173 = V_283 ;
int V_278 ;
if ( ! V_173 )
return;
F_140 ( & V_173 -> V_174 ) ;
F_141 ( V_177 ) ;
for ( V_278 = 0 ; V_278 <= V_173 -> V_280 - V_173 -> V_176 ; ++ V_278 ) {
if ( F_67 ( V_23 , V_278 + 1 ) ) {
F_138 ( V_173 -> V_21 [ V_278 ] . V_22 ) ;
if ( V_173 -> V_21 [ V_278 ] . V_132 )
F_63 ( & V_173 -> V_21 [ V_278 ] . V_132 -> V_133 , F_48 ) ;
}
}
F_51 ( V_173 ) ;
}
