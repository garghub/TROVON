...
enum V_363 type , char * V_366 )
{
struct V_21 * V_367 =
V_7 -> V_12 . V_23 ;
int V_9 , V_368 , V_87 = 0 ;
switch ( type ) {
case V_365 :
V_368 = F_85 ( F_86 ( V_7 -> V_90 ,
V_325 ,
V_326 ) ,
V_327 ,
V_328 ) ;
for ( V_9 = 0 ; V_9 < V_367 -> V_16 ; V_9 ++ )
V_87 += sprintf ( V_366 + V_87 , L_38 ,
V_9 , V_367 -> V_17 [ V_9 ] . V_26 / 100 ,
( V_9 == V_368 ) ? L_39 : L_40 ) ;
break;
default:
break;
...
static int F_95 ( struct V_6 * V_7 , const struct V_2 * V_369 ,
T_8 V_370 , T_1 V_314 ,
T_9 * V_198 )
{
...
T_1 V_371 ;
T_1 V_9 ;
if ( V_198 == NULL || V_7 == NULL || V_369 == NULL )
return - V_124 ;
V_349 = (struct V_36 * ) ( V_7 -> V_37 ) ;
V_309 = F_2 ( V_369 ) ;
V_371 = V_314 > V_309 -> V_198 - 1 ? V_309 -> V_198 - 1 : V_314 ;
V_198 -> V_372 = V_309 -> V_311 [ V_371 ] . V_159 ;
if ( V_370 == V_373 ) {
for ( V_9 = 1 ; V_9 < V_309 -> V_198 ; V_9 ++ ) {
if ( V_309 -> V_311 [ V_9 ] . V_159 > V_349 -> V_62 ) {
V_198 -> V_372 = V_309 -> V_311 [ V_9 ] . V_159 ;
break;
}
}
}
if ( V_371 == 0 )
V_198 -> V_374 = V_349 -> V_42 . V_102 [ V_141 - 1 ] ;
else
V_198 -> V_374 = V_349 -> V_42 . V_102 [ 0 ] ;
V_198 -> V_99 = ( F_13 ( V_7 , V_309 -> V_311 [ V_371 ] . V_160 ) + 2 ) / 4 ;
V_198 -> V_375 = 0 ;
V_198 -> V_376 = 0 ;
return 0 ;
}
static int F_96 ( struct V_6 * V_7 ,
const struct V_2 * V_369 , struct V_377 * V_315 )
{
const struct V_1 * V_309 = F_2 ( V_369 ) ;
V_315 -> V_378 = V_309 -> V_311 [ 0 ] . V_159 / ( 1 << ( V_309 -> V_311 [ 0 ] . V_162 ) ) ;
V_315 -> V_379 = V_309 -> V_311 [ V_309 -> V_198 - 1 ] . V_159 / ( 1 << ( V_309 -> V_311 [ V_309 -> V_198 - 1 ] . V_162 ) ) ;
return 0 ;
}
static int F_97 ( struct V_6 * V_7 , enum V_380 type ,
struct V_381 * V_267 )
{
