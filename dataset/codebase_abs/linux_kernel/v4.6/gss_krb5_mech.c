...
int V_58 ;
F_18 ( L_8 , V_64 ) ;
V_67 = F_23 ( V_17 -> V_28 -> V_72 , 0 , 0 ) ;
if ( F_7 ( V_67 ) ) {
F_18 ( L_9 ,
V_64 , F_16 ( V_67 ) , V_17 -> V_28 -> V_72 ) ;
V_58 = F_16 ( V_67 ) ;
goto V_21;
}
...
if ( V_58 )
goto V_73;
V_71 = F_25 ( sizeof( * V_71 ) + F_26 ( V_67 ) ,
V_74 ) ;
if ( ! V_71 ) {
F_18 ( L_10 ,
V_64 , V_17 -> V_28 -> V_72 ) ;
...
V_71 -> V_75 = V_67 ;
V_71 -> V_76 = 0 ;
V_58 = F_27 ( V_71 , V_68 , V_69 , V_17 -> V_63 ) ;
F_28 ( V_71 ) ;
if ( V_58 )
goto V_73;
...
{
int V_97 ;
V_6 = F_3 ( V_6 , V_7 , & V_17 -> V_76 , sizeof( V_17 -> V_76 ) ) ;
if ( F_7 ( V_6 ) )
goto V_21;
V_17 -> V_34 = V_17 -> V_76 & V_98 ;
V_6 = F_3 ( V_6 , V_7 , & V_17 -> V_39 , sizeof( V_17 -> V_39 ) ) ;
if ( F_7 ( V_6 ) )
goto V_21;
V_6 = F_3 ( V_6 , V_7 , & V_17 -> V_99 , sizeof( V_17 -> V_99 ) ) ;
if ( F_7 ( V_6 ) )
goto V_21;
V_17 -> V_40 = V_17 -> V_99 ;
if ( V_17 -> V_99 != V_17 -> V_40 ) {
F_18 ( L_20 , V_64 ,
( unsigned long ) V_17 -> V_99 , V_17 -> V_40 ) ;
V_6 = F_5 ( - V_27 ) ;
goto V_21;
}
...
V_97 = V_17 -> V_28 -> V_49 ;
V_6 = F_3 ( V_6 , V_7 , V_17 -> V_59 , V_97 ) ;
if ( F_7 ( V_6 ) )
goto V_21;
if ( V_6 != V_7 ) {
V_6 = F_5 ( - V_27 ) ;
...
V_17 -> V_41 . V_13 = F_8 ( V_102 . V_103 . V_13 ,
V_102 . V_103 . V_9 , V_54 ) ;
if ( F_4 ( V_17 -> V_41 . V_13 == NULL ) ) {
V_6 = F_5 ( - V_15 ) ;
goto V_21;
}
V_17 -> V_41 . V_9 = V_102 . V_103 . V_9 ;
switch ( V_17 -> V_35 ) {
case V_101 :
...
return - V_15 ;
if ( V_9 == 85 )
V_107 = F_15 ( V_6 , V_7 , V_17 ) ;
else
V_107 = F_31 ( V_6 , V_7 , V_17 , V_54 ) ;
if ( V_107 == 0 ) {
V_106 -> V_108 = V_17 ;
if ( V_39 )
* V_39 = V_17 -> V_39 ;
...
F_13 ( V_17 ) ;
F_18 ( L_12 , V_64 , V_107 ) ;
return V_107 ;
}
static void
F_34 ( void * V_109 ) {
struct V_16 * V_110 = V_109 ;
F_14 ( V_110 -> V_44 ) ;
F_14 ( V_110 -> V_42 ) ;
F_14 ( V_110 -> V_84 ) ;
F_14 ( V_110 -> V_80 ) ;
