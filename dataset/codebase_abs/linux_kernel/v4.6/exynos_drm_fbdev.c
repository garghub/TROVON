...
V_11 = F_19 ( V_22 , V_71 , V_20 ) ;
if ( F_8 ( V_11 ) && F_20 ( V_22 ) ) {
F_21 ( & V_63 -> V_22 , L_5 ) ;
V_11 = F_19 ( V_22 , V_72 ,
V_20 ) ;
}
...
static bool F_26 ( struct V_59 * V_22 )
{
struct V_76 * V_77 ;
bool V_13 = false ;
F_18 ( & V_22 -> V_78 . V_79 ) ;
...
if ( ! F_26 ( V_22 ) )
return 0 ;
V_82 = F_29 ( sizeof( * V_82 ) , V_88 ) ;
if ( ! V_82 )
return - V_89 ;
V_84 -> V_90 = V_6 = & V_82 -> V_5 ;
F_30 ( V_22 , V_6 , & V_91 ) ;
V_86 = V_22 -> V_78 . V_86 ;
V_13 = F_31 ( V_22 , V_6 , V_86 , V_92 ) ;
if ( V_13 < 0 ) {
F_5 ( L_7 ) ;
goto V_93;
}
