...
( ( V_87 * ) V_8 -> V_4 ) [ 2 ] = F_79 ( ( ( V_87 * ) V_8 -> V_4 ) [ 2 ] ) ;
F_19 ( & V_79 -> V_79 , L_26 ,
( ( V_87 * ) V_8 -> V_4 ) [ 2 ] , F_79 ( ( ( V_87 * ) V_8 -> V_4 ) [ 2 ] ) ) ;
V_8 -> V_88 = F_80 ( V_89 ) ;
F_81 ( V_8 ) ;
...
static int F_105 ( struct V_78 * V_79 )
{
struct V_57 * V_27 = F_106 ( V_79 -> V_79 . V_61 ) ;
struct V_22 * V_23 = F_18 ( V_27 ) ;
int V_112 ;
V_112 = F_107 ( V_27 , 1 ) ;
if ( V_112 < 0 ) {
...
static int F_113 ( struct V_78 * V_79 , int V_113 )
{
...
static int F_114 ( struct V_7 * V_8 , struct V_78 * V_79 )
{
struct V_57 * V_27 = F_106 ( V_79 -> V_79 . V_61 ) ;
struct V_22 * V_23 = F_18 ( V_27 ) ;
struct V_1 * V_2 ;
if ( ( V_8 -> V_88 != F_80 ( V_89 ) ) ||
( V_8 -> V_77 < V_82 ) )
goto V_118;
if ( ( V_8 -> V_77 & 3 ) && F_115 ( V_8 , 4 - ( V_8 -> V_77 & 3 ) ) )
goto V_118;
if ( F_116 ( V_8 , 0 ) )
goto V_118;
( ( V_87 * ) V_8 -> V_4 ) [ 2 ] = F_80 ( ( ( V_87 * ) V_8 -> V_4 ) [ 2 ] ) ;
V_2 = F_15 ( V_23 , V_8 , V_98 ) ;
if ( ! V_2 ) {
F_19 ( & V_27 -> V_28 , L_54 ) ;
goto V_118;
...
static void F_120 ( struct V_78 * V_79 )
{
V_79 -> V_124 = 0 ;
V_79 -> V_125 = & V_126 ;
V_79 -> type = V_127 ;
V_79 -> V_24 = V_128 | V_129 ;
V_79 -> V_117 = V_130 ;
V_79 -> V_131 = 1 ;
V_79 -> V_132 [ 0 ] = V_133 ;
V_79 -> V_134 = 1 ;
...
static int F_121 ( struct V_28 * V_79 )
{
static const char V_139 [] = L_60 ;
struct V_57 * V_27 = F_106 ( V_79 ) ;
struct V_22 * V_23 ;
int V_112 ;
...
if ( V_23 -> V_37 < 0 ) {
V_112 = V_23 -> V_37 ;
F_58 ( V_79 , L_63 , V_112 ) ;
goto V_36;
}
V_23 -> V_26 = F_129 ( V_27 , L_64 ) ;
if ( V_23 -> V_26 < 0 ) {
V_112 = V_23 -> V_26 ;
F_58 ( V_79 , L_65 , V_112 ) ;
goto V_36;
}
V_112 = F_30 ( V_23 ) ;
if ( V_112 < 0 ) {
...
F_131 ( V_23 -> V_62 , V_79 ) ;
F_52 ( V_23 -> V_62 ) ;
V_112 = F_132 ( V_23 -> V_62 ) ;
if ( V_112 < 0 ) {
F_58 ( V_79 , L_68 , V_112 ) ;
goto V_99;
}
...
static int F_134 ( struct V_28 * V_79 )
{
struct V_57 * V_27 = F_106 ( V_79 ) ;
struct V_22 * V_23 = F_18 ( V_27 ) ;
F_26 ( & V_23 -> V_30 ) ;
