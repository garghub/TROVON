...
static int F_53 ( struct V_12 * V_17 )
{
int V_58 = - V_59 ;
F_54 ( & V_60 ) ;
V_58 = F_55 ( & V_61 , V_17 , 1 , V_62 , V_63 ) ;
if ( V_58 >= 0 ) {
V_17 -> V_64 = V_58 ;
} else if ( V_58 == - V_65 ) {
F_56 ( V_66 L_1 ) ;
...
static struct V_13 * F_60 ( int V_64 )
{
...
F_64 ( & V_17 -> V_30 ) ;
V_17 -> V_47 = V_72 ;
V_18 = F_65 ( V_14 , F_40 , V_17 ) ;
if ( V_18 )
return V_18 ;
return F_66 ( V_68 , V_14 , V_70 , V_71 ) ;
}
...
static void F_72 ( struct V_76 * V_27 )
{
T_7 * V_77 ;
if ( ! F_73 ( V_27 ) ||
! F_74 ( V_78 , & V_27 -> V_79 -> V_3 ) )
return;
V_77 = F_50 ( V_27 ) ;
if ( V_77 && F_75 ( V_77 ) )
F_49 ( V_77 , V_80 | V_81 | V_82 ) ;
}
static void F_76 ( struct V_76 * V_27 )
{
F_77 ( & V_27 -> V_42 ) ;
}
static int F_78 ( struct V_83 * V_83 , struct V_16 * V_16 )
{
...
goto V_20;
V_18 = - V_59 ;
V_2 = (struct V_1 * ) F_80 ( V_67 , V_88 , V_63 ,
& V_89 , 0 ) ;
if ( ! V_2 )
goto V_20;
...
static int F_85 ( struct V_83 * V_83 , struct V_16 * V_16 )
{
struct V_1 * V_2 = V_16 -> V_28 ;
F_25 ( V_2 ) ;
return 0 ;
}
static unsigned int F_86 ( struct V_16 * V_16 , T_8 * V_91 )
{
struct V_1 * V_2 = V_16 -> V_28 ;
...
goto V_20;
V_106 = 0 ;
F_87 ( V_16 , & V_2 -> V_90 . V_91 , V_91 ) ;
if ( ! F_88 ( & V_2 -> V_27 . V_42 ) )
V_106 |= V_54 | V_55 ;
if ( F_73 ( & V_2 -> V_27 ) ||
( ! F_89 ( V_78 , & V_2 -> V_76 . V_3 ) &&
F_73 ( & V_2 -> V_27 ) ) )
V_106 |= V_80 | V_81 ;
V_20:
return V_106 ;
}
static inline struct V_33 * F_90 ( struct V_76 * V_27 , T_9 V_108 ,
T_9 V_109 , T_9 V_110 ,
int V_111 , int * V_18 )
{
struct V_33 * V_34 ;
...
V_110 = V_109 ;
V_34 = F_91 ( V_27 , V_108 + V_110 , V_109 - V_110 , V_111 ,
V_18 , 0 ) ;
if ( ! V_34 )
return NULL ;
F_92 ( V_34 , V_108 ) ;
...
if ( V_114 -> V_3 & V_126 ) {
if ( ! F_95 ( V_34 , F_8 ( V_2 , V_114 -> V_127 ) ,
F_8 ( V_2 , V_114 -> V_128 ) ) )
return - V_9 ;
}
if ( V_114 -> V_115 != V_116 ) {
F_96 ( V_34 ) -> V_125 = F_8 ( V_2 , V_114 -> V_125 ) ;
F_96 ( V_34 ) -> V_115 = V_115 ;
F_96 ( V_34 ) -> V_115 |= V_129 ;
F_96 ( V_34 ) -> V_130 = 0 ;
}
return 0 ;
}
...
if ( F_98 ( V_34 ) ) {
struct V_131 * V_132 = F_96 ( V_34 ) ;
V_114 -> V_133 = F_10 ( V_2 , F_99 ( V_34 ) ) ;
...
static T_10 F_103 ( struct V_1 * V_2 , struct V_137 * V_138 ,
struct V_139 * V_140 , int V_111 )
{
int V_141 = F_104 ( V_142 ) ;
struct V_33 * V_34 ;
struct V_12 * V_17 ;
unsigned long V_143 = F_105 ( V_140 ) ;
...
V_109 -= V_144 ;
V_18 = - V_7 ;
V_148 = F_106 ( & V_114 , sizeof( V_114 ) , V_140 ) ;
if ( V_148 != sizeof( V_114 ) )
goto V_18;
F_107 ( V_140 , V_144 - sizeof( V_114 ) ) ;
if ( ( V_114 . V_3 & V_126 ) &&
F_8 ( V_2 , V_114 . V_127 ) +
...
if ( F_37 ( V_109 < V_45 ) )
goto V_18;
if ( V_138 && V_138 -> V_149 && F_108 ( & V_2 -> V_27 , V_105 ) ) {
struct V_139 V_150 ;
V_145 = V_114 . V_133 ?
...
V_34 = F_90 ( & V_2 -> V_27 , V_142 , V_145 ,
V_110 , V_111 , & V_18 ) ;
if ( ! V_34 )
goto V_18;
if ( V_147 )
V_18 = F_110 ( V_34 , V_140 ) ;
else {
V_18 = F_111 ( V_34 , 0 , V_140 , V_109 ) ;
...
F_112 ( V_34 , V_45 ) ;
F_113 ( V_34 ) ;
V_34 -> V_158 = F_114 ( V_34 ) -> V_159 ;
if ( V_144 ) {
V_18 = F_94 ( V_2 , V_34 , & V_114 ) ;
if ( V_18 )
goto V_157;
}
F_115 ( V_34 , V_45 ) ;
if ( ( V_34 -> V_158 == F_116 ( V_160 ) ||
V_34 -> V_158 == F_116 ( V_161 ) ) &&
F_117 ( V_34 , V_34 -> V_158 , & V_146 ) != 0 )
F_112 ( V_34 , V_146 ) ;
F_118 () ;
V_17 = F_13 ( V_2 -> V_17 ) ;
if ( V_147 ) {
F_96 ( V_34 ) -> V_162 = V_138 -> V_149 ;
F_96 ( V_34 ) -> V_163 |= V_164 ;
F_96 ( V_34 ) -> V_163 |= V_165 ;
}
if ( V_17 ) {
V_34 -> V_14 = V_17 -> V_14 ;
F_119 ( V_34 ) ;
...
V_17 = F_13 ( V_2 -> V_17 ) ;
if ( V_17 )
F_121 ( V_17 -> V_166 -> V_167 ) ;
F_120 () ;
return V_18 ;
}
static T_10 F_122 ( struct V_168 * V_169 , struct V_139 * V_140 )
{
struct V_16 * V_16 = V_169 -> V_170 ;
struct V_1 * V_2 = V_16 -> V_28 ;
return F_103 ( V_2 , NULL , V_140 , V_16 -> V_171 & V_172 ) ;
}
...
struct V_102 V_114 ;
V_144 = V_2 -> V_101 ;
if ( F_105 ( V_173 ) < V_144 )
return - V_9 ;
F_97 ( V_2 , V_34 , & V_114 ) ;
if ( F_124 ( & V_114 , sizeof( V_114 ) , V_173 ) !=
sizeof( V_114 ) )
return - V_7 ;
F_107 ( V_173 , V_144 - sizeof( V_114 ) ) ;
}
V_176 = V_144 ;
V_176 += V_34 -> V_109 ;
if ( F_101 ( V_34 ) ) {
...
V_179 . V_178 = F_116 ( F_125 ( V_34 ) ) ;
V_175 = F_126 ( struct V_181 , V_177 ) ;
V_176 += V_134 ;
V_174 = F_127 ( V_34 , 0 , V_173 , V_175 ) ;
if ( V_174 || ! F_105 ( V_173 ) )
goto V_182;
V_174 = F_124 ( & V_179 , sizeof( V_179 ) , V_173 ) ;
if ( V_174 != sizeof( V_179 ) || ! F_105 ( V_173 ) )
goto V_182;
}
V_174 = F_127 ( V_34 , V_175 , V_173 ,
V_34 -> V_109 - V_175 ) ;
V_182:
return V_174 ? V_174 : V_176 ;
}
static T_10 F_128 ( struct V_1 * V_2 ,
struct V_139 * V_183 ,
int V_111 )
{
F_129 ( V_91 ) ;
...
while ( 1 ) {
if ( ! V_111 )
F_130 ( F_50 ( & V_2 -> V_27 ) , & V_91 ,
V_184 ) ;
V_34 = F_131 ( & V_2 -> V_27 . V_42 ) ;
if ( V_34 )
break;
if ( V_111 ) {
V_174 = - V_185 ;
...
struct V_16 * V_16 = V_169 -> V_170 ;
struct V_1 * V_2 = V_16 -> V_28 ;
T_10 V_109 = F_105 ( V_183 ) , V_174 ;
V_174 = F_128 ( V_2 , V_183 , V_16 -> V_171 & V_172 ) ;
...
return F_103 ( V_2 , V_138 , & V_138 -> V_238 , V_138 -> V_239 & V_240 ) ;
}
...
if ( V_3 & ~ ( V_240 | V_241 ) )
return - V_9 ;
V_174 = F_128 ( V_2 , & V_138 -> V_238 , V_3 & V_240 ) ;
if ( V_174 > V_143 ) {
V_138 -> V_239 |= V_241 ;
