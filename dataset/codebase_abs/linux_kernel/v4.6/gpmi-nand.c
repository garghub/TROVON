...
V_8 -> V_14 = 10 ;
V_8 -> V_16 = V_10 -> V_33 / V_8 -> V_32 ;
V_8 -> V_34 = V_10 -> V_33 + V_8 -> V_14 +
( V_8 -> V_15 * V_8 -> V_12 * V_8 -> V_16 ) / 8 ;
if ( V_8 -> V_34 < V_10 -> V_33 + V_10 -> V_13 ) {
V_22 -> V_35 = V_8 -> V_34 - V_10 -> V_33 ;
V_22 -> V_36 = V_10 -> V_13 - V_22 -> V_35 ;
}
V_8 -> V_37 = V_10 -> V_33 ;
V_8 -> V_38 = F_13 ( V_8 -> V_14 , 4 ) ;
V_8 -> V_39 = F_13 ( V_8 -> V_14 , 4 )
+ F_13 ( V_8 -> V_16 , 4 ) ;
if ( ! V_4 -> V_40 )
return 0 ;
V_25 = V_10 -> V_33 * 8 -
...
V_8 -> V_34 = V_10 -> V_33 + V_10 -> V_13 ;
V_8 -> V_37 = V_10 -> V_33 ;
V_14 = F_13 ( V_8 -> V_14 , 4 ) ;
V_42 = F_13 ( V_8 -> V_16 , 4 ) ;
V_8 -> V_39 = V_14 + V_42 ;
V_8 -> V_38 = V_14 ;
if ( ! V_4 -> V_40 )
return 0 ;
...
V_51 = F_22 ( V_4 -> V_31 , V_49 , 1 , V_47 ) ;
if ( V_51 == 0 )
goto V_54;
V_4 -> V_55 = true ;
return;
...
switch ( V_4 -> V_62 ) {
case V_63 :
F_24 ( V_4 -> V_31 , & V_4 -> V_64 , 1 , V_57 ) ;
break;
case V_65 :
F_24 ( V_4 -> V_31 , & V_4 -> V_50 , 1 , V_66 ) ;
if ( V_4 -> V_55 == false )
memcpy ( V_4 -> V_52 , V_4 -> V_56 ,
V_4 -> V_53 ) ;
break;
case V_67 :
F_24 ( V_4 -> V_31 , & V_4 -> V_50 , 1 , V_57 ) ;
break;
case V_68 :
case V_69 :
break;
...
if ( ! V_84 ) {
F_11 ( V_4 -> V_31 , L_10 , V_78 ) ;
return - V_95 ;
}
V_93 = F_39 ( V_4 -> V_31 , V_84 -> V_96 , V_91 , 0 , V_78 , V_4 ) ;
if ( V_93 )
F_11 ( V_4 -> V_31 , L_11 ) ;
return V_93 ;
}
...
struct V_101 * V_101 ;
int V_93 , V_97 ;
V_84 -> clock [ 0 ] = F_45 ( V_4 -> V_31 , L_14 ) ;
...
break;
V_101 = F_45 ( V_4 -> V_31 , V_100 [ V_97 - 1 ] ) ;
if ( F_36 ( V_101 ) ) {
V_93 = F_37 ( V_101 ) ;
goto V_102;
}
...
void * V_117 , unsigned V_36 ,
void * V_118 , T_4 V_119 , unsigned V_120 ,
void * * V_121 , T_4 * V_122 )
{
struct V_123 * V_31 = V_4 -> V_31 ;
if ( F_19 ( V_117 ) ) {
T_4 V_124 ;
V_124 = F_54 ( V_31 , V_117 ,
V_36 , V_66 ) ;
if ( F_55 ( V_31 , V_124 ) ) {
if ( V_120 < V_36 ) {
F_11 ( V_31 , L_16 ) ;
...
{
if ( ! V_4 -> V_55 )
memcpy ( V_117 , V_118 , V_36 ) ;
}
static int F_59 ( struct V_3 * V_4 ,
const void * V_129 , unsigned V_36 ,
void * V_118 , T_4 V_119 , unsigned V_120 ,
...
if ( F_19 ( V_129 ) ) {
T_4 V_130 ;
V_130 = F_54 ( V_31 , ( void * ) V_129 , V_36 ,
V_57 ) ;
if ( F_55 ( V_31 , V_130 ) ) {
if ( V_120 < V_36 ) {
F_11 ( V_31 , L_16 ) ;
...
if ( V_4 -> V_134 == NULL )
goto V_139;
V_4 -> V_56 = F_65 ( V_10 -> V_33 ? : V_136 ,
V_137 | V_138 ) ;
if ( V_4 -> V_56 == NULL )
goto V_139;
V_4 -> V_132 = V_8 -> V_37 + V_8 -> V_39 ;
V_4 -> V_131 = F_66 ( V_31 , V_4 -> V_132 ,
& V_4 -> V_133 , V_137 ) ;
if ( ! V_4 -> V_131 )
goto V_139;
V_4 -> V_135 = F_65 ( V_10 -> V_33 + V_10 -> V_13 , V_138 ) ;
if ( ! V_4 -> V_135 )
goto V_139;
V_4 -> V_140 = V_4 -> V_131 ;
V_4 -> V_141 = V_4 -> V_133 ;
V_4 -> V_142 = V_4 -> V_140 + V_8 -> V_37 ;
V_4 -> V_143 = V_4 -> V_141 + V_8 -> V_37 ;
return 0 ;
V_139:
F_61 ( V_4 ) ;
return - V_125 ;
...
int V_51 ;
F_48 ( V_4 -> V_31 , L_19 , V_163 ) ;
V_51 = F_53 ( V_4 , V_152 , V_156 -> V_37 ,
V_4 -> V_140 , V_4 -> V_141 ,
V_156 -> V_37 ,
& V_140 , & V_141 ) ;
if ( V_51 ) {
...
F_56 ( V_4 , V_152 , V_156 -> V_37 ,
V_4 -> V_140 , V_4 -> V_141 ,
V_156 -> V_37 ,
V_140 , V_141 ) ;
if ( V_51 ) {
F_11 ( V_4 -> V_31 , L_21 , V_51 ) ;
return V_51 ;
}
...
V_8 -> V_16 = V_178 ;
V_8 -> V_37 = V_178 * V_175 ;
V_8 -> V_34 = V_34 ;
V_8 -> V_38 = F_13 ( V_177 , 4 ) ;
F_48 ( V_4 -> V_31 , L_23 ,
V_163 , V_173 , V_153 , V_187 , V_183 , V_178 , V_34 ) ;
V_4 -> V_40 = false ;
...
F_48 ( V_4 -> V_31 , L_24 ) ;
if ( V_4 -> V_40 ) {
memcpy ( V_4 -> V_140 , V_152 , V_10 -> V_33 ) ;
V_140 = V_4 -> V_140 ;
V_141 = V_4 -> V_141 ;
...
{
struct V_3 * V_4 = F_69 ( V_20 ) ;
F_48 ( V_4 -> V_31 , L_28 , V_163 ) ;
memset ( V_20 -> V_172 , ~ 0 , V_10 -> V_13 ) ;
V_20 -> V_189 ( V_10 , V_197 , V_10 -> V_33 , V_163 ) ;
...
if ( ! F_95 ( V_20 ) )
return - V_201 ;
V_20 -> V_189 ( V_10 , V_202 , V_10 -> V_33 + V_22 -> V_35 , V_163 ) ;
V_20 -> V_203 ( V_10 , V_20 -> V_172 + V_22 -> V_35 , V_22 -> V_36 ) ;
...
if ( V_4 -> V_40 ) {
T_8 V_216 = V_210 [ 0 ] ;
V_210 [ 0 ] = V_210 [ V_10 -> V_33 ] ;
V_210 [ V_10 -> V_33 ] = V_216 ;
}
if ( V_162 )
...
int V_215 ;
if ( ! V_152 || ! V_162 )
memset ( V_210 , 0xff , V_10 -> V_33 + V_10 -> V_13 ) ;
...
V_20 -> V_203 ( V_10 , V_210 , V_10 -> V_33 + V_10 -> V_13 ) ;
return 0 ;
}
...
V_4 -> V_150 = - 1 ;
V_10 -> V_268 = L_47 ;
V_10 -> V_31 . V_269 = V_4 -> V_31 ;
F_114 ( V_20 , V_4 ) ;
F_115 ( V_20 , V_4 -> V_80 -> V_31 . V_43 ) ;
V_20 -> V_222 = F_73 ;
V_20 -> V_270 = F_67 ;
V_20 -> V_271 = F_71 ;
V_20 -> V_199 = F_80 ;
...
V_20 -> V_266 |= V_274 ;
V_4 -> V_40 = ! F_8 ( V_4 ) ;
if ( F_116 ( V_4 -> V_31 -> V_43 ) ) {
V_20 -> V_275 |= V_276 | V_277 ;
if ( F_16 ( V_4 -> V_31 -> V_43 ,
L_48 ) )
V_4 -> V_40 = false ;
}
F_48 ( V_4 -> V_31 , L_49 ,
...
int V_51 ;
V_4 = F_121 ( & V_80 -> V_31 , sizeof( * V_4 ) , V_138 ) ;
if ( ! V_4 )
return - V_125 ;
V_282 = F_122 ( V_283 , & V_80 -> V_31 ) ;
if ( V_282 ) {
...
static int F_127 ( struct V_123 * V_31 )
{
struct V_3 * V_4 = F_128 ( V_31 ) ;
F_40 ( V_4 ) ;
return 0 ;
}
static int F_129 ( struct V_123 * V_31 )
{
struct V_3 * V_4 = F_128 ( V_31 ) ;
int V_51 ;
V_51 = F_42 ( V_4 ) ;
...
V_51 = F_52 ( V_4 ) ;
if ( V_51 ) {
F_11 ( V_4 -> V_31 , L_54 , V_51 ) ;
return V_51 ;
}
V_51 = F_108 ( V_4 ) ;
if ( V_51 ) {
F_11 ( V_4 -> V_31 , L_55 , V_51 ) ;
return V_51 ;
}
F_112 ( V_4 ) ;
return 0 ;
