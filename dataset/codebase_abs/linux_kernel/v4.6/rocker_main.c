...
if ( ! V_207 -> V_241 )
return - V_70 ;
return V_207 -> V_241 ( V_11 , V_240 , V_221 ) ;
}
static int
F_163 ( struct V_11 * V_11 ,
const struct V_239 * V_240 )
{
struct V_204 * V_207 = V_11 -> V_8 -> V_207 ;
if ( ! V_207 -> V_242 )
...
if ( ! V_207 -> V_243 )
return - V_70 ;
return V_207 -> V_243 ( V_11 , V_240 , V_233 ) ;
}
...
if ( ! V_207 -> V_251 )
return - V_70 ;
return V_207 -> V_251 ( V_11 , V_143 , V_144 ) ;
}
static int F_169 ( struct V_116 * V_18 )
{
struct V_11 * V_11 = F_170 ( V_18 ) ;
int V_30 ;
V_30 = F_86 ( V_11 ) ;
if ( V_30 )
return V_30 ;
...
static int F_173 ( struct V_116 * V_18 )
{
struct V_11 * V_11 = F_170 ( V_18 ) ;
F_174 ( V_18 ) ;
F_91 ( V_11 , false ) ;
...
static void F_176 ( const struct V_11 * V_11 ,
const struct V_52 * V_53 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
struct V_13 * V_14 = V_8 -> V_14 ;
...
if ( ! V_118 [ V_258 ] )
return;
F_177 (attr, attrs[ROCKER_TLV_TX_FRAGS], rem) {
const struct V_117 * V_259 [ V_260 + 1 ] ;
T_3 V_22 ;
T_4 V_119 ;
if ( F_178 ( V_190 ) != V_261 )
continue;
F_101 ( V_259 , V_260 ,
V_190 ) ;
if ( ! V_259 [ V_262 ] ||
...
static int F_179 ( const struct V_11 * V_11 ,
struct V_52 * V_53 ,
char * V_23 , T_4 V_108 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
...
static T_12 F_183 ( struct V_106 * V_107 , struct V_116 * V_18 )
{
struct V_11 * V_11 = F_170 ( V_18 ) ;
struct V_8 * V_8 = V_11 -> V_8 ;
struct V_52 * V_53 ;
...
if ( ! V_268 )
goto V_270;
V_30 = F_179 ( V_11 , V_53 ,
V_107 -> V_91 , F_184 ( V_107 ) ) ;
if ( V_30 )
goto V_267;
if ( F_185 ( V_107 ) -> V_271 > V_272 ) {
V_30 = F_186 ( V_107 ) ;
if ( V_30 )
goto V_273;
}
for ( V_26 = 0 ; V_26 < F_185 ( V_107 ) -> V_271 ; V_26 ++ ) {
const T_13 * V_265 = & F_185 ( V_107 ) -> V_268 [ V_26 ] ;
V_30 = F_179 ( V_11 , V_53 ,
F_187 ( V_265 ) ,
F_188 ( V_265 ) ) ;
if ( V_30 )
...
static int F_190 ( struct V_116 * V_18 , void * V_277 )
{
struct V_278 * V_143 = V_277 ;
struct V_11 * V_11 = F_170 ( V_18 ) ;
int V_30 ;
if ( ! F_191 ( V_143 -> V_279 ) )
return - V_280 ;
...
static int F_192 ( struct V_116 * V_18 , int V_283 )
{
struct V_11 * V_11 = F_170 ( V_18 ) ;
int V_284 = F_193 ( V_18 ) ;
int V_30 ;
#define F_194 68
#define F_195 9000
if ( V_283 < F_194 || V_283 > F_195 )
return - V_66 ;
if ( V_284 )
F_173 ( V_18 ) ;
...
static void F_198 ( struct V_247 * V_248 )
{
struct V_11 * V_11 = F_170 ( V_248 -> V_18 ) ;
int V_30 ;
V_30 = F_168 ( V_11 , V_248 ) ;
if ( V_30 )
F_199 ( V_11 -> V_18 , L_31 ,
V_30 ) ;
}
static int F_200 ( struct V_116 * V_18 ,
struct V_287 * V_190 )
{
const struct V_11 * V_11 = F_170 ( V_18 ) ;
const struct V_8 * V_8 = V_11 -> V_8 ;
int V_30 = 0 ;
switch ( V_190 -> V_288 ) {
case V_289 :
V_190 -> V_290 . V_291 . V_292 = sizeof( V_8 -> V_293 . V_288 ) ;
memcpy ( & V_190 -> V_290 . V_291 . V_288 , & V_8 -> V_293 . V_288 , V_190 -> V_290 . V_291 . V_292 ) ;
break;
case V_294 :
V_30 = F_155 ( V_11 ,
& V_190 -> V_290 . V_223 ) ;
...
static int F_208 ( struct V_116 * V_18 ,
struct V_167 * V_168 )
{
struct V_11 * V_11 = F_170 ( V_18 ) ;
return F_136 ( V_11 , V_168 ) ;
}
static int F_209 ( struct V_116 * V_18 ,
struct V_167 * V_168 )
{
struct V_11 * V_11 = F_170 ( V_18 ) ;
return F_139 ( V_11 , V_168 ) ;
}
static void F_210 ( struct V_116 * V_18 ,
struct V_303 * V_304 )
{
F_211 ( V_304 -> V_305 , V_47 , sizeof( V_304 -> V_305 ) ) ;
F_211 ( V_304 -> V_306 , V_307 , sizeof( V_304 -> V_306 ) ) ;
}
static void F_212 ( struct V_116 * V_308 , T_1 V_309 ,
T_10 * V_91 )
{
T_10 * V_277 = V_91 ;
int V_26 ;
switch ( V_309 ) {
case V_310 :
for ( V_26 = 0 ; V_26 < F_213 ( V_311 ) ; V_26 ++ ) {
memcpy ( V_277 , V_311 [ V_26 ] . V_198 , V_312 ) ;
V_277 += V_312 ;
}
break;
}
...
static int
F_215 ( const struct V_11 * V_11 ,
const struct V_52 * V_53 ,
void * V_161 )
{
const struct V_117 * V_118 [ V_169 + 1 ] ;
const struct V_117 * V_316 [ V_317 + 1 ] ;
const struct V_117 * V_318 ;
T_1 V_135 ;
T_2 * V_91 = V_161 ;
int V_26 ;
F_83 ( V_118 , V_169 , V_53 ) ;
...
if ( ! V_316 [ V_315 ] )
return - V_19 ;
V_135 = F_102 ( V_316 [ V_315 ] ) ;
if ( V_135 != V_11 -> V_135 )
return - V_19 ;
for ( V_26 = 0 ; V_26 < F_213 ( V_311 ) ; V_26 ++ ) {
V_318 = V_316 [ V_311 [ V_26 ] . type ] ;
if ( ! V_318 )
continue;
V_91 [ V_26 ] = F_80 ( V_318 ) ;
}
return 0 ;
}
static int F_216 ( struct V_11 * V_11 ,
void * V_161 )
{
return F_114 ( V_11 , false ,
F_214 , NULL ,
...
static void F_217 ( struct V_116 * V_18 ,
struct V_319 * V_275 , T_2 * V_91 )
{
struct V_11 * V_11 = F_170 ( V_18 ) ;
if ( F_216 ( V_11 , V_91 ) != 0 ) {
int V_26 ;
for ( V_26 = 0 ; V_26 < F_213 ( V_311 ) ; ++ V_26 )
V_91 [ V_26 ] = 0 ;
}
}
static int F_218 ( struct V_116 * V_308 , int V_320 )
{
switch ( V_320 ) {
case V_310 :
return V_321 ;
...
static struct V_11 * F_219 ( struct V_322 * V_323 )
{
return F_220 ( V_323 , struct V_11 , V_153 ) ;
}
static int F_221 ( struct V_322 * V_323 , int V_324 )
{
struct V_11 * V_11 = F_219 ( V_323 ) ;
const struct V_8 * V_8 = V_11 -> V_8 ;
const struct V_52 * V_53 ;
T_1 V_83 = 0 ;
int V_30 ;
...
V_107 = F_38 ( V_53 ) ;
if ( V_30 == 0 ) {
V_11 -> V_18 -> V_275 . V_325 ++ ;
V_11 -> V_18 -> V_275 . V_326 += V_107 -> V_119 ;
} else {
V_11 -> V_18 -> V_275 . V_327 ++ ;
}
F_78 ( V_107 ) ;
V_83 ++ ;
}
if ( V_83 && F_222 ( V_11 -> V_18 ) )
F_223 ( V_11 -> V_18 ) ;
F_224 ( V_323 ) ;
F_46 ( V_8 , & V_11 -> V_123 , V_83 ) ;
return 0 ;
}
static int F_225 ( const struct V_8 * V_8 ,
...
return - V_66 ;
if ( V_118 [ V_331 ] )
V_329 = F_81 ( V_118 [ V_331 ] ) ;
F_79 ( V_8 , V_118 ) ;
V_328 = F_81 ( V_118 [ V_330 ] ) ;
F_226 ( V_107 , V_328 ) ;
V_107 -> V_332 = F_227 ( V_107 , V_11 -> V_18 ) ;
if ( V_329 & V_333 )
V_107 -> V_334 = V_11 -> V_18 -> V_334 ;
V_11 -> V_18 -> V_275 . V_335 ++ ;
V_11 -> V_18 -> V_275 . V_336 += V_107 -> V_119 ;
F_228 ( V_107 ) ;
return F_76 ( V_11 , V_53 ) ;
}
static struct V_11 * F_229 ( struct V_322 * V_323 )
{
return F_220 ( V_323 , struct V_11 , V_154 ) ;
}
static int F_230 ( struct V_322 * V_323 , int V_324 )
{
struct V_11 * V_11 = F_229 ( V_323 ) ;
const struct V_8 * V_8 = V_11 -> V_8 ;
struct V_52 * V_53 ;
T_1 V_83 = 0 ;
int V_30 ;
...
static void F_231 ( const struct V_11 * V_11 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
T_2 V_338 = F_23 ( V_8 , V_339 ) ;
bool V_137 ;
V_137 = V_338 & ( 1 << V_11 -> V_135 ) ;
if ( V_137 )
F_96 ( V_11 -> V_18 ) ;
else
F_99 ( V_11 -> V_18 ) ;
}
static void F_232 ( struct V_8 * V_8 )
{
struct V_11 * V_11 ;
int V_26 ;
...
static void F_235 ( struct V_11 * V_11 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
const struct V_13 * V_14 = V_8 -> V_14 ;
int V_30 ;
...
V_11 -> V_18 -> V_281 ) ;
if ( V_30 ) {
F_236 ( & V_14 -> V_18 , L_35 ) ;
F_237 ( V_11 -> V_18 ) ;
}
}
static int F_238 ( struct V_8 * V_8 , unsigned int V_12 )
{
const struct V_13 * V_14 = V_8 -> V_14 ;
struct V_11 * V_11 ;
struct V_116 * V_18 ;
int V_30 ;
V_18 = F_239 ( sizeof( struct V_11 ) ) ;
if ( ! V_18 )
return - V_33 ;
V_11 = F_170 ( V_18 ) ;
V_11 -> V_18 = V_18 ;
...
V_18 -> V_343 = & V_344 ;
V_18 -> V_345 = & V_346 ;
F_240 ( V_18 , & V_11 -> V_153 , F_221 ,
V_347 ) ;
F_241 ( V_18 , & V_11 -> V_154 , F_230 ,
V_347 ) ;
F_231 ( V_11 ) ;
V_18 -> V_348 |= V_349 | V_350 ;
V_30 = F_147 ( V_11 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_37 ) ;
goto V_351;
...
static int F_243 ( struct V_8 * V_8 )
{
int V_26 ;
T_4 V_354 ;
int V_30 ;
V_354 = sizeof( struct V_11 * ) * V_8 -> V_140 ;
V_8 -> V_141 = F_5 ( V_354 , V_5 ) ;
if ( ! V_8 -> V_141 )
return - V_33 ;
for ( V_26 = 0 ; V_26 < V_8 -> V_140 ; V_26 ++ ) {
V_30 = F_238 ( V_8 , V_26 ) ;
...
V_8 -> V_10 [ V_26 ] . V_357 = V_26 ;
V_30 = F_248 ( V_14 , V_8 -> V_10 , V_10 ) ;
if ( V_30 < 0 )
goto V_358;
return 0 ;
V_358:
...
static void F_249 ( const struct V_8 * V_8 )
{
F_250 ( V_8 -> V_14 ) ;
F_7 ( V_8 -> V_10 ) ;
}
static int F_251 ( struct V_13 * V_14 , const struct V_359 * V_288 )
{
struct V_8 * V_8 ;
int V_30 ;
...
V_30 = F_253 ( V_14 , V_47 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_41 ) ;
goto V_361;
}
V_30 = F_254 ( V_14 , F_255 ( 64 ) ) ;
if ( ! V_30 ) {
V_30 = F_256 ( V_14 , F_255 ( 64 ) ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_42 ) ;
goto V_362;
}
} else {
V_30 = F_254 ( V_14 , F_255 ( 32 ) ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_43 ) ;
goto V_362;
}
}
if ( F_257 ( V_14 , 0 ) < V_363 ) {
F_21 ( & V_14 -> V_18 , L_44 ) ;
V_30 = - V_66 ;
goto V_364;
}
V_8 -> V_365 = F_258 ( F_259 ( V_14 , 0 ) ,
F_257 ( V_14 , 0 ) ) ;
if ( ! V_8 -> V_365 ) {
F_21 ( & V_14 -> V_18 , L_45 ) ;
V_30 = - V_19 ;
...
F_19 ( V_8 , V_370 , V_371 ) ;
V_30 = F_69 ( V_8 ) ;
if ( V_30 )
goto V_372;
V_30 = F_33 ( F_12 ( V_8 , V_373 ) ,
F_92 , 0 ,
V_47 , V_8 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_48 ) ;
...
V_8 -> V_293 . V_288 = F_23 ( V_8 , V_377 ) ;
V_30 = F_243 ( V_8 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_50 ) ;
goto V_378;
}
F_262 ( & V_14 -> V_18 , L_51 ,
( int ) sizeof( V_8 -> V_293 . V_288 ) , & V_8 -> V_293 . V_288 ) ;
return 0 ;
V_378:
V_49 ( F_12 ( V_8 , V_375 ) , V_8 ) ;
V_376:
V_49 ( F_12 ( V_8 , V_373 ) , V_8 ) ;
V_374:
F_71 ( V_8 ) ;
V_372:
V_369:
...
static bool F_268 ( const struct V_116 * V_18 )
{
return V_18 -> V_341 == & V_342 ;
}
static int F_269 ( struct V_379 * V_380 ,
unsigned long V_381 , void * V_75 )
{
struct V_116 * V_18 = F_270 ( V_75 ) ;
struct V_382 * V_77 ;
struct V_11 * V_11 ;
int V_30 ;
if ( ! F_268 ( V_18 ) )
...
static int F_271 ( struct V_379 * V_380 ,
unsigned long V_381 , void * V_75 )
{
struct V_11 * V_11 ;
struct V_116 * V_18 ;
struct V_247 * V_248 = V_75 ;
int V_30 ;
switch ( V_381 ) {
case V_387 :
if ( V_248 -> V_388 != & V_389 )
return V_383 ;
V_18 = V_248 -> V_18 ;
if ( ! F_268 ( V_18 ) )
return V_383 ;
V_11 = F_170 ( V_18 ) ;
V_30 = F_167 ( V_11 , V_248 ) ;
if ( V_30 )
F_199 ( V_18 , L_54 ,
V_30 ) ;
break;
