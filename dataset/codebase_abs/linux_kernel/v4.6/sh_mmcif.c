...
V_135 = F_55 ( V_2 , V_8 ) ;
if ( V_2 -> V_85 )
F_38 ( V_2 -> V_5 , V_184 , 0xD80430C0 ) ;
else
F_38 ( V_2 -> V_5 , V_184 , 0xD80430C0 | V_185 ) ;
F_38 ( V_2 -> V_5 , V_115 , V_41 ) ;
F_38 ( V_2 -> V_5 , V_186 , V_126 -> V_6 ) ;
F_59 ( & V_2 -> V_187 , V_127 ) ;
F_38 ( V_2 -> V_5 , V_188 , V_135 ) ;
V_2 -> V_104 = V_189 ;
F_60 ( & V_2 -> V_190 , V_2 -> V_95 ) ;
F_61 ( & V_2 -> V_187 , V_127 ) ;
}
...
default:
F_41 ( V_10 , L_22 ) ;
V_8 -> V_193 -> error = F_39 ( V_2 ) ;
return;
}
V_2 -> V_104 = V_194 ;
}
static void F_63 ( struct V_195 * V_196 , struct V_7 * V_8 )
{
struct V_1 * V_2 = F_64 ( V_196 ) ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
unsigned long V_127 ;
F_59 ( & V_2 -> V_187 , V_127 ) ;
if ( V_2 -> V_103 != V_197 ) {
...
V_205 = F_32 ( V_2 -> V_65 , V_206 / 2 ) ;
if ( V_205 == V_206 )
break;
V_206 = V_205 ;
}
V_2 -> V_73 = 0x3ff ;
V_2 -> V_196 -> V_204 = V_204 / ( 1 << F_67 ( V_2 -> V_73 ) ) ;
V_2 -> V_196 -> V_205 = V_205 / ( 1 << F_34 ( V_2 -> V_73 ) ) ;
} else {
unsigned int V_65 = F_31 ( V_2 -> V_65 ) ;
V_2 -> V_196 -> V_204 = V_65 / 2 ;
V_2 -> V_196 -> V_205 = V_65 / 512 ;
}
F_7 ( V_10 , L_24 ,
V_2 -> V_196 -> V_204 , V_2 -> V_196 -> V_205 ) ;
}
static void F_68 ( struct V_1 * V_2 , struct V_207 * V_208 )
{
struct V_195 * V_196 = V_2 -> V_196 ;
if ( ! F_69 ( V_196 -> V_209 . V_210 ) )
F_70 ( V_196 , V_196 -> V_209 . V_210 ,
V_208 -> V_211 ? V_208 -> V_212 : 0 ) ;
}
static void F_71 ( struct V_195 * V_196 , struct V_207 * V_208 )
{
struct V_1 * V_2 = F_64 ( V_196 ) ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
unsigned long V_127 ;
...
F_30 ( V_2 , V_208 -> clock ) ;
}
V_2 -> V_160 = V_208 -> V_160 ;
V_2 -> V_153 = V_208 -> V_153 ;
V_2 -> V_103 = V_197 ;
}
static int F_76 ( struct V_195 * V_196 )
{
struct V_1 * V_2 = F_64 ( V_196 ) ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
struct V_61 * V_66 = V_10 -> V_60 ;
...
V_2 -> V_95 ) ;
if ( V_11 -> V_127 & V_222 )
F_81 ( V_2 -> V_20 -> V_9 -> V_10 ,
V_11 -> V_15 , V_11 -> V_24 ,
V_25 ) ;
else
F_81 ( V_2 -> V_36 -> V_9 -> V_10 ,
V_11 -> V_15 , V_11 -> V_24 ,
V_38 ) ;
if ( V_2 -> V_96 ) {
F_41 ( V_2 -> V_196 -> V_223 ,
L_26 ) ;
V_11 -> error = F_39 ( V_2 ) ;
} else if ( ! time ) {
F_41 ( V_2 -> V_196 -> V_223 , L_27 ) ;
V_11 -> error = - V_106 ;
} else if ( time < 0 ) {
F_41 ( V_2 -> V_196 -> V_223 ,
L_28 , time ) ;
...
static T_5 F_83 ( int V_225 , void * V_226 )
{
...
if ( V_2 -> V_96 ) {
V_8 -> V_193 -> error = F_39 ( V_2 ) ;
F_7 ( V_10 , L_18 , V_34 , V_8 -> V_193 -> error ) ;
break;
}
F_54 ( V_2 , V_8 -> V_193 ) ;
V_8 -> V_193 -> error = 0 ;
...
static T_5 F_88 ( int V_225 , void * V_226 )
{
struct V_1 * V_2 = V_226 ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
T_1 V_103 , V_41 ;
V_103 = F_37 ( V_2 -> V_5 , V_184 ) ;
V_41 = F_37 ( V_2 -> V_5 , V_115 ) ;
if ( V_2 -> V_85 )
F_38 ( V_2 -> V_5 , V_184 , ~ ( V_103 & V_41 ) ) ;
else
F_38 ( V_2 -> V_5 , V_184 , V_185 | ~ ( V_103 & V_41 ) ) ;
...
static void F_89 ( struct V_238 * V_239 )
{
struct V_240 * V_241 = F_90 ( V_239 ) ;
struct V_1 * V_2 = F_91 ( V_241 , struct V_1 , V_190 ) ;
struct V_7 * V_8 = V_2 -> V_8 ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
unsigned long V_127 ;
if ( V_2 -> V_242 )
...
return;
if ( ! V_196 -> V_244 )
V_196 -> V_244 = V_50 -> V_245 ;
else if ( V_50 -> V_245 )
F_17 ( F_94 ( V_196 ) , L_35 ) ;
}
...
void T_6 * V_3 ;
const char * V_248 ;
V_225 [ 0 ] = F_96 ( V_247 , 0 ) ;
V_225 [ 1 ] = F_96 ( V_247 , 1 ) ;
if ( V_225 [ 0 ] < 0 ) {
F_41 ( V_10 , L_36 ) ;
return - V_249 ;
}
V_47 = F_24 ( V_247 , V_51 , 0 ) ;
V_3 = F_97 ( V_10 , V_47 ) ;
if ( F_69 ( V_3 ) )
return F_98 ( V_3 ) ;
V_196 = F_99 ( sizeof( struct V_1 ) , V_10 ) ;
if ( ! V_196 )
return - V_250 ;
V_23 = F_100 ( V_196 ) ;
if ( V_23 < 0 )
...
V_2 -> V_196 = V_196 ;
V_2 -> V_5 = V_3 ;
V_2 -> V_95 = F_101 ( 10000 ) ;
V_2 -> V_85 = ! V_50 || ! V_50 -> V_252 ;
V_2 -> V_87 = V_50 && V_50 -> V_253 ;
V_2 -> V_50 = V_247 ;
F_102 ( & V_2 -> V_187 ) ;
V_196 -> V_254 = & V_255 ;
F_92 ( V_2 ) ;
...
if ( V_23 < 0 )
goto V_266;
F_107 ( & V_2 -> V_190 , F_89 ) ;
F_36 ( V_2 ) ;
F_38 ( V_2 -> V_5 , V_115 , V_267 ) ;
V_248 = V_225 [ 1 ] < 0 ? F_9 ( V_10 ) : L_38 ;
V_23 = F_108 ( V_10 , V_225 [ 0 ] , F_88 ,
F_83 , 0 , V_248 , V_2 ) ;
if ( V_23 ) {
F_41 ( V_10 , L_39 , V_248 ) ;
goto V_266;
}
if ( V_225 [ 1 ] >= 0 ) {
V_23 = F_108 ( V_10 , V_225 [ 1 ] ,
F_88 , F_83 ,
0 , L_40 , V_2 ) ;
if ( V_23 ) {
F_41 ( V_10 , L_41 ) ;
