...
if ( V_34 < 0 )
goto V_124;
V_25 -> V_125 = F_61 ( V_92 ) ;
if ( F_32 ( V_25 -> V_125 ) ) {
V_34 = F_38 ( V_25 -> V_125 ) ;
goto V_126;
}
V_34 = F_26 ( V_25 ) ;
if ( V_34 < 0 )
...
static int F_73 ( struct V_104 * V_92 )
{
struct V_47 * V_25 = F_74 ( V_92 ) ;
F_75 ( V_25 -> clock [ V_129 ] ) ;
F_75 ( V_25 -> clock [ V_122 ] ) ;
return 0 ;
}
static int F_76 ( struct V_104 * V_92 )
{
struct V_47 * V_25 = F_74 ( V_92 ) ;
F_77 ( V_25 -> clock [ V_122 ] ) ;
F_77 ( V_25 -> clock [ V_129 ] ) ;
return 0 ;
}
