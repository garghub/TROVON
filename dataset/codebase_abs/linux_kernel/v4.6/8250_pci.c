...
struct V_10 * V_11 , int V_27 )
{
struct V_2 * V_180 = V_9 -> V_3 ;
struct V_5 * V_3 = V_11 -> V_11 . V_3 ;
struct V_181 * V_182 ;
struct V_176 * V_183 , * V_184 ;
struct V_2 * V_178 ;
int V_95 ;
V_182 = F_96 ( V_3 , sizeof( * V_182 ) , V_185 ) ;
if ( ! V_182 )
return - V_18 ;
V_183 = F_96 ( V_3 , sizeof( * V_183 ) , V_185 ) ;
if ( ! V_183 )
return - V_18 ;
V_184 = F_96 ( V_3 , sizeof( * V_184 ) , V_185 ) ;
if ( ! V_184 )
return - V_18 ;
switch ( V_180 -> V_5 ) {
case V_186 :
...
V_184 -> V_194 = 1 ;
V_184 -> V_195 = 0 ;
V_182 -> V_196 . V_197 = 16 ;
V_183 -> V_194 = 1 ;
V_183 -> V_195 = 0 ;
V_182 -> V_198 . V_199 = 16 ;
V_178 = F_97 ( V_180 -> V_67 , F_98 ( F_99 ( V_180 -> V_200 ) , 0 ) ) ;
V_184 -> V_178 = & V_178 -> V_3 ;
V_183 -> V_178 = & V_178 -> V_3 ;
V_182 -> V_201 = F_94 ;
V_182 -> V_184 = V_184 ;
V_182 -> V_183 = V_183 ;
V_95 = F_53 ( V_9 , V_26 , V_11 , V_27 ) ;
V_11 -> V_11 . V_19 = V_20 ;
V_11 -> V_11 . type = V_202 ;
V_11 -> V_11 . V_29 = ( V_11 -> V_11 . V_29 | V_152 | V_153 ) ;
V_11 -> V_11 . V_203 = F_88 ;
V_11 -> V_11 . V_204 = 64 ;
V_11 -> V_205 = 64 ;
V_11 -> V_182 = V_182 ;
V_11 -> V_206 = V_207 | V_208 ;
F_19 ( V_209 , V_11 -> V_11 . V_23 + V_210 ) ;
return V_95 ;
}
static int
...
static int F_102 ( struct V_154 * V_11 ,
struct V_212 * V_213 )
{
struct V_2 * V_2 = F_103 ( V_11 -> V_3 ) ;
T_2 V_214 ;
T_2 * V_215 = ( T_2 * ) V_11 -> V_216 ;
F_35 ( V_2 , 0x40 + 8 * * V_215 + 7 , & V_214 ) ;
if ( ! V_213 )
V_213 = & V_11 -> V_213 ;
else if ( V_213 -> V_29 & V_217 )
memset ( V_213 -> V_218 , 0 , sizeof( V_213 -> V_218 ) ) ;
else
memset ( V_213 , 0 , sizeof( * V_213 ) ) ;
V_213 -> V_29 &= V_217 | V_219 ;
if ( V_213 -> V_29 & V_217 ) {
V_214 |= V_220 ;
if ( V_213 -> V_29 & V_219 ) {
V_214 &= ~ V_221 ;
...
T_2 V_224 ;
T_4 V_21 ;
V_224 = 0x40 + 0x08 * V_27 ;
F_105 ( V_180 , V_224 + 4 , & V_21 ) ;
F_16 ( & V_180 -> V_3 , L_21 , V_225 , V_27 , V_21 ) ;
V_11 -> V_11 . V_19 = V_24 ;
V_11 -> V_11 . V_21 = V_21 ;
V_11 -> V_11 . V_226 = F_102 ;
V_54 = F_96 ( & V_180 -> V_3 , sizeof( T_2 ) , V_185 ) ;
if ( ! V_54 )
return - V_18 ;
* V_54 = V_27 ;
V_11 -> V_11 . V_216 = V_54 ;
return 0 ;
}
...
F_15 ( V_3 , 0x24 , & V_228 [ 0 ] ) ;
F_15 ( V_3 , 0x20 , & V_228 [ 1 ] ) ;
F_15 ( V_3 , 0x1c , & V_228 [ 2 ] ) ;
for ( V_60 = 0 ; V_60 < V_227 ; ++ V_60 ) {
V_224 = 0x40 + 0x08 * V_60 ;
V_21 = ( V_228 [ V_60 / 4 ] & 0xffffffe0 ) + ( V_60 % 4 ) * 8 ;
F_36 ( V_3 , V_224 + 0x00 , 0x01 ) ;
F_36 ( V_3 , V_224 + 0x01 , 0x33 ) ;
F_36 ( V_3 , V_224 + 0x04 ,
( T_2 ) ( V_21 & 0xff ) ) ;
F_36 ( V_3 , V_224 + 0x05 ,
( T_2 ) ( ( V_21 & 0xff00 ) >> 8 ) ) ;
F_36 ( V_3 , V_224 + 0x06 , V_3 -> V_229 ) ;
if ( V_9 ) {
V_11 = F_108 ( V_9 -> line [ V_60 ] ) ;
F_102 ( & V_11 -> V_11 , NULL ) ;
} else {
F_36 ( V_3 , V_224 + 0x07 , 0x01 ) ;
}
}
return V_227 ;
}
...
static void F_110 ( struct V_154 * V_44 )
{
struct V_10 * V_231 = F_111 ( V_44 ) ;
F_112 ( V_231 ) ;
}
static unsigned int F_113 ( struct V_154 * V_44 , int V_13 )
{
struct V_10 * V_231 = F_111 ( V_44 ) ;
unsigned int V_122 ;
...
struct V_10 * V_11 , int V_27 )
{
V_11 -> V_11 . V_29 |= V_234 ;
V_11 -> V_11 . V_235 = F_113 ;
V_11 -> V_11 . V_236 = F_110 ;
return F_109 ( V_9 , V_26 , V_11 , V_27 ) ;
}
static int F_115 ( struct V_2 * V_3 )
{
#if F_116 ( V_237 ) || F_116 ( V_238 )
return - V_42 ;
#else
return 0 ;
#endif
...
struct V_10 * V_11 , int V_27 )
{
V_11 -> V_11 . V_29 |= V_239 ;
return F_53 ( V_9 , V_26 , V_11 , V_27 ) ;
}
static inline int
F_118 ( struct V_8 * V_9 )
{
const int V_240 = V_9 -> V_3 -> V_5 ;
return ( ( V_240 == V_241 ) ||
( V_240 == V_242 ) ) ;
}
static int
...
F_28 ( 0x00 , V_44 + V_243 ) ;
F_28 ( V_244 , V_44 + V_245 ) ;
F_28 ( 128 , V_44 + V_246 ) ;
F_28 ( 128 , V_44 + V_247 ) ;
F_21 ( V_44 ) ;
return F_53 ( V_9 , V_26 , V_11 , V_27 ) ;
...
{
V_11 -> V_11 . V_29 |= V_153 ;
V_11 -> V_11 . type = V_252 ;
return F_53 ( V_9 , V_26 , V_11 , V_27 ) ;
}
static inline int F_123 ( T_1 V_253 , T_1 V_240 )
{
return V_253 == V_254 || V_253 == V_240 ;
}
static struct V_255 * F_124 ( struct V_2 * V_3 )
{
struct V_255 * V_256 ;
for ( V_256 = V_257 ; ; V_256 ++ )
if ( F_123 ( V_256 -> V_4 , V_3 -> V_4 ) &&
F_123 ( V_256 -> V_5 , V_3 -> V_5 ) &&
F_123 ( V_256 -> V_258 , V_3 -> V_6 ) &&
F_123 ( V_256 -> V_259 , V_3 -> V_7 ) )
break;
return V_256 ;
}
static inline int F_125 ( struct V_2 * V_3 ,
const struct V_25 * V_26 )
{
if ( V_26 -> V_29 & V_260 )
return 0 ;
...
static int
F_126 ( struct V_2 * V_3 , struct V_25 * V_26 )
{
const struct V_261 * V_262 ;
int V_263 , V_264 , V_265 = - 1 , V_60 ;
if ( ( ( ( V_3 -> V_84 >> 8 ) != V_266 ) &&
( ( V_3 -> V_84 >> 8 ) != V_267 ) ) ||
( V_3 -> V_84 & 0xff ) > 6 )
return - V_42 ;
for ( V_262 = V_268 ;
V_262 < V_268 + F_42 ( V_268 ) ;
V_262 ++ ) {
if ( V_3 -> V_4 == V_262 -> V_4 &&
V_3 -> V_5 == V_262 -> V_5 )
return - V_42 ;
}
V_263 = V_264 = 0 ;
for ( V_60 = 0 ; V_60 < V_15 ; V_60 ++ ) {
if ( F_5 ( V_3 , V_60 ) & V_269 ) {
V_264 ++ ;
if ( V_265 == - 1 )
V_265 = V_60 ;
}
...
static inline int
F_127 ( const struct V_25 * V_26 ,
const struct V_25 * V_270 )
{
return
V_26 -> V_79 == V_270 -> V_79 &&
V_26 -> V_271 == V_270 -> V_271 &&
V_26 -> V_30 == V_270 -> V_30 &&
V_26 -> V_31 == V_270 -> V_31 &&
V_26 -> V_28 == V_270 -> V_28 ;
}
struct V_8 *
F_128 ( struct V_2 * V_3 , const struct V_25 * V_26 )
{
struct V_10 V_272 ;
struct V_8 * V_9 ;
struct V_255 * V_256 ;
...
V_9 = F_130 ( sizeof( struct V_8 ) +
sizeof( unsigned int ) * V_273 ,
V_185 ) ;
if ( ! V_9 ) {
V_9 = F_129 ( - V_18 ) ;
goto V_276;
...
V_272 . V_11 . V_29 = V_277 | V_278 | V_279 ;
V_272 . V_11 . V_146 = V_26 -> V_271 * 16 ;
V_272 . V_11 . V_229 = F_125 ( V_3 , V_26 ) ;
V_272 . V_11 . V_3 = & V_3 -> V_3 ;
for ( V_60 = 0 ; V_60 < V_273 ; V_60 ++ ) {
if ( V_256 -> V_280 ( V_9 , V_26 , & V_272 , V_60 ) )
break;
F_16 ( & V_3 -> V_3 , L_23 ,
V_272 . V_11 . V_21 , V_272 . V_11 . V_229 , V_272 . V_11 . V_19 ) ;
V_9 -> line [ V_60 ] = F_131 ( & V_272 ) ;
if ( V_9 -> line [ V_60 ] < 0 ) {
F_2 ( & V_3 -> V_3 ,
L_24 ,
V_272 . V_11 . V_21 , V_272 . V_11 . V_229 ,
V_272 . V_11 . V_19 , V_9 -> line [ V_60 ] ) ;
break;
}
}
V_9 -> V_281 = V_60 ;
...
struct V_255 * V_256 ;
int V_60 ;
for ( V_60 = 0 ; V_60 < V_9 -> V_281 ; V_60 ++ )
F_133 ( V_9 -> line [ V_60 ] ) ;
V_256 = F_124 ( V_9 -> V_3 ) ;
if ( V_256 -> exit )
V_256 -> exit ( V_9 -> V_3 ) ;
...
F_136 ( V_9 -> line [ V_60 ] ) ;
if ( V_9 -> V_256 -> exit )
V_9 -> V_256 -> exit ( V_9 -> V_3 ) ;
}
void F_137 ( struct V_8 * V_9 )
{
int V_60 ;
if ( V_9 -> V_256 -> V_274 )
V_9 -> V_256 -> V_274 ( V_9 -> V_3 ) ;
for ( V_60 = 0 ; V_60 < V_9 -> V_281 ; V_60 ++ )
if ( V_9 -> line [ V_60 ] >= 0 )
F_138 ( V_9 -> line [ V_60 ] ) ;
}
static int
F_139 ( struct V_2 * V_3 , const struct V_261 * V_282 )
{
struct V_255 * V_256 ;
struct V_8 * V_9 ;
const struct V_25 * V_26 ;
...
V_256 = F_124 ( V_3 ) ;
if ( V_256 -> V_283 ) {
V_32 = V_256 -> V_283 ( V_3 ) ;
if ( V_32 )
return V_32 ;
}
if ( V_282 -> V_284 >= F_42 ( V_285 ) ) {
F_2 ( & V_3 -> V_3 , L_25 ,
V_282 -> V_284 ) ;
return - V_16 ;
}
V_26 = & V_285 [ V_282 -> V_284 ] ;
V_32 = F_140 ( V_3 ) ;
F_141 ( V_3 ) ;
if ( V_32 )
return V_32 ;
if ( V_282 -> V_284 == V_286 ) {
memcpy ( & V_145 , V_26 , sizeof( struct V_25 ) ) ;
V_26 = & V_145 ;
V_32 = F_126 ( V_3 , & V_145 ) ;
if ( V_32 )
return V_32 ;
} else {
memcpy ( & V_145 , & V_285 [ V_286 ] ,
sizeof( struct V_25 ) ) ;
V_32 = F_126 ( V_3 , & V_145 ) ;
if ( V_32 == 0 && F_127 ( V_26 , & V_145 ) )
F_1 ( L_26 ,
V_3 ) ;
}
V_9 = F_128 ( V_3 , V_26 ) ;
...
{
struct V_2 * V_180 = F_103 ( V_3 ) ;
struct V_8 * V_9 = F_107 ( V_180 ) ;
if ( V_9 )
F_135 ( V_9 ) ;
return 0 ;
}
static int F_147 ( struct V_5 * V_3 )
{
struct V_2 * V_180 = F_103 ( V_3 ) ;
struct V_8 * V_9 = F_107 ( V_180 ) ;
int V_287 ;
...
static T_5 F_151 ( struct V_2 * V_3 )
{
int V_32 ;
V_32 = F_148 ( V_3 ) ;
if ( V_32 )
