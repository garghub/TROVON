...
return - V_133 ;
if ( V_197 . V_130 >= F_79 ( V_199 ) )
return - V_9 ;
if ( V_197 . V_200 + sizeof( V_197 ) > V_164 )
return - V_9 ;
V_122 = V_199 [ V_197 . V_130 ] ( V_3 , V_194 + sizeof( V_197 ) ,
V_197 . V_200 , V_197 . V_156 ) ;
if ( ! V_122 )
V_122 = V_164 ;
return V_122 ;
}
static unsigned int F_80 ( struct V_3 * V_134 ,
struct V_201 * V_202 )
{
struct V_2 * V_3 = V_134 -> V_115 ;
unsigned int V_203 = 0 ;
V_125 ( V_134 , & V_3 -> V_125 , V_202 ) ;
if ( ! F_13 ( & V_3 -> V_19 ) )
V_203 = V_204 | V_205 ;
return V_203 ;
}
static int F_81 ( struct V_206 * V_206 , struct V_3 * V_134 )
{
struct V_2 * V_3 ;
...
V_134 -> V_115 = V_3 ;
V_3 -> V_134 = V_134 ;
V_3 -> V_143 = F_84 ( V_206 -> V_207 , struct V_208 , V_209 ) ;
return F_85 ( V_206 , V_134 ) ;
}
static int F_86 ( struct V_206 * V_206 , struct V_3 * V_134 )
{
struct V_2 * V_3 = V_134 -> V_115 ;
struct V_1 * V_5 ;
F_2 ( & V_3 -> V_17 ) ;
...
static void F_87 ( struct V_143 * V_210 )
{
struct V_208 * V_211 ;
V_211 = F_84 ( V_210 , struct V_208 , V_210 ) ;
F_88 ( & V_211 -> V_209 ) ;
if ( V_211 -> V_212 < V_213 )
F_89 ( V_211 -> V_212 , V_214 ) ;
else
F_89 ( V_211 -> V_212 - V_213 , V_215 ) ;
F_16 ( V_211 ) ;
}
static T_1 F_90 ( struct V_143 * V_210 , struct V_216 * V_217 ,
char * V_194 )
{
struct V_208 * V_211 ;
V_211 = F_84 ( V_210 , struct V_208 , V_210 ) ;
return sprintf ( V_194 , L_1 , V_211 -> V_144 -> V_218 ) ;
}
static int F_91 ( void )
{
int V_219 ;
if ( ! V_220 ) {
V_219 = F_92 ( & V_220 , 0 , V_213 ,
L_2 ) ;
if ( V_219 ) {
F_93 ( L_3 ) ;
return V_219 ;
...
V_219 = F_94 ( V_215 , V_213 ) ;
if ( V_219 >= V_213 )
return - 1 ;
return V_219 ;
}
static void F_95 ( struct V_221 * V_143 )
{
int V_212 ;
T_9 V_222 ;
struct V_208 * V_211 ;
if ( ! V_143 -> V_223 || ! F_96 ( V_143 , 1 ) )
return;
V_211 = F_18 ( sizeof *V_211 , V_24 ) ;
if ( ! V_211 )
return;
V_211 -> V_144 = V_143 ;
V_212 = F_94 ( V_214 , V_213 ) ;
if ( V_212 >= V_213 ) {
V_212 = F_91 () ;
if ( V_212 < 0 )
goto V_224;
V_211 -> V_212 = V_212 + V_213 ;
V_222 = V_212 + V_220 ;
F_97 ( V_212 , V_215 ) ;
} else {
V_211 -> V_212 = V_212 ;
...
F_98 ( & V_211 -> V_209 , & V_226 ) ;
V_211 -> V_209 . V_227 = V_228 ;
F_99 ( & V_211 -> V_209 . V_229 , L_4 , V_211 -> V_212 ) ;
if ( F_100 ( & V_211 -> V_209 , V_222 , 1 ) )
goto V_224;
V_211 -> V_210 . V_230 = & V_231 ;
V_211 -> V_210 . V_232 = V_143 -> V_233 ;
V_211 -> V_210 . V_234 = V_211 -> V_209 . V_210 ;
V_211 -> V_210 . V_235 = F_87 ;
F_101 ( & V_211 -> V_210 , L_4 , V_211 -> V_212 ) ;
if ( F_102 ( & V_211 -> V_210 ) )
goto V_236;
if ( F_103 ( & V_211 -> V_210 , & V_237 ) )
goto V_238;
F_104 ( V_143 , & V_239 , V_211 ) ;
return;
V_238:
F_105 ( & V_211 -> V_210 ) ;
V_236:
...
static void F_106 ( struct V_221 * V_143 , void * V_240 )
{
struct V_208 * V_211 = V_240 ;
if ( ! V_211 )
return;
F_105 ( & V_211 -> V_210 ) ;
}
...
{
int V_219 ;
V_219 = F_108 ( V_225 , V_213 ,
L_2 ) ;
if ( V_219 ) {
F_93 ( L_5 ) ;
goto V_241;
}
V_219 = F_109 ( & V_231 , & V_242 . V_217 ) ;
if ( V_219 ) {
F_93 ( L_6 ) ;
goto V_243;
}
