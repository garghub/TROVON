...
char V_125 [ 42 ] ;
T_5 V_126 ;
int V_117 = V_10 -> V_118 -> V_119 . V_120 + 1 ;
int V_3 ;
...
T_1 V_3 ;
if ( ! F_70 ( V_10 , & V_3 ) ) {
int V_130 = ( V_3 & V_131 ) ? 1 : 0 ;
int V_132 = ( V_3 & V_133 ) ? 1 : 0 ;
int V_134 = ( V_3 & V_135 ) ? 1 : 0 ;
F_60 ( V_114 , L_47 , V_130 ) ;
F_60 ( V_114 , L_48 , V_132 ) ;
F_60 ( V_114 , L_49 , V_134 ) ;
return 0 ;
}
return - V_8 ;
}
...
V_136 = V_125 ;
while ( V_137 ) {
if ( sscanf ( V_136 , L_50 , & V_3 ) == 1 )
V_138 = V_3 & 1 ;
else if ( sscanf ( V_136 , L_51 , & V_3 ) == 1 )
V_139 = V_3 & 1 ;
...
if ( V_138 != - 1 )
F_1 ( & V_144 , V_131 , V_138 ) ;
if ( V_139 != - 1 )
F_1 ( & V_144 , V_133 , V_139 ) ;
if ( V_140 != - 1 )
F_1 ( & V_144 , V_135 , V_140 ) ;
if ( V_144 != V_141 )
...
if ( F_76 ( V_10 , & V_3 ) )
return - V_8 ;
F_60 ( V_114 , L_55 , ( V_3 > 0 ) ) ;
F_60 ( V_114 , L_56 , V_10 -> V_147 ) ;
return 0 ;
}
...
{
struct V_9 * V_10 = V_114 -> V_116 ;
F_60 ( V_114 , L_58 , V_10 -> V_148 ) ;
F_60 ( V_114 , L_59 , V_10 -> V_149 ) ;
return 0 ;
}
...
return - V_127 ;
V_125 [ V_126 ] = '\0' ;
if ( sscanf ( V_125 , L_60 , & V_3 ) == 1 && V_3 == 0 )
V_10 -> V_148 = 0 ;
else
return - V_128 ;
return V_22 ;
...
{
F_60 ( V_114 , L_61 , V_150 ) ;
F_60 ( V_114 , L_62 , V_151 ) ;
return 0 ;
}
...
{
return sprintf ( V_123 , L_68 , V_150 ) ;
}
...
return - V_8 ;
return sprintf ( V_123 , L_70 , time & V_66 ) ;
}
static T_3 F_98 ( struct V_163 * V_10 ,
struct V_164 * V_165 , char * V_123 )
{
struct V_9 * V_166 = F_92 ( V_10 ) ;
return sprintf ( V_123 , L_69 , V_166 -> V_64 ) ;
}
...
if ( F_22 ( V_166 , & time ) < 0 )
return - V_8 ;
return sprintf ( V_123 , L_70 , time >> V_68 ) ;
}
...
T_7 V_176 , V_177 , V_81 ;
int V_108 ;
V_173 = V_174 = 0 ;
V_108 = F_31 ( V_166 , & V_173 , & V_174 ) ;
if ( V_108 < 0 )
return V_108 ;
V_176 = V_173 & V_178 ;
V_175 = V_173 >> V_68 ;
V_177 = V_175 & V_178 ;
V_81 = V_174 & V_178 ;
return sprintf ( V_123 , L_73 , V_176 , V_177 , V_81 ) ;
}
...
if ( V_108 < 0 )
return V_108 ;
return sprintf ( V_123 , L_74 , V_88 & V_179 ) ;
}
...
V_6 = ( V_175 == 0x4 ) ? 1 : 0 ;
V_184 = V_56 >> V_68 ;
return sprintf ( V_123 , L_75 , V_6 , V_184 ) ;
}
...
if ( V_108 < 0 )
return V_108 ;
return sprintf ( V_123 , L_69 , V_56 ) ;
}
...
if ( V_108 < 0 )
return V_108 ;
return sprintf ( V_123 , L_69 , V_88 ) ;
}
...
static T_3 F_120 ( struct V_163 * V_10 ,
struct V_164 * V_165 ,
const char * V_123 , T_5 V_22 )
{
struct V_9 * V_166 = F_92 ( V_10 ) ;
...
static T_8 F_121 ( struct V_188 * V_189 ,
struct V_190 * V_165 , int V_191 )
{
struct V_163 * V_10 = F_18 ( V_189 , struct V_163 , V_189 ) ;
struct V_9 * V_192 = F_92 ( V_10 ) ;
bool V_193 = true ;
if ( V_165 == & V_194 . V_165 )
V_193 = ( V_192 -> V_158 ) ? true : false ;
else if ( V_165 == & V_195 . V_165 )
V_193 = ( V_192 -> V_60 ) ? true : false ;
else if ( V_165 == & V_196 . V_165 )
V_193 = ( V_192 -> V_65 == V_168 ) ? true : false ;
else if ( V_165 == & V_197 . V_165 )
V_193 = ( V_192 -> V_198 ) ? true : false ;
else if ( V_165 == & V_199 . V_165 )
V_193 = ( V_192 -> V_79 ) ? true : false ;
else if ( V_165 == & V_200 . V_165 )
V_193 = ( V_192 -> V_84 ) ? true : false ;
else if ( V_165 == & V_201 . V_165 )
V_193 = ( V_192 -> V_84 ) ? true : false ;
else if ( V_165 == & V_202 . V_165 )
V_193 = ( V_192 -> V_203 ) ? true : false ;
else if ( V_165 == & V_204 . V_165 )
V_193 = ( V_192 -> V_205 ) ? true : false ;
else if ( V_165 == & V_206 . V_165 )
V_193 = ( V_192 -> V_207 ) ? true : false ;
else if ( V_165 == & V_208 . V_165 )
V_193 = ( V_192 -> V_209 ) ? true : false ;
else if ( V_165 == & V_210 . V_165 )
V_193 = ( V_192 -> V_211 ) ? true : false ;
else if ( V_165 == & V_212 . V_165 )
V_193 = ( V_192 -> V_104 ) ? true : false ;
return V_193 ? V_165 -> V_88 : 0 ;
}
static void F_122 ( struct V_213 * V_214 )
{
struct V_215 * V_26 = V_171 -> V_26 ;
if ( F_123 ( & V_26 -> V_10 . V_189 ,
& V_216 ) )
F_11 ( L_79 ) ;
F_124 ( V_26 -> V_217 . V_218 ,
F_125 ( & V_26 -> V_10 ) ,
0x92 , 0 ) ;
}
static int F_126 ( T_9 * V_219 )
{
T_1 V_11 [ V_12 ] = { V_219 -> V_220 , V_219 -> V_221 , V_219 -> V_222 ,
V_219 -> V_223 , V_219 -> V_224 , V_219 -> V_225 } ;
T_1 V_13 [ V_12 ] ;
T_2 V_6 ;
...
static long F_127 ( struct V_122 * V_226 , unsigned int V_125 ,
unsigned long V_227 )
{
T_9 T_4 * V_228 = ( T_9 T_4 * ) V_227 ;
T_9 V_219 ;
int V_108 ;
if ( ! V_228 )
return - V_128 ;
switch ( V_125 ) {
case V_229 :
if ( F_69 ( & V_219 , V_228 , sizeof( T_9 ) ) )
return - V_127 ;
V_108 = F_126 ( & V_219 ) ;
if ( V_108 )
return V_108 ;
if ( F_128 ( V_228 , & V_219 , sizeof( T_9 ) ) )
return - V_127 ;
break;
case V_230 :
if ( F_69 ( & V_219 , V_228 , sizeof( T_9 ) ) )
return - V_127 ;
if ( V_219 . V_220 != V_44 && V_219 . V_220 != V_45 )
return - V_128 ;
if ( ! F_10 ( V_171 ) )
return - V_8 ;
V_108 = F_126 ( & V_219 ) ;
...
static int F_129 ( void * V_231 , bool V_232 )
{
...
if ( ! V_10 -> V_98 )
return 0 ;
return F_50 ( V_10 , ! V_232 ) ;
}
static void F_130 ( struct V_233 * V_233 , void * V_231 )
{
struct V_9 * V_10 = V_231 ;
if ( F_48 ( V_10 ) )
return;
F_131 ( V_10 -> V_234 , ! V_10 -> V_98 ) ;
}
...
if ( F_9 ( V_6 ) )
return - V_69 ;
if ( V_10 -> V_207 && V_10 -> V_237 )
V_55 = F_6 ( V_10 , V_238 ,
V_239 ) ;
else
V_55 = F_6 ( V_10 , V_238 , V_240 ) ;
if ( V_55 == V_34 )
return - V_8 ;
else if ( V_55 == V_40 )
return - V_69 ;
...
static bool F_137 ( unsigned char V_231 , unsigned char V_241 ,
struct V_242 * V_243 )
{
if ( V_241 & V_244 )
return false ;
...
static void F_139 ( struct V_213 * V_214 )
{
T_10 V_247 = F_140 () ;
T_2 V_6 ;
if ( ! V_247 )
return;
V_6 = F_5 ( V_247 , L_85 , NULL , NULL ) ;
if ( F_9 ( V_6 ) )
F_11 ( L_86 ) ;
}
...
if ( V_248 & 0x80 )
return;
if ( ! F_144 ( V_10 -> V_160 , V_248 , 1 , true ) )
F_12 ( L_89 , V_248 ) ;
}
static void F_145 ( struct V_9 * V_10 )
{
if ( V_10 -> V_249 ) {
int V_248 = F_141 ( V_10 ) ;
if ( V_248 < 0 ) {
F_11 ( L_90 ) ;
} else if ( V_248 != 0 ) {
F_143 ( V_10 , V_248 ) ;
...
} while ( V_251 && V_55 != V_253 );
}
}
static int F_147 ( struct V_9 * V_10 )
{
const struct V_254 * V_255 = V_256 ;
T_10 V_247 ;
int error ;
if ( V_257 ) {
F_12 ( L_92 ) ;
...
if ( error )
return error ;
if ( F_47 ( V_10 , & V_10 -> V_259 ) )
F_146 ( L_94 ) ;
V_10 -> V_160 = F_149 () ;
if ( ! V_10 -> V_160 )
return - V_143 ;
V_10 -> V_160 -> V_260 = L_95 ;
V_10 -> V_160 -> V_261 = L_96 ;
V_10 -> V_160 -> V_262 . V_263 = V_264 ;
if ( V_10 -> V_259 == V_265 ||
! V_10 -> V_207 )
V_255 = V_256 ;
else if ( V_10 -> V_259 == V_266 ||
V_10 -> V_207 )
V_255 = V_267 ;
else
F_12 ( L_97 ,
V_10 -> V_259 ) ;
error = F_150 ( V_10 -> V_160 , V_255 , NULL ) ;
if ( error )
goto V_268;
V_247 = F_140 () ;
if ( V_247 && F_151 ( V_247 , L_85 ) ) {
F_152 ( & V_10 -> V_246 , F_139 ) ;
error = F_153 ( F_137 ) ;
if ( error ) {
F_11 ( L_98 ) ;
goto V_269;
...
if ( F_151 ( V_10 -> V_26 -> V_27 , L_87 ) )
V_10 -> V_249 = 1 ;
else if ( F_6 ( V_10 , V_252 , 1 ) == V_49 )
V_10 -> V_250 = 1 ;
if ( ! V_10 -> V_249 && ! V_10 -> V_250 ) {
F_154 ( L_99 ) ;
goto V_271;
}
error = F_155 ( V_10 -> V_160 ) ;
if ( error ) {
F_12 ( L_100 ) ;
goto V_271;
}
...
if ( V_10 -> V_107 )
V_119 . V_120 ++ ;
V_10 -> V_118 = F_164 ( L_102 ,
& V_10 -> V_26 -> V_10 ,
V_10 ,
& V_277 ,
& V_119 ) ;
if ( F_165 ( V_10 -> V_118 ) ) {
V_108 = F_166 ( V_10 -> V_118 ) ;
F_11 ( L_103 ) ;
V_10 -> V_118 = NULL ;
return V_108 ;
}
...
static int F_169 ( struct V_215 * V_26 )
{
struct V_9 * V_10 = F_170 ( V_26 ) ;
F_171 ( & V_10 -> V_278 ) ;
F_88 ( V_10 ) ;
if ( V_10 -> V_279 )
F_172 ( & V_10 -> V_26 -> V_10 . V_189 ,
& V_216 ) ;
if ( V_10 -> V_270 ) {
F_156 ( F_137 ) ;
F_173 ( & V_10 -> V_246 ) ;
...
static const char * F_178 ( T_10 V_27 )
{
if ( F_151 ( V_27 , L_124 ) )
return L_124 ;
if ( F_151 ( V_27 , L_125 ) )
...
static int F_179 ( struct V_215 * V_26 )
{
struct V_9 * V_10 ;
const char * V_280 ;
T_1 V_281 ;
...
F_12 ( L_126 ,
V_150 ) ;
V_280 = F_178 ( V_26 -> V_27 ) ;
if ( ! V_280 ) {
F_11 ( L_127 ) ;
return - V_69 ;
}
V_10 = F_180 ( sizeof( * V_10 ) , V_142 ) ;
if ( ! V_10 )
return - V_143 ;
V_10 -> V_26 = V_26 ;
V_10 -> V_28 = V_280 ;
V_10 -> V_278 . V_283 = V_284 ;
V_10 -> V_278 . V_260 = L_128 ;
V_10 -> V_278 . V_285 = & V_286 ;
V_108 = F_181 ( & V_10 -> V_278 ) ;
if ( V_108 ) {
F_11 ( L_129 ) ;
F_75 ( V_10 ) ;
return V_108 ;
...
V_26 -> V_287 = V_10 ;
F_182 ( & V_26 -> V_10 , V_10 ) ;
V_108 = F_41 ( V_10 , & V_10 -> V_237 ) ;
V_10 -> V_207 = ! V_108 ;
V_10 -> V_259 = 0 ;
if ( F_147 ( V_10 ) )
F_12 ( L_130 ) ;
V_108 = F_54 ( V_10 , & V_281 ) ;
V_10 -> V_107 = ! V_108 ;
V_108 = F_159 ( V_10 ) ;
if ( V_108 )
goto error;
F_16 ( V_10 ) ;
if ( V_10 -> V_47 ) {
V_10 -> V_54 . V_260 = L_131 ;
V_10 -> V_54 . V_120 = 1 ;
V_10 -> V_54 . V_288 = F_17 ;
V_10 -> V_54 . V_289 = F_19 ;
if ( ! F_183 ( & V_26 -> V_10 , & V_10 -> V_54 ) )
V_10 -> V_48 = true ;
}
F_27 ( V_10 ) ;
if ( V_10 -> V_74 ) {
V_10 -> V_77 . V_260 = L_132 ;
V_10 -> V_77 . V_120 = 1 ;
V_10 -> V_77 . V_288 = F_29 ;
V_10 -> V_77 . V_289 = F_28 ;
if ( ! F_183 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_77 ) )
V_10 -> V_75 = true ;
}
F_20 ( V_10 ) ;
if ( V_10 -> V_60 && V_10 -> V_65 == V_167 ) {
V_10 -> V_70 . V_260 = L_133 ;
V_10 -> V_70 . V_120 = 1 ;
V_10 -> V_70 . V_288 = F_24 ;
V_10 -> V_70 . V_289 = F_23 ;
if ( ! F_183 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_70 ) )
V_10 -> V_61 = true ;
}
V_108 = F_26 ( V_10 , & V_281 ) ;
V_10 -> V_198 = ! V_108 ;
F_30 ( V_10 ) ;
F_32 ( V_10 ) ;
V_108 = F_37 ( V_10 , & V_281 ) ;
V_10 -> V_203 = ! V_108 ;
V_108 = F_39 ( V_10 , & V_281 ) ;
V_10 -> V_205 = ! V_108 ;
V_108 = F_43 ( V_10 , & V_281 ) ;
V_10 -> V_209 = ! V_108 ;
V_108 = F_45 ( V_10 , & V_281 ) ;
V_10 -> V_211 = ! V_108 ;
V_108 = F_70 ( V_10 , & V_281 ) ;
V_10 -> V_156 = ! V_108 ;
V_108 = F_76 ( V_10 , & V_281 ) ;
V_10 -> V_158 = ! V_108 ;
F_49 ( V_10 ) ;
if ( V_10 -> V_99 )
F_132 ( V_10 ) ;
F_51 ( V_10 ) ;
F_167 ( V_10 ) ;
V_108 = F_184 ( & V_10 -> V_26 -> V_10 . V_189 ,
& V_216 ) ;
if ( V_108 ) {
V_10 -> V_279 = 0 ;
goto error;
...
static void F_185 ( struct V_215 * V_26 , T_1 V_290 )
{
struct V_9 * V_10 = F_170 ( V_26 ) ;
switch ( V_290 ) {
case 0x80 :
...
static int F_186 ( struct V_163 * V_163 )
{
struct V_9 * V_10 = F_170 ( F_187 ( V_163 ) ) ;
if ( V_10 -> V_160 ) {
T_1 V_55 ;
V_55 = F_6 ( V_10 , V_238 , V_291 ) ;
if ( V_55 != V_49 )
F_12 ( L_138 ) ;
}
return 0 ;
}
static int F_188 ( struct V_163 * V_163 )
{
struct V_9 * V_10 = F_170 ( F_187 ( V_163 ) ) ;
if ( V_10 -> V_160 ) {
if ( F_136 ( V_10 ) )
...
static int T_11 F_189 ( void )
{
int V_108 ;
V_154 = F_190 ( V_292 , V_293 ) ;
if ( ! V_154 ) {
F_11 ( L_140 V_292 L_123 ) ;
return - V_69 ;
}
V_108 = F_191 ( & V_294 ) ;
if ( V_108 ) {
