...
if ( F_155 ( V_239 -> V_45 ) )
return - V_37 ;
V_239 -> V_45 = F_156 ( V_45 -> V_240 , V_3 -> V_241 ) ;
if ( F_20 ( ! V_239 -> V_45 ) )
return - V_61 ;
V_239 -> V_45 -> V_240 = V_45 -> V_240 ;
V_239 -> V_45 -> V_59 = V_45 -> V_59 ;
V_239 -> V_45 -> V_58 = V_45 -> V_58 ;
V_239 -> V_45 -> V_242 = F_151 ( V_45 -> V_242 ,
V_3 -> V_241 ) ;
if ( V_45 -> V_242 && ! V_239 -> V_45 -> V_242 )
return - V_61 ;
V_239 -> V_45 -> V_243 = F_151 ( V_45 -> V_243 ,
V_3 -> V_241 ) ;
if ( V_45 -> V_243 && ! V_239 -> V_45 -> V_243 )
return - V_61 ;
...
F_111 ( & V_120 -> V_7 ) ;
V_237 -> V_245 . V_7 = & V_120 -> V_7 ;
V_237 -> V_246 . V_247 . V_248 = * V_43 ;
V_239 -> V_29 = V_55 ;
V_239 -> V_46 = V_46 ;
if ( V_120 -> V_7 . V_20 & V_234 )
V_56 = V_48 -> V_249 >= V_250 ?
V_120 -> V_7 . V_9 -> V_56 : F_47 ( & V_120 -> V_7 ) ;
else
V_56 = V_48 -> V_249 >= V_250 ?
V_120 -> V_7 . V_9 -> V_56 : F_47 ( V_120 -> V_7 . V_251 ) ;
if ( V_48 -> V_155 < V_56 ) {
if ( V_48 -> V_155 )
V_56 = V_48 -> V_155 ;
}
V_237 -> V_245 . V_252 = V_56 ;
if ( F_28 ( V_120 -> V_7 . V_251 ) )
V_237 -> V_245 . V_20 |= V_253 ;
V_237 -> V_245 . V_215 = 0 ;
return 0 ;
}
...
unsigned int V_20 , int V_257 )
{
struct V_4 * V_5 , * V_258 = NULL ;
...
V_259 = V_120 -> V_7 . V_235 - V_120 -> V_266 ;
}
V_56 = V_237 -> V_252 ;
V_233 = V_56 ;
...
V_120 -> V_266 ;
if ( V_237 -> V_215 + V_215 > V_56 - V_265 && V_257 &&
( V_3 -> V_267 == V_268 ||
V_3 -> V_267 == V_269 ) ) {
...
V_264 = V_56 ;
if ( V_237 -> V_215 + V_215 > V_264 - V_265 ) {
V_270:
F_48 ( V_3 , V_74 , V_43 ,
V_56 - V_265 +
sizeof( struct V_50 ) ) ;
...
goto V_284;
while ( V_215 > 0 ) {
V_260 = ( V_237 -> V_215 <= V_56 && ! ( V_237 -> V_20 & V_253 ) ? V_56 : V_232 ) - V_5 -> V_32 ;
if ( V_260 < V_215 )
V_260 = V_232 - V_5 -> V_32 ;
if ( V_260 <= 0 ) {
char * V_89 ;
unsigned int V_285 ;
unsigned int V_286 ;
...
V_258 = V_5 ;
V_285 = V_215 + V_287 ;
if ( V_285 > ( V_237 -> V_215 <= V_56 && ! ( V_237 -> V_20 & V_253 ) ? V_56 : V_232 ) - V_217 )
V_285 = V_232 - V_217 - V_120 -> V_7 . V_289 ;
if ( ( V_20 & V_272 ) &&
...
V_259 ) ;
F_106 ( V_5 ) -> V_261 = V_261 ;
V_261 = 0 ;
F_106 ( V_5 ) -> V_262 = V_262 ;
V_262 = 0 ;
V_89 = F_118 ( V_5 , V_286 ) ;
F_148 ( V_5 , V_218 ) ;
V_89 += V_217 ;
V_5 -> V_177 = ( V_5 -> V_178 +
V_217 ) ;
...
V_258 , V_232 ,
V_89 + V_219 , V_287 , 0 ) ;
V_258 -> V_221 = F_165 ( V_258 -> V_221 ,
V_5 -> V_221 ) ;
V_89 += V_287 ;
F_166 ( V_258 , V_232 ) ;
}
V_260 = V_285 - V_219 - V_287 ;
if ( V_260 < 0 ) {
V_152 = - V_37 ;
F_14 ( V_5 ) ;
goto error;
} else if ( V_260 > 0 && F_145 ( V_140 , V_89 + V_219 , V_85 , V_260 , V_287 , V_5 ) < 0 ) {
V_152 = - V_293 ;
F_14 ( V_5 ) ;
goto error;
}
...
unsigned int V_294 ;
V_294 = V_5 -> V_32 ;
if ( F_145 ( V_140 , F_118 ( V_5 , V_260 ) ,
...
int V_295 = F_106 ( V_5 ) -> V_296 ;
V_152 = - V_167 ;
if ( ! F_168 ( V_3 , V_256 ) )
goto error;
if ( ! F_169 ( V_5 , V_295 , V_256 -> V_297 ,
V_256 -> V_85 ) ) {
V_152 = - V_74 ;
if ( V_295 == V_298 )
goto error;
F_170 ( V_5 , V_295 , V_256 -> V_297 ,
V_256 -> V_85 , 0 ) ;
F_106 ( V_5 ) -> V_296 = ++ V_295 ;
F_171 ( V_256 -> V_297 ) ;
}
V_260 = F_172 ( int , V_260 , V_256 -> V_299 - V_256 -> V_85 ) ;
if ( F_145 ( V_140 ,
F_173 ( V_256 -> V_297 ) + V_256 -> V_85 ,
V_85 , V_260 , V_5 -> V_32 , V_5 ) < 0 )
goto V_300;
V_256 -> V_85 += V_260 ;
F_174 ( & F_106 ( V_5 ) -> V_301 [ V_295 - 1 ] , V_260 ) ;
V_5 -> V_32 += V_260 ;
V_5 -> V_172 += V_260 ;
V_5 -> V_165 += V_260 ;
F_175 ( V_260 , & V_3 -> V_291 ) ;
}
V_85 += V_260 ;
V_215 -= V_260 ;
}
...
int F_145 ( void * V_140 , char * V_139 , int V_85 , int V_32 ,
int V_214 , struct V_4 * V_5 ) ,
void * V_140 , int V_215 , int V_219 , int V_55 ,
int V_46 , struct V_44 * V_45 , struct V_42 * V_43 ,
struct V_34 * V_120 , unsigned int V_20 , int V_257 )
{
struct V_303 * V_304 = F_177 ( V_3 ) ;
struct V_47 * V_48 = F_34 ( V_3 ) ;
int V_218 ;
int V_152 ;
if ( V_20 & V_305 )
return 0 ;
if ( F_178 ( & V_3 -> V_306 ) ) {
V_152 = F_154 ( V_3 , & V_304 -> V_237 , & V_48 -> V_237 , V_55 ,
...
V_43 = & V_304 -> V_237 . V_246 . V_247 . V_248 ;
V_219 = 0 ;
}
return F_157 ( V_3 , V_43 , & V_3 -> V_306 , & V_304 -> V_237 . V_245 ,
& V_48 -> V_237 , F_179 ( V_3 ) , F_145 ,
V_140 , V_215 , V_219 , V_20 , V_257 ) ;
}
static void F_180 ( struct V_236 * V_237 ,
struct V_238 * V_239 )
{
if ( V_239 -> V_45 ) {
F_113 ( V_239 -> V_45 -> V_242 ) ;
F_113 ( V_239 -> V_45 -> V_243 ) ;
...
if ( V_237 -> V_245 . V_7 ) {
F_126 ( V_237 -> V_245 . V_7 ) ;
V_237 -> V_245 . V_7 = NULL ;
V_237 -> V_245 . V_20 &= ~ V_253 ;
}
memset ( & V_237 -> V_246 , 0 , sizeof( V_237 -> V_246 ) ) ;
}
...
struct V_50 * V_51 ;
struct V_44 * V_45 = V_239 -> V_45 ;
struct V_34 * V_120 = (struct V_34 * ) V_237 -> V_245 . V_7 ;
struct V_42 * V_43 = & V_237 -> V_246 . V_247 . V_248 ;
unsigned char V_52 = V_43 -> V_53 ;
V_5 = F_182 ( V_213 ) ;
if ( ! V_5 )
goto V_186;
V_308 = & ( F_106 ( V_5 ) -> V_168 ) ;
if ( V_5 -> V_89 < F_57 ( V_5 ) )
F_108 ( V_5 , F_183 ( V_5 ) ) ;
while ( ( V_307 = F_182 ( V_213 ) ) != NULL ) {
F_108 ( V_307 , F_184 ( V_5 ) ) ;
* V_308 = V_307 ;
V_308 = & ( V_307 -> V_81 ) ;
V_5 -> V_32 += V_307 -> V_32 ;
...
V_237 . V_245 . V_20 = 0 ;
V_237 . V_245 . V_185 = 0 ;
V_237 . V_245 . V_45 = NULL ;
V_239 . V_45 = NULL ;
V_152 = F_154 ( V_3 , & V_237 , & V_239 , V_55 , V_46 , V_45 , V_120 , V_43 ) ;
if ( V_152 )
return F_138 ( V_152 ) ;
if ( V_257 < 0 )
V_257 = F_34 ( V_3 ) -> V_257 ;
V_152 = F_157 ( V_3 , V_43 , & V_213 , & V_237 . V_245 , & V_239 ,
& V_311 -> V_312 , F_145 , V_140 ,
