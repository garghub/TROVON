...
{
struct V_8 * V_14 ;
V_14 = F_51 ( sizeof( struct V_8 ) , V_85 | V_86 ) ;
if ( ! V_14 )
return NULL ;
V_14 -> V_31 = F_51 ( V_29 , V_85 | V_86 ) ;
V_14 -> V_20 = F_51 ( V_87 , V_85 | V_86 ) ;
...
struct V_8 * V_9 ;
int line ;
if ( V_88 [ 0 ] && ( V_88 [ 0 ] == F_21 ( & V_38 -> V_60 ) ) )
return 0 ;
V_9 = F_50 () ;
if ( V_9 == NULL )
return - V_89 ;
...
V_2 = F_51 ( sizeof( struct V_1 ) , V_85 | V_86 ) ;
if ( ! V_2 )
return - V_89 ;
V_2 -> V_6 = V_5 ;
V_5 = V_2 ;
...
static int F_82 ( struct V_96 * V_111 , struct V_51 * V_52 )
{
struct V_8 * V_9 ;
V_9 = V_88 [ V_52 -> V_97 ] ;
if ( V_9 == NULL )
return - V_93 ;
V_52 -> V_112 = V_9 ;
return F_83 ( & V_9 -> V_42 , V_111 , V_52 ) ;
}
static int F_84 ( struct V_51 * V_52 , struct V_113 * V_114 )
{
...
static void F_86 ( struct V_51 * V_52 , struct V_113 * V_114 )
{
struct V_8 * V_9 ;
...
V_111 -> V_126 = V_127 ;
V_111 -> V_128 = V_129 ;
V_111 -> V_128 . V_130 = V_131 | V_132 ;
V_111 -> V_128 . V_133 = V_134 ;
V_111 -> V_128 . V_135 = V_136 ;
V_111 -> V_3 = V_137 ;
F_102 ( V_111 , & V_138 ) ;
V_119 = F_103 ( V_111 ) ;
if ( V_119 ) {
