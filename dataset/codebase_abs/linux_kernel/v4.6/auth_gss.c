...
{
struct V_87 * V_87 ;
struct V_177 * V_178 = F_138 ( V_139 -> V_179 . V_180 ) ;
while ( V_139 != V_139 -> V_181 ) {
struct V_140 * V_182 = V_139 -> V_181 ;
if ( F_138 ( V_182 -> V_179 . V_180 ) != V_178 )
break;
V_139 = V_182 ;
}
...
V_5 -> V_184 = & V_185 ;
F_142 ( V_5 ) ;
V_74 = F_143 ( V_87 -> V_157 , V_5 , V_186 | V_187 ) ;
if ( ! F_17 ( V_74 ) )
F_144 ( V_74 ) ;
F_145 ( V_5 ) ;
return 1 ;
...
static void
F_148 ( struct V_188 * V_189 )
{
struct V_1 * V_2 = F_7 ( V_189 , struct V_1 , V_190 ) ;
F_146 ( V_2 ) ;
}
static void
F_5 ( struct V_1 * V_2 )
{
F_149 ( & V_2 -> V_190 , F_148 ) ;
}
static void
...
static void
F_151 ( struct V_188 * V_189 )
{
struct V_6 * V_6 = F_7 ( V_189 , struct V_6 , V_7 . V_191 ) ;
F_150 ( V_6 ) ;
}
static void
...
static struct V_4 *
F_155 ( struct V_97 * V_57 , struct V_192 * V_193 , int V_194 )
{
return F_156 ( V_57 , V_193 , V_194 ) ;
}
static struct V_4 *
F_157 ( struct V_97 * V_57 , struct V_192 * V_193 , int V_194 )
{
struct V_87 * V_87 = F_7 ( V_57 , struct V_87 , V_97 ) ;
struct V_6 * V_5 = NULL ;
int V_35 = - V_22 ;
F_29 ( L_26 ,
V_46 , F_57 ( & V_78 , V_193 -> V_62 ) ,
V_57 -> V_167 ) ;
if ( ! ( V_5 = F_24 ( sizeof( * V_5 ) , V_21 ) ) )
goto V_195;
F_158 ( & V_5 -> V_7 , V_193 , V_57 , & V_196 ) ;
V_5 -> V_7 . V_9 = 1UL << V_8 ;
V_5 -> V_197 = V_87 -> V_159 ;
V_5 -> V_95 = NULL ;
if ( V_193 -> V_198 )
V_5 -> V_95 = V_193 -> V_199 ;
F_66 ( & V_87 -> V_92 ) ;
return & V_5 -> V_7 ;
V_195:
F_29 ( L_27 , V_46 , V_35 ) ;
...
memcpy ( string , V_200 -> V_20 , V_200 -> V_15 ) ;
string [ V_200 -> V_15 ] = '\0' ;
V_101:
F_22 () ;
return string ;
...
static int
F_161 ( struct V_4 * V_201 )
{
struct V_6 * V_6 = F_7 ( V_201 , struct V_6 , V_7 ) ;
struct V_1 * V_2 ;
unsigned long V_30 = V_32 + ( V_202 * V_38 ) ;
int V_34 = 0 ;
F_20 () ;
V_2 = F_21 ( V_6 -> V_10 ) ;
...
static int
F_163 ( struct V_192 * V_193 , struct V_4 * V_201 , int V_194 )
{
struct V_6 * V_6 = F_7 ( V_201 , struct V_6 , V_7 ) ;
struct V_1 * V_2 ;
int V_34 ;
if ( F_8 ( V_8 , & V_201 -> V_9 ) )
goto V_101;
F_20 () ;
V_2 = F_21 ( V_6 -> V_10 ) ;
...
F_22 () ;
if ( ! F_8 ( V_11 , & V_201 -> V_9 ) )
return 0 ;
V_101:
if ( V_193 -> V_199 != NULL ) {
if ( V_6 -> V_95 == NULL )
return 0 ;
V_34 = strcmp ( V_193 -> V_199 , V_6 -> V_95 ) == 0 ;
goto V_203;
}
if ( V_6 -> V_95 != NULL )
return 0 ;
V_34 = F_45 ( V_201 -> V_94 , V_193 -> V_62 ) ;
V_203:
if ( V_34 == 0 )
return V_34 ;
if ( F_8 ( V_204 , & V_193 -> V_205 ) &&
( F_161 ( V_201 ) != 0 ) ) {
F_164 ( V_204 , & V_193 -> V_205 ) ;
F_10 ( V_206 , & V_193 -> V_205 ) ;
}
return V_34 ;
}
static T_8 *
...
{
struct V_207 * V_208 = V_74 -> V_75 ;
struct V_4 * V_5 = V_208 -> V_76 ;
...
V_209 = V_12 ++ ;
F_33 ( & V_2 -> V_26 ) ;
V_208 -> V_217 = V_2 -> V_25 ++ ;
F_34 ( & V_2 -> V_26 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_218 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_2 -> V_23 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_208 -> V_217 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_6 -> V_197 ) ;
V_12 = F_167 ( V_12 , & V_2 -> V_42 ) ;
* V_209 = F_166 ( ( V_12 - ( V_209 + 1 ) ) << 2 ) ;
V_213 . V_219 = F_168 ( V_208 -> V_220 ,
V_208 -> V_221 . V_189 [ 0 ] . V_219 ) ;
V_213 . V_222 = ( V_223 * ) V_12 - ( V_223 * ) V_213 . V_219 ;
F_169 ( & V_213 , & V_215 ) ;
* V_12 ++ = F_166 ( V_216 ) ;
V_211 . V_20 = ( V_223 * ) ( V_12 + 1 ) ;
V_210 = F_170 ( V_2 -> V_43 , & V_215 , & V_211 ) ;
if ( V_210 == V_224 ) {
F_12 ( V_11 , & V_5 -> V_9 ) ;
} else if ( V_210 != 0 ) {
F_87 ( L_29 , V_210 ) ;
...
V_12 = F_171 ( V_12 , NULL , V_211 . V_15 ) ;
F_3 ( V_2 ) ;
return V_12 ;
V_225:
F_3 ( V_2 ) ;
...
{
struct V_4 * V_226 = V_74 -> V_75 -> V_76 ;
struct V_6 * V_6 = F_7 ( V_226 ,
struct V_6 ,
V_7 ) ;
struct V_97 * V_57 = V_226 -> V_96 ;
struct V_192 V_193 = {
. V_62 = V_226 -> V_94 ,
. V_199 = V_6 -> V_95 ,
. V_198 = ( V_6 -> V_95 != NULL ? 1 : 0 ) ,
} ;
struct V_4 * V_174 ;
V_174 = F_155 ( V_57 , & V_193 , V_227 ) ;
if ( F_17 ( V_174 ) )
return F_30 ( V_174 ) ;
...
V_228 = V_6 -> V_71 ;
V_229 = V_228 + V_230 * V_38 ;
if ( F_174 ( V_31 , V_228 , V_229 ) )
return 1 ;
}
return 0 ;
}
...
F_29 ( L_28 , V_74 -> V_98 , V_46 ) ;
V_232 = F_178 ( * V_12 ++ ) ;
if ( ( V_15 = F_178 ( * V_12 ++ ) ) > V_233 )
goto V_234;
if ( V_232 != V_216 )
goto V_234;
V_231 = F_166 ( V_74 -> V_75 -> V_217 ) ;
V_213 . V_219 = & V_231 ;
V_213 . V_222 = sizeof( V_231 ) ;
F_169 ( & V_213 , & V_215 ) ;
V_211 . V_20 = ( V_223 * ) V_12 ;
V_211 . V_15 = V_15 ;
V_34 = F_15 ( - V_41 ) ;
V_210 = F_179 ( V_2 -> V_43 , & V_215 , & V_211 ) ;
if ( V_210 == V_224 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_210 ) {
F_29 ( L_30 ,
V_74 -> V_98 , V_46 , V_210 ) ;
goto V_234;
}
V_5 -> V_96 -> V_235 = F_180 ( V_15 ) + 2 ;
F_3 ( V_2 ) ;
F_29 ( L_31 ,
V_74 -> V_98 , V_46 ) ;
...
static void F_181 ( T_9 V_236 , struct V_207 * V_237 ,
T_8 * V_12 , void * V_238 )
{
struct V_239 V_240 ;
F_182 ( & V_240 , & V_237 -> V_221 , V_12 ) ;
V_236 ( V_237 , & V_240 , V_238 ) ;
}
static inline int
F_183 ( struct V_4 * V_5 , struct V_1 * V_2 ,
T_9 V_236 , struct V_207 * V_237 ,
T_8 * V_12 , void * V_238 )
{
struct V_214 * V_241 = & V_237 -> V_221 ;
struct V_214 V_242 ;
T_8 * V_243 = NULL ;
struct V_18 V_211 ;
T_2 V_244 ;
...
int V_245 = - V_122 ;
V_243 = V_12 ++ ;
V_244 = ( V_223 * ) V_12 - ( V_223 * ) V_241 -> V_189 [ 0 ] . V_219 ;
* V_12 ++ = F_166 ( V_237 -> V_217 ) ;
F_181 ( V_236 , V_237 , V_12 , V_238 ) ;
if ( F_184 ( V_241 , & V_242 ,
V_244 , V_241 -> V_15 - V_244 ) )
return V_245 ;
* V_243 = F_166 ( V_242 . V_15 ) ;
if ( V_241 -> V_246 || V_241 -> V_247 [ 0 ] . V_222 )
V_213 = V_241 -> V_247 ;
else
V_213 = V_241 -> V_189 ;
V_12 = V_213 -> V_219 + V_213 -> V_222 ;
V_211 . V_20 = ( V_223 * ) ( V_12 + 1 ) ;
V_210 = F_170 ( V_2 -> V_43 , & V_242 , & V_211 ) ;
V_245 = - V_122 ;
if ( V_210 == V_224 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
else if ( V_210 )
return V_245 ;
V_16 = F_171 ( V_12 , NULL , V_211 . V_15 ) ;
V_244 = ( V_223 * ) V_16 - ( V_223 * ) V_12 ;
V_213 -> V_222 += V_244 ;
V_241 -> V_15 += V_244 ;
return 0 ;
}
static void
F_185 ( struct V_207 * V_237 )
{
int V_248 ;
for ( V_248 = 0 ; V_248 < V_237 -> V_249 ; V_248 ++ )
F_186 ( V_237 -> V_250 [ V_248 ] ) ;
F_42 ( V_237 -> V_250 ) ;
}
static int
F_187 ( struct V_207 * V_237 )
{
struct V_214 * V_241 = & V_237 -> V_221 ;
int V_251 , V_252 , V_248 ;
if ( V_241 -> V_246 == 0 ) {
V_237 -> V_249 = 0 ;
return 0 ;
}
V_251 = V_241 -> V_253 >> V_254 ;
V_252 = ( V_241 -> V_253 + V_241 -> V_246 - 1 ) >> V_254 ;
V_237 -> V_249 = V_252 - V_251 + 1 + 1 ;
V_237 -> V_250
= F_83 ( V_237 -> V_249 * sizeof( struct V_255 * ) ,
V_21 ) ;
if ( ! V_237 -> V_250 )
goto V_101;
for ( V_248 = 0 ; V_248 < V_237 -> V_249 ; V_248 ++ ) {
V_237 -> V_250 [ V_248 ] = F_188 ( V_21 ) ;
if ( V_237 -> V_250 [ V_248 ] == NULL )
goto V_256;
}
V_237 -> V_257 = F_185 ;
return 0 ;
...
return V_245 ;
V_251 = V_241 -> V_253 >> V_254 ;
V_259 = V_241 -> V_262 + V_251 ;
V_241 -> V_262 = V_237 -> V_250 ;
V_241 -> V_253 -= V_251 << V_254 ;
if ( V_241 -> V_246 || V_241 -> V_247 [ 0 ] . V_222 ) {
V_261 = F_190 ( V_237 -> V_250 [ V_237 -> V_249 - 1 ] ) ;
memcpy ( V_261 , V_241 -> V_247 [ 0 ] . V_219 , V_241 -> V_247 [ 0 ] . V_222 ) ;
V_241 -> V_247 [ 0 ] . V_219 = V_261 ;
}
V_210 = F_191 ( V_2 -> V_43 , V_244 , V_241 , V_259 ) ;
F_38 ( V_241 -> V_15 > V_241 -> V_83 ) ;
V_245 = - V_122 ;
if ( V_210 == V_224 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
else if ( V_210 )
return V_245 ;
* V_258 = F_166 ( V_241 -> V_15 - V_244 ) ;
if ( V_241 -> V_246 || V_241 -> V_247 [ 0 ] . V_222 )
V_213 = V_241 -> V_247 ;
else
V_213 = V_241 -> V_189 ;
V_12 = V_213 -> V_219 + V_213 -> V_222 ;
V_260 = 3 - ( ( V_241 -> V_15 - V_244 - 1 ) & 3 ) ;
memset ( V_12 , 0 , V_260 ) ;
V_213 -> V_222 += V_260 ;
V_241 -> V_15 += V_260 ;
return 0 ;
...
T_9 V_236 , void * V_237 , T_8 * V_12 , void * V_238 )
{
struct V_4 * V_5 = V_74 -> V_75 -> V_76 ;
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 ,
V_7 ) ;
...
break;
case V_264 :
V_245 = F_183 ( V_5 , V_2 , V_236 , V_237 , V_12 , V_238 ) ;
break;
case V_265 :
V_245 = F_189 ( V_5 , V_2 , V_236 , V_237 , V_12 , V_238 ) ;
break;
}
V_101:
F_3 ( V_2 ) ;
F_29 ( L_33 , V_74 -> V_98 , V_46 , V_245 ) ;
return V_245 ;
}
static inline int
F_193 ( struct V_4 * V_5 , struct V_1 * V_2 ,
struct V_207 * V_237 , T_8 * * V_12 )
{
struct V_214 * V_266 = & V_237 -> V_267 ;
struct V_214 V_242 ;
struct V_18 V_211 ;
T_2 V_268 , V_269 ;
T_2 V_243 ;
...
if ( V_243 & 3 )
return V_245 ;
V_268 = ( V_223 * ) ( * V_12 ) - ( V_223 * ) V_266 -> V_189 [ 0 ] . V_219 ;
V_269 = V_243 + V_268 ;
if ( V_269 > V_266 -> V_15 )
return V_245 ;
if ( F_178 ( * ( * V_12 ) ++ ) != V_237 -> V_217 )
return V_245 ;
if ( F_184 ( V_266 , & V_242 , V_268 ,
V_269 - V_268 ) )
return V_245 ;
if ( F_194 ( V_266 , & V_211 , V_269 ) )
return V_245 ;
V_210 = F_179 ( V_2 -> V_43 , & V_242 , & V_211 ) ;
if ( V_210 == V_224 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_210 != V_270 )
return V_245 ;
...
int V_245 = - V_122 ;
V_258 = F_178 ( * ( * V_12 ) ++ ) ;
V_244 = ( V_223 * ) ( * V_12 ) - ( V_223 * ) V_266 -> V_189 [ 0 ] . V_219 ;
if ( V_244 + V_258 > V_266 -> V_15 )
return V_245 ;
V_266 -> V_15 = V_244 + V_258 ;
V_210 = F_196 ( V_2 -> V_43 , V_244 , V_266 ) ;
if ( V_210 == V_224 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_210 != V_270 )
return V_245 ;
...
static int
F_197 ( T_10 V_271 , struct V_207 * V_237 ,
T_8 * V_12 , void * V_238 )
{
struct V_239 V_240 ;
F_198 ( & V_240 , & V_237 -> V_267 , V_12 ) ;
return V_271 ( V_237 , & V_240 , V_238 ) ;
}
static int
F_199 ( struct V_73 * V_74 ,
T_10 V_271 , void * V_237 , T_8 * V_12 , void * V_238 )
{
struct V_4 * V_5 = V_74 -> V_75 -> V_76 ;
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 ,
V_7 ) ;
struct V_1 * V_2 = F_19 ( V_5 ) ;
T_8 * V_272 = V_12 ;
struct V_212 * V_189 = ( (struct V_207 * ) V_237 ) -> V_267 . V_189 ;
int V_273 = V_189 -> V_222 ;
int V_245 = - V_122 ;
if ( V_2 -> V_23 != V_24 )
goto V_274;
switch ( V_6 -> V_197 ) {
...
break;
case V_264 :
V_245 = F_193 ( V_5 , V_2 , V_237 , & V_12 ) ;
if ( V_245 )
goto V_101;
break;
case V_265 :
V_245 = F_195 ( V_5 , V_2 , V_237 , & V_12 ) ;
if ( V_245 )
goto V_101;
break;
}
V_5 -> V_96 -> V_163 = V_5 -> V_96 -> V_235 + ( V_12 - V_272 )
+ ( V_273 - V_189 -> V_222 ) ;
V_274:
V_245 = F_197 ( V_271 , V_237 , V_12 , V_238 ) ;
V_101:
F_3 ( V_2 ) ;
F_29 ( L_33 ,
V_74 -> V_98 , V_46 , V_245 ) ;
return V_245 ;
}
