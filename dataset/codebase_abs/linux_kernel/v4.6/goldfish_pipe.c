...
unsigned long V_60 ;
F_21 ( & V_61 -> V_62 -> V_63 ) ;
V_48 = F_22 ( V_32 , 1 , ! V_43 , 0 , & V_59 , NULL ) ;
F_23 ( & V_61 -> V_62 -> V_63 ) ;
if ( V_48 < 0 )
break;
if ( V_7 -> V_64 ) {
...
static unsigned int F_33 ( struct V_39 * V_40 , T_8 * V_78 )
{
struct V_1 * V_2 = V_40 -> V_45 ;
unsigned int V_79 = 0 ;
int V_5 ;
F_34 ( & V_2 -> V_8 ) ;
F_35 ( V_40 , & V_2 -> V_76 , V_78 ) ;
V_5 = F_1 ( V_2 , V_80 ) ;
F_29 ( & V_2 -> V_8 ) ;
if ( V_5 & V_81 )
V_79 |= V_82 | V_83 ;
...
static T_9 F_36 ( int V_90 , void * V_91 )
{
struct V_6 * V_7 = V_91 ;
unsigned long V_44 ;
int V_47 = 0 ;
...
if ( V_36 == 0 )
break;
V_92 = F_5 ( V_7 -> V_9 + V_93 ) ;
V_2 = (struct V_1 * ) ( V_94 ) V_36 ;
if ( V_92 & V_95 ) {
F_28 ( V_49 , & V_2 -> V_4 ) ;
V_92 |= V_96 | V_97 ;
}
...
F_6 ( & V_7 -> V_8 , V_44 ) ;
return ( V_47 == 0 ) ? V_98 : V_99 ;
}
static int F_40 ( struct V_100 * V_100 , struct V_39 * V_39 )
{
struct V_1 * V_2 ;
...
static int F_45 ( struct V_100 * V_100 , struct V_39 * V_40 )
{
struct V_1 * V_2 = V_40 -> V_45 ;
F_7 ( V_2 , V_103 ) ;
F_44 ( V_2 ) ;
...
F_47 ( V_7 -> V_9 != NULL ) ;
F_48 ( & V_7 -> V_8 ) ;
V_106 = F_49 ( V_29 , V_107 , 0 ) ;
if ( V_106 == NULL || F_50 ( V_106 ) < V_56 ) {
F_51 ( & V_29 -> V_7 , L_4 ) ;
return - V_20 ;
}
V_7 -> V_9 = F_52 ( & V_29 -> V_7 , V_106 -> V_108 , V_56 ) ;
if ( V_7 -> V_9 == NULL ) {
F_51 ( & V_29 -> V_7 , L_5 ) ;
return - V_20 ;
}
V_106 = F_49 ( V_29 , V_109 , 0 ) ;
if ( V_106 == NULL ) {
V_104 = - V_20 ;
goto error;
}
V_7 -> V_90 = V_106 -> V_108 ;
V_104 = F_53 ( & V_29 -> V_7 , V_7 -> V_90 , F_36 ,
V_110 , L_6 , V_7 ) ;
if ( V_104 ) {
F_51 ( & V_29 -> V_7 , L_7 ) ;
goto error;
