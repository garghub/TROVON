...
static void F_28 ( struct V_24 * V_18 )
{
int V_44 ;
char * V_45 [] = { V_46 , V_18 -> V_10 -> V_47 , L_2 , NULL } ;
char * V_48 [] = { NULL } ;
struct V_5 * V_6 ;
if ( F_29 ( F_30 ( V_18 -> V_10 ) , & V_49 ) )
V_44 = F_31 ( V_46 , V_45 , V_48 , V_50 ) ;
else
V_44 = - V_51 ;
F_9 ( & V_18 -> V_25 ) ;
if ( V_18 -> V_52 < V_53 )
...
static void F_34 ( struct V_24 * V_18 )
{
int V_44 ;
...
void F_37 ( struct V_24 * V_18 , unsigned long V_58 )
{
F_38 () ;
if ( V_58 ) {
if ( V_18 -> V_26 == V_57 )
...
void F_39 ( struct V_24 * V_18 , const unsigned char * V_59 )
{
...
F_12 (p, &br->port_list, list) {
if ( F_41 ( V_6 -> V_65 . V_59 , V_62 ) )
memcpy ( V_6 -> V_65 . V_59 , V_59 , V_61 ) ;
if ( F_41 ( V_6 -> V_66 . V_59 , V_62 ) )
...
if ( F_41 ( V_18 -> V_63 . V_59 , V_59 ) )
return false ;
F_39 ( V_18 , V_59 ) ;
return true ;
}
void F_43 ( struct V_24 * V_18 , V_3 V_71 )
{
struct V_5 * V_6 ;
int V_40 ;
F_9 ( & V_18 -> V_25 ) ;
...
int F_45 ( struct V_5 * V_6 , unsigned long V_71 )
{
T_1 V_73 ;
if ( V_71 > V_74 )
return - V_75 ;
...
int F_46 ( struct V_5 * V_6 , unsigned long V_77 )
{
if ( V_77 < V_78 ||
V_77 > V_79 )
return - V_75 ;
...
T_4 F_47 ( char * V_81 , const struct V_63 * V_11 )
{
