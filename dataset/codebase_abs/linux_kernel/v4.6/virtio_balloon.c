...
static unsigned F_16 ( struct V_8 * V_9 , T_2 V_20 )
{
...
static inline void F_30 ( struct V_8 * V_9 , int V_31 ,
T_3 V_32 , T_4 V_33 )
{
F_5 ( V_31 >= V_34 ) ;
V_9 -> V_35 [ V_31 ] . V_32 = F_31 ( V_9 -> V_10 , V_32 ) ;
V_9 -> V_35 [ V_31 ] . V_33 = F_32 ( V_9 -> V_10 , V_33 ) ;
}
...
F_30 ( V_9 , V_31 ++ , V_42 ,
F_37 ( V_36 [ V_43 ] ) ) ;
F_30 ( V_9 , V_31 ++ , V_44 , V_36 [ V_45 ] ) ;
F_30 ( V_9 , V_31 ++ , V_46 , V_36 [ V_47 ] ) ;
F_30 ( V_9 , V_31 ++ , V_48 ,
F_37 ( V_19 . V_49 ) ) ;
F_30 ( V_9 , V_31 ++ , V_50 ,
F_37 ( V_19 . V_51 ) ) ;
...
static void F_43 ( struct V_58 * V_10 )
{
...
static inline T_5 F_46 ( struct V_8 * V_9 )
{
T_5 V_61 ;
T_1 V_26 ;
F_47 ( V_9 -> V_10 , struct V_62 , V_26 ,
& V_26 ) ;
if ( ! F_23 ( V_9 -> V_10 , V_63 ) )
V_26 = F_48 ( ( V_64 V_65 ) V_26 ) ;
V_61 = V_26 ;
...
T_1 V_66 = V_9 -> V_26 ;
if ( ! F_23 ( V_9 -> V_10 , V_63 ) )
V_66 = ( V_64 T_1 ) F_50 ( V_66 ) ;
F_51 ( V_9 -> V_10 , struct V_62 , V_66 ,
& V_66 ) ;
}
...
unsigned long * V_71 ;
unsigned V_29 ;
V_9 = F_53 ( V_68 , struct V_8 , V_72 ) ;
if ( ! F_23 ( V_9 -> V_10 , V_27 ) )
return V_73 ;
V_71 = V_70 ;
V_29 = F_28 ( V_9 , V_74 ) ;
F_49 ( V_9 ) ;
...
static int F_64 ( struct V_58 * V_10 )
{
struct V_8 * V_9 ;
int V_81 ;
if ( ! V_10 -> V_84 -> V_94 ) {
...
V_10 -> V_11 = V_9 = F_66 ( sizeof( * V_9 ) , V_18 ) ;
if ( ! V_9 ) {
V_81 = - V_97 ;
goto V_98;
}
...
F_28 ( V_9 , V_9 -> V_26 ) ;
F_49 ( V_9 ) ;
V_9 -> V_10 -> V_84 -> V_106 ( V_9 -> V_10 ) ;
V_9 -> V_10 -> V_84 -> V_105 ( V_9 -> V_10 ) ;
}
static void F_77 ( struct V_58 * V_10 )
{
struct V_8 * V_9 = V_10 -> V_11 ;
F_78 ( & V_9 -> V_72 ) ;
F_79 ( & V_9 -> V_53 ) ;
...
static int F_82 ( struct V_58 * V_10 )
{
struct V_8 * V_9 = V_10 -> V_11 ;
F_76 ( V_9 ) ;
return 0 ;
}
static int F_83 ( struct V_58 * V_10 )
{
struct V_8 * V_9 = V_10 -> V_11 ;
int V_107 ;
V_107 = F_56 ( V_10 -> V_11 ) ;
if ( V_107 )
return V_107 ;
F_74 ( V_10 ) ;
if ( F_46 ( V_9 ) )
