...
static int F_68 ( struct F_64 * V_42 ,
struct V_5 * V_6 )
{
struct V_10 * V_10 ;
V_10 = F_69 ( V_89 , V_90 ) ;
...
static int F_71 ( struct F_64 * V_42 ,
struct V_43 * V_43 ,
struct V_14 * V_14 ,
struct V_5 * V_6 )
{
...
V_46 = F_72 ( V_42 -> V_80 , V_14 , V_6 -> V_33 , F_16 ( V_6 ) ) ;
if ( V_46 != V_6 -> V_33 )
goto V_93;
F_73 ( V_42 -> V_82 , V_14 , V_6 -> V_33 ) ;
V_42 -> V_92 ++ ;
return 0 ;
}
int F_74 ( struct F_64 * V_42 ,
struct V_14 * V_14 ,
int V_94 ,
struct V_87 * V_88 ,
bool V_95 )
...
if ( F_87 ( V_6 ) ) {
F_88 ( V_6 ) ;
F_89 ( V_6 -> V_8 , V_6 -> V_9 ) ;
}
F_90 ( V_6 ) ;
V_100 ++ ;
} while ( ( V_6 = V_6 -> V_34 ) != V_19 );
V_6 = V_19 = F_13 ( V_14 ) ;
if ( F_91 ( V_43 ) && F_92 ( V_43 -> V_102 ) &&
V_100 ) {
T_6 V_103 = V_104 ;
V_105:
V_16 = F_93 ( V_43 , V_14 , V_103 ) ;
if ( F_94 ( V_16 ) ) {
V_46 = F_95 ( V_16 ) ;
