...
{
unsigned long V_160 ;
if ( F_129 ( V_159 , 10 , & V_160 ) )
return - V_161 ;
if ( ! strcasecmp ( V_158 , L_1 ) ||
! strcasecmp ( V_158 , L_2 ) ||
! strcasecmp ( V_158 , L_3 ) ||
! strcasecmp ( V_158 , L_4 ) ||
! strcasecmp ( V_158 , L_5 ) ) {
F_130 ( L_6 , V_158 ) ;
return 0 ;
}
return - V_161 ;
}
static int F_131 ( struct V_138 * V_139 , char * V_120 ,
unsigned V_162 , T_6 * V_163 )
{
T_6 V_164 = * V_163 ;
F_132 ( L_7
L_8
...
static void F_133 ( struct V_73 * V_74 , bool V_165 )
{
V_74 -> V_140 . V_166 = F_104 ;
V_74 -> V_140 . F_101 = F_107 ;
V_74 -> V_140 . V_167 = F_110 ;
V_74 -> V_140 . V_168 = F_112 ;
V_74 -> V_140 . V_169 = F_113 ;
V_74 -> V_140 . V_170 = F_114 ;
V_74 -> V_140 . V_171 = F_116 ;
V_74 -> V_140 . V_172 = F_118 ;
V_74 -> V_140 . V_173 = F_120 ;
V_74 -> V_140 . V_174 = F_123 ;
V_74 -> V_140 . V_175 = F_125 ;
V_74 -> V_140 . V_176 = F_126 ;
V_74 -> V_140 . V_157 = F_127 ;
if ( V_165 ) {
V_74 -> V_140 . V_177 = F_128 ;
V_74 -> V_140 . V_178 = F_131 ;
}
}
static bool F_134 ( T_3 V_179 ,
T_3 V_180 ,
unsigned V_97 )
{
return ( V_180 * V_97 ) > V_179 ;
}
static void F_135 ( T_3 V_179 ,
T_3 V_181 ,
unsigned V_182 ,
T_3 * V_180 ,
unsigned * V_97 )
{
* V_180 = V_181 * 16u ;
* V_97 = F_44 ( V_182 / 4u , 1024u ) ;
while ( ( * V_180 > V_181 ) &&
F_134 ( V_179 , * V_180 , * V_97 ) )
* V_180 /= 2u ;
}
static struct V_138 * F_136 ( T_2 V_102 ,
T_3 V_179 ,
T_3 V_181 ,
bool V_165 )
{
unsigned V_25 ;
unsigned V_183 = 2u * V_72 ;
unsigned V_184 = 2u * V_183 ;
struct V_73 * V_74 = F_137 ( sizeof( * V_74 ) , V_185 ) ;
if ( ! V_74 )
return NULL ;
F_133 ( V_74 , V_165 ) ;
V_74 -> V_102 = V_102 ;
V_74 -> V_181 = V_181 ;
F_135 ( V_179 , V_181 , F_84 ( V_102 ) ,
& V_74 -> V_180 , & V_74 -> V_97 ) ;
V_74 -> V_130 = F_138 ( V_74 -> V_180 , V_74 -> V_181 ) ;
V_74 -> V_95 = 1u ;
if ( F_3 ( & V_74 -> V_4 , V_184 + V_74 -> V_97 + F_84 ( V_102 ) ) ) {
F_139 ( L_12 ) ;
goto V_186;
}
F_58 ( & V_74 -> V_75 , & V_74 -> V_4 , 0 , V_183 ) ;
for ( V_25 = 0 ; V_25 < V_183 ; V_25 ++ )
F_65 ( & V_74 -> V_75 , V_25 ) -> V_20 = true ;
F_58 ( & V_74 -> V_77 , & V_74 -> V_4 , V_183 , V_184 ) ;
for ( V_25 = 0 ; V_25 < V_183 ; V_25 ++ )
F_65 ( & V_74 -> V_77 , V_25 ) -> V_20 = true ;
F_58 ( & V_74 -> V_134 , & V_74 -> V_4 , V_184 ,
V_184 + V_74 -> V_97 ) ;
F_58 ( & V_74 -> V_87 , & V_74 -> V_4 ,
V_184 + V_74 -> V_97 ,
V_184 + V_74 -> V_97 + F_84 ( V_102 ) ) ;
V_74 -> V_96 = F_140 ( V_74 -> V_97 ) ;
if ( ! V_74 -> V_96 ) {
F_139 ( L_13 ) ;
goto V_187;
}
...
static struct V_138 * F_142 ( T_2 V_102 ,
T_3 V_179 ,
T_3 V_181 )
{
return F_136 ( V_102 , V_179 , V_181 , false ) ;
}
static struct V_138 * F_143 ( T_2 V_102 ,
T_3 V_179 ,
T_3 V_181 )
{
return F_136 ( V_102 , V_179 , V_181 , true ) ;
}
