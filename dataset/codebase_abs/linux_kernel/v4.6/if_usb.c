...
sizeof( V_127 ) ) ;
if ( F_17 ( V_3 -> V_46 -> V_60 . V_82 ) < 0x3106 ) {
F_61 ( V_118 ) ;
F_62 ( V_3 ) ;
V_3 -> V_127 = V_131 ;
F_29 ( & V_3 -> V_46 -> V_8 ,
...
static void V_84 ( struct V_6 * V_7 , int V_104 ,
...
static int F_86 ( struct V_41 * V_42 , T_5 V_180 )
{
struct V_2 * V_3 = F_44 ( V_42 ) ;
struct V_6 * V_7 = V_3 -> V_7 ;
int V_104 ;
