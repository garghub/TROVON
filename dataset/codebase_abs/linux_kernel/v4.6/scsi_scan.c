...
T_1 V_23 , int * V_205 ,
struct V_12 * * V_206 , int V_207 ,
void * V_24 )
{
struct V_12 * V_13 ;
unsigned char * V_14 ;
int V_108 , V_208 = V_138 , V_107 = 256 ;
struct V_27 * V_5 = F_19 ( V_22 -> V_28 . V_29 ) ;
V_13 = F_82 ( V_22 , V_23 ) ;
if ( V_13 ) {
if ( V_207 || ! F_83 ( V_13 ) ) {
...
V_208 = F_69 ( V_13 , V_14 , & V_108 , V_5 -> V_216 ) ;
if ( V_208 == V_198 ) {
if ( V_108 & V_217 ) {
V_13 -> V_149 = 0 ;
F_15 ( V_13 , V_14 ) ;
...
if ( V_108 & V_224 )
V_218 = F_67 ( 5U , V_218 ) ;
if ( V_95 < V_151 && ! ( V_108 & V_225 ) )
V_218 = F_67 ( 8U , V_218 ) ;
if ( ! ( V_108 & V_226 ) )
V_218 = F_67 ( 256U , V_218 ) ;
for ( V_23 = 1 ; V_23 < V_218 ; ++ V_23 )
if ( ( F_81 ( V_22 , V_23 , NULL , NULL , V_207 ,
NULL ) != V_198 ) &&
! V_219 )
return;
}
...
V_228 = ( 511 + 1 ) * sizeof( struct V_231 ) ;
V_99:
V_233 = F_3 ( V_228 , V_4 |
( V_13 -> V_42 -> V_209 ? V_210 : 0 ) ) ;
if ( ! V_233 ) {
F_9 ( V_72 , V_73 ) ;
goto V_37;
}
...
if ( F_91 ( V_233 -> V_231 ) +
sizeof( struct V_231 ) > V_228 ) {
V_228 = F_91 ( V_233 -> V_231 ) +
sizeof( struct V_231 ) ;
F_14 ( V_233 ) ;
goto V_99;
}
V_228 = F_91 ( V_233 -> V_231 ) ;
V_229 = ( V_228 / sizeof( struct V_231 ) ) ;
F_63 ( 3 , F_16 ( V_10 , V_13 ,
L_35 ) ) ;
for ( V_232 = & V_233 [ 1 ] ; V_232 <= & V_233 [ V_229 ] ; V_232 ++ ) {
V_23 = F_92 ( V_232 ) ;
if ( V_23 > V_13 -> V_42 -> V_221 ) {
F_16 ( V_144 , V_13 ,
L_36
L_37 , V_23 ) ;
} else {
...
{
struct V_12 * V_13 = F_94 ( - V_239 ) ;
struct V_74 * V_29 = & V_5 -> V_240 ;
struct V_21 * V_22 ;
if ( strncmp ( V_241 , L_41 , 4 ) == 0 )
return F_94 ( - V_239 ) ;
...
{
struct V_12 * V_13 =
F_93 ( V_42 , V_46 , V_244 , V_23 , NULL ) ;
if ( F_103 ( V_13 ) )
return F_104 ( V_13 ) ;
F_85 ( V_13 ) ;
return 0 ;
...
F_107 ( V_28 ) ;
F_78 ( V_13 ) ;
if ( V_13 -> V_245 && V_13 -> V_245 -> V_207 )
V_13 -> V_245 -> V_207 ( V_13 ) ;
if ( V_28 -> V_246 && F_108 ( V_28 -> V_246 -> V_247 ) ) {
struct V_248 * V_249 = F_109 ( V_28 -> V_246 ) ;
if ( V_249 -> V_207 )
V_249 -> V_207 ( V_28 ) ;
F_110 ( V_28 -> V_246 -> V_247 ) ;
}
F_111 ( V_28 ) ;
}
static void F_112 ( struct V_74 * V_29 , unsigned int V_46 ,
unsigned int V_45 , T_1 V_23 , int V_207 )
{
struct V_27 * V_5 = F_19 ( V_29 ) ;
int V_108 = 0 ;
int V_208 ;
...
F_95 ( V_22 ) ;
if ( V_23 != V_251 ) {
F_81 ( V_22 , V_23 , NULL , NULL , V_207 , NULL ) ;
goto V_252;
}
V_208 = F_81 ( V_22 , 0 , & V_108 , NULL , V_207 , NULL ) ;
if ( V_208 == V_198 || V_208 == V_214 ) {
if ( F_89 ( V_22 , V_108 , V_207 ) != 0 )
F_87 ( V_22 , V_108 ,
V_22 -> V_95 , V_207 ) ;
}
V_252:
...
F_1 () ;
if ( F_97 ( V_5 ) && F_98 ( V_5 ) == 0 ) {
F_112 ( V_29 , V_46 , V_45 , V_23 , V_207 ) ;
F_99 ( V_5 ) ;
}
F_100 ( & V_5 -> V_243 ) ;
}
...
T_2 V_253 ;
if ( V_45 == V_251 )
for ( V_45 = 0 ; V_45 < V_5 -> V_254 ; ++ V_45 ) {
if ( V_5 -> V_255 )
V_253 = V_5 -> V_254 - V_45 - 1 ;
else
V_253 = V_45 ;
F_112 ( & V_5 -> V_240 , V_46 ,
V_253 , V_23 , V_207 ) ;
}
else
F_112 ( & V_5 -> V_240 , V_46 ,
...
L_42 ,
V_73 , V_46 , V_45 , V_23 ) ) ;
if ( ( ( V_46 != V_251 ) && ( V_46 > V_5 -> V_256 ) ) ||
( ( V_45 != V_251 ) && ( V_45 >= V_5 -> V_254 ) ) ||
( ( V_23 != V_251 ) && ( V_23 >= V_5 -> V_221 ) ) )
return - V_257 ;
F_96 ( & V_5 -> V_243 ) ;
if ( ! V_5 -> V_216 )
F_1 () ;
if ( F_97 ( V_5 ) && F_98 ( V_5 ) == 0 ) {
if ( V_46 == V_251 )
for ( V_46 = 0 ; V_46 <= V_5 -> V_256 ;
V_46 ++ )
F_114 ( V_5 , V_46 , V_45 , V_23 ,
V_207 ) ;
else
F_114 ( V_5 , V_46 , V_45 , V_23 , V_207 ) ;
F_99 ( V_5 ) ;
}
F_100 ( & V_5 -> V_243 ) ;
return 0 ;
...
struct V_1 * V_2 ;
unsigned long V_75 ;
if ( strncmp ( V_241 , L_43 , 4 ) == 0 )
return NULL ;
if ( V_5 -> V_216 ) {
F_68 ( V_260 , V_5 , L_44 , V_73 ) ;
return NULL ;
}
V_2 = F_3 ( sizeof( * V_2 ) , V_4 ) ;
if ( ! V_2 )
...
if ( V_5 -> V_67 -> V_265 )
V_5 -> V_67 -> V_265 ( V_5 ) ;
while ( ! V_5 -> V_67 -> V_262 ( V_5 , V_264 - V_263 ) )
F_4 ( 10 ) ;
} else {
F_115 ( V_5 , V_251 , V_251 ,
V_251 , 0 ) ;
}
}
...
if ( ! F_97 ( V_5 ) )
goto V_37;
V_22 = F_52 ( & V_5 -> V_240 , 0 , V_5 -> V_250 ) ;
if ( ! V_22 )
goto V_37;
V_13 = F_18 ( V_22 , 0 , NULL ) ;
if ( V_13 )
...
{
F_60 ( V_13 -> V_45 != V_13 -> V_42 -> V_250 ) ;
F_35 ( V_13 ) ;
}
