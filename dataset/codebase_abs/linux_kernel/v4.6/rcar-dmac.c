...
F_28 ( V_72 ) ;
F_23 ( & V_8 -> V_67 , V_65 ) ;
F_36 ( & V_8 -> V_15 . V_81 , & V_72 ) ;
F_26 ( & V_8 -> V_67 , V_65 ) ;
F_37 (desc, _desc, &list, node) {
if ( F_38 ( & V_15 -> V_44 ) ) {
F_39 ( & V_15 -> V_33 ) ;
F_33 ( V_8 , V_15 ) ;
}
...
return;
F_23 ( & V_8 -> V_67 , V_65 ) ;
F_41 ( & V_72 , & V_8 -> V_15 . V_81 ) ;
F_26 ( & V_8 -> V_67 , V_65 ) ;
}
static struct V_14 * F_42 ( struct V_7 * V_8 )
{
struct V_14 * V_15 ;
unsigned long V_65 ;
int V_82 ;
...
static int F_43 ( struct V_7 * V_8 , T_4 V_69 )
{
struct V_70 * V_71 ;
unsigned long V_65 ;
F_28 ( V_72 ) ;
...
return;
if ( V_15 -> V_18 . V_85 ) {
F_47 ( V_8 -> V_8 . V_22 -> V_23 , V_15 -> V_18 . V_48 ,
...
if ( ! V_48 )
return;
V_15 -> V_18 . V_85 = F_48 ( V_8 -> V_8 . V_22 -> V_23 , V_48 ,
& V_15 -> V_18 . V_26 , V_83 ) ;
if ( ! V_15 -> V_18 . V_85 )
return;
V_15 -> V_18 . V_48 = V_48 ;
...
struct V_20 * V_21 ;
struct V_86 * V_87 ;
F_45 ( V_8 , V_15 , V_15 -> V_25 * sizeof( * V_87 ) ) ;
V_87 = V_15 -> V_18 . V_85 ;
if ( ! V_87 )
return - V_74 ;
F_50 (chunk, &desc->chunks, node) {
V_87 -> V_88 = V_21 -> V_49 ;
V_87 -> V_89 = V_21 -> V_35 ;
...
F_28 ( V_76 ) ;
F_23 ( & V_8 -> V_67 , V_65 ) ;
F_36 ( & V_8 -> V_15 . V_68 , & V_76 ) ;
F_36 ( & V_8 -> V_15 . V_92 , & V_76 ) ;
F_36 ( & V_8 -> V_15 . V_93 , & V_76 ) ;
F_36 ( & V_8 -> V_15 . V_81 , & V_76 ) ;
V_8 -> V_15 . V_16 = NULL ;
F_26 ( & V_8 -> V_67 , V_65 ) ;
F_37 (desc, _desc, &descs, node) {
F_39 ( & V_15 -> V_33 ) ;
F_33 ( V_8 , V_15 ) ;
}
}
...
V_15 -> V_54 = F_58 ( V_103 ) ;
V_15 -> V_10 = V_10 | V_95 [ V_15 -> V_54 ] ;
}
static struct V_63 *
F_59 ( struct V_7 * V_8 , struct V_117 * V_118 ,
...
T_6 V_130 = F_61 ( V_124 ) ;
unsigned int V_131 = F_62 ( V_124 ) ;
V_126 += V_131 ;
while ( V_131 ) {
unsigned int V_48 = F_63 ( V_131 , V_125 ) ;
#ifdef F_13
if ( V_120 >> 32 != ( V_120 + V_48 - 1 ) >> 32 )
V_48 = F_64 ( V_120 , 1ULL << 32 ) - V_120 ;
if ( V_130 >> 32 != ( V_130 + V_48 - 1 ) >> 32 )
V_48 = F_64 ( V_130 , 1ULL << 32 ) - V_130 ;
...
static int F_65 ( struct V_132 * V_8 )
{
struct V_7 * V_133 = F_21 ( V_8 ) ;
int V_82 ;
F_31 ( & V_133 -> V_15 . V_79 ) ;
F_31 ( & V_133 -> V_15 . V_78 ) ;
V_82 = F_43 ( V_133 , V_134 ) ;
if ( V_82 < 0 )
return - V_74 ;
V_82 = F_27 ( V_133 , V_134 ) ;
if ( V_82 < 0 )
return - V_74 ;
return F_66 ( V_8 -> V_22 -> V_23 ) ;
}
static void F_67 ( struct V_132 * V_8 )
{
struct V_7 * V_133 = F_21 ( V_8 ) ;
struct V_1 * V_2 = F_68 ( V_8 -> V_22 ) ;
...
F_70 ( & V_133 -> V_67 ) ;
if ( V_133 -> V_17 >= 0 ) {
F_71 ( V_133 -> V_17 , V_2 -> V_136 ) ;
V_133 -> V_17 = - V_137 ;
}
F_36 ( & V_133 -> V_15 . free , & V_72 ) ;
F_36 ( & V_133 -> V_15 . V_68 , & V_72 ) ;
F_36 ( & V_133 -> V_15 . V_92 , & V_72 ) ;
F_36 ( & V_133 -> V_15 . V_93 , & V_72 ) ;
F_36 ( & V_133 -> V_15 . V_81 , & V_72 ) ;
F_50 (desc, &list, node)
F_45 ( V_133 , V_15 , 0 ) ;
F_37 (page, _page, &rchan->desc.pages, node) {
F_39 ( & V_71 -> V_33 ) ;
F_72 ( ( unsigned long ) V_71 ) ;
}
F_73 ( V_8 -> V_22 -> V_23 ) ;
}
static struct V_63 *
F_74 ( struct V_132 * V_8 , T_6 V_138 ,
...
return NULL ;
F_75 ( & V_118 , 1 ) ;
F_76 ( & V_118 , F_77 ( F_78 ( V_139 ) ) , V_131 ,
F_79 ( V_139 ) ) ;
F_61 ( & V_118 ) = V_139 ;
F_62 ( & V_118 ) = V_131 ;
return F_59 ( V_133 , & V_118 , 1 , V_138 ,
V_114 , V_65 , false ) ;
}
static struct V_63 *
F_80 ( struct V_132 * V_8 , struct V_117 * V_118 ,
...
return F_59 ( V_133 , V_118 , V_119 , V_120 ,
V_122 , V_65 , false ) ;
}
static struct V_63 *
F_81 ( struct V_132 * V_8 , T_6 V_144 ,
T_5 V_145 , T_5 V_146 ,
...
V_118 = F_83 ( V_119 , sizeof( * V_118 ) , V_83 ) ;
if ( ! V_118 )
return NULL ;
F_75 ( V_118 , V_119 ) ;
for ( V_73 = 0 ; V_73 < V_119 ; ++ V_73 ) {
T_6 V_148 = V_144 + ( V_146 * V_73 ) ;
F_76 ( & V_118 [ V_73 ] , F_77 ( F_78 ( V_148 ) ) , V_146 ,
F_79 ( V_148 ) ) ;
F_61 ( & V_118 [ V_73 ] ) = V_148 ;
F_62 ( & V_118 [ V_73 ] ) = V_146 ;
}
V_120 = V_122 == V_105
? V_133 -> V_142 : V_133 -> V_143 ;
V_15 = F_59 ( V_133 , V_118 , V_119 , V_120 ,
V_122 , V_65 , true ) ;
F_84 ( V_118 ) ;
return V_15 ;
}
...
V_154 = ( F_7 ( V_8 , V_30 ) &
V_155 ) >> V_156 ;
F_88 ( V_154 >= V_15 -> V_25 ) ;
} else {
V_16 = V_15 -> V_16 ;
}
F_89 (chunk, &desc->chunks, node) {
...
static enum V_157 F_90 ( struct V_132 * V_8 ,
T_3 V_66 ,
struct V_158 * V_159 )
{
struct V_7 * V_133 = F_21 ( V_8 ) ;
...
unsigned long V_65 ;
unsigned int V_153 ;
V_160 = F_91 ( V_8 , V_66 , V_159 ) ;
if ( V_160 == V_161 || ! V_159 )
return V_160 ;
F_23 ( & V_133 -> V_67 , V_65 ) ;
V_153 = F_87 ( V_133 , V_66 ) ;
F_26 ( & V_133 -> V_67 , V_65 ) ;
F_92 ( V_159 , V_153 ) ;
return V_160 ;
}
static void F_93 ( struct V_132 * V_8 )
{
struct V_7 * V_133 = F_21 ( V_8 ) ;
unsigned long V_65 ;
F_23 ( & V_133 -> V_67 , V_65 ) ;
if ( F_40 ( & V_133 -> V_15 . V_68 ) )
goto V_93;
...
static T_7 F_95 ( struct V_7 * V_8 )
{
struct V_14 * V_15 = V_8 -> V_15 . V_16 ;
T_7 V_82 = V_164 ;
if ( F_11 ( ! V_15 ) ) {
...
if ( ! V_15 -> V_18 . V_19 ) {
if ( ! F_96 ( & V_15 -> V_16 -> V_33 , & V_15 -> V_32 ) ) {
V_15 -> V_16 = F_97 ( V_15 -> V_16 , V_33 ) ;
if ( ! V_15 -> V_41 )
V_82 = V_165 ;
goto V_93;
}
...
F_98 ( & V_15 -> V_33 , & V_8 -> V_15 . V_93 ) ;
if ( ! F_40 ( & V_8 -> V_15 . V_92 ) )
...
static T_7 F_100 ( int V_166 , void * V_23 )
{
struct V_7 * V_8 = V_23 ;
struct V_14 * V_15 ;
F_69 ( & V_8 -> V_67 ) ;
...
static T_7 F_102 ( int V_166 , void * V_4 )
{
struct V_1 * V_2 = V_4 ;
if ( ! ( F_4 ( V_2 , V_5 ) & V_61 ) )
return V_163 ;
...
static bool F_103 ( struct V_132 * V_8 , void * V_169 )
{
struct V_1 * V_2 = F_68 ( V_8 -> V_22 ) ;
struct V_170 * V_171 = V_169 ;
if ( V_8 -> V_22 -> V_172 != F_85 ||
V_171 -> V_173 != V_8 -> V_22 -> V_23 -> V_174 )
return false ;
return ! F_104 ( V_171 -> args [ 0 ] , V_2 -> V_136 ) ;
}
static struct V_132 * F_105 ( struct V_170 * V_171 ,
struct V_175 * V_176 )
{
struct V_7 * V_133 ;
struct V_132 * V_8 ;
...
unsigned int V_24 )
{
struct V_179 * V_180 = F_115 ( V_2 -> V_23 ) ;
...
V_166 = F_118 ( V_180 , V_181 ) ;
if ( V_166 < 0 ) {
F_82 ( V_2 -> V_23 , L_10 , V_24 ) ;
return - V_183 ;
}
V_182 = F_119 ( V_2 -> V_23 , V_134 , L_11 ,
F_120 ( V_2 -> V_23 ) , V_24 ) ;
if ( ! V_182 )
return - V_74 ;
V_82 = F_121 ( V_2 -> V_23 , V_166 , F_99 ,
F_100 , 0 ,
V_182 , V_133 ) ;
if ( V_82 ) {
F_82 ( V_2 -> V_23 , L_12 , V_166 , V_82 ) ;
return V_82 ;
}
V_8 -> V_22 = & V_2 -> V_184 ;
F_122 ( V_8 ) ;
...
static int F_123 ( struct V_22 * V_23 , struct V_1 * V_2 )
{
struct V_185 * V_173 = V_23 -> V_174 ;
int V_82 ;
V_82 = F_124 ( V_173 , L_13 , & V_2 -> V_58 ) ;
if ( V_82 < 0 ) {
F_82 ( V_23 , L_14 ) ;
return V_82 ;
}
...
int V_166 ;
int V_82 ;
V_2 = F_126 ( & V_180 -> V_23 , sizeof( * V_2 ) , V_134 ) ;
if ( ! V_2 )
return - V_74 ;
V_2 -> V_23 = & V_180 -> V_23 ;
F_127 ( V_180 , V_2 ) ;
V_82 = F_123 ( & V_180 -> V_23 , V_2 ) ;
if ( V_82 < 0 )
return V_82 ;
if ( V_180 -> V_23 . V_198 ) {
V_2 -> V_58 -- ;
...
V_2 -> V_94 = F_128 ( & V_180 -> V_23 , V_2 -> V_58 ,
sizeof( * V_2 -> V_94 ) , V_134 ) ;
if ( ! V_2 -> V_94 )
return - V_74 ;
V_85 = F_129 ( V_180 , V_199 , 0 ) ;
V_2 -> V_6 = F_130 ( & V_180 -> V_23 , V_85 ) ;
if ( F_131 ( V_2 -> V_6 ) )
return F_132 ( V_2 -> V_6 ) ;
V_166 = F_118 ( V_180 , L_16 ) ;
if ( V_166 < 0 ) {
F_82 ( & V_180 -> V_23 , L_17 ) ;
return - V_183 ;
}
V_182 = F_119 ( V_2 -> V_23 , V_134 , L_18 ,
F_120 ( V_2 -> V_23 ) ) ;
if ( ! V_182 )
return - V_74 ;
V_82 = F_133 ( & V_180 -> V_23 , V_166 , F_102 , 0 ,
V_182 , V_2 ) ;
if ( V_82 ) {
F_82 ( & V_180 -> V_23 , L_12 ,
V_166 , V_82 ) ;
return V_82 ;
}
F_134 ( & V_180 -> V_23 ) ;
V_82 = F_66 ( & V_180 -> V_23 ) ;
if ( V_82 < 0 ) {
F_82 ( & V_180 -> V_23 , L_19 , V_82 ) ;
return V_82 ;
}
V_82 = F_17 ( V_2 ) ;
F_73 ( & V_180 -> V_23 ) ;
if ( V_82 ) {
F_82 ( & V_180 -> V_23 , L_20 ) ;
goto error;
}
F_31 ( & V_2 -> V_184 . V_94 ) ;
for ( V_73 = 0 ; V_73 < V_2 -> V_58 ; ++ V_73 ) {
V_82 = F_114 ( V_2 , & V_2 -> V_94 [ V_73 ] ,
V_73 + V_195 ) ;
if ( V_82 < 0 )
goto error;
}
V_82 = F_135 ( V_180 -> V_23 . V_174 , F_105 ,
NULL ) ;
if ( V_82 < 0 )
goto error;
V_184 = & V_2 -> V_184 ;
F_107 ( V_200 , V_184 -> V_201 ) ;
F_107 ( V_178 , V_184 -> V_201 ) ;
V_184 -> V_23 = & V_180 -> V_23 ;
V_184 -> V_202 = F_58 ( V_116 ) ;
V_184 -> V_203 = V_187 ;
V_184 -> V_204 = V_187 ;
V_184 -> V_205 = F_136 ( V_110 ) | F_136 ( V_105 ) ;
V_184 -> V_206 = V_207 ;
V_184 -> V_208 = F_65 ;
V_184 -> V_209 = F_67 ;
V_184 -> V_210 = F_74 ;
...
return 0 ;
error:
F_138 ( V_180 -> V_23 . V_174 ) ;
F_139 ( & V_180 -> V_23 ) ;
return V_82 ;
}
static int F_140 ( struct V_179 * V_180 )
{
struct V_1 * V_2 = F_141 ( V_180 ) ;
F_138 ( V_180 -> V_23 . V_174 ) ;
F_142 ( & V_2 -> V_184 ) ;
F_139 ( & V_180 -> V_23 ) ;
return 0 ;
}
static void F_143 ( struct V_179 * V_180 )
{
struct V_1 * V_2 = F_141 ( V_180 ) ;
F_53 ( V_2 ) ;
}
