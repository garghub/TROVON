...
static int F_37 ( struct V_50 * V_51 , T_6 V_70 )
{
T_6 V_71 , V_8 , type , V_64 = 0 ;
...
V_72 = F_40 ( V_70 , V_80 ) ;
V_73 = F_40 ( V_70 , V_81 ) ;
V_64 = ( T_6 ) V_51 -> V_82 . V_51 [ V_72 ] ;
V_8 = ( T_6 ) V_51 -> V_82 . V_51 [ V_73 ] ;
V_71 = F_40 ( V_70 , V_83 ) ;
F_29 ( L_9 ,
V_72 , V_64 , V_71 ,
F_40 ( V_70 , V_81 ) , V_8 ) ;
...
static int F_44 ( struct V_50 * V_51 , T_6 V_70 )
{
F_38 ( V_74 , 1 , V_51 , V_51 -> V_75 ) ;
switch ( F_39 ( V_70 , V_51 -> V_76 ) ) {
case V_77 :
...
static int F_53 ( struct V_50 * V_51 , T_6 V_91 )
{
char * V_10 ;
F_38 ( V_74 , 1 , V_51 , V_51 -> V_75 ) ;
if ( V_91 ) {
...
static int F_54 ( struct V_50 * V_51 , T_6 V_70 )
{
int V_15 = F_53 ( V_51 , ( V_70 >> 9 ) & 1 ) ;
V_51 -> V_75 += 4 ;
return V_15 ;
}
static int F_55 ( struct V_50 * V_51 , T_6 V_70 )
{
