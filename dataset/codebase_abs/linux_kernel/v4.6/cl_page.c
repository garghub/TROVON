...
F_16 ( V_20 , V_2 , ! V_2 -> V_51 ) ;
F_16 ( V_20 , V_2 , ! V_2 -> V_52 ) ;
F_16 ( V_20 , V_2 , ! V_2 -> V_3 ) ;
...
F_39 ( & V_2 -> V_46 ) ;
V_66 = V_61 -> V_10 . V_73 ;
F_7 (o, &head->loh_layers, co_lu.lo_linkage) {
if ( V_61 -> V_74 -> V_75 ) {
...
V_91 = V_88 -> V_51 ;
return F_60 ( V_88 ) &&
F_49 ( V_77 , V_77 -> V_13 == V_88 ) &&
F_49 ( V_90 , V_90 -> V_3 == V_88 ) &&
F_49 ( V_90 , V_88 -> V_49 != V_90 -> V_49 ) &&
F_49 ( V_77 , V_88 -> V_49 != V_77 -> V_49 ) &&
F_49 ( V_91 && V_77 ,
V_77 -> V_51 == V_88 -> V_51 -> V_92 ) &&
F_49 ( V_91 && V_90 , V_90 -> V_51 -> V_92 == V_91 ) &&
...
for (; V_2 ; V_2 = V_2 -> V_13 ) {
F_16 ( V_20 , V_2 , V_2 -> V_43 == V_93 ) ;
F_16 ( V_20 , V_2 ,
F_63 ( V_60 == V_96 , V_2 -> V_51 ) ) ;
F_31 ( V_2 , V_60 ) ;
}
}
...
if ( ! V_101 )
return NULL ;
for ( V_2 = V_101 ; V_2 ; V_2 = V_2 -> V_13 ) {
...
{
for ( V_2 = F_67 ( V_2 ) ; V_2 ; V_2 = V_2 -> V_13 ) {
if ( V_2 -> V_51 ) {
...
V_24 , V_107 ) ;
if ( V_69 == 0 ) {
F_16 ( V_20 , V_88 , ! V_88 -> V_51 ) ;
F_16 ( V_20 , V_88 , ! V_88 -> V_52 ) ;
V_88 -> V_51 = V_24 ;
V_88 -> V_105 = V_47 ;
F_76 ( V_88 ) ;
if ( V_88 -> V_43 != V_44 ) {
...
if ( ! V_138 -> V_56 -> V_24 [ V_124 ] . V_139 )
continue;
...
{
struct V_1 * V_138 ;
for ( V_138 = F_67 ( (struct V_1 * ) V_88 ) ; V_138 ;
V_138 = V_138 -> V_13 )
