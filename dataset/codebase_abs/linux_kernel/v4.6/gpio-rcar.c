...
static int F_38 ( struct V_67 * V_26 )
{
struct V_1 * V_2 ;
...
const char * V_72 = F_39 ( V_27 ) ;
unsigned int V_53 ;
int V_62 ;
V_2 = F_40 ( V_27 , sizeof( * V_2 ) , V_73 ) ;
if ( ! V_2 )
return - V_74 ;
V_2 -> V_26 = V_26 ;
F_41 ( & V_2 -> V_19 ) ;
...
F_47 ( V_27 ) ;
F_48 ( V_27 ) ;
V_69 = F_49 ( V_26 , V_76 , 0 ) ;
V_38 = F_49 ( V_26 , V_77 , 0 ) ;
if ( ! V_69 || ! V_38 ) {
F_45 ( V_27 , L_6 ) ;
V_62 = - V_34 ;
goto V_75;
}
V_2 -> V_4 = F_50 ( V_27 , V_69 -> V_78 , F_51 ( V_69 ) ) ;
if ( ! V_2 -> V_4 ) {
F_45 ( V_27 , L_7 ) ;
V_62 = - V_79 ;
goto V_75;
...
static int F_59 ( struct V_67 * V_26 )
{
