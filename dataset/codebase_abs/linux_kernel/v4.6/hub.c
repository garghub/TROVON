...
static int F_28 ( struct V_1 * V_2 , int V_72 , int type ,
...
V_116 = 8 ;
F_29 ( & V_2 -> V_118 ) ;
V_57 = F_27 ( V_2 -> V_4 , V_72 , & V_2 -> V_83 -> V_119 , type , V_116 ) ;
if ( V_57 < V_116 ) {
if ( V_57 != - V_120 )
F_30 ( V_2 -> V_121 ,
L_14 , V_122 , V_57 ) ;
...
* V_83 = F_12 ( V_2 -> V_83 -> V_119 . V_124 ) ;
* V_114 = F_12 ( V_2 -> V_83 -> V_119 . V_125 ) ;
if ( type != V_117 && V_115 )
* V_115 = F_6 (
...
static int F_32 ( struct V_1 * V_2 , int V_72 ,
T_1 * V_83 , T_1 * V_114 )
{
return F_28 ( V_2 , V_72 , V_117 ,
V_83 , V_114 , NULL ) ;
}
static void F_33 ( struct V_1 * V_2 )
{
struct V_127 * V_128 ;
if ( V_2 -> V_129 || F_34 ( & V_2 -> V_130 ) )
return;
V_128 = F_35 ( V_2 -> V_121 ) ;
F_36 ( V_128 ) ;
F_37 ( & V_2 -> V_131 ) ;
if ( F_38 ( V_132 , & V_2 -> V_130 ) )
return;
F_39 ( V_128 ) ;
F_40 ( & V_2 -> V_131 , V_133 ) ;
}
...
V_2 = F_3 ( V_4 ) ;
if ( V_2 ) {
F_43 ( V_134 , V_2 -> V_135 ) ;
F_33 ( V_2 ) ;
}
}
static void F_44 ( struct V_136 * V_136 )
{
...
if ( V_2 -> V_92 )
return;
V_83 = F_45 ( V_2 -> V_136 , V_147 ) ;
if ( V_83 != 0 && V_83 != - V_120 && V_83 != - V_148 )
F_30 ( V_2 -> V_121 , L_16 , V_83 ) ;
}
static inline int
F_46 ( struct V_7 * V_4 , T_1 V_149 , T_1 V_150 )
{
if ( ( ( V_149 >> 11 ) & V_151 ) ==
V_152 ) {
...
{
struct V_1 * V_2 =
F_24 ( V_86 , struct V_1 , V_150 . V_154 ) ;
unsigned long V_155 ;
F_48 ( & V_2 -> V_150 . V_156 , V_155 ) ;
while ( ! F_49 ( & V_2 -> V_150 . V_157 ) ) {
struct V_158 * V_159 ;
struct V_160 * V_161 ;
struct V_7 * V_4 = V_2 -> V_4 ;
...
V_161 = F_50 ( V_159 , struct V_160 , V_157 ) ;
F_51 ( & V_161 -> V_157 ) ;
F_52 ( & V_2 -> V_150 . V_156 , V_155 ) ;
V_83 = F_46 ( V_4 , V_161 -> V_149 , V_161 -> V_150 ) ;
if ( V_83 && V_83 != - V_120 )
F_30 ( & V_4 -> V_22 ,
L_17 ,
...
int F_54 ( struct V_7 * V_4 , struct V_1 * V_2 ,
int V_72 , bool V_168 )
{
int V_57 ;
if ( V_168 )
...
unsigned long V_155 ;
struct V_160 * V_161 ;
V_161 = F_57 ( sizeof *V_161 , V_147 ) ;
if ( V_161 == NULL ) {
F_30 ( & V_11 -> V_22 , L_18 ) ;
return - V_173 ;
}
V_161 -> V_150 = V_150 -> V_174 ? V_11 -> V_175 : 1 ;
V_161 -> V_149 = F_58 ( V_171 ) ;
...
if ( F_60 ( V_171 ) )
V_161 -> V_149 |= 1 << 15 ;
V_161 -> V_164 = F_61 ( V_11 -> V_178 ) ;
V_161 -> V_167 = V_136 -> V_167 ;
F_48 ( & V_150 -> V_156 , V_155 ) ;
F_62 ( & V_161 -> V_157 , & V_150 -> V_157 ) ;
F_63 ( & V_150 -> V_154 ) ;
F_52 ( & V_150 -> V_156 , V_155 ) ;
return 0 ;
}
static void F_64 ( struct V_1 * V_2 , bool V_179 )
{
int V_72 ;
if ( F_65 ( V_2 ) )
F_22 ( V_2 -> V_121 , L_19 ) ;
...
if ( F_66 ( V_72 , V_2 -> V_170 ) )
F_19 ( V_2 -> V_4 , V_72 , V_169 ) ;
else
F_18 ( V_2 -> V_4 , V_72 ,
V_169 ) ;
if ( V_179 )
...
* V_83 = F_12 ( V_2 -> V_83 -> V_2 . V_180 ) ;
* V_114 = F_12 ( V_2 -> V_83 -> V_2 . V_181 ) ;
V_57 = 0 ;
}
F_31 ( & V_2 -> V_118 ) ;
return V_57 ;
...
if ( V_184 >= V_190 )
F_72 ( & V_2 -> V_82 [ V_72 - 1 ] -> V_22 ,
L_23 , V_184 ) ;
return F_70 ( V_2 , V_72 , V_187 ) ;
}
static int F_73 ( struct V_1 * V_2 , int V_72 , int V_191 )
{
struct V_80 * V_81 = V_2 -> V_82 [ V_72 - 1 ] ;
struct V_7 * V_4 = V_2 -> V_4 ;
int V_57 = 0 ;
if ( V_81 -> V_192 && V_191 )
F_74 ( V_81 -> V_192 , V_193 ) ;
if ( ! V_2 -> error ) {
if ( F_2 ( V_2 -> V_4 ) )
V_57 = F_71 ( V_2 , V_72 ) ;
else
...
static void F_75 ( struct V_1 * V_2 , int V_72 )
{
...
V_128 = F_35 ( V_2 -> V_121 ) ;
F_77 ( V_128 ) ;
F_43 ( V_11 -> V_134 , V_2 -> V_196 ) ;
F_75 ( V_2 , V_11 -> V_134 ) ;
F_78 ( V_128 ) ;
return 0 ;
}
static void F_79 ( struct V_1 * V_2 , enum V_197 type )
{
struct V_7 * V_4 = V_2 -> V_4 ;
struct V_198 * V_164 ;
int V_57 ;
...
V_204:
V_2 -> V_92 = 0 ;
V_83 = F_45 ( V_2 -> V_136 , V_214 ) ;
if ( V_83 < 0 )
F_30 ( V_2 -> V_121 , L_34 , V_83 ) ;
if ( V_2 -> V_232 && V_103 )
F_25 ( V_104 ,
& V_2 -> V_87 , V_105 ) ;
F_33 ( V_2 ) ;
...
{
struct V_1 * V_2 = F_24 ( V_233 , struct V_1 , V_210 . V_86 ) ;
F_79 ( V_2 , V_201 ) ;
}
...
static void F_85 ( struct V_1 * V_2 , enum V_234 type )
{
struct V_7 * V_4 = V_2 -> V_4 ;
int V_56 ;
F_86 ( & V_2 -> V_210 ) ;
...
unsigned V_249 ;
unsigned V_9 ;
V_2 -> V_145 = F_57 ( sizeof( * V_2 -> V_145 ) , V_250 ) ;
if ( ! V_2 -> V_145 ) {
V_57 = - V_173 ;
goto V_251;
}
V_2 -> V_83 = F_57 ( sizeof( * V_2 -> V_83 ) , V_250 ) ;
if ( ! V_2 -> V_83 ) {
V_57 = - V_173 ;
goto V_251;
}
F_95 ( & V_2 -> V_118 ) ;
V_2 -> V_36 = F_57 ( sizeof( * V_2 -> V_36 ) , V_250 ) ;
if ( ! V_2 -> V_36 ) {
V_57 = - V_173 ;
goto V_251;
}
...
F_7 ( V_242 , L_39 , V_9 ,
( V_9 == 1 ) ? L_40 : L_41 ) ;
V_2 -> V_82 = F_96 ( V_9 * sizeof( struct V_80 * ) , V_250 ) ;
if ( ! V_2 -> V_82 ) {
V_57 = - V_173 ;
goto V_251;
}
V_245 = F_12 ( V_2 -> V_36 -> V_245 ) ;
if ( F_2 ( V_4 ) ) {
V_248 = 150 ;
V_249 = 900 ;
} else {
...
F_97 ( & V_2 -> V_150 . V_156 ) ;
F_98 ( & V_2 -> V_150 . V_157 ) ;
F_99 ( & V_2 -> V_150 . V_154 , F_47 ) ;
...
if ( ( V_245 & V_262 ) == 0 )
F_22 ( V_242 , L_66 ,
( V_243 & V_291 ) ? L_40 : L_67 ) ;
V_171 = F_102 ( V_4 , V_240 -> V_292 ) ;
V_246 = F_103 ( V_4 , V_171 , F_104 ( V_171 ) ) ;
if ( V_246 > sizeof( * V_2 -> V_145 ) )
V_246 = sizeof( * V_2 -> V_145 ) ;
V_2 -> V_136 = F_105 ( 0 , V_250 ) ;
if ( ! V_2 -> V_136 ) {
V_57 = - V_173 ;
goto V_251;
}
F_106 ( V_2 -> V_136 , V_4 , V_171 , * V_2 -> V_145 , V_246 , F_44 ,
V_2 , V_240 -> V_293 ) ;
if ( V_2 -> V_232 && V_103 )
V_2 -> V_94 [ 0 ] = V_95 ;
F_29 ( & V_294 ) ;
...
{
struct V_1 * V_2 = F_24 ( V_131 , struct V_1 , V_131 ) ;
F_110 ( V_2 -> V_4 ) ;
F_111 ( F_35 ( V_2 -> V_121 ) ) ;
F_53 ( V_2 ) ;
}
...
static int F_120 ( struct V_127 * V_128 , const struct V_298 * V_299 )
{
struct V_300 * V_288 ;
struct V_239 * V_240 ;
struct V_7 * V_4 ;
...
const struct V_162 * V_163 = F_61 ( V_4 -> V_178 ) -> V_165 ;
...
goto V_309;
F_7 ( & V_128 -> V_22 , L_74 ) ;
V_2 = F_96 ( sizeof( * V_2 ) , V_250 ) ;
if ( ! V_2 ) {
F_22 ( & V_128 -> V_22 , L_75 ) ;
return - V_173 ;
}
F_125 ( & V_2 -> V_131 ) ;
...
static int
F_128 ( struct V_127 * V_128 , unsigned int V_316 , void * V_317 )
{
struct V_7 * V_4 = F_113 ( V_128 ) ;
struct V_1 * V_2 = F_3 ( V_4 ) ;
switch ( V_316 ) {
...
void F_132 ( struct V_7 * V_4 , struct V_323 * V_326 )
{
struct V_1 * V_2 = F_3 ( V_4 ) ;
int V_330 ;
...
if ( V_2 -> V_82 [ V_56 ] -> V_192 )
F_134 ( V_2 -> V_82 [ V_56 ] -> V_192 ) ;
}
if ( V_11 -> V_90 == V_331 )
V_11 -> V_332 -= V_333 ;
V_11 -> V_90 = V_193 ;
}
void F_74 ( struct V_7 * V_11 ,
enum V_334 V_335 )
{
unsigned long V_155 ;
int V_336 = - 1 ;
...
if ( V_11 -> V_341 ) {
V_176 = V_11 -> V_134 + 1 ;
F_137 ( F_66 ( V_176 , V_178 -> V_342 . V_343 ) ) ;
} else {
V_176 = F_138 ( V_178 -> V_342 . V_343 , 128 ,
V_178 -> V_344 ) ;
if ( V_176 >= 128 )
V_176 = F_138 ( V_178 -> V_342 . V_343 ,
128 , 1 ) ;
V_178 -> V_344 = ( V_176 >= 127 ? 1 : V_176 + 1 ) ;
}
if ( V_176 < 128 ) {
F_43 ( V_176 , V_178 -> V_342 . V_343 ) ;
V_11 -> V_176 = V_176 ;
}
F_31 ( & V_178 -> V_340 ) ;
}
...
{
if ( V_11 -> V_176 > 0 ) {
F_55 ( V_11 -> V_176 , V_11 -> V_178 -> V_342 . V_343 ) ;
V_11 -> V_176 = - 1 ;
}
}
...
{
struct V_198 * V_164 = F_61 ( V_11 -> V_178 ) ;
...
F_146 ( & V_11 -> V_22 . V_347 , L_78 ) ;
F_146 ( & V_81 -> V_22 . V_347 , L_79 ) ;
if ( ! F_147 ( V_72 , V_2 -> V_348 ) )
F_148 ( & V_81 -> V_22 ) ;
}
F_149 ( & V_11 -> V_349 ) ;
F_150 ( V_11 ) ;
...
* V_346 = NULL ;
F_116 ( & V_296 ) ;
if ( V_81 && F_152 ( V_72 , V_2 -> V_348 ) )
F_108 ( & V_81 -> V_22 ) ;
F_141 ( V_11 ) ;
F_153 ( & V_11 -> V_22 ) ;
}
static void F_154 ( struct V_7 * V_11 , char * V_299 , char * string )
{
if ( ! string )
return;
F_7 ( & V_11 -> V_22 , L_80 , V_299 , string ) ;
}
static void F_155 ( struct V_7 * V_11 )
{
F_7 ( & V_11 -> V_22 , L_81 ,
F_12 ( V_11 -> V_36 . V_350 ) ,
F_12 ( V_11 -> V_36 . V_351 ) ) ;
F_7 ( & V_11 -> V_22 ,
L_82 ,
V_11 -> V_36 . V_352 ,
V_11 -> V_36 . V_353 ,
V_11 -> V_36 . V_354 ) ;
F_154 ( V_11 , L_83 , V_11 -> V_355 ) ;
F_154 ( V_11 , L_84 , V_11 -> V_356 ) ;
F_154 ( V_11 , L_85 , V_11 -> V_357 ) ;
}
...
V_358 = F_158 ( V_11 -> V_362 [ 0 ] ,
F_12 ( V_11 -> V_360 [ 0 ] . V_288 . V_363 ) ,
V_364 , ( void * * ) & V_288 ) ;
if ( V_358 || ! ( V_288 -> V_20 & V_365 ) )
return 0 ;
F_7 ( & V_11 -> V_22 , L_86 ,
( V_72 == V_178 -> V_366 ) ? L_40 : L_87 ) ;
if ( V_72 == V_178 -> V_366 ) {
V_178 -> V_367 = 1 ;
V_358 = F_14 ( V_11 ,
F_17 ( V_11 , 0 ) ,
...
V_11 -> V_355 = F_161 ( V_11 , V_11 -> V_36 . V_353 ) ;
V_11 -> V_356 = F_161 ( V_11 ,
V_11 -> V_36 . V_352 ) ;
V_11 -> V_357 = F_161 ( V_11 , V_11 -> V_36 . V_354 ) ;
V_358 = F_156 ( V_11 ) ;
if ( V_358 < 0 )
return V_358 ;
if ( F_162 ( V_371 ) && V_164 -> V_372 &&
! F_163 ( V_11 ) ) {
if ( F_162 ( F_157 ) && ( V_11 -> V_178 -> V_367
|| V_11 -> V_178 -> V_359 ) ) {
V_358 = F_164 ( V_11 , V_373 ) ;
if ( V_358 < 0 )
F_22 ( & V_11 -> V_22 , L_91 , V_358 ) ;
}
return - V_374 ;
}
F_165 ( V_11 ) ;
...
return;
if ( F_2 ( V_4 ) ) {
if ( F_12 ( V_2 -> V_36 -> V_37 . V_38 . V_257 )
& ( 1 << V_119 ) )
V_375 = false ;
} else {
...
V_11 -> V_22 . V_383 = F_174 ( V_384 ,
( ( ( V_11 -> V_178 -> V_382 - 1 ) * 128 ) + ( V_11 -> V_176 - 1 ) ) ) ;
F_155 ( V_11 ) ;
if ( V_11 -> V_357 )
F_175 ( V_11 -> V_357 , strlen ( V_11 -> V_357 ) ) ;
if ( V_11 -> V_355 )
F_175 ( V_11 -> V_355 , strlen ( V_11 -> V_355 ) ) ;
if ( V_11 -> V_356 )
F_175 ( V_11 -> V_356 ,
strlen ( V_11 -> V_356 ) ) ;
F_176 ( & V_11 -> V_22 ) ;
if ( V_11 -> V_25 )
F_166 ( V_11 ) ;
V_358 = F_177 ( & V_11 -> V_22 ) ;
if ( V_358 ) {
F_30 ( & V_11 -> V_22 , L_93 , V_358 ) ;
goto V_251;
}
if ( V_11 -> V_25 ) {
...
int V_72 = V_11 -> V_134 ;
struct V_80 * V_81 = V_2 -> V_82 [ V_72 - 1 ] ;
V_358 = F_178 ( & V_11 -> V_22 . V_347 ,
& V_81 -> V_22 . V_347 , L_78 ) ;
if ( V_358 )
goto V_251;
V_358 = F_178 ( & V_81 -> V_22 . V_347 ,
...
( void ) F_179 ( & V_11 -> V_22 , & V_11 -> V_349 , V_11 ) ;
F_180 ( V_11 ) ;
F_181 ( & V_11 -> V_22 ) ;
return V_358 ;
V_251:
...
if ( V_385 -> V_341 ) {
V_388 = F_188 ( V_385 , sizeof( V_385 -> V_36 ) ) ;
if ( V_388 < 0 ) {
F_30 ( & V_385 -> V_22 , L_95
L_96 , V_388 ) ;
goto V_392;
}
}
...
static int F_191 ( struct V_7 * V_4 , int V_393 )
{
int V_394 ;
T_2 V_395 ;
int V_56 ;
...
if ( ! V_397 )
return 0 ;
V_394 = F_6 ( V_397 -> V_20 ) &
V_398 ;
for ( V_56 = 0 ; V_56 <= V_394 ; V_56 ++ ) {
V_395 = F_6 ( V_397 -> V_399 [ V_56 ] ) ;
...
return 0 ;
V_164 = F_61 ( V_2 -> V_4 -> V_178 ) ;
return V_164 -> V_402 ;
}
static bool F_193 ( struct V_7 * V_11 , int V_403 )
{
if ( V_11 -> V_14 >= V_52 )
return false ;
return F_194 ( V_403 ) ;
...
if ( ! F_2 ( V_2 -> V_4 ) ) {
if ( V_408 ) {
F_30 ( V_2 -> V_121 , L_101
L_102 ) ;
return - V_69 ;
}
F_199 ( & V_421 ) ;
} else if ( ! V_408 ) {
if ( F_32 ( V_2 , V_72 , & V_3 , & V_185 ) == 0 )
if ( F_195 ( V_2 , V_72 ,
V_3 ) )
V_408 = true ;
}
...
F_30 ( & V_81 -> V_22 ,
L_103 ,
V_408 ? L_100 : L_40 , V_83 ) ;
} else {
V_83 = F_196 ( V_2 , V_72 , V_11 , V_200 ,
V_408 ) ;
...
int F_164 ( struct V_7 * V_11 , T_4 V_442 )
{
struct V_1 * V_2 = F_3 ( V_11 -> V_25 ) ;
...
break;
default:
F_72 ( & V_11 -> V_22 , L_137 ,
V_122 ) ;
return - V_69 ;
}
if ( V_90 == V_475 && V_484 > V_487 &&
V_484 != V_488 ) {
F_72 ( & V_11 -> V_22 , L_138
L_139 ,
V_479 [ V_90 ] , V_484 ) ;
return - V_69 ;
}
...
{
struct V_7 * V_4 = V_2 -> V_4 ;
struct V_198 * V_164 = F_61 ( V_4 -> V_178 ) ;
...
if ( V_514 == V_420 )
V_200 = V_415 ;
F_29 ( & V_4 -> V_178 -> V_340 ) ;
V_504 = F_198 ( V_2 , V_72 , V_11 , V_200 , false ) ;
if ( V_504 < 0 )
goto V_251;
V_504 = - V_120 ;
if ( V_514 != V_516 && V_514 != V_11 -> V_14 &&
...
case V_52 :
case V_417 :
V_11 -> V_349 . V_288 . V_517 = F_233 ( 512 ) ;
break;
case V_15 :
V_11 -> V_349 . V_288 . V_517 = F_233 ( 64 ) ;
break;
case V_16 :
V_11 -> V_349 . V_288 . V_517 = F_233 ( 64 ) ;
break;
case V_420 :
V_11 -> V_349 . V_288 . V_517 = F_233 ( 8 ) ;
break;
default:
goto V_251;
}
...
V_176 , V_11 -> V_178 -> V_518 -> V_165 -> V_519 ) ;
if ( V_4 -> V_150 ) {
...
for ( V_433 = 0 ; V_433 < V_520 ; ( ++ V_433 , F_67 ( 100 ) ) ) {
bool V_521 = false ;
if ( F_193 ( V_11 , V_511 ) ) {
struct V_522 * V_523 ;
int V_524 = 0 ;
...
if ( V_524 == 0 || ( V_524 == - V_107 && V_433 == 0 ) )
break;
}
V_11 -> V_36 . V_525 =
V_523 -> V_525 ;
...
goto V_251;
if ( ( V_11 -> V_14 >= V_52 ) &&
( F_12 ( V_11 -> V_36 . V_532 ) < 0x0300 ) ) {
F_30 ( & V_11 -> V_22 , L_161
L_162 ) ;
F_198 ( V_2 , V_72 , V_11 ,
V_533 , true ) ;
V_504 = - V_69 ;
...
if ( V_11 -> V_36 . V_525 == 0xff ||
V_11 -> V_14 >= V_52 )
V_56 = 512 ;
else
V_56 = V_11 -> V_36 . V_525 ;
if ( F_254 ( & V_11 -> V_349 . V_288 ) != V_56 ) {
if ( V_11 -> V_14 == V_420 ||
! ( V_56 == 8 || V_56 == 16 || V_56 == 32 || V_56 == 64 ) ) {
F_30 ( & V_11 -> V_22 , L_163 , V_56 ) ;
V_504 = - V_530 ;
goto V_251;
}
if ( V_11 -> V_14 == V_16 )
F_22 ( & V_11 -> V_22 , L_164 , V_56 ) ;
else
F_72 ( & V_11 -> V_22 , L_165 , V_56 ) ;
V_11 -> V_349 . V_288 . V_517 = F_233 ( V_56 ) ;
F_242 ( V_11 ) ;
}
V_504 = F_188 ( V_11 , V_534 ) ;
if ( V_504 < ( signed ) sizeof( V_11 -> V_36 ) ) {
if ( V_504 != - V_120 )
F_30 ( & V_11 -> V_22 , L_166 ,
V_504 ) ;
if ( V_504 >= 0 )
V_504 = - V_535 ;
goto V_251;
...
F_255 ( V_11 ) ;
if ( V_11 -> V_341 == 0 && F_12 ( V_11 -> V_36 . V_532 ) >= 0x0201 ) {
V_504 = F_256 ( V_11 ) ;
if ( ! V_504 ) {
V_11 -> V_26 = F_5 ( V_11 ) ;
F_11 ( V_11 ) ;
...
if ( V_11 -> V_12 & V_539 )
return;
V_538 = F_57 ( sizeof *V_538 , V_250 ) ;
if ( V_538 == NULL )
return;
V_83 = F_258 ( V_11 , V_540 , 0 ,
V_538 , sizeof *V_538 ) ;
if ( V_83 == sizeof *V_538 ) {
F_7 ( & V_11 -> V_22 , L_167
L_168 ) ;
if ( V_2 -> V_232 ) {
...
V_248 = 100 ;
if ( V_11 -> V_8 )
V_541 = F_260 ( V_11 , V_11 -> V_8 ) ;
else if ( V_72 != V_11 -> V_178 -> V_366 || V_4 -> V_25 )
V_541 = V_248 ;
else
V_541 = 8 ;
if ( V_541 > V_2 -> V_283 )
F_72 ( & V_81 -> V_22 , L_169 ,
V_541 , V_2 -> V_283 ) ;
V_286 -= V_541 ;
}
if ( V_286 < 0 ) {
F_72 ( V_2 -> V_121 , L_170 ,
- V_286 ) ;
V_286 = 0 ;
}
return V_286 ;
...
static int V_542 = - 1 ;
if ( V_11 ) {
if ( V_164 -> V_543 && ! V_4 -> V_25 )
F_262 ( V_164 -> V_543 , V_11 -> V_14 ) ;
F_87 ( & V_81 -> V_192 ) ;
}
if ( ! ( V_3 & V_215 ) ||
( V_185 & V_217 ) )
...
&& V_11 -> V_282 <= V_248 ) {
T_1 V_550 ;
V_83 = F_101 ( V_11 , V_279 , 0 ,
& V_550 ) ;
if ( V_83 ) {
F_22 ( & V_11 -> V_22 , L_173 , V_83 ) ;
goto V_551;
}
if ( ( V_550 & ( 1 << V_285 ) ) == 0 ) {
F_30 ( & V_11 -> V_22 ,
...
if ( F_12 ( V_11 -> V_36 . V_532 ) >= 0x0200
&& V_11 -> V_14 == V_16
&& V_297 != 0 )
F_257 ( V_2 , V_11 , V_72 ) ;
V_83 = 0 ;
...
V_425:
F_73 ( V_2 , V_72 , 1 ) ;
if ( V_164 -> V_165 -> V_553 && ! V_2 -> V_4 -> V_25 )
...
T_1 V_244 ;
int V_56 , V_57 ;
V_2 = F_24 ( V_86 , struct V_1 , V_130 ) ;
V_4 = V_2 -> V_4 ;
V_242 = V_2 -> V_121 ;
V_128 = F_35 ( V_242 ) ;
F_22 ( V_242 , L_178 ,
...
V_57 = F_77 ( V_128 ) ;
if ( V_57 ) {
F_22 ( V_242 , L_179 , V_57 ) ;
goto V_554;
}
if ( V_2 -> V_92 )
goto V_555;
if ( V_2 -> error ) {
F_22 ( V_242 , L_180 , V_2 -> error ) ;
V_57 = F_270 ( V_4 ) ;
if ( V_57 ) {
F_22 ( V_242 , L_181 , V_57 ) ;
goto V_555;
}
V_2 -> V_142 = 0 ;
V_2 -> error = 0 ;
...
;
else if ( F_69 ( V_2 , & V_243 , & V_244 ) < 0 )
F_30 ( V_242 , L_182 ) ;
else {
if ( V_244 & V_556 ) {
F_22 ( V_242 , L_183 ) ;
...
return 1 ;
if ( V_11 -> V_17 ) {
V_116 = F_12 ( V_11 -> V_17 -> V_288 -> V_363 ) ;
if ( V_116 != F_12 ( V_567 -> V_288 -> V_363 ) )
return 1 ;
if ( memcmp ( V_11 -> V_17 -> V_288 , V_567 -> V_288 , V_116 ) )
return 1 ;
}
if ( V_11 -> V_357 )
V_569 = strlen ( V_11 -> V_357 ) + 1 ;
V_116 = V_569 ;
for ( V_568 = 0 ; V_568 < V_11 -> V_36 . V_571 ; V_568 ++ ) {
V_570 = F_12 ( V_11 -> V_360 [ V_568 ] . V_288 . V_363 ) ;
V_116 = F_281 ( V_116 , V_570 ) ;
}
V_523 = F_57 ( V_116 , V_214 ) ;
if ( V_523 == NULL ) {
F_30 ( & V_11 -> V_22 , L_189 ) ;
return 1 ;
}
for ( V_568 = 0 ; V_568 < V_11 -> V_36 . V_571 ; V_568 ++ ) {
V_570 = F_12 ( V_11 -> V_360 [ V_568 ] . V_288 . V_363 ) ;
V_113 = F_258 ( V_11 , V_572 , V_568 , V_523 ,
V_570 ) ;
if ( V_113 != V_570 ) {
...
if ( memcmp ( V_523 , V_11 -> V_362 [ V_568 ] , V_570 )
!= 0 ) {
...
V_113 ) ;
V_88 = 1 ;
} else if ( memcmp ( V_523 , V_11 -> V_357 , V_113 ) != 0 ) {
...
struct V_1 * V_576 ;
struct V_198 * V_164 = F_61 ( V_11 -> V_178 ) ;
struct V_522 V_36 = V_11 -> V_36 ;
struct V_566 * V_17 ;
int V_56 , V_577 , V_57 = 0 ;
int V_72 = V_11 -> V_134 ;
if ( V_11 -> V_90 == V_193 ||
V_11 -> V_90 == V_331 ) {
F_22 ( & V_11 -> V_22 , L_194 ,
V_11 -> V_90 ) ;
return - V_69 ;
}
if ( ! V_575 )
...
V_57 = F_215 ( V_11 ) ;
if ( V_57 ) {
F_30 ( & V_11 -> V_22 , L_195 , V_122 ) ;
goto V_579;
}
V_57 = F_207 ( V_11 ) ;
if ( V_57 ) {
F_30 ( & V_11 -> V_22 , L_196 ,
V_122 ) ;
goto V_579;
}
V_17 = V_11 -> V_17 ;
...
for ( V_56 = 0 ; V_56 < V_544 ; ++ V_56 ) {
F_242 ( V_11 ) ;
V_57 = F_250 ( V_576 , V_11 , V_72 , V_56 ) ;
...
V_57 = F_14 ( V_11 , F_17 ( V_11 , 0 ) ,
V_581 , 0 ,
V_11 -> V_8 -> V_288 . V_574 , 0 ,
NULL , 0 , V_208 ) ;
if ( V_57 < 0 ) {
F_30 ( & V_11 -> V_22 ,
L_200 ,
V_11 -> V_8 -> V_288 . V_574 , V_57 ) ;
F_31 ( V_164 -> V_497 ) ;
goto V_580;
}
F_31 ( V_164 -> V_497 ) ;
F_74 ( V_11 , V_91 ) ;
for ( V_56 = 0 ; V_56 < V_11 -> V_8 -> V_288 . V_582 ; V_56 ++ ) {
struct V_583 * V_360 = V_11 -> V_8 ;
...
V_128 -> V_586 = 1 ;
V_57 = F_100 ( V_11 , V_288 -> V_587 ,
V_288 -> V_585 ) ;
V_128 -> V_586 = 0 ;
}
if ( V_57 < 0 ) {
F_30 ( & V_11 -> V_22 , L_201
L_202 ,
V_288 -> V_587 ,
V_288 -> V_585 ,
V_57 ) ;
...
for ( V_577 = 0 ; V_577 < V_128 -> V_301 -> V_288 . V_310 ; V_577 ++ )
V_128 -> V_301 -> V_240 [ V_577 ] . V_588 = 0 ;
}
V_425:
F_214 ( V_11 , 1 ) ;
F_216 ( V_11 ) ;
...
F_187 ( V_11 ) ;
if ( V_360 ) {
for ( V_56 = 0 ; V_56 < V_360 -> V_288 . V_582 ; ++ V_56 ) {
struct V_127 * V_590 = V_360 -> V_10 [ V_56 ] ;
struct V_591 * V_163 ;
int V_592 = 0 ;
if ( V_590 -> V_22 . V_165 ) {
V_163 = F_288 ( V_590 -> V_22 . V_165 ) ;
if ( V_163 -> V_593 && V_163 -> V_594 )
V_592 = ( V_163 -> V_593 ) ( V_590 ) ;
else if ( V_590 -> V_595 ==
V_596 )
V_592 = 1 ;
if ( V_592 )
...
F_203 ( V_81 ) ;
if ( V_360 ) {
for ( V_56 = V_360 -> V_288 . V_582 - 1 ; V_56 >= 0 ; -- V_56 ) {
struct V_127 * V_590 = V_360 -> V_10 [ V_56 ] ;
struct V_591 * V_163 ;
int V_597 = V_590 -> V_598 ;
if ( ! V_597 && V_590 -> V_22 . V_165 ) {
V_163 = F_288 ( V_590 -> V_22 . V_165 ) ;
if ( V_163 -> V_594 )
V_597 = ( V_163 -> V_594 ) ( V_590 ) ;
else if ( V_590 -> V_595 ==
V_596 )
V_597 = 1 ;
if ( V_597 )
...
if ( V_376 == V_379 ) {
T_3 V_602 = 1 << ( V_56 % 8 ) ;
if ( ! ( V_288 -> V_37 . V_256 . V_257 [ V_56 / 8 ] & V_602 ) ) {
F_22 ( & V_81 -> V_22 , L_204 ) ;
V_288 -> V_37 . V_256 . V_257 [ V_56 / 8 ] |= V_602 ;
}
}
}
} else {
T_1 V_603 = F_12 ( V_288 -> V_37 . V_38 . V_257 ) ;
for ( V_56 = 1 ; V_56 <= V_4 -> V_9 ; V_56 ++ ) {
struct V_80 * V_81 = V_2 -> V_82 [ V_56 - 1 ] ;
V_376 = V_81 -> V_376 ;
if ( V_376 == V_379 ) {
...
V_288 -> V_37 . V_38 . V_257 = F_233 ( V_603 ) ;
}
}
