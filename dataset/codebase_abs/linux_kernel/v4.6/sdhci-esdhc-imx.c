...
F_57 ( F_24 ( V_10 -> V_111 ) , L_15 ) ;
return - V_145 ;
}
V_19 -> V_86 = * ( (struct V_119 * )
V_10 -> V_111 -> V_189 -> V_190 ) ;
if ( V_86 -> V_120 == V_121 ) {
V_188 = F_58 ( V_10 -> V_111 , V_86 -> V_178 ) ;
if ( V_188 ) {
F_57 ( F_24 ( V_10 -> V_111 ) ,
L_16 ) ;
return V_188 ;
}
...
switch ( V_86 -> V_193 ) {
case V_194 :
V_188 = F_59 ( V_10 -> V_111 , V_86 -> V_195 , 0 ) ;
if ( V_188 ) {
F_57 ( F_24 ( V_10 -> V_111 ) ,
L_17 ) ;
return V_188 ;
...
F_61 ( V_207 , & V_173 -> V_176 ) ;
struct V_17 * V_18 ;
struct V_9 * V_10 ;
int V_188 ;
struct V_1 * V_19 ;
V_10 = F_62 ( V_173 , & V_208 ,
sizeof( * V_19 ) ) ;
if ( F_34 ( V_10 ) )
return F_63 ( V_10 ) ;
V_18 = F_9 ( V_10 ) ;
...
V_173 -> V_210 -> V_211 ;
V_19 -> V_212 = F_64 ( & V_173 -> V_176 , L_18 ) ;
if ( F_34 ( V_19 -> V_212 ) ) {
V_188 = F_63 ( V_19 -> V_212 ) ;
goto V_213;
}
V_19 -> V_214 = F_64 ( & V_173 -> V_176 , L_19 ) ;
if ( F_34 ( V_19 -> V_214 ) ) {
V_188 = F_63 ( V_19 -> V_214 ) ;
goto V_213;
}
V_19 -> V_215 = F_64 ( & V_173 -> V_176 , L_20 ) ;
if ( F_34 ( V_19 -> V_215 ) ) {
V_188 = F_63 ( V_19 -> V_215 ) ;
goto V_213;
}
V_18 -> V_216 = V_19 -> V_215 ;
V_18 -> clock = F_65 ( V_18 -> V_216 ) ;
F_66 ( V_19 -> V_215 ) ;
F_66 ( V_19 -> V_212 ) ;
F_66 ( V_19 -> V_214 ) ;
V_19 -> V_141 = F_67 ( & V_173 -> V_176 ) ;
if ( F_34 ( V_19 -> V_141 ) ) {
V_188 = F_63 ( V_19 -> V_141 ) ;
goto V_217;
}
...
static int F_83 ( struct V_234 * V_176 )
{
...
static int F_87 ( struct V_234 * V_176 )
{
struct V_9 * V_10 = F_84 ( V_176 ) ;
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = F_10 ( V_18 ) ;
