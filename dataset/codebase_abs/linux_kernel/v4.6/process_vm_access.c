...
static T_2 F_10 ( T_3 V_27 , struct V_5 * V_6 ,
...
struct V_5 V_6 ;
T_2 V_22 ;
int V_54 = V_7 ? V_55 : V_56 ;
if ( V_31 != 0 )
return - V_57 ;
V_22 = F_24 ( V_54 , V_47 , V_48 , V_50 , & V_52 , & V_6 ) ;
if ( V_22 < 0 )
return V_22 ;
if ( ! F_2 ( & V_6 ) )
goto V_58;
V_22 = F_25 ( V_59 , V_29 , V_30 , V_50 ,
V_51 , & V_53 ) ;
if ( V_22 <= 0 )
goto V_58;
V_22 = F_10 ( V_27 , & V_6 , V_53 , V_30 , V_31 , V_7 ) ;
V_58:
if ( V_53 != V_51 )
F_22 ( V_53 ) ;
F_22 ( V_52 ) ;
...
static T_2
F_26 ( T_5 V_27 ,
const struct V_60 T_4 * V_47 ,
unsigned long V_48 ,
const struct V_60 T_4 * V_29 ,
unsigned long V_30 ,
unsigned long V_31 , int V_7 )
{
struct V_28 V_49 [ V_50 ] ;
...
if ( V_31 != 0 )
return - V_57 ;
V_22 = F_27 ( V_54 , V_47 , V_48 , V_50 , & V_52 , & V_6 ) ;
if ( V_22 < 0 )
return V_22 ;
if ( ! F_2 ( & V_6 ) )
goto V_58;
V_22 = F_28 ( V_59 , V_29 , V_30 ,
V_50 , V_51 ,
& V_53 ) ;
if ( V_22 <= 0 )
goto V_58;
