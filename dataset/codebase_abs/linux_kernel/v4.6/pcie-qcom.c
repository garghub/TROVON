...
T_3 V_9 = F_34 ( V_2 -> V_54 + V_55 + V_56 ) ;
return ! ! ( V_9 & V_57 ) ;
}
...
{
if ( V_64 == V_66 && V_65 == 4 ) {
* V_9 = F_9 ( V_8 -> V_67 + V_66 ) ;
* V_9 &= 0xff ;
* V_9 |= V_68 << 16 ;
return V_69 ;
}
return F_41 ( V_8 -> V_67 + V_64 , V_65 , V_9 ) ;
}
...
struct V_7 * V_8 ;
int V_36 ;
V_2 = F_43 ( V_17 , sizeof( * V_2 ) , V_73 ) ;
if ( ! V_2 )
return - V_74 ;
V_2 -> V_58 = (struct V_75 * ) F_44 ( V_17 ) ;
V_2 -> V_17 = V_17 ;
V_2 -> V_3 = F_45 ( V_17 , L_30 , V_76 ) ;
if ( F_14 ( V_2 -> V_3 ) )
return F_15 ( V_2 -> V_3 ) ;
V_14 = F_46 ( V_71 , V_77 , L_31 ) ;
V_2 -> V_43 = F_47 ( V_17 , V_14 ) ;
if ( F_14 ( V_2 -> V_43 ) )
return F_15 ( V_2 -> V_43 ) ;
V_14 = F_46 ( V_71 , V_77 , L_32 ) ;
V_2 -> V_54 = F_47 ( V_17 , V_14 ) ;
if ( F_14 ( V_2 -> V_54 ) )
return F_15 ( V_2 -> V_54 ) ;
V_14 = F_46 ( V_71 , V_77 , L_33 ) ;
...
V_8 -> V_58 = & V_80 ;
if ( F_31 ( V_52 ) ) {
V_8 -> V_81 = F_49 ( V_71 , L_35 ) ;
if ( V_8 -> V_81 < 0 )
return V_8 -> V_81 ;
V_36 = F_50 ( V_17 , V_8 -> V_81 ,
F_5 ,
V_82 , L_36 , V_8 ) ;
if ( V_36 ) {
F_25 ( V_17 , L_37 ) ;
