...
F_25 ( ( V_99 % V_100 ) != 0 ) ;
V_97 = V_88 -> V_97 * ( V_99 / V_100 ) ;
V_96 = F_26 ( V_6 , V_93 , V_94 , V_97 , V_54 -> V_101 ) ;
if ( F_27 ( V_96 ) )
return F_28 ( V_96 ) ;
V_11 = F_29 ( V_54 , & V_96 -> V_102 ,
V_91 , V_92 , V_88 ) ;
F_30 ( & V_96 ) ;
return V_11 ;
}
...
V_58 . V_59 = 0 ;
V_58 . V_60 = 0 ;
V_58 . V_26 = V_32 | V_105 ;
V_11 = F_32 ( V_54 , & V_56 , & V_104 ,
V_103 , V_92 ) ;
if ( F_33 ( V_11 ) ) {
return V_11 ;
}
V_11 = F_34 ( V_54 -> V_83 , V_104 . V_56 ) ;
if ( F_33 ( V_11 ) ) {
goto V_106;
}
V_11 = F_35 ( V_54 -> V_83 , & V_104 ) ;
if ( F_33 ( V_11 ) ) {
goto V_106;
}
V_11 = F_24 ( V_54 , true , V_92 , & V_104 , V_89 ) ;
if ( F_33 ( V_11 ) ) {
goto V_106;
}
V_11 = F_36 ( V_54 , true , V_92 , V_88 ) ;
V_106:
F_37 ( V_54 , & V_104 ) ;
return V_11 ;
}
...
V_11 = F_36 ( V_54 , true , V_92 , & V_104 ) ;
if ( F_33 ( V_11 ) ) {
goto V_106;
}
...
V_6 -> V_108 -> V_109 . V_109 == NULL ) {
goto memcpy;
}
if ( V_89 -> V_69 == V_50 &&
V_88 -> V_69 == V_29 ) {
V_11 = F_31 ( V_54 , V_91 , V_103 ,
V_92 , V_88 ) ;
} else if ( V_89 -> V_69 == V_29 &&
V_88 -> V_69 == V_50 ) {
V_11 = F_38 ( V_54 , V_91 , V_103 ,
V_92 , V_88 ) ;
} else {
...
if ( V_11 ) {
memcpy:
V_11 = F_41 ( V_54 , V_91 , V_92 , V_88 ) ;
if ( V_11 ) {
return V_11 ;
}
}
F_42 ( ( V_110 ) V_54 -> V_97 << V_76 , & V_6 -> V_111 ) ;
return 0 ;
}
static int F_43 ( struct V_2 * V_3 , struct V_87 * V_68 )
{
...
V_68 -> V_112 . V_102 = V_6 -> V_39 . V_116 ;
...
return - V_46 ;
V_68 -> V_112 . V_102 = V_6 -> V_39 . V_117 ;
V_68 -> V_112 . V_115 = true ;
#ifdef F_44
if ( V_68 -> V_56 & V_49 )
V_68 -> V_112 . V_113 =
F_45 ( V_68 -> V_112 . V_102 + V_68 -> V_112 . V_114 ,
V_68 -> V_112 . V_16 ) ;
else
V_68 -> V_112 . V_113 =
F_46 ( V_68 -> V_112 . V_102 + V_68 -> V_112 . V_114 ,
V_68 -> V_112 . V_16 ) ;
V_68 -> V_112 . V_102 = ( V_68 -> V_112 . V_102 & 0x0ffffffffUL ) +
...
static void F_47 ( struct V_2 * V_3 , struct V_87 * V_68 )
{
}
static int F_48 ( struct V_120 * V_83 )
{
...
unsigned long V_136 = V_122 -> V_137 + V_83 -> V_97 * V_99 ;
struct V_138 * V_139 ;
V_139 = F_49 ( V_122 -> V_134 , V_122 -> V_137 ) ;
if ( ! V_139 || V_139 -> V_140 || V_139 -> V_141 < V_136 )
return - V_84 ;
}
do {
unsigned V_97 = V_83 -> V_97 - V_123 ;
T_2 V_137 = V_122 -> V_137 + V_123 * V_99 ;
struct V_142 * * V_143 = V_83 -> V_143 + V_123 ;
V_11 = F_50 ( V_137 , V_97 , V_125 , 0 , V_143 , NULL ) ;
if ( V_11 < 0 )
goto V_144;
V_123 += V_11 ;
} while ( V_123 < V_83 -> V_97 );
V_11 = F_51 ( V_83 -> V_145 , V_83 -> V_143 , V_83 -> V_97 , 0 ,
V_83 -> V_97 << V_76 ,
V_146 ) ;
if ( V_11 )
goto V_147;
V_11 = - V_148 ;
V_124 = F_52 ( V_6 -> V_149 , V_83 -> V_145 -> V_150 , V_83 -> V_145 -> V_124 , V_129 ) ;
if ( V_124 != V_83 -> V_145 -> V_124 )
goto V_147;
F_53 ( V_83 -> V_145 , V_83 -> V_143 ,
...
static void F_55 ( struct V_120 * V_83 )
{
struct V_1 * V_6 = F_1 ( V_83 -> V_3 ) ;
struct V_121 * V_122 = ( void * ) V_83 ;
struct V_152 V_153 ;
...
if ( ! V_83 -> V_145 -> V_150 )
return;
F_56 ( V_6 -> V_149 , V_83 -> V_145 -> V_150 , V_83 -> V_145 -> V_124 , V_129 ) ;
F_57 (ttm->sg->sgl, &sg_iter, ttm->sg->nents, 0 ) {
struct V_142 * V_142 = F_58 ( & V_153 ) ;
...
static int F_63 ( struct V_120 * V_83 ,
struct V_87 * V_154 )
{
struct V_121 * V_122 = ( void * ) V_83 ;
...
if ( V_83 -> V_158 == V_159 )
V_26 |= V_160 ;
V_11 = F_65 ( V_122 -> V_6 , V_122 -> V_114 , V_83 -> V_97 ,
...
static int F_66 ( struct V_120 * V_83 )
{
struct V_121 * V_122 = ( void * ) V_83 ;
F_67 ( V_122 -> V_6 , V_122 -> V_114 , V_83 -> V_97 ) ;
if ( V_122 -> V_137 )
F_55 ( V_83 ) ;
return 0 ;
}
static void F_68 ( struct V_120 * V_83 )
{
struct V_121 * V_122 = ( void * ) V_83 ;
F_69 ( & V_122 -> V_83 ) ;
F_54 ( V_122 ) ;
}
static struct V_120 * F_70 ( struct V_2 * V_3 ,
...
#if F_14 ( V_42 )
if ( V_6 -> V_26 & V_43 ) {
return F_71 ( V_3 , V_6 -> V_44 -> V_45 -> V_163 ,
V_16 , V_161 , V_162 ) ;
}
#endif
V_122 = F_72 ( sizeof( struct V_121 ) , V_146 ) ;
if ( V_122 == NULL ) {
return NULL ;
}
V_122 -> V_83 . V_83 . V_36 = & V_164 ;
V_122 -> V_6 = V_6 ;
if ( F_73 ( & V_122 -> V_83 , V_3 , V_16 , V_161 , V_162 ) ) {
F_54 ( V_122 ) ;
return NULL ;
}
return & V_122 -> V_83 . V_83 ;
}
static struct V_121 * F_74 ( struct V_120 * V_83 )
{
if ( ! V_83 || V_83 -> V_36 != & V_164 )
return NULL ;
return (struct V_121 * ) V_83 ;
}
static int F_75 ( struct V_120 * V_83 )
{
struct V_121 * V_122 = F_74 ( V_83 ) ;
struct V_1 * V_6 ;
unsigned V_77 ;
int V_11 ;
...
V_83 -> V_145 = F_72 ( sizeof( struct V_169 ) , V_146 ) ;
if ( ! V_83 -> V_145 )
return - V_148 ;
V_83 -> V_161 |= V_166 ;
V_83 -> V_167 = V_170 ;
...
#ifdef F_77
if ( F_78 () ) {
return F_79 ( & V_122 -> V_83 , V_6 -> V_149 ) ;
}
#endif
V_11 = F_80 ( V_83 ) ;
if ( V_11 ) {
...
V_122 -> V_83 . V_151 [ V_77 ] = F_81 ( V_6 -> V_171 , V_83 -> V_143 [ V_77 ] ,
0 , V_99 ,
V_172 ) ;
if ( F_82 ( V_6 -> V_171 , V_122 -> V_83 . V_151 [ V_77 ] ) ) {
while ( V_77 -- ) {
F_83 ( V_6 -> V_171 , V_122 -> V_83 . V_151 [ V_77 ] ,
V_99 , V_172 ) ;
...
static void F_85 ( struct V_120 * V_83 )
{
struct V_1 * V_6 ;
struct V_121 * V_122 = F_74 ( V_83 ) ;
unsigned V_77 ;
...
int F_88 ( struct V_120 * V_83 , T_2 V_113 ,
T_1 V_26 )
{
struct V_121 * V_122 = F_74 ( V_83 ) ;
if ( V_122 == NULL )
...
V_6 -> V_5 . V_179 = true ;
V_11 = F_92 ( & V_6 -> V_5 . V_3 , V_50 ,
V_6 -> V_39 . V_74 >> V_76 ) ;
if ( V_11 ) {
F_9 ( L_11 ) ;
return V_11 ;
}
F_93 ( V_6 , V_6 -> V_39 . V_73 ) ;
V_11 = F_94 ( V_6 , 256 * 1024 , V_99 , true ,
V_78 , 0 , NULL ,
NULL , & V_6 -> V_180 ) ;
if ( V_11 ) {
return V_11 ;
}
V_11 = F_95 ( V_6 -> V_180 , false ) ;
if ( V_11 )
return V_11 ;
V_11 = F_96 ( V_6 -> V_180 , V_78 , NULL ) ;
F_97 ( V_6 -> V_180 ) ;
if ( V_11 ) {
F_98 ( & V_6 -> V_180 ) ;
return V_11 ;
...
F_104 ( & V_6 -> V_5 . V_3 , V_50 ) ;
F_104 ( & V_6 -> V_5 . V_3 , V_35 ) ;
F_105 ( & V_6 -> V_5 . V_3 ) ;
F_106 ( V_6 ) ;
F_11 ( V_6 ) ;
V_6 -> V_5 . V_179 = false ;
...
void F_93 ( struct V_1 * V_6 , V_110 V_16 )
{
struct V_27 * V_28 ;
if ( ! V_6 -> V_5 . V_179 )
return;
...
static int F_107 ( struct V_138 * V_139 , struct V_182 * V_183 )
{
struct V_53 * V_54 ;
struct V_1 * V_6 ;
int V_11 ;
...
V_6 = F_1 ( V_54 -> V_3 ) ;
F_108 ( & V_6 -> V_186 . V_187 ) ;
V_11 = V_188 -> V_189 ( V_139 , V_183 ) ;
F_109 ( & V_6 -> V_186 . V_187 ) ;
return V_11 ;
}
int F_110 ( struct V_81 * V_82 , struct V_138 * V_139 )
{
struct V_190 * V_191 ;
struct V_1 * V_6 ;
int V_11 ;
...
V_11 = F_111 ( V_82 , V_139 , & V_6 -> V_5 . V_3 ) ;
if ( F_33 ( V_11 != 0 ) ) {
return V_11 ;
}
if ( F_33 ( V_188 == NULL ) ) {
...
static int F_112 ( struct V_198 * V_199 , void * V_200 )
{
...
F_113 ( & V_210 -> V_211 ) ;
V_209 = F_114 ( V_199 , V_133 ) ;
F_115 ( & V_210 -> V_211 ) ;
return V_209 ;
}
static int F_116 ( struct V_212 * V_212 , struct V_81 * V_213 )
{
struct V_1 * V_6 = V_212 -> V_214 ;
F_117 ( V_212 , V_6 -> V_39 . V_215 ) ;
V_213 -> V_193 = V_212 -> V_214 ;
return 0 ;
}
static T_3 F_118 ( struct V_81 * V_216 , char T_4 * V_217 ,
T_5 V_16 , T_6 * V_218 )
{
...
return V_219 ;
F_119 ( & V_6 -> V_221 , V_26 ) ;
F_120 ( V_222 , ( ( T_1 ) * V_218 ) | 0x80000000 ) ;
if ( V_6 -> V_223 >= V_224 )
F_120 ( V_225 , * V_218 >> 31 ) ;
V_220 = F_121 ( V_226 ) ;
F_122 ( & V_6 -> V_221 , V_26 ) ;
V_11 = F_123 ( V_220 , ( T_1 * ) V_217 ) ;
if ( V_11 )
return V_11 ;
V_219 += 4 ;
V_217 += 4 ;
...
static int F_124 ( struct V_212 * V_212 , struct V_81 * V_213 )
{
struct V_1 * V_6 = V_212 -> V_214 ;
F_117 ( V_212 , V_6 -> V_39 . V_181 ) ;
V_213 -> V_193 = V_212 -> V_214 ;
return 0 ;
}
static T_3 F_125 ( struct V_81 * V_216 , char T_4 * V_217 ,
T_5 V_16 , T_6 * V_218 )
{
struct V_1 * V_6 = V_216 -> V_193 ;
T_3 V_219 = 0 ;
int V_11 ;
while ( V_16 ) {
T_6 V_227 = * V_218 / V_99 ;
unsigned V_228 = * V_218 & ~ V_229 ;
T_5 V_230 = F_126 ( T_5 , V_16 , V_99 - V_228 ) ;
struct V_142 * V_142 ;
void * V_231 ;
...
V_231 = F_127 ( V_142 ) ;
V_231 += V_228 ;
V_11 = F_128 ( V_217 , V_231 , V_230 ) ;
F_129 ( V_6 -> V_232 . V_143 [ V_227 ] ) ;
} else
V_11 = F_130 ( V_217 , V_230 ) ;
if ( V_11 )
return - V_173 ;
V_219 += V_230 ;
V_217 += V_230 ;
...
static int F_100 ( struct V_1 * V_6 )
{
#if F_131 ( V_234 )
unsigned V_235 ;
struct V_236 * V_194 = V_6 -> V_44 -> V_237 ;
struct V_238 * V_239 , * V_240 = V_194 -> V_241 ;
V_239 = F_132 ( L_17 , V_242 | V_243 , V_240 ,
V_6 , & V_244 ) ;
if ( F_27 ( V_239 ) )
return F_28 ( V_239 ) ;
V_6 -> V_5 . V_245 = V_239 ;
V_239 = F_132 ( L_18 , V_242 | V_243 , V_240 ,
V_6 , & V_246 ) ;
if ( F_27 ( V_239 ) )
return F_28 ( V_239 ) ;
V_6 -> V_5 . V_122 = V_239 ;
