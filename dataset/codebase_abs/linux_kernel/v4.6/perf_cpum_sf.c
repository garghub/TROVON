...
if ( V_38 -> V_73 . V_147 || V_38 -> V_73 . V_148 != ( V_149 ) V_38 -> V_73 . V_150 )
V_117 -> V_121 = 1 ;
V_123 = 0 ;
...
V_123 = 1 ;
V_64 -> V_104 -> V_151 ( V_64 , 0 ) ;
}
F_82 ( V_64 ) ;
V_80:
return V_123 ;
}
static void F_83 ( struct V_63 * V_64 , V_46 V_152 )
{
F_84 ( V_152 , & V_64 -> V_152 ) ;
}
static int F_85 ( struct V_153 * V_154 ,
unsigned int V_54 )
{
if ( F_86 ( V_54 & V_83 ) )
if ( V_154 -> V_73 . V_155 != 0x0001 )
return 0 ;
if ( V_54 & V_88 )
if ( V_154 -> V_44 . V_155 < 0x8001 )
return 0 ;
return 1 ;
}
...
if ( F_73 ( ! ( V_54 & V_83 ) ) )
return 0 ;
if ( V_154 -> V_73 . V_156 || V_154 -> V_73 . V_138 )
return 0 ;
return 1 ;
}
...
struct V_153 * V_154 )
{
if ( F_86 ( V_38 -> V_157 & V_83 ) )
V_38 -> V_73 = V_154 -> V_73 ;
if ( V_38 -> V_157 & V_88 )
memcpy ( & V_38 -> V_44 , & V_154 -> V_44 , V_38 -> V_32 ) ;
}
...
L_29
L_30 , V_159 -> V_160 ,
V_154 -> V_73 . V_155 , & V_154 -> V_73 ,
( V_54 & V_88 )
? V_154 -> V_44 . V_155 : 0xFFFF ,
( V_54 & V_88 )
? & V_154 -> V_44 : NULL ) ;
}
...
V_38 -> V_157 = V_54 & V_161 ;
V_39 = F_26 ( & V_64 -> V_65 ) ;
V_159 = (struct V_158 * ) F_12 ( * V_1 ) ;
V_154 = (struct V_153 * ) * V_1 ;
while ( ( unsigned long * ) V_154 < ( unsigned long * ) V_159 ) {
if ( ! V_154 -> V_73 . V_155 )
break;
...
static void F_92 ( struct V_63 * V_64 , int V_162 )
{
struct V_34 * V_35 = & V_64 -> V_65 ;
struct V_158 * V_159 ;
unsigned long * V_1 ;
unsigned long long V_163 , V_164 , V_17 , V_165 ;
int V_166 ;
if ( V_162 && F_93 ( V_35 ) )
V_162 = 0 ;
V_1 = ( unsigned long * ) F_58 ( V_35 ) ;
V_166 = V_163 = V_164 = V_17 = 0 ;
while ( ! V_166 ) {
V_159 = (struct V_158 * ) F_12 ( * V_1 ) ;
if ( ! V_159 -> V_160 ) {
V_166 = 1 ;
...
L_32 ,
V_1 , V_159 -> V_123 ,
( V_159 -> V_160 ) ? F_94 ( V_159 ) : 0ULL ) ;
F_91 ( V_64 , V_1 , & V_163 ) ;
V_17 ++ ;
do {
V_165 = V_159 -> V_54 & ~ V_167 ;
V_165 |= V_16 ;
} while ( ! F_95 ( & V_159 -> V_54 , & V_159 -> V_123 ,
V_159 -> V_54 , V_159 -> V_123 ,
V_165 , 0ULL ) );
V_1 ++ ;
if ( F_6 ( V_1 ) )
V_1 = F_7 ( V_1 ) ;
...
{
struct V_6 * V_7 = F_40 ( & V_6 ) ;
if ( F_98 ( ! ( V_64 -> V_65 . V_168 & V_169 ) ) )
return;
if ( V_54 & V_170 )
F_98 ( ! ( V_64 -> V_65 . V_168 & V_171 ) ) ;
F_99 ( V_64 -> V_104 ) ;
V_64 -> V_65 . V_168 = 0 ;
V_7 -> F_3 . V_108 = 1 ;
if ( F_19 ( & V_64 -> V_65 ) )
...
{
struct V_6 * V_7 = F_40 ( & V_6 ) ;
if ( V_64 -> V_65 . V_168 & V_169 )
return;
F_99 ( V_64 -> V_104 ) ;
V_7 -> F_3 . V_108 = 0 ;
V_7 -> F_3 . V_110 = 0 ;
V_64 -> V_65 . V_168 |= V_169 ;
if ( ( V_54 & V_172 ) && ! ( V_64 -> V_65 . V_168 & V_171 ) ) {
F_92 ( V_64 , 1 ) ;
V_64 -> V_65 . V_168 |= V_171 ;
}
F_100 ( V_64 -> V_104 ) ;
}
...
static void F_104 ( struct V_179 V_179 ,
...
static int F_108 ( char * V_199 , const struct V_200 * V_201 )
{
if ( ! F_109 () )
return - V_62 ;
return sprintf ( V_199 , L_38 , V_29 , V_30 ) ;
}
static int F_110 ( const char * V_202 , const struct V_200 * V_201 )
{
int V_19 ;
...
V_26 = V_30 ;
if ( strchr ( V_202 , ',' ) )
V_19 = ( sscanf ( V_202 , L_38 , & V_25 , & V_26 ) == 2 ) ? 0 : - V_22 ;
else
V_19 = F_111 ( V_202 , 10 , & V_26 ) ;
if ( V_25 < 2 || V_25 >= V_26 || V_26 > F_112 () )
V_19 = - V_22 ;
if ( V_19 )
return V_19 ;
F_15 ( V_25 , V_26 ) ;
...
static void T_3 F_114 ( unsigned int V_203 )
{
F_41 ( L_41
L_42 , V_203 ) ;
}
...
if ( V_28 . V_33 != sizeof( struct V_205 ) ) {
F_114 ( V_206 ) ;
return - V_22 ;
}
if ( V_28 . V_86 ) {
