...
V_103 = F_35 ( V_2 , V_63 ) ;
if ( V_93 & V_53 ) {
V_94 = F_24 ( V_2 -> V_68 . V_104 ) ;
if ( ! V_94 )
V_94 = V_103 -> V_105 ;
V_95 = F_24 ( V_2 -> V_68 . V_106 ) ;
if ( ! V_95 )
V_95 = V_103 -> V_107 ;
V_96 = F_33 ( V_2 -> V_68 . V_108 ) ;
V_97 = F_36 ( V_2 -> V_68 . V_109 ) ;
V_98 = V_2 -> V_110 -> V_101 -> V_111 ;
V_100 = & V_2 -> V_76 ;
} else {
ASSERT ( V_93 & V_59 ) ;
V_94 = F_24 ( V_2 -> V_68 . V_112 ) ;
if ( ! V_94 )
V_94 = V_103 -> V_113 ;
V_95 = F_24 ( V_2 -> V_68 . V_114 ) ;
if ( ! V_95 )
V_95 = V_103 -> V_115 ;
V_96 = F_33 ( V_2 -> V_68 . V_116 ) ;
V_97 = F_36 ( V_2 -> V_68 . V_117 ) ;
V_98 = V_2 -> V_110 -> V_101 -> V_118 ;
V_100 = & V_2 -> V_77 ;
}
if ( ( V_93 & V_119 ) == 0 &&
V_2 -> V_68 . V_73 &&
( ( F_37 ( V_2 -> V_110 ) && F_16 ( V_2 ) ) ||
( F_38 ( V_2 -> V_110 ) && F_17 ( V_2 ) ) ||
( F_39 ( V_2 -> V_110 ) && F_18 ( V_2 ) ) ) ) {
if ( V_91 > 0 ) {
V_99 = * V_100 + V_91 ;
if ( V_94 && V_99 > V_94 ) {
F_30 ( V_38 , V_2 , V_120 ) ;
...
V_96 = F_33 ( V_2 -> V_68 . V_124 ) ;
V_97 = F_36 ( V_2 -> V_68 . V_125 ) ;
V_98 = V_2 -> V_110 -> V_101 -> V_126 ;
V_94 = F_24 ( V_2 -> V_68 . V_127 ) ;
if ( ! V_94 )
V_94 = V_103 -> V_128 ;
V_95 = F_24 ( V_2 -> V_68 . V_129 ) ;
if ( ! V_95 )
V_95 = V_103 -> V_130 ;
if ( V_94 && V_99 > V_94 ) {
F_30 ( V_38 , V_2 , V_131 ) ;
...
ASSERT ( V_93 & V_134 ) ;
if ( V_138 ) {
error = F_34 ( V_1 , V_38 , V_138 , V_91 , V_92 ,
( V_93 & ~ V_135 ) ) ;
if ( error )
return error ;
}
if ( V_139 ) {
error = F_34 ( V_1 , V_38 , V_139 , V_91 , V_92 , V_93 ) ;
if ( error )
goto V_141;
}
if ( V_140 ) {
error = F_34 ( V_1 , V_38 , V_140 , V_91 , V_92 , V_93 ) ;
if ( error )
goto V_142;
}
return 0 ;
...
V_93 |= V_119 ;
if ( V_139 )
F_34 ( V_1 , V_38 , V_139 , - V_91 , - V_92 , V_93 ) ;
V_141:
V_93 |= V_119 ;
if ( V_138 )
F_34 ( V_1 , V_38 , V_138 , - V_91 , - V_92 , V_93 ) ;
return error ;
}
int
F_42 (
...
T_6 V_93 )
{
struct V_80 * V_38 = V_35 -> V_144 ;
if ( ! F_8 ( V_38 ) || ! F_9 ( V_38 ) )
return 0 ;
if ( F_14 ( V_38 ) )
V_93 |= V_135 ;
ASSERT ( ! F_10 ( & V_38 -> V_40 , V_35 -> V_41 ) ) ;
ASSERT ( F_43 ( V_35 , V_145 ) ) ;
ASSERT ( ( V_93 & ~ ( V_119 | V_135 ) ) ==
V_59 ||
( V_93 & ~ ( V_119 | V_135 ) ) ==
V_53 ) ;
return F_41 ( V_1 , V_38 ,
V_35 -> V_42 , V_35 -> V_43 ,
V_35 -> V_44 ,
V_91 , V_92 , V_93 ) ;
}
...
{
V_1 -> V_7 |= V_8 ;
V_148 -> V_147 . V_9 -> V_10 |= V_11 ;
}
STATIC void
F_6 (
T_1 * V_1 )
{
V_1 -> V_21 = F_47 ( V_149 , V_150 ) ;
}
void
F_48 (
T_1 * V_1 )
