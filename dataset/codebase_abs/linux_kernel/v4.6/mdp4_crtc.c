...
V_64 = & V_3 -> V_65 -> V_66 ;
F_13 ( L_3 ,
V_10 -> V_19 , V_64 -> V_11 . V_30 , V_64 -> V_19 ,
...
struct V_13 * V_14 , int V_30 , int V_127 ,
enum V_61 V_128 )
{
struct V_2 * V_3 = NULL ;
struct V_10 * V_10 ;
