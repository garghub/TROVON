...
static inline int F_151 ( struct V_7 * V_8 )
{
int V_136 = F_12 ( V_137 , & V_8 -> V_20 ) ;
if ( V_136 ) {
F_152 () ;
}
return V_136 ;
...
V_59 = F_8 ( * V_138 , V_14 , V_11 ) ;
V_11 -= V_59 ;
V_139 = V_11 == 1 && * V_14 == F_111 ( V_8 ) ;
F_7 ( V_8 , V_14 , V_11 ) ;
F_115 ( & V_2 -> V_4 , V_2 -> V_4 + V_11 ) ;
if ( F_132 ( V_8 ) && V_2 -> V_21 && V_139 &&
( V_77 == V_2 -> V_4 ) )
V_11 = 0 ;
* V_138 += V_11 ;
* V_62 -= V_11 ;
...
F_155 ( L_7 ,
V_144 , * V_62 , V_10 , V_11 , V_13 ) ;
V_141 = F_156 ( V_2 -> V_44 , V_13 , V_10 ) ;
V_140 = V_11 - ( V_13 - V_10 ) ;
if ( V_141 == V_6 && V_140 ) {
V_141 = F_156 ( V_2 -> V_44 , V_140 , 0 ) ;
V_143 = V_141 != V_140 ;
} else
V_143 = V_141 != V_13 ;
V_11 = V_141 - V_10 ;
...
V_11 += V_6 ;
V_37 = V_11 + V_143 ;
if ( ! V_143 || F_2 ( V_2 , V_141 ) != V_102 ) {
V_37 = F_137 ( * V_62 , V_37 ) ;
V_11 = V_37 ;
}
F_155 ( L_8 ,
V_144 , V_141 , V_143 , V_11 , V_37 , V_10 , V_140 ) ;
V_142 = F_6 ( V_8 , * V_138 , V_10 , V_11 ) ;
if ( V_142 )
return - V_145 ;
* V_138 += V_11 ;
* V_62 -= V_11 ;
...
static int F_158 ( struct V_7 * V_8 , struct V_146 * V_146 )
{
if ( V_146 -> V_147 -> V_57 == V_148 )
return 0 ;
return F_159 ( V_8 , V_149 ) ;
}
static T_3 F_160 ( struct V_7 * V_8 , struct V_146 * V_146 ,
unsigned char T_2 * V_61 , T_1 V_62 )
{
struct V_1 * V_2 = V_8 -> V_12 ;
unsigned char T_2 * V_138 = V_61 ;
F_161 ( V_150 , V_151 ) ;
int V_37 , V_136 ;
int V_152 , time ;
T_3 V_59 = 0 ;
...
V_153 = ( V_95 / 10 ) * F_149 ( V_8 ) ;
V_152 = 1 ;
}
}
V_46 = V_8 -> V_46 ;
V_10 = V_2 -> V_4 ;
F_164 ( & V_8 -> V_50 , & V_150 ) ;
while ( V_62 ) {
...
F_80 ( & V_8 -> V_51 ) ;
V_153 = F_170 ( & V_150 , V_162 ,
V_153 ) ;
F_82 ( & V_8 -> V_51 ) ;
continue;
}
if ( V_2 -> V_21 && ! F_132 ( V_8 ) ) {
V_59 = F_154 ( V_8 , & V_138 , & V_62 ) ;
if ( V_59 )
break;
} else {
int V_15 ;
if ( V_46 && V_138 == V_61 ) {
if ( F_167 ( V_163 , V_138 ) ) {
V_59 = - V_145 ;
break;
}
V_138 ++ ;
...
F_9 ( V_8 ) ;
F_80 ( & V_8 -> V_51 ) ;
F_171 ( & V_8 -> V_50 , & V_150 ) ;
F_49 ( & V_2 -> V_132 ) ;
if ( V_138 - V_61 )
V_59 = V_138 - V_61 ;
return V_59 ;
}
static T_3 F_172 ( struct V_7 * V_8 , struct V_146 * V_146 ,
const unsigned char * V_61 , T_1 V_62 )
{
const unsigned char * V_138 = V_61 ;
F_161 ( V_150 , V_151 ) ;
int V_37 ;
T_3 V_59 = 0 ;
if ( F_173 ( V_8 ) && V_146 -> V_147 -> V_57 != V_148 ) {
V_59 = F_174 ( V_8 ) ;
if ( V_59 )
return V_59 ;
}
F_82 ( & V_8 -> V_51 ) ;
F_54 ( V_8 ) ;
F_164 ( & V_8 -> V_130 , & V_150 ) ;
while ( 1 ) {
if ( F_169 ( V_161 ) ) {
V_59 = - V_157 ;
break;
}
if ( F_168 ( V_146 ) || ( V_8 -> V_34 && ! V_8 -> V_34 -> V_112 ) ) {
V_59 = - V_160 ;
break;
}
if ( F_52 ( V_8 ) ) {
while ( V_62 > 0 ) {
T_3 V_164 = F_50 ( V_8 , V_138 , V_62 ) ;
if ( V_164 < 0 ) {
if ( V_164 == - V_156 )
break;
V_59 = V_164 ;
...
while ( V_62 > 0 ) {
F_47 ( & V_2 -> V_60 ) ;
V_37 = V_8 -> V_56 -> V_57 ( V_8 , V_138 , V_62 ) ;
F_49 ( & V_2 -> V_60 ) ;
if ( V_37 < 0 ) {
V_59 = V_37 ;
goto V_64;
...
F_80 ( & V_8 -> V_51 ) ;
F_170 ( & V_150 , V_162 , V_158 ) ;
F_82 ( & V_8 -> V_51 ) ;
}
V_64:
F_171 ( & V_8 -> V_130 , & V_150 ) ;
if ( V_62 && V_8 -> V_25 )
F_114 ( V_24 , & V_8 -> V_20 ) ;
F_80 ( & V_8 -> V_51 ) ;
return ( V_138 - V_61 ) ? V_138 - V_61 : V_59 ;
}
static unsigned int F_175 ( struct V_7 * V_8 , struct V_146 * V_146 ,
T_4 * V_150 )
{
unsigned int V_165 = 0 ;
F_176 ( V_146 , & V_8 -> V_50 , V_150 ) ;
F_176 ( V_146 , & V_8 -> V_130 , V_150 ) ;
if ( F_151 ( V_8 ) )
V_165 |= V_166 ;
if ( F_148 ( V_8 , 1 ) )
V_165 |= V_104 | V_167 ;
if ( V_8 -> V_46 && V_8 -> V_34 -> V_48 )
V_165 |= V_168 | V_104 | V_167 ;
if ( F_168 ( V_146 ) )
V_165 |= V_166 ;
if ( V_8 -> V_56 -> V_57 && ! F_177 ( V_8 ) &&
F_178 ( V_8 ) < V_169 &&
F_48 ( V_8 ) > 0 )
V_165 |= V_170 | V_171 ;
return V_165 ;
...
static int F_180 ( struct V_7 * V_8 , struct V_146 * V_146 ,
...
switch ( V_172 ) {
case V_174 :
return F_167 ( F_178 ( V_8 ) , ( int T_2 * ) V_173 ) ;
case V_175 :
F_33 ( & V_8 -> V_51 ) ;
if ( F_141 ( V_8 ) )
V_59 = F_179 ( V_2 ) ;
...
V_59 = F_1 ( V_2 ) ;
F_34 ( & V_8 -> V_51 ) ;
return F_167 ( V_59 , ( unsigned int T_2 * ) V_173 ) ;
default:
return F_181 ( V_8 , V_146 , V_172 , V_173 ) ;
}
}
void F_182 ( struct V_176 * V_56 )
{
* V_56 = V_177 ;
V_56 -> V_178 = NULL ;
V_56 -> V_179 = V_56 -> V_20 = 0 ;
}
void T_5 F_183 ( void )
{
F_184 ( V_180 , & V_177 ) ;
