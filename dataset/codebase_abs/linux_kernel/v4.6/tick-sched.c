...
static void F_120 ( struct V_1 * V_16 , T_1 V_4 , int V_94 )
{
F_3 ( V_4 ) ;
F_121 ( V_94 ) ;
F_122 () ;
...
static bool F_124 ( int V_2 , struct V_1 * V_16 )
{
if ( F_7 ( ! F_125 ( V_2 ) ) ) {
if ( V_2 == V_14 )
V_14 = V_15 ;
...
if ( F_7 ( V_16 -> V_69 == V_96 ) ) {
V_16 -> V_93 = ( T_1 ) { . V_8 = V_97 / V_98 } ;
return false ;
}
if ( F_126 () )
return false ;
if ( F_7 ( F_127 () && F_125 ( V_2 ) ) ) {
static int V_99 ;
if ( V_99 < 10 &&
( F_127 () & V_100 ) ) {
F_61 ( L_7 ,
...
static void F_129 ( struct V_1 * V_16 )
{
T_1 V_4 , V_80 ;
int V_2 = F_16 () ;
V_4 = F_93 ( V_16 ) ;
...
static void F_136 ( struct V_1 * V_16 )
{
#ifndef F_137
unsigned long V_5 ;
if ( F_138 () )
...
static inline void F_143 ( struct V_1 * V_16 , int V_106 )
{
if ( ! V_57 )
return;
V_16 -> V_69 = V_106 ;
...
if ( F_147 ( F_141 ) )
return;
F_148 ( & V_16 -> V_67 , V_108 , V_109 ) ;
V_107 = F_14 () ;
F_100 ( & V_16 -> V_67 , V_107 ) ;
F_149 ( & V_16 -> V_67 , V_9 ) ;
F_103 ( F_104 ( & V_16 -> V_67 ) , 1 ) ;
F_143 ( V_16 , V_110 ) ;
}
static void F_150 ( struct V_1 * V_16 , T_1 V_4 )
{
#if 0
ktime_t delta;
...
static enum V_111 F_154 ( struct V_112 * V_113 )
{
struct V_1 * V_16 =
F_155 ( V_113 , struct V_1 , V_67 ) ;
struct V_17 * V_18 = F_142 () ;
T_1 V_4 = F_94 () ;
F_15 ( V_4 ) ;
if ( V_18 )
...
static int T_4 F_156 ( char * V_43 )
{
F_157 ( & V_43 , & V_116 ) ;
return 0 ;
}
...
T_1 V_4 = F_94 () ;
F_148 ( & V_16 -> V_67 , V_108 , V_109 ) ;
V_16 -> V_67 . V_117 = F_154 ;
F_100 ( & V_16 -> V_67 , F_14 () ) ;
if ( V_116 ) {
T_5 V_118 = F_8 ( V_9 ) >> 1 ;
F_159 ( V_118 , F_160 () ) ;
V_118 *= F_16 () ;
F_161 ( & V_16 -> V_67 , V_118 ) ;
}
F_101 ( & V_16 -> V_67 , V_4 , V_9 ) ;
F_102 ( & V_16 -> V_67 , V_71 ) ;
F_143 ( V_16 , V_70 ) ;
