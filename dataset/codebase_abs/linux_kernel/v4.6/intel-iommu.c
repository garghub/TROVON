...
switch ( V_29 ) {
case V_417 :
V_216 = V_416 -> V_126 << V_11 ;
V_108 = ( ( V_416 -> V_126 + V_416 -> V_245 ) << V_11 ) - 1 ;
...
case V_419 :
case V_420 :
V_358 = F_13 ( V_416 -> V_126 ) ;
V_270 = F_13 ( V_416 -> V_126 + V_416 -> V_245 - 1 ) ;
while ( V_358 <= V_270 ) {
struct V_203 * V_203 ;
struct V_76 * V_77 ;
struct V_31 * V_32 ;
...
T_2 V_425 = F_44 ( V_32 -> V_36 + V_426 ) ;
return sprintf ( V_424 , L_77 ,
F_383 ( V_425 ) , F_384 ( V_425 ) ) ;
}
...
{
struct V_31 * V_32 = F_382 ( V_95 ) ;
return sprintf ( V_424 , L_78 , V_32 -> V_427 ) ;
}
...
{
struct V_31 * V_32 = F_382 ( V_95 ) ;
return sprintf ( V_424 , L_78 , V_32 -> V_71 ) ;
}
...
{
struct V_31 * V_32 = F_382 ( V_95 ) ;
return sprintf ( V_424 , L_78 , V_32 -> V_81 ) ;
}
...
{
struct V_31 * V_32 = F_382 ( V_95 ) ;
return sprintf ( V_424 , L_79 , F_169 ( V_32 -> V_71 ) ) ;
}
...
{
struct V_31 * V_32 = F_382 ( V_95 ) ;
return sprintf ( V_424 , L_80 , F_390 ( V_32 -> V_194 ,
F_169 ( V_32 -> V_71 ) ) ) ;
}
int T_3 F_391 ( void )
{
...
V_42 = & V_39 -> V_42 ;
V_42 -> V_443 . V_444 = 0 ;
V_42 -> V_443 . V_445 = F_406 ( V_39 -> V_132 ) ;
V_42 -> V_443 . V_446 = true ;
return V_42 ;
}
...
if ( V_39 -> V_441 > ( 1LL << V_67 ) ) {
F_122 ( L_94
L_95 ,
V_449 , V_67 , V_39 -> V_441 ) ;
return - V_282 ;
}
V_39 -> V_132 = V_67 ;
...
F_122 ( L_94
L_95 ,
V_449 , V_39 -> V_132 , V_441 ) ;
return - V_282 ;
}
V_39 -> V_441 = V_441 ;
}
V_58 = F_215 ( V_450 , V_58 ) ;
V_83 = F_226 ( V_39 , V_203 >> V_12 ,
V_450 >> V_12 , V_58 , V_246 ) ;
return V_83 ;
}
...
static bool F_414 ( enum V_457 V_71 )
{
if ( V_71 == V_458 )
return F_82 ( NULL ) == 1 ;
if ( V_71 == V_459 )
...
return;
F_422 ( V_95 ) ;
F_423 ( V_32 -> V_435 , V_95 ) ;
}
int F_424 ( struct V_31 * V_32 , struct V_463 * V_464 )
{
struct V_167 * V_168 ;
struct V_22 * V_23 ;
struct V_39 * V_42 ;
...
V_24 V_465 ;
int V_83 ;
V_42 = F_304 ( V_464 -> V_95 ) ;
if ( ! V_42 )
return - V_44 ;
F_104 ( & V_169 , V_33 ) ;
F_207 ( & V_32 -> V_112 ) ;
V_83 = - V_44 ;
V_168 = V_464 -> V_95 -> V_96 . V_32 ;
...
goto V_104;
V_465 = V_23 [ 0 ] . V_19 ;
V_464 -> V_55 = V_42 -> V_183 [ V_32 -> V_184 ] ;
V_464 -> V_178 = F_425 ( V_168 -> V_87 , V_168 -> V_88 ) ;
if ( ! ( V_465 & V_466 ) ) {
V_23 [ 1 ] . V_21 = ( V_24 ) F_92 ( V_32 -> V_467 ) ;
V_23 [ 1 ] . V_19 = ( V_24 ) F_92 ( V_32 -> V_468 ) | F_426 ( V_32 -> V_81 ) ;
F_427 () ;
if ( ( V_465 & V_469 ) == ( V_224 << 2 ) ) {
V_465 &= ~ V_469 ;
if ( V_168 -> V_171 )
V_465 |= V_470 << 2 ;
else
...
V_23 [ 0 ] . V_19 = V_465 ;
F_427 () ;
V_32 -> V_185 . V_228 ( V_32 , V_464 -> V_55 , V_464 -> V_178 ,
V_229 ,
V_155 ) ;
}
if ( ! V_168 -> V_173 )
...
if ( V_168 -> V_176 ) {
V_464 -> V_474 = 1 ;
V_464 -> V_179 = V_168 -> V_177 ;
if ( V_464 -> V_179 >= V_475 )
V_464 -> V_179 = 0 ;
}
V_83 = 0 ;
V_104:
...
struct V_99 * V_101 ;
T_10 V_479 ;
V_101 = F_433 ( V_480 , 0x3a3e , NULL ) ;
if ( ! V_101 )
return;
F_251 ( V_101 ) ;
V_101 = F_433 ( V_480 , 0x342e , NULL ) ;
if ( ! V_101 )
return;
if ( F_434 ( V_101 , 0x188 , & V_479 ) ) {
F_251 ( V_101 ) ;
return;
}
F_251 ( V_101 ) ;
