...
F_6 ( V_9 ) ;
V_9 -> V_27 . V_181 = V_182 + ( V_9 -> V_33 * V_183 / 100 ) ;
F_87 ( & V_9 -> V_27 ) ;
}
V_179:
F_30 ( & V_9 -> V_26 ) ;
...
static int
F_88 ( struct V_184 * V_185 ,
unsigned long V_186 , void * V_187 )
{
struct V_188 * V_56 = V_187 ;
struct V_1 * log = F_1 ( V_56 -> V_2 ) ;
if ( V_186 == V_189 && V_56 -> V_95 == V_190 ) {
int V_191 ;
F_21 ( & log -> V_19 ) ;
for ( V_191 = 0 ; V_191 < V_5 ; V_191 ++ ) {
struct V_192 * V_193 ;
struct V_6 * V_9 ;
struct V_7 * V_8 = & log -> V_10 [ V_191 ] ;
...
static int F_90 ( struct V_2 * V_2 , struct V_85 * V_195 ,
struct V_53 * V_42 , const struct V_58 * V_59 ,
const struct V_158 * const V_196 [] )
{
return - V_197 ;
}
static int F_91 ( struct V_2 * V_2 , struct V_85 * V_195 ,
struct V_53 * V_42 , const struct V_58 * V_59 ,
...
if ( V_198 [ V_202 ] ) {
T_1 V_67 = V_82 -> V_90 ;
V_200 = F_80 ( V_198 [ V_202 ] ) ;
switch ( V_200 -> V_203 ) {
case V_204 :
return F_93 ( V_2 , V_67 , & V_205 ) ;
case V_206 :
F_94 ( V_2 , V_67 ) ;
return 0 ;
}
...
if ( V_198 [ V_218 ] ) {
T_6 V_50 = F_106 ( V_198 [ V_218 ] ) ;
F_41 ( V_9 , F_105 ( V_50 ) ) ;
}
if ( V_198 [ V_219 ] ) {
T_6 V_35 = F_106 ( V_198 [ V_219 ] ) ;
F_40 ( V_9 , F_105 ( V_35 ) ) ;
}
if ( V_198 [ V_220 ] ) {
T_6 V_51 = F_106 ( V_198 [ V_220 ] ) ;
F_42 ( V_9 , F_105 ( V_51 ) ) ;
}
if ( V_198 [ V_209 ] )
F_43 ( V_9 , V_52 ) ;
...
static struct V_192 * F_107 ( struct V_2 * V_2 , struct V_221 * V_222 )
{
struct V_1 * log ;
if ( ! V_222 )
return NULL ;
log = F_1 ( V_2 ) ;
for ( V_222 -> V_223 = 0 ; V_222 -> V_223 < V_5 ; V_222 -> V_223 ++ ) {
struct V_7 * V_8 = & log -> V_10 [ V_222 -> V_223 ] ;
if ( ! F_108 ( V_8 ) )
return F_109 ( F_110 ( V_8 ) ) ;
}
return NULL ;
}
static struct V_192 * F_111 ( struct V_2 * V_2 , struct V_221 * V_222 ,
struct V_192 * V_224 )
{
V_224 = F_109 ( F_112 ( V_224 ) ) ;
while ( ! V_224 ) {
struct V_1 * log ;
struct V_7 * V_8 ;
if ( ++ V_222 -> V_223 >= V_5 )
return NULL ;
log = F_1 ( V_2 ) ;
V_8 = & log -> V_10 [ V_222 -> V_223 ] ;
V_224 = F_109 ( F_110 ( V_8 ) ) ;
}
return V_224 ;
}
static struct V_192 * F_113 ( struct V_2 * V_2 , struct V_221 * V_222 ,
T_9 V_225 )
{
struct V_192 * V_8 ;
V_8 = F_107 ( V_2 , V_222 ) ;
if ( V_8 )
while ( V_225 && ( V_8 = F_111 ( V_2 , V_222 , V_8 ) ) )
V_225 -- ;
return V_225 ? NULL : V_8 ;
}
static void * F_114 ( struct V_226 * V_227 , T_9 * V_225 )
__acquires( T_10 )
{
F_9 () ;
return F_113 ( F_115 ( V_227 ) , V_227 -> V_228 , * V_225 ) ;
}
static void * F_116 ( struct V_226 * V_227 , void * V_229 , T_9 * V_225 )
{
( * V_225 ) ++ ;
return F_111 ( F_115 ( V_227 ) , V_227 -> V_228 , V_229 ) ;
}
static void F_117 ( struct V_226 * V_227 , void * V_229 )
__releases( T_10 )
{
F_11 () ;
}
static int F_118 ( struct V_226 * V_227 , void * V_229 )
{
const struct V_6 * V_9 = V_229 ;
F_119 ( V_227 , L_4 ,
V_9 -> V_4 ,
V_9 -> V_30 , V_9 -> V_57 ,
V_9 -> V_37 , V_9 -> V_39 ,
...
static int F_121 ( struct V_230 * V_230 , struct V_140 * V_140 )
{
return F_122 ( V_230 , V_140 , & V_231 ,
sizeof( struct V_221 ) ) ;
}
...
#endif
for ( V_191 = 0 ; V_191 < V_5 ; V_191 ++ )
F_125 ( & log -> V_10 [ V_191 ] ) ;
F_25 ( & log -> V_19 ) ;
#ifdef F_124
V_233 = F_126 ( L_5 , 0440 ,
V_2 -> V_236 . V_237 , & V_238 ) ;
if ( ! V_233 )
return - V_23 ;
V_234 = F_127 ( V_2 -> V_17 , 0 ) ;
V_235 = F_128 ( V_2 -> V_17 , 0 ) ;
if ( F_129 ( V_234 ) && F_130 ( V_235 ) )
F_131 ( V_233 , V_234 , V_235 ) ;
#endif
return 0 ;
}
