...
static void F_41 ( void * * V_27 , bool V_40 )
{
long * V_41 = ( long * ) V_27 ;
long V_42 = * V_41 ;
if ( ! V_42 )
...
static int
F_59 ( const char * V_47 , struct V_48 * V_49 ,
unsigned long V_22 , void * V_27 )
{
long V_41 = ( long ) V_27 ;
F_60 ( V_49 , L_1 , ( void * ) V_22 , V_47 ) ;
if ( V_41 == - 1 )
F_61 ( V_49 , L_2 ) ;
else
F_60 ( V_49 , L_3 , V_41 ) ;
...
static int
F_62 ( struct V_48 * V_49 , unsigned long V_22 ,
struct V_50 * V_4 , void * V_27 )
{
return F_59 ( L_4 , V_49 , V_22 , V_27 ) ;
}
static int
F_63 ( struct V_48 * V_49 , unsigned long V_22 ,
struct V_50 * V_4 , void * V_27 )
{
return F_59 ( L_5 , V_49 , V_22 , V_27 ) ;
}
static int
F_64 ( struct V_48 * V_49 , unsigned long V_22 ,
struct V_50 * V_4 , void * V_27 )
{
return F_59 ( L_6 , V_49 , V_22 , V_27 ) ;
}
static int
F_65 ( struct V_48 * V_49 , unsigned long V_22 ,
struct V_50 * V_4 , void * V_27 )
{
return F_59 ( L_7 , V_49 , V_22 , V_27 ) ;
}
static int
F_66 ( struct V_48 * V_49 , unsigned long V_22 ,
struct V_50 * V_4 , void * V_27 )
{
return F_59 ( L_8 , V_49 , V_22 , V_27 ) ;
}
static int
F_67 ( struct V_50 * V_4 ,
struct V_51 * V_52 , char * V_53 ,
char * V_54 , char * V_55 , int V_56 )
{
void * V_41 = ( void * ) - 1 ;
char * V_57 ;
int V_14 ;
...
if ( ! strlen ( V_57 ) )
goto V_58;
V_14 = F_70 ( V_57 , 0 , ( unsigned long * ) & V_41 ) ;
if ( V_14 )
return V_14 ;
V_58:
V_14 = F_71 ( V_53 , V_4 , V_41 ) ;
return V_14 < 0 ? V_14 : 0 ;
}
static int
F_72 ( struct V_51 * V_52 ,
char * V_53 , char * V_54 , char * V_55 , int V_56 )
{
struct V_50 * V_4 ;
...
V_4 = V_55 ? & V_61 : & V_62 ;
return F_67 ( V_4 , V_52 , V_53 , V_54 ,
V_55 , V_56 ) ;
}
static int
F_73 ( struct V_51 * V_52 ,
char * V_53 , char * V_54 , char * V_55 , int V_56 )
{
struct V_50 * V_4 ;
V_4 = V_55 ? & V_63 : & V_64 ;
