...
if ( ! V_40 )
return - V_45 ;
V_5 = F_15 ( & V_38 -> V_13 , sizeof( * V_5 ) , V_46 ) ;
if ( ! V_5 )
return - V_47 ;
V_5 -> V_13 = & V_38 -> V_13 ;
F_16 ( V_38 , V_5 ) ;
V_43 = F_17 ( V_48 , V_40 ) ;
V_5 -> V_11 = (struct V_49 * ) V_43 -> V_17 ;
V_5 -> V_10 = F_18 ( V_40 , L_7 ) ;
if ( F_19 ( V_5 -> V_10 ) ) {
F_4 ( & V_38 -> V_13 , L_8 ) ;
return F_20 ( V_5 -> V_10 ) ;
}
for ( V_44 = 0 ; V_44 < V_50 ; V_44 ++ ) {
const char * V_51 = V_5 -> V_11 -> V_52 [ V_44 ] ;
struct V_1 * V_2 = & V_5 -> V_26 [ V_44 ] ;
struct V_53 * V_28 ;
int V_3 ;
if ( ! V_51 )
continue;
V_28 = F_21 ( V_5 -> V_13 , V_51 ) ;
if ( F_19 ( V_28 ) ) {
V_7 = F_20 ( V_28 ) ;
if ( V_7 == - V_45 )
continue;
...
return 0 ;
V_55:
for ( V_44 = V_50 - 1 ; V_44 >= 0 ; V_44 -- ) {
struct V_1 * V_59 = & V_5 -> V_26 [ V_44 ] ;
if ( V_59 -> V_28 )
F_25 ( V_59 -> V_28 ,
& V_59 -> V_15 ) ;
}
