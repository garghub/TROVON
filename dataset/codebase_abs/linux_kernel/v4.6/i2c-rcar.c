...
if ( F_34 ( V_2 -> V_5 ) )
return F_35 ( V_2 -> V_5 ) ;
V_2 -> V_32 = (enum V_125 ) F_38 ( V_27 ) ;
F_39 ( & V_2 -> V_97 ) ;
V_99 = & V_2 -> V_99 ;
V_99 -> V_126 = V_118 -> V_127 ;
V_99 -> V_128 = & V_129 ;
V_99 -> V_130 = V_131 ;
V_99 -> V_132 = 3 ;
V_99 -> V_27 . V_133 = V_27 ;
V_99 -> V_27 . V_134 = V_27 -> V_134 ;
F_40 ( V_99 , V_2 ) ;
F_41 ( V_99 -> V_135 , V_118 -> V_135 , sizeof( V_99 -> V_135 ) ) ;
