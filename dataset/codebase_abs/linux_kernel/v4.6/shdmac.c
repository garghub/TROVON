...
if ( ! V_7 || ! V_7 -> V_31 )
return - V_145 ;
V_33 = F_69 ( V_112 , V_146 , 0 ) ;
V_68 = F_69 ( V_112 , V_146 , 1 ) ;
V_143 = F_69 ( V_112 , V_147 , 0 ) ;
if ( ! V_33 || ! V_143 )
return - V_145 ;
...
V_36 -> V_148 = V_124 ;
V_36 -> V_149 = V_124 ;
V_36 -> V_150 = F_73 ( V_151 ) | F_73 ( V_103 ) ;
V_36 -> V_152 = V_153 ;
if ( ! V_7 -> V_154 )
F_74 ( V_155 , V_36 -> V_156 ) ;
if ( V_7 -> V_87 && V_7 -> V_88 )
F_74 ( V_157 , V_36 -> V_156 ) ;
V_36 -> V_158 = V_66 ;
V_4 -> V_35 . V_159 = & V_160 ;
V_4 -> V_35 . V_161 = sizeof( struct V_75 ) ;
...
if ( V_113 < 0 )
F_51 ( & V_112 -> V_37 , L_10 , V_165 , V_113 ) ;
F_79 ( & V_25 ) ;
F_80 ( & V_4 -> V_166 , & V_167 ) ;
F_81 ( & V_25 ) ;
V_113 = F_16 ( V_4 ) ;
if ( V_113 )
goto V_168;
#if F_66 ( V_134 ) || F_66 ( V_135 )
V_144 = F_69 ( V_112 , V_147 , 1 ) ;
if ( ! V_144 )
V_144 = V_143 ;
else
V_139 ++ ;
if ( V_144 == V_143 ||
( V_143 -> V_24 & V_169 ) == V_170 )
V_136 = V_171 ;
V_137 = V_143 -> V_172 ;
...
V_144 = V_143 ;
#endif
if ( V_144 -> V_172 == V_144 -> V_174 &&
! F_69 ( V_112 , V_147 , 1 ) ) {
for (; V_138 < V_7 -> V_31 ; V_138 ++ ) {
if ( V_138 < V_132 ) {
V_133 [ V_138 ] = V_144 -> V_172 ;
V_131 [ V_138 ] = V_171 ;
} else {
V_140 = 1 ;
break;
...
do {
for ( V_30 = V_144 -> V_172 ; V_30 <= V_144 -> V_174 ; V_30 ++ ) {
if ( V_138 >= V_132 ) {
V_140 = 1 ;
break;
}
...
{
int V_113 = F_95 ( & V_177 ) ;
if ( V_113 )
return V_113 ;
return F_96 ( & V_178 , F_65 ) ;
}
