...
static int F_61 ( const struct V_70 * V_83 ,
const void * V_84 )
{
const struct V_46 * V_85 , * V_86 ;
V_85 = F_26 ( V_83 , struct V_46 , V_78 ) ;
V_86 = V_84 ;
if ( memcmp ( V_85 -> V_76 , V_86 -> V_76 ,
sizeof( V_85 -> V_76 ) ) != 0 )
return 0 ;
if ( memcmp ( V_85 -> V_77 , V_86 -> V_77 ,
sizeof( V_85 -> V_77 ) ) != 0 )
return 0 ;
return 1 ;
}
static struct V_46 *
F_62 ( struct V_62 * V_63 ,
void * V_82 )
{
struct V_65 * V_66 ;
...
static struct V_46 * F_89 ( struct V_4 * V_5 ,
struct V_62 * V_63 ,
T_2 * V_80 ,
T_2 * V_81 )
{
...
V_47 = F_62 ( V_63 , ( void * ) & V_123 ) ;
if ( V_47 ) {
V_47 -> V_55 = V_23 ;
return V_47 ;
}
V_47 = F_82 ( sizeof( * V_47 ) , V_118 ) ;
if ( ! V_47 )
return NULL ;
F_23 ( & V_47 -> V_73 ) ;
F_24 ( & V_47 -> V_92 ) ;
...
static T_2 F_91 ( T_2 V_114 )
{
T_2 V_124 , V_125 ;
F_92 ( & V_124 , sizeof( V_124 ) ) ;
V_125 = V_124 * ( V_126 - V_114 ) ;
V_125 /= V_126 ;
return V_126 - V_125 ;
}
static void F_93 ( char * V_81 , const char * V_80 , unsigned int V_97 )
{
unsigned int V_67 ;
...
static bool F_105 ( struct V_127 * V_50 , T_2 * V_81 , T_2 * V_80 )
{
if ( F_102 ( V_50 ) -> V_174 && ! F_78 ( V_81 , V_80 ) )
return false ;
return true ;
}
static struct V_48 *
...
if ( ! F_78 ( V_47 -> V_76 , V_120 -> V_61 ) )
continue;
if ( ! F_78 ( V_47 -> V_77 , V_121 -> V_61 ) )
continue;
F_42 ( & V_47 -> V_92 ) ;
if ( F_55 ( & V_47 -> V_73 ) ) {
F_46 ( & V_47 -> V_92 ) ;
...
static bool F_113 ( struct V_127 * V_50 ,
struct V_129 * V_89 ,
struct V_128 * V_128 )
{
...
V_49 -> V_47 = V_47 ;
F_42 ( & V_47 -> V_92 ) ;
F_115 ( & V_49 -> V_57 , & V_47 -> V_73 ) ;
F_46 ( & V_47 -> V_92 ) ;
return true ;
}
bool F_116 ( struct V_127 * V_50 ,
struct V_129 * V_89 )
{
...
if ( ! V_47 )
goto V_94;
V_160 = F_97 ( V_50 , V_189 + sizeof( * V_188 ) ) ;
if ( ! F_114 ( V_50 , V_47 , V_89 , V_160 ) )
goto V_191;
return true ;
V_191:
F_32 ( V_47 ) ;
...
if ( ! V_47 )
goto V_94;
V_50 = F_118 ( V_50 , V_118 ) ;
if ( F_54 ( ! V_50 ) )
goto V_191;
if ( F_54 ( ! F_119 ( V_50 , V_98 ) ) )
goto V_192;
if ( F_54 ( ! F_120 ( V_50 , V_98 ) ) )
goto V_192;
V_160 = F_97 ( V_50 , V_189 + sizeof( * V_188 ) ) ;
if ( ! F_114 ( V_50 , V_47 , NULL , V_160 ) )
goto V_192;
F_70 ( V_5 , V_193 ) ;
return;
V_192:
...
{
struct V_128 * V_128 = F_111 ( V_50 ) ;
if ( F_122 ( V_5 , V_128 -> V_184 ) )
return;
F_99 ( V_50 , V_98 ) ;
F_112 ( V_5 , V_50 ) ;
}
static struct V_135 *
F_123 ( struct V_4 * V_5 , struct V_127 * V_50 ,
struct V_48 * V_49 )
{
...
memcpy ( & V_198 , F_124 ( V_50 ) , sizeof( V_198 ) ) ;
if ( F_125 ( V_50 , 0 ) < 0 )
return NULL ;
if ( F_54 ( ! F_120 ( V_50 , V_195 ) ) )
return NULL ;
F_126 ( V_50 , - V_98 ) ;
F_127 ( V_50 ) ;
V_128 = F_111 ( V_50 ) ;
* V_128 = V_198 ;
if ( F_122 ( V_5 , V_197 . V_144 ) ) {
F_83 ( V_128 -> V_184 , V_197 . V_144 ) ;
V_50 -> V_200 = V_201 ;
V_199 = V_197 . V_169 ;
V_112 = V_197 . V_171 ;
V_168 = V_197 . V_172 ;
...
V_153 = F_128 ( V_197 . V_173 ) ;
if ( V_153 > V_50 -> V_97 )
return NULL ;
F_93 ( V_50 -> V_82 + V_194 ,
V_49 -> V_50 -> V_82 + V_194 ,
V_153 ) ;
if ( V_49 -> V_50 -> V_97 > V_153 + V_194 ) {
V_27 = F_129 ( V_50 , V_153 + V_194 ) ;
if ( V_27 )
return NULL ;
}
...
if ( ! F_7 ( & V_5 -> V_10 ) )
return V_208 ;
if ( F_54 ( ! F_119 ( V_50 , V_207 ) ) )
return V_208 ;
V_139 = (struct V_138 * ) V_50 -> V_82 ;
V_128 = F_111 ( V_50 ) ;
if ( ! F_122 ( V_5 , V_128 -> V_184 ) &&
! F_122 ( V_5 , V_139 -> V_144 ) )
return V_208 ;
if ( F_122 ( V_5 , V_139 -> V_144 ) )
F_70 ( V_5 , V_209 ) ;
V_49 = F_130 ( V_5 , V_128 ,
V_139 ) ;
if ( ! V_49 ) {
F_70 ( V_5 , V_210 ) ;
return V_208 ;
...
if ( F_98 ( V_49 -> V_50 ) < 0 )
goto V_211;
V_196 = F_123 ( V_5 , V_50 , V_49 ) ;
if ( ! V_196 ) {
F_70 ( V_5 , V_210 ) ;
goto V_211;
}
F_102 ( V_50 ) -> V_174 = true ;
F_70 ( V_5 , V_212 ) ;
F_71 ( V_5 , V_213 ,
V_50 -> V_97 + V_98 ) ;
return F_132 ( V_50 , V_206 ) ;
V_211:
F_33 ( V_49 ) ;
return V_208 ;
}
...
int F_137 ( struct V_214 * V_215 , void * V_216 )
{
...
V_220 = F_143 ( L_13 , V_5 -> V_222 ) ;
if ( ! V_220 )
goto V_94;
V_221 = F_144 ( L_14 , V_223 | V_224 , V_220 ,
& V_5 -> V_7 . V_32 ) ;
if ( ! V_221 )
goto V_94;
V_221 = F_145 ( L_15 , V_223 | V_224 , V_220 ,
& V_5 -> V_7 . V_33 ) ;
if ( ! V_221 )
goto V_94;
V_221 = F_145 ( L_16 , V_223 | V_224 , V_220 ,
& V_5 -> V_7 . V_34 ) ;
if ( ! V_221 )
goto V_94;
return 0 ;
