...
if ( V_72 -> V_89 ) {
memcpy ( & V_2 -> V_90 , V_72 -> V_89 ,
sizeof( V_2 -> V_90 ) ) ;
V_2 -> V_91 = true ;
V_2 -> V_92 = F_37 ( V_70 , 1 ) ;
V_3 = F_35 ( V_2 -> V_92 , NULL ,
F_7 ,
V_88 ,
L_22 , V_2 ) ;
if ( V_3 < 0 ) {
...
if ( V_72 -> V_94 ) {
memcpy ( & V_2 -> V_95 , V_72 -> V_94 ,
sizeof( V_2 -> V_95 ) ) ;
V_2 -> V_96 = true ;
V_2 -> V_97 = F_37 ( V_70 , 2 ) ;
V_3 = F_35 ( V_2 -> V_97 , NULL ,
F_7 ,
V_88 ,
L_24 , V_2 ) ;
if ( V_3 < 0 ) {
...
if ( V_2 -> V_91 ) {
int V_123 ;
V_119 = V_2 -> V_90 . V_124 ;
V_118 |= V_125 ;
if ( V_2 -> V_90 . V_126 > 0 ) {
V_121 = V_2 -> V_90 . V_126 ;
V_123 = 0 ;
} else {
V_121 = V_2 -> V_90 . V_127 ;
V_123 = V_128 ;
}
V_3 = F_11 ( V_2 -> V_4 , V_5 ,
V_129 , V_121 & 0xFF ) ;
...
if ( V_2 -> V_96 ) {
int V_123 ;
V_120 = V_2 -> V_95 . V_124 ;
V_118 |= V_131 ;
if ( V_2 -> V_95 . V_126 > 0 ) {
V_121 = V_2 -> V_95 . V_126 ;
V_123 = 0 ;
} else {
V_121 = V_2 -> V_95 . V_127 ;
V_123 = V_132 ;
}
V_3 = F_11 ( V_2 -> V_4 , V_5 ,
V_133 , V_121 & 0xFF ) ;
...
static int F_49 ( struct V_136 * V_8 )
{
struct V_56 * V_57 = F_44 ( V_8 ) ;
struct V_1 * V_2 = F_22 ( V_57 ) ;
int V_137 = V_2 -> V_91 || V_2 -> V_96 ;
int V_3 ;
if ( ! F_50 ( V_8 ) || ! V_137 )
return 0 ;
V_3 = F_47 ( V_2 ) ;
...
static int F_52 ( struct V_136 * V_8 )
{
struct V_56 * V_57 = F_44 ( V_8 ) ;
struct V_1 * V_2 = F_22 ( V_57 ) ;
int V_137 = V_2 -> V_91 || V_2 -> V_96 ;
