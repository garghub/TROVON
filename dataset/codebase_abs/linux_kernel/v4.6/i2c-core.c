...
V_36 = F_191 ( V_40 , L_65 , & V_199 -> V_201 ) ;
if ( V_36 && V_200 )
V_199 -> V_201 = 100000 ;
V_36 = F_191 ( V_40 , L_66 , & V_199 -> V_202 ) ;
if ( V_36 && V_200 ) {
...
V_36 = F_191 ( V_40 , L_67 , & V_199 -> V_203 ) ;
if ( V_36 && V_200 ) {
...
F_191 ( V_40 , L_68 , & V_199 -> V_204 ) ;
V_36 = F_191 ( V_40 , L_69 , & V_199 -> V_205 ) ;
if ( V_36 && V_200 )
...
{
F_227 ( & V_47 -> V_40 , L_74 ,
V_228 , V_227 -> V_13 , V_227 -> V_60 ,
V_227 -> V_23 & V_62 ? L_75 : L_76 ) ;
return - V_124 ;
}
...
return F_226 ( V_47 , & V_56 [ V_116 ] , L_80 ) ;
} else {
...
( V_56 [ V_36 ] . V_23 & V_249 ) ? L_84 : L_85 ) ;
}
#endif
if ( F_238 () || F_239 () ) {
V_36 = F_108 ( V_47 ) ;
...
static T_4 F_253 ( T_4 V_270 , T_4 * V_271 , T_9 V_158 )
{
int V_116 ;
for ( V_116 = 0 ; V_116 < V_158 ; V_116 ++ )
V_270 = F_252 ( ( V_270 ^ V_271 [ V_116 ] ) << 8 ) ;
return V_270 ;
}
static T_4 F_254 ( T_4 V_272 , struct V_55 * V_227 )
{
T_4 V_13 = ( V_227 -> V_13 << 1 ) | ! ! ( V_227 -> V_23 & V_62 ) ;
V_272 = F_253 ( V_272 , & V_13 , 1 ) ;
return F_253 ( V_272 , V_227 -> V_61 , V_227 -> V_60 ) ;
}
...
static int F_256 ( T_4 V_273 , struct V_55 * V_227 )
{
T_4 V_274 = V_227 -> V_61 [ -- V_227 -> V_60 ] ;
V_273 = F_254 ( V_273 , V_227 ) ;
if ( V_274 != V_273 ) {
F_185 ( L_106 ,
V_274 , V_273 ) ;
return - V_275 ;
...
V_255 , 0 ,
V_261 , & V_4 ) ;
return ( V_12 < 0 ) ? V_12 : V_4 . V_276 ;
}
T_13 F_36 ( const struct V_51 * V_52 , T_4 V_277 )
{
return F_245 ( V_52 -> V_29 , V_52 -> V_13 , V_52 -> V_23 ,
V_258 , V_277 , V_261 , NULL ) ;
}
...
if ( V_12 )
return V_12 ;
memcpy ( V_280 , & V_4 . V_282 [ 1 ] , V_4 . V_282 [ 0 ] ) ;
return V_4 . V_282 [ 0 ] ;
}
T_13 F_42 ( const struct V_51 * V_52 , T_4 V_64 ,
T_4 V_77 , const T_4 * V_280 )
{
union V_251 V_4 ;
if ( V_77 > V_283 )
V_77 = V_283 ;
V_4 . V_282 [ 0 ] = V_77 ;
memcpy ( & V_4 . V_282 [ 1 ] , V_280 , V_77 ) ;
return F_245 ( V_52 -> V_29 , V_52 -> V_13 , V_52 -> V_23 ,
V_258 , V_64 ,
V_281 , & V_4 ) ;
}
...
unsigned short V_23 ,
char V_285 , T_4 V_64 , int V_286 ,
union V_251 * V_4 )
{
unsigned char V_287 [ V_283 + 3 ] ;
unsigned char V_288 [ V_283 + 2 ] ;
int V_229 = V_285 == V_255 ? 2 : 1 ;
int V_116 ;
T_4 V_289 = 0 ;
int V_12 ;
struct V_55 V_227 [ 2 ] = {
...
V_227 [ 0 ] . V_60 = V_4 -> V_282 [ 0 ] + 2 ;
if ( V_227 [ 0 ] . V_60 > V_283 + 2 ) {
F_21 ( & V_29 -> V_40 ,
L_107 ,
V_4 -> V_282 [ 0 ] ) ;
return - V_128 ;
...
V_287 [ V_116 ] = V_4 -> V_282 [ V_116 - 1 ] ;
}
break;
case V_291 :
V_229 = 2 ;
V_285 = V_255 ;
if ( V_4 -> V_282 [ 0 ] > V_283 ) {
F_21 ( & V_29 -> V_40 ,
L_107 ,
V_4 -> V_282 [ 0 ] ) ;
return - V_128 ;
...
case V_284 :
if ( V_285 == V_255 ) {
V_227 [ 1 ] . V_60 = V_4 -> V_282 [ 0 ] ;
} else {
V_227 [ 0 ] . V_60 = V_4 -> V_282 [ 0 ] + 1 ;
if ( V_227 [ 0 ] . V_60 > V_283 + 1 ) {
F_21 ( & V_29 -> V_40 ,
L_107 ,
V_4 -> V_282 [ 0 ] ) ;
return - V_128 ;
}
for ( V_116 = 1 ; V_116 <= V_4 -> V_282 [ 0 ] ; V_116 ++ )
V_287 [ V_116 ] = V_4 -> V_282 [ V_116 ] ;
}
break;
default:
F_21 ( & V_29 -> V_40 , L_108 , V_286 ) ;
return - V_124 ;
}
V_116 = ( ( V_23 & V_292 ) && V_286 != V_259
&& V_286 != V_284 ) ;
if ( V_116 ) {
...
V_12 = F_256 ( V_289 , & V_227 [ V_229 - 1 ] ) ;
if ( V_12 < 0 )
return V_12 ;
}
if ( V_285 == V_255 )
...
case V_278 :
case V_290 :
V_4 -> V_279 = V_288 [ 0 ] | ( V_288 [ 1 ] << 8 ) ;
break;
case V_284 :
for ( V_116 = 0 ; V_116 < V_4 -> V_282 [ 0 ] ; V_116 ++ )
V_4 -> V_282 [ V_116 + 1 ] = V_288 [ V_116 ] ;
break;
case V_281 :
case V_291 :
for ( V_116 = 0 ; V_116 < V_288 [ 0 ] + 1 ; V_116 ++ )
V_4 -> V_282 [ V_116 ] = V_288 [ V_116 ] ;
break;
}
return 0 ;
}
T_13 F_245 ( struct V_28 * V_29 , T_8 V_13 , unsigned short V_23 ,
char V_285 , T_4 V_64 , int V_293 ,
union V_251 * V_4 )
{
unsigned long V_244 ;
int V_245 ;
T_13 V_41 ;
F_260 ( V_29 , V_13 , V_23 , V_285 ,
V_64 , V_293 , V_4 ) ;
F_261 ( V_29 , V_13 , V_23 , V_285 ,
V_64 , V_293 ) ;
V_23 &= V_250 | V_292 | V_294 ;
if ( V_29 -> V_186 -> V_295 ) {
F_106 ( V_29 ) ;
V_244 = V_246 ;
for ( V_41 = 0 , V_245 = 0 ; V_245 <= V_29 -> V_247 ; V_245 ++ ) {
V_41 = V_29 -> V_186 -> V_295 ( V_29 , V_13 , V_23 ,
V_285 , V_64 ,
V_293 , V_4 ) ;
if ( V_41 != - V_184 )
break;
...
V_41 = F_259 ( V_29 , V_13 , V_23 , V_285 ,
V_64 , V_293 , V_4 ) ;
V_296:
F_262 ( V_29 , V_13 , V_23 , V_285 ,
V_64 , V_293 , V_4 ) ;
F_263 ( V_29 , V_13 , V_23 , V_285 ,
V_64 , V_293 , V_41 ) ;
return V_41 ;
}
T_13 F_264 ( const struct V_51 * V_52 ,
T_4 V_64 , T_4 V_77 , T_4 * V_280 )
{
T_4 V_116 = 0 ;
int V_12 ;
if ( V_77 > V_283 )
...
return F_257 ( V_52 , V_64 , V_77 , V_280 ) ;
if ( ! F_244 ( V_52 -> V_29 , V_254 ) )
return - V_124 ;
if ( F_244 ( V_52 -> V_29 , V_298 ) ) {
while ( ( V_116 + 2 ) <= V_77 ) {
V_12 = F_39 ( V_52 , V_64 + V_116 ) ;
if ( V_12 < 0 )
return V_12 ;
V_280 [ V_116 ] = V_12 & 0xff ;
V_280 [ V_116 + 1 ] = V_12 >> 8 ;
V_116 += 2 ;
}
}
while ( V_116 < V_77 ) {
...
int F_265 ( struct V_51 * V_52 , T_14 V_299 )
{
int V_36 ;
if ( ! V_52 || ! V_299 ) {
F_266 ( 1 , L_109 ) ;
...
if ( V_36 ) {
V_52 -> V_299 = NULL ;
F_21 ( & V_52 -> V_40 , L_113 , V_219 , V_36 ) ;
}
return V_36 ;
}
...
{
int V_36 ;
if ( ! V_52 -> V_29 -> V_186 -> V_301 ) {
F_21 ( & V_52 -> V_40 , L_112 , V_219 ) ;
return - V_124 ;
}
F_106 ( V_52 -> V_29 ) ;
V_36 = V_52 -> V_29 -> V_186 -> V_301 ( V_52 ) ;
F_110 ( V_52 -> V_29 ) ;
if ( V_36 == 0 )
V_52 -> V_299 = NULL ;
else
