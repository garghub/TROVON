...
static void F_18 ( T_1 * V_1 , void * V_2 , T_3 V_28 )
{
if ( V_1 -> V_24 == V_25 )
F_19 ( V_1 -> V_20 , V_2 , V_28 ) ;
if ( V_1 -> V_24 == V_26 )
F_20 ( V_2 , ( T_2 ) V_1 -> V_20 , V_28 ) ;
if ( V_1 -> V_24 == V_27 )
F_21 ( V_2 , ( unsigned long ) V_1 -> V_20 ) ;
}
static void F_22 ( T_1 * V_1 , void * V_2 )
{
F_23 ( V_1 -> V_6 >= V_1 -> V_29 ) ;
F_13 ( V_1 , V_2 ) ;
F_14 ( V_1 , V_2 ) ;
V_1 -> V_30 [ V_1 -> V_6 ++ ] = V_2 ;
}
static void * F_24 ( T_1 * V_1 , T_3 V_28 )
{
...
return;
while ( V_1 -> V_6 ) {
void * V_2 = F_24 ( V_1 , V_31 ) ;
V_1 -> free ( V_2 , V_1 -> V_20 ) ;
}
F_27 ( V_1 -> V_30 ) ;
F_27 ( V_1 ) ;
}
T_1 * F_28 ( int V_29 , T_4 * V_32 ,
T_5 * V_33 , void * V_20 )
{
return F_29 ( V_29 , V_32 , V_33 , V_20 ,
V_31 , V_34 ) ;
}
T_1 * F_29 ( int V_29 , T_4 * V_32 ,
T_5 * V_33 , void * V_20 ,
T_3 V_35 , int V_36 )
{
T_1 * V_1 ;
V_1 = F_30 ( sizeof( * V_1 ) , V_35 , V_36 ) ;
if ( ! V_1 )
return NULL ;
V_1 -> V_30 = F_31 ( V_29 * sizeof( void * ) ,
V_35 , V_36 ) ;
if ( ! V_1 -> V_30 ) {
F_27 ( V_1 ) ;
return NULL ;
...
F_37 ( & V_1 -> V_37 , V_28 ) ;
V_40 = F_38 ( V_39 , sizeof( * V_40 ) ,
V_31 ) ;
if ( ! V_40 )
return - V_42 ;
F_36 ( & V_1 -> V_37 , V_28 ) ;
if ( F_26 ( V_39 <= V_1 -> V_29 ) ) {
F_37 ( & V_1 -> V_37 , V_28 ) ;
F_27 ( V_40 ) ;
goto V_43;
}
...
return;
F_50 () ;
if ( F_26 ( V_1 -> V_6 < V_1 -> V_29 ) ) {
F_36 ( & V_1 -> V_37 , V_28 ) ;
if ( F_42 ( V_1 -> V_6 < V_1 -> V_29 ) ) {
F_22 ( V_1 , V_2 ) ;
F_37 ( & V_1 -> V_37 , V_28 ) ;
F_51 ( & V_1 -> V_38 ) ;
return;
