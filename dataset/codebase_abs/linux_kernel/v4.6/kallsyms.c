...
int V_35 = strlen ( V_30 ) - strlen ( V_29 [ V_8 ] ) ;
if ( V_35 >= 0 && strcmp ( V_30 + V_35 , V_29 [ V_8 ] ) == 0 )
return 0 ;
}
return 1 ;
}
...
{
if ( V_21 )
printf ( L_29 , V_21 , V_40 ) ;
else
printf ( L_30 , V_40 ) ;
printf ( L_31 ) ;
if ( V_21 )
printf ( L_32 , V_21 , V_40 ) ;
else
printf ( L_33 , V_40 ) ;
}
...
fprintf ( V_1 , L_15
L_43 ,
F_11 ( & V_38 [ V_8 ] ) ? L_44 : L_45 ,
V_38 [ V_8 ] . V_4 ) ;
exit ( V_25 ) ;
}
printf ( L_46 , ( int ) V_54 ) ;
} else if ( ! F_11 ( & V_38 [ V_8 ] ) ) {
...
printf ( L_49 , V_38 [ V_8 ] . V_4 ) ;
}
}
printf ( L_50 ) ;
if ( V_53 ) {
F_9 ( L_19 ) ;
printf ( L_48 , V_22 - V_57 ) ;
printf ( L_50 ) ;
}
F_9 ( L_20 ) ;
printf ( L_51 , V_36 ) ;
...
if ( ( V_8 & 0xFF ) == 0 )
V_51 [ V_8 >> 8 ] = V_49 ;
printf ( L_53 , V_38 [ V_8 ] . V_24 ) ;
for ( V_48 = 0 ; V_48 < V_38 [ V_8 ] . V_24 ; V_48 ++ )
printf ( L_54 , V_38 [ V_8 ] . V_3 [ V_48 ] ) ;
printf ( L_50 ) ;
...
return 0 ;
if ( ! memcmp ( V_61 + 2 , L_58 , 6 ) )
return 1 ;
if ( ! memcmp ( V_61 + 2 , L_59 , 5 ) )
return 1 ;
if ( ! memcmp ( V_61 + 2 , L_60 , 4 ) )
return 1 ;
if ( ! memcmp ( V_61 + V_24 - 6 , L_61 , 6 ) )
return 1 ;
if ( ! memcmp ( V_61 + V_24 - 4 , L_62 , 4 ) )
return 1 ;
return 0 ;
}
...
if( strcmp ( V_81 [ V_8 ] , L_63 ) == 0 )
V_32 = 1 ;
else if ( strcmp ( V_81 [ V_8 ] , L_64 ) == 0 )
V_56 = 1 ;
else if ( strncmp ( V_81 [ V_8 ] , L_65 , 16 ) == 0 ) {
char * V_82 = & V_81 [ V_8 ] [ 16 ] ;
if ( ( * V_82 == '"' && * ( V_82 + 2 ) == '"' ) || ( * V_82 == '\'' && * ( V_82 + 2 ) == '\'' ) )
V_82 ++ ;
V_21 = * V_82 ;
} else if ( strncmp ( V_81 [ V_8 ] , L_66 , 14 ) == 0 ) {
const char * V_82 = & V_81 [ V_8 ] [ 14 ] ;
V_31 = F_28 ( V_82 , NULL , 16 ) ;
} else if ( strcmp ( V_81 [ V_8 ] , L_67 ) == 0 )
V_53 = 1 ;
else
F_1 () ;
}
