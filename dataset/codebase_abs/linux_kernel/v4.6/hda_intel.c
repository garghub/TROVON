...
static int F_127 ( struct V_153 * V_116 )
{
...
static bool F_131 ( struct V_24 * V_25 )
{
bool V_163 = false ;
struct V_24 * V_143 = F_108 ( V_25 ) ;
if ( V_143 ) {
if ( F_132 ( V_143 ) == V_140 )
V_163 = true ;
F_109 ( V_143 ) ;
}
return V_163 ;
}
static int F_133 ( struct V_1 * V_2 , int V_164 )
{
...
static void F_135 ( struct V_1 * V_2 , int V_164 )
{
static T_2 V_178 [] = {
[ V_167 ] = NULL ,
[ V_168 ] = F_31 ,
...
static void F_136 ( struct V_1 * V_2 , int V_9 )
{
const struct V_165 * V_166 ;
V_2 -> V_179 = V_180 [ V_9 ] ;
if ( V_2 -> V_179 == - 1 ) {
V_166 = F_134 ( V_2 -> V_25 , V_181 ) ;
if ( V_166 ) {
F_32 ( V_2 -> V_33 -> V_9 ,
L_22 ,
V_166 -> V_173 , V_166 -> V_174 , V_166 -> V_175 ) ;
...
static void F_139 ( struct V_80 * V_81 )
{
...
static int F_141 ( struct V_117 * V_33 , struct V_24 * V_25 ,
...
V_2 -> V_205 = V_205 ;
F_145 ( & V_2 -> V_206 ) ;
F_146 ( & V_68 -> V_71 , F_42 ) ;
F_145 ( & V_68 -> V_107 ) ;
F_107 ( V_2 ) ;
F_147 ( & V_68 -> V_139 ) ;
F_135 ( V_2 , F_133 ( V_2 , V_207 [ V_9 ] ) ) ;
F_136 ( V_2 , V_9 ) ;
V_2 -> V_208 = V_208 ;
F_138 ( V_2 ) ;
if ( V_79 [ V_9 ] < 0 )
...
V_2 -> V_79 = V_79 [ V_9 ] ;
V_145 = F_148 ( V_2 , V_209 [ V_9 ] , & V_210 ) ;
if ( V_145 < 0 ) {
F_126 ( V_68 ) ;
F_122 ( V_25 ) ;
return V_145 ;
...
V_145 = F_149 ( V_33 , V_213 , V_2 , & V_197 ) ;
if ( V_145 < 0 ) {
F_54 ( V_33 -> V_9 , L_31 ) ;
F_113 ( V_2 ) ;
return V_145 ;
}
F_146 ( & V_68 -> V_191 , F_139 ) ;
* V_195 = V_2 ;
return 0 ;
}
...
#endif
V_145 = F_151 ( V_25 , L_32 ) ;
if ( V_145 < 0 )
return V_145 ;
V_2 -> V_151 = 1 ;
V_51 -> V_131 = F_152 ( V_25 , 0 ) ;
V_51 -> V_103 = F_153 ( V_25 , 0 ) ;
if ( V_51 -> V_103 == NULL ) {
F_54 ( V_33 -> V_9 , L_33 ) ;
return - V_220 ;
}
...
if ( ! ( V_214 & V_226 ) )
V_215 = 32 ;
if ( ! F_157 ( & V_25 -> V_9 , F_158 ( V_215 ) ) ) {
F_159 ( & V_25 -> V_9 , F_158 ( V_215 ) ) ;
} else {
F_157 ( & V_25 -> V_9 , F_158 ( 32 ) ) ;
F_159 ( & V_25 -> V_9 , F_158 ( 32 ) ) ;
}
...
F_162 ( V_33 -> V_247 , V_248 [ V_2 -> V_14 ] ,
sizeof( V_33 -> V_247 ) ) ;
...
static void F_163 ( const struct V_250 * V_152 , void * V_251 )
{
...
static void F_166 ( T_1 V_173 , T_1 T_5 * V_131 )
{
F_167 ( V_173 , V_131 ) ;
}
static T_1 F_168 ( T_1 T_5 * V_131 )
{
return F_169 ( V_131 ) ;
}
static void F_170 ( T_4 V_173 , T_4 T_5 * V_131 )
{
F_171 ( V_173 , V_131 ) ;
}
static T_4 F_172 ( T_4 T_5 * V_131 )
{
return F_61 ( V_131 ) ;
}
static void F_173 ( T_3 V_173 , T_3 T_5 * V_131 )
{
F_174 ( V_173 , V_131 ) ;
}
static T_3 F_175 ( T_3 T_5 * V_131 )
{
return F_176 ( V_131 ) ;
}
...
static int F_178 ( struct V_50 * V_51 ,
int type ,
T_6 V_252 ,
struct V_3 * V_19 )
{
struct V_1 * V_2 = F_179 ( V_51 ) ;
int V_145 ;
V_145 = F_180 ( type ,
V_51 -> V_9 ,
V_252 , V_19 ) ;
...
static void F_181 ( struct V_50 * V_51 , struct V_3 * V_19 )
{
struct V_1 * V_2 = F_179 ( V_51 ) ;
F_8 ( V_2 , V_19 , false ) ;
F_182 ( V_19 ) ;
...
T_6 V_252 )
{
struct V_20 * V_20 = F_184 ( V_22 ) ;
int V_113 ;
F_9 ( V_2 , V_20 , V_22 , false ) ;
V_113 = F_185 ( V_22 , V_252 ) ;
if ( V_113 < 0 )
return V_113 ;
...
{
#ifdef F_189
struct V_254 * V_255 = F_190 ( V_22 ) ;
struct V_1 * V_2 = V_255 -> V_2 ;
if ( ! F_2 ( V_2 ) && V_2 -> V_14 != V_15 )
V_7 -> V_256 = F_191 ( V_7 -> V_256 ) ;
#endif
}
static int F_192 ( struct V_24 * V_25 ,
...
V_145 = F_193 ( & V_25 -> V_9 , V_262 [ V_9 ] , V_263 [ V_9 ] , V_264 ,
0 , & V_33 ) ;
if ( V_145 < 0 ) {
F_54 ( & V_25 -> V_9 , L_41 ) ;
return V_145 ;
}
V_145 = F_141 ( V_33 , V_25 , V_9 , V_258 -> V_265 , & V_2 ) ;
if ( V_145 < 0 )
goto V_266;
V_33 -> V_13 = V_2 ;
V_68 = F_35 ( V_2 , struct V_67 , V_2 ) ;
...
F_32 ( V_33 -> V_9 , L_45 ,
V_267 [ V_9 ] ) ;
V_145 = F_194 ( V_264 , true , V_267 [ V_9 ] ,
& V_25 -> V_9 , V_200 , V_33 ,
F_163 ) ;
if ( V_145 < 0 )
goto V_266;
...
V_2 -> V_270 = V_270 [ V_9 ] ;
#endif
V_145 = F_199 ( V_2 , V_271 [ V_2 -> V_14 ] ) ;
if ( V_145 < 0 )
goto V_266;
#ifdef F_123
if ( V_2 -> V_152 ) {
V_145 = F_200 ( & V_2 -> V_51 , V_2 -> V_152 -> V_252 ,
V_2 -> V_152 -> V_29 ) ;
if ( V_145 < 0 )
goto V_266;
#ifndef F_201
