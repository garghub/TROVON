...
F_3 ( V_2 , V_84 , V_126 , 0 ) ;
V_2 -> V_127 = F_2 ( V_2 , V_84 , V_128 ) ;
if ( V_2 -> V_127 ) {
F_3 ( V_2 , V_84 , V_128 , ~ V_2 -> V_127 ) ;
F_38 ( V_2 -> V_129 , & V_2 -> V_130 ) ;
} else {
F_3 ( V_2 , V_84 , V_126 ,
V_131 ) ;
}
...
static void F_39 ( struct V_133 * V_134 )
{
struct V_1 * V_2 = F_40 ( V_134 ,
struct V_1 ,
V_130 ) ;
F_41 ( & V_2 -> V_135 ) ;
F_38 ( V_2 -> V_129 , & V_2 -> V_135 ) ;
}
static const char * F_42 ( enum V_87 V_89 )
{
switch ( V_89 ) {
case V_136 :
return L_10 ;
...
V_2 -> V_139 = V_93 ;
V_2 -> V_127 &= ~ V_143 ;
} else if ( V_2 -> V_127 & V_144 ) {
V_2 -> V_139 = V_109 ;
V_2 -> V_127 &= ~ V_144 ;
} else if ( V_2 -> V_127 & V_145 ) {
V_2 -> V_139 = V_137 ;
V_2 -> V_127 &= ~ V_145 ;
} else {
V_2 -> V_139 = V_120 ;
...
if ( V_2 -> V_139 == V_122 ) {
V_2 -> V_127 = 0 ;
F_3 ( V_2 , V_84 , V_128 , 0 ) ;
} else if ( V_2 -> V_139 == V_120 ) {
F_45 ( V_2 -> V_20 ,
L_21 ,
V_138 ) ;
V_2 -> V_127 = 0 ;
...
static const char * F_49 ( int V_76 )
{
switch ( V_76 ) {
case V_81 :
return L_28 ;
...
V_113 = F_55 ( V_2 ) ;
if ( V_113 )
F_56 ( V_169 , & V_2 -> V_166 ) ;
else
F_60 ( V_169 , & V_2 -> V_166 ) ;
F_46 ( & V_2 -> V_140 ) ;
return V_113 ;
}
static bool F_61 ( struct V_1 * V_2 )
{
return ( V_2 -> V_146 == V_137 ) ;
}
static void F_62 ( struct V_1 * V_2 )
{
unsigned long V_170 ;
V_170 = V_2 -> V_167 + ( V_171 * V_172 ) ;
if ( F_35 ( V_115 , V_170 ) ) {
...
return F_63 ( V_2 ) ;
V_2 -> V_71 . V_174 |= V_175 ;
V_2 -> V_71 . V_174 |= V_176 ;
V_90 = F_2 ( V_2 , V_84 , V_94 ) ;
V_91 = F_2 ( V_2 , V_84 , V_95 ) ;
if ( V_91 & 0x400 )
V_2 -> V_71 . V_174 |= V_151 ;
if ( V_91 & 0x800 )
V_2 -> V_71 . V_174 |= V_152 ;
if ( V_2 -> V_71 . V_159 ) {
V_2 -> V_71 . V_153 = 0 ;
V_2 -> V_71 . V_154 = 0 ;
if ( V_90 & V_91 & 0x400 ) {
...
V_91 = F_2 ( V_2 , V_84 , V_95 + 2 ) ;
if ( V_91 & 0xc000 )
V_2 -> V_71 . V_174 |= V_150 ;
V_2 -> V_71 . V_156 = V_157 ;
}
static void F_65 ( struct V_1 * V_2 )
{
unsigned int V_3 , V_177 ;
if ( F_66 ( V_169 , & V_2 -> V_166 ) ) {
F_67 ( V_2 -> V_20 ) ;
V_2 -> V_71 . V_19 = 0 ;
goto V_178;
}
V_177 = ( V_2 -> V_71 . V_72 == V_73 ) ;
V_3 = F_2 ( V_2 , V_7 , V_179 ) ;
V_3 = F_2 ( V_2 , V_7 , V_179 ) ;
V_2 -> V_71 . V_19 = ( V_3 & V_180 ) ? 1 : 0 ;
if ( V_2 -> V_71 . V_19 ) {
if ( V_177 && ! F_61 ( V_2 ) ) {
F_62 ( V_2 ) ;
return;
...
F_64 ( V_2 ) ;
if ( F_66 ( V_165 , & V_2 -> V_166 ) )
F_60 ( V_165 , & V_2 -> V_166 ) ;
F_68 ( V_2 -> V_20 ) ;
} else {
if ( F_66 ( V_165 , & V_2 -> V_166 ) ) {
F_62 ( V_2 ) ;
...
V_113 = F_72 ( V_2 -> V_181 , V_2 -> V_168 ,
F_37 , 0 , V_2 -> V_183 ,
V_2 ) ;
if ( V_113 ) {
F_45 ( V_20 , L_42 ) ;
...
F_76 ( V_181 , L_44 , V_8 ,
F_2 ( V_2 , V_7 , V_8 ) ) ;
F_76 ( V_181 , L_45 , V_179 ,
F_2 ( V_2 , V_7 , V_179 ) ) ;
F_76 ( V_181 , L_46 , V_189 ,
F_2 ( V_2 , V_7 , V_189 ) ) ;
F_76 ( V_181 , L_47 , V_190 ,
F_2 ( V_2 , V_7 , V_190 ) ) ;
F_76 ( V_181 , L_48 , V_191 ,
F_2 ( V_2 , V_7 , V_191 ) ) ;
F_76 ( V_181 , L_48 , V_192 ,
F_2 ( V_2 , V_7 , V_192 ) ) ;
F_76 ( V_181 , L_49 , V_8 ,
F_2 ( V_2 , V_84 , V_8 ) ) ;
F_76 ( V_181 , L_50 , V_179 ,
F_2 ( V_2 , V_84 , V_179 ) ) ;
F_76 ( V_181 , L_51 ,
V_94 ,
F_2 ( V_2 , V_84 , V_94 ) ) ;
