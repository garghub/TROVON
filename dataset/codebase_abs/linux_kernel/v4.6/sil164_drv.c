...
static int
F_27 ( struct V_1 * V_2 , const struct V_66 * V_67 )
{
...
F_32 ( L_5 , SIL164_I2C_ADDR_SLAVE)
} ;
if ( F_33 ( V_78 , & V_81 , 1 ) != 1 ) {
F_28 ( V_78 , L_6 ) ;
return NULL ;
}
return F_34 ( V_78 , & V_85 ) ;
}
static int
F_35 ( struct V_1 * V_2 ,
struct V_86 * V_87 ,
