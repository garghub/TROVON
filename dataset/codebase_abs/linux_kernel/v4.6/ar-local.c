...
F_13 ( L_17 ) ;
sin . V_79 = V_54 ;
sin . V_52 = F_57 ( V_68 ) -> V_80 ;
sin . V_51 . V_81 = F_58 ( V_68 ) -> V_82 ;
V_75 . V_83 = & sin ;
V_75 . V_84 = sizeof( sin ) ;
V_75 . V_85 = NULL ;
V_75 . V_86 = 0 ;
V_75 . V_87 = 0 ;
V_70 . V_88 = F_59 ( V_72 -> V_66 . V_88 ) ;
V_70 . V_89 = F_59 ( V_72 -> V_66 . V_89 ) ;
V_70 . V_90 = F_59 ( V_72 -> V_66 . V_90 ) ;
V_70 . V_91 = 0 ;
V_70 . V_92 = 0 ;
V_70 . type = V_93 ;
V_70 . V_94 = V_95 | ( ~ V_66 -> V_94 & V_96 ) ;
V_70 . V_97 = 0 ;
V_70 . V_98 = 0 ;
V_70 . V_99 = 0 ;
V_70 . V_100 = F_60 ( V_72 -> V_66 . V_100 ) ;
V_77 [ 0 ] . V_101 = & V_70 ;
V_77 [ 0 ] . V_102 = sizeof( V_70 ) ;
V_77 [ 1 ] . V_101 = ( char * ) V_103 ;
V_77 [ 1 ] . V_102 = sizeof( V_103 ) ;
V_78 = V_77 [ 0 ] . V_102 + V_77 [ 1 ] . V_102 ;
F_61 ( L_20 ) ;
V_26 = F_62 ( V_4 -> V_32 , & V_75 , V_77 , 2 , V_78 ) ;
if ( V_26 < 0 )
F_15 ( L_21 , V_26 ) ;
F_11 ( L_17 ) ;
}
...
F_13 ( L_17 ) ;
F_63 ( & V_4 -> V_22 ) ;
while ( ( V_68 = F_64 ( & V_4 -> V_19 ) ) ) {
struct V_71 * V_72 = F_56 ( V_68 ) ;
F_15 ( L_22 , V_4 -> V_23 , V_72 -> V_66 . type ) ;
switch ( V_72 -> V_66 . type ) {
case V_93 :
if ( F_65 ( V_68 , 0 , & V_104 , 1 ) < 0 )
return;
F_61 ( L_23 , V_104 ) ;
if ( V_104 == 0 )
F_55 ( V_4 , & V_72 -> V_66 , V_68 ) ;
break;
default:
break;
}
