...
if ( V_98 ) {
struct V_132 * V_133 ;
if ( V_98 -> V_13 . V_14 . V_134 != V_119 &&
V_98 -> V_13 . V_14 . V_134 != 0 )
goto V_47;
...
if ( F_119 ( V_87 , V_98 , & V_134 , & V_165 ) < 0 ) {
F_105 ( V_103 ) ;
goto V_170;
}
F_120 ( V_87 , V_119 ) ;
F_121 ( NULL , V_103 , V_87 , V_165 . V_15 , V_165 . V_16 , V_134 , V_141 , V_120 ,
...
if ( V_162 ) {
int V_168 = V_98 -> V_169 + sizeof( struct V_88 ) ;
V_4 -> V_197 = V_162 -> V_197 + sizeof( struct V_88 ) ;
...
static int
F_133 ( struct V_3 * V_4 , struct V_199 * V_200 , int V_201 )
{
int V_36 = 0 ;
struct V_22 V_77 ;
struct V_59 V_58 ;
...
#endif
if ( V_4 == V_11 -> V_29 ) {
if ( F_29 ( & V_77 , V_200 -> V_204 . V_205 , sizeof( V_77 ) ) ) {
V_36 = - V_68 ;
break;
}
V_9 = F_21 ( V_2 , & V_77 , 0 ) ;
...
if ( F_34 ( V_200 -> V_204 . V_205 , & V_77 ,
sizeof( V_77 ) ) )
goto V_206;
#ifdef F_13
} else {
...
if ( F_34 ( V_200 -> V_204 . V_205 , & V_30 ,
sizeof( V_30 ) ) )
goto V_206;
#endif
}
...
case V_208 :
V_36 = - V_209 ;
if ( ! F_134 ( V_2 -> V_210 , V_71 ) )
goto V_206;
V_36 = - V_68 ;
if ( F_29 ( & V_77 , V_200 -> V_204 . V_205 , sizeof( V_77 ) ) )
goto V_206;
V_36 = - V_78 ;
if ( V_77 . V_14 . V_134 != V_119 &&
V_77 . V_14 . V_134 != V_146 &&
V_77 . V_14 . V_134 != 0 )
goto V_206;
if ( V_77 . V_14 . V_211 != 4 ||
V_77 . V_14 . V_100 != 5 || ( V_77 . V_14 . V_160 & F_81 ( ~ V_212 ) ) )
goto V_206;
if ( V_77 . V_14 . V_120 )
V_77 . V_14 . V_160 |= F_81 ( V_212 ) ;
V_9 = F_21 ( V_2 , & V_77 , V_201 == V_207 ) ;
if ( V_4 != V_11 -> V_29 && V_201 == V_208 ) {
if ( V_9 ) {
if ( V_9 -> V_4 != V_4 ) {
V_36 = - V_79 ;
break;
...
if ( V_9 ) {
V_36 = 0 ;
if ( F_34 ( V_200 -> V_204 . V_205 , & V_9 -> V_13 , sizeof( V_77 ) ) )
V_36 = - V_68 ;
} else
V_36 = ( V_201 == V_207 ? - V_81 : - V_117 ) ;
break;
case V_213 :
V_36 = - V_209 ;
if ( ! F_134 ( V_2 -> V_210 , V_71 ) )
...
if ( V_4 == V_11 -> V_29 )
goto V_206;
V_36 = F_28 ( V_9 , V_200 -> V_204 . V_205 ) ;
break;
case V_215 :
case V_216 :
case V_217 :
...
goto V_206;
V_36 = - V_68 ;
if ( F_29 ( & V_58 , V_200 -> V_204 . V_205 , sizeof( V_58 ) ) )
goto V_206;
switch ( V_201 ) {
case V_216 :
V_36 = F_43 ( V_9 , & V_58 ) ;
...
case V_215 :
case V_217 :
V_36 = F_37 ( V_9 , & V_58 , V_201 == V_217 ) ;
break;
}
F_52 ( & V_9 -> V_99 ) ;
F_129 ( V_4 ) ;
...
goto V_206;
V_36 = - V_68 ;
if ( F_29 ( & V_30 , V_200 -> V_204 . V_205 ,
sizeof( V_30 ) ) )
goto V_206;
if ( V_201 != V_220 ) {
V_36 = F_130 ( V_9 , & V_30 ) ;
...
static int F_136 ( struct V_3 * V_4 , int V_221 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
int V_168 = V_98 -> V_169 + sizeof( struct V_88 ) ;
if ( V_221 < V_184 || V_221 > 0xFFF8 - V_168 )
return - V_78 ;
V_4 -> V_166 = V_221 ;
return 0 ;
}
...
V_4 -> V_224 = F_25 ;
V_4 -> type = V_225 ;
V_4 -> V_197 = V_226 + V_168 ;
V_4 -> V_166 = V_227 - V_168 ;
V_4 -> V_19 = V_228 ;
F_140 ( V_4 ) ;
V_4 -> V_229 = 4 ;
V_4 -> V_230 |= V_231 ;
...
static int F_145 ( struct V_234 * V_235 [] , struct V_234 * V_101 [] )
{
T_6 V_150 ;
if ( ! V_101 || ! V_101 [ V_236 ] )
return 0 ;
V_150 = F_146 ( V_101 [ V_236 ] ) ;
if ( V_150 != V_119 &&
V_150 != V_146 &&
V_150 != 0 )
return - V_78 ;
...
static void F_147 ( struct V_234 * V_101 [] ,
struct V_22 * V_13 )
{
memset ( V_13 , 0 , sizeof( * V_13 ) ) ;
V_13 -> V_14 . V_211 = 4 ;
V_13 -> V_14 . V_134 = V_119 ;
V_13 -> V_14 . V_100 = 5 ;
V_13 -> V_14 . V_120 = 64 ;
if ( ! V_101 )
return;
if ( V_101 [ V_237 ] )
V_13 -> V_17 = F_148 ( V_101 [ V_237 ] ) ;
if ( V_101 [ V_238 ] )
V_13 -> V_14 . V_15 = F_149 ( V_101 [ V_238 ] ) ;
if ( V_101 [ V_239 ] )
V_13 -> V_14 . V_16 = F_149 ( V_101 [ V_239 ] ) ;
if ( V_101 [ V_240 ] ) {
V_13 -> V_14 . V_120 = F_146 ( V_101 [ V_240 ] ) ;
if ( V_13 -> V_14 . V_120 )
V_13 -> V_14 . V_160 = F_81 ( V_212 ) ;
}
if ( V_101 [ V_241 ] )
V_13 -> V_14 . V_141 = F_146 ( V_101 [ V_241 ] ) ;
if ( ! V_101 [ V_242 ] || F_146 ( V_101 [ V_242 ] ) )
V_13 -> V_14 . V_160 = F_81 ( V_212 ) ;
if ( V_101 [ V_243 ] )
V_13 -> V_41 = F_150 ( V_101 [ V_243 ] ) ;
if ( V_101 [ V_236 ] )
V_13 -> V_14 . V_134 = F_146 ( V_101 [ V_236 ] ) ;
}
static bool F_151 ( struct V_234 * V_101 [] ,
struct F_119 * V_244 )
{
bool V_67 = false ;
...
if ( V_101 [ V_245 ] ) {
V_67 = true ;
V_244 -> type = F_152 ( V_101 [ V_245 ] ) ;
}
if ( V_101 [ V_246 ] ) {
V_67 = true ;
V_244 -> V_19 = F_152 ( V_101 [ V_246 ] ) ;
}
if ( V_101 [ V_247 ] ) {
V_67 = true ;
V_244 -> V_248 = F_150 ( V_101 [ V_247 ] ) ;
}
if ( V_101 [ V_249 ] ) {
V_67 = true ;
V_244 -> V_250 = F_150 ( V_101 [ V_249 ] ) ;
}
return V_67 ;
}
static bool F_153 ( struct V_234 * V_101 [] ,
struct V_198 * V_30 )
{
bool V_67 = false ;
...
static int F_155 ( struct V_2 * V_255 , struct V_3 * V_4 ,
struct V_234 * V_235 [] , struct V_234 * V_101 [] )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_1 * V_49 ;
struct F_119 V_244 ;
...
int V_36 ;
V_49 = F_14 ( V_4 ) ;
if ( F_151 ( V_101 , & V_244 ) ) {
V_36 = F_156 ( V_49 , & V_244 ) ;
if ( V_36 < 0 )
return V_36 ;
}
...
static int F_157 ( struct V_3 * V_4 , struct V_234 * V_235 [] ,
struct V_234 * V_101 [] )
{
struct V_1 * V_9 = F_14 ( V_4 ) ;
struct V_22 V_77 ;
...
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
struct V_22 * V_256 = & V_98 -> V_13 ;
if ( F_161 ( V_87 , V_237 , V_256 -> V_17 ) ||
F_162 ( V_87 , V_238 , V_256 -> V_14 . V_15 ) ||
F_162 ( V_87 , V_239 , V_256 -> V_14 . V_16 ) ||
F_163 ( V_87 , V_240 , V_256 -> V_14 . V_120 ) ||
F_163 ( V_87 , V_241 , V_256 -> V_14 . V_141 ) ||
F_163 ( V_87 , V_242 ,
! ! ( V_256 -> V_14 . V_160 & F_81 ( V_212 ) ) ) ||
F_163 ( V_87 , V_236 , V_256 -> V_14 . V_134 ) ||
F_164 ( V_87 , V_243 , V_256 -> V_41 ) )
goto V_257;
#ifdef F_13
if ( F_165 ( V_87 , V_251 ,
& V_98 -> V_30 . V_31 ) ||
...
static void F_167 ( struct V_3 * V_4 , struct V_260 * V_83 )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
if ( V_4 != V_11 -> V_29 )
...
V_11 -> V_25 [ 1 ] = V_11 -> V_263 ;
V_11 -> V_25 [ 2 ] = V_11 -> V_264 ;
V_11 -> V_25 [ 3 ] = V_11 -> V_265 ;
...
if ( V_36 < 0 )
return V_36 ;
V_36 = F_186 ( & V_270 , V_271 ) ;
if ( V_36 < 0 ) {
F_184 ( L_8 , V_275 ) ;
goto V_276;
}
V_36 = F_186 ( & V_272 , V_273 ) ;
if ( V_36 < 0 ) {
F_184 ( L_9 , V_275 ) ;
goto V_277;
}
