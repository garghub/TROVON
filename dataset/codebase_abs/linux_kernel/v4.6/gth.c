...
V_51 = F_27 ( V_2 -> V_17 , V_52 , sizeof( void * ) , V_54 ) ;
if ( ! V_51 )
return - V_55 ;
V_49 = F_27 ( V_2 -> V_17 , V_52 ,
sizeof( struct V_21 ) ,
V_54 ) ;
if ( ! V_49 )
return - V_55 ;
...
char * V_56 ;
V_56 = F_28 ( V_2 -> V_17 , V_54 , L_3 , V_37 ,
V_37 == V_53 ? L_4 : L_5 ) ;
if ( ! V_56 )
return - V_55 ;
...
V_2 -> V_62 . V_56 = L_6 ;
V_2 -> V_62 . V_51 = V_51 ;
return F_30 ( & V_2 -> V_17 -> V_63 , & V_2 -> V_62 ) ;
}
...
char * V_56 ;
V_56 = F_28 ( V_2 -> V_17 , V_54 , L_7 , V_37 ,
V_34 [ V_65 ] . V_56 ) ;
if ( ! V_56 )
return - V_55 ;
...
V_64 [ V_68 ] . V_19 . V_61 = F_24 ;
}
F_29 ( & V_64 [ V_68 ] . V_19 . V_19 ) ;
...
V_2 -> V_71 . V_56 = L_8 ;
V_2 -> V_71 . V_51 = V_51 ;
return F_30 ( & V_2 -> V_17 -> V_63 , & V_2 -> V_71 ) ;
}
static void F_33 ( struct V_72 * V_73 ,
struct V_74 * V_29 )
{
struct V_1 * V_2 = F_34 ( & V_73 -> V_17 ) ;
unsigned long V_23 ;
int V_13 ;
T_1 V_5 ;
F_10 ( & V_2 -> V_24 ) ;
...
if ( V_2 -> V_29 [ V_37 ] . V_83 != V_80 -> V_29 . type )
continue;
...
static int
F_42 ( struct V_72 * V_73 , unsigned int V_13 )
{
struct V_1 * V_2 = F_34 ( & V_73 -> V_17 ) ;
int V_3 = 0 ;
if ( V_13 > V_53 )
...
void T_4 * V_10 ;
int V_37 , V_88 ;
V_87 = F_44 ( V_73 , V_89 , 0 ) ;
if ( ! V_87 )
return - V_31 ;
V_10 = F_45 ( V_17 , V_87 -> V_90 , F_46 ( V_87 ) ) ;
if ( ! V_10 )
return - V_55 ;
V_2 = F_47 ( V_17 , sizeof( * V_2 ) , V_54 ) ;
if ( ! V_2 )
return - V_55 ;
V_2 -> V_17 = V_17 ;
V_2 -> V_10 = V_10 ;
