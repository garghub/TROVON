...
V_6 -> V_65 = F_117 ( V_6 -> V_75 -> V_76 ) ;
if ( F_118 ( V_6 -> V_65 ) )
return F_119 ( V_6 -> V_65 ) ;
V_39 = F_120 ( & V_6 -> V_6 . V_28 , 1 , & V_6 -> V_25 ) ;
if ( V_39 < 0 ) {
F_121 ( V_6 -> V_65 ) ;
return V_39 ;
}
...
int F_128 ( struct V_5 * V_6 , struct V_241 * V_242 )
{
int V_39 ;
V_6 -> V_6 . V_243 = V_242 ;
V_39 = F_129 ( & V_6 -> V_6 , V_236 , - 1 ) ;
if ( V_39 < 0 )
F_130 ( V_6 -> V_75 -> V_76 ,
L_10 ,
V_244 , V_39 ) ;
