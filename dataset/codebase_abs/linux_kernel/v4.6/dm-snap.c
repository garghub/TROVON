...
{
V_13 -> V_178 = V_3 -> V_5 -> V_29 ;
V_13 -> V_179 . V_180 =
F_3 ( V_3 -> V_7 , F_73 ( V_68 -> V_80 ) +
( V_8 - V_68 -> V_69 ) ) +
( V_13 -> V_179 . V_180 & V_3 -> V_7 -> V_181 ) ;
}
...
V_8 = F_160 ( V_3 -> V_7 , V_13 -> V_179 . V_180 ) ;
if ( ! V_3 -> V_108 )
return - V_158 ;
F_46 ( & V_3 -> V_46 ) ;
if ( ! V_3 -> V_108 || ( F_102 ( V_3 -> V_132 ) && F_161 ( V_13 ) == V_184 ) ) {
V_54 = - V_158 ;
goto V_185;
}
...
{
struct V_2 * V_3 = V_45 -> V_144 ;
struct V_2 * V_39 = NULL , * V_40 = NULL , * V_190 = NULL ;
struct V_36 * V_33 ;
...
if ( V_33 )
V_192 = F_170 ( V_33 -> V_45 -> V_61 ) ;
if ( ! V_192 ) {
( void ) F_39 ( V_3 , NULL , NULL , & V_190 ) ;
if ( V_190 )
V_192 = F_170 ( V_190 -> V_45 -> V_61 ) ;
}
if ( V_192 == F_170 ( V_45 -> V_61 ) )
V_192 = NULL ;
if ( V_192 ) {
if ( F_171 ( V_192 ) )
V_192 = NULL ;
...
if ( V_192 ) {
F_172 ( V_192 ) ;
if ( V_190 && F_101 ( V_90 , & V_190 -> V_91 ) ) {
V_193 = true ;
F_109 ( V_190 ) ;
}
}
...
struct V_2 * V_3 = V_45 -> V_144 ;
F_169 ( V_45 ) ;
V_45 -> V_153 = F_176 ( V_3 -> V_4 -> V_29 ) ;
F_107 ( V_3 ) ;
}
static void F_178 ( struct V_116 * V_45 , T_8 type ,
unsigned V_196 , char * V_197 , unsigned V_198 )
{
unsigned V_199 = 0 ;
...
if ( V_38 -> V_7 -> type -> V_201 ) {
T_1 V_202 , V_203 ,
V_204 ;
V_38 -> V_7 -> type -> V_201 ( V_38 -> V_7 ,
& V_202 ,
& V_203 ,
& V_204 ) ;
F_179 ( L_42 ,
...
break;
case V_205 :
F_179 ( L_44 , V_38 -> V_4 -> V_206 , V_38 -> V_5 -> V_206 ) ;
V_38 -> V_7 -> type -> V_207 ( V_38 -> V_7 , type , V_197 + V_199 ,
V_198 - V_199 ) ;
break;
}
}
static int F_180 ( struct V_116 * V_45 ,
T_9 V_208 , void * V_209 )
{
struct V_2 * V_38 = V_45 -> V_144 ;
int V_54 ;
V_54 = V_208 ( V_45 , V_38 -> V_4 , 0 , V_45 -> V_210 , V_209 ) ;
if ( ! V_54 )
V_54 = V_208 ( V_45 , V_38 -> V_5 , 0 , F_81 ( V_38 -> V_5 -> V_29 ) , V_209 ) ;
return V_54 ;
}
...
V_33 = F_31 ( V_4 -> V_29 ) ;
if ( V_33 )
V_54 = F_181 ( & V_33 -> V_55 , V_13 -> V_179 . V_180 , V_13 ) ;
F_42 ( & V_28 ) ;
return V_54 ;
}
static int F_103 ( struct V_2 * V_214 ,
...
struct V_4 * V_33 ;
F_41 ( & V_28 ) ;
V_33 = F_31 ( V_214 -> V_4 -> V_29 ) ;
for ( V_154 = 0 ; V_154 < V_58 ; V_154 += V_214 -> V_45 -> V_153 )
if ( F_181 ( & V_33 -> V_55 , V_110 + V_154 , NULL ) ==
V_186 )
V_215 = 1 ;
F_42 ( & V_28 ) ;
return V_215 ;
...
struct V_36 * V_33 = V_45 -> V_144 ;
unsigned V_218 ;
V_13 -> V_178 = V_33 -> V_37 -> V_29 ;
if ( F_102 ( V_13 -> V_182 & V_183 ) )
return V_156 ;
if ( F_161 ( V_13 ) != V_184 )
return V_156 ;
V_218 = V_33 -> V_219 -
( ( unsigned ) V_13 -> V_179 . V_180 & ( V_33 -> V_219 - 1 ) ) ;
if ( F_186 ( V_13 ) > V_218 )
F_187 ( V_13 , V_218 ) ;
...
{
struct V_36 * V_33 = V_45 -> V_144 ;
V_33 -> V_219 = F_176 ( V_33 -> V_37 -> V_29 ) ;
F_46 ( & V_28 ) ;
F_36 ( V_33 ) ;
F_47 ( & V_28 ) ;
}
...
static void F_190 ( struct V_116 * V_45 , T_8 type ,
unsigned V_196 , char * V_197 , unsigned V_198 )
{
struct V_36 * V_33 = V_45 -> V_144 ;
switch ( type ) {
...
break;
case V_205 :
snprintf ( V_197 , V_198 , L_48 , V_33 -> V_37 -> V_206 ) ;
break;
}
}
...
{
struct V_36 * V_33 = V_45 -> V_144 ;
return V_208 ( V_45 , V_33 -> V_37 , 0 , V_45 -> V_210 , V_209 ) ;
}
