...
V_28 += F_7 ( V_23 + V_28 , V_34 , L_3 , V_1 -> V_30 ) ;
...
static void F_44 ( struct V_1 * V_1 , struct V_72 * V_72 )
{
enum V_21 V_85 [] = {
V_7 ,
V_12 ,
...
int F_45 ( struct V_1 * V_1 , struct V_72 * V_72 )
{
...
void F_46 ( struct V_1 * V_1 V_90 )
{
F_43 ( & V_84 ) ;
}
bool F_47 ( struct V_1 * V_1 , enum V_91 V_92 )
{
T_3 V_93 = 1 << V_92 ;
...
struct V_98 * V_99 = F_49 ( V_96 ) ;
F_42 ( & V_1 -> V_100 ) ;
while ( V_99 ) {
struct V_101 * V_97 ;
V_97 = F_50 ( V_99 , struct V_101 , V_98 ) ;
V_99 = F_51 ( & V_97 -> V_98 ) ;
F_52 ( & V_97 -> V_98 , V_96 ) ;
free ( V_97 ) ;
}
...
static struct V_101 * F_53 ( struct V_1 * V_1 , T_4 V_102 )
{
...
T_4 V_105 ;
V_104 = * V_103 ;
V_97 = F_50 ( V_104 , struct V_101 , V_98 ) ;
...
static struct V_101 *
F_54 ( struct V_1 * V_1 , struct V_101 * V_109 )
{
struct V_95 * V_96 = & V_1 -> V_62 . V_97 ;
...
F_55 ( & V_109 -> V_98 , V_104 , V_103 ) ;
F_56 ( & V_109 -> V_98 , V_96 ) ;
V_97 = NULL ;
V_86:
F_43 ( & V_1 -> V_100 ) ;
return V_97 ;
...
static T_5
F_57 ( struct V_101 * V_97 , T_4 V_102 ,
T_6 * V_62 , T_4 V_24 )
{
T_4 V_110 = V_102 - V_97 -> V_102 ;
T_4 V_111 = F_58 ( V_97 -> V_24 - V_110 , V_24 ) ;
memcpy ( V_62 , V_97 -> V_62 + V_110 , V_111 ) ;
return V_111 ;
}
static T_5
F_59 ( struct V_1 * V_1 , struct V_72 * V_72 ,
...
V_110 = V_102 & V_113 ;
V_27 = F_61 ( V_1 -> V_62 . V_66 , V_97 -> V_62 , V_106 , V_110 ) ;
if ( V_27 <= 0 )
break;
V_97 -> V_102 = V_110 ;
V_97 -> V_24 = V_27 ;
...
V_27 = F_57 ( V_97 , V_102 , V_62 , V_24 ) ;
}
if ( V_27 <= 0 )
free ( V_97 ) ;
return V_27 ;
...
V_97 = F_53 ( V_1 , V_102 ) ;
if ( V_97 )
return F_57 ( V_97 , V_102 , V_62 , V_24 ) ;
else
return F_59 ( V_1 , V_72 , V_102 , V_62 , V_24 ) ;
}
...
do {
T_5 V_27 ;
V_27 = F_62 ( V_1 , V_72 , V_102 , V_103 , V_24 ) ;
if ( V_27 < 0 )
return V_27 ;
if ( ! V_27 )
break;
...
static int F_65 ( struct V_1 * V_1 , struct V_72 * V_72 )
{
int V_27 = 0 ;
struct V_115 V_116 ;
char V_67 [ V_68 ] ;
...
T_7 F_67 ( struct V_1 * V_1 , struct V_72 * V_72 )
{
if ( F_65 ( V_1 , V_72 ) )
return - 1 ;
return V_1 -> V_62 . V_76 ;
}
static T_5 F_68 ( struct V_1 * V_1 , struct V_72 * V_72 ,
T_4 V_102 , T_6 * V_62 , T_5 V_24 )
{
if ( F_65 ( V_1 , V_72 ) )
return - 1 ;
...
if ( V_102 + V_24 < V_102 )
return - 1 ;
return F_63 ( V_1 , V_72 , V_102 , V_62 , V_24 ) ;
}
T_5 F_69 ( struct V_1 * V_1 , struct V_72 * V_72 ,
T_4 V_102 , T_6 * V_62 , T_5 V_24 )
{
if ( V_1 -> V_62 . V_87 == V_89 )
return - 1 ;
...
T_5 F_70 ( struct V_1 * V_1 , struct V_118 * V_118 ,
struct V_72 * V_72 , T_4 V_119 ,
T_6 * V_62 , T_5 V_24 )
{
T_4 V_102 = V_118 -> V_120 ( V_118 , V_119 ) ;
return F_69 ( V_1 , V_72 , V_102 , V_62 , V_24 ) ;
}
struct V_118 * F_71 ( const char * V_58 )
{
struct V_118 * V_118 = NULL ;
struct V_1 * V_1 = F_72 ( V_58 ) ;
if ( V_1 )
V_118 = F_73 ( 0 , V_1 , V_121 ) ;
return V_118 ;
}
struct V_1 * F_74 ( struct V_72 * V_72 , const char * V_58 ,
const char * V_122 , int V_123 )
{
struct V_1 * V_1 = F_75 ( V_72 , V_58 ) ;
if ( V_1 != NULL ) {
F_76 ( V_1 , V_122 , false ) ;
V_1 -> V_124 = V_123 ;
}
return V_1 ;
}
static struct V_1 * F_77 ( struct V_95 * V_96 ,
...
V_58 = V_1 -> V_30 ;
while ( * V_103 ) {
struct V_1 * V_125 = F_50 ( * V_103 , struct V_1 , V_98 ) ;
...
if ( V_1 ) {
F_55 ( & V_1 -> V_98 , V_104 , V_103 ) ;
F_56 ( & V_1 -> V_98 , V_96 ) ;
V_1 -> V_96 = V_96 ;
}
return NULL ;
}
static inline struct V_1 * F_78 ( struct V_95 * V_96 ,
const char * V_58 )
{
return F_77 ( V_96 , NULL , V_58 ) ;
}
void F_79 ( struct V_1 * V_1 , const char * V_58 , bool V_127 )
{
...
void F_76 ( struct V_1 * V_1 , const char * V_58 , bool V_127 )
{
if ( V_58 == NULL )
return;
if ( V_1 -> V_129 )
...
{
char * V_131 , * V_132 = F_19 ( V_1 -> V_30 ) ;
if ( ! V_132 )
return;
V_131 = F_19 ( F_82 ( V_132 ) ) ;
free ( V_132 ) ;
if ( ! V_131 )
return;
F_76 ( V_1 , V_131 , true ) ;
}
int F_83 ( const struct V_1 * V_1 )
{
if ( ! V_1 )
return strlen ( L_21 ) ;
if ( V_133 )
...
bool F_85 ( const struct V_1 * V_1 , enum V_134 type )
{
return V_1 -> V_136 & ( 1 << type ) ;
}
void F_86 ( struct V_1 * V_1 , enum V_134 type )
{
V_1 -> V_136 |= ( 1 << type ) ;
}
struct V_1 * F_72 ( const char * V_58 )
{
struct V_1 * V_1 = calloc ( 1 , sizeof( * V_1 ) + strlen ( V_58 ) + 1 ) ;
if ( V_1 != NULL ) {
int V_41 ;
strcpy ( V_1 -> V_58 , V_58 ) ;
F_79 ( V_1 , V_1 -> V_58 , false ) ;
F_76 ( V_1 , V_1 -> V_58 , false ) ;
...
struct V_1 * F_97 ( struct V_1 * V_1 )
{
if ( V_1 )
F_98 ( & V_1 -> V_150 ) ;
return V_1 ;
...
{
if ( V_1 && F_100 ( & V_1 -> V_150 ) )
F_90 ( V_1 ) ;
}
void F_101 ( struct V_1 * V_1 , void * V_37 )
{
memcpy ( V_1 -> V_37 , V_37 , sizeof( V_1 -> V_37 ) ) ;
V_1 -> V_36 = 1 ;
}
bool F_102 ( const struct V_1 * V_1 , T_6 * V_37 )
{
return memcmp ( V_1 -> V_37 , V_37 , sizeof( V_1 -> V_37 ) ) == 0 ;
}
void F_103 ( struct V_1 * V_1 , struct V_72 * V_72 )
{
char V_55 [ V_73 ] ;
if ( F_104 ( V_72 ) )
return;
sprintf ( V_55 , L_23 , V_72 -> V_22 ) ;
if ( F_105 ( V_55 , V_1 -> V_37 ,
sizeof( V_1 -> V_37 ) ) == 0 )
V_1 -> V_36 = true ;
}
...
if ( F_105 ( V_23 , V_1 -> V_37 ,
sizeof( V_1 -> V_37 ) ) == 0 )
V_1 -> V_36 = true ;
return 0 ;
}
bool F_107 ( struct V_153 * V_154 , bool V_155 )
{
bool V_156 = false ;
struct V_1 * V_157 ;
F_108 (pos, head, node) {
...
if ( F_109 ( V_157 -> V_30 , V_157 -> V_37 ,
sizeof( V_157 -> V_37 ) ) > 0 ) {
V_156 = true ;
V_157 -> V_36 = true ;
}
...
{
F_23 ( & V_1 -> V_149 , & V_159 -> V_154 ) ;
F_77 ( & V_159 -> V_96 , V_1 , NULL ) ;
F_97 ( V_1 ) ;
}
void F_111 ( struct V_159 * V_159 , struct V_1 * V_1 )
{
F_112 ( & V_159 -> V_100 ) ;
F_110 ( V_159 , V_1 ) ;
F_113 ( & V_159 -> V_100 ) ;
...
struct V_1 * V_157 ;
if ( V_160 ) {
F_108 (pos, &dsos->head, node)
if ( strcmp ( V_157 -> V_122 , V_58 ) == 0 )
return V_157 ;
return NULL ;
}
return F_78 ( & V_159 -> V_96 , V_58 ) ;
}
struct V_1 * F_115 ( struct V_159 * V_159 , const char * V_58 , bool V_160 )
{
struct V_1 * V_1 ;
F_116 ( & V_159 -> V_100 ) ;
V_1 = F_114 ( V_159 , V_58 , V_160 ) ;
F_113 ( & V_159 -> V_100 ) ;
return V_1 ;
}
...
{
struct V_1 * V_1 = F_114 ( V_159 , V_58 , false ) ;
return V_1 ? V_1 : F_117 ( V_159 , V_58 ) ;
}
struct V_1 * F_119 ( struct V_159 * V_159 , const char * V_58 )
{
struct V_1 * V_1 ;
F_112 ( & V_159 -> V_100 ) ;
V_1 = F_97 ( F_118 ( V_159 , V_58 ) ) ;
F_113 ( & V_159 -> V_100 ) ;
return V_1 ;
}
T_1 F_120 ( struct V_153 * V_154 , T_8 * V_161 ,
bool (F_121)( struct V_1 * V_1 , int V_162 ) , int V_162 )
{
struct V_1 * V_157 ;
T_1 V_27 = 0 ;
F_108 (pos, head, node) {
if ( F_121 && F_121 ( V_157 , V_162 ) )
continue;
V_27 += F_122 ( V_157 , V_161 ) ;
V_27 += fprintf ( V_161 , L_25 , V_157 -> V_30 ) ;
}
return V_27 ;
}
T_1 F_123 ( struct V_153 * V_154 , T_8 * V_161 )
{
struct V_1 * V_157 ;
T_1 V_27 = 0 ;
F_108 (pos, head, node) {
int V_41 ;
for ( V_41 = 0 ; V_41 < V_137 ; ++ V_41 )
V_27 += F_124 ( V_157 , V_41 , V_161 ) ;
}
return V_27 ;
}
T_1 F_122 ( struct V_1 * V_1 , T_8 * V_161 )
{
char V_163 [ V_26 * 2 + 1 ] ;
F_8 ( V_1 -> V_37 , sizeof( V_1 -> V_37 ) , V_163 ) ;
return fprintf ( V_161 , L_3 , V_163 ) ;
}
T_1 F_124 ( struct V_1 * V_1 , enum V_134 type , T_8 * V_161 )
{
struct V_98 * V_164 ;
...
F_84 ( V_1 , type ) ? L_4 : L_29 ) ;
V_27 += F_122 ( V_1 , V_161 ) ;
V_27 += fprintf ( V_161 , L_30 ) ;
for ( V_164 = F_49 ( & V_1 -> V_138 [ type ] ) ; V_164 ; V_164 = F_51 ( V_164 ) ) {
struct V_166 * V_157 = F_50 ( V_164 , struct V_166 , V_98 ) ;
V_27 += F_125 ( V_157 , V_161 ) ;
}
return V_27 ;
}
enum V_123 F_126 ( struct V_1 * V_1 , struct V_72 * V_72 )
{
int V_66 ;
...
int F_128 ( struct V_1 * V_1 , char * V_168 , T_1 V_169 )
{
...
F_64 ( V_169 == 0 ) ;
if ( V_171 >= 0 ) {
const char * V_174 = F_29 ( V_171 , V_168 , V_169 ) ;
if ( V_174 != V_168 )
F_7 ( V_168 , V_169 , L_3 , V_174 ) ;
return 0 ;
}
if ( V_171 < V_175 || V_171 >= V_176 )
return - 1 ;
V_170 = V_171 - V_175 ;
F_7 ( V_168 , V_169 , L_3 , V_173 [ V_170 ] ) ;
return 0 ;
}
