...
if ( F_43 ( V_29 -> V_33 ) ) {
V_2 -> V_22 ++ ;
V_26 = V_2 -> V_4 . V_71 ( V_2 -> V_4 . V_19 ) ;
if ( V_26 ) {
F_37 ( V_29 -> V_33 ) ;
V_2 -> V_22 -- ;
} else {
...
int F_47 ( struct V_66 * V_66 , struct V_67 * V_67 )
{
...
unsigned int F_51 ( struct V_67 * V_67 , T_1 * V_73 )
{
struct V_1 * V_2 = V_55 [ F_40 ( F_52 ( V_67 ) ) ] ;
unsigned int V_72 ;
if ( ! V_2 ) {
F_25 ( V_41 L_34 , V_44 ) ;
return V_74 ;
...
V_2 -> V_4 . V_9 , V_2 -> V_4 . V_5 , V_72 ) ;
return V_72 ;
}
long F_55 ( struct V_67 * V_67 , unsigned int V_77 , unsigned long V_78 )
{
T_2 V_79 ;
int V_80 = 0 ;
struct V_1 * V_2 = V_55 [ F_40 ( F_52 ( V_67 ) ) ] ;
...
switch ( V_77 ) {
case V_81 :
V_80 = F_56 ( V_2 -> V_4 . V_59 , ( T_2 V_82 * ) V_78 ) ;
break;
case V_83 :
...
V_80 = F_58 ( V_79 , ( T_2 V_82 * ) V_78 ) ;
if ( ! V_80 && ! ( F_59 ( V_79 ) & V_2 -> V_4 . V_59 ) )
V_80 = - V_45 ;
break;
case V_87 :
V_80 = F_56 ( V_2 -> V_4 . V_47 , ( T_2 V_82 * ) V_78 ) ;
break;
case V_88 :
...
V_80 = F_56 ( V_2 -> V_4 . V_90 , ( T_2 V_82 * ) V_78 ) ;
break;
case V_91 :
if ( ! ( V_2 -> V_4 . V_59 & V_89 ) ||
V_2 -> V_4 . V_92 == 0 ) {
...
V_80 = F_56 ( V_2 -> V_4 . V_92 , ( T_2 V_82 * ) V_78 ) ;
break;
default:
V_80 = - V_45 ;
}
F_4 ( V_2 -> V_4 . V_7 , V_8 L_41 ,
V_2 -> V_4 . V_9 , V_2 -> V_4 . V_5 , V_80 ) ;
F_34 ( & V_2 -> V_3 ) ;
return V_80 ;
}
T_3 F_60 ( struct V_67 * V_67 ,
char V_82 * V_93 ,
T_4 V_94 ,
T_5 * V_95 )
{
...
F_62 ( & V_2 -> V_12 -> V_25 , & V_73 ) ;
F_13 ( V_24 ) ;
while ( V_96 < V_94 && V_72 == 0 ) {
if ( F_54 ( V_2 -> V_12 ) ) {
if ( V_96 )
break;
if ( V_67 -> V_100 & V_101 ) {
...
F_65 ( V_2 -> V_12 , V_12 ) ;
V_72 = F_66 ( ( void V_82 * ) V_93 + V_96 , V_12 ,
V_2 -> V_12 -> V_38 ) ;
if ( ! V_72 )
V_96 += V_2 -> V_12 -> V_38 ;
else
...
V_2 -> V_4 . V_9 , V_2 -> V_4 . V_5 , V_72 ? L_44 : L_45 , V_72 ) ;
return V_72 ? V_72 : V_96 ;
}
void * F_67 ( struct V_67 * V_67 )
{
return V_55 [ F_40 ( F_52 ( V_67 ) ) ] -> V_4 . V_19 ;
}
T_3 F_68 ( struct V_67 * V_67 , const char V_82 * V_93 ,
T_4 V_94 , T_5 * V_95 )
{
struct V_1 * V_2 = V_55 [ F_40 ( F_52 ( V_67 ) ) ] ;
if ( ! V_2 ) {
