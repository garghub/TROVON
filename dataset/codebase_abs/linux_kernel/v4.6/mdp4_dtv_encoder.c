...
F_34 ( V_69 ) |
F_35 ( 0x21 ) ) ;
F_36 ( V_3 -> V_68 , V_70 , 1 ) ;
F_11 ( V_9 , 1 ) ;
F_8 ( L_8 , V_66 ) ;
V_67 = F_37 ( V_9 -> V_63 , V_66 ) ;
if ( V_67 )
...
long F_39 ( struct V_2 * V_3 , unsigned long V_71 )
{
struct V_9 * V_9 = F_14 ( V_3 ) ;
return F_40 ( V_9 -> V_63 , V_71 ) ;
}
