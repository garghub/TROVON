...
{
struct V_5 * V_104 = & V_2 -> V_7 ;
struct V_59 * V_60 = & V_2 -> V_61 ;
struct V_105 * V_106 = & V_2 -> V_94 ;
struct V_107 * V_108 = & V_2 -> V_100 ;
V_60 -> V_109 = V_104 -> V_19 ;
V_60 -> V_110 = V_104 -> V_20 ;
V_60 -> V_20 = V_104 -> V_20 ;
V_60 -> V_111 = V_104 -> V_111 ;
V_60 -> V_112 = V_104 -> V_21 ;
V_106 -> V_113 = 1 ;
{
int V_114 ;
struct V_115 * V_116 = & V_106 -> V_117 ;
V_116 -> V_46 = false ;
for ( V_114 = 0 ; V_114 < 16 ; V_114 ++ )
V_116 -> V_118 [ V_114 ] = false ;
}
V_108 -> V_119 = V_104 -> V_35 ;
V_108 -> V_120 = V_104 -> V_36 ;
V_108 -> V_121 = V_88 ;
F_23 ( V_2 ) ;
F_24 ( V_2 ) ;
return V_89 ;
...
static void F_48 ( struct V_1 * V_2 , int V_125 )
{
T_1 V_126 = 0xf4000500 ;
if ( V_125 ) {
V_126 |= 0x200 ;
}
F_49 ( V_2 , V_126 ) ;
