...
T_2 F_43 ( struct V_131 T_4 * V_132 , T_1 V_96 )
{
V_13 . V_133 = false ;
if ( ! V_132 )
return V_134 ;
...
return V_137 ;
V_123 -> V_138 = V_46 ;
V_123 -> V_139 = F_5 ( V_123 -> V_138 ) ;
if ( V_123 -> V_139 >= V_9 )
return V_140 ;
F_38 ( V_123 , V_76 / 2 ) ;
F_22 ( V_123 -> V_124 , type , V_65 ,
V_123 -> V_139 , V_123 -> V_138 , 0 , false ) ;
return V_129 ;
}
T_3 F_47 ( T_3 V_85 )
{
...
T_3 V_141 )
{
return F_46 ( V_123 , V_143 , V_65 , V_76 ,
V_141 ) ;
}
...
if ( ! F_26 ( V_47 ) )
return V_144 ;
V_123 -> V_138 = V_47 * V_80 ;
V_123 -> V_139 = F_5 ( V_123 -> V_138 ) ;
if ( V_123 -> V_139 >= V_9 )
return V_140 ;
F_36 ( V_123 , V_76 / 2 , V_47 ) ;
F_22 ( V_123 -> V_124 , V_145 , V_65 , V_123 -> V_139 ,
V_123 -> V_138 , V_47 , false ) ;
return V_129 ;
}
...
if ( ! F_27 ( V_82 ) )
return V_144 ;
V_123 -> V_138 = V_82 * V_84 ;
V_123 -> V_139 = F_5 ( V_123 -> V_138 ) ;
if ( V_123 -> V_139 >= V_9 )
return V_140 ;
F_37 ( V_123 , V_76 / 2 , V_82 ) ;
F_22 ( V_123 -> V_124 , V_146 , V_65 ,
V_123 -> V_139 , V_123 -> V_138 , 0 , true ) ;
return V_129 ;
}
...
F_23 ( V_123 -> V_124 ) ;
if ( V_123 -> V_139 < V_9 )
F_6 ( V_123 -> V_139 , V_123 -> V_138 ) ;
V_123 -> V_139 = V_9 ;
return V_129 ;
}
void F_55 ( struct V_122 * const * V_147 )
{
bool V_148 ;
if ( ! V_13 . V_133 ) {
F_2 ( V_136 ,
...
do {
struct V_122 * const * V_123 = V_147 ;
V_148 = false ;
while ( * V_123 ) {
V_148 |= F_39 ( * V_123 ) ;
++ V_123 ;
...
struct V_151 * F_57 ( struct V_122 * V_123 ,
struct V_151 * V_152 )
{
if ( ! V_123 || ! V_152 )
return NULL ;
V_152 -> V_153 = V_123 -> V_70 . V_75 < 2 ;
V_152 -> V_154 = V_123 -> V_125 ;
return V_152 ;
}
bool F_58 ( struct V_122 * V_123 , T_1 V_155 ,
T_3 V_59 )
{
if ( ! V_123 )
return F_2 ( V_136 ,
L_9 ) ;
return F_40 ( V_123 , V_155 , V_59 ) ;
}
