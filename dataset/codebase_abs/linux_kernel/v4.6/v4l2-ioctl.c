...
V_19 -> V_178 . V_11 = 1 ;
if ( V_277 -> V_560 )
return V_277 -> V_560 ( V_272 , V_306 , V_19 ) ;
return 0 ;
}
...
if ( ! F_126 ( V_566 ) )
return - V_567 ;
if ( V_19 -> V_201 . type == V_568 ) {
if ( V_275 -> V_561 == NULL )
return - V_291 ;
F_127 (sd, vfd->v4l2_dev)
if ( V_19 -> V_201 . V_203 == V_565 ++ )
return F_128 ( V_564 , V_569 , V_570 , V_19 ) ;
return - V_291 ;
}
if ( V_277 -> V_571 && V_19 -> V_201 . type == V_572 &&
( V_277 -> V_573 || V_19 -> V_201 . V_203 == 0 ) )
...
F_127 (sd, vfd->v4l2_dev)
if ( V_19 -> V_201 . V_203 == V_565 ++ )
return F_128 ( V_564 , V_569 , V_574 , V_19 ) ;
return - V_291 ;
}
if ( V_277 -> V_575 && V_19 -> V_201 . type == V_572 &&
( V_277 -> V_573 || V_19 -> V_201 . V_203 == 0 ) )
return V_277 -> V_575 ( V_272 , V_306 , V_19 ) ;
return - V_291 ;
#else
return - V_319 ;
#endif
...
if ( V_277 -> V_571 )
V_19 -> V_39 |= V_577 ;
F_5 ( V_19 -> V_14 , V_275 -> V_561 -> V_14 , sizeof( V_19 -> V_14 ) ) ;
if ( V_277 -> V_573 )
return V_277 -> V_573 ( V_272 , V_306 , V_16 ) ;
if ( V_19 -> V_201 . V_203 )
return - V_291 ;
return 0 ;
case V_568 :
...
if ( V_19 -> V_201 . V_203 != V_565 ++ )
continue;
if ( V_564 -> V_277 -> V_569 && V_564 -> V_277 -> V_569 -> V_574 )
V_19 -> V_39 |= V_576 ;
if ( V_564 -> V_277 -> V_569 && V_564 -> V_277 -> V_569 -> V_570 )
V_19 -> V_39 |= V_577 ;
F_5 ( V_19 -> V_14 , V_564 -> V_14 , sizeof( V_19 -> V_14 ) ) ;
return 0 ;
}
break;
}
...
struct V_272 * V_272 , void * V_306 , void * V_16 )
{
return F_132 ( V_306 , V_16 , V_272 -> V_578 & V_579 ) ;
}
static int F_133 ( const struct V_276 * V_277 ,
struct V_272 * V_272 , void * V_306 , void * V_16 )
{
return V_277 -> V_580 ( V_306 , V_16 ) ;
}
...
return V_277 -> V_582 ( V_272 , V_306 , V_19 ) ;
}
...
if ( V_277 -> V_583 ) {
V_501 = V_277 -> V_583 ( V_272 , V_306 , V_19 ) ;
if ( V_501 != - V_319 )
return V_501 ;
}
if ( F_75 ( V_275 , V_584 ) ) {
...
if ( V_19 -> V_27 )
return - V_291 ;
V_501 = V_277 -> V_505 ( V_272 , V_306 , & V_585 ) ;
if ( V_501 )
return V_501 ;
V_19 -> V_35 = V_585 . V_35 | V_506 ;
V_19 -> V_103 = V_585 . V_103 ;
V_19 -> V_104 = V_585 . V_104 ;
...
{
if ( F_138 ( V_193 ) >= V_589 )
return false ;
return V_590 [ F_138 ( V_193 ) ] . V_591 == V_193 ;
}
struct V_592 * F_139 ( struct V_274 * V_593 , unsigned V_193 )
{
if ( F_138 ( V_193 ) >= V_589 )
return V_593 -> V_594 ;
if ( F_72 ( F_138 ( V_193 ) , V_593 -> V_595 ) )
return NULL ;
if ( V_593 -> V_596 && V_593 -> V_596 -> V_594 &&
( V_590 [ F_138 ( V_193 ) ] . V_39 & V_597 ) )
return V_593 -> V_596 -> V_594 ;
return V_593 -> V_594 ;
}
void F_140 ( const char * V_598 , unsigned int V_193 )
{
const char * V_599 , * type ;
if ( V_598 )
F_15 ( V_72 L_266 , V_598 ) ;
switch ( F_141 ( V_193 ) ) {
case 'd' :
type = L_267 ;
break;
...
F_7 ( L_269 , V_590 [ F_138 ( V_193 ) ] . V_14 ) ;
return;
default:
type = L_270 ;
break;
...
switch ( F_142 ( V_193 ) ) {
case V_600 : V_599 = L_271 ; break;
case V_601 : V_599 = L_272 ; break;
case V_602 : V_599 = L_273 ; break;
case V_601 | V_602 : V_599 = L_274 ; break;
default: V_599 = L_275 ; break;
}
F_7 ( L_276 ,
type , F_141 ( V_193 ) , V_599 , F_138 ( V_193 ) , V_193 ) ;
}
...
bool V_17 = false ;
struct V_603 V_604 ;
const struct V_603 * V_605 ;
void * V_306 = V_272 -> V_320 ;
struct V_316 * V_317 = NULL ;
int V_606 = V_275 -> V_606 ;
long V_308 = - V_319 ;
if ( V_277 == NULL ) {
F_144 ( L_277 ,
F_145 ( V_275 ) ) ;
...
V_317 = V_272 -> V_320 ;
if ( F_137 ( V_193 ) ) {
V_605 = & V_590 [ F_138 ( V_193 ) ] ;
if ( ! F_72 ( F_138 ( V_193 ) , V_275 -> V_607 ) &&
! ( ( V_605 -> V_39 & V_608 ) && V_317 && V_317 -> V_538 ) )
goto V_609;
if ( V_317 && ( V_605 -> V_39 & V_610 ) ) {
...
V_17 = F_142 ( V_193 ) == V_602 ;
if ( V_605 -> V_39 & V_612 ) {
typedef int (* F_147)( struct V_272 * V_272 , void * V_306 , void * V_19 );
const void * V_19 = V_275 -> V_278 ;
const F_147 * V_613 = V_19 + V_605 -> V_251 . V_87 ;
V_308 = (* V_613)( V_272 , V_306 , V_16 ) ;
} else if ( V_605 -> V_39 & V_614 ) {
V_308 = V_605 -> V_251 . V_615 ( V_277 , V_272 , V_306 , V_16 ) ;
} else if ( ! V_277 -> V_616 ) {
V_308 = - V_319 ;
} else {
V_308 = V_277 -> V_616 ( V_272 , V_306 ,
V_317 ? F_146 ( V_275 -> V_315 , V_317 -> V_315 ) >= 0 : 0 ,
V_193 , V_16 ) ;
}
V_609:
if ( V_606 & ( V_617 | V_618 ) ) {
if ( ! ( V_606 & V_619 ) &&
( V_193 == V_620 || V_193 == V_621 ) )
return V_308 ;
...
if ( ! ( V_606 & V_618 ) )
F_7 ( L_47 ) ;
else if ( F_142 ( V_193 ) == V_600 )
V_605 -> V_611 ( V_16 , V_17 ) ;
else {
F_7 ( L_279 ) ;
V_605 -> V_611 ( V_16 , V_17 ) ;
}
...
static int F_148 ( unsigned int V_193 , void * V_622 , T_4 * V_623 ,
void T_3 * * V_624 , void * * * V_625 )
{
int V_308 = 0 ;
switch ( V_193 ) {
case V_626 :
...
case V_620 :
case V_621 : {
struct V_118 * V_628 = V_622 ;
if ( F_26 ( V_628 -> type ) && V_628 -> V_130 > 0 ) {
if ( V_628 -> V_130 > V_629 ) {
V_308 = - V_291 ;
break;
}
* V_624 = ( void T_3 * ) V_628 -> V_128 . V_129 ;
* V_625 = ( void * * ) & V_628 -> V_128 . V_129 ;
* V_623 = sizeof( struct V_122 ) * V_628 -> V_130 ;
V_308 = 1 ;
}
break;
}
case V_630 :
case V_631 : {
struct V_264 * V_632 = V_622 ;
if ( V_632 -> V_267 ) {
if ( V_632 -> V_267 > 256 ) {
V_308 = - V_291 ;
break;
}
* V_624 = ( void T_3 * ) V_632 -> V_632 ;
* V_625 = ( void * * ) & V_632 -> V_632 ;
* V_623 = V_632 -> V_267 * 128 ;
V_308 = 1 ;
}
break;
}
...
case V_634 :
case V_635 : {
struct V_170 * V_542 = V_622 ;
if ( V_542 -> V_91 != 0 ) {
if ( V_542 -> V_91 > V_636 ) {
V_308 = - V_291 ;
break;
}
* V_624 = ( void T_3 * ) V_542 -> V_173 ;
* V_625 = ( void * * ) & V_542 -> V_173 ;
* V_623 = sizeof( struct V_543 )
* V_542 -> V_91 ;
V_308 = 1 ;
}
break;
...
char V_637 [ 128 ] ;
void * V_638 = NULL ;
void * V_622 = ( void * ) V_16 ;
long V_501 = - V_291 ;
bool V_639 ;
T_4 V_623 = 0 ;
void T_3 * V_624 = NULL ;
void * * V_625 = NULL ;
if ( F_142 ( V_193 ) != V_600 ) {
if ( F_150 ( V_193 ) <= sizeof( V_637 ) ) {
V_622 = V_637 ;
} else {
V_638 = F_151 ( F_150 ( V_193 ) , V_640 ) ;
if ( NULL == V_638 )
return - V_641 ;
V_622 = V_638 ;
}
V_501 = - V_642 ;
if ( F_142 ( V_193 ) & V_602 ) {
unsigned int V_643 = F_150 ( V_193 ) ;
if ( F_137 ( V_193 ) ) {
T_2 V_39 = V_590 [ F_138 ( V_193 ) ] . V_39 ;
if ( V_39 & V_644 )
V_643 = ( V_39 & V_644 ) >> 16 ;
}
if ( F_152 ( V_622 , ( void T_3 * ) V_16 , V_643 ) )
goto V_645;
if ( V_643 < F_150 ( V_193 ) )
memset ( ( V_646 * ) V_622 + V_643 , 0 , F_150 ( V_193 ) - V_643 ) ;
} else {
memset ( V_622 , 0 , F_150 ( V_193 ) ) ;
}
}
V_501 = F_148 ( V_193 , V_622 , & V_623 , & V_624 , & V_625 ) ;
if ( V_501 < 0 )
goto V_645;
V_639 = V_501 ;
if ( V_639 ) {
V_638 = F_151 ( V_623 , V_640 ) ;
V_501 = - V_641 ;
if ( NULL == V_638 )
goto V_647;
V_501 = - V_642 ;
if ( F_152 ( V_638 , V_624 , V_623 ) )
goto V_647;
* V_625 = V_638 ;
}
V_501 = V_615 ( V_272 , V_193 , V_622 ) ;
if ( V_501 == - V_648 )
V_501 = - V_319 ;
if ( V_501 == 0 ) {
if ( V_193 == V_621 )
F_153 ( F_61 ( V_272 ) -> V_649 , V_622 ) ;
else if ( V_193 == V_620 )
F_154 ( F_61 ( V_272 ) -> V_649 , V_622 ) ;
}
if ( V_639 ) {
* V_625 = ( void V_650 * ) V_624 ;
if ( F_155 ( V_624 , V_638 , V_623 ) )
V_501 = - V_642 ;
goto V_647;
}
...
case V_601 :
case ( V_602 | V_601 ) :
if ( F_155 ( ( void T_3 * ) V_16 , V_622 , F_150 ( V_193 ) ) )
V_501 = - V_642 ;
break;
}
V_645:
