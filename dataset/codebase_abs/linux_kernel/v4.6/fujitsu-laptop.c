...
V_101 = 0 ;
while ( F_1 ( V_109 , 0x1 , 0x0 , 0x0 ) != 0
&& ( V_101 ++ ) < V_110 )
;
F_4 ( V_91 , L_41 , V_101 ) ;
V_14 -> V_55 =
F_1 ( V_111 , 0x0 , 0x0 , 0x0 ) ;
if ( V_14 -> V_55 == V_112 )
V_14 -> V_55 = 0 ;
if ( V_14 -> V_55 )
V_14 -> V_56 =
F_1 ( V_111 , 0x4 , 0x0 , 0x0 ) ;
F_26 ( L_42 , F_1 ( V_109 , 0x0 , 0x0 , 0x0 ) ) ;
#if F_53 ( V_113 ) || F_53 ( V_114 )
if ( F_1 ( V_24 , 0x0 , 0x0 , 0x0 ) & V_25 ) {
V_100 = F_54 ( & V_35 -> V_115 -> V_50 ,
& V_116 ) ;
if ( V_100 == 0 ) {
V_14 -> V_117 = 1 ;
} else {
...
V_35 -> V_115 = F_65 ( L_50 , - 1 ) ;
if ( ! V_35 -> V_115 ) {
V_43 = - V_74 ;
goto V_137;
}
V_43 = F_66 ( V_35 -> V_115 ) ;
if ( V_43 )
goto V_138;
V_43 =
F_67 ( & V_35 -> V_115 -> V_50 . V_139 ,
& V_140 ) ;
if ( V_43 )
goto V_141;
if ( F_68 () == V_142 ) {
struct V_143 V_44 ;
memset ( & V_44 , 0 , sizeof( struct V_143 ) ) ;
V_36 = V_35 -> V_36 ;
V_44 . type = V_144 ;
V_44 . V_36 = V_36 - 1 ;
V_35 -> V_145 = F_69 ( L_50 ,
NULL , NULL ,
& V_146 ,
& V_44 ) ;
if ( F_70 ( V_35 -> V_145 ) ) {
V_43 = F_71 ( V_35 -> V_145 ) ;
V_35 -> V_145 = NULL ;
goto V_147;
}
V_35 -> V_145 -> V_44 . V_22 = V_35 -> V_39 ;
}
V_43 = F_72 ( & V_148 ) ;
if ( V_43 )
goto V_149;
V_14 = F_62 ( sizeof( struct V_120 ) , V_106 ) ;
if ( ! V_14 ) {
V_43 = - V_74 ;
goto V_150;
}
...
V_35 -> V_145 -> V_44 . V_45 = V_46 ;
else
V_35 -> V_145 -> V_44 . V_45 = V_153 ;
}
F_26 ( L_51 V_154 L_52 ) ;
return 0 ;
V_152:
F_73 ( V_14 ) ;
V_150:
