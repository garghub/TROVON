...
if ( V_388 != NULL ) {
F_47 ( V_2 , V_388 -> V_390 ) ;
V_389 = 1 ;
}
V_270 -> V_382 |= V_391 ;
}
if ( V_2 -> V_283 == V_284 ) {
V_388 = F_69 ( & V_2 -> V_392 ) ;
if ( V_388 != NULL )
F_45 ( V_2 , V_388 -> V_390 ) ;
V_270 -> V_382 |= V_393 ;
}
switch ( V_2 -> V_382 ) {
case V_394 :
...
return V_477 ;
F_100 ( V_410 , NULL ) ;
V_2 -> V_392 . type = V_400 ;
V_2 -> V_392 . V_496 = & V_499 ;
V_2 -> V_392 . V_6 = F_2 ( V_2 ) ;
V_2 -> V_392 . V_500 = F_118 ( 4096 * 4096 ) * 2 * 3 ;
V_2 -> V_392 . V_501 = 64 ;
