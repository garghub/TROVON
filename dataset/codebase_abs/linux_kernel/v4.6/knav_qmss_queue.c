...
F_60 ( ( T_3 ) V_106 -> V_114 , & V_140 -> V_151 ) ;
...
if ( V_158 [ 0 ] ) {
V_160 -> V_96 = ( T_5 ) V_158 [ 0 ] ;
V_160 -> V_119 = NULL ;
V_160 -> V_97 = V_158 [ 1 ] ;
} else {
V_160 -> V_97 = V_158 [ 1 ] ;
V_160 -> V_119 = F_115 ( V_24 -> V_25 ,
8 * V_160 -> V_97 , & V_160 -> V_96 ,
V_39 ) ;
if ( ! V_160 -> V_119 ) {
F_77 ( V_24 -> V_25 , L_33 ) ;
return - V_40 ;
...
V_160 = & V_24 -> V_164 [ 0 ] ;
F_74 ( V_24 -> V_25 , L_34 ,
& V_160 -> V_96 , V_160 -> V_119 , V_160 -> V_97 ) ;
F_60 ( ( T_3 ) V_160 -> V_96 , & V_41 -> V_165 -> V_166 ) ;
F_60 ( V_160 -> V_97 , & V_41 -> V_165 -> V_167 ) ;
V_160 ++ ;
if ( ! V_160 -> V_97 )
continue;
F_74 ( V_24 -> V_25 , L_35 ,
& V_160 -> V_96 , V_160 -> V_119 , V_160 -> V_97 ) ;
F_60 ( V_160 -> V_96 , & V_41 -> V_165 -> V_168 ) ;
}
return 0 ;
}
...
struct V_13 * V_14 ;
struct V_141 * V_41 ;
T_3 V_158 [ 2 ] , V_169 , V_81 , V_16 , V_110 ;
int V_19 , V_107 ;
...
void T_4 * V_140 ;
int V_19 ;
V_19 = F_130 ( V_125 , V_110 , & V_183 ) ;
if ( V_19 ) {
F_77 ( V_24 -> V_25 , L_47 ,
V_125 -> V_38 , V_110 ) ;
return F_27 ( V_19 ) ;
}
V_140 = F_131 ( V_24 -> V_25 , & V_183 ) ;
if ( F_132 ( V_140 ) )
F_77 ( V_24 -> V_25 , L_48 ,
V_110 , V_125 -> V_38 ) ;
return V_140 ;
...
F_129 ( V_24 , V_157 ,
V_191 ) ;
if ( F_132 ( V_41 -> V_45 ) || F_132 ( V_41 -> V_186 ) ||
F_132 ( V_41 -> V_165 ) || F_132 ( V_41 -> V_150 ) ||
F_132 ( V_41 -> V_43 ) || F_132 ( V_41 -> V_44 ) ) {
F_77 ( V_25 , L_53 ) ;
if ( ! F_132 ( V_41 -> V_45 ) )
F_135 ( V_25 , V_41 -> V_45 ) ;
if ( ! F_132 ( V_41 -> V_186 ) )
F_135 ( V_25 , V_41 -> V_186 ) ;
if ( ! F_132 ( V_41 -> V_165 ) )
F_135 ( V_25 , V_41 -> V_165 ) ;
if ( ! F_132 ( V_41 -> V_150 ) )
...
F_129 ( V_24 , V_157 ,
V_201 ) ;
if ( F_132 ( V_194 -> V_200 ) || F_132 ( V_194 -> V_195 ) ||
F_132 ( V_194 -> V_140 ) || F_132 ( V_194 -> V_198 ) ) {
F_77 ( V_25 , L_56 ,
V_194 -> V_38 ) ;
if ( ! F_132 ( V_194 -> V_200 ) )
F_135 ( V_25 , V_194 -> V_200 ) ;
if ( ! F_132 ( V_194 -> V_195 ) )
F_135 ( V_25 , V_194 -> V_195 ) ;
if ( ! F_132 ( V_194 -> V_140 ) )
F_135 ( V_25 , V_194 -> V_140 ) ;
if ( ! F_132 ( V_194 -> V_198 ) )
F_135 ( V_25 , V_194 -> V_198 ) ;
F_29 ( V_25 , V_194 ) ;
continue;
}
F_109 ( V_157 , L_26 , & V_194 -> V_16 ) ;
F_82 ( & V_194 -> V_49 , & V_24 -> V_192 ) ;
F_74 ( V_25 , L_57 ,
V_194 -> V_38 , V_194 -> V_200 , V_194 -> V_195 , V_194 -> V_140 ,
V_194 -> V_198 ) ;
}
return 0 ;
}
...
T_3 V_82 , V_80 = 1000 ;
int V_19 ;
V_82 = F_47 ( & V_194 -> V_140 -> V_202 ) & ~ V_203 ;
F_60 ( V_82 , & V_194 -> V_140 -> V_202 ) ;
V_19 = F_54 ( & V_194 -> V_140 -> V_202 , V_80 ,
V_204 ) ;
if ( V_19 < 0 ) {
F_77 ( V_24 -> V_25 , L_58 , V_194 -> V_38 ) ;
return V_19 ;
}
V_194 -> V_205 = false ;
V_194 -> V_206 = false ;
...
bool V_210 = false ;
T_3 * V_211 ;
for ( V_107 = 0 ; V_107 < F_139 ( V_212 ) ; V_107 ++ ) {
if ( V_212 [ V_107 ] ) {
V_19 = F_140 ( & V_209 ,
V_212 [ V_107 ] ,
V_24 -> V_25 ) ;
...
V_212 [ V_107 ] ) ;
F_60 ( V_194 -> V_16 + 1 , V_194 -> V_200 + 0x18 ) ;
V_211 = ( T_3 * ) V_209 -> V_133 ;
V_207 = ( V_209 -> V_97 + sizeof( T_3 ) - 1 ) / sizeof( T_3 ) ;
for ( V_107 = 0 ; V_107 < V_207 ; V_107 ++ )
F_60 ( F_141 ( V_211 [ V_107 ] ) , V_194 -> V_195 + V_107 ) ;
F_142 ( V_209 ) ;
return 0 ;
}
...
T_3 V_82 , V_80 = 1000 ;
int V_19 ;
F_60 ( 0xffffffff , V_194 -> V_200 ) ;
while ( F_47 ( V_194 -> V_200 ) != 0xffffffff )
F_57 () ;
V_82 = F_47 ( & V_194 -> V_140 -> V_202 ) ;
V_82 &= ~ ( V_213 | V_214 ) ;
F_60 ( V_82 , & V_194 -> V_140 -> V_202 ) ;
V_82 = F_47 ( & V_194 -> V_140 -> V_202 ) | V_203 ;
F_60 ( V_82 , & V_194 -> V_140 -> V_202 ) ;
V_19 = F_54 ( V_194 -> V_200 , V_80 , 0 ) ;
if ( V_19 < 0 ) {
F_77 ( V_24 -> V_25 ,
L_61 ,
V_194 -> V_38 ) ;
...
F_144 ( V_24 ) ;
F_145 (kdev, pdsp) {
V_19 = F_138 ( V_24 , V_194 ) ;
if ( ! V_19 )
V_194 -> V_205 = true ;
}
F_145 (kdev, pdsp) {
if ( V_194 -> V_205 ) {
V_19 = F_143 ( V_24 , V_194 ) ;
if ( ! V_19 )
V_194 -> V_206 = true ;
}
}
...
return V_14 -> V_47 -> V_216 ( V_14 , V_2 ) ;
else
return 0 ;
}
...
V_24 -> V_218 = F_151 ( V_97 ) ;
V_97 = ( 1 << V_24 -> V_218 ) * V_24 -> V_179 ;
V_24 -> V_219 = F_26 ( V_24 -> V_25 , V_97 , V_39 ) ;
if ( ! V_24 -> V_219 )
return - V_40 ;
F_152 (kdev, range) {
if ( V_14 -> V_47 && V_14 -> V_47 -> V_220 )
V_14 -> V_47 -> V_220 ( V_14 ) ;
V_217 = V_35 ;
for ( V_16 = V_14 -> V_17 ;
...
{
struct V_154 * V_125 = V_162 -> V_25 . V_163 ;
struct V_154 * V_184 , * V_180 , * V_155 , * V_192 ;
...
V_24 -> V_36 = V_158 [ 0 ] ;
V_24 -> V_37 = V_158 [ 1 ] ;
V_184 = F_158 ( V_125 , L_68 ) ;
if ( ! V_184 ) {
F_77 ( V_25 , L_69 ) ;
V_19 = - V_51 ;
goto V_128;
}
V_19 = F_133 ( V_24 , V_184 ) ;
F_159 ( V_184 ) ;
if ( V_19 )
goto V_128;
V_192 = F_158 ( V_125 , L_70 ) ;
if ( V_192 ) {
V_19 = F_136 ( V_24 , V_192 ) ;
if ( V_19 )
goto V_128;
V_19 = F_146 ( V_24 ) ;
if ( V_19 )
...
if ( V_19 )
goto V_128;
V_19 = F_113 ( V_24 , L_73 , & V_24 -> V_164 [ 0 ] ) ;
if ( V_19 ) {
F_77 ( V_24 -> V_25 , L_74 ) ;
goto V_128;
}
V_19 = F_113 ( V_24 , L_75 , & V_24 -> V_164 [ 1 ] ) ;
if ( V_19 ) {
}
V_19 = F_116 ( V_24 ) ;
if ( V_19 )
...
F_160 ( L_79 , V_222 | V_223 , NULL , NULL ,
& V_224 ) ;
return 0 ;
V_128:
F_144 ( V_24 ) ;
