...
if ( ( V_62 + V_59 + V_60 ) > 0x1000 ) {
F_8 ( L_36 ,
V_45 , V_2 -> V_56 ) ;
F_34 ( V_58 ) ;
continue;
}
F_7 ( & F_51 ( V_58 ) -> V_63 , ( V_62 << 16 ) | V_59 ) ;
V_62 += V_59 ;
F_7 ( & F_51 ( V_58 ) -> V_64 , ( V_62 << 16 ) | V_60 ) ;
V_62 += V_60 ;
F_7 ( & F_51 ( V_58 ) -> V_65 , 0x80 ) ;
F_7 ( & F_51 ( V_58 ) -> V_65 , 0x01 ) ;
F_7 ( & F_51 ( V_58 ) -> V_66 , 0x80 ) ;
F_7 ( & F_51 ( V_58 ) -> V_66 , 0x01 ) ;
F_34 ( V_58 ) ;
}
}
void T_1 F_52 ( void )
...
int F_57 ( unsigned int V_68 , T_4 V_69 )
{
static struct V_70 T_2 * V_71 ;
struct V_1 * V_2 ;
if ( V_68 > 7 )
return - V_72 ;
if ( ! V_71 ) {
