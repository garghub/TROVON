...
static void F_90 ( int V_108 , int type , T_3 V_70 , int V_221 , struct V_143 * V_144 )
{
...
V_250:
if ( ! ( V_244 & F_97 ) )
F_90 ( V_249 , V_40 , V_144 -> V_235 , 32 , V_226 ) ;
...
if ( ! ( V_244 & F_96 ) ) {
unsigned int V_150 ;
F_90 ( V_249 , V_83 , V_144 -> V_148 , 32 , V_226 ) ;
...
{
struct V_143 * V_144 = (struct V_143 * ) V_275 ;
