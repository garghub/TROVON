...
{
if ( ! V_6 -> V_104 ) {
V_6 -> V_33 . V_105 = F_59 ( V_6 -> V_33 . V_106 ,
V_6 -> V_33 . V_107 ) ;
}
F_60 ( L_8 ,
V_6 -> V_33 . V_108 >> 20 ,
...
T_1 V_14 = F_66 ( & V_6 -> V_14 ) ;
T_1 V_111 = V_35 >> 1 ;
T_1 V_112 = V_14 >= V_111 ? 0 : V_111 - V_14 ;
T_1 V_113 = V_112 >> 1 ;
return F_67 ( V_113 , 1024 * 1024ull ) ;
}
...
T_1 V_113 = F_65 ( V_6 ) ;
F_23 ( & V_121 ) ;
V_64 = F_69 ( V_115 , V_117 , true , & V_121 ) ;
if ( F_22 ( V_64 != 0 ) ) {
return V_64 ;
}
F_70 (lobj, head, tv.head) {
struct V_1 * V_2 = V_120 -> V_124 ;
if ( ! V_2 -> V_91 ) {
T_2 V_24 = V_120 -> V_125 ;
T_2 V_126 = V_120 -> V_127 ;
T_2 V_128 =
F_71 ( V_2 -> V_8 . V_16 . V_3 ) ;
if ( ( V_126 & V_128 ) != 0 &&
( V_24 & V_128 ) == 0 &&
V_122 > V_113 ) {
V_24 = V_128 ;
...
V_136 -> V_2 = V_2 ;
V_142:
F_78 ( V_6 , V_26 , V_2 -> V_134 , V_2 -> V_144 ,
...
{
int V_64 ;
V_64 = F_88 ( & V_2 -> V_8 , true , V_169 , false , NULL ) ;
if ( F_22 ( V_64 != 0 ) )
return V_64 ;
if ( V_3 )
* V_3 = V_2 -> V_8 . V_16 . V_3 ;
V_64 = F_89 ( & V_2 -> V_8 , true , true , V_169 ) ;
F_90 ( & V_2 -> V_8 ) ;
return V_64 ;
}
