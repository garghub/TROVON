...
static bool F_72 ( struct V_10 * V_11 , bool V_105 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_102 ;
T_1 V_106 ;
...
F_30 ( & V_11 -> V_30 ) ;
F_75 ( & V_117 ) ;
if ( F_76 ( F_56 ( V_11 -> V_11 ) ) )
F_72 ( V_11 , true ) ;
F_45 ( V_11 ) ;
V_5 -> V_8 = F_16 ( V_11 ) ;
V_5 -> V_67 = F_50 ( V_11 ) ;
if ( F_77 ( V_119 , & V_5 -> V_40 ) ) {
F_14 ( V_11 -> V_11 , L_20 ) ;
if ( F_51 ( V_5 -> V_67 ) ) {
F_14 ( V_11 -> V_11 , L_21 ) ;
V_11 -> V_71 = true ;
...
V_90 = F_81 ( V_11 ) ;
if ( F_77 ( V_104 , & V_5 -> V_40 ) ) {
V_118 = F_82 ( V_11 , & V_117 , & V_90 ) ;
...
if ( F_77 ( V_39 , & V_5 -> V_40 ) ) {
V_11 -> V_125 = true ;
V_5 -> V_90 = V_11 -> V_83 ;
}
if ( V_5 -> V_8 && V_11 -> V_125 ) {
V_11 -> V_125 = F_83 ( V_11 ) ;
V_118 = F_84 ( V_11 , & V_117 ) ;
if ( V_118 && V_118 != - V_94 )
F_25 ( V_11 -> V_11 , L_25 ,
V_118 ) ;
V_11 -> V_125 = F_83 ( V_11 ) ;
...
struct V_10 * F_87 ( struct V_77 * V_78 )
{
struct V_10 * V_11 ;
struct V_4 * V_5 ;
V_11 = F_88 ( sizeof( struct V_10 ) +
sizeof( struct V_4 ) , V_127 ) ;
if ( ! V_11 )
return NULL ;
F_89 ( V_11 , & V_78 -> V_11 , & V_128 ) ;
V_5 = F_13 ( V_11 ) ;
F_90 ( & V_5 -> V_31 ) ;
return V_11 ;
}
int F_91 ( struct V_10 * V_11 , T_7 V_129 , T_1 V_130 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_131 = F_92 ( V_129 ) ;
T_1 V_132 = F_93 ( V_129 ) ;
T_1 V_133 ;
if ( V_132 & ~ 0xF )
return - V_80 ;
if ( V_131 & 0xF )
