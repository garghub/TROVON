...
static int F_176 ( struct V_21 * V_22 , T_1 * V_169 )
{
int V_64 ;
struct V_14 * V_15 = V_22 -> V_15 ;
...
T_1 V_170 = F_177 ( V_22 -> V_57 , V_2 -> V_171 ) ;
V_64 = V_15 -> V_66 -> V_134 ( V_2 , & V_132 ) ;
if ( V_64 == V_135 ) {
* V_169 = V_170 ;
return 0 ;
...
static T_1 F_178 ( struct V_14 * V_15 , struct V_109 * V_109 )
{
...
F_183 ( V_15 , & V_109 , V_15 -> V_179 ) ;
if ( ! V_174 && ! F_168 ( V_15 ) ) {
if ( F_184 ( V_15 , V_109 , & V_177 ,
& V_178 ) )
return V_172 ;
} else
V_177 = F_185 ( V_15 ) ;
...
if ( F_58 ( ! V_22 ) )
return V_172 ;
V_169 = F_177 ( V_22 -> V_57 , V_55 . V_2 -> V_171 ) ;
if ( F_58 ( V_174 ) ) {
F_163 ( V_22 , V_109 ) ;
F_186 ( V_22 ) ;
goto V_151;
...
static T_1 F_187 ( struct V_14 * V_15 , struct V_109 * V_109 )
{
const int V_173 = F_37 ( V_109 -> V_167 ) ;
const int V_174 = V_109 -> V_167 & ( V_175 | V_176 ) ;
struct V_158 * V_159 ;
...
static void F_191 ( struct V_187 * V_188 ,
...
static struct V_93 * F_198 ( struct V_187 * V_188 ,
unsigned int V_189 )
{
struct V_93 * V_20 ;
unsigned int V_3 , V_198 , V_199 , V_200 = 4 ;
T_2 V_201 , V_202 ;
V_20 = F_199 ( V_188 -> V_203 , V_188 -> V_204 ,
V_188 -> V_205 ,
F_200 ( V_188 -> V_62 ) ) ;
if ( ! V_20 )
return NULL ;
F_31 ( & V_20 -> V_193 ) ;
V_20 -> V_59 = F_201 ( V_188 -> V_203 * sizeof( struct V_21 * ) ,
V_206 | V_207 | V_208 ,
V_188 -> V_205 ) ;
if ( ! V_20 -> V_59 ) {
F_196 ( V_20 ) ;
...
V_201 = F_202 ( sizeof( struct V_21 ) + V_188 -> V_209 ,
F_203 () ) ;
...
V_211 = F_206 ( V_199 , V_188 -> V_203 - V_3 ) ;
V_202 -= V_211 * V_201 ;
...
V_217 -> V_6 [ V_3 ] . V_119 = F_206 ( V_220 , V_217 -> V_12 ) ;
...
goto V_240;
V_2 -> V_229 = F_226 ( V_15 , V_2 -> V_205 , V_188 -> V_209 ) ;
if ( ! V_2 -> V_229 )
goto V_231;
if ( V_188 -> V_98 -> V_215 &&
...
unsigned int V_3 ;
F_228 (i) {
struct V_9 * V_242 = F_229 ( V_15 -> V_243 , V_3 ) ;
struct V_1 * V_2 ;
...
if ( ! V_2 -> V_238 ) {
if ( V_188 -> V_20 [ V_3 ] ) {
F_191 ( V_188 , V_188 -> V_20 [ V_3 ] , V_3 ) ;
V_188 -> V_20 [ V_3 ] = NULL ;
}
V_2 -> V_20 = NULL ;
continue;
...
if ( ! V_188 -> V_20 [ V_3 ] )
V_188 -> V_20 [ V_3 ] = F_198 ( V_188 , V_3 ) ;
V_2 -> V_20 = V_188 -> V_20 [ V_3 ] ;
F_132 ( ! V_2 -> V_20 ) ;
F_237 ( V_2 -> V_20 -> V_126 , V_2 -> V_126 ) ;
V_6 -> V_5 = F_238 ( V_2 -> V_238 , V_6 -> V_12 ) ;
V_2 -> V_144 = F_142 ( V_2 -> V_126 ) ;
V_2 -> V_143 = V_146 ;
}
}
static void F_239 ( struct V_14 * V_15 , bool V_74 )
{
struct V_1 * V_2 ;
int V_3 ;
F_24 (q, hctx, i) {
...
static void F_240 ( struct V_187 * V_188 , bool V_74 )
{
struct V_14 * V_15 ;
...
F_233 ( & V_188 -> V_247 ) ;
F_94 ( & V_15 -> V_248 ) ;
if ( F_243 ( & V_188 -> V_249 ) ) {
V_188 -> V_62 &= ~ V_235 ;
F_240 ( V_188 , false ) ;
}
F_236 ( & V_188 -> V_247 ) ;
}
static void F_244 ( struct V_187 * V_188 ,
struct V_14 * V_15 )
{
V_15 -> V_245 = V_188 ;
F_233 ( & V_188 -> V_247 ) ;
...
struct V_14 * F_247 ( struct V_187 * V_188 )
{
struct V_14 * V_250 , * V_15 ;
V_250 = F_248 ( V_206 , V_188 -> V_205 ) ;
if ( ! V_250 )
return F_44 ( - V_222 ) ;
V_15 = F_249 ( V_188 , V_250 ) ;
if ( F_250 ( V_15 ) )
F_251 ( V_250 ) ;
return V_15 ;
}
static void F_252 ( struct V_187 * V_188 ,
struct V_14 * V_15 )
{
int V_3 , V_198 ;
...
if ( V_251 [ V_3 ] )
continue;
V_218 = F_254 ( V_15 -> V_186 , V_3 ) ;
V_251 [ V_3 ] = F_201 ( sizeof( struct V_1 ) ,
V_206 , V_218 ) ;
if ( ! V_251 [ V_3 ] )
break;
if ( ! F_255 ( & V_251 [ V_3 ] -> V_126 , V_206 ,
V_218 ) ) {
F_195 ( V_251 [ V_3 ] ) ;
V_251 [ V_3 ] = NULL ;
break;
}
F_256 ( & V_251 [ V_3 ] -> V_61 , 0 ) ;
V_251 [ V_3 ] -> V_205 = V_218 ;
V_251 [ V_3 ] -> V_171 = V_3 ;
if ( F_220 ( V_15 , V_188 , V_251 [ V_3 ] , V_3 ) ) {
F_219 ( V_251 [ V_3 ] -> V_126 ) ;
F_195 ( V_251 [ V_3 ] ) ;
V_251 [ V_3 ] = NULL ;
break;
}
...
if ( V_2 ) {
if ( V_2 -> V_20 ) {
F_191 ( V_188 , V_2 -> V_20 , V_198 ) ;
V_188 -> V_20 [ V_198 ] = NULL ;
}
F_214 ( V_15 , V_188 , V_2 , V_198 ) ;
F_219 ( V_2 -> V_126 ) ;
F_258 ( & V_2 -> V_252 ) ;
F_195 ( V_2 -> V_120 ) ;
F_195 ( V_2 ) ;
...
struct V_14 * F_249 ( struct V_187 * V_188 ,
struct V_14 * V_15 )
{
V_15 -> V_66 = V_188 -> V_98 ;
V_15 -> V_243 = F_260 ( struct V_9 ) ;
if ( ! V_15 -> V_243 )
return F_44 ( - V_222 ) ;
V_15 -> V_185 = F_201 ( V_145 * sizeof( * ( V_15 -> V_185 ) ) ,
V_206 , V_188 -> V_205 ) ;
if ( ! V_15 -> V_185 )
goto V_253;
V_15 -> V_186 = F_261 ( V_188 ) ;
if ( ! V_15 -> V_186 )
goto V_254;
F_252 ( V_188 , V_15 ) ;
if ( ! V_15 -> V_141 )
goto V_255;
F_262 ( & V_15 -> V_108 , F_115 ) ;
F_263 ( V_15 , V_188 -> V_49 ? V_188 -> V_49 : 30 * V_256 ) ;
V_15 -> V_257 = V_145 ;
V_15 -> V_76 |= V_258 ;
if ( ! ( V_188 -> V_62 & V_259 ) )
V_15 -> V_76 |= 1 << V_260 ;
V_15 -> V_261 = V_262 ;
F_262 ( & V_15 -> V_85 , F_87 ) ;
F_31 ( & V_15 -> V_89 ) ;
F_222 ( & V_15 -> V_88 ) ;
if ( V_15 -> V_141 > 1 )
F_264 ( V_15 , F_178 ) ;
...
F_264 ( V_15 , F_187 ) ;
V_15 -> V_263 = V_188 -> V_203 ;
if ( V_188 -> V_98 -> V_264 )
F_265 ( V_15 , V_188 -> V_98 -> V_264 ) ;
F_227 ( V_15 , V_188 -> V_141 ) ;
F_266 () ;
F_233 ( & V_265 ) ;
F_100 ( & V_15 -> V_266 , & V_267 ) ;
F_244 ( V_188 , V_15 ) ;
F_232 ( V_15 , V_268 ) ;
F_236 ( & V_265 ) ;
F_267 () ;
...
F_236 ( & V_265 ) ;
F_242 ( V_15 ) ;
F_217 ( V_15 , V_188 , V_188 -> V_141 ) ;
F_218 ( V_15 , V_188 ) ;
}
static void F_269 ( struct V_14 * V_15 ,
const struct V_126 * V_244 )
{
F_20 ( ! F_270 ( & V_15 -> V_17 ) ) ;
F_253 ( V_15 ) ;
F_271 ( V_15 -> V_186 , V_15 -> V_141 , V_244 ) ;
F_232 ( V_15 , V_244 ) ;
F_259 ( V_15 ) ;
}
static int F_272 ( struct V_269 * V_270 ,
unsigned long V_225 , void * V_271 )
{
struct V_14 * V_15 ;
int V_28 = ( unsigned long ) V_271 ;
static struct V_126 V_272 ;
switch ( V_225 & ~ V_273 ) {
case V_226 :
case V_274 :
F_237 ( & V_272 , V_268 ) ;
...
static int F_275 ( struct V_187 * V_188 )
{
unsigned int V_119 ;
int V_277 ;
V_119 = V_188 -> V_203 ;
...
break;
V_188 -> V_203 >>= 1 ;
if ( V_188 -> V_203 < V_188 -> V_204 + V_278 ) {
V_277 = - V_222 ;
break;
}
} while ( V_188 -> V_203 );
if ( ! V_188 -> V_203 || V_277 ) {
F_136 ( L_3 ) ;
return - V_222 ;
}
...
struct V_126 * F_277 ( struct V_93 * V_20 )
{
return V_20 -> V_126 ;
}
int F_278 ( struct V_187 * V_188 )
{
F_279 ( V_279 > 1 << V_280 ) ;
if ( ! V_188 -> V_141 )
return - V_281 ;
...
if ( F_280 () ) {
V_188 -> V_141 = 1 ;
V_188 -> V_203 = F_206 ( 64U , V_188 -> V_203 ) ;
}
if ( V_188 -> V_141 > V_145 )
V_188 -> V_141 = V_145 ;
V_188 -> V_20 = F_201 ( V_145 * sizeof( struct V_93 * ) ,
V_206 , V_188 -> V_205 ) ;
if ( ! V_188 -> V_20 )
return - V_222 ;
if ( F_275 ( V_188 ) )
...
int F_283 ( struct V_14 * V_15 , unsigned int V_283 )
{
struct V_187 * V_188 = V_15 -> V_245 ;
struct V_1 * V_2 ;
int V_3 , V_64 ;
if ( ! V_188 || V_283 > V_188 -> V_203 )
return - V_281 ;
V_64 = 0 ;
F_24 (q, hctx, i) {
if ( ! V_2 -> V_20 )
continue;
V_64 = F_284 ( V_2 -> V_20 , V_283 ) ;
if ( V_64 )
break;
}
if ( ! V_64 )
...
void F_285 ( struct V_187 * V_188 , int V_141 )
{
struct V_14 * V_15 ;
if ( V_141 > V_145 )
V_141 = V_145 ;
