...
V_7 -> V_177 = F_131 ( & V_300 -> V_36 ) ;
if ( F_90 ( V_7 -> V_177 ) ) {
F_51 ( & V_7 -> V_149 , L_18 ) ;
V_148 = F_91 ( V_7 -> V_177 ) ;
goto V_306;
}
for ( V_20 = 0 ; V_20 < V_168 ; V_20 ++ )
F_24 ( V_20 , ( unsigned char * ) V_192 [ V_20 ] ) ;
F_32 ( V_7 -> V_217 . V_307 , V_76 , sizeof( V_7 -> V_217 . V_307 ) ) ;
V_7 -> V_217 . V_308 = & V_309 ;
V_7 -> V_217 . V_310 = & V_311 ;
V_7 -> V_217 . V_312 = - 1 ;
V_7 -> V_217 . V_313 = V_314 ;
V_7 -> V_217 . V_155 = & V_7 -> V_211 ;
V_7 -> V_217 . V_149 = & V_7 -> V_149 ;
V_7 -> V_217 . V_315 = V_316 ;
V_148 = F_132 ( & V_7 -> V_217 , V_317 , - 1 ) ;
if ( V_148 ) {
F_51 ( & V_7 -> V_149 , L_19 ) ;
goto V_318;
}
F_133 ( & V_7 -> V_217 , V_7 ) ;
F_32 ( V_7 -> V_319 . V_307 , V_76 , sizeof( V_7 -> V_319 . V_307 ) ) ;
V_7 -> V_319 . V_308 = & V_309 ;
V_7 -> V_319 . V_310 = & V_311 ;
V_7 -> V_319 . V_312 = - 1 ;
V_7 -> V_319 . V_313 = V_314 ;
V_7 -> V_319 . V_155 = & V_7 -> V_211 ;
V_7 -> V_319 . V_149 = & V_7 -> V_149 ;
V_7 -> V_319 . V_315 = V_316 ;
V_148 = F_132 ( & V_7 -> V_319 , V_317 , - 1 ) ;
if ( V_148 ) {
F_51 ( & V_7 -> V_149 , L_19 ) ;
goto V_320;
}
...
static int F_142 ( struct V_321 * V_36 )
{
...
static int F_144 ( struct V_321 * V_36 )
{
struct V_7 * V_7 = F_143 ( V_36 ) ;
if ( V_7 -> V_221 == 0 )
return 0 ;
