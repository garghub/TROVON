...
struct V_44 * V_45 ;
F_30 () ;
F_46 (hard_iface, &batadv_hardif_list, list) {
...
T_4 V_93 ;
T_4 V_94 ;
V_92 = F_49 ( V_42 , V_61 -> V_87 ) ;
if ( ! V_92 )
return;
V_10 = F_50 ( V_92 , V_11 , V_89 ) ;
if ( ! V_10 )
goto V_95;
V_59 = F_51 ( V_11 , V_89 ) ;
if ( ! V_59 )
goto V_96;
V_94 = V_59 -> V_4 . V_94 ;
V_93 = F_52 ( V_61 -> V_71 ) - V_94 ;
if ( V_93 < 1 && V_93 > - V_97 )
goto V_98;
V_10 -> V_99 = V_49 ;
V_59 -> V_99 = V_49 ;
V_59 -> V_4 . V_94 = F_52 ( V_61 -> V_71 ) ;
V_59 -> V_4 . V_5 = F_52 ( V_61 -> V_5 ) ;
V_98:
if ( V_59 )
F_16 ( V_59 ) ;
V_96:
...
struct V_52 * V_61 ;
struct V_1 * V_100 ;
struct V_101 * V_101 = (struct V_101 * ) F_56 ( V_45 ) ;
bool V_17 ;
V_17 = F_57 ( V_45 , V_11 , V_81 ) ;
if ( ! V_17 )
return V_102 ;
if ( F_58 ( V_42 , V_101 -> V_103 ) )
return V_102 ;
...
F_23 ( V_58 , V_42 ,
L_5 ,
V_101 -> V_103 , F_52 ( V_61 -> V_71 ) ,
V_61 -> V_87 ) ;
V_100 = F_59 ( V_42 ) ;
if ( ! V_100 )
goto V_64;
F_48 ( V_42 , V_101 -> V_103 , V_11 ,
V_61 ) ;
V_64:
if ( V_100 )
F_60 ( V_100 ) ;
