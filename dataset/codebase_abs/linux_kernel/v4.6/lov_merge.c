...
int F_10 ( struct V_33 * exp , struct V_1 * V_2 ,
T_3 V_6 , int V_34 )
{
struct V_25 * V_26 ;
int V_35 = 0 ;
...
F_3 ( V_2 -> V_18 == F_4 () ) ;
if ( V_34 ) {
for (; V_35 < V_2 -> V_24 ; V_35 ++ ) {
struct V_25 * V_26 = V_2 -> V_27 [ V_35 ] ;
V_7 = F_11 ( V_2 , V_6 , V_35 ) ;
F_5 ( V_19 ,
L_4 ,
V_35 , V_7 > V_26 -> V_31 ? L_5 : L_6 ,
V_26 -> V_31 , V_7 ) ;
V_26 -> V_30 . V_22 = V_7 ;
F_12 ( V_26 , V_26 -> V_30 . V_22 ) ;
}
return 0 ;
}
if ( V_6 > 0 )
...
V_26 = V_2 -> V_27 [ V_35 ] ;
F_5 ( V_19 , L_7 ,
V_35 , V_7 > V_26 -> V_31 ? L_8 : L_9 , V_26 -> V_31 , V_7 ) ;
if ( V_7 > V_26 -> V_31 )
F_12 ( V_26 , V_7 ) ;
return 0 ;
}
void F_14 ( struct V_36 * V_37 , struct V_36 * V_38 , T_3 V_39 ,
struct V_1 * V_2 , int V_40 , int * V_41 )
{
V_39 &= V_38 -> V_42 ;
if ( * V_41 ) {
if ( V_39 & V_43 ) {
T_3 V_28 ;
V_28 = F_9 ( V_2 , V_38 -> V_44 , V_40 ) ;
if ( V_28 > V_37 -> V_44 )
V_37 -> V_44 = V_28 ;
}
if ( V_39 & V_45 )
...
if ( V_39 & V_47 )
V_37 -> V_48 += V_38 -> V_48 ;
if ( V_39 & V_49 && V_37 -> V_50 < V_38 -> V_50 )
V_37 -> V_50 = V_38 -> V_50 ;
if ( V_39 & V_51 && V_37 -> V_52 < V_38 -> V_52 )
V_37 -> V_52 = V_38 -> V_52 ;
if ( V_39 & V_53 )
V_37 -> V_54 += V_38 -> V_54 ;
} else {
