...
if ( F_20 ( args , V_33 -> V_35 , sizeof( args ) ) )
return - V_25 ;
switch ( args [ 0 ] ) {
case V_36 :
case V_37 :
return F_12 ( V_11 , args [ 1 ] , args [ 0 ] == V_36 ) ;
case V_38 :
{
struct V_39 V_40 ;
...
V_40 . V_43 = V_11 -> V_43 ;
V_40 . V_44 = F_21 ( V_11 -> V_44 ) ;
V_40 . V_45 = F_21 ( V_11 -> V_45 ) ;
V_40 . V_46 = V_11 -> V_46 ;
V_40 . V_47 = V_11 -> V_47 ;
V_40 . V_48 = V_11 -> V_48 ;
V_40 . V_49 = F_21 ( V_11 -> V_49 ) ;
V_40 . V_50 = V_11 -> V_50 ;
V_40 . V_51 = V_11 -> V_51 ;
V_40 . V_52 = V_11 -> V_52 ;
V_40 . V_53 = ( V_11 -> V_53 != V_54 ) ;
V_40 . V_55 = F_21 ( V_11 -> V_55 ) ;
V_40 . V_56 = F_22 ( & V_11 -> V_57 ) ;
V_40 . V_58 = F_22 ( & V_11 -> V_59 ) ;
V_40 . V_60 = F_22 ( & V_11 -> V_61 ) ;
V_40 . V_62 = F_22 ( & V_11 -> V_63 ) ;
F_4 () ;
if ( F_10 ( ( void T_1 * ) args [ 1 ] , & V_40 , sizeof( V_40 ) ) )
return - V_25 ;
return 0 ;
}
case V_64 :
...
V_14 . V_80 = V_73 -> V_81 ;
V_14 . V_82 = V_73 -> V_82 ;
V_14 . V_83 = F_22 ( & V_73 -> V_84 ) ;
V_14 . V_85 = F_22 ( & V_73 -> V_86 ) ;
V_14 . V_87 = F_22 ( & V_73 -> V_88 ) ;
F_4 () ;
...
if ( ! F_14 ( V_1 -> V_28 , V_29 ) )
return - V_30 ;
if ( F_20 ( V_19 , ( void T_1 * ) args [ 1 ] , V_102 ) )
return - V_25 ;
V_19 [ V_102 - 1 ] = 0 ;
if ( args [ 0 ] == V_100 )
...
case V_108 :
case V_109 :
return F_12 ( V_11 , V_33 -> V_110 , V_34 == V_108 ) ;
}
F_40 ( V_11 , L_1 , V_34 ) ;
return - V_95 ;
}
