...
int V_13 ;
int V_27 ;
struct V_16 * V_17 = F_21 ( & V_26 -> V_28 ) ;
struct V_29 * V_18 ;
V_18 = F_22 ( & V_26 -> V_28 , sizeof( * V_18 ) , V_30 ) ;
if ( ! V_18 )
return - V_31 ;
switch ( V_17 -> type ) {
case V_32 :
...
V_18 -> V_17 = V_17 ;
F_24 ( V_26 , V_18 ) ;
for ( V_27 = 0 ; V_27 < V_18 -> V_33 ; V_27 ++ ) {
struct V_14 * V_15 = & V_18 -> V_15 [ V_27 ] ;
V_15 -> V_11 . V_44 = & V_26 -> V_28 ;
V_15 -> V_18 = V_18 ;
V_13 = F_25 ( & V_26 -> V_28 , & V_15 -> V_11 , V_15 ) ;
if ( V_13 ) {
F_26 ( & V_26 -> V_28 ,
L_2 ,
V_27 , V_13 ) ;
...
static int T_2 F_27 ( int V_20 , struct V_16 * V_17 )
{
int V_13 ;
T_3 V_45 ;
V_13 = F_6 ( V_20 ) ;
