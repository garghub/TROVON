...
if ( F_108 ( V_14 ) == V_142 ) {
F_109 ( V_14 , F_110 ( V_35 ) ) ;
V_88 = F_111 ( V_14 , V_35 ) ;
if ( V_88 ) {
F_39 ( L_24 ) ;
goto V_141;
}
} else if ( F_108 ( V_14 ) != F_110 ( V_35 ) ) {
F_39 ( L_25 ) ;
V_88 = - V_48 ;
goto V_141;
}
...
static int F_113 ( struct V_40 * V_41 , T_2 V_52 )
{
struct V_11 * V_12 ;
struct V_17 * V_14 ;
...
F_115 (tmp, dm_table_get_devices(table))
V_144 ++ ;
...
static int F_118 ( struct V_17 * V_14 , unsigned V_153 , char * * V_154 ,
...
V_88 = F_121 ( V_14 , V_153 , V_154 , V_155 , V_156 ) ;
if ( V_88 < 2 )
return V_88 ;
F_119 ( L_28 , V_154 [ 0 ] ) ;
return - V_48 ;
}
static int F_122 ( struct V_40 * V_41 , T_2 V_52 )
{
int V_88 , V_153 ;
char * * V_154 ;
struct V_17 * V_14 ;
...
V_88 = F_123 ( & V_153 , & V_154 , V_158 -> V_159 ) ;
if ( V_88 ) {
F_39 ( L_30 ) ;
goto V_66;
}
...
V_88 = F_118 ( V_14 , V_153 , V_154 , V_155 , V_156 ) ;
if ( V_88 <= 1 )
goto V_160;
V_29 = F_30 ( V_14 , & V_30 ) ;
if ( ! V_29 )
...
static T_5 F_128 ( unsigned int V_164 , int * V_165 )
{
static struct {
int V_164 ;
int V_45 ;
...
if ( F_129 ( V_164 >= F_130 ( V_167 ) ) )
return NULL ;
* V_165 = V_167 [ V_164 ] . V_45 ;
return V_167 [ V_164 ] . V_166 ;
}
static int F_131 ( unsigned int V_164 , struct V_40 T_6 * V_185 )
{
V_68 V_76 [ 3 ] ;
int V_88 = 0 ;
if ( F_132 ( V_76 , V_185 -> V_76 , sizeof( V_76 ) ) )
return - V_186 ;
if ( ( V_187 != V_76 [ 0 ] ) ||
( V_188 < V_76 [ 1 ] ) ) {
F_39 ( L_34
...
V_76 [ 1 ] = V_188 ;
V_76 [ 2 ] = V_189 ;
if ( F_133 ( V_185 -> V_76 , V_76 , sizeof( V_76 ) ) )
return - V_186 ;
return V_88 ;
}
static void F_134 ( struct V_40 * V_41 , T_2 V_52 , int V_190 )
{
if ( V_190 & V_191 )
memset ( V_41 , 0 , V_52 ) ;
if ( V_190 & V_192 )
...
static int F_136 ( struct V_40 T_6 * V_185 , struct V_40 * V_194 ,
int V_165 ,
...
unsigned V_205 ;
V_205 = F_137 () ;
V_195 = F_138 ( V_194 -> V_54 , V_201 | V_206 | V_207 | V_208 , V_209 ) ;
F_139 ( V_205 ) ;
if ( V_195 )
* V_190 |= V_193 ;
}
if ( ! V_195 ) {
if ( V_196 && F_140 ( V_185 , V_194 -> V_54 ) )
return - V_186 ;
return - V_23 ;
}
if ( F_132 ( V_195 , V_185 , V_194 -> V_54 ) )
goto V_25;
V_199:
...
return 0 ;
V_25:
F_134 ( V_195 , V_194 -> V_54 , * V_190 ) ;
return - V_186 ;
}
static int F_141 ( T_7 V_164 , struct V_40 * V_41 )
{
V_41 -> V_45 &= ~ V_65 ;
V_41 -> V_45 &= ~ V_51 ;
V_41 -> V_45 &= ~ V_198 ;
...
static int F_142 ( T_7 V_210 , struct V_40 T_6 * V_185 )
{
int V_88 = 0 ;
int V_165 ;
int V_190 ;
...
if ( ! F_143 ( V_213 ) )
return - V_214 ;
if ( F_144 ( V_210 ) != V_215 )
return - V_216 ;
V_164 = F_145 ( V_210 ) ;
V_88 = F_131 ( V_164 , V_185 ) ;
if ( V_88 )
return V_88 ;
if ( V_164 == V_168 )
return 0 ;
V_166 = F_128 ( V_164 , & V_165 ) ;
if ( ! V_166 ) {
F_39 ( L_39 , V_210 ) ;
return - V_216 ;
}
V_88 = F_136 ( V_185 , & V_194 , V_165 , & V_41 , & V_190 ) ;
if ( V_88 )
return V_88 ;
V_212 = V_41 -> V_54 ;
V_88 = F_141 ( V_164 , V_41 ) ;
if ( V_88 )
goto V_66;
V_41 -> V_54 = sizeof( * V_41 ) ;
V_88 = V_166 ( V_41 , V_212 ) ;
if ( F_129 ( V_41 -> V_45 & V_65 ) &&
F_129 ( V_165 & V_170 ) )
F_119 ( L_40 , V_164 ) ;
if ( ! V_88 && F_133 ( V_185 , V_41 , V_41 -> V_54 ) )
V_88 = - V_186 ;
V_66:
F_134 ( V_41 , V_212 , V_190 ) ;
return V_88 ;
}
static long F_146 ( struct V_217 * V_217 , T_7 V_210 , T_8 V_218 )
{
return ( long ) F_142 ( V_210 , (struct V_40 T_6 * ) V_218 ) ;
}
static long F_147 ( struct V_217 * V_217 , T_7 V_210 , T_8 V_218 )
{
return ( long ) F_146 ( V_217 , V_210 , ( T_8 ) F_148 ( V_218 ) ) ;
}
int T_9 F_149 ( void )
{
int V_88 ;
...
int F_154 ( struct V_17 * V_14 , char * V_13 , char * V_15 )
{
int V_88 = 0 ;
struct V_11 * V_12 ;
if ( ! V_14 )
