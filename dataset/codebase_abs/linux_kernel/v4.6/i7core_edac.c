...
static void F_90 ( const struct V_205 * V_206 , void * V_207 )
{
int * V_208 = V_207 ;
T_7 V_209 ;
if ( * V_208 == - 1 )
...
(struct V_211 * ) V_206 ;
unsigned long V_212 =
( unsigned long ) & V_211 -> V_213 -
( unsigned long ) & V_211 -> type ;
unsigned long V_214 =
( unsigned long ) & V_211 -> V_215 -
( unsigned long ) & V_211 -> type ;
if ( V_211 -> V_67 == 0 )
return;
...
{
int V_208 = 0 ;
F_92 ( F_90 , ( void * ) & V_208 ) ;
if ( V_208 < 1 )
return V_217 ;
return V_208 ;
}
static int F_93 ( struct V_20 * V_21 , T_1 V_218 )
{
struct V_22 * V_23 = V_21 -> V_24 ;
struct V_25 * V_16 ;
T_1 V_219 ;
...
if ( ! V_16 )
return - V_35 ;
F_15 ( V_16 , V_221 , & V_219 ) ;
if ( V_218 == 0 ) {
V_219 &= ~ V_222 ;
F_41 ( V_16 , V_221 ,
V_219 & ~ V_223 ) ;
F_15 ( V_16 , V_224 , & V_220 ) ;
V_220 &= ~ V_225 ;
V_220 |= V_226 ;
} else {
const int V_227 = 64 ;
const T_1 V_228 = V_23 -> V_208 ;
unsigned long long V_229 ;
V_229 = ( unsigned long long ) V_228 *
V_227 * 1000000 ;
F_94 ( V_229 , V_218 ) ;
if ( ! V_229 || V_229 > V_223 )
return - V_4 ;
V_219 = V_223 & V_229 ;
F_32 ( V_16 , V_221 ,
V_222 | V_219 ) ;
...
if ( ! V_16 )
return - V_35 ;
F_15 ( V_16 , V_221 , & V_232 ) ;
V_232 &= V_223 ;
if ( ! V_232 )
return 0 ;
V_231 = ( unsigned long long ) V_228 *
1000000 * V_227 ;
F_94 ( V_231 , V_232 ) ;
return ( int ) V_231 ;
}
...
static int F_111 ( struct V_25 * V_16 , const struct V_257 * V_258 )
{
int V_96 , V_95 = 0 ;
struct V_11 * V_11 ;
F_112 ( & V_259 ) ;
