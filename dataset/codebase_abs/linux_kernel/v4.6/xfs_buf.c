...
F_5 ( & V_2 -> V_10 ) ;
if ( ! V_2 -> V_133 )
V_2 -> V_133 = V_143 -> V_145 ;
F_10 ( & V_2 -> V_10 ) ;
}
if ( ! V_2 -> V_117 && F_1 ( V_2 ) && ( V_2 -> V_7 & V_106 ) )
F_128 ( V_2 -> V_3 , F_2 ( V_2 ) ) ;
if ( F_94 ( & V_2 -> V_146 ) == 1 )
F_119 ( V_2 ) ;
F_129 ( V_143 ) ;
}
...
if ( V_58 > V_57 )
V_58 = V_57 ;
V_162 = F_132 ( V_143 , V_2 -> V_51 [ V_150 ] , V_58 ,
V_59 ) ;
if ( V_162 < V_58 )
break;
V_59 = 0 ;
...
F_130 ( V_2 , V_30 , & V_59 , & V_57 , V_149 ) ;
if ( V_2 -> V_117 )
break;
if ( V_57 <= 0 )
break;
...
F_154 ( V_199 ) ;
int V_202 = 0 ;
F_155 ( V_80 -> V_47 -> V_167 ) ;
while ( F_156 ( & V_80 -> V_15 ) ) {
F_157 ( & V_80 -> V_15 , F_149 ,
& V_199 , V_203 ) ;
while ( ! F_33 ( & V_199 ) ) {
struct V_1 * V_2 ;
V_2 = F_158 ( & V_199 , struct V_1 , V_16 ) ;
F_159 ( & V_2 -> V_16 ) ;
if ( V_2 -> V_7 & V_141 ) {
F_53 ( V_80 -> V_47 ,
L_7 ,
...
V_80 -> V_90 = V_213 ;
V_80 -> V_91 = V_213 - 1 ;
if ( F_172 ( V_80 -> V_158 , V_213 ) ) {
F_68 ( V_80 -> V_47 ,
L_9 ,
V_213 , V_80 -> V_158 ) ;
return - V_214 ;
}
V_80 -> V_215 = F_173 ( V_80 -> V_158 ) ;
V_80 -> V_216 = F_173 ( V_80 -> V_158 ) - 1 ;
return 0 ;
}
STATIC int
F_174 (
...
V_80 -> V_158 = V_218 ;
V_80 -> V_114 = F_176 ( V_218 ) ;
if ( F_174 ( V_80 , V_218 ) )
goto error;
if ( F_177 ( & V_80 -> V_15 ) )
goto error;
V_80 -> V_209 . V_222 = F_165 ;
V_80 -> V_209 . V_223 = F_163 ;
...
F_187 ( & V_2 -> V_37 , V_234 ) ;
F_188 ( V_2 , V_49 ) ;
}
F_189 ( NULL , V_234 , F_183 ) ;
F_139 ( & V_166 ) ;
F_185 (bp, n, io_list, b_list) {
...
{
F_154 ( V_234 ) ;
return F_184 ( V_233 , & V_234 , false ) ;
}
int
F_191 (
struct V_193 * V_233 )
