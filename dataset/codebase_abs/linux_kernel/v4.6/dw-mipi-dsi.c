...
F_82 ( V_19 -> V_202 , V_203 ,
V_198 ) ;
if ( V_197 )
V_21 = V_204 | ( V_204 << 16 ) ;
else
V_21 = V_204 << 16 ;
F_83 ( V_7 -> V_205 , V_206 , V_21 ) ;
F_84 ( V_7 -> V_35 , L_16 , ( V_197 ) ? L_17 : L_18 ) ;
}
static int F_85 ( struct V_15 * V_17 )
{
struct V_6 * V_7 = F_9 ( V_17 ) ;
return F_86 ( V_7 -> V_96 ) ;
}
static enum V_207 F_87 (
struct V_15 * V_17 ,
struct V_133 * V_10 )
{
struct V_6 * V_7 = F_9 ( V_17 ) ;
...
if ( V_7 -> V_90 -> V_210 )
V_208 = V_7 -> V_90 -> V_210 ( V_17 , V_10 ) ;
return V_208 ;
}
...
static enum V_211
F_89 ( struct V_15 * V_17 , bool V_212 )
{
return V_213 ;
}
...
static int F_93 ( struct V_214 * V_215 ,
struct V_6 * V_7 )
{
...
int V_32 ;
V_19 -> V_216 = F_94 ( V_215 ,
V_35 -> V_97 ) ;
if ( V_19 -> V_216 == 0 )
return - V_217 ;
F_95 ( & V_7 -> V_19 ,
& V_218 ) ;
V_32 = F_96 ( V_215 , & V_7 -> V_19 , & V_219 ,
V_220 , NULL ) ;
if ( V_32 ) {
F_19 ( V_35 , L_19 ) ;
return V_32 ;
...
{
struct V_223 * V_224 = V_7 -> V_35 -> V_97 ;
V_7 -> V_205 = F_101 ( V_224 , L_20 ) ;
if ( F_102 ( V_7 -> V_205 ) ) {
F_19 ( V_7 -> V_35 , L_21 ) ;
return F_103 ( V_7 -> V_205 ) ;
}
return 0 ;
}
static enum V_207 F_104 (
struct V_15 * V_17 ,
struct V_133 * V_10 )
{
if ( V_10 -> V_158 > 0x7ff )
...
static int F_105 ( struct V_89 * V_35 , struct V_89 * V_227 ,
void * V_228 )
{
const struct V_229 * V_230 =
F_106 ( V_231 , V_35 ) ;
const struct V_232 * V_90 = V_230 -> V_228 ;
struct V_233 * V_234 = F_107 ( V_35 ) ;
struct V_214 * V_215 = V_228 ;
struct V_6 * V_7 ;
struct V_235 * V_236 ;
int V_32 ;
V_7 = F_108 ( V_35 , sizeof( * V_7 ) , V_237 ) ;
if ( ! V_7 )
return - V_238 ;
V_7 -> V_35 = V_35 ;
V_7 -> V_90 = V_90 ;
...
if ( V_32 )
return V_32 ;
V_236 = F_109 ( V_234 , V_239 , 0 ) ;
if ( ! V_236 )
return - V_240 ;
V_7 -> V_22 = F_110 ( V_35 , V_236 ) ;
if ( F_102 ( V_7 -> V_22 ) )
...
static void F_114 ( struct V_89 * V_35 , struct V_89 * V_227 ,
void * V_228 )
{
...
{
return F_118 ( & V_234 -> V_35 , & V_244 ) ;
}
static int F_119 ( struct V_233 * V_234 )
{
F_120 ( & V_234 -> V_35 , & V_244 ) ;
return 0 ;
}
