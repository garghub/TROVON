...
V_104 += fprintf ( V_105 , L_24 , F_104 ( V_161 ) ) ;
if ( V_13 -> V_14 && V_44 == '-' ) {
...
static int F_116 ( struct V_1 * V_7 , T_9 * V_105 )
{
...
static int F_117 ( struct V_1 * V_7 )
{
char V_188 [ 64 ] ;
T_9 * V_105 ;
while ( 1 ) {
F_87 ( V_188 , sizeof( V_188 ) , L_25 , V_7 -> V_189 ) ;
if ( F_118 ( V_188 , V_190 ) )
break;
if ( ++ V_7 -> V_189 == 8192 ) {
F_61 ( L_26 ) ;
return - 1 ;
...
if ( V_105 == NULL ) {
char V_109 [ 64 ] ;
const char * V_191 = F_119 ( V_192 , V_109 , sizeof( V_109 ) ) ;
...
static struct V_1 * F_120 ( struct V_3 * V_3 ,
struct V_75 * V_76 ,
struct V_193 * V_194 )
{
struct V_1 * V_7 = F_121 ( sizeof( * V_7 ) ) ;
if ( V_7 ) {
V_7 -> V_3 = V_3 ;
V_7 -> V_23 . V_78 = F_107 ;
V_7 -> V_23 . V_195 = F_10 ;
...
static void F_122 ( struct V_1 * V_7 )
{
free ( V_7 ) ;
}
static struct V_12 * F_123 ( struct V_1 * V_7 )
{
return V_7 -> V_65 ;
}
static struct V_199 * F_124 ( struct V_1 * V_7 )
{
return V_7 -> V_65 -> V_199 ;
}
static inline bool F_125 ( void * V_80 )
{
return V_80 == NULL ;
}
...
if ( F_127 ( V_210 ) ) {
struct V_209 * V_218 ;
F_128 ( V_210 , V_111 , V_212 ) ;
V_211 = V_111 ;
F_129 (pos, evsel) {
struct V_3 * V_219 = F_130 ( V_218 ) ;
if ( V_5 . V_215 ) {
...
L_37 , V_204 ) ;
if ( ! F_125 ( V_76 ) ) {
struct V_227 * V_88 = V_76 -> V_81 ;
if ( V_88 -> V_228 )
V_104 += F_87 ( V_109 + V_104 , V_145 - V_104 , L_38 ) ;
}
return V_104 ;
}
static inline void F_133 ( char * * V_229 , int V_40 )
{
int V_171 ;
...
{
char * V_230 , * V_229 [ 32 ] , * V_231 [ 32 ] , * V_232 ;
T_10 * V_233 ;
int V_234 = 0 , V_235 = - 1 , V_142 = - 1 ;
struct V_236 * V_237 ;
V_230 = getenv ( L_39 ) ;
if ( ! V_230 )
return V_142 ;
...
memset ( V_229 , 0 , sizeof( V_231 ) ) ;
while ( ( V_237 = F_137 ( V_233 ) ) ) {
char V_238 [ V_239 ] ;
T_3 V_240 ;
char * V_241 = V_237 -> V_242 ;
T_9 * V_243 ;
if ( ! ( V_237 -> V_244 == V_245 ) )
continue;
snprintf ( V_238 , sizeof( V_238 ) , L_40 , V_230 , V_241 ) ;
V_243 = fopen ( V_238 , L_41 ) ;
if ( ! V_243 )
continue;
if ( fread ( & V_240 , 1 , 8 , V_243 ) < 8 )
goto V_246;
if ( F_138 ( V_240 ) ) {
V_229 [ V_234 ] = F_139 ( V_241 ) ;
if ( ! V_229 [ V_234 ] )
goto V_246;
V_231 [ V_234 ] = F_139 ( V_238 ) ;
if ( ! V_231 [ V_234 ] ) {
F_134 ( & V_229 [ V_234 ] ) ;
F_140 ( L_42 ) ;
fclose ( V_243 ) ;
...
F_141 ( V_233 ) ;
if ( V_234 ) {
V_235 = F_142 ( V_234 , V_229 ) ;
if ( V_235 < V_234 && V_235 >= 0 ) {
V_232 = F_139 ( V_231 [ V_235 ] ) ;
if ( V_232 ) {
if ( V_247 )
free ( ( void * ) V_248 ) ;
V_248 = V_232 ;
...
static int
F_143 ( struct V_1 * V_7 , struct V_249 * V_250 )
{
struct V_209 * V_210 ;
struct V_251 * V_252 ;
struct V_12 * V_13 ;
int V_191 ;
if ( ! V_253 && F_144 ( V_7 -> V_194 ) )
return 0 ;
V_252 = F_64 ( V_250 -> V_67 . V_98 ) ;
if ( ! V_252 -> V_99 )
return 0 ;
V_210 = F_99 ( V_7 -> V_3 ) ;
V_191 = F_145 ( & V_250 -> V_67 , V_210 , V_7 -> V_76 ) ;
V_13 = F_123 ( V_7 ) ;
if ( ( V_191 == 'q' || V_191 == F_146 ( 'c' ) ) && V_13 -> V_254 )
return 1 ;
...
static int
F_148 ( struct V_1 * V_7 V_45 ,
struct V_249 * V_250 , char * * V_255 ,
struct V_256 * V_256 , struct V_257 * V_98 )
{
if ( V_98 == NULL || V_256 -> V_201 -> V_258 )
return 0 ;
if ( F_76 ( V_255 , L_46 , V_98 -> V_241 ) < 0 )
return 0 ;
V_250 -> V_67 . V_256 = V_256 ;
V_250 -> V_67 . V_98 = V_98 ;
V_250 -> V_259 = F_143 ;
return 1 ;
}
static int
F_149 ( struct V_1 * V_7 , struct V_249 * V_250 )
{
struct V_199 * V_199 = V_250 -> V_199 ;
if ( ( ! V_223 && ! V_260 ) || V_199 == NULL )
return 0 ;
if ( V_7 -> V_3 -> V_203 ) {
F_150 ( V_7 -> V_261 , & V_7 -> V_3 -> V_203 ) ;
F_151 ( V_262 , false ) ;
F_152 ( V_7 -> V_3 -> V_203 ) ;
F_60 () ;
} else {
...
V_7 -> V_3 -> V_203 = F_153 ( V_199 ) ;
F_151 ( V_262 , false ) ;
F_154 ( V_7 -> V_261 , & V_7 -> V_3 -> V_203 ) ;
}
F_155 ( V_7 -> V_3 ) ;
F_16 ( V_7 ) ;
return 0 ;
...
static int
F_156 ( struct V_1 * V_7 , struct V_249 * V_250 ,
char * * V_255 , struct V_199 * V_199 )
{
int V_142 ;
if ( ( ! V_223 && ! V_260 ) || V_199 == NULL )
return 0 ;
if ( V_223 ) {
V_142 = F_76 ( V_255 , L_49 ,
V_7 -> V_3 -> V_203 ? L_50 : L_51 ,
V_199 -> V_224 ? F_132 ( V_199 ) : L_18 ,
V_199 -> V_225 ) ;
} else {
V_142 = F_76 ( V_255 , L_52 ,
V_7 -> V_3 -> V_203 ? L_50 : L_51 ,
V_199 -> V_224 ? F_132 ( V_199 ) : L_18 ) ;
}
if ( V_142 < 0 )
...
static int
F_157 ( struct V_1 * V_7 , struct V_249 * V_250 )
{
struct V_256 * V_256 = V_250 -> V_67 . V_256 ;
if ( ! V_263 || V_256 == NULL )
return 0 ;
if ( V_7 -> V_3 -> V_202 ) {
F_150 ( V_7 -> V_261 , & V_7 -> V_3 -> V_202 ) ;
F_151 ( V_264 , false ) ;
V_7 -> V_3 -> V_202 = NULL ;
F_60 () ;
} else {
...
return 0 ;
F_61 ( L_53 ,
F_158 ( V_256 ) ? L_54 : V_256 -> V_201 -> V_226 ) ;
V_7 -> V_3 -> V_202 = V_256 -> V_201 ;
F_151 ( V_264 , true ) ;
F_154 ( V_7 -> V_261 , & V_7 -> V_3 -> V_202 ) ;
}
F_159 ( V_7 -> V_3 ) ;
F_16 ( V_7 ) ;
return 0 ;
...
static int
F_160 ( struct V_1 * V_7 , struct V_249 * V_250 ,
char * * V_255 , struct V_256 * V_256 )
{
if ( ! V_263 || V_256 == NULL )
return 0 ;
if ( F_76 ( V_255 , L_55 ,
V_7 -> V_3 -> V_202 ? L_50 : L_51 ,
F_158 ( V_256 ) ? L_54 : V_256 -> V_201 -> V_226 ) < 0 )
return 0 ;
V_250 -> V_67 . V_256 = V_256 ;
V_250 -> V_259 = F_157 ;
return 1 ;
...
static int
F_161 ( struct V_1 * V_7 V_45 ,
struct V_249 * V_250 )
{
F_162 ( V_250 -> V_67 . V_256 ) ;
return 0 ;
}
static int
F_163 ( struct V_1 * V_7 V_45 ,
struct V_249 * V_250 , char * * V_255 , struct V_256 * V_256 )
{
if ( ! V_263 || V_256 == NULL )
return 0 ;
if ( F_76 ( V_255 , L_56 ) < 0 )
return 0 ;
V_250 -> V_67 . V_256 = V_256 ;
V_250 -> V_259 = F_161 ;
return 1 ;
...
F_132 ( V_250 -> V_199 ) ) ;
} else if ( V_250 -> V_67 . V_98 ) {
F_87 ( V_265 , sizeof( V_265 ) , L_58 ,
V_250 -> V_67 . V_98 -> V_241 ) ;
}
F_165 ( V_265 ) ;
return 0 ;
}
...
struct V_249 * V_250 , char * * V_255 ,
struct V_199 * V_199 , struct V_257 * V_98 )
{
if ( V_199 ) {
if ( F_76 ( V_255 , L_59 ,
F_132 ( V_199 ) ) < 0 )
...
static int
F_167 ( struct V_1 * V_7 V_45 ,
struct V_249 * V_250 V_45 )
{
if ( F_135 () ) {
F_140 ( L_62
L_63 ) ;
...
static int
F_170 ( struct V_1 * V_7 V_45 ,
struct V_249 * V_250 , char * * V_255 )
{
if ( F_76 ( V_255 , L_65 ) < 0 )
return 0 ;
V_250 -> V_259 = F_169 ;
return 1 ;
}
static int
F_171 ( struct V_1 * V_7 , struct V_249 * V_250 )
{
if ( ! V_267 || V_250 -> V_268 < 0 )
return 0 ;
if ( V_7 -> V_3 -> V_205 > - 1 ) {
F_150 ( V_7 -> V_261 , & V_7 -> V_3 -> V_205 ) ;
V_7 -> V_3 -> V_205 = - 1 ;
F_151 ( V_269 , false ) ;
} else {
V_7 -> V_3 -> V_205 = V_250 -> V_268 ;
F_151 ( V_269 , true ) ;
F_154 ( V_7 -> V_261 , & V_7 -> V_3 -> V_205 ) ;
}
F_172 ( V_7 -> V_3 ) ;
F_16 ( V_7 ) ;
return 0 ;
...
static int
F_173 ( struct V_1 * V_7 , struct V_249 * V_250 ,
char * * V_255 , int V_204 )
{
if ( ! V_267 || V_204 < 0 )
return 0 ;
if ( F_76 ( V_255 , L_66 ,
...
T_3 V_270 = V_106 * ( V_55 / 100 ) ;
V_2 -> V_4 = V_46 . V_271 = V_55 ;
while ( ( V_9 = F_5 ( V_9 , V_2 -> V_4 ) ) != NULL ) {
V_13 = F_7 ( V_9 , struct V_12 , V_8 ) ;
if ( V_13 -> V_53 ) {
V_13 -> V_53 = false ;
...
V_270 = V_106 * ( V_55 / 100 ) ;
}
V_46 . V_272 ( & V_13 -> V_52 , V_13 -> V_273 ,
V_270 , & V_46 ) ;
V_59:
V_9 = F_49 ( V_9 , V_70 ) ;
V_13 -> V_64 = false ;
...
static int F_175 ( struct V_209 * V_210 , int V_84 ,
const char * V_274 ,
bool V_275 ,
struct V_75 * V_76 ,
float V_4 ,
struct V_193 * V_194 )
{
struct V_3 * V_3 = F_130 ( V_210 ) ;
struct V_1 * V_7 = F_120 ( V_3 , V_76 , V_194 ) ;
struct V_254 * V_276 ;
#define F_176 16
char * V_229 [ F_176 ] ;
struct V_249 V_277 [ F_176 ] ;
int V_234 = 0 ;
int V_73 = - 1 ;
char V_111 [ 64 ] ;
int V_77 = V_76 ? V_76 -> V_78 : 0 ;
...
if ( V_7 -> V_65 != NULL ) {
V_199 = F_124 ( V_7 ) ;
V_256 = V_7 -> V_68 -> V_256 ;
V_282 = V_7 -> V_65 -> V_268 ;
}
switch ( V_73 ) {
case V_283 :
case V_284 :
...
if ( V_7 -> V_68 == NULL ||
V_7 -> V_68 -> V_98 == NULL ||
V_7 -> V_68 -> V_256 -> V_201 -> V_258 )
continue;
V_277 -> V_67 . V_256 = V_7 -> V_68 -> V_256 ;
V_277 -> V_67 . V_98 = V_7 -> V_68 -> V_98 ;
F_143 ( V_7 , V_277 ) ;
continue;
case 'P' :
F_117 ( V_7 ) ;
...
if ( F_125 ( V_76 ) ) {
V_277 -> V_199 = NULL ;
V_277 -> V_67 . V_98 = NULL ;
F_164 ( V_7 , V_277 ) ;
}
continue;
case 's' :
if ( F_125 ( V_76 ) ) {
V_73 = F_167 ( V_7 , V_277 ) ;
if ( V_73 == V_266 )
goto V_285;
}
continue;
...
V_77 * 2 ) == V_90 ) {
char * V_289 ;
double V_290 = strtod ( V_111 , & V_289 ) ;
if ( V_290 < 0 || V_290 > 100 ) {
F_53 ( & V_7 -> V_23 , V_77 * 2 ,
L_84 , V_290 ) ;
continue;
}
...
if ( ! V_286 || V_7 -> V_68 == NULL )
goto V_297;
if ( V_298 == V_299 ) {
V_276 = V_7 -> V_65 -> V_254 ;
if ( V_276 == NULL )
goto V_297;
V_234 += F_148 ( V_7 ,
& V_277 [ V_234 ] ,
...
V_276 -> V_300 . V_256 ,
V_276 -> V_300 . V_98 ) ;
if ( V_276 -> V_301 . V_98 != V_276 -> V_300 . V_98 )
V_234 += F_148 ( V_7 ,
& V_277 [ V_234 ] ,
& V_229 [ V_234 ] ,
V_276 -> V_301 . V_256 ,
...
V_297:
V_234 += F_156 ( V_7 , & V_277 [ V_234 ] ,
& V_229 [ V_234 ] , V_199 ) ;
V_234 += F_160 ( V_7 , & V_277 [ V_234 ] ,
& V_229 [ V_234 ] , V_256 ) ;
V_234 += F_163 ( V_7 , & V_277 [ V_234 ] ,
& V_229 [ V_234 ] ,
V_7 -> V_68 ?
V_7 -> V_68 -> V_256 : NULL ) ;
V_234 += F_173 ( V_7 , & V_277 [ V_234 ] ,
& V_229 [ V_234 ] ,
V_282 ) ;
if ( ! F_125 ( V_76 ) )
goto V_302;
...
V_234 += F_166 ( V_7 , & V_277 [ V_234 ] ,
& V_229 [ V_234 ] , NULL , NULL ) ;
V_234 += F_168 ( V_7 , & V_277 [ V_234 ] ,
& V_229 [ V_234 ] ) ;
V_302:
V_234 += F_170 ( V_7 , & V_277 [ V_234 ] ,
& V_229 [ V_234 ] ) ;
do {
struct V_249 * V_250 ;
V_235 = F_142 ( V_234 , V_229 ) ;
if ( V_235 == - 1 || V_235 >= V_234 )
break;
V_250 = & V_277 [ V_235 ] ;
V_73 = V_250 -> V_259 ( V_7 , V_250 ) ;
} while ( V_73 == 1 );
if ( V_73 == V_266 )
break;
}
...
static void F_193 ( struct V_22 * V_7 ,
void * V_132 , int V_32 )
{
struct V_303 * V_304 = F_11 ( V_7 ,
struct V_303 , V_23 ) ;
...
F_67 ( V_7 , V_305 , V_7 -> V_31 - V_104 ) ;
if ( V_144 )
V_304 -> V_68 = V_210 ;
}
static int F_195 ( struct V_303 * V_304 ,
int V_84 , const char * V_72 ,
struct V_75 * V_76 )
{
struct V_308 * V_295 = V_304 -> V_23 . V_309 ;
struct V_209 * V_218 ;
const char * V_74 = L_91 ;
int V_77 = V_76 ? V_76 -> V_78 : 0 ;
int V_73 ;
if ( F_56 ( & V_304 -> V_23 , V_74 ,
L_92 ) < 0 )
return - 1 ;
while ( 1 ) {
V_73 = F_57 ( & V_304 -> V_23 , V_77 ) ;
switch ( V_73 ) {
case V_79 :
V_76 -> V_80 ( V_76 -> V_81 ) ;
if ( ! V_304 -> V_310 && V_304 -> V_306 ) {
F_52 ( & V_304 -> V_23 ) ;
V_304 -> V_310 = true ;
}
continue;
...
if ( V_76 )
V_76 -> V_80 ( V_76 -> V_81 ) ;
V_73 = F_175 ( V_218 , V_84 , V_72 ,
true , V_76 ,
V_304 -> V_4 ,
V_304 -> V_194 ) ;
F_59 ( & V_304 -> V_23 , V_74 ) ;
switch ( V_73 ) {
case V_283 :
if ( V_218 -> V_39 . V_59 == & V_295 -> V_11 )
V_218 = F_197 ( V_295 ) ;
else
V_218 = F_198 ( V_218 ) ;
goto V_311;
case V_284 :
if ( V_218 -> V_39 . V_62 == & V_295 -> V_11 )
V_218 = F_199 ( V_295 ) ;
else
V_218 = F_200 ( V_218 ) ;
goto V_311;
...
static bool F_201 ( struct V_22 * V_7 V_45 ,
void * V_132 )
{
struct V_209 * V_210 = F_37 ( V_132 , struct V_209 , V_39 ) ;
if ( V_5 . V_312 && ! F_202 ( V_210 ) )
return true ;
return false ;
}
static int F_203 ( struct V_308 * V_295 ,
...
F_181 ( L_93 ) ;
F_204 (evlist, pos) {
const char * V_211 = F_126 ( V_218 ) ;
T_8 V_317 = strlen ( V_211 ) + 7 ;
if ( V_304 . V_23 . V_31 < V_317 )
V_304 . V_23 . V_31 = V_317 ;
}
return F_195 ( & V_304 , V_17 , V_72 , V_76 ) ;
}
int F_205 ( struct V_308 * V_295 , const char * V_72 ,
struct V_75 * V_76 ,
float V_4 ,
struct V_193 * V_194 )
{
...
V_318:
if ( V_17 == 1 ) {
struct V_209 * V_57 = F_197 ( V_295 ) ;
return F_175 ( V_57 , V_17 , V_72 ,
false , V_76 , V_4 ,
V_194 ) ;
}
if ( V_5 . V_312 ) {
