...
static unsigned int F_79 ( unsigned int V_6 )
{
struct V_56 V_57 ;
struct V_10 * V_11 = F_9 ( V_6 ) ;
int V_5 = F_21 ( V_6 ) ;
...
static unsigned int F_83 ( struct V_49 * V_50 )
{
return F_79 ( V_50 -> V_6 ) ;
}
...
int F_95 ( struct V_76 * V_77 , struct V_78 * V_79 )
{
int V_53 ;
struct V_80 V_81 ;
V_81 . type = V_82 ;
...
int F_106 ( unsigned int V_24 , unsigned int V_13 , bool V_113 )
{
struct V_114 V_115 ;
int V_5 , V_6 , V_14 ;
F_91 ( & V_67 ) ;
...
if ( V_6 < 0 )
return V_6 ;
V_122 = F_109 ( V_6 , V_118 , V_119 , V_120 , V_121 ) ;
if ( V_122 != 0 ) {
F_107 ( V_6 ) ;
return V_122 ;
}
...
{
int V_6 , V_122 ;
V_6 = F_106 ( V_24 , V_13 , V_119 & V_123 ) ;
if ( V_6 < 0 )
return V_6 ;
V_122 = F_109 ( V_6 , V_118 , V_119 , V_120 , V_121 ) ;
if ( V_122 != 0 ) {
...
void F_113 ( unsigned int V_6 , void * V_121 )
{
struct V_10 * V_11 = F_10 ( V_6 ) ;
if ( F_61 ( ! V_11 ) )
return;
...
void F_119 ( unsigned int V_13 , enum V_19 V_69 )
{
int V_6 ;
#ifdef F_120
if ( F_22 ( V_69 == V_132 ) ) {
int V_53 = F_121 ( V_133 , V_13 , NULL ) ;
if ( V_53 < 0 )
F_122 ( V_134 L_12 , V_13 , V_53 ) ;
return;
}
#endif
...
F_94 ( & V_67 ) ;
F_35 ( V_5 , V_11 -> V_13 ) ;
F_140 ( V_6 , F_39 ( V_11 -> V_13 ) ) ;
F_141 ( V_6 ) ;
}
static int F_142 ( unsigned V_6 , unsigned V_144 )
{
struct V_145 V_146 ;
int V_5 = F_21 ( V_6 ) ;
int V_54 ;
...
static int F_144 ( struct V_49 * V_50 , const struct V_148 * V_149 ,
bool V_150 )
{
unsigned V_144 = F_145 ( V_149 , V_151 ) ;
return F_142 ( V_50 -> V_6 , V_144 ) ;
}
...
V_162 . V_163 = 1 ;
V_162 . V_160 = V_160 ;
F_159 ( V_162 . V_164 , & V_5 ) ;
if ( F_160 ( V_165 , & V_162 ) != 0 )
F_67 () ;
}
}
void F_161 ( int V_6 )
...
int V_53 ;
struct V_180 V_181 ;
V_33 = ( void * ) F_182 ( V_8 | V_182 ) ;
V_181 . V_183 = F_183 ( V_33 ) ;
