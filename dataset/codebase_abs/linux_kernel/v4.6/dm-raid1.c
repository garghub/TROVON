...
static inline int F_71 ( struct V_2 * V_3 , T_1 V_85 ,
int V_99 )
{
int V_100 = F_72 ( V_3 -> V_76 , V_85 , V_99 ) ;
...
static void F_75 ( struct V_2 * V_3 , struct V_14 * V_14 )
{
unsigned int V_45 ;
...
static void F_76 ( struct V_2 * V_3 , struct V_18 * V_21 )
{
int V_100 ;
struct V_14 * V_14 ;
...
F_79 ( V_3 -> V_76 , & V_108 ) ;
F_79 ( V_3 -> V_76 , & V_109 ) ;
V_3 -> V_116 = F_80 ( V_3 -> V_76 ) ? 1 : V_3 -> V_116 ;
if ( F_32 ( V_3 -> V_116 ) && F_25 ( V_3 ) ) {
F_61 ( & V_3 -> V_23 ) ;
F_78 ( & V_3 -> V_106 , & V_108 ) ;
F_62 ( & V_3 -> V_23 ) ;
F_1 ( V_3 ) ;
} else
...
static void F_83 ( struct V_2 * V_3 , struct V_18 * V_106 )
{
struct V_14 * V_14 ;
if ( F_51 ( ! V_106 -> V_24 ) )
return;
...
{
struct V_2 * V_3 =
F_85 ( V_118 , struct V_2 , V_40 ) ;
F_49 ( V_3 -> V_42 -> V_84 ) ;
}
static void F_86 ( struct V_117 * V_118 )
{
struct V_2 * V_3 = F_85 ( V_118 , struct V_2 ,
V_5 ) ;
...
F_77 ( & V_3 -> V_106 ) ;
F_13 ( & V_3 -> V_23 , V_16 ) ;
F_87 ( V_3 -> V_76 , F_25 ( V_3 ) ) ;
F_45 ( V_3 ) ;
F_73 ( V_3 , & V_22 ) ;
F_76 ( V_3 , & V_21 ) ;
F_83 ( V_3 , & V_106 ) ;
}
static struct V_2 * F_88 ( unsigned int V_30 ,
T_3 V_75 ,
struct V_41 * V_42 ,
struct V_82 * V_119 )
{
...
static void F_97 ( struct V_2 * V_3 , struct V_41 * V_42 ,
unsigned int V_27 )
{
while ( V_27 -- )
F_98 ( V_42 , V_3 -> V_25 [ V_27 ] . V_38 ) ;
F_96 ( V_3 -> V_57 ) ;
F_99 ( V_3 -> V_76 ) ;
F_94 ( V_3 ) ;
}
static int F_100 ( struct V_2 * V_3 , struct V_41 * V_42 ,
...
V_126 = F_101 ( V_42 , V_124 [ 0 ] , F_102 ( V_42 -> V_84 ) ,
& V_3 -> V_25 [ V_25 ] . V_38 ) ;
if ( V_126 ) {
V_42 -> error = L_14 ;
return V_126 ;
...
static struct V_82 * F_103 ( struct V_41 * V_42 ,
...
V_119 = F_104 ( V_124 [ 0 ] , V_42 , F_30 , V_130 ,
V_124 + 2 ) ;
if ( ! V_119 ) {
V_42 -> error = L_18 ;
return NULL ;
...
static int F_105 ( struct V_2 * V_3 , unsigned V_128 , char * * V_124 ,
unsigned * V_129 )
{
unsigned V_131 ;
...
static int F_106 ( struct V_41 * V_42 , unsigned int V_128 , char * * V_124 )
{
int V_69 ;
...
struct V_82 * V_119 ;
char V_125 ;
V_119 = F_103 ( V_42 , V_128 , V_124 , & V_129 ) ;
if ( ! V_119 )
return - V_127 ;
V_124 += V_129 ;
V_128 -= V_129 ;
...
V_3 = F_88 ( V_30 , V_119 -> type -> V_135 ( V_119 ) , V_42 , V_119 ) ;
if ( ! V_3 ) {
F_107 ( V_119 ) ;
return - V_136 ;
}
for ( V_27 = 0 ; V_27 < V_30 ; V_27 ++ ) {
V_69 = F_100 ( V_3 , V_42 , V_27 , V_124 ) ;
if ( V_69 ) {
F_97 ( V_3 , V_42 , V_27 ) ;
return V_69 ;
}
...
V_3 -> V_7 = 0 ;
F_110 ( & V_3 -> V_40 , V_40 ) ;
V_69 = F_105 ( V_3 , V_128 , V_124 , & V_129 ) ;
if ( V_69 )
goto V_144;
V_124 += V_129 ;
V_128 -= V_129 ;
...
struct V_82 * log = F_46 ( V_3 -> V_76 ) ;
struct V_141 * V_146 =
F_121 ( V_14 , sizeof( struct V_141 ) ) ;
...
if ( F_32 ( ! V_27 ) )
return - V_62 ;
F_122 ( & V_146 -> V_147 , V_14 ) ;
V_146 -> V_27 = V_27 ;
F_57 ( V_27 , V_14 ) ;
return V_152 ;
}
static int F_123 ( struct V_41 * V_42 , struct V_14 * V_14 , int error )
{
int V_15 = F_67 ( V_14 ) ;
struct V_2 * V_3 = (struct V_2 * ) V_42 -> V_43 ;
...
static char F_133 ( struct V_25 * V_27 )
{
if ( ! F_19 ( & ( V_27 -> V_31 ) ) )
return 'A' ;
...
( F_33 ( V_94 , & ( V_27 -> V_33 ) ) ) ? 'R' : 'U' ;
}
static void F_134 ( struct V_41 * V_42 , T_5 type ,
...
F_135 ( L_36 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ ) {
F_135 ( L_37 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ) ;
V_165 [ V_27 ] = F_133 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_165 [ V_27 ] = '\0' ;
F_135 ( L_38 ,
...
F_135 ( L_39 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ )
F_135 ( L_40 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ,
...
int V_126 = 0 ;
unsigned V_45 ;
for ( V_45 = 0 ; ! V_126 && V_45 < V_3 -> V_30 ; V_45 ++ )
V_126 = V_98 ( V_42 , V_3 -> V_25 [ V_45 ] . V_38 ,
