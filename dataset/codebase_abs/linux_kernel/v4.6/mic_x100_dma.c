...
L_6 , V_4 , V_4 -> V_84 ) ;
if ( F_69 ( V_4 -> V_27 ) )
return F_70 ( V_4 -> V_27 ) ;
return 0 ;
}
static inline void F_71 ( struct V_3 * V_4 )
{
F_67 ( V_4 ) -> F_72 ( F_42 ( V_4 ) , V_4 -> V_27 , V_4 ) ;
}
...
static int F_81 ( struct V_48 * V_4 )
{
int V_42 = F_73 ( F_23 ( V_4 ) ) ;
if ( V_42 )
return V_42 ;
return V_2 ;
}
static void F_82 ( struct V_48 * V_4 )
{
struct V_3 * V_49 = F_23 ( V_4 ) ;
F_74 ( V_49 ) ;
F_77 ( V_49 ) ;
...
{
int V_99 , V_100 = V_91 -> V_101 ;
F_84 ( V_91 -> V_92 . V_103 ) ;
F_85 ( V_104 , V_91 -> V_92 . V_103 ) ;
if ( V_105 == V_87 )
F_85 ( V_106 , V_91 -> V_92 . V_103 ) ;
V_91 -> V_92 . V_107 =
F_81 ;
V_91 -> V_92 . V_108 =
F_82 ;
...
F_86 ( & V_91 -> V_92 . V_115 ) ;
for ( V_99 = V_100 ; V_99 < V_100 + V_102 ; V_99 ++ ) {
V_91 -> V_49 [ V_99 ] . V_56 . V_32 = & V_91 -> V_92 ;
F_87 ( & V_91 -> V_49 [ V_99 ] . V_56 ) ;
F_88 ( & V_91 -> V_49 [ V_99 ] . V_56 . V_116 ,
& V_91 -> V_92 . V_115 ) ;
}
return F_89 ( & V_91 -> V_92 ) ;
}
static struct V_90 * F_90 ( struct V_117 * V_118 ,
enum V_98 V_87 )
{
struct V_90 * V_91 ;
int V_42 ;
...
static int F_92 ( struct V_126 * V_127 , void * V_128 )
{
struct V_90 * V_91 = V_127 -> V_129 ;
int V_99 , V_130 , V_100 = V_91 -> V_101 ;
struct V_3 * V_4 ;
F_93 ( V_127 , L_9 ,
F_94 ( & V_91 -> V_49 [ V_100 ] ,
V_131 + V_132 ) ) ;
F_95 ( V_127 , L_10 ) ;
F_93 ( V_127 , L_11 ,
L_12 , L_13 , L_14 , L_15 , L_16 , L_17 ) ;
F_93 ( V_127 , L_18 , L_19 , L_20 , L_21 ) ;
for ( V_99 = V_100 ; V_99 < V_100 + V_102 ; V_99 ++ ) {
V_4 = & V_91 -> V_49 [ V_99 ] ;
V_130 = V_4 -> V_84 ;
F_93 ( V_127 , L_22 ,
...
static int F_96 ( struct V_136 * V_136 , struct V_137 * V_137 )
{
return F_97 ( V_137 , F_92 , V_136 -> V_138 ) ;
}
static int F_98 ( struct V_136 * V_136 , struct V_137 * V_137 )
{
return F_99 ( V_136 , V_137 ) ;
}
...
V_87 = V_105 ;
V_91 = F_90 ( V_118 , V_87 ) ;
F_101 ( & V_118 -> V_33 , V_91 ) ;
if ( V_141 ) {
V_91 -> V_142 = F_102 ( F_103 ( & V_118 -> V_33 ) ,
V_141 ) ;
if ( V_91 -> V_142 )
F_104 ( L_24 , 0444 ,
V_91 -> V_142 , V_91 ,
...
{
struct V_90 * V_91 ;
V_91 = F_106 ( & V_118 -> V_33 ) ;
F_107 ( V_91 -> V_142 ) ;
F_91 ( V_91 ) ;
}
static int T_7 F_108 ( void )
{
int V_144 = F_109 ( & V_145 ) ;
if ( V_144 )
return V_144 ;
V_141 = F_102 ( V_146 , NULL ) ;
return 0 ;
}
