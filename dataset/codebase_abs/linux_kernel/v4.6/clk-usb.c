...
F_16 ( struct V_8 * V_8 , const char * V_29 ,
...
V_5 -> V_2 . V_33 = & V_33 ;
V_5 -> V_8 = V_8 ;
V_28 = F_19 ( NULL , & V_5 -> V_2 ) ;
if ( F_20 ( V_28 ) )
F_21 ( V_5 ) ;
return V_28 ;
}
static struct V_28 * T_2
F_22 ( struct V_8 * V_8 , const char * V_29 ,
const char * V_42 )
{
struct V_4 * V_5 ;
struct V_28 * V_28 = NULL ;
...
static long F_25 ( struct V_1 * V_2 , unsigned long V_23 ,
unsigned long * V_3 )
{
struct V_44 * V_5 = F_24 ( V_2 ) ;
struct V_1 * V_14 = F_26 ( V_2 ) ;
...
static int F_27 ( struct V_1 * V_2 , unsigned long V_23 ,
unsigned long V_3 )
{
int V_20 ;
struct V_44 * V_5 = F_24 ( V_2 ) ;
...
static struct V_28 * T_2
F_28 ( struct V_8 * V_8 , const char * V_29 ,
...
static void T_2 F_29 ( struct V_56 * V_57 )
{
struct V_28 * V_28 ;
unsigned int V_31 ;
const char * V_30 [ V_58 ] ;
const char * V_29 = V_57 -> V_29 ;
struct V_8 * V_8 ;
V_31 = F_30 ( V_57 ) ;
if ( V_31 == 0 || V_31 > V_58 )
return;
