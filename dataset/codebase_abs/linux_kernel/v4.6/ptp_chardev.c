...
break;
case V_79 :
V_43 = F_11 ( sizeof( * V_43 ) , V_80 ) ;
if ( ! V_43 ) {
V_8 = - V_81 ;
break;
}
if ( F_8 ( V_43 , ( void V_60 * ) V_38 ,
sizeof( * V_43 ) ) ) {
V_8 = - V_61 ;
break;
}
...
V_48 = & V_43 -> V_50 [ 0 ] ;
for ( V_28 = 0 ; V_28 < V_43 -> V_82 ; V_28 ++ ) {
F_12 ( & V_50 ) ;
V_48 -> V_67 = V_50 . V_75 ;
V_48 -> V_68 = V_50 . V_76 ;
V_48 ++ ;
V_21 -> V_23 -> V_84 ( V_21 -> V_23 , & V_50 ) ;
V_48 -> V_67 = V_50 . V_75 ;
V_48 -> V_68 = V_50 . V_76 ;
V_48 ++ ;
}
...
unsigned int F_16 ( struct V_34 * V_35 , struct V_90 * V_91 , T_2 * V_92 )
{
struct V_20 * V_21 = F_6 ( V_35 , struct V_20 , clock ) ;
F_17 ( V_91 , & V_21 -> V_93 , V_92 ) ;
return F_18 ( & V_21 -> V_94 ) ? V_95 : 0 ;
}
T_3 F_19 ( struct V_34 * V_35 ,
T_4 V_96 , char V_60 * V_97 , T_5 V_98 )
{
struct V_20 * V_21 = F_6 ( V_35 , struct V_20 , clock ) ;
struct V_99 * V_100 = & V_21 -> V_94 ;
struct V_101 * V_102 ;
unsigned long V_63 ;
T_5 V_103 , V_28 ;
int V_104 ;
if ( V_98 % sizeof( struct V_101 ) != 0 )
return - V_19 ;
if ( V_98 > V_105 )
V_98 = V_105 ;
V_98 = V_98 / sizeof( struct V_101 ) ;
if ( F_13 ( & V_21 -> V_106 ) )
return - V_87 ;
if ( F_20 ( V_21 -> V_93 ,
V_21 -> V_107 || F_18 ( V_100 ) ) ) {
F_14 ( & V_21 -> V_106 ) ;
return - V_87 ;
}
if ( V_21 -> V_107 ) {
...
V_102 = F_11 ( V_105 , V_80 ) ;
if ( ! V_102 ) {
F_14 ( & V_21 -> V_106 ) ;
return - V_81 ;
}
F_21 ( & V_100 -> V_109 , V_63 ) ;
V_103 = F_18 ( V_100 ) ;
if ( V_98 > V_103 )
V_98 = V_103 ;
for ( V_28 = 0 ; V_28 < V_98 ; V_28 ++ ) {
V_102 [ V_28 ] = V_100 -> V_97 [ V_100 -> V_110 ] ;
V_100 -> V_110 = ( V_100 -> V_110 + 1 ) % V_111 ;
}
F_22 ( & V_100 -> V_109 , V_63 ) ;
V_98 = V_98 * sizeof( struct V_101 ) ;
F_14 ( & V_21 -> V_106 ) ;
V_104 = V_98 ;
if ( F_7 ( V_97 , V_102 , V_98 ) )
V_104 = - V_61 ;
F_15 ( V_102 ) ;
return V_104 ;
}
