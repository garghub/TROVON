...
static inline T_2 F_135 ( unsigned int V_242 )
{
if ( F_136 ( V_242 ) )
return ( V_242 & V_243 )
| V_244 ;
...
static inline T_5 F_137 ( T_2 V_245 )
{
return ( V_245 & ~ V_244 ) | V_246 ;
}
static int F_138 ( struct V_247 * V_86 , struct V_181 * V_182 )
{
struct V_39 * V_40 ;
struct V_8 * V_9 ;
unsigned long V_82 ;
...
V_40 -> V_131 = V_10 ;
V_40 -> V_221 = F_135 ( V_182 -> V_111 -> V_221 ) ;
V_40 -> V_213 = ! F_143 ( V_9 ) ? true : false ;
V_40 -> V_211 = V_234 ;
F_134 ( V_9 , V_40 ) ;
V_26 = F_118 ( V_40 ) ;
if ( V_26 ) {
...
static int
F_146 ( struct V_8 * V_9 , struct V_39 * V_40 )
{
struct V_139 * V_140 = & V_9 -> V_141 . V_142 . V_143 ;
...
F_149 ( V_9 -> V_18 , L_16 ,
V_19 , V_40 -> V_131 ) ;
if ( ! F_145 ( V_9 , V_40 -> V_131 ) )
V_26 = - V_100 ;
F_30 ( V_9 , V_40 -> V_131 ) ;
}
return V_26 ;
}
static bool F_150 ( struct V_8 * V_9 , int * V_268 )
{
int V_10 ;
bool V_12 = false ;
unsigned long V_269 ;
...
static inline void F_152 ( struct V_8 * V_9 , int V_10 )
{
F_27 ( V_10 , & V_9 -> V_104 ) ;
}
...
struct V_174 V_270 ;
unsigned long V_82 ;
F_154 ( V_9 -> V_141 . V_271 , F_150 ( V_9 , & V_10 ) ) ;
F_113 ( & V_270 ) ;
V_40 = & V_9 -> V_255 [ V_10 ] ;
F_109 ( V_40 -> V_182 ) ;
V_26 = F_144 ( V_9 , V_40 , V_258 , V_10 ) ;
if ( F_155 ( V_26 ) )
goto V_272;
...
F_97 ( V_9 , V_10 ) ;
F_54 ( V_9 -> V_86 -> V_87 , V_82 ) ;
V_26 = F_148 ( V_9 , V_40 , V_27 ) ;
V_272:
F_152 ( V_9 , V_10 ) ;
F_157 ( & V_9 -> V_141 . V_271 ) ;
return V_26 ;
}
static inline void F_158 ( struct V_8 * V_9 ,
...
V_12 = F_160 ( V_9 , V_147 , V_275 , V_279 ) ;
if ( V_12 )
F_149 ( V_9 -> V_18 ,
L_17 ,
V_19 , V_12 , V_280 ) ;
...
int F_160 ( struct V_8 * V_9 , enum V_274 V_147 ,
...
F_158 ( V_9 , & V_154 , & V_143 , V_147 , V_275 , V_276 ,
V_277 ) ;
switch ( V_147 ) {
case V_284 :
case V_285 :
...
static int F_162 ( struct V_8 * V_9 , enum V_274 V_147 ,
...
V_12 = F_162 ( V_9 , V_147 , V_275 , V_276 ,
V_277 , V_294 ) ;
if ( V_12 )
F_149 ( V_9 -> V_18 , L_17 ,
V_19 , V_12 , V_280 ) ;
...
int V_280 ;
for ( V_280 = V_281 ; V_280 > 0 ; V_280 -- ) {
V_26 = F_164 ( V_9 , V_147 , V_275 , V_276 ,
V_277 , V_298 , V_152 ) ;
if ( ! V_26 || V_26 == - V_118 )
break;
}
...
V_298 = F_168 ( V_306 , V_310 ) ;
if ( ! V_298 )
return - V_311 ;
}
V_12 = F_166 ( V_9 , V_148 ,
V_301 , V_302 , 0 , V_298 ,
& V_306 ) ;
...
static inline int F_170 ( struct V_8 * V_9 ,
enum V_297 V_301 ,
int V_302 ,
T_2 * V_114 ,
T_1 V_187 )
{
return F_167 ( V_9 , V_301 , V_302 , 0 , V_114 , V_187 ) ;
}
static inline int F_171 ( struct V_8 * V_9 ,
T_2 * V_114 ,
T_1 V_187 )
{
return F_170 ( V_9 , V_314 , 0 , V_114 , V_187 ) ;
}
int F_172 ( struct V_8 * V_9 , T_2 * V_114 , T_1 V_187 )
{
return F_170 ( V_9 , V_315 , 0 , V_114 , V_187 ) ;
}
int F_173 ( struct V_8 * V_9 , int V_302 , T_2 * V_114 ,
...
V_320 = F_168 ( V_319 , V_310 ) ;
if ( ! V_320 ) {
V_26 = - V_311 ;
goto V_322;
}
F_174 ( ( V_323 * ) & V_114 [ V_321 ] ,
V_318 - V_321 ,
V_324 , V_320 , V_319 ) ;
...
static inline int F_175 ( struct V_8 * V_9 ,
int V_221 ,
enum V_325 V_303 ,
T_2 * V_304 ,
T_1 V_305 )
{
if ( V_221 != V_326 && ( V_221 >= V_327 ) )
return - V_328 ;
return F_167 ( V_9 , V_329 , V_221 ,
V_303 , V_304 , V_305 ) ;
}
static int F_176 ( struct V_8 * V_9 )
{
T_4 V_330 , V_331 , V_332 ;
V_332 = ( sizeof( struct V_333 ) * V_9 -> V_11 ) ;
V_9 -> V_334 = F_177 ( V_9 -> V_18 ,
V_332 ,
& V_9 -> V_335 ,
V_310 ) ;
if ( ! V_9 -> V_334 ||
F_109 ( V_9 -> V_335 & ( V_115 - 1 ) ) ) {
F_6 ( V_9 -> V_18 ,
L_32 ) ;
goto V_48;
}
V_331 = ( sizeof( struct V_200 ) * V_9 -> V_11 ) ;
V_9 -> V_336 = F_177 ( V_9 -> V_18 ,
V_331 ,
& V_9 -> V_337 ,
V_310 ) ;
if ( ! V_9 -> V_336 ||
F_109 ( V_9 -> V_337 & ( V_115 - 1 ) ) ) {
F_6 ( V_9 -> V_18 ,
L_33 ) ;
goto V_48;
}
V_330 = sizeof( struct V_45 ) * V_9 -> V_50 ;
V_9 -> V_338 = F_177 ( V_9 -> V_18 ,
V_330 ,
& V_9 -> V_339 ,
V_310 ) ;
if ( ! V_9 -> V_338 ||
F_109 ( V_9 -> V_339 & ( V_115 - 1 ) ) ) {
F_6 ( V_9 -> V_18 ,
L_34 ) ;
goto V_48;
}
V_9 -> V_255 = F_178 ( V_9 -> V_18 ,
...
V_340 = V_9 -> V_334 ;
V_344 =
F_180 ( struct V_333 , V_347 ) ;
V_345 =
F_180 ( struct V_333 , V_178 ) ;
V_346 = sizeof( struct V_333 ) ;
V_342 = V_9 -> V_335 ;
...
V_341 [ V_184 ] . V_352 =
F_120 ( V_353 >> 2 ) ;
V_9 -> V_255 [ V_184 ] . V_41 = ( V_341 + V_184 ) ;
V_9 -> V_255 [ V_184 ] . V_218 =
(struct V_217 * ) ( V_340 + V_184 ) ;
V_9 -> V_255 [ V_184 ] . V_59 =
(struct V_58 * ) V_340 [ V_184 ] . V_347 ;
V_9 -> V_255 [ V_184 ] . V_186 =
(struct V_177 * ) V_340 [ V_184 ] . V_178 ;
}
}
...
int F_183 ( struct V_8 * V_9 , T_1 V_359 ,
T_2 V_360 , T_1 V_361 , T_2 V_362 )
{
struct V_163 V_164 = { 0 } ;
...
const char * V_193 = V_363 [ ! ! V_362 ] ;
int V_12 ;
int V_280 = V_364 ;
V_164 . V_169 = V_362 ?
V_365 : V_366 ;
V_164 . V_165 = V_359 ;
V_164 . V_167 = F_184 ( V_360 ) ;
V_164 . V_168 = V_361 ;
do {
V_12 = F_114 ( V_9 , & V_164 ) ;
if ( V_12 )
F_149 ( V_9 -> V_18 , L_39 ,
V_193 , F_185 ( V_359 ) , V_361 , V_12 ) ;
} while ( V_12 && V_362 && -- V_280 );
if ( ! V_280 )
F_6 ( V_9 -> V_18 , L_40 ,
V_193 , F_185 ( V_359 ) , V_361 ,
V_280 ) ;
return V_12 ;
}
int F_186 ( struct V_8 * V_9 , T_1 V_359 ,
T_1 * V_361 , T_2 V_362 )
{
struct V_163 V_164 = { 0 } ;
static const char * const V_363 [] = {
...
const char * V_367 = V_363 [ ! ! V_362 ] ;
int V_12 ;
int V_280 = V_364 ;
struct V_368 V_369 ;
struct V_368 V_370 ;
bool V_371 = false ;
if ( V_362 && ( V_9 -> V_34 & V_372 ) ) {
V_369 = V_9 -> V_373 ;
V_370 = V_369 ;
...
if ( V_12 )
F_149 ( V_9 -> V_18 , L_43 ,
V_367 , F_185 ( V_359 ) , V_12 ) ;
} while ( V_12 && V_362 && -- V_280 );
if ( ! V_280 )
F_6 ( V_9 -> V_18 , L_44 ,
V_367 , F_185 ( V_359 ) , V_280 ) ;
if ( V_361 && ! V_12 )
* V_361 = V_164 . V_168 ;
if ( V_362 && ( V_9 -> V_34 & V_372 )
&& V_371 )
...
static int F_188 ( struct V_8 * V_9 , struct V_163 * V_182 )
{
struct V_174 V_107 ;
unsigned long V_82 ;
T_2 V_382 ;
...
static int F_189 ( struct V_8 * V_9 , T_2 V_123 )
{
struct V_163 V_164 = { 0 } ;
int V_12 ;
if ( V_9 -> V_34 & V_387 ) {
...
V_164 . V_169 = V_366 ;
V_164 . V_165 = F_192 ( V_389 ) ;
V_164 . V_168 = V_123 ;
F_63 ( V_9 , false ) ;
V_12 = F_188 ( V_9 , & V_164 ) ;
F_78 ( V_9 ) ;
V_48:
return V_12 ;
}
...
{
V_9 -> V_373 . V_394 = V_395 ;
V_9 -> V_373 . V_396 = V_395 ;
V_9 -> V_373 . V_397 = 1 ;
V_9 -> V_373 . V_398 = 1 ;
V_9 -> V_373 . V_376 = V_379 ;
V_9 -> V_373 . V_374 = V_379 ;
V_9 -> V_373 . V_399 = 0 ;
}
static int F_199 ( struct V_8 * V_9 )
{
struct V_368 * V_373 = & V_9 -> V_400 . V_401 ;
if ( V_9 -> V_400 . V_402 )
return 0 ;
V_373 -> V_374 = V_377 ;
V_373 -> V_376 = V_377 ;
V_373 -> V_399 = V_403 ;
F_200 ( V_9 , F_192 ( V_404 ) ,
& V_373 -> V_397 ) ;
F_200 ( V_9 , F_192 ( V_405 ) ,
& V_373 -> V_398 ) ;
if ( ! V_373 -> V_397 || ! V_373 -> V_398 ) {
F_6 ( V_9 -> V_18 , L_52 ,
V_19 ,
V_373 -> V_397 ,
V_373 -> V_398 ) ;
...
F_200 ( V_9 , F_192 ( V_406 ) , & V_373 -> V_394 ) ;
if ( ! V_373 -> V_394 ) {
F_200 ( V_9 , F_192 ( V_407 ) ,
& V_373 -> V_394 ) ;
if ( ! V_373 -> V_394 ) {
F_6 ( V_9 -> V_18 , L_53 ,
V_19 , V_373 -> V_394 ) ;
...
F_201 ( V_9 , F_192 ( V_406 ) ,
& V_373 -> V_396 ) ;
if ( ! V_373 -> V_396 ) {
F_201 ( V_9 , F_192 ( V_407 ) ,
& V_373 -> V_396 ) ;
if ( ! V_373 -> V_396 ) {
F_6 ( V_9 -> V_18 , L_54 ,
V_19 , V_373 -> V_396 ) ;
...
{
int V_12 ;
if ( V_408 -> V_394 == V_9 -> V_373 . V_394 &&
V_408 -> V_396 == V_9 -> V_373 . V_396 &&
V_408 -> V_397 == V_9 -> V_373 . V_397 &&
V_408 -> V_398 == V_9 -> V_373 . V_398 &&
V_408 -> V_376 == V_9 -> V_373 . V_376 &&
V_408 -> V_374 == V_9 -> V_373 . V_374 &&
V_408 -> V_399 == V_9 -> V_373 . V_399 ) {
F_149 ( V_9 -> V_18 , L_55 , V_19 ) ;
return 0 ;
}
F_190 ( V_9 , F_192 ( V_409 ) , V_408 -> V_394 ) ;
F_190 ( V_9 , F_192 ( V_410 ) ,
V_408 -> V_397 ) ;
if ( V_408 -> V_376 == V_377 ||
V_408 -> V_376 == V_375 )
F_190 ( V_9 , F_192 ( V_411 ) , TRUE ) ;
else
F_190 ( V_9 , F_192 ( V_411 ) , FALSE ) ;
F_190 ( V_9 , F_192 ( V_412 ) , V_408 -> V_396 ) ;
F_190 ( V_9 , F_192 ( V_413 ) ,
V_408 -> V_398 ) ;
if ( V_408 -> V_374 == V_377 ||
V_408 -> V_374 == V_375 )
F_190 ( V_9 , F_192 ( V_414 ) , TRUE ) ;
else
F_190 ( V_9 , F_192 ( V_414 ) , FALSE ) ;
if ( V_408 -> V_376 == V_377 ||
V_408 -> V_374 == V_377 ||
V_408 -> V_376 == V_375 ||
V_408 -> V_374 == V_375 )
F_190 ( V_9 , F_192 ( V_415 ) ,
V_408 -> V_399 ) ;
V_12 = F_189 ( V_9 , V_408 -> V_376 << 4
| V_408 -> V_374 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 ,
L_56 , V_19 , V_12 ) ;
} else {
F_202 ( V_9 , V_416 , NULL ,
V_408 ) ;
memcpy ( & V_9 -> V_373 , V_408 ,
sizeof( struct V_368 ) ) ;
}
return V_12 ;
}
...
struct V_368 * V_417 )
{
struct V_368 V_418 = { 0 } ;
int V_12 ;
V_12 = F_202 ( V_9 , V_419 ,
V_417 , & V_418 ) ;
if ( V_12 )
memcpy ( & V_418 , V_417 , sizeof( V_418 ) ) ;
V_12 = F_187 ( V_9 , & V_418 ) ;
return V_12 ;
}
...
F_126 ( V_9 , V_420 ) ;
if ( F_143 ( V_9 ) )
F_41 ( V_9 , V_9 -> V_11 - 1 , V_421 ) ;
else
F_44 ( V_9 ) ;
F_29 ( V_9 , F_124 ( V_9 -> V_337 ) ,
V_422 ) ;
F_29 ( V_9 , F_125 ( V_9 -> V_337 ) ,
V_423 ) ;
F_29 ( V_9 , F_124 ( V_9 -> V_339 ) ,
V_424 ) ;
F_29 ( V_9 , F_125 ( V_9 -> V_339 ) ,
V_425 ) ;
F_156 () ;
V_21 = F_12 ( V_9 , V_37 ) ;
if ( ! ( F_32 ( V_21 ) ) ) {
...
static inline void F_206 ( struct V_8 * V_9 , bool V_25 )
{
int V_26 ;
F_29 ( V_9 , V_426 , V_76 ) ;
V_26 = F_10 ( V_9 , V_76 ,
...
static int F_211 ( struct V_8 * V_9 , bool V_362 )
{
int V_429 , V_184 , V_26 = 0 ;
if ( ! V_362 )
F_200 ( V_9 , F_192 ( V_405 ) ,
& V_429 ) ;
else
F_201 ( V_9 , F_192 ( V_405 ) ,
& V_429 ) ;
for ( V_184 = 0 ; V_184 < V_429 ; V_184 ++ ) {
if ( ! V_362 )
V_26 = F_190 ( V_9 ,
F_191 ( V_430 ,
F_212 ( V_184 ) ) ,
...
if ( V_26 ) {
F_6 ( V_9 -> V_18 , L_63 ,
V_19 , V_362 , V_184 , V_26 ) ;
break;
}
}
return V_26 ;
}
static inline int F_214 ( struct V_8 * V_9 )
{
return F_211 ( V_9 , true ) ;
}
...
V_12 = F_216 ( V_9 , V_416 ) ;
if ( V_12 )
goto V_48;
V_12 = F_205 ( V_9 ) ;
V_48:
if ( V_12 )
F_6 ( V_9 -> V_18 , L_65 , V_12 ) ;
return V_12 ;
}
...
F_63 ( V_9 , false ) ;
F_115 ( & V_9 -> V_141 . V_283 ) ;
for ( V_280 = V_434 ; V_280 > 0 ; V_280 -- ) {
V_26 = F_153 ( V_9 , V_239 ,
V_435 ) ;
if ( ! V_26 || V_26 == - V_29 )
break;
F_149 ( V_9 -> V_18 , L_66 , V_19 , V_26 ) ;
}
F_117 ( & V_9 -> V_141 . V_283 ) ;
F_78 ( V_9 ) ;
if ( V_26 )
...
static void F_218 ( struct V_436 * V_437 )
{
int V_12 = 0 ;
T_2 V_438 ;
struct V_8 * V_9 ;
V_9 = F_139 ( V_437 -> V_86 ) ;
V_438 = V_9 -> V_11 ;
V_12 = F_175 ( V_9 ,
F_135 ( V_437 -> V_221 ) ,
V_439 ,
...
V_438 = F_101 ( int , V_438 , V_9 -> V_11 ) ;
F_149 ( V_9 -> V_18 , L_68 ,
V_19 , V_438 ) ;
F_219 ( V_437 , V_438 ) ;
}
...
static inline void F_221 ( struct V_8 * V_9 ,
struct V_436 * V_437 )
{
if ( V_9 -> V_442 . V_443 &&
! V_9 -> V_442 . V_444 ) {
T_2 V_440 ;
if ( ! F_220 ( V_9 , F_135 ( V_437 -> V_221 ) ,
& V_440 ) &&
( V_440 == V_445 ) )
V_9 -> V_442 . V_444 = true ;
}
}
static int F_222 ( struct V_436 * V_437 )
{
struct V_8 * V_9 ;
V_9 = F_139 ( V_437 -> V_86 ) ;
V_437 -> V_446 = 1 ;
...
static int F_223 ( struct V_436 * V_437 , int V_449 )
{
struct V_8 * V_9 = F_139 ( V_437 -> V_86 ) ;
if ( V_449 > V_9 -> V_11 )
V_449 = V_9 -> V_11 ;
return F_219 ( V_437 , V_449 ) ;
}
static int F_224 ( struct V_436 * V_437 )
{
struct V_450 * V_451 = V_437 -> V_450 ;
F_225 ( V_451 , V_452 - 1 ) ;
F_226 ( V_451 , V_453 ) ;
return 0 ;
}
static void F_227 ( struct V_436 * V_437 )
{
struct V_8 * V_9 ;
V_9 = F_139 ( V_437 -> V_86 ) ;
if ( F_135 ( V_437 -> V_221 ) == V_454 ) {
unsigned long V_82 ;
F_53 ( V_9 -> V_86 -> V_87 , V_82 ) ;
V_9 -> V_455 = NULL ;
F_54 ( V_9 -> V_86 -> V_87 , V_82 ) ;
...
static int F_228 ( struct V_8 * V_9 , T_1 V_276 , T_2 * V_260 )
{
struct V_45 * V_46 ;
struct V_456 * V_457 ;
unsigned long V_82 ;
...
static inline int
F_229 ( struct V_39 * V_40 , int V_463 )
{
int V_464 = 0 ;
switch ( V_463 ) {
case V_465 :
...
static inline int
F_230 ( struct V_8 * V_9 , struct V_39 * V_40 )
{
int V_464 = 0 ;
int V_463 ;
int V_472 ;
...
static void F_231 ( struct V_8 * V_9 , T_1 V_486 )
{
if ( ( V_486 & V_384 ) && V_9 -> V_106 ) {
V_9 -> V_106 -> V_167 |=
F_33 ( V_9 ) ;
V_9 -> V_106 -> V_168 =
F_34 ( V_9 ) ;
...
int V_464 ;
int V_276 ;
F_233 (index, &completed_reqs, hba->nutrs) {
V_40 = & V_9 -> V_255 [ V_276 ] ;
V_182 = V_40 -> V_182 ;
if ( V_182 ) {
V_464 = F_230 ( V_9 , V_40 ) ;
F_234 ( V_182 ) ;
V_182 -> V_464 = V_464 ;
V_40 -> V_182 = NULL ;
...
static int F_236 ( struct V_8 * V_9 , T_5 V_22 )
{
int V_26 = 0 ;
T_1 V_20 ;
if ( ! ( V_9 -> V_490 & V_22 ) )
...
static inline int F_241 ( struct V_8 * V_9 , T_1 * V_382 )
{
return F_163 ( V_9 , V_296 ,
V_495 , 0 , 0 , V_382 ) ;
}
...
{
return F_242 ( V_9 , V_9 -> V_499 ) ;
}
static inline int F_244 ( struct V_8 * V_9 , T_1 * V_382 )
{
return F_163 ( V_9 , V_296 ,
V_500 , 0 , 0 , V_382 ) ;
}
...
static void F_246 ( struct V_80 * V_81 )
{
struct V_8 * V_9 ;
int V_26 ;
T_1 V_382 = 0 ;
...
static void F_252 ( struct V_80 * V_81 )
{
struct V_8 * V_9 ;
unsigned long V_82 ;
T_1 V_514 = 0 ;
...
goto V_522;
F_54 ( V_9 -> V_86 -> V_87 , V_82 ) ;
F_233 (tag, &hba->outstanding_reqs, hba->nutrs) {
if ( F_145 ( V_9 , V_10 ) ) {
V_514 = true ;
goto V_523;
}
}
F_233 (tag, &hba->outstanding_tasks, hba->nutmrs) {
if ( F_253 ( V_9 , V_10 ) ) {
V_515 = true ;
goto V_523;
}
...
static void F_259 ( struct V_8 * V_9 , T_1 V_486 )
{
...
static int F_253 ( struct V_8 * V_9 , int V_10 )
{
int V_26 = 0 ;
T_1 V_22 = 1 << V_10 ;
unsigned long V_82 ;
if ( ! F_262 ( V_10 , & V_9 -> V_105 ) )
goto V_48;
F_53 ( V_9 -> V_86 -> V_87 , V_82 ) ;
...
static int F_263 ( struct V_8 * V_9 , int V_552 , int V_553 ,
T_2 V_554 , T_2 * V_555 )
{
struct V_45 * V_46 ;
struct V_556 * V_557 ;
...
F_54 ( V_86 -> V_87 , V_82 ) ;
V_26 = F_264 ( V_9 -> V_541 ,
F_262 ( V_47 , & V_9 -> V_540 ) ,
F_11 ( V_563 ) ) ;
if ( ! V_26 ) {
F_6 ( V_9 -> V_18 , L_85 ,
V_19 , V_554 ) ;
...
V_26 = F_228 ( V_9 , V_47 , V_555 ) ;
}
F_266 ( V_47 , & V_9 -> V_540 ) ;
F_26 ( V_9 , V_47 ) ;
F_157 ( & V_9 -> V_558 ) ;
F_78 ( V_9 ) ;
return V_26 ;
}
static int F_267 ( struct V_181 * V_182 )
{
struct V_247 * V_86 ;
struct V_8 * V_9 ;
unsigned int V_10 ;
...
V_10 = V_182 -> V_154 -> V_10 ;
V_40 = & V_9 -> V_255 [ V_10 ] ;
V_26 = F_263 ( V_9 , V_40 -> V_221 , 0 , V_564 , & V_260 ) ;
if ( V_26 || V_260 != V_565 ) {
if ( ! V_26 )
V_26 = V_260 ;
goto V_48;
}
F_233 (pos, &hba->outstanding_reqs, hba->nutrs) {
...
V_26 = F_263 ( V_9 , V_40 -> V_221 , V_40 -> V_131 ,
V_569 , & V_260 ) ;
if ( ! V_26 && V_260 == V_570 ) {
break;
...
static int F_270 ( struct V_181 * V_182 )
{
int V_26 ;
unsigned long V_82 ;
struct V_8 * V_9 ;
V_9 = F_139 ( V_182 -> V_111 -> V_86 ) ;
F_63 ( V_9 , false ) ;
do {
F_53 ( V_9 -> V_86 -> V_87 , V_82 ) ;
if ( ! ( F_271 ( & V_9 -> V_517 ) ||
...
static T_1 F_272 ( int V_574 , T_1 V_575 , char * V_576 )
{
int V_184 ;
int V_577 ;
T_5 V_578 ;
...
if ( V_184 < 0 ) {
V_184 = 0 ;
F_273 ( L_92 , V_19 , V_184 ) ;
}
return ( T_1 ) V_184 ;
}
static T_1 F_274 ( struct V_8 * V_9 ,
T_2 * V_298 , int V_133 )
{
T_1 V_587 = 0 ;
...
struct V_436 * V_600 ;
struct V_436 * V_601 ;
V_9 -> V_455 = F_277 ( V_9 -> V_86 , 0 , 0 ,
F_137 ( V_454 ) , NULL ) ;
if ( F_278 ( V_9 -> V_455 ) ) {
V_12 = F_279 ( V_9 -> V_455 ) ;
V_9 -> V_455 = NULL ;
goto V_48;
}
F_280 ( V_9 -> V_455 ) ;
V_601 = F_277 ( V_9 -> V_86 , 0 , 0 ,
F_137 ( V_602 ) , NULL ) ;
if ( F_278 ( V_601 ) ) {
V_12 = F_279 ( V_601 ) ;
goto V_603;
...
void F_284 ( struct V_8 * V_9 )
{
int V_26 ;
struct V_617 * V_618 ;
struct V_605 V_606 ;
V_606 . V_611 = 0 ;
V_26 = F_282 ( V_9 , & V_606 ) ;
if ( V_26 ) {
F_6 ( V_9 -> V_18 , L_99 ,
V_19 , V_26 ) ;
return;
...
( F_285 ( V_618 -> V_621 . V_615 , V_606 . V_615 ) ||
...
V_12 = F_203 ( V_9 , & V_9 -> V_400 . V_401 ) ;
if ( V_12 )
F_6 ( V_9 -> V_18 , L_101 ,
V_19 , V_12 ) ;
}
...
static void F_295 ( void * V_578 , T_8 V_645 )
{
struct V_8 * V_9 = (struct V_8 * ) V_578 ;
F_269 ( V_9 ) ;
}
static enum V_646 F_296 ( struct V_181 * V_647 )
{
unsigned long V_82 ;
struct V_247 * V_86 ;
struct V_8 * V_9 ;
...
return V_649 ;
F_53 ( V_86 -> V_87 , V_82 ) ;
F_233 (index, &hba->outstanding_reqs, hba->nutrs) {
...
static int F_297 ( struct V_111 * V_18 , struct V_651 * V_652 ,
int V_653 )
{
int V_12 ;
if ( ! V_652 )
return 0 ;
V_12 = F_298 ( V_652 -> V_21 , V_653 ) ;
if ( V_12 < 0 ) {
F_6 ( V_18 , L_102 ,
...
static inline int F_299 ( struct V_8 * V_9 ,
struct V_651 * V_652 )
{
if ( ! V_652 )
return 0 ;
...
return F_297 ( V_9 -> V_18 , V_652 , V_652 -> V_592 ) ;
}
static int F_301 ( struct V_111 * V_18 ,
...
V_12 = F_303 ( V_21 , V_658 , V_652 -> V_660 ) ;
if ( V_12 ) {
F_6 ( V_18 , L_103 ,
V_19 , V_122 , V_12 ) ;
goto V_48;
...
static int F_304 ( struct V_111 * V_18 , struct V_651 * V_652 )
{
int V_12 = 0 ;
if ( ! V_652 )
goto V_48;
...
goto V_48;
V_12 = F_301 ( V_18 , V_652 , true ) ;
if ( ! V_12 )
V_12 = F_305 ( V_652 -> V_21 ) ;
if ( ! V_12 )
V_652 -> V_661 = true ;
else
F_6 ( V_18 , L_104 ,
...
static int F_306 ( struct V_111 * V_18 , struct V_651 * V_652 )
{
int V_12 = 0 ;
if ( ! V_652 )
goto V_48;
...
goto V_48;
V_12 = F_307 ( V_652 -> V_21 ) ;
if ( ! V_12 ) {
F_301 ( V_18 , V_652 , false ) ;
V_652 -> V_661 = false ;
} else {
F_6 ( V_18 , L_105 ,
V_19 , V_652 -> V_122 , V_12 ) ;
...
static int F_308 ( struct V_8 * V_9 , bool V_656 )
{
int V_12 = 0 ;
struct V_111 * V_18 = V_9 -> V_18 ;
struct V_662 * V_401 = & V_9 -> V_588 ;
if ( ! V_401 )
goto V_48;
V_12 = F_309 ( V_18 , V_401 -> V_589 , V_656 ) ;
if ( V_12 )
goto V_48;
V_12 = F_309 ( V_18 , V_401 -> V_590 , V_656 ) ;
if ( V_12 )
goto V_48;
V_12 = F_309 ( V_18 , V_401 -> V_591 , V_656 ) ;
if ( V_12 )
goto V_48;
V_48:
if ( V_12 ) {
F_309 ( V_18 , V_401 -> V_591 , false ) ;
F_309 ( V_18 , V_401 -> V_590 , false ) ;
F_309 ( V_18 , V_401 -> V_589 , false ) ;
}
return V_12 ;
}
static int F_310 ( struct V_8 * V_9 , bool V_656 )
{
struct V_662 * V_401 = & V_9 -> V_588 ;
if ( V_401 )
return F_309 ( V_9 -> V_18 , V_401 -> V_663 , V_656 ) ;
return 0 ;
}
static int F_311 ( struct V_111 * V_18 , struct V_651 * V_652 )
{
int V_12 = 0 ;
if ( ! V_652 )
goto V_48;
V_652 -> V_21 = F_312 ( V_18 , V_652 -> V_122 ) ;
if ( F_278 ( V_652 -> V_21 ) ) {
V_12 = F_279 ( V_652 -> V_21 ) ;
F_6 ( V_18 , L_106 ,
V_19 , V_652 -> V_122 , V_12 ) ;
}
V_48:
...
if ( ! V_401 )
goto V_48;
V_12 = F_311 ( V_18 , V_401 -> V_589 ) ;
if ( V_12 )
goto V_48;
V_12 = F_311 ( V_18 , V_401 -> V_590 ) ;
if ( V_12 )
goto V_48;
V_12 = F_311 ( V_18 , V_401 -> V_591 ) ;
V_48:
return V_12 ;
}
...
struct V_662 * V_401 = & V_9 -> V_588 ;
if ( V_401 )
return F_311 ( V_9 -> V_18 , V_401 -> V_663 ) ;
return 0 ;
}
static int F_291 ( struct V_8 * V_9 , bool V_654 )
{
int V_12 = 0 ;
struct V_662 * V_401 = & V_9 -> V_588 ;
if ( ! V_401 )
...
goto V_48;
if ( V_654 ) {
V_12 = F_309 ( V_9 -> V_18 , V_401 -> V_590 , false ) ;
if ( ! V_12 )
V_401 -> V_590 -> V_654 = true ;
} else {
V_401 -> V_590 -> V_654 = false ;
}
V_48:
return V_12 ;
}
...
unsigned long V_82 ;
if ( ! V_668 || F_315 ( V_668 ) )
goto V_48;
F_316 (clki, head, list) {
if ( ! F_317 ( V_666 -> V_670 ) ) {
if ( V_664 && ! strcmp ( V_666 -> V_122 , L_107 ) )
continue;
if ( V_656 && ! V_666 -> V_661 ) {
V_12 = F_318 ( V_666 -> V_670 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 , L_108 ,
...
V_666 -> V_661 = V_656 ;
F_149 ( V_9 -> V_18 , L_109 , V_19 ,
V_666 -> V_122 , V_656 ? L_110 : L_111 ) ;
}
}
V_12 = F_320 ( V_9 , V_656 ) ;
V_48:
if ( V_12 ) {
F_316 (clki, head, list) {
if ( ! F_317 ( V_666 -> V_670 ) && V_666 -> V_661 )
F_319 ( V_666 -> V_670 ) ;
}
} else if ( V_656 ) {
F_53 ( V_9 -> V_86 -> V_87 , V_82 ) ;
...
if ( ! V_666 -> V_122 )
continue;
V_666 -> V_670 = F_322 ( V_18 , V_666 -> V_122 ) ;
if ( F_278 ( V_666 -> V_670 ) ) {
V_12 = F_279 ( V_666 -> V_670 ) ;
F_6 ( V_18 , L_112 ,
V_19 , V_666 -> V_122 , V_12 ) ;
goto V_48;
}
if ( V_666 -> V_671 ) {
V_12 = F_323 ( V_666 -> V_670 , V_666 -> V_671 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 , L_113 ,
V_19 , V_666 -> V_122 ,
V_666 -> V_671 , V_12 ) ;
...
F_149 ( V_18 , L_114 , V_19 ,
V_666 -> V_122 , F_324 ( V_666 -> V_670 ) ) ;
}
V_48:
return V_12 ;
}
...
static int F_331 ( struct V_8 * V_9 )
{
int V_26 ;
V_26 = F_314 ( V_9 ) ;
if ( V_26 )
...
static int
F_332 ( struct V_8 * V_9 , struct V_436 * V_679 )
{
...
char * V_681 ;
int V_12 ;
V_681 = F_333 ( V_138 , V_310 ) ;
if ( ! V_681 ) {
V_12 = - V_311 ;
goto V_48;
}
V_12 = F_334 ( V_679 , V_182 , V_203 , V_681 ,
V_138 , NULL ,
F_11 ( 1000 ) , 3 , NULL , V_682 ) ;
if ( V_12 )
F_273 ( L_87 , V_19 , V_12 ) ;
F_169 ( V_681 ) ;
V_48:
return V_12 ;
}
...
V_9 -> V_86 -> V_687 = 1 ;
if ( V_9 -> V_641 ) {
V_12 = F_332 ( V_9 , V_679 ) ;
if ( V_12 )
goto V_48;
V_9 -> V_641 = false ;
}
V_182 [ 4 ] = V_408 << 4 ;
V_12 = F_334 ( V_679 , V_182 , V_237 , NULL , 0 , & V_685 ,
V_688 , 0 , NULL , V_682 ) ;
if ( V_12 ) {
F_338 ( V_689 , V_679 ,
L_116 ,
...
V_9 -> V_518 & V_696 )
F_13 ( 2000 , 2100 ) ;
if ( F_343 ( V_9 ) && F_344 ( V_9 ) &&
! V_9 -> V_442 . V_444 ) {
F_308 ( V_9 , false ) ;
} else if ( ! F_345 ( V_9 ) ) {
F_309 ( V_9 -> V_18 , V_9 -> V_588 . V_589 , false ) ;
if ( ! F_74 ( V_9 ) ) {
F_299 ( V_9 , V_9 -> V_588 . V_590 ) ;
F_299 ( V_9 , V_9 -> V_588 . V_591 ) ;
}
}
}
...
V_12 = F_309 ( V_9 -> V_18 , V_9 -> V_588 . V_589 , true ) ;
if ( ! V_12 && ! F_74 ( V_9 ) ) {
V_12 = F_300 ( V_9 , V_9 -> V_588 . V_590 ) ;
if ( V_12 )
goto V_697;
V_12 = F_300 ( V_9 , V_9 -> V_588 . V_591 ) ;
if ( V_12 )
goto V_698;
}
}
...
static void F_347 ( struct V_8 * V_9 )
{
if ( F_344 ( V_9 ) )
F_310 ( V_9 , false ) ;
}
...
static int F_349 ( struct V_8 * V_9 , enum V_699 V_700 )
{
int V_12 = 0 ;
enum V_2 V_701 ;
enum V_1 V_702 ;
...
if ( ( V_702 != V_9 -> V_691 ) &&
( ( F_351 ( V_700 ) && ! V_9 -> V_492 ) ||
! F_351 ( V_700 ) ) ) {
F_239 ( V_9 ) ;
V_12 = F_335 ( V_9 , V_702 ) ;
if ( V_12 )
goto V_709;
}
V_12 = F_341 ( V_9 , V_692 , 1 ) ;
if ( V_12 )
goto V_710;
F_342 ( V_9 ) ;
V_708:
...
V_12 = F_353 ( V_9 , V_700 ) ;
if ( V_12 )
goto V_711;
V_12 = F_320 ( V_9 , false ) ;
if ( V_12 )
goto V_712;
if ( ! F_74 ( V_9 ) )
F_55 ( V_9 , false ) ;
...
static int F_355 ( struct V_8 * V_9 , enum V_699 V_700 )
{
int V_12 ;
enum V_6 V_713 ;
V_9 -> V_475 = 1 ;
...
{
if ( ! V_9 || ! V_9 -> V_678 || F_357 ( V_9 -> V_18 ) )
return 0 ;
return F_355 ( V_9 , V_718 ) ;
}
int F_360 ( struct V_8 * V_9 )
{
if ( ! V_9 || ! V_9 -> V_678 )
return 0 ;
return F_349 ( V_9 , V_720 ) ;
}
int F_358 ( struct V_8 * V_9 )
{
if ( ! V_9 || ! V_9 -> V_678 )
return 0 ;
else
return F_355 ( V_9 , V_720 ) ;
}
...
V_12 = F_349 ( V_9 , V_721 ) ;
V_48:
if ( V_12 )
F_6 ( V_9 -> V_18 , L_117 , V_19 , V_12 ) ;
return 0 ;
}
void F_363 ( struct V_8 * V_9 )
{
F_364 ( V_9 -> V_86 ) ;
F_127 ( V_9 , V_9 -> V_722 ) ;
F_206 ( V_9 , true ) ;
...
{
if ( V_9 -> V_158 & V_723 ) {
if ( ! F_369 ( V_9 -> V_18 , F_370 ( 64 ) ) )
return 0 ;
}
return F_369 ( V_9 -> V_18 , F_370 ( 32 ) ) ;
}
int F_371 ( struct V_111 * V_18 , struct V_8 * * V_724 )
{
struct V_247 * V_86 ;
struct V_8 * V_9 ;
int V_26 = 0 ;
...
static int F_373 ( struct V_8 * V_9 , bool V_727 )
{
int V_12 = 0 ;
struct V_665 * V_666 ;
struct V_667 * V_668 = & V_9 -> V_669 ;
...
continue;
V_12 = F_323 ( V_666 -> V_670 , V_666 -> V_728 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 , L_113 ,
V_19 , V_666 -> V_122 ,
V_666 -> V_728 , V_12 ) ;
...
F_149 ( V_9 -> V_18 , L_114 , V_19 ,
V_666 -> V_122 , F_324 ( V_666 -> V_670 ) ) ;
}
V_12 = F_374 ( V_9 , V_727 , V_416 ) ;
V_48:
return V_12 ;
}
static int F_375 ( struct V_111 * V_18 ,
...
int F_378 ( struct V_8 * V_9 , void T_9 * V_736 , unsigned int V_14 )
{
int V_26 ;
...
V_86 -> V_748 = V_227 ;
V_9 -> V_400 . V_402 = false ;
F_379 ( & V_9 -> V_541 ) ;
F_379 ( & V_9 -> V_558 ) ;
F_85 ( & V_9 -> V_517 , F_252 ) ;
F_85 ( & V_9 -> V_476 , F_246 ) ;
F_380 ( & V_9 -> V_176 ) ;
F_380 ( & V_9 -> V_141 . V_283 ) ;
F_379 ( & V_9 -> V_141 . V_271 ) ;
F_83 ( V_9 ) ;
F_29 ( V_9 , F_12 ( V_9 , V_549 ) ,
V_549 ) ;
F_29 ( V_9 , 0 , V_194 ) ;
F_381 () ;
V_26 = F_382 ( V_18 , V_14 , V_15 , V_16 , V_17 , V_9 ) ;
if ( V_26 ) {
F_6 ( V_9 -> V_18 , L_123 ) ;
goto V_749;
} else {
