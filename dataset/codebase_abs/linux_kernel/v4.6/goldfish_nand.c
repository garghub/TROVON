...
static int F_14 ( struct V_1 * V_2 , T_4 V_58 , T_6 V_6 ,
T_6 * V_55 , T_7 * V_59 )
{
T_5 V_40 ;
if ( V_58 + V_6 > V_2 -> V_41 )
goto V_42;
V_58 = F_9 ( V_58 , V_2 -> V_43 , & V_40 ) ;
if ( V_40 )
goto V_42;
...
static int F_15 ( struct V_1 * V_2 , T_4 V_60 , T_6 V_6 ,
T_6 * V_55 , const T_7 * V_59 )
{
T_5 V_40 ;
if ( V_60 + V_6 > V_2 -> V_41 )
goto V_42;
V_60 = F_9 ( V_60 , V_2 -> V_43 , & V_40 ) ;
if ( V_40 )
goto V_42;
...
F_2 ( ( T_1 ) ( ( T_2 ) V_65 >> 32 ) , V_15 + V_68 ) ;
F_2 ( ( T_1 ) V_65 , V_15 + V_69 ) ;
return 0 ;
}
static int F_21 ( struct V_63 * V_64 ,
struct V_10 * V_11 , int V_70 )
{
T_1 V_71 ;
T_1 V_28 ;
T_1 V_72 ;
unsigned char T_3 * V_15 = V_11 -> V_15 ;
struct V_1 * V_2 = & V_11 -> V_2 [ V_70 ] ;
char * V_73 ;
F_4 ( & V_11 -> V_29 ) ;
F_2 ( V_70 , V_15 + V_30 ) ;
V_72 = F_6 ( V_15 + V_74 ) ;
V_71 = F_6 ( V_15 + V_75 ) ;
V_2 -> V_43 = F_6 ( V_15 + V_76 ) ;
V_2 -> V_41 = F_6 ( V_15 + V_77 ) ;
V_2 -> V_41 |= ( T_2 ) F_6 ( V_15 + V_78 ) << 32 ;
V_2 -> V_44 = F_6 ( V_15 + V_79 ) ;
V_2 -> V_80 = V_2 -> V_44 ;
V_2 -> V_45 = F_6 ( V_15 + V_81 ) /
( V_2 -> V_43 + V_2 -> V_44 ) * V_2 -> V_43 ;
V_2 -> V_41 = F_22 ( V_2 -> V_41 , V_2 -> V_43 + V_2 -> V_44 ) ;
V_2 -> V_41 *= V_2 -> V_43 ;
F_23 ( & V_64 -> V_22 ,
L_10 ,
V_70 , V_2 -> V_41 , V_2 -> V_43 ,
V_2 -> V_44 , V_2 -> V_45 ) ;
F_7 ( & V_11 -> V_29 ) ;
V_2 -> V_12 = V_11 ;
V_73 = F_24 ( & V_64 -> V_22 , V_71 + 1 , V_66 ) ;
if ( ! V_73 )
return - V_67 ;
V_2 -> V_73 = V_73 ;
V_28 = F_3 ( V_2 , V_82 , 0 , V_71 ,
V_73 ) ;
if ( V_28 != V_71 ) {
F_20 ( & V_64 -> V_22 ,
L_11 ,
...
V_104 = F_27 ( V_64 , V_105 , 0 ) ;
if ( ! V_104 )
return - V_83 ;
V_15 = F_28 ( & V_64 -> V_22 , V_104 -> V_106 , V_107 ) ;
if ( ! V_15 )
return - V_67 ;
...
if ( V_98 == 0 )
return - V_83 ;
V_11 = F_24 ( & V_64 -> V_22 , sizeof( * V_11 ) +
...
{
struct V_10 * V_11 = F_32 ( V_64 ) ;
int V_99 ;
for ( V_99 = 0 ; V_99 < V_11 -> V_111 ; V_99 ++ ) {
if ( V_11 -> V_2 [ V_99 ] . V_73 )
F_33 ( & V_11 -> V_2 [ V_99 ] ) ;
}
return 0 ;
}
