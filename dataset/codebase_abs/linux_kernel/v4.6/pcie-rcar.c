...
static void F_109 ( struct V_4 * V_53 )
{
F_110 ( & V_53 -> V_179 ) ;
}
static int F_111 ( struct V_4 * V_53 )
{
int V_82 ;
struct V_180 * V_17 = V_53 -> V_17 ;
struct V_170 * V_176 = V_17 -> V_138 ;
T_2 V_181 ;
struct V_54 * V_42 ;
V_82 = F_112 ( V_176 , 0 , 0xff , & V_53 -> V_179 , & V_181 ) ;
if ( V_82 )
return V_82 ;
F_32 (win, &pci->resources) {
...
static int F_116 ( struct V_135 * V_117 )
{
struct V_4 * V_5 ;
unsigned int V_11 ;
const struct V_185 * V_186 ;
int V_82 ;
int (* F_117)( struct V_4 * );
V_5 = F_118 ( & V_117 -> V_17 , sizeof( * V_5 ) , V_147 ) ;
if ( ! V_5 )
return - V_140 ;
V_5 -> V_17 = & V_117 -> V_17 ;
F_119 ( V_117 , V_5 ) ;
