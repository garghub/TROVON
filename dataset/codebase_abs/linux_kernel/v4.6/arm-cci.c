...
{
struct V_10 * V_10 = F_2 ( V_183 ,
struct V_10 , V_186 ) ;
unsigned int V_150 = ( long ) V_185 ;
unsigned int V_187 ;
switch ( V_184 & ~ V_188 ) {
case V_189 :
if ( ! F_108 ( V_150 , & V_10 -> V_160 ) )
break;
V_187 = F_109 ( V_190 , V_150 ) ;
if ( V_187 >= V_191 )
break;
F_110 ( V_187 , & V_10 -> V_160 ) ;
default:
break;
}
return V_192 ;
...
{
const struct V_193 * V_194 = F_112 ( V_195 ,
V_50 -> V_2 . V_196 ) ;
if ( ! V_194 )
return NULL ;
if ( V_194 -> V_197 )
...
static bool F_113 ( int V_198 , int * V_102 , int V_100 )
{
int V_69 ;
...
V_10 = F_116 ( & V_50 -> V_2 , sizeof( * V_10 ) , V_199 ) ;
if ( ! V_10 )
return F_115 ( - V_200 ) ;
V_10 -> V_36 = V_36 ;
V_10 -> V_102 = F_117 ( & V_50 -> V_2 , F_118 ( V_36 ) ,
sizeof( * V_10 -> V_102 ) , V_199 ) ;
if ( ! V_10 -> V_102 )
return F_115 ( - V_200 ) ;
...
struct V_201 * V_202 ;
struct V_10 * V_10 ;
int V_69 , V_126 , V_198 ;
V_10 = F_114 ( V_50 ) ;
if ( F_120 ( V_10 ) )
return F_121 ( V_10 ) ;
V_202 = F_122 ( V_50 , V_203 , 0 ) ;
V_10 -> V_84 = F_123 ( & V_50 -> V_2 , V_202 ) ;
if ( F_120 ( V_10 -> V_84 ) )
return - V_200 ;
V_10 -> V_100 = 0 ;
for ( V_69 = 0 ; V_69 < F_118 ( V_10 -> V_36 ) ; V_69 ++ ) {
V_198 = F_124 ( V_50 , V_69 ) ;
if ( V_198 < 0 )
break;
if ( F_113 ( V_198 , V_10 -> V_102 , V_10 -> V_100 ) )
continue;
V_10 -> V_102 [ V_10 -> V_100 ++ ] = V_198 ;
}
...
V_10 -> V_186 = (struct V_182 ) {
. V_204 = F_107 ,
. V_205 = V_206 + 1 ,
} ;
V_126 = F_129 ( & V_10 -> V_186 ) ;
if ( V_126 )
return V_126 ;
...
if ( ! F_133 () )
return - V_99 ;
return F_134 ( V_50 -> V_2 . V_196 , NULL , NULL , & V_50 -> V_2 ) ;
}
...
static inline void F_137 ( struct V_209 * V_210 , T_3 V_211 , T_6 V_212 )
{
V_210 -> V_210 = V_213 | V_211 ;
V_210 -> V_212 = V_212 ;
}
static inline bool F_138 ( struct V_209 * V_210 )
{
return ! ! ( V_210 -> V_210 & V_213 ) ;
}
static inline bool F_139 ( struct V_209 * V_210 , T_6 V_212 )
{
return V_210 -> V_212 == ( V_212 & V_214 ) ;
}
static int F_140 ( struct V_215 * V_216 , int type )
{
int V_69 ;
bool V_217 ;
struct V_215 * V_218 ;
V_218 = F_141 ( V_216 , L_18 , 0 ) ;
for ( V_69 = 0 ; V_69 < V_219 ; V_69 ++ ) {
V_217 = V_220 [ V_69 ] . type == type ;
if ( V_217 && V_218 == V_220 [ V_69 ] . V_216 )
return V_69 ;
}
return - V_99 ;
}
int F_142 ( struct V_215 * V_216 )
{
return F_140 ( V_216 , V_221 ) ;
}
...
struct V_215 * V_222 ;
F_144 (cpu) {
V_222 = F_145 ( V_150 , NULL ) ;
if ( F_146 ( ! V_222 , L_19 ) )
continue;
V_210 = F_140 ( V_222 , V_223 ) ;
if ( V_210 < 0 )
continue;
F_137 ( & V_209 [ V_150 ] , V_210 , F_147 ( V_150 ) ) ;
}
F_144 (cpu) {
F_146 ( ! F_138 ( & V_209 [ V_150 ] ) ,
L_20 ,
V_150 ) ;
}
}
static void T_10 F_148 ( unsigned int V_210 , bool V_224 )
{
void T_11 * V_84 = V_220 [ V_210 ] . V_84 ;
F_35 ( V_224 ? V_225 : 0 , V_84 + V_226 ) ;
while ( F_10 ( V_41 + V_227 ) & 0x1 )
;
}
int T_10 F_149 ( T_6 V_212 )
{
int V_150 ;
bool V_228 ;
for ( V_150 = 0 ; V_150 < V_191 ; V_150 ++ ) {
V_228 = F_138 ( & V_209 [ V_150 ] ) ;
if ( V_228 && F_139 ( & V_209 [ V_150 ] , V_212 ) ) {
F_148 ( V_209 [ V_150 ] . V_210 , false ) ;
return 0 ;
}
}
return - V_99 ;
...
int T_10 F_153 ( struct V_215 * V_216 , bool V_224 )
{
int V_210 ;
if ( ! V_216 )
return - V_99 ;
V_210 = F_140 ( V_216 , V_221 ) ;
if ( F_154 ( V_210 < 0 , L_21 ,
V_216 -> V_229 ) )
return - V_99 ;
F_148 ( V_210 , V_224 ) ;
return 0 ;
}
int T_10 F_155 ( T_3 V_210 , bool V_224 )
{
if ( V_210 >= V_219 || V_220 [ V_210 ] . type == V_230 )
return - V_99 ;
if ( V_220 [ V_210 ] . type == V_223 )
return - V_231 ;
F_148 ( V_210 , V_224 ) ;
return 0 ;
}
static int F_156 ( struct V_215 * V_232 )
{
struct V_233 const * V_234 ;
int V_126 , V_69 , V_235 = 0 , V_236 = 0 ;
struct V_215 * V_237 ;
struct V_201 V_202 ;
const char * V_238 ;
bool V_239 ;
V_234 = F_112 ( V_240 , V_232 ) -> V_197 ;
if ( ! V_234 )
return - V_99 ;
V_219 = V_234 -> V_235 + V_234 -> V_236 ;
V_220 = F_157 ( V_219 , sizeof( * V_220 ) , V_199 ) ;
if ( ! V_220 )
return - V_200 ;
F_158 (np, cp) {
if ( ! F_112 ( V_241 , V_237 ) )
continue;
V_69 = V_235 + V_236 ;
if ( V_69 >= V_219 )
break;
...
V_126 = F_160 ( V_237 , 0 , & V_202 ) ;
if ( ! V_126 ) {
V_220 [ V_69 ] . V_84 = F_161 ( V_202 . V_176 , F_162 ( & V_202 ) ) ;
V_220 [ V_69 ] . V_242 = V_202 . V_176 ;
}
if ( V_126 || ! V_220 [ V_69 ] . V_84 ) {
F_146 ( 1 , L_27 , V_69 ) ;
continue;
}
if ( V_239 ) {
if ( F_22 ( V_235 >= V_234 -> V_235 ) )
continue;
V_220 [ V_69 ] . type = V_223 ;
++ V_235 ;
} else {
if ( F_22 ( V_236 >= V_234 -> V_236 ) )
continue;
V_220 [ V_69 ] . type = V_221 ;
++ V_236 ;
}
V_220 [ V_69 ] . V_216 = V_237 ;
}
F_143 () ;
F_163 ( & V_41 ) ;
F_163 ( & V_243 ) ;
F_163 ( & V_220 ) ;
F_163 ( & V_209 ) ;
F_164 ( V_220 , sizeof( * V_220 ) * V_219 ) ;
F_131 ( L_28 ) ;
return 0 ;
}
static inline int F_156 ( struct V_215 * V_232 )
{
return 0 ;
}
...
struct V_215 * V_232 ;
struct V_201 V_202 ;
V_232 = F_166 ( NULL , V_240 ) ;
if( ! V_232 || ! F_167 ( V_232 ) )
return - V_99 ;
V_126 = F_160 ( V_232 , 0 , & V_202 ) ;
if ( ! V_126 ) {
V_41 = F_161 ( V_202 . V_176 , F_162 ( & V_202 ) ) ;
V_243 = V_202 . V_176 ;
}
if ( V_126 || ! V_41 ) {
F_146 ( 1 , L_29 ) ;
