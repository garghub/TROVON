...
V_55 |= V_63 ;
V_53 = F_46 ( V_18 -> V_52 , V_2 -> V_30 , NULL ,
F_27 ,
...
static int F_62 ( struct V_1 * V_2 , struct V_76 * V_77 ,
...
V_11 = V_2 -> V_22 -> V_23 ( V_2 , V_75 , V_79 -> V_18 [ V_80 ] . V_109 ) ;
if ( V_11 < 0 )
goto V_102;
...
{
struct V_78 * V_79 , V_115 ;
struct V_1 * V_2 ;
int V_11 ;
const struct V_116 * V_117 ;
V_117 = F_70 ( F_71 ( V_118 ) ,
& V_112 -> V_77 ) ;
if ( V_117 ) {
V_79 = & V_115 ;
V_79 -> V_74 = - 1 ;
...
V_112 -> V_77 . V_58 ,
L_20 ) ;
V_79 -> V_81 = F_66 ( V_112 -> V_77 . V_58 ,
L_21 ) ;
V_112 -> V_30 = F_72 ( V_112 -> V_77 . V_58 , 0 ) ;
} else {
V_79 = F_73 ( & V_112 -> V_77 ) ;
if ( ! V_79 ) {
V_79 = F_74 ( & V_112 -> V_77 ,
sizeof( struct V_78 ) ,
V_119 ) ;
if ( ! V_79 )
return - V_120 ;
...
V_2 = F_75 ( sizeof( * V_2 ) , V_119 ) ;
if ( ! V_2 )
return - V_120 ;
V_2 -> V_30 = V_112 -> V_30 ;
V_11 = F_62 ( V_2 , & V_112 -> V_77 , V_112 , V_112 -> V_12 ,
V_114 -> V_121 , V_79 , 0 ) ;
if ( V_11 )
goto V_102;
F_76 ( V_112 , V_2 ) ;
...
{
struct V_1 * V_2 = F_79 ( V_112 ) ;
if ( V_112 -> V_30 && V_2 -> V_103 )
F_54 ( V_2 ) ;
F_80 ( & V_2 -> V_18 ) ;
F_77 ( V_2 ) ;
return 0 ;
...
const struct V_116 * V_117 ;
T_5 V_127 = 0 ;
V_117 = F_70 ( F_71 ( V_128 ) , & V_124 -> V_77 ) ;
if ( V_117 ) {
type = ( int ) ( V_129 ) V_117 -> V_4 ;
V_11 = F_86 ( V_124 -> V_77 . V_58 ,
L_22 , & V_127 ) ;
if ( V_11 ) {
V_11 = F_86 ( V_124 -> V_77 . V_58 ,
L_23 , & V_127 ) ;
...
F_40 ( & V_124 -> V_77 , L_25 ) ;
return - V_60 ;
}
V_79 = & V_115 ;
V_79 -> V_74 = - 1 ;
for ( V_12 = 0 ; V_12 < F_58 ( V_79 -> V_18 ) ; V_12 ++ ) {
V_79 -> V_18 [ V_12 ] . V_109 = 0 ;
if ( V_127 & ( 1 << V_12 ) )
V_125 ++ ;
}
V_79 -> V_103 = F_66 (
V_124 -> V_77 . V_58 ,
L_20 ) ;
V_79 -> V_81 = F_66 ( V_124 -> V_77 . V_58 ,
L_21 ) ;
} else {
type = F_87 ( V_124 ) -> V_121 ;
V_79 = F_73 ( & V_124 -> V_77 ) ;
if ( ! V_79 ) {
V_79 = F_74 ( & V_124 -> V_77 ,
sizeof( struct V_78 ) ,
V_119 ) ;
V_79 -> V_74 = - 1 ;
}
for ( V_12 = 0 ; V_12 < F_58 ( V_79 -> V_18 ) ; V_12 ++ ) {
if ( ! V_79 -> V_18 [ V_12 ] . V_130 )
continue;
V_125 ++ ;
if ( ( type == V_88 ) && ( V_12 > 3 ) ) {
F_40 ( & V_124 -> V_77 ,
...
return - V_120 ;
F_88 ( V_124 , V_4 ) ;
V_124 -> V_30 = F_72 ( V_124 -> V_77 . V_58 , 0 ) ;
for ( V_12 = 0 ; V_12 < F_58 ( V_79 -> V_18 ) ; V_12 ++ ) {
if ( ! ( V_127 & ( 1 << V_12 ) ) )
continue;
V_125 -- ;
...
V_11 = F_62 ( V_4 -> V_2 [ V_12 ] , & V_124 -> V_77 , V_124 ,
0x40 | ( V_12 << 1 ) , type , V_79 ,
V_12 ) ;
if ( V_11 < 0 )
goto V_102;
if ( V_79 -> V_74 != - 1 )
V_79 -> V_74 += V_4 -> V_2 [ V_12 ] -> V_18 . V_38 ;
...
static int F_89 ( struct V_123 * V_124 )
{
struct V_126 * V_4 = F_90 ( V_124 ) ;
unsigned V_12 ;
for ( V_12 = 0 ; V_12 < F_58 ( V_4 -> V_2 ) ; V_12 ++ ) {
if ( ! V_4 -> V_2 [ V_12 ] )
continue;
if ( V_124 -> V_30 && V_4 -> V_2 [ V_12 ] -> V_103 )
F_54 ( V_4 -> V_2 [ V_12 ] ) ;
F_80 ( & V_4 -> V_2 [ V_12 ] -> V_18 ) ;
}
return 0 ;
