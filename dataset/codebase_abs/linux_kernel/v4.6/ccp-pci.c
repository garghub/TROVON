...
if ( ! V_2 )
goto V_35;
V_3 = F_19 ( V_6 , sizeof( * V_3 ) , V_36 ) ;
if ( ! V_3 )
goto V_35;
V_2 -> V_4 = V_3 ;
V_2 -> V_19 = (struct V_37 * ) V_32 -> V_38 ;
if ( ! V_2 -> V_19 || ! V_2 -> V_19 -> V_39 ) {
V_15 = - V_40 ;
F_20 ( V_6 , L_6 ) ;
goto V_35;
}
...
V_33 = V_15 ;
V_15 = - V_30 ;
V_2 -> V_44 = F_24 ( V_8 , V_33 , 0 ) ;
if ( ! V_2 -> V_44 ) {
F_20 ( V_6 , L_10 ) ;
goto V_43;
}
V_2 -> V_45 = V_2 -> V_44 + V_29 ;
