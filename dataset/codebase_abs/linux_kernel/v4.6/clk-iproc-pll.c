...
if ( F_31 ( ! V_2 ) )
return;
V_2 -> V_106 . V_107 = V_100 ;
V_2 -> V_106 . V_108 = F_33 ( V_100 , sizeof( * V_2 -> V_106 . V_108 ) ,
V_105 ) ;
if ( F_31 ( ! V_2 -> V_106 . V_108 ) )
goto V_109;
V_2 -> V_108 = F_33 ( V_100 , sizeof( * V_2 -> V_108 ) , V_105 ) ;
if ( F_31 ( ! V_2 -> V_108 ) )
goto V_110;
...
V_103 . V_25 = 0 ;
V_104 = F_35 ( V_97 , 0 ) ;
V_103 . V_117 = ( V_104 ? & V_104 : NULL ) ;
V_103 . V_118 = ( V_104 ? 1 : 0 ) ;
...
F_29 ( V_2 ) ;
V_55 = F_36 ( NULL , & V_101 -> V_85 ) ;
if ( F_31 ( F_37 ( V_55 ) ) )
goto V_119;
V_2 -> V_106 . V_108 [ 0 ] = V_55 ;
...
if ( F_31 ( F_37 ( V_55 ) ) )
goto V_121;
V_2 -> V_106 . V_108 [ V_4 ] = V_55 ;
}
V_60 = F_39 ( V_97 , V_123 , & V_2 -> V_106 ) ;
if ( F_31 ( V_60 ) )
goto V_121;
return;
V_121:
for ( V_4 = 0 ; V_4 < V_100 ; V_4 ++ )
F_40 ( V_2 -> V_106 . V_108 [ V_4 ] ) ;
V_119:
