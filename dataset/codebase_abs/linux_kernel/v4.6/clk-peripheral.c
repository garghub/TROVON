...
F_8 ( struct V_11 * V_11 , const char * V_18 ,
const char * V_19 , T_1 V_7 )
{
struct V_3 * V_4 ;
struct V_17 * V_17 = NULL ;
struct V_20 V_21 ;
if ( ! V_18 || ! V_19 || V_7 > V_9 )
return F_9 ( - V_22 ) ;
...
static long F_27 ( struct V_1 * V_2 ,
unsigned long V_44 ,
unsigned long * V_32 )
{
int V_33 = 0 ;
...
static struct V_17 * T_2
F_29 ( struct V_11 * V_11 , T_3 * V_38 ,
...
static void T_2
F_30 ( struct V_51 * V_52 , T_4 type )
{
int V_53 ;
T_1 V_7 ;
struct V_17 * V_17 ;
