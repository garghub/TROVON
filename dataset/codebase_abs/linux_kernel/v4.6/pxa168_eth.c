...
T_1 V_166 , V_167 = F_1 ( V_2 , V_79 ) ;
T_1 V_168 , V_169 = F_1 ( V_2 , V_157 ) ;
V_166 = V_167 & ~ V_170 ;
V_168 = V_169 & ~ ( V_171 | V_172 | V_173 ) ;
if ( V_95 -> V_174 == V_175 )
V_168 |= V_173 ;
if ( V_95 -> V_176 == V_177 )
V_168 |= V_171 ;
...
if ( V_2 -> V_95 )
return 0 ;
V_2 -> V_95 = F_65 ( V_2 -> V_183 , V_2 -> V_184 ) ;
if ( F_66 ( V_2 -> V_95 ) )
return F_67 ( V_2 -> V_95 ) ;
if ( ! V_2 -> V_95 )
return - V_185 ;
V_182 = F_68 ( V_11 , V_2 -> V_95 , F_62 ,
V_2 -> V_186 ) ;
if ( V_182 )
return V_182 ;
V_182 = F_69 ( V_11 , & V_181 ) ;
if ( V_182 )
return V_182 ;
V_181 . V_187 = V_2 -> V_184 ;
V_181 . V_176 = V_2 -> V_188 ;
V_181 . V_178 = V_2 -> V_189 ;
V_181 . V_190 = V_191 ;
V_181 . V_192 = V_193 ;
if ( V_181 . V_176 != 0 )
V_181 . V_192 = V_194 ;
return F_70 ( V_11 , & V_181 ) ;
}
...
goto V_206;
V_203 = V_2 -> V_25 ;
for ( V_42 = 0 ; V_42 < V_204 ; V_42 ++ ) {
V_203 [ V_42 ] . V_207 = V_2 -> V_102 +
( ( V_42 + 1 ) % V_204 ) * sizeof( struct V_16 ) ;
}
V_2 -> V_100 = 0 ;
V_2 -> V_24 = 0 ;
V_2 -> V_205 = V_204 * sizeof( struct V_16 ) ;
return 0 ;
V_206:
F_74 ( V_2 -> V_29 ) ;
return - V_74 ;
...
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_208 ;
for ( V_208 = 0 ; V_2 -> V_19 && V_208 < V_2 -> V_20 ; V_208 ++ ) {
if ( V_2 -> V_29 [ V_208 ] ) {
F_76 ( V_2 -> V_29 [ V_208 ] ) ;
V_2 -> V_19 -- ;
}
...
V_2 -> V_19 ) ;
if ( V_2 -> V_25 )
F_77 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_205 ,
V_2 -> V_25 , V_2 -> V_102 ) ;
F_74 ( V_2 -> V_29 ) ;
}
...
V_209 [ V_42 ] . V_207 = V_2 -> V_98 +
( ( V_42 + 1 ) % V_210 ) * sizeof( struct V_99 ) ;
}
V_2 -> V_96 = 0 ;
V_2 -> V_117 = 0 ;
V_2 -> V_211 = V_210 * sizeof( struct V_99 ) ;
return 0 ;
V_206:
F_74 ( V_2 -> V_122 ) ;
return - V_74 ;
...
if ( V_2 -> V_118 )
F_77 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_211 ,
V_2 -> V_118 , V_2 -> V_98 ) ;
F_74 ( V_2 -> V_122 ) ;
}
...
if ( V_182 )
return V_182 ;
V_182 = F_81 ( V_11 -> V_149 , F_58 , 0 , V_11 -> V_212 , V_11 ) ;
if ( V_182 ) {
F_82 ( & V_11 -> V_11 , L_8 ) ;
return - V_213 ;
}
...
{
int V_42 = 0 ;
for ( V_42 = 0 ; F_1 ( V_2 , V_233 ) & V_234 ; V_42 ++ ) {
if ( V_42 == V_235 )
return - V_236 ;
F_99 ( 10 ) ;
}
...
static int F_100 ( struct V_237 * V_238 , int V_184 , int V_239 )
{
struct V_1 * V_2 = V_238 -> V_240 ;
int V_42 = 0 ;
int V_78 ;
if ( F_98 ( V_2 ) ) {
F_101 ( V_2 -> V_11 , L_10 ) ;
...
F_3 ( V_2 , V_233 , ( V_184 << 16 ) | ( V_239 << 21 ) | V_241 ) ;
for ( V_42 = 0 ; ! ( ( V_78 = F_1 ( V_2 , V_233 ) ) & V_242 ) ; V_42 ++ ) {
if ( V_42 == V_235 ) {
F_101 ( V_2 -> V_11 ,
L_11 ) ;
return - V_185 ;
...
static int F_102 ( struct V_237 * V_238 , int V_184 , int V_239 ,
T_5 V_243 )
{
struct V_1 * V_2 = V_238 -> V_240 ;
if ( F_98 ( V_2 ) ) {
...
F_3 ( V_2 , V_233 , ( V_184 << 16 ) | ( V_239 << 21 ) |
V_244 | ( V_243 & 0xffff ) ) ;
if ( F_98 ( V_2 ) ) {
F_7 ( V_2 -> V_11 , L_10 ) ;
return - V_236 ;
...
static int F_103 ( struct V_13 * V_11 , struct V_245 * V_246 ,
int V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
if ( V_2 -> V_95 != NULL )
return F_104 ( V_2 -> V_95 , V_246 , V_181 ) ;
return - V_247 ;
}
static int F_69 ( struct V_13 * V_11 , struct V_180 * V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_182 ;
V_182 = F_105 ( V_2 -> V_95 ) ;
if ( V_182 == 0 )
V_182 = F_106 ( V_2 -> V_95 , V_181 ) ;
return V_182 ;
}
static int F_70 ( struct V_13 * V_11 , struct V_180 * V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
return F_107 ( V_2 -> V_95 , V_181 ) ;
}
static void F_108 ( struct V_13 * V_11 ,
struct V_248 * V_249 )
{
F_109 ( V_249 -> V_250 , V_251 , sizeof( V_249 -> V_250 ) ) ;
F_109 ( V_249 -> V_252 , V_253 , sizeof( V_249 -> V_252 ) ) ;
F_109 ( V_249 -> V_254 , L_12 , sizeof( V_249 -> V_254 ) ) ;
F_109 ( V_249 -> V_255 , L_12 , sizeof( V_249 -> V_255 ) ) ;
}
...
int V_182 ;
F_111 ( V_263 L_13 ) ;
V_260 = F_112 ( & V_257 -> V_11 , NULL ) ;
if ( F_66 ( V_260 ) ) {
F_82 ( & V_257 -> V_11 , L_14 ) ;
return - V_185 ;
}
F_113 ( V_260 ) ;
V_11 = F_114 ( sizeof( struct V_1 ) ) ;
if ( ! V_11 ) {
V_182 = - V_74 ;
goto V_264;
}
...
V_2 -> V_11 = V_11 ;
V_2 -> V_260 = V_260 ;
V_259 = F_116 ( V_257 , V_265 , 0 ) ;
V_2 -> V_4 = F_117 ( & V_257 -> V_11 , V_259 ) ;
if ( F_66 ( V_2 -> V_4 ) ) {
V_182 = - V_74 ;
goto V_266;
}
V_259 = F_116 ( V_257 , V_267 , 0 ) ;
F_80 ( ! V_259 ) ;
...
V_11 -> V_271 = 0 ;
V_11 -> V_272 = & V_273 ;
F_118 ( & V_2 -> V_127 , F_48 ) ;
if ( V_257 -> V_11 . V_274 )
V_41 = F_119 ( V_257 -> V_11 . V_274 ) ;
if ( V_41 && F_33 ( V_41 ) ) {
F_120 ( V_11 -> V_83 , V_41 ) ;
} else {
F_31 ( V_11 , V_11 -> V_83 ) ;
if ( ! F_33 ( V_11 -> V_83 ) ) {
F_121 ( & V_257 -> V_11 , L_15 ) ;
F_122 ( V_11 ) ;
}
}
V_2 -> V_20 = V_275 ;
V_2 -> V_120 = V_276 ;
V_2 -> V_277 = F_123 ( & V_257 -> V_11 ) ;
if ( V_2 -> V_277 ) {
if ( V_2 -> V_277 -> V_278 )
V_2 -> V_20 = V_2 -> V_277 -> V_278 ;
if ( V_2 -> V_277 -> V_279 )
V_2 -> V_120 = V_2 -> V_277 -> V_279 ;
V_2 -> V_280 = V_2 -> V_277 -> V_281 ;
V_2 -> V_184 = V_2 -> V_277 -> V_184 ;
V_2 -> V_188 = V_2 -> V_277 -> V_176 ;
V_2 -> V_189 = V_2 -> V_277 -> V_178 ;
V_2 -> V_186 = V_2 -> V_277 -> V_282 ;
if ( V_2 -> V_277 -> V_283 )
V_2 -> V_277 -> V_283 () ;
} else if ( V_257 -> V_11 . V_274 ) {
F_124 ( V_257 -> V_11 . V_274 , L_16 ,
& V_2 -> V_280 ) ;
V_262 = F_125 ( V_257 -> V_11 . V_274 , L_17 , 0 ) ;
if ( ! V_262 ) {
F_82 ( & V_257 -> V_11 , L_18 ) ;
V_182 = - V_217 ;
goto V_266;
}
F_124 ( V_262 , L_19 , & V_2 -> V_184 ) ;
V_2 -> V_186 = F_126 ( V_257 -> V_11 . V_274 ) ;
}
F_80 ( V_2 -> V_280 > 2 ) ;
F_127 ( V_11 , & V_2 -> V_39 , F_91 , V_2 -> V_20 ) ;
memset ( & V_2 -> V_35 , 0 , sizeof( struct V_284 ) ) ;
F_128 ( & V_2 -> V_35 ) ;
V_2 -> V_35 . V_285 = F_16 ;
...
V_2 -> V_183 -> V_240 = V_2 ;
V_2 -> V_183 -> V_212 = L_20 ;
V_2 -> V_183 -> V_286 = F_100 ;
V_2 -> V_183 -> V_287 = F_102 ;
snprintf ( V_2 -> V_183 -> V_288 , V_289 , L_21 ,
V_257 -> V_212 , V_257 -> V_288 ) ;
V_2 -> V_183 -> V_70 = & V_257 -> V_11 ;
V_2 -> V_183 -> V_290 = 0xffffffff ;
V_182 = F_130 ( V_2 -> V_183 ) ;
if ( V_182 )
goto V_291;
...
static int F_144 ( struct V_256 * V_257 , T_6 V_294 )
{
return - V_293 ;
}
