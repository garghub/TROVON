...
static int F_41 ( struct V_161 * V_162 , void * V_163 , T_3 V_164 )
{
...
V_6 = F_42 ( V_13 -> V_168 , & V_151 , 1 ) ;
if ( V_6 != 1 ) {
F_43 ( & V_13 -> V_2 , L_31 , V_6 ) ;
if ( V_6 >= 0 )
V_6 = - V_169 ;
return V_6 ;
}
...
struct V_21 * F_44 ( const struct V_170 * V_19 ,
struct V_161 * V_171 , struct V_161 * * V_172 )
{
struct V_12 * V_13 ;
struct V_173 V_174 ;
struct V_175 V_176 ;
...
F_45 ( V_174 . type , L_32 , V_181 ) ;
V_174 . V_166 = V_19 -> V_182 ;
V_174 . V_183 = & V_176 ;
V_13 = F_46 ( V_171 , & V_174 ) ;
if ( ! V_13 || ! V_13 -> V_2 . V_184 )
return NULL ;
* V_172 = V_176 . V_185 ( V_13 ) ;
return V_176 . V_186 ( V_13 ) ;
}
static struct V_21 * F_47 ( struct V_12 * V_13 )
{
struct V_1 * V_2 = F_48 ( V_13 ) ;
F_5 ( & V_13 -> V_2 , L_9 ) ;
return & V_2 -> V_22 ;
}
static struct V_161 * F_49 ( struct V_12 * V_13 )
{
struct V_1 * V_2 = F_48 ( V_13 ) ;
F_5 ( & V_13 -> V_2 , L_9 ) ;
return V_2 -> V_161 ;
...
if ( V_6 )
goto V_196;
V_2 -> V_161 = F_55 ( V_13 -> V_168 , & V_13 -> V_2 ,
V_2 , 0 , 0 , 0 , F_41 ,
NULL ) ;
if ( V_2 -> V_161 == NULL ) {
V_6 = - V_190 ;
