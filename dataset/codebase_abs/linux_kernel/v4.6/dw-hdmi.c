...
static void F_78 ( struct V_395 * V_396 )
{
}
static enum V_400
F_79 ( struct V_401 * V_402 , bool V_387 )
{
struct V_1 * V_2 = F_80 ( V_402 , struct V_1 ,
V_402 ) ;
F_21 ( & V_2 -> V_399 ) ;
V_2 -> V_387 = V_390 ;
F_73 ( V_2 ) ;
...
static int F_81 ( struct V_401 * V_402 )
{
struct V_1 * V_2 = F_80 ( V_402 , struct V_1 ,
V_402 ) ;
struct V_406 * V_406 ;
...
if ( ! V_2 -> V_407 )
return 0 ;
V_406 = F_82 ( V_402 , V_2 -> V_407 ) ;
if ( V_406 ) {
F_17 ( V_2 -> V_29 , L_10 ,
V_406 -> V_408 , V_406 -> V_409 ) ;
V_2 -> V_213 = F_83 ( V_406 ) ;
V_2 -> V_349 = F_84 ( V_406 ) ;
F_85 ( V_402 , V_406 ) ;
V_212 = F_86 ( V_402 , V_406 ) ;
F_87 ( V_402 , V_406 ) ;
F_88 ( V_406 ) ;
} else {
F_17 ( V_2 -> V_29 , L_11 ) ;
...
static enum V_410
F_89 ( struct V_401 * V_402 ,
struct V_227 * V_228 )
{
struct V_1 * V_2 = F_80 ( V_402 ,
struct V_1 , V_402 ) ;
...
static struct V_416 * F_90 ( struct V_401
* V_402 )
{
struct V_1 * V_2 = F_80 ( V_402 , struct V_1 ,
V_402 ) ;
...
static void F_91 ( struct V_401 * V_402 )
{
F_92 ( V_402 ) ;
F_93 ( V_402 ) ;
}
static void F_94 ( struct V_401 * V_402 )
{
struct V_1 * V_2 = F_80 ( V_402 , struct V_1 ,
V_402 ) ;
F_21 ( & V_2 -> V_399 ) ;
...
static T_4 F_95 ( int V_418 , void * V_419 )
{
struct V_1 * V_2 = V_419 ;
T_1 V_420 ;
V_420 = F_10 ( V_2 , V_360 ) ;
if ( V_420 )
F_9 ( V_2 , ~ 0 , V_379 ) ;
return V_420 ? V_421 : V_422 ;
}
static T_4 F_96 ( int V_418 , void * V_419 )
{
struct V_1 * V_2 = V_419 ;
T_1 V_420 , V_423 , V_424 , V_425 ;
V_420 = F_10 ( V_2 , V_360 ) ;
V_423 = F_10 ( V_2 , V_426 ) ;
V_425 = F_10 ( V_2 , V_209 ) ;
V_424 = 0 ;
if ( V_420 & V_358 )
V_424 |= V_403 ;
if ( V_420 & V_427 )
...
static int F_98 ( struct V_436 * V_437 , struct V_1 * V_2 )
{
struct V_416 * V_417 = V_2 -> V_417 ;
struct V_395 * V_396 ;
int V_212 ;
V_396 = F_99 ( V_437 -> V_29 , sizeof( * V_396 ) , V_438 ) ;
if ( ! V_396 ) {
F_100 ( L_15 ) ;
return - V_439 ;
}
...
F_102 ( & V_2 -> V_402 ,
& V_444 ) ;
if ( F_103 ( V_437 , V_445 ) )
F_104 ( V_437 , & V_2 -> V_402 ,
& V_446 ,
V_447 ) ;
else
F_104 ( V_437 , & V_2 -> V_402 ,
& V_448 ,
V_447 ) ;
F_105 ( & V_2 -> V_402 , V_417 ) ;
return 0 ;
}
int F_106 ( struct V_449 * V_29 , struct V_449 * V_450 ,
void * V_8 , struct V_416 * V_417 ,
struct V_451 * V_452 , int V_418 ,
const struct V_176 * V_178 )
{
struct V_436 * V_437 = V_8 ;
struct V_453 * V_454 = V_29 -> V_455 ;
struct V_456 V_457 ;
struct V_453 * V_458 ;
struct V_459 V_460 ;
struct V_1 * V_2 ;
int V_212 ;
T_3 V_3 = 1 ;
V_2 = F_99 ( V_29 , sizeof( * V_2 ) , V_438 ) ;
if ( ! V_2 )
return - V_439 ;
V_2 -> V_402 . V_461 = 1 ;
V_2 -> V_178 = V_178 ;
...
V_458 = F_110 ( V_454 , L_19 , 0 ) ;
if ( V_458 ) {
V_2 -> V_407 = F_111 ( V_458 ) ;
F_112 ( V_458 ) ;
if ( ! V_2 -> V_407 ) {
F_17 ( V_2 -> V_29 , L_20 ) ;
return - V_462 ;
...
V_2 -> V_5 = F_113 ( V_29 , V_452 ) ;
if ( F_114 ( V_2 -> V_5 ) )
return F_115 ( V_2 -> V_5 ) ;
V_2 -> V_463 = F_116 ( V_2 -> V_29 , L_22 ) ;
if ( F_114 ( V_2 -> V_463 ) ) {
V_212 = F_115 ( V_2 -> V_463 ) ;
F_55 ( V_2 -> V_29 , L_23 , V_212 ) ;
return V_212 ;
}
V_212 = F_117 ( V_2 -> V_463 ) ;
if ( V_212 ) {
F_55 ( V_2 -> V_29 , L_24 , V_212 ) ;
return V_212 ;
}
V_2 -> V_464 = F_116 ( V_2 -> V_29 , L_25 ) ;
if ( F_114 ( V_2 -> V_464 ) ) {
V_212 = F_115 ( V_2 -> V_464 ) ;
F_55 ( V_2 -> V_29 , L_26 , V_212 ) ;
goto V_465;
}
V_212 = F_117 ( V_2 -> V_464 ) ;
if ( V_212 ) {
...
F_10 ( V_2 , V_469 ) ) ;
F_70 ( V_2 ) ;
V_212 = F_119 ( V_29 , V_418 , F_95 ,
F_96 , V_470 ,
F_120 ( V_29 ) , V_2 ) ;
if ( V_212 )
goto V_471;
F_20 ( V_2 ) ;
F_9 ( V_2 , V_403 | V_394 , V_426 ) ;
F_9 ( V_2 , V_358 | V_359 ,
V_360 ) ;
V_212 = F_69 ( V_2 ) ;
if ( V_212 )
goto V_471;
V_212 = F_98 ( V_437 , V_2 ) ;
if ( V_212 )
goto V_471;
F_9 ( V_2 , ~ ( V_358 | V_359 ) ,
V_379 ) ;
...
V_457 . V_472 = V_29 ;
V_457 . V_473 = V_474 ;
if ( F_10 ( V_2 , V_475 ) & V_476 ) {
V_460 . V_477 = V_452 -> V_478 ;
V_460 . V_479 = V_2 -> V_5 ;
V_460 . V_418 = V_418 ;
V_460 . V_2 = V_2 ;
V_460 . V_480 = V_2 -> V_402 . V_480 ;
V_457 . V_481 = L_29 ;
V_457 . V_8 = & V_460 ;
V_457 . V_482 = sizeof( V_460 ) ;
V_457 . V_483 = F_121 ( 32 ) ;
V_2 -> V_460 = F_122 ( & V_457 ) ;
}
F_123 ( V_29 , V_2 ) ;
return 0 ;
V_471:
...
void F_125 ( struct V_449 * V_29 , struct V_449 * V_450 , void * V_8 )
{
struct V_1 * V_2 = F_126 ( V_29 ) ;
if ( V_2 -> V_460 && ! F_114 ( V_2 -> V_460 ) )
F_127 ( V_2 -> V_460 ) ;
F_9 ( V_2 , ~ 0 , V_379 ) ;
V_2 -> V_402 . V_440 -> V_484 ( & V_2 -> V_402 ) ;
V_2 -> V_417 -> V_440 -> V_484 ( V_2 -> V_417 ) ;
F_124 ( V_2 -> V_464 ) ;
F_124 ( V_2 -> V_463 ) ;
F_128 ( V_2 -> V_407 ) ;
}
