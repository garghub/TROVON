...
args -> V_74 = V_79 ;
F_23 ( V_8 , 1 ) ;
V_12 = F_52 ( V_63 -> V_80 , V_63 ) ;
if ( V_12 )
F_53 ( V_60 -> V_2 , L_10 , V_12 ) ;
F_54 ( V_60 -> V_2 , - 1 ) ;
V_58 = F_55 ( V_60 , 0 ) ;
if ( F_45 ( V_58 ) ) {
V_12 = F_47 ( V_58 ) ;
...
V_63 -> V_59 = V_64 -> V_59 ;
V_64 -> V_59 = V_48 ;
memcpy ( V_90 , V_63 -> V_96 , sizeof( V_90 ) ) ;
memcpy ( V_63 -> V_96 , V_64 -> V_96 , sizeof( V_63 -> V_96 ) ) ;
memcpy ( V_64 -> V_96 , V_90 , sizeof( V_64 -> V_96 ) ) ;
F_70 ( V_63 , V_64 -> V_51 ) ;
F_71 ( V_63 ,
V_64 -> V_52 ) ;
F_72 ( V_63 , V_64 -> V_54 ) ;
ASSERT ( F_73 ( & V_64 -> V_97 ) ) ;
V_63 -> V_53 = V_64 -> V_53 ;
V_63 -> V_55 = V_64 -> V_54 ;
if ( V_2 -> V_98 -> V_99 == V_64 -> V_100 )
V_2 -> V_98 -> V_99 = V_63 -> V_100 ;
if ( V_2 -> V_80 -> V_101 == V_64 -> V_100 )
V_2 -> V_80 -> V_101 = V_63 -> V_100 ;
F_74 ( & V_63 -> V_102 , & V_2 -> V_80 -> V_103 ) ;
V_2 -> V_80 -> V_104 ++ ;
F_23 ( V_8 , 1 ) ;
F_60 ( V_2 ) ;
F_75 ( V_2 , V_64 ) ;
...
static int F_41 ( struct V_5 * V_60 , T_1 V_69 ,
char * V_70 ,
struct V_62 * * V_119 )
{
int V_12 ;
...
case V_47 :
V_37 = V_8 -> V_37 ;
args -> V_120 . V_121 = F_84 ( V_8 -> V_33 ,
F_84 ( F_57 ( V_37 ) , 1000 ) ) ;
break;
}
F_23 ( V_8 , 0 ) ;
...
{
if ( V_134 == 1 ) {
ASSERT ( F_99 ( & V_8 -> V_137 ) == 0 ) ;
F_81 ( & V_8 -> V_114 ) ;
} else {
ASSERT ( F_99 ( & V_8 -> V_138 ) > 0 ) ;
F_102 ( & V_8 -> V_138 ) ;
F_103 ( & V_8 -> V_114 ) ;
}
}
...
void F_110 ( struct V_1 * V_2 , T_3 V_139 )
{
F_111 ( & V_2 -> V_87 , V_139 ) ;
if ( F_107 ( & V_2 -> V_86 ) )
F_66 ( & V_2 -> V_86 ) ;
}
