...
int F_36 ( struct V_1 * V_50 , struct V_51 * V_52 ,
...
static inline int F_39 ( struct V_1 * V_7 , int V_60 )
{
return F_40 ( V_7 ) > V_60 ;
}
int F_41 ( struct V_1 * V_7 , int V_61 )
{
struct V_1 * V_12 , * V_31 ;
struct V_1 * V_39 = V_7 -> V_41 ;
int V_56 = 0 ;
if ( V_7 == V_39 )
return F_39 ( V_7 , V_61 ) ;
if ( ! F_10 ( & V_7 -> V_62 ) || F_39 ( V_7 , V_61 ) )
return 1 ;
for ( V_12 = F_21 ( V_39 , V_39 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_39 ) ) {
V_31 = F_42 ( & V_12 -> V_7 , V_7 -> V_63 ) ;
...
F_12 ( & V_31 -> V_64 ) ;
V_31 -> V_7 . V_26 |= V_65 ;
F_48 ( & V_31 -> V_66 , & V_7 -> V_66 ) ;
}
}
}
int F_49 ( struct V_22 * V_49 )
{
struct V_1 * V_7 ;
