...
V_474 = F_193 ( V_475 , V_182 + V_476 , V_476 , V_179 ) ;
...
V_504 = F_212 ( V_25 , 0 ) ;
error = F_213 ( V_504 , & F_214 ( V_25 ) -> V_513 , 0 , 0 ) ;
if ( error )
goto V_514;
V_503 = F_215 ( V_504 , V_412 , V_412 -> V_416 . V_415 ) ;
for ( V_47 = 0 ; V_47 < V_412 -> V_416 . V_415 ; V_47 ++ ) {
V_505 = & ( V_412 -> V_416 . V_509 [ V_47 ] ) ;
error = F_216 ( V_504 , V_503 , V_505 -> V_510 ,
V_505 -> V_511 ) ;
if ( error )
goto V_514;
}
...
V_412 = F_221 ( V_422 , struct V_411 , V_420 ) ;
...
int V_13 ;
int error ;
V_504 = F_212 ( V_25 , V_518 ) ;
error = F_213 ( V_504 , & F_214 ( V_25 ) -> V_519 , 0 , 0 ) ;
if ( error )
goto V_520;
error = F_224 ( V_25 , V_504 , V_437 , & V_517 ) ;
if ( error )
goto V_520;
V_516 = F_225 ( V_517 ) ;
V_516 -> V_521 [ V_171 ] = F_30 ( V_522 ) ;
V_13 = F_101 ( T_27 , V_521 ) +
( sizeof( T_10 ) * V_171 ) ;
F_226 ( V_504 , V_517 , V_13 ,
( V_13 + sizeof( T_10 ) - 1 ) ) ;
error = F_217 ( V_504 ) ;
if ( error )
goto V_81;
...
T_28 V_525 ;
int error ;
V_525 = F_228 ( V_25 , V_437 , V_523 ) ;
error = F_229 ( V_25 , NULL , V_525 , 0 , 0 , & V_338 ) ;
if ( error )
goto V_526;
error = F_230 ( V_25 , NULL , & V_338 -> V_527 , & V_334 , & V_524 , 0 , 0 ) ;
if ( error )
goto V_528;
ASSERT ( F_231 ( V_338 ) -> V_529 == 0 ) ;
ASSERT ( F_231 ( V_338 ) -> V_530 != 0 ) ;
V_523 = F_28 ( V_334 -> V_201 ) ;
F_25 ( V_524 ) ;
V_338 -> V_343 . V_531 = 0 ;
F_232 ( V_338 ) ;
return V_523 ;
...
error = F_224 ( V_25 , NULL , V_437 , & V_517 ) ;
if ( error ) {
continue;
}
V_516 = F_225 ( V_517 ) ;
F_7 ( V_517 ) ;
for ( V_171 = 0 ; V_171 < V_534 ; V_171 ++ ) {
V_523 = F_28 ( V_516 -> V_521 [ V_171 ] ) ;
while ( V_523 != V_522 ) {
V_523 = F_227 ( V_25 ,
V_437 , V_523 , V_171 ) ;
}
...
V_47 < ( V_62 / V_54 ) ; V_47 ++ ) {
* ( V_82 * ) V_473 = * ( V_82 * ) & V_78 -> V_536 [ V_47 ] ;
V_473 += V_54 ;
}
if ( F_45 ( & log -> V_7 -> V_27 ) ) {
T_29 * V_537 = ( T_29 * ) V_78 ;
for ( ; V_47 < F_46 ( F_28 ( V_78 -> V_63 ) ) ; V_47 ++ ) {
V_48 = V_47 / ( V_62 / V_54 ) ;
V_535 = V_47 % ( V_62 / V_54 ) ;
* ( V_82 * ) V_473 = V_537 [ V_48 ] . V_538 . V_539 [ V_535 ] ;
V_473 += V_54 ;
}
}
return 0 ;
...
int error ;
T_30 V_540 ;
V_540 = F_237 ( log , V_78 , V_473 , F_28 ( V_78 -> V_63 ) ) ;
if ( V_146 == V_87 ) {
if ( V_78 -> V_541 && V_540 != V_78 -> V_541 )
return - V_93 ;
return 0 ;
}
if ( V_540 != V_78 -> V_541 ) {
if ( V_78 -> V_541 || F_100 ( & log -> V_7 -> V_27 ) ) {
F_104 ( log -> V_7 ,
L_87 ,
F_238 ( V_78 -> V_541 ) ,
F_238 ( V_540 ) ) ;
...
if ( F_31 (
( ! V_78 -> V_101 ||
( F_28 ( V_78 -> V_101 ) & ( ~ V_543 ) ) ) ) ) {
F_3 ( log -> V_7 , L_89 ,
V_8 , F_28 ( V_78 -> V_101 ) ) ;
return - V_60 ;
}
V_542 = F_28 ( V_78 -> V_63 ) ;
if ( F_31 ( V_542 <= 0 || V_542 > V_72 ) ) {
F_4 ( L_90 ,
V_143 , log -> V_7 ) ;
return - V_16 ;
}
...
int V_546 , V_547 ;
int V_100 , V_548 , V_549 ;
struct V_490 V_491 [ V_550 ] ;
ASSERT ( V_65 != V_74 ) ;
V_88 = 0 ;
if ( F_45 ( & log -> V_7 -> V_27 ) ) {
V_544 = F_2 ( log , 1 ) ;
if ( ! V_544 )
return - V_51 ;
error = F_18 ( log , V_74 , 1 , V_544 , & V_13 ) ;
if ( error )
goto V_551;
V_78 = ( T_4 * ) V_13 ;
error = F_240 ( log , V_78 , V_74 ) ;
if ( error )
goto V_551;
V_61 = F_28 ( V_78 -> V_61 ) ;
V_63 = F_28 ( V_78 -> V_63 ) ;
if ( V_63 > V_61 ) {
if ( V_63 <= log -> V_7 -> V_552 &&
F_28 ( V_78 -> V_103 ) == 1 ) {
F_3 ( log -> V_7 ,
L_92 ,
V_61 , log -> V_7 -> V_552 ) ;
...
error = F_18 ( log , V_12 , V_100 , V_544 ,
& V_13 ) ;
if ( error )
goto V_554;
} else {
...
V_78 = ( T_4 * ) V_13 ;
error = F_240 ( log , V_78 ,
V_548 ? V_12 : 0 ) ;
if ( error )
goto V_554;
V_546 = ( int ) F_46 ( F_28 ( V_78 -> V_63 ) ) ;
V_12 += V_100 ;
if ( V_12 + V_546 <= log -> V_3 ) {
error = F_18 ( log , V_12 , V_546 , V_545 ,
& V_13 ) ;
if ( error )
goto V_554;
} else {
...
error = F_236 ( log , V_491 , V_78 , V_13 ,
V_146 ) ;
if ( error )
goto V_554;
V_12 += V_546 ;
...
while ( V_12 < V_65 ) {
error = F_18 ( log , V_12 , V_100 , V_544 , & V_13 ) ;
if ( error )
goto V_554;
V_78 = ( T_4 * ) V_13 ;
error = F_240 ( log , V_78 , V_12 ) ;
if ( error )
goto V_554;
V_546 = ( int ) F_46 ( F_28 ( V_78 -> V_63 ) ) ;
error = F_18 ( log , V_12 + V_100 , V_546 , V_545 ,
& V_13 ) ;
if ( error )
goto V_554;
error = F_236 ( log , V_491 , V_78 , V_13 , V_146 ) ;
if ( error )
goto V_554;
V_12 += V_546 + V_100 ;
V_88 = V_12 ;
...
int error , V_47 ;
ASSERT ( V_65 != V_74 ) ;
log -> V_184 = F_189 ( V_555 *
sizeof( struct V_170 ) ,
V_179 ) ;
for ( V_47 = 0 ; V_47 < V_555 ; V_47 ++ )
...
F_243 ( V_25 ) ;
V_6 = F_244 ( V_25 , 0 ) ;
V_6 -> V_18 &= ~ ( V_557 | V_558 ) ;
ASSERT ( ! ( V_6 -> V_18 & V_559 ) ) ;
V_6 -> V_18 |= V_19 ;
V_6 -> V_196 = & V_308 ;
error = F_15 ( V_6 ) ;
if ( error ) {
...
V_556 = & V_25 -> V_27 ;
F_245 ( V_556 , F_246 ( V_6 ) ) ;
F_25 ( V_6 ) ;
F_247 ( V_25 ) ;
error = F_248 ( V_25 , V_556 -> V_447 , & V_25 -> V_560 ) ;
if ( error ) {
F_3 ( V_25 , L_93 , error ) ;
return error ;
}
...
return error ;
if ( F_100 ( & log -> V_7 -> V_27 ) &&
! F_250 ( log -> V_7 , log -> V_7 -> V_27 . V_252 ) )
return - V_124 ;
if ( V_74 != V_65 ) {
if ( ( error = F_251 ( log -> V_7 , L_94 ) ) ) {
return error ;
}
if ( F_252 ( & log -> V_7 -> V_27 ) == V_563 &&
F_253 ( & log -> V_7 -> V_27 ,
V_564 ) ) {
F_3 ( log -> V_7 ,
L_95 ,
...
L_98 ,
V_566 . V_567 ) ;
F_255 ( V_566 . V_567 * 1000 ) ;
}
F_254 ( log -> V_7 , L_99 ,
log -> V_7 -> V_568 ? log -> V_7 -> V_568
: L_100 ) ;
error = F_242 ( log , V_65 , V_74 ) ;
log -> V_561 |= V_569 ;
}
return error ;
}
...
V_575 = 0LL ;
for ( V_437 = 0 ; V_437 < V_25 -> V_27 . V_447 ; V_437 ++ ) {
error = F_260 ( V_25 , NULL , V_437 , 0 , & V_572 ) ;
if ( error ) {
F_104 ( V_25 , L_104 ,
V_8 , V_437 , error ) ;
} else {
V_571 = F_261 ( V_572 ) ;
V_573 += F_28 ( V_571 -> V_576 ) +
F_28 ( V_571 -> V_577 ) ;
F_25 ( V_572 ) ;
}
error = F_224 ( V_25 , NULL , V_437 , & V_517 ) ;
...
struct V_238 * V_516 = F_225 ( V_517 ) ;
V_574 += F_28 ( V_516 -> V_578 ) ;
V_575 += F_28 ( V_516 -> V_579 ) ;
F_25 ( V_517 ) ;
}
}
}
