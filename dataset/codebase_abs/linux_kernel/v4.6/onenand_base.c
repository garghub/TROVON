...
( int ) V_43 ) ;
V_118 = F_66 ( V_37 , V_164 ) ;
V_172 = V_162 & ( V_37 -> V_118 - 1 ) ;
if ( V_162 + V_43 > V_37 -> V_175 ) {
F_29 ( V_92 L_13 ,
V_93 ) ;
V_164 -> V_176 = 0 ;
V_164 -> V_177 = 0 ;
...
unsigned int V_179 = V_164 -> V_179 ;
...
if ( F_67 ( V_162 >= V_37 -> V_175 ||
V_142 + V_43 > ( ( V_37 -> V_175 >> V_4 -> V_57 ) -
...
V_166 = V_37 -> V_94 ;
V_182 = F_19 ( V_4 ) ? V_56 : V_66 ;
while ( V_170 < V_43 ) {
F_28 () ;
V_143 = V_118 - V_142 ;
V_143 = F_61 ( int , V_143 , V_43 ) ;
V_4 -> V_161 ( V_37 , V_182 , V_162 , V_37 -> V_118 ) ;
F_47 ( V_37 , V_162 , 0 ) ;
V_174 = V_4 -> V_109 ( V_37 , V_88 ) ;
if ( F_67 ( V_174 ) )
V_174 = F_62 ( V_37 , V_162 , V_174 ) ;
...
static int F_71 ( struct V_36 * V_37 , T_2 V_162 , T_3 V_43 ,
T_3 * V_176 , T_6 * V_141 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
struct V_163 V_164 = {
...
F_68 ( V_37 , V_162 , & V_164 ) ;
F_57 ( V_37 ) ;
* V_176 = V_164 . V_176 ;
return V_174 ;
}
static int F_72 ( struct V_36 * V_37 , T_2 V_162 ,
struct V_163 * V_164 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_174 ;
...
V_174 = F_70 ( V_37 , V_162 , V_164 ) ;
F_57 ( V_37 ) ;
return V_174 ;
}
static int F_73 ( struct V_36 * V_37 , int V_81 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
unsigned long V_82 ;
...
int F_74 ( struct V_36 * V_37 , T_2 V_162 ,
struct V_163 * V_164 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
...
static int F_75 ( struct V_36 * V_37 , const T_6 * V_141 , T_2 V_192 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
T_6 * V_148 = V_4 -> V_148 ;
int V_158 , V_38 , V_182 ;
V_182 = F_19 ( V_4 ) ? V_56 : V_66 ;
V_4 -> V_161 ( V_37 , V_182 , V_192 , V_37 -> V_118 ) ;
F_47 ( V_37 , V_192 , 0 ) ;
...
static int F_76 ( struct V_36 * V_37 , const T_6 * V_141 , T_2 V_1 , T_3 V_43 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_174 = 0 ;
int V_143 , V_142 ;
...
static void F_77 ( struct V_36 * V_37 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
unsigned int V_85 ;
int V_38 ;
...
static int F_79 ( struct V_36 * V_37 , T_2 V_192 , T_3 V_43 ,
T_3 * V_176 , const T_6 * V_141 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_142 , V_194 ;
int V_195 = 0 ;
...
static int F_82 ( struct V_36 * V_37 , T_6 * V_148 ,
...
static int F_83 ( struct V_36 * V_37 , T_2 V_192 ,
struct V_163 * V_164 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
...
if ( V_164 -> V_179 == V_180 )
F_82 ( V_37 , V_169 , V_208 , V_172 , V_173 ) ;
else
...
if ( V_195 == V_43 ) {
V_174 = F_76 ( V_37 , V_141 - V_43 , V_192 - V_43 , V_43 ) ;
if ( V_174 )
F_29 ( V_92 L_26 ,
V_93 , V_174 ) ;
break;
...
V_174 = F_76 ( V_37 , V_141 , V_192 , V_143 ) ;
if ( V_174 ) {
F_29 ( V_92 L_26 ,
V_93 , V_174 ) ;
break;
...
static int F_85 ( struct V_36 * V_37 , T_2 V_192 ,
struct V_163 * V_164 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
...
if ( F_67 ( V_142 + V_43 > V_118 ) ) {
F_29 ( V_92 L_28 ,
V_93 ) ;
return - V_178 ;
}
if ( F_67 ( V_192 >= V_37 -> V_175 ||
V_142 + V_43 > ( ( V_37 -> V_175 >> V_4 -> V_57 ) -
...
memset ( V_169 , 0xff , V_37 -> V_118 ) ;
if ( V_179 == V_180 )
F_82 ( V_37 , V_169 , V_141 , V_142 , V_143 ) ;
else
...
static int F_86 ( struct V_36 * V_37 , T_2 V_192 , T_3 V_43 ,
T_3 * V_176 , const T_6 * V_141 )
{
struct V_163 V_164 = {
. V_43 = V_43 ,
...
int V_174 ;
F_49 ( V_37 , V_209 ) ;
V_174 = F_83 ( V_37 , V_192 , & V_164 ) ;
F_57 ( V_37 ) ;
* V_176 = V_164 . V_176 ;
return V_174 ;
}
static int F_87 ( struct V_36 * V_37 , T_2 V_192 ,
struct V_163 * V_164 )
{
int V_174 ;
switch ( V_164 -> V_179 ) {
...
V_174 = F_85 ( V_37 , V_192 , V_164 ) ;
F_57 ( V_37 ) ;
return V_174 ;
}
static int F_88 ( struct V_36 * V_37 , T_2 V_31 , int V_214 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
...
static int F_93 ( struct V_36 * V_37 , struct V_218 * V_219 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
unsigned int V_220 ;
T_2 V_1 = V_219 -> V_1 ;
...
V_220 = 1 << V_4 -> V_30 ;
if ( F_67 ( ( V_1 - V_239 ) & ( V_220 - 1 ) ) ) {
F_29 ( V_92 L_36 , V_93 ) ;
return - V_178 ;
}
if ( F_67 ( V_43 & ( V_220 - 1 ) ) ) {
F_29 ( V_92 L_38 , V_93 ) ;
return - V_178 ;
}
F_49 ( V_37 , V_234 ) ;
...
V_174 = F_92 ( V_37 , V_219 ,
V_236 , V_220 ) ;
} else {
V_174 = F_90 ( V_37 , V_219 , V_220 ) ;
}
F_57 ( V_37 ) ;
if ( ! V_174 ) {
V_219 -> V_81 = V_241 ;
...
return F_85 ( V_37 , V_31 , & V_164 ) ;
}
static int F_98 ( struct V_36 * V_37 , T_2 V_31 )
{
struct V_3 * V_4 = V_37 -> V_44 ;
int V_174 ;
V_174 = F_96 ( V_37 , V_31 ) ;
if ( V_174 ) {
if ( V_174 > 0 )
return 0 ;
return V_174 ;
...
V_164 . V_168 = V_141 ;
V_164 . V_169 = NULL ;
V_174 = F_83 ( V_37 , V_37 -> V_58 * 49 , & V_164 ) ;
* V_176 = V_164 . V_176 ;
V_4 -> V_161 ( V_37 , V_261 , 0 , 0 ) ;
V_4 -> V_109 ( V_37 , V_262 ) ;
} else {
...
T_3 * V_176 , struct V_271 * V_141 )
{
return F_109 ( V_37 , 0 , V_43 , V_176 , ( T_6 * ) V_141 , NULL ,
V_268 ) ;
}
static int F_111 ( struct V_36 * V_37 , T_2 V_162 ,
T_3 V_43 , T_3 * V_176 , T_6 * V_141 )
{
return F_109 ( V_37 , V_162 , V_43 , V_176 , V_141 , F_106 , V_268 ) ;
}
...
T_3 V_43 , T_3 * V_176 , T_6 * V_141 )
{
return F_109 ( V_37 , V_162 , V_43 , V_176 , V_141 , F_106 , V_270 ) ;
}
static int F_114 ( struct V_36 * V_37 , T_2 V_162 ,
T_3 V_43 , T_3 * V_176 , T_6 * V_141 )
{
return F_109 ( V_37 , V_162 , V_43 , V_176 , V_141 , F_107 , V_270 ) ;
}
...
F_29 ( V_97 L_48 ) ;
V_174 = F_109 ( V_37 , V_162 , V_43 , & V_176 , V_141 , F_108 , V_270 ) ;
return V_174 ? : V_176 ;
}
...
{
int V_175 = F_120 ( V_303 ) ;
char * V_304 ;
int V_38 ;
for ( V_38 = 0 ; V_38 < V_175 ; V_38 ++ )
...
V_4 -> V_26 [ V_28 ] + 1 ;
V_31 += V_37 -> V_40 [ V_38 ] . V_238 << V_310 ;
V_310 ++ ;
} else {
V_37 -> V_39 -= 1 ;
V_37 -> V_40 [ V_38 ] . V_238 +=
...
V_37 -> V_40 [ V_38 ] . V_238 ) ;
for ( V_28 = 0 , V_37 -> V_175 = 0 ; V_28 < V_4 -> V_307 ; V_28 ++ ) {
V_4 -> V_29 [ V_28 ] = ( T_2 ) V_311 << V_4 -> V_30 ;
V_4 -> V_29 [ V_28 ] -= ( T_2 ) ( V_4 -> V_26 [ V_28 ] + 1 )
<< ( V_4 -> V_30 - 1 ) ;
V_37 -> V_175 += V_4 -> V_29 [ V_28 ] ;
}
}
...
V_174 = F_123 ( V_37 , F_91 ( V_314 , V_315 ) + 1 , F_125 ( V_314 , V_315 ) ) ;
if ( V_174 ) {
F_29 ( V_92 L_74
L_75 , V_93 ) ;
return V_174 ;
...
if ( F_10 ( V_4 ) )
V_4 -> V_6 = V_4 -> V_181 >> ( V_4 -> V_30 + 1 ) ;
V_4 -> V_58 = V_37 -> V_58 ;
if ( F_12 ( V_4 ) )
F_122 ( V_37 ) ;
else
V_37 -> V_175 = V_4 -> V_181 ;
if ( F_18 ( V_4 ) ) {
V_37 -> V_58 <<= 1 ;
V_37 -> V_160 <<= 1 ;
}
...
if ( ! V_4 -> V_198 ) {
V_4 -> V_198 = F_128 ( V_37 -> V_58 , V_333 ) ;
if ( ! V_4 -> V_198 )
return - V_334 ;
#ifdef F_133
V_4 -> V_193 = F_128 ( V_37 -> V_58 , V_333 ) ;
if ( ! V_4 -> V_193 ) {
F_134 ( V_4 -> V_198 ) ;
return - V_334 ;
}
...
V_37 -> V_184 += V_4 -> V_149 -> V_150 [ V_38 ] . V_152 ;
