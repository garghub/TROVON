...
static long F_263 ( struct V_361 * V_626 ,
unsigned int V_627 , unsigned long V_628 )
{
struct V_72 * V_72 V_629 = V_626 -> V_365 ;
void T_5 * V_630 = ( void T_5 * ) V_628 ;
long V_49 ;
switch ( V_627 ) {
case V_631 : {
T_2 V_632 ;
V_49 = - V_386 ;
if ( F_264 ( V_632 , ( T_2 T_5 * ) V_630 ) )
break;
V_49 = F_265 ( V_72 , & V_632 ) ;
if ( V_49 )
break;
V_49 = - V_386 ;
if ( F_266 ( V_632 , ( T_2 T_5 * ) V_630 ) )
break;
V_49 = 0 ;
break;
}
...
struct V_634 V_635 ;
V_49 = - V_386 ;
if ( F_267 ( & V_635 , V_630 , sizeof( V_635 ) ) )
break;
V_49 = F_268 ( V_72 , & V_635 ) ;
break;
}
default:
V_49 = - V_636 ;
