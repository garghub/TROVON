...
V_4 -> V_11 = V_11 ;
memcpy ( & V_4 -> V_36 , & V_37 ,
sizeof( V_4 -> V_36 ) ) ;
V_4 -> V_13 . V_36 = & V_4 -> V_36 ;
V_4 -> V_13 . V_14 = V_32 / sizeof( * V_11 ) ;
return 0 ;
}
static int F_22 ( struct V_26 * V_27 ,
struct V_3 * V_4 )
{
memcpy ( & V_4 -> V_36 , & V_38 ,
sizeof( V_4 -> V_36 ) ) ;
V_4 -> V_13 . V_36 = & V_4 -> V_36 ;
V_4 -> V_13 . V_39 = true ;
return 0 ;
...
if ( ! V_4 )
return - V_34 ;
memcpy ( & V_4 -> V_13 , & V_45 , sizeof( V_4 -> V_13 ) ) ;
