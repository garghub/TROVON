...
V_92 ++ ;
V_182 = F_74 ( V_179 , V_46 , V_92 - V_179 ) ;
F_72 ( V_46 ) ;
V_46 = V_182 ;
} while ( ! F_11 ( V_46 ) );
F_75 ( V_178 ) ;
...
static int F_76 ( struct V_1 * V_2 , void * V_174 )
{
...
V_8 -> V_194 = F_82 ( V_174 , V_195 , V_72 ) ;
if ( V_8 -> V_194 == NULL ) {
V_122 = F_68 ( - V_39 ) ;
goto V_196;
}
...
V_187 . V_74 = V_74 ;
V_74 |= V_175 | V_199 ;
V_2 = F_85 ( V_190 , V_200 , F_76 , V_74 , & V_187 ) ;
if ( F_11 ( V_2 ) ) {
V_122 = F_80 ( V_2 ) ;
F_18 ( V_8 ) ;
goto V_201;
...
static T_2
F_88 ( struct V_204 * V_205 , struct V_206 * V_207 )
{
T_2 V_11 ;
struct V_7 * V_7 = F_89 ( V_205 -> V_208 ) ;
if ( V_205 -> V_208 -> V_209 & V_210 )
return F_90 ( V_205 , V_207 ) ;
V_11 = F_91 ( V_7 ) ;
if ( V_11 )
return V_11 ;
return F_92 ( V_205 , V_207 ) ;
}
static T_2 F_93 ( struct V_204 * V_205 , struct V_206 * V_211 )
{
struct V_7 * V_7 = F_89 ( V_205 -> V_208 ) ;
...
int V_11 ;
if ( V_205 -> V_208 -> V_209 & V_210 ) {
V_213 = F_94 ( V_205 , V_211 ) ;
if ( V_213 > 0 && F_95 ( V_212 ) ) {
F_96 ( V_7 ) ;
F_15 ( V_41 ,
L_72 ,
V_7 ) ;
...
if ( V_213 )
return V_213 ;
V_213 = F_98 ( V_205 , V_211 ) ;
if ( F_99 ( F_37 ( V_7 ) ) )
goto V_201;
V_11 = F_100 ( V_7 -> V_215 ) ;
if ( V_11 )
F_15 ( V_41 , L_73 ,
V_11 , V_7 ) ;
V_201:
...
static T_1 F_102 ( struct V_58 * V_58 , T_1 V_216 , int V_217 )
{
if ( V_217 != V_218 && V_217 != V_219 ) {
int V_11 ;
struct V_7 * V_7 = F_89 ( V_58 ) ;
if ( ! F_95 ( F_37 ( V_7 ) ) && V_7 -> V_215 &&
V_7 -> V_215 -> V_220 != 0 ) {
V_11 = F_103 ( V_7 -> V_215 ) ;
if ( V_11 ) {
F_104 ( V_7 -> V_215 , V_11 ) ;
return V_11 ;
}
}
F_37 ( V_7 ) -> time = 0 ;
...
return F_106 ( V_58 , V_216 , V_217 ) ;
}
static int
F_107 ( struct V_58 * V_58 , long V_221 , struct V_222 * * V_223 , void * * V_224 )
{
struct V_7 * V_7 = F_89 ( V_58 ) ;
...
return - V_228 ;
if ( V_221 == V_229 ||
( ( V_221 == V_230 ) && F_95 ( F_37 ( V_7 ) ) ) ||
( ( V_221 == V_231 ) && F_99 ( F_37 ( V_7 ) ) ) )
return F_109 ( V_58 , V_221 , V_223 , V_224 ) ;
else if ( F_110 ( V_226 -> V_232 ) -> V_233 &&
! F_95 ( F_37 ( V_7 ) ) )
return F_109 ( V_58 , V_221 , V_223 , V_224 ) ;
else
return - V_234 ;
}
static int F_111 ( struct V_58 * V_235 , T_1 V_60 ,
struct V_58 * V_236 , T_1 V_237 , T_3 V_61 )
{
struct V_7 * V_238 = F_89 ( V_235 ) ;
struct V_7 * V_239 = F_89 ( V_236 ) ;
struct V_225 * V_240 = V_235 -> V_227 ;
struct V_225 * V_241 = V_236 -> V_227 ;
struct V_9 * V_242 = F_110 ( V_241 -> V_232 ) ;
unsigned int V_51 ;
int V_11 ;
F_15 ( V_41 , L_74 ) ;
V_51 = F_20 () ;
...
V_286 = F_135 ( L_85 , V_287 | V_288 , 0 ) ;
if ( ! V_286 ) {
V_11 = - V_39 ;
goto V_289;
}
