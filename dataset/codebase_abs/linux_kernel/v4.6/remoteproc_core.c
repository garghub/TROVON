...
if ( ! F_68 ( V_6 -> V_13 -> V_116 -> V_117 ) ) {
F_4 ( V_6 , L_52 , V_108 ) ;
V_14 = - V_42 ;
goto V_115;
}
if ( F_69 ( & V_10 -> V_118 ) > 1 ) {
V_14 = 0 ;
goto V_115;
}
F_45 ( V_6 , L_53 , V_10 -> V_61 ) ;
V_14 = F_70 ( & V_114 , V_10 -> V_83 , V_6 ) ;
if ( V_14 < 0 ) {
F_4 ( V_6 , L_54 , V_14 ) ;
goto V_119;
}
V_14 = F_43 ( V_10 , V_114 ) ;
F_53 ( V_114 ) ;
V_119:
if ( V_14 ) {
F_71 ( V_6 -> V_13 -> V_116 -> V_117 ) ;
F_72 ( & V_10 -> V_118 ) ;
}
V_115:
F_64 ( & V_10 -> V_109 ) ;
...
struct V_10 * F_76 ( T_5 T_5 )
{
struct V_10 * V_10 = NULL , * V_121 ;
struct V_122 * V_123 ;
V_123 = F_77 ( T_5 ) ;
if ( ! V_123 )
return NULL ;
...
if ( V_121 -> V_6 . V_13 && V_121 -> V_6 . V_13 -> V_125 == V_123 ) {
V_10 = V_121 ;
F_78 ( & V_10 -> V_6 ) ;
break;
}
...
{
struct V_10 * V_10 ;
char * V_130 , * V_131 = L_61 ;
int V_132 = 0 ;
if ( ! V_6 || ! V_61 || ! V_24 )
return NULL ;
if ( ! V_83 )
V_132 = strlen ( V_61 ) + strlen ( V_131 ) - 2 + 1 ;
V_10 = F_26 ( sizeof( struct V_10 ) + V_20 + V_132 , V_41 ) ;
if ( ! V_10 )
return NULL ;
if ( ! V_83 ) {
V_130 = ( char * ) V_10 + sizeof( struct V_10 ) + V_20 ;
snprintf ( V_130 , V_132 , V_131 , V_61 ) ;
} else {
V_130 = ( char * ) V_83 ;
}
V_10 -> V_83 = V_130 ;
...
V_10 -> V_6 . V_13 = V_6 ;
V_10 -> V_6 . type = & V_133 ;
V_10 -> V_127 = F_90 ( & V_128 , 0 , 0 , V_41 ) ;
if ( V_10 -> V_127 < 0 ) {
F_4 ( V_6 , L_62 , V_10 -> V_127 ) ;
F_91 ( & V_10 -> V_6 ) ;
return NULL ;
}
F_92 ( & V_10 -> V_6 , L_63 , V_10 -> V_127 ) ;
F_93 ( & V_10 -> V_118 , 0 ) ;
V_10 -> V_134 = & V_135 ;
F_94 ( & V_10 -> V_109 ) ;
F_95 ( & V_10 -> V_43 ) ;
