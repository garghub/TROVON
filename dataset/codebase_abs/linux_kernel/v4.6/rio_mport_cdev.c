...
V_20 ) ;
V_237 -> V_274 = F_130 ( V_6 , 0 , V_249 ,
V_20 , V_275 ) ;
}
F_6 ( V_6 , V_249 , V_20 , V_276 ,
& V_237 -> V_277 ) ;
F_6 ( V_6 , V_249 , V_20 , V_278 ,
& V_237 -> V_279 ) ;
V_237 -> V_280 = V_244 . V_57 ;
V_237 -> V_249 = V_249 ;
V_237 -> V_20 = V_20 ;
...
if ( V_237 -> V_279 & V_284 )
F_133 ( & V_237 -> V_285 [ V_286 ] ,
0 , 0xffff ) ;
V_41 = F_134 ( V_237 ) ;
if ( V_41 )
goto V_257;
...
F_138 ( V_237 ) ;
F_139 ( V_237 , V_287 ) ;
if ( F_109 ( & V_240 -> V_288 ) ) {
F_140 ( V_240 ) ;
V_6 -> V_240 = NULL ;
}
return 0 ;
}
static int F_141 ( struct V_289 * V_289 , struct V_24 * V_25 )
{
int V_13 ;
int V_290 = F_142 ( V_289 ) ;
struct V_23 * V_291 ;
struct V_1 * V_2 ;
if ( V_290 >= V_292 ) {
F_24 ( L_50 ) ;
...
sizeof( struct V_183 ) * V_300 ,
V_32 ) ;
if ( V_13 < 0 ) {
F_111 ( & V_291 -> V_68 , V_192 L_51 ) ;
V_13 = - V_18 ;
goto V_301;
}
#ifdef F_149
...
static int F_151 ( int V_302 , struct V_24 * V_25 , int V_303 )
{
struct V_1 * V_2 = V_25 -> V_44 ;
return F_152 ( V_302 , V_25 , V_303 , & V_2 -> V_304 ) ;
}
...
static int F_158 ( struct V_289 * V_289 , struct V_24 * V_25 )
{
struct V_1 * V_2 = V_25 -> V_44 ;
struct V_23 * V_291 ;
struct V_222 * V_223 , * V_306 ;
struct V_197 * V_198 , * V_307 ;
struct V_29 * V_30 , * V_48 ;
unsigned long V_91 ;
...
static void F_163 ( struct V_334 * V_335 )
{
struct V_29 * V_30 = V_335 -> V_336 ;
F_13 ( V_333 , L_66 , & V_30 -> V_37 ) ;
F_53 ( & V_30 -> V_38 ) ;
}
static void F_164 ( struct V_334 * V_335 )
{
struct V_29 * V_30 = V_335 -> V_336 ;
F_13 ( V_333 , L_66 , & V_30 -> V_37 ) ;
F_20 ( & V_30 -> V_7 -> V_42 ) ;
...
static int F_165 ( struct V_24 * V_25 , struct V_334 * V_335 )
{
struct V_1 * V_2 = V_25 -> V_44 ;
struct V_23 * V_7 ;
...
V_13 = F_166 ( V_7 -> V_6 -> V_68 . V_169 , V_335 ,
V_30 -> V_149 , V_30 -> V_37 , V_30 -> V_27 ) ;
else if ( V_30 -> V_34 == V_35 ) {
V_335 -> V_340 = F_167 ( V_335 -> V_340 ) ;
V_13 = F_168 ( V_335 , V_30 -> V_37 , V_30 -> V_27 ) ;
} else {
F_24 ( L_69 ) ;
V_13 = - V_124 ;
}
...
static unsigned int F_169 ( struct V_24 * V_25 , T_9 * V_342 )
{
struct V_1 * V_2 = V_25 -> V_44 ;
F_170 ( V_25 , & V_2 -> V_191 , V_342 ) ;
if ( F_171 ( & V_2 -> V_190 ) )
return V_343 | V_344 ;
return 0 ;
}
static T_10 F_172 ( struct V_24 * V_25 , char T_1 * V_345 , T_3 V_155 ,
T_11 * V_346 )
{
struct V_1 * V_2 = V_25 -> V_44 ;
int V_347 ;
...
return V_13 ;
while ( V_13 < V_155 ) {
if ( F_175 ( & V_2 -> V_190 , V_345 ,
sizeof( struct V_183 ) , & V_347 ) )
return - V_15 ;
V_13 += V_347 ;
V_345 += V_347 ;
}
...
static T_10 F_176 ( struct V_24 * V_25 , const char T_1 * V_345 ,
T_3 V_155 , T_11 * V_346 )
{
struct V_1 * V_2 = V_25 -> V_44 ;
struct V_5 * V_6 = V_2 -> V_7 -> V_6 ;
struct V_183 V_184 ;
...
return - V_17 ;
V_350 = 0 ;
while ( ( V_155 - V_350 ) >= ( int ) sizeof( V_184 ) ) {
if ( F_3 ( & V_184 , V_345 , sizeof( V_184 ) ) )
return - V_15 ;
...
F_150 ( & V_7 -> V_297 ) ;
F_131 ( & V_7 -> V_299 ) ;
F_180 ( & V_7 -> V_294 , & V_353 ) ;
V_7 -> V_294 . V_354 = V_355 ;
V_13 = F_181 ( & V_7 -> V_294 , F_182 ( F_183 ( V_356 ) , V_6 -> V_242 ) , 1 ) ;
if ( V_13 < 0 ) {
F_18 ( V_7 ) ;
F_24 ( L_72 , V_13 ) ;
return NULL ;
...
F_127 ( & V_7 -> V_68 , V_360 L_73 , V_6 -> V_242 ) ;
F_184 ( & V_7 -> V_296 , 1 ) ;
V_13 = F_185 ( & V_7 -> V_68 ) ;
if ( V_13 ) {
F_24 ( L_74 ,
...
F_119 ( V_238 L_75 ,
V_6 -> V_250 , F_183 ( V_356 ) , V_6 -> V_242 ) ;
F_20 ( & V_373 ) ;
F_17 ( & V_7 -> V_39 , & V_374 ) ;
F_22 ( & V_373 ) ;
F_119 ( V_238 L_76 ,
...
{
int V_13 ;
V_359 = F_200 ( V_355 , V_192 ) ;
if ( F_60 ( V_359 ) ) {
F_24 ( L_80 V_192 L_81 ) ;
return F_61 ( V_359 ) ;
}
V_13 = F_201 ( & V_356 , 0 , V_292 , V_192 ) ;
if ( V_13 < 0 )
goto V_381;
F_13 ( V_295 , L_82 , F_183 ( V_356 ) ) ;
V_13 = F_202 ( & V_382 ) ;
if ( V_13 ) {
F_24 ( L_83 , V_13 ) ;
goto V_383;
