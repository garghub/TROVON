...
struct V_14 * V_15 = F_14 ( V_2 ) ;
int V_216 ;
if ( F_128 ( L_30 , & V_216 ) < 0 )
goto V_217;
if ( V_15 -> V_38 . V_218 < ( T_2 ) V_216 )
goto V_217;
V_209 = F_187 ( V_210 , V_49 ,
L_23
L_31
L_32 V_219 L_33 ,
V_213 , V_216 , V_15 -> V_38 . V_218 ) ;
break;
}
default:
V_217:
F_187 ( V_210 , V_49 , L_34 , V_213 ) ;
break;
}
return 0 ;
}
...
{
char V_211 [ V_212 ] , * V_213 = F_186 ( V_62 , V_211 , sizeof( V_211 ) ) ;
int V_220 = V_2 -> V_125 / 1024 , V_221 , V_209 = 0 ;
switch ( V_62 ) {
case V_215 :
F_128 ( L_7 , & V_221 ) ;
V_209 += F_187 ( V_210 + V_209 , V_49 - V_209 ,
...
return;
F_19 (evlist, n, evsel) {
if ( V_18 -> V_32 == V_222 -> V_32 )
F_191 ( & V_18 -> V_21 , & V_223 ) ;
}
F_192 ( & V_223 , & V_2 -> V_10 ) ;
}
