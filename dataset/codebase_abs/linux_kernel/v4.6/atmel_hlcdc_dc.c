...
struct V_1 * V_2 = V_27 -> V_28 ;
unsigned int V_31 ;
F_57 ( V_2 -> V_33 -> V_34 , V_91 , 0xffffffff ) ;
F_3 ( V_2 -> V_33 -> V_34 , V_36 , & V_31 ) ;
}
...
{
struct V_1 * V_2 = V_27 -> V_28 ;
F_57 ( V_2 -> V_33 -> V_34 , V_91 , V_38 ) ;
}
static int F_61 ( struct V_69 * V_70 )
{
struct V_26 * V_93 ;
int V_56 ;
V_93 = F_62 ( & V_94 , & V_70 -> V_27 ) ;
if ( ! V_93 )
return - V_79 ;
V_56 = F_20 ( V_93 ) ;
if ( V_56 )
...
static int F_68 ( struct V_98 * V_27 )
{
struct V_26 * V_99 = F_25 ( V_27 ) ;
struct V_100 * V_39 ;
if ( F_69 ( V_27 ) )
return 0 ;
F_70 ( V_99 ) ;
...
static int F_73 ( struct V_98 * V_27 )
{
struct V_26 * V_99 = F_25 ( V_27 ) ;
struct V_100 * V_39 ;
if ( F_69 ( V_27 ) )
