...
int F_40 ( struct V_6 * V_7 , unsigned int V_1 )
{
const struct V_98 * V_99 = V_7 -> V_22 -> V_1 ;
struct V_46 * V_100 , * V_101 ;
enum V_83 V_84 ;
unsigned int V_8 ;
int V_12 = 0 ;
if ( V_7 -> V_102 == 0 )
...
if ( F_41 ( V_101 ) )
F_42 ( V_101 ) ;
if ( ! F_26 ( V_100 ) && ! F_26 ( V_101 ) )
F_32 ( V_7 ) ;
V_12 = V_99 -> V_28 ( V_7 , & V_8 ) ;
if ( V_12 < 0 ) {
F_9 ( & V_7 -> V_13 -> V_29 ,
L_9 , V_12 ) ;
goto V_16;
...
if ( ! F_26 ( V_100 ) ) {
F_43 ( V_84 , V_100 , V_101 ) ;
V_7 -> V_100 = V_100 ;
if ( V_7 -> V_82 == NULL ) {
V_12 = V_99 -> V_103 ( V_7 , V_1 ) ;
if ( V_12 < 0 ) {
F_9 ( & V_7 -> V_13 -> V_29 ,
L_10 ,
V_12 ) ;
...
static int
F_48 ( T_1 * V_58 , unsigned int V_106 ,
struct V_107 * V_108 )
{
unsigned int V_3 , V_109 , V_51 , V_110 ;
if ( ( V_58 [ 0 ] != 0x90 ) || ( V_58 [ 1 ] != 0x40 ) )
return - V_64 ;
for ( V_3 = 0 ; V_3 < F_2 ( V_111 ) ; V_3 ++ ) {
if ( V_58 [ 2 ] == V_111 [ V_3 ] )
break;
}
if ( V_3 == F_2 ( V_111 ) )
return - V_64 ;
memset ( & V_108 [ V_3 ] , 0 , sizeof( struct V_107 ) ) ;
for ( V_109 = 0 ; V_109 < V_58 [ 4 ] ; V_109 ++ ) {
V_51 = V_58 [ 5 + V_109 * 2 ] ;
V_110 = V_58 [ 6 + V_109 * 2 ] ;
switch ( V_110 ) {
case 0x00 :
case 0x06 :
V_108 [ V_3 ] . V_52 += V_51 ;
...
if ( V_108 [ V_3 ] . V_52 > V_65 ||
V_108 [ V_3 ] . V_53 > V_112 )
return - V_64 ;
return 0 ;
}
static int
F_49 ( struct V_6 * V_7 , enum V_59 V_60 ,
...
F_52 ( struct V_6 * V_7 )
{
T_1 V_118 [ V_119 ] , V_23 [ V_24 ] ;
unsigned int V_3 ;
enum V_27 type ;
int V_12 ;
V_12 = F_53 ( V_7 -> V_13 , 0x0c , 0x00 , 0x00 , V_118 ) ;
if ( V_12 < 0 ) {
F_9 ( & V_7 -> V_13 -> V_29 ,
L_15 ,
V_12 ) ;
...
unsigned int V_3 ;
int V_12 ;
V_12 = F_53 ( V_7 -> V_13 , 0x1f , 0x07 , 0x00 , V_118 ) ;
if ( V_12 < 0 ) {
F_9 ( & V_7 -> V_13 -> V_29 ,
L_17 ,
V_12 ) ;
...
V_12 = F_49 ( V_7 , V_36 , 0 ) ;
if ( V_12 < 0 )
goto V_16;
V_7 -> V_121 = 0 ;
for ( V_3 = 0 ; V_3 < V_118 [ 2 ] ; V_3 ++ ) {
F_12 ( V_23 , V_35 ,
V_42 , V_3 ) ;
V_12 = F_13 ( V_7 -> V_13 , V_23 , & type ) ;
if ( V_12 < 0 ) {
