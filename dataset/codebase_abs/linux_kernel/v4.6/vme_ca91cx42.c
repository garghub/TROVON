...
F_17 ( & V_16 -> V_48 ) ;
F_18 ( & V_16 -> V_49 ) ;
F_14 ( 0 , V_2 -> V_19 + V_50 ) ;
F_14 ( 0 , V_2 -> V_19 + V_29 ) ;
F_14 ( 0x00FFFFFF , V_2 -> V_19 + V_30 ) ;
V_44 = F_19 ( V_47 -> V_26 , F_12 , V_51 ,
V_52 , V_16 ) ;
if ( V_44 ) {
F_8 ( & V_47 -> V_53 , L_4 ,
V_47 -> V_26 ) ;
...
F_14 ( 0 , V_2 -> V_19 + V_29 ) ;
F_14 ( 0x00FFFFFF , V_2 -> V_19 + V_30 ) ;
V_16 = F_21 ( ( void * ) V_2 , struct V_15 ,
V_18 ) ;
F_22 ( V_47 -> V_26 , V_16 ) ;
}
static int F_23 ( struct V_1 * V_2 , int V_61 )
{
T_1 V_45 ;
...
static void F_24 ( struct V_15 * V_16 , int V_61 ,
int V_62 , int V_63 )
{
struct V_46 * V_47 ;
T_1 V_45 ;
...
static int F_26 ( struct V_15 * V_16 , int V_61 ,
int V_65 )
{
T_1 V_45 ;
struct V_1 * V_2 ;
...
return - V_66 ;
F_27 ( & V_2 -> V_67 ) ;
V_45 = F_7 ( V_2 -> V_19 + V_50 ) ;
F_14 ( V_65 << 24 , V_2 -> V_19 + V_68 ) ;
V_45 = V_45 | ( 1 << ( V_61 + 24 ) ) ;
F_14 ( V_45 , V_2 -> V_19 + V_50 ) ;
F_28 ( V_2 -> V_13 ,
F_23 ( V_2 , V_61 ) ) ;
V_45 = F_7 ( V_2 -> V_19 + V_50 ) ;
V_45 = V_45 & ~ ( 1 << ( V_61 + 24 ) ) ;
...
static int F_32 ( struct V_114 * V_70 ,
...
V_116 = F_37 ( V_47 -> V_129 ,
& V_70 -> V_117 , V_73 , 0x10000 , V_130 ,
0 , NULL , NULL ) ;
if ( V_116 ) {
F_8 ( V_16 -> V_21 , L_14
L_15 ,
...
static void F_39 ( struct V_114 * V_70 )
{
F_33 ( V_70 -> V_120 ) ;
V_70 -> V_120 = NULL ;
F_35 ( & V_70 -> V_117 ) ;
...
static int F_40 ( struct V_114 * V_70 , int V_71 ,
...
static int F_43 ( struct V_114 * V_70 ,
...
static int F_44 ( struct V_114 * V_70 , int * V_71 ,
unsigned long long * V_72 , unsigned long long * V_73 , T_1 * V_75 ,
T_1 * V_76 , T_1 * V_133 )
{
int V_116 ;
F_41 ( & V_70 -> V_137 ) ;
V_116 = F_43 ( V_70 , V_71 , V_72 , V_73 , V_75 ,
V_76 , V_133 ) ;
F_42 ( & V_70 -> V_137 ) ;
return V_116 ;
}
static T_4 F_45 ( struct V_114 * V_70 ,
...
if ( ( V_173 - V_175 ) < 2 ) {
* ( V_178 * ) ( V_172 + V_175 ) = F_46 ( V_77 + V_175 ) ;
V_175 += 1 ;
goto V_179;
} else {
* ( V_180 * ) ( V_172 + V_175 ) = F_47 ( V_77 + V_175 ) ;
V_175 += 2 ;
}
}
...
static unsigned int F_51 ( struct V_114 * V_70 ,
...
static int F_52 ( struct V_193 * V_194 ,
...
int V_116 = 0 ;
struct V_185 * V_53 ;
V_53 = V_194 -> V_21 -> V_21 -> V_21 ;
V_199 = F_36 ( sizeof( struct V_198 ) , V_206 ) ;
if ( V_199 == NULL ) {
F_8 ( V_53 , L_22
L_23 ) ;
V_116 = - V_125 ;
...
F_53 ( & V_199 -> V_194 , & V_194 -> V_237 ) ;
if ( V_199 -> V_194 . V_200 != & V_194 -> V_237 ) {
V_200 = F_54 ( V_199 -> V_194 . V_200 , struct V_198 ,
V_194 ) ;
V_205 = F_55 ( & V_199 -> V_208 ) ;
...
V_240 = V_194 -> V_21 ;
V_2 = V_240 -> V_21 -> V_18 ;
V_53 = V_240 -> V_21 -> V_21 ;
F_27 ( & V_240 -> V_242 ) ;
if ( ! ( F_58 ( & V_240 -> V_243 ) ) ) {
F_29 ( & V_240 -> V_242 ) ;
return - V_244 ;
} else {
F_59 ( & V_194 -> V_194 , & V_240 -> V_243 ) ;
}
V_199 = F_60 ( & V_194 -> V_237 , struct V_198 ,
V_194 ) ;
V_241 = F_55 ( & V_199 -> V_208 ) ;
F_29 ( & V_240 -> V_242 ) ;
...
F_62 ( V_262 ) ;
V_199 = F_54 ( V_262 , struct V_198 , V_194 ) ;
F_34 ( V_199 ) ;
}
return 0 ;
}
...
static int F_66 ( struct V_264 * V_265 ,
unsigned long long * V_266 , T_1 * V_75 , T_1 * V_76 )
{
T_1 V_268 , V_71 = 0 ;
struct V_1 * V_2 ;
...
static int F_67 ( struct V_264 * V_265 , int V_281 ,
void (* F_68)( int ) )
{
T_1 V_268 , V_45 ;
struct V_1 * V_2 ;
...
static int F_69 ( struct V_264 * V_265 , int V_281 )
{
T_1 V_45 ;
struct V_1 * V_2 ;
V_2 = V_265 -> V_21 -> V_18 ;
...
F_76 ( & V_47 -> V_53 , L_36 , V_282 ) ;
if ( V_282 == 0 ) {
F_8 ( & V_47 -> V_53 , L_37
L_38 ) ;
return - V_66 ;
}
V_2 -> V_289 = F_77 ( V_47 , V_290 ,
& V_2 -> V_291 ) ;
if ( V_2 -> V_289 == NULL ) {
F_8 ( & V_47 -> V_53 , L_39
L_40 ) ;
...
F_74 ( V_47 , V_290 , V_2 -> V_289 ,
V_2 -> V_291 ) ;
}
static int F_79 ( struct V_46 * V_47 , const struct V_295 * V_296 )
{
int V_116 , V_6 ;
T_1 V_297 ;
...
struct V_239 * V_302 ;
struct V_264 * V_265 ;
V_16 = F_80 ( sizeof( struct V_15 ) , V_206 ) ;
if ( V_16 == NULL ) {
F_8 ( & V_47 -> V_53 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_299 = F_80 ( sizeof( struct V_1 ) , V_206 ) ;
if ( V_299 == NULL ) {
F_8 ( & V_47 -> V_53 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_116 = F_82 ( V_47 , V_52 ) ;
if ( V_116 ) {
F_8 ( & V_47 -> V_53 , L_43 ) ;
goto V_131;
}
V_299 -> V_19 = F_38 ( F_83 ( V_47 , 0 ) ,
4096 ) ;
if ( ! V_299 -> V_19 ) {
F_8 ( & V_47 -> V_53 , L_44 ) ;
V_116 = - V_260 ;
...
V_300 = F_36 ( sizeof( struct V_114 ) ,
V_206 ) ;
if ( V_300 == NULL ) {
F_8 ( & V_47 -> V_53 , L_47
L_48 ) ;
...
V_302 = F_36 ( sizeof( struct V_239 ) ,
V_206 ) ;
if ( V_302 == NULL ) {
F_8 ( & V_47 -> V_53 , L_47
L_50 ) ;
...
F_17 ( & V_16 -> V_327 ) ;
V_265 = F_36 ( sizeof( struct V_264 ) , V_206 ) ;
if ( V_265 == NULL ) {
F_8 ( & V_47 -> V_53 , L_47
L_51 ) ;
V_116 = - V_125 ;
...
V_265 = F_54 ( V_262 , struct V_264 , V_194 ) ;
F_62 ( V_262 ) ;
F_34 ( V_265 ) ;
}
V_322:
F_64 (pos, n, &ca91cx42_bridge->dma_resources) {
V_302 = F_54 ( V_262 , struct V_239 , V_194 ) ;
F_62 ( V_262 ) ;
F_34 ( V_302 ) ;
}
V_319:
F_64 (pos, n, &ca91cx42_bridge->slave_resources) {
V_301 = F_54 ( V_262 , struct V_69 , V_194 ) ;
F_62 ( V_262 ) ;
F_34 ( V_301 ) ;
}
V_312:
F_64 (pos, n, &ca91cx42_bridge->master_resources) {
V_300 = F_54 ( V_262 , struct V_114 ,
V_194 ) ;
F_62 ( V_262 ) ;
F_34 ( V_300 ) ;
}
