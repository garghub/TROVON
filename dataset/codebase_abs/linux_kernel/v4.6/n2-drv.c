...
static int F_42 ( struct V_112 * V_60 )
{
...
F_40 () ;
V_26 = F_44 ( & V_60 -> V_61 , sizeof( * V_26 ) , V_118 ) ;
if ( ! V_26 )
goto V_119;
V_26 -> V_60 = V_60 ;
F_45 ( & V_26 -> V_72 , F_36 ) ;
...
V_26 -> V_47 = F_47 ( V_60 -> V_61 . V_124 ,
L_12 , 0 ) ;
if ( ! V_26 -> V_47 ) {
F_22 ( & V_60 -> V_61 , L_13 ) ;
goto V_123;
...
V_26 -> V_50 = F_44 ( & V_60 -> V_61 ,
sizeof( struct V_48 ) * V_26 -> V_47 ,
V_118 ) ;
V_59 = - V_116 ;
if ( ! V_26 -> V_50 )
goto V_123;
...
L_16 : L_17 ) ,
V_26 -> V_47 ) ;
V_26 -> V_62 . V_125 = L_18 ;
V_26 -> V_62 . V_126 = F_24 ;
...
static int F_51 ( struct V_112 * V_60 )
{
struct V_25 * V_26 = F_52 ( V_60 ) ;
V_26 -> V_41 |= V_71 ;
F_53 ( & V_26 -> V_72 ) ;
F_54 ( & V_26 -> V_62 ) ;
F_50 ( V_121 ) ;
