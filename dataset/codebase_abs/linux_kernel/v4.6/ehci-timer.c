...
while ( ! F_20 ( & V_2 -> V_50 ) ) {
struct V_41 * V_42 ;
V_42 = F_21 ( & V_2 -> V_50 , struct V_41 ,
V_43 ) ;
...
static enum V_81 F_37 ( struct V_13 * V_82 )
{
struct V_1 * V_2 = F_38 ( V_82 , struct V_1 , V_13 ) ;
T_2 V_83 ;
unsigned long V_84 ;
unsigned long V_85 ;
unsigned V_86 ;
...
V_2 -> V_12 = V_88 ;
V_83 = F_7 () ;
F_40 (e, &events, EHCI_HRTIMER_NUM_EVENTS) {
if ( V_83 . V_89 >= V_2 -> V_9 [ V_86 ] . V_89 )
V_90 [ V_86 ] ( V_2 ) ;
else
F_5 ( V_2 , V_86 , false ) ;
}
