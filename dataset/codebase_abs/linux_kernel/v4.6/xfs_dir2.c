...
! ( args -> V_93 & V_102 ) )
return - V_103 ;
args -> V_104 = F_37 ( V_5 , V_75 | V_29 ) ;
if ( ! args -> V_104 )
return - V_31 ;
memcpy ( args -> V_104 , V_2 , V_5 ) ;
args -> V_105 = V_5 ;
return - V_103 ;
}
int
...
* V_79 = args -> V_89 ;
if ( V_106 ) {
V_106 -> V_2 = args -> V_104 ;
V_106 -> V_5 = args -> V_105 ;
}
}
V_99:
F_44 ( V_49 , V_107 ) ;
...
int error ;
F_57 ( args , V_111 ) ;
V_114 = F_58 ( V_14 , V_111 * V_115 ) ;
V_57 = args -> V_76 -> V_35 ;
error = F_59 ( args , & V_114 , V_57 ) ;
if ( error )
return error ;
* V_112 = F_60 ( args -> V_76 , ( V_116 ) V_114 ) ;
if ( V_111 == V_117 ) {
T_15 V_118 ;
V_118 = F_61 ( V_14 , V_114 + V_57 ) ;
if ( V_118 > V_49 -> V_52 . V_53 ) {
V_49 -> V_52 . V_53 = V_118 ;
F_62 ( args -> V_78 , V_49 , V_119 ) ;
}
}
return 0 ;
}
...
T_14 V_121 ;
int V_83 ;
if ( ( V_83 = F_63 ( args -> V_49 , & V_121 , V_92 ) ) )
return V_83 ;
V_83 = F_61 ( args -> V_49 -> V_77 , V_121 ) == args -> V_76 -> V_34 ;
ASSERT ( V_83 == 0 || args -> V_49 -> V_52 . V_53 == args -> V_76 -> V_34 ) ;
* V_120 = V_83 ;
return 0 ;
}
int
...
V_14 = V_49 -> V_77 ;
V_71 = args -> V_78 ;
V_125 = F_66 ( args -> V_76 , V_122 ) ;
error = F_67 ( V_71 , V_49 , V_125 , args -> V_76 -> V_35 , 0 , 0 ,
args -> V_90 , args -> V_81 , & V_126 ) ;
if ( error ) {
return error ;
}
ASSERT ( V_126 ) ;
F_68 ( V_71 , V_124 ) ;
if ( V_122 >= F_69 ( args -> V_76 , V_39 ) )
return 0 ;
if ( V_49 -> V_52 . V_53 > F_70 ( args -> V_76 , V_122 + 1 , 0 ) )
return 0 ;
V_114 = V_125 ;
if ( ( error = F_71 ( V_71 , V_49 , & V_114 , V_92 ) ) ) {
return error ;
}
...
ASSERT ( V_114 > 0 ) ;
V_49 -> V_52 . V_53 = F_61 ( V_14 , V_114 ) ;
F_62 ( V_71 , V_49 , V_119 ) ;
return 0 ;
}
