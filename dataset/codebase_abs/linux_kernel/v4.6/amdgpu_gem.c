...
int F_39 ( struct V_31 * V_61 , void * V_64 ,
struct V_33 * V_65 )
{
struct V_9 * V_10 = V_61 -> V_66 ;
...
V_49 -> V_87 = V_30 ;
V_49 -> V_88 = V_30 ;
V_18 = F_41 ( V_49 -> V_7 . V_89 , args -> V_79 , args -> V_14 ) ;
if ( V_18 )
goto V_90;
if ( args -> V_14 & V_83 ) {
V_18 = F_42 ( V_49 , args -> V_79 ) ;
if ( V_18 )
goto V_90;
}
if ( args -> V_14 & V_82 ) {
F_43 ( & V_91 -> V_92 -> V_93 ) ;
V_18 = F_44 ( V_49 -> V_7 . V_89 ,
V_49 -> V_7 . V_89 -> V_94 ) ;
if ( V_18 )
goto V_95;
V_18 = F_21 ( V_49 , true ) ;
...
goto V_96;
F_45 ( V_49 , V_30 ) ;
V_18 = F_46 ( & V_49 -> V_7 , & V_49 -> V_97 , true , false ) ;
F_24 ( V_49 ) ;
if ( V_18 )
goto V_96;
F_47 ( & V_91 -> V_92 -> V_93 ) ;
...
return 0 ;
V_96:
F_48 ( V_49 -> V_7 . V_89 -> V_94 , V_49 -> V_7 . V_89 -> V_98 , false ) ;
V_95:
F_47 ( & V_91 -> V_92 -> V_93 ) ;
V_90:
F_38 ( V_2 ) ;
...
int F_49 ( struct V_33 * V_65 ,
struct V_31 * V_61 ,
T_4 V_36 , T_3 * V_99 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 ;
V_2 = F_50 ( V_61 , V_65 , V_36 ) ;
if ( V_2 == NULL ) {
return - V_100 ;
}
V_4 = F_2 ( V_2 ) ;
if ( F_51 ( V_4 -> V_7 . V_89 ) ||
( V_4 -> V_14 & V_101 ) ) {
F_38 ( V_2 ) ;
return - V_102 ;
}
...
int F_53 ( struct V_31 * V_61 , void * V_64 ,
struct V_33 * V_65 )
{
union V_103 * args = V_64 ;
T_4 V_36 = args -> V_68 . V_36 ;
memset ( args , 0 , sizeof( * args ) ) ;
return F_49 ( V_65 , V_61 , V_36 , & args -> V_77 . V_104 ) ;
}
unsigned long F_54 ( T_3 V_105 )
{
unsigned long V_106 ;
T_5 V_107 ;
if ( ( ( V_108 ) V_105 ) < 0 )
return V_109 ;
V_107 = F_55 ( F_56 ( V_105 ) , F_57 () ) ;
if ( F_58 ( V_107 ) < 0 )
return 0 ;
V_106 = F_59 ( F_58 ( V_107 ) ) ;
if ( V_106 > V_109 )
return V_109 - 1 ;
return V_106 ;
}
int F_60 ( struct V_31 * V_61 , void * V_64 ,
struct V_33 * V_65 )
{
struct V_9 * V_10 = V_61 -> V_66 ;
...
struct V_3 * V_4 ;
T_4 V_36 = args -> V_68 . V_36 ;
unsigned long V_107 = F_54 ( args -> V_68 . V_107 ) ;
int V_18 = 0 ;
long V_111 ;
V_2 = F_50 ( V_61 , V_65 , V_36 ) ;
if ( V_2 == NULL ) {
...
V_4 = F_2 ( V_2 ) ;
if ( V_107 == 0 )
V_111 = F_61 ( V_4 -> V_7 . V_112 , true ) ;
else
V_111 = F_62 ( V_4 -> V_7 . V_112 , true , true , V_107 ) ;
if ( V_111 >= 0 ) {
memset ( args , 0 , sizeof( * args ) ) ;
...
int F_63 ( struct V_31 * V_61 , void * V_64 ,
struct V_33 * V_65 )
{
...
goto V_77;
if ( args -> V_115 == V_116 ) {
F_65 ( V_4 , & args -> V_64 . V_117 ) ;
V_18 = F_66 ( V_4 , args -> V_64 . V_64 ,
...
V_18 = F_67 ( V_4 , args -> V_64 . V_117 ) ;
if ( ! V_18 )
V_18 = F_68 ( V_4 , args -> V_64 . V_64 ,
args -> V_64 . V_118 ,
args -> V_64 . V_14 ) ;
}
V_120:
...
V_123 = F_71 ( V_122 -> V_49 -> V_125 . V_126 ) ;
if ( V_123 == V_85 )
goto V_127;
}
...
if ( V_18 )
goto V_127;
V_18 = F_73 ( V_10 , V_47 -> V_45 ) ;
if ( V_18 )
goto V_127;
if ( V_121 == V_128 )
V_18 = F_74 ( V_10 , V_47 , & V_47 -> V_49 -> V_7 . V_125 ) ;
V_127:
F_32 ( & V_58 , & V_53 ) ;
V_124:
if ( V_18 && V_18 != - V_28 )
...
int F_75 ( struct V_31 * V_61 , void * V_64 ,
struct V_33 * V_65 )
{
...
break;
case V_143 :
V_18 = F_77 ( V_10 , V_47 , args -> V_136 ) ;
break;
default:
break;
}
...
! V_150 )
F_69 ( V_10 , V_47 , args -> V_121 ) ;
F_38 ( V_2 ) ;
return V_18 ;
}
int F_78 ( struct V_31 * V_61 , void * V_64 ,
struct V_33 * V_65 )
{
...
V_154 . V_76 = V_4 -> V_14 ;
F_24 ( V_4 ) ;
if ( F_79 ( V_77 , & V_154 , sizeof( V_154 ) ) )
V_18 = - V_158 ;
break;
}
case V_159 :
...
T_4 V_36 ;
int V_18 ;
args -> V_161 = F_81 ( V_10 , args -> V_162 , args -> V_163 , 0 ) * ( ( args -> V_163 + 1 ) / 8 ) ;
args -> V_11 = ( T_2 ) args -> V_161 * args -> V_164 ;
args -> V_11 = F_82 ( args -> V_11 , V_19 ) ;
V_18 = F_6 ( V_10 , args -> V_11 , 0 ,
V_29 ,
V_165 ,
V_166 ,
...
static int F_83 ( int V_167 , void * V_168 , void * V_64 )
{
...
const char * V_97 ;
unsigned V_171 ;
V_123 = F_71 ( V_49 -> V_7 . V_125 . V_126 ) ;
switch ( V_123 ) {
case V_29 :
V_97 = L_12 ;
break;
...
F_84 ( V_170 , L_15 ,
V_167 , F_85 ( V_49 ) , V_97 ,
F_86 ( V_49 ) ) ;
V_171 = F_87 ( V_49 -> V_171 ) ;
if ( V_171 )
F_84 ( V_170 , L_16 , V_171 ) ;
F_84 ( V_170 , L_17 ) ;
return 0 ;
}
static int F_88 ( struct V_169 * V_170 , void * V_64 )
{
...
struct V_176 * V_177 ;
F_90 () ;
V_177 = F_91 ( V_34 -> V_178 , V_179 ) ;
F_84 ( V_170 , L_18 , F_92 ( V_34 -> V_178 ) ,
V_177 ? V_177 -> V_180 : L_19 ) ;
F_93 () ;
F_14 ( & V_34 -> V_37 ) ;
F_94 ( & V_34 -> V_38 , F_83 , V_170 ) ;
F_18 ( & V_34 -> V_37 ) ;
}
F_19 ( & V_61 -> V_35 ) ;
return 0 ;
