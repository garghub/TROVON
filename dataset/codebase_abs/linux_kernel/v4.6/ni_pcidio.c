...
int V_86 = 0 ;
unsigned int V_87 ;
V_86 |= F_44 ( & V_85 -> V_88 , V_89 | V_90 ) ;
V_86 |= F_44 ( & V_85 -> V_91 ,
V_92 | V_93 ) ;
V_86 |= F_44 ( & V_85 -> V_94 , V_89 ) ;
V_86 |= F_44 ( & V_85 -> V_95 , V_96 ) ;
V_86 |= F_44 ( & V_85 -> V_97 , V_96 | V_98 ) ;
if ( V_86 )
return 1 ;
V_86 |= F_45 ( V_85 -> V_88 ) ;
V_86 |= F_45 ( V_85 -> V_91 ) ;
...
if ( V_86 )
return 2 ;
V_86 |= F_46 ( & V_85 -> V_99 , 0 ) ;
#define F_47 (TIMER_BASE)
if ( V_85 -> V_91 == V_92 ) {
V_86 |= F_48 ( & V_85 -> V_100 ,
F_47 ) ;
} else {
...
V_86 |= F_46 ( & V_85 -> V_104 , 0 ) ;
V_86 |= F_46 ( & V_85 -> V_105 ,
V_85 -> V_106 ) ;
if ( V_85 -> V_97 == V_96 )
V_86 |= F_48 ( & V_85 -> V_107 , 1 ) ;
else
V_86 |= F_46 ( & V_85 -> V_107 , 0 ) ;
if ( V_86 )
return 3 ;
if ( V_85 -> V_91 == V_92 ) {
V_87 = V_85 -> V_100 ;
F_40 ( & V_87 , V_85 -> V_7 ) ;
V_86 |= F_46 ( & V_85 -> V_100 , V_87 ) ;
}
if ( V_86 )
return 4 ;
return 0 ;
...
static int F_50 ( struct V_2 * V_3 , struct V_18 * V_19 )
{
struct V_4 * V_5 = V_3 -> V_6 ;
struct V_84 * V_85 = & V_19 -> V_21 -> V_85 ;
...
if ( V_85 -> V_97 == V_98 ) {
V_5 -> V_109 = F_55 ( 0 ) | F_56 ( 7 ) ;
} else {
V_5 -> V_109 = V_130 | F_56 ( 7 ) ;
}
if ( V_85 -> V_88 == V_89 ) {
F_9 ( V_5 -> V_109 , V_3 -> V_16 + V_60 ) ;
V_19 -> V_21 -> V_110 = NULL ;
} else {
V_19 -> V_21 -> V_110 = F_49 ;
}
return 0 ;
}
...
int V_136 ;
T_3 V_137 ;
F_53 ( 0x80 | V_135 , V_3 -> V_16 + V_138 ) ;
F_53 ( 0xc0 | V_135 , V_3 -> V_16 + V_138 ) ;
for ( V_136 = 0 ;
( F_61 ( V_3 -> V_16 + V_139 ) & 0x2 ) == 0 &&
V_136 < V_134 ; ++ V_136 ) {
F_62 ( 1 ) ;
}
if ( V_136 == V_134 ) {
...
F_53 ( 0x0 , V_3 -> V_16 + V_138 ) ;
return 0 ;
}
static int F_66 ( struct V_2 * V_3 , int V_135 )
{
return F_60 ( V_3 , NULL , 0 , V_135 ) ;
}
...
V_72 = F_70 ( V_3 , & V_5 -> V_10 -> V_153 -> V_3 ,
V_149 [ V_74 ] ,
F_60 , V_74 ) ;
if ( V_72 == 0 && V_74 == 2 )
F_68 ( V_3 ) ;
...
F_27 ( 0 , V_3 -> V_16 + F_72 ( 0 ) ) ;
F_9 ( 0 , V_3 -> V_16 + V_51 ) ;
}
static int F_73 ( struct V_2 * V_3 ,
unsigned long V_133 )
{
struct V_154 * V_153 = F_74 ( V_3 ) ;
...
if ( ! V_5 -> V_10 )
return - V_162 ;
V_72 = F_80 ( V_3 , V_5 -> V_10 ) ;
if ( V_72 < 0 )
return V_72 ;
V_5 -> V_11 = F_81 ( V_5 -> V_10 ) ;
if ( ! V_5 -> V_11 )
return - V_162 ;
if ( V_156 -> V_163 ) {
V_72 = F_69 ( V_3 ) ;
...
static int F_91 ( struct V_154 * V_3 ,
const struct V_188 * V_189 )
{
return F_92 ( V_3 , & V_190 , V_189 -> V_191 ) ;
}
