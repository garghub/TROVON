...
static void F_35 ( struct V_8 * V_15 )
{
struct V_90 * V_11 = & V_15 -> V_11 ;
T_2 * V_91 ;
int V_92 ;
V_93 . V_94 = F_36 ( V_11 ) ;
V_95 . V_94 = F_36 ( V_11 ) ;
...
static int
F_38 ( struct V_97 * V_98 , struct V_9 * V_10 )
{
struct V_27 * V_28 = V_98 -> V_28 ;
struct V_8 * V_15 = F_6 ( V_10 ) ;
struct V_99 * V_100 ;
int V_38 ;
struct V_22 * V_23 = NULL ;
struct V_30 * V_101 ;
V_101 = F_7 ( V_10 -> V_34 , struct V_30 , V_35 ) ;
V_15 -> V_11 . V_83 = V_98 -> V_28 -> V_83 ;
if ( ! V_101 -> V_102 ) {
V_38 = F_39 ( & V_15 -> V_11 ) ;
if ( V_38 < 0 )
return V_38 ;
...
V_100 = F_40 ( V_28 , V_103 , F_41 ( V_104 ) ) ;
if ( F_18 ( V_100 ) )
return F_42 ( V_100 ) ;
V_105 . V_106 = V_100 [ V_107 ] . V_46 ;
V_93 . V_108 = V_100 [ V_109 ] . V_46 ;
V_93 . V_110 = V_100 [ V_111 ] . V_46 ;
V_112 . V_113 = V_100 [ V_114 ] . V_46 ;
V_115 . V_108 = V_100 [ V_116 ] . V_46 ;
V_117 . V_106 = V_100 [ V_118 ] . V_46 ;
V_119 . V_106 = V_100 [ V_120 ] . V_46 ;
F_35 ( V_15 ) ;
V_38 = F_43 ( V_98 , V_10 ) ;
if ( V_38 < 0 )
goto V_121;
...
V_119 . V_122 = V_38 ;
V_38 = - V_123 ;
V_23 = F_44 ( V_28 -> V_83 , & V_124 ) ;
if ( ! V_23 )
goto V_121;
V_15 -> V_39 = V_23 ;
V_15 -> V_39 -> V_125 = & V_124 ;
V_38 = - V_5 ;
V_38 = F_45 ( V_10 , V_126 , V_126 , NULL ,
NULL ) ;
if ( V_38 )
goto V_121;
return 0 ;
...
static int F_47 ( struct V_57 * V_58 , T_2 V_53 , int V_60 )
{
V_58 -> V_14 [ V_53 ] = V_60 ;
return 0 ;
}
static int F_48 ( struct V_57 * V_58 , T_2 V_53 )
{
return V_58 -> V_14 [ V_53 ] ;
}
static int F_49 ( struct V_8 * V_15 )
{
F_50 ( & V_15 -> V_56 ) ;
F_51 ( & V_127 . V_20 , & V_15 -> V_56 ) ;
F_50 ( & V_127 . V_128 ) ;
F_51 ( & V_129 . V_20 , & V_127 . V_128 ) ;
F_51 ( & V_130 . V_20 , & V_127 . V_128 ) ;
V_130 . V_14 [ V_131 ] = 0xffc0 ;
V_130 . V_14 [ V_132 ] = 0xe3a0 ;
V_130 . V_14 [ V_133 ] = 0xfff0 ;
V_130 . V_14 [ V_134 ] = 0x0030 ;
return 0 ;
}
static inline struct V_30 * F_52 ( struct V_135 * V_136 )
{
return F_7 ( F_53 ( V_136 ) , struct V_30 ,
V_35 . V_137 ) ;
}
static void F_54 ( struct V_135 * V_136 )
{
struct V_30 * V_31 = F_52 ( V_136 ) ;
F_55 ( & V_31 -> V_35 ) ;
}
static void F_56 ( struct V_138 * V_10 )
{
struct V_30 * V_31 ;
...
static struct V_138 * F_57 ( void )
{
struct V_30 * V_31 ;
V_31 = F_2 ( sizeof( * V_31 ) , V_145 ) ;
if ( ! V_31 )
return F_3 ( - V_5 ) ;
F_58 ( & V_31 -> V_18 ) ;
V_31 -> V_35 . V_146 = F_56 ;
F_59 ( & V_31 -> V_35 . V_137 , L_8 ,
& V_147 ) ;
V_31 -> V_87 = V_148 ;
V_31 -> V_88 = V_149 ;
V_31 -> V_32 = V_150 ;
...
static void F_63 ( struct V_97 * V_98 , struct V_9 * V_10 )
{
F_64 ( V_10 ) ;
}
static struct V_9 * F_65 ( struct V_138 * V_34 )
{
struct V_8 * V_15 ;
struct V_30 * V_31 ;
V_15 = F_2 ( sizeof( * V_15 ) , V_145 ) ;
if ( ! V_15 )
return F_3 ( - V_5 ) ;
...
F_50 ( & V_15 -> V_19 ) ;
F_66 ( & V_15 -> V_18 ) ;
V_15 -> V_11 . V_12 . V_155 = F_38 ;
V_15 -> V_11 . V_12 . V_156 = F_63 ;
V_15 -> V_11 . V_12 . V_157 = F_30 ;
V_15 -> V_11 . V_12 . V_158 = F_29 ;
V_15 -> V_11 . V_12 . V_159 = F_34 ;
V_15 -> V_11 . V_12 . V_160 = F_60 ;
F_49 ( V_15 ) ;
F_67 ( & V_15 -> V_16 , F_8 ) ;
