...
char V_740 [ V_567 ] ;
unsigned int V_741 ;
F_336 ( V_742 , V_27 -> V_219 ) ;
struct V_171 V_172 ;
struct V_35 * V_36 ;
int V_77 , V_95 ;
F_24 () ;
V_36 = F_32 ( V_27 -> V_35 ) ;
V_739 = strlen ( V_36 -> V_743 ) ;
memcpy ( V_740 , V_36 -> V_743 , V_739 ) ;
F_28 () ;
V_742 -> V_580 = V_27 -> V_219 ;
V_742 -> V_69 = 0 ;
V_95 = F_337 ( V_27 -> V_219 , ( V_744 * ) V_740 , V_739 ) ;
if ( V_95 ) {
...
V_738 = F_153 ( V_172 . V_64 , V_213 ) ;
if ( V_738 == NULL ) {
F_45 ( V_27 , L_180 ) ;
V_95 = - 1 ;
goto V_63;
}
V_77 = F_74 ( V_27 , V_738 , V_172 . V_64 ) ;
if ( V_77 ) {
V_95 = 0 ;
goto V_63;
}
if ( ! memcmp ( V_734 , V_738 , V_735 ) ) {
F_45 ( V_27 , L_181 ) ;
V_95 = - 1 ;
goto V_63;
}
V_741 = F_339 ( V_27 -> V_219 ) ;
V_736 = F_153 ( V_741 , V_213 ) ;
if ( V_736 == NULL ) {
F_45 ( V_27 , L_182 ) ;
V_95 = - 1 ;
goto V_63;
}
V_95 = F_340 ( V_742 , V_738 , V_172 . V_64 , V_736 ) ;
if ( V_95 ) {
...
V_77 = F_74 ( V_27 , V_736 , V_741 ) ;
if ( V_77 ) {
V_95 = 0 ;
goto V_63;
}
V_737 = F_153 ( V_741 , V_213 ) ;
if ( V_737 == NULL ) {
F_45 ( V_27 , L_186 ) ;
V_95 = - 1 ;
goto V_63;
}
V_95 = F_340 ( V_742 , V_734 , V_735 ,
V_737 ) ;
if ( V_95 ) {
F_45 ( V_27 , L_183 , V_95 ) ;
V_95 = - 1 ;
...
int F_342 ( struct V_747 * V_748 )
{
struct V_26 * V_27 = V_748 -> V_27 ;
int V_194 ;
F_68 ( V_27 , L_188 ) ;
do {
V_194 = F_108 ( V_27 ) ;
...
static int F_343 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_749 * V_315 = V_172 -> V_96 ;
int V_750 = F_125 ( V_315 -> V_750 ) ;
if ( V_750 >= V_199 ) {
F_111 ( V_751 , & V_27 -> V_69 ) ;
} else {
F_111 ( V_752 , & V_27 -> V_69 ) ;
F_45 ( V_27 , L_191 ,
F_344 ( V_750 ) , V_750 ) ;
}
F_41 ( & V_27 -> V_101 ) ;
...
return - V_108 ;
V_10 = V_29 -> V_10 ;
if ( F_69 ( V_753 , & V_27 -> V_69 ) ) {
F_53 ( V_10 , V_27 -> V_186 < 100 ) ;
return F_343 ( V_27 , V_172 ) ;
}
if ( V_750 >= V_199 ) {
F_111 ( V_754 , & V_10 -> V_69 ) ;
} else {
F_111 ( V_755 , & V_10 -> V_69 ) ;
F_45 ( V_10 , L_191 ,
F_344 ( V_750 ) , V_750 ) ;
}
F_41 ( & V_10 -> V_756 ) ;
...
static int F_346 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
return F_347 ( V_27 ) ;
}
static int F_348 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
V_27 -> V_202 . V_83 -> V_111 -> V_138 = V_27 -> V_35 -> V_217 * V_44 ;
if ( ! F_349 ( V_757 , & V_27 -> V_69 ) )
F_41 ( & V_27 -> V_101 ) ;
return 0 ;
}
static int F_350 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
struct V_758 * V_315 = V_172 -> V_96 ;
...
static int
F_352 ( struct V_9 * V_10 , T_2 V_51 , T_3 V_52 ,
struct V_352 * V_353 , const char * V_355 ,
enum V_761 V_117 , bool V_354 )
{
struct V_332 * V_333 ;
struct V_400 V_401 ;
F_20 ( & V_10 -> V_24 -> V_25 ) ;
...
return F_352 ( V_10 , V_315 -> V_68 , V_52 ,
& V_10 -> V_311 , V_62 ,
V_117 , false ) ;
}
...
V_77 = F_352 ( V_10 , V_315 -> V_68 , V_52 ,
& V_10 -> V_311 , V_62 ,
V_402 , true ) ;
if ( V_77 ) {
...
{
struct V_767 * V_315 = V_172 -> V_96 ;
struct V_28 * V_29 ;
int V_30 ;
F_358 ( V_27 , V_315 -> V_316 , F_125 ( V_315 -> V_768 ) ) ;
F_24 () ;
F_25 (&connection->peer_devices, peer_device, vnr) {
struct V_9 * V_10 = V_29 -> V_10 ;
if ( V_10 -> V_368 . V_105 == V_661 &&
F_26 ( & V_10 -> V_191 ) == 0 &&
! F_349 ( V_769 , & V_10 -> V_69 ) ) {
V_10 -> V_770 . V_771 = V_66 + V_44 ;
F_359 ( & V_10 -> V_770 ) ;
}
}
F_28 () ;
...
V_64 = F_125 ( V_315 -> V_462 ) ;
F_195 ( V_29 , F_125 ( V_315 -> V_410 ) ) ;
if ( F_180 ( V_315 -> V_68 ) == V_774 )
F_361 ( V_10 , V_52 , V_64 ) ;
else
F_288 ( V_10 ) ;
if ( ! F_129 ( V_10 ) )
return 0 ;
...
F_362 ( V_10 , V_10 -> V_454 ) ;
if ( V_10 -> V_454 == 0 ) {
V_773 = F_153 ( sizeof( * V_773 ) , V_213 ) ;
if ( V_773 ) {
V_773 -> V_20 . V_80 = V_775 ;
V_773 -> V_10 = V_10 ;
F_363 ( & V_29 -> V_27 -> V_721 , & V_773 -> V_20 ) ;
} else {
F_45 ( V_10 , L_193 ) ;
F_288 ( V_10 ) ;
F_287 ( V_10 ) ;
...
static void F_365 ( struct V_26 * V_27 , bool V_776 )
{
long V_23 ;
struct V_35 * V_36 ;
F_24 () ;
V_36 = F_32 ( V_27 -> V_35 ) ;
V_23 = V_776 ? V_36 -> V_100 : V_36 -> V_217 ;
F_28 () ;
V_23 *= V_44 ;
if ( V_776 )
V_23 /= 10 ;
...
static void F_367 ( struct V_26 * V_27 )
{
F_365 ( V_27 , 0 ) ;
}
int F_368 ( struct V_747 * V_748 )
{
struct V_26 * V_27 = V_748 -> V_27 ;
struct V_777 * V_169 = NULL ;
struct V_171 V_172 ;
unsigned long V_778 ;
int V_95 ;
...
int F_55 = V_170 ;
bool V_780 = false ;
struct V_781 V_782 = { . V_783 = 2 } ;
V_95 = F_369 ( V_43 , V_784 , & V_782 ) ;
if ( V_95 < 0 )
F_45 ( V_27 , L_194 , V_95 ) ;
while ( F_114 ( V_748 ) == V_705 ) {
F_321 ( V_748 ) ;
F_23 ( V_27 ) ;
if ( F_270 ( V_785 , & V_27 -> V_69 ) ) {
if ( F_370 ( V_27 ) ) {
F_45 ( V_27 , L_195 ) ;
goto V_597;
}
...
V_778 = V_66 ;
V_95 = F_65 ( V_27 -> V_202 . V_83 , V_85 , F_55 - V_779 , 0 ) ;
if ( F_168 ( V_95 > 0 ) ) {
V_779 += V_95 ;
V_85 += V_95 ;
} else if ( V_95 == 0 ) {
...
if ( F_371 ( V_27 -> V_218 , V_778 ) )
continue;
if ( V_780 ) {
F_45 ( V_27 , L_197 ) ;
goto V_597;
}
F_111 ( V_785 , & V_27 -> V_69 ) ;
continue;
} else if ( V_95 == - V_146 ) {
F_112 ( V_43 ) ;
continue;
...
if ( V_779 == F_55 && V_169 == NULL ) {
if ( F_96 ( V_27 , V_27 -> V_202 . V_173 , & V_172 ) )
goto V_597;
V_169 = & V_786 [ V_172 . V_169 ] ;
if ( V_172 . V_169 >= F_322 ( V_786 ) || ! V_169 -> V_709 ) {
F_45 ( V_27 , L_198 ,
F_257 ( V_172 . V_169 ) , V_172 . V_169 ) ;
goto V_577;
}
...
void F_373 ( struct V_788 * V_789 )
{
struct V_28 * V_29 =
F_167 ( V_789 , struct V_28 , V_407 ) ;
