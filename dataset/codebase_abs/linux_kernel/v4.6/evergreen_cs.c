...
int V_87 ;
if ( V_53 -> V_13 == NULL ) {
V_13 = F_101 ( sizeof( * V_13 ) , V_504 ) ;
if ( V_13 == NULL )
return - V_505 ;
F_3 ( V_13 ) ;
if ( V_53 -> V_185 -> V_114 >= V_186 ) {
V_91 = V_53 -> V_185 -> V_506 . V_507 . V_508 ;
V_13 -> V_430 = V_509 ;
} else {
V_91 = V_53 -> V_185 -> V_506 . V_510 . V_508 ;
V_13 -> V_430 = V_511 ;
}
F_102 ( F_103 ( V_509 ) != V_429 ) ;
F_102 ( F_103 ( V_511 ) != V_429 ) ;
switch ( V_91 & 0xf ) {
case 0 :
V_13 -> V_76 = 1 ;
break;
...
do {
V_87 = F_104 ( V_53 , & V_144 , V_53 -> V_105 ) ;
if ( V_87 ) {
F_105 ( V_53 -> V_13 ) ;
V_53 -> V_13 = NULL ;
return V_87 ;
...
} while ( V_53 -> V_105 < V_53 -> V_516 -> V_517 );
#if 0
...
{
struct V_518 * V_519 = V_53 -> V_516 ;
struct V_148 * V_520 , * V_521 , * V_522 ;
T_1 V_523 , V_524 , V_147 , V_525 ;
T_2 * V_89 = V_53 -> V_89 . V_90 ;
T_1 V_105 ;
T_3 V_526 , V_527 , V_528 ;
int V_87 ;
do {
if ( V_53 -> V_105 >= V_519 -> V_517 ) {
F_64 ( L_124 ,
V_53 -> V_105 , V_519 -> V_517 ) ;
return - V_68 ;
}
V_105 = V_53 -> V_105 ;
V_523 = F_43 ( V_53 , V_105 ) ;
V_524 = F_107 ( V_523 ) ;
V_147 = F_108 ( V_523 ) ;
V_525 = F_109 ( V_523 ) ;
switch ( V_524 ) {
case V_529 :
V_87 = F_110 ( V_53 , & V_521 ) ;
if ( V_87 ) {
F_64 ( L_125 ) ;
return - V_68 ;
}
switch ( V_525 ) {
case 8 :
V_527 = F_43 ( V_53 , V_105 + 1 ) ;
V_527 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 >> 8 ) ;
V_53 -> V_105 += V_147 + 7 ;
break;
case 0 :
V_527 = F_43 ( V_53 , V_105 + 1 ) ;
V_527 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 2 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_521 -> V_182 ) & 0xff ;
V_53 -> V_105 += V_147 + 3 ;
break;
default:
F_64 ( L_126 , V_105 , V_523 ) ;
return - V_68 ;
}
if ( ( V_527 + ( V_147 * 4 ) ) > F_23 ( V_521 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_127 ,
V_527 , F_23 ( V_521 -> V_198 ) ) ;
return - V_68 ;
}
break;
case V_530 :
V_87 = F_110 ( V_53 , & V_520 ) ;
if ( V_87 ) {
F_64 ( L_128 ) ;
return - V_68 ;
}
...
switch ( V_525 ) {
case 0x00 :
V_526 = F_43 ( V_53 , V_105 + 2 ) ;
V_526 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 4 ) & 0xff ) ) << 32 ;
V_527 = F_43 ( V_53 , V_105 + 1 ) ;
V_527 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_526 + ( V_147 * 4 ) ) > F_23 ( V_520 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_129 ,
V_526 + ( V_147 * 4 ) , F_23 ( V_520 -> V_198 ) ) ;
return - V_68 ;
}
if ( ( V_527 + ( V_147 * 4 ) ) > F_23 ( V_521 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_130 ,
V_527 + ( V_147 * 4 ) , F_23 ( V_521 -> V_198 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_520 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_521 -> V_182 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_520 -> V_182 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
case 0x08 :
...
V_526 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_182 >> 8 ) ;
V_527 = F_43 ( V_53 , V_105 + 7 ) ;
V_527 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_521 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_521 -> V_182 ) & 0xff ;
} else {
V_526 = F_43 ( V_53 , V_105 + 7 ) ;
V_526 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_520 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_520 -> V_182 ) & 0xff ;
V_527 = F_43 ( V_53 , V_105 + 1 ) ;
V_527 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 >> 8 ) ;
}
...
V_527 = F_43 ( V_53 , V_105 + 1 ) ;
V_527 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_526 + V_147 ) > F_23 ( V_520 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_133 ,
V_526 + V_147 , F_23 ( V_520 -> V_198 ) ) ;
return - V_68 ;
}
if ( ( V_527 + V_147 ) > F_23 ( V_521 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_134 ,
V_527 + V_147 , F_23 ( V_521 -> V_198 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_520 -> V_182 & 0xffffffff ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_521 -> V_182 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_520 -> V_182 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_182 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_520 -> V_182 ) & 0xff ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_521 -> V_182 & 0xffffffff ) ;
V_89 [ V_105 + 5 ] += F_91 ( V_521 -> V_182 ) & 0xff ;
V_53 -> V_105 += 9 ;
break;
case 0x44 :
V_87 = F_110 ( V_53 , & V_522 ) ;
if ( V_87 ) {
F_64 ( L_136 ) ;
return - V_68 ;
}
V_527 = F_43 ( V_53 , V_105 + 1 ) ;
V_527 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 4 ) & 0xff ) ) << 32 ;
V_528 = F_43 ( V_53 , V_105 + 2 ) ;
V_528 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 5 ) & 0xff ) ) << 32 ;
V_526 = F_43 ( V_53 , V_105 + 3 ) ;
V_526 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 6 ) & 0xff ) ) << 32 ;
if ( ( V_526 + ( V_147 * 4 ) ) > F_23 ( V_520 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_137 ,
V_526 + ( V_147 * 4 ) , F_23 ( V_520 -> V_198 ) ) ;
return - V_68 ;
...
if ( ( V_528 + ( V_147 * 4 ) ) > F_23 ( V_522 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_139 ,
V_528 + ( V_147 * 4 ) , F_23 ( V_522 -> V_198 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_522 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( T_1 ) ( V_520 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 4 ] += F_91 ( V_521 -> V_182 ) & 0xff ;
V_89 [ V_105 + 5 ] += F_91 ( V_522 -> V_182 ) & 0xff ;
V_89 [ V_105 + 6 ] += F_91 ( V_520 -> V_182 ) & 0xff ;
V_53 -> V_105 += 7 ;
break;
case 0x48 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_528 = F_43 ( V_53 , V_105 + 2 ) ;
V_528 <<= 8 ;
V_526 = F_43 ( V_53 , V_105 + 8 ) ;
V_526 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 9 ) & 0xff ) ) << 32 ;
if ( ( V_526 + ( V_147 * 4 ) ) > F_23 ( V_520 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_141 ,
V_526 + ( V_147 * 4 ) , F_23 ( V_520 -> V_198 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 >> 8 ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_522 -> V_182 >> 8 ) ;
V_89 [ V_105 + 8 ] += ( T_1 ) ( V_520 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 9 ] += F_91 ( V_520 -> V_182 ) & 0xff ;
V_53 -> V_105 += 10 ;
break;
case 0x49 :
if ( V_53 -> V_114 < V_186 ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_520 -> V_182 >> 8 ) ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_521 -> V_182 >> 8 ) ;
V_53 -> V_105 += 13 ;
break;
case 0x4f :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_527 = F_43 ( V_53 , V_105 + 1 ) ;
V_527 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 3 ) & 0x00ff0000 ) ) << 16 ;
if ( ( V_527 + ( V_147 * 4 ) ) > F_23 ( V_521 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_152 ,
V_527 , F_23 ( V_521 -> V_198 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_521 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( F_91 ( V_521 -> V_182 ) << 16 ) & 0x00ff0000 ;
V_53 -> V_105 += 4 ;
break;
case V_532 :
V_53 -> V_105 += 1 ;
...
static int F_112 ( struct V_607 * V_185 ,
...
int F_113 ( struct V_607 * V_185 , struct V_617 * V_89 )
{
int V_618 = 0 ;
T_1 V_105 = 0 ;
struct V_143 V_144 ;
do {
V_144 . V_105 = V_105 ;
V_144 . type = F_114 ( V_89 -> V_90 [ V_105 ] ) ;
V_144 . V_147 = F_115 ( V_89 -> V_90 [ V_105 ] ) ;
V_144 . V_619 = 0 ;
switch ( V_144 . type ) {
case V_513 :
F_87 ( V_185 -> V_66 , L_158 ) ;
V_618 = - V_68 ;
break;
case V_514 :
V_105 += 1 ;
break;
case V_515 :
V_144 . V_434 = F_116 ( V_89 -> V_90 [ V_105 ] ) ;
V_618 = F_112 ( V_185 , V_89 -> V_90 , & V_144 ) ;
V_105 += V_144 . V_147 + 2 ;
break;
default:
F_87 ( V_185 -> V_66 , L_123 , V_144 . type ) ;
V_618 = - V_68 ;
break;
}
if ( V_618 )
break;
} while ( V_105 < V_89 -> V_517 );
return V_618 ;
}
int F_117 ( struct V_607 * V_185 , struct V_617 * V_89 )
{
T_1 V_105 = 0 ;
T_1 V_523 , V_524 , V_147 , V_525 ;
do {
V_523 = V_89 -> V_90 [ V_105 ] ;
V_524 = F_107 ( V_523 ) ;
V_147 = F_108 ( V_523 ) ;
V_525 = F_109 ( V_523 ) ;
switch ( V_524 ) {
