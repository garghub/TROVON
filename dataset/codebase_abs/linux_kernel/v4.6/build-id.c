...
while ( ( V_99 = F_49 ( V_97 ) ) != NULL ) {
if ( ! strcmp ( V_99 -> V_103 , L_12 ) || ! strcmp ( V_99 -> V_103 , L_13 ) )
continue;
F_50 ( V_95 , V_99 -> V_103 ) ;
}
F_51 ( V_97 ) ;
V_101:
free ( V_96 ) ;
...
int F_53 ( const char * V_31 , const char * V_56 ,
bool V_87 , bool V_88 )
{
const T_4 V_39 = V_33 ;
char * V_89 = NULL , * V_90 = NULL , * V_96 = NULL ,
* V_104 = F_54 ( V_39 ) , * V_105 , * V_42 ;
int V_51 = - 1 ;
if ( ! V_87 ) {
V_89 = F_44 ( V_56 , NULL ) ;
if ( ! V_89 )
...
V_96 = F_43 ( V_56 , V_87 , V_88 ) ;
if ( ! V_96 )
goto V_106;
if ( F_55 ( V_96 , 0755 ) )
goto V_106;
if ( F_45 ( & V_90 , L_14 , V_96 , V_31 ) < 0 ) {
V_90 = NULL ;
goto V_106;
}
if ( F_20 ( V_90 , V_52 ) ) {
...
if ( F_56 ( L_15 , V_90 ) )
goto V_106;
} else if ( F_57 ( V_89 , V_90 ) && V_102 != V_107 &&
F_56 ( V_56 , V_90 ) )
goto V_106;
}
if ( ! F_17 ( V_31 , V_104 , V_39 ) )
goto V_106;
V_42 = strrchr ( V_104 , '/' ) ;
* V_42 = '\0' ;
if ( F_20 ( V_104 , V_108 ) && F_55 ( V_104 , 0755 ) )
goto V_106;
* V_42 = '/' ;
V_105 = V_90 + strlen ( V_43 ) - 5 ;
memcpy ( V_105 , L_16 , 5 ) ;
if ( F_58 ( V_105 , V_104 ) == 0 )
V_51 = 0 ;
V_106:
if ( ! V_87 )
free ( V_89 ) ;
...
static int F_59 ( const T_3 * V_24 , T_4 V_109 ,
const char * V_56 , bool V_87 ,
bool V_88 )
{
char V_31 [ V_45 ] ;
F_9 ( V_24 , V_109 , V_31 ) ;
return F_53 ( V_31 , V_56 , V_87 , V_88 ) ;
}
bool F_60 ( const char * V_31 )
{
bool V_35 = false ;
...
int F_61 ( const char * V_31 )
{
const T_4 V_39 = V_33 ;
char * V_90 = F_54 ( V_39 ) ,
* V_104 = F_54 ( V_39 ) , * V_42 ;
int V_51 = - 1 ;
if ( V_90 == NULL || V_104 == NULL )
goto V_106;
if ( ! F_17 ( V_31 , V_104 , V_39 ) )
goto V_106;
if ( F_20 ( V_104 , V_52 ) )
goto V_106;
if ( F_22 ( V_104 , V_90 , V_39 - 1 ) < 0 )
goto V_106;
if ( F_62 ( V_104 ) )
goto V_106;
V_42 = strrchr ( V_104 , '/' ) + 1 ;
snprintf ( V_42 , V_39 - ( V_42 - V_104 ) , L_17 , V_90 ) ;
if ( F_62 ( V_104 ) )
goto V_106;
V_51 = 0 ;
V_106:
...
static int F_63 ( struct V_19 * V_19 , struct V_8 * V_8 )
{
...
return F_59 ( V_19 -> V_24 , sizeof( V_19 -> V_24 ) , V_56 ,
V_87 , V_88 ) ;
}
...
{
return F_64 ( & V_8 -> V_85 . V_84 , V_8 ) ;
}
int F_66 ( struct V_76 * V_77 )
{
struct V_78 * V_79 ;
int V_35 ;
if ( V_86 )
return 0 ;
if ( F_67 ( V_43 , 0755 ) != 0 && V_102 != V_107 )
return - 1 ;
V_35 = F_65 ( & V_77 -> V_80 . V_81 ) ;
for ( V_79 = F_35 ( & V_77 -> V_80 . V_82 ) ; V_79 ; V_79 = F_36 ( V_79 ) ) {
struct V_8 * V_64 = F_37 ( V_79 , struct V_8 , V_78 ) ;
V_35 |= F_65 ( V_64 ) ;
}
...
static bool F_68 ( struct V_8 * V_8 , bool V_110 )
{
return F_69 ( & V_8 -> V_85 . V_84 , V_110 ) ;
}
bool F_70 ( struct V_76 * V_77 , bool V_110 )
{
struct V_78 * V_79 ;
bool V_35 = F_68 ( & V_77 -> V_80 . V_81 , V_110 ) ;
for ( V_79 = F_35 ( & V_77 -> V_80 . V_82 ) ; V_79 ; V_79 = F_36 ( V_79 ) ) {
struct V_8 * V_64 = F_37 ( V_79 , struct V_8 , V_78 ) ;
V_35 |= F_68 ( V_64 , V_110 ) ;
}
return V_35 ;
}
