...
void F_34 ( struct V_18 * V_44 , struct V_1 * V_2 )
{
F_30 ( V_2 ) ;
V_44 -> V_13 = V_2 -> V_13 ;
V_44 -> V_48 = V_2 ;
...
static void F_35 ( struct V_18 * V_44 )
{
if ( ! V_44 -> V_24 ) return;
F_36 ( V_44 -> V_24 -> V_24 ) ;
V_44 -> V_24 -> V_51 = NULL ;
...
int F_38 ( struct V_18 * V_44 , unsigned int V_52 )
{
unsigned int V_42 , V_43 ;
int V_53 = 0 ;
struct V_18 * V_54 ;
...
unsigned int F_39 ( struct V_18 * V_44 )
{
return V_44 -> V_46 ;
}
int F_40 ( struct V_18 * V_44 ,
struct V_56 * V_57 )
{
int V_58 = 0 ;
F_30 ( V_44 -> V_48 ) ; do {
