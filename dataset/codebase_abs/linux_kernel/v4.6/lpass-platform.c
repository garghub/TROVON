...
static void F_51 ( struct V_80 * V_66 )
{
struct V_5 * V_97 ;
struct V_21 * V_22 ;
struct V_19 * V_77 ;
...
struct V_1 * V_2 ;
int V_30 , V_98 ;
for ( V_98 = 0 ; V_98 < F_52 ( V_66 -> V_90 ) ; V_98 ++ ) {
...
int F_53 ( struct V_102 * V_103 )
{
struct V_21 * V_22 = F_54 ( V_103 ) ;
struct V_24 * V_25 = V_22 -> V_26 ;
int V_8 ;
V_22 -> V_104 = F_55 ( V_103 , L_17 ) ;
if ( V_22 -> V_104 < 0 ) {
F_4 ( & V_103 -> V_13 , L_18 ,
V_14 , V_22 -> V_104 ) ;
return - V_105 ;
...
V_8 = F_56 ( & V_103 -> V_13 , V_22 -> V_104 ,
F_42 , V_106 ,
L_17 , V_22 ) ;
if ( V_8 ) {
F_4 ( & V_103 -> V_13 , L_19 ,
