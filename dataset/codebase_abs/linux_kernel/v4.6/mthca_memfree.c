...
V_27 = F_44 ( V_72 & V_77 , 1 , 1 , 0 , V_73 , NULL ) ;
if ( V_27 < 0 )
goto V_43;
F_15 ( & V_71 -> V_19 [ V_5 ] . V_8 , V_73 [ 0 ] , V_49 ,
V_72 & ~ V_77 ) ;
V_27 = F_26 ( V_2 -> V_7 , & V_71 -> V_19 [ V_5 ] . V_8 , 1 , V_78 ) ;
if ( V_27 < 0 ) {
F_45 ( V_73 [ 0 ] ) ;
goto V_43;
}
...
F_42 ( V_2 , V_65 , V_5 ) ) ;
if ( V_27 ) {
F_2 ( V_2 -> V_7 , & V_71 -> V_19 [ V_5 ] . V_8 , 1 , V_78 ) ;
...
int F_51 ( struct V_1 * V_2 , enum V_79 type ,
T_4 V_80 , T_5 * * V_81 )
{
int V_82 ;
int V_53 , V_54 , V_83 ;
...
for ( V_5 = V_53 ; V_5 != V_54 ; V_5 += V_83 )
if ( V_2 -> V_71 -> V_19 [ V_5 ] . V_93 &&
! F_52 ( V_2 -> V_71 -> V_19 [ V_5 ] . V_94 ,
V_75 ) ) {
...
if ( V_2 -> V_71 -> V_88 >= V_2 -> V_71 -> V_92 - 1 ) {
V_27 = - V_21 ;
goto V_43;
}
if ( V_82 == 0 )
...
V_96:
V_19 -> V_93 = F_17 ( & V_2 -> V_7 -> V_2 , V_49 ,
& V_19 -> V_97 , V_46 ) ;
if ( ! V_19 -> V_93 ) {
V_27 = - V_21 ;
goto V_43;
}
memset ( V_19 -> V_93 , 0 , V_49 ) ;
V_27 = F_46 ( V_2 , V_19 -> V_97 ,
F_42 ( V_2 , & V_2 -> V_98 , V_5 ) ) ;
if ( V_27 ) {
...
F_53 ( V_19 -> V_94 , V_75 ) ;
V_95:
V_84 = F_54 ( V_19 -> V_94 , V_75 ) ;
F_55 ( V_84 , V_19 -> V_94 ) ;
if ( V_82 == 1 )
V_84 = V_75 - 1 - V_84 ;
V_27 = V_5 * V_75 + V_84 ;
V_19 -> V_93 [ V_84 ] = F_56 ( ( V_80 << 8 ) | ( type << 5 ) ) ;
* V_81 = ( T_5 * ) & V_19 -> V_93 [ V_84 ] ;
V_43:
F_30 ( & V_2 -> V_71 -> V_42 ) ;
return V_27 ;
}
void F_57 ( struct V_1 * V_2 , int type , int V_99 )
{
int V_5 , V_84 ;
struct V_85 * V_19 ;
V_5 = V_99 / V_75 ;
...
F_28 ( & V_2 -> V_71 -> V_42 ) ;
V_19 -> V_93 [ V_84 ] = 0 ;
if ( V_5 >= V_2 -> V_71 -> V_92 )
V_84 = V_75 - 1 - V_84 ;
F_58 ( V_84 , V_19 -> V_94 ) ;
if ( F_59 ( V_19 -> V_94 , V_75 ) &&
V_5 >= V_2 -> V_71 -> V_88 - 1 ) {
F_33 ( V_2 , F_42 ( V_2 , & V_2 -> V_98 , V_5 ) , 1 ) ;
F_7 ( & V_2 -> V_7 -> V_2 , V_49 ,
V_19 -> V_93 , V_19 -> V_97 ) ;
V_19 -> V_93 = NULL ;
if ( V_5 == V_2 -> V_71 -> V_88 ) {
-- V_2 -> V_71 -> V_88 ;
}
if ( V_5 == V_2 -> V_71 -> V_92 )
++ V_2 -> V_71 -> V_92 ;
...
if ( ! V_2 -> V_71 -> V_19 [ V_5 ] . V_93 )
continue;
if ( ! F_59 ( V_2 -> V_71 -> V_19 [ V_5 ] . V_94 , V_75 ) )
F_62 ( V_2 , L_1 , V_5 ) ;
F_33 ( V_2 , F_42 ( V_2 , & V_2 -> V_98 , V_5 ) , 1 ) ;
F_7 ( & V_2 -> V_7 -> V_2 , V_49 ,
V_2 -> V_71 -> V_19 [ V_5 ] . V_93 ,
V_2 -> V_71 -> V_19 [ V_5 ] . V_97 ) ;
}
F_12 ( V_2 -> V_71 -> V_19 ) ;
F_12 ( V_2 -> V_71 ) ;
}
