...
if ( ! V_266 )
return;
if ( F_196 ( F_197 ( V_266 , L_110 , & V_267 ) )
|| F_196 ( F_197 ( V_266 , L_111 , & V_268 ) )
|| F_196 ( F_197 ( V_266 , L_112 , & V_269 ) ) )
return;
F_6 ( & V_2 -> V_2 , L_113 ) ;
F_198 ( V_267 , NULL , 1 ) ;
F_198 ( V_268 , NULL , 0 ) ;
...
goto V_228;
F_6 ( & V_2 -> V_2 , L_114 ) ;
F_201 ( & V_2 -> V_2 , & V_273 -> V_2 ) ;
V_228:
F_17 ( V_273 ) ;
F_17 ( V_272 ) ;
}
static void F_202 ( struct V_1 * V_2 , struct V_275 * V_276 ,
struct V_275 * V_36 )
{
T_6 V_254 ;
...
V_254 = F_173 ( V_2 , V_276 -> V_279 ) ;
V_276 -> V_279 ( V_2 ) ;
F_181 ( V_2 , V_254 , V_276 -> V_279 ) ;
}
}
void F_203 ( enum V_280 V_281 , struct V_1 * V_2 )
{
...
static int F_206 ( struct V_1 * V_2 , int V_312 )
{
if ( V_312 )
return 0 ;
if ( ! F_207 ( V_2 ) )
F_170 ( & V_2 -> V_2 , L_118 ) ;
F_208 ( V_2 , V_313 , V_314 ) ;
F_199 ( 100 ) ;
return 0 ;
}
static int F_209 ( struct V_1 * V_2 , int V_312 )
{
void T_4 * V_315 ;
unsigned long V_316 ;
T_1 V_76 ;
...
if ( ! V_315 )
return - V_317 ;
F_210 ( 0x00000002 , V_315 + V_318 ) ;
F_210 ( 0x00000005 , V_315 + V_319 ) ;
V_76 = F_211 ( V_315 + V_320 ) & 0xfffffffe ;
F_210 ( V_76 , V_315 + V_320 ) ;
V_316 = V_321 + F_212 ( V_322 ) ;
do {
V_76 = F_211 ( V_315 + V_323 ) ;
if ( ( V_76 & 0xb0000000 ) == 0 )
goto V_324;
F_199 ( 10 ) ;
} while ( F_213 ( V_321 , V_316 ) );
F_52 ( & V_2 -> V_2 , L_119 ) ;
V_324:
F_210 ( 0x00000002 , V_315 + V_325 ) ;
F_186 ( V_2 , V_315 ) ;
return 0 ;
}
static int F_214 ( struct V_1 * V_2 , int V_312 )
{
T_2 V_326 ;
T_2 V_327 ;
...
int F_217 ( struct V_1 * V_2 , int V_312 )
{
...
if ( ! F_191 ( V_54 -> V_51 ) &&
V_54 -> V_150 == V_342 &&
! F_223 ( V_54 ) && F_223 ( V_54 -> V_51 -> V_343 ) &&
F_194 ( V_54 -> V_51 -> V_343 ) != V_344 )
V_54 -> V_109 |= V_345 ;
}
...
static int F_229 ( struct V_1 * V_2 , T_2 V_350 )
{
#ifdef F_230
...
{
int V_29 ;
if ( ! F_223 ( V_2 ) || F_194 ( V_2 ) != V_362 )
return false ;
for ( V_29 = 0 ; V_29 < F_234 ( V_363 ) ; V_29 ++ )
if ( V_363 [ V_29 ] == V_2 -> V_87 )
return true ;
return false ;
}
static int F_235 ( struct V_1 * V_2 , T_2 V_350 )
{
T_2 V_33 = V_2 -> V_109 & V_364 ?
V_365 : 0 ;
if ( ! F_233 ( V_2 ) )
return - V_328 ;
return V_350 & ~ V_33 ? 0 : 1 ;
}
static int F_236 ( struct V_1 * V_2 , T_2 V_350 )
{
V_350 &= ~ ( V_359 | V_360 | V_355 |
V_356 | V_361 | V_358 ) ;
return V_350 ? 0 : 1 ;
}
int F_237 ( struct V_1 * V_2 , T_2 V_350 )
{
...
static void F_244 ( struct V_1 * V_54 )
{
int V_39 , V_29 = 0 ;
T_3 V_386 ;
T_2 V_387 , * V_388 ;
struct V_389 * V_390 ;
if ( V_54 -> V_391 || F_147 ( V_54 , V_392 ) )
return;
V_39 = F_147 ( V_54 , V_393 ) ;
if ( ! V_39 )
return;
...
if ( F_246 ( V_54 , V_392 ) )
return;
V_390 = F_247 ( sizeof( * V_390 ) + V_40 , V_401 ) ;
if ( ! V_390 )
return;
...
F_248 ( V_54 , V_313 , & V_388 [ V_29 ++ ] ) ;
F_248 ( V_54 , V_405 , & V_388 [ V_29 ++ ] ) ;
F_248 ( V_54 , V_406 , & V_388 [ V_29 ++ ] ) ;
F_248 ( V_54 , V_407 , & V_388 [ V_29 ++ ] ) ;
F_248 ( V_54 , V_408 , & V_388 [ V_29 ++ ] ) ;
F_248 ( V_54 , V_409 , & V_388 [ V_29 ++ ] ) ;
F_248 ( V_54 , V_410 , & V_388 [ V_29 ++ ] ) ;
F_249 ( & V_390 -> V_411 , & V_54 -> V_412 ) ;
}
}
