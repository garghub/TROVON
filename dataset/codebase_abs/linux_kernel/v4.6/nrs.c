...
V_126 = F_64 ( V_78 -> V_40 , V_125 -> V_134 , sizeof( V_78 -> V_40 ) ) ;
if ( V_126 >= sizeof( V_78 -> V_40 ) ) {
F_37 ( V_78 ) ;
V_36 = - V_136 ;
goto V_135;
}
...
{
struct V_17 * V_18 = F_53 ( V_80 , V_119 ) ;
...
F_59 (svcpt, i, svc) {
if ( ( V_111 & V_113 ) != 0 ) {
V_36 = F_34 ( F_53 ( V_80 , false ) , V_43 ,
V_10 , V_11 ) ;
