...
F_63 ( & V_98 -> V_96 , V_108 ,
F_55 , NULL , NULL ) ;
V_98 -> V_2 = V_2 ;
F_64 ( V_2 -> V_109 , & V_98 -> V_96 ) ;
F_47 ( & V_2 -> V_102 ) ;
}
static void F_65 ( struct V_1 * V_2 , int V_110 )
{
struct V_43 * V_55 ;
struct V_103 * V_104 = V_2 -> V_104 ;
unsigned long V_69 ;
...
V_48 -> V_54 ) ;
for ( V_111 = 0 ; V_111 < V_48 -> V_59 ; ++ V_111 ) {
F_66 ( V_115 L_6 ,
V_48 -> V_57 [ V_111 ] -> V_114 ) ;
}
if ( V_55 -> V_89 == V_48 )
F_66 ( V_115 L_7 ,
V_55 -> V_90 - V_48 -> V_7 ) ;
...
V_4 -> V_77 [ V_11 ] -> V_7 ,
V_4 -> V_77 [ V_11 ] -> V_51 ) ;
for ( V_111 = 0 ; V_111 < V_4 -> V_77 [ V_11 ] -> V_59 ; ++ V_111 ) {
F_66 ( V_115 L_6 ,
V_4 -> V_77 [ V_11 ] -> V_57 [ V_111 ] -> V_114 ) ;
}
}
F_66 ( V_115 L_8 ) ;
...
struct V_27 * F_67 ( struct V_61 * V_62 ,
...
int F_72 ( void * V_119 )
{
struct V_27 * V_28 = V_119 ;
struct V_1 * V_2 = V_28 -> V_62 -> V_2 ;
while ( F_61 ( & V_28 -> V_34 ) ) {
if ( ! F_61 ( & V_2 -> V_102 ) )
F_27 ( V_2 ) ;
F_73 ( V_28 -> V_36 , F_61 ( & V_28 -> V_34 ) == 0 ,
5 * V_120 ) ;
F_65 ( V_28 -> V_62 -> V_2 ,
F_61 ( & V_28 -> V_34 ) < 10 ? 1 : 0 ) ;
}
F_65 ( V_28 -> V_62 -> V_2 , F_61 ( & V_28 -> V_34 ) < 10 ? 1 : 0 ) ;
F_22 ( & V_28 -> V_33 , V_35 ) ;
return 0 ;
}
int F_72 ( void * V_119 )
