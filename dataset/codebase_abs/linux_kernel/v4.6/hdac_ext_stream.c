...
V_73 |= ( 1 << V_46 ) ;
V_74 = F_20 ( V_2 -> V_19 + V_75 ) ;
V_73 |= V_74 ;
if ( V_72 )
F_13 ( V_2 -> V_19 , V_75 , 0 , V_73 ) ;
else
F_13 ( V_2 -> V_19 , V_75 , V_73 , 0 ) ;
}
...
V_73 |= ( 1 << V_46 ) ;
V_74 = F_20 ( V_2 -> V_26 + V_75 ) ;
V_73 |= V_74 ;
if ( V_72 )
F_13 ( V_2 -> V_26 , V_79 , 0 , V_73 ) ;
else
F_13 ( V_2 -> V_26 , V_79 , V_73 , 0 ) ;
}
