...
static int F_40 ( struct V_1 * V_2 , T_2 V_49 , char * V_63 )
{
...
int F_46 ( struct V_66 * V_25 , void T_3 * V_67 , int V_68 ,
const char * V_24 , struct V_69 V_70 , struct V_17 * * V_71 )
{
struct V_17 * V_18 ;
struct V_1 * V_72 ;
int V_9 ;
...
void F_51 ( struct V_66 * V_25 , struct V_17 * V_2 )
{
F_43 ( V_2 -> V_71 ) ;
F_52 ( & V_2 -> V_44 ) ;
V_2 -> V_71 -> V_11 -> free ( V_2 -> V_71 ) ;
}
