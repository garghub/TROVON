...
struct V_22 * V_36 ;
struct V_37 * V_38 ;
V_35 = F_14 ( V_16 -> V_39 , V_18 , V_20 [ V_32 ] . V_40 ) ;
if ( ! V_35 ) {
V_6 = - V_41 ;
goto V_42;
}
...
V_33 -> V_48 = V_36 ;
V_33 -> V_49 = F_20 ( V_20 [ V_32 ] . V_50 ,
V_51 ) ;
V_33 -> V_52 . V_36 = & V_33 -> V_48 -> V_43 ;
V_33 -> V_52 . V_53 = true ;
if ( V_33 -> V_48 -> V_54 == V_55 )
V_23 = V_33 -> V_48 ;
if ( V_33 -> V_48 -> V_54 == V_56 )
V_26 = V_33 -> V_48 ;
if ( V_33 -> V_48 -> V_54 == V_57 )
V_28 = V_33 -> V_48 ;
F_21 ( V_14 , V_33 -> V_48 ) ;
}
...
int F_30 ( struct V_64 * V_65 , void * V_66 ,
struct V_17 * V_18 )
{
...
return - V_8 ;
V_6 = - V_77 ;
if ( F_31 ( V_67 == args -> V_72 . V_78 ) ) {
unsigned long V_79 = args -> V_72 . V_76 *
args -> V_72 . V_78 ;
if ( F_32 ( V_20 , V_74 , V_79 ) )
goto V_42;
} else {
