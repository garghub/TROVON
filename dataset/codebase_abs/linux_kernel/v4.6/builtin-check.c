...
return 0 ;
if ( V_12 -> V_22 == V_24 )
for ( V_19 = 0 ; V_19 < F_9 ( V_21 ) ; V_19 ++ )
if ( ! strcmp ( V_12 -> V_25 , V_21 [ V_19 ] ) )
return 1 ;
if ( ! V_12 -> V_5 )
return 0 ;
F_7 (file, func, insn) {
...
F_7 (file, func, insn) {
if ( V_7 -> V_5 != V_12 -> V_5 ||
V_7 -> V_6 >= V_12 -> V_6 + V_12 -> V_27 )
break;
if ( V_7 -> type == V_28 ) {
struct V_1 * V_29 = V_7 -> V_30 ;
struct V_11 * V_31 ;
if ( ! V_29 )
return 0 ;
if ( V_29 -> V_5 != V_12 -> V_5 ||
V_29 -> V_6 < V_12 -> V_6 ||
V_29 -> V_6 >= V_12 -> V_6 + V_12 -> V_27 ) {
V_31 = F_10 ( V_29 -> V_5 ,
V_29 -> V_6 ) ;
if ( ! V_31 )
continue;
...
if ( V_7 -> type == V_32 && F_12 ( & V_7 -> V_33 ) )
return 0 ;
}
return 1 ;
}
...
continue;
for ( V_6 = 0 ; V_6 < V_5 -> V_27 ; V_6 += V_7 -> V_27 ) {
V_7 = malloc ( sizeof( * V_7 ) ) ;
memset ( V_7 , 0 , sizeof( * V_7 ) ) ;
F_15 ( & V_7 -> V_33 ) ;
V_7 -> V_5 = V_5 ;
V_7 -> V_6 = V_6 ;
V_34 = F_16 ( V_3 -> V_38 , V_5 , V_6 ,
V_5 -> V_27 - V_6 ,
& V_7 -> V_27 , & V_7 -> type ,
& V_7 -> V_39 ) ;
if ( V_34 )
return V_34 ;
if ( ! V_7 -> type || V_7 -> type > V_40 ) {
F_11 ( L_10 ,
V_7 -> V_5 , V_7 -> V_6 , V_7 -> type ) ;
return - 1 ;
}
F_17 ( V_3 -> V_41 , & V_7 -> V_42 , V_7 -> V_6 ) ;
...
if ( ! V_13 ) {
V_45 = V_7 -> V_5 ;
V_46 = V_7 -> V_6 + V_7 -> V_27 + V_7 -> V_39 ;
} else if ( V_13 -> V_15 -> type == V_48 ) {
V_45 = V_13 -> V_15 -> V_5 ;
V_46 = V_13 -> V_16 + 4 ;
} else if ( V_13 -> V_15 -> V_5 -> V_49 ) {
V_45 = V_13 -> V_15 -> V_5 ;
V_46 = V_13 -> V_15 -> V_15 . V_50 + V_13 -> V_16 + 4 ;
} else {
V_7 -> V_30 = 0 ;
continue;
}
V_7 -> V_30 = F_1 ( V_3 , V_45 , V_46 ) ;
if ( ! V_7 -> V_30 ) {
if ( ! strcmp ( V_7 -> V_5 -> V_25 , L_12 ) )
continue;
F_11 ( L_13 ,
V_7 -> V_5 , V_7 -> V_6 , V_45 -> V_25 ,
V_46 ) ;
return - 1 ;
}
}
...
if ( V_53 -> V_74 ) {
V_34 = F_25 ( V_3 , V_53 , V_54 ,
& V_55 ) ;
if ( V_34 )
goto V_73;
} else if ( V_53 -> V_75 ) {
V_34 = F_28 ( V_3 , V_53 , V_54 ,
& V_55 ) ;
if ( V_34 )
goto V_73;
}
V_72 -> V_7 = V_55 ;
F_18 ( & V_72 -> V_9 , & V_54 -> V_33 ) ;
F_32 ( & V_53 -> V_9 ) ;
free ( V_53 ) ;
}
V_73:
...
V_13 -> V_16 <= V_12 -> V_6 ||
V_13 -> V_16 >= V_12 -> V_6 + V_12 -> V_27 )
break;
V_78 = F_1 ( V_3 , V_7 -> V_5 , V_13 -> V_16 ) ;
if ( ! V_78 ) {
F_19 ( L_23 ,
V_3 -> V_79 -> V_13 -> V_25 , V_7 -> V_5 -> V_25 ,
V_13 -> V_16 ) ;
return - 1 ;
}
V_72 = malloc ( sizeof( * V_72 ) ) ;
...
if ( V_80 ) {
V_34 = F_33 ( V_3 , V_12 , V_80 , V_83 , NULL ) ;
if ( V_34 )
return V_34 ;
}
return 0 ;
...
struct V_11 * V_15 ;
unsigned long V_6 ;
V_13 = F_23 ( V_7 -> V_5 , V_7 -> V_6 , V_7 -> V_27 ) ;
if ( ! V_13 )
return false ;
if ( V_13 -> V_15 -> type != V_48 )
return false ;
V_5 = V_13 -> V_15 -> V_5 ;
V_6 = V_13 -> V_16 + V_7 -> V_6 + V_7 -> V_27 - V_13 -> V_6 ;
F_6 (sym, &sec->symbol_list, list) {
if ( V_15 -> type != V_99 )
continue;
if ( V_6 >= V_15 -> V_6 && V_6 < V_15 -> V_6 + V_15 -> V_27 )
return ( ! memcmp ( V_15 -> V_25 , L_34 , 8 ) ) ;
}
return false ;
}
...
! strcmp ( V_7 -> V_52 -> V_25 , L_35 ) ) ;
}
static bool F_46 ( struct V_1 * V_7 )
{
return ( V_7 -> type == V_51 &&
! strcmp ( V_7 -> V_52 -> V_25 ,
L_36 ) ) ;
}
...
return true ;
if ( V_7 -> type == V_28 && V_7 -> V_30 ) {
V_7 = V_7 -> V_30 ;
continue;
}
if ( V_7 -> V_6 + V_7 -> V_27 >= V_12 -> V_6 + V_12 -> V_27 )
break;
V_7 = F_4 ( V_7 , V_9 ) ;
}
return false ;
...
F_15 ( & V_3 . V_10 ) ;
F_59 ( V_3 . V_41 ) ;
V_3 . V_14 = F_60 ( V_3 . V_38 , L_42 ) ;
V_3 . V_79 = F_60 ( V_3 . V_38 , L_43 ) ;
V_3 . V_84 = false ;
V_3 . V_91 = F_60 ( V_3 . V_38 , L_44 ) ;
V_34 = F_38 ( & V_3 ) ;
if ( V_34 < 0 )
goto V_73;
V_100 += V_34 ;
