...
F_158 ( V_85 , V_241 ) ;
memcpy ( F_159 ( V_85 , V_74 ) , V_240 , V_74 ) ;
V_85 -> V_238 = V_90 ;
V_85 -> V_243 = F_160 ( V_244 ) ;
F_161 ( V_85 ) ;
F_153 ( V_90 ) . V_245 ++ ;
F_153 ( V_90 ) . V_246 += V_74 ;
F_150 ( V_233 ) ;
return;
}
static int F_162 ( struct V_226 * V_90 , int V_247 )
{
struct V_229 * V_233 = F_144 ( V_90 ) ;
...
static int F_164 ( struct V_7 * V_8 , struct V_264 * V_265 )
{
char * V_266 ;
int V_267 = 0 ;
struct V_226 * V_90 ;
...
if ( V_265 -> V_271 [ 0 ] != '\0' )
V_266 = V_265 -> V_271 ;
V_90 = F_166 ( sizeof( struct V_229 ) , V_266 ,
V_272 , F_163 ) ;
if ( ! V_90 ) {
F_167 ( L_36 ) ;
return - V_80 ;
...
V_233 -> V_8 = V_8 ;
F_110 ( & V_233 -> V_184 ) ;
strncpy ( V_265 -> V_271 , V_90 -> V_273 , V_274 ) ;
V_8 -> V_231 = V_8 -> V_76 ;
V_8 -> V_232 = V_8 -> V_25 ;
V_8 -> V_76 = V_265 -> V_76 ;
V_8 -> V_25 = F_156 ;
...
static void F_171 ( struct V_107 * V_104 , int V_276 )
{
struct V_7 * V_8 = F_77 ( V_104 , struct V_7 , V_104 ) ;
...
static int F_172 ( struct V_277 * V_278 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
unsigned int line = V_95 -> V_279 ;
unsigned int V_280 = line >> 6 ;
bool V_281 = false ;
int V_192 ;
line = line & 0x3F ;
if ( V_280 >= V_179 )
...
V_192 = F_173 ( & V_8 -> V_104 , V_278 , V_95 ) ;
if ( V_192 ) {
if ( V_281 )
F_84 ( V_8 ) ;
F_89 ( & V_48 -> V_148 ) ;
...
static int F_174 ( struct V_94 * V_95 , struct V_202 * V_288 )
{
struct V_7 * V_8 = V_95 -> V_287 ;
struct V_107 * V_104 = & V_8 -> V_104 ;
V_104 -> V_165 ++ ;
F_91 ( V_104 , V_95 ) ;
V_8 -> V_103 = 0 ;
F_113 ( V_289 , & V_104 -> V_71 ) ;
F_65 ( V_8 ) ;
return F_175 ( V_104 , V_95 , V_288 ) ;
}
static void F_176 ( struct V_94 * V_95 , struct V_202 * V_288 )
{
struct V_7 * V_8 = V_95 -> V_287 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_89 ( & V_8 -> V_148 ) ;
V_48 = V_8 -> V_48 ;
if ( F_177 ( & V_8 -> V_104 , V_95 , V_288 ) == 0 )
return;
F_49 ( V_8 ) ;
if ( F_178 ( V_289 , & V_8 -> V_104 . V_71 ) ) {
if ( F_179 ( V_95 ) )
F_180 ( & V_8 -> V_104 ) ;
}
...
if ( V_8 -> V_142 == V_143 )
return - V_200 ;
V_290 = F_185 ( V_8 -> V_77 , V_114 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_290 ;
}
...
static void F_189 ( struct V_94 * V_95 , int V_292 )
{
}
...
switch ( V_93 ) {
case V_295 :
if ( F_137 ( & V_265 , ( void T_4 * ) V_221 , sizeof( V_265 ) ) )
return - V_224 ;
V_265 . V_271 [ V_274 - 1 ] = '\0' ;
F_87 ( & V_8 -> V_148 ) ;
V_279 = F_164 ( V_8 , & V_265 ) ;
F_89 ( & V_8 -> V_148 ) ;
if ( F_136 ( ( void T_4 * ) V_221 , & V_265 , sizeof( V_265 ) ) )
return - V_224 ;
return V_279 ;
case V_296 :
if ( ! F_165 ( V_268 ) )
...
static void F_193 ( struct V_94 * V_95 , struct V_298 * V_299 )
{
struct V_7 * V_8 = V_95 -> V_287 ;
if ( V_8 -> V_142 == V_143 )
return;
F_194 ( & V_95 -> V_300 , V_299 ) ;
}
...
V_194 -> type = V_308 ;
V_194 -> V_309 = V_310 ;
V_194 -> V_71 = V_311 | V_312
| V_313 ;
V_194 -> V_314 = V_315 ;
V_194 -> V_314 . V_316 &= ~ V_317 ;
F_204 ( V_194 , & V_318 ) ;
F_70 ( & V_178 ) ;
if ( F_205 ( V_194 ) ) {
F_206 ( V_194 ) ;
...
F_8 ( L_43 ,
V_194 -> V_306 , V_194 -> V_307 ) ;
return 0 ;
}
static void T_8 F_207 ( void )
{
int V_302 = F_203 ( V_303 ) ;
if ( V_302 != 0 )
F_167 ( L_44 ,
V_302 ) ;
F_208 ( V_194 ) ;
