...
if ( ! V_2 -> V_228 [ V_219 ] )
continue;
if ( ! F_103 ( & V_2 -> V_229 [ V_219 ] , V_230 ) )
return;
if ( V_219 < V_231 )
V_226 = F_1 ( V_2 , V_219 ) + 1 ;
else
V_226 = 0 ;
F_104 ( F_105 ( V_226 , V_2 -> V_51 ) ,
V_2 -> V_229 [ V_219 ] ) ;
V_227 = V_2 -> V_222 [ V_219 ] . V_232 ;
F_106 ( V_227 , V_2 -> V_229 [ V_219 ] ) ;
}
}
...
int V_232 ;
F_108 (irq)
sprintf ( V_2 -> V_233 [ V_207 ] , L_22 ,
V_2 -> V_34 , V_207 ) ;
F_109 (irq)
sprintf ( V_2 -> V_233 [ V_207 ] , L_23 ,
V_2 -> V_34 , V_207 - V_231 ) ;
F_110 (irq)
sprintf ( V_2 -> V_233 [ V_207 ] , L_24 ,
V_2 -> V_34 , V_207 - V_234 ) ;
for ( V_207 = 0 ; V_207 < V_2 -> V_87 -> V_117 ; V_207 ++ ) {
V_232 = V_2 -> V_222 [ V_207 ] . V_232 ;
V_218 = F_111 ( V_232 , F_92 ,
0 , V_2 -> V_233 [ V_207 ] , V_2 -> V_154 [ V_207 ] ) ;
if ( V_218 )
goto V_119;
V_2 -> V_228 [ V_207 ] = true ;
}
for ( V_207 = V_234 ;
V_207 < ( V_234 + V_2 -> V_87 -> V_214 ) ; V_207 ++ ) {
V_232 = V_2 -> V_222 [ V_207 ] . V_232 ;
V_218 = F_111 ( V_232 , F_94 ,
0 , V_2 -> V_233 [ V_207 ] , V_2 ) ;
if ( V_218 )
goto V_119;
V_2 -> V_228 [ V_207 ] = true ;
}
sprintf ( V_2 -> V_233 [ V_235 ] ,
L_25 , V_2 -> V_34 ) ;
V_207 = V_235 ;
V_218 = F_111 ( V_2 -> V_222 [ V_207 ] . V_232 ,
F_97 ,
0 , V_2 -> V_233 [ V_207 ] , V_2 ) ;
if ( V_218 )
goto V_119;
...
if ( ! V_2 -> V_228 [ V_207 ] )
continue;
F_106 ( V_2 -> V_222 [ V_207 ] . V_232 , NULL ) ;
F_113 ( V_2 -> V_229 [ V_207 ] ) ;
if ( V_207 < V_231 )
F_114 ( V_2 -> V_222 [ V_207 ] . V_232 , V_2 -> V_154 [ V_207 ] ) ;
else
F_114 ( V_2 -> V_222 [ V_207 ] . V_232 , V_2 ) ;
V_2 -> V_228 [ V_207 ] = false ;
}
F_100 ( V_2 ) ;
}
...
if ( ! F_98 ( V_2 ) )
return 1 ;
sprintf ( V_2 -> V_233 [ V_207 ] , L_27 , L_28 ) ;
V_218 = F_111 ( V_2 -> V_222 [ V_207 ] . V_232 ,
F_91 , 0 , V_2 -> V_233 [ V_207 ] , V_2 ) ;
if ( V_218 )
return V_218 ;
V_2 -> V_228 [ V_207 ] = true ;
F_81 ( V_2 , V_79 , 0 ) ;
...
struct V_1 * V_2 = F_46 ( V_33 ) ;
int V_237 = F_117 ( V_8 ) ;
struct V_181 * V_182 = F_71 ( V_33 , V_237 ) ;
if ( V_8 -> V_9 <= V_238 ) {
F_118 ( V_8 ) ;
return V_239 ;
}
if ( ! F_72 ( V_182 ) && ! F_119 ( V_2 , V_8 ) ) {
F_120 ( V_182 ) ;
V_2 -> V_10 . V_240 ++ ;
if ( F_75 ( V_2 ) )
F_76 ( V_33 ,
...
struct V_179 * V_87 = V_2 -> V_87 ;
struct V_201 * V_213 = NULL ;
V_2 -> V_245 = V_33 -> V_245 ;
F_21 ( V_33 ) ;
V_119 = F_115 ( V_2 ) ;
if ( V_119 )
return V_119 ;
for ( V_3 = 0 ; V_3 < V_87 -> V_117 ; V_3 ++ ) {
V_213 = F_130 ( sizeof( * V_213 ) , V_230 ) ;
if ( ! V_213 ) {
V_119 = - V_246 ;
goto V_247;
}
...
F_135 ( & V_2 -> V_217 , F_82 ,
( unsigned long ) V_2 ) ;
F_135 ( & V_2 -> V_216 , V_249 ,
( unsigned long ) V_2 ) ;
F_136 ( & V_2 -> V_244 , V_250 ) ;
V_2 -> V_85 = V_85 ;
if ( ! V_2 -> V_4 )
F_25 ( V_2 ) ;
F_34 ( V_2 ) ;
...
static int F_138 ( struct V_1 * V_2 , int V_245 )
{
union V_23 V_24 = {} ;
V_24 . V_252 . V_25 = V_253 ;
V_24 . V_252 . V_254 = V_245 ;
V_24 . V_252 . V_34 = V_2 -> V_34 ;
return F_10 ( V_2 , & V_24 ) ;
}
static int F_139 ( struct V_80 * V_33 , int V_255 )
{
struct V_1 * V_2 = F_46 ( V_33 ) ;
if ( V_255 > V_256 )
return - V_32 ;
...
static int F_140 ( struct V_80 * V_33 , void * V_258 )
{
struct V_259 * V_21 = V_258 ;
struct V_1 * V_2 = F_46 ( V_33 ) ;
if ( ! F_141 ( V_21 -> V_260 ) )
return - V_261 ;
memcpy ( V_33 -> V_54 , V_21 -> V_260 , V_33 -> V_262 ) ;
if ( V_2 -> V_225 ) {
if ( F_24 ( V_2 , V_33 ) )
return - V_35 ;
} else {
...
{
int V_3 ;
struct V_266 * V_43 = & V_2 -> V_267 ;
struct V_268 * V_10 = & V_2 -> V_10 ;
struct V_179 * V_87 = V_2 -> V_87 ;
#define F_145 ( T_7 ) \
nicvf_reg_read(nic, NIC_VNIC_RX_STAT_0_13 | (reg << 3))
#define F_146 ( T_7 ) \
nicvf_reg_read(nic, NIC_VNIC_TX_STAT_0_4 | (reg << 3))
V_43 -> V_269 = F_145 ( V_270 ) ;
V_43 -> V_271 = F_145 ( V_272 ) ;
V_43 -> V_273 = F_145 ( V_274 ) ;
V_43 -> V_275 = F_145 ( V_276 ) ;
V_43 -> V_277 = F_145 ( V_278 ) ;
V_43 -> V_279 = F_145 ( V_280 ) ;
V_43 -> V_281 = F_145 ( V_282 ) ;
V_43 -> V_283 = F_145 ( V_284 ) ;
V_43 -> V_285 = F_145 ( V_286 ) ;
V_43 -> V_287 = F_145 ( V_288 ) ;
V_43 -> V_289 = F_145 ( V_290 ) ;
V_43 -> V_291 = F_145 ( V_292 ) ;
V_43 -> V_293 = F_145 ( V_294 ) ;
V_43 -> V_295 = F_145 ( V_296 ) ;
V_43 -> V_297 = F_146 ( V_298 ) ;
V_43 -> V_299 = F_146 ( V_300 ) ;
V_43 -> V_301 = F_146 ( V_302 ) ;
V_43 -> V_303 = F_146 ( V_304 ) ;
V_43 -> V_305 = F_146 ( V_306 ) ;
V_10 -> V_307 = V_43 -> V_299 +
V_43 -> V_301 +
V_43 -> V_303 ;
V_10 -> V_308 = V_43 -> V_271 +
V_43 -> V_273 +
V_43 -> V_275 ;
V_10 -> V_309 = V_43 -> V_281 +
V_43 -> V_285 ;
V_10 -> V_305 = V_43 -> V_305 ;
for ( V_3 = 0 ; V_3 < V_87 -> V_86 ; V_3 ++ )
F_147 ( V_2 , V_3 ) ;
for ( V_3 = 0 ; V_3 < V_87 -> V_116 ; V_3 ++ )
F_148 ( V_2 , V_3 ) ;
}
static struct V_310 * F_149 ( struct V_80 * V_33 ,
struct V_310 * V_43 )
{
struct V_1 * V_2 = F_46 ( V_33 ) ;
struct V_266 * V_267 = & V_2 -> V_267 ;
struct V_268 * V_10 = & V_2 -> V_10 ;
F_144 ( V_2 ) ;
V_43 -> V_269 = V_267 -> V_269 ;
V_43 -> V_311 = V_10 -> V_308 ;
V_43 -> V_312 = V_10 -> V_309 ;
V_43 -> V_313 = V_267 -> V_275 ;
V_43 -> V_314 = V_267 -> V_297 ;
V_43 -> V_315 = V_10 -> V_307 ;
V_43 -> V_316 = V_10 -> V_305 ;
return V_43 ;
}
static void F_150 ( struct V_80 * V_200 )
{
...
static void F_152 ( struct V_319 * V_320 )
{
struct V_1 * V_2 ;
V_2 = F_79 ( V_320 , struct V_1 , V_318 ) ;
if ( ! F_143 ( V_2 -> V_33 ) )
return;
F_123 ( V_2 -> V_33 ) ;
F_36 ( V_2 -> V_33 ) ;
V_2 -> V_33 -> V_321 = V_322 ;
}
static int F_153 ( struct V_1 * V_2 ,
T_8 V_143 )
{
union V_23 V_24 = {} ;
V_24 . V_323 . V_25 = V_324 ;
V_24 . V_323 . V_34 = V_2 -> V_34 ;
V_24 . V_323 . V_105 = ( V_143 & V_325 ) != 0 ;
return F_10 ( V_2 , & V_24 ) ;
}
static T_8 F_154 ( struct V_80 * V_33 ,
T_8 V_143 )
{
struct V_1 * V_2 = F_46 ( V_33 ) ;
if ( ( V_143 & V_325 ) &&
...
static int F_155 ( struct V_80 * V_33 ,
T_8 V_143 )
{
struct V_1 * V_2 = F_46 ( V_33 ) ;
T_8 V_326 = V_143 ^ V_33 -> V_143 ;
if ( V_326 & V_327 )
F_156 ( V_2 , V_143 ) ;
if ( ( V_326 & V_325 ) && F_143 ( V_33 ) )
return F_153 ( V_2 , V_143 ) ;
return 0 ;
}
static int F_157 ( struct V_328 * V_224 , const struct V_329 * V_330 )
{
struct V_331 * V_200 = & V_224 -> V_200 ;
struct V_80 * V_33 ;
struct V_1 * V_2 ;
int V_119 , V_332 ;
V_119 = F_158 ( V_224 ) ;
...
V_119 = F_160 ( V_224 , V_333 ) ;
if ( V_119 ) {
F_159 ( V_200 , L_32 , V_119 ) ;
goto V_334;
}
V_119 = F_161 ( V_224 , F_162 ( 48 ) ) ;
if ( V_119 ) {
F_159 ( V_200 , L_33 ) ;
goto V_335;
}
V_119 = F_163 ( V_224 , F_162 ( 48 ) ) ;
if ( V_119 ) {
F_159 ( V_200 , L_34 ) ;
goto V_335;
}
V_332 = V_6 ;
if ( V_224 -> V_336 ) {
V_332 = F_164 ( F_165 () , V_6 ) ;
V_332 = F_28 ( V_332 ,
( V_337 + 1 ) * V_6 ) ;
}
V_33 = F_166 ( sizeof( struct V_1 ) , V_332 , V_332 ) ;
if ( ! V_33 ) {
V_119 = - V_246 ;
goto V_335;
}
F_167 ( V_224 , V_33 ) ;
F_168 ( V_33 , & V_224 -> V_200 ) ;
V_2 = F_46 ( V_33 ) ;
V_2 -> V_33 = V_33 ;
V_2 -> V_224 = V_224 ;
V_2 -> V_78 = V_2 ;
V_2 -> V_338 = V_332 ;
V_2 -> V_20 = F_169 ( V_224 , V_339 , 0 ) ;
if ( ! V_2 -> V_20 ) {
F_159 ( V_200 , L_35 ) ;
V_119 = - V_246 ;
goto V_340;
...
if ( V_119 )
goto V_341;
V_33 -> V_160 = ( V_161 | V_342 | V_343 |
V_344 | V_171 |
V_327 ) ;
V_33 -> V_160 |= V_144 ;
V_33 -> V_143 |= V_33 -> V_160 ;
V_33 -> V_160 |= V_325 ;
V_33 -> V_345 = V_343 | V_342 | V_344 ;
V_33 -> V_346 = & V_347 ;
V_33 -> V_348 = V_349 ;
F_172 ( & V_2 -> V_318 , F_152 ) ;
V_119 = F_173 ( V_33 ) ;
if ( V_119 ) {
F_159 ( V_200 , L_36 ) ;
goto V_341;
...
static void F_178 ( struct V_328 * V_224 )
{
struct V_80 * V_33 = F_179 ( V_224 ) ;
struct V_1 * V_2 ;
struct V_80 * V_352 ;
if ( ! V_33 )
return;
...
static void F_181 ( struct V_328 * V_224 )
{
F_178 ( V_224 ) ;
}
static int T_9 F_182 ( void )
{
F_183 ( L_37 , V_333 , V_355 ) ;
return F_184 ( & V_356 ) ;
}
