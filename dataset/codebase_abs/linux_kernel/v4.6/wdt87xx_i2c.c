...
const struct V_52 * V_53 , T_3 V_145 )
{
const void * V_131 ;
int error ;
V_131 = F_19 ( V_53 , V_145 ) ;
if ( ! V_131 ) {
F_4 ( & V_2 -> V_17 , L_37 ,
V_145 ) ;
return - V_21 ;
}
error = F_25 ( V_131 , V_145 ) ;
if ( error ) {
F_4 ( & V_2 -> V_17 , L_38 ,
V_145 , error ) ;
return error ;
...
static int F_40 ( struct V_149 * V_17 ,
const char * V_150 , unsigned int V_57 )
{
struct V_1 * V_2 = F_41 ( V_17 ) ;
const struct V_52 * V_53 ;
int error ;
error = F_42 ( & V_53 , V_150 , V_17 ) ;
if ( error ) {
F_4 ( & V_2 -> V_17 , L_43 ,
V_150 , error ) ;
return error ;
...
static T_4 F_44 ( struct V_149 * V_17 ,
struct V_151 * V_152 , char * V_12 )
{
struct V_1 * V_2 = F_41 ( V_17 ) ;
struct V_92 * V_93 = F_35 ( V_2 ) ;
T_3 V_153 ;
V_153 = V_93 -> V_64 . V_72 ;
V_153 = ( V_153 << 16 ) | V_93 -> V_64 . V_74 ;
return F_45 ( V_12 , V_154 , L_44 , V_153 ) ;
}
static T_4 F_46 ( struct V_149 * V_17 ,
struct V_151 * V_152 , char * V_12 )
{
struct V_1 * V_2 = F_41 ( V_17 ) ;
struct V_92 * V_93 = F_35 ( V_2 ) ;
return F_45 ( V_12 , V_154 , L_44 , V_93 -> V_64 . V_91 ) ;
}
static T_4 F_47 ( struct V_149 * V_17 ,
struct V_151 * V_152 , char * V_12 )
{
struct V_1 * V_2 = F_41 ( V_17 ) ;
struct V_92 * V_93 = F_35 ( V_2 ) ;
return F_45 ( V_12 , V_154 , L_44 , V_93 -> V_64 . V_90 ) ;
}
static T_4 F_48 ( struct V_149 * V_17 ,
struct V_151 * V_152 ,
const char * V_12 , T_1 V_112 )
{
int error ;
error = F_40 ( V_17 , V_155 , V_156 ) ;
return error ? error : V_112 ;
}
static T_4 F_49 ( struct V_149 * V_17 ,
struct V_151 * V_152 ,
const char * V_12 , T_1 V_112 )
{
int error ;
error = F_40 ( V_17 , V_157 , V_104 ) ;
return error ? error : V_112 ;
}
static void F_50 ( struct V_158 * V_159 ,
struct V_63 * V_64 ,
T_2 * V_12 )
{
int V_160 ;
T_3 V_161 , V_124 , V_162 ;
T_2 V_163 ;
V_160 = ( V_12 [ V_164 ] >> 3 ) - 1 ;
if ( V_160 < 0 )
return;
if ( ! ( V_12 [ V_164 ] & 0x1 ) )
return;
...
V_162 *= V_64 -> V_84 ;
V_163 = V_12 [ V_166 ] ;
V_161 = F_10 ( V_12 + V_167 ) ;
V_124 = F_10 ( V_12 + V_168 ) ;
V_124 = F_22 ( V_124 * V_64 -> V_82 , V_64 -> V_80 ) ;
if ( V_161 > V_64 -> V_86 || V_124 > V_64 -> V_88 )
return;
F_17 ( V_159 -> V_17 . V_169 , L_45 ,
V_160 , V_161 , V_124 ) ;
F_51 ( V_159 , V_160 ) ;
F_52 ( V_159 , V_170 , 1 ) ;
F_53 ( V_159 , V_171 , V_162 ) ;
F_53 ( V_159 , V_172 , V_163 ) ;
F_53 ( V_159 , V_173 , V_161 ) ;
F_53 ( V_159 , V_174 , V_124 ) ;
}
static T_5 F_54 ( int V_147 , void * V_175 )
{
struct V_92 * V_93 = V_175 ;
struct V_1 * V_2 = V_93 -> V_2 ;
int V_126 , V_176 ;
int error ;
T_2 V_177 [ V_178 ] = { 0 } ;
error = F_55 ( V_2 , V_177 , V_178 ) ;
if ( error < 0 ) {
...
{
struct V_149 * V_17 = & V_93 -> V_2 -> V_17 ;
struct V_158 * V_159 ;
unsigned int V_185 = F_22 ( V_87 , V_93 -> V_64 . V_80 ) ;
int error ;
V_159 = F_59 ( V_17 ) ;
if ( ! V_159 ) {
F_4 ( V_17 , L_47 ) ;
...
V_93 -> V_159 = V_159 ;
V_159 -> V_187 = L_48 ;
V_159 -> V_54 . V_188 = V_189 ;
V_159 -> V_54 . V_190 = V_93 -> V_64 . V_67 ;
V_159 -> V_54 . V_191 = V_93 -> V_64 . V_69 ;
V_159 -> V_192 = V_93 -> V_192 ;
F_60 ( V_159 , V_173 , 0 ,
V_93 -> V_64 . V_86 , 0 , 0 ) ;
F_60 ( V_159 , V_174 , 0 ,
V_93 -> V_64 . V_88 , 0 , 0 ) ;
F_61 ( V_159 , V_173 , V_185 ) ;
F_61 ( V_159 , V_174 , V_185 ) ;
F_60 ( V_159 , V_171 ,
0 , V_93 -> V_64 . V_86 , 0 , 0 ) ;
F_60 ( V_159 , V_172 , 0 , 0xFF , 0 , 0 ) ;
F_62 ( V_159 , V_181 ,
V_193 | V_194 ) ;
error = F_63 ( V_159 ) ;
if ( error ) {
...
const struct V_195 * V_54 )
{
struct V_92 * V_93 ;
int error ;
F_17 ( & V_2 -> V_17 , L_50 ,
V_2 -> V_15 -> V_196 , V_2 -> V_147 ) ;
if ( ! F_65 ( V_2 -> V_15 , V_197 ) )
return - V_198 ;
V_93 = F_66 ( & V_2 -> V_17 , sizeof( * V_93 ) , V_199 ) ;
if ( ! V_93 )
return - V_186 ;
V_93 -> V_2 = V_2 ;
F_67 ( & V_93 -> V_146 ) ;
F_68 ( V_2 , V_93 ) ;
snprintf ( V_93 -> V_192 , sizeof( V_93 -> V_192 ) , L_51 ,
V_2 -> V_15 -> V_196 , V_2 -> V_9 ) ;
error = F_21 ( V_2 , & V_93 -> V_64 ) ;
if ( error )
return error ;
error = F_58 ( V_93 ) ;
...
error = F_70 ( & V_2 -> V_17 . V_201 , & V_202 ) ;
if ( error ) {
...
{
F_72 ( & V_2 -> V_17 . V_201 , & V_202 ) ;
return 0 ;
}
static int T_6 F_73 ( struct V_149 * V_17 )
{
struct V_1 * V_2 = F_41 ( V_17 ) ;
int error ;
F_37 ( V_2 -> V_147 ) ;
error = F_13 ( V_2 , V_40 , V_203 ) ;
if ( error ) {
F_38 ( V_2 -> V_147 ) ;
F_4 ( & V_2 -> V_17 ,
L_54 ,
...
static int T_6 F_74 ( struct V_149 * V_17 )
{
struct V_1 * V_2 = F_41 ( V_17 ) ;
int error ;
F_6 ( 100 ) ;
