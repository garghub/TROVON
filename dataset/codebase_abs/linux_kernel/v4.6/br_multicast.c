...
if ( ! V_60 ) {
V_23 -> V_54 = true ;
F_42 ( & V_23 -> V_52 , V_134 + V_27 -> V_137 ) ;
goto V_53;
}
for ( V_58 = & V_23 -> V_55 ;
( V_48 = F_32 ( * V_58 , V_27 ) ) != NULL ;
...
goto V_66;
F_38 ( * V_58 , V_48 ) ;
F_41 ( V_27 -> V_51 , V_60 , V_70 , V_139 , 0 ) ;
V_138:
F_42 ( & V_48 -> V_52 , V_134 + V_27 -> V_137 ) ;
V_53:
V_66 = 0 ;
V_66:
F_35 ( & V_27 -> V_50 ) ;
...
{
if ( V_14 -> V_4 == F_2 ( V_6 ) )
V_27 -> V_152 . V_24 . V_7 . V_8 = F_18 ( V_29 ) -> V_90 ;
#if F_3 ( V_9 )
else
V_27 -> V_153 . V_24 . V_7 . V_11 = F_19 ( V_29 ) -> V_90 ;
#endif
}
...
if ( ! V_159 || F_31 ( & V_159 -> V_52 ) )
return;
F_102 ( V_27 , V_60 , & V_140 ) ;
time = V_63 ;
time += V_157 -> V_163 < V_27 -> V_164 ?
V_27 -> V_165 :
V_27 -> V_166 ;
F_42 ( & V_157 -> V_52 , time ) ;
}
static void
...
V_60 -> V_135 == V_167 )
goto V_53;
if ( V_149 -> V_163 < V_27 -> V_164 )
V_149 -> V_163 ++ ;
F_105 ( V_60 -> V_27 , V_60 , V_149 ) ;
V_53:
F_35 ( & V_27 -> V_50 ) ;
}
...
{
V_60 -> V_141 = V_147 ;
F_84 ( & V_60 -> V_144 , F_93 ,
( unsigned long ) V_60 ) ;
F_84 ( & V_60 -> V_150 . V_52 ,
...
static void F_115 ( struct V_148 * V_149 )
{
V_149 -> V_163 = 0 ;
if ( F_116 ( & V_149 -> V_52 ) >= 0 ||
F_40 ( & V_149 -> V_52 ) )
F_42 ( & V_149 -> V_52 , V_63 ) ;
}
...
T_1 V_70 ;
V_72 = F_121 ( V_29 ) ;
V_173 = F_122 ( V_72 -> V_174 ) ;
V_42 = F_123 ( V_29 ) + sizeof( * V_72 ) ;
for ( V_43 = 0 ; V_43 < V_173 ; V_43 ++ ) {
V_42 += sizeof( * V_172 ) ;
if ( ! F_124 ( V_29 , V_42 ) )
return - V_46 ;
V_172 = ( void * ) ( V_29 -> V_49 + V_42 - sizeof( * V_172 ) ) ;
V_70 = V_172 -> V_175 ;
type = V_172 -> V_176 ;
V_42 += F_122 ( V_172 -> V_177 ) * 4 ;
if ( ! F_124 ( V_29 , V_42 ) )
return - V_46 ;
switch ( type ) {
case V_178 :
...
int V_173 ;
int V_66 = 0 ;
if ( ! F_124 ( V_29 , sizeof( * V_185 ) ) )
return - V_46 ;
V_185 = F_70 ( V_29 ) ;
V_173 = F_122 ( V_185 -> V_187 . V_188 [ 1 ] ) ;
V_42 = F_123 ( V_29 ) + sizeof( * V_185 ) ;
for ( V_43 = 0 ; V_43 < V_173 ; V_43 ++ ) {
T_5 * V_189 , V_190 ;
V_189 = F_127 ( V_29 ,
V_42 + F_128 ( struct V_186 ,
V_177 ) ,
sizeof( V_190 ) , & V_190 ) ;
if ( ! V_189 )
return - V_46 ;
if ( ! F_124 ( V_29 ,
V_42 + sizeof( * V_172 ) +
sizeof( struct V_19 ) * F_122 ( * V_189 ) ) )
return - V_46 ;
V_172 = (struct V_186 * ) ( V_29 -> V_49 + V_42 ) ;
V_42 += sizeof( * V_172 ) +
sizeof( struct V_19 ) * F_122 ( * V_189 ) ;
switch ( V_172 -> V_176 ) {
case V_191 :
...
if ( ( V_172 -> V_176 == V_193 ||
V_172 -> V_176 == V_191 ) &&
F_122 ( * V_189 ) == 0 ) {
F_129 ( V_27 , V_60 , & V_172 -> V_175 ,
V_5 ) ;
} else {
V_66 = F_91 ( V_27 , V_60 ,
& V_172 -> V_175 , V_5 ) ;
...
T_1 V_90 )
{
if ( ! F_31 ( & V_27 -> V_150 . V_52 ) &&
! F_31 ( & V_27 -> V_161 . V_52 ) )
goto V_197;
if ( ! V_27 -> V_152 . V_24 . V_7 . V_8 )
goto V_197;
if ( F_131 ( V_90 ) <= F_131 ( V_27 -> V_152 . V_24 . V_7 . V_8 ) )
goto V_197;
return false ;
V_197:
V_27 -> V_152 . V_24 . V_7 . V_8 = V_90 ;
F_38 ( V_27 -> V_152 . V_60 , V_60 ) ;
return true ;
}
...
goto V_197;
if ( F_133 ( V_90 , & V_27 -> V_153 . V_24 . V_7 . V_11 ) <= 0 )
goto V_197;
return false ;
V_197:
V_27 -> V_153 . V_24 . V_7 . V_11 = * V_90 ;
...
{
if ( ! F_31 ( & V_149 -> V_52 ) )
V_149 -> V_199 = V_63 + V_198 ;
F_42 ( & V_149 -> V_52 , V_63 + V_27 -> V_200 ) ;
}
...
if ( V_201 )
F_136 ( & V_60 -> V_145 , V_201 ) ;
else
F_85 ( & V_60 -> V_145 , & V_27 -> V_202 ) ;
...
goto V_53;
V_70 = V_72 -> V_70 ;
if ( V_29 -> V_42 == V_205 + sizeof( * V_72 ) ) {
V_198 = V_72 -> V_97 * ( V_100 / V_101 ) ;
if ( ! V_198 ) {
V_198 = 10 * V_100 ;
V_70 = 0 ;
}
} else if ( V_29 -> V_42 >= V_205 + sizeof( * V_204 ) ) {
V_204 = F_140 ( V_29 ) ;
if ( V_204 -> V_189 )
goto V_53;
V_198 = V_204 -> V_97 ?
F_141 ( V_204 -> V_97 ) * ( V_100 / V_101 ) : 1 ;
} else {
goto V_53;
}
if ( ! V_70 ) {
...
if ( V_23 -> V_54 &&
( F_31 ( & V_23 -> V_52 ) ?
F_142 ( V_23 -> V_52 . V_207 , V_134 + V_198 ) :
F_116 ( & V_23 -> V_52 ) >= 0 ) )
F_42 ( & V_23 -> V_52 , V_134 + V_198 ) ;
for ( V_58 = & V_23 -> V_55 ;
( V_48 = F_32 ( * V_58 , V_27 ) ) != NULL ;
V_58 = & V_48 -> V_59 ) {
if ( F_31 ( & V_48 -> V_52 ) ?
F_142 ( V_48 -> V_52 . V_207 , V_134 + V_198 ) :
F_116 ( & V_48 -> V_52 ) >= 0 )
F_42 ( & V_48 -> V_52 , V_134 + V_198 ) ;
}
V_53:
F_35 ( & V_27 -> V_50 ) ;
return V_66 ;
...
( V_60 && V_60 -> V_135 == V_136 ) )
goto V_53;
if ( V_29 -> V_42 == V_205 + sizeof( * V_208 ) ) {
if ( ! F_124 ( V_29 , V_205 + sizeof( * V_208 ) ) ) {
V_66 = - V_46 ;
goto V_53;
}
V_208 = (struct V_105 * ) F_70 ( V_29 ) ;
V_198 = F_144 ( F_122 ( V_208 -> V_120 ) ) ;
if ( V_198 )
V_70 = & V_208 -> V_122 ;
} else {
if ( ! F_124 ( V_29 , V_205 + sizeof( * V_210 ) ) ) {
V_66 = - V_46 ;
goto V_53;
}
V_210 = (struct V_209 * ) F_70 ( V_29 ) ;
if ( ! V_210 -> V_212 )
V_70 = & V_210 -> V_213 ;
V_198 = V_18 ( F_144 ( F_145 ( V_210 ) ) , 1UL ) ;
}
V_211 = V_70 && F_71 ( V_70 ) ;
if ( V_211 ) {
V_90 . V_4 = F_2 ( V_10 ) ;
...
V_134 = V_63 ;
time = V_134 + V_27 -> V_206 *
V_27 -> V_98 ;
if ( ! V_60 ) {
if ( V_23 -> V_54 &&
( F_31 ( & V_23 -> V_52 ) ?
F_142 ( V_23 -> V_52 . V_207 , time ) :
F_116 ( & V_23 -> V_52 ) >= 0 ) ) {
F_42 ( & V_23 -> V_52 , time ) ;
}
goto V_53;
...
if ( F_90 ( V_70 ) )
return;
V_157 = V_60 ? & V_60 -> V_150 : & V_27 -> V_150 ;
V_140 . V_7 . V_8 = V_70 ;
V_140 . V_4 = F_2 ( V_6 ) ;
V_140 . V_5 = V_5 ;
F_146 ( V_27 , V_60 , & V_140 , & V_27 -> V_161 ,
V_157 ) ;
}
...
if ( F_92 ( V_70 ) )
return;
V_157 = V_60 ? & V_60 -> V_151 : & V_27 -> V_151 ;
V_140 . V_7 . V_11 = * V_70 ;
V_140 . V_4 = F_2 ( V_10 ) ;
V_140 . V_5 = V_5 ;
F_146 ( V_27 , V_60 , & V_140 , & V_27 -> V_162 ,
V_157 ) ;
}
...
T_3 V_5 )
{
struct V_28 * V_215 = NULL ;
struct V_71 * V_72 ;
int V_66 ;
V_66 = F_148 ( V_29 , & V_215 ) ;
if ( V_66 == - V_216 ) {
...
break;
case V_220 :
V_66 = F_120 ( V_27 , V_60 , V_215 , V_5 ) ;
break;
case V_96 :
V_66 = F_139 ( V_27 , V_60 , V_215 , V_5 ) ;
break;
case V_221 :
...
F_17 ( V_29 ) -> V_31 = 1 ;
V_208 = (struct V_105 * ) F_151 ( V_29 ) ;
switch ( V_208 -> V_116 ) {
case V_222 :
F_17 ( V_29 ) -> V_217 = 1 ;
V_66 = F_91 ( V_27 , V_60 , & V_208 -> V_122 , V_5 ) ;
break;
case V_223 :
V_66 = F_126 ( V_27 , V_60 , V_215 , V_5 ) ;
break;
case V_117 :
V_66 = F_143 ( V_27 , V_60 , V_215 , V_5 ) ;
break;
case V_224 :
F_129 ( V_27 , V_60 , & V_208 -> V_122 , V_5 ) ;
break;
}
if ( V_215 && V_215 != V_29 )
F_68 ( V_215 ) ;
...
if ( V_149 -> V_163 < V_27 -> V_164 )
V_149 -> V_163 ++ ;
F_154 ( V_226 -> V_60 , NULL ) ;
F_105 ( V_27 , NULL , V_149 ) ;
F_35 ( & V_27 -> V_50 ) ;
}
static void F_155 ( unsigned long V_49 )
{
struct V_26 * V_27 = ( void * ) V_49 ;
F_153 ( V_27 , & V_27 -> V_150 , & V_27 -> V_152 ) ;
}
...
V_27 -> V_98 = V_100 ;
V_27 -> V_99 = 10 * V_100 ;
V_27 -> V_165 = 125 * V_100 / 4 ;
V_27 -> V_166 = 125 * V_100 ;
V_27 -> V_200 = 255 * V_100 ;
V_27 -> V_137 = 260 * V_100 ;
V_27 -> V_161 . V_199 = 0 ;
V_27 -> V_152 . V_60 = NULL ;
#if F_3 ( V_9 )
V_27 -> V_162 . V_199 = 0 ;
...
F_84 ( & V_27 -> V_144 ,
F_96 , 0 ) ;
F_84 ( & V_27 -> V_161 . V_52 ,
F_99 , ( unsigned long ) V_27 ) ;
F_84 ( & V_27 -> V_150 . V_52 , F_155 ,
( unsigned long ) V_27 ) ;
#if F_3 ( V_9 )
F_84 ( & V_27 -> V_162 . V_52 ,
F_100 , ( unsigned long ) V_27 ) ;
F_84 ( & V_27 -> V_151 . V_52 , F_156 ,
( unsigned long ) V_27 ) ;
#endif
}
...
{
F_114 ( & V_27 -> V_144 ) ;
F_114 ( & V_27 -> V_161 . V_52 ) ;
F_114 ( & V_27 -> V_150 . V_52 ) ;
#if F_3 ( V_9 )
...
int F_164 ( struct V_26 * V_27 , unsigned long V_227 )
{
int V_66 = - V_46 ;
F_111 ( & V_27 -> V_50 ) ;
switch ( V_227 ) {
...
static void F_165 ( struct V_123 * V_48 )
{
if ( F_44 ( & V_48 -> V_145 ) )
return;
F_94 ( & V_48 -> V_145 ) ;
...
int F_166 ( struct V_123 * V_48 , unsigned long V_227 )
{
...
int F_168 ( struct V_26 * V_27 , unsigned long V_227 )
{
int V_66 = 0 ;
struct V_12 * V_13 ;
F_111 ( & V_27 -> V_50 ) ;
...
int F_169 ( struct V_26 * V_27 , unsigned long V_227 )
{
unsigned long V_198 ;
V_227 = ! ! V_227 ;
F_111 ( & V_27 -> V_50 ) ;
...
goto V_228;
V_198 = V_27 -> V_99 ;
if ( ! F_31 ( & V_27 -> V_161 . V_52 ) )
V_27 -> V_161 . V_199 = V_63 + V_198 ;
F_98 ( V_27 , & V_27 -> V_150 ) ;
#if F_3 ( V_9 )
if ( ! F_31 ( & V_27 -> V_162 . V_52 ) )
V_27 -> V_162 . V_199 = V_63 + V_198 ;
F_98 ( V_27 , & V_27 -> V_151 ) ;
#endif
V_228:
F_113 ( & V_27 -> V_50 ) ;
...
int F_170 ( struct V_26 * V_27 , unsigned long V_227 )
{
int V_66 = - V_46 ;
V_16 V_37 ;
struct V_12 * V_13 ;
...
V_233 = F_47 ( sizeof( * V_233 ) , V_67 ) ;
if ( ! V_233 )
goto V_228;
V_233 -> V_24 = V_70 -> V_24 ;
F_177 ( & V_233 -> V_234 , V_232 ) ;
V_124 ++ ;
}
}
V_228:
...
bool F_179 ( struct V_230 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_123 * V_60 ;
struct V_73 V_74 ;
...
V_74 . V_80 = F_2 ( V_4 ) ;
V_235 = F_180 ( V_27 , & V_74 ) ;
V_228:
F_178 () ;
return V_235 ;
}
bool F_181 ( struct V_230 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_123 * V_60 ;
bool V_235 = false ;
