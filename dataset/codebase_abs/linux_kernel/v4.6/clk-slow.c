...
{
struct V_43 * V_38 = F_36 ( V_2 ) ;
unsigned int V_44 ;
F_37 ( V_38 -> V_45 , V_46 , & V_44 ) ;
return V_44 & V_47 ? 1 : 0 ;
}
static struct V_10 * T_3
F_38 ( struct V_45 * V_45 ,
const char * V_11 ,
const char * * V_22 ,
int V_23 )
{
...
static void T_3 F_39 ( struct V_26 * V_27 )
{
struct V_10 * V_10 ;
const char * V_22 [ 2 ] ;
unsigned int V_23 ;
