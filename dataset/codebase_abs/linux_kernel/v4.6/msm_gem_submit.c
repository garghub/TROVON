...
struct V_84 V_85 ;
void T_1 * V_32 =
F_1 ( args -> V_86 + ( V_23 * sizeof( V_85 ) ) ) ;
struct V_30 * V_31 ;
T_3 V_38 ;
V_24 = F_8 ( & V_85 , V_32 , sizeof( V_85 ) ) ;
if ( V_24 ) {
V_24 = - V_33 ;
goto V_83;
}
...
if ( ( V_85 . V_65 + V_85 . V_64 ) >=
V_31 -> V_44 . V_65 ) {
F_9 ( L_11 , V_85 . V_65 ) ;
V_24 = - V_37 ;
goto V_83;
}
V_9 -> V_91 [ V_23 ] . type = V_85 . type ;
V_9 -> V_91 [ V_23 ] . V_65 = V_85 . V_65 / 4 ;
V_9 -> V_91 [ V_23 ] . V_38 = V_38 + V_85 . V_64 ;
V_9 -> V_91 [ V_23 ] . V_56 = V_85 . V_90 ;
if ( V_9 -> V_53 )
continue;
V_24 = F_25 ( V_9 , V_31 , V_85 . V_64 ,
V_85 . V_58 , V_85 . V_59 ) ;
if ( V_24 )
goto V_83;
}
