...
F_80 ( V_72 -> V_163 , F_81 ( & V_2 -> V_45 ) , sizeof( V_72 -> V_163 ) ) ;
V_14 = F_82 ( V_72 ) ;
if ( V_14 ) {
if ( V_14 != - V_127 )
F_45 ( V_2 , L_40 , V_14 ) ;
...
static int F_90 ( struct V_79 * V_45 )
{
...
static int F_98 ( struct V_79 * V_45 )
{
int V_14 ;
struct V_1 * V_2 = F_91 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
struct V_83 * V_72 = V_11 -> V_72 ;
int V_165 ;
if ( F_95 ( & V_2 -> V_45 ) && V_11 -> V_169 ) {
V_165 = F_99 ( V_11 -> V_74 ) ;
if ( ! V_165 )
V_11 -> V_169 = false ;
else
F_97 ( V_72 , L_42 ,
...
static int F_101 ( struct V_79 * V_45 )
{
struct V_1 * V_2 = F_91 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_15 ( V_2 , V_67 ) ;
...
static int F_102 ( struct V_79 * V_45 )
{
struct V_1 * V_2 = F_91 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_100 ( V_11 -> V_74 ) ;
