...
V_61 = F_43 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 ,
V_58 ) ;
if ( ! V_61 ) {
F_44 ( V_67
L_2 ,
...
V_61 = F_45 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 , V_58 ) ;
if ( ! V_61 ) {
F_44 ( V_67
L_3 ,
( unsigned long long ) V_39 -> V_36 ,
...
if ( V_39 == V_59 )
break;
F_46 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 ) ;
}
V_59 = NULL ;
V_68:
F_30 (res, &resources->iomem, list) {
if ( V_39 == V_59 )
break;
F_47 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 ) ;
}
V_66:
if ( F_40 )
F_32 ( & V_63 ) ;
...
static int F_49 ( struct V_70 * V_71 , T_2 * V_72 ,
T_1 * V_73 )
{
T_1 V_74 , V_13 , V_75 , V_76 ;
V_74 = V_71 -> V_74 ;
V_13 = V_71 -> V_13 ;
V_75 = V_71 -> V_77 ;
V_76 = V_71 -> V_76 ;
...
* V_73 = 1UL << ( V_75 + 2 ) ;
if ( V_74 == 32 && V_13 == 0 && ( * V_72 & 0x03 ) == 0 &&
* V_73 < 32 )
* V_73 = 32 ;
else if ( V_74 == 64 && V_13 == 0 && ( * V_72 & 0x07 ) == 0 &&
* V_73 < 64 )
* V_73 = 64 ;
if ( ( V_74 + V_13 ) > * V_73 ) {
F_12 (FW_BUG APEI_PFX
...
int F_15 ( struct V_70 * V_71 )
{
int V_11 ;
T_1 V_73 ;
T_2 V_78 ;
V_11 = F_49 ( V_71 , & V_78 , & V_73 ) ;
if ( V_11 )
return V_11 ;
return F_51 ( V_71 ) ;
}
int F_3 ( T_2 * V_10 , struct V_70 * V_71 )
{
int V_11 ;
T_1 V_73 ;
T_2 V_78 ;
...
int F_7 ( T_2 V_10 , struct V_70 * V_71 )
{
int V_11 ;
T_1 V_73 ;
T_2 V_78 ;
...
if ( ! ( V_2 -> V_4 [ V_31 ] . V_16 & V_32 ) )
return 0 ;
V_11 = F_49 ( V_71 , & V_72 , & V_73 ) ;
if ( V_11 )
return V_11 ;
switch ( V_71 -> V_76 ) {
case V_79 :
return F_20 ( & V_53 -> V_54 , V_72 ,
V_73 / 8 ) ;
case V_80 :
return F_20 ( & V_53 -> V_55 , V_72 ,
V_73 / 8 ) ;
default:
return - V_26 ;
}
...
struct V_52 * V_53 )
{
return F_13 ( V_2 , F_57 ,
V_53 , NULL ) ;
}
struct V_84 * F_59 ( void )
{
...
int __weak F_61 ( struct V_86 * V_87 ,
void * V_29 )
{
return 1 ;
}
void __weak F_62 ( int V_88 ,
struct V_89 * V_90 )
{
}
int F_63 ( void )
{
static T_3 V_91 [] = L_11 ;
T_8 V_92 ;
T_1 V_93 [ 3 ] ;
struct V_94 V_95 = {
. V_96 = V_91 ,
. V_97 = 1 ,
. V_98 . V_99 = sizeof( V_93 ) ,
. V_98 . V_100 = V_93 ,
} ;
V_93 [ V_101 ] = V_102 ;
V_93 [ V_103 ] = 1 ;
V_93 [ V_104 ] = 0 ;
if ( F_53 ( F_64 ( NULL , L_12 , & V_92 ) )
|| F_53 ( F_65 ( V_92 , & V_95 ) ) )
return - V_83 ;
else {
F_22 ( V_95 . V_105 . V_100 ) ;
return 0 ;
}
}
