...
static int F_46 ( struct V_2 * V_3 , int V_111 )
{
int V_101 ;
V_112:
if ( ! V_3 -> V_49 ) {
...
struct V_1 * * V_4 , int V_113 )
{
int V_101 ;
struct V_1 * V_28 = NULL ;
V_101 = F_46 ( V_3 , V_113 ) ;
if ( V_101 )
goto V_9;
V_28 = F_48 ( V_3 -> V_47 . V_114 , struct V_1 , V_47 ) ;
V_101 = F_9 ( V_3 , V_28 , V_113 , 1 ) ;
if ( V_101 < 0 )
goto V_9;
* V_4 = V_28 ;
V_9:
...
return - V_97 ;
V_3 -> V_51 -> V_67 = V_74 ;
V_3 -> V_51 -> V_76 = ( unsigned long ) V_116 ;
V_3 -> V_51 -> V_73 = V_100 ;
V_36 = F_30 ( V_3 ) ;
...
struct V_1 * V_28 ,
char T_3 * V_116 , T_4 V_100 ,
int V_113 )
{
void * V_29 = F_56 ( V_3 , V_29 , V_28 ) ;
if ( V_100 > V_28 -> V_91 - V_3 -> V_119 )
V_100 = V_28 -> V_91 - V_3 -> V_119 ;
if ( F_57 ( V_116 , V_29 + V_3 -> V_119 , V_100 ) )
return - V_120 ;
return V_100 ;
}
static int F_58 ( struct V_2 * V_3 ,
struct V_1 * V_28 ,
char T_3 * V_116 , T_4 V_100 , T_4 V_121 ,
int V_122 , int V_113 )
{
unsigned int * V_123 = F_56 ( V_3 , V_29 , V_28 ) ;
if ( V_122 ) {
V_123 += ( V_28 -> V_91 >> 2 ) - 1 ;
* V_123 = V_28 -> V_93 >> 1 ;
F_23 ( 1 , L_42 , * V_123 ) ;
}
V_100 = F_55 ( V_3 , V_28 , V_116 , V_100 , V_113 ) ;
if ( ( V_100 == - V_120 ) && ( V_121 == 0 ) )
return - V_120 ;
return V_100 ;
}
T_2 F_59 ( struct V_2 * V_3 ,
char T_3 * V_116 , T_4 V_100 , T_5 * V_117 ,
int V_113 )
{
enum V_35 V_36 ;
unsigned long V_12 = 0 ;
unsigned V_91 = 0 , V_124 = 1 ;
int V_101 ;
F_10 ( V_3 -> V_6 -> V_10 , V_26 ) ;
F_33 ( V_3 ) ;
V_3 -> V_31 -> V_41 ( V_3 , & V_124 , & V_91 ) ;
if ( NULL == V_3 -> V_51 &&
V_100 >= V_91 &&
! V_113 ) {
V_101 = F_54 ( V_3 , V_116 , V_100 , V_117 ) ;
if ( V_101 >= 0 || V_101 == - V_118 )
goto V_9;
}
if ( NULL == V_3 -> V_51 ) {
V_101 = - V_97 ;
...
V_101 = F_9 ( V_3 , V_3 -> V_51 , V_113 , 1 ) ;
if ( 0 != V_101 )
goto V_9;
F_17 ( V_3 , V_115 , V_3 , V_3 -> V_51 ) ;
if ( V_58 == V_3 -> V_51 -> V_15 ) {
...
V_101 = F_55 ( V_3 , V_3 -> V_51 , V_116 , V_100 , V_113 ) ;
if ( V_101 < 0 )
goto V_9;
V_3 -> V_119 += V_101 ;
if ( V_3 -> V_119 == V_3 -> V_51 -> V_91 ) {
V_3 -> V_31 -> V_44 ( V_3 , V_3 -> V_51 ) ;
F_25 ( V_3 -> V_51 ) ;
V_3 -> V_51 = NULL ;
}
...
while ( V_100 > 0 ) {
if ( NULL == V_3 -> V_51 ) {
V_3 -> V_51 = F_48 ( V_3 -> V_47 . V_114 ,
struct V_1 ,
V_47 ) ;
F_28 ( & V_3 -> V_51 -> V_47 ) ;
V_3 -> V_119 = 0 ;
}
V_13 = F_9 ( V_3 , V_3 -> V_51 , V_113 , 1 ) ;
if ( V_13 < 0 ) {
if ( 0 == V_101 )
V_101 = V_13 ;
break;
...
V_13 = F_58 ( V_3 , V_3 -> V_51 , V_116 + V_101 , V_100 ,
V_101 , V_122 , V_113 ) ;
if ( V_13 < 0 ) {
V_101 = V_13 ;
break;
...
unsigned int F_66 ( struct V_125 * V_125 ,
struct V_2 * V_3 ,
T_6 * V_46 )
{
unsigned long V_126 = F_67 ( V_46 ) ;
struct V_1 * V_28 = NULL ;
unsigned int V_13 = 0 ;
F_33 ( V_3 ) ;
if ( V_3 -> V_49 ) {
if ( ! F_39 ( & V_3 -> V_47 ) )
V_28 = F_48 ( V_3 -> V_47 . V_114 ,
struct V_1 , V_47 ) ;
} else if ( V_126 & ( V_127 | V_128 ) ) {
if ( ! V_3 -> V_50 )
F_60 ( V_3 ) ;
if ( ! V_3 -> V_50 ) {
V_13 = V_129 ;
...
int F_69 ( struct V_2 * V_3 , struct V_132 * V_133 )
{
int V_13 = - V_102 ;
int V_48 ;
F_10 ( V_3 -> V_6 -> V_10 , V_26 ) ;
if ( ! ( V_133 -> V_134 & V_135 ) || ! ( V_133 -> V_134 & V_136 ) ) {
F_23 ( 1 , L_44 ) ;
return - V_102 ;
}
F_33 ( V_3 ) ;
...
V_28 -> V_71 == ( V_133 -> V_137 << V_103 ) ) {
V_13 = F_17 ( V_3 , V_138 , V_3 , V_28 , V_133 ) ;
break;
}
}
F_34 ( V_3 ) ;
