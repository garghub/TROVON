...
T_1 V_16 = 0xffff ;
struct V_76 V_77 ;
struct V_78 * V_79 = F_11 ( V_74 ) ;
struct V_6 * V_7 = F_12 ( V_74 -> V_80 ) ;
union V_12 V_13 ;
if ( ! ( V_11 -> V_81 & V_82 ) )
return F_13 ( - V_36 ) ;
if ( F_14 ( & V_7 -> V_83 , 1 , 0 ) )
F_15 ( V_7 ) ;
V_9 = F_16 ( sizeof( * V_9 ) , V_84 ) ;
if ( ! V_9 )
return F_13 ( - V_85 ) ;
V_17 = F_17 ( V_7 , V_9 ) ;
if ( V_17 )
goto V_86;
V_17 = F_18 ( & V_7 -> V_87 , 1 , V_11 -> V_21 . V_49 , & V_13 ,
& V_77 ) ;
if ( V_17 ) {
F_2 ( L_4 ,
V_88 , V_17 ) ;
...
V_9 -> V_2 = F_22 ( V_77 . V_91 , & V_13 ) ;
if ( ( V_79 -> V_92 ) &&
( ! F_23 ( (struct V_93 * ) V_11 -> V_21 . V_64 . V_66 ) ) &&
( ! F_24 ( (struct V_93 * ) V_11 -> V_21 . V_64 . V_66 ) ) ) {
...
V_17 = F_3 ( V_7 , V_9 , V_11 , & V_13 , V_79 -> V_35 , & V_15 , V_16 ) ;
if ( V_17 )
goto V_89;
if ( ( V_79 -> V_92 ) && ( V_79 -> V_92 -> V_95 . V_96 ) ) {
V_75 = V_79 -> V_92 -> V_95 . V_96 + V_11 -> V_97 ;
* V_75 = 0 ;
* V_75 |= V_9 -> V_35 & V_98 ;
if ( F_26 ( V_7 ) ) {
* V_75 |= ( ( T_3 ) V_9 -> V_2 &
...
int F_29 ( struct V_72 * V_103 )
{
struct V_8 * V_9 = F_30 ( V_103 ) ;
struct V_6 * V_7 = F_12 ( V_103 -> V_80 ) ;
F_27 ( V_7 , V_9 ) ;
F_28 ( V_9 ) ;
return 0 ;
}
int F_31 ( struct V_72 * V_103 , struct V_10 * V_11 )
{
struct V_8 * V_9 = F_30 ( V_103 ) ;
struct V_104 * V_50 = V_9 -> V_50 ;
struct V_20 * V_21 ;
V_11 -> V_81 |= V_82 ;
if ( V_9 -> V_50 -> V_70 & V_105 ) {
...
int F_34 ( struct V_72 * V_103 , struct V_10 * V_11 )
{
return - V_106 ;
}
int F_35 ( struct V_107 * V_87 ,
int V_108 ,
T_2 V_109 ,
const struct V_110 * V_111 ,
const struct V_112 * V_113 ,
const struct V_114 * V_115 , T_4 V_116 ,
struct V_114 * V_117 , T_4 * V_118 ,
T_1 * V_119 )
{
int V_17 ;
struct V_6 * V_7 ;
const struct V_120 * V_121 = ( const struct V_120 * ) V_115 ;
struct V_120 * V_122 = (struct V_120 * ) V_117 ;
if ( F_36 ( V_116 != sizeof( * V_121 ) ||
* V_118 != sizeof( * V_122 ) ) )
return V_123 ;
switch ( V_121 -> V_124 . V_125 ) {
case V_126 :
V_7 = F_12 ( V_87 ) ;
if ( ! F_37 ( V_7 , V_122 ) )
V_17 = V_127 | V_128 ;
