...
int F_30 ( struct V_10 * V_11 , int V_4 , int V_72 ,
...
V_8 = F_33 ( sizeof( * V_8 ) , V_75 ) ;
if ( ! V_8 )
return - V_74 ;
V_8 -> V_62 = F_34 ( V_5 -> V_18 , sizeof( unsigned int ) ,
V_75 ) ;
if ( ! V_8 -> V_62 )
goto V_76;
...
return;
F_42 ( V_4 , V_8 ) ;
for ( V_40 = 0 ; V_40 < V_8 -> V_5 -> V_63 ; V_40 ++ ) {
if ( ! V_8 -> V_5 -> V_6 [ V_40 ] . V_42 )
continue;
V_68 = F_23 ( V_8 -> V_64 , V_40 ) ;
if ( V_68 )
F_43 ( V_68 ) ;
}
F_44 ( V_8 -> V_64 ) ;
...
static void F_45 ( struct V_82 * V_17 , void * V_83 )
{
struct V_2 * V_8 = * (struct V_2 * * ) V_83 ;
F_41 ( V_8 -> V_4 , V_8 ) ;
}
static int F_46 ( struct V_82 * V_17 , void * V_83 , void * V_3 )
{
struct V_2 * * V_84 = V_83 ;
if ( ! V_84 || ! * V_84 ) {
F_47 ( ! V_84 || ! * V_84 ) ;
return 0 ;
}
...
int F_48 ( struct V_82 * V_17 , struct V_10 * V_11 , int V_4 ,
int V_72 , int V_73 ,
...
struct V_2 * * V_85 , * V_8 ;
int V_13 ;
V_85 = F_49 ( F_45 , sizeof( * V_85 ) ,
V_75 ) ;
if ( ! V_85 )
return - V_74 ;
V_13 = F_30 ( V_11 , V_4 , V_72 , V_73 ,
V_5 , & V_8 ) ;
if ( V_13 < 0 ) {
F_50 ( V_85 ) ;
return V_13 ;
...
void F_52 ( struct V_82 * V_17 , int V_4 ,
struct V_2 * V_3 )
{
int V_86 ;
F_47 ( V_4 != V_3 -> V_4 ) ;
...
return - V_49 ;
return F_56 ( V_3 -> V_64 , V_4 ) ;
}
struct V_66 * F_57 ( struct V_2 * V_3 )
{
if ( V_3 )
return V_3 -> V_64 ;
else
