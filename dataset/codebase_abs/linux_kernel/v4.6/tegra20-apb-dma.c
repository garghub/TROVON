...
while ( ! F_21 ( & V_165 ) ) {
V_28 = F_25 ( & V_165 , F_26 ( * V_28 ) , V_20 ) ;
F_15 ( & V_28 -> V_20 ) ;
F_76 ( V_28 ) ;
}
F_77 ( V_2 -> V_16 ) ;
...
static struct V_9 * F_78 ( struct V_167 * V_168 ,
struct V_169 * V_170 )
{
...
V_178 = F_81 ( & V_174 -> V_16 ) ;
if ( ! V_178 ) {
F_18 ( & V_174 -> V_16 , L_28 ) ;
return - V_179 ;
}
V_2 = F_82 ( & V_174 -> V_16 , sizeof( * V_2 ) + V_178 -> V_180 *
sizeof( struct V_6 ) , V_181 ) ;
if ( ! V_2 ) {
F_18 ( & V_174 -> V_16 , L_29 ) ;
return - V_182 ;
}
V_2 -> V_16 = & V_174 -> V_16 ;
V_2 -> V_43 = V_178 ;
F_83 ( V_174 , V_2 ) ;
V_176 = F_84 ( V_174 , V_183 , 0 ) ;
V_2 -> V_5 = F_85 ( & V_174 -> V_16 , V_176 ) ;
if ( F_86 ( V_2 -> V_5 ) )
return F_87 ( V_2 -> V_5 ) ;
V_2 -> V_184 = F_88 ( & V_174 -> V_16 , NULL ) ;
if ( F_86 ( V_2 -> V_184 ) ) {
F_18 ( & V_174 -> V_16 , L_30 ) ;
return F_87 ( V_2 -> V_184 ) ;
}
V_2 -> V_185 = F_89 ( & V_174 -> V_16 , L_31 ) ;
if ( F_86 ( V_2 -> V_185 ) ) {
F_18 ( & V_174 -> V_16 , L_32 ) ;
return F_87 ( V_2 -> V_185 ) ;
}
F_90 ( & V_2 -> V_37 ) ;
F_91 ( & V_174 -> V_16 ) ;
if ( ! F_92 ( & V_174 -> V_16 ) )
V_106 = F_93 ( & V_174 -> V_16 ) ;
else
V_106 = F_74 ( & V_174 -> V_16 ) ;
if ( V_106 < 0 ) {
F_94 ( & V_174 -> V_16 ) ;
return V_106 ;
}
...
F_1 ( V_2 , V_39 , V_42 ) ;
F_1 ( V_2 , V_186 , 0 ) ;
F_1 ( V_2 , V_187 , 0xFFFFFFFFul ) ;
F_77 ( & V_174 -> V_16 ) ;
F_67 ( & V_2 -> V_172 . V_188 ) ;
for ( V_144 = 0 ; V_144 < V_178 -> V_180 ; V_144 ++ ) {
struct V_6 * V_7 = & V_2 -> V_188 [ V_144 ] ;
V_7 -> V_8 = V_2 -> V_5 +
V_189 +
( V_144 * V_178 -> V_190 ) ;
V_176 = F_84 ( V_174 , V_191 , V_144 ) ;
if ( ! V_176 ) {
V_106 = - V_138 ;
F_18 ( & V_174 -> V_16 , L_33 , V_144 ) ;
goto V_192;
}
V_7 -> V_91 = V_176 -> V_193 ;
snprintf ( V_7 -> V_194 , sizeof( V_7 -> V_194 ) , L_34 , V_144 ) ;
V_106 = F_97 ( V_7 -> V_91 , F_51 , 0 , V_7 -> V_194 , V_7 ) ;
if ( V_106 ) {
F_18 ( & V_174 -> V_16 ,
L_35 ,
V_106 , V_144 ) ;
...
F_99 ( V_196 , V_2 -> V_172 . V_197 ) ;
F_99 ( V_198 , V_2 -> V_172 . V_197 ) ;
F_99 ( V_199 , V_2 -> V_172 . V_197 ) ;
V_2 -> V_38 = 0 ;
V_2 -> V_172 . V_16 = & V_174 -> V_16 ;
V_2 -> V_172 . V_200 =
F_72 ;
V_2 -> V_172 . V_201 =
F_75 ;
V_2 -> V_172 . V_202 = F_66 ;
V_2 -> V_172 . V_203 = F_71 ;
V_2 -> V_172 . V_204 = F_100 ( V_111 ) |
F_100 ( V_113 ) |
F_100 ( V_115 ) |
F_100 ( V_117 ) ;
V_2 -> V_172 . V_205 = F_100 ( V_111 ) |
F_100 ( V_113 ) |
F_100 ( V_115 ) |
F_100 ( V_117 ) ;
V_2 -> V_172 . V_206 = F_100 ( V_134 ) | F_100 ( V_129 ) ;
V_2 -> V_172 . V_207 = V_208 ;
V_2 -> V_172 . V_209 = F_27 ;
V_2 -> V_172 . V_210 = F_57 ;
V_2 -> V_172 . V_211 = F_58 ;
V_2 -> V_172 . V_212 = F_56 ;
V_106 = F_101 ( & V_2 -> V_172 ) ;
if ( V_106 < 0 ) {
F_18 ( & V_174 -> V_16 ,
L_36 , V_106 ) ;
goto V_192;
}
V_106 = F_102 ( V_174 -> V_16 . V_213 ,
F_78 , V_2 ) ;
if ( V_106 < 0 ) {
F_18 ( & V_174 -> V_16 ,
L_37 , V_106 ) ;
...
static int F_108 ( struct V_173 * V_174 )
{
struct V_1 * V_2 = F_109 ( V_174 ) ;
int V_144 ;
struct V_6 * V_7 ;
F_103 ( & V_2 -> V_172 ) ;
for ( V_144 = 0 ; V_144 < V_2 -> V_43 -> V_180 ; ++ V_144 ) {
V_7 = & V_2 -> V_188 [ V_144 ] ;
F_104 ( V_7 -> V_91 , V_7 ) ;
F_105 ( & V_7 -> V_93 ) ;
}
...
struct V_1 * V_2 = F_110 ( V_16 ) ;
int V_106 ;
V_106 = F_112 ( V_2 -> V_184 ) ;
if ( V_106 < 0 ) {
F_18 ( V_16 , L_39 , V_106 ) ;
return V_106 ;
}
return 0 ;
}
...
if ( V_106 < 0 )
return V_106 ;
V_2 -> V_215 = F_3 ( V_2 , V_39 ) ;
for ( V_144 = 0 ; V_144 < V_2 -> V_43 -> V_180 ; V_144 ++ ) {
struct V_6 * V_7 = & V_2 -> V_188 [ V_144 ] ;
struct V_56 * V_216 = & V_7 -> V_217 ;
if ( ! V_7 -> V_35 )
continue;
V_216 -> V_47 = F_6 ( V_7 , V_49 ) ;
V_216 -> V_65 = F_6 ( V_7 , V_64 ) ;
V_216 -> V_61 = F_6 ( V_7 , V_60 ) ;
V_216 -> V_63 = F_6 ( V_7 , V_62 ) ;
V_216 -> V_59 = F_6 ( V_7 , V_58 ) ;
if ( V_2 -> V_43 -> V_66 )
V_216 -> V_68 = F_6 ( V_7 ,
V_67 ) ;
}
...
F_5 ( V_7 , V_67 ,
V_216 -> V_68 ) ;
F_5 ( V_7 , V_58 , V_216 -> V_59 ) ;
F_5 ( V_7 , V_60 , V_216 -> V_61 ) ;
F_5 ( V_7 , V_62 , V_216 -> V_63 ) ;
F_5 ( V_7 , V_64 , V_216 -> V_65 ) ;
F_5 ( V_7 , V_49 ,
( V_216 -> V_47 & ~ V_51 ) ) ;
}
F_77 ( V_16 ) ;
