...
* V_207 = F_114 ( V_18 , V_14 , & V_12 -> V_3 ) ;
return 0 ;
}
static struct V_17 * F_115 ( struct V_17 * V_18 , unsigned long V_199 )
{
struct V_1 * V_12 = (struct V_1 * ) V_199 ;
return V_12 -> V_3 ;
}
static void F_116 ( struct V_17 * V_18 , unsigned long V_199 )
{
struct V_1 * V_12 = (struct V_1 * ) V_199 ;
if ( V_12 -> V_3 -> V_3 . V_58 == 0 )
F_12 ( V_12 ) ;
}
static unsigned long F_117 ( struct V_17 * V_18 , T_1 V_4 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
static void F_118 ( struct V_17 * V_18 , struct V_1 * V_12 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
F_67 ( V_12 -> V_209 ) ;
F_119 ( & V_12 -> V_33 ) ;
...
for ( V_117 = 0 ; V_117 < V_3 -> V_7 . V_119 ; V_117 ++ ) {
F_124 (cl, next, &q->clhash.hash[h],
common.hnode)
F_118 ( V_18 , V_12 ) ;
}
F_125 ( & V_3 -> V_7 ) ;
}
static void F_126 ( struct V_17 * V_18 , unsigned long V_199 )
{
struct V_1 * V_12 = (struct V_1 * ) V_199 ;
if ( -- V_12 -> V_177 == 0 ) {
#ifdef F_10
T_5 * V_212 = F_127 ( V_18 ) ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
F_128 ( V_212 ) ;
if ( V_3 -> V_56 == V_12 )
V_3 -> V_56 = NULL ;
...
static int
F_130 ( struct V_17 * V_18 , T_1 V_4 , T_1 V_213 , struct V_165 * * V_214 ,
unsigned long * V_199 )
{
int V_171 ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
V_222 = V_12 -> V_3 -> V_59 . V_222 ;
F_74 ( V_12 -> V_3 ) ;
F_139 ( V_12 -> V_3 , V_58 , V_222 ) ;
if ( V_12 -> V_47 )
F_12 ( V_12 ) ;
if ( V_3 -> V_105 == V_12 )
V_3 -> V_105 = V_3 -> V_94 ;
...
static struct V_25 T_6 * * F_141 ( struct V_17 * V_18 ,
unsigned long V_199 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_199 ;
...
static unsigned long F_142 ( struct V_17 * V_18 , unsigned long V_131 ,
T_1 V_4 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
static void F_143 ( struct V_17 * V_18 , unsigned long V_199 )
{
struct V_1 * V_12 = (struct V_1 * ) V_199 ;
V_12 -> V_209 -- ;
}
static void F_144 ( struct V_17 * V_18 , struct V_224 * V_199 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 ;
unsigned int V_117 ;
