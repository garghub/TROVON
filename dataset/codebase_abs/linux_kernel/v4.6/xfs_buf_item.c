...
V_9 -> V_26 = F_63 ( V_92 * sizeof( struct V_5 ) ,
V_93 ) ;
if ( ! V_9 -> V_26 )
return - V_94 ;
return 0 ;
...
return 0 ;
V_9 = F_67 ( V_101 , V_93 ) ;
F_68 ( V_96 , & V_9 -> V_4 , V_100 , & V_102 ) ;
V_9 -> V_14 = V_13 ;
error = F_62 ( V_9 , V_13 -> V_103 ) ;
ASSERT ( error == 0 ) ;
if ( error ) {
F_69 ( V_101 , V_9 ) ;
return error ;
...
for ( V_18 = 0 ; V_18 < V_9 -> V_25 ; V_18 ++ ) {
V_97 = F_70 ( F_71 ( V_13 -> V_49 [ V_18 ] . V_50 ) ,
V_17 ) ;
V_98 = F_70 ( V_97 , V_104 ) ;
...
if ( V_121 > V_111 )
break;
V_122 = V_121 + F_71 ( V_13 -> V_49 [ V_18 ] . V_50 ) ;
if ( V_110 > V_122 ) {
V_121 += F_71 ( V_13 -> V_49 [ V_18 ] . V_50 ) ;
continue;
}
if ( V_110 < V_121 )
V_110 = V_121 ;
