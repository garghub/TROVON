...
V_15 = ( ( 1UL ) << V_8 ) ;
if ( ! F_8 ( V_22 ) )
V_13 = F_9 ( V_13 , F_10 ( V_11 ) , V_5 ) ;
if ( F_5 ( V_11 & V_23 ) ) {
unsigned long V_24 , V_16 ;
V_24 = F_11 ( V_10 , V_8 , V_7 ) ;
if ( V_11 & V_25 )
V_24 = ~ V_24 ;
V_16 = ( V_24 & V_26 ) * V_27 ;
V_16 += ( V_11 & V_28 ) >> V_29 ;
...
if ( F_12 ( ! ( V_11 & V_23 ) ) ) {
unsigned long V_24 = F_11 ( V_10 , V_8 , V_7 ) ;
V_14 = F_13 ( F_10 ( V_11 ) ) << V_33 ;
V_12 = ( V_12 & ~ V_32 ) | V_23 ;
V_16 = F_14 ( V_24 , V_10 , V_14 , V_13 , 0 ,
V_9 , V_7 ) ;
if ( F_5 ( V_16 == - 2 ) ) {
* V_4 = F_10 ( V_11 ) ;
...
{
bool V_35 ;
V_35 = ( ( ( V_34 . V_36 & 0x3 ) == 0x0 ) && ( ( V_34 . V_36 & V_37 ) != 0 ) ) ;
F_17 ( V_35 , L_1 ) ;
return 0 ;
}
