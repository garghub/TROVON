...
static unsigned int F_78 ( const union V_139 * V_140 )
{
...
static int F_79 ( struct V_33 * V_34 , void * V_3 )
{
...
int F_80 ( struct V_147 * V_105 , const char * V_148 )
{
struct V_73 * V_74 = F_81 ( V_105 ) ;
...
char V_104 [ 32 ] ;
unsigned int V_13 ;
for ( V_13 = 0 ; V_13 < F_82 ( V_149 ) ; V_13 ++ ) {
...
bool F_84 ( struct V_73 * V_74 , const char * V_148 )
{
...
if ( ! V_90 ) {
V_90 = F_85 ( sizeof( * V_90 ) , V_67 ) ;
if ( V_90 ) {
V_90 -> V_74 = V_74 ;
V_90 -> V_148 = F_86 ( V_148 , V_67 ) ;
