...
if ( F_75 ( V_51 ) == F_109 () )
F_110 ( F_111 ( V_51 ) ) ;
V_97 = F_112 ( V_51 ) - V_33 -> V_100 . V_101 ;
if ( F_94 ( ( T_2 ) V_97 <= 0 ) )
return;
F_113 ( V_33 -> V_100 . V_102 . V_103 ,
F_114 ( V_33 -> V_100 . V_102 . V_103 , V_97 ) ) ;
V_33 -> V_100 . V_104 += V_97 ;
F_115 ( V_33 , V_97 ) ;
V_33 -> V_100 . V_101 = F_112 ( V_51 ) ;
F_116 ( V_33 , V_97 ) ;
F_117 ( V_51 , V_97 ) ;
if ( ! F_12 () )
return;
...
F_122 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_65 ) ;
}
static void
F_123 ( struct V_22 * V_22 , int V_65 , int V_106 )
{
struct V_51 * V_51 = F_27 ( V_22 ) ;
#ifdef F_101
if ( & V_51 -> V_50 != V_22 )
...
F_122 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_22 -> V_32 . V_33 ) ;
}
static inline
void F_121 ( struct V_22 * V_22 , int V_65 , int V_106 ) {}
static inline
void F_123 ( struct V_22 * V_22 , int V_65 , int V_106 ) {}
static void
...
int V_65 = F_104 ( V_49 ) ;
F_126 ( ! F_133 ( V_65 ) ) ;
V_22 -> V_80 += F_130 ( V_49 ) ;
V_22 -> V_110 += F_131 ( V_49 ) ;
F_124 ( V_22 , V_65 ) ;
F_52 ( V_49 , V_22 ) ;
F_128 ( V_49 , V_22 ) ;
}
static inline
void F_134 ( struct V_48 * V_49 , struct V_22 * V_22 )
{
F_126 ( ! F_133 ( F_104 ( V_49 ) ) ) ;
F_126 ( ! V_22 -> V_80 ) ;
V_22 -> V_80 -= F_130 ( V_49 ) ;
V_22 -> V_110 -= F_131 ( V_49 ) ;
F_125 ( V_22 , F_104 ( V_49 ) ) ;
F_53 ( V_49 , V_22 ) ;
F_129 ( V_49 , V_22 ) ;
}
static inline bool F_135 ( unsigned int V_113 )
{
if ( ( V_113 & ( V_114 | V_115 ) ) == V_114 )
return false ;
return true ;
}
static void F_136 ( struct V_48 * V_49 , struct V_23 * V_24 )
{
F_137 ( & V_49 -> V_58 ) ;
if ( F_138 ( V_24 -> V_28 + F_104 ( V_49 ) ) )
F_16 ( F_104 ( V_49 ) , V_24 -> V_29 ) ;
V_49 -> V_116 = 0 ;
}
static void F_139 ( struct V_48 * V_49 , unsigned int V_113 )
{
struct V_22 * V_22 = F_28 ( V_49 ) ;
struct V_23 * V_24 = & V_22 -> V_26 ;
struct V_22 * V_108 = F_73 ( V_49 ) ;
struct V_117 * V_28 = V_24 -> V_28 + F_104 ( V_49 ) ;
if ( V_108 && ( F_82 ( V_108 ) || ! V_108 -> V_80 ) ) {
if ( V_49 -> V_116 )
F_136 ( V_49 , V_24 ) ;
return;
}
...
static void F_143 ( struct V_48 * V_49 , unsigned int V_113 )
{
...
static void F_77 ( struct V_48 * V_49 , unsigned int V_113 )
{
struct V_51 * V_51 = F_29 ( V_49 ) ;
F_143 ( V_49 , V_113 ) ;
F_118 (rt_se)
...
static void F_81 ( struct V_48 * V_49 , unsigned int V_113 )
{
struct V_51 * V_51 = F_29 ( V_49 ) ;
F_143 ( V_49 , V_113 ) ;
F_118 (rt_se) {
...
static void
F_144 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_113 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
if ( V_113 & V_120 )
V_49 -> V_121 = 0 ;
F_77 ( V_49 , V_113 ) ;
if ( ! F_145 ( V_51 , V_63 ) && V_63 -> V_71 > 1 )
F_60 ( V_51 , V_63 ) ;
}
static void F_146 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_113 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
F_108 ( V_51 ) ;
F_81 ( V_49 , V_113 ) ;
...
static void
F_147 ( struct V_22 * V_22 , struct V_48 * V_49 , int V_122 )
{
if ( F_66 ( V_49 ) ) {
struct V_23 * V_24 = & V_22 -> V_26 ;
struct V_117 * V_28 = V_24 -> V_28 + F_104 ( V_49 ) ;
...
static void F_150 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_122 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
struct V_22 * V_22 ;
F_118 (rt_se) {
V_22 = F_28 ( V_49 ) ;
F_147 ( V_22 , V_49 , V_122 ) ;
}
}
static void F_151 ( struct V_51 * V_51 )
{
F_150 ( V_51 , V_51 -> V_33 , 0 ) ;
}
static int
F_152 ( struct V_47 * V_63 , int V_54 , int V_123 , int V_113 )
{
struct V_47 * V_33 ;
struct V_51 * V_51 ;
...
V_51 = F_34 ( V_54 ) ;
F_153 () ;
V_33 = F_154 ( V_51 -> V_33 ) ;
if ( V_33 && F_94 ( F_155 ( V_33 ) ) &&
( V_33 -> V_71 < 2 ||
V_33 -> V_65 <= V_63 -> V_65 ) ) {
int V_127 = F_156 ( V_63 ) ;
if ( V_127 != - 1 &&
...
static void F_158 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
if ( V_51 -> V_33 -> V_71 == 1 ||
! F_159 ( & V_51 -> V_66 -> V_107 , V_51 -> V_33 , NULL ) )
return;
if ( V_63 -> V_71 != 1
&& F_159 ( & V_51 -> V_66 -> V_107 , V_63 , NULL ) )
return;
F_150 ( V_51 , V_63 , 1 ) ;
F_78 ( V_51 ) ;
}
static void F_160 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_113 )
{
...
#ifdef V_31
if ( V_63 -> V_65 == V_51 -> V_33 -> V_65 && ! F_161 ( V_51 -> V_33 ) )
F_158 ( V_51 , V_63 ) ;
#endif
}
static struct V_48 * F_162 ( struct V_51 * V_51 ,
struct V_22 * V_22 )
{
struct V_23 * V_24 = & V_22 -> V_26 ;
...
struct V_117 * V_28 ;
int V_128 ;
V_128 = F_127 ( V_24 -> V_29 ) ;
F_97 ( V_128 >= V_27 ) ;
V_28 = V_24 -> V_28 + V_128 ;
V_34 = F_163 ( V_28 -> V_34 , struct V_48 , V_58 ) ;
return V_34 ;
}
static struct V_47 * F_164 ( struct V_51 * V_51 )
{
struct V_48 * V_49 ;
struct V_47 * V_63 ;
struct V_22 * V_22 = & V_51 -> V_50 ;
do {
V_49 = F_162 ( V_51 , V_22 ) ;
F_97 ( ! V_49 ) ;
V_22 = F_73 ( V_49 ) ;
} while ( V_22 );
V_63 = F_23 ( V_49 ) ;
V_63 -> V_100 . V_101 = F_112 ( V_51 ) ;
return V_63 ;
}
static struct V_47 *
F_165 ( struct V_51 * V_51 , struct V_47 * V_64 )
{
struct V_47 * V_63 ;
struct V_22 * V_22 = & V_51 -> V_50 ;
if ( F_41 ( V_51 , V_64 ) ) {
...
V_75 ( V_51 ) ;
F_167 ( & V_51 -> V_96 ) ;
if ( F_94 ( ( V_51 -> V_129 && F_168 ( V_51 -> V_129 ) ) ||
V_51 -> V_130 . V_131 ) )
return V_132 ;
}
if ( V_64 -> V_98 == & V_99 )
...
static void F_170 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
F_108 ( V_51 ) ;
if ( F_66 ( & V_63 -> V_50 ) && V_63 -> V_71 > 1 )
F_60 ( V_51 , V_63 ) ;
}
static int F_171 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_54 )
{
if ( ! F_172 ( V_51 , V_63 ) &&
F_173 ( V_54 , F_174 ( V_63 ) ) )
return 1 ;
return 0 ;
}
static struct V_47 * F_175 ( struct V_51 * V_51 , int V_54 )
{
struct V_133 * V_122 = & V_51 -> V_50 . V_37 ;
struct V_47 * V_63 ;
if ( ! F_54 ( V_51 ) )
return NULL ;
F_176 (p, head, pushable_tasks) {
if ( F_171 ( V_51 , V_63 , V_54 ) )
return V_63 ;
}
return NULL ;
}
static int F_156 ( struct V_47 * V_134 )
{
struct V_135 * V_136 ;
struct V_82 * V_137 = F_177 ( V_138 ) ;
int V_139 = F_109 () ;
int V_54 = F_178 ( V_134 ) ;
if ( F_94 ( ! V_137 ) )
return - 1 ;
if ( V_134 -> V_71 == 1 )
return - 1 ;
if ( ! F_159 ( & F_40 ( V_134 ) -> V_66 -> V_107 , V_134 , V_137 ) )
return - 1 ;
if ( F_173 ( V_54 , V_137 ) )
return V_54 ;
if ( ! F_173 ( V_139 , V_137 ) )
V_139 = - 1 ;
F_153 () ;
F_179 (cpu, sd) {
if ( V_136 -> V_113 & V_140 ) {
int V_141 ;
if ( V_139 != - 1 &&
F_173 ( V_139 , F_180 ( V_136 ) ) ) {
F_157 () ;
return V_139 ;
}
V_141 = F_181 ( V_137 ,
...
static struct V_51 * F_183 ( struct V_47 * V_134 , struct V_51 * V_51 )
{
struct V_51 * V_142 = NULL ;
int V_143 ;
int V_54 ;
...
break;
V_142 = F_34 ( V_54 ) ;
if ( V_142 -> V_50 . V_32 . V_33 <= V_134 -> V_65 ) {
V_142 = NULL ;
break;
}
if ( F_184 ( V_51 , V_142 ) ) {
if ( F_94 ( F_40 ( V_134 ) != V_51 ||
! F_173 ( V_142 -> V_54 ,
F_174 ( V_134 ) ) ||
F_172 ( V_51 , V_134 ) ||
! F_155 ( V_134 ) ||
...
V_63 = F_65 ( & V_51 -> V_50 . V_37 ,
struct V_47 , V_37 ) ;
F_97 ( V_51 -> V_54 != F_178 ( V_63 ) ) ;
F_97 ( F_145 ( V_51 , V_63 ) ) ;
F_97 ( V_63 -> V_71 <= 1 ) ;
F_97 ( ! F_168 ( V_63 ) ) ;
F_97 ( ! F_155 ( V_63 ) ) ;
return V_63 ;
...
return 0 ;
V_147:
if ( F_94 ( V_145 == V_51 -> V_33 ) ) {
F_126 ( 1 ) ;
return 0 ;
}
if ( F_94 ( V_145 -> V_65 < V_51 -> V_33 -> V_65 ) ) {
F_78 ( V_51 ) ;
return 0 ;
}
F_188 ( V_145 ) ;
V_142 = F_183 ( V_145 , V_51 ) ;
if ( ! V_142 ) {
struct V_47 * V_134 ;
V_134 = F_186 ( V_51 ) ;
if ( F_178 ( V_145 ) == V_51 -> V_54 && V_134 == V_145 ) {
goto V_126;
}
if ( ! V_134 )
goto V_126;
...
{
int V_148 = V_51 -> V_50 . V_39 ;
int V_54 ;
V_54 = F_194 ( V_148 , V_51 -> V_66 -> V_69 ) ;
if ( V_148 < V_51 -> V_54 ) {
if ( V_54 >= V_51 -> V_54 )
return V_40 ;
} else if ( V_54 >= V_40 ) {
...
break;
V_149 = F_34 ( V_54 ) ;
if ( V_149 -> V_50 . V_32 . V_34 < V_51 -> V_50 . V_32 . V_33 )
break;
}
return V_54 ;
}
...
if ( V_54 >= V_40 )
return;
V_51 -> V_50 . V_38 = V_150 ;
F_198 ( & V_51 -> V_50 . V_42 , V_54 ) ;
}
static void F_199 ( void * V_152 )
{
struct V_22 * V_22 = V_152 ;
struct V_51 * V_51 , * V_153 ;
int V_139 ;
int V_54 ;
V_139 = V_22 -> V_39 ;
F_97 ( V_139 != F_109 () ) ;
...
static void V_43 ( struct V_155 * V_156 )
{
struct V_22 * V_22 = F_2 ( V_156 , struct V_22 , V_42 ) ;
F_199 ( V_22 ) ;
}
static void V_75 ( struct V_51 * V_76 )
{
int V_139 = V_76 -> V_54 , V_54 ;
bool V_157 = false ;
struct V_47 * V_63 ;
struct V_51 * V_153 ;
if ( F_106 ( ! F_42 ( V_76 ) ) )
...
continue;
V_153 = F_34 ( V_54 ) ;
if ( V_153 -> V_50 . V_32 . V_34 >=
V_76 -> V_50 . V_32 . V_33 )
continue;
F_184 ( V_76 , V_153 ) ;
V_63 = F_175 ( V_153 , V_139 ) ;
if ( V_63 && ( V_63 -> V_65 < V_76 -> V_50 . V_32 . V_33 ) ) {
F_126 ( V_63 == V_153 -> V_33 ) ;
F_126 ( ! F_168 ( V_63 ) ) ;
if ( V_63 -> V_65 < V_153 -> V_33 -> V_65 )
goto V_159;
V_157 = true ;
F_190 ( V_153 , V_63 , 0 ) ;
F_191 ( V_63 , V_139 ) ;
...
! F_161 ( V_51 -> V_33 ) &&
V_63 -> V_71 > 1 &&
( F_202 ( V_51 -> V_33 ) || F_155 ( V_51 -> V_33 ) ) &&
( V_51 -> V_33 -> V_71 < 2 ||
...
F_44 ( V_51 ) ;
F_98 ( V_51 ) ;
F_122 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_51 -> V_50 . V_32 . V_33 ) ;
}
...
F_48 ( V_51 ) ;
F_93 ( V_51 ) ;
F_122 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_160 ) ;
}
static void F_205 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
if ( ! F_168 ( V_63 ) || V_51 -> V_50 . V_80 )
return;
F_59 ( V_51 ) ;
}
void T_4 F_206 ( void )
...
static void
F_209 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_161 )
{
if ( ! F_168 ( V_63 ) )
return;
if ( V_51 -> V_33 == V_63 ) {
...
V_162 = F_211 ( V_63 , V_164 ) ;
V_163 = F_212 ( V_63 , V_164 ) ;
if ( V_162 != V_165 ) {
unsigned long V_34 ;
if ( V_63 -> V_50 . V_166 != V_167 ) {
V_63 -> V_50 . V_121 ++ ;
V_63 -> V_50 . V_166 = V_167 ;
}
V_34 = F_213 ( F_102 ( V_162 , V_163 ) , V_168 / V_169 ) ;
if ( V_63 -> V_50 . V_121 > V_34 )
V_63 -> V_170 . V_171 = V_63 -> V_100 . V_104 ;
}
}
static void F_214 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_172 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
F_108 ( V_51 ) ;
F_210 ( V_51 , V_63 ) ;
...
static unsigned int F_216 ( struct V_51 * V_51 , struct V_47 * V_134 )
{
if ( V_134 -> V_111 == V_112 )
return V_174 ;
else
return 0 ;
}
void F_217 ( struct V_175 * V_176 , int V_54 )
{
T_3 V_87 ;
struct V_22 * V_22 ;
F_153 () ;
F_95 (rt_rq, iter, cpu_rq(cpu))
F_218 ( V_176 , V_54 , V_22 ) ;
F_157 () ;
}
