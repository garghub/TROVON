...
F_24 ( struct V_10 * V_10 , T_4 * V_9 , const char
* V_41 , const char * * V_42 , T_2 V_43 ,
T_2 V_12 , const struct V_44 * V_31 )
{
struct V_3 * V_4 ;
struct V_36 * V_36 = NULL ;
struct V_45 V_46 ;
V_4 = F_25 ( sizeof( * V_4 ) , V_47 ) ;
if ( ! V_4 )
return F_26 ( - V_48 ) ;
V_46 . V_41 = V_41 ;
V_46 . V_49 = & V_50 ;
...
void T_3 F_30 ( struct V_53 * V_54 )
{
int V_55 ;
T_1 V_12 ;
const char * V_41 ;
struct V_36 * V_36 ;
unsigned int V_43 ;
const char * V_42 [ V_56 ] ;
struct V_53 * V_57 ;
struct V_44 V_31 = F_31 ( 0 , 0 ) ;
struct V_10 * V_10 ;
V_43 = F_32 ( V_54 ) ;
if ( V_43 == 0 || V_43 > V_56 )
return;
...
return;
F_37 (np, gcknp) {
if ( F_38 ( V_57 , L_3 , & V_12 ) )
continue;
if ( V_12 < V_59 || V_12 >= V_58 )
continue;
if ( F_39 ( V_54 , L_4 , & V_41 ) )
V_41 = V_57 -> V_41 ;
F_40 ( V_57 , L_5 ,
& V_31 ) ;
V_36 = F_24 ( V_10 , & V_60 , V_41 ,
V_42 , V_43 ,
V_12 , & V_31 ) ;
if ( F_28 ( V_36 ) )
continue;
