...
if ( F_13 ( V_25 -> V_29 ) )
return - V_22 ;
V_27 = F_14 ( V_25 -> V_19 , L_8 , NULL , & V_26 ) ;
if ( F_15 ( V_27 ) || ! ( V_26 & V_30 ) )
return - V_22 ;
F_16 () ;
F_17 () ;
...
static inline int F_12 ( struct V_24 * V_25 )
{
return - V_22 ;
}
...
F_2 ( ( V_7 ,
L_11 ) ) ;
if ( ! strcmp ( F_23 ( V_36 ) , V_49 ) ) {
V_27 = F_24 ( V_25 -> V_19 , NULL , NULL , & V_40 ) ;
if ( F_15 ( V_27 ) ) {
F_25 ( & V_36 -> V_2 ,
L_12 ,
V_27 ) ;
...
V_25 -> V_29 = F_26 ( V_25 -> V_19 , V_41 ,
V_25 -> V_50 ) ;
if ( F_13 ( V_25 -> V_29 ) )
F_27 ( V_25 -> V_19 , L_14 ) ;
V_25 -> V_31 = F_28 ( V_25 -> V_29 , V_25 -> V_50 ) ;
if ( ! V_43 && ! F_29 () ) {
V_43 = 1 ;
if ( F_30 ( V_25 -> V_31 ) && ( F_31 () == 1 ) )
V_25 -> V_31 = 0 ;
}
if ( F_30 ( V_25 -> V_31 ) ) {
int V_28 = F_12 ( V_25 ) ;
...
sprintf ( F_32 ( V_36 ) , L_15 , V_25 -> V_31 ) ;
...
F_33 ( V_25 -> V_56 . V_57 , 6 , L_19 ) ;
}
V_27 = F_14 ( V_25 -> V_19 , L_20 , NULL , & V_44 ) ;
if ( F_34 ( V_27 ) )
F_35 ( V_25 -> V_31 , V_44 ) ;
return 0 ;
}
...
struct V_36 * V_2 ;
int V_17 = 0 ;
V_25 = F_37 ( sizeof( struct V_24 ) , V_62 ) ;
if ( ! V_25 )
return - V_63 ;
if ( ! F_38 ( & V_25 -> V_56 . V_64 , V_62 ) ) {
V_17 = - V_63 ;
goto V_65;
}
V_25 -> V_19 = V_36 -> V_19 ;
strcpy ( F_39 ( V_36 ) , V_66 ) ;
strcpy ( F_40 ( V_36 ) , V_67 ) ;
V_36 -> V_68 = V_25 ;
V_17 = F_21 ( V_36 ) ;
if ( V_17 )
return 0 ;
...
#endif
F_42 ( V_25 -> V_31 >= V_70 ) ;
if ( F_43 ( V_71 , V_25 -> V_31 ) != NULL &&
F_43 ( V_71 , V_25 -> V_31 ) != V_36 ) {
F_44 ( & V_36 -> V_2 ,
L_21 ,
V_25 -> V_31 ) ;
goto V_72;
...
static int F_62 ( struct V_35 * V_2 ,
const struct V_61 * V_31 )
{
return 1 ;
}
