...
F_49 ( V_102 , F_50 ( V_102 ) , V_115 ) ;
} else {
V_102 -> V_10 = V_63 -> V_10 ;
}
F_51 ( V_102 , ! F_52 ( V_63 -> V_59 , F_53 ( V_63 -> V_10 ) ) ) ;
...
V_77 , V_137 , V_117 , ! F_52 ( V_63 -> V_59 , F_53 ( V_10 ) ) ) ;
...
struct V_60 * V_61 )
{
struct V_59 * V_59 = F_53 ( V_2 -> V_56 ) ;
...
void F_114 ( struct V_9 * V_10 , int V_198 )
{
struct V_40 * V_63 = F_12 ( V_10 ) ;
V_63 -> V_163 = V_198 ;
}
