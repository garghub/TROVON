...
if ( V_177 -> V_45 == V_179 )
continue;
V_115 = F_48 ( V_178 -> V_183 -> V_45 , V_179 ,
& V_25 -> V_28 ) ;
if ( V_115 == - V_184 )
V_115 = V_178 -> V_185 ;
else
...
if ( V_115 == 0 )
continue;
V_180 = F_48 ( V_177 -> V_45 , V_179 ,
& V_177 -> V_28 ) ;
if ( V_180 == - V_184 ) {
V_7 = - V_51 ;
break;
}
V_181 = F_48 ( V_177 -> V_45 , V_179 ,
& V_25 -> V_28 ) ;
if ( V_181 != - V_184 )
V_180 &= V_181 ;
...
int V_351 ;
int V_352 ;
if ( ( V_232 -> V_72 & V_353 ) != 0 ) {
F_47 () ;
F_128 (skp, &smack_known_list, list) {
if ( V_232 -> V_354 . V_355 . V_356 != V_9 -> V_231 . V_354 . V_355 . V_356 )
continue;
...
for ( V_351 = - 1 , V_352 = - 1 ; V_351 == V_352 ; ) {
V_351 = F_180 (
V_232 -> V_354 . V_355 . V_358 , V_351 + 1 ) ;
V_352 = F_180 (
V_9 -> V_231 . V_354 . V_355 . V_358 ,
V_352 + 1 ) ;
if ( V_351 < 0 || V_352 < 0 )
break;
}
...
if ( ( V_232 -> V_72 & V_359 ) != 0 ) {
V_9 = F_95 ( V_232 -> V_354 . V_163 ) ;
F_181 ( V_9 == NULL ) ;
return V_9 ;
}
return V_228 ;
}
static int F_182 ( struct V_360 * V_361 , struct V_248 * V_216 )
{
T_8 V_362 ;
int V_363 ;
int V_364 = - V_140 ;
...
V_216 -> V_254 = 0 ;
V_363 = F_183 ( V_361 ) ;
V_367 = F_184 ( V_361 , V_363 , sizeof( V_366 ) , & V_366 ) ;
if ( V_367 == NULL )
return - V_140 ;
V_216 -> V_262 = V_367 -> V_267 ;
V_362 = V_367 -> V_362 ;
V_363 += sizeof( V_366 ) ;
V_363 = F_185 ( V_361 , V_363 , & V_362 , & V_368 ) ;
if ( V_363 < 0 )
return - V_140 ;
V_364 = V_362 ;
switch ( V_364 ) {
case V_378 :
V_371 = F_184 ( V_361 , V_363 , sizeof( V_370 ) , & V_370 ) ;
if ( V_371 != NULL )
V_216 -> V_254 = V_371 -> V_379 ;
break;
case V_380 :
V_374 = F_184 ( V_361 , V_363 , sizeof( V_373 ) , & V_373 ) ;
if ( V_374 != NULL )
V_216 -> V_254 = V_374 -> V_379 ;
break;
case V_381 :
V_377 = F_184 ( V_361 , V_363 , sizeof( V_376 ) , & V_376 ) ;
if ( V_377 != NULL )
V_216 -> V_254 = V_377 -> V_382 ;
break;
}
return V_364 ;
}
static int F_186 ( struct V_150 * V_156 , struct V_360 * V_361 )
{
struct V_349 V_383 ;
struct V_147 * V_148 = V_156 -> V_157 ;
struct V_1 * V_9 ;
...
case V_269 :
F_187 ( & V_383 ) ;
V_7 = F_188 ( V_361 , V_156 -> V_230 , & V_383 ) ;
if ( V_7 == 0 )
V_9 = F_179 ( & V_383 , V_148 ) ;
else
V_9 = V_228 ;
F_189 ( & V_383 ) ;
#ifdef F_125
F_126 ( & V_42 , V_43 , V_237 , & V_236 ) ;
V_42 . V_238 . V_239 . V_236 -> V_212 = V_156 -> V_230 ;
V_42 . V_238 . V_239 . V_236 -> V_385 = V_361 -> V_386 ;
F_190 ( V_361 , & V_42 . V_238 , NULL ) ;
#endif
...
break;
case V_271 :
V_7 = F_182 ( V_361 , & V_384 ) ;
if ( V_7 == V_380 || V_7 == V_378 )
V_7 = F_131 ( V_156 , & V_384 , V_261 ) ;
else
V_7 = 0 ;
break;
}
...
if ( V_148 -> V_214 != NULL ) {
V_389 = V_148 -> V_214 ;
V_340 = strlen ( V_389 ) + 1 ;
}
if ( V_340 > V_112 )
V_7 = - V_390 ;
else if ( F_193 ( V_387 , V_389 , V_340 ) != 0 )
V_7 = - V_391 ;
if ( F_194 ( V_340 , V_388 ) != 0 )
V_7 = - V_391 ;
return V_7 ;
}
static int F_195 ( struct V_149 * V_150 ,
struct V_360 * V_361 , T_3 * V_163 )
{
struct V_349 V_383 ;
...
int V_7 ;
if ( V_361 != NULL ) {
if ( V_361 -> V_272 == F_196 ( V_394 ) )
V_212 = V_269 ;
else if ( V_361 -> V_272 == F_196 ( V_395 ) )
V_212 = V_271 ;
}
if ( V_212 == V_392 && V_150 != NULL )
V_212 = V_150 -> V_156 -> V_230 ;
if ( V_212 == V_396 ) {
V_148 = V_150 -> V_156 -> V_157 ;
V_393 = V_148 -> V_161 -> V_206 ;
} else if ( V_212 == V_269 || V_212 == V_271 ) {
if ( V_150 != NULL && V_150 -> V_156 != NULL )
V_148 = V_150 -> V_156 -> V_157 ;
F_187 ( & V_383 ) ;
V_7 = F_188 ( V_361 , V_212 , & V_383 ) ;
if ( V_7 == 0 ) {
V_9 = F_179 ( & V_383 , V_148 ) ;
V_393 = V_9 -> V_206 ;
}
...
static void F_197 ( struct V_150 * V_156 , struct V_149 * V_397 )
{
struct V_147 * V_148 ;
struct V_1 * V_9 = F_22 () ;
if ( V_156 == NULL ||
...
static int F_198 ( struct V_150 * V_156 , struct V_360 * V_361 ,
struct V_398 * V_399 )
{
...
if ( V_7 != 0 )
return V_7 ;
V_399 -> V_405 = V_9 -> V_206 ;
V_402 = F_199 ( V_361 ) ;
V_400 . V_221 . V_222 = V_402 -> V_267 ;
F_47 () ;
V_403 = F_116 ( & V_400 ) ;
F_49 () ;
if ( V_403 == NULL )
V_7 = F_200 ( V_399 , & V_9 -> V_231 ) ;
else
F_201 ( V_399 ) ;
return V_7 ;
}
...
struct V_1 * V_9 ;
if ( V_399 -> V_405 != 0 ) {
V_9 = F_95 ( V_399 -> V_405 ) ;
V_148 -> V_214 = V_9 -> V_45 ;
} else
V_148 -> V_214 = NULL ;
}
static int F_203 ( struct V_406 * V_406 , const struct V_99 * V_99 ,
unsigned long V_72 )
{
struct V_1 * V_9 = F_14 ( V_99 -> V_100 ) ;
V_406 -> V_100 = V_9 -> V_45 ;
return 0 ;
}
static void F_204 ( struct V_406 * V_406 )
{
V_406 -> V_100 = NULL ;
}
static int F_205 ( T_10 V_407 ,
const struct V_99 * V_99 , T_11 V_408 )
{
struct V_406 * V_409 ;
struct V_41 V_42 ;
...
return - V_51 ;
#ifdef F_125
F_16 ( & V_42 , V_43 , V_410 ) ;
V_42 . V_238 . V_239 . V_411 . V_406 = V_409 -> V_412 ;
V_42 . V_238 . V_239 . V_411 . V_413 = V_409 -> V_414 ;
#endif
return V_185 ( V_190 , V_409 -> V_100 , V_46 , & V_42 ) ;
}
static int F_207 ( T_3 V_415 , T_3 V_78 , char * V_416 , void * * V_417 )
{
char * * V_418 = ( char * * ) V_417 ;
* V_418 = NULL ;
if ( V_415 != V_419 && V_415 != V_420 )
return - V_140 ;
if ( V_78 != V_421 && V_78 != V_422 )
return - V_140 ;
* V_418 = F_30 ( V_416 , 0 ) ;
return 0 ;
}
static int F_208 ( struct V_423 * V_424 )
{
struct V_425 * V_426 ;
int V_427 ;
for ( V_427 = 0 ; V_427 < V_424 -> V_428 ; V_427 ++ ) {
V_426 = & V_424 -> V_429 [ V_427 ] ;
if ( V_426 -> type == V_419 || V_426 -> type == V_420 )
return 1 ;
}
return 0 ;
}
static int F_209 ( T_3 V_163 , T_3 V_415 , T_3 V_78 , void * V_417 ,
struct V_430 * V_431 )
{
struct V_1 * V_9 ;
char * V_418 = V_417 ;
if ( ! V_418 ) {
F_210 ( V_431 , V_432 , V_433 ,
L_5 ) ;
return - V_184 ;
}
if ( V_415 != V_419 && V_415 != V_420 )
...
V_9 = F_95 ( V_163 ) ;
if ( V_78 == V_421 )
return ( V_418 == V_9 -> V_45 ) ;
if ( V_78 == V_422 )
return ( V_418 != V_9 -> V_45 ) ;
return 0 ;
}
static void F_211 ( void * V_417 )
{
}
...
static int F_213 ( T_3 V_163 , char * * V_434 , T_3 * V_435 )
{
struct V_1 * V_9 = F_95 ( V_163 ) ;
if ( V_434 )
* V_434 = V_9 -> V_45 ;
* V_435 = strlen ( V_9 -> V_45 ) ;
return 0 ;
}
static int F_214 ( const char * V_434 , T_3 V_435 , T_3 * V_163 )
{
* V_163 = F_70 ( V_434 ) ;
return 0 ;
}
static void F_215 ( char * V_434 , T_3 V_435 )
{
}
static int F_216 ( struct V_3 * V_3 , void * V_436 , T_3 V_437 )
{
return F_132 ( V_3 , V_116 , V_436 , V_437 , 0 ) ;
}
static int F_217 ( struct V_5 * V_5 , void * V_436 , T_3 V_437 )
{
return F_218 ( V_5 , V_134 , V_436 , V_437 , 0 ) ;
}
static int F_219 ( struct V_3 * V_3 , void * * V_436 , T_3 * V_437 )
{
int V_112 = 0 ;
V_112 = F_66 ( V_3 , V_116 , V_436 , true ) ;
if ( V_112 < 0 )
return V_112 ;
* V_437 = V_112 ;
return 0 ;
