...
if ( F_91 ( & V_170 -> V_2 ) ) {
struct V_186 * V_187 = F_91 ( & V_170 -> V_2 ) ;
memcpy ( V_43 -> V_139 , V_187 -> V_188 , V_189 ) ;
...
{
const T_7 * V_94 ;
V_94 = F_93 ( V_170 -> V_2 . V_190 ,
L_27 ,
NULL ) ;
if ( V_94 )
memcpy ( V_43 -> V_139 , V_94 , V_189 ) ;
}
#endif
}
if ( ! F_66 ( V_43 -> V_139 ) )
...
snprintf ( V_60 -> V_119 -> V_193 , V_194 , L_29 ,
V_60 -> V_119 -> V_124 , V_170 -> V_193 ) ;
V_60 -> V_119 -> V_195 = F_36 ;
V_60 -> V_119 -> V_196 = F_39 ;
V_60 -> V_119 -> V_197 = F_40 ;
V_60 -> V_119 -> V_60 = V_60 ;
V_60 -> V_119 -> V_87 = F_96 ( sizeof( int ) * V_133 , V_185 ) ;
if ( ! V_60 -> V_119 -> V_87 ) {
V_44 = - V_177 ;
goto V_198;
}
for ( V_104 = 0 ; V_104 < V_133 ; V_104 ++ )
V_60 -> V_119 -> V_87 [ V_104 ] = V_199 ;
V_44 = F_97 ( V_60 -> V_119 ) ;
if ( V_44 ) {
F_15 ( & V_43 -> V_2 , L_30 ) ;
goto V_198;
}
...
static int F_111 ( struct V_169 * V_170 , T_8 V_206 )
{
return - V_138 ;
}
