...
F_51 ( L_59 , 0 , V_196 ) ;
F_4 ( V_197 , L_60 , F_2 () ) ;
V_195 = V_198 + sizeof( struct V_164 ) + sizeof( struct V_188 ) ;
V_193 = calloc ( 1 , V_195 ) ;
...
V_183 = V_207 ;
if ( F_54 ( V_8 , V_208 , V_209 , & V_183 , sizeof( V_183 ) ) < 0 ) {
F_4 ( V_10 , L_65 , V_11 , strerror ( V_11 ) ) ;
F_12 ( V_8 ) ;
exit ( V_12 ) ;
}
V_172 = (struct V_164 * ) V_193 ;
V_172 -> V_210 . V_211 = V_207 ;
V_172 -> V_210 . V_212 = V_213 ;
V_189 = (struct V_188 * ) V_172 -> V_214 ;
V_189 -> V_215 . V_216 = V_217 ;
V_172 -> V_218 = 0 ;
...
V_185 . V_8 = V_8 ;
while ( 1 ) {
struct V_206 * V_219 = (struct V_206 * ) & V_92 ;
T_4 V_220 = sizeof( V_92 ) ;
V_185 . V_221 = V_222 ;
V_185 . V_223 = 0 ;
if ( F_55 ( & V_185 , 1 , - 1 ) < 0 ) {
...
V_73 = F_56 ( V_8 , V_194 , V_195 , 0 ,
V_219 , & V_220 ) ;
if ( V_73 < 0 ) {
F_4 ( V_10 , L_68 ,
V_92 . V_204 , V_11 , strerror ( V_11 ) ) ;
F_12 ( V_8 ) ;
return - 1 ;
}
if ( V_92 . V_204 ) {
...
V_186 = (struct V_166 * ) V_194 ;
if ( V_186 -> V_168 != V_169 )
continue;
V_187 = (struct V_164 * ) F_57 ( V_186 ) ;
V_189 = (struct V_188 * ) V_187 -> V_214 ;
V_103 = V_189 -> V_215 . V_216 ;
V_1 = V_189 -> V_215 . V_1 ;
V_189 -> error = V_226 ;
if ( ( V_227 ) && ( V_103 == V_217 ) ) {
V_227 = 0 ;
V_44 = ( char * ) V_189 -> V_228 . V_229 . V_230 ;
...
switch ( V_103 ) {
case V_123 :
V_192 = & V_189 -> V_228 . V_192 ;
V_64 =
F_25 ( ( char * ) V_192 -> V_232 ) ;
if ( V_64 == NULL ) {
V_189 -> error = V_102 ;
break;
}
...
case V_235 :
if ( F_14 ( V_1 ,
V_189 -> V_228 . V_236 . V_214 . V_34 ,
V_189 -> V_228 . V_236 . V_214 . V_35 ,
V_189 -> V_228 . V_236 . V_214 . V_38 ,
V_189 -> V_228 . V_236 . V_214 . V_39 ) )
V_189 -> error = V_237 ;
break;
case V_238 :
if ( F_15 ( V_1 ,
...
case V_239 :
if ( F_13 ( V_1 ,
V_189 -> V_228 . V_240 . V_34 ,
V_189 -> V_228 . V_240 . V_35 ) )
V_189 -> error = V_237 ;
break;
default:
break;
...
if ( V_1 != V_242 ) {
if ( F_16 ( V_1 ,
V_189 -> V_228 . V_243 . V_42 ,
V_189 -> V_228 . V_243 . V_214 . V_34 ,
V_40 ,
V_189 -> V_228 . V_243 . V_214 . V_38 ,
V_41 ) )
V_189 -> error = V_237 ;
goto V_241;
}
V_189 = (struct V_188 * ) V_187 -> V_214 ;
V_191 = ( char * ) V_189 -> V_228 . V_243 . V_214 . V_34 ;
V_190 = ( char * ) V_189 -> V_228 . V_243 . V_214 . V_38 ;
switch ( V_189 -> V_228 . V_243 . V_42 ) {
case V_244 :
F_43 ( V_190 ,
V_41 ) ;
strcpy ( V_191 , L_71 ) ;
...
V_241:
V_187 -> V_210 . V_211 = V_207 ;
V_187 -> V_210 . V_212 = V_213 ;
V_187 -> V_218 = 0 ;
