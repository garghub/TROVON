...
static inline void F_92 ( char * * V_164 , int V_18 )
{
int V_165 ;
...
static inline bool F_93 ( void * V_47 )
{
return V_47 == NULL ;
}
...
goto V_181;
if ( F_97 ( V_176 ) ) {
V_164 [ V_170 ] = F_98 ( V_67 ) ;
if ( ! V_164 [ V_170 ] )
goto V_181;
V_167 [ V_170 ] = F_98 ( V_174 ) ;
if ( ! V_167 [ V_170 ] ) {
free ( V_164 [ V_170 ] ) ;
F_99 ( L_37 ) ;
fclose ( V_178 ) ;
...
F_100 ( V_169 ) ;
if ( V_170 ) {
V_171 = F_101 ( V_170 , V_164 ) ;
if ( V_171 < V_170 && V_171 >= 0 ) {
V_168 = F_98 ( V_167 [ V_171 ] ) ;
if ( V_168 ) {
if ( V_182 )
free ( ( void * ) V_183 ) ;
V_183 = V_168 ;
...
static int F_102 ( struct V_113 * V_114 , int V_51 ,
...
V_12 -> V_228 = true ;
V_148 = F_113 ( V_12 , V_114 , V_39 ) ;
V_12 -> V_228 = false ;
if ( ( V_148 == 'q' || V_148 == F_111 ( 'c' ) )
&& V_197 != - 2 && V_196 != - 2 )
goto V_226;
...
void * V_130 , int V_76 )
{
struct V_233 * V_234 = F_67 ( V_2 ,
struct V_233 , V_3 ) ;
struct V_113 * V_114 = F_123 ( V_130 , struct V_113 , V_17 ) ;
bool V_107 = F_47 ( V_2 , V_76 ) ;
unsigned long V_51 = V_114 -> V_5 . V_49 . V_51 [ V_157 ] ;
const char * V_37 = F_124 ( V_114 ) ;
char V_62 [ 256 ] , V_153 ;
...
V_159 = F_123 ( V_240 -> V_35 . V_27 , struct V_113 , V_17 ) ;
else
V_159 = F_123 ( V_159 -> V_17 . V_27 , struct V_113 , V_17 ) ;
goto V_243;
case V_204 :
if ( V_159 -> V_17 . V_244 == & V_240 -> V_35 )
V_159 = F_123 ( V_240 -> V_35 . V_244 , struct V_113 , V_17 ) ;
else
V_159 = F_123 ( V_159 -> V_17 . V_244 , struct V_113 , V_17 ) ;
goto V_243;
case V_217 :
if ( ! F_110 ( & V_234 -> V_3 ,
L_65 ) )
...
static bool F_128 ( struct V_36 * T_7 V_245 ,
void * V_130 )
{
struct V_113 * V_114 = F_123 ( V_130 , struct V_113 , V_17 ) ;
if ( V_101 . V_110 && ! F_129 ( V_114 ) )
return true ;
return false ;
}
static int F_130 ( struct V_239 * V_240 ,
...
const char * V_37 = F_124 ( V_159 ) ;
T_2 V_250 = strlen ( V_37 ) + 7 ;
if ( V_234 . V_3 . V_4 < V_250 )
V_234 . V_3 . V_4 = V_250 ;
}
return F_126 ( & V_234 , V_6 , V_238 , V_39 ) ;
}
int F_131 ( struct V_239 * V_240 , const char * V_238 ,
struct V_38 * V_39 ,
float V_44 ,
struct V_186 * V_187 )
{
...
V_251:
if ( V_6 == 1 ) {
struct V_113 * V_25 = F_123 ( V_240 -> V_35 . V_27 ,
struct V_113 , V_17 ) ;
const char * V_37 = F_124 ( V_25 ) ;
return F_102 ( V_25 , V_6 , V_238 ,
