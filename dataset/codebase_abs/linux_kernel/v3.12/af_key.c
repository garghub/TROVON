...
V_164 -> V_181 . V_197 = F_79 (unsigned int, sa->sadb_sa_replay,
...
V_168 = V_108 [ V_227 - 1 ] ;
if ( V_168 != NULL ) {
V_164 -> V_229 . V_230 = F_80 ( V_168 -> V_228 ) ;
V_164 -> V_229 . V_232 = F_80 ( V_168 -> V_231 ) ;
V_164 -> V_229 . V_234 = V_168 -> V_233 ;
V_164 -> V_229 . V_236 = V_168 -> V_235 ;
}
V_168 = V_108 [ V_237 - 1 ] ;
if ( V_168 != NULL ) {
V_164 -> V_229 . V_238 = F_80 ( V_168 -> V_228 ) ;
V_164 -> V_229 . V_239 = F_80 ( V_168 -> V_231 ) ;
...
if ( V_135 -> V_208 ) {
int V_291 = 0 ;
struct V_209 * V_210 = F_83 ( V_135 -> V_208 ) ;
...
int V_291 = 0 ;
struct V_209 * V_210 = F_85 ( V_135 -> V_215 ) ;
if ( ! V_210 || ! V_210 -> V_212 ) {
V_23 = - V_292 ;
goto V_35;
}
...
memset ( & V_180 -> V_301 , 0 , sizeof( V_180 -> V_301 ) ) ;
}
V_23 = F_86 ( V_164 ) ;
if ( V_23 )
goto V_35;
V_164 -> V_198 . V_302 = V_59 -> V_62 ;
return V_164 ;
V_35:
V_164 -> V_198 . V_199 = V_303 ;
F_87 ( V_164 ) ;
return F_68 ( V_23 ) ;
}
...
static int F_89 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
struct V_41 * V_305 ;
struct V_171 * V_172 ;
...
switch ( V_134 ) {
case V_85 :
V_312 = ( T_4 * ) & ( (struct V_80 * ) ( V_251 + 1 ) ) -> V_138 . V_106 ;
V_311 = ( T_4 * ) & ( (struct V_80 * ) ( V_184 + 1 ) ) -> V_138 . V_106 ;
break;
#if F_45 ( V_81 )
case V_88 :
V_312 = ( T_4 * ) & ( (struct V_82 * ) ( V_251 + 1 ) ) -> V_140 ;
V_311 = ( T_4 * ) & ( (struct V_82 * ) ( V_184 + 1 ) ) -> V_140 ;
break;
#endif
}
if ( V_59 -> V_62 ) {
V_164 = F_90 ( V_10 , V_146 , V_59 -> V_62 ) ;
if ( V_164 && ! F_69 ( & V_164 -> V_194 . V_251 , V_312 , V_134 ) ) {
F_87 ( V_164 ) ;
V_164 = NULL ;
}
}
if ( ! V_164 )
V_164 = F_91 ( V_10 , & V_313 , V_148 , V_269 , V_133 , V_312 , V_311 , 1 , V_134 ) ;
if ( V_164 == NULL )
return - V_314 ;
V_309 = 0x100 ;
V_310 = 0x0fffffff ;
...
V_23 = F_92 ( V_164 , V_309 , V_310 ) ;
V_305 = V_23 ? F_68 ( V_23 ) : F_75 ( V_164 ) ;
if ( F_93 ( V_305 ) ) {
F_87 ( V_164 ) ;
return F_94 ( V_305 ) ;
}
V_306 = (struct V_58 * ) V_305 -> V_61 ;
V_306 -> V_318 = V_59 -> V_318 ;
V_306 -> V_319 = V_320 ;
V_306 -> V_145 = F_54 ( V_133 ) ;
V_306 -> V_63 = 0 ;
V_306 -> V_321 = 0 ;
V_306 -> V_62 = V_59 -> V_62 ;
V_306 -> V_322 = V_59 -> V_322 ;
F_87 ( V_164 ) ;
F_34 ( V_305 , V_33 , V_57 , V_3 , V_10 ) ;
return 0 ;
}
static int F_95 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
struct V_142 * V_164 ;
...
V_164 -> V_198 . V_199 = V_324 ;
F_97 ( & V_10 -> V_325 . V_326 ) ;
}
F_98 ( & V_164 -> V_323 ) ;
F_87 ( V_164 ) ;
return 0 ;
...
static int F_101 ( struct V_142 * V_164 , const struct V_343 * V_344 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
V_8 = F_75 ( V_164 ) ;
...
V_59 -> V_318 = V_29 ;
V_59 -> V_319 = F_100 ( V_344 -> V_327 ) ;
V_59 -> V_145 = F_54 ( V_164 -> V_194 . V_133 ) ;
V_59 -> V_63 = 0 ;
V_59 -> V_321 = 0 ;
V_59 -> V_62 = V_344 -> V_302 ;
V_59 -> V_322 = V_344 -> V_345 ;
F_34 ( V_8 , V_64 , V_53 , NULL , F_102 ( V_164 ) ) ;
return 0 ;
}
static int F_103 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
struct V_142 * V_164 ;
int V_23 ;
...
V_344 . V_327 = V_339 ;
V_344 . V_302 = V_59 -> V_62 ;
V_344 . V_345 = V_59 -> V_322 ;
F_111 ( V_164 , & V_344 ) ;
V_35:
F_87 ( V_164 ) ;
return V_23 ;
}
static int F_112 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
struct V_142 * V_164 ;
struct V_343 V_344 ;
...
F_111 ( V_164 , & V_344 ) ;
V_35:
F_116 ( V_164 , V_23 ? 0 : 1 ,
F_108 ( V_346 ) ,
F_109 ( V_346 ) , 0 ) ;
F_87 ( V_164 ) ;
return V_23 ;
}
static int F_117 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
T_8 V_133 ;
struct V_41 * V_347 ;
...
V_306 -> V_62 = V_59 -> V_62 ;
V_306 -> V_322 = V_59 -> V_322 ;
F_34 ( V_347 , V_64 , V_57 , V_3 , F_7 ( V_3 ) ) ;
return 0 ;
}
...
struct V_41 * V_8 ;
struct V_58 * V_59 ;
int V_47 , V_349 , V_350 , V_351 ;
V_349 = F_119 () ;
if ( V_349 ) {
V_349 *= sizeof( struct V_352 ) ;
V_349 += sizeof( struct V_353 ) ;
}
V_350 = F_120 () ;
if ( V_350 ) {
V_350 *= sizeof( struct V_352 ) ;
V_350 += sizeof( struct V_353 ) ;
}
V_47 = V_350 + V_349 + sizeof( struct V_58 ) ;
...
struct V_353 * V_77 ;
struct V_352 * V_355 ;
V_77 = (struct V_353 * ) F_43 ( V_8 , V_349 ) ;
V_355 = (struct V_352 * ) ( V_77 + 1 ) ;
V_77 -> V_356 = V_349 / sizeof( V_74 ) ;
V_77 -> V_357 = V_358 ;
for ( V_351 = 0 ; ; V_351 ++ ) {
struct V_209 * V_185 = F_121 ( V_351 ) ;
if ( ! V_185 )
break;
if ( ! V_185 -> V_212 )
continue;
...
struct V_353 * V_77 ;
struct V_352 * V_355 ;
V_77 = (struct V_353 * ) F_43 ( V_8 , V_350 ) ;
V_355 = (struct V_352 * ) ( V_77 + 1 ) ;
V_77 -> V_356 = V_350 / sizeof( V_74 ) ;
V_77 -> V_357 = V_360 ;
for ( V_351 = 0 ; ; V_351 ++ ) {
struct V_209 * V_187 = F_122 ( V_351 ) ;
if ( ! V_187 )
break;
if ( ! V_187 -> V_212 )
continue;
...
static int F_123 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_1 * V_6 = F_1 ( V_3 ) ;
struct V_41 * V_361 ;
if ( V_59 -> V_145 > V_362 )
...
F_124 () ;
V_361 = F_118 ( V_59 , V_33 ) ;
if ( ! V_361 ) {
if ( V_59 -> V_145 != V_125 )
V_6 -> V_56 &= ~ ( 1 << V_59 -> V_145 ) ;
return - V_44 ;
}
F_34 ( V_361 , V_33 , V_55 , V_3 , F_7 ( V_3 ) ) ;
return 0 ;
}
static int F_125 ( struct V_2 * V_3 , const struct V_58 * V_364 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
...
return - V_44 ;
V_59 = (struct V_58 * ) F_43 ( V_8 , sizeof( struct V_58 ) ) ;
memcpy ( V_59 , V_364 , sizeof( struct V_58 ) ) ;
V_59 -> V_63 = ( V_72 ) 0 ;
V_59 -> V_73 = ( sizeof( struct V_58 ) / sizeof( V_74 ) ) ;
return F_34 ( V_8 , V_64 , V_57 , V_3 , F_7 ( V_3 ) ) ;
}
static int F_126 ( const struct V_343 * V_344 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
V_8 = F_41 ( sizeof( struct V_58 ) + 16 , V_64 ) ;
...
return - V_44 ;
V_59 = (struct V_58 * ) F_43 ( V_8 , sizeof( struct V_58 ) ) ;
V_59 -> V_145 = F_54 ( V_344 -> V_61 . V_133 ) ;
V_59 -> V_319 = V_365 ;
V_59 -> V_62 = V_344 -> V_302 ;
V_59 -> V_322 = V_344 -> V_345 ;
V_59 -> V_318 = V_29 ;
...
V_59 -> V_73 = ( sizeof( struct V_58 ) / sizeof( V_74 ) ) ;
V_59 -> V_321 = 0 ;
F_34 ( V_8 , V_64 , V_53 , NULL , V_344 -> V_10 ) ;
return 0 ;
}
static int F_127 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
unsigned int V_133 ;
struct V_343 V_344 ;
...
if ( V_133 == 0 )
return - V_71 ;
V_367 . V_368 = F_108 ( V_346 ) ;
V_367 . V_369 = F_109 ( V_346 ) ;
V_367 . V_370 = 0 ;
V_23 = F_128 ( V_10 , V_133 , & V_367 ) ;
V_51 = F_125 ( V_3 , V_59 ) ;
if ( V_23 || V_51 ) {
if ( V_23 == - V_50 )
V_23 = 0 ;
...
static int F_129 ( struct V_142 * V_164 , int V_372 , void * V_373 )
{
struct V_1 * V_6 = V_373 ;
struct V_41 * V_347 ;
struct V_58 * V_306 ;
if ( ! F_2 ( & V_6 -> V_3 ) )
return - V_44 ;
...
return F_94 ( V_347 ) ;
V_306 = (struct V_58 * ) V_347 -> V_61 ;
V_306 -> V_318 = V_6 -> V_7 . V_374 ;
V_306 -> V_319 = V_375 ;
V_306 -> V_145 = F_54 ( V_164 -> V_194 . V_133 ) ;
V_306 -> V_63 = 0 ;
V_306 -> V_321 = 0 ;
V_306 -> V_62 = V_372 + 1 ;
V_306 -> V_322 = V_6 -> V_7 . V_376 ;
if ( V_6 -> V_7 . V_8 )
F_34 ( V_6 -> V_7 . V_8 , V_64 , V_57 ,
& V_6 -> V_3 , F_7 ( & V_6 -> V_3 ) ) ;
V_6 -> V_7 . V_8 = V_347 ;
...
return F_131 ( V_10 , & V_6 -> V_7 . V_377 . V_199 , F_129 , ( void * ) V_6 ) ;
}
static void F_132 ( struct V_1 * V_6 )
{
F_133 ( & V_6 -> V_7 . V_377 . V_199 ) ;
}
static int F_134 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
T_7 V_133 ;
struct V_1 * V_6 = F_1 ( V_3 ) ;
if ( V_6 -> V_7 . V_7 != NULL )
...
if ( V_133 == 0 )
return - V_71 ;
V_6 -> V_7 . V_374 = V_59 -> V_318 ;
V_6 -> V_7 . V_376 = V_59 -> V_322 ;
V_6 -> V_7 . V_7 = F_130 ;
V_6 -> V_7 . V_9 = F_132 ;
F_135 ( & V_6 -> V_7 . V_377 . V_199 , V_133 ) ;
return F_38 ( V_6 ) ;
}
static int F_136 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_1 * V_6 = F_1 ( V_3 ) ;
...
V_8 = F_31 ( V_8 , V_33 ) ;
if ( V_379 && V_8 ) {
struct V_58 * V_380 = (struct V_58 * ) V_8 -> V_61 ;
V_380 -> V_63 = 0 ;
}
F_34 ( V_8 , V_33 , V_53 , NULL , F_7 ( V_3 ) ) ;
return 0 ;
}
static int F_139 ( struct V_381 * V_382 , int V_383 , int V_372 , void * V_373 )
{
int V_351 ;
T_6 V_269 = * ( T_6 * ) V_373 ;
for ( V_351 = 0 ; V_351 < V_382 -> V_384 ; V_351 ++ ) {
if ( V_382 -> V_385 [ V_351 ] . V_269 == V_269 )
return - V_363 ;
}
return 0 ;
}
...
V_269 = V_389 + 1 ;
F_141 ( & V_387 , V_390 ) ;
V_60 = V_386 ( V_10 , & V_387 , F_139 , ( void * ) & V_269 ) ;
F_142 ( & V_387 ) ;
if ( V_60 != - V_363 )
return V_269 ;
} while ( V_269 != V_388 );
...
static int
F_143 ( struct V_381 * V_382 , struct V_391 * V_392 )
{
struct V_10 * V_10 = F_144 ( V_382 ) ;
struct V_393 * V_394 = V_382 -> V_385 + V_382 -> V_384 ;
int V_148 ;
if ( V_382 -> V_384 >= V_395 )
return - V_396 ;
if ( V_392 -> V_397 == 0 )
return - V_71 ;
V_394 -> V_194 . V_133 = V_392 -> V_398 ;
if ( ( V_148 = F_65 ( V_392 -> V_397 ) ) < 0 )
return - V_71 ;
V_394 -> V_148 = V_148 ;
if ( V_392 -> V_399 == V_400 )
V_394 -> V_401 = 1 ;
else if ( V_392 -> V_399 == V_402 ) {
V_394 -> V_269 = V_392 -> V_403 ;
if ( V_394 -> V_269 > V_389 )
V_394 -> V_269 = 0 ;
if ( ! V_394 -> V_269 && ! ( V_394 -> V_269 = F_140 ( V_10 ) ) )
return - V_44 ;
}
if ( V_394 -> V_148 == V_151 ) {
T_7 * V_135 = ( T_7 * ) ( V_392 + 1 ) ;
int V_134 , V_404 ;
...
return - V_71 ;
V_404 = F_57 ( V_134 ) ;
if ( F_58 ( (struct V_78 * ) ( V_135 + V_404 ) ,
& V_394 -> V_194 . V_251 ) != V_134 )
return - V_71 ;
V_394 -> V_405 = V_134 ;
} else
V_394 -> V_405 = V_382 -> V_134 ;
V_394 -> V_406 = 1 ;
V_382 -> V_384 ++ ;
return 0 ;
}
static int
F_145 ( struct V_381 * V_382 , struct V_407 * V_408 )
{
int V_23 ;
int V_47 = V_408 -> V_409 * 8 - sizeof( struct V_407 ) ;
struct V_391 * V_392 = ( void * ) ( V_408 + 1 ) ;
if ( V_408 -> V_409 * 8 < sizeof( struct V_407 ) )
return - V_71 ;
while ( V_47 >= sizeof( struct V_391 ) ) {
if ( ( V_23 = F_143 ( V_382 , V_392 ) ) < 0 )
return V_23 ;
V_47 -= V_392 -> V_410 ;
V_392 = ( void * ) ( ( T_7 * ) V_392 + V_392 -> V_410 ) ;
}
return 0 ;
}
static inline int F_146 ( const struct V_381 * V_382 )
{
struct V_173 * V_174 = V_382 -> V_182 ;
if ( V_174 ) {
...
static int F_147 ( const struct V_381 * V_382 )
{
const struct V_393 * V_394 ;
int V_178 = F_62 ( V_382 -> V_134 ) ;
int V_404 = 0 ;
int V_351 ;
for ( V_351 = 0 ; V_351 < V_382 -> V_384 ; V_351 ++ ) {
V_394 = V_382 -> V_385 + V_351 ;
V_404 += F_57 ( V_394 -> V_405 ) ;
}
...
( V_178 * 2 ) +
sizeof( struct V_407 ) +
( V_382 -> V_384 * sizeof( struct V_391 ) ) +
( V_404 * 2 ) +
F_146 ( V_382 ) ;
}
static struct V_41 * F_148 ( const struct V_381 * V_382 )
{
struct V_41 * V_8 ;
int V_175 ;
V_175 = F_147 ( V_382 ) ;
...
static int F_149 ( struct V_41 * V_8 , const struct V_381 * V_382 , int V_383 )
{
struct V_58 * V_59 ;
struct V_76 * V_79 ;
struct V_167 * V_168 ;
...
sizeof( V_74 ) ;
V_79 -> V_248 = V_119 ;
V_79 -> V_249 = F_56 ( V_382 -> V_411 . V_133 ) ;
V_79 -> V_87 = V_382 -> V_411 . V_252 ;
V_79 -> V_250 = 0 ;
if ( ! F_66 ( & V_382 -> V_411 . V_184 ,
V_382 -> V_411 . V_253 ,
(struct V_78 * ) ( V_79 + 1 ) ,
V_382 -> V_134 ) )
F_74 () ;
...
V_79 -> V_248 = V_120 ;
V_79 -> V_249 = F_56 ( V_382 -> V_411 . V_133 ) ;
V_79 -> V_87 = V_382 -> V_411 . V_412 ;
V_79 -> V_250 = 0 ;
F_66 ( & V_382 -> V_411 . V_251 , V_382 -> V_411 . V_413 ,
(struct V_78 * ) ( V_79 + 1 ) ,
V_382 -> V_134 ) ;
V_168 = (struct V_167 * ) F_43 ( V_8 ,
sizeof( struct V_167 ) ) ;
...
sizeof( struct V_167 ) / sizeof( V_74 ) ;
V_168 -> V_226 = V_227 ;
V_168 -> V_228 = F_73 ( V_382 -> V_229 . V_230 ) ;
V_168 -> V_231 = F_73 ( V_382 -> V_229 . V_232 ) ;
V_168 -> V_233 = V_382 -> V_229 . V_234 ;
V_168 -> V_235 = V_382 -> V_229 . V_236 ;
V_168 = (struct V_167 * ) F_43 ( V_8 ,
sizeof( struct V_167 ) ) ;
V_168 -> V_225 =
sizeof( struct V_167 ) / sizeof( V_74 ) ;
V_168 -> V_226 = V_237 ;
V_168 -> V_228 = F_73 ( V_382 -> V_229 . V_238 ) ;
V_168 -> V_231 = F_73 ( V_382 -> V_229 . V_239 ) ;
V_168 -> V_233 = V_382 -> V_229 . V_240 ;
V_168 -> V_235 = V_382 -> V_229 . V_241 ;
V_168 = (struct V_167 * ) F_43 ( V_8 ,
sizeof( struct V_167 ) ) ;
V_168 -> V_225 =
sizeof( struct V_167 ) / sizeof( V_74 ) ;
V_168 -> V_226 = V_242 ;
V_168 -> V_228 = V_382 -> V_243 . V_244 ;
V_168 -> V_231 = V_382 -> V_243 . V_245 ;
V_168 -> V_233 = V_382 -> V_243 . V_246 ;
V_168 -> V_235 = V_382 -> V_243 . V_247 ;
V_408 = (struct V_407 * ) F_43 ( V_8 , sizeof( struct V_407 ) ) ;
V_408 -> V_409 = sizeof( struct V_407 ) / sizeof( V_74 ) ;
V_408 -> V_414 = V_415 ;
V_408 -> V_416 = V_417 ;
if ( V_382 -> V_418 == V_419 ) {
if ( V_382 -> V_384 )
V_408 -> V_416 = V_420 ;
else
V_408 -> V_416 = V_421 ;
...
V_408 -> V_422 = V_383 + 1 ;
V_408 -> V_423 = 0 ;
V_408 -> V_424 = V_382 -> V_425 ;
V_408 -> V_426 = V_382 -> V_427 ;
for ( V_351 = 0 ; V_351 < V_382 -> V_384 ; V_351 ++ ) {
const struct V_393 * V_394 = V_382 -> V_385 + V_351 ;
struct V_391 * V_392 ;
int V_428 ;
int V_148 ;
V_428 = sizeof( struct V_391 ) ;
if ( V_394 -> V_148 == V_151 ) {
V_404 = F_57 ( V_394 -> V_405 ) ;
V_428 += V_404 * 2 ;
} else {
...
V_392 = ( void * ) F_43 ( V_8 , V_428 ) ;
V_408 -> V_409 += V_428 / 8 ;
memset ( V_392 , 0 , sizeof( * V_392 ) ) ;
V_392 -> V_410 = V_428 ;
V_392 -> V_398 = V_394 -> V_194 . V_133 ;
if ( ( V_148 = F_64 ( V_394 -> V_148 ) ) < 0 )
return - V_71 ;
V_392 -> V_397 = V_148 ;
V_392 -> V_399 = V_429 ;
if ( V_394 -> V_269 )
...
if ( V_394 -> V_401 )
V_392 -> V_399 = V_400 ;
V_392 -> V_403 = V_394 -> V_269 ;
if ( V_394 -> V_148 == V_151 ) {
T_7 * V_135 = ( void * ) ( V_392 + 1 ) ;
F_66 ( & V_394 -> V_184 , 0 ,
(struct V_78 * ) V_135 ,
V_394 -> V_405 ) ;
F_66 ( & V_394 -> V_194 . V_251 , 0 ,
(struct V_78 * ) ( V_135 + V_404 ) ,
V_394 -> V_405 ) ;
}
}
if ( ( V_174 = V_382 -> V_182 ) ) {
int V_96 = F_146 ( V_382 ) ;
...
V_59 -> V_73 = V_175 / sizeof( V_74 ) ;
V_59 -> V_321 = F_3 ( & V_382 -> V_430 ) ;
return 0 ;
}
static int F_150 ( struct V_381 * V_382 , int V_383 , const struct V_343 * V_344 )
{
struct V_41 * V_347 ;
struct V_58 * V_306 ;
int V_23 ;
...
if ( F_93 ( V_347 ) )
return F_94 ( V_347 ) ;
V_23 = F_149 ( V_347 , V_382 , V_383 ) ;
if ( V_23 < 0 )
return V_23 ;
V_306 = (struct V_58 * ) V_347 -> V_61 ;
V_306 -> V_318 = V_29 ;
if ( V_344 -> V_61 . V_431 && V_344 -> V_327 == V_328 )
V_306 -> V_319 = V_432 ;
else
V_306 -> V_319 = F_99 ( V_344 -> V_327 ) ;
V_306 -> V_63 = 0 ;
V_306 -> V_62 = V_344 -> V_302 ;
V_306 -> V_322 = V_344 -> V_345 ;
F_34 ( V_347 , V_64 , V_53 , NULL , F_144 ( V_382 ) ) ;
return 0 ;
}
static int F_151 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
int V_23 = 0 ;
struct V_167 * V_168 ;
...
return - V_71 ;
V_408 = V_108 [ V_415 - 1 ] ;
if ( V_408 -> V_416 > V_420 )
return - V_71 ;
if ( ! V_408 -> V_422 || V_408 -> V_422 >= V_433 )
return - V_71 ;
V_382 = F_152 ( V_10 , V_33 ) ;
if ( V_382 == NULL )
return - V_44 ;
V_382 -> V_418 = ( V_408 -> V_416 == V_417 ?
V_434 : V_419 ) ;
V_382 -> V_427 = V_408 -> V_426 ;
V_135 = V_108 [ V_119 - 1 ] ;
V_382 -> V_134 = F_59 ( V_135 , & V_382 -> V_411 . V_184 ) ;
V_382 -> V_411 . V_134 = V_382 -> V_134 ;
V_382 -> V_411 . V_252 = V_135 -> V_87 ;
V_382 -> V_411 . V_133 = F_55 ( V_135 -> V_249 ) ;
V_382 -> V_411 . V_253 = ( (struct V_80 * ) ( V_135 + 1 ) ) -> V_158 ;
if ( V_382 -> V_411 . V_253 )
V_382 -> V_411 . V_435 = F_153 ( 0xffff ) ;
V_135 = V_108 [ V_120 - 1 ] ;
F_59 ( V_135 , & V_382 -> V_411 . V_251 ) ;
V_382 -> V_411 . V_412 = V_135 -> V_87 ;
V_382 -> V_411 . V_133 = F_55 ( V_135 -> V_249 ) ;
V_382 -> V_411 . V_413 = ( (struct V_80 * ) ( V_135 + 1 ) ) -> V_158 ;
if ( V_382 -> V_411 . V_413 )
V_382 -> V_411 . V_436 = F_153 ( 0xffff ) ;
V_90 = V_108 [ V_123 - 1 ] ;
if ( V_90 != NULL ) {
struct V_94 * V_95 = F_49 ( V_90 ) ;
if ( ! V_95 ) {
...
V_23 = F_154 ( & V_382 -> V_182 , V_95 ) ;
F_82 ( V_95 ) ;
if ( V_23 )
goto V_35;
}
V_382 -> V_229 . V_239 = V_437 ;
V_382 -> V_229 . V_232 = V_437 ;
V_382 -> V_229 . V_238 = V_437 ;
V_382 -> V_229 . V_230 = V_437 ;
if ( ( V_168 = V_108 [ V_227 - 1 ] ) != NULL ) {
V_382 -> V_229 . V_230 = F_80 ( V_168 -> V_228 ) ;
V_382 -> V_229 . V_232 = F_80 ( V_168 -> V_231 ) ;
V_382 -> V_229 . V_234 = V_168 -> V_233 ;
V_382 -> V_229 . V_236 = V_168 -> V_235 ;
}
if ( ( V_168 = V_108 [ V_237 - 1 ] ) != NULL ) {
V_382 -> V_229 . V_238 = F_80 ( V_168 -> V_228 ) ;
V_382 -> V_229 . V_239 = F_80 ( V_168 -> V_231 ) ;
V_382 -> V_229 . V_240 = V_168 -> V_233 ;
V_382 -> V_229 . V_241 = V_168 -> V_235 ;
}
V_382 -> V_384 = 0 ;
if ( V_408 -> V_416 == V_420 &&
( V_23 = F_145 ( V_382 , V_408 ) ) < 0 )
goto V_35;
V_23 = F_155 ( V_408 -> V_422 - 1 , V_382 ,
V_59 -> V_319 != V_333 ) ;
F_156 ( V_382 , V_23 ? 0 : 1 ,
F_108 ( V_346 ) ,
F_109 ( V_346 ) , 0 ) ;
if ( V_23 )
goto V_35;
...
V_344 . V_302 = V_59 -> V_62 ;
V_344 . V_345 = V_59 -> V_322 ;
F_157 ( V_382 , V_408 -> V_422 - 1 , & V_344 ) ;
F_158 ( V_382 ) ;
return 0 ;
V_35:
V_382 -> V_387 . V_438 = 1 ;
...
static int F_160 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
int V_23 ;
struct V_76 * V_135 ;
...
if ( V_183 . V_253 )
V_183 . V_435 = F_153 ( 0xffff ) ;
V_135 = V_108 [ V_120 - 1 ] ;
F_59 ( V_135 , & V_183 . V_251 ) ;
V_183 . V_412 = V_135 -> V_87 ;
V_183 . V_133 = F_55 ( V_135 -> V_249 ) ;
V_183 . V_413 = ( (struct V_80 * ) ( V_135 + 1 ) ) -> V_158 ;
if ( V_183 . V_413 )
V_183 . V_436 = F_153 ( 0xffff ) ;
V_90 = V_108 [ V_123 - 1 ] ;
if ( V_90 != NULL ) {
struct V_94 * V_95 = F_49 ( V_90 ) ;
if ( ! V_95 )
return - V_31 ;
V_23 = F_154 ( & V_440 , V_95 ) ;
F_82 ( V_95 ) ;
if ( V_23 )
return V_23 ;
}
V_382 = F_161 ( V_10 , V_146 , V_390 ,
V_408 -> V_422 - 1 , & V_183 , V_440 ,
1 , & V_23 ) ;
F_162 ( V_440 ) ;
if ( V_382 == NULL )
return - V_314 ;
F_163 ( V_382 , V_23 ? 0 : 1 ,
F_108 ( V_346 ) ,
F_109 ( V_346 ) , 0 ) ;
if ( V_23 )
goto V_35;
...
static int F_165 ( struct V_2 * V_3 , struct V_381 * V_382 , const struct V_58 * V_59 , int V_383 )
{
int V_23 ;
struct V_41 * V_347 ;
struct V_58 * V_306 ;
...
V_306 = (struct V_58 * ) V_347 -> V_61 ;
V_306 -> V_318 = V_59 -> V_318 ;
V_306 -> V_319 = V_59 -> V_319 ;
V_306 -> V_145 = 0 ;
V_306 -> V_63 = 0 ;
V_306 -> V_62 = V_59 -> V_62 ;
V_306 -> V_322 = V_59 -> V_322 ;
F_34 ( V_347 , V_64 , V_57 , V_3 , F_144 ( V_382 ) ) ;
V_23 = 0 ;
V_35:
return V_23 ;
}
static int F_166 ( T_3 V_134 )
{
return F_63 ( F_57 ( V_134 ) * 2 ) ;
}
static int F_167 ( struct V_78 * V_135 , int V_112 ,
T_4 * V_184 , T_4 * V_251 ,
T_9 * V_134 )
{
int V_441 , V_404 ;
if ( V_112 < F_166 ( V_135 -> V_84 ) )
return - V_71 ;
V_441 = F_58 ( V_135 , V_184 ) ;
if ( ! V_441 )
return - V_71 ;
V_404 = F_57 ( V_441 ) ;
if ( F_58 ( (struct V_78 * ) ( ( ( T_7 * ) V_135 ) + V_404 ) ,
V_251 ) != V_441 )
return - V_71 ;
* V_134 = V_441 ;
return 0 ;
}
static int F_168 ( struct V_391 * V_442 , int V_47 ,
struct V_443 * V_444 )
{
int V_23 ;
struct V_391 * V_445 ;
int V_148 ;
if ( V_47 <= sizeof( struct V_391 ) ||
V_47 < V_442 -> V_410 )
return - V_71 ;
V_23 = F_167 ( (struct V_78 * ) ( V_442 + 1 ) ,
V_442 -> V_410 ,
& V_444 -> V_446 , & V_444 -> V_447 ,
& V_444 -> V_448 ) ;
if ( V_23 )
return V_23 ;
V_445 = (struct V_391 * ) ( ( T_7 * ) V_442 + V_442 -> V_410 ) ;
V_47 -= V_442 -> V_410 ;
if ( V_47 <= sizeof( struct V_391 ) ||
V_47 < V_445 -> V_410 )
return - V_71 ;
V_23 = F_167 ( (struct V_78 * ) ( V_445 + 1 ) ,
V_445 -> V_410 ,
& V_444 -> V_449 , & V_444 -> V_450 ,
& V_444 -> V_451 ) ;
if ( V_23 )
return V_23 ;
if ( V_442 -> V_398 != V_445 -> V_398 ||
V_442 -> V_397 != V_445 -> V_397 ||
V_442 -> V_403 != V_445 -> V_403 )
return - V_71 ;
V_444 -> V_133 = V_442 -> V_398 ;
if ( ( V_148 = F_65 ( V_442 -> V_397 ) ) < 0 )
return - V_71 ;
V_444 -> V_148 = V_148 ;
V_444 -> V_269 = V_442 -> V_403 ;
return ( ( int ) ( V_442 -> V_410 +
V_445 -> V_410 ) ) ;
}
static int F_169 ( struct V_2 * V_3 , struct V_41 * V_8 ,
const struct V_58 * V_59 , void * const * V_108 )
{
int V_351 , V_47 , V_452 , V_23 = - V_71 ;
T_7 V_383 ;
struct V_76 * V_135 ;
struct V_453 * V_454 ;
struct V_407 * V_408 ;
...
V_454 = V_108 [ V_457 - 1 ] ;
V_408 = V_108 [ V_415 - 1 ] ;
if ( V_408 -> V_422 >= V_433 ) {
V_23 = - V_71 ;
goto V_35;
}
if ( V_454 ) {
V_456 . V_458 = V_454 -> V_459 ;
V_452 = F_167 ( (struct V_78 * ) ( V_454 + 1 ) ,
...
if ( V_183 . V_413 )
V_183 . V_436 = F_153 ( 0xffff ) ;
V_392 = (struct V_391 * ) ( V_408 + 1 ) ;
V_351 = 0 ;
V_47 = V_408 -> V_409 * 8 - sizeof( struct V_407 ) ;
while ( V_47 > 0 && V_351 < V_395 ) {
V_452 = F_168 ( V_392 , V_47 , & V_444 [ V_351 ] ) ;
if ( V_452 < 0 ) {
V_23 = V_452 ;
goto V_35;
} else {
V_392 = (struct V_391 * ) ( ( T_7 * ) V_392 + V_452 ) ;
V_47 -= V_452 ;
V_351 ++ ;
}
}
...
return V_443 ( & V_183 , V_383 , V_390 , V_444 , V_351 ,
V_454 ? & V_456 : NULL ) ;
V_35:
return V_23 ;
}
...
static int F_170 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
unsigned int V_383 ;
int V_23 = 0 , V_464 ;
...
struct V_381 * V_382 ;
struct V_343 V_344 ;
if ( ( V_408 = V_108 [ V_415 - 1 ] ) == NULL )
return - V_71 ;
V_383 = F_171 ( V_408 -> V_424 ) ;
if ( V_383 >= V_465 )
return - V_71 ;
V_464 = ( V_59 -> V_319 == V_432 ) ;
V_382 = F_172 ( V_10 , V_146 , V_390 ,
V_383 , V_408 -> V_424 , V_464 , & V_23 ) ;
if ( V_382 == NULL )
return - V_314 ;
if ( V_464 ) {
F_163 ( V_382 , V_23 ? 0 : 1 ,
...
V_344 . V_61 . V_431 = 1 ;
V_344 . V_327 = V_328 ;
F_157 ( V_382 , V_383 , & V_344 ) ;
} else {
V_23 = F_165 ( V_3 , V_382 , V_59 , V_383 ) ;
}
V_35:
F_158 ( V_382 ) ;
if ( V_464 && V_23 == 0 )
...
static int F_173 ( struct V_381 * V_382 , int V_383 , int V_372 , void * V_373 )
{
struct V_1 * V_6 = V_373 ;
struct V_41 * V_347 ;
struct V_58 * V_306 ;
...
{
struct V_10 * V_10 = F_7 ( & V_6 -> V_3 ) ;
return V_386 ( V_10 , & V_6 -> V_7 . V_377 . V_467 , F_173 , ( void * ) V_6 ) ;
}
static void F_175 ( struct V_1 * V_6 )
{
F_142 ( & V_6 -> V_7 . V_377 . V_467 ) ;
}
...
V_6 -> V_7 . V_7 = F_174 ;
V_6 -> V_7 . V_9 = F_175 ;
F_141 ( & V_6 -> V_7 . V_377 . V_467 , V_390 ) ;
return F_38 ( V_6 ) ;
}
static int F_177 ( const struct V_343 * V_344 )
{
struct V_41 * V_468 ;
struct V_58 * V_59 ;
...
V_59 -> V_73 = ( sizeof( struct V_58 ) / sizeof( V_74 ) ) ;
V_59 -> V_321 = 0 ;
F_34 ( V_468 , V_64 , V_53 , NULL , V_344 -> V_10 ) ;
return 0 ;
}
static int F_178 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
struct V_343 V_344 ;
struct V_366 V_367 ;
...
V_23 = - V_304 ;
if ( V_471 [ V_59 -> V_319 ] )
V_23 = V_471 [ V_59 -> V_319 ] ( V_3 , V_8 , V_59 , V_108 ) ;
}
return V_23 ;
}
static struct V_58 * F_181 ( struct V_41 * V_8 , int * V_472 )
{
...
static inline int F_182 ( const struct V_393 * V_394 ,
const struct V_209 * V_476 )
{
unsigned int V_194 = V_476 -> V_213 . V_214 ;
if ( V_194 >= sizeof( V_394 -> V_477 ) * 8 )
return 0 ;
return ( V_394 -> V_477 >> V_194 ) & 1 ;
}
static inline int F_183 ( const struct V_393 * V_394 ,
const struct V_209 * V_476 )
{
unsigned int V_194 = V_476 -> V_213 . V_214 ;
if ( V_194 >= sizeof( V_394 -> V_478 ) * 8 )
return 0 ;
return ( V_394 -> V_478 >> V_194 ) & 1 ;
}
static int F_184 ( const struct V_393 * V_394 )
{
int V_351 , V_479 = 0 ;
for ( V_351 = 0 ; ; V_351 ++ ) {
const struct V_209 * V_185 = F_121 ( V_351 ) ;
if ( ! V_185 )
break;
if ( ! V_185 -> V_212 )
continue;
if ( F_182 ( V_394 , V_185 ) && V_185 -> V_359 )
V_479 += sizeof( struct V_480 ) ;
}
return V_479 + sizeof( struct V_481 ) ;
}
static int F_185 ( const struct V_393 * V_394 )
{
int V_351 , V_456 , V_479 = 0 ;
for ( V_351 = 0 ; ; V_351 ++ ) {
const struct V_209 * V_187 = F_122 ( V_351 ) ;
if ( ! V_187 )
break;
if ( ! V_187 -> V_212 )
continue;
if ( ! ( F_183 ( V_394 , V_187 ) && V_187 -> V_359 ) )
continue;
for ( V_456 = 1 ; ; V_456 ++ ) {
const struct V_209 * V_185 = F_121 ( V_456 ) ;
if ( ! V_185 )
break;
if ( ! V_185 -> V_212 )
continue;
...
static void F_186 ( struct V_41 * V_8 , const struct V_393 * V_394 )
{
struct V_481 * V_75 ;
int V_351 ;
...
if ( F_182 ( V_394 , V_185 ) && V_185 -> V_359 ) {
struct V_480 * V_344 ;
V_344 = (struct V_480 * ) F_43 ( V_8 , sizeof( struct V_480 ) ) ;
memset ( V_344 , 0 , sizeof( * V_344 ) ) ;
V_75 -> V_482 += sizeof( struct V_480 ) / 8 ;
V_344 -> V_487 = V_185 -> V_213 . V_214 ;
V_344 -> V_488 = V_185 -> V_213 . V_489 ;
V_344 -> V_490 = V_185 -> V_213 . V_491 ;
V_344 -> V_492 = 24 * 60 * 60 ;
V_344 -> V_493 = 20 * 60 * 60 ;
V_344 -> V_494 = 8 * 60 * 60 ;
V_344 -> V_495 = 7 * 60 * 60 ;
}
}
}
static void F_187 ( struct V_41 * V_8 , const struct V_393 * V_394 )
{
struct V_481 * V_75 ;
int V_351 , V_456 ;
V_75 = (struct V_481 * ) F_43 ( V_8 , sizeof( struct V_481 ) ) ;
...
V_344 -> V_488 = V_185 -> V_213 . V_489 ;
V_344 -> V_490 = V_185 -> V_213 . V_491 ;
V_344 -> V_496 = V_187 -> V_213 . V_214 ;
V_344 -> V_497 = V_187 -> V_213 . V_489 ;
V_344 -> V_498 = V_187 -> V_213 . V_491 ;
V_344 -> V_492 = 24 * 60 * 60 ;
V_344 -> V_493 = 20 * 60 * 60 ;
V_344 -> V_494 = 8 * 60 * 60 ;
V_344 -> V_495 = 7 * 60 * 60 ;
...
static int F_188 ( struct V_381 * V_382 , const struct V_343 * V_344 )
{
return 0 ;
}
static int F_189 ( struct V_142 * V_164 , const struct V_343 * V_344 )
{
struct V_41 * V_347 ;
struct V_58 * V_306 ;
int V_499 ;
int V_166 ;
V_499 = V_344 -> V_61 . V_499 ;
if ( V_499 )
V_166 = 2 ;
else
V_166 = 1 ;
V_347 = F_76 ( V_164 , V_166 ) ;
if ( F_93 ( V_347 ) )
return F_94 ( V_347 ) ;
V_306 = (struct V_58 * ) V_347 -> V_61 ;
V_306 -> V_318 = V_29 ;
...
V_306 -> V_62 = 0 ;
V_306 -> V_322 = 0 ;
F_34 ( V_347 , V_64 , V_55 , NULL , F_102 ( V_164 ) ) ;
return 0 ;
}
static int F_190 ( struct V_142 * V_164 , const struct V_343 * V_344 )
{
struct V_10 * V_10 = V_164 ? F_102 ( V_164 ) : V_344 -> V_10 ;
struct V_11 * V_12 = F_8 ( V_10 , V_13 ) ;
if ( F_3 ( & V_12 -> V_17 ) == 0 )
return 0 ;
switch ( V_344 -> V_327 ) {
case V_341 :
return F_189 ( V_164 , V_344 ) ;
case V_335 :
case V_337 :
case V_339 :
return F_101 ( V_164 , V_344 ) ;
case V_371 :
return F_126 ( V_344 ) ;
case V_500 :
break;
...
static int F_191 ( struct V_381 * V_382 , int V_383 , const struct V_343 * V_344 )
{
if ( V_382 && V_382 -> type != V_390 )
return 0 ;
switch ( V_344 -> V_327 ) {
case V_334 :
return F_188 ( V_382 , V_344 ) ;
case V_328 :
case V_330 :
case V_332 :
return F_150 ( V_382 , V_383 , V_344 ) ;
case V_470 :
if ( V_344 -> V_61 . type != V_390 )
break;
return F_177 ( V_344 ) ;
default:
...
static int F_194 ( struct V_142 * V_164 , struct V_393 * V_394 , struct V_381 * V_382 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
struct V_76 * V_79 ;
...
V_59 -> V_63 = 0 ;
V_59 -> V_321 = 0 ;
V_59 -> V_62 = V_164 -> V_198 . V_302 = F_192 () ;
V_59 -> V_322 = 0 ;
V_79 = (struct V_76 * ) F_43 ( V_8 ,
sizeof( struct V_76 ) + V_178 ) ;
V_79 -> V_86 =
...
return F_34 ( V_8 , V_64 , V_55 , NULL , F_102 ( V_164 ) ) ;
}
static struct V_381 * F_195 ( struct V_2 * V_3 , int V_505 ,
T_7 * V_61 , int V_47 , int * V_383 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
struct V_381 * V_382 ;
struct V_407 * V_408 = (struct V_407 * ) V_61 ;
struct V_89 * V_90 ;
switch ( V_3 -> V_38 ) {
case V_85 :
if ( V_505 != V_506 ) {
...
* V_383 = - V_71 ;
if ( V_47 < sizeof( struct V_407 ) ||
V_408 -> V_409 * 8 > V_47 ||
V_408 -> V_416 > V_508 ||
( ! V_408 -> V_422 || V_408 -> V_422 > V_509 ) )
return NULL ;
V_382 = F_152 ( V_10 , V_64 ) ;
if ( V_382 == NULL ) {
* V_383 = - V_44 ;
return NULL ;
}
...
V_382 -> V_229 . V_238 = V_437 ;
V_382 -> V_229 . V_230 = V_437 ;
V_382 -> V_134 = V_3 -> V_38 ;
V_382 -> V_384 = 0 ;
if ( V_408 -> V_416 == V_420 &&
( * V_383 = F_145 ( V_382 , V_408 ) ) < 0 )
goto V_35;
if ( V_47 >= ( V_408 -> V_409 * 8 +
sizeof( struct V_89 ) ) ) {
char * V_75 = ( char * ) V_408 ;
struct V_94 * V_95 ;
V_75 += V_408 -> V_409 * 8 ;
...
static int F_196 ( struct V_142 * V_164 , T_4 * V_510 , T_5 V_253 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
struct V_143 * V_135 ;
...
static int F_197 ( struct V_41 * V_8 , int V_512 , int type ,
...
static int F_198 ( struct V_41 * V_8 , const struct V_455 * V_456 )
{
struct V_453 * V_454 ;
T_7 * V_135 ;
int V_134 = V_456 -> V_134 ;
int V_404 = F_57 ( V_134 ) ;
int V_513 ;
...
! F_66 ( & V_456 -> V_462 , 0 , (struct V_78 * ) ( V_135 + V_404 ) , V_134 ) )
return - V_71 ;
return 0 ;
}
...
int V_404 = F_57 ( V_134 ) ;
int V_513 ;
V_513 = sizeof( struct V_391 ) +
F_166 ( V_134 ) ;
V_392 = (struct V_391 * ) F_43 ( V_8 , V_513 ) ;
memset ( V_392 , 0 , V_513 ) ;
V_392 -> V_410 = V_513 ;
V_392 -> V_398 = V_133 ;
V_392 -> V_397 = V_148 ;
V_392 -> V_399 = V_515 ;
...
! F_66 ( V_105 , 0 , (struct V_78 * ) ( V_135 + V_404 ) , V_134 ) )
return - V_71 ;
return 0 ;
}
static int F_200 ( const struct V_439 * V_183 , T_7 V_383 , T_7 type ,
...
V_518 += sizeof( struct V_407 ) ;
for ( V_351 = 0 , V_519 = V_444 ; V_351 < V_516 ; V_351 ++ , V_519 ++ ) {
V_518 += sizeof( struct V_391 ) +
F_166 ( V_519 -> V_448 ) ;
V_518 += sizeof( struct V_391 ) +
F_166 ( V_519 -> V_451 ) ;
}
...
V_59 -> V_62 = 0 ;
V_59 -> V_322 = 0 ;
if ( V_456 != NULL && ( F_198 ( V_8 , V_456 ) < 0 ) )
goto V_23;
F_197 ( V_8 , V_517 , V_119 , V_183 ) ;
F_197 ( V_8 , V_517 , V_120 , V_183 ) ;
V_408 = (struct V_407 * ) F_43 ( V_8 , sizeof( struct V_407 ) ) ;
V_408 -> V_409 = V_518 / 8 ;
V_408 -> V_414 = V_415 ;
V_408 -> V_416 = V_420 ;
...
if ( V_148 < 0 )
goto V_23;
if ( F_199 ( V_8 , V_519 -> V_133 , V_148 ,
( V_519 -> V_269 ? V_402 : V_429 ) ,
...
goto V_35;
V_23 = - V_528 ;
if ( F_202 ( F_43 ( V_8 , V_47 ) , V_524 -> V_529 , V_47 ) )
goto V_35;
V_59 = F_181 ( V_8 , & V_23 ) ;
if ( ! V_59 )
goto V_35;
...
goto V_35;
V_524 -> V_536 = 0 ;
V_8 = F_204 ( V_3 , V_218 , V_218 & V_533 , & V_23 ) ;
if ( V_8 == NULL )
goto V_35;
V_531 = V_8 -> V_47 ;
if ( V_531 > V_47 ) {
...
F_212 ( V_541 ) ,
F_213 ( V_541 ) ,
F_214 ( F_215 ( V_539 ) , F_216 ( V_541 ) ) ,
F_217 ( V_541 )
) ;
return 0 ;
}
static void * F_218 ( struct V_538 * V_539 , T_13 * V_544 )
__acquires( T_14 )
{
struct V_10 * V_10 = F_219 ( V_539 ) ;
struct V_11 * V_12 = F_8 ( V_10 , V_13 ) ;
F_35 () ;
return F_220 ( & V_12 -> V_19 , * V_544 ) ;
}
static void * F_221 ( struct V_538 * V_539 , void * V_540 , T_13 * V_544 )
{
struct V_10 * V_10 = F_219 ( V_539 ) ;
struct V_11 * V_12 = F_8 ( V_10 , V_13 ) ;
return F_222 ( V_540 , & V_12 -> V_19 , V_544 ) ;
}
static void F_223 ( struct V_538 * V_539 , void * V_540 )
__releases( T_14 )
{
F_37 () ;
}
static int F_224 ( struct V_545 * V_545 , struct V_546 * V_546 )
{
return F_225 ( V_545 , V_546 , & V_547 ,
sizeof( struct V_548 ) ) ;
}
static int T_15 F_226 ( struct V_10 * V_10 )
{
struct V_549 * V_550 ;
V_550 = F_227 ( L_6 , 0 , V_10 -> V_551 , & V_552 ) ;
if ( V_550 == NULL )
return - V_31 ;
return 0 ;
}
