...
static int F_161 ( struct V_1 * V_2 , struct V_99 * V_100 )
{
F_5 ( V_214 , & V_100 -> V_83 ) ;
if ( F_3 ( V_215 , & V_100 -> V_83 ) ) {
F_7 ( V_214 , & V_100 -> V_83 ) ;
return 0 ;
}
F_5 ( V_216 , & V_100 -> V_109 -> V_217 ) ;
F_5 ( V_218 , & V_2 -> V_18 ) ;
return 1 ;
}
static int F_162 ( struct V_1 * V_2 , struct V_99 * V_100 )
{
F_5 ( V_215 , & V_100 -> V_83 ) ;
F_7 ( V_214 , & V_100 -> V_83 ) ;
F_5 ( V_219 , & V_100 -> V_109 -> V_217 ) ;
F_5 ( V_220 , & V_2 -> V_18 ) ;
return 1 ;
}
int F_163 ( const struct V_31 * V_32 , struct V_99 * V_100 )
{
struct V_1 * V_2 = V_32 -> V_1 ;
if ( ! F_92 ( V_100 ) )
return - V_221 ;
...
const T_5 * V_222 )
{
struct V_1 * V_2 = F_165 ( V_110 ) -> V_1 ;
struct V_111 * V_112 = F_90 ( V_110 ) ;
struct V_223 * V_224 ;
struct V_99 * V_100 ;
bool V_225 = false ;
...
static void F_167 ( struct V_99 * V_100 )
{
struct V_110 * V_110 = V_100 -> V_110 ;
struct V_111 * V_112 = F_90 ( V_110 ) ;
struct V_223 * V_224 ;
F_15 ( & V_110 -> V_113 ) ;
F_91 (ctx, &nfsi->open_files, list) {
if ( V_224 -> V_100 != V_100 )
continue;
F_5 ( V_226 , & V_224 -> V_83 ) ;
}
F_16 ( & V_110 -> V_113 ) ;
}
static void F_168 ( struct V_99 * V_100 , int error )
{
F_5 ( V_227 , & V_100 -> V_83 ) ;
F_167 ( V_100 ) ;
}
static int F_169 ( struct V_99 * V_100 , const struct V_228 * V_229 )
{
struct V_110 * V_110 = V_100 -> V_110 ;
struct V_111 * V_112 = F_90 ( V_110 ) ;
struct V_151 * V_156 ;
...
F_170 ( & V_112 -> V_231 ) ;
F_15 ( & V_110 -> V_113 ) ;
for ( V_156 = V_110 -> V_230 ; V_156 != NULL ; V_156 = V_156 -> V_232 ) {
if ( ! ( V_156 -> V_158 & ( V_159 | V_160 ) ) )
continue;
if ( F_171 ( V_156 -> V_233 ) -> V_100 != V_100 )
continue;
F_16 ( & V_110 -> V_113 ) ;
V_12 = V_229 -> V_234 ( V_100 , V_156 ) ;
switch ( V_12 ) {
case 0 :
break;
case - V_235 :
...
static int F_173 ( struct V_33 * V_34 , const struct V_228 * V_229 )
{
struct V_99 * V_100 ;
struct V_127 * V_85 ;
int V_12 = 0 ;
...
if ( ! F_28 ( V_229 -> V_247 , & V_100 -> V_83 ) )
continue;
if ( ! F_92 ( V_100 ) )
continue;
if ( V_100 -> V_100 == 0 )
...
F_47 ( & V_100 -> V_102 ) ;
F_16 ( & V_34 -> V_89 ) ;
V_12 = V_229 -> V_248 ( V_34 , V_100 ) ;
if ( V_12 >= 0 ) {
V_12 = F_169 ( V_100 , V_229 ) ;
if ( V_12 >= 0 ) {
if ( F_3 ( V_125 , & V_100 -> V_83 ) != 0 ) {
F_15 ( & V_100 -> V_104 ) ;
...
static void F_177 ( struct V_99 * V_100 )
{
struct V_127 * V_85 ;
F_7 ( V_125 , & V_100 -> V_83 ) ;
...
int (* F_179)( struct V_1 * V_2 , struct V_99 * V_100 ) )
{
struct V_1 * V_2 = V_32 -> V_1 ;
struct V_33 * V_34 ;
struct V_35 * V_36 ;
...
F_153 ( L_18 , V_204 , error ,
V_2 -> V_207 ) ;
return 0 ;
}
static int F_191 ( struct V_1 * V_2 , const struct V_228 * V_229 )
{
struct V_33 * V_34 ;
struct V_31 * V_32 ;
struct V_35 * V_36 ;
...
F_16 ( & V_2 -> V_30 ) ;
F_26 () ;
V_12 = F_173 ( V_34 , V_229 ) ;
if ( V_12 < 0 ) {
F_5 ( V_229 -> V_257 , & V_34 -> V_217 ) ;
F_81 ( V_34 ) ;
...
if ( F_28 ( V_275 , & V_2 -> V_18 ) )
F_189 ( V_2 ) ;
if ( ! F_3 ( V_220 , & V_2 -> V_18 ) )
F_5 ( V_218 , & V_2 -> V_18 ) ;
F_7 ( V_206 , & V_2 -> V_18 ) ;
F_7 ( V_205 , & V_2 -> V_18 ) ;
return 0 ;
...
case - V_266 :
case - V_283 :
V_277 = F_201 ( V_277 , V_284 ) ;
if ( F_147 ( V_277 ) ) {
V_12 = F_149 ( V_277 ) ;
break;
}
V_277 = F_202 ( & V_2 -> V_200 , V_277 ) ;
F_203 ( V_277 ) ;
V_277 = V_2 -> V_200 ;
goto V_280;
case - V_270 :
...
V_281:
F_205 ( & V_279 ) ;
F_153 ( L_24 , V_204 , V_12 ) ;
return V_12 ;
}
void F_206 ( struct V_46 * V_286 , int V_76 )
{
...
void F_216 ( struct V_1 * V_2 , T_6 V_83 )
{
if ( ! V_83 )
return;
F_153 ( L_30 ,
...
memset ( V_2 -> V_48 -> V_297 . V_298 , 0 , V_299 ) ;
V_12 = F_40 ( V_2 , V_4 ) ;
if ( V_12 ) {
F_153 ( L_31 ,
...
break;
default:
return F_190 ( V_2 , V_55 ) ;
}
return 0 ;
}
static int F_217 ( struct V_1 * V_2 ) { return 0 ; }
static int F_219 ( struct V_1 * V_2 )
{
return 0 ;
}
...
{
int V_12 = 0 ;
const char * V_300 = L_34 , * V_301 = L_34 ;
do {
if ( F_3 ( V_264 , & V_2 -> V_18 ) ) {
V_300 = L_35 ;
V_12 = F_198 ( V_2 ) ;
if ( V_12 < 0 )
goto V_302;
...
static int V_202 ( void * V_305 )
{
struct V_1 * V_2 = V_305 ;
F_224 ( V_306 ) ;
F_221 ( V_2 ) ;
F_150 ( V_2 ) ;
F_225 ( 0 ) ;
