...
F_8 (p, &br->port_list, list) {
if ( F_34 ( V_6 -> V_50 . V_44 , V_47 ) )
memcpy ( V_6 -> V_50 . V_44 , V_44 , V_46 ) ;
if ( F_34 ( V_6 -> V_51 . V_44 , V_47 ) )
...
if ( F_34 ( V_12 -> V_48 . V_44 , V_44 ) )
return false ;
F_33 ( V_12 , V_44 ) ;
return true ;
}
void F_36 ( struct V_11 * V_12 , V_3 V_56 )
{
struct V_5 * V_6 ;
int V_26 ;
V_26 = F_19 ( V_12 ) ;
...
int F_38 ( struct V_5 * V_6 , unsigned long V_56 )
{
T_1 V_58 ;
if ( V_56 > V_59 )
return - V_60 ;
...
int F_39 ( struct V_5 * V_6 , unsigned long V_62 )
{
if ( V_62 < V_63 ||
V_62 > V_64 )
return - V_60 ;
...
T_4 F_40 ( char * V_67 , const struct V_48 * V_68 )
{
