...
V_11 = 0xff00 ;
V_34 = F_49 ( V_2 , V_19 , V_65 , V_66 , V_11 ) ;
if ( V_34 )
return V_34 ;
...
static const struct V_136 * F_50 ( int V_137 , int V_124 )
{
if ( V_137 ) {
if ( V_124 < 0 || V_124 >= 2 )
V_124 = 0 ;
...
static const struct V_136 * F_51 ( int V_124 )
{
if ( V_124 < 0 || V_124 >= 5 )
V_124 = 0 ;
return V_140 [ V_124 ] ;
}
static int F_52 ( struct V_1 * V_2 , int V_141 , int V_142 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
int V_34 ;
V_8 -> V_96 = 0 ;
...
V_34 = F_53 ( V_141 , L_12 ) ;
if ( V_34 )
return - V_143 ;
V_8 -> V_29 [ 0 ] . V_30 = V_141 ;
V_34 = F_53 ( V_142 , L_13 ) ;
if ( V_34 )
return - V_143 ;
V_8 -> V_29 [ 1 ] . V_30 = V_142 ;
V_8 -> V_31 = V_144 ;
V_8 -> V_29 [ 0 ] . V_3 = ( void * ) F_54 ( V_145 | V_146 ) ;
V_8 -> V_29 [ 1 ] . V_3 = ( void * ) F_54 ( V_145 | V_146 ) ;
...
static int F_55 ( struct V_1 * V_2 , struct V_148 * V_149 )
{
const struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 ;
int V_10 , V_45 ;
int V_34 ;
struct V_18 * V_19 ;
V_34 = F_56 ( V_2 , V_149 -> V_150 [ 0 ] , V_151 ) ;
if ( V_34 )
return V_34 ;
...
V_8 = F_59 ( V_2 , sizeof( * V_8 ) ) ;
if ( ! V_8 )
return - V_147 ;
V_34 = F_52 ( V_2 , V_149 -> V_150 [ V_166 ] ,
V_149 -> V_150 [ V_167 ] ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = F_60 ( V_2 , 3 ) ;
...
V_19 -> V_184 = 16 ;
V_19 -> V_185 =
F_50 ( V_6 -> V_137 , V_149 -> V_150 [ V_186 ] ) ;
...
V_8 -> V_195 [ 0 ] =
F_51 ( V_149 -> V_150 [ V_196 ] ) ;
V_8 -> V_195 [ 1 ] =
F_51 ( V_149 -> V_150 [ V_197 ] ) ;
...
if ( V_2 -> V_9 ) {
if ( V_8 -> V_29 [ 0 ] . V_30 )
F_62 ( V_8 -> V_29 [ 0 ] . V_30 ) ;
if ( V_8 -> V_29 [ 1 ] . V_30 )
F_62 ( V_8 -> V_29 [ 1 ] . V_30 ) ;
if ( V_8 -> V_29 [ 0 ] . V_3 )
F_63 ( ( unsigned long ) V_8 -> V_29 [ 0 ] . V_3 ) ;
if ( V_8 -> V_29 [ 1 ] . V_3 )
F_63 ( ( unsigned long ) V_8 -> V_29 [ 1 ] . V_3 ) ;
}
F_64 ( V_2 ) ;
}
