...
F_80 ( V_37 -> type , type ? : L_23 , sizeof( V_37 -> type ) ) ;
F_81 ( & V_37 -> V_19 ) ;
F_82 ( & V_37 -> V_116 ) ;
V_37 -> V_28 = V_28 ;
V_37 -> V_125 = true ;
...
F_80 ( V_23 -> type , type ? : L_23 , sizeof( V_23 -> type ) ) ;
V_23 -> V_28 = V_28 ;
V_23 -> V_14 = V_14 ;
...
V_82 = F_108 ( V_159 , 0 , V_170 . V_20 , V_165 ) ;
if ( V_82 )
F_18 ( & V_23 -> V_39 , L_26 , V_82 ) ;
return V_82 ;
}
