...
static int F_49 ( struct V_72 * V_53 )
{
T_2 V_15 ;
int V_73 = 0 ;
int V_43 = 0 ;
...
V_53 -> V_78 = V_16 ;
F_50 ( & V_16 -> V_107 ) ;
error = F_51 ( & V_16 -> V_108 , V_109 * sizeof( int ) ,
V_110 ) ;
if ( error ) {
F_40 ( L_42 ) ;
goto V_80;
...
V_105 = 0 ;
while ( F_1 ( V_112 , 0x1 , 0x0 , 0x0 ) != 0
&& ( V_105 ++ ) < V_113 )
;
F_4 ( V_96 , L_43 , V_105 ) ;
V_16 -> V_59 =
F_1 ( V_114 , 0x0 , 0x0 , 0x0 ) ;
if ( V_16 -> V_59 == V_115 )
V_16 -> V_59 = 0 ;
if ( V_16 -> V_59 )
V_16 -> V_60 =
F_1 ( V_114 , 0x4 , 0x0 , 0x0 ) ;
F_26 ( L_44 , F_1 ( V_112 , 0x0 , 0x0 , 0x0 ) ) ;
#if F_52 ( V_116 ) || F_52 ( V_117 )
if ( F_1 ( V_29 , 0x0 , 0x0 , 0x0 ) & V_30 ) {
V_73 = F_53 ( & V_40 -> V_118 -> V_54 ,
& V_119 ) ;
if ( V_73 == 0 ) {
V_16 -> V_120 = 1 ;
} else {
...
static int F_55 ( struct V_72 * V_53 )
{
struct V_123 * V_16 = F_45 ( V_53 ) ;
...
static void F_57 ( struct V_72 * V_53 , T_5 V_100 )
{
struct V_74 * V_75 ;
int V_101 , V_124 ;
...
if ( V_130 )
return - V_18 ;
V_40 = F_61 ( sizeof( struct V_99 ) , V_110 ) ;
if ( ! V_40 )
return - V_79 ;
V_40 -> V_64 = V_131 ;
V_40 -> V_66 = V_132 ;
...
V_40 -> V_118 = F_64 ( L_52 , - 1 ) ;
if ( ! V_40 -> V_118 ) {
V_48 = - V_79 ;
goto V_138;
}
V_48 = F_65 ( V_40 -> V_118 ) ;
if ( V_48 )
goto V_139;
V_48 =
F_66 ( & V_40 -> V_118 -> V_54 . V_140 ,
& V_141 ) ;
if ( V_48 )
goto V_142;
if ( ! F_67 () ) {
struct V_143 V_49 ;
memset ( & V_49 , 0 , sizeof( struct V_143 ) ) ;
V_41 = V_40 -> V_41 ;
V_49 . type = V_144 ;
V_49 . V_41 = V_41 - 1 ;
V_40 -> V_145 = F_68 ( L_52 ,
NULL , NULL ,
& V_146 ,
& V_49 ) ;
if ( F_69 ( V_40 -> V_145 ) ) {
V_48 = F_70 ( V_40 -> V_145 ) ;
V_40 -> V_145 = NULL ;
goto V_147;
}
V_40 -> V_145 -> V_49 . V_27 = V_40 -> V_44 ;
}
V_48 = F_71 ( & V_148 ) ;
if ( V_48 )
goto V_149;
V_16 = F_61 ( sizeof( struct V_123 ) , V_110 ) ;
if ( ! V_16 ) {
V_48 = - V_79 ;
goto V_150;
}
...
V_40 -> V_145 -> V_49 . V_50 = 4 ;
else
V_40 -> V_145 -> V_49 . V_50 = 0 ;
}
F_26 ( L_53 V_153 L_54 ) ;
return 0 ;
V_152:
F_72 ( V_16 ) ;
V_150:
