...
goto error;
V_2 -> V_64 -> V_68 = V_68 ;
V_2 -> V_64 -> V_94 = V_16 -> V_84 -> V_95 [ 0 ] ;
V_2 -> V_64 -> V_96 = V_87 ;
V_2 -> V_64 -> V_97 = V_88 ;
V_2 -> V_64 -> V_98 = V_15 -> V_35 ;
V_2 -> V_64 -> V_99 = V_15 -> V_43 ;
F_42 ( V_2 -> V_64 , V_16 -> V_84 ) ;
V_2 -> V_52 = 0 ;
return 0 ;
error:
...
{
struct V_102 * V_103 ;
struct V_104 * V_7 = V_2 -> V_16 . V_7 ;
unsigned long V_24 ;
F_55 ( & V_7 -> V_105 , V_24 ) ;
V_103 = V_2 -> V_103 ;
if ( V_103 && V_103 -> V_106 . V_107 == V_101 ) {
V_2 -> V_103 = NULL ;
V_103 -> V_106 . V_108 ( & V_103 -> V_106 ) ;
F_56 ( V_7 , V_2 -> V_18 ) ;
}
F_57 ( & V_7 -> V_105 , V_24 ) ;
}
...
return;
F_55 ( & V_7 -> V_105 , V_24 ) ;
F_59 ( V_7 , V_2 -> V_18 , V_103 ) ;
F_57 ( & V_7 -> V_105 , V_24 ) ;
F_56 ( V_7 , V_2 -> V_18 ) ;
}
static T_2 F_60 ( int V_109 , void * V_110 )
{
struct V_1 * V_2 = V_110 ;
T_2 V_13 = V_111 ;
T_1 V_112 ;
V_112 = F_1 ( V_2 , V_113 ) ;
F_3 ( V_2 , V_114 , V_112 & V_115 ) ;
if ( V_112 & V_116 ) {
...
int F_64 ( struct V_121 * V_122 , unsigned int V_18 )
{
static const unsigned int V_123 [] = {
V_124 , V_125 , V_126
} ;
struct V_4 * V_5 = V_122 -> V_7 ;
struct V_127 * V_128 = F_65 ( V_5 -> V_7 ) ;
struct V_1 * V_2 = & V_5 -> V_129 [ V_18 ] ;
struct V_49 * V_16 = & V_2 -> V_16 ;
unsigned int V_130 ;
char V_131 [ 5 ] ;
char * V_132 ;
...
V_2 -> V_18 = V_18 ;
V_2 -> V_82 = V_86 ;
V_2 -> V_64 = & V_122 -> V_57 . V_57 [ V_18 % 2 ] ;
V_2 -> V_64 -> V_16 = V_16 ;
V_13 = F_70 ( V_5 -> V_134 , V_16 , & V_135 ) ;
if ( V_13 < 0 )
return V_13 ;
F_71 ( V_16 , & V_136 ) ;
if ( F_22 ( V_5 , V_133 ) ) {
V_109 = F_72 ( V_128 , V_18 ) ;
V_130 = 0 ;
} else {
V_109 = F_72 ( V_128 , 0 ) ;
V_130 = V_137 ;
...
V_13 = F_73 ( V_5 -> V_7 , V_109 , F_60 , V_130 ,
F_74 ( V_5 -> V_7 ) , V_2 ) ;
if ( V_13 < 0 ) {
F_68 ( V_5 -> V_7 ,
L_5 , V_18 ) ;
...
void F_75 ( struct V_1 * V_2 , bool V_138 )
{
if ( V_138 ) {
F_3 ( V_2 , V_114 , V_139 ) ;
F_6 ( V_2 , V_140 , V_141 ) ;
