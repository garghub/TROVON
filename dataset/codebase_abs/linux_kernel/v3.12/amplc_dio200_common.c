...
V_142 = 0xf00000 ;
V_116 = F_57 ( V_9 , V_24 , V_26 , V_27 , V_142 ) ;
if ( V_116 )
return V_116 ;
F_54 ( V_9 , V_24 ) ;
return V_26 -> V_33 ;
...
break;
case V_123 :
V_116 = F_63 ( V_9 , V_24 , V_27 [ 1 ] ) ;
if ( V_116 < 0 )
V_116 = - V_50 ;
break;
case V_124 :
F_61 ( V_9 , V_24 , & V_27 [ 1 ] , & V_27 [ 2 ] ) ;
break;
default:
V_116 = - V_50 ;
break;
...
void F_66 ( struct V_8 * V_9 , unsigned char V_22 )
{
F_10 ( V_9 , V_156 , V_22 ) ;
}
int F_67 ( struct V_8 * V_9 , unsigned int V_94 ,
unsigned long V_157 )
{
const struct V_5 * V_11 = F_6 ( V_9 ) ;
struct V_12 * V_13 = V_9 -> V_14 ;
