...
const char * F_51 ( T_3 V_82 )
{
return F_52 ( V_83 [ V_82 ] ) ;
}
T_3 F_53 ( const char * V_84 )
{
return F_54 ( V_84 ) ;
}
int F_55 ( struct V_85 * V_86 , int V_87 , int V_88 )
{
struct V_89 * V_90 ;
int V_91 = V_86 -> V_92 [ V_87 ] ;
V_90 = F_56 ( V_86 , V_87 , sizeof( * V_90 ) ) ;
if ( V_90 == NULL ) {
F_24 ( L_27 , V_91 ) ;
return - V_93 ;
}
...
if ( F_11 ( V_90 -> V_97 >= V_98 ) ) {
F_24 ( L_29 , V_90 -> V_97 ) ;
return - V_96 ;
}
if ( F_11 ( V_90 -> V_99 != V_100 &&
V_90 -> V_99 != V_101 &&
V_90 -> V_99 != V_102 ) ) {
F_24 ( L_30 , V_90 -> V_99 ) ;
return - V_96 ;
...
int F_58 ( struct V_68 * V_69 , T_3 V_103 ,
void * V_104 , int V_105 )
{
struct V_106 * V_107 ;
int V_108 ;
char V_109 [ 64 ] ;
unsigned int V_110 ;
int V_47 , V_111 ;
F_7 ( V_103 > V_112 && V_103 < V_113 ) ;
F_7 ( V_105 >= 4 ) ;
V_107 = F_59 ( V_83 [ V_103 ] , NULL , 0 ) ;
if ( F_60 ( V_107 ) ) {
F_24 ( L_31 ,
F_52 ( V_83 [ V_103 ] ) ) ;
return F_61 ( V_107 ) ;
}
V_108 = F_62 ( V_83 [ V_103 ] ) ;
for ( V_47 = 0 ; V_47 < V_69 -> V_73 ; V_47 ++ ) {
F_63 ( V_107 , V_69 -> V_114 [ V_47 ] . V_78 ,
V_69 -> V_114 [ V_47 ] . V_115 & ~ V_116 ,
V_69 -> V_114 [ V_47 ] . V_117 ) ;
}
if ( V_108 > V_105 ) {
V_110 = sizeof( V_109 ) ;
V_111 = F_64 ( V_107 , ( unsigned char * ) V_109 ,
& V_110 ) ;
memcpy ( V_104 , V_109 , V_105 ) ;
} else {
V_110 = V_105 ;
V_111 = F_64 ( V_107 , ( unsigned char * ) V_104 ,
& V_110 ) ;
}
if ( V_111 )
F_64 ( V_107 , NULL , NULL ) ;
return V_111 ;
}
