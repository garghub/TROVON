...
static void F_176 ( struct V_36 * V_36 , struct V_91 * V_268 )
{
struct V_70 * V_71 ;
F_2 (lseg, &NFS_I(inode)->layout->plh_segs, pls_list) {
if ( V_71 -> V_97 . V_53 == V_54 &&
F_35 ( V_146 , & V_71 -> V_76 ) )
F_17 ( & V_71 -> V_73 , V_268 ) ;
}
}
static void F_177 ( struct V_36 * V_36 , struct V_91 * V_268 )
{
struct V_70 * V_71 , * V_27 ;
unsigned long * V_269 = & F_28 ( V_36 ) -> V_145 ;
...
void F_183 ( struct V_275 * V_227 )
{
struct V_8 * V_9 = F_22 ( V_227 -> args . V_36 ) ;
if ( V_9 -> V_10 -> V_276 )
V_9 -> V_10 -> V_276 ( V_227 ) ;
F_177 ( V_227 -> args . V_36 , & V_227 -> V_106 ) ;
}
int
...
if ( ! F_42 ( V_144 , & V_48 -> V_145 ) )
goto V_278;
if ( F_33 ( V_270 , & V_48 -> V_145 ) ) {
if ( ! V_277 ) {
V_25 = - V_104 ;
goto V_278;
}
V_25 = F_184 ( & V_48 -> V_145 , V_270 ,
V_279 , V_280 ) ;
if ( V_25 )
goto V_278;
}
...
F_5 ( & V_36 -> V_52 ) ;
if ( ! F_35 ( V_144 , & V_48 -> V_145 ) ) {
F_52 ( V_270 , & V_48 -> V_145 ) ;
F_7 ( & V_36 -> V_52 ) ;
F_180 ( & V_48 -> V_145 , V_270 ) ;
goto V_278;
}
F_176 ( V_36 , & V_227 -> V_106 ) ;
