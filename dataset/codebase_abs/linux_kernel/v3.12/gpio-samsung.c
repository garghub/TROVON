...
F_67 (pctrl_np, exynos_pinctrl_ids)
if ( V_69 && F_68 ( V_69 ) )
return - V_73 ;
#endif
F_23 ( V_56 , F_46 ( V_56 ) ) ;
...
int F_77 ( unsigned int V_63 , unsigned int V_53 )
{
...
F_26 ( V_2 , V_28 ) ;
V_42 = F_79 ( V_2 , V_26 , V_53 ) ;
F_27 ( V_2 , V_28 ) ;
return V_42 ;
}
int F_80 ( unsigned int V_96 , unsigned int V_97 ,
unsigned int V_15 )
{
int V_42 ;
for (; V_97 > 0 ; V_97 -- , V_96 ++ ) {
V_42 = F_77 ( V_96 , V_15 ) ;
if ( V_42 != 0 )
return V_42 ;
}
...
int F_81 ( unsigned int V_96 , unsigned int V_97 ,
...
unsigned F_83 ( unsigned int V_63 )
{
struct V_1 * V_2 = F_78 ( V_63 ) ;
unsigned long V_28 ;
unsigned V_42 = 0 ;
...
int F_82 ( unsigned int V_63 , T_1 V_4 )
{
struct V_1 * V_2 = F_78 ( V_63 ) ;
unsigned long V_28 ;
int V_26 , V_42 ;
...
V_26 = V_63 - V_2 -> V_2 . V_6 ;
F_26 ( V_2 , V_28 ) ;
V_42 = F_85 ( V_2 , V_26 , V_4 ) ;
F_27 ( V_2 , V_28 ) ;
return V_42 ;
}
T_1 F_86 ( unsigned int V_63 )
{
struct V_1 * V_2 = F_78 ( V_63 ) ;
unsigned long V_28 ;
int V_26 ;
...
int F_89 ( unsigned int V_63 , T_5 V_98 )
{
struct V_1 * V_2 = F_78 ( V_63 ) ;
unsigned int V_3 ;
void T_2 * V_5 ;
...
unsigned int F_90 ( unsigned int V_100 , unsigned int V_101 )
{
unsigned long V_28 ;
unsigned long V_102 ;
F_38 ( V_28 ) ;
