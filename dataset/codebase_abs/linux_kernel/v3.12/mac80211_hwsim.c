...
F_5 ( V_148 -> V_11 ) ;
if ( V_177 )
F_78 ( V_173 -> V_148 . V_2 , V_148 -> V_11 , V_21 ,
V_173 -> V_148 . V_126 ,
F_79 ( V_173 -> V_148 . V_126 ) ) ;
V_173 -> V_178 [ 0 ] = V_137 ;
...
struct V_38 * V_39 )
{
T_4 V_191 = F_80 ( V_179 ) ;
if ( V_177 ) {
struct V_43 * V_173 = F_24 ( V_21 ) ;
F_78 ( V_173 -> V_148 . V_2 , NULL , V_21 ,
V_173 -> V_148 . V_126 ,
F_79 ( V_173 -> V_148 . V_126 ) ) ;
}
F_23 ( V_30 , V_21 , V_39 ) ;
...
static void F_92 ( void * V_192 , T_7 * V_92 ,
struct V_1 * V_2 )
{
...
static enum V_201
F_94 ( struct V_202 * V_203 )
{
struct V_25 * V_26 =
F_95 ( V_203 , struct V_25 ,
V_182 . V_203 ) ;
struct V_29 * V_30 = V_26 -> V_30 ;
T_2 V_33 = V_26 -> V_34 ;
T_8 V_204 ;
...
V_204 = F_96 ( F_97 ( V_203 ) ,
F_98 ( V_33 * 1000 ) ) ;
F_99 ( & V_26 -> V_182 , V_204 , V_206 ) ;
V_205:
return V_207 ;
}
static int F_100 ( struct V_29 * V_30 , T_4 V_208 )
{
struct V_25 * V_26 = V_30 -> V_31 ;
...
F_85 ( & V_26 -> V_182 ) ;
else if ( ! F_101 ( & V_26 -> V_182 . V_203 ) ) {
...
struct V_25 * V_26 = V_30 -> V_31 ;
F_1 ( V_2 ) ;
F_77 ( V_30 -> V_90 , L_15 , V_131 , V_208 ) ;
if ( V_208 & V_234 ) {
F_77 ( V_30 -> V_90 , L_16 ,
V_131 , V_44 -> V_235 ) ;
...
if ( V_208 & V_239 ) {
F_77 ( V_30 -> V_90 , L_18 , V_44 -> V_34 ) ;
V_26 -> V_34 = V_44 -> V_34 * 1024 ;
}
if ( V_208 & V_240 ) {
F_77 ( V_30 -> V_90 , L_19 , V_44 -> V_241 ) ;
if ( V_26 -> V_164 &&
! F_101 ( & V_26 -> V_182 . V_203 ) &&
V_44 -> V_241 ) {
T_2 V_32 , V_225 ;
T_4 V_33 ;
if ( F_6 ( ! V_26 -> V_34 ) )
...
if ( V_208 & V_246 ) {
F_77 ( V_30 -> V_90 , L_22 , V_44 -> V_247 ) ;
}
if ( V_208 & V_248 ) {
F_77 ( V_30 -> V_90 , L_23 ,
V_44 -> V_249 ) ;
...
if ( V_208 & V_252 )
F_77 ( V_30 -> V_90 , L_25 , V_44 -> V_253 ) ;
}
...
{
struct V_209 * V_210 = & V_30 -> V_210 ;
F_77 ( V_30 -> V_90 , L_28 , V_131 , V_124 ) ;
if ( V_124 != 0 )
return - V_268 ;
...
struct V_20 * V_21 ;
int V_276 , V_84 ;
V_276 = F_111 ( V_274 , V_275 , V_26 , V_118 ,
V_277 ) ;
if ( V_276 )
return V_276 ;
if ( ! V_274 [ V_278 ] )
return - V_279 ;
switch ( F_112 ( V_274 [ V_278 ] ) ) {
case V_280 :
if ( ! V_274 [ V_281 ] )
return - V_279 ;
V_84 = F_112 ( V_274 [ V_281 ] ) ;
return F_113 ( V_272 , V_84 ) ;
case V_282 :
V_21 = F_114 ( V_30 -> V_90 ,
F_115 ( sizeof( T_4 ) ) ) ;
if ( ! V_21 )
return - V_283 ;
...
static void F_123 ( struct V_29 * V_30 , T_4 V_300 , bool V_301 )
{
}
static void F_124 ( struct V_302 * V_303 )
{
struct V_25 * V_272 =
F_95 ( V_303 , struct V_25 , V_304 . V_303 ) ;
struct V_305 * V_306 = V_272 -> V_307 ;
int V_308 , V_101 ;
F_125 ( & V_272 -> V_309 ) ;
if ( V_272 -> V_310 >= V_306 -> V_311 ) {
F_77 ( V_272 -> V_30 -> V_90 , L_29 ) ;
F_126 ( V_272 -> V_30 , false ) ;
V_272 -> V_307 = NULL ;
V_272 -> V_312 = NULL ;
V_272 -> V_166 = NULL ;
F_127 ( & V_272 -> V_309 ) ;
...
V_306 -> V_319 ) ;
F_129 () ;
F_91 ( V_272 -> V_30 , V_315 ,
V_272 -> V_166 ) ;
F_130 () ;
}
}
F_131 ( V_272 -> V_30 , & V_272 -> V_304 ,
F_132 ( V_308 ) ) ;
V_272 -> V_310 ++ ;
F_127 ( & V_272 -> V_309 ) ;
}
...
F_127 ( & V_272 -> V_309 ) ;
F_77 ( V_30 -> V_90 , L_31 ) ;
F_131 ( V_272 -> V_30 , & V_272 -> V_304 , 0 ) ;
return 0 ;
}
...
static void F_138 ( struct V_302 * V_303 )
{
struct V_25 * V_272 =
F_95 ( V_303 , struct V_25 , V_323 . V_303 ) ;
F_125 ( & V_272 -> V_309 ) ;
F_139 ( V_272 -> V_30 ) ;
V_272 -> V_166 = NULL ;
F_127 ( & V_272 -> V_309 ) ;
F_77 ( V_272 -> V_30 -> V_90 , L_36 ) ;
}
...
static int F_146 ( struct V_29 * V_30 ,
struct V_1 * V_2 ,
struct V_15 * V_326 )
{
F_1 ( V_2 ) ;
...
F_149 ( & V_328 ) ;
F_150 ( & V_162 ) ;
F_151 (i, tmp, &hwsim_radios)
F_152 ( V_101 , & V_328 ) ;
F_153 ( & V_162 ) ;
F_154 (data, tmpdata, &tmplist, list) {
F_155 ( V_26 -> V_331 ) ;
F_155 ( V_26 -> V_332 ) ;
F_155 ( V_26 -> V_333 ) ;
F_156 ( V_26 -> V_30 ) ;
...
static void F_163 ( void * V_342 , T_7 * V_92 , struct V_1 * V_2 )
{
...
static void F_166 ( struct V_25 * V_26 , T_7 * V_92 ,
...
{
struct V_25 * V_26 = V_342 ;
F_166 ( V_26 , V_92 , V_2 , 1 ) ;
}
static void F_168 ( void * V_342 , T_7 * V_92 ,
struct V_1 * V_2 )
{
struct V_25 * V_26 = V_342 ;
F_166 ( V_26 , V_92 , V_2 , 0 ) ;
}
static int F_169 ( void * V_342 , T_2 * V_350 )
{
struct V_25 * V_26 = V_342 ;
* V_350 = V_26 -> V_84 ;
return 0 ;
}
static int F_113 ( void * V_342 , T_2 V_350 )
{
struct V_25 * V_26 = V_342 ;
enum V_351 V_352 ;
...
static int F_172 ( void * V_342 , T_2 V_350 )
{
struct V_25 * V_26 = V_342 ;
V_26 -> V_167 = V_350 ;
return 0 ;
}
static struct V_25 * F_173 (
struct V_115 * V_8 )
{
struct V_25 * V_26 ;
bool V_353 = false ;
...
static int F_174 ( struct V_20 * V_354 ,
struct V_355 * V_44 )
{
struct V_76 * V_41 ;
struct V_25 * V_140 ;
...
! V_44 -> V_359 [ V_128 ] )
goto V_205;
V_357 = (struct V_115 * ) F_175 (
V_44 -> V_359 [ V_114 ] ) ;
V_100 = F_112 ( V_44 -> V_359 [ V_123 ] ) ;
V_356 = F_176 ( V_44 -> V_359 [ V_129 ] ) ;
V_140 = F_173 ( V_357 ) ;
if ( V_140 == NULL )
goto V_205;
F_177 (&data2->pending, skb, tmp) {
if ( ( unsigned long ) V_21 == V_356 ) {
F_178 ( V_21 , & V_140 -> V_106 ) ;
V_358 = true ;
break;
}
}
...
V_173 -> V_125 . V_360 = F_112 ( V_44 -> V_359 [ V_361 ] ) ;
if ( ! ( V_100 & V_122 ) &&
( V_100 & V_362 ) ) {
if ( V_21 -> V_118 >= 16 ) {
...
F_82 ( V_140 -> V_30 , V_21 ) ;
return 0 ;
V_205:
return - V_279 ;
}
static int F_179 ( struct V_20 * V_354 ,
struct V_355 * V_44 )
{
struct V_25 * V_140 ;
struct V_142 V_143 ;
...
! V_44 -> V_359 [ V_361 ] )
goto V_205;
V_363 = (struct V_115 * ) F_175 (
V_44 -> V_359 [ V_366 ] ) ;
V_364 = F_180 ( V_44 -> V_359 [ V_117 ] ) ;
V_365 = ( char * ) F_175 ( V_44 -> V_359 [ V_117 ] ) ;
V_21 = F_181 ( V_364 , V_368 ) ;
if ( V_21 == NULL )
goto V_276;
if ( V_364 <= V_369 ) {
...
V_143 . V_150 = F_112 ( V_44 -> V_359 [ V_367 ] ) ;
V_143 . signal = F_112 ( V_44 -> V_359 [ V_361 ] ) ;
...
static int F_182 ( struct V_20 * V_354 ,
struct V_355 * V_44 )
{
if ( V_44 == NULL )
goto V_205;
...
static int F_183 ( struct V_371 * V_372 ,
unsigned long V_373 ,
void * V_374 )
{
...
V_26 = V_30 -> V_31 ;
V_26 -> V_30 = V_30 ;
V_26 -> V_23 = F_197 ( V_334 , NULL , 0 , V_30 ,
L_56 , V_101 ) ;
if ( F_194 ( V_26 -> V_23 ) ) {
F_46 ( V_113
L_57 ,
...
F_201 ( & V_26 -> V_323 , F_138 ) ;
F_201 ( & V_26 -> V_304 , F_124 ) ;
V_30 -> V_414 = 1 ;
V_30 -> V_300 = 5 ;
V_30 -> V_415 = 4 ;
V_30 -> V_90 -> V_416 =
...
V_430 |
V_431 ;
V_30 -> V_90 -> V_432 |= V_433 ;
V_30 -> V_434 = sizeof( struct V_3 ) ;
V_30 -> V_435 = sizeof( struct V_12 ) ;
V_30 -> V_436 = sizeof( struct V_17 ) ;
memcpy ( V_26 -> V_437 , V_438 ,
sizeof( V_438 ) ) ;
memcpy ( V_26 -> V_439 , V_440 ,
sizeof( V_440 ) ) ;
memcpy ( V_26 -> V_126 , V_441 , sizeof( V_441 ) ) ;
for ( V_147 = V_442 ; V_147 < V_443 ; V_147 ++ ) {
struct V_444 * V_445 = & V_26 -> V_446 [ V_147 ] ;
switch ( V_147 ) {
case V_442 :
V_445 -> V_175 = V_26 -> V_437 ;
V_445 -> V_311 =
F_79 ( V_438 ) ;
V_445 -> V_447 = V_26 -> V_126 ;
V_445 -> V_448 = F_79 ( V_441 ) ;
break;
case V_449 :
V_445 -> V_175 = V_26 -> V_439 ;
V_445 -> V_311 =
F_79 ( V_440 ) ;
V_445 -> V_447 = V_26 -> V_126 + 4 ;
V_445 -> V_448 = F_79 ( V_441 ) - 4 ;
break;
default:
continue;
}
V_445 -> V_450 . V_451 = true ;
V_445 -> V_450 . V_452 = V_453 |
V_454 |
V_455 |
V_456 ;
V_445 -> V_450 . V_457 = 0x3 ;
V_445 -> V_450 . V_458 = 0x6 ;
memset ( & V_445 -> V_450 . V_459 , 0 ,
sizeof( V_445 -> V_450 . V_459 ) ) ;
V_445 -> V_450 . V_459 . V_460 [ 0 ] = 0xff ;
V_445 -> V_450 . V_459 . V_460 [ 1 ] = 0xff ;
V_445 -> V_450 . V_459 . V_461 = V_462 ;
V_30 -> V_90 -> V_446 [ V_147 ] = V_445 ;
V_445 -> V_463 . V_464 = true ;
V_445 -> V_463 . V_452 =
V_465 |
V_466 |
V_467 |
...
F_77 ( V_30 -> V_90 , L_60 ,
V_30 -> V_90 -> V_91 ) ;
V_26 -> V_333 = F_208 ( L_61 ,
V_30 -> V_90 -> V_500 ) ;
V_26 -> V_332 = F_209 ( L_62 , 0666 ,
V_26 -> V_333 , V_26 ,
& V_501 ) ;
V_26 -> V_331 = F_209 ( L_63 , 0666 ,
V_26 -> V_333 , V_26 ,
& V_502 ) ;
F_210 ( & V_26 -> V_182 ,
F_94 ,
V_503 , V_206 ) ;
F_211 ( & V_26 -> V_504 , & V_400 ) ;
}
V_47 = F_212 ( 0 , L_56 , F_161 ) ;
if ( V_47 == NULL ) {
V_276 = - V_283 ;
goto V_404;
}
F_213 () ;
V_276 = F_214 ( V_47 , V_47 -> V_505 ) ;
if ( V_276 < 0 )
goto V_506;
V_276 = F_215 ( V_47 ) ;
if ( V_276 < 0 )
