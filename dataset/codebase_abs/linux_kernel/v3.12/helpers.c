...
V_29 = & V_2 -> V_6 -> V_31 [ V_20 ] ;
if ( ! ( V_15 <= V_29 -> V_16 && V_16 >= V_29 -> V_15 ) )
continue;
if ( V_15 <= V_29 -> V_15 )
V_15 = V_29 -> V_15 ;
if ( V_29 -> V_26 == 0 ) {
...
if ( V_19 >= V_2 -> V_6 -> V_21 )
return - V_24 ;
return V_2 -> V_6 -> V_34 [ V_19 ] ;
}
int F_18 ( struct V_1 * V_2 , bool V_35 )
{
unsigned int V_3 ;
if ( V_35 )
V_3 = V_2 -> V_6 -> V_36 ;
...
V_3 = 0 ;
return F_4 ( V_2 -> V_5 , V_2 -> V_6 -> V_37 ,
V_2 -> V_6 -> V_36 , V_3 ) ;
}
int F_19 ( struct V_1 * V_2 , bool * V_35 )
{
unsigned int V_3 ;
int V_4 ;
V_4 = F_2 ( V_2 -> V_5 , V_2 -> V_6 -> V_37 , & V_3 ) ;
if ( V_4 != 0 )
return V_4 ;
* V_35 = V_3 & V_2 -> V_6 -> V_36 ;
return 0 ;
}
