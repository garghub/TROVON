...
int V_58 ;
V_56 = F_52 ( ( unsigned long ) & V_59 ) ;
V_57 = ( unsigned long ) & V_60 & V_61 ;
for ( V_58 = 0 ; V_58 < V_62 ; V_58 ++ ) {
if ( ! V_63 [ V_58 ] . V_14 )
continue;
V_13 = V_63 [ V_58 ] . V_64 ;
V_16 = V_63 [ V_58 ] . V_64 + V_63 [ V_58 ] . V_14 ;
...
if ( ! V_45 )
F_54 ( L_1 ) ;
V_45 -> V_13 = V_63 [ V_58 ] . V_64 ;
V_45 -> V_14 = V_63 [ V_58 ] . V_14 ;
F_39 ( V_45 ) ;
}
F_48 ( & V_52 ) ;
return 0 ;
