...
F_41 ( V_4 -> V_87 ) ;
V_2 -> V_62 = F_42 ( V_9 , 0 ) ;
V_78 = F_43 ( & V_9 -> V_2 , V_2 -> V_62 , F_24 , 0 , V_2 -> V_88 , V_2 ) ;
if ( V_78 )
goto V_89;
F_44 ( V_2 ) ;
V_2 -> V_90 = & V_91 ;
...
F_45 ( V_9 , V_2 ) ;
F_46 ( V_2 , & V_9 -> V_2 ) ;
V_80 = F_47 ( V_9 -> V_2 . V_94 ) ;
if ( V_80 )
memcpy ( V_4 -> V_2 -> V_95 , V_80 , V_96 ) ;
else
F_48 ( V_4 ) ;
V_78 = F_49 ( V_9 -> V_2 . V_94 ) ;
if ( V_78 < 0 ) {
if ( V_73 && V_73 -> V_97 )
V_4 -> V_98 = V_99 ;
else
...
F_6 ( V_4 , V_22 , 0 ) ;
V_79 = F_18 ( V_101 , V_102 ) | F_5 ( V_103 ) ;
if ( V_4 -> V_98 == V_99 )
V_79 |= F_5 ( V_104 ) ;
F_6 ( V_4 , V_105 , V_79 ) ;
V_78 = F_50 ( V_2 ) ;
...
V_77 = V_4 -> V_35 ;
F_53 ( V_2 , L_4 ,
V_77 -> V_107 -> V_88 , F_54 ( & V_77 -> V_2 ) ,
V_77 -> V_62 ) ;
F_53 ( V_2 , L_5 ,
V_2 -> V_84 , V_2 -> V_62 , V_2 -> V_95 ) ;
return 0 ;
V_106:
F_55 ( V_2 ) ;
V_89:
...
static int F_64 ( struct V_71 * V_9 , T_5 V_109 )
{
struct V_1 * V_110 = F_59 ( V_9 ) ;
struct V_3 * V_4 = F_2 ( V_110 ) ;
if ( F_65 ( V_110 ) ) {
F_13 ( V_110 ) ;
F_66 ( V_110 ) ;
F_56 ( V_4 -> V_87 ) ;
