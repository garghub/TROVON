...
if ( V_9 < 0 )
return V_9 ;
V_7 = F_13 ( & V_43 -> V_16 , sizeof( struct V_6 ) ,
V_50 ) ;
if ( V_7 == NULL )
return - V_51 ;
V_7 -> V_20 = F_14 ( V_43 , & V_52 ) ;
if ( F_15 ( V_7 -> V_20 ) ) {
V_9 = F_16 ( V_7 -> V_20 ) ;
return V_9 ;
}
if ( V_45 ) {
enum V_53 V_54 ;
int V_55 = F_17 ( V_45 , L_3 , 0 , & V_54 ) ;
if ( F_18 ( V_55 ) ) {
V_9 = F_19 ( & V_43 -> V_16 , V_55 ,
V_54 & V_56 ?
V_57 : V_58 ,
L_4 ) ;
if ( V_9 < 0 )
