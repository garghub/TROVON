...
if ( ! V_91 [ V_93 ] )
continue;
error = F_61 ( V_91 [ V_93 ] , V_41 , V_42 , args ) ;
F_59 ( V_91 [ V_93 ] ) ;
if ( error == V_45 ) {
V_87 ++ ;
continue;
...
struct V_100 * V_101 )
{
struct V_2 * V_3 = F_11 ( F_70 ( V_101 ) ,
struct V_2 , V_98 ) ;
F_71 ( V_3 , NULL ) ;
F_65 ( V_3 ) ;
}
...
T_10 V_102 ;
V_102 = 0 ;
while ( ( V_41 = F_75 ( V_3 , V_102 , V_84 ) ) ) {
V_102 = V_41 -> V_94 + 1 ;
error = F_60 ( V_3 , V_41 , F_61 , V_42 , args , V_84 ) ;
F_50 ( V_41 ) ;
if ( error ) {
V_86 = error ;
if ( error == V_83 )
...
{
F_24 () ;
if ( F_66 ( & V_3 -> V_95 , V_103 ) ) {
F_67 ( V_3 -> V_104 , & V_3 -> V_105 ,
F_68 ( V_106 / 6 * 10 ) ) ;
}
F_23 () ;
}
...
V_102 = 0 ;
V_87 = 0 ;
while ( ( V_41 = F_75 ( V_3 , V_102 , V_103 ) ) ) {
...
if ( ! V_91 [ V_93 ] )
continue;
error = F_88 ( V_91 [ V_93 ] , V_41 , V_42 ) ;
if ( error && V_86 != V_83 )
V_86 = error ;
}
* V_121 -= V_92 ;
...
F_76 ( V_3 ) ;
F_106 ( V_3 -> V_127 ) ;
return F_101 ( V_3 , V_107 | V_116 , & V_121 ) ;
}
int
F_107 (
struct V_2 * V_3 )
...
! F_109 ( F_4 ( V_5 ) -> V_133 , V_130 -> V_134 ) )
return 0 ;
if ( ( V_130 -> V_131 & V_135 ) &&
! F_110 ( F_4 ( V_5 ) -> V_136 , V_130 -> V_137 ) )
return 0 ;
if ( ( V_130 -> V_131 & V_138 ) &&
F_111 ( V_5 ) != V_130 -> V_139 )
return 0 ;
return 1 ;
}
STATIC int
...
if ( ! ( V_42 & V_116 ) &&
F_116 ( F_4 ( V_5 ) -> V_141 , V_142 ) )
return 0 ;
if ( V_130 ) {
if ( ! F_108 ( V_5 , V_130 ) )
return 0 ;
if ( V_130 -> V_131 & V_143 &&
F_117 ( V_5 ) < V_130 -> V_144 )
return 0 ;
}
V_140 = F_118 ( V_5 -> V_14 , V_5 , true ) ;
...
F_33 ( V_5 -> V_14 , V_5 -> V_11 ) ,
V_96 ) ;
if ( ! F_66 ( & V_41 -> V_70 , V_96 ) ) {
F_16 ( & V_5 -> V_14 -> V_109 ) ;
F_85 ( & V_5 -> V_14 -> V_95 ,
F_47 ( V_5 -> V_14 , V_5 -> V_11 ) ,
V_96 ) ;
F_17 ( & V_5 -> V_14 -> V_109 ) ;
F_123 ( V_5 -> V_14 , V_41 -> V_94 ,
- 1 , V_110 ) ;
}
F_17 ( & V_41 -> V_51 ) ;
F_50 ( V_41 ) ;
