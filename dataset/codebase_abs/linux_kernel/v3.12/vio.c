...
const T_6 * V_6 ;
enum V_163 V_85 ;
const char * V_164 = V_4 -> V_159 ? V_4 -> V_159 : L_18 ;
V_162 = F_92 ( V_4 ) ;
if ( V_162 ) {
if ( ! strcmp ( V_162 -> V_165 , L_19 ) )
V_85 = V_87 ;
else if ( ! strcmp ( V_162 -> V_165 , L_20 ) )
V_85 = V_86 ;
else {
F_93 ( L_21 ,
V_89 ,
...
V_166 = F_94 ( V_6 , 1 ) ;
F_95 ( & V_8 -> V_49 , L_30 , V_166 ) ;
V_8 -> V_167 = F_96 ( V_4 , 0 ) ;
V_8 -> V_166 = V_166 ;
} else {
V_6 = F_40 ( V_4 , L_31 , NULL ) ;
if ( V_6 != NULL )
V_8 -> V_120 = F_94 ( V_6 , 1 ) ;
F_95 ( & V_8 -> V_49 , L_32 , V_164 ) ;
V_8 -> type = V_164 ;
V_8 -> V_167 = 0 ;
}
V_8 -> V_159 = V_4 -> V_159 ;
V_8 -> V_49 . V_4 = F_97 ( V_4 ) ;
...
F_100 ( & V_8 -> V_49 ,
F_72 ( V_8 ) ) ;
F_101 ( & V_8 -> V_49 , F_102 ( 64 ) ) ;
F_103 ( & V_8 -> V_49 , F_102 ( 64 ) ) ;
}
if ( F_104 ( & V_8 -> V_49 ) ) {
F_58 ( V_99 L_33 ,
V_89 , F_105 ( & V_8 -> V_49 ) ) ;
...
V_176 = F_40 ( V_175 , L_39 , NULL ) ;
if ( ! V_176 ) {
strcat ( V_103 , L_38 ) ;
return strlen ( V_103 ) ;
}
return sprintf ( V_103 , L_40 , V_7 -> type , V_176 ) ;
}
...
if ( ! V_176 )
return - V_152 ;
F_118 ( V_181 , L_41 , V_7 -> type , V_176 ) ;
return 0 ;
}
...
if ( ! V_185 )
return NULL ;
V_186 = F_40 ( V_185 , L_42 , NULL ) ;
F_5 ( V_185 ) ;
if ( ! V_186 )
return NULL ;
if ( ! strcmp ( V_186 , L_1 ) ) {
const T_6 * V_6 ;
V_6 = F_40 ( V_183 , L_28 , NULL ) ;
if ( ! V_6 )
return NULL ;
snprintf ( V_184 , sizeof( V_184 ) , L_30 ,
( V_187 ) F_94 ( V_6 , 1 ) ) ;
} else if ( ! strcmp ( V_186 , L_36 ) )
snprintf ( V_184 , sizeof( V_184 ) , L_32 , V_183 -> V_159 ) ;
else
return NULL ;
return F_120 ( V_184 ) ;
}
