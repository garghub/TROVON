...
V_301 -> V_323 = 9 ;
V_301 -> V_324 = 0 ;
V_301 -> V_325 = F_183 ( 0x0011 ) ;
V_301 -> V_326 . V_327 . V_328 [ 0 ] =
( ( 1 << V_1 -> V_57 ) - 1 ) << 1 ;
V_301 -> V_326 . V_327 . V_328 [ 1 ] = ~ 0 ;
}
static int F_184 ( struct V_250 * V_251 , T_1 V_329 , T_1 V_330 ,
T_1 V_331 , char * V_258 , T_1 V_332 )
{
struct V_1 * V_1 = F_154 ( V_251 ) ;
int V_37 ;
int V_13 = ( V_331 & 0x00FF ) - 1 ;
struct V_198 * V_199 = & V_1 -> V_113 [ V_13 ] ;
unsigned long V_293 ;
V_37 = 0 ;
F_158 ( & V_1 -> V_177 , V_293 ) ;
...
struct V_1 * V_1 = F_154 ( V_251 ) ;
int V_13 ;
F_49 ( & V_1 -> V_101 . V_63 -> V_65 , L_20 , V_353 ) ;
for ( V_13 = 0 ; V_13 < V_1 -> V_57 ; V_13 ++ ) {
struct V_198 * V_199 = & V_1 -> V_113 [ V_13 ] ;
unsigned long V_289 = F_156 ( V_13 ) ;
if ( ! ( V_199 -> V_13 & V_216 ) )
...
V_199 -> V_13 &= ~ V_354 ;
V_199 -> V_13 |= V_357 << 16 ;
F_12 ( V_1 , V_358 , V_358 | V_291 , V_289 ) ;
F_14 ( 50 ) ;
F_12 ( V_1 , V_291 , V_358 | V_291 , V_289 ) ;
}
return 0 ;
}
static int F_188 ( struct V_359 * V_65 )
{
struct V_1 * V_1 = F_28 ( V_65 ) ;
int V_13 ;
F_49 ( V_65 , L_20 , V_353 ) ;
F_26 ( V_1 ) ;
for ( V_13 = 0 ; V_13 < V_1 -> V_57 ; V_13 ++ ) {
struct V_198 * V_199 = & V_1 -> V_113 [ V_13 ] ;
...
static int F_189 ( struct V_359 * V_65 )
{
struct V_1 * V_1 = F_28 ( V_65 ) ;
struct V_250 * V_251 = F_92 ( V_1 ) ;
F_49 ( V_65 , L_20 , V_353 ) ;
...
static int F_191 ( struct V_360 * V_361 )
{
struct V_1 * V_1 = F_192 ( V_361 ) ;
struct V_250 * V_251 = F_92 ( V_1 ) ;
F_193 ( & V_1 -> V_194 ) ;
F_194 ( V_251 ) ;
F_195 ( V_1 -> V_3 ) ;
...
static int F_198 ( struct V_360 * V_361 )
{
char V_362 [ 8 ] ;
struct V_363 * V_364 = NULL , * V_365 ;
int V_366 = - 1 ;
void T_7 * V_3 = NULL ;
...
if ( V_361 -> V_65 . V_368 ) {
V_37 = - V_369 ;
F_48 ( & V_361 -> V_65 , L_23 ) ;
goto V_370;
}
V_364 = F_200 ( V_361 , V_371 , 0 ) ;
if ( ! V_364 ) {
V_37 = - V_188 ;
F_48 ( & V_361 -> V_65 , L_24 ) ;
goto V_370;
}
V_365 = F_200 ( V_361 , V_372 , 0 ) ;
if ( ! V_365 ) {
V_37 = - V_188 ;
F_48 ( & V_361 -> V_65 ,
L_25 ) ;
...
V_366 = V_365 -> V_373 ;
V_367 = V_365 -> V_293 & V_374 ;
V_3 = F_201 ( V_364 -> V_373 , F_202 ( V_364 ) ) ;
if ( V_3 == NULL ) {
V_37 = - V_106 ;
F_48 ( & V_361 -> V_65 , L_26 ) ;
goto V_370;
}
if ( V_361 -> V_65 . V_375 == NULL ) {
F_48 ( & V_361 -> V_65 , L_27 ) ;
V_37 = - V_188 ;
goto V_370;
}
V_251 = F_203 ( & V_376 , & V_361 -> V_65 , ( char * ) V_377 ) ;
if ( ! V_251 ) {
V_37 = - V_106 ;
F_48 ( & V_361 -> V_65 , L_28 ) ;
goto V_370;
}
V_1 = F_154 ( V_251 ) ;
memset ( V_1 , 0 , sizeof( struct V_1 ) ) ;
F_204 ( V_361 , V_1 ) ;
V_1 -> V_17 = F_205 ( & V_361 -> V_65 ) ;
V_1 -> V_41 = V_367 == V_378 ;
if ( V_1 -> V_17 -> V_18 ) {
snprintf ( V_362 , sizeof( V_362 ) , L_29 , V_361 -> V_379 ) ;
V_1 -> V_19 = F_206 ( & V_361 -> V_65 , V_362 ) ;
if ( F_207 ( V_1 -> V_19 ) ) {
F_48 ( & V_361 -> V_65 , L_30 ,
V_362 ) ;
V_37 = F_208 ( V_1 -> V_19 ) ;
goto V_380;
}
...
F_209 ( & V_1 -> V_177 ) ;
F_210 ( & V_1 -> V_194 ) ;
V_1 -> V_194 . V_381 = F_163 ;
V_1 -> V_194 . V_382 = ( unsigned long ) V_1 ;
V_1 -> V_3 = V_3 ;
V_37 = F_9 ( V_1 ) ;
if ( V_37 < 0 )
goto V_383;
...
F_45 ( & V_1 -> V_186 [ V_16 ] ) ;
F_210 ( & V_1 -> V_248 [ V_16 ] ) ;
V_1 -> V_248 [ V_16 ] . V_381 = F_161 ;
V_1 -> V_248 [ V_16 ] . V_382 = ( unsigned long ) V_1 ;
F_211 ( & V_1 -> V_295 [ V_16 ] ,
F_157 ,
( unsigned long ) V_1 ) ;
}
F_45 ( & V_1 -> V_112 ) ;
V_251 -> V_384 = V_364 -> V_373 ;
V_251 -> V_385 = 1 ;
V_37 = F_212 ( V_251 , V_366 , V_367 ) ;
if ( V_37 != 0 ) {
F_48 ( & V_361 -> V_65 , L_31 ) ;
goto V_383;
}
return 0 ;
V_383:
