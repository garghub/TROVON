...
{
struct V_1 * V_2 ;
struct V_94 * V_95 = F_26 ( & V_93 -> V_8 ) ;
int V_6 ;
T_1 V_88 ;
if ( ! V_95 ) {
F_3 ( & V_93 -> V_8 , L_22 ) ;
...
V_2 = F_27 ( sizeof( * V_2 ) , V_96 ) ;
if ( ! V_2 )
return - V_97 ;
V_2 -> V_8 = & V_93 -> V_8 ;
V_2 -> V_38 = ( V_95 -> V_98 == 1 ) ?
V_99 : V_100 ;
V_2 -> V_49 = ( V_95 -> V_98 == 1 ) ?
V_101 : V_102 ;
V_6 = F_24 ( V_2 , 1 ) ;
if ( V_6 < 0 )
goto V_103;
...
{
struct V_1 * V_2 = F_35 ( V_93 ) ;
F_36 ( F_32 ( V_93 , 0 ) , V_2 ) ;
F_23 ( V_2 , 0 , 0 ) ;
F_24 ( V_2 , 0 ) ;
F_33 ( V_2 ) ;
return 0 ;
