...
static int F_137 ( struct V_246 * V_247 [] , struct V_246 * V_64 [] )
{
T_3 V_32 ;
if ( ! V_64 )
return 0 ;
V_32 = 0 ;
if ( V_64 [ V_248 ] )
V_32 |= F_138 ( V_64 [ V_248 ] ) ;
if ( V_64 [ V_249 ] )
V_32 |= F_138 ( V_64 [ V_249 ] ) ;
if ( V_32 & ( V_69 | V_68 ) )
return - V_221 ;
return 0 ;
}
static int F_139 ( struct V_246 * V_247 [] , struct V_246 * V_64 [] )
{
struct V_1 V_70 ;
if ( V_247 [ V_250 ] ) {
if ( F_140 ( V_247 [ V_250 ] ) != V_251 )
return - V_221 ;
if ( ! F_141 ( F_142 ( V_247 [ V_250 ] ) ) )
return - V_252 ;
}
if ( ! V_64 )
goto V_253;
if ( V_64 [ V_254 ] ) {
F_143 ( & V_70 , V_64 [ V_254 ] , sizeof( struct V_1 ) ) ;
if ( F_14 ( & V_70 ) )
return - V_221 ;
}
V_253:
return F_137 ( V_247 , V_64 ) ;
}
static void F_144 ( struct V_246 * V_64 [] ,
struct V_35 * V_28 )
{
...
return;
if ( V_64 [ V_255 ] )
V_28 -> V_13 = F_145 ( V_64 [ V_255 ] ) ;
if ( V_64 [ V_248 ] )
V_28 -> V_106 = F_138 ( V_64 [ V_248 ] ) ;
if ( V_64 [ V_249 ] )
V_28 -> V_51 = F_138 ( V_64 [ V_249 ] ) ;
if ( V_64 [ V_256 ] )
V_28 -> V_31 = F_146 ( V_64 [ V_256 ] ) ;
if ( V_64 [ V_257 ] )
V_28 -> V_160 = F_146 ( V_64 [ V_257 ] ) ;
if ( V_64 [ V_258 ] )
F_143 ( & V_28 -> V_29 , V_64 [ V_258 ] , sizeof( struct V_1 ) ) ;
if ( V_64 [ V_254 ] )
F_143 ( & V_28 -> V_30 , V_64 [ V_254 ] , sizeof( struct V_1 ) ) ;
if ( V_64 [ V_259 ] )
V_28 -> V_156 = F_147 ( V_64 [ V_259 ] ) ;
if ( V_64 [ V_260 ] )
V_28 -> V_81 = F_147 ( V_64 [ V_260 ] ) ;
if ( V_64 [ V_261 ] )
V_28 -> V_193 = F_145 ( V_64 [ V_261 ] ) ;
if ( V_64 [ V_262 ] )
V_28 -> V_32 = F_145 ( V_64 [ V_262 ] ) ;
}
...
static int F_151 ( struct V_12 * V_264 , struct V_6 * V_7 ,
struct V_246 * V_247 [] , struct V_246 * V_64 [] )
{
struct V_5 * V_44 ;
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
...
return - V_222 ;
if ( V_7 -> type == V_24 && ! V_247 [ V_250 ] )
F_152 ( V_7 ) ;
V_44 -> V_7 = V_7 ;
V_44 -> V_12 = F_5 ( V_7 ) ;
F_25 ( V_44 , ! V_247 [ V_265 ] ) ;
if ( ! ( V_44 -> V_28 . V_51 & V_52 ) )
V_7 -> V_53 |= V_54 ;
V_91 = F_26 ( V_7 ) ;
if ( V_91 )
...
static int F_153 ( struct V_6 * V_7 , struct V_246 * V_247 [] ,
struct V_246 * V_64 [] )
{
struct V_5 * V_17 , * V_44 ;
struct V_12 * V_12 = F_5 ( V_7 ) ;
...
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_157 ( V_56 , V_255 , V_36 -> V_13 ) ||
F_158 ( V_56 , V_248 , V_36 -> V_106 ) ||
F_158 ( V_56 , V_249 , V_36 -> V_51 ) ||
F_159 ( V_56 , V_256 , V_36 -> V_31 ) ||
F_159 ( V_56 , V_257 , V_36 -> V_160 ) ||
F_160 ( V_56 , V_258 , sizeof( struct V_1 ) , & V_36 -> V_29 ) ||
F_160 ( V_56 , V_254 , sizeof( struct V_1 ) , & V_36 -> V_30 ) ||
F_161 ( V_56 , V_259 , V_36 -> V_156 ) ||
F_161 ( V_56 , V_260 , V_36 -> V_81 ) ||
F_159 ( V_56 , V_261 , V_36 -> V_193 ) ||
F_157 ( V_56 , V_262 , V_36 -> V_32 ) )
goto V_266;
return 0 ;
V_266:
return - V_149 ;
