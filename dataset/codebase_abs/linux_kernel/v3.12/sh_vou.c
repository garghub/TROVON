...
for ( V_120 = 0 ; V_120 < F_36 ( V_36 ) ; V_120 ++ )
...
{
struct V_198 * V_220 = V_219 -> V_40 . V_221 ;
struct V_93 * V_94 ;
struct V_44 * V_12 ;
struct V_222 * V_223 ;
struct V_33 * V_34 ;
...
struct V_227 * V_228 ;
int V_182 , V_46 ;
V_225 = F_93 ( V_219 , V_229 , 0 ) ;
V_182 = F_94 ( V_219 , 0 ) ;
if ( ! V_220 || ! V_225 || V_182 <= 0 ) {
F_95 ( & V_219 -> V_40 , L_23 ) ;
return - V_230 ;
}
...
V_12 -> V_43 = V_141 ;
V_12 -> V_233 = V_101 * 2 ;
V_12 -> V_234 = V_101 * 2 * 480 ;
V_12 -> V_138 = V_139 ;
V_226 = F_100 ( V_225 -> V_235 , F_101 ( V_225 ) ,
V_219 -> V_236 ) ;
if ( ! V_226 ) {
F_95 ( & V_219 -> V_40 , L_24 ) ;
V_46 = - V_237 ;
goto V_238;
}
V_2 -> V_5 = F_102 ( V_225 -> V_235 , F_101 ( V_225 ) ) ;
if ( ! V_2 -> V_5 ) {
V_46 = - V_207 ;
goto V_239;
}
...
if ( V_46 < 0 )
goto V_240;
V_46 = F_104 ( & V_219 -> V_40 , & V_2 -> V_39 ) ;
if ( V_46 < 0 ) {
F_95 ( & V_219 -> V_40 , L_26 ) ;
goto V_241;
}
V_34 = F_105 () ;
if ( V_34 == NULL ) {
...
if ( V_46 < 0 )
goto V_248;
V_228 = F_110 ( & V_2 -> V_39 , V_223 ,
V_220 -> V_249 , NULL ) ;
if ( ! V_228 ) {
V_46 = - V_207 ;
goto V_250;
}
V_46 = F_111 ( V_34 , V_251 , - 1 ) ;
if ( V_46 < 0 )
goto V_252;
return 0 ;
V_252:
...
{
int V_182 = F_94 ( V_219 , 0 ) ;
struct V_253 * V_39 = F_119 ( V_219 ) ;
struct V_1 * V_2 = F_120 ( V_39 ,
struct V_1 , V_39 ) ;
struct V_227 * V_254 = F_72 ( V_39 -> V_255 . V_59 ,
struct V_227 , V_256 ) ;
struct V_257 * V_258 = F_121 ( V_254 ) ;
struct V_224 * V_225 ;
if ( V_182 > 0 )
F_115 ( V_182 , V_2 ) ;
F_113 ( & V_219 -> V_40 ) ;
