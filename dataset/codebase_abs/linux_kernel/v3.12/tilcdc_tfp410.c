...
static enum V_28 F_21 (
struct V_25 * V_26 ,
bool V_29 )
{
struct V_27 * V_27 = F_19 ( V_26 ) ;
if ( F_22 ( V_27 -> V_7 -> V_30 ) )
return V_31 ;
return V_32 ;
}
...
static struct V_25 * F_30 ( struct V_14 * V_15 ,
...
static int F_35 ( struct V_45 * V_7 , struct V_14 * V_15 )
{
struct V_16 * V_46 = F_36 ( V_7 ) ;
...
static void F_37 ( struct V_45 * V_7 )
{
struct V_16 * V_46 = F_36 ( V_7 ) ;
if ( V_46 -> V_30 )
F_38 ( V_46 -> V_30 ) ;
...
F_50 ( V_57 ) ;
V_46 -> V_8 = F_51 ( V_55 , L_11 ,
0 , NULL ) ;
if ( F_39 ( V_46 -> V_8 ) ) {
F_46 ( & V_53 -> V_15 , L_12 ) ;
} else {
V_17 = F_52 ( V_46 -> V_8 , L_13 ) ;
if ( V_17 ) {
F_15 ( & V_53 -> V_15 , L_14 ) ;
goto V_23;
}
