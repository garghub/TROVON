...
F_13 ( V_22 , L_19
L_20 ,
F_22 ( F_23 ( V_7 -> V_19 . V_48 ) ) ,
F_24 ( F_23 ( V_7 -> V_19 . V_48 ) ) ,
V_7 -> V_19 . V_20 ) ;
V_11 = V_23 ;
goto V_47;
}
...
struct V_56 V_57 [ 2 ] ;
T_1 V_58 = 1 ;
F_13 ( 0 , L_21 , V_5 -> V_35 . V_36 , V_5 -> V_35 . V_37 ) ;
memset ( & V_53 , 0 , sizeof( struct V_52 ) ) ;
V_53 . V_59 = V_3 -> V_39 ;
V_53 . V_60 = type ;
V_53 . V_48 = V_7 -> V_19 . V_48 ;
V_53 . V_61 = V_5 -> V_35 . V_36 ;
V_53 . V_8 = F_26 ( V_8 ) ;
memcpy ( V_53 . V_37 , V_5 -> V_35 . V_37 , V_53 . V_61 ) ;
V_57 [ 0 ] . V_62 = sizeof( struct V_52 ) ;
V_57 [ 0 ] . V_63 = & V_53 ;
if ( V_8 & V_50 ) {
V_57 [ 1 ] . V_62 = V_41 ;
V_57 [ 1 ] . V_63 = V_7 -> V_28 -> V_40 ;
V_58 ++ ;
}
V_54 = F_27 ( V_64 , V_3 -> V_65 ,
V_57 , V_58 , V_5 -> V_66 , & V_11 ) ;
if ( V_54 >= 0 ) {
V_55 = V_11 ;
if ( V_55 == V_46 ) {
F_13 ( 0 , L_22
...
F_13 ( 0 , L_25
L_23 , V_5 -> V_66 ) ;
} else if ( V_55 != V_16 && V_55 != V_17 )
F_8 ( V_55 ) ;
} else {
F_13 ( V_22 , L_26
L_27 , V_54 , V_64 , V_3 -> V_65 ,
V_5 -> V_66 ) ;
if ( F_28 ( V_54 ) ) {
F_29 ( V_3 , V_5 -> V_66 ,
V_69 ) ;
...
int F_31 ( struct V_70 * V_71 , T_2 V_36 , void * V_72 ,
void * * V_73 )
{
struct V_2 * V_3 = V_72 ;
struct V_52 * V_74 = (struct V_52 * ) V_71 -> V_75 ;
struct V_4 * V_5 = NULL ;
struct V_6 * V_7 = NULL ;
struct V_6 * V_76 ;
struct V_77 * V_28 ;
enum V_1 V_11 = V_16 ;
T_2 V_8 ;
int V_9 = 0 , V_10 = 0 , V_78 = 0 , V_79 = 0 ;
if ( ! F_32 ( V_3 ) ) {
F_8 ( V_80 ) ;
return V_80 ;
}
...
F_13 ( 0 , L_32 , V_8 & V_50 ? L_33 :
( V_8 & V_51 ? L_34 : L_35 ) ) ;
V_11 = V_85 ;
V_5 = F_36 ( V_3 , V_74 -> V_37 , V_74 -> V_61 ) ;
if ( ! V_5 ) {
F_8 ( V_11 ) ;
goto V_83;
}
...
if ( V_76 -> V_19 . V_48 == V_74 -> V_48 &&
V_76 -> V_19 . V_38 == V_74 -> V_59 ) {
V_7 = V_76 ;
F_38 ( V_7 ) ;
break;
}
...
V_28 -> V_8 |= V_29 ;
memcpy ( & V_28 -> V_40 [ 0 ] , & V_74 -> V_40 [ 0 ] , V_41 ) ;
} else if ( V_8 & V_51 ) {
F_40 ( V_28 -> V_8 & ( V_29 | V_32 ) ) ;
V_28 -> V_8 |= V_32 ;
}
