...
V_96 = F_72 ( V_15 -> V_65 , V_154 , V_155 ,
( char * ) & V_156 , sizeof( V_156 ) ) ;
F_8 ( L_18 , V_96 ) ;
}
static void F_73 ( struct V_2 * V_3 , int V_161 )
{
struct V_14 * V_15 = (struct V_14 * ) V_3 -> V_114 ;
T_2 * V_115 ;
F_8 ( L_19 ,
...
static void F_77 ( struct V_2 * V_3 , int V_113 )
{
struct V_14 * V_15 = (struct V_14 * ) V_3 -> V_114 ;
T_2 * V_115 = F_33 ( V_3 ) ;
F_8 ( L_22 ,
...
if ( ! V_2 )
return NULL ;
F_42 ( V_164 , & V_15 -> V_17 . V_117 ) ;
V_96 = F_79 ( V_2 , & V_168 , V_170 ) ;
if ( V_96 < 0 ) {
if ( V_96 == - V_171 )
F_74 ( V_172 L_24 ,
V_125 -> V_173 ) ;
...
V_169 = F_83 ( V_125 , V_168 ,
( V_177 | V_178 ) ) ;
if ( F_84 ( V_169 ) )
goto V_174;
F_85 ( & V_169 -> V_17 , sin , V_58 ) ;
V_96 = F_86 ( V_168 , sin , & V_58 ) ;
if ( F_87 ( V_96 < 0 ) ) {
F_8 ( L_29 , - V_96 ) ;
V_58 = F_88 ( struct V_151 , V_179 ) ;
}
F_89 ( & V_169 -> V_17 , sin , V_58 ) ;
if ( V_125 -> V_142 )
V_125 -> V_142 -> V_180 ++ ;
return & V_169 -> V_17 ;
V_174:
...
F_92 ( V_10 -> V_140 [ V_106 ] ) ;
F_93 ( V_15 -> V_184 [ V_106 ] == NULL ) ;
...
V_181 = ( V_59 + V_63 - 1 ) >> V_183 ;
for ( V_106 = 0 ; V_106 < V_181 ; V_106 ++ ) {
if ( V_15 -> V_184 [ V_106 ] == NULL ) {
F_2 ( 1 ) ;
continue;
}
F_92 ( V_15 -> V_184 [ V_106 ] ) ;
V_15 -> V_184 [ V_106 ] = NULL ;
}
V_62:
V_15 -> V_185 = 0 ;
...
F_103 ( V_194 -> V_204 , V_10 -> V_136 . V_59 ) ;
V_10 -> V_136 . V_59 = 0 ;
return 0 ;
}
static int F_104 ( struct V_98 * V_205 , struct V_43 * * V_51 , int V_59 )
{
int V_106 = 0 ;
int V_206 = 0 ;
while ( V_206 < V_59 ) {
...
goto error;
V_52 = F_91 ( V_15 , V_10 ) ;
V_186 = F_98 ( V_15 ) - ( V_15 -> V_185 - sizeof( V_187 ) ) ;
V_205 = V_10 -> V_208 ;
V_207 = F_104 ( & V_205 [ 0 ] , & V_10 -> V_140 [ 0 ] ,
V_15 -> V_182 + V_186 ) ;
...
int V_213 ;
T_3 V_214 ;
V_214 = F_110 ( 0x80000000 | ( ( V_212 -> V_59 ) - 4 ) ) ;
...
int V_56 )
{
return F_68 ( V_125 , V_210 , V_150 , V_152 , V_153 , V_56 ) ;
}
...
int V_56 )
{
return F_118 ( V_125 , V_210 , V_150 , V_152 , V_153 , V_56 ) ;
}
...
int V_96 = 0 ;
F_8 ( L_50 , V_2 ) ;
V_15 = F_132 ( sizeof( * V_15 ) , V_226 ) ;
if ( ! V_15 )
return F_133 ( - V_171 ) ;
V_224 = V_2 -> V_3 ;
if ( V_225 )
V_96 = F_134 ( V_125 , F_71 ( V_2 -> V_3 ) , V_224 -> V_4 ,
V_224 -> V_88 ,
F_135 ( F_22 ( V_224 ) -> V_227 ) ) ;
if ( V_96 < 0 ) {
F_136 ( V_15 ) ;
return F_133 ( V_96 ) ;
}
...
int F_137 ( struct V_124 * V_125 , const int V_232 , char * V_233 ,
const T_1 V_59 )
{
int V_96 = 0 ;
struct V_1 * V_234 = F_138 ( V_232 , & V_96 ) ;
...
error = F_144 ( V_150 , V_246 , type , V_243 , & V_2 , 1 ) ;
if ( error < 0 )
return F_133 ( error ) ;
F_1 ( V_2 ) ;
V_247 = 1 ;
