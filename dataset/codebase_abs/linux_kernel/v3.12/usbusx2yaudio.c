...
if ( 0 > ( V_40 = F_62 ( V_81 , F_63 ( V_108 ) ) ) ) {
F_3 ( V_19 L_22 ,
V_81 , F_63 ( V_108 ) , V_40 ) ;
return V_40 ;
}
return 0 ;
}
...
static void F_73 ( struct V_1 * * V_132 )
{
F_32 ( V_132 [ V_64 ] ) ;
V_132 [ V_64 ] = NULL ;
F_32 ( V_132 [ V_63 ] ) ;
...
static void F_74 ( struct V_115 * V_112 )
{
struct V_1 * * V_133 = V_112 -> V_82 ;
if ( V_133 )
F_73 ( V_133 ) ;
}
static int F_75 ( struct V_109 * V_110 , int V_134 , int V_135 )
{
struct V_115 * V_112 ;
int V_40 , V_9 ;
struct V_1 * * V_132 =
...
V_9 <= V_63 ; ++ V_9 ) {
V_132 [ V_9 ] = F_50 ( sizeof( struct V_1 ) , V_71 ) ;
if ( NULL == V_132 [ V_9 ] ) {
F_3 ( V_19 L_28 ) ;
return - V_72 ;
}
...
if ( V_134 )
V_132 [ V_64 ] -> V_60 = V_134 ;
V_132 [ V_63 ] -> V_60 = V_135 ;
V_40 = F_76 ( V_110 , V_137 L_29 , V_14 ( V_110 ) -> V_136 ,
V_134 ? 1 : 0 , 1 ,
& V_112 ) ;
if ( V_40 < 0 ) {
F_73 ( V_132 ) ;
...
if ( V_134 )
F_77 ( V_112 , V_64 , & V_138 ) ;
F_77 ( V_112 , V_63 , & V_138 ) ;
V_112 -> V_82 = V_132 ;
V_112 -> V_139 = F_74 ;
V_112 -> V_140 = 0 ;
sprintf ( V_112 -> V_141 , V_137 L_30 , V_14 ( V_110 ) -> V_136 ) ;
if ( ( V_134 &&
0 > ( V_40 = F_78 ( V_112 -> V_119 [ V_64 ] . V_81 ,
V_142 ,
F_79 ( V_71 ) ,
64 * 1024 , 128 * 1024 ) ) ) ||
0 > ( V_40 = F_78 ( V_112 -> V_119 [ V_63 ] . V_81 ,
V_142 ,
F_79 ( V_71 ) ,
64 * 1024 , 128 * 1024 ) ) ) {
F_74 ( V_112 ) ;
...
{
int V_40 = 0 ;
F_81 ( & V_14 ( V_110 ) -> V_143 ) ;
if ( 0 > ( V_40 = F_75 ( V_110 , 0xA , 0x8 ) ) )
return V_40 ;
if ( F_82 ( V_14 ( V_110 ) -> V_45 -> V_144 . V_145 ) == V_146 )
if ( 0 > ( V_40 = F_75 ( V_110 , 0 , 0xA ) ) )
return V_40 ;
if ( F_82 ( V_14 ( V_110 ) -> V_45 -> V_144 . V_145 ) != V_147 )
