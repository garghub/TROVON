...
V_6 -> V_9 . V_10 -> V_17 ( V_6 , V_5 -> V_18 ) ;
...
struct V_1 * V_2 ;
int V_7 ;
V_5 = F_20 ( & V_29 -> V_32 , sizeof( * V_5 ) , V_36 ) ;
if ( ! V_5 )
return - V_37 ;
F_21 ( V_29 , V_5 ) ;
if ( F_16 ( & V_29 -> V_32 ) ) {
...
static int T_1 F_25 ( struct V_28 * V_29 )
{
struct V_4 * V_5 = F_15 ( V_29 ) ;
