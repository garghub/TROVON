...
* V_72 = 0 ;
F_34 ( & V_2 -> V_85 , V_82 ) ;
for ( V_15 = V_2 -> V_75 -> V_86 . V_15 ; V_71 > 0 && V_15 ;
V_15 = V_15 -> V_86 . V_15 )
...
unsigned V_93 ;
T_3 V_94 ;
V_91 = F_37 ( V_95 * sizeof( * V_91 ) , V_96 ) ;
if ( ! V_91 )
return 0 ;
V_92 = 0 ;
V_81 = F_32 ( V_29 -> V_60 ) ;
...
F_67 ( V_2 , & V_2 -> V_124 -> V_31 , V_32 | V_33 , V_70 ,
16 * 125 ) ;
F_70 ( & V_2 -> V_85 ) ;
V_2 -> V_43 &= ~ ( V_46 | V_47 ) ;
F_71 ( V_2 , V_2 -> V_43 , & V_2 -> V_124 -> V_43 ) ;
F_72 ( & V_2 -> V_85 ) ;
F_67 ( V_2 , & V_2 -> V_124 -> V_31 , V_32 | V_33 , 0 ,
16 * 125 ) ;
}
...
static struct V_8 * F_130 ( struct V_1 * V_2 ,
T_14 V_82 )
{
struct V_8 * V_9 ;
T_13 V_275 ;
...
static struct V_14 * F_135 ( struct V_1 * V_2 ,
T_14 V_82 )
{
struct V_14 * V_15 ;
T_13 V_275 ;
...
V_2 -> V_98 = F_142 ( V_2 -> V_97 , sizeof( void * ) ,
V_82 ) ;
if ( V_2 -> V_98 != NULL )
return 0 ;
V_281:
...
static inline void
F_144 ( struct V_1 * V_2 , struct V_14 * V_15 ,
struct V_8 * V_9 )
{
struct V_16 * V_17 = V_15 -> V_17 ;
...
static void F_211 ( struct V_1 * V_2 , unsigned V_24 ,
void * V_99 )
{
...
static int F_270 ( struct V_80 * V_81 )
{
struct V_1 * V_2 = F_33 ( V_81 ) ;
T_1 V_70 ;
T_1 V_7 ;
...
F_71 ( V_2 , V_2 -> V_283 ,
& V_2 -> V_124 -> V_491 ) ;
F_71 ( V_2 , ( T_1 ) V_2 -> V_75 -> V_280 ,
& V_2 -> V_124 -> V_492 ) ;
V_7 = F_3 ( V_2 , & V_2 -> V_5 -> V_7 ) ;
V_2 -> V_43 &= ~ ( V_45 | V_47 | V_46 | V_49 ) ;
V_2 -> V_43 |= V_50 ;
F_71 ( V_2 , V_2 -> V_43 , & V_2 -> V_124 -> V_43 ) ;
F_76 ( V_2 , L_139 , V_2 -> V_43 ) ;
F_271 ( & V_493 ) ;
V_2 -> V_113 = V_116 ;
F_3 ( V_2 , & V_2 -> V_124 -> V_43 ) ;
F_272 ( 5 ) ;
...
static int F_275 ( struct V_80 * V_81 )
{
struct V_1 * V_2 = F_33 ( V_81 ) ;
int V_160 ;
...
static T_17 F_277 ( struct V_80 * V_81 )
{
struct V_1 * V_2 = F_33 ( V_81 ) ;
...
F_121 ( V_2 , L_146 ) ;
F_76 ( V_2 , L_147 , V_205 ) ;
F_266 ( V_2 , L_147 , V_31 ) ;
V_501:
F_279 ( V_81 ) ;
V_2 -> V_477 = true ;
V_2 -> V_113 = V_117 ;
...
static int F_282 ( struct V_80 * V_81 , struct V_25 * V_25 , int V_31 )
{
struct V_1 * V_2 = F_33 ( V_81 ) ;
struct V_14 * V_15 ;
unsigned long V_82 ;
...
static void
F_284 ( struct V_80 * V_81 , struct V_295 * V_296 )
{
struct V_1 * V_2 = F_33 ( V_81 ) ;
unsigned long V_82 ;
...
static void
F_286 ( struct V_80 * V_81 , struct V_295 * V_296 )
{
struct V_1 * V_2 = F_33 ( V_81 ) ;
struct V_14 * V_15 ;
int V_509 = F_287 ( & V_296 -> V_223 ) ;
int V_292 = F_173 ( & V_296 -> V_223 ) ;
int V_291 = F_288 ( & V_296 -> V_223 ) ;
unsigned long V_82 ;
...
static int F_290 ( struct V_80 * V_81 )
{
struct V_1 * V_2 = F_33 ( V_81 ) ;
return ( F_46 ( V_2 ) >> 3 ) %
V_2 -> V_97 ;
...
{
T_1 V_512 ;
F_292 ( V_513 | V_514 | V_515 ,
& V_2 -> V_124 -> V_516 ) ;
V_512 = F_293 ( & V_2 -> V_124 -> V_517 ) ;
V_512 &= ~ V_518 ;
V_512 |= V_519 ;
F_292 ( V_512 , & V_2 -> V_124 -> V_517 ) ;
}
static int F_294 ( struct V_520 * V_521 )
{
...
V_159 = V_523 -> V_362 ;
V_81 = F_298 ( & V_528 , V_293 ,
F_44 ( V_293 ) ) ;
if ( ! V_81 ) {
F_297 ( V_293 , L_153 , V_160 ) ;
V_160 = - V_137 ;
goto V_529;
}
V_523 = F_296 ( V_521 , V_530 , 0 ) ;
if ( ! V_523 ) {
F_297 ( V_293 ,
L_154 ,
F_44 ( V_293 ) ) ;
...
V_81 -> V_532 = V_523 -> V_362 ;
V_81 -> V_533 = F_299 ( V_523 ) ;
V_81 -> V_534 = 1 ;
if ( ! F_300 ( V_81 -> V_532 , V_81 -> V_533 ,
V_528 . V_535 ) ) {
F_156 ( V_293 , L_155 ) ;
V_160 = - V_536 ;
goto V_531;
}
V_523 = F_296 ( V_521 , V_537 , 0 ) ;
if ( ! V_523 ) {
F_297 ( V_293 ,
L_154 ,
F_44 ( V_293 ) ) ;
...
V_81 -> V_124 = F_301 ( V_523 -> V_362 , F_299 ( V_523 ) ) ;
if ( V_81 -> V_124 == NULL ) {
F_156 ( V_293 , L_156 ) ;
V_160 = - V_538 ;
goto V_539;
...
goto V_540;
F_291 ( V_2 ) ;
V_160 = F_302 ( V_81 , V_159 , V_541 ) ;
if ( V_160 ) {
F_297 ( V_293 , L_157 , V_160 ) ;
goto V_540;
}
return V_160 ;
V_540:
F_303 ( V_81 -> V_124 ) ;
V_539:
F_304 ( V_81 -> V_532 , V_81 -> V_533 ) ;
V_531:
F_305 ( V_81 ) ;
V_529:
F_297 ( V_293 , L_158 , F_44 ( V_293 ) , V_160 ) ;
return V_160 ;
}
static int F_306 ( struct V_520 * V_521 )
{
struct V_471 * V_293 = & V_521 -> V_293 ;
...
static int T_18 F_308 ( void )
{
int V_160 = 0 ;
if ( F_295 () )
return - V_157 ;
F_309 ( L_159 V_542 L_55 , V_543 ) ;
F_120 ( V_544 , & V_545 ) ;
