...
unsigned int * V_28 )
{
unsigned int V_71 = V_28 [ 0 ] ;
unsigned int V_72 = V_28 [ 1 ] ;
V_9 -> V_73 = F_23 ( V_4 -> V_70 + 48 ) & 0xf ;
if ( V_71 ) {
V_9 -> V_73 &= ~ V_71 ;
V_9 -> V_73 |= ( V_72 & V_71 ) ;
F_25 ( V_9 -> V_73 , V_4 -> V_70 + 48 ) ;
}
V_28 [ 1 ] = V_9 -> V_73 ;
return V_27 -> V_31 ;
}
...
V_29 = F_27 ( V_4 , V_9 , V_27 , V_28 , V_71 ) ;
if ( V_29 )
return V_29 ;
F_25 ( ( V_9 -> V_75 >> 24 ) & 0xff , V_4 -> V_70 + 224 ) ;
return V_27 -> V_31 ;
}
...
V_9 -> V_73 |= ( V_72 & V_71 ) ;
if ( V_71 & 0xff )
F_25 ( V_9 -> V_73 & 0xff , V_4 -> V_70 + 80 ) ;
if ( V_71 & 0xff0000 )
F_25 ( ( V_9 -> V_73 >> 16 ) & 0xff , V_4 -> V_70 + 112 ) ;
}
...
V_4 -> V_83 = V_35 ;
V_4 -> V_84 = V_35 -> V_85 ;
V_6 = F_35 ( V_4 , sizeof( * V_6 ) ) ;
if ( ! V_6 )
return - V_86 ;
V_29 = F_36 ( V_4 ) ;
if ( V_29 )
return V_29 ;
V_4 -> V_70 = F_37 ( V_78 , 2 ) ;
V_6 -> V_13 = F_38 ( V_78 , 3 ) ;
if ( V_78 -> V_1 > 0 ) {
V_29 = F_39 ( V_78 -> V_1 , F_1 ,
V_87 , V_4 -> V_84 , V_4 ) ;
if ( V_29 == 0 )
V_4 -> V_1 = V_78 -> V_1 ;
}
V_79 = ( V_35 -> V_88 ? 0 : 1 ) + V_35 -> V_89 +
V_35 -> V_90 + V_35 -> V_91 +
V_35 -> V_92 ;
V_29 = F_40 ( V_4 , V_79 ) ;
if ( V_29 )
...
static int F_45 ( struct V_77 * V_4 ,
const struct V_121 * V_122 )
{
return F_46 ( V_4 , & V_123 , V_122 -> V_124 ) ;
}
