...
struct V_24 * V_498 = F_553 ( & V_1542 -> V_11 ) ;
...
T_5 * V_1547 ;
int V_26 ;
V_1547 = ( V_1546 ? V_498 -> V_809 : V_498 -> V_810 ) ;
for ( V_26 = 0 ; V_26 < V_498 -> V_481 ; V_26 ++ ) {
V_1541 += sprintf ( V_1541 ,
( V_26 == 0 ) ? L_202 : L_203 ,
V_1547 [ V_26 ] ) ;
...
union V_1548 * V_1464 , T_5 V_543 )
{
struct V_1521 * V_1542 ;
struct V_24 * V_498 ;
int V_26 ;
V_1542 = F_560 ( L_205 , V_1549 ,
NULL , 0 ) ;
if ( F_561 ( V_1542 ) )
return NULL ;
for ( V_26 = 0 ; V_1550 [ V_26 ] . V_1540 . V_1117 ; V_26 ++ ) {
