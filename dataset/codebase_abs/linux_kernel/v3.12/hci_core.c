...
F_112 ( & V_2 -> V_225 , 1 ) ;
F_34 ( V_226 , & V_2 -> V_41 ) ;
if ( V_2 -> V_227 && F_30 ( V_220 , & V_2 -> V_76 ) )
V_39 = V_2 -> V_227 ( V_2 ) ;
if ( ! V_39 ) {
...
F_113 ( V_226 , & V_2 -> V_41 ) ;
if ( ! V_39 ) {
F_77 ( V_2 ) ;
F_34 ( V_40 , & V_2 -> V_41 ) ;
F_1 ( V_2 , V_231 ) ;
if ( ! F_30 ( V_220 , & V_2 -> V_76 ) &&
F_114 ( V_2 ) ) {
F_8 ( V_2 ) ;
F_115 ( V_2 , 1 ) ;
F_9 ( V_2 ) ;
...
F_119 ( & V_2 -> V_243 ) ;
V_2 -> V_242 = 0 ;
F_113 ( V_244 , & V_2 -> V_76 ) ;
}
if ( F_120 ( V_245 , & V_2 -> V_76 ) )
F_119 ( & V_2 -> V_246 ) ;
F_122 ( & V_2 -> V_247 ) ;
F_8 ( V_2 ) ;
F_82 ( V_2 ) ;
...
int F_127 ( unsigned int V_259 , void T_8 * V_184 )
{
struct V_1 * V_2 ;
struct V_260 V_261 ;
int V_11 = 0 ;
...
static int F_132 ( void * V_24 , bool V_296 )
{
struct V_1 * V_2 = V_24 ;
...
F_113 ( V_219 , & V_2 -> V_76 ) ;
}
return 0 ;
}
static void F_133 ( struct V_297 * V_298 )
{
struct V_1 * V_2 = F_134 ( V_298 , struct V_1 , V_299 ) ;
int V_11 ;
F_4 ( L_7 , V_2 -> V_5 ) ;
...
if ( F_30 ( V_219 , & V_2 -> V_76 ) ) {
F_113 ( V_252 , & V_2 -> V_76 ) ;
F_118 ( V_2 ) ;
} else if ( F_30 ( V_252 , & V_2 -> V_76 ) ) {
F_136 ( V_2 -> V_300 , & V_2 -> V_240 ,
V_301 ) ;
}
if ( F_120 ( V_220 , & V_2 -> V_76 ) )
F_137 ( V_2 ) ;
}
static void F_138 ( struct V_297 * V_298 )
{
struct V_1 * V_2 = F_134 ( V_298 , struct V_1 ,
V_240 . V_298 ) ;
F_4 ( L_7 , V_2 -> V_5 ) ;
F_118 ( V_2 ) ;
}
...
struct V_1 * V_2 ;
T_1 V_122 = V_302 ;
V_2 = F_134 ( V_298 , struct V_1 , V_243 . V_298 ) ;
F_4 ( L_7 , V_2 -> V_5 ) ;
F_8 ( V_2 ) ;
F_140 ( V_2 , V_123 , sizeof( V_122 ) , & V_122 ) ;
V_2 -> V_242 = 0 ;
F_9 ( V_2 ) ;
}
...
F_143 (p, n, &hdev->link_keys) {
struct V_306 * V_307 ;
V_307 = F_144 ( V_112 , struct V_306 , V_151 ) ;
F_84 ( V_112 ) ;
F_85 ( V_307 ) ;
}
return 0 ;
...
struct V_306 * F_146 ( struct V_1 * V_2 , T_7 * V_115 )
{
struct V_306 * V_309 ;
...
static bool F_147 ( struct V_1 * V_2 , struct V_310 * V_311 ,
T_1 V_312 , T_1 V_313 )
{
if ( V_312 < 0x03 )
return true ;
...
struct V_308 * F_148 ( struct V_1 * V_2 , T_5 V_318 , T_1 rand [ 8 ] )
{
struct V_308 * V_309 ;
...
struct V_308 * F_149 ( struct V_1 * V_2 , T_7 * V_115 ,
T_1 V_319 )
{
struct V_308 * V_309 ;
F_76 (k, &hdev->long_term_keys, list)
...
int F_150 ( struct V_1 * V_2 , struct V_310 * V_311 , int V_321 ,
T_7 * V_115 , T_1 * V_322 , T_1 type , T_1 V_323 )
{
struct V_306 * V_307 , * V_324 ;
T_1 V_313 ;
bool V_325 ;
V_324 = F_146 ( V_2 , V_115 ) ;
if ( V_324 ) {
V_313 = V_324 -> type ;
V_307 = V_324 ;
} else {
...
if ( ! V_321 )
return 0 ;
V_325 = F_147 ( V_2 , V_311 , type , V_313 ) ;
F_151 ( V_2 , V_307 , V_325 ) ;
if ( V_311 )
V_311 -> V_329 = ! V_325 ;
return 0 ;
}
int F_152 ( struct V_1 * V_2 , T_7 * V_115 , T_1 V_319 , T_1 type ,
...
int F_154 ( struct V_1 * V_2 , T_7 * V_115 )
{
struct V_306 * V_307 ;
V_307 = F_146 ( V_2 , V_115 ) ;
if ( ! V_307 )
return - V_336 ;
...
static void F_156 ( unsigned long V_184 )
{
...
F_112 ( & V_2 -> V_225 , 1 ) ;
F_157 ( V_2 -> V_339 , & V_2 -> V_233 ) ;
}
struct V_340 * F_158 ( struct V_1 * V_2 ,
T_7 * V_115 )
{
struct V_340 * V_24 ;
...
int F_160 ( struct V_1 * V_2 , T_7 * V_115 , T_1 * V_341 ,
T_1 * V_342 )
{
struct V_340 * V_24 ;
V_24 = F_158 ( V_2 , V_115 ) ;
...
struct V_344 * F_161 ( struct V_1 * V_2 , T_7 * V_115 )
{
struct V_344 * V_345 ;
...
{
struct V_149 * V_112 , * V_142 ;
F_143 (p, n, &hdev->blacklist) {
struct V_344 * V_345 ;
V_345 = F_144 ( V_112 , struct V_344 , V_151 ) ;
F_84 ( V_112 ) ;
F_85 ( V_345 ) ;
}
return 0 ;
}
int F_163 ( struct V_1 * V_2 , T_7 * V_115 , T_1 type )
{
struct V_344 * V_346 ;
...
static void F_167 ( struct V_1 * V_2 , T_1 V_350 )
{
if ( V_350 ) {
F_11 ( L_27 , V_350 ) ;
F_8 ( V_2 ) ;
...
static void F_169 ( struct V_297 * V_298 )
{
struct V_1 * V_2 = F_134 ( V_298 , struct V_1 ,
V_247 . V_298 ) ;
struct V_354 V_90 ;
...
F_172 ( & V_2 -> V_234 , V_371 ) ;
F_172 ( & V_2 -> V_233 , V_372 ) ;
F_172 ( & V_2 -> V_232 , V_373 ) ;
F_172 ( & V_2 -> V_299 , F_133 ) ;
F_173 ( & V_2 -> V_240 , F_138 ) ;
F_173 ( & V_2 -> V_243 , F_139 ) ;
F_173 ( & V_2 -> V_247 , F_169 ) ;
F_174 ( & V_2 -> V_236 ) ;
F_174 ( & V_2 -> V_235 ) ;
F_174 ( & V_2 -> V_250 ) ;
F_175 ( & V_2 -> V_10 ) ;
F_176 ( & V_2 -> V_241 , F_156 , ( unsigned long ) V_2 ) ;
F_177 ( V_2 ) ;
F_178 ( V_2 ) ;
return V_2 ;
}
...
{
int V_130 , error ;
if ( ! V_2 -> V_223 || ! V_2 -> V_239 )
return - V_281 ;
switch ( V_2 -> V_55 ) {
case V_56 :
V_130 = F_182 ( & V_374 , 0 , 0 , V_195 ) ;
break;
case V_57 :
V_130 = F_182 ( & V_374 , 1 , 0 , V_195 ) ;
break;
default:
return - V_281 ;
}
...
V_2 -> V_339 = F_183 ( L_7 , V_375 | V_376 |
V_377 , 1 , V_2 -> V_5 ) ;
if ( ! V_2 -> V_339 ) {
error = - V_196 ;
goto V_11;
}
V_2 -> V_300 = F_183 ( L_7 , V_375 | V_376 |
V_377 , 1 , V_2 -> V_5 ) ;
if ( ! V_2 -> V_300 ) {
F_184 ( V_2 -> V_339 ) ;
error = - V_196 ;
...
if ( error < 0 )
goto V_378;
V_2 -> V_379 = F_186 ( V_2 -> V_5 , & V_2 -> V_217 ,
V_380 , & V_381 ,
V_2 ) ;
if ( V_2 -> V_379 ) {
if ( F_187 ( V_2 -> V_379 ) < 0 ) {
F_188 ( V_2 -> V_379 ) ;
V_2 -> V_379 = NULL ;
}
}
if ( V_2 -> V_379 && F_189 ( V_2 -> V_379 ) )
F_34 ( V_219 , & V_2 -> V_76 ) ;
F_34 ( V_220 , & V_2 -> V_76 ) ;
if ( V_2 -> V_55 != V_57 )
F_34 ( V_252 , & V_2 -> V_76 ) ;
F_190 ( & V_129 ) ;
F_92 ( & V_2 -> V_151 , & V_382 ) ;
F_191 ( & V_129 ) ;
F_1 ( V_2 , V_383 ) ;
F_77 ( V_2 ) ;
F_157 ( V_2 -> V_300 , & V_2 -> V_299 ) ;
return V_130 ;
V_378:
F_184 ( V_2 -> V_339 ) ;
F_184 ( V_2 -> V_300 ) ;
...
F_14 ( V_2 -> V_386 [ V_384 ] ) ;
F_194 ( & V_2 -> V_299 ) ;
if ( ! F_30 ( V_226 , & V_2 -> V_41 ) &&
! F_30 ( V_220 , & V_2 -> V_76 ) ) {
F_8 ( V_2 ) ;
F_195 ( V_2 ) ;
F_9 ( V_2 ) ;
...
struct V_13 * V_19 ;
struct V_395 * V_396 ;
if ( ( type < V_397 || type > V_398 ) ||
V_127 >= V_385 )
return - V_399 ;
V_19 = V_2 -> V_386 [ V_127 ] ;
if ( ! V_19 ) {
switch ( type ) {
case V_397 :
V_22 = V_400 ;
...
if ( ! V_19 )
return - V_196 ;
V_396 = ( void * ) V_19 -> V_406 ;
V_396 -> V_407 = V_393 ;
V_396 -> V_274 = type ;
V_19 -> V_217 = ( void * ) V_2 ;
V_2 -> V_386 [ V_127 ] = V_19 ;
}
while ( V_392 ) {
V_396 = ( void * ) V_19 -> V_406 ;
V_22 = F_208 ( V_408 , V_396 -> V_407 , V_392 ) ;
...
case V_398 :
if ( V_19 -> V_22 == V_25 ) {
struct V_17 * V_409 = V_17 ( V_19 ) ;
V_396 -> V_407 = V_409 -> V_28 ;
if ( F_210 ( V_19 ) < V_396 -> V_407 ) {
F_14 ( V_19 ) ;
V_2 -> V_386 [ V_127 ] = NULL ;
return - V_196 ;
}
}
break;
case V_397 :
if ( V_19 -> V_22 == V_401 ) {
struct V_410 * V_409 = V_410 ( V_19 ) ;
V_396 -> V_407 = F_13 ( V_409 -> V_411 ) ;
if ( F_210 ( V_19 ) < V_396 -> V_407 ) {
F_14 ( V_19 ) ;
V_2 -> V_386 [ V_127 ] = NULL ;
return - V_196 ;
...
case V_403 :
if ( V_19 -> V_22 == V_405 ) {
struct V_412 * V_409 = V_412 ( V_19 ) ;
V_396 -> V_407 = V_409 -> V_411 ;
if ( F_210 ( V_19 ) < V_396 -> V_407 ) {
F_14 ( V_19 ) ;
V_2 -> V_386 [ V_127 ] = NULL ;
return - V_196 ;
...
int F_211 ( struct V_1 * V_2 , int type , void * V_24 , int V_392 )
{
int V_413 = 0 ;
if ( type < V_397 || type > V_398 )
return - V_399 ;
while ( V_392 ) {
V_413 = F_206 ( V_2 , type , V_24 , V_392 , type - 1 ) ;
if ( V_413 < 0 )
return V_413 ;
V_24 += ( V_392 - V_413 ) ;
V_392 = V_413 ;
...
int F_212 ( struct V_1 * V_2 , void * V_24 , int V_392 )
{
int type ;
int V_413 = 0 ;
while ( V_392 ) {
struct V_13 * V_19 = V_2 -> V_386 [ V_414 ] ;
if ( ! V_19 ) {
struct { char type ; } * V_415 ;
V_415 = V_24 ;
type = V_415 -> type ;
V_24 ++ ;
V_392 -- ;
...
V_413 = F_206 ( V_2 , type , V_24 , V_392 ,
V_414 ) ;
if ( V_413 < 0 )
return V_413 ;
V_24 += ( V_392 - V_413 ) ;
...
int F_213 ( struct V_416 * V_406 )
{
F_4 ( L_33 , V_406 , V_406 -> V_5 ) ;
F_190 ( & V_417 ) ;
F_92 ( & V_406 -> V_151 , & V_418 ) ;
F_191 ( & V_417 ) ;
return 0 ;
}
int F_214 ( struct V_416 * V_406 )
{
F_4 ( L_33 , V_406 , V_406 -> V_5 ) ;
F_190 ( & V_417 ) ;
F_84 ( & V_406 -> V_151 ) ;
...
int F_19 ( struct V_33 * V_34 , T_11 V_421 )
{
struct V_1 * V_2 = V_34 -> V_2 ;
struct V_13 * V_19 ;
unsigned long V_41 ;
...
if ( ! V_19 )
return NULL ;
V_18 = (struct V_337 * ) F_209 ( V_19 , V_422 ) ;
V_18 -> V_14 = F_62 ( V_14 ) ;
V_18 -> V_28 = V_28 ;
if ( V_28 )
memcpy ( F_209 ( V_19 , V_28 ) , V_29 , V_28 ) ;
F_4 ( L_36 , V_19 -> V_22 ) ;
F_203 ( V_19 ) -> V_274 = V_423 ;
V_19 -> V_217 = ( void * ) V_2 ;
return V_19 ;
}
int F_140 ( struct V_1 * V_2 , T_10 V_14 , T_4 V_28 ,
const void * V_29 )
{
struct V_13 * V_19 ;
...
return V_2 -> V_238 -> V_24 + V_422 ;
}
static void F_228 ( struct V_13 * V_19 , T_10 V_425 , T_10 V_41 )
{
struct V_410 * V_18 ;
int V_22 = V_19 -> V_22 ;
F_229 ( V_19 , V_401 ) ;
F_230 ( V_19 ) ;
V_18 = (struct V_410 * ) F_231 ( V_19 ) ;
V_18 -> V_425 = F_62 ( F_232 ( V_425 , V_41 ) ) ;
V_18 -> V_411 = F_62 ( V_22 ) ;
}
static void F_233 ( struct V_426 * V_427 , struct V_428 * V_429 ,
struct V_13 * V_19 , T_10 V_41 )
{
struct V_310 * V_311 = V_427 -> V_311 ;
struct V_1 * V_2 = V_311 -> V_2 ;
struct V_13 * V_151 ;
V_19 -> V_22 = F_234 ( V_19 ) ;
V_19 -> V_430 = 0 ;
F_203 ( V_19 ) -> V_274 = V_397 ;
switch ( V_2 -> V_55 ) {
case V_56 :
F_228 ( V_19 , V_311 -> V_425 , V_41 ) ;
break;
case V_57 :
F_228 ( V_19 , V_427 -> V_425 , V_41 ) ;
break;
default:
F_11 ( L_41 , V_2 -> V_5 , V_2 -> V_55 ) ;
return;
}
V_151 = F_235 ( V_19 ) -> V_431 ;
if ( ! V_151 ) {
F_4 ( L_42 , V_2 -> V_5 , V_19 , V_19 -> V_22 ) ;
F_205 ( V_429 , V_19 ) ;
} else {
F_4 ( L_43 , V_2 -> V_5 , V_19 , V_19 -> V_22 ) ;
F_235 ( V_19 ) -> V_431 = NULL ;
F_236 ( & V_429 -> V_366 ) ;
F_237 ( V_429 , V_19 ) ;
V_41 &= ~ V_432 ;
V_41 |= V_433 ;
do {
V_19 = V_151 ; V_151 = V_151 -> V_434 ;
V_19 -> V_217 = ( void * ) V_2 ;
F_203 ( V_19 ) -> V_274 = V_397 ;
F_228 ( V_19 , V_311 -> V_425 , V_41 ) ;
F_4 ( L_43 , V_2 -> V_5 , V_19 , V_19 -> V_22 ) ;
...
void F_239 ( struct V_426 * V_427 , struct V_13 * V_19 , T_10 V_41 )
{
struct V_1 * V_2 = V_427 -> V_311 -> V_2 ;
F_4 ( L_44 , V_2 -> V_5 , V_427 , V_41 ) ;
V_19 -> V_217 = ( void * ) V_2 ;
F_233 ( V_427 , & V_427 -> V_435 , V_19 , V_41 ) ;
F_157 ( V_2 -> V_339 , & V_2 -> V_232 ) ;
}
...
V_18 . V_425 = F_62 ( V_311 -> V_425 ) ;
V_18 . V_411 = V_19 -> V_22 ;
F_229 ( V_19 , V_405 ) ;
F_230 ( V_19 ) ;
memcpy ( F_231 ( V_19 ) , & V_18 , V_405 ) ;
V_19 -> V_217 = ( void * ) V_2 ;
F_203 ( V_19 ) -> V_274 = V_403 ;
F_205 ( & V_311 -> V_435 , V_19 ) ;
F_157 ( V_2 -> V_339 , & V_2 -> V_232 ) ;
}
static struct V_310 * F_241 ( struct V_1 * V_2 , T_6 type ,
int * V_436 )
{
struct V_437 * V_409 = & V_2 -> V_370 ;
struct V_310 * V_311 = NULL , * V_438 ;
unsigned int V_165 = 0 , V_439 = ~ 0 ;
F_242 () ;
F_243 (c, &h->list, list) {
if ( V_438 -> type != type || F_221 ( & V_438 -> V_435 ) )
continue;
if ( V_438 -> V_134 != V_440 && V_438 -> V_134 != V_441 )
continue;
V_165 ++ ;
if ( V_438 -> V_338 < V_439 ) {
V_439 = V_438 -> V_338 ;
V_311 = V_438 ;
}
...
break;
case V_447 :
V_442 = V_2 -> V_293 ? V_2 -> V_256 : V_2 -> V_254 ;
break;
default:
V_442 = 0 ;
F_11 ( L_46 ) ;
...
F_242 () ;
F_243 (c, &h->list, list) {
if ( V_438 -> type == type && V_438 -> V_338 ) {
F_11 ( L_49 ,
V_2 -> V_5 , & V_438 -> V_448 ) ;
F_247 ( V_438 , V_449 ) ;
}
...
static struct V_426 * F_248 ( struct V_1 * V_2 , T_6 type ,
int * V_436 )
{
struct V_437 * V_409 = & V_2 -> V_370 ;
struct V_426 * V_427 = NULL ;
unsigned int V_165 = 0 , V_439 = ~ 0 , V_450 = 0 ;
struct V_310 * V_311 ;
int V_442 , V_443 , V_451 = 0 ;
F_4 ( L_7 , V_2 -> V_5 ) ;
F_242 () ;
...
if ( V_311 -> type != type )
continue;
if ( V_311 -> V_134 != V_440 && V_311 -> V_134 != V_441 )
continue;
V_451 ++ ;
F_243 (tmp, &conn->chan_list, list) {
struct V_13 * V_19 ;
if ( F_221 ( & V_305 -> V_435 ) )
continue;
V_19 = F_249 ( & V_305 -> V_435 ) ;
if ( V_19 -> V_452 < V_450 )
continue;
if ( V_19 -> V_452 > V_450 ) {
V_165 = 0 ;
...
V_165 ++ ;
if ( V_311 -> V_338 < V_439 ) {
V_439 = V_311 -> V_338 ;
V_427 = V_305 ;
}
}
if ( F_244 ( V_2 , type ) == V_451 )
break;
}
F_245 () ;
if ( ! V_427 )
return NULL ;
switch ( V_427 -> V_311 -> type ) {
case V_444 :
V_442 = V_2 -> V_254 ;
break;
case V_453 :
...
if ( F_221 ( & V_427 -> V_435 ) )
continue;
V_19 = F_249 ( & V_427 -> V_435 ) ;
if ( V_19 -> V_452 >= V_455 - 1 )
continue;
V_19 -> V_452 = V_455 - 1 ;
F_4 ( L_51 , V_427 , V_19 ,
V_19 -> V_452 ) ;
...
{
return F_252 ( V_19 -> V_22 - V_401 , V_2 -> V_456 ) ;
}
static void F_253 ( struct V_1 * V_2 , unsigned int V_442 )
{
if ( ! F_30 ( V_229 , & V_2 -> V_41 ) ) {
if ( ! V_442 && F_254 ( V_164 , V_2 -> V_457 +
V_458 ) )
F_246 ( V_2 , V_444 ) ;
}
}
...
{
unsigned int V_442 = V_2 -> V_254 ;
struct V_426 * V_427 ;
struct V_13 * V_19 ;
int V_436 ;
F_253 ( V_2 , V_442 ) ;
while ( V_2 -> V_254 &&
( V_427 = F_248 ( V_2 , V_444 , & V_436 ) ) ) {
T_3 V_452 = ( F_249 ( & V_427 -> V_435 ) ) -> V_452 ;
while ( V_436 -- && ( V_19 = F_249 ( & V_427 -> V_435 ) ) ) {
F_4 ( L_52 , V_427 , V_19 ,
V_19 -> V_22 , V_19 -> V_452 ) ;
if ( V_19 -> V_452 < V_452 )
break;
V_19 = F_256 ( & V_427 -> V_435 ) ;
F_257 ( V_427 -> V_311 ,
F_203 ( V_19 ) -> V_459 ) ;
F_215 ( V_19 ) ;
V_2 -> V_457 = V_164 ;
...
type = V_444 ;
while ( V_2 -> V_454 > 0 &&
( V_427 = F_248 ( V_2 , type , & V_436 ) ) ) {
T_3 V_452 = ( F_249 ( & V_427 -> V_435 ) ) -> V_452 ;
while ( V_436 > 0 && ( V_19 = F_249 ( & V_427 -> V_435 ) ) ) {
int V_460 ;
F_4 ( L_52 , V_427 , V_19 ,
V_19 -> V_22 , V_19 -> V_452 ) ;
if ( V_19 -> V_452 < V_452 )
...
{
F_4 ( L_7 , V_2 -> V_5 ) ;
if ( ! F_244 ( V_2 , V_444 ) && V_2 -> V_55 == V_56 )
return;
if ( ! F_244 ( V_2 , V_453 ) && V_2 -> V_55 == V_57 )
return;
switch ( V_2 -> V_45 ) {
case V_46 :
F_255 ( V_2 ) ;
...
if ( ! F_244 ( V_2 , V_445 ) )
return;
while ( V_2 -> V_255 && ( V_311 = F_241 ( V_2 , V_445 , & V_436 ) ) ) {
while ( V_436 -- && ( V_19 = F_256 ( & V_311 -> V_435 ) ) ) {
...
if ( ! F_244 ( V_2 , V_446 ) )
return;
while ( V_2 -> V_255 && ( V_311 = F_241 ( V_2 , V_446 ,
& V_436 ) ) ) {
while ( V_436 -- && ( V_19 = F_256 ( & V_311 -> V_435 ) ) ) {
F_4 ( L_53 , V_19 , V_19 -> V_22 ) ;
F_215 ( V_19 ) ;
...
struct V_426 * V_427 ;
struct V_13 * V_19 ;
int V_436 , V_442 , V_305 ;
F_4 ( L_7 , V_2 -> V_5 ) ;
if ( ! F_244 ( V_2 , V_447 ) )
return;
if ( ! F_30 ( V_229 , & V_2 -> V_41 ) ) {
if ( ! V_2 -> V_256 && V_2 -> V_294 &&
F_254 ( V_164 , V_2 -> V_461 + V_462 * 45 ) )
F_246 ( V_2 , V_447 ) ;
}
V_442 = V_2 -> V_294 ? V_2 -> V_256 : V_2 -> V_254 ;
V_305 = V_442 ;
while ( V_442 && ( V_427 = F_248 ( V_2 , V_447 , & V_436 ) ) ) {
T_3 V_452 = ( F_249 ( & V_427 -> V_435 ) ) -> V_452 ;
while ( V_436 -- && ( V_19 = F_249 ( & V_427 -> V_435 ) ) ) {
F_4 ( L_52 , V_427 , V_19 ,
V_19 -> V_22 , V_19 -> V_452 ) ;
...
{
struct V_1 * V_2 = F_134 ( V_298 , struct V_1 , V_232 ) ;
struct V_13 * V_19 ;
...
{
struct V_410 * V_18 = ( void * ) V_19 -> V_24 ;
struct V_310 * V_311 ;
T_10 V_425 , V_41 ;
F_12 ( V_19 , V_401 ) ;
V_425 = F_13 ( V_18 -> V_425 ) ;
V_41 = F_264 ( V_425 ) ;
V_425 = F_265 ( V_425 ) ;
...
{
struct V_412 * V_18 = ( void * ) V_19 -> V_24 ;
struct V_310 * V_311 ;
T_10 V_425 ;
F_12 ( V_19 , V_405 ) ;
V_425 = F_13 ( V_18 -> V_425 ) ;
F_4 ( L_57 , V_2 -> V_5 , V_19 -> V_22 , V_425 ) ;
V_2 -> V_257 . V_465 ++ ;
F_8 ( V_2 ) ;
V_311 = F_266 ( V_2 , V_425 ) ;
F_9 ( V_2 ) ;
...
F_4 ( L_59 , V_14 , V_350 ) ;
if ( ! F_227 ( V_2 , V_14 ) ) {
if ( F_30 ( V_226 , & V_2 -> V_41 ) && V_14 == V_44 )
F_271 ( V_2 ) ;
return;
}
if ( ! V_350 && ! F_270 ( V_2 ) )
return;
if ( V_2 -> V_238 ) {
V_466 = F_203 ( V_2 -> V_238 ) -> V_34 . V_421 ;
if ( V_466 ) {
F_203 ( V_2 -> V_238 ) -> V_34 . V_421 = NULL ;
goto V_467;
}
}
F_223 ( & V_2 -> V_235 . V_366 , V_41 ) ;
while ( ( V_19 = F_275 ( & V_2 -> V_235 ) ) ) {
if ( F_203 ( V_19 ) -> V_34 . V_424 ) {
F_276 ( & V_2 -> V_235 , V_19 ) ;
break;
}
V_466 = F_203 ( V_19 ) -> V_34 . V_421 ;
F_14 ( V_19 ) ;
}
F_225 ( & V_2 -> V_235 . V_366 , V_41 ) ;
V_467:
...
{
struct V_1 * V_2 = F_134 ( V_298 , struct V_1 , V_234 ) ;
struct V_13 * V_19 ;
F_4 ( L_7 , V_2 -> V_5 ) ;
...
{
struct V_1 * V_2 = F_134 ( V_298 , struct V_1 , V_233 ) ;
struct V_13 * V_19 ;
F_4 ( L_63 , V_2 -> V_5 ,
F_217 ( & V_2 -> V_225 ) , F_220 ( & V_2 -> V_235 ) ) ;
if ( F_217 ( & V_2 -> V_225 ) ) {
