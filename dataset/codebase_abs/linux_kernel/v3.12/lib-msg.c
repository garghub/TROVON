...
V_51 -> V_97 [ V_89 ] = V_98 ;
while ( ! F_36 ( & V_51 -> V_95 ) ) {
V_7 = F_37 ( V_51 -> V_95 . V_99 ,
T_3 , V_94 ) ;
F_18 ( & V_7 -> V_94 ) ;
V_85 = F_24 ( V_7 , V_49 ) ;
if ( V_85 != 0 )
...
void
F_38 ( struct V_50 * V_51 )
{
int V_100 = 0 ;
if ( V_51 -> V_101 == 0 )
return;
while ( ! F_36 ( & V_51 -> V_63 ) ) {
T_3 * V_7 = F_37 ( V_51 -> V_63 . V_99 ,
T_3 , V_62 ) ;
F_5 ( V_7 -> V_60 ) ;
V_7 -> V_60 = 0 ;
F_18 ( & V_7 -> V_62 ) ;
...
int
F_43 ( struct V_50 * V_51 , int V_49 )
{
int V_85 ;
V_51 -> V_101 = 1 ;
F_44 ( & V_51 -> V_63 ) ;
...
V_85 = 0 ;
#endif
V_51 -> V_96 = F_46 ( F_47 () , V_49 ) ;
F_48 ( V_51 -> V_97 , F_47 () , V_49 ,
V_51 -> V_96 *
sizeof( * V_51 -> V_97 ) ) ;
if ( V_51 -> V_97 == NULL ) {
F_39 ( L_3 ) ;
