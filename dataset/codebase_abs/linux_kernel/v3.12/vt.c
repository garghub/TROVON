...
case V_238 :
if ( V_9 == 'P' ) {
for ( V_5 -> V_181 = 0 ; V_5 -> V_181 < V_244 ; V_5 -> V_181 ++ )
...
if ( V_5 -> V_181 == 7 ) {
int V_79 = V_5 -> V_182 [ 0 ] * 3 , V_246 = 1 ;
V_5 -> V_247 [ V_79 ] = 16 * V_5 -> V_182 [ V_246 ++ ] ;
V_5 -> V_247 [ V_79 ++ ] += V_5 -> V_182 [ V_246 ++ ] ;
V_5 -> V_247 [ V_79 ] = 16 * V_5 -> V_182 [ V_246 ++ ] ;
V_5 -> V_247 [ V_79 ++ ] += V_5 -> V_182 [ V_246 ++ ] ;
V_5 -> V_247 [ V_79 ] = 16 * V_5 -> V_182 [ V_246 ++ ] ;
V_5 -> V_247 [ V_79 ] += V_5 -> V_182 [ V_246 ] ;
...
struct V_345 * V_345 ;
int V_79 , V_246 = - 1 , V_335 = - 1 , V_323 = - V_383 ;
if ( ! F_192 ( V_111 ) )
return - V_383 ;
F_21 () ;
for ( V_79 = 0 ; V_79 < V_344 ; V_79 ++ ) {
