...
V_198 = F_105 ( & V_229 -> V_62 , & V_60 -> V_141 ) ;
if ( V_198 )
goto V_253;
if ( V_254 ) {
V_60 -> V_255 = F_106 ( L_86 , V_256 ,
V_254 ,
V_60 , & V_257 ) ;
if ( ! V_60 -> V_255 )
F_107 ( V_62 , L_87 ) ;
