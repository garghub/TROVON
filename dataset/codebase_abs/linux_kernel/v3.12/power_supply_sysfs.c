...
static char * V_10 [] = {
L_1 , L_24 , L_25 , L_26 , L_27 , L_28 ,
L_29
} ;
static char * V_11 [] = {
L_1 , L_30 , L_31 , L_32 , L_33 , L_12
} ;
static char * V_12 [] = {
L_1 , L_34 , L_35
} ;
...
if ( V_16 == V_26 )
return sprintf ( V_5 , L_38 , V_7 [ V_19 . V_21 ] ) ;
else if ( V_16 == V_27 )
return sprintf ( V_5 , L_38 , V_8 [ V_19 . V_21 ] ) ;
else if ( V_16 == V_28 )
return sprintf ( V_5 , L_38 , V_9 [ V_19 . V_21 ] ) ;
else if ( V_16 == V_29 )
return sprintf ( V_5 , L_38 , V_10 [ V_19 . V_21 ] ) ;
else if ( V_16 == V_30 )
return sprintf ( V_5 , L_38 , V_11 [ V_19 . V_21 ] ) ;
else if ( V_16 == V_20 )
return sprintf ( V_5 , L_38 , V_6 [ V_19 . V_21 ] ) ;
else if ( V_16 == V_31 )
return sprintf ( V_5 , L_38 , V_12 [ V_19 . V_21 ] ) ;
else if ( V_16 >= V_32 )
return sprintf ( V_5 , L_38 , V_19 . V_33 ) ;
return sprintf ( V_5 , L_39 , V_19 . V_21 ) ;
}
...
F_3 ( V_2 , L_42 , V_15 -> V_24 ) ;
V_13 = F_14 ( V_60 , L_43 , V_15 -> V_24 ) ;
if ( V_13 )
return V_13 ;
V_62 = ( char * ) F_15 ( V_64 ) ;
if ( ! V_62 )
...
F_3 ( V_2 , L_44 , V_63 , V_62 ) ;
V_13 = F_14 ( V_60 , L_45 , V_63 , V_62 ) ;
F_16 ( V_63 ) ;
if ( V_13 )
goto V_66;
}
