...
V_48 (* F_38)( void * V_77 , V_48 V_78 ) ,
void * V_77 , enum V_79 * V_80 )
{
int V_57 ;
V_48 V_81 , V_78 , V_82 ;
struct V_3 * V_83 ;
...
V_36 -> V_86 ++ ;
F_43 ( & V_69 . V_65 , - 1 ) ;
if ( F_10 ( V_69 . V_66 ) == V_81 )
V_69 . V_66 = F_5 ( V_81 + 1 ) ;
} else if ( V_78 && ! V_82 ) {
* V_80 = V_87 ;
V_36 -> V_86 -- ;
F_43 ( & V_69 . V_65 , 1 ) ;
V_69 . V_66 = F_5 ( F_44 ( F_10 ( V_69 . V_66 ) , V_81 ) ) ;
}
return V_36 -> V_67 ( V_36 , V_68 , & V_69 ) ;
}
static V_48 F_45 ( void * V_77 , V_48 V_78 )
{
return * ( ( V_48 * ) V_77 ) ;
}
int F_46 ( struct V_35 * V_36 , T_4 V_4 ,
V_48 V_82 , enum V_79 * V_80 )
{
return F_37 ( V_36 , V_4 , F_45 , & V_82 , V_80 ) ;
}
static V_48 F_47 ( void * V_77 , V_48 V_78 )
{
return V_78 + 1 ;
}
int F_48 ( struct V_35 * V_36 , T_4 V_4 , enum V_79 * V_80 )
{
return F_37 ( V_36 , V_4 , F_47 , NULL , V_80 ) ;
}
static V_48 F_49 ( void * V_77 , V_48 V_78 )
{
return V_78 - 1 ;
}
int F_50 ( struct V_35 * V_36 , T_4 V_4 , enum V_79 * V_80 )
{
return F_37 ( V_36 , V_4 , F_49 , NULL , V_80 ) ;
}
...
int V_57 , V_44 ;
struct V_3 * V_4 ;
V_57 = F_39 ( V_36 -> V_38 , V_36 -> V_53 , & V_90 , & V_4 , & V_44 ) ;
if ( V_57 )
return V_57 ;
memcpy ( F_2 ( V_4 ) , & V_36 -> V_7 , sizeof( V_36 -> V_7 ) ) ;
V_36 -> V_53 = F_4 ( V_4 ) ;
