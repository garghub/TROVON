...
static struct V_88 * F_58 ( struct V_89 * V_64 )
{
struct V_88 * V_90 ;
struct V_91 * V_92 = V_64 -> V_93 ;
T_1 V_94 = 0 ;
V_90 = F_59 ( V_64 , sizeof( struct V_88 ) , V_95 ) ;
if ( ! V_90 ) {
F_52 ( V_64 , L_3 ) ;
return NULL ;
}
...
static int F_61 ( struct V_99 * V_63 )
{
struct V_100 * V_101 ;
struct V_102 * V_58 ;
struct V_1 * V_2 ;
int V_103 ;
int V_73 ;
V_58 = F_62 ( & V_63 -> V_64 , sizeof( struct V_1 ) ) ;
if ( V_58 == NULL ) {
F_52 ( & V_63 -> V_64 , L_7 ) ;
V_73 = - V_104 ;
goto V_105;
...
F_63 ( V_63 , V_2 ) ;
if ( V_63 -> V_64 . V_93 )
V_2 -> V_90 = F_58 ( & V_63 -> V_64 ) ;
else
V_2 -> V_90 = F_64 ( & V_63 -> V_64 ) ;
if ( ! V_2 -> V_90 ) {
F_52 ( & V_63 -> V_64 , L_8 ) ;
V_73 = - V_106 ;
goto V_107;
...
F_65 ( & V_2 -> V_17 ) ;
V_2 -> V_65 = F_66 ( & V_63 -> V_64 , NULL ) ;
if ( F_67 ( V_2 -> V_65 ) ) {
F_52 ( & V_63 -> V_64 , L_9 ) ;
V_73 = F_68 ( V_2 -> V_65 ) ;
goto V_107;
}
V_101 = F_69 ( V_63 , V_108 , 0 ) ;
V_103 = F_70 ( V_63 , 0 ) ;
if ( ! V_101 || V_103 < 0 ) {
F_52 ( & V_63 -> V_64 , L_10 ) ;
V_73 = - V_109 ;
...
V_2 -> V_6 = F_71 ( V_101 -> V_111 , F_72 ( V_101 ) ) ;
if ( ! V_2 -> V_6 ) {
F_52 ( & V_63 -> V_64 , L_11 ) ;
V_73 = - V_106 ;
goto V_110;
}
V_73 = F_73 ( V_103 , F_9 , 0 ,
F_74 ( & V_63 -> V_64 ) , V_2 ) ;
if ( V_73 ) {
F_52 ( & V_63 -> V_64 , L_12 ) ;
goto V_112;
...
V_2 -> V_75 = 64 ;
if ( V_2 -> V_90 -> V_96 )
V_2 -> V_74 = V_2 -> V_90 -> V_96 ;
if ( V_2 -> V_90 -> V_97 )
V_2 -> V_75 = V_2 -> V_90 -> V_97 ;
V_58 -> V_113 = V_66 | V_67 | V_60 ;
V_58 -> V_113 |= V_69 | V_68 ;
V_58 -> V_62 = 0 ;
V_58 -> V_114 = V_63 -> V_115 ;
V_58 -> V_98 = V_2 -> V_90 -> V_98 ;
V_58 -> V_116 = V_117 ;
V_58 -> V_118 = V_119 ;
V_2 -> V_120 . V_58 = V_58 ;
V_2 -> V_120 . V_121 = F_39 ;
V_2 -> V_120 . V_122 = F_37 ;
V_2 -> V_120 . V_123 = F_54 ;
V_2 -> V_120 . V_124 [ V_125 ] = F_56 ;
V_2 -> V_120 . V_124 [ V_126 ] = F_56 ;
V_2 -> V_120 . V_124 [ V_127 ] = F_56 ;
V_2 -> V_120 . V_124 [ V_128 ] = F_56 ;
V_73 = F_76 ( & V_2 -> V_120 ) ;
if ( V_73 == 0 )
return 0 ;
F_77 ( & V_63 -> V_64 ) ;
...
static int F_81 ( struct V_99 * V_63 )
{
struct V_1 * V_2 = F_82 ( V_63 ) ;
int V_73 ;
V_73 = F_83 ( & V_2 -> V_120 ) ;
if ( ! V_73 ) {
F_77 ( & V_63 -> V_64 ) ;
F_84 ( F_70 ( V_63 , 0 ) , V_2 ) ;
F_78 ( V_2 -> V_6 ) ;
F_79 ( V_2 -> V_65 ) ;
F_80 ( V_2 -> V_120 . V_58 ) ;
}
