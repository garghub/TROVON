...
if ( V_41 -> V_132 == V_133 )
F_35 ( V_2 , V_4 ) ;
V_85 = F_36 ( V_41 , V_2 -> V_134 , V_81 -> V_58 . V_123 . V_135 ,
( V_55 * ) V_13 , V_82 , V_4 -> V_74 ) ;
if ( V_85 ) {
F_32 ( V_82 , V_41 -> V_125 ) ;
goto V_127;
}
...
V_127:
V_84 . V_58 . V_95 . V_96 = V_102 ;
V_84 . V_58 . V_95 . V_98 = V_146 ;
F_26 ( V_2 , V_84 . V_58 . V_100 , V_43 , V_4 , NULL ) ;
return 0 ;
}
static void
F_37 ( struct V_40 * V_41 , T_4 * V_147 )
{
struct V_1 * V_2 ;
struct V_42 * V_148 ;
struct V_3 * V_4 ;
T_1 V_149 ;
V_148 = (struct V_42 * ) V_147 -> V_150 ;
V_4 = (struct V_3 * ) V_147 -> V_52 ;
V_2 = V_147 -> V_2 ;
V_149 = V_148 -> V_151 ;
if ( V_149 == V_152 ) {
F_38 ( V_2 , V_148 , V_4 ) ;
} else {
F_28 ( V_2 , V_121 , V_148 ,
V_4 , NULL ) ;
}
F_39 ( V_148 ) ;
F_32 ( V_147 , V_41 -> V_125 ) ;
}
static int
...
if ( V_149 == V_152 ) {
V_155 = ( T_5 * ) V_48 ;
V_153 = (struct V_5 * ) & V_155 -> V_33 ;
V_154 = (struct V_5 * ) & V_155 -> V_34 ;
} else {
V_13 = (struct V_12 * ) V_48 ;
V_153 = (struct V_5 * ) & V_13 -> V_33 ;
V_154 = (struct V_5 * ) & V_13 -> V_34 ;
}
V_81 = & V_43 -> V_51 ;
if ( V_81 -> V_56 == 0 && F_1 ( V_2 , V_4 , V_153 , V_154 ) ) {
if ( V_2 -> V_41 -> V_132 == V_133 ) {
V_148 = F_41 ( sizeof( struct V_42 ) ,
V_126 ) ;
if ( V_148 ) {
memcpy ( ( V_55 * ) V_148 , ( V_55 * ) V_43 ,
sizeof( struct V_42 ) ) ;
V_148 -> V_151 = V_149 ;
F_42 ( V_4 ,
F_37 , V_148 ) ;
...
V_84 . V_58 . V_95 . V_158 = 0 ;
V_84 . V_58 . V_95 . V_96 = V_102 ;
V_84 . V_58 . V_95 . V_98 = V_105 ;
V_84 . V_58 . V_95 . V_159 = 0 ;
F_26 ( V_2 , V_84 . V_58 . V_100 , V_43 , V_4 , NULL ) ;
F_44 ( & V_4 -> V_160 , V_161 + F_45 ( 1000 ) ) ;
F_9 ( V_80 -> V_137 ) ;
V_4 -> V_8 |= V_162 ;
F_14 ( V_80 -> V_137 ) ;
V_4 -> V_163 = V_121 ;
...
F_9 ( V_80 -> V_137 ) ;
V_41 -> V_78 -> V_88 &= ~ V_176 ;
F_14 ( V_80 -> V_137 ) ;
F_50 ( V_41 ) ;
}
} else if ( ( ! ( V_4 -> V_156 & V_177 ) &&
( ( V_4 -> V_156 & V_157 ) ||
! ( V_4 -> V_156 & V_178 ) ) ) ||
( V_4 -> V_73 == V_179 ) ) {
F_44 ( & V_4 -> V_160 ,
...
V_46 = (struct V_45 * ) V_43 -> V_52 ;
V_48 = ( T_1 * ) V_46 -> V_54 ;
V_180 = ( T_6 * ) ( ( V_55 * ) V_48 + sizeof ( T_1 ) ) ;
V_4 -> V_156 &= ~ ( V_157 | V_178 ) ;
V_4 -> V_107 &= ~ V_184 ;
V_4 -> V_8 &= ~ V_185 ;
...
T_4 * V_199 ;
int V_85 ;
V_199 = ( T_4 * ) F_29 ( V_41 -> V_125 ,
V_126 ) ;
if ( ! V_199 )
F_3 ( V_2 , V_35 , V_200 ,
L_11 ) ;
else {
F_56 ( V_41 , V_2 -> V_134 , V_198 , V_199 ) ;
V_199 -> V_128 = V_129 ;
V_85 = F_31 ( V_41 , V_199 , V_130 ) ;
if ( V_85 == V_131 )
F_32 ( V_199 , V_41 -> V_125 ) ;
}
}
static T_1
...
F_44 ( & V_4 -> V_160 , V_161 + F_45 ( 1000 * 1 ) ) ;
F_9 ( V_80 -> V_137 ) ;
V_4 -> V_8 |= V_162 ;
F_14 ( V_80 -> V_137 ) ;
V_4 -> V_163 = V_121 ;
...
F_35 ( V_2 , V_4 ) ;
if ( F_36 ( V_41 , V_2 -> V_134 , V_50 -> V_58 . V_224 . V_135 ,
( V_55 * ) V_13 , V_82 , V_4 -> V_74 ) == 0 ) {
switch ( V_4 -> V_37 ) {
case V_225 :
V_82 -> V_128 = V_226 ;
break;
...
V_4 -> V_8 &= ~ V_228 ;
F_74 ( V_4 ) ;
V_220 = (struct V_45 * ) V_82 -> V_150 ;
F_75 ( V_41 , V_220 -> V_54 , V_220 -> V_229 ) ;
F_39 ( V_220 ) ;
F_32 ( V_82 , V_41 -> V_125 ) ;
F_3 ( V_2 , V_35 , V_101 ,
L_19
...
V_43 = (struct V_42 * ) V_201 ;
V_44 = V_43 -> V_221 . V_222 ;
V_155 = ( T_5 * ) F_4 ( V_41 , V_43 , V_44 ) ;
V_50 = & V_44 -> V_51 ;
if ( ( V_50 -> V_56 ) ||
( ! F_1 ( V_2 , V_4 , & V_155 -> V_33 , & V_155 -> V_34 ) ) ) {
F_44 ( & V_4 -> V_160 ,
V_161 + F_45 ( 1000 ) ) ;
F_9 ( V_80 -> V_137 ) ;
V_4 -> V_8 |= V_162 ;
...
if ( ( V_203 -> V_38 . V_203 . V_236 == V_237 ) &&
( V_4 == (struct V_3 * ) V_203 -> V_52 ) ) {
V_220 = (struct V_45 * ) ( V_203 -> V_150 ) ;
if ( V_220 ) {
F_96 ( V_41 , V_220 -> V_54 , V_220 -> V_229 ) ;
F_39 ( V_220 ) ;
}
F_74 ( V_4 ) ;
F_97 ( & V_203 -> V_53 ) ;
V_41 -> V_66 . V_238 -- ;
F_32 ( V_203 , V_41 -> V_125 ) ;
}
}
F_14 ( & V_41 -> V_75 ) ;
F_46 ( V_2 , V_4 , V_43 , V_218 ) ;
...
L_22
L_23 ,
V_239 , V_203 -> V_207 , V_2 -> V_86 ,
V_203 -> V_58 . V_240 . V_134 ,
...
struct V_40 * V_41 = V_2 -> V_41 ;
struct V_42 * V_43 = (struct V_42 * ) V_201 ;
F_131 ( V_2 , & V_41 -> V_66 . V_69 [ V_41 -> V_66 . V_247 ] ,
V_4 -> V_248 , 0 , V_249 ) ;
F_46 ( V_2 , V_4 , V_43 , V_170 ) ;
return V_4 -> V_73 ;
}
...
L_24
L_25 ,
V_202 , V_4 -> V_37 , V_253 , V_4 -> V_8 ) ;
F_52 ( V_2 , V_255 ,
L_26 ,
V_202 , V_253 , V_4 -> V_37 ) ;
F_147 = V_256 [ ( V_253 * V_257 ) + V_202 ] ;
V_85 = ( F_147 ) ( V_2 , V_4 , V_201 , V_202 ) ;
if ( V_254 ) {
F_3 ( V_2 , V_72 , V_36 ,
L_27 ,
