...
T_2 V_78 , V_258 ;
int V_259 , V_260 ;
V_259 = F_125 ( V_256 , L_60 , 0 ) ;
V_260 = F_125 ( V_256 , L_61 , 0 ) ;
if ( V_259 == - V_261 || V_260 == - V_261 )
return F_126 ( - V_261 ) ;
V_8 = F_127 ( V_2 , sizeof( * V_8 ) , V_262 ) ;
if ( ! V_8 )
return NULL ;
if ( F_128 ( V_256 , L_62 , NULL ) )
V_8 -> V_93 |= V_94 ;
V_8 -> V_263 = 1 ;
V_8 -> V_9 [ 0 ] . V_10 = V_259 ;
V_8 -> V_9 [ 0 ] . V_11 = V_260 ;
if ( F_128 ( V_256 , L_63 , NULL ) ) {
V_8 -> V_9 [ 0 ] . V_264 = true ;
V_8 -> V_9 [ 0 ] . V_27 = true ;
}
F_129 ( V_256 , L_64 , & V_78 ) ;
if ( V_78 == 4 )
V_8 -> V_9 [ 0 ] . V_265 |= V_266 ;
else if ( V_78 == 8 )
V_8 -> V_9 [ 0 ] . V_265 |= V_267 ;
if ( F_128 ( V_256 , L_65 , NULL ) )
V_8 -> V_9 [ 0 ] . V_67 |= V_168 ;
if ( ! F_129 ( V_256 , L_66 , & V_258 ) )
V_8 -> V_258 = V_258 ;
if ( F_128 ( V_256 , L_67 , NULL ) )
V_8 -> V_9 [ 0 ] . V_67 |= V_68 ;
return V_8 ;
}
...
static int F_130 ( struct V_268 * V_269 )
{
struct V_6 * V_8 = V_269 -> V_2 . V_270 ;
struct V_114 * V_7 ;
struct V_4 * V_5 = NULL ;
struct V_271 * V_162 ;
int V_15 , V_105 ;
...
T_6 V_274 ;
unsigned V_275 , V_276 ;
struct V_277 * V_277 ;
V_273 = F_131 ( F_132 ( V_278 ) , & V_269 -> V_2 ) ;
if ( V_273 ) {
V_8 = F_124 ( & V_269 -> V_2 ) ;
if ( F_19 ( V_8 ) )
return F_21 ( V_8 ) ;
if ( V_273 -> V_118 ) {
const T_1 * V_279 = V_273 -> V_118 ;
V_8 -> V_280 = * V_279 ;
}
}
if ( V_8 == NULL ) {
...
V_162 = F_133 ( V_269 , V_282 , 0 ) ;
V_105 = F_134 ( V_269 , 0 ) ;
if ( V_162 == NULL || V_105 < 0 )
return - V_281 ;
V_162 = F_135 ( V_162 -> V_283 , F_136 ( V_162 ) , V_269 -> V_116 ) ;
if ( V_162 == NULL )
return - V_284 ;
V_15 = F_28 ( V_8 ) ;
if ( V_15 )
goto V_170;
V_7 = F_137 ( sizeof( struct V_4 ) , & V_269 -> V_2 ) ;
if ( ! V_7 ) {
V_15 = - V_285 ;
goto V_286;
}
...
V_5 -> V_105 = V_105 ;
V_5 -> V_28 = 0 ;
V_5 -> V_209 = V_162 -> V_283 + V_8 -> V_280 ;
V_5 -> V_36 = F_138 ( V_5 -> V_209 , V_287 ) ;
V_5 -> V_95 = V_96 ;
V_5 -> V_198 . V_199 = 1 ;
F_139 ( V_269 , V_5 ) ;
V_7 -> V_288 = & V_289 ;
...
V_7 -> V_294 = V_295 ;
F_140 ( & V_5 -> V_146 ) ;
V_5 -> V_56 = F_141 ( & V_269 -> V_2 , L_70 ) ;
if ( F_19 ( V_5 -> V_56 ) ) {
V_15 = F_21 ( V_5 -> V_56 ) ;
V_5 -> V_56 = NULL ;
goto V_296;
}
if ( V_5 -> V_8 -> V_93 & V_297 ) {
F_87 ( & V_269 -> V_2 , L_71 ) ;
V_7 -> V_298 |= V_299 ;
}
F_142 ( V_5 -> V_2 ) ;
...
F_144 ( V_5 -> V_2 ) ;
F_54 ( V_5 ) ;
if ( V_5 -> V_2 -> V_257 && V_5 -> V_209 == 0x4809c000 )
V_5 -> V_17 = 1 ;
V_5 -> V_185 = F_141 ( & V_269 -> V_2 , L_72 ) ;
if ( F_19 ( V_5 -> V_185 ) ) {
V_5 -> V_185 = NULL ;
...
V_7 -> V_302 = 512 ;
V_7 -> V_303 = 0xFFFF ;
V_7 -> V_304 = V_7 -> V_302 * V_7 -> V_303 ;
V_7 -> V_305 = V_7 -> V_304 ;
V_7 -> V_265 |= V_306 | V_307 |
V_308 | V_309 ;
V_7 -> V_265 |= F_13 ( V_5 ) . V_265 ;
if ( V_7 -> V_265 & V_267 )
V_7 -> V_265 |= V_266 ;
if ( F_13 ( V_5 ) . V_264 )
V_7 -> V_265 |= V_310 ;
V_7 -> V_311 = F_13 ( V_5 ) . V_311 ;
F_114 ( V_5 ) ;
if ( ! V_269 -> V_2 . V_257 ) {
V_162 = F_146 ( V_269 , V_312 , L_74 ) ;
if ( ! V_162 ) {
...
V_5 -> V_143 =
F_149 ( V_274 , V_315 ,
& V_276 , & V_269 -> V_2 , L_76 ) ;
if ( ! V_5 -> V_143 ) {
F_20 ( F_40 ( V_5 -> V_7 ) , L_78 , V_276 ) ;
V_15 = - V_281 ;
goto V_313;
}
V_5 -> V_142 =
F_149 ( V_274 , V_315 ,
& V_275 , & V_269 -> V_2 , L_74 ) ;
if ( ! V_5 -> V_142 ) {
F_20 ( F_40 ( V_5 -> V_7 ) , L_79 , V_275 ) ;
V_15 = - V_281 ;
goto V_313;
}
V_15 = F_150 ( V_5 -> V_105 , F_79 , 0 ,
F_62 ( V_7 ) , V_5 ) ;
if ( V_15 ) {
...
V_7 -> V_320 = F_13 ( V_5 ) . V_25 ;
if ( ( F_13 ( V_5 ) . V_12 ) ) {
V_15 = F_151 ( F_13 ( V_5 ) . V_12 ,
NULL ,
F_88 ,
V_321 | V_322 | V_323 ,
F_62 ( V_7 ) , V_5 ) ;
...
V_15 = F_154 ( & V_7 -> V_115 , & V_327 ) ;
if ( V_15 < 0 )
goto V_328;
}
if ( F_13 ( V_5 ) . V_12 && F_13 ( V_5 ) . V_30 ) {
V_15 = F_154 ( & V_7 -> V_115 ,
& V_329 ) ;
if ( V_15 < 0 )
goto V_328;
}
...
V_328:
F_155 ( V_7 ) ;
F_156 ( F_13 ( V_5 ) . V_12 , V_5 ) ;
V_324:
if ( V_5 -> V_319 )
F_25 ( V_5 ) ;
V_318:
if ( V_5 -> V_8 -> V_330 )
V_5 -> V_8 -> V_330 ( & V_269 -> V_2 ) ;
V_317:
F_156 ( V_5 -> V_105 , V_5 ) ;
V_313:
if ( V_5 -> V_142 )
...
V_162 = F_133 ( V_269 , V_282 , 0 ) ;
if ( V_162 )
F_161 ( V_162 -> V_283 , F_136 ( V_162 ) ) ;
return V_15 ;
}
static int F_162 ( struct V_268 * V_269 )
{
struct V_4 * V_5 = F_11 ( V_269 ) ;
struct V_271 * V_162 ;
F_84 ( V_5 -> V_2 ) ;
F_155 ( V_5 -> V_7 ) ;
if ( V_5 -> V_319 )
...
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( V_5 -> V_8 -> V_325 )
return V_5 -> V_8 -> V_325 ( V_2 , V_5 -> V_28 ) ;
return 0 ;
}
