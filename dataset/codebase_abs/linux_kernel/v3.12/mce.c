...
static void F_194 ( void * V_238 )
{
int V_36 = * ( ( int * ) V_238 ) ;
F_101 ( V_36 , F_48 ( V_160 ) ) ;
F_195 ( V_36 ) ;
}
void F_196 ( int V_36 )
{
...
static int T_11 F_197 ( char * V_249 )
{
struct V_132 * V_133 = & V_49 ;
if ( * V_249 == 0 ) {
F_198 () ;
...
if ( * V_249 == '=' )
V_249 ++ ;
if ( ! strcmp ( V_249 , L_35 ) )
V_133 -> V_77 = true ;
else if ( ! strcmp ( V_249 , L_36 ) )
V_133 -> V_250 = true ;
else if ( ! strcmp ( V_249 , L_37 ) )
V_133 -> V_99 = true ;
else if ( ! strcmp ( V_249 , L_38 ) )
V_133 -> V_209 = true ;
else if ( ! strcmp ( V_249 , L_39 ) || ! strcmp ( V_249 , L_40 ) )
V_133 -> V_186 = ( V_249 [ 0 ] == 'b' ) ;
else if ( ! strcmp ( V_249 , L_41 ) )
V_133 -> V_251 = true ;
else if ( isdigit ( V_249 [ 0 ] ) ) {
F_199 ( & V_249 , & ( V_133 -> V_102 ) ) ;
if ( * V_249 == ',' ) {
++ V_249 ;
F_199 ( & V_249 , & ( V_133 -> V_105 ) ) ;
}
} else {
F_137 ( L_42 , V_249 ) ;
return 0 ;
...
static void F_208 ( void * V_155 )
{
if ( ! F_60 ( F_115 ( & V_159 ) ) )
return;
F_209 () ;
}
static void F_210 ( void * V_252 )
{
if ( ! F_60 ( F_115 ( & V_159 ) ) )
return;
F_211 () ;
...
static inline struct V_174 * F_213 ( struct V_253 * V_254 )
{
return F_214 ( V_254 , struct V_174 , V_254 ) ;
}
static T_8 F_215 ( struct V_255 * V_256 , struct V_253 * V_254 ,
char * V_230 )
{
return sprintf ( V_230 , L_43 , F_213 ( V_254 ) -> V_94 ) ;
}
static T_8 F_216 ( struct V_255 * V_256 , struct V_253 * V_254 ,
const char * V_230 , T_7 V_257 )
{
T_2 V_258 ;
if ( F_217 ( V_230 , 0 , & V_258 ) < 0 )
return - V_224 ;
F_213 ( V_254 ) -> V_94 = V_258 ;
F_207 () ;
return V_257 ;
}
static T_8
F_218 ( struct V_255 * V_256 , struct V_253 * V_254 , char * V_230 )
{
strcpy ( V_230 , V_167 ) ;
strcat ( V_230 , L_7 ) ;
return strlen ( V_167 ) + 1 ;
}
static T_8 F_219 ( struct V_255 * V_256 , struct V_253 * V_254 ,
const char * V_230 , T_7 V_259 )
{
char * V_239 ;
...
static T_8 F_220 ( struct V_255 * V_256 ,
struct V_253 * V_254 ,
const char * V_230 , T_7 V_257 )
{
T_2 V_258 ;
...
V_49 . V_209 = false ;
F_181 ( F_210 , ( void * ) 1 , 1 ) ;
}
}
return V_257 ;
}
static T_8 F_221 ( struct V_255 * V_256 ,
struct V_253 * V_254 ,
const char * V_230 , T_7 V_257 )
{
T_2 V_258 ;
...
static T_8 F_222 ( struct V_255 * V_256 ,
struct V_253 * V_254 ,
const char * V_230 , T_7 V_257 )
{
T_8 V_18 = F_223 ( V_256 , V_254 , V_230 , V_257 ) ;
F_207 () ;
return V_18 ;
}
static void F_224 ( struct V_255 * V_260 )
{
F_183 ( V_260 ) ;
}
static int F_225 ( unsigned int V_3 )
{
struct V_255 * V_260 ;
int V_180 ;
int V_27 , V_261 ;
if ( ! F_60 ( & V_7 ) )
return - V_262 ;
V_260 = F_139 ( sizeof *V_260 , V_175 ) ;
if ( ! V_260 )
return - V_176 ;
V_260 -> V_263 = V_3 ;
V_260 -> V_264 = & V_265 ;
...
if ( V_180 )
return V_180 ;
for ( V_27 = 0 ; V_267 [ V_27 ] ; V_27 ++ ) {
V_180 = F_227 ( V_260 , V_267 [ V_27 ] ) ;
if ( V_180 )
goto error;
}
for ( V_261 = 0 ; V_261 < V_49 . V_92 ; V_261 ++ ) {
V_180 = F_227 ( V_260 , & V_93 [ V_261 ] . V_254 ) ;
if ( V_180 )
goto V_268;
}
F_228 ( V_3 , V_269 ) ;
F_83 ( V_270 , V_3 ) = V_260 ;
return 0 ;
V_268:
while ( -- V_261 >= 0 )
F_229 ( V_260 , & V_93 [ V_261 ] . V_254 ) ;
error:
while ( -- V_27 >= 0 )
F_229 ( V_260 , V_267 [ V_27 ] ) ;
F_230 ( V_260 ) ;
return V_180 ;
}
static void F_231 ( unsigned int V_3 )
{
struct V_255 * V_260 = F_83 ( V_270 , V_3 ) ;
int V_27 ;
if ( ! F_232 ( V_3 , V_269 ) )
return;
for ( V_27 = 0 ; V_267 [ V_27 ] ; V_27 ++ )
F_229 ( V_260 , V_267 [ V_27 ] ) ;
for ( V_27 = 0 ; V_27 < V_49 . V_92 ; V_27 ++ )
F_229 ( V_260 , & V_93 [ V_27 ] . V_254 ) ;
F_230 ( V_260 ) ;
F_233 ( V_3 , V_269 ) ;
F_83 ( V_270 , V_3 ) = NULL ;
}
static void F_234 ( void * V_271 )
{
unsigned long V_272 = * ( unsigned long * ) V_271 ;
int V_27 ;
if ( ! F_60 ( F_115 ( & V_159 ) ) )
return;
if ( ! ( V_272 & V_273 ) )
...
static int
F_236 ( struct V_32 * V_274 , unsigned long V_272 , void * V_275 )
{
unsigned int V_3 = ( unsigned long ) V_275 ;
...
break;
case V_279 :
F_238 ( V_3 , F_234 , & V_272 , 1 ) ;
F_130 ( V_104 ) ;
break;
case V_280 :
F_238 ( V_3 , F_235 , & V_272 , 1 ) ;
F_160 ( V_3 , V_104 ) ;
break;
}
if ( V_272 == V_281 ) {
...
for ( V_27 = 0 ; V_27 < V_49 . V_92 ; V_27 ++ ) {
struct V_174 * V_90 = & V_93 [ V_27 ] ;
struct V_253 * V_283 = & V_90 -> V_254 ;
F_241 ( & V_283 -> V_254 ) ;
V_283 -> V_254 . V_284 = V_90 -> V_285 ;
snprintf ( V_90 -> V_285 , V_286 , L_44 , V_27 ) ;
V_283 -> V_254 . V_287 = 0644 ;
V_283 -> V_288 = F_215 ;
V_283 -> V_289 = F_216 ;
}
}
...
static int T_11 F_248 ( char * V_249 )
{
V_49 . V_77 = true ;
return 1 ;
}
struct V_293 * F_249 ( void )
{
static struct V_293 * V_294 ;
if ( ! V_294 )
V_294 = F_250 ( L_45 , NULL ) ;
return V_294 ;
}
...
static int F_252 ( void * V_155 , T_2 * V_201 )
{
* V_201 = V_53 ;
return 0 ;
}
static int F_253 ( void * V_155 , T_2 V_201 )
{
F_251 () ;
V_53 = V_201 ;
return 0 ;
}
static int T_11 F_254 ( void )
{
struct V_293 * V_294 , * V_295 ;
V_294 = F_249 () ;
if ( ! V_294 )
return - V_176 ;
V_295 = F_255 ( L_46 , 0444 , V_294 , NULL ,
& V_296 ) ;
if ( ! V_295 )
return - V_176 ;
return 0 ;
