...
static int F_45 ( struct V_48 * V_49 , const struct V_54 * V_23 )
{
struct V_1 * V_2 ;
struct V_55 * V_56 ;
struct V_57 V_19 ;
...
if ( V_1 )
return - V_64 ;
V_2 = F_46 ( sizeof( * V_2 ) , V_65 ) ;
if ( ! V_2 )
return - V_66 ;
F_47 ( V_49 , V_2 ) ;
V_56 = F_48 ( V_49 , V_67 , 0 ) ;
if ( ! V_56 ) {
F_49 ( L_5 ) ;
goto V_68;
}
V_2 -> V_4 = V_56 -> V_69 ;
V_2 -> V_70 = V_56 -> V_71 - V_56 -> V_69 ;
if ( V_2 -> V_70 < V_72 ) {
F_49 ( L_6 ,
V_2 -> V_70 , V_72 ) ;
goto V_68;
}
if ( ! F_50 ( V_2 -> V_4 , V_2 -> V_70 ,
L_7 ) ) {
F_49 ( L_8 ) ;
goto V_68;
}
...
V_60 = F_17 ( V_2 , V_74 ) ;
V_61 = F_17 ( V_2 , V_75 ) ;
if ( V_59 == 0xff && V_60 == 0xff && V_61 == 0xff ) {
if ( F_21 ( V_2 ) ) {
T_2 V_76 ;
F_51 ( & V_2 -> V_11 ) ;
V_2 -> V_13 = true ;
...
F_52 ( L_10 , V_59 , V_60 ,
V_61 , ( V_2 -> V_13 ? L_11 : L_12 ) ) ;
memset ( & V_19 , 0 , sizeof( V_19 ) ) ;
V_19 . type = V_79 ;
V_19 . V_80 = F_19 ( V_2 , V_81 ) ;
if ( F_53 ( V_19 . V_80 > V_82 ) )
V_19 . V_80 = V_82 ;
V_58 = F_54 ( L_13 , & V_49 -> V_51 ,
V_2 , & V_83 , & V_19 ) ;
if ( F_55 ( V_58 ) ) {
V_62 = F_56 ( V_58 ) ;
goto V_78;
...
V_2 -> V_58 = V_58 ;
V_58 -> V_19 . V_18 = F_22 ( V_58 ) ;
F_57 ( V_58 ) ;
F_58 () ;
F_59 () ;
F_60 () ;
V_2 -> V_32 = V_30 ;
V_2 -> V_84 = F_61 ( & V_49 -> V_51 ) ;
if ( ! V_2 -> V_84 ) {
F_49 ( L_14 ,
F_62 ( & V_49 -> V_51 ) ) ;
V_62 = - V_77 ;
...
V_45 = F_63 ( V_2 -> V_84 , L_15 , NULL , & V_33 ) ;
if ( F_64 ( V_45 ) ) {
V_2 -> V_33 = ( int ) V_33 ;
V_45 = F_65 ( V_2 -> V_84 ,
V_86 ,
