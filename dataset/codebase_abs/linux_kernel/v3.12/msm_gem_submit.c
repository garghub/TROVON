...
int F_37 ( struct V_4 * V_5 , void * V_71 ,
struct V_21 * V_22 )
{
struct V_72 * V_73 = V_5 -> V_74 ;
struct V_20 * args = V_71 ;
...
V_9 -> V_87 [ V_23 ] . type = V_84 . type ;
V_9 -> V_87 [ V_23 ] . V_65 = V_84 . V_65 / 4 ;
V_9 -> V_87 [ V_23 ] . V_38 = V_38 + V_84 . V_64 ;
if ( V_9 -> V_53 )
continue;
