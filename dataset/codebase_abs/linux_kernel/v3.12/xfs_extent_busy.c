...
if ( V_31 - V_27 >= args -> V_40 ) {
V_37 = V_31 ;
} else if ( V_37 - V_32 >= args -> V_40 * 4 ) {
V_27 = V_32 ;
...
F_19 ( args -> V_25 , args -> V_3 , V_4 , V_5 ,
V_27 , V_28 ) ;
}
* V_34 = V_27 ;
* V_35 = V_28 ;
...
V_39:
F_13 ( & args -> V_11 -> V_19 ) ;
F_19 ( args -> V_25 , args -> V_3 , V_4 , V_5 , V_27 , 0 ) ;
* V_34 = V_27 ;
* V_35 = 0 ;
}
STATIC void
...
{
if ( V_9 -> V_17 ) {
F_21 ( V_25 , V_9 -> V_3 , V_9 -> V_4 ,
V_9 -> V_17 ) ;
F_22 ( & V_9 -> V_12 , & V_11 -> V_20 ) ;
}
F_23 ( & V_9 -> V_18 ) ;
F_24 ( V_9 ) ;
}
...
struct V_41 * V_48 )
{
return F_28 ( V_47 , struct V_7 , V_18 ) -> V_3 -
F_28 ( V_48 , struct V_7 , V_18 ) -> V_3 ;
}
