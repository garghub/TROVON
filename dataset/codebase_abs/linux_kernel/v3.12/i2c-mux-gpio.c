...
V_2 -> V_5 . V_29 = F_10 ( V_25 ) ;
F_11 ( & V_25 -> V_21 ) ;
V_2 -> V_5 . V_30 = F_12 ( V_20 ) ;
V_12 = F_13 ( & V_18 -> V_21 ,
sizeof( * V_2 -> V_5 . V_12 ) * V_2 -> V_5 . V_30 ,
V_31 ) ;
if ( ! V_12 ) {
F_8 ( & V_18 -> V_21 , L_4 ) ;
return - V_32 ;
...
unsigned V_35 , V_7 ;
int V_4 , V_26 ;
V_2 = F_13 ( & V_18 -> V_21 , sizeof( * V_2 ) , V_31 ) ;
if ( ! V_2 ) {
F_8 ( & V_18 -> V_21 , L_10 ) ;
return - V_32 ;
}
...
memcpy ( & V_2 -> V_5 , F_21 ( & V_18 -> V_21 ) ,
sizeof( V_2 -> V_5 ) ) ;
}
if ( V_2 -> V_5 . V_14 ) {
struct V_14 * V_36 ;
V_36 = F_22 ( V_2 -> V_5 . V_14 ,
F_5 ) ;
if ( ! V_36 )
return - V_28 ;
V_7 = V_36 -> V_37 ;
...
V_2 -> V_10 [ V_4 ] = F_26 ( V_29 , & V_18 -> V_21 , V_2 , V_40 ,
V_4 , V_42 ,
F_3 , F_19 ) ;
if ( ! V_2 -> V_10 [ V_4 ] ) {
V_26 = - V_27 ;
