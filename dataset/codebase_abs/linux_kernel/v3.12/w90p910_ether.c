...
return - V_53 ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_196 = F_81 ( V_15 , V_197 , 0 ) ;
if ( V_6 -> V_196 == NULL ) {
F_45 ( & V_15 -> V_2 , L_19 ) ;
error = - V_198 ;
goto V_199;
}
if ( ! F_82 ( V_6 -> V_196 -> V_200 ,
F_83 ( V_6 -> V_196 ) , V_15 -> V_21 ) ) {
F_45 ( & V_15 -> V_2 , L_20 ) ;
error = - V_201 ;
goto V_199;
}
V_6 -> V_8 = F_84 ( V_6 -> V_196 -> V_200 , F_83 ( V_6 -> V_196 ) ) ;
if ( V_6 -> V_8 == NULL ) {
F_45 ( & V_15 -> V_2 , L_21 ) ;
error = - V_198 ;
goto V_202;
...
F_92 ( V_6 -> V_8 ) ;
V_202:
F_93 ( V_6 -> V_196 -> V_200 , F_83 ( V_6 -> V_196 ) ) ;
V_199:
F_94 ( V_2 ) ;
return error ;
}
