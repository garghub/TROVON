...
static bool F_80 ( struct V_130 * V_24 )
{
if ( V_24 -> V_60 == V_61 &&
V_24 -> V_131 == 0x00e2 ) {
F_81 ( V_132 L_22 ) ;
...
static void F_82 ( struct V_130 * V_24 , enum V_133 V_121 )
{
struct V_134 * V_36 = F_83 ( V_24 ) ;
T_6 V_135 = { . V_136 = V_137 } ;
if ( V_121 == V_138 ) {
unsigned V_139 = V_36 -> V_24 -> V_139 ;
F_81 ( V_132 L_23 ) ;
V_36 -> V_140 = V_141 ;
if ( V_139 < 20 && F_80 ( V_24 ) )
V_36 -> V_24 -> V_139 = 20 ;
F_84 ( V_36 ) ;
V_36 -> V_24 -> V_139 = V_139 ;
V_36 -> V_140 = V_142 ;
F_85 ( V_36 ) ;
} else {
F_81 ( V_132 L_24 ) ;
...
static bool F_88 ( struct V_130 * V_24 )
{
struct V_134 * V_36 = F_83 ( V_24 ) ;
bool V_144 ;
F_89 ( & V_36 -> V_145 ) ;
...
V_2 -> V_90 = false ;
V_2 -> V_150 = V_151 ;
V_2 -> V_44 . V_58 = 512 * 1024 * 1024 ;
V_2 -> V_152 = false ;
for ( V_9 = 0 ; V_9 < V_153 ; V_9 ++ ) {
V_2 -> V_154 [ V_9 ] . V_155 = V_9 ;
}
F_14 ( L_25 ,
V_156 [ V_2 -> V_10 ] , V_24 -> V_157 , V_24 -> V_158 ,
V_24 -> V_60 , V_24 -> V_131 ) ;
F_69 ( & V_2 -> V_159 ) ;
F_69 ( & V_2 -> V_160 ) ;
F_92 ( & V_2 -> V_161 . V_162 , 0 ) ;
F_69 ( & V_2 -> V_163 . V_119 ) ;
F_69 ( & V_2 -> V_82 . V_119 ) ;
F_69 ( & V_2 -> V_164 ) ;
F_69 ( & V_2 -> V_165 ) ;
F_93 ( & V_2 -> V_82 . V_166 ) ;
F_93 ( & V_2 -> V_167 ) ;
F_94 ( & V_2 -> V_168 . V_169 ) ;
V_33 = F_95 ( V_2 ) ;
if ( V_33 )
return V_33 ;
F_69 ( & V_2 -> V_170 . V_162 ) ;
V_2 -> V_170 . V_171 = 1 << 20 ;
F_96 ( & V_2 -> V_170 . V_172 ) ;
V_33 = F_97 ( V_2 ) ;
if ( V_33 )
return V_33 ;
F_79 ( V_2 ) ;
...
if ( V_2 -> V_40 & V_41 && V_129 == - 1 ) {
F_98 ( V_2 ) ;
}
if ( V_2 -> V_10 >= V_174 )
V_2 -> V_44 . V_49 = 0xffffffffffULL ;
else if ( V_2 -> V_10 >= V_175 )
...
( V_2 -> V_10 <= V_178 ) )
V_2 -> V_176 = true ;
V_147 = V_2 -> V_176 ? 32 : 40 ;
V_33 = F_99 ( V_2 -> V_24 , F_100 ( V_147 ) ) ;
if ( V_33 ) {
V_2 -> V_176 = true ;
V_147 = 32 ;
F_81 ( V_179 L_26 ) ;
}
V_33 = F_101 ( V_2 -> V_24 , F_100 ( V_147 ) ) ;
if ( V_33 ) {
...
F_102 ( & V_2 -> V_191 ) ;
if ( V_2 -> V_10 >= V_192 ) {
V_2 -> V_193 = F_11 ( V_2 -> V_24 , 5 ) ;
V_2 -> V_194 = F_12 ( V_2 -> V_24 , 5 ) ;
} else {
V_2 -> V_193 = F_11 ( V_2 -> V_24 , 2 ) ;
V_2 -> V_194 = F_12 ( V_2 -> V_24 , 2 ) ;
}
V_2 -> V_195 = F_13 ( V_2 -> V_193 , V_2 -> V_194 ) ;
if ( V_2 -> V_195 == NULL ) {
return - V_27 ;
}
F_14 ( L_28 , ( T_2 ) V_2 -> V_193 ) ;
F_14 ( L_29 , ( unsigned ) V_2 -> V_194 ) ;
if ( V_2 -> V_10 >= V_192 )
F_10 ( V_2 ) ;
for ( V_9 = 0 ; V_9 < V_196 ; V_9 ++ ) {
if ( F_103 ( V_2 -> V_24 , V_9 ) & V_197 ) {
V_2 -> V_198 = F_12 ( V_2 -> V_24 , V_9 ) ;
V_2 -> V_112 = F_104 ( V_2 -> V_24 , V_9 , V_2 -> V_198 ) ;
break;
}
}
if ( V_2 -> V_112 == NULL )
...
int F_87 ( struct V_134 * V_36 , T_6 V_121 )
{
struct V_1 * V_2 ;
struct V_202 * V_203 ;
struct V_204 * V_205 ;
...
struct V_210 * V_211 = F_122 ( V_203 -> V_212 ) ;
struct V_213 * V_214 ;
if ( V_211 == NULL || V_211 -> V_215 == NULL ) {
continue;
}
V_214 = F_123 ( V_211 -> V_215 ) ;
if ( ! F_124 ( V_2 , V_214 ) ) {
V_33 = F_21 ( V_214 , false ) ;
if ( V_33 == 0 ) {
F_23 ( V_214 ) ;
F_24 ( V_214 ) ;
}
...
F_153 ( & V_2 -> V_167 ) ;
F_129 ( V_2 ) ;
V_224 = F_154 ( & V_2 -> V_225 . V_226 ) ;
F_130 ( V_2 ) ;
F_131 ( V_2 ) ;
for ( V_9 = 0 ; V_9 < V_153 ; ++ V_9 ) {
V_221 [ V_9 ] = F_155 ( V_2 , & V_2 -> V_154 [ V_9 ] ,
& V_222 [ V_9 ] ) ;
if ( V_221 [ V_9 ] ) {
V_223 = true ;
F_32 ( V_2 -> V_36 , L_37
...
{
unsigned V_9 ;
for ( V_9 = 0 ; V_9 < V_2 -> V_231 ; V_9 ++ ) {
if ( V_2 -> V_232 [ V_9 ] . V_229 == V_229 ) {
return 0 ;
}
}
V_9 = V_2 -> V_231 + 1 ;
...
V_2 -> V_232 [ V_2 -> V_231 ] . V_229 = V_229 ;
V_2 -> V_232 [ V_2 -> V_231 ] . V_234 = V_230 ;
V_2 -> V_231 = V_9 ;
#if F_160 ( V_235 )
F_161 ( V_229 , V_230 ,
V_2 -> V_93 -> V_236 -> V_237 ,
V_2 -> V_93 -> V_236 ) ;
F_161 ( V_229 , V_230 ,
V_2 -> V_93 -> V_238 -> V_237 ,
V_2 -> V_93 -> V_238 ) ;
#endif
return 0 ;
}
