...
V_1 -> V_63 [ V_52 ] -> V_21 . V_34 = F_24 ( V_33 ) ;
}
V_1 -> V_48 [ V_52 ] = F_25 ( V_1 -> V_63 [ V_52 ] ,
& V_66 [ V_52 ] ) ;
if ( F_26 ( V_1 -> V_48 [ V_52 ] ) ) {
V_9 = F_27 ( V_1 -> V_48 [ V_52 ] ) ;
F_4 ( V_1 -> V_21 ,
L_11 ,
V_52 , V_9 ) ;
goto V_65;
...
V_44 = F_14 ( V_72 , V_73 ) ;
V_53 = V_74 ;
F_29 ( V_1 -> V_48 [ V_45 ] , V_44 , V_53 ) ;
V_9 = F_30 ( V_1 -> V_48 [ V_45 ] , V_1 -> V_29 ,
...
if ( V_27 -> V_36 ) {
V_53 = V_27 -> V_37 ;
V_9 = F_29 ( V_1 -> V_48 [ V_45 ] , V_44 , V_53 ) ;
if ( V_9 )
goto V_78;
} else {
V_9 = F_31 ( V_1 -> V_48 [ V_45 ] , V_44 , & V_53 ) ;
if ( V_9 )
goto V_78;
}
if ( ! ( V_53 & V_79 ) )
...
goto V_78;
if ( V_33 ) {
V_9 = F_32 ( V_33 , NULL , NULL , & V_25 -> V_21 ) ;
if ( V_9 < 0 ) {
goto V_78;
