...
struct V_42 * V_43 ;
int V_44 = 0 ;
F_26 (pos, pattrs, node) {
if ( V_43 -> V_45 . type != V_46 )
continue;
++ V_44 ;
if ( V_43 -> V_27 ) {
V_41 -> V_28 = F_27 ( V_43 -> V_27 ) ;
if ( V_41 -> V_28 )
goto V_28;
...
struct V_51 * F_31 ( struct V_39 * V_40 ,
int V_13 , bool V_52 )
{
struct V_25 * V_26 ;
struct V_51 * V_53 ;
...
int F_35 ( int V_13 , struct V_39 * V_40 )
{
int V_14 ;
struct V_51 * V_53 ;
V_53 = F_31 ( V_40 , V_13 , false ) ;
if ( ! V_53 )
return - V_23 ;
V_14 = F_33 ( V_53 ) ;
return V_14 ;
