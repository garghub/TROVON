...
V_74 = F_51 ( V_72 , V_82 , 0 ) ;
V_27 = F_42 ( V_74 -> V_57 , V_39 -> type ,
V_61 , V_10 ) ;
if ( V_27 < 0 )
return V_27 ;
V_6 = F_52 ( V_10 , sizeof( struct V_5 ) , V_83 ) ;
if ( ! V_6 )
return - V_84 ;
V_6 -> V_7 = V_74 -> V_57 ;
V_6 -> type = V_39 -> type ;
V_6 -> V_37 = V_81 [ V_39 -> type ] ;
F_53 ( & V_6 -> V_28 ) ;
F_54 ( V_72 , V_6 ) ;
V_78 = ( F_7 ( V_6 , F_55 ( 0 ) ) & 0x05 )
== 0x04 ;
V_79 = ( F_7 ( V_6 , F_55 ( 1 ) ) & 0x05 )
== 0x04 ;
if ( V_6 -> type == V_45 ) {
V_75 = ( F_7 ( V_6 , V_85 )
& 0x0d ) == 0x09 ;
...
if ( ! ( V_75 || V_76 || V_77 || V_78 || V_79 || V_80 ) ) {
F_57 ( V_10 , L_16 ) ;
return - V_44 ;
}
F_13 ( V_10 , 1 ) ;
...
static int T_5 F_63 ( struct V_71 * V_72 )
{
struct V_5 * V_6 = F_64 ( V_72 ) ;
F_65 ( V_6 -> V_90 ) ;
F_47 ( & V_72 -> V_10 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_26 ( V_10 ) ;
F_28 ( & V_6 -> V_28 ) ;
if ( F_66 ( V_92 , V_6 -> V_93 + V_94 + V_94 / 2 ) || V_91 ) {
int V_54 , V_95 ;
V_95 = V_6 -> type == V_45 ? 3 : 2 ;
...
static int T_4 F_67 ( unsigned short V_49 ,
