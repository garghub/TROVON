...
if ( V_128 == V_17 [ V_2 -> V_6 . type ] . V_122 ) {
V_2 -> V_122 . V_123 = 14318181 ;
V_2 -> V_122 . V_124 = V_125 ;
}
...
if ( V_18 != V_131 [ V_2 -> V_6 . V_12 ] )
V_2 -> V_33 = V_131 [ V_2 -> V_6 . V_12 ] ;
if ( V_2 -> V_33 == V_35 )
...
if ( V_18 == V_2 -> V_33 )
V_2 -> V_33 = V_35 ;
V_2 -> V_133 = V_17 [ V_2 -> V_6 . type ] . V_134 ?
V_17 [ V_2 -> V_6 . type ] . V_135 - 1 : V_18 ;
V_2 -> V_136 = V_17 [ V_2 -> V_6 . type ] . V_136 == V_137 ?
V_18 : V_17 [ V_2 -> V_6 . type ] . V_136 ;
if ( V_136 [ V_2 -> V_6 . V_12 ] != V_18 )
V_2 -> V_136 = V_136 [ V_2 -> V_6 . V_12 ] ;
if ( V_138 [ V_2 -> V_6 . V_12 ] != V_18 )
V_2 -> V_28 = V_138 [ V_2 -> V_6 . V_12 ] ;
if ( V_17 [ V_2 -> V_6 . type ] . V_29 )
V_2 -> V_29 = 1 ;
if ( V_17 [ V_2 -> V_6 . type ] . V_28 )
V_2 -> V_28 = 1 ;
if ( ! V_17 [ V_2 -> V_6 . type ] . V_139 )
V_2 -> V_140 = 1 ;
if ( V_17 [ V_2 -> V_6 . type ] . V_141 )
V_2 -> V_141 = V_17 [ V_2 -> V_6 . type ] . V_141 ;
if ( V_17 [ V_2 -> V_6 . type ] . V_36 )
V_2 -> V_36 = V_17 [ V_2 -> V_6 . type ] . V_36 ;
if ( V_2 -> V_33 == V_35 )
return;
if ( V_2 -> V_142 || V_143 [ V_2 -> V_6 . V_12 ] ) {
...
struct V_146 * V_147 ;
V_147 = F_46 ( & V_2 -> V_6 . V_148 ,
& V_2 -> V_6 . V_149 , L_40 , 0 , V_144 ) ;
V_2 -> V_142 = ( V_147 != NULL ) ;
}
switch ( V_150 [ V_2 -> V_6 . V_12 ] ) {
case - 1 :
return;
case 0 :
break;
...
V_2 -> V_152 = F_46 ( & V_2 -> V_6 . V_148 ,
& V_2 -> V_6 . V_149 , L_41 , 0 , V_144 ) ;
if ( V_2 -> V_152 )
return;
goto V_153;
}
...
if ( F_46 ( & V_2 -> V_6 . V_148 ,
& V_2 -> V_6 . V_149 , L_42 , 0 , V_144 ) )
return;
goto V_153;
}
case 3 : {
V_2 -> V_155 = F_46 ( & V_2 -> V_6 . V_148 ,
& V_2 -> V_6 . V_149 , L_43 , 0 , F_47 () ) ;
if ( V_2 -> V_155 )
return;
goto V_153;
}
...
if ( ! V_17 [ V_2 -> V_6 . type ] . V_156 ) {
V_2 -> V_152 = F_46 ( & V_2 -> V_6 . V_148 ,
& V_2 -> V_6 . V_149 , L_41 ,
0 , F_48 ( V_40 >> 1 ) ) ;
} else if ( V_17 [ V_2 -> V_6 . type ] . V_157 ) {
V_2 -> V_152 = F_46 ( & V_2 -> V_6 . V_148 ,
& V_2 -> V_6 . V_149 , L_41 ,
0 , F_48 ( V_151 >> 1 ) ) ;
}
...
if ( ! V_17 [ V_2 -> V_6 . type ] . V_158 ) {
static const unsigned short V_144 [] = {
V_154 >> 1 ,
V_145
} ;
V_2 -> V_159 = F_46 ( & V_2 -> V_6 . V_148 ,
& V_2 -> V_6 . V_149 , L_42 , 0 , V_144 ) ;
if ( V_2 -> V_159 )
return;
}
...
{
int V_160 = V_161 ;
if ( V_161 != V_17 [ V_2 -> V_6 . type ] . V_162 )
V_160 = V_17 [ V_2 -> V_6 . type ] . V_162 ;
if ( V_2 -> V_33 != V_35 ) {
struct V_163 V_164 ;
if ( V_2 -> V_29 )
F_46 ( & V_2 -> V_6 . V_148 ,
...
if ( V_2 -> V_29 )
V_164 . V_168 |= V_170 ;
F_51 ( V_2 , V_131 , V_171 , & V_164 ) ;
}
if ( V_2 -> V_53 ) {
struct V_172 V_173 ;
V_173 . V_131 = V_174 ;
V_173 . V_175 = & V_2 -> V_53 ;
F_51 ( V_2 , V_131 , V_176 , & V_173 ) ;
}
}
...
{
struct V_180 V_181 ;
F_52 ( & V_2 -> V_182 , & V_181 , V_23 ) ;
V_2 -> V_33 = V_181 . V_33 ;
V_2 -> V_29 = V_181 . V_29 ;
F_2 ( L_52 ,
V_2 -> V_6 . V_12 , V_181 . V_183 ) ;
...
static int F_55 ( struct V_1 * V_2 , const T_2 * V_190 , T_1 V_191 )
{
T_1 V_192 ;
T_2 V_193 ;
int V_4 ;
F_8 ( 0xffffff , V_194 | V_195 | V_196 ) ;
F_14 ( 0 ) ;
F_9 ( V_197 ) ;
F_14 ( V_196 ) ;
F_9 ( V_197 ) ;
...
int V_200 ;
V_200 = F_56 ( & V_199 , L_55 , & V_2 -> V_6 . V_7 -> V_201 ) ;
if ( V_200 != 0 ) {
F_45 ( L_56 , V_2 -> V_6 . V_12 ) ;
return V_200 ;
}
V_200 = F_55 ( V_2 , V_199 -> V_202 , V_199 -> V_203 ) ;
F_2 ( L_57 ,
V_2 -> V_6 . V_12 , ( V_200 < 0 ) ? L_58 : L_59 ) ;
F_57 ( V_199 ) ;
return V_200 ;
}
static void F_40 ( struct V_1 * V_2 , const T_2 V_204 [ 256 ] )
{
int V_4 ;
T_1 V_205 = 0 ;
int V_5 = - 1 ;
if ( V_2 -> V_6 . type == V_82 ) {
if ( ! strncmp ( V_204 , L_60 , 4 ) ) {
T_2 V_206 = 0 ;
...
V_205 *= 10 , V_205 += V_204 [ V_4 ] - '0' ;
}
} else {
unsigned short type ;
for ( V_4 = 4 * 16 ; V_4 < 8 * 16 ; V_4 += 16 ) {
T_3 V_206 = F_58 ( V_204 + V_4 , 16 ) ;
if ( ( V_206 & 0xff ) + ( V_206 >> 8 ) == 0xff )
break;
}
if ( V_4 >= 8 * 16 )
return;
V_204 += V_4 ;
type = F_59 ( ( V_207 * ) ( V_204 + 4 ) ) ;
switch( type ) {
case 0x0004 :
V_5 = V_104 ;
break;
...
V_205 = F_60 ( ( V_208 * ) ( V_204 + 6 ) ) ;
}
F_2 ( L_62 ,
V_2 -> V_6 . V_12 , V_5 ,
V_5 > 0 ? V_17 [ V_5 ] . V_13 : L_63 , V_205 ) ;
...
{
int V_209 , V_210 , V_211 , V_33 = 0 ;
V_209 = ( V_23 [ 0x41 ] & 0x7 ) ;
V_210 = ( V_23 [ 0x41 ] & 0x18 ) >> 3 ;
V_211 = ( V_23 [ 0x42 ] & 0xf0 ) >> 4 ;
...
static void F_30 ( struct V_1 * V_2 , int V_221 )
{
int V_222 = ( 1 << V_221 ) ;
F_8 ( V_222 , V_222 ) ;
F_15 ( V_222 , 0 ) ;
...
{
static int V_225 [] = { 0x08 , 0x09 , 0x0a , 0x0b , 0x0d , 0x0d , 0x01 , 0x02 ,
...
V_226 = F_64 ( V_2 , 0x1E , 0 , V_225 [ V_4 ] , 1 ) ;
if ( V_226 != - 1 ) {
F_2 ( L_75 ,
V_225 [ V_4 ] , V_226 , F_12 ( V_2 , 0x1F , NULL ) ) ;
}
}
F_2 ( L_76 ) ;
}
...
F_2 ( L_77 ,
V_2 -> V_6 . V_12 ) ;
F_22 ( 0x00c3feff , V_234 ) ;
F_22 ( 0 + V_233 , V_235 ) ;
F_66 ( 1 ) ;
F_22 ( 0x10 + V_233 , V_235 ) ;
F_66 ( 10 ) ;
F_22 ( 0 + V_233 , V_235 ) ;
V_232 = F_65 ( V_235 ) ;
...
F_22 ( 0x4400 + V_233 , V_235 ) ;
F_66 ( 10 ) ;
F_22 ( 0x4410 + V_233 , V_235 ) ;
F_66 ( 1 ) ;
F_22 ( V_233 , V_235 ) ;
F_66 ( 1 ) ;
V_232 = F_65 ( V_235 ) ;
...
static void F_67 ( struct V_1 * V_2 , int V_236 )
{
if ( V_2 -> V_188 ) {
F_15 ( V_2 -> V_188 | V_2 -> V_187 | V_2 -> V_189 ,
V_2 -> V_188 | V_2 -> V_187 | V_2 -> V_189 ) ;
F_9 ( 5 ) ;
}
F_15 ( V_236 , 0 ) ;
F_9 ( 5 ) ;
if ( V_2 -> V_188 ) {
F_15 ( V_2 -> V_187 | V_2 -> V_189 , 0 ) ;
F_9 ( 5 ) ;
}
}
static void F_68 ( struct V_1 * V_2 , int V_236 )
{
if ( V_2 -> V_188 ) {
F_15 ( V_2 -> V_188 | V_2 -> V_187 | V_2 -> V_189 ,
V_2 -> V_188 | V_2 -> V_187 | V_2 -> V_189 ) ;
...
static int F_69 ( struct V_1 * V_2 , int V_236 )
{
if ( V_2 -> V_188 ) {
F_15 ( V_2 -> V_188 | V_2 -> V_187 | V_2 -> V_189 ,
V_2 -> V_188 | V_2 -> V_187 | V_2 -> V_189 ) ;
...
F_67 ( V_2 , V_2 -> V_46 ) ;
F_9 ( 10 ) ;
V_237 = V_238 + F_70 ( 1000 ) ;
while ( F_69 ( V_2 , V_2 -> V_47 ) && F_71 ( V_238 , V_237 ) )
F_72 () ;
...
void F_75 ( struct V_1 * V_2 , unsigned short V_186 )
{
F_73 ( L_88 , V_186 ) ;
F_53 ( V_2 , 5 * V_186 + 0x358 ) ;
}
...
{
static const T_2 V_240 [] = { 0x3 , 0x1 , 0x2 , 0x4 , 0xf , 0x7 , 0xe , 0x0 ,
0xd , 0xb , 0xc , 0x6 , 0x9 , 0x5 , 0x8 , 0xa } ;
F_15 ( 0x07f , V_240 [ V_59 ] ) ;
F_15 ( 0x200 , 0x200 ) ;
F_62 ( 1 ) ;
F_15 ( 0x200 , 0x000 ) ;
F_62 ( 1 ) ;
...
unsigned char V_202 ) {
unsigned int V_243 ;
V_243 = ( V_202 << 7 ) | ( ( V_242 & 3 ) << 4 ) | ( V_241 & 0xf ) ;
F_15 ( 0x1ff , V_243 ) ;
F_15 ( 0x1ff , V_243 | ( 1 << 8 ) ) ;
F_15 ( 0x1ff , V_243 ) ;
}
...
int V_241 , V_242 ;
struct V_1 * V_244 ;
static unsigned char V_245 [ 4 ] = { 3 , 0 , 2 , 1 } ;
V_244 = V_246 [ V_2 -> V_6 . V_12 ] ;
if ( V_244 == NULL ) {
return;
}
V_242 = ( V_2 -> V_6 . V_12 - V_244 -> V_6 . V_12 + 1 ) & 3 ;
V_242 = V_245 [ V_242 ] ;
V_241 = V_59 & 0xf ;
if ( V_244 -> V_247 [ V_242 ] != V_241 )
{
F_78 ( V_244 , V_244 -> V_247 [ V_242 ] , V_242 , 0 ) ;
V_244 -> V_247 [ V_242 ] = V_241 ;
F_78 ( V_244 , V_241 , V_242 , 1 ) ;
}
}
...
V_2 -> V_247 [ V_248 ] = V_248 ;
F_78 ( V_2 , V_248 , V_248 , 1 ) ;
}
if ( ( V_2 -> V_6 . V_12 < 1 ) || ( V_2 -> V_6 . V_12 > V_249 - 3 ) )
return;
V_246 [ V_2 -> V_6 . V_12 - 1 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
}
static void F_80 ( struct V_1 * V_2 , unsigned int V_59 )
{
static const int V_65 [] = {
V_250 , V_250 | V_251 , V_250 | V_252 , V_250 | V_251 | V_252 ,
V_253 , V_253 | V_251 , V_253 | V_252 , V_253 | V_251 | V_252 ,
...
int V_259 = V_59 / 4 ;
F_73 ( L_90 ,
V_2 -> V_6 . V_12 , V_59 , V_259 , V_258 ) ;
F_64 ( V_2 , V_260 , 0x00 ,
( ( V_259 == 3 ) ? ( V_258 | V_258 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_261 , 0x00 ,
( ( V_259 == 0 ) ? ( V_258 | V_258 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_262 , 0x00 ,
( ( V_259 == 1 ) ? ( V_258 | V_258 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_263 , 0x00 ,
( ( V_259 == 2 ) ? ( V_258 | V_258 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_260 , 0x02 ,
( ( V_259 == 3 ) ? 0x03 : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_261 , 0x02 ,
( ( V_259 == 0 ) ? 0x03 : 0x00 ) , 1 ) ;
...
long V_264 ;
int V_265 ;
unsigned char V_266 [ 2 ] ;
V_266 [ 0 ] = 0 ;
V_266 [ 1 ] = 0 ;
V_200 = F_64 ( V_2 , ( V_267 << 1 ) , V_266 [ 0 ] , V_266 [ 1 ] , 1 ) ;
if ( V_200 ) {
F_3 ( L_91 ,
V_2 -> V_6 . V_12 , V_200 ) ;
return;
}
V_200 = F_12 ( V_2 , ( V_267 << 1 ) , NULL ) ;
if ( ! ( V_200 & V_268 ) ) {
F_3 ( L_92 ,
V_2 -> V_6 . V_12 , V_200 ) ;
return;
...
V_265 = F_65 ( V_235 ) ;
if ( V_2 -> V_5 == V_269 )
V_265 = ( V_265 & ~ 0x280 ) | ( ( V_264 & 2 ) << 8 ) | ( ( V_264 & 1 ) << 7 ) ;
else
V_265 = ( V_265 & ~ 0x300 ) | ( ( V_264 & 3 ) << 8 ) ;
F_22 ( V_265 , V_235 ) ;
if ( V_2 -> V_5 == V_269 )
F_16 ( 2 << 5 , ~ V_270 , V_58 ) ;
else
F_19 ( ~ V_270 , V_58 ) ;
F_3 ( L_93 , V_2 -> V_6 . V_12 , ( int ) V_264 ) ;
}
static void F_84 ( struct V_1 * V_2 , unsigned int V_59 )
{
unsigned int V_264 = V_59 % 4 ;
if ( V_59 == V_2 -> V_136 )
V_264 = 0 ;
F_15 ( 0x3 , V_264 ) ;
}
...
unsigned char V_242 ,
unsigned char V_202 ) {
const T_1 V_271 = ( ( V_241 & 0xf ) | ( V_242 & 3 ) << 4 ) ;
const T_1 V_272 = 1 << 16 ;
const T_1 V_273 = 1 << 17 ;
const T_1 V_274 = V_202 << 18 ;
F_15 ( 0x1007f , V_271 | V_272 ) ;
F_15 ( 0x20000 , V_273 ) ;
F_15 ( 0x40000 , V_274 ) ;
F_15 ( 0x20000 , ~ V_273 ) ;
}
...
struct V_1 * V_244 ;
int V_241 , V_242 ;
static unsigned int V_245 [ 4 ] [ 4 ] = { { 0x0 , 0x4 , 0xa , 0x6 } ,
{ 0x1 , 0x5 , 0xb , 0x7 } ,
{ 0x2 , 0x8 , 0xc , 0xe } ,
{ 0x3 , 0x9 , 0xd , 0xf } } ;
V_59 = V_59 % 4 ;
...
V_242 = ( V_2 -> V_6 . V_12 - V_244 -> V_6 . V_12 ) & 3 ;
V_241 = V_245 [ V_242 ] [ V_59 ] & 0xf ;
if ( V_244 -> V_247 [ V_242 ] != V_241 ) {
F_85 ( V_244 , V_244 -> V_247 [ V_242 ] , V_242 , 0 ) ;
V_244 -> V_247 [ V_242 ] = V_241 ;
F_85 ( V_244 , V_241 , V_242 , 1 ) ;
}
}
...
for ( V_248 = 0 ; V_248 < 4 ; V_248 ++ ) {
V_2 -> V_247 [ V_248 ] = V_248 ;
F_85 ( V_2 , V_248 , V_248 , 1 ) ;
}
F_64 ( V_2 , 0x18 , 0x5 , 0x90 , 1 ) ;
if ( V_2 -> V_6 . V_12 > V_249 - 4 )
return;
V_246 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 + 3 ] = V_2 ;
}
void T_5 F_87 ( void )
{
int V_275 = 0 ;
struct V_276 * V_201 = NULL ;
if ( V_277 & ( V_278 | V_279 ) )
V_275 = 1 ;
if ( V_277 & ( V_280 | V_281 | V_282 ) )
V_283 = 1 ;
if ( V_277 & V_284 )
V_285 = 1 ;
#ifdef F_88
...
if ( V_18 != V_286 )
F_2 ( L_99 , V_286 ) ;
while ( ( V_201 = F_89 ( V_288 ,
V_289 , V_201 ) ) ) {
unsigned char V_290 ;
F_90 ( V_201 , 0x53 , & V_290 ) ;
if ( V_70 )
F_2 ( L_100 ,
V_290 ) ;
}
...
{
unsigned char V_291 ;
if ( ! V_283 && ! V_285 && V_18 == V_286 )
return 0 ;
if ( V_224 ) {
if ( V_283 )
F_2 ( L_101 ,
V_2 -> V_6 . V_12 ) ;
if ( V_285 && V_2 -> V_11 >= 878 )
...
F_90 ( V_2 -> V_6 . V_7 , V_293 , & V_291 ) ;
if ( V_283 )
V_291 |= V_294 ;
if ( V_285 )
V_291 |= V_295 ;
F_92 ( V_2 -> V_6 . V_7 , V_293 , V_291 ) ;
}
if ( V_18 != V_286 )
F_92 ( V_2 -> V_6 . V_7 , V_296 , V_286 ) ;
return 0 ;
}
