...
F_21 ( & V_6 -> V_42 , L_2
L_3 ,
V_31 -> V_48 , V_33 -> V_1 , V_6 -> V_44 ) ;
if ( ! F_22 ( V_35 , V_49 ) )
return - V_50 ;
if ( V_37 ) {
if ( V_37 -> V_51 != V_33 -> V_1 ) {
F_20 ( & V_6 -> V_42 , L_4
L_5 ,
V_37 -> V_51 , V_33 -> V_1 ) ;
return - V_47 ;
...
V_9 = F_23 ( & V_6 -> V_42 , sizeof( * V_9 ) , V_52 ) ;
if ( ! V_9 )
return - V_53 ;
V_9 -> V_54 = F_23 ( & V_6 -> V_42 ,
sizeof( * V_13 ) * V_33 -> V_1 , V_52 ) ;
if ( ! V_9 -> V_54 )
return - V_53 ;
F_24 ( V_6 , V_9 ) ;
F_25 ( & V_9 -> V_17 ) ;
...
V_13 -> V_9 = V_9 ;
if ( V_37 ) {
if ( V_37 -> V_54 [ V_38 ] . V_48 )
snprintf ( V_13 -> V_48 ,
sizeof( V_13 -> V_48 ) , L_6 ,
V_37 -> V_54 [ V_38 ] . V_48 ) ;
if ( V_37 -> V_54 [ V_38 ] . V_55 )
V_13 -> V_27 . V_55 =
V_37 -> V_54 [ V_38 ] . V_55 ;
} else {
snprintf ( V_13 -> V_48 , sizeof( V_13 -> V_48 ) ,
L_7 , V_38 ) ;
}
V_13 -> V_27 . V_48 = V_13 -> V_48 ;
V_13 -> V_27 . V_56 = F_15 ;
F_26 ( & V_13 -> V_12 , F_11 ) ;
V_39 = F_27 ( & V_6 -> V_42 ,
& V_13 -> V_27 ) ;
...
exit:
while ( V_38 -- ) {
F_28 ( & V_9 -> V_54 [ V_38 ] . V_27 ) ;
F_29 ( & V_9 -> V_54 [ V_38 ] . V_12 ) ;
}
return V_39 ;
}
