...
static int F_57 ( struct V_38 * V_38 , void T_3 * V_100 )
{
int V_32 ;
struct V_101 args ;
struct V_5 * V_14 = NULL ;
if ( F_58 ( & args , V_100 , sizeof( struct V_101 ) ) )
return - V_102 ;
args . V_103 [ 23 ] = 0 ;
...
case V_113 :
V_32 = - V_114 ;
V_14 = F_60 ( V_38 , args . V_103 ) ;
if ( ! V_14 )
goto V_83;
V_32 = - V_115 ;
if ( args . V_106 != V_110 && ! F_50 ( V_14 ) )
goto V_83;
}
switch ( args . V_106 ) {
case V_107 :
V_32 = - V_116 ;
if ( ! F_61 ( V_38 -> V_117 , V_118 ) )
break;
F_62 ( V_14 ,
args . V_104 . V_119 ,
args . V_120 ) ;
...
if ( ! F_61 ( V_38 -> V_117 , V_118 ) )
break;
V_32 = F_29 ( V_14 , args . V_104 . V_124 ) ;
break;
case V_111 :
V_32 = - V_116 ;
if ( ! F_61 ( V_38 -> V_117 , V_118 ) )
