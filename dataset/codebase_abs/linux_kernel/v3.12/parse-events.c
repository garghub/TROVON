...
continue;
if ( V_153 ) {
printf ( L_27 , V_16 . V_8 , V_17 . V_8 ) ;
continue;
}
snprintf ( V_4 , V_5 , L_28 ,
V_16 . V_8 , V_17 . V_8 ) ;
printf ( L_29 , V_4 ,
V_154 [ V_26 ] ) ;
}
...
V_36 = F_19 ( & V_32 , 0 ) ;
if ( V_36 ) {
V_64 = F_81 ( V_36 , NULL , & V_160 . V_158 ) >= 0 ;
F_82 ( V_36 ) ;
}
return V_64 ;
}
static void F_83 ( T_7 type , struct V_162 * V_163 ,
unsigned V_164 )
{
char V_22 [ 64 ] ;
unsigned V_42 ;
for ( V_42 = 0 ; V_42 < V_164 ; V_42 ++ , V_163 ++ ) {
if ( ! F_80 ( type , V_42 ) )
continue;
if ( strlen ( V_163 -> V_165 ) )
snprintf ( V_22 , sizeof( V_22 ) , L_30 ,
V_163 -> V_166 , V_163 -> V_165 ) ;
else
snprintf ( V_22 , sizeof( V_22 ) , L_9 , V_163 -> V_166 ) ;
printf ( L_29 , V_22 , V_154 [ type ] ) ;
}
}
void F_84 ( T_7 type )
{
if ( type == V_25 )
F_83 ( type , V_167 , V_168 ) ;
else
F_83 ( type , V_169 , V_170 ) ;
}
int F_85 ( const char * V_152 , bool V_153 )
{
unsigned int type , V_171 , V_42 , V_172 = 0 ;
char V_22 [ 64 ] ;
for ( type = 0 ; type < V_54 ; type ++ ) {
for ( V_171 = 0 ; V_171 < V_56 ; V_171 ++ ) {
if ( ! F_24 ( type , V_171 ) )
continue;
for ( V_42 = 0 ; V_42 < V_58 ; V_42 ++ ) {
F_86 ( type , V_171 , V_42 ,
V_22 , sizeof( V_22 ) ) ;
if ( V_152 != NULL && ! F_29 ( V_22 , V_152 ) )
continue;
if ( ! F_80 ( V_27 ,
type | ( V_171 << 8 ) | ( V_42 << 16 ) ) )
continue;
if ( V_153 )
printf ( L_31 , V_22 ) ;
else
...
static void F_87 ( const char * V_152 , unsigned type ,
struct V_162 * V_163 , unsigned V_164 ,
bool V_153 )
{
unsigned V_42 , V_172 = 0 ;
char V_22 [ V_48 ] ;
for ( V_42 = 0 ; V_42 < V_164 ; V_42 ++ , V_163 ++ ) {
if ( V_152 != NULL &&
! ( F_29 ( V_163 -> V_166 , V_152 ) ||
( V_163 -> V_165 && F_29 ( V_163 -> V_165 , V_152 ) ) ) )
continue;
if ( ! F_80 ( type , V_42 ) )
continue;
if ( V_153 ) {
printf ( L_31 , V_163 -> V_166 ) ;
continue;
}
if ( strlen ( V_163 -> V_165 ) )
snprintf ( V_22 , V_48 , L_30 , V_163 -> V_166 , V_163 -> V_165 ) ;
else
strncpy ( V_22 , V_163 -> V_166 , V_48 ) ;
printf ( L_29 , V_22 , V_154 [ type ] ) ;
V_172 ++ ;
}
if ( V_172 )
...
void F_88 ( const char * V_152 , bool V_153 )
{
if ( ! V_153 ) {
printf ( L_32 ) ;
printf ( L_33 ) ;
...
int F_90 ( struct V_79 * V_80 )
{
return V_80 -> V_81 != V_174 ;
}
static int F_91 ( struct V_79 * * V_175 , int V_176 ,
int V_81 , char * V_12 ,
char * V_23 , T_1 V_85 )
{
struct V_79 * V_80 ;
...
{
return F_91 ( V_80 , V_177 , V_81 ,
V_12 , NULL , V_85 ) ;
}
int F_94 ( struct V_79 * * V_80 ,
int V_81 , char * V_12 , char * V_23 )
{
return F_91 ( V_80 , V_178 , V_81 ,
V_12 , V_23 , 0 ) ;
}
...
V_179 = & V_169 [ V_30 ] ;
if ( V_12 )
return F_91 ( V_80 , V_178 ,
V_174 , V_12 ,
( char * ) V_179 -> V_166 , 0 ) ;
else
return F_91 ( V_80 , V_178 ,
V_174 ,
( char * ) L_38 , ( char * ) V_179 -> V_166 , 0 ) ;
}
int F_97 ( struct V_79 * * V_180 ,
struct V_79 * V_80 )
{
return F_91 ( V_180 , V_80 -> V_176 , V_80 -> V_81 , V_80 -> V_12 ,
V_80 -> V_84 . V_23 , V_80 -> V_84 . V_85 ) ;
}
void F_71 ( struct V_28 * V_135 )
{
struct V_79 * V_80 , * V_181 ;
F_98 (term, h, terms, list)
free ( V_80 ) ;
}
