...
V_34 = F_26 ( & V_8 -> V_3 ) ;
if ( V_34 < 0 ) {
F_20 ( & V_33 -> V_16 , L_7 , V_34 ) ;
return V_34 ;
}
F_27 ( & V_33 -> V_16 ) ;
F_5 ( & V_33 -> V_16 ) ;
V_38 = F_28 ( V_33 -> V_16 . V_51 ,
V_52 ) ;
if ( ! ( V_38 & V_53 ) ) {
F_20 ( & V_33 -> V_16 , L_8 ) ;
V_34 = - V_42 ;
...
{
F_5 ( V_8 -> V_3 . V_16 ) ;
V_8 -> V_56 . V_57 = F_6 ( V_8 -> V_17 + V_18 ) ;
V_8 -> V_56 . V_58 = F_35 ( V_8 -> V_17 + V_25 ) ;
V_8 -> V_56 . V_59 = F_35 ( V_8 -> V_17 + V_26 ) ;
F_10 ( V_8 -> V_3 . V_16 ) ;
}
static void F_36 ( struct V_1 * V_8 )
{
F_9 ( V_8 -> V_56 . V_59 , V_8 -> V_17 + V_26 ) ;
F_9 ( V_8 -> V_56 . V_58 , V_8 -> V_17 + V_25 ) ;
F_7 ( V_8 -> V_56 . V_57 , V_8 -> V_17 + V_18 ) ;
}
static int F_37 ( struct V_60 * V_16 )
{
struct V_1 * V_8 = F_38 ( V_16 ) ;
struct V_4 * V_5 = V_8 -> V_3 . V_61 ;
F_34 ( V_8 ) ;
if ( F_8 ( V_21 , & V_5 -> V_22 ) )
F_10 ( V_16 ) ;
return 0 ;
}
static int F_39 ( struct V_60 * V_16 )
{
struct V_1 * V_8 = F_38 ( V_16 ) ;
struct V_4 * V_5 = V_8 -> V_3 . V_61 ;
if ( F_8 ( V_21 , & V_5 -> V_22 ) )
