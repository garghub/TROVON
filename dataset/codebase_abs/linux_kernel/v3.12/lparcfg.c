...
{
int V_51 ;
unsigned char * V_52 = F_21 ( V_53 , V_54 ) ;
if ( ! V_52 ) {
F_22 ( V_55 L_31 ,
...
F_9 ( V_30 , L_42 , F_18 ( V_70 ) ) ;
if ( ! F_18 ( V_70 ) )
return;
F_2 (cpu) {
V_68 += F_34 ( F_35 ( V_2 ) . V_68 ) ;
V_69 += F_34 ( F_35 ( V_2 ) . V_69 ) ;
}
F_9 ( V_30 , L_43 , V_68 ) ;
F_9 ( V_30 , L_44 ,
V_69 / V_71 ) ;
...
static int F_42 ( struct V_29 * V_30 , void * V_79 )
{
int V_80 ;
int V_81 ;
struct V_31 * V_82 ;
...
static T_1 F_43 ( T_2 * V_13 , T_3 * V_18 )
{
struct V_7 V_8 ;
T_3 V_88 ;
T_2 V_89 ;
...
F_44 ( L_62 ,
V_56 , V_89 , V_88 ) ;
V_90 = F_45 ( V_92 , V_89 , V_88 ) ;
return V_90 ;
}
static T_1 F_46 ( T_2 * V_13 , T_3 * V_18 )
{
struct V_35 V_36 ;
T_2 V_89 ;
T_3 V_88 ;
...
F_44 ( L_62 ,
V_56 , V_89 , V_88 ) ;
V_9 = F_45 ( V_93 , V_89 , V_88 ) ;
return V_9 ;
}
static T_1 F_48 ( struct V_94 * V_94 , const char T_4 * V_95 ,
T_5 V_67 , T_6 * V_96 )
{
int V_97 = 64 ;
char V_98 [ V_97 ] ;
...
if ( ! strcmp ( V_98 , L_64 ) ) {
char * V_103 ;
* V_100 = ( T_2 ) F_50 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_43 ( V_100 , NULL ) ;
} else if ( ! strcmp ( V_98 , L_65 ) ) {
char * V_103 ;
* V_101 = ( T_3 ) F_50 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_43 ( NULL , V_101 ) ;
} else if ( ! strcmp ( V_98 , L_66 ) ) {
char * V_103 ;
* V_100 = ( T_2 ) F_50 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_46 ( V_100 , NULL ) ;
} else if ( ! strcmp ( V_98 , L_67 ) ) {
char * V_103 ;
* V_101 = ( T_3 ) F_50 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_46 ( NULL , V_101 ) ;
} else
return - V_91 ;
...
static int F_51 ( struct V_29 * V_30 , void * V_79 )
{
struct V_31 * V_110 ;
...
return F_42 ( V_30 , V_79 ) ;
}
static int F_52 ( struct V_117 * V_117 , struct V_94 * V_94 )
{
return F_53 ( V_94 , F_51 , NULL ) ;
}
