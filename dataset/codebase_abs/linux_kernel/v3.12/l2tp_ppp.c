...
static int F_37 ( struct V_61 * V_37 , struct V_9 * V_10 )
{
...
static int F_55 ( struct V_73 * V_73 , struct V_14 * V_2 )
{
int error = - V_55 ;
struct V_2 * V_3 ;
V_3 = F_56 ( V_73 , V_74 , V_59 , & V_75 ) ;
if ( ! V_3 )
goto V_6;
F_57 ( V_2 , V_3 ) ;
V_2 -> V_76 = V_77 ;
...
static void F_58 ( struct V_88 * V_40 , void * V_89 )
{
struct V_1 * V_4 = V_89 ;
struct V_30 * V_31 = F_14 ( V_4 ) ;
if ( V_31 ) {
...
if ( V_34 )
F_59 ( V_40 , L_4 , F_60 ( & V_34 -> V_37 ) ) ;
}
}
static int F_61 ( struct V_14 * V_2 , struct V_90 * V_91 ,
int V_92 , int V_18 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
...
error = F_64 ( F_63 ( V_3 ) , V_104 , V_103 , V_99 , V_100 , & V_120 , & V_44 ) ;
if ( error < 0 )
goto V_23;
}
} else {
...
if ( V_44 -> V_100 == 0 )
V_44 -> V_100 = V_100 ;
V_4 = F_65 ( F_63 ( V_3 ) , V_44 , V_101 ) ;
if ( V_4 == NULL ) {
V_98 . V_124 = V_98 . V_125 = 1500 - V_126 ;
V_4 = F_66 ( sizeof( struct V_30 ) ,
V_44 , V_101 ,
V_102 , & V_98 ) ;
if ( V_4 == NULL ) {
error = - V_55 ;
...
static int F_73 ( struct V_73 * V_73 , T_3 V_99 , T_3 V_101 , T_3 V_102 , struct V_97 * V_98 )
{
int error ;
struct V_43 * V_44 ;
struct V_1 * V_4 ;
...
static int F_74 ( struct V_14 * V_2 , struct V_90 * V_144 ,
int * V_145 , int V_146 )
{
int V_17 = 0 ;
int error = 0 ;
...
( V_44 -> V_2 -> V_83 == V_163 ) ) {
struct V_164 * V_165 = F_77 ( V_44 -> V_2 ) ;
struct V_116 V_94 ;
V_17 = sizeof( V_94 ) ;
memset ( & V_94 , 0 , V_17 ) ;
V_94 . V_153 = V_154 ;
...
struct V_172 * V_38 )
{
V_171 -> V_173 = F_79 ( & V_38 -> V_173 ) ;
V_171 -> V_174 = F_79 ( & V_38 -> V_174 ) ;
V_171 -> V_175 = F_79 ( & V_38 -> V_175 ) ;
V_171 -> V_176 = F_79 ( & V_38 -> V_176 ) ;
V_171 -> V_177 = F_79 ( & V_38 -> V_177 ) ;
V_171 -> V_178 = F_79 ( & V_38 -> V_178 ) ;
V_171 -> V_179 = F_79 ( & V_38 -> V_179 ) ;
V_171 -> V_39 = F_79 ( & V_38 -> V_39 ) ;
}
...
break;
V_19 = - V_186 ;
if ( F_81 ( & V_182 , ( void V_187 * ) V_89 , sizeof( struct V_181 ) ) )
break;
V_182 . V_188 = V_4 -> V_124 ;
if ( F_82 ( ( void V_187 * ) V_89 , & V_182 , sizeof( struct V_181 ) ) )
break;
F_21 ( V_4 , V_143 , L_7 ,
V_4 -> V_36 , V_4 -> V_124 ) ;
V_19 = 0 ;
...
break;
V_19 = - V_186 ;
if ( F_83 ( V_4 -> V_125 , ( int V_187 * ) V_89 ) )
break;
F_21 ( V_4 , V_143 , L_9 ,
V_4 -> V_36 , V_4 -> V_125 ) ;
V_19 = 0 ;
...
case V_192 :
V_19 = - V_186 ;
if ( F_83 ( V_31 -> V_18 , ( int V_187 * ) V_89 ) )
break;
F_21 ( V_4 , V_143 , L_11 ,
V_4 -> V_36 , V_31 -> V_18 ) ;
V_19 = 0 ;
...
if ( V_38 . V_101 != 0 ) {
struct V_1 * V_4 =
F_65 ( F_63 ( V_3 ) , V_44 , V_38 . V_101 ) ;
if ( V_4 != NULL )
V_19 = F_80 ( V_4 , V_180 , V_89 ) ;
else
V_19 = - V_196 ;
break;
}
...
#endif
F_78 ( & V_38 , & V_44 -> V_38 ) ;
if ( F_82 ( ( void V_187 * ) V_89 , & V_38 , sizeof( V_38 ) ) ) {
V_19 = - V_186 ;
break;
}
...
static int F_87 ( struct V_14 * V_2 , unsigned int V_180 ,
unsigned long V_89 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_1 * V_4 ;
...
static int F_91 ( struct V_14 * V_2 , int V_212 , int V_199 ,
...
if ( V_44 == NULL )
goto V_150;
V_19 = F_88 ( V_3 , V_44 , V_199 , V_183 ) ;
F_3 ( V_31 -> V_50 ) ;
} else
V_19 = F_89 ( V_3 , V_4 , V_199 , V_183 ) ;
V_19 = 0 ;
V_150:
F_3 ( V_3 ) ;
V_23:
...
static int F_95 ( struct V_14 * V_2 , int V_212 , int V_199 ,
...
if ( V_44 == NULL )
goto V_150;
V_19 = F_92 ( V_3 , V_44 , V_199 , & V_183 ) ;
F_3 ( V_31 -> V_50 ) ;
} else
V_19 = F_93 ( V_3 , V_4 , V_199 , & V_183 ) ;
V_19 = - V_186 ;
if ( F_83 ( V_17 , V_214 ) )
goto V_150;
if ( F_82 ( ( void V_187 * ) V_213 , & V_183 , V_17 ) )
goto V_150;
V_19 = 0 ;
V_150:
F_3 ( V_3 ) ;
...
{
for (; ; ) {
V_220 -> V_44 = F_98 ( V_73 , V_220 -> V_221 ) ;
V_220 -> V_221 ++ ;
if ( V_220 -> V_44 == NULL )
break;
...
static void F_99 ( struct V_73 * V_73 , struct V_219 * V_220 )
{
V_220 -> V_4 = F_100 ( V_220 -> V_44 , V_220 -> V_222 ) ;
V_220 -> V_222 ++ ;
if ( V_220 -> V_4 == NULL ) {
V_220 -> V_222 = 0 ;
F_97 ( V_73 , V_220 ) ;
...
static void * F_101 ( struct V_88 * V_40 , T_4 * V_223 )
{
...
static void * F_103 ( struct V_88 * V_40 , void * V_226 , T_4 * V_225 )
{
( * V_225 ) ++ ;
return NULL ;
}
static void F_104 ( struct V_88 * V_227 , void * V_226 )
{
}
...
F_59 ( V_40 , L_27 ,
V_44 -> V_121 ,
F_79 ( & V_44 -> V_38 . V_173 ) ,
F_79 ( & V_44 -> V_38 . V_174 ) ,
F_79 ( & V_44 -> V_38 . V_175 ) ,
F_79 ( & V_44 -> V_38 . V_176 ) ,
F_79 ( & V_44 -> V_38 . V_177 ) ,
F_79 ( & V_44 -> V_38 . V_39 ) ) ;
}
static void F_107 ( struct V_88 * V_40 , void * V_226 )
{
...
T_5 V_230 = 0 ;
if ( V_44 -> V_2 ) {
struct V_147 * V_148 = F_75 ( V_44 -> V_2 ) ;
V_229 = F_108 ( V_148 -> V_231 ) ;
V_230 = F_109 ( V_148 -> V_232 ) ;
}
F_59 ( V_40 , L_28
L_29 ,
...
static int F_110 ( struct V_88 * V_40 , void * V_226 )
{
struct V_219 * V_220 = V_226 ;
if ( V_226 == V_224 ) {
F_111 ( V_40 , L_34 V_235 L_35 ) ;
F_111 ( V_40 , L_36 ) ;
F_111 ( V_40 , L_37 ) ;
F_111 ( V_40 , L_38
L_39 ) ;
...
if ( V_220 -> V_4 == NULL )
F_105 ( V_40 , V_220 -> V_44 ) ;
else
F_107 ( V_40 , V_220 -> V_4 ) ;
V_6:
return 0 ;
}
static int F_112 ( struct V_236 * V_236 , struct V_237 * V_237 )
{
return F_113 ( V_236 , V_237 , & V_238 ,
sizeof( struct V_219 ) ) ;
}
static T_6 int F_114 ( struct V_73 * V_73 )
{
struct V_239 * V_240 ;
int V_19 = 0 ;
V_240 = F_115 ( L_42 , V_241 , V_73 -> V_242 ,
& V_243 ) ;
if ( ! V_240 ) {
V_19 = - V_55 ;
goto V_6;
...
static T_7 void F_116 ( struct V_73 * V_73 )
{
F_117 ( L_42 , V_73 -> V_242 ) ;
}
...
if ( V_19 )
goto V_245;
V_19 = F_121 ( V_82 , & V_246 ) ;
if ( V_19 )
goto V_247;
#ifdef F_122
V_19 = F_123 ( V_248 , & V_249 ) ;
if ( V_19 )
goto V_250;
#endif
F_124 ( L_43 , V_235 ) ;
