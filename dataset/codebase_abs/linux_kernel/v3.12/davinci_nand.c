...
static int T_5 F_39 ( struct V_83 * V_84 )
{
struct V_82 * V_87 ;
struct V_1 * V_2 ;
struct V_101 * V_102 ;
...
F_41 ( V_84 , V_2 ) ;
V_102 = F_42 ( V_84 , V_109 , 0 ) ;
V_103 = F_42 ( V_84 , V_109 , 1 ) ;
if ( ! V_102 || ! V_103 ) {
F_40 ( & V_84 -> V_85 , L_13 ) ;
V_105 = - V_67 ;
goto V_108;
}
V_104 = F_43 ( & V_84 -> V_85 , V_102 ) ;
if ( F_44 ( V_104 ) ) {
V_105 = F_45 ( V_104 ) ;
goto V_110;
}
V_4 = F_43 ( & V_84 -> V_85 , V_103 ) ;
if ( F_44 ( V_4 ) ) {
V_105 = F_45 ( V_4 ) ;
goto V_110;
}
...
V_2 -> V_24 . V_115 = 0 ;
V_2 -> V_24 . V_116 = F_8 ;
V_2 -> V_24 . V_99 = V_87 -> V_99 ;
V_2 -> V_24 . V_97 = V_87 -> V_97 ;
...
V_2 -> V_133 = F_49 ( & V_84 -> V_85 , L_14 ) ;
if ( F_44 ( V_2 -> V_133 ) ) {
V_105 = F_45 ( V_2 -> V_133 ) ;
F_50 ( & V_84 -> V_85 , L_15 , V_105 ) ;
goto V_134;
}
V_105 = F_51 ( V_2 -> V_133 ) ;
if ( V_105 < 0 ) {
F_50 ( & V_84 -> V_85 , L_16 ,
V_105 ) ;
goto V_135;
}
V_46 = F_1 ( V_2 , V_136 + V_2 -> V_29 * 4 ) ;
V_46 &= ~ ( V_137 | V_138 | V_139 ) ;
if ( V_2 -> V_24 . V_97 & V_98 )
V_46 |= 0x1 ;
F_3 ( V_2 , V_136 + V_2 -> V_29 * 4 , V_46 ) ;
V_105 = 0 ;
if ( V_2 -> V_119 )
V_105 = F_52 ( V_2 -> V_119 , V_2 -> V_4 ,
V_2 -> V_29 ) ;
if ( V_105 < 0 ) {
F_50 ( & V_84 -> V_85 , L_17 ) ;
goto V_140;
...
F_3 ( V_2 , V_34 , V_46 ) ;
F_48 ( & V_33 ) ;
V_105 = F_53 ( & V_2 -> V_7 , V_87 -> V_26 ? 2 : 1 , NULL ) ;
if ( V_105 < 0 ) {
F_50 ( & V_84 -> V_85 , L_18 ) ;
goto V_141;
}
if ( V_87 -> V_96 == 4 ) {
int V_142 = V_2 -> V_7 . V_143 / 512 ;
if ( ! V_142 || V_2 -> V_7 . V_144 < 16 ) {
F_50 ( & V_84 -> V_85 , L_19 ) ;
V_105 = - V_67 ;
goto V_141;
}
if ( V_142 == 1 ) {
V_2 -> V_145 = V_146 ;
V_2 -> V_145 . V_147 [ 1 ] . V_148 =
V_2 -> V_7 . V_144 - 16 ;
goto V_149;
}
if ( V_142 == 4 ) {
V_2 -> V_145 = V_150 ;
V_2 -> V_24 . V_44 . V_30 = V_151 ;
goto V_149;
}
F_54 ( & V_84 -> V_85 , L_20
L_21 ) ;
...
goto V_141;
V_149:
V_2 -> V_24 . V_44 . V_152 = & V_2 -> V_145 ;
}
V_105 = F_55 ( & V_2 -> V_7 ) ;
if ( V_105 < 0 )
goto V_141;
if ( V_87 -> V_153 )
V_105 = F_56 ( & V_2 -> V_7 , NULL , NULL ,
V_87 -> V_153 , V_87 -> V_154 ) ;
else {
struct V_155 V_156 ;
V_156 . V_86 = V_84 -> V_85 . V_86 ;
V_105 = F_56 ( & V_2 -> V_7 , NULL , & V_156 ,
NULL , 0 ) ;
}
if ( V_105 < 0 )
goto V_141;
...
static int T_7 F_59 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_60 ( V_84 ) ;
F_47 ( & V_33 ) ;
if ( V_2 -> V_24 . V_44 . V_30 == V_158 )
V_126 = false ;
F_48 ( & V_33 ) ;
F_61 ( & V_2 -> V_7 ) ;
F_58 ( V_2 -> V_133 ) ;
