...
struct V_179 * V_180 ;
struct V_181 * V_182 ;
V_182 = F_53 ( V_2 -> V_5 . V_15 , V_2 -> V_5 . V_183 ) ;
V_180 = F_54 ( V_182 , V_2 -> V_5 . V_180 ) ;
if ( ! V_180 ) {
F_6 ( L_59 ) ;
V_2 -> V_5 . V_8 = - V_184 ;
return;
...
F_2 ( V_2 , V_190 , 0x01 ) ;
F_2 ( V_2 , V_191 , 0x03 ) ;
V_173 = ( V_2 -> V_5 . V_172 >> 3 ) - 1 ;
V_174 = ( V_2 -> V_5 . V_192 >> 3 ) - 1 ;
F_2 ( V_2 , V_193 , V_173 ) ;
F_2 ( V_2 , V_194 , V_174 ) ;
F_2 ( V_2 , V_195 , 0x00 ) ;
F_2 ( V_2 , V_196 , 0x00 ) ;
...
V_177 = V_176 * V_2 -> V_5 . V_172 * V_2 -> V_5 . V_192 * 3 / 2 ;
if ( V_177 > 1000 * V_175 ) {
F_2 ( V_2 , V_100 , 0x07 ) ;
F_2 ( V_2 , V_101 , 0x03 ) ;
} else {
...
V_173 = V_2 -> V_5 . V_172 / 16 ;
V_174 = V_2 -> V_5 . V_192 / 4 ;
F_2 ( V_2 , 0x29 , V_173 ) ;
F_2 ( V_2 , 0x2a , V_174 ) ;
F_2 ( V_2 , 0x39 , V_173 ) ;
F_2 ( V_2 , 0x3a , V_174 ) ;
...
switch ( V_2 -> V_59 ) {
case V_68 :
if ( V_2 -> V_108 > 0 && V_2 -> V_5 . V_172 == 640 ) {
F_2 ( V_2 , 0x20 , 0x60 ) ;
F_2 ( V_2 , 0x21 , 0x1f ) ;
} else {
F_2 ( V_2 , 0x20 , 0x00 ) ;
...
F_2 ( V_2 , V_207 , V_2 -> V_5 . V_172 >> 4 ) ;
F_2 ( V_2 , V_208 , V_2 -> V_5 . V_192 >> 3 ) ;
if ( V_2 -> V_59 == V_66 &&
V_2 -> V_5 . V_130 . V_134 [ V_2 -> V_5 . V_123 ] . V_209 )
F_2 ( V_2 , V_210 , 0x04 ) ;
...
T_2 V_1 ;
V_216 = V_5 -> V_130 . V_134 [ V_5 -> V_123 ] . V_209 & 1 ;
switch ( V_2 -> V_59 ) {
case V_60 :
...
case V_63 :
if ( V_216 ) {
V_217 = ( 1040 - V_5 -> V_172 ) / 2 + ( 0x1f << 4 ) ;
V_219 = ( 776 - V_5 -> V_192 ) / 2 ;
} else {
V_217 = ( 2076 - V_5 -> V_172 ) / 2 + ( 0x10 << 4 ) ;
V_219 = ( 1544 - V_5 -> V_192 ) / 2 ;
}
V_218 = V_217 + V_5 -> V_172 ;
V_220 = V_219 + V_5 -> V_192 ;
...
static void F_59 ( struct V_5 * V_5 , T_4 V_232 , T_4 V_233 )
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
if ( V_2 -> V_5 . V_234 )
F_2 ( V_2 , V_42 , 0x0f ) ;
...
V_5 = & V_2 -> V_5 ;
V_216 = V_5 -> V_130 . V_134 [ V_5 -> V_123 ] . V_209 & 1 ;
V_238 = V_5 -> V_130 . V_134 [ V_5 -> V_123 ] . V_209 & 2 ;
switch ( V_2 -> V_59 ) {
case V_65 :
V_239 = 0x1e ;
V_240 = 0x1e ;
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
V_2 -> V_245 = V_2 -> V_5 . V_172 ;
V_2 -> V_246 = V_2 -> V_5 . V_192 ;
switch ( V_2 -> V_9 ) {
case V_10 :
case V_11 :
F_52 ( V_2 ) ;
...
static void F_69 ( struct V_5 * V_5 , T_2 V_253 )
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
if ( V_2 -> V_250 != V_253 ) {
#if F_66 ( V_249 )
F_67 ( V_5 -> V_251 , V_252 , V_253 ) ;
F_68 ( V_5 -> V_251 ) ;
#endif
if ( V_253 )
V_2 -> V_83 = 1 ;
...
( V_254 [ 8 ] & 0x08 ) ) {
F_69 ( V_5 , ( V_254 [ 8 ] >> 2 ) & 1 ) ;
if ( V_254 [ 8 ] & 0x80 ) {
if ( ( V_254 [ 9 ] + 1 ) * 8 != V_5 -> V_172 ||
( V_254 [ 10 ] + 1 ) * 8 != V_5 -> V_192 ) {
F_6 ( L_61
L_62 ,
...
F_71 ( V_5 , V_258 , V_254 , 11 ) ;
return;
} else {
F_71 ( V_5 , V_259 , V_254 , 0 ) ;
V_2 -> V_260 = 0 ;
}
}
V_255 -- ;
F_71 ( V_5 , V_261 , V_254 , V_255 ) ;
}
...
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
F_71 ( V_5 , V_261 , V_262 , V_255 ) ;
if ( V_255 < V_5 -> V_130 . V_139 ) {
if ( V_2 -> V_247 ) {
V_2 -> V_247 -- ;
if ( V_5 -> V_263 <
V_2 -> V_5 . V_172 * V_2 -> V_5 . V_192 )
V_5 -> V_256 = V_257 ;
}
F_71 ( V_5 , V_258 , NULL , 0 ) ;
F_71 ( V_5 , V_259 , NULL , 0 ) ;
...
case V_10 :
case V_11 :
F_70 ( V_5 , V_262 , V_255 ) ;
break;
case V_36 :
case V_37 :
F_72 ( V_5 , V_262 , V_255 ) ;
break;
case V_38 :
F_73 ( V_5 , V_262 , V_255 ) ;
break;
case V_12 :
F_75 ( V_5 , V_262 , V_255 ) ;
break;
case V_13 :
F_77 ( V_5 , V_262 , V_255 ) ;
break;
}
}
...
{
struct V_5 * V_5 =
F_91 ( V_286 -> V_287 , struct V_5 , V_288 ) ;
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
V_5 -> V_8 = 0 ;
switch ( V_286 -> V_129 ) {
case V_289 :
V_5 -> V_290 -> V_55 = F_22 ( V_2 , 0x10 ) ;
break;
}
return 0 ;
}
...
F_78 ( V_5 , V_2 -> V_296 -> V_55 ) ;
break;
case V_297 :
F_81 ( V_5 , V_286 -> V_55 ) ;
break;
case V_298 :
F_59 ( V_5 , V_286 -> V_55 , V_2 -> V_233 -> V_55 ) ;
break;
case V_289 :
if ( V_286 -> V_295 )
F_46 ( V_5 , V_286 -> V_55 ) ;
if ( ! V_286 -> V_55 && V_5 -> V_290 -> V_295 )
F_80 ( V_5 , V_5 -> V_290 -> V_55 ) ;
break;
case V_299 :
return - V_300 ;
}
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
struct V_301 * V_302 = & V_5 -> V_288 ;
V_5 -> V_303 . V_288 = V_302 ;
F_94 ( V_302 , 10 ) ;
