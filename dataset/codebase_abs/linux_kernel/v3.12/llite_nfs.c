...
static int F_32 ( struct V_8 * V_8 , T_1 * V_42 , int * V_43 ,
struct V_8 * V_33 )
{
struct V_44 * V_45 = ( void * ) V_42 ;
F_10 ( V_24 , L_7 V_25 L_8 ,
V_8 -> V_46 , F_11 ( F_33 ( V_8 ) ) , * V_43 ,
...
static int F_34 ( void * V_50 , const char * V_1 , int V_51 ,
T_4 V_20 , T_5 V_52 , unsigned type )
{
struct V_53 * V_54 = F_35 ( V_1 , struct V_53 , V_55 ) ;
...
if ( ! V_63 || ! F_38 ( V_63 -> V_36 ) )
GOTO ( V_67 , V_23 = - V_68 ) ;
if ( ! V_63 -> V_69 )
GOTO ( V_67 , V_23 = - V_70 ) ;
F_39 ( & V_63 -> V_71 ) ;
V_23 = F_40 ( V_63 , & V_57 . V_65 ) ;
F_41 ( & V_63 -> V_71 ) ;
if ( ! V_23 && ! V_57 . V_61 )
V_23 = - V_72 ;
V_67:
...
static struct V_32 * F_43 ( struct V_12 * V_13 , struct V_14 * V_14 ,
int V_73 , int V_74 )
{
struct V_44 * V_45 = (struct V_44 * ) V_14 ;
if ( V_74 != V_49 )
...
static struct V_32 * F_44 ( struct V_32 * V_76 )
{
struct V_17 * V_18 = NULL ;
...
int V_23 ;
int V_80 ;
F_45 ( V_63 && F_38 ( V_63 -> V_36 ) ) ;
V_16 = F_7 ( V_63 -> V_81 ) ;
F_10 ( V_24 , L_10 V_25 L_2 ,
V_63 -> V_46 , F_11 ( F_33 ( V_63 ) ) ) ;
V_23 = F_13 ( V_16 , & V_80 ) ;
if ( V_23 != 0 )
return F_14 ( V_23 ) ;
V_22 = F_46 ( NULL , V_63 , NULL , V_79 ,
strlen ( V_79 ) , V_80 ,
V_82 , NULL ) ;
if ( F_23 ( V_22 ) )
return ( void * ) V_22 ;
V_23 = F_47 ( V_16 -> V_31 , V_22 , & V_18 ) ;
F_48 ( V_22 ) ;
if ( V_23 ) {
F_18 ( L_11 , V_23 , V_63 -> V_46 ) ;
return F_14 ( V_23 ) ;
}
V_78 = F_49 ( & V_18 -> V_83 , & V_84 ) ;
F_45 ( V_78 -> V_85 & V_86 ) ;
F_10 ( V_24 , L_12 V_25 L_13 V_25 L_6 ,
F_11 ( F_33 ( V_63 ) ) , F_11 ( & V_78 -> V_87 ) ) ;
