...
unsigned long V_153 ;
F_97 ( V_10 , V_148 ) ;
F_98 ( V_10 , V_148 , V_162 ) ;
V_153 = F_99 ( V_164 ) ;
F_95 ( V_170 , & V_12 -> V_156 ,
V_153 ) ;
F_93 ( V_12 , V_148 , V_171 , NULL , V_39 ) ;
}
...
if ( F_22 ( ! V_8 -> V_66 ) )
return;
F_92 ( & V_148 , V_8 -> V_66 , V_167 ) ;
switch ( V_173 ) {
case V_175 :
V_153 = V_8 -> V_176 +
F_99 ( V_177 ) ;
F_22 ( ! F_91 ( V_165 , V_153 ) ) ;
F_98 ( V_10 , & V_148 , V_178 ) ;
break;
case V_179 :
break;
default:
...
V_8 -> V_174 = false ;
F_93 ( V_12 , & V_148 , V_173 , V_24 , V_39 ) ;
}
