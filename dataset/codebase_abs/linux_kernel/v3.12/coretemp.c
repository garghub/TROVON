...
static int F_18 ( struct V_31 * V_32 , T_2 V_33 , struct V_1 * V_2 )
{
int V_36 ;
T_2 V_18 , V_19 ;
T_2 V_49 ;
...
V_36 = F_23 ( V_2 , & V_12 -> V_64 [ V_37 ] . V_65 ) ;
if ( V_36 )
goto V_66;
}
return 0 ;
V_66:
while ( -- V_37 >= 0 )
F_25 ( V_2 , & V_12 -> V_64 [ V_37 ] . V_65 ) ;
return V_36 ;
}
static int F_26 ( unsigned int V_20 )
{
struct V_31 * V_32 = & F_27 ( V_20 ) ;
...
static struct V_69 * F_29 ( unsigned int V_20 )
{
T_4 V_16 = F_30 ( V_20 ) ;
struct V_70 * V_71 ;
F_10 ( & V_72 ) ;
F_31 (p, &pdev_list, list)
if ( V_71 -> V_16 == V_16 ) {
F_12 ( & V_72 ) ;
return V_71 -> V_73 ;
}
...
static struct V_11 * F_32 ( unsigned int V_20 , int V_74 )
{
struct V_11 * V_12 ;
V_12 = F_33 ( sizeof( struct V_11 ) , V_75 ) ;
if ( ! V_12 )
return NULL ;
V_12 -> V_21 = V_74 ? V_76 :
V_77 ;
...
static int F_36 ( struct V_69 * V_73 , unsigned int V_20 ,
int V_74 )
{
struct V_11 * V_12 ;
struct V_9 * V_10 = F_37 ( V_73 ) ;
struct V_31 * V_32 = & F_27 ( V_20 ) ;
T_2 V_18 , V_19 ;
int V_36 , V_57 ;
V_57 = V_74 ? 1 : F_38 ( V_20 ) ;
if ( V_57 > V_79 - 1 )
return - V_80 ;
...
if ( V_36 )
goto V_66;
V_12 -> V_22 = F_18 ( V_32 , V_20 , & V_73 -> V_2 ) ;
...
static void F_40 ( unsigned int V_20 , int V_74 )
{
struct V_69 * V_73 = F_29 ( V_20 ) ;
int V_36 ;
if ( ! V_73 )
return;
V_36 = F_36 ( V_73 , V_20 , V_74 ) ;
if ( V_36 )
F_41 ( & V_73 -> V_2 , L_20 , V_20 ) ;
}
...
static int F_43 ( struct V_69 * V_73 )
{
struct V_9 * V_10 ;
int V_36 ;
V_10 = F_33 ( sizeof( struct V_9 ) , V_75 ) ;
if ( ! V_10 )
return - V_81 ;
V_36 = F_21 ( V_10 , & V_73 -> V_2 ) ;
if ( V_36 )
goto V_66;
V_10 -> V_16 = V_73 -> V_33 ;
F_44 ( V_73 , V_10 ) ;
V_10 -> V_83 = F_45 ( & V_73 -> V_2 ) ;
if ( F_46 ( V_10 -> V_83 ) ) {
V_36 = F_47 ( V_10 -> V_83 ) ;
F_41 ( & V_73 -> V_2 , L_21 , V_36 ) ;
goto V_84;
}
return 0 ;
V_84:
F_25 ( & V_73 -> V_2 , & V_10 -> V_52 ) ;
V_66:
F_39 ( V_10 ) ;
return V_36 ;
}
static int F_48 ( struct V_69 * V_73 )
{
struct V_9 * V_10 = F_37 ( V_73 ) ;
int V_37 ;
for ( V_37 = V_79 - 1 ; V_37 >= 0 ; -- V_37 )
if ( V_10 -> V_13 [ V_37 ] )
F_42 ( V_10 , & V_73 -> V_2 , V_37 ) ;
F_25 ( & V_73 -> V_2 , & V_10 -> V_52 ) ;
F_49 ( V_10 -> V_83 ) ;
F_39 ( V_10 ) ;
return 0 ;
}
static int F_50 ( unsigned int V_20 )
{
int V_36 ;
struct V_69 * V_73 ;
struct V_70 * V_70 ;
F_10 ( & V_72 ) ;
V_73 = F_51 ( V_6 , F_30 ( V_20 ) ) ;
if ( ! V_73 ) {
V_36 = - V_81 ;
F_28 ( L_22 ) ;
goto exit;
}
V_70 = F_33 ( sizeof( struct V_70 ) , V_75 ) ;
if ( ! V_70 ) {
V_36 = - V_81 ;
goto V_85;
}
...
static void F_55 ( unsigned int V_20 )
{
struct V_70 * V_71 , * V_89 ;
T_4 V_16 = F_30 ( V_20 ) ;
F_10 ( & V_72 ) ;
F_56 (p, n, &pdev_list, list) {
if ( V_71 -> V_16 != V_16 )
continue;
F_57 ( V_71 -> V_73 ) ;
F_58 ( & V_71 -> V_87 ) ;
...
static bool F_59 ( struct V_9 * V_10 )
{
int V_37 ;
for ( V_37 = V_79 - 1 ; V_37 >= 0 ; -- V_37 ) {
if ( V_10 -> V_13 [ V_37 ] &&
...
static void F_60 ( unsigned int V_20 )
{
struct V_31 * V_32 = & F_27 ( V_20 ) ;
struct V_69 * V_73 = F_29 ( V_20 ) ;
int V_36 ;
