...
unsigned int F_52 ( struct V_12 * V_13 ,
enum V_14 V_15 ,
unsigned int V_103 ,
struct V_7 * V_8 )
{
...
static int F_54 ( struct V_12 * V_72 , void * V_109 )
{
...
( V_111 -> V_50 && F_55 ( V_72 ) != V_111 -> V_50 ) )
return 0 ;
return V_72 -> V_96 & V_105 ? 1 : 0 ;
}
static void F_56 ( T_1 V_11 , T_1 V_50 )
{
struct V_110 V_111 = {
. V_11 = V_11 ,
. V_50 = V_50 ,
...
F_57 () ;
F_58 (net)
F_59 ( V_40 , F_54 , & V_111 , 0 , 0 ) ;
F_60 () ;
}
static void F_61 ( T_1 V_11 )
{
struct V_110 V_111 = {
. V_11 = V_11 ,
} ;
...
int F_62 ( T_1 V_11 , const struct V_4 * V_50 )
{
...
F_63 ( & V_114 ) ;
if ( V_6 [ V_11 ] == NULL ) {
V_112 = F_64 ( V_115 * sizeof( struct V_4 * ) ,
V_116 ) ;
if ( V_112 == NULL ) {
V_113 = - V_39 ;
goto V_24;
...
F_65 ( V_6 [ V_11 ] [ V_50 -> V_50 ] , V_50 ) ;
V_24:
F_69 ( & V_114 ) ;
return V_113 ;
}
void F_70 ( T_1 V_11 , const struct V_4 * V_50 )
{
F_63 ( & V_114 ) ;
F_65 ( V_6 [ V_11 ] [ V_50 -> V_50 ] ,
& V_117 ) ;
F_69 ( & V_114 ) ;
F_71 () ;
F_56 ( V_11 , V_50 -> V_50 ) ;
}
int F_72 ( const struct V_1 * V_11 )
{
int V_31 ;
V_31 = F_73 ( V_11 -> V_11 ) ;
if ( V_31 < 0 )
return V_31 ;
F_63 ( & V_114 ) ;
F_65 ( V_6 [ V_11 -> V_11 ] [ V_119 ] ,
& V_120 ) ;
F_65 ( V_6 [ V_11 -> V_11 ] [ V_121 ] ,
& V_122 ) ;
F_69 ( & V_114 ) ;
F_65 ( V_3 [ V_11 -> V_11 ] , V_11 ) ;
return 0 ;
}
void F_74 ( const struct V_1 * V_11 )
{
F_63 ( & V_114 ) ;
F_65 ( V_3 [ V_11 -> V_11 ] , NULL ) ;
F_69 ( & V_114 ) ;
F_71 () ;
F_61 ( V_11 -> V_11 ) ;
F_75 ( V_11 -> V_11 ) ;
...
{
struct V_65 * V_66 = F_77 ( V_13 , V_93 ) ;
...
static void F_79 ( void * V_123 , void * V_124 )
{
...
return;
F_49 ( & V_98 ) ;
F_80 ( & V_126 -> V_99 , & V_125 -> V_99 ) ;
F_51 ( & V_98 ) ;
}
static int F_81 ( struct V_127 * V_128 ,
const struct V_12 * V_13 ,
struct V_51 * V_52 )
{
...
const struct V_4 * V_50 ;
int V_31 ;
V_31 = F_82 ( V_129 , V_130 , V_128 , V_131 ) ;
if ( V_31 < 0 )
return V_31 ;
V_50 = F_3 ( F_33 ( V_13 ) , F_55 ( V_13 ) ) ;
if ( V_50 -> V_132 )
V_31 = V_50 -> V_132 ( V_129 , V_52 ) ;
return V_31 ;
}
static int
F_83 ( const struct V_127 * V_66 ,
...
V_31 = F_82 ( V_129 , V_133 , V_66 , V_134 ) ;
if ( V_31 < 0 )
return V_31 ;
F_6 () ;
V_11 = F_1 ( F_33 ( V_13 ) ) ;
...
if ( ! V_129 [ V_136 ] )
goto V_24;
V_31 = F_81 ( V_129 [ V_136 ] , V_13 , V_52 ) ;
V_24:
F_8 () ;
return V_31 ;
}
static int
F_84 ( struct V_12 * V_13 ,
enum V_68 V_137 ,
const struct V_127 * V_128 )
{
struct V_51 V_52 ;
int V_31 ;
V_31 = F_83 ( V_128 , V_13 , & V_52 ) ;
if ( V_31 < 0 )
return V_31 ;
if ( F_44 ( V_13 , V_137 ) )
return - V_138 ;
...
static int T_3 F_85 ( struct V_40 * V_40 )
{
V_40 -> V_13 . V_47 = V_40 -> V_13 . V_140 ;
V_40 -> V_13 . V_100 = F_86 ( & V_40 -> V_13 . V_47 , 0 ) ;
if ( ! V_40 -> V_13 . V_100 )
return - V_39 ;
return 0 ;
}
static void T_4 F_87 ( struct V_40 * V_40 )
{
struct V_110 V_111 = {} ;
F_59 ( V_40 , & F_54 , & V_111 , 0 , 0 ) ;
F_71 () ;
F_88 ( V_40 -> V_13 . V_100 , V_40 -> V_13 . V_47 ) ;
}
