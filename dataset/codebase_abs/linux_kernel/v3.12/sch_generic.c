...
goto V_80;
V_74 -> V_89 = V_87 ;
if ( ! V_72 -> V_90 || V_72 -> V_90 ( V_74 , NULL ) == 0 )
return V_74 ;
F_92 ( V_74 ) ;
V_80:
return NULL ;
}
void F_93 ( struct V_3 * V_46 )
{
...
static void F_94 ( struct V_92 * V_93 )
{
struct V_3 * V_46 = F_95 ( V_93 , struct V_3 , V_92 ) ;
...
#ifdef F_97
F_98 ( V_46 ) ;
F_99 ( F_100 ( V_46 -> V_95 ) ) ;
#endif
F_101 ( & V_46 -> V_96 , & V_46 -> V_97 ) ;
if ( V_72 -> V_91 )
V_72 -> V_91 ( V_46 ) ;
if ( V_72 -> V_98 )
V_72 -> V_98 ( V_46 ) ;
...
F_47 ( F_26 ( V_46 ) ) ;
F_11 ( V_46 -> V_5 ) ;
F_103 ( & V_46 -> V_92 , F_94 ) ;
}
struct V_3 * F_104 ( struct V_9 * V_11 ,
struct V_3 * V_46 )
{
...
V_22 = F_25 ( V_99 ) ;
F_105 ( V_22 ) ;
if ( V_99 && F_106 ( & V_99 -> V_86 ) <= 1 )
F_93 ( V_99 ) ;
if ( V_46 == NULL )
V_46 = & V_101 ;
V_11 -> V_100 = V_46 ;
F_107 ( V_11 -> V_46 , & V_101 ) ;
F_108 ( V_22 ) ;
return V_99 ;
}
...
struct V_3 * V_46 ;
V_10 = F_6 ( V_12 , 0 ) ;
if ( ! F_111 ( V_12 ) || V_12 -> V_52 == 0 ) {
F_113 ( V_12 , F_109 , NULL ) ;
V_12 -> V_46 = V_10 -> V_100 ;
F_114 ( & V_12 -> V_46 -> V_86 ) ;
} else {
...
int * V_110 = V_108 ;
if ( ! ( V_109 -> V_13 & V_94 ) )
F_116 ( V_111 , & V_109 -> V_43 ) ;
F_107 ( V_11 -> V_46 , V_109 ) ;
...
F_105 ( F_25 ( V_46 ) ) ;
if ( ! ( V_46 -> V_13 & V_94 ) )
F_120 ( V_111 , & V_46 -> V_43 ) ;
F_107 ( V_11 -> V_46 , V_114 ) ;
F_93 ( V_46 ) ;
F_108 ( F_25 ( V_46 ) ) ;
}
}
...
{
V_12 -> V_46 = & V_101 ;
F_113 ( V_12 , F_132 , & V_101 ) ;
if ( F_118 ( V_12 ) )
F_132 ( V_12 , F_118 ( V_12 ) , & V_101 ) ;
...
{
F_113 ( V_12 , F_135 , & V_101 ) ;
if ( F_118 ( V_12 ) )
F_135 ( V_12 , F_118 ( V_12 ) , & V_101 ) ;
F_92 ( V_12 -> V_46 ) ;
V_12 -> V_46 = & V_101 ;
F_137 ( F_138 ( & V_12 -> V_40 ) ) ;
}
void F_139 ( struct V_122 * V_123 ,
...
T_2 V_132 = V_133 ;
for (; ; ) {
V_123 -> V_131 = F_140 ( V_132 , V_123 -> V_127 ) ;
