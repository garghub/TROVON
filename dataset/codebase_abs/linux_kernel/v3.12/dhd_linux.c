...
void F_49 ( struct V_65 * V_66 , struct V_79 * V_80 )
{
...
T_5 V_3 ;
int V_40 ;
F_5 ( V_43 , L_36 , F_50 ( V_66 ) ,
F_43 ( V_80 ) ) ;
F_47 (skb_list, skb, pnext) {
F_51 ( V_39 , V_80 ) ;
V_40 = F_52 ( V_2 , true , & V_3 , V_39 ) ;
V_11 = V_2 -> V_5 [ V_3 ] ;
...
void F_53 ( struct V_1 * V_2 , struct V_38 * V_109 ,
bool V_110 )
{
struct V_10 * V_11 ;
struct V_41 * V_42 ;
...
T_6 type ;
int V_111 ;
V_111 = F_52 ( V_2 , false , & V_3 , V_109 ) ;
V_11 = V_2 -> V_5 [ V_3 ] ;
if ( ! V_11 )
goto V_48;
if ( V_111 == 0 ) {
...
void F_57 ( struct V_65 * V_66 , struct V_38 * V_109 , bool V_110 )
{
struct V_67 * V_44 = F_30 ( V_66 ) ;
struct V_1 * V_2 = V_44 -> V_2 ;
if ( F_58 ( V_2 -> V_118 ) ) {
if ( ! V_110 )
F_59 ( V_2 -> V_118 , V_109 ) ;
} else {
F_53 ( V_2 , V_109 , V_110 ) ;
}
}
static struct V_119 * F_60 ( struct V_12 * V_6 )
{
struct V_10 * V_11 = F_16 ( V_6 ) ;
F_5 ( V_23 , L_6 , V_11 -> V_24 ) ;
return & V_11 -> V_56 ;
}
static int F_61 ( struct V_10 * V_11 , T_1 V_120 )
{
T_3 V_21 ;
...
struct V_10 * V_11 = F_16 ( V_6 ) ;
struct V_1 * V_2 = V_11 -> V_2 ;
F_63 ( V_122 -> V_123 , V_124 , sizeof( V_122 -> V_123 ) ) ;
snprintf ( V_122 -> V_125 , sizeof( V_122 -> V_125 ) , L_41 ,
V_2 -> V_126 ) ;
F_63 ( V_122 -> V_127 , F_50 ( V_2 -> V_44 -> V_66 ) ,
sizeof( V_122 -> V_127 ) ) ;
}
static int F_64 ( struct V_10 * V_11 , void T_7 * V_128 )
{
struct V_1 * V_2 = V_11 -> V_2 ;
struct V_121 V_122 ;
...
int V_40 ;
F_5 ( V_23 , L_6 , V_11 -> V_24 ) ;
if ( F_65 ( & V_130 , V_128 , sizeof( T_1 ) ) )
return - V_135 ;
switch ( V_130 ) {
case V_136 :
if ( F_65 ( & V_122 , V_128 , sizeof( V_122 ) ) )
return - V_135 ;
...
if ( F_66 ( V_128 , & V_122 , sizeof( V_122 ) ) )
return - V_135 ;
F_5 ( V_23 , L_45 ,
...
if ( F_66 ( V_128 , & V_132 , sizeof( V_132 ) ) )
return - V_135 ;
break;
case V_142 :
case V_143 :
if ( F_65 ( & V_132 , V_128 , sizeof( V_132 ) ) )
return - V_135 ;
V_40 = F_67 ( V_11 , L_37 , & V_133 ) ;
if ( V_40 < 0 )
return V_40 ;
...
static int F_68 ( struct V_12 * V_6 , struct V_147 * V_148 ,
int V_130 )
{
struct V_10 * V_11 = F_16 ( V_6 ) ;
struct V_1 * V_2 = V_11 -> V_2 ;
...
int F_75 ( struct V_10 * V_11 , bool V_152 )
{
struct V_1 * V_2 = V_11 -> V_2 ;
struct V_12 * V_6 ;
T_3 V_21 ;
...
static int F_81 ( struct V_12 * V_6 ,
struct V_147 * V_148 , int V_130 )
{
F_5 ( V_23 , L_20 ) ;
return 0 ;
}
static T_4 F_82 ( struct V_38 * V_39 ,
struct V_12 * V_6 )
{
if ( V_39 )
F_83 ( V_39 ) ;
...
struct V_10 * F_85 ( struct V_1 * V_2 , T_3 V_24 , T_3 V_3 ,
char * V_7 , T_5 * V_33 )
{
struct V_10 * V_11 ;
struct V_12 * V_6 ;
...
F_5 ( V_51 , L_57 ) ;
V_6 = F_88 ( sizeof( * V_11 ) , V_7 , V_167 ) ;
if ( ! V_6 )
return F_87 ( - V_53 ) ;
V_11 = F_16 ( V_6 ) ;
V_11 -> V_6 = V_6 ;
...
void F_91 ( struct V_1 * V_2 , T_3 V_24 )
{
struct V_10 * V_11 ;
V_11 = V_2 -> V_5 [ V_24 ] ;
V_2 -> V_5 [ V_24 ] = NULL ;
...
int F_96 ( T_8 V_171 , struct V_65 * V_66 )
{
struct V_1 * V_2 = NULL ;
int V_40 = 0 ;
F_5 ( V_23 , L_20 ) ;
...
V_11 = F_85 ( V_2 , 0 , 0 , L_63 , NULL ) ;
if ( F_105 ( V_11 ) )
return F_106 ( V_11 ) ;
if ( V_165 )
V_174 = F_85 ( V_2 , 1 , 0 , L_64 , NULL ) ;
else
V_174 = NULL ;
if ( F_105 ( V_174 ) )
V_174 = NULL ;
...
{
return F_122 ( & V_11 -> V_115 ) ;
}
int F_123 ( struct V_12 * V_6 )
{
struct V_10 * V_11 = F_16 ( V_6 ) ;
int V_21 ;
V_21 = F_124 ( V_11 -> V_116 ,
! F_121 ( V_11 ) ,
F_125 ( V_178 ) ) ;
F_46 ( ! V_21 ) ;
return ! V_21 ;
