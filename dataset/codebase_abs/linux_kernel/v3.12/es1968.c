...
static T_5 F_107 ( int V_178 , void * V_179 )
{
...
static int F_139 ( struct V_1 * V_2 , int V_113 )
{
struct V_256 * V_257 ;
struct V_258 * V_259 ;
T_1 V_17 ;
...
static T_2 F_159 ( struct V_275 * V_276 )
{
struct V_1 * V_2 = V_276 -> V_18 ;
struct V_278 V_279 = * F_158 ( V_2 ) ;
...
static void F_160 ( struct V_275 * V_276 , bool V_289 )
{
struct V_1 * V_2 = V_276 -> V_18 ;
...
static int F_169 ( struct V_294 * V_149 )
{
struct V_1 * V_2 = V_149 -> V_295 ;
return F_161 ( V_2 ) ;
}
static int F_170 ( struct V_249 * V_150 ,
struct V_211 * V_111 ,
int V_115 ,
int V_296 ,
int V_297 ,
...
return V_112 ;
if ( F_171 ( V_111 , F_172 ( 28 ) ) < 0 ||
F_173 ( V_111 , F_172 ( 28 ) ) < 0 ) {
F_71 ( V_116 L_20 ) ;
F_130 ( V_111 ) ;
return - V_303 ;
}
...
V_2 -> V_151 = V_296 ;
V_2 -> V_152 = V_297 ;
if ( ( V_112 = F_177 ( V_111 , L_10 ) ) < 0 ) {
F_63 ( V_2 ) ;
F_130 ( V_111 ) ;
return V_112 ;
}
V_2 -> V_5 = F_178 ( V_111 , 0 ) ;
if ( F_179 ( V_111 -> V_178 , F_107 , V_304 ,
V_305 , V_2 ) ) {
...
for ( V_21 = 0 ; V_21 < ( int ) F_180 ( V_306 ) ; V_21 ++ ) {
...
V_2 -> V_250 = V_250 ;
F_118 ( V_2 ) ;
if ( ( V_112 = F_181 ( V_150 , V_307 , V_2 , & V_195 ) ) < 0 ) {
F_161 ( V_2 ) ;
return V_112 ;
}
F_182 ( V_150 , & V_111 -> V_113 ) ;
#ifdef F_164
if ( V_2 -> V_111 -> V_308 != 0x125d )
goto V_309;
V_112 = F_183 ( & V_111 -> V_113 , & V_2 -> V_293 ) ;
if ( V_112 < 0 ) {
F_161 ( V_2 ) ;
return V_112 ;
}
...
sprintf ( V_2 -> V_276 . V_311 , L_23 , F_145 ( V_111 ) ) ;
for ( V_21 = 0 ; V_21 < F_180 ( V_312 ) ; V_21 ++ ) {
V_2 -> V_313 = V_21 ;
if ( ! F_184 ( & V_2 -> V_276 , V_314 ) ) {
F_71 ( V_146 L_24 ,
F_158 ( V_2 ) -> V_159 ) ;
F_185 ( V_2 -> V_276 . V_150 , F_158 ( V_2 ) -> V_159 ,
...
static int F_186 ( struct V_211 * V_111 ,
...
V_112 = F_187 ( V_20 [ V_113 ] , V_173 [ V_113 ] , V_314 , 0 , & V_150 ) ;
if ( V_112 < 0 )
return V_112 ;
if ( V_115 [ V_113 ] < 128 )
V_115 [ V_113 ] = 128 ;
...
unsigned short V_205 ;
F_114 ( V_2 -> V_111 , V_206 , & V_205 ) ;
for ( V_21 = 0 ; V_21 < F_180 ( V_329 ) ; V_21 ++ ) {
...
static void F_192 ( struct V_211 * V_111 )
{
F_188 ( F_193 ( V_111 ) ) ;
}
