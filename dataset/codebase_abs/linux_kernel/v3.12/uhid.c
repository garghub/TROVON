...
sizeof( V_68 -> V_72 ) ) ;
V_12 -> V_48 . V_69 . V_24 = F_31 ( V_68 -> V_24 ) ;
...
if ( F_30 ( V_12 , V_64 , F_22 ( V_33 , sizeof( * V_12 ) ) ) )
return - V_65 ;
return 0 ;
}
static int F_26 ( const char T_4 * V_64 , T_3 V_33 ,
...
return - V_44 ;
V_2 -> V_24 = F_29 ( V_2 -> V_25 , V_14 ) ;
if ( ! V_2 -> V_24 )
return - V_15 ;
if ( F_30 ( V_2 -> V_24 , V_4 -> V_48 . V_69 . V_24 ,
V_2 -> V_25 ) ) {
V_31 = - V_65 ;
goto V_80;
}
