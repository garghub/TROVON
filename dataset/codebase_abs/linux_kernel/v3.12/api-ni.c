...
& V_220 -> V_224 , & V_220 -> V_230 ) ;
case V_231 :
return F_132 ( NULL , V_220 -> V_224 , V_220 -> V_230 ,
F_133 () -
F_97 ( F_134 () -
( V_232 ) V_220 -> V_233 [ 0 ] ) ) ;
case V_234 :
return 0 ;
case V_235 :
V_3 = F_135 ( V_220 -> V_224 , & V_220 -> V_224 , & V_220 -> V_236 [ 1 ] ) ;
if ( V_3 < 0 && V_3 != - V_237 )
return V_3 ;
V_220 -> V_236 [ 0 ] = V_3 ;
return 0 ;
case V_238 :
F_39 ( V_69 ) ;
V_6 . V_239 = V_220 -> V_230 ;
F_41 ( V_69 ) ;
return 0 ;
case V_240 :
V_221 . V_152 = V_220 -> V_224 ;
V_221 . V_241 = V_220 -> V_236 [ 0 ] ;
V_3 = F_136 ( V_221 , V_220 -> V_236 [ 1 ] ,
( T_10 * ) V_220 -> V_242 ,
V_220 -> V_243 / sizeof( T_10 ) ) ;
if ( V_3 < 0 )
return V_3 ;
V_220 -> V_223 = V_3 ;
return 0 ;
...
if ( V_149 -> V_161 -> V_245 == NULL ) {
F_33 ( V_174 , L_32 ,
F_138 ( V_221 ) ) ;
} else {
( void ) V_149 -> V_161 -> V_245 ( V_149 , V_217 , V_218 ) ;
}
F_139 ( V_149 ) ;
}
return 0 ;
...
V_3 = V_149 -> V_161 -> V_245 ( V_149 , V_217 , V_218 ) ;
F_139 ( V_149 ) ;
return V_3 ;
}
}
int
F_128 ( unsigned int V_247 , T_10 * V_221 )
{
struct V_157 * V_149 ;
struct V_12 * V_60 ;
int V_113 ;
...
void
F_140 ( char * V_249 , int V_250 , T_11 V_251 )
{
snprintf ( V_249 , V_250 , V_252 , V_251 . V_95 ) ;
}
static int
F_141 ( void )
{
...
V_254 -> V_256 = V_81 ;
V_254 -> V_257 = V_6 . V_132 ;
V_254 -> V_258 = V_259 ;
V_254 -> V_260 = V_261 ;
for ( V_11 = 0 ; V_11 < V_81 ; V_11 ++ ) {
T_13 * V_262 = & V_254 -> V_255 [ V_11 ] ;
V_3 = F_128 ( V_11 , & V_221 ) ;
F_11 ( V_3 == 0 ) ;
V_262 -> V_263 = V_221 . V_152 ;
V_262 -> V_264 = V_265 ;
F_39 ( 0 ) ;
V_149 = F_85 ( V_221 . V_152 , 0 ) ;
F_11 ( V_149 != NULL ) ;
F_142 ( V_149 ) ;
F_11 ( V_149 -> V_266 == NULL ) ;
V_149 -> V_266 = V_262 ;
F_143 ( V_149 ) ;
F_84 ( V_149 , 0 ) ;
F_41 ( 0 ) ;
...
V_253 = F_25 ( T_12 ,
V_255 [ V_6 . V_267 -> V_256 ] ) ;
V_268 . V_279 = V_6 . V_267 ;
V_268 . V_280 = V_253 ;
V_268 . V_281 = V_282 ;
V_268 . V_283 = 0 ;
V_268 . V_284 = V_285 | V_286 |
V_287 ;
V_268 . V_288 = NULL ;
V_268 . V_289 = V_6 . V_272 ;
V_3 = F_147 ( V_269 , V_268 ,
V_290 ,
& V_6 . V_291 ) ;
if ( V_3 != 0 ) {
F_13 ( L_36 , V_3 ) ;
...
F_151 ( V_6 . V_291 ) ;
for (; ; ) {
V_3 = F_152 ( & V_6 . V_272 , 1 ,
V_295 , & V_293 , & V_294 ) ;
F_11 ( V_3 >= 0 || V_3 == - V_297 ) ;
if ( V_3 == 0 ) {
F_153 ( L_37 ) ;
V_295 *= 2 ;
continue;
...
int
F_136 ( T_10 V_221 , int V_295 , T_10 * V_299 , int V_300 )
{
T_18 V_301 ;
T_19 V_302 ;
T_16 V_293 ;
...
int V_298 = 0 ;
int V_303 = 0 ;
const int V_304 = 60000 ;
int V_253 = F_25 ( T_12 , V_255 [ V_300 ] ) ;
T_12 * V_305 ;
T_10 V_306 ;
int V_11 ;
int V_307 ;
...
V_300 > 20 )
return - V_246 ;
if ( V_221 . V_241 == V_210 )
V_221 . V_241 = V_308 ;
F_12 ( V_305 , V_253 ) ;
if ( V_305 == NULL )
return - V_17 ;
V_3 = F_145 ( 2 , V_271 , & V_301 ) ;
if ( V_3 != 0 ) {
F_13 ( L_38 , V_3 ) ;
goto V_309;
}
...
V_268 . V_288 = NULL ;
V_268 . V_289 = V_301 ;
V_3 = F_155 ( V_268 , V_276 , & V_302 ) ;
if ( V_3 != 0 ) {
F_13 ( L_39 , V_3 ) ;
goto V_310;
}
V_3 = F_156 ( V_147 , V_302 , V_221 ,
V_274 ,
V_275 , 0 ) ;
if ( V_3 != 0 ) {
V_270 = F_151 ( V_302 ) ;
...
if ( V_298 )
V_296 = F_150 () ;
V_270 = F_152 ( & V_301 , 1 , V_295 , & V_293 , & V_294 ) ;
if ( V_298 )
F_154 ( V_296 ) ;
F_33 ( V_66 , L_40 , V_270 ,
( V_270 <= 0 ) ? - 1 : V_293 . type ,
( V_270 <= 0 ) ? - 1 : V_293 . V_311 ,
( V_270 > 0 && V_293 . V_298 ) ? L_41 : L_23 ) ;
F_11 ( V_270 != - V_297 ) ;
if ( V_270 <= 0 || V_293 . V_311 != 0 ) {
if ( ! V_303 && V_3 == 0 )
V_3 = ( V_270 < 0 ) ? V_270 :
( V_270 == 0 ) ? - V_312 :
V_293 . V_311 ;
...
} else if ( V_293 . type == V_313 ) {
V_303 = 1 ;
V_3 = V_293 . V_46 ;
}
} while ( V_270 <= 0 || ! V_293 . V_298 );
if ( ! V_303 ) {
if ( V_3 >= 0 )
F_153 ( L_43 ,
F_138 ( V_221 ) ) ;
...
if ( V_305 -> V_258 == F_157 ( V_259 ) ) {
F_158 ( V_305 ) ;
} else if ( V_305 -> V_258 != V_259 ) {
F_13 ( L_45 ,
F_138 ( V_221 ) , V_305 -> V_258 ) ;
goto V_310;
}
if ( ( V_305 -> V_260 & V_261 ) == 0 ) {
F_13 ( L_46 ,
F_138 ( V_221 ) , V_305 -> V_260 ) ;
goto V_310;
}
if ( V_307 < F_25 ( T_12 , V_255 [ 0 ] ) ) {
F_13 ( L_47 , F_138 ( V_221 ) ,
V_307 , ( int ) F_25 ( T_12 , V_255 [ 0 ] ) ) ;
goto V_310;
}
if ( V_305 -> V_256 < V_300 )
V_300 = V_305 -> V_256 ;
if ( V_307 < F_25 ( T_12 , V_255 [ V_300 ] ) ) {
F_13 ( L_48 , F_138 ( V_221 ) ,
V_307 , ( int ) F_25 ( T_12 , V_255 [ V_300 ] ) ) ;
goto V_310;
}
V_3 = - V_316 ;
for ( V_11 = 0 ; V_11 < V_300 ; V_11 ++ ) {
V_306 . V_241 = V_305 -> V_257 ;
V_306 . V_152 = V_305 -> V_255 [ V_11 ] . V_263 ;
if ( F_159 ( & V_299 [ V_11 ] , & V_306 , sizeof( V_306 ) ) )
goto V_310;
}
V_3 = V_305 -> V_256 ;
V_310:
