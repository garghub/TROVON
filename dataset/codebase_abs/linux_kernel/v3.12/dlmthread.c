...
V_49 = F_30 ( V_2 -> V_13 . V_44 , struct V_47 , V_53 ) ;
if ( V_49 -> V_54 . V_55 == V_56 ) {
F_16 ( V_38 , L_9 ,
V_23 -> V_25 , V_2 -> V_26 . V_27 , V_2 -> V_26 . V_25 ) ;
F_25 () ;
}
...
if ( V_48 == V_49 )
continue;
if ( ! F_38 ( V_48 -> V_54 . type ,
V_49 -> V_54 . V_55 ) ) {
V_50 = 0 ;
if ( V_48 -> V_54 . V_57 == V_56 ) {
F_39 ( V_2 ) ;
F_40 ( V_23 , V_48 ) ;
}
if ( V_48 -> V_54 . V_57 < V_49 -> V_54 . V_55 )
V_48 -> V_54 . V_57 =
V_49 -> V_54 . V_55 ;
}
}
...
if ( V_50 ) {
F_8 ( & V_49 -> V_6 ) ;
F_36 ( V_49 -> V_54 . V_57 != V_56 ) ;
F_16 ( 0 , L_10
L_11 , V_23 -> V_25 , V_2 -> V_26 . V_27 ,
V_2 -> V_26 . V_25 ,
F_41 ( F_42 ( V_49 -> V_54 . V_58 ) ) ,
F_43 ( F_42 ( V_49 -> V_54 . V_58 ) ) ,
V_49 -> V_54 . type ,
V_49 -> V_54 . V_55 , V_49 -> V_54 . V_59 ) ;
V_49 -> V_54 . type = V_49 -> V_54 . V_55 ;
V_49 -> V_54 . V_55 = V_56 ;
F_33 ( & V_49 -> V_53 , & V_2 -> V_12 ) ;
F_36 ( ! V_49 -> V_60 ) ;
V_49 -> V_60 -> V_61 = V_62 ;
F_6 ( & V_49 -> V_6 ) ;
F_39 ( V_2 ) ;
...
if ( F_12 ( & V_2 -> V_14 ) )
goto V_63;
V_49 = F_30 ( V_2 -> V_14 . V_44 , struct V_47 , V_53 ) ;
F_37 (lock, &res->granted, list) {
if ( V_48 == V_49 )
continue;
if ( ! F_38 ( V_48 -> V_54 . type , V_49 -> V_54 . type ) ) {
V_50 = 0 ;
if ( V_48 -> V_54 . V_57 == V_56 ) {
F_39 ( V_2 ) ;
F_40 ( V_23 , V_48 ) ;
}
if ( V_48 -> V_54 . V_57 < V_49 -> V_54 . type )
V_48 -> V_54 . V_57 = V_49 -> V_54 . type ;
}
}
F_37 (lock, &res->converting, list) {
if ( V_48 == V_49 )
...
T_1 V_72 ;
F_8 ( & V_23 -> V_51 ) ;
while ( ! F_12 ( & V_23 -> V_73 ) ) {
V_48 = F_30 ( V_23 -> V_73 . V_44 ,
struct V_47 , V_74 ) ;
F_56 ( V_48 ) ;
V_2 = V_48 -> V_43 ;
F_16 ( 0 , L_18
L_13 , V_23 -> V_25 , V_2 -> V_26 . V_27 ,
V_2 -> V_26 . V_25 ,
F_41 ( F_42 ( V_48 -> V_54 . V_58 ) ) ,
F_43 ( F_42 ( V_48 -> V_54 . V_58 ) ) ,
V_48 -> V_54 . type , V_48 -> V_54 . V_59 ) ;
F_36 ( ! V_48 -> V_75 ) ;
F_19 ( & V_48 -> V_74 ) ;
F_57 ( V_48 ) ;
F_6 ( & V_23 -> V_51 ) ;
if ( V_48 -> V_54 . V_59 != V_23 -> V_35 ) {
...
V_48 = F_30 ( V_23 -> V_76 . V_44 ,
struct V_47 , V_77 ) ;
F_56 ( V_48 ) ;
V_2 = V_48 -> V_43 ;
F_36 ( ! V_48 -> V_78 ) ;
F_8 ( & V_48 -> V_6 ) ;
F_36 ( V_48 -> V_54 . V_57 <= V_56 ) ;
V_72 = V_48 -> V_54 . V_57 ;
V_48 -> V_54 . V_57 = V_56 ;
F_6 ( & V_48 -> V_6 ) ;
F_19 ( & V_48 -> V_77 ) ;
...
V_72 , V_48 -> V_54 . V_59 ) ;
if ( V_48 -> V_54 . V_59 != V_23 -> V_35 ) {
V_33 = F_61 ( V_23 , V_2 , V_48 , V_72 ) ;
if ( V_33 < 0 )
F_50 ( V_33 ) ;
} else
F_62 ( V_23 , V_2 , V_48 , V_72 ) ;
F_8 ( & V_23 -> V_51 ) ;
if ( ! F_12 ( & V_48 -> V_77 ) ) {
F_16 ( 0 , L_23
L_20 , V_23 -> V_25 , V_2 -> V_26 . V_27 ,
...
static int V_68 ( void * V_80 )
{
struct V_1 * V_2 ;
struct V_22 * V_23 = V_80 ;
unsigned long V_81 = F_31 ( V_82 ) ;
F_16 ( 0 , L_24 , V_23 -> V_25 ) ;
while ( ! F_63 () ) {
int V_83 = V_84 ;
F_29 ( V_23 , F_64 ( V_23 ) ) ;
F_8 ( & V_23 -> V_6 ) ;
while ( ! F_12 ( & V_23 -> V_66 ) ) {
int V_85 = 0 ;
V_2 = F_30 ( V_23 -> V_66 . V_44 ,
struct V_1 , V_17 ) ;
F_36 ( ! V_2 ) ;
F_17 ( V_2 ) ;
F_8 ( & V_2 -> V_6 ) ;
