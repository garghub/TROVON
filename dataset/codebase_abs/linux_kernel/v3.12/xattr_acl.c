...
F_12 ( V_6 -> V_14 ) ;
if ( error == 0 ) {
error = F_13 ( & V_12 , V_6 , type , V_9 ) ;
F_10 ( V_6 -> V_14 ) ;
V_10 = F_14 ( & V_12 , V_6 -> V_14 , V_13 ) ;
F_12 ( V_6 -> V_14 ) ;
if ( V_10 )
error = V_10 ;
}
...
static int
F_13 ( struct V_11 * V_12 , struct V_6 * V_6 ,
...
if ( ! error ) {
int V_10 ;
error = F_13 ( & V_12 , V_6 , V_53 , V_9 ) ;
F_10 ( V_6 -> V_14 ) ;
V_10 = F_14 ( & V_12 , V_6 -> V_14 , V_4 * 2 ) ;
F_12 ( V_6 -> V_14 ) ;
if ( V_10 )
error = V_10 ;
}
...
static T_1 F_54 ( struct V_1 * V_1 , char * V_71 ,
T_1 V_72 , const char * V_2 ,
T_1 V_73 , int type )
{
...
return 0 ;
if ( V_71 && V_4 <= V_72 )
memcpy ( V_71 , V_54 , V_4 ) ;
return V_4 ;
}
static T_1 F_55 ( struct V_1 * V_1 , char * V_71 ,
T_1 V_72 , const char * V_2 ,
T_1 V_73 , int type )
{
