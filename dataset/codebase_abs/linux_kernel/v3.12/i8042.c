...
static int T_2 F_70 ( int V_117 )
{
struct V_4 * V_4 ;
int V_50 = V_117 < 0 ? V_36 : V_60 + V_117 ;
...
F_69 ( V_4 -> V_115 , V_118 , sizeof( V_4 -> V_115 ) ) ;
V_4 -> V_112 = F_23 ;
} else {
snprintf ( V_4 -> V_114 , sizeof( V_4 -> V_114 ) , L_49 , V_117 ) ;
snprintf ( V_4 -> V_115 , sizeof( V_4 -> V_115 ) , V_119 , V_117 + 1 ) ;
}
V_11 -> V_4 = V_4 ;
V_11 -> V_29 = V_117 ;
V_11 -> V_47 = V_44 ;
...
if ( V_134 )
goto V_135;
V_133 = F_89 ( & V_136 , F_84 , NULL , 0 , NULL , 0 ) ;
if ( F_90 ( V_133 ) ) {
V_134 = F_91 ( V_133 ) ;
goto V_135;
}
