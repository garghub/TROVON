...
{
struct V_1 * V_2 = F_60 ( V_118 , struct V_1 , V_17 ) ;
if ( ! F_9 ( V_2 -> V_119 ) )
F_61 ( V_2 -> V_119 ) ;
F_19 ( V_2 -> V_120 ) ;
}
...
static int F_64 ( struct V_117 * V_118 , int V_122 )
{
struct V_1 * V_2 = F_60 ( V_118 , struct V_1 , V_17 ) ;
if ( V_122 )
return F_63 ( V_2 ) ;
...
int V_129 ;
int V_123 ;
V_2 -> V_120 = F_8 ( V_2 -> V_17 . V_18 , L_14 ) ;
if ( F_9 ( V_2 -> V_120 ) ) {
F_10 ( L_15 ) ;
return F_11 ( V_2 -> V_120 ) ;
}
V_123 = F_13 ( V_2 -> V_120 ) ;
if ( V_123 )
return V_123 ;
V_128 = F_69 ( F_70 ( V_2 -> V_120 ) ) ;
...
void F_74 ( struct V_117 * V_118 )
{
struct V_1 * V_2 = F_60 ( V_118 , struct V_1 , V_17 ) ;
if ( ! V_2 -> V_121 )
F_45 ( V_2 ) ;
}
void F_75 ( struct V_117 * V_118 ,
enum V_98 V_99 )
{
struct V_1 * V_2 = F_60 ( V_118 , struct V_1 , V_17 ) ;
if ( ! V_2 -> V_121 )
...
V_138 -> V_23 = F_83 ( & V_133 -> V_18 ,
sizeof( * V_138 -> V_23 ) , V_144 ) ;
if ( ! V_138 -> V_23 ) {
F_51 ( & V_133 -> V_18 ,
L_21 ) ;
return - V_125 ;
...
V_138 -> V_119 = F_92 ( & V_133 -> V_18 , L_44 ) ;
if ( F_9 ( V_138 -> V_119 ) )
return F_11 ( V_138 -> V_119 ) ;
} else {
F_93 ( & V_133 -> V_18 , L_45 ) ;
V_138 -> V_119 = F_94 ( - V_152 ) ;
}
V_138 -> V_17 . V_18 = & V_133 -> V_18 ;
V_123 = F_68 ( V_138 ) ;
if ( V_123 < 0 )
return V_123 ;
V_138 -> V_17 . V_157 = F_59 ;
V_138 -> V_17 . V_158 = F_64 ;
F_95 ( V_133 , V_138 ) ;
