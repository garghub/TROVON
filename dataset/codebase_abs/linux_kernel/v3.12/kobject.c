...
static void F_54 ( struct V_20 * V_20 )
{
struct V_1 * V_2 = F_52 ( V_20 , struct V_1 , V_20 ) ;
#ifdef F_55
F_56 ( L_27 ,
F_8 ( V_2 ) , V_2 , V_13 , V_2 -> V_10 ) ;
F_57 ( & V_2 -> V_48 , F_51 ) ;
...
struct V_1 * F_62 ( const char * V_26 , struct V_1 * V_10 )
{
struct V_1 * V_2 ;
int V_35 ;
V_2 = F_61 () ;
...
void F_63 ( struct V_16 * V_55 )
{
F_21 ( & V_55 -> V_2 ) ;
F_23 ( & V_55 -> V_19 ) ;
F_64 ( & V_55 -> V_17 ) ;
}
static T_4 F_65 ( struct V_1 * V_2 , struct V_5 * V_6 ,
char * V_56 )
{
struct V_57 * V_58 ;
T_4 V_59 = - V_60 ;
V_58 = F_52 ( V_6 , struct V_57 , V_6 ) ;
if ( V_58 -> V_61 )
V_59 = V_58 -> V_61 ( V_2 , V_58 , V_56 ) ;
return V_59 ;
}
static T_4 F_66 ( struct V_1 * V_2 , struct V_5 * V_6 ,
const char * V_56 , T_5 V_62 )
{
struct V_57 * V_58 ;
T_4 V_59 = - V_60 ;
V_58 = F_52 ( V_6 , struct V_57 , V_6 ) ;
if ( V_58 -> V_63 )
V_59 = V_58 -> V_63 ( V_2 , V_58 , V_56 , V_62 ) ;
return V_59 ;
}
int F_67 ( struct V_16 * V_55 )
{
int V_64 ;
if ( ! V_55 )
return - V_27 ;
...
void F_68 ( struct V_16 * V_55 )
{
if ( ! V_55 )
return;
F_27 ( & V_55 -> V_2 ) ;
}
struct V_1 * F_69 ( struct V_16 * V_16 , const char * V_26 )
{
struct V_1 * V_55 ;
struct V_1 * V_59 = NULL ;
F_15 ( & V_16 -> V_17 ) ;
F_70 (k, &kset->list, entry) {
if ( F_8 ( V_55 ) && ! strcmp ( F_8 ( V_55 ) , V_26 ) ) {
V_59 = F_47 ( V_55 ) ;
break;
}
}
...
static struct V_16 * F_72 ( const char * V_26 ,
...
struct V_16 * F_73 ( const char * V_26 ,
const struct V_66 * V_67 ,
struct V_1 * V_68 )
{
struct V_16 * V_16 ;
int error ;
V_16 = F_72 ( V_26 , V_67 , V_68 ) ;
if ( ! V_16 )
return NULL ;
error = F_67 ( V_16 ) ;
if ( error ) {
...
int F_74 ( const struct V_70 * V_71 )
{
enum V_72 type = V_71 -> type ;
int error ;
F_15 ( & V_73 ) ;
error = - V_27 ;
if ( type >= V_74 )
...
const struct V_70 * F_76 ( struct V_1 * V_10 )
{
const struct V_70 * V_71 = NULL ;
if ( V_10 && V_10 -> V_36 -> V_79 )
V_71 = V_10 -> V_36 -> V_79 ( V_10 ) ;
return V_71 ;
}
const struct V_70 * F_77 ( struct V_1 * V_2 )
{
return F_76 ( V_2 -> V_10 ) ;
}
bool F_78 ( enum V_72 type )
{
bool V_80 = true ;
F_15 ( & V_73 ) ;
if ( ( type > V_75 ) && ( type < V_74 ) &&
...
const void * F_82 ( enum V_72 type , struct V_82 * V_83 )
{
const void * V_81 = NULL ;
F_15 ( & V_73 ) ;
if ( ( type > V_75 ) && ( type < V_74 ) &&
V_77 [ type ] )
V_81 = V_77 [ type ] -> F_83 ( V_83 ) ;
F_17 ( & V_73 ) ;
return V_81 ;
}
const void * F_84 ( enum V_72 type )
{
const void * V_81 = NULL ;
F_15 ( & V_73 ) ;
if ( ( type > V_75 ) && ( type < V_74 ) &&
...
void F_86 ( enum V_72 type , void * V_81 )
{
F_15 ( & V_73 ) ;
if ( ( type > V_75 ) && ( type < V_74 ) &&
V_77 [ type ] && V_77 [ type ] -> V_84 )
V_77 [ type ] -> V_84 ( V_81 ) ;
F_17 ( & V_73 ) ;
}
