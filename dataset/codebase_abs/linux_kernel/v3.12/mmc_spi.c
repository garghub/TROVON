...
static T_5
F_53 ( int V_144 , void * V_84 )
{
struct V_1 * V_2 = F_40 ( V_84 ) ;
T_4 V_145 = F_54 ( V_2 -> V_136 -> V_146 , ( T_4 ) 100 ) ;
F_55 ( V_84 , F_56 ( V_145 ) ) ;
return V_147 ;
}
static int F_57 ( struct V_82 * V_3 )
{
void * V_77 ;
struct V_117 * V_84 ;
struct V_1 * V_2 ;
...
V_5 = - V_153 ;
V_77 = F_58 ( V_154 , V_155 ) ;
if ( ! V_77 )
goto V_156;
memset ( V_77 , 0xff , V_154 ) ;
V_84 = F_59 ( sizeof( * V_2 ) , & V_3 -> V_48 ) ;
if ( ! V_84 )
goto V_156;
V_84 -> V_157 = & V_158 ;
V_84 -> V_159 = V_154 ;
...
F_61 ( & V_3 -> V_48 , V_84 ) ;
V_2 -> V_6 = F_58 ( sizeof( * V_2 -> V_6 ) , V_155 ) ;
if ( ! V_2 -> V_6 )
goto V_172;
if ( V_3 -> V_121 -> V_48 . V_173 -> V_174 ) {
struct V_94 * V_48 = V_3 -> V_121 -> V_48 . V_173 ;
V_2 -> V_8 = V_48 ;
V_2 -> V_78 = F_62 ( V_48 , V_77 ,
V_154 , V_72 ) ;
V_2 -> V_9 = F_62 ( V_48 , V_2 -> V_6 ,
sizeof( * V_2 -> V_6 ) , V_67 ) ;
F_7 ( V_2 -> V_8 ,
V_2 -> V_9 , sizeof( * V_2 -> V_6 ) ,
V_67 ) ;
...
V_5 = V_2 -> V_136 -> V_175 ( & V_3 -> V_48 , F_53 , V_84 ) ;
if ( V_5 != 0 )
goto V_176;
}
if ( V_2 -> V_136 ) {
...
static int F_73 ( struct V_82 * V_3 )
{
