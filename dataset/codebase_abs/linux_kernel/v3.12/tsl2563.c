...
int V_110 = 0 ;
T_1 V_27 = 0 ;
V_70 = F_40 ( & V_5 -> V_108 , sizeof( * V_2 ) ) ;
if ( ! V_70 )
return - V_111 ;
V_2 = F_25 ( V_70 ) ;
F_41 ( V_5 , V_2 ) ;
...
V_70 -> V_113 = V_5 -> V_113 ;
V_70 -> V_114 = V_115 ;
V_70 -> V_116 = F_45 ( V_115 ) ;
V_70 -> V_108 . V_117 = & V_5 -> V_108 ;
V_70 -> V_118 = V_119 ;
if ( V_5 -> V_94 )
V_70 -> V_120 = & V_121 ;
else
...
static int F_54 ( struct V_126 * V_108 )
{
struct V_1 * V_2 = F_51 ( F_55 ( V_108 ) ) ;
int V_11 ;
F_27 ( & V_2 -> V_82 ) ;
V_11 = F_1 ( V_2 , 0 ) ;
if ( V_11 )
...
static int F_56 ( struct V_126 * V_108 )
{
struct V_1 * V_2 = F_51 ( F_55 ( V_108 ) ) ;
int V_11 ;
F_27 ( & V_2 -> V_82 ) ;
