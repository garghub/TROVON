...
int V_109 ;
int V_104 ;
V_10 = F_37 ( V_2 , sizeof( * V_10 ) ) ;
if ( ! V_10 )
return - V_124 ;
V_104 = F_38 ( V_2 , V_122 -> V_123 [ 0 ] , V_125 ) ;
if ( V_104 )
return V_104 ;
V_109 = F_34 ( V_2 ) ;
if ( V_109 < 0 ) {
...
V_2 -> V_127 = V_110 + V_109 ;
V_8 = F_6 ( V_2 ) ;
V_2 -> V_128 = V_8 -> V_129 ;
if ( V_77 > 1 && V_77 <= 7 ) {
V_104 = F_39 ( V_77 , F_25 , 0 , V_2 -> V_128 ,
V_2 ) ;
if ( V_104 == 0 )
V_2 -> V_77 = V_77 ;
}
...
V_2 -> V_79 = V_26 ;
V_26 -> type = V_131 ;
V_26 -> V_132 = V_133 | V_134 ;
V_26 -> V_135 = 8 ;
V_26 -> V_90 = ( 1 << V_8 -> V_14 ) - 1 ;
V_26 -> V_136 = V_8 -> V_137 ;
V_26 -> V_138 = F_29 ;
if ( V_2 -> V_77 ) {
V_26 -> V_132 |= V_139 ;
V_26 -> V_140 = 8 ;
