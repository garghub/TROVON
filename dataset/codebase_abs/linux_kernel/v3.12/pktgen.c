...
if ( V_247 > 0 ) {
V_151 = F_116 ( V_238 , V_247 , 0 , V_249 ) ;
if ( V_151 < 0 ) {
F_47 ( L_233 ,
V_151 ) ;
goto V_9;
...
V_248 = ( T_11 * ) F_118 ( V_238 , V_250 ) ;
memcpy ( V_248 , V_23 -> V_144 , 12 ) ;
* ( V_251 * ) & V_248 [ 12 ] = V_246 ;
}
}
return 1 ;
V_9:
...
static void F_120 ( V_234 * V_252 , struct V_22 * V_23 )
{
unsigned int V_61 ;
for ( V_61 = 0 ; V_61 < V_23 -> V_60 ; V_61 ++ )
* V_252 ++ = V_23 -> V_62 [ V_61 ] & ~ V_118 ;
V_252 -- ;
* V_252 |= V_118 ;
}
static inline T_10 F_121 ( unsigned int V_253 , unsigned int V_254 ,
unsigned int V_255 )
{
return F_122 ( V_253 | ( V_254 << 12 ) | ( V_255 << 13 ) ) ;
}
static void F_123 ( struct V_22 * V_23 , struct V_237 * V_238 ,
int V_256 )
{
struct V_257 V_258 ;
struct V_189 * V_259 ;
V_259 = (struct V_189 * ) F_124 ( V_238 , sizeof( * V_259 ) ) ;
V_256 -= sizeof( * V_259 ) ;
if ( V_23 -> V_29 <= 0 ) {
memset ( F_124 ( V_238 , V_256 ) , 0 , V_256 ) ;
} else {
int V_260 = V_23 -> V_29 ;
int V_61 , V_116 ;
int V_261 ;
if ( V_260 > V_262 )
V_260 = V_262 ;
V_116 = V_256 - V_260 * V_263 ;
if ( V_116 > 0 ) {
memset ( F_124 ( V_238 , V_116 ) , 0 , V_116 ) ;
V_256 = V_260 * V_263 ;
}
V_61 = 0 ;
V_261 = ( V_256 / V_260 ) < V_263 ?
( V_256 / V_260 ) : V_263 ;
while ( V_256 > 0 ) {
if ( F_125 ( ! V_23 -> V_137 ) ) {
int V_71 = F_126 () ;
...
V_71 = V_23 -> V_71 ;
V_23 -> V_137 = F_127 ( V_71 , V_264 | V_265 , 0 ) ;
if ( ! V_23 -> V_137 )
break;
}
F_128 ( V_23 -> V_137 ) ;
F_129 ( V_238 , V_61 , V_23 -> V_137 ) ;
F_130 ( V_238 ) -> V_260 [ V_61 ] . V_266 = 0 ;
if ( V_61 == ( V_260 - 1 ) )
F_131 ( & F_130 ( V_238 ) -> V_260 [ V_61 ] ,
( V_256 < V_263 ? V_256 : V_263 ) ) ;
else
F_131 ( & F_130 ( V_238 ) -> V_260 [ V_61 ] , V_261 ) ;
V_256 -= F_132 ( & F_130 ( V_238 ) -> V_260 [ V_61 ] ) ;
V_238 -> V_116 += F_132 ( & F_130 ( V_238 ) -> V_260 [ V_61 ] ) ;
V_238 -> V_267 += F_132 ( & F_130 ( V_238 ) -> V_260 [ V_61 ] ) ;
V_61 ++ ;
F_130 ( V_238 ) -> V_268 = V_61 ;
}
}
V_259 -> V_269 = F_29 ( V_270 ) ;
V_259 -> V_95 = F_29 ( V_23 -> V_95 ) ;
F_133 ( & V_258 ) ;
V_259 -> V_271 = F_29 ( V_258 . V_271 ) ;
V_259 -> V_272 = F_29 ( V_258 . V_272 ) ;
}
static struct V_237 * F_134 ( struct V_163 * V_164 ,
struct V_22 * V_23 ,
unsigned int V_273 )
{
struct V_237 * V_238 = NULL ;
unsigned int V_274 = V_23 -> V_131 + 64 + V_273 +
V_23 -> V_190 ;
if ( V_23 -> V_38 & V_87 ) {
int V_71 = V_23 -> V_71 >= 0 ? V_23 -> V_71 : F_126 () ;
V_238 = F_135 ( V_275 + V_274 , V_276 , 0 , V_71 ) ;
if ( F_86 ( V_238 ) ) {
F_136 ( V_238 , V_275 ) ;
V_238 -> V_164 = V_164 ;
}
} else {
V_238 = F_137 ( V_164 , V_274 , V_276 ) ;
}
return V_238 ;
}
static struct V_237 * F_138 ( struct V_163 * V_51 ,
struct V_22 * V_23 )
{
struct V_237 * V_238 = NULL ;
T_11 * V_248 ;
...
F_102 ( V_23 ) ;
V_285 = V_23 -> V_104 ;
V_256 = ( V_51 -> V_288 + 16 ) & ~ 0xf ;
V_238 = F_134 ( V_51 , V_23 , V_256 ) ;
if ( ! V_238 ) {
...
V_252 = ( V_234 * ) F_124 ( V_238 , V_23 -> V_60 * sizeof( T_7 ) ) ;
if ( V_23 -> V_60 )
F_120 ( V_252 , V_23 ) ;
if ( V_23 -> V_63 != 0xffff ) {
if ( V_23 -> V_66 != 0xffff ) {
V_283 = ( T_10 * ) F_124 ( V_238 , sizeof( T_10 ) ) ;
* V_283 = F_121 ( V_23 -> V_66 ,
V_23 -> V_68 ,
V_23 -> V_67 ) ;
V_284 = ( T_10 * ) F_124 ( V_238 , sizeof( T_10 ) ) ;
* V_284 = F_122 ( V_287 ) ;
}
V_281 = ( T_10 * ) F_124 ( V_238 , sizeof( T_10 ) ) ;
* V_281 = F_121 ( V_23 -> V_63 ,
V_23 -> V_65 ,
V_23 -> V_64 ) ;
V_282 = ( T_10 * ) F_124 ( V_238 , sizeof( T_10 ) ) ;
* V_282 = F_122 ( V_280 ) ;
}
F_140 ( V_238 , 0 ) ;
F_141 ( V_238 , V_238 -> V_116 ) ;
V_279 = (struct V_199 * ) F_124 ( V_238 , sizeof( struct V_199 ) ) ;
F_142 ( V_238 , V_238 -> V_116 ) ;
V_277 = (struct V_188 * ) F_124 ( V_238 , sizeof( struct V_188 ) ) ;
F_143 ( V_238 , V_285 ) ;
V_238 -> V_289 = V_23 -> V_37 ;
memcpy ( V_248 , V_23 -> V_144 , 12 ) ;
* ( T_10 * ) & V_248 [ 12 ] = V_246 ;
V_256 = V_23 -> V_131 - 14 - 20 - 8 -
V_23 -> V_190 ;
if ( V_256 < 0 || V_256 < sizeof( struct V_189 ) )
V_256 = sizeof( struct V_189 ) ;
V_277 -> V_290 = F_122 ( V_23 -> V_103 ) ;
V_277 -> V_291 = F_122 ( V_23 -> V_102 ) ;
V_277 -> V_116 = F_122 ( V_256 + 8 ) ;
V_277 -> V_292 = 0 ;
V_279 -> V_293 = 5 ;
V_279 -> V_4 = 4 ;
V_279 -> V_294 = 32 ;
V_279 -> V_69 = V_23 -> V_69 ;
V_279 -> V_246 = V_295 ;
V_279 -> V_296 = V_23 -> V_100 ;
V_279 -> V_297 = V_23 -> V_101 ;
V_279 -> V_253 = F_122 ( V_23 -> V_298 ) ;
V_23 -> V_298 ++ ;
V_279 -> V_299 = 0 ;
V_278 = 20 + 8 + V_256 ;
V_279 -> V_300 = F_122 ( V_278 ) ;
F_144 ( V_279 ) ;
V_238 -> V_246 = V_246 ;
V_238 -> V_164 = V_51 ;
V_238 -> V_301 = V_302 ;
...
V_238 -> V_303 = V_307 ;
V_238 -> V_308 = 0 ;
F_145 ( V_238 , V_277 -> V_290 , V_277 -> V_291 ) ;
} else {
T_12 V_308 = F_146 ( V_238 ) ;
V_277 -> V_292 = F_147 ( V_277 -> V_290 , V_277 -> V_291 ,
V_256 + 8 , V_295 , V_308 ) ;
if ( V_277 -> V_292 == 0 )
V_277 -> V_292 = V_309 ;
}
F_123 ( V_23 , V_238 , V_256 ) ;
#ifdef F_18
...
static struct V_237 * F_148 ( struct V_163 * V_51 ,
struct V_22 * V_23 )
{
struct V_237 * V_238 = NULL ;
T_11 * V_248 ;
...
F_140 ( V_238 , 0 ) ;
F_141 ( V_238 , V_238 -> V_116 ) ;
V_279 = (struct V_187 * ) F_124 ( V_238 , sizeof( struct V_187 ) ) ;
F_142 ( V_238 , V_238 -> V_116 ) ;
V_277 = (struct V_188 * ) F_124 ( V_238 , sizeof( struct V_188 ) ) ;
F_143 ( V_238 , V_285 ) ;
V_238 -> V_289 = V_23 -> V_37 ;
...
V_310 = V_256 + sizeof( struct V_188 ) ;
V_277 -> V_290 = F_122 ( V_23 -> V_103 ) ;
V_277 -> V_291 = F_122 ( V_23 -> V_102 ) ;
V_277 -> V_116 = F_122 ( V_310 ) ;
V_277 -> V_292 = 0 ;
* ( V_234 * ) V_279 = F_29 ( 0x60000000 ) ;
if ( V_23 -> V_70 ) {
* ( V_234 * ) V_279 |= F_29 ( 0x60000000 | ( V_23 -> V_70 << 20 ) ) ;
}
V_279 -> V_312 = 32 ;
V_279 -> V_313 = F_122 ( V_310 ) ;
V_279 -> V_314 = V_295 ;
V_279 -> V_297 = V_23 -> V_99 ;
V_279 -> V_296 = V_23 -> V_98 ;
V_238 -> V_246 = V_246 ;
V_238 -> V_164 = V_51 ;
V_238 -> V_301 = V_302 ;
if ( ! ( V_23 -> V_38 & V_77 ) ) {
...
V_238 -> V_303 = V_307 ;
V_238 -> V_316 = F_150 ( V_238 ) - V_238 -> V_317 ;
V_238 -> V_318 = F_151 ( struct V_188 , V_292 ) ;
V_277 -> V_292 = ~ F_152 ( & V_279 -> V_296 , & V_279 -> V_297 , V_310 , V_295 , 0 ) ;
} else {
T_12 V_308 = F_146 ( V_238 ) ;
V_277 -> V_292 = F_152 ( & V_279 -> V_296 , & V_279 -> V_297 , V_310 , V_295 , V_308 ) ;
if ( V_277 -> V_292 == 0 )
V_277 -> V_292 = V_309 ;
}
F_123 ( V_23 , V_238 , V_256 ) ;
...
static struct V_237 * F_153 ( struct V_163 * V_51 ,
struct V_22 * V_23 )
{
if ( V_23 -> V_38 & V_39 )
return F_148 ( V_51 , V_23 ) ;
else
...
static void F_154 ( struct V_149 * V_150 )
{
struct V_22 * V_23 ;
int V_320 = 0 ;
F_155 () ;
...
static int F_156 ( const struct V_149 * V_150 )
{
const struct V_22 * V_23 ;
F_44 (pkt_dev, &t->if_list, list)
if ( V_23 -> V_88 )
...
static int F_157 ( struct V_149 * V_150 )
{
F_43 ( V_150 ) ;
while ( F_156 ( V_150 ) ) {
F_45 ( V_150 ) ;
...
static void F_160 ( struct V_22 * V_23 , int V_268 )
{
T_13 V_324 , V_325 , V_326 ;
char * V_327 = V_23 -> V_106 ;
T_5 V_328 = F_91 ( V_23 -> V_89 ,
V_23 -> V_94 ) ;
T_5 V_26 = F_161 ( V_23 -> V_90 ) ;
...
{
int V_268 = V_23 -> V_238 ? F_130 ( V_23 -> V_238 ) -> V_268 : - 1 ;
if ( ! V_23 -> V_88 ) {
F_10 ( L_241 ,
V_23 -> V_32 ) ;
return - V_127 ;
...
static struct V_22 * F_164 ( struct V_149 * V_150 )
{
...
static void F_165 ( struct V_149 * V_150 )
{
struct V_22 * V_23 ;
F_155 () ;
F_43 ( V_150 ) ;
...
F_43 ( V_150 ) ;
F_167 (q, n, &t->if_list) {
V_332 = F_168 ( V_331 , struct V_22 , V_333 ) ;
if ( ! V_332 -> V_158 )
continue;
F_119 ( V_332 -> V_238 ) ;
V_332 -> V_238 = NULL ;
...
static void F_170 ( struct V_149 * V_150 )
{
struct V_330 * V_331 , * V_115 ;
struct V_22 * V_332 ;
F_155 () ;
...
{
F_172 ( V_150 -> V_334 -> V_335 , V_150 -> V_178 -> V_166 ) ;
}
...
{
T_5 V_336 = F_19 () ;
while ( F_175 ( & ( V_23 -> V_238 -> V_337 ) ) != 1 ) {
if ( F_89 ( V_13 ) )
break;
if ( F_176 () )
F_173 ( V_23 ) ;
...
T_14 (* F_179)( struct V_237 * , struct V_163 * )
= V_51 -> V_338 -> V_339 ;
struct V_340 * V_341 ;
V_251 V_285 ;
int V_151 ;
if ( F_125 ( ! F_67 ( V_51 ) || ! F_180 ( V_51 ) ) ) {
F_163 ( V_23 ) ;
return;
}
if ( F_125 ( V_23 -> V_30 == V_132 ) ) {
...
V_285 = F_181 ( V_23 -> V_238 ) ;
V_341 = F_182 ( V_51 , V_285 ) ;
F_183 ( V_341 ) ;
if ( F_125 ( F_184 ( V_341 ) ) ) {
V_151 = V_347 ;
V_23 -> V_343 = 0 ;
goto V_348;
}
F_185 ( & ( V_23 -> V_238 -> V_337 ) ) ;
V_151 = (* F_179)( V_23 -> V_238 , V_51 ) ;
switch ( V_151 ) {
case V_349 :
F_186 ( V_341 ) ;
V_23 -> V_343 = 1 ;
...
F_191 ( & V_150 -> V_357 ) ;
F_192 ( & V_150 -> V_358 ) ;
F_32 ( L_244 , V_356 , F_193 ( V_13 ) ) ;
F_83 ( V_213 ) ;
F_194 () ;
while ( ! F_195 () ) {
V_23 = F_164 ( V_150 ) ;
if ( F_125 ( ! V_23 && V_150 -> V_153 == 0 ) ) {
...
static int F_198 ( struct V_149 * V_150 ,
struct V_22 * V_23 )
{
int V_360 = 0 ;
F_43 ( V_150 ) ;
...
struct V_22 * V_23 ;
int V_9 ;
int V_71 = F_200 ( V_150 -> V_356 ) ;
V_23 = F_54 ( V_150 -> V_178 , V_155 , V_157 ) ;
if ( V_23 ) {
F_47 ( L_250 ) ;
return - V_362 ;
}
V_23 = F_201 ( sizeof( struct V_22 ) , V_264 , V_71 ) ;
if ( ! V_23 )
return - V_364 ;
strcpy ( V_23 -> V_32 , V_155 ) ;
V_23 -> V_218 = F_202 ( V_146 * sizeof( struct V_365 ) ,
V_71 ) ;
if ( V_23 -> V_218 == NULL ) {
F_203 ( V_23 ) ;
return - V_364 ;
...
static int T_15 F_205 ( int V_356 , struct V_11 * V_12 )
{
struct V_149 * V_150 ;
struct V_373 * V_374 ;
struct V_375 * V_327 ;
V_150 = F_201 ( sizeof( struct V_149 ) , V_264 ,
F_200 ( V_356 ) ) ;
if ( ! V_150 ) {
F_47 ( L_252 ) ;
return - V_364 ;
...
static void F_218 ( struct V_149 * V_150 ,
struct V_22 * V_23 )
{
struct V_330 * V_331 , * V_115 ;
struct V_22 * V_327 ;
F_167 (q, n, &t->if_list) {
V_327 = F_168 ( V_331 , struct V_22 , V_333 ) ;
if ( V_327 == V_23 )
F_212 ( & V_327 -> V_333 ) ;
}
}
static int F_169 ( struct V_149 * V_150 ,
struct V_22 * V_23 )
{
F_32 ( L_255 , V_23 ) ;
if ( V_23 -> V_88 ) {
...
static int T_15 F_219 ( struct V_178 * V_178 )
{
...
F_207 ( & V_12 -> V_377 ) ;
V_12 -> V_172 = false ;
V_12 -> V_166 = F_220 ( V_370 , V_12 -> V_178 -> V_379 ) ;
if ( ! V_12 -> V_166 ) {
F_221 ( L_257 , V_370 ) ;
return - V_179 ;
}
V_374 = F_222 ( V_380 , 0600 , V_12 -> V_166 , & V_381 ) ;
if ( V_374 == NULL ) {
F_47 ( L_258 , V_380 ) ;
V_151 = - V_127 ;
goto remove;
...
return 0 ;
V_382:
F_172 ( V_380 , V_12 -> V_166 ) ;
remove:
F_172 ( V_370 , V_12 -> V_178 -> V_379 ) ;
return V_151 ;
}
static void T_16 F_225 ( struct V_178 * V_178 )
{
struct V_11 * V_12 = F_4 ( V_178 , V_16 ) ;
struct V_149 * V_150 ;
struct V_330 * V_331 , * V_115 ;
...
V_12 -> V_172 = true ;
F_48 ( & V_152 ) ;
F_227 ( & V_12 -> V_377 , & V_333 ) ;
F_50 ( & V_152 ) ;
F_167 (q, n, &list) {
V_150 = F_168 ( V_331 , struct V_149 , V_376 ) ;
F_212 ( & V_150 -> V_376 ) ;
F_215 ( V_150 -> V_334 ) ;
F_203 ( V_150 ) ;
}
