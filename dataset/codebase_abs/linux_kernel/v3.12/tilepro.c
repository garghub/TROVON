...
static void F_82 ( struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
int V_2 ;
int V_117 = 0 ;
F_83 ( F_80 , ( void * ) V_39 , 1 ) ;
F_84 (i) {
...
static int F_90 ( struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
int V_8 = F_2 () ;
struct V_15 * V_16 ;
...
F_91 ( F_72 , ( void * ) V_39 , 1 ) ;
F_84 (i) {
struct V_15 * V_16 = V_59 -> V_82 [ V_2 ] ;
if ( V_16 -> V_149 )
F_92 ( V_39 , & V_16 -> V_38 , F_55 , 64 ) ;
else
V_12 = - V_154 ;
}
if ( V_12 != 0 ) {
...
F_16 ( V_59 -> V_112 == 0 ) ;
V_113 = F_93 ( V_59 -> V_112 ) ;
F_94 ( V_113 , V_156 ) ;
F_16 ( F_95 ( V_113 , F_59 ,
...
static void F_99 ( struct V_162 * V_163 )
{
struct V_164 * V_165 =
F_100 ( V_163 , struct V_164 , V_109 ) ;
struct V_58 * V_59 =
F_100 ( V_165 , struct V_58 , V_166 ) ;
if ( F_90 ( V_59 -> V_39 ) != 0 )
F_101 ( & V_59 -> V_166 ,
V_167 ) ;
else
...
static int F_103 ( struct V_56 * V_39 )
{
int V_116 = 0 ;
struct V_58 * V_59 = F_30 ( V_39 ) ;
if ( ! V_59 -> V_152 ) {
...
F_104 ( & V_59 -> V_133 , V_170 ) ;
V_9 = F_105 ( & V_59 -> V_133 ) ;
V_168 = F_106 ( 16 , ( V_160 / V_9 ) & ~ 1 ) ;
V_168 = F_96 ( V_171 , V_168 ) ;
V_59 -> V_158 = V_9 ;
V_59 -> V_136 = V_168 ;
#ifdef F_107
F_6 ( L_32 ,
...
static int F_110 ( struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
F_74 ( L_33 ) ;
V_59 -> V_110 = false ;
F_97 () ;
F_83 ( F_79 , ( void * ) V_39 , 1 ) ;
( void ) F_109 ( V_59 ) ;
F_111 ( & V_59 -> V_166 ) ;
F_112 ( V_39 ) ;
F_83 ( F_86 , ( void * ) V_39 , 1 ) ;
if ( F_109 ( V_59 ) != 0 )
F_78 ( L_34 ) ;
F_82 ( V_39 ) ;
...
static unsigned int F_113 ( T_13 * V_173 ,
struct V_35 * V_36 ,
void * V_174 , unsigned int V_175 )
{
unsigned int V_2 , V_53 = 0 ;
struct V_176 * V_177 = F_114 ( V_36 ) ;
V_80 V_178 ;
if ( V_175 != 0 ) {
if ( ! V_41 )
F_115 ( V_174 , V_175 , 0 ) ;
...
unsigned long V_184 = F_116 ( F_117 ( V_183 ) ) ;
int V_181 = V_41 ;
if ( ! V_41 ) {
void * V_25 = F_118 ( V_184 ) + V_183 -> V_185 ;
F_16 ( F_119 ( F_117 ( V_183 ) ) ) ;
F_115 ( V_25 , F_120 ( V_183 ) , 0 ) ;
}
V_178 = ( ( V_80 ) V_184 << V_186 ) + V_183 -> V_185 ;
V_173 [ V_53 ] . V_179 = V_178 ;
V_173 [ V_53 ] . V_180 = V_178 >> 32 ;
V_173 [ V_53 ] . V_6 = F_120 ( V_183 ) ;
V_173 [ V_53 ] . V_181 = V_181 ;
V_53 ++ ;
}
return V_53 ;
}
static int F_121 ( struct V_35 * V_36 , struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
int V_8 = F_2 () ;
struct V_15 * V_16 = V_59 -> V_82 [ V_8 ] ;
...
struct V_187 * V_188 = F_122 ( V_36 ) ;
unsigned int V_189 = V_188 -> V_190 * 4 ;
unsigned char * V_191 = F_123 ( V_36 ) ;
...
unsigned int V_175 = F_124 ( V_36 ) - V_197 ;
...
unsigned int V_207 =
F_113 ( V_206 -> V_173 , V_36 , V_5 + V_197 , V_175 ) ;
T_16 V_208 = F_125 ( V_207 , V_197 ) ;
T_15 V_209 = {
. V_210 = true ,
. V_211 = V_197 ,
. V_212 = V_192 ,
...
F_127 ( & V_49 -> V_218 ) ;
F_97 () ;
F_128 ( & V_59 -> V_63 , V_215 ) ;
if ( F_129 ( V_49 ) == 0 ) {
V_216 = F_27 ( V_49 , V_60 , V_61 , 0 ) ;
if ( V_216 == 0 ) {
V_224:
F_130 ( & V_59 -> V_63 , V_215 ) ;
return V_225 ;
}
}
V_217 = V_49 -> V_217 ;
...
static int F_131 ( struct V_35 * V_36 , struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
int V_8 = F_2 () ;
struct V_15 * V_16 = V_59 -> V_82 [ V_8 ] ;
...
#endif
#ifdef F_44
F_5 ( V_5 , F_124 ( V_36 ) , L_36 ) ;
#endif
if ( V_177 -> V_201 != 0 )
return F_121 ( V_36 , V_39 ) ;
V_207 = F_113 ( V_173 , V_36 , V_5 , F_124 ( V_36 ) ) ;
...
static void F_133 ( struct V_56 * V_39 )
{
F_74 ( L_37 ) ;
F_74 ( L_38 , V_67 ,
V_67 - V_39 -> V_234 ) ;
...
static int F_135 ( struct V_56 * V_39 , struct V_245 * V_246 , int V_206 )
{
return - V_247 ;
}
static struct V_248 * F_136 ( struct V_56 * V_39 ,
struct V_248 * V_85 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
...
static int F_139 ( struct V_56 * V_39 , int V_257 )
{
F_74 ( L_39 ) ;
...
static int F_140 ( struct V_56 * V_39 , void * V_260 )
{
struct V_261 * V_262 = V_260 ;
if ( ! F_141 ( V_262 -> V_263 ) )
return - V_264 ;
memcpy ( V_39 -> V_98 , V_262 -> V_263 , V_39 -> V_265 ) ;
return 0 ;
}
static int F_142 ( struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
char V_266 [ 32 ] ;
int V_3 ;
...
V_59 -> V_119 = F_143 ( ( V_120 ) V_266 , 0 ) ;
F_74 ( L_42 ,
...
static void F_145 ( struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
F_60 ( V_59 -> V_112 ) ;
...
static struct V_56 * F_148 ( const char * V_138 )
{
int V_116 ;
struct V_56 * V_39 ;
struct V_58 * V_59 ;
V_39 = F_149 ( sizeof( * V_59 ) , V_138 , F_146 ) ;
if ( ! V_39 ) {
F_64 ( L_47 , V_138 ) ;
return NULL ;
}
...
V_59 -> V_39 = V_39 ;
F_150 ( & V_59 -> V_166 , F_99 ) ;
F_151 ( & V_59 -> V_63 ) ;
V_59 -> V_124 = F_152 ( V_286 | V_287 , V_125 ) ;
if ( ! V_59 -> V_124 ) {
F_153 ( V_39 ) ;
return NULL ;
}
V_59 -> V_49 = F_154 ( V_59 -> V_124 ) ;
V_116 = F_155 ( V_39 ) ;
if ( V_116 ) {
F_64 ( L_48 , V_39 -> V_138 , V_116 ) ;
F_156 ( V_59 -> V_124 , V_125 ) ;
F_153 ( V_39 ) ;
return NULL ;
}
V_116 = F_142 ( V_39 ) ;
...
static int T_20 F_160 ( char * V_290 )
{
int V_291 = F_161 ( V_290 , & V_133 ) ;
if ( V_291 != 0 ) {
F_71 ( L_50 ,
V_290 ) ;
} else {
