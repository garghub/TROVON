...
V_66 = F_32 ( & V_63 -> V_72 , sizeof( * V_66 ) , V_77 ) ;
if ( ! V_66 )
return F_30 ( - V_78 ) ;
V_66 -> V_60 = F_32 ( & V_63 -> V_72 ,
...
{
struct V_44 * V_44 = F_34 ( V_63 -> V_72 . V_73 ) ;
struct V_80 * V_80 = F_35 ( V_44 -> V_72 ) ;
struct V_64 * V_65 ;
struct V_57 * V_58 ;
...
V_43 -> V_107 = F_42 ( V_44 -> V_108 , V_40 ) ;
if ( V_43 -> V_107 >= 0 ) {
V_17 = F_43 ( V_43 -> V_107 ,
NULL , F_22 ,
V_109 | V_110 ,
L_9 , V_43 ) ;
if ( V_17 ) {
...
V_106:
while ( -- V_10 >= 0 )
F_44 ( V_43 -> V_45 [ V_10 ] . V_2 ) ;
return V_17 ;
}
static int F_45 ( struct V_62 * V_63 )
{
struct V_42 * V_43 = F_46 ( V_63 ) ;
struct V_5 * V_6 ;
F_47 ( V_43 -> V_107 , V_43 ) ;
F_47 ( V_43 -> V_112 , V_43 ) ;
for ( V_6 = & V_43 -> V_45 [ V_43 -> V_50 - 1 ] ;
V_6 >= & V_43 -> V_45 [ 0 ] ; V_6 -- )
F_44 ( V_6 -> V_2 ) ;
return 0 ;
}
