...
int F_51 ( struct V_45 * V_45 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_46 ;
...
int F_56 ( struct V_45 * V_45 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_50 = 0 ;
F_57 () ;
...
if ( V_62 )
goto V_77;
V_62 = F_71 ( & V_11 -> V_21 , & V_78 , & ( V_2 -> V_2 . V_21 ) ,
V_79 ) ;
if ( V_62 )
goto V_80;
V_62 = F_72 ( V_11 ) ;
...
if ( V_62 )
goto V_82;
V_62 = F_74 ( V_2 , V_13 -> V_2 ) ;
if ( V_62 )
goto V_83;
V_62 = F_75 ( V_2 , V_84 , V_11 ) ;
if ( V_62 )
goto V_85;
V_2 -> V_28 |= V_29 ;
F_76 ( V_2 ) ;
F_77 ( & V_11 -> V_27 , & V_13 -> V_57 ) ;
F_78 ( V_13 -> V_2 ) ;
...
void T_2 F_85 ( struct V_45 * V_45 )
{
struct V_1 * V_2 ;
F_86 ( V_27 ) ;
F_57 () ;
