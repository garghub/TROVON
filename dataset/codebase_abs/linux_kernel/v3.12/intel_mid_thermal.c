...
{
static char * V_53 [ V_54 ] = {
L_4 , L_5 , L_6 , L_7
} ;
int V_23 ;
int V_38 ;
struct V_55 * V_56 ;
V_56 = F_15 ( sizeof( struct V_55 ) , V_49 ) ;
if ( ! V_56 )
return - V_57 ;
V_23 = F_11 ( & V_52 -> V_45 ) ;
if ( V_23 ) {
...
V_56 -> V_17 [ V_38 ] = F_22 ( V_53 [ V_38 ] ,
0 , 0 , V_19 , & V_59 , NULL , 0 , 0 ) ;
if ( F_23 ( V_56 -> V_17 [ V_38 ] ) ) {
F_21 ( V_19 ) ;
V_23 = F_24 ( V_56 -> V_17 [ V_38 ] ) ;
goto V_58;
}
}
V_56 -> V_52 = V_52 ;
