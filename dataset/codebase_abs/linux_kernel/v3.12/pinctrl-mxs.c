...
if ( ! V_4 -> V_58 )
return - V_88 ;
V_89 . V_10 = V_4 -> V_5 -> V_10 ;
V_89 . V_12 = V_4 -> V_5 -> V_12 ;
V_89 . V_9 = F_7 ( & V_70 -> V_16 ) ;
F_44 ( V_70 , V_4 ) ;
V_31 = F_37 ( V_70 , V_4 ) ;
if ( V_31 ) {
F_39 ( & V_70 -> V_16 , L_13 , V_31 ) ;
goto V_90;
}
V_4 -> V_91 = F_45 ( & V_89 , & V_70 -> V_16 , V_4 ) ;
if ( ! V_4 -> V_91 ) {
F_39 ( & V_70 -> V_16 , L_14 ) ;
V_31 = - V_76 ;
goto V_90;
