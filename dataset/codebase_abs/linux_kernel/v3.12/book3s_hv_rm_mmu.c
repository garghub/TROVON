...
long F_39 ( struct V_92 * V_93 , unsigned long V_8 ,
long V_22 , unsigned long V_55 , unsigned long V_37 )
{
return F_22 ( V_93 -> V_7 , V_8 , V_22 , V_55 , V_37 ,
V_93 -> V_10 . V_46 , true , & V_93 -> V_10 . V_94 [ 4 ] ) ;
}
static inline int F_40 ( unsigned int * V_95 )
{
...
static void F_41 ( struct V_7 * V_7 , unsigned long * V_100 ,
long V_101 , int V_9 , bool V_102 )
{
long V_26 ;
if ( V_9 ) {
while ( ! F_40 ( & V_7 -> V_10 . V_103 ) )
F_35 () ;
if ( V_102 )
asm volatile("ptesync" : : : "memory");
...
long V_26 ;
if ( F_25 ( V_105 ) ) {
F_41 ( V_7 , V_100 , V_101 , V_9 , V_102 ) ;
return;
}
if ( V_9 ) {
while ( ! F_40 ( & V_7 -> V_10 . V_103 ) )
...
if ( V_108 & V_70 ) {
V_54 [ 0 ] &= ~ V_70 ;
V_104 = F_44 ( V_108 , V_54 [ 1 ] , V_22 ) ;
F_42 ( V_7 , & V_104 , 1 , F_6 ( V_7 , V_8 ) , true ) ;
...
long F_45 ( struct V_92 * V_93 , unsigned long V_8 ,
unsigned long V_22 , unsigned long V_106 )
{
return F_43 ( V_93 -> V_7 , V_8 , V_22 , V_106 ,
& V_93 -> V_10 . V_94 [ 4 ] ) ;
}
long F_46 ( struct V_92 * V_93 )
{
...
V_113 [ 0 ] &= ~ V_70 ;
V_115 [ V_118 ] = F_44 ( V_113 [ 0 ] , V_113 [ 1 ] , V_22 ) ;
V_120 [ V_118 ] = V_116 ;
V_114 [ V_118 ] = V_113 ;
V_123 [ V_118 ] = V_20 ;
++ V_118 ;
...
unsigned long V_104 ;
V_130 [ 0 ] &= ~ V_70 ;
V_104 = F_44 ( V_130 [ 0 ] , V_130 [ 1 ] , V_22 ) ;
F_42 ( V_7 , & V_104 , 1 , 1 , true ) ;
}
...
unsigned int V_168 = F_55 ( V_154 , V_93 -> V_10 . V_169 ) ;
if ( V_151 & V_165 )
V_168 >>= 1 ;
if ( V_168 & 1 )
return V_151 | V_170 ;
