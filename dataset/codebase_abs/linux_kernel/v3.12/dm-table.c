...
unsigned F_87 ( struct V_6 * V_7 )
{
return V_7 -> type ;
}
struct V_127 * F_88 ( struct V_6 * V_7 )
{
return V_7 -> V_105 ;
}
bool F_89 ( struct V_6 * V_7 )
{
return F_87 ( V_7 ) == V_125 ;
}
int F_90 ( struct V_6 * V_7 )
{
unsigned type = F_87 ( V_7 ) ;
unsigned V_128 = 0 ;
struct V_21 * V_43 ;
unsigned V_42 ;
if ( F_54 ( type == V_129 ) ) {
...
for ( V_42 = 0 ; V_42 < V_7 -> V_23 ; V_42 ++ ) {
V_43 = V_7 -> V_26 + V_42 ;
V_128 = V_118 ( V_128 , V_43 -> V_128 ) ;
}
V_7 -> V_45 = F_91 ( type , V_7 -> V_130 , V_128 ) ;
if ( ! V_7 -> V_45 )
return - V_24 ;
return 0 ;
}
...
struct V_131 * F_93 ( struct V_6 * V_7 )
{
return V_7 -> V_45 ;
}
...
V_133 = ( T_1 * ) F_7 ( V_132 , ( unsigned long ) V_134 ) ;
if ( ! V_133 )
return - V_24 ;
for ( V_42 = V_7 -> V_11 - 2 ; V_42 >= 0 ; V_42 -- ) {
V_7 -> V_9 [ V_42 ] = V_133 ;
V_133 += ( V_10 * V_7 -> V_12 [ V_42 ] ) ;
F_6 ( V_42 , V_7 ) ;
}
return 0 ;
}
...
int V_52 = 0 ;
unsigned int V_135 ;
V_135 = F_2 ( V_7 -> V_23 , V_10 ) ;
V_7 -> V_11 = 1 + F_1 ( V_135 , V_5 ) ;
V_7 -> V_12 [ V_7 -> V_11 - 1 ] = V_135 ;
V_7 -> V_9 [ V_7 -> V_11 - 1 ] = V_7 -> V_25 ;
if ( V_7 -> V_11 >= 2 )
V_52 = F_94 ( V_7 ) ;
return V_52 ;
}
static struct V_136 * F_96 ( struct V_6 * V_7 ,
bool V_137 )
{
struct V_34 * V_32 = F_85 ( V_7 ) ;
struct V_37 * V_38 = NULL ;
struct V_136 * V_138 = NULL , * V_139 = NULL ;
F_25 (dd, devices, list) {
V_139 = V_38 -> V_40 . V_47 -> V_140 ;
if ( ! F_97 ( V_139 ) )
goto V_141;
if ( ! V_137 && ! F_98 ( V_139 ) )
continue;
...
static int F_100 ( struct V_6 * V_7 , struct V_29 * V_30 )
{
struct V_136 * V_139 = NULL ;
V_139 = F_96 ( V_7 , false ) ;
if ( ! V_139 )
return 0 ;
if ( ! F_98 ( F_32 ( V_30 ) ) ) {
V_7 -> V_130 = 1 ;
return F_101 ( F_32 ( V_30 ) , NULL ) ;
}
if ( F_98 ( V_139 ) &&
F_99 ( F_32 ( V_30 ) , V_139 ) < 0 ) {
F_19 ( L_34
L_35 ,
F_39 ( V_7 -> V_30 ) ,
V_139 -> V_142 ) ;
...
struct V_21 * F_110 ( struct V_6 * V_7 , T_1 V_147 )
{
...
static int F_111 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
unsigned * V_148 = V_57 ;
( * V_148 ) ++ ;
...
bool F_112 ( struct V_6 * V_70 )
{
struct V_21 * V_75 ( V_54 ) ;
unsigned V_42 = 0 , V_148 = 0 ;
while ( V_42 < F_67 ( V_70 ) ) {
V_54 = F_68 ( V_70 , V_42 ++ ) ;
if ( ! V_54 -> type -> V_100 )
return false ;
V_54 -> type -> V_100 ( V_54 , F_111 , & V_148 ) ;
if ( V_148 )
return false ;
}
return true ;
}
int F_113 ( struct V_6 * V_70 ,
struct V_60 * V_61 )
{
struct V_21 * V_75 ( V_54 ) ;
struct V_60 V_99 ;
...
& V_99 ) ;
if ( V_54 -> type -> V_150 )
V_54 -> type -> V_150 ( V_54 , & V_99 ) ;
if ( V_54 -> type -> V_100 ( V_54 , F_36 ,
& V_99 ) )
return - V_101 ;
V_149:
if ( F_114 ( V_61 , & V_99 , 0 ) < 0 )
F_19 ( L_40
L_41
L_42 ,
F_39 ( V_70 -> V_30 ) ,
...
{
struct V_136 * V_139 = NULL ;
if ( ! F_97 ( F_32 ( V_7 -> V_30 ) ) )
return;
V_139 = F_96 ( V_7 , true ) ;
if ( V_139 )
F_101 ( F_32 ( V_7 -> V_30 ) ,
F_97 ( V_139 ) ) ;
else if ( F_98 ( F_32 ( V_7 -> V_30 ) ) )
F_19 ( L_43 ,
F_39 ( V_7 -> V_30 ) ) ;
else
F_19 ( L_44 ,
...
static int F_116 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
unsigned V_151 = ( * ( unsigned * ) V_57 ) ;
struct V_58 * V_59 = F_38 ( V_46 -> V_47 ) ;
return V_59 && ( V_59 -> V_152 & V_151 ) ;
}
static bool F_117 ( struct V_6 * V_7 , unsigned V_151 )
{
struct V_21 * V_54 ;
unsigned V_42 = 0 ;
while ( V_42 < F_67 ( V_7 ) ) {
...
return 1 ;
if ( V_54 -> type -> V_100 &&
V_54 -> type -> V_100 ( V_54 , F_116 , & V_151 ) )
return 1 ;
}
return 0 ;
}
...
static int F_121 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
struct V_58 * V_59 = F_38 ( V_46 -> V_47 ) ;
return V_59 && ! F_122 ( V_59 ) ;
}
...
V_54 = F_68 ( V_7 , V_42 ++ ) ;
if ( ! V_54 -> type -> V_100 ||
! V_54 -> type -> V_100 ( V_54 , V_156 , NULL ) )
return 0 ;
}
return 1 ;
}
static int F_124 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
struct V_58 * V_59 = F_38 ( V_46 -> V_47 ) ;
return V_59 && ! V_59 -> V_61 . V_157 ;
}
...
return false ;
if ( ! V_54 -> type -> V_100 ||
V_54 -> type -> V_100 ( V_54 , F_124 , NULL ) )
return false ;
}
return true ;
}
void F_126 ( struct V_6 * V_7 , struct V_58 * V_59 ,
struct V_60 * V_61 )
{
unsigned V_151 = 0 ;
V_59 -> V_61 = * V_61 ;
...
struct V_34 * F_85 ( struct V_6 * V_7 )
{
return & V_7 -> V_32 ;
}
...
static void F_133 ( struct V_6 * V_7 , unsigned V_166 )
{
int V_42 = V_7 -> V_23 ;
...
if ( V_166 ) {
if ( V_54 -> type -> V_166 )
V_54 -> type -> V_166 ( V_54 ) ;
} else if ( V_54 -> type -> V_167 )
...
void F_137 ( struct V_6 * V_7 , struct V_170 * V_171 )
{
F_51 ( & V_171 -> V_39 , & V_7 -> V_33 ) ;
}
int F_138 ( struct V_6 * V_7 , int V_172 )
{
struct V_37 * V_38 ;
struct V_34 * V_32 = F_85 ( V_7 ) ;
struct V_170 * V_171 ;
...
for ( V_42 = 0 ; V_42 < V_7 -> V_23 ; V_42 ++ ) {
V_54 = V_7 -> V_26 + V_42 ;
if ( V_54 -> type -> V_175 && V_54 -> type -> V_175 ( V_54 ) )
return 1 ;
}
return 0 ;
}
...
static int F_144 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
struct V_58 * V_59 = F_38 ( V_46 -> V_47 ) ;
return V_59 && F_145 ( V_59 ) ;
}
...
return 1 ;
if ( V_54 -> type -> V_100 &&
V_54 -> type -> V_100 ( V_54 , F_144 , NULL ) )
return 1 ;
}
return 0 ;
}
