...
void F_53 ( struct V_68 * V_69 , T_1 V_70 , T_2 V_71 )
{
struct V_24 * V_25 = F_54 ( & V_69 -> V_72 ) ;
struct V_4 * V_5 ;
while ( V_71 ) {
V_5 = F_19 ( V_69 -> V_73 , V_70 , V_74 ) ;
if ( V_5 ) {
F_7 ( V_5 ) ;
F_55 ( V_25 ) ;
...
int F_57 ( struct V_68 * V_69 , int V_75 , T_1 V_76 ,
struct V_4 * * V_42 )
{
struct V_24 * V_25 = F_54 ( & V_69 -> V_72 ) ;
...
V_77 = F_34 ( V_19 , V_76 , V_49 , & V_5 ) ;
if ( V_77 == 0 && F_58 ( V_25 , V_5 , V_78 ) ) {
F_40 ( V_5 ) ;
V_77 = - V_45 ;
}
* V_42 = V_5 ;
...
struct V_4 * F_59 ( struct V_18 * V_19 , T_1 V_81 , T_2 V_82 )
{
struct V_24 * V_25 = V_19 -> V_26 ;
struct V_4 * V_83 , * V_5 ;
T_2 V_84 = F_60 ( V_25 , V_85 ) >>
V_25 -> V_31 . V_32 ;
F_2 ( ! V_82 ) ;
if ( V_84 < 1 )
V_84 = 1 ;
if ( V_82 > V_84 )
V_82 = V_84 ;
V_83 = F_19 ( V_19 , V_81 , V_40 ) ;
if ( F_37 ( V_83 ) )
goto V_86;
if ( ! F_61 ( V_83 ) )
F_62 ( V_48 | V_9 , 1 , & V_83 ) ;
V_81 ++ ;
V_82 -- ;
while ( V_82 ) {
V_5 = F_19 ( V_19 , V_81 , V_40 ) ;
if ( ! F_37 ( V_5 ) && ! F_61 ( V_5 ) )
F_62 ( V_87 | V_9 , 1 , & V_5 ) ;
F_40 ( V_5 ) ;
V_81 ++ ;
V_82 -- ;
if ( ! F_61 ( V_83 ) && F_37 ( V_83 ) )
goto V_86;
}
F_38 ( V_83 ) ;
V_86:
