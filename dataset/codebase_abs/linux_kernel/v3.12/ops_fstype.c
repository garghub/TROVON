...
static int F_77 ( struct V_11 * V_14 , struct V_183 * V_184 )
{
int error ;
struct V_145 V_228 ;
struct V_229 V_230 ;
...
static int F_80 ( struct V_11 * V_14 , int V_147 )
{
struct V_171 * V_235 = V_14 -> V_180 -> V_236 ;
struct V_145 V_215 ;
struct V_189 * V_190 ;
int V_237 = 1 ;
int error = 0 ;
...
if ( V_14 -> V_138 . V_241 ) {
V_14 -> V_185 = F_83 ( V_14 , 0 ) ;
F_9 ( & V_14 -> V_242 , V_14 -> V_185 -> V_243 ) ;
F_9 ( & V_14 -> V_244 , 2 * V_14 -> V_185 -> V_243 / 5 ) ;
F_9 ( & V_14 -> V_245 , 4 * V_14 -> V_185 -> V_243 / 5 ) ;
} else {
if ( V_14 -> V_210 . V_246 >= F_82 ( V_14 ) ) {
F_39 ( V_14 , L_35 ,
V_14 -> V_210 . V_246 ) ;
F_39 ( V_14 , L_36 ,
F_82 ( V_14 ) ,
...
V_14 -> V_185 = F_83 ( V_14 , V_14 -> V_210 . V_246 ) ;
error = F_46 ( V_14 , V_14 -> V_210 . V_246 ,
& V_247 ,
V_151 , V_152 ,
& V_14 -> V_248 ) ;
if ( error ) {
F_39 ( V_14 , L_37 , error ) ;
goto V_240;
}
...
F_84 ( V_14 , F_85 ( & V_14 -> V_242 ) ) ;
if ( V_14 -> V_210 . V_251 ) {
unsigned int V_108 ;
for ( V_108 = 0 ; V_108 < V_14 -> V_221 ; V_108 ++ ) {
struct V_183 * V_184 = F_83 ( V_14 , V_108 ) ;
if ( V_14 -> V_138 . V_241 ) {
error = F_77 ( V_14 , V_184 ) ;
if ( error )
goto V_238;
continue;
}
...
F_64 ( V_14 ) ;
} else if ( ! V_14 -> V_138 . V_241 ) {
error = F_86 ( V_14 -> V_185 , true ) ;
if ( error ) {
F_39 ( V_14 , L_41 , error ) ;
goto V_238;
}
}
F_7 ( V_252 , & V_14 -> V_21 ) ;
...
static int F_89 ( struct V_11 * V_14 , int V_147 )
{
int error = 0 ;
struct V_171 * V_235 = V_14 -> V_180 -> V_236 ;
if ( V_147 )
goto V_253;
error = F_80 ( V_14 , V_147 ) ;
if ( error )
goto V_154;
V_14 -> V_254 = F_81 ( V_235 , L_42 ) ;
if ( F_52 ( V_14 -> V_254 ) ) {
error = F_53 ( V_14 -> V_254 ) ;
F_39 ( V_14 , L_43 , error ) ;
goto V_255;
}
V_14 -> V_256 = F_81 ( V_235 , L_44 ) ;
if ( F_52 ( V_14 -> V_256 ) ) {
error = F_53 ( V_14 -> V_256 ) ;
F_39 ( V_14 , L_45 , error ) ;
goto V_257;
}
V_14 -> V_258 = 0 ;
V_14 -> V_259 = F_81 ( V_235 , L_46 ) ;
if ( F_52 ( V_14 -> V_259 ) ) {
error = F_53 ( V_14 -> V_259 ) ;
F_39 ( V_14 , L_47 , error ) ;
goto V_260;
}
F_90 ( & V_14 -> V_259 -> V_261 ,
& V_262 ) ;
error = F_91 ( V_14 ) ;
if ( error )
goto V_253;
...
static int F_93 ( struct V_11 * V_14 , int V_147 )
{
...
sprintf ( V_71 , L_50 , V_14 -> V_185 -> V_226 ) ;
V_14 -> V_266 = F_81 ( V_264 , V_71 ) ;
if ( F_52 ( V_14 -> V_266 ) ) {
error = F_53 ( V_14 -> V_266 ) ;
F_39 ( V_14 , L_51 , error ) ;
goto V_154;
}
sprintf ( V_71 , L_52 , V_14 -> V_185 -> V_226 ) ;
V_14 -> V_267 = F_81 ( V_264 , V_71 ) ;
if ( F_52 ( V_14 -> V_267 ) ) {
error = F_53 ( V_14 -> V_267 ) ;
F_39 ( V_14 , L_53 , error ) ;
goto V_268;
}
F_88 ( V_264 ) ;
V_264 = NULL ;
V_190 = F_61 ( V_14 -> V_266 ) ;
...
V_190 = F_61 ( V_14 -> V_267 ) ;
error = F_69 ( V_190 -> V_219 , V_151 , 0 ,
& V_14 -> V_271 ) ;
if ( error ) {
F_39 ( V_14 , L_55 , error ) ;
goto V_272;
}
return 0 ;
V_265:
...
static int F_94 ( struct V_11 * V_14 , int V_147 )
{
struct V_273 * V_92 ;
int error = 0 ;
if ( V_147 )
goto V_274;
V_92 = F_95 ( V_275 , V_14 , L_56 ) ;
if ( F_52 ( V_92 ) ) {
error = F_53 ( V_92 ) ;
F_39 ( V_14 , L_57 , error ) ;
return error ;
}
V_14 -> V_276 = V_92 ;
V_92 = F_95 ( V_277 , V_14 , L_58 ) ;
if ( F_52 ( V_92 ) ) {
error = F_53 ( V_92 ) ;
F_39 ( V_14 , L_59 , error ) ;
goto V_154;
}
V_14 -> V_278 = V_92 ;
return 0 ;
...
static int F_97 ( struct V_11 * V_14 , int V_55 )
{
const struct V_279 * V_280 ;
struct V_281 * V_282 = & V_14 -> V_210 ;
struct V_283 * args = & V_14 -> V_138 ;
...
V_175 = V_280 -> V_301 ( V_14 , V_137 ) ;
if ( V_175 == 0 )
F_65 ( V_14 , L_67 ) ;
F_103 ( & V_14 -> V_25 ) ;
return V_175 ;
}
void F_104 ( struct V_11 * V_14 )
{
const struct V_279 * V_280 = V_14 -> V_210 . V_211 ;
if ( F_105 ( ! F_106 ( V_302 , & V_14 -> V_21 ) ) &&
V_280 -> V_303 )
V_280 -> V_303 ( V_14 ) ;
}
...
static int F_110 ( struct V_11 * V_14 )
{
if ( V_14 -> V_210 . V_211 -> V_301 == NULL )
return 0 ;
return F_111 ( & V_14 -> V_21 , V_20 , F_107 , V_307 ) ;
}
void F_112 ( struct V_11 * V_14 )
{
struct V_12 * V_13 = V_14 -> V_17 ;
char V_308 [ 20 ] ;
char V_309 [ 20 ] ;
char * V_209 [] = { V_308 , V_309 , NULL } ;
sprintf ( V_308 , L_68 , ( V_13 -> V_310 & V_311 ) ? 1 : 0 ) ;
sprintf ( V_309 , L_69 , V_14 -> V_138 . V_241 ? 1 : 0 ) ;
F_66 ( & V_14 -> V_213 , V_312 , V_209 ) ;
}
static int F_113 ( struct V_12 * V_13 , struct V_283 * args , int V_55 )
{
struct V_11 * V_14 ;
struct V_145 V_146 ;
int error ;
...
V_13 -> V_326 = V_327 ;
V_13 -> V_328 = & V_329 ;
F_114 ( V_13 ) -> V_330 |= V_331 ;
V_13 -> V_332 = 1 ;
V_13 -> V_333 = V_334 ;
V_14 -> V_57 . V_80 = F_115 ( V_13 , V_335 ) ;
V_14 -> V_57 . V_81 = V_13 -> V_336 ;
V_14 -> V_110 = V_14 -> V_57 . V_81 -
V_111 ;
V_14 -> V_112 = 1 << V_14 -> V_110 ;
V_14 -> V_22 . V_337 = V_14 -> V_138 . V_338 ;
V_14 -> V_22 . V_339 = V_14 -> V_138 . V_340 ;
if ( V_14 -> V_138 . V_341 ) {
V_14 -> V_22 . V_342 = 0 ;
V_14 -> V_22 . V_343 = V_14 -> V_138 . V_341 ;
} else {
V_14 -> V_22 . V_342 = 1 ;
V_14 -> V_22 . V_343 = 30 ;
}
...
snprintf ( V_14 -> V_344 , V_143 , L_71 , V_14 -> V_144 ) ;
error = F_117 ( V_14 ) ;
if ( error )
return error ;
F_118 ( V_14 ) ;
error = F_97 ( V_14 , V_55 ) ;
if ( error )
goto V_345;
...
if ( error )
goto V_348;
if ( V_14 -> V_210 . V_246 < 0 ) {
error = V_14 -> V_210 . V_246 ;
V_14 -> V_210 . V_246 = 0 ;
goto V_348;
}
if ( V_14 -> V_138 . V_241 )
snprintf ( V_14 -> V_344 , V_143 , L_72 ,
V_14 -> V_144 ) ;
else
snprintf ( V_14 -> V_344 , V_143 , L_73 ,
V_14 -> V_144 , V_14 -> V_210 . V_246 ) ;
error = F_89 ( V_14 , DO ) ;
if ( error )
goto V_348;
error = F_93 ( V_14 , DO ) ;
...
static int F_124 ( struct V_12 * V_72 , void * V_352 )
{
V_72 -> V_98 = V_352 ;
...
static int F_126 ( struct V_12 * V_72 , void * V_357 )
{
...
char V_378 [ V_379 ] ;
V_72 -> V_380 = V_363 ;
F_44 ( V_72 -> V_141 , F_133 ( V_359 , V_378 ) , sizeof( V_72 -> V_141 ) ) ;
F_57 ( V_72 , F_134 ( V_359 ) ) ;
error = F_113 ( V_72 , & args , V_330 & V_381 ? 1 : 0 ) ;
if ( error )
goto V_377;
V_72 -> V_310 |= V_382 ;
V_359 -> V_383 = V_72 ;
...
static int F_137 ( struct V_12 * V_72 , void * V_357 )
{
return - V_63 ;
}
static struct V_168 * F_138 ( struct V_360 * V_361 ,
...
struct V_384 V_384 ;
int error ;
error = F_139 ( V_362 , V_385 , & V_384 ) ;
if ( error ) {
F_15 ( V_62 L_77 ,
V_362 , error ) ;
return F_136 ( error ) ;
}
V_72 = F_130 ( & V_386 , F_126 , F_137 , V_330 ,
V_384 . V_168 -> V_236 -> V_387 -> V_98 ) ;
F_140 ( & V_384 ) ;
if ( F_52 ( V_72 ) ) {
F_15 ( V_62 L_78 ) ;
return F_129 ( V_72 ) ;
