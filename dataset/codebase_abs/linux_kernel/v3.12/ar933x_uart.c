...
{
struct V_2 * V_3 = (struct V_2 * ) V_5 ;
unsigned long V_20 ;
unsigned int V_15 ;
F_14 ( & V_3 -> V_5 . V_21 , V_20 ) ;
V_15 = F_3 ( V_3 , V_18 ) ;
F_15 ( & V_3 -> V_5 . V_21 , V_20 ) ;
return ( V_15 & V_17 ) ? 0 : V_22 ;
}
static unsigned int F_16 ( struct V_19 * V_5 )
{
return V_23 ;
}
static void F_17 ( struct V_19 * V_5 , unsigned int V_24 )
{
}
static void F_18 ( struct V_19 * V_5 )
{
struct V_2 * V_3 = (struct V_2 * ) V_5 ;
F_10 ( V_3 ) ;
}
...
static void F_21 ( struct V_19 * V_5 , int V_26 )
{
struct V_2 * V_3 = (struct V_2 * ) V_5 ;
unsigned long V_20 ;
F_14 ( & V_3 -> V_5 . V_21 , V_20 ) ;
...
static void F_22 ( struct V_19 * V_5 )
{
}
