...
{
int V_4 , V_13 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_4 ( V_9 ) ;
if ( V_2 -> V_14 ) {
...
int F_50 ( struct V_1 * V_2 , struct V_8 * V_9 )
{
int V_15 , V_44 = 0 ;
if ( ! V_66 ) {
V_15 = F_40 () ;
...
V_2 -> V_9 = F_51 ( sizeof( struct V_8 ) , V_73 ) ;
if ( ! V_2 -> V_9 )
return - V_72 ;
V_2 -> V_9 -> V_74 = V_9 ;
V_2 -> V_9 -> V_75 = V_66 ;
V_2 -> V_9 -> V_76 = F_47 ;
V_2 -> V_49 = V_2 -> V_49 ? V_2 -> V_49 : F_8 ( V_9 ) ;
F_52 ( V_2 -> V_9 , L_13 , V_2 -> V_49 ) ;
if ( V_2 -> V_16 ) {
char V_12 [ 10 ] ;
char * V_77 ;
struct V_22 * V_23 ;
V_2 -> V_78 = F_51 ( sizeof( struct V_22 ) *
V_2 -> V_16 , V_73 ) ;
if ( ! V_2 -> V_78 ) {
V_15 = - V_72 ;
goto V_79;
...
V_23 = & V_2 -> V_78 [ V_44 ] ;
snprintf ( V_12 , 10 , L_14 , V_44 ) ;
V_77 = F_51 ( sizeof( char ) * ( strlen ( V_12 ) + 1 ) ,
V_73 ) ;
if ( ! V_77 ) {
...
F_53 ( & V_23 -> V_24 . V_11 ) ;
V_23 -> V_24 . V_11 . V_49 = L_15 ;
V_23 -> V_24 . V_11 . V_83 = 0444 ;
V_23 -> V_24 . V_84 = F_9 ;
F_53 ( & V_23 -> V_26 . V_11 ) ;
V_23 -> V_26 . V_11 . V_49 = L_16 ;
...
;
V_2 -> V_85 = F_51 ( sizeof( struct V_86 * ) *
( V_44 + 1 ) , V_73 ) ;
if ( ! V_2 -> V_85 ) {
V_15 = - V_72 ;
goto V_87;
}
V_2 -> V_88 = F_51 ( sizeof( struct V_10 ) *
V_44 , V_73 ) ;
if ( ! V_2 -> V_88 ) {
V_15 = - V_72 ;
F_48 ( V_2 -> V_85 ) ;
...
V_49 = F_51 ( sizeof( char ) * ( strlen ( V_12 ) + 1 ) ,
V_73 ) ;
if ( ! V_49 ) {
for ( V_44 -- ; V_44 >= 0 ; V_44 -- ) {
F_48 ( V_2 -> V_88 [ V_44 ] . V_11 .
V_49 ) ;
}
F_48 ( V_2 -> V_88 ) ;
F_48 ( V_2 -> V_85 ) ;
...
if ( V_2 -> V_16 && V_2 -> V_5 ) {
for ( V_44 = 0 ; V_2 -> V_5 [ V_44 ] ; V_44 ++ )
F_48 ( V_2 -> V_88 [ V_44 ] . V_11 . V_49 ) ;
F_48 ( V_2 -> V_88 ) ;
F_48 ( V_2 -> V_85 ) ;
}
V_87:
for ( V_44 = 0 ; V_44 < V_2 -> V_16 ; V_44 ++ )
F_48 ( V_2 -> V_78 [ V_44 ] . V_80 . V_49 ) ;
V_81:
if ( V_2 -> V_16 )
F_48 ( V_2 -> V_78 ) ;
V_79:
