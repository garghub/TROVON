...
return F_7 ( & V_18 , & V_14 , 1 , V_10 , & V_12 , 0 ) ;
}
...
struct V_17 V_18 = { . V_19 = 0 , . V_8 = V_8 } ;
return F_7 ( & V_18 , & V_14 , 1 , V_10 , & V_12 , 1 ) ;
}
static int F_9 ( struct V_20 * V_20 , struct V_8 * V_8 )
{
T_1 V_5 = V_20 -> V_21 -> V_22 ;
struct V_1 * V_23 = NULL , * V_12 ;
int V_24 ;
F_10 ( & V_25 ) ;
F_11 (pos, cuse_conntbl_head(devt), list)
if ( V_12 -> V_22 -> V_5 == V_5 ) {
F_12 ( & V_12 -> V_3 ) ;
V_23 = V_12 ;
break;
}
...
if ( ! V_23 )
return - V_26 ;
V_24 = F_14 ( & V_23 -> V_3 , 0 , V_8 , 0 ) ;
if ( V_24 )
F_15 ( & V_23 -> V_3 ) ;
return V_24 ;
}
static int F_16 ( struct V_20 * V_20 , struct V_8 * V_8 )
{
...
static long F_18 ( struct V_8 * V_8 , unsigned int V_31 ,
unsigned long V_32 )
{
struct V_27 * V_28 = V_8 -> V_29 ;
...
if ( V_23 -> V_34 )
V_33 |= V_35 ;
return F_19 ( V_8 , V_31 , V_32 , V_33 ) ;
}
static long F_20 ( struct V_8 * V_8 , unsigned int V_31 ,
unsigned long V_32 )
{
struct V_27 * V_28 = V_8 -> V_29 ;
struct V_1 * V_23 = F_1 ( V_28 -> V_3 ) ;
...
if ( ! strcmp ( F_39 ( V_12 -> V_22 ) , F_39 ( V_22 ) ) )
goto V_79;
}
V_24 = F_40 ( V_22 ) ;
if ( V_24 )
...
static int F_59 ( struct V_20 * V_20 , struct V_8 * V_8 )
{
struct V_1 * V_23 ;
int V_24 ;
...
static int F_62 ( struct V_20 * V_20 , struct V_8 * V_8 )
{
struct V_1 * V_23 = F_1 ( V_8 -> V_29 ) ;
int V_24 ;
F_10 ( & V_25 ) ;
F_63 ( & V_23 -> V_85 ) ;
F_13 ( & V_25 ) ;
...
static T_2 F_66 ( struct V_52 * V_22 ,
struct V_108 * V_109 , char * V_9 )
{
struct V_1 * V_23 = F_67 ( V_22 ) ;
return sprintf ( V_9 , L_9 , F_68 ( & V_23 -> V_3 . V_110 ) ) ;
}
