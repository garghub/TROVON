...
memcpy ( F_36 ( V_23 , V_15 - V_70 ) , V_70 , V_15 - V_70 ) ;
F_7 ( V_78 , L_38 , V_23 -> V_57 ,
V_23 -> V_11 ) ;
{
F_37 ( V_23 ) -> V_94 = V_95 ;
F_37 ( V_23 ) -> V_96 = F_38 ( V_3 ) -> F_39 ( V_3 ) ;
V_71 . V_32 = V_33 ;
V_71 . V_97 = F_38 ( V_3 ) -> F_40 ( V_3 ) ;
memcpy ( & ( V_71 . V_34 ) , V_68 , 8 ) ;
V_72 . V_97 = F_38 ( V_3 ) -> F_40 ( V_3 ) ;
if ( F_41 ( V_69 ) ) {
V_72 . V_32 = V_35 ;
V_72 . V_36 = V_98 ;
} else {
...
return F_42 ( V_23 , V_1 ( V_3 ) -> V_100 ,
...
static int F_49 ( struct V_22 * V_23 , struct V_66 * V_67 )
{
struct V_22 * V_109 ;
int V_104 = V_105 ;
V_109 = F_50 ( V_23 , sizeof( struct V_66 ) , F_51 ( V_23 ) ,
V_107 ) ;
F_52 ( V_23 ) ;
if ( ! V_109 )
return - V_108 ;
F_36 ( V_109 , sizeof( struct V_66 ) ) ;
F_53 ( V_109 ) ;
F_54 ( V_109 , V_67 , sizeof( struct V_66 ) ) ;
...
static void F_55 ( unsigned long V_113 )
{
...
static struct V_114 *
F_59 ( struct V_22 * V_23 , T_2 V_11 , T_2 V_115 )
{
struct V_114 * V_117 ;
V_117 = F_60 ( sizeof( struct V_114 ) ,
V_107 ) ;
if ( ! V_117 )
goto V_118;
F_61 ( & V_117 -> V_116 ) ;
V_117 -> V_119 = V_11 ;
V_117 -> V_115 = V_115 ;
V_117 -> V_23 = F_62 ( V_23 -> V_3 , V_117 -> V_119 +
sizeof( struct V_66 ) ) ;
if ( ! V_117 -> V_23 )
goto V_120;
V_117 -> V_23 -> V_81 = V_23 -> V_81 ;
V_117 -> V_23 -> V_3 = V_23 -> V_3 ;
F_63 ( V_117 -> V_23 , sizeof( struct V_66 ) ) ;
F_64 ( V_117 -> V_23 , V_117 -> V_119 ) ;
memcpy ( V_117 -> V_23 -> V_121 , V_23 -> V_121 , sizeof( V_23 -> V_121 ) ) ;
F_65 ( & V_117 -> V_122 ) ;
V_117 -> V_122 . V_123 = V_124 + V_125 ;
V_117 -> V_122 . V_57 = ( unsigned long ) V_117 ;
V_117 -> V_122 . V_126 = F_55 ;
F_66 ( & V_117 -> V_122 ) ;
F_67 ( & V_117 -> V_116 , & V_127 ) ;
return V_117 ;
V_120:
F_58 ( V_117 ) ;
V_118:
...
F_69 ( & V_137 ) ;
F_70 (frame, &lowpan_fragments, list)
...
F_5 ( L_45
L_46 , V_78 , V_115 ) ;
V_117 = F_59 ( V_23 , V_11 , V_115 ) ;
if ( ! V_117 )
goto V_136;
}
if ( F_71 ( ( V_134 * 8 + V_23 -> V_11 ) <= V_117 -> V_119 ) )
F_72 ( V_117 -> V_23 , V_134 * 8 ,
V_23 -> V_57 , V_23 -> V_11 ) ;
else
goto V_136;
...
if ( F_25 ( V_23 , & V_46 ) )
goto V_129;
V_109 = F_50 ( V_23 , sizeof( struct V_45 ) ,
F_51 ( V_23 ) , V_107 ) ;
F_52 ( V_23 ) ;
if ( ! V_109 )
return - V_108 ;
V_23 = V_109 ;
F_36 ( V_23 , sizeof( struct V_45 ) ) ;
F_75 ( V_23 ) ;
F_54 ( V_23 , & V_46 , sizeof( struct V_45 ) ) ;
F_7 ( V_78 , L_56 ,
...
static int
F_80 ( struct V_22 * V_23 , T_1 * V_70 ,
...
V_152 = F_81 ( V_153 + V_150 + V_151 + V_157 ) ;
if ( ! V_152 )
return - V_108 ;
V_152 -> V_81 = V_23 -> V_81 ;
V_152 -> V_3 = V_23 -> V_3 ;
memcpy ( F_64 ( V_152 , V_150 ) , V_23 -> V_57 , V_150 ) ;
memcpy ( F_64 ( V_152 , V_153 ) , V_70 , V_153 ) ;
if ( V_151 )
F_82 ( V_23 , V_134 + V_150 ,
F_64 ( V_152 , V_151 ) , V_151 ) ;
...
static int
F_84 ( struct V_22 * V_23 , struct V_2 * V_3 )
{
int V_59 , V_158 , V_159 , V_115 , V_134 = 0 ;
T_1 V_70 [ 5 ] ;
V_158 = F_79 ( V_23 ) ;
V_159 = V_23 -> V_11 - V_158 ;
V_115 = V_1 ( V_3 ) -> V_160 ++ ;
V_70 [ 0 ] = V_131 | ( ( V_159 >> 8 ) & 0x7 ) ;
V_70 [ 1 ] = V_159 & 0xff ;
V_70 [ 2 ] = V_115 >> 8 ;
V_70 [ 3 ] = V_115 & 0xff ;
V_59 = F_80 ( V_23 , V_70 , V_158 , V_161 ,
0 , V_131 ) ;
if ( V_59 ) {
F_5 ( L_63 ,
V_78 , V_115 ) ;
...
V_70 [ 0 ] &= ~ V_131 ;
V_70 [ 0 ] |= V_132 ;
while ( ( V_159 - V_134 > 0 ) && ( V_59 >= 0 ) ) {
int V_11 = V_161 ;
V_70 [ 4 ] = V_134 / 8 ;
if ( V_159 - V_134 < V_11 )
V_11 = V_159 - V_134 ;
V_59 = F_80 ( V_23 , V_70 , V_158 ,
V_11 , V_134 , V_132 ) ;
if ( V_59 ) {
F_5 ( L_64
...
static T_3 F_85 ( struct V_22 * V_23 , struct V_2 * V_3 )
{
int V_59 = - 1 ;
F_5 ( L_66 ) ;
...
static struct V_165 * F_86 ( const struct V_2 * V_3 )
{
struct V_2 * V_100 = V_1 ( V_3 ) -> V_100 ;
return F_38 ( V_100 ) -> F_87 ( V_100 ) ;
}
static T_2 F_88 ( const struct V_2 * V_3 )
{
struct V_2 * V_100 = V_1 ( V_3 ) -> V_100 ;
return F_38 ( V_100 ) -> F_40 ( V_100 ) ;
}
static T_2 F_89 ( const struct V_2 * V_3 )
{
struct V_2 * V_100 = V_1 ( V_3 ) -> V_100 ;
return F_38 ( V_100 ) -> F_90 ( V_100 ) ;
}
static T_1 F_91 ( const struct V_2 * V_3 )
{
struct V_2 * V_100 = V_1 ( V_3 ) -> V_100 ;
return F_38 ( V_100 ) -> F_39 ( V_100 ) ;
}
...
static int F_93 ( struct V_183 * V_184 [] , struct V_183 * V_57 [] )
{
if ( V_184 [ V_185 ] ) {
if ( F_94 ( V_184 [ V_185 ] ) != V_7 )
return - V_37 ;
}
return 0 ;
}
static int F_95 ( struct V_22 * V_23 , struct V_2 * V_3 ,
...
static int F_98 ( struct V_193 * V_194 , struct V_2 * V_3 ,
...
if ( ! V_184 [ V_195 ] )
return - V_37 ;
V_100 = F_99 ( V_194 , F_100 ( V_184 [ V_195 ] ) ) ;
if ( ! V_100 )
return - V_196 ;
if ( V_100 -> type != V_167 )
return - V_37 ;
...
V_1 ( V_3 ) -> V_160 = 0 ;
F_101 ( & V_1 ( V_3 ) -> V_197 ) ;
V_102 = F_60 ( sizeof( struct V_101 ) , V_198 ) ;
if ( ! V_102 ) {
F_102 ( V_100 ) ;
V_1 ( V_3 ) -> V_100 = NULL ;
return - V_108 ;
...
F_103 ( & V_1 ( V_3 ) -> V_197 ) ;
F_61 ( & V_102 -> V_116 ) ;
F_67 ( & V_102 -> V_116 , & V_199 ) ;
F_104 ( & V_1 ( V_3 ) -> V_197 ) ;
F_105 ( V_3 ) ;
return 0 ;
}
static void F_106 ( struct V_2 * V_3 , struct V_200 * V_70 )
{
...
F_107 () ;
F_103 ( & V_1 ( V_3 ) -> V_197 ) ;
F_108 (entry, tmp, &lowpan_devices, list) {
if ( V_102 -> V_106 == V_3 ) {
F_56 ( & V_102 -> V_116 ) ;
F_58 ( V_102 ) ;
}
...
static inline int T_4 F_111 ( void )
{
return F_112 ( & V_202 ) ;
}
static inline void F_113 ( void )
{
F_114 ( & V_202 ) ;
}
...
F_124 ( & V_211 ) ;
F_69 ( & V_137 ) ;
F_108 (frame, tframe, &lowpan_fragments, list) {
F_73 ( & V_117 -> V_122 ) ;
F_56 ( & V_117 -> V_116 ) ;
F_57 ( V_117 -> V_23 ) ;
F_58 ( V_117 ) ;
