...
static T_1 * F_86 ( struct V_8 * V_8 )
{
T_1 * V_215 = NULL ;
int V_2 ;
...
static unsigned int
F_92 ( const struct V_58 * V_221 )
{
if ( V_221 -> V_74 == 4096 && V_221 -> V_70 == 2160 )
return V_221 -> clock ;
return F_87 ( V_221 ) ;
}
static T_1 F_93 ( const struct V_58 * V_217 )
{
T_1 V_68 ;
if ( ! V_217 -> clock )
return 0 ;
for ( V_68 = 0 ; V_68 < F_24 ( V_222 ) ; V_68 ++ ) {
const struct V_58 * V_221 = & V_222 [ V_68 ] ;
unsigned int V_219 , V_220 ;
V_219 = V_221 -> clock ;
V_220 = F_92 ( V_221 ) ;
if ( ( F_90 ( V_217 -> clock ) == F_90 ( V_219 ) ||
...
static int
F_94 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
struct V_75 * V_50 = V_39 -> V_50 ;
struct V_58 * V_68 , * V_223 ;
F_95 ( V_224 ) ;
int V_179 = 0 ;
if ( ! F_86 ( V_8 ) )
return 0 ;
F_51 (mode, &connector->probed_modes, head) {
const struct V_58 * V_216 = NULL ;
struct V_58 * V_180 ;
T_1 V_225 = F_89 ( V_68 ) - 1 ;
unsigned int V_219 , V_220 ;
if ( V_225 < F_24 ( V_218 ) ) {
V_216 = & V_218 [ V_225 ] ;
V_220 = F_87 ( V_216 ) ;
...
static int
F_98 ( struct V_38 * V_39 , const T_1 * V_226 , T_1 V_21 )
{
struct V_75 * V_50 = V_39 -> V_50 ;
const T_1 * V_68 ;
T_1 V_216 ;
int V_179 = 0 ;
for ( V_68 = V_226 ; V_68 < V_226 + V_21 ; V_68 ++ ) {
V_216 = ( * V_68 & 127 ) - 1 ;
if ( V_216 < F_24 ( V_218 ) ) {
struct V_58 * V_180 ;
V_180 = F_35 ( V_50 ,
...
static int
F_99 ( struct V_38 * V_39 , const T_1 * V_226 , T_1 V_21 )
{
struct V_75 * V_50 = V_39 -> V_50 ;
int V_179 = 0 , V_227 = 0 , V_2 ;
T_1 V_228 ;
if ( V_21 < 8 )
goto V_47;
if ( ! ( V_226 [ 8 ] & ( 1 << 5 ) ) )
...
if ( V_21 < ( 8 + V_227 ) )
goto V_47;
V_228 = V_226 [ 8 + V_227 ] >> 5 ;
for ( V_2 = 0 ; V_2 < V_228 && V_21 >= ( 9 + V_227 + V_2 ) ; V_2 ++ ) {
struct V_58 * V_180 ;
T_1 V_229 ;
V_229 = V_226 [ 9 + V_227 + V_2 ] ;
V_229 -- ;
if ( V_229 >= F_24 ( V_222 ) ) {
F_5 ( L_14 , V_229 ) ;
continue;
}
V_180 = F_35 ( V_50 , & V_222 [ V_229 ] ) ;
if ( ! V_180 )
continue;
F_69 ( V_39 , V_180 ) ;
V_179 ++ ;
...
static int
F_100 ( const T_1 * V_226 )
{
return V_226 [ 0 ] & 0x1f ;
}
static int
F_101 ( const T_1 * V_226 )
{
return V_226 [ 0 ] >> 5 ;
}
static int
F_102 ( const T_1 * V_230 )
{
return V_230 [ 1 ] ;
}
static int
F_103 ( const T_1 * V_230 , int * V_22 , int * V_231 )
{
* V_22 = 4 ;
* V_231 = V_230 [ 2 ] ;
if ( * V_231 == 0 )
* V_231 = 127 ;
if ( * V_231 < 4 || * V_231 > 127 )
return - V_232 ;
return 0 ;
}
static bool F_104 ( const T_1 * V_226 )
{
int V_233 ;
if ( F_101 ( V_226 ) != V_234 )
return false ;
if ( F_100 ( V_226 ) < 5 )
return false ;
V_233 = V_226 [ 1 ] | ( V_226 [ 2 ] << 8 ) | ( V_226 [ 3 ] << 16 ) ;
return V_233 == V_235 ;
}
static int
F_105 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
const T_1 * V_230 = F_86 ( V_8 ) ;
const T_1 * V_226 ;
T_1 V_236 ;
int V_179 = 0 ;
if ( V_230 && F_102 ( V_230 ) >= 3 ) {
int V_2 , V_22 , V_231 ;
if ( F_103 ( V_230 , & V_22 , & V_231 ) )
return 0 ;
F_106 (cea, i, start, end) {
V_226 = & V_230 [ V_2 ] ;
V_236 = F_100 ( V_226 ) ;
if ( F_101 ( V_226 ) == V_237 )
V_179 += F_98 ( V_39 , V_226 + 1 , V_236 ) ;
else if ( F_104 ( V_226 ) )
V_179 += F_99 ( V_39 , V_226 , V_236 ) ;
}
}
return V_179 ;
}
static void
F_107 ( struct V_38 * V_39 , const T_1 * V_226 )
{
T_1 V_21 = F_100 ( V_226 ) ;
if ( V_21 >= 6 ) {
V_39 -> V_238 [ 5 ] |= ( V_226 [ 6 ] >> 7 ) << 1 ;
V_39 -> V_239 = V_226 [ 6 ] & 1 ;
}
if ( V_21 >= 7 )
V_39 -> V_240 = V_226 [ 7 ] * 5 ;
if ( V_21 >= 8 ) {
V_39 -> V_241 [ 0 ] = V_226 [ 8 ] >> 7 ;
V_39 -> V_241 [ 1 ] = ( V_226 [ 8 ] >> 6 ) & 1 ;
}
if ( V_21 >= 9 )
V_39 -> V_242 [ 0 ] = V_226 [ 9 ] ;
if ( V_21 >= 10 )
V_39 -> V_243 [ 0 ] = V_226 [ 10 ] ;
if ( V_21 >= 11 )
V_39 -> V_242 [ 1 ] = V_226 [ 11 ] ;
if ( V_21 >= 12 )
V_39 -> V_243 [ 1 ] = V_226 [ 12 ] ;
F_11 ( L_15
L_16
L_17
L_18
...
static void
F_108 ( struct V_88 * V_59 , void * V_93 )
{
if ( V_59 -> V_93 . V_186 . type == V_244 )
* ( T_1 * * ) V_93 = V_59 -> V_93 . V_186 . V_93 . V_245 . V_245 ;
}
void F_109 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
T_4 * V_238 = V_39 -> V_238 ;
T_1 * V_230 ;
T_1 * V_35 ;
T_1 * V_226 ;
int V_246 = 0 ;
int V_247 ;
int V_236 ;
memset ( V_238 , 0 , sizeof( V_39 -> V_238 ) ) ;
V_230 = F_86 ( V_8 ) ;
if ( ! V_230 ) {
F_11 ( L_20 ) ;
return;
...
V_35 = NULL ;
F_39 ( ( T_1 * ) V_8 , F_108 , & V_35 ) ;
for ( V_247 = 0 ; V_35 && V_247 < 13 ; V_247 ++ ) {
if ( V_35 [ V_247 ] == 0x0a )
break;
V_238 [ 20 + V_247 ] = V_35 [ V_247 ] ;
}
V_238 [ 4 ] = ( V_230 [ 1 ] << 5 ) | V_247 ;
F_11 ( L_21 , V_238 + 20 ) ;
V_238 [ 0 ] = 2 << 3 ;
V_238 [ 16 ] = V_8 -> V_52 [ 0 ] ;
V_238 [ 17 ] = V_8 -> V_52 [ 1 ] ;
V_238 [ 18 ] = V_8 -> V_248 [ 0 ] ;
V_238 [ 19 ] = V_8 -> V_248 [ 1 ] ;
if ( F_102 ( V_230 ) >= 3 ) {
int V_2 , V_22 , V_231 ;
if ( F_103 ( V_230 , & V_22 , & V_231 ) ) {
V_22 = 0 ;
...
V_246 = V_236 / 3 ;
if ( V_236 >= 1 )
memcpy ( V_238 + 20 + V_247 , & V_226 [ 1 ] , V_236 ) ;
break;
case V_250 :
if ( V_236 >= 1 )
V_238 [ 7 ] = V_226 [ 1 ] ;
...
V_238 [ 5 ] |= V_246 << 4 ;
V_238 [ 2 ] = ( 20 + V_247 + V_246 * 3 + 3 ) / 4 ;
F_11 ( L_22 , ( int ) V_238 [ 2 ] , V_246 ) ;
}
int F_110 ( struct V_8 * V_8 , struct V_251 * * V_252 )
{
int V_253 = 0 ;
int V_2 , V_22 , V_231 , V_236 ;
T_1 * V_230 ;
V_230 = F_86 ( V_8 ) ;
if ( ! V_230 ) {
F_11 ( L_23 ) ;
...
F_106 (cea, i, start, end) {
T_1 * V_226 = & V_230 [ V_2 ] ;
if ( F_101 ( V_226 ) == V_249 ) {
int V_40 ;
V_236 = F_100 ( V_226 ) ;
V_253 = V_236 / 3 ;
* V_252 = F_111 ( V_253 , sizeof( * * V_252 ) , V_46 ) ;
if ( ! * V_252 )
return - V_257 ;
for ( V_40 = 0 ; V_40 < V_253 ; V_40 ++ ) {
T_1 * V_258 = & V_226 [ 1 + V_40 * 3 ] ;
( * V_252 ) [ V_40 ] . V_259 = ( V_258 [ 0 ] & 0x78 ) >> 3 ;
( * V_252 ) [ V_40 ] . V_260 = V_258 [ 0 ] & 0x7 ;
( * V_252 ) [ V_40 ] . V_261 = V_258 [ 1 ] & 0x7F ;
( * V_252 ) [ V_40 ] . V_262 = V_258 [ 2 ] ;
}
break;
}
}
...
int F_112 ( struct V_8 * V_8 , T_1 * * V_263 )
{
int V_253 = 0 ;
int V_2 , V_22 , V_231 , V_236 ;
const T_1 * V_230 ;
...
F_106 (cea, i, start, end) {
const T_1 * V_226 = & V_230 [ V_2 ] ;
if ( F_101 ( V_226 ) == V_250 ) {
V_236 = F_100 ( V_226 ) ;
if ( V_236 == 3 ) {
* V_263 = F_15 ( V_236 , V_46 ) ;
if ( ! * V_263 )
return - V_257 ;
memcpy ( * V_263 , & V_226 [ 1 ] , V_236 ) ;
V_253 = V_236 ;
break;
}
}
...
if ( ! V_39 -> V_241 [ 1 ] )
V_2 = 0 ;
V_104 = V_39 -> V_243 [ V_2 ] ;
V_264 = V_39 -> V_242 [ V_2 ] ;
if ( V_104 == 255 || V_264 == 255 )
return 0 ;
if ( V_104 )
V_104 = F_38 ( 2 * ( V_104 - 1 ) , 500 ) ;
if ( V_264 )
V_264 = F_38 ( 2 * ( V_264 - 1 ) , 500 ) ;
return F_114 ( V_264 - V_104 , 0 ) ;
}
struct V_38 * F_115 ( struct V_265 * V_266 ,
struct V_58 * V_68 )
{
struct V_38 * V_39 ;
struct V_75 * V_50 = V_266 -> V_50 ;
F_51 (connector, &dev->mode_config.connector_list, head)
if ( V_39 -> V_266 == V_266 && V_39 -> V_238 [ 0 ] )
return V_39 ;
return NULL ;
}
bool F_116 ( struct V_8 * V_8 )
{
T_1 * V_215 ;
int V_2 ;
int V_267 , V_268 ;
...
if ( ! V_215 )
return false ;
if ( F_103 ( V_215 , & V_267 , & V_268 ) )
return false ;
F_106 (edid_ext, i, start_offset, end_offset) {
if ( F_104 ( & V_215 [ V_2 ] ) )
return true ;
}
return false ;
}
bool F_117 ( struct V_8 * V_8 )
{
T_1 * V_215 ;
int V_2 , V_40 ;
bool V_269 = false ;
...
goto V_231;
F_106 (edid_ext, i, start_offset, end_offset) {
if ( F_101 ( & V_215 [ V_2 ] ) == V_249 ) {
V_269 = true ;
for ( V_40 = 1 ; V_40 < F_100 ( & V_215 [ V_2 ] ) + 1 ; V_40 += 3 )
F_11 ( L_27 ,
...
if ( ! V_215 )
return false ;
if ( F_103 ( V_215 , & V_22 , & V_231 ) )
return false ;
F_106 (edid_ext, i, start, end) {
if ( F_101 ( & V_215 [ V_2 ] ) == V_271 &&
F_100 ( & V_215 [ V_2 ] ) == 2 ) {
F_11 ( L_28 , V_215 [ V_2 + 2 ] ) ;
return V_215 [ V_2 + 2 ] & V_272 ;
}
}
return false ;
}
...
{
T_1 * V_215 ;
V_274 -> V_160 = V_8 -> V_167 * 10 ;
V_274 -> V_163 = V_8 -> V_168 * 10 ;
V_274 -> V_275 = 0 ;
V_274 -> V_276 = 0 ;
if ( V_8 -> V_13 < 3 )
return;
...
int F_120 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
int V_293 = 0 ;
T_2 V_57 ;
if ( V_8 == NULL ) {
...
V_57 = F_23 ( V_8 ) ;
V_293 += F_85 ( V_39 , V_8 , V_57 ) ;
V_293 += F_83 ( V_39 , V_8 ) ;
V_293 += F_80 ( V_39 , V_8 ) ;
V_293 += F_78 ( V_39 , V_8 ) ;
if ( V_8 -> V_98 & V_99 )
V_293 += F_75 ( V_39 , V_8 ) ;
V_293 += F_105 ( V_39 , V_8 ) ;
V_293 += F_94 ( V_39 , V_8 ) ;
if ( V_57 & ( V_64 | V_65 ) )
F_26 ( V_39 , V_57 ) ;
F_119 ( V_8 , & V_39 -> V_294 ) ;
return V_293 ;
}
int F_121 ( struct V_38 * V_39 ,
int V_70 , int V_74 )
{
int V_2 , V_253 , V_293 = 0 ;
struct V_58 * V_68 ;
struct V_75 * V_50 = V_39 -> V_50 ;
V_253 = sizeof( V_80 ) / sizeof( struct V_58 ) ;
if ( V_70 < 0 )
V_70 = 0 ;
if ( V_74 < 0 )
V_74 = 0 ;
...
if ( V_68 -> V_31 & V_299 )
V_296 -> V_300 = 1 ;
V_296 -> V_301 = F_89 ( V_68 ) ;
V_296 -> V_302 = V_303 ;
V_296 -> V_304 = V_305 ;
return 0 ;
}
int
F_124 ( struct V_306 * V_296 ,
const struct V_58 * V_68 )
{
int V_297 ;
T_1 V_229 ;
