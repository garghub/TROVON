...
{
struct V_69 * V_38 = F_49 ( & V_46 -> V_47 ) ;
struct V_233 * V_234 = V_46 -> V_47 . V_235 ;
struct V_43 * V_44 ;
struct V_236 * V_237 ;
int V_70 = 0 ;
int V_45 ;
...
if ( F_50 ( V_46 -> V_239 , V_240 ) == 0 ) {
F_22 ( & V_46 -> V_47 , L_40 ) ;
V_45 = - V_241 ;
goto free;
}
V_3 = F_51 ( & V_46 -> V_47 , sizeof( struct V_242 ) ,
V_243 ) ;
if ( ! V_3 ) {
V_45 = - V_48 ;
goto free;
...
if ( F_2 () ) {
F_55 ( V_232 -> V_36 ) ;
V_70 = F_56 ( & V_46 -> V_47 , V_46 -> V_253 ) ;
} else {
V_70 = F_57 ( & V_46 -> V_47 , V_46 -> V_253 ) ;
}
if ( V_70 < 0 ) {
V_45 = V_70 ;
goto V_24;
...
if ( F_2 () ) {
T_1 V_254 ;
F_18 ( V_21 , & V_254 , V_255 ) ;
V_254 &= ~ ( V_256 | V_257 | \
V_258 | V_259 ) ;
F_12 ( V_21 , V_254 , V_255 ) ;
}
if ( V_234 )
V_45 = F_58 ( V_234 , NULL , NULL , & V_46 -> V_47 ) ;
else
