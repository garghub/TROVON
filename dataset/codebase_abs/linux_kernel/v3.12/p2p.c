...
static bool
F_61 ( struct V_47 * V_48 , T_2 * V_224 )
{
...
T_4 V_234 ;
T_2 V_7 ;
V_169 . V_73 = F_63 ( V_230 -> V_69 ) ;
V_107 -> V_153 . V_219 ( & V_169 ) ;
F_5 ( V_65 , L_64 , V_41 -> V_53 -> V_235 ) ;
V_234 = ( V_236 & V_237 ) >> 4 ;
if ( ( V_41 -> V_53 -> V_235 & F_64 ( V_234 ) ) == 0 )
return 0 ;
F_4 ( false , V_1 , V_227 ) ;
V_7 = V_238 ;
if ( F_1 ( V_1 , V_227 ) ) {
...
V_7 = V_15 -> V_25 ;
if ( ( V_7 == V_26 ) &&
( F_61 ( V_48 , ( T_2 * ) V_183 -> V_239 ) ) ) {
if ( F_19 ( V_199 ,
& V_48 -> V_80 ) &&
( memcmp ( V_160 -> V_217 , V_183 -> V_239 ,
V_46 ) == 0 ) ) {
...
static T_3 F_70 ( struct V_47 * V_48 ,
struct V_256 * V_257 )
{
struct V_75 * V_53 ;
T_3 V_133 = 0 ;
...
static T_3 F_71 ( struct V_132 * V_107 ,
struct V_256 * V_257 ,
struct V_263 * V_264 )
{
struct V_47 * V_48 = & V_107 -> V_48 ;
...
bool F_72 ( struct V_132 * V_107 ,
struct V_134 * V_277 ,
struct V_256 * V_257 )
{
struct V_47 * V_48 = & V_107 -> V_48 ;
struct V_40 * V_41 = F_73 ( V_277 ) ;
struct V_265 * V_266 ;
struct V_263 V_264 ;
struct V_160 * V_160 = & V_48 -> V_160 ;
T_4 V_278 ;
...
V_107 -> V_153 . V_219 ( & V_169 ) ;
if ( F_19 ( V_199 , & V_48 -> V_80 ) &&
( memcmp ( V_160 -> V_217 , V_183 -> V_239 , V_46 ) == 0 ) ) {
V_160 -> V_203 = V_169 . V_171 ;
F_5 ( V_65 , L_84 ,
V_160 -> V_203 ) ;
F_43 ( & V_160 -> V_200 ) ;
...
V_248 :
V_249 ) ;
F_68 ( & V_53 -> V_139 , V_233 , 0 , V_232 , V_227 , 0 ,
V_250 ) ;
F_5 ( V_65 , L_87 ,
V_227 , V_183 -> V_228 , V_69 , V_233 ) ;
return 0 ;
}
T_3 F_78 ( struct V_132 * V_107 )
{
struct V_40 * V_50 ;
struct V_40 * V_292 ;
struct V_75 * V_293 ;
...
F_81 ( V_292 -> V_277 , F_82 ( V_107 -> V_159 ) ) ;
...
F_85 ( & V_48 -> V_255 ) ;
F_86 ( & V_48 -> V_160 . V_195 , F_47 ) ;
F_85 ( & V_48 -> V_160 . V_200 ) ;
F_85 ( & V_48 -> V_189 ) ;
}
exit:
return V_133 ;
...
F_60 ( V_107 , V_53 -> V_41 , true , true ) ;
V_53 = V_48 -> V_51 [ V_138 ] . V_53 ;
if ( ! V_53 ) {
F_10 ( L_93 ) ;
return - V_78 ;
...
static int F_93 ( struct V_75 * V_53 )
{
struct V_132 * V_107 = F_94 ( & V_53 -> V_139 ) ;
struct V_134 * V_314 = F_95 ( V_107 ) ;
struct V_40 * V_41 = F_73 ( V_314 ) ;
T_2 * V_239 = V_53 -> V_139 . V_140 -> V_49 ;
return F_9 ( V_41 , L_98 , V_239 , V_46 ) ;
}
static int F_96 ( struct V_75 * V_53 )
{
struct V_132 * V_107 = F_94 ( & V_53 -> V_139 ) ;
struct V_134 * V_314 = F_95 ( V_107 ) ;
struct V_40 * V_41 = F_73 ( V_314 ) ;
...
static struct V_177 * F_97 ( struct V_47 * V_48 ,
struct V_159 * V_159 ,
T_2 * V_239 )
{
struct V_75 * V_293 ;
...
F_11 ( V_48 , V_239 ) ;
F_6 ( V_50 , V_48 -> V_49 ) ;
F_90 ( V_48 -> V_107 , V_293 ) ;
V_133 = F_8 ( V_50 , L_29 , 1 ) ;
if ( V_133 < 0 ) {
F_10 ( L_32 ) ;
F_90 ( V_48 -> V_107 , NULL ) ;
goto V_316;
}
V_133 = F_91 ( V_48 -> V_107 , V_317 ,
F_52 ( 1500 ) ) ;
F_90 ( V_48 -> V_107 , NULL ) ;
if ( ! V_133 ) {
F_10 ( L_100 ) ;
...
return & V_293 -> V_139 ;
V_316:
F_83 ( V_48 -> V_107 , V_293 ) ;
return F_98 ( V_133 ) ;
}
static void F_100 ( struct V_132 * V_107 ,
struct V_75 * V_53 )
{
F_101 ( & V_53 -> V_139 ) ;
...
static void F_102 ( struct V_134 * V_277 )
{
struct V_132 * V_107 ;
struct V_75 * V_53 ;
struct V_40 * V_41 ;
V_41 = F_73 ( V_277 ) ;
V_107 = V_41 -> V_185 -> V_186 ;
V_53 = V_41 -> V_53 ;
F_83 ( V_107 , V_53 ) ;
F_103 ( V_41 -> V_277 ) ;
}
struct V_177 * F_104 ( struct V_159 * V_159 , const char * V_319 ,
enum V_320 type , T_1 * V_150 ,
struct V_321 * V_322 )
{
struct V_132 * V_107 = F_34 ( V_159 ) ;
struct V_40 * V_41 = F_73 ( F_95 ( V_107 ) ) ;
struct V_75 * V_53 ;
enum V_305 V_313 ;
enum V_323 V_146 ;
int V_133 ;
...
break;
case V_298 :
return F_97 ( & V_107 -> V_48 , V_159 ,
V_322 -> V_330 ) ;
default:
return F_98 ( - V_331 ) ;
}
V_53 = F_79 ( V_107 , type , false ) ;
if ( F_80 ( V_53 ) )
return (struct V_177 * ) V_53 ;
F_90 ( V_107 , V_53 ) ;
V_133 = F_92 ( & V_107 -> V_48 , V_41 , V_107 -> V_48 . V_56 ,
V_313 ) ;
if ( V_133 ) {
F_90 ( V_107 , NULL ) ;
goto V_316;
}
V_133 = F_91 ( V_107 , V_317 ,
F_52 ( 1500 ) ) ;
F_90 ( V_107 , NULL ) ;
if ( ! V_133 ) {
F_10 ( L_100 ) ;
