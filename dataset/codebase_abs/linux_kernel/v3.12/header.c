...
static int F_143 ( int V_5 , struct V_1 * T_7 , int type ,
struct V_207 * * V_94 ,
struct V_83 * V_84 )
{
int V_15 ;
...
if ( F_143 ( V_5 , V_2 , V_3 , & V_94 , V_84 ) )
F_3 ( V_2 , V_3 ) ;
}
...
int F_142 ( struct V_1 * V_2 , int V_5 ,
void * V_208 ,
int (* F_151)( struct V_207 * T_12 ,
struct V_1 * V_19 ,
int V_3 , int V_5 , void * V_208 ) )
{
...
V_15 = F_149 ( V_2 , V_5 , V_223 , V_224 ) ;
if ( V_15 < 0 )
goto V_74;
F_146 (feat, header->adds_features, HEADER_LAST_FEATURE) {
V_15 = F_151 ( V_242 ++ , V_2 , V_3 , V_5 , V_208 ) ;
if ( V_15 < 0 )
goto V_74;
}
V_15 = 0 ;
...
static int F_152 ( T_9 V_243 , struct V_1 * V_19 )
{
T_9 V_244 , V_240 ;
int V_24 ;
...
static int F_155 ( V_113 V_230 , T_9 V_243 ,
...
if ( V_19 -> V_21 ) {
F_150 ( V_2 , F_157 ( struct V_233 ,
V_4 ) ) ;
}
if ( V_2 -> V_7 != sizeof( * V_2 ) ) {
if ( V_2 -> V_7 == F_157 ( F_158 ( * V_2 ) , V_4 ) )
F_159 ( V_2 -> V_4 , V_226 ) ;
else
return - 1 ;
} else if ( V_19 -> V_21 ) {
...
static int F_163 ( struct V_207 * T_12 ,
struct V_1 * V_19 ,
int V_3 , int V_5 , void * V_208 )
{
if ( F_79 ( V_5 , T_12 -> V_144 , V_147 ) == ( T_10 ) - 1 ) {
...
if ( ! V_218 [ V_3 ] . F_151 )
return 0 ;
return V_218 [ V_3 ] . F_151 ( T_12 , V_19 , V_5 , V_208 ) ;
}
static int F_164 ( struct V_228 * V_2 ,
struct V_1 * V_19 , int V_5 ,
bool V_255 )
{
int V_8 ;
...
if ( V_8 <= 0 )
return - 1 ;
if ( F_155 ( V_2 -> V_230 , V_2 -> V_7 , true , V_19 ) < 0 ) {
F_31 ( L_92 ) ;
return - 1 ;
}
if ( V_19 -> V_21 )
...
static int F_165 ( struct V_56 * V_57 )
{
struct V_1 * V_2 = & V_57 -> V_2 ;
struct V_228 V_229 ;
if ( F_164 ( & V_229 , V_2 , V_57 -> V_5 ,
V_57 -> V_255 ) < 0 ) {
F_31 ( L_93 ) ;
return - V_257 ;
}
...
static int F_166 ( int V_5 , struct V_1 * V_19 ,
struct V_234 * V_235 )
{
...
static int F_167 ( struct V_105 * V_106 ,
struct V_263 * V_263 )
{
struct V_264 * V_209 ;
char V_10 [ 128 ] ;
...
V_209 = F_168 ( V_263 , V_106 -> V_110 . V_173 ) ;
if ( V_209 == NULL )
return - 1 ;
if ( ! V_106 -> V_28 ) {
...
static int F_169 ( struct V_83 * V_84 ,
struct V_263 * V_263 )
{
struct V_105 * V_42 ;
...
int F_170 ( struct V_56 * V_57 )
{
struct V_1 * V_2 = & V_57 -> V_2 ;
struct V_233 V_229 ;
struct V_234 V_235 ;
V_113 V_267 ;
int V_268 , V_269 , V_24 , V_140 ;
int V_5 = V_57 -> V_5 ;
V_57 -> V_84 = F_171 () ;
if ( V_57 -> V_84 == NULL )
return - V_27 ;
...
V_268 = V_229 . V_241 . V_7 / V_229 . V_240 ;
F_79 ( V_5 , V_229 . V_241 . V_144 , V_147 ) ;
for ( V_24 = 0 ; V_24 < V_268 ; V_24 ++ ) {
struct V_105 * V_106 ;
T_10 V_185 ;
if ( F_166 ( V_5 , V_2 , & V_235 ) < 0 )
goto V_271;
if ( V_2 -> V_21 )
F_97 ( & V_235 . V_110 ) ;
V_185 = F_79 ( V_5 , 0 , V_145 ) ;
V_106 = F_172 ( & V_235 . V_110 , V_24 ) ;
if ( V_106 == NULL )
goto V_272;
V_106 -> V_21 = V_2 -> V_21 ;
F_173 ( V_57 -> V_84 , V_106 ) ;
V_269 = V_235 . V_111 . V_7 / sizeof( V_113 ) ;
if ( F_174 ( V_106 , 1 , V_269 ) )
goto V_272;
F_79 ( V_5 , V_235 . V_111 . V_144 , V_147 ) ;
for ( V_140 = 0 ; V_140 < V_269 ; V_140 ++ ) {
if ( F_149 ( V_2 , V_5 , & V_267 , sizeof( V_267 ) ) )
goto V_271;
F_175 ( V_57 -> V_84 , V_106 , 0 , V_140 , V_267 ) ;
}
F_79 ( V_5 , V_185 , V_147 ) ;
}
V_72 . V_273 = V_268 ;
F_142 ( V_2 , V_5 , & V_57 -> V_263 ,
F_163 ) ;
if ( F_169 ( V_57 -> V_84 ,
V_57 -> V_263 ) )
goto V_272;
...
if ( V_277 == NULL )
return - V_27 ;
V_277 -> V_110 . V_110 = * V_110 ;
memcpy ( V_277 -> V_110 . V_112 , V_112 , V_111 * sizeof( V_113 ) ) ;
V_277 -> V_110 . V_2 . type = V_278 ;
V_277 -> V_110 . V_2 . V_7 = ( T_6 ) V_7 ;
if ( V_277 -> V_110 . V_2 . V_7 == V_7 )
V_15 = F_151 ( V_275 , V_277 , NULL , NULL ) ;
else
V_15 = - V_279 ;
free ( V_277 ) ;
return V_15 ;
}
int F_178 ( struct V_274 * V_275 ,
struct V_56 * V_57 ,
T_13 F_151 )
{
struct V_105 * V_106 ;
int V_15 = 0 ;
F_66 (evsel, &session->evlist->entries, node) {
V_15 = F_177 ( V_275 , & V_106 -> V_110 , V_106 -> V_111 ,
V_106 -> V_112 , F_151 ) ;
if ( V_15 ) {
F_31 ( L_101 ) ;
return V_15 ;
...
int F_179 ( struct V_274 * V_275 V_82 ,
union V_276 * V_209 ,
struct V_83 * * V_280 )
{
T_2 V_24 , V_111 , V_281 ;
struct V_105 * V_106 ;
struct V_83 * V_84 = * V_280 ;
if ( V_84 == NULL ) {
* V_280 = V_84 = F_171 () ;
if ( V_84 == NULL )
return - V_27 ;
}
V_106 = F_172 ( & V_209 -> V_110 . V_110 , V_84 -> V_109 ) ;
if ( V_106 == NULL )
return - V_27 ;
F_173 ( V_84 , V_106 ) ;
V_111 = V_209 -> V_2 . V_7 ;
V_111 -= ( void * ) & V_209 -> V_110 . V_112 - ( void * ) V_209 ;
V_281 = V_111 / sizeof( V_113 ) ;
if ( F_174 ( V_106 , 1 , V_281 ) )
return - V_27 ;
for ( V_24 = 0 ; V_24 < V_281 ; V_24 ++ ) {
F_175 ( V_84 , V_106 , 0 , V_24 , V_209 -> V_110 . V_112 [ V_24 ] ) ;
}
V_72 . V_273 = V_84 -> V_109 ;
return 0 ;
}
int F_180 ( struct V_274 * V_275 , int V_5 ,
struct V_83 * V_84 ,
T_13 F_151 )
{
union V_276 V_277 ;
struct V_282 * V_283 ;
T_3 V_7 = 0 , V_284 = 0 , V_285 ;
int V_15 V_82 = 0 ;
V_283 = F_181 ( & V_84 -> V_85 , V_5 , true ) ;
if ( ! V_283 )
return - 1 ;
memset ( & V_277 , 0 , sizeof( V_277 ) ) ;
V_277 . V_282 . V_2 . type = V_286 ;
V_7 = V_283 -> V_7 ;
V_284 = F_11 ( V_7 , sizeof( V_113 ) ) ;
V_285 = V_284 - V_7 ;
V_277 . V_282 . V_2 . V_7 = sizeof( V_277 . V_282 ) ;
V_277 . V_282 . V_7 = V_284 ;
F_151 ( V_275 , & V_277 , NULL , NULL ) ;
F_182 ( V_283 ) ;
F_9 ( V_5 , NULL , 0 , V_285 ) ;
return V_284 ;
}
int F_183 ( struct V_274 * V_275 V_82 ,
union V_276 * V_209 ,
struct V_56 * V_57 )
{
T_3 V_287 , V_285 , V_7 = V_209 -> V_282 . V_7 ;
T_10 V_144 = F_79 ( V_57 -> V_5 , 0 , V_145 ) ;
char V_6 [ V_288 ] ;
F_79 ( V_57 -> V_5 , V_144 + sizeof( struct V_289 ) ,
V_147 ) ;
V_287 = F_115 ( V_57 -> V_5 , & V_57 -> V_263 ,
V_57 -> V_255 ) ;
V_285 = F_11 ( V_287 , sizeof( V_113 ) ) - V_287 ;
if ( F_13 ( V_57 -> V_5 , V_6 , V_285 ) < 0 ) {
F_184 ( L_102 , V_290 ) ;
return - 1 ;
}
if ( V_57 -> V_255 ) {
int V_291 = F_8 ( V_256 , V_6 , V_285 ) ;
if ( V_291 <= 0 || V_291 != V_285 ) {
F_184 ( L_103 , V_290 ) ;
return - 1 ;
}
}
...
V_17 = V_42 -> V_47 + 1 ;
V_17 = F_11 ( V_17 , V_14 ) ;
memcpy ( & V_277 . V_30 . V_30 , V_42 -> V_30 , sizeof( V_42 -> V_30 ) ) ;
V_277 . V_30 . V_2 . type = V_292 ;
V_277 . V_30 . V_2 . V_32 = V_32 ;
V_277 . V_30 . V_31 = V_38 -> V_31 ;
V_277 . V_30 . V_2 . V_7 = sizeof( V_277 . V_30 ) + V_17 ;
memcpy ( & V_277 . V_30 . V_68 , V_42 -> V_46 , V_42 -> V_47 ) ;
V_15 = F_151 ( V_275 , & V_277 , NULL , V_38 ) ;
return V_15 ;
}
int F_186 ( struct V_274 * V_275 V_82 ,
union V_276 * V_209 ,
struct V_56 * V_57 )
{
F_107 ( & V_209 -> V_30 ,
