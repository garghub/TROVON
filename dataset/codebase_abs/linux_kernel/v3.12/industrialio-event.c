...
static T_3 F_28 ( struct V_39 * V_40 ,
struct V_41 * V_42 ,
char * V_24 )
{
struct V_1 * V_2 = F_24 ( V_40 ) ;
...
static T_3 F_29 ( struct V_39 * V_40 ,
struct V_41 * V_42 ,
const char * V_24 ,
T_5 V_43 )
{
...
if ( ! V_54 -> V_59 )
return 0 ;
F_32 (i, &chan->event_mask, sizeof(chan->event_mask)*8 ) {
V_58 = F_33 ( V_60 , L_3 ,
V_61 [ V_55 / V_62 ] ,
V_63 [ V_55 % V_62 ] ) ;
if ( V_58 == NULL ) {
...
if ( V_54 -> V_66 )
V_57 = F_34 ( V_54 -> type , 0 , V_54 -> V_67 ,
V_55 / V_62 ,
V_55 % V_62 ) ;
else if ( V_54 -> V_68 )
V_57 = F_35 ( V_54 -> type ,
