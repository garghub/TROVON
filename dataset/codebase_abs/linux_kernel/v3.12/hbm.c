...
struct V_41 * V_42 = & V_2 -> V_43 . V_44 ;
struct V_56 * V_57 ;
const T_2 V_18 = sizeof( struct V_56 ) ;
F_17 ( V_42 , V_18 ) ;
V_57 = (struct V_56 * ) V_2 -> V_43 . V_47 ;
memset ( V_57 , 0 , V_18 ) ;
V_57 -> V_16 = V_58 ;
if ( F_18 ( V_2 , V_42 , V_2 -> V_43 . V_47 ) ) {
V_2 -> V_12 = V_13 ;
...
struct V_41 * V_42 = & V_2 -> V_43 . V_44 ;
struct V_60 * V_61 ;
const T_2 V_18 = sizeof( struct V_60 ) ;
unsigned long V_62 ;
unsigned long V_63 ;
V_63 = V_2 -> V_7 ;
...
V_2 -> V_9 [ V_63 ] . V_68 = V_62 ;
V_2 -> V_9 [ V_63 ] . V_69 = 0 ;
F_17 ( V_42 , V_18 ) ;
V_61 = (struct V_60 * ) V_2 -> V_43 . V_47 ;
...
memcpy ( V_2 -> V_64 , V_115 -> V_128 , 32 ) ;
if ( V_2 -> V_12 == V_122 &&
V_2 -> V_34 == V_59 ) {
V_2 -> V_54 = 0 ;
F_1 ( V_2 ) ;
