...
{
char V_65 [ 255 ] = { 0 } ;
struct V_8 V_22 = { sizeof( V_65 ) , V_65 } ;
...
if ( V_69 )
F_5 ( L_9 ) ;
while ( ( V_49 = F_24 ( V_71 << 8 , V_49 ) ) != NULL ) {
V_68 ++ ;
V_57 = F_17 ( V_49 ) ;
if ( V_57 & V_59 )
V_66 |= 1 ;
...
static int F_31 ( T_1 V_77 , T_5 * V_78 ,
int V_79 , int V_80 )
{
T_4 V_56 ;
union V_13 V_81 [ 2 ] , * V_15 ;
struct V_11 V_82 ;
struct V_8 V_22 = { V_10 , NULL } ;
V_82 . V_19 = 2 ;
V_82 . V_20 = & V_81 [ 0 ] ;
V_81 [ 0 ] . type = V_25 ;
V_81 [ 0 ] . integer . V_26 = V_79 ;
V_81 [ 1 ] . type = V_25 ;
V_81 [ 1 ] . integer . V_26 = V_80 ;
V_56 = F_4 ( V_77 , NULL , & V_82 , & V_22 ) ;
if ( F_20 ( V_56 ) ) {
F_5 ( V_27 L_12 , F_32 ( V_56 ) ) ;
return - V_28 ;
}
...
if ( ! V_46 )
return false ;
V_56 = F_19 ( V_46 , L_13 , & V_77 ) ;
if ( F_20 ( V_56 ) )
return false ;
V_1 . V_77 = V_77 ;
return true ;
}
int F_34 ( T_5 * V_78 , int V_79 , int V_80 )
{
return F_31 ( V_1 . V_77 , V_78 , V_79 , V_80 ) ;
}
void *
F_35 ( struct V_83 * V_58 , struct V_84 * V_85 )
{
struct V_86 * V_87 ;
T_1 V_4 ;
int type , V_70 ;
...
if ( V_70 )
return NULL ;
V_70 = F_37 ( V_87 , type , - 1 , & V_88 ) ;
if ( V_70 < 0 )
return NULL ;
return F_38 ( V_88 , V_93 , V_94 ) ;
}
