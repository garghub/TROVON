...
static void F_68 ( unsigned long V_102 )
{
struct V_15 * V_16 = (struct V_15 * ) V_102 ;
struct V_1 * V_2 = F_36 ( V_16 ) ;
T_1 V_116 ;
...
struct V_15 * V_16 ;
struct V_1 * V_2 ;
struct V_162 * V_163 = F_98 ( & V_159 -> V_58 ) ;
T_1 V_164 ;
unsigned V_35 ;
V_161 = F_99 ( V_159 , V_165 , 0 ) ;
if ( ! F_100 ( V_161 -> V_166 , F_101 ( V_161 ) , V_148 ) )
goto V_167;
V_16 = F_102 ( sizeof( struct V_1 ) ) ;
if ( ! V_16 )
goto V_168;
F_103 ( V_16 , & V_159 -> V_58 ) ;
V_2 = F_36 ( V_16 ) ;
V_2 -> V_16 = V_16 ;
F_104 ( & V_2 -> V_149 , F_93 ) ;
V_2 -> V_3 = F_105 ( V_161 -> V_166 , F_101 ( V_161 ) ) ;
V_2 -> V_11 = V_161 -> V_44 ;
if ( ! V_2 -> V_3 )
goto V_169;
V_2 -> V_126 = F_106 ( V_159 , 0 ) ;
if ( V_2 -> V_126 < 0 ) {
V_95 = V_2 -> V_126 ;
goto V_170;
}
V_2 -> V_58 = ( V_159 -> V_58 . V_171 ) ? V_159 -> V_58 . V_171 : & V_159 -> V_58 ;
if ( ! ( V_2 -> V_11 & V_12 ) && V_163 &&
( V_163 -> V_172 != - 1 ) &&
( V_163 -> V_173 != - 1 ) ) {
V_2 -> V_93 . V_143 = V_163 -> V_173 ;
V_2 -> V_51 . V_143 = V_163 -> V_172 ;
} else {
V_2 -> V_93 . V_143 = - 1 ;
V_2 -> V_51 . V_143 = - 1 ;
}
...
if ( V_163 -> V_178 [ V_35 ] != 0 )
break;
if ( V_35 < V_16 -> V_155 )
memcpy ( V_16 -> V_146 , V_163 -> V_178 ,
V_16 -> V_155 ) ;
}
if ( V_35 == V_16 -> V_155 ) {
F_30 ( V_2 , V_16 -> V_146 ) ;
...
F_113 ( V_16 ) ;
V_168:
F_114 ( V_161 -> V_166 , F_101 ( V_161 ) ) ;
V_167:
return V_95 ;
}
static int F_115 ( struct V_158 * V_159 )
{
struct V_15 * V_16 = F_116 ( V_159 ) ;
struct V_1 * V_2 = F_36 ( V_16 ) ;
struct V_160 * V_161 = F_99 ( V_159 , V_165 , 0 ) ;
F_117 ( V_16 ) ;
F_75 ( & V_2 -> V_130 ) ;
F_112 ( V_2 -> V_3 ) ;
F_113 ( V_16 ) ;
