...
static void T_1 F_27 ( int V_1 , int V_2 , int V_3 )
{
T_5 V_45 ;
int V_46 ;
T_2 V_47 ;
T_4 V_21 , V_48 , V_49 ;
V_21 = F_21 ( V_1 , V_2 , V_3 , V_22 ) ;
V_48 = F_21 ( V_1 , V_2 , V_3 ,
V_50 ) ;
V_49 = F_21 ( V_1 , V_2 , V_3 , V_51 ) ;
for ( V_46 = 0 ; V_46 < F_28 ( V_52 ) ; V_46 ++ ) {
if ( V_52 [ V_46 ] . V_21 == V_21 ) {
T_6 V_25 =
( T_6 ) V_52 [ V_46 ] . V_53 ;
V_45 = V_25 ( V_1 , V_2 , V_3 ) ;
V_47 = F_23 ( V_1 , V_2 , V_3 ) ;
if ( V_45 && V_47 ) {
F_29 ( V_47 , V_45 , V_54 ) ;
F_30 ( V_55 . V_56 ,
F_28 ( V_55 . V_56 ) ,
...
static int T_1 F_31 ( int V_1 , int V_2 , int V_3 )
{
T_4 V_58 ;
T_4 V_59 ;
T_4 V_21 ;
T_3 type ;
int V_46 ;
V_58 = F_21 ( V_1 , V_2 , V_3 , V_60 ) ;
if ( V_58 == 0xffff )
return - 1 ;
V_59 = F_21 ( V_1 , V_2 , V_3 , V_61 ) ;
V_21 = F_21 ( V_1 , V_2 , V_3 , V_22 ) ;
for ( V_46 = 0 ; V_62 [ V_46 ] . V_63 != NULL ; V_46 ++ ) {
if ( ( ( V_62 [ V_46 ] . V_59 == V_64 ) ||
( V_62 [ V_46 ] . V_59 == V_59 ) ) &&
( ( V_62 [ V_46 ] . V_21 == V_64 ) ||
( V_62 [ V_46 ] . V_21 == V_21 ) ) &&
( ! ( ( V_62 [ V_46 ] . V_58 ^ V_58 ) &
