...
F_21 ( 2 , L_19 , V_21 , V_5 -> V_74 , V_126 ) ;
switch ( V_126 ) {
case V_129 :
if ( ! F_56 ( V_130 ) )
V_14 = - V_131 ;
...
F_32 ( L_28 , V_21 , V_139 ) ;
return;
}
F_21 ( 2 , L_29 , V_21 , V_203 , V_139 ) ;
V_31 = F_84 ( V_139 + 1 ) ;
if ( ! V_31 ) {
F_32 ( L_30 ,
V_21 ) ;
...
F_99 ( V_34 ) ;
sprintf ( V_238 , L_39 , V_34 -> V_35 . V_37 ) ;
...
F_16 ( L_53 , V_21 , V_8 , V_9 , V_10 , V_11 , V_274 ) ;
...
if ( ! F_127 ( V_265 , V_260 , L_50 ) ||
! F_128 ( V_267 , V_260 , L_50 ) )
V_14 = 0 ;
F_48 ( V_260 , 2 ) ;
}
return V_14 ;
...
if ( ! F_127 ( V_269 , V_260 , L_51 ) ||
! F_128 ( V_270 , V_260 , L_51 ) )
V_14 = 0 ;
F_48 ( V_260 , 2 ) ;
}
return V_14 ;
