...
V_49 = V_60 -> V_67 ;
F_49 ( & V_61 , F_50 ( V_31 ) ,
F_27 ( struct V_30 , V_68 ) ,
( unsigned long ) ( V_31 ) % V_10 ) ;
F_42 ( V_2 , V_48 , & V_49 , & V_61 , V_61 . V_69 , V_58 ) ;
F_51 ( V_2 ) ;
return 0 ;
}
int F_52 ( T_3 * V_70 , T_3 * V_71 , T_2 * V_48 , int V_49 )
{
struct V_1 * V_2 ;
struct V_50 V_72 ;
struct V_50 V_73 ;
...
V_76 = F_55 ( V_2 , V_48 , V_75 ) ;
if ( V_76 ) {
F_44 ( L_10 ) ;
GOTO ( V_78 , V_76 ) ;
}
F_49 ( & V_72 , F_50 ( V_70 ) , 16 ,
( unsigned long ) ( V_70 ) % V_10 ) ;
F_49 ( & V_73 , F_50 ( V_71 ) , 16 ,
( unsigned long ) ( V_71 ) % V_10 ) ;
V_55 . V_2 = V_2 ;
V_55 . V_80 = NULL ;
V_55 . V_57 = 0 ;
V_76 = F_56 ( & V_55 , & V_72 , & V_73 , 16 ) ;
if ( V_76 ) {
F_44 ( L_11 ) ;
GOTO ( V_78 , V_76 ) ;
}
...
int F_58 ( T_3 * V_70 , T_3 * V_71 , T_2 * V_48 , int V_49 )
{
struct V_1 * V_2 ;
struct V_50 V_72 ;
struct V_50 V_73 ;
...
void F_60 ( void * V_31 , struct V_12 * V_13 )
{
F_13 ( & V_13 -> V_81 ) ;
* (struct V_30 * ) V_31 = V_13 -> V_28 ;
F_15 ( & V_13 -> V_81 ) ;
}
void F_61 ( struct V_30 * V_82 ,
struct V_83 * V_84 ,
const char * V_85 , ... )
{
T_4 args ;
va_start ( args , V_85 ) ;
F_62 ( V_84 , V_85 , args ,
L_13 V_86 L_14 V_87 L_15 V_88
L_16 V_88 L_17
L_18 , V_82 , F_63 ( F_64 ( V_82 ) ) , F_65 ( V_82 ) ,
F_66 ( V_82 ) , F_67 ( V_82 ) , F_68 ( V_82 ) ,
F_47 ( V_82 ) , F_69 ( V_82 ) , F_70 ( V_82 ) ,
F_71 ( V_82 ) ) ;
va_end ( args ) ;
}
