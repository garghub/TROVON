...
static T_2 F_26 ( int V_73 , void * V_74 )
{
struct V_1 * V_2 = V_74 ;
...
if ( F_30 ( V_2 ) )
F_29 ( V_2 , F_24 ( V_2 , V_61 ) ) ;
else
F_29 ( V_2 , F_22 ( V_2 , V_61 ) ) ;
V_78:
if ( F_31 ( V_2 , V_71 ) ) {
F_6 ( V_2 , V_24 ) ;
F_20 ( V_2 ) ;
...
F_40 ( V_42 ) ;
if ( V_60 < 0 )
F_13 ( V_42 , L_10 , V_60 , V_2 -> V_69 ) ;
return V_60 ;
}
static T_1 F_41 ( struct V_84 * V_85 )
{
return V_95 | V_96 ;
}
static int F_42 ( struct V_97 * V_98 )
{
struct V_99 * V_100 = F_43 ( & V_98 -> V_42 ) ;
struct V_1 * V_2 ;
struct V_84 * V_85 ;
struct V_101 * V_102 ;
...
T_1 V_40 ;
int V_60 ;
V_2 = F_44 ( V_42 , sizeof( struct V_1 ) , V_103 ) ;
if ( ! V_2 ) {
F_13 ( V_42 , L_11 ) ;
return - V_104 ;
}
...
if ( V_100 && V_100 -> V_40 )
V_40 = V_100 -> V_40 ;
V_2 -> V_52 = F_45 ( V_98 ) -> V_105 ;
V_60 = F_11 ( V_2 , V_40 , V_42 ) ;
if ( V_60 < 0 )
return V_60 ;
V_102 = F_46 ( V_98 , V_106 , 0 ) ;
V_2 -> V_5 = F_47 ( V_42 , V_102 ) ;
if ( F_48 ( V_2 -> V_5 ) )
return F_49 ( V_2 -> V_5 ) ;
V_2 -> V_73 = F_50 ( V_98 , 0 ) ;
F_51 ( & V_2 -> V_82 ) ;
F_52 ( & V_2 -> V_75 ) ;
V_85 = & V_2 -> V_85 ;
V_85 -> V_107 = V_98 -> V_108 ;
V_85 -> V_109 = & V_110 ;
V_85 -> V_111 = V_112 | V_113 ;
V_85 -> V_114 = 3 ;
V_85 -> V_42 . V_115 = V_42 ;
F_53 ( V_85 , V_2 ) ;
F_54 ( V_85 -> V_116 , V_98 -> V_116 , sizeof( V_85 -> V_116 ) ) ;
V_60 = F_55 ( V_42 , V_2 -> V_73 , F_26 , 0 ,
F_56 ( V_42 ) , V_2 ) ;
if ( V_60 < 0 ) {
F_13 ( V_42 , L_12 , V_2 -> V_73 ) ;
return V_60 ;
}
V_60 = F_57 ( V_85 ) ;
if ( V_60 < 0 ) {
