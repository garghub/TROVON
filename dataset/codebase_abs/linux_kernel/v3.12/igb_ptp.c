...
struct V_14 V_15 ;
V_4 -> V_38 . V_70 ( & V_4 -> V_38 , & V_15 ) ;
F_36 ( L_2 , V_15 . V_18 , V_15 . V_19 ) ;
F_37 ( & V_4 -> V_69 ,
V_71 ) ;
}
void F_38 ( struct V_3 * V_13 )
{
struct V_5 * V_6 = & V_13 -> V_6 ;
struct V_72 * V_73 ;
T_3 V_74 = F_3 ( V_75 ) ;
...
V_76 = V_13 -> V_79 ;
for ( V_77 = 0 ; V_77 < V_13 -> V_81 ; V_77 ++ ) {
V_73 = V_13 -> V_73 [ V_77 ] ;
...
{
T_6 * V_87 = ( T_6 * ) V_92 ;
F_8 ( V_91 -> V_13 , F_42 ( V_94 ) ,
F_43 ( V_87 [ 1 ] ) ) ;
}
void F_44 ( struct V_90 * V_91 ,
struct V_93 * V_94 )
{
struct V_3 * V_13 = V_91 -> V_13 ;
struct V_5 * V_6 = & V_13 -> V_6 ;
T_2 V_87 ;
if ( ! ( F_3 ( V_75 ) & V_78 ) )
return;
...
{
struct V_5 * V_6 = & V_13 -> V_6 ;
struct V_96 * V_97 = V_13 -> V_97 ;
switch ( V_6 -> V_25 . type ) {
case V_26 :
snprintf ( V_13 -> V_38 . V_155 , 16 , L_4 , V_97 -> V_156 ) ;
V_13 -> V_38 . V_157 = V_158 ;
V_13 -> V_38 . V_159 = 999999881 ;
V_13 -> V_38 . V_160 = 0 ;
V_13 -> V_38 . V_161 = 0 ;
V_13 -> V_38 . V_162 = F_14 ;
V_13 -> V_38 . V_163 = F_17 ;
V_13 -> V_38 . V_70 = F_23 ;
V_13 -> V_38 . V_164 = F_26 ;
V_13 -> V_38 . V_165 = F_28 ;
V_13 -> V_2 . V_166 = F_1 ;
V_13 -> V_2 . V_167 = F_57 ( 64 ) ;
V_13 -> V_2 . V_168 = 1 ;
V_13 -> V_2 . V_169 = V_42 ;
F_7 ( V_43 , V_44 | V_170 ) ;
break;
...
snprintf ( V_13 -> V_38 . V_155 , 16 , L_4 , V_97 -> V_156 ) ;
V_13 -> V_38 . V_157 = V_158 ;
V_13 -> V_38 . V_159 = 62499999 ;
V_13 -> V_38 . V_160 = 0 ;
V_13 -> V_38 . V_161 = 0 ;
V_13 -> V_38 . V_162 = F_16 ;
V_13 -> V_38 . V_163 = F_17 ;
V_13 -> V_38 . V_70 = F_23 ;
V_13 -> V_38 . V_164 = F_26 ;
V_13 -> V_38 . V_165 = F_28 ;
V_13 -> V_2 . V_166 = F_4 ;
V_13 -> V_2 . V_167 = F_57 ( V_171 ) ;
V_13 -> V_2 . V_168 = 1 ;
V_13 -> V_2 . V_169 = 0 ;
F_7 ( V_172 , 0x0 ) ;
break;
...
V_13 -> V_38 . V_161 = 0 ;
V_13 -> V_38 . V_162 = F_16 ;
V_13 -> V_38 . V_163 = F_20 ;
V_13 -> V_38 . V_70 = F_25 ;
V_13 -> V_38 . V_164 = F_27 ;
V_13 -> V_38 . V_165 = F_28 ;
F_7 ( V_172 , 0x0 ) ;
break;
default:
...
V_13 -> V_173 = F_64 ( & V_13 -> V_38 ,
& V_13 -> V_65 -> V_66 ) ;
if ( F_65 ( V_13 -> V_173 ) ) {
V_13 -> V_173 = NULL ;
F_66 ( & V_13 -> V_65 -> V_66 , L_5 ) ;
} else {
F_67 ( & V_13 -> V_65 -> V_66 , L_6 ,
V_13 -> V_97 -> V_155 ) ;
V_13 -> V_23 |= V_178 ;
}
}
...
if ( V_13 -> V_173 ) {
F_71 ( V_13 -> V_173 ) ;
F_67 ( & V_13 -> V_65 -> V_66 , L_7 ,
V_13 -> V_97 -> V_155 ) ;
V_13 -> V_23 &= ~ V_178 ;
}
}
void F_72 ( struct V_3 * V_13 )
{
struct V_5 * V_6 = & V_13 -> V_6 ;
if ( ! ( V_13 -> V_23 & V_178 ) )
return;
