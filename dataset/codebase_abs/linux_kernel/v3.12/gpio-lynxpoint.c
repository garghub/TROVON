...
T_1 V_43 , V_44 , V_45 ;
unsigned long V_4 , V_46 , V_47 ;
unsigned V_48 ;
for ( V_43 = 0 ; V_43 < V_6 -> V_2 . V_25 ; V_43 += 32 ) {
V_4 = F_1 ( & V_6 -> V_2 , V_43 , V_49 ) ;
V_46 = F_1 ( & V_6 -> V_2 , V_43 , V_50 ) ;
while ( ( V_47 = ( F_5 ( V_4 ) & F_5 ( V_46 ) ) ) ) {
V_44 = F_26 ( V_47 ) ;
V_45 = F_6 ( V_44 ) ;
F_8 ( V_45 , V_4 ) ;
V_48 = F_27 ( V_6 -> V_37 , V_43 + V_44 ) ;
F_28 ( V_48 ) ;
}
}
V_2 -> V_51 ( V_41 ) ;
...
static int F_34 ( struct V_52 * V_21 , unsigned int V_48 ,
T_2 V_53 )
{
struct V_5 * V_6 = V_21 -> V_54 ;
F_35 ( V_48 , & V_55 , V_56 ,
L_2 ) ;
F_36 ( V_48 , V_6 ) ;
F_37 ( V_48 , V_57 ) ;
...
static int F_38 ( struct V_58 * V_14 )
{
struct V_5 * V_6 ;
struct V_1 * V_59 ;
struct V_60 * V_61 , * V_62 ;
struct V_63 * V_15 = & V_14 -> V_15 ;
unsigned long V_64 ;
unsigned V_22 ;
int V_65 = - V_18 ;
V_6 = F_39 ( V_15 , sizeof( struct V_5 ) , V_66 ) ;
if ( ! V_6 ) {
F_7 ( V_15 , L_3 ) ;
return - V_67 ;
}
...
V_6 -> V_10 = V_61 -> V_70 ;
V_64 = F_42 ( V_61 ) ;
if ( ! F_43 ( V_15 , V_6 -> V_10 , V_64 , L_5 ) ) {
F_7 ( V_15 , L_6 ,
...
static int F_52 ( struct V_63 * V_15 )
{
return 0 ;
}
