...
char * V_29 ;
V_29 = F_20 ( V_9 , V_26 -> V_10 , L_19 , NULL ) ;
if ( F_21 ( V_29 ) ) {
int V_16 = F_22 ( V_29 ) ;
F_12 ( V_26 , V_16 , L_20 ) ;
return V_16 ;
} else {
if ( F_23 ( V_28 , L_21 , V_29 ) ) {
F_8 ( V_29 ) ;
return - V_19 ;
}
F_8 ( V_29 ) ;
...
if ( ! V_4 || ! V_4 -> V_6 )
return 0 ;
return F_23 ( V_28 , L_22 , V_4 -> V_6 -> V_2 -> V_30 ) ;
}
...
if ( V_4 -> V_6 != NULL )
return;
V_16 = F_24 ( V_9 , V_2 -> V_10 , L_23 , L_24 , & V_31 ) ;
if ( V_16 != 1 ) {
F_12 ( V_2 , V_16 , L_25 ) ;
return;
}
...
* V_44 = ~ 0UL ;
* V_45 = 0 ;
V_50 = F_20 ( V_9 , V_2 -> V_10 , L_30 , NULL ) ;
if ( F_21 ( V_50 ) )
return;
V_46 = V_50 ;
...
char * V_46 , * V_47 , * V_52 ;
int V_53 ;
V_52 = V_46 = F_20 ( V_9 , V_2 -> V_10 , L_32 , NULL ) ;
if ( F_21 ( V_52 ) )
return F_22 ( V_52 ) ;
...
if ( F_21 ( V_62 ) )
return;
if ( V_63 == sizeof( L_33 ) - 1 && ! memcmp ( V_62 , L_33 , V_63 ) ) {
...
V_16 = F_24 ( V_9 , V_2 -> V_39 , L_44 , L_15 ,
& V_73 ) ;
if ( V_16 == - V_55 ) {
V_16 = 0 ;
V_73 = 0 ;
...
V_29 = 0 ;
V_6 -> V_78 = ! ! V_29 ;
if ( F_24 ( V_9 , V_2 -> V_39 , L_47 ,
L_5 , & V_29 ) < 0 )
V_29 = 0 ;
V_6 -> V_79 = ! ! V_29 ;
if ( F_24 ( V_9 , V_2 -> V_39 , L_48 ,
L_5 , & V_29 ) < 0 )
V_29 = 0 ;
V_6 -> V_80 = ! V_29 ;
V_16 = F_48 ( V_6 , V_69 , V_70 ,
V_71 , V_72 ) ;
if ( V_16 ) {
F_12 ( V_2 , V_16 ,
L_49 ,
