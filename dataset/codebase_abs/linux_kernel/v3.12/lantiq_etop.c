...
goto V_139;
F_83 ( V_42 , 1500 ) ;
memcpy ( & V_135 , & V_17 -> V_46 -> V_135 , sizeof( struct V_134 ) ) ;
if ( ! F_93 ( V_135 . V_140 ) ) {
F_94 ( L_14 ) ;
F_95 ( V_135 . V_140 ) ;
V_136 = true ;
}
V_97 = F_87 ( V_42 , & V_135 ) ;
if ( V_97 )
goto V_141;
if ( V_136 )
V_42 -> V_142 = V_143 ;
...
int V_97 ;
int V_43 ;
V_146 = F_101 ( V_103 , V_147 , 0 ) ;
if ( ! V_146 ) {
F_102 ( & V_103 -> V_42 , L_16 ) ;
V_97 = - V_148 ;
goto V_98;
}
V_146 = F_103 ( & V_103 -> V_42 , V_146 -> V_149 ,
F_104 ( V_146 ) , F_56 ( & V_103 -> V_42 ) ) ;
if ( ! V_146 ) {
F_102 ( & V_103 -> V_42 , L_17 ) ;
V_97 = - V_150 ;
goto V_98;
}
V_151 = F_105 ( & V_103 -> V_42 ,
V_146 -> V_149 , F_104 ( V_146 ) ) ;
if ( ! V_151 ) {
