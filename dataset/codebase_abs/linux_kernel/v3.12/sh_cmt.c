...
{
F_46 ( & F_53 ( V_57 ) -> V_25 -> V_26 ) ;
}
static void F_62 ( struct V_79 * V_57 )
{
F_48 ( & F_53 ( V_57 ) -> V_25 -> V_26 ) ;
}
...
static int F_67 ( struct V_4 * V_5 , struct V_98 * V_25 )
{
...
V_100 = F_68 ( V_5 -> V_25 , V_103 , 0 ) ;
if ( ! V_100 ) {
F_25 ( & V_5 -> V_25 -> V_26 , L_10 ) ;
goto V_35;
}
V_101 = F_68 ( V_5 -> V_25 , V_103 , 1 ) ;
V_50 = F_69 ( V_5 -> V_25 , 0 ) ;
if ( V_50 < 0 ) {
F_25 ( & V_5 -> V_25 -> V_26 , L_11 ) ;
goto V_35;
}
V_5 -> V_8 = F_70 ( V_100 -> V_22 , F_71 ( V_100 ) ) ;
if ( V_5 -> V_8 == NULL ) {
F_25 ( & V_5 -> V_25 -> V_26 , L_12 ) ;
goto V_35;
}
V_5 -> V_7 = F_70 ( V_101 ? V_101 -> V_22 :
...
V_5 -> V_105 . V_70 = F_72 ( & V_5 -> V_25 -> V_26 ) ;
V_5 -> V_105 . V_106 = F_35 ;
V_5 -> V_105 . V_51 = V_5 ;
V_5 -> V_105 . V_28 = V_107 | V_108 | \
V_109 | V_110 ;
V_5 -> V_34 = F_73 ( & V_5 -> V_25 -> V_26 , L_14 ) ;
if ( F_74 ( V_5 -> V_34 ) ) {
F_25 ( & V_5 -> V_25 -> V_26 , L_15 ) ;
V_33 = F_75 ( V_5 -> V_34 ) ;
goto V_111;
}
if ( V_101 && ( F_71 ( V_101 ) == 4 ) ) {
V_5 -> V_6 = F_3 ;
V_5 -> V_12 = F_7 ;
} else {
V_5 -> V_6 = F_1 ;
...
V_5 -> V_47 = V_5 -> V_46 ;
F_76 ( & V_5 -> V_49 ) ;
V_33 = F_66 ( V_5 , ( char * ) F_72 ( & V_5 -> V_25 -> V_26 ) ,
V_24 -> V_96 ,
V_24 -> V_97 ) ;
if ( V_33 ) {
...
static int F_81 ( struct V_98 * V_25 )
{
struct V_4 * V_5 = F_82 ( V_25 ) ;
struct V_23 * V_24 = V_25 -> V_26 . V_27 ;
int V_33 ;
if ( ! F_83 ( V_25 ) ) {
F_84 ( & V_25 -> V_26 ) ;
...
static int F_90 ( struct V_98 * V_25 )
{
return - V_115 ;
}
