...
int F_59 ( struct V_74 * V_75 , void * V_76 ,
struct V_77 * V_78 )
{
struct V_95 * V_80 =
(struct V_95 * ) V_76 ;
return F_60 ( F_56 ( V_78 ) -> V_38 ,
V_80 -> V_39 ,
V_96 ) ;
}
...
return F_63 ( V_38 , & V_64 -> V_4 , V_96 , NULL ) ;
}
...
static void F_73 ( struct V_42 * * V_61 )
{
struct V_42 * V_4 = * V_61 ;
struct V_105 * V_101 =
...
F_60 ( V_38 , V_101 -> V_4 . V_70 . V_71 , V_96 ) ;
V_97:
F_16 ( & V_9 ) ;
return V_30 ;
}
int F_75 ( struct V_74 * V_75 , void * V_76 ,
struct V_77 * V_78 )
{
struct V_11 * V_12 = F_54 ( V_75 ) ;
struct V_105 * V_101 ;
...
V_101 -> V_4 . V_38 = NULL ;
V_30 = F_68 ( V_12 , & V_101 -> V_101 , F_70 ) ;
if ( F_31 ( V_30 != 0 ) )
goto V_110;
V_65 = F_2 ( V_9 ) ;
...
if ( V_30 != 0 )
return - V_43 ;
* V_120 = F_57 ( & V_49 -> V_4 . V_92 ) ;
F_13 ( & V_49 ) ;
return 0 ;
}
int F_82 ( struct V_77 * V_78 ,
struct V_74 * V_75 ,
T_1 V_39 )
{
return F_60 ( F_56 ( V_78 ) -> V_38 ,
...
if ( V_9 -> V_21 ) {
F_87 ( & V_9 -> V_21 -> V_4 . V_132 -> V_89 . V_4 ) ;
F_9 ( & V_9 -> V_22 ) ;
F_13 ( & V_9 -> V_21 ) ;
}
V_9 -> V_21 = F_88 ( V_130 ) ;
F_87 ( & V_130 -> V_4 . V_132 -> V_89 . V_4 ) ;
F_85 ( & V_9 -> V_22 , & V_130 -> V_58 ) ;
}
if ( V_130 )
V_9 -> V_35 = V_131 ;
if ( ! V_9 -> V_15 -> V_133 || V_9 -> V_18 == - 1 )
return;
F_5 ( & V_12 -> V_17 ) ;
F_85 ( & V_9 -> V_20 ,
...
F_85 ( & V_25 -> V_139 , & V_138 ) ;
V_30 = F_90 ( V_136 , & V_138 ) ;
if ( F_31 ( V_30 != 0 ) )
goto V_140;
if ( V_9 -> V_15 -> V_128 && F_11 ( & V_9 -> V_22 ) )
return 0 ;
V_26 = V_9 -> V_26 ;
V_30 = F_91 ( & V_9 -> V_21 -> V_4 ,
V_9 -> V_15 -> V_125 ,
true , false ) ;
if ( F_31 ( V_30 != 0 ) )
goto V_141;
...
int F_93 ( struct V_8 * V_9 , bool V_142 )
{
struct V_11 * V_12 = V_9 -> V_12 ;
int V_30 ;
F_5 ( & V_12 -> V_17 ) ;
...
struct V_8 * V_144 ;
struct V_11 * V_12 = V_9 -> V_12 ;
struct V_137 * V_145 = & V_12 -> V_134 [ V_9 -> V_15 -> V_16 ] ;
struct V_24 V_25 ;
...
struct V_150 * V_151 = V_56 -> V_151 ;
struct V_148 * V_152 ;
struct V_11 * V_12 =
F_1 ( V_56 , struct V_11 , V_56 ) ;
if ( V_149 == NULL )
F_99 ( NULL , V_12 , & V_149 , NULL ) ;
else
V_151 -> V_153 ( V_149 ) ;
F_100 ( & V_56 -> V_154 ) ;
V_152 = V_3 -> V_155 ;
...
bool F_104 ( const struct V_8 * V_9 )
{
...
enum V_158 type )
{
struct V_137 * V_145 = & V_12 -> V_134 [ type ] ;
struct V_8 * V_144 ;
do {
F_5 ( & V_12 -> V_17 ) ;
if ( F_11 ( V_145 ) )
