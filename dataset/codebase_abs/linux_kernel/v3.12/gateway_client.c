...
{
struct V_1 * V_8 ;
if ( F_20 ( & V_6 -> V_31 ) != V_32 )
return;
V_8 = F_4 ( V_6 ) ;
if ( ! V_8 )
return;
F_25 ( V_6 , V_33 , V_34 , NULL ) ;
F_1 ( V_8 ) ;
}
void F_26 ( struct V_5 * V_6 )
{
struct V_1 * V_8 = NULL , * V_35 = NULL ;
struct V_17 * V_18 = NULL ;
char V_36 [ 18 ] = { '\0' } ;
if ( F_20 ( & V_6 -> V_31 ) != V_32 )
goto V_9;
V_8 = F_4 ( V_6 ) ;
if ( ! F_27 ( & V_6 -> V_7 . V_16 ) && V_8 )
goto V_9;
V_35 = F_17 ( V_6 ) ;
if ( V_8 == V_35 )
goto V_9;
if ( V_35 ) {
sprintf ( V_36 , L_1 , V_35 -> V_11 -> V_37 ) ;
V_18 = F_19 ( V_35 -> V_11 ) ;
if ( ! V_18 ) {
F_15 ( V_6 ) ;
goto V_9;
...
struct V_1 * V_2 , * V_8 ;
struct V_52 * V_53 ;
unsigned long V_54 = F_38 ( 2 * V_55 ) ;
int V_56 = 0 ;
V_8 = F_4 ( V_6 ) ;
F_11 ( & V_6 -> V_7 . V_15 ) ;
F_39 (gw_node, node_tmp,
&bat_priv->gw.list, list) {
if ( ( ( ! V_2 -> V_27 ) ||
( F_40 ( V_51 , V_2 -> V_27 + V_54 ) ) ) &&
F_20 ( & V_6 -> V_57 ) == V_58 )
continue;
if ( V_8 == V_2 )
V_56 = 1 ;
...
int F_44 ( struct V_59 * V_60 , void * V_66 )
{
struct V_67 * V_64 = (struct V_67 * ) V_60 -> V_68 ;
struct V_5 * V_6 = F_45 ( V_64 ) ;
struct V_69 * V_70 ;
struct V_1 * V_2 ;
int V_71 = 0 ;
V_70 = F_46 ( V_60 ) ;
...
static bool F_49 ( struct V_75 * V_76 , int V_77 )
{
int V_61 = false ;
unsigned char * V_78 ;
int V_79 ;
...
bool F_52 ( struct V_75 * V_76 , unsigned int * V_77 )
{
struct V_83 * V_83 ;
struct V_84 * V_84 ;
struct V_85 * V_85 ;
struct V_86 * V_86 ;
if ( ! F_53 ( V_76 , * V_77 + V_87 ) )
return false ;
V_83 = (struct V_83 * ) V_76 -> V_81 ;
* V_77 += V_87 ;
if ( F_54 ( V_83 -> V_88 ) == V_89 ) {
if ( ! F_53 ( V_76 , * V_77 + V_90 ) )
return false ;
V_83 = (struct V_83 * ) ( V_76 -> V_81 + V_90 ) ;
* V_77 += V_90 ;
}
switch ( F_54 ( V_83 -> V_88 ) ) {
case V_91 :
if ( ! F_53 ( V_76 , * V_77 + sizeof( * V_84 ) ) )
return false ;
...
* V_77 += sizeof( * V_86 ) ;
if ( ( F_54 ( V_83 -> V_88 ) == V_91 ) &&
( F_54 ( V_86 -> V_97 ) != 67 ) )
return false ;
if ( ( F_54 ( V_83 -> V_88 ) == V_95 ) &&
( F_54 ( V_86 -> V_97 ) != 547 ) )
return false ;
return true ;
}
bool F_55 ( struct V_5 * V_6 ,
struct V_75 * V_76 )
{
