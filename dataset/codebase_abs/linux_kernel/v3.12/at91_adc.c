...
if ( ! V_105 )
return - V_68 ;
V_9 -> V_108 = (struct V_109 * )
F_55 ( V_110 , & V_95 -> V_35 ) -> V_111 ;
V_9 -> V_81 = F_56 ( V_105 , L_13 ) ;
if ( F_57 ( V_105 , L_14 , & V_107 ) ) {
F_34 ( & V_6 -> V_35 , L_15 ) ;
V_75 = - V_68 ;
goto V_79;
}
V_9 -> V_34 = V_107 ;
if ( F_57 ( V_105 , L_16 , & V_107 ) ) {
F_34 ( & V_6 -> V_35 , L_17 ) ;
V_75 = - V_68 ;
goto V_79;
}
V_9 -> V_33 = V_107 ;
V_9 -> V_112 = F_56 ( V_105 , L_18 ) ;
if ( F_57 ( V_105 , L_19 , & V_107 ) ) {
F_34 ( & V_6 -> V_35 , L_20 ) ;
V_75 = - V_68 ;
goto V_79;
}
V_9 -> V_113 = V_107 ;
V_107 = 0 ;
F_57 ( V_105 , L_21 , & V_107 ) ;
V_9 -> V_114 = V_107 ;
if ( F_57 ( V_105 , L_22 , & V_107 ) ) {
F_34 ( & V_6 -> V_35 , L_23 ) ;
V_75 = - V_68 ;
goto V_79;
}
...
const char * V_59 ;
if ( F_51 ( V_106 , L_25 , & V_59 ) ) {
F_34 ( & V_6 -> V_35 , L_26 ) ;
V_75 = - V_68 ;
goto V_79;
}
V_18 -> V_59 = V_59 ;
if ( F_57 ( V_106 , L_27 , & V_107 ) ) {
F_34 ( & V_6 -> V_35 , L_28 ) ;
V_75 = - V_68 ;
goto V_79;
}
V_18 -> V_57 = V_107 ;
V_18 -> V_80 = F_56 ( V_106 , L_29 ) ;
V_10 ++ ;
}
return 0 ;
V_79:
...
struct V_94 * V_95 )
{
struct V_115 * V_116 = V_95 -> V_35 . V_117 ;
if ( ! V_116 )
return - V_68 ;
V_9 -> V_81 = V_116 -> V_118 ;
V_9 -> V_92 = V_116 -> V_119 ;
V_9 -> V_34 = V_116 -> V_120 ;
V_9 -> V_33 = V_116 -> V_33 ;
...
{
unsigned int V_121 , V_122 , V_123 , V_124 , V_125 , V_126 ;
int V_75 ;
struct V_5 * V_6 ;
struct V_8 * V_9 ;
struct V_127 * V_46 ;
T_3 V_65 ;
V_6 = F_62 ( & V_95 -> V_35 , sizeof( struct V_8 ) ) ;
if ( ! V_6 )
return - V_37 ;
V_9 = F_2 ( V_6 ) ;
if ( V_95 -> V_35 . V_98 )
...
V_46 = F_66 ( V_95 , V_132 , 0 ) ;
V_9 -> V_133 = F_67 ( & V_95 -> V_35 , V_46 ) ;
if ( F_68 ( V_9 -> V_133 ) ) {
return F_69 ( V_9 -> V_133 ) ;
}
F_27 ( V_9 , V_88 , V_134 ) ;
...
F_10 ,
0 ,
V_95 -> V_35 . V_135 -> V_59 ,
V_6 ) ;
if ( V_75 ) {
F_34 ( & V_95 -> V_35 , L_32 ) ;
return V_75 ;
}
V_9 -> V_136 = F_71 ( & V_95 -> V_35 , L_33 ) ;
if ( F_68 ( V_9 -> V_136 ) ) {
F_34 ( & V_95 -> V_35 , L_34 ) ;
V_75 = F_69 ( V_9 -> V_136 ) ;
goto V_137;
...
V_122 = F_73 ( V_9 -> V_136 ) ;
V_124 = F_73 ( V_9 -> V_124 ) ;
V_125 = V_124 / 1000 ;
...
V_123 = F_74 ( ( V_9 -> V_113 * V_125 /
1000 ) - 1 , 8 ) / 8 ;
V_126 = F_74 ( ( V_9 -> V_114 * V_125 /
1000 ) - 1 , 1 ) ;
V_65 = F_75 ( V_121 ) & V_9 -> V_23 -> V_140 ;
V_65 |= F_76 ( V_123 ) & V_9 -> V_23 -> V_141 ;
if ( V_9 -> V_104 )
V_65 |= V_142 ;
if ( V_9 -> V_112 )
V_65 |= V_143 ;
V_65 |= F_77 ( V_126 ) & V_144 ;
F_27 ( V_9 , V_145 , V_65 ) ;
V_75 = F_16 ( V_6 ) ;
if ( V_75 < 0 ) {
F_34 ( & V_95 -> V_35 , L_40 ) ;
