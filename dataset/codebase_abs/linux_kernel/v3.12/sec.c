...
static
void F_75 ( struct V_66 * V_67 , struct V_45 * V_59 )
{
F_41 ( & V_59 -> V_69 ) ;
if ( ! F_56 ( & V_67 -> V_70 ) )
F_43 ( & V_67 -> V_70 ) ;
...
int F_76 ( struct V_66 * V_67 , long V_102 )
{
...
V_67 -> V_123 = 0 ;
F_45 ( & V_67 -> V_100 ) ;
V_104 = F_80 ( V_102 * V_97 , F_71 ,
F_74 , V_67 ) ;
V_77 = F_81 ( V_67 -> V_124 , F_69 ( V_59 ) , & V_104 ) ;
if ( ! F_70 ( V_59 ) ) {
F_75 ( V_67 , V_59 ) ;
F_2 ( V_77 != 0 ) ;
return V_77 ;
...
F_45 ( & V_47 -> V_138 ) ;
if ( F_4 ( V_67 -> V_105 ) )
F_82 ( & V_67 -> V_93 . V_34 , V_139 ) ;
else if ( F_4 ( V_67 -> V_106 ) )
F_82 ( & V_67 -> V_93 . V_34 , V_140 ) ;
...
void F_84 ( struct V_66 * V_67 )
{
if ( F_85 ( V_67 -> V_93 . V_34 ) != V_141 )
return;
F_2 ( V_67 -> V_142 ) ;
if ( V_67 -> V_143 || ! V_67 -> V_144 )
return;
F_86 ( V_67 -> V_144 , V_67 -> V_145 ) ;
V_67 -> V_144 = NULL ;
V_67 -> V_145 = 0 ;
}
...
if ( V_67 -> V_148 ) {
V_77 = F_96 ( V_67 , V_67 -> V_148 ) ;
if ( V_77 )
return V_77 ;
}
switch ( F_85 ( V_67 -> V_93 . V_34 ) ) {
case V_139 :
case V_149 :
case V_140 :
F_2 ( V_59 -> V_64 -> V_150 ) ;
V_77 = V_59 -> V_64 -> V_150 ( V_59 , V_67 ) ;
break;
case V_141 :
F_2 ( V_59 -> V_64 -> V_151 ) ;
...
F_2 ( V_67 -> V_155 == NULL ) ;
V_67 -> V_156 = 0 ;
V_77 = F_99 ( V_67 -> V_154 , V_67 -> V_157 ) ;
switch ( V_77 ) {
case 1 :
F_100 ( V_67 , V_158 ) ;
case 0 :
break;
default:
F_8 ( L_32 V_159 L_33 , V_67 -> V_160 ) ;
return - V_161 ;
}
if ( V_67 -> V_157 < sizeof( struct V_162 ) ) {
F_8 ( L_34 ,
V_67 -> V_157 ) ;
return - V_161 ;
}
if ( F_12 ( V_67 -> V_154 -> V_163 ) !=
F_12 ( V_67 -> V_93 . V_34 ) ) {
F_8 ( L_35 ,
F_12 ( V_67 -> V_154 -> V_163 ) ,
F_12 ( V_67 -> V_93 . V_34 ) ) ;
return - V_161 ;
}
switch ( F_85 ( V_67 -> V_93 . V_34 ) ) {
...
F_2 ( V_77 || V_67 -> V_155 || V_67 -> V_122 ) ;
if ( F_12 ( V_67 -> V_93 . V_34 ) != V_166 &&
! V_67 -> V_105 )
V_67 -> V_156 = 0 ;
return V_77 ;
}
int F_101 ( struct V_66 * V_67 )
{
F_2 ( V_67 -> V_153 ) ;
F_2 ( V_67 -> V_154 == NULL ) ;
F_2 ( V_67 -> V_155 == NULL ) ;
...
V_67 -> V_154 = (struct V_162 * )
( V_67 -> V_153 + V_67 -> V_167 ) ;
V_67 -> V_157 = V_67 -> V_168 ;
return F_98 ( V_67 ) ;
}
...
F_59 ( V_173 , V_174 ) ;
if ( V_173 == NULL )
GOTO ( V_176 , V_77 = - V_83 ) ;
F_41 ( & V_67 -> V_100 ) ;
if ( V_67 -> V_177 ) {
F_45 ( & V_67 -> V_100 ) ;
GOTO ( V_178 , V_77 = - V_12 ) ;
}
F_2 ( V_67 -> V_153 ) ;
F_2 ( V_67 -> V_154 == NULL ) ;
F_2 ( V_67 -> V_155 == NULL ) ;
...
void F_106 ( struct V_66 * V_172 )
{
F_2 ( V_172 -> V_153 ) ;
F_2 ( V_172 -> V_154 ) ;
F_2 ( V_172 -> V_155 ) ;
F_36 ( V_172 -> V_82 , 1 ) ;
F_65 ( V_172 -> V_153 , V_172 -> V_169 ) ;
F_94 ( V_172 ) ;
}
int F_107 ( void )
{
...
static int F_109 ( struct V_46 * V_47 , T_4 V_183 ,
int V_184 , int V_185 )
{
...
void F_113 ( struct V_46 * V_47 )
{
F_110 ( V_47 ) ;
}
static void F_114 ( struct V_46 * V_47 )
{
F_37 ( & V_47 -> V_187 ) ;
...
struct V_46 * F_115 ( struct V_46 * V_47 )
{
if ( V_47 )
F_35 ( & V_47 -> V_187 ) ;
return V_47 ;
...
static
struct V_46 * F_117 ( struct V_72 * V_73 ,
struct V_191 * V_192 ,
struct V_30 * V_31 ,
enum V_193 V_194 )
{
...
static inline
int F_121 ( struct V_30 * V_208 , struct V_30 * V_209 )
{
return ( memcmp ( V_208 , V_209 , sizeof( * V_208 ) ) == 0 ) ;
}
static inline
void F_122 ( struct V_30 * V_210 , struct V_30 * V_211 )
{
* V_210 = * V_211 ;
}
...
V_31 . V_55 = V_41 |
V_42 ;
V_194 = F_125 ( V_73 -> V_197 ) ;
}
V_47 = F_51 ( V_73 ) ;
if ( V_47 ) {
char V_213 [ 24 ] ;
if ( F_121 ( & V_31 , & V_47 -> V_54 ) )
GOTO ( V_228 , V_77 ) ;
F_6 ( V_13 , L_47 ,
V_73 -> V_197 -> V_200 ,
F_126 ( & V_215 -> V_229 ) ,
...
F_12 ( V_47 -> V_54 . V_34 ) &&
F_127 ( V_31 . V_34 ) ==
F_127 ( V_47 -> V_54 . V_34 ) ) {
F_123 ( V_73 , V_47 , & V_31 ) ;
GOTO ( V_228 , V_77 ) ;
}
...
F_17 ( & V_73 -> V_230 ) ;
V_216 = F_117 ( V_73 , V_192 , & V_31 , V_194 ) ;
if ( V_216 ) {
F_120 ( V_73 , V_216 ) ;
} else {
F_8 ( L_49 ,
...
static void F_130 ( struct V_72 * V_73 ,
...
V_211 = F_135 ( V_234 , V_235 + 1 , 0 ) ;
V_234 -> V_241 [ V_235 ] = V_236 ;
V_210 = F_135 ( V_234 , V_235 + 1 , 0 ) ;
V_234 -> V_241 [ V_235 ] = V_237 ;
F_2 ( V_234 -> V_242 == V_243 ) ;
V_238 = F_136 ( V_234 -> V_240 , V_234 -> V_241 ) ;
...
int F_138 ( struct V_66 * V_67 , int V_231 )
{
struct V_45 * V_59 = V_67 -> V_82 ;
struct V_1 * V_2 ;
F_2 ( V_59 ) ;
...
static int F_141 ( struct V_30 * exp ,
struct V_66 * V_67 )
{
...
F_12 ( exp -> V_34 ) ==
F_12 ( V_28 -> V_34 ) &&
F_127 ( exp -> V_34 ) == F_127 ( V_28 -> V_34 ) )
return 1 ;
return 0 ;
}
int F_142 ( struct V_251 * exp ,
struct V_66 * V_67 )
{
struct V_30 V_14 ;
if ( exp == NULL )
...
exp -> V_255 [ 1 ] . V_34 ) ;
F_45 ( & exp -> V_253 ) ;
return F_140 ( exp -> V_252 ,
V_67 -> V_264 ) ;
}
}
if ( exp -> V_257 [ 0 ] ) {
if ( exp -> V_257 [ 0 ] >= F_48 () ) {
if ( F_141 ( & exp -> V_255 [ 0 ] , V_67 ) ) {
F_6 ( V_13 , L_55
L_56 V_265 L_57 , exp ,
exp -> V_256 . V_34 ,
exp -> V_255 [ 0 ] . V_34 ,
...
continue;
F_41 ( & exp -> V_253 ) ;
F_146 ( V_270 , exp -> V_274 ,
exp -> V_273 -> V_275 . V_276 ,
& V_271 ) ;
if ( exp -> V_254 ||
! F_121 ( & V_271 , & exp -> V_256 ) ) {
exp -> V_255 [ 1 ] = V_271 ;
exp -> V_257 [ 1 ] = 0 ;
exp -> V_254 = 1 ;
exp -> V_259 = 1 ;
...
static int F_148 ( struct V_66 * V_67 , int V_277 )
{
...
F_105 ( V_281 , V_67 , L_67 ) ;
V_277 = V_278 ;
}
break;
case V_282 :
if ( ! V_67 -> V_262 ) {
F_105 ( V_281 , V_67 , L_68 ) ;
V_277 = V_278 ;
}
break;
case V_283 :
if ( ! V_67 -> V_263 ) {
F_105 ( V_281 , V_67 , L_69 ) ;
V_277 = V_278 ;
}
break;
case V_284 :
...
! V_67 -> V_263 ) {
F_105 ( V_281 , V_67 , L_70 ) ;
V_277 = V_278 ;
}
break;
case V_285 :
default:
F_105 ( V_281 , V_67 , L_71 , V_67 -> V_279 ) ;
V_277 = V_278 ;
}
return V_277 ;
}
int F_149 ( struct V_66 * V_67 )
{
struct V_1 * V_2 ;
...
default:
F_8 ( L_72 V_159 L_33 ,
F_151 ( V_67 -> V_287 ) , V_67 -> V_160 ) ;
return V_278 ;
}
V_67 -> V_93 . V_34 = F_152 ( V_234 -> V_163 ) ;
V_67 -> V_279 = V_285 ;
V_67 -> V_288 = - 1 ;
V_67 -> V_289 = - 1 ;
...
if ( F_12 ( V_67 -> V_93 . V_34 ) != V_166 )
V_67 -> V_286 = 0 ;
V_77 = F_148 ( V_67 , V_77 ) ;
return V_77 ;
}
int F_153 ( struct V_66 * V_67 , int V_292 )
{
struct V_1 * V_2 ;
struct V_293 * V_294 ;
int V_77 ;
...
F_2 ( V_77 != 0 ||
( V_67 -> V_298 && V_67 -> V_298 -> V_299 ) ) ;
return V_77 ;
}
int F_156 ( struct V_66 * V_67 )
{
struct V_1 * V_2 ;
int V_77 ;
F_2 ( V_67 -> V_264 ) ;
...
V_2 = V_67 -> V_264 -> V_201 ;
F_2 ( V_2 -> V_7 -> V_300 ) ;
V_77 = V_2 -> V_7 -> V_300 ( V_67 ) ;
F_2 ( V_77 || V_67 -> V_298 -> V_301 ) ;
return V_77 ;
}
void F_157 ( struct V_293 * V_294 )
{
struct V_1 * V_2 ;
unsigned int V_302 ;
F_2 ( V_294 -> V_303 ) ;
F_2 ( V_294 -> V_303 -> V_201 ) ;
V_2 = V_294 -> V_303 -> V_201 ;
F_2 ( V_2 -> V_7 -> V_304 ) ;
V_302 = V_294 -> V_305 ;
V_2 -> V_7 -> V_304 ( V_294 ) ;
if ( V_302 )
...
F_37 ( & V_59 -> V_306 ) ;
if ( F_38 ( & V_59 -> V_306 ) ) {
if ( V_59 -> V_201 -> V_7 -> V_307 )
V_59 -> V_201 -> V_7 -> V_307 ( V_59 ) ;
}
V_67 -> V_264 = NULL ;
}
...
return;
F_37 ( & V_59 -> V_306 ) ;
if ( V_59 -> V_201 -> V_7 -> V_308 )
V_59 -> V_201 -> V_7 -> V_308 ( V_59 ) ;
}
...
V_59 = V_67 -> V_82 ;
if ( V_59 -> V_64 -> V_311 )
return V_59 -> V_64 -> V_311 ( V_59 , V_67 , V_310 ) ;
return 0 ;
}
int F_161 ( struct V_66 * V_67 ,
struct V_309 * V_310 ,
int V_312 )
{
struct V_45 * V_59 ;
...
V_59 = V_67 -> V_82 ;
if ( V_59 -> V_64 -> V_314 ) {
V_77 = V_59 -> V_64 -> V_314 ( V_59 , V_67 , V_310 ) ;
if ( V_77 < 0 )
return V_77 ;
}
return V_310 -> V_313 ;
...
if ( V_310 -> V_315 != V_310 -> V_313 ) {
F_8 ( L_74 ,
V_310 -> V_315 , V_310 -> V_313 ) ;
return - V_161 ;
}
return 0 ;
}
...
int F_165 ( struct V_162 * V_234 , int V_319 )
{
struct V_320 * V_321 ;
V_321 = F_135 ( V_234 , V_319 , 0 ) ;
V_321 -> V_322 = F_30 ( & V_58 , F_31 () ) ;
V_321 -> V_323 = F_32 ( & V_58 , F_33 () ) ;
V_321 -> V_324 = F_30 ( & V_58 , F_166 () ) ;
V_321 -> V_325 = F_32 ( & V_58 , F_167 () ) ;
V_321 -> V_326 = F_168 () ;
V_321 -> V_327 = ( V_234 -> V_241 [ V_319 ] - sizeof( * V_321 ) ) / 4 ;
F_169 ( V_328 ) ;
if ( V_321 -> V_327 > V_317 )
V_321 -> V_327 = V_317 ;
memcpy ( V_321 -> V_329 , F_170 () -> V_330 -> V_331 [ 0 ] ,
V_321 -> V_327 * sizeof( T_2 ) ) ;
F_171 ( V_328 ) ;
return 0 ;
}
int F_172 ( struct V_162 * V_234 , int V_319 , int V_332 )
{
struct V_320 * V_321 ;
int V_333 ;
V_321 = F_135 ( V_234 , V_319 , sizeof( * V_321 ) ) ;
if ( ! V_321 )
return - V_9 ;
if ( V_332 ) {
F_173 ( & V_321 -> V_322 ) ;
...
if ( V_321 -> V_327 > V_318 ) {
F_8 ( L_75 , V_321 -> V_327 ) ;
return - V_9 ;
}
if ( sizeof( * V_321 ) + V_321 -> V_327 * sizeof( T_2 ) >
V_234 -> V_241 [ V_319 ] ) {
F_8 ( L_76 ,
V_321 -> V_327 , V_234 -> V_241 [ V_319 ] ) ;
return - V_9 ;
}
if ( V_332 ) {
for ( V_333 = 0 ; V_333 < V_321 -> V_327 ; V_333 ++ )
F_173 ( & V_321 -> V_329 [ V_333 ] ) ;
}
return 0 ;
}
const char * F_58 ( struct V_46 * V_47 )
{
if ( ! V_47 || ! V_47 -> V_334 || ! V_47 -> V_334 -> V_197 )
return L_77 ;
if ( F_174 ( V_47 ) )
return L_78 ;
return F_126 ( & V_47 -> V_334 -> V_197 -> V_220 . V_221 . V_226 ) ;
}
int F_83 ( struct V_30 * V_28 )
{
switch ( F_175 ( V_28 -> V_34 ) ) {
case V_335 :
case V_336 :
return 1 ;
default:
