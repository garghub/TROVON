...
struct V_22 * F_6 ( struct V_2 * V_3 ,
struct V_23 * * V_24 ,
struct V_25 * V_26 ,
T_3 V_27 , unsigned long * V_28 )
{
...
static inline unsigned long F_49 ( struct V_2 * V_3 , T_5 V_108 )
{
return V_3 -> V_8 + ( V_108 - ( ( T_5 ) V_3 -> V_10 << V_11 ) ) ;
}
int F_50 ( struct V_109 * V_81 , T_5 V_110 , T_5 V_111 )
{
int V_38 = - V_112 ;
F_51 ( V_111 > V_110 , L_10 V_113 L_11 V_113 L_12 , V_111 , V_110 ) ;
if ( F_52 ( V_81 ) ) {
V_38 = 0 ;
F_53 ( V_81 , V_110 + V_114 - 1 ,
V_111 - V_110 + 1 , 0 ) ;
}
return V_38 ;
}
