...
V_158 -> V_70 = 0 ;
V_158 -> V_162 = 0 ;
V_160 = F_52 ( & V_158 -> V_163 ) ;
F_53 (xfer, &msg->transfers, transfer_list) {
F_20 ( V_2 -> V_164 ) ;
...
V_2 -> V_119 = F_79 ( & V_182 -> V_45 , L_26 ) ;
if ( F_74 ( V_2 -> V_119 ) ) {
F_22 ( & V_182 -> V_45 , L_27 ) ;
V_69 = F_75 ( V_2 -> V_119 ) ;
goto V_200;
}
V_2 -> V_26 = V_143 << 2 ;
...
V_69 = F_30 ( V_2 , true ) ;
if ( V_69 < 0 ) {
F_22 ( & V_182 -> V_45 , L_28 , V_69 ) ;
goto V_200;
}
V_69 = F_30 ( V_2 , false ) ;
if ( V_69 < 0 ) {
F_22 ( & V_182 -> V_45 , L_29 , V_69 ) ;
goto V_202;
}
V_2 -> V_26 = V_2 -> V_47 ;
F_80 ( & V_2 -> V_56 ) ;
