...
{
struct V_28 * V_29 = F_16 ( & V_18 -> V_2 ) ;
struct V_17 * V_12 ;
struct V_30 * V_21 = V_18 -> V_21 ;
int V_31 ;
V_12 = F_17 ( & V_18 -> V_2 , sizeof( struct V_17 ) ,
V_32 ) ;
if ( ! V_12 )
return - V_33 ;
V_12 -> V_22 = V_29 -> V_22 ;
...
V_12 -> V_18 = V_18 ;
if ( V_29 -> V_23 > 0 ) {
V_31 = F_19 ( & V_18 -> V_2 , V_29 -> V_23 , F_12 ,
0 , L_6 , V_12 ) ;
if ( V_31 )
return V_31 ;
}
...
struct V_4 * F_25 ( struct V_30 * V_21 ,
struct V_28 * V_29 )
{
struct V_34 V_35 = {
F_26 ( L_6 , 0x0c ) ,
