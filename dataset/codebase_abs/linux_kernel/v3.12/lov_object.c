...
int F_93 ( const struct V_1 * V_2 , struct V_15 * V_105 ,
const struct V_148 * V_10 )
{
struct V_7 * V_8 = F_91 ( V_105 -> V_18 ) ;
struct V_3 * V_4 = F_62 ( V_105 ) ;
const struct V_9 * V_149 = F_94 ( V_10 ) ;
...
F_96 ( & V_4 -> V_132 , 0 ) ;
F_97 ( & V_4 -> V_133 ) ;
F_98 ( F_10 ( V_105 ) , sizeof( struct V_152 ) ) ;
...
static int F_99 ( const struct V_1 * V_2 , struct V_11 * V_105 ,
const struct V_9 * V_10 )
{
...
static void F_100 ( const struct V_1 * V_2 , struct V_15 * V_105 )
{
struct V_3 * V_4 = F_62 ( V_105 ) ;
F_101 ( V_4 , V_141 , V_2 , V_4 , & V_4 -> V_64 ) ;
}
static void F_102 ( const struct V_1 * V_2 , struct V_15 * V_105 )
{
struct V_3 * V_4 = F_62 ( V_105 ) ;
F_101 ( V_4 , V_142 , V_2 , V_4 , & V_4 -> V_64 ) ;
F_103 ( V_105 ) ;
F_104 ( V_4 , V_158 ) ;
}
static int F_105 ( const struct V_1 * V_2 , void * V_101 ,
T_2 V_102 , const struct V_15 * V_16 )
{
return F_106 ( F_62 ( V_16 ) , V_159 , V_2 , V_101 , V_102 , V_16 ) ;
}
int F_107 ( const struct V_1 * V_2 , struct V_11 * V_105 ,
struct V_160 * V_161 , struct V_161 * V_162 )
{
return F_106 ( F_22 ( V_105 ) ,
V_163 , V_2 , V_105 , V_161 , V_162 ) ;
}
int F_108 ( const struct V_1 * V_2 , struct V_11 * V_105 ,
struct V_164 * V_165 )
{
F_109 ( F_110 ( V_2 ) , V_166 ) ;
return F_111 ( F_22 ( V_105 ) , V_167 ,
! V_165 -> V_168 , V_2 , V_105 , V_165 ) ;
}
static int F_112 ( const struct V_1 * V_2 , struct V_11 * V_105 ,
struct V_106 * V_107 )
{
return F_106 ( F_22 ( V_105 ) , V_169 , V_2 , V_105 , V_107 ) ;
}
...
int F_114 ( const struct V_1 * V_2 , struct V_11 * V_105 ,
struct V_171 * V_172 , const struct V_164 * V_165 )
{
return F_106 ( F_22 ( V_105 ) , V_173 , V_2 , V_105 , V_172 ,
V_165 ) ;
}
struct V_15 * F_115 ( const struct V_1 * V_2 ,
const struct V_174 * V_134 ,
struct V_175 * V_8 )
{
struct V_3 * V_4 ;
struct V_15 * V_105 ;
F_116 ( V_4 , V_158 , V_176 ) ;
if ( V_4 != NULL ) {
V_105 = F_26 ( V_4 ) ;
F_117 ( V_105 , NULL , V_8 ) ;
...
struct V_62 * F_118 ( struct V_3 * V_4 )
{
struct V_62 * V_63 = NULL ;
F_76 ( V_4 ) ;
if ( V_4 -> V_35 != NULL ) {
...
void F_119 ( struct V_3 * V_4 , struct V_62 * V_63 )
{
if ( V_63 == NULL )
return;
F_16 ( V_37 , L_19 ,
...
struct V_62 * F_120 ( struct V_11 * V_181 )
{
struct V_15 * V_182 ;
struct V_62 * V_63 = NULL ;
if ( V_181 == NULL )
return NULL ;
V_182 = F_21 ( & V_25 ( V_181 ) -> V_40 ,
& V_53 ) ;
if ( V_182 != NULL )
V_63 = F_118 ( F_62 ( V_182 ) ) ;
return V_63 ;
}
void F_121 ( struct V_11 * V_134 , struct V_62 * V_63 )
{
if ( V_63 != NULL )
F_59 ( & V_63 ) ;
}
int F_122 ( struct V_11 * V_183 )
{
struct V_15 * V_182 ;
int V_184 = 0 ;
V_182 = F_21 ( & V_25 ( V_183 ) -> V_40 ,
& V_53 ) ;
if ( V_182 != NULL ) {
struct V_3 * V_4 = F_62 ( V_182 ) ;
F_76 ( V_4 ) ;
switch ( V_4 -> V_82 ) {
case V_126 : {
struct V_62 * V_63 ;
...
struct V_29 * V_185 = V_63 -> V_36 [ V_57 ] ;
