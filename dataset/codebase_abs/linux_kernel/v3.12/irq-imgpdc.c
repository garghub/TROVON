...
static void F_17 ( unsigned int V_40 , struct V_41 * V_42 )
{
struct V_1 * V_2 ;
unsigned int V_43 , V_44 ;
V_2 = (struct V_1 * ) F_18 ( V_42 ) ;
for ( V_43 = 0 ; V_43 < V_2 -> V_45 ; ++ V_43 )
if ( V_40 == V_2 -> V_39 [ V_43 ] )
goto V_46;
return;
V_46:
V_44 = F_19 ( V_2 -> V_10 , V_43 ) ;
F_20 ( V_44 ) ;
}
static void F_21 ( unsigned int V_40 , struct V_41 * V_42 )
{
struct V_1 * V_2 ;
...
if ( ! V_56 )
return - V_65 ;
V_60 = F_24 ( V_54 , V_66 , 0 ) ;
if ( V_60 == NULL ) {
F_25 ( & V_54 -> V_57 , L_1 ) ;
return - V_65 ;
}
V_2 = F_26 ( & V_54 -> V_57 , sizeof( * V_2 ) , V_67 ) ;
if ( ! V_2 ) {
F_25 ( & V_54 -> V_57 , L_2 ) ;
return - V_68 ;
}
F_27 ( & V_2 -> V_12 ) ;
F_28 ( V_54 , V_2 ) ;
V_2 -> V_5 = F_29 ( & V_54 -> V_57 , V_60 -> V_69 ,
V_60 -> V_70 - V_60 -> V_69 ) ;
if ( ! V_2 -> V_5 )
return - V_71 ;
V_63 = F_30 ( V_56 , L_3 , & V_64 ) ;
if ( V_63 ) {
F_25 ( & V_54 -> V_57 , L_4 ) ;
return - V_31 ;
}
if ( V_64 > V_7 ) {
F_25 ( & V_54 -> V_57 , L_5 , V_64 ) ;
return - V_31 ;
}
V_2 -> V_45 = V_64 ;
V_63 = F_30 ( V_56 , L_6 , & V_64 ) ;
if ( V_63 ) {
F_25 ( & V_54 -> V_57 , L_7 ) ;
return - V_31 ;
}
if ( V_64 > V_7 ) {
F_25 ( & V_54 -> V_57 , L_8 , V_64 ) ;
return - V_31 ;
}
V_2 -> V_50 = V_64 ;
V_2 -> V_39 = F_26 ( & V_54 -> V_57 , 4 * V_2 -> V_45 ,
V_67 ) ;
if ( ! V_2 -> V_39 ) {
F_25 ( & V_54 -> V_57 , L_9 ) ;
return - V_68 ;
...
for ( V_43 = 0 ; V_43 < V_2 -> V_45 ; ++ V_43 ) {
V_40 = F_31 ( V_54 , 1 + V_43 ) ;
if ( V_40 < 0 ) {
F_25 ( & V_54 -> V_57 , L_10 , V_43 ) ;
return V_40 ;
}
V_2 -> V_39 [ V_43 ] = V_40 ;
}
if ( F_31 ( V_54 , 1 + V_43 ) >= 0 ) {
F_25 ( & V_54 -> V_57 , L_11 ) ;
return - V_31 ;
}
V_40 = F_31 ( V_54 , 0 ) ;
...
V_2 -> V_38 = V_40 ;
V_2 -> V_10 = F_32 ( V_56 , 16 , & V_72 ,
V_2 ) ;
if ( F_33 ( ! V_2 -> V_10 ) ) {
F_25 ( & V_54 -> V_57 , L_13 ) ;
return - V_68 ;
}
V_63 = F_34 ( V_2 -> V_10 , 8 , 2 , L_14 ,
V_73 , 0 , 0 ,
V_74 ) ;
if ( V_63 )
goto V_75;
V_62 = F_35 ( V_2 -> V_10 , 0 ) ;
V_62 -> V_76 = ~ ( F_36 ( V_2 -> V_45 ) - 1 ) ;
V_62 -> V_77 = V_2 -> V_5 ;
V_62 -> V_78 [ 0 ] . V_79 . V_14 = V_15 ;
V_62 -> V_78 [ 0 ] . V_80 . V_81 = F_9 ;
V_62 -> V_78 [ 0 ] . V_80 . V_82 = F_12 ;
V_62 -> V_78 [ 0 ] . V_80 . V_83 = F_15 ;
V_62 = F_35 ( V_2 -> V_10 , 8 ) ;
V_62 -> V_76 = ~ ( F_36 ( V_2 -> V_50 ) - 1 ) ;
V_62 -> V_77 = V_2 -> V_5 ;
