...
static void F_100 ( void * V_6 , enum V_3 V_4 )
{
...
static bool F_101 ( struct V_278 * V_81 , void * V_303 )
{
...
return false ;
V_310 = V_81 -> V_314 ;
return * V_310 == ( unsigned ) V_303 ;
}
static struct V_278 * F_103 ( struct V_315 * V_316 ,
struct V_317 * V_318 )
{
...
F_105 ( V_324 , V_323 ) ;
F_105 ( V_325 , V_323 ) ;
return F_106 ( V_323 , F_101 , & V_305 ) ;
}
static int F_107 ( struct V_278 * V_81 )
{
...
static int F_109 ( struct V_278 * V_81 , enum V_326 V_327 , unsigned long V_47 )
{
struct V_277 * V_284 = F_90 ( V_81 ) ;
struct V_280 * V_285 ;
unsigned long V_206 ;
...
F_111 ( & V_284 -> V_300 , & V_307 -> V_301 ) ;
F_111 ( & V_284 -> V_296 , & V_307 -> V_301 ) ;
F_60 ( & V_284 -> V_214 , V_206 ) ;
break;
case V_332 :
...
static void F_113 ( struct V_278 * V_81 )
{
struct V_277 * V_284 = F_90 ( V_81 ) ;
unsigned long V_206 ;
F_89 ( & V_284 -> V_292 ) ;
...
V_284 -> V_288 = NULL ;
if ( V_284 -> V_294 )
F_111 ( & V_284 -> V_300 , & V_284 -> V_12 -> V_301 ) ;
F_60 ( & V_284 -> V_214 , V_206 ) ;
}
static enum V_344
F_114 ( struct V_278 * V_81 , T_7 V_291 ,
struct V_345 * V_346 )
{
return F_115 ( V_81 , V_291 , V_346 ) ;
}
static void F_116 ( struct V_278 * V_81 )
{
F_95 ( ( unsigned long ) F_90 ( V_81 ) ) ;
}
static T_7 F_117 ( struct V_281 * V_282 )
{
...
V_285 = F_118 ( V_347 -> V_295 . V_167 , struct V_280 , V_295 ) ;
if ( V_284 -> V_294 ) {
...
V_291 = F_119 ( & V_347 -> V_283 ) ;
F_64 ( & V_347 -> V_295 , & V_284 -> V_300 ) ;
F_60 ( & V_284 -> V_214 , V_206 ) ;
return V_291 ;
}
static inline void F_120 ( struct V_280 * V_285 )
{
V_285 -> V_302 = NULL ;
...
V_285 -> V_9 . V_5 = F_100 ;
V_285 -> V_283 . V_353 = F_117 ;
F_83 ( & V_285 -> V_295 ) ;
}
static int F_121 ( struct V_321 * V_307 , T_8 V_354 , int V_319 )
{
struct V_280 * V_285 ;
unsigned long V_206 ;
int V_219 ;
if ( ! V_307 )
return 0 ;
V_285 = F_122 ( V_319 * sizeof( * V_285 ) , V_354 ) ;
if ( ! V_285 )
return 0 ;
...
static struct V_280 * F_125 ( struct V_277 * V_284 )
{
struct V_321 * V_307 = V_284 -> V_12 ;
...
F_127 ( & V_285 -> V_283 , & V_284 -> V_81 ) ;
return V_285 ;
}
static inline void F_128 ( struct V_157 * V_348 ,
...
static struct V_280 *
F_129 ( struct V_277 * V_284 , T_9 V_55 ,
T_9 V_357 , T_10 V_358 )
{
struct V_280 * V_285 = F_125 ( V_284 ) ;
if ( ! V_285 ) {
F_34 ( V_284 -> V_12 -> V_290 . V_95 , L_43 ,
V_134 , __LINE__ ) ;
return NULL ;
}
F_128 ( & V_285 -> V_348 , V_55 , V_357 , V_358 ) ;
return V_285 ;
}
static inline int F_130 ( struct V_280 * V_285 , T_10 V_358 )
{
struct V_277 * V_284 = V_285 -> V_302 ;
...
V_285 -> V_349 . V_182 = 1 ;
F_128 ( & V_285 -> V_348 , V_55 , V_357 , V_360 ) ;
if ( ! V_363 )
V_363 = V_285 ;
else
...
static struct V_281 *
F_133 ( struct V_278 * V_81 , T_9 V_55 ,
...
struct V_203 * V_204 ;
int V_364 ;
if ( F_134 ( ! V_284 || ! V_358 ) )
return NULL ;
V_204 = & V_284 -> V_12 -> V_290 ;
V_285 = F_129 ( V_284 , V_55 , V_357 , V_358 ) ;
if ( ! V_285 )
return NULL ;
V_285 -> V_349 . V_170 = 1 ;
V_285 -> V_349 . V_172 = 1 ;
...
V_285 -> V_349 . V_185 ++ ;
V_285 -> V_349 . V_182 = F_130 ( V_285 , V_358 ) ;
V_285 -> V_283 . V_206 = V_206 ;
return & V_285 -> V_283 ;
}
static void F_135 ( struct V_321 * V_307 ,
struct V_280 * V_363 )
{
unsigned long V_206 ;
struct V_280 * V_285 ;
...
static struct V_281 *
F_136 ( struct V_278 * V_81 , struct V_365 * V_366 ,
...
int V_219 ;
T_9 V_82 ;
if ( F_134 ( ! V_284 || ! V_366 || ! V_367 ) )
return NULL ;
V_82 = V_284 -> V_335 ;
V_363 = NULL ;
F_137 (sgl, sg, sg_len, i) {
V_285 = F_125 ( V_284 ) ;
if ( ! V_285 ) {
struct V_321 * V_307 = V_284 -> V_12 ;
F_34 ( V_284 -> V_12 -> V_290 . V_95 ,
...
V_285 -> V_9 . V_143 = V_144 ;
F_128 ( & V_285 -> V_348 ,
V_82 , F_138 ( V_368 ) , F_139 ( V_368 ) ) ;
} else {
V_285 -> V_349 . V_170 = 0 ;
V_285 -> V_349 . V_172 = 1 ;
V_285 -> V_9 . V_143 = V_145 ;
F_128 ( & V_285 -> V_348 ,
F_138 ( V_368 ) , V_82 , F_139 ( V_368 ) ) ;
}
V_285 -> V_349 . V_185 = V_284 -> V_337 ;
V_285 -> V_349 . V_182 = 1 ;
}
...
static T_11 F_140 ( int V_369 , void * V_218 )
{
if ( F_62 ( V_218 ) )
return V_370 ;
else
...
static int F_141 ( struct V_278 * V_372 ,
struct V_373 * V_374 )
{
V_374 -> V_375 = V_376 ;
V_374 -> V_377 = V_376 ;
V_374 -> V_378 = F_142 ( V_340 ) | F_142 ( V_334 ) ;
V_374 -> V_379 = false ;
V_374 -> V_380 = true ;
return 0 ;
}
static int
F_143 ( struct V_381 * V_382 , const struct V_383 * V_13 )
{
struct V_384 * V_385 ;
struct V_321 * V_307 ;
...
int V_16 ;
V_385 = F_144 ( & V_382 -> V_95 ) ;
V_307 = F_145 ( & V_382 -> V_95 , sizeof( * V_307 ) , V_271 ) ;
if ( ! V_307 ) {
...
V_390 = & V_382 -> V_390 ;
V_204 -> V_87 = F_146 ( & V_382 -> V_95 , V_390 ) ;
if ( F_147 ( V_204 -> V_87 ) )
return F_148 ( V_204 -> V_87 ) ;
F_149 ( V_382 , V_307 ) ;
V_369 = V_382 -> V_369 [ 0 ] ;
V_207 = F_150 ( V_369 , F_140 , 0 ,
F_151 ( & V_382 -> V_95 ) , V_204 ) ;
if ( V_207 )
return V_207 ;
V_204 -> V_15 . V_19 = V_382 -> V_392 ;
V_207 = F_81 ( V_204 ) ;
if ( V_207 )
goto V_393;
F_83 ( & V_307 -> V_301 ) ;
F_82 ( & V_307 -> V_355 ) ;
if ( ! F_121 ( V_307 , V_271 , V_394 ) )
F_152 ( & V_382 -> V_95 , L_46 ) ;
V_388 = & V_307 -> V_308 ;
F_83 ( & V_388 -> V_223 ) ;
if ( V_385 )
V_16 = F_153 ( int , V_385 -> V_395 , V_204 -> V_15 . V_16 ) ;
else
...
F_105 ( V_401 , V_388 -> V_400 ) ;
if ( V_204 -> V_15 . V_213 ) {
F_105 ( V_324 , V_388 -> V_400 ) ;
F_105 ( V_325 , V_388 -> V_400 ) ;
F_105 ( V_402 , V_388 -> V_400 ) ;
}
}
V_388 -> V_403 = F_107 ;
V_388 -> V_404 = F_113 ;
...
V_207 = F_156 ( & V_382 -> V_95 , 1900800 ) ;
if ( V_207 )
...
static int F_158 ( struct V_381 * V_382 )
{
struct V_321 * V_307 = F_159 ( V_382 ) ;
struct V_277 * V_284 , * V_386 ;
struct V_203 * V_204 ;
int V_369 ;
if ( ! V_307 )
