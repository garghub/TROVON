...
static int F_26 ( void * V_16 , void * V_25 )
{
T_3 * V_60 = V_16 ;
...
if ( F_20 ( V_49 ) )
V_62 = V_9 [ V_30 -> V_63 ++ ] ;
V_4 = F_17 ( V_30 -> V_32 , V_30 -> V_37 & V_40 , * V_60 , 1 ,
...
T_3 V_60 = * ( ( T_3 * ) V_16 ) ;
if ( V_60 & V_67 )
return F_28 ( V_60 , V_30 -> V_69 ++ ) ;
else
V_30 -> V_69 ++ ;
} else {
int V_70 = * ( ( int * ) V_16 ) ;
if ( V_70 )
return F_28 ( V_70 , V_30 -> V_71 ++ ) ;
else
V_30 -> V_71 ++ ;
}
return 0 ;
}
static int F_29 ( struct V_31 * V_32 , int V_72 )
{
int V_33 ;
struct V_10 * * V_9 ;
V_9 = F_30 ( V_72 , sizeof( V_9 [ 0 ] ) , V_20 ) ;
if ( V_9 == NULL )
return - V_21 ;
V_33 = F_31 ( V_72 , V_9 , 0 ) ;
if ( V_33 != 0 ) {
F_32 ( L_1 , V_73 ,
V_72 , V_33 ) ;
F_33 ( V_9 ) ;
...
static long F_34 ( void T_1 * V_1 , int V_64 )
{
int V_4 ;
struct V_74 V_75 ;
struct V_46 * V_47 = V_48 -> V_47 ;
...
return - V_5 ;
V_75 . V_70 = NULL ;
if ( ! F_35 ( V_78 , V_75 . V_79 , V_75 . V_51 * sizeof( * V_75 . V_79 ) ) )
return - V_5 ;
break;
case 2 :
if ( F_2 ( & V_75 , V_1 , sizeof( struct V_74 ) ) )
return - V_5 ;
if ( ! F_35 ( V_78 , V_75 . V_70 , V_75 . V_51 * ( sizeof( * V_75 . V_70 ) ) ) )
return - V_5 ;
break;
default:
return - V_38 ;
...
if ( V_64 == 2 ) {
if ( F_36 ( V_75 . V_70 , sizeof( int ) * V_75 . V_51 ) ) {
V_4 = - V_5 ;
goto V_53;
}
}
...
static long F_38 ( struct V_84 * V_84 ,
...
if ( ! F_20 ( V_49 ) || ! V_72 || ! V_9 )
return;
F_40 ( V_32 , V_72 , V_9 ) ;
F_41 ( V_72 , V_9 ) ;
F_33 ( V_9 ) ;
}
static int F_42 ( struct V_31 * V_32 , struct V_90 * V_91 )
{
F_43 ( V_92 L_2 ,
...
static int F_44 ( T_4 * V_102 , struct V_10 * V_103 ,
unsigned long V_80 , void * V_16 )
{
return F_45 ( * V_102 ) ? 0 : - V_104 ;
}
static int F_37 (
struct V_31 * V_32 ,
unsigned long V_80 ,
unsigned long V_76 )
{
return F_46 ( V_32 -> V_105 , V_80 , V_76 << V_36 ,
F_44 , NULL ) != 0 ;
}
