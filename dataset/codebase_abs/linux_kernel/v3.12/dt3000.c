...
V_10 = F_39 ( V_7 , sizeof( * V_10 ) ) ;
if ( ! V_10 )
return - V_121 ;
V_106 = F_40 ( V_7 ) ;
if ( V_106 < 0 )
return V_106 ;
V_10 -> V_13 = F_41 ( V_115 , 0 ) ;
if ( ! V_10 -> V_13 )
return - V_121 ;
V_106 = F_42 ( V_115 -> V_43 , F_14 , V_122 ,
V_7 -> V_119 , V_7 ) ;
if ( V_106 )
return V_106 ;
V_7 -> V_43 = V_115 -> V_43 ;
...
static int F_49 ( struct V_114 * V_7 ,
const struct V_152 * V_153 )
{
return F_50 ( V_7 , & V_154 , V_153 -> V_155 ) ;
}
