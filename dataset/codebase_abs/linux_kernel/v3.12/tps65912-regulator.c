...
return - V_25 ;
V_63 = V_66 -> V_69 ;
V_2 = F_26 ( & V_56 -> V_40 , sizeof( * V_2 ) , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
F_27 ( & V_2 -> V_72 ) ;
V_2 -> V_5 = V_4 ;
...
if ( V_67 > V_13 ) {
V_2 -> V_75 [ V_67 ] . V_78 = & V_79 ;
V_2 -> V_75 [ V_67 ] . V_80 = V_81 ;
V_2 -> V_75 [ V_67 ] . V_82 =
F_29 ( V_81 ) ;
} else {
V_2 -> V_75 [ V_67 ] . V_78 = & V_83 ;
}
V_2 -> V_75 [ V_67 ] . type = V_84 ;
V_2 -> V_75 [ V_67 ] . V_85 = V_86 ;
V_6 = F_1 ( V_2 , V_67 ) ;
V_59 . V_40 = V_4 -> V_40 ;
V_59 . V_87 = V_63 ;
V_59 . V_88 = V_2 ;
V_64 = F_30 ( & V_2 -> V_75 [ V_67 ] , & V_59 ) ;
if ( F_31 ( V_64 ) ) {
F_32 ( V_4 -> V_40 ,
L_1 ,
V_56 -> V_76 ) ;
