...
{
return F_11 ( V_15 , & V_21 [ 0 ] ) ;
}
static unsigned int F_12 ( struct V_28 * V_29 )
{
if ( V_29 -> V_30 == 0x06 ) {
if ( F_13 ( V_29 , V_31 ) )
F_14 (KERN_WARNING PFX L_4
L_5
L_6
L_7
L_8 ) ;
...
{
struct V_28 * V_29 = & F_19 ( V_15 -> V_1 ) ;
int V_40 = 0 ;
unsigned int V_20 ;
#ifdef F_20
F_21 ( V_15 -> V_41 , F_22 ( V_15 -> V_1 ) ) ;
#endif
...
static unsigned int F_7 ( unsigned int V_1 )
{
T_1 V_3 , V_4 ;
F_2 ( V_1 , V_13 , & V_3 , & V_4 ) ;
if ( V_3 & 0x10 ) {
...
{
int V_49 ;
if ( ! F_29 ( V_50 ) || ! F_30 ( V_51 ) )
return - V_52 ;
V_49 = F_31 ( & V_33 ) ;
if ( ! V_49 )
F_17 (KERN_INFO PFX L_15
L_16 ) ;
return V_49 ;
}
