...
V_2 = F_15 ( & V_6 -> V_9 , sizeof( * V_2 ) , V_55 ) ;
if ( ! V_2 )
return - V_56 ;
V_2 -> V_50 = V_50 ;
V_2 -> V_6 = V_6 ;
F_16 ( & V_2 -> V_57 ) ;
F_17 ( V_6 , V_2 ) ;
F_11 ( & V_6 -> V_9 , L_7 , V_10 ) ;
V_52 = & V_2 -> V_58 [ V_53 ] ;
V_52 -> V_59 = L_8 ;
V_52 -> V_60 = & V_2 ;
V_52 -> V_61 = sizeof( V_2 ) ;
V_53 ++ ;
V_2 -> V_62 = F_1 ;
V_2 -> V_63 = F_4 ;
V_2 -> V_64 = F_6 ;
