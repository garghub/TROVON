...
if ( ! V_1 -> V_2 ) {
F_84 ( V_193 L_2 , V_1 -> V_104 , V_1 -> V_104 + V_192 - 1 ) ;
return - V_194 ;
}
if ( F_85 ( V_77 -> V_137 , F_45 , V_195 ,
V_196 , V_1 ) ) {
F_84 ( V_193 L_3 , V_77 -> V_137 ) ;
return - V_110 ;
}
...
static int
F_127 ( struct V_191 * V_77 ,
T_7 V_257 )
{
struct V_253 * V_156 = F_128 ( V_77 ) ;
...
V_100 = F_141 ( V_271 [ V_266 ] , V_159 [ V_266 ] , V_272 ,
...
#endif
strcpy ( V_156 -> V_273 , L_68 ) ;
switch ( V_1 -> V_77 -> V_78 ) {
case V_204 :
strcpy ( V_156 -> V_274 , L_69 ) ;
break;
case V_234 :
strcpy ( V_156 -> V_274 , L_70 ) ;
break;
case V_80 :
strcpy ( V_156 -> V_274 , L_71 ) ;
break;
case V_79 :
F_86 ( V_1 -> V_77 , 8 , & V_17 ) ;
if ( V_17 < 5 ) {
strcpy ( V_156 -> V_274 , L_72 ) ;
} else {
strcpy ( V_156 -> V_274 , L_73 ) ;
}
break;
}
sprintf ( V_156 -> V_213 , L_74 , V_156 -> V_274 ,
V_1 -> V_104 , V_1 -> V_137 ) ;
