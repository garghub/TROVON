...
static void T_2 F_8 ( struct V_3 * V_4 , struct V_18 * V_19 )
{
...
static int T_2 F_18 ( T_3 * V_32 , T_3 * V_33 )
{
int V_34 = 0 , V_35 ;
while ( V_34 < V_9 ) {
...
static int T_2 F_24 ( struct V_38 * V_38 )
{
...
static int T_2 F_27 ( unsigned long V_46 )
{
...
int T_2
F_34 ( struct V_3 * V_4 , unsigned long V_2 )
{
return ( ( unsigned long ) V_4 -> V_6 . V_2 <= V_2 &&
( unsigned long ) V_4 -> V_6 . V_2 + V_4 -> V_14 . V_47 > V_2 ) ;
}
static T_2
void F_35 ( struct V_3 * V_4 , int V_56 )
{
if ( V_4 -> V_14 . V_38 ) {
F_36 ( V_4 -> V_14 . V_38 , V_56 ) ;
V_4 -> V_14 . V_38 = NULL ;
V_4 -> V_14 . V_47 = 0 ;
}
}
void T_2 F_37 ( struct V_3 * V_4 )
{
F_35 ( V_4 , 1 ) ;
}
int T_2 F_38 ( struct V_3 * V_4 )
{
T_3 * V_1 ;
int V_35 ;
long V_57 ;
...
return - V_60 ;
V_1 = ( T_3 * ) V_4 -> V_14 . V_38 ;
V_35 = F_18 ( V_1 + V_61 , V_4 -> V_6 . V_2 ) ;
if ( V_35 < 0 ) {
F_35 ( V_4 , 0 ) ;
return V_35 ;
}
...
F_40 ( V_1 + V_64 , F_8 ) ;
F_41 ( V_1 + V_61 + V_4 -> V_14 . V_47 ,
( T_3 * ) V_4 -> V_6 . V_2 + V_4 -> V_14 . V_47 ) ;
F_42 ( ( unsigned long ) V_1 ,
( unsigned long ) V_1 + V_61 +
V_4 -> V_14 . V_47 + V_9 ) ;
return 0 ;
}
void T_2 F_43 ( struct V_65 * V_66 )
{
struct V_3 * V_4 , * V_67 ;
T_3 V_68 [ V_9 ] ;
F_44 (op, tmp, oplist, list) {
T_4 V_57 = ( T_4 ) ( ( long ) V_4 -> V_14 . V_38 -
...
V_68 [ 0 ] = V_69 ;
* ( T_4 * ) ( & V_68 [ 1 ] ) = V_57 ;
F_46 ( V_4 -> V_6 . V_2 , V_68 , V_9 ,
V_4 -> V_14 . V_38 ) ;
F_47 ( & V_4 -> V_10 ) ;
}
}
void T_2 F_48 ( struct V_3 * V_4 )
{
T_3 V_68 [ V_9 ] ;
V_68 [ 0 ] = V_51 ;
memcpy ( V_68 + 1 , V_4 -> V_14 . V_15 , V_16 ) ;
F_46 ( V_4 -> V_6 . V_2 , V_68 , V_9 ,
V_4 -> V_14 . V_38 ) ;
}
extern void F_49 ( struct V_65 * V_66 ,
struct V_65 * V_70 )
{
struct V_3 * V_4 , * V_67 ;
F_44 (op, tmp, oplist, list) {
...
int T_2
F_51 ( struct V_5 * V_54 , struct V_18 * V_19 , int V_71 )
{
struct V_3 * V_4 ;
if ( V_54 -> V_22 & V_72 ) {
