...
V_2 -> V_100 = V_339 ;
if ( V_336 ) {
V_8 = F_125 ( & V_328 -> V_9 , V_336 , V_2 -> V_100 ) ;
if ( V_8 ) {
F_5 ( & V_328 -> V_9 , L_107 ) ;
return V_8 ;
}
V_2 -> V_16 = F_126 ( V_336 , L_108 ) ;
} else
V_2 -> V_16 = false ;
V_2 -> V_9 = & V_328 -> V_9 ;
V_2 -> V_10 = F_62 ( V_328 -> V_9 . V_10 ) ;
V_2 -> V_31 = F_127 ( L_109 ) ;
F_128 ( & V_2 -> V_105 . V_240 ) ;
F_129 ( & V_2 -> V_135 ) ;
V_2 -> V_20 = false ;
V_2 -> V_235 = 0 ;
...
if ( V_2 -> V_165 . V_332 ) {
V_8 = F_138 ( V_2 -> V_9 , & V_2 -> V_165 . V_15 ) ;
if ( V_8 ) {
F_5 ( V_2 -> V_9 , L_117 ) ;
goto V_362;
}
...
if ( V_2 -> V_24 . V_332 ) {
V_8 = F_138 ( V_2 -> V_9 , & V_2 -> V_24 . V_15 ) ;
if ( V_8 ) {
F_5 ( V_2 -> V_9 , L_118 ) ;
goto V_363;
}
}
V_2 -> V_331 = F_139 ( V_364 ) ;
if ( F_140 ( V_2 -> V_331 ) ) {
F_5 ( V_2 -> V_9 , L_119 ) ;
V_8 = - V_282 ;
goto V_365;
...
for ( V_95 = 0 ; V_95 < F_28 ( V_330 ) ; V_95 ++ ) {
V_260 = F_115 ( V_328 , V_330 [ V_95 ] . V_198 ) ;
V_8 = F_142 ( V_260 , NULL , V_330 [ V_95 ] . V_368 ,
V_369 | V_370 ,
