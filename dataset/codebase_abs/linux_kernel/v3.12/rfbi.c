...
static void F_15 ( const void * V_11 , T_1 V_12 )
{
switch ( V_4 . V_13 ) {
case V_14 :
{
...
static void F_18 ( void * V_11 , T_1 V_12 )
{
switch ( V_4 . V_13 ) {
case V_14 :
{
...
static void F_19 ( const void * V_11 , T_1 V_12 )
{
switch ( V_4 . V_13 ) {
case V_14 :
{
...
static void F_20 ( const void T_4 * V_11 , int V_23 ,
T_3 V_24 , T_3 V_25 ,
T_3 V_18 , T_3 V_26 )
{
...
static int F_42 ( enum V_86 V_87 ,
...
static int F_43 ( bool V_102 , unsigned line )
{
T_1 V_37 ;
...
static int F_50 ( struct V_34 * V_35 , void (* F_24)( void * ) ,
void * V_36 )
{
return F_23 ( V_35 , F_24 , V_36 ) ;
}
static void F_51 ( struct V_34 * V_35 , T_3 V_18 , T_3 V_26 )
{
V_4 . V_43 . V_44 = V_18 ;
V_4 . V_43 . V_46 = V_26 ;
}
static void F_52 ( struct V_34 * V_35 , int V_121 )
{
V_4 . V_121 = V_121 ;
}
static void F_53 ( struct V_34 * V_35 , int V_122 )
{
V_4 . V_122 = V_122 ;
}
...
static void F_64 ( struct V_157 * V_7 )
{
struct V_34 * V_154 = & V_4 . V_40 ;
V_154 -> V_8 = & V_7 -> V_8 ;
V_154 -> V_158 = V_159 ;
...
static void T_5 F_66 ( struct V_157 * V_7 )
{
struct V_34 * V_154 = & V_4 . V_40 ;
F_67 ( V_154 ) ;
}
static int F_68 ( struct V_157 * V_7 )
{
T_1 V_167 ;
struct V_168 * V_169 ;
struct V_170 * V_170 ;
...
V_4 . V_7 = V_7 ;
F_69 ( & V_4 . V_10 , 1 ) ;
V_169 = F_70 ( V_4 . V_7 , V_171 , 0 ) ;
if ( ! V_169 ) {
F_38 ( L_21 ) ;
return - V_98 ;
}
V_4 . V_5 = F_71 ( & V_7 -> V_8 , V_169 -> V_172 ,
F_72 ( V_169 ) ) ;
if ( ! V_4 . V_5 ) {
F_38 ( L_22 ) ;
return - V_173 ;
}
V_170 = F_73 ( & V_7 -> V_8 , L_23 ) ;
if ( F_74 ( V_170 ) ) {
F_38 ( L_24 ) ;
return F_75 ( V_170 ) ;
}
V_4 . V_52 = F_76 ( V_170 ) / 1000 ;
F_77 ( V_170 ) ;
F_78 ( & V_7 -> V_8 ) ;
V_6 = F_5 () ;
if ( V_6 )
...
static int T_5 F_84 ( struct V_157 * V_7 )
{
F_66 ( V_7 ) ;
F_83 ( & V_7 -> V_8 ) ;
return 0 ;
}
static int F_85 ( struct V_175 * V_8 )
{
F_86 () ;
return 0 ;
}
static int F_87 ( struct V_175 * V_8 )
{
int V_6 ;
V_6 = F_88 () ;
if ( V_6 < 0 )
