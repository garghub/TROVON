...
V_31 = V_10 ;
else if ( memcmp ( V_10 -> V_35 . V_36 . V_28 , V_28 ,
V_37 ) == 0 ) {
V_32 = V_10 ;
break;
}
...
if ( V_10 -> type != V_34 )
continue;
if ( memcmp ( V_10 -> V_35 . V_36 . V_28 , V_28 ,
V_37 ) == 0 ) {
V_48 = V_10 ;
break;
}
...
T_3 F_26 ( T_2 * V_3 ,
void (* F_27)( struct V_50 * , int V_51 , void * ) ,
void * V_52 )
{
unsigned long V_47 ;
struct V_53 * V_54 ;
V_54 = F_28 ( sizeof( * V_54 ) , V_55 ) ;
if ( V_54 == NULL )
return 0 ;
V_54 -> F_27 = F_27 ;
V_54 -> V_52 = V_52 ;
...
int F_33 ( struct V_1 * V_7 , int V_62 , T_3 V_63 )
{
struct V_9 * V_10 ;
T_4 V_64 = F_34 ( V_63 ) ;
V_10 = F_3 ( V_7 ) ;
return V_10 -> V_3 -> F_27 -> V_65 ( V_7 , V_62 , & V_64 , 2 ) ;
}
int F_35 ( struct V_1 * V_7 , int V_62 , const char * V_63 )
{
struct V_9 * V_10 ;
char V_66 [ V_67 + 2 ] ;
int V_68 ;
...
return V_10 -> V_3 -> F_27 -> V_65 ( V_7 , V_62 , & V_66 , V_67 + 2 ) ;
}
T_3 F_36 ( T_2 * V_3 )
{
...
V_88 = V_87 ;
if ( V_3 -> F_27 -> V_93 ( V_3 -> V_7 , V_94 , & V_63 , 2 ,
1 ) < 0 ) {
F_11 ( V_22 L_8 ) ;
goto V_95;
}
...
if ( V_3 -> F_27 -> V_113 ( V_3 -> V_7 , V_119 ,
V_115 , & V_63 , NULL ) ) {
F_11 ( V_120 L_13 ,
V_3 -> V_7 -> V_6 ) ;
V_11 = - 1 ;
...
return F_33 ( V_3 -> V_7 , V_127 , V_63 ) ;
}
int F_42 ( T_2 * V_3 )
{
int V_63 = V_3 -> V_128 ;
if ( V_3 -> V_129 < F_43 ( 0 , 7 , 0 ) &&
V_63 != V_130 && V_63 != V_131 )
V_63 = V_130 ;
if ( F_33 ( V_3 -> V_7 , V_132 , V_63 ) ) {
F_11 ( V_120 L_15
...
void F_44 ( const char * V_6 , const struct V_133 * V_134 )
{
T_3 V_135 , V_136 ;
V_135 = F_45 ( V_134 -> V_135 ) ;
F_11 ( V_22 L_17
L_18
L_19 ,
V_6 , V_135 , ( V_135 >> 8 ) & 0x07 , V_135 >> 13 , V_135 & 1 ,
V_134 -> V_137 , V_134 -> signal , V_134 -> V_138 , V_134 -> V_139 , V_140 ) ;
V_136 = F_45 ( V_134 -> V_141 ) ;
F_11 ( V_22 L_20
L_21 ,
V_136 , ( V_136 & V_142 ) >> 2 ,
( V_136 & V_143 ) >> 4 ,
F_45 ( V_134 -> V_144 ) , F_45 ( V_134 -> V_145 ) ,
F_45 ( V_134 -> V_146 ) ,
...
void F_47 ( const char * V_6 , const struct V_155 * V_156 )
{
T_3 V_136 ;
F_11 ( V_22 L_27
L_28 ,
V_6 , F_45 ( V_156 -> V_135 ) , V_156 -> V_157 , V_156 -> V_158 ,
F_45 ( V_156 -> V_159 ) , V_140 ) ;
V_136 = F_45 ( V_156 -> V_141 ) ;
F_11 ( V_22 L_20
L_21 ,
V_136 , ( V_136 & V_142 ) >> 2 ,
( V_136 & V_143 ) >> 4 ,
F_45 ( V_156 -> V_144 ) , F_45 ( V_156 -> V_145 ) ,
F_45 ( V_156 -> V_146 ) ,
V_136 & V_147 ? L_22 : L_23 ,
V_136 & V_148 ? L_24 : L_23 ) ;
F_11 ( V_22 L_25 ,
...
static int F_48 ( const struct V_50 * V_160 ,
unsigned char * V_161 )
{
memcpy ( V_161 , F_49 ( V_160 ) + 10 , V_37 ) ;
return V_37 ;
}
int F_50 ( T_4 V_136 )
{
if ( F_51 ( V_136 ) && F_52 ( V_136 ) )
return 30 ;
else if ( F_53 ( V_136 ) || F_54 ( V_136 ) )
return 10 ;
else if ( F_55 ( V_136 ) )
return 16 ;
return 24 ;
...
( ! V_3 -> F_27 -> V_165 || V_3 -> F_27 -> V_165 ( V_3 ) ) &&
V_3 -> V_166 && V_3 -> V_39 && V_3 -> V_69 == V_167 )
F_60 ( V_7 , V_3 -> V_39 , 1 ) ;
#endif
if ( V_7 == V_3 -> V_7 ) {
V_3 -> F_27 -> V_168 ( V_7 , V_169 ) ;
}
if ( F_61 ( V_7 ) ) {
F_62 ( V_7 ) ;
F_63 ( V_7 ) ;
...
if ( ( V_3 -> F_27 -> V_165 && ! V_3 -> F_27 -> V_165 ( V_3 ) ) ||
V_3 -> V_180 )
return - V_49 ;
if ( ! F_69 ( V_3 -> V_175 ) )
return - V_49 ;
V_3 -> V_176 ++ ;
if ( ! V_3 -> V_181 && V_3 -> F_27 -> V_182 ( V_7 , 1 ) ) {
F_11 ( V_21 L_33 ,
V_7 -> V_6 ) ;
F_56 ( V_7 ) ;
return - V_49 ;
...
static int F_74 ( struct V_1 * V_7 , void * V_184 )
{
struct V_9 * V_10 ;
T_2 * V_3 ;
struct V_29 * V_30 ;
...
V_10 = F_3 ( V_7 ) ;
V_3 = V_10 -> V_3 ;
if ( V_3 -> F_27 -> V_65 ( V_7 , V_186 , V_27 -> V_187 ,
V_37 ) < 0 || V_3 -> F_27 -> V_188 ( V_7 ) )
return - V_44 ;
F_18 ( & V_3 -> V_33 ) ;
F_19 (ptr, &local->hostap_interfaces) {
V_10 = F_20 ( V_30 , struct V_9 , V_12 ) ;
...
void F_75 ( struct V_190 * V_191 )
{
T_2 * V_3 =
F_76 ( V_191 , T_2 , V_171 ) ;
...
static int F_78 ( struct V_1 * V_7 , int V_194 )
{
...
if ( ! V_3 -> V_129 )
V_11 = - 1 ;
else if ( V_3 -> V_129 >= F_43 ( 1 , 3 , 1 ) ) {
if ( V_3 -> F_27 -> V_93 ( V_3 -> V_7 ,
V_229 ,
& V_228 , sizeof( V_228 ) , 1 ) >= 0 ) {
V_3 -> V_230 = ( V_231 ) F_89 ( V_228 . V_232 ) ;
V_3 -> V_233 = ( V_231 ) F_89 ( V_228 . V_234 ) ;
V_3 -> V_235 = ( V_231 ) F_89 ( V_228 . V_236 ) ;
V_3 -> V_237 = V_140 ;
} else
V_11 = - 1 ;
} else {
if ( V_3 -> F_27 -> V_93 ( V_3 -> V_7 , V_238 ,
& V_228 , sizeof( V_228 ) , 1 ) >= 0 ) {
V_3 -> V_230 = F_89 ( V_228 . V_232 ) ;
V_3 -> V_233 = F_90 (
F_89 ( V_228 . V_234 ) ) ;
V_3 -> V_235 = F_90 (
F_89 ( V_228 . V_236 ) ) ;
...
int F_91 ( T_2 * V_3 , T_1 * V_239 , T_3 V_240 ,
T_1 * V_241 , T_5 V_242 )
{
struct V_50 * V_160 ;
struct V_243 * V_244 ;
...
if ( V_3 -> V_69 != V_74 ||
F_97 ( V_3 -> V_251 ) ||
memcmp ( V_3 -> V_251 , L_45 , V_37 ) == 0 )
return 0 ;
V_11 = F_91 ( V_3 , V_3 -> V_251 , V_257 ,
( T_1 * ) & V_63 , 2 ) ;
memset ( V_256 . V_258 . V_187 , 0 , V_37 ) ;
F_98 ( V_3 -> V_7 , V_259 , & V_256 , NULL ) ;
return V_11 ;
}
static int T_6 F_99 ( void )
{
if ( V_260 . V_261 != NULL ) {
V_262 = F_100 ( L_46 , V_260 . V_261 ) ;
if ( ! V_262 )
F_11 ( V_21 L_47
L_48 ) ;
} else
