...
V_50 -> V_51 = V_51 ;
F_5 ( V_50 -> V_11 . V_12 ,
V_44 [ V_51 ] . V_53 , 0x0000 ) ;
return 1 ;
}
static void F_22 ( unsigned long V_54 )
{
struct V_8 * V_50 = (struct V_8 * ) V_54 ;
...
V_55 = ( int ) F_26 () ;
F_27 ( V_11 , 0x80c6 , & V_55 , 4 ) ;
F_5 ( V_12 , 0x0301 , 0x0000 ) ;
switch ( V_12 -> V_56 . V_57 ) {
case V_58 :
case V_59 :
case V_60 :
case V_61 :
...
F_25 ( V_50 ) ;
F_38 ( & V_50 -> V_72 ) ;
V_50 -> V_72 . V_73 = V_74 + V_75 * V_28 ;
V_50 -> V_72 . V_76 = F_22 ;
V_50 -> V_72 . V_77 = ( unsigned long ) V_50 ;
F_39 ( & V_50 -> V_72 ) ;
return 0 ;
}
...
V_50 = F_4 ( V_7 ) ;
F_43 ( & V_50 -> V_72 ) ;
if ( F_1 ( V_50 -> V_11 . V_12 -> V_56 . V_57 ) ) {
F_44 ( & V_7 -> V_5 , & V_70 ) ;
F_44 ( & V_7 -> V_5 , & V_71 ) ;
}
if ( V_50 != NULL ) {
