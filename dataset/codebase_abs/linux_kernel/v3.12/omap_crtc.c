...
static void F_53 ( struct V_82 * V_83 , T_1 V_84 )
{
struct V_3 * V_3 =
F_36 ( V_83 , struct V_3 , V_22 ) ;
struct V_1 * V_2 = & V_3 -> V_46 ;
if ( ! V_3 -> V_25 . V_23 )
F_54 ( V_2 -> V_24 , & V_3 -> V_25 ) ;
if ( ! F_55 ( V_3 -> V_4 ) ) {
struct V_30 * V_31 =
V_2 -> V_24 -> V_32 ;
F_10 ( L_7 , V_3 -> V_17 ) ;
F_18 ( V_2 -> V_24 , & V_3 -> V_22 ) ;
...
static void F_66 ( struct V_1 * V_2 , bool V_97 )
{
struct V_60 * V_24 = V_2 -> V_24 ;
struct V_3 * V_3 = F_2 ( V_2 ) ;
enum V_81 V_4 = V_3 -> V_4 ;
...
F_69 ( V_4 , V_97 ) ;
if ( V_99 ) {
int V_100 = V_98 ( V_24 , V_99 , F_70 ( 100 ) ) ;
if ( V_100 ) {
F_44 ( V_24 -> V_24 , L_9 ,
...
static void F_71 ( struct V_86 * V_36 )
{
struct V_3 * V_3 =
...
static void F_76 ( struct V_86 * V_36 )
{
}
void F_77 ( void )
{
...
struct V_1 * F_79 ( struct V_60 * V_24 ,
