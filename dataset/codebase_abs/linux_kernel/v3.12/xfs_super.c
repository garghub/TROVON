...
if ( F_54 ( V_197 ) )
goto V_201;
ASSERT ( F_55 ( V_199 -> V_202 ) || V_199 -> V_203 == 0 ) ;
F_56 ( ! F_57 ( V_199 , V_204 ) ) ;
F_56 ( ! F_57 ( V_199 , V_205 ) ) ;
V_201:
F_58 ( V_199 ) ;
}
STATIC void
...
{
struct V_198 * V_199 = F_51 ( V_197 ) ;
return F_73 ( V_197 ) || ( V_199 -> V_218 & V_219 ) ;
}
STATIC void
F_74 (
struct V_9 * V_10 )
...
struct V_226 * V_227 )
{
struct V_9 * V_10 = F_77 ( V_225 -> V_228 ) ;
T_4 * V_140 = & V_10 -> V_141 ;
struct V_198 * V_199 = F_51 ( V_225 -> V_229 ) ;
T_2 V_230 , V_231 ;
T_11 V_232 ;
T_12 V_233 ;
V_227 -> V_234 = V_235 ;
V_227 -> V_236 = V_22 - 1 ;
V_231 = F_86 ( V_10 -> V_168 -> V_237 ) ;
V_227 -> V_238 . V_239 [ 0 ] = ( V_240 ) V_231 ;
V_227 -> V_238 . V_239 [ 1 ] = ( V_240 ) ( V_231 >> 32 ) ;
F_87 ( V_10 , V_241 ) ;
F_88 ( & V_10 -> V_242 ) ;
V_227 -> V_243 = V_140 -> V_179 ;
V_232 = V_140 -> V_244 ? V_140 -> V_245 : 0 ;
V_227 -> V_246 = V_140 -> V_150 - V_232 ;
V_227 -> V_247 = V_227 -> V_248 =
V_140 -> V_249 - F_89 ( V_10 ) ;
V_230 = V_227 -> V_247 << V_140 -> V_250 ;
V_227 -> V_251 =
F_90 ( V_140 -> V_252 + V_230 , ( T_2 ) V_253 ) ;
if ( V_10 -> V_148 )
V_227 -> V_251 = F_91 ( F_92 ( V_227 -> V_251 ) ,
V_227 -> V_251 ,
V_10 -> V_148 ) ;
V_233 = V_227 -> V_251 - ( V_140 -> V_252 - V_140 -> V_254 ) ;
V_227 -> V_255 = F_93 ( T_12 , V_233 , 0 ) ;
F_94 ( & V_10 -> V_242 ) ;
if ( ( V_199 -> V_256 . V_257 & V_258 ) &&
( ( V_10 -> V_82 & ( V_96 | V_98 ) ) ) ==
( V_96 | V_98 ) )
F_95 ( V_199 , V_227 ) ;
return 0 ;
...
{
T_2 V_259 = 0 ;
V_10 -> V_260 = V_10 -> V_261 ;
F_97 ( V_10 , & V_259 , NULL ) ;
}
STATIC void
...
char * V_266 ;
int error ;
while ( ( V_266 = F_5 ( & V_11 , L_1 ) ) != NULL ) {
int V_267 ;
if ( ! * V_266 )
continue;
V_267 = F_108 ( V_266 , V_268 , args ) ;
switch ( V_267 ) {
case V_269 :
V_10 -> V_28 |= V_34 ;
break;
...
break;
case V_271 :
V_10 -> V_272 = F_24 ( V_10 ) ;
break;
case V_273 :
V_10 -> V_272 = F_18 ( V_10 ) ;
break;
default:
#if 0
xfs_info(mp,
...
if ( ( V_10 -> V_28 & V_29 ) && ! ( * V_264 & V_27 ) ) {
V_10 -> V_28 &= ~ V_29 ;
if ( V_10 -> V_274 ) {
error = F_109 ( V_10 , V_10 -> V_274 ) ;
if ( error ) {
F_6 ( V_10 , L_37 ) ;
return error ;
}
...
struct V_225 * V_275 )
{
return - F_12 ( F_77 ( V_275 -> V_228 ) , V_123 ) ;
}
STATIC int
F_115 (
struct V_9 * V_10 )
...
F_122 ( & V_10 -> V_284 ) ;
F_62 ( & V_10 -> V_262 , 0 ) ;
F_123 ( & V_10 -> V_285 , V_286 ) ;
F_123 ( & V_10 -> V_287 , V_288 ) ;
V_10 -> V_14 = V_13 ;
V_13 -> V_289 = V_10 ;
...
goto V_303;
V_13 -> V_304 = V_235 ;
V_13 -> V_305 = V_10 -> V_141 . V_179 ;
V_13 -> V_306 = F_7 ( V_13 -> V_305 ) - 1 ;
V_13 -> V_307 = F_16 ( V_13 -> V_306 ) ;
V_13 -> V_308 = V_309 ;
V_13 -> V_310 = 1 ;
F_128 ( V_13 ) ;
if ( F_129 ( & V_10 -> V_141 ) == V_311 )
V_13 -> V_26 |= V_312 ;
error = F_130 ( V_10 ) ;
if ( error )
goto V_313;
V_275 = F_131 ( F_61 ( V_10 -> V_314 ) ) ;
if ( ! V_275 ) {
error = V_315 ;
goto V_316;
}
...
void * V_282 )
{
return F_134 ( V_319 , V_264 , V_320 , V_282 , F_120 ) ;
}
static long
F_135 (
struct V_12 * V_13 ,
...
int V_321 )
{
return F_138 ( F_77 ( V_13 ) , V_322 ) ;
}
STATIC int T_14
F_139 ( void )
{
V_323 = F_140 ( sizeof( V_324 ) , L_43 ) ;
if ( ! V_323 )
goto V_174;
V_325 = F_141 ( 4 * V_326 ,
V_323 ) ;
if ( ! V_325 )
goto V_327;
V_328 = F_140 ( sizeof( V_329 ) ,
L_44 ) ;
if ( ! V_328 )
goto V_330;
V_331 = F_140 ( sizeof( V_332 ) ,
L_45 ) ;
if ( ! V_331 )
goto V_333;
V_334 = F_140 ( sizeof( V_335 ) ,
L_46 ) ;
if ( ! V_334 )
goto V_336;
V_337 = F_140 ( sizeof( V_338 ) ,
L_47 ) ;
if ( ! V_337 )
goto V_339;
V_340 = F_140 ( sizeof( V_341 ) , L_48 ) ;
if ( ! V_340 )
goto V_342;
V_343 = F_140 ( sizeof( V_344 ) , L_49 ) ;
if ( ! V_343 )
goto V_345;
V_346 =
F_140 ( sizeof( struct V_347 ) ,
L_50 ) ;
if ( ! V_346 )
goto V_348;
V_349 = F_140 ( sizeof( struct V_350 ) ,
L_51 ) ;
if ( ! V_349 )
goto V_351;
V_352 = F_140 ( ( sizeof( V_353 ) +
( ( V_354 - 1 ) *
sizeof( V_355 ) ) ) , L_52 ) ;
if ( ! V_352 )
goto V_356;
V_357 = F_140 ( ( sizeof( V_358 ) +
( ( V_359 - 1 ) *
sizeof( V_355 ) ) ) , L_53 ) ;
if ( ! V_357 )
goto V_360;
...
goto V_365;
V_366 =
F_142 ( sizeof( V_367 ) , L_55 ,
V_364 , NULL ) ;
if ( ! V_366 )
goto V_368;
V_369 = F_140 ( sizeof( struct V_370 ) ,
L_56 ) ;
if ( ! V_369 )
goto V_371;
return 0 ;
