...
int
F_8 ( struct V_1 * V_2 , const char * V_9 , ... )
{
T_1 V_10 ;
int V_3 ;
int V_11 ;
...
int
F_9 ( struct V_1 * V_2 , const char * V_9 , T_1 args )
{
int V_3 ;
int V_11 ;
F_4 ( V_2 ) ;
...
int F_10 ( struct V_1 * V_2 , const char * V_13 )
{
int V_3 ;
F_4 ( V_2 ) ;
V_3 = strlen ( V_13 ) ;
...
int F_11 ( struct V_1 * V_2 , unsigned char V_14 )
{
F_4 ( V_2 ) ;
