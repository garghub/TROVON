...
static bool F_101 ( struct V_158 * V_151 , void * V_159 )
{
...
static int F_104 ( struct V_13 * V_14 , struct V_31 * V_32 ,
int V_163 )
{
struct V_5 * V_6 = F_11 ( V_14 ) ;
T_1 V_109 = F_13 ( V_14 ) ? V_131 : V_132 ;
T_1 V_92 = V_163 ? V_164 : 0 ;
F_62 ( V_14 , V_85 , V_164 , V_92 ) ;
F_105 ( V_32 -> V_151 ) ;
if ( F_12 ( V_14 ) )
F_82 ( V_6 , V_133 , V_109 , ( V_92 ) ? V_109 : 0 ) ;
return 0 ;
...
F_107 ( V_3 ) ;
F_108 ( V_165 , V_3 ) ;
V_32 -> V_151 = F_109 ( V_3 , F_101 , & V_32 -> V_161 ) ;
if ( ! V_32 -> V_151 ) {
if ( F_22 ( V_14 , V_32 ) )
V_14 -> V_49 . V_166 = & V_167 ;
else
V_14 -> V_53 . V_166 = & V_168 ;
F_110 ( V_66 , L_31 ) ;
return F_38 ( V_14 , V_66 ) ;
}
F_111 ( & V_32 -> V_147 , F_95 ) ;
return 0 ;
}
...
T_1 V_35 , V_121 ;
int V_169 ;
V_35 = F_117 ( V_6 , V_170 ) ;
V_35 >>= F_21 ( V_14 , V_32 ) ;
V_35 &= V_171 ;
V_169 = 256 << V_35 ;
F_41 ( V_66 , L_32 , V_169 ) ;
for ( V_121 = 1 ; V_121 < V_14 -> V_41 ; V_121 <<= 1 )
V_169 >>= 1 ;
F_41 ( V_66 , L_33 ,
V_14 -> V_41 , V_169 ) ;
V_32 -> V_130 = F_23 ( V_14 , V_169 ) ;
if ( V_33 ) {
F_28 ( V_14 , V_172 , V_173 ) ;
F_62 ( V_14 , V_172 , V_157 , V_157 ) ;
} else {
F_28 ( V_14 , V_156 , V_173 ) ;
F_62 ( V_14 , V_156 , V_157 , V_157 ) ;
}
}
...
if ( F_12 ( V_14 ) )
V_2 = V_174 | V_175 ;
F_62 ( V_14 , V_106 , ( V_174 | V_175 ) , V_2 ) ;
V_2 = 0 ;
if ( V_14 -> V_176 )
V_2 |= ( 1 << 0 ) ;
if ( V_14 -> V_177 )
...
static int F_123 ( struct V_18 * V_19 , int V_181 ,
struct V_22 * V_27 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
...
static void F_139 ( struct V_204 * V_205 )
{
F_140 ( V_205 ) ;
}
static int F_141 ( struct V_23 * V_24 )
{
struct V_204 * V_205 = V_24 -> V_205 ;
return F_142 (
V_205 ,
V_206 ,
F_143 ( V_207 ) ,
...
for ( V_121 = 0 ; V_121 < F_145 ( V_216 ) ; V_121 ++ ) {
sprintf ( V_215 , L_37 , V_210 , V_216 [ V_121 ] . V_210 ) ;
if ( F_146 ( V_212 , V_215 , NULL ) )
V_8 |= V_216 [ V_121 ] . V_4 ;
}
V_214 -> V_8 = V_8 ;
F_41 ( V_66 , L_38 , V_210 , V_214 -> V_8 ) ;
}
...
V_14 -> V_53 . V_55 = V_14 ;
if ( V_214 -> V_220 ) {
V_14 -> V_49 . V_161 . V_221 . V_222 = V_214 -> V_220 ;
V_14 -> V_49 . V_166 = & V_223 ;
}
}
static int F_149 ( struct V_224 * V_225 )
{
struct V_5 * V_6 ;
struct V_211 * V_212 = V_225 -> V_66 . V_226 ;
struct V_227 V_214 ;
const struct V_228 * V_11 ;
struct V_13 * V_14 ;
struct V_229 * V_230 ;
unsigned int V_134 ;
int V_7 ;
...
V_232 = F_150 ( V_233 , & V_225 -> V_66 ) ;
if ( V_232 ) {
V_11 = V_232 -> V_2 ;
F_144 ( L_39 , V_212 , & V_214 . V_234 , & V_225 -> V_66 ) ;
F_144 ( L_40 , V_212 , & V_214 . V_235 , & V_225 -> V_66 ) ;
}
} else {
const struct V_236 * V_237 = V_225 -> V_237 ;
if ( V_237 )
V_11 = (struct V_228 * ) V_237 -> V_238 ;
if ( V_225 -> V_66 . V_239 )
memcpy ( & V_214 , V_225 -> V_66 . V_239 , sizeof( V_214 ) ) ;
}
if ( ! V_11 ) {
F_36 ( & V_225 -> V_66 , L_41 ) ;
return - V_240 ;
}
V_230 = F_151 ( V_225 , V_241 , 0 ) ;
V_134 = F_152 ( V_225 , 0 ) ;
if ( ! V_230 || ( int ) V_134 <= 0 ) {
F_36 ( & V_225 -> V_66 , L_42 ) ;
return - V_240 ;
}
V_6 = F_153 ( & V_225 -> V_66 , sizeof( * V_6 ) , V_207 ) ;
if ( ! V_6 ) {
F_36 ( & V_225 -> V_66 , L_43 ) ;
return - V_242 ;
}
V_6 -> V_10 = F_154 ( & V_225 -> V_66 ,
V_230 -> V_163 , F_155 ( V_230 ) ) ;
if ( ! V_6 -> V_10 ) {
F_36 ( & V_225 -> V_66 , L_44 ) ;
return - V_243 ;
}
V_6 -> V_11 = V_11 ;
F_156 ( & V_6 -> V_9 ) ;
...
V_14 -> V_10 = V_6 -> V_10 ;
V_14 -> V_6 = V_6 ;
F_147 ( V_14 , & V_214 . V_234 ) ;
F_148 ( V_14 , & V_214 . V_234 ) ;
V_7 = F_38 ( V_14 , & V_225 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_225 -> V_66 , L_45 ) ;
return V_7 ;
}
V_14 = & V_6 -> V_30 ;
V_14 -> V_10 = V_6 -> V_10 + 0x40 ;
V_14 -> V_6 = V_6 ;
F_147 ( V_14 , & V_214 . V_235 ) ;
F_148 ( V_14 , & V_214 . V_235 ) ;
V_7 = F_38 ( V_14 , & V_225 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_225 -> V_66 , L_46 ) ;
goto V_244;
}
F_157 ( & V_225 -> V_66 ) ;
F_158 ( & V_225 -> V_66 , V_6 ) ;
V_7 = F_159 ( & V_225 -> V_66 , V_134 , & F_86 , 0 ,
F_160 ( & V_225 -> V_66 ) , V_6 ) ;
if ( V_7 ) {
F_36 ( & V_225 -> V_66 , L_47 ) ;
goto V_245;
}
V_7 = F_161 ( & V_225 -> V_66 , & V_246 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_225 -> V_66 , L_48 ) ;
goto V_245;
}
V_7 = F_162 ( & V_225 -> V_66 , & V_247 ,
V_248 , F_145 ( V_248 ) ) ;
if ( V_7 < 0 ) {
F_36 ( & V_225 -> V_66 , L_49 ) ;
goto V_249;
}
return V_7 ;
V_249:
...
static int F_165 ( struct V_224 * V_225 )
{
struct V_5 * V_6 ;
V_6 = F_166 ( & V_225 -> V_66 ) ;
F_164 ( & V_225 -> V_66 ) ;
F_167 ( & V_225 -> V_66 ) ;
F_163 ( & V_225 -> V_66 ) ;
F_39 ( & V_6 -> V_29 ) ;
