...
{
struct V_35 * V_36 = & V_2 -> V_36 ;
const struct V_157 * V_158 = F_72 ( V_36 ) ;
struct V_3 * V_4 ;
int V_82 ;
if ( ! V_14 )
return - V_149 ;
if ( ! F_73 ( V_2 -> V_159 , V_160
| V_161
| V_162 ) )
return - V_149 ;
...
V_82 = F_76 ( & V_36 -> V_164 , & V_4 -> V_102 ) ;
if ( V_82 ) {
F_70 ( V_36 , L_20 ) ;
goto V_163;
}
...
return 0 ;
V_166:
F_80 ( & V_36 -> V_164 , & V_4 -> V_102 ) ;
V_163:
F_81 ( V_4 -> V_102 . V_103 ) ;
return V_82 ;
}
