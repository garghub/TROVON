...
F_40 ( V_25 , V_54 , & V_25 -> V_38 -> V_39 . V_59 ) ;
V_25 -> V_31 &= ~ V_60 ;
} else if ( F_41 () ) {
F_17 ( V_25 ) -> V_48 = 0 ;
}
...
if ( V_64 -> V_69 [ 0 ] . V_31 != V_70
|| V_64 -> V_69 [ 1 ] . V_31 != V_71 ) {
F_45 ( V_68 L_7 ) ;
return - V_53 ;
}
V_5 = F_46 ( & V_64 -> V_72 , L_8 ) ;
if ( F_47 ( V_5 ) )
return F_48 ( V_5 ) ;
if ( ! F_34 () )
V_4 = F_46 ( & V_64 -> V_72 , L_9 ) ;
else
V_4 = F_46 ( & V_64 -> V_72 , L_10 ) ;
if ( F_47 ( V_4 ) ) {
F_49 ( V_5 ) ;
return F_48 ( V_4 ) ;
}
V_27 = F_50 ( V_62 , & V_64 -> V_72 , F_51 ( & V_64 -> V_72 ) ) ;
if ( ! V_27 ) {
V_65 = - V_73 ;
goto V_74;
}
V_27 -> V_75 = V_64 -> V_69 [ 0 ] . V_76 ;
V_27 -> V_77 = V_64 -> V_69 [ 0 ] . V_78 - V_64 -> V_69 [ 0 ] . V_76 + 1 ;
if ( ! F_52 ( V_27 -> V_75 , V_27 -> V_77 , V_79 ) ) {
F_25 ( & V_64 -> V_72 , L_11 ) ;
V_65 = - V_80 ;
goto V_81;
}
V_27 -> V_38 = F_53 ( V_27 -> V_75 , V_27 -> V_77 ) ;
if ( ! V_27 -> V_38 ) {
F_33 ( & V_64 -> V_72 , L_12 ) ;
V_65 = - V_73 ;
goto V_82;
...
static inline void
F_60 ( struct V_26 * V_27 , struct V_63 * V_64 )
{
F_61 ( V_27 ) ;
if ( ! F_30 ( V_27 -> V_33 ) ) {
...
if ( ! V_84 )
return 0 ;
V_44 = F_24 ( V_27 -> V_29 . V_45 ) ;
if ( V_44 -> V_34 || V_44 -> V_87 ) {
V_25 -> V_88 = V_89 ;
F_20 ( V_89 , & V_25 -> V_38 -> V_90 ) ;
}
if ( ( V_47 = F_64 ( V_25 ) ) < 0 ) {
F_33 ( V_27 -> V_29 . V_45 , L_13 ) ;
F_43 ( V_27 ) ;
return V_47 ;
}
return 0 ;
}
static int F_65 ( struct V_63 * V_72 )
{
return F_44 ( & V_91 , V_72 ) ;
}
static int F_66 ( struct V_63 * V_72 )
{
struct V_26 * V_27 = F_67 ( V_72 ) ;
F_60 ( V_27 , V_72 ) ;
return 0 ;
}
static int F_68 ( struct V_63 * V_72 , T_2 V_92 )
{
struct V_24 * V_25 = F_23 ( F_67 ( V_72 ) ) ;
if ( F_69 ( V_93 , V_25 -> V_94 ) )
F_70 ( 5 ) ;
V_25 -> V_94 = V_93 ;
F_2 ( 0 ) ;
return 0 ;
}
static int F_71 ( struct V_63 * V_72 )
{
struct V_26 * V_27 = F_67 ( V_72 ) ;
struct V_24 * V_25 = F_23 ( V_27 ) ;
if ( F_69 ( V_93 , V_25 -> V_94 ) )
