...
if ( V_212 -> V_165 . V_247 ) {
V_218 = F_111 ( V_212 -> V_165 . V_247 ) ;
if ( V_218 )
memcpy ( V_2 -> V_148 , V_218 , V_143 ) ;
} else {
struct V_248 * V_101 ;
V_101 = F_112 ( & V_212 -> V_165 ) ;
if ( ! V_101 ) {
F_91 ( V_23 , L_16 ) ;
V_94 = - V_242 ;
goto V_249;
...
F_117 ( V_23 ) ;
V_223:
F_118 ( V_216 -> V_220 , F_101 ( V_216 ) ) ;
V_222:
F_118 ( V_215 -> V_220 , F_101 ( V_215 ) ) ;
V_221:
return V_94 ;
}
static int F_119 ( struct V_211 * V_212 )
{
struct V_53 * V_23 = F_120 ( V_212 ) ;
struct V_1 * V_2 = F_36 ( V_23 ) ;
struct V_214 * V_250 = F_99 ( V_212 , V_219 , 0 ) ;
F_121 ( V_2 -> V_57 ) ;
F_115 ( V_23 ) ;
F_116 ( V_2 -> V_10 ) ;
F_117 ( V_23 ) ;
F_118 ( V_250 -> V_220 , F_101 ( V_250 ) ) ;
return 0 ;
}
