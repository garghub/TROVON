...
static void F_11 ( unsigned int V_12 , struct V_14 * V_15 )
{
...
V_26 = F_21 ( V_23 , struct V_25 , V_23 ) ;
V_3 = F_16 ( V_26 -> V_19 ) ;
V_20 = F_19 ( V_3 , V_24 ) ;
...
V_23 -> V_66 = F_22 ;
V_23 -> V_67 = F_27 ;
V_23 -> V_27 = V_44 -> V_23 [ V_38 ] . V_68 ;
V_23 -> V_40 = V_44 -> V_23 [ V_38 ] . V_69 ;
F_38 ( V_23 ) ;
}
F_28 ( V_3 ) ;
V_3 -> V_13 = V_44 -> V_70 ;
...
static int T_3 F_47 ( struct V_41 * V_42 )
{
...
static int F_49 ( struct V_41 * V_42 , T_4 V_80 )
{
struct V_2 * V_3 = F_48 ( V_42 ) ;
if ( V_3 -> V_52 && F_50 ( & V_42 -> V_19 ) )
F_51 ( V_3 -> V_52 ) ;
return 0 ;
}
