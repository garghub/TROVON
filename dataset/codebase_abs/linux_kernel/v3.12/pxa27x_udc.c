...
static T_4 F_137 ( int V_250 , void * V_265 )
{
...
static int F_139 ( struct V_268 * V_269 )
{
struct V_270 * V_271 ;
...
return V_5 -> V_250 ;
V_5 -> V_90 = & V_269 -> V_90 ;
V_5 -> V_196 = F_142 ( & V_269 -> V_90 ) ;
V_5 -> V_208 = F_143 ( V_276 ) ;
V_273 = V_5 -> V_196 -> V_197 ;
if ( F_99 ( V_273 ) ) {
V_222 = F_144 ( V_273 , L_86 ) ;
if ( V_222 == 0 )
F_145 ( V_273 ,
V_5 -> V_196 -> V_198 ) ;
}
...
V_5 -> V_212 = F_146 ( & V_269 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_212 ) ) {
V_222 = F_147 ( V_5 -> V_212 ) ;
goto V_277;
}
V_222 = - V_278 ;
V_5 -> V_271 = F_148 ( V_271 -> V_279 , F_149 ( V_271 ) ) ;
if ( ! V_5 -> V_271 ) {
...
V_222 = F_152 ( & V_269 -> V_90 , & V_5 -> V_78 ) ;
if ( V_222 )
goto V_284;
F_14 ( V_5 ) ;
return 0 ;
...
static int F_156 ( struct V_268 * V_265 )
{
struct V_4 * V_5 = F_157 ( V_265 ) ;
...
static void F_162 ( struct V_268 * V_265 )
{
struct V_4 * V_5 = F_157 ( V_265 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_109 ( V_5 ) ;
}
static int F_163 ( struct V_268 * V_265 , T_5 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_157 ( V_265 ) ;
struct V_44 * V_45 ;
...
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_285 = F_9 ( V_45 , V_56 ) ;
V_45 -> V_286 = F_9 ( V_45 , V_17 ) ;
F_42 ( V_45 , L_90 ,
V_45 -> V_285 , V_45 -> V_286 ) ;
}
F_109 ( V_5 ) ;
V_5 -> V_287 = V_5 -> V_202 ;
F_98 ( V_5 , 0 ) ;
...
static int F_164 ( struct V_268 * V_265 )
{
int V_48 ;
struct V_4 * V_5 = F_157 ( V_265 ) ;
struct V_44 * V_45 ;
...
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
F_35 ( V_45 , V_56 , V_45 -> V_285 ) ;
F_35 ( V_45 , V_17 , V_45 -> V_286 ) ;
F_42 ( V_45 , L_90 ,
V_45 -> V_285 , V_45 -> V_286 ) ;
}
F_98 ( V_5 , V_5 -> V_287 ) ;
