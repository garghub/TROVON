...
static int F_12 ( struct V_16 * V_24 ,
unsigned int V_25 )
{
...
V_54 = F_17 ( V_2 -> V_12 , F_15 ( V_2 -> V_11 ) / V_52 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_17 ( V_2 -> V_13 , F_15 ( V_2 -> V_12 ) / V_53 ) ;
if ( V_54 )
return V_54 ;
F_5 ( V_2 , V_23 -> V_6 ) ;
return 0 ;
}
static int F_18 ( struct V_16 * V_24 , int V_63 ,
unsigned int V_64 , int V_65 )
{
struct V_1 * V_2 = F_11 ( V_24 ) ;
if ( V_65 == V_66 || V_63 != 0 )
return - V_36 ;
return F_17 ( V_2 -> V_11 , V_64 ) ;
}
...
struct V_70 * V_71 ;
int V_54 ;
V_2 = F_22 ( & V_69 -> V_72 , sizeof( * V_2 ) , V_73 ) ;
if ( ! V_2 )
return - V_74 ;
V_71 = F_23 ( V_69 , V_75 , 0 ) ;
V_2 -> V_5 = F_24 ( & V_69 -> V_72 , V_71 ) ;
if ( F_25 ( V_2 -> V_5 ) )
return F_26 ( V_2 -> V_5 ) ;
V_2 -> V_11 = F_27 ( & V_69 -> V_72 , L_1 ) ;
if ( F_25 ( V_2 -> V_11 ) ) {
V_54 = F_26 ( V_2 -> V_11 ) ;
goto V_76;
}
V_2 -> V_12 = F_27 ( & V_69 -> V_72 , L_2 ) ;
if ( F_25 ( V_2 -> V_12 ) ) {
V_54 = F_26 ( V_2 -> V_12 ) ;
goto V_77;
}
V_2 -> V_13 = F_27 ( & V_69 -> V_72 , L_3 ) ;
if ( F_25 ( V_2 -> V_13 ) ) {
V_54 = F_26 ( V_2 -> V_13 ) ;
goto V_78;
}
F_28 ( & V_69 -> V_72 , V_2 ) ;
V_54 = F_29 ( & V_69 -> V_72 , & V_79 ,
& V_80 , 1 ) ;
if ( V_54 )
goto V_81;
return 0 ;
