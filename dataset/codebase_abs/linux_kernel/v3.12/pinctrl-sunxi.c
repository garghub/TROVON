...
V_63 = V_51 / 10 - 1 ;
V_38 = F_27 ( V_3 -> V_65 + F_28 ( V_60 -> V_20 ) ) ;
V_62 = V_66 << F_29 ( V_60 -> V_20 ) ;
F_30 ( ( V_38 & ~ V_62 )
| V_63 << F_29 ( V_60 -> V_20 ) ,
V_3 -> V_65 + F_28 ( V_60 -> V_20 ) ) ;
break;
case V_56 :
V_38 = F_27 ( V_3 -> V_65 + F_31 ( V_60 -> V_20 ) ) ;
V_62 = V_67 << F_32 ( V_60 -> V_20 ) ;
F_30 ( ( V_38 & ~ V_62 ) | 1 << F_32 ( V_60 -> V_20 ) ,
V_3 -> V_65 + F_31 ( V_60 -> V_20 ) ) ;
break;
case V_57 :
V_38 = F_27 ( V_3 -> V_65 + F_31 ( V_60 -> V_20 ) ) ;
V_62 = V_67 << F_32 ( V_60 -> V_20 ) ;
F_30 ( ( V_38 & ~ V_62 ) | 2 << F_32 ( V_60 -> V_20 ) ,
V_3 -> V_65 + F_31 ( V_60 -> V_20 ) ) ;
break;
default:
break;
...
T_2 V_38 , V_62 ;
F_23 ( & V_3 -> V_64 , V_61 ) ;
V_38 = F_27 ( V_3 -> V_65 + F_37 ( V_20 ) ) ;
V_62 = V_69 << F_38 ( V_20 ) ;
F_30 ( ( V_38 & ~ V_62 ) | V_59 << F_38 ( V_20 ) ,
V_3 -> V_65 + F_37 ( V_20 ) ) ;
F_26 ( & V_3 -> V_64 , V_61 ) ;
}
...
T_2 V_78 = F_49 ( V_73 ) ;
T_3 V_79 = F_50 ( V_73 ) ;
T_2 V_38 = ( F_27 ( V_3 -> V_65 + V_78 ) >> V_79 ) & V_80 ;
return V_38 ;
}
...
T_2 V_82 ;
F_23 ( & V_3 -> V_64 , V_61 ) ;
V_82 = F_27 ( V_3 -> V_65 + V_78 ) ;
if ( V_81 )
V_82 |= F_54 ( V_79 ) ;
else
V_82 &= ~ ( F_54 ( V_79 ) ) ;
F_30 ( V_82 , V_3 -> V_65 + V_78 ) ;
F_26 ( & V_3 -> V_64 , V_61 ) ;
}
...
V_82 = F_27 ( V_3 -> V_65 + V_78 ) ;
V_82 &= ~ V_107 ;
F_30 ( V_82 | ( V_96 << V_79 ) , V_3 -> V_65 + V_78 ) ;
F_26 ( & V_3 -> V_64 , V_61 ) ;
return 0 ;
}
...
T_2 V_38 ;
F_23 ( & V_3 -> V_64 , V_61 ) ;
V_38 = F_27 ( V_3 -> V_65 + V_108 ) ;
F_30 ( V_38 & ~ ( 1 << V_109 ) , V_3 -> V_65 + V_108 ) ;
F_30 ( 1 << V_111 , V_3 -> V_65 + V_110 ) ;
F_26 ( & V_3 -> V_64 , V_61 ) ;
}
...
T_2 V_38 ;
F_23 ( & V_3 -> V_64 , V_61 ) ;
V_38 = F_27 ( V_3 -> V_65 + V_78 ) ;
F_30 ( V_38 & ~ ( 1 << V_112 ) , V_3 -> V_65 + V_78 ) ;
F_26 ( & V_3 -> V_64 , V_61 ) ;
}
...
const unsigned long V_78 = F_27 ( V_3 -> V_65 + V_116 ) ;
F_30 ( V_78 , V_3 -> V_65 + V_116 ) ;
if ( V_78 ) {
int V_117 ;
