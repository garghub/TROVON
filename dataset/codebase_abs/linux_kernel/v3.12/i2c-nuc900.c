...
V_2 = F_30 ( sizeof( struct V_1 ) , V_79 ) ;
if ( ! V_2 ) {
F_14 ( & V_74 -> V_4 , L_19 ) ;
return - V_80 ;
}
F_31 ( V_2 -> V_64 . V_81 , L_20 , sizeof( V_2 -> V_64 . V_81 ) ) ;
V_2 -> V_64 . V_82 = V_83 ;
V_2 -> V_64 . V_84 = & V_85 ;
V_2 -> V_64 . V_67 = 2 ;
...
F_33 ( & V_2 -> V_9 ) ;
V_2 -> V_4 = & V_74 -> V_4 ;
V_2 -> V_89 = F_34 ( & V_74 -> V_4 , NULL ) ;
if ( F_35 ( V_2 -> V_89 ) ) {
F_14 ( & V_74 -> V_4 , L_21 ) ;
V_3 = - V_90 ;
goto V_91;
}
F_2 ( & V_74 -> V_4 , L_22 , V_2 -> V_89 ) ;
F_36 ( V_2 -> V_89 ) ;
V_78 = F_37 ( V_74 , V_92 , 0 ) ;
if ( V_78 == NULL ) {
F_14 ( & V_74 -> V_4 , L_23 ) ;
V_3 = - V_90 ;
goto V_93;
}
V_2 -> V_94 = F_38 ( V_78 -> V_95 , F_39 ( V_78 ) ,
V_74 -> V_81 ) ;
if ( V_2 -> V_94 == NULL ) {
F_14 ( & V_74 -> V_4 , L_24 ) ;
V_3 = - V_33 ;
...
V_2 -> V_11 = F_40 ( V_78 -> V_95 , F_39 ( V_78 ) ) ;
if ( V_2 -> V_11 == NULL ) {
F_14 ( & V_74 -> V_4 , L_25 ) ;
V_3 = - V_33 ;
goto V_96;
...
F_2 ( & V_74 -> V_4 , L_26 ,
V_2 -> V_11 , V_2 -> V_94 , V_78 ) ;
V_2 -> V_64 . V_65 = V_2 ;
V_2 -> V_64 . V_4 . V_97 = & V_74 -> V_4 ;
F_41 ( & V_74 -> V_4 , NULL ) ;
F_42 ( V_2 -> V_89 ) ;
V_3 = ( V_2 -> V_89 . V_98 ) / ( V_76 -> V_99 * 5 ) - 1 ;
F_6 ( V_3 & 0xffff , V_2 -> V_11 + V_100 ) ;
V_2 -> V_101 = V_3 = F_43 ( V_74 , 0 ) ;
if ( V_3 <= 0 ) {
F_14 ( & V_74 -> V_4 , L_27 ) ;
goto V_102;
}
V_3 = F_44 ( V_2 -> V_101 , F_17 , V_103 ,
F_45 ( & V_74 -> V_4 ) , V_2 ) ;
if ( V_3 != 0 ) {
F_14 ( & V_74 -> V_4 , L_28 , V_2 -> V_101 ) ;
goto V_102;
}
V_2 -> V_64 . V_104 = V_76 -> V_105 ;
V_3 = F_46 ( & V_2 -> V_64 ) ;
if ( V_3 < 0 ) {
F_14 ( & V_74 -> V_4 , L_29 ) ;
goto V_106;
