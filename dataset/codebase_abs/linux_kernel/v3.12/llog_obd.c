...
if ( ! V_58 )
F_35 ( V_62 ) ;
V_14 = F_13 ( V_4 , V_61 ) ( V_10 , V_4 , V_52 , V_54 , V_56 ,
V_57 ) ;
if ( ! V_58 )
F_36 ( V_62 ) ;
return V_14 ;
...
struct V_53 * V_54 , int V_63 ,
struct V_55 * V_64 , int V_49 )
{
int V_14 ;
if ( ! V_4 ) {
F_20 ( L_6 ) ;
...
F_33 ( V_4 , V_65 , - V_47 ) ;
V_14 = F_13 ( V_4 , V_65 ) ( V_10 , V_4 , V_54 , V_63 , V_64 , V_49 ) ;
return V_14 ;
}
int F_38 ( struct V_2 * V_3 , struct V_11 * V_12 ,
struct V_2 * V_31 , int * V_30 )
{
int V_14 ;
F_39 ( V_3 , V_66 , 0 ) ;
F_40 ( V_3 , V_66 ) ;
V_14 = F_41 ( V_3 , V_66 ) ( V_3 , V_12 , V_31 , V_30 ) ;
return V_14 ;
}
int F_42 ( struct V_2 * V_3 , int V_63 )
{
int V_14 ;
F_39 ( V_3 , V_67 , 0 ) ;
F_40 ( V_3 , V_67 ) ;
V_14 = F_41 ( V_3 , V_67 ) ( V_3 , V_63 ) ;
return V_14 ;
}
int F_43 ( void )
{
