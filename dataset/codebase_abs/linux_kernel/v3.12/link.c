...
V_41 -> V_52 ) ;
else if ( V_4 != 0 && V_86 -> V_87 -> V_119 )
V_4 = V_86 -> V_87 -> V_119 ( V_35 , V_37 , V_116 ,
& V_117 , V_41 ) ;
F_12 ( V_116 ) ;
V_84:
if ( V_4 != 0 ) {
...
int
F_47 ( struct V_98 * V_98 , struct V_96 * V_99 , const char * V_120 )
{
int V_4 = - V_111 ;
unsigned int V_35 ;
struct V_40 * V_41 = F_32 ( V_98 -> V_103 ) ;
...
void F_52 ( struct V_96 * V_99 , struct V_114 * V_115 , void * V_124 )
{
char * V_125 = F_53 ( V_115 ) ;
if ( ! F_3 ( V_125 ) )
F_12 ( V_125 ) ;
}
