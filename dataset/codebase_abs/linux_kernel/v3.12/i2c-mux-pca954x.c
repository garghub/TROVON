...
if ( ! F_8 ( V_2 , V_40 ) )
goto V_41;
V_17 = F_9 ( sizeof( struct V_22 ) , V_42 ) ;
if ( ! V_17 ) {
V_6 = - V_43 ;
goto V_41;
}
...
V_17 -> type = V_32 -> V_45 ;
V_17 -> V_30 = 0 ;
for ( V_37 = 0 ; V_37 < V_25 [ V_17 -> type ] . V_46 ; V_37 ++ ) {
V_38 = 0 ;
V_39 = 0 ;
if ( V_36 ) {
if ( V_37 < V_36 -> V_47 ) {
V_38 = V_36 -> V_48 [ V_37 ] . V_49 ;
V_39 = V_36 -> V_48 [ V_37 ] . V_39 ;
} else
break;
}
V_17 -> V_50 [ V_37 ] =
F_13 ( V_2 , & V_4 -> V_33 , V_4 ,
V_38 , V_37 , V_39 , F_2 ,
( V_36 && V_36 -> V_48 [ V_37 ] . V_51 )
? F_4 : NULL ) ;
if ( V_17 -> V_50 [ V_37 ] == NULL ) {
V_6 = - V_7 ;
F_14 ( & V_4 -> V_33 ,
L_2
L_3 , V_37 , V_38 ) ;
