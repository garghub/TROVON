...
int F_98 ( unsigned int V_198 , struct V_199 * V_200 )
{
unsigned long V_201 ;
int V_202 ;
V_202 = F_97 () ;
V_201 = ( F_55 ( V_203 ) & V_204 ) ;
if ( F_99 ( V_201 ) ) {
F_100 ( & V_96 [ V_202 ] . V_205 ) ;
V_201 = ( F_55 ( V_203 ) & V_204 ) ;
if ( V_201 ) {
V_96 [ V_202 ] . V_206 ++ ;
F_101 ( V_207 , V_204 ) ;
}
F_102 ( & V_96 [ V_202 ] . V_205 ) ;
}
if ( F_36 ( F_103 ( V_208 ) == V_96 [ V_202 ] . V_206 ) )
return V_209 ;
F_103 ( V_208 ) = V_96 [ V_202 ] . V_206 ;
F_100 ( & V_210 ) ;
F_57 ( L_26 , F_26 () ) ;
F_104 () ;
F_102 ( & V_210 ) ;
...
void F_105 ( void )
{
if ( F_106 ( V_212 , F_98 , 0 , L_27 ) )
F_75 ( V_164 L_28 ) ;
}
void V_60 ( void )
{
unsigned int V_213 ;
V_213 = F_44 ( V_214 ) | V_215 ;
V_213 &= ~ V_216 ;
F_47 ( V_214 , V_213 ) ;
}
void T_1 F_107 ( void )
...
union V_20 V_21 ;
union V_18 V_19 ;
unsigned long V_217 , V_218 , V_219 ;
int V_113 , V_119 , V_76 , V_220 , V_22 , V_95 , V_103 , V_221 , V_121 , V_222 ;
int V_223 , V_131 = 999999 , V_111 = - 1 ;
unsigned long V_224 , V_225 , V_114 ;
unsigned short V_226 ;
char * V_227 = ( F_10 () ? L_29 :
( F_71 () ? L_30 :
L_31 ) ) ;
F_57 ( L_32 , V_227 ) ;
F_72 () ;
V_21 . V_23 = F_55 ( V_25 ) ;
V_121 = V_21 . V_27 . V_228 ;
V_222 = V_21 . V_27 . V_38 ;
V_226 = ( 1 << V_222 ) - 1 ;
V_224 =
F_55 ( V_129 ) &
~ V_229 ;
V_19 . V_23 = F_55 ( V_24 ) ;
V_223 = ( V_19 . V_27 . V_19 & ~ ( ( 1 << V_222 ) - 1 ) ) >> 1 ;
V_217 = ( ( unsigned long ) V_223 << V_121 ) ;
F_57 ( L_33 ,
V_222 , V_121 , V_226 , V_217 , V_223 ) ;
F_57 ( L_34 , V_224 ) ;
for( V_103 = 0 ; V_103 < V_230 ; V_103 ++ )
V_231 +=
F_108 ( F_55 ( V_232 + V_103 * 8 ) ) ;
F_57 ( L_35 ,
F_10 () ? F_51 () :
( F_51 () + 1 ) / 2 ,
F_51 () ) ;
V_113 = sizeof( struct V_96 ) * F_51 () ;
V_96 = F_109 ( V_113 , V_233 ) ;
F_110 ( ! V_96 ) ;
for ( V_95 = 0 ; V_95 < F_51 () ; V_95 ++ )
V_96 [ V_95 ] . V_234 = - 1 ;
F_53 ( & V_218 , & V_219 ) ;
V_113 = sizeof( V_235 [ 0 ] ) * F_111 () ;
V_235 = F_112 ( V_113 , V_233 ) ;
F_110 ( ! V_235 ) ;
memset ( V_235 , 255 , V_113 ) ;
V_113 = sizeof( V_236 [ 0 ] ) * F_113 () ;
V_236 = F_112 ( V_113 , V_233 ) ;
F_110 ( ! V_236 ) ;
memset ( V_236 , 255 , V_113 ) ;
V_95 = 0 ;
for ( V_103 = 0 ; V_103 < V_230 ; V_103 ++ ) {
V_225 = F_55 ( V_232 + V_103 * 8 ) ;
for ( V_221 = 0 ; V_221 < 64 ; V_221 ++ ) {
if ( ! F_114 ( V_221 , & V_225 ) )
continue;
V_22 = ( V_103 * 64 + V_221 ) & V_226 ;
V_96 [ V_95 ] . V_22 = V_22 ;
V_96 [ V_95 ] . V_237 = 0 ;
V_96 [ V_95 ] . V_197 = 0 ;
F_115 ( & V_96 [ V_95 ] . V_205 ) ;
...
F_116 () ;
F_117 ( 0 , & V_238 , & V_239 , & V_240 ,
& V_241 , & V_242 ) ;
F_73 () ;
F_118 (cpu) {
int V_78 = F_21 ( V_79 , V_76 ) ;
V_119 = F_119 ( V_76 ) ;
F_82 ( V_76 ) -> V_226 = V_226 ;
F_82 ( V_76 ) -> V_243 = V_39 . V_27 . V_41 ;
F_82 ( V_76 ) -> V_37 = V_36 -> V_37 ;
F_82 ( V_76 ) -> V_244 = 64 - V_121 ;
F_82 ( V_76 ) -> V_245 = F_120 () ?
( V_121 == 40 ? 40 : 39 ) : V_121 ;
V_22 = F_17 ( V_78 ) ;
V_95 = F_50 ( V_22 ) ;
V_220 = V_96 [ V_95 ] . V_237 ;
V_96 [ V_95 ] . V_237 ++ ;
V_96 [ V_95 ] . V_234 = V_119 ;
F_82 ( V_76 ) -> V_246 = V_218 ;
F_82 ( V_76 ) -> V_247 = V_219 ;
F_82 ( V_76 ) -> V_121 = V_121 ;
F_82 ( V_76 ) -> V_222 = V_222 ;
F_82 ( V_76 ) -> V_248 = V_95 ;
F_82 ( V_76 ) -> V_249 = V_220 ;
F_82 ( V_76 ) -> V_22 = V_22 ;
F_82 ( V_76 ) -> V_250 = ( 1UL << ( V_121 + V_222 ) ) - 1 ;
F_82 ( V_76 ) -> V_217 = V_217 ;
F_82 ( V_76 ) -> V_223 = V_223 ;
F_82 ( V_76 ) -> V_251 = V_224 ;
F_82 ( V_76 ) -> V_252 = V_240 ;
F_82 ( V_76 ) -> V_169 . V_253 = F_121 ( V_78 ) ;
V_235 [ V_119 ] = V_95 ;
V_236 [ V_76 ] = V_95 ;
}
F_62 (nid) {
if ( V_235 [ V_119 ] >= 0 )
continue;
V_114 = F_122 ( V_119 ) << V_254 ;
V_22 = F_123 ( F_124 ( V_114 ) ) ;
V_95 = F_50 ( V_22 ) ;
V_235 [ V_119 ] = V_95 ;
}
F_66 ( V_111 ) ;
