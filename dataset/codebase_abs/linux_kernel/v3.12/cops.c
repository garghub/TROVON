...
static T_3 F_49 ( struct V_84 * V_85 ,
struct V_1 * V_2 )
{
struct V_9 * V_19 = F_15 ( V_2 ) ;
int V_18 = V_2 -> V_4 ;
...
if( V_19 -> V_21 == V_35 )
while( ( F_18 ( V_18 + V_45 ) & V_72 ) == 0 ) ;
F_52 ( V_18 , V_85 -> V_51 , V_85 -> V_99 ) ;
if( V_19 -> V_21 == V_35 )
F_17 ( 1 , V_18 + V_71 ) ;
F_38 ( & V_19 -> V_30 , V_86 ) ;
V_2 -> V_89 . V_102 ++ ;
V_2 -> V_89 . V_103 += V_85 -> V_99 ;
F_53 ( V_85 ) ;
return V_104 ;
}
...
static int F_55 ( struct V_1 * V_2 , struct V_61 * V_62 , int V_105 )
{
struct V_9 * V_19 = F_15 ( V_2 ) ;
struct V_106 * V_107 = (struct V_106 * ) & V_62 -> V_108 ;
struct V_109 * V_110 = & V_19 -> V_111 ;
switch( V_105 )
{
case V_112 :
F_27 ( V_2 , V_107 -> V_113 . V_114 ) ;
V_110 -> V_115 = V_107 -> V_113 . V_115 ;
V_110 -> V_114 = V_19 -> V_57 ;
V_2 -> V_116 [ 0 ] = 0xFF ;
V_2 -> V_117 [ 0 ] = V_110 -> V_114 ;
V_2 -> V_118 = 1 ;
return 0 ;
case V_119 :
V_107 -> V_113 . V_115 = V_110 -> V_115 ;
V_107 -> V_113 . V_114 = V_110 -> V_114 ;
return 0 ;
default:
return - V_120 ;
}
