...
if ( V_12 < 0 )
return V_12 ;
return F_6 ( V_11 , V_13 , V_79 , V_12 ) ;
}
static unsigned int F_34 ( struct V_8 * V_9 )
{
struct V_3 * V_4 = F_4 ( V_9 ) ;
struct V_11 * V_11 = V_4 -> V_11 ;
int V_19 = V_4 -> V_14 + V_20 ;
...
switch ( V_27 ) {
case V_23 :
V_21 = F_6 ( V_11 , V_19 , V_80 , 0 ) ;
if ( V_21 < 0 )
return V_21 ;
break;
case V_26 :
V_21 = F_6 ( V_11 , V_19 , V_80 ,
V_80 ) ;
if ( V_21 < 0 )
return V_21 ;
break;
...
{
struct V_3 * V_4 = F_31 ( V_38 ) ;
F_32 ( F_25 ( V_4 -> V_11 , F_26 ( V_38 , L_7 ) ) ,
V_4 ) ;
F_29 ( V_4 -> V_5 ) ;
return 0 ;
}
...
struct V_3 * V_4 = F_4 ( V_9 ) ;
struct V_11 * V_11 = V_4 -> V_11 ;
int V_12 , V_13 = V_4 -> V_14 + V_84 ;
V_12 = F_40 ( V_9 , V_10 , V_10 ) ;
if ( V_12 < 0 )
return V_12 ;
return F_6 ( V_11 , V_13 , V_85 , V_12 ) ;
}
...
V_4 -> V_55 . V_45 = V_45 ;
V_4 -> V_55 . type = V_57 ;
V_4 -> V_55 . V_58 = V_87 + 1 ;
V_4 -> V_55 . V_59 = & V_88 ;
V_4 -> V_55 . V_61 = V_62 ;
V_4 -> V_55 . V_63 = V_4 -> V_14 + V_89 ;
V_4 -> V_55 . V_64 = V_85 ;
V_4 -> V_55 . V_65 = V_66 ;
V_4 -> V_55 . V_67 = 1 << V_45 ;
V_4 -> V_55 . V_90 = 800000 ;
V_4 -> V_55 . V_91 = 50000 ;
V_4 -> V_55 . V_92 = 1000 ;
V_44 . V_39 = V_38 -> V_39 . V_40 ;
if ( V_42 )
