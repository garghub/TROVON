...
F_129 ( V_24 -> V_144 . V_145 ,
F_130 ( & V_24 -> V_25 ) , V_76 ,
V_9 ) ;
...
static void F_133 ( struct V_15 * V_16 , int V_17 , const char * V_56 )
{
int V_152 ;
if ( ! ( V_16 -> V_20 & ( 1 << V_17 ) )
...
{
F_133 ( V_16 , V_153 , L_57 ) ;
F_133 ( V_16 , V_154 , L_58 ) ;
F_133 ( V_16 , V_155 , L_59 ) ;
F_133 ( V_16 , V_49 , L_60 ) ;
}
static int F_135 ( struct V_15 * V_16 )
{
unsigned int V_156 ;
int V_14 ;
V_14 = F_136 ( V_16 -> V_24 ) ;
if ( V_14 )
return V_14 ;
...
static int F_139 ( struct V_141 * V_24 )
{
struct V_15 * V_16 ;
int V_14 ;
F_137 ( V_161 L_7 ) ;
...
static int F_143 ( struct V_141 * V_24 )
{
struct V_15 * V_16 = F_128 ( V_24 ) ;
F_114 ( V_16 ) ;
F_79 ( V_16 ) ;
