...
{
int V_147 , V_141 , V_148 , error = 0 ;
struct V_11 * V_113 ;
if ( V_64 -> V_149 == 0x1979 )
return 0 ;
if ( V_102 > V_150 )
V_102 = V_150 ;
else if ( V_102 < V_151 )
...
F_80 ( V_64 , V_113 ) ;
F_40 ( V_113 ) ;
error = F_81 ( V_64 -> V_134 , F_61 , V_156 , L_7 , V_113 ) ;
if ( error )
goto V_157;
F_41 ( V_113 ) ;
F_82 ( & V_113 -> V_125 , & V_158 ) ;
V_113 -> V_125 . V_159 = V_160 ;
V_148 = V_147 * V_102 ;
error = F_83 ( & V_113 -> V_125 , F_71 ( V_143 , V_148 ) , V_102 ) ;
if ( error ) {
F_25 ( & V_64 -> V_73 , L_8 ) ;
goto V_161;
}
...
int error ;
T_11 V_73 ;
V_142 = F_87 ( V_160 , L_11 ) ;
if ( F_85 ( V_142 ) ) {
error = F_88 ( V_142 ) ;
goto V_130;
}
error = F_89 ( & V_73 , 0 , V_163 , V_153 ) ;
if ( error )
goto V_164;
V_143 = F_90 ( V_73 ) ;
error = F_91 ( & V_165 ) ;
