...
if ( ! V_44 )
return;
F_32 (vid, pv->vlan_bitmap, VLAN_N_VID) {
...
if ( ! V_44 || F_92 ( V_44 -> V_137 , V_135 ) ) {
V_115 = F_84 ( V_95 , V_27 , V_40 , V_131 , 0 ) ;
goto V_65;
}
F_93 (vid, pv->vlan_bitmap, VLAN_N_VID) {
V_115 = F_84 ( V_95 , V_27 , V_40 , V_131 , V_16 ) ;
if ( V_115 )
goto V_65;
}
...
int F_94 ( struct V_6 * V_7 , const T_5 * V_40 ,
T_4 V_138 )
{
...
int V_115 ;
F_21 ( & V_27 -> V_7 -> V_31 ) ;
V_115 = F_94 ( V_27 -> V_7 , V_40 , V_16 ) ;
F_28 ( & V_27 -> V_7 -> V_31 ) ;
return V_115 ;
}
int F_96 ( struct V_94 * V_95 , struct V_133 * V_134 [] ,
struct V_54 * V_38 ,
const unsigned char * V_40 )
{
struct V_26 * V_27 ;
...
V_115 = F_95 ( V_27 , V_40 , V_16 ) ;
} else {
if ( ! V_44 || F_92 ( V_44 -> V_137 , V_135 ) ) {
V_115 = F_95 ( V_27 , V_40 , 0 ) ;
goto V_65;
}
V_115 = - V_128 ;
F_93 (vid, pv->vlan_bitmap, VLAN_N_VID) {
