...
static T_3 F_226 ( struct V_36 * V_37 , T_2 V_15 ,
bool V_111 )
{
struct V_99 * V_100 ;
...
if ( ! V_100 )
return V_275 ;
return F_227 ( V_100 , V_15 ) ;
}
static int F_228 ( struct V_36 * V_37 ,
struct V_51 * V_52 ,
T_1 * V_147 , T_1 * V_148 )
{
...
return - 1 ;
V_68 = F_229 ( V_37 -> V_11 , V_15 , V_198 , V_148 - V_147 ) ;
if ( V_68 <= 0 )
return - 1 ;
for ( V_105 = 0 ; V_105 < V_68 ; V_105 ++ , V_15 ++ , V_147 ++ )
F_222 ( V_37 , V_147 , V_16 , 0 , NULL ,
V_52 -> V_94 . V_44 , V_15 , F_230 ( V_198 [ V_105 ] ) ,
true , true ) ;
return 0 ;
}
...
if ( ! V_147 )
continue;
if ( F_228 ( V_37 , V_52 , V_147 , V_10 ) < 0 )
break;
V_147 = NULL ;
} else if ( ! V_147 )
V_147 = V_10 ;
...
static void F_232 ( struct V_36 * V_37 , T_1 * V_14 )
{
struct V_51 * V_52 ;
if ( ! V_32 )
return;
...
if ( V_52 -> V_94 . V_44 > V_45 )
return;
F_231 ( V_37 , V_52 , V_14 ) ;
}
static int F_233 ( struct V_36 * V_37 , T_9 V_276 , int V_277 ,
...
int V_271 = 0 ;
T_2 V_280 ;
F_234 (vcpu, (u64)gfn << PAGE_SHIFT, iterator) {
if ( V_219 . V_44 == V_44 ) {
F_222 ( V_37 , V_219 . V_14 , V_281 ,
V_277 , & V_271 , V_44 , V_15 , V_21 ,
V_279 , V_278 ) ;
F_232 ( V_37 , V_219 . V_14 ) ;
++ V_37 -> V_135 . V_282 ;
break;
}
if ( ! F_23 ( * V_219 . V_14 ) ) {
T_1 V_283 = V_219 . V_220 ;
V_283 &= F_235 ( V_219 . V_44 ) ;
V_280 = V_283 >> V_19 ;
...
static void F_236 ( unsigned long V_284 , struct V_285 * V_286 )
{
T_10 V_287 ;
V_287 . V_288 = V_289 ;
V_287 . V_290 = 0 ;
...
V_287 . V_295 = V_19 ;
F_237 ( V_289 , & V_287 , V_286 ) ;
}
static int F_238 ( struct V_36 * V_37 , T_2 V_15 , T_3 V_21 )
{
if ( V_21 == V_296 )
return 1 ;
if ( V_21 == V_297 ) {
F_236 ( F_239 ( V_37 -> V_11 , V_15 ) , V_298 ) ;
return 0 ;
}
return - V_299 ;
}
static void F_240 ( struct V_36 * V_37 ,
T_2 * V_300 , T_3 * V_301 , int * V_302 )
{
T_3 V_21 = * V_301 ;
T_2 V_15 = * V_300 ;
int V_44 = * V_302 ;
if ( ! F_241 ( V_21 ) && ! F_49 ( V_21 ) &&
V_44 == V_45 &&
F_242 ( F_51 ( V_21 ) ) &&
...
static bool F_246 ( struct V_36 * V_37 , T_7 V_175 , T_2 V_15 ,
T_3 V_21 , unsigned V_16 , int * V_303 )
{
bool V_68 = true ;
if ( F_14 ( F_247 ( V_21 ) ) ) {
* V_303 = F_238 ( V_37 , V_15 , V_21 ) ;
goto exit;
}
if ( F_14 ( F_15 ( V_21 ) ) )
F_248 ( V_37 , V_175 , V_15 , V_16 ) ;
V_68 = false ;
exit:
return V_68 ;
}
static bool F_249 ( T_4 V_304 )
{
if ( F_14 ( V_304 & V_305 ) )
return false ;
if ( ! ( V_304 & V_306 ) ||
...
static bool
F_250 ( struct V_36 * V_37 , T_1 * V_14 , T_1 V_10 )
{
struct V_51 * V_52 = F_37 ( F_38 ( V_14 ) ) ;
T_2 V_15 ;
F_3 ( ! V_52 -> V_94 . V_95 ) ;
V_15 = F_75 ( V_52 , V_14 - V_52 -> V_131 ) ;
if ( F_251 ( V_14 , V_10 , V_10 | V_139 ) == V_10 )
F_221 ( V_37 -> V_11 , V_15 ) ;
return true ;
}
static bool F_252 ( struct V_36 * V_37 , T_7 V_175 , int V_44 ,
T_4 V_304 )
{
struct V_218 V_219 ;
bool V_68 = false ;
...
if ( ! F_41 ( V_10 ) )
goto exit;
V_68 = F_250 ( V_37 , V_219 . V_14 , V_10 ) ;
exit:
F_254 ( V_37 , V_175 , V_304 , V_219 . V_14 ,
V_10 , V_68 ) ;
F_57 ( V_37 ) ;
return V_68 ;
}
static int F_255 ( struct V_36 * V_37 , T_7 V_276 , T_4 V_304 ,
T_2 V_15 , bool V_279 )
{
int V_84 ;
int V_44 ;
...
V_44 = V_45 ;
if ( F_252 ( V_37 , V_276 , V_44 , V_304 ) )
return 0 ;
V_309 = V_37 -> V_11 -> V_310 ;
F_40 () ;
if ( F_256 ( V_37 , V_279 , V_15 , V_276 , & V_21 , V_277 , & V_278 ) )
return 0 ;
if ( F_246 ( V_37 , V_276 , V_15 , V_21 , V_281 , & V_84 ) )
return V_84 ;
F_210 ( & V_37 -> V_11 -> V_200 ) ;
if ( F_257 ( V_37 -> V_11 , V_309 ) )
goto V_311;
F_258 ( V_37 ) ;
if ( F_18 ( ! V_308 ) )
F_240 ( V_37 , & V_15 , & V_21 , & V_44 ) ;
V_84 = F_233 ( V_37 , V_276 , V_277 , V_278 , V_44 , V_15 , V_21 ,
V_279 ) ;
...
struct V_51 * V_52 ;
F_166 ( V_187 ) ;
if ( ! F_259 ( V_37 -> V_38 . V_190 . V_222 ) )
return;
...
static int F_260 ( struct V_36 * V_37 , T_2 V_314 )
{
int V_68 = 0 ;
if ( ! F_261 ( V_37 -> V_11 , V_314 ) ) {
F_185 ( V_315 , V_37 ) ;
V_68 = 1 ;
}
return V_68 ;
...
static T_9 F_271 ( struct V_36 * V_37 , T_7 V_325 ,
T_4 V_16 ,
struct V_326 * V_327 )
{
if ( V_327 )
...
static bool F_272 ( struct V_36 * V_37 , T_1 V_220 , bool V_95 )
{
if ( V_95 )
return F_273 ( V_37 , V_220 ) ;
return F_274 ( V_37 , V_220 ) ;
}
static bool F_275 ( T_1 V_10 )
{
return F_35 ( V_10 ) ;
}
static T_1 F_276 ( struct V_36 * V_37 , T_1 V_220 )
{
struct V_218 V_219 ;
T_1 V_10 = 0ull ;
F_54 ( V_37 ) ;
F_253 (vcpu, addr, iterator, spte)
if ( ! F_23 ( V_10 ) )
break;
F_57 ( V_37 ) ;
return V_10 ;
}
int F_277 ( struct V_36 * V_37 , T_1 V_220 , bool V_95 )
{
T_1 V_10 ;
if ( F_272 ( V_37 , V_220 , V_95 ) )
return V_330 ;
V_10 = F_276 ( V_37 , V_220 ) ;
if ( F_10 ( V_10 ) ) {
T_2 V_15 = F_11 ( V_10 ) ;
...
if ( V_95 )
V_220 = 0 ;
F_278 ( V_220 , V_15 , V_16 ) ;
F_248 ( V_37 , V_220 , V_15 , V_16 ) ;
return V_330 ;
}
if ( V_95 && ! F_275 ( V_10 ) )
return V_332 ;
...
static int F_279 ( struct V_36 * V_37 , T_1 V_220 ,
T_4 V_304 , bool V_95 )
{
int V_68 ;
V_68 = F_277 ( V_37 , V_220 , V_95 ) ;
F_3 ( V_68 == V_332 ) ;
return V_68 ;
}
static int F_280 ( struct V_36 * V_37 , T_7 V_175 ,
...
if ( F_14 ( V_304 & V_305 ) ) {
V_84 = F_279 ( V_37 , V_175 , V_304 , true ) ;
if ( F_18 ( V_84 != V_331 ) )
return V_84 ;
}
V_84 = F_69 ( V_37 ) ;
...
return V_84 ;
ASSERT ( V_37 ) ;
ASSERT ( F_259 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
V_15 = V_175 >> V_19 ;
return F_255 ( V_37 , V_175 & V_20 ,
V_304 , V_15 , V_279 ) ;
}
static int F_281 ( struct V_36 * V_37 , T_7 V_175 , T_2 V_15 )
{
struct V_334 V_38 ;
...
return F_282 ( V_37 , V_175 , V_15 , & V_38 ) ;
}
static bool F_283 ( struct V_36 * V_37 )
{
if ( F_14 ( ! F_284 ( V_37 -> V_11 ) ||
F_285 ( V_37 ) ) )
return false ;
return V_118 -> V_340 ( V_37 ) ;
}
static bool F_256 ( struct V_36 * V_37 , bool V_279 , T_2 V_15 ,
T_7 V_175 , T_3 * V_21 , bool V_277 , bool * V_341 )
{
bool V_342 ;
* V_21 = F_286 ( V_37 -> V_11 , V_15 , & V_342 , V_277 , V_341 ) ;
if ( ! V_342 )
return false ;
if ( ! V_279 && F_283 ( V_37 ) ) {
F_287 ( V_175 , V_15 ) ;
...
F_185 ( V_343 , V_37 ) ;
return true ;
} else if ( F_281 ( V_37 , V_175 , V_15 ) )
return true ;
}
* V_21 = F_290 ( V_37 -> V_11 , V_15 , V_277 , V_341 ) ;
return false ;
}
static int F_291 ( struct V_36 * V_37 , T_7 V_344 , T_4 V_304 ,
bool V_279 )
{
T_3 V_21 ;
int V_84 ;
...
ASSERT ( F_259 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
if ( F_14 ( V_304 & V_305 ) ) {
V_84 = F_279 ( V_37 , V_344 , V_304 , true ) ;
if ( F_18 ( V_84 != V_331 ) )
return V_84 ;
}
V_84 = F_69 ( V_37 ) ;
...
V_44 = V_45 ;
if ( F_252 ( V_37 , V_344 , V_44 , V_304 ) )
return 0 ;
V_309 = V_37 -> V_11 -> V_310 ;
F_40 () ;
if ( F_256 ( V_37 , V_279 , V_15 , V_344 , & V_21 , V_277 , & V_278 ) )
return 0 ;
if ( F_246 ( V_37 , 0 , V_15 , V_21 , V_281 , & V_84 ) )
return V_84 ;
F_210 ( & V_37 -> V_11 -> V_200 ) ;
if ( F_257 ( V_37 -> V_11 , V_309 ) )
goto V_311;
...
if ( F_18 ( ! V_308 ) )
F_240 ( V_37 , & V_15 , & V_21 , & V_44 ) ;
V_84 = F_233 ( V_37 , V_344 , V_277 , V_278 ,
...
static void F_292 ( struct V_36 * V_37 )
{
F_225 ( V_37 ) ;
}
static int F_293 ( struct V_36 * V_37 ,
struct V_345 * V_346 )
{
V_346 -> V_347 = F_224 ;
V_346 -> V_348 = F_280 ;
...
struct V_326 * V_355 )
{
V_37 -> V_38 . V_190 . F_296 ( V_37 , V_355 ) ;
}
static void F_297 ( struct V_36 * V_37 )
{
F_292 ( V_37 ) ;
}
static bool F_298 ( struct V_11 * V_11 , T_1 * V_14 , T_2 V_15 ,
unsigned V_16 , int * V_356 )
{
if ( F_14 ( F_10 ( * V_14 ) ) ) {
if ( V_15 != F_11 ( * V_14 ) ) {
F_52 ( V_14 ) ;
...
static inline bool F_299 ( struct V_345 * V_190 , unsigned V_44 , unsigned V_47 )
{
unsigned V_93 ;
V_93 = V_44 - 1 ;
V_93 |= ( V_47 & V_43 ) >> ( V_357 - 2 ) ;
return V_190 -> V_358 & ( 1 << V_93 ) ;
}
static void F_300 ( struct V_36 * V_37 ,
struct V_345 * V_346 )
{
int V_359 = F_301 ( V_37 ) ;
T_1 V_360 = 0 ;
V_346 -> V_361 = 0 ;
if ( ! V_346 -> V_352 )
V_360 = F_19 ( 63 , 63 ) ;
...
V_346 -> V_362 [ 0 ] [ 1 ] = 0 ;
V_346 -> V_362 [ 0 ] [ 0 ] = 0 ;
V_346 -> V_362 [ 1 ] [ 0 ] = V_346 -> V_362 [ 0 ] [ 0 ] ;
if ( ! F_302 ( V_37 ) ) {
V_346 -> V_362 [ 1 ] [ 1 ] = 0 ;
break;
}
if ( F_21 () )
V_346 -> V_362 [ 1 ] [ 1 ] = F_19 ( 17 , 21 ) ;
else
V_346 -> V_362 [ 1 ] [ 1 ] = F_19 ( 13 , 21 ) ;
break;
case V_224 :
V_346 -> V_362 [ 0 ] [ 2 ] =
F_19 ( V_359 , 63 ) |
F_19 ( 7 , 8 ) | F_19 ( 1 , 2 ) ;
V_346 -> V_362 [ 0 ] [ 1 ] = V_360 |
F_19 ( V_359 , 62 ) ;
V_346 -> V_362 [ 0 ] [ 0 ] = V_360 |
F_19 ( V_359 , 62 ) ;
V_346 -> V_362 [ 1 ] [ 1 ] = V_360 |
F_19 ( V_359 , 62 ) |
F_19 ( 13 , 20 ) ;
V_346 -> V_362 [ 1 ] [ 0 ] = V_346 -> V_362 [ 0 ] [ 0 ] ;
break;
case V_197 :
V_346 -> V_362 [ 0 ] [ 3 ] = V_360 |
F_19 ( V_359 , 51 ) | F_19 ( 7 , 8 ) ;
V_346 -> V_362 [ 0 ] [ 2 ] = V_360 |
F_19 ( V_359 , 51 ) | F_19 ( 7 , 8 ) ;
V_346 -> V_362 [ 0 ] [ 1 ] = V_360 |
F_19 ( V_359 , 51 ) ;
V_346 -> V_362 [ 0 ] [ 0 ] = V_360 |
F_19 ( V_359 , 51 ) ;
V_346 -> V_362 [ 1 ] [ 3 ] = V_346 -> V_362 [ 0 ] [ 3 ] ;
V_346 -> V_362 [ 1 ] [ 2 ] = V_360 |
F_19 ( V_359 , 51 ) |
F_19 ( 13 , 29 ) ;
V_346 -> V_362 [ 1 ] [ 1 ] = V_360 |
F_19 ( V_359 , 51 ) |
...
static void F_303 ( struct V_36 * V_37 ,
struct V_345 * V_346 , bool V_363 )
{
int V_359 = F_301 ( V_37 ) ;
int V_41 ;
V_346 -> V_362 [ 0 ] [ 3 ] =
F_19 ( V_359 , 51 ) | F_19 ( 3 , 7 ) ;
V_346 -> V_362 [ 0 ] [ 2 ] =
F_19 ( V_359 , 51 ) | F_19 ( 3 , 6 ) ;
V_346 -> V_362 [ 0 ] [ 1 ] =
F_19 ( V_359 , 51 ) | F_19 ( 3 , 6 ) ;
V_346 -> V_362 [ 0 ] [ 0 ] = F_19 ( V_359 , 51 ) ;
V_346 -> V_362 [ 1 ] [ 3 ] = V_346 -> V_362 [ 0 ] [ 3 ] ;
V_346 -> V_362 [ 1 ] [ 2 ] =
F_19 ( V_359 , 51 ) | F_19 ( 12 , 29 ) ;
V_346 -> V_362 [ 1 ] [ 1 ] =
F_19 ( V_359 , 51 ) | F_19 ( 12 , 20 ) ;
V_346 -> V_362 [ 1 ] [ 0 ] = V_346 -> V_362 [ 0 ] [ 0 ] ;
...
V_364 == 0x2 || V_364 == 0x6 ||
( V_364 == 0x4 && ! V_363 ) )
V_346 -> V_361 |= ( 1ull << V_41 ) ;
}
}
static void F_304 ( struct V_36 * V_37 ,
struct V_345 * V_190 , bool V_366 )
{
unsigned V_367 , V_368 , V_369 ;
T_8 V_370 ;
bool V_355 , V_371 , V_372 , V_373 , V_374 , V_375 , V_376 , V_377 ;
V_377 = F_305 ( V_37 , V_378 ) ;
for ( V_368 = 0 ; V_368 < F_60 ( V_190 -> V_379 ) ; ++ V_368 ) {
V_369 = V_368 << 1 ;
V_370 = 0 ;
V_374 = V_369 & V_307 ;
V_375 = V_369 & V_380 ;
...
if ( ! V_366 ) {
V_371 |= ! V_190 -> V_352 ;
V_372 |= ! F_306 ( V_37 ) && ! V_375 ;
V_371 &= ! ( V_377 && V_373 && ! V_375 ) ;
} else
V_373 = 1 ;
V_355 = ( V_376 && ! V_371 ) || ( V_375 && ! V_373 ) || ( V_374 && ! V_372 ) ;
V_370 |= V_355 << V_367 ;
}
V_190 -> V_379 [ V_368 ] = V_370 ;
}
}
static void F_307 ( struct V_36 * V_37 , struct V_345 * V_190 )
{
T_8 V_370 ;
...
if ( V_44 <= V_383
&& ( V_190 -> V_210 >= V_224 || F_302 ( V_37 ) ) )
V_370 |= 1 << ( V_382 | ( V_44 - 1 ) ) ;
}
V_190 -> V_358 = V_370 ;
}
static int F_308 ( struct V_36 * V_37 ,
struct V_345 * V_346 ,
int V_44 )
{
V_346 -> V_352 = F_22 ( V_37 ) ;
V_346 -> V_210 = V_44 ;
F_300 ( V_37 , V_346 ) ;
F_304 ( V_37 , V_346 , false ) ;
F_307 ( V_37 , V_346 ) ;
ASSERT ( F_162 ( V_37 ) ) ;
V_346 -> V_347 = F_294 ;
V_346 -> V_348 = V_384 ;
...
static int F_309 ( struct V_36 * V_37 ,
struct V_345 * V_346 )
{
return F_308 ( V_37 , V_346 , V_197 ) ;
}
static int F_310 ( struct V_36 * V_37 ,
struct V_345 * V_346 )
{
V_346 -> V_352 = false ;
V_346 -> V_210 = V_211 ;
...
struct V_345 * V_346 )
{
return F_308 ( V_37 , V_346 , V_224 ) ;
}
static int F_312 ( struct V_36 * V_37 )
{
struct V_345 * V_346 = V_37 -> V_38 . V_394 ;
V_346 -> V_208 . V_214 = 0 ;
V_346 -> V_347 = F_224 ;
V_346 -> V_348 = F_291 ;
V_346 -> free = F_292 ;
...
V_346 -> V_350 = F_152 ;
V_346 -> V_351 = F_153 ;
V_346 -> V_223 = V_118 -> V_395 () ;
V_346 -> V_222 = V_313 ;
V_346 -> V_209 = true ;
V_346 -> V_396 = V_118 -> V_397 ;
V_346 -> V_318 = V_318 ;
V_346 -> V_321 = V_398 ;
V_346 -> F_296 = V_399 ;
if ( ! F_313 ( V_37 ) ) {
...
int F_315 ( struct V_36 * V_37 , struct V_345 * V_346 )
{
int V_84 ;
bool V_377 = F_305 ( V_37 , V_378 ) ;
ASSERT ( V_37 ) ;
ASSERT ( ! F_259 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
if ( ! F_313 ( V_37 ) )
V_84 = F_293 ( V_37 , V_346 ) ;
else if ( F_314 ( V_37 ) )
V_84 = F_309 ( V_37 , V_346 ) ;
else if ( F_162 ( V_37 ) )
V_84 = F_311 ( V_37 , V_346 ) ;
else
V_84 = F_310 ( V_37 , V_346 ) ;
V_37 -> V_38 . V_190 . V_208 . V_400 = F_22 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_189 = ! ! F_162 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_401 = F_306 ( V_37 ) ;
V_37 -> V_38 . V_190 . V_208 . V_402
= V_377 && ! F_306 ( V_37 ) ;
return V_84 ;
}
int F_316 ( struct V_36 * V_37 , struct V_345 * V_346 ,
bool V_363 )
{
ASSERT ( V_37 ) ;
ASSERT ( ! F_259 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
...
V_346 -> V_222 = V_313 ;
V_346 -> V_209 = false ;
F_304 ( V_37 , V_346 , true ) ;
F_303 ( V_37 , V_346 , V_363 ) ;
return 0 ;
}
static int F_317 ( struct V_36 * V_37 )
{
int V_84 = F_315 ( V_37 , V_37 -> V_38 . V_394 ) ;
V_37 -> V_38 . V_394 -> V_396 = V_118 -> V_396 ;
V_37 -> V_38 . V_394 -> V_318 = V_318 ;
V_37 -> V_38 . V_394 -> V_321 = V_398 ;
V_37 -> V_38 . V_394 -> F_296 = V_399 ;
return V_84 ;
}
static int F_318 ( struct V_36 * V_37 )
{
struct V_345 * V_408 = & V_37 -> V_38 . V_328 ;
V_408 -> V_318 = V_318 ;
V_408 -> V_321 = V_398 ;
V_408 -> F_296 = V_399 ;
if ( ! F_313 ( V_37 ) ) {
...
F_304 ( V_37 , V_408 , false ) ;
F_307 ( V_37 , V_408 ) ;
return 0 ;
}
static int F_319 ( struct V_36 * V_37 )
{
if ( F_320 ( V_37 ) )
return F_318 ( V_37 ) ;
else if ( V_266 )
...
ASSERT ( V_37 ) ;
if ( F_259 ( V_37 -> V_38 . V_190 . V_222 ) )
V_37 -> V_38 . V_190 . free ( V_37 ) ;
}
int F_322 ( struct V_36 * V_37 )
{
F_321 ( V_37 ) ;
return F_319 ( V_37 ) ;
}
int F_323 ( struct V_36 * V_37 )
{
int V_84 ;
V_84 = F_69 ( V_37 ) ;
if ( V_84 )
...
if ( V_84 )
goto V_88;
V_37 -> V_38 . V_190 . V_396 ( V_37 , V_37 -> V_38 . V_190 . V_222 ) ;
V_88:
return V_84 ;
}
void F_324 ( struct V_36 * V_37 )
{
F_225 ( V_37 ) ;
}
static void F_325 ( struct V_36 * V_37 ,
struct V_51 * V_52 , T_1 * V_10 ,
const void * V_411 )
{
if ( V_52 -> V_94 . V_44 != V_45 ) {
...
++ V_37 -> V_11 -> V_135 . V_413 ;
V_37 -> V_38 . V_190 . V_351 ( V_37 , V_52 , V_10 , V_411 ) ;
}
static bool F_326 ( T_1 V_414 , T_1 V_411 )
{
if ( ! F_23 ( V_414 ) )
return false ;
if ( ! F_23 ( V_411 ) )
...
V_414 ^= V_34 ;
V_411 ^= V_34 ;
return ( V_414 & ~ V_411 & V_415 ) != 0 ;
}
static void F_327 ( struct V_36 * V_37 , bool V_416 ,
bool V_417 , bool V_418 )
{
if ( V_416 )
return;
if ( V_417 )
...
static T_1 F_328 ( struct V_36 * V_37 , T_9 * V_344 ,
const T_8 * V_411 , int * V_419 )
{
T_1 V_420 ;
int V_84 ;
if ( F_162 ( V_37 ) && * V_419 == 4 ) {
* V_344 &= ~ ( T_9 ) 7 ;
* V_419 = 8 ;
V_84 = F_329 ( V_37 -> V_11 , * V_344 , & V_420 , 8 ) ;
if ( V_84 )
V_420 = 0 ;
V_411 = ( const T_8 * ) & V_420 ;
}
switch ( * V_419 ) {
case 4 :
V_420 = * ( const T_4 * ) V_411 ;
break;
case 8 :
V_420 = * ( const T_1 * ) V_411 ;
break;
default:
V_420 = 0 ;
break;
...
static bool F_330 ( struct V_51 * V_52 )
{
if ( V_52 -> V_94 . V_44 == V_45 )
return false ;
return ++ V_52 -> V_202 >= 3 ;
}
static bool F_331 ( struct V_51 * V_52 , T_9 V_344 ,
int V_419 )
{
unsigned V_421 , V_422 , V_423 ;
F_213 ( L_26 ,
V_344 , V_419 , V_52 -> V_94 . V_214 ) ;
V_421 = F_332 ( V_344 ) ;
V_422 = V_52 -> V_94 . V_189 ? 8 : 4 ;
if ( ! ( V_421 & ( V_422 - 1 ) ) && V_419 == 1 )
return false ;
V_423 = ( V_421 ^ ( V_421 + V_419 - 1 ) ) & ~ ( V_422 - 1 ) ;
V_423 |= V_419 < 4 ;
return V_423 ;
}
static T_1 * F_333 ( struct V_51 * V_52 , T_9 V_344 , int * V_424 )
{
unsigned V_425 , V_206 ;
T_1 * V_10 ;
int V_44 ;
V_425 = F_332 ( V_344 ) ;
V_44 = V_52 -> V_94 . V_44 ;
...
V_10 = & V_52 -> V_131 [ V_425 / sizeof( * V_10 ) ] ;
return V_10 ;
}
void F_334 ( struct V_36 * V_37 , T_9 V_344 ,
const T_8 * V_411 , int V_419 )
{
T_2 V_15 = V_344 >> V_19 ;
...
struct V_51 * V_52 ;
F_166 ( V_187 ) ;
T_1 V_426 , V_420 , * V_10 ;
int V_427 ;
bool V_417 , V_418 , V_416 ;
if ( ! F_34 ( V_37 -> V_11 -> V_38 . V_109 ) )
return;
V_416 = V_417 = V_418 = false ;
F_213 ( L_27 , V_162 , V_344 , V_419 ) ;
V_420 = F_328 ( V_37 , & V_344 , V_411 , & V_419 ) ;
F_69 ( V_37 ) ;
F_210 ( & V_37 -> V_11 -> V_200 ) ;
++ V_37 -> V_11 -> V_135 . V_428 ;
F_168 ( V_37 , V_429 ) ;
V_4 . V_401 = V_4 . V_189 = V_4 . V_400 = 1 ;
F_172 (vcpu->kvm, sp, gfn) {
if ( F_331 ( V_52 , V_344 , V_419 ) ||
F_330 ( V_52 ) ) {
V_416 |= ! ! F_163 ( V_37 -> V_11 , V_52 ,
& V_187 ) ;
++ V_37 -> V_11 -> V_135 . V_430 ;
continue;
}
V_10 = F_333 ( V_52 , V_344 , & V_427 ) ;
if ( ! V_10 )
continue;
V_418 = true ;
while ( V_427 -- ) {
...
& V_4 . V_214 ) && F_99 ( V_37 ) )
F_325 ( V_37 , V_52 , V_10 , & V_420 ) ;
if ( F_326 ( V_426 , * V_10 ) )
V_417 = true ;
++ V_10 ;
}
}
F_327 ( V_37 , V_416 , V_417 , V_418 ) ;
F_167 ( V_37 -> V_11 , & V_187 ) ;
F_168 ( V_37 , V_431 ) ;
F_211 ( & V_37 -> V_11 -> V_200 ) ;
}
int F_335 ( struct V_36 * V_37 , T_7 V_175 )
{
T_9 V_344 ;
int V_84 ;
if ( V_37 -> V_38 . V_190 . V_209 )
return 0 ;
V_344 = F_336 ( V_37 , V_175 , NULL ) ;
...
{
F_166 ( V_187 ) ;
if ( F_18 ( F_337 ( V_37 -> V_11 ) >= V_432 ) )
return;
while ( F_337 ( V_37 -> V_11 ) < V_433 ) {
...
static bool F_338 ( struct V_36 * V_37 , T_7 V_220 )
{
if ( V_37 -> V_38 . V_190 . V_209 || F_320 ( V_37 ) )
return F_273 ( V_37 , V_220 ) ;
return F_274 ( V_37 , V_220 ) ;
}
int F_339 ( struct V_36 * V_37 , T_7 V_435 , T_4 V_304 ,
void * V_436 , int V_437 )
{
int V_84 , V_438 = V_439 ;
enum V_440 V_441 ;
V_84 = V_37 -> V_38 . V_190 . V_348 ( V_37 , V_435 , V_304 , false ) ;
if ( V_84 < 0 )
goto V_88;
if ( ! V_84 ) {
V_84 = 1 ;
...
if ( F_338 ( V_37 , V_435 ) )
V_438 = 0 ;
V_441 = F_340 ( V_37 , V_435 , V_438 , V_436 , V_437 ) ;
switch ( V_441 ) {
case V_442 :
return 1 ;
case V_443 :
...
void F_341 ( struct V_36 * V_37 , T_7 V_175 )
{
V_37 -> V_38 . V_190 . V_350 ( V_37 , V_175 ) ;
F_164 ( V_37 ) ;
++ V_37 -> V_135 . V_350 ;
}
void F_342 ( void )
...
static void F_344 ( struct V_36 * V_37 )
{
F_68 ( ( unsigned long ) V_37 -> V_38 . V_190 . V_225 ) ;
if ( V_37 -> V_38 . V_190 . V_322 != NULL )
F_68 ( ( unsigned long ) V_37 -> V_38 . V_190 . V_322 ) ;
}
static int F_345 ( struct V_36 * V_37 )
{
struct V_83 * V_83 ;
int V_105 ;
ASSERT ( V_37 ) ;
V_83 = F_346 ( V_80 | V_446 ) ;
if ( ! V_83 )
return - V_81 ;
V_37 -> V_38 . V_190 . V_225 = F_347 ( V_83 ) ;
for ( V_105 = 0 ; V_105 < 4 ; ++ V_105 )
V_37 -> V_38 . V_190 . V_225 [ V_105 ] = V_313 ;
return 0 ;
}
int F_348 ( struct V_36 * V_37 )
{
ASSERT ( V_37 ) ;
V_37 -> V_38 . V_394 = & V_37 -> V_38 . V_190 ;
V_37 -> V_38 . V_190 . V_222 = V_313 ;
V_37 -> V_38 . V_190 . V_329 = V_329 ;
V_37 -> V_38 . V_328 . V_329 = V_447 ;
return F_345 ( V_37 ) ;
}
int F_349 ( struct V_36 * V_37 )
{
ASSERT ( V_37 ) ;
ASSERT ( ! F_259 ( V_37 -> V_38 . V_190 . V_222 ) ) ;
return F_319 ( V_37 ) ;
}
void F_350 ( struct V_11 * V_11 , int V_100 )
{
struct V_99 * V_150 ;
T_2 V_448 ;
int V_105 ;
V_150 = F_351 ( V_11 -> V_449 , V_100 ) ;
V_448 = V_150 -> V_102 + V_150 -> V_156 - 1 ;
F_210 ( & V_11 -> V_200 ) ;
for ( V_105 = V_45 ;
V_105 < V_45 + V_107 ; ++ V_105 ) {
unsigned long * V_130 ;
unsigned long V_450 , V_93 ;
V_130 = V_150 -> V_38 . V_129 [ V_105 - V_45 ] ;
V_450 = F_78 ( V_448 , V_150 -> V_102 , V_105 ) ;
for ( V_93 = 0 ; V_93 <= V_450 ; ++ V_93 , ++ V_130 ) {
if ( * V_130 )
F_109 ( V_11 , V_130 , false ) ;
if ( F_352 () || F_353 ( & V_11 -> V_200 ) ) {
F_107 ( V_11 ) ;
F_178 ( & V_11 -> V_200 ) ;
}
}
...
static void F_354 ( struct V_11 * V_11 )
{
struct V_51 * V_52 , * V_451 ;
int V_452 = 0 ;
V_453:
F_355 (sp, node,
...
static bool F_358 ( struct V_11 * V_11 )
{
return F_14 ( ! F_359 ( & V_11 -> V_38 . V_455 ) ) ;
}
...
F_362 ( struct V_457 * V_458 , struct V_459 * V_460 )
{
struct V_11 * V_11 ;
int V_461 = V_460 -> V_461 ;
...
V_465:
F_211 ( & V_11 -> V_200 ) ;
F_366 ( & V_11 -> V_464 , V_101 ) ;
F_367 ( & V_11 -> V_466 , & V_466 ) ;
break;
}
F_368 ( & V_463 ) ;
return V_462 ;
...
static unsigned long
F_369 ( struct V_457 * V_458 , struct V_459 * V_460 )
{
return F_370 ( & V_165 ) ;
}
...
unsigned int F_377 ( struct V_11 * V_11 )
{
unsigned int V_469 ;
...
F_120 (memslot, slots)
V_470 += V_150 -> V_156 ;
V_469 = V_470 * V_471 / 1000 ;
V_469 = F_121 ( V_469 ,
( unsigned int ) V_472 ) ;
return V_469 ;
}
int F_378 ( struct V_36 * V_37 , T_1 V_220 , T_1 V_122 [ 4 ] )
{
struct V_218 V_219 ;
T_1 V_10 ;
int V_473 = 0 ;
