...
static void F_41 ( unsigned int V_29 , struct V_42 * V_43 )
{
T_2 V_44 ;
...
& V_73 ,
V_2 ) ;
V_60 = F_53 ( V_2 -> V_19 , V_2 -> V_11 . V_72 , 2 ,
V_2 -> V_64 , V_74 , 0 , 0 ,
V_75 ) ;
if ( V_60 ) {
F_51 ( V_56 ,
...
V_59 -> V_76 = V_2 -> V_5 ;
V_59 -> V_77 [ 0 ] . type = V_78 ;
V_59 -> V_77 [ 0 ] . V_79 = V_80 ;
V_59 -> V_77 [ 0 ] . V_81 . V_82 = V_48 ;
V_59 -> V_77 [ 0 ] . V_81 . V_83 = V_49 ;
V_59 -> V_77 [ 0 ] . V_11 . V_84 = F_30 ,
V_59 -> V_77 [ 0 ] . V_11 . V_85 = F_33 ,
V_59 -> V_77 [ 0 ] . V_11 . V_86 = V_87 ,
V_59 -> V_77 [ 0 ] . V_11 . V_88 = F_34 ,
V_59 -> V_77 [ 0 ] . V_11 . V_89 = F_35 ,
V_59 -> V_77 [ 0 ] . V_11 . V_90 = F_37 ,
V_59 -> V_77 [ 0 ] . V_11 . V_91 = V_92 ,
V_59 -> V_77 [ 1 ] . type = V_31 ;
V_59 -> V_77 [ 1 ] . V_79 = V_93 ;
V_59 -> V_77 [ 1 ] . V_81 . V_82 = V_48 ;
V_59 -> V_77 [ 1 ] . V_81 . V_83 = V_49 ;
V_59 -> V_77 [ 1 ] . V_11 . V_84 = F_30 ,
V_59 -> V_77 [ 1 ] . V_11 . V_85 = F_33 ,
V_59 -> V_77 [ 1 ] . V_11 . V_86 = V_87 ,
V_59 -> V_77 [ 1 ] . V_11 . V_88 = F_34 ,
V_59 -> V_77 [ 1 ] . V_11 . V_89 = F_35 ,
V_59 -> V_77 [ 1 ] . V_11 . V_90 = F_37 ,
V_59 -> V_77 [ 1 ] . V_11 . V_91 = V_92 ,
F_56 ( V_2 -> V_29 , V_2 ) ;
F_57 ( V_2 -> V_29 , F_41 ) ;
return 0 ;
}
static void F_58 ( struct V_94 * V_57 )
{
struct V_52 * V_53 = V_57 -> V_56 -> V_71 ;
struct V_52 * V_54 ;
F_59 (np, node) {
struct V_50 V_51 ;
T_1 V_95 ;
int V_16 ;
V_16 = F_60 ( V_54 , L_8 , & V_95 ) ;
if ( V_16 ) {
F_48 ( V_57 -> V_56 , L_9 ,
V_54 -> V_96 ) ;
continue;
...
{
struct V_52 * V_53 = V_98 -> V_56 . V_71 ;
struct V_99 * V_100 ;
struct V_94 V_57 ;
if ( ! V_53 ) {
F_48 ( & V_98 -> V_56 , L_12 ) ;
...
V_100 = F_64 ( V_98 , V_102 , 0 ) ;
if ( ! V_100 ) {
F_48 ( & V_98 -> V_56 , L_13 ) ;
return - V_101 ;
}
V_57 . V_56 = & V_98 -> V_56 ;
V_57 . V_5 = F_65 ( & V_98 -> V_56 , V_100 -> V_103 ,
