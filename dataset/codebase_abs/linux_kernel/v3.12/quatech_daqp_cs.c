...
{
struct V_5 * V_6 = V_2 -> V_7 ;
unsigned int V_105 = V_27 [ 0 ] ;
unsigned int V_106 = V_27 [ 1 ] ;
if ( V_6 -> V_8 )
return - V_9 ;
if ( V_105 ) {
V_4 -> V_107 &= ~ V_105 ;
V_4 -> V_107 |= ( V_106 & V_105 ) ;
F_2 ( V_4 -> V_107 , V_2 -> V_11 + V_104 ) ;
}
V_27 [ 1 ] = V_4 -> V_107 ;
return V_50 -> V_63 ;
}
...
unsigned long V_108 )
{
struct V_109 * V_110 = F_33 ( V_2 ) ;
struct V_5 * V_6 ;
struct V_3 * V_4 ;
int V_111 ;
V_6 = F_34 ( V_2 , sizeof( * V_6 ) ) ;
if ( ! V_6 )
return - V_112 ;
...
if ( V_111 )
return V_111 ;
V_2 -> V_11 = V_110 -> V_116 [ 0 ] -> V_40 ;
V_110 -> V_117 = V_2 ;
V_111 = F_36 ( V_110 , F_3 ) ;
if ( V_111 )
return V_111 ;
V_111 = F_37 ( V_2 , 4 ) ;
if ( V_111 )
...
V_2 -> V_18 = V_4 ;
V_4 -> type = V_119 ;
V_4 -> V_120 = V_121 | V_122 | V_123 | V_124 ;
V_4 -> V_125 = 8 ;
V_4 -> V_126 = 2048 ;
V_4 -> V_127 = 0xffff ;
V_4 -> V_128 = & V_129 ;
