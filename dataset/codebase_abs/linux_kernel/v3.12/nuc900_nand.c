...
struct V_55 * V_56 ;
V_54 = 0 ;
V_4 = F_20 ( sizeof( struct V_4 ) , V_57 ) ;
if ( ! V_4 )
return - V_58 ;
V_18 = & ( V_4 -> V_18 ) ;
V_4 -> V_2 . V_19 = V_18 ;
...
V_18 -> V_23 = 0 ;
V_18 -> V_69 . V_70 = V_71 ;
V_56 = F_25 ( V_53 , V_72 , 0 ) ;
if ( ! V_56 ) {
V_54 = - V_73 ;
goto V_64;
}
if ( ! F_26 ( V_56 -> V_74 , F_27 ( V_56 ) , V_53 -> V_75 ) ) {
V_54 = - V_76 ;
goto V_64;
}
V_4 -> V_41 = F_28 ( V_56 -> V_74 , F_27 ( V_56 ) ) ;
if ( ! V_4 -> V_41 ) {
V_54 = - V_58 ;
goto V_77;
}
...
return V_54 ;
V_78: F_33 ( V_4 -> V_41 ) ;
V_77: F_34 ( V_56 -> V_74 , F_27 ( V_56 ) ) ;
V_64: F_35 ( V_4 ) ;
return V_54 ;
}
static int F_36 ( struct V_52 * V_53 )
{
struct V_4 * V_4 = F_37 ( V_53 ) ;
struct V_55 * V_56 ;
F_38 ( & V_4 -> V_2 ) ;
F_33 ( V_4 -> V_41 ) ;
V_56 = F_25 ( V_53 , V_72 , 0 ) ;
F_34 ( V_56 -> V_74 , F_27 ( V_56 ) ) ;
F_39 ( V_4 -> V_61 ) ;
F_40 ( V_4 -> V_61 ) ;
F_35 ( V_4 ) ;
return 0 ;
