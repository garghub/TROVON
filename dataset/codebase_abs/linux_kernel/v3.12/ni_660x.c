...
struct V_160 * V_161 ;
unsigned V_208 ;
V_161 = F_57 ( V_15 , sizeof( * V_161 ) ) ;
if ( ! V_161 )
return - V_216 ;
F_58 ( & V_161 -> V_188 ) ;
F_58 ( & V_161 -> V_211 ) ;
F_58 ( & V_161 -> V_181 ) ;
for ( V_208 = 0 ; V_208 < V_217 ; ++ V_208 )
V_161 -> V_218 [ V_208 ] = V_219 ;
return 0 ;
}
...
for ( V_220 = 0 ; V_220 < V_12 ; ++ V_220 ) {
V_161 -> V_178 [ V_208 ] [ V_220 ] =
F_60 ( V_161 -> V_164 ) ;
if ( V_161 -> V_178 [ V_208 ] [ V_220 ] == NULL )
return - V_216 ;
}
}
return 0 ;
...
{
return F_64 ( F_38 ( V_193 ) , V_222 , V_223 ) ;
}
...
struct V_221 * V_222 , unsigned int * V_223 )
{
return F_67 ( F_38 ( V_193 ) , V_222 , V_223 ) ;
}
static int F_68 ( struct V_14 * V_15 ,
struct V_192 * V_193 ,
struct V_221 * V_222 , unsigned int * V_223 )
{
return F_69 ( F_38 ( V_193 ) , V_222 , V_223 ) ;
}
static int F_70 ( struct V_14 * V_15 ,
struct V_192 * V_193 ,
struct V_221 * V_222 , unsigned int * V_223 )
{
unsigned V_224 = F_71 ( V_222 -> V_225 ) ;
if ( V_223 [ 0 ] ) {
V_193 -> V_226 &= ~ ( V_223 [ 0 ] << V_224 ) ;
V_193 -> V_226 |= ( V_223 [ 0 ] & V_223 [ 1 ] ) << V_224 ;
F_17 ( V_15 , 0 , V_193 -> V_226 , V_227 ) ;
}
V_223 [ 1 ] =
( F_20 ( V_15 , 0 ,
V_228 ) >> V_224 ) ;
...
{
const struct V_16 * V_17 = F_14 ( V_15 ) ;
static const unsigned V_230 = 8 ;
static const unsigned V_231 = 23 ;
unsigned V_232 = 0 ;
unsigned V_233 = 0 ;
unsigned V_234 ;
unsigned V_235 ;
...
V_234 &= ~ F_5 ( V_1 ) ;
V_234 |= F_6 ( V_1 , V_7 ) ;
F_17 ( V_15 , V_232 , V_234 ,
F_1 ( V_1 ) ) ;
}
static int F_73 ( struct V_14 * V_15 , unsigned V_237 ,
unsigned V_238 )
{
struct V_160 * V_161 = V_15 -> V_162 ;
if ( V_238 > V_239 )
...
V_161 -> V_218 [ V_237 ] = V_238 ;
if ( V_161 -> V_244 & ( ( ( V_245 ) 1 ) << V_237 ) )
F_72 ( V_15 , V_237 ,
V_161 -> V_218 [ V_237 ] ) ;
return 0 ;
}
...
{
struct V_160 * V_161 = V_15 -> V_162 ;
unsigned int V_237 = F_71 ( V_222 -> V_225 ) ;
V_245 V_246 = 1ULL << V_237 ;
unsigned int V_247 ;
int V_215 ;
switch ( V_223 [ 0 ] ) {
case V_248 :
...
case V_249 :
V_161 -> V_244 &= ~ V_246 ;
F_72 ( V_15 , V_237 , V_236 ) ;
break;
case V_250 :
V_223 [ 1 ] = ( V_161 -> V_244 & V_246 ) ? V_251
: V_195 ;
break;
case V_252 :
V_215 = F_73 ( V_15 , V_237 , V_223 [ 1 ] ) ;
if ( V_215 )
return V_215 ;
break;
case V_253 :
V_223 [ 1 ] = V_161 -> V_218 [ V_237 ] ;
break;
case V_254 :
V_247 = F_20 ( V_15 , 0 , F_1 ( V_237 ) ) ;
V_247 &= ~ F_7 ( V_237 ) ;
V_247 |= F_8 ( V_237 , V_223 [ 1 ] ) ;
F_17 ( V_15 , 0 , V_247 , F_1 ( V_237 ) ) ;
break;
default:
return - V_240 ;
}
...
if ( V_215 < 0 )
return V_215 ;
V_215 = F_82 ( V_15 , 2 + V_265 ) ;
if ( V_215 )
return V_215 ;
V_193 = & V_15 -> V_212 [ 0 ] ;
V_193 -> type = V_266 ;
V_193 = & V_15 -> V_212 [ V_267 ] ;
V_193 -> type = V_268 ;
V_193 -> V_269 = V_270 | V_271 ;
V_193 -> V_272 = V_217 ;
V_193 -> V_273 = 1 ;
V_193 -> V_274 = & V_275 ;
V_193 -> V_276 = F_70 ;
...
V_193 -> V_291 = V_292 ;
V_193 -> V_293 = & F_54 ;
V_193 -> V_162 = & V_161 -> V_175 -> V_294 [ V_208 ] ;
V_161 -> V_175 -> V_294 [ V_208 ] . V_158 =
V_208 / V_12 ;
V_161 -> V_175 -> V_294 [ V_208 ] . V_11 =
V_208 % V_12 ;
} else {
V_193 -> type = V_266 ;
}
...
F_65 ( V_15 , V_208 ) ;
for ( V_208 = 0 ; V_208 < F_13 ( V_15 ) ; ++ V_208 )
F_84 ( & V_161 -> V_175 -> V_294 [ V_208 ] ) ;
for ( V_208 = 0 ; V_208 < V_217 ; ++ V_208 ) {
if ( V_208 < V_241 )
F_73 ( V_15 , V_208 , V_243 ) ;
else
F_73 ( V_15 , V_208 ,
V_219 ) ;
F_72 ( V_15 , V_208 , V_236 ) ;
}
for ( V_208 = 0 ; V_208 < V_17 -> V_18 ; ++ V_208 )
F_45 ( V_15 , V_208 ) ;
...
F_17 ( V_15 , 0 , V_258 ,
V_298 ) ;
F_87 ( V_15 -> V_264 , L_6 , V_15 -> V_262 ) ;
return 0 ;
}
...
static int F_94 ( struct V_256 * V_15 ,
const struct V_299 * V_300 )
{
return F_95 ( V_15 , & V_301 , V_300 -> V_302 ) ;
}
