...
struct V_135 * V_136 ;
struct V_137 * V_138 ;
struct V_50 * V_51 = F_50 ( V_67 ) ;
struct V_139 * V_140 ;
struct V_141 * V_142 ;
union V_89 * V_143 ;
union V_89 * V_41 ;
memset ( V_144 , 0 , sizeof( V_144 ) ) ;
F_51 ( V_67 -> V_68 , V_144 ,
V_97 , & V_133 , & V_134 ) ;
if ( V_133 > 0 ) {
...
F_53 ( & V_17 . V_54 . V_149 ) ;
break;
case V_156 :
F_28 ( V_51 , (struct V_70 * ) V_136 ) ;
break;
default:
F_54 ( L_10 , V_138 -> type ) ;
}
}
}
static int F_55 ( struct V_132 * V_67 ,
...
struct V_159 V_160 ;
V_22 = V_161 ;
V_106 = F_56 ( V_97 , V_44 ) ;
if ( ! V_106 )
return - V_162 ;
V_10 = F_57 ( V_67 -> V_68 , V_163 , V_163 , NULL , 0 ,
F_49 , V_67 ) ;
if ( V_10 )
goto V_164;
V_17 . V_67 = V_67 ;
...
F_7 ( & V_17 . V_116 ) ;
F_22 ( & V_17 . V_33 ) ;
F_58 ( & V_17 . V_103 . V_149 , F_42 ) ;
F_58 ( & V_17 . V_54 . V_149 , F_24 ) ;
V_17 . V_42 = false ;
V_17 . V_166 =
F_59 ( F_45 , & V_17 , L_11 ) ;
if ( F_60 ( V_17 . V_166 ) ) {
V_10 = F_61 ( V_17 . V_166 ) ;
goto V_167;
}
#ifdef F_25
F_62 ( & F_13 ) ;
...
static int F_68 ( struct V_132 * V_67 )
{
struct V_50 * V_51 = F_50 ( V_67 ) ;
...
if ( V_51 -> V_88 != 0 )
F_52 ( L_12 , V_51 -> V_88 ) ;
F_69 ( & V_51 -> V_103 . V_149 ) ;
F_69 ( & V_51 -> V_54 . V_149 ) ;
F_66 ( V_67 -> V_68 ) ;
F_65 ( V_51 -> V_166 ) ;
F_67 ( V_106 ) ;
#ifdef F_25
F_64 ( & F_13 ) ;
#endif
F_70 (cur, tmp, &dm->ha_region_list) {
V_9 = F_16 ( V_25 , struct V_8 , V_28 ) ;
F_71 ( & V_9 -> V_28 ) ;
F_67 ( V_9 ) ;
}
