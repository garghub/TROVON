...
#ifdef F_2
if ( V_51 == V_65 ) {
if ( ! V_58 . V_141 && F_99 ( V_15 ) ) {
struct V_14 * V_194 = F_99 ( V_15 ) ;
V_194 -> V_150 = 1 ;
...
int (* F_103)( struct V_14 * ) )
{
return F_95 ( V_115 , V_15 , V_137 ) ;
}
static unsigned int
...
static unsigned int
F_105 ( unsigned int V_115 , struct V_14 * V_15 ,
const struct V_195 * V_196 , const struct V_195 * V_148 ,
int (* F_103)( struct V_14 * ) )
{
return F_95 ( V_115 , V_15 , V_65 ) ;
}
static unsigned int
F_106 ( unsigned int V_115 , struct V_14 * V_15 ,
const struct V_195 * V_196 , const struct V_195 * V_148 ,
int (* F_103)( struct V_14 * ) )
{
return F_95 ( V_115 , V_15 , V_65 ) ;
...
static int
F_107 ( struct V_14 * V_15 , int * V_152 , unsigned int V_115 )
{
struct V_36 * V_36 = NULL ;
struct V_127 * V_58 ;
struct V_130 V_153 , * V_154 ;
...
V_154 -> V_203 == V_204 ) {
struct V_16 * V_17 = V_13 -> V_17 ;
T_7 V_205 = F_25 ( V_154 -> V_201 . V_206 . V_205 ) ;
F_108 ( V_15 , V_129 + sizeof( V_153 ) ) ;
V_197 -= V_129 + sizeof( V_153 ) ;
F_109 ( V_15 ) ;
F_28 ( 12 , L_37 ,
& F_61 ( V_15 ) -> V_67 , & F_61 ( V_15 ) -> V_71 , V_205 ) ;
F_110 ( V_15 , F_45 ( V_15 -> V_89 ) ,
V_205 , 0 , 0 , 0 , 0 ) ;
if ( ! ( V_156 -> V_160 & F_85 ( V_207 ) ) )
goto V_208;
if ( V_17 ) {
struct V_209 * V_210 ;
F_11 () ;
V_210 = F_12 ( V_17 -> V_210 ) ;
if ( V_210 )
V_205 = F_111 ( V_210 -> V_211 ) ;
F_13 () ;
}
...
F_48 ( V_15 , V_154 -> type , V_154 -> V_203 , V_200 ) ;
F_14 ( V_13 , V_15 ) ;
V_208:
F_113 ( V_15 ) ;
V_147 = V_157 ;
...
return V_106 ;
V_36 = F_7 ( V_15 ) ;
V_40 = F_100 ( V_36 , V_132 . V_43 ) ;
if ( ! V_40 )
return V_106 ;
V_41 = V_40 -> V_41 ;
if ( V_132 . V_141 )
return V_106 ;
F_35 ( 11 , V_65 , V_41 , V_15 , V_212 ,
L_40 ) ;
...
if ( F_84 ( V_58 . V_43 == V_7 ) ) {
int V_152 ;
int V_147 = F_107 ( V_15 , & V_152 , V_115 ) ;
if ( V_152 )
return V_147 ;
}
V_40 = F_100 ( V_36 , V_58 . V_43 ) ;
...
F_84 ( ! F_39 ( & V_13 -> V_17 -> V_217 ) ) && ! V_58 . V_141 &&
F_91 ( V_15 , & V_58 ) ) {
F_119 ( V_13 ) ;
F_36 ( V_13 ) ;
V_13 = NULL ;
