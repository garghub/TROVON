...
{
struct V_101 * V_13 ;
V_13 = F_2 ( V_2 , sizeof( struct V_101 ) ,
& V_102 ) ;
if ( ! V_13 -> V_97 )
V_13 -> V_97 = V_98 ;
if ( ! V_13 -> V_99 )
...
void T_1 F_41 ( struct V_103 * V_2 )
{
F_2 ( V_2 , sizeof( * V_2 ) , & V_104 ) ;
}
void T_1 F_42 ( int (* V_17)( void ) , int V_105 ,
int V_106 )
{
struct V_107 V_2 ;
if ( ! V_106 || V_105 < 0 ) {
...
V_2 . V_109 = V_110 ;
#endif
F_2 ( & V_2 , sizeof( V_2 ) , & V_111 ) ;
}
void T_1 F_45 ( int (* V_17)( void ) , int V_105 ,
int V_106 )
{
struct V_107 V_2 ;
if ( ! V_106 || V_105 < 0 ) {
...
V_2 . V_106 = V_106 ;
V_2 . V_105 = V_105 ;
V_2 . V_17 = ( V_17 ) ? V_17 : V_112 ;
#ifdef F_44
V_2 . V_109 = V_110 ;
#endif
F_2 ( & V_2 , sizeof( V_2 ) , & V_113 ) ;
}
void T_1 F_46 ( int (* V_17)( void ) , int V_105 ,
int V_106 )
{
struct V_107 V_2 ;
if ( ! V_106 || V_105 < 0 ) {
...
V_2 . V_106 = V_106 ;
V_2 . V_105 = V_105 ;
V_2 . V_17 = ( V_17 ) ? V_17 : V_114 ;
#ifdef F_44
V_2 . V_109 = V_110 ;
#endif
F_2 ( & V_2 , sizeof( V_2 ) , & V_115 ) ;
}
