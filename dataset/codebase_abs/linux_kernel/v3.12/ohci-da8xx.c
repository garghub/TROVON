...
V_19 -> V_70 = V_62 -> V_71 ;
V_19 -> V_72 = F_34 ( V_62 ) ;
if ( ! F_35 ( V_19 -> V_70 , V_19 -> V_72 , V_73 ) ) {
F_12 ( & V_60 -> V_21 , L_13 ) ;
error = - V_74 ;
goto V_69;
}
V_19 -> V_29 = F_36 ( V_19 -> V_70 , V_19 -> V_72 ) ;
if ( ! V_19 -> V_29 ) {
F_37 ( & V_60 -> V_21 , L_14 ) ;
error = - V_66 ;
goto V_75;
...
static inline void
F_46 ( struct V_18 * V_19 , struct V_59 * V_60 )
{
struct V_12 * V_13 = F_10 ( & V_60 -> V_21 ) ;
V_13 -> V_77 ( NULL ) ;
F_41 ( V_19 ) ;
...
static int F_47 ( struct V_59 * V_21 )
{
return F_27 ( & V_78 , V_21 ) ;
}
static int F_48 ( struct V_59 * V_21 )
{
struct V_18 * V_19 = F_49 ( V_21 ) ;
F_46 ( V_19 , V_21 ) ;
return 0 ;
}
static int F_50 ( struct V_59 * V_21 , T_3 V_79 )
{
struct V_18 * V_19 = F_49 ( V_21 ) ;
struct V_24 * V_25 = F_11 ( V_19 ) ;
if ( F_51 ( V_80 , V_25 -> V_81 ) )
F_52 ( 5 ) ;
V_25 -> V_81 = V_80 ;
F_1 ( 0 ) ;
V_19 -> V_82 = V_83 ;
V_21 -> V_21 . V_84 . V_85 = V_86 ;
return 0 ;
}
static int F_53 ( struct V_59 * V_21 )
{
struct V_18 * V_19 = F_49 ( V_21 ) ;
struct V_24 * V_25 = F_11 ( V_19 ) ;
if ( F_51 ( V_80 , V_25 -> V_81 ) )
