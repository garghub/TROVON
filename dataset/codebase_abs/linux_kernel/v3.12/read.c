...
struct V_12 * V_14 = V_124 ;
int V_127 ;
V_127 = F_31 ( V_14 -> V_7 -> V_29 ) -> F_89 ( V_70 , V_14 ) ;
if ( V_127 )
F_90 ( V_70 , V_127 ) ;
}
int F_91 ( struct V_128 * V_128 , struct V_25 * V_25 )
{
struct V_37 * V_38 ;
struct V_29 * V_29 = F_92 ( V_25 ) -> V_129 ;
int error ;
F_39 ( L_5 ,
V_25 , V_26 , F_93 ( V_25 ) ) ;
F_80 ( V_29 , V_130 ) ;
F_77 ( V_29 , V_131 , 1 ) ;
error = F_94 ( V_29 , V_25 ) ;
if ( error )
goto V_132;
if ( F_37 ( V_25 ) )
goto V_132;
...
if ( V_128 == NULL ) {
error = - V_133 ;
V_38 = F_96 ( V_29 , NULL , V_134 ) ;
if ( V_38 == NULL )
goto V_132;
} else
V_38 = F_55 ( F_97 ( V_128 ) ) ;
if ( ! F_98 ( V_29 ) ) {
error = F_99 ( V_38 , V_29 , V_25 ) ;
if ( error == 0 )
goto V_17;
}
...
static int
F_100 ( void * V_14 , struct V_25 * V_25 )
{
struct V_135 * V_101 = (struct V_135 * ) V_14 ;
struct V_29 * V_29 = F_92 ( V_25 ) -> V_129 ;
struct V_39 * V_40 ;
unsigned int V_41 ;
int error ;
...
int F_101 ( struct V_128 * V_138 , struct V_139 * V_140 ,
...
goto V_17;
if ( V_138 == NULL ) {
V_101 . V_38 = F_96 ( V_29 , NULL , V_134 ) ;
if ( V_101 . V_38 == NULL )
return - V_133 ;
} else
V_101 . V_38 = F_55 ( F_97 ( V_138 ) ) ;
V_98 = F_102 ( V_101 . V_38 , V_29 , V_140 ,
V_8 , & V_141 ) ;
if ( V_98 == 0 )
goto V_144;
F_31 ( V_29 ) -> F_32 ( & V_28 , V_29 , & V_42 ) ;
V_98 = F_103 ( V_140 , V_8 , F_100 , & V_101 ) ;
F_34 ( & V_28 ) ;
F_35 ( V_29 ) -> V_43 += V_28 . V_44 ;
V_142 = ( V_28 . V_44 + V_26 - 1 ) >> V_145 ;
F_77 ( V_29 , V_131 , V_142 ) ;
V_144:
F_15 ( V_101 . V_38 ) ;
V_17:
return V_98 ;
