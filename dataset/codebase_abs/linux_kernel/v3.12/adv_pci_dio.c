...
V_49 = F_44 ( V_2 , sizeof( * V_49 ) ) ;
if ( ! V_49 )
return - V_162 ;
V_24 = F_45 ( V_2 ) ;
if ( V_24 )
return V_24 ;
V_2 -> V_13 = F_38 ( V_151 , V_76 -> V_163 ) ;
V_24 = F_46 ( V_2 , V_76 -> V_164 ) ;
if ( V_24 )
return V_24 ;
V_155 = 0 ;
...
V_4 = & V_2 -> V_125 [ V_155 ] ;
F_32 ( V_2 , V_4 , & V_76 -> V_166 [ V_11 ] ) ;
V_155 ++ ;
}
for ( V_11 = 0 ; V_11 < V_167 ; V_11 ++ )
if ( V_76 -> V_168 [ V_11 ] . V_145 ) {
V_4 = & V_2 -> V_125 [ V_155 ] ;
F_33 ( V_2 , V_4 , & V_76 -> V_168 [ V_11 ] ) ;
V_155 ++ ;
}
...
V_4 = & V_2 -> V_125 [ V_155 ] ;
V_4 -> type = V_126 ;
F_32 ( V_2 , V_4 , & V_76 -> V_172 ) ;
V_155 ++ ;
}
for ( V_11 = 0 ; V_11 < V_173 ; V_11 ++ )
if ( V_76 -> V_174 [ V_11 ] . V_145 ) {
V_4 = & V_2 -> V_125 [ V_155 ] ;
F_34 ( V_2 , V_4 , & V_76 -> V_174 [ V_11 ] ) ;
V_155 ++ ;
}
if ( V_76 -> V_77 == V_122 )
F_31 ( V_2 ) ;
...
{
unsigned long V_77 ;
V_77 = F_35 ( V_2 , V_177 -> V_178 ) ;
return F_51 ( V_2 , & V_179 , V_77 ) ;
}
