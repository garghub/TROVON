...
F_27 () ;
V_67 = F_95 ( V_262 [ V_51 ] ) ;
if ( F_102 ( V_67 && V_67 -> V_263 . V_279 ) )
...
V_260 -> V_287 = 0 ;
V_260 -> V_287 = F_107 ( F_108 ( V_257 ) , V_260 -> V_261 ) ;
} while ( ( V_257 = V_257 -> V_282 ) );
V_31:
return V_266 ;
}
static struct V_256 * * F_109 ( struct V_256 * * V_288 ,
struct V_256 * V_257 )
{
const struct V_258 * V_67 ;
...
V_260 = F_111 ( V_257 , V_291 ) ;
if ( F_112 ( V_257 , V_290 ) ) {
V_260 = F_113 ( V_257 , V_290 , V_291 ) ;
if ( F_26 ( ! V_260 ) )
goto V_31;
}
V_51 = V_260 -> V_47 ;
...
if ( * ( V_295 * ) V_260 != 0x45 )
goto V_294;
if ( F_26 ( F_107 ( ( V_295 * ) V_260 , 5 ) ) )
goto V_294;
V_267 = F_114 ( * ( T_2 * ) & V_260 -> V_267 ) ;
V_292 = ( V_296 ) ( ( F_114 ( * ( T_2 * ) V_260 ) ^ F_115 ( V_257 ) ) | ( V_267 & ~ V_297 ) ) ;
V_267 >>= 16 ;
for ( V_223 = * V_288 ; V_223 ; V_223 = V_223 -> V_282 ) {
struct V_259 * V_298 ;
if ( ! F_116 ( V_223 ) -> V_299 )
continue;
V_298 = F_99 ( V_223 ) ;
...
( ( V_296 ) ( F_43 ( V_298 -> V_267 ) + F_116 ( V_223 ) -> V_303 ) ^ V_267 ) ;
F_116 ( V_223 ) -> V_292 |= V_292 ;
}
F_116 ( V_257 ) -> V_292 |= V_292 ;
...
{
T_6 V_304 = F_17 ( V_257 -> V_284 - F_120 ( V_257 ) ) ;
struct V_259 * V_260 = F_99 ( V_257 ) ;
const struct V_258 * V_67 ;
int V_51 = V_260 -> V_47 ;
int V_27 = - V_305 ;
F_121 ( & V_260 -> V_287 , V_260 -> V_286 , V_304 ) ;
V_260 -> V_286 = V_304 ;
F_27 () ;
V_67 = F_95 ( V_262 [ V_51 ] ) ;
...
int F_122 ( struct V_1 * * V_2 , unsigned short V_307 ,
unsigned short type , unsigned char V_47 ,
struct V_46 * V_46 )
{
struct V_24 * V_1 ;
int V_308 = F_123 ( V_307 , type , V_47 , & V_1 ) ;
if ( V_308 == 0 ) {
* V_2 = V_1 -> V_2 ;
( * V_2 ) -> V_309 = V_310 ;
( * V_2 ) -> V_20 -> V_311 ( * V_2 ) ;
...
unsigned long F_125 ( void T_7 * V_312 [] , int V_313 )
{
unsigned long V_314 = 0 ;
int V_315 , V_316 ;
F_126 (i) {
for ( V_316 = 0 ; V_316 < V_317 ; V_316 ++ )
V_314 += * ( ( ( unsigned long * ) F_127 ( V_312 [ V_316 ] , V_315 ) ) + V_313 ) ;
}
return V_314 ;
}
T_8 F_128 ( void T_7 * V_312 [] , int V_313 , T_3 V_318 )
{
T_8 V_314 = 0 ;
int V_319 ;
F_126 (cpu) {
...
T_8 V_323 ;
unsigned int V_324 ;
V_320 = F_127 ( V_312 [ 0 ] , V_319 ) ;
V_322 = (struct V_321 * ) ( V_320 + V_318 ) ;
do {
V_324 = F_129 ( V_322 ) ;
V_323 = * ( ( ( T_8 * ) V_320 ) + V_313 ) ;
} while ( F_130 ( V_322 , V_324 ) );
V_314 += V_323 ;
}
return V_314 ;
}
int F_131 ( void T_7 * V_325 [ 2 ] , T_3 V_326 , T_3 V_327 )
{
F_132 ( V_325 == NULL ) ;
V_325 [ 0 ] = F_133 ( V_326 , V_327 ) ;
if ( ! V_325 [ 0 ] )
return - V_328 ;
#if V_317 == 2
V_325 [ 1 ] = F_133 ( V_326 , V_327 ) ;
if ( ! V_325 [ 1 ] ) {
F_134 ( V_325 [ 0 ] ) ;
V_325 [ 0 ] = NULL ;
return - V_328 ;
...
static T_9 int F_135 ( struct V_46 * V_46 )
{
if ( F_131 ( ( void T_7 * * ) V_46 -> V_312 . V_329 ,
sizeof( struct V_330 ) ,
F_136 ( struct V_330 ) ) < 0 )
goto V_331;
if ( F_131 ( ( void T_7 * * ) V_46 -> V_312 . V_332 ,
sizeof( struct V_333 ) ,
F_136 ( struct V_333 ) ) < 0 )
goto V_334;
if ( F_131 ( ( void T_7 * * ) V_46 -> V_312 . V_335 ,
sizeof( struct V_336 ) ,
F_136 ( struct V_336 ) ) < 0 )
goto V_337;
if ( F_131 ( ( void T_7 * * ) V_46 -> V_312 . V_338 ,
sizeof( struct V_339 ) ,
F_136 ( struct V_339 ) ) < 0 )
goto V_340;
if ( F_131 ( ( void T_7 * * ) V_46 -> V_312 . V_341 ,
sizeof( struct V_339 ) ,
F_136 ( struct V_339 ) ) < 0 )
goto V_342;
if ( F_131 ( ( void T_7 * * ) V_46 -> V_312 . V_343 ,
sizeof( struct V_344 ) ,
F_136 ( struct V_344 ) ) < 0 )
goto V_345;
V_46 -> V_312 . V_346 = F_137 ( sizeof( struct V_347 ) ,
V_73 ) ;
if ( ! V_46 -> V_312 . V_346 )
goto V_348;
F_138 ( V_46 ) ;
return 0 ;
V_348:
F_139 ( ( void T_7 * * ) V_46 -> V_312 . V_343 ) ;
V_345:
F_139 ( ( void T_7 * * ) V_46 -> V_312 . V_341 ) ;
V_342:
F_139 ( ( void T_7 * * ) V_46 -> V_312 . V_338 ) ;
V_340:
F_139 ( ( void T_7 * * ) V_46 -> V_312 . V_335 ) ;
V_337:
F_139 ( ( void T_7 * * ) V_46 -> V_312 . V_332 ) ;
V_334:
F_139 ( ( void T_7 * * ) V_46 -> V_312 . V_329 ) ;
V_331:
return - V_328 ;
}
...
struct V_224 * V_352 ;
int V_308 = - V_28 ;
F_149 ( sizeof( struct V_353 ) > F_150 ( struct V_256 , V_354 ) ) ;
V_355 = F_137 ( 65536 / 8 , V_73 ) ;
if ( ! V_355 )
goto V_31;
V_308 = F_151 ( & V_356 , 1 ) ;
if ( V_308 )
...
if ( F_155 ( & V_369 , V_370 ) < 0 )
F_145 ( L_11 , V_253 ) ;
if ( F_155 ( & V_371 , V_280 ) < 0 )
F_145 ( L_12 , V_253 ) ;
if ( F_155 ( & V_372 , V_160 ) < 0 )
F_145 ( L_13 , V_253 ) ;
#ifdef F_156
if ( F_155 ( & V_373 , V_374 ) < 0 )
F_145 ( L_14 , V_253 ) ;
#endif
