...
static int F_54 ( struct V_112 * V_15 )
{
...
{
struct V_115 * V_7 = F_61 ( & V_15 -> V_16 ) ;
struct V_4 * V_5 ;
struct V_1 * V_2 ;
struct V_116 * V_117 ;
int V_61 = 0 , V_118 ;
...
V_5 = F_62 ( & V_15 -> V_16 , sizeof( * V_5 ) , V_119 ) ;
if ( ! V_5 ) {
F_17 ( & V_15 -> V_16 , L_28 ) ;
return - V_120 ;
}
V_2 = F_62 ( & V_15 -> V_16 , sizeof( * V_2 ) , V_119 ) ;
if ( ! V_2 )
return - V_120 ;
F_63 ( V_15 , V_5 ) ;
V_5 -> V_15 = V_15 ;
V_5 -> V_7 = V_7 ;
V_5 -> V_60 = F_64 ( & V_15 -> V_16 , NULL ) ;
if ( F_65 ( V_5 -> V_60 ) )
return F_66 ( V_5 -> V_60 ) ;
V_5 -> V_17 = F_67 ( L_29 ) ;
if ( ! V_5 -> V_17 ) {
F_6 ( & V_15 -> V_16 , L_30 ) ;
return - V_120 ;
...
V_2 -> V_124 = F_4 ;
V_2 -> V_8 = F_1 ;
for ( V_118 = 0 ; V_118 < V_26 ; V_118 ++ )
F_18 ( & V_5 -> V_20 . V_25 [ V_118 ] ) ;
V_117 = F_69 ( V_5 -> V_15 ,
V_125 , L_31 ) ;
if ( V_117 == NULL ) {
F_17 ( & V_15 -> V_16 , L_32 ) ;
...
V_5 -> V_64 = F_70 ( & V_15 -> V_16 , V_117 -> V_127 , F_71 ( V_117 ) ) ;
if ( V_5 -> V_64 == NULL ) {
F_17 ( & V_15 -> V_16 , L_33 ) ;
V_61 = - V_128 ;
goto V_126;
...
V_5 -> V_129 = F_70 ( & V_15 -> V_16 , V_117 -> V_127 , F_71 ( V_117 ) ) ;
if ( V_5 -> V_129 == NULL ) {
F_17 ( & V_15 -> V_16 , L_36 ) ;
V_61 = - V_128 ;
goto V_126;
...
V_5 -> V_35 =
(struct V_130 V_131 * ) ( ( unsigned long ) V_5 -> V_129
+ ( F_21 ( V_5 -> V_129 ) & V_132 ) ) ;
if ( V_7 -> V_23 ) {
V_61 = F_72 ( & V_15 -> V_16 , V_7 -> V_23 -> V_58 ,
NULL , F_46 ,
V_133 , L_38 , V_5 ) ;
if ( V_61 ) {
F_9 ( & V_15 -> V_16 ,
...
if ( V_7 -> V_49 ) {
V_5 -> V_65 = 1 ;
V_61 = F_72 ( & V_15 -> V_16 , V_7 -> V_49 -> V_58 ,
NULL , F_46 ,
V_133 , L_40 , V_5 ) ;
if ( V_61 ) {
F_9 ( & V_15 -> V_16 ,
...
F_20 ( V_5 ) ;
F_24 ( V_5 ) ;
V_117 = F_73 ( V_5 -> V_15 , V_135 , 0 ) ;
if ( V_117 == NULL ) {
F_17 ( & V_15 -> V_16 , L_43 ) ;
V_61 = - V_9 ;
goto V_136;
}
V_5 -> V_58 = V_117 -> V_127 ;
if ( F_74 ( & V_15 -> V_16 , V_5 -> V_58 , F_45 , V_59 ,
V_122 , V_5 ) ) {
F_17 ( & V_15 -> V_16 , L_44 ,
V_5 -> V_58 ) ;
V_5 -> V_58 = 0 ;
...
V_61 = F_75 ( & V_5 -> V_6 , V_137 ) ;
if ( V_61 < 0 ) {
F_17 ( & V_15 -> V_16 , L_45 ,
V_61 ) ;
goto V_136;
}
V_61 = F_76 ( & V_15 -> V_16 . V_113 , & V_114 ) ;
if ( V_61 < 0 ) {
F_6 ( & V_15 -> V_16 ,
L_46 , V_61 ) ;
goto V_138;
...
static int F_78 ( struct V_112 * V_15 , T_5 V_84 )
{
struct V_4 * V_5 = F_55 ( V_15 ) ;
if ( V_5 -> V_6 . V_84 != V_86 ) {
F_9 ( & V_15 -> V_16 ,
...
static int F_79 ( struct V_112 * V_15 )
{
struct V_4 * V_5 = F_55 ( V_15 ) ;
T_1 V_42 ;
if ( ! V_5 -> V_65 ) {
