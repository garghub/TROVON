...
{
V_2 -> V_10 -= ( V_14 -> V_43 + V_44 - 1 ) >> V_45 ;
F_29 ( V_2 , V_14 ) ;
F_6 ( V_14 ) ;
if ( ! F_35 ( V_14 -> V_46 ) )
F_36 ( V_14 -> V_46 , 0 , V_14 -> V_47 ) ;
else if ( V_14 -> V_47 )
F_37 ( F_38 ( V_14 -> V_46 ) -> V_48 ,
V_14 -> V_47 ) ;
F_39 ( V_14 -> V_46 ) ;
F_40 ( V_14 , F_25 ) ;
}
...
struct V_104 * V_149 = F_84 ( V_14 -> V_46 ) ;
...
goto V_180;
F_24 ( & V_14 -> V_15 ) ;
V_188 = V_14 -> V_46 -> V_205 ;
F_105 ( & V_188 ) ;
V_14 -> V_16 ++ ;
V_93 = F_106 ( V_188 . V_206 -> V_207 ) ;
F_72 ( & V_14 -> V_15 ) ;
F_73 () ;
V_64 = - V_100 ;
V_39 = F_107 ( sizeof( * V_39 ) , V_208 ) ;
if ( ! V_39 ) {
F_108 ( & V_188 ) ;
goto V_209;
}
...
if ( V_64 )
goto V_213;
F_43 ( & V_42 -> V_214 -> V_215 ) ;
if ( V_66 && ! ( V_91 & V_195 ) ) {
V_64 = - V_80 ;
if ( F_112 ( V_42 -> V_214 , V_66 , V_66 + V_93 ) )
goto V_216;
if ( V_66 < V_42 -> V_214 -> V_217 &&
V_66 > V_42 -> V_214 -> V_217 - V_93 - V_44 * 5 )
goto V_216;
}
...
static int V_26 ( struct V_218 * V_33 , void * V_219 )
{
struct V_220 * V_221 = F_116 ( V_33 ) ;
struct V_13 * V_14 = V_219 ;
...
V_14 -> V_41 ,
V_14 -> V_16 ,
F_119 ( V_221 , V_14 -> V_15 . V_134 ) ,
F_120 ( V_221 , V_14 -> V_15 . V_135 ) ,
F_119 ( V_221 , V_14 -> V_15 . V_222 ) ,
F_120 ( V_221 , V_14 -> V_15 . V_223 ) ,
V_14 -> V_40 ,
V_14 -> V_50 ,
V_14 -> V_117 ,
V_155 * V_44 ,
