...
static void F_28 ( struct V_1 * V_2 , int V_49 )
{
struct V_16 * V_17 = F_8 ( V_2 ) ;
unsigned long V_20 ;
T_1 V_50 ;
...
static int F_30 ( struct V_38 * V_39 , unsigned long V_56 )
{
struct V_1 * V_2 = V_39 -> V_57 ;
struct V_16 * V_17 = F_8 ( V_2 ) ;
unsigned long V_20 ;
unsigned int V_58 ;
unsigned int V_8 ;
...
unsigned int V_71 , unsigned long V_56 )
{
struct V_72 V_73 ;
struct V_1 * V_2 = V_39 -> V_57 ;
F_3 ( & V_2 -> V_13 , L_7 , V_14 , V_71 ) ;
switch ( V_71 ) {
case V_74 :
...
V_73 . V_2 = V_2 -> V_77 ;
V_73 . V_78 = 460800 ;
if ( F_34 ( ( void V_79 * ) V_56 , & V_73 , sizeof V_73 ) )
return - V_80 ;
return 0 ;
default:
F_3 ( & V_2 -> V_13 , L_8 ,
