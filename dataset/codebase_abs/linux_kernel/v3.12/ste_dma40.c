...
{
struct V_392 * V_74 = F_176 ( & V_374 -> V_5 ) ;
...
V_187 = F_180 ( V_374 , V_399 , L_53 ) ;
if ( ! V_187 )
goto V_398;
if ( F_181 ( V_187 -> V_400 , F_182 ( V_187 ) ,
V_401 L_54 ) == NULL )
goto V_398;
V_9 = F_183 ( V_187 -> V_400 , F_182 ( V_187 ) ) ;
if ( ! V_9 )
goto V_398;
for ( V_396 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_396 |= ( F_58 ( V_9 + F_182 ( V_187 ) - 0x20 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
for ( V_397 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_397 |= ( F_58 ( V_9 + F_182 ( V_187 ) - 0x10 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
if ( V_397 != V_402 ) {
F_99 ( & V_374 -> V_5 , L_55 ) ;
goto V_398;
}
if ( F_184 ( V_396 ) != V_403 ) {
F_99 ( & V_374 -> V_5 , L_56 ,
F_184 ( V_396 ) ,
V_403 ) ;
goto V_398;
...
V_8 = F_186 ( F_47 ( sizeof( struct V_109 ) , 4 ) +
( V_110 + V_216 + V_368 ) *
...
V_8 -> V_111 = F_186 ( V_110 * sizeof( struct V_218 ) ,
V_408 ) ;
if ( ! V_8 -> V_111 )
goto V_398;
V_8 -> V_207 = F_186 ( V_110 *
sizeof( struct V_2 * ) ,
V_408 ) ;
if ( ! V_8 -> V_207 )
goto V_398;
V_8 -> V_208 = F_186 ( V_216 *
sizeof( struct V_2 * ) ,
V_408 ) ;
if ( ! V_8 -> V_208 )
goto V_398;
...
goto V_398;
V_8 -> V_36 . V_40 =
F_186 ( V_110 * sizeof( struct V_14 * )
* V_38 , V_408 ) ;
if ( ! V_8 -> V_36 . V_40 )
goto V_398;
V_8 -> V_48 = F_187 ( V_401 , sizeof( struct V_14 ) ,
0 , V_435 ,
NULL ) ;
if ( V_8 -> V_48 == NULL )
goto V_398;
...
static void T_9 F_192 ( struct V_109 * V_8 )
{
int V_33 ;
T_2 V_436 [ 2 ] = { 0 , 0 } ;
...
static int T_9 F_193 ( struct V_109 * V_8 )
{
...
V_444 [ V_33 ] = F_194 ( V_408 ,
V_8 -> V_36 . V_446 ) ;
if ( ! V_444 [ V_33 ] ) {
F_99 ( V_8 -> V_5 , L_60 ,
V_8 -> V_36 . V_446 ) ;
for ( V_235 = 0 ; V_235 < V_33 ; V_235 ++ )
F_195 ( V_444 [ V_235 ] , V_8 -> V_36 . V_446 ) ;
goto V_398;
}
...
static int T_9 F_197 ( struct V_373 * V_374 ,
struct V_350 * V_452 )
{
struct V_392 * V_453 ;
int V_454 = 0 , V_455 = 0 , V_456 = 0 ;
const T_11 * V_457 ;
V_453 = F_198 ( & V_374 -> V_5 ,
sizeof( struct V_392 ) ,
V_408 ) ;
if ( ! V_453 )
return - V_25 ;
F_199 ( V_452 , L_62 , & V_454 ) ;
if ( V_454 > 0 )
V_453 -> V_404 = V_454 ;
V_457 = F_200 ( V_452 , L_63 , & V_455 ) ;
V_455 /= sizeof( * V_457 ) ;
...
static int T_9 F_202 ( struct V_373 * V_374 )
{
struct V_392 * V_74 = F_176 ( & V_374 -> V_5 ) ;
...
F_157 ( & V_8 -> V_204 ) ;
F_157 ( & V_8 -> V_127 ) ;
V_187 = F_180 ( V_374 , V_399 , L_68 ) ;
if ( ! V_187 ) {
V_34 = - V_462 ;
F_99 ( & V_374 -> V_5 , L_69 ) ;
goto V_398;
}
V_8 -> V_463 = F_182 ( V_187 ) ;
...
V_8 -> V_296 = F_183 ( V_187 -> V_400 , F_182 ( V_187 ) ) ;
if ( ! V_8 -> V_296 ) {
V_34 = - V_25 ;
F_99 ( & V_374 -> V_5 , L_73 ) ;
goto V_398;
...
V_8 -> V_36 . V_8 = F_183 ( V_187 -> V_400 ,
F_182 ( V_187 ) ) ;
if ( ! V_8 -> V_36 . V_8 ) {
V_34 = - V_25 ;
F_99 ( & V_374 -> V_5 , L_76 ) ;
...
F_157 ( & V_8 -> V_36 . V_37 ) ;
V_8 -> V_198 = F_204 ( V_374 , 0 ) ;
V_34 = F_205 ( V_8 -> V_198 , F_95 , 0 , V_401 , V_8 ) ;
if ( V_34 ) {
F_99 ( & V_374 -> V_5 , L_78 ) ;
goto V_398;
}
...
F_210 ( V_8 -> V_5 ) ;
if ( V_8 -> V_74 -> V_73 ) {
V_8 -> V_375 = F_211 ( V_8 -> V_5 , L_74 ) ;
if ( F_178 ( V_8 -> V_375 ) ) {
F_99 ( & V_374 -> V_5 , L_79 ) ;
V_34 = F_212 ( V_8 -> V_375 ) ;
V_8 -> V_375 = NULL ;
goto V_398;
}
V_34 = F_170 ( V_8 -> V_375 ) ;
...
F_195 ( ( unsigned long ) V_8 -> V_36 . V_8 ,
V_8 -> V_36 . V_446 ) ;
F_10 ( V_8 -> V_36 . V_450 ) ;
if ( V_8 -> V_464 )
F_191 ( V_8 -> V_464 ,
