...
struct V_106 V_107 ;
unsigned long V_108 ;
V_108 = F_111 ( struct V_106 , V_109 ) ;
if ( F_112 ( & V_107 , ( void T_2 * ) V_59 , V_108 ) )
return - V_110 ;
...
if ( V_14 -> V_19 )
V_107 . V_109 |= V_113 ;
if ( F_113 ( ( void T_2 * ) V_59 , & V_107 , V_108 ) )
return - V_110 ;
V_26 = 0 ;
break;
}
...
{
char * V_80 ;
V_80 = F_115 ( ( const char T_2 * ) V_59 , V_117 ) ;
if ( F_34 ( V_80 ) )
return F_67 ( V_80 ) ;
...
struct V_13 * F_128 ( struct V_72 * V_73 )
{
struct V_13 * V_14 = V_73 -> V_75 ;
if ( V_73 -> V_94 != & V_118 )
return F_23 ( - V_10 ) ;
...
void F_130 ( struct V_13 * V_14 )
{
F_39 ( V_14 ) ;
F_97 ( V_14 ) ;
}
int F_131 ( struct V_13 * V_14 )
{
return F_33 ( V_14 -> V_22 ) ;
}
static char * F_132 ( struct V_24 * V_25 , T_5 * V_119 )
{
if ( V_119 && ( F_133 ( V_25 -> V_34 ) == 0 ) )
* V_119 = V_120 | V_121 ;
return F_134 ( V_6 , L_9 , F_60 ( V_25 ) ) ;
}
...
F_25 ( & V_8 . V_12 ) ;
F_137 ( & V_8 . V_41 ) ;
V_8 . V_33 = F_138 ( V_122 , L_10 ) ;
if ( F_34 ( V_8 . V_33 ) ) {
V_26 = F_67 ( V_8 . V_33 ) ;
goto V_123;
}
V_8 . V_33 -> V_124 = F_132 ;
V_26 = F_139 ( & V_8 . V_34 , 0 , V_16 , L_10 ) ;
if ( V_26 )
goto V_125;
F_140 ( & V_8 . V_126 , & V_95 ) ;
V_26 = F_141 ( & V_8 . V_126 , V_8 . V_34 , 1 ) ;
if ( V_26 )
goto V_127;
...
F_140 ( & V_8 . V_129 , & V_118 ) ;
V_26 = F_141 ( & V_8 . V_129 ,
F_31 ( F_32 ( V_8 . V_34 ) , 1 ) , V_16 - 1 ) ;
if ( V_26 )
goto V_130;
F_142 ( V_131 L_11 V_132 L_12 ) ;
F_143 ( L_13 ) ;
F_143 ( L_14 ) ;
return 0 ;
V_130:
