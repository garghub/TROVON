...
int F_18 ( struct V_1 * V_2 , struct V_37 * V_29 ,
unsigned long V_38 , T_1 V_32 ,
struct V_7 * V_39 )
{
V_2 -> V_29 = V_29 ;
V_2 -> V_40 = V_29 -> V_40 ;
V_2 -> V_4 = ( V_38 + V_41 - 1 ) >> V_42 ;
V_2 -> V_20 = V_13 ;
V_2 -> V_32 = V_32 ;
V_2 -> V_39 = V_39 ;
V_2 -> V_21 = V_22 ;
...
int F_22 ( struct V_5 * V_44 , struct V_37 * V_29 ,
unsigned long V_38 , T_1 V_32 ,
struct V_7 * V_39 )
{
...
if ( V_2 -> V_21 == V_27 )
return 0 ;
V_12 = V_2 -> V_29 -> V_30 -> V_50 ( V_2 ) ;
if ( V_12 )
return V_12 ;
V_12 = V_2 -> V_35 -> V_51 ( V_2 , V_48 ) ;
if ( F_13 ( V_12 != 0 ) )
return V_12 ;
V_2 -> V_21 = V_27 ;
return 0 ;
...
int V_17 ;
int V_12 = - V_43 ;
F_25 ( V_2 -> V_21 != V_28 && V_2 -> V_21 != V_22 ) ;
F_25 ( V_2 -> V_20 != V_13 ) ;
if ( ! V_59 ) {
V_34 = F_35 ( L_2 ,
V_2 -> V_4 << V_42 ,
