...
V_2 -> V_25 [ V_19 ] . V_26 = V_61 -> V_67 [ V_19 ] ;
V_2 -> V_25 [ V_19 ] . V_68 = V_69 ;
V_2 -> V_25 [ V_19 ] . V_70 = V_71 [ V_19 ] ;
}
V_7 = F_31 ( V_2 -> V_25 ,
F_30 ( V_2 -> V_25 ) ) ;
if ( V_7 )
...
F_32 ( V_3 , V_6 ) ;
V_2 -> V_3 = V_3 ;
V_6 -> V_62 . V_73 = & V_3 -> V_62 ;
V_6 -> V_74 = F_33 ( V_3 ) -> V_74 ;
V_6 -> V_75 = V_76 ;
V_6 -> V_77 = & V_78 ;
F_22 ( V_6 ) ;
V_2 -> V_79 [ 0 ] . V_80 = & V_2 -> V_4 ;
V_2 -> V_79 [ 0 ] . V_81 = 2 ;
V_2 -> V_79 [ 0 ] . V_82 = 1 ;
V_2 -> V_79 [ 1 ] . V_80 = & V_2 -> V_4 ;
V_2 -> V_79 [ 1 ] . V_81 = 4 ;
V_2 -> V_79 [ 1 ] . V_82 = 1 ;
V_2 -> V_79 [ 2 ] . V_83 = & V_2 -> V_4 ;
V_2 -> V_79 [ 2 ] . V_81 = 1 ;
F_34 ( & V_2 -> V_31 ) ;
F_35 ( & V_2 -> V_79 [ 0 ] , & V_2 -> V_31 ) ;
F_35 ( & V_2 -> V_79 [ 1 ] , & V_2 -> V_31 ) ;
F_35 ( & V_2 -> V_79 [ 2 ] , & V_2 -> V_31 ) ;
V_7 = F_36 ( V_6 , & V_84 ,
& F_8 , & V_85 ) ;
if ( V_7 )
goto V_86;
...
static int F_41 ( struct V_59 * V_3 )
{
struct V_5 * V_6 = F_42 ( V_3 ) ;
struct V_1 * V_2 = F_5 ( V_6 ) ;
F_43 ( V_6 ) ;
F_38 ( V_6 ) ;
if ( ! V_2 -> V_20 )
