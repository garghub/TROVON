...
F_3 ( V_7 , V_3 ) ;
F_30 ( F_31 ( V_3 ) ) ;
V_51 = F_32 ( V_3 , V_7 -> V_54 [ 1 ] . V_55 , 0 ) ;
if ( V_51 != 0 )
goto V_59;
return 0 ;
V_59:
...
static int F_37 ( struct V_6 * V_63 )
{
return F_22 ( & V_64 , V_63 ) ;
}
static int F_38 ( struct V_6 * V_63 )
{
struct V_2 * V_3 = F_39 ( V_63 ) ;
F_19 ( V_3 , V_63 ) ;
return 0 ;
}
static int F_40 ( struct V_65 * V_7 )
{
struct V_2 * V_3 = F_41 ( V_7 ) ;
struct V_60 * V_61 = F_31 ( V_3 ) ;
struct V_6 * V_63 = F_42 ( V_7 ) ;
unsigned long V_20 ;
int V_66 = 0 ;
F_43 ( & V_61 -> V_67 , V_20 ) ;
if ( V_61 -> V_68 != V_69 ) {
