...
static int T_8 F_50 ( char * V_105 , int V_3 )
{
int V_36 = 0 ;
struct V_1 * log ;
unsigned char * V_14 ;
...
if ( V_14 == NULL )
return - V_82 ;
log = F_52 ( sizeof( struct V_1 ) , V_81 ) ;
if ( log == NULL ) {
V_36 = - V_82 ;
goto V_106;
}
log -> V_14 = V_14 ;
log -> V_77 . V_76 = V_107 ;
log -> V_77 . V_108 = F_53 ( V_105 , V_81 ) ;
if ( log -> V_77 . V_108 == NULL ) {
V_36 = - V_82 ;
goto V_109;
}
log -> V_77 . V_110 = & V_111 ;
log -> V_77 . V_112 = NULL ;
F_54 ( & log -> V_40 ) ;
F_40 ( & log -> V_86 ) ;
F_55 ( & log -> V_39 ) ;
...
F_58 ( L_2 ,
( unsigned long ) log -> V_3 >> 10 , log -> V_77 . V_108 ) ;
return 0 ;
V_109:
F_44 ( log ) ;
V_106:
...
{
int V_36 ;
V_36 = F_50 ( V_115 , 256 * 1024 ) ;
if ( F_21 ( V_36 ) )
goto V_49;
V_36 = F_50 ( V_116 , 256 * 1024 ) ;
if ( F_21 ( V_36 ) )
goto V_49;
V_36 = F_50 ( V_117 , 256 * 1024 ) ;
if ( F_21 ( V_36 ) )
goto V_49;
V_36 = F_50 ( V_118 , 256 * 1024 ) ;
if ( F_21 ( V_36 ) )
goto V_49;
V_49:
return V_36 ;
...
{
struct V_1 * V_119 , * V_120 ;
F_62 (current_log, next_log, &log_list, logs) {
F_63 ( & V_119 -> V_77 ) ;
F_59 ( V_119 -> V_14 ) ;
F_44 ( V_119 -> V_77 . V_108 ) ;
F_43 ( & V_119 -> V_113 ) ;
F_44 ( V_119 ) ;
}
}
