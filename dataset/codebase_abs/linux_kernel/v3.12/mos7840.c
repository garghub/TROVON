...
F_2 ( & V_23 -> V_2 -> V_6 , L_48 , V_18 , V_147 ) ;
return V_147 ;
}
...
F_2 ( & V_2 -> V_6 , L_53 , V_18 , V_23 -> V_129 ) ;
V_92 |= V_131 ;
V_52 = F_9 ( V_2 , V_128 , V_92 ) ;
V_92 = 0x00 ;
V_52 = F_10 ( V_2 , V_132 , & V_92 ) ;
F_2 ( & V_2 -> V_6 , L_54 , V_18 , V_92 ) ;
V_92 = 0x0 ;
...
F_2 ( & V_2 -> V_6 , L_62 , V_2 -> V_30 . V_153 ) ;
exit:
return V_149 ;
}
...
return 0 ;
#ifdef F_76
for ( V_95 = 0 ; V_95 < F_77 ( V_180 ) ; V_95 ++ ) {
if ( V_180 [ V_95 ] . V_181 == V_182 ) {
* V_178 = V_180 [ V_95 ] . V_183 ;
return 0 ;
}
}
...
V_184 ++ ;
* V_178 = V_184 ;
F_2 ( & V_2 -> V_6 , L_68 , V_182 , V_184 ) ;
return 0 ;
}
F_2 ( & V_2 -> V_6 , L_14 , L_69 ) ;
return - 1 ;
#endif
}
...
if ( V_52 ) {
F_35 ( & V_2 -> V_6 , L_73 , V_18 ) ;
return V_52 ;
}
V_92 = V_23 -> V_129 | V_131 ;
V_23 -> V_129 = V_92 ;
F_9 ( V_2 , V_128 , V_92 ) ;
V_92 = ( unsigned char ) ( V_178 & 0xff ) ;
F_2 ( & V_2 -> V_6 , L_74 , V_92 ) ;
F_9 ( V_2 , V_132 , V_92 ) ;
V_92 = ( unsigned char ) ( ( V_178 & 0xff00 ) >> 8 ) ;
...
struct V_22 * V_23 , struct V_188 * V_189 )
{
int V_190 ;
unsigned V_191 ;
unsigned V_192 ;
...
V_195 = V_197 ;
V_194 = V_198 ;
V_191 = V_116 -> V_155 . V_156 ;
V_192 = V_116 -> V_155 . V_199 ;
if ( V_191 & V_200 ) {
switch ( V_191 & V_200 ) {
case V_201 :
V_193 = V_202 ;
...
V_190 = F_81 ( V_116 ) ;
if ( ! V_190 ) {
F_2 ( & V_2 -> V_6 , L_14 , L_82 ) ;
V_190 = 9600 ;
}
F_2 ( & V_2 -> V_6 , L_83 , V_18 , V_190 ) ;
V_52 = F_78 ( V_23 , V_190 ) ;
V_92 = 0x0c ;
F_9 ( V_2 , V_126 , V_92 ) ;
if ( V_23 -> V_105 == false ) {
V_23 -> V_105 = true ;
...
V_116 -> V_155 . V_156 , F_83 ( V_116 -> V_155 . V_199 ) ) ;
F_2 ( & V_2 -> V_6 , L_88 , V_18 ,
V_189 -> V_156 , F_83 ( V_189 -> V_199 ) ) ;
F_80 ( V_116 , V_23 , V_189 ) ;
if ( ! V_23 -> V_109 ) {
F_2 ( & V_2 -> V_6 , L_14 , L_89 ) ;
return;
}
if ( V_23 -> V_105 == false ) {
V_23 -> V_105 = true ;
...
V_225 . type = V_226 ;
V_225 . line = V_23 -> V_2 -> V_138 ;
V_225 . V_2 = V_23 -> V_2 -> V_20 ;
V_225 . V_227 = 0 ;
V_225 . V_63 = V_228 | V_229 ;
V_225 . V_230 = V_112 * V_124 ;
V_225 . V_231 = 9600 ;
V_225 . V_232 = 5 * V_233 ;
V_225 . V_234 = 30 * V_233 ;
if ( F_85 ( V_224 , & V_225 , sizeof( * V_224 ) ) )
return - V_222 ;
return 0 ;
}
static int F_87 ( struct V_115 * V_116 ,
unsigned int V_235 , unsigned long V_81 )
{
struct V_1 * V_2 = V_116 -> V_143 ;
void T_4 * V_236 = ( void T_4 * ) V_81 ;
struct V_22 * V_23 ;
if ( F_36 ( V_2 , V_18 ) )
return - 1 ;
V_23 = F_14 ( V_2 ) ;
if ( V_23 == NULL )
return - 1 ;
F_2 ( & V_2 -> V_6 , L_90 , V_18 , V_235 ) ;
switch ( V_235 ) {
case V_237 :
F_2 ( & V_2 -> V_6 , L_91 , V_18 ) ;
return F_84 ( V_116 , V_236 ) ;
case V_238 :
F_2 ( & V_2 -> V_6 , L_92 , V_18 ) ;
return F_86 ( V_23 , V_236 ) ;
case V_239 :
...
if ( ! V_12 )
return 0 ;
V_244 = F_3 ( V_7 -> V_6 , F_7 ( V_7 -> V_6 , 0 ) ,
...
if ( V_244 == V_13 )
V_27 = * V_12 ;
if ( ( ( V_243 >> V_95 ) ^ ( ~ V_27 >> 1 ) ) & 0x0001 )
break;
V_241 ++ ;
}
F_3 ( V_7 -> V_6 , F_4 ( V_7 -> V_6 , 0 ) , V_8 ,
V_9 , 0x0300 | V_242 , V_82 , NULL ,
0 , V_10 ) ;
F_8 ( V_12 ) ;
if ( V_241 == 16 )
return 1 ;
...
{
T_5 V_248 = F_90 ( V_7 -> V_6 -> V_249 . V_250 ) ;
T_2 * V_12 ;
int V_251 ;
if ( V_248 == V_252 ||
V_248 == V_253 ) {
...
F_8 ( V_12 ) ;
V_57:
F_92 ( V_7 , ( void * ) ( unsigned long ) V_251 ) ;
return 0 ;
}
static int F_93 ( struct V_91 * V_7 )
{
int V_251 = ( unsigned long ) F_94 ( V_7 ) ;
int V_255 ;
V_255 = ( V_251 >> 4 ) & 0x000F ;
return V_255 ;
}
...
T_1 V_92 ;
V_256 = V_2 -> V_20 ;
F_2 ( & V_2 -> V_6 , L_94 , V_256 ) ;
V_23 = F_91 ( sizeof( struct V_22 ) , V_14 ) ;
if ( V_23 == NULL ) {
F_35 ( & V_2 -> V_6 , L_95 , V_18 ) ;
return - V_15 ;
}
V_23 -> V_2 = V_2 ;
F_12 ( V_2 , V_23 ) ;
F_96 ( & V_23 -> V_111 ) ;
V_23 -> V_60 = V_256 + 1 ;
F_2 ( & V_2 -> V_6 , L_96 , V_2 -> V_138 ) ;
F_2 ( & V_2 -> V_6 , L_97 , V_23 -> V_60 ) ;
if ( V_23 -> V_60 == 1 ) {
V_23 -> V_24 = 0x0 ;
V_23 -> V_25 = 0x1 ;
V_23 -> V_26 = 0x4 ;
...
( ( T_1 ) V_23 -> V_60 ) ) , V_92 ) ;
F_2 ( & V_2 -> V_6 , L_114 ,
( T_1 ) ( V_260 + ( ( T_1 ) V_23 -> V_60 ) ) ) ;
if ( V_52 < 0 ) {
F_2 ( & V_2 -> V_6 , L_115 , V_256 + 2 , V_52 ) ;
goto V_57;
} else
F_2 ( & V_2 -> V_6 , L_116 , V_256 + 2 , V_52 ) ;
} else {
V_92 = 0xff ;
V_52 = F_1 ( V_2 ,
( T_1 ) ( V_260 +
...
F_2 ( & V_2 -> V_6 , L_114 ,
( T_1 ) ( V_260 + ( ( T_1 ) V_23 -> V_60 ) - 0x1 ) ) ;
if ( V_52 < 0 ) {
F_2 ( & V_2 -> V_6 , L_115 , V_256 + 1 , V_52 ) ;
goto V_57;
} else
F_2 ( & V_2 -> V_6 , L_116 , V_256 + 1 , V_52 ) ;
}
