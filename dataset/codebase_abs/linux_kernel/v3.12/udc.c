...
V_138 = F_65 ( & V_54 -> V_81 , V_71 , V_142 ) ;
if ( V_138 )
goto V_159;
return 0 ;
V_159:
...
V_4 -> V_88 -> V_160 = V_4 ;
V_4 -> V_88 -> V_126 = F_70 ;
V_138 = F_65 ( & V_54 -> V_81 , V_4 -> V_88 , V_63 ) ;
return V_138 ;
}
...
V_4 -> V_144 = V_82 ;
F_51 ( & V_4 -> V_124 ) ;
V_167 = V_4 -> V_136 -> V_150 ( & V_4 -> V_90 , & V_71 ) ;
F_52 ( & V_4 -> V_124 ) ;
break;
}
if ( V_167 < 0 ) {
...
if ( V_54 -> V_1 )
V_138 |= F_10 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 ,
V_54 -> type ) ;
...
do {
V_138 |= F_50 ( V_54 ) ;
V_138 |= F_9 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 ) ;
if ( V_54 -> type == V_111 )
...
V_192 = V_54 -> V_2 ;
do {
V_138 |= F_16 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 , V_36 ) ;
if ( ! V_36 )
V_54 -> V_175 = 0 ;
if ( V_54 -> type == V_111 )
V_54 -> V_2 = ( V_54 -> V_2 == V_82 ) ? V_33 : V_82 ;
...
V_138 = F_105 ( & V_4 -> V_134 -> V_81 ) ;
if ( V_138 )
return V_138 ;
V_4 -> V_135 -> V_81 . V_143 = & V_222 ;
V_138 = F_105 ( & V_4 -> V_135 -> V_81 ) ;
if ( V_138 )
return V_138 ;
F_55 ( & V_4 -> V_124 , V_129 ) ;
V_4 -> V_136 = V_136 ;
...
V_138 = F_3 ( V_4 , V_4 -> V_134 -> V_98 . V_8 ) ;
if ( V_138 )
F_96 ( & V_4 -> V_90 . V_139 ) ;
V_104:
F_56 ( & V_4 -> V_124 , V_129 ) ;
...
V_229 : V_230 ;
if ( V_4 -> V_133 && V_4 -> V_136 -> V_231 ) {
F_51 ( & V_4 -> V_124 ) ;
V_4 -> V_136 -> V_231 ( & V_4 -> V_90 ) ;
F_52 ( & V_4 -> V_124 ) ;
V_4 -> V_133 = 0 ;
}
}
...
if ( V_4 -> V_241 ) {
V_4 -> V_208 = F_112 ( V_242 ) ;
if ( F_113 ( V_4 -> V_208 ) )
V_4 -> V_208 = NULL ;
}
if ( V_4 -> V_201 -> V_129 & V_243 ) {
if ( V_4 -> V_208 == NULL ) {
V_138 = - V_244 ;
goto F_103;
}
...
if ( V_4 -> V_208 ) {
V_138 = F_114 ( V_4 -> V_208 -> V_245 ,
& V_4 -> V_90 ) ;
if ( V_138 && V_138 != - V_209 )
goto V_246;
}
V_138 = F_115 ( V_139 , & V_4 -> V_90 ) ;
if ( V_138 )
goto V_247;
F_116 ( & V_4 -> V_90 . V_139 ) ;
F_117 ( & V_4 -> V_90 . V_139 ) ;
F_118 ( V_4 ) ;
return V_138 ;
V_247:
if ( V_4 -> V_208 ) {
F_114 ( V_4 -> V_208 -> V_245 , NULL ) ;
if ( V_4 -> V_241 )
F_119 ( V_4 -> V_208 ) ;
}
F_63 ( V_139 , L_17 , V_138 ) ;
V_246:
if ( V_4 -> V_208 && V_4 -> V_241 )
F_119 ( V_4 -> V_208 ) ;
F_103:
F_103 ( V_4 ) ;
V_239:
...
{
struct V_252 * V_253 ;
if ( ! F_7 ( V_4 , V_254 , V_255 ) )
return - V_256 ;
V_253 = F_129 ( V_4 -> V_139 , sizeof( struct V_252 ) , V_217 ) ;
if ( ! V_253 )
return - V_64 ;
V_253 -> V_257 = F_123 ;
V_253 -> V_258 = F_126 ;
