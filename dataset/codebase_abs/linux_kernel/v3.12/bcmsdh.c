...
F_38 ( & V_126 ) ;
F_42 ( & V_126 , V_121 ) ;
V_36 = F_60 ( V_6 , V_38 , V_58 , V_18 , & V_126 ) ;
F_61 ( & V_126 ) ;
F_52 ( V_121 ) ;
return V_36 ;
}
...
V_46 = ( V_18 & V_124 ) ? 4 : 2 ;
F_27 ( V_6 , V_46 , & V_38 ) ;
V_36 = F_32 ( V_6 , V_58 , true , V_38 , V_126 ) ;
return V_36 ;
}
int
F_62 ( struct V_5 * V_6 , bool V_51 , T_3 V_35 ,
T_2 * V_17 , T_5 V_131 )
{
int V_132 = 0 ;
struct V_75 * V_122 ;
...
int F_67 ( struct V_5 * V_6 , T_5 V_58 )
{
...
void F_74 ( struct V_5 * V_6 , bool V_146 )
{
if ( V_146 )
F_75 ( V_6 -> V_11 , V_147 ) ;
else
