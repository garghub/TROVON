...
V_102 = V_100 ;
V_58 = F_37 ( V_103 , V_103 -> V_104 , V_40 ,
V_102 , 0 , 1 , V_101 , NULL ) ;
if ( V_58 != V_102 ) {
V_29 = 0 ;
V_102 = V_58 ;
V_58 = - V_59 ;
...
unsigned long V_106 = V_40 & ~ V_95 ;
int V_107 = ( ( V_106 + V_99 ) > V_108 ) ?
( V_108 - V_106 ) : V_99 ;
V_58 = F_13 ( V_44 , V_7 , V_28 ,
V_101 [ V_29 ] , 1 , V_106 , V_107 , NULL ) ;
if ( V_58 < 0 ) {
V_29 ++ ;
goto V_105;
}
...
int V_58 = 0 ;
unsigned long V_109 ;
for ( V_109 = 0 ; V_109 < V_87 ; V_109 ++ ) {
const int V_100 = F_31 ( V_86 + V_109 ) ;
const unsigned long V_40 = ( unsigned long ) V_86 [ V_109 ] . V_91 ;
V_58 = F_36 ( V_44 , V_7 , V_28 , V_40 ,
V_86 [ V_109 ] . V_92 , V_100 ) ;
if ( V_58 < 0 )
goto V_110;
}
goto V_9;
V_110:
for ( V_109 = 1 ; V_109 < V_28 -> V_67 ; V_109 ++ )
F_32 ( & V_44 -> V_56 -> V_3 , V_7 , V_28 , V_109 ) ;
if ( V_28 -> V_40 [ 0 ] . V_35 ) {
F_34 ( & V_44 -> V_56 -> V_3 ,
V_28 -> V_40 [ 0 ] . V_40 ,
V_28 -> V_40 [ 0 ] . V_39 ,
...
T_5 V_10 = V_7 -> V_10 ;
T_1 V_65 ;
while ( V_109 < V_87 && V_119 < * V_117 ) {
const unsigned long V_40 = ( unsigned long ) V_86 [ V_109 ] . V_91 ;
const unsigned long V_122 = V_109 ;
unsigned V_123 ;
unsigned V_124 ;
int V_125 = 0 ;
int V_100 = 0 ;
...
int V_61 = 0 ;
int V_90 ;
V_31 = V_86 [ V_109 ] . V_92 ;
V_121 = V_31 >> 2 ;
if ( V_31 < V_126 ||
V_31 > V_108 || V_31 & 3 || V_40 & 3 ) {
V_58 = - V_127 ;
goto V_128;
}
V_120 = F_11 ( V_7 , V_31 , & V_38 ) ;
if ( ! V_120 ) {
V_58 = - V_59 ;
goto V_128;
}
V_90 = F_30 ( V_120 , V_86 [ V_109 ] . V_91 , V_31 ) ;
if ( V_90 ) {
V_58 = - V_69 ;
goto V_129;
}
V_124 = V_121 - 1 ;
V_123 = F_24 ( * V_120 ) & 0xFFFF ;
if ( V_123 < V_124 ) {
V_58 = - V_127 ;
goto V_129;
}
V_109 ++ ;
while ( V_124 < V_123 && V_109 < V_87 ) {
const T_3 V_130 = V_86 [ V_109 ] . V_92 ;
const unsigned long V_131 =
( unsigned long ) V_86 [ V_109 ] . V_91 ;
if ( V_130 & 3 || V_131 & 3 || ! V_130 ) {
V_58 = - V_127 ;
goto V_129;
}
V_100 += F_31 ( & V_86 [ V_109 ] ) ;
V_66 += V_130 ;
V_124 += V_130 >> 2 ;
V_109 ++ ;
V_125 ++ ;
...
V_135 = V_100 * ( ( 2 * V_108 / V_65 ) + 1 ) ;
V_133 = sizeof( * V_28 ) + sizeof( V_28 -> V_40 [ 0 ] ) * V_135 ;
V_61 = ( ( ( F_24 ( V_120 [ 7 ] ) >>
V_81 ) &
V_136 ) !=
V_136 ) ;
if ( V_61 )
V_134 = V_86 [ V_109 ] . V_92 ;
else
V_134 = 0 ;
V_28 = F_2 ( V_133 + V_134 , V_8 ) ;
if ( ! V_28 ) {
V_58 = - V_59 ;
goto V_129;
}
V_28 -> V_114 = 1 ;
V_28 -> V_65 = V_65 ;
V_28 -> V_68 = V_135 + F_40 ( V_28 -> V_40 ) ;
if ( V_61 ) {
char * V_62 = ( char * ) V_28 + V_133 ;
V_90 = F_30 ( V_62 ,
V_86 [ V_109 ] . V_91 , V_134 ) ;
if ( V_90 ) {
V_58 = - V_69 ;
goto V_110;
}
...
* V_120 = F_26 ( F_24 ( * V_120 ) & 0x0000FFFF ) ;
} else {
...
V_129:
if ( V_38 )
F_35 ( V_7 -> V_23 , V_120 , V_38 ) ;
else
F_9 ( V_120 ) ;
V_128:
F_41 ( & V_44 -> V_56 -> V_3 , V_7 , V_112 ) ;
V_9:
return V_58 ;
}
...
T_7 V_140 = V_116 -> V_141 - V_28 -> V_14 ;
if ( V_140 < 0 )
break;
F_50 ( & V_28 -> V_112 , & V_128 ) ;
V_58 ++ ;
V_7 -> V_13 -- ;
}
F_51 ( & V_7 -> V_16 , V_75 ) ;
if ( ! F_52 ( & V_128 ) ) {
T_5 V_10 ;
V_28 = F_53 ( V_128 . V_142 ,
struct V_20 , V_112 ) ;
V_10 = V_28 -> V_10 ;
F_41 ( & V_44 -> V_56 -> V_3 , V_7 , & V_128 ) ;
F_47 ( V_7 , V_10 ) ;
}
return V_58 ;
}
...
int V_58 ;
unsigned long V_75 ;
F_49 ( & V_116 -> V_143 , V_75 ) ;
V_58 = F_57 ( V_116 ) ;
F_51 ( & V_116 -> V_143 , V_75 ) ;
return V_58 ;
}
void F_58 ( struct V_115 * V_116 ,
struct V_1 * V_7 )
{
struct V_43 * V_44 = V_116 -> V_44 ;
unsigned long V_75 ;
...
static inline T_8 F_64 ( T_9 V_145 ,
T_10 V_40 , T_10 V_146 , T_10 V_147 )
{
return F_65 (
...
static inline T_8 F_66 ( T_8 V_148 )
{
return V_148 | F_65 ( 1ULL << 12 ) ;
}
static inline T_8 F_67 ( T_8 V_148 )
{
return V_148 | F_65 ( 1ULL << 11 | 1ULL << 13 ) ;
}
...
struct V_20 * V_28 , int V_109 ,
unsigned V_149 , T_1 V_150 , T_9 V_145 )
{
const T_10 V_40 = ( T_10 ) V_28 -> V_40 [ V_109 ] . V_40 +
( T_10 ) V_28 -> V_40 [ V_109 ] . V_30 ;
const T_10 V_146 = ( T_10 ) V_28 -> V_40 [ V_109 ] . V_41 / 4 ;
T_8 * V_151 ;
T_8 V_152 ;
V_151 = & V_116 -> V_153 [ V_150 ] . V_154 [ 0 ] ;
V_152 = F_64 ( V_145 , V_40 , V_146 , V_149 ) ;
if ( V_28 -> V_40 [ V_109 ] . V_32 )
V_152 = F_66 ( V_152 ) ;
if ( V_28 -> V_40 [ V_109 ] . V_33 ) {
V_152 = F_67 ( V_152 ) ;
if ( V_116 -> V_155 ) {
V_152 |= F_65 ( 1ULL << 15 ) ;
V_116 -> V_155 = 0 ;
...
V_161:
V_158 = 0 ;
V_159 = V_150 = V_116 -> V_162 ;
V_160 = V_145 = V_116 -> V_163 ;
while ( ! F_52 ( V_156 ) ) {
struct V_20 * V_28 =
F_53 ( V_156 -> V_164 , struct V_20 ,
V_112 ) ;
int V_29 , V_102 , V_138 = 0 ;
unsigned V_149 = 0 ;
T_1 V_165 = V_150 ;
for ( V_29 = V_28 -> V_70 ; V_29 < V_28 -> V_67 && V_157 ; V_29 ++ ) {
F_69 ( V_116 , V_28 , V_29 , V_149 , V_150 , V_145 ) ;
V_149 += V_28 -> V_40 [ V_29 ] . V_41 >> 2 ;
if ( ++ V_150 == V_116 -> V_166 ) {
V_150 = 0 ;
++ V_145 ;
V_116 -> V_155 = 1 ;
} else if ( V_150 == ( V_116 -> V_166 >> 1 ) ) {
V_116 -> V_155 = 1 ;
}
V_157 -- ;
...
V_116 -> V_153 [ V_165 ] . V_154 [ 0 ] |=
F_65 ( 1ULL << 14 ) ;
if ( ++ V_165 == V_116 -> V_166 )
V_165 = 0 ;
}
}
V_138 += V_29 + 1 - V_28 -> V_70 ;
V_28 -> V_70 = V_29 + 1 ;
V_159 = V_165 = V_150 ;
V_160 = V_145 ;
V_149 = 0 ;
...
V_28 -> V_14 = V_116 -> V_168 ;
V_28 -> V_7 -> V_14 = V_28 -> V_14 ;
V_28 -> V_7 -> V_12 -- ;
F_72 ( & V_28 -> V_7 -> V_16 ) ;
V_28 -> V_7 -> V_13 ++ ;
F_50 ( & V_28 -> V_112 , & V_28 -> V_7 -> V_15 ) ;
F_73 ( & V_28 -> V_7 -> V_16 ) ;
}
if ( ! V_157 || ( V_158 << 2 ) > V_116 -> V_166 )
break;
}
if ( V_116 -> V_162 != V_159 ) {
V_116 -> V_163 = V_160 ;
V_44 -> V_169 ( V_116 , V_159 ) ;
}
if ( V_157 && ! F_52 ( V_156 ) )
goto V_161;
return;
...
struct V_1 * V_7 ,
struct V_111 * V_156 , int V_170 )
{
int V_58 = 0 ;
unsigned long V_75 ;
if ( F_75 ( ! ( V_116 -> V_171 & V_172 ) ) )
return - V_173 ;
F_49 ( & V_116 -> V_143 , V_75 ) ;
if ( F_75 ( ! F_76 ( V_116 ) ) ) {
V_58 = - V_173 ;
...
V_7 -> V_12 += V_170 ;
F_77 ( V_156 , & V_116 -> V_175 ) ;
F_70 ( V_116 , & V_116 -> V_175 ) ;
V_174:
F_51 ( & V_116 -> V_143 , V_75 ) ;
return V_58 ;
}
int F_78 ( struct V_176 * V_177 ,
struct V_1 * V_7 ,
const struct V_85 * V_86 ,
unsigned long V_178 )
{
struct V_43 * V_44 = V_177 -> V_44 ;
struct V_115 * V_116 = V_177 -> V_116 ;
int V_58 = 0 ;
struct V_111 V_112 ;
int V_119 = 0 ;
F_3 ( & V_112 ) ;
...
int V_180 = 8 ;
int V_118 = 0 ;
F_80 ( & V_103 -> V_104 -> V_181 ) ;
V_58 = F_44 ( V_44 , V_116 , V_7 ,
V_86 , V_178 , & V_112 , & V_180 , & V_118 ) ;
F_81 ( & V_103 -> V_104 -> V_181 ) ;
if ( V_58 < 0 )
goto V_179;
else {
V_178 -= V_58 ;
...
V_58 = F_74 ( V_116 , V_7 , & V_112 , V_180 ) ;
if ( V_58 < 0 )
goto V_179;
else {
V_119 += V_180 ;
...
F_41 ( & V_44 -> V_56 -> V_3 , V_7 , & V_112 ) ;
F_60 ( & V_7 -> V_17 ) ;
return ( V_58 < 0 ) ? V_58 : V_119 ;
}
int F_82 ( struct V_115 * V_116 ,
struct V_1 * V_7 )
{
int V_58 = 0 ;
F_59 ( & V_7 -> V_17 ) ;
...
T_5 F_83 ( const struct V_1 * V_7 )
{
return V_7 ? V_7 -> V_11 : 0 ;
}
T_5 F_84 ( struct V_1 * V_7 )
{
