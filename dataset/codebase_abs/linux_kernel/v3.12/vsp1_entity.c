...
unsigned int V_34 ;
for ( V_34 = 0 ; V_34 < F_14 ( V_32 ) ; ++ V_34 ) {
if ( V_32 [ V_34 ] . V_30 == V_3 -> V_30 ) {
V_3 -> V_24 = V_32 [ V_34 ] . V_31 ;
break;
}
}
if ( V_34 == F_14 ( V_32 ) )
...
V_3 -> V_29 = V_29 ;
V_3 -> V_36 = V_15 - 1 ;
V_3 -> V_10 = F_15 ( V_29 -> V_37 ,
V_15 * sizeof( * V_3 -> V_10 ) ,
V_38 ) ;
if ( V_3 -> V_10 == NULL )
return - V_39 ;
V_3 -> V_40 = F_15 ( V_29 -> V_37 , V_15 * sizeof( * V_3 -> V_40 ) ,
V_38 ) ;
if ( V_3 -> V_40 == NULL )
return - V_39 ;
for ( V_34 = 0 ; V_34 < V_15 - 1 ; ++ V_34 )
V_3 -> V_40 [ V_34 ] . V_21 = V_41 ;
V_3 -> V_40 [ V_15 - 1 ] . V_21 = V_23 ;
