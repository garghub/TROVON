...
void F_39 ( struct V_19 * V_22 , unsigned long V_5 , T_1 V_15 )
{
struct V_1 * V_2 ;
int V_41 = V_22 -> V_20 ;
int V_45 , V_31 , V_46 ;
...
void F_42 ( struct V_19 * V_22 ,
void (* F_43)( struct V_19 * V_22 , struct V_1 * V_2 , void * V_28 ) ,
void * V_28 )
{
struct V_1 * V_2 ;
F_24 () ;
...
void F_46 ( struct V_19 * V_22 , T_3 V_26 , void * V_28 )
{
F_24 () ;
V_22 -> V_26 = V_26 ;
if ( ! V_22 -> V_26 )
...
{
return F_47 ( V_11 , V_15 , V_12 , V_13 , 0 ) ;
}
unsigned long F_48 ( unsigned long * V_11 , unsigned long V_15 ,
unsigned long V_12 , unsigned int V_13 , void * V_28 )
{
unsigned long V_45 = V_15 ;
unsigned long V_48 = V_15 + 1 ;
unsigned long V_49 ;
V_49 = F_47 ( V_11 , V_15 , V_12 , V_13 , 0 ) ;
while ( V_49 < V_15 ) {
int V_50 = F_31 ( V_11 , V_15 , V_49 + V_13 ) ;
if ( ( V_50 - V_49 ) < V_48 ) {
V_48 = V_50 - V_49 ;
V_45 = V_49 ;
if ( V_48 == V_13 )
...
static void F_49 ( struct V_51 * V_52 , void * V_53 )
{
F_27 ( * (struct V_19 * * ) V_53 ) ;
}
struct V_19 * F_50 ( struct V_51 * V_52 , int V_20 ,
int V_21 )
{
struct V_19 * * V_54 , * V_22 ;
V_54 = F_51 ( F_49 , sizeof( * V_54 ) , V_23 ) ;
V_22 = F_11 ( V_20 , V_21 ) ;
if ( V_22 ) {
* V_54 = V_22 ;
F_52 ( V_52 , V_54 ) ;
...
struct V_19 * F_54 ( struct V_51 * V_52 )
{
struct V_19 * * V_14 = F_55 ( V_52 , F_49 , NULL ,
NULL ) ;
if ( ! V_14 )
return NULL ;
return * V_14 ;
}
struct V_19 * F_56 ( struct V_55 * V_56 ,
const char * V_57 , int V_49 )
{
struct V_58 * V_59 ;
struct V_55 * V_60 ;
V_60 = F_57 ( V_56 , V_57 , V_49 ) ;
if ( ! V_60 )
return NULL ;
V_59 = F_58 ( V_60 ) ;
if ( ! V_59 )
return NULL ;
return F_54 ( & V_59 -> V_52 ) ;
}
