...
struct V_1 * V_2 ;
struct V_106 * V_107 ;
V_2 = F_55 ( & V_105 -> V_18 , sizeof( * V_2 ) , V_28 ) ;
if ( ! V_2 ) {
...
V_108 . V_12 = V_91 ;
V_108 . V_14 = F_6 ( V_91 ) ;
V_107 = F_57 ( V_105 , V_109 , 0 ) ;
V_2 -> V_4 = F_58 ( & V_105 -> V_18 , V_107 ) ;
if ( F_59 ( V_2 -> V_4 ) )
return F_60 ( V_2 -> V_4 ) ;
V_2 -> V_9 = F_61 ( & V_108 , & V_105 -> V_18 , V_2 ) ;
if ( ! V_2 -> V_9 ) {
F_14 ( & V_105 -> V_18 , L_15 ) ;
return - V_110 ;
}
F_62 ( V_105 , V_2 ) ;
F_63 ( & V_105 -> V_18 , L_16 ) ;
return 0 ;
}
static int F_64 ( struct V_104 * V_105 )
{
struct V_1 * V_2 = F_65 ( V_105 ) ;
F_66 ( V_2 -> V_9 ) ;
return 0 ;
}
