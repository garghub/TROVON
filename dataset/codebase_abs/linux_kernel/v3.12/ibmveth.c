...
static int F_108 ( struct V_90 * V_49 , int V_225 )
{
struct V_1 * V_2 = F_44 ( V_49 ) ;
...
static unsigned long F_110 ( struct V_226 * V_48 )
{
...
V_71 += F_113 ( V_232 * sizeof( struct V_95 ) ) ;
return V_71 ;
}
static int F_114 ( struct V_226 * V_49 , const struct V_236 * V_237 )
{
int V_86 , V_23 , V_238 ;
struct V_90 * V_45 ;
struct V_1 * V_2 ;
...
V_49 -> V_61 ) ;
V_239 = ( unsigned char * ) F_116 ( V_49 , V_241 ,
& V_238 ) ;
if ( ! V_239 ) {
...
V_2 -> V_243 = 0 ;
memcpy ( & V_2 -> V_243 , V_239 , 6 ) ;
V_45 -> V_100 = V_49 -> V_100 ;
V_45 -> V_244 = & V_245 ;
V_45 -> V_246 = & V_247 ;
F_121 ( V_45 , & V_49 -> V_49 ) ;
V_45 -> V_248 = V_249 | V_134 |
V_151 | V_153 ;
V_45 -> V_133 |= V_45 -> V_248 ;
memcpy ( V_45 -> V_96 , & V_2 -> V_243 , V_45 -> V_97 ) ;
for ( V_23 = 0 ; V_23 < V_66 ; V_23 ++ ) {
...
V_19 [ V_23 ] ) ;
error = F_122 ( V_251 , & V_253 ,
& V_49 -> V_49 . V_251 , L_46 , V_23 ) ;
if ( ! error )
F_123 ( V_251 , V_254 ) ;
}
F_20 ( V_45 , L_47 , V_2 ) ;
...
static int F_126 ( struct V_226 * V_49 )
{
struct V_90 * V_45 = F_112 ( & V_49 -> V_49 ) ;
struct V_1 * V_2 = F_44 ( V_45 ) ;
int V_23 ;
for ( V_23 = 0 ; V_23 < V_66 ; V_23 ++ )
F_127 ( & V_2 -> V_67 [ V_23 ] . V_251 ) ;
F_128 ( V_45 ) ;
F_125 ( V_45 ) ;
F_119 ( & V_49 -> V_49 , NULL ) ;
return 0 ;
}
static T_8 F_129 ( struct V_250 * V_251 ,
struct V_255 * V_256 , char * V_182 )
{
struct V_14 * V_15 = F_91 ( V_251 ,
struct V_14 ,
V_251 ) ;
if ( V_256 == & V_257 )
...
static T_8 F_130 ( struct V_250 * V_251 , struct V_255 * V_256 ,
...
F_91 ( V_251 -> V_260 , struct V_74 , V_251 ) ) ;
struct V_1 * V_2 = F_44 ( V_45 ) ;
long V_261 = F_131 ( V_182 , NULL , 10 ) ;
long V_86 ;
if ( V_256 == & V_257 ) {
if ( V_261 && ! V_15 -> V_22 ) {
if ( F_62 ( V_45 ) ) {
