...
V_5 -> V_129 = V_5 -> V_56 + ( V_5 -> V_56 >> 2 ) ;
V_121 = ( ( V_5 -> V_129 + 0xffff ) * ( V_125 >> 3 ) )
>> ( 16 - V_5 -> V_33 ) ;
if ( V_5 -> V_130 && V_5 -> V_130 < V_121 ) {
V_121 = V_5 -> V_130 ;
V_5 -> V_129 = ( V_121 / ( V_125 >> 3 ) )
<< ( 16 - V_5 -> V_33 ) ;
}
if ( V_5 -> V_28 )
V_5 -> V_57 = V_5 -> V_130 ;
...
V_134 = F_56 ( V_135 * V_124 , V_122 * 2 ) ;
...
{
int V_40 ;
V_5 -> V_112 = F_58 ( V_5 -> V_6 -> V_7 , V_113 * 4 ,
V_93 , & V_5 -> V_114 ) ;
if ( ! V_5 -> V_112 )
return - V_143 ;
...
int F_61 ( struct V_22 * V_5 , bool V_151 )
{
int V_11 ;
unsigned int V_40 ;
if ( V_5 -> V_6 -> V_76 )
...
void F_66 ( struct V_154 * V_155 )
{
struct V_22 * V_5 ;
V_5 = F_67 ( V_155 , struct V_22 , V_102 ) ;
F_53 ( V_5 , 1 ) ;
F_68 ( V_5 ) ;
}
...
V_158 >>= - V_5 -> V_149 ;
if ( F_70 ( V_158 >= V_5 -> V_56 - V_5 -> V_56 / 8 && V_158 <= V_5 -> V_129 ) ) {
F_10 ( & V_5 -> V_30 , V_26 ) ;
V_5 -> V_32 = V_158 ;
F_12 ( & V_5 -> V_30 , V_26 ) ;
} else {
