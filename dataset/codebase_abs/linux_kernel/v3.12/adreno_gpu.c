...
{
int V_45 , V_31 ;
for ( V_45 = 0 ; V_45 < F_31 ( V_83 ) ; V_45 ++ ) {
const struct V_84 * V_7 = & V_83 [ V_45 ] ;
...
V_2 -> V_32 = V_32 ;
V_2 -> V_68 = V_68 ;
V_31 = F_32 ( & V_2 -> V_86 , V_2 -> V_7 -> V_87 , V_78 -> V_30 ) ;
if ( V_31 ) {
F_13 ( V_78 -> V_30 , L_13 ,
V_2 -> V_7 -> V_87 , V_31 ) ;
return V_31 ;
...
V_31 = F_33 ( V_78 , V_80 , & V_2 -> V_90 , & V_32 -> V_90 ,
V_2 -> V_7 -> V_11 , L_15 , L_16 ,
V_91 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_34 ( V_78 , V_2 -> V_90 . V_92 ,
V_93 , F_31 ( V_93 ) ) ;
if ( V_31 )
return V_31 ;
V_2 -> V_94 = F_35 ( V_78 , sizeof( * V_2 -> V_28 ) ,
V_95 ) ;
if ( F_36 ( V_2 -> V_94 ) ) {
V_31 = F_37 ( V_2 -> V_94 ) ;
V_2 -> V_94 = NULL ;
...
V_2 -> V_28 = F_38 ( V_2 -> V_94 ) ;
if ( ! V_2 -> V_28 ) {
F_13 ( V_78 -> V_30 , L_18 ) ;
return - V_96 ;
}
V_31 = F_39 ( V_2 -> V_94 , V_2 -> V_90 . V_76 ,
& V_2 -> V_97 ) ;
if ( V_31 ) {
...
void F_40 ( struct V_5 * V_2 )
{
if ( V_2 -> V_94 ) {
if ( V_2 -> V_97 )
F_41 ( V_2 -> V_94 , V_2 -> V_90 . V_76 ) ;
F_42 ( V_2 -> V_94 ) ;
}
if ( V_2 -> V_86 )
F_43 ( V_2 -> V_86 ) ;
