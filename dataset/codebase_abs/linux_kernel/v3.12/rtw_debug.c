...
struct V_58 * V_59 ;
int V_7 = 0 ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_62 , V_53 -> V_113 , V_53 -> V_114 ) ;
F_53 ( & V_53 -> V_115 , & V_109 ) ;
for ( V_57 = 0 ; V_57 < V_116 ; V_57 ++ ) {
V_112 = & ( V_53 -> V_117 [ V_57 ] ) ;
V_111 = F_54 ( V_112 ) ;
while ( ( F_55 ( V_112 , V_111 ) ) == false ) {
V_49 = F_56 ( V_111 , struct V_48 , V_118 ) ;
V_111 = F_54 ( V_111 ) ;
