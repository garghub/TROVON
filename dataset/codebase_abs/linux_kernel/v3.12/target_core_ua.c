...
if ( ( V_23 -> V_32 == V_19 ) && ( V_23 -> V_33 == V_20 ) ) {
F_10 ( & V_4 -> V_35 ) ;
F_11 ( & V_9 -> V_34 ) ;
F_12 ( V_26 , V_22 ) ;
return 0 ;
...
if ( V_23 -> V_32 == 0x29 ) {
if ( ( V_19 == 0x29 ) && ( V_20 > V_23 -> V_33 ) )
F_13 ( & V_22 -> V_30 ,
& V_4 -> V_36 ) ;
else
F_14 ( & V_22 -> V_30 ,
& V_4 -> V_36 ) ;
} else if ( V_23 -> V_32 == 0x2a ) {
...
F_14 ( & V_22 -> V_30 , & V_4 -> V_36 ) ;
F_10 ( & V_4 -> V_35 ) ;
F_11 ( & V_9 -> V_34 ) ;
F_17 ( L_2
L_3 ,
V_9 -> V_37 -> V_38 -> V_39 () , V_18 ,
V_19 , V_20 ) ;
F_15 ( & V_4 -> V_12 ) ;
F_16 () ;
return 0 ;
