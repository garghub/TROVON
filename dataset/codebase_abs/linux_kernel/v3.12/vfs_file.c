...
static int F_33 ( struct V_2 * V_24 , struct V_26 * V_27 )
{
struct V_63 V_64 ;
struct V_8 * V_9 ;
int V_28 = 0 ;
...
static int F_36 ( struct V_2 * V_24 , int V_25 , struct V_26 * V_27 )
{
struct V_1 * V_1 = F_21 ( V_24 ) ;
int V_65 = - V_31 ;
F_2 ( V_11 , L_3 ,
...
static int F_38 ( struct V_2 * V_24 , int V_25 ,
struct V_26 * V_27 )
{
struct V_1 * V_1 = F_21 ( V_24 ) ;
int V_65 = - V_31 ;
...
T_2
F_39 ( struct V_8 * V_9 , char * V_72 , char T_3 * V_73 , T_4 V_74 ,
T_5 V_75 )
{
int V_76 , V_77 , V_78 ;
F_2 ( V_11 , L_4 ,
...
do {
V_76 = F_40 ( V_9 , V_72 , V_73 , V_75 , V_74 ) ;
if ( V_76 <= 0 )
break;
if ( V_72 )
V_72 += V_76 ;
...
T_2
F_41 ( struct V_2 * V_24 , char * V_72 , char T_3 * V_73 , T_4 V_74 ,
T_5 V_75 )
{
return F_39 ( V_24 -> V_13 , V_72 , V_73 , V_74 , V_75 ) ;
}
static T_2
F_42 ( struct V_2 * V_24 , char T_3 * V_73 , T_6 V_74 ,
T_7 * V_75 )
{
int V_65 ;
struct V_8 * V_9 ;
...
V_78 = V_9 -> V_79 ? V_9 -> V_79 : V_9 -> V_53 -> V_80 - V_81 ;
if ( V_74 > V_78 )
V_65 = F_41 ( V_24 , NULL , V_73 , V_74 , * V_75 ) ;
else
V_65 = F_40 ( V_9 , NULL , V_73 , * V_75 , V_74 ) ;
if ( V_65 > 0 )
* V_75 += V_65 ;
return V_65 ;
}
...
V_53 = V_9 -> V_53 ;
do {
V_76 = F_44 ( V_9 , NULL , V_72 + V_77 , V_85 + V_77 , V_74 ) ;
if ( V_76 <= 0 )
break;
V_74 -= V_76 ;
V_77 += V_76 ;
...
static T_2
F_49 ( struct V_2 * V_24 , const char T_3 * V_72 ,
T_6 V_74 , T_7 * V_75 )
{
T_2 V_90 = 0 ;
T_7 V_85 = * V_75 ;
V_90 = F_50 ( V_24 , & V_85 , & V_74 , 0 ) ;
if ( V_90 )
goto V_39;
V_90 = - V_68 ;
if ( ( T_2 ) V_74 < 0 )
...
static int F_51 ( struct V_2 * V_24 , T_7 V_45 , T_7 V_91 ,
int V_92 )
{
struct V_8 * V_9 ;
...
int F_55 ( struct V_2 * V_24 , T_7 V_45 , T_7 V_91 ,
int V_92 )
{
struct V_8 * V_9 ;
struct V_1 * V_1 = V_24 -> V_93 -> V_94 ;
...
static int
F_57 ( struct V_2 * V_2 , struct V_98 * V_99 )
{
int V_90 ;
V_90 = F_58 ( V_2 , V_99 ) ;
if ( ! V_90 )
...
static int
F_59 ( struct V_98 * V_99 , struct V_102 * V_103 )
{
struct V_4 * V_5 ;
...
static T_2
F_65 ( struct V_2 * V_24 , char T_3 * V_73 , T_6 V_74 ,
T_7 * V_110 )
{
T_7 V_78 , V_75 ;
struct V_1 * V_1 ;
...
F_52 ( V_106 , V_75 ,
V_75 + V_74 - 1 ) ;
return F_42 ( V_24 , V_73 , V_74 , V_110 ) ;
}
static T_2
F_66 ( struct V_2 * V_24 , char T_3 * V_72 , T_6 V_74 ,
T_7 * V_75 )
{
if ( V_24 -> V_12 & V_112 )
return F_65 ( V_24 , V_72 , V_74 , V_75 ) ;
return F_67 ( V_24 , V_72 , V_74 , V_75 ) ;
}
static T_2
F_68 ( struct V_2 * V_24 , const char T_3 * V_72 ,
T_6 V_74 , T_7 * V_110 )
{
T_7 V_75 ;
T_2 V_90 ;
...
V_90 = F_49 ( V_24 , V_72 , V_74 , V_110 ) ;
V_113:
F_17 ( & V_1 -> V_97 ) ;
return V_90 ;
V_115:
F_17 ( & V_1 -> V_97 ) ;
return F_69 ( V_24 , V_72 , V_74 , V_110 ) ;
}
static T_2
F_70 ( struct V_2 * V_24 , const char T_3 * V_72 ,
T_6 V_74 , T_7 * V_75 )
{
if ( V_24 -> V_12 & V_112 )
