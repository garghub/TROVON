...
F_45 ( V_73 , L_11 , V_76 , V_19 ) ;
F_6 ( & V_10 . V_11 ) ;
return 0 ;
}
static int F_47 ( struct V_72 * V_73 , void * V_82 )
{
void (* F_48)( struct V_72 * ) = V_73 -> V_83 ;
F_48 ( V_73 ) ;
return 0 ;
}
static int F_49 ( struct V_1 * V_1 , struct V_2 * V_2 )
{
return F_50 ( V_2 , F_47 , V_1 -> V_84 ) ;
}
...
int F_54 ( const char * V_87 ,
int (* F_58)( struct V_72 * ) )
{
struct V_88 * V_89 ;
V_89 = F_59 ( V_87 , V_90 , V_86 ,
F_58 , & V_91 ) ;
return F_60 ( V_89 ) ;
}
