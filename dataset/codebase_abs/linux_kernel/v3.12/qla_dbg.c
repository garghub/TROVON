...
V_130 = V_30 * 4 ;
V_133 -> V_135 [ V_130 ] =
F_2 ( F_12 ( & V_37 -> V_136 . V_137 ) ) ;
V_133 -> V_135 [ V_130 + 1 ] =
F_2 ( F_12 ( & V_37 -> V_136 . V_138 ) ) ;
V_133 -> V_135 [ V_130 + 2 ] =
F_2 ( F_12 ( & V_37 -> V_136 . V_139 ) ) ;
V_133 -> V_135 [ V_130 + 3 ] =
F_2 ( F_12 ( & V_37 -> V_136 . V_140 ) ) ;
}
return V_14 + sizeof( struct V_132 ) ;
}
void
F_41 ( T_7 * V_141 , int V_29 )
{
struct V_1 * V_2 = V_141 -> V_142 ;
if ( V_29 != V_44 ) {
F_42 ( V_143 , V_141 , 0xd000 ,
L_1 , V_29 ) ;
V_2 -> V_144 = 0 ;
} else {
F_42 ( V_145 , V_141 , 0xd001 ,
L_2 ,
V_141 -> V_146 , V_2 -> V_4 ) ;
V_2 -> V_144 = 1 ;
F_43 ( V_141 , V_147 ) ;
...
struct F_44 * V_150 ;
void * V_28 ;
struct V_151 * V_152 = F_45 ( V_2 -> V_10 ) ;
V_149 = 0 ;
if ( ! V_148 )
F_46 ( & V_2 -> V_153 , V_149 ) ;
if ( ! V_2 -> V_4 ) {
F_42 ( V_143 , V_141 , 0xd002 ,
L_3 ) ;
goto V_154;
}
if ( V_2 -> V_144 ) {
F_42 ( V_143 , V_141 , 0xd003 ,
L_4
L_5 ,
V_2 -> V_4 ) ;
goto V_154;
}
V_150 = & V_2 -> V_4 -> V_86 . V_155 ;
F_1 ( V_2 , V_2 -> V_4 ) ;
V_29 = V_44 ;
V_150 -> V_57 = F_29 ( F_14 ( & V_37 -> V_57 ) ) ;
F_5 ( & V_37 -> V_57 , V_156 ) ;
if ( F_47 ( V_2 ) ) {
for ( V_30 = 30000 ;
( F_14 ( & V_37 -> V_57 ) & V_157 ) == 0 &&
V_29 == V_44 ; V_30 -- ) {
if ( V_30 )
F_15 ( 100 ) ;
else
...
if ( V_29 == V_44 ) {
V_69 = & V_37 -> V_158 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_159 ) / 2 ; V_30 ++ )
V_150 -> V_159 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
V_69 = & V_37 -> V_88 . V_89 . V_137 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_160 ) / 2 ; V_30 ++ )
V_150 -> V_160 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
V_69 = & V_37 -> V_88 . V_89 . V_45 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_161 ) / 2 ; V_30 ++ )
V_150 -> V_161 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
F_5 ( & V_37 -> V_76 , 0x40 ) ;
F_28 ( V_37 , 32 , V_150 -> V_162 ) ;
F_5 ( & V_37 -> V_76 , 0x50 ) ;
F_28 ( V_37 , 48 , V_150 -> V_163 ) ;
F_5 ( & V_37 -> V_76 , 0x00 ) ;
V_69 = & V_37 -> V_164 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_165 ) / 2 ; V_30 ++ )
V_150 -> V_165 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
F_5 ( & V_37 -> V_166 , 0x2000 ) ;
F_28 ( V_37 , 16 , V_150 -> V_167 ) ;
F_5 ( & V_37 -> V_166 , 0x2200 ) ;
F_28 ( V_37 , 16 , V_150 -> V_168 ) ;
F_5 ( & V_37 -> V_166 , 0x2400 ) ;
F_28 ( V_37 , 16 , V_150 -> V_169 ) ;
F_5 ( & V_37 -> V_166 , 0x2600 ) ;
F_28 ( V_37 , 16 , V_150 -> V_170 ) ;
F_5 ( & V_37 -> V_166 , 0x2800 ) ;
F_28 ( V_37 , 16 , V_150 -> V_171 ) ;
F_5 ( & V_37 -> V_166 , 0x2A00 ) ;
F_28 ( V_37 , 16 , V_150 -> V_172 ) ;
F_5 ( & V_37 -> V_166 , 0x2C00 ) ;
F_28 ( V_37 , 16 , V_150 -> V_173 ) ;
F_5 ( & V_37 -> V_166 , 0x2E00 ) ;
F_28 ( V_37 , 16 , V_150 -> V_174 ) ;
F_5 ( & V_37 -> V_76 , 0x10 ) ;
F_28 ( V_37 , 64 , V_150 -> V_175 ) ;
F_5 ( & V_37 -> V_76 , 0x20 ) ;
F_28 ( V_37 , 64 , V_150 -> V_176 ) ;
F_5 ( & V_37 -> V_76 , 0x30 ) ;
F_28 ( V_37 , 64 , V_150 -> V_177 ) ;
F_5 ( & V_37 -> V_76 , V_178 ) ;
for ( V_30 = 0 ; V_30 < 30000 ; V_30 ++ ) {
if ( ( F_14 ( & V_37 -> V_76 ) &
V_178 ) == 0 )
...
if ( V_29 == V_44 )
V_29 = F_24 ( V_2 , 0x800 , V_150 -> V_179 ,
sizeof( V_150 -> V_179 ) / 2 , & V_28 ) ;
if ( V_29 == V_44 )
V_29 = F_24 ( V_2 , 0x10000 , V_150 -> V_180 ,
sizeof( V_150 -> V_180 ) / 2 , & V_28 ) ;
if ( V_29 == V_44 )
V_29 = F_24 ( V_2 , 0x11000 , V_150 -> V_181 ,
...
V_154:
if ( ! V_148 )
F_48 ( & V_2 -> V_153 , V_149 ) ;
}
void
F_49 ( T_7 * V_141 , int V_148 )
{
int V_29 ;
T_1 V_30 , V_32 ;
T_2 V_182 ;
...
F_46 ( & V_2 -> V_153 , V_149 ) ;
if ( ! V_2 -> V_4 ) {
F_42 ( V_143 , V_141 , 0xd004 ,
L_3 ) ;
goto V_184;
}
if ( V_2 -> V_144 ) {
F_42 ( V_143 , V_141 , 0xd005 ,
L_4
L_5 ,
V_2 -> V_4 ) ;
goto V_184;
}
V_150 = & V_2 -> V_4 -> V_86 . V_185 ;
F_1 ( V_2 , V_2 -> V_4 ) ;
V_29 = V_44 ;
V_150 -> V_57 = F_29 ( F_14 ( & V_37 -> V_57 ) ) ;
F_5 ( & V_37 -> V_57 , V_156 ) ;
for ( V_30 = 30000 ; ( F_14 ( & V_37 -> V_57 ) & V_157 ) == 0 &&
V_29 == V_44 ; V_30 -- ) {
if ( V_30 )
F_15 ( 100 ) ;
else
...
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_159 ) / 2 ; V_30 ++ )
V_150 -> V_159 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
V_69 = & V_37 -> V_88 . V_186 . V_45 ;
for ( V_30 = 0 ; V_30 < V_2 -> V_187 ; V_30 ++ ) {
if ( V_30 == 8 )
V_69 = & V_37 -> V_188 . V_189 . V_50 ;
V_150 -> V_161 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
}
V_69 = & V_37 -> V_88 . V_186 . V_190 [ 0 ] ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_163 ) / 2 ; V_30 ++ )
V_150 -> V_163 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
F_5 ( & V_37 -> V_76 , 0x00 ) ;
V_69 = & V_37 -> V_164 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_165 ) / 2 ; V_30 ++ )
V_150 -> V_165 [ V_30 ] = F_29 ( F_14 ( V_69 ++ ) ) ;
F_5 ( & V_37 -> V_166 , 0x2000 ) ;
F_28 ( V_37 , 16 , V_150 -> V_167 ) ;
F_5 ( & V_37 -> V_166 , 0x2100 ) ;
F_28 ( V_37 , 16 , V_150 -> V_168 ) ;
F_5 ( & V_37 -> V_166 , 0x2200 ) ;
F_28 ( V_37 , 16 , V_150 -> V_169 ) ;
F_5 ( & V_37 -> V_166 , 0x2300 ) ;
F_28 ( V_37 , 16 , V_150 -> V_170 ) ;
F_5 ( & V_37 -> V_166 , 0x2400 ) ;
F_28 ( V_37 , 16 , V_150 -> V_171 ) ;
F_5 ( & V_37 -> V_166 , 0x2500 ) ;
F_28 ( V_37 , 16 , V_150 -> V_172 ) ;
F_5 ( & V_37 -> V_166 , 0x2600 ) ;
F_28 ( V_37 , 16 , V_150 -> V_173 ) ;
F_5 ( & V_37 -> V_166 , 0x2700 ) ;
F_28 ( V_37 , 16 , V_150 -> V_174 ) ;
F_5 ( & V_37 -> V_76 , 0x10 ) ;
F_28 ( V_37 , 16 , V_150 -> V_175 ) ;
F_5 ( & V_37 -> V_76 , 0x20 ) ;
F_28 ( V_37 , 64 , V_150 -> V_176 ) ;
F_5 ( & V_37 -> V_76 , 0x30 ) ;
F_28 ( V_37 , 64 , V_150 -> V_177 ) ;
...
if ( V_29 == V_44 && ( F_50 ( V_2 ) || ( F_51 ( V_2 ) &&
( F_14 ( & V_37 -> V_191 ) & ( V_192 | V_193 ) ) != 0 ) ) ) {
F_5 ( & V_37 -> V_57 , V_156 ) ;
for ( V_30 = 30000 ;
( F_14 ( & V_37 -> V_57 ) & V_157 ) == 0 &&
V_29 == V_44 ; V_30 -- ) {
...
if ( V_29 == V_44 ) {
V_182 = 0x1000 ;
F_25 ( V_2 , V_37 , 0 , V_195 ) ;
F_6 ( V_47 , & V_2 -> V_48 ) ;
}
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_179 ) / 2 && V_29 == V_44 ;
V_30 ++ , V_182 ++ ) {
F_25 ( V_2 , V_37 , 1 , V_182 ) ;
F_5 ( & V_37 -> V_57 , V_87 ) ;
for ( V_32 = 6000000 ; V_32 != 0 ; V_32 -- ) {
if ( F_14 ( & V_37 -> V_196 ) & V_197 ) {
if ( F_14 ( & V_37 -> V_91 ) & V_193 ) {
F_13 ( V_47 ,
& V_2 -> V_48 ) ;
V_35 = F_26 ( V_2 , V_37 , 0 ) ;
V_183 = F_26 ( V_2 , V_37 , 2 ) ;
F_5 ( & V_37 -> V_91 , 0 ) ;
F_5 ( & V_37 -> V_57 ,
V_92 ) ;
F_14 ( & V_37 -> V_57 ) ;
...
if ( F_16 ( V_47 , & V_2 -> V_48 ) ) {
V_29 = V_35 & V_62 ;
V_150 -> V_179 [ V_30 ] = F_29 ( V_183 ) ;
} else {
V_29 = V_63 ;
}
}
if ( V_29 == V_44 )
F_3 ( V_2 , & V_150 -> V_179 [ V_30 ] ) ;
F_41 ( V_152 , V_29 ) ;
V_184:
if ( ! V_148 )
F_48 ( & V_2 -> V_153 , V_149 ) ;
...
F_46 ( & V_2 -> V_153 , V_149 ) ;
if ( ! V_2 -> V_4 ) {
F_42 ( V_143 , V_141 , 0xd006 ,
L_3 ) ;
goto V_201;
}
if ( V_2 -> V_144 ) {
F_42 ( V_143 , V_141 , 0xd007 ,
L_4
L_5 ,
V_2 -> V_4 ) ;
goto V_201;
}
V_150 = & V_2 -> V_4 -> V_86 . V_39 ;
F_1 ( V_2 , V_2 -> V_4 ) ;
V_150 -> V_59 = F_2 ( F_12 ( & V_37 -> V_59 ) ) ;
V_29 = F_20 ( V_37 ) ;
if ( V_29 != V_44 )
goto V_202;
V_69 = & V_37 -> V_203 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_204 ) / 4 ; V_30 ++ )
V_150 -> V_204 [ V_30 ] = F_2 ( F_12 ( V_69 ++ ) ) ;
F_11 ( & V_37 -> V_205 , 0 ) ;
F_12 ( & V_37 -> V_205 ) ;
F_11 ( & V_37 -> V_70 , 0x0F70 ) ;
F_12 ( & V_37 -> V_70 ) ;
F_11 ( & V_37 -> V_206 , 0xB0000000 ) ;
V_150 -> V_207 [ 0 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0100000 ) ;
V_150 -> V_207 [ 1 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0200000 ) ;
V_150 -> V_207 [ 2 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0300000 ) ;
V_150 -> V_207 [ 3 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0400000 ) ;
V_150 -> V_207 [ 4 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0500000 ) ;
V_150 -> V_207 [ 5 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0600000 ) ;
V_150 -> V_207 [ 6 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
V_198 = & V_37 -> V_45 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_161 ) / 2 ; V_30 ++ )
V_150 -> V_161 [ V_30 ] = F_29 ( F_14 ( V_198 ++ ) ) ;
V_97 = V_150 -> V_209 ;
...
F_19 ( V_37 , 0xBFE0 , 16 , V_150 -> V_210 ) ;
F_19 ( V_37 , 0xBFF0 , 16 , V_150 -> V_211 ) ;
V_97 = V_150 -> V_212 ;
...
F_19 ( V_37 , 0xFFD0 , 16 , V_150 -> V_213 ) ;
F_19 ( V_37 , 0xFFE0 , 16 , V_150 -> V_214 ) ;
F_19 ( V_37 , 0xFFF0 , 16 , V_150 -> V_215 ) ;
F_19 ( V_37 , 0x7100 , 16 , V_150 -> V_216 ) ;
V_97 = V_150 -> V_217 ;
...
F_19 ( V_37 , 0x76A0 , 16 , V_150 -> V_226 ) ;
V_97 = V_150 -> V_227 ;
...
if ( V_29 != V_44 )
goto V_202;
V_29 = F_18 ( V_2 , V_150 -> V_64 , sizeof( V_150 -> V_64 ) ,
& V_28 ) ;
if ( V_29 != V_44 )
goto V_202;
V_28 = F_3 ( V_2 , V_28 ) ;
F_30 ( V_2 , V_28 ) ;
V_200 = ( void * ) V_2 -> V_4 + V_2 -> V_233 ;
V_200 = F_36 ( V_2 , V_200 , & V_96 ) ;
if ( V_96 ) {
V_2 -> V_4 -> V_234 |= F_33 ( V_235 ) ;
* V_96 |= F_33 ( V_236 ) ;
}
V_2 -> V_237 = ( V_200 - ( void * ) V_2 -> V_4 ) ;
V_202:
F_41 ( V_152 , V_29 ) ;
V_201:
if ( ! V_148 )
...
F_46 ( & V_2 -> V_153 , V_149 ) ;
if ( ! V_2 -> V_4 ) {
F_42 ( V_143 , V_141 , 0xd008 ,
L_3 ) ;
goto V_238;
}
if ( V_2 -> V_144 ) {
F_42 ( V_143 , V_141 , 0xd009 ,
L_4
L_5 ,
V_2 -> V_4 ) ;
goto V_238;
}
V_150 = & V_2 -> V_4 -> V_86 . V_239 ;
F_1 ( V_2 , V_2 -> V_4 ) ;
V_2 -> V_4 -> V_234 = F_33 ( 2 ) ;
V_150 -> V_59 = F_2 ( F_12 ( & V_37 -> V_59 ) ) ;
V_29 = F_20 ( V_37 ) ;
if ( V_29 != V_44 )
goto V_240;
...
F_11 ( & V_37 -> V_71 , 0x01 ) ;
V_69 = & V_37 -> V_242 ;
V_150 -> V_243 [ 0 ] = F_2 ( F_12 ( V_69 ++ ) ) ;
V_150 -> V_243 [ 1 ] = F_2 ( F_12 ( V_69 ++ ) ) ;
V_150 -> V_243 [ 2 ] = F_2 ( F_12 ( V_69 ) ) ;
V_150 -> V_243 [ 3 ] = F_2 ( F_12 ( & V_37 -> V_71 ) ) ;
F_11 ( & V_37 -> V_71 , 0x00 ) ;
F_12 ( & V_37 -> V_71 ) ;
V_69 = & V_37 -> V_203 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_204 ) / 4 ; V_30 ++ )
...
F_11 ( & V_37 -> V_206 , 0xB0600000 ) ;
V_150 -> V_207 [ 6 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0700000 ) ;
V_150 -> V_207 [ 7 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0800000 ) ;
V_150 -> V_207 [ 8 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0900000 ) ;
V_150 -> V_207 [ 9 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_206 , 0xB0A00000 ) ;
V_150 -> V_207 [ 10 ] = F_2 ( F_12 ( & V_37 -> V_208 ) ) ;
F_11 ( & V_37 -> V_70 , 0x0010 ) ;
V_150 -> V_244 = F_2 ( F_12 ( & V_37 -> V_71 ) ) ;
V_198 = & V_37 -> V_45 ;
for ( V_30 = 0 ; V_30 < sizeof( V_150 -> V_161 ) / 2 ; V_30 ++ )
V_150 -> V_161 [ V_30 ] = F_29 ( F_14 ( V_198 ++ ) ) ;
V_97 = V_150 -> V_209 ;
...
F_19 ( V_37 , 0xB0E0 , 16 , V_150 -> V_247 ) ;
F_19 ( V_37 , 0xB0F0 , 16 , V_150 -> V_248 ) ;
F_19 ( V_37 , 0x7100 , 16 , V_150 -> V_216 ) ;
V_97 = V_150 -> V_217 ;
V_97 = F_19 ( V_37 , 0x7200 , 8 , V_97 ) ;
V_69 = & V_37 -> V_218 ;
...
V_200 = F_38 ( V_2 , ( void * ) V_2 -> V_4 + V_2 -> V_233 ,
& V_96 ) ;
V_29 = F_21 ( V_2 ) ;
if ( V_29 != V_44 )
goto V_240;
...
V_28 = F_3 ( V_2 , V_28 ) ;
F_30 ( V_2 , V_28 ) ;
V_200 = F_32 ( V_2 , V_200 , & V_96 ) ;
V_200 = F_37 ( V_2 , V_200 , & V_96 ) ;
V_200 = F_36 ( V_2 , V_200 , & V_96 ) ;
if ( V_96 ) {
V_2 -> V_4 -> V_234 |= F_33 ( V_235 ) ;
* V_96 |= F_33 ( V_236 ) ;
...
F_46 ( & V_2 -> V_153 , V_149 ) ;
if ( ! V_2 -> V_4 ) {
F_42 ( V_143 , V_141 , 0xd00a ,
L_3 ) ;
goto V_249;
}
if ( V_2 -> V_144 ) {
F_42 ( V_143 , V_141 , 0xd00b ,
L_4
L_5 ,
V_2 -> V_4 ) ;
goto V_249;
}
V_150 = & V_2 -> V_4 -> V_86 . V_250 ;
F_1 ( V_2 , V_2 -> V_4 ) ;
V_150 -> V_59 = F_2 ( F_12 ( & V_37 -> V_59 ) ) ;
V_29 = F_20 ( V_37 ) ;
if ( V_29 != V_44 )
...
F_46 ( & V_2 -> V_153 , V_149 ) ;
if ( ! V_2 -> V_4 ) {
F_42 ( V_143 , V_141 , 0xd00c ,
L_6 ) ;
goto V_253;
}
if ( V_2 -> V_144 ) {
F_42 ( V_143 , V_141 , 0xd00d ,
L_7
L_8 , V_2 -> V_4 ) ;
goto V_253;
}
V_150 = & V_2 -> V_4 -> V_86 . V_254 ;
F_1 ( V_2 , V_2 -> V_4 ) ;
V_150 -> V_59 = F_2 ( F_12 ( & V_37 -> V_59 ) ) ;
V_29 = F_20 ( V_37 ) ;
if ( V_29 != V_44 )
...
F_19 ( V_37 , 0xBFE0 , 16 , V_97 ) ;
F_19 ( V_37 , 0xBFF0 , 16 , V_150 -> V_211 ) ;
F_19 ( V_37 , 0xBEF0 , 16 , V_150 -> V_257 ) ;
V_97 = V_150 -> V_212 ;
...
F_19 ( V_37 , 0xFFE0 , 16 , V_150 -> V_214 ) ;
F_19 ( V_37 , 0xFFF0 , 16 , V_150 -> V_215 ) ;
F_19 ( V_37 , 0xFEF0 , 16 , V_150 -> V_258 ) ;
V_97 = V_150 -> V_245 ;
V_97 = F_19 ( V_37 , 0xB000 , 16 , V_97 ) ;
V_97 = F_19 ( V_37 , 0xB010 , 16 , V_97 ) ;
V_97 = F_19 ( V_37 , 0xB020 , 16 , V_97 ) ;
...
F_19 ( V_37 , 0xB0E0 , 16 , V_150 -> V_247 ) ;
F_19 ( V_37 , 0xB0F0 , 16 , V_150 -> V_248 ) ;
F_19 ( V_37 , 0xB1F0 , 16 , V_150 -> V_259 ) ;
V_97 = V_150 -> V_216 ;
...
F_19 ( V_37 , 0x7800 , 16 , V_150 -> V_265 ) ;
V_97 = V_150 -> V_232 ;
V_97 = F_19 ( V_37 , 0x6000 , 16 , V_97 ) ;
V_97 = F_19 ( V_37 , 0x6010 , 16 , V_97 ) ;
V_97 = F_19 ( V_37 , 0x6020 , 16 , V_97 ) ;
...
V_29 = F_21 ( V_2 ) ;
if ( V_29 != V_44 ) {
F_42 ( V_143 , V_141 , 0xd00e ,
L_9 ) ;
V_29 = V_44 ;
F_42 ( V_143 , V_141 , 0xd00f , L_10 ) ;
F_11 ( & V_37 -> V_57 , V_266 ) ;
F_12 ( & V_37 -> V_57 ) ;
F_11 ( & V_37 -> V_57 , V_267 ) ;
F_12 ( & V_37 -> V_57 ) ;
F_11 ( & V_37 -> V_57 , V_82 ) ;
F_12 ( & V_37 -> V_57 ) ;
...
if ( ! V_30 ) {
V_28 = V_150 -> V_64 ;
V_28 += sizeof( V_150 -> V_64 ) ;
V_28 += ( V_2 -> V_66 - 0x100000 + 1 ) ;
goto V_268;
} else
F_42 ( V_143 , V_141 , 0xd010 ,
L_11 ) ;
}
V_29 = F_18 ( V_2 , V_150 -> V_64 , sizeof( V_150 -> V_64 ) ,
& V_28 ) ;
...
if ( V_270 == 1 )
V_270 = V_271 ;
return ( V_269 & V_270 ) == V_269 ;
}
void
F_58 ( T_1 V_269 , T_7 * V_141 , T_8 V_272 , const char * V_273 , ... )
{
T_9 V_274 ;
struct V_275 V_276 ;
if ( ! F_57 ( V_269 ) )
return;
va_start ( V_274 , V_273 ) ;
V_276 . V_273 = V_273 ;
V_276 . V_274 = & V_274 ;
if ( V_141 != NULL ) {
const struct V_277 * V_10 = V_141 -> V_142 -> V_10 ;
F_59 ( L_12 ,
V_278 , F_60 ( & ( V_10 -> V_279 ) ) , V_272 + V_280 ,
V_141 -> V_146 , & V_276 ) ;
} else {
F_59 ( L_13 ,
V_278 , L_14 , V_272 + V_280 , & V_276 ) ;
}
va_end ( V_274 ) ;
}
void
F_61 ( T_1 V_269 , struct V_277 * V_10 , T_8 V_272 ,
const char * V_273 , ... )
{
T_9 V_274 ;
struct V_275 V_276 ;
...
V_276 . V_274 = & V_274 ;
F_59 ( L_13 ,
V_278 , F_60 ( & ( V_10 -> V_279 ) ) , V_272 + V_280 , & V_276 ) ;
va_end ( V_274 ) ;
}
void
F_42 ( T_1 V_269 , T_7 * V_141 , T_8 V_272 , const char * V_273 , ... )
{
T_9 V_274 ;
struct V_275 V_276 ;
char V_281 [ 128 ] ;
...
if ( V_141 != NULL ) {
const struct V_277 * V_10 = V_141 -> V_142 -> V_10 ;
snprintf ( V_281 , sizeof( V_281 ) , L_15 ,
V_278 , F_60 ( & ( V_10 -> V_279 ) ) , V_272 , V_141 -> V_146 ) ;
} else {
snprintf ( V_281 , sizeof( V_281 ) , L_16 ,
V_278 , L_14 , V_272 ) ;
}
V_281 [ sizeof( V_281 ) - 1 ] = 0 ;
va_start ( V_274 , V_273 ) ;
V_276 . V_273 = V_273 ;
V_276 . V_274 = & V_274 ;
switch ( V_269 ) {
case V_283 :
F_62 ( L_17 , V_281 , & V_276 ) ;
break;
case V_143 :
F_63 ( L_17 , V_281 , & V_276 ) ;
break;
case V_145 :
F_59 ( L_17 , V_281 , & V_276 ) ;
break;
default:
F_64 ( L_17 , V_281 , & V_276 ) ;
break;
}
va_end ( V_274 ) ;
}
void
F_65 ( T_1 V_269 , struct V_277 * V_10 , T_8 V_272 ,
const char * V_273 , ... )
{
T_9 V_274 ;
struct V_275 V_276 ;
...
void
F_66 ( T_1 V_269 , T_7 * V_141 , T_8 V_272 )
{
int V_284 ;
struct V_1 * V_2 = V_141 -> V_142 ;
struct V_85 T_3 * V_37 = & V_2 -> V_38 -> V_86 ;
struct V_36 T_3 * V_285 = & V_2 -> V_38 -> V_39 ;
struct V_286 T_3 * V_287 = & V_2 -> V_38 -> V_288 ;
T_2 T_3 * V_198 ;
if ( ! F_57 ( V_269 ) )
return;
if ( F_53 ( V_2 ) )
...
V_198 = F_68 ( V_2 , V_37 , 0 ) ;
F_58 ( V_269 , V_141 , V_272 , L_18 ) ;
for ( V_284 = 0 ; V_284 < 6 ; V_284 ++ )
F_58 ( V_269 , V_141 , V_272 ,
L_19 , V_284 , F_14 ( V_198 ++ ) ) ;
}
void
F_69 ( T_1 V_269 , T_7 * V_141 , T_8 V_272 ,
T_5 * V_290 , T_1 V_104 )
{
T_1 V_30 ;
T_5 V_291 ;
if ( ! F_57 ( V_269 ) )
return;
F_58 ( V_269 , V_141 , V_272 , L_20
L_21 ) ;
F_58 ( V_269 , V_141 , V_272 , L_22
L_23 ) ;
F_58 ( V_269 , V_141 , V_272 , L_24 ) ;
