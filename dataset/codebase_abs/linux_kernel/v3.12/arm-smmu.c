...
static void F_78 ( struct V_62 * V_63 , struct V_17 * V_18 )
{
struct V_64 * V_65 = V_63 -> V_66 ;
struct V_1 * V_9 ;
V_9 = F_1 ( V_65 -> V_190 , V_18 -> V_10 ) ;
...
static void F_79 ( struct V_2 * V_3 , void * V_199 ,
T_10 V_200 )
{
unsigned long V_201 = ( unsigned long ) V_199 & ~ V_202 ;
if ( ! ( V_3 -> V_153 & V_203 ) )
F_80 ( V_3 -> V_18 , F_81 ( V_199 ) , V_201 , V_200 ,
V_204 ) ;
}
static bool F_82 ( unsigned long V_199 ,
unsigned long V_37 )
{
return ! ( V_199 & ~ V_205 ) &&
( V_199 + V_206 <= V_37 ) ;
}
static int F_83 ( struct V_2 * V_3 , T_5 * V_169 ,
...
if ( F_59 ( * V_169 ) ) {
T_6 V_170 = F_84 ( V_213 ) ;
if ( ! V_170 )
return - V_29 ;
F_79 ( V_3 , F_85 ( V_170 ) ,
V_214 ) ;
F_86 ( V_170 ) ;
F_87 ( NULL , V_169 , V_170 ) ;
F_79 ( V_3 , V_169 , sizeof( * V_169 ) ) ;
}
if ( V_208 == 1 ) {
V_210 |= V_215 | V_216 ;
...
int V_230 ;
T_11 * V_231 ;
unsigned long V_38 = F_89 ( V_199 ) ;
V_38 &= ~ ( V_229 - 1 ) ;
V_231 = F_88 ( * V_169 ) + V_38 ;
for ( V_230 = 0 ; V_230 < V_229 ; ++ V_230 )
F_90 ( * ( V_231 + V_230 ) ) &= ~ V_228 ;
F_79 ( V_3 , V_231 ,
sizeof( * V_209 ) *
V_229 ) ;
}
do {
* V_209 = F_91 ( V_207 , F_92 ( V_210 ) ) ;
} while ( V_209 ++ , V_207 ++ , V_199 += V_118 , -- V_21 );
} while ( V_199 != V_37 );
F_79 ( V_3 , V_36 , sizeof( * V_209 ) * ( V_209 - V_36 ) ) ;
return 0 ;
}
static int F_93 ( struct V_2 * V_3 , T_7 * V_171 ,
unsigned long V_199 , unsigned long V_37 ,
V_115 V_232 , int V_55 , int V_208 )
{
int V_56 ;
T_5 * V_169 ;
unsigned long V_233 , V_207 = F_94 ( V_232 ) ;
#ifndef F_95
if ( F_63 ( * V_171 ) ) {
V_169 = F_96 ( NULL , V_199 ) ;
if ( ! V_169 )
return - V_29 ;
} else
#endif
...
do {
V_233 = F_97 ( V_199 , V_37 ) ;
V_56 = F_83 ( V_3 , V_169 , V_199 , V_37 , V_207 ,
V_55 , V_208 ) ;
F_98 ( NULL , V_171 , V_169 ) ;
F_79 ( V_3 , V_171 , sizeof( * V_171 ) ) ;
V_232 += V_233 - V_199 ;
} while ( V_169 ++ , V_199 = V_233 , V_199 < V_37 );
return V_56 ;
}
static int F_99 ( struct V_2 * V_3 , T_4 * V_113 ,
unsigned long V_199 , unsigned long V_37 ,
V_115 V_232 , int V_55 , int V_208 )
{
int V_56 = 0 ;
...
do {
V_233 = F_102 ( V_199 , V_37 ) ;
V_56 = F_93 ( V_3 , V_171 , V_199 , V_233 , V_232 ,
V_55 , V_208 ) ;
F_103 ( NULL , V_171 , V_113 ) ;
F_79 ( V_3 , V_113 , sizeof( * V_113 ) ) ;
V_232 += V_233 - V_199 ;
...
V_37 = V_61 + V_200 ;
do {
unsigned long V_233 = F_106 ( V_61 , V_37 ) ;
V_56 = F_99 ( V_3 , V_113 , V_61 , V_233 , V_234 ,
V_55 , V_208 ) ;
if ( V_56 )
goto V_34;
V_234 += V_233 - V_61 ;
...
static int F_108 ( struct V_62 * V_63 , unsigned long V_61 ,
V_115 V_234 , T_10 V_200 , int V_55 )
{
struct V_64 * V_65 = V_63 -> V_66 ;
struct V_2 * V_3 = V_65 -> V_190 ;
if ( ! V_65 || ! V_3 )
return - V_152 ;
if ( ( V_115 ) V_61 & ~ V_65 -> V_151 )
return - V_236 ;
return F_104 ( V_65 , V_61 , V_234 , V_200 , V_55 ) ;
}
static T_10 F_109 ( struct V_62 * V_63 , unsigned long V_61 ,
T_10 V_200 )
{
int V_56 ;
struct V_64 * V_65 = V_63 -> V_66 ;
V_56 = F_104 ( V_65 , V_61 , 0 , V_200 , 0 ) ;
F_26 ( & V_65 -> V_67 ) ;
return V_56 ? V_56 : V_200 ;
}
static V_115 F_110 ( struct V_62 * V_63 ,
T_13 V_61 )
{
T_4 * V_113 ;
T_7 * V_171 ;
...
if ( F_113 ( V_169 ) )
goto V_198;
V_209 = F_88 ( * V_169 ) + F_89 ( V_61 ) ;
if ( F_114 ( V_209 ) )
goto V_198;
F_13 ( & V_65 -> V_168 ) ;
return F_115 ( F_116 ( * V_209 ) ) | ( V_61 & ~ V_202 ) ;
V_198:
F_13 ( & V_65 -> V_168 ) ;
F_12 ( V_3 -> V_18 ,
L_15 ,
...
{
struct V_2 * V_240 , * V_14 , * V_3 ;
struct V_1 * V_9 = NULL ;
F_10 ( & V_33 ) ;
F_11 (parent, &arm_smmu_devices, list) {
V_3 = V_14 ;
F_11 (child, &arm_smmu_devices, list) {
if ( V_240 -> V_32 == V_14 -> V_18 -> V_10 ) {
V_9 = F_1 ( V_240 , V_18 -> V_10 ) ;
if ( V_9 ) {
V_3 = NULL ;
break;
}
...
{
void T_1 * V_40 = F_20 ( V_3 ) ;
void T_1 * V_241 = F_27 ( V_3 ) + V_148 ;
int V_21 = 0 ;
T_3 V_242 = F_22 ( V_40 + V_243 ) ;
for ( V_21 = 0 ; V_21 < V_3 -> V_181 ; ++ V_21 ) {
F_21 ( ~ V_185 , V_40 + F_70 ( V_21 ) ) ;
F_21 ( V_189 , V_40 + F_73 ( V_21 ) ) ;
}
for ( V_21 = 0 ; V_21 < V_3 -> V_159 ; ++ V_21 )
F_21 ( 0 , V_241 + F_28 ( V_3 , V_21 ) ) ;
F_21 ( 0 , V_40 + V_244 ) ;
F_21 ( 0 , V_40 + V_245 ) ;
F_21 ( 0 , V_40 + V_246 ) ;
V_242 |= ( V_247 | V_248 | V_249 | V_250 ) ;
V_242 |= ( V_251 | V_252 ) ;
V_242 &= ~ ( V_253 | V_254 ) ;
V_242 &= ~ V_255 ;
V_242 &= ~ ( V_256 << V_257 ) ;
F_19 ( V_3 ) ;
F_34 ( V_242 , V_40 + V_243 ) ;
}
static int F_121 ( int V_200 )
{
switch ( V_200 ) {
case 0 :
return 32 ;
...
T_3 V_184 ;
F_123 ( V_3 -> V_18 , L_16 ) ;
V_184 = F_22 ( V_40 + V_258 ) ;
V_3 -> V_94 = ( ( V_184 >> V_259 ) & V_260 ) + 1 ;
F_123 ( V_3 -> V_18 , L_17 , V_3 -> V_94 ) ;
V_184 = F_22 ( V_40 + V_261 ) ;
#ifndef F_32
if ( ( ( V_184 >> V_262 ) & V_263 ) == V_264 ) {
F_7 ( V_3 -> V_18 , L_18 ) ;
return - V_152 ;
}
#endif
...
if ( V_184 & V_270 ) {
T_3 V_271 , V_188 , V_183 ;
V_3 -> V_153 |= V_179 ;
V_3 -> V_181 = ( V_184 >> V_272 ) &
V_273 ;
if ( V_3 -> V_181 == 0 ) {
F_7 ( V_3 -> V_18 ,
L_24 ) ;
...
V_271 = V_274 << V_187 ;
V_271 |= ( V_275 << V_186 ) ;
F_21 ( V_271 , V_40 + F_70 ( 0 ) ) ;
V_271 = F_22 ( V_40 + F_70 ( 0 ) ) ;
V_183 = ( V_271 >> V_187 ) & V_274 ;
V_188 = ( V_271 >> V_186 ) & V_275 ;
...
V_184 = F_22 ( V_40 + V_276 ) ;
V_3 -> V_277 = ( V_184 & V_278 ) ? V_279 : V_119 ;
V_200 = 1 << ( ( ( V_184 >> V_280 ) & V_281 ) + 1 ) ;
V_200 *= ( V_3 -> V_277 << 1 ) ;
if ( V_3 -> V_200 < V_200 )
F_12 ( V_3 -> V_18 ,
L_27 ,
V_200 , V_3 -> V_200 ) ;
V_3 -> V_156 = ( V_184 >> V_282 ) &
V_283 ;
V_3 -> V_159 = ( V_184 >> V_284 ) & V_285 ;
...
F_123 ( V_3 -> V_18 , L_29 ,
V_3 -> V_159 , V_3 -> V_156 ) ;
V_184 = F_22 ( V_40 + V_286 ) ;
V_200 = F_121 ( ( V_184 >> V_287 ) & V_288 ) ;
#ifdef F_32
V_3 -> V_110 = F_124 ( 39UL , V_200 ) ;
#else
V_3 -> V_110 = F_124 ( 32UL , V_200 ) ;
#endif
V_200 = F_121 ( ( V_184 >> V_289 ) & V_290 ) ;
V_3 -> V_122 = F_124 ( ( unsigned long ) V_291 , V_200 ) ;
if ( V_3 -> V_94 == 1 ) {
V_3 -> V_102 = 32 ;
} else {
#ifdef F_32
V_200 = ( V_184 >> V_292 ) & V_293 ;
V_200 = F_124 ( 39 , F_121 ( V_200 ) ) ;
#else
V_200 = 32 ;
#endif
V_3 -> V_102 = V_200 ;
if ( ( V_118 == V_119 && ! ( V_184 & V_294 ) ) ||
( V_118 == V_279 && ! ( V_184 & V_295 ) ) ||
( V_118 != V_119 && V_118 != V_279 ) ) {
F_7 ( V_3 -> V_18 , L_30 ,
V_118 ) ;
return - V_152 ;
}
...
struct V_2 * V_3 ;
struct V_4 * V_5 ;
struct V_17 * V_18 = & V_297 -> V_18 ;
struct V_6 * V_7 ;
struct V_19 V_20 ;
int V_300 , V_21 , V_301 ;
...
V_3 -> V_18 = V_18 ;
V_299 = F_126 ( V_297 , V_302 , 0 ) ;
if ( ! V_299 ) {
F_7 ( V_18 , L_33 ) ;
return - V_152 ;
}
V_3 -> V_200 = F_127 ( V_299 ) ;
V_3 -> V_47 = F_128 ( V_18 , V_299 ) ;
if ( ! V_3 -> V_47 )
return - V_303 ;
if ( F_129 ( V_18 -> V_10 , L_34 ,
& V_3 -> V_162 ) ) {
F_7 ( V_18 , L_35 ) ;
return - V_152 ;
}
V_300 = 0 ;
while ( ( V_299 = F_126 ( V_297 , V_304 , V_300 ) ) ) {
V_300 ++ ;
if ( V_300 > V_3 -> V_162 )
V_3 -> V_160 ++ ;
}
...
V_3 -> V_160 = V_300 - V_3 -> V_162 ;
V_3 -> V_161 = F_8 ( V_18 , sizeof( * V_3 -> V_161 ) * V_300 ,
V_28 ) ;
if ( ! V_3 -> V_161 ) {
F_7 ( V_18 , L_37 , V_300 ) ;
return - V_29 ;
}
for ( V_21 = 0 ; V_21 < V_300 ; ++ V_21 ) {
int V_54 = F_130 ( V_297 , V_21 ) ;
if ( V_54 < 0 ) {
F_7 ( V_18 , L_38 , V_21 ) ;
return - V_152 ;
}
...
V_21 = 0 ;
V_3 -> V_8 = V_305 ;
while ( ! F_131 ( V_18 -> V_10 , L_39 ,
L_40 , V_21 ,
& V_20 ) ) {
V_301 = F_6 ( V_3 , V_18 , & V_20 ) ;
if ( V_301 ) {
F_7 ( V_18 , L_41 ,
V_20 . V_22 -> V_23 ) ;
goto V_306;
...
F_123 ( V_18 , L_42 , V_21 ) ;
if ( ( V_5 = F_132 ( V_18 -> V_10 , L_43 , 0 ) ) )
V_3 -> V_32 = V_5 ;
V_301 = F_122 ( V_3 ) ;
if ( V_301 )
goto V_307;
...
F_135 ( V_3 -> V_32 ) ;
V_306:
for ( V_7 = F_136 ( & V_3 -> V_8 ) ; V_7 ; V_7 = F_137 ( V_7 ) ) {
struct V_1 * V_9 ;
V_9 = F_2 ( V_7 , struct V_1 , V_7 ) ;
F_135 ( V_9 -> V_10 ) ;
}
...
if ( ! F_140 ( V_3 -> V_158 , V_312 ) )
F_7 ( V_18 , L_47 ) ;
for ( V_21 = 0 ; V_21 < V_3 -> V_162 ; ++ V_21 )
F_48 ( V_3 -> V_161 [ V_21 ] , V_3 ) ;
F_34 ( V_253 , F_20 ( V_3 ) + V_243 ) ;
return 0 ;
}
static int T_14 F_141 ( void )
{
int V_56 ;
V_56 = F_142 ( & V_313 ) ;
if ( V_56 )
