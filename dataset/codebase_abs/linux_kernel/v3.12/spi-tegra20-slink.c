...
{
struct V_186 * V_187 = V_2 -> V_50 -> V_188 ;
T_2 V_189 [ 2 ] ;
if ( F_68 ( V_187 , L_21 ,
V_189 , 2 ) >= 0 )
V_2 -> V_109 = V_189 [ 1 ] ;
...
static int F_70 ( struct V_190 * V_191 )
{
struct V_160 * V_121 ;
struct V_1 * V_2 ;
struct V_192 * V_193 ;
int V_76 , V_194 ;
const struct V_195 * V_196 = NULL ;
const struct V_197 * V_198 ;
V_198 = F_71 ( V_199 , & V_191 -> V_50 ) ;
if ( ! V_198 ) {
F_23 ( & V_191 -> V_50 , L_23 ) ;
return - V_200 ;
}
V_196 = V_198 -> V_201 ;
V_121 = F_72 ( & V_191 -> V_50 , sizeof( * V_2 ) ) ;
if ( ! V_121 ) {
F_23 ( & V_191 -> V_50 , L_24 ) ;
return - V_107 ;
}
V_121 -> V_202 = V_139 | V_137 | V_159 ;
V_121 -> V_203 = F_47 ;
V_121 -> V_204 = F_54 ;
V_121 -> V_205 = true ;
V_121 -> V_206 = V_151 ;
...
F_74 ( & V_2 -> V_158 ) ;
F_67 ( V_2 ) ;
V_193 = F_75 ( V_191 , V_209 , 0 ) ;
if ( ! V_193 ) {
F_23 ( & V_191 -> V_50 , L_25 ) ;
V_76 = - V_200 ;
goto V_210;
}
V_2 -> V_111 = V_193 -> V_211 ;
V_2 -> V_4 = F_76 ( & V_191 -> V_50 , V_193 ) ;
if ( F_77 ( V_2 -> V_4 ) ) {
V_76 = F_78 ( V_2 -> V_4 ) ;
goto V_210;
}
V_194 = F_79 ( V_191 , 0 ) ;
V_2 -> V_179 = V_194 ;
V_76 = F_80 ( V_2 -> V_179 , F_66 ,
F_65 , V_212 ,
F_81 ( & V_191 -> V_50 ) , V_2 ) ;
if ( V_76 < 0 ) {
F_23 ( & V_191 -> V_50 , L_26 ,
V_2 -> V_179 ) ;
goto V_210;
}
V_2 -> V_127 = F_82 ( & V_191 -> V_50 , NULL ) ;
if ( F_77 ( V_2 -> V_127 ) ) {
F_23 ( & V_191 -> V_50 , L_27 ) ;
V_76 = F_78 ( V_2 -> V_127 ) ;
goto V_213;
}
V_2 -> V_31 = V_148 << 2 ;
...
V_76 = F_33 ( V_2 , true ) ;
if ( V_76 < 0 ) {
F_23 ( & V_191 -> V_50 , L_28 , V_76 ) ;
goto V_213;
}
V_76 = F_33 ( V_2 , false ) ;
if ( V_76 < 0 ) {
F_23 ( & V_191 -> V_50 , L_29 , V_76 ) ;
goto V_215;
}
V_2 -> V_31 = V_2 -> V_52 ;
F_83 ( & V_2 -> V_62 ) ;
...
F_84 ( & V_191 -> V_50 ) ;
if ( ! F_85 ( & V_191 -> V_50 ) ) {
V_76 = F_86 ( & V_191 -> V_50 ) ;
if ( V_76 )
goto V_216;
}
V_76 = F_50 ( & V_191 -> V_50 ) ;
if ( V_76 < 0 ) {
F_23 ( & V_191 -> V_50 , L_30 , V_76 ) ;
goto V_216;
}
V_2 -> V_130 = V_217 ;
V_2 -> V_133 = V_218 ;
...
F_3 ( V_2 , V_2 -> V_133 , V_147 ) ;
F_53 ( & V_191 -> V_50 ) ;
V_121 -> V_50 . V_188 = V_191 -> V_50 . V_188 ;
V_76 = F_87 ( V_121 ) ;
if ( V_76 < 0 ) {
F_23 ( & V_191 -> V_50 , L_31 , V_76 ) ;
goto V_216;
}
return V_76 ;
V_216:
...
static int F_93 ( struct V_190 * V_191 )
{
struct V_160 * V_121 = F_94 ( V_191 ) ;
struct V_1 * V_2 = F_43 ( V_121 ) ;
F_91 ( V_2 -> V_179 , V_2 ) ;
F_95 ( V_121 ) ;
if ( V_2 -> V_64 )
...
{
struct V_160 * V_121 = F_97 ( V_50 ) ;
return F_98 ( V_121 ) ;
}
static int F_99 ( struct V_219 * V_50 )
{
struct V_160 * V_121 = F_97 ( V_50 ) ;
struct V_1 * V_2 = F_43 ( V_121 ) ;
int V_76 ;
...
struct V_1 * V_2 = F_43 ( V_121 ) ;
int V_76 ;
V_76 = F_102 ( V_2 -> V_127 ) ;
if ( V_76 < 0 ) {
F_23 ( V_2 -> V_50 , L_32 , V_76 ) ;
return V_76 ;
}
return 0 ;
}
