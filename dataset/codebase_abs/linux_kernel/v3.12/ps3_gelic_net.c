...
int V_4 ;
#ifdef F_19
if ( F_20 ( V_2 -> V_24 . V_25 ) !=
V_26 ) {
F_21 ( V_27 L_4 , V_5 ,
F_22 ( V_2 -> V_24 . V_25 -> V_28 ) ) ;
F_21 ( V_27 L_5 , V_5 ,
F_22 ( V_2 -> V_24 . V_25 -> V_29 ) ) ;
F_21 ( V_27 L_6 , V_5 ,
V_2 -> V_24 . V_25 ) ;
}
#endif
V_4 = F_23 ( F_3 ( V_2 ) , F_4 ( V_2 ) ,
V_2 -> V_24 . V_25 -> V_30 , 0 ) ;
if ( V_4 )
F_5 ( F_6 ( V_2 ) ,
L_7 , V_4 ) ;
}
...
{
struct V_31 * V_32 ;
for ( V_32 = V_37 ; V_37 != V_32 -> V_38 ; V_32 ++ ) {
F_26 ( V_32 , V_26 ) ;
V_32 -> V_29 = F_27 ( V_32 -> V_38 -> V_30 ) ;
}
V_36 -> V_25 = V_37 ;
V_36 -> V_39 = ( V_32 - 1 ) ;
( V_32 - 1 ) -> V_29 = 0 ;
...
{
return F_22 ( V_32 -> V_28 ) & V_34 ;
}
static void F_39 ( struct V_1 * V_2 ,
struct V_31 * V_46 )
{
struct V_31 * V_32 ;
for ( V_32 = V_46 ; V_32 && V_32 -> V_30 ; V_32 = V_32 -> V_38 ) {
F_40 ( F_6 ( V_2 ) , V_32 -> V_30 ,
V_47 , V_48 ) ;
V_32 -> V_30 = 0 ;
}
}
...
struct V_35 * V_36 ,
struct V_31 * V_37 , int V_49 )
{
int V_50 ;
struct V_31 * V_32 ;
V_32 = V_37 ;
memset ( V_32 , 0 , sizeof( * V_32 ) * V_49 ) ;
for ( V_50 = 0 ; V_50 < V_49 ; V_50 ++ , V_32 ++ ) {
F_26 ( V_32 , V_51 ) ;
V_32 -> V_30 =
F_42 ( F_6 ( V_2 ) , V_32 ,
V_47 ,
...
return 0 ;
V_52:
for ( V_50 -- , V_32 -- ; 0 <= V_50 ; V_50 -- , V_32 -- )
if ( V_32 -> V_30 )
F_40 ( F_6 ( V_2 ) , V_32 -> V_30 ,
V_47 ,
V_48 ) ;
...
V_32 -> V_63 = 0 ;
V_32 -> V_64 = 0 ;
V_55 = ( ( unsigned long ) V_32 -> V_59 -> V_65 ) &
( V_58 - 1 ) ;
if ( V_55 )
F_46 ( V_32 -> V_59 , V_58 - V_55 ) ;
V_32 -> V_60 = F_27 ( F_42 ( F_6 ( V_2 ) ,
V_32 -> V_59 -> V_65 ,
V_57 ,
V_66 ) ) ;
if ( ! V_32 -> V_60 ) {
...
{
struct V_31 * V_32 = V_2 -> V_24 . V_25 ;
do {
if ( V_32 -> V_59 ) {
F_40 ( F_6 ( V_2 ) ,
F_22 ( V_32 -> V_60 ) ,
...
struct V_31 * V_32 )
{
struct V_70 * V_59 = V_32 -> V_59 ;
F_52 ( ! ( F_22 ( V_32 -> V_71 ) & V_72 ) ) ;
F_40 ( F_6 ( V_2 ) , F_22 ( V_32 -> V_60 ) , V_59 -> V_67 ,
V_73 ) ;
F_47 ( V_59 ) ;
V_32 -> V_60 = 0 ;
V_32 -> V_61 = 0 ;
...
if ( ! V_2 -> V_76 . V_25 )
return NULL ;
if ( V_2 -> V_76 . V_39 != V_2 -> V_76 . V_25 -> V_38 &&
F_20 ( V_2 -> V_76 . V_25 ) ==
V_51 )
return V_2 -> V_76 . V_25 ;
else
return NULL ;
}
...
V_32 -> V_60 = F_27 ( V_116 ) ;
V_32 -> V_61 = F_27 ( V_59 -> V_67 ) ;
V_32 -> V_59 = V_59 ;
V_32 -> V_71 = 0 ;
V_32 -> V_29 = 0 ;
F_67 ( V_32 , V_59 ) ;
V_2 -> V_76 . V_25 = V_32 -> V_38 ;
return 0 ;
}
...
V_71 = F_22 ( V_32 -> V_71 ) ;
V_64 = F_22 ( V_32 -> V_64 ) ;
F_40 ( F_6 ( V_2 ) , F_22 ( V_32 -> V_60 ) ,
V_57 ,
V_66 ) ;
F_83 ( V_59 , F_22 ( V_32 -> V_63 ) ?
F_22 ( V_32 -> V_63 ) :
F_22 ( V_32 -> V_62 ) ) ;
if ( ! V_32 -> V_63 )
F_5 ( F_6 ( V_2 ) , L_25 ,
...
{
enum V_33 V_4 ;
struct V_35 * V_36 = & V_2 -> V_24 ;
struct V_31 * V_32 = V_36 -> V_25 ;
...
return 0 ;
if ( V_4 == V_51 ) {
F_89 ( F_6 ( V_2 ) , L_26 , V_32 ) ;
return 0 ;
}
if ( V_2 -> V_117 ) {
unsigned int V_50 ;
T_5 V_135 ;
V_135 = * ( T_5 * ) ( V_32 -> V_59 -> V_65 ) & V_136 ;
...
0 , 0 , 0 , & V_19 , & V_9 ) ;
V_19 <<= 16 ;
if ( V_4 || ! F_122 ( ( V_226 * ) & V_19 ) ) {
F_5 ( F_6 ( V_2 ) ,
L_40 ,
V_5 , V_4 ) ;
return - V_149 ;
}
memcpy ( V_15 -> V_227 , & V_19 , V_96 ) ;
if ( V_2 -> V_117 ) {
V_15 -> V_228 += V_111 ;
V_15 -> V_127 |= V_229 ;
}
...
F_125 ( F_126 ( struct V_1 , V_32 ) % 32 ) ;
V_232 =
sizeof( struct V_1 ) +
sizeof( struct V_31 ) * V_233 +
sizeof( struct V_31 ) * V_45 +
V_234 - 1 ;
...
V_2 -> V_6 = V_7 | V_155 |
V_156 ;
if ( F_41 ( V_2 , & V_2 -> V_76 ,
V_2 -> V_32 , V_45 ) )
goto V_254;
if ( F_41 ( V_2 , & V_2 -> V_24 ,
V_2 -> V_32 + V_45 ,
V_233 ) )
goto V_255;
V_2 -> V_256 = V_2 -> V_76 . V_25 ;
V_2 -> V_69 = V_2 -> V_24 . V_25 ;
F_89 ( F_6 ( V_2 ) , L_56 ,
V_2 -> V_69 , V_2 -> V_256 , sizeof( struct V_31 ) ,
V_233 ) ;
if ( F_50 ( V_2 ) )
goto V_257;
F_149 ( & V_2 -> V_124 ) ;
...
V_258:
V_257:
F_39 ( V_2 , V_2 -> V_24 . V_25 ) ;
V_255:
F_39 ( V_2 , V_2 -> V_76 . V_25 ) ;
V_254:
F_152 ( V_2 -> V_151 , V_2 ) ;
V_15 -> V_151 = V_259 ;
V_253:
