...
if ( V_48 < 1 )
goto V_133;
if ( ( ( 1 << V_48 ) & V_83 -> V_134 ) == 0 ) {
F_24 ( L_31 ) ;
return - V_102 ;
}
V_125 = F_49 ( V_48 , V_2 -> V_132 ) ;
if ( V_125 ) {
F_24 ( V_129
L_32 , V_48 ) ;
return - V_103 ;
