...
( V_90 -> V_142 . V_5 & V_143 ) )
V_134 = - 1 ;
else
V_134 = F_36 ( V_10 , V_12 ) ;
#ifdef F_40
if ( V_10 -> V_144 != - 1 ) {
V_12 -> V_51 = V_10 -> V_144 ;
V_12 -> V_52 = V_10 -> V_144 ;
V_12 -> V_53 = V_10 -> V_144 ;
V_134 = - 1 ;
}
#endif
V_12 -> V_145 ++ ;
...
if ( V_84 -> V_146 != V_147 )
return;
if ( ! ( V_10 -> V_131 -> V_5 & V_148 ) )
return;
V_12 -> V_149 = 0 ;
V_12 -> V_136 = 0 ;
for ( V_44 = 0 ; V_44 < 4 ; V_44 ++ ) {
if ( ! F_42 ( V_73 , V_84 -> V_146 , V_10 -> V_16 [ V_44 ] ) )
continue;
V_12 -> V_149 |= F_5 ( V_44 ) ;
if ( V_84 -> V_150 [ V_44 ] . V_5 & V_151 )
V_12 -> V_136 |= F_5 ( V_44 ) ;
}
V_12 -> V_17 [ V_15 ] . V_18 = V_12 -> V_149 ;
}
static void
...
struct V_86 * V_87 = V_85 ;
struct V_11 * V_12 = & V_87 -> V_88 ;
struct V_154 * V_155 = & V_73 -> V_156 . V_155 ;
T_1 V_157 = V_73 -> V_156 . V_158 ;
int V_159 = 0 ;
int V_160 ;
int V_161 ;
int V_44 ;
...
V_12 -> V_73 = V_73 ;
V_12 -> V_57 = V_58 ;
V_160 = F_45 ( V_84 -> V_146 , 10 , 60 , 1 , 1 , 0 ) ;
V_12 -> V_36 = F_45 ( V_84 -> V_146 , 0 , 60 , 1 , 1 , 0 ) ;
V_12 -> V_36 += V_160 ;
V_12 -> V_118 = V_12 -> V_36 + 2 * V_160 ;
V_12 -> V_37 = F_9 ( 1 , 1 ) ;
if ( V_10 -> V_166 ) {
V_12 -> V_49 = 16 ;
V_12 -> V_104 = 0 ;
...
V_87 -> V_99 . V_179 = V_87 -> V_180 ;
V_87 -> V_99 . V_62 = V_87 -> V_62 ;
return V_97 . V_181 ( V_82 , V_84 , V_153 , V_73 ,
& V_87 -> V_99 ) ;
}
static void
...
struct V_65 * V_73 , void * V_85 )
{
F_43 ( V_82 , V_84 , V_153 , V_73 , V_85 ) ;
}
static void
...
static void *
F_48 ( void * V_82 , struct V_65 * V_73 , T_4 V_183 )
{
struct V_83 * V_84 ;
struct V_86 * V_87 ;
struct V_9 * V_10 = V_82 ;
struct V_184 * V_131 = V_10 -> V_131 ;
int V_132 = 0 ;
int V_44 ;
for ( V_44 = 0 ; V_44 < V_185 ; V_44 ++ ) {
V_84 = V_131 -> V_186 -> V_187 [ V_44 ] ;
if ( V_84 && V_84 -> V_188 > V_132 )
V_132 = V_84 -> V_188 ;
}
V_87 = F_33 ( sizeof( * V_87 ) , V_183 ) ;
if ( ! V_87 )
return NULL ;
V_87 -> V_180 = F_33 ( sizeof( struct V_189 ) * V_132 , V_183 ) ;
if ( ! V_87 -> V_180 )
goto error;
V_87 -> V_62 = F_49 ( V_190 * V_132 , V_183 ) ;
if ( ! V_87 -> V_62 )
goto V_191;
return V_87 ;
V_191:
...
static void *
F_52 ( struct V_184 * V_131 , struct V_192 * V_193 )
{
return V_97 . V_194 ( V_131 , V_193 ) ;
}
static void
F_53 ( void * V_82 )
{
...
V_196 = ( V_44 + V_197 [ V_44 ] ) % V_4 ;
while ( V_62 [ V_195 ] [ V_196 ] != 0xff )
V_196 = ( V_196 + 1 ) % V_4 ;
V_62 [ V_195 ] [ V_196 ] = V_44 ;
}
}
}
int T_5
