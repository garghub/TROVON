...
void T_1 * V_9 ;
int V_82 = 0 ;
V_8 = F_28 ( & V_6 -> V_2 , sizeof( * V_8 ) , V_83 ) ;
if ( ! V_8 )
return - V_84 ;
V_80 = F_29 ( V_6 , V_85 , 0 ) ;
V_9 = F_30 ( & V_6 -> V_2 , V_80 ) ;
if ( F_31 ( V_9 ) )
return F_32 ( V_9 ) ;
V_8 -> V_9 = V_9 ;
V_8 -> V_57 = F_33 ( V_6 , 0 ) ;
...
V_8 -> V_65 = F_38 ( & V_6 -> V_2 , V_6 -> V_91 ,
& V_92 , V_93 ) ;
if ( F_31 ( V_8 -> V_65 ) )
return F_32 ( V_8 -> V_65 ) ;
V_82 = F_39 ( & V_6 -> V_2 . V_71 , & V_94 ) ;
return V_82 ;
}
static int F_40 ( struct V_5 * V_6 )
{
struct V_7 * V_8 = F_3 ( V_6 ) ;
F_41 ( & V_6 -> V_2 . V_71 , & V_94 ) ;
if ( V_8 -> V_57 > 0 )
F_5 ( 0 , V_8 -> V_9 + V_54 ) ;
return 0 ;
}
