...
static unsigned long
F_46 ( struct V_46 * V_47 , struct V_48 * V_49 )
{
unsigned long V_42 ;
F_17 ( & V_23 ) ;
V_42 = F_40 () ;
...
V_63 ) ;
T_2 V_64 = F_48 ( V_57 -> V_60 [ 0 ] . V_21 , V_61 ) ;
V_55 = F_49 ( V_59 , V_64 , 0 ) ;
V_61 -= V_64 ;
V_53 = V_57 -> V_65 / V_66 ;
V_54 = V_57 -> V_65 & ~ V_67 ;
while ( V_61 ) {
V_59 = F_50 ( V_57 -> V_68 [ V_53 ] ) + V_54 ;
V_64 = F_3 ( T_2 , V_66 - V_54 , V_61 ) ;
V_55 = F_49 ( V_59 , V_64 , V_55 ) ;
V_61 -= V_64 ;
V_54 = 0 ;
++ V_53 ;
}
...
static bool
F_51 ( struct V_51 * V_52 , T_1 V_55 , struct V_7 * V_8 )
{
if ( V_52 -> V_69 != V_8 -> V_39 || V_52 -> V_70 != V_8 -> V_71 ||
V_52 -> V_72 != V_8 -> V_73 || V_52 -> V_74 != V_8 -> V_75 ||
V_52 -> V_58 . V_64 != V_8 -> V_76 ||
! F_52 ( F_53 ( V_52 ) , (struct V_77 * ) & V_8 -> V_78 ) ||
F_54 ( F_53 ( V_52 ) ) != F_54 ( (struct V_77 * ) & V_8 -> V_78 ) )
return false ;
if ( V_55 != V_8 -> V_79 ) {
++ V_80 ;
return false ;
...
static struct V_7 *
F_55 ( struct V_51 * V_52 , T_1 V_55 )
{
...
V_8 -> V_39 = V_87 ;
V_8 -> V_71 = V_90 ;
F_61 ( (struct V_77 * ) & V_8 -> V_78 , F_53 ( V_52 ) ) ;
F_62 ( (struct V_77 * ) & V_8 -> V_78 , F_54 ( F_53 ( V_52 ) ) ) ;
V_8 -> V_73 = V_88 ;
V_8 -> V_75 = V_89 ;
...
break;
case V_107 :
F_63 ( & V_52 -> V_108 . V_60 [ 0 ] , V_8 -> V_109 ) ;
V_93 = V_110 ;
break;
case V_17 :
if ( ! F_64 ( V_52 , & V_8 -> V_18 ) )
goto V_100;
V_93 = V_110 ;
break;
default:
...
void
F_65 ( struct V_51 * V_52 , int V_112 , T_3 * V_113 )
{
...
static int
F_64 ( struct V_51 * V_52 , struct V_114 * V_119 )
{
...
static int F_67 ( struct V_121 * V_122 , void * V_123 )
{
F_17 ( & V_23 ) ;
F_68 ( V_122 , L_7 , V_26 ) ;
F_68 ( V_122 , L_8 , V_22 ) ;
F_68 ( V_122 , L_9 , 1 << V_27 ) ;
F_68 ( V_122 , L_10 , V_20 ) ;
F_68 ( V_122 , L_11 , V_96 . V_102 ) ;
F_68 ( V_122 , L_12 , V_96 . V_101 ) ;
F_68 ( V_122 , L_13 , V_96 . V_97 ) ;
F_68 ( V_122 , L_14 , V_80 ) ;
F_68 ( V_122 , L_15 , V_84 ) ;
F_68 ( V_122 , L_16 , V_85 ) ;
F_18 ( & V_23 ) ;
return 0 ;
}
int F_69 ( struct V_124 * V_124 , struct V_125 * V_125 )
{
return F_70 ( V_125 , F_67 , NULL ) ;
}
