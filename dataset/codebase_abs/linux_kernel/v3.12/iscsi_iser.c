...
static void
F_37 ( struct V_59 * V_63 , int V_73 )
{
struct V_1 * V_2 = V_63 -> V_19 ;
struct V_25 * V_26 = V_2 -> V_19 ;
struct V_26 * V_29 = V_26 -> V_29 ;
...
{
struct V_74 * V_75 = F_40 ( V_61 ) ;
F_41 ( V_61 ) ;
F_42 ( V_75 ) ;
F_43 ( V_75 ) ;
}
static struct V_60 *
F_44 ( struct V_70 * V_71 ,
T_5 V_76 , T_5 V_77 ,
T_3 V_78 )
{
struct V_60 * V_61 ;
...
break;
default:
return F_49 ( V_63 , V_96 , V_97 , V_98 ) ;
}
return 0 ;
}
static void
...
V_107 -> V_124 = 4 ;
strcpy ( V_107 -> V_125 [ 0 ] . V_20 , L_15 ) ;
V_107 -> V_125 [ 0 ] . V_99 = 0 ;
strcpy ( V_107 -> V_125 [ 1 ] . V_20 , L_16 ) ;
V_107 -> V_125 [ 1 ] . V_99 = 0 ; ;
strcpy ( V_107 -> V_125 [ 2 ] . V_20 , L_17 ) ;
V_107 -> V_125 [ 2 ] . V_99 = V_2 -> V_126 ;
strcpy ( V_107 -> V_125 [ 3 ] . V_20 , L_18 ) ;
V_107 -> V_125 [ 3 ] . V_99 = V_2 -> V_127 ;
}
static int F_51 ( struct V_70 * V_71 ,
enum V_95 V_96 , char * V_97 )
{
struct V_26 * V_29 = V_71 -> V_19 ;
int V_128 ;
switch ( V_96 ) {
case V_129 :
case V_130 :
...
static struct V_70 *
F_53 ( struct V_74 * V_75 , struct V_137 * V_135 ,
int V_138 )
{
int V_139 ;
struct V_26 * V_29 ;
struct V_70 * V_71 ;
V_71 = F_54 ( sizeof( * V_29 ) ) ;
if ( ! V_71 )
return F_55 ( - V_34 ) ;
V_29 = V_71 -> V_19 ;
V_29 -> V_71 = V_71 ;
...
static int
F_58 ( struct V_70 * V_71 , int V_141 )
{
struct V_26 * V_29 ;
int V_7 ;
V_29 = V_71 -> V_19 ;
...
if ( V_29 -> V_26 )
F_62 ( V_29 -> V_26 -> V_1 ) ;
F_35 ( L_20 , V_29 , V_29 -> V_143 ) ;
F_63 ( V_29 ) ;
}
static T_6 F_64 ( int V_147 , int V_96 )
{
switch ( V_147 ) {
case V_148 :
switch ( V_96 ) {
...
memset ( & V_180 , 0 , sizeof( struct V_181 ) ) ;
V_180 . V_182 = F_66 ( L_23 ,
sizeof( struct V_23 ) ,
0 , V_183 ,
NULL ) ;
if ( V_180 . V_182 == NULL )
