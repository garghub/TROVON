...
static int F_112 ( struct V_119 * V_10 )
{
struct V_3 * V_4 = (struct V_3 * ) V_10 ;
unsigned int V_205 ;
int V_225 ;
...
goto V_230;
F_42 ( V_4 -> V_92 , V_4 -> V_10 . V_11 + V_94 ) ;
V_225 = F_113 ( V_4 -> V_10 . V_182 , F_98 , 0 , L_21 , V_4 ) ;
if ( V_225 )
goto V_230;
F_42 ( V_4 -> V_158 -> V_231 , V_4 -> V_10 . V_11 + V_232 ) ;
V_205 = V_233 | V_234 | V_216 ;
F_42 ( V_205 , V_4 -> V_10 . V_11 + V_206 ) ;
F_42 ( 0 , V_4 -> V_10 . V_11 + V_235 ) ;
F_42 ( 1 , V_4 -> V_10 . V_11 + V_236 ) ;
F_42 ( 0 , V_4 -> V_10 . V_11 + V_4 -> V_237 ) ;
if ( V_4 -> V_221 != V_4 -> V_237 ) {
int V_238 ;
for ( V_238 = 0 ; V_238 < 10 ; ++ V_238 )
F_42 ( 0xff , V_4 -> V_10 . V_11 + V_188 ) ;
F_42 ( 0 , V_4 -> V_10 . V_11 + V_4 -> V_221 ) ;
}
F_42 ( 0 , V_4 -> V_10 . V_11 + V_14 ) ;
while ( F_5 ( V_4 -> V_10 . V_11 + V_12 ) & V_164 )
F_84 () ;
V_205 = V_4 -> V_239 & ( V_208 | V_210 ) ;
V_205 |= V_233 | V_240 | V_234 ;
F_42 ( V_205 , V_4 -> V_10 . V_11 + V_206 ) ;
...
{
unsigned long V_242 ;
V_242 = F_5 ( V_4 -> V_10 . V_11 + V_241 ) ;
V_242 &= ~ ( V_222 | V_243 ) ;
F_42 ( V_242 , V_4 -> V_10 . V_11 + V_241 ) ;
}
static void F_116 ( struct V_119 * V_10 )
{
struct V_3 * V_4 = (struct V_3 * ) V_10 ;
unsigned int V_205 ;
F_70 ( & V_4 -> V_10 . V_85 ) ;
...
static void
F_119 ( struct V_119 * V_10 , struct V_244 * V_245 ,
struct V_244 * V_246 )
{
struct V_3 * V_4 = (struct V_3 * ) V_10 ;
unsigned int V_220 , V_239 ;
unsigned long V_83 ;
...
V_249 = 16 ;
V_247 = F_120 ( V_10 , V_245 , V_246 , 0 ,
V_10 -> V_228 / V_249 ) ;
#ifdef F_121
if ( V_4 -> V_68 . V_71 )
V_4 -> V_68 . V_72 = F_122 ( 10000000 , V_247 ) ;
#endif
if ( V_247 > V_10 -> V_228 / 16 )
V_248 = F_123 ( V_10 -> V_228 * 8 , V_247 ) ;
else
V_248 = F_123 ( V_10 -> V_228 * 4 , V_247 ) ;
switch ( V_245 -> V_251 & V_252 ) {
case V_253 :
V_220 = V_254 ;
break;
case V_255 :
...
if ( V_245 -> V_251 & V_260 )
V_220 |= V_261 ;
if ( V_245 -> V_251 & V_262 ) {
V_220 |= V_263 ;
if ( ! ( V_245 -> V_251 & V_264 ) )
V_220 |= V_265 ;
}
if ( V_4 -> V_55 > 1 )
V_220 |= V_243 ;
F_40 ( & V_10 -> V_85 , V_83 ) ;
F_124 ( V_10 , V_245 -> V_251 , V_247 ) ;
V_10 -> V_28 = V_26 | 255 ;
if ( V_245 -> V_266 & V_267 )
V_10 -> V_28 |= V_21 | V_22 ;
if ( V_245 -> V_266 & ( V_268 | V_269 ) )
V_10 -> V_28 |= V_20 ;
V_10 -> V_270 = 0 ;
if ( V_245 -> V_266 & V_271 )
V_10 -> V_270 |= V_21 | V_22 ;
if ( V_245 -> V_266 & V_272 ) {
V_10 -> V_270 |= V_20 ;
if ( V_245 -> V_266 & V_271 )
V_10 -> V_270 |= V_26 ;
}
if ( ( V_245 -> V_251 & V_273 ) == 0 )
V_10 -> V_270 |= V_15 ;
if ( F_125 ( V_10 , V_245 -> V_251 ) )
F_91 ( V_10 ) ;
V_239 = F_5 ( V_10 -> V_11 + V_206 ) ;
F_42 ( 0 , V_10 -> V_11 + V_206 ) ;
if ( V_245 -> V_251 & V_274 ) {
if ( V_239 & V_208 )
V_239 |= V_218 ;
V_239 |= V_275 ;
V_4 -> V_217 = true ;
...
if ( V_4 -> V_158 -> V_250 ) {
if ( ( V_247 >= 3000000 ) && ( V_247 < 3250000 ) && ( V_248 > 1 ) )
V_248 -= 1 ;
else if ( ( V_247 > 3250000 ) && ( V_248 > 2 ) )
V_248 -= 2 ;
}
F_42 ( V_248 & 0x3f , V_10 -> V_11 + V_235 ) ;
F_42 ( V_248 >> 6 , V_10 -> V_11 + V_236 ) ;
F_42 ( V_220 , V_10 -> V_11 + V_4 -> V_237 ) ;
if ( V_4 -> V_237 != V_4 -> V_221 ) {
int V_238 ;
for ( V_238 = 0 ; V_238 < 10 ; ++ V_238 )
F_42 ( 0xff , V_4 -> V_10 . V_11 + V_188 ) ;
F_42 ( V_220 , V_10 -> V_11 + V_4 -> V_221 ) ;
}
F_42 ( V_239 , V_10 -> V_11 + V_206 ) ;
F_45 ( & V_10 -> V_85 , V_83 ) ;
}
static const char * F_126 ( struct V_119 * V_10 )
{
struct V_3 * V_4 = (struct V_3 * ) V_10 ;
return V_4 -> V_10 . type == V_277 ? V_4 -> type : NULL ;
}
static void F_127 ( struct V_119 * V_10 )
{
F_128 ( V_10 -> V_49 , V_278 ) ;
}
static int F_129 ( struct V_119 * V_10 )
{
return F_130 ( V_10 -> V_49 , V_278 , L_21 )
!= NULL ? 0 : - V_107 ;
}
static void F_131 ( struct V_119 * V_10 , int V_83 )
{
if ( V_83 & V_279 ) {
V_10 -> type = V_277 ;
F_129 ( V_10 ) ;
...
static int F_132 ( struct V_119 * V_10 , struct V_280 * V_281 )
{
int V_117 = 0 ;
if ( V_281 -> type != V_282 && V_281 -> type != V_277 )
V_117 = - V_283 ;
if ( V_281 -> V_182 < 0 || V_281 -> V_182 >= V_284 )
V_117 = - V_283 ;
if ( V_281 -> V_285 < 9600 )
V_117 = - V_283 ;
return V_117 ;
}
static void F_133 ( struct V_119 * V_10 , int V_6 )
{
struct V_3 * V_4 = (struct V_3 * ) V_10 ;
while ( F_5 ( V_4 -> V_10 . V_11 + V_12 ) & V_118 )
F_84 () ;
...
static void
F_134 ( struct V_286 * V_287 , const char * V_288 , unsigned int V_100 )
{
struct V_3 * V_4 = V_289 [ V_287 -> V_290 ] ;
unsigned int V_5 , V_239 , V_291 ;
unsigned long V_83 ;
int V_292 = 1 ;
F_135 ( V_4 -> V_226 ) ;
F_136 ( V_83 ) ;
...
V_292 = F_137 ( & V_4 -> V_10 . V_85 ) ;
else
F_66 ( & V_4 -> V_10 . V_85 ) ;
V_239 = F_5 ( V_4 -> V_10 . V_11 + V_206 ) ;
V_291 = V_239 & ~ V_275 ;
V_291 |= V_233 | V_234 ;
F_42 ( V_291 , V_4 -> V_10 . V_11 + V_206 ) ;
F_138 ( & V_4 -> V_10 , V_288 , V_100 , F_133 ) ;
do {
V_5 = F_5 ( V_4 -> V_10 . V_11 + V_12 ) ;
} while ( V_5 & V_164 );
F_42 ( V_239 , V_4 -> V_10 . V_11 + V_206 ) ;
if ( V_292 )
F_63 ( & V_4 -> V_10 . V_85 ) ;
F_139 ( V_83 ) ;
F_140 ( V_4 -> V_226 ) ;
...
static void T_4
F_141 ( struct V_3 * V_4 , int * V_247 ,
int * V_24 , int * V_295 )
{
if ( F_5 ( V_4 -> V_10 . V_11 + V_206 ) & V_233 ) {
unsigned int V_220 , V_296 , V_297 ;
V_220 = F_5 ( V_4 -> V_10 . V_11 + V_4 -> V_221 ) ;
* V_24 = 'n' ;
if ( V_220 & V_263 ) {
if ( V_220 & V_265 )
...
* V_295 = 8 ;
V_296 = F_5 ( V_4 -> V_10 . V_11 + V_236 ) ;
V_297 = F_5 ( V_4 -> V_10 . V_11 + V_235 ) ;
* V_247 = V_4 -> V_10 . V_228 * 4 / ( 64 * V_296 + V_297 ) ;
if ( V_4 -> V_158 -> V_250 ) {
...
static int T_4 F_142 ( struct V_286 * V_287 , char * V_298 )
{
struct V_3 * V_4 ;
int V_247 = 38400 ;
int V_295 = 8 ;
...
int V_299 = 'n' ;
int V_117 ;
if ( V_287 -> V_290 >= V_300 )
V_287 -> V_290 = 0 ;
V_4 = V_289 [ V_287 -> V_290 ] ;
if ( ! V_4 )
return - V_301 ;
F_109 ( V_4 -> V_10 . V_2 ) ;
V_117 = F_143 ( V_4 -> V_226 ) ;
if ( V_117 )
return V_117 ;
if ( F_20 ( V_4 -> V_10 . V_2 ) ) {
struct V_44 * V_45 ;
...
V_4 -> V_10 . V_228 = F_111 ( V_4 -> V_226 ) ;
if ( V_298 )
F_144 ( V_298 , & V_247 , & V_24 , & V_295 , & V_299 ) ;
else
F_141 ( V_4 , & V_247 , & V_24 , & V_295 ) ;
return F_145 ( & V_4 -> V_10 , V_287 , V_247 , V_24 , V_295 , V_299 ) ;
}
static int F_146 ( int V_290 , struct V_40 * V_2 )
{
struct V_302 * V_303 ;
...
if ( ! V_303 )
return V_117 ;
V_117 = F_148 ( V_303 , L_22 ) ;
if ( F_149 ( V_117 ) ) {
V_305 = true ;
V_117 = V_290 ;
} else {
V_304 = true ;
if ( V_117 >= F_150 ( V_289 ) || V_289 [ V_117 ] != NULL ) {
F_62 ( V_2 , L_23 , V_117 ) ;
V_117 = V_290 ;
}
}
...
static int F_151 ( struct V_1 * V_2 , const struct V_308 * V_309 )
{
struct V_3 * V_4 ;
struct V_310 * V_158 = V_309 -> V_81 ;
void T_10 * V_311 ;
int V_238 , V_117 ;
for ( V_238 = 0 ; V_238 < F_150 ( V_289 ) ; V_238 ++ )
if ( V_289 [ V_238 ] == NULL )
break;
if ( V_238 == F_150 ( V_289 ) ) {
V_117 = - V_107 ;
goto V_227;
}
V_4 = F_152 ( & V_2 -> V_2 , sizeof( struct V_3 ) ,
V_42 ) ;
if ( V_4 == NULL ) {
V_117 = - V_43 ;
goto V_227;
}
V_238 = F_146 ( V_238 , & V_2 -> V_2 ) ;
V_311 = F_153 ( & V_2 -> V_2 , V_2 -> V_312 . V_313 ,
F_154 ( & V_2 -> V_312 ) ) ;
if ( ! V_311 ) {
V_117 = - V_43 ;
goto V_227;
}
V_4 -> V_226 = F_155 ( & V_2 -> V_2 , NULL ) ;
if ( F_156 ( V_4 -> V_226 ) ) {
V_117 = F_157 ( V_4 -> V_226 ) ;
goto V_227;
}
V_4 -> V_158 = V_158 ;
V_4 -> V_237 = V_158 -> V_237 ;
...
static int F_163 ( struct V_1 * V_2 , T_11 V_90 )
{
struct V_3 * V_4 = F_161 ( V_2 ) ;
if ( ! V_4 )
return - V_283 ;
return F_164 ( & V_320 , & V_4 -> V_10 ) ;
}
