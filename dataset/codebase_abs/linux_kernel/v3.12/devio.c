...
L_22
L_23 ,
V_173 . V_177 , V_173 . V_178 ,
F_109 ( & V_173 . V_184 ) ,
F_109 ( & V_173 . V_179 ) ,
F_109 ( & V_173 . V_176 ) ) ;
if ( V_173 . V_177 & 0x80 ) {
if ( V_173 . V_176 && ! F_110 ( V_185 , V_173 . V_70 ,
V_173 . V_176 ) ) {
V_16 = - V_19 ;
goto V_182;
}
...
F_19 ( V_10 ) ;
V_27 = F_112 ( V_10 , V_66 , V_173 . V_178 ,
...
V_175 , V_173 . V_176 ) ;
F_19 ( V_10 ) ;
V_27 = F_112 ( V_10 , F_114 ( V_10 , 0 ) , V_173 . V_178 ,
V_173 . V_177 , V_173 . V_184 , V_173 . V_179 ,
V_175 , V_173 . V_176 , V_174 ) ;
F_14 ( V_10 ) ;
...
V_16 = V_27 ;
V_182:
F_116 ( ( unsigned long ) V_175 ) ;
F_6 ( V_180 + sizeof( struct V_50 ) +
sizeof( struct V_181 ) ) ;
return V_16 ;
}
static int F_117 ( struct V_7 * V_8 , void T_3 * V_171 )
{
struct V_24 * V_10 = V_8 -> V_10 ;
struct V_187 V_188 ;
...
V_66 = F_119 ( V_10 , V_188 . V_74 & 0x7f ) ;
if ( ! F_120 ( V_10 , V_66 , ! ( V_188 . V_74 & V_107 ) ) )
return - V_19 ;
V_189 = V_188 . V_25 ;
if ( V_189 >= V_4 )
return - V_19 ;
...
V_174 = V_188 . V_183 ;
if ( V_188 . V_74 & 0x80 ) {
if ( V_189 && ! F_110 ( V_185 , V_188 . V_70 , V_189 ) ) {
V_16 = - V_19 ;
goto V_182;
}
F_40 ( V_10 , NULL , V_66 , V_189 , V_174 , V_78 , NULL , 0 ) ;
F_19 ( V_10 ) ;
V_27 = F_121 ( V_10 , V_66 , V_175 , V_189 , & V_190 , V_174 ) ;
F_14 ( V_10 ) ;
...
static int F_122 ( struct V_7 * V_8 , void T_3 * V_171 )
{
unsigned int V_74 ;
int V_16 ;
if ( F_123 ( V_74 , ( unsigned int T_3 * ) V_171 ) )
return - V_37 ;
...
static int F_125 ( struct V_7 * V_8 , void T_3 * V_171 )
{
unsigned int V_74 ;
int V_66 ;
int V_16 ;
...
static int F_127 ( struct V_7 * V_8 , void T_3 * V_171 )
{
struct V_191 V_192 ;
struct V_116 * V_117 ;
int V_16 ;
...
F_128 ( V_192 . V_193 , V_117 -> V_10 . V_193 -> V_195 ,
sizeof( V_192 . V_193 ) ) ;
V_16 = ( F_16 ( V_171 , & V_192 , sizeof( V_192 ) ) ? - V_37 : 0 ) ;
}
return V_16 ;
}
static int F_129 ( struct V_7 * V_8 , void T_3 * V_171 )
{
struct V_196 V_197 = {
...
static int F_132 ( struct V_7 * V_8 , void T_3 * V_171 )
{
struct V_202 V_203 ;
int V_16 ;
...
return V_16 ;
return F_133 ( V_8 -> V_10 , V_203 . V_138 ,
V_203 . V_120 ) ;
}
static int F_134 ( struct V_7 * V_8 , void T_3 * V_171 )
{
int V_204 ;
int V_98 = 0 ;
struct V_205 * V_135 ;
if ( F_123 ( V_204 , ( int T_3 * ) V_171 ) )
return - V_37 ;
...
V_98 = F_137 ( V_8 -> V_10 , V_204 ) ;
}
return V_98 ;
}
static int F_138 ( struct V_7 * V_8 , struct V_209 * V_210 ,
...
if ( V_210 -> V_225 < ( F_140 ( & V_215 -> V_176 ) + 8 ) ) {
V_16 = - V_19 ;
goto error;
}
...
V_270 V_258 ;
V_113 = F_168 ( sizeof( * V_113 ) ) ;
if ( F_123 ( V_272 , & V_268 -> V_74 ) || F_156 ( V_272 , & V_113 -> V_74 ) ||
F_123 ( V_272 , & V_268 -> V_25 ) || F_156 ( V_272 , & V_113 -> V_25 ) ||
F_123 ( V_272 , & V_268 -> V_183 ) || F_156 ( V_272 , & V_113 -> V_183 ) ||
F_123 ( V_258 , & V_268 -> V_70 ) || F_156 ( F_170 ( V_258 ) , & V_113 -> V_70 ) )
return - V_37 ;
...
{
T_8 V_277 ;
if ( ! F_110 ( V_242 , V_210 , sizeof( * V_210 ) ) ||
...
{
unsigned int V_112 ;
if ( F_123 ( V_112 , ( unsigned int T_3 * ) V_171 ) )
return - V_37 ;
return F_75 ( V_8 , V_112 ) ;
}
...
if ( ! F_110 ( V_242 , V_293 , sizeof( * V_293 ) ) ||
...
unsigned V_294 ;
int V_295 ;
if ( F_123 ( V_294 , ( unsigned T_3 * ) V_171 ) )
return - V_37 ;
