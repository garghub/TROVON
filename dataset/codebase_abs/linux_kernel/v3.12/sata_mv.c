...
if ( V_547 == NULL )
return - V_146 ;
if ( V_126 -> V_152 . V_551 ) {
F_196 ( V_126 -> V_152 . V_551 , L_59 , & V_86 ) ;
V_396 = F_197 ( V_126 -> V_152 . V_551 , 0 ) ;
} else {
V_543 = F_198 ( & V_126 -> V_152 ) ;
V_86 = V_543 -> V_86 ;
V_396 = F_199 ( V_126 , 0 ) ;
}
...
if ( ! V_16 || ! V_18 )
return - V_198 ;
V_18 -> V_552 = F_60 ( & V_126 -> V_152 ,
sizeof( struct V_553 * ) * V_86 ,
V_197 ) ;
if ( ! V_18 -> V_552 )
return - V_198 ;
V_16 -> V_19 = V_18 ;
...
F_202 ( V_547 ) ) ;
V_18 -> V_6 -= V_8 ;
V_18 -> V_553 = F_203 ( & V_126 -> V_152 , NULL ) ;
if ( F_204 ( V_18 -> V_553 ) )
...
char V_555 [ 16 ] ;
sprintf ( V_555 , L_61 , V_3 ) ;
V_18 -> V_552 [ V_3 ] = F_203 ( & V_126 -> V_152 , V_555 ) ;
if ( ! F_204 ( V_18 -> V_552 [ V_3 ] ) )
F_206 ( V_18 -> V_552 [ V_3 ] ) ;
}
V_534 = F_207 () ;
if ( V_534 )
F_190 ( V_18 , V_534 ) ;
...
V_429 = F_209 ( V_16 , V_396 , F_134 , V_556 , & V_557 ) ;
if ( ! V_429 )
return 0 ;
V_120:
if ( ! F_204 ( V_18 -> V_553 ) ) {
...
for ( V_3 = 0 ; V_3 < V_86 ; V_3 ++ ) {
if ( ! F_204 ( V_18 -> V_552 [ V_3 ] ) ) {
F_210 ( V_18 -> V_552 [ V_3 ] ) ;
F_211 ( V_18 -> V_552 [ V_3 ] ) ;
}
}
return V_429 ;
}
...
static int F_215 ( struct V_541 * V_126 , T_8 V_558 )
{
struct V_15 * V_16 = F_213 ( V_126 ) ;
if ( V_16 )
return F_216 ( V_16 , V_558 ) ;
else
return 0 ;
}
...
struct V_17 * V_18 = V_16 -> V_19 ;
T_3 V_560 ;
const char * V_561 , * V_562 ;
F_224 ( V_126 , V_563 , & V_560 ) ;
if ( V_560 == 0 )
V_561 = L_67 ;
else if ( V_560 == 0x01 )
V_561 = L_68 ;
...
V_562 , ( unsigned ) V_192 , V_16 -> V_86 ,
V_561 , ( V_399 & V_18 -> V_170 ) ? L_74 : L_75 ) ;
}
static int F_225 ( struct V_125 * V_126 ,
const struct V_564 * V_565 )
{
unsigned int V_492 = ( unsigned int ) V_565 -> V_566 ;
...
if ( V_429 )
return V_429 ;
V_429 = F_227 ( V_126 , 1 << V_567 , V_329 ) ;
if ( V_429 == - V_568 )
F_228 ( V_126 ) ;
if ( V_429 )
return V_429 ;
V_16 -> V_554 = F_229 ( V_126 ) ;
V_18 -> V_6 = V_16 -> V_554 [ V_567 ] ;
V_429 = F_219 ( V_126 ) ;
if ( V_429 )
return V_429 ;
V_429 = F_188 ( V_18 , & V_126 -> V_152 ) ;
...
F_230 ( V_21 , V_567 , - 1 , L_76 ) ;
F_230 ( V_21 , V_567 , V_210 , L_77 ) ;
}
V_429 = F_187 ( V_16 ) ;
if ( V_429 )
return V_429 ;
if ( V_569 && F_231 ( V_126 ) == 0 )
V_18 -> V_170 |= V_399 ;
F_37 ( V_126 , 0x68 ) ;
F_223 ( V_16 ) ;
F_232 ( V_126 ) ;
F_233 ( V_126 ) ;
return F_209 ( V_16 , V_126 -> V_396 , F_134 , V_556 ,
F_25 ( V_18 ) ? & V_570 : & V_557 ) ;
}
