...
T_12 T_7 * V_420 = V_411 -> V_31 ;
for ( V_41 = 0 ; V_41 < V_193 ; V_41 ++ ) {
if ( F_170 ( V_420 , V_405 [ V_41 ] , V_412 [ V_41 ] ) ) {
F_104 ( V_8 , V_10 ) ;
V_413 = - V_369 ;
goto V_417;
}
...
case V_370 :
return F_178 ( V_8 , V_391 ) ;
case V_372 :
return F_181 ( V_8 , V_391 ) ;
default:
return - V_421 ;
}
}
...
V_92 , V_216 ) ;
V_10 -> V_84 . V_85 [ 1 ] = V_422 ;
V_10 -> V_201 = NULL ;
F_37 ( V_8 , V_10 ) ;
return 0 ;
}
static int F_103 ( struct V_9 * V_10 , T_4 V_154 , struct V_1 * V_8 ,
void * V_405 , T_2 V_423 , T_4 V_424 , unsigned char * V_44 ,
int V_271 )
{
int V_425 = V_289 ;
struct V_9 * V_63 ;
...
V_10 -> V_84 . V_85 [ 6 ] = ( V_423 >> 24 ) & 0xFF ;
V_10 -> V_84 . V_85 [ 7 ] = ( V_423 >> 16 ) & 0xFF ;
V_10 -> V_84 . V_85 [ 8 ] = ( V_423 >> 8 ) & 0xFF ;
V_10 -> V_84 . V_85 [ 9 ] = V_423 & 0xFF ;
break;
case V_426 :
V_10 -> V_84 . V_279 = 12 ;
V_10 -> V_84 . Type . V_280 = V_281 ;
...
V_10 -> V_84 . V_85 [ 6 ] = V_427 ;
V_10 -> V_84 . V_85 [ 7 ] = ( V_423 >> 8 ) & 0xFF ;
V_10 -> V_84 . V_85 [ 8 ] = V_423 & 0xFF ;
break;
case V_325 :
V_10 -> V_84 . V_279 = 6 ;
V_10 -> V_84 . Type . V_280 = V_281 ;
...
if ( F_93 ( V_8 -> V_15 , V_10 , V_405 , V_423 , V_425 ) )
return - 1 ;
return 0 ;
}
static void T_13 * F_183 ( T_14 V_431 , T_14 V_423 )
{
T_14 V_432 = ( ( T_14 ) V_431 ) & V_433 ;
T_14 V_434 = ( ( T_14 ) V_431 ) - V_432 ;
void T_13 * V_435 = F_184 ( V_432 ,
V_434 + V_423 ) ;
return V_435 ? ( V_435 + V_434 ) : NULL ;
}
...
F_21 ( & V_8 -> V_50 , V_49 ) ;
while ( ! F_41 ( & V_8 -> V_90 ) ) {
V_10 = F_185 ( V_8 -> V_90 . V_436 , struct V_9 , V_61 ) ;
if ( ( V_8 -> V_67 . V_437 ( V_8 ) ) ) {
...
F_25 ( & V_8 -> V_340 , V_10 ) ;
V_8 -> V_37 ++ ;
if ( V_8 -> V_37 > V_8 -> V_438 )
V_8 -> V_438 = V_8 -> V_37 ;
F_22 ( & V_8 -> V_50 , V_49 ) ;
V_8 -> V_67 . V_439 ( V_8 , V_10 ) ;
F_21 ( & V_8 -> V_50 , V_49 ) ;
}
F_22 ( & V_8 -> V_50 , V_49 ) ;
}
...
{
return V_8 -> V_67 . V_440 ( V_8 ) ;
}
static inline long F_188 ( struct V_1 * V_8 )
{
return ( V_8 -> V_67 . V_440 ( V_8 ) == 0 ) ||
( V_8 -> V_441 == 0 ) ;
}
static inline int F_189 ( struct V_1 * V_8 , T_3 V_442 ,
T_3 V_443 )
{
if ( F_28 ( V_442 >= V_8 -> V_130 ) ) {
F_5 ( & V_8 -> V_15 -> V_16 , L_142 , V_443 ) ;
return 1 ;
}
return 0 ;
}
...
struct V_9 * V_10 ;
V_442 = F_192 ( V_443 ) ;
if ( ! F_189 ( V_8 , V_442 , V_443 ) ) {
V_10 = V_8 -> V_355 + V_442 ;
F_158 ( V_10 ) ;
}
}
...
static struct V_1 * F_199 ( T_4 * V_445 )
{
return F_200 ( ( V_445 - * V_445 ) , struct V_1 , V_62 [ 0 ] ) ;
}
static T_15 F_201 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_199 ( V_445 ) ;
T_4 V_62 = * ( T_4 * ) V_445 ;
T_3 V_443 ;
if ( F_198 ( V_8 ) )
return V_446 ;
...
V_8 -> V_447 = F_202 () ;
while ( F_187 ( V_8 ) ) {
V_443 = F_186 ( V_8 , V_62 ) ;
while ( V_443 != V_72 )
V_443 = F_27 ( V_8 , V_62 ) ;
}
return V_448 ;
}
static T_15 F_203 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_199 ( V_445 ) ;
T_3 V_443 ;
T_4 V_62 = * ( T_4 * ) V_445 ;
...
static T_15 F_204 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_199 ( ( T_4 * ) V_445 ) ;
T_3 V_443 ;
T_4 V_62 = * ( T_4 * ) V_445 ;
if ( F_188 ( V_8 ) )
return V_446 ;
...
static T_15 F_205 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_199 ( V_445 ) ;
T_3 V_443 ;
T_4 V_62 = * ( T_4 * ) V_445 ;
...
static int F_206 ( struct V_192 * V_15 , unsigned char V_449 ,
unsigned char type )
{
struct V_450 {
struct V_451 V_452 ;
...
struct V_450 * V_154 ;
static const T_2 V_456 = sizeof( * V_154 ) +
sizeof( V_154 -> V_455 ) ;
V_196 V_457 ;
T_16 V_458 , V_332 ;
void T_13 * V_459 ;
...
if ( V_459 == NULL )
return - V_132 ;
V_365 = F_208 ( V_15 , F_209 ( 32 ) ) ;
if ( V_365 ) {
F_210 ( V_459 ) ;
return - V_132 ;
}
V_154 = F_162 ( V_15 , V_456 , & V_457 ) ;
if ( V_154 == NULL ) {
F_210 ( V_459 ) ;
return - V_132 ;
}
...
V_154 -> V_452 . V_77 = 0 ;
V_154 -> V_452 . V_144 = 0 ;
V_154 -> V_452 . V_274 . V_147 = V_458 ;
V_154 -> V_452 . V_274 . V_148 = 0 ;
memset ( & V_154 -> V_452 . V_250 . V_273 , 0 , 8 ) ;
V_154 -> V_84 . V_279 = 16 ;
V_154 -> V_84 . Type . Type = V_216 ;
V_154 -> V_84 . Type . V_280 = V_460 ;
V_154 -> V_84 . Type . V_284 = V_289 ;
V_154 -> V_84 . V_277 = 0 ;
V_154 -> V_84 . V_85 [ 0 ] = V_449 ;
V_154 -> V_84 . V_85 [ 1 ] = type ;
memset ( & V_154 -> V_84 . V_85 [ 2 ] , 0 , 14 ) ;
V_154 -> V_455 . V_146 . V_147 = V_458 + sizeof( * V_154 ) ;
V_154 -> V_455 . V_146 . V_148 = 0 ;
V_154 -> V_455 . V_143 = sizeof( struct V_155 ) ;
F_211 ( V_458 , V_459 + V_461 ) ;
for ( V_41 = 0 ; V_41 < V_462 ; V_41 ++ ) {
V_332 = F_212 ( V_459 + V_463 ) ;
if ( ( V_332 & ~ F_195 ) == V_458 )
break;
F_99 ( V_464 ) ;
}
F_210 ( V_459 ) ;
...
void * T_13 V_459 , T_3 V_468 )
{
V_199 V_469 ;
int V_470 ;
if ( V_468 ) {
F_52 ( & V_15 -> V_16 , L_148 ) ;
F_211 ( V_468 , V_459 + V_471 ) ;
} else {
V_470 = F_214 ( V_15 , V_472 ) ;
if ( V_470 == 0 ) {
F_51 ( & V_15 -> V_16 ,
L_149
L_150 ) ;
...
F_215 ( V_15 , V_470 + V_473 , & V_469 ) ;
V_469 &= ~ V_474 ;
V_469 |= V_475 ;
F_216 ( V_15 , V_470 + V_473 , V_469 ) ;
F_99 ( 500 ) ;
V_469 &= ~ V_474 ;
V_469 |= V_476 ;
F_216 ( V_15 , V_470 + V_473 , V_469 ) ;
...
static void F_217 ( char * V_477 , int V_259 )
{
memset ( V_477 , 0 , V_259 ) ;
strncpy ( V_477 , V_17 L_152 V_403 , V_259 - 1 ) ;
}
static int F_218 ( struct V_478 T_13 * V_479 )
{
char * V_477 ;
int V_41 , V_423 = sizeof( V_479 -> V_477 ) ;
V_477 = F_81 ( V_423 , V_126 ) ;
if ( ! V_477 )
return - V_132 ;
F_217 ( V_477 , V_423 ) ;
for ( V_41 = 0 ; V_41 < V_423 ; V_41 ++ )
F_219 ( V_477 [ V_41 ] , & V_479 -> V_477 [ V_41 ] ) ;
F_59 ( V_477 ) ;
return 0 ;
}
static void F_220 ( struct V_478 T_13 * V_479 ,
unsigned char * V_480 )
{
int V_41 ;
for ( V_41 = 0 ; V_41 < sizeof( V_479 -> V_477 ) ; V_41 ++ )
V_480 [ V_41 ] = F_221 ( & V_479 -> V_477 [ V_41 ] ) ;
}
static int F_222 ( struct V_478 T_13 * V_479 )
{
char * V_480 , * V_481 ;
int V_209 , V_423 = sizeof( V_479 -> V_477 ) ;
V_481 = F_81 ( 2 * V_423 , V_126 ) ;
if ( ! V_481 )
return - V_132 ;
V_480 = V_481 + V_423 ;
F_217 ( V_481 , V_423 ) ;
F_220 ( V_479 , V_480 ) ;
V_209 = ! memcmp ( V_480 , V_481 , V_423 ) ;
F_59 ( V_481 ) ;
return V_209 ;
}
...
F_225 ( V_15 ) ;
F_226 ( V_15 ) ;
V_209 = F_227 ( V_15 , & V_485 ) ;
if ( V_209 )
return V_209 ;
V_459 = F_183 ( V_485 , 0x250 ) ;
if ( ! V_459 )
return - V_132 ;
V_209 = F_228 ( V_15 , V_459 , & V_483 ,
& V_484 , & V_482 ) ;
if ( V_209 )
goto V_488;
V_479 = F_183 ( F_229 ( V_15 ,
V_484 ) + V_482 , sizeof( * V_479 ) ) ;
if ( ! V_479 ) {
V_209 = - V_132 ;
goto V_488;
}
...
static void F_233 ( struct V_28 * V_16 , struct V_478 * V_496 )
{
#ifdef F_234
int V_41 ;
char V_497 [ 17 ] ;
...
V_497 [ V_41 ] = F_221 ( & ( V_496 -> V_498 [ V_41 ] ) ) ;
V_497 [ 4 ] = '\0' ;
F_52 ( V_16 , L_167 , V_497 ) ;
F_52 ( V_16 , L_168 , F_212 ( & ( V_496 -> V_499 ) ) ) ;
F_52 ( V_16 , L_169 ,
F_212 ( & ( V_496 -> V_500 ) ) ) ;
F_52 ( V_16 , L_170 ,
F_212 ( & ( V_496 -> V_501 ) ) ) ;
F_52 ( V_16 , L_171 ,
F_212 ( & ( V_496 -> V_502 . V_503 ) ) ) ;
F_52 ( V_16 , L_172 ,
F_212 ( & ( V_496 -> V_502 . V_504 ) ) ) ;
F_52 ( V_16 , L_173 ,
F_212 ( & ( V_496 -> V_502 . V_505 ) ) ) ;
F_52 ( V_16 , L_174 ,
F_212 ( & ( V_496 -> V_506 ) ) ) ;
F_52 ( V_16 , L_175 , F_212 ( & ( V_496 -> V_507 ) ) ) ;
for ( V_41 = 0 ; V_41 < 16 ; V_41 ++ )
V_497 [ V_41 ] = F_221 ( & ( V_496 -> V_508 [ V_41 ] ) ) ;
V_497 [ 16 ] = '\0' ;
F_52 ( V_16 , L_176 , V_497 ) ;
F_52 ( V_16 , L_177 ,
F_212 ( & ( V_496 -> V_509 ) ) ) ;
#endif
}
static int F_235 ( struct V_192 * V_15 , unsigned long V_510 )
{
int V_41 , V_511 , V_512 , V_513 ;
if ( V_510 == V_514 )
return 0 ;
V_511 = 0 ;
for ( V_41 = 0 ; V_41 < V_515 ; V_41 ++ ) {
V_513 = F_236 ( V_15 , V_41 ) & V_516 ;
if ( V_513 == V_517 )
V_511 += 4 ;
else {
V_512 = F_236 ( V_15 , V_41 ) &
V_518 ;
switch ( V_512 ) {
case V_519 :
case V_520 :
...
for ( V_41 = 0 ; V_41 < V_524 ; V_41 ++ ) {
V_523 [ V_41 ] . V_525 = 0 ;
V_523 [ V_41 ] . V_109 = V_41 ;
}
if ( ( V_8 -> V_40 == 0x40700E11 ) || ( V_8 -> V_40 == 0x40800E11 ) ||
( V_8 -> V_40 == 0x40820E11 ) || ( V_8 -> V_40 == 0x40830E11 ) )
goto V_526;
if ( F_214 ( V_8 -> V_15 , V_527 ) ) {
F_52 ( & V_8 -> V_15 -> V_16 , L_179 ) ;
V_365 = F_239 ( V_8 -> V_15 , V_523 ,
V_524 ) ;
if ( ! V_365 ) {
for ( V_41 = 0 ; V_41 < V_524 ; V_41 ++ )
V_8 -> V_315 [ V_41 ] = V_523 [ V_41 ] . V_525 ;
V_8 -> V_78 = 1 ;
return;
}
if ( V_365 > 0 ) {
...
V_530 = V_15 -> V_532 ;
V_531 = V_15 -> V_533 ;
* V_40 = ( ( V_531 << 16 ) & 0xffff0000 ) |
V_530 ;
for ( V_41 = 0 ; V_41 < F_14 ( V_534 ) ; V_41 ++ )
if ( * V_40 == V_534 [ V_41 ] . V_40 )
return V_41 ;
if ( ( V_530 != V_535 &&
V_530 != V_536 ) ||
! V_537 ) {
...
int V_41 ;
for ( V_41 = 0 ; V_41 < V_515 ; V_41 ++ )
if ( F_236 ( V_15 , V_41 ) & V_539 ) {
* V_538 = F_229 ( V_15 , V_41 ) ;
...
static int F_232 ( struct V_192 * V_15 , void T_13 * V_459 ,
int V_540 )
{
int V_41 , V_541 ;
T_3 V_542 ;
...
V_541 = V_544 ;
for ( V_41 = 0 ; V_41 < V_541 ; V_41 ++ ) {
V_542 = F_212 ( V_459 + V_545 ) ;
if ( V_540 ) {
if ( V_542 == V_546 )
return 0 ;
} else {
...
static int F_228 ( struct V_192 * V_15 , void T_13 * V_459 ,
T_3 * V_483 , T_5 * V_484 ,
T_5 * V_482 )
{
* V_483 = F_212 ( V_459 + V_548 ) ;
* V_482 = F_212 ( V_459 + V_549 ) ;
* V_483 &= ( T_3 ) 0x0000ffff ;
* V_484 = F_235 ( V_15 , * V_483 ) ;
if ( * V_484 == - 1 ) {
F_5 ( & V_15 -> V_16 , L_190 ) ;
return - V_52 ;
}
...
T_3 V_550 ;
int V_209 ;
V_209 = F_228 ( V_8 -> V_15 , V_8 -> V_459 , & V_483 ,
& V_484 , & V_482 ) ;
if ( V_209 )
return V_209 ;
V_8 -> V_479 = F_183 ( F_229 ( V_8 -> V_15 ,
V_484 ) + V_482 , sizeof( * V_8 -> V_479 ) ) ;
if ( ! V_8 -> V_479 )
return - V_132 ;
V_209 = F_218 ( V_8 -> V_479 ) ;
if ( V_209 )
return V_209 ;
V_550 = F_212 ( & V_8 -> V_479 -> V_551 ) ;
V_8 -> V_552 = F_183 ( F_229 ( V_8 -> V_15 ,
V_484 ) + V_482 + V_550 ,
sizeof( * V_8 -> V_552 ) ) ;
if ( ! V_8 -> V_552 )
return - V_132 ;
...
{
V_8 -> V_73 = F_212 ( & ( V_8 -> V_479 -> V_553 ) ) ;
if ( V_444 && V_8 -> V_73 > 32 )
V_8 -> V_73 = 32 ;
if ( V_8 -> V_73 < 16 ) {
...
V_8 -> V_266 = F_212 ( & ( V_8 -> V_479 -> V_554 ) ) ;
V_8 -> V_139 = 31 ;
if ( V_8 -> V_266 > 512 ) {
V_8 -> V_139 = 32 ;
...
V_8 -> V_346 = F_212 ( & ( V_8 -> V_479 -> V_346 ) ) ;
}
static inline bool F_244 ( struct V_1 * V_8 )
{
if ( ! F_245 ( V_8 -> V_479 -> V_498 , L_194 , 4 ) ) {
...
#ifdef F_247
T_3 V_555 ;
V_555 = F_212 ( & ( V_8 -> V_479 -> V_556 ) ) ;
V_555 |= 0x100 ;
F_211 ( V_555 , & ( V_8 -> V_479 -> V_556 ) ) ;
#endif
}
...
return;
V_557 = F_212 ( V_8 -> V_459 + V_558 ) ;
V_557 |= 0x8000 ;
F_211 ( V_557 , V_8 -> V_459 + V_558 ) ;
}
...
{
T_3 V_562 ;
V_562 = F_212 ( & ( V_8 -> V_479 -> V_500 ) ) ;
if ( ! ( V_562 & V_563 ) )
return - V_299 ;
V_8 -> V_73 = F_212 ( & ( V_8 -> V_479 -> V_506 ) ) ;
F_211 ( V_564 , & ( V_8 -> V_479 -> V_502 . V_503 ) ) ;
F_211 ( V_561 , V_8 -> V_459 + V_471 ) ;
F_249 ( V_8 ) ;
F_233 ( & V_8 -> V_15 -> V_16 , V_8 -> V_479 ) ;
if ( ! ( F_212 ( & ( V_8 -> V_479 -> V_501 ) ) & V_564 ) ) {
F_5 ( & V_8 -> V_15 -> V_16 ,
L_196 ) ;
return - V_52 ;
}
...
{
int V_565 , V_365 ;
V_565 = F_224 ( V_8 -> V_15 , & V_8 -> V_40 ) ;
if ( V_565 < 0 )
return - V_52 ;
V_8 -> V_566 = V_534 [ V_565 ] . V_566 ;
V_8 -> V_67 = * ( V_534 [ V_565 ] . V_67 ) ;
F_253 ( V_8 -> V_15 , V_567 |
V_568 | V_569 ) ;
V_365 = F_231 ( V_8 -> V_15 ) ;
if ( V_365 ) {
F_5 ( & V_8 -> V_15 -> V_16 , L_197 ) ;
return V_365 ;
}
F_254 ( V_8 -> V_15 ) ;
V_365 = F_255 ( V_8 -> V_15 , V_17 ) ;
if ( V_365 ) {
F_51 ( & V_8 -> V_15 -> V_16 ,
L_198 ) ;
return V_365 ;
...
F_237 ( V_8 ) ;
V_365 = F_227 ( V_8 -> V_15 , & V_8 -> V_485 ) ;
if ( V_365 )
goto V_570;
V_8 -> V_459 = F_183 ( V_8 -> V_485 , 0x250 ) ;
if ( ! V_8 -> V_459 ) {
V_365 = - V_132 ;
goto V_570;
}
V_365 = F_232 ( V_8 -> V_15 , V_8 -> V_459 , V_495 ) ;
if ( V_365 )
goto V_570;
V_365 = F_241 ( V_8 ) ;
if ( V_365 )
...
if ( V_8 -> V_316 == V_572 && V_8 -> V_78 ) {
for ( V_41 = 0 ; V_41 < V_524 ; V_41 ++ )
V_209 = F_267 ( V_8 -> V_315 [ V_41 ] , F_265 ,
0 , V_8 -> V_573 ,
& V_8 -> V_62 [ V_41 ] ) ;
} else {
if ( V_8 -> V_78 || V_8 -> V_529 ) {
V_209 = F_267 ( V_8 -> V_315 [ V_8 -> V_316 ] ,
F_265 , 0 , V_8 -> V_573 ,
& V_8 -> V_62 [ V_8 -> V_316 ] ) ;
} else {
V_209 = F_267 ( V_8 -> V_315 [ V_8 -> V_316 ] ,
F_266 , V_574 , V_8 -> V_573 ,
& V_8 -> V_62 [ V_8 -> V_316 ] ) ;
}
}
if ( V_209 ) {
F_51 ( & V_8 -> V_15 -> V_16 , L_204 ,
V_8 -> V_315 [ V_8 -> V_316 ] , V_8 -> V_573 ) ;
return - V_52 ;
}
return 0 ;
}
...
if ( F_232 ( V_8 -> V_15 , V_8 -> V_459 , V_494 ) ) {
F_5 ( & V_8 -> V_15 -> V_16 , L_207 ) ;
return - 1 ;
}
F_52 ( & V_8 -> V_15 -> V_16 , L_208 ) ;
if ( F_232 ( V_8 -> V_15 , V_8 -> V_459 , V_495 ) ) {
...
F_276 ( & V_8 -> V_50 ) ;
while ( ! F_41 ( V_61 ) ) {
V_10 = F_185 ( V_61 -> V_436 , struct V_9 , V_61 ) ;
V_10 -> V_11 -> V_23 = V_183 ;
F_158 ( V_10 ) ;
}
}
...
F_276 ( & V_580 ) ;
F_275 ( V_8 ) ;
V_8 -> V_67 . V_583 ( V_8 , V_584 ) ;
F_21 ( & V_8 -> V_50 , V_49 ) ;
V_8 -> V_202 = F_212 ( V_8 -> V_459 + V_545 ) ;
F_22 ( & V_8 -> V_50 , V_49 ) ;
...
static int F_282 ( void * V_589 )
{
struct V_1 * V_8 ;
unsigned long V_49 ;
while ( 1 ) {
struct V_60 * V_590 , * V_591 ;
F_283 ( V_89 ) ;
if ( F_284 () )
break;
F_21 ( & V_580 , V_49 ) ;
F_285 (this, tmp, &hpsa_ctlr_list) {
V_8 = F_185 ( V_590 , struct V_1 , V_582 ) ;
F_280 ( V_8 ) ;
}
F_22 ( & V_580 , V_49 ) ;
}
...
static int F_292 ( struct V_192 * V_15 , const struct V_593 * V_594 )
{
int V_595 , V_209 ;
struct V_1 * V_8 ;
int V_596 = 0 ;
...
if ( V_209 != 0 )
goto V_601;
sprintf ( V_8 -> V_573 , V_17 L_214 , V_597 ) ;
V_8 -> V_18 = V_597 ;
V_597 ++ ;
...
V_8 -> V_573 , V_15 -> V_28 ,
V_8 -> V_315 [ V_8 -> V_316 ] , V_595 ? L_202 : L_217 ) ;
if ( F_261 ( V_8 ) )
goto V_603;
if ( F_80 ( V_8 ) )
goto V_603;
...
F_52 ( & V_8 -> V_15 -> V_16 ,
L_221 ) ;
V_8 -> V_67 . V_583 ( V_8 , V_605 ) ;
F_99 ( 10000 ) ;
V_8 -> V_67 . V_583 ( V_8 , V_584 ) ;
V_209 = F_222 ( V_8 -> V_479 ) ;
if ( V_209 )
F_52 ( & V_8 -> V_15 -> V_16 ,
L_222 ) ;
F_274 ( V_8 ) ;
...
if ( F_103 ( V_10 , V_426 , V_8 , V_606 , 4 , 0 ,
V_92 , V_212 ) ) {
goto V_213;
}
F_98 ( V_8 , V_10 , V_145 ) ;
...
static void F_305 ( int V_608 [] , int V_609 ,
int V_610 , int * V_611 )
{
int V_41 , V_113 , V_612 , V_423 ;
#define F_306 4
#define F_307 8
for ( V_41 = 0 ; V_41 <= V_610 ; V_41 ++ ) {
V_423 = V_41 + F_306 ;
V_612 = V_609 ;
for ( V_113 = 0 ; V_113 < 8 ; V_113 ++ ) {
if ( V_608 [ V_113 ] >= V_423 ) {
V_612 = V_113 ;
break;
}
}
...
static void F_308 ( struct V_1 * V_8 , T_3 V_613 )
{
int V_41 ;
unsigned long V_614 ;
int V_615 [ 8 ] = { 5 , 6 , 8 , 10 , 12 , 20 , 28 , V_419 + 4 } ;
F_295 ( 28 > V_419 + 4 ) ;
memset ( V_8 -> V_64 , 0 , V_8 -> V_578 ) ;
V_615 [ 7 ] = V_419 + 4 ;
F_305 ( V_615 , F_14 ( V_615 ) ,
V_419 , V_8 -> V_75 ) ;
for ( V_41 = 0 ; V_41 < 8 ; V_41 ++ )
F_211 ( V_615 [ V_41 ] , & V_8 -> V_552 -> V_616 [ V_41 ] ) ;
F_211 ( V_8 -> V_73 , & V_8 -> V_552 -> V_617 ) ;
F_211 ( V_8 -> V_80 , & V_8 -> V_552 -> V_618 ) ;
F_211 ( 0 , & V_8 -> V_552 -> V_619 ) ;
F_211 ( 0 , & V_8 -> V_552 -> V_620 ) ;
for ( V_41 = 0 ; V_41 < V_8 -> V_80 ; V_41 ++ ) {
F_211 ( 0 , & V_8 -> V_552 -> V_621 [ V_41 ] . V_148 ) ;
F_211 ( V_8 -> V_579 +
( V_8 -> V_73 * sizeof( T_5 ) * V_41 ) ,
& V_8 -> V_552 -> V_621 [ V_41 ] . V_147 ) ;
}
F_211 ( V_39 | V_613 |
V_622 ,
& ( V_8 -> V_479 -> V_502 . V_503 ) ) ;
F_211 ( V_561 , V_8 -> V_459 + V_471 ) ;
F_249 ( V_8 ) ;
V_614 = F_212 ( & ( V_8 -> V_479 -> V_501 ) ) ;
if ( ! ( V_614 & V_39 ) ) {
...
if ( ! ( V_562 & V_624 ) )
return;
V_8 -> V_80 = V_8 -> V_78 ? V_524 : 1 ;
F_242 ( V_8 ) ;
V_8 -> V_578 = V_8 -> V_73 * sizeof( T_5 ) * V_8 -> V_80 ;
V_8 -> V_64 = F_162 ( V_8 -> V_15 , V_8 -> V_578 ,
& ( V_8 -> V_579 ) ) ;
for ( V_41 = 0 ; V_41 < V_8 -> V_80 ; V_41 ++ ) {
V_8 -> V_66 [ V_41 ] . V_69 = & V_8 -> V_64 [ V_8 -> V_73 * V_41 ] ;
V_8 -> V_66 [ V_41 ] . V_423 = V_8 -> V_73 ;
