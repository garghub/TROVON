...
if ( F_22 ( V_54 -> V_58 . V_59 ) == V_33 ||
V_54 -> V_59 -> type != V_60 )
continue;
V_8 = F_8 ( V_54 -> V_59 -> V_61 . V_11 -> V_8 ) ;
V_9 = F_19 ( V_8 ) ;
if ( V_9 ) {
F_5 ( _ ( L_13 ) ,
V_8 ) ;
...
V_11 = NULL ;
if ( line [ 0 ] == '#' ) {
if ( memcmp ( line + 2 , V_66 , strlen ( V_66 ) ) )
continue;
V_25 = strchr ( line + 2 + strlen ( V_66 ) , ' ' ) ;
if ( ! V_25 )
continue;
* V_25 ++ = 0 ;
...
continue;
if ( V_23 == V_67 ) {
V_11 = F_25 ( line + 2 + strlen ( V_66 ) ) ;
if ( ! V_11 ) {
F_20 ( 1 ) ;
goto V_68;
}
} else {
V_11 = F_9 ( line + 2 + strlen ( V_66 ) , 0 ) ;
if ( V_11 -> type == V_69 )
V_11 -> type = V_31 ;
}
if ( V_11 -> V_30 & V_24 ) {
...
} else if ( memcmp ( line , V_66 , strlen ( V_66 ) ) == 0 ) {
V_25 = strchr ( line + strlen ( V_66 ) , '=' ) ;
if ( ! V_25 )
continue;
* V_25 ++ = 0 ;
V_26 = strchr ( V_25 , '\n' ) ;
...
if ( V_23 == V_67 ) {
V_11 = F_25 ( line + strlen ( V_66 ) ) ;
if ( ! V_11 ) {
F_20 ( 1 ) ;
goto V_68;
}
} else {
V_11 = F_9 ( line + strlen ( V_66 ) , 0 ) ;
if ( V_11 -> type == V_69 )
V_11 -> type = V_35 ;
}
if ( V_11 -> V_30 & V_24 ) {
...
V_68:
if ( V_11 && F_26 ( V_11 ) ) {
struct V_10 * V_70 = F_27 ( F_28 ( V_11 ) ) ;
switch ( V_11 -> V_23 [ V_23 ] . V_28 ) {
case V_33 :
break;
case V_29 :
if ( V_70 -> V_23 [ V_23 ] . V_28 == V_32 ) {
F_1 ( L_17 , V_11 -> V_8 ) ;
V_70 -> V_30 &= ~ V_24 ;
}
break;
case V_32 :
if ( V_70 -> V_23 [ V_23 ] . V_28 != V_33 )
F_1 ( L_18 , V_11 -> V_8 ) ;
V_70 -> V_23 [ V_23 ] . V_40 = V_11 ;
break;
}
V_70 -> V_23 [ V_23 ] . V_28 = F_29 ( V_70 -> V_23 [ V_23 ] . V_28 , V_11 -> V_23 [ V_23 ] . V_28 ) ;
}
}
free ( line ) ;
fclose ( V_9 ) ;
...
case V_31 :
case V_27 :
if ( V_11 -> V_23 [ V_67 ] . V_28 != F_33 ( V_11 ) )
break;
if ( ! F_24 ( V_11 ) )
continue;
default:
if ( ! strcmp ( V_11 -> V_73 . V_40 , V_11 -> V_23 [ V_67 ] . V_40 ) )
continue;
break;
}
...
if ( V_11 -> V_58 == V_33 && ! V_62 )
V_11 -> V_30 &= ~ V_74 ;
switch ( V_11 -> type ) {
case V_36 :
case V_38 :
case V_39 :
if ( F_34 ( V_11 , V_11 -> V_23 [ V_67 ] . V_40 ) )
break;
V_11 -> V_30 &= ~ ( V_65 | V_74 ) ;
V_62 ++ ;
break;
...
fprintf ( V_75 , L_20 , V_66 , V_11 -> V_8 , V_76 ) ;
}
static void
...
case V_39 : {
const char * V_81 = L_23 ;
if ( V_76 [ 0 ] != '0' || ( V_76 [ 1 ] != 'x' && V_76 [ 1 ] != 'X' ) )
V_81 = L_26 ;
fprintf ( V_75 , L_27 ,
V_66 , V_11 -> V_8 , V_81 , V_76 ) ;
break;
}
case V_36 :
case V_38 :
...
fprintf ( V_75 , L_32 , V_66 , V_11 -> V_8 , ( char ) toupper ( * V_76 ) ) ;
}
...
V_100 = F_6 () ;
sprintf ( V_103 , L_37 , V_101 , V_100 ) ;
V_20 = getenv ( L_38 ) ;
if ( ! V_20 || ! * V_20 ) {
sprintf ( V_102 , L_39 , V_101 , ( int ) F_53 () ) ;
V_93 = fopen ( V_102 , L_35 ) ;
} else {
* V_102 = 0 ;
V_93 = fopen ( V_103 , L_35 ) ;
}
if ( ! V_93 )
return 1 ;
F_43 ( V_93 , & V_97 , NULL ) ;
...
F_65 (prop->expr, e, sym) {
if ( V_23 == V_131 ++ ) {
V_11 -> V_23 [ V_67 ] . V_28 = V_32 ;
V_129 -> V_23 [ V_67 ] . V_40 = V_11 ;
}
else {
V_11 -> V_23 [ V_67 ] . V_28 = V_33 ;
}
V_11 -> V_30 |= V_74 ;
V_11 -> V_30 &= ~ V_65 ;
}
