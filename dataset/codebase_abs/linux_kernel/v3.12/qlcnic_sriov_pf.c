...
int F_49 ( struct V_117 * V_29 , int V_40 )
{
struct V_1 * V_2 = F_50 ( V_29 ) ;
int V_8 ;
if ( F_51 ( V_118 , & V_2 -> V_93 ) )
return - V_119 ;
if ( V_40 == 0 )
V_8 = F_33 ( V_2 ) ;
else
...
static int F_54 ( struct V_128 * V_129 ,
struct V_6 * V_7 )
{
...
static int F_57 ( struct V_128 * V_153 ,
struct V_6 * V_7 )
{
...
F_55 ( V_2 , V_130 -> V_47 , V_130 -> V_52 ,
V_126 , V_143 ) ;
} else {
V_130 -> V_156 = 0 ;
}
...
static int F_65 ( struct V_73 * V_130 ,
struct V_6 * V_7 )
{
...
static int F_68 ( struct V_73 * V_130 ,
struct V_6 * V_7 )
{
...
static int F_74 ( struct V_73 * V_130 ,
struct V_6 * V_7 )
{
if ( V_7 -> V_11 . V_12 [ 1 ] != V_130 -> V_156 )
return - V_48 ;
...
static int F_77 ( struct V_128 * V_153 ,
struct V_6 * V_7 )
{
struct V_73 * V_130 = V_153 -> V_130 ;
struct V_1 * V_2 = V_130 -> V_2 ;
...
static int F_80 ( struct V_73 * V_130 ,
struct V_6 * V_7 )
{
if ( ( V_7 -> V_11 . V_12 [ 1 ] >> 16 ) != V_130 -> V_156 )
return - V_48 ;
...
static int F_87 ( struct V_128 * V_153 ,
struct V_6 * V_7 )
{
struct V_73 * V_130 = V_153 -> V_130 ;
struct V_1 * V_2 = V_130 -> V_2 ;
...
unsigned long V_74 ;
F_101 ( & V_182 -> V_184 , V_74 ) ;
F_102 ( V_33 , V_130 , V_129 ) ;
F_103 ( & V_182 -> V_184 , V_74 ) ;
return 0 ;
}
static void F_104 ( struct V_73 * V_130 )
{
struct V_1 * V_2 = V_130 -> V_2 ;
F_105 ( & V_130 -> V_185 ) ;
F_20 ( & V_130 -> V_186 ) ;
F_105 ( & V_130 -> V_183 ) ;
if ( F_106 ( V_187 , & V_130 -> V_93 ) ) {
F_99 ( V_2 , V_130 ) ;
F_98 ( V_2 , V_130 ) ;
}
...
if ( F_106 ( V_187 , & V_130 -> V_93 ) ) {
F_100 ( V_2 -> V_34 -> V_33 , V_130 ,
V_130 -> V_189 ) ;
F_28 ( V_187 , & V_130 -> V_93 ) ;
V_130 -> V_189 = NULL ;
}
}
static void F_107 ( struct V_190 * V_191 )
{
struct V_73 * V_130 ;
V_130 = F_108 ( V_191 , struct V_73 , V_86 ) ;
F_104 ( V_130 ) ;
return;
}
...
T_4 V_31 )
{
if ( F_106 ( V_118 , & V_130 -> V_2 -> V_93 ) )
return;
F_110 ( & V_130 -> V_86 , V_31 ) ;
F_111 ( V_33 -> V_84 . V_87 , & V_130 -> V_86 ) ;
}
...
{
struct V_32 * V_33 = V_2 -> V_34 -> V_33 ;
F_45 ( V_188 , & V_130 -> V_93 ) ;
F_28 ( V_136 , & V_130 -> V_93 ) ;
F_45 ( V_187 , & V_130 -> V_93 ) ;
V_130 -> V_189 = V_129 ;
F_109 ( V_33 , V_130 , F_107 ) ;
F_32 ( V_2 -> V_94 , L_27 ,
V_130 -> V_52 ) ;
}
...
( V_193 -> V_173 == V_174 ) &&
F_106 ( V_136 , & V_130 -> V_93 ) ) {
F_112 ( V_2 , V_129 , V_130 ) ;
return true ;
}
return false ;
}
...
struct V_46 * V_47 = V_130 -> V_47 ;
if ( ! F_115 ( V_136 , & V_130 -> V_93 ) ) {
F_28 ( V_188 , & V_130 -> V_93 ) ;
return;
}
if ( F_51 ( V_188 , & V_130 -> V_93 ) ) {
F_32 ( V_29 , L_28 ,
V_130 -> V_52 ) ;
return;
}
...
F_14 ( V_2 , V_34 -> V_52 ) ;
F_117 ( V_34 , V_194 , ( V_34 -> V_195 - 1 ) << 8 ) ;
}
...
int F_119 ( struct V_96 * V_94 , int V_130 , T_3 * V_120 )
{
struct V_1 * V_2 = F_120 ( V_94 ) ;
struct V_32 * V_33 = V_2 -> V_34 -> V_33 ;
int V_85 , V_40 ;
struct V_73 * V_55 ;
T_3 * V_197 ;
...
return - V_198 ;
V_40 = V_33 -> V_40 ;
if ( ! F_121 ( V_120 ) || V_130 >= V_40 )
return - V_48 ;
if ( F_122 ( V_2 -> V_199 , V_120 ) ) {
F_48 ( V_94 , L_31 ) ;
return - V_48 ;
}
for ( V_85 = 0 ; V_85 < V_40 ; V_85 ++ ) {
V_55 = & V_33 -> V_55 [ V_85 ] ;
if ( F_122 ( V_55 -> V_47 -> V_120 , V_120 ) ) {
F_48 ( V_94 ,
L_32 ,
V_85 ) ;
return - V_48 ;
...
int F_123 ( struct V_96 * V_94 , int V_130 , int V_201 )
{
struct V_1 * V_2 = F_120 ( V_94 ) ;
struct V_32 * V_33 = V_2 -> V_34 -> V_33 ;
struct V_73 * V_55 ;
...
int F_125 ( struct V_96 * V_94 , int V_130 ,
T_1 V_126 , T_3 V_204 )
{
struct V_1 * V_2 = F_120 ( V_94 ) ;
struct V_32 * V_33 = V_2 -> V_34 -> V_33 ;
...
V_208 -> V_126 = F_126 ( V_2 , V_47 , V_130 ) ;
...
int F_128 ( struct V_96 * V_94 , int V_130 , bool V_210 )
{
struct V_1 * V_2 = F_120 ( V_94 ) ;
struct V_32 * V_33 = V_2 -> V_34 -> V_33 ;
struct V_73 * V_55 ;
