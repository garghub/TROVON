...
if ( F_58 ( & V_58 -> V_64 ) )
V_76 = F_59 ( V_19 , V_89 -> V_61 ,
F_6 ,
V_24 ) ;
else if ( F_60 ( & V_58 -> V_64 ) )
V_76 = F_61 ( V_19 , F_6 ,
V_24 ) ;
else
V_76 = 0 ;
...
if ( V_41 )
break;
V_76 = F_66 ( V_89 -> V_123 , V_89 -> V_124 , - 1 ) ;
V_87 ++ ;
}
if ( V_41 && ! V_91 && ! F_63 ( & V_58 -> V_64 ) ) {
F_67 ( V_89 ) ;
V_91 = true ;
}
}
...
static int
F_68 ( const struct V_128 * V_129 , const char * V_130 , int V_131 )
{
#define F_69 \
...
static int F_71 ( char * V_130 , unsigned long * V_142 )
{
char * V_143 ;
unsigned long V_13 ;
unsigned long V_144 = F_72 ( V_145 , sizeof( T_5 ) ) ;
V_13 = strtoul ( V_130 , & V_143 , 0 ) ;
do {
if ( * V_143 )
break;
V_13 = F_73 ( V_13 , sizeof( T_5 ) ) ;
if ( ! V_13 || V_13 > V_144 )
break;
* V_142 = V_13 ;
return 0 ;
...
int F_74 ( const char * V_2 , struct V_57 * V_58 )
{
...
return - V_5 ;
strcpy ( V_15 , V_2 ) ;
V_146 = strtok_r ( ( char * ) V_15 , L_37 , & V_147 ) ;
V_140 = V_146 ? : ( char * ) V_15 ;
do {
if ( ! strncmp ( V_140 , L_38 , sizeof( L_38 ) ) ) {
if ( ! strtok_r ( NULL , L_37 , & V_147 ) ) {
V_58 -> V_148 = V_149 ;
V_16 = 0 ;
} else
F_5 ( L_39
...
break;
#ifdef F_75
} else if ( ! strncmp ( V_140 , L_41 , sizeof( L_41 ) ) ) {
const unsigned long V_150 = 8192 ;
V_16 = 0 ;
V_58 -> V_148 = V_151 ;
V_58 -> V_152 = V_150 ;
V_146 = strtok_r ( NULL , L_37 , & V_147 ) ;
if ( V_146 ) {
unsigned long V_13 = 0 ;
V_16 = F_71 ( V_146 , & V_13 ) ;
V_58 -> V_152 = V_13 ;
}
#endif
} else {
...
{
F_77 ( L_44 , V_58 -> V_148 ) ;
if ( V_58 -> V_148 == V_151 )
F_77 ( L_45 ,
V_58 -> V_152 ) ;
}
int F_78 ( const struct V_128 * V_129 ,
const char * V_2 ,
int V_131 )
{
...
int F_79 ( const struct V_128 * V_129 ,
const char * V_2 V_23 ,
int V_131 V_23 )
{
struct V_57 * V_58 = V_129 -> V_133 ;
...
int F_80 ( int V_81 , const char * * V_82 , const char * T_7 V_23 )
{
int V_76 = - V_5 ;
struct V_54 * V_89 ;
struct V_11 * V_12 = & V_154 ;
char V_155 [ V_156 ] ;
V_89 = F_81 () ;
if ( V_89 == NULL )
return - V_5 ;
V_12 -> V_44 = V_89 ;
V_81 = F_82 ( V_81 , V_82 , V_157 , V_158 ,
V_159 ) ;
if ( ! V_81 && F_63 ( & V_12 -> V_58 . V_64 ) )
F_83 ( V_158 , V_157 ) ;
if ( V_160 && ! V_12 -> V_58 . V_64 . V_161 ) {
F_25 ( L_47
L_48 ) ;
F_83 ( V_158 , V_157 ) ;
}
...
V_76 = F_88 ( & V_12 -> V_58 . V_64 ) ;
if ( V_76 ) {
F_89 ( & V_12 -> V_58 . V_64 , V_76 , V_155 , V_156 ) ;
F_23 ( L_57 , V_155 ) ;
}
V_76 = F_90 ( & V_12 -> V_58 . V_64 ) ;
if ( V_76 ) {
int V_167 = V_62 ;
F_89 ( & V_12 -> V_58 . V_64 , V_76 , V_155 , V_156 ) ;
F_25 ( L_57 , V_155 ) ;
...
V_76 = - V_5 ;
if ( F_91 ( V_89 , & V_12 -> V_58 . V_64 ) < 0 )
F_83 ( V_158 , V_157 ) ;
if ( V_12 -> V_58 . V_168 != V_169 )
V_12 -> V_58 . V_170 = V_12 -> V_58 . V_168 ;
if ( V_12 -> V_58 . V_171 != V_67 )
V_12 -> V_58 . V_172 = V_12 -> V_58 . V_171 ;
if ( V_12 -> V_58 . V_170 )
V_12 -> V_58 . V_172 = 0 ;
else if ( V_12 -> V_58 . V_172 ) {
V_12 -> V_58 . V_170 = V_12 -> V_58 . V_172 ;
} else {
F_25 ( L_58 ) ;
V_76 = - V_68 ;
goto V_173;
}
V_76 = F_43 ( & V_154 , V_81 , V_82 ) ;
F_92 ( V_89 ) ;
F_93 ( V_89 ) ;
V_173:
F_94 ( V_89 ) ;
