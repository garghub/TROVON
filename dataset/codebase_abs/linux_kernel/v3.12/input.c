...
{
static T_6 V_205 = F_127 ( 0 ) ;
struct V_7 * V_8 ;
V_8 = F_128 ( sizeof( struct V_7 ) , V_90 ) ;
if ( V_8 ) {
V_8 -> V_8 . type = & V_206 ;
V_8 -> V_8 . V_207 = & V_208 ;
F_129 ( & V_8 -> V_8 ) ;
...
F_133 ( & V_8 -> V_168 ) ;
F_134 ( & V_8 -> V_8 , L_56 ,
( unsigned long ) F_135 ( & V_205 ) - 1 ) ;
F_136 ( V_197 ) ;
}
return V_8 ;
}
static int F_137 ( struct V_193 * V_8 , void * V_210 , void * V_15 )
{
struct V_211 * V_212 = V_210 ;
return V_212 -> V_213 == V_15 ;
}
static void F_138 ( struct V_193 * V_8 , void * V_210 )
{
struct V_211 * V_212 = V_210 ;
struct V_7 * V_213 = V_212 -> V_213 ;
F_139 ( V_8 , L_57 ,
V_91 , F_125 ( & V_213 -> V_8 ) ) ;
F_140 ( V_213 ) ;
}
struct V_7 * F_141 ( struct V_193 * V_8 )
{
struct V_7 * V_213 ;
struct V_211 * V_212 ;
V_212 = F_142 ( F_138 ,
...
void F_148 ( struct V_7 * V_8 , unsigned int type , unsigned int V_1 )
{
switch ( type ) {
case V_32 :
F_60 ( V_1 , V_8 -> V_36 ) ;
...
static unsigned int F_150 ( struct V_7 * V_8 )
{
int V_216 ;
int V_123 ;
unsigned int V_28 ;
...
{
F_154 ( V_8 , V_220 , V_35 ) ;
F_154 ( V_8 , V_221 , V_222 ) ;
F_154 ( V_8 , ABS , abs ) ;
F_154 ( V_8 , V_223 , V_224 ) ;
F_154 ( V_8 , V_202 , V_76 ) ;
F_154 ( V_8 , V_203 , V_80 ) ;
F_154 ( V_8 , V_225 , V_226 ) ;
F_154 ( V_8 , V_227 , V_63 ) ;
}
...
F_52 ( V_8 ) ;
F_46 ( & V_164 ) ;
F_156 (handle, next, &dev->h_list, d_node)
V_19 -> V_24 -> V_229 ( V_19 ) ;
F_146 ( ! F_157 ( & V_8 -> V_209 ) ) ;
F_158 ( & V_8 -> V_14 ) ;
F_159 ( & V_8 -> V_168 ) ;
F_69 () ;
F_39 ( & V_164 ) ;
...
static void F_161 ( struct V_193 * V_8 , void * V_210 )
{
struct V_211 * V_212 = V_210 ;
struct V_7 * V_213 = V_212 -> V_213 ;
F_139 ( V_8 , L_59 ,
...
F_39 ( & V_164 ) ;
if ( V_8 -> V_215 ) {
F_139 ( V_8 -> V_8 . V_214 , L_63 ,
V_91 , F_125 ( & V_8 -> V_8 ) ) ;
F_144 ( V_8 -> V_8 . V_214 , V_212 ) ;
}
return 0 ;
V_235:
F_160 ( & V_8 -> V_8 ) ;
...
struct V_18 * V_19 , * V_228 ;
F_46 ( & V_164 ) ;
F_156 (handle, next, &handler->h_list, h_node)
V_24 -> V_229 ( V_19 ) ;
F_146 ( ! F_157 ( & V_24 -> V_209 ) ) ;
F_159 ( & V_24 -> V_168 ) ;
F_69 () ;
F_39 ( & V_164 ) ;
}
...
return error ;
if ( V_24 -> V_27 )
F_172 ( & V_19 -> V_236 , & V_8 -> V_209 ) ;
else
F_173 ( & V_19 -> V_236 , & V_8 -> V_209 ) ;
F_39 ( & V_8 -> V_98 ) ;
F_173 ( & V_19 -> V_237 , & V_24 -> V_209 ) ;
if ( V_24 -> V_102 )
V_24 -> V_102 ( V_19 ) ;
return 0 ;
}
