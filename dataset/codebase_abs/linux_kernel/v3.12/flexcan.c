...
V_4 -> V_160 = V_160 ;
V_4 -> V_161 = V_161 ;
V_4 -> V_199 = V_175 -> V_17 . V_200 ;
V_4 -> V_149 = V_149 ;
V_4 -> V_158 = F_82 ( & V_175 -> V_17 , L_24 ) ;
if ( F_73 ( V_4 -> V_158 ) )
V_4 -> V_158 = NULL ;
F_83 ( V_17 , & V_4 -> V_99 , F_36 , V_201 ) ;
F_84 ( V_175 , V_17 ) ;
F_85 ( V_17 , & V_175 -> V_17 ) ;
V_133 = F_66 ( V_17 ) ;
if ( V_133 ) {
...
{
struct V_16 * V_17 = F_90 ( V_175 ) ;
F_68 ( V_17 ) ;
F_88 ( V_17 ) ;
return 0 ;
}
static int F_91 ( struct V_203 * V_203 )
{
struct V_16 * V_17 = F_92 ( V_203 ) ;
struct V_3 * V_4 = F_12 ( V_17 ) ;
F_10 ( V_4 ) ;
if ( F_93 ( V_17 ) ) {
F_16 ( V_17 ) ;
...
static int F_95 ( struct V_203 * V_203 )
{
struct V_16 * V_17 = F_92 ( V_203 ) ;
struct V_3 * V_4 = F_12 ( V_17 ) ;
V_4 -> V_6 . V_68 = V_69 ;
