...
V_300 = 0xffff ;
if ( V_322 . type & 8 )
V_191 = F_120 ( V_2 , V_299 , V_300 ,
V_301 , & V_322 ) ;
else
V_191 = F_117 ( V_2 , V_299 , V_300 ,
V_301 , & V_322 ) ;
if ( V_191 != V_89 )
return V_191 ;
if ( V_319 == V_329 || V_319 == V_324 )
...
V_2 -> V_44 = V_2 -> V_30 ;
V_2 -> V_27 . type = V_200 ;
V_91 = F_121 ( V_2 , V_299 , V_318 , V_319 ,
V_320 , V_57 ) ;
if ( V_91 == V_89 ) {
V_2 -> V_30 = V_2 -> V_44 ;
F_4 ( V_2 ) ;
...
{
return F_147 ( V_2 , V_2 -> V_6 -> V_181 ) ;
}
static int F_150 ( struct V_1 * V_2 )
{
return F_147 ( V_2 , V_2 -> V_6 -> V_178 ) ;
}
...
if ( ! F_114 ( V_2 , V_2 -> V_22 . V_112 , V_2 -> V_27 . V_25 ) )
return F_25 ( V_2 , 0 ) ;
return V_89 ;
}
...
if ( ! F_114 ( V_2 , V_2 -> V_27 . V_112 , V_2 -> V_22 . V_25 ) )
return F_25 ( V_2 , 0 ) ;
return V_89 ;
}
static unsigned F_177 ( struct V_1 * V_2 )
{
unsigned V_72 ;
...
static int F_179 ( struct V_1 * V_2 , struct V_110 * V_111 ,
unsigned V_40 )
{
int V_91 = V_89 ;
switch ( V_40 ) {
...
break;
case V_405 :
V_91 = F_178 ( V_2 , V_111 , F_177 ( V_2 ) , true ) ;
break;
case V_406 :
V_91 = F_178 ( V_2 , V_111 , V_2 -> V_104 , true ) ;
break;
case V_407 :
V_2 -> V_392 . V_25 = 1 ;
...
goto V_393;
case V_410 :
V_91 = F_178 ( V_2 , V_111 , 2 , false ) ;
break;
case V_411 :
V_91 = F_178 ( V_2 , V_111 , F_177 ( V_2 ) , false ) ;
break;
case V_412 :
V_111 -> type = V_143 ;
V_111 -> V_25 = ( V_2 -> V_40 & V_132 ) ? 1 : V_2 -> V_104 ;
...
F_180 ( V_111 -> V_239 , V_111 -> V_25 , V_2 ) ;
break;
case V_415 :
...
int F_181 ( struct V_1 * V_2 , void * V_423 , int V_424 )
{
int V_91 = V_89 ;
int V_36 = V_2 -> V_36 ;
...
V_91 = F_179 ( V_2 , & V_2 -> V_22 , ( V_2 -> V_40 >> V_461 ) & V_462 ) ;
if ( V_91 != V_89 )
goto V_155;
V_91 = F_179 ( V_2 , & V_2 -> V_223 , ( V_2 -> V_40 >> V_463 ) & V_462 ) ;
if ( V_91 != V_89 )
goto V_155;
V_91 = F_179 ( V_2 , & V_2 -> V_27 , ( V_2 -> V_40 >> V_464 ) & V_462 ) ;
V_155:
...
static bool F_183 ( struct V_1 * V_2 )
{
...
if ( ! ( V_2 -> V_40 & V_132 ) )
F_46 += F_186 ( V_2 -> V_27 . V_25 ) * V_470 ;
...
if ( V_2 -> V_453 ) {
if ( V_2 -> V_40 & V_489 ) {
void (* F_46)( struct F_104 * ) = ( void * ) V_2 -> V_453 ;
V_91 = F_104 ( V_2 , F_46 ) ;
if ( V_91 != V_89 )
goto V_155;
goto F_78;
...
if ( V_2 -> V_40 & V_494 ) {
F_188 ( V_2 -> V_22 . type == V_143 || V_2 -> V_22 . type == V_174 ) ;
...
F_123 ( V_2 , V_148 , & V_2 -> V_22 ) ;
if ( ( V_2 -> V_40 & V_485 ) == V_496 )
F_123 ( V_2 , V_150 , & V_2 -> V_27 ) ;
if ( V_2 -> V_17 && ( V_2 -> V_40 & String ) ) {
unsigned int V_170 ;
