...
static void F_95 ( struct V_47 * V_48 , unsigned char V_2 )
{
if ( V_2 == V_42 ) {
...
int V_87 = 0 ;
F_73 ( & V_48 -> V_131 ) ;
V_48 -> V_131 . V_153 = F_53 ;
V_48 -> V_131 . V_25 = ( unsigned long ) V_48 ;
F_102 ( & V_48 -> V_134 ) ;
F_69 ( & V_48 -> V_129 ) ;
F_69 ( & V_48 -> V_72 ) ;
if ( V_48 -> V_51 == 0 )
...
static void F_104 ( struct V_186 * V_187 )
{
...
{
F_108 ( & V_48 -> V_187 , F_104 ) ;
}
struct V_47 * F_109 ( void )
{
...
F_11 ( V_95 != V_48 -> V_95 ) ;
for ( V_87 = 1 ; V_87 < V_88 ; V_87 ++ )
F_118 ( V_197 , V_196 + V_87 ) ;
F_97 ( V_48 ) ;
F_44 ( V_48 -> V_95 ) ;
V_48 -> V_95 = NULL ;
}
static void F_119 ( struct V_94 * V_95 , const unsigned char * V_198 ,
...
default:
F_120 ( 1 , L_29 ,
F_121 ( V_95 , V_117 ) , V_71 ) ;
break;
}
}
}
static T_3 F_122 ( struct V_94 * V_95 )
{
return 0 ;
}
...
static int F_125 ( struct V_94 * V_95 )
{
struct V_47 * V_48 ;
...
V_95 -> V_204 = 65536 ;
V_48 -> V_51 = 1 ;
return F_114 ( V_95 , V_48 ) ;
}
static void F_126 ( struct V_94 * V_95 )
{
struct V_47 * V_48 = V_95 -> V_200 ;
unsigned long V_71 ;
F_127 ( V_192 , & V_95 -> V_71 ) ;
F_25 ( & V_48 -> V_72 , V_71 ) ;
F_17 ( V_48 ) ;
if ( V_48 -> V_67 < V_92 ) {
F_35 ( V_48 ) ;
...
static T_3 F_129 ( struct V_94 * V_95 , struct V_205 * V_205 ,
const unsigned char * V_117 , T_5 V_206 )
{
int V_207 = F_112 ( V_95 ) ;
if ( V_207 >= V_206 )
return V_95 -> V_154 -> V_194 ( V_95 , V_117 , V_206 ) ;
F_113 ( V_192 , & V_95 -> V_71 ) ;
return - V_208 ;
}
static unsigned int F_130 ( struct V_94 * V_95 , struct V_205 * V_205 ,
T_6 * V_209 )
{
unsigned int V_210 = 0 ;
struct V_47 * V_48 = V_95 -> V_200 ;
F_131 ( V_205 , & V_95 -> V_211 , V_209 ) ;
F_131 ( V_205 , & V_95 -> V_212 , V_209 ) ;
if ( F_132 ( V_205 ) )
V_210 |= V_213 ;
if ( ! F_133 ( V_95 ) && F_112 ( V_95 ) > 0 )
V_210 |= V_214 | V_215 ;
if ( V_48 -> V_119 )
V_210 |= V_213 ;
return V_210 ;
}
static int F_134 ( struct V_94 * V_95 , struct V_47 * V_48 ,
struct V_216 * V_2 )
{
int V_217 = 0 ;
int V_218 = 0 ;
...
static int F_136 ( struct V_94 * V_95 , struct V_205 * V_205 ,
...
V_2 . V_78 = V_48 -> V_78 ;
V_2 . V_219 = 0 ;
if ( F_137 ( ( void * ) V_224 , & V_2 , sizeof( V_2 ) ) )
return - V_227 ;
return 0 ;
case V_228 :
if ( F_138 ( & V_2 , ( void * ) V_224 , sizeof( V_2 ) ) )
return - V_227 ;
return F_134 ( V_95 , V_48 , & V_2 ) ;
default:
return F_139 ( V_95 , V_205 , V_93 , V_224 ) ;
}
}
static int F_140 ( struct V_229 * V_90 )
{
F_8 ( L_31 , V_230 ) ;
F_141 ( V_90 ) ;
return 0 ;
}
static int F_142 ( struct V_229 * V_90 )
{
F_143 ( V_90 ) ;
return 0 ;
}
static struct V_231 * F_144 ( struct V_229 * V_90 )
{
return & ( (struct V_232 * ) F_145 ( V_90 ) ) -> V_233 ;
}
...
static void F_148 ( struct V_186 * V_187 )
{
struct V_232 * V_236 ;
struct V_7 * V_8 ;
...
static inline void F_151 ( struct V_232 * V_236 )
{
F_108 ( & V_236 -> V_187 , F_148 ) ;
}
static int F_152 ( struct V_237 * V_85 ,
struct V_229 * V_90 )
{
struct V_232 * V_236 = (struct V_232 * ) F_145 ( V_90 ) ;
struct V_7 * V_8 = V_236 -> V_8 ;
F_150 ( V_236 ) ;
F_153 ( & V_8 -> V_86 , V_85 ) ;
F_154 ( V_90 ) . V_238 ++ ;
F_154 ( V_90 ) . V_67 += V_85 -> V_4 ;
F_36 ( V_8 ) ;
V_90 -> V_239 = V_137 ;
F_151 ( V_236 ) ;
return V_240 ;
}
static void F_155 ( struct V_229 * V_90 )
{
F_156 ( & V_90 -> V_241 , L_32 ) ;
F_154 ( V_90 ) . V_242 ++ ;
}
...
F_159 ( V_85 , V_244 ) ;
memcpy ( F_160 ( V_85 , V_74 ) , V_243 , V_74 ) ;
V_85 -> V_241 = V_90 ;
V_85 -> V_246 = F_161 ( V_247 ) ;
F_162 ( V_85 ) ;
F_154 ( V_90 ) . V_248 ++ ;
F_154 ( V_90 ) . V_249 += V_74 ;
F_151 ( V_236 ) ;
return;
}
int F_163 ( struct V_229 * V_90 , int V_250 )
{
struct V_232 * V_236 = (struct V_232 * ) F_145 ( V_90 ) ;
...
static void F_164 ( struct V_229 * V_90 )
{
...
if ( ! V_8 -> V_90 )
return;
V_236 = (struct V_232 * ) F_145 ( V_8 -> V_90 ) ;
F_151 ( V_236 ) ;
}
static int F_165 ( struct V_7 * V_8 , struct V_267 * V_268 )
{
char * V_269 ;
int V_270 = 0 ;
struct V_229 * V_90 ;
...
if ( V_268 -> V_274 [ 0 ] != '\0' )
V_269 = V_268 -> V_274 ;
V_90 = F_168 ( sizeof( struct V_232 ) ,
V_269 ,
F_164 ) ;
if ( ! V_90 ) {
F_169 ( L_36 ) ;
...
static int F_171 ( struct V_7 * V_8 , T_1 V_99 )
{
T_1 V_9 [ 5 ] ;
struct V_128 * V_55 ;
int V_4 = 2 ;
...
static int F_172 ( struct V_110 * V_107 )
{
struct V_7 * V_8 = F_76 ( V_107 , struct V_7 , V_107 ) ;
if ( V_8 -> V_145 != V_147 )
return 0 ;
...
static void F_173 ( struct V_110 * V_107 , int V_278 )
{
struct V_7 * V_8 = F_76 ( V_107 , struct V_7 , V_107 ) ;
...
static int F_174 ( struct V_279 * V_280 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
...
if ( V_8 == NULL )
return - V_80 ;
V_195 = F_175 ( & V_8 -> V_107 , V_280 , V_95 ) ;
if ( V_195 ) {
if ( V_283 )
F_83 ( V_8 ) ;
return V_195 ;
...
static int F_176 ( struct V_94 * V_95 , struct V_205 * V_290 )
{
...
F_92 ( V_107 , V_95 ) ;
V_8 -> V_103 = 0 ;
F_113 ( V_291 , & V_107 -> V_71 ) ;
F_64 ( V_8 ) ;
return F_177 ( V_107 , V_95 , V_290 ) ;
}
static void F_178 ( struct V_94 * V_95 , struct V_205 * V_290 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_88 ( & V_8 -> V_151 ) ;
V_48 = V_8 -> V_48 ;
if ( F_179 ( & V_8 -> V_107 , V_95 , V_290 ) == 0 )
goto V_292;
F_48 ( V_8 ) ;
if ( F_180 ( V_291 , & V_8 -> V_107 . V_71 ) ) {
if ( F_181 ( V_95 ) )
F_182 ( & V_8 -> V_107 ) ;
}
F_183 ( & V_8 -> V_107 , V_95 ) ;
F_92 ( & V_8 -> V_107 , NULL ) ;
V_292:
F_83 ( V_8 ) ;
F_83 ( V_48 -> V_8 [ 0 ] ) ;
...
static int F_186 ( struct V_94 * V_95 , const unsigned char * V_117 ,
int V_4 )
{
int V_293 ;
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return - V_203 ;
V_293 = F_187 ( V_8 -> V_77 , V_117 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_293 ;
}
...
static int F_189 ( struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return - V_203 ;
...
static void F_190 ( struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return;
...
static void F_191 ( struct V_94 * V_95 , int V_295 )
{
}
...
static int F_194 ( struct V_94 * V_95 ,
unsigned int V_93 , unsigned long V_224 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
struct V_267 V_268 ;
...
switch ( V_93 ) {
case V_298 :
if ( F_138 ( & V_268 , ( void T_4 * ) V_224 , sizeof( V_268 ) ) )
return - V_227 ;
V_268 . V_274 [ V_276 - 1 ] = '\0' ;
F_86 ( & V_8 -> V_151 ) ;
V_281 = F_165 ( V_8 , & V_268 ) ;
F_88 ( & V_8 -> V_151 ) ;
if ( F_137 ( ( void T_4 * ) V_224 , & V_268 , sizeof( V_268 ) ) )
return - V_227 ;
return V_281 ;
case V_299 :
if ( ! F_166 ( V_271 ) )
...
static void F_195 ( struct V_94 * V_95 , struct V_301 * V_302 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return;
F_196 ( & V_95 -> V_104 , V_302 ) ;
}
...
static int F_199 ( struct V_94 * V_95 , int V_145 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
int V_304 = 0 ;
if ( V_8 -> V_145 == V_146 )
