...
V_57 -> V_23 . V_68 = V_69 ;
V_57 -> V_23 . V_24 = V_70 ;
memcpy ( V_57 -> V_45 , V_55 -> V_71 -> V_72 , V_73 ) ;
memcpy ( V_58 , V_57 , sizeof( * V_58 ) ) ;
if ( V_61 & 1 )
V_62 = V_74 ;
V_57 -> V_16 = V_17 | V_62 ;
V_58 -> V_16 = V_62 ;
V_21 = F_34 ( 2 , & V_52 -> V_75 ) ;
...
static bool F_38 ( struct V_1 * V_6 , int V_76 ,
struct V_40 * V_41 )
{
struct V_10 * V_11 ;
T_1 V_77 = ( T_1 ) F_39 ( & V_41 -> V_78 ) ;
if ( F_33 ( V_6 , V_76 ) < 0 )
return false ;
V_11 = (struct V_10 * ) V_6 -> V_15 ;
V_11 -> V_23 . V_68 = V_69 ;
V_11 -> V_23 . V_24 = V_25 ;
V_11 -> V_23 . V_67 = V_79 ;
memcpy ( V_11 -> V_80 , V_41 -> V_45 , V_73 ) ;
V_11 -> V_77 = V_77 ;
return true ;
}
...
struct V_40 * V_41 )
{
T_3 V_81 = sizeof( struct V_10 ) ;
return F_38 ( V_6 , V_81 , V_41 ) ;
}
...
V_45 ) )
goto V_46;
V_84 = (struct V_83 * ) V_6 -> V_15 ;
V_84 -> V_85 . V_23 . V_24 = V_86 ;
memcpy ( V_84 -> V_87 , V_55 -> V_71 -> V_72 ,
V_73 ) ;
V_84 -> V_88 = V_82 ;
V_84 -> V_89 = 0 ;
V_43 = true ;
...
int V_82 )
{
struct V_90 * V_90 = (struct V_90 * ) V_6 -> V_15 ;
struct V_10 * V_11 ;
struct V_40 * V_41 ;
struct V_91 * V_92 ;
int V_61 = V_6 -> V_19 ;
...
V_41 = F_45 ( V_38 , V_90 -> V_97 ,
V_90 -> V_95 ) ;
V_96:
V_92 = F_46 ( V_38 , V_41 , NULL ) ;
if ( ! V_92 )
goto V_46;
switch ( V_24 ) {
case V_25 :
if ( ! F_40 ( V_6 , V_41 ) )
goto V_46;
V_94 = sizeof( struct V_10 ) ;
break;
case V_86 :
if ( ! F_41 ( V_38 , V_6 , V_41 ,
V_82 ) )
goto V_46;
V_94 = sizeof( struct V_83 ) ;
break;
default:
goto V_46;
}
V_90 = (struct V_90 * ) ( V_6 -> V_15 + V_94 ) ;
V_11 = (struct V_10 * ) V_6 -> V_15 ;
if ( F_47 ( V_38 , V_90 -> V_95 ) )
V_11 -> V_77 = V_11 -> V_77 - 1 ;
V_93 = V_92 -> V_98 -> V_71 -> V_99 ;
if ( V_24 == V_25 &&
F_39 ( & V_38 -> V_100 ) &&
V_61 + sizeof( * V_11 ) > V_93 ) {
V_11 -> V_23 . V_67 ++ ;
V_43 = F_28 ( V_6 , V_38 ,
V_92 -> V_98 ,
V_92 -> V_101 ) ;
