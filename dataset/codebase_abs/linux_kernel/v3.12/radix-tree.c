...
F_31 () ;
V_23 = & F_21 ( V_24 ) ;
while ( V_23 -> V_25 < F_32 ( V_23 -> V_26 ) ) {
F_33 () ;
V_8 = F_22 ( V_27 , V_5 ) ;
if ( V_8 == NULL )
goto V_35;
...
static inline unsigned long F_36 ( unsigned int V_36 )
{
return V_37 [ V_36 ] ;
}
static int F_37 ( struct V_3 * V_4 , unsigned long V_38 )
{
struct V_7 * V_8 ;
struct V_7 * V_39 ;
unsigned int V_36 ;
...
V_39 -> V_42 = V_8 ;
if ( V_8 ) {
F_38 ( V_8 -> V_32 [ V_10 ] , V_39 ) ;
V_8 -> V_33 ++ ;
} else
F_38 ( V_4 -> V_40 , F_1 ( V_39 ) ) ;
}
V_10 = ( V_38 >> V_44 ) & V_46 ;
V_8 = V_39 ;
V_39 = V_8 -> V_32 [ V_10 ] ;
...
{
return ( void * * ) F_40 ( V_4 , V_38 , 1 ) ;
}
void * F_43 ( struct V_3 * V_4 , unsigned long V_38 )
{
return F_40 ( V_4 , V_38 , 0 ) ;
}
...
unsigned long F_48 ( struct V_3 * V_4 ,
...
unsigned long F_51 ( struct V_3 * V_4 ,
unsigned long V_38 , unsigned long V_69 )
{
unsigned long V_30 ;
for ( V_30 = 0 ; V_30 < V_69 ; V_30 ++ ) {
...
static unsigned long F_59 ( struct V_7 * V_39 , void * V_43 ,
...
unsigned long F_60 ( struct V_3 * V_4 , void * V_43 )
{
struct V_7 * V_8 ;
unsigned long V_76 ;
...
void * F_65 ( struct V_3 * V_4 , unsigned long V_38 )
{
struct V_7 * V_8 = NULL ;
struct V_7 * V_39 = NULL ;
struct V_7 * V_78 ;
...
int F_66 ( struct V_3 * V_4 , unsigned int V_9 )
{
return F_13 ( V_4 , V_9 ) ;
}
static void
...
static T_3 unsigned long F_68 ( unsigned int V_36 )
{
...
{
unsigned int V_30 ;
for ( V_30 = 0 ; V_30 < F_32 ( V_37 ) ; V_30 ++ )
V_37 [ V_30 ] = F_68 ( V_30 ) ;
}
