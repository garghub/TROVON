...
F_21 ( & V_2 -> V_70 ) ;
time = F_62 ( & V_136 ) - F_62 ( & V_135 ) ;
V_132 = ( V_131 - V_130 ) * V_137 ;
return sprintf ( V_39 , L_12 ,
( unsigned long long ) F_63 ( V_132 * V_138 , time ) ) ;
}
...
static T_6 F_66 ( struct V_4 * V_104 ,
struct V_126 * V_127 ,
const char * V_39 , T_2 V_139 )
{
struct V_128 * V_129 = F_58 ( V_127 ) ;
struct V_36 * V_136 = F_55 ( V_104 ) ;
unsigned long V_77 ;
int V_42 ;
V_42 = F_67 ( V_39 , 10 , & V_77 ) ;
if ( V_42 )
return V_42 ;
if ( V_77 < V_140 )
return - V_48 ;
...
static int F_68 ( struct V_36 * V_2 ,
struct V_141 * V_142 ,
struct V_143 * V_144 )
{
struct V_4 * V_104 = & V_2 -> V_84 -> V_104 ;
struct V_128 * V_145 = V_2 -> V_145 ;
int V_6 ;
while ( V_142 -> V_146 ) {
F_69 ( & V_145 -> V_147 . V_129 ) ;
V_145 -> V_147 . V_129 . V_148 = V_142 -> V_146 ;
V_145 -> V_147 . V_129 . V_149 = V_150 ;
V_145 -> V_147 . V_151 = V_142 -> V_151 ;
V_145 -> V_90 = V_142 -> V_90 ;
V_6 = F_70 ( V_104 , & V_145 -> V_147 ) ;
if ( V_6 ) {
V_145 -> V_147 . V_129 . V_148 = NULL ;
goto error;
}
V_145 ++ ;
V_142 ++ ;
...
while ( V_144 -> V_146 ) {
F_69 ( & V_145 -> V_147 . V_129 ) ;
V_145 -> V_147 . V_129 . V_148 = V_144 -> V_146 ;
V_145 -> V_147 . V_129 . V_149 = V_150 | V_152 ;
V_145 -> V_147 . V_151 = V_144 -> V_151 ;
V_145 -> V_147 . V_153 = V_144 -> V_154 ;
V_145 -> V_90 = V_144 -> V_90 ;
V_6 = F_70 ( V_104 , & V_145 -> V_147 ) ;
if ( V_6 ) {
V_145 -> V_147 . V_129 . V_148 = NULL ;
goto error;
...
V_6 = F_70 ( V_104 , & V_155 . V_147 ) ;
if ( V_6 )
goto error;
V_6 = F_70 ( V_104 , & V_156 . V_147 ) ;
return V_6 ;
error:
F_25 ( V_2 ) ;
return V_6 ;
...
static T_6 F_72 ( struct V_4 * V_104 ,
struct V_126 * V_127 ,
char * V_39 )
{
struct V_128 * V_129 = F_58 ( V_127 ) ;
...
{
int V_75 ;
for ( V_75 = 0 ; V_75 < V_157 ; V_75 ++ ) {
if ( ! V_2 -> V_145 [ V_75 ] . V_147 . V_129 . V_148 )
continue;
F_73 ( & V_2 -> V_84 -> V_104 ,
& V_2 -> V_145 [ V_75 ] . V_147 ) ;
}
F_73 ( & V_2 -> V_84 -> V_104 ,
& V_155 . V_147 ) ;
F_73 ( & V_2 -> V_84 -> V_104 ,
...
{
return F_68 ( V_2 , V_158 , V_159 ) ;
}
static int F_49 ( struct V_36 * V_2 )
{
return F_68 ( V_2 , V_160 , V_161 ) ;
}
static int T_7 F_74 ( void )
{
int V_42 ;
V_42 = F_75 ( & V_106 . V_105 ) ;
if ( V_42 ) {
F_76 ( L_15 ) ;
return V_42 ;
}
V_42 = F_77 ( & V_19 . V_162 ) ;
if ( V_42 )
goto V_163;
return 0 ;
V_163:
