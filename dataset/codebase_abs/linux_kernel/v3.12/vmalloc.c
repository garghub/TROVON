...
void F_136 ( const void * V_109 , unsigned int V_110 )
{
...
F_137 ( V_109 , V_46 ) ;
F_80 ( V_10 , V_10 + V_46 ) ;
if ( F_138 ( V_110 <= V_100 ) )
F_130 ( V_109 , V_46 ) ;
else
F_107 ( V_10 ) ;
}
void * F_139 ( struct V_20 * * V_21 , unsigned int V_110 , int V_50 , T_5 V_19 )
{
unsigned long V_46 = V_110 << V_79 ;
unsigned long V_10 ;
void * V_109 ;
...
void T_7 F_140 ( struct V_112 * V_113 )
{
...
void T_7 F_141 ( struct V_112 * V_113 , T_8 V_47 )
{
static T_8 T_9 V_115 ;
unsigned long V_10 ;
V_10 = F_63 ( V_68 + T_9 , V_47 ) ;
T_9 = F_142 ( V_10 + V_113 -> V_46 ) - V_68 ;
...
V_38 = F_146 ( sizeof( struct V_34 ) , V_116 ) ;
V_38 -> V_65 = V_117 ;
...
int F_147 ( unsigned long V_10 , unsigned long V_46 ,
T_5 V_19 , struct V_20 * * V_21 )
{
return F_33 ( V_10 , V_10 + V_46 , V_19 , V_21 ) ;
}
void F_148 ( unsigned long V_10 , unsigned long V_46 )
{
F_20 ( V_10 , V_10 + V_46 ) ;
}
...
int F_150 ( struct V_112 * V_118 , T_5 V_19 , struct V_20 * * * V_21 )
{
unsigned long V_10 = ( unsigned long ) V_118 -> V_10 ;
unsigned long V_11 = V_10 + F_151 ( V_118 ) ;
int V_26 ;
...
V_172 [ V_118 ] = F_146 ( sizeof( struct V_34 ) , V_111 ) ;
V_173 [ V_118 ] = F_146 ( sizeof( struct V_112 ) , V_111 ) ;
