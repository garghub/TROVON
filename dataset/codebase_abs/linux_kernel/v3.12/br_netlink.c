...
struct V_64 * V_113 ;
struct V_6 * V_7 ;
struct V_64 * V_95 [ V_114 + 1 ] ;
int V_85 = 0 ;
V_112 = F_56 ( V_40 , sizeof( struct V_1 ) , V_66 ) ;
V_113 = F_56 ( V_40 , sizeof( struct V_1 ) , V_79 ) ;
if ( ! V_112 && ! V_113 )
return 0 ;
V_7 = F_36 ( V_35 ) ;
if ( ! V_7 && ! V_113 )
...
if ( F_59 ( V_112 ) < sizeof( T_2 ) )
return - V_99 ;
F_57 ( & V_7 -> V_37 -> V_117 ) ;
V_85 = F_44 ( V_7 , F_49 ( V_112 ) ) ;
F_58 ( & V_7 -> V_37 -> V_117 ) ;
}
if ( V_85 )
goto V_91;
...
int F_60 ( struct V_34 * V_35 , struct V_39 * V_40 )
{
struct V_64 * V_113 ;
struct V_6 * V_7 ;
int V_85 ;
...
return 0 ;
V_7 = F_36 ( V_35 ) ;
if ( ! V_7 && ! ( V_35 -> V_118 & V_119 ) )
return - V_99 ;
V_85 = F_37 ( (struct V_36 * ) F_11 ( V_35 ) , V_7 ,
V_113 , V_102 ) ;
return V_85 ;
}
static int F_61 ( struct V_64 * V_95 [] , struct V_64 * V_120 [] )
{
if ( V_95 [ V_58 ] ) {
if ( F_59 ( V_95 [ V_58 ] ) != V_121 )
return - V_99 ;
if ( ! F_62 ( F_39 ( V_95 [ V_58 ] ) ) )
return - V_122 ;
}
return 0 ;
}
static T_1 F_63 ( const struct V_34 * V_35 )
{
struct V_70 * V_71 ;
if ( F_64 ( V_35 ) )
V_71 = F_20 ( F_36 ( V_35 ) ) ;
else if ( V_35 -> V_118 & V_119 )
V_71 = F_21 ( (struct V_36 * ) F_11 ( V_35 ) ) ;
else
return 0 ;
if ( ! V_71 )
return 0 ;
return V_71 -> V_123 * F_2 ( sizeof( struct V_72 ) ) ;
}
int T_5 F_65 ( void )
{
int V_85 ;
