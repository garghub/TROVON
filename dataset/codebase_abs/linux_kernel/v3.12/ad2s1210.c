...
static T_2 F_25 ( struct V_35 * V_36 ,
...
static T_2 F_30 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
char * V_39 )
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
struct V_56 * V_57 = F_31 ( V_38 ) ;
int V_9 ;
F_18 ( & V_4 -> V_43 ) ;
...
if ( V_9 < 0 )
goto V_44;
V_9 = F_34 ( V_4 -> V_12 , V_4 -> V_19 , 2 ) ;
if ( V_9 < 0 )
goto V_44;
switch ( V_61 -> type ) {
case V_68 :
V_66 = F_35 ( ( T_4 * ) V_4 -> V_19 ) ;
if ( V_4 -> V_53 )
V_66 >>= 16 - V_4 -> V_33 ;
* V_62 = V_66 ;
V_9 = V_72 ;
