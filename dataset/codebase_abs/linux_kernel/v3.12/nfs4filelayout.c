...
V_22 ) )
return;
F_46 ( & V_108 -> args . V_113 , V_108 -> args . V_96 ,
...
static void F_48 ( struct V_21 * V_22 , void * V_17 )
{
struct V_35 * V_108 = V_17 ;
F_49 ( V_22 , F_18 ( V_108 -> V_20 -> V_27 ) -> V_118 -> V_119 ) ;
}
static void F_50 ( void * V_17 )
{
struct V_35 * V_108 = V_17 ;
...
static void F_54 ( struct V_121 * V_17 )
{
struct V_122 * V_123 = F_55 ( V_17 -> V_32 . V_124 ) ;
V_17 -> V_22 . V_31 = 0 ;
...
V_22 ) )
return;
F_46 ( & V_98 -> args . V_113 , V_98 -> args . V_96 ,
...
{
struct V_16 * V_98 = V_17 ;
F_49 ( V_22 , F_18 ( V_98 -> V_20 -> V_27 ) -> V_118 -> V_119 ) ;
}
static void F_61 ( void * V_17 )
{
struct V_16 * V_98 = V_17 ;
...
static void F_62 ( struct V_21 * V_22 , void * V_17 )
{
...
F_49 ( V_22 , F_18 ( V_128 -> V_27 ) -> V_118 -> V_119 ) ;
}
static void F_65 ( void * V_129 )
{
...
V_136 = F_69 ( V_12 , V_3 ) ;
V_137 = F_70 ( V_12 , V_136 ) ;
V_133 = F_71 ( V_12 , V_137 ) ;
if ( ! V_133 )
return V_142 ;
V_135 = F_72 ( V_133 -> V_97 , V_19 -> V_27 ) ;
if ( F_73 ( V_135 ) )
return V_142 ;
F_9 ( L_12 , V_25 ,
V_133 -> V_143 , F_74 ( & V_133 -> V_97 -> V_144 ) ) ;
F_75 ( & V_133 -> V_97 -> V_144 ) ;
V_17 -> V_97 = V_133 -> V_97 ;
V_139 = F_76 ( V_12 , V_136 ) ;
if ( V_139 )
...
static enum V_131
F_78 ( struct V_16 * V_17 , int V_149 )
{
struct V_18 * V_19 = V_17 -> V_20 ;
struct V_11 * V_12 = V_19 -> V_12 ;
struct V_132 * V_133 ;
...
V_3 , V_133 -> V_143 , F_74 ( & V_133 -> V_97 -> V_144 ) ) ;
V_17 -> V_150 = F_52 ;
F_75 ( & V_133 -> V_97 -> V_144 ) ;
V_17 -> V_97 = V_133 -> V_97 ;
V_139 = F_76 ( V_12 , V_136 ) ;
...
V_158 = F_81 ( F_18 ( V_37 -> V_45 ) -> V_167 ,
F_18 ( V_37 -> V_45 ) -> V_42 , V_156 ) ;
if ( V_158 == NULL ) {
V_6 = F_82 ( V_37 -> V_45 , V_156 ,
V_37 -> V_168 , V_157 ) ;
if ( V_6 == NULL )
goto V_90;
} else
V_6 = F_83 ( V_158 , struct V_159 , V_169 ) ;
if ( F_38 ( & V_6 -> V_169 ) )
goto V_170;
V_152 -> V_6 = V_6 ;
...
static void F_85 ( struct V_1 * V_152 )
{
int V_176 ;
for ( V_176 = 0 ; V_176 < V_152 -> V_172 ; V_176 ++ ) {
if ( ! V_152 -> V_177 [ V_176 ] )
break;
F_86 ( V_152 -> V_177 [ V_176 ] ) ;
}
F_86 ( V_152 -> V_177 ) ;
V_152 -> V_177 = NULL ;
}
static void
F_87 ( struct V_1 * V_152 )
{
F_85 ( V_152 ) ;
F_86 ( V_152 ) ;
}
static int
F_88 ( struct V_36 * V_178 ,
struct V_1 * V_152 ,
struct V_153 * V_154 ,
struct V_155 * V_156 ,
T_4 V_157 )
...
if ( ! V_184 )
return - V_187 ;
F_90 ( & V_180 , & V_182 , V_154 -> V_188 -> V_32 , V_154 -> V_188 -> V_189 ) ;
F_91 ( & V_180 , F_92 ( V_184 ) , V_166 ) ;
V_185 = F_93 ( & V_180 , V_190 + 20 ) ;
if ( F_43 ( ! V_185 ) )
goto V_191;
...
V_152 -> V_171 = F_96 ( V_185 ++ ) ;
V_185 = F_97 ( V_185 , & V_152 -> V_10 ) ;
V_152 -> V_172 = F_96 ( V_185 ++ ) ;
F_9 ( L_24 ,
...
goto V_191;
if ( V_152 -> V_172 > 0 ) {
V_152 -> V_177 = F_99 ( V_152 -> V_172 , sizeof( V_152 -> V_177 [ 0 ] ) ,
V_157 ) ;
if ( ! V_152 -> V_177 )
goto V_191;
}
for ( V_176 = 0 ; V_176 < V_152 -> V_172 ; V_176 ++ ) {
V_152 -> V_177 [ V_176 ] = F_100 ( sizeof( struct V_138 ) , V_157 ) ;
if ( ! V_152 -> V_177 [ V_176 ] )
goto V_197;
V_185 = F_93 ( & V_180 , 4 ) ;
if ( F_43 ( ! V_185 ) )
goto V_197;
V_152 -> V_177 [ V_176 ] -> V_198 = F_96 ( V_185 ++ ) ;
if ( sizeof( struct V_138 ) < V_152 -> V_177 [ V_176 ] -> V_198 ) {
F_101 ( V_199 L_25 ,
V_176 , V_152 -> V_177 [ V_176 ] -> V_198 ) ;
goto V_197;
}
V_185 = F_93 ( & V_180 , V_152 -> V_177 [ V_176 ] -> V_198 ) ;
if ( F_43 ( ! V_185 ) )
goto V_197;
...
struct V_203 * V_178 ;
V_178 = F_104 ( V_12 -> V_44 ) ;
V_178 -> V_204 . V_205 = 0 ;
F_86 ( V_178 -> V_204 . V_206 ) ;
...
V_206 = F_99 ( V_198 , sizeof( struct V_209 ) ,
V_157 ) ;
if ( ! V_206 )
return - V_187 ;
else {
...
F_107 ( & V_206 [ V_176 ] . V_211 ) ;
F_107 ( & V_206 [ V_176 ] . V_212 ) ;
}
}
F_108 ( V_208 -> V_210 ) ;
return 0 ;
...
struct V_155 V_156 ;
F_9 ( L_14 , V_25 ) ;
V_152 = F_110 ( sizeof( * V_152 ) , V_157 ) ;
if ( ! V_152 )
return NULL ;
V_214 = F_88 ( V_213 , V_152 , V_154 , & V_156 , V_157 ) ;
if ( V_214 != 0 || F_80 ( V_213 , V_152 , V_154 , & V_156 , V_157 ) ) {
F_87 ( V_152 ) ;
return NULL ;
}
return & V_152 -> V_215 ;
...
static bool
F_111 ( struct V_216 * V_217 , struct V_122 * V_218 ,
struct V_122 * V_219 )
{
T_3 V_220 , V_221 ;
T_2 V_5 ;
if ( ! F_112 ( V_217 , V_218 , V_219 ) ||
! F_113 ( V_217 , V_218 , V_219 ) )
return false ;
V_220 = ( T_3 ) F_114 ( V_218 ) ;
V_221 = ( T_3 ) F_114 ( V_219 ) ;
...
static void
F_116 ( struct V_216 * V_217 ,
struct V_122 * V_219 )
{
F_117 ( V_217 -> V_222 != NULL ) ;
if ( V_219 -> V_223 != V_219 -> V_224 ) {
F_118 ( V_217 ) ;
return;
}
V_217 -> V_222 = F_119 ( V_217 -> V_225 ,
V_219 -> V_226 ,
0 ,
V_165 ,
V_227 ,
...
if ( V_217 -> V_222 == NULL )
goto V_229;
F_121 ( & V_208 , V_217 -> V_225 , V_217 -> V_231 ) ;
V_160 = F_105 ( V_217 -> V_222 , & V_208 , V_230 ) ;
if ( V_160 < 0 ) {
F_66 ( V_217 -> V_222 ) ;
V_217 -> V_222 = NULL ;
goto V_229;
...
static T_2 F_123 ( struct V_1 * V_152 , T_2 V_136 )
{
if ( V_152 -> V_13 == V_14 )
return F_70 ( & V_152 -> V_215 , V_136 ) ;
else
return V_136 ;
}
static void
F_124 ( struct V_122 * V_219 ,
struct V_207 * V_208 )
{
...
goto V_90;
V_208 -> V_133 -> V_235 -- ;
if ( F_125 ( & V_219 -> V_236 ) ) {
struct V_209 * V_237 ;
V_237 = F_126 ( & V_219 -> V_236 ,
struct V_209 ,
V_211 ) ;
V_232 = V_237 -> V_238 ;
V_237 -> V_238 = NULL ;
...
V_136 = F_69 ( V_12 , F_114 ( V_219 ) ) ;
V_176 = F_123 ( V_152 , V_136 ) ;
V_206 = V_208 -> V_133 -> V_206 ;
V_240 = & V_206 [ V_176 ] . V_211 ;
if ( F_129 ( V_240 ) ) {
V_206 [ V_176 ] . V_238 = F_130 ( V_12 ) ;
}
...
static void
F_131 ( struct V_122 * V_219 ,
struct V_11 * V_12 ,
struct V_207 * V_208 )
{
struct V_239 * V_240 ;
V_240 = F_128 ( V_219 , V_12 , V_208 ) ;
F_132 ( V_219 , V_240 , V_208 ) ;
}
static T_2 F_133 ( struct V_11 * V_12 , T_2 V_176 )
{
struct V_1 * V_2 = F_5 ( V_12 ) ;
if ( V_2 -> V_13 == V_14 )
return V_176 ;
else
return F_70 ( V_12 , V_176 ) ;
}
static struct V_138 *
F_134 ( struct V_11 * V_12 , T_2 V_176 )
{
struct V_1 * V_2 = F_5 ( V_12 ) ;
if ( V_2 -> V_13 == V_14 ) {
if ( V_2 -> V_172 == 1 )
...
static int F_135 ( struct V_121 * V_17 , int V_242 )
{
...
T_2 V_137 ;
struct V_138 * V_139 ;
V_137 = F_133 ( V_12 , V_17 -> V_243 ) ;
V_133 = F_71 ( V_12 , V_137 ) ;
if ( ! V_133 )
goto V_191;
V_135 = F_72 ( V_133 -> V_97 , V_17 -> V_27 ) ;
if ( F_73 ( V_135 ) )
goto V_191;
F_9 ( L_27 , V_25 ,
V_17 -> V_27 -> V_104 , V_242 , F_74 ( & V_133 -> V_97 -> V_144 ) ) ;
V_17 -> V_244 = F_56 ;
F_75 ( & V_133 -> V_97 -> V_144 ) ;
V_17 -> V_97 = V_133 -> V_97 ;
V_139 = F_134 ( V_12 , V_17 -> V_243 ) ;
if ( V_139 )
V_17 -> args . V_139 = V_139 ;
return F_136 ( V_135 , V_17 ,
& V_245 , V_242 ,
V_147 ) ;
V_191:
F_54 ( V_17 ) ;
...
static int
F_137 ( struct V_239 * V_246 , struct V_239 * V_247 ,
struct V_207 * V_208 , int F_98 )
{
struct V_122 * V_219 , * V_248 ;
int V_249 = 0 ;
F_138 (req, tmp, src, wb_list) {
if ( ! F_139 ( V_219 ) )
continue;
F_140 ( & V_219 -> V_250 ) ;
if ( F_141 ( V_208 -> V_210 ) )
F_142 ( V_219 , V_248 , V_236 ) ;
F_127 ( V_219 , V_208 ) ;
F_143 ( V_233 , & V_219 -> V_234 ) ;
F_144 ( V_219 , V_247 ) ;
V_249 ++ ;
if ( ( V_249 == F_98 ) && ! V_208 -> V_34 )
break;
}
return V_249 ;
}
static int
F_145 ( struct V_209 * V_237 ,
struct V_207 * V_208 ,
int F_98 )
{
...
int V_249 ;
V_249 = F_137 ( V_246 , V_247 , V_208 , F_98 ) ;
if ( V_249 ) {
...
static int F_146 ( struct V_207 * V_208 ,
int F_98 )
{
int V_176 , V_253 = 0 , V_254 ;
for ( V_176 = 0 ; V_176 < V_208 -> V_133 -> V_205 && F_98 != 0 ; V_176 ++ ) {
V_254 = F_145 ( & V_208 -> V_133 -> V_206 [ V_176 ] ,
V_208 , F_98 ) ;
F_98 -= V_254 ;
V_253 += V_254 ;
}
...
static unsigned int
F_148 ( struct V_207 * V_208 , struct V_239 * V_240 )
{
struct V_256 * V_257 ;
struct V_209 * V_237 ;
struct V_121 * V_17 ;
...
V_237 -> V_252 = NULL ;
F_150 ( & V_17 -> V_32 , V_240 ) ;
V_258 ++ ;
}
for ( V_136 = V_176 ; V_136 < V_257 -> V_205 ; V_136 ++ , V_237 ++ ) {
if ( F_129 ( & V_237 -> V_212 ) )
continue;
F_151 ( & V_237 -> V_212 , V_237 -> V_252 , V_208 ) ;
F_66 ( V_237 -> V_252 ) ;
V_237 -> V_252 = NULL ;
}
return V_258 ;
...
static int
F_152 ( struct V_27 * V_27 , struct V_239 * V_259 ,
...
F_151 ( V_259 , NULL , V_208 ) ;
}
V_258 += F_148 ( V_208 , & V_240 ) ;
if ( V_258 == 0 ) {
V_208 -> V_33 -> V_260 ( F_26 ( V_27 ) ) ;
goto V_90;
}
F_154 ( V_258 , & V_208 -> V_241 -> V_261 ) ;
F_138 (data, tmp, &list, pages) {
F_155 ( & V_17 -> V_32 ) ;
if ( ! V_17 -> V_12 ) {
F_156 ( V_17 , V_259 , NULL , V_208 ) ;
F_136 ( F_157 ( V_27 ) , V_17 ,
V_17 -> V_116 , V_242 , 0 ) ;
} else {
struct V_209 * V_206 ;
V_206 = V_208 -> V_133 -> V_206 ;
F_156 ( V_17 , & V_206 [ V_17 -> V_243 ] . V_212 , V_17 -> V_12 , V_208 ) ;
F_135 ( V_17 , V_242 ) ;
}
}
V_90:
...
static void
F_158 ( struct V_48 * V_158 )
{
F_159 ( F_83 ( V_158 , struct V_159 , V_169 ) ) ;
}
static struct V_36 *
F_160 ( struct V_27 * V_27 , T_4 V_157 )
{
struct V_203 * V_178 ;
V_178 = F_110 ( sizeof( * V_178 ) , V_157 ) ;
return & V_178 -> V_215 ;
}
static void
F_161 ( struct V_36 * V_37 )
{
F_86 ( F_104 ( V_37 ) ) ;
}
static struct V_256 *
F_162 ( struct V_27 * V_27 )
{
struct V_36 * V_105 = F_26 ( V_27 ) -> V_105 ;
if ( V_105 == NULL )
return NULL ;
else
return & F_104 ( V_105 ) -> V_204 ;
}
