...
void F_79 ( struct V_9 * V_10 , int V_96 )
{
enum V_97 V_98 ;
T_7 * V_99 = & V_100 [ V_96 ] ;
V_98 = V_96 ? V_101 : V_102 ;
if ( F_80 ( V_98 , & V_10 -> V_26 ) )
F_81 ( & V_103 [ V_96 ] ) ;
F_82 () ;
if ( F_83 ( V_99 ) )
F_84 ( V_99 ) ;
}
void F_85 ( struct V_9 * V_10 , int V_96 )
{
enum V_97 V_98 ;
V_98 = V_96 ? V_101 : V_102 ;
if ( ! F_86 ( V_98 , & V_10 -> V_26 ) )
F_87 ( & V_103 [ V_96 ] ) ;
}
long F_88 ( int V_96 , long V_59 )
{
long V_40 ;
unsigned long V_104 = V_73 ;
F_89 ( V_105 ) ;
T_7 * V_99 = & V_100 [ V_96 ] ;
F_90 ( V_99 , & V_105 , V_106 ) ;
V_40 = F_91 ( V_59 ) ;
F_92 ( V_99 , & V_105 ) ;
F_93 ( F_94 ( V_59 ) ,
F_94 ( V_73 - V_104 ) ) ;
...
long F_95 ( struct V_107 * V_107 , int V_96 , long V_59 )
{
long V_40 ;
unsigned long V_104 = V_73 ;
F_89 ( V_105 ) ;
T_7 * V_99 = & V_100 [ V_96 ] ;
if ( F_96 ( & V_103 [ V_96 ] ) == 0 ||
! F_97 ( V_107 ) ) {
F_98 () ;
...
int F_100 ( struct V_109 * V_110 , int V_111 ,
...
if ( F_101 ( V_112 , V_115 , sizeof( V_115 ) ) )
return - V_116 ;
F_102 ( V_117 L_22 ,
V_110 -> V_118 ) ;
* V_113 = 2 ;
