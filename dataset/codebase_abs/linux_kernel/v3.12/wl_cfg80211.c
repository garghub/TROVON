...
static int F_173 ( enum V_612 V_613 )
{
int V_463 ;
switch ( V_613 ) {
case V_614 :
...
static int F_174 ( struct V_75 * V_75 ,
struct V_64 * V_65 , T_2 * V_620 ,
enum V_612 V_613 )
{
struct V_67 * V_68 ;
struct V_621 V_582 ;
...
V_582 . V_70 = ( T_2 ) V_463 ;
if ( V_620 )
memcpy ( V_582 . V_63 , V_620 , V_105 ) ;
V_463 = F_48 ( V_68 , L_278 ,
& V_582 , sizeof( V_582 ) ) ;
if ( V_463 < 0 )
F_19 ( L_279 , V_463 ) ;
return V_463 ;
}
static T_5 F_175 ( enum V_77 type )
{
switch ( type ) {
case V_83 :
case V_84 :
...
static void F_176 ( struct V_75 * V_75 )
{
V_75 -> V_624 = V_625 ;
V_75 -> V_626 = V_625 ;
V_75 -> V_627 = V_628 ;
...
static struct V_75 * F_177 ( struct V_630 * V_631 )
{
struct V_75 * V_75 ;
T_5 V_66 = 0 ;
V_75 = F_178 ( & V_632 , sizeof( struct V_94 ) ) ;
if ( ! V_75 ) {
F_19 ( L_280 ) ;
return F_23 ( - V_158 ) ;
}
...
F_119 ( V_90 ) ;
V_75 -> V_637 = V_638 ;
V_75 -> V_639 = F_153 ( V_638 ) ;
V_75 -> V_381 [ V_382 ] = & V_640 ;
V_75 -> V_641 = V_642 ;
V_75 -> V_643 = V_644 ;
V_75 -> V_645 = F_153 ( V_644 ) ;
V_75 -> V_57 |= V_646 |
V_647 |
V_648 |
V_649 ;
...
struct V_1 * F_183 ( struct V_94 * V_95 ,
enum V_77 type ,
bool V_655 )
{
struct V_1 * V_2 ;
...
static bool F_188 ( const struct V_415 * V_416 )
{
T_4 V_661 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_661 == V_662 && V_419 == V_429 ) {
F_3 ( V_222 , L_284 ) ;
return true ;
}
return false ;
}
static bool F_189 ( const struct V_415 * V_416 )
{
T_4 V_661 = V_416 -> V_456 ;
T_1 V_57 = V_416 -> V_57 ;
if ( V_661 == V_663 && ( ! ( V_57 & V_664 ) ) ) {
F_3 ( V_222 , L_285 ) ;
return true ;
}
return false ;
}
static bool F_190 ( struct V_94 * V_95 ,
const struct V_415 * V_416 )
{
T_4 V_661 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_661 == V_663 && V_419 == V_665 ) {
F_3 ( V_222 , L_286 ,
V_416 -> V_57 & V_664 ? L_287 : L_288 ) ;
return true ;
}
if ( V_661 == V_662 && V_419 != V_429 ) {
F_3 ( V_222 , L_289 ) ;
...
static T_5 F_193 ( struct V_94 * V_95 ,
struct V_67 * V_68 )
{
struct V_672 * V_673 ;
struct V_666 * V_667 = F_192 ( V_95 ) ;
...
V_673 =
(struct V_672 * ) V_95 -> V_401 ;
V_674 = F_97 ( V_673 -> V_674 ) ;
V_675 = F_97 ( V_673 -> V_675 ) ;
if ( V_674 ) {
V_66 = F_96 ( V_68 , L_292 ,
V_95 -> V_401 ,
V_676 ) ;
if ( V_66 ) {
F_19 ( L_293 , V_66 ) ;
...
F_3 ( V_73 , L_13 ) ;
F_193 ( V_95 , V_68 ) ;
memcpy ( V_216 -> V_104 , V_416 -> V_677 , V_105 ) ;
F_111 ( V_95 , V_68 ) ;
V_30 = F_46 ( V_377 , V_157 ) ;
if ( V_30 == NULL ) {
V_66 = - V_158 ;
...
V_129:
F_49 ( V_30 ) ;
F_196 ( V_65 , V_365 , ( T_2 * ) V_216 -> V_104 ,
V_667 -> V_668 , V_667 -> V_669 ,
V_667 -> V_670 , V_667 -> V_671 , V_157 ) ;
F_3 ( V_222 , L_297 ) ;
...
static T_5
F_199 ( struct V_94 * V_95 ,
struct V_64 * V_65 ,
const struct V_415 * V_416 , void * V_62 )
{
static int V_681 ;
T_4 V_661 = V_416 -> V_456 ;
T_4 V_682 = V_416 -> V_682 ;
struct V_332 V_333 ;
F_3 ( V_222 , L_300 , V_661 , V_682 ) ;
if ( V_661 == V_663 && V_682 == V_683 &&
V_65 != F_63 ( V_95 ) ) {
F_3 ( V_222 , L_301 ) ;
F_200 ( & V_95 -> V_684 ) ;
return 0 ;
}
if ( ( ( V_661 == V_685 ) || ( V_661 == V_686 ) ) &&
( V_682 == V_429 ) ) {
...
V_333 . V_688 = V_62 ;
V_333 . V_689 = V_416 -> V_690 ;
V_681 ++ ;
V_333 . V_681 = V_681 ;
F_201 ( V_65 , V_416 -> V_677 , & V_333 , V_157 ) ;
} else if ( ( V_661 == V_691 ) ||
( V_661 == V_692 ) ||
( V_661 == V_693 ) ) {
F_202 ( V_65 , V_416 -> V_677 , V_157 ) ;
}
return 0 ;
}
static T_5
...
T_5 V_66 = 0 ;
if ( V_68 -> V_2 -> V_70 == V_128 ) {
V_66 = F_199 ( V_95 , V_65 , V_416 , V_62 ) ;
} else if ( F_188 ( V_416 ) ) {
F_3 ( V_222 , L_303 ) ;
if ( F_110 ( V_68 -> V_2 ) ) {
memcpy ( V_216 -> V_104 , V_416 -> V_677 , V_105 ) ;
F_109 ( V_95 , V_65 , V_416 -> V_677 ) ;
F_204 ( V_65 , V_416 -> V_677 , V_157 ) ;
F_56 ( V_185 ,
& V_68 -> V_2 -> V_4 ) ;
F_40 ( V_212 ,
& V_68 -> V_2 -> V_4 ) ;
} else
F_197 ( V_95 , V_65 , V_416 , true ) ;
} else if ( F_189 ( V_416 ) ) {
F_3 ( V_222 , L_304 ) ;
if ( ! F_110 ( V_68 -> V_2 ) ) {
F_197 ( V_95 , V_65 , V_416 , false ) ;
if ( F_33 ( V_212 ,
& V_68 -> V_2 -> V_4 ) )
F_66 ( V_65 , 0 , NULL , 0 ,
V_157 ) ;
...
T_4 V_661 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_661 == V_694 && V_419 == V_429 ) {
if ( F_2 ( V_212 , & V_68 -> V_2 -> V_4 ) )
F_195 ( V_95 , V_68 -> V_65 , V_416 ) ;
else
F_197 ( V_95 , V_68 -> V_65 , V_416 , true ) ;
}
return V_66 ;
}
static T_5
...
V_696 = V_699 ;
F_207 ( V_68 -> V_65 , ( T_2 * ) & V_416 -> V_677 , V_696 , - 1 ,
NULL , V_157 ) ;
return 0 ;
}
static T_5 F_208 ( struct V_67 * V_68 ,
const struct V_415 * V_416 , void * V_62 )
{
struct V_94 * V_95 = V_68 -> V_417 -> V_418 ;
struct V_700 * V_701 = (struct V_700 * ) V_62 ;
struct V_702 * V_661 = & V_95 -> V_703 ;
struct V_1 * V_2 ;
F_3 ( V_73 , L_305 ,
V_701 -> V_152 , V_701 -> V_57 , V_701 -> V_704 ,
V_701 -> V_423 ) ;
F_209 ( & V_661 -> V_705 ) ;
V_661 -> V_152 = V_701 -> V_152 ;
V_2 = V_661 -> V_2 ;
switch ( V_701 -> V_152 ) {
case V_706 :
if ( ! V_95 -> V_703 . V_2 ) {
...
F_211 ( V_68 -> V_65 , F_212 ( V_95 -> V_75 ) ) ;
}
F_210 ( & V_661 -> V_705 ) ;
F_213 ( & V_661 -> V_708 ) ;
return 0 ;
...
static void F_214 ( struct V_711 * V_204 )
{
V_204 -> V_196 = ( T_4 ) - 1 ;
V_204 -> V_195 = ( T_4 ) - 1 ;
V_204 -> V_209 = ( T_4 ) - 1 ;
...
static void F_215 ( struct V_94 * V_95 )
{
F_121 ( V_95 -> V_430 , V_663 ,
F_203 ) ;
F_121 ( V_95 -> V_430 , V_692 ,
F_203 ) ;
F_121 ( V_95 -> V_430 , V_693 ,
F_203 ) ;
F_121 ( V_95 -> V_430 , V_691 ,
F_203 ) ;
F_121 ( V_95 -> V_430 , V_685 ,
F_203 ) ;
F_121 ( V_95 -> V_430 , V_686 ,
F_203 ) ;
F_121 ( V_95 -> V_430 , V_694 ,
F_205 ) ;
F_121 ( V_95 -> V_430 , V_712 ,
F_206 ) ;
F_121 ( V_95 -> V_430 , V_662 ,
F_203 ) ;
F_121 ( V_95 -> V_430 , V_713 ,
F_135 ) ;
F_121 ( V_95 -> V_430 , V_714 ,
F_208 ) ;
F_121 ( V_95 -> V_430 , V_715 ,
V_716 ) ;
F_121 ( V_95 -> V_430 , V_717 ,
V_718 ) ;
F_121 ( V_95 -> V_430 , V_719 ,
V_720 ) ;
F_121 ( V_95 -> V_430 , V_721 ,
V_722 ) ;
F_121 ( V_95 -> V_430 , V_723 ,
V_722 ) ;
}
static void F_216 ( struct V_94 * V_95 )
{
F_49 ( V_95 -> V_204 ) ;
V_95 -> V_204 = NULL ;
F_49 ( V_95 -> V_724 ) ;
...
static T_5 F_217 ( struct V_94 * V_95 )
{
V_95 -> V_204 = F_46 ( sizeof( * V_95 -> V_204 ) , V_157 ) ;
if ( ! V_95 -> V_204 )
goto V_725;
V_95 -> V_724 = F_46 ( V_159 , V_157 ) ;
if ( ! V_95 -> V_724 )
goto V_725;
...
static T_5 F_218 ( struct V_94 * V_95 )
{
T_5 V_66 = 0 ;
V_95 -> V_101 = NULL ;
V_95 -> V_358 = true ;
...
static void F_222 ( struct V_702 * V_661 )
{
F_223 ( & V_661 -> V_708 ) ;
F_219 ( & V_661 -> V_705 ) ;
}
struct V_94 * F_224 ( struct V_729 * V_417 ,
struct V_630 * V_730 )
{
struct V_64 * V_65 = V_417 -> V_731 [ 0 ] -> V_65 ;
struct V_94 * V_95 ;
struct V_75 * V_75 ;
struct V_1 * V_2 ;
struct V_67 * V_68 ;
...
V_66 = F_21 ( V_68 , L_310 , 1 ) ;
if ( V_66 ) {
F_3 ( V_5 , L_311 , V_66 ) ;
V_75 -> V_57 &= ~ V_649 ;
}
V_66 = F_98 ( V_68 , V_735 ,
& V_732 ) ;
if ( V_66 ) {
F_19 ( L_312 , V_66 ) ;
goto V_734;
}
V_95 -> V_18 . V_732 = ( T_2 ) V_732 ;
F_230 ( & V_95 -> V_18 ) ;
return V_95 ;
V_734:
F_221 ( V_95 ) ;
...
void F_231 ( struct V_94 * V_95 )
{
struct V_1 * V_2 ;
struct V_1 * V_736 ;
F_221 ( V_95 ) ;
F_232 ( V_95 ) ;
F_233 (vif, tmp, &cfg->vif_list, list) {
F_185 ( V_95 , V_2 ) ;
}
}
static T_5
F_234 ( struct V_67 * V_68 , T_4 V_737 , T_4 V_738 )
{
T_5 V_66 = 0 ;
V_396 V_739 [ 2 ] ;
V_396 V_740 [ 2 ] ;
if ( V_737 ) {
V_66 = F_21 ( V_68 , L_313 , V_738 ) ;
if ( V_66 ) {
F_19 ( L_314 , V_66 ) ;
goto V_741;
}
}
F_3 ( V_5 , L_315 , V_737 ? L_316 : L_317 ) ;
V_66 = F_21 ( V_68 , L_318 , V_737 ) ;
if ( V_66 ) {
F_19 ( L_319 , V_66 ) ;
goto V_741;
}
V_739 [ 0 ] = F_13 ( V_742 ) ;
V_739 [ 1 ] = F_13 ( V_743 ) ;
V_66 = F_29 ( V_68 , V_744 ,
( void * ) V_739 , sizeof( V_739 ) ) ;
if ( V_66 ) {
F_19 ( L_320 , V_66 ) ;
goto V_741;
}
V_740 [ 0 ] = F_13 ( V_745 ) ;
V_740 [ 1 ] = F_13 ( V_743 ) ;
V_66 = F_29 ( V_68 , V_746 ,
( void * ) V_740 , sizeof( V_740 ) ) ;
if ( V_66 ) {
F_19 ( L_321 , V_66 ) ;
goto V_741;
}
...
static T_5
F_235 ( struct V_67 * V_68 , T_5 V_747 ,
T_5 V_748 , T_5 V_749 )
{
T_5 V_66 = 0 ;
V_66 = F_41 ( V_68 , V_750 ,
V_747 ) ;
if ( V_66 ) {
if ( V_66 == - V_87 )
F_3 ( V_5 , L_322 ) ;
...
static T_5 F_236 ( struct V_94 * V_95 , T_4 V_754 )
{
struct V_67 * V_68 = F_18 ( F_63 ( V_95 ) ) ;
struct V_19 * V_755 ;
struct V_756 * V_391 ;
...
bool V_763 ;
T_4 V_764 ;
V_757 = F_46 ( V_159 , V_157 ) ;
if ( V_757 == NULL )
return - V_158 ;
V_391 = (struct V_756 * ) V_757 ;
V_66 = F_96 ( V_68 , L_328 , V_757 ,
V_159 ) ;
if ( V_66 ) {
F_19 ( L_329 , V_66 ) ;
goto exit;
...
V_640 . V_137 = 0 ;
V_765 . V_137 = 0 ;
V_758 = F_97 ( V_391 -> V_172 ) ;
for ( V_138 = 0 ; V_138 < V_758 ; V_138 ++ ) {
V_20 . V_28 = ( T_1 ) F_97 ( V_391 -> V_766 [ V_138 ] ) ;
V_95 -> V_18 . V_379 ( & V_20 ) ;
if ( V_20 . V_369 == V_398 ) {
V_755 = V_767 ;
V_764 = F_153 ( V_767 ) ;
...
F_19 ( L_330 , V_20 . V_28 ) ;
continue;
}
if ( ! V_761 && V_20 . V_25 == V_772 )
continue;
V_763 = false ;
for ( V_438 = 0 ; ( V_438 < * V_760 && ( * V_760 < V_764 ) ) ; V_438 ++ ) {
if ( V_755 [ V_438 ] . V_144 == V_20 . V_23 ) {
V_763 = true ;
break;
}
}
...
V_755 [ V_55 ] . V_144 = V_20 . V_23 ;
if ( V_20 . V_25 == V_772 && V_761 ) {
V_762 = V_755 [ V_55 ] . V_57 &
V_462 ;
if ( V_20 . V_773 == V_774 ) {
if ( V_762 == V_462 )
V_755 [ V_55 ] . V_57 &=
...
T_4 V_786 ;
T_5 V_138 ;
struct V_368 * V_381 [ V_787 ] ;
T_5 V_55 ;
V_66 = F_99 ( V_68 , V_788 ,
& V_782 , sizeof( V_782 ) ) ;
if ( V_66 ) {
F_19 ( L_332 , V_66 ) ;
return V_66 ;
...
F_3 ( V_5 , L_335 ,
V_783 [ 0 ] , V_783 [ 1 ] , V_783 [ 2 ] ) ;
V_66 = F_86 ( V_68 , L_336 , & V_784 ) ;
if ( V_66 ) {
F_19 ( L_337 , V_66 ) ;
} else {
V_66 = F_86 ( V_68 , L_338 , & V_754 ) ;
if ( V_66 )
F_19 ( L_339 , V_66 ) ;
}
F_3 ( V_5 , L_340 , V_784 , V_754 ) ;
V_66 = F_236 ( V_95 , V_754 ) ;
if ( V_66 ) {
F_19 ( L_341 , V_66 ) ;
return V_66 ;
}
...
for ( V_138 = 1 ; V_138 <= V_786 && V_138 < F_153 ( V_783 ) ; V_138 ++ ) {
V_55 = - 1 ;
if ( ( V_783 [ V_138 ] == V_790 ) &&
( V_765 . V_137 > 0 ) ) {
V_55 = V_383 ;
V_381 [ V_55 ] = & V_765 ;
if ( ( V_754 == V_768 ) ||
( V_754 == V_791 ) )
V_381 [ V_55 ] -> V_792 . V_793 |=
V_794 ;
} else if ( ( V_783 [ V_138 ] == V_795 ) &&
( V_640 . V_137 > 0 ) ) {
V_55 = V_382 ;
V_381 [ V_55 ] = & V_640 ;
if ( V_754 == V_768 )
...
if ( ( V_55 >= 0 ) && V_784 ) {
V_381 [ V_55 ] -> V_792 . V_793 |= V_796 ;
V_381 [ V_55 ] -> V_792 . V_793 |= V_797 ;
V_381 [ V_55 ] -> V_792 . V_798 = true ;
V_381 [ V_55 ] -> V_792 . V_799 =
V_800 ;
V_381 [ V_55 ] -> V_792 . V_801 =
V_802 ;
V_381 [ V_55 ] -> V_792 . V_803 . V_804 [ 0 ] = 0xff ;
}
}
V_75 = F_31 ( V_95 ) ;
...
static T_5 F_238 ( struct V_94 * V_95 )
{
return F_237 ( V_95 ) ;
}
static T_5 F_239 ( struct V_94 * V_95 )
{
struct V_64 * V_65 ;
struct V_74 * V_119 ;
struct V_67 * V_68 ;
...
F_235 ( V_68 , V_806 ,
V_807 , V_808 ) ;
V_805 = V_95 -> V_358 ? V_359 : V_360 ;
V_66 = F_41 ( V_68 , V_361 , V_805 ) ;
if ( V_66 )
goto V_809;
F_3 ( V_5 , L_342 ,
( V_805 ? L_154 : L_155 ) ) ;
V_66 = F_234 ( V_68 , ( V_95 -> V_726 ? 0 : 1 ) , V_810 ) ;
if ( V_66 )
goto V_809;
...
static T_5 F_240 ( struct V_67 * V_68 )
{
F_40 ( V_3 , & V_68 -> V_2 -> V_4 ) ;
return F_239 ( V_68 -> V_417 -> V_418 ) ;
}
static T_5 F_241 ( struct V_67 * V_68 )
{
struct V_94 * V_95 = V_68 -> V_417 -> V_418 ;
if ( F_1 ( V_68 -> V_2 ) ) {
F_65 ( V_68 -> V_2 ) ;
...
enum V_77 F_244 ( struct V_67 * V_68 )
{
struct V_74 * V_119 = & V_68 -> V_2 -> V_119 ;
return V_119 -> V_123 ;
}
T_4 F_245 ( struct V_94 * V_95 , unsigned long V_811 )
{
struct V_1 * V_2 ;
bool V_313 = 0 ;
F_130 (vif, &cfg->vif_list, list) {
if ( F_2 ( V_811 , & V_2 -> V_4 ) )
V_313 ++ ;
}
return V_313 ;
}
static inline bool F_246 ( struct V_702 * V_661 ,
T_2 V_152 )
{
T_2 V_812 ;
F_209 ( & V_661 -> V_705 ) ;
...
bool V_813 ;
F_209 ( & V_661 -> V_705 ) ;
V_813 = V_661 -> V_2 != NULL ;
F_210 ( & V_661 -> V_705 ) ;
return V_813 ;
}
int F_248 ( struct V_94 * V_95 ,
T_2 V_152 , T_11 V_356 )
{
struct V_702 * V_661 = & V_95 -> V_703 ;
return F_249 ( V_661 -> V_708 ,
F_246 ( V_661 , V_152 ) , V_356 ) ;
}
