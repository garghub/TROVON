...
V_6 = V_101 -> V_105 ( V_12 , V_2 -> V_8 . V_36 ,
V_2 -> V_8 . V_9 , V_101 -> V_106 ) ;
if ( V_6 < 0 )
...
{
struct V_100 * V_101 = F_57 ( & V_12 -> V_13 ) ;
struct V_1 * V_2 = F_63 ( V_12 ) ;
int V_6 = 0 ;
if ( V_101 && V_101 -> V_107 ) {
V_6 = V_101 -> V_107 ( V_12 , V_2 -> V_8 . V_36 ,
V_2 -> V_8 . V_9 , V_101 -> V_106 ) ;
if ( V_6 < 0 ) {
F_4 ( & V_12 -> V_13 , L_13 ,
L_14 , V_6 ) ;
