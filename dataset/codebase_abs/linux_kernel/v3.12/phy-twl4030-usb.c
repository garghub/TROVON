...
{
struct V_98 * V_99 = F_51 ( & V_97 -> V_7 ) ;
struct V_1 * V_2 ;
int V_19 , V_100 ;
struct V_88 * V_89 ;
struct V_101 * V_102 = V_97 -> V_7 . V_103 ;
V_2 = F_52 ( & V_97 -> V_7 , sizeof *V_2 , V_104 ) ;
if ( ! V_2 )
return - V_105 ;
if ( V_102 )
F_53 ( V_102 , L_20 ,
...
V_89 = F_52 ( & V_97 -> V_7 , sizeof *V_89 , V_104 ) ;
if ( ! V_89 )
return - V_105 ;
V_2 -> V_7 = & V_97 -> V_7 ;
V_2 -> V_77 = F_54 ( V_97 , 0 ) ;
V_2 -> V_22 = false ;
V_2 -> V_56 = 1 ;
V_2 -> V_20 = V_21 ;
...
F_57 ( & V_2 -> V_85 ) ;
F_58 ( V_97 , V_2 ) ;
if ( F_59 ( & V_97 -> V_7 , & V_113 ) )
F_60 ( & V_97 -> V_7 , L_24 ) ;
V_2 -> V_114 = true ;
V_19 = F_61 ( V_2 -> V_7 , V_2 -> V_77 , NULL ,
F_38 , V_115 |
