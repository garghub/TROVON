...
return 0 ;
if ( V_5 -> V_60 . V_84 ) {
V_5 -> V_60 . V_84 -> V_85 = V_5 -> V_60 . V_86 ;
V_5 -> V_60 . V_84 -> V_87 = V_5 -> V_60 . V_88 ;
}
V_5 -> V_60 . V_61 . V_89 = V_5 -> V_60 . V_86 != - 1 ;
if ( V_5 -> V_60 . V_84 ) {
V_69 = F_38 ( V_5 -> V_60 . V_84 , sizeof( * V_69 ) , V_19 ) ;
if ( ! V_69 )
return - V_90 ;
for ( V_65 = 0 ; V_65 < 6 ; V_65 ++ )
V_69 -> V_38 [ V_65 ] . V_91 = V_69 -> V_92 [ V_65 ] ;
}
V_41 = F_20 ( V_26 , V_5 -> V_83 ,
& V_5 -> V_60 . V_61 , V_69 ) ;
if ( V_41 )
F_23 ( V_69 ) ;
return V_41 ;
...
if ( ! V_26 -> V_66 -> V_99 )
return - V_100 ;
V_98 = F_40 ( V_5 -> V_14 , V_96 ) ;
if ( V_98 < 0 )
return V_98 ;
if ( V_98 ) {
V_48 = F_41 ( V_5 -> V_14 , V_98 ) ;
if ( ! V_48 )
return - V_82 ;
if ( V_48 -> V_29 & V_78 ||
V_48 -> V_29 & V_79 )
...
if ( V_41 )
return V_41 ;
if ( V_105 > 0 && V_15 [ V_105 - 1 ] == '\0' )
V_105 -- ;
V_5 -> V_60 . V_61 . V_15 = V_5 -> V_15 ;
memcpy ( V_5 -> V_60 . V_61 . V_15 , V_15 , V_105 ) ;
V_5 -> V_60 . V_61 . V_13 = V_105 ;
F_28 ( V_5 ) ;
V_41 = F_36 ( V_26 , V_5 ) ;
F_29 ( V_5 ) ;
return V_41 ;
...
V_92 -> V_29 = 1 ;
V_92 -> V_106 = V_5 -> V_13 ;
memcpy ( V_15 , V_5 -> V_15 , V_92 -> V_106 ) ;
} else if ( V_5 -> V_60 . V_61 . V_15 && V_5 -> V_60 . V_61 . V_13 ) {
V_92 -> V_29 = 1 ;
V_92 -> V_106 = V_5 -> V_60 . V_61 . V_13 ;
memcpy ( V_15 , V_5 -> V_60 . V_61 . V_15 , V_92 -> V_106 ) ;
}
F_29 ( V_5 ) ;
return 0 ;
}
