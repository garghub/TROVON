...
V_99 = F_69 ( F_39 , V_25 , L_7 , V_25 -> V_53 ) ;
if ( F_70 ( V_99 ) )
GOTO ( V_96 , V_43 = F_71 ( V_99 ) ) ;
V_43 = 0 ;
F_72 ( & V_25 -> V_76 ) ;
}
V_96:
...
void F_75 ( struct V_6 * V_25 , int V_100 )
{
...
if ( V_102 < 2 )
V_102 = 2 ;
if ( V_102 < 3 && V_85 == V_89 )
V_85 = V_88 ;
else if ( V_102 % 2 != 0 && V_85 == V_88 )
V_102 &= ~ 1 ;
V_103 = F_80 ( struct F_39 , V_20 [ V_102 ] ) ;
F_60 ( V_12 , V_103 ) ;
if ( V_12 == NULL )
GOTO ( V_96 , V_43 = - V_91 ) ;
snprintf ( V_94 , sizeof( V_94 ) , L_9 ) ;
F_57 ( V_106 , & V_12 -> V_13 . V_70 ) ;
V_43 = F_62 ( - 1 , V_102 , V_94 , & V_12 -> V_13 ) ;
if ( V_43 < 0 )
GOTO ( V_96 , V_43 ) ;
for ( V_28 = 0 ; V_28 < V_102 ; V_28 ++ ) {
snprintf ( V_94 , sizeof( V_94 ) , L_10 , V_28 ) ;
V_43 = F_62 ( V_28 , V_102 , V_94 , & V_12 -> V_20 [ V_28 ] ) ;
if ( V_43 < 0 )
GOTO ( V_96 , V_43 ) ;
}
V_12 -> V_101 = V_103 ;
...
F_75 ( & V_12 -> V_20 [ V_104 ] , 0 ) ;
for ( V_104 = 0 ; V_104 <= V_28 ; V_104 ++ )
F_76 ( & V_12 -> V_20 [ V_104 ] ) ;
F_75 ( & V_12 -> V_13 , 0 ) ;
F_76 ( & V_12 -> V_13 ) ;
F_77 ( V_12 , V_103 ) ;
V_12 = NULL ;
