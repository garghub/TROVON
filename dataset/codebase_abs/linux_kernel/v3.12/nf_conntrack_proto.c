...
static int F_21 ( struct V_24 * V_25 , void * V_26 )
{
return F_22 ( V_25 ) == ( (struct V_15 * ) V_26 ) -> V_10 ;
}
static int F_23 ( struct V_24 * V_25 , void * V_26 )
{
struct V_9 * V_11 ;
V_11 = (struct V_9 * ) V_26 ;
return F_24 ( V_25 ) == V_11 -> V_11 &&
F_22 ( V_25 ) == V_11 -> V_10 ;
}
static struct V_27 * F_25 ( struct V_1 * V_1 ,
struct V_15 * V_10 )
{
if ( V_10 -> V_10 == V_28 )
...
{
int V_31 = 0 ;
struct V_27 * V_32 = F_25 ( V_1 , V_10 ) ;
if ( V_32 == NULL )
return 0 ;
#if F_27 ( V_33 ) && F_27 ( V_34 )
if ( V_32 -> V_5 != NULL ) {
V_31 = F_1 ( V_1 ,
& V_32 -> V_2 ,
V_10 -> V_35 ,
...
return F_26 ( V_1 , V_36 ) ;
}
void F_36 ( struct V_15 * V_36 )
{
F_37 ( V_36 -> V_10 >= V_12 ) ;
F_30 ( & V_42 ) ;
F_37 ( F_31 ( V_43 [ V_36 -> V_10 ] ,
F_32 ( & V_42 )
) != V_36 ) ;
F_33 ( V_43 [ V_36 -> V_10 ] ,
& V_18 ) ;
...
{
F_28 ( V_1 , V_36 ) ;
F_40 ( V_1 , F_21 , V_36 , 0 , 0 ) ;
}
static struct V_47 * F_41 ( struct V_1 * V_1 ,
struct V_9 * V_11 )
{
if ( V_11 -> V_48 ) {
return V_11 -> V_48 ( V_1 ) ;
} else if ( V_11 -> V_49 ) {
return F_42 ( V_1 , * V_11 -> V_49 ) ;
}
return NULL ;
}
static
...
V_50 -> V_8 -- ;
F_45 ( V_1 , V_50 , V_11 ) ;
F_40 ( V_1 , F_23 , V_11 , 0 , 0 ) ;
}
int F_53 ( struct V_1 * V_1 )
{
int V_31 ;
struct V_47 * V_50 = F_41 ( V_1 ,
& V_14 ) ;
V_31 = V_14 . V_46 ( V_1 ,
V_14 . V_10 ) ;
if ( V_31 < 0 )
