...
memcpy ( V_236 -> V_68 , V_234 -> V_67 , V_243 ) ;
V_236 -> V_73 = 0 ;
++ V_236 ;
++ V_240 ;
if ( -- V_239 == 0 ) {
if ( F_104 ( & V_238 ) ) {
V_86 = F_105 ( sizeof( * V_86 ) , V_204 ) ;
if ( ! V_86 )
break;
V_86 -> V_218 = F_106 (
& V_5 -> V_97 -> V_244 , V_102 ,
& V_86 -> V_67 , V_204 ) ;
if ( ! V_86 -> V_218 ) {
F_84 ( V_86 ) ;
break;
...
V_86 = F_107 (
& V_238 , struct V_85 , V_245 ) ;
F_108 ( & V_86 -> V_245 ) ;
}
F_109 ( & V_86 -> V_245 , & V_5 -> V_241 ) ;
...
struct V_233 * V_234 ;
struct V_85 * V_86 ;
while ( ! F_104 ( & V_5 -> V_246 ) ) {
V_234 = F_107 ( & V_5 -> V_246 ,
struct V_233 , V_245 ) ;
F_108 ( & V_234 -> V_245 ) ;
F_84 ( V_234 ) ;
}
while ( ! F_104 ( & V_5 -> V_241 ) ) {
V_86 = F_107 ( & V_5 -> V_241 ,
struct V_85 , V_245 ) ;
F_108 ( & V_86 -> V_245 ) ;
F_110 ( & V_5 -> V_97 -> V_244 , V_102 ,
V_86 -> V_218 , V_86 -> V_67 ) ;
...
unsigned V_3 ;
struct V_1 * V_2 ;
V_5 -> V_2 = F_113 ( sizeof( struct V_1 ) * V_5 -> V_21 , V_204 ) ;
if ( ! V_5 -> V_2 )
return - V_247 ;
...
static void F_117 ( struct V_6 * V_5 )
{
struct V_1 * V_2 ;
unsigned int V_87 ;
for ( V_87 = 0 ; V_87 < V_5 -> V_21 ; ++ V_87 ) {
...
static int F_118 ( struct V_6 * V_5 )
{
struct V_97 * V_97 = V_5 -> V_97 ;
unsigned V_3 , V_98 , V_249 , V_190 ;
T_5 V_109 , V_250 ;
struct V_1 * V_2 ;
int V_17 ;
V_249 = F_119 ( V_97 , V_251 ) ;
if ( ! V_249 )
return - V_252 ;
F_120 ( V_97 , V_249 + V_253 , & V_109 ) ;
F_120 ( V_97 , V_249 + V_254 , & V_250 ) ;
V_190 = V_5 -> V_255 ;
...
L_23 ,
F_121 ( V_97 -> V_256 ) , V_97 -> V_256 -> V_257 ,
F_122 ( V_98 ) , F_123 ( V_98 ) ) ;
...
int F_124 ( struct V_6 * V_5 )
{
struct V_259 * V_65 = V_5 -> V_65 ;
struct V_82 * V_82 ;
int V_17 ;
F_69 ( V_260 + 1 >= V_4 ) ;
F_69 ( V_4 & ( ( 1 << V_26 ) - 1 ) ) ;
...
V_82 -> V_263 = V_71 ;
V_82 -> V_14 = V_5 -> V_14 ;
V_82 -> V_264 = V_5 -> V_265 ;
V_82 -> V_240 = 1 + V_5 -> V_21 ;
V_82 -> V_266 = V_5 -> V_266 ;
V_17 = F_112 ( V_5 ) ;
if ( V_17 )
goto V_267;
F_116 ( & V_5 -> V_203 ) ;
F_114 ( & V_5 -> V_81 , F_101 ) ;
F_102 ( & V_5 -> V_246 ) ;
F_102 ( & V_5 -> V_241 ) ;
V_17 = F_118 ( V_5 ) ;
if ( V_17 )
goto V_268;
F_70 () ;
memcpy ( V_82 -> V_242 [ 0 ] . V_68 ,
V_65 -> V_269 , V_243 ) ;
V_5 -> V_123 = V_5 -> V_21 ;
F_72 () ;
F_8 ( V_5 , true ) ;
V_17 = F_125 ( V_5 -> V_97 , V_5 -> V_21 ) ;
if ( V_17 )
goto V_270;
F_126 ( V_5 , V_271 , V_65 ,
L_24 ,
V_5 -> V_21 , F_2 ( V_5 ) ) ;
return 0 ;
V_270:
...
void F_130 ( struct V_226 * V_33 , T_6 * V_89 )
{
struct V_6 * V_5 = V_33 -> V_5 ;
struct V_1 * V_2 ;
unsigned V_272 , V_273 , type , V_232 ;
V_272 = F_131 ( * V_89 , V_274 ) ;
F_69 ( V_275 != 0 ) ;
V_273 = F_131 ( * V_89 , V_105 ) ;
type = F_131 ( * V_89 , V_107 ) ;
V_232 = F_131 ( * V_89 , V_276 ) ;
F_132 ( V_5 , V_64 , V_5 -> V_65 ,
L_25 ,
V_272 , V_273 , type , V_232 ) ;
if ( F_44 ( V_5 , V_272 , & V_2 , NULL ) )
return;
if ( V_2 -> V_208 )
goto error;
if ( type == V_277 ) {
...
case V_280 :
case V_281 :
V_2 -> V_207 |= ( T_3 ) V_232 << ( V_2 -> V_278 << 4 ) ;
++ V_2 -> V_278 ;
return;
case V_282 :
...
void F_133 ( struct V_6 * V_5 , unsigned V_122 )
{
struct V_1 * V_2 ;
if ( V_122 > V_5 -> V_123 )
return;
V_2 = V_5 -> V_2 + V_122 ;
F_126 ( V_5 , V_64 , V_5 -> V_65 ,
L_27 , V_2 -> V_66 ) ;
V_2 -> V_91 = 0 ;
F_82 ( V_2 ) ;
F_66 ( V_2 ) ;
...
void F_134 ( struct V_6 * V_5 )
{
struct V_82 * V_82 = V_5 -> V_82 . V_67 ;
if ( ! V_5 -> V_123 )
return;
memcpy ( V_82 -> V_242 [ 0 ] . V_68 ,
V_5 -> V_65 -> V_269 , V_243 ) ;
F_32 ( V_80 , & V_5 -> V_81 ) ;
}
void F_135 ( struct V_6 * V_5 , T_6 * V_89 )
{
struct V_1 * V_2 ;
unsigned V_283 , V_272 ;
V_283 = F_131 ( * V_89 , V_284 ) ;
if ( F_44 ( V_5 , V_283 , & V_2 , & V_272 ) )
return;
if ( ! F_73 ( V_272 , V_2 -> V_165 ) )
return;
F_136 ( V_272 , V_2 -> V_165 ) ;
-- V_2 -> V_166 ;
if ( F_63 ( V_2 ) )
F_137 ( & V_2 -> V_189 ) ;
}
void F_138 ( struct V_6 * V_5 , T_6 * V_89 )
{
struct V_1 * V_2 ;
unsigned V_285 , V_283 , V_272 ;
V_283 = F_131 ( * V_89 , V_286 ) ;
V_285 = F_131 ( * V_89 ,
V_287 ) ;
if ( F_44 ( V_5 , V_283 , & V_2 , & V_272 ) )
return;
if ( ! F_73 ( V_272 , V_2 -> V_150 ) )
return;
if ( V_285 ) {
F_139 ( V_272 , V_2 -> V_177 ) ;
F_140 ( & V_2 -> V_176 ) ;
} else {
F_136 ( V_272 , V_2 -> V_150 ) ;
-- V_2 -> V_151 ;
}
if ( F_63 ( V_2 ) )
F_137 ( & V_2 -> V_189 ) ;
}
void F_141 ( struct V_6 * V_5 , unsigned V_288 )
{
struct V_1 * V_2 ;
unsigned int V_289 ;
if ( F_44 ( V_5 , V_288 , & V_2 , & V_289 ) )
return;
if ( F_47 () )
F_48 ( V_5 , V_64 , V_5 -> V_65 ,
L_28 ,
...
int F_148 ( struct V_259 * V_65 , int V_122 , T_8 * V_290 )
{
struct V_6 * V_5 = F_149 ( V_65 ) ;
struct V_1 * V_2 ;
if ( V_122 >= V_5 -> V_123 )
return - V_291 ;
V_2 = V_5 -> V_2 + V_122 ;
F_59 ( & V_2 -> V_90 ) ;
memcpy ( V_2 -> V_67 . V_68 , V_290 , V_243 ) ;
F_31 ( V_2 ) ;
F_60 ( & V_2 -> V_90 ) ;
return 0 ;
}
int F_150 ( struct V_259 * V_65 , int V_122 ,
T_5 V_61 , T_8 V_292 )
{
struct V_6 * V_5 = F_149 ( V_65 ) ;
struct V_1 * V_2 ;
...
V_2 = V_5 -> V_2 + V_122 ;
F_59 ( & V_2 -> V_90 ) ;
V_73 = ( V_61 & V_74 ) | ( ( V_292 & 0x7 ) << V_293 ) ;
V_2 -> V_67 . V_73 = F_151 ( V_73 ) ;
F_31 ( V_2 ) ;
F_60 ( & V_2 -> V_90 ) ;
return 0 ;
}
int F_152 ( struct V_259 * V_65 , int V_122 ,
bool V_294 )
{
struct V_6 * V_5 = F_149 ( V_65 ) ;
struct V_1 * V_2 ;
...
int F_153 ( struct V_259 * V_65 , int V_122 ,
struct V_297 * V_298 )
{
struct V_6 * V_5 = F_149 ( V_65 ) ;
struct V_1 * V_2 ;
...
V_2 = V_5 -> V_2 + V_122 ;
V_298 -> V_2 = V_122 ;
memcpy ( V_298 -> V_290 , V_2 -> V_67 . V_68 , V_243 ) ;
V_298 -> V_299 = 0 ;
V_73 = F_23 ( V_2 -> V_67 . V_73 ) ;
V_298 -> V_61 = V_73 & V_74 ;
V_298 -> V_292 = ( V_73 >> V_293 ) & 0x7 ;
V_298 -> V_294 = V_2 -> V_69 == V_72 ;
return 0 ;
}
