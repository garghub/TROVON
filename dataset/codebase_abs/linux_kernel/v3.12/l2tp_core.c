...
V_32 -> V_68 = V_74 ;
V_57 -> V_66 = F_55 ( & V_146 -> V_70 , & V_146 -> V_71 , V_144 ,
V_72 , V_73 ) ;
if ( V_57 -> V_66 == 0 )
V_57 -> V_66 = V_150 ;
} else {
V_32 -> V_68 = V_151 ;
V_32 -> V_152 = F_99 ( V_32 ) - V_32 -> V_153 ;
V_32 -> V_154 = F_100 ( struct V_56 , V_66 ) ;
V_57 -> V_66 = ~ F_55 ( & V_146 -> V_70 , & V_146 -> V_71 ,
V_144 , V_72 , 0 ) ;
}
}
int F_101 ( struct V_15 * V_20 , struct V_31 * V_32 , int V_155 )
{
int V_136 = V_32 -> V_59 ;
struct V_1 * V_8 = V_20 -> V_8 ;
...
memset ( & ( F_103 ( V_32 ) -> V_163 ) , 0 , sizeof( F_103 ( V_32 ) -> V_163 ) ) ;
F_103 ( V_32 ) -> V_126 &= ~ ( V_164 | V_165 |
V_166 ) ;
F_104 ( V_32 ) ;
F_105 ( V_3 ) ;
if ( F_106 ( V_3 ) ) {
...
V_20 = F_122 ( V_188 , struct V_15 , V_190 ) ;
F_69 ( V_20 , V_178 ,
L_30 , V_20 -> V_39 ) ;
F_123 ( & V_20 -> V_190 ) ;
if ( V_20 -> V_91 != NULL )
...
struct V_11 * V_2 = NULL ;
struct V_2 * V_3 = NULL ;
V_8 = F_130 ( V_194 , struct V_1 , V_195 ) ;
V_3 = F_9 ( V_8 ) ;
if ( ! V_3 )
return;
V_2 = V_3 -> V_14 ;
...
V_10 = F_137 ( V_2 , (struct V_217 * ) & V_206 ,
sizeof( V_206 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_206 . V_213 = V_211 ;
...
V_10 = F_137 ( V_2 , (struct V_217 * ) & V_202 ,
sizeof( V_202 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_202 . V_220 = V_219 ;
...
sizeof( V_208 . V_228 ) ) ;
V_208 . V_229 = V_30 ;
V_10 = F_137 ( V_2 , (struct V_217 * ) & V_208 ,
sizeof( V_208 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_208 . V_227 = V_211 ;
...
V_204 . V_229 = V_30 ;
V_10 = F_137 ( V_2 , (struct V_217 * ) & V_204 ,
sizeof( V_204 ) ) ;
if ( V_10 < 0 )
goto V_12;
V_204 . V_227 = V_219 ;
...
V_204 . V_229 = V_127 ;
V_10 = F_138 ( V_2 , (struct V_217 * ) & V_204 ,
sizeof( V_204 ) , 0 ) ;
if ( V_10 < 0 )
goto V_12;
}
...
int F_139 ( struct V_6 * V_6 , int V_13 , int V_96 , T_1 V_30 , T_1 V_127 , struct V_197 * V_198 , struct V_1 * * V_230 )
{
struct V_1 * V_8 = NULL ;
int V_10 ;
struct V_11 * V_2 = NULL ;
...
V_8 = F_143 ( sizeof( struct V_1 ) , V_236 ) ;
if ( V_8 == NULL ) {
V_10 = - V_237 ;
goto V_10;
}
...
V_8 -> V_65 = true ;
V_76 -> V_77 = V_146 -> V_70 . V_240 [ 3 ] ;
V_76 -> V_241 = V_146 -> V_242 . V_240 [ 3 ] ;
V_76 -> V_78 = V_146 -> V_71 . V_240 [ 3 ] ;
} else {
V_8 -> V_65 = false ;
}
}
...
V_8 -> V_129 = V_129 ;
if ( V_129 == V_130 ) {
F_115 ( V_3 ) -> V_179 = V_243 ;
F_115 ( V_3 ) -> V_180 = F_84 ;
F_115 ( V_3 ) -> V_181 = F_126 ;
#if F_53 ( V_62 )
if ( V_3 -> V_63 == V_64 && ! V_8 -> V_65 )
F_146 () ;
else
...
V_8 -> V_2 = V_3 ;
V_8 -> V_13 = V_13 ;
F_148 ( & V_3 -> V_244 . V_245 , & V_246 , L_36 ) ;
V_3 -> V_247 = V_248 ;
F_149 ( & V_8 -> V_195 , F_129 ) ;
F_150 ( & V_8 -> V_185 ) ;
F_5 ( & V_186 ) ;
F_151 ( V_8 ) ;
F_34 ( & V_17 -> V_184 ) ;
F_152 ( & V_8 -> V_185 , & V_17 -> V_249 ) ;
F_41 ( & V_17 -> V_184 ) ;
V_10 = 0 ;
V_10:
if ( V_230 )
...
{
F_118 ( V_8 ) ;
return ( false == F_154 ( V_251 , & V_8 -> V_195 ) ) ;
}
...
struct V_15 * F_160 ( int V_255 , struct V_1 * V_8 , T_1 V_16 , T_1 V_128 , struct V_256 * V_198 )
{
struct V_15 * V_20 ;
V_20 = F_143 ( sizeof( struct V_15 ) + V_255 , V_236 ) ;
if ( V_20 != NULL ) {
V_20 -> V_110 = V_111 ;
V_20 -> V_8 = V_8 ;
V_20 -> V_16 = V_16 ;
...
if ( V_262 )
goto V_12;
V_251 = F_171 ( L_38 , V_264 | V_265 , 0 ) ;
if ( ! V_251 ) {
F_140 ( L_39 ) ;
V_262 = - V_237 ;
goto V_12;
