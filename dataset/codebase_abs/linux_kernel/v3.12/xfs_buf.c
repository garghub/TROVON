...
V_153:
F_56 ( & V_2 -> V_143 ) ;
V_151 = V_154 >> ( V_64 - V_119 ) ;
if ( V_151 > V_150 )
V_151 = V_150 ;
V_144 = F_141 ( V_155 , V_151 ) ;
...
if ( V_57 > V_56 )
V_57 = V_56 ;
V_160 = F_142 ( V_144 , V_2 -> V_50 [ V_149 ] , V_57 ,
V_58 ) ;
if ( V_160 < V_57 )
break;
V_58 = 0 ;
...
F_140 ( V_2 , V_30 , & V_58 , & V_56 , V_148 ) ;
if ( V_2 -> V_131 )
break;
if ( V_56 <= 0 )
break;
...
while ( V_176 < V_180 ) {
struct V_53 * V_53 ;
int V_149 , V_181 , V_182 ;
V_149 = ( V_176 + V_2 -> V_6 ) >> V_64 ;
...
F_159 ( V_191 ) ;
int V_194 = 0 ;
while ( F_160 ( & V_75 -> V_15 ) ) {
F_161 ( & V_75 -> V_15 , F_154 ,
& V_191 , V_195 ) ;
while ( ! F_33 ( & V_191 ) ) {
struct V_1 * V_2 ;
V_2 = F_162 ( & V_191 , struct V_1 , V_16 ) ;
F_163 ( & V_2 -> V_16 ) ;
F_61 ( V_2 ) ;
}
if ( V_194 ++ != 0 )
...
V_202 = F_168 ( & V_75 -> V_15 , V_200 -> V_204 , F_165 ,
& V_191 , & V_203 ) ;
while ( ! F_33 ( & V_191 ) ) {
struct V_1 * V_2 ;
V_2 = F_162 ( & V_191 , struct V_1 , V_16 ) ;
...
struct V_25 * V_75 = F_114 ( V_198 ,
struct V_25 , V_201 ) ;
return F_170 ( & V_75 -> V_15 , V_200 -> V_204 ) ;
}
void
F_171 (
struct V_141 * V_142 ,
...
{
V_75 -> V_210 = V_207 ;
V_75 -> V_86 = F_176 ( V_208 ) - 1 ;
V_75 -> V_87 = V_208 - 1 ;
if ( F_177 ( V_75 -> V_157 , V_208 ) ) {
char V_211 [ V_212 ] ;
F_178 ( V_75 -> V_157 , V_211 ) ;
F_66 ( V_75 -> V_88 ,
L_5 ,
V_208 , V_211 ) ;
return V_213 ;
...
unsigned int V_208 )
{
return F_175 ( V_75 , V_207 , V_208 , 1 ) ;
}
T_13 *
F_182 (
struct V_141 * V_142 ,
...
{
T_13 * V_75 ;
V_75 = F_12 ( sizeof( * V_75 ) , V_218 | V_23 ) ;
V_75 -> V_88 = V_142 ;
V_75 -> V_219 = V_215 -> V_220 ;
V_75 -> V_157 = V_215 ;
V_75 -> V_110 = F_183 ( V_215 ) ;
if ( ! V_75 -> V_110 )
goto error;
if ( F_179 ( V_75 , V_215 ) )
goto error;
if ( F_184 ( & V_75 -> V_15 ) )
goto error;
V_75 -> V_201 . V_221 = F_169 ;
V_75 -> V_201 . V_222 = F_167 ;
V_75 -> V_201 . V_223 = V_224 ;
V_75 -> V_201 . V_29 = V_225 ;
F_185 ( & V_75 -> V_201 ) ;
return V_75 ;
error:
F_14 ( V_75 ) ;
...
struct V_187 * V_229 )
{
struct V_1 * V_230 = F_114 ( V_228 , struct V_1 , V_37 ) ;
struct V_1 * V_2 = F_114 ( V_229 , struct V_1 , V_37 ) ;
T_7 V_231 ;
...
F_194 ( & V_2 -> V_37 , V_233 ) ;
F_195 ( V_2 , V_48 ) ;
}
F_196 ( NULL , V_233 , F_190 ) ;
F_146 ( & V_163 ) ;
F_192 (bp, n, io_list, b_list) {
V_2 -> V_7 &= ~ ( V_9 | V_34 ) ;
V_2 -> V_7 |= V_104 ;
if ( ! V_123 ) {
V_2 -> V_7 |= V_34 ;
...
{
F_159 ( V_233 ) ;
return F_191 ( V_232 , & V_233 , false ) ;
}
int
F_198 (
struct V_187 * V_232 )
...
int error = 0 , V_236 ;
struct V_1 * V_2 ;
F_191 ( V_232 , & V_233 , true ) ;
while ( ! F_33 ( & V_233 ) ) {
V_2 = F_162 ( & V_233 , struct V_1 , V_37 ) ;
F_163 ( & V_2 -> V_37 ) ;
V_236 = F_71 ( V_2 ) ;
F_67 ( V_2 ) ;
if ( ! error )
