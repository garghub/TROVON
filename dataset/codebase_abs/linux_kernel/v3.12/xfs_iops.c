...
ASSERT ( ( V_108 & ( V_124 | V_125 | V_145 | V_165 |
V_166 | V_167 | V_168 ) ) == 0 ) ;
if ( ! ( V_30 & V_169 ) ) {
V_163 |= V_170 ;
F_82 ( V_6 , V_163 ) ;
...
V_161 = V_1 -> V_171 ;
V_162 = V_105 -> V_172 ;
if ( V_162 == 0 && V_161 == 0 && V_6 -> V_77 . V_173 == 0 ) {
...
goto V_174;
if ( V_162 > V_161 ) {
error = F_102 ( V_6 , V_162 , V_161 ) ;
if ( error )
goto V_174;
}
if ( V_161 != V_6 -> V_77 . V_175 && V_162 > V_6 -> V_77 . V_175 ) {
error = - F_103 ( F_23 ( V_6 ) -> V_176 ,
V_6 -> V_77 . V_175 , V_162 ) ;
if ( error )
goto V_174;
}
F_104 ( V_1 ) ;
error = - F_105 ( V_1 -> V_176 , V_162 , V_177 ) ;
if ( error )
goto V_174;
V_104 = F_79 ( V_71 , V_178 ) ;
error = F_80 ( V_104 , & F_81 ( V_71 ) -> V_179 , 0 , 0 ) ;
if ( error )
goto V_136;
F_106 ( V_1 , V_162 ) ;
V_164 = V_180 ;
...
F_91 ( V_104 , V_6 , V_158 ) ;
if ( V_162 <= V_161 ) {
error = F_108 ( & V_104 , V_6 , V_181 , V_162 ) ;
if ( error )
goto V_182;
F_109 ( V_6 , V_183 ) ;
F_110 ( V_6 ) ;
...
return - F_99 ( F_2 ( V_15 -> V_40 ) , V_105 , 0 ) ;
return - F_69 ( F_2 ( V_15 -> V_40 ) , V_105 , 0 ) ;
}
STATIC int
F_112 (
struct V_1 * V_1 ,
...
int error ;
F_113 ( V_6 ) ;
V_104 = F_79 ( V_71 , V_187 ) ;
error = F_80 ( V_104 , & F_81 ( V_71 ) -> V_188 , 0 , 0 ) ;
if ( error ) {
F_98 ( V_104 , 0 ) ;
return - error ;
}
...
if ( V_30 & V_189 ) {
V_1 -> V_91 = * V_186 ;
V_6 -> V_77 . V_154 . V_148 = ( V_190 ) V_186 -> V_149 ;
V_6 -> V_77 . V_154 . V_150 = ( V_190 ) V_186 -> V_151 ;
}
if ( V_30 & V_191 ) {
V_1 -> V_90 = * V_186 ;
V_6 -> V_77 . V_157 . V_148 = ( V_190 ) V_186 -> V_149 ;
V_6 -> V_77 . V_157 . V_150 = ( V_190 ) V_186 -> V_151 ;
}
if ( V_30 & V_192 ) {
V_1 -> V_88 = * V_186 ;
V_6 -> V_77 . V_147 . V_148 = ( V_190 ) V_186 -> V_149 ;
V_6 -> V_77 . V_147 . V_150 = ( V_190 ) V_186 -> V_151 ;
}
F_88 ( V_104 , V_6 , V_107 ) ;
F_91 ( V_104 , V_6 , V_193 ) ;
return - F_94 ( V_104 , 0 ) ;
}
STATIC int
F_114 (
...
if ( V_196 -> V_204 == - 1LL )
return 0 ;
V_201 = F_115 ( V_196 -> V_205 ) ;
V_202 = F_115 ( V_196 -> V_204 ) ;
V_203 = F_115 ( V_196 -> V_206 ) ;
...
struct V_195 V_216 ;
int error ;
error = F_118 ( V_199 , V_217 ) ;
if ( error )
return error ;
V_216 . V_205 = F_119 ( V_215 ) ;
if ( V_203 == V_218 )
V_216 . V_206 = - 1LL ;
else
V_216 . V_206 = F_119 ( V_203 ) ;
V_216 . V_219 = ! V_199 -> V_220 ? V_221 :
V_199 -> V_220 + 1 ;
V_216 . V_219 = F_120 ( V_222 , V_216 . V_219 ,
...
V_216 . V_224 |= V_231 ;
error = F_121 ( V_6 , & V_216 , F_114 , V_199 ) ;
if ( error )
return - error ;
return 0 ;
}
...
F_126 ( V_1 , V_6 -> V_77 . V_80 ) ;
V_1 -> V_82 = F_127 ( V_6 -> V_77 . V_141 ) ;
V_1 -> V_84 = F_128 ( V_6 -> V_77 . V_143 ) ;
switch ( V_1 -> V_41 & V_20 ) {
case V_95 :
case V_96 :
V_1 -> V_246 =
...
case V_45 :
V_1 -> V_250 = & V_259 ;
if ( ! ( V_6 -> V_99 . V_260 & V_261 ) )
V_1 -> V_176 -> V_254 = & V_255 ;
break;
default:
V_1 -> V_250 = & V_251 ;
F_130 ( V_1 , V_1 -> V_41 , V_1 -> V_246 ) ;
break;
}
if ( ! F_131 ( V_6 ) ) {
F_132 ( V_1 ) ;
