...
static void F_40 ( struct V_77 * V_78 , struct V_2 * V_3 )
{
struct V_1 * V_12 = F_1 ( V_3 ) ;
V_82 [ 0 ] . V_86 = 0 ;
F_41 ( V_3 ) ;
...
static struct V_2 * F_44 ( struct V_115 * V_116 )
{
struct V_117 * V_118 ;
struct V_1 * V_12 ;
V_12 = F_45 ( sizeof( * V_12 ) , V_104 ) ;
if ( ! V_12 )
return F_46 ( - V_119 ) ;
F_47 ( & V_12 -> V_66 ) ;
V_12 -> V_4 . V_120 = F_25 ;
...
V_12 -> V_4 . V_5 . V_123 = V_81 ;
V_12 -> V_4 . V_5 . V_124 = F_28 ;
V_12 -> V_4 . V_5 . V_125 = F_12 ;
V_12 -> V_4 . V_5 . V_126 = F_7 ;
V_12 -> V_4 . V_5 . V_127 = F_18 ;
V_118 = F_2 ( V_116 , struct V_117 , V_128 ) ;
V_12 -> V_18 = V_118 -> V_18 ;
V_12 -> V_4 . V_5 . V_129 = F_40 ;
V_12 -> V_4 . V_5 . V_130 = F_42 ;
return & V_12 -> V_4 . V_5 ;
}
static inline struct V_117 * F_48 ( struct V_131 * V_132 )
{
return F_2 ( F_49 ( V_132 ) , struct V_117 ,
V_128 . V_133 ) ;
}
static T_3 F_50 ( struct V_131 * V_132 ,
struct V_134 * V_135 ,
char * V_136 )
{
struct V_117 * V_118 = F_48 ( V_132 ) ;
struct V_137 * V_138 =
F_2 ( V_135 , struct V_137 , V_135 ) ;
T_3 V_139 = 0 ;
if ( V_138 -> V_140 )
V_139 = V_138 -> V_140 ( V_118 , V_136 ) ;
return V_139 ;
}
...
static T_3 F_53 ( struct V_117 * V_118 , char * V_136 )
{
return sprintf ( V_136 , L_19 , V_118 -> V_18 ) ;
}
...
static struct V_115 * F_56 ( void )
{
struct V_117 * V_118 ;
int V_139 ;
V_118 = F_45 ( sizeof( * V_118 ) , V_104 ) ;
if ( ! V_118 )
return F_46 ( - V_119 ) ;
V_118 -> V_128 . V_141 = F_54 ;
V_139 = F_57 ( & V_118 -> V_18 ) ;
if ( V_139 ) {
F_43 ( V_118 ) ;
return F_46 ( V_139 ) ;
}
F_58 ( & V_118 -> V_128 . V_133 , L_20 ,
& V_142 ) ;
return & V_118 -> V_128 ;
}
