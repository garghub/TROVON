...
static bool F_28 ( struct V_41 * V_42 , void * V_43 )
{
...
static T_3 F_39 ( T_3 V_58 , T_3 V_59 )
{
V_58 -= V_59 ;
if ( V_58 == 0 )
return 0 ;
...
static bool F_41 ( T_3 V_58 , T_3 V_59 )
{
if ( ! V_58 || ! V_59 )
return true ;
return F_40 ( V_58 ) == F_40 ( V_59 ) ;
}
...
V_62 = F_39 ( V_61 ,
V_2 -> V_38 ) ;
if ( F_41 ( V_61 , V_2 -> V_38 ) )
V_26 = false ;
if ( F_41 ( V_62 , V_2 -> V_39 ) )
V_26 = false ;
V_2 -> V_38 = V_61 ;
V_2 -> V_39 = V_62 ;
return V_26 ;
...
V_2 = & V_69 -> V_68 ;
V_2 -> V_66 = V_69 ;
V_70 = F_23 ( V_2 , V_69 -> V_72 . V_32 , 0 ) ;
if ( V_70 && V_2 -> V_13 == NULL )
F_44 ( V_69 ) ;
return V_70 ;
}
struct V_65 * F_46 ( struct V_73 * V_74 )
{
struct V_65 * V_66 ;
...
if ( ! F_59 ( V_74 ) )
return 0 ;
F_60 ( V_76 , & V_74 -> V_88 -> V_75 ) ;
return F_55 ( V_74 ) ;
}
int F_61 ( struct V_73 * V_74 , unsigned long V_89 )
{
struct V_65 * V_66 = V_74 -> V_88 ;
int V_26 ;
F_24 ( & V_74 -> V_90 ) ;
if ( F_62 ( V_76 , & V_66 -> V_75 ) ) {
V_74 -> V_91 = V_89 ;
V_74 -> V_92 = V_53 ;
}
F_25 ( & V_74 -> V_90 ) ;
