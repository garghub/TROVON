...
V_112 = F_37 ( V_117 , V_118 ) ;
if ( ! V_112 )
goto V_119;
error = 0 ;
for ( V_27 = 0 ; V_27 < V_110 . V_113 ; V_27 ++ ) {
V_109 [ V_27 ] . V_120 = F_38 ( ( char * ) V_112 ,
F_21 ( V_109 [ V_27 ] . V_121 ) ,
V_117 ) ;
if ( V_109 [ V_27 ] . V_120 == 0 || V_109 [ V_27 ] . V_120 == V_117 )
error = - V_122 ;
if ( V_109 [ V_27 ] . V_120 < 0 )
break;
switch ( V_109 [ V_27 ] . V_123 ) {
case V_124 :
V_109 [ V_27 ] . V_120 = F_39 (
V_92 -> V_107 , V_112 ,
F_21 ( V_109 [ V_27 ] . V_125 ) ,
& V_109 [ V_27 ] . V_126 , V_109 [ V_27 ] . V_127 ) ;
break;
case V_128 :
V_109 [ V_27 ] . V_120 = F_40 ( V_94 ) ;
if ( V_109 [ V_27 ] . V_120 )
break;
V_109 [ V_27 ] . V_120 = F_41 (
V_92 -> V_107 , V_112 ,
F_21 ( V_109 [ V_27 ] . V_125 ) ,
V_109 [ V_27 ] . V_126 , V_109 [ V_27 ] . V_127 ) ;
F_42 ( V_94 ) ;
...
if ( V_109 [ V_27 ] . V_120 )
break;
V_109 [ V_27 ] . V_120 = F_43 (
V_92 -> V_107 , V_112 ,
V_109 [ V_27 ] . V_127 ) ;
F_42 ( V_94 ) ;
break;
default:
V_109 [ V_27 ] . V_120 = V_78 ;
}
}
...
sizeof( T_26 ) ) )
return - F_4 ( V_11 ) ;
V_92 = F_25 ( V_94 , & V_132 . V_83 ) ;
if ( F_28 ( V_92 ) )
return F_29 ( V_92 ) ;
if ( F_46 ( V_92 -> V_107 ) || F_47 ( V_92 -> V_107 ) ) {
error = - F_4 ( V_72 ) ;
goto V_134;
}
if ( F_3 ( & V_131 , F_21 ( V_132 . V_135 ) , sizeof( V_131 ) ) ) {
error = - F_4 ( V_11 ) ;
goto V_134;
}
error = - F_48 ( F_32 ( V_92 -> V_107 ) , V_131 . V_136 ,
V_131 . V_137 ) ;
V_134:
F_34 ( V_92 ) ;
return error ;
...
unsigned long V_59 )
{
struct V_139 * V_139 = F_50 ( V_138 ) ;
struct V_140 * V_141 = F_32 ( V_139 ) ;
...
if ( F_1 ( & V_1 , V_95 ) )
return - F_4 ( V_11 ) ;
V_66 = F_54 ( V_66 , struct V_184 ) ;
return F_55 ( V_141 , V_139 , V_138 , V_143 , V_66 , & V_1 ) ;
}
case V_185 :
...
if ( F_24 ( & V_83 , V_95 ) )
return - F_4 ( V_11 ) ;
return F_59 ( V_138 , & V_83 ) ;
}
case V_202 : {
struct V_200 V_83 ;
if ( F_24 ( & V_83 , V_95 ) )
return - F_4 ( V_11 ) ;
return F_60 ( V_138 , & V_83 ) ;
}
case V_203 :
return F_27 ( V_138 , V_95 ) ;
case V_204 :
return F_35 ( V_138 , V_95 ) ;
case V_205 :
return F_45 ( V_138 , V_95 ) ;
default:
return - F_4 ( V_206 ) ;
}
}
