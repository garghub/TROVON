...
static int F_85 ( struct V_145 * V_140 , struct V_1 * V_2 )
{
enum V_161 V_162 ;
V_162 = F_86 ( V_140 , V_2 ) ;
switch ( V_162 ) {
case V_163 :
F_87 ( V_2 , V_164 ) ;
return V_165 ;
...
int F_98 ( struct V_145 * V_140 , struct V_1 * V_2 ,
unsigned int V_184 )
{
int V_133 = V_168 ;
int V_147 ;
...
V_193 = F_112 ( & V_2 -> V_237 -> V_238 ) ;
V_231 = F_113 ( V_2 , V_230 , V_229 ) ;
V_232 = V_231 >> V_239 ;
if ( F_114 ( V_2 -> V_237 , V_232 ) ) {
F_115 ( V_2 , V_229 , V_231 , V_230 ) ;
F_105 ( V_2 , V_235 ) ;
V_133 = V_200 ;
} else {
V_2 -> V_4 . V_240 = V_231 ;
V_2 -> V_4 . V_241 = V_229 ;
V_133 = F_116 ( V_140 , V_2 ) ;
F_105 ( V_2 , V_242 ) ;
}
F_117 ( & V_2 -> V_237 -> V_238 , V_193 ) ;
break;
}
case V_243 : {
...
static void F_120 ( struct V_1 * V_2 , T_1 V_121 )
{
...
int F_130 ( struct V_1 * V_2 , struct V_265 * V_178 )
{
int V_3 ;
V_178 -> V_5 = V_2 -> V_4 . V_5 ;
V_178 -> V_266 = F_131 ( V_2 ) ;
...
for ( V_3 = 0 ; V_3 < F_133 ( V_178 -> V_181 ) ; V_3 ++ )
V_178 -> V_181 [ V_3 ] = F_3 ( V_2 , V_3 ) ;
return 0 ;
}
int F_134 ( struct V_1 * V_2 , struct V_265 * V_178 )
{
int V_3 ;
V_2 -> V_4 . V_5 = V_178 -> V_5 ;
F_135 ( V_2 , V_178 -> V_266 ) ;
...
V_278 -> V_279 . V_280 . V_284 = F_139 ( V_2 , V_103 ) ;
...
void F_145 ( struct V_1 * V_2 , struct V_277 * V_278 )
{
...
int F_146 ( struct V_1 * V_2 , struct V_277 * V_278 )
{
...
return - V_153 ;
V_146 = F_140 ( V_2 , V_278 ) ;
if ( V_146 < 0 )
return V_146 ;
V_146 = F_144 ( V_2 , V_278 ) ;
if ( V_146 < 0 )
return V_146 ;
return F_150 ( V_2 , V_278 ) ;
}
int F_151 ( struct V_1 * V_2 , struct V_294 * V_295 )
{
int V_133 = 0 ;
union V_296 V_157 ;
int V_297 ;
long int V_3 ;
V_297 = F_152 ( V_295 -> V_298 ) ;
...
V_157 = F_153 ( V_295 -> V_298 , V_2 -> V_4 . V_303 . V_304 [ V_3 ] ) ;
break;
case V_305 :
case V_306 :
V_3 = V_295 -> V_298 - V_305 ;
V_157 = F_153 ( V_295 -> V_298 , V_2 -> V_4 . V_303 . V_307 [ V_3 ] ) ;
break;
case V_308 : {
T_1 V_54 = F_44 ( V_2 ) ;
V_157 = F_153 ( V_295 -> V_298 , V_54 ) ;
break;
}
#if F_13 ( V_97 )
case V_309 :
V_157 = F_153 ( V_295 -> V_298 , V_2 -> V_4 . V_98 ) ;
break;
#endif
case V_310 :
V_157 = F_153 ( V_295 -> V_298 , V_2 -> V_4 . V_108 ) ;
break;
case V_311 :
V_157 = F_153 ( V_295 -> V_298 , V_2 -> V_4 . V_111 ) ;
break;
case V_312 :
V_157 = F_153 ( V_295 -> V_298 , V_313 ) ;
break;
default:
V_133 = F_154 ( V_2 , V_295 -> V_298 , & V_157 ) ;
break;
}
if ( V_133 )
return V_133 ;
if ( F_155 ( ( char V_314 * ) ( unsigned long ) V_295 -> V_315 , & V_157 , V_297 ) )
V_133 = - V_316 ;
return V_133 ;
}
int F_156 ( struct V_1 * V_2 , struct V_294 * V_295 )
{
int V_133 = 0 ;
union V_296 V_157 ;
int V_297 ;
...
if ( V_297 > sizeof( V_157 ) )
return - V_153 ;
if ( F_157 ( & V_157 , ( char V_314 * ) ( unsigned long ) V_295 -> V_315 , V_297 ) )
return - V_316 ;
switch ( V_295 -> V_298 ) {
case V_299 :
case V_300 :
...
case V_302 :
V_3 = V_295 -> V_298 - V_299 ;
V_2 -> V_4 . V_303 . V_304 [ V_3 ] = F_158 ( V_295 -> V_298 , V_157 ) ;
break;
case V_305 :
case V_306 :
V_3 = V_295 -> V_298 - V_305 ;
V_2 -> V_4 . V_303 . V_307 [ V_3 ] = F_158 ( V_295 -> V_298 , V_157 ) ;
break;
case V_308 : {
T_1 V_317 = F_158 ( V_295 -> V_298 , V_157 ) ;
F_159 ( V_2 , V_317 ) ;
break;
}
#if F_13 ( V_97 )
case V_309 : {
T_1 V_318 = F_158 ( V_295 -> V_298 , V_157 ) ;
F_160 ( V_2 , V_318 ) ;
break;
}
#endif
case V_319 : {
T_1 V_320 = F_158 ( V_295 -> V_298 , V_157 ) ;
F_161 ( V_2 , V_320 ) ;
break;
}
case V_321 : {
...
case V_311 : {
T_1 V_111 = F_158 ( V_295 -> V_298 , V_157 ) ;
F_120 ( V_2 , V_111 ) ;
break;
}
case V_310 : {
T_1 V_108 = F_158 ( V_295 -> V_298 , V_157 ) ;
F_141 ( V_2 , V_108 ) ;
break;
}
default:
V_133 = F_163 ( V_2 , V_295 -> V_298 , & V_157 ) ;
break;
}
return V_133 ;
}
...
int F_165 ( struct V_1 * V_2 , struct V_324 * V_325 )
{
return - V_326 ;
}
...
{
int V_133 ;
V_133 = F_168 ( V_2 , V_328 ) ;
return V_133 ;
}
int F_169 ( struct V_237 * V_237 , struct V_329 * log )
{
return - V_326 ;
}
void F_170 ( struct V_330 * free ,
struct V_330 * V_331 )
{
}
int F_171 ( struct V_330 * V_332 ,
unsigned long V_333 )
{
return 0 ;
}
int F_172 ( struct V_237 * V_237 ,
struct V_330 * V_334 ,
struct V_335 * V_336 )
{
return 0 ;
}
void F_173 ( struct V_237 * V_237 ,
struct V_335 * V_336 ,
const struct V_330 * V_337 )
{
}
void F_174 ( struct V_237 * V_237 , struct V_330 * V_334 )
{
}
void F_160 ( struct V_1 * V_2 , T_1 V_318 )
{
#if F_13 ( V_97 )
V_2 -> V_4 . V_98 = V_318 ;
#ifdef V_16
...
void F_141 ( struct V_1 * V_2 , T_1 V_340 )
{
V_2 -> V_4 . V_108 = V_340 ;
F_55 ( V_2 ) ;
F_64 ( V_2 ) ;
}
void F_161 ( struct V_1 * V_2 , T_1 V_320 )
{
F_175 ( V_320 , & V_2 -> V_4 . V_111 ) ;
F_62 () ;
F_46 ( V_123 , V_2 ) ;
F_63 ( V_2 ) ;
}
...
void F_177 ( unsigned long V_120 )
{
struct V_1 * V_2 = (struct V_1 * ) V_120 ;
...
void F_178 ( struct V_1 * V_2 , int V_342 )
{
V_2 -> V_342 = F_179 () ;
V_155 -> V_156 . V_1 = V_2 ;
}
