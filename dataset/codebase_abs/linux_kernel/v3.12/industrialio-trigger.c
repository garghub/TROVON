...
static struct V_6 * F_60 ( const char * V_48 , T_5 V_49 )
{
struct V_6 * V_7 ;
...
struct V_6 * F_66 ( const char * V_48 , ... )
{
struct V_6 * V_7 ;
T_5 V_49 ;
va_start ( V_49 , V_48 ) ;
...
static void F_69 ( struct V_1 * V_2 , void * V_71 )
{
F_67 ( * (struct V_6 * * ) V_71 ) ;
}
static int F_70 ( struct V_1 * V_2 , void * V_71 , void * V_72 )
{
struct V_6 * * V_73 = V_71 ;
if ( ! V_73 || ! * V_73 ) {
F_71 ( ! V_73 || ! * V_73 ) ;
return 0 ;
}
...
void F_76 ( struct V_1 * V_2 , struct V_6 * V_75 )
{
int V_76 ;
V_76 = F_77 ( V_2 , F_69 ,
F_70 , V_75 ) ;
...
void F_78 ( struct V_47 * V_37 )
{
V_37 -> V_77 [ V_37 -> V_78 ++ ] =
& V_79 ;
}
void F_79 ( struct V_47 * V_37 )
{
if ( V_37 -> V_7 )
F_49 ( V_37 -> V_7 ) ;
}
int F_80 ( struct V_47 * V_37 )
{
return F_32 ( V_37 -> V_7 ,
V_37 -> V_80 ) ;
}
int F_81 ( struct V_47 * V_37 )
{
