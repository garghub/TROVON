...
#endif
V_198 = F_138 (
( unsigned short * ) F_139 ( & V_194 -> V_130 ) ,
V_127 ) ;
if ( V_198 ) {
F_135 ( & V_194 -> V_130 ,
L_21 ) ;
...
V_4 -> V_2 . V_209 = V_210 ;
V_4 -> V_2 . V_87 = V_211 ;
V_197 = F_141 ( V_194 , V_212 , 0 ) ;
if ( V_197 == NULL ) {
F_135 ( & V_194 -> V_130 , L_22 ) ;
V_198 = - V_200 ;
goto V_213;
}
V_4 -> V_2 . V_203 = F_142 ( V_197 -> V_214 , F_143 ( V_197 ) ) ;
if ( ! V_4 -> V_2 . V_203 ) {
...
V_4 -> V_116 = F_144 ( V_194 , 0 ) ;
if ( V_4 -> V_116 < 0 ) {
F_135 ( & V_194 -> V_130 , L_24 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_115 = F_144 ( V_194 , 1 ) ;
if ( V_4 -> V_115 < 0 ) {
...
F_148 ( & V_194 -> V_130 , V_4 ) ;
V_198 = F_149 ( & V_195 , & V_4 -> V_2 ) ;
#ifdef F_146
}
#endif
if ( ! V_198 )
...
static int F_159 ( struct V_193 * V_194 )
{
struct V_196 * V_197 ;
int V_198 ;
if ( V_194 -> V_199 < 0 || V_194 -> V_199 >= V_190 ) {
...
V_198 = F_138 (
( unsigned short * ) F_139 ( & V_194 -> V_130 ) , V_127 ) ;
if ( V_198 ) {
F_135 ( & V_194 -> V_130 ,
L_21 ) ;
return V_198 ;
...
V_192 . V_2 . V_203 = F_142 ( V_197 -> V_214 ,
F_143 ( V_197 ) ) ;
if ( ! V_192 . V_2 . V_203 ) {
F_135 ( & V_194 -> V_130 , L_23 ) ;
V_198 = - V_215 ;
...
struct V_182 T_5 * F_160 ( unsigned int V_2 ,
unsigned int V_224 )
{
struct V_133 V_225 ;
char V_226 [ 20 ] ;
if ( V_2 < 0 || V_2 >= V_190 )
return NULL ;
snprintf ( V_226 , 20 , V_127 L_30 , V_2 ) ;
F_156 ( & V_227 ,
V_226 ) ;
F_157 ( V_228 , 1 , 0 ) ;
if ( ! V_192 . V_2 . V_203 )
