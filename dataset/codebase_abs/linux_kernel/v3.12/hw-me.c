...
char V_33 , V_34 ;
V_2 -> V_21 = F_8 ( V_2 ) ;
V_33 = ( char ) ( ( V_2 -> V_21 & V_35 ) >> 8 ) ;
V_34 = ( char ) ( ( V_2 -> V_21 & V_36 ) >> 16 ) ;
...
int V_47 ;
int V_38 ;
F_26 ( & V_7 -> V_31 -> V_7 , V_48 , F_32 ( V_41 ) ) ;
V_38 = F_33 ( V_7 ) ;
F_26 ( & V_7 -> V_31 -> V_7 , L_3 , V_38 ) ;
V_46 = F_34 ( V_44 ) ;
if ( V_38 < 0 || V_46 > V_38 )
return - V_49 ;
...
V_2 -> V_23 = F_7 ( V_2 ) ;
V_52 = ( unsigned char ) ( ( V_2 -> V_23 & V_53 ) >> 24 ) ;
V_33 = ( char ) ( ( V_2 -> V_23 & V_54 ) >> 8 ) ;
V_34 = ( char ) ( ( V_2 -> V_23 & V_55 ) >> 16 ) ;
V_37 = ( unsigned char ) ( V_34 - V_33 ) ;
if ( V_37 > V_52 )
return - V_39 ;
F_26 ( & V_7 -> V_31 -> V_7 , L_4 , V_37 ) ;
return ( int ) V_37 ;
}
...
break;
F_26 ( & V_7 -> V_31 -> V_7 , L_9 , V_65 ) ;
F_26 ( & V_7 -> V_31 -> V_7 , L_10 ) ;
...
V_66 = F_48 ( V_7 , & V_64 ) ;
V_73:
F_26 ( & V_7 -> V_31 -> V_7 , L_11 ) ;
V_7 -> V_74 = F_49 ( V_7 ) ;
F_20 ( & V_7 -> V_27 ) ;
F_50 ( V_7 , & V_64 ) ;
return V_70 ;
}
struct V_6 * F_51 ( struct V_75 * V_31 )
{
struct V_6 * V_7 ;
