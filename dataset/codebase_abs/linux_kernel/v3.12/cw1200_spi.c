...
struct V_1 * V_2 ;
int V_55 ;
if ( V_19 -> V_56 > 52000000 )
V_19 -> V_56 = 52000000 ;
if ( V_19 -> V_56 < 1000000 )
V_19 -> V_56 = 1000000 ;
if ( V_52 -> V_57 )
V_19 -> V_20 = V_52 -> V_57 ;
if ( ! V_19 -> V_20 )
...
static int F_55 ( struct V_68 * V_53 , T_5 V_69 )
{
...
static int F_58 ( struct V_68 * V_53 )
{
return 0 ;
}
