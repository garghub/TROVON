...
if ( V_105 == V_112 )
return F_31 ( - V_23 ) ;
V_106 = F_57 ( V_11 , V_105 ) ;
return V_106 ? V_106 : F_31 ( - V_32 ) ;
}
...
bool V_14 ;
F_9 ( & V_11 -> V_19 ) ;
V_14 = F_10 ( V_20 , & V_11 -> V_21 ) ;
F_11 ( & V_11 -> V_19 ) ;
if ( ! V_14 ) {
V_66 = ( T_9 ) V_11 -> V_16 . V_66 / V_301 ;
F_18 ( L_50 , ( unsigned long long ) V_66 ) ;
F_219 ( V_11 -> V_25 , V_66 ) ;
F_220 ( V_11 -> V_25 ) ;
}
}
...
V_25 -> V_309 = & V_310 ;
V_25 -> V_13 = V_11 ;
V_281 = F_226 ( F_203 , & V_11 -> V_19 ) ;
if ( ! V_281 )
goto V_311;
F_227 ( V_281 , V_301 ) ;
V_123 = F_76 ( & V_11 -> V_79 ) ;
F_228 ( V_281 , V_123 / V_301 ) ;
F_229 ( V_281 , V_123 ) ;
F_230 ( V_281 , V_123 ) ;
F_231 ( V_281 , V_123 ) ;
F_232 ( V_281 , F_209 ) ;
...
static struct V_10 * F_233 ( struct V_5 * V_6 )
{
...
static T_10 F_245 ( struct V_5 * V_6 ,
struct V_312 * V_313 ,
const char * V_133 ,
T_5 V_66 )
{
...
static struct V_318 * F_247 ( struct V_318 * V_101 )
{
F_33 ( & V_101 -> V_36 ) ;
return V_101 ;
}
...
static struct V_318 * F_248 ( void )
{
struct V_318 * V_101 ;
V_101 = F_249 ( sizeof ( * V_101 ) , V_34 ) ;
if ( ! V_101 )
return NULL ;
F_20 ( & V_101 -> V_36 ) ;
return V_101 ;
...
static struct V_10 * F_250 ( struct V_27 * V_30 ,
struct V_318 * V_101 )
{
struct V_10 * V_11 ;
V_11 = F_249 ( sizeof ( * V_11 ) , V_34 ) ;
if ( ! V_11 )
return NULL ;
F_161 ( & V_11 -> V_19 ) ;
V_11 -> V_21 = 0 ;
...
V_11 -> V_101 = V_101 ;
V_11 -> V_27 = V_30 ;
V_11 -> V_231 . V_322 = F_253 ( 1 << V_323 ) ;
V_11 -> V_231 . V_324 = F_253 ( 1 ) ;
V_11 -> V_231 . V_325 = F_253 ( 1 << V_323 ) ;
V_11 -> V_231 . V_326 = F_253 ( ( T_4 ) V_101 -> V_315 ) ;
return V_11 ;
}
...
V_317 = F_258 ( & V_333 , V_140 , NULL , V_34 ) ;
if ( F_23 ( V_317 ) ) {
V_31 = F_179 ( V_317 ) ;
goto V_87;
}
F_261 ( & V_333 , V_140 , V_102 , V_87 ) ;
F_261 ( & V_333 , V_140 , V_338 , V_87 ) ;
if ( ! V_11 -> V_234 ) {
V_234 -> V_315 = V_315 ;
V_234 -> V_317 = V_317 ;
V_234 -> V_102 = V_102 ;
...
static char * F_265 ( struct V_10 * V_11 )
{
T_5 V_344 ;
char * V_317 ;
void * V_333 ;
...
V_333 = V_317 ;
V_140 = V_317 + V_344 ;
F_266 ( & V_333 , V_140 , V_11 -> V_101 -> V_317 , ( T_4 ) V_86 ) ;
...
V_333 = V_332 ;
V_140 = V_332 + V_31 ;
V_316 = F_258 ( & V_333 , V_140 , & V_86 , V_34 ) ;
if ( F_23 ( V_316 ) )
V_316 = NULL ;
else
F_18 ( L_86 , V_33 , V_316 , V_86 ) ;
V_246:
F_29 ( V_332 ) ;
F_29 ( V_317 ) ;
return V_316 ;
...
static V_76 F_269 ( struct V_10 * V_11 , const char * V_117 )
{
if ( V_11 -> V_63 == 1 )
return F_267 ( V_11 , V_117 ) ;
return F_268 ( V_11 , V_117 ) ;
}
...
V_314 = F_271 ( V_188 -> V_347 , V_101 -> V_315 ) ;
if ( ! V_314 ) {
F_97 ( V_11 , L_87 , V_101 -> V_315 ) ;
return - V_104 ;
}
...
static int F_272 ( struct V_10 * V_11 )
{
T_5 V_66 ;
int V_31 ;
void * V_332 ;
...
V_140 = V_332 + V_31 ;
V_31 = - V_331 ;
F_261 ( & V_333 , V_140 , V_88 , V_246 ) ;
F_273 ( & V_333 , V_140 , V_67 , V_246 ) ;
if ( V_67 > ( V_73 - sizeof ( struct V_74 ) )
/ sizeof ( V_76 ) ) {
V_31 = - V_4 ;
goto V_246;
}
if ( ! F_274 ( & V_333 , V_140 , V_67 * sizeof ( V_75 ) ) )
goto V_246;
V_31 = 0 ;
V_82 = F_55 ( V_67 , V_34 ) ;
if ( ! V_82 ) {
...
V_333 = V_332 ;
V_140 = V_332 + V_31 ;
V_106 = F_258 ( & V_333 , V_140 , NULL , V_34 ) ;
if ( F_23 ( V_106 ) )
goto V_246;
F_18 ( L_92 ,
...
F_25 ( & V_359 ) ;
F_284 ( & V_11 -> V_37 ) ;
if ( V_362 != F_285 ( & V_358 ) ) {
F_27 ( & V_359 ) ;
return;
}
V_363 = 0 ;
F_286 (tmp, &rbd_dev_list) {
struct V_10 * V_11 ;
V_11 = F_287 ( V_128 , struct V_10 , V_37 ) ;
if ( V_11 -> V_306 > V_363 )
V_363 = V_11 -> V_306 ;
}
F_27 ( & V_359 ) ;
F_288 ( & V_358 , V_362 , V_363 ) ;
F_18 ( L_98 ) ;
}
static inline T_5 F_289 ( const char * * V_133 )
{
const char * V_364 = L_99 ;
* V_133 += strspn ( * V_133 , V_364 ) ;
return strcspn ( * V_133 , V_364 ) ;
}
static inline T_5 F_290 ( const char * * V_133 ,
char * V_52 ,
T_5 V_365 )
{
T_5 V_86 ;
...
static inline char * F_291 ( const char * * V_133 , T_5 * V_366 )
{
char * V_367 ;
T_5 V_86 ;
V_86 = F_289 ( V_133 ) ;
V_367 = F_292 ( * V_133 , V_86 + 1 , V_34 ) ;
if ( ! V_367 )
return NULL ;
* ( V_367 + V_86 ) = '\0' ;
* V_133 += V_86 ;
...
static int F_293 ( const char * V_133 ,
struct V_28 * * V_29 ,
struct V_48 * * V_368 ,
struct V_318 * * V_318 )
{
...
V_106 = F_292 ( V_133 , V_86 + 1 , V_34 ) ;
if ( ! V_106 )
goto V_372;
* ( V_106 + V_86 ) = '\0' ;
V_101 -> V_106 = V_106 ;
V_49 = F_249 ( sizeof ( * V_49 ) , V_34 ) ;
if ( ! V_49 )
goto V_372;
V_49 -> V_17 = V_374 ;
V_371 = F_294 ( V_70 , V_369 ,
V_369 + V_370 - 1 ,
F_37 , V_49 ) ;
if ( F_23 ( V_371 ) ) {
V_31 = F_179 ( V_371 ) ;
...
if ( ! V_217 )
return - V_32 ;
sprintf ( V_217 , L_104 , V_376 , V_11 -> V_101 -> V_316 ) ;
F_18 ( L_105 , V_217 ) ;
V_66 = sizeof ( V_257 ) + V_339 ;
V_375 = F_249 ( V_66 , V_121 ) ;
if ( ! V_375 ) {
V_31 = - V_32 ;
goto V_246;
}
...
F_18 ( L_67 , V_33 , V_31 ) ;
if ( V_31 == - V_23 ) {
V_317 = F_58 ( L_107 , V_34 ) ;
V_31 = V_317 ? 0 : - V_32 ;
if ( ! V_31 )
V_11 -> V_63 = 1 ;
} else if ( V_31 > sizeof ( V_257 ) ) {
void * V_333 = V_375 ;
V_317 = F_258 ( & V_333 , V_333 + V_31 ,
NULL , V_121 ) ;
...
if ( ! V_11 -> V_234 )
return 0 ;
V_234 = F_247 ( V_11 -> V_234 ) ;
V_30 = F_32 ( V_11 -> V_27 ) ;
V_31 = - V_32 ;
V_243 = F_250 ( V_30 , V_234 ) ;
if ( ! V_243 )
goto V_87;
V_31 = F_298 ( V_243 , false ) ;
if ( V_31 < 0 )
goto V_87;
V_11 -> V_243 = V_243 ;
F_251 ( & V_11 -> V_235 , 1 ) ;
...
F_300 ( V_378
< sizeof ( V_305 ) + V_379 ) ;
sprintf ( V_11 -> V_117 , L_109 , V_305 , V_11 -> V_306 ) ;
V_31 = F_301 ( 0 , V_11 -> V_117 ) ;
if ( V_31 < 0 )
goto V_380;
V_11 -> V_307 = V_31 ;
V_31 = F_224 ( V_11 ) ;
...
if ( V_31 )
goto V_382;
F_219 ( V_11 -> V_25 , V_11 -> V_16 . V_66 / V_301 ) ;
V_31 = F_276 ( V_11 ) ;
if ( V_31 )
goto V_383;
F_105 ( V_289 , & V_11 -> V_21 ) ;
F_302 ( V_11 -> V_25 ) ;
F_262 ( L_110 , V_11 -> V_25 -> V_304 ,
( unsigned long long ) V_11 -> V_16 . V_66 ) ;
return V_31 ;
V_383:
F_69 ( V_11 ) ;
...
static int F_298 ( struct V_10 * V_11 , bool V_16 )
{
int V_31 ;
int V_128 ;
V_31 = F_295 ( V_11 ) ;
...
static T_10 F_306 ( struct V_390 * V_352 ,
const char * V_133 ,
T_5 V_319 )
{
struct V_10 * V_11 = NULL ;
...
if ( ! F_307 ( V_392 ) )
return - V_393 ;
V_391 = F_293 ( V_133 , & V_29 , & V_49 , & V_101 ) ;
if ( V_391 < 0 )
goto V_394;
V_17 = V_49 -> V_17 ;
F_29 ( V_49 ) ;
...
V_391 = F_308 ( V_188 -> V_347 , V_101 -> V_314 ) ;
if ( V_391 < 0 )
goto V_396;
...
V_11 = F_250 ( V_30 , V_101 ) ;
if ( ! V_11 )
goto V_396;
V_30 = NULL ;
V_101 = NULL ;
V_391 = F_298 ( V_11 , true ) ;
if ( V_391 < 0 )
goto V_397;
if ( V_11 -> V_101 -> V_102 != V_103 )
V_17 = true ;
...
static T_10 F_310 ( struct V_390 * V_352 ,
const char * V_133 ,
T_5 V_319 )
{
struct V_10 * V_11 = NULL ;
...
if ( V_31 )
F_97 ( V_11 , L_117 , V_31 ) ;
F_18 ( L_118 , V_33 ) ;
F_313 ( & V_11 -> V_27 -> V_38 -> V_188 ) ;
F_279 ( V_11 ) ;
F_305 ( V_11 ) ;
F_309 ( V_392 ) ;
return V_319 ;
...
F_262 ( L_123 V_404 L_124 ) ;
return V_391 ;
}
static void T_12 F_325 ( void )
{
F_316 () ;
F_322 () ;
}
