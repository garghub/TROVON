...
V_3 -> V_107 = F_119 ( & V_129 ) ;
if ( F_120 ( V_3 -> V_107 ) ) {
V_51 = F_121 ( V_3 -> V_107 ) ;
V_42 -> error = L_23 ;
goto V_130;
}
V_3 -> V_72 = F_122 ( V_131 , V_132 ) ;
if ( ! V_3 -> V_72 ) {
V_42 -> error = L_24 ;
V_51 = - V_26 ;
goto V_133;
...
V_51 = V_3 -> V_7 -> type -> V_138 ( V_3 -> V_7 , F_73 ,
( void * ) V_3 ) ;
if ( V_51 < 0 ) {
V_42 -> error = L_26 ;
goto V_139;
...
V_142 . V_140 = V_37 -> V_80 ;
V_37 -> V_80 = V_36 -> V_80 ;
V_36 -> V_80 = V_142 . V_140 ;
V_142 . V_141 = V_37 -> V_7 ;
V_37 -> V_7 = V_36 -> V_7 ;
V_36 -> V_7 = V_142 . V_141 ;
V_37 -> V_7 -> V_35 = V_37 ;
V_36 -> V_7 -> V_35 = V_36 ;
V_37 -> V_42 -> V_143 = V_37 -> V_7 -> V_48 ;
...
static void F_141 ( struct V_2 * V_3 , int V_147 )
{
if ( ! V_3 -> V_104 )
return;
if ( V_147 == - V_148 )
...
F_25 ( L_31 ) ;
if ( V_3 -> V_7 -> type -> V_149 )
V_3 -> V_7 -> type -> V_149 ( V_3 -> V_7 ) ;
V_3 -> V_104 = 0 ;
F_142 ( V_3 -> V_42 -> V_58 ) ;
}
static void F_143 ( struct V_70 * V_71 , int V_150 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_71 -> V_35 ;
struct V_13 * V_151 = NULL ;
...
V_151 = F_86 ( & V_71 -> V_151 ) ;
V_153 = V_71 -> V_153 ;
if ( V_153 ) {
V_153 -> V_154 = V_71 -> V_155 ;
V_153 -> V_156 = V_71 -> V_157 ;
}
F_64 ( V_71 ) ;
F_94 () ;
F_43 ( & V_3 -> V_43 ) ;
...
static void F_145 ( void * V_77 , int V_150 )
{
struct V_70 * V_71 = V_77 ;
F_143 ( V_71 , V_150 ) ;
}
static void F_146 ( int V_109 , unsigned long V_110 , void * V_77 )
{
struct V_70 * V_71 = V_77 ;
struct V_2 * V_3 = V_71 -> V_35 ;
if ( V_109 || V_110 )
...
V_3 -> V_7 -> type -> V_158 ( V_3 -> V_7 , & V_71 -> V_65 ,
F_145 , V_71 ) ;
}
...
V_98 . V_39 = F_79 ( ( T_1 ) V_3 -> V_7 -> V_48 , V_159 - V_98 . V_106 ) ;
V_99 . V_28 = V_3 -> V_5 -> V_28 ;
V_99 . V_106 = F_3 ( V_3 -> V_7 , V_71 -> V_65 . V_76 ) ;
V_99 . V_39 = V_98 . V_39 ;
F_102 ( V_3 -> V_107 , & V_98 , 1 , & V_99 , 0 , F_146 , V_71 ) ;
}
static void V_155 ( struct V_13 * V_13 , int error )
{
void * V_160 = V_13 -> V_156 ;
F_148 ( V_160 , 0 , error ? 1 : 0 ) ;
}
...
void * V_160 ;
V_71 -> V_153 = V_13 ;
V_71 -> V_155 = V_13 -> V_154 ;
V_71 -> V_157 = V_13 -> V_156 ;
V_160 = F_150 ( V_3 -> V_107 ,
F_146 , V_71 ) ;
V_13 -> V_154 = V_155 ;
V_13 -> V_156 = V_160 ;
F_137 ( V_13 ) ;
...
V_71 -> V_162 = 0 ;
V_71 -> V_153 = NULL ;
if ( V_3 -> V_7 -> type -> V_163 ( V_3 -> V_7 , & V_71 -> V_65 ) ) {
F_64 ( V_71 ) ;
return NULL ;
}
...
{
V_13 -> V_164 = V_3 -> V_5 -> V_28 ;
V_13 -> V_165 = F_3 ( V_3 -> V_7 ,
F_70 ( V_65 -> V_76 ) +
( V_8 - V_65 -> V_66 ) ) +
( V_13 -> V_165 &
V_3 -> V_7 -> V_166 ) ;
}
static int F_155 ( struct V_113 * V_42 , struct V_13 * V_13 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_42 -> V_135 ;
int V_51 = V_146 ;
...
static int F_159 ( struct V_113 * V_42 , struct V_13 * V_13 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_42 -> V_135 ;
int V_51 = V_146 ;
...
static int F_161 ( struct V_113 * V_42 , struct V_13 * V_13 , int error )
{
struct V_2 * V_3 = V_42 -> V_135 ;
if ( F_8 ( V_13 ) )
F_15 ( V_3 , V_13 ) ;
...
static void F_162 ( struct V_113 * V_42 )
{
struct V_2 * V_3 = V_42 -> V_135 ;
F_108 ( V_3 ) ;
}
static int F_163 ( struct V_113 * V_42 )
{
int V_51 = 0 ;
struct V_2 * V_3 = V_42 -> V_135 ;
struct V_2 * V_36 = NULL , * V_37 = NULL ;
...
struct V_2 * V_3 = V_42 -> V_135 ;
F_165 ( V_42 ) ;
V_42 -> V_143 = F_167 ( V_3 -> V_4 -> V_28 ) ;
F_104 ( V_3 ) ;
}
static void F_169 ( struct V_113 * V_42 , T_6 type ,
unsigned V_177 , char * V_178 , unsigned V_179 )
{
unsigned V_180 = 0 ;
struct V_2 * V_35 = V_42 -> V_135 ;
switch ( type ) {
case V_181 :
F_42 ( & V_35 -> V_43 ) ;
if ( ! V_35 -> V_104 )
...
if ( V_35 -> V_7 -> type -> V_182 ) {
T_1 V_183 , V_184 ,
V_185 ;
V_35 -> V_7 -> type -> V_182 ( V_35 -> V_7 ,
& V_183 ,
& V_184 ,
& V_185 ) ;
F_170 ( L_38 ,
...
break;
case V_186 :
F_170 ( L_40 , V_35 -> V_4 -> V_187 , V_35 -> V_5 -> V_187 ) ;
V_35 -> V_7 -> type -> V_188 ( V_35 -> V_7 , type , V_178 + V_180 ,
V_179 - V_180 ) ;
break;
}
}
static int F_171 ( struct V_113 * V_42 ,
T_7 V_189 , void * V_190 )
{
struct V_2 * V_35 = V_42 -> V_135 ;
int V_51 ;
V_51 = V_189 ( V_42 , V_35 -> V_4 , 0 , V_42 -> V_191 , V_190 ) ;
if ( ! V_51 )
V_51 = V_189 ( V_42 , V_35 -> V_5 , 0 , F_78 ( V_35 -> V_5 -> V_28 ) , V_190 ) ;
return V_51 ;
}
static int F_172 ( struct V_24 * V_52 , T_1 V_106 ,
struct V_13 * V_13 )
{
int V_51 = V_146 ;
struct V_2 * V_35 ;
...
goto V_194;
if ( V_106 >= F_173 ( V_35 -> V_42 -> V_58 ) )
goto V_194;
V_8 = F_156 ( V_35 -> V_7 , V_106 ) ;
...
V_32 = F_31 ( V_4 -> V_28 ) ;
if ( V_32 )
V_51 = F_172 ( & V_32 -> V_52 , V_13 -> V_165 , V_13 ) ;
F_38 ( & V_27 ) ;
return V_51 ;
}
static int F_100 ( struct V_2 * V_195 ,
...
struct V_4 * V_32 ;
F_37 ( & V_27 ) ;
V_32 = F_31 ( V_195 -> V_4 -> V_28 ) ;
for ( V_144 = 0 ; V_144 < V_55 ; V_144 += V_195 -> V_42 -> V_143 )
if ( F_172 ( & V_32 -> V_52 , V_106 + V_144 , NULL ) ==
V_171 )
V_196 = 1 ;
F_38 ( & V_27 ) ;
return V_196 ;
}
static int F_174 ( struct V_113 * V_42 , unsigned int V_114 , char * * V_115 )
{
int V_51 ;
struct V_1 * V_197 ;
if ( V_114 != 1 ) {
...
V_51 = F_113 ( V_42 , V_115 [ 0 ] , F_114 ( V_42 -> V_58 ) , & V_197 ) ;
if ( V_51 ) {
V_42 -> error = L_42 ;
return V_51 ;
}
...
static void F_175 ( struct V_113 * V_42 )
{
struct V_1 * V_197 = V_42 -> V_135 ;
F_129 ( V_42 , V_197 ) ;
}
static int F_176 ( struct V_113 * V_42 , struct V_13 * V_13 )
{
struct V_1 * V_197 = V_42 -> V_135 ;
V_13 -> V_164 = V_197 -> V_28 ;
if ( V_13 -> V_167 & V_168 )
return V_146 ;
return ( F_157 ( V_13 ) == V_170 ) ? F_139 ( V_197 , V_13 ) : V_146 ;
}
static void F_177 ( struct V_113 * V_42 )
{
struct V_1 * V_197 = V_42 -> V_135 ;
V_42 -> V_143 = F_167 ( V_197 -> V_28 ) ;
}
static void F_178 ( struct V_113 * V_42 , T_6 type ,
unsigned V_177 , char * V_178 , unsigned V_179 )
{
struct V_1 * V_197 = V_42 -> V_135 ;
switch ( type ) {
...
break;
case V_186 :
snprintf ( V_178 , V_179 , L_43 , V_197 -> V_187 ) ;
break;
}
}
static int F_179 ( struct V_113 * V_42 , struct V_198 * V_199 ,
struct V_200 * V_201 , int V_202 )
{
struct V_1 * V_197 = V_42 -> V_135 ;
struct V_203 * V_204 = F_180 ( V_197 -> V_28 ) ;
if ( ! V_204 -> V_205 )
return V_202 ;
V_199 -> V_164 = V_197 -> V_28 ;
return F_79 ( V_202 , V_204 -> V_205 ( V_204 , V_199 , V_201 ) ) ;
}
static int F_181 ( struct V_113 * V_42 ,
T_7 V_189 , void * V_190 )
{
struct V_1 * V_197 = V_42 -> V_135 ;
return V_189 ( V_42 , V_197 , 0 , V_42 -> V_191 , V_190 ) ;
}
