...
static T_3 F_62 ( int V_137 , void * V_138 )
{
T_1 V_139 ;
...
static void F_73 ( struct V_69 * V_70 , int V_160 )
{
if ( V_160 )
F_25 ( V_161 ,
V_70 -> V_40 + V_155 ) ;
...
static void F_75 ( struct V_69 * V_10 , int V_163 )
{
...
static void
F_76 ( struct V_165 * V_166 , const char * V_167 , unsigned int V_86 )
{
struct V_1 * V_2 ;
struct V_69 * V_10 ;
...
static void T_4
F_80 ( struct V_69 * V_10 , int * V_107 ,
int * V_59 , int * V_174 )
{
...
static int T_4
F_81 ( struct V_165 * V_166 , char * V_182 )
{
struct V_1 * V_2 ;
int V_107 = 9600 ;
int V_174 = 8 ;
...
int V_183 = 'n' ;
int V_184 ;
if ( V_166 -> V_170 == - 1 || V_166 -> V_170 >= F_82 ( V_172 ) )
V_166 -> V_170 = 0 ;
V_2 = V_172 [ V_166 -> V_170 ] ;
if ( ! V_2 )
return - V_185 ;
F_67 ( V_2 -> V_151 ) ;
if ( V_182 )
F_83 ( V_182 , & V_107 , & V_59 , & V_174 , & V_183 ) ;
else
F_80 ( & V_2 -> V_10 , & V_107 , & V_59 , & V_174 ) ;
V_184 = F_84 ( & V_2 -> V_10 , V_166 , V_107 , V_59 , V_174 , V_183 ) ;
F_69 ( V_2 -> V_151 ) ;
return V_184 ;
}
...
if ( ! V_189 )
return 1 ;
V_184 = F_86 ( V_189 , L_7 ) ;
if ( V_184 < 0 ) {
F_13 ( & V_187 -> V_12 , L_8 , V_184 ) ;
return V_184 ;
}
V_2 -> V_10 . line = V_184 ;
if ( F_87 ( V_189 , L_9 , NULL ) )
F_88 ( V_131 , & V_2 -> V_5 ) ;
return 0 ;
}
static int F_89 ( struct V_186 * V_187 )
{
const struct V_191 * V_192 =
F_90 ( V_193 , & V_187 -> V_12 ) ;
struct V_1 * V_2 ;
T_1 V_194 ;
int V_184 = 0 ;
struct V_195 * V_196 ;
...
V_184 = F_85 ( V_2 , V_187 ) ;
if ( V_184 > 0 )
V_2 -> V_10 . line = V_187 -> V_198 < 0 ? 0 : V_187 -> V_198 ;
else if ( V_184 < 0 )
goto V_199;
if ( V_192 ) {
V_187 -> V_200 = V_192 -> V_201 ;
V_2 -> V_3 = V_187 -> V_200 -> V_202 ;
}
V_2 -> V_151 = F_91 ( & V_187 -> V_12 , NULL ) ;
if ( F_92 ( V_2 -> V_151 ) ) {
V_184 = F_93 ( V_2 -> V_151 ) ;
goto V_199;
}
V_196 = F_94 ( V_187 , V_203 , 0 ) ;
if ( ! V_196 ) {
V_184 = - V_204 ;
goto V_205;
}
V_2 -> V_10 . V_206 = V_196 -> V_207 ;
V_2 -> V_10 . V_40 = F_95 ( V_196 -> V_207 , F_96 ( V_196 ) ) ;
V_2 -> V_10 . V_208 = & V_209 ;
V_2 -> V_10 . V_210 = V_211 ;
V_2 -> V_10 . V_212 = 16 ;
V_2 -> V_10 . V_133 = F_97 ( V_2 -> V_151 ) ;
V_2 -> V_10 . type = V_74 ;
V_2 -> V_10 . V_12 = V_2 -> V_12 = & V_187 -> V_12 ;
V_2 -> V_76 = 0 ;
V_2 -> V_137 = F_98 ( V_187 , 0 ) ;
V_2 -> V_10 . V_137 = V_2 -> V_137 ;
V_184 = F_99 ( V_2 -> V_137 , F_62 , 0 , F_37 ( & V_187 -> V_12 ) , V_2 ) ;
if ( V_184 )
goto V_205;
F_100 ( V_187 , V_2 ) ;
V_172 [ V_2 -> V_10 . line ] = V_2 ;
F_64 ( & V_2 -> V_10 ) ;
V_184 = F_101 ( & V_213 , & V_2 -> V_10 ) ;
if ( V_184 )
goto V_214;
V_194 = F_24 ( V_2 -> V_10 . V_40 + V_215 ) ;
F_102 ( & V_187 -> V_12 , L_10 ,
( V_194 >> 24 ) & 0xff ,
( V_194 >> 16 ) & 0xff , V_194 & 0xffff ) ;
return 0 ;
V_214:
V_172 [ V_187 -> V_198 ] = NULL ;
F_103 ( V_2 -> V_137 , V_2 ) ;
V_205:
F_104 ( V_2 -> V_151 ) ;
V_199:
...
static int F_105 ( struct V_186 * V_187 )
{
struct V_1 * V_2 = F_106 ( V_187 ) ;
F_107 ( & V_213 , & V_2 -> V_10 ) ;
V_172 [ V_187 -> V_198 ] = NULL ;
F_104 ( V_2 -> V_151 ) ;
F_103 ( V_2 -> V_137 , V_2 ) ;
F_49 ( V_2 ) ;
