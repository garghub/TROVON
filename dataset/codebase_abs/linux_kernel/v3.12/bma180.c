...
F_22 ( & V_2 -> V_55 ) ;
if ( V_50 -> V_74 ) {
V_7 = V_50 -> V_66 / sizeof( V_75 ) - 1 ;
( ( V_75 * ) V_2 -> V_65 ) [ V_7 ] = F_32 () ;
}
...
F_24 ( & V_2 -> V_55 ) ;
F_34 ( V_50 , ( T_1 * ) V_2 -> V_65 ) ;
V_20:
F_35 ( V_50 -> V_76 ) ;
return V_77 ;
}
static int F_36 ( struct V_78 * V_76 ,
bool V_17 )
{
struct V_49 * V_50 = F_37 ( V_76 ) ;
struct V_1 * V_2 = F_21 ( V_50 ) ;
return F_9 ( V_2 , V_17 ) ;
}
static int F_38 ( struct V_78 * V_76 )
{
struct V_49 * V_50 = F_37 ( V_76 ) ;
struct V_1 * V_2 = F_21 ( V_50 ) ;
return F_8 ( V_2 ) ;
}
static int F_39 ( struct V_79 * V_10 ,
...
goto V_82;
F_42 ( & V_2 -> V_55 ) ;
V_50 -> V_11 . V_83 = & V_10 -> V_11 ;
V_50 -> V_84 = V_85 ;
V_50 -> V_86 = F_13 ( V_85 ) ;
V_50 -> V_87 = V_88 ;
V_50 -> V_89 = V_90 ;
V_50 -> V_91 = & V_92 ;
V_76 = F_43 ( L_12 , V_50 -> V_87 , V_50 -> V_81 ) ;
if ( ! V_76 ) {
V_7 = - V_68 ;
goto V_82;
}
...
static int F_52 ( struct V_79 * V_10 )
{
...
static int F_55 ( struct V_101 * V_11 )
{
...
static int F_57 ( struct V_101 * V_11 )
{
struct V_49 * V_50 = F_53 ( F_56 ( V_11 ) ) ;
struct V_1 * V_2 = F_21 ( V_50 ) ;
int V_7 ;
