...
struct V_129 * V_130 )
{
return F_79 ( V_68 , V_60 , V_130 ) ;
}
static T_6 F_80 ( int V_131 , void * V_132 )
{
...
static void F_82 ( unsigned long V_132 )
{
...
static T_6 F_85 ( int V_131 , void * V_132 )
{
struct V_142 * V_143 = V_132 ;
struct V_1 * V_2 ;
unsigned int V_144 = 0 ;
T_1 V_145 , V_146 ;
int V_43 ;
V_145 = ( V_143 -> V_17 & V_147 ) ? F_86 ( V_143 -> V_4 )
: F_87 ( V_143 -> V_4 ) ;
V_146 = 0xff000000 ;
F_88 ( V_143 -> V_70 , L_24 , V_145 ) ;
for ( V_43 = 0 ; V_43 < V_148 ; V_43 ++ ) {
V_2 = V_143 -> V_2 [ V_43 ] ;
if ( ! V_2 )
continue;
if ( V_145 & V_146 ) {
F_88 ( V_143 -> V_70 , L_25 , V_2 -> V_149 ) ;
F_80 ( V_131 , V_2 ) ;
V_144 ++ ;
}
V_145 &= ~ V_146 ;
...
static void F_90 ( struct V_142 * V_143 )
{
struct V_1 * V_2 ;
int V_43 ;
if ( V_143 -> V_131 != V_150 ) {
F_88 ( V_143 -> V_70 , L_26 ) ;
F_91 ( V_143 -> V_131 , V_143 ) ;
return;
}
for ( V_43 = 0 ; V_43 < V_148 ; V_43 ++ ) {
V_2 = V_143 -> V_2 [ V_43 ] ;
if ( V_2 && V_2 -> V_131 != V_150 ) {
F_44 ( V_2 , L_27 ) ;
F_91 ( V_2 -> V_131 , V_2 ) ;
}
}
...
int V_43 ;
if ( V_143 -> V_131 != V_150 ) {
F_88 ( V_143 -> V_70 , L_28 ) ;
V_151 = F_93 ( V_143 -> V_131 , F_85 , V_152 ,
L_29 , V_143 ) ;
return V_151 ;
}
for ( V_43 = 0 ; V_43 < V_148 ; V_43 ++ ) {
...
F_44 ( V_2 , L_31 ) ;
V_151 = F_93 ( V_2 -> V_131 , F_80 , V_152 ,
L_32 , V_2 ) ;
if ( V_151 ) {
F_23 ( V_2 , L_33 ) ;
goto V_154;
...
if ( ! V_2 ) {
F_96 ( V_143 -> V_70 , L_34 ) ;
V_159 = - V_71 ;
goto V_161;
}
V_2 -> V_4 = F_97 ( V_75 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_96 ( V_143 -> V_70 , L_35 ) ;
V_159 = - V_71 ;
goto V_162;
}
V_159 = F_98 ( V_75 , 0 , & V_158 ) ;
if ( V_159 ) {
F_96 ( V_143 -> V_70 , L_36 ) ;
goto V_163;
}
V_2 -> V_17 = V_17 ;
if ( ! V_143 -> V_17 )
V_143 -> V_17 = V_2 -> V_17 ;
F_99 ( V_143 -> V_17 != V_2 -> V_17 ) ;
V_2 -> V_70 = V_143 -> V_70 ;
V_2 -> V_149 = ( ( V_158 . V_164 - 0x100 ) & 0xfff ) >> 7 ;
if ( V_2 -> V_149 >= V_148 ) {
F_96 ( V_143 -> V_70 , L_37 ) ;
V_159 = - V_105 ;
goto V_163;
}
V_143 -> V_2 [ V_2 -> V_149 ] = V_2 ;
F_100 ( & V_2 -> V_139 , F_82 , ( unsigned long ) V_2 ) ;
snprintf ( V_2 -> V_69 , sizeof( V_2 -> V_69 ) , L_38 , V_2 -> V_149 ) ;
F_18 ( V_2 ) ;
F_5 ( V_2 , 0 ) ;
switch ( V_2 -> V_17 & V_18 ) {
case V_19 :
...
F_45 ( & V_2 -> V_76 ) ;
V_2 -> V_107 = true ;
V_2 -> V_65 . V_119 = & V_143 -> V_65 ;
F_102 ( & V_2 -> V_65 ) ;
V_2 -> V_131 = F_103 ( V_75 , 0 ) ;
F_60 ( & V_2 -> V_65 . V_155 , & V_143 -> V_65 . V_168 ) ;
V_143 -> V_65 . V_169 ++ ;
F_104 ( V_143 -> V_70 , L_39 , V_2 -> V_149 , V_156 ,
V_2 -> V_131 != V_150 ? V_2 -> V_131 : V_143 -> V_131 ) ;
return 0 ;
V_163:
F_105 ( V_2 -> V_4 ) ;
V_162:
...
struct V_155 * V_58 ;
int V_159 ;
V_143 = F_95 ( sizeof( * V_143 ) , V_160 ) ;
if ( ! V_143 ) {
F_96 ( & V_171 -> V_70 , L_40 ) ;
V_159 = - V_71 ;
goto V_161;
}
V_143 -> V_70 = & V_171 -> V_70 ;
F_45 ( & V_143 -> V_65 . V_168 ) ;
V_143 -> V_4 = F_97 ( V_171 -> V_70 . V_172 , 0 ) ;
if ( ! V_143 -> V_4 ) {
F_96 ( & V_171 -> V_70 , L_35 ) ;
V_159 = - V_71 ;
goto V_173;
}
V_143 -> V_131 = F_103 ( V_171 -> V_70 . V_172 , 0 ) ;
F_110 ( V_174 , V_143 -> V_65 . V_175 ) ;
F_110 ( V_176 , V_143 -> V_65 . V_175 ) ;
F_110 ( V_177 , V_143 -> V_65 . V_175 ) ;
F_110 ( V_178 , V_143 -> V_65 . V_175 ) ;
V_143 -> V_65 . V_179 = F_48 ;
V_143 -> V_65 . V_180 = F_57 ;
V_143 -> V_65 . V_181 = F_59 ;
V_143 -> V_65 . V_182 = F_61 ;
V_143 -> V_65 . V_183 = F_64 ;
V_143 -> V_65 . V_184 = F_78 ;
V_143 -> V_65 . V_185 = F_77 ;
V_143 -> V_65 . V_186 = F_69 ;
V_143 -> V_65 . V_187 = F_70 ;
V_143 -> V_65 . V_70 = & V_171 -> V_70 ;
