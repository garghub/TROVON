...
if ( V_33 == V_84 ) {
V_4 -> V_20 . V_21 &= ~ V_77 ;
V_4 -> V_20 . V_21 |= V_5 . V_87 [ V_84 ] . V_4 ;
V_4 -> V_20 . V_86 . V_88 = V_89 ;
} else if ( V_33 == V_85 ) {
V_4 -> V_20 . V_21 &= ~ V_77 ;
V_4 -> V_20 . V_21 |= V_5 . V_87 [ V_85 ] . V_4 ;
V_4 -> V_20 . V_86 . V_88 = V_90 ;
}
}
static struct V_74 *
...
unsigned long V_50 ;
int V_33 = V_88 -> V_33 ;
if ( V_88 -> V_96 && ! V_12 -> V_97 )
return NULL ;
V_66:
V_95 = & V_12 -> V_98 -> V_57 [ V_33 ] ;
F_60 ( & V_95 -> V_99 , V_50 ) ;
if ( ! F_61 ( & V_95 -> V_100 ) || V_95 -> V_21 == V_88 -> V_21 ) {
if ( ! V_12 -> V_97 ) {
if ( V_33 != V_88 -> V_33 )
F_58 ( V_4 , V_33 ) ;
V_88 -> V_96 = 1 ;
...
struct V_3 * V_4 )
{
struct V_74 * V_92 = NULL , * V_101 ;
struct V_91 * V_102 , * V_103 ;
V_102 = & V_4 -> V_20 . V_86 ;
if ( V_102 -> V_33 != V_104 ) {
V_92 = F_59 ( V_12 , V_4 , V_102 ) ;
if ( V_92 == & V_93 )
return V_92 ;
}
V_103 = & V_4 -> V_20 . V_105 ;
if ( V_103 -> V_33 != V_104 ) {
V_101 = F_59 ( V_12 , V_4 , V_103 ) ;
if ( V_101 == & V_93 ) {
F_64 ( V_12 , V_102 ) ;
V_92 = V_101 ;
}
...
if ( ( V_4 -> V_20 . V_21 & V_92 -> V_107 ) == V_92 -> V_108 ) {
V_4 -> V_20 . V_50 |= V_92 -> V_50 ;
return V_92 ;
}
}
}
...
{
if ( ( V_4 -> V_20 . V_21 & V_110 ) == 0x003c ) {
T_1 V_111 = F_74 ( . V_4 = 0xc0 , . V_112 = 1 , . V_107 = 16 ) ;
V_111 |= ( V_4 -> V_20 . V_21 & ~ V_110 ) ;
V_4 -> V_20 . V_21 = V_111 ;
}
}
...
{
if ( ( V_4 -> V_20 . V_21 & V_110 ) == 0x003c ) {
T_1 V_111 = F_74 ( . V_4 = 0xc2 , . V_113 = 0x01 , . V_112 = 1 , . V_107 = 16 ) ;
V_111 |= ( V_4 -> V_20 . V_21 & ~ V_110 ) ;
V_4 -> V_20 . V_21 = V_111 ;
}
}
...
struct V_120 * F_81 ( int * V_121 )
{
if ( V_5 . V_122 )
return V_5 . V_122 ( V_121 ) ;
* V_121 = 0 ;
return NULL ;
}
static struct V_120 * F_82 ( int * V_121 )
{
struct V_11 * V_12 = & F_5 ( V_11 ) ;
struct V_120 * V_123 = V_12 -> V_124 ;
V_123 [ 0 ] . V_125 = V_13 ;
V_123 [ 0 ] . V_126 = V_5 . V_17 & ~ V_12 -> V_18 ;
V_123 [ 0 ] . V_127 = V_5 . V_17 & ~ V_12 -> V_38 ;
V_123 [ 1 ] . V_125 = V_128 ;
V_123 [ 1 ] . V_126 = V_12 -> V_129 ;
V_123 [ 1 ] . V_127 = 0 ;
* V_121 = 2 ;
return V_123 ;
}
static struct V_120 * F_83 ( int * V_121 )
{
struct V_11 * V_12 = & F_5 ( V_11 ) ;
struct V_120 * V_123 = V_12 -> V_124 ;
int V_33 ;
...
V_123 [ V_33 ] . V_125 = F_42 ( V_33 ) ;
V_123 [ V_33 ] . V_126 = V_123 [ V_33 ] . V_127 = 0 ;
if ( ! F_7 ( V_33 , V_12 -> V_15 ) )
continue;
V_123 [ V_33 ] . V_126 = V_123 [ V_33 ] . V_127 =
V_4 -> V_20 . V_21 | V_26 ;
if ( V_4 -> V_8 . V_46 )
V_123 [ V_33 ] . V_126 &= ~ V_26 ;
else if ( V_4 -> V_8 . V_47 )
V_123 [ V_33 ] . V_127 &= ~ V_26 ;
}
* V_121 = V_5 . V_51 ;
return V_123 ;
}
...
if ( V_114 )
return V_114 ;
if ( ! F_88 ( V_130 ) && ! F_88 ( V_131 ) )
return 0 ;
V_4 -> V_20 . V_21 |= V_4 -> V_8 . V_21 & ( V_132 | V_133 ) ;
if ( ( V_4 -> V_20 . V_21 & ( V_132 | V_133 ) ) &&
( ( V_4 -> V_20 . V_21 & V_44 ) ||
V_4 -> V_8 . V_9 > 0 ) )
return - V_134 ;
return 0 ;
...
{
struct V_74 * V_92 = F_69 ( V_12 , V_4 ) ;
if ( V_4 -> V_20 . V_21 & V_133 ) {
if ( V_92 -> V_135 & ( 1U << 2 ) )
return & V_136 ;
return & V_93 ;
}
...
T_2 F_90 ( char * V_137 , T_1 V_21 )
{
T_1 V_4 = ( V_21 & V_138 ) ;
return F_91 ( V_137 , V_21 , V_4 ) ;
}
struct V_139 * F_92 ( int V_140 )
{
struct V_139 * V_57 ;
int V_23 ;
V_57 = F_93 ( sizeof( struct V_139 ) ,
V_141 , F_94 ( V_140 ) ) ;
if ( V_57 ) {
for ( V_23 = 0 ; V_23 < V_142 ; V_23 ++ )
F_95 ( & V_57 -> V_57 [ V_23 ] . V_99 ) ;
V_57 -> V_143 = - 1 ;
}
return V_57 ;
}
static int F_96 ( int V_140 )
{
struct V_11 * V_12 = & F_97 ( V_11 , V_140 ) ;
if ( ! ( V_5 . V_87 || V_5 . V_144 ) )
return V_145 ;
V_12 -> V_98 = F_92 ( V_140 ) ;
if ( ! V_12 -> V_98 )
return V_146 ;
return V_145 ;
}
static void F_98 ( int V_140 )
{
struct V_11 * V_12 = & F_97 ( V_11 , V_140 ) ;
int V_143 = F_99 ( V_140 ) ;
int V_23 ;
F_100 ( V_140 ) ;
F_101 () ;
V_12 -> V_147 = NULL ;
...
struct V_139 * V_149 ;
V_149 = F_97 ( V_11 , V_23 ) . V_98 ;
if ( V_149 && V_149 -> V_143 == V_143 ) {
V_12 -> V_150 = V_12 -> V_98 ;
V_12 -> V_98 = V_149 ;
break;
}
}
V_12 -> V_98 -> V_143 = V_143 ;
V_12 -> V_98 -> V_151 ++ ;
}
if ( V_5 . V_144 )
V_12 -> V_147 = & V_12 -> V_98 -> V_57 [ V_152 ] ;
}
static void F_103 ( int V_140 )
{
struct V_11 * V_12 = & F_97 ( V_11 , V_140 ) ;
struct V_139 * V_149 ;
V_149 = V_12 -> V_98 ;
if ( V_149 ) {
if ( V_149 -> V_143 == - 1 || -- V_149 -> V_151 == 0 )
F_104 ( V_149 ) ;
V_12 -> V_98 = NULL ;
}
F_105 ( V_140 ) ;
...
static int F_109 ( int V_140 )
{
T_4 V_156 = V_157 ;
switch ( F_110 ( V_140 ) . V_158 ) {
case 42 :
V_156 = 0x28 ;
break;
case 45 :
switch ( F_110 ( V_140 ) . V_159 ) {
case 6 : V_156 = 0x618 ; break;
case 7 : V_156 = 0x70c ; break;
}
}
return ( F_110 ( V_140 ) . V_160 < V_156 ) ;
}
...
V_5 . V_206 = V_207 ;
V_2 [ V_208 ] =
F_74 ( . V_4 = 0x0e , . V_113 = 0x01 , . V_112 = 1 , . V_107 = 1 ) ;
V_2 [ V_209 ] =
F_74 ( . V_4 = 0xb1 , . V_113 = 0x3f , . V_112 = 1 , . V_107 = 1 ) ;
F_127 ( F_117 ) ;
F_128 ( L_10 ) ;
break;
case 28 :
...
F_74 ( . V_4 = 0x0e , . V_113 = 0x01 , . V_112 = 1 , . V_107 = 1 ) ;
V_2 [ V_209 ] =
F_74 ( . V_4 = 0xb1 , . V_113 = 0x01 , . V_112 = 1 , . V_107 = 1 ) ;
F_128 ( L_14 ) ;
break;
case 58 :
case 62 :
...
case 69 :
V_5 . V_63 = true ;
memcpy ( V_195 , V_222 , sizeof( V_195 ) ) ;
memcpy ( V_200 , V_223 , sizeof( V_200 ) ) ;
F_132 () ;
V_5 . V_106 = V_231 ;
V_5 . V_155 = V_232 ;
V_5 . V_87 = V_227 ;
