...
static void F_7 ( const struct V_9 * V_3 ,
struct V_1 * V_2 )
{
F_8 ( V_3 , L_2 ,
( unsigned int ) V_2 -> V_4 , V_2 -> V_5 -> V_6 ) ;
...
static void F_23 ( struct V_9 * V_3 ,
const struct V_37 * V_38 )
{
V_3 -> V_29 = V_38 -> V_29 ;
V_3 -> V_31 = V_38 -> V_31 ;
...
void F_24 ( struct V_9 * V_3 )
{
struct V_1 * V_2 ;
V_2 = F_3 ( V_3 , V_3 -> V_10 ) ;
if ( V_2 )
F_25 ( V_2 ) ;
else
F_8 ( V_3 , L_3 ,
...
static void F_30 ( struct V_9 * V_3 )
{
V_3 -> V_49 = 0 ;
F_15 ( & V_3 -> V_34 ) ;
}
...
F_24 ( V_3 ) ;
F_10 ( & V_3 -> V_34 , V_25 + V_3 -> V_32 ) ;
}
V_3 -> V_49 = 1 ;
}
void F_16 ( struct V_9 * V_3 )
{
struct V_1 * V_2 ;
F_12 (p, &br->port_list, list) {
if ( V_2 -> V_8 != V_13 &&
...
int F_42 ( struct V_9 * V_3 , unsigned long V_61 )
{
unsigned long V_12 = F_43 ( V_61 ) ;
...
int F_46 ( struct V_9 * V_3 , unsigned long V_61 )
{
unsigned long V_12 = F_43 ( V_61 ) ;
...
void F_47 ( struct V_9 * V_3 , unsigned long V_12 )
{
V_3 -> V_33 = V_12 ;
if ( F_19 ( V_3 ) )
V_3 -> V_23 = V_3 -> V_33 ;
}
int F_48 ( struct V_9 * V_3 , unsigned long V_61 )
{
unsigned long V_12 = F_43 ( V_61 ) ;
int V_68 = - V_64 ;
F_44 ( & V_3 -> V_65 ) ;
