...
static void F_62 ( struct V_1 * V_76 , unsigned long V_31 )
{
unsigned long V_25 = ( unsigned long ) V_76 ;
unsigned long V_26 = ( unsigned long ) ( V_76 + V_31 ) ;
F_63 ( V_25 , V_26 ) ;
}
static void F_64 ( struct V_1 * V_76 , unsigned long V_31 )
{
unsigned long V_25 = ( unsigned long ) V_76 ;
unsigned long V_26 = ( unsigned long ) ( V_76 + V_31 ) ;
F_63 ( V_25 , V_26 ) ;
}
static struct V_1 * F_65 ( unsigned long V_31 )
{
struct V_1 * V_1 , * V_77 ;
unsigned long V_78 = sizeof( struct V_1 ) * V_31 ;
...
memset ( V_76 , 0 , sizeof( struct V_1 ) * V_31 ) ;
V_14 -> V_18 |= V_30 ;
