...
{
struct V_221 * V_222 ;
V_222 = F_75 ( V_31 -> V_28 , sizeof( * V_222 ) , V_223 ) ;
if ( ! V_222 )
return - V_224 ;
V_222 -> V_225 = 1 ;
V_222 -> V_226 = 1 ;
...
V_222 -> V_235 . V_102 = V_236 ;
V_222 -> V_235 . V_103 = V_236 ;
V_222 -> V_237 = 1 ;
V_222 -> V_238 . V_102 = V_239 ;
V_222 -> V_238 . V_103 = V_239 ;
V_222 -> V_240 . V_102 = V_241 ;
V_222 -> V_240 . V_103 = V_241 ;
V_31 -> V_222 = V_222 ;
return 0 ;
}
static inline bool F_76 ( enum V_71 V_72 )
{
switch ( V_72 ) {
case V_242 :
case V_76 :
...
if ( ( V_170 == V_216 ) && ( V_244 -> V_232 ) ) {
if ( V_73 ) {
if ( ( V_90 -> V_99 < V_244 -> V_235 . V_102 ) ||
( V_92 -> V_103 > V_244 -> V_233 . V_102 ) ||
( V_90 -> V_98 < V_244 -> V_235 . V_103 ) ||
( V_92 -> V_102 > V_244 -> V_233 . V_103 ) ) {
F_5 ( L_36 ) ;
goto V_249;
}
} else {
if ( ( V_90 -> V_98 < V_244 -> V_235 . V_102 ) ||
( V_92 -> V_102 > V_244 -> V_233 . V_102 ) ||
( V_90 -> V_99 < V_244 -> V_235 . V_103 ) ||
( V_92 -> V_103 > V_244 -> V_233 . V_103 ) ) {
F_5 ( L_36 ) ;
goto V_249;
}
}
}
if ( ( V_170 == V_218 ) && ( V_244 -> V_237 ) ) {
if ( V_73 ) {
if ( ( V_90 -> V_99 < V_244 -> V_240 . V_102 ) ||
( V_92 -> V_103 > V_244 -> V_238 . V_102 ) ||
( V_90 -> V_98 < V_244 -> V_240 . V_103 ) ||
( V_92 -> V_102 > V_244 -> V_238 . V_103 ) ) {
F_5 ( L_37 ) ;
goto V_249;
}
} else {
if ( ( V_90 -> V_98 < V_244 -> V_240 . V_102 ) ||
( V_92 -> V_102 > V_244 -> V_238 . V_102 ) ||
( V_90 -> V_99 < V_244 -> V_240 . V_103 ) ||
( V_92 -> V_103 > V_244 -> V_238 . V_103 ) ) {
F_5 ( L_37 ) ;
goto V_249;
}
}
...
V_92 = & V_246 -> V_92 ;
F_5 ( L_38 ,
V_170 ? L_39 : L_40 , V_246 -> V_72 , V_246 -> V_70 ,
...
static int F_80 ( struct V_27 * V_28 , enum V_250 V_247 )
{
struct V_1 * V_2 = F_18 ( V_28 ) ;
struct V_30 * V_31 = & V_2 -> V_31 ;
struct V_122 * V_123 = V_31 -> V_123 ;
...
case V_248 :
V_252 . V_17 = 1 ;
V_252 . V_262 = V_125 -> V_263 ;
F_8 ( V_2 , V_252 . V_17 ) ;
F_81 ( V_264 , ( void * ) & V_252 ) ;
V_3 = F_3 ( V_32 ) ;
V_3 &= ~ ( V_258 | V_259 ) ;
V_3 |= ( V_265 | V_266 ) ;
F_2 ( V_3 , V_32 ) ;
...
static void F_82 ( struct V_27 * V_28 , enum V_250 V_247 )
{
struct V_1 * V_2 = F_18 ( V_28 ) ;
struct V_251 V_252 = { 0 , 0 } ;
T_1 V_3 ;
F_16 ( L_42 , V_247 ) ;
switch ( V_247 ) {
case V_253 :
...
struct V_30 * V_31 ;
int V_163 ;
V_2 = F_75 ( V_28 , sizeof( * V_2 ) , V_223 ) ;
if ( ! V_2 )
return - V_224 ;
...
V_2 -> V_273 = F_87 ( V_270 , V_274 , 0 ) ;
V_2 -> V_275 = F_88 ( V_28 , V_2 -> V_273 ) ;
if ( F_85 ( V_2 -> V_275 ) )
return F_86 ( V_2 -> V_275 ) ;
V_272 = F_87 ( V_270 , V_276 , 0 ) ;
if ( ! V_272 ) {
F_19 ( V_28 , L_47 ) ;
return - V_277 ;
}
V_2 -> V_207 = V_272 -> V_278 ;
...
static int F_96 ( struct V_269 * V_270 )
{
struct V_27 * V_28 = & V_270 -> V_28 ;
struct V_1 * V_2 = F_18 ( V_28 ) ;
struct V_30 * V_31 = & V_2 -> V_31 ;
