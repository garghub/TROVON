...
F_21 ( V_13 ) ;
if ( V_13 -> V_16 != V_147 )
F_58 ( & V_13 -> V_143 . V_89 -> V_149 , V_150 ) ;
if ( V_13 -> V_84 ) {
for ( V_82 = 0 ; V_82 < V_151 ; ++ V_82 ) {
if ( ! ( V_13 -> V_68 & ( 1 << V_82 ) ) )
continue;
V_130 = & V_13 -> V_3 [ V_82 ] ;
V_148 = V_130 -> V_24 ;
...
if ( V_148 == V_130 -> V_24 )
continue;
F_58 ( & V_130 -> V_130 . V_89 -> V_149 , V_150 ) ;
}
}
}
static int F_59 ( struct V_152 * V_88 )
{
struct V_12 * V_13 ;
int V_62 = 0 ;
int V_82 ;
V_13 = F_60 ( sizeof( struct V_12 ) , V_153 ) ;
if ( ! V_13 ) {
V_62 = - V_154 ;
goto V_78;
}
F_61 ( & V_13 -> V_111 ) ;
V_13 -> V_64 = F_62 ( V_88 -> V_155 ) ;
V_13 -> V_88 = V_88 ;
strcpy ( F_63 ( V_88 ) , V_156 ) ;
strcpy ( F_64 ( V_88 ) , V_157 ) ;
V_88 -> V_158 = V_13 ;
V_62 = F_55 ( V_13 ) ;
if ( V_62 )
goto V_78;
...
F_47 ( V_13 , 0 ) ;
F_65 ( V_13 -> V_64 , F_57 , V_13 ) ;
V_78:
if ( V_62 )
F_66 ( V_88 ) ;
return V_62 ;
}
static int F_66 ( struct V_152 * V_88 )
{
struct V_12 * V_13 ;
int V_82 ;
if ( ! V_88 )
