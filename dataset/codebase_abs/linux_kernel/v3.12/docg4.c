...
int V_36 = ( int ) ( V_135 >> V_9 -> V_140 ) ;
T_4 V_90 = F_33 ( V_36 , 0 ) ;
F_7 ( V_15 -> V_19 , L_31 , V_20 , V_135 ) ;
if ( F_11 ( V_135 & ( V_141 - 1 ) ) )
F_12 ( V_15 -> V_19 , L_32 ,
V_20 , V_135 ) ;
V_5 = F_47 ( V_45 , V_126 ) ;
if ( V_5 == NULL )
return - V_127 ;
memset ( V_9 -> V_41 , 0xff , V_4 -> V_142 ) ;
for ( V_7 = 0 ; V_7 < V_138 -> V_6 ; V_7 ++ )
V_9 -> V_41 [ V_138 -> V_143 + V_7 ] = ~ V_138 -> V_144 [ V_7 ] ;
F_32 ( V_4 , V_90 ) ;
F_44 ( V_4 , V_9 , V_5 , 1 ) ;
V_136 = F_29 ( V_4 ) ;
F_48 ( V_5 ) ;
...
static int F_50 ( struct V_3 * V_4 , T_7 V_135 , int V_145 )
{
return 0 ;
}
static int F_51 ( struct V_146 * V_147 , T_8 V_148 )
{
int V_7 ;
T_2 V_149 ;
struct V_14 * V_15 = F_52 ( V_147 ) ;
void T_1 * V_1 = V_15 -> V_18 ;
F_7 ( V_15 -> V_19 , L_1 , V_20 ) ;
...
static int T_5 F_59 ( struct V_146 * V_147 )
{
struct V_3 * V_4 ;
struct V_8 * V_9 ;
void T_1 * V_18 ;
...
int V_6 , V_63 ;
struct V_207 * V_208 ;
struct V_209 * V_19 = & V_147 -> V_19 ;
V_208 = F_60 ( V_147 , V_210 , 0 ) ;
if ( V_208 == NULL ) {
F_10 ( V_19 , L_37 ) ;
return - V_206 ;
}
...
static int T_9 F_70 ( struct V_146 * V_147 )
{
struct V_14 * V_15 = F_52 ( V_147 ) ;
F_68 ( V_15 -> V_4 ) ;
F_69 ( V_15 -> V_46 ) ;
