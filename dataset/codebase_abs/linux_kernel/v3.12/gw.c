...
if ( ! V_39 -> V_3 . V_46 )
goto V_159;
if ( V_39 -> V_3 . V_46 -> type != V_74 || V_39 -> V_3 . V_46 -> V_160 )
goto V_161;
V_39 -> V_2 . V_46 = F_52 ( & V_72 , V_39 -> V_64 . V_116 ) ;
if ( ! V_39 -> V_2 . V_46 )
goto V_161;
if ( V_39 -> V_2 . V_46 -> type != V_74 || V_39 -> V_2 . V_46 -> V_160 )
goto V_162;
V_39 -> V_55 = V_128 ;
F_25 () ;
V_132 = F_17 ( V_39 ) ;
if ( ! V_132 )
F_53 ( & V_39 -> V_78 , & V_163 ) ;
V_162:
F_54 ( V_39 -> V_2 . V_46 ) ;
V_161:
F_54 ( V_39 -> V_3 . V_46 ) ;
...
static int F_56 ( struct V_36 * V_37 , struct V_86 * V_87 )
{
struct V_38 * V_39 = NULL ;
struct V_76 * V_77 ;
struct V_84 * V_153 ;
...
{
V_44 = F_58 (unsigned int, max_hops, CGW_MIN_HOPS, CGW_MAX_HOPS) ;
F_59 ( L_2 V_164 L_3 ,
V_44 ) ;
V_79 = F_60 ( L_4 , sizeof( struct V_38 ) ,
0 , 0 , NULL ) ;
if ( ! V_79 )
return - V_158 ;
V_165 . V_166 = F_21 ;
F_61 ( & V_165 ) ;
if ( F_62 ( V_167 , V_168 , NULL , F_37 , NULL ) ) {
F_63 ( & V_165 ) ;
F_64 ( V_79 ) ;
return - V_169 ;
}
F_62 ( V_167 , V_121 , F_48 , NULL , NULL ) ;
F_62 ( V_167 , V_170 , F_56 , NULL , NULL ) ;
return 0 ;
}
static T_5 void F_65 ( void )
{
F_66 ( V_167 ) ;
F_63 ( & V_165 ) ;
F_67 () ;
