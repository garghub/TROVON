...
* V_44 = ( V_46 & F_28 ( 5 , 15 ) ) << 6 ;
* V_44 |= ( V_46 & F_28 ( 19 , 30 ) ) << 8 ;
* V_45 = ~ 0ULL ;
* V_45 &= ~ ( ( F_28 ( 5 , 15 ) << 6 ) |
( F_28 ( 19 , 30 ) << 8 ) ) ;
* V_45 |= ( V_47 & F_28 ( 5 , 15 ) ) << 6 ;
* V_45 |= ( V_47 & F_28 ( 19 , 30 ) ) << 8 ;
return;
} else {
V_46 = V_9 -> V_53 [ V_13 ] . V_54 [ V_43 ] ;
V_47 = V_9 -> V_53 [ V_13 ] . V_55 [ V_43 >> 1 ] ;
...
V_10 = V_115 -> V_10 & F_28 ( V_116 , V_117 ) ;
if ( V_9 -> V_31 == 0x15 ) {
struct V_8 * V_9 ;
T_3 V_118 , V_119 ;
T_1 V_120 ;
...
V_37 = V_120 >> 21 & 0x7 ;
V_118 = ( V_120 & F_28 ( 0 , 20 ) ) << 3 ;
V_118 |= V_37 ^ 0x7 ;
V_118 <<= 24 ;
if ( ! V_37 )
return V_118 | ( V_10 & F_28 ( 0 , 23 ) ) ;
F_10 ( V_9 -> V_15 , V_125 , & V_120 ) ;
V_119 = ( V_10 & F_28 ( 12 , 23 ) ) << F_61 ( V_37 + 1 ) ;
V_119 |= ( V_120 & F_28 ( 21 , 23 ) ) >> 9 ;
V_119 |= V_10 & F_28 ( 0 , 11 ) ;
return V_118 | V_119 ;
}
return V_10 ;
}
...
V_9 -> V_140 [ V_132 ] . V_143 . V_141 &= F_28 ( 0 , 15 ) ;
V_9 -> V_140 [ V_132 ] . V_143 . V_141 |= ( ( V_138 & 0x1fff ) << 3 | 0x7 ) << 16 ;
V_9 -> V_140 [ V_132 ] . V_143 . V_145 &= F_28 ( 0 , 7 ) ;
...
return ( V_34 & F_28 ( 6 , 47 ) ) - ( V_184 & F_28 ( 23 , 47 ) ) ;
}
...
static inline void F_112 ( struct V_26 * V_27 ,
struct V_114 * V_115 )
{
struct V_8 * V_9 = V_27 -> V_29 ;
...
void F_117 ( int V_36 , struct V_114 * V_115 )
{
F_112 ( V_123 [ V_36 ] , V_115 ) ;
}
static int F_118 ( struct V_8 * V_9 , T_4 V_249 , T_4 V_250 )
{
...
F_26 ( 1 , L_80 , F_120 ( V_9 -> V_15 ) ) ;
F_26 ( 1 , L_81 , F_120 ( V_9 -> V_12 ) ) ;
F_26 ( 1 , L_82 , F_120 ( V_9 -> V_32 ) ) ;
return 0 ;
}
...
T_3 V_253 ;
T_1 V_120 ;
F_123 ( V_254 , V_9 -> V_255 ) ;
F_26 ( 0 , L_83 , V_9 -> V_255 ) ;
F_123 ( V_256 , V_253 ) ;
if ( V_253 & ( 1U << 21 ) ) {
F_123 ( V_257 , V_9 -> V_258 ) ;
...
static T_1 F_124 ( struct V_8 * V_9 , T_2 V_13 , int V_270 )
{
T_1 V_161 , V_271 ;
...
static void F_126 ( struct V_288 * V_45 , T_4 V_35 )
{
int V_289 ;
F_127 (cpu)
if ( F_60 ( V_289 ) == V_35 )
...
F_126 ( V_45 , V_35 ) ;
F_131 ( V_45 , V_292 , V_293 ) ;
F_132 (cpu, mask) {
struct V_294 * V_14 = F_133 ( V_293 , V_289 ) ;
...
static int F_135 ( struct V_299 * V_229 , T_4 V_35 , bool V_300 )
{
T_5 V_301 ;
int V_289 ;
if ( ! F_130 ( & V_301 , V_291 ) ) {
F_3 ( L_100 , V_42 ) ;
return false ;
}
F_126 ( V_301 , V_35 ) ;
F_131 ( V_301 , V_292 , V_293 ) ;
F_132 (cpu, cmask) {
struct V_294 * V_14 = F_133 ( V_293 , V_289 ) ;
if ( V_300 ) {
if ( V_14 -> V_295 & V_296 )
...
F_136 ( V_301 , V_292 , V_293 ) ;
F_134 ( V_301 ) ;
return 0 ;
}
static bool F_137 ( struct V_299 * V_229 , T_4 V_35 ,
struct V_1 * V_32 )
{
bool V_64 = true ;
T_1 V_304 , V_45 = 0x3 ;
if ( F_135 ( V_229 , V_35 , V_305 ) ) {
F_3 ( L_101 ) ;
return false ;
}
...
static void F_138 ( struct V_299 * V_229 , T_4 V_35 ,
struct V_1 * V_32 )
{
T_1 V_304 , V_45 = 0x3 ;
if ( ! V_229 -> V_308 )
...
if ( F_135 ( V_229 , V_35 , V_310 ) )
F_3 ( L_108 ) ;
}
static bool F_139 ( struct V_1 * V_32 , T_4 V_35 )
{
T_1 V_304 ;
T_2 V_311 = 0 ;
bool V_312 = false ;
...
V_27 -> V_326 = F_120 ( V_9 -> V_12 ) ;
V_27 -> V_327 = NULL ;
V_27 -> V_328 = F_16 ;
V_27 -> V_329 = F_17 ;
}
static struct V_315 * F_148 ( struct V_8 * V_9 )
{
...
T_4 V_35 = F_150 ( V_12 ) ;
V_64 = - V_343 ;
V_9 = F_151 ( sizeof( struct V_8 ) , V_291 ) ;
if ( ! V_9 )
goto V_344;
V_9 -> V_57 = V_35 ;
V_9 -> V_12 = V_12 ;
...
goto V_345;
V_64 = - V_252 ;
V_6 = F_118 ( V_9 , V_330 -> V_249 , V_330 -> V_250 ) ;
if ( V_6 )
goto V_345;
F_122 ( V_9 ) ;
V_64 = - V_11 ;
...
V_342 [ 1 ] . V_349 = 2 ;
V_342 [ 1 ] . V_350 = false ;
V_27 = F_152 ( V_35 , F_14 ( V_342 ) , V_342 , 0 ) ;
if ( ! V_27 )
goto V_347;
V_27 -> V_29 = V_9 ;
...
V_64 = - V_343 ;
V_229 = F_151 ( sizeof( struct V_299 ) , V_291 ) ;
if ( ! V_229 )
goto V_359;
V_360 [ V_35 ] = V_229 ;
if ( ! F_139 ( V_32 , V_35 ) ) {
...
goto V_362;
F_3 ( L_119 ) ;
if ( ! F_137 ( V_229 , V_35 , V_32 ) )
goto V_362;
}
V_64 = F_149 ( V_2 ) ;
if ( V_64 < 0 ) {
F_119 ( L_120 , V_35 ) ;
F_138 ( V_229 , V_35 , V_32 ) ;
}
return V_64 ;
V_362:
F_159 ( V_229 ) ;
...
V_27 = F_163 ( & V_2 -> V_129 ) ;
F_70 ( ! V_27 ) ;
F_144 ( V_27 ) ;
V_27 = F_157 ( & V_2 -> V_129 ) ;
if ( ! V_27 )
return;
V_9 = V_27 -> V_29 ;
F_138 ( V_229 , V_35 , V_32 ) ;
...
{
int V_6 = - V_252 ;
F_169 ( V_364 L_123 , V_324 ) ;
F_170 () ;
if ( F_171 () < 0 )
goto V_344;
V_6 = - V_343 ;
V_123 = F_151 ( F_172 () * sizeof( V_123 [ 0 ] ) , V_291 ) ;
V_360 = F_151 ( F_172 () * sizeof( V_360 [ 0 ] ) , V_291 ) ;
if ( ! ( V_123 && V_360 ) )
goto V_345;
V_293 = F_173 () ;
if ( ! V_293 )
