...
int type , int V_193 , int V_194 )
{
struct V_1 * V_2 = V_47 -> V_2 ;
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_210 * V_211 ;
struct V_249 * V_251 = NULL ;
struct V_108 * V_109 , * V_118 , * V_257 , * * V_258 ;
int V_145 , V_259 , V_260 , V_261 , V_262 ;
if ( V_47 -> V_98 & V_102 )
return V_170 ;
V_261 = type == V_195 ||
type == V_196 ;
...
type == V_198 ;
V_259 = V_145 = 0 ;
V_258 = V_194 ? & V_47 -> V_110 : & V_47 -> V_111 ;
if ( ! * V_258 )
goto V_263;
...
V_260 = 1 ;
V_257 = NULL ;
for ( V_109 = * V_258 ; V_109 ; V_109 = V_118 ) {
struct V_10 * V_264 ;
V_118 = V_109 -> V_112 ;
if ( ! F_122 ( V_47 , V_109 , type , V_193 , V_194 ) ) {
V_257 = V_109 ;
...
if ( V_261 )
V_109 -> V_147 = 0 ;
if ( F_157 ( V_170 ) < sizeof( * V_264 ) +
V_260 * sizeof( struct V_249 ) ) {
if ( V_262 && ! V_260 )
break;
if ( V_251 )
...
if ( ! V_170 )
return NULL ;
V_264 = (struct V_10 * ) F_127 ( V_170 , sizeof( * V_264 ) ) ;
* V_264 = V_109 -> V_130 ;
V_145 ++ ; V_259 ++ ;
if ( ( type == V_199 ||
...
type = V_195 ;
V_170 = F_156 ( V_170 , V_47 , type , 0 , 0 ) ;
F_57 ( & V_47 -> V_97 ) ;
}
} else {
F_54 ( & V_47 -> V_97 ) ;
...
static void F_159 ( struct V_108 * * V_265 )
{
struct V_108 * V_257 , * V_118 , * V_109 ;
V_257 = NULL ;
for ( V_109 = * V_265 ; V_109 ; V_109 = V_118 ) {
V_118 = V_109 -> V_112 ;
if ( V_109 -> V_113 == 0 ) {
if ( V_257 )
V_257 -> V_112 = V_109 -> V_112 ;
...
{
struct V_91 * V_47 , * V_117 , * V_266 ;
struct V_169 * V_170 = NULL ;
int type , V_267 ;
F_30 ( & V_2 -> V_40 ) ;
F_18 ( & V_2 -> V_114 ) ;
V_117 = NULL ;
for ( V_47 = V_2 -> V_115 ; V_47 ; V_47 = V_266 ) {
V_266 = V_47 -> V_24 ;
if ( V_47 -> V_107 == V_64 ) {
type = V_200 ;
V_267 = V_200 ;
V_170 = F_156 ( V_170 , V_47 , type , 1 , 0 ) ;
V_170 = F_156 ( V_170 , V_47 , V_267 , 1 , 1 ) ;
}
if ( V_47 -> V_103 ) {
if ( V_47 -> V_107 == V_30 ) {
type = V_197 ;
...
V_170 = F_156 ( V_170 , V_47 , type , 0 , 0 ) ;
V_170 = F_156 ( V_170 , V_47 , V_267 , 0 , 1 ) ;
if ( V_47 -> V_103 ) {
if ( V_47 -> V_107 == V_30 )
type = V_198 ;
else
...
struct V_169 * V_170 ;
struct V_164 * V_203 ;
const struct V_10 * V_268 , * V_176 ;
struct V_10 V_212 ;
int V_213 = F_130 ( V_13 ) ;
int V_214 = V_13 -> V_215 ;
int V_19 , V_173 , V_174 , V_269 ;
T_3 V_216 [ 8 ] = { V_217 , 0 ,
V_218 , 2 , 0 , 0 ,
V_219 , 0 } ;
struct V_235 V_236 ;
...
V_269 = sizeof( struct V_175 ) + V_174 ;
F_7 () ;
F_139 ( V_18 , F_24 ( V_13 ) ,
V_238 , V_269 ) ;
F_10 () ;
V_170 = F_133 ( V_8 , V_213 + V_214 + V_269 , 1 , & V_19 ) ;
if ( V_170 == NULL ) {
F_7 () ;
...
struct V_91 * V_274 ;
F_30 ( & V_2 -> V_40 ) ;
for ( V_274 = V_2 -> V_120 ; V_274 ; V_274 = V_274 -> V_24 ) {
if ( ! ( V_274 -> V_98 & V_102 ) )
F_161 ( & V_274 -> V_95 , V_2 -> V_13 ,
V_275 ) ;
}
F_31 ( & V_2 -> V_40 ) ;
} else {
...
{
struct V_108 * V_109 , * V_257 ;
int V_53 = 0 ;
V_257 = NULL ;
for ( V_109 = V_47 -> V_111 ; V_109 ; V_109 = V_109 -> V_112 ) {
if ( F_9 ( & V_109 -> V_130 , V_277 ) )
break;
V_257 = V_109 ;
}
...
if ( V_109 -> V_279 && ! ( V_47 -> V_98 & V_102 ) &&
! F_2 ( V_2 ) ) {
...
int V_29 , int V_280 , const struct V_10 * V_277 ,
int V_281 )
{
struct V_91 * V_47 ;
int V_282 = 0 ;
...
V_19 = 0 ;
for ( V_51 = 0 ; V_51 < V_280 ; V_51 ++ ) {
int V_53 = F_169 ( V_47 , V_29 , & V_277 [ V_51 ] ) ;
V_282 |= V_53 > 0 ;
if ( ! V_19 && V_53 < 0 )
V_19 = V_53 ;
}
...
V_109 -> V_279 = V_109 -> V_131 [ V_64 ] != 0 ;
}
static int F_171 ( struct V_91 * V_47 )
{
struct V_108 * V_109 , * V_284 ;
int V_283 = V_47 -> V_126 [ V_30 ] ;
int V_285 = V_47 -> V_2 -> V_104 ;
int V_286 , V_53 ;
V_53 = 0 ;
for ( V_109 = V_47 -> V_111 ; V_109 ; V_109 = V_109 -> V_112 ) {
if ( V_47 -> V_126 [ V_30 ] ) {
V_286 = V_283 == V_109 -> V_131 [ V_30 ] &&
! V_109 -> V_131 [ V_64 ] ;
} else
V_286 = V_109 -> V_131 [ V_64 ] != 0 ;
if ( V_286 ) {
if ( ! V_109 -> V_279 ) {
struct V_108 * V_287 = NULL ;
for ( V_284 = V_47 -> V_110 ; V_284 ;
V_284 = V_284 -> V_112 ) {
if ( F_9 ( & V_284 -> V_130 ,
& V_109 -> V_130 ) )
break;
...
if ( V_284 ) {
if ( V_287 )
V_287 -> V_112 = V_284 -> V_112 ;
else
V_47 -> V_110 = V_284 -> V_112 ;
F_51 ( V_284 ) ;
}
V_109 -> V_113 = V_285 ;
V_53 ++ ;
...
V_109 -> V_113 = 0 ;
for ( V_284 = V_47 -> V_110 ; V_284 ; V_284 = V_284 -> V_112 )
if ( F_9 ( & V_284 -> V_130 ,
& V_109 -> V_130 ) )
break;
if ( ! V_284 ) {
V_284 = F_173 ( sizeof( * V_284 ) , V_71 ) ;
if ( ! V_284 )
continue;
* V_284 = * V_109 ;
V_284 -> V_112 = V_47 -> V_110 ;
V_47 -> V_110 = V_284 ;
}
V_284 -> V_113 = V_285 ;
V_53 ++ ;
...
F_54 ( & V_47 -> V_97 ) ;
F_170 ( V_47 ) ;
V_288 = V_47 -> V_107 == V_30 ;
if ( ! V_281 )
V_47 -> V_126 [ V_29 ] ++ ;
V_19 = 0 ;
for ( V_51 = 0 ; V_51 < V_280 ; V_51 ++ ) {
V_19 = F_172 ( V_47 , V_29 , & V_277 [ V_51 ] ) ;
if ( V_19 )
break;
}
if ( V_19 ) {
...
F_169 ( V_47 , V_29 , & V_277 [ V_52 ] ) ;
} else if ( V_288 != ( V_47 -> V_126 [ V_30 ] != 0 ) ) {
struct V_108 * V_109 ;
if ( V_47 -> V_126 [ V_30 ] )
V_47 -> V_107 = V_30 ;
...
{
struct V_108 * V_109 , * V_289 ;
for ( V_109 = V_47 -> V_110 ; V_109 ; V_109 = V_289 ) {
V_289 = V_109 -> V_112 ;
F_51 ( V_109 ) ;
}
V_47 -> V_110 = NULL ;
for ( V_109 = V_47 -> V_111 ; V_109 ; V_109 = V_289 ) {
V_289 = V_109 -> V_112 ;
F_51 ( V_109 ) ;
}
V_47 -> V_111 = NULL ;
...
if ( V_127 -> V_98 & V_102 )
return;
F_161 ( & V_127 -> V_95 , V_127 -> V_2 -> V_13 , V_275 ) ;
