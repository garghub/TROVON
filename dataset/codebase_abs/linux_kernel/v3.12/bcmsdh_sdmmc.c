...
V_50 -> V_56 . V_57 = V_2 ;
F_35 ( & V_12 -> V_58 , V_50 ) ;
F_35 ( & V_2 -> V_12 [ 1 ] -> V_58 , V_50 ) ;
V_2 -> V_58 = & V_2 -> V_12 [ 1 ] -> V_58 ;
V_2 -> V_59 = V_60 ;
F_36 ( & V_2 -> V_4 , false ) ;
F_37 ( & V_2 -> V_24 ) ;
F_37 ( & V_2 -> V_30 ) ;
...
F_41 ( V_2 ) ;
F_35 ( & V_2 -> V_12 [ 1 ] -> V_58 , NULL ) ;
F_35 ( & V_2 -> V_12 [ 2 ] -> V_58 , NULL ) ;
F_12 ( V_50 ) ;
F_12 ( V_2 ) ;
}
F_15 ( V_23 , L_29 ) ;
}
static int F_42 ( struct V_53 * V_58 )
{
T_6 V_63 ;
struct V_49 * V_50 = F_40 ( V_58 ) ;
struct V_1 * V_2 = V_50 -> V_56 . V_57 ;
int V_32 = 0 ;
F_15 ( V_23 , L_13 ) ;
F_36 ( & V_2 -> V_4 , true ) ;
V_63 = F_43 ( V_2 -> V_12 [ 1 ] ) ;
if ( ! ( V_63 & V_64 ) ) {
F_8 ( L_30 ) ;
return - V_29 ;
}
V_32 = F_44 ( V_2 -> V_12 [ 1 ] , V_64 ) ;
if ( V_32 ) {
F_8 ( L_31 ) ;
return V_32 ;
}
...
static int F_46 ( struct V_53 * V_58 )
{
struct V_49 * V_50 = F_40 ( V_58 ) ;
struct V_1 * V_2 = V_50 -> V_56 . V_57 ;
F_45 ( V_2 , true ) ;
