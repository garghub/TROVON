...
V_126 [ V_127 ] = {} ;
int V_128 , V_129 [ V_127 ] ;
int V_112 , V_30 , V_130 = 0 , V_131 = 0 , V_132 = 0 ;
struct V_3 * V_4 ;
struct V_119 * V_36 ;
struct V_133 * V_33 , * V_67 , * V_134 , * V_135 ;
if ( V_111 -> V_37 . V_84 )
V_7 = F_68 ( V_136 , & V_111 -> V_37 ) -> V_16 ;
else
V_7 = F_69 ( & V_111 -> V_37 ) ;
if ( ! V_7 || ! V_7 -> V_31 )
return - V_137 ;
V_33 = F_70 ( V_111 , V_138 , 0 ) ;
V_67 = F_70 ( V_111 , V_138 , 1 ) ;
V_134 = F_70 ( V_111 , V_139 , 0 ) ;
if ( ! V_33 || ! V_134 )
return - V_137 ;
...
if ( ! V_7 -> V_140 )
F_74 ( V_141 , V_36 -> V_142 ) ;
if ( V_7 -> V_86 && V_7 -> V_87 )
F_74 ( V_143 , V_36 -> V_142 ) ;
V_36 -> V_144 = V_65 ;
V_4 -> V_35 . V_145 = & V_146 ;
V_4 -> V_35 . V_147 = sizeof( struct V_74 ) ;
...
if ( V_112 < 0 )
F_51 ( & V_111 -> V_37 , L_10 , V_151 , V_112 ) ;
F_79 ( & V_25 ) ;
F_80 ( & V_4 -> V_152 , & V_153 ) ;
F_81 ( & V_25 ) ;
V_112 = F_16 ( V_4 ) ;
if ( V_112 )
goto V_154;
#if F_82 ( V_155 ) || F_82 ( V_156 )
V_135 = F_70 ( V_111 , V_139 , 1 ) ;
if ( ! V_135 )
V_135 = V_134 ;
else
V_131 ++ ;
if ( V_135 == V_134 ||
( V_134 -> V_24 & V_157 ) == V_158 )
V_124 = V_159 ;
V_128 = V_134 -> V_160 ;
V_112 = F_83 ( & V_111 -> V_37 , V_128 , F_40 , V_124 ,
L_11 , V_4 ) ;
if ( V_112 ) {
F_51 ( & V_111 -> V_37 ,
L_12 ,
...
V_135 = V_134 ;
#endif
if ( V_135 -> V_160 == V_135 -> V_162 &&
! F_70 ( V_111 , V_139 , 1 ) ) {
for (; V_130 < V_7 -> V_31 ; V_130 ++ ) {
if ( V_130 < V_127 ) {
V_129 [ V_130 ] = V_135 -> V_160 ;
V_126 [ V_130 ] = V_159 ;
} else {
V_132 = 1 ;
break;
...
do {
for ( V_30 = V_135 -> V_160 ; V_30 <= V_135 -> V_162 ; V_30 ++ ) {
if ( V_130 >= V_127 ) {
V_132 = 1 ;
break;
}
...
V_135 = F_70 ( V_111 ,
V_139 , ++ V_131 ) ;
} while ( V_130 < V_7 -> V_31 && V_135 );
}
for ( V_30 = 0 ; V_30 < V_130 ; V_30 ++ ) {
V_112 = F_48 ( V_4 , V_30 , V_129 [ V_30 ] , V_126 [ V_30 ] ) ;
if ( V_112 )
goto V_163;
}
if ( V_132 )
