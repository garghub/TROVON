...
V_61 = 0xf0 ;
V_62 = F_25 ( V_5 , V_7 , V_9 , V_10 , V_61 ) ;
if ( V_62 )
return V_62 ;
V_12 -> V_25 &= ~ 0x00c0 ;
...
static const void * F_26 ( struct V_4 * V_5 ,
struct V_64 * V_65 )
{
const struct V_66 * V_67 ;
int V_18 ;
for ( V_18 = 0 ; V_18 < F_27 ( V_68 ) ; V_18 ++ ) {
V_67 = & V_68 [ V_18 ] ;
