...
static int F_59 ( struct V_66 * V_48 , T_5 V_67 ,
T_2 * V_68 , T_5 * V_100 )
{
int V_24 , V_41 ;
T_3 V_25 ;
...
int F_60 ( struct V_38 * V_39 , T_5 V_40 ,
T_2 * V_101 )
{
...
F_44 ( & V_53 , V_39 ) ;
for ( V_57 = 0 ; V_57 < V_39 -> V_58 ; V_57 ++ ) {
V_41 = F_59 ( & V_53 , V_40 , V_101 + V_57 ,
...
static int F_61 ( struct V_66 * V_48 , T_5 V_67 ,
int (* F_62)( void * V_28 , T_2 * V_19 , void * V_102 ) ,
void * V_28 )
{
int V_41 ;
unsigned V_24 , V_103 ;
...
if ( F_4 ( V_10 -> V_15 . V_25 ) & V_26 ) {
V_41 = F_61 ( V_48 , F_9 ( V_10 , V_24 ) , F_62 , V_28 ) ;
if ( V_41 )
goto V_64;
} else {
V_19 = F_5 ( * F_63 ( V_10 , V_24 ) ) ;
V_41 = F_62 ( V_28 , & V_19 , F_10 ( V_10 , V_24 ) ) ;
if ( V_41 )
goto V_64;
}
}
