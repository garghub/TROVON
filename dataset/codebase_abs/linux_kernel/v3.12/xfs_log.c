...
struct V_121 * V_139 ;
T_6 V_140 ;
F_91 ( & V_37 -> V_89 -> V_141 ) ;
V_139 = F_92 ( V_37 -> V_89 ) ;
if ( V_139 )
V_140 = V_139 -> V_142 ;
else
V_140 = F_2 ( & log -> V_143 ) ;
F_93 ( & log -> V_144 , V_140 ) ;
return V_140 ;
}
T_6
F_94 (
...
int V_147 ;
int V_148 ;
F_95 ( V_2 , & V_147 , & V_148 ) ;
F_96 ( & log -> V_144 , & V_146 , & V_145 ) ;
V_145 = F_97 ( V_145 ) ;
...
int V_154 = 0 ;
if ( F_99 ( ( F_100 ( V_150 ) ) , V_152 -> V_149 ,
V_155 , V_156 ) ) {
F_101 ( V_150 , V_113 ) ;
F_102 ( V_150 ) ;
...
struct V_36 * V_37 )
{
F_107 ( V_37 -> V_174 , & V_37 -> V_38 -> V_118 ,
F_108 ( V_175 * 10 ) ) ;
}
void
F_109 (
struct V_176 * V_177 )
{
struct V_1 * log = F_110 ( F_111 ( V_177 ) ,
struct V_1 , V_118 ) ;
...
int error = V_54 ;
T_4 V_182 = 0 ;
log = F_114 ( sizeof( struct V_1 ) , V_53 ) ;
if ( ! log ) {
F_55 ( V_37 , L_15 ) ;
goto V_81;
}
...
F_105 ( V_37 , log ) ;
error = V_54 ;
V_150 = F_118 ( V_37 -> V_192 , 0 , F_119 ( log -> V_164 ) , 0 ) ;
if ( ! V_150 )
goto V_87;
V_150 -> V_193 = F_98 ;
ASSERT ( F_120 ( V_150 ) ) ;
...
* V_179 = F_114 ( sizeof( T_11 ) , V_53 ) ;
if ( ! * V_179 )
goto V_196;
V_59 = * V_179 ;
V_59 -> V_197 = V_180 ;
V_180 = V_59 ;
V_150 = F_122 ( V_37 -> V_192 ,
F_119 ( log -> V_164 ) , 0 ) ;
if ( ! V_150 )
goto V_196;
V_150 -> V_193 = F_98 ;
...
V_2 -> V_204 = F_123 ( V_205 ) ;
V_2 -> V_206 = F_123 (
F_106 ( & log -> V_149 -> V_82 ) ? 2 : 1 ) ;
V_2 -> V_207 = F_123 ( log -> V_164 ) ;
V_2 -> V_208 = F_123 ( V_209 ) ;
memcpy ( & V_2 -> V_210 , & V_37 -> V_82 . V_211 , sizeof( V_212 ) ) ;
V_59 -> V_213 = F_97 ( V_150 -> V_214 ) - log -> V_167 ;
V_59 -> V_67 = V_69 ;
V_59 -> V_153 = log ;
F_124 ( & V_59 -> V_115 , 0 ) ;
F_10 ( & V_59 -> V_66 ) ;
...
int V_225 ;
int V_226 ;
ASSERT ( F_119 ( V_24 ) < log -> V_185 ) ;
V_23 = F_21 ( log , & log -> V_56 . V_12 ) ;
V_223 = F_130 ( V_23 ) ;
V_226 = F_119 ( V_24 ) ;
V_226 = F_131 ( V_226 , ( log -> V_185 >> 2 ) ) ;
V_226 = F_131 ( V_226 , 256 ) ;
if ( V_223 >= V_226 )
return;
F_96 ( & log -> V_144 , & V_225 ,
& V_224 ) ;
V_224 += V_226 ;
if ( V_224 >= log -> V_185 ) {
V_224 -= log -> V_185 ;
...
V_224 ) ;
V_222 = F_2 ( & log -> V_143 ) ;
if ( F_133 ( V_221 , V_222 ) > 0 )
V_221 = V_222 ;
if ( ! F_26 ( log ) )
F_134 ( log -> V_88 , V_221 ) ;
}
STATIC void
F_135 (
struct V_1 * log ,
...
T_16 V_230 ;
V_202 V_231 ;
V_230 = F_136 ( V_59 -> V_203 . V_232 ) ;
V_231 = V_59 -> V_216 ;
for ( V_181 = 0 ; V_181 < F_119 ( V_158 ) ; V_181 ++ ) {
...
if ( F_106 ( & log -> V_149 -> V_82 ) ) {
T_17 * V_234 = V_59 -> V_199 ;
for ( ; V_181 < F_119 ( V_158 ) ; V_181 ++ ) {
...
{
T_13 V_240 ;
V_240 = F_138 ( ( char * ) V_239 ,
sizeof( struct V_238 ) ,
F_139 ( struct V_238 , V_241 ) ) ;
if ( F_106 ( & log -> V_149 -> V_82 ) ) {
union V_242 * V_234 = (union V_242 * ) V_239 ;
int V_181 ;
for ( V_181 = 1 ; V_181 < log -> V_169 ; V_181 ++ ) {
V_240 = F_140 ( V_240 , & V_234 [ V_181 ] . V_235 ,
sizeof( struct V_243 ) ) ;
}
}
V_240 = F_140 ( V_240 , V_231 , V_158 ) ;
return F_141 ( V_240 ) ;
}
STATIC int
F_142 (
...
int V_247 = 0 ;
int error ;
int V_248 = F_106 ( & log -> V_149 -> V_82 ) ;
int V_158 ;
F_28 ( V_249 ) ;
ASSERT ( F_147 ( & V_59 -> V_115 ) == 0 ) ;
V_246 = log -> V_167 + V_59 -> V_95 ;
if ( V_248 && log -> V_149 -> V_82 . V_250 > 1 ) {
V_245 = F_148 ( log , F_149 ( log , V_246 ) ) ;
} else {
V_245 = F_97 ( F_119 ( V_246 ) ) ;
}
V_227 = V_245 - V_246 ;
ASSERT ( V_227 >= 0 ) ;
...
F_135 ( log , V_59 , V_227 ) ;
V_158 = V_59 -> V_95 ;
if ( V_248 )
V_158 += V_227 ;
V_59 -> V_203 . V_251 = F_123 ( V_158 ) ;
V_150 = V_59 -> V_198 ;
F_150 ( V_150 , F_151 ( F_152 ( V_59 -> V_203 . V_232 ) ) ) ;
F_153 ( V_252 , F_119 ( V_245 ) ) ;
if ( F_154 ( V_150 ) + F_119 ( V_245 ) > log -> V_185 ) {
char * V_253 ;
V_247 = V_245 - ( F_97 ( log -> V_185 - F_154 ( V_150 ) ) ) ;
V_245 = F_97 ( log -> V_185 - F_154 ( V_150 ) ) ;
V_59 -> V_254 = 2 ;
V_253 = ( char * ) & V_59 -> V_203 + V_245 ;
for ( V_181 = 0 ; V_181 < V_247 ; V_181 += V_171 ) {
T_13 V_7 = F_155 ( * ( T_16 * ) V_253 ) ;
if ( ++ V_7 == V_205 )
V_7 ++ ;
* ( T_16 * ) V_253 = F_123 ( V_7 ) ;
V_253 += V_171 ;
}
} else {
V_59 -> V_254 = 1 ;
}
V_59 -> V_203 . V_241 = F_137 ( log , & V_59 -> V_203 ,
V_59 -> V_216 , V_158 ) ;
V_150 -> V_255 = F_119 ( V_245 ) ;
V_150 -> V_151 = V_59 ;
F_156 ( V_150 ) ;
F_157 ( V_150 ) ;
V_150 -> V_256 |= V_257 ;
...
F_158 ( log -> V_149 -> V_119 ) ;
else
V_150 -> V_256 |= V_260 ;
}
ASSERT ( F_154 ( V_150 ) <= log -> V_185 - 1 ) ;
ASSERT ( F_154 ( V_150 ) + F_119 ( V_245 ) <= log -> V_185 ) ;
F_159 ( log , V_59 , V_245 , true ) ;
F_150 ( V_150 , F_154 ( V_150 ) + log -> V_184 ) ;
F_160 ( V_150 ) ;
error = F_142 ( V_150 ) ;
if ( error ) {
F_101 ( V_150 , L_19 ) ;
...
int V_181 ;
F_162 ( log ) ;
F_163 ( log -> V_194 , F_119 ( log -> V_164 ) ) ;
F_126 ( log -> V_194 ) ;
V_59 = log -> V_94 ;
for ( V_181 = 0 ; V_181 < log -> V_161 ; V_181 ++ ) {
F_126 ( V_59 -> V_198 ) ;
...
int error ;
* V_304 = 0 ;
V_30 = F_168 ( V_57 , V_272 ) ;
if ( V_57 -> V_19 & V_62 )
V_57 -> V_42 -= sizeof( V_266 ) ;
if ( V_60 & ( V_220 | V_112 ) )
V_57 -> V_42 -= sizeof( V_266 ) ;
if ( V_57 -> V_42 < 0 )
F_166 ( log -> V_149 , V_57 ) ;
V_305 = 0 ;
V_273 = V_272 ;
V_278 = V_273 -> V_111 ;
...
void * V_307 ;
int V_302 ;
error = F_173 ( log , V_30 , & V_59 , V_57 ,
& V_306 , & V_302 ) ;
if ( error )
return error ;
...
V_308 = F_169 ( V_307 , V_57 ) ;
if ( V_308 ) {
V_262 ++ ;
F_174 ( & V_307 , & V_30 , & V_302 ,
V_308 ) ;
}
V_280 = F_170 ( log , V_307 , V_57 , V_60 ) ;
if ( ! V_280 )
return F_27 ( V_39 ) ;
F_174 ( & V_307 , & V_30 , & V_302 ,
sizeof( struct V_279 ) ) ;
V_30 += F_171 ( V_57 , V_280 ,
V_59 -> V_213 - V_302 ,
V_103 -> V_105 ,
& V_291 , & V_292 ,
& V_300 ,
...
F_174 ( & V_307 , & V_30 , & V_302 , V_292 ) ;
V_292 += V_308 + sizeof( V_266 ) ;
V_262 ++ ;
V_299 += V_306 ? V_292 : 0 ;
error = F_172 ( log , V_59 , V_60 ,
& V_262 , & V_299 ,
& V_300 ,
& V_301 ,
V_302 ,
...
if ( V_315 &&
F_133 ( V_315 ,
F_152 ( V_59 -> V_203 . V_232 ) ) < 0 ) {
V_59 = V_59 -> V_96 ;
continue;
}
V_59 -> V_67 = V_325 ;
ASSERT ( F_133 ( F_2 ( & log -> V_143 ) ,
F_152 ( V_59 -> V_203 . V_232 ) ) <= 0 ) ;
if ( V_59 -> V_215 )
F_93 ( & log -> V_143 ,
F_152 ( V_59 -> V_203 . V_232 ) ) ;
} else
V_318 ++ ;
F_15 ( & log -> V_114 ) ;
F_12 ( & V_59 -> V_66 ) ;
...
log -> V_167 ,
V_333 ) ;
V_2 -> V_334 = F_123 ( log -> V_187 ) ;
V_2 -> V_232 = F_180 (
F_132 ( log -> V_187 , log -> V_335 ) ) ;
ASSERT ( log -> V_335 >= 0 ) ;
}
if ( V_59 -> V_213 - V_59 -> V_95 < 2 * sizeof( V_266 ) ) {
F_181 ( log , V_59 , V_59 -> V_213 ) ;
if ( ! F_182 ( & V_59 -> V_115 , - 1 , 1 ) ) {
F_15 ( & log -> V_114 ) ;
error = F_47 ( log , V_59 ) ;
if ( error )
return error ;
...
V_59 -> V_67 == V_70 ) ;
if ( V_59 -> V_67 == V_70 ) {
T_6 V_140 = F_94 ( log -> V_149 ) ;
V_336 ++ ;
V_59 -> V_67 = V_328 ;
V_59 -> V_203 . V_337 = F_180 ( V_140 ) ;
F_190 ( log , V_59 , V_140 ) ;
}
F_15 ( & log -> V_114 ) ;
if ( V_336 )
return F_146 ( log , V_59 ) ;
return 0 ;
}
STATIC void
F_181 (
...
V_338 = V_59 -> V_95 ;
V_59 -> V_67 = V_70 ;
V_59 -> V_203 . V_339 = F_123 ( log -> V_186 ) ;
log -> V_186 = log -> V_335 ;
log -> V_340 = log -> V_187 ;
log -> V_335 += F_119 ( V_338 ) + F_119 ( log -> V_167 ) ;
if ( F_106 ( & log -> V_149 -> V_82 ) &&
log -> V_149 -> V_82 . V_250 > 1 ) {
T_13 V_341 = F_119 ( log -> V_149 -> V_82 . V_250 ) ;
log -> V_335 = F_191 ( log -> V_335 , V_341 ) ;
}
...
if ( F_147 ( & V_59 -> V_115 ) == 0 ) {
F_72 ( & V_59 -> V_115 ) ;
V_61 = F_152 ( V_59 -> V_203 . V_232 ) ;
F_181 ( log , V_59 , 0 ) ;
F_15 ( & log -> V_114 ) ;
if ( F_47 ( log , V_59 ) )
return F_27 ( V_39 ) ;
...
* V_342 = 1 ;
F_12 ( & log -> V_114 ) ;
if ( F_152 ( V_59 -> V_203 . V_232 ) == V_61 &&
V_59 -> V_67 != V_116 )
goto V_345;
else
goto V_344;
...
int error ;
F_193 ( V_37 , V_61 ) ;
error = F_194 ( V_37 , V_61 , V_60 , NULL ) ;
if ( error )
F_55 ( V_37 , L_94 , V_113 , error ) ;
}
STATIC void
...
V_353 = F_201 ( V_44 , V_352 ) ;
V_44 += sizeof( V_266 ) * V_353 ;
while ( ! V_353 ||
F_201 ( V_44 , V_352 ) > V_353 ) {
V_44 += sizeof( V_266 ) ;
V_353 ++ ;
}
V_44 += log -> V_167 * V_353 ;
V_44 += log -> V_167 ;
if ( F_106 ( & V_37 -> V_82 ) && V_37 -> V_82 . V_250 > 1 ) {
...
struct V_15 * V_16 ;
int V_356 ;
V_16 = F_202 ( V_351 , V_355 ) ;
if ( ! V_16 )
return NULL ;
V_356 = F_200 ( log -> V_149 , V_44 ) ;
F_124 ( & V_16 -> V_350 , 1 ) ;
V_16 -> V_17 = V_357 ;
F_9 ( & V_16 -> V_358 ) ;
V_16 -> V_21 = V_356 ;
...
int V_146 , V_361 ;
int V_7 , V_8 ;
F_95 ( & log -> V_18 . V_12 , & V_7 , & V_8 ) ;
F_96 ( & log -> V_144 , & V_146 , & V_361 ) ;
if ( V_146 != V_7 ) {
if ( V_7 - 1 != V_146 &&
! ( log -> V_25 & V_362 ) ) {
F_167 ( log -> V_149 , V_271 ,
L_96 , V_113 ) ;
log -> V_25 |= V_362 ;
}
if ( V_8 > F_97 ( V_361 ) &&
...
{
int V_363 ;
if ( F_205 ( V_140 ) == log -> V_340 ) {
V_363 =
log -> V_185 - ( log -> V_186 - F_151 ( V_140 ) ) ;
if ( V_363 < F_119 ( V_59 -> V_95 ) + F_119 ( log -> V_167 ) )
F_204 ( log -> V_149 , L_98 , V_113 ) ;
} else {
ASSERT ( F_205 ( V_140 ) + 1 == log -> V_340 ) ;
if ( F_151 ( V_140 ) == log -> V_186 )
F_204 ( log -> V_149 , L_99 , V_113 ) ;
V_363 = F_151 ( V_140 ) - log -> V_186 ;
if ( V_363 < F_119 ( V_59 -> V_95 ) + 1 )
F_204 ( log -> V_149 , L_98 , V_113 ) ;
}
}
STATIC void
...
if ( V_366 != log -> V_94 )
F_204 ( log -> V_149 , L_100 , V_113 ) ;
F_15 ( & log -> V_114 ) ;
if ( V_59 -> V_203 . V_204 != F_123 ( V_205 ) )
F_204 ( log -> V_149 , L_101 , V_113 ) ;
V_307 = ( V_202 ) & V_59 -> V_203 ;
for ( V_307 += V_171 ; V_307 < ( ( V_202 ) & V_59 -> V_203 ) + V_245 ;
V_307 += V_171 ) {
if ( * ( T_16 * ) V_307 == F_123 ( V_205 ) )
F_204 ( log -> V_149 , L_102 ,
V_113 ) ;
}
V_30 = F_155 ( V_59 -> V_203 . V_264 ) ;
V_307 = V_59 -> V_216 ;
V_367 = V_307 ;
V_365 = ( V_266 * ) V_307 ;
V_234 = V_59 -> V_199 ;
...
V_371 = F_130 ( ( V_202 ) & ( V_365 -> V_282 ) - V_59 -> V_216 ) ;
...
if ( ! V_364 || ( V_368 & 0x1ff ) ) {
V_370 = F_155 ( V_365 -> V_284 ) ;
} else {
V_371 = F_130 ( ( T_20 ) & V_365 -> V_284 -
( T_20 ) V_59 -> V_216 ) ;
if ( V_371 >= ( V_166 / V_171 ) ) {
V_228 = V_371 / ( V_166 / V_171 ) ;
V_229 = V_371 % ( V_166 / V_171 ) ;
V_370 = F_155 ( V_234 [ V_228 ] . V_235 . V_236 [ V_229 ] ) ;
} else {
V_370 = F_155 ( V_59 -> V_203 . V_233 [ V_371 ] ) ;
}
}
