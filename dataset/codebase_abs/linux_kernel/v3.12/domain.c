...
static struct V_8 * F_23 ( struct V_8 * V_15 , T_1 V_50 )
{
...
static struct V_8 * F_28 ( struct V_8 * V_15 ,
...
F_40 ( V_67 ) ;
V_28:
error = F_41 ( V_15 , & V_21 , V_100 , V_101 , V_45 ,
V_18 , V_71 , V_23 . V_102 , V_72 , error ) ;
V_80:
F_10 ( V_15 ) ;
F_42 ( V_68 ) ;
return error ;
...
{
int V_103 = F_44 ( V_65 ) ;
if ( ! V_103 && ( V_65 -> V_90 & V_97 ) )
V_103 = 1 ;
return V_103 ;
}
void F_45 ( struct V_64 * V_65 )
{
struct V_8 * V_15 = F_46 () ;
struct V_66 * V_104 = F_32 ( V_65 -> V_74 ) ;
if ( ( V_104 -> V_15 == V_15 ) ||
( F_7 ( V_104 -> V_15 ) ) )
return;
V_96 -> V_105 = 0 ;
F_47 ( V_15 , V_104 -> V_15 ) ;
}
void F_48 ( struct V_64 * V_65 )
{
return;
}
static char * F_49 ( const char * V_106 , const char * V_107 )
{
char * V_18 = F_50 ( strlen ( V_106 ) + strlen ( V_107 ) + 3 , V_100 ) ;
if ( V_18 )
sprintf ( V_18 , L_8 , V_106 , V_107 ) ;
return V_18 ;
}
int F_51 ( const char * V_108 [] , int V_109 , T_2 V_110 , bool V_111 )
{
const struct V_74 * V_74 ;
struct V_66 * V_67 ;
struct V_8 * V_15 , * V_112 , * V_113 = NULL ;
char * V_18 = NULL ;
int V_3 ;
struct V_14 V_21 = {} ;
...
struct V_8 * V_116 ;
if ( F_54 ( V_15 ) )
V_116 = F_55 ( & V_15 -> V_117 ) ;
else
V_116 = F_20 ( V_15 ) ;
for ( V_3 = 0 ; V_3 < V_109 && ! V_113 ; V_3 ++ )
V_113 = F_24 ( V_116 , V_108 [ V_3 ] ) ;
if ( ! V_113 ) {
if ( ! F_37 ( V_116 ) || V_111 ) {
if ( F_56 ( & V_116 -> V_34 . V_62 ) )
error = - V_118 ;
else
error = - V_86 ;
F_10 ( V_116 ) ;
...
V_18 = F_49 ( V_116 -> V_34 . V_59 , V_108 [ 0 ] ) ;
F_10 ( V_116 ) ;
V_71 = V_18 ;
V_113 = F_38 ( V_15 , 1 ) ;
if ( ! V_113 ) {
...
V_28:
if ( ! V_111 )
error = F_41 ( V_15 , & V_21 , V_100 ,
V_120 , V_119 , NULL ,
V_71 , V_121 , V_72 , error ) ;
V_12:
F_10 ( V_113 ) ;
F_42 ( V_18 ) ;
F_59 ( V_74 ) ;
...
int F_60 ( const char * V_48 , const char * V_59 , bool V_79 ,
bool V_111 )
{
const struct V_74 * V_74 ;
struct V_8 * V_15 , * V_71 = NULL ;
...
V_28:
if ( ! V_111 )
error = F_41 ( V_15 , & V_21 , V_100 , V_122 , V_19 ,
V_18 , V_59 , V_121 , V_72 , error ) ;
F_27 ( V_17 ) ;
F_10 ( V_71 ) ;
F_59 ( V_74 ) ;
return error ;
