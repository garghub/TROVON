...
struct V_28 * V_29 = V_3 -> V_30 ;
int V_31 ;
V_31 = F_76 ( V_3 , 1 , NULL ) ;
if ( V_31 )
return V_31 ;
if ( V_61 ) {
if ( F_77 ( V_3 -> V_58 >= 512 ) ) {
V_29 -> V_32 . V_33 = 512 ;
V_29 -> V_32 . V_79 = 6 ;
V_29 -> V_32 . V_80 = 2 ;
} else {
...
if ( V_61 ) {
#ifdef F_86
V_29 -> V_32 . V_108 = & V_109 ;
#endif
V_29 -> V_94 = F_54 ;
V_29 -> V_95 = F_55 ;
V_29 -> V_32 . V_110 = F_20 ;
V_29 -> V_32 . V_111 = F_18 ;
V_29 -> V_32 . V_34 = V_112 ;
V_29 -> V_32 . V_113 = F_19 ;
V_29 -> V_32 . V_114 = F_56 ;
V_29 -> V_32 . V_115 = F_57 ;
} else {
V_29 -> V_32 . V_34 = V_116 ;
}
if ( F_75 ( V_3 ) ) {
V_62 = - V_72 ;
goto V_117;
...
static int F_87 ( struct V_4 * V_7 , T_7 V_119 )
{
struct V_1 * V_19 = F_4 ( V_7 ) ;
return 0 ;
}
static int F_88 ( struct V_4 * V_7 )
{
struct V_1 * V_19 = F_4 ( V_7 ) ;
return 0 ;
}
