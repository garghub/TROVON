...
F_37 ( & V_9 -> V_29 ) ;
if ( V_17 ) {
V_9 -> V_64 = F_38 ( V_13 , L_8 ,
F_39 ( V_9 -> V_15 ) , V_17 ) ;
V_17 = V_9 -> V_64 ;
} else {
V_17 = F_39 ( V_9 -> V_15 ) ;
}
V_9 -> V_65 = F_40 ( V_17 , V_66 ) ;
if ( ! V_9 -> V_65 ) {
F_41 ( V_9 -> V_15 , L_9 ) ;
return;
}
F_42 ( L_10 , 0400 , V_9 -> V_65 ,
V_9 , & V_67 ) ;
F_42 ( L_11 , 0400 , V_9 -> V_65 ,
V_9 , & V_68 ) ;
if ( V_9 -> V_30 ) {
F_42 ( L_12 , 0400 , V_9 -> V_65 ,
V_9 , & V_69 ) ;
F_42 ( L_13 , 0400 , V_9 -> V_65 ,
V_9 , & V_70 ) ;
}
if ( V_9 -> V_71 ) {
F_43 ( L_14 , 0400 , V_9 -> V_65 ,
& V_9 -> V_72 ) ;
F_43 ( L_15 , 0400 , V_9 -> V_65 ,
& V_9 -> V_73 ) ;
F_43 ( L_16 , 0400 , V_9 -> V_65 ,
& V_9 -> V_74 ) ;
}
V_62 = F_44 ( & V_9 -> V_75 ) ;
while ( V_62 ) {
V_63 = F_45 ( V_62 , struct V_53 , V_76 ) ;
if ( V_63 -> V_17 )
F_42 ( V_63 -> V_17 , 0400 ,
V_9 -> V_65 , V_63 ,
& V_77 ) ;
