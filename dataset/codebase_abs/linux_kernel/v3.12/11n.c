...
F_6 ( & V_2 -> V_35 , V_34 ) ;
F_7 (tx_ba_tsr_tbl, &priv->tx_ba_stream_tbl_ptr, list) {
if ( ! memcmp ( V_33 -> V_50 , V_50 , V_146 ) &&
V_33 -> V_38 == V_38 ) {
F_8 ( & V_2 -> V_35 ,
V_34 ) ;
return V_33 ;
...
V_147 -> V_38 = V_38 ;
V_147 -> V_32 = V_32 ;
memcpy ( V_147 -> V_50 , V_50 , V_146 ) ;
F_6 ( & V_2 -> V_35 , V_34 ) ;
F_32 ( & V_147 -> V_139 , & V_2 -> V_143 ) ;
F_8 ( & V_2 -> V_35 , V_34 ) ;
}
}
...
V_152 = 1 ;
V_151 . V_161 = V_152 ;
memcpy ( & V_151 . V_47 , V_149 , V_146 ) ;
V_153 = F_33 ( V_2 , V_162 ,
0 , 0 , & V_151 ) ;
return V_153 ;
}
int F_34 ( struct V_1 * V_2 , int V_38 , T_1 * V_149 ,
int V_163 )
{
struct V_40 V_164 ;
int V_153 ;
...
V_43 &= ~ V_165 ;
memcpy ( & V_164 . V_47 , V_149 , V_146 ) ;
V_153 = F_33 ( V_2 , V_166 ,
V_76 , 0 , & V_164 ) ;
return V_153 ;
}
...
V_154 , V_171 -> V_38 ) ;
memcpy ( V_171 -> V_50 , V_33 -> V_50 , V_146 ) ;
V_171 ++ ;
V_174 ++ ;
if ( V_174 >= V_182 )
break;
...
if ( ! memcmp ( V_183 -> V_50 , V_50 , V_146 ) ) {
F_8 ( & V_2 -> V_35 ,
V_34 ) ;
F_25 ( V_2 , V_183 ) ;
F_6 ( & V_2 -> V_35 , V_34 ) ;
