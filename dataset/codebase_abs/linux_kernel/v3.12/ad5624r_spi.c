...
struct V_9 * V_10 ;
int V_25 , V_39 = 0 ;
V_10 = F_12 ( & V_2 -> V_40 , sizeof( * V_16 ) ) ;
if ( ! V_10 )
return - V_41 ;
V_16 = F_4 ( V_10 ) ;
V_16 -> V_42 = F_13 ( & V_2 -> V_40 , L_2 ) ;
if ( ! F_14 ( V_16 -> V_42 ) ) {
V_25 = F_15 ( V_16 -> V_42 ) ;
if ( V_25 )
return V_25 ;
...
V_16 -> V_19 = V_16 -> V_44 -> V_47 ;
V_16 -> V_27 = V_2 ;
V_10 -> V_40 . V_48 = & V_2 -> V_40 ;
V_10 -> V_49 = F_18 ( V_2 ) -> V_49 ;
V_10 -> V_50 = & V_51 ;
V_10 -> V_52 = V_53 ;
V_10 -> V_54 = V_16 -> V_44 -> V_54 ;
V_10 -> V_55 = V_56 ;
V_25 = F_1 ( V_2 , V_57 , 0 ,
! ! V_39 , 16 ) ;
if ( V_25 )
