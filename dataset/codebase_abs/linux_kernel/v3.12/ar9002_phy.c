...
static void F_36 ( struct V_1 * V_2 , bool V_176 )
{
...
V_181 = V_183 ;
V_178 -> V_184 &= ( ~ ( V_185 ) ) ;
F_7 ( V_2 , V_186 , V_178 -> V_184 ) ;
F_7 ( V_2 , V_187 , V_188 ) ;
F_37 ( V_2 , V_189 , 0 , 0xf0000000 ) ;
} else {
V_180 = V_190 ;
V_181 = V_191 ;
V_178 -> V_184 |= V_185 ;
...
V_163 &= ( ~ ( V_192 ) ) ;
V_163 &= ( ~ ( V_172 ) ) ;
V_163 |= F_18 ( V_180 , V_193 ) ;
V_163 |= F_18 ( V_181 , V_169 ) ;
V_163 |= F_18 ( ( V_181 >> 2 ) , V_166 ) ;
V_163 |= F_18 ( ( V_180 >> 1 ) , V_194 ) ;
V_163 |= F_18 ( ( V_180 >> 2 ) , V_195 ) ;
F_7 ( V_2 , V_164 , V_163 ) ;
V_163 = F_3 ( V_2 , V_196 ) ;
V_163 &= ( ~ V_197 ) ;
V_163 |= F_18 ( ( V_180 >> 3 ) , V_197 ) ;
F_7 ( V_2 , V_196 , V_163 ) ;
}
...
F_21 ( V_2 , V_204 , V_205 ) ;
F_21 ( V_2 , V_202 , V_203 ) ;
if ( V_199 -> V_206 )
F_21 ( V_2 , V_202 ,
V_207 ) ;
else
...
{
struct V_218 * V_219 = F_46 ( V_2 ) ;
struct V_220 * V_221 = F_47 ( V_2 ) ;
V_219 -> V_222 = NULL ;
V_219 -> V_223 = F_1 ;
V_219 -> V_224 = F_12 ;
V_219 -> V_225 = F_20 ;
