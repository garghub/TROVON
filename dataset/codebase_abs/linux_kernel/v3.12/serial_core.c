...
V_33 . V_34 = V_271 | V_44 | V_75 ;
for ( V_248 = 0 ; V_272 [ V_248 ] . V_273 ; V_248 ++ )
if ( V_272 [ V_248 ] . V_273 <= V_46 )
break;
V_33 . V_34 |= V_272 [ V_248 ] . V_32 ;
if ( V_47 == 7 )
V_33 . V_34 |= V_51 ;
else
V_33 . V_34 |= V_274 ;
...
if ( V_4 -> V_250 != V_250 ) {
if ( V_2 -> V_10 -> V_276 )
V_2 -> V_10 -> V_276 ( V_2 , V_250 , V_4 -> V_250 ) ;
V_4 -> V_250 = V_250 ;
}
}
static int F_123 ( struct V_277 * V_278 , void * V_279 )
{
...
F_57 ( & V_2 -> V_115 ) ;
V_286 = F_126 ( V_23 -> V_278 , & V_281 , F_123 ) ;
if ( F_127 ( V_286 ) ) {
if ( ! F_128 ( V_23 -> V_102 ) )
V_23 -> V_287 = 1 ;
F_129 ( V_286 ) ;
...
F_65 ( V_292 L_25
L_26 ,
V_23 -> V_278 ? F_131 ( V_23 -> V_278 ) : L_24 ,
V_23 -> V_278 ? L_27 : L_24 ,
V_236 -> F_131 ,
...
F_65 ( V_301 L_32 ,
V_2 -> V_278 ? F_131 ( V_2 -> V_278 ) : L_24 ,
V_2 -> V_278 ? L_27 : L_24 ,
V_236 -> F_131 ,
V_236 -> V_256 -> V_293 + V_2 -> line ,
V_295 , V_2 -> V_102 , V_2 -> V_71 / 16 , F_105 ( V_2 ) ) ;
}
static void
...
V_309 -> V_315 = V_316 ;
V_309 -> V_317 = V_318 ;
V_309 -> V_317 . V_34 = V_319 | V_274 | V_271 | V_44 | V_75 ;
...
{
struct V_235 * V_323 = V_264 -> V_279 ;
* V_88 = V_264 -> V_88 ;
return V_323 -> V_256 ;
}
static T_7 F_155 ( struct V_277 * V_278 ,
struct V_324 * V_325 , char * V_13 )
{
struct V_97 V_116 ;
struct V_24 * V_2 = F_156 ( V_278 ) ;
F_56 ( V_2 , & V_116 ) ;
...
static T_7 F_168 ( struct V_277 * V_278 ,
struct V_324 * V_325 , char * V_13 )
{
struct V_97 V_116 ;
struct V_24 * V_2 = F_156 ( V_278 ) ;
...
F_121 ( & V_23 -> V_9 ) ;
F_122 ( & V_23 -> V_9 , & V_270 ) ;
}
F_138 ( V_236 , V_4 , V_23 ) ;
V_286 = F_171 ( V_2 , V_236 -> V_256 ,
V_23 -> line , V_23 -> V_278 , V_2 , V_330 ) ;
