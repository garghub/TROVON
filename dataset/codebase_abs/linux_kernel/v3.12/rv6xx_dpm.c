...
struct V_286 * V_287 )
{
V_3 -> V_288 = F_209 ( V_287 -> V_289 ) ;
V_3 -> V_290 = F_210 ( V_287 -> V_291 ) ;
V_3 -> V_292 = F_210 ( V_287 -> V_293 ) ;
if ( F_211 ( V_3 -> V_290 , V_3 -> V_292 ) ) {
V_3 -> V_264 = V_294 ;
V_3 -> V_265 = V_295 ;
} else {
V_3 -> V_264 = 0 ;
...
V_98 = F_210 ( V_300 -> V_303 . V_304 ) ;
V_98 |= V_300 -> V_303 . V_305 << 16 ;
V_107 = F_210 ( V_300 -> V_303 . V_306 ) ;
V_107 |= V_300 -> V_303 . V_307 << 16 ;
V_302 -> V_107 = V_107 ;
V_302 -> V_98 = V_98 ;
V_302 -> V_111 = F_210 ( V_300 -> V_303 . V_308 ) ;
V_302 -> V_113 = F_209 ( V_300 -> V_303 . V_309 ) ;
if ( V_302 -> V_111 == 0xff01 ) {
if ( F_213 ( V_8 , 0 , 0 , & V_111 ) == 0 )
V_302 -> V_111 = V_111 ;
}
if ( V_302 -> V_113 & V_116 ) {
if ( ( V_8 -> V_310 == V_311 ) || ( V_8 -> V_310 == V_312 ) ) {
if ( V_302 -> V_111 < 1100 )
V_302 -> V_113 &= ~ V_116 ;
}
}
if ( V_3 -> V_290 & V_296 ) {
T_4 V_111 , V_313 , V_314 ;
F_214 ( V_8 , & V_111 , & V_313 , & V_314 ) ;
V_302 -> V_107 = V_8 -> clock . V_315 ;
V_302 -> V_98 = V_8 -> clock . V_316 ;
V_302 -> V_111 = V_111 ;
}
}
static int F_215 ( struct V_7 * V_8 )
{
struct V_317 * V_318 = & V_8 -> V_318 ;
struct V_286 * V_287 ;
union V_319 * V_320 ;
int V_14 , V_321 ;
union V_299 * V_300 ;
union V_322 * V_322 ;
int V_69 = F_216 ( V_323 , V_324 ) ;
T_4 V_325 ;
T_2 V_326 , V_327 ;
struct V_1 * V_4 ;
if ( ! F_217 ( V_318 -> V_328 , V_69 , NULL ,
& V_326 , & V_327 , & V_325 ) )
return - V_138 ;
V_322 = (union V_322 * ) ( V_318 -> V_328 -> V_329 + V_325 ) ;
V_8 -> V_10 . V_11 . V_4 = F_218 ( sizeof( struct V_2 ) *
V_322 -> V_330 . V_331 , V_332 ) ;
if ( ! V_8 -> V_10 . V_11 . V_4 )
return - V_333 ;
V_8 -> V_10 . V_11 . V_267 = F_209 ( V_322 -> V_330 . V_334 ) ;
V_8 -> V_10 . V_11 . V_194 = F_210 ( V_322 -> V_330 . V_335 ) ;
V_8 -> V_10 . V_11 . V_193 = F_210 ( V_322 -> V_330 . V_336 ) ;
for ( V_14 = 0 ; V_14 < V_322 -> V_330 . V_331 ; V_14 ++ ) {
V_320 = (union V_319 * )
( V_318 -> V_328 -> V_329 + V_325 +
F_210 ( V_322 -> V_330 . V_337 ) +
V_14 * V_322 -> V_330 . V_338 ) ;
V_287 = (struct V_286 * )
( V_318 -> V_328 -> V_329 + V_325 +
F_210 ( V_322 -> V_330 . V_339 ) +
( V_320 -> V_340 . V_341 *
V_322 -> V_330 . V_342 ) ) ;
if ( V_322 -> V_330 . V_338 - 1 ) {
T_2 * V_343 ;
V_4 = F_218 ( sizeof( struct V_1 ) , V_332 ) ;
if ( V_4 == NULL ) {
...
V_287 ) ;
V_343 = ( T_2 * ) & V_320 -> V_340 . V_344 [ 0 ] ;
for ( V_321 = 0 ; V_321 < ( V_322 -> V_330 . V_338 - 1 ) ; V_321 ++ ) {
V_300 = (union V_299 * )
( V_318 -> V_328 -> V_329 + V_325 +
F_210 ( V_322 -> V_330 . V_345 ) +
( V_343 [ V_321 ] * V_322 -> V_330 . V_346 ) ) ;
F_212 ( V_8 ,
& V_8 -> V_10 . V_11 . V_4 [ V_14 ] , V_321 ,
V_300 ) ;
}
}
}
V_8 -> V_10 . V_11 . V_347 = V_322 -> V_330 . V_331 ;
return 0 ;
}
...
struct V_6 * V_9 ;
int V_36 ;
V_9 = F_218 ( sizeof( struct V_6 ) , V_332 ) ;
if ( V_9 == NULL )
return - V_333 ;
...
V_8 -> V_10 . V_11 . V_193 = V_348 ;
if ( V_8 -> V_10 . V_11 . V_194 == 0 )
V_8 -> V_10 . V_11 . V_194 = V_349 ;
V_36 = F_18 ( V_8 , V_39 ,
0 , false , & V_38 ) ;
if ( V_36 )
...
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_301 * V_302 ;
F_223 ( V_3 -> V_290 , V_3 -> V_292 ) ;
F_224 ( V_3 -> V_288 ) ;
F_225 ( L_1 , V_3 -> V_264 , V_3 -> V_265 ) ;
V_302 = & V_4 -> V_61 ;
F_225 ( L_2 ,
V_302 -> V_98 , V_302 -> V_107 , V_302 -> V_111 ) ;
V_302 = & V_4 -> V_100 ;
F_225 ( L_3 ,
V_302 -> V_98 , V_302 -> V_107 , V_302 -> V_111 ) ;
V_302 = & V_4 -> V_62 ;
...
V_302 = & V_4 -> V_62 ;
F_228 ( V_354 , L_6 , V_3 -> V_264 , V_3 -> V_265 ) ;
F_228 ( V_354 , L_7 ,
V_355 , V_302 -> V_98 , V_302 -> V_107 , V_302 -> V_111 ) ;
}
}
void F_229 ( struct V_7 * V_8 )
{
int V_14 ;
for ( V_14 = 0 ; V_14 < V_8 -> V_10 . V_11 . V_347 ; V_14 ++ ) {
...
{
struct V_1 * V_359 = F_1 ( V_8 -> V_10 . V_11 . V_279 ) ;
if ( V_61 )
return V_359 -> V_61 . V_98 ;
else
return V_359 -> V_62 . V_98 ;
}
T_1 F_231 ( struct V_7 * V_8 , bool V_61 )
{
struct V_1 * V_359 = F_1 ( V_8 -> V_10 . V_11 . V_279 ) ;
if ( V_61 )
return V_359 -> V_61 . V_107 ;
else
return V_359 -> V_62 . V_107 ;
}
