...
+ F_30 ( & V_2 -> V_63 . V_60 ) +
! F_31 ( & V_2 -> V_64 . V_65 . V_66 ) ;
}
static inline struct V_1 * F_32 ( struct V_1 * V_2 )
{
int V_67 ;
V_67 = F_29 ( V_2 ) ;
log ( L_4 , V_67 , F_33 ( V_2 ) ) ;
while ( V_67 -- )
F_34 ( V_2 -> V_36 ) ;
F_16 ( V_2 -> V_13 ) ;
F_17 ( V_2 -> V_36 ) ;
...
static struct V_1 * F_35 ( struct V_31 * V_13 )
{
struct V_1 * V_2 ;
F_36 (pd, &pd_device_list, device_list) {
if ( V_2 -> V_58 == V_13 -> V_58 && F_37 ( V_2 ) )
return F_32 ( V_2 ) ;
}
return NULL ;
}
...
static int F_39 ( struct V_32 * V_57 , T_6 V_68 )
{
struct V_1 * V_2 = F_26 ( V_57 ) ;
if ( ! V_2 )
return 0 ;
if ( ! F_38 ( V_2 ) ) {
if ( F_33 ( V_2 ) <= 0 && ! F_37 ( V_2 ) ) {
V_2 -> V_68 . V_25 = V_69 ;
V_2 -> V_70 = NULL ;
F_40 ( V_71 L_6 ) ;
}
...
static int F_42 ( struct V_32 * V_57 )
{
struct V_1 * V_2 = F_26 ( V_57 ) ;
if ( ! V_2 )
return 0 ;
...
static inline struct V_1 * F_35 ( struct V_31 * V_13 )
{
return NULL ;
}
static inline void F_28 ( struct V_1 * V_2 , struct V_31 * V_13 )
...
static int F_45 ( struct V_31 * V_13 )
{
void * V_20 ;
int V_6 ;
struct V_77 * V_78 ;
V_20 = F_46 ( sizeof( * V_78 ) + sizeof( V_79 ) , V_50 ) ;
if ( ! V_20 )
return - V_51 ;
V_6 = F_3 ( V_13 ,
F_4 ( V_13 , 0 ) ,
...
static int F_47 ( struct V_32 * V_36 ,
const struct V_81 * V_82 )
{
struct V_31 * V_13 = F_48 ( V_36 ) ;
struct V_1 * V_2 = NULL ;
int V_6 = 0 ;
int V_83 = 0 ;
V_6 = F_45 ( V_13 ) ;
...
static void F_71 ( struct V_32 * V_36 )
{
