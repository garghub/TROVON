...
if ( V_32 )
goto V_174;
V_206 = F_68 ( V_64 -> V_67 -> V_65 , V_161 ,
V_9 ) ;
if ( F_31 ( V_206 ) ) {
F_5 ( L_78 ) ;
V_32 = V_180 ;
...
V_206 -> V_210 = V_211 ;
V_206 -> V_212 = V_109 ;
V_206 -> V_213 = F_65 ( V_116 -> V_118 ) ;
V_206 -> V_109 = & V_116 -> V_118 [ 0 ] ;
V_206 -> V_214 = & V_116 -> V_133 [ 0 ] ;
V_206 -> V_215 = 0 ;
...
V_206 -> V_216 = V_218 ;
V_206 -> V_219 = V_220 ;
F_69 ( V_64 -> V_67 -> V_65 , NULL , V_206 ,
( V_109 -> V_221 == V_222 ) ,
V_211 ) ;
return 0 ;
V_207:
...
{
struct V_1 * V_64 = F_1 ( V_3 ) ;
if ( V_64 -> V_89 && V_64 -> V_89 -> V_223 )
return V_64 -> V_89 -> V_223 -> V_224 ;
F_72 () ;
return 0 ;
}
static void V_211 ( struct V_205 * V_206 , int V_225 )
{
struct V_108 * V_109 = V_206 -> V_212 ;
struct V_115 * V_116 = V_109 -> V_117 ;
V_116 -> V_119 = V_206 -> V_226 ;
V_116 -> V_227 = V_206 -> V_228 ;
V_109 -> V_229 = F_43 ( V_116 -> V_119 ) << 1 ;
if ( V_109 -> V_229 ) {
F_6 ( L_79
