...
F_29 () ;
V_29 = F_30 ( sizeof( V_37 ) - 1 , * V_5 ) ;
V_29 = F_31 ( V_37 , V_29 , V_19 ) ;
if ( ! V_29 ) {
* V_5 = 0 ;
goto V_31;
}
...
int V_9 ;
F_37 ( V_41 , V_42 ) ;
V_9 = F_38 ( & V_43 , V_3 , V_4 , V_5 , V_6 ) ;
if ( V_3 && V_9 == 0 )
V_9 = F_39 ( V_41 ) ;
return V_9 ;
}
static T_5 int F_40 ( struct V_44 * V_44 )
{
struct V_1 * V_43 ;
V_44 -> V_45 . V_46 = V_47 ;
V_43 = V_48 ;
if ( ! F_41 ( V_44 , & V_49 ) ) {
V_43 = F_42 ( V_43 , sizeof( V_48 ) , V_30 ) ;
if ( V_43 == NULL )
goto V_50;
V_43 [ 0 ] . V_12 = & V_44 -> V_45 . V_46 ;
if ( V_44 -> V_51 != & V_52 ) {
V_43 [ 0 ] . V_53 = NULL ;
}
}
V_44 -> V_45 . V_54 = F_43 ( V_44 , L_1 , V_43 ) ;
if ( V_44 -> V_45 . V_54 == NULL )
goto V_55;
return 0 ;
V_55:
if ( V_43 != V_48 )
...
static T_6 void F_44 ( struct V_44 * V_44 )
{
struct V_1 * V_43 ;
V_43 = V_44 -> V_45 . V_54 -> V_56 ;
F_45 ( V_44 -> V_45 . V_54 ) ;
F_46 ( V_43 == V_48 ) ;
F_23 ( V_43 ) ;
}
