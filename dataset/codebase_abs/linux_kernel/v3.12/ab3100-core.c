...
int V_9 = 0 ;
int V_57 ;
for ( V_57 = 0 ; V_57 < F_40 ( V_78 ) ; V_57 ++ ) {
V_9 = F_3 ( V_3 ,
V_78 [ V_57 ] . V_79 ,
V_78 [ V_57 ] . V_80 ) ;
if ( V_9 )
...
static int F_42 ( struct V_11 * V_82 ,
...
int V_9 ;
int V_57 ;
V_3 = F_44 ( & V_82 -> V_2 , sizeof( struct V_3 ) , V_87 ) ;
if ( ! V_3 ) {
F_6 ( & V_82 -> V_2 , L_33 ) ;
return - V_68 ;
}
...
if ( V_9 )
goto V_97;
V_9 = F_50 ( & V_82 -> V_2 , & V_98 ) ;
if ( V_9 )
goto V_99;
for ( V_57 = 0 ; V_57 < F_40 ( V_100 ) ; V_57 ++ ) {
V_100 [ V_57 ] . V_101 = V_86 ;
V_100 [ V_57 ] . V_102 = sizeof( struct V_85 ) ;
}
V_9 = F_51 ( & V_82 -> V_2 , 0 , V_100 ,
F_40 ( V_100 ) , NULL , 0 , NULL ) ;
F_34 ( V_3 ) ;
return 0 ;
V_99:
V_97:
...
static int F_53 ( struct V_11 * V_82 )
{
struct V_3 * V_3 = F_54 ( V_82 ) ;
F_55 ( & V_82 -> V_2 ) ;
F_38 () ;
F_52 ( V_3 -> V_15 ) ;
return 0 ;
