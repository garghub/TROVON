...
if ( V_114 == V_120 ||
V_114 == V_121 ) {
int V_122 = V_114 == V_120 ?
- V_123 : - V_124 ;
F_51 (qtd, qtd_tmp, &qh->qtd_list,
qtd_list_entry) {
if ( V_65 -> V_70 ) {
for ( V_3 = 0 ; V_3 < V_65 -> V_70 -> V_80 ;
V_3 ++ ) {
V_69 = & V_65 -> V_70 -> V_71 [ V_3 ] ;
V_69 -> V_77 = V_122 ;
}
F_48 ( V_16 , V_65 , V_122 ) ;
}
F_49 ( V_16 , V_65 , V_10 ) ;
}
return;
...
V_24 V_23 , int * V_126 )
{
struct V_127 * V_70 = V_65 -> V_70 ;
T_1 V_107 = 0 ;
if ( V_38 -> V_93 )
V_107 = ( V_67 -> V_77 & V_96 ) >>
V_95 ;
...
if ( ! V_70 )
return - V_51 ;
V_67 = & V_10 -> V_18 [ V_134 ] ;
V_23 = V_10 -> V_23 [ V_134 ] ;
F_19 ( V_16 -> V_19 ,
L_24 ,
V_65 , V_70 , V_134 , V_67 , V_23 ) ;
V_135 = F_52 ( V_16 , V_38 , V_65 , V_67 ,
V_114 , V_23 ,
V_126 ) ;
if ( V_135 || ( * V_126 && V_70 -> V_77 != - V_136 ) ) {
F_48 ( V_16 , V_65 , V_70 -> V_77 ) ;
F_49 ( V_16 , V_65 , V_10 ) ;
F_19 ( V_16 -> V_19 , L_25 ,
V_135 , * V_126 , V_70 -> V_77 ) ;
return V_135 ;
}
if ( V_10 -> V_11 == V_97 ) {
switch ( V_65 -> V_98 ) {
...
F_19 ( V_16 -> V_19 ,
L_27 ) ;
} else if ( V_134 + 1 == V_65 -> V_82 ) {
F_54 ( V_16 , V_38 , V_133 ,
V_65 ) ;
}
break;
default:
...
int V_39 ;
V_65 = F_57 ( V_138 , struct V_64 , V_139 ) ;
V_126 = 0 ;
for ( V_39 = 0 ; V_39 < V_65 -> V_82 ; V_39 ++ ) {
if ( F_53 ( V_16 , V_38 , V_133 , V_65 ,
V_134 , V_114 ,
& V_126 ) )
break;
V_134 ++ ;
...
enum V_147 V_148 ;
if ( V_38 -> V_11 == V_12 ) {
F_50 ( V_16 , V_38 , V_114 ) ;
if ( V_114 != V_142 ||
F_26 ( & V_10 -> V_149 ) ) {
if ( V_114 == V_142 )
F_59 ( V_16 , V_38 , V_114 ) ;
F_24 ( V_16 , V_10 ) ;
F_60 ( V_16 , V_10 ) ;
} else {
F_61 ( & V_10 -> V_150 ,
