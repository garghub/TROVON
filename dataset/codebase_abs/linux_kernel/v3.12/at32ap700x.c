...
struct V_88 * T_2
F_90 ( unsigned int V_89 , struct V_235 * V_115 ,
unsigned int V_45 )
{
struct V_88 * V_90 ;
struct V_236 * V_237 ;
...
struct V_88 * T_2
F_91 ( unsigned int V_89 , struct V_248 * V_115 )
{
struct V_88 * V_90 ;
struct V_236 * V_249 ;
T_1 V_91 ;
...
goto V_241;
V_249 = & V_115 -> V_249 ;
V_249 -> V_157 = & V_80 . V_67 ;
V_249 -> V_158 = F_74 ( 2 ) ;
V_249 -> V_159 &= ~ ( V_160 | V_161 ) ;
V_249 -> V_244 = 0 ;
V_249 -> V_245 = 1 ;
if ( F_75 ( V_90 , V_115 ,
sizeof( struct V_248 ) ) )
...
void T_2 F_92 ( void )
{
T_1 V_253 = 0 , V_254 = 0 , V_255 = 0 , V_256 = 0 ;
int V_257 ;
if ( F_9 ( V_258 ) & F_7 ( V_71 ) ) {
V_44 = & V_70 ;
V_259 . V_9 = & V_70 ;
} else {
V_44 = & V_42 ;
...
F_39 ( & V_263 ) ;
F_39 ( & V_264 ) ;
#if F_93 ( V_265 ) || F_93 ( V_266 )
F_39 ( & V_186 ) ;
#endif
F_39 ( & V_252 ) ;
for ( V_257 = 0 ; V_257 < F_48 ( V_267 ) ; V_257 ++ ) {
struct V_1 * V_1 = V_267 [ V_257 ] ;
F_94 ( V_1 ) ;
if ( V_1 -> V_39 == 0 )
continue;
if ( V_1 -> V_135 == & F_20 )
...
if ( ! V_269 )
goto V_153;
if ( F_98 ( V_269 , 0x24000000 , 0x8000 , - 1 ) )
goto V_270;
V_271 = V_269 ;
return 0 ;
V_270:
