...
{
T_1 * V_116 = ( T_1 * ) & V_115 -> V_117 . V_118 ;
T_4 V_119 = F_3 ( V_115 -> V_120 ) , V_121 ;
int V_122 = true ;
struct V_123 * V_124 ;
struct V_125 * V_126 ;
struct V_58 * V_127 = NULL ;
struct V_79 * V_80 ;
F_8 ( V_34 -> V_15 -> V_23 , L_18 ,
V_119 ) ;
while ( ( V_119 >= sizeof( V_124 -> V_128 ) ) && V_122 ) {
V_124 = (struct V_123 * ) V_116 ;
V_121 = F_3 ( V_124 -> V_128 . V_129 ) ;
switch ( F_3 ( V_124 -> V_128 . type ) ) {
case V_130 :
V_126 =
(struct V_125 * )
V_124 ;
...
V_126 -> V_82 ,
V_126 -> V_81 ) ;
V_80 = & V_34 -> V_45 . V_80 [ V_126 ->
V_131 ] ;
V_80 -> V_81 = V_126 -> V_81 ;
V_80 -> V_82 =
V_126 -> V_82 ;
V_80 -> V_132 = V_126 -> V_132 ;
break;
case V_133 :
V_127 =
(struct V_58 * ) ( V_116 +
2 ) ;
V_127 -> V_67 . V_129 = ( T_1 ) V_121 ;
V_127 -> V_67 . V_134 =
V_133 ;
F_8 ( V_34 -> V_15 -> V_23 ,
L_19
...
V_116 += ( V_121 + sizeof( V_124 -> V_128 ) ) ;
V_119 -= ( V_121 + sizeof( V_124 -> V_128 ) ) ;
}
F_22 ( V_34 , V_127 ) ;
F_26 ( V_34 ) ;
return 0 ;
...
V_141 -> V_128 . type = F_58 ( ( T_3 ) V_147 [ 0 ] ) ;
V_141 -> V_128 . V_129 = F_58 ( ( T_3 ) V_147 [ 1 ] ) ;
memcpy ( V_141 -> V_59 , & V_147 [ 2 ] ,
F_3 ( V_141 -> V_128 . V_129 ) ) ;
if ( V_59 -> V_69 & V_148 )
memcpy ( ( T_1 * ) ( V_141 -> V_59
+ F_3 ( V_141 -> V_128 . V_129 )
- sizeof( V_34 -> V_149 ) ) ,
& V_34 -> V_149 , sizeof( V_34 -> V_149 ) ) ;
V_142 = sizeof( V_141 -> V_128 )
+ F_3 ( V_141 -> V_128 . V_129 ) ;
* V_137 += V_142 ;
}
return V_142 ;
