...
struct V_9 * V_10 = V_5 -> V_11 ;
#ifdef F_166
F_6 ( L_38 , V_71 [ 0 ] , V_71 [ 1 ] ) ;
#endif
if ( V_71 [ 0 ] ) {
if ( ( V_71 [ 0 ] & ( V_511 | V_512 ) )
&& V_10 -> V_513 )
return - V_42 ;
V_100 -> V_514 &= ~ V_71 [ 0 ] ;
V_100 -> V_514 |= ( V_71 [ 0 ] & V_71 [ 1 ] ) ;
V_10 -> V_515 &= ~ V_516 ;
V_10 -> V_515 |= F_167 ( V_100 -> V_514 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_515 ,
V_517 ) ;
}
...
#endif
V_10 -> V_515 &= ~ V_568 ;
V_10 -> V_515 |= F_176 ( V_565 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_515 , V_517 ) ;
...
static void F_179 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
int V_106 ;
for ( V_106 = 0 ; V_106 < V_100 -> V_257 ; V_106 ++ ) {
...
static unsigned F_180 ( enum V_576 V_6 )
{
unsigned V_577 ;
switch ( V_6 ) {
case V_578 :
...
static void F_189 ( struct V_605 * V_606 , unsigned V_72 ,
enum V_576 V_6 )
{
...
static unsigned F_190 ( struct V_605 * V_606 ,
enum V_576 V_6 )
{
struct V_4 * V_5 = V_606 -> V_52 -> V_5 ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
switch ( V_71 [ 0 ] ) {
case V_646 :
return F_194 ( V_5 , V_71 [ 1 ] ) ;
break;
case V_647 :
F_195 ( V_5 , & V_71 [ 1 ] , & V_71 [ 2 ] ) ;
return 3 ;
default:
break;
}
...
static int F_200 ( int V_43 , int V_649 , int V_71 , unsigned long V_650 )
{
...
struct V_246 * V_247 , unsigned int * V_71 )
{
V_71 [ 0 ] = F_202 ( V_5 , F_111 ( V_247 -> V_251 ) ) ;
return 1 ;
}
static int F_202 ( struct V_4 * V_5 , int V_74 )
{
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
int V_652 ;
int V_653 ;
...
static int F_204 ( struct V_4 * V_5 , unsigned int * V_71 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
...
struct V_246 * V_247 , unsigned int * V_71 )
{
F_210 ( V_5 , F_111 ( V_247 -> V_251 ) , V_71 [ 0 ] ) ;
return 1 ;
}
...
static void F_212 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
int V_106 , V_667 ;
...
F_210 ( V_5 , V_106 , V_100 -> V_673 [ V_106 ] / 2 ) ;
} else {
type = V_59 -> V_671 [ 0 ] ;
V_100 -> V_676 = ( 1 << V_666 [ type ] . V_669 ) - 1 ;
for ( V_172 = 0 ; V_172 < V_100 -> V_257 ; V_172 ++ )
F_210 ( V_5 , V_106 , V_100 -> V_676 / 2 ) ;
}
}
static void F_210 ( struct V_4 * V_5 , int V_74 , int V_677 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
V_72 = V_666 [ type ] . F_213 ( V_74 , V_677 , & V_653 ) ;
V_678 = F_214 ( V_106 ) ;
break;
}
...
static int F_215 ( int V_74 , int V_677 , int * V_653 )
{
V_74 ++ ;
* V_653 = ( ( V_74 & 0x1 ) << 11 ) |
( ( V_74 & 0x2 ) << 9 ) |
...
{
struct V_605 * V_606 = V_100 -> V_11 ;
return F_226 ( V_606 , V_247 , V_71 ) ;
}
static int F_227 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
int V_194 ;
struct V_605 * V_606 = V_100 -> V_11 ;
...
F_228 ( V_606 , NULL , NULL , NULL , NULL ) ;
F_30 ( V_5 , V_606 -> V_1 , 1 ) ;
V_194 = F_229 ( V_606 , V_100 -> V_103 ) ;
return V_194 ;
}
...
static int F_233 ( struct V_4 * V_5 , unsigned V_172 ,
unsigned V_680 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
unsigned V_681 ;
...
static int F_237 ( struct V_4 * V_5 , unsigned V_172 ,
unsigned V_680 )
{
if ( V_680 != F_238 ( V_5 , V_172 ) )
return - V_392 ;
return 2 ;
}
static int F_239 ( struct V_4 * V_5 , unsigned V_172 ,
unsigned V_680 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return F_233 ( V_5 , V_172 , V_680 ) ;
else
return F_237 ( V_5 , V_172 , V_680 ) ;
}
...
static unsigned F_238 ( struct V_4 * V_5 , unsigned V_172 )
{
switch ( V_172 ) {
case 0 :
return V_684 ;
...
static unsigned F_242 ( struct V_4 * V_5 , unsigned V_172 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return F_240 ( V_5 , V_172 ) ;
else
return F_238 ( V_5 , V_172 ) ;
}
static int F_243 ( struct V_4 * V_5 , unsigned V_694 ,
enum V_695 V_696 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
...
break;
case V_701 :
return F_239 ( V_5 , V_172 , V_71 [ 1 ] ) ;
break;
case V_702 :
V_71 [ 1 ] = F_242 ( V_5 , V_172 ) ;
break;
case V_703 :
return F_243 ( V_5 , V_172 , V_71 [ 1 ] ) ;
break;
default:
return - V_392 ;
}
...
static int F_252 ( unsigned V_719 ,
unsigned * V_720 ,
unsigned * V_721 ,
unsigned * V_722 )
{
...
static inline unsigned F_253 ( struct V_4 * V_5 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return 8 ;
...
static int F_249 ( struct V_4 * V_5 , unsigned V_680 ,
unsigned V_734 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( F_259 ( V_5 , V_172 , V_680 ) == 0 )
return - V_392 ;
if ( V_172 < 4 ) {
V_10 -> V_707 &= ~ F_261 ( V_172 ) ;
V_10 -> V_707 |=
F_250 ( V_172 , V_680 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_707 ,
V_712 ) ;
} else if ( V_172 < 8 ) {
V_10 -> V_713 &= ~ F_261 ( V_172 ) ;
V_10 -> V_713 |=
F_250 ( V_172 , V_680 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_713 ,
V_718 ) ;
...
static unsigned F_262 ( struct V_4 * V_5 , unsigned V_172 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( V_172 < 4 ) {
return F_263 ( V_172 ,
V_10 -> V_707 ) ;
} else if ( V_172 < F_253 ( V_5 ) ) {
return F_263 ( V_172 ,
V_10 -> V_713 ) ;
} else {
if ( V_172 == V_758 )
...
break;
case V_646 :
return F_249 ( V_5 , V_71 [ 1 ] , V_71 [ 2 ] ) ;
break;
case V_647 :
V_71 [ 1 ] = V_10 -> V_639 ;
V_71 [ 2 ] = V_10 -> V_310 ;
...
break;
case V_701 :
return F_260 ( V_5 , V_172 , V_71 [ 1 ] ) ;
break;
case V_702 :
V_71 [ 1 ] = F_262 ( V_5 , V_172 ) ;
return 2 ;
break;
default:
return - V_392 ;
...
if ( V_106 == V_105 ) {
F_6 ( L_62 , __FILE__ , V_25 ) ;
return - V_255 ;
}
return 0 ;
}
static void F_269 ( struct V_4 * V_5 , unsigned short V_78 )
{
...
static void F_270 ( struct V_4 * V_5 , unsigned int V_78 ,
unsigned int V_769 )
{
...
V_771 ) ;
V_769 &= V_772 ;
F_269 ( V_5 , V_773 | V_769 ) ;
if ( F_266 ( V_5 ) )
F_19 ( V_5 , L_64 ) ;
}
static unsigned int F_271 ( struct V_4 * V_5 ,
unsigned int V_769 )
{
unsigned int V_78 ;
V_769 &= V_772 ;
F_269 ( V_5 , V_773 | V_774 | V_769 ) ;
if ( F_266 ( V_5 ) )
F_19 ( V_5 , L_65 ) ;
V_78 = ( F_41 ( V_5 ,
V_770 ) << 16 ) &
...
static int F_272 ( struct V_4 * V_5 , unsigned short * V_71 )
{
int V_194 ;
unsigned short V_130 ;
F_269 ( V_5 , V_773 | V_775 ) ;
V_194 = F_266 ( V_5 ) ;
if ( V_194 ) {
F_19 ( V_5 ,
L_66 ) ;
...
V_783 | V_784 ;
#if 1
F_270 ( V_5 , V_278 | V_785 ,
V_786 ) ;
F_272 ( V_5 , NULL ) ;
#else
F_270 ( V_5 , 0x400000 , V_787 ) ;
F_270 ( V_5 , V_278 | V_788 ,
V_786 ) ;
if ( F_266 ( V_5 ) )
F_19 ( V_5 , L_69 ) ;
#endif
