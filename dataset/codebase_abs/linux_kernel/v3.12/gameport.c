...
static void F_67 ( struct V_61 * V_27 )
{
struct V_4 * V_4 = F_60 ( V_27 ) ;
F_40 ( V_4 ) ;
F_39 ( V_67 ) ;
}
void F_68 ( struct V_4 * V_4 , const char * V_68 , ... )
{
T_3 args ;
va_start ( args , V_68 ) ;
...
{
static T_4 V_69 = F_70 ( 0 ) ;
F_71 ( V_67 ) ;
F_72 ( & V_4 -> V_70 ) ;
F_73 ( & V_4 -> V_27 ) ;
F_74 ( & V_4 -> V_27 , L_9 ,
( unsigned long ) F_75 ( & V_69 ) - 1 ) ;
V_4 -> V_27 . V_71 = & V_66 ;
V_4 -> V_27 . V_72 = F_67 ;
if ( V_4 -> V_59 )
...
void F_87 ( struct V_4 * V_4 , struct V_49 * V_40 )
{
F_69 ( V_4 ) ;
F_48 ( V_4 , V_40 , V_47 ) ;
}
void F_88 ( struct V_4 * V_4 )
{
F_44 ( & V_46 ) ;
F_63 ( V_4 ) ;
F_82 ( V_4 ) ;
...
static T_1 F_89 ( struct V_65 * V_26 , char * V_64 )
{
struct V_25 * V_28 = F_66 ( V_26 ) ;
return sprintf ( V_64 , L_5 , V_28 -> V_33 ? V_28 -> V_33 : L_13 ) ;
}
static int F_90 ( struct V_61 * V_27 )
{
struct V_4 * V_4 = F_60 ( V_27 ) ;
...
{
int error ;
error = F_92 ( & V_26 -> V_28 ) ;
if ( error )
F_51 ( L_14 ,
V_26 -> V_28 . V_32 , error ) ;
}
int F_93 ( struct V_25 * V_26 , struct V_49 * V_40 ,
const char * V_80 )
{
int error ;
V_26 -> V_28 . V_71 = & V_66 ;
...
static int F_97 ( struct V_61 * V_27 , struct V_65 * V_26 )
{
struct V_25 * V_83 = F_66 ( V_26 ) ;
return ! V_83 -> V_81 ;
}
static void F_98 ( struct V_4 * V_4 , struct V_25 * V_26 )
{
F_44 ( & V_4 -> V_70 ) ;
V_4 -> V_26 = V_26 ;
F_47 ( & V_4 -> V_70 ) ;
