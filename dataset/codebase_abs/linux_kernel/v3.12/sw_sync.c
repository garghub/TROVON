...
static long F_18 ( struct V_5 * V_6 ,
unsigned long V_28 )
{
int V_29 = F_19 ( V_30 ) ;
int V_31 ;
...
if ( V_29 < 0 )
return V_29 ;
if ( F_20 ( & V_13 , ( void V_35 * ) V_28 , sizeof( V_13 ) ) ) {
V_31 = - V_36 ;
goto V_31;
}
...
V_13 . V_33 = V_29 ;
if ( F_23 ( ( void V_35 * ) V_28 , & V_13 , sizeof( V_13 ) ) ) {
F_24 ( V_33 ) ;
V_31 = - V_36 ;
goto V_31;
}
...
{
T_1 V_7 ;
if ( F_20 ( & V_7 , ( void V_35 * ) V_28 , sizeof( V_7 ) ) )
return - V_36 ;
F_12 ( V_6 , V_7 ) ;
return 0 ;
}
static long F_28 ( struct V_23 * V_23 , unsigned int V_37 ,
unsigned long V_28 )
{
struct V_5 * V_6 = V_23 -> V_27 ;
switch ( V_37 ) {
