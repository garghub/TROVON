...
{
struct V_471 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_15 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_12 ( V_2 ) ;
V_15 = F_68 ( V_2 , V_185 , & V_300 -> V_130 ) ;
...
goto V_183;
if ( F_24 ( V_429 , & V_2 -> V_11 ) ||
( V_15 -> V_463 & ~ 0x01 ) == V_469 ) {
struct V_472 V_182 ;
F_52 ( & V_182 . V_130 , & V_300 -> V_130 ) ;
V_182 . V_473 = ( V_15 -> V_468 == 0x04 ) ?
V_474 : V_15 -> V_468 ;
V_15 -> V_242 = F_200 ( V_15 ) ;
V_182 . V_475 = V_15 -> V_242 ;
if ( F_202 ( V_2 , & V_15 -> V_282 ) &&
( V_15 -> V_229 || F_24 ( V_476 , & V_15 -> V_9 ) ) )
V_182 . V_477 = 0x01 ;
else
V_182 . V_477 = 0x00 ;
F_108 ( V_2 , V_478 ,
...
{
struct V_482 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_15 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_12 ( V_2 ) ;
V_15 = F_68 ( V_2 , V_185 , & V_300 -> V_130 ) ;
if ( ! V_15 )
goto V_183;
V_15 -> V_466 = V_300 -> V_473 ;
V_15 -> V_463 = V_300 -> V_475 ;
if ( V_300 -> V_477 )
F_8 ( V_476 , & V_15 -> V_9 ) ;
V_183:
F_15 ( V_2 ) ;
...
struct V_3 * V_4 )
{
struct V_483 * V_300 = ( void * ) V_4 -> V_6 ;
int V_484 , V_485 , V_486 = 0 ;
struct V_14 * V_15 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_12 ( V_2 ) ;
if ( ! F_24 ( V_39 , & V_2 -> V_11 ) )
...
if ( ! V_15 )
goto V_183;
V_484 = ( V_15 -> V_242 & 0x01 ) ;
V_485 = ( V_15 -> V_463 & 0x01 ) ;
if ( ! V_15 -> V_487 && V_484 &&
V_15 -> V_466 == V_467 ) {
F_2 ( L_34 ) ;
F_108 ( V_2 , V_387 ,
...
if ( ( ! V_484 || V_15 -> V_466 == V_467 ) &&
( ! V_485 || V_15 -> V_468 == V_467 ) ) {
...
V_2 -> V_489 ) ;
if ( V_2 -> V_489 > 0 ) {
int V_490 = F_34 ( V_2 -> V_489 ) ;
F_205 ( & V_15 -> V_491 , V_449 + V_490 ) ;
goto V_183;
}
F_108 ( V_2 , V_386 ,
sizeof( V_300 -> V_130 ) , & V_300 -> V_130 ) ;
...
V_488:
F_206 ( V_2 , & V_300 -> V_130 , V_185 , 0 , V_300 -> V_492 ,
V_486 ) ;
V_183:
F_15 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_493 * V_300 = ( void * ) V_4 -> V_6 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
if ( F_24 ( V_39 , & V_2 -> V_11 ) )
...
struct V_3 * V_4 )
{
struct V_494 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_15 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
V_15 = F_68 ( V_2 , V_185 , & V_300 -> V_130 ) ;
if ( ! V_15 )
return;
V_15 -> V_495 = F_59 ( V_300 -> V_492 ) ;
V_15 -> V_496 = 0 ;
if ( F_24 ( V_39 , & V_2 -> V_11 ) )
F_210 ( V_2 , & V_15 -> V_282 , V_15 -> type ,
V_15 -> V_283 , V_15 -> V_495 ,
V_15 -> V_496 ) ;
}
static void F_211 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_497 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_15 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
V_15 = F_68 ( V_2 , V_185 , & V_300 -> V_130 ) ;
if ( ! V_15 )
...
struct V_3 * V_4 )
{
struct V_503 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_15 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_12 ( V_2 ) ;
V_15 = F_68 ( V_2 , V_185 , & V_300 -> V_130 ) ;
...
struct V_3 * V_4 )
{
struct V_504 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_244 * V_316 ;
struct V_14 * V_15 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_12 ( V_2 ) ;
...
F_108 ( V_2 , V_507 , sizeof( V_182 ) ,
& V_182 ) ;
} else {
struct V_508 V_182 ;
F_52 ( & V_182 . V_130 , & V_300 -> V_130 ) ;
F_108 ( V_2 , V_509 , sizeof( V_182 ) ,
& V_182 ) ;
}
V_183:
F_15 ( V_2 ) ;
...
struct V_3 * V_4 )
{
struct V_510 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_287 , * V_511 ;
...
V_511 = V_287 -> V_512 -> V_513 -> V_287 ;
V_287 -> V_31 = V_307 ;
F_52 ( & V_287 -> V_282 , & V_511 -> V_282 ) ;
F_139 ( V_287 ) ;
V_287 -> V_304 = V_306 ;
F_103 ( V_287 ) ;
F_141 ( V_287 ) ;
...
{
struct V_514 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_287 ;
struct V_414 * V_515 ;
struct V_512 * V_516 ;
F_2 ( L_38 ,
...
if ( ! V_515 )
return;
V_515 -> V_16 = F_218 ( V_300 -> V_16 ) ;
F_2 ( L_39 , V_287 , V_287 -> V_512 , V_515 ) ;
V_516 = V_287 -> V_512 ;
if ( V_516 && V_516 -> V_517 ) {
struct V_518 * V_517 = V_516 -> V_517 ;
F_220 ( V_517 ) ;
V_517 -> V_15 -> V_519 = V_2 -> V_143 ;
F_221 ( V_517 , V_515 , 0 ) ;
F_139 ( V_287 ) ;
F_222 ( V_517 ) ;
}
...
struct V_3 * V_4 )
{
struct V_520 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_414 * V_515 ;
F_2 ( L_40 , V_2 -> V_7 ,
...
return;
F_12 ( V_2 ) ;
V_515 = F_181 ( V_2 , F_218 ( V_300 -> V_16 ) ) ;
if ( ! V_515 )
goto V_183;
F_224 ( V_515 , V_300 -> V_328 ) ;
V_183:
F_15 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_521 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_287 ;
F_2 ( L_1 , V_2 -> V_7 , V_300 -> V_5 ) ;
if ( V_300 -> V_5 )
return;
...
{
struct V_522 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_15 ;
F_2 ( L_1 , V_2 -> V_7 , V_300 -> V_5 ) ;
F_12 ( V_2 ) ;
V_15 = F_129 ( V_2 , V_284 , V_225 ) ;
...
{
T_3 V_526 = V_4 -> V_6 [ 0 ] ;
void * V_527 = & V_4 -> V_6 [ 1 ] ;
T_6 V_265 ;
while ( V_526 -- ) {
struct V_528 * V_300 = V_527 ;
V_265 = V_300 -> V_6 [ V_300 -> V_529 ] ;
F_137 ( V_2 , & V_300 -> V_130 , V_284 , V_300 -> V_523 ,
NULL , V_265 , 0 , 1 , V_300 -> V_6 , V_300 -> V_529 ) ;
V_527 += sizeof( * V_300 ) + V_300 -> V_529 + 1 ;
}
}
static void F_228 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_530 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_531 V_182 ;
struct V_532 V_533 ;
struct V_14 * V_15 ;
struct V_534 * V_535 ;
...
if ( V_15 == NULL )
goto V_435;
V_535 = F_229 ( V_2 , V_300 -> V_536 , V_300 -> V_537 ) ;
if ( V_535 == NULL )
goto V_435;
memcpy ( V_182 . V_535 , V_535 -> V_441 , sizeof( V_535 -> V_441 ) ) ;
V_182 . V_16 = F_142 ( V_15 -> V_16 ) ;
if ( V_535 -> V_538 )
V_15 -> V_240 = V_243 ;
else
V_15 -> V_240 = V_539 ;
V_15 -> V_540 = V_535 -> V_541 ;
F_108 ( V_2 , V_542 , sizeof( V_182 ) , & V_182 ) ;
if ( V_535 -> type & V_543 ) {
F_115 ( & V_535 -> V_263 ) ;
F_230 ( V_535 ) ;
}
...
return;
V_435:
V_533 . V_16 = V_300 -> V_16 ;
F_108 ( V_2 , V_544 , sizeof( V_533 ) , & V_533 ) ;
F_15 ( V_2 ) ;
}
static void F_231 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_545 * V_546 = ( void * ) V_4 -> V_6 ;
F_169 ( V_4 , sizeof( * V_546 ) ) ;
switch ( V_546 -> V_547 ) {
case V_548 :
F_226 ( V_2 , V_4 ) ;
break;
...
{
struct V_551 * V_300 = ( void * ) V_4 -> V_6 ;
struct V_14 * V_287 ;
...
{
struct V_552 * V_553 = ( void * ) V_4 -> V_6 ;
T_1 V_403 = V_553 -> V_554 ;
F_12 ( V_2 ) ;
if ( V_2 -> V_555 == V_556 ) {
F_235 ( V_2 -> V_557 ) ;
V_2 -> V_557 = F_236 ( V_4 , V_558 ) ;
}
F_15 ( V_2 ) ;
F_169 ( V_4 , V_559 ) ;
if ( V_2 -> V_402 && F_176 ( V_2 -> V_402 ) -> V_204 . V_403 == V_403 ) {
struct V_560 * V_553 = ( void * ) V_2 -> V_402 -> V_6 ;
T_7 V_356 = F_14 ( V_553 -> V_356 ) ;
F_171 ( V_2 , V_356 , 0 ) ;
}
switch ( V_403 ) {
case V_561 :
