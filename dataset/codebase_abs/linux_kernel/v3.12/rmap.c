...
static int F_106 ( struct V_38 * V_38 , struct V_10 * V_11 ,
unsigned long V_51 )
{
struct V_15 * V_16 = V_11 -> V_17 ;
T_7 * V_64 ;
...
if ( ! V_64 )
goto V_43;
if ( F_107 ( * V_64 ) || F_108 ( * V_64 ) ) {
T_7 V_79 ;
F_109 ( V_11 , V_51 , F_81 ( * V_64 ) ) ;
V_79 = F_110 ( V_11 , V_51 , V_64 ) ;
V_79 = F_111 ( V_79 ) ;
V_79 = F_112 ( V_79 ) ;
F_113 ( V_16 , V_51 , V_64 , V_79 ) ;
V_78 = 1 ;
}
F_82 ( V_64 , V_65 ) ;
if ( V_78 )
...
static int F_115 ( struct V_74 * V_40 , struct V_38 * V_38 )
{
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
struct V_10 * V_11 ;
int V_78 = 0 ;
...
if ( V_11 -> V_55 & V_80 ) {
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
V_78 += F_106 ( V_38 , V_11 , V_51 ) ;
}
}
F_99 ( & V_40 -> V_75 ) ;
return V_78 ;
}
int F_116 ( struct V_38 * V_38 )
{
int V_78 = 0 ;
F_95 ( ! F_96 ( V_38 ) ) ;
if ( F_46 ( V_38 ) ) {
struct V_74 * V_40 = F_117 ( V_38 ) ;
if ( V_40 )
V_78 = F_115 ( V_40 , V_38 ) ;
}
return V_78 ;
}
void F_118 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 )
{
struct V_1 * V_1 = V_11 -> V_1 ;
F_5 ( ! F_96 ( V_38 ) ) ;
F_5 ( ! V_1 ) ;
F_5 ( V_38 -> V_46 != F_119 ( V_11 , V_51 ) ) ;
V_1 = ( void * ) V_1 + V_42 ;
V_38 -> V_40 = (struct V_74 * ) V_1 ;
}
static void F_120 ( struct V_38 * V_38 ,
...
F_95 ( V_38 -> V_46 != F_119 ( V_11 , V_51 ) ) ;
#endif
}
void F_123 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 )
{
F_124 ( V_38 , V_11 , V_51 , 0 ) ;
}
void F_124 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 , int V_81 )
{
int V_82 = F_125 ( & V_38 -> V_83 ) ;
if ( V_82 ) {
if ( F_86 ( V_38 ) )
F_126 ( V_38 ,
V_84 ) ;
F_127 ( F_128 ( V_38 ) , V_85 ,
F_129 ( V_38 ) ) ;
}
if ( F_18 ( F_102 ( V_38 ) ) )
return;
F_5 ( ! F_96 ( V_38 ) ) ;
if ( V_82 )
F_120 ( V_38 , V_11 , V_51 , V_81 ) ;
else
F_121 ( V_38 , V_11 , V_51 ) ;
}
...
F_139 ( V_38 , & V_86 , & V_87 ) ;
}
void F_140 ( struct V_38 * V_38 )
{
bool V_90 = F_63 ( V_38 ) ;
bool V_86 ;
unsigned long V_87 ;
...
int F_147 ( struct V_38 * V_38 , struct V_10 * V_11 ,
...
F_109 ( V_11 , V_51 , F_80 ( V_38 ) ) ;
V_92 = F_110 ( V_11 , V_51 , V_64 ) ;
if ( F_107 ( V_92 ) )
F_149 ( V_38 ) ;
F_150 ( V_16 ) ;
if ( F_151 ( V_38 ) && ! ( V_87 & V_100 ) ) {
if ( ! F_73 ( V_38 ) ) {
if ( F_63 ( V_38 ) )
F_152 ( V_16 , V_101 ) ;
else
...
F_113 ( V_16 , V_51 , V_64 ,
F_153 ( F_154 ( V_38 ) ) ) ;
} else if ( F_63 ( V_38 ) ) {
T_9 V_79 = { . V_103 = F_155 (page) } ;
T_7 V_104 ;
if ( F_156 ( V_38 ) ) {
if ( F_157 ( V_79 ) < 0 ) {
F_113 ( V_16 , V_51 , V_64 , V_92 ) ;
V_78 = V_99 ;
goto V_97;
}
if ( F_158 ( & V_16 -> V_105 ) ) {
...
F_95 ( F_148 ( V_87 ) != V_110 ) ;
V_79 = F_161 ( V_38 , F_108 ( V_92 ) ) ;
}
V_104 = F_153 ( V_79 ) ;
if ( F_162 ( V_92 ) )
V_104 = F_163 ( V_104 ) ;
F_113 ( V_16 , V_51 , V_64 , V_104 ) ;
F_95 ( F_164 ( * V_64 ) ) ;
} else if ( F_160 ( V_109 ) &&
( F_148 ( V_87 ) == V_110 ) ) {
T_9 V_79 ;
V_79 = F_161 ( V_38 , F_108 ( V_92 ) ) ;
F_113 ( V_16 , V_51 , V_64 , F_153 ( V_79 ) ) ;
} else
F_152 ( V_16 , V_102 ) ;
F_140 ( V_38 ) ;
F_165 ( V_38 ) ;
...
static int F_167 ( unsigned long V_113 , unsigned int * V_67 ,
...
V_115 = V_51 ;
V_116 = V_117 ;
F_168 ( V_16 , V_115 , V_116 ) ;
if ( F_50 ( & V_11 -> V_17 -> V_111 ) ) {
V_118 = ( V_11 -> V_55 & V_70 ) ;
if ( ! V_118 )
F_51 ( & V_11 -> V_17 -> V_111 ) ;
}
V_64 = F_169 ( V_16 , V_61 , V_51 , & V_65 ) ;
F_150 ( V_16 ) ;
for (; V_51 < V_117 ; V_64 ++ , V_51 += V_121 ) {
if ( ! F_77 ( * V_64 ) )
continue;
V_38 = F_170 ( V_11 , V_51 , * V_64 ) ;
F_95 ( ! V_38 || F_63 ( V_38 ) ) ;
if ( V_118 ) {
F_166 ( V_38 ) ;
if ( V_38 == V_114 )
...
F_109 ( V_11 , V_51 , F_81 ( * V_64 ) ) ;
V_92 = F_110 ( V_11 , V_51 , V_64 ) ;
if ( V_38 -> V_46 != F_119 ( V_11 , V_51 ) ) {
T_7 V_122 = F_171 ( V_38 -> V_46 ) ;
if ( F_162 ( V_92 ) )
F_172 ( V_122 ) ;
F_113 ( V_16 , V_51 , V_64 , V_122 ) ;
}
if ( F_107 ( V_92 ) )
F_149 ( V_38 ) ;
F_140 ( V_38 ) ;
...
static int F_175 ( struct V_38 * V_38 , enum V_91 V_87 )
{
struct V_1 * V_1 ;
T_3 V_45 ;
struct V_7 * V_12 ;
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 ;
if ( F_160 ( V_109 ) && ( V_87 & V_110 ) &&
F_174 ( V_11 ) )
continue;
V_51 = F_61 ( V_38 , V_11 ) ;
V_78 = F_147 ( V_38 , V_11 , V_51 , V_87 ) ;
...
static int F_176 ( struct V_38 * V_38 , enum V_91 V_87 )
{
struct V_74 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
struct V_10 * V_11 ;
...
if ( F_148 ( V_87 ) == V_96 )
goto V_43;
F_178 (vma, &mapping->i_mmap_nonlinear,
shared.nonlinear) {
...
F_178 (vma, &mapping->i_mmap_nonlinear, shared.nonlinear)
V_11 -> V_130 = NULL ;
V_43:
F_99 ( & V_40 -> V_75 ) ;
return V_78 ;
}
int F_180 ( struct V_38 * V_38 , enum V_91 V_87 )
{
int V_78 ;
F_95 ( ! F_96 ( V_38 ) ) ;
F_5 ( ! F_73 ( V_38 ) && F_86 ( V_38 ) ) ;
if ( F_18 ( F_102 ( V_38 ) ) )
V_78 = F_181 ( V_38 , V_87 ) ;
else if ( F_63 ( V_38 ) )
V_78 = F_175 ( V_38 , V_87 ) ;
else
V_78 = F_176 ( V_38 , V_87 ) ;
if ( V_78 != V_112 && ! F_46 ( V_38 ) )
V_78 = V_131 ;
return V_78 ;
}
int F_182 ( struct V_38 * V_38 )
{
F_5 ( ! F_96 ( V_38 ) || F_183 ( V_38 ) ) ;
if ( F_18 ( F_102 ( V_38 ) ) )
return F_181 ( V_38 , V_96 ) ;
else if ( F_63 ( V_38 ) )
return F_175 ( V_38 , V_96 ) ;
else
return F_176 ( V_38 , V_96 ) ;
}
...
static int F_184 ( struct V_38 * V_38 , int (* F_185)( struct V_38 * ,
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
V_78 = F_185 ( V_38 , V_11 , V_51 , V_132 ) ;
if ( V_78 != V_93 )
break;
}
F_54 ( V_1 ) ;
...
static int F_186 ( struct V_38 * V_38 , int (* F_185)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_132 )
{
struct V_74 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
...
int F_187 ( struct V_38 * V_38 , int (* F_185)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_132 )
{
F_5 ( ! F_96 ( V_38 ) ) ;
if ( F_18 ( F_102 ( V_38 ) ) )
return F_188 ( V_38 , F_185 , V_132 ) ;
else if ( F_63 ( V_38 ) )
return F_184 ( V_38 , F_185 , V_132 ) ;
else
return F_186 ( V_38 , F_185 , V_132 ) ;
}
