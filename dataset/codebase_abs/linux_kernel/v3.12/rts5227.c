...
static int F_24 ( struct V_1 * V_2 , int V_38 )
{
int V_39 ;
F_15 ( V_2 ) ;
F_2 ( V_2 , V_11 , V_40 ,
...
int V_39 ;
if ( V_3 == V_8 ) {
V_39 = F_19 ( V_2 , 0x08 , 0x4FC0 | 0x24 ) ;
if ( V_39 < 0 )
return V_39 ;
} else if ( V_3 == V_49 ) {
V_39 = F_19 ( V_2 , 0x11 , 0x3C02 ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_19 ( V_2 , 0x08 , 0x4C80 | 0x24 ) ;
if ( V_39 < 0 )
return V_39 ;
} else {
return - V_50 ;
...
V_2 -> V_9 = V_58 ;
V_2 -> V_19 = V_59 ;
V_2 -> V_60 = F_29 ( 27 , 27 , 15 ) ;
V_2 -> V_61 = F_29 ( 30 , 7 , 7 ) ;
V_2 -> V_62 = V_63 ;
V_2 -> V_64 = V_65 ;
V_2 -> V_66 = V_67 ;
V_2 -> V_68 = V_69 ;
