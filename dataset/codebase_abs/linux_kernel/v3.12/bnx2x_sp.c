...
F_117 ( V_205 , & V_158 . V_25 ) ;
F_117 ( V_204 , & V_158 . V_25 ) ;
F_117 ( V_184 , & V_158 . V_25 ) ;
F_4 ( V_17 , L_56 ) ;
V_60 = F_57 ( V_2 , V_4 ) ;
if ( V_60 != 0 )
return V_60 ;
...
static inline void F_118 ( struct V_32 * V_38 , T_6 V_96 ,
...
static inline void F_119 ( struct V_39 * V_4 ,
...
V_4 -> V_210 = F_106 ;
V_4 -> V_211 = F_104 ;
F_118 ( & V_4 -> V_38 , V_96 , V_101 , V_97 , V_110 , V_200 ,
V_33 , V_34 , type ) ;
}
...
F_119 ( V_212 , V_96 , V_101 , V_97 , V_110 ,
...
F_119 ( V_218 , V_96 , V_101 , V_97 , V_110 ,
...
union V_6 * V_213 =
(union V_6 * ) V_160 ;
F_119 ( V_160 , V_96 , V_101 , V_97 , V_110 ,
V_200 , V_33 , V_34 , type ,
V_43 , V_46 ) ;
V_160 -> V_170 = F_45 ;
V_160 -> V_172 = F_50 ;
...
T_7 V_221 = V_222 +
F_128 ( V_138 ) ;
F_129 ( V_2 , V_221 , V_55 , ( T_7 * ) V_220 ) ;
}
...
V_220 -> V_242 ) ;
F_127 ( V_2 , V_220 , V_158 -> V_97 ) ;
F_29 ( V_158 -> V_33 , V_158 -> V_34 ) ;
F_30 () ;
return 0 ;
}
static inline void F_131 ( T_7 V_101 ,
struct V_102 * V_94 ,
T_6 V_103 )
{
...
V_64 -> V_115 [ V_107 ] . V_98 =
V_259 ;
F_132 ( V_2 , & V_158 -> V_232 ,
& ( V_64 -> V_115 [ V_107 ++ ] ) ,
false ) ;
}
if ( F_18 ( V_260 , & V_158 -> V_261 ) ) {
if ( F_18 ( V_255 , & V_158 -> V_25 ) ) {
V_64 -> V_115 [ V_107 ] . V_95 = F_134 ( V_2 , V_96 ) ;
V_64 -> V_115 [ V_107 ] . V_97 = V_158 -> V_97 ;
V_64 -> V_115 [ V_107 ] . V_98 =
V_256 ;
F_132 ( V_2 , & V_158 -> V_257 ,
...
F_131 ( V_158 -> V_101 , & V_64 -> V_124 , V_107 ) ;
F_4 ( V_17 , L_63 ,
...
static inline T_6 F_139 ( T_6 * V_65 )
{
return ( F_140 ( 0 , V_65 , V_62 ) >> 24 ) & 0xff ;
}
...
static inline int F_143 ( struct V_266 * V_4 , int V_287 )
{
...
static inline int F_145 ( struct V_266 * V_4 )
{
int V_296 = F_143 ( V_4 , 0 ) ;
if ( V_296 >= 0 )
F_146 ( V_4 -> V_293 . V_294 . V_295 , V_296 ) ;
return V_296 ;
}
static inline T_6 F_147 ( struct V_266 * V_4 )
{
struct V_32 * V_38 = & V_4 -> V_38 ;
T_6 V_75 = 0 ;
if ( ( V_38 -> V_76 == V_77 ) ||
...
switch ( V_111 ) {
case V_277 :
V_303 = F_139 ( V_300 -> V_65 ) ;
F_149 ( V_4 -> V_293 . V_294 . V_295 , V_303 ) ;
break;
case V_281 :
V_303 = F_145 ( V_4 ) ;
break;
...
static inline int F_157 ( struct V_1 * V_2 ,
struct V_268 * V_158 ,
enum V_269 V_111 ,
int V_319 )
{
...
int V_20 = 0 , V_22 ;
memset ( V_64 , 0 , sizeof( * V_64 ) ) ;
V_20 = F_154 ( V_2 , V_158 ) ;
if ( F_14 ( & V_4 -> V_285 ) )
V_4 -> V_328 ( V_4 ) ;
if ( V_158 -> V_278 > 0 )
V_20 = F_157 ( V_2 , V_158 , V_111 , V_20 ) ;
V_4 -> V_324 -= V_20 ;
F_19 ( V_4 -> V_324 < 0 ) ;
F_19 ( V_20 > V_4 -> V_310 ) ;
F_160 ( V_2 , V_158 , ( T_6 ) V_20 ) ;
if ( ! V_4 -> V_324 )
F_161 ( V_2 , V_4 ) ;
...
int V_331 ;
F_9 (mlist_pos, &p->mcast_list, link) {
V_331 = F_139 ( V_318 -> V_65 ) ;
F_166 ( V_330 , V_331 ) ;
F_4 ( V_17 , L_74 ,
V_318 -> V_65 , V_331 ) ;
F_149 ( V_4 -> V_293 . V_294 . V_295 ,
V_331 ) ;
}
}
...
{
int V_331 ;
for ( V_331 = F_143 ( V_4 , 0 ) ;
V_331 >= 0 ;
V_331 = F_143 ( V_4 , V_331 + 1 ) ) {
F_166 ( V_330 , V_331 ) ;
F_4 ( V_17 , L_75 , V_331 ) ;
}
}
...
F_76 ( V_2 , F_169 ( V_2 , V_288 ) , V_330 [ V_288 ] ) ;
} else
memset ( V_4 -> V_293 . V_294 . V_295 , 0 ,
sizeof( V_4 -> V_293 . V_294 . V_295 ) ) ;
V_131 -> V_182 ( V_131 ) ;
...
static inline void F_177 ( T_13 * V_337 , T_13 * V_338 ,
T_13 * V_339 , T_6 * V_65 )
{
V_65 [ 1 ] = ( ( T_6 * ) V_337 ) [ 0 ] ;
V_65 [ 0 ] = ( ( T_6 * ) V_337 ) [ 1 ] ;
...
static inline int F_178 ( struct V_1 * V_2 ,
struct V_266 * V_4 )
{
struct V_32 * V_38 = & V_4 -> V_38 ;
struct V_273 * V_19 ;
struct V_147 * V_64 =
(struct V_147 * ) ( V_38 -> V_110 ) ;
if ( F_179 ( V_64 -> V_149 [ 0 ] . V_139 ,
V_140 ) ) {
int V_288 , V_326 = V_64 -> V_94 . V_132 ;
if ( ! F_14 ( & V_4 -> V_293 . V_340 . V_341 ) )
return 0 ;
V_19 = F_180 ( V_326 , sizeof( * V_19 ) , V_31 ) ;
if ( ! V_19 ) {
F_38 ( L_80 ) ;
return - V_188 ;
}
...
V_140 ,
V_146 ) ;
V_20 = F_176 ( V_2 , V_158 ) ;
if ( F_14 ( & V_4 -> V_285 ) )
V_4 -> V_328 ( V_4 ) ;
if ( ! V_20 )
V_20 = F_157 ( V_2 , V_158 , V_111 , 0 ) ;
V_4 -> V_324 -= V_4 -> V_310 ;
F_19 ( V_20 > V_4 -> V_310 ) ;
F_173 ( V_2 , V_158 , ( T_6 ) V_20 ) ;
V_22 = F_178 ( V_2 , V_4 ) ;
if ( V_22 )
return V_22 ;
if ( F_18 ( V_28 , & V_158 -> V_25 ) ) {
...
static int F_182 ( struct V_266 * V_4 )
{
...
static void F_184 ( struct V_266 * V_4 ,
int V_52 )
{
...
static void F_187 ( struct V_266 * V_4 )
{
F_28 () ;
...
static bool F_189 ( struct V_266 * V_4 )
{
...
F_118 ( & V_317 -> V_38 , V_351 , V_352 , V_97 ,
...
static inline bool F_192 ( T_14 * V_354 , int V_355 , int V_61 )
{
int V_356 , V_357 ;
V_356 = F_193 ( V_354 ) ;
for (; ; ) {
if ( F_194 ( V_356 + V_355 >= V_61 ) )
return false ;
V_357 = F_195 ( ( V_354 ) , V_356 , V_356 + V_355 ) ;
if ( F_196 ( V_357 == V_356 ) )
break;
V_356 = V_357 ;
}
return true ;
}
static inline bool F_197 ( T_14 * V_354 , int V_355 , int V_61 )
{
int V_356 , V_357 ;
V_356 = F_193 ( V_354 ) ;
for (; ; ) {
...
static bool F_198 ( struct V_41 * V_4 , int V_20 )
{
bool V_22 ;
F_199 () ;
V_22 = F_197 ( & V_4 -> V_358 , V_20 , 0 ) ;
F_199 () ;
return V_22 ;
}
static bool F_200 ( struct V_41 * V_4 , int V_20 )
{
bool V_22 ;
F_199 () ;
V_22 = F_192 ( & V_4 -> V_358 , V_20 , V_4 -> V_359 + 1 ) ;
F_199 () ;
return V_22 ;
}
static int F_201 ( struct V_41 * V_4 )
{
int V_360 ;
F_199 () ;
V_360 = F_193 ( & V_4 -> V_358 ) ;
return V_360 ;
}
static bool F_202 ( struct V_41 * V_4 ,
int V_20 )
{
return true ;
}
...
if ( F_144 ( V_4 -> V_362 , V_193 ) ) {
F_146 ( V_4 -> V_362 , V_193 ) ;
...
static inline void F_207 ( struct V_41 * V_158 ,
int V_53 , int V_358 )
{
memset ( V_158 , 0 , sizeof( * V_158 ) ) ;
memset ( & V_158 -> V_362 , 0xff , sizeof( V_158 -> V_362 ) ) ;
F_208 ( & V_158 -> V_358 , V_358 ) ;
V_158 -> V_359 = V_358 ;
V_158 -> V_363 = V_53 ;
F_199 () ;
V_158 -> V_364 = F_201 ;
...
F_213 ( V_17 , L_86 , V_158 -> V_373 [ V_288 ] ) ;
if ( ( V_288 + 1 < V_372 ) &&
( ( ( V_288 + 1 ) & 0x3 ) == 0 ) ) {
F_213 ( V_17 , L_87 ) ;
...
T_10 type )
{
F_118 ( & V_375 -> V_38 , V_96 , V_101 , V_97 , V_110 ,
V_200 , V_33 , V_34 , type ) ;
V_375 -> V_306 = V_306 ;
V_375 -> V_403 = F_214 ;
}
...
static int F_221 ( struct V_406 * V_415 ,
struct V_404 * V_405 )
{
...
static void F_228 ( struct V_406 * V_4 ,
struct V_454 * V_405 ,
struct V_455 * V_456 ,
unsigned long * V_139 )
{
...
F_4 ( V_17 , L_102 ,
V_4 -> V_421 [ cos ] , cos ) ;
F_4 ( V_17 , L_103 , V_560 -> V_567 [ cos ] ) ;
F_235 ( V_2 , V_560 -> V_567 [ cos ] , V_4 -> V_421 [ cos ] ) ;
}
...
enum V_632 F_256 ( struct V_1 * V_2 ,
struct V_633 * V_4 )
{
if ( V_4 -> V_409 )
return V_634 ;
...
if ( ! F_224 ( V_111 , & V_420 ) ) {
F_38 ( L_111 ,
V_111 , F_260 ( V_2 ) , V_4 -> V_33 ,
V_420 , V_4 -> V_413 ) ;
return - V_66 ;
}
F_4 ( V_17 ,
L_112 ,
V_111 , F_260 ( V_2 ) , V_4 -> V_413 ) ;
V_4 -> V_33 = V_4 -> V_413 ;
V_4 -> V_413 = V_634 ;
F_225 () ;
F_29 ( V_111 , & V_4 -> V_409 ) ;
...
static
inline int F_277 ( struct V_1 * V_2 ,
struct V_636 * V_405 )
{
struct V_633 * V_4 = V_405 -> V_659 ;
struct V_709 * V_110 =
...
for ( V_288 = 0 ; V_288 < F_281 ( V_110 -> V_728 ) ; V_288 ++ )
V_110 -> V_728 [ V_288 ] =
V_723 -> V_728 [ V_288 ] ;
...
switch ( V_405 -> V_111 ) {
case V_638 :
return F_267 ( V_2 , V_405 ) ;
case V_640 :
return F_273 ( V_2 , V_405 ) ;
case V_643 :
return F_278 ( V_2 , V_405 ) ;
case V_642 :
return F_272 ( V_2 , V_405 ) ;
case V_644 :
