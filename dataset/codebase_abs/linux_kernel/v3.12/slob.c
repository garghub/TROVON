...
void * F_45 ( T_4 V_6 , T_3 V_12 )
{
return F_38 ( V_6 , V_12 , V_15 , V_47 ) ;
}
...
V_2 = F_29 ( V_37 ) ;
if ( F_33 ( ! F_51 ( V_2 ) ) )
return V_36 << F_53 ( V_2 ) ;
V_20 = F_39 ( T_4 , V_41 , V_42 ) ;
V_40 = ( unsigned int * ) ( V_37 - V_20 ) ;
return F_21 ( * V_40 ) * V_48 ;
}
int F_55 ( struct V_49 * V_50 , unsigned long V_28 )
{
if ( V_28 & V_51 ) {
V_50 -> V_6 += sizeof( struct V_52 ) ;
}
V_50 -> V_28 = V_28 ;
return 0 ;
}
void * F_56 ( struct V_49 * V_50 , T_3 V_28 , int V_14 )
{
void * V_16 ;
V_28 &= V_44 ;
F_40 ( V_28 ) ;
if ( V_50 -> V_6 < V_36 ) {
V_16 = F_23 ( V_50 -> V_6 , V_28 , V_50 -> V_20 , V_14 ) ;
F_57 ( V_47 , V_16 , V_50 -> V_53 ,
F_21 ( V_50 -> V_6 ) * V_48 ,
V_28 , V_14 ) ;
} else {
V_16 = F_13 ( V_28 , F_42 ( V_50 -> V_6 ) , V_14 ) ;
F_57 ( V_47 , V_16 , V_50 -> V_53 ,
V_36 << F_42 ( V_50 -> V_6 ) ,
V_28 , V_14 ) ;
}
if ( V_16 && V_50 -> V_54 )
V_50 -> V_54 ( V_16 ) ;
F_58 ( V_16 , V_50 -> V_6 , 1 , V_50 -> V_28 , V_28 ) ;
return V_16 ;
}
void * F_59 ( struct V_49 * V_55 , T_3 V_28 )
{
return F_56 ( V_55 , V_28 , V_15 ) ;
}
void * F_60 ( T_4 V_6 , T_3 V_12 , int V_14 )
{
return F_38 ( V_6 , V_12 , V_14 , V_47 ) ;
}
void * F_61 ( struct V_49 * V_55 , T_3 V_12 , int V_14 )
{
return F_56 ( V_55 , V_12 , V_14 ) ;
}
static void F_62 ( void * V_16 , int V_6 )
{
if ( V_6 < V_36 )
F_34 ( V_16 , V_6 ) ;
else
...
{
struct V_52 * V_52 = (struct V_52 * ) V_57 ;
void * V_16 = ( void * ) V_52 - ( V_52 -> V_6 - sizeof( struct V_52 ) ) ;
F_62 ( V_16 , V_52 -> V_6 ) ;
}
void F_64 ( struct V_49 * V_50 , void * V_16 )
{
F_65 ( V_16 , V_50 -> V_28 ) ;
if ( F_33 ( V_50 -> V_28 & V_51 ) ) {
struct V_52 * V_52 ;
V_52 = V_16 + ( V_50 -> V_6 - sizeof( struct V_52 ) ) ;
V_52 -> V_6 = V_50 -> V_6 ;
F_66 ( & V_52 -> V_57 , F_63 ) ;
} else {
F_62 ( V_16 , V_50 -> V_6 ) ;
...
int F_68 ( struct V_49 * V_50 )
{
return 0 ;
}
int F_69 ( struct V_49 * V_58 )
{
return 0 ;
}
void T_6 F_70 ( void )
