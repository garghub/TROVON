...
static int F_55 ( struct V_89 * V_90 , struct V_5 * V_6 ,
struct V_9 * V_10 )
{
int V_68 ;
struct V_91 * V_92 ;
...
V_68 = F_58 ( V_95 , V_90 , & V_93 , & V_10 -> error ) ;
if ( V_68 ) {
F_15 ( V_92 ) ;
return - V_96 ;
}
...
static struct V_1 * F_60 ( struct V_89 * V_90 , struct V_20 * V_21 ,
struct V_9 * V_10 )
{
int V_68 ;
struct V_1 * V_99 ;
...
if ( ! V_99 )
return F_61 ( - V_42 ) ;
V_68 = F_62 ( V_10 , F_57 ( V_90 ) , F_63 ( V_10 -> V_88 ) ,
& V_99 -> V_17 . V_18 ) ;
if ( V_68 ) {
V_10 -> error = L_5 ;
goto V_103;
...
static struct V_5 * F_67 ( struct V_89 * V_90 ,
struct V_12 * V_13 )
{
static struct V_94 V_95 [] = {
{ 1 , 1024 , L_9 } ,
...
V_6 -> V_13 = V_13 ;
V_68 = F_55 ( V_90 , V_6 , V_10 ) ;
if ( V_68 )
goto V_103;
V_68 = F_68 ( V_95 , V_90 , & V_6 -> V_110 , & V_10 -> error ) ;
if ( V_68 )
goto V_103;
V_68 = F_68 ( V_95 + 1 , V_90 , & V_108 , & V_10 -> error ) ;
if ( V_68 )
goto V_103;
V_109 = 1 + V_108 ;
...
V_1 = F_60 ( & V_111 , & V_6 -> V_21 , V_10 ) ;
if ( F_69 ( V_1 ) ) {
V_68 = F_70 ( V_1 ) ;
goto V_103;
}
V_1 -> V_6 = V_6 ;
F_42 ( & V_1 -> V_15 , & V_6 -> V_7 ) ;
F_59 ( V_90 , V_109 ) ;
}
return V_6 ;
V_103:
...
static int F_71 ( struct V_89 * V_90 , struct V_12 * V_13 )
{
unsigned V_112 ;
int V_113 ;
struct V_9 * V_10 = V_13 -> V_10 ;
...
if ( F_58 ( V_95 , V_90 , & V_112 , & V_10 -> error ) )
return - V_96 ;
if ( ! V_112 )
return 0 ;
V_13 -> V_16 = F_72 ( F_57 ( V_90 ) , V_2 ) ;
...
static int F_75 ( struct V_89 * V_90 , struct V_12 * V_13 )
{
int V_68 ;
unsigned V_102 ;
struct V_9 * V_10 = V_13 -> V_10 ;
...
V_68 = F_58 ( V_95 , V_90 , & V_102 , & V_10 -> error ) ;
if ( V_68 )
return - V_96 ;
if ( ! V_102 )
return 0 ;
...
( V_102 >= 1 ) ) {
V_68 = F_68 ( V_95 + 1 , V_90 , & V_13 -> V_118 , & V_10 -> error ) ;
V_102 -- ;
continue;
}
if ( ! strcasecmp ( V_117 , L_26 ) &&
( V_102 >= 1 ) ) {
V_68 = F_68 ( V_95 + 2 , V_90 , & V_13 -> V_28 , & V_10 -> error ) ;
V_102 -- ;
continue;
}
V_10 -> error = L_27 ;
...
static int F_76 ( struct V_9 * V_10 , unsigned int V_102 ,
char * * V_98 )
{
static struct V_94 V_95 [] = {
{ 0 , 1024 , L_28 } ,
...
if ( V_68 )
goto V_103;
V_68 = F_68 ( V_95 , & V_90 , & V_13 -> V_121 , & V_10 -> error ) ;
if ( V_68 )
goto V_103;
V_68 = F_68 ( V_95 + 1 , & V_90 , & V_120 , & V_10 -> error ) ;
if ( V_68 )
goto V_103;
if ( ( ! V_13 -> V_121 && V_120 ) ||
( V_13 -> V_121 && ! V_120 ) ) {
...
if ( V_1 == V_13 -> V_57 )
V_13 -> V_57 = NULL ;
F_90 ( V_135 , V_13 -> V_10 ,
V_1 -> V_17 . V_18 -> V_133 , V_13 -> V_59 ) ;
F_91 ( & V_13 -> V_31 ) ;
V_132:
F_44 ( & V_13 -> V_26 , V_70 ) ;
return 0 ;
...
static int F_93 ( struct V_12 * V_13 , struct V_137 * V_18 ,
T_2 V_138 )
{
int V_68 = - V_96 ;
struct V_1 * V_1 ;
...
static int F_95 ( struct V_12 * V_13 , const char * V_139 )
{
struct V_5 * V_6 ;
unsigned V_140 ;
unsigned long V_70 ;
char V_141 ;
if ( ! V_139 || ( sscanf ( V_139 , L_35 , & V_140 , & V_141 ) != 1 ) || ! V_140 ||
( V_140 > V_13 -> V_121 ) ) {
F_89 ( L_36 ) ;
return - V_96 ;
}
...
static int F_96 ( struct V_12 * V_13 , const char * V_139 , int V_58 )
{
struct V_5 * V_6 ;
unsigned V_140 ;
char V_141 ;
...
static void F_98 ( void * V_143 , int V_144 )
{
...
if ( F_102 ( error ) ) {
if ( ( V_65 -> V_130 & V_158 ) &&
! V_65 -> V_76 -> V_159 . V_160 ) {
struct V_161 * V_159 ;
V_159 = F_104 ( F_105 ( V_13 -> V_10 -> V_88 ) ) ;
V_159 -> V_160 = 0 ;
}
return error ;
}
...
V_21 = & V_1 -> V_6 -> V_21 ;
if ( V_21 -> type -> V_163 )
V_21 -> type -> V_163 ( V_21 , & V_1 -> V_17 , V_40 -> V_52 ) ;
}
F_27 ( V_13 , V_66 ) ;
return V_68 ;
}
...
F_114 ( L_43 ) ;
if ( V_13 -> V_118 )
F_114 ( L_44 , V_13 -> V_118 ) ;
if ( V_13 -> V_28 != V_29 )
F_114 ( L_45 , V_13 -> V_28 ) ;
if ( V_13 -> V_104 )
F_114 ( L_46 ) ;
}
if ( ! V_13 -> V_16 || type == V_169 )
F_114 ( L_47 ) ;
else
F_114 ( L_48 , V_13 -> V_16 ) ;
F_114 ( L_42 , V_13 -> V_121 ) ;
if ( V_13 -> V_61 )
...
V_168 = 'E' ;
F_114 ( L_49 , V_168 ) ;
if ( V_6 -> V_21 . type -> V_170 )
V_167 += V_6 -> V_21 . type -> V_170 ( & V_6 -> V_21 , NULL , type ,
V_165 + V_167 ,
V_166 - V_167 ) ;
else
F_114 ( L_47 ) ;
F_114 ( L_50 , V_6 -> V_110 ,
V_6 -> V_21 . type -> V_171 ) ;
F_31 (p, &pg->pgpaths, list) {
F_114 ( L_51 , V_99 -> V_17 . V_18 -> V_133 ,
V_99 -> V_3 ? L_52 : L_53 ,
V_99 -> V_134 ) ;
if ( V_6 -> V_21 . type -> V_170 )
V_167 += V_6 -> V_21 . type -> V_170 ( & V_6 -> V_21 ,
& V_99 -> V_17 , type , V_165 + V_167 ,
V_166 - V_167 ) ;
}
}
break;
case V_172 :
F_31 (pg, &m->priority_groups, list) {
F_114 ( L_54 , V_6 -> V_21 . type -> V_133 ) ;
if ( V_6 -> V_21 . type -> V_170 )
V_167 += V_6 -> V_21 . type -> V_170 ( & V_6 -> V_21 , NULL , type ,
V_165 + V_167 ,
V_166 - V_167 ) ;
...
V_6 -> V_21 . type -> V_173 ) ;
F_31 (p, &pg->pgpaths, list) {
F_114 ( L_54 , V_99 -> V_17 . V_18 -> V_133 ) ;
if ( V_6 -> V_21 . type -> V_170 )
V_167 += V_6 -> V_21 . type -> V_170 ( & V_6 -> V_21 ,
& V_99 -> V_17 , type , V_165 + V_167 ,
V_166 - V_167 ) ;
...
static int F_115 ( struct V_9 * V_10 , unsigned V_102 , char * * V_98 )
{
int V_68 = - V_96 ;
struct V_137 * V_18 ;
struct V_12 * V_13 = (struct V_12 * ) V_10 -> V_14 ;
...
V_68 = F_96 ( V_13 , V_98 [ 1 ] , 1 ) ;
goto V_132;
} else if ( ! strcasecmp ( V_98 [ 0 ] , L_58 ) ) {
V_68 = F_96 ( V_13 , V_98 [ 1 ] , 0 ) ;
goto V_132;
} else if ( ! strcasecmp ( V_98 [ 0 ] , L_59 ) ) {
V_68 = F_95 ( V_13 , V_98 [ 1 ] ) ;
goto V_132;
...
V_68 = F_62 ( V_10 , V_98 [ 1 ] , F_63 ( V_10 -> V_88 ) , & V_18 ) ;
if ( V_68 ) {
F_89 ( L_62 ,
V_98 [ 1 ] ) ;
goto V_132;
}
V_68 = F_93 ( V_13 , V_18 , V_138 ) ;
F_13 ( V_10 , V_18 ) ;
V_132:
F_111 ( & V_13 -> V_33 ) ;
return V_68 ;
}
static int F_117 ( struct V_9 * V_10 , unsigned int V_174 ,
unsigned long V_175 )
{
struct V_12 * V_13 = V_10 -> V_14 ;
struct V_1 * V_1 ;
...
V_68 = - V_80 ;
F_44 ( & V_13 -> V_26 , V_70 ) ;
if ( ! V_68 && V_10 -> V_116 != F_118 ( V_19 -> V_178 ) >> V_179 )
V_68 = F_119 ( NULL , V_174 ) ;
if ( V_68 == - V_177 && ! F_120 ( V_127 ) )
F_43 ( V_74 , & V_13 -> V_30 ) ;
return V_68 ? : F_121 ( V_19 , V_176 , V_174 , V_175 ) ;
}
static int F_122 ( struct V_9 * V_10 ,
T_5 V_180 , void * V_143 )
{
struct V_12 * V_13 = V_10 -> V_14 ;
struct V_5 * V_6 ;
struct V_1 * V_99 ;
...
F_31 (pg, &m->priority_groups, list) {
F_31 (p, &pg->pgpaths, list) {
V_113 = V_180 ( V_10 , V_99 -> V_17 . V_18 , V_10 -> V_181 , V_10 -> V_116 , V_143 ) ;
if ( V_113 )
goto V_132;
}
}
