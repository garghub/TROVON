...
if ( ! F_77 ( V_7 , * V_177 ) )
F_76 ( & V_7 -> V_7 , * V_177 , V_176 ) ;
}
} else {
F_78 ( & V_7 -> V_7 , V_177 , V_176 , V_168 ) ;
}
return V_168 ;
}
static void F_79 ( struct V_208 * V_208 )
{
...
static void F_81 ( struct V_29 * V_30 , int V_213 )
{
...
goto V_235;
if ( ( V_220 -> V_224 & ( V_236 | V_237 | V_238 | V_239 | V_240 ) ) ==
( V_222 -> V_224 & ( V_236 | V_237 | V_238 | V_239 | V_240 ) ) )
goto V_241;
V_232:
V_14 = 0 ;
V_14 |= ( V_223 & V_240 ? V_242 :
V_243 ) ;
if ( V_223 & V_238 ) {
if ( V_223 & V_239 )
V_14 |= V_223 & V_237 ?
