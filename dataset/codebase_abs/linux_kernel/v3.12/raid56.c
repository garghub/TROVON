...
if ( V_63 ) {
V_110 = ( T_1 ) V_63 -> V_118 << 9 ;
V_110 += V_63 -> V_119 ;
if ( V_110 == V_113 && V_112 -> V_116 -> V_117 &&
F_20 ( V_84 , & V_63 -> V_85 ) &&
V_63 -> V_120 == V_112 -> V_116 -> V_117 ) {
...
V_121 = ( T_1 ) V_82 -> V_118 << 9 ;
V_122 = V_121 - V_24 -> V_35 [ 0 ] ;
V_107 = V_122 >> V_67 ;
for ( V_11 = 0 ; V_11 < V_82 -> V_123 ; V_11 ++ ) {
V_93 = V_82 -> V_124 [ V_11 ] . V_125 ;
...
F_15 ( V_93 ) ;
V_126 [ V_112 ++ ] = F_13 ( V_93 ) ;
V_130 . V_131 ( V_68 -> V_69 , V_132 ,
V_126 ) ;
} else {
memcpy ( V_126 [ V_61 ] , V_126 [ 0 ] , V_132 ) ;
F_47 ( V_126 + 1 , V_61 - 1 , V_31 ) ;
}
...
struct V_82 * V_82 )
{
T_1 V_137 = V_82 -> V_118 ;
T_1 V_136 ;
int V_11 ;
V_137 <<= 9 ;
for ( V_11 = 0 ; V_11 < V_24 -> V_61 ; V_11 ++ ) {
V_136 = V_24 -> V_35 [ V_11 ] ;
if ( V_137 >= V_136 &&
V_137 < V_136 + V_24 -> V_62 ) {
return V_11 ;
}
}
return - 1 ;
}
static int F_86 ( struct V_23 * V_24 , int V_138 )
{
unsigned long V_33 ;
int V_27 = 0 ;
F_37 ( & V_24 -> V_46 , V_33 ) ;
if ( V_24 -> V_102 == V_138 || V_24 -> V_103 == V_138 )
goto V_74;
if ( V_24 -> V_102 == - 1 ) {
V_24 -> V_102 = V_138 ;
...
struct V_82 * V_82 )
{
int V_138 = F_100 ( V_24 , V_82 ) ;
if ( V_138 < 0 )
return - V_89 ;
return F_86 ( V_24 , V_138 ) ;
}
...
{
V_24 -> V_139 . V_33 = 0 ;
V_24 -> V_139 . V_140 = V_141 ;
F_104 ( & V_24 -> V_45 -> V_142 ,
& V_24 -> V_139 ) ;
}
static void F_61 ( struct V_23 * V_24 )
{
V_24 -> V_139 . V_33 = 0 ;
V_24 -> V_139 . V_140 = V_143 ;
F_104 ( & V_24 -> V_45 -> V_142 ,
& V_24 -> V_139 ) ;
}
...
static int F_110 ( void * V_148 , struct V_77 * V_149 , struct V_77 * V_150 )
{
struct V_23 * V_151 = F_111 ( V_149 , struct V_23 ,
V_49 ) ;
struct V_23 * V_152 = F_111 ( V_150 , struct V_23 ,
V_49 ) ;
T_1 V_153 = V_151 -> V_40 . V_78 -> V_118 ;
T_1 V_154 = V_152 -> V_40 . V_78 -> V_118 ;
if ( V_153 < V_154 )
return - 1 ;
if ( V_153 > V_154 )
return 1 ;
...
static void F_114 ( struct V_158 * V_139 )
{
struct V_155 * V_156 ;
V_156 = F_111 ( V_139 , struct V_155 , V_139 ) ;
F_112 ( V_156 ) ;
}
static void F_115 ( struct V_159 * V_160 , bool V_161 )
{
struct V_155 * V_156 ;
V_156 = F_111 ( V_160 , struct V_155 , V_160 ) ;
if ( V_161 ) {
V_156 -> V_139 . V_33 = 0 ;
V_156 -> V_139 . V_140 = F_114 ;
F_104 ( & V_156 -> V_2 -> V_142 ,
& V_156 -> V_139 ) ;
return;
}
F_112 ( V_156 ) ;
}
int F_116 ( struct V_97 * V_98 , struct V_82 * V_82 ,
struct V_99 * V_68 , T_1 * V_35 ,
T_1 V_62 )
{
struct V_23 * V_24 ;
...
return F_118 ( V_24 ) ;
F_89 ( & V_24 -> V_40 , V_82 ) ;
V_24 -> V_41 = V_82 -> V_119 ;
if ( F_51 ( V_24 ) )
return F_107 ( V_24 ) ;
V_160 = F_119 ( F_115 , V_98 -> V_45 ,
sizeof( * V_156 ) ) ;
if ( V_160 ) {
V_156 = F_111 ( V_160 , struct V_155 , V_160 ) ;
if ( ! V_156 -> V_2 ) {
...
int V_80 ;
int V_11 ;
V_126 = F_2 ( V_24 -> V_68 -> V_69 * sizeof( void * ) ,
V_101 ) ;
if ( ! V_126 ) {
V_80 = - V_17 ;
goto V_162;
...
V_126 [ V_112 ] = V_126 [ V_112 + 1 ] ;
V_126 [ V_24 -> V_61 - 1 ] = V_93 ;
F_47 ( V_126 , V_24 -> V_61 - 1 , V_31 ) ;
}
if ( ! V_24 -> V_65 ) {
...
static void F_123 ( struct V_82 * V_82 , int V_80 )
{
struct V_23 * V_24 = V_82 -> V_86 ;
if ( V_80 )
F_73 ( V_24 , V_82 ) ;
...
int F_124 ( struct V_97 * V_98 , struct V_82 * V_82 ,
struct V_99 * V_68 , T_1 * V_35 ,
T_1 V_62 , int V_166 )
{
struct V_23 * V_24 ;
...
static void V_141 ( struct V_158 * V_139 )
{
struct V_23 * V_24 ;
V_24 = F_111 ( V_139 , struct V_23 , V_139 ) ;
F_105 ( V_24 ) ;
}
static void V_143 ( struct V_158 * V_139 )
{
struct V_23 * V_24 ;
V_24 = F_111 ( V_139 , struct V_23 , V_139 ) ;
F_91 ( V_24 ) ;
