...
void F_31 ( struct V_1 * V_2 , T_5 V_80 , unsigned long * V_81 )
{
struct V_61 * V_62 = & V_2 -> V_82 ;
struct V_29 * V_30 = V_2 -> V_77 ;
struct V_55 * V_6 = & V_2 -> V_6 ;
struct V_83 * V_84 = & V_6 -> V_60 -> V_6 ;
int V_11 ;
if ( V_80 & 0xf00 )
F_32 ( 2 ) ;
F_21 ( V_30 , V_32 , 0x0 ) ;
...
F_35 ( & V_2 -> V_6 . V_87 , * V_81 ) ;
F_36 ( V_84 ) ;
F_37 ( & V_2 -> V_6 . V_87 , * V_81 ) ;
F_21 ( V_30 , V_32 , 0x3 ) ;
}
static void F_38 ( struct V_55 * V_6 )
{
struct V_1 * V_2 =
F_19 ( V_6 , struct V_1 , V_6 ) ;
struct V_29 * V_30 = V_2 -> V_77 ;
...
static inline void F_39 ( struct V_1 * V_2 , int * V_91 ,
unsigned long * V_81 )
{
...
#ifdef F_43
if ( V_2 -> V_6 . V_106 &&
V_2 -> V_6 . V_106 -> V_19 == V_2 -> V_6 . line ) {
* V_91 |= V_2 -> V_107 ;
V_2 -> V_107 = 0 ;
}
#endif
...
if ( F_44 ( & V_2 -> V_6 , V_92 ) )
goto V_102;
F_45 ( & V_2 -> V_6 , * V_91 , V_100 , V_92 , V_93 ) ;
V_102:
* V_91 = F_1 ( V_2 , V_24 ) ;
} while ( ( * V_91 & V_90 ) && V_94 -- );
F_35 ( & V_2 -> V_6 . V_87 , * V_81 ) ;
F_36 ( & V_2 -> V_6 . V_60 -> V_6 ) ;
F_37 ( & V_2 -> V_6 . V_87 , * V_81 ) ;
}
...
V_11 = V_2 -> V_6 . V_113 / 2 ;
do {
F_4 ( V_2 , V_112 , V_59 -> V_14 [ V_59 -> V_65 ] ) ;
...
V_2 -> V_6 . V_68 . V_118 ++ ;
if ( V_91 & V_119 )
F_48 ( & V_2 -> V_6 , V_91 & V_120 ) ;
if ( V_91 & V_121 )
F_49 ( & V_2 -> V_6 , V_91 & V_122 ) ;
F_50 ( & V_2 -> V_6 . V_60 -> V_6 . V_123 ) ;
}
static T_6 F_51 ( int V_124 , void * V_125 )
{
...
static T_6 F_53 ( int V_124 , void * V_125 )
{
struct V_44 * V_45 = V_125 ;
T_5 V_80 , V_46 ;
...
static void F_72 ( struct V_55 * V_6 , int V_81 )
{
struct V_1 * V_2 =
F_19 ( V_6 , struct V_1 , V_6 ) ;
V_2 -> V_6 . type = V_212 ;
...
static void F_76 ( struct V_55 * V_6 , int V_92 )
{
struct V_1 * V_2 =
F_19 ( V_6 , struct V_1 , V_6 ) ;
F_75 ( V_2 ) ;
...
V_223 = F_80 ( & V_2 -> V_6 . V_87 ) ;
} else
F_81 ( & V_2 -> V_6 . V_87 ) ;
V_56 = F_1 ( V_2 , V_20 ) ;
F_4 ( V_2 , V_20 , 0 ) ;
F_82 ( & V_2 -> V_6 , V_221 , V_11 , F_76 ) ;
F_75 ( V_2 ) ;
F_4 ( V_2 , V_20 , V_56 ) ;
if ( V_223 )
F_83 ( & V_2 -> V_6 . V_87 ) ;
...
static int T_7
F_85 ( struct V_219 * V_220 , char * V_226 )
{
struct V_1 * V_2 ;
int V_173 = 115200 ;
int V_227 = 8 ;
...
return - V_231 ;
if ( V_226 )
F_86 ( V_226 , & V_173 , & V_103 , & V_227 , & V_228 ) ;
return F_87 ( & V_2 -> V_6 , V_220 , V_173 , V_103 , V_227 , V_228 ) ;
}
static int F_88 ( struct V_232 * V_233 , T_8 V_60 )
{
void * V_234 = F_89 ( V_233 ) ;
struct V_1 * V_2 ;
...
F_91 ( V_233 ) ;
F_92 ( V_233 , F_93 ( V_233 , V_60 ) ) ;
return 0 ;
}
static int F_94 ( struct V_232 * V_233 )
{
void * V_234 = F_89 ( V_233 ) ;
struct V_1 * V_2 ;
int V_16 ;
...
static int F_98 ( struct V_235 * V_71 )
{
F_99 ( V_71 , 500 ) ;
return - V_237 ;
}
...
static int F_101 ( struct V_235 * V_71 )
{
return 0 ;
}
static int F_102 ( struct V_232 * V_233 ,
const struct V_238 * V_239 )
{
struct V_1 * V_133 ;
int V_19 , V_16 ;
F_103 ( V_240 L_27 ,
V_233 -> V_241 , V_233 -> V_235 ) ;
switch ( V_233 -> V_235 ) {
case 0x081B :
V_19 = 0 ;
break;
...
return V_16 ;
if ( V_19 == 3 ) {
V_16 = F_105 ( V_233 -> V_124 , F_53 , 0 , L_29 , V_242 ) ;
if ( V_16 ) {
F_104 ( & V_233 -> V_71 , L_30 ) ;
goto V_243;
}
F_106 ( V_233 , V_242 ) ;
} else {
V_133 = & V_242 -> V_6 [ V_19 ] ;
V_133 -> V_6 . V_124 = V_233 -> V_124 ;
V_133 -> V_6 . V_71 = & V_233 -> V_71 ;
V_133 -> V_71 = & V_233 -> V_71 ;
V_16 = F_105 ( V_233 -> V_124 , F_51 , 0 , V_133 -> V_47 , V_133 ) ;
if ( V_16 ) {
F_104 ( & V_233 -> V_71 , L_30 ) ;
goto V_243;
}
F_107 ( & V_229 , & V_133 -> V_6 ) ;
F_106 ( V_233 , V_133 ) ;
}
F_108 ( & V_233 -> V_71 ) ;
F_109 ( & V_233 -> V_71 ) ;
...
if ( ! V_45 )
return;
V_45 -> V_245 = 0xffa28000 ;
V_45 -> V_246 = 0x1000 ;
if ( ! ( F_112 ( V_45 -> V_245 , V_45 -> V_246 , L_31 ) ) )
F_113 ( L_32 ) ;
V_45 -> V_247 = F_114 ( ( unsigned long ) V_45 -> V_245 , V_45 -> V_246 ) ;
if ( ! V_45 -> V_247 ) {
F_115 ( L_33 ) ;
V_16 = - V_49 ;
goto V_248;
...
V_133 -> V_6 . V_249 = V_250 ;
V_133 -> V_6 . V_251 = ( V_252 ) V_45 -> V_245
+ V_253
+ V_46 * V_254 ;
V_133 -> V_6 . V_7 = V_45 -> V_247 + V_253
+ V_46 * V_254 ;
sprintf ( V_133 -> V_47 , L_34 , V_46 ) ;
V_133 -> V_6 . V_113 = 64 ;
V_133 -> V_6 . V_255 = & V_256 ;
V_133 -> V_6 . line = V_46 ;
V_133 -> V_6 . V_81 = V_257 ;
...
for ( V_46 = 0 ; V_46 < 6 ; V_46 ++ ) {
V_244 -> V_31 = V_46 ;
V_244 -> V_135 = ( V_46 & 0x1 ) ? V_85 : V_74 ;
V_244 -> V_133 = & V_45 -> V_6 [ V_46 / 2 ] ;
V_244 -> V_247 = V_45 -> V_247 + V_259 +
V_46 * V_260 ;
V_244 ++ ;
}
V_242 = V_45 ;
...
return;
V_248:
F_116 ( V_45 -> V_245 , V_45 -> V_246 ) ;
F_10 ( V_45 ) ;
return;
}
static void F_117 ( struct V_232 * V_233 )
{
void * V_234 = F_89 ( V_233 ) ;
struct V_1 * V_2 ;
if ( ! V_234 )
