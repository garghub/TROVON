...
V_34 = V_1 -> V_18 . V_19 [ V_1 -> V_36 ] . V_34 ;
V_35 = V_1 -> V_18 . V_19 [ V_1 -> V_36 ] . V_35 ;
if ( V_34 <= 640 ) {
F_18 ( V_1 , 0x1a7 , V_34 ) ;
F_18 ( V_1 , 0x1aa , V_35 ) ;
...
if ( V_61 -> V_67 & V_68 ) {
V_55 = 8 ;
F_30 ( V_1 , V_72 , V_26 , 0 ) ;
V_59 = V_73 ;
}
F_30 ( V_1 , V_59 , V_26 + V_55 , V_54 - V_55 ) ;
}
static void F_31 ( struct V_1 * V_1 , T_3 V_12 )
{
struct V_29 * V_29 = (struct V_29 * ) V_1 ;
if ( V_29 -> V_65 )
V_12 = ! V_12 ;
...
if ( V_29 -> V_66 > 100 ) {
V_29 -> V_65 = ! V_29 -> V_65 ;
F_31 ( V_1 , F_34 ( V_29 -> V_74 ) ) ;
F_32 ( V_1 , F_34 ( V_29 -> V_75 ) ) ;
}
}
static int F_35 ( struct V_76 * V_77 )
{
struct V_1 * V_1 =
F_36 ( V_77 -> V_78 , struct V_1 , V_79 ) ;
V_1 -> V_6 = 0 ;
if ( ! V_1 -> V_80 )
return 0 ;
switch ( V_77 -> V_17 ) {
...
V_1 -> V_85 . V_79 = V_84 ;
F_38 ( V_84 , 2 ) ;
V_29 -> V_74 = F_39 ( V_84 , & V_86 ,
V_81 , 0 , 1 , 1 , 0 ) ;
V_29 -> V_75 = F_39 ( V_84 , & V_86 ,
V_82 , 0 , 1 , 1 , 0 ) ;
if ( V_84 -> error ) {
F_5 ( L_15 ) ;
return V_84 -> error ;
...
const struct V_16 * V_17 )
{
return F_41 ( V_88 , V_17 , & V_89 , sizeof( struct V_29 ) ,
V_90 ) ;
}
