...
V_107 = ( ( T_3 * ) V_99 ) +
sizeof( struct V_98 ) ;
V_106 = F_3 ( * ( V_74 * ) ( V_107 + sizeof( T_2 ) ) ) ;
while ( V_107 && V_106 > 0 ) {
V_105 = ( * V_107 ) ;
...
int F_43 ( struct V_1 * V_2 , T_2 V_235 ,
struct V_3 * V_4 )
{
int V_236 = 0 ;
struct V_8 * V_9 = V_2 -> V_9 ;
...
break;
case V_252 :
V_236 = F_14 ( V_2 , V_4 , V_66 ) ;
break;
case V_253 :
V_236 = F_10 ( V_2 , V_4 ) ;
break;
case V_254 :
V_236 = F_12 ( V_2 , V_4 , V_66 ) ;
break;
case V_117 :
V_236 = F_24 ( V_2 , V_4 ) ;
break;
case V_255 :
V_236 = F_32 ( V_2 , V_4 , V_66 ) ;
break;
case V_256 :
V_236 = F_33 ( V_2 , V_4 , V_66 ) ;
break;
case V_257 :
break;
case V_258 :
V_236 = F_34 ( V_2 , V_4 , V_66 ) ;
break;
case V_259 :
case V_260 :
case V_261 :
