...
F_29 ( & ( V_4 -> V_53 ) , V_2 -> V_23 , sizeof( T_7 ) * 2 ) ;
...
V_38 = F_31 ( T_6 , V_49 -> V_56 . V_57 [ 0 ] , sizeof( V_4 -> V_75 ) ) ;
F_32 ( V_4 -> V_75 , & V_49 -> V_56 . V_76 [ 2 ] , V_38 ) ;
V_49 -> V_56 . V_57 [ 0 ] = F_30 ( V_49 -> V_56 . V_57 [ 0 ] ) ;
break;
case V_77 :
...
{
T_8 * V_150 = ( T_8 * ) V_49 ;
V_150 -> V_151 [ 0 ] . V_38 = F_30 ( V_150 -> V_151 [ 0 ] . V_38 ) ;
V_150 -> V_151 [ 1 ] . V_38 = F_30 ( V_150 -> V_151 [ 1 ] . V_38 ) ;
V_150 -> V_151 [ 2 ] . V_38 = F_30 ( V_150 -> V_151 [ 2 ] . V_38 ) ;
V_150 -> V_151 [ 3 ] . V_38 = F_30 ( V_150 -> V_151 [ 3 ] . V_38 ) ;
...
break;
case V_202 :
V_49 -> V_56 . V_57 [ V_98 / 2 ] = F_30 ( V_49 -> V_56 . V_57 [ V_98 / 2 ] ) ;
break;
case V_203 :
case V_204 :
V_49 -> V_56 . V_57 [ 0 ] = F_30 ( V_49 -> V_56 . V_57 [ 0 ] ) ;
...
case V_196 :
if ( V_4 -> V_197 ) {
F_35 ( & ( V_4 -> V_18 ) , V_210 | V_46 ) ;
F_35 ( & ( V_4 -> V_18 ) , V_211 ) ;
} else {
F_35 ( & ( V_4 -> V_18 ) , V_212 | V_46 ) ;
F_35 ( & ( V_4 -> V_18 ) , V_213 ) ;
}
break;
default:
F_36 ( V_4 ) ;
V_2 -> V_15 = F_37 ( & ( V_4 -> V_18 ) , ( V_214 ) V_49 ) ;
F_38 ( V_4 ) ;
break;
}
if ( V_50 )
...
V_15 = F_24 ( V_40 , V_2 -> V_23 , sizeof( T_7 ) * 2 ) ;
if ( V_15 != 0 ) {
F_13 ( V_6 , L_30 ) ;
V_2 -> V_15 = V_35 ;
F_11 ( V_6 ) ;
...
V_15 = F_29 ( & ( V_4 -> V_53 ) , V_2 -> V_23 , sizeof( T_7 ) * 2 ) ;
if ( ( ( V_4 -> V_53 . V_38 + 1 ) * sizeof( T_7 ) ) > V_2 -> V_38 ) {
F_13 ( V_6 , L_36 ) ;
V_2 -> V_38 = sizeof( V_4 -> V_53 ) ;
V_2 -> V_15 = V_31 ;
...
F_30 ( V_4 -> V_18 . V_219 . V_220 ) == V_221 ;
break;
case V_190 :
case V_222 :
case V_196 :
...
case V_165 :
default:
V_15 = F_24 ( V_225 , V_2 -> V_23 , V_2 -> V_38 ) ;
if ( V_15 != 0 ) {
F_13 ( V_6 , L_40 ) ;
V_2 -> V_15 = V_35 ;
break;
...
F_36 ( V_4 ) ;
V_2 -> V_15 = F_41 ( & ( V_4 -> V_18 ) , ( V_214 ) V_49 ) ;
F_38 ( V_4 ) ;
break;
}
switch ( V_4 -> V_53 . V_24 ) {
...
V_150 [ 0 ] . V_38 = F_30 ( V_150 [ 0 ] . V_38 ) ;
V_150 [ 1 ] . V_38 = F_30 ( V_150 [ 1 ] . V_38 ) ;
V_150 [ 2 ] . V_38 = F_30 ( V_150 [ 2 ] . V_38 ) ;
V_150 [ 3 ] . V_38 = F_30 ( V_150 [ 3 ] . V_38 ) ;
}
break;
case V_118 :
case V_130 :
...
V_4 -> V_53 . V_56 . V_57 [ V_215 ] = F_30 ( V_4 -> V_53 . V_56 . V_57 [ V_215 ] ) ;
break;
case V_217 :
break;
case V_207 :
...
F_42 ( V_2 -> V_23 , & ( V_4 -> V_53 ) , V_2 -> V_38 ) ;
if ( V_50 )
F_27 ( & ( V_4 -> V_53 ) ) ;
V_2 -> V_15 = V_19 ;
} else {
...
V_15 = F_24 ( V_225 , V_2 -> V_23 , sizeof( V_4 -> V_226 ) ) ;
if ( V_15 != 0 ) {
V_2 -> V_15 = V_35 ;
F_11 ( V_6 ) ;
return V_15 ;
}
V_4 -> V_226 . V_227 = V_4 -> V_18 . V_228 ;
V_2 -> V_15 = V_19 ;
F_42 ( V_2 -> V_23 , & ( V_4 -> V_226 ) , sizeof( V_4 -> V_226 ) ) ;
F_11 ( V_6 ) ;
return V_15 ;
}
...
V_15 = F_24 ( V_225 , V_2 -> V_23 , sizeof( V_4 -> V_229 ) ) ;
if ( V_15 != 0 ) {
V_2 -> V_15 = V_35 ;
F_11 ( V_6 ) ;
return V_15 ;
...
V_2 -> V_15 = V_19 ;
F_42 ( V_2 -> V_23 , & ( V_4 -> V_229 ) , sizeof( V_4 -> V_229 ) ) ;
F_11 ( V_6 ) ;
return V_15 ;
}
int F_43 ( struct V_230 * V_34 ,
struct V_231 * V_232 ,
union V_233 * V_234 ,
char * V_235 )
{
...
F_45 ( V_4 , & V_16 ) ;
memset ( V_4 -> V_124 , 0 , sizeof( V_4 -> V_124 ) ) ;
memcpy ( V_4 -> V_124 , V_235 , V_234 -> V_23 . V_237 ) ;
F_17 ( V_4 ) ;
F_46 ( V_4 , & V_16 ) ;
F_11 ( V_6 ) ;
return V_236 ;
...
V_4 -> V_53 . V_24 = V_170 ;
V_238 = F_41 ( & ( V_4 -> V_18 ) , ( V_214 ) & ( V_4 -> V_53 ) ) ;
if ( V_238 == V_240 ) {
V_239 = ( T_9 * ) & ( V_4 -> V_53 . V_56 . V_241 ) ;
memset ( V_235 , '\0' , V_242 ) ;
V_234 -> V_23 . V_237 = V_239 -> V_237 ;
memcpy ( V_235 , V_239 -> V_243 , V_239 -> V_237 ) ;
} else {
V_236 = - V_244 ;
}
F_46 ( V_4 , & V_16 ) ;
...
F_45 ( V_4 , & V_16 ) ;
memset ( V_4 -> V_75 , 0 , sizeof( V_4 -> V_75 ) ) ;
V_38 = F_31 ( T_6 , V_234 -> V_23 . V_237 , sizeof( V_4 -> V_75 ) ) ;
F_32 ( V_4 -> V_75 , V_235 , V_38 ) ;
F_17 ( V_4 ) ;
F_46 ( V_4 , & V_16 ) ;
F_11 ( V_6 ) ;
return V_236 ;
}
int F_49 ( struct V_230 * V_34 ,
struct V_231 * V_232 ,
union V_233 * V_234 ,
char * V_235 )
{
...
int F_53 ( struct V_251 * V_252 , V_246 V_253 )
{
int V_5 = 0 ;
F_2 ( L_50 ) ;
F_3 ( V_6 ) ;
...
case V_254 :
F_4 ( V_6 , L_52 ) ;
V_252 -> V_23 [ 0 ] = F_55 ( V_253 + V_252 -> V_255 ) ;
F_4 ( V_6 , L_53 , V_252 -> V_255 , F_56 ( V_252 -> V_23 [ 0 ] ) ) ;
break;
case V_256 :
F_4 ( V_6 , L_54 ) ;
F_57 ( V_253 + V_252 -> V_255 , V_252 -> V_23 [ 0 ] ) ;
F_4 ( V_6 , L_55 , V_252 -> V_255 , F_56 ( V_252 -> V_23 [ 0 ] ) ) ;
break;
case V_257 :
F_4 ( V_6 , L_56 ) ;
F_58 ( V_253 + V_252 -> V_255 , V_252 -> V_23 , V_252 -> V_38 ) ;
F_4 ( V_6 , L_57 , V_252 -> V_255 , V_252 -> V_38 * sizeof( V_258 ) ) ;
break;
case V_259 :
F_4 ( V_6 , L_58 ) ;
F_59 ( V_253 + V_252 -> V_255 , V_252 -> V_23 , V_252 -> V_38 ) ;
F_4 ( V_6 , L_59 , V_252 -> V_255 , V_252 -> V_38 * sizeof( V_258 ) ) ;
break;
default:
F_4 ( V_6 , L_60 , V_252 -> V_24 ) ;
V_5 = - V_14 ;
break;
}
F_11 ( V_6 ) ;
