...
F_92 ( V_167 , V_18 -> V_20 . V_171 + V_168 . V_172 ) ) {
F_41 ( L_16 , V_18 ) ;
return - 1 ;
} else if ( V_18 -> V_96 & V_97 ) {
struct V_173 * V_174 ;
T_7 V_175 = 0 ;
V_174 = F_93 ( & V_18 -> V_20 , & V_18 -> V_117 ) ;
if ( V_174 ) {
V_175 = V_174 -> V_50 ;
F_94 ( V_174 ) ;
}
...
void F_95 ( unsigned long V_120 , struct V_21 * V_21 , bool V_177 )
{
unsigned long V_167 ;
if ( V_177 ) {
F_96 ( & V_178 ) ;
...
if ( V_189 )
goto V_192;
V_189 = F_114 ( V_193 , V_194 , NULL , F_38 ,
NULL ) ;
if ( V_189 )
goto V_195;
V_75:
