...
if ( type != V_109 )
return - 1 ;
V_108 = F_43 ( V_20 , type , V_105 , & V_75 ) ;
if ( V_108 == - 1 ) {
F_44 ( & V_11 -> V_11 , L_36 ) ;
return - 1 ;
}
F_45 ( V_75 , V_108 , V_76 ) ;
V_68 = F_46 ( V_75 -> V_65 , V_110 ) ;
if ( ! V_68 ) {
F_44 ( & V_11 -> V_11 , L_37 ) ;
return - 1 ;
}
F_47 ( V_75 -> V_65 , & V_68 [ 0 ] ) ;
V_67 = & V_106 -> V_69 [ V_70 ] ;
V_65 = V_67 -> V_71 [ V_72 ] ;
F_45 ( V_65 -> V_75 [ 0 ] , 0 , V_5 -> V_9 ) ;
F_45 ( V_65 -> V_75 [ 0 ] , 1 , V_111 ) ;
F_45 ( V_65 -> V_75 [ 0 ] , 2 , V_68 [ 1 ] ) ;
F_32 ( V_106 , V_65 , V_77 ) ;
F_5 ( V_68 ) ;
return 0 ;
}
static int F_48 ( struct V_13 * V_85 )
{
F_10 ( L_10 , V_12 ) ;
return 0 ;
}
static void F_49 ( struct V_13 * V_85 )
{
F_10 ( L_10 , V_12 ) ;
}
...
static int F_52 ( struct V_13 * V_10 ,
const struct V_116 * V_117 )
{
struct V_15 * V_16 = F_8 ( V_10 -> V_11 . V_17 ) ;
struct V_1 * V_2 ;
int V_52 ;
if ( F_53 ( (struct V_4 * ) V_10 -> V_47 ) )
return - V_73 ;
F_10 ( L_39 , V_12 ,
...
if ( ! F_59 ( V_10 , V_70 , V_72 ,
0 , V_74 - 1 ) ) {
V_52 = - V_73 ;
goto V_123;
}
V_52 = F_60 ( V_10 , V_124 ) ;
if ( V_52 ) {
F_6 ( & V_10 -> V_11 ,
L_44 , V_12 ) ;
goto V_125;
...
static int F_66 ( struct V_13 * V_10 )
{
int V_52 ;
struct V_1 * V_2 = F_51 ( V_10 ) ;
V_52 = F_33 ( V_2 , 0 ) ;
...
static void F_67 ( struct V_13 * V_10 )
{
struct V_1 * V_2 = F_51 ( V_10 ) ;
struct V_4 * V_5 ;
int V_57 ;
...
static int F_69 ( struct V_13 * V_10 ,
const struct V_116 * V_117 )
{
int V_130 ;
