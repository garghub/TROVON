...
V_7 = F_14 ( V_27 ) ;
V_8 = V_3 ;
if ( ! F_15 ( V_28 ) && ! F_16 ( V_24 ) )
return F_17 ( - V_29 ) ;
if ( ! F_18 ( V_7 -> V_30 , V_28 ) )
return F_17 ( - V_29 ) ;
}
V_2 = F_19 ( V_24 , F_1 , F_2 , V_21 , V_7 ) ;
if ( F_20 ( V_2 ) )
return F_21 ( V_2 ) ;
if ( ! F_5 ( V_8 , V_7 ) ) {
F_22 ( V_2 ) ;
...
static int F_42 ( struct V_39 * V_40 , struct V_22 * V_22 , struct V_41 * V_42
)
{
F_43 ( V_22 -> V_43 , V_42 ) ;
V_42 -> V_44 = V_45 . V_44 + F_44 () ;
return 0 ;
}
