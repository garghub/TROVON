...
if ( V_89 )
return V_89 ;
V_102 = F_49 ( V_100 -> V_129 ) ;
if ( ! V_102 )
return - V_114 ;
V_89 = F_50 ( V_102 , V_100 ) ;
if ( V_89 )
return V_89 ;
V_89 = F_51 ( V_100 , V_128 ) ;
if ( V_89 ) {
F_8 ( L_15 ,
V_128 -> V_130 ) ;
F_52 ( V_102 , V_100 ) ;
...
struct V_99 * V_128 )
{
F_13 ( V_128 != V_100 -> V_128 ) ;
if ( V_128 != V_100 -> V_128 )
return;
F_54 ( V_100 ) ;
if ( V_100 -> V_104 )
F_52 ( V_100 -> V_104 , V_100 ) ;
}
static void F_55 ( struct V_124 * V_90 )
{
struct V_99 * V_112 = & V_3 . V_103 ;
...
V_112 -> V_130 = L_16 ;
V_112 -> V_129 = V_135 ;
V_112 -> V_136 . V_137 = & V_138 ;
V_112 -> V_139 = V_140 ;
F_56 ( V_112 ) ;
}
static void T_2 F_57 ( struct V_124 * V_90 )
{
struct V_99 * V_112 = & V_3 . V_103 ;
F_58 ( V_112 ) ;
}
static int F_59 ( struct V_124 * V_90 )
{
T_3 V_141 ;
struct V_142 * V_143 ;
int V_89 ;
...
F_60 ( & V_3 . V_113 ) ;
V_3 . V_30 = 0 ;
V_143 = F_61 ( V_3 . V_90 , V_144 , 0 ) ;
if ( ! V_143 ) {
F_8 ( L_17 ) ;
return - V_115 ;
}
V_3 . V_4 = F_62 ( & V_90 -> V_91 , V_143 -> V_145 ,
F_63 ( V_143 ) ) ;
if ( ! V_3 . V_4 ) {
F_8 ( L_18 ) ;
return - V_146 ;
...
if ( V_89 )
goto V_147;
V_141 = ( T_3 ) ( F_3 ( V_148 ) & 0xff ) ;
F_65 ( & V_90 -> V_91 , L_19 , V_141 ) ;
F_14 () ;
F_66 ( L_20 , F_43 ) ;
F_55 ( V_90 ) ;
return 0 ;
...
static int T_2 F_68 ( struct V_124 * V_90 )
{
F_57 ( V_90 ) ;
F_67 ( & V_90 -> V_91 ) ;
return 0 ;
}
static int F_69 ( struct V_149 * V_91 )
{
if ( V_3 . V_127 )
F_70 ( V_3 . V_127 ) ;
F_71 () ;
...
static int F_72 ( struct V_149 * V_91 )
{
int V_89 ;
V_89 = F_73 () ;
if ( V_89 < 0 )
