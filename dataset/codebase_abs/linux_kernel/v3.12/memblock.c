...
T_2 T_4 F_47 ( T_2 V_6 , T_2 V_19 , int V_20 )
{
...
T_2 T_4 F_49 ( T_2 V_6 , T_2 V_19 , T_2 V_79 )
{
T_2 V_81 ;
V_81 = F_48 ( V_6 , V_19 , V_79 ) ;
if ( V_81 == 0 )
F_50 ( L_8 ,
( unsigned long long ) V_6 , ( unsigned long long ) V_79 ) ;
return V_81 ;
}
T_2 T_4 F_51 ( T_2 V_6 , T_2 V_19 )
{
return F_49 ( V_6 , V_19 , V_24 ) ;
}
T_2 T_4 F_52 ( T_2 V_6 , T_2 V_19 , int V_20 )
{
T_2 V_82 = F_47 ( V_6 , V_19 , V_20 ) ;
if ( V_82 )
return V_82 ;
return F_49 ( V_6 , V_19 , V_24 ) ;
}
...
T_2 T_4 F_54 ( unsigned long V_83 )
{
...
V_85 = F_56 ( V_28 ) ;
V_86 = F_57 ( V_28 ) ;
V_85 = F_58 (unsigned long, start_pfn, limit_pfn) ;
V_86 = F_58 (unsigned long, end_pfn, limit_pfn) ;
V_84 += V_86 - V_85 ;
}
...
static int T_1 F_62 ( struct V_1 * type , T_2 V_30 )
{
...
int T_4 F_63 ( T_2 V_30 )
{
return F_62 ( & V_2 . V_4 , V_30 ) != - 1 ;
}
int T_1 F_64 ( T_2 V_30 )
{
return F_62 ( & V_2 . V_3 , V_30 ) != - 1 ;
}
int T_1 F_65 ( unsigned long V_92 ,
unsigned long * V_85 , unsigned long * V_86 )
{
struct V_1 * type = & V_2 . V_3 ;
int V_91 = F_62 ( type , ( T_2 ) V_92 << V_87 ) ;
if ( V_91 == - 1 )
return - 1 ;
* V_85 = type -> V_15 [ V_91 ] . V_5 >> V_87 ;
* V_86 = ( type -> V_15 [ V_91 ] . V_5 + type -> V_15 [ V_91 ] . V_6 )
>> V_87 ;
return type -> V_15 [ V_91 ] . V_20 ;
}
int T_1 F_66 ( T_2 V_5 , T_2 V_6 )
{
int V_50 = F_62 ( & V_2 . V_3 , V_5 ) ;
T_2 V_18 = V_5 + F_2 ( V_5 , & V_6 ) ;
if ( V_50 == - 1 )
return 0 ;
...
int T_1 F_67 ( T_2 V_5 , T_2 V_6 )
{
F_2 ( V_5 , & V_6 ) ;
return F_5 ( & V_2 . V_4 , V_5 , V_6 ) >= 0 ;
}
void T_1 F_68 ( T_2 V_19 )
{
int V_12 ;
T_2 V_17 , V_18 , V_93 , V_94 ;
struct V_1 * V_67 = & V_2 . V_3 ;
for ( V_12 = 0 ; V_12 < V_67 -> V_13 ; V_12 ++ ) {
V_93 = V_67 -> V_15 [ V_12 ] . V_5 ;
V_94 = V_67 -> V_15 [ V_12 ] . V_5 + V_67 -> V_15 [ V_12 ] . V_6 ;
V_17 = F_46 ( V_93 , V_19 ) ;
V_18 = F_11 ( V_94 , V_19 ) ;
if ( V_17 == V_93 && V_18 == V_94 )
continue;
if ( V_17 < V_18 ) {
...
void T_1 F_69 ( T_2 V_88 )
{
V_2 . V_25 = V_88 ;
}
static void T_1 F_70 ( struct V_1 * type , char * V_95 )
{
unsigned long long V_5 , V_6 ;
int V_12 ;
F_71 ( L_9 , V_95 , type -> V_13 ) ;
for ( V_12 = 0 ; V_12 < type -> V_13 ; V_12 ++ ) {
struct V_32 * V_51 = & type -> V_15 [ V_12 ] ;
char V_96 [ 32 ] = L_10 ;
V_5 = V_51 -> V_5 ;
...
#ifdef F_72
if ( F_30 ( V_51 ) != V_27 )
snprintf ( V_96 , sizeof( V_96 ) , L_11 ,
F_30 ( V_51 ) ) ;
#endif
F_71 ( L_12 ,
V_95 , V_12 , V_5 , V_5 + V_6 - 1 , V_6 , V_96 ) ;
}
}
void T_1 F_73 ( void )
{
...
static int T_4 F_75 ( char * V_97 )
{
if ( V_97 && strstr ( V_97 , L_15 ) )
V_98 = 1 ;
return 0 ;
}
static int F_76 ( struct V_99 * V_71 , void * V_100 )
{
struct V_1 * type = V_71 -> V_100 ;
struct V_32 * V_101 ;
int V_12 ;
for ( V_12 = 0 ; V_12 < type -> V_13 ; V_12 ++ ) {
V_101 = & type -> V_15 [ V_12 ] ;
F_77 ( V_71 , L_16 , V_12 ) ;
if ( sizeof( T_2 ) == 4 )
F_77 ( V_71 , L_17 ,
( unsigned long ) V_101 -> V_5 ,
( unsigned long ) ( V_101 -> V_5 + V_101 -> V_6 - 1 ) ) ;
else
F_77 ( V_71 , L_18 ,
( unsigned long long ) V_101 -> V_5 ,
( unsigned long long ) ( V_101 -> V_5 + V_101 -> V_6 - 1 ) ) ;
}
return 0 ;
}
static int F_78 ( struct V_102 * V_102 , struct V_103 * V_103 )
{
return F_79 ( V_103 , F_76 , V_102 -> V_104 ) ;
}
static int T_4 F_80 ( void )
{
struct V_105 * V_106 = F_81 ( L_19 , NULL ) ;
if ( ! V_106 )
return - V_107 ;
F_82 ( L_1 , V_108 , V_106 , & V_2 . V_3 , & V_109 ) ;
F_82 ( L_2 , V_108 , V_106 , & V_2 . V_4 , & V_109 ) ;
return 0 ;
}
