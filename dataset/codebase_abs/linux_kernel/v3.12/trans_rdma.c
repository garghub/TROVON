...
static int
F_56 ( struct V_31 * V_63 , const char * V_109 , char * args )
{
int V_69 ;
struct V_2 V_3 ;
struct V_34 * V_35 ;
...
if ( ! V_35 )
return - V_19 ;
V_35 -> V_61 = F_57 ( F_9 , V_63 , V_137 ,
V_138 ) ;
if ( F_29 ( V_35 -> V_61 ) )
goto error;
V_63 -> V_36 = V_35 ;
V_35 -> V_109 . V_139 = V_140 ;
V_35 -> V_109 . V_141 . V_142 = F_58 ( V_109 ) ;
V_35 -> V_109 . V_143 = F_59 ( V_3 . V_9 ) ;
V_69 = F_60 ( V_35 -> V_61 , NULL ,
...
goto error;
V_69 = F_62 ( V_35 -> V_61 , V_35 -> V_15 ) ;
if ( V_69 )
goto error;
V_69 = F_61 ( & V_35 -> V_62 ) ;
if ( V_69 || ( V_35 -> V_38 != V_42 ) )
goto error;
V_69 = F_63 ( V_35 -> V_61 -> V_71 , & V_136 ) ;
if ( V_69 )
goto error;
V_35 -> V_85 = F_64 ( V_35 -> V_61 -> V_71 , F_23 ,
F_27 , V_63 ,
V_3 . V_11 + V_3 . V_13 + 1 , 0 ) ;
if ( F_29 ( V_35 -> V_85 ) )
goto error;
F_24 ( V_35 -> V_85 , V_90 ) ;
V_35 -> V_102 = F_65 ( V_35 -> V_61 -> V_71 ) ;
if ( F_29 ( V_35 -> V_102 ) )
goto error;
V_35 -> V_100 = NULL ;
...
V_35 -> V_100 = F_66 ( V_35 -> V_102 , V_148 ) ;
if ( F_29 ( V_35 -> V_100 ) )
goto error;
...
V_69 = F_67 ( V_35 -> V_61 , V_35 -> V_102 , & V_134 ) ;
if ( V_69 )
goto error;
