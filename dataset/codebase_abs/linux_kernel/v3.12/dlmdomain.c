...
static int F_100 ( struct V_14 * V_15 , struct V_152 * V_153 )
{
struct V_154 * V_130 ;
struct V_155 * V_132 ;
int V_10 , V_137 ;
int V_76 = 0 ;
for ( V_137 = 0 ; V_137 < V_153 -> V_156 ; ++ V_137 )
F_11 ( 0 , L_59 , V_153 -> V_157 [ V_137 ] . V_158 ,
& ( V_153 -> V_157 [ V_137 ] . V_159 ) ,
F_101 ( V_153 -> V_157 [ V_137 ] . V_160 ) ) ;
for ( V_10 = 0 ; V_10 < V_73 && ! V_76 ; ++ V_10 ) {
V_130 = F_102 ( V_10 ) ;
V_132 = NULL ;
for ( V_137 = 0 ; V_137 < V_153 -> V_156 ; ++ V_137 ) {
if ( V_153 -> V_157 [ V_137 ] . V_158 == V_10 ) {
V_132 = & ( V_153 -> V_157 [ V_137 ] ) ;
break;
}
}
if ( ! V_130 && ! V_132 )
...
V_76 = - V_142 ;
if ( ! V_76 &&
( ( V_132 -> V_158 != V_130 -> V_161 ) ||
( V_132 -> V_160 != V_130 -> V_162 ) ||
( V_132 -> V_159 != V_130 -> V_163 ) ) )
V_76 = - V_142 ;
if ( V_76 ) {
if ( V_132 && ! V_130 )
F_11 ( V_80 , L_60
...
& ( V_132 -> V_159 ) ,
F_101 ( V_132 -> V_160 ) ,
V_153 -> V_165 , V_15 -> V_78 ) ;
if ( V_130 && ! V_132 )
F_11 ( V_80 , L_60
L_63
L_64 , V_153 -> V_164 ,
V_130 -> V_161 , & ( V_130 -> V_163 ) ,
F_101 ( V_130 -> V_162 ) ,
V_15 -> V_78 , V_153 -> V_165 ) ;
F_37 ( ( ! V_130 && ! V_132 ) ) ;
}
if ( V_130 )
F_103 ( V_130 ) ;
...
struct V_154 * V_63 ;
int V_33 = 0 , V_76 , V_166 , V_10 ;
if ( F_66 ( V_114 , V_73 , 0 ) >= V_73 )
goto V_143;
V_153 = F_97 ( sizeof( struct V_152 ) , V_9 ) ;
if ( ! V_153 ) {
V_33 = - V_147 ;
F_98 ( V_33 ) ;
goto V_143;
}
for ( V_10 = 0 , V_166 = 0 ; V_10 < V_73 ; ++ V_10 ) {
V_63 = F_102 ( V_10 ) ;
if ( ! V_63 )
continue;
V_153 -> V_157 [ V_166 ] . V_158 = V_63 -> V_161 ;
V_153 -> V_157 [ V_166 ] . V_160 = V_63 -> V_162 ;
V_153 -> V_157 [ V_166 ] . V_159 = V_63 -> V_163 ;
F_11 ( 0 , L_59 , V_63 -> V_161 ,
& ( V_63 -> V_163 ) , F_101 ( V_63 -> V_162 ) ) ;
++ V_166 ;
F_103 ( V_63 ) ;
}
V_153 -> V_165 = V_15 -> V_78 ;
V_153 -> V_156 = V_166 ;
V_153 -> V_167 = strlen ( V_15 -> V_19 ) ;
memcpy ( V_153 -> V_164 , V_15 -> V_19 , V_153 -> V_167 ) ;
V_10 = - 1 ;
while ( ( V_10 = F_66 ( V_114 , V_73 ,
V_10 + 1 ) ) < V_73 ) {
if ( V_10 == V_15 -> V_78 )
continue;
F_11 ( 0 , L_65 , V_10 ) ;
V_33 = F_71 ( V_168 , V_150 ,
V_153 , sizeof( struct V_152 ) ,
V_10 , & V_76 ) ;
if ( V_33 >= 0 )
V_33 = V_76 ;
if ( V_33 ) {
F_11 ( V_80 , L_66 , V_33 , V_10 ) ;
break;
}
}
V_143:
...
struct V_152 * V_153 ;
struct V_14 * V_15 = NULL ;
int V_151 = 0 , V_76 = - V_142 ;
V_153 = (struct V_152 * ) V_60 -> V_66 ;
F_11 ( 0 , L_67 , V_153 -> V_165 ,
V_153 -> V_164 ) ;
F_25 ( & V_32 ) ;
V_15 = F_29 ( V_153 -> V_164 , V_153 -> V_167 ) ;
if ( ! V_15 ) {
F_11 ( V_80 , L_68
L_69 , V_153 -> V_165 , V_153 -> V_164 ) ;
goto V_143;
}
F_25 ( & V_15 -> V_26 ) ;
V_151 = 1 ;
if ( V_15 -> V_57 != V_153 -> V_165 ) {
F_11 ( V_80 , L_70
L_71 , V_153 -> V_165 , V_153 -> V_164 ,
V_15 -> V_57 ) ;
goto V_143;
}
if ( V_15 -> V_81 . V_82 == 1 &&
...
F_11 ( V_80 , L_72
L_58 , V_153 -> V_165 ,
V_153 -> V_164 , V_15 -> V_81 . V_82 ,
V_15 -> V_81 . V_83 ) ;
goto V_143;
}
V_76 = F_100 ( V_15 , V_153 ) ;
V_143:
if ( V_151 )
F_26 ( & V_15 -> V_26 ) ;
F_26 ( & V_32 ) ;
...
struct V_169 * V_170 ;
struct V_14 * V_15 = NULL ;
V_170 = (struct V_169 * ) V_60 -> V_66 ;
F_11 ( 0 , L_73 , V_170 -> V_67 ,
V_170 -> V_30 ) ;
F_25 ( & V_32 ) ;
V_15 = F_29 ( V_170 -> V_30 , V_170 -> V_112 ) ;
if ( V_15 ) {
F_25 ( & V_15 -> V_26 ) ;
F_37 ( V_15 -> V_57 != V_170 -> V_67 ) ;
F_90 ( V_15 , V_58 ) ;
F_26 ( & V_15 -> V_26 ) ;
}
F_26 ( & V_32 ) ;
...
V_171 . V_67 = V_15 -> V_78 ;
V_171 . V_112 = strlen ( V_15 -> V_19 ) ;
memcpy ( V_171 . V_30 , V_15 -> V_19 , V_171 . V_112 ) ;
V_76 = F_71 ( V_172 , V_150 ,
& V_171 , sizeof( V_171 ) , V_63 ,
NULL ) ;
if ( V_76 < 0 ) {
F_11 ( V_80 , L_74
L_75 , V_76 , V_172 , V_150 ,
V_63 ) ;
goto V_143;
}
V_143:
...
V_176 . V_67 = V_15 -> V_78 ;
V_176 . V_112 = strlen ( V_15 -> V_19 ) ;
memcpy ( V_176 . V_30 , V_15 -> V_19 , V_176 . V_112 ) ;
V_176 . V_120 = V_15 -> V_81 ;
V_176 . V_123 = V_15 -> V_122 ;
F_3 ( V_176 . V_114 , V_15 -> V_178 , V_73 ) ;
V_76 = F_71 ( V_179 , V_150 , & V_176 ,
sizeof( V_176 ) , V_63 , & V_177 ) ;
if ( V_76 < 0 && V_76 != - V_87 ) {
F_11 ( V_80 , L_74
L_75 , V_76 , V_179 , V_150 ,
V_63 ) ;
goto V_143;
}
F_86 ( V_177 , & V_100 ) ;
...
V_181 . V_67 = V_15 -> V_78 ;
V_181 . V_112 = strlen ( V_15 -> V_19 ) ;
memcpy ( V_181 . V_30 , V_15 -> V_19 , V_181 . V_112 ) ;
V_76 = F_71 ( V_182 , V_150 ,
& V_181 , sizeof( V_181 ) , V_63 ,
NULL ) ;
if ( V_76 < 0 )
F_11 ( V_80 , L_74
L_75 , V_76 , V_182 , V_150 ,
V_63 ) ;
return V_76 ;
}
...
F_25 ( & V_15 -> V_26 ) ;
V_33 = memcmp ( V_185 -> V_186 , V_15 -> V_178 ,
sizeof( V_15 -> V_178 ) ) ;
F_26 ( & V_15 -> V_26 ) ;
if ( V_33 )
F_11 ( 0 , L_92 ) ;
...
{
int V_76 = 0 , V_174 , V_63 ;
struct V_184 * V_185 ;
enum V_175 V_103 = V_108 ;
F_11 ( 0 , L_93 , V_15 ) ;
V_185 = F_97 ( sizeof( * V_185 ) , V_9 ) ;
if ( ! V_185 ) {
V_76 = - V_147 ;
F_98 ( V_76 ) ;
goto V_143;
}
F_115 ( V_15 -> V_178 , sizeof( V_15 -> V_178 ) ) ;
F_25 ( & V_15 -> V_26 ) ;
memcpy ( V_185 -> V_186 , V_15 -> V_178 , sizeof( V_185 -> V_186 ) ) ;
F_90 ( V_15 , V_15 -> V_78 ) ;
F_26 ( & V_15 -> V_26 ) ;
V_63 = - 1 ;
while ( ( V_63 = F_66 ( V_185 -> V_186 , V_73 ,
V_63 + 1 ) ) < V_73 ) {
if ( V_63 == V_15 -> V_78 )
continue;
...
if ( V_103 == V_126 )
F_61 ( V_63 , V_185 -> V_187 ) ;
if ( F_113 ( V_15 , V_185 , V_103 ) ) {
V_76 = - V_56 ;
goto V_143;
}
}
F_11 ( 0 , L_94 ) ;
F_25 ( & V_15 -> V_26 ) ;
memcpy ( V_15 -> V_72 , V_185 -> V_187 ,
sizeof( V_185 -> V_187 ) ) ;
F_61 ( V_15 -> V_78 , V_15 -> V_72 ) ;
F_26 ( & V_15 -> V_26 ) ;
if ( V_15 -> V_81 . V_82 > 1 ||
V_15 -> V_81 . V_83 > 0 ) {
V_76 = F_104 ( V_15 , V_185 -> V_187 ) ;
if ( V_76 ) {
F_98 ( V_76 ) ;
goto V_143;
}
V_76 = F_96 ( V_15 , V_185 -> V_187 ) ;
if ( V_76 ) {
F_98 ( V_76 ) ;
goto V_143;
}
}
F_112 ( V_15 , V_185 -> V_187 ) ;
F_25 ( & V_32 ) ;
V_15 -> V_34 = V_35 ;
V_15 -> V_40 ++ ;
F_26 ( & V_32 ) ;
...
{
F_116 ( V_15 -> V_19 , & V_15 -> V_188 ) ;
F_116 ( V_15 -> V_19 , & V_15 -> V_189 ) ;
F_117 ( & V_15 -> V_190 ) ;
}
...
int V_76 ;
F_11 ( 0 , L_97 ) ;
F_119 ( & V_15 -> V_189 , V_191 ,
V_192 , V_15 , V_193 ) ;
V_76 = F_120 ( V_15 -> V_19 , & V_15 -> V_189 ) ;
if ( V_76 )
goto V_143;
F_119 ( & V_15 -> V_188 , V_194 ,
V_195 , V_15 , V_196 ) ;
V_76 = F_120 ( V_15 -> V_19 , & V_15 -> V_188 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_197 , V_15 -> V_79 ,
sizeof( struct V_198 ) ,
V_199 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_200 , V_15 -> V_79 ,
sizeof( struct V_201 ) ,
V_202 ,
V_15 , V_203 ,
& V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_204 , V_15 -> V_79 ,
sizeof( struct V_205 ) ,
V_206 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_207 , V_15 -> V_79 ,
V_208 ,
V_209 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_210 , V_15 -> V_79 ,
V_211 ,
V_212 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_213 , V_15 -> V_79 ,
V_214 ,
V_215 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
...
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_216 , V_15 -> V_79 ,
sizeof( struct V_217 ) ,
V_218 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_219 , V_15 -> V_79 ,
sizeof( struct V_220 ) ,
V_221 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_222 , V_15 -> V_79 ,
V_223 ,
V_224 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_225 , V_15 -> V_79 ,
sizeof( struct V_226 ) ,
V_227 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_228 , V_15 -> V_79 ,
sizeof( struct V_229 ) ,
V_230 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_231 , V_15 -> V_79 ,
sizeof( struct V_232 ) ,
V_233 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_234 , V_15 -> V_79 ,
sizeof( struct V_235 ) ,
V_236 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_237 , V_15 -> V_79 ,
sizeof( struct V_238 ) ,
V_239 ,
V_15 , NULL , & V_15 -> V_190 ) ;
if ( V_76 )
...
static struct V_14 * F_131 ( const char * V_30 ,
T_2 V_79 )
{
int V_10 ;
int V_33 ;
...
F_138 ( & V_15 -> V_41 ) ;
F_138 ( & V_15 -> V_248 ) ;
F_138 ( & V_15 -> V_117 . V_249 ) ;
F_138 ( & V_15 -> V_117 . V_250 ) ;
F_138 ( & V_15 -> V_117 . V_251 ) ;
F_138 ( & V_15 -> V_252 ) ;
F_138 ( & V_15 -> V_190 ) ;
F_138 ( & V_15 -> V_92 ) ;
V_15 -> V_117 . V_28 = 0 ;
...
F_139 ( & V_15 -> V_55 ) ;
F_139 ( & V_15 -> V_257 ) ;
F_139 ( & V_15 -> V_117 . V_258 ) ;
F_139 ( & V_15 -> V_259 ) ;
F_139 ( & V_15 -> V_260 ) ;
F_138 ( & V_15 -> V_261 ) ;
V_15 -> V_57 = V_58 ;
F_139 ( & V_15 -> V_70 ) ;
V_15 -> V_117 . V_262 = V_263 ;
V_15 -> V_117 . V_264 = V_263 ;
F_140 ( & V_15 -> V_265 , 0 ) ;
F_140 ( & V_15 -> V_266 , 0 ) ;
for ( V_10 = 0 ; V_10 < V_267 ; ++ V_10 ) {
F_140 ( & V_15 -> V_268 [ V_10 ] , 0 ) ;
F_140 ( & V_15 -> V_269 [ V_10 ] , 0 ) ;
}
F_137 ( & V_15 -> V_270 ) ;
F_138 ( & V_15 -> V_271 ) ;
F_141 ( & V_15 -> V_272 , V_273 ) ;
F_142 ( & V_15 -> V_39 ) ;
V_15 -> V_34 = V_116 ;
F_138 ( & V_15 -> V_274 ) ;
F_11 ( 0 , L_104 ,
F_143 ( & V_15 -> V_39 . V_275 ) ) ;
V_91:
return V_15 ;
}
static int F_83 ( struct V_94 * V_276 ,
struct V_94 * V_96 )
{
if ( V_276 -> V_82 != V_96 -> V_82 )
return 1 ;
if ( V_276 -> V_83 > V_96 -> V_83 )
return 1 ;
if ( V_276 -> V_83 < V_96 -> V_83 )
V_96 -> V_83 = V_276 -> V_83 ;
return 0 ;
}
struct V_14 * F_144 ( const char * V_30 ,
T_2 V_79 ,
struct V_94 * V_123 )
{
int V_33 ;
struct V_14 * V_15 = NULL ;
struct V_14 * V_277 = NULL ;
if ( strlen ( V_30 ) >= V_278 ) {
V_33 = - V_279 ;
F_11 ( V_80 , L_105 ) ;
goto V_91;
}
...
{
int V_76 = 0 ;
V_76 = F_121 ( V_179 , V_150 ,
sizeof( struct V_105 ) ,
F_88 ,
NULL , NULL , & V_283 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_182 , V_150 ,
sizeof( struct V_127 ) ,
F_91 ,
NULL , NULL , & V_283 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_172 , V_150 ,
sizeof( struct V_169 ) ,
F_106 ,
NULL , NULL , & V_283 ) ;
if ( V_76 )
...
V_285 -> V_287 ( V_78 , V_285 -> V_288 ) ;
}
F_152 ( & V_286 ) ;
}
void F_153 ( struct V_284 * V_285 ,
T_3 * V_289 ,
void * V_61 )
{
F_138 ( & V_285 -> V_290 ) ;
...
{
F_155 ( & V_286 ) ;
F_146 ( & V_285 -> V_290 , & V_15 -> V_274 ) ;
F_156 ( & V_286 ) ;
}
void F_157 ( struct V_284 * V_285 )
{
F_155 ( & V_286 ) ;
F_38 ( & V_285 -> V_290 ) ;
F_156 ( & V_286 ) ;
