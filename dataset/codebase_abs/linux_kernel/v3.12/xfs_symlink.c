...
ASSERT ( V_2 -> V_15 . V_109 > 0 && V_2 -> V_15 . V_109 <= 2 ) ;
V_108 = ( int ) V_2 -> V_15 . V_16 ;
V_2 -> V_15 . V_16 = 0 ;
F_42 ( V_50 , V_2 , V_92 ) ;
V_105 = 0 ;
F_35 ( & V_52 , & V_53 ) ;
V_17 = F_59 ( V_8 ) ;
error = F_3 ( V_2 , 0 , F_2 ( V_5 , V_108 ) ,
V_8 , & V_17 , 0 ) ;
if ( error )
goto V_110;
for ( V_106 = 0 ; V_106 < V_17 ; V_106 ++ ) {
V_11 = F_44 ( V_50 , V_5 -> V_25 ,
F_4 ( V_5 , V_8 [ V_106 ] . V_23 ) ,
F_60 ( V_5 , V_8 [ V_106 ] . V_24 ) , 0 ) ;
if ( ! V_11 ) {
error = V_27 ;
goto V_85;
}
...
if ( ( error = F_62 ( V_50 , V_2 , 0 , V_108 , V_93 , V_17 ,
& V_53 , & V_52 , & V_105 ) ) )
goto V_85;
ASSERT ( V_105 ) ;
if ( ( error = F_52 ( & V_50 , & V_52 , & V_56 ) ) )
goto V_85;
ASSERT ( V_56 ) ;
F_37 ( V_50 , V_2 , 0 ) ;
F_42 ( V_50 , V_2 , V_92 ) ;
...
F_64 ( V_50 -> V_111 ) ;
if ( V_2 -> V_38 . V_112 )
F_41 ( V_2 , - V_2 -> V_38 . V_112 , V_86 ) ;
ASSERT ( V_2 -> V_38 . V_112 == 0 ) ;
error = F_31 ( V_50 , & F_32 ( V_5 ) -> V_113 , 0 , 0 ) ;
if ( error ) {
ASSERT ( F_17 ( V_5 ) ) ;
goto V_110;
}
...
if ( V_2 -> V_38 . V_39 & V_40 ) {
if ( V_2 -> V_38 . V_112 > 0 )
F_41 ( V_2 , - ( V_2 -> V_38 . V_112 ) ,
V_86 ) ;
ASSERT ( V_2 -> V_38 . V_112 == 0 ) ;
return 0 ;
}
return F_58 ( V_2 , V_50 ) ;
}
