...
if ( ( V_16 & V_19 ) && ( V_2 -> V_9 ) )
F_9 ( V_2 -> V_9 -> V_20 , L_1 ) ;
return 0 ;
}
return - V_21 ;
}
...
return 1 ;
V_35 -> V_58 =
F_35 ( F_36 ( & V_62 -> V_20 -> V_36 ) , V_35 -> V_20 ,
sizeof( struct V_42 ) ,
F_37 ( struct V_42 ) , 0 ) ;
if ( ! V_35 -> V_58 ) {
F_31 ( V_35 -> V_20 , L_6 ) ;
...
static struct V_50 * F_52 (
struct V_61 * V_62 , T_1 V_99 , T_5 V_70 ,
T_5 V_100 , enum V_95 V_101 ,
unsigned long V_38 , void * V_96 )
{
struct V_32 * V_35 ;
struct V_42 * V_71 = NULL , * V_72 = NULL , * V_73 ;
...
static enum V_132 F_54 ( struct V_61 * V_62 ,
T_4 V_53 , struct V_133 * V_134 )
{
return F_55 ( V_62 , V_53 , V_134 ) ;
}
...
{
struct V_32 * V_35 = (struct V_32 * ) V_135 ;
struct V_42 * V_43 , * V_67 ;
F_58 ( V_136 ) ;
unsigned long V_38 ;
if ( V_35 -> V_91 ) {
...
F_16 ( & V_35 -> V_55 , V_38 ) ;
V_43 = V_35 -> V_91 ;
V_137 = V_43 -> V_48 . V_139 ;
V_138 = V_43 -> V_48 . V_140 ;
F_17 ( & V_35 -> V_55 , V_38 ) ;
if ( V_137 )
V_137 ( V_138 ) ;
return;
...
F_40 ( & V_43 -> V_46 ) ;
if ( V_141 -> V_139 )
V_141 -> V_139 ( V_141 -> V_140 ) ;
F_41 ( V_35 -> V_58 , V_43 , V_141 -> V_49 ) ;
}
}
static int F_61 ( struct V_142 * V_143 )
{
struct V_27 * V_28 = F_62 ( V_143 ) ;
F_63 ( & V_28 -> V_36 ) ;
return 0 ;
}
...
int V_30 ;
V_35 = F_65 ( V_28 -> V_20 ,
sizeof( struct V_32 ) , V_144 ) ;
if ( V_35 == NULL )
return - V_63 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_7 = V_28 -> V_7 ;
if ( V_22 ) {
V_30 = F_66 ( V_28 -> V_20 , V_22 ,
F_10 , V_145 , L_10 , V_2 ) ;
if ( V_30 ) {
F_31 ( V_28 -> V_20 , L_11 ) ;
return V_30 ;
...
F_68 ( & V_35 -> V_24 , F_57 , ( unsigned long ) V_35 ) ;
F_32 ( & V_35 -> V_45 ) ;
F_32 ( & V_35 -> V_47 ) ;
F_47 ( & V_35 -> V_35 . V_146 ,
& V_28 -> V_36 . V_147 ) ;
return 0 ;
}
static struct V_61 * F_69 ( struct V_148 * V_149 ,
struct V_150 * V_151 )
{
struct V_27 * V_152 = V_151 -> V_153 ;
struct V_61 * V_35 , * V_154 ;
V_155:
V_154 = NULL ;
F_27 (chan, &d->device.channels, device_node)
if ( V_35 -> V_156 == 0 ) {
V_154 = V_35 ;
break;
}
...
V_35 = F_70 ( V_154 ) ;
if ( V_35 ) {
struct V_32 * V_157 = F_25 ( V_35 ) ;
V_157 -> V_10 = V_149 -> args [ 0 ] ;
return V_35 ;
}
goto V_155;
}
...
struct V_160 * V_161 = F_72 ( & V_143 -> V_20 ) ;
struct V_162 * V_163 ;
int V_29 , V_30 , V_22 = 0 ;
int V_40 = 0 , V_31 = 0 ;
V_28 = F_65 ( & V_143 -> V_20 , sizeof( * V_28 ) , V_144 ) ;
if ( ! V_28 )
return - V_63 ;
V_28 -> V_20 = & V_143 -> V_20 ;
F_67 ( & V_28 -> V_39 ) ;
V_163 = F_73 ( V_143 , V_164 , 0 ) ;
V_28 -> V_7 = F_74 ( V_28 -> V_20 , V_163 ) ;
if ( F_75 ( V_28 -> V_7 ) )
return F_76 ( V_28 -> V_7 ) ;
V_159 = F_77 ( V_165 , V_28 -> V_20 ) ;
if ( V_159 )
F_78 ( V_28 -> V_20 -> V_166 ,
L_12 , & V_40 ) ;
else if ( V_161 && V_161 -> V_40 )
V_40 = V_161 -> V_40 ;
else
V_40 = 32 ;
V_28 -> V_40 = V_40 ;
for ( V_29 = 0 ; V_29 < V_40 ; V_29 ++ ) {
if ( F_79 ( V_143 , V_29 ) > 0 )
V_31 ++ ;
}
V_28 -> V_2 = F_65 ( V_28 -> V_20 ,
V_40 * sizeof( struct V_32 ) , V_144 ) ;
if ( V_28 -> V_2 == NULL )
return - V_63 ;
F_32 ( & V_28 -> V_36 . V_147 ) ;
if ( V_31 != V_40 ) {
V_22 = F_79 ( V_143 , 0 ) ;
V_30 = F_66 ( V_28 -> V_20 , V_22 ,
F_12 , V_145 , L_10 , V_28 ) ;
if ( V_30 )
return V_30 ;
}
for ( V_29 = 0 ; V_29 < V_40 ; V_29 ++ ) {
V_22 = ( V_31 != V_40 ) ? 0 : F_79 ( V_143 , V_29 ) ;
V_30 = F_64 ( V_28 , V_29 , V_22 ) ;
if ( V_30 )
return V_30 ;
}
F_80 ( V_167 , V_28 -> V_36 . V_168 ) ;
F_80 ( V_169 , V_28 -> V_36 . V_168 ) ;
F_80 ( V_170 , V_28 -> V_36 . V_168 ) ;
F_80 ( V_171 , V_28 -> V_36 . V_168 ) ;
V_28 -> V_36 . V_20 = & V_143 -> V_20 ;
V_28 -> V_36 . V_172 = F_34 ;
V_28 -> V_36 . V_173 = F_42 ;
V_28 -> V_36 . V_174 = F_54 ;
V_28 -> V_36 . V_175 = F_44 ;
V_28 -> V_36 . V_176 = F_48 ;
V_28 -> V_36 . V_177 = F_52 ;
V_28 -> V_36 . V_178 = F_56 ;
V_28 -> V_36 . V_179 = F_53 ;
V_28 -> V_36 . V_180 = V_181 ;
if ( V_28 -> V_20 -> V_182 )
F_81 ( V_28 -> V_20 , V_28 -> V_20 -> V_182 ) ;
else
F_81 ( V_28 -> V_20 , F_82 ( 64 ) ) ;
V_30 = F_83 ( & V_28 -> V_36 ) ;
if ( V_30 ) {
F_31 ( V_28 -> V_36 . V_20 , L_13 ) ;
return V_30 ;
}
if ( V_143 -> V_20 . V_166 ) {
V_30 = F_84 ( V_143 -> V_20 . V_166 ,
F_69 , V_28 ) ;
if ( V_30 < 0 ) {
F_31 ( & V_143 -> V_20 , L_14 ) ;
return V_30 ;
}
}
F_85 ( V_28 -> V_36 . V_20 , L_15 , V_40 ) ;
return 0 ;
}
bool F_86 ( struct V_61 * V_35 , void * V_183 )
{
struct V_32 * V_157 = F_25 ( V_35 ) ;
if ( V_35 -> V_36 -> V_20 -> V_184 != & V_185 . V_184 )
return false ;
V_157 -> V_10 = * ( unsigned int * ) V_183 ;
return true ;
}
