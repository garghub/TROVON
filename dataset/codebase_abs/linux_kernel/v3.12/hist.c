...
static int F_49 ( T_2 V_122 , T_2 V_123 )
{
if ( V_122 > V_123 )
return 1 ;
if ( V_122 < V_123 )
...
static int F_50 ( struct V_14 * V_124 ,
struct V_14 * V_125 )
{
int V_126 ;
int V_127 , V_128 ;
...
struct V_14 * V_131 ;
T_2 * V_132 , * V_133 ;
V_126 = F_49 ( V_124 -> V_57 . V_55 , V_125 -> V_57 . V_55 ) ;
if ( V_126 || ! V_10 . V_134 )
return V_126 ;
V_130 = F_51 ( V_124 -> V_1 ) ;
V_128 = V_130 -> V_128 ;
if ( V_128 <= 1 )
return V_126 ;
...
V_130 = F_51 ( V_131 -> V_1 ) ;
V_132 [ F_52 ( V_130 ) ] = V_131 -> V_57 . V_55 ;
}
F_34 (pair, &b->pairs.head, pairs.node) {
V_130 = F_51 ( V_131 -> V_1 ) ;
V_133 [ F_52 ( V_130 ) ] = V_131 -> V_57 . V_55 ;
}
for ( V_127 = 1 ; V_127 < V_128 ; V_127 ++ ) {
V_126 = F_49 ( V_132 [ V_127 ] , V_133 [ V_127 ] ) ;
if ( V_126 )
break;
}
V_99:
...
static void F_53 ( struct V_116 * V_49 ,
struct V_14 * V_53 ,
T_2 V_135 )
{
...
V_50 = F_11 ( V_48 , struct V_14 , V_78 ) ;
V_48 = F_12 ( & V_50 -> V_78 ) ;
F_53 ( & V_1 -> V_49 , V_50 , V_135 ) ;
F_25 ( V_1 , V_50 ) ;
}
}
static void F_55 ( struct V_1 * V_1 , struct V_14 * V_15 ,
enum V_141 V_142 )
{
V_15 -> V_52 &= ~ ( 1 << V_142 ) ;
if ( V_15 -> V_52 )
...
int F_59 ( struct V_14 * V_53 , int V_155 , T_2 V_106 )
{
return F_60 ( V_53 -> V_17 . V_18 , V_53 -> V_17 . V_26 , V_155 , V_106 ) ;
}
int F_61 ( struct V_14 * V_53 , T_3 V_156 )
{
return F_62 ( V_53 -> V_17 . V_18 , V_53 -> V_17 . V_26 , V_156 ) ;
}
void F_63 ( struct V_157 * V_71 , T_6 type )
{
++ V_71 -> V_67 [ 0 ] ;
++ V_71 -> V_67 [ type ] ;
}
void F_64 ( struct V_1 * V_1 , T_6 type )
{
F_63 ( & V_1 -> V_71 , type ) ;
}
...
static struct V_14 * F_66 ( struct V_1 * V_1 ,
struct V_14 * V_53 )
{
struct V_47 * V_50 ;
if ( V_77 )
...
void F_67 ( struct V_1 * V_159 , struct V_1 * V_160 )
{
struct V_116 * V_117 ;
struct V_47 * V_149 ;
struct V_14 * V_161 , * V_131 ;
if ( V_77 )
V_117 = & V_159 -> V_79 ;
else
V_117 = V_159 -> V_98 ;
for ( V_149 = F_10 ( V_117 ) ; V_149 ; V_149 = F_12 ( V_149 ) ) {
V_161 = F_11 ( V_149 , struct V_14 , V_78 ) ;
V_131 = F_66 ( V_160 , V_161 ) ;
if ( V_131 )
F_68 ( V_131 , V_161 ) ;
}
}
int F_69 ( struct V_1 * V_159 , struct V_1 * V_160 )
{
struct V_116 * V_117 ;
struct V_47 * V_149 ;
struct V_14 * V_161 , * V_131 ;
