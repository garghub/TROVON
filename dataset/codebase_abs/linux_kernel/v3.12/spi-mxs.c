...
F_8
( V_15 ) |
( ( V_2 -> V_16 & V_17 ) ? V_18 : 0 ) |
( ( V_2 -> V_16 & V_19 ) ? V_20 : 0 ) ,
V_9 -> V_21 + F_9 ( V_9 ) ) ;
...
T_1 V_27 ;
struct V_8 * V_9 = & V_6 -> V_9 ;
F_6 ( V_30 , V_9 -> V_21 + V_31 + V_32 ) ;
V_27 = F_11 ( V_26 ) ;
F_6 ( V_27 , V_9 -> V_21 + V_31 + V_33 ) ;
}
...
F_4 ( V_9 -> V_2 , L_3 ,
V_47 , __LINE__ ,
F_22 ( V_9 -> V_21 + F_9 ( V_9 ) ) ,
F_22 ( V_9 -> V_21 + F_23 ( V_9 ) ) ) ;
return V_48 ;
}
...
V_94 , 0 ) )
return - V_42 ;
* V_49 = ( F_22 ( V_9 -> V_21 + F_41 ( V_9 ) ) & 0xff ) ;
}
