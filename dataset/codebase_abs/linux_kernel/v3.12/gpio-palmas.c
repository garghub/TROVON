...
F_7 ( V_4 , V_5 , V_15 ) ;
V_9 = F_10 ( V_7 , V_10 ,
V_11 , F_6 ( V_5 ) , F_6 ( V_5 ) ) ;
if ( V_9 < 0 )
F_5 ( V_4 -> V_12 , L_6 , V_9 ) ;
return V_9 ;
}
...
struct V_1 * V_6 = F_1 ( V_4 ) ;
struct V_7 * V_7 = V_6 -> V_7 ;
return F_13 ( V_7 , V_18 + V_5 ) ;
}
static int F_14 ( struct V_19 * V_20 )
{
struct V_7 * V_7 = F_15 ( V_20 -> V_12 . V_21 ) ;
struct V_22 * V_23 ;
struct V_1 * V_1 ;
int V_9 ;
V_1 = F_16 ( & V_20 -> V_12 ,
...
V_1 -> V_2 . V_34 = F_7 ;
V_1 -> V_2 . V_35 = F_3 ;
V_1 -> V_2 . V_12 = & V_20 -> V_12 ;
#ifdef F_18
V_1 -> V_2 . V_36 = V_20 -> V_12 . V_36 ;
#endif
V_23 = F_19 ( V_7 -> V_12 ) ;
if ( V_23 && V_23 -> V_37 )
V_1 -> V_2 . V_38 = V_23 -> V_37 ;
else
V_1 -> V_2 . V_38 = - 1 ;
V_9 = F_20 ( & V_1 -> V_2 ) ;
if ( V_9 < 0 ) {
F_5 ( & V_20 -> V_12 , L_8 , V_9 ) ;
return V_9 ;
}
F_21 ( V_20 , V_1 ) ;
return V_9 ;
