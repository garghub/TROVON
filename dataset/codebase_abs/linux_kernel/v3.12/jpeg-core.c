...
static T_3 F_132 ( int V_224 , void * V_225 )
{
...
bool V_233 = false ;
F_133 ( & V_23 -> V_166 ) ;
V_226 = F_134 ( V_23 -> V_42 ) ;
V_182 = F_135 ( V_226 -> V_41 ) ;
V_183 = F_136 ( V_226 -> V_41 ) ;
if ( V_226 -> V_36 == V_37 )
V_231 = F_137 ( V_23 -> V_8 ) ;
V_232 = F_138 ( V_23 -> V_8 ) ;
V_233 = F_139 ( V_23 -> V_8 ) ;
if ( V_226 -> V_36 == V_39 )
V_233 = V_233 && F_140 ( V_23 -> V_8 ) ;
if ( V_231 ) {
V_229 = V_207 ;
F_141 ( V_23 -> V_8 ) ;
} else if ( V_232 ) {
...
V_227 = F_143 ( V_23 -> V_8 ) ;
}
V_183 -> V_234 . V_235 = V_182 -> V_234 . V_235 ;
V_183 -> V_234 . V_236 = V_182 -> V_234 . V_236 ;
F_144 ( V_182 , V_229 ) ;
if ( V_226 -> V_36 == V_37 )
F_118 ( V_183 , 0 , V_227 ) ;
F_144 ( V_183 , V_229 ) ;
F_145 ( V_23 -> V_42 , V_226 -> V_41 ) ;
V_226 -> V_167 = F_146 ( V_23 -> V_8 ) ;
F_147 ( & V_23 -> V_166 ) ;
F_148 ( V_23 -> V_8 ) ;
return V_237 ;
}
static int F_149 ( struct V_238 * V_239 )
{
struct V_22 * V_23 ;
struct V_240 * V_50 ;
int V_29 ;
V_23 = F_150 ( & V_239 -> V_209 , sizeof( struct V_22 ) , V_30 ) ;
if ( ! V_23 )
return - V_31 ;
F_151 ( & V_23 -> V_32 ) ;
F_152 ( & V_23 -> V_166 ) ;
V_23 -> V_209 = & V_239 -> V_209 ;
V_50 = F_153 ( V_239 , V_241 , 0 ) ;
V_23 -> V_8 = F_154 ( & V_239 -> V_209 , V_50 ) ;
if ( F_29 ( V_23 -> V_8 ) )
return F_30 ( V_23 -> V_8 ) ;
V_23 -> V_224 = V_29 = F_155 ( V_239 , 0 ) ;
if ( V_29 < 0 ) {
F_156 ( & V_239 -> V_209 , L_6 ) ;
return V_29 ;
}
V_29 = F_157 ( & V_239 -> V_209 , V_23 -> V_224 , F_132 , 0 ,
F_158 ( & V_239 -> V_209 ) , V_23 ) ;
if ( V_29 ) {
F_156 ( & V_239 -> V_209 , L_7 , V_23 -> V_224 ) ;
return V_29 ;
}
V_23 -> V_242 = F_159 ( & V_239 -> V_209 , L_8 ) ;
if ( F_29 ( V_23 -> V_242 ) ) {
F_156 ( & V_239 -> V_209 , L_9 ) ;
V_29 = F_30 ( V_23 -> V_242 ) ;
return V_29 ;
}
F_160 ( & V_239 -> V_209 , L_10 , V_23 -> V_242 ) ;
F_161 ( V_23 -> V_242 ) ;
V_29 = F_162 ( & V_239 -> V_209 , & V_23 -> V_143 ) ;
if ( V_29 ) {
F_156 ( & V_239 -> V_209 , L_11 ) ;
goto V_243;
}
V_23 -> V_42 = F_163 ( & V_244 ) ;
if ( F_29 ( V_23 -> V_42 ) ) {
F_60 ( & V_23 -> V_143 , L_12 ) ;
V_29 = F_30 ( V_23 -> V_42 ) ;
goto V_245;
}
V_23 -> V_204 = F_164 ( & V_239 -> V_209 ) ;
if ( F_29 ( V_23 -> V_204 ) ) {
...
V_23 -> V_35 -> V_252 = - 1 ;
V_23 -> V_35 -> V_253 = V_254 ;
V_23 -> V_35 -> V_32 = & V_23 -> V_32 ;
V_23 -> V_35 -> V_143 = & V_23 -> V_143 ;
V_23 -> V_35 -> V_255 = V_256 ;
V_29 = F_166 ( V_23 -> V_35 , V_257 , - 1 ) ;
if ( V_29 ) {
...
F_48 ( V_23 -> V_259 -> V_98 , V_81 ,
sizeof( V_23 -> V_259 -> V_98 ) ) ;
V_23 -> V_259 -> V_248 = & V_249 ;
V_23 -> V_259 -> V_250 = & V_251 ;
V_23 -> V_259 -> V_252 = - 1 ;
V_23 -> V_259 -> V_253 = V_254 ;
V_23 -> V_259 -> V_32 = & V_23 -> V_32 ;
V_23 -> V_259 -> V_143 = & V_23 -> V_143 ;
V_23 -> V_259 -> V_255 = V_256 ;
V_29 = F_166 ( V_23 -> V_259 , V_257 , - 1 ) ;
if ( V_29 ) {
F_60 ( & V_23 -> V_143 , L_15 ) ;
goto V_261;
}
F_167 ( V_23 -> V_259 , V_23 ) ;
F_168 ( & V_23 -> V_143 ,
L_17 ,
V_23 -> V_259 -> V_93 ) ;
F_169 ( V_239 , V_23 ) ;
...
static int F_180 ( struct V_262 * V_209 )
{
return 0 ;
}
static int F_181 ( struct V_262 * V_209 )
{
