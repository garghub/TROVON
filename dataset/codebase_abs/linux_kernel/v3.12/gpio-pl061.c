...
struct V_7 * V_2 ;
int V_57 , V_31 , V_58 , V_59 ;
V_2 = F_36 ( V_54 , sizeof( * V_2 ) , V_60 ) ;
if ( V_2 == NULL )
return - V_61 ;
if ( V_56 ) {
V_2 -> V_6 . V_5 = V_56 -> V_62 ;
V_59 = V_56 -> V_59 ;
if ( V_59 <= 0 )
return - V_63 ;
} else {
...
if ( ! F_37 ( V_54 , V_50 -> V_64 . V_65 ,
F_38 ( & V_50 -> V_64 ) , L_1 ) )
return - V_66 ;
V_2 -> V_5 = F_39 ( V_54 , V_50 -> V_64 . V_65 ,
F_38 ( & V_50 -> V_64 ) ) ;
if ( ! V_2 -> V_5 )
return - V_61 ;
V_2 -> V_15 = F_40 ( V_50 -> V_54 . V_67 , V_22 ,
V_59 , & V_68 , V_2 ) ;
if ( ! V_2 -> V_15 )
return - V_63 ;
F_41 ( & V_2 -> V_12 ) ;
...
{
struct V_7 * V_2 = F_48 ( V_54 ) ;
int V_3 ;
V_2 -> V_80 . V_81 = 0 ;
V_2 -> V_80 . V_82 = F_8 ( V_2 -> V_5 + V_13 ) ;
V_2 -> V_80 . V_83 = F_8 ( V_2 -> V_5 + V_24 ) ;
V_2 -> V_80 . V_84 = F_8 ( V_2 -> V_5 + V_27 ) ;
V_2 -> V_80 . V_85 = F_8 ( V_2 -> V_5 + V_23 ) ;
V_2 -> V_80 . V_86 = F_8 ( V_2 -> V_5 + V_41 ) ;
for ( V_3 = 0 ; V_3 < V_22 ; V_3 ++ ) {
if ( V_2 -> V_80 . V_82 & ( 1 << V_3 ) )
V_2 -> V_80 . V_81 |=
...
F_9 ( V_2 -> V_80 . V_83 , V_2 -> V_5 + V_24 ) ;
F_9 ( V_2 -> V_80 . V_84 , V_2 -> V_5 + V_27 ) ;
F_9 ( V_2 -> V_80 . V_85 , V_2 -> V_5 + V_23 ) ;
F_9 ( V_2 -> V_80 . V_86 , V_2 -> V_5 + V_41 ) ;
return 0 ;
}
