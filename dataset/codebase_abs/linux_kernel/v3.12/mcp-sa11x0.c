...
{
struct V_20 * V_21 = F_17 ( & V_19 -> V_19 ) ;
...
if ( ! V_21 )
return - V_25 ;
V_23 = F_18 ( V_19 , V_26 , 0 ) ;
V_24 = F_18 ( V_19 , V_26 , 1 ) ;
if ( ! V_23 || ! V_24 )
return - V_27 ;
if ( ! F_19 ( V_23 -> V_28 , F_20 ( V_23 ) ,
V_29 ) ) {
V_8 = - V_30 ;
goto V_31;
}
if ( ! F_19 ( V_24 -> V_28 , F_20 ( V_24 ) ,
V_29 ) ) {
V_8 = - V_30 ;
goto V_32;
}
V_1 = F_21 ( & V_19 -> V_19 , sizeof( struct V_3 ) ) ;
if ( ! V_1 ) {
V_8 = - V_33 ;
goto V_34;
}
...
V_4 -> V_39 = V_21 -> V_39 ;
V_4 -> V_40 = F_22 ( V_23 -> V_28 , F_20 ( V_23 ) ) ;
V_4 -> V_41 = F_22 ( V_24 -> V_28 , F_20 ( V_24 ) ) ;
...
F_23 ( V_19 , V_1 ) ;
F_3 ( - 1 , F_10 ( V_4 ) ) ;
F_3 ( V_4 -> V_39 , F_24 ( V_4 ) ) ;
F_3 ( V_4 -> V_5 , F_4 ( V_4 ) ) ;
V_1 -> V_12 = ( 64 * 3 * 1000000 + V_1 -> V_38 - 1 ) /
V_1 -> V_38 ;
V_8 = F_25 ( V_1 , V_21 -> V_43 ) ;
if ( V_8 == 0 )
return 0 ;
V_42:
F_26 ( V_4 -> V_41 ) ;
...
F_27 ( V_1 ) ;
V_34:
F_28 ( V_24 -> V_28 , F_20 ( V_24 ) ) ;
V_32:
F_28 ( V_23 -> V_28 , F_20 ( V_23 ) ) ;
V_31:
return V_8 ;
}
...
static int F_33 ( struct V_44 * V_19 )
{
struct V_3 * V_4 = F_2 ( F_34 ( V_19 ) ) ;
if ( V_4 -> V_5 & V_17 )
F_31 ( V_19 , L_3 ) ;
F_14 ( V_4 -> V_5 & ~ V_17 , F_4 ( V_4 ) ) ;
return 0 ;
}
static int F_35 ( struct V_44 * V_19 )
{
struct V_3 * V_4 = F_2 ( F_34 ( V_19 ) ) ;
F_3 ( V_4 -> V_39 , F_24 ( V_4 ) ) ;
F_3 ( V_4 -> V_5 , F_4 ( V_4 ) ) ;
