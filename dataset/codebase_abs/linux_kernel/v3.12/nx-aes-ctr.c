...
int V_42 ;
F_8 ( & V_6 -> V_43 , V_38 ) ;
V_41 = F_9 ( T_2 , V_44 . V_45 . V_41 / sizeof( struct V_46 ) ,
V_6 -> V_12 -> V_47 ) ;
do {
V_40 = F_9 ( V_48 , V_37 - V_39 ,
V_6 -> V_12 -> V_49 ) ;
V_40 = F_9 ( V_48 , V_40 ,
V_50 * ( V_41 - 1 ) ) ;
V_40 = V_40 & ~ ( V_51 - 1 ) ;
V_42 = F_10 ( V_6 , V_33 , V_35 , V_36 , V_40 ,
V_39 , V_8 -> V_22 . V_26 . V_31 ) ;
if ( V_42 )
goto V_52;
if ( ! V_6 -> V_53 . V_54 || ! V_6 -> V_53 . V_55 ) {
V_42 = - V_21 ;
goto V_52;
}
V_42 = F_11 ( V_6 , & V_6 -> V_53 ,
V_33 -> V_56 & V_57 ) ;
if ( V_42 )
goto V_52;
memcpy ( V_33 -> V_58 , V_8 -> V_22 . V_59 . V_60 , V_51 ) ;
F_12 ( & ( V_6 -> V_61 -> V_62 ) ) ;
F_13 ( V_8 -> V_63 . V_64 ,
& ( V_6 -> V_61 -> V_65 ) ) ;
V_39 += V_40 ;
