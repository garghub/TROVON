...
int F_68 ( struct V_100 * V_101 , int V_158 )
{
return F_69 ( V_101 , V_158 ) ;
}
static void F_70 ( struct V_100 * V_159 )
{
F_71 ( & V_159 -> V_101 , V_160 ) ;
F_72 ( & V_159 -> V_101 , V_156 ) ;
V_159 -> V_101 . V_161 . V_162 =
V_163 ;
V_159 -> V_101 . V_164 = V_163 ;
}
void T_11 * F_73 ( T_1 V_165 , unsigned long V_4 )
{
...
continue;
V_166 = V_79 [ V_9 ] . V_96 . V_6 ;
V_167 = V_79 [ V_9 ] . V_96 . V_87 ;
if ( ( V_6 >= V_166 ) && ( V_87 <= V_167 ) ) {
V_59 = & V_79 [ V_9 ] ;
break;
}
}
if ( V_59 == NULL )
return NULL ;
V_168 = V_59 -> V_61 -> V_28 ;
V_6 = V_165 - V_59 -> V_93 ;
V_122 = F_56 ( V_59 -> V_145 ) + V_6 ;
return F_15 ( V_168 , V_122 , V_4 ) +
( V_6 & ( V_169 - 1 ) ) ;
}
void T_11 * F_74 ( unsigned long V_170 , unsigned int V_4 )
{
struct V_58 * V_59 = NULL ;
T_1 V_166 ;
T_1 V_167 ;
...
if ( V_79 [ V_9 ] . V_106 == NULL )
continue;
V_166 = V_79 [ V_9 ] . V_84 . V_6 ;
V_167 = V_79 [ V_9 ] . V_84 . V_87 ;
if ( ( V_6 >= V_166 ) && ( V_87 <= V_167 ) ) {
V_59 = & V_79 [ V_9 ] ;
break;
}
...
V_168 = V_59 -> V_61 -> V_28 ;
V_170 -= V_59 -> V_84 . V_6 ;
V_122 = F_56 ( V_59 -> V_146 ) + V_170 ;
return F_15 ( V_168 , V_122 , V_4 ) + ( V_170 & ( V_169 - 1 ) ) ;
}
void F_75 ( void T_11 * V_171 )
{
F_76 ( V_171 ) ;
}
void F_77 ( struct V_100 * V_101 , void T_11 * V_171 )
{
F_76 ( V_171 ) ;
}
static int F_78 ( struct V_105 * V_127 , unsigned int V_172 , int V_122 ,
int V_4 , T_12 * V_173 )
{
struct V_58 * V_59 = V_127 -> V_104 ;
T_2 * V_60 = V_59 -> V_61 ;
int V_174 = V_127 -> V_175 & 0xff ;
int V_102 = F_79 ( V_172 ) ;
int V_176 = F_80 ( V_172 ) ;
int V_177 = 1 ;
T_13 V_178 ;
void * V_179 ;
if ( F_81 ( V_127 ) ) {
...
( V_59 -> V_18 <<
V_42 ) ;
V_179 = V_60 -> V_27 + V_34 ;
goto V_181;
} else {
goto V_182;
}
}
if ( V_174 == ( V_59 -> V_142 + 1 ) ) {
if ( V_102 != 0 )
goto V_182;
V_177 = 0 ;
}
V_178 . V_43 = 0 ;
V_178 . V_183 = ( V_122 & 0xFFF ) ;
V_178 . V_184 = V_176 ;
V_178 . V_101 = V_102 ;
V_178 . V_127 = V_174 ;
V_178 . type = V_177 ;
V_179 = V_60 -> V_141 [ V_59 -> V_18 ] +
V_178 . V_43 ;
V_181:
switch ( V_4 ) {
case 4 :
...
F_84 ( V_4 , * V_173 , V_174 , V_102 , V_176 , V_122 ) ;
return 0 ;
V_182:
switch ( V_4 ) {
case 4 :
...
static int F_85 ( struct V_105 * V_127 , unsigned int V_172 , int V_122 ,
int V_4 , T_12 V_173 )
{
struct V_58 * V_59 = V_127 -> V_104 ;
T_2 * V_60 = V_59 -> V_61 ;
...
T_13 V_178 ;
void * V_179 ;
T_12 V_186 = ( T_12 ) V_173 ;
T_14 V_187 = ( T_14 ) V_173 ;
T_6 V_188 = ( T_6 ) V_173 ;
if ( F_81 ( V_127 ) ) {
if ( V_102 == 0 ) {
unsigned int V_34 ;
...
case 4 :
F_46 ( V_179 , V_186 ) ;
F_86 ( V_4 , V_186 , V_174 , V_102 , V_176 , V_122 ) ;
break;
case 2 :
F_87 ( V_179 , V_187 ) ;
F_86 ( V_4 , V_187 , V_174 , V_102 , V_176 , V_122 ) ;
break;
case 1 :
F_88 ( V_179 , V_188 ) ;
F_86 ( V_4 , V_188 , V_174 , V_102 , V_176 , V_122 ) ;
break;
default:
return V_185 ;
}
...
static unsigned int F_89 ( struct V_51 * V_52 )
{
if ( V_52 -> V_189 )
F_90 ( V_52 ) ;
return 0 ;
...
int F_95 ( struct V_100 * V_159 , struct V_189 * V_57 )
{
struct V_58 * V_59 ;
T_2 * V_60 ;
struct V_190 V_191 ;
...
F_96 ( V_199 , & V_159 -> V_101 ,
L_39
L_40 ) ;
V_17 = - V_30 ;
goto V_200;
}
V_192 = V_57 -> V_197 . V_192 ;
V_59 = F_97 ( V_192 ) ;
F_42 ( ! V_59 ) ;
V_60 = V_59 -> V_61 ;
V_196 = F_98 ( V_60 , 1 , 0 , 0 ) ;
if ( V_196 >= 0 ) {
T_16 V_201 = { {
. V_202 = 0 ,
. V_203 = 1 ,
...
V_194 = V_193 + V_206 - 1 ;
V_195 = V_193 + V_206 - 8 ;
V_191 . V_1 = ( unsigned int ) V_201 . V_43 ;
} else {
V_196 = F_64 ( V_60 , 1 , 0 , 0 ) ;
if ( V_196 < 0 ) {
F_96 ( V_199 , & V_159 -> V_101 ,
L_41
L_42
...
V_10 = F_2 ( V_7 ) ;
V_17 = F_99 ( V_60 , F_32 ( V_10 ) , F_33 ( V_10 ) ,
V_71 , V_7 , V_59 -> V_18 ,
V_196 , V_193 , V_194 ,
V_60 -> V_21 ) ;
if ( V_17 < 0 ) {
F_96 ( V_199 , & V_159 -> V_101 , L_46 ) ;
goto V_211;
}
F_100 ( V_7 , V_57 ) ;
V_191 . V_212 = V_195 >> 32 ;
V_191 . V_213 = V_195 & 0xffffffff ;
F_101 ( V_7 , & V_191 ) ;
F_34 ( V_7 , & V_214 , F_26 ) ;
F_36 ( V_7 , V_59 ) ;
return 0 ;
