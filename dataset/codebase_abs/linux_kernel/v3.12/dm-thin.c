...
static int F_91 ( struct V_22 * V_23 , T_1 * V_104 )
{
int V_15 ;
T_1 V_105 ;
unsigned long V_24 ;
...
static enum V_129 F_89 ( struct V_9 * V_9 )
{
return V_9 -> V_98 . V_130 ;
}
static void F_90 ( struct V_9 * V_9 , enum V_129 V_130 )
{
int V_15 ;
...
static int F_120 ( struct V_132 * V_110 , struct V_12 * V_12 )
{
int V_15 ;
...
V_154 = L_16 ;
if ( V_154 ) {
F_93 ( L_17 , F_130 ( V_150 , V_155 ) , V_154 ) ;
V_142 -> V_157 . V_116 = false ;
}
}
static int F_131 ( struct V_9 * V_9 , struct V_132 * V_110 )
{
...
static void F_132 ( struct V_9 * V_9 , struct V_132 * V_110 )
{
if ( V_9 -> V_110 == V_110 )
V_9 -> V_110 = NULL ;
}
...
static void F_160 ( struct V_132 * V_110 )
{
struct V_141 * V_142 = V_110 -> V_133 ;
F_161 ( & V_27 . V_28 ) ;
F_132 ( V_142 -> V_9 , V_110 ) ;
F_158 ( V_142 -> V_9 ) ;
F_162 ( V_110 , V_142 -> V_164 ) ;
F_162 ( V_110 , V_142 -> V_146 ) ;
F_141 ( V_142 ) ;
F_163 ( & V_27 . V_28 ) ;
}
...
if ( ! V_187 -> V_188 )
return 0 ;
V_15 = F_165 ( V_191 , V_187 , & V_188 , & V_110 -> error ) ;
if ( V_15 )
return - V_102 ;
while ( V_188 && ! V_15 ) {
V_189 = F_166 ( V_187 ) ;
...
static int F_173 ( struct V_132 * V_110 , unsigned V_188 , char * * V_199 )
{
int V_15 , V_200 = 0 ;
struct V_141 * V_142 ;
struct V_9 * V_9 ;
...
F_133 ( & V_98 ) ;
F_174 ( & V_187 , 4 ) ;
V_15 = F_164 ( & V_187 , & V_98 , V_110 ) ;
if ( V_15 )
goto V_202;
V_201 = V_203 | ( ( V_98 . V_130 == V_103 ) ? 0 : V_204 ) ;
V_15 = F_175 ( V_110 , V_199 [ 0 ] , V_201 , & V_164 ) ;
if ( V_15 ) {
V_110 -> error = L_39 ;
goto V_202;
}
( void ) F_168 ( V_164 -> V_48 ) ;
V_15 = F_175 ( V_110 , V_199 [ 1 ] , V_203 | V_204 , & V_146 ) ;
if ( V_15 ) {
V_110 -> error = L_40 ;
goto V_205;
}
...
if ( F_177 ( V_199 [ 3 ] , 10 , ( unsigned long long * ) & V_108 ) ) {
V_110 -> error = L_42 ;
V_15 = - V_102 ;
goto V_71;
}
...
V_9 = F_159 ( F_179 ( V_110 -> V_111 ) , V_164 -> V_48 ,
V_148 , V_98 . V_130 == V_103 , & V_110 -> error , & V_200 ) ;
if ( F_144 ( V_9 ) ) {
V_15 = F_150 ( V_9 ) ;
goto V_208;
}
...
static int F_182 ( struct V_132 * V_110 , struct V_12 * V_12 )
{
int V_15 ;
struct V_141 * V_142 = V_110 -> V_133 ;
struct V_9 * V_9 = V_142 -> V_9 ;
...
static int F_183 ( struct V_132 * V_110 , bool * V_216 )
{
int V_15 ;
struct V_141 * V_142 = V_110 -> V_133 ;
struct V_9 * V_9 = V_142 -> V_9 ;
...
static int F_186 ( struct V_132 * V_110 , bool * V_216 )
{
int V_15 ;
struct V_141 * V_142 = V_110 -> V_133 ;
struct V_9 * V_9 = V_142 -> V_9 ;
...
static int F_189 ( struct V_132 * V_110 )
{
int V_15 ;
bool V_221 , V_222 ;
struct V_141 * V_142 = V_110 -> V_133 ;
struct V_9 * V_9 = V_142 -> V_9 ;
V_15 = F_131 ( V_9 , V_110 ) ;
if ( V_15 )
return V_15 ;
V_15 = F_183 ( V_110 , & V_221 ) ;
if ( V_15 )
return V_15 ;
V_15 = F_186 ( V_110 , & V_222 ) ;
if ( V_15 )
return V_15 ;
if ( V_221 || V_222 )
( void ) F_88 ( V_9 ) ;
...
static void F_190 ( struct V_132 * V_110 )
{
struct V_141 * V_142 = V_110 -> V_133 ;
struct V_9 * V_9 = V_142 -> V_9 ;
unsigned long V_24 ;
...
static int F_208 ( struct V_132 * V_110 , unsigned V_188 , char * * V_199 )
{
int V_15 = - V_102 ;
struct V_141 * V_142 = V_110 -> V_133 ;
struct V_9 * V_9 = V_142 -> V_9 ;
if ( ! strcasecmp ( V_199 [ 0 ] , L_60 ) )
...
static void F_211 ( struct V_132 * V_110 , T_8 type ,
...
{
struct V_141 * V_142 = V_110 -> V_133 ;
return V_78 ( V_110 , V_142 -> V_146 , 0 , V_110 -> V_218 , V_246 ) ;
}
...
struct V_141 * V_142 = V_110 -> V_133 ;
struct V_9 * V_9 = V_142 -> V_9 ;
T_9 V_253 = V_153 -> V_254 >> V_81 ;
if ( V_253 < V_9 -> V_45 ||
F_221 ( V_253 , V_9 -> V_45 ) ) {
F_222 ( V_153 , 0 ) ;
F_223 ( V_153 , V_9 -> V_45 << V_81 ) ;
}
...
F_158 ( V_23 -> V_9 ) ;
F_225 ( V_23 -> V_2 ) ;
F_162 ( V_110 , V_23 -> V_47 ) ;
if ( V_23 -> V_49 )
F_162 ( V_110 , V_23 -> V_49 ) ;
F_141 ( V_23 ) ;
F_163 ( & V_27 . V_28 ) ;
}
...
V_23 = V_110 -> V_133 = F_178 ( sizeof( * V_23 ) , V_169 ) ;
if ( ! V_23 ) {
V_110 -> error = L_87 ;
V_15 = - V_86 ;
goto V_202;
...
if ( V_188 == 3 ) {
V_15 = F_175 ( V_110 , V_199 [ 2 ] , V_203 , & V_49 ) ;
if ( V_15 ) {
V_110 -> error = L_88 ;
goto V_255;
}
...
V_15 = F_175 ( V_110 , V_199 [ 0 ] , F_227 ( V_110 -> V_111 ) , & V_47 ) ;
if ( V_15 ) {
V_110 -> error = L_89 ;
goto V_256;
}
...
V_15 = F_229 ( V_23 -> V_9 -> V_100 , V_23 -> V_226 , & V_23 -> V_2 ) ;
if ( V_15 ) {
V_110 -> error = L_94 ;
goto V_259;
}
...
F_210 ( L_80 , V_263 * V_23 -> V_9 -> V_45 ) ;
if ( V_15 )
F_210 ( L_98 , ( ( V_264 + 1 ) *
V_23 -> V_9 -> V_45 ) - 1 ) ;
else
...
if ( V_23 -> V_49 )
F_210 ( L_100 , F_216 ( V_155 , V_23 -> V_49 -> V_48 -> V_245 ) ) ;
break;
}
}
return;
...
if ( V_265 )
return V_78 ( V_110 , V_23 -> V_47 , 0 , V_9 -> V_45 * V_265 , V_246 ) ;
return 0 ;
}
