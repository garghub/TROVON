...
V_109 -> V_110 = V_108 ;
V_109 -> V_128 = F_92 ;
if ( F_78 ( V_2 , ( V_121 & V_129 ) ? V_130 : V_131 ) ) {
V_109 -> V_132 |= V_121 ;
F_104 ( V_109 , - V_115 ) ;
} else {
F_105 ( V_121 , V_109 ) ;
F_106 ( V_73 >> 9 , & V_2 -> V_133 ) ;
}
}
static int F_107 ( struct V_1 * V_2 , int V_121 , unsigned V_15 , unsigned V_134 ) __must_hold( T_4 )
{
struct V_107 * V_108 ;
struct V_4 * V_5 = V_2 -> V_6 ;
int V_135 , V_40 , V_136 = 0 ;
unsigned long V_137 ;
char V_138 [ 10 ] ;
int V_92 = 0 ;
...
int F_121 ( struct V_1 * V_2 , unsigned V_147 ) __must_hold( T_4 )
{
return F_107 ( V_2 , V_129 , V_116 , V_147 ) ;
}
int F_122 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_107 ( V_2 , V_129 , V_116 , 0 ) ;
}
int F_123 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_107 ( V_2 , V_129 , V_142 | V_116 , 0 ) ;
}
...
static unsigned long F_125 ( struct V_1 * V_2 , unsigned long V_150 ,
const int V_151 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_37 ;
...
unsigned V_40 ;
if ( V_150 > V_5 -> V_64 ) {
F_3 ( V_8 , L_33 , V_150 , V_5 -> V_64 ) ;
V_150 = V_153 ;
} else {
while ( V_150 < V_5 -> V_64 ) {
V_152 = V_150 & ~ V_65 ;
V_37 = F_35 ( V_5 , F_34 ( V_5 , V_150 ) ) ;
if ( V_151 )
V_40 = F_126 ( V_37 ,
V_100 * 8 , V_150 & V_65 ) ;
else
...
if ( V_155 & V_5 -> V_19 )
F_129 ( V_2 ) ;
V_40 = F_125 ( V_2 , V_150 , V_151 ) ;
F_73 ( & V_5 -> V_58 ) ;
return V_40 ;
}
unsigned long F_130 ( struct V_1 * V_2 , unsigned long V_150 )
{
return F_128 ( V_2 , V_150 , 0 ) ;
}
unsigned long F_131 ( struct V_1 * V_2 , unsigned long V_150 )
{
return F_125 ( V_2 , V_150 , 0 ) ;
}
unsigned long F_132 ( struct V_1 * V_2 , unsigned long V_150 )
{
return F_125 ( V_2 , V_150 , 1 ) ;
}
...
if ( V_156 >= V_5 -> V_64 ) {
F_3 ( V_8 , L_34 ,
V_102 , V_156 , V_5 -> V_64 ) ;
V_156 = V_5 -> V_64 ? V_5 -> V_64 - 1 : 0 ;
}
for ( V_36 = V_102 ; V_36 <= V_156 ; V_36 ++ ) {
...
return 0 ;
F_80 ( & V_5 -> V_58 , V_15 ) ;
if ( ( V_157 ? V_160 : V_161 ) & V_5 -> V_19 )
F_129 ( V_2 ) ;
V_72 = F_133 ( V_2 , V_102 , V_156 , V_157 ) ;
F_81 ( & V_5 -> V_58 , V_15 ) ;
return V_72 ;
}
int F_137 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_156 )
{
return F_136 ( V_2 , V_102 , V_156 , 1 ) ;
}
int F_138 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_156 )
{
return - F_136 ( V_2 , V_102 , V_156 , 0 ) ;
}
static inline void F_139 ( struct V_4 * V_5 ,
int V_23 , int V_162 , int V_69 )
{
int V_40 ;
int V_68 ;
int V_163 = 0 ;
unsigned long * V_164 = F_36 ( V_5 -> V_25 [ V_23 ] ) ;
for ( V_40 = V_162 ; V_40 < V_69 ; V_40 ++ ) {
V_68 = F_61 ( V_164 [ V_40 ] ) ;
V_164 [ V_40 ] = ~ 0UL ;
V_163 += V_67 - V_68 ;
}
F_39 ( V_164 ) ;
...
void F_140 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_156 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long V_165 = F_67 ( V_102 , V_67 ) ;
unsigned long V_166 = ( V_156 + 1 ) & ~ ( ( unsigned long ) V_67 - 1 ) ;
int V_167 ;
int V_168 ;
int V_23 ;
int V_162 ;
int V_69 ;
if ( V_156 - V_102 <= 3 * V_67 ) {
F_72 ( & V_5 -> V_58 ) ;
F_133 ( V_2 , V_102 , V_156 , 1 ) ;
F_73 ( & V_5 -> V_58 ) ;
return;
}
F_72 ( & V_5 -> V_58 ) ;
if ( V_165 )
F_133 ( V_2 , V_102 , V_165 - 1 , 1 ) ;
V_167 = V_165 >> ( 3 + V_34 ) ;
V_168 = V_166 >> ( 3 + V_34 ) ;
V_162 = F_68 ( V_165 >> V_35 ) ;
V_69 = V_70 ;
for ( V_23 = V_167 ; V_23 < V_168 ; V_23 ++ ) {
F_139 ( V_2 -> V_6 , V_23 , V_162 , V_69 ) ;
F_73 ( & V_5 -> V_58 ) ;
F_64 () ;
V_162 = 0 ;
F_72 ( & V_5 -> V_58 ) ;
}
V_69 = F_68 ( V_166 >> V_35 ) ;
if ( V_69 )
F_139 ( V_2 -> V_6 , V_168 , V_162 , V_69 ) ;
if ( V_166 <= V_156 )
F_133 ( V_2 , V_166 , V_156 , 1 ) ;
F_73 ( & V_5 -> V_58 ) ;
}
...
int F_143 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_156 )
{
unsigned long V_15 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_37 = NULL ;
...
int F_144 ( struct V_1 * V_2 , unsigned long V_169 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
int V_136 , V_102 , V_156 ;
unsigned long V_15 ;
unsigned long * V_37 , * V_61 ;
if ( ! F_57 ( V_5 ) )
return 0 ;
...
F_129 ( V_2 ) ;
V_102 = F_145 ( V_169 ) ;
V_156 = F_146 ( ( T_3 ) F_145 ( V_169 + 1 ) , V_5 -> V_76 ) ;
V_136 = 0 ;
if ( V_102 < V_5 -> V_76 ) {
int V_170 = V_156 - V_102 ;
