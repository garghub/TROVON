...
case V_66 :
if ( V_61 < 0 )
return sprintf ( V_13 , L_13 , abs ( V_27 ) , - V_61 ,
V_62 ? L_14 : L_15 ) ;
else
...
case V_67 :
if ( V_61 < 0 )
return sprintf ( V_13 , L_17 , abs ( V_27 ) , - V_61 ) ;
else
...
F_63 ( V_3 ) ;
F_60 ( V_3 ) ;
F_64 ( & V_130 , V_3 -> V_131 ) ;
F_46 ( V_3 ) ;
}
struct V_2 * F_65 ( int V_132 )
{
struct V_2 * V_10 ;
T_5 V_133 ;
V_133 = sizeof( struct V_2 ) ;
if ( V_132 ) {
V_133 = F_66 ( V_133 , V_134 ) ;
V_133 += V_132 ;
}
V_133 += V_134 - 1 ;
V_10 = F_49 ( V_133 , V_86 ) ;
if ( V_10 ) {
V_10 -> V_10 . V_126 = V_10 -> V_126 ;
V_10 -> V_10 . type = & V_135 ;
V_10 -> V_10 . V_136 = & V_15 ;
F_67 ( & V_10 -> V_10 ) ;
F_68 ( & V_10 -> V_10 , ( void * ) V_10 ) ;
F_69 ( & V_10 -> V_137 ) ;
F_69 ( & V_10 -> V_138 ) ;
F_70 ( & V_10 -> V_115 ) ;
V_10 -> V_131 = F_71 ( & V_130 , 0 , 0 , V_86 ) ;
if ( V_10 -> V_131 < 0 ) {
F_6 ( V_16 L_26 ) ;
F_46 ( V_10 ) ;
return NULL ;
}
F_72 ( & V_10 -> V_10 , L_27 , V_10 -> V_131 ) ;
F_70 ( & V_10 -> V_139 ) ;
}
return V_10 ;
}
...
static void F_75 ( struct V_9 * V_10 , void * V_140 )
{
F_73 ( * (struct V_2 * * ) V_140 ) ;
}
static int F_76 ( struct V_9 * V_10 , void * V_140 , void * V_141 )
{
struct V_2 * * V_142 = V_140 ;
if ( ! V_142 || ! * V_142 ) {
F_45 ( ! V_142 || ! * V_142 ) ;
return 0 ;
}
...
struct V_2 * F_77 ( struct V_9 * V_10 , int V_132 )
{
struct V_2 * * V_143 , * V_2 ;
V_143 = F_78 ( F_75 , sizeof( * V_143 ) ,
V_86 ) ;
if ( ! V_143 )
return NULL ;
V_2 = F_65 ( V_132 ) ;
...
void F_81 ( struct V_9 * V_10 , struct V_2 * V_2 )
{
int V_144 ;
V_144 = F_82 ( V_10 , F_75 ,
F_76 , V_2 ) ;
F_45 ( V_144 ) ;
}
static int F_83 ( struct V_145 * V_145 , struct V_22 * V_146 )
{
struct V_2 * V_3 = F_84 ( V_145 -> V_147 ,
struct V_2 , V_148 ) ;
if ( F_85 ( V_149 , & V_3 -> V_150 ) )
return - V_110 ;
F_86 ( V_3 ) ;
V_146 -> V_26 = V_3 ;
return 0 ;
}
static int F_87 ( struct V_145 * V_145 , struct V_22 * V_146 )
{
struct V_2 * V_3 = F_84 ( V_145 -> V_147 ,
struct V_2 , V_148 ) ;
F_88 ( V_149 , & V_3 -> V_150 ) ;
F_89 ( V_3 ) ;
return 0 ;
}
static long F_90 ( struct V_22 * V_146 , unsigned int V_151 , unsigned long V_152 )
{
struct V_2 * V_3 = V_146 -> V_26 ;
int T_4 * V_153 = ( int T_4 * ) V_152 ;
int V_154 ;
if ( V_151 == V_155 ) {
V_154 = F_91 ( V_3 ) ;
if ( F_92 ( V_153 , & V_154 , sizeof( V_154 ) ) )
return - V_35 ;
return 0 ;
}
return - V_36 ;
...
{
int V_14 ;
if ( ! V_3 -> V_10 . V_156 && V_3 -> V_10 . V_32 )
V_3 -> V_10 . V_156 = V_3 -> V_10 . V_32 -> V_156 ;
V_3 -> V_10 . V_157 = F_94 ( F_95 ( V_18 ) , V_3 -> V_131 ) ;
V_14 = F_21 ( V_3 ) ;
if ( V_14 ) {
F_14 ( V_3 -> V_10 . V_32 ,
L_28 ) ;
...
V_3 -> V_161 == NULL )
V_3 -> V_161 = & V_162 ;
F_98 ( & V_3 -> V_148 , & V_163 ) ;
V_3 -> V_148 . V_164 = V_3 -> V_29 -> V_165 ;
V_3 -> V_148 . V_166 . V_32 = & V_3 -> V_10 . V_166 ;
V_14 = F_99 ( & V_3 -> V_148 , V_3 -> V_10 . V_157 , 1 ) ;
if ( V_14 < 0 )
goto V_167;
V_14 = F_100 ( & V_3 -> V_10 ) ;
if ( V_14 < 0 )
