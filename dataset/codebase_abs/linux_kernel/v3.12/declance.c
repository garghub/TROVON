...
static T_3 F_31 ( int V_116 , void * V_117 )
{
struct V_25 * V_26 = V_117 ;
struct V_3 * V_4 = F_7 ( V_26 ) ;
volatile struct V_5 * V_6 = V_4 -> V_6 ;
...
F_3 ( V_4 ) ;
F_33 ( V_26 ) ;
if ( F_34 ( V_26 -> V_116 , F_31 , 0 , L_18 , V_26 ) ) {
F_11 ( L_19 , V_26 -> V_103 , V_26 -> V_116 ) ;
return - V_130 ;
}
if ( V_4 -> V_131 >= 0 ) {
unsigned long V_132 ;
if ( F_34 ( V_4 -> V_131 , F_29 , 0 ,
L_20 , V_26 ) ) {
F_35 ( V_26 -> V_116 , V_26 ) ;
...
static inline int F_44 ( struct V_25 * V_26 )
{
struct V_3 * V_4 = F_7 ( V_26 ) ;
volatile struct V_5 * V_6 = V_4 -> V_6 ;
int V_92 ;
...
static int F_46 ( struct V_69 * V_70 , struct V_25 * V_26 )
{
struct V_3 * V_4 = F_7 ( V_26 ) ;
volatile struct V_5 * V_6 = V_4 -> V_6 ;
volatile T_2 * V_27 = ( volatile T_2 * ) V_26 -> V_28 ;
...
F_54 ( & V_4 -> V_136 , V_138 + 4 * V_149 / 100 ) ;
F_27 ( V_26 ) ;
return;
}
F_8 ( V_26 ) ;
...
static void F_55 ( unsigned long V_152 )
{
struct V_25 * V_26 = (struct V_25 * ) V_152 ;
F_52 ( V_26 ) ;
}
static int F_56 ( struct V_153 * V_154 , const int type )
{
static unsigned V_155 ;
static const char V_156 [] = L_23 ;
char V_103 [ 10 ] ;
struct V_25 * V_26 ;
struct V_3 * V_4 ;
...
F_11 ( V_162 ) ;
if ( V_154 )
snprintf ( V_103 , sizeof( V_103 ) , L_8 , F_57 ( V_154 ) ) ;
else {
V_29 = 0 ;
V_26 = V_163 ;
while ( V_26 ) {
...
snprintf ( V_103 , sizeof( V_103 ) , V_156 , V_29 ) ;
}
V_26 = F_58 ( sizeof( struct V_3 ) ) ;
if ( ! V_26 ) {
V_158 = - V_165 ;
goto V_166;
}
...
switch ( type ) {
case V_167 :
V_26 -> V_168 = F_60 ( V_169 + V_170 ) ;
V_26 -> V_28 = F_60 ( 0x00020000 ) ;
V_26 -> V_171 = V_26 -> V_28 + 0x00020000 ;
V_26 -> V_116 = V_172 [ V_173 ] ;
V_159 = F_60 ( V_169 + V_174 ) ;
...
case V_23 :
F_63 ( V_154 , V_26 ) ;
V_157 = F_64 ( V_154 ) -> V_180 . V_157 ;
V_17 = F_64 ( V_154 ) -> V_180 . V_181 - V_157 + 1 ;
if ( ! F_65 ( V_157 , V_17 , F_57 ( V_154 ) ) ) {
F_11 ( V_118
L_24 ,
F_57 ( V_154 ) ) ;
V_158 = - V_182 ;
...
case V_24 :
V_26 -> V_116 = V_172 [ V_173 ] ;
V_26 -> V_168 = F_60 ( V_185 + V_186 ) ;
V_26 -> V_28 = F_60 ( V_185 + V_187 ) ;
V_26 -> V_171 = V_26 -> V_28 + V_188 ;
V_159 = F_60 ( V_185 + V_189 + 1 ) ;
V_4 -> V_131 = - 1 ;
for ( V_29 = 0 ; V_29 < V_53 ; V_29 ++ ) {
V_4 -> V_60 [ V_29 ] =
( char * ) ( V_26 -> V_28 + 2 * V_175 +
...
V_26 -> V_195 = 0 ;
F_66 ( & V_4 -> V_136 ) ;
V_4 -> V_136 . V_87 = ( unsigned long ) V_26 ;
V_4 -> V_136 . V_196 = F_55 ;
V_158 = F_67 ( V_26 ) ;
if ( V_158 ) {
F_11 ( V_118
L_33 , V_103 ) ;
...
static void T_6 F_70 ( struct V_153 * V_154 )
{
struct V_25 * V_26 = F_71 ( V_154 ) ;
T_5 V_157 , V_17 ;
F_72 ( V_26 ) ;
V_157 = F_64 ( V_154 ) -> V_180 . V_157 ;
V_17 = F_64 ( V_154 ) -> V_180 . V_181 - V_157 + 1 ;
...
static int F_75 ( struct V_153 * V_26 )
{
int V_92 = F_56 ( V_26 , V_23 ) ;
if ( ! V_92 )
F_76 ( V_26 ) ;
return V_92 ;
}
static int T_6 F_77 ( struct V_153 * V_26 )
{
F_78 ( V_26 ) ;
F_70 ( V_26 ) ;
return 0 ;
