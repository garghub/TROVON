...
if ( V_102 )
F_85 ( & V_35 -> V_105 ) ;
F_86 ( V_35 -> V_32 , V_35 -> V_32 , * V_101 ) ;
F_87 ( V_35 , V_101 , V_106 ) ;
F_87 ( V_35 , V_101 , V_107 ) ;
V_35 -> V_32 = * V_101 ;
if ( V_102 )
F_88 ( & V_35 -> V_105 ) ;
F_89 ( V_35 ) ;
}
static void F_90 ( struct V_4 * V_38 , void * V_22 )
{
...
static void F_94 ( struct V_1 * V_7 , struct V_85 * V_86 )
{
static T_1 V_101 ;
...
V_112 = V_7 ;
F_24 ( V_99 , & V_101 ) ;
F_71 ( & V_7 -> V_3 , NULL , F_90 , & V_109 , V_86 ) ;
V_7 -> V_111 = V_101 ;
V_112 = NULL ;
}
static void F_95 ( struct V_1 * V_58 ,
bool V_87 , struct V_85 * V_86 )
{
struct V_1 * V_59 ;
struct V_2 * V_60 ;
...
static int F_101 ( struct V_1 * V_7 , T_3 V_113 )
{
#ifdef F_102
...
static void F_103 ( struct V_4 * V_35 , void * V_22 )
{
struct V_1 * V_7 = V_22 ;
F_27 ( V_7 , V_35 ) ;
}
static void F_104 ( struct V_1 * V_7 , struct V_85 * V_86 )
{
F_71 ( & V_7 -> V_3 , NULL , F_103 , V_7 , V_86 ) ;
}
static int F_105 ( T_4 V_115 , struct V_1 * V_7 ,
int V_116 )
{
struct V_1 * V_88 ;
int V_117 ;
...
return - V_120 ;
if ( V_116 )
F_106 ( V_115 , & V_88 -> V_10 ) ;
else
F_107 ( V_115 , & V_88 -> V_10 ) ;
V_119 = F_38 ( V_7 , V_88 ) ;
if ( V_119 < 0 )
goto V_46;
...
static void F_108 ( struct V_121 * V_122 )
{
V_122 -> V_123 = 0 ;
V_122 -> V_113 = 0 ;
V_122 -> time = 0 ;
...
static void F_113 ( struct V_121 * V_122 )
{
F_114 ( & V_122 -> V_124 ) ;
F_110 ( V_122 ) ;
V_122 -> V_123 = F_112 ( V_130 , V_122 -> V_123 + V_129 ) ;
F_115 ( & V_122 -> V_124 ) ;
}
static int F_116 ( struct V_121 * V_122 )
{
int V_113 ;
F_114 ( & V_122 -> V_124 ) ;
F_110 ( V_122 ) ;
...
struct V_94 * V_95 ;
struct V_4 * V_5 ;
struct V_4 * V_136 = F_123 ( V_132 ) ;
struct V_2 * V_137 = F_124 ( V_132 ,
V_6 ) ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
...
static int F_127 ( struct V_2 * V_3 , struct V_143 * V_144 ,
T_6 V_113 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
...
switch ( type ) {
case V_146 :
V_90 = F_105 ( V_11 , V_7 , V_113 ) ;
break;
case V_147 :
V_90 = F_105 ( V_12 , V_7 , V_113 ) ;
break;
case V_148 :
V_90 = F_105 ( V_13 , V_7 , V_113 ) ;
break;
case V_149 :
V_90 = F_105 ( V_14 , V_7 , V_113 ) ;
break;
case V_150 :
V_90 = F_105 ( V_15 , V_7 , V_113 ) ;
break;
case V_151 :
V_152 = ! ! V_113 ;
break;
...
break;
case V_154 :
V_90 = F_105 ( V_16 , V_7 , V_113 ) ;
break;
case V_155 :
V_90 = F_105 ( V_17 , V_7 , V_113 ) ;
break;
default:
V_90 = - V_49 ;
break;
...
static int F_128 ( struct V_2 * V_3 , struct V_143 * V_144 ,
T_3 V_113 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_7 type = V_144 -> V_145 ;
...
static T_8 F_131 ( char * V_160 , struct V_1 * V_7 )
{
T_8 V_161 ;
F_64 ( & V_93 ) ;
V_161 = F_132 ( V_160 , V_92 , V_7 -> V_30 ) ;
F_65 ( & V_93 ) ;
return V_161 ;
}
...
T_8 V_161 ;
F_64 ( & V_93 ) ;
V_161 = F_134 ( V_160 , V_92 , V_7 -> V_32 ) ;
F_65 ( & V_93 ) ;
return V_161 ;
}
...
T_9 V_90 = 0 ;
char * V_165 ;
if ( ! ( V_160 = ( char * ) F_136 ( V_166 ) ) )
return - V_120 ;
V_165 = V_160 ;
switch ( type ) {
case V_158 :
V_165 += F_131 ( V_165 , V_7 ) ;
break;
case V_159 :
...
* V_165 ++ = '\n' ;
V_90 = F_137 ( V_89 , V_163 , V_164 , V_160 , V_165 - V_160 ) ;
V_46:
F_138 ( ( unsigned long ) V_160 ) ;
return V_90 ;
}
static T_6 F_139 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_7 type = V_144 -> V_145 ;
switch ( type ) {
...
static T_3 F_141 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_7 type = V_144 -> V_145 ;
switch ( type ) {
...
static struct V_2 *
F_142 ( struct V_2 * V_167 )
{
struct V_1 * V_7 ;
if ( ! V_167 )
return & V_47 . V_3 ;
V_7 = F_143 ( sizeof( * V_7 ) , V_41 ) ;
if ( ! V_7 )
return F_19 ( - V_120 ) ;
...
static void F_151 ( struct V_1 * V_7 )
{
struct V_1 * V_168 ;
V_168 = F_5 ( V_7 ) ;
...
F_43 ( V_168 -> V_32 ) )
V_168 = F_5 ( V_168 ) ;
if ( F_152 ( V_168 -> V_3 . V_51 , V_7 -> V_3 . V_51 ) ) {
F_39 () ;
F_53 ( V_172 L_7 ,
F_153 ( V_7 -> V_3 . V_51 ) ) ;
F_44 () ;
...
static void F_154 ( struct V_1 * V_7 )
{
static T_13 V_173 ;
static T_1 V_174 ;
bool V_175 ;
bool V_176 = F_118 ( V_7 -> V_3 . V_51 ) ;
V_177:
F_155 ( V_142 , V_7 -> V_52 == 0 ) ;
F_64 ( & V_82 ) ;
if ( V_7 -> V_52 ) {
F_65 ( & V_82 ) ;
goto V_177;
}
F_156 ( & V_173 , V_7 -> V_30 , V_47 . V_30 ) ;
F_157 ( V_174 , V_7 -> V_32 , V_47 . V_32 ) ;
F_64 ( & V_93 ) ;
F_156 ( V_7 -> V_30 , V_7 -> V_30 , & V_173 ) ;
F_65 ( & V_93 ) ;
if ( ( V_176 && F_42 ( V_7 -> V_30 ) ) ||
( ! F_42 ( & V_173 ) && ! F_42 ( V_7 -> V_30 ) ) )
F_70 ( V_7 , NULL ) ;
F_64 ( & V_93 ) ;
F_157 ( V_7 -> V_32 , V_7 -> V_32 , V_174 ) ;
F_65 ( & V_93 ) ;
...
static void F_158 ( struct V_178 * V_179 )
{
static T_13 V_180 ;
static T_1 V_181 ;
bool V_182 , V_183 ;
...
void F_159 ( bool V_184 )
{
F_61 ( 1 , NULL , NULL ) ;
F_160 ( & V_157 ) ;
}
static int F_161 ( struct V_185 * V_186 ,
...
void F_164 ( struct V_4 * V_35 , struct V_28 * V_29 )
{
struct V_1 * V_84 ;
F_64 ( & V_93 ) ;
F_84 ( V_35 ) ;
...
void F_165 ( struct V_4 * V_35 )
{
struct V_1 * V_84 ;
F_39 () ;
V_84 = F_66 ( F_3 ( V_35 ) ) ;
F_166 ( V_35 , V_84 -> V_30 ) ;
F_44 () ;
}
void F_167 ( void )
{
...
static struct V_1 * F_170 ( struct V_1 * V_7 )
{
while ( ! ( F_11 ( V_7 ) || F_12 ( V_7 ) ) && F_5 ( V_7 ) )
V_7 = F_5 ( V_7 ) ;
return V_7 ;
}
int F_171 ( int V_192 , T_14 V_193 )
{
struct V_1 * V_7 ;
int V_194 ;
if ( F_172 () || ( V_193 & V_195 ) )
return 1 ;
F_173 ( ! ( V_193 & V_196 ) ) ;
if ( F_174 ( V_192 , V_98 -> V_32 ) )
return 1 ;
if ( F_82 ( F_83 ( V_103 ) ) )
return 1 ;
if ( V_193 & V_196 )
...
V_7 = F_170 ( F_3 ( V_98 ) ) ;
F_89 ( V_98 ) ;
V_194 = F_174 ( V_192 , V_7 -> V_32 ) ;
F_65 ( & V_93 ) ;
return V_194 ;
}
int F_175 ( int V_192 , T_14 V_193 )
{
if ( F_172 () || ( V_193 & V_195 ) )
return 1 ;
if ( F_174 ( V_192 , V_98 -> V_32 ) )
...
static int F_176 ( int * V_197 )
{
int V_192 ;
V_192 = F_177 ( * V_197 , V_98 -> V_32 ) ;
if ( V_192 == V_198 )
V_192 = F_178 ( V_98 -> V_32 ) ;
* V_197 = V_192 ;
return V_192 ;
}
int F_179 ( void )
...
V_98 -> V_201 =
F_180 ( & V_98 -> V_32 ) ;
return F_176 ( & V_98 -> V_201 ) ;
}
int F_182 ( const struct V_4 * V_202 ,
const struct V_4 * V_203 )
{
return F_25 ( V_202 -> V_32 , V_203 -> V_32 ) ;
}
void F_183 ( struct V_4 * V_35 )
{
...
{
F_84 ( V_98 ) ;
F_113 ( & F_3 ( V_98 ) -> V_121 ) ;
F_89 ( V_98 ) ;
}
int F_186 ( struct V_210 * V_211 , void * V_212 )
{
struct V_213 * V_213 ;
struct V_4 * V_35 ;
char * V_89 ;
...
V_90 = - V_214 ;
V_213 = V_211 -> V_145 ;
V_35 = F_187 ( V_213 , V_215 ) ;
if ( ! V_35 )
goto V_216;
F_39 () ;
V_3 = F_4 ( V_35 , V_6 ) ;
V_90 = F_188 ( V_3 -> V_51 , V_89 , V_92 ) ;
F_44 () ;
if ( V_90 < 0 )
goto V_217;
F_189 ( V_211 , V_89 ) ;
...
void F_192 ( struct V_210 * V_211 , struct V_4 * V_5 )
{
F_193 ( V_211 , L_9 ) ;
F_194 ( V_211 , & V_5 -> V_32 ) ;
F_193 ( V_211 , L_10 ) ;
F_193 ( V_211 , L_11 ) ;
F_195 ( V_211 , & V_5 -> V_32 ) ;
F_193 ( V_211 , L_10 ) ;
}
