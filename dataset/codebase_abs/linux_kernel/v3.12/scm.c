...
int F_20 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_37 * V_43 )
{
struct V_18 * V_19 ;
int V_44 ;
for ( V_19 = F_21 ( V_42 ) ; V_19 ; V_19 = F_22 ( V_42 , V_19 ) )
{
V_44 = - V_7 ;
if ( ! F_23 ( V_42 , V_19 ) )
goto error;
...
T_2 V_4 ;
T_3 V_6 ;
if ( V_19 -> V_28 != F_24 ( sizeof( struct V_1 ) ) )
goto error;
...
if ( ! V_43 -> V_8 || F_25 ( V_43 -> V_8 ) != V_2 . V_8 ) {
struct V_8 * V_8 ;
V_44 = - V_53 ;
V_8 = F_26 ( V_2 . V_8 ) ;
if ( ! V_8 )
...
int F_30 ( struct V_41 * V_42 , int V_54 , int type , int V_55 , void * V_56 )
{
...
int V_44 ;
if ( V_62 & V_42 -> V_63 )
return F_31 ( V_42 , V_54 , type , V_55 , V_56 ) ;
...
V_60 . V_28 = V_61 ;
V_44 = - V_66 ;
if ( F_32 ( V_57 , & V_60 , sizeof V_60 ) )
goto V_67;
if ( F_32 ( F_13 ( V_57 ) , V_56 , V_61 - sizeof( struct V_18 ) ) )
goto V_67;
V_61 = F_33 ( V_55 ) ;
if ( V_42 -> V_64 < V_61 )
V_61 = V_42 -> V_64 ;
...
void F_34 ( struct V_41 * V_42 , struct V_37 * V_38 )
{
struct V_18 T_4 * V_57
= ( V_58 struct V_18 T_4 * ) V_42 -> V_59 ;
int V_68 = 0 ;
...
if ( V_69 < V_68 )
V_68 = V_69 ;
for ( V_26 = 0 , V_70 = ( V_58 int T_4 * ) F_13 ( V_57 ) ; V_26 < V_68 ;
V_26 ++ , V_70 ++ )
{
struct V_39 * V_40 ;
int V_71 ;
...
if ( V_26 > 0 )
{
int V_61 = F_24 ( V_26 * sizeof( int ) ) ;
V_44 = F_38 ( V_46 , & V_57 -> V_45 ) ;
if ( ! V_44 )
V_44 = F_38 ( V_48 , & V_57 -> V_47 ) ;
if ( ! V_44 )
V_44 = F_38 ( V_61 , & V_57 -> V_28 ) ;
if ( ! V_44 ) {
V_61 = F_33 ( V_26 * sizeof( int ) ) ;
V_42 -> V_59 += V_61 ;
V_42 -> V_64 -= V_61 ;
}
}
