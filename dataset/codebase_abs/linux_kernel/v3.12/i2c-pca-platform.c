...
int V_8 = 0 ;
int V_9 ;
V_27 = F_22 ( V_25 , V_31 , 0 ) ;
V_9 = F_23 ( V_25 , 0 ) ;
if ( V_27 == NULL ) {
V_8 = - V_32 ;
goto V_33;
}
if ( ! F_24 ( V_27 -> V_34 , F_25 ( V_27 ) , V_27 -> V_18 ) ) {
V_8 = - V_35 ;
goto V_33;
}
V_4 = F_26 ( sizeof( struct V_3 ) , V_36 ) ;
if ( ! V_4 ) {
V_8 = - V_35 ;
goto V_37;
}
F_27 ( & V_4 -> V_10 ) ;
V_4 -> V_5 = F_28 ( V_27 -> V_34 , F_25 ( V_27 ) ) ;
if ( ! V_4 -> V_5 ) {
V_8 = - V_35 ;
goto V_38;
}
...
if ( V_4 -> V_19 > - 1 ) {
V_8 = F_29 ( V_4 -> V_19 , V_4 -> V_15 . V_18 ) ;
if ( V_8 == 0 ) {
F_30 ( V_4 -> V_19 , 1 ) ;
V_4 -> V_11 . V_51 = F_15 ;
} else {
