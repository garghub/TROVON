...
V_330 = F_145 ( V_7 -> V_456 , V_496 -> V_515 ) ;
if ( ! V_330 )
return - V_43 ;
V_143 = F_146 ( V_330 ) ;
V_279 = F_139 ( V_143 -> V_330 . V_456 ) ;
...
V_2 ) ;
F_133 ( V_143 , V_2 ) ;
V_143 -> V_165 -> V_531 [ 0 ] = F_148 ( F_16 ( V_513 -> V_532 ) ) ;
V_143 -> V_165 -> V_531 [ 1 ] = F_148 ( F_16 ( V_514 -> V_532 ) ) ;
...
V_143 -> V_165 -> V_535 |=
F_31 ( F_84 ( V_280 ,
F_134 ( V_143 -> V_165 -> V_533 ) , NULL ,
V_312 ) << 16 ) ;
V_143 -> V_165 -> V_536 = F_31 (
V_182 - F_149 ( V_280 , V_537 ) ) ;
...
V_503 = F_150 ( & V_502 ) ;
V_143 -> V_544 = F_121 ( V_503 ^ 0xffffffff ) ;
F_7 ( V_14 , L_129 ,
...
V_136 = V_7 -> V_473 ( V_7 , & V_444 ) ;
V_500 . V_547 = V_461 ;
F_151 ( & V_143 -> V_330 , & V_500 , V_548 , NULL ) ;
if ( V_2 -> V_275 ) {
V_2 -> V_275 -> V_54 =
V_143 -> V_376 ;
...
int F_152 ( struct V_194 * V_7 , const void * V_549 , T_1 V_550 )
{
struct V_1 * V_2 ;
struct V_1 * V_274 ;
struct V_130 * V_3 ;
...
int F_156 ( struct V_15 * V_16 , struct V_296 * V_563 )
{
int V_295 = 0 ;
V_564 ++ ;
if ( ( V_219 ) && ( V_219 -> V_402 ) )
V_295 = V_219 -> V_402 -> V_565 ( V_219 , F_157 ( V_563 ) , V_16 ) ;
else
F_7 ( V_14 , L_145
L_146 ) ;
return V_295 ;
...
F_136 ( & V_6 -> V_578 , V_579 ) ;
F_7 ( V_14 , L_161 ,
V_6 -> V_2 , V_6 ) ;
F_137 ( V_6 -> V_2 -> V_3 -> V_404 , & V_6 -> V_578 ) ;
F_7 ( V_14 , L_162 ) ;
return 0 ;
}
