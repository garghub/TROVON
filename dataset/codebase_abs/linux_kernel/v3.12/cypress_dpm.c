...
F_15 ( V_2 , true ) ;
if ( V_2 -> V_456 . V_457 &&
F_140 ( V_2 -> V_407 . V_408 ) ) {
T_11 V_125 ;
V_152 = F_141 ( V_2 , V_458 , V_459 ) ;
if ( V_152 )
return V_152 ;
V_2 -> V_456 . V_460 = true ;
F_142 ( V_2 ) ;
V_125 = F_21 ( V_2 , V_461 ) ;
if ( V_125 != V_83 )
F_143 ( L_8 ) ;
}
F_144 ( V_2 , V_462 , true ) ;
return 0 ;
}
...
{
struct V_19 * V_20 = F_13 ( V_2 ) ;
struct V_101 * V_463 = V_2 -> V_407 . V_416 . V_464 ;
struct V_101 * V_465 = V_2 -> V_407 . V_416 . V_466 ;
int V_152 ;
V_152 = F_151 ( V_2 ) ;
if ( V_152 ) {
F_128 ( L_9 ) ;
...
if ( V_20 -> V_446 )
F_35 ( V_2 , V_463 , V_465 ) ;
F_152 ( V_2 , V_463 , V_465 ) ;
V_152 = F_153 ( V_2 ) ;
if ( V_152 ) {
F_128 ( L_10 ) ;
return V_152 ;
}
V_152 = F_64 ( V_2 , V_463 ) ;
if ( V_152 ) {
F_128 ( L_11 ) ;
return V_152 ;
}
if ( V_20 -> V_250 ) {
V_152 = F_67 ( V_2 , V_463 ) ;
if ( V_152 ) {
F_128 ( L_12 ) ;
return V_152 ;
}
...
F_156 ( V_2 , V_463 , V_465 ) ;
if ( V_20 -> V_446 )
F_34 ( V_2 , V_463 , V_465 ) ;
return 0 ;
}
...
struct V_148 V_149 ;
int V_152 ;
V_20 = F_161 ( sizeof( struct V_19 ) , V_467 ) ;
if ( V_20 == NULL )
return - V_468 ;
V_2 -> V_407 . V_416 . V_469 = V_20 ;
V_5 = & V_20 -> V_470 ;
F_120 ( V_2 ) ;
V_20 -> V_471 . V_472 = false ;
V_5 -> V_356 = 0 ;
V_20 -> V_359 = 0 ;
V_5 -> V_358 = 0 ;
V_5 -> V_396 = 0 ;
...
if ( V_152 )
return V_152 ;
if ( V_2 -> V_407 . V_416 . V_473 == 0 )
V_2 -> V_407 . V_416 . V_473 = V_474 ;
if ( V_2 -> V_407 . V_416 . V_475 == 0 )
V_2 -> V_407 . V_416 . V_475 = V_476 ;
V_152 = F_42 ( V_2 , V_477 ,
0 , false , & V_149 ) ;
if ( V_152 )
...
{
int V_120 ;
for ( V_120 = 0 ; V_120 < V_2 -> V_407 . V_416 . V_503 ; V_120 ++ ) {
F_167 ( V_2 -> V_407 . V_416 . V_504 [ V_120 ] . V_505 ) ;
}
F_167 ( V_2 -> V_407 . V_416 . V_504 ) ;
F_167 ( V_2 -> V_407 . V_416 . V_469 ) ;
}
bool F_168 ( struct V_1 * V_2 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
T_1 V_506 = F_169 ( V_2 ) ;
T_1 V_507 = V_5 -> V_127 ? 450 : 0 ;
if ( V_506 < V_507 )
return true ;
else
return false ;
