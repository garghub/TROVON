...
static struct V_1 *
F_27 ( struct V_7 * V_8 , T_1 V_13 , T_3 V_38 ,
struct V_1 * V_2 )
{
const struct V_39 * V_40 = F_28 ( V_8 ) ;
struct V_41 V_42 , * V_43 ;
V_43 = F_29 ( V_8 , F_30 ( V_8 ) , sizeof( V_42 ) , & V_42 ) ;
if ( V_43 == NULL ) {
F_5 ( F_4 ( V_2 ) ) ;
return NULL ;
}
...
struct V_1 * V_48 ;
V_48 = F_12 ( F_31 ( V_8 -> V_14 ) , V_40 -> V_18 ,
...
static void
F_33 ( struct V_7 * V_8 , struct V_1 * V_2 )
{
F_34 ( V_8 ) ;
V_8 -> V_2 = V_2 ;
V_8 -> V_52 = V_53 ;
...
static unsigned int
F_35 ( struct V_7 * V_8 , T_1 V_13 , T_3 V_38 ,
T_4 V_54 , T_4 V_55 )
{
const struct V_39 * V_40 = F_28 ( V_8 ) ;
...
if ( V_43 == NULL )
return V_57 ;
V_2 = F_12 ( F_31 ( V_8 -> V_14 ) , V_40 -> V_18 ,
V_40 -> V_19 , V_40 -> V_10 ,
V_43 -> V_49 , V_43 -> V_50 ,
V_8 -> V_14 , V_30 ) ;
...
return F_35 ( V_8 , V_63 -> V_13 , V_63 -> V_38 , V_63 -> V_54 , V_63 -> V_55 ) ;
}
static unsigned int
F_37 ( struct V_7 * V_8 , const struct V_60 * V_61 )
{
const struct V_65 * V_63 = V_61 -> V_64 ;
return F_35 ( V_8 , V_63 -> V_13 . V_66 , V_63 -> V_38 , V_63 -> V_54 , V_63 -> V_55 ) ;
}
static inline const struct V_36 *
F_38 ( struct V_7 * V_8 , const struct V_36 * V_9 ,
...
V_12 = F_39 ( V_8 -> V_14 ) ;
if ( V_12 )
F_40 (ifa, &indev->addr_list, if_list) {
...
static struct V_1 *
F_41 ( struct V_7 * V_8 , int V_73 , int V_74 ,
const struct V_60 * V_61 ,
struct V_1 * V_2 )
{
const struct V_75 * V_40 = F_42 ( V_8 ) ;
struct V_41 V_42 , * V_43 ;
const struct V_65 * V_63 = V_61 -> V_64 ;
V_43 = F_29 ( V_8 , V_74 , sizeof( V_42 ) , & V_42 ) ;
if ( V_43 == NULL ) {
F_5 ( F_4 ( V_2 ) ) ;
return NULL ;
}
if ( V_43 -> V_44 && ! V_43 -> V_45 && ! V_43 -> V_46 && ! V_43 -> V_47 ) {
struct V_1 * V_48 ;
V_48 = F_21 ( F_31 ( V_8 -> V_14 ) , V_73 ,
& V_40 -> V_19 ,
F_38 ( V_8 , & V_63 -> V_13 . V_76 , & V_40 -> V_10 ) ,
V_43 -> V_49 ,
...
static unsigned int
F_43 ( struct V_7 * V_8 , const struct V_60 * V_61 )
{
const struct V_75 * V_40 = F_42 ( V_8 ) ;
const struct V_65 * V_63 = V_61 -> V_64 ;
struct V_56 V_42 , * V_43 ;
...
int V_74 = 0 ;
int V_73 ;
V_73 = F_44 ( V_8 , & V_74 , - 1 , NULL , NULL ) ;
if ( V_73 < 0 ) {
F_18 ( L_5 ) ;
return V_57 ;
}
...
V_2 = F_21 ( F_31 ( V_8 -> V_14 ) , V_73 ,
& V_40 -> V_19 , & V_40 -> V_10 ,
V_43 -> V_49 , V_43 -> V_50 ,
V_61 -> V_23 , V_30 ) ;
V_13 = F_38 ( V_8 , & V_63 -> V_13 . V_76 , & V_40 -> V_10 ) ;
V_38 = V_63 -> V_38 ? V_63 -> V_38 : V_43 -> V_50 ;
if ( V_2 && V_2 -> V_3 == V_4 )
V_2 = F_41 ( V_8 , V_73 , V_74 , V_61 , V_2 ) ;
else if ( ! V_2 )
V_2 = F_21 ( F_31 ( V_8 -> V_14 ) , V_73 ,
& V_40 -> V_19 , V_13 ,
V_43 -> V_49 , V_38 ,
...
static int F_45 ( const struct V_77 * V_61 )
{
...
static int F_47 ( const struct V_77 * V_61 )
{
const struct V_84 * V_79 = V_61 -> V_80 ;
if ( ( V_79 -> V_81 == V_26 || V_79 -> V_81 == V_31 )
&& ! ( V_79 -> V_85 & V_86 ) )
return 0 ;
F_46 ( L_9
