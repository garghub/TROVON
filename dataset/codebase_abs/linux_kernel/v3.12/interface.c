...
V_11 = F_2 ( V_3 , struct V_10 , V_11 ) ;
F_18 ( V_11 , & V_41 ) ;
F_48 ( & V_11 -> V_56 -> V_57 -> V_58 ) ;
V_42 = F_49 ( V_11 -> V_56 -> V_57 ) ;
F_50 ( & V_11 -> V_56 -> V_57 -> V_58 ) ;
F_20 ( V_11 , V_41 ) ;
if ( V_42 == - V_59 )
F_51 ( V_11 ,
L_16
...
static bool F_52 ( struct V_60 * V_61 )
{
struct V_8 * V_9 ;
struct V_10 * V_11 ;
const struct V_40 * V_41 ;
int V_42 ;
F_3 ( L_4 , V_61 -> V_9 -> V_43 ) ;
V_9 = F_2 ( V_61 -> V_9 , struct V_8 , V_27 ) ;
V_11 = F_2 ( V_9 -> V_27 . V_11 ,
struct V_10 , V_11 ) ;
F_18 ( V_11 , & V_41 ) ;
V_42 = F_53 ( V_9 ) ;
...
T_2 V_65 ;
int V_42 ;
V_38 -> V_5 -> V_28 -> V_66 ( V_38 -> V_5 -> V_31 , & V_64 ) ;
F_3 ( L_19 ,
V_38 -> V_43 , ( unsigned long long ) V_64 ) ;
V_9 = F_2 ( V_38 , struct V_8 , V_27 ) ;
V_11 = F_2 ( V_9 -> V_27 . V_11 ,
struct V_10 , V_11 ) ;
if ( V_64 == V_9 -> V_67 )
...
if ( ! V_9 -> V_23 )
return - V_46 ;
ASSERT ( F_54 ( V_9 -> V_23 -> V_68 -> V_69 ) ) ;
F_55 ( & V_9 -> V_27 , V_64 ) ;
V_65 = F_56 ( V_9 -> V_23 -> V_68 ) ;
if ( V_65 == V_64 )
return 0 ;
F_18 ( V_11 , & V_41 ) ;
F_57 ( & V_9 -> V_23 -> V_68 -> V_70 ) ;
if ( V_65 & ~ V_71 && V_64 > V_65 ) {
F_34 ( L_20 , V_65 ) ;
V_63 . V_72 = V_73 ;
V_63 . V_74 = V_65 & V_71 ;
V_42 = F_58 ( V_9 -> V_23 , & V_63 ) ;
if ( V_42 < 0 )
goto V_75;
}
V_63 . V_72 = V_73 ;
...
V_11 = F_2 ( V_9 -> V_27 . V_11 ,
struct V_10 , V_11 ) ;
V_61 -> V_9 -> V_5 -> V_28 -> V_66 ( V_61 -> V_9 -> V_5 -> V_31 ,
& V_64 ) ;
F_3 ( L_19 ,
V_61 -> V_9 -> V_43 , ( unsigned long long ) V_64 ) ;
if ( V_9 -> V_23 ) {
ASSERT ( F_54 ( V_9 -> V_23 -> V_68 -> V_69 ) ) ;
F_55 ( & V_9 -> V_27 , V_64 ) ;
V_76 . V_50 = V_9 -> V_23 ;
