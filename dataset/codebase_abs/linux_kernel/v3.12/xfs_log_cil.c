...
if ( V_42 -> V_71 -> V_9 < 0 )
F_48 ( V_80 , V_42 -> V_71 ) ;
V_42 -> V_132 = V_58 -> V_11 -> V_13 ;
if ( V_14 )
* V_14 = V_42 -> V_132 ;
F_33 ( V_80 , V_42 -> V_71 , NULL , V_129 ) ;
F_49 ( V_42 ) ;
F_50 ( V_42 , V_42 -> V_132 , 0 ) ;
F_41 ( log ) ;
F_51 ( & V_58 -> V_99 ) ;
return 0 ;
}
...
if ( F_9 ( & V_18 -> V_64 ) )
return false ;
V_60 = V_18 -> V_134 -> V_128 -> V_10 -> V_11 ;
if ( F_54 ( V_18 -> V_40 , V_60 -> V_13 ) != 0 )
return false ;
return true ;
}
int
...
struct V_57 * V_58 ;
struct V_59 * V_60 ;
V_58 = F_11 ( sizeof( * V_58 ) , V_5 | V_135 ) ;
if ( ! V_58 )
return V_136 ;
V_60 = F_11 ( sizeof( * V_60 ) , V_5 | V_135 ) ;
if ( ! V_60 ) {
F_7 ( V_58 ) ;
return V_136 ;
}
F_56 ( & V_58 -> V_125 , F_39 ) ;
F_28 ( & V_58 -> V_65 ) ;
F_28 ( & V_58 -> V_104 ) ;
F_57 ( & V_58 -> V_63 ) ;
F_57 ( & V_58 -> V_88 ) ;
