...
V_71 = V_58 ;
V_72 = V_74 = F_56 ( ( unsigned int ) V_77 , V_73 ) ;
}
...
F_61 ( V_107 , V_116 ,
F_36 ( V_117 ) ) ;
F_61 ( V_118 , 0x10000 | V_104 ,
F_36 ( V_105 |
V_106 ) ) ;
F_61 ( V_118 , 0x10000 | 0x40 , 0 ) ;
F_61 ( V_119 , 0x10000 | V_108 ,
F_36 ( V_53 ) ) ;
F_61 ( V_95 , V_120 , 0 ) ;
F_61 ( V_95 , V_121 ,
F_36 ( V_122 ) ) ;
F_61 ( V_51 , & V_93 -> V_123 , 0 ) ;
F_62 ( V_51 , & V_93 -> V_124 ) ;
V_48 &= F_36 ( ~ V_125 ) ;
V_48 &= F_36 ( ~ V_126 ) ;
V_48 &= F_36 ( ~ V_127 ) ;
F_61 ( V_51 , & V_93 -> V_124 , V_48 ) ;
F_63 ( 20 ) ;
V_48 |= F_36 ( V_125 ) ;
F_61 ( V_51 , & V_93 -> V_124 , V_48 ) ;
F_63 ( 20 ) ;
...
F_61 ( V_51 , & V_93 -> V_124 , V_48 ) ;
F_63 ( 100 ) ;
F_62 ( V_51 , & V_93 -> V_128 ) ;
F_61 ( V_51 , & V_93 -> V_129 , V_48 ) ;
V_73 = V_11 -> V_78 -> V_79 ;
V_32 = V_11 -> V_78 -> V_32 ;
V_94 = V_85 ;
while ( V_73 ) {
unsigned int V_130 = F_56 ( V_73 , ( unsigned int ) 512 ) ;
...
F_36 ( V_94 ) ) ;
F_61 ( V_51 , & V_93 -> V_134 ,
F_36 ( V_135 ) ) ;
F_61 ( V_51 , & V_93 -> V_136 ,
F_36 ( V_130 >> 2 ) ) ;
F_61 ( V_51 , & V_93 -> V_137 ,
F_36 ( V_138 ) ) ;
F_63 ( 10 ) ;
F_62 ( V_51 ,
...
static void F_70 ( const struct V_158 * V_158 ,
void * V_4 )
{
...
struct V_164 * V_66 )
{
struct V_159 * V_30 = F_77 ( V_66 ) ;
struct V_10 * V_11 = V_9 -> V_11 ;
struct V_162 * V_162 = & V_30 -> V_9 ;
int V_29 , V_149 ;
F_78 ( F_79 ( V_151 ) != V_150 ) ;
F_80 ( & V_11 -> V_160 ) ;
V_149 = F_65 ( V_11 ) ;
if ( V_149 < 0 )
return V_149 ;
F_81 ( & V_11 -> V_30 -> V_9 , L_23 ,
V_151 [ V_149 ] . V_78 ) ;
F_82 ( V_30 ) ;
V_29 = F_83 ( V_165 , 1 , V_151 [ V_149 ] . V_78 ,
V_162 , V_27 , V_11 ,
F_70 ) ;
if ( V_29 ) {
...
static int F_84 ( struct V_164 * V_66 ,
...
static void F_91 ( struct V_164 * V_66 )
{
...
static int F_96 ( struct V_164 * V_66 )
{
struct V_8 * V_9 = F_18 ( V_66 ) ;
if ( ! V_9 )
return - V_155 ;
...
static int F_100 ( struct V_164 * V_66 , T_5 V_186 )
{
return F_96 ( V_66 ) ;
}
