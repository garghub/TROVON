...
free -> V_21 . V_10 == F_7 ( V_25 ) ) ;
#endif
F_31 ( V_41 , V_4 , 0 , F_34 ( V_41 -> V_66 ) - 1 ) ;
}
int
F_35 (
T_6 * args ,
...
V_2 = V_43 -> V_59 ;
V_41 = args -> V_76 ;
if ( ( error = F_37 ( args , V_77 , & V_70 ) ) ) {
return error ;
}
ASSERT ( V_70 == F_38 ( V_2 ) ) ;
...
F_32 ( V_41 , V_69 ) ;
if ( V_6 -> V_21 . V_14 . V_10 == F_42 ( V_83 ) )
V_6 -> V_21 . V_14 . V_10 = F_42 ( V_17 ) ;
else
V_6 -> V_21 . V_14 . V_10 = F_42 ( V_11 ) ;
V_68 -> V_60 = & V_84 ;
F_19 ( V_41 , V_68 , V_85 ) ;
F_43 ( V_41 , V_68 ) ;
F_44 ( V_2 , V_68 ) ;
...
return 0 ;
if ( V_87 )
F_50 ( & V_9 , V_94 , & V_86 , & V_92 ,
& V_88 , & V_91 , & V_90 ) ;
else if ( V_9 . V_96 ) {
V_91 = V_9 . V_95 ;
V_90 = - 1 ;
}
V_89 = F_51 ( & V_9 , V_94 , V_86 , V_87 , V_92 ,
V_88 , & V_91 , & V_90 ) ;
V_89 -> V_98 = F_7 ( args -> V_98 ) ;
V_89 -> V_101 = F_7 ( F_52 ( V_2 ,
args -> V_15 , args -> V_86 ) ) ;
F_53 ( V_6 , & V_9 ) ;
F_43 ( V_41 , V_4 ) ;
F_54 ( V_41 , V_4 , V_91 , V_90 ) ;
F_44 ( V_2 , V_4 ) ;
return 0 ;
}
static void
...
V_109 = F_60 ( V_2 , args -> V_114 ) ;
for ( V_89 = & V_94 [ V_86 ] ;
V_86 < V_9 . V_95 && F_23 ( V_89 -> V_98 ) == args -> V_98 ;
V_89 ++ , V_86 ++ ) {
if ( F_23 ( V_89 -> V_101 ) == V_115 )
continue;
V_110 = F_61 ( V_2 , F_23 ( V_89 -> V_101 ) ) ;
if ( V_110 != V_106 ) {
T_5 * V_65 ;
V_106 = V_110 ;
V_111 = F_62 ( V_2 , V_110 ) ;
if ( V_111 != V_107 ) {
if ( V_105 )
F_63 ( V_41 , V_105 ) ;
...
return error ;
free = V_105 -> V_7 ;
F_55 ( V_2 , V_105 , V_106 ) ;
}
V_108 = F_64 ( V_2 , V_106 ) ;
V_65 = F_30 ( V_2 , free ) ;
if ( F_65 ( V_65 [ V_108 ] == F_42 ( V_82 ) ) ) {
F_66 ( L_1 ,
V_32 , V_2 ) ;
if ( V_107 != V_111 )
F_63 ( V_41 , V_105 ) ;
...
( char * ) V_105 -> V_7 ) ;
V_104 -> V_113 . V_10 = V_129 ;
V_105 -> V_60 = & V_130 ;
F_19 ( V_41 , V_105 , V_131 ) ;
if ( V_121 == V_132 )
return F_48 ( V_133 ) ;
}
}
...
{
if ( args -> V_99 & V_134 )
return F_58 ( V_4 , args , V_103 ,
V_104 ) ;
return F_67 ( V_4 , args , V_103 , V_104 ) ;
}
static void
F_73 (
T_6 * args ,
...
int V_96 ;
F_74 ( args , V_138 , V_142 , V_95 ) ;
if ( V_95 == 0 )
return;
if ( V_142 < V_140 -> V_95 ) {
memmove ( & V_141 [ V_142 + V_95 ] , & V_141 [ V_142 ] ,
( V_140 -> V_95 - V_142 ) * sizeof( T_13 ) ) ;
F_54 ( V_41 , V_139 , V_142 + V_95 ,
V_95 + V_140 -> V_95 - 1 ) ;
}
if ( V_136 -> V_96 ) {
int V_71 ;
for ( V_71 = V_138 , V_96 = 0 ; V_71 < V_138 + V_95 ; V_71 ++ ) {
if ( V_137 [ V_71 ] . V_101 ==
F_7 ( V_115 ) )
V_96 ++ ;
}
...
V_96 = 0 ;
memcpy ( & V_141 [ V_142 ] , & V_137 [ V_138 ] ,
V_95 * sizeof( T_13 ) ) ;
F_54 ( V_41 , V_139 , V_142 , V_142 + V_95 - 1 ) ;
if ( V_138 + V_95 < V_136 -> V_95 ) {
memmove ( & V_137 [ V_138 ] , & V_137 [ V_138 + V_95 ] ,
V_95 * sizeof( T_13 ) ) ;
F_54 ( V_41 , V_135 , V_138 , V_138 + V_95 - 1 ) ;
}
V_136 -> V_95 -= V_95 ;
V_136 -> V_96 -= V_96 ;
V_140 -> V_95 += V_95 ;
...
V_147 = F_47 ( V_145 ) ;
V_148 = F_47 ( V_146 ) ;
if ( V_149 . V_95 > 0 && V_150 . V_95 > 0 &&
( F_23 ( V_148 [ 0 ] . V_98 ) < F_23 ( V_147 [ 0 ] . V_98 ) ||
F_23 ( V_148 [ V_150 . V_95 - 1 ] . V_98 ) <
...
struct V_8 V_150 ;
args = V_104 -> args ;
if ( ( V_158 = F_75 ( V_151 -> V_4 , V_152 -> V_4 ) ) ) {
T_17 * V_159 ;
V_159 = V_151 ;
V_151 = V_152 ;
V_152 = V_159 ;
...
V_147 = F_47 ( V_145 ) ;
V_148 = F_47 ( V_146 ) ;
V_157 = V_149 . V_95 + V_150 . V_95 ;
#if F_77 ( F_33 ) || F_77 ( V_155 )
V_156 = V_149 . V_96 + V_150 . V_96 ;
#endif
V_154 = V_157 >> 1 ;
if ( V_157 & 1 ) {
T_14 V_160 ;
if ( V_154 >= V_149 . V_95 )
V_160 = F_23 ( V_148 [ V_154 - V_149 . V_95 ] . V_98 ) ;
else
V_160 = F_23 ( V_147 [ V_154 ] . V_98 ) ;
V_153 = args -> V_98 <= V_160 ;
}
else
V_153 = 1 ;
V_95 = V_149 . V_95 - V_154 + ( V_153 == 0 ) ;
if ( V_95 > 0 )
F_73 ( args , V_151 -> V_4 , & V_149 , V_147 ,
V_149 . V_95 - V_95 , V_152 -> V_4 ,
& V_150 , V_148 , 0 , V_95 ) ;
else if ( V_95 < 0 )
F_73 ( args , V_152 -> V_4 , & V_150 , V_148 , 0 ,
V_151 -> V_4 , & V_149 , V_147 ,
V_149 . V_95 , V_95 ) ;
ASSERT ( V_149 . V_95 + V_150 . V_95 == V_157 ) ;
ASSERT ( V_149 . V_96 + V_150 . V_96 == V_156 ) ;
F_53 ( V_145 , & V_149 ) ;
F_53 ( V_146 , & V_150 ) ;
F_43 ( args -> V_76 , V_151 -> V_4 ) ;
F_43 ( args -> V_76 , V_152 -> V_4 ) ;
F_44 ( args -> V_43 -> V_59 , V_151 -> V_4 ) ;
F_44 ( args -> V_43 -> V_59 , V_152 -> V_4 ) ;
if ( V_149 . V_95 < V_150 . V_95 )
V_104 -> V_161 = V_158 ;
else if ( V_149 . V_95 > V_150 . V_95 )
V_104 -> V_161 = ! V_158 ;
else
V_104 -> V_161 = V_158 ^ ( V_151 -> V_86 <= V_149 . V_95 ) ;
if ( ! V_104 -> V_161 )
V_152 -> V_86 = V_151 -> V_86 - V_149 . V_95 ;
if( V_152 -> V_86 < 0 ) {
V_104 -> V_161 = 1 ;
V_152 -> V_86 = 0 ;
F_78 ( args -> V_43 -> V_59 ,
...
if ( V_65 [ V_71 ] != F_42 ( V_82 ) )
break;
}
V_75 . V_56 = V_71 + 1 ;
V_165 = 0 ;
} else {
V_65 [ V_163 ] = F_42 ( V_82 ) ;
V_165 = 1 ;
}
F_24 ( free , & V_75 ) ;
F_32 ( V_41 , V_69 ) ;
...
V_94 = F_47 ( V_6 ) ;
V_89 = & V_94 [ V_86 ] ;
V_102 = F_61 ( V_2 , F_23 ( V_89 -> V_101 ) ) ;
ASSERT ( V_167 -> V_15 == V_102 ) ;
V_74 = F_70 ( V_2 , F_23 ( V_89 -> V_101 ) ) ;
ASSERT ( V_167 -> V_86 == V_74 ) ;
V_9 . V_96 ++ ;
F_53 ( V_6 , & V_9 ) ;
F_43 ( V_41 , V_4 ) ;
V_89 -> V_101 = F_7 ( V_115 ) ;
F_54 ( V_41 , V_4 , V_86 , V_86 ) ;
V_169 = V_167 -> V_4 ;
V_21 = V_169 -> V_7 ;
V_119 = ( T_16 * ) ( ( char * ) V_21 + V_74 ) ;
V_173 = F_83 ( V_21 ) ;
V_164 = F_41 ( V_173 [ 0 ] . V_109 ) ;
V_170 = V_171 = 0 ;
F_84 ( V_41 , V_169 , V_74 ,
F_60 ( V_2 , V_119 -> V_114 ) , & V_170 , & V_171 ) ;
if ( V_171 )
F_85 ( V_2 , V_21 , & V_170 ) ;
if ( V_170 )
F_86 ( V_41 , V_169 ) ;
F_69 ( V_43 , V_169 ) ;
if ( V_164 < F_41 ( V_173 [ 0 ] . V_109 ) ) {
int error ;
struct V_3 * V_69 ;
T_3 V_70 ;
int V_163 ;
...
struct V_51 V_75 ;
F_22 ( & V_75 , free ) ;
ASSERT ( V_75 . V_55 == F_56 ( V_2 ) *
( V_70 - F_38 ( V_2 ) ) ) ;
}
#endif
V_163 = F_64 ( V_2 , V_102 ) ;
V_164 = F_41 ( V_173 [ 0 ] . V_109 ) ;
if ( V_164 == V_2 -> V_81 -
F_87 ( V_21 ) ) {
error = F_80 ( args , V_102 , V_169 ) ;
if ( error == 0 ) {
V_167 -> V_4 = NULL ;
V_21 = NULL ;
}
...
error = F_90 ( args , & V_15 ) ;
if ( error ) {
return error ;
}
error = F_91 ( args , F_92 ( V_2 , V_15 ) ,
& V_176 -> V_4 , V_17 ) ;
if ( error )
return error ;
V_176 -> V_15 = V_15 ;
V_176 -> V_10 = V_17 ;
F_76 ( V_104 , V_175 , V_176 ) ;
error = F_93 ( V_104 , V_175 , V_176 ) ;
if ( error ) {
return error ;
}
if ( V_104 -> V_161 )
error = F_45 ( V_175 -> V_4 , args , V_175 -> V_86 ) ;
else
error = F_45 ( V_176 -> V_4 , args , V_176 -> V_86 ) ;
V_175 -> V_98 = F_57 ( V_175 -> V_4 , NULL ) ;
V_176 -> V_98 = F_57 ( V_176 -> V_4 , NULL ) ;
F_44 ( V_2 , V_175 -> V_4 ) ;
F_44 ( V_2 , V_176 -> V_4 ) ;
return error ;
}
...
F_2 ( & V_9 , V_6 ) ;
V_94 = F_47 ( V_6 ) ;
F_44 ( V_104 -> args -> V_43 -> V_59 , V_178 -> V_4 ) ;
V_95 = V_9 . V_95 - V_9 . V_96 ;
V_179 = F_88 ( V_6 ) + V_95 * sizeof( V_94 [ 0 ] ) ;
...
error = F_95 ( V_104 , & V_104 -> V_185 , V_180 , 0 ,
& V_168 ) ;
if ( error )
return error ;
* V_177 = V_168 ? 2 : 0 ;
...
if ( V_15 == 0 )
continue;
error = F_96 ( V_104 -> args -> V_76 , V_104 -> args -> V_43 ,
V_15 , - 1 , & V_4 ) ;
if ( error )
return error ;
V_95 = V_9 . V_95 - V_9 . V_96 ;
...
F_2 ( & V_150 , V_6 ) ;
V_94 = F_47 ( V_6 ) ;
V_95 += V_150 . V_95 - V_150 . V_96 ;
V_179 -= V_95 * sizeof( V_94 [ 0 ] ) ;
if ( V_179 >= 0 )
break;
F_63 ( V_104 -> args -> V_76 , V_4 ) ;
}
if ( V_71 >= 2 ) {
* V_177 = 0 ;
return 0 ;
...
error = F_95 ( V_104 , & V_104 -> V_181 , V_180 , 0 ,
& V_168 ) ;
if ( error ) {
return error ;
}
...
V_141 = F_47 ( V_189 ) ;
if ( V_192 . V_96 )
F_98 ( args , & V_192 , V_187 -> V_4 ) ;
if ( V_191 . V_96 )
F_98 ( args , & V_191 , V_188 -> V_4 ) ;
V_187 -> V_98 = F_23 ( V_141 [ V_192 . V_95 - 1 ] . V_98 ) ;
if ( F_75 ( V_188 -> V_4 , V_187 -> V_4 ) )
F_73 ( args , V_187 -> V_4 , & V_192 , V_141 , 0 ,
V_188 -> V_4 , & V_191 , V_137 , 0 ,
V_192 . V_95 ) ;
else
F_73 ( args , V_187 -> V_4 , & V_192 , V_141 , 0 ,
V_188 -> V_4 , & V_191 , V_137 ,
V_191 . V_95 , V_192 . V_95 ) ;
V_188 -> V_98 = F_23 ( V_137 [ V_191 . V_95 - 1 ] . V_98 ) ;
F_53 ( V_190 , & V_191 ) ;
F_53 ( V_189 , & V_192 ) ;
F_43 ( args -> V_76 , V_188 -> V_4 ) ;
F_43 ( args -> V_76 , V_187 -> V_4 ) ;
F_44 ( args -> V_43 -> V_59 , V_188 -> V_4 ) ;
F_44 ( args -> V_43 -> V_59 , V_187 -> V_4 ) ;
}
int
F_99 (
T_6 * args )
...
V_168 = F_45 ( V_178 -> V_4 , args , V_178 -> V_86 ) ;
if ( V_168 == 0 ) {
if ( ! ( args -> V_99 & V_100 ) )
F_104 ( V_104 , & V_104 -> V_181 ) ;
} else {
if ( args -> V_166 == 0 ) {
ASSERT ( V_168 == V_97 ) ;
goto V_195;
...
ASSERT ( F_41 ( V_65 [ V_163 ] ) != V_82 ) ;
ASSERT ( F_41 ( V_65 [ V_163 ] ) >= V_109 ) ;
...
if ( V_197 == - 1 ) {
T_20 V_202 ;
if ( ( error = F_107 ( V_41 , V_43 , & V_202 , V_48 ) ) )
return error ;
V_200 = F_92 ( V_2 , ( T_1 ) V_202 ) ;
V_44 = V_199 ;
}
while ( V_197 == - 1 ) {
if ( V_69 == NULL ) {
...
V_65 = F_30 ( V_2 , free ) ;
F_22 ( & V_75 , free ) ;
if ( F_41 ( V_65 [ V_163 ] ) != V_82 &&
F_41 ( V_65 [ V_163 ] ) >= V_109 )
V_197 = V_75 . V_55 + V_163 ;
else {
if ( ++ V_163 == V_75 . V_56 ) {
F_63 ( V_41 , V_69 ) ;
...
return F_48 ( V_97 ) ;
if ( F_65 ( ( error = F_37 ( args ,
V_203 ,
& V_197 ) ) ||
( error = F_108 ( args , V_197 , & V_169 ) ) ) )
return error ;
if ( V_69 )
F_63 ( V_41 , V_69 ) ;
if ( V_196 && V_196 -> V_4 )
...
return error ;
if ( ! V_69 ) {
error = F_37 ( args , V_77 ,
& V_44 ) ;
if ( error )
return error ;
if ( F_65 ( F_62 ( V_2 , V_197 ) != V_44 ) ) {
F_78 ( V_2 ,
L_3
L_4 ,
V_31 , ( unsigned long long ) V_43 -> V_62 ,
( long long ) F_62 ( V_2 , V_197 ) ,
...
V_163 = F_64 ( V_2 , V_197 ) ;
if ( V_163 >= V_75 . V_56 ) {
ASSERT ( V_163 < F_56 ( V_2 ) ) ;
V_75 . V_56 = V_163 + 1 ;
V_65 [ V_163 ] = F_42 ( V_82 ) ;
}
if ( V_65 [ V_163 ] == F_42 ( V_82 ) ) {
V_75 . V_57 ++ ;
F_24 ( V_69 -> V_7 , & V_75 ) ;
F_32 ( V_41 , V_69 ) ;
}
...
if ( args -> V_99 & V_100 )
return 0 ;
error = F_68 ( V_41 , V_43 , F_27 ( V_2 , V_197 ) ,
- 1 , & V_169 ) ;
if ( error )
return error ;
V_21 = V_169 -> V_7 ;
...
ASSERT ( F_41 ( V_173 [ 0 ] . V_109 ) >= V_109 ) ;
V_198 = ( T_19 * )
( ( char * ) V_21 + F_41 ( V_173 [ 0 ] . V_204 ) ) ;
V_171 = V_170 = 0 ;
F_109 ( V_41 , V_169 , V_198 ,
...
F_110 ( V_2 , V_119 , args -> V_128 ) ;
V_201 = F_111 ( V_2 , V_119 ) ;
* V_201 = F_42 ( ( char * ) V_119 - ( char * ) V_21 ) ;
F_112 ( V_41 , V_169 , V_119 ) ;
if ( V_171 )
F_85 ( V_2 , V_21 , & V_170 ) ;
if ( V_170 )
F_86 ( V_41 , V_169 ) ;
V_65 = F_30 ( V_2 , free ) ;
if ( F_41 ( V_65 [ V_163 ] ) != F_41 ( V_173 [ 0 ] . V_109 ) ) {
V_65 [ V_163 ] = V_173 [ 0 ] . V_109 ;
V_165 = 1 ;
}
if ( V_165 )
...
V_104 -> V_113 . V_86 ) ;
V_168 = F_115 ( args , V_119 -> V_126 , V_119 -> V_114 ) ;
}
for ( V_71 = 0 ; V_71 < V_104 -> V_181 . V_182 ; V_71 ++ ) {
F_63 ( args -> V_76 , V_104 -> V_181 . V_178 [ V_71 ] . V_4 ) ;
V_104 -> V_181 . V_178 [ V_71 ] . V_4 = NULL ;
}
if ( V_104 -> V_112 && V_104 -> V_113 . V_4 ) {
F_63 ( args -> V_76 , V_104 -> V_113 . V_4 ) ;
...
ASSERT ( V_178 -> V_10 == V_17 ) ;
ASSERT ( V_104 -> V_112 ) ;
error = F_81 ( args , V_178 -> V_4 , V_178 -> V_86 ,
& V_104 -> V_113 , & V_168 ) ;
if ( error )
return error ;
F_104 ( V_104 , & V_104 -> V_181 ) ;
...
ASSERT ( V_21 -> V_10 == F_7 ( V_129 ) ||
V_21 -> V_10 == F_7 ( V_208 ) ) ;
V_119 = ( T_16 * )
( ( char * ) V_21 +
F_70 ( V_104 -> V_2 , F_23 ( V_89 -> V_101 ) ) ) ;
ASSERT ( V_207 != F_3 ( V_119 -> V_127 ) ) ;
V_119 -> V_127 = F_15 ( V_207 ) ;
F_110 ( V_104 -> V_2 , V_119 , args -> V_128 ) ;
F_112 ( args -> V_76 , V_104 -> V_113 . V_4 , V_119 ) ;
V_168 = 0 ;
}
else if ( V_104 -> V_112 ) {
F_63 ( args -> V_76 , V_104 -> V_113 . V_4 ) ;
