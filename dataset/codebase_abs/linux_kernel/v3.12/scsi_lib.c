...
struct V_14 * F_144 ( struct V_8 * V_60 ,
T_3 * V_206 )
{
struct V_14 * V_15 ;
struct V_10 * V_207 = V_60 -> V_208 ;
V_15 = F_145 ( V_206 , NULL ) ;
if ( ! V_15 )
return NULL ;
F_146 ( V_15 , F_147 (unsigned short, shost->sg_tablesize,
SCSI_MAX_SG_CHAIN_SEGMENTS) ) ;
if ( F_148 ( V_60 ) ) {
V_60 -> V_209 =
F_149 ( V_60 -> V_209 ,
( unsigned short ) V_210 ) ;
F_64 ( V_60 -> V_209 < V_60 -> V_211 ) ;
F_150 ( V_15 , V_60 -> V_209 ) ;
}
F_151 ( V_15 , V_60 -> V_212 ) ;
F_152 ( V_15 , F_142 ( V_60 ) ) ;
F_153 ( V_15 , V_60 -> V_213 ) ;
F_154 ( V_207 , V_60 -> V_213 ) ;
F_155 ( V_15 , F_156 ( V_207 ) ) ;
if ( ! V_60 -> V_214 )
V_15 -> V_215 . V_216 = 0 ;
F_157 ( V_15 , 0x03 ) ;
return V_15 ;
}
struct V_14 * F_158 ( struct V_11 * V_29 )
{
struct V_14 * V_15 ;
V_15 = F_144 ( V_29 -> V_9 , F_131 ) ;
if ( ! V_15 )
return NULL ;
F_159 ( V_15 , F_112 ) ;
F_160 ( V_15 , F_124 ) ;
...
struct V_89 * V_90 = V_91 + V_218 ;
int V_221 = V_90 -> V_221 * sizeof( struct V_87 ) ;
V_90 -> V_222 = F_166 ( V_90 -> V_223 , V_221 , 0 ,
V_224 , NULL ) ;
if ( ! V_90 -> V_222 ) {
F_6 ( V_172 L_28 ,
V_90 -> V_223 ) ;
...
int
F_171 ( struct V_11 * V_29 , int V_227 , int V_228 , int V_229 ,
unsigned char * V_31 , int V_123 , int V_34 , int V_35 ,
struct V_230 * V_231 , struct V_52 * V_53 )
{
unsigned char V_4 [ 10 ] ;
unsigned char * V_232 ;
int V_39 ;
memset ( V_4 , 0 , sizeof( V_4 ) ) ;
V_4 [ 1 ] = ( V_227 ? 0x10 : 0 ) | ( V_228 ? 0x01 : 0 ) ;
if ( V_29 -> V_233 ) {
if ( V_123 > 65535 )
return - V_234 ;
V_232 = F_172 ( 8 + V_123 , V_235 ) ;
if ( ! V_232 )
return - V_219 ;
memcpy ( V_232 + 8 , V_31 , V_123 ) ;
V_123 += 8 ;
V_232 [ 0 ] = 0 ;
V_232 [ 1 ] = 0 ;
V_232 [ 2 ] = V_231 -> V_236 ;
...
if ( V_123 > 255 || V_231 -> V_239 > 255 ||
V_231 -> V_238 )
return - V_234 ;
V_232 = F_172 ( 4 + V_123 , V_235 ) ;
if ( ! V_232 )
return - V_219 ;
memcpy ( V_232 + 4 , V_31 , V_123 ) ;
V_123 += 4 ;
V_232 [ 0 ] = 0 ;
V_232 [ 1 ] = V_231 -> V_236 ;
V_232 [ 2 ] = V_231 -> V_237 ;
...
V_39 = F_173 ( V_29 , V_4 , V_38 , V_232 , V_123 ,
V_53 , V_34 , V_35 , NULL ) ;
F_23 ( V_232 ) ;
return V_39 ;
}
int
F_174 ( struct V_11 * V_29 , int V_242 , int V_229 ,
unsigned char * V_31 , int V_123 , int V_34 , int V_35 ,
struct V_230 * V_231 , struct V_52 * V_53 )
{
...
memset ( V_31 , 0 , V_123 ) ;
V_54 = F_173 ( V_29 , V_4 , V_161 , V_31 , V_123 ,
V_53 , V_34 , V_35 , NULL ) ;
if ( V_233 && ! F_175 ( V_54 ) &&
( F_91 ( V_54 ) & V_144 ) ) {
if ( F_176 ( V_53 ) ) {
...
V_231 -> V_148 = V_31 [ 0 ] * 256 + V_31 [ 1 ] + 2 ;
V_231 -> V_236 = V_31 [ 2 ] ;
V_231 -> V_237 = V_31 [ 3 ] ;
V_231 -> V_238 = V_31 [ 4 ] & 0x01 ;
V_231 -> V_239 = V_31 [ 6 ] * 256
+ V_31 [ 7 ] ;
} else {
V_231 -> V_148 = V_31 [ 0 ] + 1 ;
V_231 -> V_236 = V_31 [ 1 ] ;
V_231 -> V_237 = V_31 [ 2 ] ;
V_231 -> V_239 = V_31 [ 3 ] ;
}
...
int V_54 ;
if ( ! V_248 )
V_53 = F_21 ( sizeof( * V_53 ) , V_235 ) ;
else
V_53 = V_248 ;
do {
V_54 = F_173 ( V_29 , V_4 , V_159 , NULL , 0 , V_53 ,
V_34 , V_35 , NULL ) ;
if ( V_29 -> V_130 && F_176 ( V_53 ) &&
V_53 -> V_124 == V_129 )
V_29 -> V_131 = 1 ;
} while ( F_176 ( V_53 ) &&
...
int
F_178 ( struct V_11 * V_29 , enum V_250 V_251 )
{
enum V_250 V_252 = V_29 -> V_168 ;
if ( V_251 == V_252 )
return 0 ;
switch ( V_251 ) {
case V_253 :
...
static void F_181 ( struct V_11 * V_29 , struct V_256 * V_257 )
{
int V_258 = 0 ;
char * V_259 [ 3 ] ;
switch ( V_257 -> V_260 ) {
...
V_259 [ V_258 ++ ] = NULL ;
F_182 ( & V_29 -> V_81 . V_267 , V_268 , V_259 ) ;
}
void F_183 ( struct V_79 * V_80 )
{
struct V_11 * V_29 ;
enum V_269 V_260 ;
F_40 ( V_270 ) ;
V_29 = F_50 ( V_80 , struct V_11 , V_271 ) ;
for ( V_260 = V_272 ; V_260 <= V_273 ; V_260 ++ )
if ( F_184 ( V_260 , V_29 -> V_274 ) )
F_185 ( V_29 , V_260 , V_235 ) ;
while ( 1 ) {
struct V_256 * V_257 ;
struct V_275 * V_276 , * V_68 ;
unsigned long V_16 ;
F_8 ( & V_29 -> V_277 , V_16 ) ;
F_41 ( & V_29 -> V_270 , & V_270 ) ;
F_11 ( & V_29 -> V_277 , V_16 ) ;
if ( F_42 ( & V_270 ) )
break;
F_186 (this, tmp, &event_list) {
V_257 = F_43 ( V_276 , struct V_256 , V_278 ) ;
F_187 ( & V_257 -> V_278 ) ;
F_181 ( V_29 , V_257 ) ;
F_23 ( V_257 ) ;
}
...
void F_188 ( struct V_11 * V_29 , struct V_256 * V_257 )
{
unsigned long V_16 ;
#if 0
...
#endif
F_8 ( & V_29 -> V_277 , V_16 ) ;
F_117 ( & V_257 -> V_278 , & V_29 -> V_270 ) ;
F_189 ( & V_29 -> V_271 ) ;
F_11 ( & V_29 -> V_277 , V_16 ) ;
}
struct V_256 * F_190 ( enum V_269 V_260 ,
T_1 V_279 )
{
struct V_256 * V_257 = F_21 ( sizeof( struct V_256 ) , V_279 ) ;
if ( ! V_257 )
return NULL ;
V_257 -> V_260 = V_260 ;
F_125 ( & V_257 -> V_278 ) ;
...
void F_185 ( struct V_11 * V_29 ,
enum V_269 V_260 , T_1 V_279 )
{
struct V_256 * V_257 = F_190 ( V_260 , V_279 ) ;
if ( ! V_257 ) {
...
static void
F_194 ( struct V_11 * V_29 , void * V_231 )
{
F_191 ( V_29 ) ;
}
void
...
{
F_196 ( V_13 , NULL , F_194 ) ;
}
static void
F_197 ( struct V_11 * V_29 , void * V_231 )
{
F_193 ( V_29 ) ;
}
void
F_198 ( struct V_12 * V_13 )
{
F_196 ( V_13 , NULL , F_197 ) ;
}
int
...
unsigned long V_16 ;
int V_280 = 0 ;
V_280 = F_178 ( V_29 , V_176 ) ;
if ( V_280 ) {
V_280 = F_178 ( V_29 , V_177 ) ;
if ( V_280 )
return V_280 ;
}
F_8 ( V_15 -> V_27 , V_16 ) ;
...
static void
F_203 ( struct V_11 * V_29 , void * V_231 )
{
F_199 ( V_29 ) ;
}
static int
F_204 ( struct V_10 * V_207 , void * V_231 )
{
if ( F_205 ( V_207 ) )
F_196 ( F_206 ( V_207 ) , NULL ,
F_203 ) ;
return 0 ;
}
void
F_207 ( struct V_10 * V_207 )
{
if ( F_205 ( V_207 ) )
F_196 ( F_206 ( V_207 ) , NULL ,
F_203 ) ;
else
F_208 ( V_207 , NULL , F_204 ) ;
}
static void
F_209 ( struct V_11 * V_29 , void * V_231 )
{
F_201 ( V_29 , * (enum V_250 * ) V_231 ) ;
}
static int
F_210 ( struct V_10 * V_207 , void * V_231 )
{
if ( F_205 ( V_207 ) )
F_196 ( F_206 ( V_207 ) , V_231 ,
F_209 ) ;
return 0 ;
}
void
F_211 ( struct V_10 * V_207 , enum V_250 V_281 )
{
if ( F_205 ( V_207 ) )
F_196 ( F_206 ( V_207 ) , & V_281 ,
F_209 ) ;
else
F_208 ( V_207 , & V_281 , F_210 ) ;
}
void * F_212 ( struct V_87 * V_88 , int V_282 ,
T_5 * V_283 , T_5 * V_123 )
{
int V_218 ;
T_5 V_284 = 0 , V_285 = 0 ;
...
F_6 ( V_172 L_38
L_39 ,
V_196 , V_284 , * V_283 , V_282 ) ;
F_213 ( 1 ) ;
return NULL ;
}
* V_283 = * V_283 - V_285 + V_286 -> V_283 ;
V_287 = F_216 ( F_217 ( V_286 ) , ( * V_283 >> V_288 ) ) ;
* V_283 &= ~ V_289 ;
V_284 = V_290 - * V_283 ;
if ( * V_123 > V_284 )
* V_123 = V_284 ;
...
void F_219 ( void * V_291 )
{
F_220 ( V_291 ) ;
}
void F_221 ( struct V_11 * V_29 )
{
F_122 ( & V_29 -> V_292 ) ;
}
void F_222 ( struct V_11 * V_29 )
{
if ( F_223 ( F_224 ( & V_29 -> V_292 ) <= 0 ) )
return;
F_225 ( & V_29 -> V_292 ) ;
}
