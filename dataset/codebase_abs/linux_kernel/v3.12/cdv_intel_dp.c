...
if ( ! V_6 -> V_280 )
return false ;
for ( V_56 = 0 ; V_56 < V_6 -> V_280 ; V_56 ++ ) {
V_279 = V_6 -> V_281 + V_56 ;
...
void
F_98 ( struct V_21 * V_22 , struct V_294 * V_295 , int V_64 )
{
struct V_1 * V_1 ;
struct V_117 * V_117 ;
struct V_40 * V_41 ;
...
int type = V_296 ;
V_1 = F_99 ( sizeof( struct V_1 ) , V_297 ) ;
if ( ! V_1 )
return;
V_117 = F_99 ( sizeof( struct V_117 ) , V_297 ) ;
if ( ! V_117 )
goto V_298;
V_5 = F_99 ( sizeof( struct V_4 ) , V_297 ) ;
if ( ! V_5 )
goto V_299;
if ( ( V_64 == V_300 ) && F_96 ( V_22 ) )
type = V_301 ;
V_41 = & V_117 -> V_23 ;
V_2 = & V_1 -> V_23 ;
F_100 ( V_22 , V_41 , & V_302 , type ) ;
F_101 ( V_22 , V_2 , & V_303 , V_304 ) ;
F_102 ( V_117 , V_1 ) ;
if ( type == V_296 )
V_1 -> type = V_162 ;
else
...
case V_233 :
V_118 = L_38 ;
V_1 -> V_311 = ( V_312 | V_313 ) ;
break;
case V_300 :
V_118 = L_39 ;
V_1 -> V_311 = ( V_312 | V_314 ) ;
break;
}
F_97 ( V_22 ) ;
...
V_318 = F_9 ( V_324 ) ;
V_319 = F_9 ( V_325 ) ;
V_316 . V_326 = ( V_317 & V_327 ) >>
V_328 ;
V_316 . V_329 = ( V_317 & V_330 ) >>
V_331 ;
V_316 . V_332 = ( V_318 & V_333 ) >>
V_334 ;
V_316 . V_335 = ( V_318 & V_336 ) >>
V_337 ;
V_316 . V_338 = ( ( V_319 & V_339 ) >>
V_340 ) ;
F_8 ( L_40 ,
V_316 . V_326 , V_316 . V_329 , V_316 . V_332 , V_316 . V_335 , V_316 . V_338 ) ;
V_5 -> V_28 = V_316 . V_326 / 10 ;
V_5 -> V_341 = V_316 . V_329 / 10 ;
V_5 -> V_39 = V_316 . V_332 / 10 ;
V_5 -> V_342 = V_316 . V_335 / 10 ;
V_5 -> V_38 = ( V_316 . V_338 - 1 ) * 100 ;
F_8 ( L_41 ,
V_5 -> V_28 , V_5 -> V_342 ,
V_5 -> V_38 ) ;
F_8 ( L_42 ,
