...
int F_37 ( struct V_11 * V_5 )
{
F_38 () ;
return 0 ;
}
void F_39 ( struct V_47 * * V_59 )
{
struct V_60 * V_61 ;
if ( ( * V_59 ) == NULL )
return;
...
void F_41 ( struct V_11 * V_5 )
{
struct V_47 * V_47 = F_42 ( V_5 ) ;
if ( ! V_47 )
return;
F_39 ( & V_47 ) ;
}
static inline T_3 F_43 ( struct V_47 * V_59 )
{
return F_44 ( & V_59 -> V_59 . V_62 ) ;
}
int
F_45 ( struct V_15 * V_52 ,
struct V_6 * V_7 ,
T_2 V_55 ,
T_4 * V_63 )
{
