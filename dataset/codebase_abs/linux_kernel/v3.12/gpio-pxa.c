...
{
int V_15 = 0 , V_96 ;
struct V_97 * V_98 = V_79 -> V_99 . V_52 ;
const struct V_100 * V_101 =
F_49 ( V_102 , & V_79 -> V_99 ) ;
...
V_96 = V_103 -> V_89 ;
V_36 = V_96 - 1 ;
V_23 = F_51 ( - 1 , 0 , V_96 , 0 ) ;
if ( V_23 < 0 ) {
F_50 ( & V_79 -> V_99 , L_8 ) ;
V_15 = V_23 ;
goto V_106;
}
V_107 = F_52 ( V_98 , V_96 , V_23 , 0 ,
& V_108 , NULL ) ;
V_53 = V_98 ;
return 0 ;
V_106:
...
struct V_111 * V_111 ;
struct V_112 * V_113 ;
int V_6 , V_24 , V_15 , V_114 = 0 ;
int V_115 = 0 , V_116 = 0 , V_117 , V_118 = 0 ;
V_113 = F_55 ( & V_79 -> V_99 ) ;
if ( V_113 ) {
V_23 = V_113 -> V_23 ;
if ( V_23 <= 0 )
return - V_37 ;
...
return - V_37 ;
V_115 = F_56 ( V_79 , L_9 ) ;
V_116 = F_56 ( V_79 , L_10 ) ;
V_117 = F_56 ( V_79 , L_11 ) ;
if ( ( V_115 > 0 && V_116 <= 0 ) || ( V_115 <= 0 && V_116 > 0 )
|| ( V_117 <= 0 ) )
return - V_37 ;
V_110 = F_57 ( V_79 , V_119 , 0 ) ;
if ( ! V_110 )
return - V_37 ;
V_46 = F_58 ( V_110 -> V_120 , F_59 ( V_110 ) ) ;
if ( ! V_46 )
return - V_37 ;
if ( V_115 > 0 )
V_118 = 2 ;
V_111 = F_60 ( & V_79 -> V_99 , NULL ) ;
if ( F_61 ( V_111 ) ) {
F_50 ( & V_79 -> V_99 , L_12 ,
F_62 ( V_111 ) ) ;
F_53 ( V_46 ) ;
...
F_21 ( V_36 , V_113 ? V_113 -> V_121 : NULL ) ;
F_34 (gpio, c) {
F_15 ( 0 , V_2 -> V_5 + V_61 ) ;
F_15 ( 0 , V_2 -> V_5 + V_59 ) ;
F_15 ( ~ 0 , V_2 -> V_5 + V_76 ) ;
if ( F_6 ( V_9 ) )
F_15 ( ~ 0 , V_2 -> V_5 + V_122 ) ;
}
if ( ! V_114 ) {
#ifdef F_65
V_24 = F_37 ( 0 ) ;
...
int V_6 ;
F_34 (gpio, c) {
V_2 -> V_126 = F_9 ( V_2 -> V_5 + V_32 ) ;
V_2 -> V_127 = F_9 ( V_2 -> V_5 + V_18 ) ;
V_2 -> V_128 = F_9 ( V_2 -> V_5 + V_59 ) ;
V_2 -> V_129 = F_9 ( V_2 -> V_5 + V_61 ) ;
...
F_15 ( V_2 -> V_128 , V_2 -> V_5 + V_59 ) ;
F_15 ( V_2 -> V_129 , V_2 -> V_5 + V_61 ) ;
