...
static void F_48 ( T_3 V_82 , int V_40 )
{
int V_83 ;
V_6 V_35 ;
switch ( V_82 ) {
...
V_63 | V_65 ) ,
F_26 ( V_2 -> V_4 ) ) ;
F_8 ( 0xFF , F_51 ( V_2 -> V_4 ) ) ;
V_35 = V_89 | V_90 |
F_52 ( 20 ) | V_91 ;
F_8 ( V_35 , F_34 ( V_2 -> V_4 ) ) ;
F_48 ( V_2 -> V_82 , 0 ) ;
F_47 ( & V_2 -> V_19 , V_15 ) ;
V_88 = F_53 ( V_2 -> V_60 , F_35 ,
0 , V_92 , V_2 ) ;
if ( ! V_88 )
F_8 ( ( V_35 | V_78 | V_79 ) ,
F_34 ( V_2 -> V_4 ) ) ;
...
V_35 |= V_78 | V_79 ;
F_8 ( V_35 , F_34 ( V_2 -> V_4 ) ) ;
F_8 ( V_96 , F_51 ( V_2 -> V_4 ) ) ;
F_58 ( V_2 , V_94 -> V_97 , V_21 ) ;
F_47 ( & V_2 -> V_19 , V_15 ) ;
if ( F_59 ( V_94 ) )
F_60 ( V_94 , V_21 , V_21 ) ;
}
...
if ( ( V_2 -> V_108 == V_109 ) && ( V_2 -> V_82 ) ) {
V_72 = 0 ;
if ( ! F_66 ( V_2 -> V_82 , V_111 , V_92 ) )
V_72 = - V_112 ;
else if ( V_2 -> V_15 & V_110 ) {
V_2 -> V_4 = F_67 ( V_2 -> V_82 , V_111 ) ;
if ( ! V_2 -> V_4 ) {
F_64 ( V_2 -> V_82 , V_111 ) ;
V_72 = - V_113 ;
}
...
static void F_68 ( struct V_1 * V_2 , int V_114 )
{
int V_72 ;
V_72 = F_65 ( V_2 ) ;
if ( V_72 < 0 )
...
V_122 -> V_2 . V_4 = NULL ;
V_122 -> V_2 . V_60 = F_73 ( V_121 , 0 ) ;
if ( V_122 -> V_2 . V_60 < 0 ) {
F_71 ( & V_121 -> V_126 , L_4 ,
V_123 ) ;
...
F_74 ( & V_122 -> V_2 . V_19 ) ;
F_48 ( V_122 -> V_2 . V_82 , 1 ) ;
V_72 = F_75 ( & V_136 , & V_122 -> V_2 ) ;
F_76 ( V_121 , V_122 ) ;
return V_72 ;
}
static int F_77 ( struct V_120 * V_121 )
{
struct V_11 * V_122 = F_78 ( V_121 ) ;
F_79 ( & V_136 , & V_122 -> V_2 ) ;
return 0 ;
}
