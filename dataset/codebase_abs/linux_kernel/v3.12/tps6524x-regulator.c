...
static int F_31 ( struct V_48 * V_15 )
{
struct V_1 * V_2 ;
...
V_2 = F_33 ( & V_15 -> V_16 , sizeof( struct V_1 ) , V_55 ) ;
if ( ! V_2 ) {
F_14 ( V_16 , L_7 ) ;
return - V_56 ;
}
...
V_54 . V_52 = V_52 ;
V_54 . V_66 = V_2 ;
V_2 -> V_34 [ V_43 ] = F_36 ( & V_2 -> V_38 [ V_43 ] , & V_54 ) ;
if ( F_37 ( V_2 -> V_34 [ V_43 ] ) ) {
V_22 = F_38 ( V_2 -> V_34 [ V_43 ] ) ;
V_2 -> V_34 [ V_43 ] = NULL ;
goto V_67;
}
}
