...
switch ( V_77 ) {
case V_81 :
V_80 = F_56 ( V_2 -> V_4 . V_59 , ( T_2 * ) V_78 ) ;
break;
case V_82 :
if ( ! ( V_2 -> V_4 . V_59 & V_83 ) ) {
V_80 = - V_84 ;
break;
}
V_80 = F_56 ( F_57
...
V_80 = F_58 ( V_79 , ( T_2 * ) V_78 ) ;
if ( ! V_80 && ! ( F_59 ( V_79 ) & V_2 -> V_4 . V_59 ) )
V_80 = - V_45 ;
break;
case V_86 :
V_80 = F_56 ( V_2 -> V_4 . V_47 , ( T_2 * ) V_78 ) ;
break;
case V_87 :
if ( ! ( V_2 -> V_4 . V_59 & V_88 ) ||
V_2 -> V_4 . V_89 == 0 ) {
V_80 = - V_84 ;
break;
}
V_80 = F_56 ( V_2 -> V_4 . V_89 , ( T_2 * ) V_78 ) ;
break;
case V_90 :
if ( ! ( V_2 -> V_4 . V_59 & V_88 ) ||
V_2 -> V_4 . V_91 == 0 ) {
...
V_80 = F_56 ( V_2 -> V_4 . V_91 , ( T_2 * ) V_78 ) ;
break;
default:
V_80 = - V_45 ;
}
...
T_3 F_68 ( struct V_67 * V_67 , const char T_4 * V_92 ,
T_5 V_93 , T_6 * V_94 )
{
struct V_1 * V_2 = V_55 [ F_40 ( F_52 ( V_67 ) ) ] ;
if ( ! V_2 ) {
