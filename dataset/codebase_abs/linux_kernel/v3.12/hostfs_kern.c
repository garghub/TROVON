...
int F_36 ( struct V_53 * V_53 , struct V_54 * V_55 )
{
void * V_56 ;
char * V_10 ;
...
if ( ! F_39 ( V_55 , V_10 , V_14 , V_18 , type ) )
break;
V_55 -> V_59 = V_57 ;
}
F_40 ( V_56 ) ;
...
int F_41 ( struct V_2 * V_18 , struct V_53 * V_53 )
{
static F_42 ( V_60 ) ;
char * V_10 ;
T_3 V_44 = 0 ;
...
static int F_47 ( struct V_2 * V_2 , struct V_53 * V_53 )
{
F_48 ( V_2 -> V_67 ) ;
return 0 ;
}
int F_49 ( struct V_53 * V_53 , T_4 V_68 , T_4 V_22 , int V_69 )
{
struct V_2 * V_2 = V_53 -> V_70 -> V_71 ;
int V_72 ;
V_72 = F_50 ( V_2 -> V_67 , V_68 , V_22 ) ;
if ( V_72 )
return V_72 ;
F_44 ( & V_2 -> V_73 ) ;
V_72 = F_51 ( F_1 ( V_2 ) -> V_43 , V_69 ) ;
F_45 ( & V_2 -> V_73 ) ;
return V_72 ;
}
int F_52 ( struct V_74 * V_74 , struct V_75 * V_76 )
{
...
V_31 = F_54 ( F_1 ( V_2 ) -> V_43 , & V_80 , V_79 , V_81 ) ;
if ( V_31 != V_81 ) {
F_55 ( V_74 ) ;
goto V_25;
}
...
int F_60 ( struct V_53 * V_53 , struct V_74 * V_74 )
{
char * V_79 ;
long long V_68 ;
int V_31 = 0 ;
...
V_79 = F_53 ( V_74 ) ;
V_31 = F_61 ( F_62 ( V_53 ) -> V_43 , & V_68 , V_79 ,
V_82 ) ;
if ( V_31 < 0 )
goto V_25;
...
int F_65 ( struct V_53 * V_53 , struct V_77 * V_78 ,
T_4 V_59 , unsigned V_14 , unsigned V_87 ,
struct V_74 * * V_88 , void * * V_89 )
{
T_5 V_86 = V_59 >> V_85 ;
* V_88 = F_66 ( V_78 , V_86 , V_87 ) ;
if ( ! * V_88 )
return - V_23 ;
return 0 ;
}
int F_67 ( struct V_53 * V_53 , struct V_77 * V_78 ,
...
int V_31 ;
V_79 = F_53 ( V_74 ) ;
V_31 = F_54 ( F_62 ( V_53 ) -> V_43 , & V_59 , V_79 + V_91 , V_90 ) ;
F_58 ( V_74 ) ;
if ( ! F_68 ( V_74 ) && V_31 == V_82 )
F_64 ( V_74 ) ;
...
static int F_70 ( struct V_2 * V_18 , char * V_10 )
{
T_6 V_92 ;
struct V_93 V_94 ;
int V_31 = F_71 ( V_10 , & V_94 , - 1 ) ;
if ( V_31 )
return V_31 ;
V_92 = F_72 ( V_94 . V_95 , V_94 . V_96 ) ;
...
F_74 ( V_18 , V_94 . V_115 ) ;
F_75 ( V_18 , V_94 . V_116 ) ;
F_76 ( V_18 , V_94 . V_117 ) ;
...
int F_77 ( struct V_2 * V_56 , struct V_4 * V_4 , T_7 V_44 ,
bool V_126 )
{
struct V_2 * V_2 ;
char * V_10 ;
...
struct V_4 * F_82 ( struct V_2 * V_18 , struct V_4 * V_4 ,
unsigned int V_87 )
{
struct V_2 * V_2 ;
char * V_10 ;
...
int F_84 ( struct V_4 * V_139 , struct V_2 * V_18 , struct V_4 * V_91 )
{
char * V_140 , * V_141 ;
int V_31 ;
if ( ( V_140 = F_10 ( V_91 ) ) == NULL )
return - V_23 ;
V_141 = F_10 ( V_139 ) ;
if ( V_141 == NULL ) {
F_8 ( V_140 ) ;
...
V_31 = F_85 ( V_141 , V_140 ) ;
F_8 ( V_140 ) ;
F_8 ( V_141 ) ;
return V_31 ;
}
int F_86 ( struct V_2 * V_18 , struct V_4 * V_4 )
{
char * V_53 ;
int V_31 ;
if ( V_9 )
...
int F_88 ( struct V_2 * V_18 , struct V_4 * V_4 , const char * V_139 )
{
char * V_53 ;
int V_31 ;
if ( ( V_53 = F_10 ( V_4 ) ) == NULL )
return - V_23 ;
V_31 = F_89 ( V_53 , V_139 ) ;
F_8 ( V_53 ) ;
return V_31 ;
}
int F_90 ( struct V_2 * V_18 , struct V_4 * V_4 , T_7 V_44 )
{
char * V_53 ;
int V_31 ;
if ( ( V_53 = F_10 ( V_4 ) ) == NULL )
...
int F_92 ( struct V_2 * V_18 , struct V_4 * V_4 )
{
char * V_53 ;
int V_31 ;
if ( ( V_53 = F_10 ( V_4 ) ) == NULL )
...
static int F_94 ( struct V_2 * V_56 , struct V_4 * V_4 , T_7 V_44 , T_6 V_143 )
{
struct V_2 * V_2 ;
char * V_10 ;
int V_31 ;
...
goto V_128;
F_73 ( V_2 , V_44 , V_143 ) ;
V_31 = F_95 ( V_10 , V_44 , F_96 ( V_143 ) , F_97 ( V_143 ) ) ;
if ( ! V_31 )
goto V_26;
V_31 = F_70 ( V_2 , V_10 ) ;
F_8 ( V_10 ) ;
...
int F_98 ( struct V_2 * V_144 , struct V_4 * V_91 ,
struct V_2 * V_145 , struct V_4 * V_139 )
{
char * V_140 , * V_141 ;
int V_31 ;
if ( ( V_140 = F_10 ( V_91 ) ) == NULL )
return - V_23 ;
if ( ( V_141 = F_10 ( V_139 ) ) == NULL ) {
F_8 ( V_140 ) ;
return - V_23 ;
}
V_31 = F_99 ( V_140 , V_141 ) ;
F_8 ( V_140 ) ;
F_8 ( V_141 ) ;
return V_31 ;
}
int F_100 ( struct V_2 * V_18 , int V_146 )
{
char * V_10 ;
...
V_31 = F_105 ( V_10 , V_61 , V_62 , V_147 ) ;
F_8 ( V_10 ) ;
if ( ! V_31 )
V_31 = F_106 ( V_18 , V_146 ) ;
return V_31 ;
}
int F_107 ( struct V_4 * V_4 , struct V_153 * V_154 )
{
struct V_2 * V_2 = V_4 -> V_155 ;
struct V_156 V_157 ;
char * V_10 ;
int V_31 ;
int V_43 = F_1 ( V_2 ) -> V_43 ;
V_31 = F_108 ( V_2 , V_154 ) ;
if ( V_31 )
return V_31 ;
if ( V_9 )
V_154 -> V_158 &= ~ V_159 ;
...
V_157 . V_158 |= V_164 ;
V_157 . V_165 = F_109 ( & V_166 , V_154 -> V_165 ) ;
}
if ( V_154 -> V_158 & V_167 ) {
V_157 . V_158 |= V_168 ;
V_157 . V_169 = F_110 ( & V_166 , V_154 -> V_169 ) ;
}
...
if ( V_10 == NULL )
return - V_23 ;
V_31 = F_111 ( V_10 , & V_157 , V_43 ) ;
F_8 ( V_10 ) ;
if ( V_31 )
return V_31 ;
if ( ( V_154 -> V_158 & V_159 ) &&
V_154 -> V_171 != F_112 ( V_2 ) )
F_113 ( V_2 , V_154 -> V_171 ) ;
F_114 ( V_2 , V_154 ) ;
F_115 ( V_2 ) ;
return 0 ;
}
static void * F_116 ( struct V_4 * V_4 , struct V_185 * V_186 )
{
char * V_19 = F_11 () ;
if ( V_19 ) {
char * V_187 = F_10 ( V_4 ) ;
...
static void F_118 ( struct V_4 * V_4 , struct V_185 * V_186 , void * V_189 )
{
char * V_17 = F_119 ( V_186 ) ;
if ( ! F_7 ( V_17 ) )
F_8 ( V_17 ) ;
}
static int F_120 ( struct V_27 * V_28 , void * V_190 , int V_191 )
{
struct V_2 * V_192 ;
...
V_31 = - V_23 ;
V_28 -> V_16 = V_193 =
F_16 ( strlen ( V_8 ) + strlen ( V_194 ) + 2 , V_24 ) ;
if ( V_193 == NULL )
goto V_25;
sprintf ( V_193 , L_6 , V_8 , V_194 ) ;
V_192 = F_21 ( V_28 ) ;
if ( ! V_192 )
goto V_25;
V_31 = F_70 ( V_192 , V_193 ) ;
if ( V_31 )
goto V_128;
if ( F_121 ( V_192 -> V_114 ) ) {
char * V_10 = F_15 ( V_193 ) ;
if ( F_7 ( V_10 ) )
V_31 = F_78 ( V_10 ) ;
else
V_31 = F_70 ( V_192 , V_10 ) ;
F_18 ( V_10 ) ;
if ( V_31 )
goto V_128;
}
V_31 = - V_23 ;
V_28 -> V_204 = F_122 ( V_192 ) ;
if ( V_28 -> V_204 == NULL )
goto V_25;
return 0 ;
V_128:
...
static struct V_4 * F_123 ( struct V_205 * type ,
int V_87 , const char * V_206 ,
void * V_207 )
{
return F_124 ( type , V_87 , V_207 , F_120 ) ;
}
