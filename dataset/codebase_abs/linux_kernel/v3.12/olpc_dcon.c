...
return;
V_2 -> V_60 = V_70 ;
if ( ( V_2 -> V_61 != V_70 ) && ! F_35 ( & V_2 -> V_58 ) )
F_36 ( & V_2 -> V_58 ) ;
}
static void F_37 ( struct V_1 * V_2 , int V_70 )
{
F_34 ( V_2 , V_70 ) ;
F_38 () ;
}
static T_5 F_39 ( struct V_71 * V_14 ,
...
static T_5 F_45 ( struct V_71 * V_14 ,
struct V_72 * V_73 , const char * V_74 , T_6 V_75 )
{
unsigned long V_39 ;
int V_8 ;
V_8 = F_46 ( V_74 , 10 , & V_39 ) ;
if ( V_8 )
return V_8 ;
...
static T_5 F_48 ( struct V_71 * V_14 ,
struct V_72 * V_73 , const char * V_74 , T_6 V_75 )
{
unsigned short V_79 ;
int V_8 ;
V_8 = F_49 ( V_74 , 10 , & V_79 ) ;
if ( V_8 )
return V_8 ;
V_28 = V_79 ;
...
static T_5 F_50 ( struct V_71 * V_14 ,
struct V_72 * V_73 , const char * V_74 , T_6 V_75 )
{
unsigned long V_76 ;
int V_77 ;
...
if ( V_77 )
return V_77 ;
F_19 ( F_40 ( V_14 ) , V_76 ? true : false ) ;
return V_75 ;
}
static int F_51 ( struct V_80 * V_14 )
{
...
static int F_53 ( struct V_80 * V_14 )
{
struct V_1 * V_2 = F_52 ( V_14 ) ;
return V_2 -> V_37 ;
}
...
static int F_56 ( struct V_94 * V_5 , struct V_95 * V_96 )
{
F_57 ( V_96 -> type , L_26 , V_97 ) ;
return 0 ;
}
static int F_58 ( struct V_94 * V_5 , const struct V_98 * V_99 )
{
struct V_1 * V_2 ;
int V_8 , V_100 , V_101 ;
if ( ! V_12 )
return - V_10 ;
V_2 = F_59 ( sizeof( * V_2 ) , V_102 ) ;
if ( ! V_2 )
return - V_103 ;
V_2 -> V_5 = V_5 ;
F_60 ( & V_2 -> V_65 ) ;
...
for ( V_100 = 0 ; V_100 < F_66 ( V_113 ) ; V_100 ++ ) {
V_8 = F_67 ( & V_110 -> V_14 ,
& V_113 [ V_100 ] ) ;
if ( V_8 ) {
F_8 ( & V_110 -> V_14 , L_31 ) ;
...
V_115 . V_82 = V_2 -> V_37 ;
V_2 -> V_116 = F_68 ( L_32 , & V_110 -> V_14 ,
V_2 , & V_117 , & V_115 ) ;
if ( F_69 ( V_2 -> V_116 ) ) {
F_8 ( & V_5 -> V_14 , L_33 ,
F_70 ( V_2 -> V_116 ) ) ;
...
static int F_77 ( struct V_94 * V_5 )
{
...
static int F_83 ( struct V_71 * V_14 )
{
struct V_94 * V_5 = F_84 ( V_14 ) ;
struct V_1 * V_2 = F_78 ( V_5 ) ;
if ( ! V_2 -> V_43 ) {
F_37 ( V_2 , V_67 ) ;
}
...
static int F_85 ( struct V_71 * V_14 )
{
struct V_94 * V_5 = F_84 ( V_14 ) ;
struct V_1 * V_2 = F_78 ( V_5 ) ;
if ( ! V_2 -> V_43 ) {
