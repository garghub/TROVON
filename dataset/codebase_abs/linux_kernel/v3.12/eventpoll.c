...
static int F_73 ( struct V_74 * V_74 , struct V_1 * V_1 )
{
...
static inline unsigned int F_74 ( struct V_14 * V_18 , T_2 * V_17 )
{
V_17 -> V_76 = V_18 -> V_77 . V_43 ;
return V_18 -> V_6 . V_1 -> V_3 -> V_78 ( V_18 -> V_6 . V_1 , V_17 ) & V_18 -> V_77 . V_43 ;
}
static int F_75 ( struct V_25 * V_26 , struct V_10 * V_79 ,
void * V_31 )
{
struct V_14 * V_18 , * V_80 ;
T_2 V_17 ;
F_76 ( & V_17 , NULL ) ;
F_77 (epi, tmp, head, rdllink) {
if ( F_74 ( V_18 , & V_17 ) )
return V_45 | V_81 ;
else {
F_53 ( F_38 ( V_18 ) ) ;
...
static int F_78 ( void * V_31 , void * V_32 , int V_34 )
{
return F_46 ( V_31 , F_75 , NULL , V_34 + 1 ) ;
}
static unsigned int F_79 ( struct V_1 * V_1 , T_2 * V_13 )
{
int V_82 ;
struct V_25 * V_26 = V_1 -> V_75 ;
...
static int F_80 ( struct V_85 * V_86 , struct V_1 * V_2 )
{
...
static int F_83 ( struct V_25 * * V_90 )
{
int error ;
struct V_91 * V_69 ;
struct V_25 * V_26 ;
...
static struct V_14 * F_89 ( struct V_25 * V_26 , struct V_1 * V_1 , int V_7 )
{
int V_95 ;
struct V_71 * V_72 ;
...
static int F_90 ( T_1 * V_13 , unsigned V_99 , int V_100 , void * V_101 )
{
int V_58 = 0 ;
unsigned long V_35 ;
...
static void F_91 ( struct V_1 * V_1 , T_3 * V_51 ,
T_2 * V_17 )
{
struct V_14 * V_18 = F_9 ( V_17 ) ;
struct V_12 * V_50 ;
if ( V_18 -> V_105 >= 0 && ( V_50 = F_92 ( V_53 , V_93 ) ) ) {
F_93 ( & V_50 -> V_13 , F_90 ) ;
V_50 -> V_51 = V_51 ;
V_50 -> V_15 = V_18 ;
F_94 ( V_51 , & V_50 -> V_13 ) ;
...
static void F_95 ( struct V_25 * V_26 , struct V_14 * V_18 )
{
int V_95 ;
...
F_96 ( & V_18 -> V_66 , V_106 , V_11 ) ;
F_97 ( & V_18 -> V_66 , & V_26 -> V_67 ) ;
}
static int F_98 ( int V_108 )
{
if ( V_108 == 0 )
return 0 ;
...
static int F_100 ( void * V_31 , void * V_32 , int V_34 )
{
int error = 0 ;
struct V_1 * V_1 = V_31 ;
struct V_1 * V_113 ;
...
if ( ! V_55 )
return - V_92 ;
F_105 ( V_18 -> V_55 , V_55 ) ;
return 0 ;
}
static T_4 void F_106 ( struct V_14 * V_18 )
{
struct V_54 * V_55 = F_38 ( V_18 ) ;
F_107 ( V_18 -> V_55 , NULL ) ;
F_108 () ;
F_62 ( V_55 ) ;
}
static int F_109 ( struct V_25 * V_26 , struct V_121 * V_77 ,
...
struct V_14 * V_18 ;
struct V_16 V_125 ;
V_124 = F_110 ( & V_26 -> V_69 -> V_70 ) ;
if ( F_86 ( V_124 >= V_126 ) )
return - V_127 ;
if ( ! ( V_18 = F_92 ( V_68 , V_93 ) ) )
return - V_92 ;
F_12 ( & V_18 -> V_62 ) ;
F_12 ( & V_18 -> V_65 ) ;
F_12 ( & V_18 -> V_52 ) ;
...
V_125 . V_18 = V_18 ;
F_76 ( & V_125 . V_17 , F_91 ) ;
V_123 = F_74 ( V_18 , & V_125 . V_17 ) ;
error = - V_92 ;
if ( V_18 -> V_105 < 0 )
goto V_130;
F_58 ( & V_122 -> V_64 ) ;
...
static int F_112 ( struct V_25 * V_26 , struct V_14 * V_18 , struct V_121 * V_77 )
{
int V_58 = 0 ;
unsigned int V_123 ;
T_2 V_17 ;
...
static int F_116 ( struct V_25 * V_26 , struct V_10 * V_79 ,
void * V_31 )
{
...
V_123 = F_74 ( V_18 , & V_17 ) ;
if ( V_123 ) {
if ( F_117 ( V_123 , & V_136 -> V_43 ) ||
F_117 ( V_18 -> V_77 . V_88 , & V_136 -> V_88 ) ) {
F_19 ( & V_18 -> V_62 , V_79 ) ;
F_41 ( V_18 ) ;
...
static int F_118 ( struct V_25 * V_26 ,
struct V_121 T_5 * V_43 , int V_137 )
{
struct V_133 V_134 ;
V_134 . V_137 = V_137 ;
V_134 . V_43 = V_43 ;
return F_46 ( V_26 , F_116 , & V_134 , 0 ) ;
}
static inline struct V_142 F_119 ( long V_143 )
{
...
F_120 ( & V_144 ) ;
return F_121 ( V_144 , V_145 ) ;
}
static int F_122 ( struct V_25 * V_26 , struct V_121 T_5 * V_43 ,
...
if ( V_150 > 0 ) {
struct V_142 V_157 = F_119 ( V_150 ) ;
V_154 = F_123 ( & V_157 ) ;
V_156 = & V_155 ;
* V_156 = F_124 ( V_157 ) ;
} else if ( V_150 == 0 ) {
...
F_20 ( & V_26 -> V_24 , V_35 ) ;
if ( ! V_151 && V_152 &&
! ( V_151 = F_118 ( V_26 , V_43 , V_137 ) ) && ! V_153 )
goto V_159;
return V_151 ;
}
static int F_131 ( void * V_31 , void * V_32 , int V_34 )
{
int error = 0 ;
struct V_1 * V_1 = V_31 ;
struct V_25 * V_26 = V_1 -> V_75 ;
...
static int F_132 ( struct V_25 * V_26 , struct V_1 * V_1 )
{
int V_87 ;
struct V_25 * V_170 , * V_171 ;
V_87 = F_15 ( & V_114 , V_49 ,
F_131 , V_1 , V_26 , V_84 ) ;
F_77 (ep_cur, ep_next, &visited_list,
visited_list_link) {
V_170 -> V_165 = 0 ;
F_21 ( & V_170 -> V_166 ) ;
}
...
F_11 ( & V_48 ) ;
F_11 ( & V_83 ) ;
F_137 ( sizeof( void * ) <= 8 && sizeof( struct V_14 ) > 128 ) ;
V_68 = F_138 ( L_5 , sizeof( struct V_14 ) ,
0 , V_178 | V_179 , NULL ) ;
V_53 = F_138 ( L_6 ,
