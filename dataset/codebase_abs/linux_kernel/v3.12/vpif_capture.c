...
static int F_114 ( struct V_129 * V_130 , void * V_148 )
{
F_115 ( & V_83 . V_259 , 0 , V_202 , V_260 ) ;
return 0 ;
}
static int F_116 ( void )
{
int V_261 = 0 , V_86 , V_262 ;
int V_263 ;
if ( ( V_264 > 0 ) &&
( V_264 < V_36 . V_43 ) )
V_264 = V_36 . V_43 ;
...
( V_265 < V_36 . V_43 ) )
V_265 = V_36 . V_43 ;
if ( V_266 < V_36 . V_267 [ V_73 ] )
V_266 =
V_36 . V_267 [ V_73 ] ;
if ( V_268 < V_36 . V_267 [ V_74 ] )
V_268 =
V_36 . V_267 [ V_74 ] ;
V_36 . V_112 [ V_73 ] = V_264 ;
V_36 . V_112 [ V_74 ] = V_265 ;
if ( V_264 ) {
V_36 . V_37 [ V_73 ]
= V_266 ;
}
...
{
int V_86 ;
for ( V_86 = 0 ; V_86 < V_83 . V_91 -> V_183 ; V_86 ++ )
if ( ! strcmp ( V_83 . V_91 -> V_180 [ V_86 ] . V_184 ,
V_273 -> V_184 ) ) {
V_83 . V_171 [ V_86 ] = V_273 ;
return 0 ;
}
return - V_26 ;
}
...
V_261 = F_131 ( V_55 , & V_83 . V_259 ) ;
if ( V_261 ) {
F_130 ( V_55 -> V_216 , L_78 ) ;
return V_261 ;
}
while ( ( V_137 = F_132 ( V_280 , V_287 , V_282 ) ) ) {
V_261 = F_133 ( & V_280 -> V_82 , V_137 -> V_288 , F_45 ,
V_289 , L_79 ,
( void * ) ( & V_83 . V_82 [ V_282 ] ->
V_38 ) ) ;
if ( V_261 ) {
V_261 = - V_26 ;
goto V_290;
...
V_83 . V_91 = V_280 -> V_82 . V_56 ;
V_183 = V_83 . V_91 -> V_183 ;
...
V_83 . V_272 . V_299 = V_83 . V_91 -> V_275 ;
V_83 . V_272 . V_300 = V_83 . V_91 -> V_296 [ 0 ] ;
V_83 . V_272 . V_301 = F_117 ;
V_83 . V_272 . V_302 = F_128 ;
V_261 = F_138 ( & V_83 . V_259 ,
& V_83 . V_272 ) ;
if ( V_261 ) {
F_63 ( L_84 ) ;
V_261 = - V_26 ;
...
static int F_140 ( struct V_303 * V_82 )
{
struct V_10 * V_11 ;
struct V_7 * V_8 ;
int V_86 ;
...
static int F_141 ( struct V_303 * V_82 )
{
struct V_10 * V_11 ;
struct V_7 * V_8 ;
int V_86 ;
