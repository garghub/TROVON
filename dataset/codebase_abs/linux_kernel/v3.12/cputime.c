...
void F_39 ( struct V_2 * V_45 , struct V_46 * V_47 )
{
...
void F_44 ( struct V_2 * V_16 , int V_54 ,
struct V_36 * V_36 )
{
T_3 V_55 = F_45 ( V_56 ) ;
T_2 * V_10 = V_11 -> V_10 ;
...
static inline void F_46 ( int V_58 ) {}
static inline void F_44 ( struct V_2 * V_16 , int V_54 ,
struct V_36 * V_36 ) {}
void F_47 ( struct V_2 * V_61 )
{
if ( F_48 ( V_61 ) )
F_49 ( V_61 ) ;
else
...
void F_57 ( struct V_2 * V_16 , T_3 * V_62 , T_3 * V_42 )
{
* V_62 = V_16 -> V_22 ;
* V_42 = V_16 -> V_30 ;
}
void F_58 ( struct V_2 * V_16 , T_3 * V_62 , T_3 * V_42 )
{
struct V_46 V_20 ;
F_39 ( V_16 , & V_20 ) ;
* V_62 = V_20 . V_22 ;
...
void F_59 ( struct V_2 * V_16 , int V_54 )
{
T_3 V_55 = F_45 ( V_56 ) ;
struct V_36 * V_36 = F_32 () ;
if ( F_60 () )
...
if ( V_54 )
F_21 ( V_16 , V_56 , V_55 ) ;
else if ( ( V_16 != V_36 -> V_57 ) || ( F_29 () != V_63 ) )
F_28 ( V_16 , V_63 , V_56 ,
V_55 ) ;
else
F_31 ( V_56 ) ;
}
void F_61 ( unsigned long V_58 )
{
F_30 ( F_62 ( V_58 ) ) ;
}
void F_63 ( unsigned long V_58 )
{
if ( V_1 ) {
F_46 ( V_58 ) ;
return;
...
static T_3 F_64 ( T_2 V_30 , T_2 V_64 , T_2 V_65 )
{
T_2 V_66 ;
for (; ; ) {
if ( V_30 > V_64 )
...
{
T_3 V_74 = F_72 ( V_45 ) ;
F_28 ( V_45 , F_29 () , V_74 , F_45 ( V_74 ) ) ;
}
void F_50 ( struct V_2 * V_45 )
{
F_75 ( & V_45 -> V_75 ) ;
F_74 ( V_45 ) ;
F_76 ( & V_45 -> V_75 ) ;
...
void F_81 ( struct V_2 * V_50 , int V_6 )
{
unsigned long V_4 ;
F_82 ( & V_50 -> V_75 , V_4 ) ;
V_50 -> V_72 = V_77 ;
...
if ( V_50 -> V_4 & V_33 )
V_27 += F_70 ( V_50 ) ;
} while ( F_86 ( & V_50 -> V_75 , V_78 ) );
return V_27 ;
}
static void
F_87 ( struct V_2 * V_50 ,
T_3 * V_79 , T_3 * V_80 ,
T_3 * V_81 , T_3 * V_82 ,
T_3 * V_83 , T_3 * V_84 )
{
