...
return - V_471 ;
F_144 ( V_157 ) ;
if ( F_74 ( V_480 , & V_157 -> V_481 ) &&
! F_249 ( V_482 , & V_88 -> V_83 ) )
...
V_14 -> V_9 = V_390 -> V_9 ;
F_81 ( V_3 , V_390 -> V_9 , V_485 , V_155 , V_132 ) ;
V_14 -> V_424 ++ ;
V_14 -> V_439 = 0 ;
if ( ! F_74 ( V_463 , & V_14 -> V_71 ) )
goto V_484;
if ( F_74 ( V_492 , & V_14 -> V_71 ) ) {
F_258 ( V_14 ) ;
if ( V_14 -> V_119 == V_121 ||
V_14 -> V_119 == V_125 )
V_15 = F_235 ( V_14 ) ;
...
V_132 . V_6 = F_16 ( V_14 -> V_7 ) ;
V_132 . V_7 = F_16 ( V_14 -> V_6 ) ;
F_81 ( V_3 , V_390 -> V_9 , V_497 , sizeof( V_132 ) , & V_132 ) ;
F_24 ( V_13 ) ;
V_13 -> V_498 = V_499 ;
F_25 ( V_13 ) ;
F_61 ( V_14 ) ;
...
F_81 ( V_3 , V_390 -> V_9 , V_502 , sizeof( V_278 ) ,
V_278 ) ;
} else if ( type == V_503 ) {
T_2 V_278 [ 12 ] ;
struct V_500 * V_132 = (struct V_500 * ) V_278 ;
...
V_132 . V_133 = F_80 ( V_505 ) ;
F_81 ( V_3 , V_390 -> V_9 , V_502 , sizeof( V_132 ) ,
& V_132 ) ;
}
return 0 ;
}
...
if ( ! V_157 )
goto error;
if ( V_157 -> V_509 != V_510 || ! F_74 ( V_511 , & V_157 -> V_83 ) ) {
F_170 ( V_157 ) ;
goto error;
}
...
struct V_113 * V_114 = V_3 -> V_88 -> V_113 ;
struct V_168 * V_169 ;
V_169 = F_269 ( V_157 , V_512 , V_3 -> V_287 ) ;
if ( ! V_169 ) {
F_170 ( V_157 ) ;
return - V_353 ;
}
...
V_132 . V_6 = 0 ;
V_132 . V_7 = F_16 ( V_7 ) ;
V_132 . V_133 = F_80 ( V_514 ) ;
V_132 . V_138 = F_80 ( V_139 ) ;
F_81 ( V_3 , V_390 -> V_9 , V_466 ,
sizeof( V_132 ) , & V_132 ) ;
return - V_353 ;
}
static void F_270 ( struct V_1 * V_14 , T_2 V_515 )
{
struct V_516 V_235 ;
T_2 V_9 ;
...
V_235 . V_515 = V_515 ;
F_81 ( V_14 -> V_3 , V_9 , V_518 , sizeof( V_235 ) ,
& V_235 ) ;
F_78 ( V_14 , V_519 ) ;
}
...
F_81 ( V_14 -> V_3 , V_14 -> V_9 , V_524 ,
sizeof( V_523 ) , & V_523 ) ;
F_78 ( V_14 , V_519 ) ;
}
static void F_273 ( struct V_2 * V_3 , T_1 V_517 )
{
struct V_522 V_523 ;
F_21 ( L_59 , V_3 , V_517 ) ;
V_523 . V_517 = F_16 ( V_517 ) ;
V_523 . V_133 = F_80 ( V_525 ) ;
F_81 ( V_3 , F_85 ( V_3 ) , V_524 ,
sizeof( V_523 ) , & V_523 ) ;
}
...
F_81 ( V_3 , V_9 , V_527 , sizeof( V_132 ) , & V_132 ) ;
}
...
F_21 ( L_64 ,
V_14 , V_133 , V_411 , V_537 ) ;
if ( V_14 -> V_23 == V_137 || V_14 -> V_23 == V_542 ) {
F_50 ( V_14 ) ;
return;
}
if ( V_14 -> V_23 != V_56 ) {
F_281 ( V_14 , V_133 , V_411 , V_537 ) ;
} else if ( V_133 != V_536 ) {
F_284 ( V_14 , V_133 ) ;
} else {
switch ( V_14 -> V_250 ) {
...
if ( ! V_14 ) {
V_132 . V_517 = F_16 ( V_517 ) ;
V_132 . V_133 = F_80 ( V_539 ) ;
F_81 ( V_3 , V_390 -> V_9 , V_521 ,
sizeof( V_132 ) , & V_132 ) ;
return 0 ;
}
V_14 -> V_9 = V_390 -> V_9 ;
...
if ( V_14 -> V_411 == V_235 -> V_515 ) {
V_133 = V_545 ;
goto V_544;
}
if ( V_235 -> V_515 ) {
struct V_304 * V_157 ;
V_157 = F_268 ( V_235 -> V_515 ) ;
if ( ! V_157 || V_157 -> V_509 != V_510 ||
! F_74 ( V_511 , & V_157 -> V_83 ) ) {
if ( V_157 )
F_170 ( V_157 ) ;
V_133 = V_541 ;
goto V_544;
...
static void F_287 ( struct V_2 * V_3 , T_1 V_517 , T_1 V_133 )
{
struct V_1 * V_14 ;
struct V_117 * V_164 = NULL ;
V_14 = F_4 ( V_3 , V_517 ) ;
...
static void F_288 ( struct V_2 * V_3 , T_2 V_9 , T_1 V_517 ,
T_1 V_133 )
{
struct V_1 * V_14 ;
V_14 = F_10 ( V_3 , V_9 ) ;
...
if ( V_468 != sizeof( * V_132 ) )
return - V_471 ;
V_517 = F_244 ( V_132 -> V_517 ) ;
V_133 = F_244 ( V_132 -> V_133 ) ;
F_21 ( L_66 , V_517 , V_133 ) ;
if ( V_133 == V_536 || V_133 == V_547 )
F_287 ( V_3 , V_517 , V_133 ) ;
else
F_288 ( V_3 , V_390 -> V_9 , V_517 , V_133 ) ;
return 0 ;
}
...
struct V_1 * V_14 ;
T_1 V_517 , V_133 ;
if ( V_468 != sizeof( * V_523 ) )
return - V_471 ;
V_517 = F_244 ( V_523 -> V_517 ) ;
V_133 = F_244 ( V_523 -> V_133 ) ;
F_21 ( L_66 , V_517 , V_133 ) ;
V_14 = F_8 ( V_3 , V_517 ) ;
if ( ! V_14 ) {
F_274 ( V_3 , V_390 -> V_9 , V_517 ) ;
return 0 ;
}
if ( V_14 -> V_165 == V_535 ) {
if ( V_133 == V_534 ) {
...
static inline int F_292 ( T_1 V_549 , T_1 V_550 , T_1 V_551 ,
T_1 V_552 )
{
T_1 V_553 ;
...
struct F_293 * V_235 ;
struct V_554 V_132 ;
T_1 V_549 , V_550 , V_551 , V_552 , V_468 ;
int V_15 ;
if ( ! ( V_88 -> V_555 & V_556 ) )
return - V_20 ;
...
V_15 = F_292 ( V_549 , V_550 , V_551 , V_552 ) ;
if ( V_15 )
V_132 . V_133 = F_80 ( V_557 ) ;
else
V_132 . V_133 = F_80 ( V_558 ) ;
F_81 ( V_3 , V_390 -> V_9 , V_559 ,
sizeof( V_132 ) , & V_132 ) ;
if ( ! V_15 )
F_294 ( V_88 , V_549 , V_550 , V_551 , V_552 ) ;
return 0 ;
}
...
break;
case V_560 :
F_81 ( V_3 , V_390 -> V_9 , V_561 , V_468 , V_156 ) ;
break;
case V_561 :
break;
case V_266 :
...
V_564 = F_99 ( V_36 -> V_156 + V_36 -> V_155 ) ;
V_563 = F_110 ( 0 , V_36 -> V_156 - V_565 , V_36 -> V_155 + V_565 ) ;
if ( V_563 != V_564 )
return - V_566 ;
}
return 0 ;
...
static void F_303 ( struct V_32 * V_36 , struct V_32 * V_567 ,
struct V_32 * * V_568 )
{
if ( ! F_304 ( V_36 ) )
F_205 ( V_36 ) -> V_354 = V_567 ;
V_567 -> V_306 = NULL ;
( * V_568 ) -> V_306 = V_567 ;
* V_568 = V_567 ;
V_36 -> V_155 += V_567 -> V_155 ;
V_36 -> V_358 += V_567 -> V_155 ;
...
void F_307 ( struct V_1 * V_14 , int V_570 )
{
T_2 V_377 ;
if ( V_14 -> V_119 != V_121 )
return;
V_377 = V_570 ? V_378 : V_380 ;
...
V_14 -> V_247 = V_347 ;
if ( V_14 -> V_169 )
V_14 -> V_3 -> V_318 = V_14 -> V_169 -> V_157 -> V_513 ;
else
...
{
T_1 V_587 ;
V_587 = F_201 ( V_14 , V_14 -> V_338 , V_14 -> V_376 ) ;
return F_201 ( V_14 , V_14 -> V_338 , V_174 ) <= V_587 ;
}
...
static inline void F_334 ( struct V_1 * V_14 , T_2 V_598 )
{
if ( V_14 -> V_86 != V_87 )
return;
if ( V_598 == 0x00 ) {
...
int F_335 ( struct V_168 * V_88 , T_2 V_138 , T_2 V_598 )
{
struct V_2 * V_3 = V_88 -> V_311 ;
struct V_1 * V_14 ;
if ( ! V_3 )
...
static int F_339 ( struct V_609 * V_610 , void * V_19 )
{
struct V_1 * V_5 ;
F_135 ( & V_16 ) ;
F_2 (c, &chan_list, global_l) {
...
static int F_341 ( struct V_611 * V_611 , struct V_612 * V_612 )
{
return F_342 ( V_612 , F_339 , V_611 -> V_613 ) ;
}
int T_11 F_343 ( void )
{
int V_15 ;
