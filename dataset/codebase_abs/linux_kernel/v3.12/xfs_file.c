...
F_93 ( & V_165 , 0 ) ;
V_166 = V_168 >> V_169 ;
V_167 = F_51 ( V_24 , V_163 -> V_97 + V_163 -> V_98 ) ;
V_19 = V_167 >> V_169 ;
do {
int V_170 ;
unsigned V_171 ;
unsigned int V_172 ;
V_170 = F_81 ( T_11 , V_19 - V_166 , V_173 ) ;
V_171 = F_94 ( & V_165 , V_31 -> V_11 , V_166 ,
V_170 ) ;
if ( V_171 == 0 ) {
if ( type == V_159 )
break;
...
V_154 < F_88 ( V_165 . V_174 [ 0 ] ) ) {
V_155 = true ;
break;
}
for ( V_172 = 0 ; V_172 < V_171 ; V_172 ++ ) {
struct V_7 * V_7 = V_165 . V_174 [ V_172 ] ;
T_1 V_175 ;
if ( V_7 -> V_166 > V_19 ) {
if ( type == V_160 && V_154 < V_167 ) {
* V_12 = V_154 ;
V_155 = true ;
}
goto V_106;
...
V_155 = F_87 ( V_7 , & V_175 , type ) ;
if ( V_155 ) {
* V_12 = F_98 ( T_1 , V_168 , V_175 ) ;
F_96 ( V_7 ) ;
goto V_106;
}
V_154 = F_88 ( V_7 ) + V_176 ;
F_96 ( V_7 ) ;
}
if ( V_171 < V_170 ) {
if ( type == V_160 ) {
...
V_166 = V_165 . V_174 [ V_172 - 1 ] -> V_166 + 1 ;
F_99 ( & V_165 ) ;
} while ( V_166 <= V_19 );
V_106:
F_99 ( & V_165 ) ;
...
V_178 = F_45 ( V_24 , V_18 ) ;
V_19 = F_50 ( V_24 , V_77 ) ;
for (; ; ) {
struct V_82 V_163 [ 2 ] ;
int V_181 = 2 ;
unsigned int V_172 ;
error = F_47 ( V_2 , V_178 , V_19 - V_178 , V_163 , & V_181 ,
V_182 ) ;
if ( error )
goto V_129;
if ( V_181 == 0 ) {
...
V_12 = F_98 ( T_1 , V_18 ,
F_51 ( V_24 , V_163 [ V_172 ] . V_97 ) ) ;
if ( V_163 [ V_172 ] . V_85 == V_183 ||
( V_163 [ V_172 ] . V_95 == V_184 &&
! F_101 ( V_163 [ V_172 ] . V_85 ) ) )
goto V_106;
if ( V_163 [ V_172 ] . V_95 == V_96 ) {
if ( F_92 ( V_31 , & V_163 [ V_172 ] ,
V_159 , & V_12 ) )
goto V_106;
}
}
...
ASSERT ( V_172 > 1 ) ;
V_178 = V_163 [ V_172 - 1 ] . V_97 + V_163 [ V_172 - 1 ] . V_98 ;
V_18 = F_51 ( V_24 , V_178 ) ;
if ( V_18 >= V_77 ) {
error = V_180 ;
goto V_129;
}
...
V_106:
V_12 = F_102 ( V_17 , V_12 , V_31 -> V_139 -> V_65 ) ;
V_129:
F_103 ( V_2 , V_179 ) ;
if ( error )
return - error ;
