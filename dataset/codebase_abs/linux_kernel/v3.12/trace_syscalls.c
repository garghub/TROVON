...
if ( V_62 < 0 )
return;
if ( ! F_26 ( V_62 , V_55 -> V_65 ) )
return;
V_56 = F_7 ( V_62 ) ;
if ( ! V_56 )
return;
V_63 = sizeof( * V_5 ) + sizeof( unsigned long ) * V_56 -> V_36 ;
F_27 ( V_60 ) ;
V_61 = F_28 () ;
V_59 = V_55 -> V_66 . V_59 ;
V_22 = F_29 ( V_59 ,
V_56 -> V_34 -> V_22 . type , V_63 , V_60 , V_61 ) ;
if ( ! V_22 )
return;
V_5 = F_30 ( V_22 ) ;
V_5 -> V_14 = V_62 ;
F_31 ( V_64 , V_13 , 0 , V_56 -> V_36 , V_5 -> args ) ;
if ( ! F_32 ( V_59 , V_56 -> V_34 ,
V_5 , V_22 ) )
F_33 ( V_59 , V_22 ,
V_60 , V_61 ) ;
}
...
V_59 = V_55 -> V_66 . V_59 ;
V_22 = F_29 ( V_59 ,
V_56 -> V_42 -> V_22 . type , sizeof( * V_5 ) ,
V_60 , V_61 ) ;
if ( ! V_22 )
return;
V_5 = F_30 ( V_22 ) ;
V_5 -> V_14 = V_62 ;
V_5 -> V_31 = F_35 ( V_64 , V_13 ) ;
if ( ! F_32 ( V_59 , V_56 -> V_42 ,
V_5 , V_22 ) )
F_33 ( V_59 , V_22 ,
V_60 , V_61 ) ;
}
...
static void F_56 ( void * V_77 , struct V_12 * V_13 , long V_53 )
{
struct V_4 * V_56 ;
struct V_28 * V_78 ;
struct V_79 * V_80 ;
...
if ( ! V_56 )
return;
V_80 = F_57 ( V_56 -> V_34 -> V_83 ) ;
if ( F_58 ( V_80 ) )
return;
V_63 = sizeof( unsigned long ) * V_56 -> V_36 + sizeof( * V_78 ) ;
V_63 = F_59 ( V_63 + sizeof( V_84 ) , sizeof( V_85 ) ) ;
V_63 -= sizeof( V_84 ) ;
V_78 = (struct V_28 * ) F_60 ( V_63 ,
V_56 -> V_34 -> V_22 . type , V_13 , & V_81 ) ;
if ( ! V_78 )
return;
V_78 -> V_14 = V_62 ;
F_31 ( V_64 , V_13 , 0 , V_56 -> V_36 ,
( unsigned long * ) & V_78 -> args ) ;
F_61 ( V_78 , V_63 , V_81 , 0 , 1 , V_13 , V_80 , NULL ) ;
}
...
static void F_65 ( void * V_77 , struct V_12 * V_13 , long V_31 )
{
struct V_4 * V_56 ;
struct V_41 * V_78 ;
struct V_79 * V_80 ;
...
if ( ! V_56 )
return;
V_80 = F_57 ( V_56 -> V_42 -> V_83 ) ;
if ( F_58 ( V_80 ) )
return;
V_63 = F_59 ( sizeof( * V_78 ) + sizeof( V_84 ) , sizeof( V_85 ) ) ;
V_63 -= sizeof( V_84 ) ;
V_78 = (struct V_41 * ) F_60 ( V_63 ,
V_56 -> V_42 -> V_22 . type , V_13 , & V_81 ) ;
if ( ! V_78 )
return;
V_78 -> V_14 = V_62 ;
V_78 -> V_31 = F_35 ( V_64 , V_13 ) ;
F_61 ( V_78 , V_63 , V_81 , 0 , 1 , V_13 , V_80 , NULL ) ;
}
...
{
struct V_68 * V_69 = V_6 ;
switch ( type ) {
case V_90 :
return F_36 ( V_69 , V_22 ) ;
case V_91 :
F_41 ( V_69 , V_22 ) ;
return 0 ;
#ifdef F_69
