...
static inline int F_10 ( struct V_11 * V_12 , T_2 * V_19 )
{
T_1 V_20 = ( ( T_1 ) ( V_19 [ 1 ] << 8 ) | ( T_1 ) ( V_19 [ 0 ] ) ) ;
return F_9 ( V_12 , V_21 , V_20 , 0 ) ;
}
static inline int F_11 ( struct V_11 * V_12 , T_2 * V_19 )
{
return F_7 ( V_12 , F_12 ( V_12 , 0 ) ,
V_21 , 0xc0 , 0 , 0 ,
V_19 , 3 , V_17 ) ;
}
static inline int F_13 ( struct V_11 * V_12 ,
T_2 V_22 ,
T_2 V_23 ,
T_2 * V_19 )
{
...
static inline int F_15 ( struct V_26 * V_27 ,
...
if ( V_41 . V_44 == F_19 ( V_2 -> V_12 -> V_45 . V_46 ) )
return V_41 . V_47 ;
}
F_17 ( & V_2 -> V_12 -> V_12 ,
L_3 ) ;
...
F_17 ( & V_31 -> V_12 , L_5 ,
V_70 , V_33 ) ;
if ( F_23 ( V_49 ) || F_24 ( V_49 ) ) {
T_1 V_20 = ( ( T_1 ) ( F_25 ( V_49 ) << 8 ) | ( T_1 ) ( F_26 ( V_49 ) ) ) ;
V_33 = F_9 ( V_12 , V_74 ,
V_20 , V_27 -> V_38 ) ;
} else
V_33 = F_9 ( V_12 , V_74 ,
...
static int F_27 ( struct V_48 * V_49 , struct V_30 * V_31 )
{
struct V_1 * V_2 ;
struct V_26 * V_27 ;
T_2 * V_19 ;
...
struct V_3 * V_4 ;
int V_33 ;
V_33 = F_7 ( V_2 -> V_12 , F_12 ( V_2 -> V_12 , 0 ) ,
...
V_4 = F_28 ( sizeof( * V_4 ) , V_78 ) ;
if ( ! V_4 ) {
F_17 ( & V_2 -> V_12 -> V_12 , L_23 , V_70 ) ;
return - V_79 ;
}
...
struct V_30 * V_31 = V_49 -> V_105 ;
struct V_11 * V_12 = V_31 -> V_2 -> V_12 ;
struct V_26 * V_27 = F_21 ( V_31 ) ;
T_2 * V_41 ;
int V_137 ;
V_41 = F_28 ( 2 , V_78 ) ;
if ( ! V_41 )
return - V_79 ;
V_137 = F_13 ( V_12 , V_27 -> V_38 , V_39 , V_41 ) ;
if ( V_137 < 0 )
goto V_138;
V_137 = F_13 ( V_12 , V_27 -> V_38 , V_139 , V_41 + 1 ) ;
if ( V_137 < 0 )
goto V_138;
...
{
struct V_26 * V_27 ;
V_27 = F_21 ( V_49 -> V_105 ) ;
return F_15 ( V_27 , V_28 , V_29 ) ;
}
...
struct V_26 * V_27 = F_21 ( V_31 ) ;
if ( ! V_151 ) {
if ( F_14 ( V_12 , V_27 -> V_38 ,
V_39 , 0 ) < 0 )
F_43 ( & V_31 -> V_12 , L_25 ) ;
}
if ( V_151 )
F_15 ( V_27 , V_34 | V_35 , 0 ) ;
else
F_15 ( V_27 , 0 , V_34 | V_35 ) ;
}
