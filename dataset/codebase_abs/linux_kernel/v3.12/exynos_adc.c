...
if ( ! V_51 )
return V_54 ;
V_10 = F_29 ( & V_2 -> V_6 , sizeof( struct V_16 ) ) ;
if ( ! V_10 ) {
F_30 ( & V_2 -> V_6 , L_1 ) ;
return - V_56 ;
}
...
if ( F_33 ( V_17 -> V_26 ) )
return F_34 ( V_17 -> V_26 ) ;
V_53 = F_31 ( V_2 , V_57 , 1 ) ;
V_17 -> V_58 = F_32 ( & V_2 -> V_6 , V_53 ) ;
if ( F_33 ( V_17 -> V_58 ) )
return F_34 ( V_17 -> V_58 ) ;
V_35 = F_35 ( V_2 , 0 ) ;
if ( V_35 < 0 ) {
F_30 ( & V_2 -> V_6 , L_2 ) ;
return V_35 ;
...
V_17 -> V_24 = F_1 ( V_2 ) ;
F_41 ( V_2 , V_10 ) ;
V_10 -> V_62 = F_38 ( & V_2 -> V_6 ) ;
V_10 -> V_6 . V_63 = & V_2 -> V_6 ;
...
static int F_53 ( struct V_42 * V_6 )
{
struct V_9 * V_10 = F_54 ( V_6 ) ;
struct V_16 * V_17 = F_4 ( V_10 ) ;
T_1 V_75 ;
if ( V_17 -> V_24 == V_25 ) {
V_75 = F_6 ( F_10 ( V_17 -> V_26 ) ) ;
V_75 &= ~ V_29 ;
F_9 ( V_75 , F_10 ( V_17 -> V_26 ) ) ;
} else {
V_75 = F_6 ( F_12 ( V_17 -> V_26 ) ) ;
V_75 |= V_76 ;
F_9 ( V_75 , F_12 ( V_17 -> V_26 ) ) ;
}
F_48 ( V_17 -> V_59 ) ;
F_9 ( 0 , V_17 -> V_58 ) ;
F_47 ( V_17 -> V_61 ) ;
...
static int F_55 ( struct V_42 * V_6 )
{
struct V_9 * V_10 = F_54 ( V_6 ) ;
struct V_16 * V_17 = F_4 ( V_10 ) ;
int V_54 ;
