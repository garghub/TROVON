...
V_64 -> V_75 = V_53 ;
V_64 -> V_76 = V_77 ;
V_65 = V_78 | ( V_54 ? V_79 : 0 ) ;
V_64 -> V_80 = V_65 ;
V_62 = F_20 ( V_58 , V_60 , V_64 , V_81 , V_82 ) ;
if ( F_13 ( V_62 ) ) {
F_21 ( V_58 , V_60 ) ;
F_18 ( V_58 , & V_66 ) ;
return F_14 ( V_62 ) ;
...
{
struct V_57 * V_58 = V_56 -> V_83 ;
struct V_59 * V_60 = V_56 -> V_84 ;
struct V_61 * V_62 = V_56 -> V_85 ;
int V_66 ;
F_17 ( V_56 -> V_83 ) ;
F_17 ( V_56 -> V_86 ) ;
F_24 ( V_58 , & V_66 ) ;
