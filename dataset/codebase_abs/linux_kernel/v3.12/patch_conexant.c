...
const struct V_296 * V_297 , int V_298 )
{
struct V_1 * V_2 = V_10 -> V_2 ;
V_2 -> V_6 . V_299 = 1 ;
}
...
bool V_301 = false ;
struct V_1 * V_2 = V_10 -> V_2 ;
struct V_302 * V_250 = & V_2 -> V_6 . V_303 ;
T_1 V_304 = V_2 -> V_6 . V_305 [ V_2 -> V_6 . V_70 [ 0 ] ] ;
for ( V_77 = 0 ; V_77 < V_250 -> V_306 ; V_77 ++ )
if ( V_250 -> V_307 [ V_77 ] . V_308 == V_304 ) {
V_301 = ! ! V_250 -> V_307 [ V_77 ] . V_309 ;
break;
}
if ( V_301 ) {
...
V_2 -> V_6 . V_310 = F_61 ( V_10 , V_2 -> V_6 . V_303 . V_311 [ 0 ] ) ;
}
F_145 ( V_10 ) ;
}
...
T_1 * V_318 ;
for ( V_318 = V_317 ; * V_318 ; V_318 ++ )
F_71 ( V_10 , * V_318 , V_85 ,
V_319 |
F_149 ( V_10 , * V_318 , V_85 ) ) ;
}
...
F_148 ( V_10 ) ;
V_10 -> V_154 = 1 ;
F_152 ( V_10 , NULL , V_326 , V_327 ) ;
break;
default:
V_10 -> V_154 = 1 ;
F_152 ( V_10 , NULL , V_328 , V_327 ) ;
break;
}
switch ( V_10 -> V_142 >> 16 ) {
case 0x103c :
...
F_141 ( V_10 , V_300 ) ;
V_11 = F_153 ( V_10 , & V_2 -> V_6 . V_303 , NULL ,
V_2 -> V_312 ) ;
if ( V_11 < 0 )
goto error;
V_11 = F_154 ( V_10 , & V_2 -> V_6 . V_303 ) ;
if ( V_11 < 0 )
goto error;
V_10 -> V_122 = V_330 ;
if ( ! V_10 -> V_331 -> V_332 ) {
...
static int T_2 F_157 ( void )
{
return F_158 ( & V_334 ) ;
}
static void T_3 F_159 ( void )
{
F_160 ( & V_334 ) ;
}
