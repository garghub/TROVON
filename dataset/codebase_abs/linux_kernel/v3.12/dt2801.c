...
{
int V_16 ;
V_16 = F_24 ( V_2 , V_36 , V_38 , V_3 , 0xff ) ;
if ( V_16 )
return V_16 ;
F_8 ( V_2 , V_36 -> V_53 ? V_54 : V_55 ) ;
F_4 ( V_2 , ( V_36 == & V_2 -> V_49 [ 3 ] ) ? 1 : 0 ) ;
return V_38 -> V_41 ;
}
static int F_25 ( struct V_1 * V_2 , struct V_56 * V_57 )
{
const struct V_58 * V_59 = F_26 ( V_2 ) ;
struct V_43 * V_44 ;
struct V_35 * V_36 ;
int V_20 , type ;
int V_16 = 0 ;
int V_60 ;
V_16 = F_27 ( V_2 , V_57 -> V_61 [ 0 ] , V_62 ) ;
if ( V_16 )
return V_16 ;
V_20 = F_10 ( V_2 ) ;
if ( ! V_20 )
V_20 = F_10 ( V_2 ) ;
for ( type = 0 ; type < F_28 ( V_63 ) ; type ++ ) {
if ( V_63 [ type ] . V_64 == V_20 )
goto V_65;
}
F_9 ( L_14 ,
V_20 ) ;
...
V_36 -> V_75 = V_59 -> V_76 / 2 ;
#endif
V_36 -> V_77 = ( 1 << V_59 -> V_78 ) - 1 ;
V_36 -> V_79 = F_15 ( V_59 -> V_80 , V_57 -> V_61 [ 3 ] ) ;
V_36 -> V_81 = F_17 ;
V_36 = & V_2 -> V_49 [ 1 ] ;
V_36 -> type = V_82 ;
V_36 -> V_72 = V_83 ;
V_36 -> V_75 = 2 ;
V_36 -> V_77 = ( 1 << V_59 -> V_84 ) - 1 ;
V_36 -> V_85 = V_44 -> V_86 ;
V_44 -> V_86 [ 0 ] = F_14 ( V_57 -> V_61 [ 4 ] ) ;
V_44 -> V_86 [ 1 ] = F_14 ( V_57 -> V_61 [ 5 ] ) ;
V_36 -> V_81 = F_20 ;
V_36 -> V_87 = F_21 ;
V_36 = & V_2 -> V_49 [ 2 ] ;
V_36 -> type = V_88 ;
