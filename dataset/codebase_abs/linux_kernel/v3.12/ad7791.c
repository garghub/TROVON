...
V_18 = F_24 ( & V_66 -> V_40 , sizeof( * V_7 ) ) ;
if ( ! V_18 )
return - V_70 ;
V_7 = F_9 ( V_18 ) ;
V_7 -> V_36 = F_25 ( & V_66 -> V_40 , L_3 ) ;
if ( F_26 ( V_7 -> V_36 ) )
return F_27 ( V_7 -> V_36 ) ;
V_50 = F_28 ( V_7 -> V_36 ) ;
if ( V_50 )
return V_50 ;
V_7 -> V_23 = & V_71 [ F_29 ( V_66 ) -> V_72 ] ;
F_30 ( & V_7 -> V_3 , V_18 , V_66 , & V_73 ) ;
F_31 ( V_66 , V_18 ) ;
V_18 -> V_40 . V_74 = & V_66 -> V_40 ;
V_18 -> V_75 = F_29 ( V_66 ) -> V_75 ;
V_18 -> V_76 = V_77 ;
V_18 -> V_78 = V_7 -> V_23 -> V_78 ;
V_18 -> V_79 = V_7 -> V_23 -> V_79 ;
if ( V_7 -> V_23 -> V_58 & V_80 )
V_18 -> V_23 = & V_81 ;
else
V_18 -> V_23 = & V_82 ;
V_50 = F_32 ( V_18 ) ;
