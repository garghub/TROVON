...
if ( V_81 < 0 )
goto V_153;
V_81 = F_101 ( & V_65 -> V_35 , V_1 ) ;
F_63 ( V_65 , 0 ) ;
if ( V_81 < 0 )
goto V_153;
}
F_102 ( V_152 , & V_1 -> V_10 ) ;
F_4 ( V_1 ) -> V_24 ++ ;
F_4 ( V_1 ) -> V_130 = V_1 -> V_7 . V_19 ;
F_4 ( V_1 ) -> V_131 = V_1 -> V_7 . V_14 ;
if ( ! V_1 -> V_129 ) {
V_80 = 1 ;
F_33 ( F_31 () ) ;
V_81 = F_103 ( V_53 , NULL ,
F_26 ( V_53 ) + ( V_151 << V_37 -> V_58 ) ,
F_26 ( V_53 ) ) ;
if ( V_81 < 0 )
goto V_153;
}
...
static int F_107 ( struct V_36 * V_37 , int type )
{
T_6 * V_68 ;
int V_81 = 0 ;
struct V_31 * V_32 = F_11 ( V_37 , type ) -> V_34 ;
...
static struct V_1 * F_109 ( struct V_36 * V_37 , int type )
{
struct V_157 * V_1 =
F_110 ( V_158 , V_159 ) ;
if ( ! V_1 )
