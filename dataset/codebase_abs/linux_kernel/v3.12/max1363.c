...
if ( ! V_26 )
return - V_84 ;
V_26 -> V_50 . V_115 = V_12 -> V_50 . V_115 ;
V_31 = F_47 ( V_26 , V_12 -> V_50 . V_116 ) ;
if ( V_31 < 0 )
return V_31 ;
V_17 = F_7 ( V_26 ) ;
V_17 -> V_117 = F_48 ( & V_12 -> V_50 , L_2 ) ;
if ( F_49 ( V_17 -> V_117 ) ) {
V_31 = F_50 ( V_17 -> V_117 ) ;
goto V_118;
}
V_31 = F_51 ( V_17 -> V_117 ) ;
if ( V_31 )
goto V_118;
F_52 ( V_12 , V_26 ) ;
V_17 -> V_39 = & V_119 [ V_113 -> V_120 ] ;
V_17 -> V_12 = V_12 ;
V_17 -> V_46 = V_17 -> V_39 -> V_121 * 1000 ;
...
if ( V_31 )
goto V_122;
V_26 -> V_50 . V_123 = & V_12 -> V_50 ;
V_26 -> V_124 = V_113 -> V_124 ;
V_26 -> V_125 = V_17 -> V_39 -> V_125 ;
V_26 -> V_126 = V_17 -> V_39 -> V_126 ;
