...
void T_1 * V_9 ;
int V_85 = 0 ;
V_8 = F_28 ( & V_6 -> V_2 , sizeof( * V_8 ) , V_86 ) ;
if ( ! V_8 )
return - V_87 ;
V_82 = F_29 ( V_6 , V_88 , 0 ) ;
V_9 = F_30 ( & V_6 -> V_2 , V_82 ) ;
if ( F_31 ( V_9 ) )
return F_32 ( V_9 ) ;
V_8 -> V_9 = V_9 ;
V_8 -> V_58 = F_33 ( V_6 , 0 ) ;
...
V_66 = F_38 ( & V_6 -> V_2 , V_6 -> V_91 ,
& V_92 , V_93 ) ;
if ( F_31 ( V_66 ) )
return F_32 ( V_66 ) ;
V_8 -> V_66 = V_66 ;
V_85 = F_39 ( & V_6 -> V_2 . V_72 , & V_94 ) ;
return V_85 ;
}
static int F_40 ( struct V_5 * V_6 )
{
struct V_7 * V_8 = F_3 ( V_6 ) ;
F_41 ( & V_6 -> V_2 . V_72 , & V_94 ) ;
if ( V_8 -> V_58 > 0 )
F_5 ( 0 , V_8 -> V_9 + V_54 ) ;
return 0 ;
}
