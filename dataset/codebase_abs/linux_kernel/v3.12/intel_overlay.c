...
if ( ! V_41 -> V_22 )
return - V_49 ;
if ( F_53 ( V_3 -> V_5 ) -> V_149 < 4 &&
( F_20 ( F_54 ( V_41 -> V_122 ) ) & ( V_150 | V_151 ) ) != V_151 )
return - V_49 ;
return 0 ;
}
...
struct V_14 * V_5 = V_3 -> V_5 ;
T_2 * V_4 = V_5 -> V_6 ;
T_3 V_152 = F_20 ( V_153 ) ;
T_3 V_154 ;
if ( F_53 ( V_5 ) -> V_149 >= 4 ) {
V_154 = F_20 ( V_155 ) >> V_156 ;
} else {
if ( V_152 & V_157 )
V_154 = F_20 ( V_158 ) ;
else
...
static int F_57 ( struct V_60 * V_162 )
{
T_3 V_33 ;
...
static int F_58 ( struct V_14 * V_5 ,
struct V_161 * V_162 ,
struct V_36 * V_108 )
{
...
static int F_60 ( struct V_14 * V_5 )
{
struct V_21 * V_4 = V_5 -> V_6 ;
T_3 V_152 ;
if ( F_15 ( V_5 ) )
...
V_61 = F_66 ( sizeof( struct V_60 ) , V_191 ) ;
if ( ! V_61 )
return - V_119 ;
...
if ( ! F_82 ( V_5 ) )
return;
V_3 = F_83 ( sizeof( struct V_2 ) , V_191 ) ;
if ( ! V_3 )
return;
F_63 ( & V_5 -> V_114 ) ;
if ( F_14 ( V_4 -> V_3 ) )
