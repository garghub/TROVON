...
static int F_105 ( struct V_228 * V_261 )
{
struct V_37 * V_38 ;
...
V_314 = V_88 - V_313 ;
V_312 = 0 ;
for ( V_38 = V_4 -> V_5 -> V_114 ; V_38 != NULL ; V_38 = V_38 -> V_322 ) {
struct V_82 * V_82 ;
const char * V_323 ;
V_82 = V_38 -> V_201 ;
if ( ! V_82 )
continue;
V_323 = F_108 ( & V_82 -> V_324 , V_318 , V_314 ) ;
if ( F_44 ( V_323 ) ) {
if ( F_43 ( V_323 ) == - V_325 ) {
F_109 ( V_239 ) ;
V_88 = V_88 * 5 / 4 ;
...
V_315 = ( V_318 + V_314 ) - V_323 ;
V_314 = V_323 - V_318 ;
memmove ( V_318 , V_323 , V_315 ) ;
V_318 += V_315 ;
* V_316 ++ = V_38 -> V_212 ;
* V_316 ++ = V_38 -> V_227 ;
* V_316 ++ = V_38 -> V_209 ;
...
if ( V_315 != 0 ) {
unsigned V_326 = V_315 * 3 * sizeof( V_239 [ 0 ] ) ;
memmove ( V_317 - V_326 , V_317 ,
V_318 - V_317 ) ;
V_318 -= V_326 ;
}
V_88 = V_318 - ( char * ) V_239 ;
F_84 ( V_261 , L_2 , V_327 , V_88 , V_239 ) ;
return 0 ;
}
static void F_110 ( struct V_264 * V_328 ,
const struct V_329 * V_330 )
{
if ( V_330 -> V_331 )
V_330 -> V_331 ( V_328 , V_330 , 1 ) ;
}
static int F_111 ( struct V_332 * V_333 ,
const struct V_334 * V_335 ,
long V_265 , T_2 * V_336 )
{
unsigned int V_95 ;
F_85 ( & V_333 -> V_263 , V_333 -> V_328 , V_265 ) ;
( void ) V_335 -> V_337 [ 0 ] . F_112 ( V_333 -> V_328 , & V_335 -> V_337 [ 0 ] ,
0 , F_113 ( V_333 -> V_263 . V_338 ) ,
F_114 ( & V_333 -> V_263 ) , NULL ) ;
F_84 ( & V_333 -> V_339 [ 0 ] , L_2 , V_340 ,
F_115 ( V_333 -> V_263 ) , & V_333 -> V_263 ) ;
* V_336 += F_77 ( & V_333 -> V_339 [ 0 ] ) ;
F_110 ( V_333 -> V_328 , & V_335 -> V_337 [ 0 ] ) ;
for ( V_95 = 1 ; V_95 < V_335 -> V_315 ; ++ V_95 ) {
const struct V_329 * V_330 = & V_335 -> V_337 [ V_95 ] ;
F_110 ( V_333 -> V_328 , V_330 ) ;
if ( V_330 -> V_341 && V_330 -> F_112 &&
( ! V_330 -> V_342 || V_330 -> V_342 ( V_333 -> V_328 , V_330 ) ) ) {
int V_343 ;
T_2 V_88 = V_330 -> V_315 * V_330 -> V_88 ;
void * V_239 = F_34 ( V_88 , V_116 ) ;
if ( F_52 ( ! V_239 ) )
return 0 ;
V_343 = V_330 -> F_112 ( V_333 -> V_328 , V_330 ,
0 , V_88 , V_239 , NULL ) ;
if ( F_52 ( V_343 ) )
F_36 ( V_239 ) ;
else {
if ( V_330 -> V_341 != V_344 )
F_84 ( & V_333 -> V_339 [ V_95 ] , L_3 ,
V_330 -> V_341 ,
V_88 , V_239 ) ;
else {
F_116 ( & V_333 -> V_263 , 1 ) ;
F_84 ( & V_333 -> V_339 [ V_95 ] , L_2 ,
V_344 , V_88 , V_239 ) ;
}
* V_336 += F_77 ( & V_333 -> V_339 [ V_95 ] ) ;
}
}
}
return 1 ;
}
static int F_117 ( struct V_15 * V_240 , int V_345 ,
struct V_346 * V_347 ,
T_12 * V_308 , struct V_156 * V_157 )
{
struct V_264 * V_348 = V_4 ;
const struct V_334 * V_335 = F_118 ( V_348 ) ;
struct V_332 * V_333 ;
struct V_289 * V_290 ;
struct V_349 * V_350 ;
unsigned int V_95 ;
...
if ( V_290 == NULL ) {
V_347 -> V_290 . V_239 = NULL ;
return 0 ;
}
F_84 ( & V_347 -> V_290 , L_2 , V_352 , sizeof( * V_290 ) , V_290 ) ;
V_347 -> V_353 = 0 ;
for ( V_95 = 0 ; V_95 < V_335 -> V_315 ; ++ V_95 )
if ( V_335 -> V_337 [ V_95 ] . V_341 != 0 )
++ V_347 -> V_353 ;
if ( F_52 ( V_347 -> V_353 == 0 ) ||
F_52 ( V_335 -> V_337 [ 0 ] . V_341 != V_340 ) ) {
F_119 ( 1 ) ;
return 0 ;
}
F_82 ( V_240 , V_345 ,
V_335 -> V_252 , V_335 -> V_254 ) ;
for ( V_350 = & V_348 -> V_5 -> V_354 -> V_355 ; V_350 ; V_350 = V_350 -> V_356 ) {
V_333 = F_120 ( F_121 ( struct V_332 ,
V_339 [ V_347 -> V_353 ] ) ,
V_116 ) ;
if ( F_52 ( ! V_333 ) )
return 0 ;
V_333 -> V_328 = V_350 -> V_328 ;
if ( V_350 -> V_328 == V_348 || ! V_347 -> V_351 ) {
V_333 -> V_356 = V_347 -> V_351 ;
V_347 -> V_351 = V_333 ;
} else {
V_333 -> V_356 = V_347 -> V_351 -> V_356 ;
V_347 -> V_351 -> V_356 = V_333 ;
}
}
for ( V_333 = V_347 -> V_351 ; V_333 != NULL ; V_333 = V_333 -> V_356 )
if ( ! F_111 ( V_333 , V_335 , V_308 -> V_267 , & V_347 -> V_88 ) )
return 0 ;
F_95 ( V_290 , V_348 -> V_357 , V_348 -> V_5 ) ;
V_347 -> V_88 += F_77 ( & V_347 -> V_290 ) ;
F_103 ( & V_347 -> V_358 , & V_347 -> V_307 , V_308 ) ;
V_347 -> V_88 += F_77 ( & V_347 -> V_358 ) ;
F_102 ( & V_347 -> V_304 , V_4 -> V_5 ) ;
V_347 -> V_88 += F_77 ( & V_347 -> V_304 ) ;
if ( F_105 ( & V_347 -> V_359 ) == 0 )
V_347 -> V_88 += F_77 ( & V_347 -> V_359 ) ;
return 1 ;
}
static T_2 F_122 ( struct V_346 * V_347 )
{
return V_347 -> V_88 ;
}
static int F_123 ( struct V_346 * V_347 ,
struct V_82 * V_82 , T_8 * V_234 )
{
bool V_360 = 1 ;
struct V_332 * V_333 = V_347 -> V_351 ;
do {
int V_95 ;
if ( ! F_81 ( & V_333 -> V_339 [ 0 ] , V_82 , V_234 ) )
return 0 ;
if ( V_360 && ! F_81 ( & V_347 -> V_290 , V_82 , V_234 ) )
return 0 ;
if ( V_360 && ! F_81 ( & V_347 -> V_358 , V_82 , V_234 ) )
return 0 ;
if ( V_360 && ! F_81 ( & V_347 -> V_304 , V_82 , V_234 ) )
return 0 ;
if ( V_360 && V_347 -> V_359 . V_239 &&
! F_81 ( & V_347 -> V_359 , V_82 , V_234 ) )
return 0 ;
for ( V_95 = 1 ; V_95 < V_347 -> V_353 ; ++ V_95 )
if ( V_333 -> V_339 [ V_95 ] . V_239 &&
! F_81 ( & V_333 -> V_339 [ V_95 ] , V_82 , V_234 ) )
return 0 ;
V_360 = 0 ;
V_333 = V_333 -> V_356 ;
} while ( V_333 );
...
static void F_124 ( struct V_346 * V_347 )
{
struct V_332 * V_361 = V_347 -> V_351 ;
while ( V_361 ) {
unsigned int V_95 ;
struct V_332 * V_333 = V_361 ;
V_361 = V_333 -> V_356 ;
F_119 ( V_333 -> V_339 [ 0 ] . V_239 && V_333 -> V_339 [ 0 ] . V_239 != & V_333 -> V_263 ) ;
for ( V_95 = 1 ; V_95 < V_347 -> V_353 ; ++ V_95 )
F_36 ( V_333 -> V_339 [ V_95 ] . V_239 ) ;
F_36 ( V_333 ) ;
}
F_36 ( V_347 -> V_290 . V_239 ) ;
F_109 ( V_347 -> V_359 . V_239 ) ;
}
static int F_125 ( long V_265 , struct V_362 * V_333 )
{
int V_230 = 0 ;
struct V_264 * V_19 = V_333 -> V_351 ;
V_333 -> V_363 = 0 ;
F_85 ( & V_333 -> V_263 , V_19 , V_265 ) ;
F_126 ( V_19 , & V_333 -> V_263 . V_338 ) ;
F_84 ( & V_333 -> V_339 [ 0 ] , L_2 , V_340 , sizeof( V_333 -> V_263 ) ,
& ( V_333 -> V_263 ) ) ;
V_333 -> V_363 ++ ;
V_230 += F_77 ( & V_333 -> V_339 [ 0 ] ) ;
if ( ( V_333 -> V_263 . V_364 = F_127 ( V_19 , NULL ,
& V_333 -> V_365 ) ) ) {
F_84 ( & V_333 -> V_339 [ 1 ] , L_2 , V_344 , sizeof( V_333 -> V_365 ) ,
& ( V_333 -> V_365 ) ) ;
V_333 -> V_363 ++ ;
V_230 += F_77 ( & V_333 -> V_339 [ 1 ] ) ;
}
#ifdef F_128
if ( F_129 ( V_19 , & V_333 -> V_366 ) ) {
F_84 ( & V_333 -> V_339 [ 2 ] , L_3 , V_367 ,
sizeof( V_333 -> V_366 ) , & V_333 -> V_366 ) ;
V_333 -> V_363 ++ ;
V_230 += F_77 ( & V_333 -> V_339 [ 2 ] ) ;
}
#endif
return V_230 ;
}
static int F_130 ( struct V_346 * V_347 )
{
memset ( V_347 , 0 , sizeof( * V_347 ) ) ;
F_131 ( & V_347 -> V_368 ) ;
V_347 -> V_339 = F_34 ( 8 * sizeof( struct V_228 ) , V_116 ) ;
if ( ! V_347 -> V_339 )
return 0 ;
V_347 -> V_290 = F_34 ( sizeof( * V_347 -> V_290 ) , V_116 ) ;
if ( ! V_347 -> V_290 )
return 0 ;
V_347 -> V_263 = F_34 ( sizeof( * V_347 -> V_263 ) , V_116 ) ;
if ( ! V_347 -> V_263 )
return 0 ;
V_347 -> V_365 = F_34 ( sizeof( * V_347 -> V_365 ) , V_116 ) ;
if ( ! V_347 -> V_365 )
return 0 ;
#ifdef F_128
V_347 -> V_366 = F_34 ( sizeof( * V_347 -> V_366 ) , V_116 ) ;
if ( ! V_347 -> V_366 )
return 0 ;
#endif
return 1 ;
...
struct V_349 * V_350 ;
struct V_362 * V_370 ;
for ( V_350 = V_4 -> V_5 -> V_354 -> V_355 . V_356 ;
V_350 ; V_350 = V_350 -> V_356 ) {
V_370 = F_120 ( sizeof( * V_370 ) , V_116 ) ;
if ( ! V_370 )
return 0 ;
V_370 -> V_351 = V_350 -> V_328 ;
F_132 ( & V_370 -> V_371 , & V_347 -> V_368 ) ;
}
F_133 (t, &info->thread_list) {
int V_230 ;
V_370 = F_134 ( V_333 , struct V_362 , V_371 ) ;
V_230 = F_125 ( V_308 -> V_267 , V_370 ) ;
V_347 -> V_372 += V_230 ;
}
}
memset ( V_347 -> V_263 , 0 , sizeof( * V_347 -> V_263 ) ) ;
F_85 ( V_347 -> V_263 , V_4 , V_308 -> V_267 ) ;
F_135 ( & V_347 -> V_263 -> V_338 , V_157 ) ;
F_82 ( V_240 , V_345 , V_373 , V_374 ) ;
F_84 ( V_347 -> V_339 + 0 , L_2 , V_340 ,
sizeof( * V_347 -> V_263 ) , V_347 -> V_263 ) ;
F_95 ( V_347 -> V_290 , V_4 -> V_357 , V_4 -> V_5 ) ;
F_84 ( V_347 -> V_339 + 1 , L_2 , V_352 ,
sizeof( * V_347 -> V_290 ) , V_347 -> V_290 ) ;
F_103 ( V_347 -> V_339 + 2 , & V_347 -> V_307 , V_308 ) ;
F_102 ( V_347 -> V_339 + 3 , V_4 -> V_5 ) ;
V_347 -> V_375 = 4 ;
if ( F_105 ( V_347 -> V_339 + V_347 -> V_375 ) == 0 ) {
V_347 -> V_376 = V_347 -> V_339 + V_347 -> V_375 ;
V_347 -> V_375 ++ ;
}
V_347 -> V_263 -> V_364 = F_127 ( V_4 , V_157 ,
V_347 -> V_365 ) ;
if ( V_347 -> V_263 -> V_364 )
F_84 ( V_347 -> V_339 + V_347 -> V_375 ++ ,
L_2 , V_344 , sizeof( * V_347 -> V_365 ) , V_347 -> V_365 ) ;
#ifdef F_128
if ( F_129 ( V_4 , V_347 -> V_366 ) )
F_84 ( V_347 -> V_339 + V_347 -> V_375 ++ ,
L_3 , V_367 ,
sizeof( * V_347 -> V_366 ) , V_347 -> V_366 ) ;
#endif
return 1 ;
}
static T_2 F_122 ( struct V_346 * V_347 )
...
int V_230 = 0 ;
int V_95 ;
for ( V_95 = 0 ; V_95 < V_347 -> V_375 ; V_95 ++ )
V_230 += F_77 ( V_347 -> V_339 + V_95 ) ;
V_230 += V_347 -> V_372 ;
return V_230 ;
}
static int F_123 ( struct V_346 * V_347 ,
...
struct V_369 * V_333 ;
for ( V_95 = 0 ; V_95 < V_347 -> V_375 ; V_95 ++ )
if ( ! F_81 ( V_347 -> V_339 + V_95 , V_82 , V_234 ) )
return 0 ;
F_133 (t, &info->thread_list) {
struct V_362 * V_377 =
F_134 ( V_333 , struct V_362 , V_371 ) ;
for ( V_95 = 0 ; V_95 < V_377 -> V_363 ; V_95 ++ )
if ( ! F_81 ( & V_377 -> V_339 [ V_95 ] , V_82 , V_234 ) )
return 0 ;
}
return 1 ;
}
static void F_124 ( struct V_346 * V_347 )
{
while ( ! F_136 ( & V_347 -> V_368 ) ) {
struct V_369 * V_377 = V_347 -> V_368 . V_356 ;
F_137 ( V_377 ) ;
F_36 ( F_134 ( V_377 , struct V_362 , V_371 ) ) ;
}
if ( V_347 -> V_376 )
F_109 ( V_347 -> V_376 -> V_239 ) ;
F_36 ( V_347 -> V_263 ) ;
F_36 ( V_347 -> V_290 ) ;
F_36 ( V_347 -> V_339 ) ;
F_36 ( V_347 -> V_365 ) ;
...
struct V_37 * V_379 )
{
struct V_37 * V_343 = V_378 -> V_5 -> V_114 ;
if ( V_343 )
return V_343 ;
return V_379 ;
}
...
if ( ! F_117 ( V_240 , V_52 , & V_347 , V_394 -> V_308 , V_394 -> V_157 ) )
goto V_399;
V_395 = 1 ;
V_214 = F_73 () ;
F_75 ( V_310 ) ;
...
goto V_400;
if ( ! F_123 ( & V_347 , V_394 -> V_82 , & V_234 ) )
goto V_400;
