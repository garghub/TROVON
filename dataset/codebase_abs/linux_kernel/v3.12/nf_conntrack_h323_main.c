...
memcmp ( & V_30 , & V_5 -> V_50 [ ! V_13 ] . V_51 . V_52 . V_53 , sizeof( V_30 ) ) ) {
F_6 ( L_26 ,
& V_30 , F_42 ( V_31 ) , & V_5 -> V_50 [ ! V_13 ] . V_51 . V_52 . V_53 ,
F_42 ( V_5 -> V_50 [ ! V_13 ] . V_51 . V_52 . V_159 . V_160 . V_31 ) ) ;
...
F_6 ( L_27 ,
& V_30 , F_42 ( V_31 ) , & V_5 -> V_50 [ ! V_13 ] . V_51 . V_55 . V_53 ,
F_42 ( V_5 -> V_50 [ ! V_13 ] . V_51 . V_55 . V_159 . V_160 . V_31 ) ) ;
V_43 = V_153 ( V_2 , V_3 , V_8 , V_10 ,
& V_151 -> V_162 ,
& V_5 -> V_50 [ ! V_13 ] . V_51 . V_55 . V_53 ,
...
case V_191 :
V_43 = F_41 ( V_2 , V_5 , V_7 , V_3 , V_8 , V_10 ,
& V_187 -> V_190 . V_151 ) ;
break;
case V_192 :
V_43 = F_43 ( V_2 , V_5 , V_7 ,
V_3 , V_8 , V_10 ,
& V_187 -> V_190 .
V_193 ) ;
break;
...
static int F_49 ( struct V_1 * V_2 , unsigned int V_3 ,
struct V_4 * V_5 , enum V_6 V_7 )
{
static T_16 V_186 ;
unsigned char * V_8 = NULL ;
...
static unsigned char * F_51 ( struct V_1 * V_2 , unsigned int V_3 ,
int * V_9 )
{
...
static struct V_46 * F_52 ( struct V_4 * V_5 ,
union V_29 * V_30 ,
T_2 V_31 )
{
struct V_204 * V_204 = F_53 ( V_5 ) ;
struct V_46 * exp ;
struct V_205 V_51 ;
...
V_51 . V_55 . V_206 = V_62 ;
exp = F_54 ( V_204 , F_55 ( V_5 ) , & V_51 ) ;
if ( exp && exp -> V_207 == V_5 )
return exp ;
return NULL ;
}
static int F_56 ( struct V_46 * exp ,
unsigned int V_208 )
{
if ( ! exp || ! F_57 ( & exp -> V_208 ) )
return 0 ;
exp -> V_208 . V_209 = V_210 + V_208 * V_211 ;
F_58 ( & exp -> V_208 ) ;
return 1 ;
}
...
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_18 * V_216 )
{
F_10 (set_ras_addr_hook) V_217 ;
F_6 ( L_39 ) ;
V_217 = F_15 ( V_218 ) ;
if ( V_217 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 )
return V_217 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
& V_216 -> V_219 , 1 ) ;
return 0 ;
}
...
struct V_46 * exp ;
F_6 ( L_40 ) ;
if ( ! F_29 ( V_5 , * V_8 , & V_220 -> V_219 , & V_30 , & V_31 ) )
return 0 ;
if ( ! memcmp ( & V_30 , & V_5 -> V_50 [ V_13 ] . V_51 . V_52 . V_53 , sizeof( V_30 ) ) &&
V_31 == V_5 -> V_50 [ V_13 ] . V_51 . V_52 . V_159 . V_221 . V_31 )
return 0 ;
if ( F_62 ( V_222 , & V_5 -> V_59 ) )
return 0 ;
if ( ( exp = F_12 ( V_5 ) ) == NULL )
return - 1 ;
F_13 ( exp , V_54 , F_8 ( V_5 ) ,
...
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_20 * V_224 )
{
struct V_11 * V_12 = F_2 ( V_5 ) ;
int V_43 ;
F_10 (set_ras_addr_hook) V_217 ;
F_6 ( L_42 ) ;
V_43 = F_59 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
V_224 -> V_225 . V_166 ,
V_224 -> V_225 . V_165 ) ;
if ( V_43 < 0 )
return - 1 ;
...
if ( V_217 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 ) {
V_43 = V_217 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
V_224 -> V_219 . V_166 ,
V_224 -> V_219 . V_165 ) ;
if ( V_43 < 0 )
return - 1 ;
...
if ( V_224 -> V_67 & V_226 ) {
F_6 ( L_43 , V_224 -> V_227 ) ;
V_12 -> V_208 = V_224 -> V_227 ;
} else
V_12 -> V_208 = V_228 ;
return 0 ;
}
...
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_21 * V_229 )
{
struct V_11 * V_12 = F_2 ( V_5 ) ;
int V_13 = F_3 ( V_7 ) ;
int V_43 ;
struct V_46 * exp ;
F_10 (set_sig_addr_hook) V_230 ;
F_6 ( L_44 ) ;
V_230 = F_15 ( V_231 ) ;
if ( V_230 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 ) {
V_43 = V_230 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
V_229 -> V_225 . V_166 ,
V_229 -> V_225 . V_165 ) ;
if ( V_43 < 0 )
return - 1 ;
...
if ( V_229 -> V_67 & V_232 ) {
F_6 ( L_45 , V_229 -> V_227 ) ;
V_12 -> V_208 = V_229 -> V_227 ;
}
if ( V_12 -> V_208 > 0 ) {
F_6 ( L_46
L_47 , V_12 -> V_208 ) ;
F_65 ( V_5 , V_2 , V_12 -> V_208 * V_211 ) ;
F_25 ( & V_233 ) ;
exp = F_52 ( V_5 , & V_5 -> V_50 [ V_13 ] . V_51 . V_55 . V_53 ,
V_12 -> V_215 [ ! V_13 ] ) ;
if ( exp ) {
F_6 ( L_48
L_49 ,
...
V_12 -> V_215 [ V_13 ] = 0 ;
V_12 -> V_215 [ ! V_13 ] = 0 ;
F_65 ( V_5 , V_2 , 30 * V_211 ) ;
return 0 ;
}
static int F_68 ( struct V_1 * V_2 , struct V_4 * V_5 ,
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_23 * V_235 )
{
...
V_153 = F_15 ( V_156 ) ;
if ( ( V_235 -> V_67 & V_236 ) &&
F_29 ( V_5 , * V_8 , & V_235 -> V_158 ,
& V_30 , & V_31 ) &&
! memcmp ( & V_30 , & V_5 -> V_50 [ V_13 ] . V_51 . V_52 . V_53 , sizeof( V_30 ) ) &&
V_31 == V_12 -> V_215 [ V_13 ] &&
F_8 ( V_5 ) == V_58 &&
V_153 && V_5 -> V_59 & V_60 ) {
...
if ( V_230 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 )
return V_230 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
& V_239 -> V_158 , 1 ) ;
return 0 ;
}
if ( ( exp = F_12 ( V_5 ) ) == NULL )
...
static int F_73 ( struct V_1 * V_2 , struct V_4 * V_5 ,
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_28 * V_244 )
{
switch ( V_244 -> V_33 ) {
case V_245 :
...
& V_244 -> V_248 ) ;
case V_249 :
return F_63 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
& V_244 -> V_250 ) ;
case V_251 :
...
& V_244 -> V_260 ) ;
case V_261 :
return F_71 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
& V_244 -> V_262 ) ;
case V_263 :
return F_72 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
& V_244 -> V_264 ) ;
default:
F_6 ( L_56 , V_244 -> V_33 ) ;
break;
...
F_6 ( L_57 , V_2 -> V_23 ) ;
F_25 ( & V_116 ) ;
V_8 = F_51 ( V_2 , V_3 , & V_9 ) ;
if ( V_8 == NULL )
goto V_265;
F_6 ( L_58 , V_9 ) ;
F_17 ( & V_5 -> V_50 [ F_3 ( V_7 ) ] . V_51 ) ;
V_43 = F_75 ( V_8 , V_9 , & V_244 ) ;
if ( V_43 < 0 ) {
F_6 ( L_59 ,
V_43 == V_117 ?
L_19 : L_20 ) ;
...
if ( F_73 ( V_2 , V_5 , V_7 , V_3 , & V_8 , & V_244 ) < 0 )
goto V_118;
V_265:
F_27 ( & V_116 ) ;
return V_115 ;
...
static int T_30 F_79 ( void )
{
int V_43 ;
V_25 = F_80 ( 65536 , V_266 ) ;
if ( ! V_25 )
return - V_267 ;
V_43 = F_81 ( & V_127 ) ;
if ( V_43 < 0 )
