...
static void F_45 ( unsigned int V_61 )
{
if ( V_61 > V_60 ) {
while ( V_60 < V_61 ) {
if ( F_39 () )
...
static void F_46 ( unsigned int V_62 )
{
F_47 () ;
V_62 = F_48 (unsigned int, num_cpus, num_online_cpus()) ;
F_45 ( V_62 ) ;
F_49 () ;
}
...
static T_4 F_51 ( struct V_63 * V_64 ,
struct V_65 * V_66 , const char * V_67 , T_5 V_68 )
{
unsigned long V_61 ;
if ( F_52 ( V_67 , 0 , & V_61 ) )
return - V_69 ;
...
static T_4 F_53 ( struct V_63 * V_64 ,
struct V_65 * V_66 , char * V_67 )
{
return F_54 ( V_67 , V_71 , L_3 , V_48 ) ;
}
static T_4 F_55 ( struct V_63 * V_64 ,
struct V_65 * V_66 , const char * V_67 , T_5 V_68 )
{
unsigned long V_61 ;
if ( F_52 ( V_67 , 0 , & V_61 ) )
...
static T_4 F_56 ( struct V_63 * V_64 ,
struct V_65 * V_66 , char * V_67 )
{
return F_54 ( V_67 , V_71 , L_3 , V_51 ) ;
}
static T_4 F_57 ( struct V_63 * V_64 ,
struct V_65 * V_66 , const char * V_67 , T_5 V_68 )
{
unsigned long V_61 ;
if ( F_52 ( V_67 , 0 , & V_61 ) )
...
static T_4 F_58 ( struct V_63 * V_64 ,
struct V_65 * V_66 , char * V_67 )
{
int V_72 = 0 ;
V_72 = F_59 ( V_67 , V_71 - 2 , F_6 ( V_28 ) ) ;
V_67 [ V_72 ++ ] = '\n' ;
V_67 [ V_72 ] = '\0' ;
return V_72 ;
}
static int F_60 ( struct V_73 * V_63 )
{
int V_74 ;
V_74 = F_61 ( & V_63 -> V_64 , & V_75 ) ;
if ( V_74 )
return - V_76 ;
V_74 = F_61 ( & V_63 -> V_64 , & V_77 ) ;
if ( V_74 ) {
F_62 ( & V_63 -> V_64 , & V_75 ) ;
return - V_76 ;
}
V_74 = F_61 ( & V_63 -> V_64 , & V_78 ) ;
if ( V_74 ) {
F_62 ( & V_63 -> V_64 , & V_75 ) ;
F_62 ( & V_63 -> V_64 , & V_77 ) ;
return - V_76 ;
...
static void F_63 ( struct V_73 * V_63 )
{
F_62 ( & V_63 -> V_64 , & V_75 ) ;
F_62 ( & V_63 -> V_64 , & V_77 ) ;
F_62 ( & V_63 -> V_64 , & V_78 ) ;
...
V_61 = V_84 -> V_84 . V_88 [ 1 ] . integer . V_89 ;
F_67 ( V_81 . V_86 ) ;
return V_61 ;
}
...
void * V_40 )
{
struct V_73 * V_63 = V_40 ;
switch ( V_98 ) {
case V_97 :
F_69 ( V_79 ) ;
F_71 ( V_63 -> V_99 . V_100 ,
F_72 ( & V_63 -> V_64 ) , V_98 , 0 ) ;
break;
default:
F_73 ( L_6 , V_98 ) ;
break;
...
static int F_74 ( struct V_73 * V_63 )
{
T_8 V_101 ;
strcpy ( F_75 ( V_63 ) , V_102 ) ;
strcpy ( F_76 ( V_63 ) , V_103 ) ;
if ( F_60 ( V_63 ) )
return - V_76 ;
V_101 = F_77 ( V_63 -> V_79 ,
V_104 , F_70 , V_63 ) ;
if ( F_65 ( V_101 ) ) {
F_63 ( V_63 ) ;
return - V_76 ;
...
static int F_78 ( struct V_73 * V_63 )
{
F_8 ( & V_70 ) ;
F_46 ( 0 ) ;
F_15 ( & V_70 ) ;
