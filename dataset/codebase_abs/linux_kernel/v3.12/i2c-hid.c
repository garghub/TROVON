...
struct V_127 V_34 = { V_128 , NULL } ;
union V_129 V_130 [ 4 ] , * V_131 ;
struct V_132 V_133 ;
struct V_134 * V_135 ;
T_5 V_136 ;
V_136 = F_56 ( & V_2 -> V_45 ) ;
if ( ! V_136 || F_57 ( V_136 , & V_135 ) )
return - V_121 ;
V_133 . V_89 = F_58 ( V_130 ) ;
V_133 . V_137 = V_130 ;
V_130 [ 0 ] . type = V_138 ;
V_130 [ 0 ] . V_76 . V_18 = sizeof( V_126 ) ;
V_130 [ 0 ] . V_76 . V_137 = V_126 ;
V_130 [ 1 ] . type = V_139 ;
V_130 [ 1 ] . integer . V_140 = 1 ;
V_130 [ 2 ] . type = V_139 ;
V_130 [ 2 ] . integer . V_140 = 1 ;
V_130 [ 3 ] . type = V_141 ;
V_130 [ 3 ] . V_142 . V_89 = 0 ;
V_130 [ 3 ] . V_142 . V_143 = NULL ;
if ( F_59 ( F_60 ( V_136 , L_35 , & V_133 , & V_34 ) ) ) {
F_13 ( & V_2 -> V_45 , L_36 ) ;
return - V_121 ;
}
V_131 = (union V_129 * ) V_34 . V_137 ;
if ( V_131 -> type != V_139 ) {
F_13 ( & V_2 -> V_45 , L_37 ,
V_131 -> type ) ;
F_29 ( V_34 . V_137 ) ;
...
V_125 -> V_144 = V_131 -> integer . V_140 ;
F_29 ( V_34 . V_137 ) ;
return 0 ;
}
...
T_6 V_145 ;
int V_14 ;
V_14 = F_62 ( V_45 -> V_146 , L_38 , & V_145 ) ;
if ( V_14 ) {
F_13 ( & V_2 -> V_45 , L_39 ) ;
return - V_121 ;
}
...
const struct V_147 * V_69 )
{
int V_14 ;
struct V_10 * V_11 ;
struct V_78 * V_66 ;
V_86 V_148 ;
struct V_124 * V_149 = V_2 -> V_45 . V_149 ;
F_39 ( L_41 , V_2 -> V_30 ) ;
if ( ! V_2 -> V_68 ) {
F_13 ( & V_2 -> V_45 ,
L_42 ) ;
...
F_64 ( V_2 , V_11 ) ;
V_11 -> V_2 = V_2 ;
V_148 = V_11 -> V_125 . V_144 ;
V_11 -> V_24 = F_65 ( V_148 ) ;
F_66 ( & V_11 -> V_19 ) ;
...
V_66 -> V_154 = F_33 ;
V_66 -> V_155 = F_35 ;
V_66 -> V_45 . V_156 = & V_2 -> V_45 ;
F_70 ( & V_66 -> V_45 , F_56 ( & V_2 -> V_45 ) ) ;
V_66 -> V_157 = V_158 ;
V_66 -> V_159 = F_12 ( V_11 -> V_42 . V_123 ) ;
V_66 -> V_160 = F_12 ( V_11 -> V_42 . V_161 ) ;
V_66 -> V_162 = F_12 ( V_11 -> V_42 . V_163 ) ;
snprintf ( V_66 -> V_119 , sizeof( V_66 -> V_119 ) , L_43 ,
V_2 -> V_119 , V_66 -> V_160 , V_66 -> V_162 ) ;
V_14 = F_71 ( V_66 ) ;
if ( V_14 ) {
if ( V_14 != - V_121 )
F_41 ( V_2 , L_44 , V_14 ) ;
...
static int F_75 ( struct V_73 * V_45 )
{
struct V_1 * V_2 = F_76 ( V_45 ) ;
if ( F_77 ( & V_2 -> V_45 ) )
F_78 ( V_2 -> V_68 ) ;
F_15 ( V_2 , V_61 ) ;
return 0 ;
