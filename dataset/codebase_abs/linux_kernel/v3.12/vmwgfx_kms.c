...
F_97 ( V_25 , V_287 + V_8 * 3 + 0 , V_283 [ V_8 ] >> 8 ) ;
F_97 ( V_25 , V_287 + V_8 * 3 + 1 , V_284 [ V_8 ] >> 8 ) ;
F_97 ( V_25 , V_287 + V_8 * 3 + 2 , V_285 [ V_8 ] >> 8 ) ;
}
}
...
enum V_288
F_107 ( struct V_266 * V_23 , bool V_289 )
{
T_6 V_251 ;
...
F_33 ( & V_25 -> V_290 ) ;
V_251 = F_99 ( V_25 , V_291 ) ;
F_28 ( & V_25 -> V_290 ) ;
return ( ( F_106 ( V_23 ) -> V_137 < V_251 &&
V_18 -> V_270 ) ?
V_292 : V_293 ) ;
}
static void F_120 ( struct V_294 * V_139 )
{
...
if ( V_18 -> V_304 ) {
F_127 ( & V_18 -> V_304 -> V_114 ) ;
F_126 ( V_66 , V_18 -> V_304 ) ;
}
V_18 -> V_304 = V_139 ;
}
...
if ( V_18 -> V_304 )
F_128 ( & V_18 -> V_304 -> V_114 , & V_23 -> V_306 ) ;
F_129 ( V_23 ) ;
return 1 ;
}
...
V_2 = F_132 ( V_228 -> V_314 , sizeof( struct V_210 ) ,
V_133 ) ;
if ( F_12 ( ! V_2 ) ) {
V_47 = - V_36 ;
goto V_316;
