...
if ( V_20 >= F_2 ( V_19 ) ) {
V_5 = V_20 - F_2 ( V_19 ) ;
return F_51 ( V_18 , V_5 , V_45 , V_46 ) ;
}
V_1 = & V_19 [ V_20 ] ;
if ( V_1 -> V_11 == 1 ) {
V_5 = V_1 -> V_10 [ 0 ] ;
V_53 = F_51 ( V_18 , V_5 , V_45 , V_46 ) ;
if ( V_53 != - V_109 )
return V_53 ;
}
for ( V_123 = 0 ; V_123 < V_46 ; V_123 ++ ) {
V_96 = F_49 ( V_45 [ V_123 ] ) ;
F_43 ( V_18 -> V_28 , L_14 ,
V_90 , V_1 -> V_21 , V_45 [ V_123 ] ) ;
V_53 = F_53 ( V_18 , V_1 , V_96 , true , & V_14 ,
& V_83 , & V_79 , & V_72 , & V_31 ) ;
if ( V_53 < 0 ) {
for ( V_50 = 0 , V_122 = V_1 -> V_10 ; V_50 < V_1 -> V_11 ; ++ V_50 , ++ V_122 ) {
V_53 = F_51 ( V_18 , * V_122 , V_45 ,
V_46 ) ;
if ( V_53 )
return V_53 ;
}
...
struct V_12 * V_13 ;
struct V_127 * V_128 ;
V_13 = F_57 ( & V_126 -> V_28 , sizeof( * V_13 ) , V_38 ) ;
if ( ! V_13 ) {
F_15 ( & V_126 -> V_28 , L_16 ) ;
return - V_39 ;
}
V_13 -> V_28 = & V_126 -> V_28 ;
F_58 ( & V_13 -> V_73 ) ;
V_129 . V_21 = F_12 ( & V_126 -> V_28 ) ;
V_129 . V_10 = V_22 ;
V_129 . V_11 = F_2 ( V_22 ) ;
V_128 = F_59 ( V_126 , V_130 , 0 ) ;
V_13 -> V_15 = F_60 ( & V_126 -> V_28 , V_128 ) ;
if ( F_61 ( V_13 -> V_15 ) )
return F_62 ( V_13 -> V_15 ) ;
V_13 -> V_131 = F_63 ( & V_129 , & V_126 -> V_28 , V_13 ) ;
if ( ! V_13 -> V_131 ) {
F_15 ( & V_126 -> V_28 , L_17 ) ;
return - V_132 ;
}
F_64 ( V_126 , V_13 ) ;
F_65 ( & V_126 -> V_28 , L_18 ) ;
return 0 ;
}
static int F_66 ( struct V_125 * V_126 )
{
struct V_12 * V_13 = F_67 ( V_126 ) ;
F_68 ( V_13 -> V_131 ) ;
return 0 ;
}
