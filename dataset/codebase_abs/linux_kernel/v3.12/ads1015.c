...
unsigned int V_7 = V_6 -> V_8 [ V_3 ] . V_7 ;
int V_23 = V_24 [ V_7 ] ;
const unsigned V_25 = V_6 -> V_12 == V_13 ? 0x7fff : 0x7ff0 ;
...
int V_44 ;
unsigned int V_3 ;
unsigned int V_7 = V_45 ;
unsigned int V_9 = V_46 ;
V_43 = F_20 ( V_40 , L_2 , & V_44 ) ;
if ( ! V_43 || V_44 != sizeof( int ) ) {
F_21 ( & V_2 -> V_27 , L_3 ,
V_40 -> V_47 ) ;
continue;
}
...
unsigned int V_34 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_49 * V_50 = F_24 ( & V_2 -> V_27 ) ;
if ( V_50 ) {
memcpy ( V_6 -> V_8 , V_50 -> V_8 ,
sizeof( V_6 -> V_8 ) ) ;
return;
}
#ifdef F_25
...
#endif
for ( V_34 = 0 ; V_34 < V_36 ; ++ V_34 ) {
V_6 -> V_8 [ V_34 ] . V_48 = true ;
V_6 -> V_8 [ V_34 ] . V_7 = V_45 ;
V_6 -> V_8 [ V_34 ] . V_9 = V_46 ;
}
}
static int F_26 ( struct V_1 * V_2 ,
const struct V_51 * V_12 )
{
struct V_5 * V_6 ;
int V_52 ;
unsigned int V_34 ;
V_6 = F_27 ( & V_2 -> V_27 , sizeof( struct V_5 ) ,
V_53 ) ;
if ( ! V_6 )
return - V_54 ;
V_6 -> V_12 = V_12 -> V_55 ;
...
F_23 ( V_2 ) ;
for ( V_34 = 0 ; V_34 < V_36 ; ++ V_34 ) {
if ( ! V_6 -> V_8 [ V_34 ] . V_48 )
continue;
V_52 = F_30 ( & V_2 -> V_27 , & V_37 [ V_34 ] . V_38 ) ;
if ( V_52 )
goto V_56;
}
V_6 -> V_35 = F_31 ( & V_2 -> V_27 ) ;
if ( F_32 ( V_6 -> V_35 ) ) {
V_52 = F_33 ( V_6 -> V_35 ) ;
goto V_56;
}
