...
V_19 -> V_48 = V_15 -> V_57 ;
if ( V_9 -> V_72 )
V_18 = V_60 -> V_61 -> V_73 ( V_74 , V_19 , 0 ,
V_29 ,
V_9 , 0 ) ;
else
V_18 = 0 ;
...
V_19 -> V_36 = V_99 >> V_54 ;
if ( V_96 -> V_72 )
V_18 = V_59 -> V_61 -> V_73 ( V_107 , V_19 , 0 ,
V_29 ,
V_96 , 0 ) ;
else
V_18 = 0 ;
...
V_18 = F_38 ( V_2 , V_107 , V_96 , V_31 , 0 ) ;
if ( V_18 )
F_20 ( V_96 , V_18 ) ;
F_22 ( V_96 ) ;
return 0 ;
...
static struct V_113 * F_69 ( int type )
{
struct V_113 * V_114 ;
int V_115 = F_70 () ;
int V_116 = type - 1 ;
...
F_76 ( V_124 ) ;
F_74 ( V_118 ) ;
F_77 ( V_120 , & V_124 , V_125 ) ;
if ( F_75 ( V_119 ) > V_115 && ! * V_121 )
F_78 () ;
F_79 ( V_120 , & V_124 ) ;
goto V_123;
}
...
static void F_83 ( int type , struct V_113 * V_114 )
{
int V_116 = type - 1 ;
struct V_113 * V_117 = & V_109 [ V_116 ] ;
T_8 * V_118 = & V_110 [ V_116 ] ;
...
int V_20 ;
for ( V_20 = 0 ; V_20 < V_108 ; V_20 ++ ) {
while ( ! F_72 ( & V_109 [ V_20 ] ) ) {
V_114 = V_109 [ V_20 ] . V_87 ;
F_73 ( V_114 ) ;
V_126 [ V_20 ] -> F_83 ( V_114 ) ;
F_81 ( & V_111 [ V_20 ] ) ;
}
}
}
...
if ( F_80 ( V_114 ) )
return - 1 ;
V_18 = V_126 [ type - 1 ] -> F_89 ( V_114 , V_48 ,
V_43 , V_63 , V_56 ,
V_128 , V_129 ,
V_130 , V_131 ,
V_132 ) ;
...
static int F_16 ( int type , struct V_19 * * V_133 ,
T_2 V_17 , struct V_50 * V_51 ,
int V_134 , T_6 V_135 )
{
struct V_113 * V_114 ;
int V_18 ;
...
if ( F_80 ( V_114 ) )
return - V_68 ;
V_18 = V_126 [ type - 1 ] -> F_90 ( V_114 , V_133 ,
V_17 ,
V_51 , V_134 , V_135 ) ;
F_83 ( type , V_114 ) ;
return V_18 ;
}
int F_91 ( int type , unsigned char * V_136 , struct V_19 * V_137 ,
...
if ( F_80 ( V_114 ) )
return - V_68 ;
V_18 = V_126 [ type - 1 ] -> F_92 ( V_114 , V_136 ,
V_137 , V_138 ,
V_135 , V_139 ) ;
F_83 ( type , V_114 ) ;
return V_18 ;
...
int F_94 ( char * V_140 , unsigned long V_141 ,
...
unsigned long V_146 ;
char * V_21 ;
struct V_19 * V_147 = V_51 [ * V_65 ] . V_52 ;
V_138 = F_42 ( V_147 ) - V_17 ;
if ( V_131 <= V_138 )
return 1 ;
...
V_144 = V_141 ;
while ( V_145 > 0 ) {
V_146 = F_95 ( V_29 - * V_142 ,
V_29 - V_143 ) ;
V_146 = F_95 ( V_146 , V_145 ) ;
V_21 = F_8 ( V_147 ) ;
