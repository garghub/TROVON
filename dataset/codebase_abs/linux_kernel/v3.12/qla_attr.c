...
if ( V_14 -> V_117 == 1 )
V_14 -> V_36 -> V_118 ( V_11 ) ;
}
static T_1
F_75 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
return snprintf ( V_7 , V_120 , L_38 , V_121 ) ;
}
static T_1
F_76 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
char V_122 [ 128 ] ;
return snprintf ( V_7 , V_120 , L_38 ,
V_14 -> V_36 -> V_123 ( V_11 , V_122 ) ) ;
}
static T_1
F_78 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
...
if ( F_79 ( V_11 -> V_15 ) ) {
return snprintf ( V_7 , V_120 , L_38 ,
V_11 -> V_15 -> V_125 . V_126 ) ;
} else if ( F_27 ( V_14 ) ) {
F_80 ( V_11 , L_39 , V_7 , V_120 ) ;
return snprintf ( V_7 , V_120 , L_38 , V_7 ) ;
}
V_124 = ( ( V_14 -> V_127 & 0x1f ) << 16 ) | ( V_14 -> V_128 << 8 ) | V_14 -> V_129 ;
return snprintf ( V_7 , V_120 , L_40 , 'A' + V_124 / 100000 ,
V_124 % 100000 ) ;
}
static T_1
F_81 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
return snprintf ( V_7 , V_120 , L_41 , V_11 -> V_15 -> V_62 -> V_12 ) ;
}
static T_1
F_82 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
if ( F_79 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_120 , L_38 ,
V_11 -> V_15 -> V_125 . V_130 ) ;
return snprintf ( V_7 , V_120 , L_42 ,
V_14 -> V_131 [ 0 ] , V_14 -> V_131 [ 1 ] , V_14 -> V_131 [ 2 ] ,
V_14 -> V_131 [ 3 ] ) ;
}
static T_1
F_83 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
if ( F_79 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_120 , L_38 ,
V_11 -> V_15 -> V_125 . V_132 ) ;
return snprintf ( V_7 , V_120 , L_38 , V_11 -> V_15 -> V_133 ) ;
}
static T_1
F_84 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
return snprintf ( V_7 , V_120 , L_38 ,
V_11 -> V_15 -> V_134 ? V_11 -> V_15 -> V_134 : L_43 ) ;
}
static T_1
F_85 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
char V_135 [ 30 ] ;
...
static T_1
F_86 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
int V_137 = 0 ;
if ( F_87 ( & V_11 -> V_138 ) == V_139 ||
F_87 ( & V_11 -> V_138 ) == V_140 ||
V_11 -> V_141 & V_142 )
V_137 = snprintf ( V_7 , V_120 , L_44 ) ;
else if ( F_87 ( & V_11 -> V_138 ) != V_143 ||
F_88 ( V_11 ) )
V_137 = snprintf ( V_7 , V_120 , L_45 ) ;
else {
V_137 = snprintf ( V_7 , V_120 , L_46 ) ;
switch ( V_14 -> V_144 ) {
case V_145 :
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_47 ) ;
break;
case V_146 :
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_48 ) ;
break;
case V_147 :
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 ,
L_49 ) ;
break;
case V_148 :
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_50 ) ;
break;
default:
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_47 ) ;
break;
...
static T_1
F_89 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
int V_137 = 0 ;
...
case V_150 :
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_51 ) ;
break;
case V_151 :
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_52 ) ;
break;
}
return V_137 ;
}
static T_1
F_90 ( struct V_12 * V_103 , struct V_119 * V_115 ,
...
static T_1
F_92 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
return snprintf ( V_7 , V_120 , L_54 , V_11 -> V_15 -> V_153 * 100 ) ;
}
static T_1
F_93 ( struct V_12 * V_103 , struct V_119 * V_115 ,
const char * V_7 , T_3 V_9 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
int V_60 = 0 ;
...
static T_1
F_94 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
int V_137 = 0 ;
if ( V_11 -> V_15 -> V_117 )
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_55 ) ;
else
V_137 += snprintf ( V_7 + V_137 , V_120 - V_137 , L_52 ) ;
return V_137 ;
}
static T_1
F_95 ( struct V_12 * V_103 , struct V_119 * V_115 ,
const char * V_7 , T_3 V_9 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
int V_60 = 0 ;
int V_16 ;
if ( F_96 ( V_14 ) || F_97 ( V_14 ) )
return - V_93 ;
if ( F_98 ( V_154 , & V_11 -> V_34 ) ) {
...
V_16 = V_14 -> V_36 -> V_118 ( V_11 ) ;
if ( V_16 != V_46 )
V_9 = 0 ;
return V_9 ;
}
static T_1
F_99 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
return snprintf ( V_7 , V_120 , L_57 , V_14 -> V_157 [ 1 ] ,
V_14 -> V_157 [ 0 ] ) ;
}
static T_1
...
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
return snprintf ( V_7 , V_120 , L_57 , V_14 -> V_158 [ 1 ] ,
V_14 -> V_158 [ 0 ] ) ;
}
static T_1
...
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
return snprintf ( V_7 , V_120 , L_57 , V_14 -> V_159 [ 1 ] ,
V_14 -> V_159 [ 0 ] ) ;
}
static T_1
...
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
return snprintf ( V_7 , V_120 , L_58 ,
...
struct V_13 * V_14 = V_11 -> V_15 ;
if ( ! F_55 ( V_14 ) && ! F_56 ( V_14 ) )
return snprintf ( V_7 , V_120 , L_59 ) ;
return snprintf ( V_7 , V_120 , L_60 ,
...
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
return snprintf ( V_7 , V_120 , L_61 ,
V_11 -> V_162 . V_163 ) ;
}
static T_1
...
V_16 = F_107 ( V_11 , V_164 ) ;
if ( ( V_16 == V_46 ) && ( V_164 [ 0 ] == 0 ) )
return snprintf ( V_7 , V_120 , L_62 ,
( T_5 ) V_14 -> V_165 -> V_166 ) ;
return snprintf ( V_7 , V_120 , L_59 ) ;
}
static T_1
F_108 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
...
return snprintf ( V_7 , V_120 , L_59 ) ;
return snprintf ( V_7 , V_120 , L_63 ,
V_14 -> V_167 [ 0 ] , V_14 -> V_167 [ 1 ] , V_14 -> V_167 [ 2 ] ,
V_14 -> V_168 ) ;
}
static T_1
F_109 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
...
return snprintf ( V_7 , V_120 , L_59 ) ;
return snprintf ( V_7 , V_120 , L_64 ,
V_14 -> V_169 [ 0 ] , V_14 -> V_169 [ 1 ] , V_14 -> V_169 [ 2 ] ) ;
}
static T_1
F_110 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
return snprintf ( V_7 , V_120 , L_65 , V_14 -> V_170 ) ;
}
static T_1
F_111 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
if ( ! F_42 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_120 , L_59 ) ;
return snprintf ( V_7 , V_120 , L_61 , V_11 -> V_171 ) ;
}
static T_1
F_112 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
if ( ! F_42 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_120 , L_59 ) ;
return snprintf ( V_7 , V_120 , L_66 , V_11 -> V_172 ) ;
}
static T_1
F_113 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
return snprintf ( V_7 , V_120 , L_61 , V_11 -> V_15 -> V_173 ) ;
}
static T_1
F_114 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
T_4 V_174 = 0 ;
...
if ( F_115 ( V_11 , & V_174 ) == V_46 )
return snprintf ( V_7 , V_120 , L_61 , V_174 ) ;
V_175:
return snprintf ( V_7 , V_120 , L_59 ) ;
}
static T_1
F_116 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
int V_16 = V_177 ;
...
T_5 V_179 ;
if ( F_79 ( V_11 -> V_15 ) ) {
V_179 = F_117 ( V_103 , V_115 , V_7 ) ;
return snprintf ( V_7 , V_120 , L_65 , V_179 ) ;
}
if ( F_88 ( V_11 ) )
F_9 ( V_47 , V_11 , 0x707c ,
L_67 ) ;
else if ( ! V_11 -> V_15 -> V_89 . V_176 )
V_16 = F_118 ( V_11 , V_178 ) ;
if ( V_16 != V_46 )
memset ( V_178 , - 1 , sizeof( V_178 ) ) ;
return snprintf ( V_7 , V_120 , L_69 , V_178 [ 0 ] ,
V_178 [ 1 ] , V_178 [ 2 ] , V_178 [ 3 ] , V_178 [ 4 ] ) ;
}
static T_1
F_119 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
if ( ! F_120 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_120 , L_59 ) ;
return snprintf ( V_7 , V_120 , L_70 , V_11 -> V_180 . V_181 ) ;
}
static T_1
F_121 ( struct V_12 * V_103 ,
struct V_119 * V_115 , char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
if ( ! F_120 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_120 , L_59 ) ;
return snprintf ( V_7 , V_120 , L_70 ,
V_11 -> V_180 . V_182 >> 20 ) ;
}
static T_1
F_122 ( struct V_12 * V_103 , struct V_119 * V_115 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_77 ( V_103 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
...
V_58 = V_14 -> V_27 ;
return snprintf ( V_7 , V_120 , L_61 , V_58 ) ;
}
static void
F_123 ( struct V_108 * V_183 )
{
T_7 * V_11 = F_2 ( V_183 ) ;
F_124 ( V_183 ) = V_11 -> V_184 . V_185 . V_186 << 16 |
V_11 -> V_184 . V_185 . V_187 << 8 | V_11 -> V_184 . V_185 . V_188 ;
}
static void
F_125 ( struct V_108 * V_183 )
{
...
static void
F_130 ( struct V_212 * V_213 )
{
struct V_108 * V_88 = F_3 ( V_213 -> V_103 . V_214 ) ;
T_7 * V_11 = F_2 ( V_88 ) ;
T_9 * V_215 ;
T_10 V_216 = 0 ;
F_131 (fcport, &vha->vp_fcports, list) {
if ( V_215 -> V_217 &&
V_213 -> V_218 == V_215 -> V_217 -> V_219 ) {
V_216 = F_132 ( V_215 -> V_216 ) ;
break;
}
}
F_133 ( V_213 ) = V_216 ;
...
static void
F_138 ( struct V_222 * V_217 , T_5 V_223 )
{
if ( V_223 )
V_217 -> V_224 = V_223 ;
else
...
static void
F_139 ( struct V_222 * V_217 )
{
struct V_108 * V_88 = F_140 ( V_217 ) ;
T_9 * V_215 = * ( T_9 * * ) V_217 -> V_225 ;
unsigned long V_89 ;
if ( ! V_215 )
return;
F_141 ( V_215 , V_226 ) ;
F_142 ( V_88 -> V_227 , V_89 ) ;
V_215 -> V_217 = V_215 -> V_228 = NULL ;
* ( ( T_9 * * ) V_217 -> V_225 ) = NULL ;
F_143 ( V_88 -> V_227 , V_89 ) ;
if ( F_98 ( V_154 , & V_215 -> V_11 -> V_34 ) )
return;
if ( F_36 ( F_37 ( V_215 -> V_11 -> V_15 -> V_62 ) ) ) {
F_144 ( V_215 -> V_11 , V_229 << 16 ) ;
return;
}
}
static void
F_145 ( struct V_222 * V_217 )
{
T_9 * V_215 = * ( T_9 * * ) V_217 -> V_225 ;
if ( ! V_215 )
return;
...
F_146 ( V_215 -> V_11 , V_215 ) ;
}
}
static int
F_147 ( struct V_108 * V_183 )
{
T_7 * V_11 = F_2 ( V_183 ) ;
if ( F_79 ( V_11 -> V_15 ) )
return 0 ;
...
V_16 = V_177 ;
if ( F_27 ( V_14 ) ) {
V_16 = F_150 ( V_86 , V_235 , V_236 ) ;
} else if ( F_87 ( & V_86 -> V_138 ) == V_143 &&
! V_14 -> V_241 ) {
V_16 = F_151 ( V_86 , V_86 -> V_230 ,
V_235 , V_236 ) ;
}
if ( V_16 != V_46 )
goto V_242;
...
V_237 -> V_277 =
F_152 () - V_11 -> V_162 . V_278 ;
F_153 ( V_237 -> V_277 , V_279 ) ;
V_242:
F_154 ( V_14 -> V_81 , V_235 , V_236 ) ;
V_175:
return V_237 ;
}
static void
F_155 ( struct V_108 * V_183 )
{
T_7 * V_11 = F_2 ( V_183 ) ;
memset ( & V_11 -> V_238 , 0 , sizeof( V_11 -> V_238 ) ) ;
V_11 -> V_162 . V_278 = F_152 () ;
}
static void
F_156 ( struct V_108 * V_183 )
{
T_7 * V_11 = F_2 ( V_183 ) ;
F_157 ( V_11 , F_158 ( V_183 ) ) ;
}
static void
F_159 ( struct V_108 * V_183 )
{
T_7 * V_11 = F_2 ( V_183 ) ;
...
0xFF , 0xFF , 0xFF , 0xFF } ;
T_10 V_282 = F_132 ( V_216 ) ;
if ( V_11 -> V_141 & V_283 )
V_282 = F_132 ( V_11 -> V_284 ) ;
F_161 ( V_183 ) = V_282 ;
}
static void
F_162 ( struct V_108 * V_183 )
{
T_7 * V_11 = F_2 ( V_183 ) ;
...
switch ( F_87 ( & V_86 -> V_138 ) ) {
case V_287 :
F_163 ( V_183 ) = V_288 ;
break;
case V_139 :
if ( F_98 ( V_289 , & V_86 -> V_34 ) )
F_163 ( V_183 ) = V_288 ;
else
F_163 ( V_183 ) = V_290 ;
break;
...
static int
F_164 ( struct V_293 * V_293 , bool V_294 )
{
int V_110 = 0 ;
T_6 V_295 = 0 ;
...
if ( V_294 ) {
F_167 ( & V_11 -> V_301 , V_302 ) ;
F_168 ( V_293 , V_303 ) ;
} else
F_167 ( & V_11 -> V_301 , V_304 ) ;
F_9 ( V_29 , V_11 , 0x7080 ,
L_74 , V_11 -> V_206 ) ;
F_167 ( & V_11 -> V_138 , V_139 ) ;
V_11 -> V_305 = V_306 ;
V_11 -> V_307 = V_308 ;
if ( F_87 ( & V_86 -> V_138 ) == V_139 ||
F_87 ( & V_86 -> V_138 ) == V_140 ) {
F_21 ( V_32 , V_11 , 0x7081 ,
L_75 ) ;
F_167 ( & V_11 -> V_138 , V_140 ) ;
if ( ! V_294 )
F_168 ( V_293 , V_309 ) ;
}
if ( F_169 ( V_14 ) && V_310 ) {
...
( V_310 > 1 || F_172 ( V_14 ) ) )
V_314 |= V_324 ;
F_173 ( V_11 -> V_88 , V_314 ) ;
} else
V_11 -> V_89 . V_315 = 0 ;
}
if ( F_174 ( V_11 -> V_88 , & V_293 -> V_103 ,
& V_14 -> V_62 -> V_103 ) ) {
F_21 ( V_32 , V_11 , 0x7083 ,
L_77 , V_11 -> V_206 ) ;
goto V_325;
}
F_175 ( V_11 -> V_88 ) = V_14 -> V_326 ;
F_176 ( V_11 -> V_88 ) = F_132 ( V_11 -> V_216 ) ;
F_177 ( V_11 -> V_88 ) = F_132 ( V_11 -> V_220 ) ;
F_178 ( V_11 -> V_88 ) =
F_178 ( V_86 -> V_88 ) ;
F_179 ( V_11 -> V_88 ) =
F_179 ( V_86 -> V_88 ) ;
...
if ( V_295 ) {
V_110 = F_182 ( V_14 , V_296 , V_11 -> V_206 , 0 , 0 ,
V_295 ) ;
if ( ! V_110 )
...
static int
F_186 ( struct V_293 * V_293 )
{
T_7 * V_11 = V_293 -> V_225 ;
struct V_13 * V_14 = V_11 -> V_15 ;
T_4 V_218 = V_11 -> V_206 ;
while ( F_98 ( V_334 , & V_11 -> V_34 ) ||
F_98 ( V_335 , & V_11 -> V_34 ) )
F_187 ( 1000 ) ;
F_183 ( V_11 ) ;
V_11 -> V_89 . V_336 = 1 ;
F_188 ( V_11 -> V_88 ) ;
...
F_191 ( F_87 ( & V_11 -> V_338 ) ) ;
F_192 ( V_11 ) ;
F_193 ( & V_14 -> V_339 ) ;
V_14 -> V_340 -- ;
F_194 ( V_11 -> V_206 , V_14 -> V_341 ) ;
F_195 ( & V_14 -> V_339 ) ;
if ( V_11 -> V_298 -> V_218 && ! V_14 -> V_89 . V_327 ) {
if ( F_196 ( V_11 , V_11 -> V_298 ) != V_46 )
...
static int
F_181 ( struct V_293 * V_293 , bool V_294 )
{
T_7 * V_11 = V_293 -> V_225 ;
if ( V_294 )
F_183 ( V_11 ) ;
...
F_176 ( V_11 -> V_88 ) = F_132 ( V_11 -> V_216 ) ;
F_177 ( V_11 -> V_88 ) = F_132 ( V_11 -> V_220 ) ;
F_178 ( V_11 -> V_88 ) = V_14 -> V_342 . V_343 ?
( V_344 | V_345 ) : V_345 ;
F_199 ( V_11 -> V_88 ) = V_14 -> V_346 ;
F_200 ( V_11 -> V_88 ) = V_14 -> V_340 ;
if ( F_42 ( V_14 ) )
V_189 = V_201 ;
else if ( F_43 ( V_14 ) )
V_189 = V_203 | V_199 |
