...
V_4 = F_35 ( & V_61 -> V_9 , sizeof( * V_4 ) , V_70 ) ;
if ( ! V_4 ) {
F_8 ( & V_61 -> V_9 , L_8 ) ;
return - V_71 ;
}
...
F_39 ( & V_4 -> V_46 ) ;
V_15 = F_40 ( & V_61 -> V_9 , V_4 -> V_1 , NULL ,
F_1 , 0 ,
L_17 , V_4 ) ;
if ( V_15 ) {
...
V_4 -> V_16 [ 0 ] . V_72 = L_19 ;
V_4 -> V_16 [ 1 ] . V_72 = L_20 ;
V_15 = F_41 ( V_62 , F_7 ( V_4 -> V_16 ) ,
V_4 -> V_16 ) ;
if ( V_15 ) {
F_8 ( V_4 -> V_9 , L_21 , V_15 ) ;
return V_15 ;
}
if ( V_66 ) {
V_15 = F_42 ( V_4 -> V_16 [ 0 ] . V_34 ,
V_66 , V_66 ) ;
if ( V_15 ) {
F_8 ( V_4 -> V_9 , L_22 ,
V_15 ) ;
