...
int F_27 ( struct V_5 * V_5 , int V_6 )
{
struct V_59 * V_60 = F_28 ( V_5 -> V_17 ) ;
struct V_42 * V_61 ;
int V_10 , V_34 , V_62 ;
F_29 ( & V_5 -> V_9 ) ;
for ( V_10 = 0 ; V_10 < F_7 ( V_5 -> V_15 ) ; V_10 ++ ) {
...
if ( V_62 )
V_61 = F_32 ( V_5 -> V_17 -> V_63 ,
F_7 ( V_7 ) ,
V_62 , 0 ,
& V_64 ,
V_5 ) ;
else
V_61 = F_33 ( V_5 -> V_17 -> V_63 ,
F_7 ( V_7 ) ,
& V_64 ,
V_5 ) ;
if ( ! V_61 ) {
