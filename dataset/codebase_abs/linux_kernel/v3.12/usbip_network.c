...
int F_24 ( char * V_41 , char * V_42 )
{
struct V_43 V_44 , * V_45 , * V_46 ;
int V_18 ;
int V_35 ;
memset ( & V_44 , 0 , sizeof( V_44 ) ) ;
V_44 . V_47 = V_48 ;
V_44 . V_49 = V_50 ;
V_35 = F_25 ( V_41 , V_42 , & V_44 , & V_45 ) ;
if ( V_35 < 0 ) {
F_2 ( L_14 , V_41 , V_42 ,
F_26 ( V_35 ) ) ;
return V_35 ;
}
for ( V_46 = V_45 ; V_46 ; V_46 = V_46 -> V_51 ) {
V_18 = F_27 ( V_46 -> V_47 , V_46 -> V_49 ,
V_46 -> V_52 ) ;
if ( V_18 < 0 )
continue;
F_22 ( V_18 ) ;
F_23 ( V_18 ) ;
if ( F_28 ( V_18 , V_46 -> V_53 , V_46 -> V_54 ) == 0 )
break;
F_29 ( V_18 ) ;
}
F_30 ( V_45 ) ;
