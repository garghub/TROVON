...
if ( V_35 > 0 ) {
V_18 -> V_60 = V_18 -> V_59 ;
V_27 = & V_18 -> V_62 [ V_18 -> V_59 ++ ] ;
V_27 -> V_46 = L_19 ;
V_27 -> V_63 = L_20 ;
V_27 -> V_64 = & V_18 ;
V_27 -> V_65 = sizeof( V_18 ) ;
}
if ( V_36 > 0 ) {
V_18 -> V_61 = V_18 -> V_59 ;
V_27 = & V_18 -> V_62 [ V_18 -> V_59 ++ ] ;
...
V_31 = F_31 ( & V_17 -> V_24 , V_17 -> V_66 , V_18 -> V_62 ,
V_18 -> V_59 , NULL , 0 , NULL ) ;
if ( V_31 < 0 )
goto V_50;
F_32 ( & V_17 -> V_24 , true ) ;
F_33 ( V_17 , V_18 ) ;
...
{
struct V_1 * V_68 = F_40 ( V_24 ) ;
F_3 ( V_68 , V_6 , 0x00 ) ;
F_34 ( V_24 ) ;
return 0 ;
}
static int F_41 ( struct V_67 * V_24 )
{
struct V_1 * V_68 = F_40 ( V_24 ) ;
unsigned int V_69 , V_32 ;
F_27 ( V_24 ) ;
V_32 = V_53 | V_54 ;
if ( V_68 -> V_60 != - 1 )
V_32 |= V_56 | V_55 ;
