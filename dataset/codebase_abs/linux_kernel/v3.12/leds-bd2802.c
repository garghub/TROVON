...
V_2 -> V_13 = V_13 ;
V_32 = V_2 -> V_32 = F_43 ( & V_13 -> V_14 ) ;
F_44 ( V_13 , V_2 ) ;
F_45 ( V_32 -> V_33 , V_96 , L_17 ) ;
F_14 ( 100 ) ;
V_25 = F_7 ( V_13 , V_97 , 0x00 ) ;
if ( V_25 < 0 ) {
F_2 ( & V_13 -> V_14 , L_18 ) ;
return V_25 ;
} else
F_46 ( & V_13 -> V_14 , L_19 , V_25 ) ;
F_10 ( V_2 -> V_32 -> V_33 , 0 ) ;
V_2 -> V_48 = V_98 ;
V_2 -> V_43 = V_99 ;
F_47 ( & V_2 -> V_57 ) ;
for ( V_17 = 0 ; V_17 < F_21 ( V_100 ) ; V_17 ++ ) {
V_25 = F_22 ( & V_2 -> V_13 -> V_14 ,
V_100 [ V_17 ] ) ;
if ( V_25 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_4 ,
V_100 [ V_17 ] -> V_51 . V_52 ) ;
goto V_101;
}
}
V_25 = F_35 ( V_2 ) ;
...
V_101:
for ( V_17 -- ; V_17 >= 0 ; V_17 -- )
F_23 ( & V_2 -> V_13 -> V_14 , V_100 [ V_17 ] ) ;
return V_25 ;
}
static int F_48 ( struct V_22 * V_13 )
{
...
static int F_51 ( struct V_54 * V_14 )
{
struct V_22 * V_13 = F_27 ( V_14 ) ;
struct V_1 * V_2 = F_26 ( V_13 ) ;
if ( ! F_4 ( V_2 ) || V_2 -> V_31 ) {
