...
V_10 = F_50 ( & V_4 -> V_8 , struct V_8 , V_8 ) ;
F_51 ( V_24 ) ;
F_52 ( V_10 -> V_9 ) ;
...
unsigned int V_52 , V_67 = V_44 [ V_78 ] . V_40 / sizeof( T_10 ) ;
for ( V_52 = 1 ; V_52 < V_67 ; V_52 ++ ) {
if ( strcmp ( V_77 + V_81 [ V_52 ] . V_87 , L_25 ) == 0 ) {
...
static int F_86 ( struct V_161 * V_161 , struct V_162 * V_163 )
{
struct V_1 * V_4 ;
T_3 * V_43 ;
int V_38 = 0 ;
...
static T_12 F_88 ( struct V_162 * V_162 , const char T_13 * V_180 ,
V_138 V_181 , T_14 * V_182 )
{
V_138 V_38 = V_181 ;
struct V_1 * V_4 ;
if ( F_82 ( F_89 ( V_162 ) ) != V_2 )
return - V_167 ;
V_4 = F_1 ( V_168 ) ;
if ( V_4 == NULL )
return - V_167 ;
if ( ( V_181 + V_4 -> V_32 ) > V_4 -> V_124 ) {
F_17 ( V_91
L_45 ) ;
return - V_68 ;
}
V_181 -= F_90 ( V_4 -> V_123 + V_4 -> V_32 , V_180 , V_181 ) ;
if ( ! V_181 )
return - V_183 ;
V_4 -> V_32 += V_181 ;
return V_38 ;
...
int F_92 ( T_15 V_1 , unsigned long V_118 )
{
struct V_1 * V_4 = V_1 ;
V_4 -> V_108 = V_118 ;
return F_41 ( V_4 ) ;
...
unsigned int V_185 ;
V_185 = F_46 () ;
if ( ( V_10 = F_94 ( V_4 -> V_8 . V_70 , struct V_8 , V_8 ) ) != NULL ) {
F_52 ( V_10 -> V_9 ) ;
F_62 ( F_63 () & ~ V_114 ) ;
}
F_48 ( V_185 ) ;
...
static T_12 F_102 ( struct V_186 * V_187 , struct V_188 * V_189 ,
const char * V_190 , V_138 V_32 )
{
...
static T_12 F_103 ( struct V_186 * V_191 , struct V_188 * V_189 ,
char * V_190 )
{
struct V_1 * V_1 = F_1 ( V_168 ) ;
return sprintf ( V_190 , L_46 , V_1 -> V_111 ) ;
}
static T_12 F_104 ( struct V_186 * V_187 , struct V_188 * V_189 ,
const char * V_190 , V_138 V_32 )
{
struct V_1 * V_1 = F_1 ( V_168 ) ;
unsigned long V_192 ;
char * V_193 ;
V_192 = F_105 ( V_190 , & V_193 , 0 ) ;
if ( V_193 == V_190 )
goto V_194;
if ( V_192 == 0 || V_192 > ( V_195 - V_168 ) )
goto V_194;
V_1 -> V_111 = V_192 ;
return V_32 ;
V_194:
...
static void F_106 ( struct V_186 * V_191 )
{
F_14 ( V_191 ) ;
}
static int T_16 F_107 ( void )
{
unsigned int V_155 , V_156 ;
...
V_19 = F_19 () ;
V_195 = ( V_19 & V_29 ) + 1 ;
V_208 = ( ( V_19 & V_27 ) >> V_28 ) + 1 ;
for ( V_8 = V_168 ; V_8 < V_195 ; V_8 ++ ) {
F_67 ( V_24 ) ;
F_48 ( V_156 ) ;
F_49 ( V_155 ) ;
F_44 ( V_101 ) ;
...
static void T_17 F_120 ( void )
{
struct V_1 * V_4 , * V_67 ;
F_121 ( & V_203 ) ;
F_119 ( V_198 , V_199 ) ;
F_122 (v, n, &vpecontrol.vpe_list, list) {
if ( V_4 -> V_165 != V_170 )
F_11 ( V_4 ) ;
}
}
