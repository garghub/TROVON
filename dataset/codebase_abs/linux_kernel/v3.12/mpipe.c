...
if ( ! V_1 )
return V_95 ;
strncpy ( V_94 . V_94 , V_93 , sizeof( V_94 . V_94 ) ) ;
V_94 . V_94 [ V_96 - 1 ] = '\0' ;
return F_49 ( V_1 , V_94 ) ;
}
int F_50 ( int V_97 , char * V_93 , T_11 * V_98 )
{
int V_99 ;
T_17 V_94 ;
T_18 V_100 ;
...
if ( ! V_1 )
return V_95 ;
V_99 = F_51 ( V_1 , V_97 , & V_94 , & V_100 ) ;
if ( V_99 >= 0 ) {
strncpy ( V_93 , V_94 . V_94 , sizeof( V_94 . V_94 ) ) ;
memcpy ( V_98 , V_100 . V_100 , sizeof( V_100 . V_100 ) ) ;
}
return V_99 ;
}
int F_52 ( T_19 * V_101 ,
...
strncpy ( V_94 . V_94 , V_93 , sizeof( V_94 . V_94 ) ) ;
V_94 . V_94 [ V_96 - 1 ] = '\0' ;
V_99 = F_53 ( V_1 , V_94 , V_102 ) ;
if ( V_99 < 0 )
return V_99 ;
V_101 -> V_1 = V_1 ;
V_101 -> V_45 = V_99 >> 8 ;
V_101 -> V_100 = V_99 & 0xFF ;
return 0 ;
}
int F_54 ( T_19 * V_101 )
{
return F_55 ( V_101 -> V_1 , V_101 -> V_100 ) ;
}
int F_56 ( T_19 * V_101 , T_20 V_103 ,
T_16 V_104 )
{
return F_57 ( V_101 -> V_1 , V_101 -> V_100 , V_103 ,
V_104 ) ;
}
