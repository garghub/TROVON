...
static void F_46 ( struct V_7 * V_8 , struct V_73 * V_74 )
{
struct V_81 * V_82 ;
if ( V_74 != V_8 -> V_104 )
return;
...
static void F_49 ( struct V_75 * V_76 , struct V_37 * V_108 )
{
...
static inline struct V_7 * F_65 ( struct V_37 * V_108 )
{
return (struct V_7 * ) V_108 -> V_117 ;
}
static int F_66 ( struct V_52 * V_53 , struct V_125 * V_126 )
{
struct V_127 V_128 = {
. V_126 = V_126 ,
. V_129 = sizeof( V_92 ) ,
...
if ( F_67 ( V_53 , 0 , & V_128 , V_130 ) < 0 )
return - 1 ;
if ( V_128 . V_3 )
return - 1 ;
return 0 ;
}
static void F_68 ( struct V_37 * V_108 , int V_64 )
{
struct V_73 * V_74 ;
struct V_7 * V_8 ;
struct V_81 * V_131 ;
...
V_135 = F_71 ( V_126 , sizeof( V_92 ) , sizeof( V_134 ) , & V_134 ) ;
if ( V_135 == NULL )
goto V_136;
F_72 ( & V_8 -> V_88 ) ;
V_131 = F_73 ( V_8 , * V_135 ) ;
if ( ! V_131 )
goto V_137;
V_74 = V_131 -> V_138 ;
...
static void F_78 ( struct V_37 * V_108 , int V_64 )
{
struct V_73 * V_74 ;
struct V_7 * V_8 ;
struct V_81 * V_131 ;
...
if ( ! ( V_8 = F_65 ( V_108 ) ) )
goto V_71;
if ( ( V_126 = F_70 ( V_108 , 0 , 1 , & V_57 ) ) == NULL )
goto V_71;
...
V_135 = F_71 ( V_126 , sizeof( struct V_141 ) ,
sizeof( V_134 ) , & V_134 ) ;
if ( V_135 == NULL )
goto V_136;
F_72 ( & V_8 -> V_88 ) ;
...
static inline void F_84 ( struct V_7 * V_8 , struct V_127 * V_128 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
T_4 V_64 , V_144 ;
char * V_145 ;
...
static inline void F_86 ( struct V_75 * V_76 , struct V_127 * V_128 )
{
T_4 V_64 , V_144 ;
char * V_145 ;
...
static inline void F_87 ( struct V_75 * V_76 ,
struct V_127 * V_128 )
{
T_4 V_64 , V_144 ;
T_1 V_129 ;
...
static inline void F_97 ( struct V_75 * V_76 , struct V_127 * V_128 )
{
T_4 V_64 ;
V_64 = V_76 -> V_148 - V_76 -> V_147 ;
if ( V_64 > V_128 -> V_3 )
...
static int F_98 ( T_6 * V_174 , struct V_125 * V_126 , unsigned int V_129 , T_4 V_64 )
{
...
static void F_99 ( struct V_37 * V_108 , int V_177 )
{
struct V_7 * V_8 ;
T_6 V_174 ;
int V_178 ;
...
static void F_109 ( struct V_37 * V_108 )
{
struct V_7 * V_8 ;
F_69 ( & V_108 -> V_116 ) ;
if ( ! ( V_8 = F_65 ( V_108 ) ) )
...
static void F_114 ( struct V_37 * V_108 )
{
struct V_36 * V_37 ;
struct V_7 * V_8 ;
if ( F_24 ( ! ( V_37 = V_108 -> V_185 ) ) )
return;
F_25 ( V_89 , & V_37 -> V_65 ) ;
if ( F_24 ( ! ( V_8 = F_65 ( V_108 ) ) ) )
return;
if ( F_59 ( V_69 , & V_37 -> V_65 ) == 0 )
return;
F_115 ( V_8 ) ;
}
static void F_116 ( struct V_37 * V_108 )
{
F_69 ( & V_108 -> V_116 ) ;
if ( F_117 ( V_108 ) )
F_114 ( V_108 ) ;
...
static void F_118 ( struct V_37 * V_108 )
{
F_69 ( & V_108 -> V_116 ) ;
if ( F_119 ( V_108 ) )
F_114 ( V_108 ) ;
...
static void F_121 ( struct V_7 * V_8 , T_4 V_201 , T_4 V_196 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
V_76 -> V_201 = 0 ;
if ( V_201 )
...
static void F_122 ( struct V_7 * V_8 , struct V_73 * V_74 )
{
F_81 ( V_8 , V_74 , - V_204 ) ;
}
...
unsigned short rand = ( unsigned short ) F_124 () % V_205 ;
return rand + V_207 ;
}
static void F_125 ( struct V_7 * V_8 , unsigned short V_208 )
{
F_2 ( L_47 , V_8 , V_208 ) ;
F_126 ( F_3 ( V_8 ) , V_208 ) ;
F_16 ( V_8 ) ;
}
static unsigned short F_127 ( struct V_75 * V_76 )
{
...
static unsigned short F_128 ( struct V_75 * V_76 , unsigned short V_208 )
{
if ( V_76 -> V_115 != 0 )
V_76 -> V_115 = 0 ;
if ( ! V_76 -> V_8 . V_209 )
...
static int F_129 ( struct V_75 * V_76 , struct V_36 * V_37 )
{
struct V_210 V_211 ;
int V_57 , V_212 = 0 ;
unsigned short V_208 = F_127 ( V_76 ) ;
unsigned short V_213 ;
memcpy ( & V_211 , & V_76 -> V_214 , V_76 -> V_8 . V_38 ) ;
do {
F_126 ( (struct V_6 * ) & V_211 , V_208 ) ;
V_57 = F_130 ( V_37 , (struct V_6 * ) & V_211 ,
V_76 -> V_8 . V_38 ) ;
if ( V_208 == 0 )
break;
if ( V_57 == 0 ) {
...
static void F_131 ( struct V_73 * V_74 )
{
F_132 () ;
F_133 ( F_134 ( V_74 -> V_217 -> V_218 ) ) ;
F_135 () ;
}
static void F_136 ( struct V_7 * V_8 , unsigned short V_208 )
{
}
...
static inline void F_141 ( int V_221 , struct V_36 * V_37 )
{
F_142 ( F_143 ( V_37 -> V_108 ) ) ;
if ( F_143 ( V_37 -> V_108 ) )
return;
switch ( V_221 ) {
case V_17 :
...
static struct V_36 * F_144 ( struct V_7 * V_8 ,
struct V_75 * V_76 , int V_221 , int type , int V_30 )
{
struct V_36 * V_37 ;
int V_57 ;
V_57 = F_145 ( V_8 -> V_222 , V_221 , type , V_30 , & V_37 , 1 ) ;
if ( V_57 < 0 ) {
F_2 ( L_58 ,
V_30 , - V_57 ) ;
goto V_71;
...
return F_149 ( V_37 , F_3 ( V_8 ) , V_8 -> V_38 , 0 ) ;
}
static int F_150 ( struct V_75 * V_76 )
{
...
static void F_153 ( struct V_7 * V_8 , struct V_73 * V_74 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
int V_83 ;
if ( F_154 ( V_74 ) ) {
...
int F_160 ( struct V_7 * V_8 , int V_236 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 ,
V_8 ) ;
int V_57 = 0 ;
...
static void F_162 ( struct V_7 * V_8 , struct V_36 * V_37 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
if ( ! V_76 -> V_79 ) {
struct V_37 * V_108 = V_37 -> V_108 ;
...
static void F_163 ( struct V_238 * V_239 )
{
struct V_75 * V_76 =
...
V_243 . V_16 = V_244 ;
V_242 = F_149 ( V_76 -> V_37 , & V_243 , sizeof( V_243 ) , 0 ) ;
F_166 ( & V_76 -> V_8 ,
V_76 -> V_37 , V_242 ) ;
if ( ! V_242 )
F_107 ( & V_76 -> V_8 ) ;
...
static void F_167 ( struct V_75 * V_76 )
{
unsigned int V_107 = V_76 -> V_79 -> V_181 ;
if ( V_107 == V_195 && V_76 -> V_37 -> V_107 == V_245 ) {
...
static int F_168 ( struct V_7 * V_8 , struct V_36 * V_37 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
int V_83 = - V_90 ;
if ( ! V_76 -> V_79 ) {
...
V_8 -> V_225 . V_226 ++ ;
V_8 -> V_225 . V_227 = V_228 ;
V_83 = F_149 ( V_37 , F_3 ( V_8 ) , V_8 -> V_38 , V_253 ) ;
switch ( V_83 ) {
case 0 :
case - V_254 :
V_8 -> V_188 ++ ;
...
static void F_171 ( struct V_238 * V_239 )
{
struct V_75 * V_76 =
F_27 ( V_239 , struct V_75 , V_124 . V_239 ) ;
struct V_36 * V_37 = V_76 -> V_37 ;
...
static void F_173 ( struct V_7 * V_8 , struct V_73 * V_74 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
if ( V_76 -> V_37 != NULL && ! F_156 ( V_74 ) ) {
F_2 ( L_75
L_76 ,
V_8 , V_8 -> V_119 / V_261 ) ;
F_103 ( V_180 ,
...
static void F_174 ( struct V_7 * V_8 , struct V_263 * V_264 )
{
long V_265 = 0 ;
if ( F_30 ( V_8 ) )
...
static void F_176 ( struct V_7 * V_8 , struct V_263 * V_264 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
F_175 ( V_264 , L_80
L_81 ,
...
static void F_177 ( struct V_7 * V_8 , struct V_263 * V_264 )
{
struct V_75 * V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
long V_265 = 0 ;
if ( F_30 ( V_8 ) )
...
static void * F_178 ( struct V_73 * V_74 , T_4 V_277 )
{
struct V_54 * V_54 ;
struct V_278 * V_4 ;
F_142 ( V_277 > V_279 - sizeof( struct V_278 ) ) ;
...
static void F_181 ( void * V_280 )
{
struct V_278 * V_4 ;
if ( ! V_280 )
return;
V_4 = F_27 ( V_280 , struct V_278 , V_176 ) ;
F_182 ( ( unsigned long ) V_4 ) ;
}
...
V_64 = F_184 ( V_37 , V_281 ,
F_185 ( V_281 -> V_70 [ 0 ] . V_50 ) , V_282 ,
...
V_8 = V_82 -> V_78 -> V_286 ;
if ( ! F_187 ( & V_8 -> V_287 ) ) {
F_188 ( & V_8 -> V_288 , V_74 , NULL ) ;
if ( ! F_187 ( & V_8 -> V_287 ) )
return - V_84 ;
F_189 ( & V_8 -> V_288 , V_74 ) ;
}
...
static int F_193 ( const int V_221 , struct V_6 * V_13 )
{
static const struct V_11 sin = {
. V_291 = V_22 ,
. V_23 . V_24 = F_194 ( V_292 ) ,
} ;
...
V_8 = F_196 ( args -> V_301 , sizeof( * V_299 ) , V_297 ,
V_298 ) ;
if ( V_8 == NULL ) {
F_2 ( L_87
L_88 ) ;
...
static struct V_7 * F_197 ( struct V_296 * args )
{
struct V_10 * V_15 = (struct V_10 * ) args -> V_303 ;
struct V_75 * V_76 ;
struct V_7 * V_8 ;
struct V_7 * V_83 ;
V_8 = F_195 ( args , V_304 ,
V_305 ) ;
if ( F_164 ( V_8 ) )
return V_8 ;
V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
...
switch ( V_9 -> V_16 ) {
case V_22 :
if ( ( (struct V_11 * ) V_9 ) -> V_324 != F_200 ( 0 ) )
F_133 ( V_8 ) ;
F_201 ( & V_76 -> V_124 ,
F_163 ) ;
F_15 ( V_8 , L_92 , V_325 ) ;
break;
case V_25 :
if ( ( (struct V_12 * ) V_9 ) -> V_326 != F_200 ( 0 ) )
F_133 ( V_8 ) ;
F_201 ( & V_76 -> V_124 ,
F_163 ) ;
F_15 ( V_8 , L_92 , V_327 ) ;
...
static struct V_7 * F_202 ( struct V_296 * args )
{
struct V_6 * V_9 = args -> V_303 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
...
static struct V_7 * F_203 ( struct V_296 * args )
{
struct V_6 * V_9 = args -> V_303 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
...
if ( ! V_347 )
return - V_260 ;
V_83 = F_214 ( V_347 , 0 , & V_352 ) ;
if ( V_83 == - V_260 || V_352 < V_350 || V_352 > V_351 )
return - V_260 ;
* ( ( unsigned int * ) V_349 -> V_175 ) = V_352 ;
return 0 ;
}
static int F_215 ( const char * V_347 , const struct V_348 * V_349 )
{
return F_213 ( V_347 , V_349 ,
V_353 ,
V_354 ) ;
}
static int F_216 ( const char * V_347 ,
const struct V_348 * V_349 )
{
return F_213 ( V_347 , V_349 ,
V_355 ,
...
static int F_217 ( const char * V_347 ,
const struct V_348 * V_349 )
{
return F_213 ( V_347 , V_349 ,
V_355 ,
