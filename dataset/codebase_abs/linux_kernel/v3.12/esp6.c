...
F_36 ( V_25 , 3 ) ;
F_38 ( V_25 , & V_23 -> V_50 , sizeof( T_1 ) ) ;
* V_35 = F_35 ( V_18 ) -> V_53 . V_74 . V_57 ;
F_38 ( V_25 + 1 , V_35 , V_10 ) ;
F_38 ( V_25 + 2 , & V_23 -> V_52 , sizeof( T_1 ) ) ;
} else
F_39 ( V_25 , V_23 , sizeof( * V_23 ) ) ;
F_60 ( V_12 , 0 , F_56 , V_18 ) ;
F_61 ( V_12 , V_24 , V_24 , V_62 , V_11 ) ;
F_62 ( V_12 , V_25 , V_32 ) ;
V_71 = F_63 ( V_12 ) ;
if ( V_71 == - V_58 )
goto V_65;
...
static T_3 F_26 ( struct V_20 * V_21 , int V_75 )
{
struct V_36 * V_37 = V_21 -> V_19 ;
T_3 V_27 = F_5 ( F_27 ( V_37 -> V_2 ) , 4 ) ;
T_3 V_76 = F_64 ( T_3 , V_27 , V_37 -> V_43 ) ;
unsigned int V_77 ;
if ( V_21 -> V_44 . V_68 != V_69 )
V_77 = sizeof( struct V_78 ) ;
else
V_77 = 0 ;
return ( ( V_75 - V_21 -> V_44 . V_79 - F_23 ( V_37 -> V_2 ) -
V_77 ) & ~ ( V_76 - 1 ) ) + V_77 - 2 ;
}
...
type != V_89 )
return;
V_21 = F_67 ( V_85 , V_18 -> V_90 , ( const V_91 * ) & V_87 -> V_92 ,
V_23 -> V_50 , V_49 , V_93 ) ;
if ( ! V_21 )
return;
if ( type == V_89 )
F_68 ( V_18 , V_85 , V_18 -> V_86 -> V_94 , 0 ) ;
else
F_69 ( V_18 , V_85 , V_84 , 0 , 0 ) ;
F_70 ( V_21 ) ;
}
...
struct V_1 * V_2 ;
int V_16 ;
V_2 = F_74 ( V_21 -> V_2 -> V_95 , 0 , 0 ) ;
V_16 = F_75 ( V_2 ) ;
if ( F_76 ( V_2 ) )
goto error;
V_37 -> V_2 = V_2 ;
V_16 = F_77 ( V_2 , V_21 -> V_2 -> V_96 ,
( V_21 -> V_2 -> V_97 + 7 ) / 8 ) ;
if ( V_16 )
goto error;
V_16 = F_78 ( V_2 , V_21 -> V_2 -> V_98 / 8 ) ;
if ( V_16 )
goto error;
error:
return V_16 ;
...
( V_21 -> V_108 -> V_97 + 7 ) / 8 + F_80 ( sizeof( * V_100 ) ) ;
V_16 = - V_47 ;
...
V_102 = ( void * ) V_104 ;
V_102 -> V_112 = V_113 ;
V_102 -> V_114 = F_81 ( sizeof( * V_100 ) ) ;
V_100 = F_82 ( V_102 ) ;
V_104 += F_80 ( sizeof( * V_100 ) ) ;
if ( V_21 -> V_110 ) {
struct V_115 * V_116 ;
memcpy ( V_104 , V_21 -> V_110 -> V_96 , ( V_21 -> V_110 -> V_97 + 7 ) / 8 ) ;
V_104 += ( V_21 -> V_110 -> V_97 + 7 ) / 8 ;
V_116 = F_83 ( V_21 -> V_110 -> V_95 , 0 ) ;
F_84 ( ! V_116 ) ;
V_16 = - V_66 ;
...
V_100 -> V_123 = F_86 ( ( V_21 -> V_108 -> V_97 + 7 ) / 8 ) ;
memcpy ( V_104 , V_21 -> V_108 -> V_96 , ( V_21 -> V_108 -> V_97 + 7 ) / 8 ) ;
V_16 = F_77 ( V_2 , V_103 , V_107 ) ;
V_121:
F_19 ( V_103 ) ;
error:
return V_16 ;
...
F_2 ( V_2 ) ;
switch ( V_21 -> V_44 . V_68 ) {
case V_125 :
if ( V_21 -> V_126 . V_127 != V_93 )
...
V_76 = F_5 ( F_27 ( V_2 ) , 4 ) ;
if ( V_37 -> V_43 )
V_76 = F_64 ( T_3 , V_76 , V_37 -> V_43 ) ;
V_21 -> V_44 . V_131 = V_76 + 1 + F_23 ( V_37 -> V_2 ) ;
error:
return V_16 ;
}
static int T_4 F_89 ( void )
{
if ( F_90 ( & V_132 , V_93 ) < 0 ) {
F_91 ( L_7 , V_133 ) ;
return - V_134 ;
}
if ( F_92 ( & V_135 , V_49 ) < 0 ) {
F_91 ( L_8 , V_133 ) ;
F_93 ( & V_132 , V_93 ) ;
return - V_134 ;
}
...
{
if ( F_95 ( & V_135 , V_49 ) < 0 )
F_91 ( L_9 , V_133 ) ;
if ( F_93 ( & V_132 , V_93 ) < 0 )
F_91 ( L_10 , V_133 ) ;
}
