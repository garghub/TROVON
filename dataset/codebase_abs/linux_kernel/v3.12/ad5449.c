...
if ( V_7 )
return V_7 ;
V_2 -> V_48 . V_57 = & V_10 -> V_48 ;
V_2 -> V_58 = V_51 -> V_58 ;
V_2 -> V_24 = & V_59 ;
V_2 -> V_60 = V_61 ;
V_2 -> V_62 = V_6 -> V_43 -> V_62 ;
V_2 -> V_44 = V_6 -> V_43 -> V_44 ;
if ( V_6 -> V_43 -> V_63 ) {
unsigned int V_64 = 0x00 ;
if ( V_47 ) {
if ( V_47 -> V_65 )
V_64 |= V_66 ;
V_64 |= V_47 -> V_67 << V_68 ;
V_6 -> V_29 = V_47 -> V_67 != V_69 ;
} else {
V_6 -> V_29 = true ;
}
F_1 ( V_2 , V_70 , V_64 ) ;
...
static int F_26 ( struct V_45 * V_10 )
{
