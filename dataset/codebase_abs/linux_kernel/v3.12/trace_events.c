...
static int
F_129 ( struct V_78 * V_143 , struct V_35 * V_36 )
{
struct V_5 * V_14 = V_36 -> V_6 ;
...
static int
F_137 ( struct V_5 * V_14 , struct V_157 * V_158 )
{
int V_25 ;
V_25 = F_135 ( V_14 ) ;
if ( V_25 < 0 )
...
static int
F_140 ( struct V_5 * V_14 , struct V_48 * V_49 )
{
struct V_35 * V_36 ;
V_36 = F_138 ( V_14 , V_49 ) ;
if ( ! V_36 )
return - V_22 ;
return F_129 ( V_49 -> V_160 , V_36 ) ;
}
static T_5 int
...
static int F_154 ( struct V_169 * V_170 ,
...
static struct V_35 *
F_156 ( struct V_48 * V_49 , const char * system , const char * V_31 )
{
struct V_35 * V_36 ;
struct V_5 * V_14 ;
F_6 (file, &tr->events, list) {
...
static void
F_157 ( unsigned long V_173 , unsigned long V_174 , void * * V_175 )
{
...
static void
F_158 ( unsigned long V_173 , unsigned long V_174 , void * * V_175 )
{
struct V_176 * * V_177 = (struct V_176 * * ) V_175 ;
struct V_176 * V_34 = * V_177 ;
if ( ! V_34 )
...
if ( V_34 -> V_178 != - 1 )
( V_34 -> V_178 ) -- ;
F_157 ( V_173 , V_174 , V_175 ) ;
}
static int
F_159 ( struct V_94 * V_95 , unsigned long V_173 ,
...
static int
F_160 ( struct V_179 * V_180 , unsigned long V_173 ,
void * * V_175 )
{
struct V_176 * * V_177 = (struct V_176 * * ) V_175 ;
struct V_176 * V_34 = * V_177 ;
...
static void
F_161 ( struct V_179 * V_180 , unsigned long V_173 ,
void * * V_175 )
{
struct V_176 * * V_177 = (struct V_176 * * ) V_175 ;
struct V_176 * V_34 = * V_177 ;
...
if ( ! V_34 -> V_183 ) {
F_35 ( V_34 -> V_36 , 0 , 1 ) ;
F_162 ( V_34 -> V_36 -> V_6 -> V_158 ) ;
F_43 ( V_34 ) ;
}
* V_177 = NULL ;
}
static int
F_163 ( struct V_184 * V_185 ,
...
if ( ! strlen ( V_190 ) )
goto V_141;
V_25 = F_165 ( V_190 , 0 , & V_34 -> V_178 ) ;
if ( V_25 )
goto V_141;
V_195:
V_25 = F_166 ( V_36 -> V_6 -> V_158 ) ;
if ( ! V_25 ) {
V_25 = - V_162 ;
goto V_141;
}
...
F_35 ( V_36 , 0 , 1 ) ;
V_102:
F_162 ( V_36 -> V_6 -> V_158 ) ;
V_141:
F_43 ( V_34 ) ;
goto V_111;
}
static T_5 int F_168 ( void )
{
int V_25 ;
V_25 = F_169 ( & V_198 ) ;
if ( F_13 ( V_25 < 0 ) )
...
static inline int F_168 ( void ) { return 0 ; }
static T_5 void
F_171 ( struct V_48 * V_49 )
{
struct V_35 * V_36 ;
int V_25 ;
F_6 (file, &tr->events, list) {
V_25 = F_129 ( V_49 -> V_160 , V_36 ) ;
if ( V_25 < 0 )
F_126 ( L_28 ,
V_36 -> V_6 -> V_12 ) ;
}
...
static void F_143 ( struct V_5 * V_14 )
{
struct V_48 * V_49 ;
F_6 (tr, &ftrace_trace_arrays, list)
F_140 ( V_14 , V_49 ) ;
}
static T_5 int F_174 ( char * V_200 )
{
F_175 ( V_201 , V_200 , V_202 ) ;
V_203 = true ;
V_204 = true ;
return 1 ;
}
static int
F_176 ( struct V_78 * V_143 , struct V_48 * V_49 )
{
struct V_78 * V_148 ;
struct V_78 * V_75 ;
...
V_148 = F_125 ( L_36 , V_143 ) ;
if ( ! V_148 ) {
F_126 ( L_37 ) ;
return - V_22 ;
}
F_128 ( L_38 , 0444 , V_148 ,
V_206 ,
& V_207 ) ;
F_128 ( L_39 , 0444 , V_148 ,
V_208 ,
& V_207 ) ;
...
int F_177 ( struct V_78 * V_143 , struct V_48 * V_49 )
{
int V_25 ;
F_27 ( & V_50 ) ;
V_25 = F_176 ( V_143 , V_49 ) ;
if ( V_25 )
goto V_210;
F_148 ( & V_163 ) ;
F_155 ( V_49 ) ;
...
{
V_20 = F_181 ( V_10 , V_211 ) ;
V_82 = F_181 ( V_35 , V_211 ) ;
return 0 ;
}
static T_5 int F_182 ( void )
{
struct V_48 * V_49 = F_61 () ;
...
char * V_213 ;
int V_25 ;
F_151 (iter, __start_ftrace_events, __stop_ftrace_events) {
V_14 = * V_212 ;
V_25 = F_135 ( V_14 ) ;
if ( ! V_25 )
F_11 ( & V_14 -> V_69 , & V_159 ) ;
...
static T_5 void F_188 ( struct V_217 * V_218 )
{
F_54 ( & V_219 ) ;
F_189 ( & V_220 ) ;
F_190 ( 1 ) ;
...
static T_5 int F_193 ( void * V_222 )
{
void * V_223 ;
...
static T_5 void F_198 ( void )
{
struct V_225 * V_226 ;
V_226 = F_199 ( F_193 , NULL , L_48 ) ;
F_192 ( 1 ) ;
F_200 ( V_226 ) ;
}
...
static void
F_204 ( unsigned long V_173 , unsigned long V_174 ,
...
V_75 -> V_173 = V_173 ;
V_75 -> V_174 = V_174 ;
F_212 ( V_100 , V_31 , V_51 , V_235 ) ;
V_111:
F_213 ( & F_208 ( V_236 , V_234 ) ) ;
F_214 () ;
}
static T_5 void F_215 ( void )
{
int V_25 ;
V_25 = F_216 ( & V_238 ) ;
if ( F_13 ( V_25 < 0 ) ) {
