...
static int
F_70 ( struct V_121 * V_122 , unsigned long V_123 , void * V_124 )
{
F_60 () ;
return V_125 ;
}
static void F_71 ( enum F_71 F_71 , int V_126 )
{
struct V_60 * V_61 ;
unsigned long V_27 ;
if ( ! V_126 ) {
...
F_16 ( & V_28 , V_27 ) ;
if ( V_61 -> V_128 )
V_61 -> V_128 ( V_61 , F_71 ) ;
V_61 -> V_100 = V_126 ? 0 : 1 ;
} while ( 1 );
}
...
static int F_76 ( enum F_71 V_123 )
{
unsigned long V_27 ;
int V_7 ;
V_7 = F_61 () ;
...
static T_7 F_79 ( struct V_136 * V_130 , char * V_137 )
{
return sprintf ( V_137 , L_2 , V_9 ) ;
}
static T_7 F_80 ( struct V_136 * V_130 , char * V_137 )
{
return sprintf ( V_137 , L_2 , V_11 ) ;
}
static T_7 F_81 ( struct V_136 * V_130 , char * V_137 )
{
return sprintf ( V_137 , L_3 , V_138 ) ;
}
static int
F_54 ( void )
{
...
static int F_86 ( struct V_121 * V_146 ,
unsigned long V_123 , void * V_3 )
{
if ( V_45 == V_132 )
F_76 ( V_134 ) ;
return V_147 ;
