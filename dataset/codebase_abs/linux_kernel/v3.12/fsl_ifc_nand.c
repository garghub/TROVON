...
if ( ! ( V_142 & V_182 ) )
return 0 ;
if ( ( V_142 & V_183 ) != V_184 )
return 0 ;
return ( V_142 & V_185 ) == F_40 ( V_23 ) ;
}
static int F_41 ( struct V_186 * V_43 )
{
...
for ( V_40 = 0 ; V_40 < V_197 ; V_40 ++ ) {
if ( F_39 ( V_13 , V_40 , V_188 . V_198 ) )
break;
}
if ( V_40 >= V_197 ) {
F_11 ( & V_43 -> V_43 , L_36 ,
...
NULL , 0 ) ;
F_55 ( V_8 -> V_43 , L_40 ,
( unsigned long long ) V_188 . V_198 , V_8 -> V_40 ) ;
return 0 ;
V_205:
F_34 ( V_8 ) ;
return V_190 ;
