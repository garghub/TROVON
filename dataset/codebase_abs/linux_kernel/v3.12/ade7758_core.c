...
int F_25 ( struct V_1 * V_2 , bool V_30 )
{
int V_5 ;
T_3 V_31 ;
...
int V_5 ;
struct V_8 * V_9 ;
struct V_6 * V_7 = F_33 ( sizeof( * V_9 ) ) ;
if ( V_7 == NULL ) {
V_5 = - V_46 ;
goto V_22;
}
V_9 = F_3 ( V_7 ) ;
F_34 ( V_45 , V_7 ) ;
V_9 -> V_21 = F_35 ( V_47 , sizeof( * V_9 -> V_21 ) , V_48 ) ;
if ( V_9 -> V_21 == NULL ) {
V_5 = - V_46 ;
goto V_49;
}
V_9 -> V_11 = F_35 ( V_50 , sizeof( * V_9 -> V_11 ) , V_48 ) ;
if ( V_9 -> V_11 == NULL ) {
V_5 = - V_46 ;
goto V_51;
}
...
V_9 -> V_52 = & V_53 [ 0 ] ;
F_36 ( & V_9 -> V_10 ) ;
V_7 -> V_54 = V_45 -> V_2 . V_55 -> V_54 ;
V_7 -> V_2 . V_56 = & V_45 -> V_2 ;
V_7 -> V_57 = & V_58 ;
V_7 -> V_59 = V_60 ;
V_5 = F_37 ( V_7 ) ;
if ( V_5 )
