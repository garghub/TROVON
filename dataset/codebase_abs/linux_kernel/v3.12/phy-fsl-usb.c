...
struct V_146 * V_147 ;
T_1 V_4 ;
struct V_148 * V_149 = F_67 ( & V_128 -> V_76 ) ;
V_144 = F_43 ( V_145 , struct V_77 , V_28 ) ;
V_31 = & V_144 -> V_31 ;
F_68 ( V_145 , V_102 ) ;
V_31 -> V_34 = V_144 -> V_28 . V_34 ;
V_147 = F_69 ( V_128 , V_150 , 0 ) ;
if ( ! V_147 )
return - V_151 ;
V_5 = F_70 ( V_147 -> V_152 , sizeof( struct V_153 ) ) ;
V_144 -> V_19 = (struct V_153 * ) V_5 ;
V_149 -> V_154 = ( void * ) V_5 ;
if ( V_149 -> V_155 && V_149 -> V_155 ( V_128 ) != 0 )
return - V_156 ;
if ( V_149 -> V_157 ) {
V_158 = F_1 ;
V_159 = F_5 ;
...
V_144 -> V_118 = F_71 ( V_128 , 0 ) ;
V_130 = F_72 ( V_144 -> V_118 , F_56 ,
V_160 , V_161 , V_144 ) ;
if ( V_130 ) {
F_73 ( V_144 -> V_28 . V_76 , L_15 ,
V_144 -> V_118 , V_130 ) ;
F_74 ( V_144 -> V_19 ) ;
...
V_4 |= V_163 ;
F_10 ( V_4 , & V_144 -> V_19 -> V_73 ) ;
while ( F_12 ( & V_144 -> V_19 -> V_73 ) & V_163 )
;
V_4 = V_164 | ( V_149 -> V_165 ? V_166 : 0 ) ;
F_10 ( V_4 , & V_144 -> V_19 -> V_167 ) ;
...
if ( V_149 -> V_177 ) {
V_4 = F_75 ( & V_144 -> V_19 -> V_178 ) ;
V_4 |= V_179 ;
F_76 ( V_4 , & V_144 -> V_19 -> V_178 ) ;
}
...
unsigned long V_191 ;
int V_192 ;
F_78 ( & V_31 -> V_133 , V_191 ) ;
V_192 = F_79 ( V_188 , V_189 ,
V_136 L_17 L_18 ,
V_193 ) ;
V_189 -= V_192 ;
V_188 += V_192 ;
...
V_189 -= V_192 ;
V_188 += V_192 ;
F_81 ( & V_31 -> V_133 , V_191 ) ;
return V_190 - V_189 ;
}
static long F_82 ( struct V_203 * V_203 , unsigned int V_204 ,
unsigned long V_205 )
{
T_1 V_79 = 0 ;
switch ( V_204 ) {
...
static int F_84 ( struct V_212 * V_212 , struct V_203 * V_203 )
{
return 0 ;
}
...
V_213 = F_58 ( V_128 ) ;
if ( V_213 ) {
F_86 ( & V_128 -> V_76 , L_41 ) ;
return V_213 ;
}
V_213 = F_65 ( V_128 ) ;
if ( V_213 ) {
F_86 ( & V_128 -> V_76 , L_42 ) ;
return V_213 ;
}
V_213 = F_87 ( V_214 , V_143 , & V_215 ) ;
if ( V_213 ) {
F_86 ( & V_128 -> V_76 , L_43 ) ;
return V_213 ;
}
V_213 = F_88 ( & V_128 -> V_76 , & V_216 ) ;
if ( V_213 )
F_89 ( & V_128 -> V_76 , L_44 ) ;
return V_213 ;
}
...
struct V_148 * V_149 = F_67 ( & V_128 -> V_76 ) ;
F_91 ( & V_18 -> V_28 ) ;
F_92 ( V_18 -> V_118 , V_18 ) ;
F_74 ( ( void * ) V_5 ) ;
F_33 () ;
F_34 ( V_18 -> V_28 . V_34 ) ;
F_34 ( V_18 ) ;
F_93 ( & V_128 -> V_76 , & V_216 ) ;
F_94 ( V_214 , V_143 ) ;
if ( V_149 -> exit )
V_149 -> exit ( V_128 ) ;
return 0 ;
