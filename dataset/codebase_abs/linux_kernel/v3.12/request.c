...
V_82 -> V_53 . V_54 = V_7 ;
if ( V_7 -> V_101 & V_102 ) {
struct V_7 * V_162 = F_150 ( V_108 , 0 ,
V_36 -> V_122 . V_106 ) ;
V_162 -> V_101 = V_163 ;
V_162 -> V_137 = V_7 -> V_137 ;
V_162 -> V_109 = F_102 ;
V_162 -> V_97 = V_51 ;
F_135 ( V_162 , V_51 , V_82 -> V_45 ) ;
}
}
V_58:
F_142 ( & V_82 -> V_53 . V_51 , F_96 , NULL , V_51 ) ;
...
! V_57 -> V_166 )
return 0 ;
V_44 = ( F_170 () - V_57 -> V_167 ) / 1024 ;
if ( V_44 < 0 )
return 0 ;
V_44 += F_13 ( & V_57 -> V_168 ) ;
if ( V_44 >= 0 )
return 0 ;
V_44 += V_169 ;
if ( V_44 > 0 )
V_44 = F_171 ( V_44 , 6 ) ;
rand = F_172 () ;
V_44 -= F_173 ( & rand , V_170 ) ;
return V_44 > 0 ? V_44 : 1 ;
}
static void F_174 ( struct V_71 * V_171 )
{
F_175 ( V_171 -> V_172 ,
V_171 -> V_173 , 8 , 0 ) ;
V_171 -> V_173 = 0 ;
}
static struct V_174 * F_176 ( struct V_35 * V_36 , T_6 V_40 )
{
return & V_36 -> V_175 [ F_177 ( V_40 , V_176 ) ] ;
}
static void F_155 ( struct V_35 * V_36 , struct V_70 * V_82 )
{
struct V_64 * V_57 = V_82 -> V_53 . V_57 ;
struct V_7 * V_7 = & V_82 -> V_7 . V_7 ;
unsigned V_177 = V_21 ( V_36 , V_7 ) ;
unsigned V_81 , V_168 = F_169 ( V_57 ) ;
if ( F_13 ( & V_36 -> V_122 . V_178 ) ||
V_57 -> V_149 . V_150 > V_179 ||
( V_7 -> V_101 & V_132 ) )
goto V_99;
if ( V_177 == V_180 ||
( V_177 == V_181 &&
...
goto V_77;
V_44 = F_43 ( & V_36 -> V_189 , struct V_187 , V_190 ) ;
F_174 ( V_82 -> V_72 ) ;
V_44 -> V_191 = 0 ;
V_77:
if ( V_44 -> V_191 + V_7 -> V_59 > V_44 -> V_191 )
V_44 -> V_191 += V_7 -> V_59 ;
V_44 -> V_78 = F_148 ( V_7 ) ;
V_44 -> V_120 = V_120 + F_180 ( 5000 ) ;
V_82 -> V_72 -> V_173 = V_44 -> V_191 ;
F_181 ( & V_44 -> V_192 ) ;
F_182 ( & V_44 -> V_192 , F_176 ( V_36 , V_44 -> V_78 ) ) ;
F_66 ( & V_44 -> V_190 , & V_36 -> V_189 ) ;
F_57 ( & V_36 -> V_188 ) ;
} else {
V_82 -> V_72 -> V_173 = V_7 -> V_59 ;
F_174 ( V_82 -> V_72 ) ;
}
V_81 = F_183 ( V_82 -> V_72 -> V_173 ,
V_82 -> V_72 -> V_172 ) >> 9 ;
if ( V_36 -> V_182 &&
V_81 >= V_36 -> V_182 >> 9 ) {
F_184 ( V_82 -> V_116 ) ;
...
static void F_188 ( struct V_193 * V_194 , struct V_7 * V_7 )
{
struct V_70 * V_82 ;
struct V_128 * V_45 = V_7 -> V_137 -> V_195 -> V_196 ;
struct V_35 * V_36 = F_2 ( V_45 , struct V_35 , V_122 ) ;
int V_117 , V_118 = F_107 ( V_7 ) ;
V_117 = F_108 () ;
F_189 ( V_117 , & V_45 -> V_122 -> V_123 , V_197 [ V_118 ] ) ;
F_110 ( V_117 , & V_45 -> V_122 -> V_123 , V_81 [ V_118 ] , F_34 ( V_7 ) ) ;
F_111 () ;
V_7 -> V_137 = V_36 -> V_164 ;
V_7 -> V_55 += V_36 -> V_38 . V_198 ;
if ( F_190 ( V_36 ) ) {
V_82 = F_119 ( V_7 , V_45 ) ;
F_191 ( V_82 , V_7 ) ;
if ( ! F_192 ( V_7 ) )
...
F_193 ( V_7 , & V_45 -> V_199 ) ;
}
}
static int F_194 ( struct V_128 * V_45 , T_7 V_177 ,
unsigned int V_200 , unsigned long V_201 )
{
struct V_35 * V_36 = F_2 ( V_45 , struct V_35 , V_122 ) ;
return F_195 ( V_36 -> V_164 , V_177 , V_200 , V_201 ) ;
}
static int F_196 ( void * V_202 , int V_203 )
{
struct V_128 * V_45 = V_202 ;
struct V_35 * V_36 = F_2 ( V_45 , struct V_35 , V_122 ) ;
struct V_193 * V_194 = F_166 ( V_36 -> V_164 ) ;
int V_74 = 0 ;
if ( F_197 ( & V_194 -> V_204 , V_203 ) )
return 1 ;
if ( F_190 ( V_36 ) ) {
unsigned V_44 ;
struct V_205 * V_206 ;
F_198 (ca, d->c, i) {
V_194 = F_166 ( V_206 -> V_164 ) ;
V_74 |= F_197 ( & V_194 -> V_204 , V_203 ) ;
}
F_128 ( V_36 ) ;
}
return V_74 ;
...
{
struct V_207 * V_208 = V_36 -> V_122 . V_122 ;
V_208 -> V_209 -> V_210 = F_188 ;
V_208 -> V_209 -> V_204 . V_211 = F_196 ;
V_36 -> V_122 . V_136 = F_147 ;
V_36 -> V_122 . V_212 = F_194 ;
}
...
int V_44 ;
F_27 (bv, bio, i) {
unsigned V_213 = F_35 ( V_42 -> V_48 >> 9 , V_81 ) ;
...
static void F_202 ( struct V_193 * V_194 , struct V_7 * V_7 )
{
struct V_70 * V_82 ;
struct V_50 * V_51 ;
struct V_128 * V_45 = V_7 -> V_137 -> V_195 -> V_196 ;
...
static int F_203 ( struct V_128 * V_45 , T_7 V_177 ,
unsigned int V_200 , unsigned long V_201 )
{
return - V_215 ;
}
static int F_204 ( void * V_202 , int V_203 )
{
struct V_128 * V_45 = V_202 ;
struct V_193 * V_194 ;
struct V_205 * V_206 ;
...
{
struct V_207 * V_208 = V_45 -> V_122 ;
V_208 -> V_209 -> V_210 = F_202 ;
V_208 -> V_209 -> V_204 . V_211 = F_204 ;
V_45 -> V_136 = F_200 ;
V_45 -> V_212 = F_203 ;
}
void F_206 ( void )
