...
struct V_38 * V_40 ;
struct V_38 * V_41 ;
struct V_66 * V_67 = F_14 ( & V_65 -> V_5 ) ;
if ( ( V_65 -> V_68 != 3 ) && ( V_65 -> V_68 != 2 ) ) {
F_11 ( & V_65 -> V_5 , L_7 ) ;
return - V_69 ;
}
V_39 = F_15 ( V_65 , V_70 , 0 ) ;
if ( V_39 == NULL ) {
V_39 = F_15 ( V_65 , V_51 , 0 ) ;
if ( F_16 ( V_39 == NULL ) )
return - V_69 ;
}
V_40 = F_15 ( V_65 , V_70 , 1 ) ;
if ( V_40 == NULL ) {
V_40 = F_15 ( V_65 , V_51 , 1 ) ;
if ( F_16 ( V_40 == NULL ) )
return - V_69 ;
}
V_41 = F_15 ( V_65 , V_71 , 0 ) ;
if ( V_41 )
