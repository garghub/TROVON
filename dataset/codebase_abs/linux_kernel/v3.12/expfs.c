...
error = - V_55 ;
if ( ! V_4 || ! F_23 ( V_4 -> V_56 ) )
goto V_57;
error = - V_58 ;
if ( ! V_4 -> V_59 )
goto V_57;
V_51 = F_24 ( V_11 , V_60 , V_50 ) ;
error = F_18 ( V_51 ) ;
if ( F_17 ( V_51 ) )
goto V_57;
error = - V_58 ;
...
static int F_27 ( struct V_16 * V_16 , struct V_65 * V_65 ,
int * V_66 , struct V_16 * V_19 )
{
int V_41 = * V_66 ;
int type = V_67 ;
if ( V_19 && ( V_41 < 4 ) ) {
...
V_41 = 2 ;
V_65 -> V_69 . V_43 = V_16 -> V_38 ;
V_65 -> V_69 . V_70 = V_16 -> V_71 ;
if ( V_19 ) {
V_65 -> V_69 . V_72 = V_19 -> V_38 ;
V_65 -> V_69 . V_73 = V_19 -> V_71 ;
V_41 = 4 ;
type = V_74 ;
}
* V_66 = V_41 ;
...
int F_28 ( struct V_16 * V_16 , struct V_65 * V_65 ,
int * V_66 , struct V_16 * V_19 )
{
const struct V_7 * V_8 = V_16 -> V_75 -> V_10 ;
if ( V_8 && V_8 -> V_76 )
return V_8 -> V_76 ( V_16 , V_65 -> V_77 , V_66 , V_19 ) ;
return F_27 ( V_16 , V_65 , V_66 , V_19 ) ;
}
int F_29 ( struct V_3 * V_3 , struct V_65 * V_65 , int * V_66 ,
int V_78 )
{
int error ;
struct V_3 * V_79 = NULL ;
struct V_16 * V_16 = V_3 -> V_17 , * V_19 = NULL ;
if ( V_78 && ! F_23 ( V_16 -> V_56 ) ) {
V_79 = F_11 ( V_3 ) ;
V_19 = V_79 -> V_17 ;
}
error = F_28 ( V_16 , V_65 , V_66 , V_19 ) ;
F_8 ( V_79 ) ;
return error ;
}
struct V_3 * F_30 ( struct V_1 * V_2 , struct V_65 * V_65 ,
int V_80 , int V_81 ,
...
if ( ! V_8 || ! V_8 -> V_83 )
return F_14 ( - V_26 ) ;
V_13 = V_8 -> V_83 ( V_2 -> V_29 , V_65 , V_80 , V_81 ) ;
if ( ! V_13 )
V_13 = F_14 ( - V_26 ) ;
if ( F_17 ( V_13 ) )
return V_13 ;
if ( F_23 ( V_13 -> V_17 -> V_56 ) ) {
if ( V_13 -> V_20 & V_21 ) {
