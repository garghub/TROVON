...
V_4 >>= V_183 ;
V_181 = ( 1 << V_4 ) ;
V_184 = F_88 ( V_184 , V_181 ) ;
V_180 = V_7 -> V_179 & V_185 ;
V_180 >>= V_186 ;
if ( V_187 == - 1 )
V_187 = V_180 ;
else
V_187 = F_88 ( V_187 , V_180 ) ;
}
if ( F_54 ( V_7 , V_85 ) &&
F_54 ( V_7 , V_188 ) ) {
V_7 -> V_189 = true ;
...
if ( V_7 -> V_42 & ( 1UL << V_191 ) )
V_192 = true ;
F_83 ( V_7 ) ;
if ( F_89 ( V_7 -> V_11 ) ) {
int V_55 , V_193 ;
V_7 -> V_194 = F_86 ( V_7 -> V_11 -> V_39 -> V_195 ,
F_90 ( 0 , 0 ) ) ;
...
V_7 -> V_198 [ V_55 ] [ V_193 ] = F_4 ( V_7 , V_55 , V_193 ) ;
for ( V_55 = 0 ; V_55 < 0x83 ; V_55 ++ )
V_7 -> V_199 [ V_55 ] = F_8 ( V_7 , V_55 ) ;
}
F_75 ( V_7 ) ;
...
if ( V_7 -> V_42 & ( 1 << V_201 ) ) {
F_62 ( L_43 ) ;
for ( V_55 = 0 ; V_55 < F_94 ( V_200 ) ; ++ V_55 ) {
if ( F_54 ( V_7 , ( 1ULL << V_55 ) ) )
F_95 ( L_44 , V_200 [ V_55 ] ) ;
}
F_95 ( L_45 ) ;
}
}
...
break;
case V_213 :
for ( V_55 = V_125 -> V_1 ; V_55 <= V_125 -> V_214 ; ++ V_55 )
F_66 ( V_55 , V_125 ) ;
break;
default:
break;
...
case V_211 :
V_215 = L_48 ;
V_134 -> V_130 = V_134 -> V_216 = V_125 -> V_1 ;
break;
case V_212 :
V_215 = L_49 ;
V_134 -> V_130 = 0 ;
...
V_134 -> V_216 = V_125 -> V_214 ;
break;
}
V_134 -> V_217 = F_107 ( V_125 -> V_128 ) ;
V_134 -> V_218 = V_134 -> V_217 + F_107 ( V_125 -> V_129 ) ;
V_134 -> V_219 = V_125 -> V_94 >> 1 ;
F_68 ( L_51
L_52 , V_215 ,
F_36 ( V_134 -> V_130 ) , F_37 ( V_134 -> V_130 ) ,
F_38 ( V_134 -> V_130 ) , F_36 ( V_134 -> V_216 ) ,
F_37 ( V_134 -> V_216 ) , F_38 ( V_134 -> V_216 ) ,
V_134 -> V_217 , V_134 -> V_218 , V_125 -> V_94 ) ;
F_64 ( & V_134 -> V_112 , & V_220 ) ;
return 0 ;
}
...
int V_55 , V_193 ;
T_2 V_236 ;
struct V_237 * V_238 = V_7 -> V_194 ;
if ( ! F_89 ( V_7 -> V_11 ) || ! V_238 )
return;
F_5 ( V_238 , 0x60 , 0x75 | ( 1 << 7 ) ) ;
F_6 ( V_238 , 0x64 , & V_236 ) ;
if ( ! ( V_236 & 0x1 ) )
F_5 ( V_238 , 0x64 , V_236 | 1 ) ;
...
for ( V_55 = 0 ; V_55 < 6 ; V_55 ++ )
for ( V_193 = 0 ; V_193 < 0x12 ; V_193 ++ )
F_7 ( V_7 , V_55 , V_193 , V_7 -> V_198 [ V_55 ] [ V_193 ] ) ;
for ( V_55 = 0 ; V_55 < 0x83 ; V_55 ++ )
F_9 ( V_7 , V_55 , V_7 -> V_199 [ V_55 ] ) ;
F_5 ( V_7 -> V_11 , V_7 -> V_41 + 4 ,
V_7 -> V_196 | 1 ) ;
}
...
if ( V_247 )
V_243 = L_53 ;
for ( V_246 = 0 ; V_246 < V_248 ; V_246 ++ ) {
int V_1 , V_108 = F_127 ( V_246 ) ;
V_1 = F_128 ( V_108 ) ;
if ( V_1 < 0 ) {
F_24 ( L_54 ,
V_243 , V_108 ) ;
...
if ( ! V_255 )
return - V_57 ;
V_254 = F_132 ( L_57 , 0 , & V_252 , & V_253 ) ;
if ( V_254 == V_256 )
return - V_57 ;
else if ( F_133 ( V_254 ) ) {
const char * V_257 = F_134 ( V_254 ) ;
F_24 ( L_58 , V_257 ) ;
return - V_117 ;
}
V_119 = F_40 ( V_252 ) ;
...
case V_276 :
V_119 = F_96 () ;
V_267 = V_119 ? V_271 : V_277 ;
F_116 () ;
break;
case V_277 :
V_119 = F_120 () ;
V_267 = V_119 ? V_271 : V_278 ;
break;
case V_278 :
V_119 = F_139 () ;
V_267 = V_119 ? V_271 : V_279 ;
break;
case V_279 :
V_267 = V_280 ;
break;
...
static int T_6 F_147 ( enum V_281 V_282 )
{
int V_119 = 0 ;
while ( V_267 != V_282 ) {
V_119 = F_144 () ;
...
V_255 = true ;
V_285 = 1 ;
V_288 . V_7 . V_289 = F_154 ;
return 0 ;
}
static int T_6 F_156 ( char * V_290 )
{
V_291 = true ;
return 1 ;
}
static int T_6 F_157 ( char * V_290 )
{
for (; * V_290 ; ++ V_290 ) {
if ( strncmp ( V_290 , L_60 , 9 ) == 0 )
V_292 = true ;
if ( strncmp ( V_290 , L_61 , 3 ) == 0 )
V_287 = true ;
if ( strncmp ( V_290 , L_62 , 15 ) == 0 )
V_293 = true ;
}
return 1 ;
}
static int T_6 F_158 ( char * V_290 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
V_119 = sscanf ( V_290 , L_63 , & V_108 , & V_39 , & V_11 , & V_40 ) ;
if ( V_119 != 4 ) {
F_24 ( L_64 , V_290 ) ;
return 1 ;
}
...
static int T_6 F_159 ( char * V_290 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
...
int F_84 ( T_1 V_1 , T_3 V_295 , T_3 V_296 , T_3 V_297 ,
T_4 * V_148 , bool V_298 )
{
struct V_6 * V_7 ;
T_2 V_299 ;
T_2 V_300 ;
...
return - V_57 ;
V_7 = V_93 [ V_1 ] ;
if ( F_39 ( ( V_7 == NULL ) || ( V_297 > 0x28 ) || ( V_297 & 7 ) ) )
return - V_57 ;
V_299 = ( T_2 ) ( ( ( 0x40 | V_295 ) << 12 ) | ( V_296 << 8 ) | V_297 ) ;
V_300 = ( T_2 ) ( ( ( 0x40 | V_7 -> V_168 ) << 12 ) |
( V_7 -> V_169 << 8 ) | 0x28 ) ;
if ( ( V_299 < V_301 ) ||
( V_299 > V_300 ) )
return - V_117 ;
if ( V_298 ) {
F_17 ( ( T_2 ) * V_148 , V_7 -> V_19 + V_299 ) ;
F_17 ( ( * V_148 >> 32 ) , V_7 -> V_19 + V_299 + 4 ) ;
} else {
* V_148 = F_16 ( V_7 -> V_19 + V_299 + 4 ) ;
* V_148 <<= 32 ;
* V_148 = F_16 ( V_7 -> V_19 + V_299 ) ;
}
return 0 ;
}
