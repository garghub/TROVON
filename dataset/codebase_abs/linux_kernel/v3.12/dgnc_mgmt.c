...
T_3 V_49 = 0 ;
T_3 V_50 = 0 ;
if ( F_9 ( & V_47 , V_12 , sizeof( struct V_46 ) ) ) {
return ( - V_20 ) ;
}
F_3 ( ( L_10 ,
V_47 . V_49 , V_47 . V_50 ) ) ;
...
V_47 . V_78 = V_45 -> V_79 ;
V_47 . V_80 = V_45 -> V_81 ;
if ( V_45 -> V_82 . V_83 & V_84 || V_45 -> V_79 & V_85 )
V_47 . V_86 = 1 ;
else
V_47 . V_86 = 0 ;
if ( ( V_45 -> V_87 & V_88 ) || ( V_45 -> V_87 & V_89 ) )
V_47 . V_90 = 1 ;
else
V_47 . V_90 = 0 ;
