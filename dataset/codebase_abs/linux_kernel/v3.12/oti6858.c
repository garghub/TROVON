...
static int F_47 ( struct V_43 * V_44 , unsigned long V_112 )
{
struct V_6 * V_7 = V_44 -> V_46 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
unsigned long V_10 ;
unsigned int V_113 , V_96 ;
unsigned int V_114 ;
F_10 ( & V_4 -> V_19 , V_10 ) ;
V_113 = V_4 -> V_96 . V_94 ;
F_12 ( & V_4 -> V_19 , V_10 ) ;
...
return - V_119 ;
F_10 ( & V_4 -> V_19 , V_10 ) ;
V_96 = V_4 -> V_96 . V_94 & V_101 ;
F_12 ( & V_4 -> V_19 , V_10 ) ;
V_114 = V_113 ^ V_96 ;
if ( ( ( V_112 & V_120 ) && ( V_114 & V_108 ) ) ||
( ( V_112 & V_106 ) && ( V_114 & V_105 ) ) ||
( ( V_112 & V_111 ) && ( V_114 & V_110 ) ) ||
( ( V_112 & V_104 ) && ( V_114 & V_103 ) ) )
return 0 ;
V_113 = V_96 ;
}
return 0 ;
}
static void F_50 ( struct V_121 * V_121 )
{
struct V_6 * V_7 = V_121 -> V_122 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
int V_26 = 0 , V_123 = 0 , V_124 = 1 ;
int V_96 = V_121 -> V_96 ;
switch ( V_96 ) {
case 0 :
break;
...
case - V_126 :
case - V_127 :
F_14 ( & V_121 -> V_14 -> V_14 , L_10 ,
V_15 , V_96 ) ;
return;
default:
F_14 ( & V_121 -> V_14 -> V_14 , L_11 ,
V_15 , V_96 ) ;
break;
}
if ( V_96 == 0 && V_121 -> V_128 == V_12 ) {
struct V_8 * V_129 = V_121 -> V_39 ;
unsigned long V_10 ;
F_10 ( & V_4 -> V_19 , V_10 ) ;
if ( ! V_4 -> V_26 ) {
if ( ! F_11 ( V_129 , V_4 ) ) {
...
if ( ! V_4 -> V_26 ) {
if ( V_129 -> V_94 != V_4 -> V_96 . V_94 )
F_51 ( & V_7 -> V_7 . V_115 ) ;
memcpy ( & V_4 -> V_96 , V_129 , V_12 ) ;
}
if ( ! V_4 -> V_26 && V_129 -> V_95 != 0 ) {
V_123 = V_129 -> V_95 ;
V_4 -> V_10 . V_130 = 1 ;
}
V_26 = V_4 -> V_26 ;
...
static void F_52 ( struct V_121 * V_121 )
{
struct V_6 * V_7 = V_121 -> V_122 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
unsigned char * V_132 = V_121 -> V_39 ;
unsigned long V_10 ;
int V_96 = V_121 -> V_96 ;
int V_11 ;
F_10 ( & V_4 -> V_19 , V_10 ) ;
...
F_12 ( & V_4 -> V_19 , V_10 ) ;
if ( V_96 != 0 ) {
F_14 ( & V_121 -> V_14 -> V_14 , L_16 , V_15 ) ;
return;
}
if ( V_121 -> V_128 > 0 ) {
F_53 ( & V_7 -> V_7 , V_132 , V_121 -> V_128 ) ;
F_54 ( & V_7 -> V_7 ) ;
}
V_11 = F_15 ( V_7 -> V_28 , V_131 ) ;
if ( V_11 != 0 && V_11 != - V_133 ) {
F_4 ( & V_7 -> V_14 , L_13
L_14 , V_15 , V_11 ) ;
}
}
static void F_55 ( struct V_121 * V_121 )
{
struct V_6 * V_7 = V_121 -> V_122 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
int V_96 = V_121 -> V_96 ;
...
case - V_126 :
case - V_127 :
F_14 ( & V_121 -> V_14 -> V_14 , L_10 , V_15 , V_96 ) ;
V_4 -> V_10 . V_32 = 0 ;
return;
default:
F_14 ( & V_121 -> V_14 -> V_14 , L_17 , V_15 , V_96 ) ;
F_14 ( & V_121 -> V_14 -> V_14 , L_18 , V_15 ) ;
V_7 -> V_38 -> V_40 = 1 ;
V_11 = F_15 ( V_7 -> V_38 , V_131 ) ;
if ( V_11 ) {
F_18 ( V_7 , L_13
L_14 , V_15 , V_11 ) ;
} else {
