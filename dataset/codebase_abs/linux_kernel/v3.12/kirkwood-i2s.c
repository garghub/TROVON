...
static int F_20 ( struct V_36 * V_37 , int V_67 ,
struct V_1 * V_28 )
{
if ( V_37 -> V_44 == V_45 )
return F_16 ( V_37 , V_67 , V_28 ) ;
else
return F_19 ( V_37 , V_67 , V_28 ) ;
return 0 ;
}
...
struct V_4 * V_5 ;
struct V_97 * V_98 ;
struct V_99 * V_100 = V_90 -> V_30 . V_101 ;
int V_102 ;
V_5 = F_24 ( & V_90 -> V_30 , sizeof( * V_5 ) , V_103 ) ;
if ( ! V_5 ) {
F_25 ( & V_90 -> V_30 , L_4 ) ;
return - V_104 ;
}
F_26 ( & V_90 -> V_30 , V_5 ) ;
V_98 = F_27 ( V_90 , V_105 , 0 ) ;
V_5 -> V_16 = F_28 ( & V_90 -> V_30 , V_98 ) ;
if ( F_29 ( V_5 -> V_16 ) )
return F_30 ( V_5 -> V_16 ) ;
V_5 -> V_106 = F_31 ( V_90 , 0 ) ;
if ( V_5 -> V_106 <= 0 ) {
F_25 ( & V_90 -> V_30 , L_5 ) ;
return - V_107 ;
}
...
V_5 -> V_108 = V_92 -> V_108 ;
} else {
F_25 ( & V_90 -> V_30 , L_6 ) ;
return - V_15 ;
}
V_5 -> V_109 = F_32 ( & V_90 -> V_30 , V_100 ? L_7 : NULL ) ;
if ( F_29 ( V_5 -> V_109 ) ) {
F_25 ( & V_90 -> V_30 , L_8 ) ;
return F_30 ( V_5 -> V_109 ) ;
}
V_102 = F_33 ( V_5 -> V_109 ) ;
if ( V_102 < 0 )
return V_102 ;
V_5 -> V_33 = F_32 ( & V_90 -> V_30 , L_9 ) ;
if ( ! F_29 ( V_5 -> V_33 ) ) {
if ( V_5 -> V_33 == V_5 -> V_109 ) {
F_34 ( & V_90 -> V_30 , V_5 -> V_33 ) ;
V_5 -> V_33 = F_35 ( - V_15 ) ;
} else {
F_36 ( & V_90 -> V_30 , L_10 ) ;
F_33 ( V_5 -> V_33 ) ;
...
V_102 = F_37 ( & V_90 -> V_30 , & V_115 ,
V_95 , 1 ) ;
if ( V_102 ) {
F_25 ( & V_90 -> V_30 , L_11 ) ;
goto V_116;
}
V_102 = F_38 ( & V_90 -> V_30 , & V_117 ) ;
if ( V_102 ) {
F_25 ( & V_90 -> V_30 , L_12 ) ;
goto V_118;
}
