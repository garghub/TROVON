...
{
char V_143 [ 64 ] ;
snprintf ( V_143 , sizeof( V_143 ) , L_14 , V_29 -> V_93 ) ;
...
int F_102 ( struct V_42 * V_103 , char * V_148 )
{
int V_80 ;
int V_149 = 0 ;
for ( V_80 = 0 ; V_80 < V_81 ; ++ V_80 ) {
...
if ( V_29 )
V_149 += sprintf ( & V_148 [ V_149 ] , L_15 ,
V_29 -> type -> V_50 , V_29 -> V_93 ) ;
}
return V_149 ;
}
...
continue;
if ( V_152 == NULL )
V_152 = F_104 ( L_16 , V_151 ) ;
V_25 -> V_146 = F_104 ( V_25 -> V_50 , V_152 ) ;
}
}
static long F_105 ( struct V_145 * V_145 , unsigned int V_153 , unsigned long V_154 )
{
struct V_7 * V_29 = V_145 -> V_155 ;
int V_156 = F_106 ( V_145 -> V_157 -> V_158 ) ;
struct V_24 * V_25 ;
if ( F_107 ( V_153 ) != V_159 )
return - V_21 ;
F_108 ( V_81 != V_160 ) ;
F_108 ( V_81 !=
sizeof( V_2 ) / sizeof( V_2 [ 0 ] ) ) ;
if ( V_156 < 0 || V_156 >= V_81 )
return - V_21 ;
V_25 = & V_2 [ V_156 ] ;
F_109 ( V_29 && V_25 != V_29 -> type ) ;
switch ( F_110 ( V_153 ) ) {
case V_161 :
if ( V_25 -> V_4 )
return - V_162 ;
if ( V_29 != NULL )
return - V_163 ;
V_29 = F_47 ( V_25 , F_111 ( V_153 ) ,
( const unsigned char T_4 * ) V_154 ) ;
if ( F_112 ( V_29 ) )
return F_113 ( V_29 ) ;
V_145 -> V_155 = V_29 ;
return 0 ;
...
static long F_114 ( struct V_145 * V_145 ,
unsigned int V_153 , unsigned long V_154 )
{
return F_105 ( V_145 , V_153 , ( unsigned long ) F_115 ( V_154 ) ) ;
}
static int F_116 ( struct V_145 * V_145 , T_5 V_167 )
{
struct V_7 * V_29 = V_145 -> V_155 ;
struct V_42 * V_103 , * V_168 ;
unsigned long V_60 ;
if ( V_29 ) {
struct V_24 * V_25 = V_29 -> type ;
F_57 ( & V_25 -> V_47 , V_60 ) ;
F_117 (task, tmp, &info->task_head,
thread.hardwall[hwt->index].list) {
if ( V_103 -> V_169 == V_167 || V_103 -> V_169 == NULL )
F_67 ( V_25 , V_103 ) ;
}
F_59 ( & V_25 -> V_47 , V_60 ) ;
}
...
static int F_118 ( struct V_144 * V_144 , struct V_145 * V_145 )
{
F_90 ( V_145 -> V_155 ) ;
return 0 ;
}
...
int V_85 ;
T_6 V_170 ;
V_85 = F_120 ( & V_170 , 0 , V_81 , L_16 ) ;
if ( V_85 < 0 )
return V_85 ;
F_121 ( & V_171 , & V_172 ) ;
V_85 = F_122 ( & V_171 , V_170 , V_81 ) ;
if ( V_85 < 0 )
return V_85 ;
return 0 ;
}
