...
static void F_92 ( unsigned long V_153 )
{
struct V_21 * V_15 = (struct V_21 * ) V_153 ;
F_76 ( V_15 ) ;
F_8 ( & V_15 -> V_154 ) ;
...
return;
F_88 ( & V_15 -> V_181 ) ;
V_15 -> V_181 . V_177 = ( F_87 () + V_173 -> V_180 * V_176 ) ;
V_15 -> V_181 . V_153 = ( unsigned long ) V_15 ;
V_15 -> V_181 . V_178 = F_92 ;
V_15 -> V_179 &= ~ V_156 ;
V_15 -> V_179 |= V_158 ;
F_89 ( & V_15 -> V_181 ) ;
F_25 ( L_37
...
V_183 = F_97 ( V_15 , & V_187 [ 0 ] , V_185 , V_184 ) ;
if ( V_184 != V_183 ) {
if ( V_183 == - V_192 ) {
F_3 ( L_39 ) ;
goto V_188;
...
T_1 V_209 = F_99 ( T_1 , V_197 , V_208 ) ;
V_210:
V_183 = V_15 -> V_211 -> V_212 -> V_213 ( V_15 -> V_211 ,
F_100 ( V_194 ) , V_194 -> V_3 + V_3 , V_209 , 0 ) ;
if ( V_183 != V_209 ) {
if ( V_183 == - V_192 ) {
F_3 ( L_40
L_41 ) ;
...
V_183 = F_97 ( V_15 , V_215 , 1 , V_2 -> V_206 ) ;
if ( V_2 -> V_206 != V_183 ) {
if ( V_183 == - V_192 ) {
F_3 ( L_39 ) ;
goto V_214;
...
int F_102 ( struct V_21 * V_15 , T_4 V_218 , T_4 V_219 )
{
struct V_220 * V_66 ;
struct V_221 * V_222 = V_15 -> V_223 ;
V_222 -> V_224 = 1 ;
F_103 ( V_15 , V_218 , V_219 ) ;
...
V_205 = V_232 -> V_185 ;
while ( V_234 < V_153 ) {
V_233 = F_108 ( V_15 -> V_211 , & V_236 , V_215 , V_205 ,
( V_153 - V_234 ) , V_237 ) ;
if ( V_233 <= 0 ) {
F_25 ( L_45 ,
V_233 , V_234 ) ;
...
V_205 = V_232 -> V_185 ;
while ( V_238 < V_153 ) {
V_239 = F_110 ( V_15 -> V_211 , & V_236 , V_215 , V_205 ,
( V_153 - V_238 ) ) ;
if ( V_239 <= 0 ) {
F_25 ( L_48 ,
V_239 , V_238 ) ;
...
struct V_161 * F_112 ( struct V_21 * V_15 )
{
struct V_159 * V_160 ;
if ( ! V_15 || ! V_15 -> V_25 )
return NULL ;
