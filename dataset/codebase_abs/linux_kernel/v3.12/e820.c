...
int V_3 ;
unsigned long V_81 ;
V_81 = F_30 ( V_4 . V_8 [ 0 ] . V_9 + V_4 . V_8 [ 0 ] . V_10 ) ;
for ( V_3 = 1 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
struct V_6 * V_7 = & V_4 . V_8 [ V_3 ] ;
if ( V_81 < F_31 ( V_7 -> V_9 ) )
F_32 ( V_81 , F_31 ( V_7 -> V_9 ) ) ;
V_81 = F_30 ( V_7 -> V_9 + V_7 -> V_10 ) ;
if ( V_7 -> type != V_15 && V_7 -> type != V_16 )
F_32 ( F_31 ( V_7 -> V_9 ) , V_81 ) ;
if ( V_81 >= V_80 )
break;
}
}
...
V_87 = F_71 (unsigned long, start_pfn, MAX_DMA_PFN) ;
V_88 = F_71 (unsigned long, end_pfn, MAX_DMA_PFN) ;
V_128 += V_88 - V_87 ;
}
F_72 (u, MAX_NUMNODES, &start, &end, NULL) {
V_87 = F_71 (unsigned long, PFN_UP(start), MAX_DMA_PFN) ;
V_88 = F_71 (unsigned long, PFN_DOWN(end), MAX_DMA_PFN) ;
if ( V_87 < V_88 )
V_129 += V_88 - V_87 ;
}
F_73 ( V_128 - V_129 ) ;
