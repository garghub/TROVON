...
struct V_31 * V_32 = V_15 -> V_33 ;
int V_383 ;
V_383 = F_131 ( V_15 , V_170 , V_172 , V_164 , 0 ) ;
if ( V_383 )
return V_383 ;
F_85 ( V_170 -> V_384 ,
V_32 -> V_201 + V_385 ) ;
...
static int F_132 ( struct V_14 * V_15 , struct V_169 * V_170 ,
struct V_171 * V_172 , unsigned int * V_164 )
{
struct V_31 * V_32 = V_15 -> V_33 ;
if ( V_164 [ 0 ] ) {
...
static int F_133 ( struct V_14 * V_15 , unsigned int V_163 ,
T_2 V_387 )
{
struct V_31 * V_32 = V_15 -> V_33 ;
...
static T_1 F_141 ( struct V_14 * V_15 , T_2 V_163 )
{
struct V_31 * V_32 = V_15 -> V_33 ;
static const int V_389 = 11 ;
...
struct V_171 * V_172 , unsigned int * V_164 )
{
V_164 [ 0 ] = F_141 ( V_15 , F_58 ( V_172 -> V_176 ) ) ;
return 1 ;
}
...
F_145 ( V_15 , V_170 , F_127 ,
( unsigned long ) V_414 ) ;
} else {
V_414 =
V_32 -> V_201 + V_448 ;
F_145 ( V_15 , V_170 , F_126 ,
( unsigned long ) V_414 ) ;
}
} else
V_170 -> type = V_441 ;
...
V_170 -> V_440 = F_136 ;
for ( V_128 = 0 ; V_128 < V_170 -> V_424 ; V_128 ++ )
F_135 ( V_15 , V_128 , V_170 -> V_427 / 2 ) ;
V_170 = & V_15 -> V_415 [ 7 ] ;
if ( V_17 -> V_10 == V_18 ) {
V_170 -> type = V_450 ;
V_170 -> V_417 = V_418 | V_436 | V_451 ;
...
V_170 -> V_427 = 0xff ;
for ( V_128 = 0 ; V_128 < V_170 -> V_424 ; V_128 ++ )
F_138 ( V_15 , V_128 , V_170 -> V_427 / 2 ) ;
} else
V_170 -> type = V_441 ;
V_170 = & V_15 -> V_415 [ 8 ] ;
...
V_32 -> V_462 = F_151 ( V_127 , 2 ) ;
V_32 -> V_463 = F_151 ( V_127 , 3 ) ;
V_32 -> V_36 = F_152 ( V_127 , 0 ) ;
V_32 -> V_46 = F_152 ( V_127 , 2 ) ;
V_32 -> V_201 = F_152 ( V_127 , 3 ) ;
if ( ! V_32 -> V_36 || ! V_32 -> V_46
|| ! V_32 -> V_201 ) {
F_153 ( V_15 -> V_199 , L_74 ) ;
return - V_132 ;
}
F_33 ( L_75 , V_32 -> V_36 ) ;
F_33 ( L_76 , V_32 -> V_46 ) ;
...
F_35 ( V_15 ) ;
F_43 ( V_15 ) ;
if ( F_154 ( V_127 -> V_344 , F_111 , V_470 ,
L_81 , V_15 ) ) {
