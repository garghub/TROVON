...
{
int V_47 ;
for ( V_47 = V_37 ; V_47 < V_48 ; V_47 ++ ) {
T_2 V_2 ;
T_6 V_49 , V_50 ;
V_2 = F_61 ( V_47 , & V_49 , & V_50 ) ;
if ( F_53 ( V_2 ) ) {
V_34 [ V_47 ] = 1 ;
}
}
