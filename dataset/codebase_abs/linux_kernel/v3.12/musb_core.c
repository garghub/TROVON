...
static int
F_122 ( struct V_2 * V_3 , int V_230 , void T_2 * V_237 )
{
int V_174 ;
struct V_1 * V_1 ;
struct V_238 * V_239 = F_123 ( V_3 ) ;
if ( ! V_239 ) {
F_12 ( V_3 , L_77 ) ;
V_174 = - V_231 ;
goto V_240;
}
V_1 = F_109 ( V_3 , V_239 -> V_136 , V_237 ) ;
if ( ! V_1 ) {
V_174 = - V_241 ;
goto V_240;
}
...
F_4 ( V_1 -> V_30 ) ;
if ( V_252 && V_3 -> V_253 )
V_1 -> V_236 = F_129 ( V_1 , V_1 -> V_36 ) ;
F_56 ( V_1 ) ;
F_52 ( V_1 ) ;
V_174 = F_74 ( V_239 -> V_136 -> V_254
? V_187
: V_255 , V_1 ) ;
if ( V_174 < 0 )
goto V_256;
F_130 ( & V_1 -> V_98 , F_25 , ( unsigned long ) V_1 ) ;
F_131 ( & V_1 -> V_116 , F_106 ) ;
if ( F_132 ( V_230 , V_1 -> V_248 , 0 , F_133 ( V_3 ) , V_1 ) ) {
...
if ( V_239 -> V_257 ) {
T_3 V_258 = F_136 ( V_1 -> V_36 ) ;
V_258 |= V_259 ;
F_137 ( V_1 -> V_36 , V_258 ) ;
}
...
if ( V_174 < 0 )
goto V_263;
V_174 = F_141 ( & V_1 -> V_30 -> V_221 , & V_234 ) ;
if ( V_174 )
goto V_264;
F_7 ( V_1 -> V_30 ) ;
return 0 ;
...
int V_265 = F_146 ( V_127 , L_81 ) ;
struct V_266 * V_267 ;
void T_2 * V_268 ;
V_267 = F_147 ( V_127 , V_269 , 0 ) ;
if ( ! V_267 || V_265 <= 0 )
return - V_231 ;
V_268 = F_148 ( V_3 , V_267 ) ;
if ( F_149 ( V_268 ) )
return F_150 ( V_268 ) ;
return F_122 ( V_3 , V_265 , V_268 ) ;
}
...
{
int V_9 ;
void T_2 * V_270 = V_1 -> V_36 ;
void T_2 * V_271 ;
V_1 -> V_272 . V_273 = F_20 ( V_270 , V_274 ) ;
V_1 -> V_272 . V_275 = F_5 ( V_270 , V_121 ) ;
V_1 -> V_272 . V_258 = F_136 ( V_1 -> V_36 ) ;
V_1 -> V_272 . V_11 = F_5 ( V_270 , V_14 ) ;
V_1 -> V_272 . V_276 = F_5 ( V_270 , V_107 ) ;
V_1 -> V_272 . V_32 = F_5 ( V_270 , V_140 ) ;
V_1 -> V_272 . V_62 = F_5 ( V_270 , V_83 ) ;
...
continue;
F_6 ( V_270 , V_140 , V_9 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_278 =
F_20 ( V_271 , V_279 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_280 =
F_20 ( V_271 , V_281 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_282 =
F_20 ( V_271 , V_283 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_284 =
F_20 ( V_271 , V_285 ) ;
if ( V_1 -> V_177 ) {
V_1 -> V_272 . V_277 [ V_9 ] . V_286 =
F_153 ( V_270 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_287 =
F_154 ( V_270 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_288 =
F_155 ( V_270 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_289 =
F_156 ( V_270 ) ;
}
V_1 -> V_272 . V_277 [ V_9 ] . V_290 =
F_5 ( V_271 , V_291 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_292 =
F_5 ( V_271 , V_293 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_294 =
F_5 ( V_271 , V_295 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_296 =
F_5 ( V_271 , V_297 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_298 =
F_157 ( V_270 , V_9 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_299 =
F_158 ( V_270 , V_9 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_300 =
F_159 ( V_270 , V_9 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_301 =
F_160 ( V_270 , V_9 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_302 =
F_161 ( V_270 , V_9 ) ;
V_1 -> V_272 . V_277 [ V_9 ] . V_303 =
F_162 ( V_270 , V_9 ) ;
}
}
...
void T_2 * V_304 ;
void T_2 * V_271 ;
F_15 ( V_270 , V_274 , V_1 -> V_272 . V_273 ) ;
F_6 ( V_270 , V_121 , V_1 -> V_272 . V_275 ) ;
F_137 ( V_1 -> V_36 , V_1 -> V_272 . V_258 ) ;
F_6 ( V_270 , V_14 , V_1 -> V_272 . V_11 ) ;
F_15 ( V_270 , V_104 , V_1 -> V_102 ) ;
F_15 ( V_270 , V_106 , V_1 -> V_105 ) ;
F_6 ( V_270 , V_107 , V_1 -> V_272 . V_276 ) ;
F_6 ( V_270 , V_83 , V_1 -> V_272 . V_62 ) ;
for ( V_9 = 0 ; V_9 < V_1 -> V_136 -> V_167 ; ++ V_9 ) {
struct V_25 * V_26 ;
V_26 = & V_1 -> V_35 [ V_9 ] ;
if ( ! V_26 )
...
F_6 ( V_270 , V_140 , V_1 -> V_272 . V_32 ) ;
}
