...
V_2 -> V_113 = 0 ;
F_19 ( & V_2 -> V_42 , V_39 ) ;
V_33 -> V_89 -> V_132 ( V_33 , V_133 , 0 ) ;
}
static T_13
F_77 ( struct V_134 * V_135 )
{
struct V_61 * V_70 = F_14 ( V_135 , struct V_61 ,
V_62 ) ;
struct V_1 * V_2 = F_13 ( V_135 -> V_33 ) ;
unsigned long V_39 ;
T_13 V_136 ;
F_18 ( & V_2 -> V_42 , V_39 ) ;
V_136 = F_78 ( V_135 ) ;
...
static struct V_134 *
F_79 ( struct V_32 * V_33 , T_9 V_137 , T_9 V_138 ,
T_2 V_139 , unsigned long V_39 )
{
struct V_3 * V_4 ;
struct V_61 * V_70 ;
unsigned long V_140 ;
struct V_1 * V_2 = F_13 ( V_33 ) ;
int V_141 ;
T_7 V_142 = F_15 ( V_2 ) -> V_103 ;
int V_24 ;
F_18 ( & V_2 -> V_42 , V_140 ) ;
F_2 ( F_3 ( V_2 ) ,
L_19 ,
V_108 , V_2 -> V_36 , V_138 , V_137 , V_139 ) ;
if ( V_39 & V_143 )
V_142 |= V_144 ;
V_141 = V_139 >> V_145 ;
if ( ( V_141 << V_145 ) < V_139 )
V_141 ++ ;
V_4 = F_80 ( & V_2 -> V_41 -> V_20 , V_141 ) ;
if ( V_4 == NULL )
goto V_110;
V_24 = F_81 (
& V_2 -> V_41 -> V_20 , V_4 , V_138 , V_139 , V_137 ,
F_15 ( V_2 ) -> V_146 ,
V_142 ) ;
if ( V_24 )
goto V_110;
...
static struct V_134 *
F_83 ( struct V_32 * V_33 , struct V_148 * V_149 ,
unsigned int V_67 , enum V_150 V_151 ,
unsigned long V_39 , void * V_152 )
{
struct V_1 * V_2 = F_13 ( V_33 ) ;
struct V_3 * V_4 ;
struct V_61 * V_70 ;
const struct V_34 * V_153 ;
struct V_148 * V_66 ;
int V_154 = 0 ;
int V_139 ;
int V_6 ;
T_7 V_155 = F_15 ( V_2 ) -> V_146 ;
T_7 V_156 = F_15 ( V_2 ) -> V_157 ;
T_7 V_142 = F_15 ( V_2 ) -> V_103 ;
T_7 V_102 ;
unsigned long V_140 ;
int V_24 ;
...
V_169 = V_139 >> V_145 ;
if ( ( V_169 << V_145 ) < V_139 )
V_169 ++ ;
V_154 += V_169 ;
}
F_86 ( L_21 , V_154 ) ;
V_4 = F_80 ( & V_2 -> V_41 -> V_20 , V_154 ) ;
if ( V_4 == NULL )
goto V_171;
V_24 = F_87 ( & V_2 -> V_41 -> V_20 , V_4 , V_149 , V_67 ,
V_2 -> V_172 ,
V_155 ,
V_156 ,
V_142 ,
...
static enum V_175
F_88 ( struct V_32 * V_33 , T_13 V_136 ,
struct V_176 * V_177 )
{
struct V_1 * V_2 = F_13 ( V_33 ) ;
enum V_175 V_24 ;
V_24 = F_89 ( V_33 , V_136 , V_177 ) ;
if ( V_24 == V_178 )
return V_24 ;
F_90 ( V_177 , F_43 ( V_33 ) ) ;
if ( V_24 == V_179 && V_2 -> V_83 )
V_24 = V_180 ;
return V_24 ;
}
static void
F_91 ( struct V_32 * V_33 )
{
struct V_1 * V_2 = F_13 ( V_33 ) ;
unsigned long V_39 ;
F_18 ( & V_2 -> V_42 , V_39 ) ;
...
T_7 V_156 = 0 ;
int V_6 = 0 ;
if ( V_102 -> V_151 == V_163 ) {
V_172 = V_102 -> V_8 ;
V_183 = V_102 -> V_185 ;
V_184 = V_102 -> V_186 ;
} else if ( V_102 -> V_151 == V_158 ) {
V_172 = V_102 -> V_9 ;
V_183 = V_102 -> V_187 ;
V_184 = V_102 -> V_188 ;
} else {
...
V_190 |
V_191 ;
while ( V_6 < F_93 ( V_192 ) ) {
if ( V_192 [ V_6 ] . V_193 <= V_184 )
break;
V_6 ++ ;
}
break;
...
V_156 |= V_192 [ V_6 ] . V_202 ;
F_60 ( F_3 ( V_2 ) ,
L_25 ,
V_192 [ V_6 ] . V_193 , V_183 , V_184 ) ;
V_2 -> V_172 = V_172 ;
V_2 -> V_156 = V_156 ;
}
static int
F_94 ( struct V_32 * V_33 , enum V_203 V_204 ,
unsigned long V_205 )
{
unsigned long V_39 ;
struct V_1 * V_2 = F_13 ( V_33 ) ;
...
void F_95 ( struct V_210 * V_211 , const int * V_212 ,
struct V_119 * V_41 )
{
int V_213 ;
int V_6 = 0 ;
struct V_1 * V_2 ;
F_31 ( & V_211 -> V_214 ) ;
for ( V_213 = 0 ; V_212 [ V_213 ] != - 1 ; V_213 += 2 ) {
for ( V_6 = V_212 [ V_213 ] ; V_6 <= V_212 [ V_213 + 1 ] ; V_6 ++ ) {
V_2 = & V_41 -> V_124 [ V_6 ] ;
V_2 -> V_41 = V_41 ;
V_2 -> V_33 . V_89 = V_211 ;
V_2 -> V_36 = V_6 ;
...
static int T_5 F_98 ( struct V_216 * V_217 )
{
int V_110 = 0 ;
struct V_119 * V_41 ;
int V_114 ;
struct V_218 * V_219 ;
V_219 = F_99 ( V_217 , V_220 , 0 ) ;
if ( ! V_219 )
return - V_221 ;
if ( F_100 ( & V_217 -> V_122 ,
V_219 -> V_222 ,
F_101 ( V_219 ) ,
V_217 -> V_122 . V_223 -> V_224 ) == NULL )
return - V_26 ;
V_41 = F_102 ( & V_217 -> V_122 ,
...
V_41 -> V_44 = F_104 ( & V_217 -> V_122 , V_219 -> V_222 , F_101 ( V_219 ) ) ;
if ( ! V_41 -> V_44 )
return - V_26 ;
V_41 -> V_122 = & V_217 -> V_122 ;
F_96 ( & V_41 -> V_18 . V_42 ) ;
V_41 -> V_18 . V_16 = 0 ;
F_105 ( V_17 , V_41 ) ;
V_114 = F_106 ( V_217 , 0 ) ;
if ( V_114 < 0 )
return V_114 ;
V_110 = F_107 ( & V_217 -> V_122 , V_114 , F_67 , V_225 ,
L_26 , V_41 ) ;
if ( V_110 )
return V_110 ;
V_110 = F_108 ( & V_41 -> V_20 , & V_217 -> V_122 ,
sizeof( struct V_3 ) ,
32 ) ;
if ( V_110 )
return V_110 ;
F_95 ( & V_41 -> V_88 , V_226 ,
V_41 ) ;
F_52 ( V_41 -> V_88 . V_227 ) ;
F_53 ( V_96 , V_41 -> V_88 . V_227 ) ;
V_41 -> V_88 . V_228 = F_74 ;
V_41 -> V_88 . V_229 = F_76 ;
V_41 -> V_88 . V_230 = F_83 ;
V_41 -> V_88 . V_231 = F_88 ;
V_41 -> V_88 . V_232 = F_91 ;
V_41 -> V_88 . V_132 = F_94 ;
V_41 -> V_88 . V_122 = & V_217 -> V_122 ;
V_110 = F_109 ( & V_41 -> V_88 ) ;
if ( V_110 )
goto V_233;
F_95 ( & V_41 -> V_234 , V_235 ,
V_41 ) ;
F_52 ( V_41 -> V_234 . V_227 ) ;
F_53 ( V_236 , V_41 -> V_234 . V_227 ) ;
V_41 -> V_234 . V_228 = F_74 ;
V_41 -> V_234 . V_229 = F_76 ;
V_41 -> V_234 . V_237 = F_79 ;
V_41 -> V_234 . V_231 = F_88 ;
V_41 -> V_234 . V_232 = F_91 ;
V_41 -> V_234 . V_132 = F_94 ;
V_41 -> V_234 . V_122 = & V_217 -> V_122 ;
V_41 -> V_234 . V_238 = 2 ;
V_110 = F_109 ( & V_41 -> V_234 ) ;
if ( V_110 )
goto V_239;
V_110 = F_110 ( V_217 -> V_122 . V_240 , F_51 ,
V_41 ) ;
if ( V_110 )
goto V_241;
F_111 ( V_217 , V_41 ) ;
F_112 ( & V_217 -> V_122 , L_27 ,
( T_7 ) V_41 -> V_44 ) ;
return V_110 ;
V_241:
F_113 ( & V_41 -> V_234 ) ;
...
{
struct V_119 * V_41 = F_116 ( V_217 ) ;
F_117 ( V_217 -> V_122 . V_240 ) ;
F_113 ( & V_41 -> V_234 ) ;
F_113 ( & V_41 -> V_88 ) ;
F_114 ( & V_41 -> V_20 ) ;
return 0 ;
