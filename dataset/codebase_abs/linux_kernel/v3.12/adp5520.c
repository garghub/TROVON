...
V_9 = F_30 ( & V_2 -> V_6 , sizeof( * V_9 ) , V_43 ) ;
if ( ! V_9 )
return - V_44 ;
F_31 ( V_2 , V_9 ) ;
V_9 -> V_2 = V_2 ;
...
V_5 = F_10 ( V_9 -> V_6 , V_25 , V_48 ) ;
if ( V_5 ) {
F_3 ( & V_2 -> V_6 , L_7 ) ;
goto V_49;
}
if ( V_37 -> V_50 ) {
V_39 = F_35 ( V_9 -> V_6 , L_8 ,
V_9 -> V_35 , V_37 -> V_50 , sizeof( * V_37 -> V_50 ) ) ;
if ( F_36 ( V_39 ) ) {
V_5 = F_37 ( V_39 ) ;
goto V_51;
}
...
if ( V_37 -> V_53 ) {
V_39 = F_35 ( V_9 -> V_6 , L_10 ,
V_9 -> V_35 , V_37 -> V_53 , sizeof( * V_37 -> V_53 ) ) ;
if ( F_36 ( V_39 ) ) {
V_5 = F_37 ( V_39 ) ;
goto V_51;
}
...
struct V_8 * V_9 = F_14 ( & V_2 -> V_6 ) ;
F_12 ( V_9 -> V_6 , V_25 , & V_9 -> V_55 ) ;
V_9 -> V_55 &= V_56 | V_57 | V_48 ;
F_10 ( V_9 -> V_6 , V_25 , 0 ) ;
return 0 ;
}
