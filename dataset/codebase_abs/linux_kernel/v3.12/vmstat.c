...
#endif
#ifdef F_123
F_124 ( L_36 , V_141 , NULL , & V_142 ) ;
F_124 ( L_37 , V_141 , NULL , & V_143 ) ;
F_124 ( L_38 , V_141 , NULL , & V_144 ) ;
F_124 ( L_39 , V_141 , NULL , & V_145 ) ;
#endif
return 0 ;
}
static int F_125 ( unsigned int V_61 ,
struct V_59 * V_60 )
{
if ( V_60 -> V_62 == 0 )
return 1000 ;
...
static void F_126 ( struct V_70 * V_71 ,
T_1 * V_21 , struct V_10 * V_10 )
{
unsigned int V_61 ;
int V_146 ;
...
for ( V_61 = 0 ; V_61 < V_65 ; ++ V_61 ) {
F_58 ( V_10 , V_61 , & V_60 ) ;
V_146 = F_125 ( V_61 , & V_60 ) ;
F_73 ( V_71 , L_40 , V_146 / 1000 , V_146 % 1000 ) ;
}
F_74 ( V_71 , '\n' ) ;
}
static int F_127 ( struct V_70 * V_71 , void * V_73 )
{
T_1 * V_21 = ( T_1 * ) V_73 ;
if ( ! F_87 ( V_21 -> V_76 , V_90 ) )
return 0 ;
F_67 ( V_71 , V_21 , F_126 ) ;
return 0 ;
}
static int F_128 ( struct V_92 * V_92 , struct V_93 * V_93 )
{
return F_89 ( V_93 , & V_147 ) ;
}
