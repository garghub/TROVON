...
static int F_63 ( struct V_26 * V_12 , unsigned V_74 ,
unsigned V_75 , T_7 * V_76 , bool V_66 )
{
int V_67 , V_77 , V_31 = 0 ;
if ( V_74 + V_75 > V_12 -> V_55 )
return - V_52 ;
for ( V_67 = 0 , V_77 = V_74 ; V_67 < V_75 && ! V_31 ; V_67 ++ , V_77 ++ ) {
int V_27 = V_76 ? V_76 [ V_67 ] : - 1 ;
V_31 = F_62 ( V_12 , V_77 , V_27 , V_66 ) ;
}
if ( V_31 ) {
for ( -- V_77 ; V_77 >= V_74 ; V_77 -- )
F_62 ( V_12 , V_77 , - 1 , V_66 ) ;
}
return V_31 ;
}
static void F_64 ( struct V_26 * V_12 , bool V_66 )
{
struct V_44 * V_45 = V_12 -> V_45 ;
int V_67 ;
F_63 ( V_12 , 0 , V_12 -> V_55 , NULL , V_66 ) ;
...
unsigned V_78 , unsigned V_74 ,
unsigned V_75 , T_8 V_9 , void * V_13 )
{
if ( ! F_36 ( V_12 ) || V_74 != 0 || V_75 != 1 )
return - V_52 ;
if ( V_9 & V_79 ) {
F_45 ( V_12 ) ;
} else if ( V_9 & V_80 ) {
...
unsigned V_75 , T_8 V_9 , void * V_13 )
{
if ( F_36 ( V_12 ) && ! V_75 && ( V_9 & V_79 ) ) {
F_56 ( V_12 ) ;
return 0 ;
}
if ( ! ( F_36 ( V_12 ) || F_49 ( V_12 ) ) || V_74 != 0 || V_75 != 1 )
return - V_52 ;
if ( V_9 & V_81 ) {
T_7 V_27 = * ( T_7 * ) V_13 ;
int V_31 ;
...
{
int V_67 ;
bool V_66 = ( V_78 == V_70 ) ? true : false ;
if ( F_71 ( V_12 , V_78 ) && ! V_75 && ( V_9 & V_79 ) ) {
F_64 ( V_12 , V_66 ) ;
return 0 ;
}
if ( ! ( F_71 ( V_12 , V_78 ) || F_49 ( V_12 ) ) )
return - V_52 ;
if ( V_9 & V_81 ) {
T_7 * V_76 = V_13 ;
int V_31 ;
if ( V_12 -> V_56 == V_78 )
return F_63 ( V_12 , V_74 , V_75 ,
V_76 , V_66 ) ;
V_31 = F_58 ( V_12 , V_74 + V_75 , V_66 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_63 ( V_12 , V_74 , V_75 , V_76 , V_66 ) ;
if ( V_31 )
F_64 ( V_12 , V_66 ) ;
return V_31 ;
}
if ( ! F_71 ( V_12 , V_78 ) || V_74 + V_75 > V_12 -> V_55 )
return - V_52 ;
for ( V_67 = V_74 ; V_67 < V_74 + V_75 ; V_67 ++ ) {
...
unsigned V_78 , unsigned V_74 , unsigned V_75 ,
void * V_13 )
{
int (* F_76)( struct V_26 * V_12 , unsigned V_78 ,
unsigned V_74 , unsigned V_75 , T_8 V_9 ,
void * V_13 ) = NULL ;
switch ( V_78 ) {
case V_57 :
switch ( V_9 & V_89 ) {
...
if ( ! F_76 )
return - V_82 ;
return F_76 ( V_12 , V_78 , V_74 , V_75 , V_9 , V_13 ) ;
}
