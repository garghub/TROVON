...
static T_1 F_9 ( struct V_30 * V_31 , struct V_32 * V_33 ,
char * V_21 , T_2 V_34 , T_3 V_35 ,
T_3 V_36 , T_4 V_18 )
{
struct V_37 * V_38 =
F_10 ( V_33 , struct V_37 , V_33 ) -> V_39 -> V_39 ;
struct V_1 * V_2 = F_11 ( F_12 ( V_38 ) ) ;
struct V_8 * V_9 = F_13 ( F_14 ( V_38 ) ) ;
int V_23 ;
if ( V_34 >= V_36 )
return 0 ;
if ( V_34 != 0 || V_35 != V_36 )
return - V_17 ;
F_15 ( & V_2 -> V_40 ) ;
V_23 = F_5 ( V_9 , V_18 , V_21 , V_36 ) ;
F_16 ( & V_2 -> V_40 ) ;
if ( V_23 )
return V_23 ;
return V_36 ;
}
static T_1 F_17 ( struct V_30 * V_31 , struct V_32 * V_33 ,
...
return - V_17 ;
F_15 ( & V_2 -> V_40 ) ;
V_23 = F_8 ( V_9 , V_18 , ( void * ) V_21 , V_36 ) ;
F_16 ( & V_2 -> V_40 ) ;
if ( V_23 )
return V_23 ;
return V_36 ;
...
struct V_8 * V_9 = F_13 ( F_14 ( V_38 ) ) ;
T_1 V_23 ;
V_23 = F_2 ( V_9 , * ( T_4 * ) ( V_42 -> V_43 ) ,
V_15 ) ;
if ( V_23 )
return V_23 ;
return F_9 ( V_31 , V_33 , V_21 , V_34 , V_35 ,
V_25 ,
V_24 ) ;
}
...
static T_1 F_22 ( struct V_37 * V_38 ,
struct V_53 * V_42 , char * V_21 )
{
struct V_1 * V_2 =
F_11 ( F_12 ( V_38 -> V_39 -> V_39 ) ) ;
return snprintf ( V_21 , V_54 , L_1 , V_2 -> V_5 ) ;
}
...
{
struct V_63 * V_64 = F_14 ( V_62 -> V_38 . V_39 ) ;
struct V_8 * V_9 = F_13 ( V_64 ) ;
struct V_1 * V_2 ;
int V_23 ;
if ( V_64 -> V_65 -> V_66 . V_67
== V_68 ) {
V_2 = F_28 ( sizeof( * V_2 ) , V_69 ) ;
if ( ! V_2 ) {
F_29 ( V_62 , L_2 ) ;
return - V_70 ;
}
...
static int F_35 ( struct V_61 * V_62 , const struct V_74 * V_75 )
{
int V_23 ;
V_23 = F_36 ( V_62 ) ;
if ( V_23 ) {
...
static void F_41 ( struct V_1 const * V_2 ,
T_5 const * V_78 )
{
struct V_46 V_47 ;
struct V_79 const * V_80 ;
...
static int F_42 ( struct V_61 * V_62 , struct V_89 * V_90 ,
T_5 * V_78 , int V_91 )
{
struct V_63 * V_64 = F_14 ( V_62 -> V_38 . V_39 ) ;
struct V_1 * V_2 = F_11 ( V_62 ) ;
if ( V_64 -> V_65 -> V_66 . V_67
!= V_68 )
return 0 ;
if ( V_2 == NULL )
