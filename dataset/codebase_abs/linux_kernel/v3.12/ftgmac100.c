...
V_119 = F_105 ( V_11 , F_106 ( & V_119 -> V_73 ) ,
& F_101 , V_129 ) ;
if ( F_107 ( V_119 ) ) {
...
static int F_109 ( struct V_125 * V_130 , int V_131 , int V_132 )
{
...
static int F_113 ( struct V_125 * V_130 , int V_131 ,
int V_132 , T_5 V_139 )
{
struct V_10 * V_11 = V_130 -> V_2 ;
struct V_1 * V_2 = F_102 ( V_11 ) ;
...
static int F_115 ( struct V_125 * V_130 )
{
return 0 ;
}
...
F_117 ( V_142 -> V_147 , F_106 ( & V_11 -> V_73 ) , sizeof( V_142 -> V_147 ) ) ;
}
...
V_2 -> V_125 -> V_2 = V_11 ;
V_2 -> V_125 -> V_196 = F_109 ;
V_2 -> V_125 -> V_197 = F_113 ;
V_2 -> V_125 -> V_198 = F_115 ;
