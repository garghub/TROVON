...
static int F_49 ( struct V_3 * V_61 )
{
struct V_23 * V_24 = V_93 ;
struct V_8 * V_9 = & V_61 -> V_94 ;
T_1 V_22 = V_35 ;
int V_95 ;
V_9 -> V_37 = 0 ;
V_9 -> V_27 = V_96 ;
...
F_21 ( & V_9 -> V_102 ) ;
F_21 ( & V_9 -> V_103 ) ;
V_95 = F_50 ( V_61 , V_9 , V_22 , V_24 ) ;
if ( V_95 < 0 )
return V_95 ;
return 0 ;
}
static void F_51 ( struct V_3 * V_61 )
{
struct V_8 * V_9 = & V_61 -> V_94 ;
F_52 ( V_61 , V_9 ) ;
}
...
F_54 ( & V_117 ) ;
F_28 ( & V_61 -> V_114 , & V_118 ) ;
F_55 ( & V_117 ) ;
F_12 ( L_34
L_35 , V_105 -> V_16 () ,
( V_61 -> V_108 == V_116 ) ?
L_36 : L_37 , ( V_105 -> V_119 ( V_61 ) == NULL ) ?
L_38 : V_105 -> V_119 ( V_61 ) , V_105 -> V_36 ( V_61 ) ) ;
return 0 ;
}
int F_56 ( struct V_3 * V_61 )
{
...
V_61 -> V_15 -> V_119 ( V_61 ) ,
V_61 -> V_15 -> V_36 ( V_61 ) ) ;
F_54 ( & V_117 ) ;
F_38 ( & V_61 -> V_114 ) ;
F_55 ( & V_117 ) ;
while ( F_30 ( & V_61 -> V_113 ) != 0 )
F_31 () ;
F_2 ( & V_61 -> V_21 ) ;
