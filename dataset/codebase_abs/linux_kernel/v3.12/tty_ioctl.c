...
static int F_65 ( struct V_1 * V_2 , char V_140 )
{
int V_141 = V_2 -> V_142 ;
if ( V_2 -> V_3 -> V_143 ) {
V_2 -> V_3 -> V_143 ( V_2 , V_140 ) ;
return 0 ;
}
if ( F_66 ( V_2 , 0 ) < 0 )
return - V_95 ;
if ( V_141 )
F_67 ( V_2 ) ;
V_2 -> V_3 -> V_144 ( V_2 , & V_140 , 1 ) ;
if ( V_141 )
F_68 ( V_2 ) ;
F_69 ( V_2 ) ;
return 0 ;
}
static int F_70 ( struct V_1 * V_2 , int V_79 )
{
int V_13 = 0 ;
int V_145 = V_79 ? V_55 : 0 ;
struct V_23 V_25 ;
F_5 ( & V_2 -> V_7 ) ;
V_25 = V_2 -> V_24 ;
V_2 -> V_24 . V_31 &= ~ V_55 ;
...
if ( ( V_2 -> V_24 . V_31 & V_55 ) != V_145 )
V_13 = - V_91 ;
F_7 ( & V_2 -> V_7 ) ;
return V_13 ;
}
int F_71 ( struct V_1 * V_2 , struct V_146 * V_146 ,
unsigned int V_147 , unsigned long V_79 )
{
struct V_1 * V_148 ;
void T_5 * V_149 = ( void T_5 * ) V_79 ;
int V_13 = 0 ;
struct V_23 V_88 ;
F_72 ( V_146 == NULL ) ;
...
#ifdef F_73
case F_73 :
return F_57 ( V_148 , (struct V_101 T_5 * ) V_79 ) ;
case V_154 :
case V_155 :
return F_60 ( V_148 , (struct V_101 T_5 * ) V_79 ) ;
#endif
#ifdef F_74
case F_74 :
return F_61 ( V_148 , V_149 ) ;
case V_156 :
return F_62 ( V_148 , V_149 ) ;
#endif
#ifdef F_75
case F_75 :
return F_63 ( V_148 , V_149 ) ;
case V_157 :
return F_64 ( V_148 , V_149 ) ;
#endif
case V_158 :
return V_78 ( V_148 , V_149 , V_92 | V_93 | V_86 ) ;
case V_159 :
return V_78 ( V_148 , V_149 , V_93 | V_86 ) ;
case V_160 :
return V_78 ( V_148 , V_149 , V_86 ) ;
#ifndef F_46
case V_161 :
F_49 ( V_148 , & V_88 ) ;
if ( F_76 ( (struct V_24 T_5 * ) V_79 , & V_88 ) )
V_13 = - V_85 ;
return V_13 ;
#else
case V_161 :
F_49 ( V_148 , & V_88 ) ;
if ( F_77 ( (struct V_24 T_5 * ) V_79 , & V_88 ) )
V_13 = - V_85 ;
return V_13 ;
case F_46 :
F_49 ( V_148 , & V_88 ) ;
if ( F_76 ( (struct V_87 T_5 * ) V_79 , & V_88 ) )
V_13 = - V_85 ;
return V_13 ;
case V_162 :
return V_78 ( V_148 , V_149 , V_92 | V_93 ) ;
case V_163 :
return V_78 ( V_148 , V_149 , V_93 ) ;
case V_164 :
return V_78 ( V_148 , V_149 , 0 ) ;
#endif
case V_165 :
return F_51 ( V_148 , V_149 ) ;
case V_166 :
return V_78 ( V_148 , V_149 , V_92 | V_93 | V_83 ) ;
case V_167 :
return V_78 ( V_148 , V_149 , V_93 | V_83 ) ;
case V_168 :
return V_78 ( V_148 , V_149 , V_83 ) ;
#ifndef F_46
case V_169 :
F_50 ( V_148 , & V_88 ) ;
if ( F_76 ( (struct V_24 T_5 * ) V_79 , & V_88 ) )
...
return - V_91 ;
F_43 ( & V_148 -> V_7 ) ;
memcpy ( & V_173 , V_148 -> V_89 , sizeof( struct V_89 ) ) ;
F_44 ( & V_148 -> V_7 ) ;
if ( F_58 ( V_149 , & V_173 , sizeof( struct V_89 ) ) )
V_13 = - V_85 ;
return V_13 ;
}
case V_174 :
return F_53 ( V_148 , V_149 , 0 ) ;
case V_175 :
return F_53 ( V_148 , V_149 , V_93 ) ;
case V_176 :
return F_53 ( V_148 , V_149 , V_92 ) ;
#endif
case V_177 :
F_49 ( V_148 , & V_88 ) ;
V_13 = F_80 ( ( V_88 . V_31 & V_55 ) ? 1 : 0 ,
( int T_5 * ) V_79 ) ;
return V_13 ;
case V_178 :
if ( F_81 ( V_79 , ( unsigned int T_5 * ) V_79 ) )
return - V_85 ;
return F_70 ( V_148 , V_79 ) ;
default:
return - V_179 ;
}
}
static int F_82 ( struct V_1 * V_2 , unsigned long V_79 )
{
struct V_60 * V_61 = V_2 -> V_180 ;
switch ( V_79 ) {
case V_181 :
...
int F_83 ( struct V_1 * V_2 , unsigned long V_79 )
{
struct V_60 * V_61 ;
int V_82 = F_42 ( V_2 ) ;
if ( V_82 )
...
int F_85 ( struct V_1 * V_2 , struct V_146 * V_146 ,
unsigned int V_147 , unsigned long V_79 )
{
int V_82 ;
switch ( V_147 ) {
...
case V_188 :
if ( F_35 ( V_2 ) != V_189 )
return F_65 ( V_2 , F_35 ( V_2 ) ) ;
break;
case V_190 :
if ( F_36 ( V_2 ) != V_189 )
return F_65 ( V_2 , F_36 ( V_2 ) ) ;
break;
default:
return - V_91 ;
}
...
if ( V_82 )
return V_82 ;
return F_82 ( V_2 , V_79 ) ;
default:
return F_71 ( V_2 , V_146 , V_147 , V_79 ) ;
}
}
long F_86 ( struct V_1 * V_2 , struct V_146 * V_146 ,
unsigned int V_147 , unsigned long V_79 )
{
switch ( V_147 ) {
case V_169 :
case V_170 :
return F_71 ( V_2 , V_146 , V_147 , ( unsigned long ) F_87 ( V_79 ) ) ;
default:
return - V_179 ;
}
}
