...
struct V_118 * V_119 ;
int V_29 ;
V_2 = F_47 ( & V_115 -> V_20 , sizeof( * V_2 ) , V_120 ) ;
if ( ! V_2 ) {
...
V_124 . V_13 = F_11 ( & V_115 -> V_20 ) ;
V_124 . V_14 = V_2 -> V_9 -> V_14 ;
V_124 . V_16 = V_2 -> V_9 -> V_16 ;
for ( V_29 = 0 ; ; V_29 ++ ) {
V_119 = F_48 ( V_115 , V_125 , V_29 ) ;
if ( ! V_119 )
break;
}
V_2 -> V_126 = V_29 ;
V_2 -> V_5 = F_47 ( & V_115 -> V_20 , V_2 -> V_126 * sizeof( * V_2 -> V_5 ) ,
V_120 ) ;
if ( ! V_2 -> V_5 ) {
...
V_119 = F_48 ( V_115 , V_125 , V_29 ) ;
V_2 -> V_5 [ V_29 ] = F_49 ( & V_115 -> V_20 , V_119 ) ;
if ( F_50 ( V_2 -> V_5 [ V_29 ] ) )
return F_51 ( V_2 -> V_5 [ V_29 ] ) ;
}
V_2 -> V_128 = F_52 ( & V_124 , & V_115 -> V_20 , V_2 ) ;
if ( ! V_2 -> V_128 ) {
F_14 ( & V_115 -> V_20 , L_18 ) ;
return - V_127 ;
}
F_53 ( V_2 -> V_128 , & V_122 ) ;
F_54 ( V_115 , V_2 ) ;
F_55 ( & V_115 -> V_20 , L_19 ) ;
return 0 ;
}
int F_56 ( struct V_114 * V_115 )
{
struct V_1 * V_2 = F_57 ( V_115 ) ;
F_58 ( V_2 -> V_128 ) ;
return 0 ;
}
