...
static void T_4 F_89 ( struct V_1 * V_1 )
{
#ifdef F_83
F_88 ( V_1 ) ;
F_87 ( V_1 ) ;
...
struct V_162 * V_227 ;
int V_18 = 0 ;
F_92 ( sizeof( struct V_190 ) > F_93 ( struct V_131 , V_228 ) ) ;
for ( V_227 = & V_169 [ 0 ] ; V_227 < & V_169 [ V_167 ] ; ++ V_227 )
F_94 ( V_227 ) ;
if ( V_229 ) {
F_95 ( L_6 ) ;
goto V_38;
