...
struct V_44 V_45 = { } ;
struct V_3 * V_4 ;
struct V_9 * V_9 = F_23 ( V_72 -> V_56 . V_73 ) ;
struct V_46 * V_47 = F_24 ( V_9 -> V_56 ) ;
int V_7 , V_66 ;
if ( V_47 == NULL || V_47 -> V_74 [ V_72 -> V_48 ] == NULL )
return - V_75 ;
V_4 = F_25 ( & V_72 -> V_56 , sizeof( struct V_3 ) ,
V_76 ) ;
if ( ! V_4 )
return - V_77 ;
...
V_45 . V_79 = V_9 -> V_79 ;
if ( V_47 && V_47 -> V_74 )
V_45 . V_80 = V_47 -> V_74 [ V_72 -> V_48 ] ;
V_7 = F_17 ( V_4 , & V_45 , V_47 , V_72 -> V_48 ) ;
if ( V_7 < 0 )
return V_7 ;
V_4 -> V_2 = F_27 ( & V_4 -> V_6 -> V_70 ,
& V_45 ) ;
if ( F_28 ( V_4 -> V_2 ) ) {
F_26 ( & V_72 -> V_56 , L_3 ,
V_4 -> V_6 -> V_70 . V_50 ) ;
...
if ( V_72 -> V_48 == V_81 || V_72 -> V_48 == V_82 ) {
V_66 = F_30 ( V_72 , L_4 ) ;
V_66 = F_31 ( V_9 -> V_83 , V_66 ) ;
V_7 = F_32 ( & V_72 -> V_56 , V_66 , NULL ,
F_19 ,
V_84 |
V_85 |
V_86 ,
