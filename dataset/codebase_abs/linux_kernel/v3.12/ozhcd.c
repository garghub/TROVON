...
static void F_116 ( struct V_234 * V_118 )
{
}
static int F_117 ( struct V_234 * V_118 )
{
int V_7 ;
int V_57 ;
struct V_2 * V_3 ;
struct V_1 * V_5 ;
V_3 = F_118 ( & V_235 , & V_118 -> V_118 , F_119 ( & V_118 -> V_118 ) ) ;
if ( V_3 == NULL ) {
F_21 ( V_35 , L_82 ) ;
return - V_61 ;
}
...
static int F_125 ( struct V_234 * V_118 , T_5 V_236 )
{
return 0 ;
}
