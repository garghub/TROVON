...
struct V_1 * V_2 = F_14 ( V_6 ) ;
int V_30 ;
V_30 = ( V_2 -> V_18 == V_19 ) ? 1 : 0 ;
return F_19 ( V_27 , V_31 , L_3 , V_30 ) ;
}
...
static int F_31 ( const char * * V_27 , struct V_34 * V_35 )
{
...
int F_32 ( struct V_24 * V_43 , struct V_11 * V_12 ,
int V_44 , const char * V_27 )
{
struct V_1 * V_2 ;
struct V_34 V_45 ;
int V_33 , V_3 ;
...
static int F_59 ( struct V_24 * V_6 , void * V_59 )
{
return 1 ;
}
