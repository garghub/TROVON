...
if ( V_18 [ 0 ] ) {
V_15 -> V_27 &= ~ V_18 [ 0 ] ;
V_15 -> V_27 |= ( V_18 [ 0 ] & V_18 [ 1 ] ) ;
F_2 ( V_15 -> V_27 , V_2 -> V_7 + V_28 ) ;
}
V_18 [ 1 ] = F_10 ( V_2 -> V_7 + V_29 ) ;
return V_17 -> V_19 ;
}
static int F_11 ( struct V_1 * V_2 ,
unsigned long V_30 )
{
struct V_31 * V_32 = F_12 ( V_2 ) ;
struct V_3 * V_4 ;
struct V_14 * V_15 ;
int V_24 ;
V_4 = F_13 ( V_2 , sizeof( * V_4 ) ) ;
if ( ! V_4 )
return - V_33 ;
V_24 = F_14 ( V_2 ) ;
if ( V_24 )
...
V_15 -> V_27 = F_10 ( V_2 -> V_7 + V_29 ) ;
F_1 ( V_2 ) ;
F_17 ( V_2 -> V_55 , L_1 , V_2 -> V_56 ) ;
return 0 ;
}
