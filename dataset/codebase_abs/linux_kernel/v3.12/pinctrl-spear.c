...
if ( ! V_17 )
return - V_56 ;
V_2 = F_34 ( & V_73 -> V_21 , sizeof( * V_2 ) , V_57 ) ;
if ( ! V_2 ) {
F_18 ( & V_73 -> V_21 , L_8 ) ;
return - V_58 ;
}
V_76 = F_35 ( V_73 , V_77 , 0 ) ;
V_2 -> V_78 = F_36 ( & V_73 -> V_21 , V_76 ) ;
if ( F_37 ( V_2 -> V_78 ) )
return F_38 ( V_2 -> V_78 ) ;
V_2 -> V_21 = & V_73 -> V_21 ;
V_2 -> V_17 = V_17 ;
if ( V_17 -> V_65 ) {
int V_13 = 0 ;
if ( F_39 ( V_50 , L_9 , & V_13 ) ) {
F_18 ( & V_73 -> V_21 , L_10 ) ;
return - V_20 ;
}
if ( F_4 ( V_2 , V_13 ) ) {
...
V_79 . V_38 = V_17 -> V_38 ;
V_79 . V_40 = V_17 -> V_40 ;
V_2 -> V_80 = F_41 ( & V_79 , & V_73 -> V_21 , V_2 ) ;
if ( ! V_2 -> V_80 ) {
F_18 ( & V_73 -> V_21 , L_12 ) ;
return - V_56 ;
}
