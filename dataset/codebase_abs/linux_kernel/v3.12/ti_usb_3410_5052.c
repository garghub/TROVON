...
V_28 -> V_30 = V_32 ;
V_26 -> V_26 . V_33 = F_17 ( 10 * V_33 ) ;
V_28 -> V_34 = V_26 ;
V_28 -> V_35 = F_14 ( V_26 -> V_2 ) ;
V_28 -> V_36 = 0 ;
F_18 ( V_26 , V_28 ) ;
V_26 -> V_26 . V_37 = 3 ;
return 0 ;
...
static int F_21 ( struct V_38 * V_39 , struct V_25 * V_26 )
{
struct V_27 * V_28 = F_20 ( V_26 ) ;
struct V_3 * V_4 ;
struct V_5 * V_6 ;
struct V_40 * V_40 ;
int V_41 ;
...
V_28 -> V_49 |= ( V_50 | V_51 ) ;
if ( V_4 -> V_52 == 0 ) {
F_2 ( & V_26 -> V_6 , L_6 , V_8 ) ;
V_40 = V_4 -> V_18 -> V_26 [ 0 ] -> V_53 ;
if ( ! V_40 ) {
F_5 ( & V_26 -> V_6 , L_7 , V_8 ) ;
V_7 = - V_54 ;
goto V_55;
}
V_40 -> V_56 = V_4 ;
V_7 = F_23 ( V_40 , V_15 ) ;
if ( V_7 ) {
F_5 ( & V_26 -> V_6 , L_8 , V_8 , V_7 ) ;
goto V_55;
}
}
if ( V_39 )
F_24 ( V_39 , V_26 , & V_39 -> V_57 ) ;
F_2 ( & V_26 -> V_6 , L_9 , V_8 ) ;
V_7 = F_25 ( V_4 , V_58 ,
...
F_2 ( & V_26 -> V_6 , L_20 , V_8 ) ;
V_40 = V_26 -> V_67 ;
if ( ! V_40 ) {
F_5 ( & V_26 -> V_6 , L_21 , V_8 ) ;
V_7 = - V_54 ;
goto V_60;
}
V_28 -> V_68 = V_69 ;
...
struct V_25 * V_26 = V_39 -> V_78 ;
struct V_27 * V_28 = F_20 ( V_26 ) ;
F_2 ( & V_26 -> V_6 , L_29 , V_8 , V_84 ) ;
if ( V_28 == NULL )
return - V_22 ;
switch ( V_84 ) {
case V_86 :
F_2 ( & V_26 -> V_6 , L_30 , V_8 ) ;
return F_49 ( V_28 ,
...
F_2 ( & V_26 -> V_6 , L_32 , V_8 , V_95 , V_96 ) ;
F_2 ( & V_26 -> V_6 , L_33 , V_8 ,
V_92 -> V_99 , V_92 -> V_100 ) ;
if ( V_28 == NULL )
return;
V_94 = F_51 ( sizeof( * V_94 ) , V_15 ) ;
if ( ! V_94 ) {
F_5 ( & V_26 -> V_6 , L_2 , V_8 ) ;
return;
}
V_94 -> V_101 = 0 ;
V_94 -> V_101 |= V_102 ;
...
case - V_165 :
case - V_166 :
F_2 ( V_6 , L_40 , V_8 , V_7 ) ;
V_4 -> V_167 = 1 ;
return;
default:
F_5 ( V_6 , L_41 , V_8 , V_7 ) ;
V_4 -> V_167 = 1 ;
goto exit;
}
if ( V_160 != 2 ) {
F_2 ( V_6 , L_42 , V_8 , V_160 ) ;
goto exit;
}
if ( V_76 [ 0 ] == V_168 ) {
F_5 ( V_6 , L_43 , V_8 , V_76 [ 1 ] ) ;
goto exit;
}
V_41 = F_64 ( V_76 [ 0 ] ) ;
V_162 = F_65 ( V_76 [ 0 ] ) ;
...
F_2 ( & V_26 -> V_6 , L_56 , V_8 , V_76 -> V_188 ) ;
* V_82 = V_76 -> V_188 ;
V_187:
F_12 ( V_76 ) ;
return V_7 ;
...
struct V_38 * V_39 ;
unsigned long V_72 ;
F_2 ( & V_28 -> V_34 -> V_6 , L_57 , V_8 , V_140 ) ;
if ( V_140 & V_203 ) {
F_30 ( & V_28 -> V_29 , V_72 ) ;
...
if ( V_7 ) {
F_5 ( & V_6 -> V_6 , L_69 , V_8 ) ;
return - V_165 ;
}
if ( V_248 -> V_184 > V_258 ) {
F_5 ( & V_6 -> V_6 , L_70 , V_8 , V_248 -> V_184 ) ;
F_98 ( V_248 ) ;
return - V_165 ;
}
