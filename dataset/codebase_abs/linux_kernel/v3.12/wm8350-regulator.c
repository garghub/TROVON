...
V_8 = F_44 ( & V_173 [ V_165 -> V_168 ] , & V_167 ) ;
if ( F_45 ( V_8 ) ) {
F_46 ( & V_165 -> V_48 , L_8 ,
...
{
struct V_7 * V_8 = F_51 ( V_165 ) ;
struct V_9 * V_9 = F_4 ( V_8 ) ;
F_52 ( V_9 , V_173 [ V_165 -> V_168 ] . V_156 , V_8 ) ;
F_49 ( V_8 ) ;
return 0 ;
}
int F_53 ( struct V_9 * V_9 , int V_32 ,
struct V_175 * V_176 )
{
struct V_164 * V_165 ;
int V_12 ;
...
int F_58 ( struct V_9 * V_9 , int V_184 , int V_47 , int V_10 ,
struct V_185 * V_186 )
{
struct V_187 * V_188 ;
struct V_164 * V_165 ;
...
V_12 = F_53 ( V_9 , V_10 , & V_188 -> V_192 ) ;
if ( V_12 != 0 ) {
F_57 ( V_165 ) ;
return V_12 ;
}
...
V_12 = F_53 ( V_9 , V_47 , & V_188 -> V_201 ) ;
if ( V_12 != 0 ) {
F_57 ( V_165 ) ;
return V_12 ;
}
