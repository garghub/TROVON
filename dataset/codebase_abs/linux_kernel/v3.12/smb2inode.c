...
int
F_15 ( const unsigned int V_1 , struct V_2 * V_3 , const char * V_54 ,
struct V_4 * V_5 )
{
return F_1 ( V_1 , V_3 , V_5 , V_54 ,
V_55 , V_56 ,
V_57 , NULL , V_29 ) ;
}
void
F_16 ( struct V_58 * V_58 , const char * V_54 ,
...
int
F_19 ( const unsigned int V_1 , struct V_2 * V_3 , const char * V_54 ,
struct V_4 * V_5 )
{
return F_1 ( V_1 , V_3 , V_5 , V_54 , V_65 , V_51 ,
V_57 | V_66 ,
NULL , V_24 ) ;
}
int
F_20 ( const unsigned int V_1 , struct V_2 * V_3 , const char * V_54 ,
struct V_4 * V_5 )
{
return F_1 ( V_1 , V_3 , V_5 , V_54 , V_65 , V_51 ,
V_66 | V_52 ,
...
struct V_4 * V_5 , T_1 V_69 , int V_11 )
{
T_2 * V_70 = NULL ;
int V_12 ;
V_70 = F_2 ( V_68 , V_5 ) ;
...
V_12 = F_1 ( V_1 , V_3 , V_5 , V_67 , V_69 ,
V_51 , 0 , V_70 , V_11 ) ;
V_71:
F_4 ( V_70 ) ;
return V_12 ;
...
int
V_71 ( const unsigned int V_1 , struct V_2 * V_3 ,
const char * V_67 , const char * V_68 ,
struct V_4 * V_5 )
{
return F_21 ( V_1 , V_3 , V_67 , V_68 , V_5 ,
V_65 , V_30 ) ;
}
int
...
const char * V_6 , T_6 V_72 ,
struct V_4 * V_5 , bool V_73 )
{
V_35 V_74 = F_24 ( V_72 ) ;
...
int
F_25 ( struct V_58 * V_58 , const char * V_6 ,
V_37 * V_76 , const unsigned int V_1 )
{
struct V_4 * V_5 = F_26 ( V_58 -> V_77 ) ;
struct V_78 * V_79 ;
int V_12 ;
V_79 = F_27 ( V_5 ) ;
if ( F_28 ( V_79 ) )
return F_29 ( V_79 ) ;
V_12 = F_1 ( V_1 , F_30 ( V_79 ) , V_5 , V_6 ,
V_55 , V_51 , 0 , V_76 ,
V_36 ) ;
F_31 ( V_79 ) ;
return V_12 ;
