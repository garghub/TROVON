...
struct V_1 * V_2 ;
int V_32 ;
V_2 = F_112 ( V_7 , V_82 , V_22 ) ;
if ( ! V_2 )
return - V_37 ;
V_32 = F_113 ( V_72 , V_2 , V_87 ) ;
if ( V_32 ) {
F_111 ( V_2 ) ;
F_21 ( V_2 ) ;
return V_32 ;
...
if ( ! V_10 )
goto V_66;
F_116 ( & V_10 -> V_146 , & V_96 -> V_149 ) ;
V_2 = & V_10 -> V_108 ;
if ( ( V_22 & V_86 ) && ! V_96 -> V_98 ) {
V_10 -> V_57 = F_117 ( V_7 -> V_7 , V_14 ,
& V_10 -> V_55 , V_34 ) ;
if ( V_10 -> V_57 )
V_22 |= V_54 ;
}
...
F_114 ( V_150 [ V_21 ] , & V_43 , & V_44 ) ;
V_12 [ V_21 ] . V_13 = V_44 ;
V_12 [ V_21 ] . V_60 = F_124 ( V_44 ) ;
V_12 [ V_21 ] . V_64 = F_73 ( V_150 [ V_21 ] , 0 ) >> V_18 ;
V_12 [ V_21 ] . V_61 = F_124 ( ( V_15 / V_44 ) >> V_21 ) ;
