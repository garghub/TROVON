...
unsigned long V_161 ;
struct V_162 * V_163 = NULL , * V_164 = NULL ;
T_4 V_165 ;
T_4 V_166 ;
T_4 V_149 ;
T_4 V_167 = V_12 -> V_14 ;
...
do {
F_32 ( V_4 , V_69 ) ;
V_69 = F_37 ( V_4 , V_4 -> V_171 , V_4 -> V_172 ) ;
if ( V_69 == NULL ) {
F_38 ( V_4 , V_132 ) ;
return false ;
}
V_69 -> V_132 = V_132 ;
V_69 -> V_136 = V_132 -> V_165 ;
V_132 -> V_173 = V_69 ;
V_69 -> V_106 = 1 ;
V_69 -> V_91 = 1 ;
F_39 ( V_2 , V_69 -> V_174 , V_69 ) ;
F_40 ( V_2 , V_69 ) ;
break;
} while ( 1 );
V_154 = V_69 ;
...
V_168 = 0 ;
V_169 = ( ( V_165 / V_167 ) + 1 ) * V_167 ;
}
V_158 = V_154 -> V_78 . V_158 ;
switch ( V_154 -> V_78 . V_175 ) {
case 1 :
case 2 :
V_160 = & ( V_158 -> V_176 . V_177 ) ;
V_156 = V_4 -> V_171 + 3 ;
break;
case 4 :
case 5 :
V_160 = & ( V_158 -> V_176 . V_178 ) ;
V_156 = V_4 -> V_171 + 1 ;
break;
case 6 :
case 7 :
V_160 = & ( V_158 -> V_176 . V_179 ) ;
V_156 = V_4 -> V_171 ;
break;
case 0 :
case 3 :
default:
V_160 = & ( V_158 -> V_176 . V_180 ) ;
V_156 = V_4 -> V_171 + 2 ;
break;
}
F_42 ( & V_4 -> V_181 , & V_161 ) ;
V_164 = F_43 ( & V_160 -> V_182 ) ;
V_163 = F_44 ( V_164 ) ;
while ( ! F_45 ( V_164 , V_163 ) ) {
V_69 = F_46 ( V_163 , struct V_68 , V_183 ) ;
V_163 = F_44 ( V_163 ) ;
V_69 -> V_106 = 0 ;
V_69 -> V_91 = 0 ;
V_149 = F_34 ( V_69 ) + V_13 + ( V_69 -> V_91 * V_89 ) ;
if ( F_41 ( V_165 + V_149 ) > V_184 ) {
V_69 -> V_106 = 1 ;
V_69 -> V_91 = 1 ;
break;
}
...
if ( F_48 ( & V_160 -> V_182 ) == true )
F_47 ( & V_160 -> V_189 ) ;
F_49 ( & V_4 -> V_181 , & V_161 ) ;
...
V_130 = F_28 ( V_154 ) ;
F_29 ( V_2 , V_130 , V_166 , ( T_2 * ) V_132 ) ;
V_166 -= ( V_154 -> V_106 * V_13 ) ;
V_166 -= ( V_154 -> V_91 * V_89 ) ;
F_30 ( V_2 , V_154 , V_166 ) ;
F_32 ( V_4 , V_154 ) ;
return true ;
}
...
{
T_1 V_190 = V_8 ;
V_190 = F_39 ( V_2 , V_69 -> V_174 , V_69 ) ;
if ( V_190 == V_8 )
F_25 ( V_2 , V_69 ) ;
else
F_21 ( L_7 , V_191 ) ;
...
if ( F_52 ( V_2 , V_41 ) > 0 )
goto V_195;
if ( F_53 ( V_193 , V_196 | V_197 ) == true )
goto V_195;
V_132 = F_36 ( V_4 ) ;
if ( V_132 == NULL )
goto V_195;
...
T_1 F_55 ( struct V_1 * V_2 , struct V_68 * V_201 )
{
return F_25 ( V_2 , V_201 ) ;
}
