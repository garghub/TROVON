...
{
const unsigned long V_47 = V_48 - 1 ;
unsigned long V_49 ;
if ( ! V_32 -> V_38 )
return - 1UL ;
F_5 ( & V_32 -> V_46 ) ;
V_49 = F_29 ( V_32 -> V_38 , V_32 -> V_31 ) ;
if ( V_49 < V_32 -> V_31 ) {
F_30 ( V_49 ^ V_47 , V_32 -> V_38 ) ;
if ( V_49 >= V_32 -> V_39 )
V_32 -> V_39 = V_49 + 1 ;
} else
V_49 = - 1UL ;
...
void F_31 ( struct V_30 * V_32 , unsigned long V_49 )
{
const unsigned long V_47 = V_48 - 1 ;
if ( ! V_32 -> V_38 )
return;
F_5 ( & V_32 -> V_46 ) ;
F_30 ( V_49 ^ V_47 , V_32 -> V_35 ) ;
F_32 ( V_49 ^ V_47 , V_32 -> V_38 ) ;
if ( V_49 == V_32 -> V_39 - 1 ) {
while ( -- V_32 -> V_39 > 0 )
if ( ! F_33 ( ( V_32 -> V_39 - 1 ) ^ V_47 , V_32 -> V_38 ) )
break;
}
F_7 ( & V_32 -> V_46 ) ;
}
unsigned long F_34 ( struct V_30 * V_32 , unsigned long V_50 ,
unsigned long V_39 )
{
const unsigned long V_47 = V_48 - 1 ;
unsigned long V_49 ;
V_49 = F_35 ( V_32 -> V_35 , V_39 , V_50 ) ;
if ( V_49 >= V_39 )
return - 1UL ;
F_30 ( V_49 ^ V_47 , V_32 -> V_35 ) ;
return V_49 ;
