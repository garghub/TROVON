...
V_62 = F_42 ( V_1 , V_49 , sizeof( * V_49 ) ) ;
if ( V_62 ) {
F_6 ( & V_46 -> V_51 , L_23 ) ;
goto V_80;
}
...
static int F_51 ( struct V_81 * V_51 )
{
struct V_59 * V_60 = F_52 ( V_51 ) ;
struct V_1 * V_1 = F_53 ( V_60 ) ;
F_54 ( V_1 -> V_8 , 1 ) ;
F_44 ( V_60 -> V_61 ) ;
return 0 ;
}
static int F_55 ( struct V_81 * V_51 )
{
struct V_59 * V_60 = F_52 ( V_51 ) ;
struct V_1 * V_1 = F_53 ( V_60 ) ;
int V_62 ;
