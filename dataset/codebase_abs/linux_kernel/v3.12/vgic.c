...
V_11 |= 1 << ( V_18 -> V_53 [ V_8 + V_51 ] + V_51 * 8 ) ;
return V_11 ;
}
...
for ( V_51 = 0 ; V_51 < V_52 ; V_51 ++ ) {
int V_57 = V_51 * V_58 ;
V_56 = F_39 ( ( V_11 >> V_57 ) & 0xffU ) ;
V_56 = V_56 ? ( V_56 - 1 ) : 0 ;
V_18 -> V_53 [ V_8 + V_51 ] = V_56 ;
F_40 (c, vcpu, kvm) {
V_55 = F_9 ( & V_18 -> V_59 [ V_54 ] ) ;
if ( V_54 == V_56 )
F_5 ( V_8 + V_51 , V_55 ) ;
else
F_6 ( V_8 + V_51 , V_55 ) ;
...
if ( V_78 & 1 ) {
F_18 ( V_16 , V_79 ) ;
V_18 -> V_80 [ V_54 ] [ V_79 ] |= 1 << V_24 ;
F_57 ( L_2 , V_79 , V_24 , V_54 ) ;
}
V_78 >>= 1 ;
}
}
