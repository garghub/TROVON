...
static int F_47 ( struct V_5 * V_14 )
{
struct V_1 * V_2 ;
V_2 = F_21 ( V_14 -> V_8 . V_9 ) ;
...
static void F_48 ( struct V_5 * V_14 )
{
struct V_1 * V_2 ;
V_2 = F_21 ( V_14 -> V_8 . V_9 ) ;
F_41 ( V_2 -> V_10 ) ;
...
V_14 . V_18 = 1 ;
V_14 . V_19 = & V_12 ;
V_15 = F_53 ( V_10 , L_5 , & V_14 , & V_25 ) ;
if ( F_15 ( V_15 ) )
* V_17 = V_25 ;
return V_15 ;
}
static void F_54 ( struct V_1 * V_8 , T_5 V_30 )
{
unsigned long long V_20 = 0 ;
struct V_5 * V_6 = F_7 ( & V_8 -> V_8 ) ;
if ( V_30 == 0x81 ) {
if ( F_15 ( F_52 ( V_8 -> V_10 , & V_20 ) ) ) {
F_55 ( V_6 , V_62 , ! V_20 ) ;
F_19 ( V_6 ) ;
}
}
...
static int F_59 ( struct V_34 * V_8 )
{
struct V_5 * V_6 = F_7 ( V_8 ) ;
unsigned long long V_20 = 0 ;
if ( F_15 ( F_52 ( F_21 ( V_8 ) -> V_10 , & V_20 ) ) ) {
F_55 ( V_6 , V_62 , ! V_20 ) ;
F_19 ( V_6 ) ;
}
return 0 ;
}
static T_2 F_60 ( T_3 V_10 ,
unsigned long long * V_17 )
{
union V_11 V_12 ;
struct V_13 V_14 ;
...
V_14 . V_18 = 2 ;
V_14 . V_19 = V_12 ;
V_15 = F_53 ( V_10 , L_8 , & V_14 , & V_25 ) ;
return V_15 ;
}
static int F_62 ( struct V_65 * V_66 )
{
T_2 V_15 ;
T_3 V_10 ;
...
T_3 V_10 ;
V_10 = F_63 ( V_66 ) ;
V_15 = F_61 ( V_10 , V_66 -> V_68 . V_67 ) ;
if ( F_15 ( V_15 ) )
return 0 ;
else
return - 1 ;
}
static T_2 F_65 ( T_3 V_10 ,
unsigned long long * V_17 )
{
union V_11 V_12 ;
struct V_13 V_14 ;
...
static void F_67 ( struct V_69 * V_69 , void * V_70 )
{
T_2 V_15 ;
T_3 V_10 ;
...
static int F_69 ( void * V_70 , bool V_72 )
{
T_2 V_15 ;
T_3 V_10 ;
unsigned long long V_71 ;
...
V_77 -> V_83 = F_74 ( L_10 , & V_2 -> V_8 , V_84 ,
& V_85 , V_2 -> V_10 ) ;
if ( V_77 -> V_83 ) {
V_75 = F_75 ( V_77 -> V_83 ) ;
if ( V_75 ) {
...
static void F_80 ( struct V_1 * V_8 , T_5 V_30 )
{
struct V_5 * V_6 ;
int V_86 = V_87 ;
if ( ( V_30 & 0x0F ) < F_81 ( V_88 ) )
V_86 = V_88 [ V_30 & 0x0F ] ;
V_6 = F_7 ( & V_8 -> V_8 ) ;
F_82 ( V_6 , V_86 , ! ( V_30 & 0x10 ) ) ;
F_19 ( V_6 ) ;
}
