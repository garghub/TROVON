...
struct V_22 V_23 = { } ;
struct V_3 * V_4 ;
int V_24 , V_25 , V_9 = - V_26 ;
V_4 = F_11 ( & V_8 -> V_11 , sizeof( struct V_3 ) +
sizeof( struct V_1 * ) * ( V_27 + 1 ) ,
V_28 ) ;
if ( ! V_4 )
return - V_26 ;
V_4 -> V_8 = V_8 ;
...
V_4 -> V_13 = 0 ;
V_2 = V_4 -> V_2 ;
for ( V_24 = 0 ; V_24 < V_21 -> V_35 && V_24 <= V_27 ; V_24 ++ ) {
V_25 = V_21 -> V_36 [ V_24 ] . V_25 ;
if ( ! V_21 -> V_36 [ V_24 ] . V_37 )
continue;
if ( V_25 < V_38 || V_25 > V_27 ) {
F_12 ( & V_8 -> V_11 , L_3 , V_25 ) ;
goto V_39;
}
if ( V_25 == V_38 ) {
V_40 [ V_25 ] . V_31 = V_4 -> V_31 ;
V_40 [ V_25 ] . V_41 =
( V_4 -> V_33 - V_4 -> V_31 ) /
V_42 ;
}
V_23 . V_11 = & V_8 -> V_11 ;
V_23 . V_43 = V_21 -> V_36 [ V_24 ] . V_37 ;
V_23 . V_44 = V_4 ;
V_2 [ V_24 ] = F_13 ( & V_40 [ V_25 ] , & V_23 ) ;
if ( F_14 ( V_2 [ V_24 ] ) ) {
V_9 = F_15 ( V_2 [ V_24 ] ) ;
F_12 ( & V_8 -> V_11 , L_4 ,
V_40 [ V_25 ] . V_45 ) ;
