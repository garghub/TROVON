...
case V_172 :
default:
F_104 ( L_46 , F_105 ( V_169 -> V_175 ) ) ;
return - V_15 ;
}
F_22 ( V_46 , V_45 + V_186 ) ;
return 0 ;
}
static int F_106 ( struct V_168 * V_169 , unsigned V_187 )
{
struct V_104 * V_155 = F_99 ( V_169 ) ;
...
static void F_116 ( unsigned V_175 , struct V_196 * V_197 )
{
struct V_198 * V_107 = F_117 ( V_197 ) ;
struct V_168 * V_199 = F_118 ( V_197 ) ;
struct V_104 * V_155 = F_99 ( V_199 ) ;
void T_1 * V_45 = V_155 -> V_42 ;
unsigned long V_200 ;
int V_201 ;
F_119 ( V_107 , V_197 ) ;
...
F_121 ( F_122 ( V_155 -> V_162 , V_201 ) ) ;
}
}
F_123 ( V_107 , V_197 ) ;
}
static int F_124 ( struct V_204 * V_205 , unsigned int V_161 ,
T_5 V_206 )
{
...
static int F_129 ( struct V_204 * V_169 ,
struct V_19 * V_214 ,
...
static int F_133 ( struct V_19 * V_221 ,
struct V_104 * V_155 )
{
struct V_104 * V_222 = NULL ;
struct V_168 * V_169 = F_134 ( V_155 -> V_191 ) ;
V_155 -> V_223 = F_135 ( V_169 ) ;
V_209 . V_224 = V_155 -> V_91 -> V_225 ;
F_22 ( ~ 0 , V_155 -> V_42 + V_47 ) ;
V_155 -> V_162 = F_136 ( V_221 , V_155 -> V_107 . V_154 ,
& V_226 , V_155 ) ;
if ( ! V_155 -> V_162 )
F_137 ( L_48 ,
V_155 -> V_188 ) ;
...
return 0 ;
F_128 ( V_155 -> V_191 , V_155 ) ;
F_138 ( V_155 -> V_191 , F_116 ) ;
return 0 ;
}
...
static int F_140 ( struct V_138 * V_139 )
{
struct V_19 * V_20 = V_139 -> V_9 . V_141 ;
struct V_228 * V_229 ;
...
int V_88 = 0 ;
int V_175 , V_6 ;
int V_230 = F_141 ( V_20 , L_49 ) ;
T_3 V_154 ;
char * * V_231 ;
F_142 ( V_230 >= F_143 ( V_41 ) ) ;
if ( V_41 [ V_230 ] ) {
V_88 = - V_232 ;
goto V_152;
}
...
V_229 = F_145 ( V_139 , V_233 , 0 ) ;
V_105 -> V_42 = F_146 ( & V_139 -> V_9 , V_229 ) ;
if ( F_147 ( V_105 -> V_42 ) ) {
V_88 = F_148 ( V_105 -> V_42 ) ;
goto V_152;
}
V_105 -> V_91 = (struct V_143 * )
F_74 ( V_234 , & V_139 -> V_9 ) -> V_30 ;
V_105 -> V_191 = V_175 ;
V_105 -> V_188 = V_230 ;
V_105 -> clock = F_149 ( & V_139 -> V_9 , NULL ) ;
if ( F_147 ( V_105 -> clock ) ) {
F_11 ( & V_139 -> V_9 , L_50 ) ;
goto V_152;
}
...
for ( V_6 = 0 ; V_6 < V_107 -> V_154 ; V_6 ++ )
V_231 [ V_6 ] = F_77 ( V_27 , L_36 , V_230 + 'A' , V_6 ) ;
