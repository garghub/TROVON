...
int V_184 ;
V_223 = V_224 -> V_127 ;
if ( V_10 -> V_108 -> V_136 == NULL )
return - V_126 ;
V_10 -> V_202 -> V_225 = F_147 () ;
V_10 -> V_202 -> V_226 = F_150 () ;
if ( ! ( V_10 -> V_108 -> V_128 . V_129 -> V_130 & V_227 ) &&
! V_14 -> V_217 &&
F_175 ( V_10 -> V_202 -> V_228 , V_224 -> V_229 ) &&
F_176 ( V_10 -> V_202 -> V_228 , V_224 -> V_230 ) ) {
if ( V_223 & V_231 ) {
V_10 -> V_192 |= V_232 ;
V_10 -> V_202 -> V_225 = V_224 -> V_229 ;
}
if ( ( V_223 & ( V_233 | V_234 ) ) == ( V_233 | V_234 ) ) {
V_10 -> V_192 |= V_232 ;
V_10 -> V_202 -> V_226 = V_224 -> V_230 ;
}
}
V_184 = F_177 ( V_10 ) ;
if ( V_184 )
...
if ( F_187 ( V_10 -> V_179 [ 0 ] ) && F_187 ( V_10 -> V_179 [ 1 ] ) &&
F_187 ( V_10 -> V_179 [ 2 ] ) && F_187 ( V_10 -> V_179 [ 3 ] ) )
return V_184 ;
if ( F_188 ( L_1 , * ( V_245 * ) ( V_10 -> V_179 + 2 ) ) < 0 )
return V_184 ;
V_238 = false ;
goto V_243;
}
...
V_246 = V_14 -> V_164 ;
F_171 () ;
V_247 = F_190 ( V_14 , F_191 ( V_14 -> V_175 ) ) ;
F_173 () ;
V_21 = F_181 ( V_10 ) ;
if ( V_21 >= 0 ) {
...
static int F_206 ( const char * V_110 ,
const T_2 T_1 * V_75 ,
const T_2 T_1 * V_265 )
{
struct V_55 V_56 = {
...
switch ( V_268 ) {
case V_269 :
F_209 ( V_270 , & V_13 -> V_186 ) ;
F_210 () ;
F_209 ( V_271 , & V_13 -> V_186 ) ;
break;
case V_198 :
F_211 ( V_270 , & V_13 -> V_186 ) ;
F_210 () ;
F_209 ( V_271 , & V_13 -> V_186 ) ;
break;
case V_272 :
F_211 ( V_271 , & V_13 -> V_186 ) ;
F_210 () ;
F_211 ( V_270 , & V_13 -> V_186 ) ;
break;
}
}
int F_212 ( unsigned long V_273 )
{
int V_21 ;
V_21 = V_273 & V_274 ;
...
{
return F_212 ( V_13 -> V_186 ) ;
}
T_10 long F_213 ( const char T_1 * V_110 ,
const T_2 T_1 * V_56 ,
const T_2 T_1 * V_250 )
{
struct V_110 * V_275 = F_214 ( V_110 ) ;
int error = F_200 ( V_275 ) ;
if ( ! F_49 ( V_275 ) ) {
error = F_206 ( V_275 -> V_109 , V_56 , V_250 ) ;
F_215 ( V_275 ) ;
}
return error ;
}
