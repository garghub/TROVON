...
static int T_4 F_51 ( unsigned long V_76 )
{
int V_77 = - V_78 ;
asm volatile(
"0: lura 0,%1\n"
...
static T_4 int F_59 ( T_2 V_84 , const char * V_15 , int V_85 )
{
char V_86 [ 17 ] ;
unsigned int V_16 = V_85 ;
if ( V_16 > sizeof( V_86 ) - 1 )
V_16 = sizeof( V_86 ) - 1 ;
V_86 [ V_16 ] = '\0' ;
memcpy ( V_86 , V_15 , V_16 ) ;
F_17 ( V_24 , F_60 ( V_86 ) ) ;
return V_16 ;
}
