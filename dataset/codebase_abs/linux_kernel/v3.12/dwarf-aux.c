...
T_1 * F_61 ( T_1 * V_91 , const char * V_20 ,
T_1 * V_15 )
{
return F_16 ( V_91 , F_60 , ( void * ) V_20 ,
V_15 ) ;
}
int F_62 ( T_1 * V_23 , char * V_92 , int V_93 )
{
T_1 type ;
int V_25 , V_7 , V_94 ;
const char * V_73 = L_7 ;
...
V_7 = snprintf ( V_92 , V_93 , L_9 ) ;
return ( V_7 >= V_93 ) ? - V_98 : V_7 ;
} else {
if ( ! F_18 ( & type ) )
return - V_13 ;
if ( V_25 == V_99 )
...
V_73 = L_12 ;
V_7 = snprintf ( V_92 , V_93 , L_13 , V_73 , F_18 ( & type ) ) ;
return ( V_7 >= V_93 ) ? - V_98 : V_7 ;
}
V_7 = F_62 ( & type , V_92 , V_93 ) ;
if ( V_7 > 0 ) {
V_94 = snprintf ( V_92 + V_7 , V_93 - V_7 , L_14 , V_73 ) ;
V_7 = ( V_94 >= V_93 - V_7 ) ? - V_98 : V_94 + V_7 ;
}
return V_7 ;
}
int F_63 ( T_1 * V_23 , char * V_92 , int V_93 )
{
int V_7 , V_94 ;
V_7 = F_62 ( V_23 , V_92 , V_93 ) ;
if ( V_7 < 0 ) {
F_34 ( L_15 ) ;
V_7 = snprintf ( V_92 , V_93 , L_16 ) ;
}
if ( V_7 > 0 ) {
V_94 = snprintf ( V_92 + V_7 , V_93 - V_7 , L_17 ,
F_18 ( V_23 ) ) ;
V_7 = ( V_94 >= V_93 - V_7 ) ? - V_98 : V_94 + V_7 ;
}
return V_7 ;
