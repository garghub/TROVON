...
static int T_1 F_24 ( char * V_10 , T_3 V_6 , const char * V_65 )
{
int V_66 = 0 ;
const char * V_22 ;
if ( ! V_65 )
return V_66 ;
for ( V_22 = V_65 ; * V_22 ; V_22 ++ )
if ( isprint ( * V_22 ) )
V_66 += F_25 ( V_10 + V_66 , V_6 - V_66 , L_6 , * V_22 ) ;
else
V_66 += F_25 ( V_10 + V_66 , V_6 - V_66 , L_7 , * V_22 & 0xff ) ;
return V_66 ;
}
static void T_1 F_26 ( char * V_10 , T_3 V_6 )
{
int V_66 = 0 ;
const char * V_67 ;
V_66 += F_24 ( V_10 + V_66 , V_6 - V_66 ,
F_27 ( V_50 ) ) ;
V_66 += F_25 ( V_10 + V_66 , V_6 - V_66 , L_8 ) ;
V_66 += F_24 ( V_10 + V_66 , V_6 - V_66 ,
F_27 ( V_51 ) ) ;
V_67 = F_27 ( V_56 ) ;
if ( V_67 ) {
V_66 += F_25 ( V_10 + V_66 , V_6 - V_66 , L_9 ) ;
V_66 += F_24 ( V_10 + V_66 , V_6 - V_66 , V_67 ) ;
}
V_66 += F_25 ( V_10 + V_66 , V_6 - V_66 , L_10 ) ;
V_66 += F_24 ( V_10 + V_66 , V_6 - V_66 ,
F_27 ( V_48 ) ) ;
V_66 += F_25 ( V_10 + V_66 , V_6 - V_66 , L_8 ) ;
V_66 += F_24 ( V_10 + V_66 , V_6 - V_66 ,
...
static int T_1 F_28 ( const T_2 * V_10 )
{
int V_68 ;
if ( memcmp ( V_10 , L_11 , 4 ) == 0 &&
V_10 [ 5 ] < 32 && F_10 ( V_10 , V_10 [ 5 ] ) ) {
V_68 = ( V_10 [ 6 ] << 8 ) + V_10 [ 7 ] ;
switch ( V_68 ) {
case 0x021F :
case 0x0221 :
F_29 ( L_12 ,
...
V_10 += 16 ;
if ( memcmp ( V_10 , L_13 , 5 ) == 0 && F_10 ( V_10 , 15 ) ) {
...
goto error;
memset ( V_10 , 0 , 16 ) ;
for ( V_71 = V_22 ; V_71 < V_22 + 0x10000 ; V_71 += 16 ) {
F_34 ( V_10 + 16 , V_71 , 16 ) ;
if ( ! F_28 ( V_10 ) ) {
V_76 = 1 ;
F_9 ( V_22 , 0x10000 ) ;
goto V_77;
...
static bool F_37 ( const struct V_79 * V_80 )
{
int V_14 ;
F_38 ( ! V_78 , V_81 L_19 ) ;
for ( V_14 = 0 ; V_14 < F_39 ( V_80 -> V_82 ) ; V_14 ++ ) {
int V_3 = V_80 -> V_82 [ V_14 ] . V_20 ;
if ( V_3 == V_83 )
break;
if ( V_23 [ V_3 ] ) {
if ( ! V_80 -> V_82 [ V_14 ] . V_84 &&
strstr ( V_23 [ V_3 ] , V_80 -> V_82 [ V_14 ] . V_85 ) )
continue;
else if ( V_80 -> V_82 [ V_14 ] . V_84 &&
! strcmp ( V_23 [ V_3 ] , V_80 -> V_82 [ V_14 ] . V_85 ) )
continue;
}
return false ;
}
...
static bool F_40 ( const struct V_79 * V_80 )
{
return V_80 -> V_82 [ 0 ] . V_20 == V_83 ;
}
int F_41 ( const struct V_79 * V_32 )
{
int V_34 = 0 ;
const struct V_79 * V_21 ;
for ( V_21 = V_32 ; ! F_40 ( V_21 ) ; V_21 ++ )
if ( F_37 ( V_21 ) ) {
V_34 ++ ;
if ( V_21 -> V_86 && V_21 -> V_86 ( V_21 ) )
break;
}
return V_34 ;
}
const struct V_79 * F_42 ( const struct V_79 * V_32 )
{
const struct V_79 * V_21 ;
for ( V_21 = V_32 ; ! F_40 ( V_21 ) ; V_21 ++ )
if ( F_37 ( V_21 ) )
...
{
int V_88 = V_53 ;
if ( V_23 [ V_88 ] && strstr ( V_23 [ V_88 ] , V_9 ) )
return 1 ;
return 0 ;
}
int F_44 ( const char * V_9 )
{
static int V_89 [] = { V_50 , V_55 , V_83 } ;
int V_14 ;
for ( V_14 = 0 ; V_89 [ V_14 ] != V_83 ; V_14 ++ ) {
int V_88 = V_89 [ V_14 ] ;
if ( V_23 [ V_88 ] && strstr ( V_23 [ V_88 ] , V_9 ) )
return 1 ;
}
...
{
const struct V_91 * V_92 = V_90 ? & V_90 -> V_32 : & V_33 ;
struct V_91 * V_21 ;
for ( V_21 = V_92 -> V_93 ; V_21 != & V_33 ; V_21 = V_21 -> V_93 ) {
const struct V_29 * V_30 =
F_45 ( V_21 , struct V_29 , V_32 ) ;
if ( ( ( type == V_94 ) || ( V_30 -> type == type ) ) &&
( ( V_28 == NULL ) || ( strcmp ( V_30 -> V_28 , V_28 ) == 0 ) ) )
return V_30 ;
}
return NULL ;
}
bool F_46 ( int V_87 , int * V_95 , int * V_96 , int * V_97 )
{
...
if ( V_98 > 9999 )
V_98 = 0 ;
V_99 = F_47 ( V_3 , & V_103 , 10 ) ;
if ( V_3 == V_103 || * V_103 != '/' || ! V_99 || V_99 > 12 ) {
V_99 = 0 ;
goto V_77;
}
V_3 = V_103 + 1 ;
V_100 = F_47 ( V_3 , & V_103 , 10 ) ;
...
int F_48 ( void (* F_5)( const struct V_1 * , void * ) ,
void * V_12 )
{
T_2 * V_10 ;
if ( ! V_76 )
...
bool F_51 ( enum V_104 V_88 , const char * V_9 )
{
const char * V_65 = F_27 ( V_88 ) ;
