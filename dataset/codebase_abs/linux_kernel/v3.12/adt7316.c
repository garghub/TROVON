...
static T_5 F_76 ( int V_107 , void * V_108 )
{
...
static inline T_1 F_82 ( struct V_1 * V_2 ,
struct V_3 * V_4 ,
char * V_5 )
{
struct V_130 * V_131 = F_83 ( V_4 ) ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = F_3 ( V_7 ) ;
T_2 V_93 ;
int V_37 ;
...
int F_90 ( struct V_1 * V_2 , struct V_135 * V_14 ,
const char * V_136 )
{
struct V_8 * V_9 ;
struct V_6 * V_109 ;
...
if ( V_9 -> V_14 . V_107 > 0 ) {
if ( V_137 [ 0 ] )
V_9 -> V_14 . V_149 = V_137 [ 0 ] ;
V_13 = F_93 ( V_9 -> V_14 . V_107 ,
NULL ,
& F_76 ,
V_9 -> V_14 . V_149 | V_150 ,
V_109 -> V_136 ,
V_109 ) ;
if ( V_13 )
goto V_151;
if ( V_9 -> V_14 . V_149 & V_152 )
V_9 -> V_10 |= V_153 ;
}
