...
int V_86 , V_87 ;
V_86 = ( V_84 -> V_88 - V_84 -> V_89 ) == strlen ( V_84 -> V_2 -> V_49 ) ;
V_87 = ( V_85 -> V_88 - V_85 -> V_89 ) == strlen ( V_85 -> V_2 -> V_49 ) ;
if ( V_86 && ! V_87 )
return - 1 ;
if ( ! V_86 && V_87 )
return 1 ;
...
for (; V_103 ; V_103 = V_103 -> V_58 ) {
V_2 = V_103 -> V_2 ;
V_107 = V_103 -> V_58 ? V_103 -> V_58 -> V_2 : V_106 ;
V_5 = V_103 -> V_5 ;
if ( V_5 == NULL )
V_5 = V_103 -> V_2 -> V_5 ;
if ( F_32 ( V_2 ) || F_8 ( V_2 ) ) {
...
if ( V_103 -> V_2 == V_106 )
fprintf ( V_52 , L_23 ,
V_5 -> V_109 -> V_49 , V_5 -> V_110 ) ;
if ( V_103 -> V_7 ) {
fprintf ( V_52 , L_24 ,
V_5 -> V_109 -> V_49 , V_5 -> V_110 ,
V_2 -> V_49 ? V_2 -> V_49 : L_25 ,
F_60 ( V_5 -> type ) ,
V_107 -> V_49 ? V_107 -> V_49 : L_25 ) ;
} else if ( V_103 -> V_5 ) {
fprintf ( V_52 , L_26 ,
V_5 -> V_109 -> V_49 , V_5 -> V_110 ,
V_2 -> V_49 ? V_2 -> V_49 : L_25 ,
...
V_5 -> V_110 = F_65 () ;
if ( V_2 ) {
for ( V_124 = & V_2 -> V_5 ; * V_124 ; V_124 = & ( * V_124 ) -> V_58 )
;
* V_124 = V_5 ;
}
return V_5 ;
