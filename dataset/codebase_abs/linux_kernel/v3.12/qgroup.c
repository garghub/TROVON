...
V_52 = F_25 ( V_36 , V_37 ,
struct V_60 ) ;
V_8 -> V_61 = F_33 ( V_36 , V_52 ) ;
V_8 -> V_62 = F_34 ( V_36 , V_52 ) ;
V_8 -> V_63 = F_35 ( V_36 , V_52 ) ;
V_8 -> V_64 = F_36 ( V_36 , V_52 ) ;
break;
}
case V_59 : {
struct V_65 * V_52 ;
V_52 = F_25 ( V_36 , V_37 ,
struct V_65 ) ;
V_8 -> V_66 = F_37 ( V_36 , V_52 ) ;
V_8 -> V_67 = F_38 ( V_36 , V_52 ) ;
V_8 -> V_68 = F_39 ( V_36 , V_52 ) ;
V_8 -> V_69 = F_40 ( V_36 , V_52 ) ;
V_8 -> V_70 = F_41 ( V_36 , V_52 ) ;
break;
}
}
V_57:
...
V_29 . type = V_71 ;
V_29 . V_47 = V_80 ;
V_38 = F_50 ( V_78 , V_32 , V_34 , & V_29 , 0 ) ;
F_51 ( V_34 -> V_49 [ 0 ] ) ;
F_45 ( V_34 ) ;
return V_38 ;
}
...
V_29 . type = V_71 ;
V_29 . V_47 = V_80 ;
V_38 = F_53 ( V_78 , V_32 , & V_29 , V_34 , - 1 , 1 ) ;
if ( V_38 < 0 )
goto V_44;
if ( V_38 > 0 ) {
V_38 = - V_23 ;
...
V_29 . type = V_58 ;
V_29 . V_47 = V_4 ;
V_38 = F_50 ( V_78 , V_32 , V_34 , & V_29 ,
sizeof( * V_81 ) ) ;
if ( V_38 )
goto V_44;
V_83 = V_34 -> V_49 [ 0 ] ;
V_81 = F_25 ( V_83 , V_34 -> V_48 [ 0 ] ,
struct V_60 ) ;
F_56 ( V_83 , V_81 , V_78 -> V_84 ) ;
F_57 ( V_83 , V_81 , 0 ) ;
F_58 ( V_83 , V_81 , 0 ) ;
F_59 ( V_83 , V_81 , 0 ) ;
F_60 ( V_83 , V_81 , 0 ) ;
...
if ( ! V_34 )
return - V_15 ;
V_38 = F_53 ( V_78 , V_85 , & V_29 , V_34 , 0 , 1 ) ;
if ( V_38 > 0 )
V_38 = - V_23 ;
if ( V_38 )
goto V_44;
...
V_36 = V_34 -> V_49 [ 0 ] ;
V_37 = V_34 -> V_48 [ 0 ] ;
V_81 = F_25 ( V_36 , V_34 -> V_48 [ 0 ] ,
struct V_60 ) ;
F_56 ( V_36 , V_81 , V_78 -> V_84 ) ;
F_57 ( V_36 , V_81 , V_8 -> V_61 ) ;
F_58 ( V_36 , V_81 , V_8 -> V_62 ) ;
F_59 ( V_36 , V_81 , V_8 -> V_63 ) ;
F_60 ( V_36 , V_81 , V_8 -> V_64 ) ;
F_51 ( V_36 ) ;
V_44:
F_45 ( V_34 ) ;
return V_38 ;
}
static int F_69 ( struct V_77 * V_78 ,
struct V_2 * V_3 ,
struct V_31 * V_85 )
{
struct V_33 * V_34 ;
...
F_70 ( V_36 , V_52 , V_3 -> V_45 ) ;
F_71 ( V_36 , V_52 , V_78 -> V_84 ) ;
F_72 ( V_36 , V_52 ,
V_3 -> V_86 . V_46 ) ;
F_51 ( V_36 ) ;
V_44:
...
V_29 . type = 0 ;
while ( 1 ) {
V_38 = F_53 ( V_78 , V_85 , & V_29 , V_34 , - 1 , 1 ) ;
if ( V_38 < 0 )
goto V_44;
V_83 = V_34 -> V_49 [ 0 ] ;
V_87 = F_74 ( V_83 ) ;
...
break;
V_34 -> V_48 [ 0 ] = 0 ;
V_38 = F_75 ( V_78 , V_85 , V_34 , 0 , V_87 ) ;
if ( V_38 )
goto V_44;
F_43 ( V_34 ) ;
}
...
goto V_93;
V_83 = V_34 -> V_49 [ 0 ] ;
V_52 = F_25 ( V_83 , V_34 -> V_48 [ 0 ] ,
struct V_51 ) ;
F_71 ( V_83 , V_52 , V_78 -> V_84 ) ;
F_79 ( V_83 , V_52 , V_53 ) ;
V_3 -> V_45 = V_74 |
V_56 ;
F_70 ( V_83 , V_52 , V_3 -> V_45 ) ;
F_72 ( V_83 , V_52 , 0 ) ;
F_51 ( V_83 ) ;
V_29 . V_46 = 0 ;
V_29 . type = V_94 ;
...
if ( V_38 )
goto V_44;
V_38 = F_85 ( V_78 , V_89 , & V_32 -> V_99 ) ;
if ( V_38 )
goto V_44;
F_10 ( & V_32 -> V_100 ) ;
F_86 ( V_32 -> V_9 ) ;
F_87 ( V_78 , V_89 , V_32 -> V_9 ) ;
F_88 ( V_32 -> V_9 ) ;
F_89 ( V_78 , V_32 , V_32 -> V_9 , 0 , 1 ) ;
F_82 ( V_32 -> V_9 ) ;
F_82 ( V_32 -> V_98 ) ;
F_13 ( V_32 ) ;
V_44:
...
V_38 = F_49 ( V_78 , V_32 , V_79 , V_80 ) ;
if ( V_38 )
goto V_44;
V_38 = F_49 ( V_78 , V_32 , V_80 , V_79 ) ;
if ( V_38 ) {
F_52 ( V_78 , V_32 , V_79 , V_80 ) ;
goto V_44;
}
F_80 ( & V_3 -> V_97 ) ;
V_38 = F_16 ( V_32 -> V_3 , V_79 , V_80 ) ;
F_81 ( & V_3 -> V_97 ) ;
V_44:
F_83 ( & V_3 -> V_90 ) ;
return V_38 ;
...
goto V_44;
V_105:
V_38 = F_52 ( V_78 , V_32 , V_79 , V_80 ) ;
V_104 = F_52 ( V_78 , V_32 , V_80 , V_79 ) ;
if ( V_104 && ! V_38 )
V_38 = V_104 ;
F_80 ( & V_3 -> V_97 ) ;
F_18 ( V_3 , V_79 , V_80 ) ;
...
int F_97 ( struct V_77 * V_78 ,
struct V_111 * V_9 ,
struct V_112 * V_113 )
{
struct V_114 * V_115 ;
F_98 ( ! V_78 -> V_116 . V_117 ) ;
V_115 = F_99 ( sizeof( * V_115 ) , V_43 ) ;
if ( ! V_115 )
return - V_15 ;
V_115 -> V_9 = V_9 ;
V_115 -> V_113 = V_113 ;
F_17 ( & V_115 -> V_20 , & V_78 -> V_118 ) ;
return 0 ;
}
...
int V_38 ;
F_101 ( & V_125 ) ;
while ( ( V_123 = F_102 ( V_120 , & V_125 ) ) ) {
V_128 = F_1 ( V_3 , V_123 -> V_129 ) ;
if ( ! V_128 )
continue;
F_103 ( V_121 ) ;
V_38 = F_104 ( V_121 , V_128 -> V_4 ,
( T_1 ) ( V_130 ) V_128 , V_14 ) ;
if ( V_38 < 0 )
return V_38 ;
F_101 ( & V_127 ) ;
while ( ( V_126 = F_102 ( V_121 , & V_127 ) ) ) {
struct V_19 * V_131 ;
...
V_38 = F_104 ( V_121 , V_131 -> V_27 -> V_4 ,
...
int V_38 ;
F_103 ( V_121 ) ;
V_38 = F_104 ( V_121 , V_8 -> V_4 , ( V_130 ) V_8 , V_14 ) ;
if ( V_38 < 0 )
return V_38 ;
F_101 ( & V_125 ) ;
while ( ( V_123 = F_102 ( V_121 , & V_125 ) ) ) {
...
continue;
F_103 ( V_121 ) ;
V_38 = F_104 ( V_121 , V_128 -> V_4 , ( V_130 ) V_128 , V_14 ) ;
if ( V_38 < 0 )
return V_38 ;
F_101 ( & V_127 ) ;
while ( ( V_126 = F_102 ( V_121 , & V_127 ) ) ) {
...
F_83 ( & V_3 -> V_154 ) ;
V_38 = F_114 ( V_78 , V_3 , V_9 -> V_140 , V_117 , & V_120 ) ;
if ( V_38 < 0 )
return V_38 ;
F_80 ( & V_3 -> V_97 ) ;
V_32 = V_3 -> V_32 ;
...
V_38 = F_100 ( V_3 , V_120 , V_3 -> V_42 ,
V_117 ) ;
if ( V_38 )
goto V_155;
V_38 = F_105 ( V_3 , V_120 , V_3 -> V_42 ,
V_117 , V_134 , V_9 -> V_135 , V_8 ) ;
if ( V_38 )
goto V_155;
V_38 = F_107 ( V_3 , V_120 , V_3 -> V_42 ,
...
V_38 = F_55 ( V_78 , V_32 , V_46 ) ;
if ( V_38 )
goto V_44;
if ( V_161 && V_161 -> V_39 & V_171 ) {
V_38 = F_67 ( V_78 , V_32 , V_46 ,
V_161 -> V_172 . V_39 ,
V_161 -> V_172 . V_67 ,
V_161 -> V_172 . V_68 ,
V_161 -> V_172 . V_69 ,
...
V_174 . type = V_176 ;
V_174 . V_47 = ( T_1 ) - 1 ;
V_173 = F_120 ( V_3 , & V_174 ) ;
if ( F_31 ( V_173 ) ) {
V_38 = F_32 ( V_173 ) ;
goto V_44;
}
F_121 () ;
V_175 = F_122 ( V_173 -> V_9 ) ;
V_166 = F_123 ( V_173 , V_175 ) ;
F_124 () ;
}
if ( V_161 ) {
V_163 = ( T_1 * ) ( V_161 + 1 ) ;
...
int F_125 ( struct V_31 * V_85 , T_1 V_135 )
{
struct V_31 * V_32 ;
struct V_1 * V_8 ;
struct V_2 * V_3 = V_85 -> V_3 ;
T_1 V_139 = V_85 -> V_99 . V_46 ;
int V_38 = 0 ;
struct V_122 * V_123 ;
struct V_124 V_125 ;
if ( ! F_112 ( V_139 ) )
...
goto V_44;
F_103 ( V_3 -> V_42 ) ;
V_38 = F_104 ( V_3 -> V_42 , V_8 -> V_4 ,
( V_130 ) V_8 , V_14 ) ;
if ( V_38 < 0 )
goto V_44;
F_101 ( & V_125 ) ;
while ( ( V_123 = F_102 ( V_3 -> V_42 , & V_125 ) ) ) {
struct V_1 * V_128 ;
struct V_19 * V_131 ;
V_128 = (struct V_1 * ) ( V_130 ) V_123 -> V_132 ;
if ( ( V_128 -> V_66 & V_177 ) &&
...
void F_126 ( struct V_31 * V_85 , T_1 V_135 )
{
struct V_31 * V_32 ;
struct V_1 * V_8 ;
struct V_2 * V_3 = V_85 -> V_3 ;
...
void F_127 ( struct V_77 * V_78 )
{
if ( F_11 ( & V_78 -> V_118 ) && ! V_78 -> V_116 . V_117 )
return;
F_128 ( L_7 ,
V_78 , F_11 ( & V_78 -> V_118 ) ? L_8 : L_9 ,
( T_2 ) ( V_78 -> V_116 . V_117 >> 32 ) ,
( T_2 ) V_78 -> V_116 . V_117 ) ;
F_111 () ;
}
static int
F_129 ( struct V_2 * V_3 , struct V_33 * V_34 ,
...
F_43 ( V_34 ) ;
F_83 ( & V_3 -> V_154 ) ;
for (; V_37 < F_74 ( V_182 ) ; ++ V_37 ) {
F_24 ( V_182 , & V_183 , V_37 ) ;
if ( V_183 . type != V_141 )
continue;
V_38 = F_114 ( V_78 , V_3 , V_183 . V_46 ,
V_185 . V_117 , & V_120 ) ;
if ( V_38 < 0 )
goto V_44;
F_80 ( & V_3 -> V_97 ) ;
V_117 = V_3 -> V_156 ;
V_3 -> V_156 += V_120 -> V_136 + 1 ;
V_38 = F_100 ( V_3 , V_120 , V_121 , V_117 ) ;
if ( V_38 ) {
F_81 ( & V_3 -> V_97 ) ;
F_46 ( V_120 ) ;
goto V_44;
...
if ( ! V_128 )
continue;
V_38 = F_104 ( V_121 , V_128 -> V_4 , ( V_130 ) V_128 ,
V_14 ) ;
if ( V_38 < 0 ) {
F_81 ( & V_3 -> V_97 ) ;
F_46 ( V_120 ) ;
...
{
struct V_2 * V_3 = F_134 ( V_188 , struct V_2 ,
V_159 ) ;
struct V_33 * V_34 ;
...
if ( ! V_121 )
goto V_44;
V_182 = F_99 ( sizeof( * V_182 ) , V_43 ) ;
if ( ! V_182 )
goto V_44;
V_104 = 0 ;
while ( ! V_104 ) {
V_78 = F_135 ( V_3 -> V_189 , 0 ) ;
if ( F_31 ( V_78 ) ) {
V_104 = F_32 ( V_78 ) ;
break;
}
...
V_104 = F_129 ( V_3 , V_34 , V_78 ,
V_121 , V_182 ) ;
}
if ( V_104 > 0 )
F_136 ( V_78 , V_3 -> V_189 ) ;
else
F_137 ( V_78 , V_3 -> V_189 ) ;
}
V_44:
F_13 ( V_182 ) ;
F_46 ( V_121 ) ;
...
struct V_1 * V_8 ;
F_80 ( & V_3 -> V_97 ) ;
for ( V_6 = F_48 ( & V_3 -> V_7 ) ; V_6 ; V_6 = F_141 ( V_6 ) ) {
V_8 = F_2 ( V_6 , struct V_1 , V_9 ) ;
V_8 -> V_61 = 0 ;
V_8 -> V_62 = 0 ;
V_8 -> V_63 = 0 ;
...
if ( V_38 )
return V_38 ;
V_78 = F_143 ( V_3 -> V_189 ) ;
if ( F_31 ( V_78 ) ) {
V_3 -> V_45 &= ~ V_76 ;
return F_32 ( V_78 ) ;
}
V_38 = F_136 ( V_78 , V_3 -> V_189 ) ;
if ( V_38 ) {
V_3 -> V_45 &= ~ V_76 ;
return V_38 ;
}
