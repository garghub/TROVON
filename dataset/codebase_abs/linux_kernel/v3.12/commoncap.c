...
if ( V_29 < 0 )
return V_29 ;
V_87 = F_34 ( V_41 -> V_14 , 0 ) ;
if ( ! F_35 ( V_88 ) ) {
if ( V_55 && ! F_6 ( V_41 -> V_89 , V_87 ) && F_6 ( V_41 -> V_20 , V_87 ) ) {
F_1 ( V_45 -> V_86 ) ;
goto V_90;
}
...
! F_36 ( V_8 -> V_93 , V_8 -> V_94 ) ) ;
}
int F_42 ( struct V_46 * V_46 , const char * V_106 ,
const void * V_107 , T_4 V_62 , int V_108 )
{
if ( ! strcmp ( V_106 , V_51 ) ) {
if ( ! F_8 ( V_109 ) )
return - V_16 ;
return 0 ;
}
...
int F_43 ( struct V_46 * V_46 , const char * V_106 )
{
if ( ! strcmp ( V_106 , V_51 ) ) {
if ( ! F_8 ( V_109 ) )
return - V_16 ;
...
int F_45 ( struct V_8 * V_41 , const struct V_8 * V_42 , int V_108 )
{
switch ( V_108 ) {
case V_112 :
case V_113 :
...
int F_49 ( struct V_26 * V_117 )
{
return F_48 ( V_117 ) ;
}
int F_50 ( struct V_26 * V_117 , int V_120 )
{
return F_48 ( V_117 ) ;
}
int F_51 ( struct V_26 * V_117 , int V_121 )
{
return F_48 ( V_117 ) ;
}
...
int F_56 ( int V_122 , unsigned long V_123 , unsigned long V_124 ,
...
if ( ! F_54 ( V_123 ) )
goto error;
error = ! ! F_5 ( V_41 -> V_43 , V_123 ) ;
goto V_129;
case V_130 :
error = F_52 ( V_41 , V_123 ) ;
if ( error < 0 )
goto error;
goto V_131;
case V_132 :
error = - V_16 ;
if ( ( ( ( V_41 -> V_104 & V_133 ) >> 1 )
& ( V_41 -> V_104 ^ V_123 ) )
|| ( ( V_41 -> V_104 & V_133 & ~ V_123 ) )
|| ( V_123 & ~ ( V_133 | V_134 ) )
|| ( F_4 ( F_11 () ,
F_11 () -> V_14 , V_39 ,
V_40 ) != 0 )
...
int F_60 ( struct V_140 * V_141 , long V_142 )
{
int V_143 = 0 ;
if ( F_4 ( F_11 () , & V_17 , V_111 ,
V_144 ) == 0 )
V_143 = 1 ;
return F_61 ( V_141 , V_142 , V_143 ) ;
}
int F_62 ( unsigned long V_145 )
{
int V_29 = 0 ;
if ( V_145 < V_146 ) {
...
int F_63 ( struct V_78 * V_78 , unsigned long V_150 ,
unsigned long V_151 , unsigned long V_108 )
{
return 0 ;
}
