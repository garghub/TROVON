...
return V_29 ;
V_66:
if ( V_55 -> V_30 -> V_62 -> V_99 )
V_55 -> V_30 -> V_62 -> V_99 ( V_2 , V_55 ) ;
V_98:
if ( V_56 -> V_30 -> V_62 -> V_99 )
...
static int F_36 ( struct V_1 * V_2 , int V_100 )
{
struct V_15 * V_27 = V_2 -> V_28 ;
struct V_53 * V_54 = V_27 -> V_54 ;
struct V_25 * V_55 = V_27 -> V_55 ;
...
if ( V_55 -> V_30 -> V_62 -> V_104 )
V_104 += V_55 -> V_30 -> V_62 -> V_104 ( V_2 , V_55 ) ;
if ( V_56 -> V_30 -> V_62 -> V_104 )
...
V_20 = F_40 ( sizeof( struct V_19 ) , V_106 ) ;
if ( ! V_20 )
return - V_107 ;
V_20 -> V_21 = V_21 ;
V_20 -> V_16 = V_16 ;
...
V_20 -> V_108 = V_109 ;
F_41 ( & V_20 -> V_110 , & V_16 -> V_20 [ V_37 ] . V_111 ) ;
F_41 ( & V_20 -> V_112 , & V_21 -> V_20 [ V_37 ] . V_113 ) ;
F_4 ( V_16 -> V_22 , L_31 ,
V_37 ? L_32 : L_33 , V_16 -> V_23 -> V_24 ,
V_37 ? L_34 : L_35 , V_21 -> V_23 -> V_24 ) ;
#ifdef F_42
V_20 -> V_114 = F_43 ( V_21 -> V_23 -> V_24 , 0644 ,
...
static struct V_15 * F_51 ( struct V_121 * V_92 ,
...
struct V_127 * V_128 ;
int V_132 ;
V_128 = F_40 ( sizeof( struct V_127 ) +
sizeof( struct V_122 * ) , V_106 ) ;
if ( V_128 == NULL )
return - V_107 ;
V_132 = F_56 ( V_55 , V_37 , & V_128 ) ;
...
int V_133 = 0 ;
F_3 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
V_123 = F_52 ( V_20 -> V_21 , V_37 ) ;
if ( V_123 && F_54 ( V_128 , V_123 ) )
continue;
V_123 = F_53 ( V_20 -> V_21 , V_37 ) ;
if ( V_123 && F_54 ( V_128 , V_123 ) )
continue;
F_4 ( V_16 -> V_22 , L_41 ,
V_37 ? L_32 : L_33 ,
...
V_21 = F_51 ( V_92 , V_128 -> V_130 [ V_35 ] , V_37 ) ;
if ( ! V_21 ) {
F_9 ( V_16 -> V_22 , L_43 ,
...
{
if ( V_136 )
return F_59 ( V_16 , V_37 , V_128 ) ;
else
return F_58 ( V_16 , V_37 , V_128 ) ;
}
...
F_9 ( V_16 -> V_22 , L_59 ,
V_16 -> V_23 -> V_24 ) ;
V_137 = F_70 ( V_16 , V_37 ) ;
V_16 -> V_20 [ V_37 ] . V_108 = V_150 ;
V_16 -> V_20 [ V_37 ] . V_134 = V_141 ;
F_23 ( & V_16 -> V_92 -> V_155 ) ;
return 0 ;
}
...
static int F_80 ( struct V_1 * V_2 , int V_100 )
{
struct V_15 * V_16 = V_2 -> V_28 ;
...
struct V_15 * V_27 = V_2 -> V_28 ;
struct V_53 * V_54 = V_27 -> V_54 ;
if ( V_54 -> V_30 -> V_62 -> V_171 )
return V_54 -> V_30 -> V_62 -> V_171 ( V_2 , V_100 , V_170 ) ;
return F_85 ( V_2 , V_100 , V_170 ) ;
}
...
F_4 ( V_16 -> V_22 , L_78 ,
V_16 -> V_23 -> V_24 ) ;
V_137 = F_37 ( V_2 , V_163 ) ;
if ( V_137 < 0 )
F_9 ( V_16 -> V_22 , L_68 , V_137 ) ;
} else {
F_4 ( V_16 -> V_22 , L_79 ,
V_16 -> V_23 -> V_24 ) ;
V_137 = F_79 ( V_16 , V_37 , V_163 ) ;
if ( V_137 < 0 )
F_9 ( V_16 -> V_22 , L_68 , V_137 ) ;
}
V_137 = F_70 ( V_16 , V_37 ) ;
if ( V_137 < 0 )
F_9 ( V_16 -> V_22 , L_80 , V_137 ) ;
V_137 = F_68 ( V_16 , V_37 ) ;
if ( V_137 < 0 )
...
int F_90 ( struct V_121 * V_92 )
{
int V_35 , V_174 , V_136 , V_132 ;
F_18 ( & V_92 -> V_155 , V_156 ) ;
...
V_136 = F_60 ( V_16 , V_38 , & V_128 , 1 ) ;
if ( V_136 ) {
F_88 ( V_16 , V_38 ) ;
F_61 ( V_16 , V_38 ) ;
F_46 ( V_16 , V_38 ) ;
}
V_174 = F_60 ( V_16 , V_38 , & V_128 , 0 ) ;
if ( V_174 ) {
F_89 ( V_16 , V_38 ) ;
F_61 ( V_16 , V_38 ) ;
F_46 ( V_16 , V_38 ) ;
...
V_136 = F_60 ( V_16 , V_90 , & V_128 , 1 ) ;
if ( V_136 ) {
F_88 ( V_16 , V_90 ) ;
F_61 ( V_16 , V_90 ) ;
F_46 ( V_16 , V_90 ) ;
}
V_174 = F_60 ( V_16 , V_90 , & V_128 , 0 ) ;
if ( V_174 ) {
F_89 ( V_16 , V_90 ) ;
F_61 ( V_16 , V_90 ) ;
F_46 ( V_16 , V_90 ) ;
...
int F_91 ( struct V_15 * V_16 , int V_176 )
{
struct V_19 * V_20 ;
struct V_177 * V_178 =
...
if ( V_179 -> V_62 -> V_181 && V_34 -> V_75 )
V_179 -> V_62 -> V_181 ( V_34 , V_176 ) ;
}
return 0 ;
}
static int F_92 ( struct V_1 * V_116 )
{
struct V_15 * V_16 = V_116 -> V_28 ;
struct V_19 * V_20 ;
struct V_127 * V_128 ;
...
if ( F_55 ( V_16 , V_37 , & V_128 ) <= 0 ) {
F_4 ( V_16 -> V_22 , L_91 ,
V_16 -> V_23 -> V_24 , V_37 ? L_32 : L_33 ) ;
}
F_60 ( V_16 , V_37 , & V_128 , 1 ) ;
V_29 = F_67 ( V_116 ) ;
if ( V_29 < 0 ) {
F_3 (dpcm, &fe->dpcm[stream].be_clients, list_be)
V_20 -> V_108 = V_120 ;
...
static int F_93 ( struct V_1 * V_116 )
{
struct V_15 * V_16 = V_116 -> V_28 ;
struct V_19 * V_20 ;
...
int F_94 ( struct V_15 * V_27 , int V_182 )
{
struct V_53 * V_54 = V_27 -> V_54 ;
struct V_25 * V_56 = V_27 -> V_56 ;
struct V_25 * V_55 = V_27 -> V_55 ;
...
if ( V_27 -> V_23 -> V_70 ) {
snprintf ( V_185 , sizeof( V_185 ) , L_92 ,
V_27 -> V_23 -> V_83 ) ;
V_29 = F_95 ( V_27 -> V_92 -> V_188 , V_185 , V_182 ,
V_39 , V_41 , & V_184 ) ;
} else {
if ( V_27 -> V_23 -> V_69 )
...
V_29 = F_96 ( V_27 -> V_92 -> V_188 , V_185 , V_182 , V_39 ,
V_41 , & V_184 ) ;
}
if ( V_29 < 0 ) {
F_9 ( V_27 -> V_92 -> V_22 , L_95 ,
V_27 -> V_23 -> V_24 ) ;
return V_29 ;
}
F_4 ( V_27 -> V_92 -> V_22 , L_96 , V_182 , V_185 ) ;
F_97 ( & V_27 -> V_82 , F_25 ) ;
V_27 -> V_184 = V_184 ;
V_184 -> V_28 = V_27 ;
if ( V_27 -> V_23 -> V_70 ) {
...
V_27 -> V_62 . V_96 = F_75 ;
V_27 -> V_62 . V_91 = F_82 ;
V_27 -> V_62 . V_101 = F_80 ;
V_27 -> V_62 . V_99 = F_72 ;
V_27 -> V_62 . V_79 = F_93 ;
V_27 -> V_62 . V_105 = F_38 ;
V_27 -> V_62 . V_171 = F_84 ;
} else {
V_27 -> V_62 . V_65 = F_16 ;
V_27 -> V_62 . V_96 = F_33 ;
V_27 -> V_62 . V_91 = F_31 ;
V_27 -> V_62 . V_101 = F_36 ;
V_27 -> V_62 . V_99 = F_35 ;
V_27 -> V_62 . V_79 = F_27 ;
V_27 -> V_62 . V_105 = F_38 ;
V_27 -> V_62 . V_171 = F_84 ;
...
if ( V_39 )
F_98 ( V_184 , V_38 , & V_27 -> V_62 ) ;
if ( V_41 )
F_98 ( V_184 , V_90 , & V_27 -> V_62 ) ;
if ( V_54 -> V_30 -> V_195 ) {
...
V_64:
F_99 ( V_27 -> V_92 -> V_22 , L_98 , V_56 -> V_24 ,
V_55 -> V_24 ) ;
return V_29 ;
}
...
{
if ( V_54 -> V_30 -> V_62 -> V_101 )
return V_54 -> V_30 -> V_62 -> V_101 ( V_2 , V_100 ) ;
return 0 ;
}
static char * F_104 ( enum V_198 V_108 )
{
switch ( V_108 ) {
case V_146 :
return L_99 ;
...
V_37 ? L_111 : L_112 ) ;
V_103 += snprintf ( V_199 + V_103 , V_200 - V_103 , L_113 ,
F_104 ( V_16 -> V_20 [ V_37 ] . V_108 ) ) ;
if ( ( V_16 -> V_20 [ V_37 ] . V_108 >= V_151 ) &&
( V_16 -> V_20 [ V_37 ] . V_108 <= V_154 ) )
V_103 += snprintf ( V_199 + V_103 , V_200 - V_103 ,
L_114
...
F_76 ( V_95 ) ,
F_34 ( V_95 ) ) ;
V_103 += snprintf ( V_199 + V_103 , V_200 - V_103 , L_116 ) ;
if ( F_83 ( & V_16 -> V_20 [ V_37 ] . V_111 ) ) {
V_103 += snprintf ( V_199 + V_103 , V_200 - V_103 ,
L_117 ) ;
goto V_64;
...
static T_3 F_107 ( struct V_201 * V_201 , char T_5 * V_202 ,
T_4 V_144 , T_6 * V_203 )
{
struct V_15 * V_16 = V_201 -> V_28 ;
T_3 V_204 = V_205 , V_103 = 0 , V_29 = 0 ;
char * V_199 ;
V_199 = F_108 ( V_204 , V_106 ) ;
if ( ! V_199 )
return - V_107 ;
if ( V_16 -> V_55 -> V_30 -> V_39 . V_48 )
V_103 += F_105 ( V_16 , V_38 ,
V_199 + V_103 , V_204 - V_103 ) ;
if ( V_16 -> V_55 -> V_30 -> V_41 . V_48 )
V_103 += F_105 ( V_16 , V_90 ,
V_199 + V_103 , V_204 - V_103 ) ;
V_29 = F_109 ( V_202 , V_144 , V_203 , V_199 , V_103 ) ;
F_50 ( V_199 ) ;
return V_29 ;
}
...
if ( ! V_27 -> V_23 )
return 0 ;
V_27 -> V_115 = F_111 ( V_27 -> V_23 -> V_24 ,
V_27 -> V_92 -> V_206 ) ;
if ( ! V_27 -> V_115 ) {
F_4 ( V_27 -> V_22 ,
L_121 ,
