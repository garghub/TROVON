...
{
struct V_1 * V_3 = V_38 -> V_41 ;
if ( ! V_3 || ! V_3 -> V_33 -> V_84 )
return - V_85 ;
return V_3 -> V_33 -> V_84 ( V_3 ) ;
}
static int F_67 ( struct V_37 * V_38 ,
unsigned int V_86 , unsigned int V_87 )
{
struct V_1 * V_3 = V_38 -> V_41 ;
if ( ! V_3 || ! V_3 -> V_33 -> V_88 )
return - V_85 ;
return V_3 -> V_33 -> V_88 ( V_3 , V_86 , V_87 ) ;
}
int F_68 ( struct V_23 * V_39 , int line , char * V_25 )
{
return 0 ;
}
static int F_69 ( struct V_23 * V_39 , int line )
{
struct V_37 * V_38 = V_39 -> V_89 [ 0 ] ;
struct V_1 * V_3 = V_38 -> V_41 ;
int V_16 ;
char V_90 ;
V_16 = V_3 -> V_33 -> V_78 ( V_3 -> V_31 , & V_90 , 1 ) ;
if ( V_16 == 0 )
return V_91 ;
return V_90 ;
}
static void F_70 ( struct V_23 * V_39 , int line , char V_90 )
{
struct V_37 * V_38 = V_39 -> V_89 [ 0 ] ;
struct V_1 * V_3 = V_38 -> V_41 ;
int V_16 ;
do {
V_16 = V_3 -> V_33 -> F_9 ( V_3 -> V_31 , & V_90 , 1 ) ;
} while ( V_16 <= 0 );
}
struct V_1 * F_71 ( T_2 V_31 , int V_45 ,
...
V_3 = F_74 ( F_75 ( sizeof( * V_3 ) , sizeof( long ) ) + V_60 ,
V_93 ) ;
if ( ! V_3 )
return F_73 ( - V_94 ) ;
V_3 -> V_31 = V_31 ;
...
V_3 -> V_33 = V_33 ;
V_3 -> V_60 = V_60 ;
V_3 -> V_53 = & ( ( char * ) V_3 ) [ F_75 ( sizeof( * V_3 ) , sizeof( long ) ) ] ;
F_76 ( & V_3 -> V_7 ) ;
V_3 -> V_7 . V_33 = & V_95 ;
F_77 ( & V_3 -> V_49 , F_39 ) ;
F_78 ( & V_3 -> V_6 ) ;
...
V_97 -> type = V_106 ;
V_97 -> V_107 = V_108 ;
V_97 -> V_4 = V_109 | V_110 ;
F_85 ( V_97 , & V_111 ) ;
V_36 = F_86 ( F_56 , NULL , L_4 ) ;
if ( F_87 ( V_36 ) ) {
F_28 ( V_46 L_5 ) ;
V_92 = F_88 ( V_36 ) ;
goto V_112;
