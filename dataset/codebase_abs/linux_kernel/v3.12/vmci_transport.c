...
V_2 = F_115 ( V_99 , sizeof( * V_32 ) , V_193 -> V_204 ,
V_195 ) ;
if ( V_2 )
goto V_90;
if ( V_193 -> V_205 ) {
struct V_22 * V_206 ;
V_206 = (struct V_22 * ) V_193 -> V_205 ;
F_6 ( V_206 , V_32 -> V_23 . V_58 , V_32 -> V_23 . V_108 ) ;
V_193 -> V_200 = sizeof( * V_206 ) ;
}
V_2 = V_195 ;
V_90:
F_116 ( & V_66 -> V_64 , V_99 ) ;
return V_2 ;
}
static bool F_117 ( T_2 V_102 , T_2 V_103 )
{
if ( V_102 == V_17 ) {
return V_103 == V_207 ;
}
...
static int F_118 ( struct V_65 * V_66 )
{
int V_2 ;
bool V_138 = false ;
...
{
if ( V_88 & V_209 )
return F_120 ( F_63 ( V_66 ) -> V_84 , V_187 , V_188 , 0 ) ;
else
...
T_6 V_188 )
{
return F_123 ( F_63 ( V_66 ) -> V_84 , V_187 , V_188 , 0 ) ;
}
static T_9 F_124 ( struct V_65 * V_66 )
{
return F_125 ( F_63 ( V_66 ) -> V_84 ) ;
}
static T_9 F_126 ( struct V_65 * V_66 )
{
return F_127 ( F_63 ( V_66 ) -> V_84 ) ;
}
static T_4 F_128 ( struct V_65 * V_66 )
{
return F_63 ( V_66 ) -> V_86 ;
}
static bool F_129 ( struct V_65 * V_66 )
{
return ! F_73 ( F_63 ( V_66 ) -> V_124 ) ;
}
static T_4 F_130 ( struct V_65 * V_66 )
{
...
static void F_133 ( struct V_65 * V_66 , T_4 V_210 )
{
