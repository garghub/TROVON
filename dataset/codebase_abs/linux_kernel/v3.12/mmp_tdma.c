...
{
struct V_1 * V_2 = F_19 ( V_74 ) ;
F_31 ( V_111 , V_74 -> V_112 , V_74 -> V_109 ,
V_2 -> V_52 - V_2 -> V_50 ) ;
return V_2 -> V_11 ;
}
...
{
struct V_56 * V_57 = F_34 ( V_114 ) ;
F_35 ( & V_57 -> V_115 ) ;
return 0 ;
}
static int F_36 ( struct V_56 * V_57 ,
int V_116 , int V_48 , int type )
{
struct V_1 * V_2 ;
if ( V_116 >= V_61 ) {
F_9 ( V_57 -> V_32 , L_6 ) ;
...
V_2 = F_37 ( V_57 -> V_32 , sizeof( * V_2 ) , V_117 ) ;
if ( ! V_2 ) {
F_9 ( V_57 -> V_32 , L_7 ) ;
return - V_118 ;
}
...
V_2 -> V_48 = V_48 ;
V_2 -> V_32 = V_57 -> V_32 ;
V_2 -> V_74 . V_115 = & V_57 -> V_115 ;
V_2 -> V_116 = V_116 ;
V_2 -> type = type ;
V_2 -> V_4 = ( unsigned long ) V_57 -> V_119 + V_116 * 4 ;
V_2 -> V_11 = V_13 ;
V_57 -> V_2 [ V_2 -> V_116 ] = V_2 ;
F_38 ( & V_2 -> V_53 , F_14 , ( unsigned long ) V_2 ) ;
F_39 ( & V_2 -> V_74 . V_120 ,
& V_57 -> V_115 . V_121 ) ;
return 0 ;
}
static int F_40 ( struct V_113 * V_114 )
{
enum V_122 type ;
...
int V_48 = 0 , V_60 = 0 ;
int V_127 = V_61 ;
V_124 = F_41 ( V_128 , & V_114 -> V_32 ) ;
if ( V_124 )
type = (enum V_122 ) V_124 -> V_62 ;
else
type = F_42 ( V_114 ) -> V_129 ;
V_57 = F_37 ( & V_114 -> V_32 , sizeof( * V_57 ) , V_117 ) ;
if ( ! V_57 )
return - V_118 ;
V_57 -> V_32 = & V_114 -> V_32 ;
for ( V_58 = 0 ; V_58 < V_127 ; V_58 ++ ) {
if ( F_43 ( V_114 , V_58 ) > 0 )
V_60 ++ ;
}
V_126 = F_44 ( V_114 , V_130 , 0 ) ;
V_57 -> V_119 = F_45 ( & V_114 -> V_32 , V_126 ) ;
if ( F_46 ( V_57 -> V_119 ) )
return F_47 ( V_57 -> V_119 ) ;
F_48 ( & V_57 -> V_115 . V_121 ) ;
if ( V_60 != V_127 ) {
V_48 = F_43 ( V_114 , 0 ) ;
V_59 = F_22 ( & V_114 -> V_32 , V_48 ,
F_13 , V_78 , L_4 , V_57 ) ;
if ( V_59 )
return V_59 ;
}
for ( V_58 = 0 ; V_58 < V_127 ; V_58 ++ ) {
V_48 = ( V_60 != V_127 ) ? 0 : F_43 ( V_114 , V_58 ) ;
V_59 = F_36 ( V_57 , V_58 , V_48 , type ) ;
if ( V_59 )
return V_59 ;
}
F_49 ( V_131 , V_57 -> V_115 . V_132 ) ;
F_49 ( V_133 , V_57 -> V_115 . V_132 ) ;
V_57 -> V_115 . V_32 = & V_114 -> V_32 ;
V_57 -> V_115 . V_134 =
F_20 ;
V_57 -> V_115 . V_135 =
F_23 ;
V_57 -> V_115 . V_136 = F_28 ;
V_57 -> V_115 . V_137 = F_30 ;
V_57 -> V_115 . V_138 = F_32 ;
V_57 -> V_115 . V_139 = F_29 ;
V_57 -> V_115 . V_140 = V_141 ;
F_50 ( & V_114 -> V_32 , F_51 ( 64 ) ) ;
F_52 ( V_114 , V_57 ) ;
V_59 = F_53 ( & V_57 -> V_115 ) ;
if ( V_59 ) {
F_9 ( V_57 -> V_115 . V_32 , L_8 ) ;
return V_59 ;
}
F_54 ( V_57 -> V_115 . V_32 , L_9 ) ;
return 0 ;
}
