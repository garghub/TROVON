...
if ( ! F_31 ( V_18 -> V_35 ) )
return - V_75 ;
V_84 = F_2 ( V_3 -> V_85 , struct V_83 , V_86 ) ;
if ( ! V_84 -> V_87 ) {
F_32 ( & V_84 -> V_88 ) ;
F_33 ( V_84 -> V_72 , V_18 -> V_35 ) ;
V_21 = F_34 ( V_84 -> V_72 ) ;
F_35 ( & V_84 -> V_88 ) ;
if ( V_21 )
return V_21 ;
...
if ( F_23 ( V_82 ) )
return F_24 ( V_82 ) ;
V_91 . V_92 = V_82 [ 0 ] . V_93 ;
V_94 . V_92 = V_82 [ 2 ] . V_93 ;
V_95 . V_96 = V_82 [ 1 ] . V_93 ;
V_97 . V_98 = V_82 [ 3 ] . V_93 ;
V_21 = F_38 ( V_80 , V_3 ) ;
if ( V_21 < 0 )
goto V_65;
V_11 -> V_38 = V_21 ;
...
V_101 . V_104 = V_21 ;
V_21 = - V_105 ;
V_42 = F_39 ( V_18 -> V_35 , & V_106 ) ;
if ( ! V_42 )
goto V_65;
V_11 -> V_4 . V_69 = V_42 ;
V_42 -> V_66 = V_18 ;
V_42 = F_39 ( V_18 -> V_35 , & V_107 ) ;
if ( ! V_42 )
goto V_65;
V_11 -> V_4 . V_70 = V_42 ;
V_42 -> V_66 = V_18 ;
V_42 = F_39 ( V_18 -> V_35 , & V_108 ) ;
if ( ! V_42 )
goto V_65;
V_11 -> V_39 = V_42 ;
V_42 -> V_66 = V_18 ;
V_21 = - V_109 ;
V_11 -> V_14 = F_40 ( V_42 , V_110 ) ;
if ( ! V_11 -> V_14 )
goto V_65;
V_11 -> V_14 -> V_22 = F_41 ( V_34 , V_110 ) ;
if ( ! V_11 -> V_14 -> V_22 )
goto V_65;
V_11 -> V_14 -> V_43 = V_11 ;
V_11 -> V_14 -> V_111 = F_12 ;
V_112 . V_113 = V_106 . V_113 ;
V_114 . V_113 = V_107 . V_113 ;
V_115 . V_113 =
V_108 . V_113 ;
V_116 . V_113 = V_106 . V_113 ;
V_117 . V_113 = V_107 . V_113 ;
V_118 . V_113 =
V_108 . V_113 ;
V_21 = F_42 ( V_3 , V_119 , V_120 ,
V_121 ) ;
if ( V_21 )
goto V_65;
V_11 -> V_4 . V_122 = F_27 ;
...
V_11 -> V_4 . V_69 -> V_124 , V_11 -> V_4 . V_70 -> V_124 ,
V_11 -> V_39 -> V_124 ) ;
return 0 ;
V_65:
if ( V_11 -> V_14 ) {
F_43 ( V_11 -> V_14 -> V_22 ) ;
F_44 ( V_11 -> V_39 , V_11 -> V_14 ) ;
}
if ( V_11 -> V_39 )
V_11 -> V_39 -> V_66 = NULL ;
if ( V_11 -> V_4 . V_70 )
...
ERROR ( V_18 , L_22 , V_3 -> V_124 , V_21 ) ;
return V_21 ;
}
static void
F_45 ( struct V_79 * V_80 , struct V_2 * V_3 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
F_8 ( V_80 -> V_18 , L_23 ) ;
F_46 ( V_3 ) ;
...
int
F_47 ( struct V_79 * V_80 , T_3 V_125 [ V_126 ] ,
struct V_127 * V_128 )
{
struct V_1 * V_11 ;
int V_21 ;
if ( ! F_31 ( V_80 -> V_18 -> V_35 ) || ! V_125 )
return - V_75 ;
V_11 = F_48 ( sizeof *V_11 , V_110 ) ;
if ( ! V_11 )
return - V_109 ;
snprintf ( V_11 -> V_125 , sizeof V_11 -> V_125 , L_24 , V_125 ) ;
V_90 [ 1 ] . V_129 = V_11 -> V_125 ;
V_11 -> V_4 . V_130 = V_128 ;
V_11 -> V_4 . V_60 = V_74 ;
V_11 -> V_4 . V_5 . V_124 = L_25 ;
V_11 -> V_4 . V_5 . V_131 = F_29 ;
V_11 -> V_4 . V_5 . V_132 = F_45 ;
V_11 -> V_4 . V_5 . V_133 = F_15 ;
V_11 -> V_4 . V_5 . V_134 = F_25 ;
V_11 -> V_4 . V_5 . V_135 = F_13 ;
V_11 -> V_4 . V_5 . V_136 = F_26 ;
V_21 = F_49 ( V_80 , & V_11 -> V_4 . V_5 ) ;
if ( V_21 )
F_43 ( V_11 ) ;
return V_21 ;
}
static inline struct V_83 * F_50 ( struct V_137 * V_138 )
{
return F_2 ( F_51 ( V_138 ) , struct V_83 ,
V_86 . V_139 ) ;
}
static void F_52 ( struct V_140 * V_3 )
{
struct V_83 * V_141 ;
V_141 = F_2 ( V_3 , struct V_83 , V_86 ) ;
if ( V_141 -> V_87 )
F_53 ( F_54 ( V_141 -> V_72 ) ) ;
else
F_55 ( V_141 -> V_72 ) ;
F_43 ( V_141 ) ;
}
static struct V_140 * F_56 ( void )
{
struct V_83 * V_141 ;
V_141 = F_48 ( sizeof( * V_141 ) , V_110 ) ;
if ( ! V_141 )
return F_57 ( - V_109 ) ;
F_58 ( & V_141 -> V_88 ) ;
V_141 -> V_86 . V_142 = F_52 ;
V_141 -> V_72 = F_59 () ;
if ( F_23 ( V_141 -> V_72 ) ) {
struct V_71 * V_72 = V_141 -> V_72 ;
F_43 ( V_141 ) ;
return F_60 ( V_72 ) ;
}
F_61 ( & V_141 -> V_86 . V_139 , L_26 , & V_143 ) ;
return & V_141 -> V_86 ;
}
...
struct V_83 * V_141 ;
V_11 = F_1 ( V_3 ) ;
V_141 = F_2 ( V_3 -> V_85 , struct V_83 , V_86 ) ;
F_43 ( V_11 ) ;
F_32 ( & V_141 -> V_88 ) ;
V_141 -> V_144 -- ;
F_35 ( & V_141 -> V_88 ) ;
}
static void F_63 ( struct V_79 * V_80 , struct V_2 * V_3 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
F_8 ( V_80 -> V_18 , L_23 ) ;
F_46 ( V_3 ) ;
...
static struct V_2 * F_64 ( struct V_140 * V_85 )
{
struct V_1 * V_11 ;
struct V_83 * V_141 ;
int V_21 ;
...
if ( ! V_11 )
return F_57 ( - V_109 ) ;
V_141 = F_2 ( V_85 , struct V_83 , V_86 ) ;
F_32 ( & V_141 -> V_88 ) ;
V_141 -> V_144 ++ ;
V_21 = F_65 ( V_141 -> V_72 , V_11 -> V_125 ,
sizeof( V_11 -> V_125 ) ) ;
if ( V_21 < 12 ) {
F_43 ( V_11 ) ;
F_35 ( & V_141 -> V_88 ) ;
...
V_90 [ 1 ] . V_129 = V_11 -> V_125 ;
V_11 -> V_4 . V_130 = F_54 ( V_141 -> V_72 ) ;
F_35 ( & V_141 -> V_88 ) ;
V_11 -> V_4 . V_60 = V_74 ;
V_11 -> V_4 . V_5 . V_124 = L_25 ;
V_11 -> V_4 . V_5 . V_131 = F_29 ;
V_11 -> V_4 . V_5 . V_132 = F_63 ;
V_11 -> V_4 . V_5 . V_133 = F_15 ;
V_11 -> V_4 . V_5 . V_134 = F_25 ;
V_11 -> V_4 . V_5 . V_135 = F_13 ;
V_11 -> V_4 . V_5 . V_136 = F_26 ;
V_11 -> V_4 . V_5 . V_145 = F_62 ;
return & V_11 -> V_4 . V_5 ;
}
