...
struct V_132 * V_133 = F_7 ( V_2 ) ;
unsigned int V_229 = 0 , V_230 , V_231 , V_232 ;
...
static int F_43 ( struct V_132 * V_133 , struct V_337 * V_338 )
{
V_133 -> V_339 . V_340 = F_44 ( V_338 ,
L_15 ) ;
V_133 -> V_339 . V_341 = F_44 ( V_338 ,
L_16 ) ;
V_133 -> V_339 . V_342 = F_45 ( V_338 ,
L_17 , 0 ) ;
if ( ! F_46 ( V_133 -> V_339 . V_342 ) &&
( V_133 -> V_339 . V_342 != - V_343 ) )
return V_133 -> V_339 . V_342 ;
return 0 ;
}
static int F_47 ( struct V_344 * V_345 ,
const struct V_346 * V_237 )
{
struct V_347 * V_339 = F_48 ( & V_345 -> V_5 ) ;
struct V_132 * V_133 ;
int V_203 ;
unsigned int V_145 ;
V_133 = F_49 ( & V_345 -> V_5 ,
sizeof( struct V_132 ) ,
V_348 ) ;
if ( NULL == V_133 )
return - V_349 ;
...
if ( V_339 ) {
V_133 -> V_339 = * V_339 ;
if ( ! V_133 -> V_339 . V_342 )
V_133 -> V_339 . V_342 = - V_135 ;
} else if ( V_345 -> V_5 . V_350 ) {
V_203 = F_43 ( V_133 , V_345 -> V_5 . V_350 ) ;
if ( V_203 )
return V_203 ;
} else
V_133 -> V_339 . V_342 = - V_135 ;
V_133 -> V_168 = F_51 ( V_345 , & V_351 ) ;
if ( F_52 ( V_133 -> V_168 ) ) {
V_203 = F_53 ( V_133 -> V_168 ) ;
F_8 ( & V_345 -> V_5 , L_18 ,
V_203 ) ;
return V_203 ;
}
if ( F_46 ( V_133 -> V_339 . V_342 ) ) {
V_203 = F_54 ( & V_345 -> V_5 , V_133 -> V_339 . V_342 ,
V_352 ,
L_19 ) ;
if ( V_203 < 0 ) {
F_8 ( & V_345 -> V_5 , L_20 ,
V_133 -> V_339 . V_342 , V_203 ) ;
return V_203 ;
}
F_55 ( 400 ) ;
}
...
V_203 = F_57 ( V_133 -> V_168 , V_355 ,
F_4 ( V_355 ) ) ;
if ( V_203 != 0 )
F_58 ( & V_345 -> V_5 , L_22 , V_203 ) ;
if ( V_133 -> V_339 . V_340 )
F_15 ( V_133 -> V_168 , V_32 ,
V_356 , V_356 ) ;
if ( V_133 -> V_339 . V_341 )
F_15 ( V_133 -> V_168 , V_33 ,
V_357 , V_357 ) ;
V_133 -> V_200 = 1 ;
V_203 = F_59 ( & V_345 -> V_5 , & V_358 ,
V_359 , F_4 ( V_359 ) ) ;
if ( V_203 < 0 )
goto V_360;
return 0 ;
...
static int F_60 ( struct V_344 * V_345 )
{
F_61 ( & V_345 -> V_5 ) ;
return 0 ;
}
