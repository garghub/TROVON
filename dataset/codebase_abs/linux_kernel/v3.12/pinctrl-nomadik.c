...
static void F_46 ( unsigned int V_47 , struct V_111 * V_112 ,
T_1 V_113 )
{
struct V_1 * V_2 ;
struct V_114 * V_115 = F_47 ( V_47 ) ;
F_48 ( V_115 , V_112 ) ;
V_2 = F_49 ( V_47 ) ;
while ( V_113 ) {
int V_5 = F_50 ( V_113 ) ;
F_51 ( F_14 ( V_2 -> V_48 , V_5 ) ) ;
V_113 &= ~ F_7 ( V_5 ) ;
}
F_52 ( V_115 , V_112 ) ;
}
static void F_53 ( unsigned int V_47 , struct V_111 * V_112 )
{
struct V_1 * V_2 = F_49 ( V_47 ) ;
T_1 V_113 ;
F_23 ( V_2 -> V_79 ) ;
V_113 = F_2 ( V_2 -> V_8 + V_116 ) ;
F_25 ( V_2 -> V_79 ) ;
F_46 ( V_47 , V_112 , V_113 ) ;
}
static void F_54 ( unsigned int V_47 ,
struct V_111 * V_112 )
{
struct V_1 * V_2 = F_49 ( V_47 ) ;
...
static int F_58 ( struct V_121 * V_45 , unsigned V_3 )
{
int V_44 = V_45 -> V_46 + V_3 ;
return F_59 ( V_44 ) ;
}
static void F_60 ( struct V_121 * V_45 , unsigned V_3 )
{
int V_44 = V_45 -> V_46 + V_3 ;
F_61 ( V_44 ) ;
}
static int F_62 ( struct V_121 * V_45 , unsigned V_3 )
{
struct V_1 * V_2 =
F_63 ( V_45 , struct V_1 , V_45 ) ;
F_23 ( V_2 -> V_79 ) ;
F_3 ( 1 << V_3 , V_2 -> V_8 + V_31 ) ;
F_25 ( V_2 -> V_79 ) ;
return 0 ;
...
static void F_65 ( struct V_121 * V_45 , unsigned V_3 ,
int V_32 )
{
struct V_1 * V_2 =
F_63 ( V_45 , struct V_1 , V_45 ) ;
...
static int F_67 ( struct V_121 * V_45 , unsigned V_3 )
{
struct V_1 * V_2 =
F_63 ( V_45 , struct V_1 , V_45 ) ;
return F_68 ( V_2 -> V_48 , V_3 ) ;
}
static void F_69 ( struct V_123 * V_124 ,
struct V_80 * V_81 , struct V_121 * V_45 ,
unsigned V_3 , unsigned V_44 )
{
const char * V_125 = F_70 ( V_45 , V_3 ) ;
struct V_1 * V_2 =
F_63 ( V_45 , struct V_1 , V_45 ) ;
int V_14 ;
bool V_126 ;
...
V_126 ? L_17 : L_18 ,
V_45 -> V_130
? ( V_45 -> V_130 ( V_45 , V_3 ) ? L_19 : L_20 )
: L_21 ,
( V_14 < 0 ) ? L_22 : V_127 [ V_14 ] ,
V_19 ? L_23 : L_24 ) ;
if ( V_125 && ! V_126 ) {
int V_47 = F_72 ( V_44 ) ;
struct V_111 * V_112 = F_73 ( V_47 ) ;
...
static void F_74 ( struct V_123 * V_124 , struct V_121 * V_45 )
{
unsigned V_60 ;
unsigned V_44 = V_45 -> V_46 ;
for ( V_60 = 0 ; V_60 < V_45 -> V_133 ; V_60 ++ , V_44 ++ ) {
F_69 ( V_124 , NULL , V_45 , V_60 , V_44 ) ;
F_71 ( V_124 , L_31 ) ;
}
}
static inline void F_69 ( struct V_123 * V_124 ,
struct V_80 * V_81 ,
struct V_121 * V_45 ,
unsigned V_3 , unsigned V_44 )
{
...
static int F_80 ( struct V_135 * V_50 , unsigned int V_47 ,
T_6 V_85 )
{
struct V_1 * V_2 = V_50 -> V_136 ;
if ( ! V_2 )
return - V_84 ;
F_81 ( V_47 , & V_137 , V_138 ) ;
F_82 ( V_47 , V_139 ) ;
F_83 ( V_47 , V_2 ) ;
F_84 ( V_47 , V_110 ) ;
return 0 ;
}
static int F_85 ( struct V_140 * V_53 )
{
...
if ( V_145 ) {
V_142 = F_86 ( & V_53 -> V_53 , sizeof( * V_142 ) , V_153 ) ;
if ( ! V_142 )
return - V_154 ;
if ( F_87 ( V_145 , L_33 , NULL ) )
V_142 -> V_155 = true ;
if ( F_88 ( V_145 , L_34 , & V_53 -> V_156 ) ) {
F_20 ( & V_53 -> V_53 , L_35 ) ;
return - V_84 ;
}
...
return - V_84 ;
V_148 = F_90 ( V_53 , V_159 , 0 ) ;
V_46 = F_91 ( & V_53 -> V_53 , V_148 ) ;
if ( F_92 ( V_46 ) )
return F_93 ( V_46 ) ;
V_79 = F_94 ( & V_53 -> V_53 , NULL ) ;
if ( F_92 ( V_79 ) )
return F_93 ( V_79 ) ;
F_95 ( V_79 ) ;
V_2 = F_86 ( & V_53 -> V_53 , sizeof( * V_2 ) , V_153 ) ;
if ( ! V_2 )
return - V_154 ;
...
V_45 -> V_125 = V_142 -> V_161 ? : F_97 ( & V_53 -> V_53 ) ;
V_45 -> V_53 = & V_53 -> V_53 ;
V_45 -> V_162 = V_163 ;
F_23 ( V_2 -> V_79 ) ;
V_2 -> V_28 = F_98 ( V_2 -> V_8 + V_30 ) ;
F_25 ( V_2 -> V_79 ) ;
#ifdef F_99
V_45 -> V_146 = V_145 ;
#endif
V_151 = F_100 ( & V_2 -> V_45 ) ;
if ( V_151 )
return V_151 ;
F_101 ( V_2 -> V_118 >= F_102 ( V_77 ) ) ;
V_77 [ V_2 -> V_118 ] = V_2 ;
F_103 ( V_53 , V_2 ) ;
if ( ! V_145 )
V_150 = V_142 -> V_164 ;
V_2 -> V_48 = F_104 ( V_145 ,
V_83 , V_150 ,
& V_165 , V_2 ) ;
if ( ! V_2 -> V_48 ) {
F_20 ( & V_53 -> V_53 , L_36 ) ;
V_151 = F_105 ( & V_2 -> V_45 ) ;
return - V_166 ;
}
F_55 ( V_2 ) ;
F_106 ( & V_53 -> V_53 , L_37 , V_2 -> V_8 ) ;
return 0 ;
}
static int F_107 ( struct V_80 * V_81 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_167 ;
}
static const char * F_108 ( struct V_80 * V_81 ,
unsigned V_168 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_169 [ V_168 ] . V_161 ;
}
static int F_109 ( struct V_80 * V_81 , unsigned V_168 ,
...
static struct V_173 *
F_110 ( struct V_80 * V_81 , unsigned V_3 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
int V_60 ;
...
static void F_111 ( struct V_80 * V_81 , struct V_123 * V_124 ,
unsigned V_3 )
{
struct V_173 * V_175 ;
struct V_121 * V_45 ;
V_175 = F_110 ( V_81 , V_3 ) ;
if ( ! V_175 || ! V_175 -> V_178 ) {
F_71 ( V_124 , L_38 ) ;
return;
}
V_45 = V_175 -> V_178 ;
F_69 ( V_124 , V_81 , V_45 , V_3 - V_45 -> V_46 , V_3 ) ;
}
static void F_112 ( struct V_80 * V_81 ,
struct V_179 * V_180 , unsigned V_181 )
{
int V_60 ;
for ( V_60 = 0 ; V_60 < V_181 ; V_60 ++ )
if ( V_180 [ V_60 ] . type == V_182 )
F_113 ( V_180 [ V_60 ] . V_183 . V_184 . V_184 ) ;
F_113 ( V_180 ) ;
}
static int F_114 ( struct V_179 * * V_180 , unsigned * V_185 ,
...
if ( V_187 >= V_188 )
return 0 ;
V_189 = F_115 ( * V_180 , sizeof( * V_189 ) * V_188 , V_153 ) ;
if ( ! V_189 )
return - V_154 ;
...
if ( * V_181 == * V_185 )
return - V_192 ;
V_196 = F_118 ( V_184 , V_195 * sizeof( * V_196 ) ,
V_153 ) ;
if ( ! V_196 )
return - V_154 ;
...
static int F_119 ( int V_198 , int V_32 , unsigned long * V_199 )
{
int V_151 = 0 ;
...
static const char * F_120 ( struct V_80 * V_81 , const char * V_203 )
{
int V_60 , V_204 ;
struct V_57 * V_58 = F_27 ( V_81 ) ;
if ( sscanf ( ( char * ) V_203 , L_39 , & V_204 ) == 1 )
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_172 ; V_60 ++ )
if ( V_58 -> V_67 -> V_170 [ V_60 ] . V_205 == V_204 )
return V_58 -> V_67 -> V_170 [ V_60 ] . V_161 ;
return NULL ;
}
static bool F_121 ( struct V_144 * V_145 ,
unsigned long * V_184 )
{
bool V_206 = 0 ;
unsigned long V_207 = 0 ;
int V_60 , V_32 , V_151 ;
for ( V_60 = 0 ; V_60 < F_102 ( V_200 ) ; V_60 ++ ) {
V_151 = F_88 ( V_145 ,
V_200 [ V_60 ] . V_208 , & V_32 ) ;
if ( V_151 != - V_84 ) {
if ( F_119 ( V_60 , V_32 , & V_207 ) == 0 ) {
* V_184 |= V_207 ;
V_206 = 1 ;
}
}
...
static int F_122 ( struct V_80 * V_81 ,
struct V_144 * V_145 ,
struct V_179 * * V_180 ,
unsigned * V_185 ,
unsigned * V_181 )
...
struct V_144 * V_211 ;
V_151 = F_123 ( V_145 , L_40 , & V_191 ) ;
if ( V_151 >= 0 )
V_186 = 1 ;
V_206 = F_121 ( V_145 , & V_184 ) ;
V_211 = F_124 ( V_145 , L_41 , 0 ) ;
if ( V_211 )
V_206 |= F_121 ( V_211 , & V_184 ) ;
V_151 = F_125 ( V_145 , L_42 ) ;
if ( V_151 < 0 )
goto exit;
if ( V_206 )
V_186 ++ ;
V_186 *= V_151 ;
V_151 = F_114 ( V_180 , V_185 , V_181 , V_186 ) ;
if ( V_151 < 0 )
goto exit;
F_126 (np, L_42 , prop, group) {
if ( V_191 ) {
V_151 = F_116 ( V_180 , V_185 , V_181 ,
V_190 , V_191 ) ;
if ( V_151 < 0 )
goto exit;
}
if ( V_206 ) {
V_210 = F_120 ( V_81 , V_190 ) ;
V_151 = F_117 ( V_180 , V_185 , V_181 ,
V_210 , & V_184 , 1 ) ;
if ( V_151 < 0 )
goto exit;
}
...
* V_181 = 0 ;
F_128 (np_config, np) {
V_151 = F_122 ( V_81 , V_145 , V_180 ,
& V_185 , V_181 ) ;
if ( V_151 < 0 ) {
F_112 ( V_81 , * V_180 , * V_181 ) ;
return V_151 ;
}
}
return 0 ;
...
static const char * F_130 ( struct V_80 * V_81 ,
unsigned V_191 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
...
static int F_132 ( struct V_80 * V_81 , unsigned V_191 ,
unsigned V_190 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
...
if ( V_216 -> V_217 < 0 )
return - V_84 ;
F_17 ( V_58 -> V_53 , L_43 , V_216 -> V_161 , V_216 -> V_172 ) ;
...
struct V_121 * V_45 ;
unsigned V_5 ;
V_175 = F_110 ( V_81 , V_216 -> V_170 [ V_60 ] ) ;
if ( ! V_175 ) {
F_20 ( V_58 -> V_53 ,
L_44 ,
...
V_45 = V_175 -> V_178 ;
V_2 = F_63 ( V_45 , struct V_1 , V_45 ) ;
F_17 ( V_58 -> V_53 , L_46 , V_216 -> V_170 [ V_60 ] , V_216 -> V_217 ) ;
F_23 ( V_2 -> V_79 ) ;
...
if ( V_216 -> V_217 < 0 )
return;
F_17 ( V_58 -> V_53 , L_47 , V_216 -> V_161 , V_216 -> V_172 ) ;
}
static int F_134 ( struct V_80 * V_81 ,
struct V_173 * V_175 ,
unsigned V_3 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
...
static int F_136 ( struct V_80 * V_81 , unsigned V_70 ,
unsigned long * V_199 )
{
return - V_84 ;
}
static int F_137 ( struct V_80 * V_81 , unsigned V_70 ,
unsigned long * V_184 , unsigned V_195 )
{
...
V_175 = F_110 ( V_81 , V_70 ) ;
if ( ! V_175 ) {
F_20 ( V_58 -> V_53 , L_57 , V_70 ) ;
return - V_84 ;
}
if ( ! V_175 -> V_178 ) {
F_20 ( V_58 -> V_53 , L_58 ,
...
V_225 = F_144 ( V_207 ) ;
if ( V_225 ) {
int V_226 = F_145 ( V_207 ) ;
int V_227 = F_146 ( V_207 ) ;
int V_228 = F_147 ( V_207 ) ;
V_224 = true ;
if ( V_226 )
V_19 = V_226 - 1 ;
if ( V_227 )
...
L_59 ,
V_70 ,
V_226 ? V_220 [ V_19 ] : L_60 ,
V_227 ? ( V_223 ? L_61 : L_62 )
: L_60 ,
V_228 ? ( V_32 ? L_63 : L_64 ) : L_60 ) ;
}
F_17 ( V_2 -> V_45 . V_53 ,
L_65 ,
V_70 , V_207 , V_220 [ V_19 ] , V_221 [ V_15 ] ,
V_223 ? L_66 : L_62 ,
V_223 ? ( V_32 ? L_63 : L_64 ) : L_30 ,
V_28 ? L_67 : L_68 ) ;
F_23 ( V_2 -> V_79 ) ;
V_5 = V_70 % V_83 ;
if ( V_224 )
...
static int F_148 ( struct V_140 * V_229 , T_8 V_230 )
{
struct V_57 * V_58 ;
V_58 = F_149 ( V_229 ) ;
if ( ! V_58 )
return - V_84 ;
return F_150 ( V_58 -> V_231 ) ;
}
static int F_151 ( struct V_140 * V_229 )
{
struct V_57 * V_58 ;
V_58 = F_149 ( V_229 ) ;
if ( ! V_58 )
...
{
const struct V_232 * V_233 = F_154 ( V_229 ) ;
...
int V_60 ;
V_58 = F_86 ( & V_229 -> V_53 , sizeof( * V_58 ) , V_153 ) ;
if ( ! V_58 )
return - V_154 ;
if ( V_233 )
V_235 = V_233 -> V_236 ;
...
F_158 ( & V_58 -> V_67 ) ;
if ( V_145 ) {
V_234 = F_124 ( V_145 , L_69 , 0 ) ;
if ( V_234 )
V_58 -> V_65 = F_159 ( V_234 , 0 ) ;
}
V_148 = F_90 ( V_229 , V_159 , 0 ) ;
if ( V_148 )
V_58 -> V_65 = F_160 ( & V_229 -> V_53 , V_148 -> V_243 ,
F_161 ( V_148 ) ) ;
if ( ! V_58 -> V_65 ) {
if ( V_235 == V_240 ) {
F_106 ( & V_229 -> V_53 ,
...
F_20 ( & V_229 -> V_53 , L_72 ) ;
return - V_84 ;
}
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_174 ; V_60 ++ ) {
if ( ! V_77 [ V_58 -> V_67 -> V_176 [ V_60 ] . V_156 ] ) {
F_21 ( & V_229 -> V_53 , L_73 , V_60 ) ;
return - V_244 ;
}
...
V_58 -> V_231 = F_162 ( & V_245 , & V_229 -> V_53 , V_58 ) ;
if ( ! V_58 -> V_231 ) {
F_20 ( & V_229 -> V_53 , L_74 ) ;
return - V_84 ;
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_174 ; V_60 ++ )
F_163 ( V_58 -> V_231 , & V_58 -> V_67 -> V_176 [ V_60 ] ) ;
F_103 ( V_229 , V_58 ) ;
F_106 ( & V_229 -> V_53 , L_75 ) ;
return 0 ;
}
