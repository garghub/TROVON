...
V_35 -> V_50 = F_82 ( sizeof( * V_35 -> V_50 ) *
( V_44 -> V_47 + 1 ) , V_115 ) ;
if ( ! V_35 -> V_50 ) {
V_87 = - V_114 ;
goto V_136;
...
V_33 -> V_141 . V_142 = 0 ;
for ( V_45 = 0 ; V_45 < V_44 -> V_47 ; V_45 ++ ) {
if ( ( V_44 -> V_48 [ V_45 ] . V_142 * 1000 ) >
V_33 -> V_141 . V_142 )
V_33 -> V_141 . V_142 =
V_44 -> V_48 [ V_45 ] . V_142 * 1000 ;
}
if ( V_44 -> V_74 . V_137 == V_140 &&
V_33 -> V_141 . V_142 > 20 * 1000 ) {
V_33 -> V_141 . V_142 = 20 * 1000 ;
F_83 ( V_123
L_26 ) ;
}
...
if ( V_87 )
goto V_143;
if ( V_44 -> V_48 [ 0 ] . V_95 * 1000 != V_33 -> V_141 . V_144 )
F_68 (KERN_WARNING FW_WARN L_27 ) ;
switch ( V_44 -> V_74 . V_137 ) {
case V_139 :
V_33 -> V_145 = F_54 ( V_35 , V_33 -> V_1 ) ;
break;
case V_140 :
V_128 . V_146 = F_45 ;
V_33 -> V_145 = F_45 ( V_1 ) ;
...
( T_1 ) V_44 -> V_48 [ V_45 ] . V_148 ,
( T_1 ) V_44 -> V_48 [ V_45 ] . V_142 ) ;
F_86 ( V_35 -> V_50 , V_33 -> V_1 ) ;
V_35 -> V_79 = 1 ;
return V_87 ;
V_143:
F_87 ( V_35 -> V_50 ) ;
...
struct V_156 * * V_157 ;
F_12 ( L_35 ) ;
for ( V_157 = V_158 ; * V_157 != NULL ; V_157 ++ )
;
if ( V_157 [ 1 ] == NULL )
* V_157 = & V_159 ;
}
