...
return - V_114 ;
V_110 = F_74 ( V_109 ) ;
if ( ! F_75 ( & V_105 -> V_56 , V_109 -> V_115 , V_110 , V_107 ) )
return - V_116 ;
V_2 -> V_4 = F_76 ( & V_105 -> V_56 , V_109 -> V_115 , V_110 ) ;
if ( ! V_2 -> V_4 )
return - V_116 ;
F_77 ( & V_2 -> V_8 ) ;
V_2 -> V_30 = V_110 < V_117 ;
if ( V_2 -> V_30 ) {
V_2 -> V_118 = F_5 ;
V_2 -> V_119 = F_9 ;
} else {
...
F_21 ( V_2 ) ;
if ( F_11 ( V_2 , V_120 ) != V_121 )
return - V_122 ;
V_87 = F_78 ( V_105 , 0 ) ;
if ( V_87 < 0 )
return V_87 ;
V_111 = F_79 ( V_87 , F_52 ,
V_123 , V_107 , V_24 ) ;
if ( V_111 < 0 )
return V_111 ;
V_2 -> V_87 = V_87 ;
V_2 -> V_58 = V_6 ? V_6 -> V_58 : - V_124 ;
if ( F_31 ( V_2 -> V_58 ) ) {
char * V_125 = F_80 ( & V_105 -> V_56 , 16 , V_126 ) ;
if ( ! V_125 )
return - V_83 ;
snprintf ( V_125 , 16 , L_7 , V_107 ) ;
V_2 -> V_127 = F_81 ( V_2 -> V_58 ) ;
if ( F_82 ( V_2 -> V_127 , F_55 ,
V_128 | V_129 ,
V_125 , V_2 -> V_24 ) < 0 )
V_2 -> V_58 = - V_124 ;
}
F_83 ( V_24 , L_8 , ( V_130 ) V_109 -> V_115 , V_87 ) ;
return 0 ;
}
...
struct V_23 * V_24 ;
int V_131 ;
V_24 = F_85 ( sizeof( * V_2 ) ) ;
if ( ! V_24 )
return - V_83 ;
F_86 ( V_24 , & V_105 -> V_56 ) ;
F_87 ( V_105 , V_24 ) ;
V_2 = F_30 ( V_24 ) ;
V_2 -> V_24 = V_24 ;
F_88 ( V_24 ) ;
...
static int F_95 ( struct V_142 * V_56 )
{
...
static int F_98 ( struct V_142 * V_56 )
{
struct V_104 * V_105 = F_96 ( V_56 ) ;
struct V_23 * V_24 = F_70 ( V_105 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
