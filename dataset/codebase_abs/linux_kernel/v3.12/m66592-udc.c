...
static int F_98 ( struct V_274 * V_275 ,
struct V_276 * V_21 )
{
struct V_1 * V_1 = F_99 ( V_275 ) ;
V_21 -> V_21 . V_277 = NULL ;
V_1 -> V_21 = V_21 ;
...
static int F_100 ( struct V_274 * V_275 ,
struct V_276 * V_21 )
{
struct V_1 * V_1 = F_99 ( V_275 ) ;
...
static int F_101 ( struct V_274 * V_281 )
{
struct V_1 * V_1 = F_102 ( V_281 ) ;
return F_2 ( V_1 , V_282 ) & 0x03FF ;
}
static int F_103 ( struct V_274 * V_18 , int V_283 )
{
struct V_1 * V_1 = F_102 ( V_18 ) ;
unsigned long V_262 ;
F_85 ( & V_1 -> V_17 , V_262 ) ;
if ( V_283 )
F_5 ( V_1 , V_15 , V_16 ) ;
...
static int T_5 F_104 ( struct V_284 * V_285 )
{
struct V_1 * V_1 = F_105 ( V_285 ) ;
F_106 ( & V_1 -> V_18 ) ;
F_107 ( & V_1 -> V_257 ) ;
F_108 ( V_1 -> V_5 ) ;
F_109 ( F_110 ( V_285 , 0 ) , V_1 ) ;
...
static void F_113 ( struct V_263 * V_23 , struct V_266 * V_287 )
{
}
static int T_6 F_114 ( struct V_284 * V_285 )
{
...
int V_33 = 0 ;
int V_178 ;
V_289 = F_115 ( V_285 , V_292 , 0 ) ;
if ( ! V_289 ) {
V_33 = - V_112 ;
F_16 ( L_19 ) ;
goto V_293;
}
V_290 = F_115 ( V_285 , V_294 , 0 ) ;
if ( ! V_290 ) {
V_33 = - V_112 ;
F_116 ( & V_285 -> V_295 ,
L_20 ) ;
...
V_5 = F_117 ( V_289 -> V_296 , F_118 ( V_289 ) ) ;
if ( V_5 == NULL ) {
V_33 = - V_75 ;
F_16 ( L_21 ) ;
goto V_293;
}
if ( F_119 ( & V_285 -> V_295 ) == NULL ) {
F_116 ( & V_285 -> V_295 , L_22 ) ;
V_33 = - V_112 ;
goto V_293;
}
...
V_1 -> V_51 = F_119 ( & V_285 -> V_295 ) ;
V_1 -> V_160 = V_290 -> V_262 & V_297 ;
F_120 ( & V_1 -> V_17 ) ;
F_121 ( V_285 , V_1 ) ;
V_1 -> V_18 . V_298 = & V_299 ;
V_1 -> V_18 . V_300 = V_222 ;
V_1 -> V_18 . V_301 = V_302 ;
F_122 ( & V_1 -> V_257 ) ;
V_1 -> V_257 . V_303 = F_84 ;
V_1 -> V_257 . V_304 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
V_33 = F_123 ( V_290 -> V_296 , F_81 , V_305 ,
V_302 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_24 , V_33 ) ;
goto V_293;
...
if ( V_1 -> V_51 -> V_52 ) {
snprintf ( V_291 , sizeof( V_291 ) , L_25 , V_285 -> V_306 ) ;
V_1 -> V_286 = F_124 ( & V_285 -> V_295 , V_291 ) ;
if ( F_125 ( V_1 -> V_286 ) ) {
F_116 ( & V_285 -> V_295 , L_26 ,
V_291 ) ;
V_33 = F_126 ( V_1 -> V_286 ) ;
goto V_307;
}
F_127 ( V_1 -> V_286 ) ;
}
...
F_13 ( & V_1 -> V_18 . V_206 -> V_308 ) ;
for ( V_178 = 0 ; V_178 < V_29 ; V_178 ++ ) {
struct V_45 * V_23 = & V_1 -> V_23 [ V_178 ] ;
if ( V_178 != 0 ) {
F_13 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_308 ) ;
F_94 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_308 ,
& V_1 -> V_18 . V_308 ) ;
}
V_23 -> V_1 = V_1 ;
F_13 ( & V_23 -> V_24 ) ;
V_23 -> V_23 . V_301 = V_309 [ V_178 ] ;
V_23 -> V_23 . V_298 = & V_310 ;
V_23 -> V_23 . V_76 = 512 ;
}
...
F_56 ( V_1 ) ;
V_33 = F_128 ( & V_285 -> V_295 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_312;
F_129 ( & V_285 -> V_295 , L_27 , V_313 ) ;
return 0 ;
V_312:
F_92 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_205 ) ;
V_311:
