...
T_8 int F_101 ( struct V_5 T_9 * V_147 )
{
struct V_5 args ;
unsigned long V_1 ;
char * V_52 , * V_148 = NULL ;
int V_9 ;
int V_62 ;
if ( ! F_102 ( V_149 ) )
return - V_150 ;
if ( F_103 ( & args , V_147 , 3 * sizeof( T_3 ) ) != 0 )
return - V_65 ;
V_9 = args . V_9 ;
if ( V_9 > F_104 ( args . args )
|| args . V_10 > F_104 ( args . args )
|| V_9 + args . V_10 > F_104 ( args . args ) )
return - V_64 ;
if ( F_103 ( args . args , V_147 -> args ,
V_9 * sizeof( V_151 ) ) != 0 )
return - V_65 ;
if ( args . V_8 == V_33 )
return - V_64 ;
args . V_11 = & args . args [ V_9 ] ;
memset ( args . V_11 , 0 , args . V_10 * sizeof( V_151 ) ) ;
if ( args . V_8 == V_152 ) {
V_62 = F_90 ( & args ) ;
if ( V_62 )
return V_62 ;
...
V_153:
if ( F_106 ( V_147 -> args + V_9 ,
args . args + V_9 ,
args . V_10 * sizeof( V_151 ) ) != 0 )
return - V_65 ;
return 0 ;
}
void T_1 F_107 ( void )
...
return;
#ifdef F_109
if ( F_110 ( V_160 ) && F_111 ( V_161 ) ) {
V_154 = F_112 ( V_162 , V_155 ) ;
V_152 = F_28 ( L_29 ) ;
}
#endif
V_163 = F_113 ( V_164 , V_165 , V_154 ) ;
#ifdef F_114
V_45 = F_28 ( L_39 ) ;
#endif
}
int T_1 F_115 ( unsigned long V_166 ,
const char * V_167 , int V_168 , void * V_94 )
{
T_3 * V_156 , * V_157 , * V_158 ;
if ( V_168 != 1 || strcmp ( V_167 , L_35 ) != 0 )
return 0 ;
V_156 = F_116 ( V_166 , L_36 , NULL ) ;
V_157 = F_116 ( V_166 , L_38 , NULL ) ;
V_158 = F_116 ( V_166 , L_37 , NULL ) ;
...
#ifdef F_117
V_156 = F_116 ( V_166 , L_40 , NULL ) ;
if ( V_156 )
V_16 = * V_156 ;
V_156 = F_116 ( V_166 , L_41 , NULL ) ;
if ( V_156 )
V_17 = * V_156 ;
if ( V_16 != V_33 &&
V_17 != V_33 )
...
F_122 () ;
F_120 ( & V_169 ) ;
F_124 ( V_170 >> 32 , V_170 & 0xffffffff ) ;
V_170 = 0 ;
F_6 ( & V_169 ) ;
}
