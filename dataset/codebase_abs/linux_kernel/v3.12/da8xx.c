...
static int F_35 ( struct V_10 * V_10 , T_3 V_75 )
{
T_1 V_1 = F_2 ( V_2 ) ;
V_1 &= ~ V_76 ;
switch ( V_75 ) {
...
{
struct V_95 V_96 [ 2 ] ;
struct V_97 * V_98 = F_48 ( & V_94 -> V_99 ) ;
struct V_93 * V_10 ;
struct V_100 * V_101 ;
struct V_102 * V_102 ;
int V_59 = - V_103 ;
V_101 = F_49 ( sizeof( * V_101 ) , V_104 ) ;
if ( ! V_101 ) {
F_50 ( & V_94 -> V_99 , L_17 ) ;
goto V_105;
}
V_10 = F_51 ( L_18 , V_106 ) ;
if ( ! V_10 ) {
F_50 ( & V_94 -> V_99 , L_19 ) ;
goto V_107;
}
V_102 = F_52 ( & V_94 -> V_99 , L_20 ) ;
if ( F_53 ( V_102 ) ) {
F_50 ( & V_94 -> V_99 , L_21 ) ;
V_59 = F_54 ( V_102 ) ;
goto V_108;
...
V_10 -> V_99 . V_110 = & V_94 -> V_99 ;
V_10 -> V_99 . V_111 = & V_112 ;
V_10 -> V_99 . V_113 = V_112 ;
V_101 -> V_99 = & V_94 -> V_99 ;
V_101 -> V_10 = V_10 ;
V_101 -> V_102 = V_102 ;
V_98 -> V_114 = & V_115 ;
F_56 ( V_94 , V_101 ) ;
...
F_57 ( V_96 ) ) ;
V_96 [ 0 ] . V_116 = V_94 -> V_95 [ 0 ] . V_116 ;
V_96 [ 0 ] . V_117 = V_94 -> V_95 [ 0 ] . V_117 ;
V_96 [ 0 ] . V_118 = V_94 -> V_95 [ 0 ] . V_118 ;
V_96 [ 0 ] . V_33 = V_94 -> V_95 [ 0 ] . V_33 ;
V_96 [ 1 ] . V_116 = V_94 -> V_95 [ 1 ] . V_116 ;
V_96 [ 1 ] . V_117 = V_94 -> V_95 [ 1 ] . V_117 ;
V_96 [ 1 ] . V_118 = V_94 -> V_95 [ 1 ] . V_118 ;
V_96 [ 1 ] . V_33 = V_94 -> V_95 [ 1 ] . V_33 ;
V_59 = F_58 ( V_10 , V_96 ,
F_57 ( V_96 ) ) ;
if ( V_59 ) {
F_50 ( & V_94 -> V_99 , L_23 ) ;
...
V_59 = F_59 ( V_10 , V_98 , sizeof( * V_98 ) ) ;
if ( V_59 ) {
F_50 ( & V_94 -> V_99 , L_24 ) ;
goto V_119;
}
