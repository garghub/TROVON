...
F_21 ( V_80 -> V_2 , L_31 ) ;
V_75 -> V_80 = V_80 ;
V_80 -> V_242 = V_75 -> V_77 ;
V_76 = F_49 ( V_80 , 8 , 8 , V_243 ) ;
if ( V_76 != 0 ) {
...
if ( ( V_76 >= V_247 ) && ( V_76 <= V_247 + 0x0f ) ) {
V_75 -> V_112 = V_248 ;
F_24 ( V_80 -> V_2 , L_34 , V_76 ) ;
} else if ( ( V_76 >= V_249 ) && ( V_76 <= V_249 + 0x0f ) ) {
V_75 -> V_112 = V_113 ;
...
static int F_54 ( struct V_261 * V_262 ,
const struct V_263 * V_264 )
{
struct V_74 * V_75 ;
int V_76 ;
F_55 ( L_40 ) ;
V_75 = F_56 ( & V_262 -> V_2 , sizeof( struct V_74 ) ,
V_265 ) ;
if ( V_75 == NULL )
return - V_266 ;
V_75 -> V_112 = V_264 -> V_267 ;
F_57 ( V_262 , V_75 ) ;
V_75 -> V_242 = V_262 ;
V_75 -> V_241 = V_262 -> V_2 . V_268 ;
V_75 -> V_225 = V_262 -> V_225 ;
V_75 -> V_77 = F_58 ( V_262 , & V_269 ) ;
if ( F_59 ( V_75 -> V_77 ) ) {
V_76 = F_60 ( V_75 -> V_77 ) ;
F_5 ( & V_262 -> V_2 , L_41 , V_76 ) ;
goto V_270;
}
V_76 = F_61 ( & V_262 -> V_2 ,
& V_271 , V_272 ,
...
static int F_62 ( struct V_261 * V_273 )
{
F_63 ( & V_273 -> V_2 ) ;
return 0 ;
}
