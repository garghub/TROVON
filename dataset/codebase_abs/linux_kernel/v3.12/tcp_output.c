...
V_296 = F_19 ( V_4 -> V_197 , V_2 -> V_320 >> 10 ) ;
...
F_55 ( V_2 , V_237 , V_291 , 1 , V_2 -> V_339 ) ;
}
...
int V_341 = F_191 ( V_2 ) ;
int V_342 = F_28 ( int , V_8 -> V_45 , F_192 ( V_2 ) ) ;
int V_222 ;
if ( V_18 > V_342 )
V_18 = V_342 ;
if ( V_341 < ( V_342 >> 1 ) ) {
...
if ( V_222 <= V_341 - V_18 || V_222 > V_341 )
V_222 = ( V_341 / V_18 ) * V_18 ;
else if ( V_18 == V_342 &&
V_341 > V_222 + ( V_342 >> 1 ) )
V_222 = V_341 ;
}
...
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_3 * V_345 = F_195 ( V_2 , V_4 ) ;
int V_346 , V_347 ;
V_346 = V_4 -> V_74 ;
V_347 = V_345 -> V_74 ;
...
F_196 ( V_2 , V_345 , V_4 ) ;
F_174 ( V_345 , V_2 ) ;
F_197 ( V_345 , F_128 ( V_4 , V_347 ) ,
V_347 ) ;
if ( V_345 -> V_82 == V_83 )
V_4 -> V_82 = V_83 ;
if ( V_4 -> V_82 != V_83 )
V_4 -> V_84 = F_198 ( V_4 -> V_84 , V_345 -> V_84 , V_346 ) ;
...
static void F_201 ( struct V_1 * V_2 , struct V_3 * V_350 ,
int V_49 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
...
if ( F_178 ( & V_2 -> V_198 ) >
F_18 ( V_2 -> V_236 + ( V_2 -> V_236 >> 2 ) , V_2 -> V_354 ) )
return - V_355 ;
...
F_205 ( V_4 ) >= 0xFFFF ) ) {
struct V_3 * V_306 = F_206 ( V_4 , V_360 ,
V_174 ) ;
...
if ( V_370 == NULL && ! ( V_85 & ( V_244 | V_243 ) ) )
V_370 = V_4 ;
continue;
} else {
V_371 = F_5 ( V_4 ) -> V_12 ;
...
F_187 ( V_2 , V_237 , V_334 ) ;
}
void F_218 ( struct V_1 * V_2 , T_11 V_380 )
{
struct V_3 * V_4 ;
V_4 = F_219 ( V_360 , V_380 ) ;
if ( ! V_4 ) {
F_220 ( F_35 ( V_2 ) , V_381 ) ;
return;
}
F_217 ( V_4 , V_360 ) ;
F_43 ( V_4 , F_8 ( V_2 ) ,
...
if ( F_93 ( V_4 ) ) {
struct V_3 * V_306 = F_223 ( V_4 , V_174 ) ;
if ( V_306 == NULL )
return - V_255 ;
F_174 ( V_4 , V_2 ) ;
F_110 ( V_306 ) ;
...
int V_204 ;
int V_18 ;
V_4 = F_226 ( V_2 , V_360 + 15 , 1 , V_174 ) ;
if ( F_46 ( ! V_4 ) ) {
F_227 ( V_17 ) ;
return NULL ;
}
...
V_70 -> V_393 = 1 ;
F_36 ( V_68 , V_70 ) ;
V_70 -> V_216 = V_159 -> V_394 ;
V_70 -> V_218 = V_159 -> V_395 ;
...
static int F_239 ( struct V_1 * V_2 , struct V_3 * V_392 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
...
F_240 ( V_2 , & V_8 -> V_56 . V_269 , & V_406 -> V_155 ,
& V_407 , & V_411 ) ;
if ( V_407 > 1 &&
F_241 ( V_302 , V_411 + ( 60 * V_412 << V_407 ) ) ) {
V_406 -> V_155 . V_74 = - 1 ;
goto V_413;
}
if ( V_414 & V_415 )
...
goto V_413;
if ( V_8 -> V_56 . V_386 && V_8 -> V_56 . V_386 < V_8 -> V_56 . V_269 )
V_8 -> V_56 . V_269 = V_8 -> V_56 . V_386 ;
V_49 = F_143 ( V_2 , F_2 ( V_2 ) -> V_279 ) -
V_138 ;
V_410 = F_242 ( V_392 , F_205 ( V_392 ) , V_49 ,
V_2 -> V_339 ) ;
if ( V_410 == NULL )
goto V_413;
...
V_250 = F_215 ( V_360 + 15 , V_2 -> V_339 ) ;
if ( F_46 ( V_250 == NULL ) )
return - V_212 ;
F_217 ( V_250 , V_360 ) ;
F_43 ( V_250 , V_8 -> V_235 ++ , V_88 ) ;
V_8 -> V_366 = F_5 ( V_250 ) -> V_147 = V_22 ;
F_237 ( V_2 , V_250 ) ;
F_34 ( V_2 , V_250 ) ;
V_205 = V_8 -> V_141 ? F_239 ( V_2 , V_250 ) :
F_89 ( V_2 , V_250 , 1 , V_2 -> V_339 ) ;
if ( V_205 == - V_425 )
return V_205 ;
V_8 -> V_11 = V_8 -> V_235 ;
V_8 -> V_426 = V_8 -> V_235 ;
F_208 ( F_35 ( V_2 ) , V_427 ) ;
F_184 ( V_2 , V_328 ,
F_2 ( V_2 ) -> V_29 , V_332 ) ;
return 0 ;
}
...
if ( V_6 -> V_34 . V_433 ||
F_248 ( V_6 -> V_34 . V_322 , V_302 + ( V_36 >> 2 ) ) ) {
F_249 ( V_2 ) ;
return;
}
if ( ! F_241 ( V_322 , V_6 -> V_34 . V_322 ) )
V_322 = V_6 -> V_34 . V_322 ;
}
V_6 -> V_34 . V_430 |= V_434 | V_432 ;
V_6 -> V_34 . V_322 = V_322 ;
F_250 ( V_2 , & V_6 -> V_435 , V_322 ) ;
}
...
if ( V_2 -> V_168 == V_338 )
return;
V_250 = F_219 ( V_360 , F_188 ( V_2 , V_174 ) ) ;
if ( V_250 == NULL ) {
F_251 ( V_2 ) ;
...
static int F_252 ( struct V_1 * V_2 , int V_437 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_3 * V_4 ;
V_4 = F_219 ( V_360 , F_188 ( V_2 , V_174 ) ) ;
if ( V_4 == NULL )
return - 1 ;
F_217 ( V_4 , V_360 ) ;
F_43 ( V_4 , V_8 -> V_90 - ! V_437 , V_230 ) ;
F_5 ( V_4 ) -> V_147 = V_22 ;
...
if ( F_255 ( V_8 -> V_91 , V_8 -> V_90 + 1 , V_8 -> V_90 + 0xFFFF ) )
F_252 ( V_2 , 1 ) ;
return F_252 ( V_2 , 0 ) ;
}
}
