...
static int F_65 ( int V_13 , struct V_129 * V_130 )
{
struct V_15 * V_16 ;
int V_18 ;
V_18 = F_51 ( V_13 , & V_16 ) ;
...
static int F_69 ( struct V_129 * V_100 ,
unsigned int V_13 )
{
if ( ! V_131 [ V_13 ] )
return 0 ;
...
static int F_71 ( struct V_129 * V_100 ,
unsigned int V_13 )
{
int V_18 ;
...
static int F_74 ( struct V_129 * V_130 , unsigned int V_13 )
{
F_67 ( F_75 ( V_130 ) ) ;
return 0 ;
}
static int F_76 ( struct V_96 * V_138 ,
...
static void F_78 ( struct V_96 * V_138 )
{
F_67 ( F_79 ( V_138 ) ) ;
F_77 ( V_138 , NULL ) ;
}
