...
int V_89 ;
unsigned int V_46 ;
V_12 = F_37 ( V_6 , sizeof( * V_12 ) ) ;
if ( ! V_12 )
return - V_92 ;
V_89 = F_38 ( V_6 , V_91 -> V_93 [ 0 ] , V_94 ) ;
if ( V_89 )
return V_89 ;
V_89 = F_39 ( V_6 , V_6 -> V_41 + V_95 ,
V_96 ) ;
if ( V_89 )
return V_89 ;
V_12 -> V_97 = V_6 -> V_41 + V_95 ;
V_46 = V_91 -> V_93 [ 1 ] ;
if ( F_35 ( V_46 ) >= 0 ) {
...
V_8 -> V_119 = F_24 ;
V_8 = & V_6 -> V_101 [ 3 ] ;
V_89 = F_43 ( V_6 , V_8 , NULL , V_12 -> V_97 ) ;
if ( V_89 )
return V_89 ;
F_14 ( V_122 , V_6 -> V_41 + V_123 ) ;
F_14 ( V_12 -> V_71 , V_6 -> V_41 + V_69 ) ;
if ( V_6 -> V_46 )
