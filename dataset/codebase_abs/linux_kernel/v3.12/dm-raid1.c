...
V_146 -> V_147 . V_88 = NULL ;
if ( V_15 == V_20 ) {
V_146 -> V_148 = F_52 ( V_3 -> V_76 , V_14 ) ;
F_10 ( V_3 , V_14 , V_15 ) ;
return V_149 ;
}
...
F_121 ( V_3 -> V_76 , V_146 -> V_148 ) ;
return error ;
}
if ( error == - V_155 )
goto V_36;
if ( ( error == - V_150 ) && ( V_14 -> V_50 & V_156 ) )
goto V_36;
if ( F_31 ( error ) ) {
if ( ! V_146 -> V_147 . V_88 ) {
F_35 ( L_28 ) ;
...
V_165 [ V_27 ] = F_130 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_165 [ V_27 ] = '\0' ;
F_132 ( L_36 ,
( unsigned long long ) log -> type -> V_83 ( log ) ,
( unsigned long long ) V_3 -> V_78 , V_165 ) ;
V_164 += log -> type -> V_167 ( log , type , V_162 + V_164 , V_163 - V_164 ) ;
break;
case V_168 :
V_164 = log -> type -> V_167 ( log , type , V_162 , V_163 ) ;
F_132 ( L_37 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ )
