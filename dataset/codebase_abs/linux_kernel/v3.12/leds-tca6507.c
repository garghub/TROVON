...
F_44 ( V_37 , V_19 ) ;
for ( V_63 = 0 ; V_63 < V_91 ; V_63 ++ ) {
struct V_56 * V_124 = V_19 -> V_92 + V_63 ;
V_124 -> V_57 = V_19 ;
V_124 -> V_65 = V_63 ;
if ( V_89 -> V_92 . V_92 [ V_63 ] . V_93 && ! V_89 -> V_92 . V_92 [ V_63 ] . V_75 ) {
V_124 -> V_62 . V_93 = V_89 -> V_92 . V_92 [ V_63 ] . V_93 ;
V_124 -> V_62 . V_115
= V_89 -> V_92 . V_92 [ V_63 ] . V_115 ;
V_124 -> V_62 . V_125 = F_20 ;
V_124 -> V_62 . V_126 = F_21 ;
V_124 -> V_28 = - 1 ;
V_74 = F_45 ( & V_37 -> V_38 ,
& V_124 -> V_62 ) ;
if ( V_74 < 0 )
...
F_46 ( & V_19 -> V_92 [ V_63 ] . V_62 ) ;
}
return V_74 ;
}
static int F_47 ( struct V_49 * V_37 )
{
int V_63 ;
struct V_18 * V_19 = F_48 ( V_37 ) ;
struct V_56 * V_109 = V_19 -> V_92 ;
for ( V_63 = 0 ; V_63 < V_91 ; V_63 ++ ) {
if ( V_109 [ V_63 ] . V_62 . V_93 )
F_46 ( & V_109 [ V_63 ] . V_62 ) ;
}
F_26 ( V_19 ) ;
F_49 ( & V_19 -> V_48 ) ;
return 0 ;
