...
struct V_66 * V_81 = V_46 -> V_68 . V_69 . V_70 ;
int V_262 = V_81 -> V_263 ;
F_43 ( V_55 , V_100 , L_38 ,
V_81 -> V_82 ) ;
F_104 ( & V_3 -> V_22 -> V_264 [ V_262 ] ,
& V_46 -> V_68 . V_69 ) ;
if ( F_41 ( V_3 , V_46 , & V_3 -> V_22 -> V_264 [ V_262 ] ) < 0 ) {
F_32 ( V_55 , L_39 ) ;
V_20 = - V_7 ;
goto V_253;
}
...
static void F_105 ( struct V_91 * V_46 ,
unsigned int V_269 ,
unsigned int * V_270 ,
T_5 V_271 )
{
...
V_3 -> V_274 = * V_270 ;
V_272 = F_106 ( V_3 ) ;
F_107 ( V_3 -> V_22 , V_272 ) ;
F_43 ( F_20 ( V_3 -> V_22 ) , V_100 , L_41 ,
V_272 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_75 ) ;
}
static int F_108 ( struct V_91 * V_46 ,
struct V_36 * V_37 ,
struct V_133 * V_134 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
...
F_7 ( V_3 ) ;
V_139 = (struct V_138 * ) V_134 -> V_137 ;
F_110 ( V_3 -> V_88 , V_139 -> V_106 ) ;
V_20 = F_51 ( V_3 , V_37 , V_134 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_75 ) ;
return V_20 ;
}
static void F_111 ( struct V_91 * V_46 ,
struct V_36 * V_37 ,
...
static int F_112 ( struct V_91 * V_46 ,
struct V_36 * V_37 , T_3 V_276 ,
...
V_280 . V_289 = V_278 -> V_290 * 32 ;
V_281 = F_113 ( V_276 , V_3 -> V_291 ) ;
F_43 ( V_55 , V_100 ,
L_44 ,
V_276 , V_281 , V_278 -> V_284 , V_278 -> V_286 ,
V_278 -> V_288 , V_278 -> V_290 ) ;
V_20 = F_114 ( V_3 , V_281 , & V_280 ) ;
if ( V_20 ) {
F_32 ( V_55 , L_45 ) ;
goto V_253;
}
...
static int F_116 ( struct V_91 * V_46 ,
enum V_293 V_294 ,
struct V_36 * V_37 ,
struct V_133 * V_134 ,
struct V_295 * V_296 )
...
switch ( V_294 ) {
case V_303 :
V_20 = F_117 ( V_55 , V_37 , V_134 , V_296 ) ;
if ( V_20 >= 0 ) {
V_296 -> V_304 = V_20 ;
V_296 -> V_98 |= V_305 ;
...
static void F_123 ( struct V_91 * V_46 ,
struct V_36 * V_37 ,
struct V_38 * V_39 ,
T_4 V_255 )
{
...
static T_5 F_127 ( struct V_91 * V_46 ,
struct V_36 * V_37 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
T_5 V_323 ;
F_4 ( & V_3 -> V_75 ) ;
F_7 ( V_3 ) ;
V_323 = F_128 ( V_3 -> V_22 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_75 ) ;
return V_323 ;
}
static void F_129 ( struct V_91 * V_46 ,
struct V_36 * V_37 , T_5 V_323 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
F_4 ( & V_3 -> V_75 ) ;
F_7 ( V_3 ) ;
F_130 ( V_3 -> V_22 , V_323 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_75 ) ;
}
static void F_131 ( struct V_91 * V_46 ,
struct V_36 * V_37 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
F_4 ( & V_3 -> V_75 ) ;
...
static int F_133 ( struct V_91 * V_46 ,
struct V_36 * V_37 ,
enum V_187 V_188 ,
struct V_133 * V_134 ,
T_3 V_189 , T_3 * V_324 , T_1 V_325 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
struct V_138 * V_139 ;
int V_20 = 0 ;
...
static void F_136 ( struct V_91 * V_46 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
F_4 ( & V_3 -> V_75 ) ;
F_65 ( & V_3 -> V_333 ) ;
...
static int F_138 ( struct V_91 * V_46 , T_4 V_334 )
{
return 0 ;
}
static void F_139 ( struct V_91 * V_46 ,
T_1 V_335 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
F_4 ( & V_3 -> V_75 ) ;
...
static int F_140 ( struct V_91 * V_46 ,
struct V_36 * V_37 ,
const struct V_336 * V_52 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
struct V_54 * V_55 = F_20 ( V_3 -> V_22 ) ;
struct V_337 V_338 ;
...
V_338 . V_125 = V_136 -> V_106 ;
V_338 . V_160 = V_339 ;
V_338 . V_52 = F_53 ( V_52 -> V_225 [ V_339 ] . V_340 ) ;
F_36 ( V_341 , & V_338 ) ;
if ( V_20 ) {
F_32 ( V_55 ,
L_53
...
V_338 . V_160 = V_342 ;
V_338 . V_52 = F_53 ( V_52 -> V_225 [ V_342 ] . V_340 ) ;
F_36 ( V_341 , & V_338 ) ;
if ( V_20 ) {
F_32 ( V_55 ,
L_55
...
V_52 -> V_225 [ V_339 ] . V_340 ,
V_52 -> V_225 [ V_342 ] . V_340 ) ;
V_253:
return V_20 ;
}
...
struct V_356 * F_142 ( struct V_2 * V_3 )
{
struct V_356 * V_357 = NULL ;
if ( F_143 ( V_3 -> V_22 ) )
V_357 = (struct V_356 * )
& V_3 -> V_22 -> V_358 . V_359 . V_360 ;
else if ( V_3 -> V_22 -> V_361 . V_362 == V_363 )
V_357 = (struct V_356 * )
& V_3 -> V_22 -> V_358 . V_364 . V_360 ;
else if ( V_3 -> V_22 -> V_361 . V_362 == V_365 )
V_357 = (struct V_356 * )
& V_3 -> V_22 -> V_358 . V_366 . V_360 ;
return V_357 ;
}
static int F_144 ( struct V_91 * V_46 , T_4 * V_367 ,
T_4 * V_368 )
{
struct V_2 * V_3 = V_46 -> V_3 ;
struct V_356 * V_357 = F_142 ( V_3 ) ;
if ( V_357 ) {
* V_367 = V_357 -> V_369 ;
* V_368 = V_357 -> V_370 ;
} else {
