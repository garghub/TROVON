...
V_38 = V_68 -> V_79 -> V_38 ;
V_77 = V_68 -> V_79 -> V_80 . V_77 ;
}
V_76 = F_52 ( V_68 -> V_79 ,
sizeof( * V_68 -> V_79 ) + sizeof( V_68 -> V_79 -> V_77 [ 0 ] ) * ( V_38 + 1 ) ,
V_4 ) ;
if ( ! V_76 ) {
F_7 ( V_77 ) ;
V_26 = - V_43 ;
...
V_77 = F_52 ( V_77 , sizeof( V_76 -> V_80 . V_77 [ 0 ] ) * ( V_38 + 2 ) , V_4 ) ;
if ( ! V_77 ) {
V_26 = - V_43 ;
goto V_82;
}
memset ( V_76 , 0 , sizeof( * V_76 ) ) ;
memset ( & V_76 -> V_77 [ V_38 ] , 0 , sizeof( V_76 -> V_77 [ V_38 ] ) ) ;
memset ( & V_77 [ V_38 ] , 0 , sizeof( V_77 [ V_38 ] ) ) ;
V_76 -> V_80 . V_18 = L_21 ;
V_76 -> V_80 . V_77 = V_77 ;
F_53 ( & V_76 -> V_77 [ V_38 ] . V_66 . V_83 ) ;
V_76 -> V_77 [ V_38 ] . V_8 = V_15 ;
V_76 -> V_77 [ V_38 ] . V_66 . V_84 = F_46 ;
V_76 -> V_77 [ V_38 ] . V_66 . V_85 = F_48 ;
V_76 -> V_77 [ V_38 ] . V_66 . V_83 . V_18 = ( char * ) V_18 ;
V_76 -> V_77 [ V_38 ] . V_66 . V_83 . V_86 = V_15 -> V_78 ;
V_76 -> V_38 = V_38 + 1 ;
for ( V_38 = 0 ; V_38 < V_76 -> V_38 ; V_38 ++ )
V_76 -> V_80 . V_77 [ V_38 ] = & V_76 -> V_77 [ V_38 ] . V_66 . V_83 ;
V_76 -> V_80 . V_77 [ V_38 ] = NULL ;
V_68 -> V_79 = V_76 ;
return 0 ;
V_82:
F_7 ( V_76 ) ;
...
{
F_7 ( V_68 -> V_79 -> V_80 . V_77 ) ;
F_7 ( V_68 -> V_79 ) ;
V_68 -> V_79 = NULL ;
}
int F_55 ( struct V_87 * V_88 ,
const struct V_14 * V_89 ,
unsigned int V_23 )
{
int V_13 , V_26 ;
bool V_22 = false ;
...
if ( V_89 [ V_13 ] . V_78 == 0 )
continue;
V_26 = F_51 ( & V_88 -> V_90 , & V_89 [ V_13 ] , V_89 [ V_13 ] . V_18 ) ;
if ( V_26 )
return V_26 ;
V_22 = true ;
}
if ( ! V_22 )
return 0 ;
V_26 = F_56 ( & V_88 -> V_90 . V_91 , & V_88 -> V_90 . V_79 -> V_80 ) ;
if ( V_26 )
F_54 ( & V_88 -> V_90 ) ;
return V_26 ;
}
void F_57 ( struct V_87 * V_88 )
{
if ( V_88 -> V_90 . V_79 ) {
F_58 ( & V_88 -> V_90 . V_91 , & V_88 -> V_90 . V_79 -> V_80 ) ;
F_54 ( & V_88 -> V_90 ) ;
}
}
void F_59 ( const struct V_14 * V_22 , unsigned V_38 )
{
unsigned int V_13 ;
...
static struct V_67 * T_5 F_60 ( const char * V_18 )
{
struct V_67 * V_68 ;
struct V_92 * V_91 ;
int V_26 ;
...
V_68 = F_63 ( sizeof( struct V_67 ) , V_4 ) ;
F_38 ( ! V_68 ) ;
V_68 -> V_88 = V_94 ;
V_68 -> V_91 . V_95 = V_93 ;
V_26 = F_64 ( & V_68 -> V_91 , & V_96 , NULL ,
L_13 , V_18 ) ;
#ifdef F_65
if ( ! V_26 )
V_26 = F_66 ( & V_68 -> V_91 , & V_97 . V_83 ) ;
#endif
if ( V_26 ) {
F_67 ( & V_68 -> V_91 ) ;
F_68 ( L_22 ,
...
return;
if ( V_68 -> V_79 )
F_58 ( & V_68 -> V_91 , & V_68 -> V_79 -> V_80 ) ;
V_26 = F_51 ( V_68 , V_89 , V_89 -> V_18 + V_98 ) ;
F_38 ( V_26 ) ;
V_26 = F_56 ( & V_68 -> V_91 , & V_68 -> V_79 -> V_80 ) ;
F_38 ( V_26 ) ;
F_71 ( & V_68 -> V_91 , V_99 ) ;
F_67 ( & V_68 -> V_91 ) ;
}
...
unsigned int V_100 ;
char V_101 [ V_102 ] ;
for ( V_15 = V_103 ; V_15 < V_104 ; V_15 ++ ) {
char * V_105 ;
if ( V_15 -> V_78 == 0 )
continue;
V_105 = strchr ( V_15 -> V_18 , '.' ) ;
if ( ! V_105 ) {
strcpy ( V_101 , L_23 ) ;
V_100 = 0 ;
} else {
V_100 = V_105 - V_15 -> V_18 + 1 ;
F_45 ( V_101 , V_15 -> V_18 , V_100 ) ;
}
F_70 ( V_101 , V_15 , V_100 ) ;
}
}
...
{
struct V_106 * V_107 =
F_74 ( V_66 , struct V_106 , V_66 ) ;
return F_29 ( V_69 , V_45 , L_24 , V_107 -> V_108 ) ;
}
static void T_5 F_75 ( void )
{
const struct V_106 * * V_3 ;
struct V_67 * V_68 ;
int V_26 ;
for ( V_3 = V_109 ; V_3 < V_110 ; V_3 ++ ) {
const struct V_106 * V_107 = * V_3 ;
V_68 = F_60 ( V_107 -> V_111 ) ;
if ( V_68 ) {
V_26 = F_66 ( & V_68 -> V_91 , & V_107 -> V_66 . V_83 ) ;
F_71 ( & V_68 -> V_91 , V_99 ) ;
F_67 ( & V_68 -> V_91 ) ;
}
}
}
static T_3 F_76 ( struct V_92 * V_91 ,
struct V_72 * V_83 ,
char * V_69 )
{
struct V_65 * V_72 ;
...
if ( ! V_72 -> V_84 )
return - V_112 ;
V_39 = V_72 -> V_84 ( V_72 , V_68 , V_69 ) ;
return V_39 ;
}
static T_3 F_78 ( struct V_92 * V_91 ,
struct V_72 * V_83 ,
const char * V_69 , T_1 V_55 )
{
struct V_65 * V_72 ;
...
if ( ! V_72 -> V_85 )
return - V_112 ;
V_39 = V_72 -> V_85 ( V_72 , V_68 , V_69 , V_55 ) ;
return V_39 ;
}
static int F_79 ( struct V_95 * V_95 , struct V_92 * V_91 )
{
struct V_113 * V_114 = F_80 ( V_91 ) ;
if ( V_114 == & V_96 )
return 1 ;
return 0 ;
}
static void F_81 ( struct V_92 * V_91 )
{
struct V_67 * V_68 = F_62 ( V_91 ) ;
F_82 ( V_68 -> V_115 ) ;
}
static int T_5 F_83 ( void )
{
V_93 = F_84 ( L_25 , & V_116 , NULL ) ;
if ( ! V_93 ) {
F_85 ( V_117 L_26 ,
__FILE__ , __LINE__ ) ;
return - V_43 ;
