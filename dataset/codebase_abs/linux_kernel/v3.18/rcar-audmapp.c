...
{
struct V_48 * V_49 = & V_6 -> V_42 . V_49 ;
struct V_10 * V_11 ;
int V_12 ;
...
static struct V_51 * F_27 ( struct V_52 * V_53 ,
struct V_54 * V_55 )
{
T_4 V_56 ;
struct V_51 * V_57 ;
T_1 V_18 = V_53 -> args [ 0 ] ;
if ( V_53 -> V_58 != 1 )
return NULL ;
F_28 ( V_56 ) ;
F_29 ( V_59 , V_56 ) ;
V_57 = F_30 ( V_56 , V_60 , NULL ) ;
if ( V_57 )
F_31 ( V_57 ) -> V_61 = V_18 ;
return V_57 ;
}
...
{
struct V_25 * V_26 = V_40 -> V_8 . V_62 ;
struct V_63 * V_64 = V_40 -> V_8 . V_65 ;
struct V_5 * V_6 ;
struct V_42 * V_43 ;
struct V_48 * V_49 ;
struct V_66 * V_67 ;
...
return - V_69 ;
V_67 = F_34 ( V_40 , V_70 , 0 ) ;
V_6 = F_21 ( & V_40 -> V_8 , sizeof( * V_6 ) , V_44 ) ;
if ( ! V_6 )
return - V_45 ;
V_6 -> V_8 = & V_40 -> V_8 ;
V_6 -> V_26 = V_26 ;
V_6 -> V_47 = F_35 ( & V_40 -> V_8 , V_67 ) ;
if ( F_36 ( V_6 -> V_47 ) )
return F_37 ( V_6 -> V_47 ) ;
V_43 = & V_6 -> V_42 ;
V_43 -> V_71 = & V_72 ;
V_43 -> V_73 = sizeof( struct V_16 ) ;
V_49 = & V_43 -> V_49 ;
V_49 -> V_74 = V_75 ;
F_29 ( V_59 , V_49 -> V_76 ) ;
V_68 = F_38 ( & V_40 -> V_8 , V_43 , V_77 ) ;
if ( V_68 < 0 )
return V_68 ;
F_39 ( V_40 , V_6 ) ;
for ( V_12 = 0 ; V_12 < V_77 ; V_12 ++ ) {
V_68 = F_20 ( V_40 , V_6 , V_12 ) ;
if ( V_68 )
goto V_78;
}
V_68 = F_40 ( V_49 ) ;
