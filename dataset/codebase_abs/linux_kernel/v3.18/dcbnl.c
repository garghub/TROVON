...
{
struct V_214 * V_214 = F_71 ( V_8 -> V_236 ) ;
struct V_17 * V_18 ;
struct V_9 * V_10 = F_5 ( V_11 ) ;
struct V_19 * V_20 [ V_237 + 1 ] ;
T_2 V_212 = V_8 ? F_72 ( V_8 ) . V_212 : 0 ;
int V_29 = - V_33 ;
struct V_1 * V_238 ;
struct V_6 * V_239 = NULL ;
const struct V_240 * V_241 ;
if ( ( V_11 -> V_242 == V_79 ) && ! F_73 ( V_8 , V_243 ) )
return - V_244 ;
V_29 = F_74 ( V_11 , sizeof( * V_10 ) , V_20 , V_237 ,
V_245 ) ;
if ( V_29 < 0 )
return V_29 ;
if ( V_10 -> V_2 > V_246 )
return - V_33 ;
V_241 = & V_247 [ V_10 -> V_2 ] ;
if ( ! V_241 -> V_248 )
return - V_23 ;
if ( ! V_20 [ V_159 ] )
return - V_33 ;
V_18 = F_75 ( V_214 , F_59 ( V_20 [ V_159 ] ) ) ;
if ( ! V_18 )
return - V_249 ;
if ( ! V_18 -> V_21 )
return - V_23 ;
V_238 = F_1 ( V_241 -> type , V_10 -> V_2 , V_212 , V_11 -> V_250 ,
V_11 -> V_251 , & V_239 ) ;
if ( ! V_238 )
return - V_215 ;
V_29 = V_241 -> V_248 ( V_18 , V_11 , V_11 -> V_250 , V_20 , V_238 ) ;
if ( V_29 < 0 ) {
F_53 ( V_238 ) ;
goto V_252;
}
F_55 ( V_238 , V_239 ) ;
V_29 = F_76 ( V_238 , V_214 , V_212 ) ;
V_252:
return V_29 ;
}
...
static int F_78 ( const struct V_71 * V_72 , int V_176 )
{
struct V_156 * V_253 ;
V_253 = F_42 ( sizeof( * V_253 ) , V_254 ) ;
if ( ! V_253 )
return - V_152 ;
memcpy ( & V_253 -> V_72 , V_72 , sizeof( * V_72 ) ) ;
V_253 -> V_176 = V_176 ;
F_79 ( & V_253 -> V_255 , & V_256 ) ;
return 0 ;
}
...
T_1 V_88 = 0 ;
F_46 ( & V_175 ) ;
if ( ( V_157 = F_77 ( V_72 , V_186 -> V_176 , 0 ) ) )
V_88 = V_157 -> V_72 . V_78 ;
F_48 ( & V_175 ) ;
return V_88 ;
}
int F_26 ( struct V_17 * V_186 , struct V_71 * V_257 )
{
struct V_156 * V_157 ;
struct V_156 V_211 ;
int V_150 = 0 ;
V_211 . V_176 = V_186 -> V_176 ;
memcpy ( & V_211 . V_72 , V_257 , sizeof( V_211 . V_72 ) ) ;
if ( V_186 -> V_21 -> V_178 )
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( ( V_157 = F_77 ( V_257 , V_186 -> V_176 , 0 ) ) ) {
if ( V_257 -> V_78 )
V_157 -> V_72 . V_78 = V_257 -> V_78 ;
else {
F_80 ( & V_157 -> V_255 ) ;
F_43 ( V_157 ) ;
}
...
T_1 F_82 ( struct V_17 * V_186 , struct V_71 * V_72 )
{
struct V_156 * V_157 ;
T_1 V_88 = 0 ;
F_46 ( & V_175 ) ;
...
int F_61 ( struct V_17 * V_186 , struct V_71 * V_257 )
{
struct V_156 V_211 ;
int V_150 = 0 ;
V_211 . V_176 = V_186 -> V_176 ;
...
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( F_77 ( V_257 , V_186 -> V_176 , V_257 -> V_78 ) ) {
V_150 = - V_259 ;
goto V_252;
}
V_150 = F_78 ( V_257 , V_186 -> V_176 ) ;
...
int F_64 ( struct V_17 * V_186 , struct V_71 * V_260 )
{
struct V_156 * V_157 ;
struct V_156 V_211 ;
int V_150 = - V_261 ;
V_211 . V_176 = V_186 -> V_176 ;
memcpy ( & V_211 . V_72 , V_260 , sizeof( V_211 . V_72 ) ) ;
if ( V_186 -> V_21 -> V_178 )
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( ( V_157 = F_77 ( V_260 , V_186 -> V_176 , V_260 -> V_78 ) ) ) {
F_80 ( & V_157 -> V_255 ) ;
F_43 ( V_157 ) ;
V_150 = 0 ;
}
...
{
F_86 ( & V_256 ) ;
F_87 ( V_263 , V_264 , F_70 , NULL , NULL ) ;
F_87 ( V_263 , V_79 , F_70 , NULL , NULL ) ;
return 0 ;
}
