...
V_168 = F_107 ( F_101 , V_65 ,
L_13 , V_153 -> V_80 ) ;
if ( F_91 ( V_168 ) ) {
F_108 ( L_14 , F_92 ( V_168 ) ) ;
F_104 ( V_158 , V_166 ) ;
return;
}
F_105 ( V_158 -> V_70 ,
...
V_178 = F_112 ( V_170 ) ;
for ( V_180 = F_113 ( V_178 ) ; V_180 != NULL ;
V_180 = F_114 ( V_180 ) ) {
T_1 V_12 ;
int V_181 ;
char * V_32 ;
V_12 = F_115 ( V_180 -> V_182 ) ;
if ( F_25 ( V_12 < V_58 ) )
continue;
V_181 = F_116 ( V_180 -> V_183 ) ;
if ( F_25 ( V_181 == 0 ) )
continue;
V_32 = V_180 -> V_184 ;
if ( V_32 [ 0 ] == '.' ) {
...
V_189:
F_98 ( V_65 , V_32 , V_181 ) ;
}
V_58 = F_115 ( V_178 -> V_190 ) ;
if ( V_58 == V_191 ) {
F_117 ( V_170 , 0 ) ;
while ( 1 ) {
F_105 ( V_158 -> V_70 ,
...
F_117 ( V_170 , F_118 ( V_178 -> V_192 ) &
V_193 ) ;
V_170 = F_111 ( V_88 , V_58 , & V_173 ) ;
} else {
F_36 ( F_118 ( V_178 -> V_192 ) & V_193 ) ;
F_117 ( V_170 , 1 ) ;
}
}
V_97:
