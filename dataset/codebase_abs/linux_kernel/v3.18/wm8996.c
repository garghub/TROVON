...
{
return F_53 ( V_418 , struct V_4 , V_417 ) ;
}
static void F_54 ( struct V_417 * V_418 , unsigned V_419 , int V_38 )
{
struct V_4 * V_5 = F_52 ( V_418 ) ;
F_55 ( V_5 -> V_295 , V_259 + V_419 ,
V_420 , ! ! V_38 << V_421 ) ;
}
static int F_56 ( struct V_417 * V_418 ,
unsigned V_419 , int V_38 )
{
struct V_4 * V_5 = F_52 ( V_418 ) ;
int V_65 ;
V_65 = ( 1 << V_422 ) | ( ! ! V_38 << V_421 ) ;
return F_55 ( V_5 -> V_295 , V_259 + V_419 ,
V_341 | V_423 |
V_420 , V_65 ) ;
}
static int F_57 ( struct V_417 * V_418 , unsigned V_419 )
{
struct V_4 * V_5 = F_52 ( V_418 ) ;
unsigned int V_88 ;
int V_47 ;
V_47 = F_58 ( V_5 -> V_295 , V_259 + V_419 , & V_88 ) ;
if ( V_47 < 0 )
return V_47 ;
return ( V_88 & V_420 ) != 0 ;
}
static int F_59 ( struct V_417 * V_418 , unsigned V_419 )
{
struct V_4 * V_5 = F_52 ( V_418 ) ;
return F_55 ( V_5 -> V_295 , V_259 + V_419 ,
V_341 | V_423 ,
...
int F_64 ( struct V_1 * V_2 , struct V_428 * V_429 ,
T_2 V_430 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
...
static T_3 F_76 ( int V_59 , void * V_460 )
{
...
static T_3 F_78 ( int V_59 , void * V_460 )
{
T_3 V_47 = V_462 ;
T_3 V_65 ;
do {
V_65 = F_76 ( V_59 , V_460 ) ;
if ( V_65 != V_462 )
V_47 = V_65 ;
} while ( V_65 != V_462 );
return V_47 ;
...
int V_47 , V_12 ;
unsigned int V_88 ;
V_5 = F_89 ( & V_56 -> V_29 , sizeof( struct V_4 ) ,
V_474 ) ;
if ( V_5 == NULL )
return - V_489 ;
F_90 ( V_56 , V_5 ) ;
V_5 -> V_29 = & V_56 -> V_29 ;
if ( F_91 ( & V_56 -> V_29 ) )
memcpy ( & V_5 -> V_7 , F_91 ( & V_56 -> V_29 ) ,
sizeof( V_5 -> V_7 ) ) ;
if ( V_5 -> V_7 . V_294 > 0 ) {
V_47 = F_92 ( V_5 -> V_7 . V_294 ,
V_490 , L_52 ) ;
if ( V_47 < 0 ) {
F_23 ( & V_56 -> V_29 , L_53 ,
V_5 -> V_7 . V_294 , V_47 ) ;
...
V_47 = F_93 ( & V_56 -> V_29 , F_5 ( V_5 -> V_293 ) ,
V_5 -> V_293 ) ;
if ( V_47 != 0 ) {
F_23 ( & V_56 -> V_29 , L_54 , V_47 ) ;
goto V_494;
}
...
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_293 ) ; V_12 ++ ) {
V_47 = F_94 ( V_5 -> V_293 [ V_12 ] . V_500 ,
& V_5 -> V_495 [ V_12 ] ) ;
if ( V_47 != 0 ) {
F_23 ( & V_56 -> V_29 ,
L_55 ,
...
V_5 -> V_295 = F_95 ( V_56 , & V_501 ) ;
if ( F_96 ( V_5 -> V_295 ) ) {
V_47 = F_97 ( V_5 -> V_295 ) ;
F_23 ( & V_56 -> V_29 , L_56 , V_47 ) ;
goto V_502;
}
V_47 = F_58 ( V_5 -> V_295 , V_89 , & V_88 ) ;
if ( V_47 < 0 ) {
...
V_47 = F_58 ( V_5 -> V_295 , V_128 , & V_88 ) ;
if ( V_47 < 0 ) {
F_23 ( & V_56 -> V_29 , L_59 ,
V_47 ) ;
goto V_503;
...
V_47 = F_99 ( V_5 -> V_295 , V_89 ,
0x8915 ) ;
if ( V_47 != 0 ) {
F_23 ( & V_56 -> V_29 , L_61 , V_47 ) ;
goto V_503;
}
}
...
V_560 ,
1 << V_547 | 1 ) ;
V_47 = F_58 ( V_5 -> V_295 , V_259 , & V_88 ) ;
if ( V_47 != 0 ) {
...
V_561 ,
V_561 ) ;
V_47 = F_58 ( V_5 -> V_295 , V_260 , & V_88 ) ;
if ( V_47 != 0 ) {
...
static int F_102 ( struct V_55 * V_566 )
{
struct V_4 * V_5 = F_103 ( V_566 ) ;
int V_12 ;
F_104 ( & V_566 -> V_29 ) ;
F_62 ( V_5 ) ;
if ( V_5 -> V_7 . V_294 > 0 ) {
