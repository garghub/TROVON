...
static int F_52 ( struct V_17 * V_18 , unsigned int V_31 )
{
struct V_9 * V_10 = F_8 ( V_18 ) ;
if ( V_10 -> V_12 & V_34 )
return V_148 ;
...
static void T_3 * F_53 ( struct V_17 * V_18 ,
...
goto V_158;
F_54 ( V_153 -> V_157 + V_159 , V_155 ) ;
V_153 -> V_155 = V_155 ;
V_158:
return V_153 -> V_160 + V_32 ;
}
static int F_55 ( struct V_17 * V_18 , unsigned int V_31 ,
int V_32 , int V_33 , T_2 * V_11 )
{
void T_3 * V_145 ;
V_145 = F_53 ( V_18 , V_31 , V_32 ) ;
if ( ! V_145 )
return V_148 ;
switch ( V_33 ) {
case 1 :
...
static int F_59 ( struct V_17 * V_18 , unsigned int V_31 ,
int V_32 , int V_33 , T_2 V_11 )
{
struct V_9 * V_10 = F_8 ( V_18 ) ;
void T_3 * V_145 ;
...
static int T_6 F_62 ( struct V_9 * V_10 ,
struct V_42 * V_78 )
{
struct V_152 * V_153 ;
T_2 V_162 ;
int V_156 = - V_134 ;
V_153 = F_63 ( sizeof( * V_153 ) , V_163 ) ;
if ( ! V_153 )
return V_156 ;
V_153 -> V_157 = F_45 ( V_78 -> V_45 , F_16 ( V_78 ) ) ;
if ( ! V_153 -> V_157 )
goto V_164;
V_162 = F_58 ( V_153 -> V_157 + V_165 ) ;
if ( ! V_162 ) {
V_156 = - V_132 ;
goto V_166;
}
...
if ( ! V_153 -> V_160 )
goto V_166;
F_64 ( V_10 -> V_76 -> V_154 ) ;
V_10 -> V_76 -> V_154 = V_153 ;
V_10 -> V_14 = & V_167 ;
V_10 -> V_12 |= V_13 ;
F_54 ( V_153 -> V_157 + V_168 , 0 ) ;
F_54 ( V_153 -> V_157 + V_159 , 0 ) ;
if ( F_4 ( V_10 ) )
V_10 -> V_12 |= V_34 ;
return 0 ;
V_166:
...
if ( ! ( F_58 ( & V_173 [ V_49 ] . V_175 ) & V_176 ) )
continue;
if ( F_70 () == F_58 ( & V_173 [ V_49 ] . V_177 ) )
return ( T_4 ) F_58 ( & V_173 [ V_49 ] . V_178 ) << 32 |
F_58 ( & V_173 [ V_49 ] . V_179 ) ;
}
F_42 ( V_133 L_38 ) ;
}
#endif
#if F_71 ( V_180 ) || F_71 ( V_181 )
if ( ! V_171 ) {
T_2 V_182 ;
F_72 ( V_10 -> V_18 ,
F_73 ( 0 , 0 ) , V_91 , & V_182 ) ;
...
static int F_74 ( struct V_184 * V_185 , T_2 V_186 )
{
...
if ( F_86 ( V_185 ) ) {
F_87 () ;
V_156 = F_88 ( V_185 -> V_216 , & V_186 ) ;
F_89 () ;
} else {
V_156 = F_90 ( V_185 -> V_216 , V_186 ) ;
}
if ( F_74 ( V_185 , V_186 ) ) {
V_185 -> V_216 += 4 ;
return 1 ;
...
if ( V_218 )
return;
V_217 = F_92 ( NULL , L_39 ) ;
while ( ( V_218 = F_93 ( V_217 ) ) ) {
F_94 ( V_217 ) ;
V_217 = V_218 ;
if ( F_95 ( V_219 , V_217 ) && F_40 ( V_217 ) )
return;
}
F_96 (np, pci_ids) {
if ( F_40 ( V_217 ) ) {
...
static T_9 F_97 ( int V_220 , void * V_221 )
{
...
int V_43 ;
T_7 V_227 ;
V_2 = F_99 ( & V_10 -> V_18 -> V_228 , F_100 ( * V_2 ) , V_229 ) ;
F_101 ( V_2 , V_2 -> V_230 + V_231 , & V_227 ) ;
V_227 &= ~ V_232 ;
F_102 ( V_2 , V_2 -> V_230 + V_231 , V_227 ) ;
V_226 = F_103 ( V_10 -> V_76 , 0 ) ;
if ( ! V_226 ) {
F_104 ( & V_2 -> V_2 , L_40 ) ;
return - V_233 ;
}
V_43 = F_105 ( V_10 -> V_121 , V_226 ,
F_97 ,
V_234 ,
L_41 , V_10 ) ;
if ( V_43 < 0 ) {
F_104 ( & V_2 -> V_2 , L_42 , V_226 ) ;
F_106 ( V_226 ) ;
return - V_132 ;
}
V_25 = V_10 -> V_26 ;
...
void F_116 ( struct V_9 * V_244 )
{
#ifdef F_117
F_98 ( V_244 ) ;
#endif
}
static int F_118 ( struct V_124 * V_125 )
{
struct V_130 * V_245 ;
int V_156 ;
