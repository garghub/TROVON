...
static enum V_60
F_85 ( struct V_1 * V_2 , bool V_161 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_8 * V_8 = F_2 ( V_2 ) ;
...
if ( V_8 -> V_79 && V_212 -> V_224 ) {
if ( V_8 -> V_79 -> V_187 . V_188 == V_212 -> V_188 ) {
V_8 -> V_172 = true ;
V_172 = true ;
}
if ( V_8 -> V_225 && V_76 -> V_77 &&
( V_8 -> V_76 . V_226 == V_76 -> V_226 ) ) {
V_8 -> V_172 = false ;
V_172 = false ;
}
}
...
V_8 -> V_9 = * V_9 ;
V_8 -> V_76 = * V_76 ;
if ( V_76 -> V_77 || V_76 -> V_227 ) {
V_8 -> V_225 = F_91 ( V_6 , & V_76 -> V_228 ) ;
if ( ! V_8 -> V_225 )
F_70 ( L_20 ) ;
}
if ( V_218 ) {
V_198 = F_90 ( sizeof( struct V_15 ) , V_75 ) ;
if ( ! V_198 )
goto V_229;
V_198 -> V_213 = V_213 ;
V_8 -> V_17 = V_198 ;
if ( V_212 -> V_224 ) {
V_8 -> V_79 = F_91 ( V_6 , V_212 ) ;
if ( V_8 -> V_79 )
V_80 = true ;
else
F_70 ( L_21 ) ;
