...
static int F_31 ( struct V_30 * V_31 , T_4 * V_66 )
{
int V_6 ;
T_2 V_67 = 0 ;
struct V_1 * V_2 = V_31 -> V_63 ;
...
static int F_32 ( struct V_1 * V_2 , T_3 V_74 )
{
T_5 V_75 ;
T_3 V_76 ;
V_75 = F_19 ( V_2 ) ;
V_75 <<= 23 ;
F_33 ( V_75 , V_74 ) ;
V_76 = V_75 & 0x3fffffff ;
return F_14 ( V_2 , 0x00e4 , V_76 ) ;
}
...
if ( V_2 -> V_15 . V_79 )
V_76 = - V_76 ;
V_76 = V_76 & 0x1fffffff ;
return F_14 ( V_2 , 0x00e8 , V_76 ) ;
}
...
if ( V_6 < 0 )
return V_6 ;
if ( V_31 -> V_84 . V_85 . V_88 )
V_31 -> V_84 . V_85 . V_88 ( V_31 ) ;
V_31 -> V_84 . V_85 . V_86 ( V_31 , & IF ) ;
V_6 = F_34 ( V_2 , IF ) ;
if ( V_6 < 0 )
return V_6 ;
...
struct V_30 * F_38 ( const struct V_89 * V_15 ,
struct V_90 * V_10 )
{
struct V_1 * V_2 = NULL ;
int V_91 ;
...
goto error;
V_2 = F_39 ( sizeof( struct V_1 ) , V_95 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_15 = * V_15 ;
...
memcpy ( & V_2 -> V_96 . V_84 , & V_97 ,
sizeof( struct V_98 ) ) ;
V_2 -> V_96 . V_63 = V_2 ;
V_92 = F_11 ( V_2 , 0x0000 , V_2 -> V_15 . V_64 ) ;
if ( V_92 < 0 )
goto error;
V_92 = F_8 ( V_2 , 0x0000 , & V_23 ) ;
if ( V_92 < 0 )
goto error;
if ( V_23 != V_2 -> V_15 . V_64 )
goto error;
V_92 = F_8 ( V_2 , 0x0023 , & V_2 -> V_58 ) ;
if ( V_92 < 0 )
goto error;
V_92 = F_8 ( V_2 , 0x0118 , & V_2 -> V_99 ) ;
if ( V_92 < 0 )
goto error;
V_92 = F_11 ( V_2 , 0x0000 , V_65 ) ;
if ( V_92 < 0 )
goto error;
if ( V_2 -> V_58 < 26 )
V_93 = 'A' + V_2 -> V_58 ;
...
V_12 , V_2 -> V_99 , V_2 -> V_58 ) ;
goto error;
}
F_25 ( & V_2 -> V_10 -> V_11 ,
L_32 ,
V_12 , V_94 , V_93 , V_2 -> V_99 ,
V_2 -> V_58 ) ;
F_40 ( V_2 -> V_96 . V_84 . V_101 . V_102 , V_94 ,
sizeof( V_2 -> V_96 . V_84 . V_101 . V_102 ) ) ;
V_91 = 0 ;
if ( V_2 -> V_68 ) {
V_2 -> V_96 . V_84 . V_103 [ V_91 ++ ] = V_104 ;
F_40 ( V_2 -> V_96 . V_84 . V_101 . V_102 , L_33 ,
sizeof( V_2 -> V_96 . V_84 . V_101 . V_102 ) ) ;
}
if ( V_2 -> V_100 )
