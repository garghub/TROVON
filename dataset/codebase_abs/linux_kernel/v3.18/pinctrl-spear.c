...
static struct V_23 * F_28 ( struct V_1 * V_2 ,
unsigned V_67 )
{
struct V_23 * V_24 ;
int V_16 , V_10 ;
...
if ( ! V_17 )
return - V_56 ;
V_2 = F_33 ( & V_73 -> V_21 , sizeof( * V_2 ) , V_57 ) ;
if ( ! V_2 ) {
F_18 ( & V_73 -> V_21 , L_8 ) ;
return - V_58 ;
}
V_76 = F_34 ( V_73 , V_77 , 0 ) ;
V_2 -> V_78 = F_35 ( & V_73 -> V_21 , V_76 ) ;
if ( F_36 ( V_2 -> V_78 ) )
...
V_79 . V_38 = V_17 -> V_38 ;
V_79 . V_40 = V_17 -> V_40 ;
V_2 -> V_80 = F_40 ( & V_79 , & V_73 -> V_21 , V_2 ) ;
if ( ! V_2 -> V_80 ) {
F_18 ( & V_73 -> V_21 , L_12 ) ;
return - V_56 ;
}
