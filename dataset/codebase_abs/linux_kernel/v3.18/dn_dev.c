...
if ( ! F_52 ( V_100 , & V_18 ) )
goto V_108;
V_28 = F_53 ( V_99 , sizeof( * V_106 ) , V_103 , V_104 , V_109 ) ;
if ( V_28 < 0 )
goto V_108;
V_28 = - V_82 ;
V_106 = F_54 ( V_99 ) ;
...
V_45 = & V_43 -> V_49 ) {
if ( V_103 [ V_111 ] &&
F_55 ( V_103 [ V_111 ] , & V_43 -> V_50 , 2 ) )
continue;
if ( V_103 [ V_112 ] && F_56 ( V_103 [ V_112 ] , V_43 -> V_84 ) )
continue;
F_17 ( V_27 , V_45 , 1 ) ;
return 0 ;
}
...
V_43 -> V_50 = F_58 ( V_103 [ V_111 ] ) ;
V_43 -> V_90 = F_58 ( V_103 [ V_113 ] ) ;
V_43 -> V_114 = V_103 [ V_115 ] ? F_59 ( V_103 [ V_115 ] ) :
V_106 -> V_114 ;
V_43 -> V_63 = V_106 -> V_63 ;
V_43 -> V_60 = V_27 ;
if ( V_103 [ V_112 ] )
F_60 ( V_43 -> V_84 , V_103 [ V_112 ] , V_9 ) ;
else
memcpy ( V_43 -> V_84 , V_2 -> V_15 , V_9 ) ;
V_28 = F_26 ( V_27 , V_43 ) ;
if ( V_28 )
...
{
return F_62 ( sizeof( struct V_105 ) )
+ F_63 ( V_9 )
+ F_63 ( 2 )
+ F_63 ( 2 )
+ F_63 ( 4 ) ;
...
V_99 = F_65 ( V_97 , V_116 , V_117 , V_118 , sizeof( * V_106 ) , V_61 ) ;
if ( V_99 == NULL )
return - V_120 ;
V_106 = F_54 ( V_99 ) ;
V_106 -> V_121 = V_81 ;
...
if ( ( V_43 -> V_90 &&
F_66 ( V_97 , V_113 , V_43 -> V_90 ) ) ||
( V_43 -> V_50 &&
F_66 ( V_97 , V_111 , V_43 -> V_50 ) ) ||
( V_43 -> V_84 [ 0 ] &&
F_67 ( V_97 , V_112 , V_43 -> V_84 ) ) ||
F_68 ( V_97 , V_115 , V_114 ) )
goto V_123;
return F_69 ( V_97 , V_99 ) ;
V_123:
F_70 ( V_97 , V_99 ) ;
return - V_120 ;
}
...
if ( V_97 == NULL )
goto V_108;
V_28 = F_64 ( V_97 , V_43 , 0 , 0 , V_118 , 0 ) ;
if ( V_28 < 0 ) {
F_72 ( V_28 == - V_120 ) ;
F_73 ( V_97 ) ;
goto V_108;
}
F_74 ( V_97 , & V_18 , 0 , V_124 , NULL , V_11 ) ;
return;
V_108:
if ( V_28 < 0 )
F_75 ( & V_18 , V_124 , V_28 ) ;
}
static int F_76 ( struct V_96 * V_97 , struct V_125 * V_126 )
{
struct V_100 * V_100 = F_50 ( V_97 -> V_101 ) ;
...
goto V_131;
for ( V_43 = F_79 ( V_27 -> V_55 ) , V_128 = 0 ; V_43 ;
V_43 = F_79 ( V_43 -> V_49 ) , V_128 ++ ) {
if ( V_128 < V_130 )
continue;
if ( F_64 ( V_97 , V_43 , F_80 ( V_126 -> V_97 ) . V_116 ,
...
static int F_82 ( struct V_1 * V_2 , V_86 * V_135 )
{
struct V_26 * V_27 ;
struct V_42 * V_43 ;
int V_59 = - V_82 ;
...
if ( ( V_97 = F_85 ( NULL , sizeof( * V_140 ) , V_142 ) ) == NULL )
return;
V_97 -> V_2 = V_2 ;
V_140 = (struct V_139 * ) F_86 ( V_97 , sizeof( * V_140 ) ) ;
V_140 -> V_143 = 0x0D ;
memcpy ( V_140 -> V_144 , V_145 , 3 ) ;
F_21 ( V_140 -> V_146 , V_43 -> V_50 ) ;
V_140 -> V_147 = V_148 ;
V_140 -> V_36 = F_87 ( F_12 ( V_2 ) ) ;
V_140 -> V_149 = 0x00 ;
...
V_140 -> V_157 = F_87 ( ( unsigned short ) V_27 -> V_4 . V_158 ) ;
V_140 -> V_159 = 0x00 ;
V_140 -> V_160 = 0x02 ;
memset ( V_140 -> V_14 , 0xAA , 2 ) ;
V_141 = ( V_86 * ) F_88 ( V_97 , 2 ) ;
* V_141 = F_87 ( V_97 -> V_134 - 2 ) ;
F_89 ( V_97 ) ;
F_90 ( V_97 , V_161 , V_140 -> V_146 ) ;
}
static int F_91 ( struct V_155 * V_156 , struct V_26 * V_27 , struct V_42 * V_43 )
{
if ( F_92 ( V_162 , V_27 -> V_163 + V_164 ) )
return 0 ;
if ( ! V_27 -> V_154 )
return 1 ;
...
if ( V_156 -> V_165 != V_27 -> V_4 . V_165 )
return 0 ;
if ( F_93 ( V_156 -> V_135 ) < F_93 ( V_43 -> V_50 ) )
return 1 ;
return 0 ;
}
...
V_166 = 32 ;
V_167 = 2 + 26 + 7 * V_166 ;
if ( ( V_97 = F_85 ( NULL , V_167 , V_142 ) ) == NULL )
return;
V_97 -> V_2 = V_2 ;
V_168 = F_86 ( V_97 , V_167 ) ;
* V_168 ++ = V_172 | V_173 ;
* V_168 ++ = 2 ;
* V_168 ++ = 0 ;
* V_168 ++ = 0 ;
...
V_174 : V_175 ;
* ( ( V_86 * ) V_168 ) = F_87 ( F_12 ( V_2 ) ) ;
V_168 += 2 ;
* V_168 ++ = V_27 -> V_4 . V_165 ;
* V_168 ++ = 0 ;
* ( ( V_86 * ) V_168 ) = F_87 ( ( unsigned short ) V_27 -> V_4 . V_158 ) ;
V_168 += 2 ;
* V_168 ++ = 0 ;
V_169 = V_168 ++ ;
memset ( V_168 , 0 , 7 ) ;
...
* V_141 = F_87 ( V_97 -> V_134 - 2 ) ;
F_89 ( V_97 ) ;
if ( F_91 ( V_156 , V_27 , V_43 ) ) {
struct V_96 * V_176 = F_97 ( V_97 , V_142 ) ;
if ( V_176 ) {
F_90 ( V_176 , V_177 , V_171 ) ;
}
}
F_90 ( V_97 , V_161 , V_171 ) ;
}
...
struct V_96 * V_97 = F_85 ( NULL , V_167 , V_142 ) ;
int V_7 ;
unsigned char * V_168 ;
char V_171 [ V_153 ] ;
if ( V_97 == NULL )
...
int F_122 ( struct V_198 * V_199 )
{
return F_123 ( & V_53 , V_199 ) ;
}
static inline int F_124 ( struct V_1 * V_2 )
{
return V_2 -> V_32 != NULL ;
}
static void * F_125 ( struct V_200 * V_117 , T_3 * V_201 )
__acquires( T_7 )
{
int V_7 ;
struct V_1 * V_2 ;
...
static void * F_126 ( struct V_200 * V_117 , void * V_203 , T_3 * V_201 )
{
struct V_1 * V_2 ;
++ * V_201 ;
V_2 = V_203 ;
if ( V_203 == V_202 )
V_2 = F_127 ( & V_18 . V_204 ) ;
F_128 (&init_net, dev) {
if ( ! F_124 ( V_2 ) )
continue;
return V_2 ;
...
static void F_129 ( struct V_200 * V_117 , void * V_203 )
__releases( T_7 )
{
F_81 () ;
}
...
static int F_131 ( struct V_200 * V_117 , void * V_203 )
{
if ( V_203 == V_202 )
F_132 ( V_117 , L_7 ) ;
else {
...
F_130 ( V_27 -> V_4 . V_211 ) ,
0 , 0 ,
V_27 -> V_158 , V_27 -> V_4 . V_158 ,
F_12 ( V_2 ) ,
V_27 -> V_4 . V_165 ,
V_27 -> V_4 . V_212 , V_27 -> V_4 . V_15 ,
V_27 -> V_154 ? F_134 ( F_93 ( * ( V_86 * ) V_27 -> V_154 -> V_213 ) , V_210 ) : L_11 ,
V_27 -> V_196 ? F_134 ( F_93 ( * ( V_86 * ) V_27 -> V_196 -> V_213 ) , V_208 ) : L_11 ) ;
}
return 0 ;
}
static int F_135 ( struct V_214 * V_214 , struct V_215 * V_215 )
{
return F_136 ( V_215 , & V_216 ) ;
}
void T_8 F_137 ( void )
{
...
V_193 = F_87 ( ( V_135 [ 0 ] << 10 ) | V_135 [ 1 ] ) ;
F_119 () ;
F_139 ( V_218 , V_57 , F_57 , NULL , NULL ) ;
F_139 ( V_218 , V_52 , F_49 , NULL , NULL ) ;
F_139 ( V_218 , V_219 , NULL , F_76 , NULL ) ;
F_140 ( L_14 , V_220 , V_18 . V_221 , & V_222 ) ;
#ifdef F_141
{
int V_7 ;
