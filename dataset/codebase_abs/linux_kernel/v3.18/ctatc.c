...
F_20 ( L_2 , V_103 , V_4 -> V_10 -> V_93 , V_4 -> V_10 -> V_95 ) ;
V_103 = V_4 -> V_10 -> V_93 ;
}
V_95 = V_4 -> V_10 -> V_95 ;
V_90 = V_44 -> V_52 * V_44 -> V_73 . V_53 ;
...
V_124 -> V_161 ( V_124 , V_162 , NULL ) ;
V_124 -> V_163 ( V_124 , V_162 , NULL ) ;
V_124 -> V_161 ( V_124 , V_195 , NULL ) ;
V_124 -> V_163 ( V_124 , V_195 , NULL ) ;
}
if ( V_2 -> V_146 ) {
V_175 = (struct V_175 * ) V_2 -> V_36 [ V_176 ] ;
for ( V_49 = 0 ; V_49 < V_2 -> V_196 ; V_49 ++ ) {
V_148 = V_2 -> V_146 [ V_49 ] ;
if ( V_148 -> type < V_183 ) {
V_145 = F_29 ( V_148 , struct V_145 , V_148 ) ;
V_145 -> V_60 -> V_197 ( V_145 ) ;
V_145 -> V_60 -> V_198 ( V_145 ) ;
} else {
V_194 = F_29 ( V_148 , struct V_194 , V_148 ) ;
}
V_175 -> V_199 ( V_175 , V_148 ) ;
}
F_14 ( V_2 -> V_146 ) ;
V_2 -> V_146 = NULL ;
}
...
if ( V_2 -> V_165 ) {
V_35 = V_2 -> V_36 [ V_37 ] ;
for ( V_49 = 0 ; V_49 < V_2 -> V_201 ; V_49 ++ )
...
if ( V_203 [ V_49 ] . V_204 && V_2 -> V_36 [ V_49 ] )
V_203 [ V_49 ] . V_204 ( V_2 -> V_36 [ V_49 ] ) ;
}
if ( V_2 -> V_143 )
F_57 ( V_2 -> V_143 ) ;
if ( V_2 -> V_8 ) {
...
static int F_59 ( struct V_205 * V_30 )
{
struct V_1 * V_2 = V_30 -> V_206 ;
return F_54 ( V_2 ) ;
}
static int F_60 ( struct V_1 * V_2 , unsigned int V_207 )
{
const struct V_208 * V_209 ;
const struct V_208 * V_210 ;
T_3 V_211 , V_212 ;
switch ( V_2 -> V_213 ) {
case V_214 :
V_2 -> V_215 = L_3 ;
...
V_211 = V_2 -> V_219 -> V_220 ;
V_212 = V_2 -> V_219 -> V_221 ;
}
V_209 = F_61 ( V_211 , V_212 , V_210 ) ;
if ( V_209 ) {
if ( V_209 -> V_222 < 0 ) {
F_5 ( V_2 -> V_19 -> V_30 ,
L_5 ,
...
enum V_228 V_49 ;
int V_46 ;
V_229 [ V_230 ] . V_231 = V_2 -> V_215 ;
for ( V_49 = 0 ; V_49 < V_232 ; V_49 ++ ) {
if ( ! V_229 [ V_49 ] . V_233 )
continue;
V_46 = V_229 [ V_49 ] . V_233 ( V_2 , V_49 ,
V_229 [ V_49 ] . V_231 ) ;
if ( V_46 ) {
F_5 ( V_2 -> V_19 -> V_30 ,
L_7 , V_49 ) ;
...
int V_49 , V_46 ;
V_46 = F_65 ( V_2 -> V_219 , V_2 -> V_213 , V_2 -> V_223 , & V_143 ) ;
if ( V_46 ) {
...
V_235 . V_59 = V_2 -> V_59 ;
V_235 . V_53 = V_2 -> V_53 ;
V_235 . V_236 = F_3 ( V_2 , 0 ) ;
V_46 = V_143 -> V_237 ( V_143 , & V_235 ) ;
if ( V_46 < 0 )
return V_46 ;
for ( V_49 = 0 ; V_49 < V_202 ; V_49 ++ ) {
if ( ! V_203 [ V_49 ] . V_233 )
continue;
V_46 = V_203 [ V_49 ] . V_233 ( V_2 -> V_143 , & V_2 -> V_36 [ V_49 ] ) ;
if ( V_46 ) {
F_5 ( V_2 -> V_19 -> V_30 ,
L_9 , V_49 ) ;
return V_46 ;
...
struct V_113 V_114 = { 0 } ;
struct V_78 * V_78 ;
int V_46 , V_49 , V_240 , V_241 ;
V_241 = ( ( V_2 -> V_223 == V_242 ) ? 8 : 7 ) ;
V_240 = ( ( V_2 -> V_223 == V_242 ) ? 6 : 4 ) ;
V_2 -> V_146 = F_10 ( sizeof( void * ) * V_241 , V_68 ) ;
if ( ! V_2 -> V_146 )
return - V_69 ;
V_2 -> V_165 = F_10 ( sizeof( void * ) * V_240 , V_68 ) ;
if ( ! V_2 -> V_165 )
return - V_69 ;
V_2 -> V_81 = F_10 ( sizeof( void * ) * V_240 , V_68 ) ;
if ( ! V_2 -> V_81 )
return - V_69 ;
...
V_175 = (struct V_175 * ) V_2 -> V_36 [ V_176 ] ;
V_239 . V_53 = V_2 -> V_53 ;
for ( V_49 = 0 , V_2 -> V_196 = 0 ; V_49 < V_241 ; V_49 ++ ) {
V_239 . type = ( V_2 -> V_223 != V_243 ) ? V_49 :
( ( V_49 == V_185 ) ? V_244 : V_49 ) ;
V_46 = V_175 -> V_245 ( V_175 , & V_239 ,
...
V_110 . V_53 = V_2 -> V_53 ;
V_110 . V_54 = V_117 ;
for ( V_49 = 0 , V_2 -> V_201 = 0 ; V_49 < V_240 ; V_49 ++ ) {
V_46 = V_35 -> V_56 ( V_35 , & V_110 ,
...
V_76 = V_2 -> V_36 [ V_77 ] ;
V_112 . V_53 = 8 ;
for ( V_49 = 0 , V_2 -> V_82 = 0 ; V_49 < V_240 ; V_49 ++ ) {
...
V_78 = V_2 -> V_36 [ V_79 ] ;
V_114 . V_53 = V_2 -> V_53 ;
for ( V_49 = 0 , V_2 -> V_200 = 0 ; V_49 < ( 2 * 4 ) ; V_49 ++ ) {
...
static void
F_67 ( struct V_35 * V_35 , struct V_194 * V_194 ,
...
struct V_80 * V_80 ;
int V_49 = 0 ;
V_188 [ 0 ] = & V_194 -> V_148 . V_246 ;
V_188 [ 1 ] = & V_194 -> V_148 . V_247 ;
for ( V_49 = 0 ; V_49 < 2 ; V_49 ++ ) {
V_44 = V_165 [ V_49 ] ;
V_80 = V_81 [ V_49 ] ;
...
V_194 -> V_60 -> V_248 ( V_194 , & ( V_165 [ 0 ] -> V_73 ) ) ;
V_194 -> V_60 -> V_249 ( V_194 , & ( V_165 [ 1 ] -> V_73 ) ) ;
V_194 -> V_60 -> V_250 ( V_194 , 1 ) ;
V_194 -> V_60 -> V_251 ( V_194 , 1 ) ;
V_194 -> V_60 -> V_101 ( V_194 ) ;
V_35 -> V_101 ( V_35 ) ;
}
...
V_194 = F_29 ( V_2 -> V_146 [ V_183 ] , struct V_194 , V_148 ) ;
F_67 ( V_2 -> V_36 [ V_37 ] , V_194 ,
...
V_124 -> V_163 ( V_124 , V_166 , & V_44 -> V_73 ) ;
if ( V_2 -> V_223 == V_242 ) {
V_194 = F_29 ( V_2 -> V_146 [ V_184 ] , struct V_194 , V_148 ) ;
F_67 ( V_2 -> V_36 [ V_37 ] , V_194 ,
...
V_194 = F_29 ( V_2 -> V_146 [ V_185 ] , struct V_194 , V_148 ) ;
F_67 ( V_2 -> V_36 [ V_37 ] , V_194 ,
(struct V_44 * * ) & V_2 -> V_165 [ 0 ] ,
(struct V_80 * * ) & V_2 -> V_81 [ 0 ] ) ;
V_44 = V_2 -> V_165 [ 0 ] ;
V_124 -> V_161 ( V_124 , V_195 , & V_44 -> V_73 ) ;
V_44 = V_2 -> V_165 [ 1 ] ;
V_124 -> V_163 ( V_124 , V_195 , & V_44 -> V_73 ) ;
...
V_235 . V_53 = V_2 -> V_53 ;
V_235 . V_236 = F_3 ( V_2 , 0 ) ;
return V_143 -> V_260 ( V_143 , & V_235 ) ;
}
...
int F_76 ( struct V_18 * V_19 , struct V_262 * V_219 ,
unsigned int V_59 , unsigned int V_53 ,
int V_213 , unsigned int V_207 ,
struct V_1 * * V_263 )
{
struct V_1 * V_2 ;
