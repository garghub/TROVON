...
static void
F_53 ( struct V_1 * V_2 , T_1 V_61 , bool V_62 ,
bool V_63 )
{
...
static bool F_55 ( struct V_1 * V_2 , T_1 V_61 )
{
int V_68 ;
for ( V_68 = 0 ; V_68 < F_56 ( V_69 ) ; V_68 ++ )
if ( V_61 == V_69 [ V_68 ] )
return true ;
return false ;
}
...
int V_68 , V_23 = 0 ;
for ( V_68 = 0 ; V_68 < F_56 ( V_131 ) ; V_68 ++ , V_130 ++ ) {
...
return - V_134 ;
if ( args -> V_144 == V_145 && ! F_68 ( V_146 ) )
return - V_147 ;
V_23 = F_69 ( & V_3 -> V_71 ) ;
if ( V_23 )
return V_23 ;
V_141 = F_70 ( V_127 -> V_148 , args -> V_144 ) ;
if ( F_71 ( V_141 ) ) {
F_60 ( & V_3 -> V_71 ) ;
return F_72 ( V_141 ) ;
}
...
V_23 = F_78 ( ( F_7 ( V_2 , V_168 ) & V_169 ) == 0 , 500 ) ;
F_38 ( V_3 , true ) ;
return V_23 ;
}
