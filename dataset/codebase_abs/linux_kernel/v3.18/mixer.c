...
static int F_101 ( struct V_244 * V_245 )
{
struct V_103 * V_52 = V_245 -> V_246 ;
F_99 ( V_52 ) ;
return 0 ;
}
...
struct V_2 V_3 ;
int V_56 ;
const struct V_247 * V_7 ;
void * V_6 ;
memset ( & V_3 , 0 , sizeof( V_3 ) ) ;
V_3 . V_37 = V_52 -> V_37 ;
V_3 . V_52 = V_52 ;
V_3 . V_28 = V_52 -> V_248 -> V_249 ;
V_3 . V_10 = V_52 -> V_248 -> V_250 ;
for ( V_7 = V_251 ; V_7 -> V_8 ; V_7 ++ ) {
...
V_6 = NULL ;
while ( ( V_6 = F_103 ( V_52 -> V_248 -> V_249 ,
V_52 -> V_248 -> V_250 ,
V_6 , V_252 ) ) != NULL ) {
if ( V_52 -> V_77 == V_78 ) {
struct V_253 * V_180 = V_6 ;
if ( V_180 -> V_30 < sizeof( * V_180 ) )
continue;
F_104 ( V_180 -> V_254 , V_3 . V_239 ) ;
V_3 . V_192 . V_8 = V_180 -> V_254 ;
...
F_60 ( V_52 -> V_37 -> V_105 , V_256 ,
V_214 -> V_106 ) ;
}
static void F_106 ( struct V_257 * V_28 ,
int V_4 ,
struct V_13 * V_14 )
{
static char * V_258 [] = { L_66 , L_67 ,
L_68 , L_69 , L_70 , L_71 } ;
F_107 ( V_28 , L_72 , V_4 ) ;
if ( V_14 -> V_106 )
F_107 ( V_28 , L_73 ,
...
static void F_108 ( struct V_259 * V_260 ,
struct V_257 * V_28 )
{
struct V_51 * V_37 = V_260 -> V_95 ;
struct V_103 * V_52 ;
struct V_13 * V_14 ;
int V_4 ;
...
V_52 -> V_83 ) ;
F_107 ( V_28 , L_78 , V_37 -> V_105 -> V_261 ) ;
for ( V_4 = 0 ; V_4 < V_262 ; V_4 ++ ) {
...
static void F_111 ( struct V_240 * V_240 )
{
struct V_103 * V_52 = V_240 -> V_265 ;
int V_36 = V_240 -> V_266 ;
int V_267 = V_240 -> V_268 ;
if ( V_267 != 0 )
goto V_269;
if ( V_52 -> V_77 == V_78 ) {
struct V_270 * V_268 ;
for ( V_268 = V_240 -> V_241 ;
V_36 >= sizeof( * V_268 ) ;
V_36 -= sizeof( * V_268 ) , V_268 ++ ) {
F_112 ( & V_240 -> V_38 -> V_38 , L_81 ,
V_268 -> V_271 ,
V_268 -> V_272 ) ;
if ( ( V_268 -> V_271 & V_273 ) !=
V_274 )
continue;
if ( V_268 -> V_271 & V_275 )
F_113 ( V_52 , V_268 -> V_272 ) ;
else
F_105 ( V_52 , V_268 -> V_272 ) ;
}
} else {
struct V_276 * V_277 ;
for ( V_277 = V_240 -> V_241 ;
V_36 >= sizeof( * V_277 ) ;
V_36 -= sizeof( * V_277 ) , V_277 ++ ) {
if ( ( V_277 -> V_278 & V_279 ) ||
( V_277 -> V_278 & V_280 ) )
continue;
F_110 ( V_52 , V_277 -> V_281 ,
F_44 ( V_277 -> V_282 ) ,
F_44 ( V_277 -> V_283 ) ) ;
}
}
...
int V_290 ;
unsigned int V_291 ;
if ( F_116 ( V_52 -> V_248 ) -> V_292 < 1 )
return 0 ;
V_289 = F_117 ( V_52 -> V_248 , 0 ) ;
if ( ! F_118 ( V_289 ) || ! F_119 ( V_289 ) )
return 0 ;
V_291 = F_120 ( V_289 ) ;
V_290 = F_44 ( V_289 -> V_293 ) ;
V_241 = F_96 ( V_290 , V_185 ) ;
if ( ! V_241 )
return - V_97 ;
V_52 -> V_240 = F_121 ( 0 , V_185 ) ;
if ( ! V_52 -> V_240 ) {
F_54 ( V_241 ) ;
return - V_97 ;
}
F_122 ( V_52 -> V_240 , V_52 -> V_37 -> V_38 ,
F_123 ( V_52 -> V_37 -> V_38 , V_291 ) ,
V_241 , V_290 ,
F_111 , V_52 , V_289 -> V_294 ) ;
F_114 ( V_52 -> V_240 , V_185 ) ;
return 0 ;
}
int F_124 ( struct V_51 * V_37 , int V_295 ,
int V_296 )
{
...
struct V_259 * V_260 ;
int V_56 ;
strcpy ( V_37 -> V_105 -> V_300 , L_82 ) ;
V_52 = F_68 ( sizeof( * V_52 ) , V_185 ) ;
if ( ! V_52 )
return - V_97 ;
V_52 -> V_37 = V_37 ;
V_52 -> V_83 = V_296 ;
V_52 -> V_108 = F_125 ( V_262 , sizeof( * V_52 -> V_108 ) ,
V_185 ) ;
if ( ! V_52 -> V_108 ) {
F_54 ( V_52 ) ;
return - V_97 ;
}
V_52 -> V_248 = & F_126 ( V_37 -> V_38 , V_295 ) -> V_301 [ 0 ] ;
switch ( F_116 ( V_52 -> V_248 ) -> V_302 ) {
case V_78 :
default:
V_52 -> V_77 = V_78 ;
break;
...
goto V_303;
F_127 ( V_52 ) ;
V_56 = F_128 ( V_37 -> V_105 , V_304 , V_52 , & V_298 ) ;
if ( V_56 < 0 )
goto V_303;
if ( F_129 ( & V_37 -> V_305 ) &&
! F_130 ( V_37 -> V_105 , L_83 , & V_260 ) )
F_131 ( V_260 , V_37 , F_108 ) ;
F_132 ( & V_52 -> V_213 , & V_37 -> V_305 ) ;
return 0 ;
V_303:
F_99 ( V_52 ) ;
return V_56 ;
}
void F_133 ( struct V_306 * V_6 )
{
struct V_103 * V_52 ;
...
int F_140 ( struct V_103 * V_52 , bool V_308 )
{
struct V_13 * V_14 ;
int V_8 , V_56 ;
if ( V_308 ) {
for ( V_8 = 0 ; V_8 < V_262 ; V_8 ++ ) {
