...
static int F_88 ( struct V_124 * V_125 , void * V_130 )
{
struct V_9 * V_127 = V_125 -> V_128 ;
unsigned int * V_129 = ( unsigned int * ) V_130 ;
struct V_4 * V_5 ;
...
static int F_89 ( struct V_132 * V_132 , struct V_133 * V_133 )
{
int V_119 = F_90 ( V_133 , & V_134 ) ;
if ( ! V_119 ) {
struct V_124 * V_135 = V_133 -> V_136 ;
V_135 -> V_128 = F_91 ( V_132 ) ;
}
return V_119 ;
}
static int T_8 F_92 ( struct V_2 * V_2 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
V_1 -> V_42 = F_93 ( L_7 , V_2 -> V_137 ) ;
if ( ! V_1 -> V_42 )
return - V_36 ;
#if F_66 ( V_103 )
V_1 -> V_43 = F_93 ( L_8 , V_2 -> V_137 ) ;
if ( ! V_1 -> V_43 ) {
F_46 ( L_7 , V_2 -> V_137 ) ;
return - V_36 ;
}
...
static void T_9 F_94 ( struct V_2 * V_2 )
{
struct V_9 * V_30 ;
struct V_1 * V_1 = F_1 ( V_2 ) ;
F_52 ( & V_60 ) ;
...
static int T_8 F_95 ( struct V_2 * V_2 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
F_27 ( & V_1 -> V_49 ) ;
return F_92 ( V_2 ) ;
}
static void T_9 F_96 ( struct V_2 * V_2 )
{
F_94 ( V_2 ) ;
}
