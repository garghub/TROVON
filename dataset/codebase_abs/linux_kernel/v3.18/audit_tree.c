...
goto V_46;
F_39 ( & V_39 -> V_24 , V_23 ) ;
if ( F_40 ( & V_39 -> V_24 , V_39 -> V_24 . V_47 , V_39 -> V_24 . V_16 . V_33 , NULL , 1 ) ) {
F_41 ( & V_39 -> V_24 ) ;
goto V_46;
}
V_15 -> V_43 = 1 ;
...
F_39 ( V_51 , V_50 ) ;
if ( F_40 ( V_51 , V_51 -> V_47 , V_51 -> V_16 . V_33 , NULL , 1 ) ) {
F_34 ( & V_50 -> V_42 ) ;
F_41 ( V_51 ) ;
F_41 ( V_50 ) ;
return - V_49 ;
...
struct V_33 * V_33 = V_15 -> V_24 . V_16 . V_33 ;
V_26 -> V_29 |= 1U << 31 ;
