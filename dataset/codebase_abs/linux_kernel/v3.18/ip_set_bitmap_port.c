...
static bool
F_27 ( const struct V_17 * V_51 , const struct V_17 * V_52 )
{
const struct V_1 * V_53 = V_51 -> V_25 ;
const struct V_1 * V_54 = V_52 -> V_25 ;
return V_53 -> V_4 == V_54 -> V_4 &&
V_53 -> V_16 == V_54 -> V_16 &&
V_51 -> V_55 == V_52 -> V_55 &&
V_51 -> V_56 == V_52 -> V_56 ;
}
...
T_1 V_4 , T_1 V_16 )
{
V_7 -> V_10 = F_29 ( V_7 -> V_57 ) ;
if ( ! V_7 -> V_10 )
return false ;
if ( V_18 -> V_8 ) {
V_7 -> V_56 = F_29 ( V_18 -> V_8 * V_7 -> V_58 ) ;
if ( ! V_7 -> V_56 ) {
F_30 ( V_7 -> V_10 ) ;
return false ;
}
...
static int
F_31 ( struct V_61 * V_61 , struct V_17 * V_18 , struct V_36 * V_37 [] ,
T_3 V_11 )
{
struct V_1 * V_7 ;
T_1 V_4 , V_16 ;
