...
T_13 * V_111 )
{
struct V_112 * V_49 = args -> V_49 ;
struct V_13 * V_14 = V_49 -> V_77 ;
T_14 V_113 ;
int V_57 ;
int error ;
F_54 ( args , V_110 ) ;
V_113 = F_55 ( V_14 , V_110 * V_114 ) ;
V_57 = args -> V_76 -> V_35 ;
error = F_56 ( args , & V_113 , V_57 ) ;
if ( error )
return error ;
* V_111 = F_57 ( args -> V_76 , ( V_115 ) V_113 ) ;
if ( V_110 == V_116 ) {
T_15 V_117 ;
V_117 = F_58 ( V_14 , V_113 + V_57 ) ;
if ( V_117 > V_49 -> V_51 . V_53 ) {
V_49 -> V_51 . V_53 = V_117 ;
F_59 ( args -> V_78 , V_49 , V_118 ) ;
}
}
return 0 ;
}
...
T_14 V_120 ;
int V_83 ;
if ( ( V_83 = F_60 ( args -> V_49 , & V_120 , V_92 ) ) )
return V_83 ;
V_83 = F_58 ( args -> V_49 -> V_77 , V_120 ) == args -> V_76 -> V_34 ;
...
if ( ( V_83 = F_60 ( args -> V_49 , & V_120 , V_92 ) ) )
return V_83 ;
* V_119 = V_120 == args -> V_76 -> V_38 + args -> V_76 -> V_35 ;
return 0 ;
}
int
F_61 (
...
V_14 = V_49 -> V_77 ;
V_71 = args -> V_78 ;
V_124 = F_63 ( args -> V_76 , V_121 ) ;
if ( ( error = F_64 ( V_71 , V_49 , V_124 , args -> V_76 -> V_35 ,
V_126 , 0 , args -> V_90 , args -> V_81 ,
& V_125 ) ) ) {
return error ;
}
ASSERT ( V_125 ) ;
F_65 ( V_71 , V_123 ) ;
if ( V_121 >= F_66 ( args -> V_76 , V_39 ) )
return 0 ;
if ( V_49 -> V_51 . V_53 > F_67 ( args -> V_76 , V_121 + 1 , 0 ) )
return 0 ;
V_113 = V_124 ;
if ( ( error = F_68 ( V_71 , V_49 , & V_113 , V_92 ) ) ) {
return error ;
}
if ( V_121 == args -> V_76 -> V_36 )
ASSERT ( V_113 == 0 ) ;
else
ASSERT ( V_113 > 0 ) ;
V_49 -> V_51 . V_53 = F_58 ( V_14 , V_113 ) ;
F_59 ( V_71 , V_49 , V_118 ) ;
return 0 ;
}
