...
struct V_1 * V_2 = F_20 ( V_16 ) ;
struct V_4 * V_5 = V_2 -> V_6 -> V_7 ;
const struct V_92 * V_68 ;
int V_13 ;
V_68 = V_92 ( V_16 -> V_84 -> V_85 -> V_93 ) ;
if ( V_68 == NULL ) {
F_49 ( V_5 -> V_7 , L_1 ,
V_16 -> V_84 -> V_85 -> V_93 ) ;
V_13 = - V_94 ;
...
V_2 -> V_64 -> V_95 = V_88 ;
V_2 -> V_64 -> V_96 = V_89 ;
V_2 -> V_64 -> V_97 = V_15 -> V_35 ;
V_2 -> V_64 -> V_98 = V_15 -> V_43 ;
F_42 ( V_2 -> V_64 , V_16 -> V_84 -> V_85 ) ;
V_2 -> V_52 = 0 ;
return 0 ;
error:
...
static int F_52 ( struct V_49 * V_16 , int V_88 , int V_89 ,
struct V_90 * V_91 )
{
struct V_1 * V_2 = F_20 ( V_16 ) ;
V_2 -> V_64 -> V_95 = V_88 ;
...
{
struct V_101 * V_102 ;
struct V_103 * V_7 = V_2 -> V_16 . V_7 ;
unsigned long V_24 ;
F_55 ( & V_7 -> V_104 , V_24 ) ;
V_102 = V_2 -> V_102 ;
if ( V_102 && V_102 -> V_105 . V_106 == V_100 ) {
V_2 -> V_102 = NULL ;
V_102 -> V_105 . V_107 ( & V_102 -> V_105 ) ;
F_56 ( V_7 , V_2 -> V_18 ) ;
}
F_57 ( & V_7 -> V_104 , V_24 ) ;
}
...
return;
F_55 ( & V_7 -> V_104 , V_24 ) ;
F_59 ( V_7 , V_2 -> V_18 , V_102 ) ;
F_57 ( & V_7 -> V_104 , V_24 ) ;
F_56 ( V_7 , V_2 -> V_18 ) ;
}
static T_2 F_60 ( int V_108 , void * V_109 )
{
struct V_1 * V_2 = V_109 ;
T_2 V_13 = V_110 ;
T_1 V_111 ;
V_111 = F_1 ( V_2 , V_112 ) ;
F_3 ( V_2 , V_113 , V_111 & V_114 ) ;
if ( V_111 & V_115 ) {
...
int F_64 ( struct V_120 * V_121 , unsigned int V_18 )
{
static const unsigned int V_122 [] = {
V_123 , V_124 , V_125
} ;
struct V_4 * V_5 = V_121 -> V_7 ;
struct V_126 * V_127 = F_65 ( V_5 -> V_7 ) ;
struct V_1 * V_2 = & V_5 -> V_128 [ V_18 ] ;
struct V_49 * V_16 = & V_2 -> V_16 ;
unsigned int V_129 ;
char V_130 [ 5 ] ;
char * V_131 ;
...
int V_13 ;
if ( F_22 ( V_5 , V_132 ) ) {
sprintf ( V_130 , L_2 , V_18 ) ;
V_131 = V_130 ;
} else {
V_131 = NULL ;
}
V_2 -> clock = F_66 ( V_5 -> V_7 , V_131 ) ;
if ( F_67 ( V_2 -> clock ) ) {
...
V_2 -> V_18 = V_18 ;
V_2 -> V_82 = V_87 ;
V_2 -> V_64 = & V_121 -> V_57 . V_57 [ V_18 % 2 ] ;
V_2 -> V_64 -> V_16 = V_16 ;
V_13 = F_70 ( V_5 -> V_133 , V_16 , & V_134 ) ;
if ( V_13 < 0 )
return V_13 ;
F_71 ( V_16 , & V_135 ) ;
if ( F_22 ( V_5 , V_132 ) ) {
V_108 = F_72 ( V_127 , V_18 ) ;
V_129 = 0 ;
} else {
V_108 = F_72 ( V_127 , 0 ) ;
V_129 = V_136 ;
...
V_13 = F_73 ( V_5 -> V_7 , V_108 , F_60 , V_129 ,
F_74 ( V_5 -> V_7 ) , V_2 ) ;
if ( V_13 < 0 ) {
F_68 ( V_5 -> V_7 ,
L_5 , V_18 ) ;
...
void F_75 ( struct V_1 * V_2 , bool V_137 )
{
if ( V_137 ) {
F_3 ( V_2 , V_113 , V_138 ) ;
F_6 ( V_2 , V_139 , V_140 ) ;
