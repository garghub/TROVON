...
static int F_92 ( struct V_5 * V_6 , unsigned long V_8 )
{
...
static int F_95 ( struct V_5 * V_6 , unsigned long V_8 )
{
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_2 , V_6 -> V_65 ) ;
}
static T_1 F_98 ( struct V_1 * V_2 ,
struct V_15 * V_16 ,
const char * V_3 , T_2 V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_66 ) ;
}
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_8 , F_100 ( V_6 -> V_67 ) ) ;
}
static T_1 F_101 ( struct V_1 * V_2 ,
struct V_15 * V_16 ,
const char * V_3 , T_2 V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_68 ) ;
}
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_2 , V_6 -> V_69 ) ;
}
static T_1 F_103 ( struct V_1 * V_2 ,
struct V_15 * V_16 ,
const char * V_3 , T_2 V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_70 ) ;
}
static T_1 F_104 ( struct V_71 * V_72 , struct V_73 * V_74 ,
struct V_75 * V_76 ,
char * V_3 , T_4 V_77 , T_2 V_78 )
{
struct V_1 * V_10 = F_105 ( V_74 ) ;
struct V_5 * V_6 = F_3 ( V_10 ) ;
int V_79 ;
if ( V_77 % sizeof( struct V_80 ) != 0 )
return - V_14 ;
V_79 = F_106 ( V_6 , V_3 ,
...
int F_107 ( struct V_81 * V_10 )
{
struct V_73 * V_82 = & V_10 -> V_10 . V_74 ;
struct V_5 * V_6 = F_108 ( V_10 ) ;
int V_9 ;
V_9 = F_109 ( V_82 , & V_83 ) ;
if ( V_9 ) {
F_110 ( L_9 ,
V_84 , V_10 -> V_85 , V_83 . V_85 ) ;
goto V_86;
}
V_9 = F_111 ( V_82 , & V_87 ) ;
if ( V_9 ) {
F_110 ( L_10 ,
V_84 , V_10 -> V_85 , V_87 . V_16 . V_85 ) ;
goto V_88;
}
V_6 -> V_89 = F_112 ( V_90 , V_82 ) ;
if ( ! V_6 -> V_89 ) {
F_110 ( L_11 ,
V_84 , V_10 -> V_85 , V_90 ) ;
goto V_91;
...
return 0 ;
V_91:
F_113 ( & V_10 -> V_10 . V_74 , & V_87 ) ;
V_88:
F_114 ( & V_10 -> V_10 . V_74 , & V_83 ) ;
V_86:
return V_9 ;
}
void F_115 ( struct V_81 * V_10 )
{
struct V_73 * V_74 = & V_10 -> V_10 . V_74 ;
struct V_5 * V_6 = F_108 ( V_10 ) ;
F_116 ( V_6 -> V_89 ) ;
F_113 ( V_74 , & V_87 ) ;
F_114 ( V_74 , & V_83 ) ;
