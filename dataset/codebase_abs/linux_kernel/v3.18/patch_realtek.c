...
if ( V_2 -> V_70 -> V_227 )
return;
for ( V_67 = 0 ; V_67 < V_2 -> V_228 . V_229 ; V_67 ++ ) {
struct V_230 * V_158 = F_117 ( & V_2 -> V_228 , V_67 ) ;
if ( V_158 -> V_3 != V_226 )
F_3 ( V_2 , V_158 -> V_3 , 0 ,
V_231 , 0 ) ;
}
...
static void F_118 ( struct V_1 * V_2 , int V_233 )
{
F_21 ( V_2 , 0x04 , 1 << 11 , V_233 ? ( 1 << 11 ) : 0 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
T_1 V_235 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
bool V_236 ;
int V_237 ;
F_120 ( V_2 ) ;
if ( ! V_235 )
return;
V_236 = F_122 ( V_2 , V_235 ) ;
V_237 = F_7 ( V_2 , 0x78 ) ;
...
T_1 V_235 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
bool V_236 ;
if ( ! V_13 -> V_86 . V_87 . V_242 ) {
if ( V_13 -> V_86 . V_87 . V_90 == V_173 )
V_235 = V_13 -> V_86 . V_87 . V_89 [ 0 ] ;
}
F_125 ( V_2 ) ;
if ( ! V_235 )
return;
...
static void F_128 ( struct V_1 * V_2 , unsigned int V_243 ,
unsigned int V_5 )
{
F_2 ( V_2 , 0x51 , 0 , V_6 , V_243 >> 1 ) ;
F_2 ( V_2 , 0x51 , 0 , V_9 , V_5 & 0xffff ) ;
F_2 ( V_2 , 0x51 , 0 , V_9 , V_5 >> 16 ) ;
}
static int F_129 ( struct V_1 * V_2 , unsigned int V_243 )
{
unsigned int V_5 ;
F_2 ( V_2 , 0x51 , 0 , V_6 , V_243 >> 1 ) ;
...
F_29 ( 200 ) ;
V_148 ( V_2 , V_27 ) ;
V_256 = V_13 -> V_86 . V_144 ? V_257 : 0 ;
F_29 ( 100 ) ;
F_2 ( V_2 , 0x18 , 0 , V_231 ,
V_256 ) ;
F_29 ( 500 ) ;
F_2 ( V_2 , 0x18 , 0 , V_231 ,
V_256 ) ;
...
if ( V_57 == V_58 ) {
V_13 -> V_125 |= V_248 ;
V_13 -> V_86 . V_258 = F_148 ;
}
}
static void F_150 ( void * V_259 , int V_260 )
{
...
if ( V_13 -> V_262 )
V_260 = ! V_260 ;
V_261 = F_93 ( V_2 , V_13 -> V_263 ) ;
V_261 &= ~ V_264 ;
V_261 |= V_260 ? V_265 : V_174 ;
if ( V_13 -> V_263 )
F_151 ( V_2 , V_13 -> V_263 , V_261 ) ;
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
if ( V_266 != V_267 || V_3 == 0 ||
( V_3 != V_13 -> V_263 && V_3 != V_13 -> V_268 ) )
return V_266 ;
F_94 ( V_2 , V_3 ,
F_93 ( V_2 , V_3 ) ) ;
return V_269 ;
...
if ( V_57 != V_58 )
return;
while ( ( V_271 = F_154 ( V_272 , NULL , V_271 ) ) ) {
int V_273 , V_158 ;
if ( sscanf ( V_271 -> V_98 , L_17 , & V_273 , & V_158 ) != 2 )
continue;
if ( V_158 < 0x0a || V_158 >= 0x10 )
break;
V_13 -> V_262 = V_273 ;
V_13 -> V_263 = V_158 - 0x0a + 0x18 ;
V_13 -> V_86 . V_274 . V_275 = F_150 ;
V_13 -> V_86 . V_276 = 1 ;
V_2 -> V_277 = F_152 ;
F_38 ( V_2 ,
L_18 , V_13 -> V_263 ,
...
static void F_157 ( void * V_259 , int V_260 )
{
struct V_1 * V_2 = V_259 ;
struct V_12 * V_13 = V_2 -> V_13 ;
unsigned int V_278 = V_13 -> V_246 ;
if ( V_260 )
V_13 -> V_246 &= ~ 0x08 ;
else
V_13 -> V_246 |= 0x08 ;
...
if ( ! V_280 )
return;
if ( V_280 -> V_36 . integer . V_36 [ 0 ] ||
V_280 -> V_36 . integer . V_36 [ 1 ] )
V_13 -> V_246 &= ~ 0x10 ;
else
V_13 -> V_246 |= 0x10 ;
if ( V_13 -> V_246 != V_278 )
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
static const struct V_249 V_281 [] = {
{ 0x01 , V_167 , 0x18 } ,
{ 0x01 , V_168 , 0x18 } ,
{}
} ;
if ( V_57 == V_58 ) {
V_13 -> V_86 . V_274 . V_275 = F_157 ;
V_13 -> V_86 . V_282 = F_158 ;
V_13 -> V_246 = 0 ;
F_80 ( V_2 , V_281 ) ;
}
}
...
{
struct V_12 * V_13 = V_2 -> V_13 ;
unsigned int V_261 , V_283 , V_284 ;
V_261 = F_93 ( V_2 , V_13 -> V_268 ) ;
V_261 &= ~ V_264 ;
V_283 = V_261 | V_174 ;
V_284 = V_261 | V_265 ;
if ( ! V_280 )
...
{
static struct V_15 V_285 [] = {
F_165 ( 0x1b , 0x0c0b ) ,
F_165 ( 0x45 , 0xd089 ) ,
F_166 ( 0x57 , 0x05 , 1 << 14 , 0 ) ,
F_165 ( 0x06 , 0x6104 ) ,
F_167 ( 0x57 , 0x03 , 0x8aa6 ) ,
{}
} ;
static struct V_15 V_286 [] = {
F_165 ( 0x1b , 0x0c0b ) ,
F_165 ( 0x45 , 0xc429 ) ,
F_168 ( 0x35 , 0x4000 , 0 ) ,
F_165 ( 0x06 , 0x2104 ) ,
...
static struct V_15 V_288 [] = {
F_168 ( 0x10 , 7 << 8 , 6 << 8 ) ,
F_166 ( 0x57 , 0x05 , 1 << 15 | 1 << 13 , 0x0 ) ,
F_166 ( 0x57 , 0x03 , 1 << 10 , 1 << 10 ) ,
F_168 ( 0x1a , 1 << 3 , 1 << 3 ) ,
F_165 ( 0x45 , 0xc429 ) ,
F_168 ( 0x4a , 0x000f , 0x000e ) ,
{}
} ;
static struct V_15 V_289 [] = {
F_165 ( 0x15 , 0x0d40 ) ,
F_165 ( 0xb7 , 0x802b ) ,
{}
} ;
...
static void F_169 ( struct V_1 * V_2 , T_1 V_235 ,
T_1 V_226 )
{
static struct V_15 V_285 [] = {
F_167 ( 0x57 , 0x03 , 0x8aa6 ) ,
...
static struct V_15 V_288 [] = {
F_166 ( 0x57 , 0x05 , 0 , 1 << 15 | 1 << 13 ) ,
F_166 ( 0x57 , 0x03 , 1 << 10 , 0 ) ,
F_168 ( 0x1a , 1 << 3 , 0 ) ,
{}
} ;
...
F_29 ( 300 ) ;
V_5 = F_7 ( V_2 , 0xbe ) ;
V_292 = ( V_5 & 0x1c02 ) == 0x1c02 ;
break;
}
F_38 ( V_2 , L_24 ,
V_292 ? L_25 : L_26 ) ;
V_13 -> V_293 = V_292 ? V_294 : V_295 ;
}
static void F_174 ( struct V_1 * V_2 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
T_1 V_296 = V_13 -> V_86 . V_297 [ V_13 -> V_86 . V_298 [ 0 ] ] ;
T_1 V_235 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
int V_299 ;
if ( ! F_122 ( V_2 , V_235 ) )
V_299 = V_300 ;
else if ( V_296 == V_13 -> V_301 )
V_299 = V_302 ;
else if ( V_296 == V_13 -> V_303 )
V_299 = V_304 ;
else
V_299 = V_305 ;
if ( V_299 == V_13 -> V_306 ) {
...
if ( V_13 -> V_293 == V_294 )
F_171 ( V_2 ) ;
else if ( V_13 -> V_293 == V_295 )
F_172 ( V_2 ) ;
V_13 -> V_86 . V_144 = true ;
break;
case V_304 :
F_169 ( V_2 , V_235 , V_13 -> V_303 ) ;
V_13 -> V_86 . V_144 = false ;
break;
case V_305 :
F_170 ( V_2 ) ;
...
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_123 * V_124 = & V_13 -> V_86 . V_87 ;
for ( V_67 = 0 ; V_67 < V_124 -> V_311 ; V_67 ++ ) {
if ( V_124 -> V_312 [ V_67 ] . V_313 && ! V_13 -> V_301 )
V_13 -> V_301 = V_124 -> V_312 [ V_67 ] . V_158 ;
if ( V_124 -> V_312 [ V_67 ] . V_314 && ! V_13 -> V_303 )
V_13 -> V_303 = V_124 -> V_312 [ V_67 ] . V_158 ;
}
V_13 -> V_86 . V_282 = F_175 ;
V_13 -> V_86 . V_145 = F_174 ;
V_13 -> V_86 . V_258 = F_176 ;
}
...
if ( V_57 == V_63 ) {
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_317 * V_318 = & V_13 -> V_86 . V_319 ;
int V_67 ;
V_13 -> V_104 = F_184 ;
V_2 -> V_277 = F_187 ;
for ( V_67 = 0 ; V_67 < V_318 -> V_320 ; V_67 ++ ) {
if ( V_13 -> V_86 . V_297 [ V_67 ] == 0x12 ) {
V_13 -> V_86 . V_298 [ 0 ] = V_67 ;
break;
}
}
}
...
int V_67 ;
for ( V_67 = 0 ; V_67 < V_124 -> V_311 ; V_67 ++ ) {
if ( V_124 -> V_312 [ V_67 ] . type != V_322 )
continue;
V_3 = V_124 -> V_312 [ V_67 ] . V_158 ;
V_321 = F_36 ( V_2 , V_3 ) ;
if ( F_190 ( V_321 ) == V_323 )
continue;
return V_3 ;
}
return 0 ;
...
if ( V_57 == V_63 ) {
int V_226 = F_116 ( V_2 ) ;
int V_235 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
if ( F_10 ( ! V_226 || ! V_235 ) )
return;
F_192 ( V_2 , V_226 , V_235 ) ;
}
}
...
return;
for ( V_67 = 0 ; V_67 < V_124 -> V_311 ; V_67 ++ ) {
T_1 V_3 = V_124 -> V_312 [ V_67 ] . V_158 ;
unsigned int V_321 ;
if ( V_124 -> V_312 [ V_67 ] . type != V_322 )
continue;
V_321 = F_36 ( V_2 , V_3 ) ;
...
F_146 ( V_2 ) ;
if ( F_122 ( V_2 , 0x1b ) )
V_13 -> V_86 . V_324 |= ( 1ULL << 0x14 ) ;
}
static void F_199 ( struct V_1 * V_2 ,
const struct V_55 * V_56 , int V_57 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
static const struct V_249 V_325 [] = {
{ 0x01 , V_167 , 0x04 } ,
{ 0x01 , V_168 , 0x04 } ,
{ 0x01 , V_143 , 0x04 } ,
{}
} ;
static const struct V_149 V_326 [] = {
{ 0x1b , 0x21114000 } ,
{}
} ;
struct V_28 * V_29 ;
...
V_29 = F_15 ( V_2 , L_27 ) ;
if ( V_29 )
strcpy ( V_29 -> V_327 . V_98 , L_28 ) ;
V_29 = F_15 ( V_2 , L_29 ) ;
if ( V_29 )
strcpy ( V_29 -> V_327 . V_98 , L_27 ) ;
break;
}
}
...
if ( F_3 ( V_2 , 0x51 , 0 , V_333 , 0 ) == 0x10ec5505 ) {
V_13 -> V_245 = 1 ;
V_13 -> V_102 = F_132 ;
}
V_94 = F_114 ( V_2 ) ;
...
V_2 -> V_106 = V_139 ;
#ifdef F_204
V_2 -> V_106 . V_334 = F_134 ;
V_2 -> V_106 . V_335 = F_136 ;
#endif
if ( ! V_13 -> V_104 )
V_13 -> V_104 = F_119 ;
F_50 ( V_2 , V_63 ) ;
...
F_75 ( V_2 , NULL , V_340 , V_341 ) ;
F_50 ( V_2 , V_58 ) ;
V_94 = F_205 ( V_2 ) ;
if ( V_94 < 0 )
goto error;
if ( ! V_13 -> V_86 . V_137 )
F_76 ( V_13 , 0x23 , 0 , V_342 ) ;
V_2 -> V_106 = V_139 ;
#ifdef F_204
V_13 -> V_105 = F_54 ;
#endif
...
{
static const T_1 V_343 [] = { 0x1d , 0 } ;
static const T_1 V_344 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
return F_66 ( V_2 , V_343 , V_344 ) ;
}
static void F_210 ( struct V_1 * V_2 ,
const struct V_55 * V_56 , int V_57 )
{
if ( V_57 == V_58 ) {
F_211 ( V_2 , 0x18 , 0x00000734 ) ;
F_211 ( V_2 , 0x19 , 0x0000073c ) ;
}
}
...
static const T_1 V_348 [] = { 0x15 , 0x1b , 0x14 , 0x21 } ;
static const T_1 V_349 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
const T_1 * V_213 ;
...
if ( V_57 == V_101 ) {
struct V_12 * V_13 = V_2 -> V_13 ;
V_13 -> V_86 . V_350 [ 0 ] . V_351 [ 0 ] . V_352 = V_353 ;
}
}
static void F_217 ( void * V_259 , int V_260 )
{
struct V_1 * V_2 = V_259 ;
struct V_12 * V_13 = V_2 -> V_13 ;
unsigned int V_278 = V_13 -> V_246 ;
...
static unsigned int F_218 ( struct V_1 * V_2 ,
T_1 V_3 ,
unsigned int V_266 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
if ( V_3 == V_2 -> V_163 && V_266 == V_267 && V_13 -> V_246 )
return V_269 ;
return V_266 ;
}
...
static int T_2 F_224 ( void )
{
return F_225 ( & V_359 ) ;
}
static void T_3 F_226 ( void )
{
F_227 ( & V_359 ) ;
}
