...
struct V_23 * V_24 ;
int V_52 = 0 ;
if ( V_47 -> V_53 -> V_54 . V_55 [ 0 ] & V_56 &&
V_47 -> V_57 -> V_58 )
V_22 . V_51 |= F_4 ( V_59 ) ;
if ( V_50 != V_19 && V_47 -> V_60 == V_50 )
return 0 ;
switch ( V_50 ) {
case V_61 :
break;
...
V_52 = F_13 ( V_47 , V_65 , V_66 ,
sizeof( V_22 ) , & V_22 ) ;
if ( ! V_52 )
V_47 -> V_60 = V_50 ;
return V_52 ;
}
int F_14 ( struct V_46 * V_47 , struct V_3 * V_67 ,
bool V_68 )
{
enum V_49 V_50 ;
T_1 V_48 = V_62 ;
