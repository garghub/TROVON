...
V_89 = F_67 ( V_90 , V_84 , & V_88 ) ;
if ( F_68 ( * V_89 ) )
V_70 = ( * V_89 >> V_118 ) & V_119 ;
else {
if ( F_63 () )
F_64 ( L_3 ,
V_64 , ( long ) V_81 , V_45 ) ;
...
static int F_72 ( struct V_30 * V_31 , int V_57 ,
struct V_9 * V_10 )
{
struct V_9 * V_37 ;
struct V_58 * V_59 ;
...
int V_57 )
{
unsigned int V_33 = V_31 -> V_121 ++ ;
if ( F_76 ( V_31 -> V_121 >= F_1 () ) )
V_31 -> V_121 = 0 ;
if ( V_31 -> V_68 [ V_33 ] ) {
unsigned int V_122 = V_31 -> V_68 [ V_33 ] - 1 ;
V_31 -> V_65 [ V_122 ] &= ~ ( 1ULL << V_33 ) ;
}
...
int V_33 ;
int V_120 ;
V_120 = F_49 ( V_31 , V_75 , V_81 , V_37 , 1 , V_10 ,
V_59 ) ;
if ( V_120 )
return V_120 ;
if ( F_78 ( V_10 ) == V_49 ) {
...
V_33 = F_75 ( V_31 , V_59 , V_57 ) ;
F_17 ( V_31 , V_37 , V_10 , 1 , V_33 ) ;
return 0 ;
}
void F_79 ( struct V_40 * V_34 , V_52 V_25 , T_8 V_123 ,
unsigned int V_124 )
{
struct V_30 * V_31 = F_23 ( V_34 ) ;
struct V_125 * V_126 ;
...
switch ( V_32 ) {
case 0 :
V_126 = & V_31 -> V_60 [ V_32 ] [ V_57 ] ;
if ( ! ( V_126 -> V_59 . V_13 & V_61 ) ) {
F_72 ( V_31 , V_57 , & V_10 ) ;
} else {
F_46 ( V_34 , V_37 , V_49 ,
& V_126 -> V_59 , V_25 , & V_10 ) ;
F_17 ( V_31 , V_37 , & V_10 , 0 , 0 ) ;
}
break;
case 1 : {
T_5 V_81 = V_123 >> V_46 ;
F_77 ( V_31 , V_25 , V_81 , V_37 , & V_10 ,
V_57 ) ;
break;
}
default:
...
int F_83 ( struct V_40 * V_34 , enum V_127 type ,
T_1 * V_128 )
{
T_9 V_129 ;
T_10 V_130 ;
...
unsigned long V_13 ;
V_129 = F_84 ( V_34 ) ;
V_133 = ( V_34 -> V_36 . V_43 -> V_77 & V_135 ) >> V_136 ;
F_5 ( V_13 ) ;
F_6 ( V_27 , ( V_34 -> V_36 . V_137 << V_138 ) | V_133 ) ;
F_6 ( V_139 , V_140 | F_85 ( V_34 ) ) ;
...
V_131 = F_12 ( V_141 ) ;
#else
V_131 = ( ( V_52 ) F_12 ( V_21 ) << 32 ) | V_4 ;
#endif
F_9 ( V_13 ) ;
if ( ! ( V_16 & V_47 ) )
return V_142 ;
V_76 = V_34 -> V_36 . V_43 -> V_77 & V_78 ;
if ( F_76 ( ( V_76 && ! ( V_4 & V_143 ) ) ||
( ! V_76 && ! ( V_4 & V_144 ) ) ) ) {
F_87 (
L_4 ,
V_64 , V_129 ) ;
...
if ( F_88 ( V_34 , V_145 ) &&
F_76 ( ( V_18 & V_146 ) || ( V_18 & V_147 ) || ! ( V_18 & V_51 ) ) ) {
F_87 (
L_5 ,
V_64 , V_129 ) ;
return V_142 ;
...
V_132 = F_26 ( V_45 ) ;
V_25 = ( unsigned long ) F_91 ( V_132 ) ;
* V_128 = * ( T_1 * ) ( V_25 | ( unsigned long ) ( V_130 & ~ V_44 ) ) ;
F_92 ( ( T_1 * ) V_25 ) ;
return V_148 ;
}
int F_83 ( struct V_40 * V_34 , enum V_127 type ,
...
int F_93 ( struct V_35 * V_35 , unsigned long V_84 )
{
F_94 ( V_84 ) ;
F_95 ( V_35 ) ;
return 0 ;
}
int F_96 ( struct V_35 * V_35 , unsigned long V_100 , unsigned long V_101 )
{
F_93 ( V_35 , V_100 ) ;
return 0 ;
}
int F_97 ( struct V_35 * V_35 , unsigned long V_100 , unsigned long V_101 )
{
return 0 ;
}
int F_98 ( struct V_35 * V_35 , unsigned long V_84 )
{
return 0 ;
}
void F_99 ( struct V_35 * V_35 , unsigned long V_84 , T_6 V_149 )
{
F_93 ( V_35 , V_84 ) ;
}
...
V_1 [ 0 ] . V_2 / V_1 [ 0 ] . V_154 ;
V_1 [ 1 ] . V_157 = 1 ;
V_31 -> V_68 = F_102 ( sizeof( unsigned int ) *
V_1 [ 1 ] . V_2 ,
V_158 ) ;
if ( ! V_31 -> V_68 )
return - V_114 ;
