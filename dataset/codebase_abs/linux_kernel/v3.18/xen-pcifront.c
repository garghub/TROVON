...
static void F_55 ( struct V_44 * V_6 )
{
struct V_58 * V_24 ;
while ( ! F_56 ( & V_6 -> V_93 ) ) {
V_24 = F_57 ( V_6 -> V_93 . V_94 , struct V_58 ,
V_95 ) ;
F_7 ( & V_24 -> V_24 , L_29 ) ;
F_58 ( V_24 ) ;
}
...
F_46 () ;
F_60 (bus_entry, t, &pdev->root_buses, list) {
F_61 ( & V_86 -> V_91 ) ;
F_55 ( V_86 -> V_6 ) ;
F_52 ( V_86 -> V_6 -> V_53 ) ;
F_62 ( V_86 -> V_6 -> V_97 ) ;
...
V_4 -> V_20 -> V_102 . V_28 = F_64 ( V_49 , V_4 , V_98 ) ;
F_11 () ;
...
static T_6 F_69 ( int V_33 , void * V_24 )
{
struct V_1 * V_4 = V_24 ;
F_4 ( V_4 ) ;
return V_117 ;
...
static struct V_1 * F_76 ( struct V_121 * V_23 )
{
struct V_1 * V_4 ;
V_4 = F_77 ( sizeof( struct V_1 ) , V_88 ) ;
if ( V_4 == NULL )
goto V_43;
V_4 -> V_20 =
(struct V_122 * ) F_78 ( V_88 ) ;
if ( V_4 -> V_20 == NULL ) {
F_52 ( V_4 ) ;
V_4 = NULL ;
goto V_43;
...
F_85 ( V_4 -> V_33 , V_4 ) ;
if ( V_4 -> V_32 != V_124 )
F_86 ( V_4 -> V_23 , V_4 -> V_32 ) ;
if ( V_4 -> V_125 != V_126 )
F_87 ( V_4 -> V_125 , 0 ,
( unsigned long ) V_4 -> V_20 ) ;
else
F_88 ( ( unsigned long ) V_4 -> V_20 ) ;
F_79 ( & V_4 -> V_23 -> V_24 , NULL ) ;
F_52 ( V_4 ) ;
}
...
int V_28 = 0 ;
struct V_127 V_128 ;
V_28 = F_90 ( V_4 -> V_23 , F_91 ( V_4 -> V_20 ) ) ;
if ( V_28 < 0 )
goto V_43;
V_4 -> V_125 = V_28 ;
V_28 = F_92 ( V_4 -> V_23 , & V_4 -> V_32 ) ;
if ( V_28 )
goto V_43;
V_28 = F_93 ( V_4 -> V_32 , F_69 ,
0 , L_42 , V_4 ) ;
if ( V_28 < 0 )
return V_28 ;
V_4 -> V_33 = V_28 ;
...
V_28 = F_96 ( V_128 , V_4 -> V_23 -> V_130 ,
L_45 , L_46 , V_4 -> V_125 ) ;
if ( ! V_28 )
V_28 = F_96 ( V_128 , V_4 -> V_23 -> V_130 ,
L_47 , L_46 , V_4 -> V_32 ) ;
...
V_28 = F_101 ( V_138 , V_4 -> V_23 -> V_139 ,
L_54 , L_55 , & V_135 ) ;
if ( V_28 == - V_140 ) {
F_102 ( V_4 -> V_23 , V_28 ,
L_56 ) ;
...
if ( F_103 ( V_136 >= ( sizeof( V_137 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_101 ( V_138 , V_4 -> V_23 -> V_139 , V_137 ,
L_59 , & V_5 , & V_6 ) ;
if ( V_28 != 2 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
...
V_141 )
goto V_43;
V_28 = F_101 ( V_138 , V_4 -> V_23 -> V_139 , L_62 , L_55 ,
& V_147 ) ;
if ( V_28 != 1 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
...
if ( F_103 ( V_150 >= ( sizeof( V_137 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_101 ( V_138 , V_4 -> V_23 -> V_139 , V_137 , L_55 ,
& V_98 ) ;
if ( V_28 != 1 )
V_98 = V_151 ;
if ( V_98 != V_144 )
...
V_28 = F_98 ( V_4 -> V_23 , V_146 ) ;
V_43:
return V_28 ;
}
static void T_7 F_109 ( struct V_121 * V_23 ,
enum V_142 V_152 )
{
struct V_1 * V_4 = F_110 ( & V_23 -> V_24 ) ;
switch ( V_152 ) {
case V_151 :
case V_153 :
case V_154 :
...
static int F_111 ( struct V_121 * V_23 ,
const struct V_156 * V_157 )
{
int V_28 = 0 ;
struct V_1 * V_4 = F_76 ( V_23 ) ;
if ( V_4 == NULL ) {
V_28 = - V_89 ;
F_95 ( V_23 , V_28 ,
L_71 ) ;
...
static int F_112 ( struct V_121 * V_23 )
{
struct V_1 * V_4 = F_110 ( & V_23 -> V_24 ) ;
if ( V_4 )
F_83 ( V_4 ) ;
