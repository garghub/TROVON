...
case V_123 :
V_53 -> V_58 = & F_1 ;
V_53 -> V_161 = F_29 ( V_162 ) ;
V_53 -> V_112 = V_163 ;
V_107 = V_162 ;
break;
case V_127 :
V_53 -> V_58 = & F_2 ;
V_53 -> V_161 = F_29 ( V_164 ) ;
V_53 -> V_112 = V_165 ;
V_107 = V_164 ;
break;
default:
...
V_53 -> V_93 = F_27 ( & V_133 -> V_50 , V_53 -> V_161 *
sizeof( struct V_167 ) , V_145 ) ;
if ( ! V_53 -> V_93 )
return - V_158 ;
V_53 -> V_107 = F_27 ( & V_133 -> V_50 , V_53 -> V_161 *
sizeof( struct V_154 * ) , V_145 ) ;
if ( ! V_53 -> V_107 )
return - V_158 ;
V_53 -> V_155 = F_27 ( & V_133 -> V_50 , V_53 -> V_161 *
sizeof( struct V_49 * ) , V_145 ) ;
if ( ! V_53 -> V_155 )
return - V_158 ;
for ( V_156 = 0 ; V_156 < V_53 -> V_161 && V_156 < V_168 ;
V_156 ++ , V_107 ++ ) {
V_53 -> V_107 [ V_156 ] = V_107 ;
V_53 -> V_93 [ V_156 ] . V_169 = V_107 -> V_169 ;
V_53 -> V_93 [ V_156 ] . V_170 = V_107 -> V_171 ;
V_53 -> V_93 [ V_156 ] . V_1 = V_156 ;
V_53 -> V_93 [ V_156 ] . V_172 = V_107 -> V_172 ;
V_53 -> V_93 [ V_156 ] . V_173 = V_107 -> V_174 ;
if ( V_156 == V_6 || V_156 == V_8 ) {
V_53 -> V_93 [ V_156 ] . V_175 = & V_176 ;
V_53 -> V_93 [ V_156 ] . V_172 = V_100 *
V_177 ;
V_53 -> V_93 [ V_156 ] . V_178 = 12500 ;
} else if ( V_156 == V_10 ) {
if ( F_24 ( V_54 ) == V_123 ) {
V_53 -> V_93 [ V_156 ] . V_175 = & V_179 ;
V_53 -> V_93 [ V_156 ] . V_94 = V_107 -> V_108 ;
} else {
V_53 -> V_93 [ V_156 ] . V_175 = & V_176 ;
V_53 -> V_93 [ V_156 ] . V_178 = 5000 ;
}
} else if ( V_156 == V_28 &&
F_24 ( V_54 ) == V_123 ) {
V_53 -> V_93 [ V_156 ] . V_175 = & V_180 ;
V_53 -> V_93 [ V_156 ] . V_94 = V_107 -> V_108 ;
} else {
if ( F_24 ( V_54 ) == V_123 ) {
V_53 -> V_93 [ V_156 ] . V_175 = & V_181 ;
V_53 -> V_93 [ V_156 ] . V_94 = V_107 -> V_108 ;
} else {
V_53 -> V_93 [ V_156 ] . V_175 = & V_182 ;
}
}
...
F_35 ( V_54 -> V_50 ,
L_14 ) ;
V_53 -> V_93 [ V_156 ] . type = V_183 ;
V_53 -> V_93 [ V_156 ] . V_184 = V_185 ;
V_53 -> V_93 [ V_156 ] . V_186 = V_53 -> V_58 ( V_156 ) ;
V_53 -> V_93 [ V_156 ] . V_187 = V_188 ;
V_153 . V_50 = V_54 -> V_50 ;
V_153 . V_150 = V_136 -> V_149 [ V_156 ] ;
V_153 . V_189 = V_53 ;
V_153 . V_190 = V_54 -> V_190 ;
if ( V_135 )
V_153 . V_146 = V_135 [ V_156 ] . V_146 ;
V_155 = F_36 ( & V_133 -> V_50 , & V_53 -> V_93 [ V_156 ] ,
& V_153 ) ;
if ( F_37 ( V_155 ) ) {
F_23 ( V_54 -> V_50 ,
L_15 ,
...
int V_156 ;
for ( V_156 = 0 ; V_156 < V_53 -> V_161 ; V_156 ++ ) {
int V_157 ;
if ( ! V_53 -> V_155 [ V_156 ] )
continue;
