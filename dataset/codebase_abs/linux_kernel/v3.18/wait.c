...
int T_3 F_41 (
void * V_32 , int V_33 , T_4 * V_31 ,
unsigned V_10 , unsigned long V_34 )
{
T_1 * V_30 = F_39 ( V_32 , V_33 ) ;
F_40 ( V_7 , V_32 , V_33 ) ;
V_7 . V_4 . V_34 = V_35 + V_34 ;
return F_37 ( V_30 , & V_7 , V_31 , V_10 ) ;
}
int T_3
...
int T_3 F_44 ( void * V_32 , int V_33 ,
T_4 * V_31 , unsigned V_10 )
{
T_1 * V_30 = F_39 ( V_32 , V_33 ) ;
F_40 ( V_7 , V_32 , V_33 ) ;
return F_42 ( V_30 , & V_7 , V_31 , V_10 ) ;
}
void F_45 ( T_1 * V_30 , void * V_32 , int V_33 )
{
struct V_26 V_4 = F_46 ( V_32 , V_33 ) ;
if ( F_32 ( V_30 ) )
F_15 ( V_30 , V_36 , 1 , & V_4 ) ;
}
void F_47 ( void * V_32 , int V_33 )
{
F_45 ( F_39 ( V_32 , V_33 ) , V_32 , V_33 ) ;
}
T_1 * F_39 ( void * V_32 , int V_33 )
{
const int V_37 = V_38 == 32 ? 5 : 6 ;
const struct V_39 * V_39 = F_48 ( F_49 ( V_32 ) ) ;
unsigned long V_40 = ( unsigned long ) V_32 << V_37 | V_33 ;
return & V_39 -> V_41 [ F_50 ( V_40 , V_39 -> V_42 ) ] ;
}
static inline T_1 * F_51 ( T_5 * V_43 )
{
if ( V_38 == 64 ) {
unsigned long V_1 = ( unsigned long ) V_43 ;
...
break;
V_24 = (* V_31)( V_40 ) ;
} while ( ! V_24 && F_53 ( V_40 ) != 0 );
F_27 ( V_30 , & V_1 -> V_7 ) ;
return V_24 ;
}
T_3 int F_55 ( T_5 * V_43 , int (* V_31)( T_5 * ) ,
unsigned V_10 )
{
T_1 * V_30 = F_51 ( V_43 ) ;
F_56 ( V_7 , V_43 ) ;
return F_54 ( V_30 , & V_7 , V_31 , V_10 ) ;
}
void F_57 ( T_5 * V_43 )
{
F_45 ( F_51 ( V_43 ) , V_43 , V_44 ) ;
}
T_3 int F_58 ( struct V_26 * V_32 )
{
...
T_3 int F_62 ( struct V_26 * V_32 )
{
unsigned long V_45 = F_63 ( V_35 ) ;
if ( F_26 ( V_18 -> V_17 , V_18 ) )
return 1 ;
if ( F_64 ( V_45 , V_32 -> V_34 ) )
return - V_46 ;
F_65 ( V_32 -> V_34 - V_45 ) ;
return 0 ;
}
T_3 int F_66 ( struct V_26 * V_32 )
{
unsigned long V_45 = F_63 ( V_35 ) ;
if ( F_26 ( V_18 -> V_17 , V_18 ) )
return 1 ;
