...
{
struct V_60 * V_32 ;
V_32 = F_14 ( V_59 , struct V_60 , V_59 ) ;
F_15 ( & V_32 -> V_61 ) ;
F_16 ( V_32 ) ;
}
static struct V_60 * F_17 ( int V_62 , char * V_63 ,
...
static int F_25 ( struct V_2 * V_3 , int V_38 ,
...
int V_78 , V_86 ;
struct V_87 * V_88 ;
V_78 = F_25 ( V_3 , 0xC8 , sizeof( struct V_87 ) , V_23 ) ;
if ( V_78 == V_89 ) {
V_88 = & V_23 -> V_80 . V_90 ;
if ( V_88 -> V_38 != 0xc8 )
return V_91 ;
...
static int F_28 ( struct V_2 * V_3 , struct V_1 * V_23 )
{
int V_78 ;
struct V_96 * V_88 ;
V_23 -> V_97 = V_98 ;
V_78 = F_25 ( V_3 , 0xC9 , sizeof( struct V_96 ) , V_23 ) ;
if ( V_78 == V_89 ) {
V_88 = & V_23 -> V_80 . V_99 ;
if ( ( V_88 -> V_100 >> 5 ) & 0x1 )
V_23 -> V_101 = V_102 ;
...
int V_78 , V_62 ;
struct V_113 * V_88 ;
V_78 = F_25 ( V_3 , 0xC4 , sizeof( struct V_113 ) , V_23 ) ;
if ( V_78 == V_89 ) {
...
V_62 = 1 ;
F_30 ( & V_116 ) ;
V_23 -> V_32 = F_17 ( V_62 , V_63 , V_64 , V_3 ) ;
if ( ! V_23 -> V_32 )
V_78 = V_79 ;
F_31 ( & V_116 ) ;
}
...
static int F_32 ( struct V_2 * V_3 , struct V_1 * V_23 )
{
int V_78 ;
struct V_117 * V_88 ;
V_78 = F_25 ( V_3 , 0xC2 , sizeof( struct V_117 ) , V_23 ) ;
if ( V_78 == V_89 ) {
...
V_32 = V_30 -> V_23 -> V_32 ;
F_30 ( & V_32 -> V_72 ) ;
F_41 ( & V_30 -> V_140 , & V_32 -> V_75 ) ;
if ( ! V_32 -> V_70 ) {
V_32 -> V_70 = 1 ;
V_32 -> V_71 = V_3 ;
F_42 ( V_146 , & V_32 -> V_73 ) ;
}
F_31 ( & V_32 -> V_72 ) ;
return V_89 ;
}
...
static int F_44 ( struct V_2 * V_3 , struct V_6 * V_148 )
{
struct V_1 * V_23 = F_1 ( V_3 ) ;
int V_124 = V_149 ;
if ( V_23 -> V_97 != V_98 ) {
...
V_4 -> V_163 = & V_164 ;
V_23 = (struct V_1 * ) V_4 -> V_5 ;
V_23 -> V_50 = V_165 ;
V_23 -> V_97 = V_98 ;
V_78 = F_27 ( V_3 , V_23 , V_63 , V_64 ) ;
if ( V_78 != V_89 )
goto V_166;
V_78 = F_29 ( V_3 , V_23 , V_63 , V_64 ) ;
if ( V_78 != V_89 )
goto V_166;
V_78 = F_28 ( V_3 , V_23 ) ;
if ( V_78 != V_89 )
...
if ( ! F_49 ( V_168 ) )
goto V_167;
F_50 ( V_3 -> V_11 -> V_169 , V_159 ) ;
V_3 -> V_4 = V_4 ;
F_51 ( V_3 -> V_11 -> V_169 , V_159 ) ;
F_6 ( V_170 , V_3 ,
L_11 ,
V_161 , V_23 -> V_50 , V_101 [ ( int ) V_23 -> V_101 ] ,
V_105 [ ( int ) V_23 -> V_105 ] ) ;
return 0 ;
V_167:
F_30 ( & V_116 ) ;
F_52 ( & V_23 -> V_32 -> V_59 , F_13 ) ;
F_31 ( & V_116 ) ;
V_166:
F_16 ( V_4 ) ;
F_6 ( V_160 , V_3 , L_12 ,
