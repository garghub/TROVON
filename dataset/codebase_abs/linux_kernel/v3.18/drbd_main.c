...
F_302 ( & V_22 -> V_476 , V_5 -> V_73 ) ;
F_302 ( & V_481 , F_48 ( V_5 ) ) ;
F_307 ( V_5 -> V_458 ) ;
F_304 () ;
F_308 ( & V_5 -> V_58 , V_577 , F_206 ) ;
}
static int T_8 F_309 ( void )
{
int V_110 ;
if ( V_443 < V_578 || V_443 > V_579 ) {
F_310 ( L_53 , V_443 ) ;
#ifdef F_311
return - V_580 ;
#else
...
goto V_515;
V_110 = - V_452 ;
V_478 = F_315 ( L_38 , V_584 | V_585 , NULL , & V_586 , NULL ) ;
if ( ! V_478 ) {
F_310 ( L_56 ) ;
goto V_515;
}
V_464 . V_475 = F_316 ( L_57 ) ;
if ( ! V_464 . V_475 ) {
F_310 ( L_58 ) ;
goto V_515;
}
...
void F_189 ( struct V_591 * V_128 )
{
if ( V_128 == NULL )
return;
F_320 ( V_128 -> V_188 , V_592 | V_351 | V_593 ) ;
F_320 ( V_128 -> V_594 , V_592 | V_351 | V_593 ) ;
F_55 ( V_128 -> V_120 ) ;
F_55 ( V_128 ) ;
}
static void F_321 ( struct V_102 * V_595 )
{
struct V_104 * V_24 ;
F_71 ( & V_595 -> V_106 ) ;
V_24 = V_595 -> V_104 ;
...
V_100 -> V_598 = F_90 ( F_105 ( V_5 -> V_196 ) ) ;
for ( V_158 = V_162 ; V_158 < V_163 ; V_158 ++ )
...
V_100 -> V_602 = F_64 ( V_5 -> V_455 -> V_603 ) ;
V_100 -> V_604 = F_64 ( V_605 ) ;
V_100 -> V_606 = F_90 ( V_5 -> V_128 -> V_160 . V_606 ) ;
V_100 -> V_607 = F_64 ( V_5 -> V_128 -> V_160 . V_607 ) ;
V_100 -> V_608 = F_64 ( V_5 -> V_412 ) ;
V_100 -> V_609 = F_64 ( V_5 -> V_128 -> V_160 . V_609 ) ;
V_100 -> V_610 = F_64 ( V_5 -> V_128 -> V_160 . V_610 ) ;
F_97 ( V_5 , F_326 ( V_5 -> V_128 ) == V_5 -> V_128 -> V_160 . V_611 ) ;
V_254 = V_5 -> V_128 -> V_160 . V_611 ;
if ( F_327 ( V_5 , V_5 -> V_128 , V_254 , V_612 ) ) {
F_11 ( V_5 , L_67 ) ;
F_328 ( V_5 , 1 , V_613 ) ;
}
}
...
goto V_324;
F_325 ( V_5 , V_100 ) ;
V_5 -> V_128 -> V_160 . V_598 = F_105 ( V_5 -> V_196 ) ;
F_332 ( V_5 ) ;
V_324:
F_85 ( V_5 ) ;
}
...
struct V_617 * V_618 )
{
T_5 V_609 = F_334 ( V_616 -> V_609 ) ;
T_5 V_610 = F_334 ( V_616 -> V_610 ) ;
T_3 V_619 ;
if ( V_609 == 0 && V_610 == 0 ) {
V_609 = 1 ;
V_610 = V_620 / 8 ;
...
static int F_335 ( struct V_4 * V_5 , struct V_591 * V_345 )
{
T_4 V_621 = F_105 ( V_345 -> V_594 ) ;
struct V_617 * V_618 = & V_345 -> V_160 ;
T_9 V_622 ;
T_9 V_623 ;
if ( V_618 -> V_601 < 0 ) {
...
goto V_110;
if ( V_621 - V_618 -> V_600 < F_336 ( V_345 ) )
goto V_110;
...
int F_337 ( struct V_4 * V_5 , struct V_591 * V_345 )
{
struct V_597 * V_100 ;
T_5 V_92 , V_44 ;
int V_158 , V_333 = V_576 ;
if ( V_5 -> V_10 . V_11 != V_363 )
return V_627 ;
V_100 = F_331 ( V_5 , V_291 ) ;
if ( ! V_100 )
return V_547 ;
V_345 -> V_160 . V_625 = V_345 -> V_120 -> V_625 ;
V_345 -> V_160 . V_611 = F_326 ( V_345 ) ;
if ( F_327 ( V_5 , V_345 , V_345 -> V_160 . V_611 , V_628 ) ) {
F_11 ( V_5 , L_72 ) ;
V_333 = V_629 ;
goto V_110;
}
...
if ( F_334 ( V_100 -> V_604 ) != V_605 ) {
F_11 ( V_5 , L_76 ,
F_334 ( V_100 -> V_604 ) , V_605 ) ;
goto V_110;
}
V_345 -> V_160 . V_598 = F_338 ( V_100 -> V_598 ) ;
for ( V_158 = V_162 ; V_158 < V_163 ; V_158 ++ )
V_345 -> V_160 . V_164 [ V_158 ] = F_338 ( V_100 -> V_164 [ V_158 ] ) ;
V_345 -> V_160 . V_44 = F_334 ( V_100 -> V_44 ) ;
V_345 -> V_160 . V_606 = F_338 ( V_100 -> V_606 ) ;
V_345 -> V_160 . V_600 = F_334 ( V_100 -> V_600 ) ;
V_345 -> V_160 . V_601 = F_334 ( V_100 -> V_601 ) ;
V_345 -> V_160 . V_607 = F_334 ( V_100 -> V_607 ) ;
if ( F_333 ( V_5 , V_100 , & V_345 -> V_160 ) )
goto V_110;
if ( F_335 ( V_5 , V_345 ) )
goto V_110;
if ( F_334 ( V_100 -> V_607 ) != V_345 -> V_160 . V_607 ) {
F_11 ( V_5 , L_77 ,
F_334 ( V_100 -> V_607 ) , V_345 -> V_160 . V_607 ) ;
goto V_110;
}
if ( F_334 ( V_100 -> V_600 ) != V_345 -> V_160 . V_600 ) {
F_11 ( V_5 , L_78 ,
F_334 ( V_100 -> V_600 ) , V_345 -> V_160 . V_600 ) ;
goto V_110;
}
V_333 = V_576 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
...
unsigned int V_360 ;
V_360 = F_334 ( V_100 -> V_608 ) ;
V_360 = F_339 ( V_360 , V_413 ) ;
V_5 -> V_412 = V_360 ;
}
F_14 ( & V_5 -> V_22 -> V_23 ) ;
V_110:
...
{
if ( ! F_341 ( V_614 , & V_5 -> V_44 ) ) {
F_342 ( & V_5 -> V_399 , V_635 + V_636 ) ;
V_5 -> V_637 . line = line ;
V_5 -> V_637 . F_32 = F_32 ;
}
}
...
void F_345 ( struct V_4 * V_5 , int V_638 , T_3 V_203 ) __must_hold( T_10 )
{
if ( V_638 == V_162 ) {
if ( V_5 -> V_10 . V_349 == V_350 )
V_203 |= 1 ;
...
void F_347 ( struct V_4 * V_5 , int V_638 , T_3 V_203 ) __must_hold( T_10 )
{
unsigned long V_44 ;
F_24 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
F_345 ( V_5 , V_638 , V_203 ) ;
F_26 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
}
void F_99 ( struct V_4 * V_5 , int V_638 , T_3 V_203 ) __must_hold( T_10 )
{
unsigned long V_44 ;
F_24 ( & V_5 -> V_128 -> V_160 . V_161 , V_44 ) ;
...
static int V_397 ( struct V_494 * V_391 , int V_640 )
{
struct V_4 * V_5 =
F_207 ( V_391 , struct V_4 , V_390 . V_391 ) ;
struct V_390 * V_641 = & V_5 -> V_390 ;
int V_333 = - V_115 ;
F_97 ( V_5 , F_217 ( & V_5 -> V_366 ) == 0 ) ;
if ( F_84 ( V_5 ) ) {
F_355 ( V_5 , V_641 -> V_642 , V_641 -> V_44 ) ;
V_333 = V_641 -> V_643 ( V_5 ) ;
F_356 ( V_5 ) ;
F_85 ( V_5 ) ;
}
F_357 ( V_644 , & V_5 -> V_44 ) ;
F_7 ( & V_5 -> V_12 ) ;
if ( V_641 -> V_497 )
V_641 -> V_497 ( V_5 , V_333 ) ;
F_160 ( V_645 , & V_5 -> V_44 ) ;
V_641 -> V_642 = NULL ;
V_641 -> V_44 = 0 ;
return 0 ;
}
...
if ( V_5 -> V_390 . V_642 )
F_11 ( V_5 , L_81 ,
V_642 , V_5 -> V_390 . V_642 ) ;
V_5 -> V_390 . V_643 = V_643 ;
V_5 -> V_390 . V_497 = V_497 ;
V_5 -> V_390 . V_642 = V_642 ;
V_5 -> V_390 . V_44 = V_44 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
F_150 ( V_644 , & V_5 -> V_44 ) ;
if ( F_217 ( & V_5 -> V_366 ) == 0 ) {
if ( ! F_341 ( V_645 , & V_5 -> V_44 ) )
F_249 ( & F_22 ( V_5 ) -> V_14 -> V_431 ,
& V_5 -> V_390 . V_391 ) ;
}
F_14 ( & V_5 -> V_22 -> V_23 ) ;
}
int F_359 ( struct V_4 * V_5 , int (* V_643)( struct V_4 * ) ,
char * V_642 , enum V_646 V_44 )
{
int V_333 ;
F_97 ( V_5 , V_46 != F_22 ( V_5 ) -> V_14 -> V_465 . V_55 ) ;
...
void F_351 ( struct V_4 * V_5 , int V_648 ) __must_hold( T_10 )
{
if ( ( V_5 -> V_128 -> V_160 . V_44 & V_648 ) != V_648 ) {
F_343 ( V_5 ) ;
V_5 -> V_128 -> V_160 . V_44 |= V_648 ;
}
}
void F_131 ( struct V_4 * V_5 , int V_648 ) __must_hold( T_10 )
{
if ( ( V_5 -> V_128 -> V_160 . V_44 & V_648 ) != 0 ) {
F_343 ( V_5 ) ;
V_5 -> V_128 -> V_160 . V_44 &= ~ V_648 ;
}
}
int F_128 ( struct V_591 * V_345 , int V_648 )
{
return ( V_345 -> V_160 . V_44 & V_648 ) != 0 ;
}
...
int F_365 ( struct V_4 * V_5 , struct V_679 * V_158 )
{
struct V_118 * V_119 ;
F_366 ( V_67 ) ;
long V_680 ;
...
V_680 = V_119 -> V_274 ? V_119 -> V_680 * V_636 / 10 * V_119 -> V_274 : V_682 ;
F_49 () ;
V_158 -> V_683 = true ;
F_367 ( & V_5 -> V_12 , & V_67 , V_684 ) ;
F_14 ( & V_5 -> V_22 -> V_23 ) ;
V_680 = F_368 ( V_680 ) ;
F_369 ( & V_5 -> V_12 , & V_67 ) ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
if ( ! V_680 || V_5 -> V_10 . V_32 < V_258 )
return - V_681 ;
if ( F_370 ( V_46 ) )
return - V_685 ;
return 0 ;
...
F_371 ( struct V_686 * V_687 )
{
long V_688 ;
if ( ! V_687 -> V_689 -- ) {
F_98 ( & V_688 , sizeof( V_688 ) ) ;
V_687 -> V_10 += V_688 ;
V_687 -> V_689 = V_690 ;
}
V_687 -> V_10 = V_687 -> V_10 * V_691 + V_692 ;
return F_372 ( V_687 -> V_10 ) ;
}
static char *
...
return ( type < V_704 ) ? V_693 [ type ] : L_141 ;
}
unsigned int
F_374 ( struct V_4 * V_5 , unsigned int type )
{
static struct V_686 V_705 = { 0 , 0 } ;
unsigned int V_706 = (
( V_707 == 0 ||
( ( 1 << F_48 ( V_5 ) ) & V_707 ) != 0 ) &&
( ( ( F_371 ( & V_705 ) % 100 ) + 1 ) <= V_708 ) ) ;
if ( V_706 ) {
V_709 ++ ;
if ( F_375 ( & V_710 ) )
F_159 ( V_5 , L_142 ,
...
{
static char V_711 [ 38 ] = L_143 ;
if ( V_711 [ 0 ] == 0 ) {
#ifdef F_311
sprintf ( V_711 , L_144 , V_61 -> V_712 ) ;
#else
V_711 [ 0 ] = 'b' ;
#endif
}
