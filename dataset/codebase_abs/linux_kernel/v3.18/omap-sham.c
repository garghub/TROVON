...
F_91 ( V_2 -> V_52 ) ;
if ( V_15 -> V_32 . V_146 )
V_15 -> V_32 . V_146 ( & V_15 -> V_32 , V_54 ) ;
F_42 ( & V_2 -> V_96 ) ;
}
...
F_77 ( & V_132 . V_133 ) ;
V_54 = F_108 ( V_29 -> V_160 , V_163 , V_164 ) ;
if ( V_54 )
return V_54 ;
if ( V_164 > V_72 ) {
...
struct V_174 * V_52 , struct V_175 * V_176 )
{
struct V_177 * V_178 = V_52 -> V_179 ;
const struct V_180 * V_181 ;
int V_54 = 0 ;
V_181 = F_135 ( F_136 ( V_182 ) , V_52 ) ;
if ( ! V_181 ) {
F_51 ( V_52 , L_29 ) ;
V_54 = - V_117 ;
goto V_54;
}
V_54 = F_137 ( V_178 , 0 , V_176 ) ;
if ( V_54 < 0 ) {
F_51 ( V_52 , L_30 ) ;
V_54 = - V_117 ;
goto V_54;
...
int V_54 , V_21 , V_191 ;
T_1 V_192 ;
V_2 = F_143 ( V_52 , sizeof( struct V_1 ) , V_193 ) ;
if ( V_2 == NULL ) {
F_51 ( V_52 , L_35 ) ;
V_54 = - V_194 ;
goto V_195;
...
V_54 = ( V_52 -> V_179 ) ? F_134 ( V_2 , V_52 , & V_176 ) :
F_139 ( V_2 , V_184 , & V_176 ) ;
if ( V_54 )
goto V_195;
V_2 -> V_4 = F_149 ( V_52 , & V_176 ) ;
if ( F_113 ( V_2 -> V_4 ) ) {
V_54 = F_114 ( V_2 -> V_4 ) ;
goto V_195;
}
V_2 -> V_106 = V_176 . V_189 ;
V_54 = F_150 ( V_52 , V_2 -> V_171 , V_2 -> V_22 -> V_198 ,
V_199 , F_151 ( V_52 ) , V_2 ) ;
if ( V_54 ) {
F_51 ( V_52 , L_36 ,
V_2 -> V_171 , V_54 ) ;
goto V_195;
...
F_155 ( V_52 ) ;
F_21 ( V_52 ) ;
V_192 = F_1 ( V_2 , F_156 ( V_2 ) ) ;
F_157 ( & V_184 -> V_52 ) ;
F_158 ( V_52 , L_39 ,
( V_192 & V_2 -> V_22 -> V_202 ) >> V_2 -> V_22 -> V_203 ,
( V_192 & V_2 -> V_22 -> V_204 ) >> V_2 -> V_22 -> V_205 ) ;
F_159 ( & V_132 . V_133 ) ;
F_160 ( & V_2 -> V_196 , & V_132 . V_206 ) ;
F_161 ( & V_132 . V_133 ) ;
for ( V_21 = 0 ; V_21 < V_2 -> V_22 -> V_207 ; V_21 ++ ) {
for ( V_191 = 0 ; V_191 < V_2 -> V_22 -> V_208 [ V_21 ] . V_209 ; V_191 ++ ) {
V_54 = F_162 (
& V_2 -> V_22 -> V_208 [ V_21 ] . V_210 [ V_191 ] ) ;
if ( V_54 )
goto V_211;
...
for ( V_191 = V_2 -> V_22 -> V_208 [ V_21 ] . V_212 - 1 ; V_191 >= 0 ; V_191 -- )
F_163 (
& V_2 -> V_22 -> V_208 [ V_21 ] . V_210 [ V_191 ] ) ;
F_164 ( V_52 ) ;
if ( V_2 -> V_110 )
...
static int F_166 ( struct V_183 * V_184 )
{
...
static int F_170 ( struct V_174 * V_52 )
{
F_157 ( V_52 ) ;
return 0 ;
}
static int F_171 ( struct V_174 * V_52 )
{
F_21 ( V_52 ) ;
return 0 ;
}
