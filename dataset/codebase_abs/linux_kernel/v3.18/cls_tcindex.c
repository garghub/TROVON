...
static void F_13 ( struct V_19 * V_20 , unsigned long V_10 )
{
F_7 ( L_5 , V_20 , V_10 ) ;
}
...
struct V_6 * V_7 ;
F_7 ( L_6 , V_20 ) ;
V_7 = F_15 ( sizeof( struct V_6 ) , V_31 ) ;
if ( ! V_7 )
return - V_32 ;
V_7 -> V_24 = 0xffff ;
V_7 -> V_14 = V_33 ;
...
struct V_40 * V_41 )
{
return F_17 ( V_20 , V_34 ) ;
}
static void F_22 ( struct V_42 * V_43 )
{
struct V_6 * V_7 = F_23 ( V_43 , struct V_6 , V_39 ) ;
F_24 ( V_7 -> V_9 ) ;
F_24 ( V_7 -> V_11 ) ;
F_24 ( V_7 ) ;
}
...
static int
F_29 ( struct V_46 * V_46 , struct V_19 * V_20 , unsigned long V_47 ,
...
struct V_59 V_60 ;
F_27 ( & V_60 , V_44 , V_45 ) ;
V_52 = F_30 ( V_46 , V_20 , V_49 , V_50 , & V_60 , V_51 ) ;
if ( V_52 < 0 )
return V_52 ;
V_52 = - V_32 ;
V_57 = F_15 ( sizeof( * V_57 ) , V_31 ) ;
if ( ! V_57 )
goto V_61;
V_57 -> V_24 = V_7 -> V_24 ;
V_57 -> V_25 = V_7 -> V_25 ;
...
V_56 . V_4 = V_2 -> V_4 ;
if ( V_49 [ V_62 ] )
V_57 -> V_14 = F_32 ( V_49 [ V_62 ] ) ;
if ( V_49 [ V_63 ] )
V_57 -> V_24 = F_33 ( V_49 [ V_63 ] ) ;
if ( V_49 [ V_64 ] )
V_57 -> V_25 = F_32 ( V_49 [ V_64 ] ) ;
V_52 = - V_65 ;
if ( V_57 -> V_9 ) {
if ( ! F_25 ( V_57 ) ||
V_57 -> V_14 > V_57 -> V_30 )
...
if ( F_25 ( V_57 ) ) {
int V_37 ;
V_57 -> V_9 = F_34 ( V_57 -> V_14 , sizeof( * V_2 ) , V_31 ) ;
if ( ! V_57 -> V_9 )
goto V_66;
for ( V_37 = 0 ; V_37 < V_57 -> V_14 ; V_37 ++ )
F_27 ( & V_57 -> V_9 [ V_37 ] . V_3 ,
...
if ( V_49 [ V_70 ] ) {
V_56 . V_4 . V_5 = F_32 ( V_49 [ V_70 ] ) ;
F_35 ( V_20 , & V_56 . V_4 , V_47 ) ;
}
if ( V_55 )
F_36 ( V_20 , & V_2 -> V_3 , & V_60 ) ;
else
F_36 ( V_20 , & V_56 . V_3 , & V_60 ) ;
if ( V_55 && V_55 != V_2 )
F_26 ( V_55 ) ;
V_58 = V_7 ;
V_2 -> V_4 = V_56 . V_4 ;
...
struct V_12 * V_71 ;
struct V_12 T_2 * * V_13 ;
F_36 ( V_20 , & V_10 -> V_16 . V_3 , & V_2 -> V_3 ) ;
...
if ( V_52 < 0 )
return V_52 ;
return F_29 ( V_46 , V_20 , V_47 , V_28 , V_7 , V_2 , V_49 ,
V_73 [ V_78 ] , V_51 ) ;
}
static void F_40 ( struct V_19 * V_20 , struct V_40 * V_41 )
{
struct V_6 * V_7 = F_12 ( V_20 -> V_22 ) ;
struct V_12 * V_10 , * V_15 ;
int V_37 ;
F_7 ( L_10 , V_20 , V_41 , V_7 ) ;
if ( V_7 -> V_9 ) {
for ( V_37 = 0 ; V_37 < V_7 -> V_14 ; V_37 ++ ) {
...
static int F_43 ( struct V_46 * V_46 , struct V_19 * V_20 , unsigned long V_83 ,
struct V_17 * V_18 , struct V_84 * V_85 )
{
struct V_6 * V_7 = F_12 ( V_20 -> V_22 ) ;
struct V_1 * V_2 = (struct V_1 * ) V_83 ;
unsigned char * V_86 = F_44 ( V_18 ) ;
struct V_48 * V_87 ;
F_7 ( L_12 ,
V_20 , V_83 , V_18 , V_85 , V_7 , V_2 , V_86 ) ;
F_7 ( L_13 , V_7 -> V_9 , V_7 -> V_11 ) ;
V_87 = F_45 ( V_18 , V_75 ) ;
if ( V_87 == NULL )
goto V_88;
if ( ! V_83 ) {
V_85 -> V_89 = ~ 0 ;
if ( F_46 ( V_18 , V_62 , V_7 -> V_14 ) ||
F_47 ( V_18 , V_63 , V_7 -> V_24 ) ||
F_46 ( V_18 , V_64 , V_7 -> V_25 ) ||
F_46 ( V_18 , V_68 , V_7 -> V_26 ) )
goto V_88;
F_48 ( V_18 , V_87 ) ;
} else {
if ( V_7 -> V_9 ) {
V_85 -> V_89 = V_2 - V_7 -> V_9 ;
} else {
struct V_12 * V_10 ;
struct V_12 T_2 * * V_13 ;
int V_37 ;
V_85 -> V_89 = 0 ;
for ( V_37 = 0 ; ! V_85 -> V_89 && V_37 < V_7 -> V_14 ; V_37 ++ ) {
V_13 = & V_7 -> V_11 [ V_37 ] ;
for ( V_10 = F_12 ( * V_13 ) ;
! V_85 -> V_89 && V_10 ;
...
F_7 ( L_14 , V_85 -> V_89 ) ;
if ( V_2 -> V_4 . V_29 &&
F_46 ( V_18 , V_70 , V_2 -> V_4 . V_5 ) )
goto V_88;
if ( F_49 ( V_18 , & V_2 -> V_3 ) < 0 )
goto V_88;
F_48 ( V_18 , V_87 ) ;
if ( F_50 ( V_18 , & V_2 -> V_3 ) < 0 )
goto V_88;
}
return V_18 -> V_90 ;
V_88:
