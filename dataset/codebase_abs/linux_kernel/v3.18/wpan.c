...
V_144 -> V_2 -> V_117 . V_155 ++ ;
V_144 -> V_2 -> V_117 . V_156 += V_94 -> V_97 ;
...
if ( V_34 -> V_84 == V_148 )
F_28 ( L_8 , V_147 ) ;
F_28 ( L_9 , V_147 , F_5 ( V_34 -> V_12 ) ) ;
if ( V_34 -> V_84 == V_36 ) {
F_28 ( L_10 , V_147 ,
F_5 ( V_34 -> V_28 ) ) ;
} else {
T_5 V_47 = F_47 ( ( V_158 T_5 ) V_34 -> V_15 ) ;
F_28 ( L_11 , V_147 , & V_47 ) ;
}
}
...
break;
case V_88 :
V_159 = F_47 ( ( V_158 T_5 ) V_69 -> V_73 . V_89 ) ;
F_28 ( L_19 , & V_159 ,
V_69 -> V_73 . V_91 ) ;
break;
}
...
void F_53 ( struct V_162 * V_4 , struct V_93 * V_94 )
{
int V_163 ;
struct V_3 * V_144 ;
struct V_68 V_69 ;
V_163 = F_48 ( V_94 , & V_69 ) ;
if ( V_163 ) {
F_28 ( L_20 ) ;
F_30 ( V_94 ) ;
return;
