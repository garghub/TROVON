...
V_75 = F_91 ( & V_217 -> V_39 , V_206 , F_85 , 0 ,
F_92 ( & V_217 -> V_39 ) , V_5 ) ;
if ( V_75 < 0 ) {
F_21 ( & V_217 -> V_39 , L_40 , V_206 ) ;
goto V_228;
}
V_5 -> V_60 = F_93 ( V_219 , L_41 ) ;
...
V_5 -> V_13 ( V_5 -> V_1 , V_105 , V_95 ) ;
F_96 ( V_217 , V_5 ) ;
F_97 ( & V_217 -> V_39 , L_42 ,
V_230 , ( T_2 ) V_222 -> V_233 , ( T_2 V_52 ) V_5 -> V_1 ,
V_5 -> V_60 ? L_43 : L_44 ) ;
return 0 ;
V_228:
