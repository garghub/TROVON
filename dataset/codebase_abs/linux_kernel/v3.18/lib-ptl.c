...
if ( F_4 ( V_6 ) ) {
return & V_19 -> V_88 [ V_3 & V_89 ] ;
} else {
unsigned long V_90 = V_3 + V_62 . V_10 + V_62 . V_12 ;
F_2 ( F_3 ( V_6 ) ) ;
V_90 = F_28 ( V_90 , V_91 ) ;
return & V_19 -> V_88 [ V_90 ] ;
}
}
int
...
if ( V_86 == V_36 ) {
F_26 ( V_19 , V_92 - V_19 -> V_88 , 1 ) ;
if ( ! F_25 ( V_19 , - 1 ) )
V_86 = 0 ;
}
if ( V_86 == 0 && V_92 == & V_19 -> V_88 [ V_84 ] ) {
V_92 = F_27 ( V_19 , V_28 -> V_40 , V_28 -> V_42 ) ;
goto V_95;
}
if ( V_28 -> V_38 == V_98 ||
...
V_115 = & V_30 -> V_72 ;
V_28 . V_40 . V_10 = V_115 -> V_73 ;
V_28 . V_40 . V_12 = V_115 -> V_116 ;
V_28 . V_38 = V_54 ;
V_28 . V_55 = V_115 -> V_30 . V_117 . V_67 ;
V_28 . V_50 = V_115 -> V_118 ;
V_28 . V_46 = V_115 -> V_30 . V_117 . V_31 ;
V_28 . V_42 = V_115 -> V_30 . V_117 . V_119 ;
...
continue;
V_120 = V_19 -> V_88 ;
for ( V_121 = 0 ; V_121 < V_122 + 1 ; V_121 ++ ) {
while ( ! F_30 ( & V_120 [ V_121 ] ) ) {
V_33 = F_45 ( V_120 [ V_121 ] . V_123 ,
T_4 , V_124 ) ;
F_14 ( L_12 , V_33 ) ;
F_46 ( & V_33 -> V_124 ) ;
F_47 ( V_33 ) ;
...
F_48 ( V_120 , sizeof( * V_120 ) * ( V_122 + 1 ) ) ;
}
F_49 ( V_6 -> V_20 ) ;
V_6 -> V_20 = NULL ;
}
...
F_54 ( & V_6 -> V_126 ) ;
F_44 (mtable, i, ptl->ptl_mtables) {
F_55 ( V_120 , F_52 () , V_21 ,
sizeof( * V_120 ) * ( V_122 + 1 ) ) ;
if ( V_120 == NULL ) {
F_14 ( L_14 ,
V_1 ) ;
goto V_127;
...
int V_128 ;
int V_21 ;
V_128 = F_59 ( struct V_5 , V_23 [ V_25 ] ) ;
V_7 . V_64 = V_129 ;
V_7 . V_8 = F_60 ( V_7 . V_64 , V_128 ) ;
if ( V_7 . V_8 == NULL ) {
F_14 ( L_15 ) ;
return - V_125 ;
}
...
{
struct V_5 * V_6 ;
if ( V_130 < 0 || V_130 >= V_7 . V_64 )
return - V_131 ;
F_16 ( V_53 , L_16 , V_130 ) ;
V_6 = V_7 . V_8 [ V_130 ] ;
F_36 ( V_132 ) ;
F_6 ( V_6 ) ;
F_9 ( V_6 , V_133 ) ;
...
F_16 ( V_53 , L_18 , V_130 ) ;
F_65 ( & V_6 -> V_102 , & V_134 ) ;
F_66 ( V_6 , V_133 ) ;
F_8 ( V_6 ) ;
F_38 ( V_132 ) ;
F_67 ( & V_134 , L_19 ) ;
