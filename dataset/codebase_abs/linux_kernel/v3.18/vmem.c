...
{
struct V_43 * V_45 ;
if ( V_44 -> V_13 + V_44 -> V_14 > V_46 ||
V_44 -> V_13 + V_44 -> V_14 < V_44 -> V_13 )
return - V_47 ;
F_40 (tmp, &mem_segs, list) {
if ( V_44 -> V_13 >= V_45 -> V_13 + V_45 -> V_14 )
continue;
if ( V_44 -> V_13 + V_44 -> V_14 <= V_45 -> V_13 )
continue;
return - V_48 ;
}
F_41 ( & V_44 -> V_49 , & V_50 ) ;
...
if ( V_44 -> V_13 == V_13 && V_44 -> V_14 == V_14 )
break;
}
if ( V_44 -> V_13 != V_13 || V_44 -> V_14 != V_14 )
goto V_23;
...
struct V_57 * V_58 ;
T_8 V_13 , V_16 ;
V_55 = F_52 ( ( unsigned long ) & V_59 ) ;
V_56 = ( unsigned long ) & V_60 & V_61 ;
F_53 (memory, reg) {
V_13 = V_58 -> V_62 ;
V_16 = V_58 -> V_62 + V_58 -> V_14 - 1 ;
if ( V_13 >= V_56 || V_16 <= V_55 )
F_12 ( V_13 , V_16 - V_13 , 0 ) ;
else if ( V_13 >= V_55 && V_16 <= V_56 )
F_12 ( V_13 , V_16 - V_13 , 1 ) ;
else if ( V_13 >= V_55 ) {
F_12 ( V_13 , V_56 - V_13 , 1 ) ;
F_12 ( V_56 , V_16 - V_56 , 0 ) ;
} else if ( V_16 < V_56 ) {
F_12 ( V_13 , V_55 - V_13 , 0 ) ;
F_12 ( V_55 , V_16 - V_55 , 1 ) ;
} else {
F_12 ( V_13 , V_55 - V_13 , 0 ) ;
F_12 ( V_55 , V_56 - V_55 , 1 ) ;
F_12 ( V_56 , V_16 - V_56 , 0 ) ;
}
}
}
