...
T_3 V_151 = V_9 -> V_96 -> V_97 + V_152 ;
int V_55 ;
F_4 ( V_9 -> V_21 , L_34 ,
( unsigned long long ) V_151 ) ;
F_59 ( & V_125 -> V_138 ) ;
V_125 -> V_153 = F_60 ( V_151 , 0x20 , L_35 ) ;
if ( V_125 -> V_153 == NULL ) {
F_22 ( V_9 -> V_21 , L_36 ) ;
return - V_154 ;
}
...
V_55 = F_56 ( V_9 , V_125 , & V_125 -> V_156 ) ;
if ( V_55 ) {
F_22 ( V_9 -> V_21 , L_38 ) ;
goto V_157;
}
...
return;
F_62 ( & V_125 -> V_156 . V_125 ) ;
F_62 ( & V_125 -> V_148 . V_125 ) ;
F_63 ( V_125 -> V_11 ) ;
F_64 ( V_125 -> V_153 ) ;
F_33 ( V_125 -> V_153 ) ;
}
static inline int F_66 ( struct V_8 * V_9 , unsigned int V_160 )
{
struct V_126 * V_125 = & V_9 -> V_125 ;
int V_145 = ( V_160 < 32 ) ? V_125 -> V_156 . V_125 . V_145 : V_125 -> V_148 . V_125 . V_145 ;
return ( V_160 % 32 ) + V_145 ;
}
static inline int F_67 ( struct V_8 * V_9 )
{
return V_9 -> V_125 . V_159 ;
}
...
if ( ! V_74 )
return - V_103 ;
V_164 = F_47 ( & V_74 -> V_21 ) ;
V_164 -> V_165 = F_66 ( V_9 , V_162 -> V_166 ) ;
V_164 -> V_167 = F_66 ( V_9 , V_162 -> V_168 ) ;
V_164 -> V_169 = V_162 -> V_169 ;
V_164 -> V_170 = V_162 -> V_170 ;
V_74 -> V_82 = V_162 -> V_171 ;
F_7 ( V_9 -> V_21 , L_41 ,
V_162 -> V_171 ,
V_164 -> V_165 , V_162 -> V_166 , V_164 -> V_167 , V_162 -> V_168 ) ;
return F_37 ( V_9 , V_74 ) ;
}
static int F_69 ( struct V_8 * V_9 ,
struct V_141 * V_142 )
{
struct V_161 * V_162 = V_142 -> V_172 ;
int V_173 ;
int V_55 ;
for ( V_173 = 0 ; V_173 < V_142 -> V_174 ; V_173 ++ , V_162 ++ ) {
V_55 = F_68 ( V_9 , V_162 ) ;
if ( V_55 < 0 )
return V_55 ;
}
...
{
unsigned long V_180 ;
V_180 = F_3 ( V_9 -> V_11 + V_39 ) ;
V_180 &= ~ V_179 -> V_5 ;
V_180 |= V_179 -> V_33 ;
F_16 ( V_180 , V_9 -> V_11 + V_39 ) ;
}
...
if ( V_182 -> V_187 ) {
F_7 ( V_9 -> V_21 , L_43 , V_182 -> V_187 ) ;
F_28 ( V_9 -> V_21 , V_70 , V_182 -> V_187 ) ;
}
if ( V_182 -> V_53 ) {
F_7 ( V_9 -> V_21 , L_44 , V_182 -> V_53 ) ;
...
if ( V_142 && V_142 -> V_172 != NULL && V_142 -> V_174 > 0 ) {
if ( ! F_67 ( V_9 ) )
F_22 ( V_9 -> V_21 , L_48 ) ;
else
F_69 ( V_9 , V_142 ) ;
...
F_4 ( V_9 -> V_21 , L_57 , V_212 ) ;
return;
}
}
if ( V_213 -> V_215 ) {
F_4 ( V_9 -> V_21 , L_58 , V_212 ) ;
V_213 -> V_215 ( V_9 -> V_21 , V_212 ) ;
F_10 ( V_9 , 10 ) ;
}
}
static int F_84 ( struct V_73 * V_74 , T_5 V_216 )
{
