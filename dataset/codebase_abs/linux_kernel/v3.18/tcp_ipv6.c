...
static void F_118 ( struct V_6 * V_7 , T_2 V_132 , T_2 V_232 , T_2 V_233 ,
T_2 V_234 , T_2 V_235 , int V_236 ,
struct V_1 * V_206 , int V_237 , T_3 V_180 ,
T_2 V_238 )
{
const struct V_112 * V_129 = F_15 ( V_7 ) ;
struct V_112 * V_239 ;
struct V_6 * V_240 ;
struct V_44 V_45 ;
struct V_134 * V_134 = F_49 ( F_3 ( V_7 ) -> V_135 ) ;
...
F_118 ( V_7 , V_132 , V_249 , 0 , 0 , 0 , V_236 , V_206 , 1 , 0 , 0 ) ;
#ifdef F_26
V_264:
if ( V_263 ) {
F_111 () ;
...
static void F_133 ( struct V_6 * V_7 , T_2 V_132 , T_2 V_232 ,
T_2 V_233 , T_2 V_234 , T_2 V_235 , int V_236 ,
struct V_1 * V_206 , T_3 V_180 ,
T_2 V_238 )
{
F_118 ( V_7 , V_132 , V_232 , V_233 , V_234 , V_235 , V_236 , V_206 , 0 , V_180 ,
V_238 ) ;
}
...
F_133 ( V_7 , V_270 -> V_271 , V_270 -> V_272 ,
...
struct V_130 * V_157 )
{
F_133 ( V_7 , ( V_3 -> V_18 == V_148 ) ?
F_59 ( V_157 ) -> V_147 + 1 : F_17 ( V_3 ) -> V_149 ,
F_59 ( V_157 ) -> V_281 ,
V_157 -> V_282 , V_275 , V_157 -> V_69 , V_3 -> V_65 ,
...
F_163 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_203 ) ;
if ( V_311 )
goto V_315;
return 0 ;
}
if ( V_7 -> V_203 < F_164 ( V_7 ) || F_165 ( V_7 ) )
goto V_316;
if ( V_3 -> V_18 == V_148 ) {
...
F_162 ( V_3 , V_7 ) ;
if ( F_168 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_203 ) )
goto V_317;
if ( V_311 )
goto V_315;
return 0 ;
...
F_154 ( V_311 , V_3 ) ;
V_311 = F_169 ( & V_39 -> V_299 , V_311 ) ;
} else {
F_167 ( V_311 ) ;
V_311 = F_169 ( & V_39 -> V_299 , NULL ) ;
}
}
F_83 ( V_311 ) ;
return 0 ;
...
goto V_325;
F_129 ( V_134 , V_326 ) ;
if ( ! F_171 ( V_7 , sizeof( struct V_112 ) ) )
goto V_325;
V_129 = F_15 ( V_7 ) ;
if ( V_129 -> V_211 < sizeof( struct V_112 ) / 4 )
goto V_327;
if ( ! F_171 ( V_7 , V_129 -> V_211 * 4 ) )
goto V_325;
if ( F_172 ( V_7 , V_94 , V_328 ) )
goto V_329;
V_129 = F_15 ( V_7 ) ;
V_127 = F_14 ( V_7 ) ;
memmove ( & F_114 ( V_7 ) -> V_222 . V_223 , F_173 ( V_7 ) ,
sizeof( struct V_123 ) ) ;
F_174 () ;
...
F_114 ( V_7 ) -> V_330 = F_175 ( V_129 ) ;
F_114 ( V_7 ) -> V_221 = 0 ;
F_114 ( V_7 ) -> V_331 = F_176 ( V_127 ) ;
F_114 ( V_7 ) -> V_332 = 0 ;
V_3 = F_177 ( & V_136 , V_7 , V_129 -> V_28 , V_129 -> V_27 ,
F_113 ( V_7 ) ) ;
if ( ! V_3 )
goto V_333;
V_334:
...
return V_219 ? - 1 : 0 ;
V_333:
if ( ! F_178 ( NULL , V_337 , V_7 ) )
goto V_325;
if ( V_7 -> V_203 < ( V_129 -> V_211 << 2 ) || F_165 ( V_7 ) ) {
V_329:
F_129 ( V_134 , V_318 ) ;
V_327:
F_129 ( V_134 , V_319 ) ;
...
switch ( F_184 ( F_54 ( V_3 ) , V_7 , V_129 ) ) {
case V_341 :
{
struct V_2 * V_342 ;
...
if ( V_7 -> V_323 != V_324 )
return;
if ( ! F_171 ( V_7 , F_187 ( V_7 ) + sizeof( struct V_112 ) ) )
return;
V_127 = F_14 ( V_7 ) ;
V_129 = F_15 ( V_7 ) ;
if ( V_129 -> V_211 < sizeof( struct V_112 ) / 4 )
...
static void F_195 ( struct V_348 * V_132 ,
...
F_197 ( V_351 ) ,
V_157 -> V_357 ,
F_198 ( F_199 ( V_132 ) , V_350 ) ,
0 ,
0 ,
0 , V_157 ) ;
}
static void F_200 ( struct V_348 * V_132 , struct V_2 * V_358 , int V_349 )
{
...
F_202 ( V_362 - V_353 ) ,
V_37 -> V_373 ,
F_198 ( F_199 ( V_132 ) , F_203 ( V_358 ) ) ,
V_37 -> V_374 ,
F_204 ( V_358 ) ,
F_205 ( & V_358 -> V_375 ) , V_358 ,
F_197 ( V_37 -> V_376 ) ,
F_197 ( V_37 -> V_377 . V_378 ) ,
( V_37 -> V_377 . V_379 << 1 ) | V_37 -> V_377 . V_380 ,
V_41 -> V_381 ,
V_358 -> V_18 == V_148 ?
( V_364 ? V_364 -> V_382 : 0 ) :
( F_206 ( V_41 ) ? - 1 : V_41 -> V_383 )
) ;
}
static void F_207 ( struct V_348 * V_132 ,
struct V_267 * V_268 , int V_349 )
{
const struct V_4 * V_27 , * V_354 ;
T_9 V_359 , V_360 ;
T_10 V_384 = V_268 -> V_385 - F_208 () ;
V_27 = & V_268 -> V_386 ;
V_354 = & V_268 -> V_387 ;
...
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] , V_359 ,
V_268 -> V_390 , 0 , 0 ,
3 , F_202 ( V_384 ) , 0 , 0 , 0 , 0 ,
F_205 ( & V_268 -> V_391 ) , V_268 ) ;
}
static int F_209 ( struct V_348 * V_132 , void * V_392 )
{
struct V_393 * V_394 ;
...
case V_399 :
if ( V_3 -> V_18 == V_139 )
F_207 ( V_132 , V_392 , V_394 -> V_400 ) ;
else
F_200 ( V_132 , V_392 , V_394 -> V_400 ) ;
break;
case V_401 :
F_195 ( V_132 , V_394 -> V_402 , V_392 , V_394 -> V_400 , V_394 -> V_350 ) ;
break;
}
V_142:
return 0 ;
}
int T_11 F_211 ( struct V_134 * V_134 )
{
return F_212 ( V_134 , & V_403 ) ;
}
void F_213 ( struct V_134 * V_134 )
{
F_214 ( V_134 , & V_403 ) ;
}
static void F_215 ( struct V_2 * V_3 , int V_404 )
{
struct V_34 * V_35 = F_5 ( V_3 ) ;
F_216 ( V_3 , F_217 ( struct V_34 , V_294 ) ) ;
V_404 -= F_217 ( struct V_34 , V_294 ) + sizeof( V_35 -> V_294 ) ;
memset ( & V_35 -> V_294 + 1 , 0 , V_404 ) ;
}
static int T_11 F_218 ( struct V_134 * V_134 )
{
return F_219 ( & V_134 -> V_242 . F_17 , V_405 ,
V_406 , V_94 , V_134 ) ;
}
static void T_12 F_220 ( struct V_134 * V_134 )
{
F_221 ( V_134 -> V_242 . F_17 ) ;
}
static void T_12 F_222 ( struct V_407 * V_408 )
{
F_223 ( & V_136 , & V_105 , V_51 ) ;
}
int T_13 F_224 ( void )
{
int V_219 ;
V_219 = F_225 ( & V_409 , V_94 ) ;
if ( V_219 )
goto V_142;
V_219 = F_226 ( & V_410 ) ;
if ( V_219 )
