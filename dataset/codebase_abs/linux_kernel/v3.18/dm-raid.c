...
V_105 -> V_108 = F_48 ( V_109 ) ;
V_105 -> V_110 = F_48 ( 0 ) ;
V_105 -> V_111 = F_48 ( V_37 -> V_21 ) ;
V_105 -> V_112 = F_48 ( V_28 -> V_35 ) ;
V_105 -> V_113 = F_49 ( V_37 -> V_113 ) ;
V_105 -> V_103 = F_49 ( V_103 ) ;
V_105 -> V_114 = F_49 ( V_28 -> V_42 ) ;
V_105 -> V_115 = F_49 ( V_37 -> V_27 ) ;
V_105 -> V_22 = F_48 ( V_37 -> V_22 ) ;
V_105 -> V_1 = F_48 ( V_37 -> V_1 ) ;
V_105 -> V_116 = F_48 ( V_37 -> V_53 ) ;
}
static int F_50 ( struct V_99 * V_28 , struct V_99 * V_117 )
{
int V_34 ;
struct V_104 * V_105 ;
struct V_104 * V_118 ;
T_2 V_119 , V_120 ;
V_28 -> V_121 = 0 ;
V_28 -> V_107 = F_51 ( V_28 -> V_43 ) ;
if ( V_28 -> V_107 < sizeof( * V_105 ) || V_28 -> V_107 > V_122 ) {
F_21 ( L_56 ) ;
return - V_16 ;
}
V_34 = F_41 ( V_28 , V_28 -> V_107 ) ;
if ( V_34 )
return V_34 ;
V_105 = F_46 ( V_28 -> V_39 ) ;
if ( ( V_105 -> V_108 != F_48 ( V_109 ) ) ||
...
if ( ! V_117 )
return 1 ;
V_119 = F_47 ( V_105 -> V_113 ) ;
V_118 = F_46 ( V_117 -> V_39 ) ;
V_120 = F_47 ( V_118 -> V_113 ) ;
return ( V_119 > V_120 ) ? 1 : 0 ;
}
static int F_52 ( struct V_37 * V_37 , struct V_99 * V_28 )
{
int V_125 ;
struct V_10 * V_14 = F_35 ( V_37 , struct V_10 , V_20 ) ;
T_2 V_119 ;
...
V_103 = F_47 ( V_105 -> V_103 ) ;
V_37 -> V_113 = V_119 ? : 1 ;
if ( F_53 ( V_105 -> V_22 ) != V_37 -> V_22 ) {
F_21 ( L_57 ) ;
return - V_16 ;
}
if ( F_53 ( V_105 -> V_1 ) != V_37 -> V_1 ) {
F_21 ( L_58 ) ;
F_21 ( L_59 , F_53 ( V_105 -> V_1 ) , V_37 -> V_1 ) ;
F_21 ( L_60 ,
F_1 ( F_53 ( V_105 -> V_1 ) ) ,
F_2 ( F_53 ( V_105 -> V_1 ) ) ) ;
F_21 ( L_61 ,
...
if ( F_53 ( V_105 -> V_116 ) != V_37 -> V_53 ) {
F_21 ( L_62 ) ;
return - V_16 ;
}
if ( ( V_14 -> V_6 -> V_22 != 1 ) &&
( F_53 ( V_105 -> V_111 ) != V_37 -> V_21 ) ) {
F_21 ( L_63 ) ;
return - V_16 ;
}
if ( ! ( V_14 -> V_71 & ( V_73 | V_72 ) ) )
V_37 -> V_27 = F_47 ( V_105 -> V_115 ) ;
F_54 (r, mddev) {
...
if ( ! V_128 -> V_39 )
continue;
V_129 = F_46 ( V_128 -> V_39 ) ;
V_129 -> V_103 = 0 ;
if ( ! F_19 ( V_123 , & V_128 -> V_41 ) && ( V_128 -> V_35 >= 0 ) ) {
V_125 = F_53 ( V_129 -> V_112 ) ;
if ( V_125 != V_128 -> V_35 ) {
if ( V_14 -> V_6 -> V_22 != 1 ) {
...
static int F_56 ( struct V_11 * V_12 , struct V_10 * V_14 )
{
int V_34 ;
struct V_134 * V_17 ;
...
continue;
V_140 = F_61 ( V_14 -> V_17 [ V_8 ] . V_28 . V_44 ) ;
if ( ! V_140 || ! F_62 ( V_140 ) )
return;
if ( V_137 ) {
...
static int F_63 ( struct V_11 * V_12 , unsigned V_146 , char * * V_31 )
{
int V_34 ;
struct V_6 * V_147 ;
...
F_74 ( & V_14 -> V_98 . V_158 ) ;
F_72 ( & V_14 -> V_20 ) ;
F_11 ( V_14 ) ;
}
static int F_75 ( struct V_11 * V_12 , struct V_159 * V_159 )
{
struct V_10 * V_14 = V_12 -> V_151 ;
struct V_37 * V_37 = & V_14 -> V_20 ;
...
static int F_81 ( struct V_11 * V_12 , unsigned V_146 , char * * V_31 )
{
struct V_10 * V_14 = V_12 -> V_151 ;
struct V_37 * V_37 = & V_14 -> V_20 ;
...
static void F_85 ( struct V_11 * V_12 , struct V_197 * V_141 )
{
struct V_10 * V_14 = V_12 -> V_151 ;
unsigned V_198 = V_14 -> V_20 . V_53 << 9 ;
struct V_186 * V_187 = V_14 -> V_20 . V_151 ;
F_86 ( V_141 , V_198 ) ;
F_87 ( V_141 , V_198 * ( V_187 -> V_21 - V_187 -> V_199 ) ) ;
}
...
F_43 ( V_128 , 0 , V_128 -> V_107 , V_128 -> V_39 , V_102 , 1 ) ) {
F_24 ( L_118
L_119 ,
V_14 -> V_6 -> V_7 , V_8 ) ;
if ( ( V_128 -> V_35 >= 0 ) &&
