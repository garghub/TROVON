...
struct V_4 * V_5 ;
T_2 V_6 ;
V_5 = F_34 ( V_57 , struct V_4 , V_57 . V_57 ) ;
...
if ( V_8 )
return V_8 ;
if ( ! F_40 ( V_108 , L_9 , NULL ) &&
! F_40 ( V_108 , L_10 , NULL ) &&
! F_40 ( V_108 , L_11 , NULL ) )
goto V_114;
V_8 = F_41 ( & V_2 -> V_10 , sizeof( struct V_106 ) ,
V_115 ) ;
if ( ! V_8 )
goto V_114;
V_112 = F_42 ( V_108 , L_9 , & V_113 ) ;
if ( ! V_112 )
V_8 -> V_9 = V_113 ;
V_112 = F_42 ( V_108 , L_10 , & V_113 ) ;
if ( ! V_112 )
V_8 -> V_103 = V_113 ;
if ( ! F_40 ( V_108 , L_11 , NULL ) ) {
V_8 -> V_30 = - 1 ;
goto V_114;
}
V_8 -> V_30 = F_43 ( V_108 ,
...
int V_97 ;
char * V_119 ;
V_119 = F_45 ( V_115 , L_12 , F_46 ( & V_2 -> V_10 ) ) ;
if ( ! V_119 ) {
F_10 ( & V_2 -> V_10 , L_13 ) ;
return - V_120 ;
}
V_5 = F_47 ( sizeof( struct V_4 ) , V_115 ) ;
if ( ! V_5 ) {
V_112 = - V_120 ;
goto V_121;
}
...
V_5 -> V_95 = false ;
V_5 -> V_29 = false ;
V_5 -> V_58 . V_119 = V_119 ;
V_5 -> V_58 . type = V_122 ;
V_5 -> V_58 . V_123 = V_124 ;
V_5 -> V_58 . V_125 = F_31 ( V_124 ) ;
V_5 -> V_58 . V_126 = F_33 ;
V_5 -> V_58 . V_108 = V_2 -> V_10 . V_108 ;
V_5 -> V_101 = 1 ;
V_5 -> V_56 = V_59 ;
V_5 -> V_58 . V_127 = F_36 ;
V_8 = F_39 ( V_2 ) ;
if ( V_8 ) {
V_5 -> V_29 = F_48 ( V_8 -> V_30 ) ;
V_5 -> V_8 = V_8 ;
}
F_49 ( V_2 , V_5 ) ;
if ( ! V_5 -> V_29 )
goto V_128;
V_112 = F_50 ( V_8 -> V_30 , F_46 ( & V_2 -> V_10 ) ) ;
if ( V_112 ) {
...
V_97 = F_53 ( V_8 -> V_30 ) ;
if ( V_97 <= 0 ) {
F_32 ( & V_2 -> V_10 , L_16 , V_97 ) ;
F_52 ( V_8 -> V_30 ) ;
V_5 -> V_29 = false ;
goto V_128;
}
V_112 = F_54 ( V_97 , F_35 ,
V_129 | V_130 ,
F_46 ( & V_2 -> V_10 ) , & V_5 -> V_58 ) ;
if ( V_112 ) {
F_32 ( & V_2 -> V_10 , L_17 , V_112 ) ;
F_52 ( V_8 -> V_30 ) ;
V_5 -> V_29 = false ;
goto V_128;
}
...
static int F_62 ( struct V_132 * V_10 )
{
struct V_1 * V_2 = F_63 ( V_10 ) ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
T_2 V_6 ;
if ( V_5 -> V_55 > 0 )
F_17 ( & V_5 -> V_57 ) ;
