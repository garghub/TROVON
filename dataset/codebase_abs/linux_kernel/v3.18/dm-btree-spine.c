...
int F_12 ( struct V_25 * V_26 , T_3 V_4 ,
struct V_3 * * V_27 )
{
...
F_7 ( ! V_36 -> V_37 ) ;
-- V_36 -> V_37 ;
F_19 ( V_36 -> V_26 , V_36 -> V_38 [ V_36 -> V_37 ] ) ;
}
...
void F_26 ( struct V_43 * V_36 , struct V_25 * V_26 )
{
V_36 -> V_26 = V_26 ;
V_36 -> V_37 = 0 ;
}
int F_27 ( struct V_43 * V_36 )
{
int V_33 = 0 , V_39 ;
for ( V_39 = 0 ; V_39 < V_36 -> V_37 ; V_39 ++ ) {
int V_40 = F_19 ( V_36 -> V_26 , V_36 -> V_38 [ V_39 ] ) ;
...
int F_28 ( struct V_43 * V_36 , T_3 V_4 ,
struct V_31 * V_32 )
{
int V_33 ;
if ( V_36 -> V_37 == 2 ) {
...
struct V_3 * F_30 ( struct V_43 * V_36 )
{
F_7 ( V_36 -> V_37 != 2 ) ;
