...
F_16 () ;
if ( V_13 )
F_17 ( V_2 , V_13 , sizeof( * V_13 ) ) ;
return V_19 ;
}
int F_18 ( struct V_1 * V_2 , int V_3 , const struct V_4 * V_5 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 ;
...
static void F_24 ( struct V_42 * V_45 )
{
if ( F_25 ( & V_45 -> V_44 ) ) {
F_26 ( V_45 -> V_46 ) ;
F_27 ( & V_45 -> V_47 -> V_30 ) ;
...
static struct V_42 * F_29 ( struct V_28 * V_29 ,
const struct V_4 * V_5 )
{
struct V_10 * V_11 = V_29 -> V_48 ;
struct V_42 * V_43 ;
V_43 = F_30 ( sizeof( * V_43 ) , V_49 ) ;
if ( V_43 == NULL )
return NULL ;
V_43 -> V_50 = * V_5 ;
F_31 ( V_11 ) ;
...
static int F_20 ( struct V_8 * V_9 , const struct V_4 * V_5 )
{
