...
V_2 -> V_15 . V_105 = F_57 ( V_6 ,
V_2 -> V_26 -> V_28 . V_29 -> V_147 ) ;
if ( V_2 -> V_15 . V_105 )
V_2 -> V_148 . V_149 = F_57 ( L_13 ,
V_2 -> V_15 . V_105 ) ;
F_61 ( V_2 ) ;
}
...
struct V_103 * V_104 ;
char V_6 [ 10 + V_146 ] ;
V_104 = V_2 -> V_15 . V_105 ;
if ( ! V_104 )
return;
sprintf ( V_6 , L_12 , V_2 -> T_8 ) ;
if ( ! F_67 ( V_104 -> V_150 , V_104 , V_104 -> V_150 , V_6 ) )
F_68 ( V_2 ,
L_14 ,
V_6 ) ;
}
