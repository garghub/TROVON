...
return F_79 ( V_96 , V_31 ) ;
}
static struct V_23 * F_80 ( struct V_97 * V_98 ,
...
V_27 = F_88 ( V_63 , V_38 , V_31 , 0 ) ;
if ( V_27 == V_31 )
return 0 ;
}
}
V_82 = F_89 ( V_101 , V_108 >> V_94 ? : 1 ) ;
if ( ! V_82 )
return - V_17 ;
V_82 -> V_118 . V_120 = 0 ;
...
F_16 ( V_84 , & V_82 -> V_85 ) ;
F_88 ( V_82 , V_38 , V_31 , 0 ) ;
F_90 ( V_40 , V_82 ) ;
return 0 ;
}
static void F_91 ( struct V_23 * V_24 )
{
...
static struct V_38 * F_94 ( struct V_23 * V_24 , int V_112 , int V_38 )
{
int V_66 ;
...
static T_3 void F_93 ( struct V_23 * V_24 )
{
...
static int F_87 ( struct V_23 * V_24 , int V_139 )
{
unsigned long V_33 ;
int V_27 = 0 ;
F_37 ( & V_24 -> V_46 , V_33 ) ;
...
struct V_82 * V_82 )
{
int V_139 = F_101 ( V_24 , V_82 ) ;
if ( V_139 < 0 )
return - V_89 ;
return F_87 ( V_24 , V_139 ) ;
}
...
static void F_104 ( struct V_82 * V_82 , int V_80 )
{
struct V_23 * V_24 = V_82 -> V_86 ;
if ( V_80 )
F_73 ( V_24 , V_82 ) ;
...
{
F_105 ( & V_24 -> V_140 , V_141 ,
V_142 , NULL , NULL ) ;
F_106 ( V_24 -> V_45 -> V_143 ,
& V_24 -> V_140 ) ;
}
...
static int F_112 ( void * V_149 , struct V_77 * V_150 , struct V_77 * V_151 )
{
struct V_23 * V_152 = F_113 ( V_150 , struct V_23 ,
V_49 ) ;
struct V_23 * V_153 = F_113 ( V_151 , struct V_23 ,
V_49 ) ;
T_1 V_154 = V_152 -> V_40 . V_78 -> V_118 . V_119 ;
T_1 V_155 = V_153 -> V_40 . V_78 -> V_118 . V_119 ;
if ( V_154 < V_155 )
return - 1 ;
if ( V_154 > V_155 )
return 1 ;
...
static void F_114 ( struct V_156 * V_157 )
{
struct V_23 * V_7 ;
struct V_23 * V_63 = NULL ;
F_115 ( NULL , & V_157 -> V_158 , F_112 ) ;
while ( ! F_31 ( & V_157 -> V_158 ) ) {
V_7 = F_40 ( V_157 -> V_158 . V_50 ,
struct V_23 , V_49 ) ;
F_29 ( & V_7 -> V_49 ) ;
if ( F_51 ( V_7 ) ) {
F_109 ( V_7 ) ;
...
static void F_116 ( struct V_159 * V_140 )
{
struct V_156 * V_157 ;
V_157 = F_113 ( V_140 , struct V_156 , V_140 ) ;
F_114 ( V_157 ) ;
}
static void F_117 ( struct V_160 * V_161 , bool V_162 )
{
struct V_156 * V_157 ;
V_157 = F_113 ( V_161 , struct V_156 , V_161 ) ;
if ( V_162 ) {
F_105 ( & V_157 -> V_140 , V_141 ,
F_116 , NULL , NULL ) ;
F_106 ( V_157 -> V_2 -> V_143 ,
& V_157 -> V_140 ) ;
return;
}
F_114 ( V_157 ) ;
}
int F_118 ( struct V_97 * V_98 , struct V_82 * V_82 ,
struct V_99 * V_68 , T_1 * V_35 ,
T_1 V_62 )
{
struct V_23 * V_24 ;
...
F_58 ( & V_24 -> V_49 , & V_157 -> V_158 ) ;
} else {
return F_111 ( V_24 ) ;
}
return 0 ;
}
static void F_122 ( struct V_23 * V_24 )
{
int V_90 , V_112 ;
void * * V_127 ;
int V_102 = - 1 , V_103 = - 1 ;
...
if ( V_24 -> V_35 [ V_102 ] == V_166 ) {
V_80 = - V_89 ;
goto V_134;
}
goto V_164;
}
if ( V_24 -> V_35 [ V_103 ] == V_166 ) {
F_123 ( V_24 -> V_68 -> V_69 ,
V_133 , V_102 , V_127 ) ;
} else {
F_124 ( V_24 -> V_68 -> V_69 ,
V_133 , V_102 , V_103 ,
V_127 ) ;
}
} else {
...
if ( V_102 != - 1 ) {
V_38 = F_94 ( V_24 , V_102 , V_11 ) ;
F_15 ( V_38 ) ;
}
if ( V_103 != - 1 ) {
V_38 = F_94 ( V_24 , V_103 , V_11 ) ;
F_15 ( V_38 ) ;
}
}
}
...
static void F_125 ( struct V_82 * V_82 , int V_80 )
{
struct V_23 * V_24 = V_82 -> V_86 ;
if ( V_80 )
F_73 ( V_24 , V_82 ) ;
...
F_82 ( & V_24 -> V_68 -> error , 0 ) ;
for ( V_112 = 0 ; V_112 < V_68 -> V_69 ; V_112 ++ ) {
if ( V_24 -> V_102 == V_112 || V_24 -> V_103 == V_112 ) {
F_44 ( & V_24 -> V_68 -> error ) ;
continue;
}
for ( V_90 = 0 ; V_90 < V_28 ; V_90 ++ ) {
struct V_38 * V_93 ;
V_93 = F_94 ( V_24 , V_112 , V_90 ) ;
if ( F_21 ( V_93 ) )
continue;
V_27 = F_86 ( V_24 , & V_40 ,
F_94 ( V_24 , V_112 , V_90 ) ,
V_112 , V_90 , V_24 -> V_62 ) ;
if ( V_27 < 0 )
goto V_134;
}
...
int F_126 ( struct V_97 * V_98 , struct V_82 * V_82 ,
struct V_99 * V_68 , T_1 * V_35 ,
T_1 V_62 , int V_167 )
{
struct V_23 * V_24 ;
...
static void V_142 ( struct V_159 * V_140 )
{
struct V_23 * V_24 ;
V_24 = F_113 ( V_140 , struct V_23 , V_140 ) ;
F_107 ( V_24 ) ;
}
static void V_144 ( struct V_159 * V_140 )
{
struct V_23 * V_24 ;
V_24 = F_113 ( V_140 , struct V_23 , V_140 ) ;
F_92 ( V_24 ) ;
