...
V_50 = F_74 ( & V_10 -> F_13 [ V_78 ] , 0 , V_84 ) ;
if ( V_50 )
goto V_50;
}
V_10 -> V_85 = 0 ;
...
int V_78 ;
if ( F_39 ( V_10 ) ) {
struct V_1 * V_93 = & V_57 . V_12 ;
F_1 ( & V_10 -> V_12 , V_93 ) ;
F_78 ( & V_10 -> V_12 . V_74 , & V_93 -> V_74 ) ;
F_78 ( & V_10 -> V_12 . V_75 , & V_93 -> V_75 ) ;
F_78 ( & V_10 -> V_12 . V_76 , & V_93 -> V_76 ) ;
F_8 ( & V_10 -> V_12 . V_4 ) ;
F_8 ( & V_93 -> V_4 ) ;
}
F_67 ( V_10 ) ;
...
void F_82 ( struct V_9 * V_10 , int V_97 )
{
enum V_98 V_99 ;
T_7 * V_100 = & V_101 [ V_97 ] ;
V_99 = V_97 ? V_102 : V_103 ;
if ( F_83 ( V_99 , & V_10 -> V_26 ) )
F_84 ( & V_104 [ V_97 ] ) ;
F_85 () ;
if ( F_86 ( V_100 ) )
F_87 ( V_100 ) ;
}
void F_88 ( struct V_9 * V_10 , int V_97 )
{
enum V_98 V_99 ;
V_99 = V_97 ? V_102 : V_103 ;
if ( ! F_89 ( V_99 , & V_10 -> V_26 ) )
F_90 ( & V_104 [ V_97 ] ) ;
}
long F_91 ( int V_97 , long V_59 )
{
long V_40 ;
unsigned long V_105 = V_73 ;
F_92 ( V_106 ) ;
T_7 * V_100 = & V_101 [ V_97 ] ;
F_93 ( V_100 , & V_106 , V_107 ) ;
V_40 = F_94 ( V_59 ) ;
F_95 ( V_100 , & V_106 ) ;
F_96 ( F_97 ( V_59 ) ,
F_97 ( V_73 - V_105 ) ) ;
...
long F_98 ( struct V_108 * V_108 , int V_97 , long V_59 )
{
long V_40 ;
unsigned long V_105 = V_73 ;
F_92 ( V_106 ) ;
T_7 * V_100 = & V_101 [ V_97 ] ;
if ( F_99 ( & V_104 [ V_97 ] ) == 0 ||
! F_44 ( V_109 , & V_108 -> V_110 ) ) {
F_100 () ;
...
int F_102 ( struct V_112 * V_113 , int V_114 ,
void T_8 * V_115 , T_3 * V_116 , T_9 * V_117 )
{
char V_118 [] = L_21 ;
if ( * V_117 || * V_116 < sizeof( V_118 ) ) {
* V_116 = 0 ;
return 0 ;
}
if ( F_103 ( V_115 , V_118 , sizeof( V_118 ) ) )
return - V_119 ;
F_104 ( V_120 L_22 ,
V_113 -> V_121 ) ;
* V_116 = 2 ;
