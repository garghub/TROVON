...
F_35 ( V_151 , V_25 -> V_34 . V_92 + V_145 ) ;
F_35 ( V_152 , V_25 -> V_34 . V_92 + V_153 ) ;
F_35 ( V_154 | V_155 ,
V_25 -> V_34 . V_92 + V_156 ) ;
F_35 ( 0x1 , V_25 -> V_34 . V_92 + V_96 ) ;
...
F_87 ( 1 ) ) |
V_158 ,
V_25 -> V_67 [ V_33 ] . V_92 + V_159 ) ;
}
V_25 -> V_34 . V_35 [ V_160 ] . V_36 = ~ 0 ;
V_25 -> V_34 . V_35 [ V_160 ] . V_37 = ~ 0 ;
V_25 -> V_34 . V_35 [ V_161 ] . V_36 = 0 ;
V_25 -> V_34 . V_35 [ V_161 ] . V_37 = 0 ;
V_25 -> V_34 . V_35 [ V_162 ] . V_36 = ~ 0 ;
V_25 -> V_34 . V_35 [ V_162 ] . V_37 = ~ ( 0x1 << 15 ) ;
V_25 -> V_34 . V_35 [ V_163 ] . V_36 = ~ 0 ;
V_25 -> V_34 . V_35 [ V_163 ] . V_37 = ~ ( 0x1f << 9 ) ;
V_25 -> V_34 . V_127 = F_88 ( & V_164 , 0 , 0 , V_165 ) ;
if ( V_25 -> V_34 . V_127 == 0 ) {
V_32 = L_19 ;
} else {
int V_166 = snprintf ( NULL , 0 , L_20 , V_25 -> V_34 . V_127 ) ;
V_32 = F_89 ( V_25 -> V_7 , V_166 + 1 , V_165 ) ;
snprintf ( V_32 , V_166 + 1 , L_20 , V_25 -> V_34 . V_127 ) ;
}
...
if ( ! V_25 -> V_110 ) {
F_90 ( V_25 -> V_7 , L_21 ) ;
F_91 ( & V_25 -> V_34 . V_111 , V_177 ,
V_112 ) ;
V_25 -> V_34 . V_111 . V_178 = F_81 ;
}
...
int V_33 ;
for ( V_33 = 0 ; V_33 < V_25 -> V_81 ; V_33 ++ )
F_35 ( 0 , V_25 -> V_67 [ V_33 ] . V_92 + V_159 ) ;
F_35 ( 0 , V_25 -> V_34 . V_92 + V_156 ) ;
F_94 ( & V_25 -> V_34 . V_55 ) ;
F_95 ( & V_164 , V_25 -> V_34 . V_127 ) ;
}
static int F_96 ( struct V_24 * V_25 ,
int (* F_97)( struct V_24 * V_25 , int V_179 ,
...
void T_8 * V_92 ;
int V_40 ;
V_101 = F_36 ( V_25 -> V_92 + V_181 +
4 * ( V_179 / 32 ) ) ;
if ( ! ( V_101 & ( 1 << ( V_179 % 32 ) ) ) )
continue;
V_92 = V_25 -> V_92 + V_179 * V_150 ;
V_101 = F_36 ( V_92 + V_182 ) ;
type = ( V_101 >> V_183 ) &
V_184 ;
V_127 = ( V_101 >> V_185 ) &
V_186 ;
V_40 = F_97 ( V_25 , V_179 , V_92 , type , V_127 ) ;
if ( V_40 )
return V_40 ;
}
return 0 ;
}
static int F_98 ( struct V_24 * V_25 , int V_179 ,
void T_8 * V_92 , T_2 type , T_2 V_127 )
{
...
static int F_99 ( struct V_24 * V_25 , int V_179 ,
void T_8 * V_92 , T_2 type , T_2 V_127 )
{
struct V_61 * V_187 ;
F_100 ( V_25 -> V_7 , L_22 , V_179 , V_127 , type ) ;
switch ( type ) {
case V_188 :
case V_189 :
return 0 ;
case V_64 :
V_187 = & V_25 -> V_67 [ V_127 ] ;
break;
case V_29 :
V_25 -> V_30 = 1 ;
V_187 = & V_25 -> V_1 [ V_127 ] ;
break;
case V_27 :
V_25 -> V_28 = 1 ;
default:
...
static T_7 F_103 ( int V_193 , void * V_194 )
{
T_7 V_17 = V_144 ;
struct V_24 * V_25 = V_194 ;
T_2 V_190 [ 6 ] ;
T_2 V_195 ;
int V_33 ;
V_195 = V_190 [ 0 ] = F_36 ( V_25 -> V_92 + V_196 ) ;
if ( V_195 & V_197 ) {
V_195 &= ~ V_197 ;
V_17 = F_78 ( & V_25 -> V_34 ) ;
}
for ( V_33 = 1 ; V_33 < F_30 ( V_190 ) ; V_33 ++ ) {
V_190 [ V_33 ] = F_36 ( V_25 -> V_92 +
V_196 + V_33 * 4 ) ;
V_195 |= V_190 [ V_33 ] ;
}
if ( V_195 )
V_17 |= F_101 ( V_25 , V_190 ) ;
if ( V_17 != V_144 )
F_35 ( V_198 ,
V_25 -> V_92 + V_192 ) ;
return V_17 ;
...
struct V_201 * V_17 ;
int V_40 ;
V_25 = F_89 ( & V_200 -> V_7 , sizeof( * V_25 ) , V_165 ) ;
if ( ! V_25 )
return - V_202 ;
V_25 -> V_7 = & V_200 -> V_7 ;
F_105 ( V_200 , V_25 ) ;
V_17 = F_106 ( V_200 , V_203 , 0 ) ;
if ( ! V_17 )
return - V_38 ;
if ( ! F_107 ( V_25 -> V_7 , V_17 -> V_174 ,
F_108 ( V_17 ) , V_200 -> V_32 ) )
return - V_204 ;
V_25 -> V_92 = F_109 ( V_25 -> V_7 , V_17 -> V_174 ,
F_108 ( V_17 ) ) ;
if ( ! V_25 -> V_92 )
return - V_205 ;
V_17 = F_106 ( V_200 , V_206 , 0 ) ;
if ( ! V_17 )
return - V_38 ;
F_35 ( V_207 ,
V_25 -> V_92 + V_192 ) ;
if ( F_36 ( V_25 -> V_92 + V_192 ) &
V_208 ) {
F_35 ( V_209 ,
V_25 -> V_92 + V_192 ) ;
V_40 = F_110 ( V_25 -> V_7 , V_17 -> V_174 ,
