...
V_51 . V_66 , V_51 . V_64 ) ;
F_11 ( V_72 , V_79 , 0 ) ;
F_11 ( V_72 , V_80 , V_51 . V_66 ) ;
F_11 ( V_72 , V_79 , V_51 . V_64 ) ;
}
...
F_11 ( V_72 , V_79 , V_81 ) ;
F_16 ( & V_72 -> V_82 ) ;
if ( F_17 ( F_18 ( F_19 ( V_84 ) ) & V_85 , 20 ) ) {
F_7 ( L_5 ) ;
return;
}
F_10 ( L_6 ) ;
}
void F_20 ( struct V_69 * V_70 )
{
struct V_71 * V_72 = V_70 -> V_73 . V_74 -> V_75 ;
T_1 V_81 ;
F_10 ( L_4 ) ;
...
static void F_21 ( int V_3 , int V_87 )
{
int V_7 ;
switch ( V_3 ) {
default:
...
T_1 F_23 ( struct V_69 * V_70 , int V_87 )
{
struct V_71 * V_72 = V_70 -> V_73 . V_74 -> V_75 ;
struct V_76 * V_76 = F_9 ( & V_70 -> V_73 ) ;
T_1 V_88 , V_49 ;
...
for ( V_92 = 0 ; V_92 < F_24 ( V_63 ) ; V_92 ++ ) {
if ( V_63 [ V_92 ] == V_90 )
break;
}
if ( V_92 == F_24 ( V_63 ) ) {
