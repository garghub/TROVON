...
static void * F_18 ( int V_40 , T_2 V_42 , T_3 V_43 )
{
void * * V_41 ;
int V_5 ;
V_41 = F_19 ( V_40 * sizeof( void * ) , V_43 ) ;
if ( ! V_41 )
return NULL ;
for ( V_5 = 0 ; V_5 < V_40 ; V_5 ++ ) {
V_41 [ V_5 ] = F_19 ( V_42 , V_43 ) ;
if ( ! V_41 [ V_5 ] ) {
F_16 ( V_41 , V_40 ) ;
return NULL ;
}
...
F_40 ( & V_20 -> V_57 , V_43 ) ;
V_20 -> V_80 = 1 ;
F_41 (sess, sess_tmp, &acl->acl_sess_list,
sess_acl_list) {
if ( V_77 -> V_81 != 0 )
continue;
F_42 ( V_77 ) ;
...
F_44 ( & V_20 -> V_57 , V_43 ) ;
F_41 (sess, sess_tmp, &sess_list, sess_acl_list) {
F_39 ( & V_77 -> V_82 ) ;
...
{
struct V_8 * V_9 = F_51 ( V_93 , struct V_8 , V_94 ) ;
F_52 ( & V_9 -> V_95 ) ;
}
static int F_53 ( struct V_3 * V_61 )
{
...
F_39 ( & V_61 -> V_115 ) ;
F_57 ( & V_118 ) ;
while ( F_31 ( & V_61 -> V_114 ) != 0 )
F_32 () ;
F_2 ( & V_61 -> V_21 ) ;
F_41 (nacl, nacl_tmp, &se_tpg->acl_node_list,
acl_list) {
F_39 ( & V_2 -> V_53 ) ;
V_61 -> V_69 -- ;
F_4 ( & V_61 -> V_21 ) ;
...
{
int V_98 ;
V_98 = F_61 ( & V_9 -> V_94 , F_50 , 0 ,
V_44 ) ;
if ( V_98 < 0 )
return V_98 ;
V_98 = F_62 ( V_24 , V_4 , V_9 ) ;
if ( V_98 < 0 ) {
F_63 ( & V_9 -> V_94 ) ;
return V_98 ;
}
