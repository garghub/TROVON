...
void F_164 ( struct V_1 * V_2 , int V_317 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_5 -> V_82 ;
struct V_173 * V_194 , * V_116 ;
...
F_178 () ;
while ( F_179 ( V_321 , & V_14 -> V_12 . V_322 ) )
F_172 ( 1 ) ;
F_163 ( V_5 , V_5 -> V_16 [ V_6 ] ) ;
F_145 ( V_5 , V_14 ) ;
F_138 ( V_5 , V_6 ) ;
...
if ( V_5 -> V_333 ) {
F_72 ( V_5 -> V_82 -> V_2 , V_5 -> V_333 , V_5 -> V_215 ) ;
V_5 -> V_333 = 0 ;
}
}
...
int V_114 ;
int V_335 ;
V_114 = F_69 ( V_5 -> V_82 -> V_2 , V_5 -> V_215 , 256 , & V_5 -> V_333 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_78 ) ;
return V_114 ;
}
for ( V_6 = 0 ; V_6 < V_5 -> V_215 ; V_6 ++ ) {
V_335 = F_191 ( V_6 % F_192 () ) ;
...
#ifdef F_185
if ( V_5 -> V_82 -> V_2 -> V_130 . V_340 ) {
V_5 -> V_2 -> V_330 = F_196 ( V_5 -> V_82 -> V_2 -> V_130 . V_340 ) ;
if ( ! V_5 -> V_2 -> V_330 )
goto V_114;
}
#endif
...
F_198 ( V_2 ) ;
if ( V_5 -> V_342 )
F_199 ( V_82 -> V_2 , & V_5 -> V_343 , V_344 ) ;
F_200 ( & V_5 -> V_271 ) ;
F_200 ( & V_5 -> V_275 ) ;
F_201 ( V_82 -> V_115 ) ;
F_50 ( & V_82 -> V_126 ) ;
...
static int F_203 ( struct V_1 * V_2 , int V_346 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_5 -> V_82 ;
int V_114 = 0 ;
...
static int F_205 ( struct V_1 * V_2 , struct V_349 * V_350 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_5 -> V_82 ;
struct V_351 V_352 ;
if ( F_206 ( & V_352 , V_350 -> V_353 , sizeof( V_352 ) ) )
return - V_354 ;
if ( V_352 . V_164 )
return - V_9 ;
if ( ! ( V_82 -> V_2 -> V_130 . V_276 & V_277 ) )
...
if ( F_207 ( V_2 , V_352 . V_355 , V_352 . V_359 ) ) {
V_352 . V_355 = V_356 ;
V_352 . V_359 = V_360 ;
}
return F_208 ( V_350 -> V_353 , & V_352 ,
sizeof( V_352 ) ) ? - V_354 : 0 ;
}
static int F_209 ( struct V_1 * V_2 , struct V_349 * V_350 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
return F_208 ( V_350 -> V_353 , & V_5 -> V_351 ,
sizeof( V_5 -> V_351 ) ) ? - V_354 : 0 ;
}
static int F_210 ( struct V_1 * V_2 , struct V_349 * V_350 , int V_375 )
{
switch ( V_375 ) {
case V_376 :
return F_205 ( V_2 , V_350 ) ;
case V_377 :
return F_209 ( V_2 , V_350 ) ;
default:
return - V_378 ;
}
}
static int F_211 ( struct V_1 * V_379 ,
T_6 V_380 )
{
struct V_4 * V_5 = F_2 ( V_379 ) ;
if ( V_380 & V_381 )
V_5 -> V_382 |= F_212 ( V_383 ) ;
else
V_5 -> V_382 &=
F_212 ( ~ V_383 ) ;
F_213 ( V_379 , V_380 ) ;
...
static int F_214 ( struct V_1 * V_2 , int V_384 , T_1 * V_135 )
{
struct V_4 * V_385 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_385 -> V_82 ;
T_5 V_386 = F_66 ( V_135 ) ;
if ( ! F_84 ( V_135 ) )
return - V_9 ;
return F_215 ( V_82 -> V_2 , V_385 -> V_64 , V_384 , V_386 ) ;
}
static int F_216 ( struct V_1 * V_2 , int V_387 , T_4 V_388 , T_1 V_389 )
{
struct V_4 * V_385 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_385 -> V_82 ;
return F_217 ( V_82 -> V_2 , V_385 -> V_64 , V_387 , V_388 , V_389 ) ;
}
static int F_218 ( struct V_1 * V_2 , int V_387 , bool V_390 )
{
struct V_4 * V_385 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_385 -> V_82 ;
return F_219 ( V_82 -> V_2 , V_385 -> V_64 , V_387 , V_390 ) ;
}
static int F_220 ( struct V_1 * V_2 , int V_387 , struct V_391 * V_392 )
{
struct V_4 * V_385 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_385 -> V_82 ;
return F_221 ( V_82 -> V_2 , V_385 -> V_64 , V_387 , V_392 ) ;
}
static int F_222 ( struct V_1 * V_2 , int V_387 , int V_206 )
{
struct V_4 * V_385 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_385 -> V_82 ;
return F_223 ( V_82 -> V_2 , V_385 -> V_64 , V_387 , V_206 ) ;
}
...
int V_6 ;
T_5 V_395 = V_82 -> V_130 . V_395 [ V_5 -> V_64 ] ;
if ( ! V_395 )
return - V_378 ;
...
struct V_4 * V_5 = F_6 ( V_32 , struct V_4 ,
V_398 ) ;
V_96 = F_226 ( V_5 -> V_82 -> V_2 , V_5 -> V_399 ) ;
if ( V_96 )
goto V_112;
...
if ( V_408 && V_408 != V_64 ) {
F_15 ( V_5 , L_86 ,
F_229 ( V_408 ) , F_229 ( V_64 ) ) ;
return;
}
V_5 -> V_399 = V_64 ;
F_37 ( V_5 -> V_82 -> V_115 , & V_5 -> V_398 ) ;
}
...
static bool F_231 ( struct V_98 * V_99 , struct V_1 * V_2 )
{
return F_232 ( V_99 ) ;
}
int F_233 ( struct V_122 * V_82 , int V_64 ,
struct V_334 * V_309 )
{
struct V_1 * V_2 ;
struct V_4 * V_5 ;
...
int V_114 ;
T_5 V_386 ;
V_2 = F_234 ( sizeof( struct V_4 ) ,
V_410 , V_411 ) ;
if ( V_2 == NULL )
return - V_113 ;
F_235 ( V_2 , V_309 -> V_215 ) ;
F_236 ( V_2 , V_309 -> V_213 ) ;
F_237 ( V_2 , & V_82 -> V_2 -> V_412 -> V_2 ) ;
V_2 -> V_413 = V_64 - 1 ;
V_5 = F_2 ( V_2 ) ;
memset ( V_5 , 0 , sizeof( struct V_4 ) ) ;
V_5 -> V_2 = V_2 ;
V_5 -> V_82 = V_82 ;
V_5 -> V_414 = & V_82 -> V_412 -> V_2 ;
V_5 -> V_309 = V_309 ;
V_5 -> V_64 = V_64 ;
V_5 -> V_19 = false ;
V_5 -> V_164 = V_309 -> V_164 ;
V_5 -> V_415 = V_416 ;
V_5 -> V_382 = F_212 ( V_417 |
V_418 ) ;
V_5 -> V_10 = V_82 -> V_419 . V_10 ;
V_5 -> V_215 = V_309 -> V_215 ;
V_5 -> V_420 = V_421 ;
V_5 -> V_216 = F_24 ( sizeof( struct V_285 * ) * V_410 ,
V_154 ) ;
if ( ! V_5 -> V_216 ) {
V_114 = - V_113 ;
goto V_112;
}
V_5 -> V_243 = F_24 ( sizeof( struct V_13 * ) * V_410 ,
V_154 ) ;
if ( ! V_5 -> V_243 ) {
V_114 = - V_113 ;
goto V_112;
...
V_5 -> V_422 = ( V_82 -> V_2 -> V_130 . V_423 == 64 ) ? 1 : 0 ;
V_5 -> V_423 = V_82 -> V_2 -> V_130 . V_423 ;
V_5 -> V_424 = - 1 ;
V_5 -> V_425 = V_426 ;
F_238 ( & V_5 -> V_224 ) ;
...
F_239 ( & V_5 -> V_271 , F_125 ) ;
F_239 ( & V_5 -> V_275 , F_129 ) ;
#ifdef F_156
F_25 ( & V_5 -> V_398 , F_225 ) ;
F_25 ( & V_5 -> V_406 , F_227 ) ;
#endif
#ifdef F_240
if ( ! F_241 ( V_5 -> V_82 -> V_2 ) ) {
if ( V_82 -> V_2 -> V_130 . V_164 & V_427 ) {
V_2 -> V_428 = & V_429 ;
} else {
F_132 ( V_5 , L_88 ) ;
V_2 -> V_428 = & V_430 ;
...
for ( V_6 = 0 ; V_6 < V_162 ; ++ V_6 )
F_242 ( & V_5 -> V_158 [ V_6 ] ) ;
V_5 -> V_293 = V_82 -> V_2 -> V_130 . V_431 [ V_5 -> V_64 ] ;
V_2 -> V_432 = V_78 ;
F_57 ( V_2 -> V_77 , V_82 -> V_2 -> V_130 . V_433 [ V_5 -> V_64 ] ) ;
if ( ! F_84 ( V_2 -> V_77 ) ) {
if ( F_241 ( V_5 -> V_82 -> V_2 ) ) {
F_243 ( V_2 ) ;
F_15 ( V_5 , L_89 , V_2 -> V_77 ) ;
V_386 = F_66 ( V_2 -> V_77 ) ;
V_82 -> V_2 -> V_130 . V_433 [ V_5 -> V_64 ] = V_386 ;
} else {
F_18 ( V_5 , L_90 ,
V_5 -> V_64 , V_2 -> V_77 ) ;
V_114 = - V_9 ;
...
V_5 -> V_332 = F_244 ( sizeof( struct V_434 ) +
V_435 * V_436 ) ;
V_114 = F_190 ( V_5 ) ;
if ( V_114 )
goto V_112;
...
V_114 = F_245 ( V_82 -> V_2 , & V_5 -> V_343 ,
V_344 , V_344 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_91 ) ;
goto V_112;
...
F_236 ( V_2 , V_5 -> V_213 ) ;
V_2 -> V_442 = & V_443 ;
V_2 -> V_405 = V_444 | V_401 | V_445 ;
if ( V_82 -> V_446 )
V_2 -> V_405 |= V_403 | V_447 ;
V_2 -> V_448 = V_2 -> V_405 ;
V_2 -> V_405 |= V_402 | V_449 ;
V_2 -> V_380 = V_2 -> V_405 | V_450 |
V_451 | V_452 |
V_453 ;
V_2 -> V_405 |= V_381 ;
if ( V_82 -> V_2 -> V_130 . V_137 ==
