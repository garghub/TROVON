...
int V_48 ;
int V_133 ;
V_28 -> V_65 = V_14 -> V_152 . V_65 ;
switch ( V_149 ) {
case V_153 :
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_154 ,
V_155 , V_155 ) ;
if( V_28 -> V_156 ) {
V_48 = F_60 ( V_28 -> V_51 , V_28 -> V_156 , & V_133 ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_64 ,
V_48 ) ;
return V_48 ;
}
V_133 = ( V_133 & V_28 -> V_157 )
>> V_28 -> V_158 ;
V_48 = F_59 ( V_28 -> V_51 ,
V_28 -> V_35 + V_159 ,
V_160 , V_133 ) ;
...
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_154 ,
V_162 | V_163 , 0 ) ;
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_165 ,
V_166 , 0 ) ;
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_154 ,
V_155 , 0 ) ;
...
unsigned int V_133 ;
int V_48 , V_45 ;
V_48 = F_62 ( V_28 -> V_51 , V_28 -> V_35 + V_167 ,
V_168 , V_168 ) ;
if ( V_48 != 0 )
return V_48 ;
for ( V_45 = 0 ; V_45 < 10 ; ++ V_45 ) {
V_48 = F_60 ( V_28 -> V_51 , V_28 -> V_35 + V_169 ,
& V_133 ) ;
if ( V_48 != 0 )
return V_48 ;
if ( V_133 & V_170 )
...
int V_48 ;
unsigned int V_133 ;
V_48 = F_60 ( V_28 -> V_51 , V_172 , & V_133 ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_64 , V_48 ) ;
return;
}
...
if ( V_28 -> V_177 ) {
V_48 = F_60 ( V_28 -> V_51 ,
V_28 -> V_35 + V_175 , & V_133 ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 , L_68 , V_48 ) ;
return;
}
if ( ( V_133 & V_176 ) >= 3 ) {
V_48 = F_65 ( V_28 -> V_177 ) ;
if ( V_48 != 0 ) {
F_20 ( V_28 ,
L_69 ,
V_48 ) ;
...
return;
V_161:
F_59 ( V_28 -> V_51 , V_28 -> V_35 + V_167 ,
V_168 | V_178 | V_179 , 0 ) ;
}
int F_67 ( struct V_147 * V_148 ,
...
V_168 | V_178 |
V_179 , 0 ) ;
F_71 ( V_28 -> V_51 , V_28 -> V_35 + V_183 , 0 ) ;
F_71 ( V_28 -> V_51 , V_28 -> V_35 + V_184 , 0 ) ;
F_71 ( V_28 -> V_51 , V_28 -> V_35 + V_185 , 0 ) ;
if ( V_28 -> V_177 ) {
V_48 = F_66 ( V_28 -> V_177 , 1200000 ,
1800000 ) ;
if ( V_48 != 0 )
F_39 ( V_28 ,
L_71 ,
V_48 ) ;
V_48 = F_72 ( V_28 -> V_177 ) ;
if ( V_48 != 0 )
F_20 ( V_28 ,
L_69 ,
V_48 ) ;
...
int F_73 ( struct V_18 * V_19 , bool V_177 )
{
int V_48 ;
V_48 = F_59 ( V_19 -> V_51 , V_19 -> V_35 + V_167 ,
V_186 , 0 ) ;
if ( V_48 != 0 ) {
F_20 ( V_19 , L_73 , V_48 ) ;
return V_48 ;
...
F_57 ( & V_19 -> V_136 ) ;
F_57 ( & V_19 -> V_67 ) ;
F_49 ( & V_19 -> V_171 , F_64 ) ;
if ( V_177 ) {
V_19 -> V_177 = F_74 ( V_19 -> V_89 , L_74 ) ;
if ( F_75 ( V_19 -> V_177 ) ) {
V_48 = F_76 ( V_19 -> V_177 ) ;
F_20 ( V_19 , L_75 , V_48 ) ;
return V_48 ;
}
V_48 = F_65 ( V_19 -> V_177 ) ;
if ( V_48 != 0 ) {
F_20 ( V_19 , L_76 , V_48 ) ;
return V_48 ;
}
V_48 = F_66 ( V_19 -> V_177 , 1200000 , 1800000 ) ;
if ( V_48 != 0 ) {
F_20 ( V_19 , L_77 , V_48 ) ;
return V_48 ;
}
V_48 = F_72 ( V_19 -> V_177 ) ;
if ( V_48 != 0 ) {
F_20 ( V_19 , L_78 , V_48 ) ;
return V_48 ;
}
