...
F_76 ( struct V_100 * , V_141 , V_115 -> V_142 ) ;
T_6 V_143 ;
T_4 V_110 ;
struct V_3 * V_4 = NULL ;
struct V_1 * V_2 ;
...
V_30 = F_82 ( V_4 , V_115 -> V_158 , V_139 ) ;
if ( V_30 )
goto V_35;
}
V_4 -> V_38 . V_39 = 1 ;
...
F_85 ( V_2 ) ;
V_30 = F_86 ( V_2 -> V_164 , V_110 , V_144 , V_67 ) ;
if ( V_30 ) {
V_67 -> V_165 = 1 ;
goto V_35;
}
...
V_4 -> V_38 . V_39 = 1 ;
F_85 ( V_2 ) ;
V_30 = F_86 ( V_2 -> V_164 , V_110 , 1 , NULL ) ;
if ( V_30 )
goto V_35;
F_4 ( & V_2 -> V_19 , V_6 ) ;
F_46 ( & V_4 -> V_42 , & V_2 -> V_24 ) ;
