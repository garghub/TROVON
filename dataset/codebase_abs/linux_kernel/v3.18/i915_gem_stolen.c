...
struct V_56 * V_57 ;
F_34 ( L_10 , V_54 , V_24 ) ;
F_35 ( V_54 > V_4 -> V_14 . V_15 - V_24 ) ;
V_55 = F_36 ( sizeof( * V_55 ) , V_39 ) ;
if ( V_55 == NULL )
return NULL ;
if ( F_37 ( V_55 , 1 , V_39 ) ) {
F_20 ( V_55 ) ;
...
V_57 -> V_54 = 0 ;
V_57 -> V_59 = V_24 ;
F_38 ( V_57 ) = ( V_60 ) V_4 -> V_28 . V_42 + V_54 ;
F_39 ( V_57 ) = V_24 ;
return V_55 ;
}
...
V_62 -> V_83 = 1 ;
F_58 ( & V_62 -> V_84 , & V_4 -> V_28 . V_85 ) ;
F_58 ( & V_79 -> V_86 , & V_77 -> V_87 ) ;
F_49 ( V_62 ) ;
return V_62 ;
V_82:
F_59 ( V_79 ) ;
