...
static int F_323 ( const T_6 V_599 )
{
int V_73 ;
T_6 V_118 , V_217 ;
if ( V_599 > V_600 )
...
static int F_324 ( const T_6 V_599 )
{
F_20 ( V_593 ,
L_339 , V_599 ) ;
return F_323 ( V_599 ) ;
...
static int F_327 ( struct V_607 * V_608 ,
struct V_609 * V_610 )
{
V_610 -> type = V_611 ;
V_610 -> V_35 = 1 ;
V_610 -> V_38 . integer . V_612 = 0 ;
V_610 -> V_38 . integer . V_127 = V_600 ;
return 0 ;
}
static int F_328 ( struct V_607 * V_608 ,
struct V_613 * V_614 )
{
T_6 V_118 ;
int V_73 ;
...
if ( V_73 < 0 )
return V_73 ;
V_614 -> V_38 . integer . V_38 [ 0 ] = V_118 & V_596 ;
return 0 ;
}
static int F_329 ( struct V_607 * V_608 ,
struct V_613 * V_614 )
{
F_82 ( L_340 , L_341 ,
V_614 -> V_38 . integer . V_38 [ 0 ] ) ;
return F_324 ( V_614 -> V_38 . integer . V_38 [ 0 ] ) ;
}
static int F_330 ( struct V_607 * V_608 ,
struct V_613 * V_614 )
{
T_6 V_118 ;
int V_73 ;
...
static int F_331 ( struct V_607 * V_608 ,
struct V_613 * V_614 )
{
F_82 ( L_340 , L_342 ,
V_614 -> V_38 . integer . V_38 [ 0 ] ?
L_42 : L_1 ) ;
return F_321 ( ! V_614 -> V_38 . integer . V_38 [ 0 ] ) ;
}
...
V_66 = V_616 -> V_603 ;
V_66 -> V_616 = V_616 ;
F_339 ( V_616 -> V_81 , V_622 ,
sizeof( V_616 -> V_81 ) ) ;
F_339 ( V_616 -> V_623 , V_624 ,
sizeof( V_616 -> V_623 ) ) ;
snprintf ( V_616 -> V_625 , sizeof( V_616 -> V_625 ) , L_344 ,
( V_7 . V_626 ) ?
V_7 . V_626 : L_345 ) ;
snprintf ( V_616 -> V_627 , sizeof( V_616 -> V_627 ) ,
L_346 , V_616 -> V_623 , V_598 ,
( V_7 . V_626 ) ?
V_7 . V_626 : L_347 ) ;
if ( V_592 ) {
V_628 . V_629 = F_329 ;
...
if ( ! V_186 . V_594 ) {
V_617 = F_340 ( & V_628 , NULL ) ;
V_73 = F_341 ( V_616 , V_617 ) ;
if ( V_73 < 0 ) {
F_8 ( L_348 ,
V_73 ) ;
goto V_345;
}
V_66 -> V_606 = & V_617 -> V_144 ;
}
V_618 = F_340 ( & V_632 , NULL ) ;
V_73 = F_341 ( V_616 , V_618 ) ;
if ( V_73 < 0 ) {
F_8 ( L_349 , V_73 ) ;
goto V_345;
}
V_66 -> V_604 = & V_618 -> V_144 ;
V_73 = F_342 ( V_616 ) ;
if ( V_73 < 0 ) {
F_8 ( L_350 , V_73 ) ;
goto V_345;
...
V_649 -- ;
continue;
} else if ( sscanf ( V_159 , L_373 , & V_651 ) == 1 &&
V_651 >= 0 && V_651 <= V_600 ) {
V_649 = V_651 ;
continue;
}
...
F_82 ( L_376 ,
L_377 ,
V_650 ? L_1 : L_42 , V_649 ) ;
V_73 = F_319 ( V_650 | V_649 ) ;
}
F_325 () ;
return ( V_73 == - V_588 ) ? - V_294 : V_73 ;
}
...
static void F_347 ( T_6 * V_655 )
{
if ( F_142 ( V_186 . V_654 ) ) {
if ( * V_655 != V_653 ) {
V_186 . V_654 = 0 ;
} else {
* V_655 = V_656 ;
...
if ( V_186 . V_657 ) {
T_6 V_658 ;
if ( F_12 ( V_659 , & V_658 ) < 0 )
return false ;
V_658 &= 0xFEU ;
if ( F_14 ( V_659 , V_658 ) < 0 )
return false ;
}
return true ;
}
...
case V_663 : {
int V_17 ;
if ( F_142 ( ! F_7 ( V_664 , & V_17 , NULL , L_64 ) ) )
return - V_50 ;
if ( F_140 ( V_30 ) )
* V_30 = V_17 & 0x07 ;
break;
...
static int F_353 ( unsigned int * V_668 )
{
T_6 V_669 , V_670 ;
switch ( V_662 ) {
case V_665 :
...
static int F_354 ( unsigned int * V_668 )
{
T_6 V_669 , V_670 ;
bool V_73 ;
switch ( V_662 ) {
...
case V_674 :
if ( V_56 >= 0 && V_56 <= 7 ) {
if ( ! F_7 ( V_675 , NULL , NULL , L_9 , V_56 ) )
return - V_50 ;
} else
return - V_94 ;
break;
...
V_118 &= 0x07 ;
V_118 |= 4 ;
if ( ! F_7 ( V_675 , NULL , NULL , L_9 , V_118 ) )
V_73 = - V_50 ;
else
V_73 = 0 ;
break;
...
break;
case V_674 :
if ( ! F_7 ( V_675 , NULL , NULL , L_9 , 0x00 ) )
V_73 = - V_50 ;
else
V_661 = 0 ;
break;
...
switch ( V_673 ) {
case V_676 :
if ( V_668 >= 0 && V_668 <= 65535 ) {
if ( ! F_7 ( V_680 , NULL , NULL , L_383 ,
V_668 , V_668 , V_668 ) )
V_73 = - V_50 ;
} else
V_73 = - V_94 ;
...
static void F_364 ( struct V_459 * V_684 )
{
int V_73 ;
if ( V_69 != V_70 )
return;
...
if ( V_17 < 0 )
return V_17 ;
return snprintf ( V_126 , V_102 , L_389 , V_668 ) ;
}
...
char * V_126 )
{
return snprintf ( V_126 , V_102 , L_389 , V_682 ) ;
}
...
{
int V_705 ;
if ( sscanf ( V_159 , L_425 , & V_705 ) != 1 )
return 0 ;
if ( V_705 < 0 || V_705 > 120 )
* V_73 = - V_94 ;
else {
V_682 = V_705 ;
F_82 ( L_417 ,
...
static int F_384 ( struct V_706 * V_157 , bool V_205 )
{
T_3 V_528 ;
int V_707 ;
...
if ( ! F_7 ( V_129 , & V_707 , V_157 -> V_51 , L_7 ,
V_205 ? V_157 -> V_708 : V_157 -> V_709 ) )
return - V_50 ;
V_157 -> V_205 = V_205 ;
return V_205 ;
}
int F_385 ( int V_710 , bool V_711 )
{
struct V_706 * V_157 ;
if ( V_710 < 0 || V_710 >= V_712 )
return - V_94 ;
V_157 = & V_713 [ V_710 ] ;
if ( V_157 -> V_205 < 0 || V_157 -> V_205 == V_711 )
return V_157 -> V_205 ;
return F_384 ( V_157 , V_711 ) ;
}
static int F_386 ( struct V_306 * V_307 )
{
T_3 V_528 ;
int V_42 ;
for ( V_42 = 0 ; V_42 < V_712 ; V_42 ++ ) {
struct V_706 * V_157 = & V_713 [ V_42 ] ;
if ( F_19 ( F_18 ( V_129 , V_157 -> V_51 , & V_528 ) ) )
F_384 ( V_157 , false ) ;
else
V_157 -> V_205 = - V_75 ;
...
static void F_389 ( const unsigned int V_714 )
{
if ( V_562 ) {
switch ( V_714 ) {
case V_715 :
...
{
static char V_721 [] V_722 = L_429 ;
return ( V_1 ) ? & V_721 [ 4 ] : & V_721 [ 0 ] ;
}
...
F_25 ( V_68 == NULL ) ;
F_397 ( & V_68 -> V_723 ) ;
if ( V_68 -> V_79 . V_729 && ! V_729 )
return 0 ;
F_20 ( V_55 ,
L_435 , V_68 -> V_51 ) ;
if ( V_307 -> V_730 ) {
V_100 = V_307 -> V_730 ( V_307 ) ;
if ( V_100 > 0 )
return 0 ;
if ( V_100 )
return V_100 ;
...
L_437 , V_68 -> V_51 ) ;
if ( V_68 -> V_93 ) {
T_19 V_356 = V_307 -> V_732 ;
if ( ! V_356 )
V_356 = V_733 ;
if ( V_68 -> V_101 )
V_356 |= V_734 ;
V_728 = F_398 ( V_68 -> V_51 , V_356 , V_725 ,
& V_735 , V_68 ) ;
if ( ! V_728 ) {
F_8 ( L_438 , V_68 -> V_51 ) ;
V_100 = - V_75 ;
...
return 0 ;
V_118 = F_404 ( V_741 ) ;
V_738 -> V_742 = F_405 ( V_118 , V_83 ) ;
if ( V_118 && ! V_738 -> V_742 )
return - V_84 ;
if ( ! ( F_401 ( V_738 -> V_742 , 'E' ) ||
F_401 ( V_738 -> V_742 , 'C' ) ) )
return 0 ;
V_738 -> V_10 = V_738 -> V_742 [ 0 ]
| ( V_738 -> V_742 [ 1 ] << 8 ) ;
V_738 -> V_184 = ( V_738 -> V_742 [ 4 ] << 8 )
| V_738 -> V_742 [ 5 ] ;
while ( ( V_60 = F_406 ( V_743 , NULL , V_60 ) ) ) {
if ( sscanf ( V_60 -> V_51 ,
L_442 ,
V_740 ) == 1 ) {
V_740 [ sizeof( V_740 ) - 1 ] = 0 ;
V_740 [ strcspn ( V_740 , L_443 ) ] = 0 ;
V_738 -> V_626 = F_405 ( V_740 , V_83 ) ;
if ( ! V_738 -> V_626 )
return - V_84 ;
if ( F_401 ( V_740 , 'H' ) ) {
V_738 -> V_12 = V_740 [ 0 ]
| ( V_740 [ 1 ] << 8 ) ;
V_738 -> V_185 = ( V_740 [ 4 ] << 8 )
| V_740 [ 5 ] ;
} else {
F_32 ( L_444
L_445 ,
...
V_118 = F_404 ( V_744 ) ;
if ( V_118 && ! ( strncasecmp ( V_118 , L_446 , 8 ) && strncasecmp ( V_118 , L_447 , 6 ) ) ) {
V_738 -> V_745 = F_405 ( V_118 , V_83 ) ;
if ( ! V_738 -> V_745 )
return - V_84 ;
} else {
V_118 = F_404 ( V_746 ) ;
if ( V_118 && ! ( strncasecmp ( V_118 , L_447 , 6 ) ) ) {
V_738 -> V_745 = F_405 ( V_118 , V_83 ) ;
if ( ! V_738 -> V_745 )
return - V_84 ;
}
...
V_118 = F_404 ( V_747 ) ;
V_738 -> V_748 = F_405 ( V_118 , V_83 ) ;
if ( V_118 && ! V_738 -> V_748 )
return - V_84 ;
return 0 ;
}
...
if ( ! F_6 () && ! F_5 () )
return - V_75 ;
V_749 = ( V_7 . V_745 != NULL ) ||
( V_7 . V_12 != 0 ) ||
F_107 () ;
F_24 ( L_448 , V_751 , & V_451 ) ;
if ( ! V_451 ) {
if ( V_749 )
F_8 ( L_449 ) ;
return - V_75 ;
...
static int T_1 F_409 ( const char * V_658 , struct V_754 * V_755 )
{
unsigned int V_42 ;
struct V_67 * V_68 ;
if ( ! V_755 || ! V_755 -> V_51 || ! V_658 )
return - V_94 ;
for ( V_42 = 0 ; V_42 < F_100 ( V_756 ) ; V_42 ++ ) {
V_68 = V_756 [ V_42 ] . V_66 ;
F_410 ( V_68 == NULL ) ;
if ( ! V_68 || ! V_68 -> V_51 )
continue;
if ( strcmp ( V_68 -> V_51 , V_755 -> V_51 ) == 0 && V_68 -> V_101 ) {
if ( strlen ( V_658 ) > sizeof( V_756 [ V_42 ] . V_757 ) - 2 )
return - V_758 ;
strcpy ( V_756 [ V_42 ] . V_757 , V_658 ) ;
strcat ( V_756 [ V_42 ] . V_757 , L_28 ) ;
return 0 ;
}
}
return - V_94 ;
...
V_725 = F_421 ( V_768 , V_769 ) ;
if ( ! V_725 ) {
F_8 ( L_455 V_768 L_279 ) ;
F_411 () ;
return - V_75 ;
}
V_100 = F_422 ( & V_765 ) ;
...
V_208 -> V_51 = L_463 ;
V_208 -> V_775 = V_773 L_464 ;
V_208 -> V_144 . V_776 = V_777 ;
V_208 -> V_144 . V_6 = V_7 . V_6 ;
V_208 -> V_144 . V_778 = V_779 ;
V_208 -> V_144 . V_780 = V_781 ;
V_208 -> V_60 . V_52 = & V_154 -> V_60 ;
}
F_304 () ;
for ( V_42 = 0 ; V_42 < F_100 ( V_756 ) ; V_42 ++ ) {
V_100 = F_396 ( & V_756 [ V_42 ] ) ;
if ( V_100 >= 0 && * V_756 [ V_42 ] . V_757 )
V_100 = V_756 [ V_42 ] . V_66 -> V_101 ( V_756 [ V_42 ] . V_757 ) ;
if ( V_100 < 0 ) {
F_411 () ;
return V_100 ;
}
