...
return - V_38 ;
if ( ! F_36 ( V_54 ) ) {
V_237 = snprintf ( V_234 , V_239 , L_51 , V_27 -> V_30 ) ;
if ( V_237 >= V_239 ) {
F_19 ( V_234 , V_239 ) ;
return - V_240 ;
}
...
V_237 = V_245 - V_244 ;
V_244 [ V_237 ] = 0 ;
V_237 += sprintf ( V_244 + V_237 , L_56 ,
V_243 ? L_57 : L_58 , V_230 -> V_256 ) ;
V_245 = V_243 ? L_59 : L_60 ,
V_237 += sprintf ( V_244 + V_237 , L_61 , V_245 , V_234 ) ;
F_119 ( & V_232 , V_244 ) ;
V_34 = F_120 ( V_244 ) ;
if ( V_34 == NULL ) {
F_5 ( V_18 , L_62 ,
...
++ V_237 ;
V_246 = V_235 + V_237 ;
V_237 += sprintf ( V_246 , L_63 , V_245 , L_64 ) ;
V_247 = V_235 + V_237 ;
...
V_237 += strlen ( V_247 ) ;
V_237 += sprintf ( V_235 + V_237 , L_67 , V_230 -> V_259 ) ;
F_12 ( V_237 < V_236 ) ;
F_123 ( & V_232 , 1 , V_246 ) ;
V_37 = - V_38 ;
...
F_5 ( V_11 , L_75 ,
V_225 -> V_48 , V_16 -> V_19 , V_37 ? L_76 : L_77 , V_37 ) ;
F_44 ( & V_16 -> V_41 ) ;
if ( ! V_303 )
F_156 ( & V_126 , V_307 ) ;
return V_37 ;
