...
V_47 += F_34 ( V_13 , V_45 , V_46 ) ;
}
return V_47 ;
}
static int F_35 ( struct V_24 * V_8 , struct V_48 * V_49 ,
void * V_50 )
{
struct V_7 * V_27 = F_15 ( V_8 ,
struct V_7 ,
...
struct V_24 * F_37 ( struct V_53 * V_50 )
{
struct V_7 * V_8 ;
int V_2 ;
...
F_45 ( V_6 , V_1 ) ;
V_60 = F_16 ( V_60 ) ;
for ( V_2 = V_60 >> V_62 ; V_2 < ( 1 << V_1 ) ; V_2 ++ )
F_46 ( V_6 + V_2 ) ;
V_29 = F_19 ( sizeof( struct V_28 ) , V_41 ) ;
if ( ! V_29 ) {
V_61 = - V_38 ;
...
V_61 = F_20 ( V_29 , 1 , V_41 ) ;
if ( V_61 )
goto V_42;
F_22 ( V_29 -> V_43 , V_6 , V_60 , 0 ) ;
V_10 -> V_44 = V_29 ;
F_8 ( NULL , V_6 , V_60 , V_19 ) ;
return 0 ;
V_42:
F_25 ( V_29 ) ;
V_39:
for ( V_2 = 0 ; V_2 < V_60 > > V_62 ; V_2 ++ )
F_46 ( V_6 + V_2 ) ;
return V_61 ;
}
...
unsigned long V_33 = F_16 ( V_10 -> V_22 ) >> V_62 ;
unsigned long V_2 ;
...
struct V_24 * F_52 ( struct V_53 * V_50 )
{
struct V_24 * V_8 ;
