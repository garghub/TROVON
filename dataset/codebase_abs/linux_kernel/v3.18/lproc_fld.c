...
int V_18 ;
V_5 = ( (struct V_1 * ) V_12 -> V_19 ) -> V_6 ;
F_2 ( V_5 != NULL ) ;
for ( V_18 = 0 ; V_20 [ V_18 ] . V_11 != NULL ; V_18 ++ ) {
if ( V_14 != strlen ( V_20 [ V_18 ] . V_11 ) )
continue;
if ( ! strncmp ( V_20 [ V_18 ] . V_11 , V_13 , V_14 ) ) {
V_17 = & V_20 [ V_18 ] ;
break;
}
}
