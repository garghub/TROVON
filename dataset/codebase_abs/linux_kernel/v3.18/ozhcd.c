...
{
struct V_15 * V_18 =
F_8 ( sizeof( struct V_15 ) + V_16 , V_17 ) ;
if ( V_18 ) {
F_9 ( & V_18 -> V_19 ) ;
F_9 ( & V_18 -> V_20 ) ;
V_18 -> V_21 = - 1 ;
...
void F_52 ( void * V_78 , T_1 V_50 , int V_24 , const T_1 * V_88 ,
...
V_88 -> V_195 = 0x29 ;
V_88 -> V_196 = 9 ;
V_88 -> V_197 = ( V_198 V_199 ) F_108 ( 0x0001 ) ;
V_88 -> V_200 = V_8 ;
}
...
unsigned V_202 = 0 ;
unsigned V_203 = 0 ;
if ( ( V_201 < 1 ) || ( V_201 > V_8 ) )
return - V_65 ;
V_32 = & V_5 -> V_9 [ V_201 - 1 ] ;
switch ( V_96 ) {
case V_204 :
F_18 ( V_193 , L_60 ) ;
break;
...
F_18 ( V_193 , L_75 , V_201 , V_32 -> V_24 ) ;
return 0 ;
}
...
F_112 ( F_113 ( V_24 ) , ( V_220 * ) V_192 ) ;
F_18 ( V_193 , L_77 , V_125 , V_24 ) ;
return 0 ;
}
static int F_114 ( struct V_2 * V_3 , T_3 V_221 , T_3 V_96 ,
T_3 V_125 , char * V_192 , T_3 V_171 )
{
int V_51 = 0 ;
switch ( V_221 ) {
case V_222 :
F_18 ( V_193 , L_78 , V_221 ) ;
break;
case V_223 :
...
break;
case V_225 :
F_18 ( V_193 , L_79 , V_221 ) ;
F_112 ( F_113 ( 0 ) , ( V_220 * ) V_192 ) ;
break;
case V_226 :
V_51 = F_111 ( V_3 , V_125 , V_192 ) ;
break;
case V_227 :
F_18 ( V_193 , L_80 , V_221 ) ;
break;
case V_228 :
V_51 = F_109 ( V_3 , V_96 , V_125 ) ;
break;
default:
F_18 ( V_193 , L_81 , V_221 ) ;
break;
}
return V_51 ;
}
...
static void F_117 ( struct V_230 * V_114 )
{
}
static int F_118 ( struct V_230 * V_114 )
{
int V_7 ;
int V_51 ;
struct V_2 * V_3 ;
struct V_1 * V_5 ;
V_3 = F_119 ( & V_231 , & V_114 -> V_114 , F_120 ( & V_114 -> V_114 ) ) ;
if ( V_3 == NULL ) {
F_18 ( V_29 , L_82 ) ;
return - V_55 ;
}
...
F_123 ( V_3 -> V_232 . V_233 ) ;
F_26 ( & V_76 ) ;
V_77 = V_5 ;
F_29 ( & V_76 ) ;
return 0 ;
}
static int F_124 ( struct V_230 * V_114 )
{
...
static int F_127 ( struct V_230 * V_114 , T_5 V_234 )
{
return 0 ;
}
static int F_128 ( struct V_230 * V_114 )
{
return 0 ;
}
int F_129 ( void )
