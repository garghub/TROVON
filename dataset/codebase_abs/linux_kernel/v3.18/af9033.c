...
static int F_23 ( struct V_31 * V_32 , T_3 * V_134 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
int V_6 ;
T_2 V_19 ;
...
static int F_24 ( struct V_31 * V_32 , T_4 * V_141 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
struct V_34 * V_30 = & V_2 -> V_32 . V_35 ;
if ( V_30 -> V_84 . V_81 [ 0 ] . V_82 == V_142 )
* V_141 = F_25 ( V_30 -> V_84 . V_81 [ 0 ] . V_143 , 100 ) ;
else
* V_141 = 0 ;
return 0 ;
}
static int F_26 ( struct V_31 * V_32 , T_4 * V_80 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
int V_6 ;
T_2 V_144 ;
V_6 = F_6 ( V_2 , 0x800048 , & V_144 ) ;
if ( V_6 < 0 )
goto V_25;
* V_80 = V_144 * 0xffff / 100 ;
return 0 ;
V_25:
F_11 ( & V_2 -> V_12 -> V_2 , L_6 , V_6 ) ;
return V_6 ;
}
static int F_27 ( struct V_31 * V_32 , T_1 * V_145 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
* V_145 = ( V_2 -> V_88 - V_2 -> V_146 ) ;
V_2 -> V_146 = V_2 -> V_88 ;
return 0 ;
}
static int F_28 ( struct V_31 * V_32 , T_1 * V_147 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
* V_147 = V_2 -> V_148 ;
return 0 ;
}
static int F_29 ( struct V_31 * V_32 , int V_149 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
int V_6 ;
F_11 ( & V_2 -> V_12 -> V_2 , L_18 , V_149 ) ;
...
static int F_30 ( struct V_31 * V_32 , int V_150 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
int V_6 ;
F_11 ( & V_2 -> V_12 -> V_2 , L_19 , V_150 ) ;
V_6 = F_7 ( V_2 , 0x80f993 , V_150 , 0x01 ) ;
if ( V_6 < 0 )
goto V_25;
return 0 ;
V_25:
...
static int F_31 ( struct V_31 * V_32 , int V_151 , T_4 V_152 ,
int V_150 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
int V_6 ;
T_2 V_153 [ 2 ] = { ( V_152 >> 0 ) & 0xff , ( V_152 >> 8 ) & 0xff } ;
F_11 ( & V_2 -> V_12 -> V_2 , L_20 ,
V_151 , V_152 , V_150 ) ;
if ( V_152 > 0x1fff )
return 0 ;
V_6 = F_1 ( V_2 , 0x80f996 , V_153 , 2 ) ;
if ( V_6 < 0 )
goto V_25;
V_6 = F_5 ( V_2 , 0x80f994 , V_150 ) ;
if ( V_6 < 0 )
goto V_25;
V_6 = F_5 ( V_2 , 0x80f995 , V_151 ) ;
if ( V_6 < 0 )
goto V_25;
return 0 ;
V_25:
...
{
struct V_1 * V_2 = F_33 ( V_155 , struct V_1 , V_89 . V_155 ) ;
struct V_34 * V_30 = & V_2 -> V_32 . V_35 ;
...
if ( V_2 -> V_140 & V_135 ) {
if ( V_2 -> V_157 ) {
V_6 = F_6 ( V_2 , 0x80004a , & V_156 ) ;
V_19 = - V_156 * 1000 ;
} else {
V_6 = F_6 ( V_2 , 0x8000f7 , & V_156 ) ;
V_19 = ( V_156 - 100 ) * 1000 ;
}
if ( V_6 )
goto V_25;
...
if ( V_6 )
goto V_25;
V_158 = ( V_7 [ 2 ] << 16 ) | ( V_7 [ 1 ] << 8 ) | ( V_7 [ 0 ] << 0 ) ;
V_6 = F_6 ( V_2 , 0x80f903 , & V_156 ) ;
if ( V_6 )
goto V_25;
switch ( ( V_156 >> 0 ) & 3 ) {
case 0 :
...
V_19 = V_160 [ V_20 ] . V_141 * 1000 ;
if ( V_158 < V_160 [ V_20 ] . V_4 )
break;
}
V_30 -> V_84 . V_5 = 1 ;
...
if ( V_6 )
goto V_25;
V_165 = ( V_7 [ 1 ] << 8 ) | ( V_7 [ 0 ] << 0 ) ;
V_167 = ( V_7 [ 4 ] << 16 ) | ( V_7 [ 3 ] << 8 ) | V_7 [ 2 ] ;
V_166 = ( V_7 [ 6 ] << 8 ) | ( V_7 [ 5 ] << 0 ) ;
V_2 -> V_148 += V_165 ;
V_2 -> V_168 += V_166 ;
V_2 -> V_88 += V_167 ;
V_2 -> V_87 += V_166 * 204 * 8 ;
V_30 -> V_85 . V_5 = 1 ;
V_30 -> V_85 . V_81 [ 0 ] . V_82 = V_169 ;
V_30 -> V_85 . V_81 [ 0 ] . V_170 = V_2 -> V_168 ;
V_30 -> V_86 . V_5 = 1 ;
V_30 -> V_86 . V_81 [ 0 ] . V_82 = V_169 ;
V_30 -> V_86 . V_81 [ 0 ] . V_170 = V_2 -> V_148 ;
V_30 -> V_87 . V_5 = 1 ;
V_30 -> V_87 . V_81 [ 0 ] . V_82 = V_169 ;
V_30 -> V_87 . V_81 [ 0 ] . V_170 = V_2 -> V_87 ;
V_30 -> V_88 . V_5 = 1 ;
V_30 -> V_88 . V_81 [ 0 ] . V_82 = V_169 ;
V_30 -> V_88 . V_81 [ 0 ] . V_170 = V_2 -> V_88 ;
}
V_164:
F_15 ( & V_2 -> V_89 , F_16 ( 2000 ) ) ;
return;
...
static int F_34 ( struct V_171 * V_12 ,
const struct V_172 * V_173 )
{
struct V_174 * V_40 = V_12 -> V_2 . V_175 ;
struct V_1 * V_2 ;
int V_6 ;
T_2 V_7 [ 8 ] ;
T_1 V_3 ;
V_2 = F_35 ( sizeof( struct V_1 ) , V_176 ) ;
if ( V_2 == NULL ) {
V_6 = - V_177 ;
F_36 ( & V_12 -> V_2 , L_21 ) ;
goto V_25;
...
V_2 -> V_12 = V_12 ;
F_37 ( & V_2 -> V_89 , F_32 ) ;
memcpy ( & V_2 -> V_40 , V_40 , sizeof( struct V_174 ) ) ;
...
memcpy ( & V_2 -> V_32 . V_103 , & V_181 , sizeof( struct V_182 ) ) ;
V_2 -> V_32 . V_33 = V_2 ;
* V_40 -> V_32 = & V_2 -> V_32 ;
if ( V_40 -> V_103 ) {
V_40 -> V_103 -> V_183 = F_31 ;
V_40 -> V_103 -> V_184 = F_30 ;
}
F_39 ( V_12 , V_2 ) ;
F_38 ( & V_2 -> V_12 -> V_2 , L_24 ) ;
return 0 ;
V_178:
F_40 ( V_2 ) ;
V_25:
...
static int F_41 ( struct V_171 * V_12 )
{
struct V_1 * V_2 = F_42 ( V_12 ) ;
F_11 ( & V_2 -> V_12 -> V_2 , L_17 ) ;
V_2 -> V_32 . V_103 . V_185 = NULL ;
V_2 -> V_32 . V_33 = NULL ;
F_40 ( V_2 ) ;
return 0 ;
}
