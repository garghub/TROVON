...
{
struct V_76 * V_77 = F_67 ( V_173 -> V_174 -> V_175 ) ;
V_173 -> V_19 . V_20 = V_19 -> V_20 ;
F_32 ( V_77 , V_127 ) ;
V_77 -> V_176 = F_73 ( V_77 ) ;
}
static void
...
struct V_128 * V_19 )
{
return F_76 ( V_87 , V_93 , V_19 -> V_20 ) ;
}
static int
F_77 ( const unsigned int V_87 , struct V_128 * V_177 ,
struct V_178 * V_179 , unsigned int * V_164 ,
char * * V_3 , int * V_180 )
{
V_179 -> V_20 = V_177 -> V_20 ;
return F_78 ( V_87 , V_179 , V_164 , V_3 , V_180 ) ;
}
static int
F_79 ( const unsigned int V_87 , struct V_128 * V_177 ,
struct V_178 * V_179 , unsigned int * V_181 ,
struct V_182 * V_183 , unsigned long V_184 )
{
V_179 -> V_20 = V_177 -> V_20 ;
return F_80 ( V_87 , V_179 , V_181 , V_183 , V_184 ) ;
}
static int
F_81 ( struct V_166 * V_166 , const char * V_115 ,
...
struct V_113 * V_114 = F_82 ( V_166 -> V_187 ) ;
struct V_188 * V_189 = NULL ;
struct V_92 * V_93 ;
V_186 = F_83 ( V_77 , true ) ;
if ( V_186 ) {
V_19 . V_20 = V_186 -> V_19 . V_20 ;
V_185 = V_186 -> V_190 ;
V_93 = F_84 ( V_186 -> V_189 ) ;
goto V_191;
}
V_189 = F_85 ( V_114 ) ;
if ( F_86 ( V_189 ) ) {
...
V_185 = V_197 -> V_198 ;
V_191:
V_6 = F_88 ( V_87 , V_93 , V_3 , V_19 . V_20 , V_185 ) ;
if ( ! V_6 )
V_77 -> V_170 = F_53 ( V_3 -> V_124 ) ;
if ( V_186 == NULL )
F_55 ( V_87 , V_93 , V_19 . V_20 ) ;
...
static int
F_91 ( const unsigned int V_87 , struct V_92 * V_93 ,
struct V_16 * V_173 )
{
return F_92 ( V_87 , V_93 , V_173 -> V_19 . V_20 ) ;
}
static int
F_93 ( const unsigned int V_87 , struct V_92 * V_93 ,
const char * V_136 , struct V_113 * V_114 ,
struct V_128 * V_19 , T_3 V_199 ,
struct V_200 * V_201 )
{
return F_94 ( V_87 , V_93 , V_136 , V_114 ,
& V_19 -> V_20 , V_199 , V_201 , true ) ;
}
static int
F_95 ( const unsigned int V_87 , struct V_92 * V_93 ,
struct V_128 * V_19 , T_3 V_199 ,
struct V_200 * V_201 )
{
return F_96 ( V_87 , V_93 , V_19 -> V_20 , V_199 , V_201 ) ;
}
static int
F_97 ( const unsigned int V_87 , struct V_92 * V_93 ,
struct V_128 * V_19 )
{
return F_98 ( V_87 , V_93 , V_19 -> V_20 ) ;
}
static int
F_99 ( struct V_92 * V_93 , struct V_128 * V_19 ,
struct V_76 * V_77 )
{
return F_100 ( 0 , V_93 , V_19 -> V_20 , V_197 -> V_198 , 0 , 0 , 0 , 0 ,
V_202 , false ,
F_101 ( V_77 ) ? 1 : 0 ) ;
}
static int
F_102 ( const unsigned int V_87 , struct V_92 * V_93 ,
struct V_203 * V_3 )
{
int V_6 = - V_120 ;
V_3 -> V_204 = V_205 ;
if ( ( V_93 -> V_89 -> V_104 & V_106 ) &&
( V_206 & F_40 ( V_93 -> V_97 . V_98 ) ) )
...
static int
F_106 ( const unsigned int V_87 , struct V_16 * V_173 , T_2 V_207 ,
T_2 V_208 , T_8 type , int V_209 , int V_210 , bool V_211 )
{
return F_100 ( V_87 , F_84 ( V_173 -> V_189 ) , V_173 -> V_19 . V_20 ,
V_197 -> V_198 , V_208 , V_207 , V_210 , V_209 ,
( V_212 ) type , V_211 , 0 ) ;
}
static int
F_107 ( const unsigned int V_87 , struct V_92 * V_93 ,
const unsigned char * V_213 , char * * V_214 ,
...
V_6 = F_109 ( V_87 , V_93 -> V_89 , V_213 , V_216 ,
& V_217 , & V_219 , 0 ) ;
if ( ! V_6 && V_217 > 0 ) {
* V_214 = F_110 ( V_219 -> V_220 ,
strlen ( V_219 -> V_220 ) ,
V_117 ) ;
if ( ! * V_214 )
V_6 = - V_118 ;
...
static int
F_112 ( const unsigned int V_87 , struct V_92 * V_93 ,
const char * V_115 , char * * V_222 ,
struct V_113 * V_114 )
{
int V_6 ;
int V_127 = 0 ;
struct V_128 V_19 ;
struct V_129 V_130 ;
F_9 ( V_15 , L_27 , V_223 , V_115 ) ;
if ( F_113 ( V_93 -> V_89 ) ) {
V_6 = F_114 ( V_87 , V_93 , V_115 , V_222 ,
V_114 -> V_119 ) ;
if ( V_6 == - V_221 )
V_6 = F_107 ( V_87 , V_93 , V_115 ,
V_222 ,
V_114 -> V_119 ) ;
goto V_192;
}
...
if ( V_6 )
goto V_192;
V_6 = F_115 ( V_87 , V_93 , V_19 . V_20 , V_222 ,
V_114 -> V_119 ) ;
if ( V_6 )
goto V_225;
F_116 ( * V_222 , '/' ) ;
...
static unsigned int
F_118 ( struct V_166 * V_166 )
{
return F_82 ( V_166 -> V_187 ) -> V_99 ;
}
static bool
F_119 ( struct V_16 * V_173 )
{
return ! V_173 -> V_201 . V_226 && ! V_173 -> V_227 ;
}
