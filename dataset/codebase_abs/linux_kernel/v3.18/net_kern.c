...
if ( ! F_75 ( V_80 , V_67 , V_85 , & V_78 , & V_79 ) )
continue;
if ( V_78 != NULL ) {
F_55 ( V_85 , V_78 , V_79 , V_80 ) ;
F_53 ( V_78 ) ;
}
V_122 = 1 ;
break;
...
static int F_87 ( char * * V_67 , int * V_124 , int * V_125 )
{
char * V_70 ;
int V_77 ;
V_77 = F_46 ( * V_67 , & V_70 , 0 ) ;
...
static int F_90 ( struct V_128 * V_129 , unsigned long V_130 ,
void * V_131 )
{
...
void F_97 ( void * V_151 , void (* F_98)( unsigned char * , unsigned char * ,
void * ) ,
void * V_152 )
{
...
(* F_98)( V_153 , V_154 , V_152 ) ;
V_145 = V_145 -> V_149 ;
}
}
int F_99 ( void * V_151 , void * V_155 )
{
struct V_11 * V_12 = V_151 ;
struct V_143 * V_144 = V_12 -> V_147 ;
struct V_132 * V_145 ;
...
void * F_100 ( int * V_157 )
{
void * V_158 ;
V_158 = ( void * ) F_101 ( V_83 , 0 ) ;
if ( V_158 ) * V_157 = V_159 ;
else * V_157 = 0 ;
return V_158 ;
}
void F_102 ( void * V_160 )
{
F_103 ( ( unsigned long ) V_160 , 0 ) ;
}
int F_104 ( char * V_67 , char * type , char * * V_161 , char * * V_114 ,
char * * V_162 )
{
char * V_163 ;
V_163 = F_105 ( V_67 , V_161 , V_114 , V_162 , NULL ) ;
if ( V_163 != NULL ) {
F_18 ( V_32 L_28
L_29 , V_163 ) ;
return 1 ;
