...
1ULL << 16 ) ;
#else
V_55 = ( 1ULL << 63 | 1ULL << 59 | 1ULL << 57 | 1ULL << 50 |
1ULL << 29 ) ;
V_56 = ( 1ULL << 43 | 1ULL << 42 | 1ULL << 41 | 1ULL << 40 |
1ULL << 36 | 1ULL << 35 | 1ULL << 34 | 1ULL << 32 |
...
if ( V_25 . V_63 & ( 1U << V_64 ) )
F_32 () ;
if ( V_25 . V_63 & ( 1U << V_65 ) )
F_33 () ;
if ( V_25 . V_63 & ( 1U << V_66 ) )
F_34 () ;
if ( V_25 . V_63 & ( 1U << V_67 ) )
F_35 () ;
}
if ( V_18 -> V_68 )
F_1 ( L_14
