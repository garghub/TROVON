...
V_10 -> V_21 = V_21 ;
V_10 -> V_13 = V_13 ;
F_44 ( V_13 , V_2 -> V_112 , sizeof( V_2 -> V_112 ) ) ;
V_2 -> V_113 = V_81 -> V_88 ;
...
F_14 , V_2 , 8 ) ;
F_51 ( V_79 , & V_2 -> V_118 ) ;
if ( F_52 ( V_2 , V_2 -> V_119 -> V_22 &
V_120 ) < 0 )
goto V_117;
if ( V_21 -> V_22 & V_121 ) {
memcpy ( & V_2 -> V_63 , & V_122 ,
sizeof( V_122 ) ) ;
F_53 ( & V_10 -> V_73 ) ;
V_2 -> V_63 . V_24 . V_123 = V_2 -> V_24 ;
F_54 ( & V_2 -> V_63 , V_2 ) ;
if ( F_55 ( & V_2 -> V_63 ) < 0 ) {
F_10 ( V_2 -> V_24 , L_36 ) ;
goto V_117;
...
V_2 -> V_124 ) {
union V_125 V_26 ;
F_56 ( & V_2 -> V_63 , 0x21 , V_126 ,
V_127 , 0x0A , V_128 , & V_26 ) ;
if ( V_26 . V_129 != 0x76 ) {
if ( V_130 ) {
V_2 -> V_113 = V_131 ;
V_10 -> V_21 = V_21 = & V_132 ;
V_2 -> V_119 = & V_21 -> V_110 ;
strncpy ( V_2 -> V_85 , L_37 ,
sizeof( V_2 -> V_85 ) ) ;
} else {
T_1 V_133 ;
F_57 ( V_2 , 0x3c81 , & V_133 ) ;
V_133 &= 0x3 ;
V_2 -> V_113 = V_134 ;
V_10 -> V_21 = V_21 = & V_135 ;
V_2 -> V_119 = & V_21 -> V_110 ;
V_2 -> V_136 = V_133 ;
