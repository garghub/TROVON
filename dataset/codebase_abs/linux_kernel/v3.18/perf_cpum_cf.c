...
int V_20 ;
do {
V_61 = F_39 ( & V_6 -> V_47 . V_63 ) ;
V_20 = F_40 ( V_6 -> V_47 . V_15 , & V_62 ) ;
if ( V_20 ) {
if ( V_20 != 3 )
break;
V_62 = 0 ;
}
} while ( F_41 ( & V_6 -> V_47 . V_63 , V_61 , V_62 ) != V_61 );
return V_20 ;
}
...
static int F_57 ( struct V_74 * V_75 , unsigned long V_76 ,
void * V_77 )
{
