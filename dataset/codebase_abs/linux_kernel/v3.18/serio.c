...
static T_1 F_53 ( struct V_51 * V_16 , struct V_52 * V_53 , char * V_54 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
return sprintf ( V_54 , L_5 , V_1 -> V_59 ) ;
}
...
F_61 ( & V_1 -> V_16 ) ;
F_62 ( & V_1 -> V_16 , L_13 ,
( unsigned long ) F_63 ( & V_61 ) - 1 ) ;
V_1 -> V_16 . V_65 = & V_57 ;
V_1 -> V_16 . V_66 = F_54 ;
V_1 -> V_16 . V_67 = V_68 ;
if ( V_1 -> V_49 ) {
V_1 -> V_16 . V_49 = & V_1 -> V_49 -> V_16 ;
V_1 -> V_69 = V_1 -> V_49 -> V_69 + 1 ;
} else
V_1 -> V_69 = 0 ;
F_64 ( & V_1 -> V_64 , V_1 -> V_69 ) ;
}
...
static void F_27 ( struct V_1 * V_73 )
{
struct V_1 * V_74 = V_73 ;
int error ;
do {
error = F_25 ( V_74 ) ;
if ( ! error ) {
...
while ( V_74 != V_73 ) {
struct V_1 * V_49 = V_74 -> V_49 ;
if ( ! F_73 ( & V_74 -> V_62 , & V_49 -> V_63 ) ) {
V_74 = F_74 ( V_74 -> V_62 . V_32 ,
struct V_1 , V_62 ) ;
break;
}
V_74 = V_49 ;
...
{
struct V_2 * V_75 = F_50 ( V_3 ) ;
return sprintf ( V_54 , L_5 , V_75 -> V_58 ? L_11 : L_12 ) ;
}
...
int F_89 ( struct V_2 * V_3 , struct V_41 * V_28 , const char * V_77 )
{
bool V_58 = V_3 -> V_58 ;
int error ;
V_3 -> V_17 . V_65 = & V_57 ;
...
struct V_1 * V_1 = F_41 ( V_16 ) ;
struct V_2 * V_75 = F_50 ( V_3 ) ;
if ( V_1 -> V_58 || V_75 -> V_58 )
return 0 ;
return F_6 ( V_75 -> V_15 , V_1 ) ;
}
static int F_95 ( struct V_51 * V_16 , struct V_79 * V_80 )
{
struct V_1 * V_1 ;
if ( ! V_16 )
return - V_18 ;
...
unsigned char V_83 , unsigned int V_84 )
{
unsigned long V_24 ;
T_4 V_85 = V_86 ;
F_13 ( & V_1 -> V_64 , V_24 ) ;
if ( F_102 ( V_1 -> V_3 ) ) {
V_85 = V_1 -> V_3 -> V_87 ( V_1 , V_83 , V_84 ) ;
} else if ( ! V_84 && F_71 ( & V_1 -> V_16 ) ) {
F_76 ( V_1 ) ;
V_85 = V_88 ;
}
F_17 ( & V_1 -> V_64 , V_24 ) ;
