...
if ( V_43 -> V_45 . V_103 )
return - V_104 ;
if ( V_96 == V_43 -> V_45 . V_105 )
return - V_106 ;
F_81 ( V_96 , V_17 -> V_107 ) ;
if ( ! V_97 )
F_82 ( V_96 , V_17 -> V_107 ) ;
F_83 ( V_17 ) ;
if ( ! ( V_21 -> V_108 & V_109 ) ) {
V_9 = V_43 -> V_45 . V_99 . V_110 ( V_43 , V_96 , 0 , V_97 ) ;
if ( V_9 )
goto V_111;
}
V_9 = V_43 -> V_45 . V_99 . V_100 ( V_43 , V_17 -> V_48 , V_43 -> V_45 . V_112 ,
V_96 , V_97 , 0 ) ;
if ( V_9 )
goto V_111;
...
{
struct V_42 * V_43 = & V_17 -> V_43 ;
T_1 V_105 = V_43 -> V_45 . V_105 ;
T_1 V_113 = V_96 < V_105 ? V_105 : V_98 ;
V_96 = F_90 ( V_17 -> V_107 , V_113 , ++ V_96 ) ;
return V_96 ;
}
...
for ( V_96 = 0 , V_114 = 0 ;
V_114 < V_98 ;
V_114 = V_96 + 1 , V_96 = F_89 ( V_17 , V_96 ) ) {
if ( V_114 == V_96 )
continue;
V_114 += ( V_96 - V_114 - 1 ) << V_115 ;
V_43 -> V_45 . V_99 . V_110 ( V_43 , V_114 , 0 , false ) ;
}
}
static int F_92 ( struct V_61 * V_4 ,
const unsigned char * V_112 , bool V_116 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
struct V_42 * V_43 = & V_17 -> V_43 ;
...
if ( ! F_93 ( V_112 ) )
return - V_117 ;
for ( V_96 = V_43 -> V_45 . V_105 ? F_89 ( V_17 , 0 ) : 0 ;
V_96 < V_98 ;
V_96 = F_89 ( V_17 , V_96 ) ) {
V_9 = V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_112 ,
V_96 , V_116 , 0 ) ;
if ( V_9 )
return V_9 ;
}
...
{
return F_92 ( V_4 , V_112 , true ) ;
}
static int F_95 ( struct V_61 * V_4 ,
const unsigned char * V_112 )
{
return F_92 ( V_4 , V_112 , false ) ;
}
static int F_96 ( struct V_61 * V_4 , void * V_118 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
struct V_42 * V_43 = & V_17 -> V_43 ;
struct V_119 * V_112 = V_118 ;
T_5 V_9 = 0 ;
if ( ! F_93 ( V_112 -> V_120 ) )
return - V_117 ;
if ( V_4 -> V_108 & V_121 ) {
F_83 ( V_17 ) ;
V_9 = F_94 ( V_4 , V_112 -> V_120 ) ;
if ( ! V_9 )
F_95 ( V_4 , V_43 -> V_45 . V_112 ) ;
F_86 ( V_17 ) ;
}
if ( ! V_9 ) {
F_97 ( V_4 -> V_122 , V_112 -> V_120 ) ;
F_97 ( V_43 -> V_45 . V_112 , V_112 -> V_120 ) ;
V_4 -> V_123 &= ~ V_124 ;
}
return V_9 ? - V_125 : 0 ;
}
...
V_96 < V_98 ;
V_96 = F_89 ( V_17 , V_96 ) ) {
V_9 = V_43 -> V_45 . V_99 . V_102 ( V_43 , V_48 , V_112 , V_96 , V_116 ) ;
if ( V_9 )
return V_9 ;
}
return 0 ;
...
const unsigned char * V_112 )
{
return F_98 ( V_4 , V_112 , true ) ;
}
static int F_101 ( struct V_61 * V_4 ,
const unsigned char * V_112 )
{
return F_98 ( V_4 , V_112 , false ) ;
}
...
if ( ! ( V_4 -> V_108 & V_121 ) )
return;
V_126 = ( V_4 -> V_108 & V_109 ) ? V_127 :
( V_4 -> V_108 & V_128 ) ? V_129 :
( V_4 -> V_108 & ( V_130 | V_131 ) ) ?
V_132 : V_133 ;
F_83 ( V_17 ) ;
if ( V_126 != V_127 ) {
F_103 ( V_4 , F_94 , F_95 ) ;
...
if ( V_17 -> V_126 != V_126 ) {
if ( V_126 == V_127 )
V_43 -> V_45 . V_99 . V_110 ( V_43 , V_134 , 0 , true ) ;
if ( V_17 -> V_126 == V_127 )
F_91 ( V_17 ) ;
V_43 -> V_45 . V_99 . V_135 ( V_43 , V_17 -> V_48 , V_126 ) ;
V_17 -> V_126 = V_126 ;
}
F_86 ( V_17 ) ;
}
...
int V_126 ;
T_1 V_96 , V_48 ;
if ( V_43 -> V_45 . type == V_136 ) {
if ( F_93 ( V_43 -> V_45 . V_137 ) ) {
F_97 ( V_43 -> V_45 . V_112 , V_43 -> V_45 . V_137 ) ;
F_97 ( V_21 -> V_137 , V_43 -> V_45 . V_137 ) ;
F_97 ( V_21 -> V_122 , V_43 -> V_45 . V_137 ) ;
V_21 -> V_123 &= ~ V_124 ;
}
if ( V_43 -> V_45 . V_103 )
V_21 -> V_138 &= ~ V_139 ;
...
if ( V_21 -> V_108 & V_109 )
V_126 = V_127 ;
else if ( V_21 -> V_108 & V_128 )
V_126 = V_129 ;
else if ( V_21 -> V_108 & ( V_130 | V_131 ) )
V_126 = V_132 ;
else
V_126 = V_133 ;
F_83 ( V_17 ) ;
V_43 -> V_45 . V_99 . V_140 ( V_43 , V_48 , V_17 -> V_50 , true ) ;
V_43 -> V_45 . V_99 . V_110 ( V_43 , V_134 , 0 ,
V_126 == V_127 ) ;
V_43 -> V_45 . V_99 . V_110 ( V_43 , 0 , 0 , true ) ;
for ( V_96 = V_43 -> V_45 . V_105 ? F_89 ( V_17 , 0 ) : 0 ;
V_96 < V_98 ;
V_96 = F_89 ( V_17 , V_96 ) ) {
V_43 -> V_45 . V_99 . V_110 ( V_43 , V_96 , 0 , true ) ;
V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_43 -> V_45 . V_112 ,
V_96 , true , 0 ) ;
}
if ( V_126 != V_127 ) {
...
V_43 -> V_45 . V_99 . V_135 ( V_43 , V_48 , V_126 ) ;
F_86 ( V_17 ) ;
V_17 -> V_126 = V_126 ;
F_37 ( V_17 ) ;
}
...
struct V_42 * V_43 = & V_17 -> V_43 ;
F_83 ( V_17 ) ;
V_43 -> V_45 . V_99 . V_140 ( V_43 , V_17 -> V_48 ,
V_17 -> V_50 , false ) ;
F_86 ( V_17 ) ;
V_17 -> V_126 = V_133 ;
F_84 ( V_21 , NULL ) ;
...
static struct V_141 * F_107 ( struct V_61 * V_21 ,
struct V_141 * V_142 )
{
struct V_16 * V_17 = F_41 ( V_21 ) ;
struct V_1 * V_29 ;
unsigned int V_143 , V_18 ;
T_8 V_144 , V_145 ;
F_108 () ;
for ( V_18 = 0 ; V_18 < V_17 -> V_27 ; V_18 ++ ) {
...
continue;
do {
V_143 = F_110 ( & V_29 -> V_10 ) ;
V_145 = V_29 -> V_142 . V_145 ;
V_144 = V_29 -> V_142 . V_144 ;
} while ( F_111 ( & V_29 -> V_10 , V_143 ) );
V_142 -> V_146 += V_145 ;
V_142 -> V_147 += V_144 ;
}
for ( V_18 = 0 ; V_18 < V_17 -> V_19 ; V_18 ++ ) {
...
F_112 () ;
V_142 -> V_150 = V_21 -> V_142 . V_150 ;
return V_142 ;
}
int F_113 ( struct V_61 * V_4 , T_9 V_151 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
if ( V_151 && ( V_17 -> V_43 . V_45 . type != V_56 ) )
return - V_89 ;
if ( V_151 > 8 )
return - V_89 ;
if ( F_114 ( V_4 ) )
...
static int F_121 ( struct V_61 * V_21 , struct V_153 * V_154 , int V_155 )
{
switch ( V_155 ) {
case V_156 :
return F_122 ( V_21 , V_154 ) ;
case V_157 :
return F_123 ( V_21 , V_154 ) ;
default:
return - V_158 ;
}
}
...
if ( V_17 -> V_50 < 7 )
return F_127 ( - V_106 ) ;
V_5 = F_128 ( struct V_159 , V_165 [ 7 ] ) ;
V_160 = F_129 ( V_5 , V_14 ) ;
if ( ! V_160 )
return F_127 ( - V_15 ) ;
V_160 -> V_5 = 7 ;
V_160 -> V_164 = V_17 -> V_48 ;
F_124 ( V_17 , V_160 ) ;
} else if ( ( V_160 -> V_7 == V_166 ) ||
( V_160 -> V_7 == ( V_17 -> V_50 - 1 ) ) ) {
return F_127 ( - V_106 ) ;
} else if ( V_160 -> V_7 == V_160 -> V_5 ) {
V_162 = V_160 ;
V_5 = F_128 ( struct V_159 ,
V_165 [ ( V_160 -> V_5 * 2 ) + 1 ] ) ;
V_160 = F_129 ( V_5 , V_14 ) ;
if ( ! V_160 )
return F_127 ( - V_15 ) ;
...
F_128 ( struct V_159 ,
V_165 [ V_162 -> V_5 ] ) ) ;
V_160 -> V_5 = ( V_162 -> V_5 * 2 ) + 1 ;
F_124 ( V_17 , V_160 ) ;
F_130 ( V_162 , V_167 ) ;
}
for ( V_18 = 0 ; V_18 < V_160 -> V_5 ; V_18 ++ ) {
if ( ! V_160 -> V_165 [ V_18 ] )
break;
}
V_160 -> V_165 [ V_18 ] = V_161 ;
V_160 -> V_7 ++ ;
V_164 . V_168 = V_169 ;
V_164 . V_170 = 1 ;
V_164 . V_171 = F_131 ( V_17 -> V_172 [ V_173 ] . V_44 ) ;
V_164 . V_174 = F_131 ( V_17 -> V_172 [ V_175 ] . V_44 ) ;
V_164 . V_48 = V_17 -> V_48 ;
V_164 . V_176 = F_131 ( V_160 -> V_5 ) ;
V_43 -> V_45 . V_99 . V_177 ( V_43 , & V_164 ) ;
F_83 ( V_17 ) ;
V_48 = V_160 -> V_164 + 1 + V_18 ;
V_43 -> V_45 . V_99 . V_135 ( V_43 , V_48 , V_132 ) ;
V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_161 -> V_122 , 0 , true , 0 ) ;
F_86 ( V_17 ) ;
return V_161 ;
}
...
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
struct V_159 * V_160 = F_109 ( V_17 -> V_160 ) ;
struct V_163 V_164 = { 0 } ;
struct V_42 * V_43 = & V_17 -> V_43 ;
struct V_61 * V_161 = V_178 ;
int V_18 ;
T_1 V_48 ;
if ( ! V_160 )
return;
for ( V_18 = 0 ; V_18 < V_160 -> V_5 ; V_18 ++ ) {
if ( V_160 -> V_165 [ V_18 ] == V_161 )
break;
}
if ( V_18 == V_160 -> V_5 )
return;
F_83 ( V_17 ) ;
V_48 = V_160 -> V_164 + 1 + V_18 ;
V_43 -> V_45 . V_99 . V_135 ( V_43 , V_48 , V_133 ) ;
V_43 -> V_45 . V_99 . V_100 ( V_43 , V_48 , V_161 -> V_122 , 0 , false , 0 ) ;
F_86 ( V_17 ) ;
V_160 -> V_165 [ V_18 ] = NULL ;
V_160 -> V_7 -- ;
V_164 . V_168 = V_169 ;
V_164 . V_170 = 1 ;
V_164 . V_171 = F_131 ( V_17 -> V_172 [ V_173 ] . V_44 ) ;
...
struct V_61 * F_133 ( void )
{
struct V_16 * V_17 ;
struct V_61 * V_4 ;
V_4 = F_134 ( sizeof( struct V_16 ) , V_179 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_180 = & V_181 ;
F_135 ( V_4 ) ;
V_17 = F_41 ( V_4 ) ;
V_17 -> V_182 = ( 1 << V_183 ) - 1 ;
V_4 -> V_138 |= V_184 |
V_185 |
V_186 |
V_187 |
