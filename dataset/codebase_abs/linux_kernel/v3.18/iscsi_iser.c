...
struct V_17 * V_18 = V_15 -> V_19 ;
T_2 V_29 ;
V_29 = F_9 ( V_27 -> V_30 , ( void * ) V_24 ,
V_31 , V_32 ) ;
if ( F_10 ( V_27 -> V_30 , V_29 ) )
return - V_33 ;
V_24 -> V_29 = V_29 ;
V_24 -> V_34 [ 0 ] . V_35 = V_24 -> V_29 ;
V_24 -> V_34 [ 0 ] . V_36 = V_31 ;
V_24 -> V_34 [ 0 ] . V_37 = V_27 -> V_38 -> V_37 ;
V_18 -> V_25 = V_25 ;
return 0 ;
}
static int
...
static T_3
F_26 ( struct V_14 * V_15 , T_4 * V_58 )
{
struct V_17 * V_18 = V_15 -> V_19 ;
if ( V_18 -> V_59 [ V_60 ] )
...
V_28 = & V_25 -> V_28 ;
if ( V_28 -> V_106 ) {
T_8 V_107 = V_28 -> V_27 -> V_108 . V_109 ;
F_52 ( V_82 , F_49 ( V_107 ) ) ;
if ( V_110 )
F_53 ( V_82 , V_111 ) ;
else
F_53 ( V_82 , V_112 ) ;
...
break;
default:
return F_57 ( V_66 , V_121 , V_122 , V_123 ) ;
}
return 0 ;
}
static void
F_58 ( struct V_62 * V_66 , struct V_131 * V_132 )
{
struct V_1 * V_2 = V_66 -> V_19 ;
...
{
struct V_25 * V_25 = V_72 -> V_19 ;
int V_153 ;
switch ( V_121 ) {
case V_154 :
case V_155 :
if ( ! V_25 || ! V_25 -> V_28 . V_156 )
return - V_157 ;
return F_60 ( (struct V_158 * )
& V_25 -> V_28 . V_156 -> V_159 . V_35 . V_160 ,
V_121 , V_122 ) ;
break;
default:
return - V_161 ;
...
static struct V_71 *
F_61 ( struct V_81 * V_82 , struct V_162 * V_160 ,
int V_163 )
{
int V_164 ;
struct V_25 * V_25 ;
...
V_25 -> V_72 = V_72 ;
F_65 ( V_25 ) ;
V_164 = F_66 ( V_25 , NULL , V_160 , V_163 ) ;
if ( V_164 )
goto V_166;
return V_72 ;
V_166:
...
static int
F_68 ( struct V_71 * V_72 , int V_167 )
{
struct V_25 * V_25 ;
int V_7 ;
V_25 = V_72 -> V_19 ;
...
F_42 ( V_25 ) ;
if ( V_25 -> V_1 ) {
F_72 ( & V_25 -> V_171 , V_172 ) ;
F_73 ( V_173 , & V_25 -> V_171 ) ;
F_36 ( & V_25 -> V_74 ) ;
} else {
V_25 -> V_75 = V_170 ;
F_36 ( & V_25 -> V_74 ) ;
