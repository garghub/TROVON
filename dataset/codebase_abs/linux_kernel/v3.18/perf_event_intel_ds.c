...
if ( F_58 ( V_21 ) )
V_104 . V_176 = & V_91 -> V_137 ;
if ( F_59 ( V_21 , & V_104 , & V_106 ) )
F_60 ( V_21 , 0 ) ;
}
static void F_61 ( struct V_105 * V_156 )
{
struct V_47 * V_91 = F_30 ( & V_47 ) ;
struct V_45 * V_46 = V_91 -> V_46 ;
struct V_20 * V_21 = V_91 -> V_95 [ 0 ] ;
struct V_177 * V_97 , * V_98 ;
int V_178 ;
if ( ! V_55 . V_81 )
return;
V_97 = (struct V_177 * ) ( unsigned long ) V_46 -> V_65 ;
V_98 = (struct V_177 * ) ( unsigned long ) V_46 -> V_66 ;
V_46 -> V_66 = V_46 -> V_65 ;
if ( ! F_62 ( 0 , V_91 -> V_179 ) )
return;
F_63 ( ! V_21 ) ;
if ( ! V_21 -> V_116 . V_117 )
return;
...
if ( V_178 <= 0 )
return;
F_16 ( V_178 > 1 , L_2 , V_178 ) ;
V_97 += V_178 - 1 ;
F_55 ( V_21 , V_156 , V_97 ) ;
}
static void F_64 ( struct V_105 * V_156 )
{
struct V_47 * V_91 = F_30 ( & V_47 ) ;
struct V_45 * V_46 = V_91 -> V_46 ;
...
if ( ! V_55 . V_81 )
return;
V_97 = (struct V_181 * ) ( unsigned long ) V_46 -> V_65 ;
V_98 = (struct V_181 * ) ( unsigned long ) V_46 -> V_66 ;
V_46 -> V_66 = V_46 -> V_65 ;
if ( F_12 ( V_97 > V_98 ) )
return;
F_16 ( V_98 - V_97 > V_55 . V_182 * V_55 . V_64 ,
L_3 ,
( long ) ( V_98 - V_97 ) / V_55 . V_64 ) ;
for (; V_97 < V_98 ; V_97 += V_55 . V_64 ) {
struct V_181 * V_183 = V_97 ;
F_65 (bit, (unsigned long *)&p->status,
x86_pmu.max_pebs_events) {
V_21 = V_91 -> V_95 [ V_180 ] ;
if ( ! F_62 ( V_180 , V_91 -> V_179 ) )
continue;
F_63 ( ! V_21 ) ;
if ( ! V_21 -> V_116 . V_117 )
continue;
if ( F_66 ( V_180 , ( unsigned long * ) & V_1 ) )
continue;
break;
}
if ( ! V_21 || V_180 >= V_55 . V_182 )
continue;
F_55 ( V_21 , V_156 , V_97 ) ;
}
}
...
if ( ! F_68 ( V_184 ) )
return;
V_55 . V_69 = F_68 ( V_185 ) ;
V_55 . V_56 = F_68 ( V_186 ) ;
if ( V_55 . V_56 ) {
char V_187 = V_55 . V_60 . V_136 ? '+' : '-' ;
int V_188 = V_55 . V_60 . V_61 ;
switch ( V_188 ) {
case 0 :
F_69 ( V_189 L_4 , V_187 ) ;
V_55 . V_64 = sizeof( struct V_177 ) ;
V_55 . V_190 = F_61 ;
break;
case 1 :
F_69 ( V_189 L_5 , V_187 ) ;
V_55 . V_64 = sizeof( struct V_181 ) ;
V_55 . V_190 = F_64 ;
break;
case 2 :
F_70 ( L_6 , V_187 ) ;
...
void F_71 ( void )
{
struct V_45 * V_46 = F_72 ( V_47 . V_46 ) ;
if ( ! V_55 . V_69 && ! V_55 . V_56 )
return;
