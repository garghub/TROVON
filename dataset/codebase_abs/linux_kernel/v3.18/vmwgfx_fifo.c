...
void F_21 ( struct V_1 * V_2 , T_3 V_59 )
{
F_2 ( & V_2 -> V_14 ) ;
F_20 ( V_2 , V_59 ) ;
F_5 ( & V_2 -> V_14 ) ;
}
void F_22 ( struct V_1 * V_2 , struct V_7 * V_8 )
{
T_1 T_2 * V_3 = V_2 -> V_4 ;
F_2 ( & V_2 -> V_14 ) ;
F_3 ( V_2 , V_60 , V_61 ) ;
...
F_5 ( & V_2 -> V_14 ) ;
F_23 ( & V_8 -> V_58 ) ;
if ( F_24 ( V_8 -> V_32 != NULL ) ) {
F_25 ( V_8 -> V_32 ) ;
V_8 -> V_32 = NULL ;
}
if ( F_24 ( V_8 -> V_34 != NULL ) ) {
F_25 ( V_8 -> V_34 ) ;
V_8 -> V_34 = NULL ;
}
}
static bool F_26 ( struct V_1 * V_2 , T_3 V_63 )
{
T_1 T_2 * V_3 = V_2 -> V_4 ;
...
long V_68 = 1L ;
unsigned long V_78 ;
if ( F_24 ( ! F_26 ( V_2 , V_63 ) ) )
return 0 ;
F_21 ( V_2 , V_79 ) ;
if ( ! ( V_2 -> V_9 & V_80 ) )
return F_27 ( V_2 , V_63 ,
V_66 , V_67 ) ;
F_2 ( & V_2 -> V_14 ) ;
if ( F_37 ( 1 , & V_2 -> V_81 ) > 0 ) {
F_38 ( & V_2 -> V_82 , V_78 ) ;
F_39 ( V_83 ,
V_2 -> V_84 + V_85 ) ;
V_2 -> V_86 |= V_83 ;
...
void * F_44 ( struct V_1 * V_2 , T_3 V_63 )
{
...
bool V_93 = false ;
if ( V_64 >= V_65 ) {
if ( F_24 ( ( V_64 + V_63 < V_27 ||
( V_64 + V_63 == V_27 && V_65 > V_28 ) ) ) )
V_93 = true ;
else if ( F_26 ( V_2 , V_63 ) ) {
V_68 = F_36 ( V_2 , V_63 ,
false , 3 * V_94 ) ;
if ( F_10 ( V_68 != 0 ) )
goto V_91;
...
static void F_46 ( struct V_7 * V_88 ,
T_1 T_2 * V_3 ,
T_3 V_64 ,
...
F_14 ( V_63 , V_3 + V_95 ) ;
F_16 () ;
F_47 ( V_3 + ( V_64 >> 2 ) , V_98 , V_96 ) ;
V_97 = V_63 - V_96 ;
if ( V_97 )
F_47 ( V_3 + ( V_28 >> 2 ) , V_98 + ( V_96 >> 2 ) ,
V_97 ) ;
}
static void F_48 ( struct V_7 * V_88 ,
T_1 T_2 * V_3 ,
T_3 V_64 ,
T_3 V_27 , T_3 V_28 , T_3 V_63 )
{
...
void F_49 ( struct V_1 * V_2 , T_3 V_63 )
{
struct V_7 * V_88 = & V_2 -> V_8 ;
T_1 T_2 * V_3 = V_2 -> V_4 ;
T_3 V_64 = F_6 ( V_3 + V_52 ) ;
...
* V_99 = F_52 ( & V_2 -> V_55 ) ;
V_68 = - V_33 ;
( void ) F_53 ( V_2 , false , true , * V_99 ,
false , 3 * V_94 ) ;
goto V_91;
}
do {
* V_99 = F_37 ( 1 , & V_2 -> V_55 ) ;
} while ( * V_99 == 0 );
if ( ! ( V_88 -> V_9 & V_103 ) ) {
F_49 ( V_2 , 0 ) ;
return 0 ;
}
* ( T_1 * ) V_102 = F_54 ( V_104 ) ;
V_101 = (struct V_100 * )
( ( unsigned long ) V_102 + sizeof( T_1 ) ) ;
F_14 ( * V_99 , & V_101 -> V_105 ) ;
F_49 ( V_2 , V_63 ) ;
( void ) F_55 ( & V_88 -> V_58 , * V_99 ) ;
F_56 ( V_2 , V_88 ) ;
V_91:
return V_68 ;
}
