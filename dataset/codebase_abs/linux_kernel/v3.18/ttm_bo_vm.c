...
if ( V_4 -> V_50 & V_64 )
V_7 = F_17 ( & V_37 , V_30 , V_25 ) ;
else
V_7 = F_18 ( & V_37 , V_30 , V_25 ) ;
...
struct V_1 * V_2 =
(struct V_1 * ) V_4 -> V_20 ;
F_22 ( V_2 -> V_22 -> V_67 != V_4 -> V_61 -> V_62 ) ;
( void ) F_23 ( V_2 ) ;
}
...
static struct V_1 * F_26 ( struct V_21 * V_22 ,
unsigned long V_58 ,
unsigned long V_59 )
{
struct V_68 * V_69 ;
struct V_1 * V_2 = NULL ;
F_27 ( & V_22 -> V_70 ) ;
V_69 = F_28 ( & V_22 -> V_70 , V_58 , V_59 ) ;
if ( F_2 ( V_69 ) ) {
V_2 = F_29 ( V_69 , struct V_1 , V_47 ) ;
if ( ! F_30 ( & V_2 -> V_71 ) )
V_2 = NULL ;
}
F_31 ( & V_22 -> V_70 ) ;
...
int F_33 ( struct V_72 * V_73 , struct V_3 * V_4 ,
struct V_21 * V_22 )
{
struct V_74 * V_41 ;
struct V_1 * V_2 ;
int V_7 ;
V_2 = F_26 ( V_22 , V_4 -> V_46 , F_13 ( V_4 ) ) ;
if ( F_6 ( ! V_2 ) )
return - V_75 ;
V_41 = V_2 -> V_22 -> V_41 ;
if ( F_6 ( ! V_41 -> V_76 ) ) {
...
V_7 = V_41 -> V_76 ( V_2 , V_73 ) ;
if ( F_6 ( V_7 != 0 ) )
goto V_78;
V_4 -> V_79 = & V_80 ;
V_4 -> V_20 = V_2 ;
V_4 -> V_50 |= V_64 ;
V_4 -> V_50 |= V_81 | V_82 | V_83 ;
return 0 ;
V_78:
F_25 ( & V_2 ) ;
return V_7 ;
