...
V_70 -> V_62 |= V_58 ;
if ( V_104 -> V_120 & ( V_122 | V_123 | V_124 ) )
V_70 -> V_62 |= V_55 ;
V_70 -> V_125 = 0 ;
if ( V_104 -> V_120 & V_126 )
V_70 -> V_125 |= V_58 ;
if ( V_104 -> V_120 & V_122 ) {
V_70 -> V_125 |= V_55 ;
if ( V_104 -> V_120 & V_126 )
V_70 -> V_125 |= V_66 ;
}
...
static void F_74 ( struct V_69 * V_10 , int V_166 )
{
...
static void
F_75 ( struct V_168 * V_169 , const char * V_170 , unsigned int V_86 )
{
struct V_1 * V_2 ;
struct V_69 * V_10 ;
...
static void T_4
F_79 ( struct V_69 * V_10 , int * V_108 ,
int * V_59 , int * V_177 )
{
...
static int T_4
F_80 ( struct V_168 * V_169 , char * V_185 )
{
struct V_1 * V_2 ;
int V_108 = 9600 ;
int V_177 = 8 ;
...
int V_186 = 'n' ;
int V_152 ;
if ( V_169 -> V_173 == - 1 || V_169 -> V_173 >= F_81 ( V_175 ) )
V_169 -> V_173 = 0 ;
V_2 = V_175 [ V_169 -> V_173 ] ;
if ( ! V_2 )
return - V_187 ;
...
return V_152 ;
if ( V_185 )
F_82 ( V_185 , & V_108 , & V_59 , & V_177 , & V_186 ) ;
else
F_79 ( & V_2 -> V_10 , & V_108 , & V_59 , & V_177 ) ;
V_152 = F_83 ( & V_2 -> V_10 , V_169 , V_108 , V_59 , V_177 , V_186 ) ;
F_69 ( V_2 -> V_153 ) ;
return V_152 ;
}
...
if ( ! V_191 )
return 1 ;
V_152 = F_85 ( V_191 , L_7 ) ;
if ( V_152 < 0 ) {
F_13 ( & V_189 -> V_12 , L_8 , V_152 ) ;
return V_152 ;
}
V_2 -> V_10 . line = V_152 ;
if ( F_86 ( V_191 , L_9 , NULL ) )
F_87 ( V_132 , & V_2 -> V_5 ) ;
return 0 ;
}
...
V_2 -> V_153 = F_90 ( & V_189 -> V_12 , NULL ) ;
if ( F_91 ( V_2 -> V_153 ) ) {
V_152 = F_92 ( V_2 -> V_153 ) ;
goto V_201;
}
V_198 = F_93 ( V_189 , V_205 , 0 ) ;
if ( ! V_198 ) {
V_152 = - V_206 ;
goto V_207;
}
V_2 -> V_10 . V_208 = V_198 -> V_209 ;
V_2 -> V_10 . V_40 = F_94 ( V_198 -> V_209 , F_95 ( V_198 ) ) ;
V_2 -> V_10 . V_210 = & V_211 ;
V_2 -> V_10 . V_212 = V_213 ;
V_2 -> V_10 . V_102 = V_157 ;
V_2 -> V_10 . V_134 = F_96 ( V_2 -> V_153 ) ;
V_2 -> V_10 . type = V_74 ;
V_2 -> V_10 . V_12 = V_2 -> V_12 = & V_189 -> V_12 ;
V_2 -> V_76 = 0 ;
V_2 -> V_138 = F_97 ( V_189 , 0 ) ;
V_2 -> V_10 . V_138 = V_2 -> V_138 ;
V_152 = F_98 ( V_2 -> V_138 , F_62 , 0 , F_37 ( & V_189 -> V_12 ) , V_2 ) ;
if ( V_152 )
goto V_207;
F_99 ( V_189 , V_2 ) ;
V_175 [ V_2 -> V_10 . line ] = V_2 ;
F_64 ( & V_2 -> V_10 ) ;
V_152 = F_100 ( & V_214 , & V_2 -> V_10 ) ;
if ( V_152 )
goto V_215;
V_196 = F_24 ( V_2 -> V_10 . V_40 + V_216 ) ;
F_101 ( & V_189 -> V_12 , L_10 ,
( V_196 >> 24 ) & 0xff ,
...
static int F_104 ( struct V_188 * V_189 )
{
struct V_1 * V_2 = F_105 ( V_189 ) ;
F_106 ( & V_214 , & V_2 -> V_10 ) ;
V_175 [ V_189 -> V_200 ] = NULL ;
F_103 ( V_2 -> V_153 ) ;
F_102 ( V_2 -> V_138 , V_2 ) ;
F_49 ( V_2 ) ;
