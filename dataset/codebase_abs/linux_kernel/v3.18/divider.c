...
static int F_17 ( struct V_11 * V_12 , unsigned long V_20 ,
unsigned long * V_21 )
{
struct V_5 * V_6 = F_10 ( V_12 ) ;
int V_22 , V_23 = 0 ;
...
{
int div ;
div = F_17 ( V_12 , V_20 , V_29 ) ;
return F_13 ( * V_29 , div ) ;
}
...
V_10 |= V_30 << V_6 -> V_17 ;
V_14 -> V_34 ( V_10 , V_6 -> V_16 ) ;
if ( V_6 -> V_32 )
F_26 ( V_6 -> V_32 , V_7 ) ;
return 0 ;
}
static struct V_19 * F_27 ( struct V_35 * V_36 , const char * V_37 ,
const char * V_38 ,
...
T_2 * V_7 , T_1 * V_58 , T_1 * V_39 , T_1 * V_17 )
{
T_2 V_10 ;
* V_16 = F_42 ( V_52 , 0 ) ;
if ( ! * V_16 )
...
& V_40 , & V_39 , & V_17 ) )
goto V_59;
V_19 = F_27 ( NULL , V_52 -> V_37 , V_38 , V_7 , V_16 ,
V_17 , V_39 , V_40 , V_2 , NULL ) ;
if ( ! F_33 ( V_19 ) ) {
F_47 ( V_52 , V_60 , V_19 ) ;
F_48 ( V_52 ) ;
return;
