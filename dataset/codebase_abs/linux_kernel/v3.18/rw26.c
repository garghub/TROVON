...
static T_3 F_52 ( int V_23 , struct V_68 * V_69 ,
struct V_70 * V_71 , T_4 V_45 )
{
struct V_6 * V_7 ;
struct V_36 * V_37 ;
...
struct V_1 * * V_26 ;
T_2 V_92 ;
V_76 = F_59 ( T_2 , F_54 ( V_71 ) , V_25 ) ;
if ( V_23 == V_32 ) {
if ( V_45 >= F_60 ( V_5 ) )
break;
if ( V_45 + V_76 > F_60 ( V_5 ) )
V_76 = F_60 ( V_5 ) - V_45 ;
}
V_22 = F_61 ( V_71 , & V_26 , V_76 , & V_92 ) ;
if ( F_44 ( V_22 > 0 ) ) {
int V_93 = ( V_22 + V_92 + V_94 - 1 ) / V_94 ;
V_22 = F_51 ( V_7 , V_37 , V_23 , V_5 ,
V_72 -> V_74 ,
V_22 , V_45 ,
V_26 , V_93 ) ;
F_27 ( V_26 , V_93 , V_23 == V_32 ) ;
}
if ( F_25 ( V_22 <= 0 ) ) {
if ( V_22 == - V_28 &&
...
static int F_70 ( struct V_72 * V_72 , struct V_21 * V_13 ,
...
V_1 = F_71 ( V_13 , V_103 , V_100 ) ;
if ( ! V_1 )
return - V_28 ;
* V_101 = V_1 ;
V_44 = F_72 ( V_72 , V_1 , V_104 , V_104 + V_99 ) ;
if ( V_44 ) {
F_73 ( V_1 ) ;
F_29 ( V_1 ) ;
}
...
static int F_74 ( struct V_72 * V_72 , struct V_21 * V_13 ,
T_4 V_98 , unsigned V_99 , unsigned V_105 ,
struct V_1 * V_1 , void * V_102 )
{
unsigned V_104 = V_98 & ( V_12 - 1 ) ;
int V_44 ;
V_44 = F_75 ( V_72 , V_1 , V_104 , V_104 + V_105 ) ;
F_73 ( V_1 ) ;
F_29 ( V_1 ) ;
return V_44 ? : V_105 ;
}
static int F_76 ( struct V_21 * V_13 ,
