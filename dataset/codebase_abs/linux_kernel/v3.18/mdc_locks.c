...
struct V_41 * V_66 = F_18 ( exp ) ;
struct V_49 * V_50 ;
T_7 V_31 , V_192 = V_184 ;
struct V_36 V_37 ;
int V_193 , V_194 = 0 ;
struct V_146 * V_147 ;
enum V_195 V_195 = V_196 ;
int V_38 ;
F_11 ( ! V_2 || V_141 -> V_197 == V_198 , L_9 ,
V_141 -> V_197 ) ;
F_15 ( & V_62 -> V_86 , & V_37 ) ;
if ( V_2 ) {
V_192 |= V_199 ;
if ( V_2 -> V_84 & ( V_166 | V_168 | V_200 ) )
V_34 = & V_187 ;
else if ( V_2 -> V_84 & V_178 )
V_34 = & V_188 ;
else if ( V_2 -> V_84 & ( V_111 | V_201 ) )
V_34 = & V_190 ;
}
F_9 ( V_183 == NULL ) ;
V_193 = V_66 -> V_99 . V_100 . V_202 -> V_203 ;
V_204:
V_31 = V_192 ;
if ( ! V_2 ) {
F_9 ( V_63 && V_64 == 0 ) ;
F_11 ( V_141 -> V_197 == V_205 , L_9 ,
V_141 -> V_197 ) ;
V_34 = ( T_4 * ) V_63 ;
V_37 . V_206 [ 3 ] = V_205 ;
...
V_50 -> V_211 = 1 ;
V_50 -> V_212 = V_193 ;
V_50 -> V_213 = F_80 () + V_194 ;
}
if ( V_2 ) {
F_81 ( V_66 -> V_99 . V_100 . V_214 , V_2 ) ;
V_38 = F_82 ( & V_66 -> V_99 . V_100 ) ;
if ( V_38 != 0 ) {
F_83 ( V_66 -> V_99 . V_100 . V_214 , V_2 ) ;
F_28 ( V_50 , 0 ) ;
F_84 ( V_50 ) ;
return V_38 ;
}
...
F_83 ( V_66 -> V_99 . V_100 . V_214 , V_2 ) ;
if ( V_38 < 0 ) {
F_87 ( ( V_38 == - V_217 || V_38 == - V_218 ) ? V_219 : V_54 ,
L_10 ,
V_66 -> V_220 , V_38 ) ;
F_28 ( V_50 , V_38 ) ;
F_84 ( V_50 ) ;
...
( int ) V_147 -> V_159 == - V_221 ) {
F_28 ( V_50 , V_38 ) ;
F_84 ( V_50 ) ;
V_194 ++ ;
F_89 ( V_222 , L_11 V_223 L_12 V_223 L_13 ,
V_66 -> V_220 , V_194 , V_2 -> V_84 ,
F_90 ( & V_62 -> V_86 ) , F_90 ( & V_62 -> V_74 ) ) ;
if ( V_193 == V_66 -> V_99 . V_100 . V_202 -> V_203 ) {
goto V_204;
} else {
F_89 ( V_222 , L_14 ) ;
return - V_224 ;
...
if ( V_38 )
return V_38 ;
V_55 = F_64 ( & V_225 -> V_94 , & V_169 ) ;
F_9 ( V_55 != NULL ) ;
if ( F_36 ( & V_62 -> V_74 ) &&
V_2 -> V_71 & V_229 &&
V_2 -> V_84 != V_168 ) {
if ( ( ! F_93 ( & V_62 -> V_74 , & V_55 -> V_230 ) ) &&
( ! F_93 ( & V_62 -> V_231 , & V_55 -> V_230 ) ) ) {
F_89 ( V_232 , L_15 V_223 L_16 V_223 L_17 V_223
L_13 , F_90 ( & V_62 -> V_74 ) ,
F_90 ( & V_62 -> V_74 ) , F_90 ( & V_55 -> V_230 ) ) ;
return - V_233 ;
}
}
V_38 = F_4 ( V_11 , V_2 ) ;
...
T_4 V_34 = V_18 -> V_29 ;
F_72 ( V_18 , L_18 ) ;
F_11 ( F_96 ( & V_55 -> V_230 ,
& V_18 -> V_22 -> V_238 ) ,
L_19 V_239 L_20 V_223 L_13 ,
F_97 ( V_18 -> V_22 ) , F_90 ( & V_55 -> V_230 ) ) ;
F_13 ( V_18 ) ;
memcpy ( & V_226 , V_14 , sizeof( * V_14 ) ) ;
if ( F_17 ( NULL , V_240 , NULL ,
V_198 , & V_34 , V_241 ,
& V_226 , 0 ) ) {
F_98 ( V_14 ,
V_2 -> V_4 . V_5 . V_160 ) ;
memcpy ( V_14 , & V_226 , sizeof( V_226 ) ) ;
V_2 -> V_4 . V_5 . V_161 = V_14 -> V_162 ;
}
}
F_89 ( V_232 ,
L_21 ,
V_62 -> V_97 , V_62 -> V_242 , F_73 ( V_2 -> V_84 ) ,
...
V_35 = F_14 ( exp , V_240 , V_33 ,
V_198 , & V_34 ,
V_82 | V_81 | V_79 | V_244 ,
& V_14 ) ;
}
if ( V_35 ) {
V_2 -> V_4 . V_5 . V_161 = V_14 . V_162 ;
...
int V_38 = 0 ;
F_9 ( V_2 ) ;
F_89 ( V_250 , L_22 V_223 L_23 V_223
L_24 , V_62 -> V_97 ,
V_62 -> V_242 , F_90 ( & V_62 -> V_74 ) ,
...
static int F_104 ( const struct V_251 * V_252 ,
struct V_49 * V_50 ,
void * args , int V_38 )
{
struct V_253 * V_254 = args ;
struct V_13 * exp = V_254 -> V_255 ;
struct V_256 * V_257 = V_254 -> V_258 ;
struct V_140 * V_141 = V_254 -> V_259 ;
struct V_1 * V_2 ;
struct V_21 * V_14 ;
struct V_41 * V_66 ;
struct V_146 * V_147 ;
...
if ( F_105 ( V_262 ) )
V_38 = - V_216 ;
V_38 = F_106 ( exp , V_50 , V_141 -> V_197 , 1 , V_141 -> V_155 ,
...
if ( V_38 )
goto V_263;
V_38 = F_92 ( exp , V_50 , & V_257 -> V_264 , V_2 , V_14 ) ;
V_263:
F_107 ( V_141 ) ;
V_257 -> V_265 ( V_50 , V_257 , V_38 ) ;
return 0 ;
}
...
struct V_140 * V_141 )
{
struct V_61 * V_62 = & V_257 -> V_264 ;
struct V_1 * V_2 = & V_257 -> V_260 ;
struct V_49 * V_50 ;
struct V_253 * V_254 ;
struct V_41 * V_66 = F_18 ( exp ) ;
struct V_36 V_37 ;
...
F_89 ( V_250 ,
L_27 V_223 L_24 ,
V_62 -> V_97 , V_62 -> V_242 , F_90 ( & V_62 -> V_86 ) ,
...
V_38 = F_85 ( exp , & V_50 , V_141 , & V_37 , & V_34 , & V_31 , NULL ,
0 , V_196 , & V_257 -> V_261 , 1 ) ;
if ( V_38 < 0 ) {
F_86 ( & V_66 -> V_99 . V_100 ) ;
F_84 ( V_50 ) ;
return V_38 ;
}
F_109 ( sizeof( * V_254 ) <= sizeof( V_50 -> V_266 ) ) ;
V_254 = F_110 ( V_50 ) ;
V_254 -> V_255 = exp ;
V_254 -> V_258 = V_257 ;
V_254 -> V_259 = V_141 ;
