...
struct V_286 * V_73 ;
struct V_36 * V_39 ;
V_73 = F_218 ( V_213 , & V_301 , sizeof( * V_73 ) ) ;
if ( ! V_73 ) {
F_113 ( - V_283 ) ;
return - V_283 ;
}
...
static int F_219 ( struct V_36 * V_39 )
{
int V_60 = 0 ;
struct V_49 * V_50 = V_39 -> V_84 ;
V_50 -> V_284 = F_220 ( L_69 ,
V_303 | V_304 ,
V_39 -> V_305 ,
V_39 ,
& V_306 ) ;
...
static void F_221 ( struct V_36 * V_39 )
{
struct V_49 * V_50 = V_39 -> V_84 ;
if ( V_50 ) {
F_222 ( V_50 -> V_284 ) ;
...
V_39 -> V_310 = F_224 ( V_311 , V_39 , L_71 ) ;
if ( F_225 ( V_39 -> V_310 ) ) {
V_161 = F_226 ( V_39 -> V_310 ) ;
V_39 -> V_310 = NULL ;
F_113 ( V_161 ) ;
goto V_175;
}
V_161 = F_227 ( V_39 -> V_312 ,
V_39 -> V_313 ,
strlen ( V_39 -> V_313 ) ,
V_39 -> V_314 ,
strlen ( V_39 -> V_314 ) ,
...
F_229 ( V_39 -> V_176 , V_316 ) ;
V_39 -> V_176 = NULL ;
F_221 ( V_39 ) ;
}
static int F_233 ( struct V_36 * V_39 ,
struct V_3 * V_4 )
{
int V_60 ;
unsigned long V_152 ;
...
F_81 ( & V_4 -> V_89 , V_152 ) ;
F_3 ( 0 , L_78 , V_4 -> V_8 ) ;
V_60 = F_234 ( V_39 -> V_176 , & V_4 -> V_7 , V_183 ) ;
if ( V_60 ) {
F_95 ( L_79 , V_60 , V_4 ) ;
...
{
F_239 ( V_39 , & V_39 -> V_273 ) ;
F_239 ( V_39 , & V_39 -> V_274 ) ;
F_239 ( V_39 , & V_39 -> V_275 ) ;
F_239 ( V_39 , & V_39 -> V_268 . V_269 ) ;
}
int F_240 ( struct V_27 * V_27 )
{
int V_161 , V_323 ;
V_323 = F_233 ( F_46 ( V_27 -> V_97 ) ,
& F_45 ( V_27 ) -> V_209 ) ;
if ( V_323 < 0 )
F_113 ( V_323 ) ;
V_161 = V_323 ;
...
static int F_241 ( struct V_36 * V_39 ,
struct V_3 * V_4 ,
struct V_325 * V_326 )
{
unsigned long V_152 ;
...
static int F_250 ( struct V_342 * V_343 ,
struct V_3 * V_4 ,
int V_138 )
{
int V_344 = F_251 ( V_343 ) ;
F_11 ( V_138 != V_139 && V_138 != V_137 ) ;
F_11 ( V_4 -> V_74 != V_136 && ! V_344 ) ;
if ( V_344 )
return 1 ;
F_252 ( F_46 ( F_253 ( V_343 ) ) ) ;
return 0 ;
}
...
{
struct V_27 * V_27 = F_10 ( V_4 ) ;
return F_250 ( F_159 ( V_27 ) , V_4 , V_138 ) ;
}
static void F_255 ( struct V_3 * V_4 )
{
struct V_27 * V_27 = F_10 ( V_4 ) ;
F_137 ( V_27 ) ;
}
static void F_256 ( struct V_36 * V_39 ,
struct V_3 * V_4 )
{
...
struct V_33 * V_352 =
F_14 ( V_4 ) ;
return F_250 ( & V_352 -> V_353 , V_4 , V_138 ) ;
}
...
struct V_356 * V_98 = F_265 ( V_355 -> V_99 . V_100 ,
V_355 -> V_99 . V_129 ) ;
V_6 = F_2 ( & V_4 -> V_7 ) ;
V_6 -> V_9 = V_357 ;
...
void F_266 ( struct V_31 * V_355 , int V_204 )
{
...
static int F_267 ( struct V_31 * V_355 )
{
struct V_356 * V_98 = F_265 ( V_355 -> V_99 . V_100 ,
V_355 -> V_99 . V_129 ) ;
struct V_3 * V_4 = & V_355 -> V_370 ;
...
int F_269 ( struct V_31 * V_355 , int V_204 )
{
struct V_3 * V_4 = & V_355 -> V_370 ;
struct V_36 * V_39 = F_46 ( V_355 -> V_99 . V_100 ) ;
int V_1 = V_204 ? V_136 : V_137 ;
...
int F_270 ( struct V_33 * V_376 , int V_204 )
{
int V_161 ;
int V_1 = V_204 ? V_136 : V_137 ;
...
void F_271 ( struct V_33 * V_376 , int V_204 )
{
int V_1 = V_204 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_376 -> V_35 ;
struct V_36 * V_39 = V_4 -> V_28 ;
...
static void F_238 ( struct V_36 * V_39 ,
struct V_3 * V_4 )
{
int V_161 ;
