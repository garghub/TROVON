...
V_48 -> V_223 = F_58 ( V_256 -> V_166 ) ;
V_48 -> V_258 = V_259 ;
V_257 = F_54 ( & V_48 -> V_254 ,
F_52 ( V_260 ) ) ;
...
break;
case V_34 :
V_155 = F_57 ( V_265 -> V_273 ) -
F_23 ( struct V_3 , V_274 ) ;
if ( F_32 ( & V_15 -> V_274 [ 0 ] , V_155 ,
V_275 ,
NULL , 0 ) < 0 )
V_263 -> V_268 = true ;
V_263 -> V_267 = 0 ;
...
T_6 V_281 ;
V_265 = & V_256 -> V_265 ;
V_277 = F_57 ( V_265 -> V_273 ) ;
F_4 ( true , V_265 -> V_184 , V_277 ) ;
V_256 -> V_269 = F_25 ( V_282 ) ;
...
if ( V_263 . V_268 &&
F_76 ( F_58 ( V_256 -> V_166 ) ) &&
V_48 -> V_51 [ V_76 ] . V_53 -> V_285 . V_286 ) {
V_160 = & V_48 -> V_160 ;
V_160 -> V_198 = F_58 ( V_256 -> V_166 ) ;
if ( F_50 ( V_48 ) ==
V_204 ) {
F_10 ( L_80 ) ;
goto exit;
...
F_61 ( V_107 , V_41 , true , true ) ;
V_256 -> V_166 = F_25 ( V_160 -> V_203 ) ;
}
V_279 = 0 ;
while ( ! V_48 -> V_226 &&
( V_278 == false ) && ( V_279 < V_287 ) ) {
V_278 = ! F_71 ( V_48 , V_256 ) ;
V_279 ++ ;
}
if ( V_278 == false ) {
F_10 ( L_81 , V_279 ) ;
...
V_281 = F_77 ( V_259 - V_48 -> V_258 ) ;
if ( F_58 ( V_256 -> V_269 ) > V_281 )
V_280 = F_58 ( V_256 -> V_269 ) -
V_281 ;
else
V_280 = 0 ;
if ( V_280 > 50 ) {
...
F_82 ( V_291 -> V_276 , F_83 ( V_107 -> V_159 ) ) ;
...
struct V_134 * V_312 = F_96 ( V_107 ) ;
struct V_40 * V_41 = F_74 ( V_312 ) ;
...
struct V_177 * F_103 ( struct V_159 * V_159 , const char * V_317 ,
enum V_318 type , T_1 * V_150 ,
struct V_319 * V_320 )
{
struct V_132 * V_107 = F_34 ( V_159 ) ;
