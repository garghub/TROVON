...
bool F_45 ( struct V_19 * V_22 , unsigned long V_12 ,
T_1 V_15 )
{
bool V_50 = false ;
unsigned long V_51 = V_12 + V_15 ;
struct V_1 * V_2 ;
F_24 () ;
F_25 (chunk, &(pool)->chunks, next_chunk) {
...
void F_48 ( struct V_19 * V_22 , T_4 V_26 , void * V_28 )
{
F_24 () ;
V_22 -> V_26 = V_26 ;
if ( ! V_22 -> V_26 )
...
{
return F_49 ( V_11 , V_15 , V_12 , V_13 , 0 ) ;
}
unsigned long F_50 ( unsigned long * V_11 ,
unsigned long V_15 , unsigned long V_12 ,
unsigned int V_13 , void * V_28 )
{
unsigned long V_52 = F_51 ( V_13 ) - 1 ;
return F_49 ( V_11 , V_15 , V_12 , V_13 , V_52 ) ;
}
unsigned long F_52 ( unsigned long * V_11 , unsigned long V_15 ,
unsigned long V_12 , unsigned int V_13 , void * V_28 )
{
unsigned long V_45 = V_15 ;
unsigned long V_53 = V_15 + 1 ;
unsigned long V_54 ;
V_54 = F_49 ( V_11 , V_15 , V_12 , V_13 , 0 ) ;
while ( V_54 < V_15 ) {
int V_55 = F_31 ( V_11 , V_15 , V_54 + V_13 ) ;
if ( ( V_55 - V_54 ) < V_53 ) {
V_53 = V_55 - V_54 ;
V_45 = V_54 ;
if ( V_53 == V_13 )
...
static void F_53 ( struct V_56 * V_57 , void * V_58 )
{
F_27 ( * (struct V_19 * * ) V_58 ) ;
}
struct V_19 * F_54 ( struct V_56 * V_57 , int V_20 ,
int V_21 )
{
struct V_19 * * V_59 , * V_22 ;
V_59 = F_55 ( F_53 , sizeof( * V_59 ) , V_23 ) ;
V_22 = F_11 ( V_20 , V_21 ) ;
if ( V_22 ) {
* V_59 = V_22 ;
F_56 ( V_57 , V_59 ) ;
...
struct V_19 * F_58 ( struct V_56 * V_57 )
{
struct V_19 * * V_14 = F_59 ( V_57 , F_53 , NULL ,
NULL ) ;
if ( ! V_14 )
return NULL ;
return * V_14 ;
}
struct V_19 * F_60 ( struct V_60 * V_61 ,
const char * V_62 , int V_54 )
{
struct V_63 * V_64 ;
struct V_60 * V_65 ;
V_65 = F_61 ( V_61 , V_62 , V_54 ) ;
if ( ! V_65 )
return NULL ;
V_64 = F_62 ( V_65 ) ;
F_63 ( V_65 ) ;
