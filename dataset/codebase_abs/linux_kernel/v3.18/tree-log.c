...
F_204 ( & V_235 ) ;
V_8 = F_239 ( V_2 , log , V_78 , V_41 , V_274 -> V_36 ,
...
F_242 ( V_88 , V_297 , 0 , & V_235 ) ;
F_243 ( V_88 , V_297 , 0 ,
& V_235 ) ;
}
F_244 ( V_88 , V_297 , V_298 , & V_235 ) ;
F_245 ( V_88 , V_297 , V_274 -> V_37 , & V_235 ) ;
F_246 ( V_88 , V_297 , V_274 -> V_305 , & V_235 ) ;
F_247 ( V_88 , V_297 , V_274 -> V_294 ,
& V_235 ) ;
F_248 ( V_88 , V_297 , 0 , & V_235 ) ;
...
F_252 (em, n, &tree->modified_extents, list) {
F_161 ( & V_274 -> V_22 ) ;
if ( ++ V_312 > 32768 ) {
F_161 ( & V_309 -> V_315 ) ;
V_8 = - V_316 ;
...
F_256 ( & V_309 -> V_313 ) ;
V_8 = F_238 ( V_2 , V_78 , V_4 , V_274 , V_41 , V_275 ,
V_6 ) ;
F_251 ( & V_309 -> V_313 ) ;
F_254 ( V_309 , V_274 ) ;
F_255 ( V_274 ) ;
...
struct V_271 * V_274 , * V_306 ;
F_251 ( & V_323 -> V_313 ) ;
F_252 (em, n, &em_tree->modified_extents,
list) {
...
if ( V_8 )
goto V_343;
V_8 = F_257 ( V_2 , V_4 , V_78 , V_248 , V_36 , V_213 , V_6 ) ;
if ( V_8 )
goto V_346;
if ( F_132 ( V_78 -> V_143 ) &&
F_113 ( V_78 ) -> V_236 <= V_335 &&
...
struct V_5 * V_6 )
{
struct V_332 * V_183 = F_267 ( V_332 ) ;
int V_8 ;
V_8 = F_269 ( V_2 , V_4 , V_332 -> V_339 , V_183 ,
V_36 , V_213 , 0 , V_6 ) ;
F_268 ( V_183 ) ;
return V_8 ;
}
...
V_4 -> V_11 -> V_314 ) )
return 0 ;
return F_269 ( V_2 , V_4 , V_78 , V_183 , 0 ,
V_347 , 1 , NULL ) ;
}
