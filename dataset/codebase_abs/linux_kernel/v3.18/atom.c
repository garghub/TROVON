...
static void F_34 ( T_2 * V_3 , int * V_29 , int V_35 )
{
}
static void F_35 ( T_2 * V_3 , int * V_29 , int V_35 )
{
...
static void F_58 ( T_2 * V_3 , int * V_29 , int V_35 )
{
T_3 V_28 = F_9 ( ( * V_29 ) ++ ) ;
T_1 V_87 , V_88 , V_30 ;
int V_89 = * V_29 ;
...
static void F_59 ( T_2 * V_3 , int * V_29 , int V_35 )
{
F_2 ( V_27 L_58 ) ;
}
...
int F_63 ( struct V_2 * V_3 , int V_5 , T_1 * V_126 )
{
int V_90 ;
F_64 ( & V_3 -> V_144 ) ;
V_3 -> V_53 = 0 ;
...
int F_66 ( struct V_2 * V_3 , int V_5 , T_1 * V_126 )
{
int V_90 ;
F_64 ( & V_3 -> V_145 ) ;
V_90 = F_63 ( V_3 , V_5 , V_126 ) ;
F_65 ( & V_3 -> V_145 ) ;
return V_90 ;
}
static void F_67 ( struct V_2 * V_3 , int V_4 )
{
V_3 -> V_44 = F_60 ( 2 * 256 , V_137 ) ;
if ( ! V_3 -> V_44 )
return;
while ( F_4 ( V_4 ) == V_146 ) {
...
struct V_2 * F_68 ( struct V_148 * V_9 , void * V_149 )
{
int V_4 ;
struct V_2 * V_3 =
F_60 ( sizeof( struct V_2 ) , V_137 ) ;
char * V_150 ;
char V_151 [ 512 ] ;
int V_152 ;
if ( ! V_3 )
...
V_4 = F_5 ( V_156 ) ;
if ( strncmp
( F_69 ( V_4 + V_157 ) , V_158 ,
strlen ( V_158 ) ) ) {
F_2 ( V_27 L_77 ) ;
F_62 ( V_3 ) ;
return NULL ;
}
V_3 -> V_93 = F_5 ( V_4 + V_159 ) ;
V_3 -> V_115 = F_5 ( V_4 + V_160 ) ;
F_67 ( V_3 , F_5 ( V_3 -> V_115 + V_161 ) + 4 ) ;
if ( ! V_3 -> V_44 ) {
F_70 ( V_3 ) ;
return NULL ;
}
V_150 = F_69 ( F_5 ( V_4 + V_162 ) ) ;
while ( * V_150 && ( ( * V_150 == '\n' ) || ( * V_150 == '\r' ) ) )
V_150 ++ ;
for ( V_152 = 0 ; V_152 < 511 ; V_152 ++ ) {
V_151 [ V_152 ] = V_150 [ V_152 ] ;
if ( V_151 [ V_152 ] < '.' || V_151 [ V_152 ] > 'z' ) {
V_151 [ V_152 ] = 0 ;
break;
}
}
...
{
struct V_7 * V_8 = V_3 -> V_9 -> V_10 -> V_11 ;
int V_163 = F_5 ( V_3 -> V_115 + V_164 ) ;
T_1 V_47 [ 16 ] ;
int V_130 ;
memset ( V_47 , 0 , 64 ) ;
V_47 [ 0 ] = F_19 ( F_72 ( V_163 + V_165 ) ) ;
V_47 [ 1 ] = F_19 ( F_72 ( V_163 + V_166 ) ) ;
if ( ! V_47 [ 0 ] || ! V_47 [ 1 ] )
return 1 ;
if ( ! F_5 ( V_3 -> V_93 + 4 + 2 * V_167 ) )
return 1 ;
V_130 = F_66 ( V_3 , V_167 , V_47 ) ;
if ( V_130 )
return V_130 ;
memset ( V_47 , 0 , 64 ) ;
if ( V_8 -> V_17 < V_168 ) {
if ( F_5 ( V_3 -> V_93 + 4 + 2 * V_169 ) )
F_66 ( V_3 , V_169 , V_47 ) ;
}
return V_130 ;
}
...
bool F_73 ( struct V_2 * V_3 , int V_5 ,
T_4 * V_170 , T_3 * V_171 , T_3 * V_172 ,
T_4 * V_173 )
{
int V_174 = V_5 * 2 + 4 ;
int V_32 = F_5 ( V_3 -> V_115 + V_174 ) ;
T_5 * V_175 = ( T_5 * ) ( V_3 -> V_149 + V_3 -> V_115 + 4 ) ;
if ( ! V_175 [ V_5 ] )
return false ;
if ( V_170 )
* V_170 = F_5 ( V_32 ) ;
...
bool F_74 ( struct V_2 * V_3 , int V_5 , T_3 * V_171 ,
T_3 * V_172 )
{
int V_174 = V_5 * 2 + 4 ;
int V_32 = F_5 ( V_3 -> V_93 + V_174 ) ;
T_5 * V_176 = ( T_5 * ) ( V_3 -> V_149 + V_3 -> V_93 + 4 ) ;
if ( ! V_176 [ V_5 ] )
return false ;
if ( V_171 )
* V_171 = F_4 ( V_32 + 2 ) ;
...
{
int V_5 = F_76 ( V_177 , V_178 ) ;
T_4 V_179 ;
int V_180 = 0 ;
struct V_181 * V_182 ;
if ( F_73 ( V_3 , V_5 , NULL , NULL , NULL , & V_179 ) ) {
V_182 = (struct V_181 * ) ( V_3 -> V_149 + V_179 ) ;
F_77 ( L_79 ,
F_78 ( V_182 -> V_183 [ 0 ] . V_184 ) ,
F_79 ( V_182 -> V_183 [ 0 ] . V_185 ) ) ;
V_180 = F_79 ( V_182 -> V_183 [ 0 ] . V_185 ) * 1024 ;
}
V_3 -> V_65 = 0 ;
if ( V_180 == 0 )
V_180 = 20 * 1024 ;
V_3 -> V_66 = F_60 ( V_180 , V_137 ) ;
if ( ! V_3 -> V_66 )
return - V_186 ;
V_3 -> V_65 = V_180 ;
return 0 ;
