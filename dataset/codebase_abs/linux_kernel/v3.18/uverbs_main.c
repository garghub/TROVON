...
void F_49 ( struct V_118 * V_74 , void * V_119 )
{
struct V_10 * V_11 = F_2 ( V_74 -> V_113 . V_46 -> V_42 ,
struct V_10 , V_42 ) ;
F_48 ( V_11 -> V_102 , V_11 -> V_42 . V_108 ,
V_74 -> V_74 , & V_11 -> V_120 ,
& V_11 -> V_121 ) ;
}
void F_50 ( struct V_118 * V_74 , void * V_119 )
{
struct V_18 * V_11 ;
if ( ! V_74 -> V_113 . V_20 -> V_42 || ! V_74 -> V_113 . V_20 -> V_42 -> V_122 )
return;
V_11 = F_2 ( V_74 -> V_113 . V_20 -> V_42 ,
struct V_18 , V_42 ) ;
F_48 ( V_119 , V_11 -> V_42 . V_108 ,
V_74 -> V_74 , & V_11 -> V_77 ,
& V_11 -> V_123 ) ;
}
void F_51 ( struct V_118 * V_74 , void * V_119 )
{
struct V_18 * V_11 ;
...
void F_52 ( struct V_124 * V_125 ,
struct V_118 * V_74 )
{
struct V_8 * V_7 =
F_2 ( V_125 , struct V_8 , V_103 ) ;
F_48 ( V_7 , V_74 -> V_113 . V_126 , V_74 -> V_74 ,
NULL , NULL ) ;
}
...
{
struct V_6 * V_9 = NULL ;
struct V_96 V_131 = F_62 ( V_96 ) ;
if ( ! V_131 . V_7 )
return NULL ;
if ( V_131 . V_7 -> V_132 != & V_129 )
goto V_133;
V_9 = V_131 . V_7 -> V_73 ;
if ( V_9 -> V_84 ) {
V_9 = NULL ;
...
struct V_134 V_135 ;
T_7 V_104 ;
if ( V_71 < sizeof V_135 )
return - V_87 ;
if ( F_66 ( & V_135 , V_70 , sizeof V_135 ) )
return - V_90 ;
V_104 = ( V_135 . V_136 &
V_137 ) >> V_138 ;
if ( ! V_104 ) {
T_7 V_136 ;
if ( V_135 . V_136 & ~ ( T_7 ) ( V_137 |
V_139 ) )
return - V_87 ;
V_136 = V_135 . V_136 & V_139 ;
if ( V_136 >= F_67 ( V_140 ) ||
! V_140 [ V_136 ] )
return - V_87 ;
if ( ! V_7 -> V_141 &&
V_136 != V_142 )
return - V_87 ;
if ( ! ( V_7 -> V_56 -> V_67 -> V_143 & ( 1ull << V_136 ) ) )
return - V_144 ;
if ( V_135 . V_145 * 4 != V_71 )
return - V_87 ;
return V_140 [ V_136 ] ( V_7 ,
V_70 + sizeof( V_135 ) ,
V_135 . V_145 * 4 ,
V_135 . V_146 * 4 ) ;
} else if ( V_104 == V_147 ) {
...
if ( ! V_7 -> V_141 )
return - V_87 ;
if ( ! ( V_7 -> V_56 -> V_67 -> V_156 & ( 1ull << V_136 ) ) )
return - V_144 ;
if ( V_71 < ( sizeof( V_135 ) + sizeof( V_149 ) ) )
return - V_87 ;
if ( F_66 ( & V_149 , V_70 + sizeof( V_135 ) , sizeof( V_149 ) ) )
return - V_90 ;
V_71 -= sizeof( V_135 ) + sizeof( V_149 ) ;
V_70 += sizeof( V_135 ) + sizeof( V_149 ) ;
if ( ( V_135 . V_145 + V_149 . V_157 ) * 8 != V_71 )
return - V_87 ;
if ( V_149 . V_158 )
return - V_87 ;
if ( V_149 . V_159 ) {
if ( ! V_135 . V_146 && ! V_149 . V_160 )
return - V_87 ;
if ( ! F_68 ( V_161 ,
( void T_2 * ) ( unsigned long ) V_149 . V_159 ,
( V_135 . V_146 + V_149 . V_160 ) * 8 ) )
return - V_90 ;
} else {
if ( V_135 . V_146 || V_149 . V_160 )
return - V_87 ;
}
F_69 ( & V_151 , V_70 , ( unsigned long ) V_149 . V_159 ,
V_135 . V_145 * 8 , V_135 . V_146 * 8 ) ;
F_69 ( & V_152 ,
V_70 + V_151 . V_162 ,
( unsigned long ) V_149 . V_159 + V_151 . V_163 ,
V_149 . V_157 * 8 ,
V_149 . V_160 * 8 ) ;
V_153 = V_155 [ V_136 ] ( V_7 ,
& V_151 ,
& V_152 ) ;
if ( V_153 )
return V_153 ;
...
static int F_70 ( struct V_7 * V_69 , struct V_164 * V_165 )
{
struct V_8 * V_7 = V_69 -> V_73 ;
if ( ! V_7 -> V_141 )
return - V_166 ;
else
return V_7 -> V_56 -> V_67 -> V_167 ( V_7 -> V_141 , V_165 ) ;
}
...
struct V_8 * V_7 ;
int V_76 ;
V_4 = F_2 ( V_99 -> V_168 , struct V_3 , V_169 ) ;
if ( V_4 )
F_63 ( & V_4 -> V_2 ) ;
else
return - V_170 ;
...
static T_1 F_76 ( struct V_56 * V_56 , struct V_173 * V_174 ,
char * V_70 )
{
struct V_3 * V_4 = F_77 ( V_56 ) ;
if ( ! V_4 )
return - V_166 ;
return sprintf ( V_70 , L_2 , V_4 -> V_67 -> V_175 ) ;
}
static T_1 F_78 ( struct V_56 * V_56 ,
struct V_173 * V_174 , char * V_70 )
{
struct V_3 * V_4 = F_77 ( V_56 ) ;
if ( ! V_4 )
return - V_166 ;
return sprintf ( V_70 , L_3 , V_4 -> V_67 -> V_176 ) ;
}
static int F_79 ( void )
{
int V_76 ;
if ( ! V_177 ) {
V_76 = F_80 ( & V_177 , 0 , V_178 ,
L_4 ) ;
if ( V_76 ) {
F_81 ( V_179 L_5 ) ;
return V_76 ;
...
V_76 = F_82 ( V_180 , V_178 ) ;
if ( V_76 >= V_178 )
return - 1 ;
return V_76 ;
}
static void F_83 ( struct V_181 * V_56 )
{
int V_182 ;
T_8 V_183 ;
struct V_3 * V_184 ;
...
F_87 ( & V_188 ) ;
V_184 -> V_67 = V_56 ;
V_184 -> V_191 = V_56 -> V_191 ;
F_89 ( & V_184 -> V_169 , NULL ) ;
V_184 -> V_169 . V_68 = V_192 ;
V_184 -> V_169 . V_193 = V_56 -> V_167 ? & V_194 : & V_195 ;
F_90 ( & V_184 -> V_169 . V_196 , L_6 , V_184 -> V_182 ) ;
if ( F_91 ( & V_184 -> V_169 , V_183 , 1 ) )
goto V_197;
V_184 -> V_4 = F_92 ( V_198 , V_56 -> V_199 ,
V_184 -> V_169 . V_4 , V_184 ,
L_6 , V_184 -> V_182 ) ;
if ( F_60 ( V_184 -> V_4 ) )
goto V_197;
if ( F_93 ( V_184 -> V_4 , & V_200 ) )
goto V_201;
if ( F_93 ( V_184 -> V_4 , & V_202 ) )
goto V_201;
F_94 ( V_56 , & V_203 , V_184 ) ;
return;
V_201:
F_95 ( V_198 , V_184 -> V_169 . V_4 ) ;
V_197:
F_96 ( & V_184 -> V_169 ) ;
if ( V_184 -> V_182 < V_178 )
F_97 ( V_182 , V_189 ) ;
else
F_97 ( V_182 , V_180 ) ;
V_153:
...
static void F_99 ( struct V_181 * V_56 )
{
struct V_3 * V_184 = F_100 ( V_56 , & V_203 ) ;
if ( ! V_184 )
return;
F_101 ( V_184 -> V_4 , NULL ) ;
F_95 ( V_198 , V_184 -> V_169 . V_4 ) ;
F_96 ( & V_184 -> V_169 ) ;
if ( V_184 -> V_182 < V_178 )
F_97 ( V_184 -> V_182 , V_189 ) ;
else
F_97 ( V_184 -> V_182 - V_178 , V_180 ) ;
F_11 ( & V_184 -> V_2 , F_1 ) ;
F_98 ( & V_184 -> V_5 ) ;
F_5 ( V_184 ) ;
}
static char * F_102 ( struct V_56 * V_4 , T_9 * V_204 )
{
if ( V_204 )
* V_204 = 0666 ;
return F_103 ( V_127 , L_7 , F_104 ( V_4 ) ) ;
}
static int T_10 F_105 ( void )
{
int V_76 ;
V_76 = F_106 ( V_190 , V_178 ,
L_4 ) ;
if ( V_76 ) {
F_81 ( V_179 L_8 ) ;
goto V_133;
}
V_198 = F_107 ( V_192 , L_4 ) ;
if ( F_60 ( V_198 ) ) {
V_76 = F_108 ( V_198 ) ;
F_81 ( V_179 L_9 ) ;
goto V_205;
