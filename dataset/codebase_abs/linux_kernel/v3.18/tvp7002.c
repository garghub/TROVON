...
if ( V_24 -> V_79 == V_78 )
return 0 ;
error = F_10 ( V_3 , V_80 , V_78 ? 0x00 : 0x03 ) ;
if ( error ) {
F_19 ( 1 , V_52 , V_3 , L_7 ) ;
return error ;
}
...
static int
F_30 ( struct V_2 * V_3 , struct V_85 * V_86 ,
struct V_87 * V_46 )
{
if ( V_46 -> V_53 != 0 )
return - V_29 ;
...
static int
F_31 ( struct V_2 * V_3 , struct V_85 * V_86 ,
struct V_88 * V_89 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
V_89 -> V_90 . V_46 = V_47 ;
V_89 -> V_90 . V_35 = V_1 -> V_36 -> V_33 . V_26 . V_35 ;
V_89 -> V_90 . V_45 = V_1 -> V_36 -> V_33 . V_26 . V_45 ;
V_89 -> V_90 . V_48 = V_1 -> V_36 -> V_49 ;
V_89 -> V_90 . V_50 = V_1 -> V_36 -> V_51 ;
return 0 ;
}
static int
F_32 ( struct V_2 * V_3 , struct V_85 * V_86 ,
struct V_88 * V_89 )
{
return F_31 ( V_3 , V_86 , V_89 ) ;
}
static struct V_91 *
F_33 ( struct V_10 * V_92 )
{
struct V_93 V_94 ;
struct V_91 * V_95 ;
struct V_96 * V_97 ;
unsigned int V_98 ;
if ( ! F_34 ( V_99 ) || ! V_92 -> V_100 . V_101 )
return V_92 -> V_100 . V_102 ;
V_97 = F_35 ( V_92 -> V_100 . V_101 , NULL ) ;
if ( ! V_97 )
return NULL ;
V_95 = F_36 ( & V_92 -> V_100 , sizeof( * V_95 ) , V_103 ) ;
if ( ! V_95 )
goto V_104;
F_37 ( V_97 , & V_94 ) ;
V_98 = V_94 . V_105 . V_106 . V_98 ;
if ( V_98 & V_107 )
V_95 -> V_108 = 1 ;
if ( V_98 & V_109 )
V_95 -> V_110 = 1 ;
...
static int F_39 ( struct V_10 * V_11 , const struct V_117 * V_38 )
{
struct V_91 * V_95 = F_33 ( V_11 ) ;
struct V_2 * V_3 ;
struct V_1 * V_24 ;
struct V_22 V_33 ;
int V_118 ;
...
int error ;
if ( V_95 == NULL ) {
F_40 ( & V_11 -> V_100 , L_14 ) ;
return - V_29 ;
}
if ( ! F_41 ( V_11 -> V_121 ,
V_122 | V_123 ) )
return - V_124 ;
V_24 = F_36 ( & V_11 -> V_100 , sizeof( struct V_1 ) , V_103 ) ;
if ( ! V_24 )
return - V_125 ;
V_3 = & V_24 -> V_3 ;
V_24 -> V_95 = V_95 ;
...
F_42 ( V_3 , V_11 , & V_126 ) ;
F_43 ( V_11 , L_15 ,
V_11 -> V_8 , V_11 -> V_121 -> V_82 ) ;
error = F_4 ( V_3 , V_127 , & V_120 ) ;
if ( error < 0 )
return error ;
F_27 ( V_3 , L_16 , V_120 ) ;
if ( V_120 != 0x02 )
F_27 ( V_3 , L_17 ) ;
error = F_14 ( V_3 , V_128 ) ;
if ( error < 0 )
return error ;
V_118 = 0x20 | V_24 -> V_95 -> V_108 << 5
| V_24 -> V_95 -> V_110 << 2 ;
error = F_10 ( V_3 , V_129 , V_118 ) ;
if ( error < 0 )
return error ;
V_119 = 0x01 | V_24 -> V_95 -> V_114 << 2
| V_24 -> V_95 -> V_116 << 1
| V_24 -> V_95 -> V_112 ;
error = F_10 ( V_3 , V_130 , V_119 ) ;
if ( error < 0 )
return error ;
V_33 = V_24 -> V_36 -> V_33 ;
error = F_15 ( V_3 , & V_33 ) ;
#if F_44 ( V_131 )
V_24 -> V_84 . V_98 = V_132 ;
V_24 -> V_3 . V_98 |= V_133 ;
V_24 -> V_3 . V_134 . V_98 |= V_135 ;
error = F_45 ( & V_24 -> V_3 . V_134 , 1 , & V_24 -> V_84 , 0 ) ;
if ( error < 0 )
return error ;
#endif
F_46 ( & V_24 -> V_7 , 1 ) ;
