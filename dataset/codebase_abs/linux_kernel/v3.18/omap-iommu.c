...
struct V_116 * V_117 ;
struct V_16 * V_17 = V_15 -> V_7 . V_18 ;
struct V_118 * V_119 = V_15 -> V_7 . V_120 ;
V_9 = F_84 ( & V_15 -> V_7 , sizeof( * V_9 ) + V_121 , V_66 ) ;
if ( ! V_9 )
return - V_78 ;
if ( V_119 ) {
V_9 -> V_113 = F_85 ( & V_15 -> V_7 ) ;
V_9 -> V_52 = 32 ;
V_13 = F_86 ( V_119 , L_16 ,
& V_9 -> V_52 ) ;
if ( V_13 && V_13 != - V_30 )
return V_13 ;
if ( V_9 -> V_52 != 32 && V_9 -> V_52 != 8 )
return - V_30 ;
if ( F_87 ( V_119 , L_17 , NULL ) )
V_9 -> V_122 = V_123 ;
} else {
V_9 -> V_52 = V_17 -> V_52 ;
...
V_9 -> V_7 = & V_15 -> V_7 ;
V_9 -> V_124 = ( void * ) V_9 + sizeof( * V_9 ) ;
F_88 ( & V_9 -> V_114 ) ;
F_88 ( & V_9 -> V_77 ) ;
V_117 = F_89 ( V_15 , V_125 , 0 ) ;
V_9 -> V_126 = F_90 ( V_9 -> V_7 , V_117 ) ;
if ( F_35 ( V_9 -> V_126 ) )
return F_36 ( V_9 -> V_126 ) ;
V_106 = F_91 ( V_15 , 0 ) ;
if ( V_106 < 0 )
return - V_19 ;
V_13 = F_92 ( V_9 -> V_7 , V_106 , F_75 , V_127 ,
F_85 ( V_9 -> V_7 ) , V_9 ) ;
if ( V_13 < 0 )
return V_13 ;
F_93 ( V_15 , V_9 ) ;
F_94 ( V_9 -> V_7 ) ;
F_95 ( V_9 -> V_7 ) ;
F_96 ( & V_15 -> V_7 , L_18 , V_9 -> V_113 ) ;
return 0 ;
}
static int F_97 ( struct V_14 * V_15 )
{
struct V_8 * V_9 = F_98 ( V_15 ) ;
F_74 ( V_9 ) ;
F_99 ( V_9 -> V_7 ) ;
F_96 ( & V_15 -> V_7 , L_19 , V_9 -> V_113 ) ;
return 0 ;
}
static void F_100 ( void * V_73 )
{
F_101 ( V_73 , V_128 ) ;
}
static T_1 F_102 ( struct V_27 * V_28 , T_1 V_35 , T_1 V_80 , int V_93 )
{
...
static int F_103 ( struct V_108 * V_109 , unsigned long V_35 ,
T_5 V_80 , T_3 V_58 , int V_81 )
{
struct V_136 * V_137 = V_109 -> V_138 ;
struct V_8 * V_139 = V_137 -> V_140 ;
...
F_102 ( & V_28 , V_35 , V_80 , V_141 ) ;
V_142 = F_69 ( V_139 , & V_28 ) ;
if ( V_142 )
F_10 ( V_7 , L_22 , V_142 ) ;
return V_142 ;
}
static T_3 F_105 ( struct V_108 * V_109 , unsigned long V_35 ,
T_3 V_143 )
{
struct V_136 * V_137 = V_109 -> V_138 ;
struct V_8 * V_139 = V_137 -> V_140 ;
struct V_6 * V_7 = V_139 -> V_7 ;
F_34 ( V_7 , L_23 , V_35 , V_143 ) ;
return F_73 ( V_139 , V_35 ) ;
}
static int
F_106 ( struct V_108 * V_109 , struct V_6 * V_7 )
{
struct V_136 * V_137 = V_109 -> V_138 ;
struct V_8 * V_139 ;
struct V_144 * V_145 = V_7 -> V_146 . V_147 ;
int V_142 = 0 ;
if ( ! V_145 || ! V_145 -> V_113 ) {
F_10 ( V_7 , L_24 ) ;
return - V_30 ;
}
F_57 ( & V_137 -> V_148 ) ;
...
V_139 = F_80 ( V_145 -> V_113 , V_137 -> V_149 ) ;
if ( F_35 ( V_139 ) ) {
V_142 = F_36 ( V_139 ) ;
F_10 ( V_7 , L_26 , V_142 ) ;
goto V_53;
}
V_137 -> V_140 = V_145 -> V_140 = V_139 ;
V_137 -> V_7 = V_7 ;
V_139 -> V_109 = V_109 ;
V_53:
F_55 ( & V_137 -> V_148 ) ;
...
static void F_107 ( struct V_136 * V_137 ,
struct V_6 * V_7 )
{
struct V_8 * V_139 = F_5 ( V_7 ) ;
struct V_144 * V_145 = V_7 -> V_146 . V_147 ;
...
F_74 ( V_139 ) ;
F_82 ( V_139 ) ;
V_137 -> V_140 = V_145 -> V_140 = NULL ;
V_137 -> V_7 = NULL ;
}
static void F_108 ( struct V_108 * V_109 ,
struct V_6 * V_7 )
{
struct V_136 * V_137 = V_109 -> V_138 ;
F_57 ( & V_137 -> V_148 ) ;
...
static int F_109 ( struct V_108 * V_109 )
{
struct V_136 * V_137 ;
V_137 = F_110 ( sizeof( * V_137 ) , V_66 ) ;
if ( ! V_137 ) {
F_3 ( L_28 ) ;
goto V_53;
}
V_137 -> V_149 = F_110 ( V_150 , V_66 ) ;
if ( ! V_137 -> V_149 ) {
F_3 ( L_28 ) ;
goto V_151;
}
F_15 ( ! F_111 ( ( long ) V_137 -> V_149 , V_150 ) ) ;
F_101 ( V_137 -> V_149 , V_150 ) ;
F_88 ( & V_137 -> V_148 ) ;
V_109 -> V_138 = V_137 ;
V_109 -> V_152 . V_153 = 0 ;
V_109 -> V_152 . V_154 = ( 1ULL << 32 ) - 1 ;
V_109 -> V_152 . V_155 = true ;
return 0 ;
V_151:
F_37 ( V_137 ) ;
V_53:
...
V_109 -> V_138 = NULL ;
if ( V_137 -> V_140 )
F_107 ( V_137 , V_137 -> V_7 ) ;
F_37 ( V_137 -> V_149 ) ;
F_37 ( V_137 ) ;
}
static T_5 F_113 ( struct V_108 * V_109 ,
T_6 V_35 )
{
struct V_136 * V_137 = V_109 -> V_138 ;
struct V_8 * V_139 = V_137 -> V_140 ;
...
T_1 * V_156 , * V_157 ;
T_5 V_142 = 0 ;
F_70 ( V_139 , V_35 , & V_156 , & V_157 ) ;
if ( V_157 ) {
if ( F_114 ( * V_157 ) )
V_142 = F_115 ( * V_157 , V_35 , V_158 ) ;
else if ( F_116 ( * V_157 ) )
V_142 = F_115 ( * V_157 , V_35 , V_90 ) ;
else
F_10 ( V_7 , L_29 , * V_157 ,
( unsigned long long ) V_35 ) ;
} else {
if ( F_117 ( * V_156 ) )
V_142 = F_115 ( * V_156 , V_35 , V_82 ) ;
else if ( F_118 ( * V_156 ) )
V_142 = F_115 ( * V_156 , V_35 , V_85 ) ;
else
F_10 ( V_7 , L_30 , * V_156 ,
( unsigned long long ) V_35 ) ;
}
...
V_145 = F_110 ( sizeof( * V_145 ) , V_66 ) ;
if ( ! V_145 ) {
F_123 ( V_159 ) ;
return - V_78 ;
}
V_145 -> V_113 = F_124 ( F_85 ( & V_15 -> V_7 ) , V_66 ) ;
V_7 -> V_146 . V_147 = V_145 ;
F_123 ( V_159 ) ;
return 0 ;
}
...
{
struct V_160 * V_65 ;
const unsigned long V_161 = V_162 ;
T_3 V_163 = 1 << 10 ;
V_65 = F_127 ( L_32 , V_128 , V_163 , V_161 ,
F_100 ) ;
if ( ! V_65 )
return - V_78 ;
V_74 = V_65 ;
