...
V_65 -> V_43 . V_75 . V_75 . V_100 = 0 ;
V_65 -> V_43 . V_75 . V_75 . V_101 = 0 ;
V_66 = F_26 ( V_37 , V_34 ) ;
if ( V_65 -> V_43 . V_75 . V_75 . V_101 )
...
{
struct V_31 * V_31 = V_3 -> V_30 -> V_32 -> V_33 ;
struct V_106 * V_107 = F_44 ( V_31 ) ;
F_3 ( V_3 -> V_30 ) ;
F_3 ( F_45 ( & V_107 -> V_108 ) >= 0 ) ;
F_46 ( & V_107 -> V_108 ) ;
}
...
int F_49 ( struct V_109 * V_81 , T_5 V_110 , T_5 V_111 )
{
int V_38 = - V_112 ;
F_50 ( V_111 > V_110 , L_10 , V_111 , V_110 ) ;
if ( F_51 ( V_81 ) ) {
V_38 = 0 ;
F_52 ( V_81 , V_110 + V_113 - 1 ,
V_111 - V_110 + 1 , 0 ) ;
}
return V_38 ;
}
