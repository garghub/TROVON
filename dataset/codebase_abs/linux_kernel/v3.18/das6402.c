...
return F_33 ( V_2 , V_29 , V_37 , V_42 ) ;
}
...
if ( ! V_15 )
return - V_68 ;
V_47 = F_40 ( V_2 , V_64 -> V_69 [ 0 ] , 0x10 ) ;
if ( V_47 )
return V_47 ;
F_37 ( V_2 ) ;
if ( ( 1 << V_64 -> V_69 [ 1 ] ) & 0x8cec ) {
V_47 = F_41 ( V_64 -> V_69 [ 1 ] , F_9 , 0 ,
V_2 -> V_70 , V_2 ) ;
if ( V_47 == 0 ) {
V_2 -> V_25 = V_64 -> V_69 [ 1 ] ;
switch ( V_2 -> V_25 ) {
case 10 :
V_15 -> V_25 = 4 ;
break;
