...
if ( V_243 -> V_304 )
return 0 ;
F_124 ( V_229 , V_243 -> V_268 , V_334 , V_343 ,
V_15 -> V_344 , & V_324 ) ;
...
F_124 ( V_229 , V_243 -> V_268 , V_334 , V_345 ,
V_15 -> V_332 , & V_324 ) ;
if ( ! V_324 . V_327 ) {
F_124 ( V_229 , V_243 -> V_268 , V_334 ,
...
if ( V_267 < 0 )
goto V_380;
V_267 = F_144 ( V_30 , V_243 -> V_269 . V_381 , false ) ;
if ( V_267 < 0 ) {
fprintf ( V_243 -> V_262 , L_95 ,
F_115 ( V_382 , V_374 , sizeof( V_374 ) ) ) ;
goto V_378;
}
F_145 ( V_30 ) ;
if ( V_372 )
F_146 ( V_30 ) ;
V_243 -> V_255 = V_30 -> V_271 -> V_327 [ 0 ] == - 1 || V_30 -> V_271 -> V_383 > 1 ;
V_384:
V_371 = V_243 -> V_231 ;
for ( V_294 = 0 ; V_294 < V_30 -> V_385 ; V_294 ++ ) {
union V_258 * V_259 ;
...
if ( V_267 ) {
fprintf ( V_243 -> V_262 , L_96 , V_267 ) ;
goto V_386;
}
if ( ! V_243 -> V_349 && V_243 -> V_251 == 0 )
V_243 -> V_251 = V_15 . time ;
...
if ( V_19 == NULL ) {
fprintf ( V_243 -> V_262 , L_97 V_263 L_98 , V_15 . V_24 ) ;
goto V_386;
}
if ( V_19 -> V_338 . type == V_388 &&
V_15 . V_16 == NULL ) {
fprintf ( V_243 -> V_262 , L_99 ,
F_105 ( V_19 ) , V_15 . V_240 ,
V_15 . V_389 , V_15 . V_390 ) ;
goto V_386;
}
V_22 = V_19 -> V_22 ;
V_22 ( V_243 , V_19 , V_259 , & V_15 ) ;
...
char V_395 [ V_396 ] ;
V_375:
F_156 ( V_30 , V_382 , V_395 , sizeof( V_395 ) ) ;
goto V_397;
V_380:
F_157 ( V_30 , V_382 , V_395 , sizeof( V_395 ) ) ;
V_397:
fprintf ( V_243 -> V_262 , L_104 , V_395 ) ;
goto V_378;
}
}
static int F_158 ( struct V_243 * V_243 )
{
...
V_243 -> V_266 . V_406 = V_407 ;
V_243 -> V_266 . V_408 = V_409 ;
V_243 -> V_266 . V_410 = V_411 ;
V_243 -> V_266 . exit = V_412 ;
V_243 -> V_266 . V_413 = V_414 ;
V_243 -> V_266 . V_338 = V_415 ;
V_243 -> V_266 . V_416 = V_417 ;
V_243 -> V_266 . V_418 = V_419 ;
V_243 -> V_266 . V_420 = true ;
V_243 -> V_266 . V_421 = true ;
V_243 -> V_255 = true ;
V_405 = F_159 ( & V_401 , false , & V_243 -> V_266 ) ;
if ( V_405 == NULL )
return - 1 ;
if ( F_94 ( & V_405 -> V_260 . V_422 ) < 0 )
goto V_36;
V_243 -> V_268 = & V_405 -> V_423 . V_268 ;
V_267 = F_160 ( V_405 , V_399 ) ;
if ( V_267 )
goto V_36;
V_19 = F_161 ( V_405 -> V_30 ,
L_82 ) ;
if ( V_19 == NULL )
V_19 = F_161 ( V_405 -> V_30 ,
L_84 ) ;
...
F_162 (session->evlist, evsel) {
if ( V_19 -> V_338 . type == V_368 &&
( V_19 -> V_338 . V_339 == V_340 ||
V_19 -> V_338 . V_339 == V_376 ||
V_19 -> V_338 . V_339 == V_424 ) )
V_19 -> V_22 = F_123 ;
}
V_267 = F_128 ( V_243 ) ;
if ( V_267 != 0 )
...
static T_1 F_166 ( V_67 * V_218 )
{
T_1 V_52 ;
V_52 = fprintf ( V_218 , L_111 ) ;
return V_52 ;
}
static T_1 F_167 ( struct V_224 * V_225 ,
struct V_243 * V_243 , V_67 * V_218 )
{
struct V_245 * V_245 ;
T_1 V_52 = 0 ;
struct V_272 * V_273 ;
struct V_297 * V_298 = F_168 ( V_225 -> V_228 ) ;
if ( V_298 == NULL )
return 0 ;
V_52 += fprintf ( V_218 , L_102 ) ;
...
static int F_172 ( struct V_229 * V_229 , void * V_21 )
{
struct V_428 * V_429 = V_21 ;
V_67 * V_218 = V_429 -> V_218 ;
T_1 V_52 = V_429 -> V_52 ;
struct V_243 * V_243 = V_429 -> V_243 ;
struct V_224 * V_225 = F_74 ( V_229 ) ;
double V_430 ;
if ( V_225 == NULL )
return 0 ;
V_430 = ( double ) V_225 -> V_231 / V_243 -> V_231 * 100.0 ;
V_52 += fprintf ( V_218 , L_120 , F_87 ( V_229 ) , V_229 -> V_240 ) ;
V_52 += fprintf ( V_218 , L_121 , V_225 -> V_231 ) ;
V_52 += fprintf ( V_218 , L_122 , V_430 ) ;
if ( V_225 -> V_341 )
V_52 += fprintf ( V_218 , L_123 , V_225 -> V_341 ) ;
if ( V_225 -> V_342 )
V_52 += fprintf ( V_218 , L_124 , V_225 -> V_342 ) ;
V_52 += fprintf ( V_218 , L_125 , V_225 -> V_319 ) ;
V_52 += F_167 ( V_225 , V_243 , V_218 ) ;
V_429 -> V_52 += V_52 ;
return 0 ;
}
...
V_429 . V_52 = F_166 ( V_218 ) ;
F_173 ( V_243 -> V_268 , F_172 , & V_429 ) ;
return V_429 . V_52 ;
}
static int F_174 ( const struct V_431 * V_432 , const char * V_433 ,
int T_9 V_300 )
{
struct V_243 * V_243 = V_432 -> V_434 ;
V_243 -> V_248 = atof ( V_433 ) ;
return 0 ;
}
static int F_175 ( struct V_243 * V_243 , const char * V_435 )
{
struct V_237 V_238 ;
if ( ! V_237 ( V_435 , & V_238 ) && V_238 . V_241 ) {
char V_436 [ V_236 ] ;
F_18 ( V_436 , sizeof( V_436 ) , L_126 , V_435 ) ;
F_176 ( V_436 ) ;
rename ( V_435 , V_436 ) ;
}
V_243 -> V_262 = fopen ( V_435 , L_127 ) ;
return V_243 -> V_262 == NULL ? - V_382 : 0 ;
}
static int F_177 ( const struct V_431 * V_432 , const char * V_433 ,
int T_9 V_300 )
{
int * V_364 = V_432 -> V_434 ;
if ( strcmp ( V_433 , L_128 ) == 0 )
* V_364 |= V_365 | V_366 ;
else if ( strcmp ( V_433 , L_67 ) == 0 )
* V_364 |= V_365 ;
else if ( strcmp ( V_433 , L_68 ) == 0 )
* V_364 |= V_366 ;
else
return - 1 ;
return 0 ;
}
int F_178 ( int V_351 , const char * * V_352 , const char * T_10 V_300 )
{
const char * const V_437 [] = {
L_129 ,
L_130 ,
L_131 ,
L_132 ,
...
. V_283 = {
. V_257 = F_179 () ,
. V_307 = F_180 ( L_133 , V_243 . V_283 . V_257 ) ,
} ,
. V_284 = {
. V_227 = - 1 ,
} ,
...
const char * V_445 = NULL ;
const char * V_446 = NULL ;
const struct V_431 V_447 [] = {
F_181 ( 0 , L_60 , & V_243 . V_256 ,
L_134 ) ,
F_181 ( 0 , L_135 , & V_243 . V_394 , L_136 ) ,
F_182 ( 'e' , L_137 , & V_446 , L_137 ,
L_138 ) ,
F_182 ( 'o' , L_139 , & V_445 , L_140 , L_141 ) ,
F_182 ( 'i' , L_142 , & V_402 , L_140 , L_143 ) ,
F_182 ( 'p' , L_61 , & V_243 . V_269 . V_270 . V_302 , L_61 ,
L_144 ) ,
F_182 ( 't' , L_145 , & V_243 . V_269 . V_270 . V_240 , L_145 ,
L_146 ) ,
F_181 ( 'a' , L_147 , & V_243 . V_269 . V_270 . V_448 ,
L_148 ) ,
F_182 ( 'C' , L_149 , & V_243 . V_269 . V_270 . V_449 , L_149 ,
L_150 ) ,
F_181 ( 0 , L_151 , & V_243 . V_269 . V_450 ,
L_152 ) ,
F_183 ( 'm' , L_153 , & V_243 . V_269 . V_381 , L_154 ,
L_155 ,
V_451 ) ,
F_182 ( 'u' , L_156 , & V_243 . V_269 . V_270 . V_452 , L_157 ,
L_158 ) ,
F_183 ( 0 , L_159 , & V_243 , L_160 ,
L_161 ,
F_174 ) ,
F_181 ( 0 , L_90 , & V_243 . V_377 , L_162 ) ,
F_184 ( 'v' , L_163 , & V_295 , L_164 ) ,
F_181 ( 'T' , L_165 , & V_243 . V_349 ,
L_166 ) ,
F_181 ( 's' , L_167 , & V_243 . V_304 ,
L_168 ) ,
F_181 ( 'S' , L_169 , & V_243 . V_306 ,
L_170 ) ,
F_185 ( 'F' , L_171 , & V_243 . V_364 , L_172 ,
L_173 , F_177 , L_67 ) ,
F_181 ( 0 , L_2 , & V_243 . V_363 , L_174 ) ,
F_186 ()
} ;
int V_267 ;
char V_39 [ V_396 ] ;
V_351 = F_187 ( V_351 , V_352 , V_447 , V_437 ,
V_453 ) ;
if ( V_243 . V_364 ) {
V_243 . V_269 . V_454 = true ;
V_243 . V_269 . V_455 = true ;
}
...
if ( V_446 != NULL ) {
const char * V_456 = V_446 ;
V_243 . V_288 = * V_456 == '!' ;
if ( V_243 . V_288 )
++ V_456 ;
V_243 . V_286 = F_188 ( true , V_456 ) ;
if ( V_243 . V_286 == NULL ) {
fputs ( L_177 ,
V_243 . V_262 ) ;
V_267 = - V_26 ;
...
V_267 = F_189 ( & V_243 . V_269 . V_270 ) ;
if ( V_267 ) {
F_190 ( & V_243 . V_269 . V_270 , V_267 , V_39 , sizeof( V_39 ) ) ;
fprintf ( V_243 . V_262 , L_5 , V_39 ) ;
goto V_457;
}
V_267 = F_191 ( & V_243 . V_269 . V_270 ) ;
if ( V_267 ) {
F_190 ( & V_243 . V_269 . V_270 , V_267 , V_39 , sizeof( V_39 ) ) ;
fprintf ( V_243 . V_262 , L_5 , V_39 ) ;
goto V_457;
}
if ( ! V_351 && F_192 ( & V_243 . V_269 . V_270 ) )
V_243 . V_269 . V_270 . V_448 = true ;
if ( V_402 )
V_267 = F_158 ( & V_243 ) ;
else
