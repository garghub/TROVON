...
struct V_47 * F_17 ( struct V_1 * V_1 , T_1 V_49 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < ( 1 << V_42 ) ; V_33 ++ ) {
struct V_43 * V_44 ;
...
F_6 ( & V_1 -> V_34 . V_35 ) ;
F_21 ( & V_1 -> V_34 . V_56 , V_57 + V_58 / 4 ) ;
}
static struct V_47 * F_22 ( struct V_43 * V_59 ,
struct V_2 * V_60 )
{
struct V_47 * V_61 ;
F_23 (tpos, h, node)
...
int F_24 ( struct V_64 * V_65 , const struct V_66 * V_67 ,
T_1 V_68 , T_2 V_55 )
{
struct V_2 V_3 ;
struct V_47 * V_48 ;
...
V_1 = F_25 ( V_65 ) ;
V_5 = F_26 ( V_67 , & V_3 ) ;
if ( ! V_5 || V_3 . V_63 != F_27 ( V_70 ) ||
( V_3 . V_8 != V_9 && V_3 . V_8 != V_14 ) )
return - V_16 ;
V_69 = F_28 ( V_67 ) & V_36 ;
F_4 ( & V_1 -> V_34 . V_35 ) ;
V_48 = F_22 ( & V_1 -> V_34 . V_37 [ V_69 ] , & V_3 ) ;
if ( V_48 ) {
if ( V_68 == V_48 -> V_54 ) {
V_5 = - V_71 ;
goto V_72;
...
V_48 -> V_3 = V_3 ;
F_30 ( & V_48 -> V_50 ) ;
F_31 ( & V_48 -> V_50 , & V_1 -> V_34 . V_37 [ V_69 ] ) ;
}
V_72:
F_6 ( & V_1 -> V_34 . V_35 ) ;
return V_5 ;
