...
V_204 = F_110 ( V_200 , V_206 , L_10 ) ;
if ( ! V_204 )
return - V_207 ;
V_202 = F_111 ( sizeof( * V_202 ) , V_208 ) ;
if ( ! V_202 )
return - V_188 ;
F_112 ( & V_202 -> V_163 ) ;
F_113 ( & V_202 -> V_164 , 50 ) ;
V_202 -> V_4 = F_114 ( V_204 -> V_209 , F_115 ( V_204 ) ) ;
if ( ! V_202 -> V_4 ) {
V_39 = - V_188 ;
goto V_182;
}
V_204 = F_110 ( V_200 , V_206 , L_11 ) ;
if ( ! V_204 ) {
V_39 = - V_207 ;
goto V_210;
}
V_202 -> V_211 = F_115 ( V_204 ) ;
V_202 -> V_50 = V_202 -> V_211 - V_212 ;
V_202 -> V_51 = F_114 ( V_204 -> V_209 , V_202 -> V_211 ) ;
if ( ! V_202 -> V_51 ) {
V_39 = - V_188 ;
goto V_210;
}
if ( V_200 -> V_213 . V_214 )
V_191 = F_116 ( V_200 -> V_213 . V_214 , 0 ) ;
else
V_191 = F_117 ( V_200 , 0 ) ;
...
F_118 ( V_200 , V_202 ) ;
V_3 = V_202 ;
V_202 -> V_11 = F_119 ( F_60 , V_202 , L_12 ) ;
if ( F_99 ( V_202 -> V_11 ) ) {
V_39 = F_100 ( V_202 -> V_11 ) ;
goto V_216;
}
V_39 = F_120 ( V_191 , F_108 , 0 , F_121 ( & V_200 -> V_213 ) ,
V_202 ) ;
if ( V_39 )
goto V_217;
V_202 -> V_218 = F_122 ( & V_200 -> V_213 , NULL ) ;
if ( ! F_99 ( V_202 -> V_218 ) )
F_123 ( V_202 -> V_218 ) ;
F_5 ( 0 , V_3 -> V_4 + V_194 ) ;
...
{
struct V_201 * V_202 = F_134 ( V_200 ) ;
F_126 ( & V_223 ) ;
F_126 ( & V_225 ) ;
if ( V_202 -> V_228 )
F_135 ( & V_227 ) ;
