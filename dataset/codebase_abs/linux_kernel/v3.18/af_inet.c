...
static struct V_249 * F_94 ( struct V_249 * V_250 ,
T_4 V_251 )
{
struct V_249 * V_252 = F_95 ( - V_28 ) ;
...
goto V_31;
F_97 ( V_250 ) ;
V_258 = F_98 ( V_250 ) - F_99 ( V_250 ) ;
if ( F_25 ( ! F_100 ( V_250 , sizeof( * V_257 ) ) ) )
goto V_31;
V_257 = F_101 ( V_250 ) ;
V_259 = V_257 -> V_259 * 4 ;
if ( V_259 < sizeof( * V_257 ) )
goto V_31;
V_260 = F_40 ( V_257 -> V_260 ) ;
V_48 = V_257 -> V_44 ;
if ( F_25 ( ! F_100 ( V_250 , V_259 ) ) )
goto V_31;
F_102 ( V_250 , V_259 ) ;
V_255 = F_103 ( V_250 ) -> V_274 > 0 ;
if ( V_255 )
V_251 &= V_250 -> V_275 -> V_276 ;
F_103 ( V_250 ) -> V_274 += V_259 ;
F_104 ( V_250 ) ;
V_252 = F_95 ( - V_55 ) ;
if ( V_250 -> V_277 &&
F_96 ( V_250 ) -> V_261 & ( V_269 | V_268 ) )
V_254 = V_48 == V_278 && V_255 ;
else
V_254 = V_48 == V_278 && ! V_250 -> V_277 ;
V_62 = F_92 ( V_279 [ V_48 ] ) ;
if ( F_105 ( V_62 && V_62 -> V_280 . V_281 ) )
V_252 = V_62 -> V_280 . V_281 ( V_250 , V_251 ) ;
if ( F_106 ( V_252 ) )
goto V_31;
V_250 = V_252 ;
do {
V_257 = (struct V_256 * ) ( F_99 ( V_250 ) + V_258 ) ;
if ( V_254 ) {
...
static struct V_249 * * F_109 ( struct V_249 * * V_289 ,
struct V_249 * V_250 )
{
const struct V_253 * V_62 ;
...
V_257 = F_111 ( V_250 , V_292 ) ;
if ( F_112 ( V_250 , V_291 ) ) {
V_257 = F_113 ( V_250 , V_291 , V_292 ) ;
if ( F_25 ( ! V_257 ) )
goto V_31;
}
V_48 = V_257 -> V_44 ;
...
if ( * ( V_288 * ) V_257 != 0x45 )
goto V_295;
if ( F_25 ( F_114 ( ( V_288 * ) V_257 , 5 ) ) )
goto V_295;
V_260 = F_115 ( * ( T_1 * ) & V_257 -> V_260 ) ;
V_293 = ( V_296 ) ( ( F_115 ( * ( T_1 * ) V_257 ) ^ F_116 ( V_250 ) ) | ( V_260 & ~ V_297 ) ) ;
V_260 >>= 16 ;
for ( V_216 = * V_289 ; V_216 ; V_216 = V_216 -> V_283 ) {
struct V_256 * V_298 ;
if ( ! F_117 ( V_216 ) -> V_299 )
continue;
...
F_117 ( V_216 ) -> V_304 =
( ( V_296 ) ( F_40 ( V_298 -> V_260 ) + F_117 ( V_216 ) -> V_305 ) ^ V_260 ) ;
F_117 ( V_216 ) -> V_293 |= V_293 ;
}
F_117 ( V_250 ) -> V_293 |= V_293 ;
F_118 ( V_250 , V_292 ) ;
F_119 ( V_250 , sizeof( * V_257 ) ) ;
F_120 ( V_250 , F_110 ( V_250 ) ) ;
...
int F_121 ( struct V_1 * V_2 , struct V_171 * V_172 , int V_285 , int * V_103 )
{
if ( V_2 -> V_306 == V_110 )
return F_122 ( V_2 , V_172 , V_285 , V_103 ) ;
#if F_123 ( V_307 )
if ( V_2 -> V_306 == V_308 )
...
static int F_124 ( struct V_249 * V_250 , int V_258 )
{
...
if ( V_250 -> V_277 )
F_125 ( V_250 , V_258 ) ;
F_126 ( & V_257 -> V_313 , V_257 -> V_286 , V_311 ) ;
V_257 -> V_286 = V_311 ;
F_23 () ;
V_62 = F_92 ( V_279 [ V_48 ] ) ;
...
int F_127 ( struct V_1 * * V_2 , unsigned short V_315 ,
unsigned short type , unsigned char V_44 ,
struct V_43 * V_43 )
{
struct V_24 * V_1 ;
int V_316 = F_128 ( V_315 , type , V_44 , & V_1 ) ;
if ( V_316 == 0 ) {
* V_2 = V_1 -> V_2 ;
( * V_2 ) -> V_317 = V_318 ;
( * V_2 ) -> V_20 -> V_319 ( * V_2 ) ;
...
unsigned long F_130 ( void T_6 * V_320 , int V_321 )
{
unsigned long V_322 = 0 ;
int V_323 ;
F_131 (i)
V_322 += * ( ( ( unsigned long * ) F_132 ( V_320 , V_323 ) ) + V_321 ) ;
return V_322 ;
}
T_7 F_133 ( void T_6 * V_320 , int V_321 , T_2 V_324 )
{
T_7 V_322 = 0 ;
int V_325 ;
F_131 (cpu) {
...
T_7 V_329 ;
unsigned int V_330 ;
V_326 = F_132 ( V_320 , V_325 ) ;
V_328 = (struct V_327 * ) ( V_326 + V_324 ) ;
do {
V_330 = F_134 ( V_328 ) ;
V_329 = * ( ( ( T_7 * ) V_326 ) + V_321 ) ;
} while ( F_135 ( V_328 , V_330 ) );
V_322 += V_329 ;
}
return V_322 ;
}
static T_8 int F_136 ( struct V_43 * V_43 )
{
int V_323 ;
V_43 -> V_320 . V_331 = F_137 ( struct V_332 ) ;
if ( ! V_43 -> V_320 . V_331 )
goto V_333;
V_43 -> V_320 . V_334 = F_137 ( struct V_335 ) ;
if ( ! V_43 -> V_320 . V_334 )
goto V_336;
F_131 (i) {
struct V_335 * V_337 ;
V_337 = F_132 ( V_43 -> V_320 . V_334 , V_323 ) ;
F_138 ( & V_337 -> V_328 ) ;
}
V_43 -> V_320 . V_338 = F_137 ( struct V_339 ) ;
if ( ! V_43 -> V_320 . V_338 )
goto V_340;
V_43 -> V_320 . V_341 = F_137 ( struct V_342 ) ;
if ( ! V_43 -> V_320 . V_341 )
goto V_343;
V_43 -> V_320 . V_344 = F_137 ( struct V_342 ) ;
if ( ! V_43 -> V_320 . V_344 )
goto V_345;
V_43 -> V_320 . V_346 = F_137 ( struct V_347 ) ;
if ( ! V_43 -> V_320 . V_346 )
goto V_348;
V_43 -> V_320 . V_349 = F_139 ( sizeof( struct V_350 ) ,
V_67 ) ;
if ( ! V_43 -> V_320 . V_349 )
goto V_351;
F_140 ( V_43 ) ;
return 0 ;
V_351:
F_141 ( V_43 -> V_320 . V_346 ) ;
V_348:
F_141 ( V_43 -> V_320 . V_344 ) ;
V_345:
F_141 ( V_43 -> V_320 . V_341 ) ;
V_343:
F_141 ( V_43 -> V_320 . V_338 ) ;
V_340:
F_141 ( V_43 -> V_320 . V_334 ) ;
V_336:
F_141 ( V_43 -> V_320 . V_331 ) ;
V_333:
return - V_352 ;
}
static T_9 void F_142 ( struct V_43 * V_43 )
{
...
static T_8 int F_145 ( struct V_43 * V_43 )
{
F_146 ( & V_43 -> V_76 . V_354 . V_355 ) ;
V_43 -> V_76 . V_354 . V_356 [ 0 ] = 32768 ;
V_43 -> V_76 . V_354 . V_356 [ 1 ] = 61000 ;
F_146 ( & V_43 -> V_76 . V_357 . V_355 ) ;
V_43 -> V_76 . V_357 . V_356 [ 0 ] = F_147 ( & V_358 , 1 ) ;
V_43 -> V_76 . V_357 . V_356 [ 1 ] = F_147 ( & V_358 , 0 ) ;
return 0 ;
}
static T_9 void F_148 ( struct V_43 * V_43 )
{
}
...
struct V_217 * V_364 ;
int V_316 = - V_28 ;
F_157 ( sizeof( struct V_365 ) > F_158 ( struct V_249 , V_366 ) ) ;
V_316 = F_159 ( & V_367 , 1 ) ;
if ( V_316 )
goto V_31;
V_316 = F_159 ( & V_368 , 1 ) ;
...
F_162 () ;
#endif
if ( F_163 ( & V_375 , V_376 ) < 0 )
F_152 ( L_11 , V_246 ) ;
if ( F_163 ( & V_377 , V_278 ) < 0 )
F_152 ( L_12 , V_246 ) ;
if ( F_163 ( & V_378 , V_153 ) < 0 )
F_152 ( L_13 , V_246 ) ;
#ifdef F_164
if ( F_163 ( & V_379 , V_380 ) < 0 )
F_152 ( L_14 , V_246 ) ;
#endif
