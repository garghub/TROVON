...
V_83 = V_5 -> V_83 -> V_48 ;
V_63 = F_32 ( V_77 , 0 ) ;
V_1 = F_33 ( sizeof( struct V_1 ) , V_84 ) ;
if ( ! V_1 )
return - V_85 ;
F_34 ( & V_1 -> V_32 ) ;
V_1 -> V_64 = & V_77 -> V_64 ;
...
V_10 = F_40 ( & V_1 -> V_3 ) ;
if ( V_10 ) {
F_41 ( & V_77 -> V_64 , L_16 , V_10 ) ;
goto V_90;
}
if ( V_63 > 0 ) {
V_10 = F_42 ( & V_77 -> V_64 , V_63 , NULL ,
F_25 , V_91 ,
L_17 , V_1 ) ;
if ( V_10 ) {
F_41 ( & V_77 -> V_64 , L_18 , V_10 ) ;
goto V_90;
}
V_10 = F_43 ( & V_1 -> V_3 ,
& V_92 ,
...
struct V_5 * V_5 = V_1 -> V_5 ;
struct V_82 * V_83 = V_5 -> V_83 -> V_48 ;
if ( V_83 && V_83 -> remove )
V_83 -> remove ( V_5 , V_1 -> V_3 . V_61 ) ;
F_47 ( & V_1 -> V_3 ) ;
F_46 ( V_5 , V_18 ) ;
F_48 ( V_1 ) ;
return 0 ;
