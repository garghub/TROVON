...
static unsigned long F_22 ( struct V_66 * V_67 , T_1 * V_36 ,
bool V_37 )
{
return F_15 ( F_23 ( V_67 ) ,
F_24 ( V_67 ) ,
F_25 ( V_67 ) ,
F_26 ( V_67 ) ,
V_36 ,
...
if ( F_22 ( V_67 , & V_70 , false ) ) {
F_2 ( L_13 ) ;
return - V_28 ;
}
return 0 ;
}
static T_1 F_34 ( struct V_66 * V_67 )
{
unsigned long V_16 ;
T_1 V_70 ;
V_16 = F_22 ( V_67 , & V_70 , true ) ;
if ( V_16 )
return 0 ;
return V_70 ;
}
...
T_1 V_88 ;
V_88 = F_34 ( V_67 ) ;
V_87 = F_36 ( & V_67 -> V_89 . V_90 , V_88 ) ;
F_37 ( V_88 - V_87 , & V_67 -> V_14 ) ;
}
static void F_38 ( struct V_66 * V_67 , int V_91 )
{
if ( V_91 & V_92 )
F_39 ( & V_67 -> V_89 . V_90 , F_34 ( V_67 ) ) ;
}
static void F_40 ( struct V_66 * V_67 , int V_91 )
{
F_35 ( V_67 ) ;
}
static int F_41 ( struct V_66 * V_67 , int V_91 )
{
if ( V_91 & V_93 )
F_38 ( V_67 , V_91 ) ;
return 0 ;
...
V_23 = F_45 ( L_16 , 4096 , 4096 , 0 , NULL ) ;
if ( ! V_23 )
return - V_27 ;
V_97 . V_98 |= V_99 ;
V_94 = F_46 ( & V_97 , V_97 . V_100 , - 1 ) ;
if ( V_94 )
return V_94 ;
return 0 ;
}
