...
if ( V_43 [ V_17 ] ) {
T_1 V_58 = F_26 ( V_43 [ V_17 ] ) ;
if ( V_58 & V_11 )
V_10 |= ( V_11 << 16 ) ;
}
if ( V_26 == V_39 || ! V_43 [ V_59 ] ) {
...
static inline bool
F_33 ( const struct V_62 * V_2 ,
const struct V_62 * V_3 ,
T_1 * V_4 )
{
return F_34 ( & V_2 -> V_5 . V_63 , & V_3 -> V_5 . V_63 ) &&
V_2 -> V_6 == V_3 -> V_6 ;
}
static inline int
F_35 ( const struct V_62 * V_7 )
{
return V_7 -> V_8 ? - V_9 : 1 ;
}
static inline void
F_36 ( struct V_62 * V_7 , T_1 V_10 )
{
V_7 -> V_8 = ( V_10 >> 16 ) & V_11 ;
}
static inline void
F_37 ( struct V_62 * V_7 , T_2 * V_10 )
{
F_5 ( * V_10 , V_7 -> V_8 ) ;
}
static inline void
F_38 ( struct V_62 * V_7 , T_2 V_6 )
{
F_39 ( & V_7 -> V_5 , V_6 ) ;
V_7 -> V_6 = V_6 ;
}
static bool
F_40 ( struct V_12 * V_13 , const struct V_62 * V_14 )
{
T_1 V_10 = V_14 -> V_8 ? V_11 : 0 ;
if ( F_41 ( V_13 , V_15 , & V_14 -> V_5 . V_63 ) ||
F_10 ( V_13 , V_16 , V_14 -> V_6 ) ||
( V_10 &&
F_11 ( V_13 , V_17 , F_12 ( V_10 ) ) ) )
goto V_18;
...
if ( V_26 == V_39 )
V_33 . V_6 = V_35 ;
F_44 ( V_13 , V_28 -> V_10 & V_40 , & V_33 . V_5 . V_63 ) ;
