...
static inline int F_18 ( struct V_15 * V_16 )
{
#if F_19 ( V_17 ) || F_19 ( V_18 )
return 0 ;
#else
return ( ( V_16 -> V_19 & V_20 ) == 0 ) ;
#endif
}
static int F_20 ( struct V_15 * V_16 , int V_21 )
{
int V_22 = 0 ;
struct V_23 * V_24 ;
long V_25 [ V_26 ] ;
...
V_24 = F_31 ( V_16 -> V_31 ) ;
if ( V_24 != NULL ) {
int V_49 = F_49 ( V_16 , V_24 -> V_48 [ 0 ] ) ;
if ( V_49 == 0 ) {
V_16 -> V_31 = ( unsigned long ) & V_24 -> V_48 [ 0 ] ;
F_48 ( & V_24 -> V_33 ) ;
} else if ( V_49 < 0 ) {
printf ( L_14 ,
( F_50 ( V_24 -> V_48 [ 0 ] ) ? L_15 : L_16 ) ) ;
}
}
}
#endif
...
static struct V_23 * F_31 ( unsigned long V_59 )
{
int V_60 ;
struct V_23 * V_24 ;
V_24 = V_61 ;
...
static struct V_23 * F_24 ( unsigned long V_31 , unsigned long * V_63 )
{
unsigned long V_64 ;
...
if ( V_64 != F_66 ( struct V_23 , V_48 [ 0 ] )
&& V_64 != F_66 ( struct V_23 , V_48 [ 1 ] ) )
return NULL ;
* V_63 = V_64 - F_66 ( struct V_23 , V_48 [ 0 ] ) ;
return (struct V_23 * ) ( V_31 - V_64 ) ;
}
static struct V_23 * F_67 ( unsigned long V_65 )
{
struct V_23 * V_24 ;
V_65 &= ~ 3UL ;
V_24 = F_31 ( V_65 ) ;
...
continue;
if ( F_69 ( V_24 -> V_32 , & V_24 -> V_48 [ 0 ] , 4 ) != 4 ) {
printf ( L_19
L_20 , V_24 -> V_32 ) ;
V_24 -> V_56 = 0 ;
continue;
}
if ( F_70 ( V_24 -> V_48 [ 0 ] ) || F_50 ( V_24 -> V_48 [ 0 ] ) ) {
printf ( L_21
L_22 , V_24 -> V_32 ) ;
V_24 -> V_56 = 0 ;
continue;
...
continue;
if ( F_69 ( V_24 -> V_32 , & V_48 , 4 ) == 4
&& V_48 == V_66
&& F_71 ( V_24 -> V_32 , & V_24 -> V_48 , 4 ) != 4 )
printf ( L_24 ,
V_24 -> V_32 ) ;
else
F_2 ( ( void * ) V_24 -> V_32 ) ;
...
if ( ! V_79 ) {
V_79 = 1 ;
F_76 ( V_51 -> V_80 [ 1 ] , V_51 -> V_81 , V_51 -> V_31 ) ;
}
for(; ; ) {
#ifdef F_21
printf ( L_25 , F_12 () ) ;
...
{
V_16 -> V_19 |= V_47 ;
F_74 ( V_84 , F_105 ( V_84 ) | V_85 | V_86 ) ;
return 1 ;
}
static int F_93 ( struct V_15 * V_16 )
{
...
if ( F_69 ( V_97 + V_60 , & V_96 , 1 ) == 0 ) {
printf ( L_38 V_99 L_32 , V_97 + V_60 ) ;
break;
}
V_95 = F_108 ( V_95 , V_96 ) ;
}
printf ( L_39 , V_95 ) ;
}
static long F_109 ( unsigned long V_100 )
{
unsigned int V_48 ;
V_100 &= ~ 3 ;
if ( ! F_110 ( V_100 ) ) {
...
if ( ! F_69 ( V_100 , & V_48 , sizeof( V_48 ) ) ) {
printf ( L_41 , V_100 ) ;
return 0 ;
}
if ( F_70 ( V_48 ) || F_50 ( V_48 ) ) {
printf ( L_42
L_43 ) ;
return 0 ;
}
...
printf ( L_50 , F_32 ( V_24 ) ) ;
F_33 ( V_24 -> V_32 , L_7 , L_8 ) ;
V_24 -> V_56 = 0 ;
break;
default:
V_82 = V_22 ;
...
if ( ! V_24 -> V_56 )
continue;
printf ( L_57 , F_32 ( V_24 ) ,
( V_24 -> V_56 & V_68 ) ? L_58 : L_59 ) ;
F_33 ( V_24 -> V_32 , L_60 , L_32 ) ;
}
break;
}
if ( ! F_109 ( V_65 ) )
...
static
const char * F_29 ( unsigned long V_105 )
{
char * V_106 ;
switch ( V_105 ) {
...
static void F_112 ( unsigned long V_59 , unsigned long * V_107 ,
unsigned long * V_108 )
{
...
V_58 = 1 ;
F_1 () ;
V_110 = F_113 ( V_59 , & V_109 , & V_27 , NULL , V_112 ) ;
if ( V_110 != NULL ) {
* V_107 = V_59 - V_27 ;
...
static void F_76 ( unsigned long V_113 , unsigned long V_114 ,
unsigned long V_59 )
{
int V_115 = 64 ;
unsigned long V_116 ;
...
if ( ! F_69 ( V_113 + V_120 , & V_116 , sizeof( unsigned long ) )
|| ! F_69 ( V_113 , & V_117 , sizeof( unsigned long ) ) ) {
printf ( L_86 , V_113 ) ;
break;
}
if ( ( V_59 | V_114 ) != 0 ) {
...
unsigned long V_123 ;
int V_124 = 1 ;
F_112 ( V_59 , & V_121 , & V_122 ) ;
V_123 = 0 ;
if ( V_117 > V_113 )
F_69 ( V_117 + V_120 , & V_123 ,
...
if ( F_69 ( V_113 + V_125 , & V_118 , sizeof( unsigned long ) )
&& V_118 == V_126 ) {
if ( F_69 ( V_113 + V_127 , & V_16 , sizeof( V_16 ) )
!= sizeof( V_16 ) ) {
printf ( L_91 ,
V_113 + V_127 ) ;
break;
...
static void F_90 ( struct V_15 * V_51 )
{
unsigned long V_113 ;
if ( F_106 ( & V_113 ) )
F_76 ( V_113 , 0 , 0 ) ;
...
static void F_28 ( struct V_15 * V_132 )
{
unsigned long V_34 ;
#ifdef F_21
printf ( L_95 , F_12 () ) ;
#endif
V_34 = F_30 ( V_132 ) ;
printf ( L_96 , V_132 -> V_34 , F_29 ( V_34 ) , V_132 ) ;
printf ( L_97 ) ;
F_33 ( V_132 -> V_31 , L_98 , L_32 ) ;
printf ( L_99 , V_132 -> V_81 ) ;
F_33 ( V_132 -> V_81 , L_98 , L_32 ) ;
...
static void F_88 ( struct V_15 * V_132 )
{
int V_141 , V_34 ;
unsigned long V_142 ;
struct V_15 V_16 ;
...
#endif
printf ( L_112 ) ;
F_33 ( V_132 -> V_31 , L_7 , L_32 ) ;
if ( F_30 ( V_132 ) != 0xc00 && F_73 ( V_143 ) ) {
printf ( L_113 ) ;
F_33 ( V_132 -> V_144 , L_7 , L_32 ) ;
}
printf ( L_114 ) ;
F_33 ( V_132 -> V_81 , L_7 , L_32 ) ;
...
static void
F_124 ( int V_141 , unsigned long V_153 )
{
unsigned int V_150 [ 2 ] ;
...
F_105 ( V_156 ) , F_105 ( V_157 ) ) ;
printf ( L_126 V_99 L_127 V_99 L_32 ,
F_105 ( V_158 ) , F_105 ( V_159 ) ) ;
printf ( L_128 V_99 L_129 V_99 L_32 , V_113 , F_105 ( V_160 ) ) ;
printf ( L_130 V_99 L_131 V_99 L_32 , V_154 , F_105 ( V_161 ) ) ;
return;
}
F_106 ( & V_162 ) ;
switch ( V_22 ) {
...
F_124 ( V_162 , V_153 ) ;
case 'r' :
printf ( L_132 , V_162 , F_123 ( V_162 ) ) ;
break;
}
F_114 () ;
}
static int
F_69 ( unsigned long V_97 , void * V_163 , int V_109 )
{
volatile int V_141 ;
char * V_1 , * V_164 ;
V_141 = 0 ;
...
static int
F_71 ( unsigned long V_97 , void * V_163 , int V_109 )
{
volatile int V_141 ;
char * V_1 , * V_164 ;
V_141 = 0 ;
...
static void
F_126 ( unsigned char * V_153 , int V_109 )
{
int V_170 ;
switch ( V_109 ) {
case 2 :
F_127 ( V_153 [ 0 ] , V_153 [ 1 ] , V_170 ) ;
break;
case 4 :
F_127 ( V_153 [ 0 ] , V_153 [ 3 ] , V_170 ) ;
F_127 ( V_153 [ 1 ] , V_153 [ 2 ] , V_170 ) ;
break;
case 8 :
F_127 ( V_153 [ 0 ] , V_153 [ 7 ] , V_170 ) ;
F_127 ( V_153 [ 1 ] , V_153 [ 6 ] , V_170 ) ;
F_127 ( V_153 [ 2 ] , V_153 [ 5 ] , V_170 ) ;
F_127 ( V_153 [ 3 ] , V_153 [ 4 ] , V_170 ) ;
break;
}
}
static void
...
printf ( L_140 , 16 , L_141 , F_131 ( V_29 ) ? L_142 : L_143 ) ;
printf ( L_140 , 16 , L_144 , F_132 ( V_29 ) ? L_142 : L_143 ) ;
printf ( L_140 , 16 , L_145 , F_133 ( V_29 ) ? L_142 : L_143 ) ;
#define F_134 ( V_185 , V_110 , T_2 ) \
printf(" %-*s = %#-*"format"\t(0x%lx)\n", 16, #name, 18, paca->name, \
offsetof(struct paca_struct, name));
F_134 ( V_1 , V_186 , L_146 ) ;
F_134 ( V_1 , V_187 , L_146 ) ;
F_134 ( V_1 , V_188 , L_147 ) ;
F_134 ( V_1 , V_189 , L_147 ) ;
F_134 ( V_1 , V_190 , L_147 ) ;
F_134 ( V_1 , V_191 , L_148 ) ;
#ifdef F_135
F_134 ( V_1 , V_192 , L_148 ) ;
F_134 ( V_1 , V_193 , L_146 ) ;
#endif
F_134 ( V_1 , V_194 , L_147 ) ;
F_134 ( V_1 , V_195 , L_146 ) ;
F_134 ( V_1 , V_196 , L_146 ) ;
F_134 ( V_1 , V_197 , L_146 ) ;
F_134 ( V_1 , V_198 , L_148 ) ;
F_134 ( V_1 , V_199 , L_147 ) ;
F_134 ( V_1 , V_200 , L_147 ) ;
F_134 ( V_1 , V_201 , L_147 ) ;
F_134 ( V_1 , V_202 , L_146 ) ;
F_134 ( V_1 , V_137 , L_146 ) ;
F_134 ( V_1 , V_138 , L_146 ) ;
F_134 ( V_1 , V_203 , L_146 ) ;
F_134 ( V_1 , V_204 , L_146 ) ;
F_134 ( V_1 , V_205 , L_146 ) ;
#undef F_134
V_58 = 0 ;
F_1 () ;
}
...
static void
F_140 ( unsigned long V_97 , long V_179 )
{
...
static int
F_141 ( unsigned long V_209 , long V_210 , int V_211 ,
T_3 V_212 )
{
int V_182 , V_213 ;
unsigned long V_214 ;
...
static int
F_42 ( unsigned long V_209 , long V_210 , int V_211 )
{
return F_141 ( V_209 , V_210 , V_211 , V_218 ) ;
}
void
F_143 ( unsigned long V_100 )
{
F_33 ( V_100 , L_159 , L_84 ) ;
}
void
F_139 ( void )
{
...
F_1 () ;
F_144 ( & V_220 ) ;
while ( F_145 ( & V_220 , false , V_163 , sizeof( V_163 ) , & V_73 ) ) {
V_163 [ V_73 ] = '\0' ;
printf ( L_137 , V_163 ) ;
}
F_1 () ;
...
V_82 = 0 ;
F_106 ( ( void * ) & V_226 ) ;
F_146 ( ( unsigned char * ) V_222 , ( unsigned char * ) V_224 , V_225 , V_226 ) ;
break;
}
}
static void
F_146 ( unsigned char * V_227 , unsigned char * V_228 , unsigned V_229 , unsigned V_230 )
{
...
if ( F_69 ( V_65 , V_153 , 4 ) == 4
&& ( ( F_142 ( V_153 ) ^ V_223 ) & V_233 ) == 0 ) {
printf ( L_164 , V_65 , F_142 ( V_153 ) ) ;
if ( ++ V_141 >= 10 )
break;
}
}
...
if ( F_150 ( line , sizeof( line ) ) == NULL ) {
V_244 = NULL ;
return V_50 ;
}
V_244 = line ;
...
static void F_33 ( unsigned long V_32 , const char * V_247 ,
const char * V_248 )
{
char * V_249 ;
...
V_58 = 1 ;
F_1 () ;
V_110 = F_113 ( V_32 , & V_109 , & V_27 , & V_249 ,
V_112 ) ;
F_1 () ;
F_121 ( 200 ) ;
}
...
V_166 V_295 = F_154 ( V_278 ) ;
V_166 V_296 = F_155 ( V_297 ) ;
V_167 V_298 = 0 ;
V_167 V_299 ;
...
void F_165 ( struct V_335 * V_336 )
{
struct V_337 * V_337 ;
F_166 (spu, list, full_list) {
...
F_1 () ;
V_337 = V_340 [ V_60 ] . V_337 ;
F_171 ( V_337 , V_340 [ V_60 ] . V_347 ) ;
F_173 ( & V_337 -> V_345 -> V_346 ,
V_340 [ V_60 ] . V_344 ) ;
F_1 () ;
F_121 ( 200 ) ;
printf ( L_237 , V_60 ) ;
...
static void F_174 ( struct V_337 * V_337 )
{
printf ( L_239 , V_337 ) ;
F_175 ( V_337 , L_240 , V_338 ) ;
F_175 ( V_337 , L_137 , V_110 ) ;
F_175 ( V_337 , L_241 , V_349 ) ;
F_175 ( V_337 , L_242 , V_343 ) ;
F_175 ( V_337 , L_241 , V_350 ) ;
F_175 ( V_337 , L_240 , V_351 ) ;
F_175 ( V_337 , L_241 , V_28 ) ;
F_175 ( V_337 , L_243 , V_352 ) ;
F_175 ( V_337 , L_241 , V_353 ) ;
F_175 ( V_337 , L_241 , V_354 ) ;
F_175 ( V_337 , L_241 , V_355 ) ;
F_175 ( V_337 , L_241 , V_356 [ 0 ] ) ;
F_175 ( V_337 , L_241 , V_356 [ 1 ] ) ;
F_175 ( V_337 , L_241 , V_356 [ 2 ] ) ;
F_175 ( V_337 , L_240 , V_357 ) ;
F_175 ( V_337 , L_243 , V_139 ) ;
F_175 ( V_337 , L_242 , V_358 ) ;
F_175 ( V_337 , L_242 , V_359 ) ;
F_175 ( V_337 , L_242 , V_360 ) ;
F_175 ( V_337 , L_242 , V_361 ) ;
F_175 ( V_337 , L_241 , V_362 ) ;
F_175 ( V_337 , L_242 , V_345 ) ;
F_176 ( L_240 , V_345 -> V_346 ,
F_169 ( & V_337 -> V_345 -> V_346 ) ) ;
F_176 ( L_240 , V_345 -> V_363 ,
F_169 ( & V_337 -> V_345 -> V_363 ) ) ;
F_176 ( L_240 , V_345 -> V_364 ,
F_169 ( & V_337 -> V_345 -> V_364 ) ) ;
F_175 ( V_337 , L_242 , V_365 ) ;
F_175 ( V_337 , L_242 , V_366 ) ;
}
int
F_177 ( unsigned long V_209 , long V_210 , int V_211 )
{
return F_141 ( V_209 , V_210 , V_211 , V_367 ) ;
}
static void F_178 ( unsigned long V_206 , int V_368 )
{
