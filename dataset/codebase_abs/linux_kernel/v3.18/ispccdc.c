...
if ( F_82 ( V_2 , 1000 ) ) {
F_92 ( V_4 -> V_5 , L_16 ) ;
V_4 -> V_386 |= 1U << V_2 -> V_202 . V_203 . V_387 ;
F_93 ( V_201 ) ;
return 0 ;
}
if ( ! F_90 ( V_2 ) )
return 1 ;
V_383 = F_94 ( & V_2 -> V_329 ) ;
if ( V_383 != NULL )
...
int F_99 ( struct V_1 * V_2 , T_3 V_369 )
{
if ( V_2 -> V_95 == V_193 )
return 0 ;
if ( V_369 & V_391 )
...
static int F_100 ( struct V_393 * V_289 , struct V_382 * V_383 )
{
...
static long F_101 ( struct V_270 * V_395 , unsigned int V_396 , void * V_397 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
int V_120 ;
switch ( V_396 ) {
case V_398 :
F_77 ( & V_2 -> V_343 ) ;
V_120 = F_55 ( V_2 , V_397 ) ;
F_79 ( & V_2 -> V_343 ) ;
break;
default:
return - V_399 ;
...
static int F_103 ( struct V_270 * V_395 , struct V_400 * V_401 ,
struct V_402 * V_403 )
{
if ( V_403 -> type != V_365 )
return - V_57 ;
if ( V_403 -> V_387 != 0 )
return - V_57 ;
return F_104 ( V_401 , V_403 , V_404 , NULL ) ;
}
static int F_105 ( struct V_270 * V_395 , struct V_400 * V_401 ,
struct V_402 * V_403 )
{
return F_106 ( V_401 , V_403 ) ;
}
static int F_107 ( struct V_270 * V_395 , int V_86 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_120 = 0 ;
...
static struct V_44 *
F_8 ( struct V_1 * V_2 , struct V_407 * V_401 ,
unsigned int V_280 , enum V_408 V_297 )
{
if ( V_297 == V_409 )
return F_110 ( V_401 , V_280 ) ;
else
return & V_2 -> V_171 [ V_280 ] ;
}
static struct V_272 *
F_111 ( struct V_1 * V_2 , struct V_407 * V_401 ,
enum V_408 V_297 )
{
if ( V_297 == V_409 )
return F_112 ( V_401 , V_318 ) ;
else
return & V_2 -> V_273 ;
}
static void
F_113 ( struct V_1 * V_2 , struct V_407 * V_401 ,
...
switch ( V_280 ) {
case V_61 :
for ( V_413 = 0 ; V_413 < F_114 ( V_414 ) ; V_413 ++ ) {
if ( V_410 -> V_87 == V_414 [ V_413 ] )
break;
}
if ( V_413 >= F_114 ( V_414 ) )
V_410 -> V_87 = V_88 ;
V_410 -> V_63 = F_115 ( T_3 , V_63 , 32 , 4096 ) ;
V_410 -> V_64 = F_115 ( T_3 , V_64 , 32 , 4096 ) ;
if ( V_410 -> V_231 == V_415 )
V_410 -> V_231 = V_375 ;
break;
case V_318 :
V_412 = V_410 -> V_87 ;
V_231 = V_410 -> V_231 ;
* V_410 = * F_8 ( V_2 , V_401 , V_61 , V_297 ) ;
if ( V_410 -> V_87 == V_249 ||
V_410 -> V_87 == V_250 ) {
if ( V_412 == V_249 ||
V_412 == V_250 ||
...
V_410 -> V_87 = V_169 -> V_417 ;
if ( V_410 -> V_87 == V_249 ||
V_410 -> V_87 == V_250 )
V_410 -> V_87 = 0 ;
V_410 -> V_63 = F_115 ( T_3 , V_63 , 32 , V_410 -> V_63 ) ;
V_410 -> V_64 = F_115 ( T_3 , V_64 , 32 , V_410 -> V_64 - 1 ) ;
break;
}
V_410 -> V_418 = V_419 ;
}
static void F_116 ( struct V_1 * V_2 ,
const struct V_44 * V_420 ,
struct V_272 * V_273 )
{
const struct V_168 * V_169 ;
unsigned int V_421 ;
V_169 = F_53 ( V_420 -> V_87 ) ;
if ( V_169 -> V_422 != V_423 ) {
V_273 -> V_319 &= ~ 1 ;
V_273 -> V_323 &= ~ 1 ;
}
V_273 -> V_319 = F_115 ( T_3 , V_273 -> V_319 , 0 , V_420 -> V_63 - V_424 ) ;
V_273 -> V_323 = F_115 ( T_3 , V_273 -> V_323 , 0 , V_420 -> V_64 - V_425 ) ;
V_421 = ( V_420 -> V_63 - V_273 -> V_319 + 15 ) & ~ 15 ;
V_273 -> V_63 = F_115 ( T_3 , V_273 -> V_63 , V_424 , V_421 )
& ~ 15 ;
V_273 -> V_64 = F_115 ( T_3 , V_273 -> V_64 , V_425 ,
V_420 -> V_64 - V_273 -> V_323 ) ;
if ( V_169 -> V_422 != V_423 ) {
V_273 -> V_63 &= ~ 1 ;
V_273 -> V_64 &= ~ 1 ;
}
}
static int F_117 ( struct V_270 * V_395 ,
struct V_407 * V_401 ,
struct V_426 * V_87 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
...
switch ( V_87 -> V_280 ) {
case V_61 :
if ( V_87 -> V_296 >= F_114 ( V_414 ) )
return - V_57 ;
V_87 -> V_87 = V_414 [ V_87 -> V_296 ] ;
break;
case V_318 :
V_45 = F_8 ( V_2 , V_401 , V_87 -> V_280 ,
V_409 ) ;
if ( V_45 -> V_87 == V_249 ||
V_45 -> V_87 == V_250 ) {
if ( V_87 -> V_296 == 0 )
...
static int F_118 ( struct V_270 * V_395 ,
struct V_407 * V_401 ,
struct V_427 * V_428 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
...
if ( V_428 -> V_296 != 0 )
return - V_57 ;
V_45 . V_87 = V_428 -> V_87 ;
V_45 . V_63 = 1 ;
V_45 . V_64 = 1 ;
F_113 ( V_2 , V_401 , V_428 -> V_280 , & V_45 , V_409 ) ;
V_428 -> V_50 = V_45 . V_63 ;
V_428 -> V_51 = V_45 . V_64 ;
if ( V_45 . V_87 != V_428 -> V_87 )
return - V_57 ;
V_45 . V_87 = V_428 -> V_87 ;
V_45 . V_63 = - 1 ;
V_45 . V_64 = - 1 ;
F_113 ( V_2 , V_401 , V_428 -> V_280 , & V_45 , V_409 ) ;
V_428 -> V_421 = V_45 . V_63 ;
V_428 -> V_429 = V_45 . V_64 ;
return 0 ;
}
static int F_119 ( struct V_270 * V_395 , struct V_407 * V_401 ,
struct V_430 * V_431 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
if ( V_431 -> V_280 != V_318 )
return - V_57 ;
switch ( V_431 -> V_432 ) {
case V_433 :
V_431 -> V_434 . V_319 = 0 ;
V_431 -> V_434 . V_323 = 0 ;
V_431 -> V_434 . V_63 = V_435 ;
V_431 -> V_434 . V_64 = V_435 ;
V_45 = F_8 ( V_2 , V_401 , V_61 , V_431 -> V_297 ) ;
F_116 ( V_2 , V_45 , & V_431 -> V_434 ) ;
break;
case V_436 :
V_431 -> V_434 = * F_111 ( V_2 , V_401 , V_431 -> V_297 ) ;
break;
default:
return - V_57 ;
}
...
static int F_120 ( struct V_270 * V_395 , struct V_407 * V_401 ,
struct V_430 * V_431 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
if ( V_431 -> V_432 != V_436 ||
V_431 -> V_280 != V_318 )
return - V_57 ;
if ( V_2 -> V_95 != V_193 )
return - V_103 ;
if ( V_431 -> V_110 & V_437 ) {
V_431 -> V_434 = * F_111 ( V_2 , V_401 , V_431 -> V_297 ) ;
return 0 ;
}
V_45 = F_8 ( V_2 , V_401 , V_61 , V_431 -> V_297 ) ;
F_116 ( V_2 , V_45 , & V_431 -> V_434 ) ;
* F_111 ( V_2 , V_401 , V_431 -> V_297 ) = V_431 -> V_434 ;
V_45 = F_8 ( V_2 , V_401 , V_318 , V_431 -> V_297 ) ;
F_113 ( V_2 , V_401 , V_318 , V_45 , V_431 -> V_297 ) ;
return 0 ;
}
static int F_121 ( struct V_270 * V_395 , struct V_407 * V_401 ,
struct V_275 * V_410 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
V_45 = F_8 ( V_2 , V_401 , V_410 -> V_280 , V_410 -> V_297 ) ;
if ( V_45 == NULL )
return - V_57 ;
V_410 -> V_45 = * V_45 ;
return 0 ;
}
static int F_122 ( struct V_270 * V_395 , struct V_407 * V_401 ,
struct V_275 * V_410 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_44 * V_45 ;
...
if ( V_45 == NULL )
return - V_57 ;
F_113 ( V_2 , V_401 , V_410 -> V_280 , & V_410 -> V_45 , V_410 -> V_297 ) ;
* V_45 = V_410 -> V_45 ;
if ( V_410 -> V_280 == V_61 ) {
V_273 = F_111 ( V_2 , V_401 , V_410 -> V_297 ) ;
V_273 -> V_319 = 0 ;
V_273 -> V_323 = 0 ;
V_273 -> V_63 = V_410 -> V_45 . V_63 ;
V_273 -> V_64 = V_410 -> V_45 . V_64 ;
F_116 ( V_2 , & V_410 -> V_45 , V_273 ) ;
V_45 = F_8 ( V_2 , V_401 , V_318 ,
V_410 -> V_297 ) ;
* V_45 = V_410 -> V_45 ;
F_113 ( V_2 , V_401 , V_318 , V_45 ,
V_410 -> V_297 ) ;
V_45 = F_8 ( V_2 , V_401 , V_210 ,
V_410 -> V_297 ) ;
* V_45 = V_410 -> V_45 ;
F_113 ( V_2 , V_401 , V_210 , V_45 ,
V_410 -> V_297 ) ;
}
return 0 ;
}
static bool F_123 ( enum V_411 V_438 ,
enum V_411 V_439 ,
unsigned int V_440 )
{
const struct V_168 * V_441 , * V_442 ;
if ( V_438 == V_439 )
return true ;
V_441 = F_53 ( V_438 ) ;
V_442 = F_53 ( V_439 ) ;
if ( ( V_441 -> V_422 == 0 ) || ( V_442 -> V_422 == 0 ) )
return false ;
if ( V_441 -> V_422 != V_442 -> V_422 )
return false ;
return V_441 -> V_63 - V_442 -> V_63 + V_440 <= 6 ;
}
static int F_124 ( struct V_270 * V_395 ,
struct V_443 * V_444 ,
struct V_275 * V_445 ,
struct V_275 * V_446 )
{
struct V_1 * V_2 = F_102 ( V_395 ) ;
unsigned long V_447 ;
if ( V_445 -> V_45 . V_63 != V_446 -> V_45 . V_63 ||
V_445 -> V_45 . V_64 != V_446 -> V_45 . V_64 )
return - V_448 ;
if ( V_2 -> V_225 == V_243 ) {
struct V_244 * V_245 =
& ( (struct V_292 * )
F_69 ( V_444 -> V_449 -> V_203 )
-> V_293 ) -> V_294 . V_295 ;
V_447 = V_245 -> V_450 * 2 ;
} else {
V_447 = 0 ;
}
if ( ! F_123 ( V_445 -> V_45 . V_87 ,
V_446 -> V_45 . V_87 , V_447 ) )
return - V_448 ;
return 0 ;
}
static int F_125 ( struct V_270 * V_395 , struct V_407 * V_401 )
{
struct V_275 V_45 ;
memset ( & V_45 , 0 , sizeof( V_45 ) ) ;
V_45 . V_280 = V_61 ;
V_45 . V_297 = V_401 ? V_409 : V_62 ;
V_45 . V_45 . V_87 = V_88 ;
V_45 . V_45 . V_63 = 4096 ;
V_45 . V_45 . V_64 = 4096 ;
F_122 ( V_395 , V_401 , & V_45 ) ;
return 0 ;
}
static int F_126 ( struct V_451 * V_203 ,
const struct V_279 * V_452 ,
const struct V_279 * V_453 , T_3 V_110 )
{
struct V_270 * V_395 = F_69 ( V_203 ) ;
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_452 -> V_296 | F_127 ( V_453 -> V_203 ) ) {
case V_61 | V_454 :
if ( ! ( V_110 & V_455 ) ) {
V_2 -> V_225 = V_456 ;
break;
...
if ( V_2 -> V_225 != V_456 )
return - V_103 ;
if ( V_453 -> V_203 == & V_4 -> V_457 . V_202 . V_203 )
V_2 -> V_225 = V_458 ;
else if ( V_453 -> V_203 == & V_4 -> V_459 . V_202 . V_203 )
V_2 -> V_225 = V_460 ;
else if ( V_453 -> V_203 == & V_4 -> V_461 . V_202 . V_203 )
V_2 -> V_225 = V_462 ;
else
V_2 -> V_225 = V_243 ;
break;
...
{
int V_120 ;
V_120 = F_132 ( V_361 , & V_2 -> V_202 ) ;
if ( V_120 < 0 )
goto error;
V_120 = F_133 ( & V_2 -> V_329 , V_361 ) ;
if ( V_120 < 0 )
goto error;
return 0 ;
error:
...
{
struct V_270 * V_395 = & V_2 -> V_202 ;
struct V_279 * V_287 = V_2 -> V_287 ;
struct V_451 * V_466 = & V_395 -> V_203 ;
int V_120 ;
V_2 -> V_225 = V_456 ;
F_135 ( V_395 , & V_467 ) ;
V_395 -> V_468 = & V_469 ;
F_136 ( V_395 -> V_470 , L_17 , sizeof( V_395 -> V_470 ) ) ;
V_395 -> V_471 = 1 << 16 ;
F_137 ( V_395 , V_2 ) ;
V_395 -> V_110 |= V_472 | V_473 ;
V_287 [ V_61 ] . V_110 = V_474
| V_475 ;
V_287 [ V_210 ] . V_110 = V_476 ;
V_287 [ V_318 ] . V_110 = V_476 ;
V_466 -> V_477 = & V_478 ;
V_120 = F_138 ( V_466 , V_479 , V_287 , 0 ) ;
if ( V_120 < 0 )
return V_120 ;
F_125 ( V_395 , NULL ) ;
V_2 -> V_329 . type = V_480 ;
V_2 -> V_329 . V_477 = & V_481 ;
V_2 -> V_329 . V_4 = F_2 ( V_2 ) ;
V_2 -> V_329 . V_482 = F_139 ( 4096 * 4096 ) * 3 ;
V_2 -> V_329 . V_483 = 32 ;
V_120 = F_140 ( & V_2 -> V_329 , L_18 ) ;
if ( V_120 < 0 )
goto V_484;
V_120 = F_141 ( & V_2 -> V_202 . V_203 , V_318 ,
& V_2 -> V_329 . V_289 . V_203 , 0 , 0 ) ;
if ( V_120 < 0 )
goto V_485;
return 0 ;
V_485:
