...
static unsigned int F_49 ( struct V_9 * V_10 )
{
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
return F_4 ( V_19 ) ? 1 << 28 : 1 << 27 ;
}
static void F_50 ( struct V_9 * V_10 , struct V_132 * V_81 )
{
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
F_51 ( V_10 , F_4 ( V_19 ) ? 0xF : 0xE ,
V_172 ) ;
}
static int
F_52 ( struct V_173 * V_174 ,
struct V_99 * V_100 )
{
struct V_175 * V_176 = V_174 -> V_177 . V_178 ;
if ( ! V_176 )
return - V_179 ;
if ( F_53 ( V_176 , L_7 , NULL ) )
V_100 -> V_180 = V_181 ;
if ( F_53 ( V_176 , L_8 , NULL ) )
V_100 -> V_180 = V_182 ;
if ( F_53 ( V_176 , L_9 , NULL ) )
V_100 -> V_113 = V_115 ;
V_100 -> V_183 = F_54 ( V_176 , L_10 , 0 ) ;
if ( F_55 ( V_100 -> V_183 ) )
V_100 -> V_180 = V_184 ;
V_100 -> V_185 = F_54 ( V_176 , L_11 , 0 ) ;
if ( F_55 ( V_100 -> V_185 ) )
V_100 -> V_113 = V_114 ;
F_56 ( V_176 , L_12 , & V_100 -> V_186 ) ;
F_56 ( V_176 , L_13 , & V_100 -> V_101 ) ;
if ( F_57 ( V_176 , L_14 , NULL ) )
V_100 -> V_187 = false ;
else
V_100 -> V_187 = true ;
if ( F_56 ( V_176 , L_15 , & V_100 -> V_167 ) )
V_100 -> V_167 = 0 ;
return 0 ;
}
static inline int
...
F_59 ( V_190 , & V_174 -> V_177 ) ;
struct V_17 * V_18 ;
struct V_9 * V_10 ;
struct V_99 * V_100 ;
int V_191 ;
struct V_1 * V_19 ;
V_10 = F_60 ( V_174 , & V_192 , 0 ) ;
if ( F_44 ( V_10 ) )
return F_61 ( V_10 ) ;
V_18 = F_9 ( V_10 ) ;
V_19 = F_62 ( & V_174 -> V_177 , sizeof( * V_19 ) , V_146 ) ;
if ( ! V_19 ) {
V_191 = - V_147 ;
goto V_193;
}
V_19 -> V_3 = V_189 ? V_189 -> V_2 : (struct V_194 * )
V_174 -> V_195 -> V_196 ;
V_18 -> V_20 = V_19 ;
V_19 -> V_197 = F_63 ( & V_174 -> V_177 , L_16 ) ;
if ( F_44 ( V_19 -> V_197 ) ) {
V_191 = F_61 ( V_19 -> V_197 ) ;
goto V_193;
}
V_19 -> V_198 = F_63 ( & V_174 -> V_177 , L_17 ) ;
if ( F_44 ( V_19 -> V_198 ) ) {
V_191 = F_61 ( V_19 -> V_198 ) ;
goto V_193;
}
V_19 -> V_199 = F_63 ( & V_174 -> V_177 , L_18 ) ;
if ( F_44 ( V_19 -> V_199 ) ) {
V_191 = F_61 ( V_19 -> V_199 ) ;
goto V_193;
}
V_18 -> V_200 = V_19 -> V_199 ;
V_18 -> clock = F_64 ( V_18 -> V_200 ) ;
F_65 ( V_19 -> V_199 ) ;
F_65 ( V_19 -> V_197 ) ;
F_65 ( V_19 -> V_198 ) ;
V_19 -> V_153 = F_66 ( & V_174 -> V_177 ) ;
if ( F_44 ( V_19 -> V_153 ) ) {
V_191 = F_61 ( V_19 -> V_153 ) ;
goto V_201;
}
V_19 -> V_154 = F_67 ( V_19 -> V_153 ,
V_202 ) ;
if ( F_44 ( V_19 -> V_154 ) ) {
V_191 = F_61 ( V_19 -> V_154 ) ;
F_68 ( F_23 ( V_10 -> V_105 ) , L_19 ) ;
goto V_201;
}
V_10 -> V_203 |= V_204 ;
if ( V_19 -> V_3 -> V_7 & V_205 )
V_10 -> V_203 |= V_206
| V_207 ;
if ( F_4 ( V_19 ) ) {
F_6 ( 0x08100810 , V_10 -> V_15 + V_208 ) ;
V_10 -> V_209 |= V_210 ;
V_10 -> V_105 -> V_211 |= V_212 ;
}
if ( V_19 -> V_3 -> V_7 & V_63 )
V_213 . V_214 =
F_39 ;
if ( V_19 -> V_3 -> V_7 & V_65 )
F_6 ( F_7 ( V_10 -> V_15 + V_215 ) |
V_216 | V_217 ,
V_10 -> V_15 + V_215 ) ;
V_100 = & V_19 -> V_100 ;
if ( F_52 ( V_174 , V_100 ) < 0 ) {
if ( ! V_10 -> V_105 -> V_125 -> V_218 ) {
F_68 ( F_23 ( V_10 -> V_105 ) , L_20 ) ;
V_191 = - V_157 ;
goto V_201;
}
V_19 -> V_100 = * ( (struct V_99 * )
V_10 -> V_105 -> V_125 -> V_218 ) ;
}
if ( V_100 -> V_113 == V_114 ) {
V_191 = F_69 ( V_10 -> V_105 , V_100 -> V_185 ) ;
if ( V_191 ) {
F_68 ( F_23 ( V_10 -> V_105 ) ,
L_21 ) ;
goto V_201;
}
V_10 -> V_105 -> V_219 |= V_220 ;
}
switch ( V_100 -> V_180 ) {
case V_184 :
V_191 = F_70 ( V_10 -> V_105 , V_100 -> V_183 , 0 ) ;
if ( V_191 ) {
F_68 ( F_23 ( V_10 -> V_105 ) ,
L_22 ) ;
goto V_201;
...
switch ( V_100 -> V_186 ) {
case 8 :
V_10 -> V_105 -> V_211 |= V_224 | V_225 ;
break;
case 4 :
V_10 -> V_105 -> V_211 |= V_225 ;
break;
case 1 :
default:
V_10 -> V_203 |= V_226 ;
...
if ( ( V_100 -> V_187 ) && F_4 ( V_19 ) ) {
V_19 -> V_155 = F_67 ( V_19 -> V_153 ,
V_227 ) ;
V_19 -> V_156 = F_67 ( V_19 -> V_153 ,
V_228 ) ;
if ( F_44 ( V_19 -> V_155 ) ||
F_44 ( V_19 -> V_156 ) ) {
F_71 ( F_23 ( V_10 -> V_105 ) ,
L_23 ) ;
V_10 -> V_209 |= V_229 ;
}
} else {
...
{
struct V_9 * V_10 = F_81 ( V_174 ) ;
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
int V_230 = ( F_7 ( V_10 -> V_15 + V_36 ) == 0xffffffff ) ;
F_82 ( V_10 , V_230 ) ;
F_83 ( & V_174 -> V_177 ) ;
F_84 ( & V_174 -> V_177 ) ;
if ( ! F_85 ( V_231 ) ) {
...
static int F_86 ( struct V_232 * V_177 )
{
struct V_9 * V_10 = F_87 ( V_177 ) ;
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
int V_57 ;
V_57 = F_88 ( V_10 ) ;
...
static int F_90 ( struct V_232 * V_177 )
{
struct V_9 * V_10 = F_87 ( V_177 ) ;
struct V_17 * V_18 = F_9 ( V_10 ) ;
struct V_1 * V_19 = V_18 -> V_20 ;
