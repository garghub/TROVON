...
case V_497 :
if ( sin )
V_41 = sprintf ( V_413 , L_124 , F_21 ( sin -> V_498 ) ) ;
else
...
break;
case V_500 :
V_41 = sprintf ( V_413 , L_123 , V_2 -> V_501 ) ;
break;
case V_502 :
V_41 = sprintf ( V_413 , L_123 , V_2 -> V_503 ) ;
break;
case V_438 :
...
break;
case V_505 :
V_41 = sprintf ( V_413 , L_3 , V_2 -> V_506 ) ;
break;
case V_507 :
V_41 = sprintf ( V_413 , L_3 , V_2 -> V_508 ) ;
break;
case V_497 :
