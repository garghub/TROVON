...
F_46 ( V_112 ) ;
if ( V_110 -> V_126 ) {
V_121 = F_47 ( V_110 -> V_126 ) ;
if ( V_4 == 0 ) {
F_48 ( & V_110 -> V_126 -> V_127 ) ;
F_49 ( V_110 -> V_126 ) ;
F_50 ( & V_110 -> V_126 -> V_127 ) ;
}
V_121 -> time = 0 ;
}
V_122:
...
void *
F_53 ( struct V_109 * V_112 , struct V_128 * V_129 )
{
struct V_111 * V_111 = V_112 -> V_126 ;
int V_4 = - V_14 ;
unsigned int V_39 ;
char * V_130 = NULL ;
char * V_131 = NULL ;
...
if ( ! V_130 )
goto V_47;
F_5 ( V_30 , L_8 , V_130 , V_111 ) ;
V_4 = - V_113 ;
if ( V_43 -> V_132 & V_133 )
V_4 = F_20 ( V_39 , V_41 , V_43 , V_130 ,
& V_131 ) ;
if ( V_4 != 0 && V_49 -> V_50 -> V_134 )
V_4 = V_49 -> V_50 -> V_134 ( V_39 , V_41 , V_130 ,
& V_131 , V_43 ) ;
F_12 ( V_130 ) ;
V_47:
if ( V_4 != 0 ) {
...
int
F_56 ( struct V_111 * V_111 , struct V_109 * V_112 , const char * V_135 )
{
int V_4 = - V_51 ;
unsigned int V_39 ;
struct V_42 * V_43 = F_39 ( V_111 -> V_116 ) ;
...
F_5 ( V_30 , L_10 , V_135 ) ;
if ( V_43 -> V_132 & V_133 )
V_4 = F_19 ( V_39 , V_136 , V_43 , V_130 , V_135 ) ;
else if ( V_136 -> V_123 )
V_4 = F_57 ( V_39 , V_136 , V_130 , V_135 ,
V_43 -> V_124 ) ;
if ( V_4 == 0 ) {
if ( V_136 -> V_123 )
V_4 = F_58 ( & V_137 , V_130 ,
V_111 -> V_116 , V_39 ) ;
else
V_4 = F_59 ( & V_137 , V_130 , NULL ,
