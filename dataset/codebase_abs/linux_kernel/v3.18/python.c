...
T_2 * V_119 = F_52 ( 0 ) ;
int V_59 ;
for ( V_59 = 0 ; V_59 < V_113 -> V_120 . V_58 ; ++ V_59 ) {
T_2 * V_121 ;
T_7 * V_122 = fdopen ( V_113 -> V_120 . V_123 [ V_59 ] . V_124 , L_68 ) ;
if ( V_122 == NULL )
goto V_125;
V_121 = F_53 ( V_122 , L_69 , L_68 , NULL ) ;
if ( V_121 == NULL )
goto V_125;
if ( F_54 ( V_119 , V_121 ) != 0 ) {
F_55 ( V_121 ) ;
goto V_125;
}
F_55 ( V_121 ) ;
