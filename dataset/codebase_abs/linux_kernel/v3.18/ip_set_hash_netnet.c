...
if ( V_49 [ V_23 ] ) {
T_1 V_68 = F_27 ( V_49 [ V_23 ] ) ;
if ( V_68 & V_11 )
V_10 |= ( V_11 << 16 ) ;
}
if ( V_32 == V_44 || ! ( V_49 [ V_69 ] ||
V_49 [ V_70 ] ) ) {
...
V_52 = V_13 ;
if ( V_49 [ V_69 ] ) {
V_58 = F_24 ( V_49 [ V_69 ] , & V_52 ) ;
if ( V_58 )
return V_58 ;
if ( V_52 < V_13 )
F_5 ( V_13 , V_52 ) ;
if ( F_21 ( V_13 + V_71 == V_52 ) )
return - V_72 ;
} else
F_31 ( V_13 , V_52 , V_39 . V_14 [ 0 ] ) ;
V_55 = V_54 ;
if ( V_49 [ V_70 ] ) {
V_58 = F_24 ( V_49 [ V_70 ] , & V_55 ) ;
if ( V_58 )
return V_58 ;
if ( V_55 < V_54 )
F_5 ( V_54 , V_55 ) ;
if ( F_21 ( V_54 + V_71 == V_55 ) )
return - V_72 ;
} else
...
static inline bool
F_35 ( const struct V_73 * V_2 ,
const struct V_73 * V_3 ,
T_1 * V_4 )
{
return F_36 ( & V_2 -> V_13 [ 0 ] . V_74 , & V_3 -> V_13 [ 0 ] . V_74 ) &&
F_36 ( & V_2 -> V_13 [ 1 ] . V_74 , & V_3 -> V_13 [ 1 ] . V_74 ) &&
V_2 -> V_6 == V_3 -> V_6 ;
}
static inline int
F_37 ( const struct V_73 * V_7 )
{
return V_7 -> V_8 ? - V_9 : 1 ;
}
static inline void
F_38 ( struct V_73 * V_7 , T_1 V_10 )
{
V_7 -> V_8 = ( V_10 >> 16 ) & V_11 ;
}
static inline void
F_39 ( struct V_73 * V_7 , T_2 * V_10 )
{
F_5 ( * V_10 , V_7 -> V_8 ) ;
}
static inline void
F_40 ( struct V_73 * V_7 ,
struct V_73 * V_12 )
{
V_7 -> V_13 [ 1 ] = V_12 -> V_13 [ 1 ] ;
}
static inline void
F_41 ( struct V_73 * V_7 , T_2 V_14 , bool V_15 )
{
if ( V_15 ) {
...
const struct V_73 * V_18 )
{
T_1 V_10 = V_18 -> V_8 ? V_11 : 0 ;
if ( F_44 ( V_17 , V_19 , & V_18 -> V_13 [ 0 ] . V_74 ) ||
F_44 ( V_17 , V_20 , & V_18 -> V_13 [ 1 ] . V_74 ) ||
F_11 ( V_17 , V_21 , V_18 -> V_14 [ 0 ] ) ||
F_11 ( V_17 , V_22 , V_18 -> V_14 [ 1 ] ) ||
( V_10 &&
F_12 ( V_17 , V_23 , F_13 ( V_10 ) ) ) )
...
F_47 ( V_17 , V_34 -> V_10 & V_45 , & V_39 . V_13 [ 0 ] . V_74 ) ;
F_47 ( V_17 , V_34 -> V_10 & V_46 , & V_39 . V_13 [ 1 ] . V_74 ) ;
...
! F_22 ( V_49 , V_64 ) ) )
return - V_65 ;
if ( F_21 ( V_49 [ V_69 ] || V_49 [ V_70 ] ) )
return - V_75 ;
if ( V_49 [ V_66 ] )
* V_50 = F_23 ( V_49 [ V_66 ] ) ;
V_58 = F_49 ( V_49 [ V_19 ] , & V_39 . V_13 [ 0 ] ) ||
F_49 ( V_49 [ V_20 ] , & V_39 . V_13 [ 1 ] ) ||
F_25 ( V_28 , V_49 , & V_41 ) ;
if ( V_58 )
return V_58 ;
if ( V_49 [ V_21 ] )
