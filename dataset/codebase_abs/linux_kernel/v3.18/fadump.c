...
static inline int F_36 ( T_3 V_72 )
{
int V_6 = - 1 ;
char V_68 [ 3 ] ;
if ( ( V_72 & V_73 ) == F_37 ( L_35 ) ) {
V_72 &= ~ V_73 ;
V_72 >>= 24 ;
V_68 [ 2 ] = '\0' ;
V_68 [ 1 ] = V_72 & 0xff ;
...
static inline void F_38 ( struct V_66 * V_67 , T_3 V_74 ,
T_3 V_75 )
{
int V_6 ;
V_6 = F_36 ( V_74 ) ;
...
else if ( V_74 == F_37 ( L_37 ) )
V_67 -> V_77 = ( unsigned long ) V_75 ;
else if ( V_74 == F_37 ( L_38 ) )
V_67 -> V_78 = ( unsigned long ) V_75 ;
else if ( V_74 == F_37 ( L_39 ) )
V_67 -> V_79 = ( unsigned long ) V_75 ;
else if ( V_74 == F_37 ( L_40 ) )
V_67 -> V_80 = ( unsigned long ) V_75 ;
else if ( V_74 == F_37 ( L_41 ) )
V_67 -> V_81 = ( unsigned long ) V_75 ;
else if ( V_74 == F_37 ( L_42 ) )
V_67 -> V_82 = ( unsigned long ) V_75 ;
else if ( V_74 == F_37 ( L_43 ) )
V_67 -> V_83 = ( unsigned long ) V_75 ;
else if ( V_74 == F_37 ( L_44 ) )
V_67 -> V_84 = ( unsigned long ) V_75 ;
}
static struct V_85 *
F_39 ( struct V_85 * V_86 , struct V_66 * V_67 )
{
memset ( V_67 , 0 , sizeof( struct V_66 ) ) ;
while ( F_21 ( V_86 -> V_74 ) != F_37 ( L_45 ) ) {
F_38 ( V_67 , F_21 ( V_86 -> V_74 ) ,
F_21 ( V_86 -> V_87 ) ) ;
V_86 ++ ;
}
V_86 ++ ;
...
static V_15 * F_40 ( V_15 * V_88 , char * V_89 , unsigned type ,
void * V_4 , T_4 V_90 )
{
struct V_91 V_92 ;
...
static V_15 * F_42 ( V_15 * V_88 , struct V_66 * V_67 )
{
struct V_96 V_97 ;
memset ( & V_97 , 0 , sizeof( V_97 ) ) ;
F_43 ( & V_97 . V_98 , V_67 ) ;
V_88 = F_40 ( V_88 , V_99 , V_100 ,
& V_97 , sizeof( V_97 ) ) ;
return V_88 ;
}
static void F_44 ( char * V_101 )
{
struct V_51 * V_102 ;
struct V_52 * V_103 ;
...
V_114 = F_46 ( V_8 ) ;
V_112 = ( void * ) F_47 ( V_116 | V_117 , V_114 ) ;
if ( ! V_112 )
return NULL ;
V_115 = 1 << V_114 ;
V_113 = F_48 ( V_112 ) ;
...
static void F_50 ( unsigned long V_112 , unsigned long V_8 )
{
struct V_113 * V_113 ;
unsigned long V_114 , V_115 , V_6 ;
V_114 = F_46 ( V_8 ) ;
...
V_112 = F_31 ( V_24 ) ;
V_119 = V_112 ;
if ( F_21 ( V_119 -> V_125 ) != V_126 ) {
F_20 ( V_64 L_46 ) ;
return - V_127 ;
}
F_8 ( L_47 ) ;
F_8 ( L_48 , F_21 ( V_119 -> V_125 ) ) ;
F_8 ( L_49 , F_3 ( V_119 -> V_128 ) ) ;
V_112 += F_3 ( V_119 -> V_128 ) ;
V_120 = F_3 ( * ( ( T_2 * ) ( V_112 ) ) ) ;
F_8 ( L_50 , V_120 ) ;
V_112 += sizeof( V_15 ) ;
V_86 = (struct V_85 * ) V_112 ;
V_10 . V_110 = V_120 * sizeof( V_129 ) ;
V_10 . V_110 = F_18 ( V_10 . V_110 ) ;
V_121 = F_45 ( V_10 . V_110 ) ;
if ( ! V_121 ) {
F_20 ( V_64 L_51
L_52 , V_10 . V_110 ) ;
return - V_130 ;
}
V_10 . V_107 = F_54 ( V_121 ) ;
F_8 ( L_53 ,
( V_120 * sizeof( V_129 ) ) , V_121 ) ;
if ( V_10 . V_57 )
V_69 = F_31 ( V_10 . V_57 ) ;
for ( V_6 = 0 ; V_6 < V_120 ; V_6 ++ ) {
if ( F_21 ( V_86 -> V_74 ) != F_37 ( L_54 ) ) {
F_20 ( V_64 L_55 ) ;
V_61 = - V_127 ;
goto V_131;
}
V_122 = F_21 ( V_86 -> V_87 ) & V_132 ;
if ( V_69 && ! F_55 ( V_122 , & V_69 -> V_71 ) ) {
F_56 ( V_86 ) ;
continue;
}
F_8 ( L_56 , V_122 ) ;
...
F_8 ( L_57 ,
V_69 -> V_133 ) ;
F_44 ( ( char * ) F_31 ( V_69 -> V_133 ) ) ;
}
return 0 ;
V_131:
F_50 ( ( unsigned long ) F_31 ( V_10 . V_107 ) ,
V_10 . V_110 ) ;
V_10 . V_107 = 0 ;
V_10 . V_110 = 0 ;
return V_61 ;
...
static void F_60 ( unsigned long long V_140 ,
unsigned long long V_137 )
{
...
static inline unsigned long F_64 ( unsigned long V_174 )
{
if ( V_174 > V_46 && V_174 < V_10 . V_21 )
return F_21 ( V_23 . V_44 . V_42 ) + V_174 ;
else
return V_174 ;
}
static int F_65 ( char * V_101 )
{
struct V_51 * V_102 ;
struct V_52 * V_103 ;
int V_6 ;
...
V_103 -> V_108 = V_179 ;
if ( V_179 == V_46 ) {
V_103 -> V_108 = F_21 ( V_23 . V_44 . V_42 ) ;
}
V_103 -> V_106 = V_179 ;
V_103 -> V_176 = ( unsigned long ) F_31 ( V_179 ) ;
V_103 -> V_109 = V_180 ;
V_103 -> V_111 = V_180 ;
V_103 -> V_177 = 0 ;
( V_102 -> V_168 ) ++ ;
...
static void F_72 ( unsigned long V_188 , unsigned long V_137 )
{
unsigned long V_24 ;
...
static T_5 F_78 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
...
static T_5 F_80 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
char * V_88 )
{
return sprintf ( V_88 , L_70 , V_10 . V_20 ) ;
}
static T_5 F_81 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
char * V_88 )
{
return sprintf ( V_88 , L_70 , V_10 . V_65 ) ;
}
static T_5 F_82 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
const char * V_88 , T_4 V_115 )
{
int V_199 = 0 ;
...
static int F_83 ( struct V_201 * V_202 , void * V_203 )
{
...
L_71
L_72 ,
F_21 ( V_204 -> V_31 . V_42 ) ,
F_21 ( V_204 -> V_31 . V_42 ) +
F_21 ( V_204 -> V_31 . V_41 ) - 1 ,
F_21 ( V_204 -> V_31 . V_41 ) ,
F_21 ( V_204 -> V_31 . V_123 ) ) ;
F_84 ( V_202 ,
L_73
L_72 ,
F_21 ( V_204 -> V_43 . V_42 ) ,
F_21 ( V_204 -> V_43 . V_42 ) +
F_21 ( V_204 -> V_43 . V_41 ) - 1 ,
F_21 ( V_204 -> V_43 . V_41 ) ,
F_21 ( V_204 -> V_43 . V_123 ) ) ;
F_84 ( V_202 ,
L_74
L_72 ,
F_21 ( V_204 -> V_44 . V_42 ) ,
F_21 ( V_204 -> V_44 . V_42 ) +
F_21 ( V_204 -> V_44 . V_41 ) - 1 ,
F_21 ( V_204 -> V_44 . V_41 ) ,
F_21 ( V_204 -> V_44 . V_123 ) ) ;
if ( ! V_13 ||
( V_10 . V_58 ==
F_21 ( V_204 -> V_31 . V_42 ) ) )
goto V_205;
...
static int F_85 ( struct V_206 * V_206 , struct V_207 * V_207 )
{
return F_86 ( V_207 , F_83 , V_206 -> V_208 ) ;
}
static void F_87 ( void )
{
struct V_209 * V_210 ;
int V_61 = 0 ;
V_61 = F_88 ( V_211 , & V_212 . V_197 ) ;
if ( V_61 )
F_20 ( V_64 L_76
L_77 , V_61 ) ;
V_61 = F_88 ( V_211 , & V_213 . V_197 ) ;
if ( V_61 )
F_20 ( V_64 L_76
L_78 , V_61 ) ;
V_210 = F_89 ( L_79 , 0444 ,
V_214 , NULL ,
& V_215 ) ;
if ( ! V_210 )
F_20 ( V_64 L_80
