...
{
struct V_44 * V_45 = V_2 -> V_39 . V_46 ;
struct V_14 * V_15 = F_20 ( & V_2 -> V_39 ) ;
struct V_12 * V_16 ;
int V_47 ;
V_47 = F_25 ( V_45 , L_3 , 0 ) ;
if ( ! F_13 ( V_47 ) ) {
F_23 ( & V_2 -> V_39 , L_4 ) ;
return V_47 ;
}
...
struct V_12 * V_13 ;
int V_17 ;
F_30 ( & V_2 -> V_39 , L_6 , V_49 ) ;
V_2 -> V_50 = V_51 ;
V_2 -> V_52 = 32 ;
V_17 = F_31 ( V_2 ) ;
if ( V_17 < 0 ) {
F_23 ( & V_2 -> V_39 , L_7 , V_17 ) ;
return V_17 ;
}
F_4 ( V_2 ) ;
V_15 = F_32 ( & V_2 -> V_39 , sizeof( * V_15 ) , V_53 ) ;
if ( V_15 == NULL )
return - V_54 ;
F_33 ( & V_2 -> V_39 , V_15 ) ;
V_15 -> V_2 = V_2 ;
...
if ( F_13 ( V_15 -> V_40 ) ) {
V_17 = F_34 ( & V_2 -> V_39 , V_15 -> V_40 ,
V_55 , L_8 ) ;
if ( V_17 )
goto V_56;
}
if ( F_13 ( V_15 -> V_28 ) ) {
V_17 = F_34 ( & V_2 -> V_39 , V_15 -> V_28 ,
V_57 , L_9 ) ;
if ( V_17 )
goto V_56;
}
...
static int F_39 ( struct V_65 * V_39 )
{
struct V_1 * V_2 = F_40 ( V_39 ) ;
F_1 ( V_2 , 2 , 0x01 ) ;
F_41 ( 40 ) ;
return 0 ;
}
