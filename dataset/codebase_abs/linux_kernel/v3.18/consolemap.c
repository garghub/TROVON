...
for ( V_6 = 0 ; V_6 < 32 ; V_6 ++ )
if ( ( V_17 = V_16 [ V_6 ] ) ) {
for ( V_15 = 0 ; V_15 < 64 ; V_15 ++ , V_57 ++ )
if ( V_17 [ V_15 ] != 0xffff ) {
V_54 = F_22 ( V_10 , V_57 , V_17 [ V_15 ] ) ;
if ( V_54 ) {
V_4 -> V_40 ++ ;
* V_21 -> V_25 = V_4 ;
F_18 ( V_10 ) ;
...
int F_28 ( struct V_1 * V_60 , struct V_1 * V_61 )
{
struct V_3 * V_10 ;
if ( ! * V_61 -> V_25 )
return - V_55 ;
if ( * V_60 -> V_25 == * V_61 -> V_25 )
return 0 ;
F_20 ( V_60 ) ;
V_10 = * V_61 -> V_25 ;
V_10 -> V_40 ++ ;
...
int F_29 ( struct V_1 * V_21 , T_3 V_50 , T_3 T_2 * V_62 , struct V_51 T_2 * V_52 )
{
...
F_15 ( V_63 , V_62 ) ;
F_13 () ;
return ( ( V_63 <= V_50 ) ? 0 : - V_46 ) ;
}
T_5 F_30 ( unsigned char V_64 )
{
unsigned short V_65 = V_9 [ V_29 ] [ V_64 ] ;
return V_65 == ( 0xf000 | V_64 ) ? V_64 : V_65 ;
}
int F_31 ( T_5 V_65 )
{
int V_64 ;
for ( V_64 = 0 ; V_64 < 0x100 ; V_64 ++ )
if ( V_9 [ V_29 ] [ V_64 ] == V_65 ||
( V_9 [ V_29 ] [ V_64 ] == ( V_64 | 0xf000 ) && V_65 == V_64 ) )
return V_64 ;
return - 1 ;
}
int
F_3 ( struct V_1 * V_2 , long V_66 )
{
int V_67 ;
T_1 * * V_16 , * V_17 ;
struct V_3 * V_4 ;
...
return - 1 ;
else if ( V_66 == 0xfeff || ( V_66 >= 0x200b && V_66 <= 0x200f ) )
return - 2 ;
else if ( ( V_66 & ~ V_68 ) == V_34 )
return V_66 & V_68 ;
if ( ! * V_2 -> V_25 )
return - 3 ;
V_4 = * V_2 -> V_25 ;
if ( ( V_16 = V_4 -> V_19 [ V_66 >> 11 ] ) &&
( V_17 = V_16 [ ( V_66 >> 6 ) & 0x1f ] ) &&
( V_67 = V_17 [ V_66 & 0x3f ] ) < V_12 )
return V_67 ;
return - 4 ;
}
void T_6
