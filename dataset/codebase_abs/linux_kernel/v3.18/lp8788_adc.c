...
{
struct V_44 * V_15 = F_15 ( V_43 -> V_41 . V_45 ) ;
struct V_20 * V_21 ;
struct V_1 * V_2 ;
int V_13 ;
V_21 = F_16 ( & V_43 -> V_41 , sizeof( * V_2 ) ) ;
if ( ! V_21 )
return - V_46 ;
V_2 = F_8 ( V_21 ) ;
V_2 -> V_15 = V_15 ;
F_17 ( V_43 , V_21 ) ;
V_21 -> V_41 . V_47 = V_43 -> V_41 . V_47 ;
V_13 = F_11 ( V_21 , V_15 -> V_36 , V_2 ) ;
if ( V_13 )
return V_13 ;
F_18 ( & V_2 -> V_27 ) ;
V_21 -> V_41 . V_45 = & V_43 -> V_41 ;
V_21 -> V_48 = V_43 -> V_48 ;
V_21 -> V_49 = V_50 ;
V_21 -> V_51 = & V_52 ;
V_21 -> V_53 = V_54 ;
