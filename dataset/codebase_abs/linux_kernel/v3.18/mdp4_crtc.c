...
static int F_83 ( struct V_2 * V_3 , int V_82 , int V_83 ,
struct V_23 * V_25 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
...
if ( V_109 ) {
F_90 ( V_109 ) ;
F_91 ( V_109 , V_1 -> V_39 , & V_112 ) ;
F_14 ( V_1 , F_92 ( V_85 ) ,
F_93 ( V_10 -> V_106 . V_114 ) |
F_94 ( V_10 -> V_106 . V_115 ) ) ;
F_14 ( V_1 , F_95 ( V_85 ) , V_112 ) ;
F_14 ( V_1 , F_96 ( V_85 ) ,
F_97 ( V_116 ) |
V_117 ) ;
} else {
...
F_14 ( V_1 , F_98 ( V_85 ) ,
F_99 ( V_10 -> V_106 . V_82 ) |
F_100 ( V_10 -> V_106 . V_83 ) ) ;
...
if ( V_120 ) {
V_86 = F_103 ( V_120 , V_1 -> V_39 , & V_112 ) ;
if ( V_86 )
goto V_125;
} else {
V_112 = 0 ;
...
static int F_104 ( struct V_2 * V_3 , int V_82 , int V_83 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
unsigned long V_36 ;
F_20 ( & V_10 -> V_106 . V_107 , V_36 ) ;
...
static void F_105 ( struct V_127 * V_128 , T_1 V_129 )
{
...
V_9 = F_106 ( & V_10 -> V_9 , 0 ) ;
if ( V_9 & V_30 ) {
F_19 ( V_3 , NULL ) ;
F_107 ( & V_10 -> V_28 , V_5 -> V_130 ) ;
}
if ( V_9 & V_126 ) {
F_89 ( V_3 ) ;
F_107 ( & V_10 -> V_47 , V_5 -> V_130 ) ;
}
}
static void F_108 ( struct V_127 * V_128 , T_1 V_129 )
{
...
T_1 F_109 ( struct V_2 * V_3 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
return V_10 -> V_12 . V_131 ;
}
void F_110 ( struct V_2 * V_3 , struct V_31 * V_32 )
{
F_13 ( L_9 , V_32 ) ;
F_19 ( V_3 , V_32 ) ;
}
void F_111 ( struct V_2 * V_3 , T_1 V_132 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
F_14 ( V_1 , F_112 ( V_10 -> V_85 ) , V_132 ) ;
}
void F_113 ( struct V_2 * V_3 , enum V_133 V_134 , int V_75 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_1 V_135 ;
V_135 = F_114 ( V_1 , V_136 ) ;
switch ( V_10 -> V_85 ) {
case V_137 :
V_135 &= ~ V_138 ;
V_135 |= F_115 ( V_134 ) ;
...
static void F_118 ( struct V_2 * V_3 , enum V_18 V_19 ,
struct V_16 * V_17 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
F_119 ( V_19 >= F_9 ( V_10 -> V_15 ) ) ;
...
void F_120 ( struct V_2 * V_3 , struct V_16 * V_17 )
{
F_118 ( V_3 , F_10 ( V_17 ) , V_17 ) ;
}
void F_121 ( struct V_2 * V_3 , struct V_16 * V_17 )
{
if ( F_5 ( V_3 ) -> V_17 == V_17 )
return;
F_118 ( V_3 , F_10 ( V_17 ) , NULL ) ;
}
struct V_2 * F_122 ( struct V_33 * V_6 ,
struct V_16 * V_17 , int V_39 , int V_146 ,
enum V_84 V_147 )
{
struct V_2 * V_3 = NULL ;
struct V_10 * V_10 ;
int V_86 ;
V_10 = F_123 ( sizeof( * V_10 ) , V_148 ) ;
if ( ! V_10 ) {
V_86 = - V_149 ;
goto V_125;
}
...
V_10 -> V_20 = V_146 ;
V_10 -> V_85 = V_147 ;
V_10 -> V_12 . V_131 = F_124 ( V_10 -> V_85 ) ;
V_10 -> V_12 . V_128 = F_105 ;
V_10 -> V_51 . V_131 = F_125 ( V_10 -> V_85 ) ;
V_10 -> V_51 . V_128 = F_108 ;
snprintf ( V_10 -> V_21 , sizeof( V_10 -> V_21 ) , L_11 ,
V_150 [ V_147 ] , V_146 ) ;
F_126 ( & V_10 -> V_106 . V_107 ) ;
V_86 = F_127 ( & V_10 -> V_28 , 16 ,
L_12 , F_26 ) ;
if ( V_86 )
goto V_125;
V_86 = F_127 ( & V_10 -> V_47 , 64 ,
L_13 , F_30 ) ;
F_128 ( & V_10 -> F_23 , F_23 ) ;
F_129 ( V_6 , V_3 , V_17 , NULL , & V_151 ) ;
F_130 ( V_3 , & V_152 ) ;
F_131 ( V_10 -> V_17 , & V_3 -> V_11 ) ;
return V_3 ;
V_125:
if ( V_3 )
F_33 ( V_3 ) ;
