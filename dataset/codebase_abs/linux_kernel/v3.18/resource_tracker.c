...
if ( V_47 )
return V_47 ;
V_47 = F_98 ( V_6 , V_39 , V_255 , & V_216 ) ;
if ( V_47 ) {
...
if ( V_47 )
break;
V_47 = F_113 ( V_6 , & V_259 ) ;
if ( V_47 ) {
F_13 ( V_6 , V_37 , V_28 , 1 , 0 ) ;
break;
}
V_47 = F_66 ( V_6 , V_37 , V_259 , 1 , V_28 , 0 ) ;
if ( V_47 ) {
F_13 ( V_6 , V_37 , V_28 , 1 , 0 ) ;
F_114 ( V_6 , V_259 ) ;
break;
...
static int F_117 ( struct V_5 * V_6 , int V_37 , T_1 V_261 , int V_7 , T_2 V_260 )
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_218 * V_219 = & V_41 -> V_44 . V_45 . V_46 ;
struct V_262 * V_263 =
...
static void F_118 ( struct V_5 * V_6 , int V_37 , T_1 V_261 ,
int V_7 )
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_218 * V_219 = & V_41 -> V_44 . V_45 . V_46 ;
...
if ( V_251 != V_258 )
return V_47 ;
V_7 = ! V_266 ? F_96 ( V_254 ) : V_266 ;
V_7 = F_122 (
V_6 , V_37 , V_7 ) ;
if ( V_7 < 0 )
return - V_48 ;
V_261 = V_253 ;
V_47 = F_123 ( V_6 , V_7 , V_261 ) ;
if ( V_47 >= 0 ) {
V_260 = V_47 ;
F_100 ( V_254 , V_47 ) ;
V_47 = 0 ;
...
if ( ! V_47 ) {
V_47 = F_117 ( V_6 , V_37 , V_261 , V_7 , V_260 ) ;
if ( V_47 )
F_120 ( V_6 , V_7 , V_261 ) ;
}
return V_47 ;
}
static int F_124 ( struct V_5 * V_6 , int V_37 , T_4 V_267 ,
int V_7 , int V_168 )
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_218 * V_219 = & V_41 -> V_44 . V_45 . V_46 ;
...
struct V_269 * V_17 , * V_265 ;
F_116 (res, tmp, vlan_list, list) {
if ( V_17 -> V_267 == V_267 && V_17 -> V_7 == ( T_2 ) V_7 ) {
++ V_17 -> V_197 ;
return 0 ;
}
}
...
static void F_125 ( struct V_5 * V_6 , int V_37 , T_4 V_267 ,
int V_7 )
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_218 * V_219 = & V_41 -> V_44 . V_45 . V_46 ;
...
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_270 * V_271 = V_41 -> V_44 . V_45 . V_271 ;
int V_47 ;
T_4 V_267 ;
int V_168 ;
int V_7 ;
...
if ( V_7 < 0 )
return - V_48 ;
if ( ! V_266 && V_7 > 0 && V_7 <= V_6 -> V_8 . V_98 ) {
V_271 [ V_37 ] . V_272 = true ;
return 0 ;
}
V_267 = ( T_4 ) V_253 ;
V_47 = F_128 ( V_6 , V_7 , V_267 , & V_168 ) ;
if ( ! V_47 ) {
F_100 ( V_254 , ( T_3 ) V_168 ) ;
V_47 = F_124 ( V_6 , V_37 , V_267 , V_7 , V_168 ) ;
if ( V_47 )
F_126 ( V_6 , V_7 , V_267 ) ;
}
return V_47 ;
...
if ( V_251 != V_256 )
return - V_48 ;
V_47 = F_133 ( V_6 , & V_273 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_66 ( V_6 , V_37 , V_273 , 1 , V_36 , 0 ) ;
if ( V_47 )
F_134 ( V_6 , V_273 ) ;
else
F_100 ( V_254 , V_273 ) ;
...
switch ( V_275 -> V_280 & 0xFF ) {
case V_26 :
V_47 = F_95 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_30 :
V_47 = F_102 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_29 :
V_47 = F_105 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_27 :
V_47 = F_109 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_28 :
V_47 = F_112 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_31 :
V_47 = F_121 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ,
( V_275 -> V_280 >> 8 ) & 0xFF ) ;
break;
case V_32 :
V_47 = F_127 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ,
( V_275 -> V_280 >> 8 ) & 0xFF ) ;
break;
case V_34 :
V_47 = F_129 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_36 :
V_47 = F_132 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
default:
V_47 = - V_48 ;
...
case V_258 :
V_259 = F_96 ( & V_253 ) ;
V_47 = F_82 ( V_6 , V_37 , V_259 , 1 , V_28 , 0 ) ;
if ( V_47 )
break;
F_13 ( V_6 , V_37 , V_28 , 1 , 0 ) ;
F_114 ( V_6 , V_259 ) ;
...
return - V_48 ;
V_273 = F_96 ( & V_253 ) ;
V_47 = F_82 ( V_6 , V_37 , V_273 , 1 , V_36 , 0 ) ;
if ( V_47 )
return V_47 ;
F_134 ( V_6 , V_273 ) ;
return V_47 ;
...
switch ( V_275 -> V_280 & 0xFF ) {
case V_26 :
V_47 = F_136 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 ) ;
break;
case V_30 :
V_47 = F_138 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_29 :
V_47 = F_139 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 ) ;
break;
case V_27 :
V_47 = F_141 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_28 :
V_47 = F_142 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_31 :
V_47 = F_143 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ,
( V_275 -> V_280 >> 8 ) & 0xFF ) ;
break;
case V_32 :
V_47 = F_144 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ,
( V_275 -> V_280 >> 8 ) & 0xFF ) ;
break;
case V_34 :
V_47 = F_145 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
break;
case V_36 :
V_47 = F_146 ( V_6 , V_37 , V_275 -> V_279 , V_278 ,
V_275 -> V_253 , & V_275 -> V_254 ) ;
default:
break;
}
...
static int F_148 ( struct V_281 * V_78 )
{
return ( F_40 ( V_78 -> V_126 ) >> 9 ) & 1 ;
}
static int F_149 ( struct V_281 * V_78 )
{
return ( int ) F_150 ( V_78 -> V_282 ) & 0xfffffff8 ;
}
static int F_151 ( struct V_281 * V_78 )
{
return F_40 ( V_78 -> V_283 ) ;
}
static T_3 F_152 ( struct V_281 * V_78 )
{
return F_40 ( V_78 -> V_284 ) & 0x00ffffff ;
}
static int F_153 ( struct V_281 * V_78 )
{
return F_40 ( V_78 -> V_284 ) & V_285 ;
}
static int F_154 ( struct V_281 * V_78 )
{
return F_40 ( V_78 -> V_126 ) & V_286 ;
}
static int F_155 ( struct V_281 * V_78 )
{
return F_40 ( V_78 -> V_126 ) & V_287 ;
}
static int F_156 ( struct V_120 * V_138 )
{
return F_40 ( V_138 -> V_288 ) & 0xfffffff8 ;
}
static int F_157 ( struct V_289 * V_290 )
{
return F_40 ( V_290 -> V_288 ) & 0xfffffff8 ;
}
static int F_158 ( struct V_120 * V_138 )
{
int V_291 = ( V_138 -> V_292 & 0x3f ) + 12 ;
int V_293 = ( V_138 -> V_294 >> 3 ) & 0xf ;
int V_295 = V_138 -> V_294 & 7 ;
int V_296 = ( V_138 -> V_297 >> 3 ) & 0xf ;
int V_298 = V_138 -> V_297 & 7 ;
int V_73 = ( F_40 ( V_138 -> V_259 ) >> 24 ) & 1 ;
int V_299 = ( F_40 ( V_138 -> V_126 ) >> 13 ) & 1 ;
T_3 V_125 = ( F_40 ( V_138 -> V_126 ) >> 16 ) & 0xff ;
int V_300 = ( V_125 == V_132 ) ? 1 : 0 ;
int V_301 ;
int V_302 ;
int V_303 ;
int V_304 ;
int V_305 = ( F_40 ( V_138 -> V_306 ) >> 6 ) & 0x3f ;
V_301 = 1 << ( V_293 + V_295 + 4 ) ;
V_302 = ( V_73 | V_299 | V_300 ) ? 0 : ( 1 << ( V_296 + V_298 + 4 ) ) ;
V_304 = V_301 + V_302 ;
V_303 =
F_159 ( ( V_304 + ( V_305 << 6 ) ) >>
V_291 ) ;
...
static int F_160 ( struct V_5 * V_6 , int V_37 , int V_307 ,
int V_308 , struct V_199 * V_76 )
{
int V_309 = V_76 -> V_192 . V_13 ;
int V_310 = ( 1 << V_76 -> V_198 ) ;
if ( V_307 < V_309 || V_307 + V_308 > V_309 + V_310 )
return - V_186 ;
return 0 ;
}
...
{
int V_47 ;
int V_236 = V_275 -> V_280 ;
struct V_199 * V_76 ;
struct V_201 * V_78 ;
int V_311 = F_149 ( V_114 -> V_116 ) / V_6 -> V_8 . V_312 ;
int V_313 ;
int V_189 ;
T_3 V_314 ;
int V_315 ;
...
V_314 = F_152 ( V_114 -> V_116 ) ;
V_315 = ( V_314 >> 17 ) & 0x7f ;
if ( V_315 != 0 && V_315 != V_37 ) {
V_47 = - V_186 ;
goto V_316;
}
...
V_313 = F_148 ( V_114 -> V_116 ) ;
if ( ! V_313 ) {
V_47 = F_48 ( V_6 , V_37 , V_311 , V_30 , & V_76 ) ;
if ( V_47 )
goto V_316;
V_47 = F_160 ( V_6 , V_37 , V_311 ,
F_151 ( V_114 -> V_116 ) , V_76 ) ;
if ( V_47 )
goto V_317;
V_78 -> V_76 = V_76 ;
}
V_47 = F_162 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
if ( V_47 )
goto V_317;
if ( ! V_313 ) {
F_163 ( & V_76 -> V_197 ) ;
...
struct V_281 * V_318 = F_167 (
& V_40 ( V_6 ) -> V_319 . V_320 ,
V_78 -> V_200 , NULL ) ;
if ( NULL == V_318 || NULL == V_276 -> V_116 ) {
V_47 = - V_48 ;
goto V_61;
}
memcpy ( V_276 -> V_116 , V_318 , sizeof( * V_318 ) ) ;
V_47 = 0 ;
...
{
return F_40 ( V_138 -> V_321 ) & 0xffffff ;
}
...
{
return F_40 ( V_138 -> V_259 ) & 0x1ffffff ;
}
static void F_171 ( struct V_5 * V_6 , struct V_274 * V_275 ,
struct V_120 * V_323 )
{
T_3 V_137 = V_275 -> V_280 & 0xffffff ;
T_3 V_324 = 0 ;
if ( F_172 ( V_6 , V_137 , & V_324 ) )
return;
V_323 -> V_324 = F_44 ( V_324 ) ;
}
...
{
int V_47 ;
int V_137 = V_275 -> V_280 & 0x7fffff ;
struct V_199 * V_76 ;
struct V_190 * V_67 ;
struct V_120 * V_138 = V_114 -> V_116 + 8 ;
int V_311 = F_156 ( V_138 ) / V_6 -> V_8 . V_312 ;
int V_325 = F_158 ( V_138 ) ;
struct V_205 * V_326 ;
struct V_205 * V_327 ;
int V_328 = F_168 ( V_138 ) ;
int V_329 = F_169 ( V_138 ) ;
T_3 V_259 = F_170 ( V_138 ) & 0xffffff ;
int V_330 = ( F_170 ( V_138 ) >> 24 ) & 1 ;
struct V_207 * V_73 ;
...
V_67 -> V_168 = 0 ;
V_67 -> V_173 = 0 ;
V_67 -> V_332 = F_40 ( V_138 -> V_126 ) ;
V_47 = F_48 ( V_6 , V_37 , V_311 , V_30 , & V_76 ) ;
if ( V_47 )
goto V_316;
V_47 = F_160 ( V_6 , V_37 , V_311 , V_325 , V_76 ) ;
if ( V_47 )
goto V_333;
V_47 = F_48 ( V_6 , V_37 , V_328 , V_27 , & V_326 ) ;
if ( V_47 )
goto V_333;
if ( V_329 != V_328 ) {
...
V_327 = V_326 ;
if ( V_330 ) {
V_47 = F_48 ( V_6 , V_37 , V_259 , V_28 , & V_73 ) ;
if ( V_47 )
goto V_335;
}
F_171 ( V_6 , V_275 , V_138 ) ;
F_38 ( V_6 , V_37 , V_114 ) ;
V_47 = F_162 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
if ( V_47 )
goto V_336;
...
if ( V_330 ) {
F_163 ( & V_73 -> V_197 ) ;
F_53 ( V_6 , V_37 , V_259 , V_28 ) ;
V_67 -> V_73 = V_73 ;
}
F_53 ( V_6 , V_37 , V_328 , V_27 ) ;
F_53 ( V_6 , V_37 , V_311 , V_30 ) ;
F_90 ( V_6 , V_37 , V_26 , V_137 ) ;
return 0 ;
V_336:
if ( V_330 )
...
static int F_174 ( struct V_337 * V_338 )
{
return F_40 ( V_338 -> V_288 ) & 0xfffffff8 ;
}
static int F_175 ( struct V_337 * V_338 )
{
int V_339 = V_338 -> V_339 & 0x1f ;
int V_291 = ( V_338 -> V_292 & 0x3f ) + 12 ;
if ( V_339 + 5 < V_291 )
return 1 ;
return 1 << ( V_339 + 5 - V_291 ) ;
}
static int F_176 ( struct V_340 * V_341 )
{
return F_40 ( V_341 -> V_288 ) & 0xfffffff8 ;
}
static int F_177 ( struct V_340 * V_341 )
{
int V_342 = ( F_40 ( V_341 -> V_343 ) >> 24 ) & 0x1f ;
int V_291 = ( V_341 -> V_292 & 0x3f ) + 12 ;
if ( V_342 + 5 < V_291 )
return 1 ;
return 1 << ( V_342 + 5 - V_291 ) ;
}
...
{
int V_47 ;
int V_344 = V_275 -> V_280 ;
int V_13 = ( V_37 << 8 ) | V_344 ;
struct V_337 * V_338 = V_114 -> V_116 ;
int V_311 = F_174 ( V_338 ) / V_6 -> V_8 . V_312 ;
int V_325 = F_175 ( V_338 ) ;
struct V_203 * V_241 ;
struct V_199 * V_76 ;
...
static int F_179 ( struct V_5 * V_6 , int V_37 , int V_307 ,
int V_348 , struct V_199 * * V_17 )
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_218 * V_219 = & V_41 -> V_44 . V_45 . V_46 ;
struct V_199 * V_76 ;
int V_47 = - V_48 ;
F_49 ( F_50 ( V_6 ) ) ;
F_180 (mtt, &tracker->slave_list[slave].res_list[RES_MTT],
com.list) {
if ( ! F_160 ( V_6 , V_37 , V_307 , V_348 , V_76 ) ) {
* V_17 = V_76 ;
...
V_351 = F_182 ( V_6 , V_37 , V_7 ) ;
else
V_351 = 1 ;
if ( V_121 -> V_128 . V_130 >= V_351 )
return - V_48 ;
}
if ( V_123 & V_135 ) {
V_7 = ( V_121 -> V_136 . V_129 >> 6 & 1 ) + 1 ;
...
{
struct V_357 V_76 ;
T_5 * V_358 = V_114 -> V_116 ;
T_1 * V_359 = ( T_1 * ) V_358 ;
int V_81 ;
struct V_199 * V_360 = NULL ;
int V_307 = F_150 ( V_358 [ 0 ] ) ;
int V_361 = V_275 -> V_280 ;
int V_47 ;
V_47 = F_179 ( V_6 , V_37 , V_307 , V_361 , & V_360 ) ;
if ( V_47 )
return V_47 ;
V_76 . V_362 = 0 ;
V_76 . V_198 = 0 ;
V_76 . V_291 = 0 ;
for ( V_81 = 0 ; V_81 < V_361 ; ++ V_81 )
V_359 [ V_81 + 2 ] = ( F_150 ( V_358 [ V_81 + 2 ] ) & ~ 1ULL ) ;
V_47 = F_186 ( V_6 , & V_76 , F_150 ( V_358 [ 0 ] ) , V_361 ,
( ( T_1 * ) V_358 + 2 ) ) ;
if ( V_360 )
F_53 ( V_6 , V_37 , V_360 -> V_192 . V_13 , V_30 ) ;
return V_47 ;
}
int F_187 ( struct V_5 * V_6 , int V_37 ,
struct V_274 * V_275 ,
struct V_113 * V_114 ,
struct V_113 * V_276 ,
struct V_277 * V_252 )
...
int F_188 ( struct V_5 * V_6 , int V_37 , struct V_363 * V_364 )
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_365 * V_366 ;
struct V_113 * V_367 ;
...
int V_13 ;
struct V_203 * V_368 ;
if ( ! V_41 -> V_44 . V_45 . V_271 )
return - V_48 ;
V_366 = & V_41 -> V_44 . V_45 . V_271 [ V_37 ] . V_366 [ V_364 -> type ] ;
if ( V_366 -> V_344 < 0 )
return 0 ;
F_35 ( & V_41 -> V_44 . V_45 . V_369 [ V_37 ] ) ;
V_13 = ( V_37 << 8 ) | V_366 -> V_344 ;
V_47 = F_48 ( V_6 , V_37 , V_13 , V_33 , & V_368 ) ;
if ( V_47 )
goto V_370;
if ( V_368 -> V_192 . V_187 != V_243 ) {
V_47 = - V_48 ;
goto V_371;
}
V_367 = F_189 ( V_6 ) ;
...
if ( V_364 -> type == V_372 ) {
++ V_366 -> V_373 ;
V_364 -> V_374 . V_252 . V_373 = F_192 ( V_366 -> V_373 ) ;
}
memcpy ( V_367 -> V_116 , ( T_2 * ) V_364 , 28 ) ;
V_280 = ( V_37 & 0xff ) | ( ( V_366 -> V_344 & 0xff ) << 16 ) ;
V_47 = F_193 ( V_6 , V_367 -> V_375 , V_280 , 0 ,
V_376 , V_377 ,
V_378 ) ;
F_53 ( V_6 , V_37 , V_13 , V_33 ) ;
F_37 ( & V_41 -> V_44 . V_45 . V_369 [ V_37 ] ) ;
F_194 ( V_6 , V_367 ) ;
return V_47 ;
V_371:
F_53 ( V_6 , V_37 , V_13 , V_33 ) ;
...
{
int V_47 ;
int V_244 = V_275 -> V_280 ;
struct V_340 * V_341 = V_114 -> V_116 ;
int V_311 = F_176 ( V_341 ) / V_6 -> V_8 . V_312 ;
struct V_205 * V_70 ;
struct V_199 * V_76 ;
...
if ( V_47 )
goto V_346;
V_47 = F_160 ( V_6 , V_37 , V_311 , F_177 ( V_341 ) , V_76 ) ;
if ( V_47 )
goto V_347;
V_47 = F_162 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
if ( V_47 )
...
static int F_199 ( struct V_5 * V_6 , int V_37 ,
struct V_274 * V_275 ,
struct V_113 * V_114 ,
struct V_113 * V_276 ,
struct V_277 * V_252 ,
...
struct V_340 * V_341 = V_114 -> V_116 ;
int V_311 = F_176 ( V_341 ) / V_6 -> V_8 . V_312 ;
V_47 = F_48 ( V_6 , V_37 , V_70 -> V_76 -> V_192 . V_13 , V_30 , & V_379 ) ;
if ( V_47 )
return V_47 ;
if ( V_379 != V_70 -> V_76 ) {
V_47 = - V_48 ;
...
goto V_380;
F_165 ( & V_379 -> V_197 ) ;
F_53 ( V_6 , V_37 , V_379 -> V_192 . V_13 , V_30 ) ;
F_163 ( & V_76 -> V_197 ) ;
V_70 -> V_76 = V_76 ;
F_53 ( V_6 , V_37 , V_76 -> V_192 . V_13 , V_30 ) ;
return 0 ;
...
goto V_317;
if ( V_275 -> V_279 == 0 ) {
V_47 = F_199 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 , V_70 ) ;
goto V_317;
}
V_47 = F_162 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
V_317:
...
static int F_201 ( struct V_289 * V_290 )
{
int V_381 = ( F_40 ( V_290 -> V_382 ) >> 24 ) & 0xf ;
int V_298 = V_290 -> V_383 & 7 ;
int V_291 = ( V_290 -> V_292 & 0x3f ) + 12 ;
if ( V_381 + V_298 + 4 < V_291 )
return 1 ;
return 1 << ( V_381 + V_298 + 4 - V_291 ) ;
}
...
{
int V_47 ;
int V_259 = V_275 -> V_280 ;
struct V_199 * V_76 ;
struct V_207 * V_73 ;
struct V_289 * V_290 = V_114 -> V_116 ;
int V_311 = F_157 ( V_290 ) / V_6 -> V_8 . V_312 ;
if ( V_259 != ( F_40 ( V_290 -> V_382 ) & 0xffffff ) )
return - V_48 ;
V_47 = F_88 ( V_6 , V_37 , V_259 , V_248 , & V_73 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_48 ( V_6 , V_37 , V_311 , V_30 , & V_76 ) ;
if ( V_47 )
goto V_316;
V_47 = F_160 ( V_6 , V_37 , V_311 , F_201 ( V_290 ) ,
V_76 ) ;
if ( V_47 )
goto V_333;
V_47 = F_162 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
...
V_73 -> V_76 = V_76 ;
F_53 ( V_6 , V_37 , V_76 -> V_192 . V_13 , V_30 ) ;
F_90 ( V_6 , V_37 , V_28 , V_259 ) ;
return 0 ;
V_333:
F_53 ( V_6 , V_37 , V_76 -> V_192 . V_13 , V_30 ) ;
V_316:
F_89 ( V_6 , V_37 , V_28 , V_259 ) ;
return V_47 ;
}
...
int V_259 = V_275 -> V_280 ;
struct V_207 * V_73 ;
V_47 = F_88 ( V_6 , V_37 , V_259 , V_208 , & V_73 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_162 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
if ( V_47 )
...
struct V_277 * V_252 )
{
struct V_120 * V_323 = V_114 -> V_116 + 8 ;
F_171 ( V_6 , V_275 , V_323 ) ;
F_38 ( V_6 , V_37 , V_114 ) ;
return F_206 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
}
static int F_208 ( struct V_5 * V_6 , int V_37 ,
struct V_120 * V_138 ,
struct V_113 * V_114 )
{
enum V_122 V_123 = F_40 ( * ( V_124 * ) V_114 -> V_116 ) ;
...
if ( V_7 < 0 )
return - V_48 ;
V_384 = ( V_138 -> V_128 . V_129 & ~ ( 1 << 6 ) ) |
( ( V_7 & 1 ) << 6 ) ;
if ( V_123 & V_134 ||
F_2 ( V_6 , V_7 + 1 ) ) {
V_138 -> V_128 . V_129 = V_384 ;
}
if ( V_123 & V_135 ) {
V_7 = F_122 (
...
V_385 = V_138 -> V_128 . V_179 & 0x7f ;
if ( F_115 ( V_6 , V_37 , V_7 , V_385 , & V_261 ) )
return - V_188 ;
}
return 0 ;
}
...
struct V_190 * V_67 ;
T_2 V_386 ;
V_124 V_387 = V_138 -> V_150 ;
T_2 V_388 = V_138 -> V_128 . V_159 ;
T_2 V_389 = V_138 -> V_128 . V_166 ;
T_2 V_390 = V_138 -> V_128 . V_170 ;
T_2 V_391 = V_138 -> V_128 . V_168 ;
T_2 V_392 = V_138 -> V_128 . V_173 ;
V_47 = F_208 ( V_6 , V_37 , V_138 , V_114 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_181 ( V_6 , V_275 , V_114 , V_352 , V_37 ) ;
if ( V_47 )
return V_47 ;
if ( F_209 ( V_6 , V_37 , V_138 , V_114 ) )
return - V_48 ;
F_38 ( V_6 , V_37 , V_114 ) ;
F_39 ( V_6 , V_114 , ( T_2 ) V_37 ) ;
F_171 ( V_6 , V_275 , V_138 ) ;
V_386 = V_138 -> V_128 . V_129 ;
...
int V_47 ;
struct V_120 * V_323 = V_114 -> V_116 + 8 ;
V_47 = F_208 ( V_6 , V_37 , V_323 , V_114 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_181 ( V_6 , V_275 , V_114 , V_353 , V_37 ) ;
if ( V_47 )
return V_47 ;
F_38 ( V_6 , V_37 , V_114 ) ;
F_39 ( V_6 , V_114 , ( T_2 ) V_37 ) ;
...
if ( V_47 )
return V_47 ;
V_47 = F_181 ( V_6 , V_275 , V_114 , V_354 , V_37 ) ;
if ( V_47 )
return V_47 ;
F_38 ( V_6 , V_37 , V_114 ) ;
F_39 ( V_6 , V_114 , ( T_2 ) V_37 ) ;
...
{
struct V_120 * V_323 = V_114 -> V_116 + 8 ;
int V_47 = F_208 ( V_6 , V_37 , V_323 , V_114 ) ;
if ( V_47 )
return V_47 ;
F_171 ( V_6 , V_275 , V_323 ) ;
return F_206 ( V_6 , V_37 , V_275 , V_114 , V_276 , V_252 ) ;
...
if ( V_47 )
return V_47 ;
V_47 = F_181 ( V_6 , V_275 , V_114 , V_355 , V_37 ) ;
if ( V_47 )
return V_47 ;
F_171 ( V_6 , V_275 , V_323 ) ;
F_39 ( V_6 , V_114 , ( T_2 ) V_37 ) ;
...
if ( V_47 )
return V_47 ;
V_47 = F_181 ( V_6 , V_275 , V_114 , V_356 , V_37 ) ;
if ( V_47 )
return V_47 ;
F_171 ( V_6 , V_275 , V_323 ) ;
F_39 ( V_6 , V_114 , ( T_2 ) V_37 ) ;
...
static struct V_393 * F_217 ( struct V_5 * V_6 , int V_37 ,
struct V_190 * V_394 , T_2 * V_395 )
{
struct V_393 * V_17 ;
F_180 (res, &rqp->mcg_list, list) {
if ( ! memcmp ( V_17 -> V_395 , V_395 , 16 ) )
return V_17 ;
}
return NULL ;
}
static int F_218 ( struct V_5 * V_6 , int V_37 , struct V_190 * V_394 ,
T_2 * V_395 , enum V_396 V_397 ,
enum V_398 V_399 , T_1 V_400 )
{
struct V_393 * V_17 ;
int V_47 ;
V_17 = F_21 ( sizeof *V_17 , V_86 ) ;
...
return - V_87 ;
F_49 ( & V_394 -> V_196 ) ;
if ( F_217 ( V_6 , V_37 , V_394 , V_395 ) ) {
F_31 ( V_17 ) ;
V_47 = - V_23 ;
} else {
memcpy ( V_17 -> V_395 , V_395 , 16 ) ;
V_17 -> V_397 = V_397 ;
V_17 -> V_399 = V_399 ;
V_17 -> V_400 = V_400 ;
F_67 ( & V_17 -> V_221 , & V_394 -> V_195 ) ;
V_47 = 0 ;
}
F_51 ( & V_394 -> V_196 ) ;
return V_47 ;
}
static int F_219 ( struct V_5 * V_6 , int V_37 , struct V_190 * V_394 ,
T_2 * V_395 , enum V_396 V_397 ,
enum V_398 V_399 , T_1 * V_400 )
{
struct V_393 * V_17 ;
int V_47 ;
F_49 ( & V_394 -> V_196 ) ;
V_17 = F_217 ( V_6 , V_37 , V_394 , V_395 ) ;
if ( ! V_17 || V_17 -> V_397 != V_397 || V_17 -> V_399 != V_399 )
V_47 = - V_48 ;
else {
* V_400 = V_17 -> V_400 ;
F_83 ( & V_17 -> V_221 ) ;
...
static int F_220 ( struct V_5 * V_6 , int V_37 , struct V_401 * V_67 ,
T_2 V_395 [ 16 ] , int V_402 , enum V_396 V_397 ,
enum V_398 type , T_1 * V_400 )
{
switch ( V_6 -> V_8 . V_403 ) {
case V_404 : {
int V_7 = F_122 ( V_6 , V_37 , V_395 [ 5 ] ) ;
if ( V_7 < 0 )
return V_7 ;
return F_221 ( V_6 , V_67 , V_395 , V_7 ,
V_402 , V_397 ,
V_400 ) ;
}
case V_405 :
...
return F_222 ( V_6 , V_67 , V_395 ,
V_402 , V_397 , type ) ;
default:
return - V_48 ;
}
}
static int F_223 ( struct V_5 * V_6 , struct V_401 * V_67 ,
T_2 V_395 [ 16 ] , enum V_396 V_397 ,
enum V_398 type , T_1 V_400 )
{
switch ( V_6 -> V_8 . V_403 ) {
case V_404 :
return F_224 ( V_6 , V_400 ) ;
case V_405 :
return F_225 ( V_6 , V_67 , V_395 , V_397 , type ) ;
default:
return - V_48 ;
}
}
static int F_226 ( struct V_5 * V_6 , int V_37 ,
T_2 * V_395 , enum V_396 V_397 )
{
int V_407 ;
if ( V_397 != V_406 )
return 0 ;
if ( V_6 -> V_8 . V_403 == V_405 ||
V_6 -> V_8 . V_403 == V_404 ) {
V_407 = F_122 ( V_6 , V_37 , V_395 [ 5 ] ) ;
if ( V_407 < 0 )
return - V_48 ;
V_395 [ 5 ] = V_407 ;
}
...
int F_227 ( struct V_5 * V_6 , int V_37 ,
struct V_274 * V_275 ,
struct V_113 * V_114 ,
struct V_113 * V_276 ,
struct V_277 * V_252 )
{
struct V_401 V_67 ;
T_2 * V_395 = V_114 -> V_116 ;
enum V_396 V_397 = ( V_275 -> V_280 >> 28 ) & 0x7 ;
int V_47 ;
int V_137 ;
struct V_190 * V_394 ;
T_1 V_400 = 0 ;
int V_408 = V_275 -> V_279 ;
int V_402 = V_275 -> V_280 >> 31 ;
T_2 V_409 = 2 ;
enum V_398 type = ( V_395 [ 7 ] & V_409 ) >> 1 ;
V_137 = V_275 -> V_280 & 0xffffff ;
V_47 = F_48 ( V_6 , V_37 , V_137 , V_26 , & V_394 ) ;
if ( V_47 )
return V_47 ;
V_67 . V_137 = V_137 ;
if ( V_408 ) {
V_47 = F_220 ( V_6 , V_37 , & V_67 , V_395 , V_402 , V_397 ,
type , & V_400 ) ;
if ( V_47 ) {
F_65 ( L_25 , V_137 ) ;
goto V_317;
}
V_47 = F_218 ( V_6 , V_37 , V_394 , V_395 , V_397 , type , V_400 ) ;
if ( V_47 )
goto V_410;
} else {
V_47 = F_226 ( V_6 , V_37 , V_395 , V_397 ) ;
if ( V_47 )
goto V_317;
V_47 = F_219 ( V_6 , V_37 , V_394 , V_395 , V_397 , type , & V_400 ) ;
if ( V_47 )
goto V_317;
V_47 = F_223 ( V_6 , & V_67 , V_395 , V_397 , type , V_400 ) ;
if ( V_47 )
F_65 ( L_26 ,
V_137 , V_400 ) ;
}
...
return V_47 ;
V_410:
F_223 ( V_6 , & V_67 , V_395 , V_397 , type , V_400 ) ;
V_317:
F_53 ( V_6 , V_37 , V_137 , V_26 ) ;
return V_47 ;
}
static int F_228 ( int V_37 , struct V_411 * V_412 ,
struct V_262 * V_413 )
{
struct V_264 * V_17 , * V_265 ;
T_5 V_414 ;
if ( ! F_229 ( V_412 -> V_415 . V_416 ) &&
! F_230 ( V_412 -> V_415 . V_416 ) ) {
F_116 (res, tmp, rlist, list) {
V_414 = F_231 ( V_17 -> V_261 << 16 ) ;
if ( F_232 ( ( T_2 * ) & V_414 , V_412 -> V_415 . V_416 ) )
return 0 ;
}
F_65 ( L_27 ,
V_412 -> V_415 . V_416 , V_37 ) ;
return - V_48 ;
}
return 0 ;
}
static int F_233 ( struct V_5 * V_6 , int V_37 ,
struct V_113 * V_114 ,
struct V_262 * V_413 , int V_417 )
{
struct V_264 * V_17 , * V_265 ;
T_2 V_7 ;
struct V_418 * V_419 ;
...
struct V_423 * V_424 ;
T_5 V_414 = 0 ;
T_5 V_425 = F_231 ( V_426 << 16 ) ;
V_419 = (struct V_418 * ) V_114 -> V_116 ;
V_7 = V_419 -> V_7 ;
V_412 = (struct V_420 * ) ( V_419 + 1 ) ;
switch ( V_417 ) {
case V_427 :
V_422 =
(struct V_421 * ) ( V_412 + 1 ) ;
memmove ( V_422 , V_412 ,
sizeof( * V_422 ) + sizeof( * V_424 ) ) ;
break;
case V_428 :
case V_429 :
V_424 = (struct V_423 * )
( V_412 + 1 ) ;
memmove ( V_424 , V_412 , sizeof( * V_424 ) ) ;
break;
default:
return - V_48 ;
}
...
V_412 -> V_308 = sizeof( * V_412 ) >> 2 ;
V_412 -> V_189 = F_192 ( V_430 [ V_431 ] ) ;
memcpy ( V_412 -> V_416 , & V_414 , V_432 ) ;
memcpy ( V_412 -> V_433 , & V_425 , V_432 ) ;
return 0 ;
}
int F_234 ( struct V_5 * V_6 , int V_37 ,
struct V_274 * V_275 ,
struct V_113 * V_114 ,
struct V_113 * V_276 ,
struct V_277 * V_434 )
...
struct V_436 * V_252 ;
int V_260 ;
V_252 = (struct V_436 * ) V_114 -> V_116 ;
V_435 = F_150 ( V_252 -> V_437 ) ;
if ( V_252 -> V_438 || V_252 -> V_439 ||
( V_435 & ~ V_440 ) )
return - V_186 ;
V_47 = F_48 ( V_6 , V_37 , V_137 , V_26 , & V_394 ) ;
if ( V_47 ) {
F_184 ( V_6 , L_29 , V_137 , V_37 ) ;
return V_47 ;
}
V_7 = ( V_394 -> V_129 >> 6 & 1 ) + 1 ;
if ( V_435 & ( 1ULL << V_441 ) ) {
V_260 = V_252 -> V_442 . V_128 . V_179 ;
...
V_47 = F_193 ( V_6 , V_114 -> V_375 ,
V_275 -> V_280 , 0 ,
V_444 , V_445 ,
V_378 ) ;
if ( V_47 ) {
F_184 ( V_6 , L_31 , V_137 ) ;
goto V_443;
}
V_443:
F_53 ( V_6 , V_37 , V_137 , V_26 ) ;
...
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_218 * V_219 = & V_41 -> V_44 . V_45 . V_46 ;
struct V_262 * V_413 = & V_219 -> V_84 [ V_37 ] . V_89 [ V_31 ] ;
int V_47 ;
int V_137 ;
struct V_190 * V_394 ;
struct V_418 * V_419 ;
...
return - V_447 ;
V_419 = (struct V_418 * ) V_114 -> V_116 ;
V_419 -> V_7 = F_122 ( V_6 , V_37 , V_419 -> V_7 ) ;
if ( V_419 -> V_7 <= 0 )
return - V_48 ;
V_137 = F_40 ( V_419 -> V_137 ) & 0xffffff ;
V_47 = F_48 ( V_6 , V_37 , V_137 , V_26 , & V_394 ) ;
if ( V_47 ) {
F_65 ( L_32 , V_137 ) ;
return V_47 ;
}
V_446 = (struct V_411 * ) ( V_419 + 1 ) ;
V_417 = F_236 ( F_237 ( V_446 -> V_189 ) ) ;
switch ( V_417 ) {
case V_431 :
if ( F_228 ( V_37 , V_446 , V_413 ) ) {
V_47 = - V_48 ;
goto V_448;
}
break;
...
case V_429 :
F_238 ( L_33 ) ;
if ( F_233 ( V_6 , V_37 , V_114 , V_413 , V_417 ) ) {
V_47 = - V_48 ;
goto V_448;
}
V_275 -> V_280 +=
sizeof( struct V_420 ) >> 2 ;
break;
default:
F_65 ( L_34 ) ;
V_47 = - V_48 ;
...
V_47 = F_239 ( V_6 , V_114 -> V_375 , & V_275 -> V_254 ,
V_275 -> V_280 , 0 ,
V_450 , V_445 ,
V_378 ) ;
if ( V_47 )
goto V_448;
V_47 = F_66 ( V_6 , V_37 , V_275 -> V_254 , 1 , V_35 , V_137 ) ;
if ( V_47 ) {
F_184 ( V_6 , L_35 ) ;
F_193 ( V_6 , V_275 -> V_254 , 0 , 0 ,
V_451 , V_445 ,
V_378 ) ;
goto V_448;
}
...
int F_240 ( struct V_5 * V_6 , int V_37 ,
struct V_274 * V_275 ,
struct V_113 * V_114 ,
struct V_113 * V_276 ,
struct V_277 * V_252 )
...
V_404 )
return - V_447 ;
V_47 = F_48 ( V_6 , V_37 , V_275 -> V_253 , V_35 , & V_452 ) ;
if ( V_47 )
return V_47 ;
F_53 ( V_6 , V_37 , V_275 -> V_253 , V_35 ) ;
V_47 = F_48 ( V_6 , V_37 , V_452 -> V_137 , V_26 , & V_394 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_82 ( V_6 , V_37 , V_275 -> V_253 , 1 , V_35 , 0 ) ;
if ( V_47 ) {
F_184 ( V_6 , L_36 ) ;
goto V_61;
}
V_47 = F_193 ( V_6 , V_275 -> V_253 , 0 , 0 ,
V_451 , V_445 ,
V_378 ) ;
if ( ! V_47 )
F_165 ( & V_394 -> V_197 ) ;
V_61:
F_53 ( V_6 , V_37 , V_452 -> V_137 , V_26 ) ;
return V_47 ;
}
...
static void F_242 ( struct V_5 * V_6 , int V_37 , struct V_190 * V_394 )
{
struct V_393 * V_453 ;
struct V_393 * V_265 ;
struct V_401 V_67 ;
...
switch ( V_6 -> V_8 . V_403 ) {
case V_404 :
F_224 ( V_6 , V_453 -> V_400 ) ;
break;
case V_405 :
V_67 . V_137 = V_394 -> V_194 ;
( void ) F_225 ( V_6 , & V_67 , V_453 -> V_395 ,
V_453 -> V_397 , V_453 -> V_399 ) ;
break;
}
F_83 ( & V_453 -> V_221 ) ;
F_31 ( V_453 ) ;
...
static int F_243 ( struct V_5 * V_6 , int V_37 ,
enum V_24 type , int V_454 )
{
struct V_40 * V_41 = V_40 ( V_6 ) ;
struct V_218 * V_219 =
& V_41 -> V_44 . V_45 . V_46 ;
struct V_262 * V_413 = & V_219 -> V_84 [ V_37 ] . V_89 [ type ] ;
struct V_16 * V_181 ;
struct V_16 * V_265 ;
int V_455 ;
V_455 = 0 ;
...
V_457 = V_458 ;
do {
V_455 = F_243 ( V_6 , V_37 , type , 0 ) ;
if ( F_245 ( V_458 , V_457 + 5 * V_459 ) )
break;
if ( V_455 )
F_246 () ;
} while ( V_455 );
if ( V_455 )
V_455 = F_243 ( V_6 , V_37 , type , 1 ) ;
return V_455 ;
}
...
F_51 ( F_50 ( V_6 ) ) ;
if ( V_472 -> V_192 . V_185 == V_37 ) {
V_216 = V_472 -> V_192 . V_13 ;
V_2 = V_472 -> V_192 . V_187 ;
while ( V_2 != 0 ) {
switch ( V_2 ) {
case V_214 :
V_47 = F_193 ( V_6 , V_216 , 0 , 0 ,
V_451 ,
V_445 ,
V_378 ) ;
F_49 ( F_50 ( V_6 ) ) ;
F_68 ( & V_472 -> V_192 . V_15 ,
& V_219 -> V_91 [ V_35 ] ) ;
F_83 ( & V_472 -> V_192 . V_221 ) ;
F_51 ( F_50 ( V_6 ) ) ;
F_31 ( V_472 ) ;
V_2 = 0 ;
break;
...
int V_47 ;
int V_236 ;
V_47 = F_244 ( V_6 , V_37 , V_34 ) ;
if ( V_47 )
F_11 ( V_6 , L_50 ,
V_37 ) ;
F_49 ( F_50 ( V_6 ) ) ;
F_116 (counter, tmp, counter_list, com.list) {
if ( V_476 -> V_192 . V_185 == V_37 ) {
V_236 = V_476 -> V_192 . V_13 ;
F_68 ( & V_476 -> V_192 . V_15 ,
& V_219 -> V_91 [ V_34 ] ) ;
F_83 ( & V_476 -> V_192 . V_221 ) ;
F_31 ( V_476 ) ;
F_131 ( V_6 , V_236 ) ;
F_13 ( V_6 , V_37 , V_34 , 1 , 0 ) ;
}
...
V_273 = V_478 -> V_192 . V_13 ;
F_68 ( & V_478 -> V_192 . V_15 , & V_219 -> V_91 [ V_36 ] ) ;
...
void F_258 ( struct V_479 * V_480 )
{
struct V_481 * V_482 =
F_4 ( V_480 , struct V_481 , V_482 ) ;
struct V_113 * V_367 ;
struct V_436 * V_483 ;
struct V_5 * V_6 = & V_482 -> V_41 -> V_6 ;
struct V_218 * V_219 =
& V_482 -> V_41 -> V_44 . V_45 . V_46 ;
struct V_262 * V_460 =
& V_219 -> V_84 [ V_482 -> V_37 ] . V_89 [ V_26 ] ;
struct V_190 * V_67 ;
struct V_190 * V_265 ;
T_1 V_484 =
( ( 1ULL << V_485 ) |
...
V_164 ;
V_483 = V_367 -> V_116 ;
V_483 -> V_438 = F_231 ( 1ULL << V_502 ) ;
F_49 ( F_50 ( V_6 ) ) ;
F_116 (qp, tmp, qp_list, com.list) {
F_51 ( F_50 ( V_6 ) ) ;
if ( V_67 -> V_192 . V_185 == V_482 -> V_37 ) {
if ( V_67 -> V_192 . V_187 != V_234 ||
! V_67 -> V_129 ||
F_43 ( V_6 , V_67 -> V_194 ) ||
V_67 -> V_332 & ( 1 << V_503 ) ) {
...
if ( V_131 == ( ( V_67 -> V_332 >> 16 ) & 0xff ) )
V_483 -> V_437 = F_231 ( V_491 ) ;
else
V_483 -> V_437 =
F_231 ( V_491 | V_484 ) ;
if ( V_482 -> V_501 == V_144 ) {
V_483 -> V_442 . V_150 = V_67 -> V_150 ;
V_483 -> V_442 . V_128 . V_159 = V_67 -> V_159 ;
V_483 -> V_442 . V_128 . V_166 = V_67 -> V_166 ;
V_483 -> V_442 . V_128 . V_168 = V_67 -> V_168 ;
V_483 -> V_442 . V_128 . V_170 = V_67 -> V_331 ;
V_483 -> V_442 . V_128 . V_173 = V_67 -> V_173 ;
V_483 -> V_442 . V_128 . V_129 =
V_67 -> V_129 ;
} else {
V_483 -> V_442 . V_150 = V_67 -> V_150 & ~ F_44 ( V_151 ) ;
V_483 -> V_442 . V_128 . V_159 = V_159 ;
V_483 -> V_442 . V_128 . V_168 = V_482 -> V_504 ;
V_483 -> V_442 . V_128 . V_166 =
V_67 -> V_166 | V_167 ;
V_483 -> V_442 . V_128 . V_170 =
V_67 -> V_331 | V_171 | V_172 ;
V_483 -> V_442 . V_128 . V_173 =
...
V_47 = F_193 ( V_6 , V_367 -> V_375 ,
V_67 -> V_194 & 0xffffff ,
0 , V_444 ,
V_506 , V_378 ) ;
if ( V_47 ) {
F_259 ( V_6 , L_53 ,
V_482 -> V_37 , V_7 , V_67 -> V_194 , V_47 ) ;
V_499 ++ ;
}
}
F_49 ( F_50 ( V_6 ) ) ;
...
if ( V_499 )
F_184 ( V_6 , L_54 ,
V_499 , V_482 -> V_37 , V_482 -> V_7 ) ;
if ( V_482 -> V_126 & V_507 && ! V_499 &&
V_508 != V_482 -> V_509 )
F_126 ( & V_482 -> V_41 -> V_6 , V_482 -> V_7 ,
V_482 -> V_510 ) ;
V_61:
F_31 ( V_482 ) ;
return;
