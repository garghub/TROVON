...
V_123 = F_39 ( V_122 , struct V_1 , V_125 ) ;
if ( V_123 -> V_32 != V_67 )
continue;
F_31 ( V_123 ) ;
}
...
V_28 = F_42 ( & V_2 -> V_44 , V_135 , 3 , & signal ) ;
if ( V_28 == 0 && signal )
F_1 ( V_2 ) ;
return V_28 ;
}
...
V_88 V_136 = 0 ;
bool signal = false ;
T_1 V_82 = F_45 ( V_156 -> V_154 ,
V_156 -> V_153 ) ;
if ( V_82 > V_158 )
return - V_35 ;
V_146 = sizeof( struct V_157 ) -
( ( V_158 - V_82 ) *
sizeof( V_88 ) ) ;
V_132 = V_146 + V_127 ;
V_133 = F_41 ( V_132 , sizeof( V_88 ) ) ;
...
V_131 . V_152 = V_128 ;
V_131 . V_91 = 1 ;
V_131 . V_93 . V_153 = V_156 -> V_153 ;
V_131 . V_93 . V_154 = V_156 -> V_154 ;
memcpy ( V_131 . V_93 . V_96 , V_156 -> V_96 ,
V_82 * sizeof( V_88 ) ) ;
V_135 [ 0 ] . V_141 = & V_131 ;
V_135 [ 0 ] . V_142 = V_146 ;
V_135 [ 1 ] . V_141 = V_126 ;
...
T_1 V_127 , T_1 * V_159 , V_88 * V_128 )
{
struct V_130 V_131 ;
T_1 V_132 ;
T_1 V_160 ;
...
* V_128 = V_131 . V_140 ;
V_28 = F_48 ( & V_2 -> V_46 , V_126 , V_160 ,
