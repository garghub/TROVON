...
if ( V_66 [ V_4 ] . V_14 < 0 )
break;
V_69 = F_1 ( V_2 , V_66 [ V_4 ] . V_14 ) ;
if ( V_69 < 0 )
continue;
V_2 -> V_5 [ V_69 ] . V_9 . V_41 += V_66 [ V_4 ] . V_17 ;
if ( ( V_4 != V_72 - 1 ) && ( V_66 [ V_4 + 1 ] . V_14 < 0 ) )
V_2 -> V_5 [ V_69 ] . V_9 . V_44 += V_44 ;
}
if ( ( V_64 -> V_70 & V_73 ) && ( V_4 >= 0 ) )
V_2 -> V_74 ++ ;
if ( V_2 -> V_75 > 0 )
V_2 -> V_75 -- ;
if ( F_14 ( V_55 , V_2 -> V_54 +
( V_24 -> V_76 * V_77 ) / 1000 ) )
F_7 ( V_24 , V_2 ) ;
}
static inline unsigned int
F_15 ( struct V_15 * V_37 ,
struct V_63 * V_64 )
{
unsigned int V_78 = V_37 -> V_18 ;
if ( V_64 -> V_79 . V_80 )
V_78 = F_16 ( 2U , F_17 ( V_37 -> V_9 . V_22 , V_78 ) ) ;
else if ( V_64 -> V_79 . V_81 )
V_78 = F_16 ( 2U , F_17 ( V_37 -> V_20 , V_78 ) ) ;
return V_78 ;
}
static int
F_18 ( struct V_1 * V_2 )
{
unsigned int V_82 ;
V_82 = F_19 ( V_2 , V_2 -> V_83 , V_2 -> V_84 ) ;
V_2 -> V_83 ++ ;
if ( ( int ) V_2 -> V_83 >= V_2 -> V_36 ) {
V_2 -> V_83 = 0 ;
V_2 -> V_84 ++ ;
if ( V_2 -> V_84 >= V_85 )
V_2 -> V_84 = 0 ;
...
static void
F_20 ( void * V_56 , struct V_59 * V_32 ,
void * V_60 , struct V_86 * V_87 )
{
struct V_61 * V_62 = V_87 -> V_62 ;
struct V_63 * V_64 = F_13 ( V_62 ) ;
struct V_1 * V_2 = V_60 ;
struct V_23 * V_24 = V_56 ;
struct V_65 * V_16 = & V_64 -> V_79 . V_68 [ 0 ] ;
...
if ( ! V_89 &&
( V_2 -> V_5 [ V_69 ] . V_9 . V_47 > F_9 ( 95 , 100 ) ) )
return;
V_2 -> V_90 = true ;
V_16 -> V_14 = V_2 -> V_5 [ V_69 ] . V_3 ;
V_16 -> V_17 = F_15 ( & V_2 -> V_5 [ V_69 ] , V_64 ) ;
}
static void
...
V_2 -> V_84 = 0 ;
V_2 -> V_83 = 0 ;
memset ( V_2 -> V_113 , 0xff , V_85 * V_2 -> V_36 ) ;
for ( V_110 = 0 ; V_110 < V_85 ; V_110 ++ ) {
F_27 ( V_112 , sizeof( V_112 ) ) ;
for ( V_4 = 0 ; V_4 < V_2 -> V_36 ; V_4 ++ ) {
V_111 = ( V_4 + V_112 [ V_4 & 7 ] ) % V_2 -> V_36 ;
while ( F_19 ( V_2 , V_111 , V_110 ) != 0xff )
V_111 = ( V_111 + 1 ) % V_2 -> V_36 ;
F_19 ( V_2 , V_111 , V_110 ) = V_4 ;
}
}
}
static void
...
continue;
if ( ( V_117 & V_58 -> V_118 [ V_4 ] . V_70 ) != V_117 )
continue;
V_115 ++ ;
...
V_125 += ( V_116 * V_126 ) >> 1 ;
V_126 = F_17 ( ( V_126 << 1 ) | 1 , V_24 -> V_128 ) ;
V_122 += V_125 ;
...
if ( ! V_2 -> V_5 )
goto error;
V_2 -> V_113 = F_33 ( V_85 * V_28 , V_130 ) ;
if ( ! V_2 -> V_113 )
goto V_135;
V_2 -> V_54 = V_55 ;
return V_2 ;
