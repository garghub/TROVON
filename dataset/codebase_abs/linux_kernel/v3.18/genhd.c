...
V_3 -> V_72 = NULL ;
if ( ! V_74 )
F_80 ( V_75 , F_85 ( F_48 ( V_3 ) ) ) ;
F_58 ( F_48 ( V_3 ) , false ) ;
F_57 ( F_48 ( V_3 ) ) ;
}
struct V_2 * F_86 ( T_3 V_49 , int * V_4 )
{
struct V_2 * V_3 = NULL ;
if ( F_41 ( V_49 ) != V_57 ) {
struct V_63 * V_65 ;
V_65 = F_87 ( V_62 , V_49 , V_4 ) ;
if ( V_65 )
V_3 = F_88 ( F_89 ( V_65 ) ) ;
} else {
struct V_1 * V_5 ;
F_36 ( & V_52 ) ;
V_5 = F_90 ( & V_53 , F_30 ( F_43 ( V_49 ) ) ) ;
...
struct V_89 V_90 ;
struct V_66 * V_87 ;
F_94 ( & V_90 , & V_91 , NULL , & V_92 ) ;
while ( ( V_87 = F_95 ( & V_90 ) ) ) {
...
static void * F_97 ( struct V_27 * V_28 , T_5 * V_101 )
{
T_5 V_102 = * V_101 ;
struct V_89 * V_90 ;
struct V_66 * V_87 ;
...
static void * F_99 ( struct V_27 * V_28 , void * V_104 , T_5 * V_101 )
{
struct V_66 * V_87 ;
( * V_101 ) ++ ;
V_87 = F_95 ( V_28 -> V_103 ) ;
if ( V_87 )
return F_88 ( V_87 ) ;
return NULL ;
}
static void F_100 ( struct V_27 * V_28 , void * V_104 )
{
...
static void * F_101 ( struct V_27 * V_28 , T_5 * V_101 )
{
void * V_37 ;
V_37 = F_97 ( V_28 , V_101 ) ;
if ( ! F_102 ( V_37 ) && ! * V_101 )
F_103 ( V_28 , L_17 ) ;
return V_37 ;
}
static int F_104 ( struct V_27 * V_28 , void * V_104 )
{
struct V_2 * V_105 = V_104 ;
struct V_10 V_11 ;
struct V_1 * V_5 ;
char V_58 [ V_94 ] ;
if ( ! F_61 ( V_105 ) || ( ! F_105 ( V_105 ) &&
( V_105 -> V_12 & V_106 ) ) )
return 0 ;
if ( V_105 -> V_12 & V_96 )
return 0 ;
...
while ( ( V_5 = F_10 ( & V_11 ) ) )
F_20 ( V_28 , L_18 ,
F_41 ( F_92 ( V_5 ) ) , F_43 ( F_92 ( V_5 ) ) ,
( unsigned long long ) F_12 ( V_5 ) >> 1 ,
V_73 ( V_105 , V_5 -> V_4 , V_58 ) ) ;
F_13 ( & V_11 ) ;
return 0 ;
}
static int F_106 ( struct V_107 * V_107 , struct V_108 * V_108 )
{
return F_107 ( V_108 , & V_109 ) ;
}
static struct V_63 * F_108 ( T_3 V_49 , int * V_4 , void * V_64 )
{
if ( F_109 ( L_19 , F_41 ( V_49 ) , F_43 ( V_49 ) ) > 0 )
F_109 ( L_20 , F_41 ( V_49 ) ) ;
return NULL ;
}
...
{
struct V_2 * V_3 = F_88 ( V_87 ) ;
return sprintf ( V_58 , L_23 , F_105 ( V_3 ) ) ;
}
...
{
struct V_2 * V_3 = F_88 ( V_87 ) ;
return sprintf ( V_58 , L_23 , F_118 ( V_3 ) ? 1 : 0 ) ;
}
...
static T_6 F_120 ( struct V_66 * V_87 ,
struct V_112 * V_113 ,
char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_87 ) ;
return sprintf ( V_58 , L_23 , F_121 ( V_3 -> V_86 ) ) ;
}
static T_6 F_122 ( struct V_66 * V_87 ,
struct V_112 * V_113 ,
char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_87 ) ;
return sprintf ( V_58 , L_23 , F_123 ( V_3 -> V_86 ) ) ;
}
...
int F_126 ( struct V_2 * V_3 , int V_4 )
{
struct V_6 * V_115 = V_3 -> V_8 ;
struct V_6 * V_114 ;
...
T_7 V_118 ;
int V_22 ;
if ( F_105 ( V_3 ) && V_117 > F_105 ( V_3 ) )
return - V_119 ;
if ( V_117 <= V_9 )
return 0 ;
V_118 = sizeof( * V_114 ) + V_117 * sizeof( V_114 -> V_5 [ 0 ] ) ;
V_114 = F_127 ( V_118 , V_42 , V_3 -> V_120 ) ;
if ( ! V_114 )
return - V_43 ;
V_114 -> V_9 = V_117 ;
...
static void F_128 ( struct V_66 * V_87 )
{
struct V_2 * V_3 = F_88 ( V_87 ) ;
F_40 ( V_87 -> V_49 ) ;
F_129 ( V_3 ) ;
...
static char * F_133 ( struct V_66 * V_87 , T_8 * V_122 ,
...
static int F_134 ( struct V_27 * V_28 , void * V_104 )
{
...
F_20 ( V_28 , L_25
L_26 ,
F_41 ( F_92 ( V_127 ) ) , F_43 ( F_92 ( V_127 ) ) ,
V_73 ( V_126 , V_127 -> V_4 , V_58 ) ,
F_138 ( V_127 , V_129 [ V_130 ] ) ,
F_138 ( V_127 , V_131 [ V_130 ] ) ,
F_138 ( V_127 , V_132 [ V_130 ] ) ,
F_139 ( F_138 ( V_127 , V_133 [ V_130 ] ) ) ,
F_138 ( V_127 , V_129 [ V_134 ] ) ,
F_138 ( V_127 , V_131 [ V_134 ] ) ,
F_138 ( V_127 , V_132 [ V_134 ] ) ,
F_139 ( F_138 ( V_127 , V_133 [ V_134 ] ) ) ,
F_140 ( V_127 ) ,
F_139 ( F_138 ( V_127 , V_135 ) ) ,
F_139 ( F_138 ( V_127 , V_136 ) )
) ;
}
F_13 ( & V_11 ) ;
return 0 ;
}
static int F_141 ( struct V_107 * V_107 , struct V_108 * V_108 )
{
return F_107 ( V_108 , & V_137 ) ;
}
static int T_4 F_142 ( void )
{
F_143 ( L_27 , 0 , NULL , & V_138 ) ;
F_143 ( L_28 , 0 , NULL , & V_139 ) ;
return 0 ;
}
T_3 F_144 ( const char * V_35 , int V_4 )
{
T_3 V_49 = F_34 ( 0 , 0 ) ;
struct V_89 V_90 ;
struct V_66 * V_87 ;
...
struct V_2 * F_145 ( int V_50 )
{
return F_146 ( V_50 , V_140 ) ;
}
struct V_2 * F_146 ( int V_50 , int V_120 )
{
struct V_2 * V_3 ;
V_3 = F_127 ( sizeof( struct V_2 ) , V_42 , V_120 ) ;
if ( V_3 ) {
if ( ! F_147 ( & V_3 -> V_24 ) ) {
F_27 ( V_3 ) ;
return NULL ;
...
if ( V_144 && ! F_152 ( V_144 ) )
return NULL ;
V_65 = F_153 ( & F_48 ( V_3 ) -> V_65 ) ;
if ( V_65 == NULL ) {
F_154 ( V_144 ) ;
return NULL ;
}
...
static void F_156 ( struct V_2 * V_146 , int V_147 )
{
char V_148 [] = L_29 ;
char * V_149 [] = { V_148 , NULL } ;
if ( ! V_147 )
V_148 [ 8 ] = '0' ;
F_157 ( & F_48 ( V_146 ) -> V_65 , V_150 , V_149 ) ;
}
void F_158 ( struct V_68 * V_69 , int V_151 )
{
V_69 -> V_152 -> V_153 = V_151 ;
}
void F_159 ( struct V_2 * V_3 , int V_151 )
{
struct V_10 V_11 ;
struct V_1 * V_5 ;
...
if ( V_69 ) {
F_161 ( V_69 ) ;
V_154 = F_162 ( V_69 , true ) ;
F_163 ( V_69 ) ;
}
return V_154 ;
}
static unsigned long F_164 ( struct V_2 * V_3 )
{
...
V_162 = ! V_156 -> V_165 ++ ;
F_168 ( & V_156 -> V_164 , V_12 ) ;
if ( V_162 )
F_169 ( & V_3 -> V_156 -> V_166 ) ;
F_21 ( & V_156 -> V_163 ) ;
}
static void F_170 ( struct V_2 * V_3 , bool V_167 )
{
struct V_155 * V_156 = V_3 -> V_156 ;
unsigned long V_168 ;
unsigned long V_12 ;
...
goto V_169;
V_168 = F_164 ( V_3 ) ;
F_171 ( & V_156 -> V_166 . V_170 , V_168 / 4 ) ;
if ( V_167 )
F_172 ( V_171 ,
& V_156 -> V_166 , 0 ) ;
else if ( V_168 )
...
void F_174 ( struct V_2 * V_3 , unsigned int V_172 )
{
struct V_155 * V_156 = V_3 -> V_156 ;
if ( ! V_156 )
return;
...
unsigned int F_178 ( struct V_2 * V_3 , unsigned int V_172 )
{
...
F_177 ( & V_156 -> V_164 ) ;
F_179 ( V_156 , & V_173 ) ;
F_170 ( V_3 , V_156 -> V_173 ? true : false ) ;
F_175 ( & V_156 -> V_164 ) ;
...
static void F_180 ( struct V_179 * V_180 )
{
struct V_181 * V_166 = F_181 ( V_180 ) ;
struct V_155 * V_156 = F_182 ( V_166 , struct V_155 , V_166 ) ;
F_179 ( V_156 , & V_156 -> V_173 ) ;
}
static void F_179 ( struct V_155 * V_156 ,
unsigned int * V_182 )
{
...
if ( V_184 )
F_157 ( & F_48 ( V_3 ) -> V_65 , V_150 , V_149 ) ;
}
static T_6 F_183 ( unsigned int V_159 , char * V_58 )
{
...
{
struct V_2 * V_3 = F_88 ( V_87 ) ;
return F_183 ( V_3 -> V_159 , V_58 ) ;
}
static T_6 F_185 ( struct V_66 * V_87 ,
struct V_112 * V_113 , char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_87 ) ;
return F_183 ( V_3 -> V_160 , V_58 ) ;
}
...
static T_6 F_187 ( struct V_66 * V_87 ,
struct V_112 * V_113 ,
...
static int F_188 ( const char * V_189 ,
const struct V_190 * V_191 )
{
struct V_155 * V_156 ;
int V_39 ;
V_39 = F_189 ( V_189 , V_191 ) ;
if ( V_39 < 0 )
return V_39 ;
F_19 ( & V_192 ) ;
F_190 (ev, &disk_events, node)
F_174 ( V_156 -> V_3 , 0 ) ;
F_21 ( & V_192 ) ;
return 0 ;
}
...
if ( ! V_3 -> V_156 )
return;
if ( F_197 ( & F_48 ( V_3 ) -> V_65 , V_194 ) < 0 )
F_192 ( L_35 ,
V_3 -> V_73 ) ;
F_19 ( & V_192 ) ;
F_198 ( & V_3 -> V_156 -> V_193 , & V_155 ) ;
F_21 ( & V_192 ) ;
F_170 ( V_3 , true ) ;
}
...
F_166 ( V_3 ) ;
F_19 ( & V_192 ) ;
F_199 ( & V_3 -> V_156 -> V_193 ) ;
F_21 ( & V_192 ) ;
F_200 ( & F_48 ( V_3 ) -> V_65 , V_194 ) ;
}
