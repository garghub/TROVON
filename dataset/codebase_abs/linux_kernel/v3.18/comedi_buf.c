...
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_53 = V_23 -> V_44 + V_23 -> V_25 ;
return V_53 - V_23 -> V_41 ;
}
static unsigned int F_37 ( struct V_20 * V_21 ,
unsigned int V_54 ,
int V_55 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
...
unsigned int F_39 ( struct V_20 * V_21 ,
unsigned int V_54 )
{
return F_37 ( V_21 , V_54 , 0 ) ;
}
...
int F_50 ( struct V_20 * V_21 , unsigned short V_68 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_69 = F_37 ( V_21 , sizeof( short ) , 1 ) ;
if ( V_69 < sizeof( short ) ) {
V_23 -> V_52 |= V_70 ;
return 0 ;
}
* ( unsigned short * ) ( V_23 -> V_24 + V_23 -> V_45 ) = V_68 ;
F_44 ( V_21 , sizeof( short ) ) ;
return 1 ;
}
int F_51 ( struct V_20 * V_21 , unsigned short * V_68 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_69 = F_45 ( V_21 ) ;
if ( V_69 < sizeof( short ) )
return 0 ;
F_47 ( V_21 , sizeof( short ) ) ;
* V_68 = * ( unsigned short * ) ( V_23 -> V_24 + V_23 -> V_46 ) ;
F_49 ( V_21 , sizeof( short ) ) ;
return 1 ;
}
void F_52 ( struct V_20 * V_21 , unsigned int V_71 ,
const void * V_72 , unsigned int V_57 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_73 = V_23 -> V_45 + V_71 ;
if ( V_73 >= V_23 -> V_25 )
V_73 %= V_23 -> V_25 ;
while ( V_57 ) {
unsigned int V_63 ;
if ( V_73 + V_57 > V_23 -> V_25 )
V_63 = V_23 -> V_25 - V_73 ;
else
V_63 = V_57 ;
...
void F_53 ( struct V_20 * V_21 , unsigned int V_71 ,
void * V_74 , unsigned int V_54 )
{
void * V_75 ;
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_76 = V_23 -> V_46 + V_71 ;
if ( V_76 >= V_23 -> V_25 )
V_76 %= V_23 -> V_25 ;
while ( V_54 ) {
unsigned int V_63 ;
V_75 = V_23 -> V_24 + V_76 ;
if ( V_54 >= V_23 -> V_25 - V_76 )
V_63 = V_23 -> V_25 - V_76 ;
else
V_63 = V_54 ;
...
unsigned int F_54 ( struct V_20 * V_21 ,
const void * V_72 ,
unsigned int V_57 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
...
V_77 = F_39 ( V_21 , V_57 ) ;
if ( V_77 != V_57 ) {
F_55 ( V_21 -> V_65 -> V_31 , L_2 ) ;
V_23 -> V_52 |= V_78 ;
return 0 ;
}
F_52 ( V_21 , 0 , V_72 , V_57 ) ;
F_44 ( V_21 , V_57 ) ;
F_56 ( V_21 , V_57 ) ;
V_23 -> V_52 |= V_79 ;
return V_57 ;
...
void * V_72 , unsigned int V_57 )
{
if ( V_57 == 0 )
return 0 ;
V_57 = F_47 ( V_21 , V_57 ) ;
F_53 ( V_21 , 0 , V_72 , V_57 ) ;
F_49 ( V_21 , V_57 ) ;
F_56 ( V_21 , V_57 ) ;
V_21 -> V_23 -> V_52 |= V_79 ;
return V_57 ;
