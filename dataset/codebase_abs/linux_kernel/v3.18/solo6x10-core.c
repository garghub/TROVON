...
unsigned short * V_40 = ( unsigned short * ) V_38 ;
int V_19 ;
if ( V_39 & 0x1 )
F_34 ( V_31 , L_1 ) ;
if ( ! V_41 && V_39 > 64 ) {
...
| F_90 ( V_1 -> V_97 * 2 - 2 )
| F_91 ( 3 ) ;
F_3 ( V_1 , V_100 , V_1 -> V_98 ) ;
} else {
T_1 V_101 , V_102 ;
V_1 -> V_97 = 135 ;
if ( V_1 -> V_97 < 125 ) {
V_101 = 3 ;
V_102 = ( V_1 -> V_97 * 4 ) / 3 - 1 ;
} else {
V_101 = 2 ;
V_102 = ( V_1 -> V_97 * 2 ) / 3 - 1 ;
}
F_3 ( V_1 , V_103 ,
( 1 << 20 ) |
( 8 << 15 ) |
...
V_1 -> V_97 - 1 ) ;
F_92 ( 1 ) ;
V_53 = F_93 ( V_30 -> V_16 , F_6 , V_105 , V_93 ,
V_1 ) ;
if ( V_53 )
goto V_92;
F_94 ( V_1 , V_22 ) ;
...
if ( V_53 )
goto V_92;
V_53 = F_103 ( V_1 , V_111 ) ;
if ( V_53 )
goto V_92;
V_53 = F_104 ( V_1 ) ;
if ( V_53 )
goto V_92;
V_53 = F_105 ( V_1 , V_111 ) ;
if ( V_53 )
goto V_92;
V_53 = F_106 ( V_1 ) ;
if ( V_53 )
