...
F_60 ( & V_116 ) ;
if ( V_107 ) {
const char * V_133 = F_55 ( V_107 , V_112 , sizeof( V_112 ) ) ;
F_61 ( L_14 , V_133 ) ;
return - 1 ;
}
if ( F_62 ( V_116 ) )
...
static void F_76 ( int V_143 , int V_14 , struct V_8 * V_9 , double V_140 )
{
...
static void F_89 ( int V_143 , int V_14 , struct V_8 * V_9 , double V_140 )
{
