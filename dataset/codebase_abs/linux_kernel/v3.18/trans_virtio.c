...
static int
F_59 ( struct V_3 * V_4 , const char * V_98 , char * args )
{
struct V_5 * V_6 ;
int V_99 = - V_100 ;
int V_101 = 0 ;
F_3 ( & V_8 ) ;
F_60 (chan, &virtio_chan_list, chan_list) {
...
static void F_61 ( struct V_81 * V_12 )
{
