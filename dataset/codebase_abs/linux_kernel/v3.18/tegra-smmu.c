...
static bool F_60 ( enum V_102 V_103 )
{
return false ;
}
...
struct V_15 * V_16 = V_96 -> V_100 ;
struct V_1 * V_2 = V_16 -> V_2 ;
struct V_11 * V_104 , * V_12 ;
T_2 V_13 ;
int V_84 ;
V_104 = F_49 ( V_2 -> V_64 , sizeof( * V_12 ) , V_87 ) ;
if ( ! V_104 )
return - V_92 ;
V_104 -> V_64 = V_64 ;
V_104 -> V_16 = V_16 ;
V_13 = ( unsigned long ) V_64 -> V_105 ;
if ( ! V_13 )
return - V_19 ;
V_84 = F_62 ( V_104 , V_13 ) ;
if ( V_84 )
goto V_106;
F_63 ( & V_16 -> V_107 ) ;
F_21 (c, &as->client, list) {
...
F_16 ( & V_2 -> V_24 , V_23 ) ;
V_96 -> V_100 = V_16 ;
V_96 -> V_115 . V_116 = V_2 -> V_67 ;
V_96 -> V_115 . V_117 = V_2 -> V_67 +
V_2 -> V_68 * V_69 - 1 ;
V_96 -> V_115 . V_118 = true ;
...
static T_6 F_75 ( struct V_119 * V_119 ,
const char T_7 * V_120 ,
T_3 V_65 , T_8 * V_121 )
{
struct V_122 * V_123 ;
struct V_1 * V_2 ;
...
T_2 V_10 ;
T_3 V_8 ;
V_65 = F_76 ( T_3 , V_65 , sizeof( V_128 ) ) ;
if ( F_77 ( V_128 , V_120 , V_65 ) )
return - V_19 ;
for ( V_4 = 0 ; V_4 < F_78 ( V_127 ) ; V_4 ++ )
if ( strncmp ( V_128 , V_127 [ V_4 ] ,
strlen ( V_127 [ V_4 ] ) ) == 0 )
break;
if ( V_4 == F_78 ( V_127 ) )
return - V_19 ;
V_123 = F_79 ( V_119 ) -> V_129 ;
V_2 = V_123 -> V_2 ;
V_8 = F_22 ( V_123 -> V_130 ) ;
V_10 = F_2 ( V_2 , V_8 ) ;
switch ( V_4 ) {
case V_124 :
V_10 &= ~ V_131 ;
...
static int F_81 ( struct V_133 * V_134 , void * V_135 )
{
struct V_122 * V_123 = V_134 -> V_136 ;
struct V_1 * V_2 = V_123 -> V_2 ;
int V_4 ;
const char * const V_137 [] = { L_19 , L_20 , } ;
for ( V_4 = 0 ; V_4 < F_78 ( V_137 ) ; V_4 ++ ) {
T_2 V_10 ;
T_3 V_8 ;
V_8 = F_82 ( V_123 -> V_138 , V_123 -> V_130 , V_4 ) ;
V_10 = F_2 ( V_2 , V_8 ) ;
F_83 ( V_134 , L_21 , V_137 [ V_4 ] , V_10 ) ;
...
static int F_84 ( struct V_139 * V_139 , struct V_119 * V_119 )
{
return F_85 ( V_119 , F_81 , V_139 -> V_129 ) ;
}
...
T_3 V_98 ;
struct V_142 * V_143 ;
V_98 = F_78 ( V_144 ) * F_78 ( V_145 ) *
sizeof( * V_2 -> V_141 ) ;
V_2 -> V_141 = F_90 ( V_98 , V_87 ) ;
if ( ! V_2 -> V_141 )
return;
V_143 = F_91 ( F_64 ( V_2 -> V_64 ) , NULL ) ;
if ( ! V_143 )
goto V_90;
V_2 -> V_140 = V_143 ;
for ( V_4 = 0 ; V_4 < F_78 ( V_144 ) ; V_4 ++ ) {
int V_146 ;
struct V_142 * V_138 ;
V_138 = F_91 ( V_144 [ V_4 ] , V_143 ) ;
if ( ! V_138 )
goto V_90;
for ( V_146 = 0 ; V_146 < F_78 ( V_145 ) ; V_146 ++ ) {
struct V_142 * V_130 ;
struct V_122 * V_123 ;
V_123 = V_2 -> V_141 ;
V_123 += V_4 * F_78 ( V_144 ) + V_146 ;
V_123 -> V_2 = V_2 ;
V_123 -> V_138 = V_4 ;
V_123 -> V_130 = V_146 ;
V_130 = F_92 ( V_145 [ V_146 ] ,
V_147 | V_148 , V_138 ,
( void * ) V_123 ,
& V_149 ) ;
if ( ! V_130 )
...
static int F_96 ( struct V_150 * V_151 )
{
struct V_1 * V_2 ;
struct V_66 * V_64 = & V_151 -> V_64 ;
int V_4 , V_152 , V_84 = 0 ;
T_4 V_153 ( V_154 ) ;
T_3 V_98 , V_153 ( V_155 ) ;
if ( V_113 )
return - V_156 ;
F_97 ( V_83 != V_157 ) ;
if ( F_98 ( V_64 -> V_158 , L_24 , & V_152 ) )
return - V_159 ;
V_98 = sizeof( * V_2 ) + V_152 * sizeof( * V_2 -> V_16 ) ;
...
for ( V_4 = 0 ; V_4 < V_2 -> V_5 ; V_4 ++ ) {
struct V_161 * V_162 ;
V_162 = F_99 ( V_151 , V_163 , V_4 ) ;
V_2 -> V_6 [ V_4 ] = F_100 ( & V_151 -> V_64 , V_162 ) ;
if ( F_101 ( V_2 -> V_6 [ V_4 ] ) )
return F_102 ( V_2 -> V_6 [ V_4 ] ) ;
V_2 -> V_7 [ V_4 ] = V_2 -> V_6 [ V_4 ] + F_103 ( V_162 ) - 1 ;
}
V_2 -> V_9 = ( void T_1 * ) ( ( T_2 ) V_2 -> V_6 [ 0 ] & V_164 ) ;
V_84 = F_104 ( V_64 -> V_158 , NULL , 0 , NULL , & V_154 , & V_155 ) ;
if ( V_84 )
return - V_159 ;
if ( V_155 & V_165 )
return - V_19 ;
...
if ( ! V_155 )
return - V_19 ;
V_2 -> V_51 = F_105 ( V_64 -> V_158 , L_26 , 0 ) ;
if ( ! V_2 -> V_51 )
return - V_159 ;
V_2 -> V_64 = V_64 ;
V_2 -> V_33 = V_152 ;
