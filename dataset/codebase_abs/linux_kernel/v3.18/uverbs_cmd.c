...
V_92 . V_429 = 0 ;
memset ( & V_92 . V_430 , 0 , sizeof( V_92 . V_430 ) ) ;
...
if ( V_52 . V_433 == V_432 -> V_145 &&
! memcmp ( V_52 . V_434 , V_432 -> V_434 . V_359 , sizeof V_432 -> V_434 . V_359 ) ) {
V_15 = 0 ;
goto V_283;
}
V_432 = F_67 ( sizeof *V_432 , V_16 ) ;
if ( ! V_432 ) {
V_15 = - V_157 ;
goto V_283;
}
V_432 -> V_145 = V_52 . V_433 ;
memcpy ( V_432 -> V_434 . V_359 , V_52 . V_434 , sizeof V_432 -> V_434 . V_359 ) ;
V_15 = F_143 ( V_39 , & V_432 -> V_434 , V_52 . V_433 ) ;
if ( ! V_15 )
F_69 ( & V_432 -> V_163 , & V_181 -> V_325 ) ;
else
F_6 ( V_432 ) ;
V_283:
F_40 ( V_39 ) ;
...
if ( ! V_39 )
return - V_65 ;
V_15 = F_145 ( V_39 , (union V_435 * ) V_52 . V_434 , V_52 . V_433 ) ;
if ( V_15 )
goto V_283;
V_181 = F_7 ( V_39 -> V_27 , struct V_289 , V_299 . V_27 ) ;
F_142 (mcast, &obj->mcast_list, list)
...
static int F_146 ( struct V_436 * V_437 ,
union V_438 * V_439 )
{
if ( V_437 -> V_277 )
return - V_65 ;
V_439 -> type = V_437 -> type ;
switch ( V_439 -> type ) {
case V_440 :
V_439 -> V_441 . V_442 = sizeof( struct V_443 ) ;
if ( V_439 -> V_441 . V_442 != V_437 -> V_441 . V_442 )
return - V_65 ;
memcpy ( & V_439 -> V_441 . V_444 , & V_437 -> V_441 . V_444 ,
sizeof( struct V_445 ) ) ;
memcpy ( & V_439 -> V_441 . V_373 , & V_437 -> V_441 . V_373 ,
sizeof( struct V_445 ) ) ;
break;
case V_446 :
V_439 -> V_447 . V_442 = sizeof( struct V_448 ) ;
if ( V_439 -> V_447 . V_442 != V_437 -> V_447 . V_442 )
return - V_65 ;
memcpy ( & V_439 -> V_447 . V_444 , & V_437 -> V_447 . V_444 ,
sizeof( struct V_449 ) ) ;
memcpy ( & V_439 -> V_447 . V_373 , & V_437 -> V_447 . V_373 ,
sizeof( struct V_449 ) ) ;
break;
case V_450 :
case V_451 :
V_439 -> V_452 . V_442 = sizeof( struct V_453 ) ;
if ( V_439 -> V_452 . V_442 != V_437 -> V_452 . V_442 )
return - V_65 ;
memcpy ( & V_439 -> V_452 . V_444 , & V_437 -> V_452 . V_444 ,
sizeof( struct V_454 ) ) ;
memcpy ( & V_439 -> V_452 . V_373 , & V_437 -> V_452 . V_373 ,
sizeof( struct V_454 ) ) ;
break;
default:
return - V_65 ;
...
void * V_439 ;
int V_390 ;
if ( V_455 -> V_465 < sizeof( V_52 ) )
return - V_65 ;
if ( V_455 -> V_466 < sizeof( V_54 ) )
return - V_63 ;
V_66 = F_148 ( & V_52 , V_455 , sizeof( V_52 ) ) ;
if ( V_66 )
return V_66 ;
V_455 -> V_467 += sizeof( V_52 ) ;
V_455 -> V_465 -= sizeof( V_52 ) ;
if ( V_52 . V_468 )
return - V_65 ;
if ( ( V_52 . V_464 . type == V_469 &&
! F_116 ( V_470 ) ) || ! F_116 ( V_297 ) )
return - V_298 ;
if ( V_52 . V_464 . V_471 > V_472 )
return - V_65 ;
if ( V_52 . V_464 . V_442 > V_455 -> V_465 ||
V_52 . V_464 . V_442 >
( V_52 . V_464 . V_471 * sizeof( struct V_436 ) ) )
return - V_65 ;
if ( V_52 . V_464 . V_277 [ 0 ] ||
V_52 . V_464 . V_277 [ 1 ] )
return - V_65 ;
if ( V_52 . V_464 . V_471 ) {
V_462 = F_67 ( sizeof( * V_462 ) + V_52 . V_464 . V_442 ,
V_16 ) ;
if ( ! V_462 )
return - V_157 ;
memcpy ( V_462 , & V_52 . V_464 , sizeof( * V_462 ) ) ;
V_66 = F_148 ( V_462 + 1 , V_455 ,
V_52 . V_464 . V_442 ) ;
if ( V_66 )
goto V_473;
} else {
...
V_464 = F_67 ( sizeof( * V_464 ) + V_52 . V_464 . V_442 , V_16 ) ;
if ( ! V_464 ) {
V_66 = - V_157 ;
goto V_210;
}
V_464 -> type = V_462 -> type ;
V_464 -> V_476 = V_462 -> V_476 ;
V_464 -> V_471 = V_462 -> V_471 ;
V_464 -> V_477 = V_462 -> V_477 ;
V_464 -> V_218 = V_462 -> V_218 ;
V_464 -> V_442 = sizeof( * V_464 ) ;
V_437 = V_462 + 1 ;
V_439 = V_464 + 1 ;
for ( V_390 = 0 ; V_390 < V_464 -> V_471 &&
V_52 . V_464 . V_442 > F_149 ( struct V_436 , V_277 ) &&
V_52 . V_464 . V_442 >=
( (struct V_436 * ) V_437 ) -> V_442 ; V_390 ++ ) {
V_66 = F_146 ( V_437 , V_439 ) ;
if ( V_66 )
goto V_81;
V_464 -> V_442 +=
( (union V_438 * ) V_439 ) -> V_442 ;
V_52 . V_464 . V_442 -= ( (struct V_436 * ) V_437 ) -> V_442 ;
V_437 += ( (struct V_436 * ) V_437 ) -> V_442 ;
V_439 += ( (union V_438 * ) V_439 ) -> V_442 ;
}
if ( V_52 . V_464 . V_442 || ( V_390 != V_464 -> V_471 ) ) {
F_150 ( L_1 ,
V_390 , V_52 . V_464 . V_442 ) ;
V_66 = - V_65 ;
goto V_81;
}
V_460 = F_151 ( V_39 , V_464 , V_478 ) ;
if ( F_49 ( V_460 ) ) {
V_66 = F_50 ( V_460 ) ;
goto V_81;
}
...
if ( V_455 -> V_465 < sizeof( V_52 ) )
return - V_65 ;
V_15 = F_148 ( & V_52 , V_455 , sizeof( V_52 ) ) ;
if ( V_15 )
return V_15 ;
if ( V_52 . V_468 )
return - V_65 ;
V_2 = F_28 ( & V_479 , V_52 . V_481 ,
V_48 -> V_61 ) ;
if ( ! V_2 )
return - V_65 ;
V_460 = V_2 -> V_22 ;
...
if ( ! V_181 )
return - V_157 ;
F_1 ( & V_181 -> V_299 . V_27 , V_52 -> V_3 , V_48 -> V_61 , & V_487 ) ;
F_29 ( & V_181 -> V_299 . V_27 . V_9 ) ;
if ( V_52 -> V_306 == V_488 ) {
V_92 . V_489 . V_490 . V_167 = F_43 ( V_52 -> V_45 , V_48 -> V_61 , & V_291 ) ;
if ( ! V_92 . V_489 . V_490 . V_167 ) {
V_15 = - V_65 ;
goto V_66;
}
V_181 -> V_330 = F_7 ( V_291 , struct V_180 , V_27 ) ;
F_87 ( & V_181 -> V_330 -> V_196 ) ;
V_92 . V_489 . V_490 . V_31 = F_33 ( V_52 -> V_29 , V_48 -> V_61 , 0 ) ;
if ( ! V_92 . V_489 . V_490 . V_31 ) {
V_15 = - V_65 ;
goto V_491;
}
}
...
V_92 . V_92 . V_495 = V_52 -> V_495 ;
V_92 . V_92 . V_104 = V_52 -> V_104 ;
V_92 . V_92 . V_496 = V_52 -> V_496 ;
V_181 -> V_299 . V_323 = 0 ;
F_51 ( & V_181 -> V_299 . V_324 ) ;
V_43 = V_26 -> V_59 -> V_497 ( V_26 , & V_92 , V_56 ) ;
if ( F_49 ( V_43 ) ) {
V_15 = F_50 ( V_43 ) ;
goto V_210;
}
...
V_43 -> V_87 = V_92 . V_87 ;
V_43 -> V_494 = V_92 . V_494 ;
if ( V_52 -> V_306 == V_488 ) {
V_43 -> V_489 . V_490 . V_31 = V_92 . V_489 . V_490 . V_31 ;
V_43 -> V_489 . V_490 . V_167 = V_92 . V_489 . V_490 . V_167 ;
F_87 ( & V_92 . V_489 . V_490 . V_31 -> V_160 ) ;
F_87 ( & V_92 . V_489 . V_490 . V_167 -> V_160 ) ;
}
F_87 ( & V_26 -> V_160 ) ;
F_68 ( & V_43 -> V_160 , 0 ) ;
...
V_54 . V_495 = V_92 . V_92 . V_495 ;
V_54 . V_104 = V_92 . V_92 . V_104 ;
if ( V_52 -> V_306 == V_488 )
V_54 . V_498 = V_43 -> V_489 . V_490 . V_499 ;
if ( F_54 ( ( void T_3 * ) ( unsigned long ) V_52 -> V_67 ,
& V_54 , sizeof V_54 ) ) {
V_15 = - V_64 ;
goto V_162;
...
if ( F_46 ( & V_52 , V_49 , sizeof V_52 ) )
return - V_64 ;
V_500 . V_67 = V_52 . V_67 ;
V_500 . V_3 = V_52 . V_3 ;
V_500 . V_306 = V_307 ;
V_500 . V_24 = V_52 . V_24 ;
V_500 . V_495 = V_52 . V_495 ;
V_500 . V_104 = V_52 . V_104 ;
V_500 . V_496 = V_52 . V_496 ;
F_48 ( & V_56 , V_49 + sizeof V_52 ,
( unsigned long ) V_52 . V_67 + sizeof V_54 ,
V_50 - sizeof V_52 , V_51 - sizeof V_54 ) ;
V_15 = F_155 ( V_48 , & V_500 , & V_56 ) ;
if ( V_15 )
return V_15 ;
return V_50 ;
}
T_2 V_483 ( struct V_47 * V_48 ,
const char T_3 * V_49 , int V_50 , int V_51 )
{
struct V_483 V_52 ;
struct V_484 V_54 ;
...
if ( ! V_43 )
return - V_65 ;
V_92 . V_495 = V_52 . V_495 ;
V_92 . V_496 = V_52 . V_496 ;
V_15 = V_43 -> V_59 -> V_502 ( V_43 , & V_92 , V_52 . V_336 , & V_56 ) ;
F_42 ( V_43 ) ;
return V_15 ? V_15 : V_50 ;
}
...
return V_15 ;
memset ( & V_54 , 0 , sizeof V_54 ) ;
V_54 . V_495 = V_92 . V_495 ;
V_54 . V_104 = V_92 . V_104 ;
V_54 . V_496 = V_92 . V_496 ;
if ( F_54 ( ( void T_3 * ) ( unsigned long ) V_52 . V_67 ,
& V_54 , sizeof V_54 ) )
return - V_64 ;
return V_50 ;
...
return - V_65 ;
V_43 = V_2 -> V_22 ;
V_181 = F_7 ( V_2 , struct V_505 , V_27 ) ;
V_306 = V_43 -> V_306 ;
V_15 = F_156 ( V_43 ) ;
if ( ! V_15 )
V_2 -> V_12 = 0 ;
...
return V_15 ;
if ( V_306 == V_488 ) {
V_506 = F_7 ( V_181 , struct V_485 , V_299 ) ;
F_89 ( & V_506 -> V_330 -> V_196 ) ;
}
F_20 ( & V_42 , V_2 ) ;
F_47 ( & V_48 -> V_9 ) ;
F_72 ( & V_2 -> V_163 ) ;
