...
* ( V_200 * ) V_199 = F_94 ( V_27 -> V_201 [ V_6 ] ) ;
return 0 ;
}
...
return V_97 ;
for ( V_6 = 0 ; V_6 < V_197 ; V_6 ++ , V_199 += 4 ) {
T_1 V_201 = F_96 ( * ( V_200 * ) V_199 ) ;
if ( V_27 -> V_201 [ V_6 ] == V_201 )
continue;
V_27 -> V_201 [ V_6 ] = V_201 ;
F_79 ( V_39 , F_40 ( 0 , V_6 ) , V_201 ) ;
}
return 0 ;
}
...
{
struct V_26 * V_27 = F_4 ( V_2 ) ;
unsigned int V_202 = V_27 -> V_39 . V_49 . V_64 ;
T_2 V_203 = F_98 ( V_2 ) ;
if ( V_203 > 1 )
V_202 = 1 << ( F_99 ( V_202 / V_203 ) - 1 ) ;
return V_202 ;
}
...
struct V_26 * V_27 = F_4 ( V_2 ) ;
struct V_38 * V_39 = & V_27 -> V_39 ;
V_205 -> V_202 = F_97 ( V_2 ) ;
V_205 -> V_206 = F_101 ( V_39 ) ;
V_205 -> V_207 = V_205 -> V_206 ;
V_205 -> V_208 = V_27 -> V_194 [ V_195 ] . V_196 ;
}
static int F_102 ( struct V_1 * V_2 ,
struct V_204 * V_205 )
{
struct V_26 * V_27 = F_4 ( V_2 ) ;
unsigned int V_107 = V_205 -> V_208 ;
struct V_38 * V_39 = & V_27 -> V_39 ;
if ( ! V_107 || V_205 -> V_209 || V_205 -> V_210 )
return - V_81 ;
if ( V_205 -> V_207 != F_101 ( V_39 ) )
return - V_81 ;
if ( V_107 > F_97 ( V_2 ) )
return - V_81 ;
V_27 -> V_194 [ V_195 ] . V_211 = V_107 ;
