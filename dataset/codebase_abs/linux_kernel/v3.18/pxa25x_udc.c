...
static int F_76 ( struct V_128 * V_170 ,
struct V_171 * V_39 )
{
struct V_24 * V_25 = F_72 ( V_170 ) ;
F_77 () ;
...
F_86 ( V_189 . V_186 . V_197 ) ,
F_86 ( V_189 . V_186 . V_198 ) ,
F_86 ( V_189 . V_186 . V_199 ) ) ;
...
F_88 ( & V_25 -> V_23 [ V_123 ] ) ;
V_78 |= V_146 ;
V_217 = 1 ;
}
#ifndef F_90
if ( V_221 & V_146 ) {
F_88 ( & V_25 -> V_23 [ V_123 + 8 ] ) ;
V_147 |= V_146 ;
V_217 = 1 ;
}
#endif
...
static void F_91 ( struct V_222 * V_25 )
{
F_13 ( L_89 , V_31 , F_92 ( V_25 ) ) ;
}
...
if ( V_177 < 0 )
return - V_125 ;
V_25 -> V_139 = F_98 ( & V_224 -> V_25 , NULL ) ;
if ( F_99 ( V_25 -> V_139 ) )
return F_100 ( V_25 -> V_139 ) ;
F_101 ( L_93 , V_227 , V_177 ,
V_25 -> V_106 ? L_11 : L_94 ,
V_247 L_38
) ;
V_25 -> V_25 = & V_224 -> V_25 ;
V_25 -> V_2 = F_102 ( & V_224 -> V_25 ) ;
V_25 -> V_141 = F_103 ( & V_224 -> V_25 , V_248 ) ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
V_172 = F_104 ( & V_224 -> V_25 , V_25 -> V_2 -> V_6 ,
L_95 ) ;
if ( V_172 ) {
F_105 ( & V_224 -> V_25 ,
L_96 ,
...
F_106 ( V_25 -> V_2 -> V_6 , 0 ) ;
}
F_107 ( & V_25 -> V_175 ) ;
V_25 -> V_175 . V_250 = F_83 ;
...
F_69 ( V_25 ) ;
V_25 -> V_136 = 0 ;
V_172 = F_109 ( & V_224 -> V_25 , V_177 , F_89 , 0 ,
V_227 , V_25 ) ;
if ( V_172 != 0 ) {
F_95 ( L_97 ,
V_227 , V_177 , V_172 ) ;
...
#endif
F_112 ( V_25 ) ;
V_172 = F_113 ( & V_224 -> V_25 , & V_25 -> V_40 ) ;
if ( ! V_172 )
return V_172 ;
F_114 ( V_25 ) ;
V_249:
...
static void F_115 ( struct V_223 * V_178 )
{
F_1 () ;
}
static int F_116 ( struct V_223 * V_224 )
{
struct V_24 * V_25 = F_117 ( V_224 ) ;
if ( V_25 -> V_39 )
return - V_253 ;
F_118 ( & V_25 -> V_40 ) ;
V_25 -> F_54 = 0 ;
...
static int F_119 ( struct V_223 * V_25 , T_6 V_254 )
{
struct V_24 * V_134 = F_117 ( V_25 ) ;
unsigned long V_48 ;
if ( ! F_2 ( V_134 -> V_2 -> V_6 ) && ! V_134 -> V_2 -> V_7 )
F_87 ( L_99 ) ;
V_134 -> V_137 = 1 ;
...
static int F_120 ( struct V_223 * V_25 )
{
struct V_24 * V_134 = F_117 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
