...
if ( ! V_49 -> V_164 )
return - V_165 ;
V_160 = V_49 -> V_164 ( V_2 -> V_53 , & V_38 -> V_166 ) ;
if ( ! V_160 )
...
struct V_146 * V_49 = V_2 -> V_49 ;
if ( V_49 -> V_191 )
return V_49 -> V_191 ( V_138 , V_189 , V_190 ) ;
return V_190 ;
}
...
if ( ! ( V_49 -> V_50 & V_120 ) )
V_49 -> V_202 = NULL ;
V_201 = F_97 ( V_53 , V_203 , 0 ) ;
if ( ! V_201 )
return - V_89 ;
V_38 = F_98 ( sizeof( struct V_1 ) , & V_53 -> V_66 ) ;
if ( ! V_38 )
return - V_204 ;
V_160 = F_99 ( V_38 ) ;
if ( V_160 < 0 )
...
if ( V_160 < 0 )
goto V_205;
V_199 -> V_206 = F_101 ( V_201 -> V_207 , F_102 ( V_201 ) ) ;
if ( ! V_199 -> V_206 ) {
V_160 = - V_204 ;
goto V_205;
}
...
F_104 ( & V_199 -> V_64 ) ;
F_105 ( & V_199 -> V_176 ) ;
F_106 ( & V_199 -> V_61 , F_25 ) ;
F_107 ( & V_199 -> V_71 , F_37 ) ;
F_108 ( V_199 , V_49 ) ;
F_109 ( & V_53 -> V_66 ) ;
F_110 ( & V_53 -> V_66 , 50 ) ;
F_111 ( & V_53 -> V_66 ) ;
...
int F_127 ( struct V_175 * V_66 )
{
struct V_37 * V_38 = F_128 ( V_66 ) ;
struct V_1 * V_2 = F_13 ( V_38 ) ;
F_3 ( V_2 , V_226 ) ;
if ( V_2 -> V_185 )
F_21 ( V_2 ) ;
if ( V_2 -> V_49 -> V_228 )
V_2 -> V_49 -> V_228 ( V_2 -> V_53 ) ;
return 0 ;
}
