...
static void F_71 ( T_3 * V_71 , T_3 V_72 )
{
T_3 V_73 ;
while ( V_72 > ( V_73 = F_72 ( * V_71 ) ) )
F_73 ( V_71 , V_73 , V_72 ) ;
}
static void F_74 ( struct V_45 * V_3 ,
struct V_20 * V_62 ,
T_3 * V_63 , T_3 * V_64 )
{
T_3 V_67 , V_30 , V_22 ;
...
T_3 V_68 = V_30 + V_22 ;
V_30 = F_68 ( ( V_26 T_2 ) V_30 ,
( V_26 T_2 ) V_67 , ( V_26 T_2 ) V_68 ) ;
V_22 = V_67 - V_30 ;
}
F_71 ( & V_62 -> V_30 , V_30 ) ;
F_71 ( & V_62 -> V_22 , V_22 ) ;
...
F_74 ( & V_20 , & V_16 -> V_76 , V_63 , V_64 ) ;
}
void F_62 ( struct V_2 * V_16 , T_3 * V_63 , T_3 * V_64 )
{
struct V_45 V_20 ;
F_40 ( V_16 , & V_20 ) ;
F_74 ( & V_20 , & V_16 -> signal -> V_76 , V_63 , V_64 ) ;
}
static unsigned long long F_75 ( struct V_2 * V_44 )
{
unsigned long long clock ;
clock = F_76 () ;
if ( clock < V_44 -> V_77 )
return 0 ;
return clock - V_44 -> V_77 ;
}
static T_3 F_77 ( struct V_2 * V_44 )
{
unsigned long long V_5 = F_75 ( V_44 ) ;
F_78 ( V_44 -> V_78 == V_79 ) ;
V_44 -> V_77 += V_5 ;
return F_38 ( V_5 ) ;
}
static void F_79 ( struct V_2 * V_44 )
{
T_3 V_80 = F_77 ( V_44 ) ;
F_28 ( V_44 , F_29 () , V_80 , F_49 ( V_80 ) ) ;
}
...
void F_86 ( struct V_2 * V_49 , int V_6 )
{
unsigned long V_4 ;
F_87 ( & V_49 -> V_81 , V_4 ) ;
V_49 -> V_78 = V_83 ;
...
continue;
V_5 = F_75 ( V_49 ) ;
if ( V_49 -> V_78 == V_82 || V_49 -> V_4 & V_33 ) {
* V_88 = V_5 ;
} else {
if ( V_49 -> V_78 == V_83 )
* V_89 = V_5 ;
