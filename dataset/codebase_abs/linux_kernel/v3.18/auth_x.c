...
F_5 ( V_81 ) ;
F_3 ( L_13 , V_76 ) ;
if ( V_75 -> V_71 && V_75 -> V_71 -> V_82 < V_76 ) {
F_24 ( V_75 -> V_71 ) ;
V_75 -> V_71 = NULL ;
}
if ( ! V_75 -> V_71 ) {
V_75 -> V_71 = F_42 ( V_76 , V_26 ) ;
if ( ! V_75 -> V_71 )
return - V_27 ;
}
V_75 -> V_31 = V_32 -> V_31 ;
V_75 -> V_66 = V_32 -> V_66 ;
V_78 = V_75 -> V_71 -> V_69 . V_83 ;
V_78 -> V_18 = 1 ;
V_78 -> V_84 = F_7 ( V_2 -> V_84 ) ;
V_78 -> V_85 = F_43 ( V_32 -> V_31 ) ;
V_78 -> V_40 . V_18 = 1 ;
V_78 -> V_40 . V_66 = F_7 ( V_32 -> V_66 ) ;
V_78 -> V_40 . V_86 = F_43 ( V_81 ) ;
if ( V_81 ) {
memcpy ( V_78 -> V_40 . V_87 , V_32 -> V_40 -> V_69 . V_83 ,
V_32 -> V_40 -> V_69 . V_70 ) ;
}
...
V_22 = V_78 + 1 ;
V_22 += V_81 ;
V_23 = V_75 -> V_71 -> V_69 . V_83 + V_75 -> V_71 -> V_69 . V_70 ;
F_44 ( & V_75 -> V_88 , sizeof( V_75 -> V_88 ) ) ;
V_80 . V_18 = 1 ;
V_80 . V_88 = F_7 ( V_75 -> V_88 ) ;
V_21 = F_6 ( & V_32 -> V_39 , & V_80 , sizeof( V_80 ) ,
V_22 , V_23 - V_22 ) ;
if ( V_21 < 0 )
goto V_89;
V_22 += V_21 ;
V_75 -> V_71 -> V_69 . V_70 = V_22 - V_75 -> V_71 -> V_69 . V_83 ;
F_3 ( L_15 , V_75 -> V_88 ,
( int ) V_75 -> V_71 -> V_69 . V_70 ) ;
F_45 ( V_75 -> V_71 -> V_69 . V_70 > V_76 ) ;
return 0 ;
V_89:
F_24 ( V_75 -> V_71 ) ;
V_75 -> V_71 = NULL ;
...
F_48 ( V_22 , V_32 -> V_66 ) ;
if ( V_32 -> V_40 ) {
const char * V_71 = V_32 -> V_40 -> V_69 . V_83 ;
V_11 V_20 = V_32 -> V_40 -> V_69 . V_70 ;
F_49 ( V_22 , V_23 , V_20 , V_63 ) ;
F_50 ( V_22 , V_23 , V_71 , V_20 , V_63 ) ;
} else {
F_49 ( V_22 , V_23 , 0 , V_63 ) ;
}
return 0 ;
V_63:
return - V_90 ;
...
return - V_90 ;
F_3 ( L_17 ) ;
V_17 -> V_101 = F_52 ( V_102 ) ;
F_44 ( & V_96 -> V_103 , sizeof( T_3 ) ) ;
...
if ( V_22 > V_23 )
return - V_90 ;
V_17 -> V_101 = F_52 ( V_109 ) ;
V_21 = F_41 ( V_2 , V_32 , & V_4 -> V_110 ) ;
if ( V_21 )
return V_21 ;
F_53 ( & V_22 , V_4 -> V_110 . V_71 -> V_69 . V_83 ,
V_4 -> V_110 . V_71 -> V_69 . V_70 ) ;
V_108 = V_22 ;
V_108 -> V_111 = F_43 ( V_6 ) ;
V_22 += sizeof( * V_108 ) ;
return V_22 - V_71 ;
}
return 0 ;
}
static int F_54 ( struct V_1 * V_2 , int V_112 ,
void * V_71 , void * V_23 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
V_101 = F_55 ( V_17 -> V_101 ) ;
V_112 = F_56 ( V_17 -> V_112 ) ;
...
V_96 -> V_122 = V_75 -> V_71 -> V_69 . V_83 ;
...
struct V_121 * V_127 , T_1 V_20 )
{
struct V_74 * V_75 = ( void * ) V_127 ;
struct V_30 * V_32 ;
int V_21 = 0 ;
struct V_128 V_129 ;
void * V_130 = & V_129 ;
...
V_32 = F_15 ( V_2 , V_75 -> V_31 ) ;
if ( F_30 ( V_32 ) )
return F_31 ( V_32 ) ;
V_21 = F_10 ( & V_32 -> V_39 , & V_22 , V_23 , & V_130 , sizeof( V_129 ) ) ;
if ( V_21 < 0 )
return V_21 ;
if ( V_21 != sizeof( V_129 ) )
return - V_29 ;
if ( V_75 -> V_88 + 1 != F_14 ( V_129 . V_131 ) )
V_21 = - V_29 ;
else
V_21 = 0 ;
F_3 ( L_22 ,
V_75 -> V_88 , F_14 ( V_129 . V_131 ) , V_21 ) ;
return V_21 ;
}
