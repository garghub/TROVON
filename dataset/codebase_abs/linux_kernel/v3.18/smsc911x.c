...
F_174 ( V_330 , L_107 , & V_4 -> V_333 ) ;
F_174 ( V_330 , L_108 , & V_332 ) ;
if ( V_332 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
...
struct V_23 * V_29 ;
struct V_1 * V_2 ;
struct V_328 * V_4 = F_177 ( & V_22 -> V_29 ) ;
...
if ( ! F_179 ( V_325 -> V_327 , V_338 , V_287 ) ) {
V_340 = - V_274 ;
goto V_341;
}
...
V_2 -> V_7 = F_182 ( V_325 -> V_327 , V_338 ) ;
V_2 -> V_29 = V_29 ;
V_2 -> V_291 = ( ( 1 << V_345 ) - 1 ) ;
F_183 ( V_22 , V_29 ) ;
V_340 = F_33 ( V_22 ) ;
...
static int F_189 ( struct V_354 * V_29 )
{
struct V_23 * V_24 = F_190 ( V_29 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
F_14 ( V_2 , V_315 ,
V_355 | V_356 |
V_357 | V_358 ) ;
...
static int F_191 ( struct V_354 * V_29 )
{
struct V_23 * V_24 = F_190 ( V_29 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_313 = 100 ;
