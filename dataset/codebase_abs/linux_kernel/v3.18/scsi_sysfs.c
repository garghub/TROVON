...
{
struct V_13 * V_14 = F_107 ( V_128 -> V_28 . V_65 ) ;
unsigned long V_52 ;
struct V_60 * V_61 ;
F_22 ( V_14 -> V_56 , V_52 ) ;
V_143:
F_108 (sdev, &shost->__devices, siblings) {
...
{
struct V_13 * V_14 = F_107 ( V_28 -> V_65 ) ;
struct V_127 * V_128 , * V_11 = NULL ;
unsigned long V_52 ;
F_22 ( V_14 -> V_56 , V_52 ) ;
F_108 (starget, &shost->__targets, siblings) {
if ( V_128 -> V_2 == V_144 )
continue;
...
V_61 -> V_62 . type = & V_85 ;
F_121 ( & V_61 -> V_62 , L_26 ,
V_61 -> V_70 -> V_154 , V_61 -> V_20 , V_61 -> V_21 , V_61 -> V_22 ) ;
F_120 ( & V_61 -> V_135 ) ;
V_61 -> V_135 . V_65 = F_122 ( & V_61 -> V_62 ) ;
V_61 -> V_135 . V_150 = & V_93 ;
F_121 ( & V_61 -> V_135 , L_26 ,
V_61 -> V_70 -> V_154 , V_61 -> V_20 , V_61 -> V_21 , V_61 -> V_22 ) ;
...
F_123 ( & V_61 -> V_62 ) ;
F_22 ( V_14 -> V_56 , V_52 ) ;
F_124 ( & V_61 -> V_72 , & V_128 -> V_160 ) ;
F_124 ( & V_61 -> V_71 , & V_14 -> V_161 ) ;
F_24 ( V_14 -> V_56 , V_52 ) ;
F_112 ( & V_128 -> V_145 ) ;
}
int F_125 ( const struct V_27 * V_28 )
{
