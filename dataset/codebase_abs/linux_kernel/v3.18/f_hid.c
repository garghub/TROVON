...
static int F_38 ( struct V_2 * V_3 , unsigned V_88 , unsigned V_89 )
{
struct V_62 * V_38 = V_3 -> V_37 -> V_38 ;
struct V_1 * V_9 = F_1 ( V_3 ) ;
int V_90 , V_36 = 0 ;
F_34 ( V_38 , L_15 , V_88 , V_89 ) ;
if ( V_9 -> V_49 != NULL ) {
if ( V_9 -> V_49 -> V_35 != NULL )
F_36 ( V_9 -> V_49 ) ;
V_36 = F_39 ( V_3 -> V_37 -> V_38 -> V_85 , V_3 ,
V_9 -> V_49 ) ;
if ( V_36 ) {
ERROR ( V_38 , L_16 ) ;
goto V_91;
...
static int T_7 F_41 ( struct V_94 * V_95 , struct V_2 * V_3 )
{
struct V_33 * V_34 ;
struct V_1 * V_9 = F_1 ( V_3 ) ;
int V_36 ;
...
V_97 . V_98 = V_36 ;
V_36 = - V_99 ;
V_34 = F_43 ( V_95 -> V_38 -> V_85 , & V_100 ) ;
if ( ! V_34 )
goto V_91;
V_34 -> V_35 = V_95 -> V_38 ;
V_9 -> V_49 = V_34 ;
V_34 = F_43 ( V_95 -> V_38 -> V_85 , & V_101 ) ;
if ( ! V_34 )
goto V_91;
V_34 -> V_35 = V_95 -> V_38 ;
V_9 -> V_31 = V_34 ;
V_36 = - V_42 ;
V_9 -> V_14 = F_44 ( V_9 -> V_49 , V_32 ) ;
if ( ! V_9 -> V_14 )
goto V_91;
V_9 -> V_14 -> V_26 = F_45 ( V_9 -> V_30 , V_32 ) ;
if ( ! V_9 -> V_14 -> V_26 )
goto V_91;
...
F_51 ( & V_9 -> V_25 ) ;
F_52 ( & V_9 -> V_38 , & V_114 ) ;
V_96 = F_53 ( V_115 , V_9 -> V_116 ) ;
V_36 = F_54 ( & V_9 -> V_38 , V_96 , 1 ) ;
if ( V_36 )
goto V_117;
F_55 ( V_118 , NULL , V_96 , NULL , L_19 , L_20 , V_9 -> V_116 ) ;
return 0 ;
V_117:
F_56 ( V_3 ) ;
V_91:
...
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_59 ( V_118 , F_53 ( V_115 , V_9 -> V_116 ) ) ;
F_60 ( & V_9 -> V_38 ) ;
F_36 ( V_9 -> V_49 ) ;
...
struct V_119 * V_120 , int V_121 )
{
struct V_1 * V_9 ;
int V_36 ;
if ( V_121 >= V_122 )
return - V_123 ;
if ( V_124 [ V_125 ] . V_126 == 0 ) {
V_36 = F_63 ( V_95 -> V_38 ) ;
if ( V_36 < 0 )
return V_36 ;
V_124 [ V_125 ] . V_126 = V_36 ;
V_97 . V_127 = V_36 ;
}
...
return - V_42 ;
V_9 -> V_116 = V_121 ;
V_9 -> V_102 = V_120 -> V_128 ;
V_9 -> V_103 = V_120 -> V_129 ;
V_9 -> V_30 = V_120 -> V_30 ;
V_9 -> V_110 = V_120 -> V_110 ;
V_9 -> V_83 = F_64 ( V_120 -> V_83 ,
V_120 -> V_110 ,
V_32 ) ;
if ( ! V_9 -> V_83 ) {
F_13 ( V_9 ) ;
...
int T_7 F_66 ( struct V_137 * V_138 , int V_7 )
{
int V_36 ;
T_8 V_96 ;
V_118 = F_67 ( V_139 , L_20 ) ;
