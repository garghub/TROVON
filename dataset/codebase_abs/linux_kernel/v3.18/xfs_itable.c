...
break;
V_128 = F_34 ( V_127 ) ;
V_105 = F_35 ( V_1 , NULL , V_127 , V_90 ,
V_138 ) ;
if ( V_106 > 0 ) {
struct V_91 V_139 ;
...
goto V_140;
if ( V_107 ) {
V_111 -> V_99 = V_139 . V_99 ;
V_111 -> V_110 = V_139 . V_110 ;
V_111 -> V_102 = V_139 . V_102 ;
V_111 ++ ;
}
error = F_36 ( V_105 , 0 , & V_11 ) ;
} else {
...
if ( V_139 . V_110 < V_101 ) {
F_15 ( V_1 , V_90 , & V_139 ) ;
V_111 -> V_99 = V_139 . V_99 ;
V_111 -> V_110 = V_139 . V_110 ;
V_111 -> V_102 = V_139 . V_102 ;
V_111 ++ ;
V_107 += V_101 - V_139 . V_110 ;
}
error = F_36 ( V_105 , 0 , & V_11 ) ;
if ( error || V_11 == 0 ) {
V_137 = true ;
...
return error ;
V_148 = F_42 ( V_149 , ( int ) ( V_135 / sizeof( * V_7 ) ) ) ;
