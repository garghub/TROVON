...
case V_290 :
case V_291 :
if ( V_2 -> V_7 . V_292 & V_79 )
* V_286 = F_118 ( V_284 , V_293 ) ;
else
* V_286 = F_118 ( V_284 , 0 ) ;
break;
default:
...
static void F_119 ( struct V_1 * V_2 , T_4 V_294 )
{
if ( V_294 & V_293 )
V_2 -> V_7 . V_292 |= V_79 ;
else
...
int V_296 = - V_297 ;
unsigned long V_298 ;
V_2 = F_123 ( V_299 , V_300 ) ;
if ( ! V_2 )
goto V_43;
V_295 = F_124 ( sizeof( struct V_269 ) ) ;
if ( ! V_295 )
goto V_301;
V_2 -> V_7 . V_302 = V_295 ;
#ifdef F_125
V_2 -> V_7 . V_27 =
F_126 ( sizeof( * V_2 -> V_7 . V_27 ) , V_300 ) ;
if ( ! V_2 -> V_7 . V_27 )
goto V_303;
#endif
V_296 = F_127 ( V_2 , V_54 , V_284 ) ;
if ( V_296 )
goto V_304;
V_296 = - V_297 ;
V_298 = F_128 ( V_300 | V_305 ) ;
if ( ! V_298 )
goto V_306;
V_2 -> V_7 . V_307 = ( void * ) V_298 ;
#ifdef F_7
#ifdef F_129
V_2 -> V_7 . V_308 = true ;
#else
...
{
struct V_269 * V_295 = F_9 ( V_2 ) ;
F_138 ( ( unsigned long ) V_2 -> V_7 . V_307 & V_129 ) ;
F_132 ( V_2 ) ;
#ifdef F_125
F_133 ( V_2 -> V_7 . V_27 ) ;
#endif
...
unsigned long V_324 ;
F_143 ( & V_54 -> V_325 ) ;
V_52 = F_144 ( V_54 , log , & V_323 ) ;
if ( V_52 )
goto V_43;
if ( V_323 ) {
V_61 = F_145 ( V_54 -> V_326 , log -> V_327 ) ;
V_321 = V_61 -> V_328 << V_68 ;
V_322 = V_321 + ( V_61 -> V_67 << V_68 ) ;
F_34 (n, vcpu, kvm)
F_35 ( V_2 , V_321 , V_322 ) ;
V_324 = F_146 ( V_61 ) ;
memset ( V_61 -> V_329 , 0 , V_324 ) ;
}
V_52 = 0 ;
V_43:
F_147 ( & V_54 -> V_325 ) ;
...
static int F_152 ( struct V_60 * V_327 ,
unsigned long V_67 )
{
return 0 ;
}
...
V_335 -> V_231 = 0 ;
V_335 -> V_336 = 64 ;
V_335 -> V_337 [ 0 ] . V_338 = 12 ;
V_335 -> V_337 [ 0 ] . V_339 = 0 ;
V_335 -> V_337 [ 0 ] . V_340 [ 0 ] . V_338 = 12 ;
V_335 -> V_337 [ 0 ] . V_340 [ 0 ] . V_341 = 0 ;
V_57 = 1 ;
V_2 = F_154 ( V_54 , 0 ) ;
if ( V_2 && ( V_2 -> V_7 . V_8 & V_120 ) ) {
V_335 -> V_231 = V_342 ;
V_335 -> V_337 [ V_57 ] . V_338 = 16 ;
V_335 -> V_337 [ V_57 ] . V_339 = V_343 | V_344 ;
V_335 -> V_337 [ V_57 ] . V_340 [ 0 ] . V_338 = 16 ;
V_335 -> V_337 [ V_57 ] . V_340 [ 0 ] . V_341 = 1 ;
++ V_57 ;
}
V_335 -> V_337 [ V_57 ] . V_338 = 24 ;
V_335 -> V_337 [ V_57 ] . V_339 = V_343 ;
V_335 -> V_337 [ V_57 ] . V_340 [ 0 ] . V_338 = 24 ;
V_335 -> V_337 [ V_57 ] . V_340 [ 0 ] . V_341 = 0 ;
return 0 ;
}
static int F_153 ( struct V_54 * V_54 ,
struct V_334 * V_335 )
...
static long F_168 ( struct V_350 * V_351 ,
unsigned int V_352 , unsigned long V_353 )
{
return - V_354 ;
}
int F_169 ( void )
