...
static int F_45 ( struct V_44 * V_45 , T_16 V_87 ,
void * V_54 , int V_102 )
{
T_8 V_95 ;
T_14 V_103 ;
...
if ( V_95 == NULL )
return - 1 ;
V_41 = F_46 ( & V_103 , V_95 , V_45 ) ;
if ( V_41 )
F_35 ( V_41 ) ;
while ( ! V_41 && ( F_47 ( & V_103 ) > 0 ) && V_102 -- ) {
T_7 V_43 ;
F_48 ( & V_103 , V_104 , & V_43 ) ;
V_41 = V_43 ? F_33 ( V_43 , V_45 -> V_48 , V_45 -> V_30 , V_87 , V_54 ) : 0 ;
}
return V_41 ;
}
int F_49 ( T_16 V_87 , void * V_54 ,
struct V_30 * V_30 , struct V_48 * V_48 ,
struct V_105 * V_37 , int V_102 )
{
T_2 V_43 ;
struct V_44 V_45 = {
. V_79 = V_37 ,
...
if ( ! V_37 -> V_81 . V_82 )
return - V_12 ;
V_41 = F_29 ( & V_43 , & V_37 -> V_81 , V_106 ) ;
if ( V_41 )
return V_41 ;
V_41 = F_33 ( V_43 , V_48 , V_30 , V_87 , V_54 ) ;
if ( V_41 )
return - V_100 ;
return -- V_102 > 0 ? F_45 ( & V_45 , V_87 , V_54 , V_102 ) : 0 ;
}
