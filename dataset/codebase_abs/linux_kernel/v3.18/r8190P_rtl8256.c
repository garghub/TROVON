...
F_9 ( V_2 , V_21 -> V_35 , V_32 << 16 , 0x1 ) ;
F_9 ( V_2 , V_21 -> V_36 , V_32 , 0x1 ) ;
F_9 ( V_2 , V_21 -> V_37 ,
V_38 , 0x0 ) ;
F_9 ( V_2 , V_21 -> V_37 ,
V_39 , 0x0 ) ;
...
case V_28 :
case V_30 :
F_9 ( V_2 , V_21 -> V_31 , V_32 ,
V_18 ) ;
break;
case V_33 :
case V_34 :
F_9 ( V_2 , V_21 -> V_31 , V_32 << 16 ,
V_18 ) ;
break;
}
if ( V_27 ) {
...
void F_13 ( struct V_1 * V_2 , T_1 V_44 )
{
T_2 V_45 = 0 ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
V_45 = V_44 ;
...
if ( V_45 > 0x24 )
V_45 = 0x24 ;
F_9 ( V_2 , V_50 , V_51 , V_45 ) ;
}
void F_14 ( struct V_1 * V_2 , T_1 V_44 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
...
( V_59 << 8 ) | V_58 ;
F_9 ( V_2 , V_57 [ V_56 ] , 0x7f7f7f7f , V_52 ) ;
}
}
