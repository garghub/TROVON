...
V_5 -> V_25 = F_79 ( V_6 , NULL ) ;
if ( F_75 ( V_5 -> V_25 ) ) {
if ( V_193 )
V_192 = * V_193 ;
else
return F_76 ( V_5 -> V_25 ) ;
} else {
V_192 = F_80 ( V_5 -> V_25 ) ;
}
V_5 -> V_8 = V_8 ;
...
static int F_93 ( struct V_14 * V_6 )
{
...
#endif
for ( V_42 = 0 ; V_42 < V_5 -> V_91 . V_92 ; V_42 ++ ) {
F_94 ( & V_5 -> V_78 [ V_42 ] . V_98 ) ;
F_94 ( & V_5 -> V_78 [ V_42 ] . V_112 ) ;
F_95 ( & V_5 -> V_91 , & V_5 -> V_78 [ V_42 ] . V_2 ) ;
F_8 ( & V_5 -> V_78 [ V_42 ] . V_2 , 0 ) ;
}
F_89 ( & V_5 -> V_88 ) ;
F_91 ( & V_5 -> V_91 ) ;
...
static int F_96 ( struct V_221 * V_222 ,
...
V_232 . V_233 = ( 0xf << V_9 ) |
( V_178 -> V_195 - 1 ) ;
V_8 = F_98 ( V_222 , & V_232 ) ;
return F_73 ( & V_222 -> V_6 , V_178 , V_8 , V_222 -> V_89 , V_100 ) ;
}
static int F_99 ( struct V_221 * V_234 )
{
return F_93 ( & V_234 -> V_6 ) ;
}
