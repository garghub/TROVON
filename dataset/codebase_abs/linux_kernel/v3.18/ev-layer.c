...
static void F_17 ( struct V_61 * V_29 ,
struct V_4 * V_5 , struct V_70 * V_71 )
{
unsigned long V_16 ;
F_7 ( & V_5 -> V_63 , V_16 ) ;
++ V_29 -> V_64 ;
...
F_12 ( & V_5 -> V_63 , V_16 ) ;
V_5 -> V_72 -> V_73 ( V_71 ) ;
if ( V_71 -> V_74 & ( V_75 | V_76 ) ) {
V_71 -> V_74 &= ~ ( V_75 | V_76 ) ;
F_18 ( V_71 ) ;
}
}
static inline struct V_61 * F_19 ( struct V_4 * V_5 ,
int V_2 )
{
unsigned long V_16 ;
int V_9 ;
...
if ( F_20 ( V_5 -> V_71 + V_9 ) >= 0 ) {
V_77 = & V_5 -> V_71 [ V_9 ] . V_29 ;
V_77 -> V_2 = V_2 ;
return V_77 ;
}
F_7 ( & V_5 -> V_63 , V_16 ) ;
V_77 = F_21 ( sizeof( struct V_61 ) , V_55 ) ;
if ( V_77 ) {
F_22 ( V_77 , NULL , V_5 , V_2 ) ;
F_23 ( & V_77 -> V_69 , & V_5 -> V_79 ) ;
}
F_12 ( & V_5 -> V_63 , V_16 ) ;
return V_77 ;
}
static void F_24 ( struct V_4 * V_5 , int V_80 )
{
int V_9 ;
struct V_61 * V_29 ;
V_5 -> V_29 . V_66 &= ~ V_81 ;
...
static void F_26 ( struct V_4 * V_5 , int V_86 )
{
if ( V_5 -> V_29 . V_66 & V_81 ) {
F_4 ( V_33 , L_17 ) ;
return;
}
V_5 -> V_82 = V_86 ;
...
static void F_28 ( struct V_4 * V_5 , const char * V_88 ,
struct V_61 * V_29 )
{
int V_2 = V_29 -> V_2 ;
struct V_89 * V_90 ;
T_1 V_91 ;
V_91 = strlen ( V_88 ) + 12 ;
V_90 = F_21 ( sizeof( struct V_89 ) + V_91 , V_55 ) ;
if ( ! V_90 ) {
...
V_90 -> V_17 = NULL ;
V_90 -> V_94 = NULL ;
V_5 -> V_72 -> V_95 ( V_5 , V_90 ) ;
}
static struct V_61 * F_29 ( struct V_4 * V_5 , int V_2 )
{
struct V_61 * V_29 ;
int V_9 ;
unsigned long V_16 ;
...
return & V_5 -> V_29 ;
for ( V_9 = 0 ; V_9 < V_5 -> V_78 ; ++ V_9 )
if ( V_2 == V_5 -> V_71 [ V_9 ] . V_29 . V_2 )
return & V_5 -> V_71 [ V_9 ] . V_29 ;
F_7 ( & V_5 -> V_63 , V_16 ) ;
...
static void F_38 ( struct V_61 * V_29 , void * V_97 ,
unsigned V_64 )
{
struct V_70 * V_71 = V_29 -> V_71 ;
...
static void F_39 ( struct V_61 * V_29 )
{
struct V_4 * V_5 = V_29 -> V_5 ;
struct V_70 * V_71 = V_29 -> V_71 ;
int V_9 ;
...
V_71 -> V_98 [ V_100 ] = F_21 ( 9 , V_55 ) ;
V_71 -> V_98 [ V_101 ] = F_21 ( 9 , V_55 ) ;
if ( ! V_71 -> V_98 [ V_100 ] || ! V_71 -> V_98 [ V_101 ] ) {
...
snprintf ( V_71 -> V_98 [ V_100 ] , 9 , L_28 , V_71 -> V_103 ) ;
snprintf ( V_71 -> V_98 [ V_101 ] , 9 , L_29 , V_71 -> V_104 + 1 ) ;
V_29 -> V_66 |= V_105 ;
F_4 ( V_33 , L_30 ) ;
V_5 -> V_68 = 1 ;
}
...
static int F_47 ( struct V_4 * V_5 , int V_104 )
{
int V_9 ;
if ( -- V_5 -> V_117 <= 0 )
return - V_118 ;
for ( V_9 = 0 ; V_9 < V_5 -> V_78 ; ++ V_9 )
if ( V_5 -> V_71 [ V_9 ] . V_29 . V_2 > 0 )
return - V_119 ;
if ( V_104 < 0 )
F_5 ( V_5 -> V_31 ,
L_32 ) ;
...
static void F_49 ( struct V_4 * V_5 , struct V_70 * V_71 ,
struct V_61 * V_29 )
{
int V_121 ;
V_121 = F_50 ( V_29 ) ;
...
case V_83 :
case V_113 :
if ( V_5 -> V_125 || ! F_14 ( & V_5 -> V_79 ) ||
V_5 -> V_29 . V_66 )
return - V_119 ;
for ( V_9 = 0 ; V_9 < V_5 -> V_78 ; ++ V_9 )
if ( V_5 -> V_71 [ V_9 ] . V_29 . V_66 )
return - V_119 ;
if ( F_52 ( V_5 ) < 0 )
return - V_119 ;
break;
...
static void F_54 ( int V_127 , struct V_4 * V_5 ,
struct V_70 * V_71 ,
...
if ( V_5 -> V_116 ) {
struct V_89 * V_90 ;
V_90 = F_21 ( sizeof( struct V_89 ) + 3 , V_55 ) ;
if ( ! V_90 ) {
F_9 ( V_5 -> V_31 , L_19 ,
V_54 ) ;
return;
...
case V_184 :
V_5 -> V_125 = V_139 ;
V_133 = V_5 -> V_71 + V_5 -> V_176 ;
F_17 ( & V_133 -> V_29 , V_5 , V_133 ) ;
break;
case V_185 :
V_5 -> V_125 = V_139 ;
F_5 ( V_5 -> V_31 , L_40 ) ;
...
L_42 ) ;
V_104 = V_5 -> V_176 ;
V_5 -> V_71 [ V_104 ] . V_29 . V_66 |= V_102 ;
V_5 -> V_68 = 1 ;
break;
case V_188 :
V_5 -> V_125 = V_139 ;
...
V_5 -> V_71 [ V_104 ] . V_29 . V_2 = V_132 -> V_48 ;
V_5 -> V_71 [ V_104 ] . V_29 . V_66 |=
V_189 ;
V_5 -> V_68 = 1 ;
break;
}
...
F_38 ( V_29 , V_132 -> V_39 , V_132 -> V_48 ) ;
break;
case V_213 :
F_39 ( V_29 ) ;
break;
...
break;
case V_217 :
V_5 -> V_111 = V_132 -> V_48 ? F_51 ( V_5 ) : F_53 ( V_5 ) ;
V_5 -> V_109 = 0 ;
F_42 ( & V_5 -> V_110 ) ;
break;
case V_218 :
...
* V_129 = V_29 -> V_71 -> V_98 [ V_127 - V_224 ] ;
if ( ! * V_129 ) {
* V_130 = 1 ;
* V_131 = V_225 ;
}
...
static void F_57 ( struct V_4 * V_5 , struct V_20 * V_132 )
{
struct V_70 * V_71 ;
char * V_226 = NULL ;
struct V_227 * V_228 ;
...
F_54 ( V_228 -> V_127 [ V_232 ] , V_5 , V_71 , & V_29 , & V_226 ,
& V_230 , & V_22 , V_132 ) ;
if ( ! V_29 )
return;
}
...
for ( V_9 = 0 ; V_9 < V_5 -> V_78 ; ++ V_9 ) {
V_71 = V_5 -> V_71 + V_9 ;
if ( V_71 -> V_29 . V_66 & V_102 ) {
if ( V_5 -> V_60 ) {
V_5 -> V_176 = V_71 -> V_104 ;
F_58 ( V_5 , & V_5 -> V_29 , V_252 ) ;
return;
}
V_71 -> V_29 . V_66 &= ~ V_102 ;
if ( V_71 -> V_29 . V_66 & V_84 ) {
V_71 -> V_29 . V_66 |= V_85 ;
V_71 -> V_29 . V_66 &= ~ V_84 ;
} else {
F_58 ( V_5 , & V_71 -> V_29 , V_253 ) ;
return;
}
}
if ( V_71 -> V_29 . V_66 & V_85 ) {
V_71 -> V_29 . V_66 &= ~ V_85 ;
V_5 -> V_176 = V_71 -> V_104 ;
F_58 ( V_5 , & V_5 -> V_29 , V_254 ) ;
return;
} else if ( V_71 -> V_29 . V_66 & V_181 ) {
V_71 -> V_29 . V_66 &= ~ V_181 ;
V_5 -> V_176 = V_71 -> V_104 ;
F_58 ( V_5 , & V_5 -> V_29 , V_252 ) ;
return;
}
...
F_58 ( V_5 , & V_5 -> V_29 , V_255 ) ;
return;
}
if ( V_5 -> V_29 . V_66 & V_115 ) {
V_5 -> V_29 . V_66 &= ~ V_115 ;
F_58 ( V_5 , & V_5 -> V_29 , V_256 ) ;
return;
}
if ( V_5 -> V_29 . V_66 & V_141 ) {
V_5 -> V_29 . V_66 &= ~ V_141 ;
if ( V_5 -> V_80 == V_140 ) {
V_5 -> V_117 = 1 ;
F_58 ( V_5 , & V_5 -> V_29 , V_257 ) ;
return;
}
}
for ( V_9 = 0 ; V_9 < V_5 -> V_78 ; ++ V_9 ) {
V_71 = V_5 -> V_71 + V_9 ;
if ( V_71 -> V_29 . V_66 & V_173 ) {
V_71 -> V_29 . V_66 &= ~ V_173 ;
V_5 -> V_176 = V_71 -> V_104 ;
F_58 ( V_5 , & V_5 -> V_29 , V_258 ) ;
return;
}
if ( V_71 -> V_29 . V_66 & V_105 ) {
V_71 -> V_29 . V_66 &= ~ V_105 ;
F_58 ( V_5 , & V_71 -> V_29 , V_259 ) ;
return;
}
if ( V_71 -> V_29 . V_66 & V_189 ) {
V_71 -> V_29 . V_66 &= ~ V_189 ;
F_58 ( V_5 , & V_71 -> V_29 , V_260 ) ;
return;
}
if ( V_71 -> V_29 . V_66 & V_84 ) {
switch ( V_5 -> V_80 ) {
