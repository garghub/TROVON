...
* V_81 = V_2 -> V_11 ;
V_2 -> V_11 = V_80 ;
F_35 ( * V_81 , ( * V_81 ) -> V_2 . V_28 ) ;
F_22 ( * V_81 ) ;
F_40 ( V_9 ) ;
return 0 ;
}
static struct V_8 * F_60 ( struct V_8 * V_9 , unsigned long V_61 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
return V_2 -> V_11 ;
}
static unsigned long F_61 ( struct V_8 * V_9 , T_1 V_82 )
{
return 1 ;
}
static void F_62 ( struct V_8 * V_9 , unsigned long V_61 )
{
}
static void F_63 ( struct V_8 * V_9 , struct V_83 * V_84 )
{
if ( ! V_84 -> V_85 ) {
