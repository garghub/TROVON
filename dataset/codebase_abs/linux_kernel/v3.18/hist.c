...
F_56 ( V_71 -> V_96 , & V_136 , V_121 -> V_58 ) ;
F_54 ( & V_136 ) ;
F_42 ( V_1 , V_71 -> V_55 ) ;
return V_128 ;
}
...
T_6 -> V_71 = V_71 ;
V_135 [ T_6 -> V_129 ++ ] = V_71 ;
F_56 ( V_71 -> V_96 , & V_140 , V_121 -> V_58 ) ;
return 0 ;
}
static int
...
static bool F_70 ( struct V_1 * V_1 V_119 ,
struct V_157 * V_158 ,
struct V_14 * V_71 )
{
...
static struct V_157 * F_73 ( struct V_1 * V_1 )
{
struct V_157 * V_158 ;
F_74 ( & V_1 -> V_159 ) ;
V_158 = V_1 -> V_107 ;
...
static void F_76 ( struct V_1 * V_1 , struct V_14 * V_71 )
{
F_77 ( V_1 , V_71 ) ;
F_78 ( V_1 , V_71 ) ;
F_79 ( V_1 , V_71 ) ;
}
void F_80 ( struct V_1 * V_1 , struct V_161 * V_162 )
{
struct V_157 * V_158 ;
struct V_50 * V_51 ;
struct V_14 * V_53 ;
...
static int F_83 ( struct V_14 * V_163 , struct V_14 * V_164 )
{
struct V_153 * V_154 ;
T_5 V_106 = 0 ;
F_66 (fmt) {
...
static void F_86 ( struct V_1 * V_1 , struct V_14 * V_15 )
{
V_1 -> V_88 ++ ;
V_1 -> V_77 . V_79 += V_15 -> V_73 . V_58 ;
}
void F_87 ( struct V_1 * V_1 , struct V_14 * V_15 )
{
if ( ! V_15 -> V_55 )
F_86 ( V_1 , V_15 ) ;
V_1 -> V_87 ++ ;
...
static void F_88 ( struct V_157 * V_52 ,
struct V_14 * V_71 ,
T_2 V_166 )
{
...
void F_94 ( struct V_184 * V_77 , T_7 type )
{
++ V_77 -> V_68 [ 0 ] ;
++ V_77 -> V_68 [ type ] ;
}
void F_95 ( struct V_1 * V_1 , T_7 type )
{
F_94 ( & V_1 -> V_77 , type ) ;
}
...
static struct V_14 * F_96 ( struct V_1 * V_1 ,
struct V_14 * V_186 )
{
struct V_157 * V_158 ;
struct V_50 * * V_105 ;
...
void F_98 ( struct V_1 * V_188 , struct V_1 * V_189 )
{
struct V_157 * V_158 ;
struct V_50 * V_178 ;
...
V_186 = F_97 ( V_189 , V_190 ) ;
if ( V_186 )
F_99 ( V_186 , V_190 ) ;
}
}
int F_100 ( struct V_1 * V_188 , struct V_1 * V_189 )
{
struct V_157 * V_158 ;
struct V_50 * V_178 ;
struct V_14 * V_190 , * V_186 ;
...
T_3 F_102 ( struct V_191 * V_192 , T_8 * V_193 )
{
struct V_127 * V_190 ;
T_3 V_194 = 0 ;
F_103 (evlist, pos) {
V_194 += fprintf ( V_193 , L_1 , F_104 ( V_190 ) ) ;
V_194 += F_105 ( & F_40 ( V_190 ) -> V_77 , V_193 ) ;
}
return V_194 ;
}
T_2 F_106 ( struct V_1 * V_1 )
{
return V_10 . V_195 ? V_1 -> V_77 . V_79 :
V_1 -> V_77 . V_78 ;
}
int F_107 ( const struct V_196 * T_9 V_119 ,
...
int F_108 ( const char * V_197 , const char * V_198 )
{
if ( ! strcmp ( V_197 , L_4 ) )
return F_107 ( NULL , V_198 , 0 ) ;
return 0 ;
}
static int F_109 ( struct V_127 * V_125 )
{
struct V_1 * V_1 = F_40 ( V_125 ) ;
...
V_1 -> V_86 = V_170 ;
V_1 -> V_52 = V_170 ;
F_110 ( & V_1 -> V_159 , NULL ) ;
return 0 ;
}
int F_111 ( void )
{
int V_128 = F_112 ( sizeof( struct V_199 ) ,
F_109 , NULL ) ;
if ( V_128 )
fputs ( L_5 , V_200 ) ;
return V_128 ;
