...
{
return F_55 ( V_5 , F_41 ( V_5 , V_106 ) , V_121 ) ;
}
...
if ( V_146 && V_146 == & V_62 -> V_70 [ V_108 ] -> V_71 )
F_3 ( V_5 , V_7 , & V_7 -> V_83 [ V_108 ] ) ;
}
V_7 -> V_68 = 0 ;
F_82 ( & V_62 -> V_69 ) ;
...
struct V_6 * V_7 = F_41 ( V_5 , V_106 ) ;
struct V_1 * V_2 ;
unsigned int * V_154 = & V_106 -> V_27 -> V_30 . V_45 . V_155 ;
* V_154 = 0 ;
F_57 (sub, &lio->lis_active, sub_linkage) {
