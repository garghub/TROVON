...
static inline int F_41 ( enum V_14 V_102 ,
...
if ( ! F_163 ( V_281 ) )
return - V_160 ;
V_196 = F_164 ( V_281 , 0 , & V_239 ) ;
if ( V_196 ) {
F_27 ( & V_70 -> V_70 , V_285 L_70 ) ;
return V_196 ;
}
V_156 = F_165 ( V_281 , L_71 , & V_283 ) ;
if ( V_156 && V_283 != 4 ) {
F_27 ( & V_70 -> V_70 , V_285 L_72 ) ;
return - V_160 ;
}
V_151 = F_165 ( V_281 , L_73 , & V_283 ) ;
if ( V_151 && V_283 != 4 ) {
F_27 ( & V_70 -> V_70 , V_285 L_74 ) ;
return - V_160 ;
}
V_153 = F_165 ( V_281 , L_75 , & V_283 ) ;
if ( V_153 && V_283 != 4 ) {
...
V_143 -> V_127 . V_156 = V_156 ? F_166 ( V_156 ) : V_265 ;
V_143 -> V_127 . V_151 = V_151 ? F_166 ( V_151 ) : V_191 ;
V_143 -> V_127 . V_153 = V_153 ? F_166 ( V_153 ) : 0 ;
V_143 -> V_49 = F_167 ( V_70 -> V_70 . V_282 , 0 ) ;
V_143 -> V_70 = & V_70 -> V_70 ;
F_168 ( & V_70 -> V_70 , L_78 ,
V_143 -> V_127 . V_150 , V_143 -> V_127 . V_156 , V_143 -> V_127 . V_151 ,
V_143 -> V_49 ) ;
F_169 ( & V_70 -> V_70 , V_143 ) ;
V_196 = F_117 ( V_143 ) ;
if ( V_196 ) {
F_118 ( V_143 ) ;
return V_196 ;
...
static int F_170 ( struct V_277 * V_70 )
{
#ifdef F_161
F_120 ( F_171 ( & V_70 -> V_70 ) ) ;
#endif
return 0 ;
}
...
V_143 -> V_133 = NULL ;
V_143 -> V_70 = & V_70 -> V_70 ;
F_168 ( & V_70 -> V_70 , L_80 , V_143 -> V_127 . V_150 ) ;
F_169 ( & V_70 -> V_70 , V_143 ) ;
V_15 = F_117 ( V_143 ) ;
if ( V_15 ) {
F_118 ( V_143 ) ;
...
static int F_173 ( struct V_287 * V_70 )
{
F_120 ( F_171 ( & V_70 -> V_70 ) ) ;
return 0 ;
}
...
static int F_177 ( struct V_4 * V_4 )
{
unsigned char V_6 [ 2 ] ;
unsigned char * V_290 ;
unsigned long V_291 ;
int V_15 = 0 ;
V_290 = F_178 ( V_66 , V_173 ) ;
if ( ! V_290 )
return - V_183 ;
V_6 [ 0 ] = V_36 << 2 ;
V_6 [ 1 ] = V_292 ;
...
V_290 , V_66 ) ;
V_15 = F_179 ( V_290 , V_291 , & V_4 -> V_293 ) ;
V_31:
F_118 ( V_290 ) ;
return V_15 ;
}
static int F_180 ( struct V_4 * V_4 )
{
unsigned char V_6 [ 3 ] ;
unsigned char * V_290 ;
unsigned long V_291 ;
...
static int F_181 ( struct V_296 * V_297 , void * V_164 )
{
struct V_4 * V_139 = V_297 -> V_298 ;
return F_182 ( V_297 , L_90 , V_299 [ V_139 -> V_136 ] ) ;
}
static int F_183 ( struct V_300 * V_300 , struct V_301 * V_301 )
{
return F_184 ( V_301 , F_181 , F_185 ( V_300 ) ) ;
}
static int F_186 ( struct V_296 * V_297 , void * V_164 )
{
struct V_4 * V_139 = V_297 -> V_298 ;
F_182 ( V_297 , L_91 ,
...
static int F_188 ( struct V_300 * V_300 , struct V_301 * V_301 )
{
return F_184 ( V_301 , F_186 , F_185 ( V_300 ) ) ;
}
static int F_189 ( struct V_296 * V_297 , void * V_164 )
{
struct V_4 * V_139 = V_297 -> V_298 ;
return F_182 ( V_297 ,
L_103 ,
...
static int F_190 ( struct V_300 * V_300 , struct V_301 * V_301 )
{
return F_184 ( V_301 , F_189 , F_185 ( V_300 ) ) ;
}
static int F_191 ( struct V_4 * V_4 )
{
...
static void F_195 ( struct V_4 * V_4 )
{
struct V_5 * V_6 = V_4 -> V_9 ;
V_6 -> V_11 [ 0 ] = V_6 -> V_12 [ 0 ] | 4 ;
V_6 -> V_11 [ 1 ] = V_6 -> V_12 [ 1 ] ;
...
static int F_196 ( struct V_1 * V_314 ,
unsigned long V_315 ,
void * V_316 )
{
...
static void F_199 ( struct V_4 * V_4 )
{
F_197 ( V_4 ) ;
}
static inline void F_200 ( struct V_4 * V_4 )
{
if ( V_4 -> V_7 ) {
if ( V_4 -> V_90 != NULL )
F_201 ( V_4 -> V_90 ) ;
...
static int F_206 ( struct V_4 * V_143 )
{
struct V_4 * V_193 ;
F_207 (e, &smi_infos, link) {
...
V_132 -> V_34 = F_178 ( V_132 -> V_32 -> V_317 () , V_173 ) ;
if ( ! V_132 -> V_34 ) {
F_12 (KERN_ERR PFX
L_112 ) ;
V_15 = - V_183 ;
