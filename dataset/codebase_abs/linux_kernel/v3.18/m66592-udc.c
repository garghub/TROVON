...
static T_3 F_82 ( int V_235 , void * V_236 )
{
...
static void F_85 ( unsigned long V_236 )
{
...
static int F_88 ( struct V_262 * V_263 ,
const struct V_84 * V_85 )
{
struct V_45 * V_23 ;
V_23 = F_89 ( V_263 , struct V_45 , V_23 ) ;
...
static struct V_265 * F_91 ( struct V_262 * V_263 ,
T_4 V_266 )
{
struct V_121 * V_122 ;
V_122 = F_92 ( sizeof( struct V_121 ) , V_266 ) ;
if ( ! V_122 )
return NULL ;
F_13 ( & V_122 -> V_24 ) ;
return & V_122 -> V_122 ;
}
static void F_93 ( struct V_262 * V_263 , struct V_265 * V_267 )
{
struct V_121 * V_122 ;
V_122 = F_89 ( V_267 , struct V_121 , V_122 ) ;
F_94 ( V_122 ) ;
}
...
static int F_96 ( struct V_262 * V_263 , struct V_265 * V_267 )
{
struct V_45 * V_23 ;
struct V_121 * V_122 ;
unsigned long V_261 ;
...
static int F_97 ( struct V_262 * V_263 , int V_270 )
{
struct V_45 * V_23 ;
struct V_121 * V_122 ;
unsigned long V_261 ;
...
V_135 ) & V_253 ;
V_1 -> V_254 = V_255 ;
F_83 ( & V_1 -> V_256 , V_257 + F_84 ( 50 ) ) ;
}
return 0 ;
}
static int F_101 ( struct V_273 * V_274 ,
struct V_275 * V_21 )
{
struct V_1 * V_1 = F_100 ( V_274 ) ;
...
static int F_102 ( struct V_273 * V_279 )
{
struct V_1 * V_1 = F_103 ( V_279 ) ;
return F_2 ( V_1 , V_280 ) & 0x03FF ;
}
static int F_104 ( struct V_273 * V_18 , int V_281 )
{
...
static int T_5 F_105 ( struct V_282 * V_283 )
{
struct V_1 * V_1 = F_106 ( V_283 ) ;
F_107 ( & V_1 -> V_18 ) ;
F_108 ( & V_1 -> V_256 ) ;
F_109 ( V_1 -> V_5 ) ;
F_110 ( F_111 ( V_283 , 0 ) , V_1 ) ;
F_93 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_204 ) ;
if ( V_1 -> V_51 -> V_52 ) {
F_112 ( V_1 -> V_284 ) ;
F_113 ( V_1 -> V_284 ) ;
}
...
static void F_114 ( struct V_262 * V_23 , struct V_265 * V_285 )
{
}
static int F_115 ( struct V_282 * V_283 )
{
...
int V_33 = 0 ;
int V_177 ;
V_287 = F_116 ( V_283 , V_290 , 0 ) ;
if ( ! V_287 ) {
V_33 = - V_112 ;
F_16 ( L_19 ) ;
goto V_291;
}
V_288 = F_116 ( V_283 , V_292 , 0 ) ;
if ( ! V_288 ) {
V_33 = - V_112 ;
F_117 ( & V_283 -> V_293 ,
L_20 ) ;
...
V_5 = F_118 ( V_287 -> V_294 , F_119 ( V_287 ) ) ;
if ( V_5 == NULL ) {
V_33 = - V_75 ;
F_16 ( L_21 ) ;
goto V_291;
}
if ( F_120 ( & V_283 -> V_293 ) == NULL ) {
F_117 ( & V_283 -> V_293 , L_22 ) ;
V_33 = - V_112 ;
goto V_291;
}
V_1 = F_92 ( sizeof( struct V_1 ) , V_206 ) ;
if ( V_1 == NULL ) {
V_33 = - V_75 ;
goto V_291;
}
V_1 -> V_51 = F_120 ( & V_283 -> V_293 ) ;
...
F_123 ( & V_1 -> V_256 ) ;
V_1 -> V_256 . V_301 = F_85 ;
V_1 -> V_256 . V_302 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
V_33 = F_124 ( V_288 -> V_294 , F_82 , V_303 ,
V_300 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_23 , V_33 ) ;
goto V_291;
...
V_1 -> V_284 = F_125 ( & V_283 -> V_293 , V_289 ) ;
if ( F_126 ( V_1 -> V_284 ) ) {
F_117 ( & V_283 -> V_293 , L_25 ,
V_289 ) ;
V_33 = F_127 ( V_1 -> V_284 ) ;
goto V_305;
}
F_128 ( V_1 -> V_284 ) ;
}
...
F_95 ( & V_1 -> V_23 [ V_177 ] . V_23 . V_306 ,
& V_1 -> V_18 . V_306 ) ;
}
V_23 -> V_1 = V_1 ;
F_13 ( & V_23 -> V_24 ) ;
...
V_1 -> V_204 = F_91 ( & V_1 -> V_23 [ 0 ] . V_23 , V_206 ) ;
if ( V_1 -> V_204 == NULL ) {
V_33 = - V_75 ;
goto V_309;
}
V_1 -> V_204 -> V_310 = F_114 ;
F_56 ( V_1 ) ;
V_33 = F_130 ( & V_283 -> V_293 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_311;
F_131 ( & V_283 -> V_293 , L_26 , V_312 ) ;
return 0 ;
V_311:
F_93 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_204 ) ;
V_309:
