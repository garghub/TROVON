...
static void F_49 ( struct V_2 * V_3 , struct V_76 * V_77 ,
struct V_76 * V_78 )
{
struct V_1 * V_68 = F_1 ( V_3 ) ;
unsigned int V_79 ;
...
V_77 -> V_82 &= ~ ( V_83 |
( V_68 -> V_84 ? 0 : V_85 ) ) ;
V_3 -> V_86 = F_50 ( V_68 -> V_72 ) ;
V_79 = F_51 ( V_3 , V_77 , V_78 , 0 , V_3 -> V_86 / 16 ) ;
V_81 = V_77 -> V_82 ;
F_46 ( & V_3 -> V_57 , V_69 ) ;
V_80 = F_3 ( V_3 , V_74 ) ;
F_6 ( V_3 , V_74 , ( V_80 & ~ V_75 ) ) ;
V_80 = V_87 | V_88 ;
F_6 ( V_3 , V_89 , 1 ) ;
F_6 ( V_3 , V_90 , 1 ) ;
if ( ( V_81 & V_91 ) == V_92 ) {
...
F_6 ( V_3 , V_104 , ( V_3 -> V_86 / ( 16 * V_79 ) ) ) ;
} else {
T_4 V_105 = ( T_4 ) V_79 * ( 1 << 16 ) ;
F_52 ( V_105 , V_3 -> V_86 / 16 ) ;
F_6 ( V_3 , V_104 , V_105 ) ;
V_80 |= V_106 ;
}
F_53 ( V_3 , V_81 , V_79 ) ;
...
static void F_57 ( struct V_2 * V_3 , int V_69 )
{
if ( ( V_69 & V_118 ) )
V_3 -> type = V_116 ;
}
static int
F_58 ( struct V_2 * V_3 , struct V_119 * V_120 )
{
return - V_121 ;
}
...
static int F_62 ( struct V_1 * V_68 ,
struct V_123 * V_124 )
{
...
V_3 -> V_17 = V_132 ;
V_3 -> V_14 = & V_124 -> V_14 ;
V_3 -> V_55 = F_63 ( V_124 , 0 ) ;
V_126 = F_64 ( V_124 , V_133 , 0 ) ;
V_3 -> V_5 = F_65 ( & V_124 -> V_14 , V_126 ) ;
if ( F_66 ( V_3 -> V_5 ) )
return F_67 ( V_3 -> V_5 ) ;
V_3 -> V_134 = V_126 -> V_135 ;
F_68 ( & V_3 -> V_57 ) ;
V_68 -> V_72 = F_69 ( & V_124 -> V_14 , NULL ) ;
if ( F_70 ( F_66 ( V_68 -> V_72 ) ) )
return - V_121 ;
F_45 ( V_68 -> V_72 ) ;
V_68 -> V_3 . V_86 = F_50 ( V_68 -> V_72 ) ;
F_70 ( V_68 -> V_3 . V_86 == 0 ) ;
F_48 ( V_68 -> V_72 ) ;
return 0 ;
}
static struct V_1 * F_71 ( struct V_123 * V_124 )
{
struct V_136 * V_137 = V_124 -> V_14 . V_138 ;
int V_139 ;
if ( ! V_137 )
return NULL ;
V_139 = F_72 ( V_137 , V_140 ) ;
if ( V_139 < 0 )
V_139 = 0 ;
if ( F_70 ( V_139 >= V_141 ) )
return NULL ;
V_142 [ V_139 ] . V_84 = F_73 ( V_137 ,
L_2 ) ;
V_142 [ V_139 ] . V_103 = F_73 ( V_137 , L_3 ) ;
...
if ( ! V_68 )
return - V_66 ;
V_143 = F_62 ( V_68 , V_124 ) ;
if ( V_143 )
return V_143 ;
V_143 = F_75 ( & V_144 , & V_68 -> V_3 ) ;
if ( V_143 )
return V_143 ;
F_76 ( V_124 , & V_68 -> V_3 ) ;
return 0 ;
...
{
struct V_2 * V_3 = F_78 ( V_124 ) ;
return F_79 ( & V_144 , V_3 ) ;
}
static int F_80 ( struct V_145 * V_14 )
{
struct V_123 * V_124 = F_16 ( V_14 ) ;
struct V_2 * V_3 = F_78 ( V_124 ) ;
return F_81 ( & V_144 , V_3 ) ;
}
static int F_82 ( struct V_145 * V_14 )
{
struct V_123 * V_124 = F_16 ( V_14 ) ;
struct V_2 * V_3 = F_78 ( V_124 ) ;
return F_83 ( & V_144 , V_3 ) ;
}
static void F_84 ( struct V_2 * V_3 , int V_146 )
{
unsigned int V_147 = 1000000 ;
while ( -- V_147 && ! F_14 ( V_3 ) )
F_85 ( 1 ) ;
F_6 ( V_3 , V_25 , V_146 ) ;
}
static void F_86 ( struct V_148 * V_149 , const char * V_150 , unsigned V_151 )
{
...
F_6 ( V_3 , V_8 , 0 ) ;
( void ) F_3 ( V_3 , V_8 ) ;
F_89 ( V_3 , V_150 , V_151 , F_84 ) ;
while ( -- V_147 && ! F_13 ( V_3 ) )
F_85 ( 1 ) ;
F_6 ( V_3 , V_8 , V_7 ) ;
if ( V_153 )
F_31 ( & V_3 -> V_57 ) ;
...
static int F_91 ( struct V_148 * V_149 , char * V_156 )
{
struct V_1 * V_68 ;
int V_79 = 9600 ;
int V_157 = 8 ;
...
if ( V_68 -> V_3 . V_134 == 0 || V_68 -> V_3 . V_5 == NULL )
return - V_159 ;
if ( V_156 )
F_92 ( V_156 , & V_79 , & V_48 , & V_157 , & V_158 ) ;
return F_93 ( & V_68 -> V_3 , V_149 , V_79 , V_48 , V_157 , V_158 ) ;
}
static int T_5 F_94 ( void )
{
int V_143 ;
static char V_160 [] V_161 =
V_162 L_4 ;
F_95 ( V_160 ) ;
V_143 = F_96 ( & V_144 ) ;
if ( V_143 )
