...
static int T_6 F_30 ( struct V_41 * V_65 ,
struct V_6 * V_66 )
{
const int * V_67 ;
unsigned int V_68 ;
...
static void T_6 F_31 ( struct V_6 * V_7 )
{
V_7 -> V_12 =
F_24 ( sizeof( struct V_10 ) ,
V_53 ) ;
}
static int T_6 F_32 ( struct V_41 * V_65 ,
struct V_6 * V_66 )
{
struct V_41 * V_42 ;
V_66 -> V_71 = & V_72 ;
F_31 ( V_66 ) ;
for ( V_42 = F_33 ( V_65 , NULL ) ;
V_42 != NULL ; V_42 = F_33 ( V_65 , V_42 ) )
F_21 ( V_42 , V_66 ) ;
return 0 ;
}
int T_6 F_34 ( struct V_6 * V_66 )
{
