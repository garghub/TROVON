...
{
struct V_72 * V_73 = V_6 -> V_73 -> V_72 ;
struct V_74 * V_75 = V_6 -> V_76 ;
struct V_70 * V_71 = V_6 -> V_71 ;
struct V_77 * V_78 = F_42 ( V_75 -> V_13 -> V_14 ) ;
struct V_67 * V_14 ;
struct V_79 * V_80 ;
int V_51 ;
int V_12 ;
...
V_80 = F_44 ( V_78 , V_82 , V_51 ) ;
if ( ! V_80 ) {
V_12 = - V_83 ;
goto exit;
}
V_14 -> V_10 [ V_51 ] . V_84 = V_80 ;
V_12 = F_45 ( V_14 , & V_14 -> V_10 [ V_51 ] ) ;
if ( V_12 )
goto exit;
}
return F_46 ( V_71 , V_85 ,
V_73 -> V_14 , 64 * 1024 , 4 * 1024 * 1024 ) ;
exit:
for ( V_51 = 0 ; V_51 < 2 ; V_51 ++ ) {
if ( V_14 -> V_10 [ V_51 ] . V_33 )
F_47 ( V_14 -> V_10 [ V_51 ] . V_33 ) ;
V_14 -> V_10 [ V_51 ] . V_33 = NULL ;
}
return V_12 ;
}
static bool F_48 ( struct V_33 * V_34 , void * V_86 )
{
struct V_9 * V_10 = V_86 ;
char * V_87 ;
bool V_88 = false ;
V_87 = F_49 ( V_89 , L_5 , V_10 -> V_84 -> V_90 ,
( int ) V_10 -> V_84 -> V_91 ) ;
if ( strcmp ( F_50 ( V_34 -> V_44 -> V_14 ) , V_87 ) == 0 ) {
V_34 -> V_92 = & V_10 -> V_93 ;
V_88 = true ;
}
F_51 ( V_87 ) ;
...
static int F_45 ( struct V_67 * V_14 ,
struct V_9 * V_10 )
{
struct V_52 * V_53 = V_54 ;
...
static int F_60 ( struct V_105 * V_13 )
{
struct V_67 * V_14 = F_61 ( V_13 ) ;
struct V_52 * V_53 = V_54 ;
void T_3 * V_55 = V_53 -> V_55 ;
int V_51 ;
F_30 ( V_49 | V_50 , V_55 + V_63 ) ;
F_30 ( F_62 ( V_55 + V_102 ) , V_55 + V_100 ) ;
for ( V_51 = 0 ; V_51 < 2 ; V_51 ++ ) {
...
static int F_63 ( struct V_77 * V_78 )
{
return F_64 ( & V_78 -> V_14 , & V_106 ) ;
}
