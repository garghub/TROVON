...
static int F_63 ( struct V_38 * V_39 , T_5 V_67 ,
...
if ( F_4 ( V_10 -> V_15 . V_25 ) & V_26 ) {
V_41 = F_63 ( V_39 , F_9 ( V_10 , V_24 ) , F_64 , V_28 ) ;
if ( V_41 )
goto V_64;
} else {
V_19 = F_5 ( * F_66 ( V_10 , V_24 ) ) ;
...
{
F_68 ( V_39 -> V_58 > 1 ) ;
return F_63 ( V_39 , V_40 , F_64 , V_28 ) ;
}
