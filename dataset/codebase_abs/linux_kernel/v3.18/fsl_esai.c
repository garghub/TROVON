...
T_2 V_130 = F_29 ( V_129 , V_4 -> V_74 ) ;
T_2 V_131 , V_88 , V_132 ;
int V_56 ;
V_131 = F_30 ( V_125 ) * V_4 -> V_75 * V_4 -> V_74 ;
V_56 = F_16 ( V_24 , V_25 , V_131 ) ;
if ( V_56 )
return V_56 ;
...
V_135 , V_136 ) ;
V_88 = V_135 | V_137 | V_138 |
( V_25 ? V_139 | V_140 : V_141 ) ;
V_132 = F_33 ( V_128 ) | F_34 ( V_4 -> V_142 ) |
( V_25 ? F_35 ( V_130 ) | V_140 : F_36 ( V_130 ) ) ;
F_8 ( V_4 -> V_8 , F_32 ( V_25 ) , V_88 , V_132 ) ;
V_88 = V_143 | ( V_25 ? V_144 : 0 ) ;
V_132 = F_37 ( V_4 -> V_75 , V_128 ) | ( V_25 ? V_144 : 0 ) ;
F_8 ( V_4 -> V_8 , F_31 ( V_25 ) , V_88 , V_132 ) ;
F_8 ( V_4 -> V_8 , V_145 ,
V_146 , F_38 ( V_147 ) ) ;
F_8 ( V_4 -> V_8 , V_148 ,
V_149 , F_39 ( V_147 ) ) ;
...
static int F_41 ( struct V_115 * V_116 , int V_150 ,
struct V_23 * V_24 )
{
struct V_3 * V_4 = F_6 ( V_24 ) ;
bool V_25 = V_116 -> V_126 == V_127 ;
T_3 V_35 , V_129 = V_116 -> V_151 -> V_129 ;
T_2 V_130 = F_29 ( V_129 , V_4 -> V_74 ) ;
switch ( V_150 ) {
case V_152 :
case V_153 :
...
F_42 ( V_4 -> V_8 , V_157 , 0x0 ) ;
F_8 ( V_4 -> V_8 , F_31 ( V_25 ) ,
V_25 ? V_158 : V_159 ,
V_25 ? F_43 ( V_130 ) : F_44 ( V_130 ) ) ;
break;
case V_160 :
case V_161 :
case V_162 :
...
static bool F_47 ( struct V_165 * V_11 , unsigned int V_166 )
{
switch ( V_166 ) {
case V_167 :
case V_69 :
...
static bool F_48 ( struct V_165 * V_11 , unsigned int V_166 )
{
switch ( V_166 ) {
case V_157 :
case V_69 :
...
{
struct V_184 * V_185 = V_6 -> V_11 . V_186 ;
struct V_3 * V_4 ;
struct V_187 * V_188 ;
const T_4 * V_189 ;
void T_5 * V_190 ;
int V_1 , V_56 ;
V_4 = F_50 ( & V_6 -> V_11 , sizeof( * V_4 ) , V_191 ) ;
if ( ! V_4 )
return - V_192 ;
V_4 -> V_6 = V_6 ;
strncpy ( V_4 -> V_193 , V_185 -> V_193 , sizeof( V_4 -> V_193 ) - 1 ) ;
V_188 = F_51 ( V_6 , V_194 , 0 ) ;
V_190 = F_52 ( & V_6 -> V_11 , V_188 ) ;
if ( F_13 ( V_190 ) )
return F_14 ( V_190 ) ;
...
V_4 -> V_74 = 2 ;
V_4 -> V_70 = true ;
V_189 = F_57 ( V_185 , L_28 , NULL ) ;
if ( V_189 )
V_4 -> V_142 = F_58 ( V_189 ) ;
else
V_4 -> V_142 = 64 ;
V_4 -> V_163 . V_197 = 16 ;
V_4 -> V_164 . V_197 = 16 ;
V_4 -> V_163 . V_198 = V_188 -> V_199 + V_157 ;
V_4 -> V_164 . V_198 = V_188 -> V_199 + V_167 ;
V_4 -> V_123 =
F_59 ( V_185 , L_29 ) ;
if ( V_4 -> V_123 ) {
V_200 . V_201 = 1 ;
...
F_60 ( & V_6 -> V_11 , V_4 ) ;
V_56 = F_42 ( V_4 -> V_8 , V_69 , V_204 ) ;
if ( V_56 ) {
F_7 ( & V_6 -> V_11 , L_30 , V_56 ) ;
return V_56 ;
}
V_56 = F_42 ( V_4 -> V_8 , V_69 , V_205 ) ;
if ( V_56 ) {
F_7 ( & V_6 -> V_11 , L_31 , V_56 ) ;
return V_56 ;
}
V_56 = F_61 ( & V_6 -> V_11 , & V_206 ,
& V_200 , 1 ) ;
if ( V_56 ) {
