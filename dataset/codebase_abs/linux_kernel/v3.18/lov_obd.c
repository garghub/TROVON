...
static int F_109 ( struct V_208 * V_209 ,
void * V_24 , int V_33 )
{
struct V_191 * V_210 = (struct V_191 * ) V_24 ;
int V_197 ;
if ( V_33 )
F_70 ( & V_210 -> V_211 , 0 ) ;
V_197 = F_110 ( V_210 ) ;
...
static int F_111 ( struct V_60 * exp , struct V_193 * V_194 ,
struct V_208 * V_209 )
{
struct V_191 * V_210 ;
struct V_3 * V_4 ;
...
return - V_48 ;
V_4 = & exp -> V_52 -> V_5 . V_4 ;
V_33 = F_112 ( exp , V_194 , & V_210 ) ;
if ( V_33 )
return V_33 ;
F_8 ( V_80 , L_64 V_206 L_65 ,
F_105 ( & V_194 -> V_212 -> V_213 ) , V_194 -> V_212 -> V_181 ,
V_194 -> V_212 -> V_214 ) ;
F_102 (pos, &lovset->set_list) {
V_196 = F_85 ( V_148 , struct V_195 , V_200 ) ;
F_8 ( V_80 , L_64 V_206 L_66 V_206 L_67
L_68 , F_105 ( & V_194 -> V_205 -> V_185 ) , V_196 -> V_202 ,
F_105 ( & V_196 -> V_204 . V_205 -> V_185 ) , V_196 -> V_203 ) ;
V_33 = F_113 ( V_4 -> V_17 [ V_196 -> V_203 ] -> V_47 ,
& V_196 -> V_204 , V_209 ) ;
if ( V_33 ) {
F_15 ( L_69 V_206 L_70
V_206 L_63 ,
exp -> V_52 -> V_49 ,
...
if ( ! F_114 ( & V_209 -> V_215 ) ) {
F_20 ( V_33 == 0 ) ;
F_20 ( V_209 -> V_216 == NULL ) ;
V_209 -> V_216 = F_109 ;
V_209 -> V_217 = ( void * ) V_210 ;
return V_33 ;
}
V_75:
if ( V_33 )
...
static int F_117 ( struct V_60 * exp , struct V_193 * V_194 ,
struct V_171 * V_172 ,
struct V_208 * V_209 )
{
struct V_191 * V_192 ;
...
L_68 , F_105 ( & V_194 -> V_205 -> V_185 ) , V_196 -> V_202 ,
F_105 ( & V_196 -> V_204 . V_205 -> V_185 ) , V_196 -> V_203 ) ;
V_33 = F_119 ( V_4 -> V_17 [ V_196 -> V_203 ] -> V_47 ,
& V_196 -> V_204 , V_172 , V_209 ) ;
if ( V_33 ) {
F_15 ( L_71 V_206 L_70
V_206 L_63 ,
F_105 ( & V_192 -> V_218 -> V_205 -> V_185 ) ,
F_105 ( & V_196 -> V_204 . V_205 -> V_185 ) ,
V_196 -> V_203 , V_33 ) ;
break;
}
}
if ( V_33 || ! V_209 || F_114 ( & V_209 -> V_215 ) ) {
int V_197 ;
if ( V_33 )
F_70 ( & V_192 -> V_211 , 0 ) ;
V_197 = F_116 ( V_192 ) ;
...
F_20 ( V_209 -> V_216 == NULL ) ;
V_209 -> V_216 = F_115 ;
V_209 -> V_217 = ( void * ) V_192 ;
return 0 ;
}
static int F_120 ( struct V_60 * exp ,
struct V_169 * V_174 , T_3 V_219 ,
void * V_24 )
{
struct V_3 * V_4 ;
int V_33 = 0 , V_10 ;
...
for ( V_10 = 0 ; V_10 < V_174 -> V_181 ; V_10 ++ ) {
struct V_169 V_220 ;
struct V_221 * V_222 = V_174 -> V_182 [ V_10 ] ;
if ( ! V_4 -> V_17 [ V_222 -> V_183 ] ) {
F_8 ( V_223 , L_72 , V_222 -> V_183 ) ;
continue;
}
V_220 . V_213 = V_222 -> V_184 ;
V_220 . V_181 = 0 ;
V_33 = F_121 ( V_4 -> V_17 [ V_222 -> V_183 ] -> V_47 ,
& V_220 , V_219 , V_24 ) ;
if ( V_33 != 0 )
return V_33 ;
}
...
int F_122 ( struct V_208 * V_209 , void * V_24 , int V_33 )
{
struct V_191 * V_210 = (struct V_191 * ) V_24 ;
int V_197 ;
if ( V_33 )
...
static int F_124 ( struct V_60 * exp , struct V_193 * V_194 ,
T_2 V_224 , struct V_208 * V_209 )
{
struct V_1 * V_2 = F_31 ( exp ) ;
struct V_191 * V_192 ;
struct V_195 * V_196 ;
...
int V_33 = 0 ;
F_20 ( V_194 != NULL ) ;
F_20 ( V_194 -> V_225 != NULL ) ;
V_4 = & V_2 -> V_5 . V_4 ;
V_33 = F_125 ( V_2 , V_194 , & V_192 ) ;
if ( V_33 )
return V_33 ;
F_102 (pos, &set->set_list) {
V_196 = F_85 ( V_148 , struct V_195 , V_200 ) ;
V_33 = F_126 ( V_4 -> V_17 [ V_196 -> V_203 ] -> V_47 ,
& V_196 -> V_204 , V_224 , V_209 ) ;
if ( V_33 )
break;
}
if ( V_33 || F_114 ( & V_209 -> V_215 ) ) {
int V_197 ;
if ( V_33 )
F_70 ( & V_192 -> V_211 , 0 ) ;
V_197 = F_123 ( V_192 ) ;
...
V_194 . V_225 = V_227 ;
V_194 . V_229 = V_228 ;
V_33 = F_124 ( exp , & V_194 , V_224 , V_192 ) ;
if ( V_33 == 0 )
V_33 = F_129 ( V_192 ) ;
F_130 ( V_192 ) ;
return V_33 ;
}
static int F_131 ( unsigned int V_156 , struct V_60 * exp , int V_230 ,
...
if ( ! V_51 )
return - V_34 ;
if ( F_132 ( V_24 -> V_240 , F_133 ( V_51 ) ,
...
if ( V_33 )
return V_33 ;
if ( F_132 ( V_24 -> V_244 , & V_236 ,
F_134 ( ( int ) V_24 -> V_245 ,
( int ) sizeof( V_236 ) ) ) )
return - V_242 ;
break;
}
...
T_1 * V_155 ;
V_230 = 0 ;
if ( F_136 ( & V_247 , & V_230 , ( void * ) V_232 ) )
return - V_34 ;
...
if ( F_132 ( ( void * ) V_232 , V_247 , V_230 ) )
V_33 = - V_242 ;
F_137 ( V_247 , V_230 ) ;
break;
}
case V_253 :
V_33 = F_138 ( exp , V_231 , V_232 ) ;
break;
case V_254 : {
...
V_197 = F_140 ( V_156 , V_4 -> V_17 [ V_10 ] -> V_47 ,
V_230 , V_231 , V_232 ) ;
if ( V_197 == - V_239 && V_156 == V_264 ) {
return V_197 ;
} else if ( V_197 ) {
if ( V_4 -> V_17 [ V_10 ] -> V_69 ) {
F_8 ( V_197 == - V_263 ?
...
if ( V_278 == - 1 )
return - V_34 ;
if ( ( F_142 ( V_174 , V_278 , V_269 , V_270 ,
& V_275 , & V_276 ) ) != 0 &&
V_272 < V_276 ) {
V_277 = V_272 ;
* V_271 = V_278 ;
...
int F_143 ( struct V_169 * V_174 , T_4 V_269 ,
T_4 V_270 , int V_271 ,
int * V_281 )
{
int V_282 ;
T_4 V_283 , V_284 ;
int V_10 , V_285 ;
if ( V_270 - V_269 > V_174 -> V_214 * V_174 -> V_181 ) {
...
if ( ( F_142 ( V_174 , V_10 , V_269 , V_270 ,
& V_283 , & V_284 ) ) == 0 )
break;
}
* V_281 = V_285 ;
...
V_291 = ( char * ) V_268 + F_145 ( V_290 ) ;
memcpy ( V_291 , V_287 , V_289 * sizeof( struct V_286 ) ) ;
}
static int F_146 ( struct V_3 * V_4 , T_1 V_295 , void * V_296 ,
...
if ( F_145 ( V_299 -> V_268 . V_279 ) < V_310 )
V_310 = F_145 ( V_299 -> V_268 . V_279 ) ;
F_148 ( V_300 , V_310 ) ;
if ( V_300 == NULL ) {
V_33 = - V_103 ;
goto V_75;
...
V_269 = V_268 -> V_269 ;
V_304 = V_268 -> V_304 ;
V_303 = V_271 = F_150 ( V_174 , V_269 ) ;
V_270 = ( V_304 == ~ 0ULL ? V_299 -> V_188 . V_312 :
V_269 + V_304 - 1 ) ;
if ( V_270 > V_299 -> V_188 . V_312 )
V_270 = V_299 -> V_188 . V_312 ;
V_282 = F_143 ( V_174 , V_269 , V_270 ,
V_303 , & V_281 ) ;
V_277 = F_141 ( V_268 , V_174 , V_269 ,
V_270 , & V_271 ) ;
if ( V_277 == - V_34 ) {
V_33 = - V_34 ;
goto V_75;
}
if ( F_145 ( V_268 -> V_279 ) > * V_297 )
V_268 -> V_279 = F_149 ( * V_297 ) ;
if ( V_268 -> V_279 == 0 ) {
V_302 = 1 ;
V_301 = 0 ;
}
...
unsigned int V_289 ;
V_309 = V_308 ;
if ( ( F_142 ( V_174 , V_308 , V_269 , V_270 ,
& V_275 , & V_315 ) ) == 0 )
continue;
...
V_299 -> V_188 . V_185 = V_174 -> V_182 [ V_308 ] -> V_184 ;
V_288 = V_174 -> V_182 [ V_308 ] -> V_183 ;
if ( V_288 < 0 ||
V_288 >= V_4 -> V_15 . V_16 ) {
V_33 = - V_34 ;
goto V_75;
...
static int F_155 ( const struct V_58 * V_59 , struct V_60 * exp ,
...
* V_297 = sizeof( * V_333 ) ;
for ( V_10 = 0 ; V_10 < V_174 -> V_181 ; V_10 ++ ) {
V_222 = V_174 -> V_182 [ V_10 ] ;
if ( ! V_4 -> V_17 [ V_222 -> V_183 ] )
continue;
if ( V_4 -> V_17 [ V_222 -> V_183 ] -> V_47 ==
V_24 -> V_328 -> V_334 &&
F_157 ( & V_222 -> V_184 , V_330 ) ) {
* V_333 = V_10 ;
V_33 = 0 ;
goto V_75;
}
}
F_158 ( V_24 -> V_328 , L_75 ) ;
F_159 ( V_335 , V_174 ) ;
V_33 = - V_336 ;
goto V_75;
} else if ( F_156 ( V_337 ) ) {
...
V_33 = F_152 ( V_59 , V_12 -> V_47 , V_295 , V_296 ,
...
V_33 = F_146 ( V_4 , V_295 , V_296 , V_297 , V_110 , V_174 ) ;
goto V_75;
} else if ( F_156 ( V_346 ) ) {
struct V_11 * V_12 ;
T_2 V_175 = * ( ( T_2 * ) V_110 ) ;
...
static int F_161 ( const struct V_58 * V_59 , struct V_60 * exp ,
T_5 V_295 , void * V_296 , T_5 V_297 ,
void * V_110 , struct V_208 * V_192 )
{
struct V_1 * V_233 = F_31 ( exp ) ;
struct V_3 * V_4 = & V_233 -> V_5 . V_4 ;
T_5 V_109 ;
...
V_350 , V_351 ;
unsigned V_352 = 0 , V_353 = 0 , V_190 = 0 ;
...
void F_162 ( struct V_169 * V_359 )
__releases( &md->lsm_lock
static int F_163 ( struct V_1 * V_2 , struct V_60 * exp ,
struct V_257 * V_258 )
{
struct V_3 * V_4 = & V_2 -> V_5 . V_4 ;
struct V_11 * V_12 ;
...
continue;
V_197 = F_165 ( V_4 -> V_17 [ V_10 ] -> V_47 , V_258 ) ;
if ( V_197 && ! V_33 )
V_33 = V_197 ;
}
V_75:
...
F_75 ( & V_123 ) ;
V_33 = F_170 ( & V_376 , NULL , V_123 . V_377 ,
V_378 , & V_379 ) ;
if ( V_33 ) {
F_171 ( V_374 ) ;
F_169 ( V_373 ) ;
