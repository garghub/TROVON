...
static int F_41 ( struct V_1 * V_2 , unsigned int V_69 )
{
struct V_13 * V_14 = V_2 -> V_14 ;
F_7 ( V_11 , V_70 ) ;
unsigned int V_36 ;
...
void T_4 * V_116 ;
int V_16 ;
V_103 = F_43 ( V_2 -> V_117 , V_2 -> V_90 * V_118 ) ;
#ifdef F_54
if ( V_91 != 0 &&
V_92 / V_91 * V_119 >=
V_2 -> V_90 ) {
