...
static T_2 F_33 ( int V_15 , void * V_22 )
{
int V_1 = F_2 () ;
F_24 ( V_1 , 0 ) ;
F_9 ( V_1 , 0xff ) ;
...
static int T_3 F_35 ( int V_23 , unsigned long V_24 ,
unsigned long V_25 )
{
char * V_26 ;
int V_27 , V_1 = - 1 ;
...
V_26 = F_39 ( V_28 , L_2 ,
V_1 , V_23 ) ;
if ( ! F_40 ( V_24 , V_25 , V_26 ) ) {
F_41 ( L_3
L_4 ,
V_1 , V_23 ) ;
return - V_29 ;
}
V_3 [ V_1 ] = F_42 ( V_24 , V_25 ) ;
F_43 ( V_1 , V_24 ) ;
if ( ! V_3 [ V_1 ] ) {
F_41 ( L_5
L_6 ,
...
static int T_3 F_45 ( struct V_31 * V_32 ,
unsigned int * V_33 )
{
unsigned int V_34 ;
const T_4 * V_35 ;
...
int V_36 ;
int V_37 = 0 ;
V_35 = F_46 ( V_32 , L_7 , & V_34 ) ;
F_47 ( ( V_35 == NULL ) || ( V_34 != 2 * sizeof( V_38 ) ) ) ;
if ( V_35 ) {
* V_33 = F_48 ( V_35 , 1 ) ;
if ( V_34 >= 2 * sizeof( V_38 ) )
V_37 = F_48 ( V_35 + 1 , 1 ) ;
}
V_35 = F_46 ( V_32 , L_8 , & V_34 ) ;
if ( ! V_35 ) {
F_31 ( L_9 ) ;
return - 1 ;
}
V_36 = ( F_49 ( V_32 ) + F_50 ( V_32 ) ) * 4 ;
if ( ( ( V_34 % V_36 ) != 0 )
|| ( V_37 && ( V_37 != ( V_34 / V_36 ) ) ) ) {
F_31 ( L_10 ,
V_34 / V_36 , V_37 ) ;
...
struct V_39 V_40 ;
int V_41 ;
V_41 = F_51 ( V_32 , V_27 , & V_40 ) ;
if ( V_41 ) {
F_31 ( L_11
L_12 , * V_33 , V_41 ) ;
return - 1 ;
}
if ( F_35 ( * V_33 , V_40 . V_42 , F_52 ( & V_40 ) ) )
return - 1 ;
( * V_33 ) ++ ;
}
return 0 ;
