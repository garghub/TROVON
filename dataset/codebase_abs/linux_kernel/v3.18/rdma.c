...
V_101 -> V_113 = ! ! ( args -> V_27 & V_114 ) ;
V_101 -> V_115 = ! ! ( args -> V_27 & V_116 ) ;
V_101 -> V_117 = ! ! ( args -> V_27 & V_118 ) ;
V_101 -> V_87 = 1 ;
V_101 -> V_119 = V_24 -> V_120 ;
F_29 ( ! V_40 ) ;
...
if ( V_101 -> V_115 || V_101 -> V_119 ) {
V_101 -> V_86 = F_57 ( sizeof( struct V_121 ) , V_61 ) ;
if ( ! V_101 -> V_86 ) {
V_44 = - V_62 ;
goto V_57;
}
V_101 -> V_86 -> V_122 = args -> V_123 ;
V_101 -> V_86 -> V_124 = V_125 ;
}
V_101 -> V_126 = F_42 ( args -> V_52 ) ;
V_101 -> V_127 = args -> V_128 . V_3 + F_58 ( args -> V_52 ) ;
V_103 = 0 ;
F_8 ( L_7 ,
( unsigned long long ) args -> V_96 ,
( unsigned long long ) args -> V_128 . V_3 ,
V_101 -> V_126 ) ;
for ( V_54 = 0 ; V_54 < args -> V_96 ; V_54 ++ ) {
struct V_1 * V_90 = & V_106 [ V_54 ] ;
unsigned int V_129 = F_1 ( V_90 ) ;
V_24 -> V_130 = V_90 -> V_3 ;
V_24 -> V_131 = V_90 -> V_4 ;
V_44 = F_22 ( V_90 -> V_3 , V_129 , V_42 , ! V_101 -> V_85 ) ;
if ( V_44 < 0 )
goto V_57;
F_8 ( L_8 ,
V_103 , V_129 , V_90 -> V_4 , V_90 -> V_3 ) ;
V_103 += V_90 -> V_4 ;
for ( V_108 = 0 ; V_108 < V_129 ; V_108 ++ ) {
unsigned int V_132 = V_90 -> V_3 & ~ V_69 ;
struct V_50 * V_51 ;
...
V_132 ) ;
F_8 ( L_9 ,
V_51 -> V_132 , V_51 -> V_133 , V_90 -> V_3 , V_90 -> V_4 ) ;
V_90 -> V_3 += V_51 -> V_133 ;
V_90 -> V_4 -= V_51 -> V_133 ;
}
V_101 -> V_83 += V_129 ;
}
if ( V_103 > args -> V_128 . V_4 ) {
F_8 ( L_10 ,
V_103 ,
( unsigned int ) args -> V_128 . V_4 ) ;
V_44 = - V_60 ;
goto V_57;
}
V_101 -> V_134 = V_103 ;
...
V_98 -> V_137 != 0 )
return - V_60 ;
memcpy ( & V_98 -> V_137 , F_53 ( V_100 ) , sizeof( V_98 -> V_137 ) ) ;
V_19 = F_42 ( V_98 -> V_137 ) ;
F_11 ( & V_24 -> V_30 , V_27 ) ;
V_17 = F_2 ( & V_24 -> V_31 , V_19 , NULL ) ;
if ( ! V_17 )
V_136 = - V_60 ;
...
F_14 ( & V_24 -> V_30 , V_27 ) ;
if ( V_17 ) {
V_17 -> V_33 -> V_79 ( V_17 -> V_32 , V_138 ) ;
V_98 -> V_102 . V_139 = V_17 ;
}
return V_136 ;
}
...
V_98 -> V_137 != 0 )
return - V_60 ;
return F_25 ( V_24 , F_53 ( V_100 ) , & V_98 -> V_137 , & V_98 -> V_102 . V_139 ) ;
}
...
struct V_140 * args ;
int V_44 = 0 ;
if ( V_100 -> V_109 < F_52 ( sizeof( struct V_140 ) )
|| V_98 -> V_141 . V_87 )
return - V_60 ;
args = F_53 ( V_100 ) ;
switch ( V_100 -> V_142 ) {
case V_143 :
V_98 -> V_141 . V_144 = V_145 ;
V_98 -> V_141 . V_146 . V_147 = args -> V_148 . V_147 ;
V_98 -> V_141 . V_146 . V_149 = 0 ;
break;
case V_150 :
V_98 -> V_141 . V_144 = V_145 ;
V_98 -> V_141 . V_146 . V_147 = args -> V_151 . V_147 ;
V_98 -> V_141 . V_146 . V_149 = args -> V_151 . V_149 ;
break;
case V_152 :
V_98 -> V_141 . V_144 = V_153 ;
V_98 -> V_141 . V_154 . V_155 = args -> V_156 . V_155 ;
V_98 -> V_141 . V_154 . V_157 = args -> V_156 . V_157 ;
V_98 -> V_141 . V_154 . V_158 = ~ 0 ;
V_98 -> V_141 . V_154 . V_159 = ~ 0 ;
break;
case V_160 :
V_98 -> V_141 . V_144 = V_153 ;
V_98 -> V_141 . V_154 . V_155 = args -> V_161 . V_155 ;
V_98 -> V_141 . V_154 . V_157 = args -> V_161 . V_157 ;
V_98 -> V_141 . V_154 . V_158 = args -> V_161 . V_158 ;
V_98 -> V_141 . V_154 . V_159 = args -> V_161 . V_159 ;
break;
default:
F_65 () ;
}
V_98 -> V_141 . V_115 = ! ! ( args -> V_27 & V_116 ) ;
V_98 -> V_141 . V_117 = ! ! ( args -> V_27 & V_118 ) ;
V_98 -> V_141 . V_87 = 1 ;
V_98 -> V_141 . V_119 = V_24 -> V_120 ;
V_98 -> V_141 . V_84 = F_56 ( V_98 , 1 ) ;
if ( ! V_98 -> V_141 . V_84 ) {
V_44 = - V_62 ;
goto V_136;
}
...
V_44 = F_22 ( args -> V_162 , 1 , & V_41 , 1 ) ;
if ( V_44 != 1 )
goto V_136;
V_44 = 0 ;
F_31 ( V_98 -> V_141 . V_84 , V_41 , 8 , F_66 ( args -> V_162 ) ) ;
if ( V_98 -> V_141 . V_115 || V_98 -> V_141 . V_119 ) {
V_98 -> V_141 . V_86 = F_57 ( sizeof( * V_98 -> V_141 . V_86 ) , V_61 ) ;
if ( ! V_98 -> V_141 . V_86 ) {
V_44 = - V_62 ;
goto V_136;
}
V_98 -> V_141 . V_86 -> V_122 = args -> V_123 ;
V_98 -> V_141 . V_86 -> V_124 = V_125 ;
}
V_98 -> V_141 . V_126 = F_42 ( args -> V_52 ) ;
V_98 -> V_141 . V_127 = args -> V_163 + F_58 ( args -> V_52 ) ;
return V_44 ;
V_136:
if ( V_41 )
F_24 ( V_41 ) ;
F_16 ( V_98 -> V_141 . V_86 ) ;
return V_44 ;
}
