...
V_2 = F_124 ( V_15 , V_247 , V_246 -> V_254 , V_79 ,
V_95 & V_251 ) ;
if ( V_2 >= 0 )
V_2 = V_79 ;
V_17:
...
V_95 & V_251 , & V_2 ) ;
if ( ! V_57 ) {
if ( V_2 == - V_132 && ( V_15 -> V_208 & V_258 ) )
V_2 = 0 ;
goto V_17;
}
V_60 = F_50 ( V_57 ) ;
V_256 = F_53 ( V_60 -> V_116 ) - sizeof( struct V_59 ) ;
if ( V_256 > V_255 ) {
V_256 = V_255 ;
V_246 -> V_250 |= V_259 ;
}
V_2 = F_127 ( V_57 , sizeof( struct V_59 ) , V_246 -> V_254 ,
V_256 ) ;
if ( V_2 )
goto V_260;
if ( V_57 -> V_261 . V_262 )
V_15 -> V_263 = V_57 -> V_261 ;
if ( V_165 ) {
V_165 -> V_168 = V_169 ;
...
long V_264 = 0 ;
struct V_14 * V_15 = V_14 -> V_15 ;
void T_1 * V_265 = ( void T_1 * ) V_10 ;
F_96 ( V_15 ) ;
switch ( V_160 ) {
case V_266 :
V_264 = V_15 -> V_267 - F_130 ( V_15 ) ;
if ( V_264 < 0 )
V_264 = 0 ;
V_2 = F_100 ( V_264 , ( int T_1 * ) V_265 ) ;
break;
case V_268 : {
struct V_56 * V_57 = F_131 ( & V_15 -> V_19 ) ;
if ( V_57 )
V_264 = V_57 -> V_79 - sizeof( struct V_59 ) ;
V_2 = F_100 ( V_264 , ( int T_1 * ) V_265 ) ;
break;
}
case V_269 :
...
( const unsigned short T_1 * ) V_265 ) ;
break;
case V_274 :
V_2 = F_133 ( V_15 , V_265 ) ;
break;
case V_275 :
case V_276 :
case V_277 :
...
static int F_135 ( struct V_189 * V_14 , int V_282 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
...
F_72 ( V_289 ) ;
V_146 = F_142 ( V_290 , F_119 ) ;
if ( ! V_146 )
F_72 ( V_291 ) ;
V_149 = F_143 ( V_292 , F_119 ) ;
if ( ! V_149 )
F_72 ( V_293 ) ;
F_144 ( & V_294 ) ;
F_145 () ;
