...
{
struct V_93 * V_94 = V_6 -> V_20 -> V_1 ;
struct V_35 * V_95 , * V_96 ;
T_2 * V_97 ;
enum V_76 V_77 ;
unsigned int V_7 ;
bool V_98 = false ;
...
if ( F_45 ( V_97 ) > 0 && ! F_23 ( V_96 ) ) {
V_11 = F_32 ( V_6 , V_96 , V_1 ) ;
if ( V_11 < 0 ) {
F_9 ( & V_6 -> V_12 -> V_26 ,
L_13 , V_11 ) ;
F_46 ( V_95 ) ;
...
static int
F_57 ( T_1 * V_47 , unsigned int V_107 ,
struct V_108 * V_109 )
{
unsigned int V_2 , V_110 , V_40 , V_111 ;
if ( ( V_47 [ 0 ] != 0x90 ) || ( V_47 [ 1 ] != 0x40 ) )
return - V_54 ;
for ( V_2 = 0 ; V_2 < F_2 ( V_112 ) ; V_2 ++ ) {
if ( V_47 [ 2 ] == V_112 [ V_2 ] )
break;
}
if ( V_2 == F_2 ( V_112 ) )
return - V_54 ;
memset ( & V_109 [ V_2 ] , 0 , sizeof( struct V_108 ) ) ;
for ( V_110 = 0 ; V_110 < V_47 [ 4 ] ; V_110 ++ ) {
V_40 = V_47 [ 5 + V_110 * 2 ] ;
V_111 = V_47 [ 6 + V_110 * 2 ] ;
switch ( V_111 ) {
case 0x00 :
case 0x06 :
V_109 [ V_2 ] . V_41 += V_40 ;
...
if ( V_109 [ V_2 ] . V_41 > V_56 ||
V_109 [ V_2 ] . V_42 > V_113 )
return - V_54 ;
return 0 ;
}
static int
...
F_61 ( struct V_5 * V_6 )
{
T_1 V_119 [ V_120 ] , V_21 [ V_22 ] ;
unsigned int V_2 ;
enum V_121 type ;
int V_11 ;
V_11 = F_62 ( V_6 -> V_12 , 0x0c , 0x00 , 0x00 , V_119 ) ;
if ( V_11 < 0 ) {
F_9 ( & V_6 -> V_12 -> V_26 ,
L_15 ,
V_11 ) ;
...
unsigned int V_2 ;
int V_11 ;
V_11 = F_62 ( V_6 -> V_12 , 0x1f , 0x07 , 0x00 , V_119 ) ;
if ( V_11 < 0 ) {
F_9 ( & V_6 -> V_12 -> V_26 ,
L_17 ,
V_11 ) ;
