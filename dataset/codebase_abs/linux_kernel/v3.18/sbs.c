...
goto V_78;
V_13 -> V_108 = 1 ;
V_13 -> V_109 . V_97 = L_10 ;
V_13 -> V_109 . type = V_110 ;
V_13 -> V_109 . V_101 = V_111 ;
V_13 -> V_109 . V_103 = F_15 ( V_111 ) ;
V_13 -> V_109 . V_105 = F_6 ;
F_27 ( & V_13 -> V_88 -> V_89 , & V_13 -> V_109 ) ;
...
struct V_2 * V_99 ;
V_67 V_113 = V_13 -> V_16 ;
V_67 V_114 ;
if ( V_13 -> V_108 ) {
F_21 ( V_13 ) ;
if ( V_13 -> V_16 != V_113 )
F_36 ( & V_13 -> V_109 . V_89 -> V_115 , V_116 ) ;
}
if ( V_13 -> V_84 ) {
for ( V_82 = 0 ; V_82 < V_117 ; ++ V_82 ) {
if ( ! ( V_13 -> V_68 & ( 1 << V_82 ) ) )
continue;
V_99 = & V_13 -> V_3 [ V_82 ] ;
V_114 = V_99 -> V_24 ;
...
if ( V_114 == V_99 -> V_24 )
continue;
F_36 ( & V_99 -> V_99 . V_89 -> V_115 , V_116 ) ;
}
}
}
static int F_37 ( const struct V_118 * V_119 )
{
V_120 = true ;
return 0 ;
}
static int F_38 ( struct V_121 * V_88 )
{
struct V_12 * V_13 ;
int V_62 = 0 ;
int V_82 ;
F_39 ( V_122 ) ;
V_13 = F_40 ( sizeof( struct V_12 ) , V_123 ) ;
if ( ! V_13 ) {
V_62 = - V_124 ;
goto V_78;
}
F_41 ( & V_13 -> V_125 ) ;
V_13 -> V_64 = F_42 ( V_88 -> V_126 ) ;
V_13 -> V_88 = V_88 ;
strcpy ( F_43 ( V_88 ) , V_127 ) ;
strcpy ( F_44 ( V_88 ) , V_128 ) ;
V_88 -> V_129 = V_13 ;
V_62 = F_33 ( V_13 ) ;
if ( V_62 && V_62 != - V_26 )
goto V_78;
...
if ( ! V_13 -> V_84 )
F_26 ( V_13 , 0 ) ;
F_45 ( V_13 -> V_64 , F_35 , V_13 ) ;
V_78:
if ( V_62 )
F_46 ( V_88 ) ;
return V_62 ;
}
static int F_46 ( struct V_121 * V_88 )
{
struct V_12 * V_13 ;
int V_82 ;
if ( ! V_88 )
