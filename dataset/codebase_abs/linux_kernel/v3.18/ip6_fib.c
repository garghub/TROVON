...
static int F_58 ( struct V_17 * V_18 , struct V_21 * V_22 ,
...
V_129 = 0 ;
F_63 (sibling, temp_sibling,
&rt->rt6i_siblings, rt6i_siblings) {
V_133 -> V_129 ++ ;
F_64 ( V_133 -> V_129 != V_22 -> V_129 ) ;
V_129 ++ ;
}
F_64 ( V_129 != V_22 -> V_129 ) ;
}
if ( ! V_114 ) {
if ( ! V_118 )
F_47 ( L_3 ) ;
...
static void F_66 ( struct V_6 * V_6 , struct V_21 * V_22 )
{
if ( ! F_67 ( & V_6 -> V_9 . V_142 ) &&
( V_22 -> V_97 & ( V_130 | V_143 ) ) )
F_68 ( & V_6 -> V_9 . V_142 ,
V_144 + V_6 -> V_9 . V_145 . V_146 ) ;
}
void F_69 ( struct V_6 * V_6 )
{
if ( ! F_67 ( & V_6 -> V_9 . V_142 ) )
F_68 ( & V_6 -> V_9 . V_142 ,
V_144 + V_6 -> V_9 . V_145 . V_146 ) ;
}
int F_70 ( struct V_17 * V_60 , struct V_21 * V_22 , struct V_110 * V_111 ,
struct V_101 * V_102 , int V_103 )
{
...
#endif
V_122 = F_58 ( V_18 , V_22 , V_111 , V_102 , V_103 ) ;
if ( ! V_122 ) {
F_66 ( V_111 -> V_138 , V_22 ) ;
if ( ! ( V_22 -> V_97 & V_143 ) )
F_75 ( V_111 -> V_138 , V_86 ) ;
}
V_76:
if ( V_122 ) {
#ifdef F_74
...
V_86 -> V_36 = F_77 ( V_111 -> V_138 , V_86 ) ;
#if V_153 >= 2
if ( ! V_86 -> V_36 ) {
F_33 ( V_86 -> V_36 == NULL ) ;
...
F_78 ( V_111 -> V_138 , V_18 ) ;
F_17 ( & V_22 -> V_24 ) ;
return V_122 ;
#endif
}
static struct V_17 * F_79 ( struct V_17 * V_60 ,
struct V_154 * args )
{
struct V_17 * V_18 ;
T_1 V_90 ;
...
struct V_17 * F_82 ( struct V_17 * V_60 , const struct V_78 * V_156 ,
const struct V_78 * V_157 )
{
struct V_17 * V_18 ;
struct V_154 args [] = {
{
. V_80 = F_71 ( struct V_21 , V_147 ) ,
. V_14 = V_156 ,
} ,
#ifdef F_74
{
. V_80 = F_71 ( struct V_21 , V_148 ) ,
. V_14 = V_157 ,
} ,
#endif
{
...
V_18 = F_79 ( V_60 , V_156 ? args : args + 1 ) ;
...
{
struct V_17 * V_18 ;
V_18 = F_83 ( V_60 , V_156 , V_158 ,
F_71 ( struct V_21 , V_147 ) ) ;
#ifdef F_74
if ( V_159 ) {
F_33 ( V_157 == NULL ) ;
if ( V_18 && V_18 -> V_150 )
V_18 = F_83 ( V_18 -> V_150 , V_157 , V_159 ,
F_71 ( struct V_21 , V_148 ) ) ;
}
#endif
...
static struct V_21 * F_77 ( struct V_6 * V_6 , struct V_17 * V_18 )
{
if ( V_18 -> V_38 & V_39 )
return V_6 -> V_9 . V_37 ;
while ( V_18 ) {
...
static struct V_17 * F_78 ( struct V_6 * V_6 ,
struct V_17 * V_18 )
{
int V_160 ;
int V_161 ;
...
if ( V_160 == 3 || F_81 ( V_18 )
#ifdef F_74
|| ( V_160 && V_18 -> V_38 & V_39 )
#endif
) {
V_18 -> V_36 = F_77 ( V_6 , V_18 ) ;
#if V_153 >= 2
if ( ! V_18 -> V_36 ) {
F_33 ( ! V_18 -> V_36 ) ;
...
static void F_88 ( struct V_17 * V_18 , struct V_21 * * V_167 ,
struct V_110 * V_111 )
{
struct V_1 * V_2 ;
...
F_64 ( F_8 ( & V_22 -> V_23 ) != 1 ) ;
}
F_65 ( V_170 , V_22 , V_111 ) ;
F_15 ( V_22 ) ;
}
int F_90 ( struct V_21 * V_22 , struct V_110 * V_111 )
{
struct V_6 * V_6 = V_111 -> V_138 ;
...
int V_53 ;
struct V_21 * V_22 ;
struct V_174 * V_175 = F_92 ( V_2 , struct V_174 , V_2 ) ;
struct V_110 V_111 = {
. V_138 = V_175 -> V_6 ,
} ;
if ( V_175 -> V_83 != V_176 &&
...
static void F_75 ( struct V_6 * V_6 , struct V_17 * V_18 )
{
...
F_102 ( V_179 , V_22 -> V_24 . V_183 + V_180 . V_184 ) ) {
F_45 ( L_16 , V_22 ) ;
return - 1 ;
} else if ( V_22 -> V_97 & V_98 ) {
struct V_185 * V_186 ;
T_5 V_187 = 0 ;
V_186 = F_103 ( & V_22 -> V_24 , & V_22 -> V_128 ) ;
if ( V_186 ) {
V_187 = V_186 -> V_51 ;
F_104 ( V_186 ) ;
}
...
void F_105 ( unsigned long V_131 , struct V_6 * V_6 , bool V_189 )
{
unsigned long V_179 ;
if ( V_189 ) {
F_106 ( & V_190 ) ;
} else if ( ! F_107 ( & V_190 ) ) {
F_68 ( & V_6 -> V_9 . V_142 , V_144 + V_191 ) ;
return;
}
...
F_114 ( & V_6 -> V_9 . V_142 , F_112 , ( unsigned long ) V_6 ) ;
V_6 -> V_9 . V_139 = F_22 ( sizeof( * V_6 -> V_9 . V_139 ) , V_194 ) ;
if ( ! V_6 -> V_9 . V_139 )
goto V_195;
V_193 = F_115 ( T_6 , V_193 , V_196 ) ;
...
if ( V_201 )
goto V_204;
V_201 = F_124 ( V_205 , V_206 , NULL , F_42 ,
NULL ) ;
if ( V_201 )
goto V_207;
V_208 = F_99 ;
...
static int F_128 ( struct V_209 * V_210 , void * V_211 )
{
struct V_21 * V_22 = V_211 ;
struct V_212 * V_112 = V_210 -> V_213 ;
F_129 ( V_210 , L_19 , & V_22 -> V_147 . V_14 , V_22 -> V_147 . V_79 ) ;
#ifdef F_74
F_129 ( V_210 , L_19 , & V_22 -> V_148 . V_14 , V_22 -> V_148 . V_79 ) ;
#else
F_130 ( V_210 , L_20 ) ;
#endif
if ( V_22 -> V_97 & V_98 )
F_129 ( V_210 , L_21 , & V_22 -> V_128 ) ;
else
F_130 ( V_210 , L_22 ) ;
F_129 ( V_210 , L_23 ,
...
static void F_132 ( struct V_212 * V_112 )
{
memset ( & V_112 -> V_2 , 0 , sizeof( V_112 -> V_2 ) ) ;
V_112 -> V_2 . V_74 = F_131 ;
...
static struct V_25 * F_134 ( struct V_25 * V_216 ,
struct V_6 * V_6 )
{
unsigned int V_27 ;
struct V_217 * V_66 ;
...
static void F_139 ( struct V_212 * V_112 )
{
...
static void * F_140 ( struct V_209 * V_210 , void * V_211 , T_8 * V_218 )
{
int V_219 ;
struct V_21 * V_220 ;
struct V_6 * V_6 = F_141 ( V_210 ) ;
struct V_212 * V_112 = V_210 -> V_213 ;
if ( ! V_211 )
goto V_221;
...
V_221:
F_139 ( V_112 ) ;
F_85 ( & V_112 -> V_216 -> V_28 ) ;
V_219 = F_41 ( & V_112 -> V_2 ) ;
F_87 ( & V_112 -> V_216 -> V_28 ) ;
if ( V_219 > 0 ) {
if ( V_211 )
++ * V_218 ;
...
F_5 ( & V_112 -> V_2 ) ;
V_112 -> V_216 = F_134 ( V_112 -> V_216 , V_6 ) ;
if ( ! V_112 -> V_216 )
return NULL ;
F_132 ( V_112 ) ;
goto V_221;
}
static void * F_142 ( struct V_209 * V_210 , T_8 * V_218 )
__acquires( T_9 )
{
struct V_6 * V_6 = F_141 ( V_210 ) ;
struct V_212 * V_112 = V_210 -> V_213 ;
F_143 () ;
V_112 -> V_216 = F_134 ( NULL , V_6 ) ;
V_112 -> V_62 = * V_218 ;
if ( V_112 -> V_216 ) {
F_132 ( V_112 ) ;
return F_140 ( V_210 , NULL , V_218 ) ;
} else {
return NULL ;
}
}
static bool F_144 ( struct V_212 * V_112 )
{
struct V_1 * V_2 = & V_112 -> V_2 ;
return V_2 -> V_66 && ! ( V_2 -> V_64 == V_165 && V_2 -> V_66 == V_2 -> V_60 ) ;
}
static void F_145 ( struct V_209 * V_210 , void * V_211 )
__releases( T_9 )
{
struct V_212 * V_112 = V_210 -> V_213 ;
if ( F_144 ( V_112 ) )
...
int F_147 ( struct V_222 * V_222 , struct V_223 * V_223 )
{
return F_148 ( V_222 , V_223 , & V_224 ,
sizeof( struct V_212 ) ) ;
}
