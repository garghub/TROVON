...
{
struct V_77 V_78 ;
printf ( L_31 V_79 , V_62 -> V_80 ) ;
if ( ! F_19 ( V_16 ) )
return;
F_20 ( V_75 , V_62 , V_76 , V_63 , & V_78 ) ;
if ( F_9 ( V_29 ) ) {
printf ( L_32 ) ;
if ( F_9 ( V_30 ) )
F_21 ( V_78 . V_81 , & V_78 , stdout ) ;
else
F_22 ( V_78 . V_81 , stdout ) ;
}
if ( F_9 ( V_31 ) ) {
printf ( L_33 ) ;
F_23 ( V_78 . V_82 , stdout ) ;
printf ( L_34 ) ;
}
}
...
bool V_83 = false ;
if ( F_9 ( V_23 ) ) {
unsigned int V_84 = V_3 [ V_16 -> type ] . V_46 ;
if ( V_56 . V_54 && V_62 -> V_85 ) {
printf ( L_35 ) ;
} else {
printf ( L_32 ) ;
if ( V_84 & V_51 ) {
...
! V_3 [ V_16 -> type ] . V_4 ) ) {
printf ( L_36 ) ;
F_18 ( V_75 , V_62 , V_78 -> V_76 , V_63 , V_16 ) ;
}
if ( V_83 )
F_26 ( V_78 -> V_82 , V_78 -> V_80 , L_37 , stdout ) ;
printf ( L_35 ) ;
}
...
F_16 ( V_62 , V_63 , V_12 ) ;
if ( F_9 ( V_43 ) )
printf ( L_38 V_87 L_32 , V_62 -> V_88 ) ;
if ( F_9 ( V_89 ) ) {
const char * V_17 = F_5 ( V_12 ) ;
printf ( L_39 , V_17 ? V_17 : L_40 ) ;
}
if ( F_28 ( V_16 ) ) {
F_24 ( V_75 , V_62 , V_12 , V_63 , V_78 ) ;
return;
}
if ( F_9 ( V_21 ) )
F_29 ( V_12 -> V_90 , V_62 -> V_71 ,
V_62 -> V_91 , V_62 -> V_92 ) ;
if ( F_9 ( V_26 ) )
F_18 ( V_75 , V_62 , V_78 -> V_76 , V_63 , V_16 ) ;
if ( F_9 ( V_23 ) ) {
...
static int F_30 ( const char * T_2 V_93 ,
int T_3 V_93 ,
const char * * T_4 V_93 )
{
return 0 ;
...
static int F_33 ( struct V_94 * V_94 V_93 ,
const char * T_5 V_93 )
{
return 0 ;
}
...
static int F_39 ( struct V_99 * T_6 V_93 ,
union V_74 * V_75 ,
struct V_61 * V_62 ,
struct V_11 * V_12 ,
struct V_76 * V_76 )
{
struct V_77 V_78 ;
struct V_63 * V_63 = F_40 ( V_76 , V_62 -> V_69 ,
V_62 -> V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_42 ,
V_75 -> V_100 . type ) ;
...
return 0 ;
V_95 -> F_27 ( V_75 , V_62 , V_12 , V_63 , & V_78 ) ;
return 0 ;
}
static int F_43 ( struct V_99 * T_6 , union V_74 * V_75 ,
struct V_107 * * V_108 )
{
...
static int F_47 ( struct V_99 * T_6 ,
union V_74 * V_75 ,
struct V_61 * V_62 ,
struct V_76 * V_76 )
{
...
int V_114 = - 1 ;
V_63 = F_40 ( V_76 , V_75 -> V_115 . V_69 , V_75 -> V_115 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_45 ) ;
return - 1 ;
}
if ( F_49 ( T_6 , V_75 , V_62 , V_76 ) < 0 )
goto V_58;
if ( ! V_12 -> V_16 . V_116 ) {
V_62 -> V_71 = 0 ;
V_62 -> time = 0 ;
...
static int F_51 ( struct V_99 * T_6 ,
union V_74 * V_75 ,
struct V_61 * V_62 ,
struct V_76 * V_76 )
{
...
struct V_19 * V_20 = T_2 -> V_20 ;
struct V_11 * V_12 = F_48 ( V_20 -> V_111 ) ;
if ( F_52 ( T_6 , V_75 , V_62 , V_76 ) < 0 )
return - 1 ;
V_63 = F_40 ( V_76 , V_75 -> V_117 . V_69 , V_75 -> V_117 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_46 ) ;
return - 1 ;
}
...
static int F_53 ( struct V_99 * T_6 ,
union V_74 * V_75 ,
struct V_61 * V_62 ,
struct V_76 * V_76 )
{
...
F_16 ( V_62 , V_63 , V_12 ) ;
F_50 ( V_75 , stdout ) ;
if ( F_54 ( T_6 , V_75 , V_62 , V_76 ) < 0 )
return - 1 ;
return 0 ;
}
static int F_55 ( struct V_99 * T_6 ,
union V_74 * V_75 ,
struct V_61 * V_62 ,
struct V_76 * V_76 )
{
...
struct V_19 * V_20 = T_2 -> V_20 ;
struct V_11 * V_12 = F_48 ( V_20 -> V_111 ) ;
if ( F_56 ( T_6 , V_75 , V_62 , V_76 ) < 0 )
return - 1 ;
V_63 = F_40 ( V_76 , V_75 -> V_118 . V_69 , V_75 -> V_118 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_48 ) ;
return - 1 ;
}
...
static int F_57 ( struct V_99 * T_6 ,
union V_74 * V_75 ,
struct V_61 * V_62 ,
struct V_76 * V_76 )
{
...
struct V_19 * V_20 = T_2 -> V_20 ;
struct V_11 * V_12 = F_48 ( V_20 -> V_111 ) ;
if ( F_58 ( T_6 , V_75 , V_62 , V_76 ) < 0 )
return - 1 ;
V_63 = F_40 ( V_76 , V_75 -> V_119 . V_69 , V_75 -> V_119 . V_70 ) ;
if ( V_63 == NULL ) {
F_7 ( L_49 ) ;
return - 1 ;
}
...
int F_68 ( const char * V_125 , struct V_95 * V_126 )
{
struct V_124 * V_127 ;
V_127 = F_65 ( V_125 ) ;
if ( V_127 )
...
static struct V_95 * F_69 ( const char * V_125 )
{
struct V_124 * V_127 = F_65 ( V_125 ) ;
if ( ! V_127 )
return NULL ;
...
static int F_71 ( const struct V_132 * T_8 V_93 ,
const char * V_10 , int T_9 V_93 )
{
char V_125 [ V_133 ] ;
...
static int F_73 ( const struct V_132 * T_8 V_93 ,
const char * V_137 , int T_9 V_93 )
{
char * V_138 ;
int V_7 , V_8 = F_3 ( V_9 ) ;
int V_1 ;
...
static int F_88 ( const struct V_132 * T_8 V_93 ,
const char * V_127 V_93 ,
int T_9 V_93 )
{
...
int F_105 ( int T_3 , const char * * T_4 , const char * T_13 V_93 )
{
bool V_194 = false ;
bool V_100 = false ;
bool V_195 = false ;
...
V_113 = V_95 -> V_228 ( V_20 -> V_229 . V_94 ,
L_170 ) ;
goto V_220;
}
if ( V_136 ) {
V_113 = V_95 -> V_230 ( V_136 , T_3 , T_4 ) ;
if ( V_113 )
goto V_220;
F_7 ( L_171 , V_136 ) ;
V_196 = true ;
