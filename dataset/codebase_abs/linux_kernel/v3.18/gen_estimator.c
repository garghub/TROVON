...
V_7 = ( V_6 . V_14 - V_4 -> V_15 ) << ( 7 - V_2 ) ;
V_4 -> V_15 = V_6 . V_14 ;
V_4 -> V_16 += ( V_7 >> V_4 -> V_17 ) - ( V_4 -> V_16 >> V_4 -> V_17 ) ;
V_4 -> V_18 -> V_19 = ( V_4 -> V_16 + 0xF ) >> 5 ;
V_8 = ( V_6 . V_20 - V_4 -> V_21 ) << ( 12 - V_2 ) ;
V_4 -> V_21 = V_6 . V_20 ;
V_4 -> V_22 += ( V_8 >> V_4 -> V_17 ) - ( V_4 -> V_22 >> V_4 -> V_17 ) ;
V_4 -> V_18 -> V_23 = ( V_4 -> V_22 + 0x1FF ) >> 10 ;
V_12:
F_7 ( & V_10 ) ;
F_8 ( V_4 -> V_9 ) ;
}
