...
static int
F_126 ( struct V_119 * V_120 , unsigned int V_308 , void * V_309 )
{
struct V_7 * V_4 = F_110 ( V_120 ) ;
struct V_1 * V_2 = F_3 ( V_4 ) ;
switch ( V_308 ) {
...
static int F_127 ( struct V_7 * V_4 , unsigned V_69 ,
struct V_315 * * * V_316 )
{
struct V_1 * V_2 = F_3 ( V_4 ) ;
if ( V_4 -> V_87 == V_185 )
...
int F_129 ( struct V_7 * V_4 , unsigned V_69 ,
struct V_315 * V_318 )
{
int V_319 ;
struct V_315 * * V_320 ;
...
void F_130 ( struct V_7 * V_4 , struct V_315 * V_318 )
{
struct V_1 * V_2 = F_3 ( V_4 ) ;
int V_322 ;
...
if ( V_11 -> V_334 ) {
V_168 = V_11 -> V_126 + 1 ;
F_135 ( F_65 ( V_168 , V_170 -> V_335 . V_336 ) ) ;
} else {
V_168 = F_136 ( V_170 -> V_335 . V_336 , 128 ,
V_170 -> V_337 ) ;
if ( V_168 >= 128 )
V_168 = F_136 ( V_170 -> V_335 . V_336 ,
128 , 1 ) ;
...
static void F_138 ( struct V_7 * V_11 , int V_168 )
{
if ( ! V_11 -> V_334 )
V_11 -> V_168 = V_168 ;
}
...
F_144 ( & V_11 -> V_19 . V_340 , L_78 ) ;
F_144 ( & V_78 -> V_19 . V_340 , L_79 ) ;
if ( ! F_145 ( V_69 , V_2 -> V_341 ) )
F_146 ( & V_78 -> V_19 ) ;
}
F_147 ( & V_11 -> V_342 ) ;
F_148 ( V_11 ) ;
...
* V_339 = NULL ;
F_113 ( & V_288 ) ;
if ( V_78 && F_150 ( V_69 , V_2 -> V_341 ) )
F_105 ( & V_78 -> V_19 ) ;
F_139 ( V_11 ) ;
F_151 ( & V_11 -> V_19 ) ;
}
static void F_152 ( struct V_7 * V_11 , char * V_291 , char * string )
{
if ( ! string )
return;
F_7 ( & V_11 -> V_19 , L_80 , V_291 , string ) ;
}
static void F_153 ( struct V_7 * V_11 )
{
F_7 ( & V_11 -> V_19 , L_81 ,
...
V_11 -> V_33 . V_346 ,
V_11 -> V_33 . V_347 ) ;
F_152 ( V_11 , L_83 , V_11 -> V_348 ) ;
F_152 ( V_11 , L_84 , V_11 -> V_349 ) ;
F_152 ( V_11 , L_85 , V_11 -> V_350 ) ;
}
static inline void F_153 ( struct V_7 * V_11 ) { }
static int F_154 ( struct V_7 * V_11 )
{
int V_351 = 0 ;
#ifdef F_155
if ( ! V_11 -> V_170 -> V_352
...
V_11 -> V_348 = F_159 ( V_11 , V_11 -> V_33 . V_346 ) ;
V_11 -> V_349 = F_159 ( V_11 ,
V_11 -> V_33 . V_345 ) ;
V_11 -> V_350 = F_159 ( V_11 , V_11 -> V_33 . V_347 ) ;
V_351 = F_154 ( V_11 ) ;
if ( V_351 < 0 )
return V_351 ;
if ( F_160 ( V_363 ) && V_156 -> V_364 &&
! F_161 ( V_11 ) ) {
if ( F_160 ( F_155 ) && ( V_11 -> V_170 -> V_360
|| V_11 -> V_170 -> V_352 ) ) {
V_351 = F_162 ( V_11 , V_365 ) ;
if ( V_351 < 0 )
...
static void F_164 ( struct V_7 * V_11 )
{
...
V_11 -> V_19 . V_374 = F_172 ( V_375 ,
( ( ( V_11 -> V_170 -> V_373 - 1 ) * 128 ) + ( V_11 -> V_168 - 1 ) ) ) ;
F_153 ( V_11 ) ;
if ( V_11 -> V_350 )
F_173 ( V_11 -> V_350 , strlen ( V_11 -> V_350 ) ) ;
if ( V_11 -> V_348 )
F_173 ( V_11 -> V_348 , strlen ( V_11 -> V_348 ) ) ;
if ( V_11 -> V_349 )
F_173 ( V_11 -> V_349 ,
strlen ( V_11 -> V_349 ) ) ;
F_174 ( & V_11 -> V_19 ) ;
...
int V_69 = V_11 -> V_126 ;
struct V_77 * V_78 = V_2 -> V_79 [ V_69 - 1 ] ;
V_351 = F_176 ( & V_11 -> V_19 . V_340 ,
& V_78 -> V_19 . V_340 , L_78 ) ;
if ( V_351 )
goto V_243;
V_351 = F_176 ( & V_78 -> V_19 . V_340 ,
...
( void ) F_177 ( & V_11 -> V_19 , & V_11 -> V_342 , V_11 ) ;
F_178 ( V_11 ) ;
F_179 ( & V_11 -> V_19 ) ;
return V_351 ;
V_243:
...
V_379 = F_186 ( V_376 , sizeof( V_376 -> V_33 ) ) ;
if ( V_379 < 0 ) {
...
static unsigned F_189 ( struct V_1 * V_2 )
{
struct V_190 * V_156 ;
...
static bool F_190 ( struct V_7 * V_11 , int V_386 )
{
if ( V_11 -> V_12 == V_49 )
return false ;
return F_191 ( V_386 ) ;
}
static bool F_192 ( struct V_1 * V_2 , int V_69 ,
T_1 V_3 )
{
T_1 V_387 ;
if ( ! F_2 ( V_2 -> V_4 ) )
...
static void F_194 ( struct V_1 * V_2 , int V_69 ,
...
static int F_195 ( struct V_1 * V_2 , int V_69 ,
struct V_7 * V_11 , unsigned int V_192 , bool V_391 )
{
int V_53 , V_80 ;
T_1 V_177 , V_3 ;
...
V_80 = F_193 ( V_2 , V_69 , V_11 , V_192 ,
V_391 ) ;
...
static void F_200 ( struct V_77 * V_78 )
...
int F_162 ( struct V_7 * V_11 , T_3 V_420 )
{
struct V_1 * V_2 = F_3 ( V_11 -> V_22 ) ;
...
else if ( F_209 ( V_420 ) || F_208 ( V_11 ) > 0 )
...
int F_217 ( struct V_7 * V_11 , T_3 V_420 )
{
struct V_1 * V_2 = F_3 ( V_11 -> V_22 ) ;
struct V_77 * V_78 = V_2 -> V_79 [ V_11 -> V_126 - 1 ] ;
int V_69 = V_11 -> V_126 ;
...
static int F_221 ( struct V_119 * V_120 , T_3 V_420 )
{
struct V_1 * V_2 = F_4 ( V_120 ) ;
struct V_7 * V_4 = V_2 -> V_4 ;
unsigned V_69 ;
...
void F_226 ( struct V_7 * V_444 )
{
F_71 ( & V_444 -> V_19 , L_125 ) ;
V_444 -> V_221 = 1 ;
}
static int F_227 ( struct V_7 * V_11 , enum V_445 V_87 )
{
struct V_446 * V_447 ;
...
if ( V_11 -> V_87 != V_88 )
return 0 ;
V_448 = F_228 ( V_11 -> V_50 . V_43 , 1000 ) ;
V_449 = F_228 ( V_11 -> V_50 . V_40 , 1000 ) ;
V_450 = F_228 ( V_11 -> V_51 . V_43 , 1000 ) ;
V_451 = F_228 ( V_11 -> V_51 . V_40 , 1000 ) ;
if ( ( V_87 == V_452 &&
( V_448 > V_453 ||
V_449 > V_453 ) ) ||
( V_87 == V_454 &&
...
V_447 -> V_448 = V_448 ;
V_447 -> V_449 = V_449 ;
V_447 -> V_450 = F_229 ( V_450 ) ;
V_447 -> V_451 = F_229 ( V_451 ) ;
...
int F_237 ( struct V_1 * V_2 , int V_69 , bool V_473 )
{
int V_54 ;
T_1 V_177 , V_3 ;
...
if ( ( V_11 -> V_14 -> V_15 -> V_17 & F_244 ( V_481 ) ) ||
V_370 == V_372 ) {
V_11 -> V_482 = 1 ;
F_210 ( V_11 , 1 ) ;
}
...
V_477 = F_195 ( V_2 , V_69 , V_11 , V_192 , false ) ;
if ( V_477 < 0 )
goto V_243;
V_477 = - V_113 ;
...
case V_49 :
case V_398 :
V_11 -> V_342 . V_280 . V_490 = F_229 ( 512 ) ;
break;
case V_13 :
V_11 -> V_342 . V_280 . V_490 = F_229 ( 64 ) ;
break;
case V_400 :
V_11 -> V_342 . V_280 . V_490 = F_229 ( 64 ) ;
break;
case V_399 :
V_11 -> V_342 . V_280 . V_490 = F_229 ( 8 ) ;
break;
default:
goto V_243;
}
...
V_11 -> V_342 . V_280 . V_490 = F_229 ( V_53 ) ;
F_238 ( V_11 ) ;
}
V_477 = F_186 ( V_11 , V_507 ) ;
...
for ( V_541 = 0 ; V_541 < V_11 -> V_33 . V_546 ; V_541 ++ ) {
V_544 = F_12 ( V_11 -> V_353 [ V_541 ] . V_280 . V_356 ) ;
V_545 = F_253 ( V_11 , V_547 , V_541 , V_496 ,
V_544 ) ;
if ( V_545 != V_544 ) {
...
if ( ! V_85 && V_542 ) {
V_545 = F_278 ( V_11 , V_11 -> V_33 . V_347 ,
V_496 , V_542 ) ;
if ( V_545 + 1 != V_542 ) {
...
for ( V_53 = 0 ; V_53 < V_517 ; ++ V_53 ) {
F_238 ( V_11 ) ;
V_54 = F_246 ( V_551 , V_11 , V_69 , V_53 ) ;
...
V_280 -> V_34 . V_35 . V_249 = F_229 ( V_576 ) ;
}
}
