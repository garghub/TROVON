...
T_2 V_175 , type ;
V_214 = V_144 -> V_173 + 2 ;
for ( V_174 = F_65 ( V_144 ) - 2 ; V_174 > sizeof( type ) ; V_174 -= V_215 ) {
type = * ( T_2 * ) V_214 ;
V_175 = type & 0x0fff ;
type = type & 0xf000 ;
V_174 -= sizeof( type ) ;
...
case V_306 :
F_106 ( V_144 ) -> V_307 |= V_308 ;
F_104 ( & V_26 -> V_213 , V_144 ) ;
break;
case V_309 :
default:
F_103 ( V_144 ) ;
...
static int F_107 ( struct V_22 * V_31 , struct V_310 * V_311 )
{
...
V_314 |
V_315 ;
V_311 -> V_316 = F_108 ( V_26 -> clock -> V_66 ) ;
V_311 -> V_317 =
( 1 << V_309 ) |
( 1 << V_306 ) |
( 1 << V_268 ) ;
