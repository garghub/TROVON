...
static void F_27 ( struct V_22 * V_23 , int V_114 )
{
...
break;
case V_16 :
V_23 -> V_119 -> V_120 = F_28 ( ( V_115 << 8 | V_117 ) * V_49 ) ;
break;
case V_18 :
V_23 -> V_121 = V_115 ;
V_23 -> V_122 = V_117 ;
...
static void F_29 ( struct V_22 * V_23 , int V_125 )
{
F_30 ( V_126 ) ;
bool V_127 = false ;
int V_94 = 0 ;
...
snprintf ( V_23 -> V_158 , sizeof( V_23 -> V_158 ) , L_57 ,
V_159 [ V_23 -> V_160 ] . V_158 ?
V_159 [ V_23 -> V_160 ] . V_158 :
L_58 ,
F_47 ( V_23 -> V_78 -> V_161 . V_162 ) ,
F_47 ( V_23 -> V_78 -> V_161 . V_163 ) ) ;
F_48 ( V_23 -> V_78 , V_23 -> V_164 , sizeof( V_23 -> V_164 ) ) ;
V_119 -> V_165 = V_23 -> V_158 ;
V_119 -> V_166 = V_23 -> V_164 ;
F_49 ( V_23 -> V_78 , & V_119 -> V_167 ) ;
V_119 -> V_36 . V_168 = V_36 ;
V_119 -> V_93 = V_23 ;
V_119 -> V_169 = V_170 ;
V_119 -> V_171 = V_172 ;
V_119 -> V_120 = F_50 ( 100 ) ;
if ( ! V_23 -> V_41 . V_151 ) {
V_119 -> V_173 = F_25 ;
V_119 -> V_174 = F_26 ;
V_119 -> V_175 = F_24 ;
...
if ( V_159 [ V_23 -> V_160 ] . V_184 )
V_119 -> V_179 = V_159 [ V_23 -> V_160 ] . V_184 ;
V_96 = F_51 ( V_119 ) ;
if ( V_96 < 0 ) {
F_8 ( V_36 , L_59 ) ;
goto V_27;
...
static int F_53 ( struct V_185 * V_186 ,
const struct V_187 * V_188 )
{
struct V_156 * V_36 = F_54 ( V_186 ) ;
struct V_189 * V_190 ;
struct V_191 * V_192 = NULL ;
struct V_191 * V_193 = NULL ;
struct V_191 * V_194 = NULL ;
struct V_22 * V_23 = NULL ;
int V_72 , V_195 , V_94 ;
char V_24 [ 63 ] , V_158 [ 128 ] = L_15 ;
enum V_196 V_160 = V_188 -> V_197 ;
bool V_198 ;
bool V_199 ;
bool V_108 ;
int V_200 ;
F_4 ( & V_186 -> V_36 , L_60 , V_140 ) ;
V_190 = V_186 -> V_201 ;
V_198 = V_159 [ V_160 ] . V_202 ;
V_199 = V_159 [ V_160 ] . V_203 ;
V_108 = V_159 [ V_160 ] . V_108 ;
V_200 = V_159 [ V_160 ] . V_200 ;
if ( V_190 -> V_204 . V_205 != V_200 )
return - V_206 ;
for ( V_94 = 0 ; V_94 < V_190 -> V_204 . V_207 ; ++ V_94 ) {
V_192 = & V_190 -> V_208 [ V_94 ] . V_204 ;
if ( V_193 == NULL ) {
if ( F_55 ( V_192 ) ) {
V_193 = V_192 ;
F_4 ( & V_186 -> V_36 , L_61 ) ;
...
if ( F_15 ( V_193 ) )
V_72 = F_59 ( V_36 , V_193 -> V_79 ) ;
else
V_72 = F_60 ( V_36 , V_193 -> V_79 ) ;
V_195 = F_61 ( V_36 , V_72 , F_62 ( V_72 ) ) ;
V_23 = F_14 ( sizeof( struct V_22 ) , V_76 ) ;
if ( ! V_23 )
goto V_209;
V_23 -> V_116 = F_63 ( V_36 , V_195 , V_86 , & V_23 -> V_210 ) ;
if ( ! V_23 -> V_116 )
goto V_211;
...
V_23 -> V_213 = V_195 ;
V_23 -> V_41 . V_42 = V_199 ;
V_23 -> V_41 . V_108 = V_108 ;
V_23 -> V_41 . V_151 = V_159 [ V_160 ] . V_151 ;
V_23 -> V_160 = V_160 ;
V_23 -> V_77 = V_194 ;
if ( V_36 -> V_161 . V_214
&& F_65 ( V_36 , V_36 -> V_161 . V_214 ,
V_24 , sizeof( V_24 ) ) > 0 )
F_66 ( V_158 , V_24 , sizeof( V_158 ) ) ;
if ( V_36 -> V_161 . V_215
&& F_65 ( V_36 , V_36 -> V_161 . V_215 ,
V_24 , sizeof( V_24 ) ) > 0 )
snprintf ( V_158 + strlen ( V_158 ) , sizeof( V_158 ) - strlen ( V_158 ) ,
L_66 , V_24 ) ;
V_23 -> V_119 = F_45 ( V_23 ) ;
if ( ! V_23 -> V_119 )
goto V_216;
F_17 ( V_23 -> V_82 , V_36 , V_72 , V_23 -> V_116 , V_195 ,
F_35 , V_23 , V_193 -> V_80 ) ;
V_23 -> V_82 -> V_217 = V_23 -> V_210 ;
V_23 -> V_82 -> V_218 |= V_219 ;
F_4 ( & V_186 -> V_36 , L_67 ) ;
F_23 ( V_23 , V_195 ) ;
F_37 ( V_23 ) ;
if ( V_23 -> V_41 . V_42 )
...
F_44 ( V_23 ) ;
if ( ! V_23 -> V_41 . V_151 )
F_25 ( V_23 -> V_119 , V_109 ) ;
F_67 ( V_186 , V_23 ) ;
F_68 ( V_23 -> V_36 , true ) ;
F_69 ( V_23 -> V_36 , true ) ;
F_70 ( & V_186 -> V_36 , L_68 ,
V_158 , V_23 -> V_123 ) ;
F_70 ( & V_186 -> V_36 , L_69 ,
...
F_10 ( V_23 -> V_82 ) ;
V_212:
F_72 ( V_36 , V_195 , V_23 -> V_116 , V_23 -> V_210 ) ;
V_211:
F_9 ( V_23 ) ;
V_209:
F_8 ( & V_186 -> V_36 , L_70 , V_140 ) ;
return - V_220 ;
}
static void F_73 ( struct V_185 * V_186 )
{
struct V_156 * V_36 = F_54 ( V_186 ) ;
struct V_22 * V_23 = F_74 ( V_186 ) ;
F_67 ( V_186 , NULL ) ;
if ( ! V_23 )
return;
V_23 -> V_78 = NULL ;
...
F_76 ( V_23 -> V_82 ) ;
F_10 ( V_23 -> V_82 ) ;
F_72 ( V_36 , V_23 -> V_213 , V_23 -> V_116 , V_23 -> V_210 ) ;
F_71 ( V_36 ) ;
F_9 ( V_23 ) ;
}
static int F_77 ( struct V_185 * V_186 , T_3 V_221 )
{
struct V_22 * V_23 = F_74 ( V_186 ) ;
F_70 ( V_23 -> V_36 , L_71 ) ;
F_76 ( V_23 -> V_82 ) ;
...
static int F_78 ( struct V_185 * V_186 )
{
struct V_22 * V_23 = F_74 ( V_186 ) ;
F_70 ( V_23 -> V_36 , L_72 ) ;
