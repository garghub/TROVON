...
V_127 = F_34 ( V_86 , F_28 ( V_86 , 0 ) , V_81 ,
V_101 | V_128 | V_78 ,
0 , V_84 ,
& V_126 , sizeof( V_126 ) ) ;
F_36 ( & V_5 -> V_65 -> V_96 ) ;
...
static int F_50 ( struct V_1 * V_88 ,
struct V_89 * V_90 )
{
struct V_4 * V_5 = F_30 ( V_88 ) ;
struct V_125 * V_86 = V_5 -> V_65 -> V_86 ;
...
V_127 = F_51 ( V_86 , F_35 ( V_86 , 0 ) , V_81 ,
V_101 | V_128 | V_100 ,
V_83 , V_84 ,
NULL , 0 , 1000 ) ;
F_36 ( & V_5 -> V_65 -> V_96 ) ;
...
void F_67 ( struct V_138 * V_65 ,
unsigned char V_154 )
{
struct V_4 * V_5 ;
struct V_14 * V_15 ;
int V_6 = 12 ;
F_68 (mixer, &chip->mixer_list, list) {
V_15 = V_5 -> V_155 [ V_6 ] ;
if ( V_15 ) {
F_69 ( V_15 , V_119 ,
V_15 -> V_7 << 8 ,
...
static int F_78 ( struct V_1 * V_88 ,
struct V_89 * V_90 )
{
struct V_4 * V_5 = F_30 ( V_88 ) ;
int V_13 ;
...
V_69 = F_79 ( V_5 -> V_65 -> V_86 , 1 ) ;
V_162 = & V_69 -> V_167 [ 1 ] ;
V_163 = F_80 ( V_162 , 0 ) -> V_168 ;
V_13 = F_34 ( V_5 -> V_65 -> V_86 ,
F_28 ( V_5 -> V_65 -> V_86 , 0 ) ,
V_146 ,
V_79 | V_169 | V_78 ,
...
static int F_84 ( struct V_1 * V_88 ,
struct V_89 * V_90 )
{
struct V_4 * V_5 = F_30 ( V_88 ) ;
int V_13 ;
...
if ( V_13 < 0 )
break;
if ( ! F_87 ( V_5 -> V_65 -> V_67 , L_38 , & V_105 ) )
F_88 ( V_105 , V_5 ,
F_39 ) ;
break;
