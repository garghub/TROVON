...
unsigned long V_6 ;
if ( F_19 ( V_26 , & V_2 -> V_27 ) ||
F_19 ( V_28 , & V_2 -> V_27 ) )
return;
F_10 ( & V_12 -> V_21 , V_6 ) ;
F_20 (list, skb, tmp) {
if ( ! F_21 ( F_7 ( V_14 ) -> V_18 ) )
continue;
F_16 ( V_14 , V_12 ) ;
F_13 ( V_14 ) ;
V_2 -> V_29 ++ ;
...
int F_31 ( struct V_36 * V_37 , struct V_38 * V_39 )
{
struct V_1 * V_2 = F_32 ( V_37 ) ;
struct V_40 * V_41 = & V_2 -> V_42 ;
return F_33 ( V_39 -> V_43 , V_41 , sizeof( * V_41 ) ) ?
- V_44 : 0 ;
}
int F_34 ( struct V_36 * V_37 , struct V_38 * V_39 )
{
struct V_1 * V_2 = F_32 ( V_37 ) ;
struct V_40 V_42 ;
if ( F_35 ( & V_42 , V_39 -> V_43 , sizeof( V_42 ) ) )
return - V_44 ;
if ( V_42 . V_6 )
return - V_45 ;
switch ( V_42 . V_46 ) {
...
V_2 -> V_42 = V_42 ;
return F_33 ( V_39 -> V_43 , & V_42 , sizeof( V_42 ) ) ?
- V_44 : 0 ;
}
static int F_36 ( struct V_66 * V_67 , T_4 V_68 )
{
struct V_1 * V_2 ;
struct V_30 * V_31 ;
int V_69 ;
V_2 = F_37 ( V_67 , struct V_1 , V_70 ) ;
V_31 = & V_2 -> V_31 ;
V_69 = V_31 -> V_32 . V_33 . V_71 ( V_31 , V_68 ) ;
return ( V_69 == V_72 ) ? - V_49 : V_69 ;
}
static int F_38 ( struct V_66 * V_67 , T_3 V_73 )
{
struct V_1 * V_2 ;
unsigned long V_6 ;
V_2 = F_37 ( V_67 , struct V_1 , V_70 ) ;
...
static int F_39 ( struct V_66 * V_67 , struct V_74 * V_75 )
{
struct V_1 * V_2 ;
unsigned long V_6 ;
T_1 V_76 ;
...
V_84 = 2 * ( F_44 ( V_31 , V_92 ) &
V_93 ) ;
if ( ( V_83 && ( V_83 < V_84 ) ) || ( V_83 > V_94 ) )
return - V_49 ;
F_45 ( V_31 , F_46 ( V_78 -> V_82 . V_86 ) ,
( T_5 ) V_83 ) ;
return 0 ;
}
static int F_47 ( struct V_66 * V_67 , unsigned int V_95 ,
...
V_104 = F_49 ( V_70 , V_102 ) ;
if ( F_50 ( V_104 ) ) {
V_104 = NULL ;
F_51 ( V_102 , L_2 ) ;
} else {
F_52 ( V_102 , L_3 , V_70 -> V_105 ) ;
}
V_2 -> V_104 = V_104 ;
}
