...
struct V_22 * V_3 = & V_2 -> V_3 [ V_36 ] ;
if ( ! V_3 -> V_24 )
continue;
V_9 = F_31 ( V_2 , V_36 , V_3 ) ;
if ( V_9 ) {
F_32 ( V_2 , V_36 ) ;
V_3 -> V_24 = false ;
V_2 -> V_38 = false ;
...
static int F_34 ( struct V_41 * V_42 , void * V_43 )
{
struct V_44 * V_45 = (struct V_44 * ) V_42 -> V_46 ;
struct V_47 * V_12 = V_45 -> V_48 -> V_12 ;
struct V_1 * V_2 = V_12 -> V_49 ;
F_35 ( & V_2 -> V_10 , V_42 ) ;
return 0 ;
}
