...
int V_43 = 0 ;
if ( ( V_22 -> V_44 != V_45 ) &&
! F_17 ( V_20 , V_23 -> V_46 , V_47 ) )
return - V_48 ;
V_49:
V_42 = F_18 ( V_22 , sizeof( * V_4 ) , V_25 , V_26 , NULL ) ;
if ( V_42 < 0 )
return V_42 ;
V_4 = F_19 ( V_22 ) ;
V_28 = F_20 ( V_4 -> V_50 ) ;
...
struct V_15 * V_65 = F_24 ( V_16 -> V_65 ) ;
F_33 ( * V_35 , V_65 ) ;
F_34 ( V_23 , V_20 , V_22 , V_16 , V_41 , V_76 ) ;
F_35 ( V_16 ) ;
V_42 = 0 ;
goto V_64;
}
...
goto V_64;
case V_45 :
V_42 = F_34 ( V_23 , V_20 , V_22 , V_16 , V_41 , V_52 ) ;
goto V_64;
default:
V_42 = - V_59 ;
goto V_64;
...
if ( V_42 == 0 ) {
if ( V_43 ) {
F_33 ( V_16 -> V_65 , F_24 ( * V_35 ) ) ;
F_36 ( * V_35 , V_16 ) ;
}
F_34 ( V_23 , V_20 , V_22 , V_16 , V_41 , V_52 ) ;
} else {
if ( V_43 )
F_35 ( V_16 ) ;
}
...
struct V_27 * V_87 ;
struct V_21 * V_88 ;
unsigned char * V_89 = F_38 ( V_20 ) ;
V_88 = F_39 ( V_20 , V_83 , V_84 , V_86 , sizeof( * V_87 ) , V_85 ) ;
if ( ! V_88 )
goto V_90;
V_87 = F_19 ( V_88 ) ;
V_87 -> V_91 = V_92 ;
V_87 -> V_93 = 0 ;
V_87 -> V_94 = 0 ;
V_87 -> V_55 = F_40 ( V_16 -> V_34 ) -> V_95 ;
V_87 -> V_51 = V_16 -> V_73 ;
V_87 -> V_50 = F_14 ( V_16 -> V_18 , V_16 -> V_28 ) ;
...
static int F_34 ( struct V_23 * V_23 , struct V_19 * V_100 ,
struct V_21 * V_22 , struct V_15 * V_16 ,
unsigned long V_41 , int V_86 )
{
struct V_19 * V_20 ;
T_1 V_83 = V_100 ? F_43 ( V_100 ) . V_83 : 0 ;
V_20 = F_44 ( V_101 , V_68 ) ;
if ( ! V_20 )
return - V_67 ;
if ( F_37 ( V_23 , V_20 , V_16 , V_41 , V_83 , V_22 -> V_102 , 0 , V_86 ) <= 0 ) {
F_45 ( V_20 ) ;
return - V_59 ;
}
return F_46 ( V_20 , V_23 , V_83 , V_103 ,
V_22 -> V_53 & V_104 ) ;
}
...
struct V_23 * V_23 = F_16 ( V_108 -> V_20 -> V_24 ) ;
return F_37 ( V_23 , V_108 -> V_20 , V_16 , V_22 , F_43 ( V_108 -> V_109 -> V_20 ) . V_83 ,
V_108 -> V_109 -> V_88 -> V_102 , V_110 , V_52 ) ;
}
static int F_48 ( struct V_19 * V_20 , struct V_111 * V_109 )
{
struct V_23 * V_23 = F_16 ( V_20 -> V_24 ) ;
int V_4 ;
int V_112 ;
...
struct V_27 * V_87 = F_19 ( V_109 -> V_88 ) ;
unsigned long V_40 = 0 ;
const struct V_38 * V_39 ;
struct V_107 V_106 ;
if ( V_98 ( V_109 -> V_88 ) < sizeof( * V_87 ) )
return V_20 -> V_99 ;
V_32 = F_22 ( V_23 , V_87 -> V_55 ) ;
if ( ! V_32 )
return V_20 -> V_99 ;
if ( ! V_87 -> V_51 )
V_34 = V_32 -> V_57 ;
else
V_34 = F_23 ( V_32 , F_21 ( V_87 -> V_51 ) ) ;
if ( ! V_34 )
goto V_11;
V_39 = V_34 -> V_8 -> V_60 ;
if ( ! V_39 )
...
goto V_64;
V_112 = V_109 -> args [ 0 ] ;
for ( V_16 = F_24 ( * V_36 ) , V_4 = 0 ;
V_16 ; V_16 = F_24 ( V_16 -> V_65 ) , V_4 ++ ) {
if ( V_4 < V_112 )
continue;
if ( F_21 ( V_87 -> V_50 ) &&
F_21 ( V_87 -> V_50 ) != V_16 -> V_18 )
continue;
if ( F_20 ( V_87 -> V_50 ) &&
F_20 ( V_87 -> V_50 ) != V_16 -> V_28 )
continue;
if ( V_4 > V_112 )
memset ( & V_109 -> args [ 1 ] , 0 , sizeof( V_109 -> args ) - sizeof( V_109 -> args [ 0 ] ) ) ;
if ( V_109 -> args [ 1 ] == 0 ) {
if ( F_37 ( V_23 , V_20 , V_16 , 0 , F_43 ( V_109 -> V_20 ) . V_83 ,
...
int F_53 ( struct V_23 * V_23 , struct V_15 * V_16 , struct V_2 * * V_123 ,
...
V_127 = F_54 ( V_23 , V_123 [ V_120 -> V_128 ] , V_124 ,
L_2 , V_125 ,
V_129 ) ;
if ( F_55 ( V_127 ) )
return F_56 ( V_127 ) ;
V_127 -> type = V_120 -> type = V_130 ;
F_57 ( & V_127 -> V_131 , & V_120 -> V_121 ) ;
} else if ( V_120 -> V_132 && V_123 [ V_120 -> V_132 ] ) {
int V_42 ;
V_42 = F_58 ( V_23 , V_123 [ V_120 -> V_132 ] , V_124 ,
NULL , V_125 ,
V_129 , & V_120 -> V_121 ) ;
if ( V_42 )
return V_42 ;
...
void F_59 ( struct V_15 * V_16 , struct V_119 * V_133 ,
struct V_119 * V_134 )
{
#ifdef F_50
F_60 ( V_135 ) ;
F_61 ( V_16 ) ;
F_62 ( & V_133 -> V_121 , & V_135 ) ;
F_63 ( & V_134 -> V_121 , & V_133 -> V_121 ) ;
V_133 -> type = V_134 -> type ;
F_64 ( V_16 ) ;
F_51 ( & V_135 , V_122 ) ;
#endif
}
int F_65 ( struct V_19 * V_20 , struct V_119 * V_120 )
{
#ifdef F_50
struct V_2 * V_136 ;
if ( V_120 -> V_132 && ! F_66 ( & V_120 -> V_121 ) ) {
if ( V_120 -> type != V_130 ) {
V_136 = F_67 ( V_20 , V_120 -> V_132 ) ;
if ( V_136 == NULL )
goto V_96;
if ( F_68 ( V_20 , & V_120 -> V_121 , 0 , 0 ) < 0 )
goto V_96;
F_69 ( V_20 , V_136 ) ;
} else if ( V_120 -> V_128 ) {
struct V_126 * V_127 = F_70 ( V_120 ) ;
V_136 = F_67 ( V_20 , V_120 -> V_128 ) ;
if ( V_136 == NULL || ! V_127 )
goto V_96;
if ( F_71 ( V_20 , V_127 , 0 , 0 ) < 0 )
goto V_96;
F_69 ( V_20 , V_136 ) ;
}
}
...
int F_73 ( struct V_19 * V_20 , struct V_119 * V_120 )
{
#ifdef F_50
struct V_126 * V_108 = F_70 ( V_120 ) ;
if ( F_74 ( V_20 , V_108 , 1 ) < 0 )
return - 1 ;
#endif
return 0 ;
}
...
{
F_76 ( V_137 , V_52 , F_15 , NULL , NULL ) ;
F_76 ( V_137 , V_76 , F_15 , NULL , NULL ) ;
F_76 ( V_137 , V_45 , F_15 ,
F_48 , NULL ) ;
return 0 ;
}
