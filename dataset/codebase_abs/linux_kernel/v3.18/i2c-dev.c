...
static int F_52 ( struct V_15 * V_16 , void * V_99 )
{
struct V_7 * V_4 ;
struct V_1 * V_1 ;
if ( V_16 -> type != & V_38 )
...
static int F_54 ( struct V_102 * V_103 , unsigned long V_104 ,
void * V_76 )
{
...
int V_46 ;
F_6 ( V_107 L_13 ) ;
V_46 = F_56 ( V_101 , L_14 , & V_108 ) ;
if ( V_46 )
goto V_109;
V_100 = F_57 ( V_110 , L_15 ) ;
if ( F_24 ( V_100 ) ) {
V_46 = F_25 ( V_100 ) ;
goto V_111;
}
V_100 -> V_112 = V_113 ;
V_46 = F_58 ( & V_114 , & V_115 ) ;
if ( V_46 )
goto V_116;
F_59 ( NULL , F_48 ) ;
return 0 ;
