...
F_173 ( V_173 ) ;
if ( ( ( V_167 - ( V_148 - V_21 ) ) < V_2 -> V_125 ) &&
( ( V_167 - ( V_148 - V_21 ) ) >= 1 ) )
V_2 -> V_125 = ( V_167 - ( V_148 - V_21 ) ) ;
if ( ! F_152 ( V_8 , 0 ) ) {
...
static T_3 F_180 ( struct V_7 * V_8 , struct V_158 * V_158 ,
...
int V_43 ;
T_3 V_65 = 0 ;
if ( F_181 ( V_8 ) && V_158 -> V_159 -> V_63 != V_160 ) {
V_65 = F_182 ( V_8 ) ;
if ( V_65 )
return V_65 ;
}
...
if ( F_175 ( V_158 ) || ( V_8 -> V_33 && ! V_8 -> V_33 -> V_38 ) ) {
V_65 = - V_163 ;
break;
}
if ( F_57 ( V_8 ) ) {
...
V_69:
F_178 ( V_175 ) ;
F_179 ( & V_8 -> V_39 , & V_166 ) ;
if ( V_148 - V_21 != V_67 && V_8 -> V_24 )
F_118 ( V_25 , & V_8 -> V_19 ) ;
F_87 ( & V_8 -> V_57 ) ;
return ( V_148 - V_21 ) ? V_148 - V_21 : V_65 ;
}
static unsigned int F_184 ( struct V_7 * V_8 , struct V_158 * V_158 ,
T_4 * V_166 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
unsigned int V_179 = 0 ;
F_185 ( V_158 , & V_8 -> V_56 , V_166 ) ;
F_185 ( V_158 , & V_8 -> V_39 , V_166 ) ;
if ( F_14 ( V_174 , & V_8 -> V_19 ) )
V_179 |= V_180 ;
if ( F_152 ( V_8 , 1 ) )
V_179 |= V_98 | V_181 ;
...
V_179 |= V_182 | V_98 | V_181 ;
if ( F_175 ( V_158 ) )
V_179 |= V_180 ;
if ( ! ( V_179 & ( V_180 | V_98 | V_181 ) ) ) {
...
static int F_189 ( struct V_7 * V_8 , struct V_158 * V_158 ,
...
default:
return F_190 ( V_8 , V_158 , V_185 , V_186 ) ;
}
}
