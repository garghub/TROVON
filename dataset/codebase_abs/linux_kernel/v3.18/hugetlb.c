...
return 0 ;
V_152:
F_9 ( ( unsigned long ) F_172 ( V_150 ) & ( F_116 ( V_41 ) - 1 ) ) ;
...
if ( V_238 )
F_290 ( V_234 , V_240 , V_241 ) ;
return V_10 ;
}
void F_291 ( struct V_248 * V_249 , struct V_14 * V_15 ,
...
if ( F_294 ( V_252 , & V_42 , V_229 ) )
goto V_256;
V_230 = F_264 ( V_229 ) ;
if ( F_268 ( V_230 ) )
goto V_256;
if ( F_67 ( F_273 ( V_230 ) ) ) {
F_295 ( V_252 , V_42 , V_229 ) ;
goto V_256;
}
V_65 = F_287 ( V_230 ) ;
if ( V_250 ) {
...
V_230 = F_296 ( V_252 , V_42 , V_229 ) ;
F_297 ( V_249 , V_229 , V_42 ) ;
if ( F_298 ( V_230 ) )
F_299 ( V_65 ) ;
F_300 ( V_65 ) ;
V_251 = ! F_301 ( V_249 , V_65 ) ;
if ( V_251 ) {
F_2 ( V_254 ) ;
break;
}
...
F_290 ( V_252 , V_240 , V_241 ) ;
F_303 ( V_249 , V_15 ) ;
}
void F_304 ( struct V_248 * V_249 ,
struct V_14 * V_15 , unsigned long V_222 ,
unsigned long V_36 , struct V_65 * V_250 )
{
F_291 ( V_249 , V_15 , V_222 , V_36 , V_250 ) ;
V_15 -> V_53 &= ~ V_54 ;
}
void F_305 ( struct V_14 * V_15 , unsigned long V_222 ,
unsigned long V_36 , struct V_65 * V_250 )
{
struct V_232 * V_252 ;
struct V_248 V_249 ;
V_252 = V_15 -> V_253 ;
F_306 ( & V_249 , V_252 , V_222 , V_36 ) ;
F_291 ( & V_249 , V_15 , V_222 , V_36 , V_250 ) ;
F_307 ( & V_249 , V_222 , V_36 ) ;
}
static void F_308 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
struct V_55 * V_56 ;
T_1 V_259 ;
V_42 = V_42 & F_292 ( V_41 ) ;
V_259 = ( ( V_42 - V_15 -> V_43 ) >> V_156 ) +
V_15 -> V_44 ;
V_56 = F_15 ( V_15 -> V_16 ) -> V_51 ;
F_309 ( & V_56 -> V_260 ) ;
F_310 (iter_vma, &mapping->i_mmap, pgoff, pgoff) {
if ( V_258 == V_15 )
continue;
if ( ! F_48 ( V_258 , V_64 ) )
F_305 ( V_258 , V_42 ,
...
static int F_312 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
V_262 = F_287 ( V_230 ) ;
V_265:
if ( F_121 ( V_262 ) == 1 && F_313 ( V_262 ) ) {
F_314 ( V_262 , V_15 , V_42 ) ;
...
F_315 ( V_262 ) ;
F_2 ( V_254 ) ;
V_263 = F_163 ( V_15 , V_42 , V_264 ) ;
if ( F_169 ( V_263 ) ) {
if ( V_264 ) {
F_316 ( V_262 ) ;
F_9 ( F_268 ( V_230 ) ) ;
F_308 ( V_252 , V_15 , V_262 , V_42 ) ;
F_9 ( F_268 ( V_230 ) ) ;
F_8 ( V_254 ) ;
V_229 = F_277 ( V_252 , V_42 & F_292 ( V_41 ) ) ;
if ( F_317 ( V_229 &&
F_318 ( F_264 ( V_229 ) , V_230 ) ) )
goto V_265;
return 0 ;
}
V_10 = ( F_319 ( V_263 ) == - V_11 ) ?
V_266 : V_267 ;
goto V_268;
}
if ( F_67 ( F_320 ( V_15 ) ) ) {
...
F_321 ( V_263 , V_262 , V_42 , V_15 ,
F_108 ( V_41 ) ) ;
F_322 ( V_263 ) ;
V_240 = V_42 & F_292 ( V_41 ) ;
V_241 = V_240 + F_116 ( V_41 ) ;
F_276 ( V_252 , V_240 , V_241 ) ;
F_8 ( V_254 ) ;
V_229 = F_277 ( V_252 , V_42 & F_292 ( V_41 ) ) ;
if ( F_317 ( V_229 && F_318 ( F_264 ( V_229 ) , V_230 ) ) ) {
F_123 ( V_263 ) ;
F_323 ( V_15 , V_42 , V_229 ) ;
F_285 ( V_252 , V_42 , V_229 ,
F_255 ( V_15 , V_263 , 1 ) ) ;
F_300 ( V_262 ) ;
F_324 ( V_263 , V_15 , V_42 ) ;
V_263 = V_262 ;
}
F_2 ( V_254 ) ;
F_290 ( V_252 , V_240 , V_241 ) ;
...
static struct V_65 * F_325 ( struct V_40 * V_41 ,
struct V_14 * V_15 , unsigned long V_42 )
{
struct V_55 * V_56 ;
T_1 V_143 ;
...
return F_326 ( V_56 , V_143 ) ;
}
static bool F_327 ( struct V_40 * V_41 ,
struct V_14 * V_15 , unsigned long V_42 )
{
struct V_55 * V_56 ;
T_1 V_143 ;
...
V_56 = V_15 -> V_16 -> V_57 ;
V_143 = F_29 ( V_41 , V_15 , V_42 ) ;
V_65 = F_328 ( V_56 , V_143 ) ;
if ( V_65 )
F_128 ( V_65 ) ;
return V_65 != NULL ;
}
static int F_329 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
V_32:
V_65 = F_326 ( V_56 , V_143 ) ;
if ( ! V_65 ) {
V_115 = F_330 ( V_56 -> V_58 ) >> F_30 ( V_41 ) ;
if ( V_143 >= V_115 )
goto V_35;
...
F_331 ( V_65 , V_42 , F_108 ( V_41 ) ) ;
F_322 ( V_65 ) ;
if ( V_15 -> V_53 & V_54 ) {
int V_85 ;
struct V_12 * V_12 = V_56 -> V_58 ;
V_85 = F_332 ( V_65 , V_56 , V_143 , V_7 ) ;
if ( V_85 ) {
F_128 ( V_65 ) ;
if ( V_85 == - V_273 )
goto V_32;
...
if ( V_270 ) {
F_123 ( V_65 ) ;
F_324 ( V_65 , V_15 , V_42 ) ;
} else
F_289 ( V_65 ) ;
V_271 = F_255 ( V_15 , V_65 , ( ( V_15 -> V_53 & V_280 )
&& ( V_15 -> V_53 & V_242 ) ) ) ;
F_285 ( V_252 , V_42 , V_229 , V_271 ) ;
if ( ( V_61 & V_278 ) && ! ( V_15 -> V_53 & V_242 ) ) {
V_10 = F_312 ( V_252 , V_15 , V_42 , V_229 , V_271 , V_65 , V_254 ) ;
}
F_2 ( V_254 ) ;
F_337 ( V_65 ) ;
V_35:
...
static T_13 F_338 ( struct V_40 * V_41 , struct V_232 * V_252 ,
struct V_14 * V_15 ,
struct V_55 * V_56 ,
T_1 V_143 , unsigned long V_42 )
{
unsigned long V_281 [ 2 ] ;
T_13 V_282 ;
if ( V_15 -> V_53 & V_242 ) {
V_281 [ 0 ] = ( unsigned long ) V_56 ;
V_281 [ 1 ] = V_143 ;
} else {
V_281 [ 0 ] = ( unsigned long ) V_252 ;
V_281 [ 1 ] = V_42 >> F_30 ( V_41 ) ;
}
V_282 = F_339 ( ( T_13 * ) & V_281 , sizeof( V_281 ) / sizeof( T_13 ) , 0 ) ;
return V_282 & ( V_199 - 1 ) ;
}
static T_13 F_338 ( struct V_40 * V_41 , struct V_232 * V_252 ,
struct V_14 * V_15 ,
struct V_55 * V_56 ,
...
int F_340 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
V_56 = V_15 -> V_16 -> V_57 ;
V_143 = F_29 ( V_41 , V_15 , V_42 ) ;
V_282 = F_338 ( V_41 , V_252 , V_15 , V_56 , V_143 , V_42 ) ;
F_309 ( & V_192 [ V_282 ] ) ;
V_227 = F_264 ( V_229 ) ;
if ( F_268 ( V_227 ) ) {
V_10 = F_329 ( V_252 , V_15 , V_56 , V_143 , V_42 , V_229 , V_61 ) ;
goto V_284;
}
V_10 = 0 ;
if ( ( V_61 & V_278 ) && ! F_342 ( V_227 ) ) {
if ( F_161 ( V_41 , V_15 , V_42 ) < 0 ) {
V_10 = V_266 ;
goto V_284;
}
...
V_254 = F_280 ( V_41 , V_252 , V_229 ) ;
F_8 ( V_254 ) ;
if ( F_67 ( ! F_318 ( V_227 , F_264 ( V_229 ) ) ) )
goto V_285;
if ( V_61 & V_278 ) {
if ( ! F_342 ( V_227 ) ) {
V_10 = F_312 ( V_252 , V_15 , V_42 , V_229 , V_227 ,
V_261 , V_254 ) ;
goto V_285;
}
V_227 = F_257 ( V_227 ) ;
...
long F_343 ( struct V_232 * V_252 , struct V_14 * V_15 ,
struct V_65 * * V_286 , struct V_14 * * V_287 ,
unsigned long * V_288 , unsigned long * V_93 ,
long V_92 , unsigned int V_61 )
{
unsigned long V_289 ;
unsigned long V_290 = * V_288 ;
unsigned long V_291 = * V_93 ;
struct V_40 * V_41 = F_33 ( V_15 ) ;
while ( V_290 < V_15 -> V_223 && V_291 ) {
T_10 * V_230 ;
T_12 * V_254 = NULL ;
int V_292 ;
struct V_65 * V_65 ;
V_230 = F_277 ( V_252 , V_290 & F_292 ( V_41 ) ) ;
if ( V_230 )
V_254 = F_279 ( V_41 , V_252 , V_230 ) ;
V_292 = ! V_230 || F_268 ( F_264 ( V_230 ) ) ;
if ( V_292 && ( V_61 & V_293 ) &&
! F_327 ( V_41 , V_15 , V_290 ) ) {
if ( V_230 )
F_2 ( V_254 ) ;
V_291 = 0 ;
break;
}
if ( V_292 || F_344 ( F_264 ( V_230 ) ) ||
( ( V_61 & V_294 ) &&
! F_342 ( F_264 ( V_230 ) ) ) ) {
int V_10 ;
if ( V_230 )
F_2 ( V_254 ) ;
V_10 = F_340 ( V_252 , V_15 , V_290 ,
( V_61 & V_294 ) ? V_278 : 0 ) ;
if ( ! ( V_10 & V_295 ) )
continue;
V_291 = 0 ;
...
V_289 = ( V_290 & ~ F_292 ( V_41 ) ) >> V_156 ;
V_65 = F_287 ( F_264 ( V_230 ) ) ;
V_296:
if ( V_286 ) {
V_286 [ V_92 ] = F_345 ( V_65 , V_289 ) ;
F_346 ( V_286 [ V_92 ] ) ;
}
if ( V_287 )
V_287 [ V_92 ] = V_15 ;
...
* V_93 = V_291 ;
* V_288 = V_290 ;
return V_92 ? V_92 : - V_297 ;
}
unsigned long F_347 ( struct V_14 * V_15 ,
unsigned long V_42 , unsigned long V_36 , T_14 V_298 )
{
struct V_232 * V_252 = V_15 -> V_253 ;
...
F_350 ( V_15 , V_222 , V_36 ) ;
F_311 ( & V_15 -> V_16 -> V_57 -> V_260 ) ;
F_290 ( V_252 , V_222 , V_36 ) ;
return V_286 << V_41 -> V_91 ;
}
int F_351 ( struct V_12 * V_12 ,
long V_29 , long V_28 ,
struct V_14 * V_15 ,
T_15 V_53 )
{
long V_10 , V_31 ;
struct V_40 * V_41 = F_352 ( V_12 ) ;
...
void F_353 ( struct V_12 * V_12 , long V_300 , long V_301 )
{
struct V_40 * V_41 = F_352 ( V_12 ) ;
...
struct V_1 * V_2 = F_12 ( V_12 ) ;
if ( V_17 )
V_31 = F_23 ( V_17 , V_300 ) ;
F_8 ( & V_12 -> V_274 ) ;
V_12 -> V_275 -= ( F_333 ( V_41 ) * V_301 ) ;
F_2 ( & V_12 -> V_274 ) ;
F_11 ( V_2 , ( V_31 - V_301 ) ) ;
F_249 ( V_41 , - ( V_31 - V_301 ) ) ;
}
static unsigned long F_354 ( struct V_14 * V_302 ,
struct V_14 * V_15 ,
unsigned long V_142 , T_1 V_143 )
{
unsigned long V_303 = ( ( V_143 - V_302 -> V_44 ) << V_156 ) +
V_302 -> V_43 ;
unsigned long V_304 = V_303 & V_305 ;
unsigned long V_306 = V_304 + V_307 ;
unsigned long V_53 = V_15 -> V_53 & ~ V_308 ;
unsigned long V_309 = V_302 -> V_53 & ~ V_308 ;
if ( F_355 ( V_142 ) != F_355 ( V_303 ) ||
V_53 != V_309 ||
V_304 < V_302 -> V_43 || V_302 -> V_223 < V_306 )
return 0 ;
return V_303 ;
}
static int F_356 ( struct V_14 * V_15 , unsigned long V_142 )
{
unsigned long V_310 = V_142 & V_305 ;
unsigned long V_36 = V_310 + V_307 ;
if ( V_15 -> V_53 & V_54 &&
V_15 -> V_43 <= V_310 && V_36 <= V_15 -> V_223 )
return 1 ;
return 0 ;
}
T_10 * F_357 ( struct V_232 * V_252 , unsigned long V_142 , T_16 * V_311 )
{
struct V_14 * V_15 = F_358 ( V_252 , V_142 ) ;
struct V_55 * V_56 = V_15 -> V_16 -> V_57 ;
...
T_12 * V_254 ;
if ( ! F_356 ( V_15 , V_142 ) )
return ( T_10 * ) F_359 ( V_252 , V_311 , V_142 ) ;
F_309 ( & V_56 -> V_260 ) ;
F_310 (svma, &mapping->i_mmap, idx, idx) {
if ( V_302 == V_15 )
continue;
V_303 = F_354 ( V_302 , V_15 , V_142 , V_143 ) ;
if ( V_303 ) {
V_312 = F_277 ( V_302 -> V_253 , V_303 ) ;
if ( V_312 ) {
F_288 ( F_179 ( V_312 ) ) ;
break;
}
...
if ( ! V_312 )
goto V_35;
V_254 = F_280 ( F_33 ( V_15 ) , V_252 , V_312 ) ;
F_8 ( V_254 ) ;
if ( F_360 ( * V_311 ) )
F_361 ( V_252 , V_311 ,
( V_313 * ) ( ( unsigned long ) V_312 & V_314 ) ) ;
else
F_128 ( F_179 ( V_312 ) ) ;
F_2 ( V_254 ) ;
V_35:
V_230 = ( T_10 * ) F_359 ( V_252 , V_311 , V_142 ) ;
F_311 ( & V_56 -> V_260 ) ;
return V_230 ;
}
int F_294 ( struct V_232 * V_252 , unsigned long * V_142 , T_10 * V_229 )
{
T_17 * V_315 = F_362 ( V_252 , * V_142 ) ;
T_16 * V_311 = F_363 ( V_315 , * V_142 ) ;
F_9 ( F_91 ( F_179 ( V_229 ) ) == 0 ) ;
if ( F_91 ( F_179 ( V_229 ) ) == 1 )
return 0 ;
F_364 ( V_311 ) ;
F_128 ( F_179 ( V_229 ) ) ;
* V_142 = F_98 ( * V_142 , V_194 * V_316 ) - V_194 ;
return 1 ;
}
T_10 * F_357 ( struct V_232 * V_252 , unsigned long V_142 , T_16 * V_311 )
{
...
T_16 * V_311 ;
T_10 * V_230 = NULL ;
V_315 = F_362 ( V_252 , V_142 ) ;
V_311 = F_365 ( V_252 , V_315 , V_142 ) ;
if ( V_311 ) {
if ( V_239 == V_307 ) {
V_230 = ( T_10 * ) V_311 ;
} else {
F_9 ( V_239 != V_317 ) ;
if ( F_366 () && F_360 ( * V_311 ) )
V_230 = F_357 ( V_252 , V_142 , V_311 ) ;
else
V_230 = ( T_10 * ) F_359 ( V_252 , V_311 , V_142 ) ;
}
}
F_9 ( V_230 && ! F_367 ( * V_230 ) && ! F_368 ( * V_230 ) ) ;
return V_230 ;
}
...
V_315 = F_362 ( V_252 , V_142 ) ;
if ( F_369 ( * V_315 ) ) {
V_311 = F_363 ( V_315 , V_142 ) ;
if ( F_370 ( * V_311 ) ) {
if ( F_371 ( * V_311 ) )
return ( T_10 * ) V_311 ;
V_318 = F_372 ( V_311 , V_142 ) ;
}
}
return ( T_10 * ) V_318 ;
}
...
V_313 * V_318 , int V_212 )
{
struct V_65 * V_65 ;
V_65 = F_287 ( * ( T_10 * ) V_318 ) ;
if ( V_65 )
V_65 += ( ( V_42 & ~ V_319 ) >> V_156 ) ;
return V_65 ;
}
struct V_65 *
F_374 ( struct V_232 * V_252 , unsigned long V_42 ,
T_16 * V_311 , int V_212 )
{
struct V_65 * V_65 ;
V_65 = F_287 ( * ( T_10 * ) V_311 ) ;
if ( V_65 )
V_65 += ( ( V_42 & ~ V_305 ) >> V_156 ) ;
return V_65 ;
}
struct V_65 * __weak
F_374 ( struct V_232 * V_252 , unsigned long V_42 ,
...
static int F_375 ( struct V_65 * V_320 )
{
struct V_65 * V_65 ;
struct V_65 * V_135 ;
struct V_40 * V_41 = F_118 ( V_320 ) ;
int V_66 = F_52 ( V_320 ) ;
...
bool F_378 ( struct V_65 * V_65 , struct V_21 * V_153 )
{
F_109 ( ! F_137 ( V_65 ) , V_65 ) ;
if ( ! F_379 ( V_65 ) )
return false ;
F_8 ( & V_117 ) ;
F_380 ( & V_65 -> V_67 , V_153 ) ;
F_2 ( & V_117 ) ;
return true ;
}
void F_381 ( struct V_65 * V_65 )
{
F_109 ( ! F_137 ( V_65 ) , V_65 ) ;
F_8 ( & V_117 ) ;
F_380 ( & V_65 -> V_67 , & ( F_118 ( V_65 ) ) -> V_71 ) ;
F_2 ( & V_117 ) ;
F_128 ( V_65 ) ;
}
bool F_382 ( struct V_65 * V_65 )
{
