...
static int F_65 ( struct V_104 * V_105 , T_6 V_132 )
{
...
static void F_66 ( struct V_136 * V_137 , T_6 V_132 )
{
...
if ( V_152 == NULL )
goto V_168;
V_159 = F_83 ( V_158 * sizeof( * V_159 ) , V_169 ) ;
if ( ! V_159 )
goto V_168;
V_127 = F_83 ( V_158 * sizeof( * V_127 ) , V_169 ) ;
if ( ! V_127 )
goto V_170;
