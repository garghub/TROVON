...
{
return F_10 ( V_2 -> V_4 , V_2 -> V_6 , V_16 ) ;
}
int F_11 ( struct V_1 * V_2 , T_2 * V_17 )
{
int V_12 , V_18 = fprintf ( V_17 , L_1 , V_2 -> V_6 ) ;
for ( V_12 = 0 ; V_12 < V_2 -> V_6 ; ++ V_12 )
V_18 += fprintf ( V_17 , L_2 , V_12 ? L_3 : L_4 , V_2 -> V_4 [ V_12 ] . V_12 ) ;
return V_18 + fprintf ( V_17 , L_5 ) ;
}
