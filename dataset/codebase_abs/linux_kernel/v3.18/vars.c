...
int F_33 ( struct V_52 * V_53 , T_5 V_25 ,
...
F_23 ( & V_29 -> V_74 ) ;
if ( V_51 && F_34 ( V_22 , V_49 , V_51 , false ) ) {
F_24 ( & V_29 -> V_74 ) ;
return - V_78 ;
}
...
static int
F_35 ( T_1 * V_22 , T_6 V_49 ,
T_5 V_25 , unsigned long V_26 , void * V_18 )
{
const struct V_27 * V_30 = V_29 -> V_30 ;
unsigned long V_79 ;
T_4 V_33 ;
if ( ! F_36 ( & V_29 -> V_74 , V_79 ) )
return - V_80 ;
V_33 = F_10 ( V_25 , V_26 + F_6 ( V_22 , 1024 ) ) ;
if ( V_33 != V_35 ) {
F_37 ( & V_29 -> V_74 , V_79 ) ;
...
V_33 = V_30 -> V_81 ( V_22 , & V_49 , V_25 ,
V_26 , V_18 ) ;
F_37 ( & V_29 -> V_74 , V_79 ) ;
return F_11 ( V_33 ) ;
}
int F_38 ( T_1 * V_22 , T_6 V_49 , T_5 V_25 ,
bool V_82 , unsigned long V_26 , void * V_18 )
{
const struct V_27 * V_30 = V_29 -> V_30 ;
unsigned long V_79 ;
T_4 V_33 ;
...
struct V_52 * F_34 ( T_1 * V_22 , T_6 V_84 ,
...
unsigned long * V_26 , void * V_18 , bool * V_89 )
{
const struct V_27 * V_30 = V_29 -> V_30 ;
T_1 * V_22 = V_53 -> V_58 . V_59 ;
T_6 * V_49 = & V_53 -> V_58 . V_60 ;
