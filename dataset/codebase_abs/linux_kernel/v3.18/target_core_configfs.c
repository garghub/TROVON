...
return - V_40 ;
V_142 = V_144 ;
while ( ( V_143 = F_61 ( & V_144 , L_114 ) ) != NULL ) {
if ( ! * V_143 )
continue;
...
if ( ! ( V_84 -> V_88 & V_184 ) )
return 0 ;
return snprintf ( V_7 , V_100 , L_125 , V_84 -> V_185 ) ;
}
static T_1 F_71 (
void * V_177 ,
const char * V_7 ,
...
if ( ! ( V_84 -> V_88 & V_189 ) )
return 0 ;
return snprintf ( V_7 , V_100 , L_125 , V_84 -> V_190 ) ;
}
static T_1 F_73 (
void * V_177 ,
const char * V_7 ,
...
{
struct V_83 * V_84 = V_177 ;
return snprintf ( V_7 , V_100 , L_132 , ! ! ( V_84 -> V_88 & V_192 ) ) ;
}
static T_1 F_75 (
void * V_177 ,
const char * V_7 ,
...
V_180 += sprintf ( V_210 + V_180 , L_146 ,
V_84 -> V_212 . V_215 ,
V_84 -> V_212 . V_216 ) ;
...
if ( sscanf ( V_143 , L_151 , & V_234 , & V_235 ) != 2 ) {
F_14 ( L_150 , V_231 ) ;
V_20 = - V_21 ;
break;
}
...
V_230 = 0 ;
while ( sscanf ( V_143 , L_154 , & V_232 , & V_211 ) == 2 ) {
switch ( V_211 ) {
case 'O' :
V_233 = V_220 ;
break;
...
if ( ! V_195 -> V_243 )
return 0 ;
return sprintf ( V_7 , L_159 , V_195 -> V_201 ) ;
}
static T_1 F_97 (
struct V_194 * V_195 ,
const char * V_7 ,
...
V_84 = V_197 -> V_247 ;
V_186 = V_84 -> V_1 ;
V_245 = snprintf ( V_86 , V_203 , L_166 ,
F_18 ( & V_186 -> V_4 . V_29 ) ,
F_18 ( & V_84 -> V_188 . V_29 ) ) ;
V_245 ++ ;
if ( ( V_245 + V_97 ) > V_100 ) {
...
char * V_7 )
{
return sprintf ( V_7 , L_132 , V_251 -> V_266 ) ;
}
static T_1 F_118 (
struct V_250 * V_251 ,
const char * V_7 ,
...
if ( ! V_251 -> V_256 )
return 0 ;
return sprintf ( V_7 , L_159 , V_251 -> V_267 ) ;
}
static T_1 F_136 (
struct V_250 * V_251 ,
const char * V_7 ,
...
V_272 = V_271 -> V_278 ;
V_124 = V_271 -> V_279 ;
V_245 = snprintf ( V_86 , V_275 , L_194
L_195 , V_272 -> V_111 -> V_47 () ,
...
F_16 ( & V_84 -> V_292 . V_293 , L_200 ,
& V_294 ) ;
F_16 ( & V_84 -> V_295 , L_201 ,
& V_296 ) ;
F_16 ( & V_84 -> V_80 . V_297 , L_202 ,
& V_298 ) ;
...
V_308 = 1 ;
return sprintf ( V_7 , L_132 , V_308 ) ;
}
...
F_14 ( L_212
L_213 , ( int ) strlen ( V_13 ) ,
V_317 ) ;
return F_15 ( - V_319 ) ;
}
snprintf ( V_86 , V_317 , L_29 , V_13 ) ;
V_315 = strstr ( V_86 , L_214 ) ;
if ( ! V_315 ) {
F_14 ( L_215 ) ;
return F_15 ( - V_21 ) ;
}
V_314 = V_86 ;
V_316 = strstr ( V_315 + 1 , L_214 ) ;
if ( V_316 ) {
* V_316 = '\0' ;
V_316 ++ ;
V_315 = V_316 ;
...
F_12 ( L_227
L_228 V_9 L_229
L_230 V_8 L_3 , F_5 () -> V_10 , F_5 () -> V_11 ) ;
V_20 = F_167 () ;
if ( V_20 < 0 )
goto V_159;
V_20 = F_168 () ;
