...
static inline int F_29 ( struct F_6 * V_29 ,
struct V_7 * V_8 ,
bool V_31 , bool V_32 )
{
int V_9 ;
...
V_9 = F_31 ( & V_29 -> V_13 , & V_8 -> V_25 ) ;
} else if ( V_31 ) {
V_9 = F_32 ( & V_29 -> V_13 , & V_8 -> V_25 ) ;
} else if ( V_32 ) {
F_33 ( & V_29 -> V_13 , & V_8 -> V_25 ) ;
V_9 = 0 ;
} else {
V_9 = F_34 ( & V_29 -> V_13 , & V_8 -> V_25 ) ;
}
if ( ! V_9 ) {
F_8 ( ! F_26 ( & V_29 -> V_30 ) ) ;
F_35 ( & V_29 -> V_30 , & V_8 -> V_27 ) ;
} else if ( V_9 == - V_33 ) {
V_9 = 0 ;
} else if ( V_9 == - V_20 ) {
V_8 -> V_28 = V_29 ;
...
bool V_31 )
{
struct F_6 * V_28 = V_8 -> V_28 ;
V_8 -> V_28 = NULL ;
if ( F_8 ( ! V_28 ) )
return 0 ;
F_13 ( V_8 ) ;
return F_29 ( V_28 , V_8 , V_31 , true ) ;
}
...
int F_6 ( struct F_6 * V_29 ,
struct V_7 * V_8 )
{
if ( V_8 )
return F_29 ( V_29 , V_8 , false , false ) ;
F_34 ( & V_29 -> V_13 , NULL ) ;
return 0 ;
}
int F_38 ( struct F_6 * V_29 ,
struct V_7 * V_8 )
{
if ( V_8 )
return F_29 ( V_29 , V_8 , true , false ) ;
return F_32 ( & V_29 -> V_13 , NULL ) ;
}
void F_28 ( struct F_6 * V_29 )
{
F_39 ( & V_29 -> V_30 ) ;
F_40 ( & V_29 -> V_13 ) ;
}
