...
if ( ! F_1 ( V_7 , V_3 , & V_4 ) )
break;
} else if ( V_7 -> type == V_30 ) {
if ( ! F_3 ( V_7 , type , V_3 , & V_4 ) )
break;
} else if ( V_7 -> type == V_31 ) {
if ( ! F_4 ( V_7 , type , V_3 , & V_4 ) )
break;
}
V_2 += V_7 -> V_21 ;
}
...
static int F_8 ( T_2 V_32 , int type , T_1 V_3 )
{
struct V_33 V_34 = { V_35 , NULL } ;
union V_36 * V_37 ;
struct V_1 * V_7 ;
int V_4 = - 1 ;
if ( F_6 ( F_9 ( V_32 , L_1 , NULL , & V_34 ) ) )
goto exit;
if ( ! V_34 . V_21 || ! V_34 . V_38 )
goto exit;
V_37 = V_34 . V_38 ;
if ( V_37 -> type != V_39 ||
V_37 -> V_34 . V_21 < sizeof( struct V_1 ) ) {
goto exit;
}
V_7 = (struct V_1 * ) V_37 -> V_34 . V_38 ;
if ( V_7 -> type == V_29 ) {
F_1 ( V_7 , V_3 , & V_4 ) ;
} else if ( V_7 -> type == V_31 ) {
F_4 ( V_7 , type , V_3 , & V_4 ) ;
} else if ( V_7 -> type == V_30 ) {
F_3 ( V_7 , type , V_3 , & V_4 ) ;
}
exit:
F_10 ( V_34 . V_38 ) ;
return V_4 ;
}
int F_11 ( T_2 V_32 , int type , T_1 V_3 )
{
int V_4 ;
V_4 = F_8 ( V_32 , type , V_3 ) ;
if ( V_4 == - 1 )
V_4 = F_5 ( type , V_3 ) ;
return V_4 ;
}
int F_12 ( int V_4 , T_1 V_3 )
{
#ifdef F_13
int V_40 ;
#endif
...
int F_16 ( T_2 V_32 , int type , T_1 V_3 )
{
int V_4 ;
V_4 = F_11 ( V_32 , type , V_3 ) ;
return F_12 ( V_4 , V_3 ) ;
}
