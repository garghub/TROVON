...
{
struct V_26 * V_27 ;
F_28 (channel, &vmbus_connection.chn_list, listentry) {
F_20 ( V_27 -> V_45 ) ;
F_7 ( V_27 -> V_45 ) ;
F_11 ( V_27 ) ;
}
...
F_25 ( & V_36 . V_52 , V_41 ) ;
F_28 (channel, &vmbus_connection.chn_list, listentry) {
if ( ! F_30 ( V_27 -> V_47 . V_58 . V_59 ,
V_54 -> V_47 . V_58 . V_59 ) &&
! F_30 ( V_27 -> V_47 . V_58 . V_60 ,
V_54 -> V_47 . V_58 . V_60 ) ) {
V_55 = false ;
break;
}
...
static void F_34 ( struct V_26 * V_27 , const T_2 * V_66 )
{
T_3 V_67 ;
int V_16 ;
bool V_68 = false ;
...
F_25 ( & V_36 . V_110 , V_41 ) ;
F_28 (msginfo, &vmbus_connection.chn_msg_list,
msglistentry) {
V_107 =
...
V_140 = F_51 ( & V_106 -> V_115 , 5 * V_145 ) ;
if ( V_140 == 0 ) {
V_57 = - V_146 ;
goto V_144;
}
...
struct V_26 * F_52 ( struct V_26 * V_147 )
{
...
if ( F_53 ( & V_147 -> V_31 ) )
return V_152 ;
F_54 (cur, tmp, &primary->sc_list) {
V_151 = F_55 ( V_149 , struct V_26 , V_31 ) ;
if ( V_151 -> V_63 != V_155 )
continue;
if ( V_151 -> V_78 == V_67 )
return V_151 ;
...
static void F_56 ( struct V_26 * V_42 )
{
struct V_148 * V_149 , * V_150 ;
struct V_26 * V_151 ;
if ( V_42 -> V_65 == NULL )
return;
F_54 (cur, tmp, &primary_channel->sc_list) {
V_151 = F_55 ( V_149 , struct V_26 , V_31 ) ;
V_42 -> V_65 ( V_151 ) ;
}
}
void F_57 ( struct V_26 * V_42 ,
void (* F_58)( struct V_26 * V_156 ) )
{
V_42 -> V_65 = F_58 ;
}
bool F_59 ( struct V_26 * V_147 )
{
bool V_57 ;
V_57 = ! F_53 ( & V_147 -> V_31 ) ;
if ( V_57 ) {
F_56 ( V_147 ) ;
}
return V_57 ;
