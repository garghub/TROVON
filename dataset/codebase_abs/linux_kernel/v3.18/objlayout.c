...
static int F_61 ( struct V_126 * V_127 )
{
static char * V_128 [] = { L_24 ,
L_25 ,
L_26 ,
NULL
} ;
...
F_5 ( L_28 , V_8 , V_127 -> V_133 ) ;
F_5 ( L_29 , V_8 , V_127 -> V_134 ) ;
F_5 ( L_30 , V_8 , V_127 -> V_135 ) ;
V_129 [ 0 ] = ( char * ) V_131 ;
V_129 [ 1 ] = L_31 ;
V_129 [ 2 ] = V_127 -> V_133 ;
V_129 [ 3 ] = L_32 ;
...
V_129 [ 6 ] = V_127 -> V_135 ;
V_129 [ 7 ] = NULL ;
V_130 = F_62 ( V_129 [ 0 ] , V_129 , V_128 , V_136 ) ;
if ( V_130 == - V_137 || V_130 == - V_132 ) {
F_56 ( V_121 L_34
L_35 ,
V_131 ) ;
V_131 [ 0 ] = '\0' ;
}
F_5 ( L_36 , V_8 , V_131 , V_130 ) ;
return V_130 ;
}
static void F_63 ( struct V_138 V_139 ,
char * V_140 , int V_141 ,
const char * V_142 )
{
if ( ! V_139 . V_24 )
return;
...
F_64 (
L_37 ,
V_142 , V_139 . V_24 , V_141 ) ;
V_139 . V_24 = V_141 - 1 ;
}
memcpy ( V_140 , V_139 . V_143 , V_139 . V_24 ) ;
}
...
V_146 = V_144 ;
for ( V_120 = 0 ; V_120 < V_139 . V_24 ; V_120 ++ )
V_146 = F_66 ( V_146 , V_139 . V_143 [ V_120 ] ) ;
}
int F_67 ( struct V_148 * V_149 )
{
int V_150 ;
struct V_126 V_127 ;
if ( ! V_149 -> V_151 . V_152 . V_153 . V_24 )
return - V_154 ;
memset ( & V_127 , 0 , sizeof( V_127 ) ) ;
F_63 (
V_149 -> V_151 . V_152 . V_153 ,
V_127 . V_133 , sizeof( V_127 . V_133 ) , L_39 ) ;
F_63 (
V_149 -> V_155 ,
V_127 . V_134 , sizeof( V_127 . V_134 ) , L_40 ) ;
F_65 ( V_149 -> V_156 , V_127 . V_135 ) ;
V_150 = F_61 ( & V_127 ) ;
if ( V_150 > 0 )
V_150 = - V_154 ;
return V_150 ;
