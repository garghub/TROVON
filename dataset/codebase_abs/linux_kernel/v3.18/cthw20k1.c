...
#endif
#endif
F_28 ( V_53 , V_164 , V_158 ) ;
F_28 ( V_53 , V_165 , V_159 ) ;
F_28 ( V_53 , V_166 , V_157 ) ;
F_28 ( V_53 , V_167 , 0x200c01 ) ;
return 0 ;
}
...
unsigned int V_168 ;
int V_55 ;
V_168 = ( 48000 == V_13 ) ? 0x1480a001 : 0x1480a731 ;
for ( V_55 = 0 ; V_55 < 3 ; V_55 ++ ) {
if ( F_30 ( V_53 , V_169 ) == V_168 )
break;
F_28 ( V_53 , V_169 , V_168 ) ;
F_85 ( 40 ) ;
}
if ( V_55 >= 3 ) {
F_96 ( V_53 -> V_161 -> V_162 , L_2 ) ;
return - V_170 ;
}
return 0 ;
}
...
{
if ( ( F_99 ( V_53 , 0xcc ) & 0xff ) == 0xaa )
return 0 ;
F_100 ( V_53 , 0xcc , 0x8c ) ;
F_100 ( V_53 , 0xcc , 0x0e ) ;
if ( ( F_99 ( V_53 , 0xcc ) & 0xff ) == 0xaa )
return 0 ;
F_100 ( V_53 , 0xcc , 0xee ) ;
F_100 ( V_53 , 0xcc , 0xaa ) ;
if ( ( F_99 ( V_53 , 0xcc ) & 0xff ) == 0xaa )
return 0 ;
return - 1 ;
}
static void F_101 ( struct V_53 * V_53 )
{
if ( ( F_99 ( V_53 , 0xcc ) & 0xff ) == 0xaa )
F_100 ( V_53 , 0xcc , 0x00 ) ;
}
static void F_102 ( struct V_53 * V_53 , T_1 V_175 , T_1 V_85 , T_1 V_48 )
{
unsigned int V_72 ;
do {
V_72 = F_99 ( V_53 , 0xEC ) ;
} while ( ! ( V_72 & 0x800000 ) );
F_100 ( V_53 , 0xE0 , V_175 ) ;
F_100 ( V_53 , 0xE4 , ( V_48 << 8 ) | ( V_85 & 0xff ) ) ;
}
static int F_103 ( struct V_53 * V_53 )
{
T_1 V_55 ;
T_2 V_176 ;
unsigned int V_72 ;
...
F_102 ( V_53 , 0x00180080 , 0x01 , 0x80 ) ;
F_102 ( V_53 , 0x00180080 , 0x02 , 0x10 ) ;
F_101 ( V_53 ) ;
return 0 ;
}
static int F_104 ( struct V_53 * V_53 , const struct V_178 * V_152 )
{
T_1 V_48 ;
T_2 V_176 ;
unsigned int V_72 ;
...
F_102 ( V_53 , 0x00180080 , 0x06 , V_48 ) ;
F_102 ( V_53 , 0x00180080 , 0x09 , V_48 ) ;
F_102 ( V_53 , 0x00180080 , 0x0c , V_48 ) ;
F_102 ( V_53 , 0x00180080 , 0x0f , V_48 ) ;
F_101 ( V_53 ) ;
V_176 = ( T_2 ) F_30 ( V_53 , V_177 ) ;
V_176 = V_176 | 0x40 ;
F_28 ( V_53 , V_177 , V_176 ) ;
...
static int F_108 ( struct V_53 * V_53 , enum V_181 type )
{
switch ( V_53 -> V_179 ) {
case V_180 :
return F_105 ( V_53 , type ) ;
case V_185 :
return F_107 ( V_53 , type ) ;
case V_186 :
return F_107 ( V_53 , type ) ;
default:
...
F_28 ( V_53 , V_177 , V_48 ) ;
F_102 ( V_53 , 0x001a0080 , 0x2a , V_189 ) ;
if ( V_187 ) {
F_102 ( V_53 , 0x001a0080 , 0x1c , 0xe7 ) ;
F_102 ( V_53 , 0x001a0080 , 0x1e , 0xe7 ) ;
} else {
F_102 ( V_53 , 0x001a0080 , 0x1c , 0xcf ) ;
F_102 ( V_53 , 0x001a0080 , 0x1e , 0xcf ) ;
}
F_101 ( V_53 ) ;
return 0 ;
}
static int
F_111 ( struct V_53 * V_53 , enum V_181 type , unsigned char V_187 )
{
T_1 V_48 ;
T_1 V_189 ;
unsigned int V_72 ;
...
static int F_112 ( struct V_53 * V_53 , enum V_181 type )
{
int V_6 = type == V_182 ;
switch ( V_53 -> V_179 ) {
case V_180 :
...
{
return F_109 ( V_53 , V_190 , V_191 ) ;
}
static int F_114 ( struct V_53 * V_53 , int V_190 , int V_191 )
{
T_2 V_176 ;
T_2 V_192 ;
T_1 V_193 ;
...
F_100 ( V_53 , 0xEC , 0x05 ) ;
F_102 ( V_53 , 0x001a0080 , 0x0e , 0x08 ) ;
F_102 ( V_53 , 0x001a0080 , 0x18 , 0x0a ) ;
F_102 ( V_53 , 0x001a0080 , 0x28 , 0x86 ) ;
F_102 ( V_53 , 0x001a0080 , 0x2a , V_193 ) ;
if ( V_191 ) {
F_102 ( V_53 , 0x001a0080 , 0x1c , 0xf7 ) ;
F_102 ( V_53 , 0x001a0080 , 0x1e , 0xf7 ) ;
} else {
F_102 ( V_53 , 0x001a0080 , 0x1c , 0xcf ) ;
F_102 ( V_53 , 0x001a0080 , 0x1e , 0xcf ) ;
}
if ( ! ( F_30 ( V_53 , V_195 ) & 0x100 ) )
F_102 ( V_53 , 0x001a0080 , 0x16 , 0x26 ) ;
F_101 ( V_53 ) ;
V_176 = ( T_2 ) F_30 ( V_53 , V_177 ) ;
V_176 &= 0xfe7f ;
V_176 |= V_192 ;
...
static int F_115 ( struct V_53 * V_53 , const struct V_196 * V_152 )
{
if ( V_53 -> V_179 == V_180 )
return F_113 ( V_53 , V_152 -> V_190 , V_152 -> V_191 ) ;
else
return F_114 ( V_53 , V_152 -> V_190 , V_152 -> V_191 ) ;
}
static struct V_197 F_116 ( struct V_53 * V_53 )
{
struct V_197 V_198 ;
...
void T_3 * V_218 ;
int V_55 ;
const T_1 V_219 = F_118 ( 'C' , 'T' , 'L' , 'X' ) ;
const T_1 V_220 = F_118 ( 'C' , 'T' , 'L' , '-' ) ;
const T_1 V_221 = F_118 ( 'C' , 'T' , 'L' , 'F' ) ;
const T_1 V_222 = F_118 ( 'C' , 'T' , 'L' , 'i' ) ;
const T_1 V_223 = F_118 ( 'C' , 'T' , 'L' , 'A' ) ;
const T_1 V_224 = F_118 ( 'C' , 'T' , 'L' , 'Z' ) ;
const T_1 V_225 = F_118 ( 'C' , 'T' , 'L' , 'L' ) ;
V_217 = F_119 ( V_204 , 0 ) ;
V_218 = F_120 ( V_217 , F_121 ( V_204 , 0 ) ) ;
if ( ! V_218 )
return - V_226 ;
for ( V_55 = 0 ; V_55 < 4 ; V_55 ++ )
V_48 [ V_55 ] = F_122 ( V_218 + V_227 ) ;
if ( V_48 [ 0 ] == V_223 ) {
...
F_124 ( V_204 , V_228 , & V_205 ) ;
F_124 ( V_204 , V_229 , & V_206 ) ;
F_124 ( V_204 , V_230 , & V_207 ) ;
F_124 ( V_204 , V_231 , & V_208 ) ;
F_124 ( V_204 , V_232 , & V_209 ) ;
F_124 ( V_204 , V_233 , & V_210 ) ;
F_124 ( V_204 , V_234 , & V_212 ) ;
F_124 ( V_204 , V_235 , & V_213 ) ;
F_124 ( V_204 , V_236 , & V_214 ) ;
F_124 ( V_204 , V_237 , & V_215 ) ;
F_124 ( V_204 , V_238 , & V_211 ) ;
F_125 ( V_204 , V_239 , 0x87654321 ) ;
F_125 ( V_204 , V_228 , V_210 ) ;
F_125 ( V_204 , V_239 , 0x12345678 ) ;
F_125 ( V_204 , V_229 , V_206 ) ;
F_125 ( V_204 , V_230 , V_207 ) ;
F_125 ( V_204 , V_231 , V_208 ) ;
F_125 ( V_204 , V_232 , V_209 ) ;
F_125 ( V_204 , V_234 , V_212 ) ;
F_125 ( V_204 , V_235 , V_213 ) ;
F_125 ( V_204 , V_236 , V_214 ) ;
F_125 ( V_204 , V_237 , V_215 ) ;
F_125 ( V_204 , V_238 , V_211 ) ;
F_126 ( V_219 , ( V_218 + V_227 ) ) ;
F_126 ( V_220 , ( V_218 + V_227 ) ) ;
F_126 ( V_221 , ( V_218 + V_227 ) ) ;
F_126 ( V_222 , ( V_218 + V_227 ) ) ;
F_123 ( V_218 ) ;
return 0 ;
}
static T_4 F_127 ( int V_212 , void * V_240 )
{
...
static int F_128 ( struct V_53 * V_53 )
{
int V_247 ;
...
if ( ! V_53 -> V_217 ) {
V_247 = F_132 ( V_204 , L_5 ) ;
if ( V_247 < 0 )
goto V_250;
if ( V_53 -> V_179 == V_186 )
V_53 -> V_217 = F_119 ( V_204 , 5 ) ;
else
V_53 -> V_217 = F_119 ( V_204 , 0 ) ;
}
if ( V_53 -> V_179 == V_186 ) {
V_247 = F_117 ( V_204 ) ;
if ( V_247 )
...
if ( V_53 -> V_212 < 0 ) {
V_247 = F_133 ( V_204 -> V_212 , F_127 , V_252 ,
V_253 , V_53 ) ;
if ( V_247 < 0 ) {
F_93 ( V_53 -> V_161 -> V_162 ,
L_6 , V_204 -> V_212 ) ;
...
static int F_137 ( struct V_53 * V_53 )
{
unsigned int V_48 ;
F_28 ( V_53 , V_166 , 0x00 ) ;
V_48 = F_30 ( V_53 , V_169 ) ;
F_28 ( V_53 , V_169 , ( V_48 & ( ~ ( 0x0F << 12 ) ) ) ) ;
if ( V_53 -> V_212 >= 0 )
F_138 ( V_53 -> V_212 ) ;
return 0 ;
}
static int F_139 ( struct V_53 * V_53 )
{
if ( V_53 -> V_212 >= 0 )
F_140 ( V_53 -> V_212 , V_53 ) ;
V_53 -> V_212 = - 1 ;
if ( V_53 -> V_218 )
F_123 ( V_53 -> V_218 ) ;
V_53 -> V_218 = NULL ;
...
static int F_141 ( struct V_53 * V_53 , struct V_254 * V_152 )
{
int V_247 ;
unsigned int V_171 ;
T_1 V_48 ;
...
V_247 = F_104 ( V_53 , & V_255 ) ;
if ( V_247 < 0 )
return V_247 ;
V_256 . V_155 = V_152 -> V_155 ;
V_256 . V_190 = V_183 ;
V_256 . V_191 = 0 ;
V_247 = F_115 ( V_53 , & V_256 ) ;
if ( V_247 < 0 )
return V_247 ;
...
static int F_142 ( struct V_53 * V_53 )
{
struct V_203 * V_204 = V_53 -> V_204 ;
F_137 ( V_53 ) ;
if ( V_53 -> V_179 == V_186 ) {
F_125 ( V_204 , V_239 , 0x0 ) ;
}
F_136 ( V_204 ) ;
F_143 ( V_204 ) ;
F_144 ( V_204 , V_267 ) ;
...
static int F_145 ( struct V_53 * V_53 , struct V_254 * V_152 )
{
struct V_203 * V_204 = V_53 -> V_204 ;
F_144 ( V_204 , V_268 ) ;
F_146 ( V_204 ) ;
return F_141 ( V_53 , V_152 ) ;
}
...
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_272 , V_47 ) ;
F_149 ( V_269 , V_53 -> V_217 + 0x0 ) ;
V_270 = F_150 ( V_53 -> V_217 + 0x4 ) ;
F_151 (
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_272 , V_47 ) ;
return V_270 ;
}
...
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_272 , V_47 ) ;
F_149 ( V_269 , V_53 -> V_217 + 0x0 ) ;
F_149 ( V_48 , V_53 -> V_217 + 0x4 ) ;
F_151 (
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_272 , V_47 ) ;
}
static T_1 F_99 ( struct V_53 * V_53 , T_1 V_269 )
{
T_1 V_270 ;
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_273 , V_47 ) ;
F_149 ( V_269 , V_53 -> V_217 + 0x10 ) ;
V_270 = F_150 ( V_53 -> V_217 + 0x14 ) ;
F_151 (
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_273 , V_47 ) ;
return V_270 ;
}
static void F_100 ( struct V_53 * V_53 , T_1 V_269 , T_1 V_48 )
{
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_273 , V_47 ) ;
F_149 ( V_269 , V_53 -> V_217 + 0x10 ) ;
F_149 ( V_48 , V_53 -> V_217 + 0x14 ) ;
F_151 (
& F_148 ( V_53 , struct V_271 , V_53 ) -> V_273 , V_47 ) ;
}
int F_152 ( struct V_53 * * V_274 )
{
struct V_271 * V_271 ;
* V_274 = NULL ;
...
int F_154 ( struct V_53 * V_53 )
{
if ( V_53 -> V_217 )
F_139 ( V_53 ) ;
F_4 ( F_148 ( V_53 , struct V_271 , V_53 ) ) ;
return 0 ;
}
