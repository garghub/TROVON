...
union V_5 * V_6 , char * V_33 )
{
int V_8 = 0 , V_51 , V_106 ;
short V_47 ;
unsigned long V_34 ;
F_11 ( V_2 ) ;
F_2 ( & V_2 -> V_12 ) ;
V_47 = V_2 -> V_47 ;
V_51 = ( V_6 -> V_55 . V_56 < V_107 ) ? V_6 -> V_55 . V_56 :
V_107 ;
if ( V_51 > V_107 ) {
V_8 = - V_108 ;
goto V_15;
...
V_2 -> V_112 ? L_4 : L_5 ) ;
if ( V_2 -> V_13 == V_38 ) {
if ( V_111 == 0 && V_2 -> V_112 ) {
if ( V_2 -> V_104 )
V_2 -> V_104 ( V_2 -> V_27 ) ;
F_38 ( V_2 -> V_27 ) ;
}
if ( V_111 && V_2 -> V_112 == 1 )
F_39 ( V_2 -> V_27 ) ;
}
F_5 ( & V_2 -> V_12 ) ;
return 0 ;
...
union V_5 * V_6 , char * V_33 )
{
strcpy ( V_6 -> V_114 , L_6 ) ;
if ( V_2 -> V_115 & V_116 )
strcat ( V_6 -> V_114 , L_7 ) ;
if ( V_2 -> V_115 & V_117 )
strcat ( V_6 -> V_114 , L_8 ) ;
if ( V_2 -> V_71 & ( V_118 | V_119 ) )
strcat ( V_6 -> V_114 , L_9 ) ;
return 0 ;
}
...
F_2 ( & V_2 -> V_12 ) ;
if ( V_6 -> V_125 . V_65 ) {
F_30 ( V_94 , L_12 , V_124 ) ;
V_2 -> V_126 = V_127 ;
goto exit;
}
if ( V_6 -> V_125 . V_34 & V_128 ) {
V_2 -> V_129 = V_6 -> V_125 . V_59 / 1000 ;
F_30 ( V_94 , L_13 , V_124 ,
V_2 -> V_129 ) ;
}
if ( V_6 -> V_125 . V_34 & V_130 )
V_2 -> V_131 = V_6 -> V_125 . V_59 / 1000 ;
switch ( V_6 -> V_125 . V_34 & V_132 ) {
case V_133 :
V_2 -> V_126 = V_134 ;
break;
case V_135 :
...
V_6 -> V_125 . V_65 = 0 ;
if ( ( V_6 -> V_125 . V_34 & V_139 ) == V_128 ) {
V_6 -> V_125 . V_34 = V_128 ;
V_6 -> V_125 . V_59 = V_2 -> V_129 * 1000 ;
} else {
V_6 -> V_125 . V_34 = V_130 ;
V_6 -> V_125 . V_59 = V_2 -> V_131 * 1000 ;
}
if ( ( V_2 -> V_126 & ( V_136 | V_134 ) ) ==
( V_136 | V_134 ) )
V_6 -> V_125 . V_34 |= V_137 ;
else if ( V_2 -> V_126 & V_136 )
V_6 -> V_125 . V_34 |= V_135 ;
else
V_6 -> V_125 . V_34 |= V_133 ;
exit:
F_5 ( & V_2 -> V_12 ) ;
return 0 ;
}
