...
static bool F_37 ( struct V_134 * V_103 , unsigned int V_135 )
{
switch ( V_135 ) {
case V_136 :
case V_137 :
...
const struct V_140 * V_29 )
{
struct V_8 * V_8 ;
int V_141 ;
V_8 = F_39 ( & V_139 -> V_103 , sizeof( * V_8 ) , V_142 ) ;
if ( ! V_8 )
return - V_143 ;
V_8 -> V_13 = F_40 ( V_139 ,
& V_144 ) ;
if ( F_41 ( V_8 -> V_13 ) )
return F_42 ( V_8 -> V_13 ) ;
F_19 ( V_8 -> V_13 , V_136 , 0x00 ) ;
F_43 ( & V_139 -> V_103 , V_8 ) ;
V_141 = F_44 ( & V_139 -> V_103 , & V_145 ,
V_146 , F_31 ( V_146 ) ) ;
return V_141 ;
}
