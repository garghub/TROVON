...
static int F_13 ( const char * V_40 )
{
char * * V_41 ;
int V_42 ;
int V_43 = 0 ;
...
int F_28 ( struct V_5 * V_5 , struct V_56 * V_57 )
{
...
void F_29 ( struct V_5 * V_5 , int V_58 )
{
if ( ! V_45 )
return;
if ( V_58 & ( V_59 | V_60 | V_61 ) )
...
struct V_21 * V_22 ;
int V_26 ;
if ( ! V_45 || ! F_13 ( V_62 -> V_53 ) )
return 0 ;
V_22 = F_31 ( sizeof( * V_22 ) , V_29 ) ;
if ( ! V_22 )
return - V_64 ;
V_22 -> type = V_35 ;
V_26 = F_32 ( V_6 , V_62 , V_22 -> V_36 ) ;
if ( V_26 < 0 )
goto V_34;
V_63 -> V_65 = V_22 ;
