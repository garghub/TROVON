...
static void F_9 ( struct V_2 * V_3 , struct V_34 * V_35 )
{
...
V_59 -> V_61 = F_13 ( V_51 , 0 ) ;
if ( ! V_59 -> V_61 ) {
F_14 ( L_1 ) ;
V_27 = - V_62 ;
goto V_63;
}
V_27 = F_15 ( V_51 , 2 , & V_57 ) ;
if ( V_27 ) {
F_14 ( L_2 ) ;
goto V_63;
}
V_59 -> V_64 = F_16 ( V_51 , 2 ) ;
if ( ! V_59 -> V_64 ) {
F_14 ( L_3 ) ;
V_27 = - V_65 ;
goto V_63;
}
V_59 -> V_66 = F_17 ( V_59 -> V_64 + V_67 ) ;
