...
V_152 . V_158 = V_159 ;
V_152 . V_22 . V_160 = F_55 ( V_161 ) ;
V_152 . V_22 . V_162 |= F_55 ( V_163 ) ;
V_153 = F_56 ( & V_11 -> V_164 -> V_6 , & V_152 , NULL ) ;
if ( V_153 ) {
F_29 ( & V_2 -> V_66 -> V_67 ,
L_14 ,
...
if ( F_61 ( V_136 , & V_2 -> V_4 [ V_126 ] . V_132 ) )
F_40 ( & V_2 -> V_4 [ V_126 ] ) ;
F_39 ( & V_2 -> V_4 [ V_126 ] ) ;
}
F_62 ( V_2 -> V_4 ) ;
...
int F_68 ( struct V_1 * V_2 , T_3 V_167 )
{
struct V_3 * V_168 ;
int V_126 , V_54 = 0 ;
F_59 ( V_2 ) ;
if ( F_69 ( V_2 -> V_66 ) != V_167 ) {
V_54 = F_70 ( V_2 -> V_66 , V_167 ) ;
if ( V_54 ) {
F_21 ( & V_2 -> V_66 -> V_67 ,
L_16 , V_54 ) ;
V_2 -> V_167 = 0 ;
...
V_168 = F_71 ( V_167 , sizeof( struct V_3 ) , V_170 ) ;
if ( ! V_168 ) {
V_54 = - V_171 ;
goto V_172;
}
...
static int F_72 ( struct V_177 * V_66 , int V_178 )
{
#ifdef F_73
struct V_1 * V_2 = F_74 ( V_66 ) ;
int V_179 = F_69 ( V_66 ) ;
int V_180 = 0 ;
...
V_180 = F_68 ( V_2 , V_178 ) ;
if ( V_180 ) {
F_66 ( & V_66 -> V_67 , L_18 , V_180 ) ;
goto V_184;
}
V_181:
return V_178 ;
...
int F_75 ( struct V_177 * V_66 , int V_178 )
{
struct V_1 * V_2 = F_74 ( V_66 ) ;
if ( V_178 )
return F_72 ( V_66 , V_178 ) ;
if ( ! F_63 ( V_2 -> V_66 ) ) {
F_58 ( V_2 ) ;
} else {
F_66 ( & V_66 -> V_67 , L_19 ) ;
...
static int F_76 ( struct V_3 * V_4 , T_1 V_185 ,
...
V_153 = F_77 ( V_6 , V_189 , V_185 , V_186 ,
V_187 , V_188 , NULL ) ;
if ( V_153 ) {
F_21 ( & V_2 -> V_66 -> V_67 ,
L_23 ,
...
T_4 V_196 )
{
return F_76 ( V_4 , V_195 , V_196 , NULL , 0 ) ;
}
...
static int F_85 ( struct V_3 * V_4 , T_2 * V_187 , T_3 V_188 )
{
struct V_223 * V_224 =
(struct V_223 * ) V_187 ;
struct V_225 * V_226 ;
...
V_245 = V_11 -> V_246 ;
V_88:
return F_76 ( V_4 , V_247 , V_153 ,
( T_2 * ) & V_245 , sizeof( V_245 ) ) ;
}
static inline int F_91 ( struct V_3 * V_4 , T_2 * V_248 )
{
struct V_1 * V_2 = V_4 -> V_2 ;
int V_54 = 0 ;
if ( F_92 ( V_248 ) ||
...
V_54 = V_249 ;
} else if ( V_4 -> V_250 && ! F_94 ( V_248 ) &&
! F_95 ( V_248 , V_4 -> V_118 . V_119 ) ) {
F_21 ( & V_2 -> V_66 -> V_67 ,
L_25 ) ;
V_54 = - V_183 ;
}
...
static int F_96 ( struct V_3 * V_4 , T_2 * V_187 , T_3 V_188 )
{
struct V_251 * V_252 =
(struct V_251 * ) V_187 ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
V_54 = F_91 ( V_4 , V_252 -> V_254 [ V_126 ] . V_119 ) ;
if ( V_54 )
goto V_88;
}
V_11 = V_2 -> V_11 [ V_10 ] ;
for ( V_126 = 0 ; V_126 < V_252 -> V_253 ; V_126 ++ ) {
struct V_103 * V_104 ;
V_104 = F_97 ( V_11 , V_252 -> V_254 [ V_126 ] . V_119 , true , false ) ;
if ( ! V_104 ) {
if ( F_98 ( V_11 ) )
V_104 = F_99 ( V_11 , V_252 -> V_254 [ V_126 ] . V_119 ,
true , false ) ;
else
...
V_88:
return F_78 ( V_4 , V_255 ,
V_54 ) ;
}
static int F_100 ( struct V_3 * V_4 , T_2 * V_187 , T_3 V_188 )
{
struct V_251 * V_252 =
(struct V_251 * ) V_187 ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
for ( V_126 = 0 ; V_126 < V_252 -> V_253 ; V_126 ++ ) {
if ( F_92 ( V_252 -> V_254 [ V_126 ] . V_119 ) ||
F_93 ( V_252 -> V_254 [ V_126 ] . V_119 ) ) {
...
V_11 = V_2 -> V_11 [ V_10 ] ;
for ( V_126 = 0 ; V_126 < V_252 -> V_253 ; V_126 ++ )
F_101 ( V_11 , V_252 -> V_254 [ V_126 ] . V_119 ,
V_256 , true , false ) ;
if ( F_32 ( V_11 ) )
F_21 ( & V_2 -> V_66 -> V_67 , L_27 ) ;
V_88:
return F_78 ( V_4 , V_257 ,
V_54 ) ;
}
static int F_102 ( struct V_3 * V_4 , T_2 * V_187 , T_3 V_188 )
{
struct V_258 * V_259 =
(struct V_258 * ) V_187 ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
F_103 ( V_11 ) ;
for ( V_126 = 0 ; V_126 < V_259 -> V_253 ; V_126 ++ ) {
int V_54 = F_104 ( V_11 , V_259 -> V_260 [ V_126 ] ) ;
if ( V_54 )
F_21 ( & V_2 -> V_66 -> V_67 ,
L_29 ,
...
V_88:
return F_78 ( V_4 , V_262 , V_153 ) ;
}
static int F_105 ( struct V_3 * V_4 , T_2 * V_187 , T_3 V_188 )
{
struct V_258 * V_259 =
(struct V_258 * ) V_187 ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
for ( V_126 = 0 ; V_126 < V_259 -> V_253 ; V_126 ++ ) {
int V_54 = F_106 ( V_11 , V_259 -> V_260 [ V_126 ] ) ;
if ( V_54 )
F_21 ( & V_2 -> V_66 -> V_67 ,
L_30 ,
V_259 -> V_260 [ V_126 ] , V_54 ) ;
...
V_88:
return F_78 ( V_4 , V_263 , V_153 ) ;
}
static int F_107 ( struct V_3 * V_4 , T_1 V_185 ,
T_1 V_186 , T_2 * V_187 , T_3 V_188 )
{
bool V_264 = false ;
int V_265 ;
if ( F_61 ( V_192 , & V_4 -> V_132 ) )
return V_206 ;
switch ( V_185 ) {
case V_200 :
...
F_78 ( V_4 , V_185 , V_206 ) ;
return - V_87 ;
} else {
return 0 ;
}
}
int F_108 ( struct V_1 * V_2 , T_3 V_8 , T_1 V_185 ,
T_1 V_186 , T_2 * V_187 , T_3 V_188 )
{
struct V_5 * V_6 = & V_2 -> V_6 ;
...
return - V_87 ;
V_4 = & ( V_2 -> V_4 [ V_275 ] ) ;
V_54 = F_107 ( V_4 , V_185 , V_186 , V_187 , V_188 ) ;
if ( V_54 ) {
...
break;
case V_222 :
V_54 = F_83 ( V_4 , V_187 , V_188 ) ;
break;
case V_231 :
V_54 = F_85 ( V_4 , V_187 , V_188 ) ;
break;
case V_236 :
...
break;
case V_255 :
V_54 = F_96 ( V_4 , V_187 , V_188 ) ;
break;
case V_257 :
V_54 = F_100 ( V_4 , V_187 , V_188 ) ;
break;
case V_262 :
V_54 = F_102 ( V_4 , V_187 , V_188 ) ;
break;
case V_263 :
V_54 = F_105 ( V_4 , V_187 , V_188 ) ;
break;
case V_247 :
...
V_165 = ( V_6 -> V_15 . V_74 + V_8 ) % 32 ;
V_4 = & V_2 -> V_4 [ V_8 ] ;
V_7 = F_2 ( V_6 , F_65 ( V_33 ) ) ;
if ( V_7 & ( 1 << V_165 ) ) {
F_4 ( V_6 , F_65 ( V_33 ) , ( 1 << V_165 ) ) ;
if ( ! F_61 ( V_280 , & V_2 -> V_279 ) )
F_48 ( V_4 , true ) ;
}
}
V_7 = F_2 ( V_6 , V_281 ) ;
...
if ( ! F_61 ( V_136 , & V_4 -> V_132 ) &&
! F_61 ( V_146 , & V_4 -> V_132 ) )
continue;
F_77 ( V_6 , V_189 , V_185 , V_186 ,
V_187 , V_188 , NULL ) ;
}
}
...
V_284 . V_289 = V_301 ;
V_284 . V_291 = V_302 ;
F_77 ( & V_4 -> V_2 -> V_6 , V_189 , V_273 ,
V_201 , ( T_2 * ) & V_284 ,
sizeof( struct V_283 ) , NULL ) ;
}
int F_114 ( struct V_303 * V_304 , int V_8 , T_2 * V_305 )
{
struct V_306 * V_307 = F_115 ( V_304 ) ;
...
F_101 ( V_11 , V_4 -> V_118 . V_119 , V_4 -> V_117 ,
true , false ) ;
F_117 (f, &vsi->mac_filter_list, list)
F_101 ( V_11 , V_104 -> V_248 , V_104 -> V_308 , true , false ) ;
...
if ( V_11 -> V_22 . V_211 == 0 && F_98 ( V_11 ) ) {
F_21 ( & V_2 -> V_66 -> V_67 ,
L_39 ,
V_8 ) ;
F_1 ( V_2 , V_4 ) ;
...
V_11 -> V_22 . V_211 )
V_54 = F_104 ( V_11 , V_256 ) ;
if ( V_11 -> V_22 . V_211 ) {
V_54 = F_106 ( V_11 , ( F_10 ( V_11 -> V_22 . V_211 ) &
V_311 ) ) ;
if ( V_54 ) {
...
int F_121 ( struct V_303 * V_304 , int V_8 , int V_313 ,
int V_314 )
{
struct V_306 * V_307 = F_115 ( V_304 ) ;
struct V_1 * V_2 = V_307 -> V_11 -> V_164 ;
...
int F_123 ( struct V_303 * V_304 , int V_8 , int V_328 )
{
struct V_306 * V_307 = F_115 ( V_304 ) ;
struct V_1 * V_2 = V_307 -> V_11 -> V_164 ;
struct V_283 V_284 ;
...
int F_124 ( struct V_303 * V_304 , int V_8 , bool V_330 )
{
struct V_306 * V_307 = F_115 ( V_304 ) ;
struct V_19 * V_11 = V_307 -> V_11 ;
struct V_1 * V_2 = V_11 -> V_164 ;
...
V_152 . V_155 = V_2 -> V_6 . V_71 ;
V_152 . V_22 . V_160 = F_55 ( V_331 ) ;
if ( V_330 )
V_152 . V_22 . V_332 |= V_333 ;
V_54 = F_56 ( V_6 , & V_152 , NULL ) ;
if ( V_54 ) {
