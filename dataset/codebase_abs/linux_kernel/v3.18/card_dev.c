...
V_3 = F_56 ( V_2 , V_91 , V_42 -> V_106 ) ;
V_78 -> V_107 = V_91 -> V_107 ;
V_78 -> V_108 = V_91 -> V_108 ;
V_78 -> V_109 = V_91 -> V_109 ;
if ( V_3 < 0 ) {
F_57 ( V_91 ) ;
goto V_92;
}
...
V_3 = F_56 ( V_2 , V_93 , V_42 -> V_106 ) ;
V_78 -> V_107 = V_93 -> V_107 ;
V_78 -> V_108 = V_93 -> V_108 ;
V_78 -> V_109 = V_93 -> V_109 ;
if ( ( V_3 < 0 ) && ( V_3 != - V_112 ) ) {
F_57 ( V_93 ) ;
goto V_92;
}
...
static int F_60 ( struct V_7 * V_8 , struct V_114 * V_13 )
{
int V_3 ;
struct V_1 * V_2 = V_8 -> V_2 ;
struct V_27 * V_27 = V_8 -> V_2 -> V_27 ;
...
unsigned long V_115 ;
unsigned long V_116 ;
if ( ( V_13 -> V_117 == 0x0 ) || ( V_13 -> V_17 == 0 ) )
return - V_65 ;
V_115 = ( V_13 -> V_117 & V_87 ) ;
V_116 = F_61 ( V_13 -> V_17 + ( V_13 -> V_117 & ~ V_87 ) , V_69 ) ;
V_22 = F_30 ( sizeof( struct V_12 ) , V_67 ) ;
if ( V_22 == NULL )
return - V_44 ;
F_41 ( V_22 , V_118 ) ;
V_3 = F_62 ( V_2 , V_22 , ( void * ) V_115 , V_116 , NULL ) ;
if ( V_3 != 0 ) {
F_16 ( & V_27 -> V_28 ,
L_6 , V_29 , V_3 ) ;
F_22 ( V_22 ) ;
...
static int F_63 ( struct V_7 * V_8 , struct V_114 * V_13 )
{
struct V_1 * V_2 = V_8 -> V_2 ;
struct V_12 * V_22 ;
unsigned long V_115 ;
...
V_115 = ( V_13 -> V_117 & V_87 ) ;
V_116 = F_61 ( V_13 -> V_17 + ( V_13 -> V_117 & ~ V_87 ) , V_69 ) ;
V_22 = F_11 ( V_8 , V_115 , V_116 , NULL ) ;
if ( V_22 == NULL )
return - V_119 ;
F_10 ( V_8 , V_22 ) ;
F_23 ( V_2 , V_22 , NULL ) ;
...
static int F_64 ( struct V_7 * V_8 , struct V_120 * V_91 )
{
unsigned int V_30 ;
struct V_12 * V_22 ;
struct V_1 * V_2 = V_8 -> V_2 ;
for ( V_30 = 0 ; V_30 < V_121 ; V_30 ++ ) {
V_22 = & V_91 -> V_122 [ V_30 ] ;
if ( F_65 ( V_22 ) ) {
F_14 ( V_8 , V_22 ) ;
F_23 ( V_2 , V_22 , V_91 ) ;
}
if ( V_91 -> V_123 [ V_30 ] . V_124 != NULL )
F_66 ( V_2 , & V_91 -> V_123 [ V_30 ] ) ;
}
return 0 ;
}
static int F_67 ( struct V_7 * V_8 , struct V_120 * V_91 )
{
int V_3 ;
unsigned int V_125 , V_30 ;
struct V_1 * V_2 = V_8 -> V_2 ;
struct V_90 * V_93 = & V_91 -> V_93 ;
struct V_12 * V_13 ;
const char * type = L_7 ;
for ( V_30 = 0 , V_125 = 0x00 ; V_125 <= 0x58 ;
V_30 ++ , V_125 += 0x08 ) {
V_19 V_16 ;
T_1 V_60 ;
T_5 V_126 = 0 ;
V_19 V_127 ;
V_127 = F_68 ( V_93 -> V_103 , V_125 ) ;
switch ( V_127 ) {
case V_128 :
break;
case V_129 :
...
V_16 = F_69 ( * ( ( V_95 * ) & V_93 ->
V_102 [ V_125 ] ) ) ;
V_126 = F_70 ( * ( ( V_97 * ) & V_93 ->
V_102 [ V_125 + 0x08 ] ) ) ;
if ( V_126 == 0x0 ) {
* ( ( V_95 * ) & V_93 -> V_102 [ V_125 ] ) =
F_54 ( 0x0 ) ;
break;
}
V_13 = F_15 ( V_8 , V_16 , V_126 ,
& V_60 , NULL ) ;
if ( V_13 == NULL ) {
V_3 = - V_73 ;
goto V_131;
...
& V_93 -> V_102 [ V_125 ] ) ) ;
V_126 = F_70 ( * ( ( V_97 * )
& V_93 -> V_102 [ V_125 + 0x08 ] ) ) ;
if ( V_126 == 0x0 ) {
* ( ( V_95 * ) & V_93 -> V_102 [ V_125 ] ) =
F_54 ( 0x0 ) ;
break;
}
V_13 = F_11 ( V_8 , V_16 , V_126 , NULL ) ;
if ( V_13 != NULL ) {
type = L_8 ;
V_134 = ( V_16 -
( V_19 ) V_13 -> V_20 ) / V_69 ;
...
V_3 = F_71 ( V_2 , & V_91 -> V_123 [ V_30 ] ,
( void T_4 * ) V_16 ,
V_126 ) ;
if ( V_3 != 0 )
goto V_131;
F_72 ( V_2 , & V_91 -> V_123 [ V_30 ] ,
& V_13 -> V_135 [ V_134 ] ) ;
* ( ( V_95 * ) & V_93 -> V_102 [ V_125 ] ) =
F_54 ( V_91 -> V_123 [ V_30 ] . V_136 ) ;
break;
}
default:
V_3 = - V_65 ;
...
struct V_1 * V_2 = V_8 -> V_2 ;
struct V_41 * V_42 = V_8 -> V_42 ;
struct V_120 * V_91 = F_31 ( V_93 , struct V_120 , V_93 ) ;
V_3 = F_67 ( V_8 , V_91 ) ;
if ( V_3 != 0 )
return V_3 ;
V_3 = F_56 ( V_2 , V_93 , V_42 -> V_106 ) ;
...
if ( V_93 == NULL )
return - V_44 ;
V_91 = F_31 ( V_93 , struct V_120 , V_93 ) ;
if ( F_49 ( V_93 , ( void T_4 * ) V_137 , sizeof( * V_93 ) ) ) {
F_57 ( V_93 ) ;
return - V_73 ;
}
if ( ! V_138 )
...
switch ( V_93 ) {
case V_145 :
F_78 ( V_2 -> V_146 , (enum V_147 T_4 * ) V_137 ) ;
return 0 ;
case V_148 : {
V_141 = (struct V_140 T_4 * ) V_137 ;
if ( F_79 ( V_143 , & V_141 -> V_149 ) )
return - V_73 ;
if ( ( V_143 >= V_2 -> V_150 ) || ( V_143 & 0x7 ) )
return - V_65 ;
V_142 = F_80 ( V_2 , V_143 ) ;
F_78 ( V_142 , & V_141 -> V_151 ) ;
return 0 ;
}
case V_152 : {
V_141 = (struct V_140 T_4 * ) V_137 ;
if ( ! F_44 ( V_71 ) )
return - V_153 ;
if ( ( V_42 -> V_106 & V_154 ) == V_155 )
return - V_153 ;
if ( F_79 ( V_143 , & V_141 -> V_149 ) )
return - V_73 ;
if ( ( V_143 >= V_2 -> V_150 ) || ( V_143 & 0x7 ) )
return - V_65 ;
if ( F_79 ( V_142 , & V_141 -> V_151 ) )
return - V_73 ;
F_81 ( V_2 , V_143 , V_142 ) ;
return 0 ;
}
case V_156 : {
V_141 = (struct V_140 T_4 * ) V_137 ;
if ( F_79 ( V_143 , & V_141 -> V_149 ) )
return - V_73 ;
if ( ( V_143 >= V_2 -> V_150 ) || ( V_143 & 0x3 ) )
return - V_65 ;
V_142 = F_82 ( V_2 , V_143 ) ;
F_78 ( V_142 , & V_141 -> V_151 ) ;
return 0 ;
}
case V_157 : {
...
if ( ( V_42 -> V_106 & V_154 ) == V_155 )
return - V_153 ;
if ( F_49 ( & V_78 , ( void T_4 * ) V_137 ,
sizeof( V_78 ) ) )
return - V_73 ;
V_3 = F_47 ( V_8 , & V_78 ) ;
if ( F_59 ( ( void T_4 * ) V_137 , & V_78 , sizeof( V_78 ) ) )
return - V_73 ;
return V_3 ;
}
case V_159 : {
...
if ( F_85 ( V_2 ) )
return - V_160 ;
if ( F_49 ( & V_78 , ( void T_4 * ) V_137 , sizeof( V_78 ) ) )
return - V_73 ;
V_3 = F_58 ( V_8 , & V_78 ) ;
if ( F_59 ( ( void T_4 * ) V_137 , & V_78 , sizeof( V_78 ) ) )
return - V_73 ;
...
case V_161 : {
struct V_114 V_13 ;
if ( F_49 ( & V_13 , ( void T_4 * ) V_137 , sizeof( V_13 ) ) )
return - V_73 ;
...
case V_163 :
return F_74 ( V_8 , V_137 , 0 ) ;
case V_164 : {
if ( ! F_44 ( V_71 ) )
return - V_153 ;
return F_74 ( V_8 , V_137 , 1 ) ;
}
default:
return - V_65 ;
}
