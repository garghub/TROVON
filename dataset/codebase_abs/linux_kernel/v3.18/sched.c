...
void F_120 ( void * V_110 )
{
T_6 V_100 ;
struct V_101 * V_102 ;
if ( ! V_110 )
return;
V_102 = F_116 ( V_110 , struct V_101 , V_68 ) ;
V_100 = V_102 -> V_109 ;
F_2 ( L_17 ,
V_100 , V_102 ) ;
if ( V_100 <= V_107 )
...
static void F_123 ( struct V_3 * V_4 , const struct V_111 * V_112 )
{
memset ( V_4 , 0 , sizeof( * V_4 ) ) ;
F_124 ( & V_4 -> V_50 , 1 ) ;
V_4 -> V_86 = V_112 -> V_48 ;
V_4 -> V_78 = V_112 -> V_113 ;
V_4 -> V_80 = V_112 -> V_114 ;
F_18 ( & V_4 -> V_115 ) ;
V_4 -> V_62 = V_112 -> V_18 - V_63 ;
V_4 -> V_19 = V_39 -> V_116 ;
...
F_126 ( void )
{
return (struct V_3 * ) F_118 ( V_119 , V_120 ) ;
}
struct V_3 * F_127 ( const struct V_111 * V_121 )
{
