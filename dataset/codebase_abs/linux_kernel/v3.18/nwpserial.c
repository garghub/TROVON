...
static void F_31 ( struct V_1 * V_2 , unsigned char V_10 )
{
F_1 ( V_2 , V_11 ) ;
F_6 ( V_2 -> V_6 , V_12 , V_10 ) ;
V_2 -> V_9 . V_13 . V_14 ++ ;
...
if ( V_9 -> V_64 ) {
F_31 ( V_2 , V_2 -> V_9 . V_64 ) ;
V_9 -> V_64 = 0 ;
}
while ( ! ( F_33 ( V_63 ) || F_34 ( & V_2 -> V_9 ) ) ) {
F_31 ( V_2 , V_63 -> V_65 [ V_63 -> V_66 ] ) ;
...
static void F_36 ( struct V_8 * V_9 , unsigned int V_68 )
{
}
static void F_37 ( struct V_8 * V_9 )
{
}
static unsigned int F_38 ( struct V_8 * V_9 )
{
struct V_1 * V_2 ;
unsigned long V_21 ;
int V_33 ;
...
V_2 -> V_9 . V_81 = V_74 ;
V_73 = F_44 ( V_76 , 0 ) ;
V_2 -> V_6 = F_45 ( V_76 , V_74 , V_73 ) ;
if ( ! F_46 ( V_2 -> V_6 ) ) {
F_47 ( V_94 L_2 ) ;
goto V_38;
}
}
V_33 = F_48 ( & V_84 , & V_2 -> V_9 ) ;
if ( V_33 == 0 )
V_33 = V_2 -> V_9 . line ;
V_38:
F_49 ( & V_77 ) ;
