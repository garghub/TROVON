...
if ( V_121 < 1 )
return - V_37 ;
if ( strncasecmp ( V_118 , L_22 , 2 ) == 0 ||
strncasecmp ( V_118 , L_24 , 1 ) == 0 ) {
V_120 = 1 ;
F_40 ( V_27 , L_25 ) ;
} else if ( strncasecmp ( V_118 , L_23 , 3 ) == 0 ||
strncasecmp ( V_118 , L_26 , 1 ) == 0 ) {
V_120 = 0 ;
F_40 ( V_27 , L_27 ) ;
} else {
return - V_37 ;
...
struct V_1 * V_2 = V_6 -> V_10 ;
T_4 V_122 ;
unsigned V_123 = F_42 ( V_6 -> V_13 . V_124 ) ;
F_5 ( L_28 , V_2 , V_123 ) ;
V_6 -> V_125 = F_43 ( V_2 -> V_27 , V_123 ,
& V_122 , V_126 ) ;
if ( V_6 -> V_125 ) {
F_5 ( L_29 ,
V_6 -> V_125 , V_123 ) ;
...
{
struct V_1 * V_2 = V_6 -> V_10 ;
F_45 ( V_2 -> V_27 , F_42 ( V_6 -> V_13 . V_124 ) ,
V_6 -> V_125 , V_6 -> V_13 . V_14 ) ;
}
static inline void F_46 ( void T_1 * V_128 ,
...
F_30 ( V_95 ) ;
F_46 ( V_136 , V_26 -> V_137 , V_26 -> V_138 ) ;
F_46 ( V_139 , V_26 -> V_140 , V_26 -> V_141 ) ;
F_46 ( V_142 , V_26 -> V_143 , V_26 -> V_144 ) ;
F_46 ( V_145 , V_26 -> V_146 , V_26 -> V_147 ) ;
F_32 ( V_95 ) ;
F_5 ( L_31 , V_26 -> V_133 ) ;
...
if ( F_49 ( V_11 + F_35 ( V_32 ) ) == V_148 )
V_2 -> V_98 [ V_32 ] = V_149 ;
else
V_2 -> V_99 = 1 ;
}
}
static T_5 F_50 ( int V_150 , void * V_151 )
{
...
struct V_5 * V_159 ;
long V_160 ;
V_6 = F_52 ( V_157 , struct V_1 , V_161 ) ;
V_159 = F_53 ( F_54 ( V_6 -> V_27 ) ) ;
V_160 = V_6 -> V_23 - F_55 ( V_6 -> V_22 ) ;
...
{
V_6 -> V_161 . V_164 = F_51 ;
return F_57 ( & V_6 -> V_161 ,
V_165 ) ;
}
...
V_159 = F_62 ( sizeof( struct V_1 ) , & V_167 -> V_27 ) ;
if ( ! V_159 )
return - V_127 ;
F_63 ( V_167 , V_159 ) ;
V_6 = V_159 -> V_10 ;
...
V_172 = F_65 ( V_170 ) ;
V_6 -> V_177 = F_66 ( V_170 -> V_178 , V_172 , V_167 -> V_179 ) ;
if ( V_6 -> V_177 == NULL ) {
F_12 ( & V_167 -> V_27 , L_37 ) ;
V_171 = - V_173 ;
goto V_176;
}
V_6 -> V_12 = F_67 ( V_170 -> V_178 , V_172 ) ;
if ( V_6 -> V_12 == NULL ) {
...
for ( V_32 = 0 ; V_32 < 256 ; V_32 ++ )
V_6 -> V_98 [ V_32 ] = V_149 ;
V_171 = F_68 ( V_150 , F_50 , 0 , V_167 -> V_179 , V_6 ) ;
if ( V_171 ) {
...
V_171 = F_75 ( & V_167 -> V_27 , & V_208 ) ;
if ( V_171 )
F_12 ( & V_167 -> V_27 , L_48 ) ;
F_76 ( & V_167 -> V_27 , L_49 ,
...
F_80 ( V_6 -> V_12 ) ;
V_180:
F_81 ( V_170 -> V_178 , V_172 ) ;
V_176:
F_82 ( V_159 ) ;
return V_171 ;
}
static int F_83 ( struct V_166 * V_167 )
{
return F_60 ( V_167 , V_210 ) ;
}
static int F_84 ( struct V_166 * V_167 )
{
return F_60 ( V_167 , V_4 ) ;
}
static int F_85 ( struct V_166 * V_167 )
{
struct V_5 * V_159 = F_53 ( V_167 ) ;
...
F_79 ( V_150 , V_6 ) ;
F_80 ( V_6 -> V_12 ) ;
F_81 ( V_6 -> V_177 -> V_178 , F_65 ( V_6 -> V_177 ) ) ;
F_82 ( V_159 ) ;
return 0 ;
}
static int F_87 ( struct V_166 * V_27 , T_6 V_211 )
{
struct V_5 * V_159 = F_53 ( V_27 ) ;
struct V_1 * V_6 = V_159 -> V_10 ;
F_36 ( V_6 , 0 ) ;
F_73 ( 1000 , 1100 ) ;
F_77 ( V_6 -> V_22 ) ;
...
static int F_88 ( struct V_166 * V_27 )
{
struct V_5 * V_159 = F_53 ( V_27 ) ;
struct V_1 * V_6 = V_159 -> V_10 ;
F_72 ( V_6 -> V_22 ) ;
