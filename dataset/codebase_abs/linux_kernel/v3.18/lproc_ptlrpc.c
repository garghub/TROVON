...
case V_145 :
case V_146 :
F_16 ( V_142 , L_38 , F_56 ( V_123 -> V_147 ) ) ;
break;
default:
F_57 ( V_148 , V_123 , L_39 , V_123 -> V_143 ) ;
}
}
...
{
struct V_35 * V_36 = V_33 -> V_37 ;
return F_16 ( V_33 , L_46 , V_36 -> V_177 ) ;
}
...
if ( strncmp ( V_222 , L_59 , 4 ) == 0 )
F_86 ( V_220 , V_222 + 4 ) ;
else if ( strncmp ( V_222 , L_60 , 5 ) == 0 )
F_87 ( V_220 , V_222 + 5 ) ;
else
F_87 ( V_220 , V_222 ) ;
