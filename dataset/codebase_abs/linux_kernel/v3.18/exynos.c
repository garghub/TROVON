...
static int T_3 F_12 ( unsigned long V_11 , const char * V_14 ,
int V_15 , void * V_16 )
{
struct V_17 V_18 ;
const T_4 * V_19 ;
...
! F_13 ( V_11 , L_2 ) )
return 0 ;
V_19 = F_14 ( V_11 , L_6 , & V_20 ) ;
if ( V_19 == NULL || V_20 != (sizeof( unsigned long ) * 2 ) )
return 0 ;
V_18 . V_21 = F_15 ( F_16 ( V_19 [ 0 ] ) ) ;
V_18 . V_22 = F_16 ( V_19 [ 1 ] ) - 1 ;
