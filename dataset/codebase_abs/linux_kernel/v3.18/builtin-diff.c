...
int V_4 = - V_5 , V_19 ;
F_56 (i, d) {
V_69 -> V_105 = F_65 ( & V_69 -> V_102 , false , & T_5 ) ;
if ( ! V_69 -> V_105 ) {
F_3 ( L_25 , V_69 -> V_102 . V_103 ) ;
V_4 = - 1 ;
goto V_113;
}
V_4 = F_66 ( V_69 -> V_105 , & T_5 ) ;
if ( V_4 ) {
...
static double F_68 ( struct V_24 * V_25 )
{
T_2 V_27 = F_7 ( V_25 -> V_28 ) ;
return 100.0 * V_25 -> V_31 . V_26 / V_27 ;
}
static int F_69 ( struct V_114 * V_74 ,
struct V_115 * V_116 , struct V_24 * V_25 )
{
struct V_70 * V_71 =
F_32 ( V_74 , struct V_70 , V_74 ) ;
double V_117 = F_68 ( V_25 ) ;
char V_118 [ 20 ] = L_27 ;
if ( ! V_25 -> V_119 ) {
F_12 ( V_118 , 20 , L_28 , V_71 -> V_120 - 1 ) ;
return F_70 ( V_116 -> V_18 , V_116 -> V_40 ,
V_118 , V_117 ) ;
} else
return F_12 ( V_116 -> V_18 , V_116 -> V_40 , L_29 ,
V_71 -> V_120 , V_118 ) ;
}
static int F_71 ( struct V_24 * V_25 , char * V_18 , T_4 V_40 )
{
double V_117 = F_68 ( V_25 ) ;
...
static int F_72 ( struct V_114 * V_74 ,
struct V_115 * V_116 , struct V_24 * V_25 ,
int V_122 )
{
struct V_70 * V_71 =
...
return F_73 ( V_116 -> V_18 , V_116 -> V_40 ,
V_118 , V_33 ) ;
case V_11 :
if ( V_25 -> V_119 )
goto V_123;
...
return F_74 ( V_116 -> V_18 , V_116 -> V_40 ,
F_75 ( V_39 ) ,
V_118 , V_39 ) ;
default:
F_16 ( 1 ) ;
...
static int F_76 ( struct V_114 * V_74 ,
struct V_115 * V_116 , struct V_24 * V_25 )
{
return F_72 ( V_74 , V_116 , V_25 , V_20 ) ;
}
static int F_77 ( struct V_114 * V_74 ,
struct V_115 * V_116 , struct V_24 * V_25 )
{
return F_72 ( V_74 , V_116 , V_25 , V_49 ) ;
}
static int F_78 ( struct V_114 * V_74 ,
struct V_115 * V_116 , struct V_24 * V_25 )
{
return F_72 ( V_74 , V_116 , V_25 , V_11 ) ;
}
static void
F_79 ( struct V_24 * V_25 , int V_73 , char * V_18 , T_4 V_40 )
{
switch ( V_73 ) {
case V_124 :
...
static void
F_80 ( struct V_24 * V_25 , struct V_24 * V_29 ,
...
static void
F_81 ( struct V_24 * V_25 , struct V_70 * V_71 ,
char * V_18 , T_4 V_40 )
{
struct V_24 * V_29 = F_31 ( V_25 , V_71 ) ;
int V_73 = V_71 -> V_73 ;
...
if ( V_29 )
F_80 ( V_25 , V_29 , V_73 , V_18 , V_40 ) ;
else
F_79 ( V_25 , V_73 , V_18 , V_40 ) ;
}
}
static int F_82 ( struct V_114 * V_132 , struct V_115 * V_116 ,
struct V_24 * V_25 )
{
struct V_70 * V_71 =
F_32 ( V_132 , struct V_70 , V_74 ) ;
char V_18 [ V_133 ] = L_27 ;
F_81 ( V_25 , V_71 , V_18 , V_133 ) ;
if ( V_45 . V_121 )
...
static int F_83 ( struct V_114 * V_74 , struct V_115 * V_116 ,
...
static int F_84 ( struct V_114 * V_74 ,
...
static void F_85 ( struct V_68 * V_69 , struct V_70 * V_71 )
{
#define F_86 100
char V_134 [ F_86 ] ;
char V_18 [ F_86 ] ;
...
F_16 ( ! V_63 ) ;
if ( V_110 > 2 )
F_12 ( V_18 , F_86 , L_39 , V_63 , V_69 -> V_73 ) ;
#define F_87 (data__files_cnt > 2 ? buf : header)
V_71 -> V_120 = V_135 ;
V_135 = ( int ) strlen ( F_87 ) ;
if ( V_71 -> V_120 < V_135 )
V_71 -> V_120 = V_135 ;
F_12 ( V_134 , F_86 , L_29 ,
V_71 -> V_120 , F_87 ) ;
V_71 -> V_63 = F_88 ( V_134 ) ;
#undef F_86
#undef F_87
}
static void F_89 ( struct V_68 * V_69 , int V_73 )
{
...
int V_19 ;
F_56 (i, d) {
F_89 ( V_69 , V_19 ? V_140 [ V_10 ] :
V_131 ) ;
if ( V_141 && V_19 )
F_89 ( V_69 , V_129 ) ;
if ( V_142 )
F_89 ( V_69 , V_19 ? V_130 :
V_124 ) ;
}
}
static int F_92 ( int V_143 , const char * * V_144 )
{
struct V_68 * V_69 ;
...
V_83 = F_93 ( sizeof( * V_83 ) * V_110 ) ;
if ( ! V_83 )
return - V_54 ;
F_56 (i, d) {
struct V_148 * V_102 = & V_69 -> V_102 ;
V_102 -> V_103 = V_146 ? V_145 [ V_19 ] : V_144 [ V_19 ] ;
V_102 -> V_149 = V_150 ,
V_102 -> V_151 = V_151 ,
V_69 -> V_73 = V_19 ;
}
...
int F_94 ( int V_143 , const char * * V_144 , const char * T_7 V_14 )
{
int V_4 = F_95 () ;
if ( V_4 < 0 )
return V_4 ;
F_96 ( V_152 , NULL ) ;
V_143 = F_97 ( V_143 , V_144 , V_153 , V_154 , 0 ) ;
if ( F_98 ( NULL ) < 0 )
return - 1 ;
if ( F_92 ( V_143 , V_144 ) < 0 )
return - 1 ;
F_91 () ;
V_155 = V_156 ;
if ( F_99 () < 0 )
