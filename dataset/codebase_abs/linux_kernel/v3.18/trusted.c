...
static struct V_118 * F_51 ( struct V_17 * V_17 )
{
struct V_118 * V_119 = NULL ;
int V_14 ;
V_14 = F_52 ( V_17 , sizeof *V_119 ) ;
if ( V_14 < 0 )
return V_119 ;
...
int V_143 ;
T_5 V_122 ;
if ( V_12 <= 0 || V_12 > 32767 || ! V_154 -> V_11 )
return - V_24 ;
V_142 = F_3 ( V_12 + 1 , V_6 ) ;
if ( ! V_142 )
return - V_7 ;
memcpy ( V_142 , V_154 -> V_11 , V_12 ) ;
V_142 [ V_12 ] = '\0' ;
V_151 = F_50 () ;
if ( ! V_151 ) {
V_14 = - V_7 ;
...
case V_144 :
V_122 = V_155 -> V_122 ;
V_14 = F_27 ( V_70 , V_155 -> V_17 , V_122 ) ;
if ( V_14 != V_122 ) {
F_7 ( L_10 , V_14 ) ;
goto V_23;
}
V_14 = F_40 ( V_155 , V_151 ) ;
if ( V_14 < 0 )
F_7 ( L_11 , V_14 ) ;
break;
default:
...
static void F_57 ( struct V_156 * V_157 )
{
struct V_118 * V_119 ;
V_119 = F_58 ( V_157 , struct V_118 , V_157 ) ;
memset ( V_119 -> V_17 , 0 , V_119 -> V_122 ) ;
F_10 ( V_119 ) ;
}
static int F_59 ( struct V_17 * V_17 , struct V_153 * V_154 )
{
struct V_118 * V_119 = V_17 -> V_155 . V_11 ;
struct V_118 * V_158 ;
struct V_120 * V_159 ;
T_5 V_12 = V_154 -> V_12 ;
char * V_142 ;
...
memcpy ( V_142 , V_154 -> V_11 , V_12 ) ;
V_142 [ V_12 ] = '\0' ;
V_14 = F_48 ( V_142 , V_158 , V_159 ) ;
if ( V_14 != V_149 ) {
V_14 = - V_24 ;
F_10 ( V_158 ) ;
goto V_23;
}
V_158 -> V_123 = V_119 -> V_123 ;
V_158 -> V_122 = V_119 -> V_122 ;
memcpy ( V_158 -> V_17 , V_119 -> V_17 , V_119 -> V_122 ) ;
F_54 ( V_119 ) ;
F_54 ( V_158 ) ;
V_14 = F_40 ( V_158 , V_159 ) ;
if ( V_14 < 0 ) {
F_7 ( L_11 , V_14 ) ;
F_10 ( V_158 ) ;
goto V_23;
...
F_56 ( V_17 , V_158 ) ;
F_60 ( & V_119 -> V_157 , F_57 ) ;
V_23:
F_10 ( V_142 ) ;
F_10 ( V_159 ) ;
return V_14 ;
}
static long F_61 ( const struct V_17 * V_17 , char T_7 * V_32 ,
T_5 V_64 )
{
struct V_118 * V_119 ;
char * V_160 ;
...
V_160 = F_3 ( 2 * V_119 -> V_124 , V_6 ) ;
if ( ! V_160 )
return - V_7 ;
V_161 = V_160 ;
for ( V_102 = 0 ; V_102 < V_119 -> V_124 ; V_102 ++ )
V_161 = F_63 ( V_161 , V_119 -> V_88 [ V_102 ] ) ;
if ( ( F_64 ( V_32 , V_160 , 2 * V_119 -> V_124 ) ) != 0 ) {
F_10 ( V_160 ) ;
return - V_162 ;
}
F_10 ( V_160 ) ;
...
static void F_65 ( struct V_17 * V_17 )
{
struct V_118 * V_119 = V_17 -> V_155 . V_11 ;
if ( ! V_119 )
return;
memset ( V_119 -> V_17 , 0 , V_119 -> V_122 ) ;
F_10 ( V_17 -> V_155 . V_11 ) ;
}
...
{
int V_14 ;
V_21 = F_69 ( V_22 , 0 , V_163 ) ;
if ( F_6 ( V_21 ) ) {
F_7 ( L_13 ,
V_22 ) ;
return F_8 ( V_21 ) ;
}
V_15 = F_69 ( V_16 , 0 , V_163 ) ;
if ( F_6 ( V_15 ) ) {
F_7 ( L_13 ,
V_16 ) ;
V_14 = F_8 ( V_15 ) ;
