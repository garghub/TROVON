...
F_220 ( V_369 , V_139 -> V_90 ) ;
F_221 ( V_139 -> V_90 , F_100 ) ;
V_139 -> V_34 = V_34 ;
...
V_139 -> V_151 = V_150 ;
V_139 -> V_87 = V_87 ;
V_362 = V_200 -> V_371 & 0xf ;
V_139 -> V_145 = V_200 -> V_362 [ V_362 ] . V_372 ;
V_139 -> V_309 = F_99 ( V_200 -> V_362 [ V_362 ] . V_309 ) ;
F_223 ( V_139 -> V_90 , 1 << V_139 -> V_145 ) ;
if ( V_34 -> V_373 )
F_224 ( V_139 -> V_90 , V_34 -> V_373 ) ;
if ( V_34 -> V_374 & V_375 )
F_225 ( V_139 -> V_90 , V_163 | V_164 ) ;
V_87 -> V_376 = V_377 ;
V_87 -> V_378 = 0 ;
V_87 -> V_379 = & V_380 ;
V_87 -> V_158 = V_139 ;
V_87 -> V_90 = V_139 -> V_90 ;
V_87 -> V_381 = & V_34 -> V_232 -> V_34 ;
V_87 -> V_54 = V_382 ;
sprintf ( V_87 -> V_383 , L_13 , V_34 -> V_260 , V_150 ) ;
F_226 ( V_87 , F_227 ( & V_200 -> V_384 ) << ( V_139 -> V_145 - 9 ) ) ;
if ( V_34 -> V_385 & V_386 )
F_215 ( V_139 ) ;
return V_139 ;
V_370:
...
static int F_229 ( int V_104 )
{
int V_387 , V_388 , V_389 = V_296 , V_390 = V_104 ;
F_230 (n) {
if ( V_387 == V_104 )
continue;
V_388 = F_231 ( V_104 , V_387 ) ;
if ( V_388 < V_389 ) {
V_389 = V_388 ;
V_390 = V_387 ;
}
...
static void F_232 ( T_13 * V_391 , struct V_14 * V_15 ,
int V_292 )
{
int V_92 ;
F_233 (cpu, qmask) {
if ( F_234 ( V_15 -> V_244 ) >= V_292 )
break;
if ( ! F_235 ( V_92 , V_15 -> V_244 ) )
* F_236 ( V_15 -> V_34 -> V_51 , V_92 ) = V_15 -> V_48 ;
}
}
static void F_237 ( T_13 * V_392 , const T_13 * V_393 ,
const T_13 * V_394 , struct V_14 * V_15 , int V_395 )
{
int V_396 ;
F_233 (next_cpu, new_mask) {
F_238 ( V_392 , V_392 , F_239 ( V_396 ) ) ;
F_238 ( V_392 , V_392 , F_240 ( V_396 ) ) ;
F_241 ( V_392 , V_392 , V_393 ) ;
F_232 ( V_392 , V_15 , V_395 ) ;
}
}
static void F_242 ( struct V_47 * V_34 )
{
unsigned V_78 , V_397 ;
V_397 = F_243 ( V_34 -> V_398 , F_244 () ) ;
for ( V_78 = V_34 -> V_246 ; V_78 <= V_397 ; V_78 ++ )
if ( ! F_152 ( V_34 , V_78 , V_34 -> V_17 , V_78 - 1 ) )
break;
V_397 = F_243 ( V_34 -> V_246 - 1 , F_244 () ) ;
for ( V_78 = V_34 -> V_249 ; V_78 <= V_397 ; V_78 ++ )
if ( F_165 ( F_21 ( V_34 , V_78 ) , V_78 ) )
break;
}
static void F_245 ( struct V_47 * V_34 )
{
unsigned V_92 , V_395 , V_49 , V_399 , V_78 ;
T_14 V_393 ;
F_242 ( V_34 ) ;
V_49 = F_243 ( V_34 -> V_249 - 1 , F_244 () ) ;
if ( ! V_49 )
return;
V_395 = F_244 () / V_49 ;
V_399 = V_49 - ( F_244 () - V_49 * V_395 ) ;
if ( ! F_246 ( & V_393 , V_255 ) )
return;
F_247 ( V_393 , V_400 ) ;
V_92 = F_248 ( V_393 ) ;
...
F_255 ( V_393 , V_393 ,
V_15 -> V_244 ) ;
V_92 = F_256 ( V_92 , V_393 ) ;
if ( V_399 && ! -- V_399 )
V_395 ++ ;
F_31 ( V_15 ) ;
}
F_254 ( F_234 ( V_393 ) , L_15 ,
V_34 -> V_260 ) ;
V_78 = 0 ;
F_255 ( V_393 , V_401 , V_400 ) ;
F_233 ( V_92 , V_393 )
* F_236 ( V_34 -> V_51 , V_92 ) = ( V_78 ++ % V_49 ) + 1 ;
F_142 ( V_393 ) ;
}
static int F_257 ( struct V_47 * V_34 , int V_292 )
{
int V_44 ;
T_8 V_43 ;
T_8 V_402 = ( V_292 - 1 ) | ( ( V_292 - 1 ) << 16 ) ;
V_44 = F_125 ( V_34 , V_403 , V_402 , 0 ,
& V_43 ) ;
if ( V_44 < 0 )
return V_44 ;
if ( V_44 > 0 ) {
...
return F_243 ( V_43 & 0xffff , V_43 >> 16 ) + 1 ;
}
static T_15 F_258 ( struct V_47 * V_34 , unsigned V_404 )
{
return 4096 + ( ( V_404 + 1 ) * 8 * V_34 -> V_182 ) ;
}
static void F_259 ( struct V_405 * V_46 )
{
struct V_47 * V_34 = F_133 ( V_46 , struct V_47 , V_406 ) ;
if ( V_34 -> V_240 )
F_245 ( V_34 ) ;
}
static int F_260 ( struct V_407 * V_408 ,
...
static int F_263 ( struct V_47 * V_34 )
{
struct V_14 * V_230 = F_21 ( V_34 , 0 ) ;
struct V_232 * V_414 = V_34 -> V_232 ;
int V_43 , V_78 , V_415 , V_404 , V_64 ;
V_404 = F_264 () ;
V_43 = F_257 ( V_34 , V_404 ) ;
if ( V_43 < 0 )
return V_43 ;
if ( V_43 < V_404 )
V_404 = V_43 ;
V_64 = F_258 ( V_34 , V_404 ) ;
if ( V_64 > 8192 ) {
F_265 ( V_34 -> V_250 ) ;
do {
V_34 -> V_250 = F_266 ( F_267 ( V_414 , 0 ) , V_64 ) ;
if ( V_34 -> V_250 )
break;
if ( ! -- V_404 )
return - V_118 ;
...
V_34 -> V_261 = ( ( void V_416 * ) V_34 -> V_250 ) + 4096 ;
V_230 -> V_60 = V_34 -> V_261 ;
}
F_148 ( V_34 -> V_248 [ 0 ] . V_247 , V_230 ) ;
for ( V_78 = 0 ; V_78 < V_404 ; V_78 ++ )
V_34 -> V_248 [ V_78 ] . V_248 = V_78 ;
V_415 = F_268 ( V_414 , V_34 -> V_248 , 1 , V_404 ) ;
if ( V_415 < 0 ) {
V_415 = F_269 ( V_414 , 1 , F_243 ( V_404 , 32 ) ) ;
if ( V_415 < 0 ) {
V_415 = 1 ;
} else {
for ( V_78 = 0 ; V_78 < V_415 ; V_78 ++ )
V_34 -> V_248 [ V_78 ] . V_247 = V_78 + V_414 -> V_187 ;
}
}
V_404 = V_415 ;
V_34 -> V_398 = V_404 ;
...
static int F_270 ( struct V_47 * V_34 )
{
struct V_232 * V_414 = V_34 -> V_232 ;
int V_418 ;
unsigned V_419 , V_78 ;
...
void * V_422 ;
T_6 V_113 ;
int V_423 = F_271 ( F_175 ( & V_34 -> V_250 -> V_267 ) ) + 12 ;
V_422 = F_154 ( & V_414 -> V_34 , 8192 , & V_113 , V_255 ) ;
if ( ! V_422 )
return - V_118 ;
V_418 = F_123 ( V_34 , 0 , 1 , V_113 ) ;
if ( V_418 ) {
F_170 ( & V_414 -> V_34 , L_17 , V_418 ) ;
V_418 = - V_106 ;
goto V_424;
}
V_420 = V_422 ;
V_419 = F_15 ( & V_420 -> V_419 ) ;
V_34 -> V_385 = F_13 ( & V_420 -> V_385 ) ;
V_34 -> V_35 = V_420 -> V_425 + 1 ;
V_34 -> V_374 = V_420 -> V_374 ;
memcpy ( V_34 -> V_426 , V_420 -> V_427 , sizeof( V_420 -> V_427 ) ) ;
memcpy ( V_34 -> V_428 , V_420 -> V_429 , sizeof( V_420 -> V_429 ) ) ;
memcpy ( V_34 -> V_430 , V_420 -> V_431 , sizeof( V_420 -> V_431 ) ) ;
if ( V_420 -> V_432 )
V_34 -> V_373 = 1 << ( V_420 -> V_432 + V_423 - 9 ) ;
if ( ( V_414 -> V_433 == V_434 ) &&
( V_414 -> V_252 == 0x0953 ) && V_420 -> V_435 [ 3 ] )
V_34 -> V_134 = 1 << ( V_420 -> V_435 [ 3 ] + V_423 ) ;
V_421 = V_422 ;
for ( V_78 = 1 ; V_78 <= V_419 ; V_78 ++ ) {
V_418 = F_123 ( V_34 , V_78 , 0 , V_113 ) ;
if ( V_418 )
continue;
if ( V_421 -> V_436 == 0 )
continue;
V_418 = F_124 ( V_34 , V_437 , V_78 ,
V_113 + 4096 , NULL ) ;
if ( V_418 )
memset ( V_422 + 4096 , 0 , 4096 ) ;
V_139 = F_218 ( V_34 , V_78 , V_422 , V_422 + 4096 ) ;
if ( V_139 )
F_61 ( & V_139 -> V_79 , & V_34 -> V_438 ) ;
}
F_261 (ns, &dev->namespaces, list)
F_272 ( V_139 -> V_87 ) ;
V_418 = 0 ;
V_424:
F_139 ( & V_34 -> V_232 -> V_34 , 8192 , V_422 , V_113 ) ;
return V_418 ;
}
static int F_273 ( struct V_47 * V_34 )
{
T_7 V_267 ;
int V_439 , V_43 = - V_118 ;
struct V_232 * V_414 = V_34 -> V_232 ;
if ( F_274 ( V_414 ) )
return V_43 ;
V_34 -> V_248 [ 0 ] . V_247 = V_414 -> V_187 ;
F_275 ( V_414 ) ;
V_439 = F_276 ( V_414 , V_440 ) ;
if ( F_277 ( V_414 , V_439 , L_18 ) )
goto V_441;
if ( F_278 ( & V_414 -> V_34 , F_279 ( 64 ) ) &&
F_278 ( & V_414 -> V_34 , F_279 ( 32 ) ) )
goto V_442;
V_34 -> V_250 = F_266 ( F_267 ( V_414 , 0 ) , 8192 ) ;
if ( ! V_34 -> V_250 )
goto V_442;
...
V_34 -> V_17 = F_181 ( int , F_280 ( V_267 ) + 1 , V_443 ) ;
V_34 -> V_182 = 1 << F_281 ( V_267 ) ;
V_34 -> V_261 = ( ( void V_416 * ) V_34 -> V_250 ) + 4096 ;
return 0 ;
V_315:
F_265 ( V_34 -> V_250 ) ;
...
static void F_284 ( struct V_47 * V_34 )
{
if ( V_34 -> V_232 -> V_444 )
F_285 ( V_34 -> V_232 ) ;
else if ( V_34 -> V_232 -> V_445 )
F_286 ( V_34 -> V_232 ) ;
if ( V_34 -> V_250 ) {
F_265 ( V_34 -> V_250 ) ;
V_34 -> V_250 = NULL ;
...
static void F_288 ( struct V_446 * V_447 , struct V_47 * V_34 )
{
V_447 -> V_448 = V_196 ;
F_289 () ;
for (; ; ) {
F_111 ( V_197 ) ;
if ( ! F_290 ( & V_447 -> V_449 ) )
break;
if ( ! F_112 ( V_199 ) ||
F_169 ( V_196 ) ) {
F_111 ( V_198 ) ;
...
F_150 ( V_34 , 0 ) ;
F_291 ( V_450 , V_447 -> V_45 -> V_193 , 1 ) ;
F_292 ( V_447 -> V_45 ) ;
return;
}
}
...
static void F_293 ( struct V_446 * V_447 )
{
F_294 ( & V_447 -> V_449 ) ;
if ( V_447 -> V_448 )
F_95 ( V_447 -> V_448 ) ;
}
static struct V_446 * F_295 ( struct V_446 * V_447 )
{
F_296 ( & V_447 -> V_449 ) ;
return V_447 ;
}
...
{
struct V_446 * V_447 = V_15 -> V_42 . V_19 ;
F_149 ( V_15 ) ;
F_293 ( V_447 ) ;
}
static int F_298 ( struct V_14 * V_15 , T_10 V_148 ,
T_16 V_25 )
{
struct V_8 V_201 ;
memset ( & V_201 , 0 , sizeof( V_201 ) ) ;
...
F_299 ( & V_15 -> V_42 . V_46 , V_25 ) ;
return F_117 ( V_15 -> V_34 , & V_201 , & V_15 -> V_42 ) ;
}
static void F_300 ( struct V_451 * V_46 )
{
...
{
return F_298 ( V_15 , V_219 ,
F_300 ) ;
}
static void F_302 ( struct V_451 * V_46 )
{
struct V_14 * V_15 = F_133 ( V_46 , struct V_14 ,
V_42 . V_46 ) ;
...
{
return F_298 ( V_15 , V_220 ,
F_302 ) ;
}
static void F_304 ( struct V_451 * V_46 )
{
struct V_14 * V_15 = F_133 ( V_46 , struct V_14 ,
V_42 . V_46 ) ;
F_305 ( V_450 ) ;
...
static void F_306 ( struct V_47 * V_34 )
{
int V_78 ;
F_307 ( V_45 ) ;
struct V_446 V_447 ;
struct V_452 * V_453 = F_308 ( V_454 ,
...
if ( F_146 ( V_15 ) )
continue;
V_15 -> V_42 . V_19 = F_295 ( & V_447 ) ;
V_15 -> V_42 . V_45 = V_447 . V_45 ;
F_299 ( & V_15 -> V_42 . V_46 , F_304 ) ;
F_16 ( V_447 . V_45 , & V_15 -> V_42 . V_46 ) ;
}
F_288 ( & V_447 , V_34 ) ;
F_310 ( V_453 ) ;
}
static void F_311 ( struct V_47 * V_34 )
{
struct V_452 * V_455 = NULL ;
F_105 ( & V_351 ) ;
F_127 ( & V_34 -> V_104 ) ;
if ( F_136 ( & V_456 ) && ! F_312 ( V_174 ) ) {
V_455 = V_174 ;
V_174 = NULL ;
}
F_106 ( & V_351 ) ;
...
static void F_314 ( struct V_47 * V_34 )
{
struct V_138 * V_139 ;
F_261 (ns, &dev->namespaces, list) {
if ( V_139 -> V_87 -> V_54 & V_457 )
F_315 ( V_139 -> V_87 ) ;
if ( ! F_316 ( V_139 -> V_90 ) )
F_228 ( V_139 -> V_90 ) ;
}
}
static int F_317 ( struct V_47 * V_34 )
{
struct V_252 * V_253 = & V_34 -> V_232 -> V_34 ;
V_34 -> V_84 = F_318 ( L_21 , V_253 ,
V_66 , V_66 , 0 ) ;
if ( ! V_34 -> V_84 )
return - V_118 ;
V_34 -> V_81 = F_318 ( L_22 , V_253 ,
256 , 256 , 0 ) ;
if ( ! V_34 -> V_81 ) {
F_319 ( V_34 -> V_84 ) ;
return - V_118 ;
...
static void F_320 ( struct V_47 * V_34 )
{
F_319 ( V_34 -> V_84 ) ;
F_319 ( V_34 -> V_81 ) ;
}
static int F_321 ( struct V_47 * V_34 )
{
int V_260 , error ;
do {
if ( ! F_322 ( & V_458 , V_255 ) )
return - V_195 ;
F_105 ( & V_351 ) ;
error = F_323 ( & V_458 , & V_260 ) ;
F_106 ( & V_351 ) ;
} while ( error == - V_459 );
if ( error )
return - V_195 ;
...
static void F_324 ( struct V_47 * V_34 )
{
F_105 ( & V_351 ) ;
F_325 ( & V_458 , V_34 -> V_260 ) ;
F_106 ( & V_351 ) ;
}
static void F_326 ( struct V_47 * V_34 )
{
...
static int F_329 ( struct V_460 * V_460 , struct V_461 * V_462 )
{
struct V_47 * V_34 = F_133 ( V_462 -> V_158 , struct V_47 ,
V_463 ) ;
F_202 ( & V_34 -> V_342 ) ;
V_462 -> V_158 = V_34 ;
return 0 ;
}
static int F_330 ( struct V_460 * V_460 , struct V_461 * V_462 )
{
struct V_47 * V_34 = V_462 -> V_158 ;
F_204 ( & V_34 -> V_342 , V_343 ) ;
return 0 ;
}
static long F_331 ( struct V_461 * V_462 , unsigned int V_53 , unsigned long V_335 )
{
struct V_47 * V_34 = V_462 -> V_158 ;
switch ( V_53 ) {
case V_337 :
...
static int F_332 ( struct V_47 * V_34 )
{
int V_43 ;
bool V_464 = false ;
V_43 = F_273 ( V_34 ) ;
...
F_333 ( & V_34 -> V_104 , & V_456 ) ;
F_106 ( & V_351 ) ;
if ( V_464 ) {
V_174 = F_308 ( F_212 , NULL , L_18 ) ;
F_19 ( & V_465 ) ;
} else
F_10 ( V_465 , V_174 ) ;
if ( F_312 ( V_174 ) ) {
...
static void F_337 ( struct V_405 * V_466 )
{
struct V_47 * V_34 = F_133 ( V_466 , struct V_47 , V_231 ) ;
F_314 ( V_34 ) ;
F_143 ( V_34 , 1 ) ;
}
static int F_338 ( struct V_47 * V_34 )
{
int V_194 ;
V_194 = F_332 ( V_34 ) ;
if ( V_194 && V_194 != - V_24 )
...
static void F_339 ( struct V_47 * V_34 )
{
F_313 ( V_34 ) ;
if ( F_338 ( V_34 ) ) {
F_170 ( & V_34 -> V_232 -> V_34 , L_23 ) ;
F_202 ( & V_34 -> V_342 ) ;
if ( F_187 ( F_308 ( F_334 , V_34 , L_19 ,
V_34 -> V_260 ) ) ) {
F_170 ( & V_34 -> V_232 -> V_34 ,
L_24 ) ;
F_204 ( & V_34 -> V_342 , V_343 ) ;
...
static void V_234 ( struct V_405 * V_466 )
{
struct V_47 * V_34 = F_133 ( V_466 , struct V_47 , V_231 ) ;
F_339 ( V_34 ) ;
}
static void F_340 ( struct V_405 * V_46 )
{
struct V_47 * V_34 = F_133 ( V_46 , struct V_47 , V_231 ) ;
V_34 -> V_233 ( V_46 ) ;
}
static int F_341 ( struct V_232 * V_414 , const struct V_467 * V_200 )
{
int V_43 = - V_118 ;
struct V_47 * V_34 ;
...
if ( ! V_34 )
return - V_118 ;
V_34 -> V_248 = F_179 ( F_264 () , sizeof( * V_34 -> V_248 ) ,
V_255 ) ;
if ( ! V_34 -> V_248 )
goto free;
V_34 -> V_49 = F_179 ( F_264 () + 1 , sizeof( void * ) ,
V_255 ) ;
if ( ! V_34 -> V_49 )
goto free;
V_34 -> V_51 = F_342 (unsigned short) ;
if ( ! V_34 -> V_51 )
goto free;
F_160 ( & V_34 -> V_438 ) ;
V_34 -> V_233 = V_234 ;
F_343 ( & V_34 -> V_231 , F_340 ) ;
F_343 ( & V_34 -> V_406 , F_259 ) ;
V_34 -> V_232 = V_414 ;
F_344 ( V_414 , V_34 ) ;
V_43 = F_321 ( V_34 ) ;
if ( V_43 )
...
goto V_471;
V_469:
F_346 ( V_34 -> V_262 , sizeof( V_34 -> V_262 ) , L_19 , V_34 -> V_260 ) ;
V_34 -> V_463 . V_472 = V_473 ;
V_34 -> V_463 . V_474 = & V_414 -> V_34 ;
V_34 -> V_463 . V_262 = V_34 -> V_262 ;
V_34 -> V_463 . V_379 = & V_475 ;
V_43 = F_347 ( & V_34 -> V_463 ) ;
if ( V_43 )
goto remove;
V_34 -> V_240 = 1 ;
return 0 ;
...
static void F_348 ( struct V_232 * V_414 , bool V_476 )
{
struct V_47 * V_34 = F_335 ( V_414 ) ;
if ( V_476 )
F_313 ( V_34 ) ;
else
F_338 ( V_34 ) ;
}
static void F_349 ( struct V_232 * V_414 )
{
struct V_47 * V_34 = F_335 ( V_414 ) ;
F_313 ( V_34 ) ;
}
static void F_350 ( struct V_232 * V_414 )
{
struct V_47 * V_34 = F_335 ( V_414 ) ;
F_105 ( & V_351 ) ;
F_127 ( & V_34 -> V_104 ) ;
...
static int F_354 ( struct V_252 * V_34 )
{
struct V_232 * V_414 = F_355 ( V_34 ) ;
struct V_47 * V_477 = F_335 ( V_414 ) ;
F_313 ( V_477 ) ;
return 0 ;
}
static int F_356 ( struct V_252 * V_34 )
{
struct V_232 * V_414 = F_355 ( V_34 ) ;
struct V_47 * V_477 = F_335 ( V_414 ) ;
if ( F_338 ( V_477 ) && ! F_126 ( & V_477 -> V_231 ) ) {
V_477 -> V_233 = V_234 ;
F_128 ( V_235 , & V_477 -> V_231 ) ;
}
return 0 ;
}
static int T_17 F_357 ( void )
{
int V_43 ;
F_157 ( & V_465 ) ;
V_235 = F_358 ( L_18 ) ;
