...
if ( V_133 -> V_305 . V_306 )
F_33 ( V_2 , V_133 -> V_305 . V_283 ,
V_133 -> V_305 . V_284 ) ;
return 0 ;
}
...
F_32 ( V_2 , V_276 ) ;
F_1 ( V_2 ) ;
F_40 ( V_133 -> V_144 , true ) ;
F_41 ( V_133 -> V_144 ) ;
if ( F_42 ( V_133 -> V_305 . V_307 ) )
F_43 ( V_133 -> V_305 . V_307 , 0 ) ;
return 0 ;
}
...
struct V_132 * V_133 = F_7 ( V_2 ) ;
if ( F_42 ( V_133 -> V_305 . V_307 ) ) {
F_43 ( V_133 -> V_305 . V_307 , 1 ) ;
F_45 ( 400 ) ;
}
F_40 ( V_133 -> V_144 , false ) ;
F_46 ( V_133 -> V_144 ) ;
return 0 ;
}
static int F_47 ( struct V_132 * V_133 , struct V_308 * V_309 )
{
V_133 -> V_305 . V_310 = F_48 ( V_309 ,
L_14 ) ;
V_133 -> V_305 . V_311 = F_48 ( V_309 ,
L_15 ) ;
V_133 -> V_305 . V_307 = F_49 ( V_309 ,
L_16 , 0 ) ;
if ( ! F_42 ( V_133 -> V_305 . V_307 ) &&
( V_133 -> V_305 . V_307 != - V_312 ) )
return V_133 -> V_305 . V_307 ;
return 0 ;
}
static int F_50 ( struct V_313 * V_314 ,
const struct V_315 * V_208 )
{
struct V_316 * V_305 = F_51 ( & V_314 -> V_5 ) ;
struct V_132 * V_133 ;
int V_179 ;
unsigned int V_141 ;
V_133 = F_52 ( & V_314 -> V_5 ,
sizeof( struct V_132 ) ,
V_317 ) ;
if ( NULL == V_133 )
return - V_318 ;
...
if ( V_305 ) {
V_133 -> V_305 = * V_305 ;
if ( ! V_133 -> V_305 . V_307 )
V_133 -> V_305 . V_307 = - V_135 ;
} else if ( V_314 -> V_5 . V_319 ) {
V_179 = F_47 ( V_133 , V_314 -> V_5 . V_319 ) ;
if ( V_179 )
return V_179 ;
} else
V_133 -> V_305 . V_307 = - V_135 ;
V_133 -> V_144 = F_54 ( V_314 , & V_320 ) ;
if ( F_55 ( V_133 -> V_144 ) ) {
V_179 = F_56 ( V_133 -> V_144 ) ;
F_9 ( & V_314 -> V_5 , L_17 ,
V_179 ) ;
return V_179 ;
}
if ( F_42 ( V_133 -> V_305 . V_307 ) ) {
V_179 = F_57 ( & V_314 -> V_5 , V_133 -> V_305 . V_307 ,
V_321 ,
L_18 ) ;
if ( V_179 < 0 ) {
F_9 ( & V_314 -> V_5 , L_19 ,
V_133 -> V_305 . V_307 , V_179 ) ;
return V_179 ;
}
F_45 ( 400 ) ;
}
F_58 ( V_133 -> V_144 , V_27 , & V_141 ) ;
if ( V_141 != V_322 ) {
F_9 ( & V_314 -> V_5 ,
L_20 , V_141 ) ;
return - V_304 ;
...
V_179 = F_59 ( V_133 -> V_144 , V_323 ,
F_4 ( V_323 ) ) ;
if ( V_179 != 0 )
F_60 ( & V_314 -> V_5 , L_21 , V_179 ) ;
if ( V_133 -> V_305 . V_310 )
F_14 ( V_133 -> V_144 , V_32 ,
V_324 , V_324 ) ;
if ( V_133 -> V_305 . V_311 )
F_14 ( V_133 -> V_144 , V_33 ,
V_325 , V_325 ) ;
V_133 -> V_176 = 1 ;
return F_61 ( & V_314 -> V_5 , & V_326 ,
V_327 , F_4 ( V_327 ) ) ;
}
static int F_62 ( struct V_313 * V_314 )
{
F_63 ( & V_314 -> V_5 ) ;
return 0 ;
}
