...
struct V_12 * F_40 ( struct V_1 * V_1 , struct V_22 * V_23 ,
const struct V_2 * V_40 , const T_2 V_41 ,
const struct V_2 * V_42 , const T_2 V_66 ,
const int V_44 )
{
struct V_12 * V_13 ;
F_41 () ;
V_13 = F_42 ( V_1 , V_23 , V_40 , V_41 , V_42 , F_43 ( V_66 ) , V_44 ) ;
F_44 () ;
return V_13 ;
}
...
V_15 -> V_19 ) ;
struct F_16 * V_33 = F_16 ( V_70 , V_34 ) ;
T_7 * V_32 = F_17 ( V_70 , V_34 ) ;
struct V_12 * V_71 ;
const struct V_45 * V_46 ;
...
if ( V_71 -> V_37 != V_34 )
continue;
if ( F_46 ( F_24 ( V_71 , V_1 , V_40 , V_42 , V_47 , V_44 ) ) ) {
if ( V_71 -> V_27 == V_72 ) {
V_21 = F_47 ( V_71 ) ;
if ( F_48 ( V_13 , V_71 , V_69 ) )
break;
}
goto V_73;
}
...
static inline T_3 F_53 ( const struct V_12 * V_13 )
{
const struct V_14 * V_15 = F_7 ( V_13 ) ;
return F_54 ( V_13 -> V_16 . V_11 ,
V_13 -> V_17 . V_11 ,
V_15 -> V_19 ) ;
}
int F_55 ( struct V_67 * V_68 ,
struct V_12 * V_13 )
{
return F_56 ( V_68 , V_13 , F_53 ( V_13 ) ,
F_45 , F_9 ) ;
}
