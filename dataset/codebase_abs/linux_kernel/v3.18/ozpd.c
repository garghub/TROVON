...
{
struct V_1 * V_2 = F_9 ( sizeof( struct V_1 ) , V_11 ) ;
if ( V_2 ) {
int V_12 ;
F_10 ( & V_2 -> V_9 , 2 ) ;
...
for ( V_12 = 0 ; V_12 < V_13 ; V_12 ++ ) {
if ( V_53 [ V_12 ] . V_54 && ( V_49 & ( 1 << V_12 ) ) ) {
if ( V_53 [ V_12 ] . V_54 ( V_2 , V_50 ) ) {
V_51 = - 1 ;
F_2 ( V_2 , V_5 ,
L_8 , V_12 ) ;
break;
...
int V_12 , V_60 = 0 ;
for ( V_12 = 0 ; V_12 < V_13 ; V_12 ++ ) {
if ( V_53 [ V_12 ] . V_29 && ( V_49 & ( 1 << V_12 ) ) ) {
if ( V_53 [ V_12 ] . V_29 ( V_2 ) )
V_60 = 1 ;
}
}
...
struct V_94 * V_95 ;
struct V_96 * V_97 ;
V_46 = F_63 ( V_45 -> V_70 + F_64 ( V_93 ) , V_11 ) ;
if ( V_46 == NULL )
return NULL ;
F_65 ( V_46 , F_66 ( V_93 ) ) ;
F_67 ( V_46 ) ;
