...
static void F_41 ( struct V_117 * V_84 , struct V_50 * V_51 )
{
...
static void F_52 ( struct V_117 * V_84 , struct V_133 * V_134 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
...
static T_5
F_55 ( int V_144 , void * V_84 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
T_4 V_145 = F_56 ( V_2 -> V_136 -> V_146 , ( T_4 ) 100 ) ;
F_57 ( V_84 , F_58 ( V_145 ) ) ;
return V_147 ;
}
...
F_63 ( & V_3 -> V_48 , V_84 ) ;
V_2 -> V_6 = F_60 ( sizeof( * V_2 -> V_6 ) , V_155 ) ;
if ( ! V_2 -> V_6 )
goto V_172;
...
V_2 -> V_5 . V_65 = 1 ;
if ( V_2 -> V_136 && V_2 -> V_136 -> V_175 ) {
V_5 = V_2 -> V_136 -> V_175 ( & V_3 -> V_48 , F_55 , V_84 ) ;
if ( V_5 != 0 )
goto V_176;
}
if ( V_2 -> V_136 ) {
V_84 -> V_164 |= V_2 -> V_136 -> V_164 ;
V_84 -> V_177 |= V_2 -> V_136 -> V_177 ;
}
V_5 = F_65 ( V_84 ) ;
if ( V_5 != 0 )
goto V_178;
if ( V_2 -> V_136 && V_2 -> V_136 -> V_55 & V_179 ) {
V_5 = F_66 ( V_84 , V_2 -> V_136 -> V_180 ,
V_2 -> V_136 -> V_181 ) ;
if ( V_5 != 0 )
goto V_178;
F_67 ( V_84 ) ;
}
if ( V_2 -> V_136 && V_2 -> V_136 -> V_55 & V_182 ) {
V_148 = true ;
V_5 = F_68 ( V_84 , V_2 -> V_136 -> V_183 ) ;
if ( V_5 != 0 )
goto V_178;
}
F_69 ( & V_3 -> V_48 , L_38 ,
...
static int F_76 ( struct V_82 * V_3 )
{
struct V_117 * V_84 = F_77 ( & V_3 -> V_48 ) ;
struct V_1 * V_2 ;
if ( V_84 ) {
V_2 = F_42 ( V_84 ) ;
