...
const struct V_78 * V_77 , const char * V_71 , ... )
{
struct V_72 V_73 ;
T_2 args ;
F_3 ( ! V_70 ) ;
...
static T_4 F_43 ( struct V_82 * V_82 , const char T_5 * V_83 ,
T_1 V_84 , T_6 * V_85 )
{
char * V_86 ;
int V_87 ;
...
V_86 = F_44 ( V_84 + 1 , V_90 ) ;
if ( ! V_86 )
return - V_91 ;
if ( F_45 ( V_86 , V_83 , V_84 ) ) {
F_46 ( V_86 ) ;
return - V_92 ;
}
V_86 [ V_84 ] = '\0' ;
...
static struct V_3 * F_47 ( struct V_93 * V_94 )
{
if ( F_48 ( & V_95 ) ) {
V_94 -> V_96 = NULL ;
V_94 -> V_97 = 0 ;
...
V_94 -> V_96 = F_49 ( V_95 . V_98 ,
struct V_24 , V_99 ) ;
V_94 -> V_97 = 0 ;
return & V_94 -> V_96 -> V_32 [ V_94 -> V_97 ] ;
}
static struct V_3 * F_50 ( struct V_93 * V_94 )
{
if ( V_94 -> V_96 == NULL )
return NULL ;
if ( ++ V_94 -> V_97 == V_94 -> V_96 -> V_31 ) {
V_94 -> V_97 = 0 ;
if ( F_51 ( & V_94 -> V_96 -> V_99 , & V_95 ) ) {
V_94 -> V_96 = NULL ;
return NULL ;
}
V_94 -> V_96 = F_49 ( V_94 -> V_96 -> V_99 . V_98 ,
struct V_24 , V_99 ) ;
}
return & V_94 -> V_96 -> V_32 [ V_94 -> V_97 ] ;
}
static void * F_52 ( struct V_100 * V_101 , T_6 * V_64 )
{
struct V_93 * V_94 = V_101 -> V_102 ;
struct V_3 * V_4 ;
int V_103 = * V_64 ;
F_6 ( L_50 , V_101 , ( unsigned long long ) * V_64 ) ;
F_8 ( & V_29 ) ;
if ( ! V_103 )
return V_104 ;
if ( V_103 < 0 )
...
static void * F_53 ( struct V_100 * V_101 , void * V_7 , T_6 * V_64 )
{
struct V_93 * V_94 = V_101 -> V_102 ;
struct V_3 * V_4 ;
F_6 ( L_51 ,
V_101 , V_7 , ( unsigned long long ) * V_64 ) ;
if ( V_7 == V_104 )
V_4 = F_47 ( V_94 ) ;
else
V_4 = F_50 ( V_94 ) ;
...
static int F_54 ( struct V_100 * V_101 , void * V_7 )
{
struct V_93 * V_94 = V_101 -> V_102 ;
struct V_3 * V_4 = V_7 ;
char V_105 [ 10 ] ;
...
F_57 ( V_101 , V_4 -> V_17 , L_55 ) ;
F_55 ( V_101 , L_56 ) ;
return 0 ;
}
static void F_58 ( struct V_100 * V_101 , void * V_7 )
{
F_6 ( L_52 , V_101 , V_7 ) ;
F_12 ( & V_29 ) ;
}
static int F_59 ( struct V_106 * V_106 , struct V_82 * V_82 )
{
F_6 ( L_57 ) ;
return F_60 ( V_82 , & V_107 ,
sizeof( struct V_93 ) ) ;
}
int F_61 ( struct V_3 * V_108 , unsigned int V_103 ,
const char * V_45 )
{
struct V_24 * V_25 ;
char * V_109 ;
V_25 = F_62 ( sizeof( * V_25 ) , V_90 ) ;
if ( V_25 == NULL )
return - V_91 ;
V_109 = F_63 ( V_45 , V_90 ) ;
if ( V_109 == NULL ) {
F_46 ( V_25 ) ;
return - V_91 ;
}
...
F_64 ( & V_25 -> V_99 , & V_95 ) ;
F_12 ( & V_29 ) ;
F_6 ( L_58 , V_103 , V_25 -> V_30 ) ;
return 0 ;
}
static int F_65 ( char * V_110 , char * V_42 ,
...
{
F_6 ( L_61 , V_110 , V_42 ) ;
return F_65 ( V_110 , V_42 , NULL , 0 ) ;
}
int F_67 ( char * V_110 , char * V_42 , const char * V_20 )
{
F_6 ( L_62 , V_20 , V_110 , V_42 ) ;
return F_65 ( V_110 , V_42 , V_20 , - V_114 ) ;
}
...
F_8 ( & V_29 ) ;
while ( ! F_48 ( & V_95 ) ) {
struct V_24 * V_25 = F_49 ( V_95 . V_98 ,
struct V_24 ,
V_99 ) ;
F_68 ( V_25 ) ;
}
...
if ( ! V_118 )
return - V_119 ;
V_117 = F_74 ( L_64 , NULL ) ;
if ( ! V_117 )
return - V_91 ;
V_82 = F_75 ( L_65 , 0644 , V_117 , NULL ,
& V_120 ) ;
if ( ! V_82 ) {
F_76 ( V_117 ) ;
return - V_91 ;
...
{
struct V_3 * V_94 , * V_121 ;
const char * V_47 = NULL ;
char * V_122 ;
int V_87 = 0 ;
int V_103 = 0 , V_123 = 0 , V_124 = 0 ;
int V_125 = 0 ;
if ( V_126 == V_127 ) {
F_41 ( L_66 ) ;
return 1 ;
...
for (; V_94 < V_127 ; V_94 ++ ) {
V_123 ++ ;
V_125 += strlen ( V_94 -> V_47 ) + strlen ( V_94 -> V_18 )
+ strlen ( V_94 -> V_19 ) + strlen ( V_94 -> V_17 ) ;
if ( strcmp ( V_47 , V_94 -> V_47 ) ) {
V_124 ++ ;
V_87 = F_61 ( V_121 , V_103 , V_47 ) ;
if ( V_87 )
goto V_128;
V_103 = 0 ;
V_47 = V_94 -> V_47 ;
...
V_118 = 1 ;
F_6 ( L_67 ,
V_124 , V_123 , ( int ) ( V_124 * sizeof( struct V_24 ) ) ,
...
V_122 = F_63 ( V_129 , V_90 ) ;
F_78 ( L_71 , V_122 , NULL ,
0 , 0 , 0 , & F_66 ) ;
F_46 ( V_122 ) ;
return 0 ;
V_128:
