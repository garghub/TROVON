...
static struct V_6 *
F_38 ( struct V_20 * V_21 , unsigned char V_103 ) {
struct V_6 * V_105 ;
...
V_21 -> V_63 = F_45 ( sizeof( struct V_61 ) , V_79 ) ;
if ( ! V_21 -> V_63 )
return - V_81 ;
V_21 -> V_126 = F_42 ;
F_4 () ;
...
static int F_47 ( struct V_127 * V_83 , struct V_20 * V_21 )
{
int V_128 ;
F_16 ( V_21 , L_64 , ( V_129 ) V_83 -> V_130 -> V_131 ) ;
switch ( V_83 -> V_130 -> V_131 ) {
case 0 :
V_128 = F_48 ( V_83 , V_21 ) ;
break;
case 1 :
V_83 -> V_130 -> V_131 = 0 ;
V_128 = F_49 ( V_83 , V_21 ) ;
V_83 -> V_130 -> V_131 = 1 ;
break;
default:
F_16 ( V_21 , L_65 , ( V_129 ) V_83 -> V_130 -> V_131 ) ;
V_128 = V_132 ;
break;
}
return V_128 ;
}
static int F_49 ( struct V_127 * V_83 , struct V_20 * V_21 )
{
...
V_135 = 1 ;
if ( V_83 -> V_138 [ 0 ] == V_141 ) {
memcpy ( V_89 , V_136 , 8 ) ;
F_51 ( V_21 , V_89 , 36 ) ;
return V_140 ;
}
if ( V_83 -> V_138 [ 0 ] == V_142 ) {
struct V_6 * V_105 ;
F_36 ( V_21 , V_62 ) ;
V_105 = F_38 ( V_21 , V_62 -> V_103 ) ;
if ( ! V_105 ) {
V_143:
V_133 = 0x02 ;
V_134 = 0x3a ;
...
( ( V_145 * ) V_89 ) [ 0 ] = F_52 ( V_76 ) ;
( ( V_145 * ) V_89 ) [ 1 ] = F_52 ( V_62 -> V_78 ) ;
F_50 ( V_89 , 8 , V_83 ) ;
return V_140 ;
}
if ( V_83 -> V_138 [ 0 ] == V_146 ) {
int V_147 = ( V_83 -> V_138 [ 2 ] & 0x3F ) ;
if ( V_147 == 0x01 || V_147 == 0x3F ) {
F_16 ( V_21 , L_66 ,
V_147 ) ;
memcpy ( V_89 , V_137 , sizeof( V_137 ) ) ;
( ( V_148 * ) V_89 ) [ 0 ] = F_53 ( sizeof( V_137 ) - 2 ) ;
V_89 [ 3 ] = ( V_62 -> V_103 & V_104 ) ? 0x80 : 0 ;
F_50 ( V_89 , sizeof( V_137 ) , V_83 ) ;
return V_140 ;
}
V_133 = 0x05 ;
V_134 = 0x24 ;
...
if ( V_83 -> V_138 [ 0 ] == V_149 )
return V_140 ;
V_135 = 0 ;
if ( V_83 -> V_138 [ 0 ] == V_150 ) {
V_68 = F_41 ( V_83 -> V_138 [ 3 ] , V_83 -> V_138 [ 2 ] ) ;
V_68 <<= 16 ;
V_68 |= F_41 ( V_83 -> V_138 [ 5 ] , V_83 -> V_138 [ 4 ] ) ;
V_69 = F_41 ( V_83 -> V_138 [ 8 ] , V_83 -> V_138 [ 7 ] ) ;
F_16 ( V_21 , L_67 ,
V_68 , V_69 ) ;
...
for (; V_83 -> V_153 < 12 ; V_83 -> V_153 ++ )
V_83 -> V_138 [ V_83 -> V_153 ] = 0 ;
V_83 -> V_138 [ 1 ] = V_43 ;
V_89 [ 0 ] = 0 ;
for ( V_8 = 0 ; V_8 < 12 ; V_8 ++ )
sprintf ( V_89 + strlen ( V_89 ) , L_69 , V_83 -> V_138 [ V_8 ] ) ;
F_16 ( V_21 , L_70 , V_89 ) ;
V_42 = F_10 ( V_21 , V_83 -> V_138 , 12 ) ;
if ( V_42 ) {
F_16 ( V_21 , L_71 ,
V_42 ) ;
return V_132 ;
...
if ( V_83 -> V_154 == V_155 ||
V_83 -> V_154 == V_156 ) {
unsigned int V_26 = ( V_83 -> V_154 == V_155 )
? V_21 -> V_57 : V_21 -> V_44 ;
F_16 ( V_21 , L_72 ,
( V_83 -> V_154 == V_155 ) ?
L_73 : L_74 ,
F_54 ( V_83 ) ) ;
V_42 = F_55 ( V_21 , V_26 , V_83 ) ;
return ( V_42 == V_32 ?
V_140 : V_132 ) ;
}
return V_140 ;
