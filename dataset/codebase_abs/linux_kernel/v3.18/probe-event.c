...
static int F_115 ( int V_61 , bool V_72 )
{
int V_4 = 0 ;
struct V_50 V_162 ;
struct V_83 V_84 ;
...
static struct V_189 * F_118 ( int V_61 , bool V_197 )
{
char V_46 [ 128 ] ;
...
static int F_119 ( int V_61 , struct V_50 * V_162 )
{
int V_4 = 0 ;
...
F_4 ( L_147 , V_46 ) ;
if ( ! V_186 ) {
V_4 = F_120 ( V_61 , V_46 , strlen ( V_46 ) ) ;
if ( V_4 <= 0 )
F_7 ( L_148 ,
F_58 ( V_64 , V_103 , sizeof( V_103 ) ) ) ;
}
...
static int F_121 ( char * V_46 , T_1 V_173 , const char * V_198 ,
...
V_199 = F_118 ( V_61 , false ) ;
if ( ! V_199 ) {
F_4 ( L_154 ) ;
return - V_203 ;
}
V_4 = 0 ;
printf ( L_155 , ( V_52 > 1 ) ? L_156 : L_98 ) ;
for ( V_53 = 0 ; V_53 < V_52 ; V_53 ++ ) {
V_162 = & V_51 [ V_53 ] ;
if ( V_84 -> V_145 )
V_145 = V_84 -> V_145 ;
...
static int F_124 ( struct V_15 * V_15 V_132 ,
struct V_13 * V_24 )
{
if ( ( V_24 -> V_204 == V_205 || V_24 -> V_204 == V_206 ) &&
strcmp ( V_207 , V_24 -> V_14 ) == 0 ) {
V_208 ++ ;
return 0 ;
}
return 1 ;
}
static int F_125 ( struct V_83 * V_84 ,
struct V_50 * * V_51 ,
int V_85 , const char * V_86 )
{
...
if ( V_23 ) {
V_69 -> V_13 = F_127 ( V_23 -> V_14 , V_210 ) ;
V_69 -> V_75 = V_69 -> V_57 - V_23 -> V_17 ;
} else {
V_69 -> V_13 = F_127 ( V_24 -> V_14 , V_210 ) ;
V_69 -> V_75 = V_71 -> V_75 ;
}
V_69 -> V_78 = V_71 -> V_78 ;
if ( V_86 )
V_162 -> V_79 . V_28 = F_127 ( V_86 , V_210 ) ;
...
F_127 ( V_84 -> args [ V_53 ] . V_14 ,
V_210 ) ;
V_162 -> args [ V_53 ] . V_171 = F_127 ( V_84 -> args [ V_53 ] . V_127 ,
V_210 ) ;
if ( V_84 -> args [ V_53 ] . type )
V_162 -> args [ V_53 ] . type =
F_127 ( V_84 -> args [ V_53 ] . type ,
V_210 ) ;
}
}
V_10:
...
if ( V_4 != 0 )
return V_4 ;
return F_125 ( V_84 , V_51 , V_85 , V_86 ) ;
}
int F_129 ( struct V_83 * V_130 , int V_131 ,
int V_85 , const char * V_86 , bool V_211 )
{
int V_53 , V_212 , V_4 ;
struct V_213 * V_214 ;
V_4 = 0 ;
V_214 = F_87 ( sizeof( struct V_213 ) * V_131 ) ;
if ( V_214 == NULL )
return - V_47 ;
V_4 = F_2 ( V_130 -> V_80 ) ;
if ( V_4 < 0 ) {
...
V_214 [ V_53 ] . V_84 = & V_130 [ V_53 ] ;
V_4 = F_128 ( V_214 [ V_53 ] . V_84 ,
& V_214 [ V_53 ] . V_51 ,
V_85 ,
V_86 ) ;
if ( V_4 < 0 )
...
for ( V_53 = 0 ; V_53 < V_131 ; V_53 ++ ) {
V_4 = F_123 ( V_214 [ V_53 ] . V_84 , V_214 [ V_53 ] . V_51 ,
V_214 [ V_53 ] . V_52 , V_211 ) ;
if ( V_4 < 0 )
break;
}
V_113:
for ( V_53 = 0 ; V_53 < V_131 ; V_53 ++ ) {
for ( V_212 = 0 ; V_212 < V_214 [ V_53 ] . V_52 ; V_212 ++ )
F_32 ( & V_214 [ V_53 ] . V_51 [ V_212 ] ) ;
F_52 ( & V_214 [ V_53 ] . V_51 ) ;
}
free ( V_214 ) ;
F_8 () ;
return V_4 ;
}
static int F_130 ( int V_61 , struct V_122 * V_194 )
{
char * V_164 ;
char V_46 [ 128 ] ;
int V_4 ;
...
static int F_131 ( int V_61 , const char * V_46 ,
struct V_189 * V_199 )
{
struct V_122 * V_194 , * V_215 ;
int V_4 = - 1 ;
if ( strpbrk ( V_46 , L_168 ) ) {
F_132 (ent, n, namelist)
if ( F_133 ( V_194 -> V_129 , V_46 ) ) {
V_4 = F_130 ( V_61 , V_194 ) ;
if ( V_4 < 0 )
break;
F_134 ( V_199 , V_194 ) ;
}
} else {
V_194 = F_135 ( V_199 , V_46 ) ;
if ( V_194 ) {
V_4 = F_130 ( V_61 , V_194 ) ;
if ( V_4 >= 0 )
F_134 ( V_199 , V_194 ) ;
...
int F_136 ( struct V_189 * V_216 )
{
int V_4 = - 1 , V_217 = - 1 , V_218 = - 1 ;
char V_46 [ 128 ] ;
const char * V_146 , * V_145 ;
char * V_164 , * V_1 ;
struct V_122 * V_194 ;
struct V_189 * V_199 = NULL , * V_219 = NULL ;
V_218 = F_108 ( true ) ;
if ( V_218 >= 0 )
V_199 = F_118 ( V_218 , true ) ;
V_217 = F_109 ( true ) ;
if ( V_217 >= 0 )
V_219 = F_118 ( V_217 , true ) ;
if ( V_218 < 0 && V_217 < 0 ) {
F_105 ( V_218 , V_217 ) ;
goto error;
}
if ( V_199 == NULL && V_219 == NULL )
goto error;
F_71 (ent, dellist) {
...
if ( V_199 )
V_4 = F_131 ( V_218 , V_46 , V_199 ) ;
if ( V_219 && V_4 != 0 )
V_4 = F_131 ( V_217 , V_46 , V_219 ) ;
if ( V_4 != 0 )
F_137 ( L_173 , V_46 ) ;
free ( V_1 ) ;
}
