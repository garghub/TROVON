...
int F_15 ( struct V_1 * V_2 , struct V_3 * V_4 , union V_5 * V_6 , char * V_7 )
{
int V_51 , V_8 = 0 ;
unsigned long V_34 ;
if ( V_2 -> V_13 == V_38 )
...
void F_22 ( struct V_72 * V_73 )
{
struct V_1 * V_2 = F_23 ( V_73 , struct V_1 , V_74 ) ;
short V_75 ;
T_2 V_76 = 0 ;
T_3 V_77 = 0 ;
int V_78 = 0 ;
...
union V_5 * V_6 , char * V_33 )
{
F_34 ( V_6 -> V_107 , L_6 , V_108 ) ;
if ( V_2 -> V_109 & V_110 ) {
F_35 ( V_6 -> V_107 , L_7 , V_108 ) ;
if ( V_2 -> V_109 & V_111 )
F_35 ( V_6 -> V_107 , L_8 , V_108 ) ;
} else if ( V_2 -> V_109 & V_111 ) {
F_35 ( V_6 -> V_107 , L_9 , V_108 ) ;
}
if ( V_2 -> V_70 & ( V_112 | V_113 ) )
F_35 ( V_6 -> V_107 , L_10 , V_108 ) ;
if ( ( V_2 -> V_30 == V_31 ) ||
( V_2 -> V_30 == V_40 ) )
F_35 ( V_6 -> V_107 , L_11 , V_108 ) ;
else if ( V_2 -> V_30 != V_114 )
F_35 ( V_6 -> V_107 , L_12 , V_108 ) ;
return 0 ;
}
