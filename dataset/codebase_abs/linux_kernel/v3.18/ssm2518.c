...
static int F_22 ( struct V_14 * V_15 , int V_96 ,
...
static bool F_23 ( struct V_108 * V_109 , unsigned int V_110 )
{
return false ;
}
static int F_24 ( struct V_111 * V_112 ,
const struct V_113 * V_114 )
{
struct V_115 * V_116 = V_112 -> V_109 . V_117 ;
struct V_1 * V_1 ;
int V_19 ;
V_1 = F_25 ( & V_112 -> V_109 , sizeof( * V_1 ) , V_118 ) ;
if ( V_1 == NULL )
return - V_119 ;
if ( V_116 ) {
V_1 -> V_63 = V_116 -> V_63 ;
} else if ( V_112 -> V_109 . V_120 ) {
V_1 -> V_63 = F_26 ( V_112 -> V_109 . V_120 , 0 ) ;
...
if ( F_13 ( V_1 -> V_63 ) ) {
V_19 = F_27 ( & V_112 -> V_109 , V_1 -> V_63 ,
V_122 , L_1 ) ;
if ( V_19 )
return V_19 ;
}
F_28 ( V_112 , V_1 ) ;
V_1 -> V_29 = F_29 ( V_112 , & V_123 ) ;
if ( F_30 ( V_1 -> V_29 ) )
...
if ( V_19 )
return V_19 ;
return F_33 ( & V_112 -> V_109 , & V_126 ,
& V_127 , 1 ) ;
}
static int F_34 ( struct V_111 * V_128 )
{
F_35 ( & V_128 -> V_109 ) ;
return 0 ;
}
