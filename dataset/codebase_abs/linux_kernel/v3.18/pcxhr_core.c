...
( long ) ( V_126 . V_129 - V_125 . V_129 ) , V_16 ) ;
#endif
return 0 ;
}
...
V_16 ) ;
V_7 = 1 ;
while ( V_7 < V_146 -> V_81 ) {
int V_156 = ( ( V_146 -> V_89 [ V_7 ] >> V_107 ) &
V_106 ) ;
int V_157 = ( ( V_146 -> V_89 [ V_7 ] >> ( 2 * V_107 ) ) &
V_106 ) ;
int V_137 = V_146 -> V_89 [ V_7 ] & V_106 ;
int V_138 = V_146 -> V_89 [ V_7 ] & 0x400000 ;
T_1 V_158 ;
if ( V_146 -> V_89 [ V_7 ] & 0x800000 ) {
F_3 ( & V_2 -> V_11 -> V_12 ,
L_41 ,
V_138 ? L_33 : L_34 ,
V_137 ) ;
...
V_7 ++ ;
V_158 = V_146 -> V_89 [ V_7 ] ? V_146 -> V_89 [ V_7 ] : V_146 -> V_89 [ V_7 + 1 ] ;
if ( V_158 )
F_39 ( V_2 , V_158 ,
V_140 ,
V_137 , V_138 ) ;
V_7 += 2 ;
for ( V_147 = 0 ; V_147 < V_157 ; V_147 ++ ) {
V_158 = V_146 -> V_89 [ V_7 ] ?
V_146 -> V_89 [ V_7 ] : V_146 -> V_89 [ V_7 + 1 ] ;
if ( V_158 )
F_39 ( V_2 , V_158 ,
V_141 ,
V_137 ,
...
struct V_77 V_78 ;
int V_16 , V_162 ;
V_162 = V_160 -> V_137 -> V_138 ? 1 : 1 << V_160 -> V_163 -> V_164 ;
F_26 ( & V_78 , V_165 ) ;
F_27 ( & V_78 , V_160 -> V_137 -> V_138 ,
V_160 -> V_137 -> V_166 , 0 , V_162 ) ;
V_16 = F_28 ( V_2 , & V_78 ) ;
if ( V_16 )
return 0 ;
V_161 = ( ( T_2 ) V_78 . V_89 [ 0 ] ) << 24 ;
V_161 += ( T_2 ) V_78 . V_89 [ 1 ] ;
F_3 ( & V_2 -> V_11 -> V_12 ,
L_42 ,
V_160 -> V_137 -> V_138 ? 'C' : 'P' ,
V_160 -> V_163 -> V_164 ,
V_161 ,
...
int V_174 = 0 ;
int V_175 = 0 ;
struct V_176 * V_177 = V_160 -> V_163 -> V_177 ;
if ( V_170 < 0 ) {
V_160 -> V_178 = 0 ;
V_170 = V_2 -> V_169 ;
}
...
while ( 1 ) {
T_2 V_180 = V_160 -> V_167 +
V_177 -> V_179 ;
if ( V_180 > V_173 )
break;
V_174 = 1 ;
V_160 -> V_181 ++ ;
if ( V_160 -> V_181 >= V_177 -> V_182 )
V_160 -> V_181 = 0 ;
V_160 -> V_167 = V_180 ;
}
if ( V_173 >= V_160 -> V_167 ) {
V_160 -> V_168 =
( V_183 ) ( V_173 -
V_160 -> V_167 ) ;
} else {
...
#endif
return V_187 ? V_198 : V_199 ;
}
T_3 F_45 ( int V_185 , void * V_186 )
{
struct V_1 * V_2 = V_186 ;
int V_7 , V_147 ;
struct V_200 * V_201 ;
...
int V_202 =
F_8 ( V_2 , V_203 ) & V_204 ;
int V_205 = V_202 - V_2 -> V_195 ;
if ( ( V_205 < 0 ) &&
( V_2 -> V_195 != V_196 ) ) {
int V_206 = V_205 + V_204 + 1 ;
F_3 ( & V_2 -> V_11 -> V_12 ,
L_46 ,
V_2 -> V_195 , V_202 ) ;
if ( V_206 > 0 && V_206 <= ( 2 * V_2 -> V_169 ) ) {
F_3 ( & V_2 -> V_11 -> V_12 ,
L_47
L_48 , V_206 ) ;
V_205 = V_206 ;
...
L_50 ,
V_202 ) ;
else if ( V_205 >= ( 2 * V_2 -> V_169 ) )
F_3 ( & V_2 -> V_11 -> V_12 ,
L_51 ,
V_2 -> V_195 ,
V_202 - V_2 -> V_195 ) ;
else if ( V_205 % V_2 -> V_169 )
F_3 ( & V_2 -> V_11 -> V_12 ,
L_52 ,
V_205 ) ;
#endif
V_2 -> V_195 = V_202 ;
for ( V_7 = 0 ; V_7 < V_2 -> V_207 ; V_7 ++ ) {
V_201 = V_2 -> V_201 [ V_7 ] ;
for ( V_147 = 0 ; V_147 < V_201 -> V_208 ; V_147 ++ )
F_42 ( V_2 ,
& V_201 -> V_209 [ V_147 ] ,
V_205 ) ;
}
for ( V_7 = 0 ; V_7 < V_2 -> V_207 ; V_7 ++ ) {
V_201 = V_2 -> V_201 [ V_7 ] ;
for ( V_147 = 0 ; V_147 < V_201 -> V_210 ; V_147 ++ )
F_42 ( V_2 ,
& V_201 -> V_211 [ V_147 ] ,
V_205 ) ;
}
