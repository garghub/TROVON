...
goto V_490;
if ( F_280 ( F_281 ( V_4 , V_480 ) , V_264 -> V_491 , V_480 ) )
goto V_490;
...
if ( F_233 ( V_30 ) == 0 )
goto V_494;
if ( V_30 -> V_495 . V_496 == V_497 &&
V_30 -> V_78 == V_30 -> V_90 && V_30 -> V_495 . V_10 &&
F_285 ( V_2 ) && ! V_30 -> V_498 ) {
int V_499 = F_43 (unsigned int, skb->len,
tp->ucopy.len) ;
F_286 ( V_500 ) ;
F_287 () ;
if ( ! F_288 ( V_4 , 0 , V_30 -> V_495 . V_501 , V_499 ) ) {
V_30 -> V_495 . V_10 -= V_499 ;
V_30 -> V_78 += V_499 ;
V_478 = ( V_499 == V_4 -> V_10 ) ;
F_48 ( V_2 ) ;
}
F_289 () ;
}
...
static void
F_291 ( struct V_1 * V_2 , struct V_504 * V_505 ,
struct V_3 * V_507 , struct V_3 * V_477 ,
T_1 V_508 , T_1 V_484 )
{
...
if ( ! F_273 ( V_505 , V_4 ) ) {
struct V_3 * V_345 = F_274 ( V_505 , V_4 ) ;
if ( V_345 != V_477 &&
...
return;
while ( F_46 ( V_508 , V_484 ) ) {
int V_512 = F_43 ( int , F_293 ( 0 , 0 ) , V_484 - V_508 ) ;
struct V_3 * V_513 ;
V_513 = F_279 ( V_512 , V_171 ) ;
if ( ! V_513 )
return;
memcpy ( V_513 -> V_514 , V_4 -> V_514 , sizeof( V_4 -> V_514 ) ) ;
F_16 ( V_513 ) -> V_77 = F_16 ( V_513 ) -> V_92 = V_508 ;
F_294 ( V_505 , V_4 , V_513 ) ;
F_275 ( V_513 , V_2 ) ;
while ( V_512 > 0 ) {
int V_515 = V_508 - F_16 ( V_4 ) -> V_77 ;
int V_480 = F_16 ( V_4 ) -> V_92 - V_508 ;
F_92 ( V_515 < 0 ) ;
if ( V_480 > 0 ) {
V_480 = F_9 ( V_512 , V_480 ) ;
if ( F_295 ( V_4 , V_515 , F_281 ( V_513 , V_480 ) , V_480 ) )
F_296 () ;
F_16 ( V_513 ) -> V_92 += V_480 ;
V_512 -= V_480 ;
V_508 += V_480 ;
}
if ( ! F_46 ( V_508 , F_16 ( V_4 ) -> V_92 ) ) {
...
static void F_305 ( struct V_1 * V_2 , int V_524 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
if ( ( ( V_30 -> V_90 - V_30 -> V_371 ) > F_2 ( V_2 ) -> V_8 . V_12 &&
F_306 ( V_2 ) >= V_30 -> V_23 ) ||
F_11 ( V_2 ) ||
( V_524 && F_258 ( & V_30 -> V_455 ) ) ) {
F_208 ( V_2 ) ;
} else {
F_307 ( V_2 ) ;
}
...
return;
if ( V_30 -> V_498 && ! F_53 ( V_208 , V_30 -> V_527 ) )
return;
F_311 ( V_2 ) ;
if ( V_30 -> V_527 == V_30 -> V_78 && V_30 -> V_498 &&
! F_236 ( V_2 , V_528 ) && V_30 -> V_78 != V_30 -> V_90 ) {
...
F_310 ( V_2 , V_43 ) ;
if ( V_30 -> V_498 == V_529 ) {
T_1 V_208 = V_30 -> V_527 - F_227 ( V_43 -> V_77 ) + ( V_43 -> V_399 * 4 ) -
V_43 -> V_45 ;
if ( V_208 < V_4 -> V_10 ) {
T_4 V_203 ;
if ( F_295 ( V_4 , V_208 , & V_203 , 1 ) )
F_296 () ;
V_30 -> V_498 = V_531 | V_203 ;
if ( ! F_236 ( V_2 , V_442 ) )
V_2 -> V_503 ( V_2 ) ;
}
}
}
static int F_313 ( struct V_1 * V_2 , struct V_3 * V_4 , int V_532 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
int V_499 = V_4 -> V_10 - V_532 ;
int V_166 ;
F_287 () ;
if ( F_314 ( V_4 ) )
V_166 = F_288 ( V_4 , V_532 , V_30 -> V_495 . V_501 , V_499 ) ;
else
V_166 = F_315 ( V_4 , V_532 ,
V_30 -> V_495 . V_501 ) ;
if ( ! V_166 ) {
V_30 -> V_495 . V_10 -= V_499 ;
V_30 -> V_78 += V_499 ;
...
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
if ( F_104 ( V_2 -> V_541 == NULL ) )
F_2 ( V_2 ) -> V_542 -> V_543 ( V_2 , V_4 ) ;
V_30 -> V_49 . V_263 = 0 ;
if ( ( F_5 ( V_43 ) & V_544 ) == V_30 -> V_362 &&
...
if ( ! F_236 ( V_2 , V_442 ) ) {
V_2 -> V_456 ( V_2 ) ;
F_244 ( V_2 , V_556 , V_557 ) ;
}
}
static bool F_329 ( struct V_1 * V_2 , struct V_3 * V_558 ,
struct V_396 * V_559 )
{
struct V_29 * V_30 = F_7 ( V_2 ) ;
struct V_3 * V_13 = V_30 -> V_560 ? F_105 ( V_2 ) : NULL ;
T_6 V_66 = V_30 -> V_49 . V_50 ;
bool V_561 ;
if ( V_66 == V_30 -> V_49 . V_407 ) {
struct V_393 V_562 ;
F_330 ( & V_562 ) ;
V_562 . V_407 = V_562 . V_50 = 0 ;
F_220 ( V_558 , & V_562 , 0 , NULL ) ;
V_66 = V_562 . V_50 ;
}
if ( ! V_30 -> V_563 )
V_559 -> V_10 = - 1 ;
V_561 = ( V_559 -> V_10 <= 0 && V_13 && V_30 -> V_316 ) ;
F_331 ( V_2 , V_66 , V_559 , V_561 ) ;
if ( V_13 ) {
F_110 (data, sk) {
if ( V_13 == F_81 ( V_2 ) ||
F_332 ( V_2 , V_13 ) )
...
if ( ! V_30 -> V_49 . V_411 ) {
V_30 -> V_49 . V_360 = V_30 -> V_49 . V_571 = 0 ;
...
V_2 -> V_434 != V_452 ) ;
if ( F_341 ( V_2 , V_4 , V_579 , NULL , true ) == NULL )
goto V_537;
}
if ( ! V_43 -> V_318 && ! V_43 -> V_535 && ! V_43 -> V_45 )
goto V_537;
...
return 1 ;
if ( V_579 ) {
V_315 = F_342 ( V_579 ) -> V_585 ;
V_30 -> V_316 = V_579 -> V_586 ;
F_343 ( V_2 , V_579 , false ) ;
} else {
V_315 = V_30 -> V_554 ;
V_6 -> V_542 -> V_553 ( V_2 ) ;
F_325 ( V_2 ) ;
...
F_53 ( F_16 ( V_4 ) -> V_92 - V_43 -> V_583 , V_30 -> V_90 ) ) ) {
F_237 ( V_2 ) ;
F_69 ( F_70 ( V_2 ) , V_591 ) ;
return 1 ;
}
V_587 = F_345 ( V_2 ) ;
if ( V_587 > V_592 ) {
F_326 ( V_2 , V_587 - V_592 ) ;
} else if ( V_43 -> V_583 || F_285 ( V_2 ) ) {
F_326 ( V_2 , V_587 ) ;
} else {
F_241 ( V_2 , V_453 , V_587 ) ;
goto V_537;
}
break;
}
...
static inline void F_347 ( struct V_578 * V_579 , T_12 V_593 , int V_594 )
{
struct V_595 * V_596 = F_348 ( V_579 ) ;
if ( V_594 == V_268 )
F_349 (KERN_DEBUG pr_fmt(L_21),
&ireq->ir_rmt_addr, port) ;
#if F_154 ( V_271 )
else if ( V_594 == V_272 )
F_349 (KERN_DEBUG pr_fmt(L_22),
&ireq->ir_v6_rmt_addr, port) ;
#endif
}
static void F_350 ( struct V_578 * V_579 ,
const struct V_3 * V_4 ,
...
V_601 = F_17 ( V_597 ) ;
if ( ! V_600 && ! V_601 && V_598 -> V_602 . V_603 )
F_348 ( V_579 ) -> V_604 = 1 ;
else if ( V_600 && V_601 )
F_348 ( V_579 ) -> V_604 = 1 ;
}
int F_352 ( struct V_605 * V_606 ,
...
T_3 V_610 = F_16 ( V_4 ) -> V_611 ;
bool V_612 = false , V_613 ;
struct V_614 V_615 ;
struct V_396 V_397 = { . V_10 = - 1 } ;
int V_166 ;
if ( ( V_616 == 2 ||
F_353 ( V_2 ) ) && ! V_610 ) {
V_612 = F_354 ( V_2 , V_4 , V_606 -> V_617 ) ;
if ( ! V_612 )
goto V_493;
}
if ( F_355 ( V_2 ) && F_356 ( V_2 ) > 1 ) {
F_69 ( F_70 ( V_2 ) , V_618 ) ;
goto V_493;
}
V_579 = F_357 ( V_606 ) ;
if ( ! V_579 )
goto V_493;
F_342 ( V_579 ) -> V_619 = V_608 ;
F_330 ( & V_609 ) ;
V_609 . V_50 = V_608 -> V_50 ;
V_609 . V_407 = V_30 -> V_49 . V_407 ;
F_220 ( V_4 , & V_609 , 0 , V_612 ? NULL : & V_397 ) ;
if ( V_612 && ! V_609 . V_263 )
F_330 ( & V_609 ) ;
V_609 . V_415 = V_609 . V_263 ;
F_358 ( V_579 , & V_609 , V_4 , V_2 ) ;
V_608 -> V_620 ( V_579 , V_2 , V_4 ) ;
if ( F_359 ( V_2 , V_4 , V_579 ) )
goto V_621;
if ( ! V_612 || V_609 . V_415 )
F_350 ( V_579 , V_4 , V_2 ) ;
if ( V_612 ) {
V_610 = F_360 ( V_608 , V_2 , V_4 , & V_579 -> V_66 ) ;
V_579 -> V_622 = V_609 . V_415 ;
} else if ( ! V_610 ) {
if ( V_623 . V_624 ) {
bool V_625 ;
V_114 = V_608 -> V_626 ( V_2 , & V_615 , V_579 , & V_625 ) ;
if ( V_114 && V_625 &&
! F_361 ( V_579 , V_114 , true ,
V_609 . V_263 ) ) {
F_69 ( F_70 ( V_2 ) , V_627 ) ;
goto V_628;
}
...
( V_629 - F_362 ( V_2 ) <
( V_629 >> 2 ) ) &&
! F_361 ( V_579 , V_114 , false ,
V_609 . V_263 ) ) {
F_347 ( V_579 , F_152 ( F_6 ( V_4 ) -> V_630 ) ,
V_606 -> V_594 ) ;
goto V_628;
}
V_610 = V_608 -> V_631 ( V_4 ) ;
}
if ( ! V_114 ) {
V_114 = V_608 -> V_626 ( V_2 , & V_615 , V_579 , NULL ) ;
if ( ! V_114 )
goto V_621;
}
F_342 ( V_579 ) -> V_632 = V_610 ;
F_363 ( V_579 , V_2 , V_114 ) ;
V_613 = ! V_612 &&
F_364 ( V_2 , V_4 , V_579 , & V_397 , V_114 ) ;
V_166 = V_608 -> V_633 ( V_2 , V_114 , & V_615 , V_579 ,
F_365 ( V_4 ) , & V_397 ) ;
if ( ! V_613 ) {
if ( V_166 || V_612 )
goto V_621;
F_342 ( V_579 ) -> V_634 = NULL ;
V_608 -> V_635 ( V_2 , V_579 , V_636 ) ;
}
return 0 ;
V_628:
F_366 ( V_114 ) ;
