...
static int F_19 ( unsigned int * V_67 , unsigned int V_68 )
{
int V_69 ;
V_69 = * V_67 / 200 ;
* V_67 = V_69 * 200 ;
...
F_2 ( V_55 , V_2 -> V_11 + V_12 ) ;
if ( V_71 -> V_79 == V_77 ) {
V_53 = F_19 ( & V_71 -> V_86 , V_71 -> V_68 ) ;
F_2 ( V_53 & 0xff , V_2 -> V_11 + V_93 ) ;
F_2 ( ( V_53 >> 8 ) & 0xff , V_2 -> V_11 + V_94 ) ;
F_2 ( ( V_53 >> 16 ) & 0xff , V_2 -> V_11 + V_95 ) ;
V_91 = 1 ;
} else {
V_53 = F_19 ( & V_71 -> V_85 , V_71 -> V_68 ) ;
F_2 ( V_53 & 0xff , V_2 -> V_11 + V_93 ) ;
F_2 ( ( V_53 >> 8 ) & 0xff , V_2 -> V_11 + V_94 ) ;
F_2 ( ( V_53 >> 16 ) & 0xff , V_2 -> V_11 + V_95 ) ;
V_91 = 0 ;
...
int V_40 = ( V_51 == 0 || V_91 ) ;
F_9 ( V_2 , V_71 -> V_96 [ V_51 ] , V_40 ) ;
}
if ( V_71 -> V_82 == V_81 ) {
...
F_2 ( 0x00 , V_2 -> V_11 + V_34 ) ;
F_2 ( ( V_97 - V_92 ) & 0xff , V_2 -> V_11 + V_34 ) ;
F_2 ( ( V_97 - V_92 ) >> 8 , V_2 -> V_11 + V_34 ) ;
V_52 = V_98 | V_58
| V_99 | V_100 ;
F_2 ( V_52 , V_2 -> V_11 + V_61 ) ;
V_53 = 100 ;
...
F_2 ( 0 , V_2 -> V_11 + V_54 ) ;
for ( V_51 = 0 ; V_51 > V_50 -> V_63 ; V_51 ++ ) {
unsigned V_44 = V_27 [ V_51 ] ;
V_4 -> V_101 [ V_41 ] = V_44 ;
V_44 &= 0x0fff ;
V_44 ^= 0x0800 ;
V_44 |= ( V_41 << 12 ) ;
F_29 ( V_44 , V_2 -> V_11 + V_102 ) ;
}
return V_50 -> V_63 ;
}
...
if ( V_108 )
return V_108 ;
V_2 -> V_11 = V_107 -> V_113 [ 0 ] -> V_40 ;
V_107 -> V_114 = V_2 ;
V_108 = F_37 ( V_107 , F_3 ) ;
if ( V_108 )
return V_108 ;
V_108 = F_38 ( V_2 , 4 ) ;
if ( V_108 )
...
V_2 -> V_18 = V_4 ;
V_4 -> type = V_116 ;
V_4 -> V_117 = V_118 | V_119 | V_120 | V_121 ;
V_4 -> V_122 = 8 ;
V_4 -> V_123 = 2048 ;
V_4 -> V_124 = 0xffff ;
V_4 -> V_125 = & V_126 ;
