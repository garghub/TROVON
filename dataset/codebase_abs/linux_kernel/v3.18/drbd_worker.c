...
static void F_201 ( struct V_2 * V_3 , const unsigned long V_339 )
{
if ( F_10 ( V_340 , & V_339 ) )
F_199 ( V_3 ) ;
if ( F_10 ( V_341 , & V_339 ) ||
F_10 ( V_342 , & V_339 ) )
F_186 ( V_3 , F_10 ( V_341 , & V_339 ) ) ;
if ( F_10 ( V_343 , & V_339 ) )
F_195 ( V_3 ) ;
if ( F_10 ( V_344 , & V_339 ) )
F_190 ( V_3 ) ;
...
static unsigned long F_202 ( unsigned long * V_11 )
{
unsigned long V_345 , V_346 ;
do {
V_345 = * V_11 ;
V_346 = V_345 & ~ V_347 ;
} while ( F_203 ( V_11 , V_345 , V_346 ) != V_345 );
return V_345 & V_347 ;
}
static void F_204 ( struct V_141 * V_25 )
{
struct V_12 * V_13 ;
int V_348 ;
F_75 () ;
...
struct V_2 * V_3 = V_13 -> V_3 ;
unsigned long V_339 = F_202 ( & V_3 -> V_11 ) ;
if ( ! V_339 )
continue;
F_205 ( & V_3 -> V_349 ) ;
F_77 () ;
F_201 ( V_3 , V_339 ) ;
F_206 ( & V_3 -> V_349 , V_350 ) ;
F_75 () ;
}
F_77 () ;
}
static bool F_207 ( struct V_351 * V_352 , struct V_353 * V_354 )
{
F_55 ( & V_352 -> V_355 ) ;
F_208 ( & V_352 -> V_356 , V_354 ) ;
F_57 ( & V_352 -> V_355 ) ;
return ! F_9 ( V_354 ) ;
}
static void F_209 ( struct V_141 * V_25 , struct V_353 * V_354 )
{
F_210 ( V_357 ) ;
struct V_285 * V_314 ;
int V_358 , V_359 ;
F_207 ( & V_25 -> V_26 , V_354 ) ;
if ( ! F_9 ( V_354 ) )
return;
F_75 () ;
V_314 = F_72 ( V_25 -> V_285 ) ;
V_358 = V_314 ? V_314 -> V_360 : 0 ;
F_77 () ;
if ( V_358 ) {
F_81 ( & V_25 -> V_107 . V_151 ) ;
if ( V_25 -> V_107 . V_152 )
F_211 ( V_25 -> V_107 . V_152 ) ;
F_82 ( & V_25 -> V_107 . V_151 ) ;
}
for (; ; ) {
int V_361 ;
F_212 ( & V_25 -> V_26 . V_362 , & V_357 , V_363 ) ;
F_55 ( & V_25 -> V_14 -> V_15 ) ;
F_181 ( & V_25 -> V_26 . V_355 ) ;
if ( ! F_9 ( & V_25 -> V_26 . V_356 ) )
F_208 ( & V_25 -> V_26 . V_356 , V_354 ) ;
F_183 ( & V_25 -> V_26 . V_355 ) ;
if ( ! F_9 ( V_354 ) || F_213 ( V_293 ) ) {
F_57 ( & V_25 -> V_14 -> V_15 ) ;
break;
}
V_361 =
...
F_143 ( V_25 ,
V_25 -> V_240 . V_241 + 1 ) ;
if ( F_10 ( V_365 , & V_25 -> V_11 ) )
break;
if ( F_214 ( & V_25 -> V_294 ) != V_366 )
break;
F_215 () ;
}
F_216 ( & V_25 -> V_26 . V_362 , & V_357 ) ;
F_75 () ;
V_314 = F_72 ( V_25 -> V_285 ) ;
V_359 = V_314 ? V_314 -> V_360 : 0 ;
F_77 () ;
F_81 ( & V_25 -> V_107 . V_151 ) ;
if ( V_25 -> V_107 . V_152 ) {
if ( V_359 )
F_217 ( V_25 -> V_107 . V_152 ) ;
else if ( ! V_358 )
F_211 ( V_25 -> V_107 . V_152 ) ;
}
F_82 ( & V_25 -> V_107 . V_151 ) ;
}
int F_218 ( struct V_367 * V_368 )
{
struct V_141 * V_25 = V_368 -> V_25 ;
struct V_87 * V_19 = NULL ;
struct V_12 * V_13 ;
F_219 ( V_354 ) ;
int V_348 ;
while ( F_214 ( V_368 ) == V_366 ) {
F_220 ( V_368 ) ;
if ( F_9 ( & V_354 ) ) {
F_221 ( V_25 , F_209 ) ;
F_209 ( V_25 , & V_354 ) ;
}
if ( F_222 ( V_365 , & V_25 -> V_11 ) ) {
F_221 ( V_25 , F_204 ) ;
F_204 ( V_25 ) ;
}
if ( F_213 ( V_293 ) ) {
F_223 ( V_293 ) ;
if ( F_214 ( V_368 ) == V_366 ) {
F_23 ( V_25 , L_43 ) ;
continue;
}
break;
...
break;
if ( ! F_9 ( & V_354 ) ) {
V_19 = F_224 ( & V_354 , struct V_87 , V_20 ) ;
F_225 ( & V_19 -> V_20 ) ;
F_221 ( V_25 , V_19 -> V_98 ) ;
if ( V_19 -> V_98 ( V_19 , V_25 -> V_369 < V_370 ) == 0 )
continue;
if ( V_25 -> V_369 >= V_370 )
F_176 ( V_25 , F_177 ( V_104 , V_371 ) , V_268 ) ;
}
}
do {
if ( F_222 ( V_365 , & V_25 -> V_11 ) ) {
...
F_207 ( & V_25 -> V_26 , & V_354 ) ;
} while ( ! F_9 ( & V_354 ) || F_10 ( V_365 , & V_25 -> V_11 ) );
F_75 () ;
F_157 (&connection->peer_devices, peer_device, vnr) {
struct V_2 * V_3 = V_13 -> V_3 ;
