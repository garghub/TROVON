...
if ( F_110 ( & V_217 [ V_2 ] ) == V_306 &&
F_109 ( & V_217 [ V_2 ] ) == 2 ) {
F_11 ( L_28 , V_217 [ V_2 + 2 ] ) ;
return V_217 [ V_2 + 2 ] & V_307 ;
}
}
return false ;
}
static bool F_130 ( struct V_8 * V_8 ,
struct V_308 * V_309 ,
struct V_38 * V_39 )
{
T_1 * V_217 , * V_265 ;
...
static void F_131 ( struct V_8 * V_8 ,
struct V_308 * V_309 ,
struct V_38 * V_39 )
{
T_1 * V_217 ;
V_309 -> V_163 = V_8 -> V_170 * 10 ;
V_309 -> V_166 = V_8 -> V_171 * 10 ;
V_309 -> V_311 = 0 ;
V_309 -> V_316 = 0 ;
if ( V_8 -> V_13 < 3 )
return;
...
F_130 ( V_8 , V_309 , V_39 ) ;
if ( V_8 -> V_13 < 4 )
return;
switch ( V_8 -> V_99 & V_324 ) {
case V_325 :
V_309 -> V_311 = 6 ;
break;
case V_326 :
...
int F_132 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
int V_334 = 0 ;
T_2 V_57 ;
if ( V_8 == NULL ) {
...
V_57 = F_24 ( V_8 ) ;
V_334 += F_86 ( V_39 , V_8 , V_57 ) ;
V_334 += F_84 ( V_39 , V_8 ) ;
V_334 += F_81 ( V_39 , V_8 ) ;
V_334 += F_79 ( V_39 , V_8 ) ;
if ( V_8 -> V_101 & V_102 )
V_334 += F_76 ( V_39 , V_8 ) ;
V_334 += F_114 ( V_39 , V_8 ) ;
V_334 += F_96 ( V_39 , V_8 ) ;
if ( V_57 & ( V_66 | V_67 ) )
F_27 ( V_39 , V_57 ) ;
F_131 ( V_8 , & V_39 -> V_335 , V_39 ) ;
if ( V_57 & V_336 )
V_39 -> V_335 . V_311 = 8 ;
if ( V_57 & V_337 )
V_39 -> V_335 . V_311 = 12 ;
...
if ( V_71 -> V_31 & V_344 )
V_341 -> V_345 = 1 ;
V_341 -> V_224 = F_90 ( V_71 ) ;
V_341 -> V_346 = V_347 ;
if ( V_71 -> V_225 == V_348 ||
V_71 -> V_225 == V_349 )
V_341 -> V_346 = V_71 -> V_225 ;
else if ( V_341 -> V_224 > 0 )
V_341 -> V_346 = F_93 (
V_341 -> V_224 ) ;
V_341 -> V_350 = V_351 ;
V_341 -> V_352 = V_353 ;
...
static enum V_354
F_137 ( const struct V_58 * V_71 )
{
T_2 V_355 = V_71 -> V_31 & V_231 ;
switch ( V_355 ) {
case V_246 :
return V_356 ;
case V_357 :
