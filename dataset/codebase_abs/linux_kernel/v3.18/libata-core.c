...
F_41 ( V_15 -> V_143 , V_508 , V_329 , sizeof( V_508 ) ) ;
F_41 ( V_15 -> V_143 , V_509 , V_328 , sizeof( V_509 ) ) ;
while ( V_511 -> V_508 ) {
if ( F_192 ( V_511 -> V_508 , V_508 ) ) {
if ( V_511 -> V_509 == NULL )
return V_511 -> V_48 ;
if ( F_192 ( V_511 -> V_509 , V_509 ) )
return V_511 -> V_48 ;
}
V_511 ++ ;
}
...
V_47 &= F_92 ( V_15 ) ;
if ( V_5 -> V_214 -> V_518 )
V_47 = V_5 -> V_214 -> V_518 ( V_15 , V_47 ) ;
if ( V_47 & ( 0xF8 << V_125 ) )
if ( F_197 ( V_5 ) ) {
F_24 ( V_15 ,
L_146 ) ;
...
unsigned int F_100 ( struct V_14 * V_15 , T_2 V_521 , T_2 V_72 )
{
struct V_67 V_68 ;
unsigned int V_158 ;
F_30 ( L_149 ) ;
...
int V_524 = V_194 -> V_199 ;
F_200 ( V_230 == NULL ) ;
F_201 ( L_151 , V_194 -> V_202 ) ;
if ( V_194 -> V_202 )
F_202 ( V_5 -> V_15 , V_230 , V_194 -> V_525 , V_524 ) ;
V_194 -> V_42 &= ~ V_526 ;
V_194 -> V_230 = NULL ;
}
...
{
struct V_4 * V_5 = V_194 -> V_5 ;
if ( ! ( V_194 -> V_15 -> V_48 & V_527 ) &&
F_5 ( V_194 -> V_232 & 15 ) )
return 1 ;
if ( V_5 -> V_214 -> V_528 )
return V_5 -> V_214 -> V_528 ( V_194 ) ;
return 0 ;
}
...
return - 1 ;
F_30 ( L_153 , V_202 ) ;
V_194 -> V_525 = V_194 -> V_202 ;
V_194 -> V_202 = V_202 ;
V_194 -> V_42 |= V_526 ;
return 0 ;
}
void F_98 ( T_4 * V_243 , unsigned int V_531 )
{
#ifdef F_209
unsigned int V_25 ;
...
unsigned int V_532 = V_5 -> V_273 -> V_533 ;
unsigned int V_25 , V_108 ;
if ( F_5 ( V_5 -> V_211 & V_212 ) )
return NULL ;
for ( V_25 = 0 , V_108 = V_5 -> V_534 + 1 ; V_25 < V_532 ; V_25 ++ , V_108 ++ ) {
V_108 = V_108 < V_532 ? V_108 : 0 ;
if ( V_108 == V_111 )
continue;
if ( ! F_69 ( V_108 , & V_5 -> V_216 ) ) {
V_194 = F_71 ( V_5 , V_108 ) ;
...
int F_254 ( struct V_517 * V_273 , T_6 V_564 )
{
V_273 -> V_15 -> V_577 . V_578 = V_564 ;
return 0 ;
}
void F_255 ( struct V_517 * V_273 )
{
...
struct V_4 * F_260 ( struct V_517 * V_273 )
{
struct V_4 * V_5 ;
F_30 ( L_130 ) ;
...
{
struct V_517 * V_273 = F_273 ( V_614 ) ;
int V_25 ;
...
struct V_517 * F_277 ( struct V_21 * V_15 , int V_618 )
{
struct V_517 * V_273 ;
T_5 V_619 ;
int V_25 ;
...
return NULL ;
V_619 = sizeof( struct V_517 ) + ( V_618 + 1 ) * sizeof( void * ) ;
...
struct V_517 * F_284 ( struct V_21 * V_15 ,
...
void F_297 ( struct V_517 * V_273 , struct V_21 * V_15 ,
struct V_633 * V_214 )
{
F_281 ( & V_273 -> V_210 ) ;
F_263 ( & V_273 -> V_620 ) ;
...
int F_303 ( struct V_517 * V_273 , struct V_648 * V_649 )
{
int V_25 , V_181 ;
V_273 -> V_533 = F_304 ( V_649 -> V_294 , 1 , V_295 - 1 ) ;
if ( ! ( V_273 -> V_42 & V_630 ) ) {
...
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ ) {
V_273 -> V_617 [ V_25 ] -> V_31 = F_305 ( & V_650 ) ;
V_273 -> V_617 [ V_25 ] -> V_590 = V_25 + 1 ;
}
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ ) {
V_181 = F_306 ( V_273 -> V_15 , V_273 -> V_617 [ V_25 ] ) ;
if ( V_181 ) {
goto V_651;
}
}
V_181 = F_307 ( V_273 , V_649 ) ;
if ( V_181 )
goto V_651;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_617 [ V_25 ] ;
...
V_651:
while ( -- V_25 >= 0 ) {
F_310 ( V_273 -> V_617 [ V_25 ] ) ;
}
return V_181 ;
}
int F_311 ( struct V_517 * V_273 , int V_652 ,
...
V_181 = F_312 ( V_273 -> V_15 , V_652 , V_653 , V_654 ,
F_313 ( V_273 -> V_15 ) , V_273 ) ;
if ( V_181 )
return V_181 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ )
F_314 ( V_273 -> V_617 [ V_25 ] , L_162 , V_652 ) ;
V_181 = F_303 ( V_273 , V_649 ) ;
if ( V_181 )
F_315 ( V_273 -> V_15 , V_652 , V_273 ) ;
return V_181 ;
}
...
void F_321 ( struct V_517 * V_273 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ )
F_316 ( V_273 -> V_617 [ V_25 ] ) ;
F_322 ( V_273 ) ;
}
void F_323 ( struct V_659 * V_660 )
{
struct V_517 * V_273 = F_324 ( V_660 ) ;
F_321 ( V_273 ) ;
}
int F_325 ( struct V_659 * V_660 , const struct V_661 * V_132 )
{
unsigned long V_386 = 0 ;
switch ( V_132 -> V_662 ) {
case 1 : {
T_2 V_663 = 0 ;
F_326 ( V_660 , V_132 -> V_560 , & V_663 ) ;
V_386 = V_663 ;
break;
}
case 2 : {
T_4 V_664 = 0 ;
F_327 ( V_660 , V_132 -> V_560 , & V_664 ) ;
V_386 = V_664 ;
break;
}
case 4 : {
T_1 V_665 = 0 ;
F_328 ( V_660 , V_132 -> V_560 , & V_665 ) ;
V_386 = V_665 ;
break;
}
default:
...
void F_329 ( struct V_659 * V_660 , T_6 V_564 )
{
F_330 ( V_660 ) ;
F_331 ( V_660 ) ;
...
int F_337 ( struct V_659 * V_660 , T_6 V_564 )
{
struct V_517 * V_273 = F_324 ( V_660 ) ;
int V_181 = 0 ;
...
int F_339 ( struct V_670 * V_660 )
{
struct V_517 * V_273 = F_340 ( V_660 ) ;
F_321 ( V_273 ) ;
return 0 ;
}
static int T_9 F_341 ( char * * V_481 ,
struct V_27 * V_671 ,
const char * * V_255 )
{
...
if ( V_148 ) {
* V_148 ++ = '\0' ;
V_671 -> V_21 = F_343 ( V_148 , & V_678 , 10 ) ;
if ( V_148 == V_678 || * V_678 != '\0' ) {
* V_255 = L_215 ;
return - V_119 ;
}
}
V_671 -> V_30 = F_343 ( V_143 , & V_678 , 10 ) ;
if ( V_148 == V_678 || * V_678 != '\0' ) {
* V_255 = L_216 ;
return - V_119 ;
}
...
T_1 F_356 ( struct V_4 * V_5 , void T_11 * V_560 , T_1 V_390 , T_1 V_561 ,
...
static unsigned int F_358 ( struct V_193 * V_194 )
{
return V_213 ;
}
...
void F_360 ( const struct V_4 * V_5 , const char * V_697 ,
const char * V_698 , ... )
{
struct V_699 V_700 ;
T_12 args ;
...
V_700 . V_698 = V_698 ;
V_700 . V_701 = & args ;
F_345 ( L_225 , V_697 , V_5 -> V_31 , & V_700 ) ;
va_end ( args ) ;
}
void F_361 ( const struct V_2 * V_3 , const char * V_697 ,
const char * V_698 , ... )
{
struct V_699 V_700 ;
T_12 args ;
...
void F_362 ( const struct V_14 * V_15 , const char * V_697 ,
const char * V_698 , ... )
{
struct V_699 V_700 ;
T_12 args ;
...
void F_363 ( const struct V_21 * V_15 , const char * V_702 )
{
F_364 ( V_271 , V_15 , L_227 , V_702 ) ;
}
