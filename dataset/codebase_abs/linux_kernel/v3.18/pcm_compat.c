...
return - V_7 ;
if ( V_57 == V_10 )
V_6 = F_27 ( V_2 , F_28 ( V_59 ) , V_8 ) ;
else
V_6 = F_29 ( V_2 , F_28 ( V_59 ) , V_8 ) ;
if ( V_6 < 0 )
return V_6 ;
...
return - V_7 ;
V_65 = F_28 ( V_59 ) ;
V_66 = F_31 ( sizeof( void T_2 * ) * V_67 , V_70 ) ;
if ( V_66 == NULL )
return - V_71 ;
...
F_18 ( & V_79 . V_41 , & V_3 -> V_85 . V_38 . V_41 ) ||
...
static long F_39 ( struct V_86 * V_86 , unsigned int V_87 , unsigned long V_88 )
{
struct V_89 * V_90 ;
struct V_1 * V_2 ;
void T_2 * V_91 = F_28 ( V_88 ) ;
V_90 = V_86 -> V_92 ;
if ( ! V_90 )
return - V_54 ;
V_2 = V_90 -> V_2 ;
...
return F_41 ( V_86 , V_2 , V_87 , V_91 ) ;
case V_110 :
return F_19 ( V_2 , 1 , V_91 ) ;
case V_111 :
return F_19 ( V_2 , 0 , V_91 ) ;
case V_112 :
return F_14 ( V_2 , V_91 ) ;
case V_113 :
return F_16 ( V_2 , V_91 ) ;
case V_114 :
return F_34 ( V_2 , V_91 ) ;
case V_115 :
return F_15 ( V_2 , V_91 ) ;
case V_116 :
return F_26 ( V_2 , V_10 , V_91 ) ;
case V_117 :
return F_26 ( V_2 , V_118 , V_91 ) ;
case V_119 :
return F_30 ( V_2 , V_10 , V_91 ) ;
case V_120 :
return F_30 ( V_2 , V_118 , V_91 ) ;
case V_121 :
return F_1 ( V_2 , V_91 ) ;
case V_122 :
return F_6 ( V_2 , V_91 ) ;
