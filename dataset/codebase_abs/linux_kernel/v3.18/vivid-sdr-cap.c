...
static T_2 F_48 ( unsigned int V_92 )
{
T_3 V_93 , V_94 , V_95 , V_96 ;
T_4 V_97 = V_92 / V_98 ;
if ( V_97 % 2 )
return - F_48 ( V_92 - V_98 ) ;
V_92 = V_92 % V_98 ;
if ( V_92 > V_98 / 2 )
return - F_48 ( V_98 / 2 - ( V_92 % ( V_98 / 2 ) ) ) ;
V_93 = V_92 * V_92 / V_99 / 2 ;
V_94 = V_93 * V_92 / V_99 * V_92 / V_99 / 3 / 4 ;
V_95 = V_94 * V_92 / V_99 * V_92 / V_99 / 5 / 6 ;
V_96 = V_95 * V_92 / V_99 * V_92 / V_99 / 7 / 8 ;
return V_99 - V_93 + V_94 - V_95 + V_96 ;
}
static inline T_2 F_49 ( unsigned int V_92 )
{
return - F_48 ( V_92 + ( V_98 / 2 ) ) ;
}
void F_9 ( struct V_1 * V_2 , struct V_3 * V_50 )
{
T_5 * V_100 = F_50 ( & V_50 -> V_10 , 0 ) ;
unsigned long V_101 ;
unsigned long V_102 = F_23 ( & V_50 -> V_10 , 0 ) ;
int V_103 , V_104 , V_105 ;
#define F_51 1000
V_103 = F_52 ( 2 * V_98 * F_51 ,
V_2 -> V_33 ) ;
for ( V_101 = 0 ; V_101 < V_102 ; V_101 += 2 ) {
V_2 -> V_106 += F_48 ( V_2 -> V_107 ) ;
V_2 -> V_107 += V_103 ;
while ( V_2 -> V_106 < ( 0 * V_98 ) )
V_2 -> V_106 += ( 2 * V_98 ) ;
while ( V_2 -> V_106 > ( 2 * V_98 ) )
V_2 -> V_106 -= ( 2 * V_98 ) ;
while ( V_2 -> V_107 > ( 2 * V_98 ) )
V_2 -> V_107 -= ( 2 * V_98 ) ;
V_104 = F_48 ( V_2 -> V_106 ) ;
V_105 = F_49 ( V_2 -> V_106 ) ;
V_104 = V_104 * 1275 + V_99 * 1275 ;
V_105 = V_105 * 1275 + V_99 * 1275 ;
* V_100 ++ = F_52 ( V_104 , V_99 * 10 ) ;
* V_100 ++ = F_52 ( V_105 , V_99 * 10 ) ;
}
}
