...
{
const struct V_117 * V_118 = V_2 -> V_119 ;
struct V_4 * V_5 ;
struct V_15 * V_16 ;
int V_109 ;
int V_41 ;
...
if ( ! V_5 )
return - V_120 ;
V_109 = F_58 ( V_2 , V_116 -> V_121 [ 0 ] , 0x10 ) ;
if ( V_109 )
return V_109 ;
if ( V_116 -> V_121 [ 1 ] >= 2 && V_116 -> V_121 [ 1 ] <= 7 ) {
V_109 = F_59 ( V_116 -> V_121 [ 1 ] , F_31 , 0 ,
V_2 -> V_122 , V_2 ) ;
if ( V_109 == 0 )
V_2 -> V_64 = V_116 -> V_121 [ 1 ] ;
}
if ( V_2 -> V_64 && ( V_116 -> V_121 [ 2 ] == 3 || V_116 -> V_121 [ 2 ] == 1 ) ) {
V_109 = F_60 ( V_116 -> V_121 [ 2 ] , V_2 -> V_122 ) ;
if ( V_109 ) {
F_34 ( V_2 -> V_77 ,
L_4 ,
V_116 -> V_121 [ 2 ] ) ;
...
V_5 -> V_29 = V_116 -> V_121 [ 2 ] ;
V_5 -> V_123 = 2 ;
V_5 -> V_22 = ( 1 << V_5 -> V_123 ) * V_124 ;
for ( V_41 = 0 ; V_41 < 2 ; V_41 ++ ) {
unsigned long V_71 ;
V_71 = F_61 ( V_125 , V_5 -> V_123 ) ;
if ( ! V_71 )
return - V_120 ;
V_5 -> V_71 [ V_41 ] = V_71 ;
...
V_16 -> V_131 = 16 ;
V_16 -> V_46 = V_118 -> V_132 ;
V_16 -> V_133 = & V_134 ;
V_16 -> V_135 = F_50 ;
if ( V_5 -> V_29 ) {
V_2 -> V_66 = V_16 ;
V_16 -> V_128 |= V_129 ;
V_16 -> V_136 = V_118 -> V_137 ;
V_16 -> V_138 = F_37 ;
V_16 -> V_139 = F_43 ;
V_16 -> V_140 = F_44 ;
V_16 -> V_141 = F_49 ;
...
F_65 ( V_5 -> V_29 ) ;
if ( V_5 -> V_71 [ 0 ] )
F_66 ( V_5 -> V_71 [ 0 ] , V_5 -> V_123 ) ;
if ( V_5 -> V_71 [ 1 ] )
F_66 ( V_5 -> V_71 [ 1 ] , V_5 -> V_123 ) ;
}
F_67 ( V_2 ) ;
}
