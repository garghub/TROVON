...
int F_78 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
int V_20 = 0 ;
bool V_70 ;
...
if ( V_20 )
goto V_84;
V_20 = F_84 ( & V_11 -> V_29 , & V_85 , & ( V_2 -> V_2 . V_29 ) ,
V_86 ) ;
if ( V_20 )
goto V_87;
V_20 = F_85 ( V_11 ) ;
...
goto V_91;
V_2 -> V_22 |= V_36 ;
V_20 = F_88 ( V_2 , V_13 -> V_2 ) ;
if ( V_20 )
goto V_92;
F_89 ( V_2 ) ;
F_90 ( & V_11 -> V_35 , & V_13 -> V_65 ) ;
F_21 ( V_13 ) ;
F_91 ( V_13 -> V_2 ) ;
if ( V_13 -> V_2 -> V_93 < V_2 -> V_93 )
V_13 -> V_2 -> V_93 = V_2 -> V_93 ;
if ( F_92 ( V_13 , V_11 , V_2 -> V_75 , 0 ) )
F_93 ( V_2 , L_3 ) ;
if ( F_94 ( V_11 ) )
F_93 ( V_2 , L_4 ) ;
F_7 ( & V_13 -> V_17 ) ;
...
int F_97 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
bool V_70 ;
V_11 = F_98 ( V_2 ) ;
...
void F_99 ( struct V_10 * V_11 , unsigned long V_68 )
{
struct V_12 * V_13 = V_11 -> V_13 ;
if ( V_68 & V_97 )
F_21 ( V_13 ) ;
