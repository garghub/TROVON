...
static T_2 int F_71 ( struct V_8 * V_8 )
{
return F_72 ( & V_8 -> V_67 ) ;
}
static T_4 void F_73 ( struct V_8 * V_8 )
{
F_74 ( V_8 -> V_67 ) ;
}
...
struct V_1 * V_2 ;
#ifdef F_76
V_36 = F_77 ( L_2 , sizeof( struct V_8 ) ,
V_68 ,
V_69 , NULL ) ;
V_52 = F_78 ( L_3 ) ;
if ( ! V_52 )
...
static int F_81 ( struct V_24 * V_44 ,
struct V_17 * V_18 )
{
struct V_8 * V_8 ;
int error ;
...
static int F_85 ( struct V_24 * V_44 ,
struct V_17 * V_18 )
{
int error ;
if ( V_18 -> V_9 ) {
V_73:
error = F_86 ( & V_74 , 1 , V_18 -> V_9 ) ;
if ( error < 0 ) {
if ( error == - V_75 ) {
F_87 ( & V_74 , V_6 ) ;
goto V_73;
...
V_5 = F_88 (unsigned int, max_gen_ptrs, *ops->id) ;
}
error = F_81 ( V_44 , V_18 ) ;
if ( error ) {
F_23 () ;
if ( V_18 -> V_9 )
F_89 ( & V_74 , * V_18 -> V_9 ) ;
...
static void * F_94 ( struct V_62 * V_79 )
{
struct V_8 * V_8 = NULL ;
struct V_65 * V_65 ;
F_68 ( V_79 ) ;
...
static void F_95 ( void * V_39 )
{
F_96 ( V_39 ) ;
}
static int F_97 ( struct V_65 * V_65 , void * V_39 )
{
struct V_8 * V_8 = V_39 ;
if ( ! F_98 ( V_8 -> V_28 , V_80 ) ||
! F_98 ( F_99 () , V_80 ) )
return - V_81 ;
F_96 ( V_65 -> V_66 ) ;
V_65 -> V_66 = F_35 ( V_8 ) ;
...
static unsigned int F_100 ( void * V_39 )
{
struct V_8 * V_8 = V_39 ;
return V_8 -> V_67 ;
}
