...
int V_39 = 0 ;
if ( V_32 == V_40 ) {
F_43 ( V_8 -> V_25 || ! V_8 -> V_19 ,
V_8 ) ;
if ( V_16 )
F_23 ( V_8 -> V_19 ) ;
V_39 = F_44 ( V_8 , V_13 , V_11 ,
V_15 , V_12 ,
V_10 , V_14 ) ;
if ( V_16 )
F_37 ( V_8 -> V_19 ) ;
...
if ( F_7 ( * V_14 ) && F_46 ( V_13 -> V_20 , V_13 ,
V_14 , V_15 ) )
break;
V_33 = ( V_15 + V_37 ) & V_38 ;
if ( V_32 > V_33 - V_15 )
...
if ( F_47 ( V_34 ) )
F_48 ( V_8 , V_12 - V_31 , V_11 ) ;
F_49 ( V_8 -> V_20 , V_35 , V_36 ) ;
...
if ( V_2 -> V_51 >= V_52 - 3 )
return - V_53 ;
V_39 = F_51 ( V_8 , V_11 , V_11 + V_42 ,
V_54 , & V_45 ) ;
if ( V_39 )
return V_39 ;
V_46 = V_8 -> V_55 + ( ( V_11 - V_8 -> V_56 ) >> V_57 ) ;
V_13 = F_52 ( & V_8 , V_15 , V_43 , V_46 ,
& V_16 ) ;
if ( ! V_13 )
return - V_53 ;
...
V_49 = V_2 -> V_49 ;
F_53 ( V_2 , V_8 -> V_45 , V_8 -> V_25 , V_43 >> V_57 ) ;
if ( F_54 ( V_2 , V_11 , V_42 ) < 0 ) {
F_55 ( V_48 >> V_57 ) ;
V_48 = 0 ;
}
V_2 -> V_49 = V_49 ;
...
V_70 = F_59 ( V_71 ) ;
V_44 += V_43 - V_42 ;
if ( V_44 > V_70 && ! F_60 ( V_72 ) )
goto V_73;
}
if ( ! F_61 ( V_2 , ( V_43 - V_42 ) >> V_57 ) )
goto V_74;
if ( V_8 -> V_45 & V_58 ) {
...
static unsigned long F_64 ( unsigned long V_3 , unsigned long V_42 ,
...
goto V_82;
V_79 = F_54 ( V_2 , V_15 , V_43 ) ;
if ( V_79 )
goto V_82;
if ( V_42 >= V_43 ) {
V_79 = F_54 ( V_2 , V_3 + V_43 , V_42 - V_43 ) ;
if ( V_79 && V_42 != V_43 )
goto V_82;
V_42 = V_43 ;
}
V_8 = F_56 ( V_3 , V_42 , V_43 , & V_75 ) ;
if ( F_65 ( V_8 ) ) {
V_79 = F_66 ( V_8 ) ;
goto V_82;
}
...
if ( V_8 -> V_45 & V_85 )
V_80 |= V_86 ;
V_79 = F_67 ( V_8 -> V_25 , V_15 , V_43 , V_8 -> V_55 +
( ( V_3 - V_8 -> V_56 ) >> V_57 ) ,
V_80 ) ;
if ( V_79 & ~ V_81 )
goto V_87;
V_79 = F_50 ( V_8 , V_3 , V_42 , V_43 , V_15 , V_44 ) ;
if ( ! ( V_79 & ~ V_81 ) )
goto V_82;
V_87:
F_55 ( V_75 ) ;
...
static int F_68 ( struct V_7 * V_8 , unsigned long V_88 )
{
...
return 0 ;
if ( F_67 ( NULL , V_8 -> V_56 , V_89 - V_8 -> V_56 ,
0 , V_84 ) & ~ V_81 )
return 0 ;
return 1 ;
}
