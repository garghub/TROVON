...
static int F_25 ( struct V_26 * V_27 , struct V_6 * V_3 ,
void * * V_35 )
{
struct V_18 * V_19 = & V_27 -> V_19 [ V_3 -> V_12 ] ;
int V_11 ;
...
static void F_28 ( struct V_26 * V_27 , struct V_6 * V_3 ,
void * V_35 )
{
struct V_18 * V_19 ;
...
V_74 -> V_85 = & V_74 -> V_86 ;
F_58 ( V_74 -> V_85 ) ;
V_11 = F_59 ( & V_74 -> V_85 -> V_87 ) ;
F_60 ( ! V_11 ) ;
* V_73 = V_74 ;
return 0 ;
}
T_2 F_47 ( T_1 V_88 , T_2 V_89 )
{
if ( V_88 & V_90 )
return V_89 ;
#if F_61 ( V_91 ) || F_61 ( V_92 )
if ( V_88 & V_38 )
V_89 = F_62 ( V_89 ) ;
else if ( V_93 . V_94 > 3 )
V_89 = F_63 ( V_89 ) ;
#endif
#if F_61 ( V_95 ) || F_61 ( V_96 ) || F_61 ( V_97 )
if ( V_88 & V_38 )
V_89 = F_62 ( V_89 ) ;
else
V_89 = F_63 ( V_89 ) ;
#endif
#if F_61 ( V_98 ) || F_61 ( V_99 )
V_89 = F_63 ( V_89 ) ;
#endif
return V_89 ;
}
...
V_101 -> V_102 = V_103 ;
V_101 -> V_35 = ( void * ) ( ( ( V_104 * ) V_2 -> V_3 . V_30 . V_36 ) + V_40 ) ;
} else {
V_101 -> V_102 = V_105 ;
if ( V_3 -> V_14 & V_38 )
V_101 -> V_35 = F_26 ( V_2 -> V_3 . V_30 . V_39 + V_2 -> V_3 . V_30 . V_40 + V_40 ,
V_41 ) ;
else
V_101 -> V_35 = F_27 ( V_2 -> V_3 . V_30 . V_39 + V_2 -> V_3 . V_30 . V_40 + V_40 ,
V_41 ) ;
}
return ( ! V_101 -> V_35 ) ? - V_42 : 0 ;
}
...
if ( V_67 == 1 && ( V_3 -> V_14 & V_90 ) ) {
V_101 -> V_102 = V_107 ;
V_101 -> V_45 = V_9 -> V_53 [ V_106 ] ;
V_101 -> V_35 = F_38 ( V_101 -> V_45 ) ;
} else {
V_51 = F_47 ( V_3 -> V_14 , V_54 ) ;
V_101 -> V_102 = V_108 ;
V_101 -> V_35 = F_37 ( V_9 -> V_53 + V_106 , V_67 ,
0 , V_51 ) ;
}
return ( ! V_101 -> V_35 ) ? - V_42 : 0 ;
}
int F_67 ( struct V_1 * V_2 ,
unsigned long V_106 , unsigned long V_67 ,
struct V_100 * V_101 )
{
struct V_18 * V_19 =
...
return F_65 ( V_2 , V_106 , V_67 , V_101 ) ;
} else {
V_40 = V_106 << V_47 ;
V_41 = V_67 << V_47 ;
return F_64 ( V_2 , V_40 , V_41 , V_101 ) ;
}
}
void F_68 ( struct V_100 * V_101 )
{
...
( void ) F_9 ( V_19 , false ) ;
F_21 ( V_101 -> V_2 -> V_27 , & V_101 -> V_2 -> V_3 ) ;
F_13 ( V_19 ) ;
V_101 -> V_35 = NULL ;
V_101 -> V_45 = NULL ;
}
...
F_71 ( V_2 -> V_85 , V_110 ) ;
if ( V_4 ) {
V_11 = F_72 ( V_2 , false , false , false ) ;
if ( V_11 )
return V_11 ;
if ( ( V_19 -> V_71 & V_72 ) &&
( V_2 -> V_9 != NULL ) ) {
...
F_73 ( V_112 , & V_2 -> V_113 ) ;
V_11 = F_52 ( V_2 , & V_111 ) ;
if ( V_11 )
return V_11 ;
F_71 ( V_111 -> V_85 , V_110 ) ;
if ( ! ( V_19 -> V_71 & V_72 ) )
V_111 -> V_9 = NULL ;
else
V_2 -> V_9 = NULL ;
