...
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_251 = ( T_18 * ) V_2 -> V_55 -> V_56 ;
F_25 ( V_2 -> V_55 , sizeof( T_18 ) ) ;
F_10 ( V_14 , V_252 ,
...
int V_406 ;
T_15 V_312 ;
struct V_407 * V_408 = (struct V_407 * ) & V_12 -> V_96 . V_315 ;
...
V_2 -> V_412 = 1 ;
V_160 = F_69 (
F_209 ( F_210 ( V_2 -> V_55 ) -> V_413 ) ) ;
if ( V_160 && V_160 -> V_414 ( V_2 -> V_55 ) && V_12 -> V_96 . V_415 ) {
F_10 ( V_14 , V_416 ,
F_122 ( V_312 ) ) ;
}
}
V_406 = F_155 ( & V_12 -> V_96 . V_315 , V_312 ) ;
if ( V_406 < 0 ) {
if ( V_2 -> V_12 )
V_2 -> V_12 -> V_417 . V_418 ++ ;
return V_256 ;
} else if ( V_406 > 0 ) {
F_10 ( V_14 , V_419 , F_122 ( V_312 ) ) ;
return V_260 ;
}
V_404 = F_2 ( V_2 -> V_5 -> V_6 ) ;
V_404 -= sizeof( V_255 ) ;
V_405 = V_420 ;
if ( ( V_404 >= V_12 -> V_181 ) && ( ! V_12 -> V_421 . V_422 ) ) {
F_10 ( V_14 , V_423 , F_16 () ) ;
}
if ( ( ! V_2 -> V_424 ) && ( ! V_12 -> V_181 || V_12 -> V_425 ||
( V_404 > V_12 -> V_181 + V_12 -> V_426 ) ) ) {
if ( F_211 ( V_408 ) &&
( F_212 ( V_408 ) + 1 ) == V_312 ) {
...
V_2 -> V_424 = 1 ;
if ( V_2 -> V_5 -> V_268 & V_431 ) {
F_14 ( V_8 , V_432 ) ;
if ( V_2 -> V_12 )
V_2 -> V_12 -> V_417 . V_433 ++ ;
} else {
F_14 ( V_8 , V_434 ) ;
if ( V_2 -> V_12 )
V_2 -> V_12 -> V_417 . V_435 ++ ;
V_411 = 1 ;
}
V_410 = F_2 ( V_266 -> V_316 ) ;
if ( V_410 >= V_12 -> V_90 . V_101 ) {
F_10 ( V_14 , V_436 , F_122 ( V_312 ) ) ;
V_187 = F_88 ( V_12 , V_2 , V_437 ,
& V_266 -> V_316 ,
sizeof( V_266 -> V_316 ) ,
sizeof( T_23 ) ) ;
if ( V_187 )
...
V_409 = F_2 ( V_266 -> V_409 ) ;
if ( V_411 && F_214 ( V_409 , F_215 ( & V_12 -> V_438 -> V_439 , V_410 ) ) ) {
return V_265 ;
}
