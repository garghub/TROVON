...
int F_264 ( struct V_361 * V_198 , int V_377 )
{
struct V_179 * V_180 = V_198 -> V_275 ;
unsigned long V_4 ;
int V_378 , V_29 ;
if ( V_377 <= 0 || V_377 > ( V_379 + 1 ) )
return - V_202 ;
for ( V_378 = 0 ; ( V_377 - 1 ) & ~ 0x1ff ; V_377 >>= 9 )
V_378 += 1 ;
if ( V_378 > V_380 )
return - V_202 ;
F_4 ( & V_180 -> V_170 , V_4 ) ;
...
static T_4 * F_270 ( T_4 * V_260 , int V_193 , int V_121 , bool V_381 )
{
int V_228 ;
T_4 * V_186 ;
while ( true ) {
...
int V_387 ;
V_384 = 1 << ( 9 * ( V_380 + 1 ) ) ;
V_384 = F_280 ( V_384 , ( 1 << 20 ) ) ;
V_383 -> V_4 |= V_388 ;
V_383 -> V_384 = F_280 ( F_281 ( V_13 ) , V_384 ) ;
V_387 = F_282 ( V_13 ) ;
if ( V_387 & V_389 )
V_383 -> V_4 |= V_390 ;
if ( V_387 & V_391 )
...
static void F_283 ( T_1 V_2 , struct V_393 * V_394 )
{
T_4 V_395 ;
V_395 = V_43 [ V_2 ] . V_40 [ 2 ] ;
V_395 &= ~ V_396 ;
V_395 |= F_115 ( V_394 -> V_394 ) ;
V_395 |= V_397 ;
V_395 |= V_398 ;
V_395 |= V_399 ;
V_43 [ V_2 ] . V_40 [ 2 ] = V_395 ;
}
static struct V_393 * F_284 ( T_1 V_2 , bool V_400 )
{
...
V_394 = F_2 ( sizeof( * V_394 ) , V_318 ) ;
if ( ! V_394 )
goto V_310;
F_175 ( & V_394 -> V_170 ) ;
if ( V_400 )
V_394 -> V_402 = 32 ;
V_394 -> V_394 = F_285 ( V_403 , V_318 ) ;
if ( ! V_394 -> V_394 ) {
F_9 ( V_394 ) ;
V_394 = NULL ;
goto V_310;
}
memset ( V_394 -> V_394 , 0 , V_404 * sizeof( T_2 ) ) ;
if ( V_400 ) {
int V_23 ;
for ( V_23 = 0 ; V_23 < 32 ; ++ V_23 )
V_394 -> V_394 [ V_23 ] = V_405 ;
}
V_401 [ V_2 ] = V_394 ;
F_283 ( V_2 , V_394 ) ;
F_96 ( V_18 , V_2 ) ;
...
static int F_286 ( struct V_406 * V_407 , T_1 V_2 , int V_88 )
{
struct V_393 * V_394 ;
unsigned long V_4 ;
int V_228 , V_408 ;
V_394 = F_284 ( V_2 , false ) ;
if ( ! V_394 )
return - V_409 ;
F_4 ( & V_394 -> V_170 , V_4 ) ;
for ( V_408 = 0 , V_228 = V_394 -> V_402 ;
V_228 < V_404 ;
++ V_228 ) {
if ( V_394 -> V_394 [ V_228 ] == 0 )
V_408 += 1 ;
else
V_408 = 0 ;
if ( V_408 == V_88 ) {
struct V_410 * V_411 ;
for (; V_408 != 0 ; -- V_408 )
V_394 -> V_394 [ V_228 - V_408 + 1 ] = V_405 ;
V_228 -= V_88 - 1 ;
V_407 -> V_412 = 1 ;
V_411 = & V_407 -> V_410 ;
V_411 -> V_2 = V_2 ;
...
static int F_287 ( T_1 V_2 , int V_228 , union V_414 * V_414 )
{
struct V_393 * V_394 ;
unsigned long V_4 ;
V_394 = F_284 ( V_2 , false ) ;
...
return - V_48 ;
F_4 ( & V_394 -> V_170 , V_4 ) ;
V_414 -> V_415 = V_394 -> V_394 [ V_228 ] ;
F_6 ( & V_394 -> V_170 , V_4 ) ;
return 0 ;
}
static int F_288 ( T_1 V_2 , int V_228 , union V_414 V_414 )
{
struct V_393 * V_394 ;
struct V_51 * V_18 ;
unsigned long V_4 ;
...
static int F_290 ( int V_130 , struct V_416 * V_28 ,
...
return - V_202 ;
V_411 = & V_407 -> V_410 ;
V_421 = F_292 ( V_420 -> V_400 ) ;
V_2 = F_293 ( V_421 ) ;
if ( V_2 < 0 )
return V_2 ;
V_394 = F_284 ( V_2 , true ) ;
if ( V_394 == NULL )
return - V_48 ;
V_228 = V_420 -> V_422 ;
V_407 -> V_412 = 1 ;
...
V_411 -> V_228 = V_228 ;
V_414 . V_415 = 0 ;
V_414 . V_423 . V_418 = V_418 ;
V_414 . V_423 . V_424 = V_425 -> V_426 ;
V_414 . V_423 . V_417 = V_417 ;
V_414 . V_423 . V_427 = V_425 -> V_428 ;
V_414 . V_423 . V_429 = 1 ;
V_29 = F_288 ( V_2 , V_228 , V_414 ) ;
if ( V_29 )
return V_29 ;
memset ( V_28 , 0 , sizeof( * V_28 ) ) ;
V_28 -> V_418 = V_228 ;
V_28 -> V_349 = 0 ;
V_28 -> V_430 = V_420 -> V_430 ;
V_28 -> V_431 = V_420 -> V_431 ;
if ( V_420 -> V_430 )
V_28 -> V_349 = 1 ;
return 0 ;
}
static int F_294 ( struct V_432 * V_40 , const struct V_433 * V_349 ,
bool V_434 )
{
struct V_410 * V_411 ;
unsigned int V_435 , V_130 ;
struct V_406 * V_407 ;
union V_414 V_414 ;
int V_436 ;
if ( ! F_295 ( V_437 ) )
...
return - V_202 ;
if ( F_287 ( V_411 -> V_2 , V_411 -> V_228 , & V_414 ) )
return - V_203 ;
if ( F_297 ( V_130 , V_407 , V_349 ) )
return - V_203 ;
V_436 = V_425 -> V_440 ( V_407 -> V_180 , V_349 , & V_435 ) ;
if ( V_436 ) {
if ( F_297 ( V_130 , V_407 , V_40 -> V_441 ) )
F_37 ( L_34 , V_130 ) ;
return V_436 ;
}
V_414 . V_423 . V_418 = V_407 -> V_418 ;
V_414 . V_423 . V_417 = V_435 ;
F_288 ( V_411 -> V_2 , V_411 -> V_228 , V_414 ) ;
if ( V_407 -> V_442 )
F_298 ( V_407 ) ;
...
return - V_202 ;
V_411 = & V_407 -> V_410 ;
F_289 ( V_411 -> V_2 , V_411 -> V_228 ) ;
return 0 ;
}
static void F_301 ( struct V_12 * V_13 ,
unsigned int V_130 , unsigned int V_435 ,
...
return - V_202 ;
V_2 = F_13 ( & V_13 -> V_11 ) ;
V_228 = F_286 ( V_407 , V_2 , V_449 ) ;
return V_228 < 0 ? V_404 : V_228 ;
}
