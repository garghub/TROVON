...
static int F_21 ( struct V_44 * V_45 , void * V_46 )
{
...
static T_2 F_24 ( struct V_2 * V_2 , const char T_3 * V_56 ,
T_4 V_57 , T_5 * V_58 )
{
...
return - V_61 ;
if ( F_25 ( V_60 , V_56 , V_57 ) )
return - V_62 ;
V_60 [ V_57 ] = '\0' ;
if ( ! strcmp ( V_60 , L_11 ) )
V_48 -> V_51 = V_52 ;
else if ( ! strcmp ( V_60 , L_12 ) )
V_48 -> V_51 = V_53 ;
...
if ( ! V_14 -> V_36 )
return - 1 ;
V_12 = F_15 ( V_48 -> V_26 , V_14 -> V_36 ) ;
if ( ! V_12 )
return - V_71 ;
V_48 -> V_72 = V_12 ;
V_17 = F_5 ( L_16 , V_28 | V_73 , V_12 , V_48 ,
& V_74 ) ;
if ( ! V_17 )
goto error;
V_17 = F_5 ( L_17 , V_28 | V_73 , V_12 ,
V_48 , & V_75 ) ;
if ( ! V_17 )
goto error;
return 0 ;
