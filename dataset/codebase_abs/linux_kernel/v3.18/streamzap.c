...
if ( ! F_28 ( V_2 -> V_83 ) ) {
F_12 ( & V_65 -> V_5 , L_16
L_15 , V_30 , V_2 -> V_83 -> V_85 ) ;
V_72 = - V_81 ;
goto V_82;
}
V_74 = F_29 ( V_46 , V_2 -> V_83 -> V_84 ) ;
V_75 = F_30 ( V_46 , V_74 , F_31 ( V_74 ) ) ;
if ( V_75 == 0 ) {
F_12 ( & V_65 -> V_5 , L_17 ,
V_30 ) ;
V_72 = - V_81 ;
...
V_2 -> V_31 = F_32 ( V_46 , V_75 , V_40 , & V_2 -> V_86 ) ;
if ( ! V_2 -> V_31 )
goto V_82;
V_2 -> V_87 = F_33 ( 0 , V_76 ) ;
if ( ! V_2 -> V_87 )
goto V_88;
V_2 -> V_5 = & V_65 -> V_5 ;
V_2 -> V_89 = V_75 ;
if ( V_46 -> V_47 . V_90
&& F_34 ( V_46 , V_46 -> V_47 . V_90 ,
V_71 , sizeof( V_71 ) ) > 0 )
F_35 ( V_45 , V_71 , sizeof( V_45 ) ) ;
if ( V_46 -> V_47 . V_91
&& F_34 ( V_46 , V_46 -> V_47 . V_91 ,
V_71 , sizeof( V_71 ) ) > 0 )
...
#endif
F_6 ( & V_2 -> V_13 ) ;
F_36 ( V_2 -> V_87 , V_46 , V_74 , V_2 -> V_31 ,
V_75 , ( V_93 ) F_11 ,
V_2 , V_2 -> V_83 -> V_94 ) ;
V_2 -> V_87 -> V_95 = V_2 -> V_86 ;
V_2 -> V_87 -> V_96 |= V_97 ;
F_37 ( V_65 , V_2 ) ;
if ( F_15 ( V_2 -> V_87 , V_40 ) )
F_12 ( V_2 -> V_5 , L_19 ) ;
F_38 ( V_2 -> V_5 , L_20 , V_45 ,
V_46 -> V_98 -> V_99 , V_46 -> V_100 ) ;
return 0 ;
V_92:
F_39 ( V_2 -> V_87 ) ;
V_88:
F_40 ( V_46 , V_75 , V_2 -> V_31 , V_2 -> V_86 ) ;
V_82:
F_41 ( V_2 ) ;
return V_72 ;
}
static void F_42 ( struct V_64 * V_77 )
{
...
F_45 ( V_2 -> V_87 ) ;
F_39 ( V_2 -> V_87 ) ;
F_40 ( V_46 , V_2 -> V_89 , V_2 -> V_31 , V_2 -> V_86 ) ;
F_41 ( V_2 ) ;
}
static int F_46 ( struct V_64 * V_65 , T_1 V_101 )
{
struct V_1 * V_2 = F_43 ( V_65 ) ;
F_45 ( V_2 -> V_87 ) ;
return 0 ;
}
