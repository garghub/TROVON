...
return - V_119 ;
V_115 = F_81 ( V_114 ) ;
V_2 -> V_4 = F_82 ( & V_110 -> V_54 , V_114 ) ;
if ( F_83 ( V_2 -> V_4 ) )
return F_84 ( V_2 -> V_4 ) ;
F_85 ( & V_2 -> V_18 ) ;
V_2 -> V_33 = V_115 < V_120 ;
if ( V_2 -> V_33 ) {
V_2 -> V_121 = F_10 ;
V_2 -> V_122 = F_14 ;
V_2 -> V_123 = F_15 ;
...
return V_116 ;
V_2 -> V_91 = V_91 ;
V_2 -> V_56 = V_6 ? V_6 -> V_56 : - V_131 ;
if ( F_35 ( V_2 -> V_56 ) ) {
char * V_132 = F_88 ( & V_110 -> V_54 , 16 , V_133 ) ;
if ( ! V_132 )
return - V_87 ;
snprintf ( V_132 , 16 , L_6 , V_112 ) ;
V_2 -> V_134 = F_89 ( V_2 -> V_56 ) ;
if ( F_90 ( V_2 -> V_134 , F_62 ,
V_135 | V_136 ,
V_132 , V_2 -> V_27 ) < 0 )
V_2 -> V_56 = - V_131 ;
}
F_91 ( V_27 , L_7 , ( V_137 ) V_114 -> V_138 , V_91 ) ;
return 0 ;
}
...
F_101 ( V_2 -> V_91 , V_27 ) ;
if ( F_35 ( V_2 -> V_56 ) )
F_101 ( V_2 -> V_134 , V_27 ) ;
F_98 ( V_27 ) ;
F_99 ( V_27 ) ;
return 0 ;
}
static int F_102 ( struct V_150 * V_54 )
{
...
static int F_105 ( struct V_150 * V_54 )
{
struct V_109 * V_110 = F_103 ( V_54 ) ;
struct V_26 * V_27 = F_77 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
