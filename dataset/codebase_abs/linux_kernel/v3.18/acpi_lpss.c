...
{
struct V_55 * V_56 = F_64 ( V_94 ) ;
struct V_1 * V_2 ;
struct V_24 * V_25 ;
const struct V_49 * V_50 ;
V_50 = F_65 ( V_95 , & V_56 -> V_28 ) ;
if ( ! V_50 || ! V_50 -> V_58 )
return 0 ;
...
if ( ! V_2 || ! V_2 -> V_8 )
return 0 ;
if ( V_2 -> V_36 < V_2 -> V_5 -> V_6 + V_96 ) {
F_66 ( & V_56 -> V_28 , L_11 ) ;
return 0 ;
}
switch ( V_93 ) {
case V_97 :
if ( V_2 -> V_5 -> V_41 & V_98 )
...
break;
case V_102 :
if ( V_2 -> V_5 -> V_41 & V_103 )
return F_67 ( & V_56 -> V_28 . V_104 ,
& V_105 ) ;
case V_106 :
if ( V_2 -> V_5 -> V_41 & V_103 )
F_68 ( & V_56 -> V_28 . V_104 , & V_105 ) ;
default:
break;
}
return 0 ;
...
{
struct V_1 * V_2 = F_41 ( F_46 ( V_28 ) ) ;
if ( ! V_2 || ! V_2 -> V_8 || ! ( V_2 -> V_5 -> V_41 & V_103 ) )
return;
if ( V_2 -> V_36 >= V_2 -> V_5 -> V_6 + V_96 )
V_28 -> V_67 . V_107 = F_45 ;
else
F_66 ( V_28 , L_11 ) ;
}
static void F_70 ( struct V_66 * V_28 )
{
V_28 -> V_67 . V_107 = NULL ;
}
void T_5 F_71 ( void )
{
if ( ! F_72 () ) {
