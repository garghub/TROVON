...
struct V_7 * V_8 = V_25 -> V_26 ;
T_3 V_109 = V_25 -> V_110 . V_111 ;
T_3 V_119 = V_25 -> V_110 . V_120 ;
T_3 V_121 = V_25 -> V_110 . V_122 ;
if ( F_33 ( V_25 , 0 ) != 0 ) {
F_7 ( 1 , L_31 ) ;
return - V_34 ;
}
...
if ( V_142 -> V_143 & V_148 ) {
V_8 -> V_52 = V_149 ;
return;
}
if ( V_142 -> V_143 & V_150 ) {
V_8 -> V_52 = V_151 ;
return;
}
if ( V_142 -> V_143 & V_152 ) {
V_8 -> V_52 = V_153 ;
return;
}
if ( V_142 -> V_143 & V_154 ) {
V_8 -> V_52 = V_155 ;
return;
}
if ( V_142 -> V_143 & V_156 ) {
V_8 -> V_52 = V_157 ;
return;
}
}
...
if ( V_8 -> V_160 == V_162 )
V_160 = V_163 ;
else if ( V_8 -> V_160 == V_164 )
V_160 = V_165 ;
else if ( V_8 -> V_160 == V_166 )
V_160 = V_167 ;
else {
F_7 ( 1 , L_48 , V_28 ,
V_8 -> V_160 ) ;
...
V_27 = F_12 ( V_8 , V_50 [ V_160 ] . V_47 ,
V_50 [ V_160 ] . V_48 , V_160 ) ;
if ( V_27 != 0 ) {
F_4 ( V_17 L_29 ) ;
return - V_18 ;
}
...
static int F_41 ( struct V_24 * V_25 , T_3 * V_119 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_119 = V_8 -> V_59 + V_8 -> V_124 ;
return 0 ;
}
static int F_42 ( struct V_24 * V_25 , T_3 * V_119 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_119 = V_8 -> V_112 * 1000 ;
return 0 ;
}
...
static int F_44 ( struct V_24 * V_25 , T_3 * V_170 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
T_2 V_74 = 0 ;
F_18 ( V_8 , & V_74 ) ;
F_7 ( 1 , L_49 , V_28 , V_74 ) ;
* V_170 = V_74 ;
return 0 ;
}
static int F_33 ( struct V_24 * V_25 , int V_171 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
...
T_2 V_172 ;
F_45 ( & V_8 -> V_173 ) ;
if ( ! V_171 && F_34 ( V_25 ) == 0 )
return 0 ;
if ( ! V_8 -> V_101 ) {
V_27 = F_46 ( & V_102 , V_100 -> V_51 ,
V_8 -> V_14 . V_16 -> V_174 . V_175 ) ;
if ( V_27 ) {
F_47 ( L_50 , V_27 ) ;
return V_27 ;
}
F_7 ( 1 , L_51 , V_102 -> V_176 ) ;
if ( V_102 -> V_176 != V_100 -> V_176 ) {
F_47 ( L_52 ) ;
F_48 ( V_102 ) ;
return - V_34 ;
}
...
static void F_49 ( struct V_182 * V_173 )
{
struct V_7 * V_8 = F_50 ( V_173 , struct V_7 ,
V_173 . V_183 ) ;
...
static int F_61 ( struct V_24 * V_25 , void * V_187 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
struct V_188 * V_189 = V_187 ;
F_7 ( 1 , L_3 , V_28 ) ;
if ( V_189 -> V_112 )
V_8 -> V_112 = V_189 -> V_112 ;
if ( V_189 -> V_160 )
V_8 -> V_160 = V_189 -> V_160 ;
return 0 ;
}
...
V_192 ? V_192 -> V_194 : - 1 ) ;
F_58 ( & V_186 ) ;
V_193 = F_64 ( struct V_7 , V_8 ,
V_195 ,
V_191 , V_192 -> V_194 , L_66 ) ;
switch ( V_193 ) {
case 0 :
goto V_196;
case 1 :
...
if ( V_8 -> V_112 == 0 ) {
V_8 -> V_112 = V_192 -> V_112 ;
}
if ( V_8 -> V_99 == 0 )
V_8 -> V_99 = V_192 -> V_99 ;
if ( V_8 -> V_160 == 0 )
V_8 -> V_160 = V_192 -> V_160 ;
if ( ( V_8 -> V_2 == 0 ) || ( V_192 -> V_2 ) )
V_8 -> V_2 = ( V_192 -> V_2 ) ? V_192 -> V_2 : 0 ;
if ( F_5 ( V_8 , V_138 , & V_137 ) != 0 )
goto V_196;
switch ( V_137 ) {
case V_197 :
F_4 ( V_181
