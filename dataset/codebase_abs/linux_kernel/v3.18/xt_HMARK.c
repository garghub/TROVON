...
return F_15 ( V_44 , V_9 -> V_47 ) + V_9 -> V_48 ;
}
static void
F_16 ( const struct V_18 * V_19 , unsigned int V_49 ,
...
return;
V_49 += V_50 ;
if ( F_18 ( V_19 , V_49 , & V_21 -> V_7 , sizeof( V_21 -> V_7 ) ) < 0 )
return;
F_3 ( & V_21 -> V_7 , V_9 ) ;
}
static int F_19 ( const struct V_18 * V_19 , int * V_51 )
{
struct V_52 * V_53 , V_54 ;
V_53 = F_20 ( V_19 , * V_51 , sizeof( V_54 ) , & V_54 ) ;
if ( V_53 == NULL )
return 0 ;
...
static int
F_21 ( const struct V_18 * V_19 , struct V_20 * V_21 ,
const struct V_8 * V_9 )
{
...
T_2 V_60 = 0 ;
int V_61 ;
V_35 = (struct V_56 * ) ( V_19 -> V_62 + F_22 ( V_19 ) ) ;
V_61 = F_23 ( V_19 , & V_49 , - 1 , & V_60 , & V_58 ) ;
if ( V_61 < 0 )
return 0 ;
if ( ( V_58 & V_63 ) || ( V_61 != V_64 ) )
goto V_65;
if ( F_19 ( V_19 , & V_49 ) ) {
V_35 = F_20 ( V_19 , V_49 , sizeof( V_57 ) , & V_57 ) ;
if ( V_35 == NULL )
return - 1 ;
V_58 = V_59 ;
V_61 = F_23 ( V_19 , & V_49 , - 1 , & V_60 , & V_58 ) ;
...
if ( V_58 & V_63 )
return 0 ;
F_16 ( V_19 , V_49 , V_21 , V_9 ) ;
return 0 ;
}
static unsigned int
F_24 ( struct V_18 * V_19 , const struct V_69 * V_70 )
{
const struct V_8 * V_9 = V_70 -> V_71 ;
struct V_20 V_21 ;
memset ( & V_21 , 0 , sizeof( struct V_20 ) ) ;
if ( V_9 -> V_38 & F_9 ( V_72 ) ) {
if ( F_5 ( V_19 , & V_21 , V_9 ) < 0 )
return V_73 ;
} else {
if ( F_21 ( V_19 , & V_21 , V_9 ) < 0 )
return V_73 ;
}
V_19 -> V_74 = F_11 ( & V_21 , V_9 ) ;
return V_73 ;
}
static int F_25 ( const struct V_18 * V_19 , int V_75 , int * V_49 )
{
const struct V_76 * V_77 ;
struct V_76 V_78 ;
V_77 = F_20 ( V_19 , * V_49 + V_75 , sizeof( V_78 ) , & V_78 ) ;
...
static int
F_26 ( const struct V_18 * V_19 , struct V_20 * V_21 ,
const struct V_8 * V_9 )
{
...
if ( V_86 -> V_88 == V_41 ) {
if ( F_25 ( V_19 , V_86 -> V_89 * 4 , & V_49 ) ) {
V_86 = F_20 ( V_19 , V_49 , sizeof( V_87 ) , & V_87 ) ;
if ( V_86 == NULL )
return - 1 ;
}
}
...
if ( V_21 -> V_40 == V_41 )
return 0 ;
if ( V_86 -> V_90 & F_27 ( V_91 | V_92 ) )
return 0 ;
F_16 ( V_19 , ( V_86 -> V_89 * 4 ) + V_49 , V_21 , V_9 ) ;
return 0 ;
}
static unsigned int
F_28 ( struct V_18 * V_19 , const struct V_69 * V_70 )
{
const struct V_8 * V_9 = V_70 -> V_71 ;
struct V_20 V_21 ;
memset ( & V_21 , 0 , sizeof( struct V_20 ) ) ;
...
if ( F_26 ( V_19 , & V_21 , V_9 ) < 0 )
return V_73 ;
}
V_19 -> V_74 = F_11 ( & V_21 , V_9 ) ;
return V_73 ;
}
static int F_29 ( const struct V_93 * V_70 )
{
const struct V_8 * V_9 = V_70 -> V_71 ;
if ( ! V_9 -> V_47 ) {
F_30 ( L_1 ) ;
...
if ( V_9 -> V_38 & F_9 ( V_95 ) &&
( V_9 -> V_38 & ( F_9 ( V_96 ) |
F_9 ( V_97 ) ) ) ) {
F_30 ( L_3 ) ;
return - V_94 ;
}
if ( V_9 -> V_38 & F_9 ( V_98 ) &&
( V_9 -> V_38 & ( F_9 ( V_99 ) |
F_9 ( V_100 ) ) ) ) {
F_30 ( L_4 ) ;
return - V_94 ;
...
{
return F_32 ( V_101 , F_33 ( V_101 ) ) ;
}
static void T_5 F_34 ( void )
{
F_35 ( V_101 , F_33 ( V_101 ) ) ;
}
