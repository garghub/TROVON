...
if ( V_5 ) {
F_4 ( L_4
L_5 , V_20 -> V_25 -> V_26 , V_5 , V_22 , V_23 ,
V_6 ) ;
return V_5 ;
}
return 0 ;
...
F_21 ( & V_74 ) ;
V_20 = F_39 ( sizeof( struct V_19 ) , V_76 ) ;
if ( ! V_20 )
return - V_77 ;
F_40 ( & V_20 -> V_40 ) ;
V_20 -> V_16 = V_70 -> V_16 ;
...
V_25 -> V_80 = & V_81 ;
V_25 -> V_82 = V_83 ;
V_25 -> V_84 = V_20 -> V_16 * V_85 + V_20 -> V_17 ;
V_25 -> V_55 = V_20 ;
sprintf ( V_25 -> V_26 , L_8 , V_20 -> V_16 , V_20 -> V_17 ) ;
F_42 ( V_25 , V_71 ) ;
V_20 -> V_25 = V_25 ;
F_43 ( & V_20 -> V_47 ) ;
...
V_20 -> V_45 -> V_48 = V_20 ;
V_20 -> V_25 -> V_87 = V_20 -> V_45 ;
V_20 -> V_50 = F_45 ( L_10 , 0 , 0 , V_25 -> V_26 ) ;
if ( ! V_20 -> V_50 ) {
V_5 = - V_77 ;
goto V_88;
}
...
F_21 ( & V_74 ) ;
F_3 ( L_13 ,
V_20 -> V_25 -> V_26 , V_70 -> V_92 ) ;
return - V_73 ;
}
F_19 ( & V_20 -> V_40 ) ;
if ( F_16 ( V_20 -> V_25 ) != V_71 ) {
F_42 ( V_20 -> V_25 , V_71 ) ;
F_49 ( L_14 , V_20 -> V_25 -> V_26 ,
V_70 -> V_72 ) ;
}
F_21 ( & V_20 -> V_40 ) ;
F_21 ( & V_74 ) ;
...
V_107 = & V_7 [ V_4 ] ;
V_24 = F_60 ( V_107 -> V_18 , V_107 -> V_16 , V_107 -> V_17 ) ;
if ( F_33 ( V_24 ) ) {
F_4 ( L_15 ,
F_34 ( V_24 ) ) ;
V_5 = F_34 ( V_24 ) ;
