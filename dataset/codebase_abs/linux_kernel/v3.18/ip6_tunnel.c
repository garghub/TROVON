...
static struct V_22 * F_32 ( struct V_34 * V_34 , struct V_46 * V_47 )
{
struct V_7 * V_8 ;
struct V_22 * V_23 ;
char V_56 [ V_59 ] ;
int V_54 ;
if ( V_47 -> V_56 [ 0 ] )
F_33 ( V_56 , V_47 -> V_56 , V_59 ) ;
else
sprintf ( V_56 , L_1 ) ;
V_8 = F_34 ( sizeof( * V_23 ) , V_56 , V_60 ,
V_61 ) ;
if ( V_8 == NULL )
goto V_62;
F_35 ( V_8 , V_34 ) ;
...
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
if ( V_8 == V_38 -> V_65 )
F_38 ( V_38 -> V_45 [ 0 ] , NULL ) ;
else
F_23 ( V_38 , V_23 ) ;
F_11 ( V_23 ) ;
F_39 ( V_8 ) ;
}
T_3 F_40 ( struct V_66 * V_67 , T_4 * V_68 )
{
const struct V_69 * V_70 = ( const struct V_69 * ) V_68 ;
T_4 V_71 = V_70 -> V_71 ;
T_3 V_72 = sizeof( * V_70 ) ;
while ( F_41 ( V_71 ) && V_71 != V_73 ) {
T_3 V_74 = 0 ;
struct V_75 * V_76 ;
if ( V_68 + V_72 + sizeof( * V_76 ) > V_67 -> V_77 &&
! F_42 ( V_67 , V_68 - V_67 -> V_77 + V_72 + sizeof ( * V_76 ) ) )
break;
...
static int
F_44 ( struct V_66 * V_67 , T_4 V_88 , struct V_89 * V_90 ,
...
if ( ( V_101 = sizeof( * V_70 ) + F_47 ( V_70 -> V_115 ) ) > V_107 ) {
V_96 = V_113 ;
V_98 = 0 ;
V_100 = V_107 ;
V_95 = 1 ;
...
static int
F_49 ( struct V_66 * V_67 , struct V_89 * V_90 ,
...
struct V_119 * V_31 ;
struct V_120 V_121 ;
V_54 = F_44 ( V_67 , V_122 , V_90 , & V_96 , & V_98 ,
& V_95 , & V_100 , V_94 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_95 == 0 )
...
if ( ! F_42 ( V_67 , V_94 + sizeof( struct V_117 ) ) )
return 0 ;
V_116 = F_51 ( V_67 , V_129 ) ;
if ( ! V_116 )
return 0 ;
F_52 ( V_116 ) ;
F_53 ( V_116 , V_94 ) ;
F_54 ( V_116 ) ;
V_118 = F_55 ( V_116 ) ;
V_31 = F_56 ( F_29 ( V_67 -> V_8 ) , & V_121 , NULL ,
V_118 -> V_104 , 0 ,
0 , 0 ,
V_122 , F_57 ( V_118 -> V_130 ) , 0 ) ;
if ( F_58 ( V_31 ) )
goto V_55;
...
F_60 ( V_116 , & V_31 -> V_24 ) ;
} else {
F_59 ( V_31 ) ;
if ( F_61 ( V_116 , V_118 -> V_103 , V_118 -> V_104 , V_118 -> V_130 ,
V_116 -> V_8 ) ||
F_62 ( V_116 ) -> V_8 -> type != V_133 )
goto V_55;
}
if ( V_96 == V_123 && V_98 == V_125 ) {
if ( V_100 > F_63 ( F_62 ( V_116 ) ) )
goto V_55;
F_62 ( V_116 ) -> V_27 -> V_134 ( F_62 ( V_116 ) , NULL , V_116 , V_100 ) ;
}
if ( V_96 == V_127 )
F_62 ( V_116 ) -> V_27 -> V_135 ( F_62 ( V_116 ) , NULL , V_116 ) ;
F_64 ( V_116 , V_96 , V_98 , F_65 ( V_100 ) ) ;
V_55:
F_66 ( V_116 ) ;
return 0 ;
}
static int
F_67 ( struct V_66 * V_67 , struct V_89 * V_90 ,
T_5 type , T_5 V_91 , int V_94 , T_7 V_93 )
{
int V_95 = 0 ;
T_5 V_96 = type ;
...
T_6 V_100 = F_50 ( V_93 ) ;
int V_54 ;
V_54 = F_44 ( V_67 , V_136 , V_90 , & V_96 , & V_98 ,
& V_95 , & V_100 , V_94 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_95 && F_42 ( V_67 , V_94 + sizeof( struct V_69 ) ) ) {
struct V_30 * V_31 ;
struct V_66 * V_116 = F_51 ( V_67 , V_129 ) ;
if ( ! V_116 )
return 0 ;
F_52 ( V_116 ) ;
F_53 ( V_116 , V_94 ) ;
F_54 ( V_116 ) ;
V_31 = F_68 ( F_29 ( V_67 -> V_8 ) , & F_69 ( V_116 ) -> V_104 ,
NULL , 0 , 0 ) ;
if ( V_31 && V_31 -> V_24 . V_8 )
V_116 -> V_8 = V_31 -> V_24 . V_8 ;
F_70 ( V_116 , V_96 , V_98 , V_100 ) ;
F_71 ( V_31 ) ;
F_66 ( V_116 ) ;
}
return 0 ;
}
static int F_72 ( const struct V_22 * V_23 ,
const struct V_69 * V_70 ,
struct V_66 * V_67 )
{
T_4 V_137 = F_73 ( V_70 ) & ~ V_138 ;
if ( V_23 -> V_40 . V_43 & V_139 )
F_74 ( F_55 ( V_67 ) , V_138 , V_137 ) ;
return F_75 ( V_70 , V_67 ) ;
}
static int F_76 ( const struct V_22 * V_23 ,
const struct V_69 * V_70 ,
struct V_66 * V_67 )
{
if ( V_23 -> V_40 . V_43 & V_139 )
F_77 ( F_73 ( V_70 ) , F_69 ( V_67 ) ) ;
return F_75 ( V_70 , V_67 ) ;
}
T_6 F_78 ( struct V_22 * V_23 ,
...
if ( ( V_47 -> V_43 & V_150 ) ||
( ( V_47 -> V_43 & V_143 ) &&
( F_78 ( V_23 , V_41 , V_42 ) & V_150 ) ) ) {
struct V_7 * V_152 = NULL ;
if ( V_47 -> V_148 )
V_152 = F_81 ( V_34 , V_47 -> V_148 ) ;
if ( ( F_82 ( V_41 ) ||
F_83 ( F_84 ( V_34 , V_41 , V_152 , 0 ) ) ) &&
F_83 ( ! F_84 ( V_34 , V_42 , NULL , 0 ) ) )
V_151 = 1 ;
}
return V_151 ;
}
static int F_85 ( struct V_66 * V_67 , T_3 V_153 ,
T_4 V_88 ,
int (* F_86)( const struct V_22 * V_23 ,
const struct V_69 * V_70 ,
struct V_66 * V_67 ) )
{
struct V_22 * V_23 ;
const struct V_69 * V_70 = F_69 ( V_67 ) ;
int V_54 ;
F_45 () ;
...
if ( ! F_87 ( NULL , V_155 , V_67 ) ) {
F_48 () ;
goto V_154;
}
if ( ! F_80 ( V_23 , & V_70 -> V_103 , & V_70 -> V_104 ) ) {
V_23 -> V_8 -> V_20 . V_156 ++ ;
F_48 () ;
goto V_154;
}
...
F_54 ( V_67 ) ;
V_67 -> V_153 = F_88 ( V_153 ) ;
memset ( V_67 -> V_159 , 0 , sizeof( struct V_89 ) ) ;
F_89 ( V_67 , V_23 -> V_8 , V_23 -> V_34 ) ;
V_54 = F_86 ( V_23 , V_70 , V_67 ) ;
if ( F_90 ( V_54 ) ) {
if ( V_160 )
F_91 ( L_6 ,
& V_70 -> V_104 ,
...
{
return F_85 ( V_67 , V_163 , V_122 ,
F_72 ) ;
}
static int F_97 ( struct V_66 * V_67 )
{
return F_85 ( V_67 , V_164 , V_136 ,
F_76 ) ;
}
static void F_98 ( struct V_165 * V_90 , T_4 V_112 )
{
...
static inline bool
F_99 ( const struct V_22 * V_23 , const struct V_69 * V_76 )
{
...
if ( V_47 -> V_148 )
V_152 = F_81 ( V_34 , V_47 -> V_148 ) ;
if ( F_90 ( ! F_84 ( V_34 , & V_47 -> V_41 , V_152 , 0 ) ) )
F_101 ( L_7 ,
V_47 -> V_56 ) ;
else if ( ! F_82 ( & V_47 -> V_42 ) &&
F_90 ( F_84 ( V_34 , & V_47 -> V_42 , NULL , 0 ) ) )
F_101 ( L_8 ,
V_47 -> V_56 ) ;
else
V_151 = 1 ;
...
V_24 = F_9 ( V_23 ) ;
if ( ! V_24 ) {
V_173 = F_103 ( V_34 , NULL , V_171 ) ;
if ( V_173 -> error )
goto V_177;
V_173 = F_104 ( V_34 , V_173 , F_105 ( V_171 ) , NULL , 0 ) ;
if ( F_58 ( V_173 ) ) {
V_54 = F_106 ( V_173 ) ;
V_173 = NULL ;
goto V_177;
...
V_107 = V_114 ;
if ( F_62 ( V_67 ) )
F_62 ( V_67 ) -> V_27 -> V_134 ( F_62 ( V_67 ) , NULL , V_67 , V_107 ) ;
if ( V_67 -> V_101 > V_107 ) {
* V_172 = V_107 ;
V_54 = - V_180 ;
goto V_179;
}
F_107 ( V_67 , ! F_108 ( V_23 -> V_34 , F_29 ( V_8 ) ) ) ;
V_175 += F_109 ( V_174 ) ;
if ( F_110 ( V_67 ) < V_175 || F_111 ( V_67 ) ||
( F_112 ( V_67 ) && ! F_113 ( V_67 , 0 ) ) ) {
struct V_66 * V_181 ;
if ( ! ( V_181 = F_114 ( V_67 , V_175 ) ) )
goto V_179;
if ( V_67 -> V_182 )
F_115 ( V_181 , V_67 -> V_182 ) ;
F_116 ( V_67 ) ;
V_67 = V_181 ;
}
if ( V_171 -> V_176 ) {
...
if ( V_112 >= 0 ) {
F_98 ( & V_90 , V_112 ) ;
F_118 ( V_67 , & V_90 . V_27 , & V_105 , NULL ) ;
}
if ( F_83 ( ! V_67 -> V_185 ) ) {
F_119 ( V_67 ) ;
V_67 -> V_185 = 1 ;
}
F_120 ( V_67 , sizeof( struct V_69 ) ) ;
F_54 ( V_67 ) ;
V_70 = F_69 ( V_67 ) ;
F_121 ( V_70 , F_122 ( 0 , V_137 ) ,
F_123 ( V_34 , V_67 , V_171 -> V_186 , false ) ) ;
...
static inline int
F_126 ( struct V_66 * V_67 , struct V_7 * V_8 )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
const struct V_117 * V_189 = F_55 ( V_67 ) ;
int V_112 = - 1 ;
struct V_170 V_171 ;
T_4 V_137 ;
T_6 V_107 ;
...
V_171 . V_186 |= F_65 ( ( T_6 ) V_189 -> V_130 << V_195 )
& V_196 ;
if ( V_23 -> V_40 . V_43 & V_197 )
V_171 . V_176 = V_67 -> V_198 ;
V_54 = F_102 ( V_67 , V_8 , V_137 , & V_171 , V_112 , & V_107 ) ;
if ( V_54 != 0 ) {
if ( V_54 == - V_180 )
F_64 ( V_67 , V_123 , V_125 ,
F_65 ( V_107 ) ) ;
return - 1 ;
}
return 0 ;
...
static inline int
F_128 ( struct V_66 * V_67 , struct V_7 * V_8 )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_69 * V_70 = F_69 ( V_67 ) ;
int V_112 = - 1 ;
...
! F_100 ( V_23 ) || F_99 ( V_23 , V_70 ) )
return - 1 ;
V_94 = F_40 ( V_67 , F_129 ( V_67 ) ) ;
if ( V_94 > 0 ) {
struct V_84 * V_85 ;
V_85 = (struct V_84 * ) & F_129 ( V_67 ) [ V_94 ] ;
if ( V_85 -> V_112 == 0 ) {
F_70 ( V_67 , V_110 ,
V_111 , V_94 + 2 ) ;
return - 1 ;
...
V_171 . V_186 |= F_130 ( V_70 ) ;
if ( V_23 -> V_40 . V_43 & V_197 )
V_171 . V_176 = V_67 -> V_198 ;
V_54 = F_102 ( V_67 , V_8 , V_137 , & V_171 , V_112 , & V_107 ) ;
if ( V_54 != 0 ) {
if ( V_54 == - V_180 )
F_70 ( V_67 , V_113 , 0 , V_107 ) ;
return - 1 ;
}
return 0 ;
}
static T_8
F_131 ( struct V_66 * V_67 , struct V_7 * V_8 )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_6 * V_20 = & V_23 -> V_8 -> V_20 ;
int V_151 ;
switch ( V_67 -> V_153 ) {
case F_88 ( V_163 ) :
V_151 = F_126 ( V_67 , V_8 ) ;
break;
case F_88 ( V_164 ) :
V_151 = F_128 ( V_67 , V_8 ) ;
break;
default:
goto V_200;
}
...
V_47 -> V_43 |= F_78 ( V_23 , & V_47 -> V_41 , & V_47 -> V_42 ) ;
...
if ( V_47 -> V_43 & V_149 ) {
int V_211 = ( F_79 ( & V_47 -> V_42 ) &
( V_145 | V_147 ) ) ;
struct V_30 * V_31 = F_68 ( V_23 -> V_34 ,
& V_47 -> V_42 , & V_47 -> V_41 ,
V_47 -> V_148 , V_211 ) ;
if ( V_31 == NULL )
return;
...
static void
F_137 ( struct V_46 * V_47 , const struct V_213 * V_192 )
{
...
static void
F_138 ( struct V_213 * V_192 , const struct V_46 * V_47 )
{
...
static int
F_139 ( struct V_7 * V_8 , struct V_214 * V_215 , int V_216 )
{
int V_54 = 0 ;
struct V_213 V_47 ;
struct V_46 V_217 ;
...
case V_218 :
if ( V_8 == V_38 -> V_65 ) {
if ( F_140 ( & V_47 , V_215 -> V_219 . V_220 , sizeof( V_47 ) ) ) {
V_54 = - V_221 ;
break;
}
F_137 ( & V_217 , & V_47 ) ;
V_23 = F_36 ( V_34 , & V_217 , 0 ) ;
if ( V_23 == NULL )
V_23 = F_28 ( V_8 ) ;
} else {
...
if ( F_141 ( V_215 -> V_219 . V_220 , & V_47 , sizeof( V_47 ) ) ) {
V_54 = - V_221 ;
}
break;
case V_222 :
...
break;
F_137 ( & V_217 , & V_47 ) ;
V_23 = F_36 ( V_34 , & V_217 , V_216 == V_222 ) ;
...
static int
F_144 ( struct V_7 * V_8 , int V_231 )
{
...
static int T_9 F_150 ( struct V_7 * V_8 )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
...
static int F_151 ( struct V_245 * V_246 [] , struct V_245 * V_77 [] )
{
T_5 V_105 ;
if ( ! V_77 || ! V_77 [ V_247 ] )
return 0 ;
V_105 = F_152 ( V_77 [ V_247 ] ) ;
if ( V_105 != V_136 &&
V_105 != V_122 &&
V_105 != 0 )
return - V_227 ;
...
static void F_153 ( struct V_245 * V_77 [] ,
struct V_46 * V_40 )
{
...
return;
if ( V_77 [ V_248 ] )
V_40 -> V_148 = F_154 ( V_77 [ V_248 ] ) ;
if ( V_77 [ V_249 ] )
F_155 ( & V_40 -> V_41 , V_77 [ V_249 ] ,
sizeof( struct V_1 ) ) ;
if ( V_77 [ V_250 ] )
F_155 ( & V_40 -> V_42 , V_77 [ V_250 ] ,
sizeof( struct V_1 ) ) ;
if ( V_77 [ V_251 ] )
V_40 -> V_187 = F_152 ( V_77 [ V_251 ] ) ;
if ( V_77 [ V_252 ] )
V_40 -> V_112 = F_152 ( V_77 [ V_252 ] ) ;
if ( V_77 [ V_253 ] )
V_40 -> V_207 = F_156 ( V_77 [ V_253 ] ) ;
if ( V_77 [ V_254 ] )
V_40 -> V_43 = F_154 ( V_77 [ V_254 ] ) ;
if ( V_77 [ V_247 ] )
V_40 -> V_105 = F_152 ( V_77 [ V_247 ] ) ;
}
static int F_157 ( struct V_34 * V_255 , struct V_7 * V_8 ,
struct V_245 * V_246 [] , struct V_245 * V_77 [] )
{
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_22 * V_256 ;
V_256 = F_28 ( V_8 ) ;
F_153 ( V_77 , & V_256 -> V_40 ) ;
if ( F_36 ( V_34 , & V_256 -> V_40 , 0 ) )
return - V_228 ;
return F_27 ( V_8 ) ;
}
static int F_158 ( struct V_7 * V_8 , struct V_245 * V_246 [] ,
struct V_245 * V_77 [] )
{
struct V_22 * V_23 = F_28 ( V_8 ) ;
struct V_46 V_47 ;
...
static void F_159 ( struct V_7 * V_8 , struct V_257 * V_258 )
{
struct V_34 * V_34 = F_29 ( V_8 ) ;
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
if ( V_8 != V_38 -> V_65 )
...
static T_10 F_161 ( const struct V_7 * V_8 )
{
return
F_162 ( 4 ) +
F_162 ( sizeof( struct V_1 ) ) +
F_162 ( sizeof( struct V_1 ) ) +
F_162 ( 1 ) +
F_162 ( 1 ) +
F_162 ( 4 ) +
...
static int F_163 ( struct V_66 * V_67 , const struct V_7 * V_8 )
{
struct V_22 * V_259 = F_28 ( V_8 ) ;
struct V_46 * V_260 = & V_259 -> V_40 ;
if ( F_164 ( V_67 , V_248 , V_260 -> V_148 ) ||
F_165 ( V_67 , V_249 , sizeof( struct V_1 ) ,
& V_260 -> V_41 ) ||
F_165 ( V_67 , V_250 , sizeof( struct V_1 ) ,
& V_260 -> V_42 ) ||
F_166 ( V_67 , V_251 , V_260 -> V_187 ) ||
F_166 ( V_67 , V_252 , V_260 -> V_112 ) ||
F_167 ( V_67 , V_253 , V_260 -> V_207 ) ||
F_164 ( V_67 , V_254 , V_260 -> V_43 ) ||
F_166 ( V_67 , V_247 , V_260 -> V_105 ) )
goto V_261;
return 0 ;
V_261:
return - V_180 ;
}
static void T_11 F_168 ( struct V_34 * V_34 )
{
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
...
if ( V_8 -> V_57 == & V_58 )
F_160 ( V_8 , & V_263 ) ;
for ( V_48 = 0 ; V_48 < V_264 ; V_48 ++ ) {
V_23 = F_22 ( V_38 -> V_265 [ V_48 ] ) ;
while ( V_23 != NULL ) {
if ( ! F_108 ( F_29 ( V_23 -> V_8 ) , V_34 ) )
F_160 ( V_23 -> V_8 , & V_263 ) ;
V_23 = F_22 ( V_23 -> V_52 ) ;
}
}
F_171 ( & V_263 ) ;
}
static int T_9 F_172 ( struct V_34 * V_34 )
{
struct V_37 * V_38 = F_14 ( V_34 , V_39 ) ;
struct V_22 * V_23 = NULL ;
int V_54 ;
V_38 -> V_50 [ 0 ] = V_38 -> V_45 ;
V_38 -> V_50 [ 1 ] = V_38 -> V_265 ;
V_54 = - V_244 ;
V_38 -> V_65 = F_34 ( sizeof( struct V_22 ) , L_10 ,
V_60 , V_61 ) ;
if ( ! V_38 -> V_65 )
goto V_266;
F_35 ( V_38 -> V_65 , V_34 ) ;
V_38 -> V_65 -> V_57 = & V_58 ;
V_38 -> V_65 -> V_267 |= V_268 ;
V_54 = F_150 ( V_38 -> V_65 ) ;
if ( V_54 < 0 )
goto V_269;
V_54 = F_173 ( V_38 -> V_65 ) ;
if ( V_54 < 0 )
goto V_269;
V_23 = F_28 ( V_38 -> V_65 ) ;
...
if ( V_54 < 0 )
goto V_271;
V_54 = F_179 ( & V_272 , V_273 ) ;
if ( V_54 < 0 ) {
F_180 ( L_11 , V_274 ) ;
goto V_275;
}
V_54 = F_179 ( & V_276 , V_277 ) ;
if ( V_54 < 0 ) {
F_180 ( L_12 , V_274 ) ;
goto V_278;
}
...
{
F_185 ( & V_58 ) ;
if ( F_182 ( & V_272 , V_273 ) )
F_186 ( L_13 , V_274 ) ;
if ( F_182 ( & V_276 , V_277 ) )
F_186 ( L_14 , V_274 ) ;
F_183 ( & V_270 ) ;
}
