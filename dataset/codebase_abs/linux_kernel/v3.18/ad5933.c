...
static void F_45 ( struct V_88 * V_78 )
{
struct V_8 * V_9 = F_46 ( V_78 ,
...
F_6 ( V_9 , V_90 ) ;
V_9 -> V_77 = V_90 ;
F_38 ( & V_9 -> V_78 , V_9 -> V_91 ) ;
F_22 ( & V_47 -> V_50 ) ;
return;
}
F_4 ( V_9 -> V_2 , V_21 , 1 , & V_89 ) ;
if ( V_89 & V_92 ) {
int V_93 = F_48 ( V_47 -> V_73 ,
V_47 -> V_74 ) ;
F_4 ( V_9 -> V_2 ,
F_49 ( 1 , V_47 -> V_73 ) ?
V_94 : V_95 ,
...
{
int V_6 , V_100 = 0 ;
struct V_101 * V_102 = V_2 -> V_7 . V_103 ;
struct V_8 * V_9 ;
struct V_46 * V_47 ;
...
V_9 -> V_41 = V_9 -> V_102 -> V_41 ;
if ( V_9 -> V_102 -> V_105 ) {
V_9 -> V_28 = V_9 -> V_102 -> V_105 ;
V_9 -> V_14 = V_106 ;
} else {
V_9 -> V_28 = V_107 ;
V_9 -> V_14 = V_108 ;
...
F_58 ( & V_9 -> V_78 , F_45 ) ;
V_9 -> V_91 = F_39 ( V_109 ) ;
V_47 -> V_7 . V_110 = & V_2 -> V_7 ;
V_47 -> V_111 = & V_112 ;
V_47 -> V_113 = V_99 -> V_113 ;
V_47 -> V_86 = V_114 ;
V_47 -> V_115 = V_116 ;
V_47 -> V_117 = F_59 ( V_116 ) ;
V_6 = F_42 ( V_47 ) ;
if ( V_6 )
goto V_118;
V_6 = F_60 ( V_47 , V_116 ,
...
if ( V_6 )
goto V_119;
F_61 ( V_47 , V_47 -> V_82 , 0 ) ;
F_61 ( V_47 , V_47 -> V_82 , 1 ) ;
V_6 = F_14 ( V_9 ) ;
if ( V_6 )
goto V_120;
V_6 = F_62 ( V_47 ) ;
