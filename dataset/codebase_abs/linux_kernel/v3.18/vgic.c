...
static bool F_115 ( struct V_26 * V_26 , int V_15 ,
...
{
if ( F_118 ( F_119 ( V_26 ) ) &&
F_115 ( V_26 , V_15 , V_149 , V_147 ) )
F_84 ( V_26 ) ;
return 0 ;
}
static T_6 F_120 ( int V_18 , void * V_44 )
{
return V_153 ;
}
...
static int F_122 ( struct V_22 * V_23 , int V_4 )
{
struct V_38 * V_38 = & V_23 -> V_27 . V_38 ;
int V_154 = ( V_4 - V_6 ) / 8 ;
V_38 -> V_40 = F_3 ( V_154 , V_8 ) ;
V_38 -> V_131 = F_3 ( V_4 , V_8 ) ;
...
F_11 ( & V_25 -> V_30 ,
V_23 -> V_31 , V_65 , V_32 ) ;
V_38 -> V_131 [ V_65 ] = V_132 ;
}
V_38 -> V_134 = V_28 -> V_134 ;
F_99 ( V_23 ) ;
}
void F_124 ( struct V_26 * V_26 )
{
struct V_24 * V_25 = & V_26 -> V_27 . V_28 ;
struct V_22 * V_23 ;
int V_65 ;
...
static int F_125 ( struct V_26 * V_26 )
{
struct V_24 * V_25 = & V_26 -> V_27 . V_28 ;
struct V_22 * V_23 ;
int V_3 , V_4 ;
...
if ( F_119 ( V_26 ) )
goto V_152;
if ( F_129 ( V_26 -> V_27 . V_28 . V_98 ) ||
F_129 ( V_26 -> V_27 . V_28 . V_158 ) ) {
F_126 ( L_11 ) ;
V_151 = - V_159 ;
goto V_152;
}
...
V_151 = F_130 ( V_26 , V_26 -> V_27 . V_28 . V_158 ,
V_28 -> V_160 , V_161 ,
true ) ;
if ( V_151 ) {
F_126 ( L_13 ) ;
...
V_199 ;
F_128 ( & V_193 -> V_26 -> V_104 ) ;
V_151 = F_125 ( V_193 -> V_26 ) ;
if ( V_151 )
goto V_152;
...
return - V_156 ;
F_128 ( & V_193 -> V_26 -> V_104 ) ;
if ( F_119 ( V_193 -> V_26 ) || V_193 -> V_26 -> V_27 . V_28 . V_4 )
V_151 = - V_166 ;
else
...
if ( V_151 )
return V_151 ;
V_151 = F_160 ( V_28 -> V_212 , F_120 ,
L_15 , F_161 () ) ;
if ( V_151 ) {
F_126 ( L_16 , V_28 -> V_212 ) ;
return V_151 ;
}
V_151 = F_162 ( & V_227 ) ;
if ( V_151 ) {
