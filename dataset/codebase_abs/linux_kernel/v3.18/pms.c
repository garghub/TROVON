...
V_62 = V_13 - V_58 ;
V_57 += V_2 -> V_49 ;
if ( F_44 ( V_53 , V_18 + 32 , V_62 ) )
return V_58 ? V_58 : - V_63 ;
V_53 += V_62 ;
V_58 += V_62 ;
}
}
...
static int F_46 ( struct V_64 * V_64 , void * V_65 ,
struct V_66 * V_67 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
F_48 ( V_67 -> V_68 , V_2 -> V_69 . V_70 , sizeof( V_67 -> V_68 ) ) ;
F_48 ( V_67 -> V_71 , L_1 , sizeof( V_67 -> V_71 ) ) ;
snprintf ( V_67 -> V_72 , sizeof( V_67 -> V_72 ) ,
L_2 , V_2 -> V_69 . V_70 ) ;
V_67 -> V_73 = V_74 | V_75 ;
V_67 -> V_76 = V_67 -> V_73 | V_77 ;
return 0 ;
}
static int F_49 ( struct V_64 * V_64 , void * V_78 , struct V_79 * V_80 )
{
...
if ( V_80 -> V_3 > 3 )
return - V_82 ;
F_48 ( V_80 -> V_70 , V_81 [ V_80 -> V_3 ] , sizeof( V_80 -> V_70 ) ) ;
V_80 -> type = V_83 ;
V_80 -> V_84 = 0 ;
V_80 -> V_85 = 0 ;
V_80 -> V_44 = V_86 ;
...
static int F_50 ( struct V_64 * V_64 , void * V_78 , unsigned int * V_88 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
* V_88 = V_2 -> V_52 ;
return 0 ;
}
static int F_51 ( struct V_64 * V_64 , void * V_78 , unsigned int V_88 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
if ( V_88 > 3 )
return - V_82 ;
...
static int F_52 ( struct V_64 * V_64 , void * V_78 , T_4 * V_44 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
* V_44 = V_2 -> V_44 ;
return 0 ;
}
static int F_53 ( struct V_64 * V_64 , void * V_78 , T_4 V_44 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
int V_89 = 0 ;
V_2 -> V_44 = V_44 ;
...
static int F_54 ( struct V_93 * V_94 )
{
struct V_1 * V_2 = F_55 ( V_94 -> V_95 , struct V_1 , V_96 ) ;
int V_89 = 0 ;
switch ( V_94 -> V_97 ) {
case V_98 :
F_14 ( V_2 , V_94 -> V_99 ) ;
...
static int F_56 ( struct V_64 * V_64 , void * V_78 , struct V_103 * V_104 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
struct V_105 * V_106 = & V_104 -> V_104 . V_106 ;
V_106 -> V_48 = V_2 -> V_48 ;
V_106 -> V_49 = V_2 -> V_49 ;
V_106 -> V_107 = V_2 -> V_48 == 15 ?
V_108 : V_109 ;
V_106 -> V_110 = V_111 ;
V_106 -> V_112 = 2 * V_2 -> V_48 ;
V_106 -> V_113 = 2 * V_2 -> V_48 * V_2 -> V_49 ;
V_106 -> V_114 = V_115 ;
return 0 ;
}
static int F_57 ( struct V_64 * V_64 , void * V_78 , struct V_103 * V_104 )
{
struct V_105 * V_106 = & V_104 -> V_104 . V_106 ;
if ( V_106 -> V_49 < 16 || V_106 -> V_49 > 480 )
return - V_82 ;
if ( V_106 -> V_48 < 16 || V_106 -> V_48 > 640 )
return - V_82 ;
if ( V_106 -> V_107 != V_108 &&
V_106 -> V_107 != V_109 )
return - V_82 ;
V_106 -> V_110 = V_111 ;
V_106 -> V_112 = 2 * V_106 -> V_48 ;
V_106 -> V_113 = 2 * V_106 -> V_48 * V_106 -> V_49 ;
V_106 -> V_114 = V_115 ;
return 0 ;
}
static int F_58 ( struct V_64 * V_64 , void * V_78 , struct V_103 * V_104 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
struct V_105 * V_106 = & V_104 -> V_104 . V_106 ;
int V_89 = F_57 ( V_64 , V_78 , V_104 ) ;
if ( V_89 )
return V_89 ;
V_2 -> V_48 = V_106 -> V_48 ;
V_2 -> V_49 = V_106 -> V_49 ;
V_2 -> V_116 = ( V_106 -> V_107 == V_108 ) ? 15 : 16 ;
F_38 ( V_2 , V_2 -> V_48 , V_2 -> V_49 ) ;
return 0 ;
}
static int F_59 ( struct V_64 * V_64 , void * V_78 , struct V_117 * V_104 )
{
...
enum V_119 type = V_104 -> type ;
if ( V_104 -> V_3 > 1 )
return - V_82 ;
* V_104 = V_118 [ V_104 -> V_3 ] ;
V_104 -> type = type ;
return 0 ;
}
static T_5 F_60 ( struct V_64 * V_64 , char T_3 * V_53 ,
T_6 V_13 , T_7 * V_120 )
{
struct V_1 * V_2 = F_47 ( V_64 ) ;
int V_58 ;
V_58 = F_40 ( V_2 , V_53 , ( V_2 -> V_116 == 15 ) , V_13 ) ;
return V_58 ;
}
static unsigned int F_61 ( struct V_64 * V_64 , struct V_121 * V_122 )
{
struct V_123 * V_78 = V_64 -> V_124 ;
unsigned int V_125 = V_126 | V_127 ;
if ( F_62 ( V_78 ) )
V_125 |= V_128 ;
F_63 ( V_64 , & V_78 -> V_122 , V_122 ) ;
return V_125 ;
}
...
static int F_70 ( struct V_138 * V_139 , unsigned int V_71 )
{
struct V_1 * V_2 ;
struct V_140 * V_69 ;
struct V_141 * V_96 ;
...
F_79 ( & V_2 -> V_148 ) ;
F_48 ( V_2 -> V_149 . V_70 , V_69 -> V_70 , sizeof( V_2 -> V_149 . V_70 ) ) ;
V_2 -> V_149 . V_69 = V_69 ;
V_2 -> V_149 . V_150 = V_96 ;
V_2 -> V_149 . V_151 = & V_152 ;
V_2 -> V_149 . V_153 = & V_154 ;
V_2 -> V_149 . V_155 = V_156 ;
V_2 -> V_149 . V_148 = & V_2 -> V_148 ;
V_2 -> V_149 . V_157 = V_90 | V_91 | V_92 ;
F_80 ( & V_2 -> V_149 , V_2 ) ;
V_2 -> V_44 = V_158 ;
V_2 -> V_49 = 240 ;
V_2 -> V_48 = 320 ;
...
F_39 ( V_2 , 0 ) ;
F_81 ( V_96 ) ;
V_125 = F_82 ( & V_2 -> V_149 , V_159 , V_160 ) ;
if ( V_125 >= 0 )
return 0 ;
V_147:
F_83 ( V_96 ) ;
...
static int F_85 ( struct V_138 * V_139 , unsigned int V_71 )
{
struct V_1 * V_2 = F_86 ( V_139 ) ;
F_87 ( & V_2 -> V_149 ) ;
F_83 ( & V_2 -> V_96 ) ;
F_69 ( V_2 -> V_5 , 3 ) ;
F_69 ( 0x9a01 , 1 ) ;
