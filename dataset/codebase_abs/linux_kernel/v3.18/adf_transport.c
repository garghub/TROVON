...
{
struct V_13 * V_14 = ( void * ) V_69 ;
F_49 ( V_14 ) ;
F_52 ( V_14 -> V_19 , V_14 -> V_20 ,
V_14 -> V_18 ) ;
}
static inline int F_53 ( struct V_37 * V_38 ,
const char * V_48 , const char * V_70 ,
T_1 V_71 , T_1 * V_72 )
{
char V_73 [ V_74 ] ;
char V_75 [ V_58 ] ;
snprintf ( V_73 , V_74 , V_70 , V_71 ) ;
if ( F_43 ( V_38 , V_48 , V_73 , V_75 ) )
return - V_6 ;
if ( F_44 ( V_75 , 10 , V_72 ) )
return - V_6 ;
return 0 ;
}
static void F_54 ( struct V_13 * V_14 ,
const char * V_48 , T_1 V_76 )
{
if ( F_53 ( V_14 -> V_38 , V_48 ,
V_77 ,
V_76 , & V_14 -> V_21 ) )
V_14 -> V_21 = V_78 ;
if ( V_79 < V_14 -> V_21 ||
...
T_1 V_87 = 0 ;
int V_9 , V_60 ;
V_86 = F_56 ( sizeof( * V_86 ) , V_45 ,
F_57 ( & F_33 ( V_38 ) ) ) ;
if ( ! V_86 )
return - V_46 ;
V_87 = F_41 ( V_38 ) ;
V_5 = V_87 * sizeof( struct V_13 ) ;
V_86 -> V_62 = F_56 ( V_5 , V_45 ,
F_57 ( & F_33 ( V_38 ) ) ) ;
if ( ! V_86 -> V_62 ) {
V_60 = - V_46 ;
goto V_88;
...
V_60 = F_55 ( V_38 , & V_86 -> V_62 [ V_9 ] , V_9 ,
V_19 ) ;
if ( V_60 )
goto V_97;
}
...
struct V_37 * V_38 = V_14 -> V_38 ;
struct V_39 * V_40 = V_38 -> V_41 ;
struct V_22 * V_15 = & V_14 -> V_63 [ V_9 ] ;
if ( V_14 -> V_17 & ( 1 << V_9 ) )
F_39 ( V_15 ) ;
if ( V_40 -> V_47 & ( 1 << V_9 ) )
F_60 ( V_15 -> V_24 ) ;
...
{
struct V_54 * V_86 = V_38 -> V_56 ;
T_1 V_9 , V_87 = F_41 ( V_38 ) ;
for ( V_9 = 0 ; V_9 < V_87 ; V_9 ++ )
F_64 ( & V_86 -> V_62 [ V_9 ] ) ;
}
