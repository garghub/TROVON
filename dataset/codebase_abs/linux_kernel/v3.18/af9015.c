...
if ( F_20 ( & V_6 -> V_129 ) )
return - V_54 ;
V_7 = V_6 -> V_132 [ F_33 ( V_120 ) -> V_124 ] ( V_120 , V_131 ) ;
F_8 ( & V_6 -> V_129 ) ;
return V_7 ;
}
...
if ( F_20 ( & V_6 -> V_129 ) )
return - V_54 ;
V_7 = V_6 -> V_133 [ F_33 ( V_120 ) -> V_124 ] ( V_120 ) ;
F_8 ( & V_6 -> V_129 ) ;
return V_7 ;
}
...
T_1 V_137 [ 4 ] ;
T_1 V_38 , V_51 ;
struct V_3 V_4 = { V_28 , 0 , 0x5100 , 0 , 0 , sizeof( V_137 ) ,
V_137 } ;
F_23 ( & V_2 -> V_31 -> V_32 , L_5 , V_62 ) ;
V_137 [ 0 ] = V_6 -> V_70 >> 8 ;
V_137 [ 1 ] = V_6 -> V_70 & 0xff ;
V_137 [ 2 ] = V_6 -> V_71 >> 8 ;
V_137 [ 3 ] = V_6 -> V_71 & 0xff ;
F_43 ( 100 ) ;
...
static int F_44 ( struct V_139 * V_47 )
{
int V_7 ;
struct V_5 * V_6 = F_45 ( V_47 ) ;
if ( V_47 -> V_124 == 0 ) {
V_6 -> V_42 [ 0 ] . V_140 = V_141 ;
memcpy ( V_6 -> V_42 [ 0 ] . V_142 , L_30 , 4 ) ;
V_6 -> V_42 [ 0 ] . V_109 [ 0 ] = V_143 ;
V_6 -> V_42 [ 0 ] . V_109 [ 3 ] = V_144 ;
} else if ( V_47 -> V_124 == 1 ) {
V_6 -> V_42 [ 1 ] . V_140 = V_145 ;
memcpy ( V_6 -> V_42 [ 1 ] . V_142 , L_30 , 4 ) ;
V_6 -> V_42 [ 1 ] . V_109 [ 0 ] = V_144 ;
...
V_47 -> V_120 [ 0 ] = F_47 ( V_146 ,
& V_6 -> V_42 [ V_47 -> V_124 ] , & F_46 ( V_47 ) -> V_147 ) ;
if ( V_47 -> V_120 [ 0 ] ) {
V_6 -> V_130 [ V_47 -> V_124 ] =
V_47 -> V_120 [ 0 ] -> V_148 . V_130 ;
V_47 -> V_120 [ 0 ] -> V_148 . V_130 =
F_35 ;
V_6 -> V_132 [ V_47 -> V_124 ] =
V_47 -> V_120 [ 0 ] -> V_148 . V_132 ;
V_47 -> V_120 [ 0 ] -> V_148 . V_132 =
F_37 ;
V_6 -> V_133 [ V_47 -> V_124 ] = V_47 -> V_120 [ 0 ] -> V_148 . V_133 ;
V_47 -> V_120 [ 0 ] -> V_148 . V_133 = F_38 ;
V_6 -> V_134 [ V_47 -> V_124 ] = V_47 -> V_120 [ 0 ] -> V_148 . V_134 ;
V_47 -> V_120 [ 0 ] -> V_148 . V_134 = F_39 ;
}
return V_47 -> V_120 [ 0 ] == NULL ? - V_111 : 0 ;
}
static int F_48 ( struct V_139 * V_47 )
{
...
case V_96 :
case V_99 :
V_7 = F_47 ( V_149 , V_47 -> V_120 [ 0 ] ,
& F_46 ( V_47 ) -> V_147 , & V_150 ,
V_6 -> V_92 [ V_47 -> V_124 ] )
== NULL ? - V_111 : 0 ;
break;
case V_97 :
case V_101 :
V_7 = F_47 ( V_151 , V_47 -> V_120 [ 0 ] ,
& F_46 ( V_47 ) -> V_147 ,
& V_152 ) == NULL ? - V_111 : 0 ;
break;
case V_100 :
V_7 = F_47 ( V_153 , V_47 -> V_120 [ 0 ] , 0xc0 ,
& F_46 ( V_47 ) -> V_147 ,
& V_154 ) == NULL ? - V_111 : 0 ;
break;
case V_102 :
V_7 = F_47 ( V_155 , V_47 -> V_120 [ 0 ] ,
& F_46 ( V_47 ) -> V_147 ,
& V_156 ) == NULL ? - V_111 : 0 ;
break;
case V_104 :
V_7 = F_47 ( V_157 , V_47 -> V_120 [ 0 ] ,
& F_46 ( V_47 ) -> V_147 ,
& V_158 ) == NULL ? - V_111 : 0 ;
break;
case V_105 :
...
break;
case V_95 :
V_7 = F_47 ( V_160 , V_47 -> V_120 [ 0 ] , 0xc0 ,
& F_46 ( V_47 ) -> V_147 ,
V_161 ) == NULL ? - V_111 : 0 ;
break;
case V_108 :
V_7 = F_47 ( V_162 , V_47 -> V_120 [ 0 ] ,
& F_46 ( V_47 ) -> V_147 ,
& V_163 ) == NULL ? - V_111 : 0 ;
break;
case V_107 :
V_7 = F_47 ( V_164 , V_47 -> V_120 [ 0 ] ,
& F_46 ( V_47 ) -> V_147 ,
0xc0 , & V_165 ) == NULL ? - V_111 : 0 ;
break;
case V_98 :
default:
...
if ( V_47 -> V_120 [ 0 ] -> V_148 . V_166 . V_133 ) {
V_6 -> V_135 [ V_47 -> V_124 ] =
V_47 -> V_120 [ 0 ] -> V_148 . V_166 . V_133 ;
V_47 -> V_120 [ 0 ] -> V_148 . V_166 . V_133 = F_40 ;
}
if ( V_47 -> V_120 [ 0 ] -> V_148 . V_166 . V_134 ) {
V_6 -> V_136 [ V_47 -> V_124 ] =
V_47 -> V_120 [ 0 ] -> V_148 . V_166 . V_134 ;
V_47 -> V_120 [ 0 ] -> V_148 . V_166 . V_134 = F_41 ;
}
return V_7 ;
}
static int F_49 ( struct V_139 * V_47 , int V_167 )
{
struct V_1 * V_2 = F_46 ( V_47 ) ;
int V_7 ;
F_23 ( & V_2 -> V_31 -> V_32 , L_35 , V_62 , V_167 ) ;
if ( V_167 )
...
static int F_50 ( struct V_139 * V_47 , int V_168 , T_2 V_169 ,
int V_167 )
{
struct V_1 * V_2 = F_46 ( V_47 ) ;
int V_7 ;
...
V_62 , V_168 , V_169 , V_167 ) ;
V_7 = F_11 ( V_2 , 0xd505 , ( V_169 & 0xff ) ) ;
if ( V_7 )
goto error;
V_7 = F_11 ( V_2 , 0xd506 , ( V_169 >> 8 ) ) ;
if ( V_7 )
goto error;
V_170 = ( ( V_168 & 0x1f ) | ( 1 << 5 ) ) ;
V_7 = F_11 ( V_2 , 0xd504 , V_170 ) ;
error:
return V_7 ;
}
...
V_7 = F_11 ( V_2 , 0xdd88 , V_171 & 0xff ) ;
if ( V_7 )
goto error;
V_7 = F_11 ( V_2 , 0xdd89 , V_171 >> 8 ) ;
if ( V_7 )
goto error;
V_7 = F_11 ( V_2 , 0xdd8a , V_171 & 0xff ) ;
if ( V_7 )
goto error;
V_7 = F_11 ( V_2 , 0xdd8b , V_171 >> 8 ) ;
if ( V_7 )
goto error;
V_7 = F_11 ( V_2 , 0xdd0c , V_172 ) ;
if ( V_7 )
goto error;
V_7 = F_11 ( V_2 , 0xdd0d , V_172 ) ;
if ( V_7 )
goto error;
...
if ( ( V_6 -> V_179 != V_12 [ 6 ] || V_12 [ 0 ] ) &&
! memcmp ( & V_12 [ 12 ] , V_6 -> V_180 , 4 ) ) {
...
if ( V_7 )
goto error;
memcpy ( V_6 -> V_180 , & V_12 [ 12 ] , 4 ) ;
if ( V_12 [ 14 ] == ( T_1 ) ~ V_12 [ 15 ] ) {
if ( V_12 [ 12 ] == ( T_1 ) ~ V_12 [ 13 ] ) {
V_6 -> V_182 = F_56 ( V_12 [ 12 ] ,
V_12 [ 14 ] ) ;
} else {
V_6 -> V_182 = F_57 ( V_12 [ 12 ] << 8 |
V_12 [ 13 ] ,
V_12 [ 14 ] ) ;
}
} else {
V_6 -> V_182 = F_58 ( V_12 [ 12 ] << 24 |
V_12 [ 13 ] << 16 |
V_12 [ 14 ] << 8 |
V_12 [ 15 ] ) ;
}
F_59 ( V_2 -> V_181 , V_183 , V_6 -> V_182 , 0 ) ;
} else {
F_23 ( & V_2 -> V_31 -> V_32 , L_42 , V_62 ) ;
V_6 -> V_180 [ 2 ] = V_6 -> V_180 [ 3 ] ;
}
V_6 -> V_179 = V_12 [ 6 ] ;
V_6 -> V_184 = false ;
error:
...
static int F_61 ( struct V_1 * V_2 , struct V_185 * V_186 )
{
struct V_5 * V_6 = F_4 ( V_2 ) ;
T_2 V_187 = F_30 ( V_2 -> V_31 -> V_113 . V_114 ) ;
if ( V_6 -> V_80 == V_188 )
return 0 ;
if ( ! V_186 -> V_189 )
V_186 -> V_189 = F_54 ( V_190 ,
V_191 ) ;
if ( ! V_186 -> V_189 )
V_186 -> V_189 = F_54 ( V_6 -> V_75 ,
V_192 ) ;
if ( ! V_186 -> V_189 && V_187 == V_193 ) {
char V_194 [ 10 ] ;
memset ( V_194 , 0 , sizeof( V_194 ) ) ;
F_62 ( V_2 -> V_31 , V_2 -> V_31 -> V_113 . V_195 ,
V_194 , sizeof( V_194 ) ) ;
if ( ! strcmp ( L_44 , V_194 ) ) {
V_186 -> V_189 = F_54 (
V_196 ,
V_191 ) ;
}
...
const struct V_204 * V_124 )
{
struct V_205 * V_31 = F_64 ( V_203 ) ;
char V_194 [ sizeof( L_45 ) ] ;
memset ( V_194 , 0 , sizeof( V_194 ) ) ;
F_62 ( V_31 , V_31 -> V_113 . V_195 ,
V_194 , sizeof( V_194 ) ) ;
if ( ( F_30 ( V_31 -> V_113 . V_114 ) == V_206 ) &&
( F_30 ( V_31 -> V_113 . V_116 ) == 0x0099 ) ) {
if ( ! strcmp ( L_45 , V_194 ) ) {
F_23 ( & V_31 -> V_32 , L_46 , V_62 ) ;
return - V_111 ;
}
}
return F_65 ( V_203 , V_124 ) ;
}
