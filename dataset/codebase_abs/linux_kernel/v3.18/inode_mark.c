...
V_25 = F_31 ( V_13 -> V_9 , V_3 -> V_9 ) ;
if ( V_25 < 0 )
continue;
F_32 ( & V_3 -> V_8 . V_12 , & V_13 -> V_8 . V_12 ) ;
goto V_27;
}
F_9 ( V_23 == NULL ) ;
F_33 ( & V_3 -> V_8 . V_12 , & V_23 -> V_8 . V_12 ) ;
V_27:
F_1 ( V_1 ) ;
F_6 ( & V_1 -> V_5 ) ;
return V_24 ;
...
F_6 ( & V_31 -> V_5 ) ;
V_31 = F_37 ( V_31 -> V_40 . V_41 ,
struct V_1 , V_40 ) ;
}
F_6 ( & V_33 ) ;
if ( V_34 )
F_38 ( V_34 ) ;
F_39 ( V_1 , V_42 , V_1 , V_43 , NULL , 0 ) ;
F_40 ( V_1 ) ;
F_38 ( V_1 ) ;
F_5 ( & V_33 ) ;
}
