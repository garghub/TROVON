...
F_26 ( V_83 ) ;
F_107 ( & V_83 -> V_62 . V_85 , & V_35 -> V_101 . V_188 ) ;
F_72 ( & V_35 -> V_101 . V_130 ) ;
if ( V_185 )
F_52 ( V_185 ) ;
...
int V_60 , T_3 V_45 , int V_191 , int * V_192 )
{
struct V_54 * V_81 , * V_193 ;
struct V_110 * V_157 ;
* V_192 = - V_194 ;
...
static inline int
F_111 ( struct V_35 * V_35 , T_4 type , bool V_195 )
{
int V_60 , V_192 = 0 ;
...
int F_113 ( struct V_35 * V_35 , T_4 type , bool V_195 )
{
int V_60 , V_192 = 0 , V_135 = 0 ;
F_71 ( & V_35 -> V_101 . V_130 ) ;
V_192 = F_111 ( V_35 , type , V_195 ) ;
if ( V_192 )
goto V_64;
for ( V_60 = 0 ; V_60 < V_147 ; V_60 ++ ) {
struct V_54 * V_81 ;
...
V_41 = F_117 ( & V_35 -> V_101 . V_188 , struct V_199 , V_85 ) ;
else
V_41 = F_118 ( & V_62 -> V_62 . V_85 , struct V_199 , V_85 ) ;
...
if ( V_203 )
V_193 = F_126 ( V_81 -> V_95 , V_4 -> V_205 ,
V_60 ) ;
return V_193 ;
}
...
V_193 = NULL ;
F_88 (pol, chain, bydst) {
V_192 = F_125 ( V_81 , V_4 , type , V_28 , V_60 ) ;
if ( V_192 ) {
if ( V_192 == - V_198 )
continue;
else {
...
T_4 V_60 , struct V_79 * V_212 , void * V_190 )
{
struct V_54 * V_81 ;
if ( V_212 )
...
struct V_110 * V_157 = F_57 ( V_35 , & V_81 -> V_123 ,
V_81 -> V_28 , V_60 ) ;
F_107 ( & V_81 -> V_62 . V_85 , & V_35 -> V_101 . V_188 ) ;
F_64 ( & V_81 -> V_86 , V_157 ) ;
F_64 ( & V_81 -> V_87 , V_35 -> V_101 . V_133 + F_54 ( V_35 , V_81 -> V_65 ) ) ;
V_35 -> V_101 . V_136 [ V_60 ] ++ ;
F_26 ( V_81 ) ;
if ( F_75 ( V_35 , V_60 , NULL ) )
F_90 ( & V_35 -> V_101 . V_154 ) ;
}
static struct V_54 * F_106 ( struct V_54 * V_81 ,
int V_60 )
{
struct V_35 * V_35 = V_84 ( V_81 ) ;
if ( F_140 ( & V_81 -> V_86 ) )
...
int F_142 ( struct V_213 * V_214 , int V_60 , struct V_54 * V_81 )
{
struct V_35 * V_35 = V_84 ( V_81 ) ;
struct V_54 * V_218 ;
#ifdef F_131
...
F_139 ( V_81 , V_147 + V_60 ) ;
}
if ( V_218 ) {
if ( V_81 )
F_93 ( V_218 , V_81 ) ;
F_106 ( V_218 , V_147 + V_60 ) ;
}
F_72 ( & V_35 -> V_101 . V_130 ) ;
if ( V_218 ) {
F_52 ( V_218 ) ;
...
static struct V_54 * F_143 ( const struct V_54 * V_175 , int V_60 )
{
...
F_71 ( & V_35 -> V_101 . V_130 ) ;
F_139 ( V_219 , V_147 + V_60 ) ;
F_72 ( & V_35 -> V_101 . V_130 ) ;
F_28 ( V_219 ) ;
}
return V_219 ;
}
int F_145 ( struct V_213 * V_214 )
{
struct V_54 * V_225 = V_214 -> V_215 [ 0 ] ,
* V_172 = V_214 -> V_215 [ 1 ] ;
V_214 -> V_215 [ 0 ] = V_214 -> V_215 [ 1 ] = NULL ;
if ( V_225 && ( V_214 -> V_215 [ 0 ] = F_143 ( V_225 , 0 ) ) == NULL )
return - V_226 ;
if ( V_172 && ( V_214 -> V_215 [ 1 ] = F_143 ( V_172 , 1 ) ) == NULL )
return - V_226 ;
return 0 ;
}
static int
F_146 ( struct V_35 * V_35 , T_1 * V_227 , T_1 * V_228 ,
unsigned short V_28 )
{
int V_192 ;
...
if ( F_9 ( V_32 == NULL ) )
return - V_202 ;
V_192 = V_32 -> V_229 ( V_35 , V_227 , V_228 ) ;
F_13 ( V_32 ) ;
return V_192 ;
}
static int
F_147 ( struct V_54 * V_83 , const struct V_3 * V_4 ,
...
V_227 = & V_231 -> V_12 ;
if ( F_148 ( V_227 , V_231 -> V_235 ) ) {
error = F_146 ( V_35 , & V_118 , V_228 , V_231 -> V_235 ) ;
if ( error )
goto V_206;
V_227 = & V_118 ;
}
}
V_41 = F_149 ( V_228 , V_227 , V_4 , V_231 , V_83 , & error , V_28 ) ;
...
static int
F_151 ( struct V_54 * * V_242 , int V_243 , const struct V_3 * V_4 ,
struct V_40 * * V_101 , unsigned short V_28 )
{
...
V_193 = F_147 ( V_242 [ V_129 ] , V_4 , & V_246 [ V_247 ] , V_28 ) ;
if ( V_193 < 0 ) {
error = V_193 ;
goto V_206;
} else
...
static inline int F_153 ( const struct V_3 * V_4 , int V_28 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
int V_36 ;
if ( ! V_32 )
...
static struct V_79 * F_154 ( struct V_79 * V_80 )
{
...
static int F_157 ( struct V_79 * V_80 )
{
struct V_250 * V_251 = F_31 ( V_80 , struct V_250 , V_80 ) ;
struct V_34 * V_37 = & V_251 -> V_7 . V_37 ;
if ( ! V_251 -> V_252 )
...
static void F_158 ( struct V_79 * V_80 )
{
struct V_250 * V_251 = F_31 ( V_80 , struct V_250 , V_80 ) ;
struct V_34 * V_37 = & V_251 -> V_7 . V_37 ;
F_159 ( V_37 ) ;
}
static inline struct V_250 * F_160 ( struct V_35 * V_35 , int V_28 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
struct V_255 * V_255 ;
struct V_250 * V_251 ;
...
V_251 = F_162 ( V_255 , NULL , 0 , V_259 , 0 ) ;
if ( F_163 ( V_251 ) ) {
struct V_34 * V_37 = & V_251 -> V_7 . V_37 ;
...
static inline int F_164 ( struct V_250 * V_262 , struct V_34 * V_37 ,
int V_263 )
{
struct V_31 * V_32 =
F_8 ( V_37 -> V_93 -> V_28 ) ;
...
if ( ! V_32 )
return - V_202 ;
V_192 = V_32 -> V_264 ( V_262 , V_37 , V_263 ) ;
F_13 ( V_32 ) ;
return V_192 ;
}
static inline int F_165 ( struct V_250 * V_251 , struct V_265 * V_266 ,
const struct V_3 * V_4 )
{
struct V_31 * V_32 =
...
if ( ! V_32 )
return - V_202 ;
V_192 = V_32 -> V_267 ( V_251 , V_266 , V_4 ) ;
F_13 ( V_32 ) ;
return V_192 ;
}
static struct V_34 * F_166 ( struct V_54 * V_83 ,
...
struct V_250 * V_251 = F_160 ( V_35 , V_28 ) ;
...
static int F_175 ( void * * V_291 , const void * V_292 , int V_293 )
{
if ( ! * V_291 ) {
* V_291 = F_176 ( V_293 , V_220 ) ;
if ( ! * V_291 )
return - V_226 ;
}
...
static int F_177 ( struct V_34 * V_37 ,
const struct V_1 * V_2 )
{
#ifdef F_131
struct V_250 * V_251 = (struct V_250 * ) V_37 ;
return F_175 ( ( void * * ) & ( V_251 -> V_294 ) ,
V_2 , sizeof( * V_2 ) ) ;
#else
return 0 ;
#endif
...
#ifdef F_131
struct V_250 * V_251 = (struct V_250 * ) V_37 ;
return F_175 ( ( void * * ) & ( V_251 -> V_295 ) , V_4 , sizeof( * V_4 ) ) ;
#else
return 0 ;
#endif
}
static int F_179 ( const struct V_3 * V_4 , T_5 V_28 ,
struct V_54 * * V_242 ,
int * V_296 , int * V_253 )
{
int V_129 ;
...
static struct V_250 *
F_181 ( struct V_54 * * V_242 , int V_296 ,
...
struct V_250 * V_251 ;
int V_192 ;
V_192 = F_151 ( V_242 , V_296 , V_4 , V_101 , V_28 ) ;
if ( V_192 <= 0 ) {
if ( V_192 != 0 && V_192 != - V_240 )
F_182 ( V_35 , V_299 ) ;
return F_15 ( V_192 ) ;
}
V_37 = F_166 ( V_242 [ 0 ] , V_101 , V_192 , V_4 , V_298 ) ;
if ( F_18 ( V_37 ) ) {
F_182 ( V_35 , V_300 ) ;
return F_135 ( V_37 ) ;
}
...
V_251 -> V_253 = V_192 ;
if ( V_296 > 1 )
V_192 = F_177 ( V_37 , & V_242 [ 1 ] -> V_123 ) ;
else
V_192 = F_178 ( V_37 , V_4 ) ;
if ( F_9 ( V_192 ) ) {
F_159 ( V_37 ) ;
F_182 ( V_35 , V_301 ) ;
return F_15 ( V_192 ) ;
...
V_251 -> V_302 = F_183 ( & V_242 [ 0 ] -> V_100 ) ;
return V_251 ;
}
...
struct V_3 V_4 ;
struct V_96 V_97 ;
F_184 ( & V_178 -> V_90 . V_61 ) ;
V_99 = F_185 ( & V_178 -> V_90 ) ;
if ( ! V_99 ) {
F_186 ( & V_178 -> V_90 . V_61 ) ;
goto V_64;
}
V_37 = F_187 ( V_99 ) ;
V_214 = V_99 -> V_214 ;
F_188 ( V_99 , & V_4 , V_37 -> V_93 -> V_28 ) ;
F_186 ( & V_178 -> V_90 . V_61 ) ;
F_156 ( V_37 -> V_262 ) ;
V_37 = F_189 ( V_84 ( V_81 ) , V_37 -> V_262 , & V_4 ,
V_214 , 0 ) ;
if ( F_18 ( V_37 ) )
goto V_304;
if ( V_37 -> V_46 & V_254 ) {
...
while ( ! F_98 ( & V_97 ) ) {
V_99 = F_190 ( & V_97 ) ;
F_188 ( V_99 , & V_4 , F_187 ( V_99 ) -> V_93 -> V_28 ) ;
F_156 ( F_187 ( V_99 ) -> V_262 ) ;
V_37 = F_189 ( V_84 ( V_81 ) , F_187 ( V_99 ) -> V_262 ,
& V_4 , V_99 -> V_214 , 0 ) ;
if ( F_18 ( V_37 ) ) {
F_51 ( V_99 ) ;
continue;
...
static int F_195 ( struct V_213 * V_214 , struct V_98 * V_99 )
{
unsigned long V_306 ;
struct V_34 * V_37 = F_187 ( V_99 ) ;
struct V_250 * V_251 = (struct V_250 * ) V_37 ;
struct V_54 * V_81 = V_251 -> V_242 [ 0 ] ;
struct V_177 * V_178 = & V_81 -> V_89 ;
if ( F_9 ( F_196 ( V_214 , V_99 ) ) ) {
F_51 ( V_99 ) ;
return 0 ;
}
...
if ( F_45 ( & V_178 -> V_91 ) ) {
if ( F_198 ( V_178 -> V_91 . V_309 , V_306 ) )
V_306 = V_178 -> V_91 . V_309 ;
F_28 ( V_81 ) ;
}
F_199 ( & V_178 -> V_90 , V_99 ) ;
if ( ! F_25 ( & V_178 -> V_91 , V_306 ) )
F_26 ( V_81 ) ;
F_97 ( & V_178 -> V_90 . V_61 ) ;
return 0 ;
}
static struct V_250 * F_200 ( struct V_35 * V_35 ,
struct V_310 * V_311 ,
const struct V_3 * V_4 ,
int V_253 ,
T_5 V_28 )
...
V_275 -> V_277 = V_37 ;
V_275 -> V_262 = V_37 ;
F_164 ( (struct V_250 * ) V_275 , V_37 , 0 ) ;
V_192 = - V_289 ;
V_266 = V_37 -> V_266 ;
if ( ! V_266 )
goto V_290;
...
static struct V_79 *
F_201 ( struct V_35 * V_35 , const struct V_3 * V_4 , T_5 V_28 , T_4 V_60 ,
struct V_79 * V_314 , void * V_190 )
{
struct V_310 * V_311 = (struct V_310 * ) V_190 ;
struct V_54 * V_242 [ V_200 ] ;
struct V_250 * V_251 , * V_315 ;
int V_296 = 0 , V_253 = 0 , V_129 , V_192 , V_316 ;
V_251 = NULL ;
if ( V_314 ) {
...
V_315 = F_181 ( V_242 , V_296 , V_4 , V_28 ,
V_311 -> V_298 ) ;
if ( F_18 ( V_315 ) ) {
V_192 = F_168 ( V_315 ) ;
if ( V_192 != - V_240 )
...
F_156 ( & V_315 -> V_7 . V_37 ) ;
return & V_315 -> V_80 ;
V_318:
V_251 = F_200 ( V_35 , V_311 , V_4 , V_253 , V_28 ) ;
if ( F_18 ( V_251 ) ) {
F_180 ( V_242 , V_296 ) ;
return F_135 ( V_251 ) ;
}
...
static struct V_34 * F_202 ( struct V_35 * V_35 , T_5 V_28 ,
struct V_34 * V_298 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
struct V_34 * V_193 ;
...
V_193 = V_32 -> V_319 ( V_35 , V_298 ) ;
}
F_13 ( V_32 ) ;
return V_193 ;
}
struct V_34 * F_189 ( struct V_35 * V_35 , struct V_34 * V_298 ,
const struct V_3 * V_4 ,
...
int V_129 , V_192 , V_296 , V_253 = 0 , V_320 = 0 ;
V_37 = NULL ;
V_251 = NULL ;
V_252 = NULL ;
...
struct V_34 * F_204 ( struct V_35 * V_35 , struct V_34 * V_298 ,
const struct V_3 * V_4 ,
struct V_213 * V_214 , int V_46 )
{
struct V_34 * V_37 = F_189 ( V_35 , V_298 , V_4 , V_214 ,
V_46 | V_312 ) ;
if ( F_18 ( V_37 ) && F_168 ( V_37 ) == - V_327 )
return F_202 ( V_35 , V_298 -> V_93 -> V_28 , V_298 ) ;
return V_37 ;
}
static inline int
F_205 ( int V_168 , struct V_98 * V_99 , const struct V_3 * V_4 )
{
struct V_40 * V_41 ;
...
static inline int
F_206 ( const struct V_224 * V_231 , const struct V_40 * V_41 ,
unsigned short V_28 )
{
if ( F_207 ( V_41 ) )
return V_231 -> V_241 && ! F_208 ( V_231 , V_41 , V_231 -> V_235 ) ;
...
! ( F_209 ( V_231 -> V_45 . V_20 , V_342 ) ) ) &&
! ( V_41 -> V_44 . V_232 != V_279 &&
F_208 ( V_231 , V_41 , V_28 ) ) ;
}
static inline int
F_210 ( const struct V_224 * V_231 , const struct V_343 * V_334 , int V_344 ,
unsigned short V_28 )
{
int V_168 = V_344 ;
if ( V_231 -> V_241 ) {
...
if ( F_206 ( V_231 , V_334 -> V_335 [ V_168 ] , V_28 ) )
return ++ V_168 ;
...
int F_211 ( struct V_98 * V_99 , struct V_3 * V_4 ,
...
V_192 = F_212 ( V_99 , & V_4 -> V_205 ) ;
F_13 ( V_32 ) ;
return V_192 ;
}
static inline int F_213 ( const struct V_343 * V_334 , int V_347 , int * V_348 )
{
...
int F_214 ( struct V_213 * V_214 , int V_60 , struct V_98 * V_99 ,
unsigned short V_28 )
{
struct V_35 * V_35 = F_215 ( V_99 -> V_266 ) ;
struct V_54 * V_81 ;
struct V_54 * V_242 [ V_200 ] ;
int V_243 = 0 ;
int V_222 ;
...
V_60 &= V_164 ;
V_350 = F_136 ( V_60 ) ;
if ( F_211 ( V_99 , & V_4 , V_28 , V_345 ) < 0 ) {
F_182 ( V_35 , V_352 ) ;
return 0 ;
}
F_216 ( V_99 , & V_4 , V_28 ) ;
...
if ( ! V_81 ) {
struct V_79 * V_80 ;
V_80 = F_203 ( V_35 , & V_4 , V_28 , V_350 ,
F_133 , NULL ) ;
if ( F_134 ( V_80 ) )
V_81 = F_135 ( V_80 ) ;
else
...
if ( ! V_81 ) {
if ( V_99 -> V_334 && F_213 ( V_99 -> V_334 , 0 , & V_351 ) ) {
F_205 ( V_351 , V_99 , & V_4 ) ;
F_182 ( V_35 , V_355 ) ;
return 0 ;
}
return 1 ;
...
V_222 = V_358 ;
if ( V_243 > 1 ) {
F_217 ( V_357 , V_246 , V_222 , V_28 , V_35 ) ;
V_246 = V_357 ;
}
for ( V_129 = V_222 - 1 , V_347 = 0 ; V_129 >= 0 ; V_129 -- ) {
V_347 = F_210 ( V_246 [ V_129 ] , V_334 , V_347 , V_28 ) ;
if ( V_347 < 0 ) {
if ( V_347 < - 1 )
V_351 = - ( 2 + V_347 ) ;
F_182 ( V_35 , V_362 ) ;
...
int F_218 ( struct V_98 * V_99 , unsigned short V_28 )
{
struct V_35 * V_35 = F_215 ( V_99 -> V_266 ) ;
struct V_3 V_4 ;
struct V_34 * V_37 ;
int V_363 = 1 ;
if ( F_188 ( V_99 , & V_4 , V_28 ) < 0 ) {
F_182 ( V_35 , V_364 ) ;
return 0 ;
}
F_197 ( V_99 ) ;
V_37 = F_189 ( V_35 , F_187 ( V_99 ) , & V_4 , NULL , V_312 ) ;
if ( F_18 ( V_37 ) ) {
V_363 = 0 ;
V_37 = NULL ;
}
...
static struct V_34 * F_219 ( struct V_34 * V_37 , T_3 V_365 )
{
if ( V_37 -> V_281 < 0 && ! F_155 ( V_37 ) )
return V_37 ;
return NULL ;
}
static int F_155 ( struct V_34 * V_37 )
{
return ! F_220 ( (struct V_250 * ) V_37 ) ;
}
void F_221 ( struct V_34 * V_37 , struct V_265 * V_266 )
{
while ( ( V_37 = V_37 -> V_277 ) && V_37 -> V_101 && V_37 -> V_266 == V_266 ) {
V_37 -> V_266 = F_215 ( V_266 ) -> V_366 ;
F_222 ( V_37 -> V_266 ) ;
F_223 ( V_266 ) ;
}
}
static void F_224 ( struct V_98 * V_99 )
{
}
static struct V_34 * F_225 ( struct V_34 * V_37 )
{
if ( V_37 ) {
if ( V_37 -> V_281 ) {
F_169 ( V_37 ) ;
...
void F_226 ( struct V_35 * V_35 )
{
F_227 ( V_35 ) ;
}
static void F_228 ( struct V_35 * V_35 )
{
F_229 ( V_35 ) ;
}
static void F_174 ( struct V_34 * V_37 )
{
do {
struct V_250 * V_251 = (struct V_250 * ) V_37 ;
T_3 V_367 , V_368 ;
V_367 = F_230 ( V_37 -> V_277 ) ;
V_251 -> V_369 = V_367 ;
V_367 = F_231 ( V_37 -> V_101 , V_367 ) ;
V_368 = F_230 ( V_251 -> V_252 ) ;
V_251 -> V_368 = V_368 ;
if ( V_367 > V_368 )
V_367 = V_368 ;
F_232 ( V_37 , V_370 , V_367 ) ;
} while ( ( V_37 = V_37 -> V_57 ) );
}
static int F_220 ( struct V_250 * V_371 )
{
struct V_34 * V_37 = & V_371 -> V_7 . V_37 ;
struct V_250 * V_372 ;
T_3 V_373 ;
if ( ! F_233 ( V_37 -> V_262 , ( (struct V_250 * ) V_37 ) -> V_374 ) ||
( V_37 -> V_266 && ! F_234 ( V_37 -> V_266 ) ) )
return 0 ;
if ( V_37 -> V_46 & V_254 )
return 1 ;
V_372 = NULL ;
...
return 0 ;
if ( V_251 -> V_296 > 0 &&
V_251 -> V_302 != F_183 ( & V_251 -> V_242 [ 0 ] -> V_100 ) )
return 0 ;
V_373 = F_230 ( V_37 -> V_277 ) ;
if ( V_251 -> V_369 != V_373 ) {
V_372 = V_251 ;
V_251 -> V_369 = V_373 ;
}
if ( ! F_233 ( V_251 -> V_252 , V_251 -> V_375 ) )
return 0 ;
V_373 = F_230 ( V_251 -> V_252 ) ;
...
for (; ; ) {
V_37 = & V_372 -> V_7 . V_37 ;
V_373 = F_231 ( V_37 -> V_101 , V_373 ) ;
if ( V_373 > V_372 -> V_368 )
V_373 = V_372 -> V_368 ;
F_232 ( V_37 , V_370 , V_373 ) ;
if ( V_372 == V_371 )
break;
...
static unsigned int F_235 ( const struct V_34 * V_37 )
{
return F_236 ( V_37 -> V_262 ) ;
}
static unsigned int F_237 ( const struct V_34 * V_37 )
{
unsigned int V_373 = F_238 ( V_37 , V_370 ) ;
return V_373 ? : F_230 ( V_37 -> V_262 ) ;
}
static struct V_376 * F_239 ( const struct V_34 * V_37 ,
struct V_98 * V_99 ,
const void * V_9 )
{
...
if ( F_163 ( V_255 -> V_379 == NULL ) )
V_255 -> V_379 = V_380 ;
if ( F_163 ( V_255 -> V_381 == NULL ) )
V_255 -> V_381 = F_219 ;
if ( F_163 ( V_255 -> V_382 == NULL ) )
V_255 -> V_382 = F_235 ;
if ( F_163 ( V_255 -> V_373 == NULL ) )
V_255 -> V_373 = F_237 ;
if ( F_163 ( V_255 -> V_383 == NULL ) )
V_255 -> V_383 = F_225 ;
if ( F_163 ( V_255 -> V_384 == NULL ) )
V_255 -> V_384 = F_224 ;
if ( F_163 ( V_255 -> V_377 == NULL ) )
V_255 -> V_377 = F_239 ;
if ( F_163 ( V_32 -> V_385 == NULL ) )
V_32 -> V_385 = F_228 ;
F_241 ( V_31 [ V_32 -> V_28 ] , V_32 ) ;
}
F_186 ( & V_378 ) ;
F_242 () ;
F_243 (net) {
...
return - V_38 ;
F_184 ( & V_378 ) ;
if ( F_163 ( V_31 [ V_32 -> V_28 ] != NULL ) ) {
if ( F_9 ( V_31 [ V_32 -> V_28 ] != V_32 ) )
V_192 = - V_202 ;
else
F_246 ( V_31 [ V_32 -> V_28 ] ,
NULL ) ;
}
F_186 ( & V_378 ) ;
if ( ! V_192 ) {
...
static void T_6 F_248 ( struct V_35 * V_35 )
{
struct V_31 * V_32 ;
F_10 () ;
V_32 = F_11 ( V_31 [ V_29 ] ) ;
...
static int F_249 ( struct V_387 * V_388 , unsigned long V_389 , void * V_390 )
{
struct V_265 * V_266 = F_250 ( V_390 ) ;
switch ( V_389 ) {
case V_391 :
F_226 ( F_215 ( V_266 ) ) ;
}
...
static int T_6 F_251 ( struct V_35 * V_35 )
{
int V_393 ;
V_35 -> V_394 . V_395 = F_252 ( struct V_396 ) ;
if ( ! V_35 -> V_394 . V_395 )
return - V_226 ;
V_393 = F_253 ( V_35 ) ;
if ( V_393 < 0 )
F_254 ( V_35 -> V_394 . V_395 ) ;
return V_393 ;
}
static void F_255 ( struct V_35 * V_35 )
{
F_256 ( V_35 ) ;
F_254 ( V_35 -> V_394 . V_395 ) ;
}
...
static int T_6 F_257 ( struct V_35 * V_35 )
{
...
F_260 ( & V_35 -> V_101 . V_156 . V_61 ) ;
F_37 ( & V_35 -> V_101 . V_188 ) ;
F_261 ( & V_35 -> V_101 . V_154 , F_80 ) ;
F_261 ( & V_35 -> V_101 . V_156 . V_153 , F_83 ) ;
if ( F_258 ( V_35 , & V_398 ) )
F_262 ( & V_405 ) ;
return 0 ;
V_404:
...
static void F_263 ( struct V_35 * V_35 )
{
unsigned int V_397 ;
int V_60 ;
F_264 ( & V_35 -> V_101 . V_154 ) ;
#ifdef F_131
F_113 ( V_35 , V_207 , false ) ;
#endif
F_113 ( V_35 , V_208 , false ) ;
F_103 ( ! F_116 ( & V_35 -> V_101 . V_188 ) ) ;
for ( V_60 = 0 ; V_60 < V_147 * 2 ; V_60 ++ ) {
struct V_402 * V_403 ;
...
static int T_6 F_265 ( struct V_35 * V_35 )
{
int V_393 ;
V_393 = F_251 ( V_35 ) ;
if ( V_393 < 0 )
...
if ( V_393 < 0 )
goto V_64;
F_269 ( & V_35 -> V_101 . V_410 ) ;
F_39 ( & V_35 -> V_101 . V_130 ) ;
F_270 ( & V_35 -> V_101 . V_411 ) ;
return 0 ;
V_64:
F_271 ( V_35 ) ;
V_409:
...
static void T_7 F_273 ( struct V_35 * V_35 )
{
F_274 ( V_35 ) ;
F_271 ( V_35 ) ;
F_263 ( V_35 ) ;
...
static void F_278 ( struct V_54 * V_55 ,
struct V_413 * V_414 )
{
struct V_189 * V_190 = V_55 -> V_95 ;
struct V_1 * V_2 = & V_55 -> V_123 ;
if ( V_190 )
F_279 ( V_414 , L_2 ,
V_190 -> V_415 , V_190 -> V_416 , V_190 -> V_417 ) ;
switch ( V_2 -> V_28 ) {
case V_29 :
F_279 ( V_414 , L_3 , & V_2 -> V_12 . V_10 ) ;
if ( V_2 -> V_13 != 32 )
F_279 ( V_414 , L_4 ,
V_2 -> V_13 ) ;
F_279 ( V_414 , L_5 , & V_2 -> V_9 . V_10 ) ;
if ( V_2 -> V_11 != 32 )
F_279 ( V_414 , L_6 ,
V_2 -> V_11 ) ;
break;
case V_30 :
F_279 ( V_414 , L_7 , V_2 -> V_12 . V_418 ) ;
if ( V_2 -> V_13 != 128 )
F_279 ( V_414 , L_4 ,
V_2 -> V_13 ) ;
F_279 ( V_414 , L_8 , V_2 -> V_9 . V_418 ) ;
if ( V_2 -> V_11 != 128 )
F_279 ( V_414 , L_6 ,
V_2 -> V_11 ) ;
break;
...
void F_280 ( struct V_54 * V_55 , int V_419 , bool V_195 )
{
struct V_413 * V_414 ;
V_414 = F_281 ( L_9 ) ;
if ( V_414 == NULL )
...
static bool F_284 ( const struct V_1 * V_420 ,
const struct V_1 * V_421 )
{
if ( V_420 -> V_20 == V_422 ) {
if ( V_421 -> V_28 == V_420 -> V_28 &&
F_285 ( & V_421 -> V_9 , & V_420 -> V_9 ,
V_420 -> V_28 ) &&
F_285 ( & V_421 -> V_12 , & V_420 -> V_12 ,
V_420 -> V_28 ) &&
...
static struct V_54 * F_286 ( const struct V_1 * V_2 ,
T_4 V_60 , T_4 type , struct V_35 * V_35 )
{
struct V_54 * V_81 , * V_193 = NULL ;
struct V_110 * V_157 ;
T_3 V_165 = ~ 0U ;
F_78 ( & V_35 -> V_101 . V_130 ) ;
V_157 = F_59 ( V_35 , & V_2 -> V_9 , & V_2 -> V_12 , V_2 -> V_28 , V_60 ) ;
F_88 (pol, chain, bydst) {
if ( F_284 ( V_2 , & V_81 -> V_123 ) &&
V_81 -> type == type ) {
V_193 = V_81 ;
V_165 = V_193 -> V_165 ;
break;
...
static int F_287 ( const struct V_423 * V_183 , const struct V_224 * V_424 )
{
int V_203 = 0 ;
...
case V_233 :
case V_234 :
if ( F_285 ( & V_424 -> V_45 . V_9 , & V_183 -> V_425 ,
V_183 -> V_426 ) &&
F_285 ( & V_424 -> V_12 , & V_183 -> V_427 ,
V_183 -> V_426 ) ) {
V_203 = 1 ;
}
break;
...
static int F_288 ( struct V_54 * V_81 ,
...
if ( ! F_287 ( V_429 , & V_81 -> V_223 [ V_129 ] ) )
continue;
V_431 ++ ;
...
static int F_289 ( const struct V_423 * V_183 , int V_428 )
{
int V_129 , V_430 ;
if ( V_428 < 1 || V_428 > V_245 )
return - V_202 ;
for ( V_129 = 0 ; V_129 < V_428 ; V_129 ++ ) {
if ( F_285 ( & V_183 [ V_129 ] . V_425 , & V_183 [ V_129 ] . V_432 ,
V_183 [ V_129 ] . V_426 ) &&
F_285 ( & V_183 [ V_129 ] . V_427 , & V_183 [ V_129 ] . V_433 ,
V_183 [ V_129 ] . V_426 ) )
return - V_202 ;
if ( F_148 ( & V_183 [ V_129 ] . V_432 , V_183 [ V_129 ] . V_434 ) ||
F_148 ( & V_183 [ V_129 ] . V_433 , V_183 [ V_129 ] . V_434 ) )
return - V_202 ;
...
{
int V_129 , V_192 , V_437 = 0 , V_438 = 0 ;
struct V_54 * V_81 = NULL ;
struct V_40 * V_41 , * V_439 ;
struct V_40 * V_440 [ V_245 ] ;
struct V_40 * V_441 [ V_245 ] ;
struct V_423 * V_429 ;
if ( ( V_192 = F_289 ( V_183 , V_428 ) ) < 0 )
goto V_64;
if ( ( V_81 = F_286 ( V_2 , V_60 , type , V_35 ) ) == NULL ) {
V_192 = - V_194 ;
goto V_64;
}
for ( V_129 = 0 , V_429 = V_183 ; V_129 < V_428 ; V_129 ++ , V_429 ++ ) {
if ( ( V_41 = F_290 ( V_429 , V_35 ) ) ) {
V_440 [ V_437 ] = V_41 ;
V_437 ++ ;
if ( ( V_439 = F_291 ( V_41 , V_429 ) ) ) {
V_441 [ V_438 ] = V_439 ;
V_438 ++ ;
} else {
V_192 = - V_435 ;
...
if ( ( V_192 = F_288 ( V_81 , V_183 , V_428 ) ) < 0 )
goto V_442;
if ( V_437 ) {
F_292 ( V_440 , V_437 ) ;
F_293 ( V_440 , V_437 ) ;
}
F_294 ( V_2 , V_60 , type , V_183 , V_428 , V_347 ) ;
F_28 ( V_81 ) ;
return 0 ;
V_64:
return V_192 ;
