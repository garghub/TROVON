...
unsigned int V_79 = V_25 -> V_80 -> V_79 ;
for ( V_77 = 0 ; V_77 < V_79 ; V_77 ++ ) {
struct V_75 * V_115 = & V_25 -> V_80 -> V_86 [ V_77 ] ;
...
static int F_51 ( struct V_2 * V_3 , struct V_164 * V_8 )
{
...
static int F_52 ( struct V_2 * V_3 , const struct V_164 * V_8 )
{
F_15 ( V_3 , V_8 -> V_8 & 0xff , V_8 -> V_30 & 0xff ) ;
return 0 ;
}
static int F_53 ( struct V_10 * V_11 ,
const struct V_166 * V_153 )
{
struct V_38 V_39 ;
struct V_2 * V_3 ;
struct V_1 * V_25 ;
int V_12 ;
V_25 = F_54 ( & V_11 -> V_167 , sizeof( * V_25 ) , V_168 ) ;
if ( V_25 == NULL )
return - V_169 ;
V_3 = & V_25 -> V_3 ;
F_55 ( V_3 , V_11 , & V_170 ) ;
V_25 -> V_49 = 30 ;
if ( V_11 -> V_167 . V_171 ) {
struct V_172 * V_173 = V_11 -> V_167 . V_171 ;
V_25 -> V_84 = V_173 -> V_84 ;
V_25 -> V_85 = V_173 -> V_85 ;
V_25 -> V_26 = V_173 -> V_26 ;
if ( V_173 -> V_49 )
V_25 -> V_49 = V_173 -> V_49 ;
if ( V_173 -> V_42 && V_153 -> V_174 != V_175 )
V_25 -> V_42 = true ;
if ( V_173 -> V_176 )
V_25 -> V_176 = true ;
}
...
F_56 ( 1 , V_177 , V_11 ,
L_2 ,
V_11 -> V_18 << 1 , V_11 -> V_22 -> V_178 ) ;
return V_12 ;
}
F_57 ( V_11 , L_3 ,
V_11 -> V_18 << 1 , V_11 -> V_22 -> V_178 ) ;
V_25 -> V_80 = & V_179 [ V_153 -> V_174 ] ;
V_25 -> V_44 = & V_71 [ 0 ] ;
V_25 -> V_40 = 0 ;
V_39 . V_47 = 1 ;
V_39 . V_48 = 30 ;
...
F_59 ( & V_25 -> V_7 , & V_182 ,
V_160 , 0 , 1 , 1 , 0 ) ;
V_25 -> V_158 = F_59 ( & V_25 -> V_7 , & V_182 ,
V_157 , 0 , 256 , 1 , 128 ) ;
V_25 -> V_129 = F_59 ( & V_25 -> V_7 , & V_182 ,
V_183 , - 180 , 180 , 5 , 0 ) ;
V_25 -> V_142 = F_59 ( & V_25 -> V_7 , & V_182 ,
V_184 , 0 , 255 , 1 , 128 ) ;
V_25 -> V_185 = F_59 ( & V_25 -> V_7 , & V_182 ,
V_154 , 0 , 1 , 1 , 1 ) ;
V_25 -> V_163 = F_59 ( & V_25 -> V_7 , & V_182 ,
V_186 , 0 , 65535 , 1 , 500 ) ;
V_25 -> V_187 = F_60 ( & V_25 -> V_7 , & V_182 ,
V_161 , V_162 , 0 ,
V_152 ) ;
V_3 -> V_188 = & V_25 -> V_7 ;
if ( V_25 -> V_7 . error ) {
int V_189 = V_25 -> V_7 . error ;
F_61 ( & V_25 -> V_7 ) ;
return V_189 ;
}
F_62 ( 2 , & V_25 -> V_185 , 0 , true ) ;
F_62 ( 2 , & V_25 -> V_187 ,
V_162 , false ) ;
F_63 ( 2 , & V_25 -> V_158 ) ;
F_64 ( & V_25 -> V_7 ) ;
