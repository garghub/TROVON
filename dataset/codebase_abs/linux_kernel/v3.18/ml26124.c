...
{
F_7 ( V_14 , V_72 , 0x01 , 1 ) ;
F_7 ( V_14 , V_72 , 0x01 , 0 ) ;
return 0 ;
}
static int F_18 ( struct V_73 * V_74 ,
const struct V_75 * V_76 )
{
struct V_15 * V_16 ;
int V_77 ;
V_16 = F_19 ( & V_74 -> V_19 , sizeof( * V_16 ) , V_78 ) ;
if ( ! V_16 )
return - V_79 ;
F_20 ( V_74 , V_16 ) ;
V_16 -> V_71 = F_21 ( V_74 , & V_80 ) ;
if ( F_22 ( V_16 -> V_71 ) ) {
V_77 = F_23 ( V_16 -> V_71 ) ;
F_9 ( & V_74 -> V_19 , L_3 , V_77 ) ;
return V_77 ;
}
return F_24 ( & V_74 -> V_19 ,
& V_81 , & V_82 , 1 ) ;
}
static int F_25 ( struct V_73 * V_83 )
{
F_26 ( & V_83 -> V_19 ) ;
return 0 ;
}
