...
if ( F_43 ( V_29 ) != V_56 + V_66 )
goto V_64;
if ( V_54 ) {
if ( F_44 ( ! F_45 ( & V_54 -> V_67 ) ) )
V_54 = NULL ;
else if ( F_44 ( F_35 ( V_54 , V_1 , V_44 , V_45 ,
V_46 ) < V_60 ) ) {
F_46 ( V_54 ) ;
goto V_64;
}
...
if ( V_8 -> V_76 != V_56 )
continue;
if ( F_56 ( F_57 ( V_8 , V_1 , V_70 ,
V_52 , V_45 , V_71 , V_46 ) ) ) {
if ( F_44 ( ! F_45 ( & V_8 -> V_67 ) ) )
goto V_77;
if ( F_44 ( ! F_57 ( V_8 , V_1 , V_70 ,
V_52 , V_45 , V_71 , V_46 ) ) ) {
F_48 ( V_8 ) ;
goto V_64;
}
...
struct V_81 * * V_82 )
{
struct V_31 * V_83 = V_80 -> V_32 ;
struct V_9 * V_10 = F_6 ( V_8 ) ;
T_1 V_45 = V_10 -> V_11 ;
T_1 V_52 = V_10 -> V_13 ;
int V_46 = V_8 -> V_51 ;
F_54 ( V_70 , V_52 , V_45 ) ;
const T_7 V_71 = F_55 ( V_10 -> V_14 , V_3 ) ;
struct V_1 * V_1 = F_7 ( V_8 ) ;
unsigned int V_56 = F_1 ( V_1 , V_45 , V_3 ,
V_52 , V_10 -> V_14 ) ;
struct V_74 * V_19 = V_74 ( V_83 , V_56 ) ;
T_8 * V_39 = F_59 ( V_83 , V_56 ) ;
struct V_7 * V_84 ;
const struct V_55 * V_29 ;
struct V_81 * V_85 = NULL ;
int V_86 = 0 ;
F_26 ( V_39 ) ;
F_60 (sk2, node, &head->chain) {
if ( V_84 -> V_76 != V_56 )
continue;
if ( F_56 ( F_57 ( V_84 , V_1 , V_70 ,
V_52 , V_45 , V_71 , V_46 ) ) ) {
if ( V_84 -> V_68 == V_69 ) {
V_85 = F_51 ( V_84 ) ;
if ( F_61 ( V_8 , V_84 , V_82 ) )
break;
}
goto V_87;
}
...
static inline T_4 F_71 ( const struct V_7 * V_8 )
{
const struct V_9 * V_10 = F_6 ( V_8 ) ;
return F_72 ( V_10 -> V_11 ,
V_10 -> V_13 ,
V_10 -> V_14 ) ;
}
int F_73 ( struct V_7 * V_8 , struct V_81 * V_85 )
{
struct V_31 * V_32 = V_8 -> V_33 -> V_34 . V_32 ;
struct V_91 * V_92 ;
T_8 * V_39 ;
...
V_92 = & V_19 -> V_30 ;
V_39 = F_59 ( V_32 , V_8 -> V_76 ) ;
F_26 ( V_39 ) ;
F_65 ( V_8 , V_92 ) ;
if ( V_85 ) {
F_63 ( V_8 -> V_76 != V_85 -> V_93 ) ;
V_86 = F_66 ( V_85 ) ;
}
F_28 ( V_39 ) ;
F_69 ( F_7 ( V_8 ) , V_8 -> V_33 , 1 ) ;
...
struct V_7 * V_8 , T_4 V_97 ,
int (* F_82)( struct V_79 * ,
struct V_7 * , T_2 , struct V_81 * * ) ,
int (* V_56)( struct V_7 * V_8 , struct V_81 * V_82 ) )
{
struct V_31 * V_83 = V_80 -> V_32 ;
...
int V_86 = 1 ;
if ( ! V_20 ) {
int V_99 , V_100 , V_101 , V_102 , V_24 ;
static T_4 V_103 ;
T_4 V_104 = V_103 + V_97 ;
struct V_81 * V_85 = NULL ;
F_83 ( V_1 , & V_101 , & V_102 ) ;
V_100 = ( V_102 - V_101 ) + 1 ;
F_30 () ;
for ( V_99 = 1 ; V_99 <= V_100 ; V_99 ++ ) {
V_24 = V_101 + ( V_99 + V_104 ) % V_100 ;
if ( F_84 ( V_1 , V_24 ) )
continue;
V_19 = & V_83 -> V_37 [ F_24 ( V_1 , V_24 ,
V_83 -> V_38 ) ] ;
F_26 ( & V_19 -> V_39 ) ;
F_33 (tb, &head->chain) {
...
V_19 = & V_83 -> V_37 [ F_24 ( V_1 , V_20 , V_83 -> V_38 ) ] ;
V_21 = F_22 ( V_8 ) -> V_36 ;
F_78 ( & V_19 -> V_39 ) ;
if ( F_86 ( & V_21 -> V_28 ) == V_8 && ! V_8 -> V_107 . V_108 ) {
V_56 ( V_8 , NULL ) ;
F_80 ( & V_19 -> V_39 ) ;
return 0 ;
} else {
F_28 ( & V_19 -> V_39 ) ;
V_98 = F_82 ( V_80 , V_8 , V_20 , NULL ) ;
V_77:
F_31 () ;
return V_98 ;
}
}
int F_87 ( struct V_79 * V_80 ,
struct V_7 * V_8 )
{
return F_81 ( V_80 , V_8 , F_71 ( V_8 ) ,
F_58 , F_73 ) ;
}
void F_88 ( struct V_31 * V_34 )
{
int V_99 ;
F_89 ( & V_34 -> V_35 , 0 ) ;
for ( V_99 = 0 ; V_99 < V_109 ; V_99 ++ ) {
F_90 ( & V_34 -> V_59 [ V_99 ] . V_39 ) ;
F_91 ( & V_34 -> V_59 [ V_99 ] . V_19 ,
V_99 + V_66 ) ;
}
}
