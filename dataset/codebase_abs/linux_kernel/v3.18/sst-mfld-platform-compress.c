...
V_22 = V_8 -> V_19 ;
if ( V_22 )
V_4 = V_8 -> V_18 -> V_23 ( V_12 -> V_13 , V_22 ) ;
...
V_31 . V_70 = V_3 ;
V_31 . V_71 = F_4 ;
V_27 = V_8 -> V_18 -> V_72 ( V_12 -> V_13 , & V_29 , & V_31 ) ;
if ( V_27 < 0 ) {
F_10 ( L_8 , V_27 ) ;
return V_27 ;
}
...
{
struct V_7 * V_8 = V_3 -> V_6 -> V_21 ;
switch ( V_73 ) {
case V_74 :
if ( V_8 -> V_18 -> V_75 )
return V_8 -> V_18 -> V_75 ( V_12 -> V_13 , V_8 -> V_19 ) ;
case V_76 :
if ( V_8 -> V_18 -> V_77 )
return V_8 -> V_18 -> V_77 ( V_12 -> V_13 , V_8 -> V_19 ) ;
case V_78 :
if ( V_8 -> V_18 -> V_79 )
return V_8 -> V_18 -> V_79 ( V_12 -> V_13 , V_8 -> V_19 ) ;
case V_80 :
if ( V_8 -> V_18 -> V_81 )
return V_8 -> V_18 -> V_81 ( V_12 -> V_13 , V_8 -> V_19 ) ;
case V_82 :
if ( V_8 -> V_18 -> V_83 )
return V_8 -> V_18 -> V_83 ( V_12 -> V_13 , V_8 -> V_19 ) ;
case V_84 :
if ( V_8 -> V_18 -> V_85 )
return V_8 -> V_18 -> V_85 ( V_12 -> V_13 , V_8 -> V_19 ) ;
default:
return - V_56 ;
}
}
...
struct V_7 * V_8 ;
V_8 = V_3 -> V_6 -> V_21 ;
V_8 -> V_18 -> V_87 ( V_12 -> V_13 , V_8 -> V_19 , V_87 ) ;
V_87 -> V_88 = V_87 -> V_89 %
( V_90 ) V_3 -> V_6 -> V_64 ;
F_2 ( L_9 , V_87 -> V_88 ) ;
return 0 ;
...
struct V_7 * V_8 ;
V_8 = V_3 -> V_6 -> V_21 ;
V_8 -> V_18 -> V_92 ( V_12 -> V_13 , V_8 -> V_19 , ( unsigned long ) V_91 ) ;
V_8 -> V_93 += V_91 ;
return 0 ;
}
...
struct V_7 * V_8 =
V_3 -> V_6 -> V_21 ;
return V_8 -> V_18 -> V_101 ( V_12 -> V_13 , V_8 -> V_19 , V_100 ) ;
}
