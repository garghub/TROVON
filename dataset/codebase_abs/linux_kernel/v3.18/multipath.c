...
static int F_27 ( void * V_48 , int V_49 )
{
struct V_15 * V_15 = V_48 ;
struct V_1 * V_2 = V_15 -> V_16 ;
int V_3 , V_50 = 0 ;
if ( F_28 ( V_15 , V_49 ) )
return 1 ;
...
struct V_6 * V_7 = F_3 ( V_2 -> V_8 [ V_3 ] . V_7 ) ;
if ( V_7 && ! F_4 ( V_51 , & V_7 -> V_10 ) ) {
struct V_52 * V_53 = F_29 ( V_7 -> V_33 ) ;
V_50 |= F_30 ( & V_53 -> V_54 , V_49 ) ;
break;
}
}
F_6 () ;
...
if ( V_57 -> V_7 )
F_7 ( L_16 ,
V_3 , ! F_4 ( V_51 , & V_57 -> V_7 -> V_10 ) ,
F_18 ( V_57 -> V_7 -> V_33 , V_31 ) ) ;
}
}
...
V_60 = V_61 = V_7 -> V_62 ;
F_34 ( V_2 ) ;
for ( V_28 = V_60 ; V_28 <= V_61 ; V_28 ++ )
if ( ( V_59 = V_2 -> V_8 + V_28 ) -> V_7 == NULL ) {
V_53 = V_7 -> V_33 -> V_63 -> V_64 ;
F_36 ( V_15 -> V_65 , V_7 -> V_33 ,
V_7 -> V_41 << 9 ) ;
if ( V_53 -> V_66 ) {
F_37 ( V_15 -> V_64 , 1 ) ;
F_38 ( V_15 -> V_64 ,
...
static void F_47 ( struct V_70 * V_19 )
{
...
if ( F_49 ( V_72 ) )
break;
V_14 = F_50 ( V_72 -> V_73 , struct V_13 , V_18 ) ;
F_51 ( V_72 -> V_73 ) ;
F_11 ( & V_2 -> V_17 , V_10 ) ;
V_21 = & V_14 -> V_21 ;
...
static T_1 F_52 ( struct V_15 * V_15 , T_1 V_74 , int V_5 )
{
F_53 ( V_74 || V_5 ,
L_23 , V_75 ) ;
return V_15 -> V_76 ;
...
V_2 = F_57 ( sizeof( struct V_1 ) , V_84 ) ;
V_15 -> V_16 = V_2 ;
if ( ! V_2 ) {
F_7 ( V_12
L_25 ,
...
V_2 -> V_8 = F_57 ( sizeof( struct V_36 ) * V_15 -> V_5 ,
V_84 ) ;
if ( ! V_2 -> V_8 ) {
F_7 ( V_12
L_25 ,
...
F_36 ( V_15 -> V_65 , V_7 -> V_33 ,
V_7 -> V_41 << 9 ) ;
if ( V_7 -> V_33 -> V_63 -> V_64 -> V_66 ) {
F_37 ( V_15 -> V_64 , 1 ) ;
F_38 ( V_15 -> V_64 ,
V_67 - 1 ) ;
}
if ( ! F_4 ( V_51 , & V_7 -> V_10 ) )
V_79 ++ ;
}
V_2 -> V_5 = V_15 -> V_5 ;
V_2 -> V_15 = V_15 ;
...
F_7 ( V_87
L_30 ,
F_56 ( V_15 ) , V_2 -> V_5 - V_15 -> V_47 ,
V_15 -> V_5 ) ;
F_63 ( V_15 , F_52 ( V_15 , 0 , 0 ) ) ;
V_15 -> V_64 -> V_54 . V_88 = F_27 ;
V_15 -> V_64 -> V_54 . V_89 = V_15 ;
if ( F_46 ( V_15 ) )
goto V_85;
return 0 ;
V_85:
