...
return ( T_9 ) F_46 ( V_53 ) + ( V_58 & ( V_5 - 1 ) ) ;
}
void
F_149 (
T_2 * V_2 ,
...
while ( V_179 < V_183 ) {
struct V_53 * V_53 ;
int V_148 , V_184 , V_185 ;
V_148 = ( V_179 + V_2 -> V_6 ) >> V_64 ;
...
void * V_193 )
{
struct V_1 * V_2 = F_119 ( V_191 , struct V_1 , V_16 ) ;
...
while ( ! F_33 ( & V_194 ) ) {
struct V_1 * V_2 ;
V_2 = F_158 ( & V_194 , struct V_1 , V_16 ) ;
F_159 ( & V_2 -> V_16 ) ;
if ( V_2 -> V_7 & V_140 ) {
F_53 ( V_76 -> V_89 ,
L_7
...
struct V_202 * V_203 )
{
struct V_25 * V_76 = F_119 ( V_201 ,
struct V_25 , V_204 ) ;
F_155 ( V_194 ) ;
unsigned long V_205 ;
unsigned long V_206 = V_203 -> V_206 ;
V_205 = F_164 ( & V_76 -> V_15 , V_203 -> V_207 , F_161 ,
& V_194 , & V_206 ) ;
while ( ! F_33 ( & V_194 ) ) {
struct V_1 * V_2 ;
V_2 = F_158 ( & V_194 , struct V_1 , V_16 ) ;
...
struct V_25 * V_76 = F_119 ( V_201 ,
struct V_25 , V_204 ) ;
return F_166 ( & V_76 -> V_15 , V_203 -> V_207 ) ;
}
void
F_167 (
struct V_174 * V_175 ,
...
V_76 -> V_87 = V_210 ;
V_76 -> V_88 = V_210 - 1 ;
if ( F_172 ( V_76 -> V_156 , V_210 ) ) {
char V_211 [ V_212 ] ;
F_173 ( V_76 -> V_156 , V_211 ) ;
F_68 ( V_76 -> V_89 ,
L_9 ,
V_210 , V_211 ) ;
return - V_213 ;
}
V_76 -> V_214 = F_174 ( V_76 -> V_156 ) ;
V_76 -> V_215 = F_174 ( V_76 -> V_156 ) - 1 ;
return 0 ;
}
STATIC int
F_175 (
...
V_76 -> V_156 = V_217 ;
V_76 -> V_111 = F_177 ( V_217 ) ;
if ( F_175 ( V_76 , V_217 ) )
goto error;
if ( F_178 ( & V_76 -> V_15 ) )
goto error;
V_76 -> V_204 . V_221 = F_165 ;
V_76 -> V_204 . V_222 = F_163 ;
...
struct V_190 * V_229 )
{
struct V_1 * V_230 = F_119 ( V_228 , struct V_1 , V_37 ) ;
struct V_1 * V_2 = F_119 ( V_229 , struct V_1 , V_37 ) ;
T_7 V_231 ;
...
F_188 ( & V_2 -> V_37 , V_233 ) ;
F_189 ( V_2 , V_48 ) ;
}
F_190 ( NULL , V_233 , F_184 ) ;
F_140 ( & V_164 ) ;
...
{
F_155 ( V_233 ) ;
return F_185 ( V_232 , & V_233 , false ) ;
}
int
F_192 (
struct V_190 * V_232 )
...
int error = 0 , V_236 ;
struct V_1 * V_2 ;
F_185 ( V_232 , & V_233 , true ) ;
while ( ! F_33 ( & V_233 ) ) {
V_2 = F_158 ( & V_233 , struct V_1 , V_37 ) ;
F_159 ( & V_2 -> V_37 ) ;
F_64 ( V_2 ) ;
V_236 = V_2 -> V_114 ;
F_69 ( V_2 ) ;
