...
T_3 V_102 [ V_97 ] ;
int V_103 = 0 ;
V_100 = F_24 ( V_34 ) ? V_63 : V_61 ;
V_101 = F_24 ( V_33 ) ? V_63 : V_61 ;
if ( V_33 == 0 || V_34 == 0 )
return V_98 ;
if ( abort )
return V_75 | V_100 ;
...
if ( ! V_104 -> V_105 )
return V_98 ;
V_95 = F_25 ( V_102 , ( void V_106 * ) V_33 , V_96 ) ;
if ( V_95 != 0 )
return V_98 ;
V_94 = V_102 ;
} else {
...
#endif
F_29 ( & V_93 , V_94 , V_103 ) ;
F_30 ( & V_93 ) ;
switch ( V_93 . V_108 . V_95 [ 0 ] ) {
case 0xf :
switch ( V_93 . V_108 . V_95 [ 1 ] ) {
case 0x05 :
case 0x34 :
V_92 = V_109 ;
break;
...
if ( type != V_98 && ( V_23 & V_118 ) ) {
if ( V_3 -> V_37 [ V_10 ] . V_46 )
type |= V_77 ;
else
type |= V_79 ;
}
if ( type == V_98 || ( V_23 & type ) != type ) {
...
V_115 = V_10 ;
while ( ++ V_115 < V_3 -> V_41 . V_42 )
V_3 -> V_37 [ V_115 - 1 ] = V_3 -> V_37 [ V_115 ] ;
V_3 -> V_41 . V_42 -- ;
if ( ! V_3 -> V_37 [ V_10 ] . V_33 )
continue;
}
