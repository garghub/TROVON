...
if ( V_35 [ V_49 ] ) {
V_39 = F_20 ( V_35 [ V_49 ] , & V_38 ) ;
if ( V_39 )
return V_39 ;
if ( V_5 > V_38 )
F_21 ( V_5 , V_38 ) ;
} else if ( V_35 [ V_50 ] ) {
T_3 V_51 = F_22 ( V_35 [ V_50 ] ) ;
if ( ! V_51 || V_51 > 32 )
return - V_52 ;
F_23 ( V_5 , V_38 , V_51 ) ;
}
...
static inline bool
F_25 ( const struct V_53 * V_2 ,
const struct V_53 * V_3 ,
T_1 * V_4 )
{
return F_26 ( & V_2 -> V_5 . V_54 , & V_3 -> V_5 . V_54 ) &&
V_2 -> V_6 == V_3 -> V_6 ;
}
static bool
F_27 ( struct V_7 * V_8 ,
const struct V_53 * V_9 )
{
if ( F_28 ( V_8 , V_10 , & V_9 -> V_5 . V_54 ) ||
F_4 ( V_8 , V_11 , F_5 ( V_9 -> V_6 ) ) )
goto V_12;
return 0 ;
V_12:
...
V_27 . V_6 = V_8 -> V_6 ;
V_27 . V_6 &= V_24 -> V_30 ;
F_31 ( V_8 , V_22 -> V_31 & V_32 , & V_27 . V_5 . V_54 ) ;
return V_25 ( V_16 , & V_27 , & V_29 , & V_22 -> V_29 , V_22 -> V_33 ) ;
}
static int
