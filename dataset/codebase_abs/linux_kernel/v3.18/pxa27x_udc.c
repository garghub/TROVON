...
{
if ( V_195 ) {
if ( F_100 ( V_5 -> V_196 -> V_197 ) )
F_101 ( V_5 -> V_196 -> V_197 ,
! V_5 -> V_196 -> V_198 ) ;
if ( V_5 -> V_196 -> V_199 )
...
static int F_102 ( struct V_203 * V_204 )
{
struct V_4 * V_5 = F_103 ( V_204 ) ;
return ( F_3 ( V_5 , V_38 ) & 0x7ff ) ;
}
static int F_104 ( struct V_203 * V_204 )
{
struct V_4 * V_5 = F_103 ( V_204 ) ;
...
V_206 &= ( ( V_5 -> V_207 ) || ( F_106 ( V_5 -> V_208 ) ) ) ;
return V_206 ;
}
...
V_209 |= ( ( ! V_5 -> V_207 ) && ( ! F_106 ( V_5 -> V_208 ) ) ) ;
return V_209 ;
}
static int F_108 ( struct V_203 * V_204 , int V_210 )
{
struct V_4 * V_5 = F_103 ( V_204 ) ;
if ( ! F_100 ( V_5 -> V_196 -> V_197 ) && ! V_5 -> V_196 -> V_199 )
return - V_112 ;
F_99 ( V_5 , V_210 ) ;
if ( F_105 ( V_5 ) )
F_109 ( V_5 ) ;
...
static int F_111 ( struct V_203 * V_204 , int V_210 )
{
struct V_4 * V_5 = F_103 ( V_204 ) ;
V_5 -> V_207 = V_210 ;
if ( F_105 ( V_5 ) )
...
static int F_112 ( struct V_203 * V_204 , unsigned V_211 )
{
struct V_4 * V_5 ;
V_5 = F_103 ( V_204 ) ;
if ( ! F_106 ( V_5 -> V_208 ) )
return F_113 ( V_5 -> V_208 , V_211 ) ;
return - V_112 ;
}
...
static void F_115 ( struct V_4 * V_90 )
{
int V_48 ;
struct V_44 * V_45 ;
...
static int F_121 ( struct V_203 * V_221 ,
struct V_222 * V_11 )
{
struct V_4 * V_5 = F_122 ( V_221 ) ;
int V_223 ;
V_5 -> V_11 = V_11 ;
F_99 ( V_5 , 1 ) ;
if ( ! F_106 ( V_5 -> V_208 ) ) {
V_223 = F_123 ( V_5 -> V_208 -> V_224 ,
& V_5 -> V_78 ) ;
if ( V_223 ) {
F_19 ( V_5 -> V_90 , L_72 ) ;
goto V_225;
...
static void F_124 ( struct V_4 * V_5 , struct V_222 * V_11 )
{
int V_48 ;
...
static int F_125 ( struct V_203 * V_221 ,
struct V_222 * V_11 )
{
struct V_4 * V_5 = F_122 ( V_221 ) ;
F_124 ( V_5 , V_11 ) ;
...
V_5 -> V_11 = NULL ;
if ( ! F_106 ( V_5 -> V_208 ) )
return F_123 ( V_5 -> V_208 -> V_224 , NULL ) ;
return 0 ;
}
...
if ( F_59 ( F_37 ( V_45 ) ) )
goto V_232;
V_229 . V_228 [ V_48 ] = F_9 ( V_45 , V_155 ) ;
}
V_230 = ! F_37 ( V_45 ) ;
while ( ! F_37 ( V_45 ) ) {
V_48 = F_9 ( V_45 , V_155 ) ;
...
F_127 ( V_229 . V_227 . V_235 ) , F_127 ( V_229 . V_227 . V_236 ) ,
F_127 ( V_229 . V_227 . V_237 ) ) ;
if ( F_59 ( V_230 ) )
goto V_232;
if ( V_229 . V_227 . V_233 & V_149 )
F_40 ( V_5 , V_181 ) ;
else
F_40 ( V_5 , V_182 ) ;
F_33 ( V_45 , V_57 | V_63 ) ;
...
static void F_128 ( struct V_4 * V_5 , int V_240 , int V_241 )
{
T_1 V_242 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
static void F_131 ( int V_251 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
...
F_29 ( V_5 , V_36 , F_132 ( 0 , V_256 ) ) ;
F_128 ( V_5 , ! ! ( V_252 & V_257 ) ,
! ! ( V_252 & V_258 ) ) ;
}
V_252 >>= 2 ;
...
if ( ! ( V_252 & V_256 ) )
continue;
F_29 ( V_5 , V_36 , F_132 ( V_48 , V_256 ) ) ;
...
F_29 ( V_5 , V_37 , F_132 ( V_48 - 16 , V_256 ) ) ;
if ( ! ( V_254 & V_256 ) )
continue;
F_56 ( V_48 >= F_133 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_133 ( V_5 -> V_44 ) ) {
...
static T_4 F_139 ( int V_251 , void * V_266 )
{
...
static int F_141 ( struct V_269 * V_270 )
{
struct V_271 * V_272 ;
struct V_4 * V_5 = & V_273 ;
int V_223 = 0 , V_274 ;
V_272 = F_142 ( V_270 , V_275 , 0 ) ;
if ( ! V_272 )
return - V_276 ;
V_5 -> V_251 = F_143 ( V_270 , 0 ) ;
if ( V_5 -> V_251 < 0 )
return V_5 -> V_251 ;
V_5 -> V_90 = & V_270 -> V_90 ;
V_5 -> V_196 = F_144 ( & V_270 -> V_90 ) ;
V_5 -> V_208 = F_145 ( V_277 ) ;
V_274 = V_5 -> V_196 -> V_197 ;
if ( F_100 ( V_274 ) ) {
V_223 = F_146 ( V_274 , L_86 ) ;
if ( V_223 == 0 )
F_147 ( V_274 ,
V_5 -> V_196 -> V_198 ) ;
}
...
V_5 -> V_212 = F_148 ( & V_270 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_212 ) ) {
V_223 = F_149 ( V_5 -> V_212 ) ;
goto V_278;
}
V_223 = F_150 ( V_5 -> V_212 ) ;
if ( V_223 )
goto V_279;
V_223 = - V_280 ;
V_5 -> V_272 = F_151 ( V_272 -> V_281 , F_152 ( V_272 ) ) ;
if ( ! V_5 -> V_272 ) {
...
V_223 = F_155 ( & V_270 -> V_90 , & V_5 -> V_78 ) ;
if ( V_223 )
goto V_286;
F_14 ( V_5 ) ;
return 0 ;
...
static int F_160 ( struct V_269 * V_266 )
{
struct V_4 * V_5 = F_161 ( V_266 ) ;
...
static void F_166 ( struct V_269 * V_266 )
{
struct V_4 * V_5 = F_161 ( V_266 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_110 ( V_5 ) ;
}
static int F_167 ( struct V_269 * V_266 , T_5 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_161 ( V_266 ) ;
struct V_44 * V_45 ;
...
static int F_168 ( struct V_269 * V_266 )
{
int V_48 ;
struct V_4 * V_5 = F_161 ( V_266 ) ;
struct V_44 * V_45 ;
