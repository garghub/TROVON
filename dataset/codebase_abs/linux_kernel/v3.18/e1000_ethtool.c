...
static int F_104 ( struct V_1 * V_2 , int V_309 )
{
switch ( V_309 ) {
case V_310 :
return V_311 ;
...
static int F_114 ( struct V_1 * V_2 , struct V_321 * V_322 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = & V_6 -> V_8 ;
...
V_6 -> V_322 |= V_346 ;
F_115 ( & V_6 -> V_144 -> V_228 , V_6 -> V_322 ) ;
return 0 ;
}
...
static void F_128 ( struct V_1 * V_2 , T_1 V_374 ,
T_3 * V_81 )
{
T_3 * V_84 = V_81 ;
int V_126 ;
