...
{
struct V_9 * V_9 = F_6 ( V_2 ) ;
unsigned int V_173 = V_9 -> V_57 ? V_34 : V_46 ;
if ( ! ( F_2 ( V_2 , V_3 ) & V_32 ) )
return V_174 ;
return F_2 ( V_2 , V_173 ) & 0xff ;
}
...
static T_4 V_175 ;
static int V_21 ;
unsigned char * V_176 = ( unsigned char * ) & V_175 ;
if ( V_21 ) {
V_43 = V_176 [ sizeof( V_175 ) - V_21 ] ;
V_21 -- ;
} else if ( ! ( F_2 ( V_2 , V_3 ) & V_32 ) ) {
V_21 = F_2 ( V_2 , V_177 ) ;
V_21 = ( V_21 >> V_178 ) & V_179 ;
if ( V_21 ) {
F_4 ( V_2 , V_180 , V_8 ) ;
V_175 = F_2 ( V_2 , V_34 ) ;
V_43 = V_176 [ 0 ] ;
...
static void F_75 ( struct V_1 * V_2 , unsigned char V_43 )
{
T_4 V_10 ;
struct V_9 * V_9 = F_6 ( V_2 ) ;
V_10 = F_2 ( V_2 , V_12 ) ;
...
{
return & V_181 [ line ] . V_182 ;
}
static void F_78 ( struct V_1 * V_2 , const char * V_183 ,
unsigned int V_21 , bool V_57 )
{
int V_65 ;
int V_184 = 0 ;
bool V_185 = false ;
...
static void F_79 ( struct V_187 * V_188 , const char * V_183 ,
unsigned int V_21 )
{
struct V_1 * V_2 ;
struct V_9 * V_9 ;
F_80 ( V_188 -> V_189 < 0 || V_188 -> V_189 >= V_190 ) ;
V_2 = F_77 ( V_188 -> V_189 ) ;
V_9 = F_6 ( V_2 ) ;
F_78 ( V_2 , V_183 , V_21 , V_9 -> V_57 ) ;
}
static int T_5 F_81 ( struct V_187 * V_188 , char * V_191 )
{
struct V_1 * V_2 ;
struct V_9 * V_9 ;
int V_94 = 0 , V_192 , V_193 , V_194 ;
if ( F_46 ( V_188 -> V_189 >= V_190 || V_188 -> V_189 < 0 ) )
return - V_163 ;
V_2 = F_77 ( V_188 -> V_189 ) ;
V_9 = F_6 ( V_2 ) ;
if ( F_46 ( ! V_2 -> V_33 ) )
...
F_41 ( V_2 ) ;
if ( V_191 )
F_82 ( V_191 , & V_94 , & V_194 , & V_193 , & V_192 ) ;
V_193 = 8 ;
V_194 = 'n' ;
V_192 = 'n' ;
F_4 ( V_2 , V_144 | V_145 ,
...
F_83 ( L_5 , V_2 -> line ) ;
return F_84 ( V_2 , V_188 , V_94 , V_194 , V_193 , V_192 ) ;
}
static void
F_85 ( struct V_187 * V_195 , const char * V_183 , unsigned V_196 )
{
struct V_197 * V_157 = V_195 -> V_109 ;
F_78 ( & V_157 -> V_2 , V_183 , V_196 , false ) ;
}
static int T_5
F_86 ( struct V_197 * V_198 , const char * V_199 )
{
if ( ! V_198 -> V_2 . V_33 )
return - V_200 ;
V_198 -> V_195 -> V_201 = F_85 ;
return 0 ;
}
static void
F_87 ( struct V_187 * V_195 , const char * V_183 , unsigned V_196 )
{
struct V_197 * V_157 = V_195 -> V_109 ;
F_78 ( & V_157 -> V_2 , V_183 , V_196 , true ) ;
}
static int T_5
...
int V_71 ;
if ( V_156 -> V_203 == - 1 )
V_156 -> V_203 = F_90 ( & V_204 ) - 1 ;
if ( F_46 ( V_156 -> V_203 < 0 || V_156 -> V_203 >= V_190 ) )
return - V_163 ;
F_91 ( & V_156 -> V_157 , L_6 , V_156 -> V_203 ) ;
V_2 = F_77 ( V_156 -> V_203 ) ;
V_2 -> V_157 = & V_156 -> V_157 ;
V_9 = F_6 ( V_2 ) ;
V_203 = F_92 ( V_205 , & V_156 -> V_157 ) ;
if ( V_203 )
V_9 -> V_57 = ( unsigned long ) V_203 -> V_109 ;
else
V_9 -> V_57 = 0 ;
V_9 -> V_107 = F_93 ( & V_156 -> V_157 , L_7 ) ;
if ( F_94 ( V_9 -> V_107 ) )
return F_95 ( V_9 -> V_107 ) ;
if ( V_9 -> V_57 ) {
V_9 -> V_108 = F_93 ( & V_156 -> V_157 , L_8 ) ;
if ( F_94 ( V_9 -> V_108 ) )
return F_95 ( V_9 -> V_108 ) ;
F_96 ( V_9 -> V_107 , 1843200 ) ;
}
V_2 -> V_206 = F_97 ( V_9 -> V_107 ) ;
F_91 ( & V_156 -> V_157 , L_9 , V_2 -> V_206 ) ;
V_158 = F_61 ( V_156 , V_161 , 0 ) ;
if ( F_46 ( ! V_158 ) )
return - V_163 ;
V_2 -> V_162 = V_158 -> V_207 ;
V_71 = F_98 ( V_156 , 0 ) ;
if ( F_46 ( V_71 < 0 ) )
return - V_163 ;
V_2 -> V_71 = V_71 ;
F_99 ( V_156 , V_2 ) ;
return F_100 ( & V_208 , V_2 ) ;
}
static int F_101 ( struct V_155 * V_156 )
{
struct V_1 * V_2 = F_102 ( V_156 ) ;
F_103 ( & V_208 , V_2 ) ;
return 0 ;
}
