...
if ( F_97 ( V_2 , V_140 , V_162 , V_163 -> V_160 ) )
F_94 ( V_173 ) ;
return - V_150 ;
}
F_56 ( & V_2 -> V_79 ) ;
...
V_163 -> V_181 = V_12 -> V_176 -> V_135 -> V_181 ;
V_163 -> V_182 = V_12 -> V_176 -> V_135 -> V_183 ;
V_163 -> V_31 = V_162 -> V_184 ;
V_163 -> V_185 |= V_186 ;
#ifdef F_104
...
{
struct V_11 * V_12 = V_2 -> V_4 ;
struct V_188 * V_189 = & V_12 -> V_5 ;
struct V_13 * V_14 = F_3 ( V_12 ) ;
if ( ! ( V_12 -> V_5 . V_6 & V_190 ) )
return;
if ( V_2 -> V_27 . V_32 != V_146 -> V_184 ) {
if ( ++ V_2 -> V_27 . V_33 >= 3 )
F_8 ( V_2 , V_146 -> V_184 ) ;
} else {
V_2 -> V_27 . V_33 = 0 ;
...
{
if ( V_146 -> V_193 ) {
V_157 -> V_185 |= V_194 | V_195 ;
V_157 -> V_196 = V_2 -> V_27 . V_197 ;
if ( ! V_146 -> V_198 ) {
V_157 -> V_185 |= V_199 ;
V_2 -> V_27 . V_197 ++ ;
}
if ( V_146 -> V_200 & V_201 )
V_157 -> V_185 |= V_202 ;
}
}
int F_64 ( struct V_1 * V_2 , int V_10 , bool V_203 )
{
struct V_8 * V_9 ;
struct V_17 * V_18 = NULL , * V_204 , * V_205 ;
struct V_156 * V_157 ;
struct V_11 * V_12 = V_2 -> V_4 ;
struct V_13 * V_14 = F_3 ( V_12 ) ;
struct V_165 * V_74 = V_2 -> V_74 ;
...
struct V_145 V_146 ;
enum V_36 V_37 ;
bool V_207 = ! ! ( V_12 -> V_5 . V_6 & V_64 ) ;
int V_208 ;
T_3 V_158 = 0 ;
unsigned long V_209 ;
T_4 V_210 ;
unsigned int V_211 = 512 ;
struct V_139 * V_140 ;
if ( V_207 )
V_208 = V_51 ;
else
V_208 = V_69 ;
V_37 = V_203 ? V_50 : V_49 ;
V_158 = F_110 ( V_12 ) ;
do {
bool V_164 = false ;
...
continue;
if ( V_2 -> V_27 . V_212 )
V_205 = V_2 -> V_27 . V_212 ;
else
V_205 = V_18 ;
V_157 = F_111 ( V_205 ) ;
memset ( V_157 , 0 , sizeof( struct V_156 ) ) ;
V_206 = F_93 ( V_2 , V_205 , & V_146 , V_157 ,
& V_164 , V_158 ) ;
if ( V_206 )
goto V_213;
V_204 = F_41 ( V_14 , V_14 -> V_26 , V_214 ) ;
if ( ! V_204 ) {
F_94 ( V_215 ) ;
goto V_213;
}
V_210 = F_42 ( V_2 -> V_45 , V_204 -> V_25 ,
V_14 -> V_26 , V_208 ) ;
if ( F_43 ( F_44 ( V_2 -> V_45 , V_210 ) ) ) {
F_34 ( V_204 ) ;
goto V_213;
}
F_33 ( V_2 -> V_45 , V_9 -> V_22 ,
...
if ( V_2 -> V_27 . V_212 ) {
int V_219 = V_18 -> V_126 - F_115 ( V_205 ) ;
if ( F_116 ( V_205 , 0 , V_219 , V_214 ) < 0 ) {
F_54 ( V_18 ) ;
F_94 ( V_215 ) ;
goto V_213;
}
V_2 -> V_27 . V_212 = NULL ;
F_117 ( V_18 , F_112 ( V_205 , V_18 -> V_126 ) ,
V_18 -> V_126 ) ;
F_34 ( V_18 ) ;
V_18 = V_205 ;
}
if ( V_157 -> V_185 & V_220 )
F_118 ( V_18 , V_18 -> V_126 - 8 ) ;
F_119 ( & V_2 -> V_221 , V_209 ) ;
if ( ( V_2 -> V_131 & ( V_132 |
V_137 |
V_143 ) ) ||
F_1 ( V_2 ) )
F_75 ( V_2 , V_18 , V_146 . V_175 ) ;
F_120 ( & V_2 -> V_221 , V_209 ) ;
F_107 ( V_2 , & V_146 ) ;
