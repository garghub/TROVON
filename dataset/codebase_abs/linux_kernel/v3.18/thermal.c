...
{
F_42 ( & V_2 -> V_9 -> V_75 . V_88 , L_31 ) ;
F_42 ( & V_2 -> V_47 -> V_9 . V_88 , L_21 ) ;
F_43 ( V_2 -> V_47 ) ;
V_2 -> V_47 = NULL ;
F_44 ( V_2 -> V_9 -> V_10 ) ;
}
static void F_45 ( struct V_80 * V_9 , T_4 V_90 )
{
...
int V_19 ;
F_2 ( V_10 , L_7 , NULL , & V_96 ) ;
F_2 ( V_10 , L_12 , NULL , & V_96 ) ;
F_2 ( V_10 , L_15 , NULL , & V_96 ) ;
for ( V_19 = 0 ; V_19 < V_39 ; V_19 ++ ) {
char V_40 [ 5 ] = { '_' , 'A' , 'C' , ( '0' + V_19 ) , '\0' } ;
T_1 V_3 ;
V_3 = F_2 ( V_10 , V_40 , NULL , & V_96 ) ;
if ( V_3 == V_97 )
break;
}
F_2 ( V_10 , L_1 , NULL , & V_96 ) ;
}
...
{
struct V_1 * V_2 = F_51 ( V_102 , struct V_1 ,
V_103 ) ;
F_16 ( V_2 ) ;
}
...
return - V_105 ;
V_2 -> V_9 = V_9 ;
strcpy ( V_2 -> V_40 , V_9 -> V_73 . V_106 ) ;
...
if ( ! V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_18 )
break;
V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_114 = 1 ;
for ( V_81 = 0 ; V_81 < V_2 -> V_21 . V_41 [ V_19 ] . V_17 . V_82 ; V_81 ++ ) {
V_52 = F_66 (
V_2 -> V_21 . V_41 [ V_19 ] . V_17 . V_83 [ V_81 ] ,
& V_113 ) ;
if ( V_52 || ( V_113 != V_115 ) ) {
V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_114 = 0 ;
break;
}
}
V_2 -> V_116 . V_41 |= V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_114 ;
}
F_67 ( V_112 , & V_2 -> V_103 ) ;
return V_4 ;
}
static int F_68 ( const struct V_117 * V_118 ) {
if ( V_42 == 0 ) {
F_69 ( V_27 L_35
L_36 , V_118 -> V_119 ) ;
V_42 = - 1 ;
...
static int F_70 ( const struct V_117 * V_118 ) {
F_69 ( V_27 L_35
L_37 , V_118 -> V_119 ) ;
V_76 = 1 ;
return 0 ;
}
static int F_71 ( const struct V_117 * V_118 ) {
if ( V_100 == 0 ) {
F_69 ( V_27 L_35
L_38 , V_118 -> V_119 ) ;
V_100 = 300 ;
