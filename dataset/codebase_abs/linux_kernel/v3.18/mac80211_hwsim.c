...
if ( V_384 )
V_29 -> V_78 |= V_193 ;
V_29 -> V_30 -> V_78 |= V_385 |
V_386 |
V_387 |
V_388 ;
V_29 -> V_30 -> V_389 |= V_390 |
V_391 |
V_392 |
V_393 ;
...
F_13 ( V_29 -> V_30 , L_50 , V_29 -> V_30 -> V_448 ) ;
if ( V_343 )
F_180 ( V_29 -> V_30 , V_343 ) ;
V_23 -> V_449 = F_181 ( L_51 , V_29 -> V_30 -> V_450 ) ;
F_182 ( L_52 , 0666 , V_23 -> V_449 , V_23 , & V_451 ) ;
F_182 ( L_53 , 0666 , V_23 -> V_449 , V_23 ,
& V_452 ) ;
if ( ! V_23 -> V_191 )
F_182 ( L_54 , 0222 ,
V_23 -> V_449 ,
...
static int F_198 ( struct V_24 * V_465 ,
struct V_466 * V_80 )
{
struct V_44 * V_45 ;
struct V_22 * V_157 ;
...
! V_80 -> V_472 [ V_148 ] )
goto V_221;
V_469 = ( void * ) F_199 ( V_80 -> V_472 [ V_135 ] ) ;
V_122 = F_129 ( V_80 -> V_472 [ V_143 ] ) ;
V_467 = F_200 ( V_80 -> V_472 [ V_149 ] ) ;
V_157 = F_197 ( V_469 ) ;
if ( ! V_157 )
goto V_221;
F_201 (&data2->pending, skb, tmp) {
if ( ( unsigned long ) V_25 == V_467 ) {
...
V_189 -> V_145 . V_473 = F_129 ( V_80 -> V_472 [ V_474 ] ) ;
if ( ! ( V_122 & V_142 ) &&
( V_122 & V_475 ) ) {
if ( V_25 -> V_138 >= 16 ) {
...
static int F_203 ( struct V_24 * V_465 ,
struct V_466 * V_80 )
{
struct V_22 * V_157 ;
struct V_159 V_160 ;
...
! V_80 -> V_472 [ V_474 ] )
goto V_221;
V_476 = ( void * ) F_199 ( V_80 -> V_472 [ V_479 ] ) ;
V_477 = F_204 ( V_80 -> V_472 [ V_137 ] ) ;
V_478 = ( void * ) F_199 ( V_80 -> V_472 [ V_137 ] ) ;
V_25 = F_205 ( V_477 , V_481 ) ;
if ( V_25 == NULL )
goto V_290;
if ( V_477 > V_363 )
goto V_290;
memcpy ( F_15 ( V_25 , V_477 ) , V_478 , V_477 ) ;
V_157 = F_197 ( V_476 ) ;
if ( ! V_157 )
goto V_221;
...
V_160 . V_167 = F_129 ( V_80 -> V_472 [ V_480 ] ) ;
V_160 . signal = F_129 ( V_80 -> V_472 [ V_474 ] ) ;
...
static int F_206 ( struct V_24 * V_465 ,
struct V_466 * V_80 )
{
struct V_22 * V_23 ;
int V_482 = 1 ;
...
static int F_208 ( struct V_24 * V_483 , struct V_466 * V_80 )
{
unsigned int V_482 = V_326 ;
const char * V_484 = NULL ;
const struct V_344 * V_345 = NULL ;
bool V_346 = V_80 -> V_472 [ V_485 ] ;
bool V_347 = V_80 -> V_472 [ V_486 ] ;
bool V_191 ;
if ( V_80 -> V_472 [ V_487 ] )
V_482 = F_129 ( V_80 -> V_472 [ V_487 ] ) ;
if ( V_80 -> V_472 [ V_488 ] )
V_191 = true ;
else
V_191 = ( V_482 > 1 ) ;
if ( V_80 -> V_472 [ V_489 ] )
V_484 = F_199 ( V_80 -> V_472 [ V_489 ] ) ;
if ( V_80 -> V_472 [ V_490 ] ) {
T_5 V_144 = F_129 ( V_80 -> V_472 [ V_490 ] ) ;
if ( V_144 >= F_94 ( V_491 ) )
return - V_59 ;
V_345 = V_491 [ V_144 ] ;
}
return F_164 ( V_482 , V_484 , V_345 , V_346 ,
V_347 , V_191 ) ;
}
static int F_209 ( struct V_24 * V_483 , struct V_466 * V_80 )
{
struct V_22 * V_23 ;
int V_144 ;
if ( ! V_80 -> V_472 [ V_492 ] )
return - V_59 ;
V_144 = F_129 ( V_80 -> V_472 [ V_492 ] ) ;
F_165 ( & V_179 ) ;
F_82 (data, &hwsim_radios, list) {
if ( V_23 -> V_144 != V_144 )
continue;
...
static int F_210 ( struct V_494 * V_495 ,
unsigned long V_496 ,
void * V_497 )
{
struct V_498 * V_499 = V_497 ;
if ( V_496 != V_500 )
return V_501 ;
if ( V_499 -> V_502 == V_195 ) {
F_63 ( V_503 L_57
L_58 ) ;
V_195 = 0 ;
}
...
if ( V_290 )
return V_290 ;
V_355 = F_221 ( V_519 , L_60 ) ;
if ( F_169 ( V_355 ) ) {
V_290 = F_170 ( V_355 ) ;
goto V_520;
}
for ( V_123 = 0 ; V_123 < V_508 ; V_123 ++ ) {
