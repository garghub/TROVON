...
F_120 ( V_87 , V_118 ) ;
V_36 = F_121 ( V_87 -> V_190 , V_102 , V_87 , V_164 . V_15 , V_164 . V_16 ,
...
static int
F_135 ( struct V_3 * V_4 , struct V_199 * V_200 , int V_201 )
{
int V_36 = 0 ;
struct V_22 V_77 ;
struct V_59 V_58 ;
...
V_77 . V_14 . V_99 != 5 || ( V_77 . V_14 . V_159 & F_80 ( ~ V_212 ) ) )
goto V_206;
if ( V_77 . V_14 . V_119 )
V_77 . V_14 . V_159 |= F_80 ( V_212 ) ;
...
static int F_138 ( struct V_3 * V_4 , int V_221 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
int V_167 = V_98 -> V_168 + sizeof( struct V_88 ) ;
if ( V_221 < V_183 || V_221 > 0xFFF8 - V_167 )
return - V_78 ;
V_4 -> V_165 = V_221 ;
return 0 ;
}
...
V_4 -> V_225 = F_25 ;
V_4 -> type = V_226 ;
V_4 -> V_196 = V_227 + V_167 ;
V_4 -> V_165 = V_228 - V_167 ;
V_4 -> V_19 = V_229 ;
F_141 ( V_4 ) ;
V_4 -> V_197 = 0 ;
V_4 -> V_230 = 4 ;
...
static int F_146 ( struct V_236 * V_237 [] , struct V_236 * V_100 [] )
{
T_6 V_149 ;
if ( ! V_100 || ! V_100 [ V_238 ] )
return 0 ;
V_149 = F_147 ( V_100 [ V_238 ] ) ;
if ( V_149 != V_118 &&
V_149 != V_145 &&
V_149 != 0 )
return - V_78 ;
...
static void F_148 ( struct V_236 * V_100 [] ,
struct V_22 * V_13 )
{
...
return;
if ( V_100 [ V_239 ] )
V_13 -> V_17 = F_149 ( V_100 [ V_239 ] ) ;
if ( V_100 [ V_240 ] )
V_13 -> V_14 . V_15 = F_150 ( V_100 [ V_240 ] ) ;
if ( V_100 [ V_241 ] )
V_13 -> V_14 . V_16 = F_150 ( V_100 [ V_241 ] ) ;
if ( V_100 [ V_242 ] ) {
V_13 -> V_14 . V_119 = F_147 ( V_100 [ V_242 ] ) ;
if ( V_13 -> V_14 . V_119 )
V_13 -> V_14 . V_159 = F_80 ( V_212 ) ;
}
if ( V_100 [ V_243 ] )
V_13 -> V_14 . V_140 = F_147 ( V_100 [ V_243 ] ) ;
if ( ! V_100 [ V_244 ] || F_147 ( V_100 [ V_244 ] ) )
V_13 -> V_14 . V_159 = F_80 ( V_212 ) ;
if ( V_100 [ V_245 ] )
V_13 -> V_41 = F_151 ( V_100 [ V_245 ] ) ;
if ( V_100 [ V_238 ] )
V_13 -> V_14 . V_133 = F_147 ( V_100 [ V_238 ] ) ;
}
static bool F_152 ( struct V_236 * V_100 [] ,
struct F_119 * V_246 )
{
bool V_67 = false ;
...
if ( V_100 [ V_247 ] ) {
V_67 = true ;
V_246 -> type = F_153 ( V_100 [ V_247 ] ) ;
}
if ( V_100 [ V_248 ] ) {
V_67 = true ;
V_246 -> V_19 = F_153 ( V_100 [ V_248 ] ) ;
}
if ( V_100 [ V_249 ] ) {
V_67 = true ;
V_246 -> V_250 = F_153 ( V_100 [ V_249 ] ) ;
}
if ( V_100 [ V_251 ] ) {
V_67 = true ;
V_246 -> V_252 = F_153 ( V_100 [ V_251 ] ) ;
}
return V_67 ;
}
static bool F_154 ( struct V_236 * V_100 [] ,
struct V_198 * V_30 )
{
bool V_67 = false ;
...
static int F_156 ( struct V_2 * V_257 , struct V_3 * V_4 ,
struct V_236 * V_237 [] , struct V_236 * V_100 [] )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_1 * V_49 ;
struct F_119 V_246 ;
...
int V_36 ;
V_49 = F_14 ( V_4 ) ;
if ( F_152 ( V_100 , & V_246 ) ) {
V_36 = F_157 ( V_49 , & V_246 ) ;
if ( V_36 < 0 )
return V_36 ;
}
...
static int F_158 ( struct V_3 * V_4 , struct V_236 * V_237 [] ,
struct V_236 * V_100 [] )
{
struct V_1 * V_9 = F_14 ( V_4 ) ;
struct V_22 V_77 ;
...
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
struct V_22 * V_258 = & V_98 -> V_13 ;
if ( F_162 ( V_87 , V_239 , V_258 -> V_17 ) ||
F_163 ( V_87 , V_240 , V_258 -> V_14 . V_15 ) ||
F_163 ( V_87 , V_241 , V_258 -> V_14 . V_16 ) ||
F_164 ( V_87 , V_242 , V_258 -> V_14 . V_119 ) ||
F_164 ( V_87 , V_243 , V_258 -> V_14 . V_140 ) ||
F_164 ( V_87 , V_244 ,
! ! ( V_258 -> V_14 . V_159 & F_80 ( V_212 ) ) ) ||
F_164 ( V_87 , V_238 , V_258 -> V_14 . V_133 ) ||
F_165 ( V_87 , V_245 , V_258 -> V_41 ) )
goto V_259;
#ifdef F_13
if ( F_166 ( V_87 , V_253 , sizeof( struct V_94 ) ,
& V_98 -> V_30 . V_31 ) ||
F_163 ( V_87 , V_254 ,
V_98 -> V_30 . V_32 ) ||
F_167 ( V_87 , V_255 ,
...
static void F_168 ( struct V_3 * V_4 , struct V_262 * V_83 )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
if ( V_4 != V_11 -> V_29 )
...
V_11 -> V_25 [ 1 ] = V_11 -> V_265 ;
V_11 -> V_25 [ 2 ] = V_11 -> V_266 ;
V_11 -> V_25 [ 3 ] = V_11 -> V_267 ;
...
F_24 ( V_11 -> V_29 , V_2 ) ;
V_11 -> V_29 -> V_46 = & V_47 ;
V_11 -> V_29 -> V_231 |= V_269 ;
V_36 = F_145 ( V_11 -> V_29 ) ;
if ( V_36 )
goto V_270;
F_12 ( V_11 -> V_29 , V_11 ) ;
if ( ( V_36 = F_173 ( V_11 -> V_29 ) ) )
goto V_271;
V_9 = F_14 ( V_11 -> V_29 ) ;
...
if ( V_36 < 0 )
return V_36 ;
V_36 = F_187 ( & V_273 , V_274 ) ;
if ( V_36 < 0 ) {
F_185 ( L_8 , V_278 ) ;
goto V_279;
}
V_36 = F_187 ( & V_275 , V_276 ) ;
if ( V_36 < 0 ) {
F_185 ( L_9 , V_278 ) ;
goto V_280;
}
