...
{
struct V_122 * V_123 = V_96 -> V_97 . V_124 ;
struct V_122 * V_125 ;
int T_2 ;
if ( V_123 == NULL )
return 0 ;
V_125 = F_83 ( V_123 , NULL ) ;
if ( ! V_125 )
return 0 ;
do {
T_1 V_126 ;
T_2 = F_84 ( V_125 , L_18 , & V_126 ) ;
if ( T_2 )
V_126 = 0 ;
#ifdef F_85
if ( V_126 == 0 )
...
F_88 ( V_96 , V_125 ) ;
#endif
} while ( ( V_125 = F_83 ( V_123 , V_125 ) ) != NULL );
return 0 ;
}
...
if ( T_2 )
return T_2 ;
V_128 = F_93 ( V_4 . V_96 , V_130 , 0 ) ;
if ( ! V_128 ) {
F_20 ( L_19 ) ;
return - V_93 ;
}
V_4 . V_5 = F_94 ( & V_96 -> V_97 , V_128 -> V_39 ,
F_95 ( V_128 ) ) ;
if ( ! V_4 . V_5 ) {
F_20 ( L_20 ) ;
return - V_104 ;
...
static int F_103 ( struct V_134 * V_97 )
{
F_5 () ;
F_104 ( V_97 , 0 ) ;
return 0 ;
}
static int F_105 ( struct V_134 * V_97 )
{
int T_2 ;
