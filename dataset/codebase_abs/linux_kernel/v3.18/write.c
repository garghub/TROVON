...
struct V_76 V_77 ;
int V_82 ;
F_76 ( & V_77 , V_16 -> V_83 -> V_21 , F_41 ( V_43 ) ,
false , & V_84 ) ;
...
int F_81 ( struct V_86 * V_83 , struct V_42 * V_43 )
{
...
goto V_91;
F_29 ( V_20 , V_92 ) ;
F_76 ( & V_77 , V_20 , F_41 ( V_43 ) , false ,
& V_84 ) ;
V_82 = F_83 ( V_83 , V_43 , F_80 , & V_77 ) ;
F_77 ( & V_77 ) ;
F_84 ( V_88 , V_87 ) ;
F_85 () ;
F_86 ( V_87 , V_88 ) ;
...
F_63 ( V_17 ) ;
F_21 ( & V_20 -> V_22 ) ;
if ( ! V_15 -> V_93 && F_88 ( V_20 ) -> F_89 ( V_20 , V_94 ) )
V_20 -> V_95 ++ ;
...
F_99 ( & V_104 , V_20 ) ;
V_101 = F_100 ( V_20 , & V_104 , V_16 ) ;
if ( V_101 )
return V_101 -> V_18 ;
F_101 (freq, t, &cinfo.mds->list, wb_list) {
if ( V_101 -> V_41 == V_16 )
return V_101 -> V_18 ;
}
return NULL ;
...
void
F_102 ( struct V_13 * V_17 , struct V_106 * V_107 ,
struct V_103 * V_104 )
{
F_10 ( V_71 , & ( V_17 ) -> V_34 ) ;
F_21 ( V_104 -> V_108 ) ;
...
F_23 ( V_104 -> V_108 ) ;
if ( ! V_104 -> V_111 ) {
F_104 ( V_17 -> V_41 , V_112 ) ;
F_105 ( F_20 ( V_17 -> V_41 ) -> V_58 ,
V_113 ) ;
F_106 ( V_17 -> V_97 -> V_98 -> V_99 ,
V_114 ) ;
}
}
void
...
void
F_112 ( struct V_13 * V_17 , struct V_120 * V_121 ,
struct V_103 * V_104 )
{
if ( F_113 ( V_17 , V_121 , V_104 ) )
return;
F_102 ( V_17 , & V_104 -> V_109 -> V_122 , V_104 ) ;
}
static void
F_114 ( struct V_16 * V_16 )
{
F_115 ( V_16 , V_112 ) ;
F_116 ( F_20 ( V_16 ) -> V_58 , V_113 ) ;
}
static void
...
int
F_123 ( struct V_106 * V_136 , struct V_106 * V_107 ,
struct V_103 * V_104 , int V_137 )
{
struct V_13 * V_17 , * V_38 ;
int V_44 = 0 ;
F_101 (req, tmp, src, wb_list) {
if ( ! F_63 ( V_17 ) )
continue;
F_18 ( & V_17 -> V_19 ) ;
if ( F_124 ( V_104 -> V_108 ) )
F_125 ( V_17 , V_38 , V_138 ) ;
F_107 ( V_17 , V_104 ) ;
F_103 ( V_17 , V_107 ) ;
V_44 ++ ;
...
V_44 = F_123 ( & V_104 -> V_109 -> V_122 , V_107 ,
V_104 , V_137 ) ;
V_44 += F_127 ( V_20 , V_104 , V_137 - V_44 ) ;
}
F_23 ( V_104 -> V_108 ) ;
return V_44 ;
}
...
int F_135 ( struct V_143 * V_143 , struct V_16 * V_16 )
{
struct V_9 * V_10 = F_136 ( V_143 ) ;
struct V_144 * V_145 ;
struct V_13 * V_17 ;
int V_146 , V_147 ;
do {
...
if ( ! V_146 )
return 0 ;
V_147 = F_130 ( F_20 ( V_16 ) -> V_21 , V_16 ) ;
} while ( V_147 == 0 );
return V_147 ;
}
int
F_137 ( struct V_143 * V_156 , struct V_20 * V_20 )
{
struct V_9 * V_10 = F_136 ( V_156 ) ;
struct V_157 * V_158 = F_43 ( V_20 ) -> V_159 -> V_160 ;
return F_138 ( V_158 , V_10 -> V_161 ) ;
}
bool F_139 ( struct V_9 * V_10 )
{
return F_140 ( V_10 -> V_161 ) ;
}
static bool F_141 ( struct V_16 * V_16 , struct V_20 * V_20 )
{
struct V_14 * V_15 = F_22 ( V_20 ) ;
if ( F_142 ( V_20 ) )
goto V_29;
...
static int F_144 ( struct V_143 * V_143 , struct V_16 * V_16 , struct V_20 * V_20 )
{
if ( V_143 -> V_166 & V_167 )
return 0 ;
if ( ! F_141 ( V_16 , V_20 ) )
return 0 ;
if ( F_88 ( V_20 ) -> F_89 ( V_20 , V_94 ) )
return 1 ;
...
int F_145 ( struct V_143 * V_143 , struct V_16 * V_16 ,
unsigned int V_23 , unsigned int V_24 )
{
struct V_9 * V_10 = F_136 ( V_143 ) ;
struct V_20 * V_20 = F_20 ( V_16 ) -> V_21 ;
...
if ( F_144 ( V_143 , V_16 , V_20 ) ) {
V_24 = V_137 ( V_24 + V_23 , F_35 ( V_16 ) ) ;
V_23 = 0 ;
}
V_147 = F_133 ( V_10 , V_16 , V_23 , V_24 ) ;
if ( V_147 < 0 )
F_30 ( V_16 ) ;
else
F_98 ( V_16 ) ;
...
static void F_148 ( struct V_6 * V_8 ,
struct V_178 * V_179 ,
struct V_180 * V_181 , int V_174 )
{
struct V_20 * V_20 = V_8 -> V_20 ;
int V_182 = F_147 ( V_174 ) ;
V_181 -> V_182 = V_182 ;
F_88 ( V_20 ) -> F_149 ( V_8 , V_179 ) ;
F_150 ( F_43 ( V_20 ) -> V_183 ,
...
static void F_151 ( struct V_106 * V_31 )
{
struct V_13 * V_17 ;
while ( ! F_120 ( V_31 ) ) {
...
#endif
F_153 ( V_77 , V_20 , V_191 , V_188 , & V_195 ,
V_189 -> V_196 , V_185 ) ;
}
void F_154 ( struct V_76 * V_77 )
{
V_77 -> V_191 = & V_192 ;
V_77 -> V_197 = F_43 ( V_77 -> V_198 ) -> V_196 ;
}
void F_155 ( struct V_199 * V_200 , void * V_201 )
{
struct V_1 * V_85 = V_201 ;
F_88 ( V_85 -> V_20 ) -> F_156 ( V_200 , V_85 ) ;
}
static void F_157 ( struct V_6 * V_8 )
{
}
static int F_158 ( const struct V_20 * V_20 )
{
...
V_204 |= V_209 ;
if ( F_14 ( V_204 && F_159 ( V_202 ) ) )
return V_204 ;
return 0 ;
}
static int F_160 ( struct V_199 * V_200 ,
struct V_6 * V_8 ,
struct V_20 * V_20 )
{
int V_147 ;
V_147 = F_88 ( V_20 ) -> F_161 ( V_200 , V_8 ) ;
if ( V_147 != 0 )
return V_147 ;
F_72 ( V_20 , V_210 , V_8 -> V_211 . V_24 ) ;
...
F_88 ( V_85 -> V_20 ) -> F_174 ( V_85 , & V_179 ) ;
F_146 ( L_6 , V_85 -> V_200 . V_243 ) ;
...
struct V_103 * V_104 )
{
struct V_13 * V_247 = F_121 ( V_31 -> V_129 ) ;
...
struct V_13 * V_17 ;
while ( ! F_120 ( V_252 ) ) {
V_17 = F_121 ( V_252 -> V_129 ) ;
F_108 ( V_17 ) ;
F_112 ( V_17 , V_121 , V_104 ) ;
if ( ! V_104 -> V_111 ) {
F_115 ( V_17 -> V_41 , V_112 ) ;
F_116 ( F_20 ( V_17 -> V_41 ) -> V_58 ,
V_113 ) ;
}
F_134 ( V_17 ) ;
}
...
F_88 ( V_85 -> V_20 ) -> F_192 ( V_200 , V_85 ) ;
}
...
struct V_103 V_104 ;
struct V_54 * V_55 ;
while ( ! F_120 ( & V_85 -> V_5 ) ) {
V_17 = F_121 ( V_85 -> V_5 . V_129 ) ;
F_108 ( V_17 ) ;
F_114 ( V_17 -> V_41 ) ;
F_146 ( L_8 ,
...
F_51 ( & V_55 -> V_58 , V_59 ) ;
F_110 ( & V_104 , V_85 -> V_20 , V_85 -> V_111 ) ;
