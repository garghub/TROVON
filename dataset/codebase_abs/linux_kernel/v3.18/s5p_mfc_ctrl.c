...
int F_34 ( struct V_1 * V_2 , struct V_66 * V_67 )
{
int V_51 = 0 ;
...
F_22 ( 2 , L_28 , V_67 -> V_75 ) ;
return V_51 ;
V_74:
if ( V_67 -> type == V_69 )
F_31 ( V_2 -> V_60 , V_76 , V_67 ) ;
V_71:
F_31 ( V_2 -> V_60 , V_77 , V_67 ) ;
V_20:
return V_51 ;
}
