...
V_38 -> V_54 = V_55 ;
V_38 -> V_56 = V_57 ;
if ( F_13 ( V_38 -> V_58 , V_38 , V_22 , V_31 , V_43 ) ) {
F_14 ( V_38 ) ;
return NULL ;
}
return V_38 ;
}
static int F_15 ( struct V_2 * V_3 , int V_59 ,
struct V_1 * V_20 )
{
...
static int F_19 ( struct V_2 * V_3 , struct V_36 * V_76 )
{
...
static int F_23 ( struct V_2 * V_3 , const char * V_89 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
