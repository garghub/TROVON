...
if ( V_2 -> V_37 == V_61 ) {
int V_51 = F_2 ( V_2 , V_72 ) ;
if ( V_51 < 0 )
return V_51 ;
V_51 &= ~ V_73 ;
V_51 |= V_74 ;
V_51 |= V_75 ;
V_3 = F_4 ( V_2 , V_72 , V_51 ) ;
if ( V_3 < 0 )
return V_3 ;
}
V_3 = F_7 ( V_2 ) ;
...
if ( V_2 -> V_83 == V_84 ) {
V_2 -> V_87 = V_77 & V_95 ? 1 : 0 ;
V_2 -> V_88 = V_77 & V_96 ? 1 : 0 ;
}
} else {
...
static void F_23 ( struct V_1 * V_2 , struct V_101 * V_102 )
{
V_102 -> V_103 = V_104 ;
V_102 -> V_105 = 0 ;
if ( F_4 ( V_2 , V_28 ,
...
static int F_24 ( struct V_1 * V_2 , struct V_101 * V_102 )
{
int V_3 , V_34 , V_51 ;
V_34 = F_2 ( V_2 , V_28 ) ;
if ( V_102 -> V_105 & V_104 ) {
V_3 = F_4 ( V_2 , V_28 , 0x00 ) ;
if ( V_3 < 0 )
return V_3 ;
V_51 = F_2 ( V_2 , V_109 ) ;
V_51 |= V_110 ;
V_3 = F_4 ( V_2 , V_109 , V_51 ) ;
if ( V_3 < 0 )
return V_3 ;
V_3 = F_4 ( V_2 , V_28 ,
V_111 ) ;
