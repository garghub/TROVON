...
struct V_29 * F_23 ( unsigned long V_30 , unsigned long V_11 )
{
struct V_29 * V_31 ;
unsigned long V_32 ;
...
goto V_33;
V_31 -> V_30 = V_30 ;
V_32 = F_24 ( V_30 ) * sizeof( unsigned long ) ;
V_31 -> V_34 = F_2 ( V_32 , V_9 ) ;
if ( ! V_31 -> V_34 )
goto V_35;
if ( V_11 & V_36 ) {
V_31 -> V_37 = F_25 ( V_32 , V_9 ) ;
if ( ! V_31 -> V_37 )
goto V_35;
...
unsigned long F_28 ( struct V_29 * V_31 , unsigned long V_46 )
{
unsigned long V_47 , V_48 , V_11 ;
if ( ! V_31 -> V_37 || V_46 == 0 )
return - 1UL ;
F_29 ( & V_31 -> V_45 , V_11 ) ;
V_47 = F_30 ( V_31 -> V_37 , V_31 -> V_30 ) ;
while ( V_47 + V_46 <= V_31 -> V_30 ) {
for ( V_48 = 1 ; V_48 < V_46 ; V_48 ++ )
if ( ! F_31 ( V_47 + V_48 , V_31 -> V_37 ) )
break;
if ( V_48 >= V_46 ) {
for ( V_48 = 0 ; V_48 < V_46 ; V_48 ++ )
F_32 ( V_47 + V_48 , V_31 -> V_37 ) ;
if ( V_47 + V_46 >= V_31 -> V_38 )
V_31 -> V_38 = V_47 + V_46 + 1 ;
break;
}
V_47 = F_33 ( V_31 -> V_37 , V_31 -> V_30 , V_47 + V_48 + 1 ) ;
}
...
void F_35 ( struct V_29 * V_31 , unsigned long V_47 , unsigned long V_46 )
{
...
F_29 ( & V_31 -> V_45 , V_11 ) ;
for ( V_48 = 0 ; V_48 < V_46 ; V_48 ++ ) {
F_32 ( V_47 + V_48 , V_31 -> V_34 ) ;
F_36 ( V_47 + V_48 , V_31 -> V_37 ) ;
}
if ( V_47 + V_46 >= V_31 -> V_38 ) {
while ( V_31 -> V_38 > 0 && ! F_31 ( V_31 -> V_38 - 1 , V_31 -> V_37 ) )
V_31 -> V_38 -- ;
}
F_34 ( & V_31 -> V_45 , V_11 ) ;
}
unsigned long F_37 ( struct V_29 * V_31 , unsigned long V_49 ,
unsigned long V_38 )
{
unsigned long V_47 ;
V_47 = F_33 ( V_31 -> V_34 , V_38 , V_49 ) ;
if ( V_47 >= V_38 )
return - 1UL ;
F_32 ( V_47 , V_31 -> V_34 ) ;
return V_47 ;
