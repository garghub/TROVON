...
static int F_21 ( struct V_3 * V_4 , int V_30 , int type )
{
unsigned int V_31 ;
struct V_24 * V_25 ;
struct V_32 V_33 ;
...
if ( V_8 == 0 )
V_8 = F_12 ( V_4 , V_15 ) ;
V_33 . V_36 = V_8 & 0xFFFFFFFF ;
V_33 . V_37 = V_8 >> 32 ;
V_31 = F_25 ( V_28 -> V_38 , V_15 ) ;
if ( V_31 == V_27 ) {
F_22 ( L_6 , V_15 ) ;
F_18 ( & V_28 -> V_29 , V_15 , 1 ) ;
return - V_39 ;
}
F_17 ( V_31 , V_25 ) ;
F_26 ( V_31 , & V_40 ) ;
