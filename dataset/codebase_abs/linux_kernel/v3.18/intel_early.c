...
return 0 ;
F_24 ( V_85 ,
( unsigned long ) V_82 -> V_86 ,
( unsigned long ) V_82 -> V_86 >> 16 >> 16 ) ;
F_24 ( V_70 , 0 , 0 ) ;
F_25 () ;
F_23 ( V_70 , V_63 [ 0 ] , V_63 [ 1 ] ) ;
...
V_95 =
( unsigned long * ) F_6 ( V_26 ) ;
V_94 = (struct V_29 * ) F_6 ( & V_29 ) ;
V_97 = ( unsigned long * ) F_6 ( & V_27 ) ;
V_96 = ( unsigned long ) F_6 ( * V_97 ) ;
#else
V_94 = & V_29 ;
V_95 = V_26 ;
V_96 = V_27 ;
