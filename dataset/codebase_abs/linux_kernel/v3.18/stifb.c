...
static int T_3 F_65 ( struct V_112 * V_113 , int V_114 )
{
struct V_115 * V_51 ;
struct V_105 * V_12 ;
struct V_1 * V_2 ;
...
V_12 = & V_11 -> V_12 ;
V_2 -> V_113 = V_113 ;
V_117 = V_113 -> V_122 -> V_123 . V_117 ;
V_2 -> V_6 = V_2 -> V_113 -> V_124 [ 0 ] ;
switch ( V_2 -> V_6 ) {
case V_7 :
if ( strstr ( V_117 , L_2 ) ) {
F_67 ( V_125
...
break;
case V_130 :
V_46 = V_2 -> V_131 . V_132 ;
V_47 = V_2 -> V_131 . V_133 ;
V_2 -> V_6 = V_9 ;
break;
case V_10 :
V_118 = 32 ;
break;
case V_14 :
memset ( & V_2 -> V_131 , 0 , sizeof( V_2 -> V_131 ) ) ;
if ( ( V_2 -> V_113 -> V_134 [ 0 ] & 0xfc000000 ) ==
( V_2 -> V_113 -> V_134 [ 2 ] & 0xfc000000 ) )
V_116 = F_71 ( V_2 -> V_113 -> V_134 [ 0 ] ) ;
else
V_116 = F_71 ( V_2 -> V_113 -> V_134 [ 1 ] ) ;
V_2 -> V_135 = F_72 ( V_116 ) ;
if ( F_53 ( V_2 ) ) {
if ( V_114 == 8 || V_114 == 32 )
V_118 = V_114 ;
else
...
V_51 -> V_137 = F_71 ( V_2 -> V_113 -> V_134 [ 1 ] ) ;
V_51 -> V_138 = V_2 -> V_113 -> V_139 [ 1 ] . V_140 . V_54 * 4096 ;
V_51 -> V_52 = ( V_2 -> V_113 -> V_141 -> V_142 * V_118 ) / 8 ;
if ( ! V_51 -> V_52 )
V_51 -> V_52 = 2048 ;
if ( V_51 -> V_138 > V_47 * V_51 -> V_52 )
V_51 -> V_138 = V_47 * V_51 -> V_52 ;
V_51 -> V_143 = V_144 ;
switch ( V_118 ) {
case 1 :
V_51 -> type = V_145 ;
...
V_12 -> V_46 = V_12 -> V_149 = V_46 ;
V_12 -> V_47 = V_12 -> V_150 = V_47 ;
V_12 -> V_13 = V_118 ;
strcpy ( V_51 -> V_6 , L_12 ) ;
V_11 -> V_151 = & V_152 ;
V_11 -> V_50 = F_74 ( F_70 ( V_2 , 1 ) , V_51 -> V_138 ) ;
V_11 -> V_153 = V_51 -> V_138 ;
V_11 -> V_154 = V_155 ;
V_11 -> V_106 = & V_2 -> V_106 ;
if ( F_75 ( & V_11 -> V_156 , V_101 , 0 ) )
goto V_157;
F_64 ( V_2 ) ;
if ( ! F_76 ( V_51 -> V_137 , V_51 -> V_138 , L_13 ) ) {
F_67 ( V_120 L_14 ,
V_51 -> V_137 , V_51 -> V_137 + V_51 -> V_138 ) ;
goto V_158;
}
if ( ! F_76 ( V_51 -> V_127 , V_51 -> V_128 , L_15 ) ) {
F_67 ( V_120 L_16 ,
V_51 -> V_127 , V_51 -> V_127 + V_51 -> V_128 ) ;
goto V_159;
}
if ( F_77 ( & V_2 -> V_11 ) < 0 )
goto V_160;
...
return 0 ;
V_160:
F_78 ( V_51 -> V_127 , V_51 -> V_128 ) ;
V_159:
F_78 ( V_51 -> V_137 , V_51 -> V_138 ) ;
V_158:
F_79 ( & V_11 -> V_156 ) ;
V_157:
F_80 ( V_11 -> V_50 ) ;
...
V_162 = F_86 ( 0 ) ;
if ( V_162 ) {
for ( V_163 = 1 ; V_163 <= V_167 ; V_163 ++ ) {
V_113 = F_86 ( V_163 ) ;
if ( ! V_113 )
break;
if ( V_113 == V_162 ) {
F_65 ( V_113 , V_168 [ V_163 - 1 ] ) ;
break;
}
}
}
...
F_88 ( V_113 -> V_11 ) ;
F_78 ( V_11 -> V_51 . V_127 , V_11 -> V_51 . V_128 ) ;
F_78 ( V_11 -> V_51 . V_137 , V_11 -> V_51 . V_138 ) ;
if ( V_11 -> V_50 )
F_80 ( V_11 -> V_50 ) ;
F_79 ( & V_11 -> V_156 ) ;
F_89 ( V_11 ) ;
...
if ( * V_169 ++ != ':' )
break;
V_168 [ V_163 ] = F_90 ( V_169 , & V_169 , 10 ) ;
}
}
return 1 ;
}
