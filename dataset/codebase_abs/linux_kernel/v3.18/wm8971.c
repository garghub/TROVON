...
F_25 ( V_12 , V_67 , 0x0100 , 0x0100 ) ;
F_25 ( V_12 , V_68 , 0x0100 , 0x0100 ) ;
F_25 ( V_12 , V_69 , 0x0100 , 0x0100 ) ;
F_25 ( V_12 , V_70 , 0x0100 , 0x0100 ) ;
F_25 ( V_12 , V_71 , 0x0100 , 0x0100 ) ;
F_25 ( V_12 , V_72 , 0x0100 , 0x0100 ) ;
return V_63 ;
}
...
struct V_77 * V_77 ;
int V_63 ;
V_14 = F_29 ( & V_74 -> V_78 , sizeof( struct V_13 ) ,
V_79 ) ;
if ( V_14 == NULL )
return - V_64 ;
V_77 = F_30 ( V_74 , & V_80 ) ;
...
static int F_35 ( struct V_73 * V_83 )
{
F_36 ( & V_83 -> V_78 ) ;
return 0 ;
}
