...
if ( V_22 -> V_39 != V_91 )
return - V_142 ;
if ( V_134 . V_139 && ( V_22 -> V_28 & V_29 ) ) {
V_134 . V_139 = F_79 ( V_22 , V_134 . V_139 ) ;
F_80 ( V_22 , V_134 . V_139 ) ;
if ( F_52 ( V_22 ) &&
F_81 ( V_22 ) == 0 ) {
F_55 ( V_2 , V_22 ) ;
}
}
if ( V_134 . V_140 && ( V_22 -> V_28 & V_31 ) ) {
V_134 . V_140 =
F_82 ( V_22 , V_134 . V_140 ) ;
F_83 ( V_22 , V_134 . V_140 ) ;
}
V_141:
V_134 . V_137 = V_35 -> V_137 ;
V_134 . V_135 = V_35 -> V_135 ;
...
static int F_84 ( struct V_143 * V_144 ,
unsigned int * V_145 )
{
if ( V_144 -> V_146 < 1 )
return - V_56 ;
...
F_85 ( L_8 ,
V_145 [ 0 ] ) ;
F_85 ( L_9 , V_177 , __FILE__ ) ;
F_85 ( L_10 , V_144 -> V_146 ) ;
return 0 ;
}
return - V_56 ;
}
static int F_86 ( struct V_1 * V_2 , struct V_143 * V_144 ,
...
unsigned int V_197 = V_145 [ 0 ] ;
unsigned int V_198 = 0 ;
if ( V_22 -> V_103 <= 32 ) {
V_198 = F_90 ( V_144 -> V_190 ) ;
if ( V_198 > 0 ) {
V_144 -> V_190 = 0 ;
V_145 [ 0 ] <<= V_198 ;
V_145 [ 1 ] <<= V_198 ;
...
return - V_79 ;
V_145 = F_92 ( V_204 , sizeof( unsigned int ) , V_65 ) ;
if ( ! V_145 ) {
V_71 = - V_102 ;
goto error;
}
...
V_71 = F_86 ( V_2 , V_203 + V_15 , V_145 , V_91 ) ;
if ( V_71 < 0 )
goto error;
...
V_71 = F_86 ( V_2 , & V_144 , V_145 , V_91 ) ;
if ( V_71 < 0 )
goto error;
...
if ( F_99 ( V_69 ) )
return F_100 ( V_69 ) ;
V_71 = F_89 ( V_22 , V_68 -> V_210 , V_69 ) ;
if ( V_71 < 0 ) {
F_10 ( V_69 ) ;
return V_71 ;
}
...
V_71 = F_97 ( V_2 , V_22 , V_211 , & V_35 -> V_68 ) ;
if ( V_71 )
goto V_212;
...
static int F_103 ( struct V_1 * V_2 , unsigned long V_76 ,
void * V_91 )
{
int V_71 = 0 ;
unsigned long V_59 ;
...
static int F_104 ( struct V_1 * V_2 , unsigned long V_76 ,
void * V_91 )
{
struct V_21 * V_22 ;
if ( V_76 >= V_2 -> V_73 )
...
static int F_105 ( struct V_1 * V_2 , unsigned long V_76 ,
void * V_91 )
{
struct V_21 * V_22 ;
int V_71 ;
...
static int F_106 ( struct V_1 * V_2 , unsigned long V_76 ,
void * V_91 )
{
struct V_21 * V_22 ;
if ( V_76 >= V_2 -> V_73 )
...
static long F_107 ( struct V_91 * V_91 , unsigned int V_68 ,
unsigned long V_76 )
{
const unsigned V_7 = F_70 ( F_71 ( V_91 ) ) ;
...
break;
case V_237 :
V_224 = F_101 ( V_2 , (struct V_208 T_3 * ) V_76 , V_91 ) ;
break;
case V_238 :
V_224 = F_102 ( V_2 , (struct V_208 T_3 * ) V_76 ,
V_91 ) ;
break;
case V_239 :
V_224 = F_91 ( V_2 ,
...
break;
case V_240 :
V_224 = F_95 ( V_2 , (struct V_143 T_3 * ) V_76 ,
V_91 ) ;
break;
case V_241 :
V_224 = F_106 ( V_2 , V_76 , V_91 ) ;
break;
default:
V_224 = - V_226 ;
break;
...
static int F_113 ( struct V_91 * V_91 , struct V_242 * V_247 )
{
const unsigned V_7 = F_70 ( F_71 ( V_91 ) ) ;
struct V_1 * V_2 = V_91 -> V_223 ;
struct V_21 * V_22 ;
...
if ( F_116 ( V_247 , V_248 ,
F_117 ( F_118 ( V_49 -> V_258 ) ) ,
V_41 , V_259 ) ) {
V_36 = - V_186 ;
goto V_227;
}
...
static unsigned int F_120 ( struct V_91 * V_91 , T_4 * V_263 )
{
unsigned int V_57 = 0 ;
const unsigned V_7 = F_70 ( F_71 ( V_91 ) ) ;
struct V_1 * V_2 = V_91 -> V_223 ;
...
V_22 = F_30 ( V_2 , V_7 ) ;
if ( V_22 && V_22 -> V_35 ) {
F_121 ( V_91 , & V_22 -> V_35 -> V_70 , V_263 ) ;
...
V_22 = F_31 ( V_2 , V_7 ) ;
if ( V_22 && V_22 -> V_35 ) {
unsigned int V_266 = F_123 ( V_22 ) ;
F_121 ( V_91 , & V_22 -> V_35 -> V_70 , V_263 ) ;
F_82 ( V_22 , V_22 -> V_35 -> V_45 ) ;
if ( ! V_22 -> V_39 || ! F_50 ( V_22 ) ||
F_124 ( V_22 ) >= V_266 )
V_57 |= V_267 | V_268 ;
}
...
static T_1 F_125 ( struct V_91 * V_91 , const char T_3 * V_49 ,
T_2 V_269 , T_5 * V_270 )
{
struct V_21 * V_22 ;
struct V_34 * V_35 ;
...
V_146 = V_269 ;
V_271 = V_146 ;
if ( V_35 -> V_135 + V_271 > V_35 -> V_45 )
V_271 = V_35 -> V_45 - V_35 -> V_135 ;
F_82 ( V_22 , V_35 -> V_45 ) ;
if ( V_271 > F_124 ( V_22 ) )
V_271 = F_124 ( V_22 ) ;
if ( V_271 < V_146 )
...
V_271 = F_64 ( V_35 -> V_283 + V_35 -> V_135 ,
V_49 , V_146 ) ;
if ( V_271 ) {
V_146 -= V_271 ;
V_36 = - V_79 ;
...
static T_1 F_132 ( struct V_91 * V_91 , char T_3 * V_49 , T_2 V_269 ,
T_5 * V_270 )
{
struct V_21 * V_22 ;
struct V_34 * V_35 ;
...
static int F_133 ( struct V_286 * V_286 , struct V_91 * V_91 )
{
...
static int F_136 ( int V_289 , struct V_91 * V_91 , int V_290 )
{
struct V_1 * V_2 = V_91 -> V_223 ;
return F_137 ( V_289 , V_91 , V_290 , & V_2 -> V_291 ) ;
}
static int F_138 ( struct V_286 * V_286 , struct V_91 * V_91 )
{
struct V_1 * V_2 = V_91 -> V_223 ;
...
F_156 ( & V_302 , & V_303 ) ;
V_302 . V_304 = V_305 ;
V_36 = F_157 ( & V_302 . V_306 , L_46 ) ;
if ( V_36 ) {
F_158 ( F_24 ( V_20 , 0 ) ,
V_300 ) ;
return V_36 ;
}
if ( F_159 ( & V_302 , F_24 ( V_20 , 0 ) , V_300 ) ) {
F_158 ( F_24 ( V_20 , 0 ) ,
V_300 ) ;
return - V_189 ;
}
V_19 = F_160 ( V_305 , L_46 ) ;
if ( F_99 ( V_19 ) ) {
F_145 ( L_47 ) ;
F_161 ( & V_302 ) ;
F_158 ( F_24 ( V_20 , 0 ) ,
