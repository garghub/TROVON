static int F_1 ( const char T_1 * V_1 , T_2 V_2 ,
struct V_3 * V_4 )
{
struct V_3 V_5 ;
int V_6 ;
...
static T_3 F_6 ( struct V_13 * V_13 ,
const char T_1 * V_1 ,
T_2 V_2 , T_4 * V_14 )
{
struct V_15 * V_16 ;
...
F_2 ( V_16 != NULL ) ;
F_7 ( & V_16 -> V_20 ) ;
V_6 = F_12 ( V_25 , L_5 , F_9 ( & V_16 -> V_21 ) ) ;
F_10 ( & V_16 -> V_20 ) ;
return V_6 ;
}
static T_3 F_13 ( struct V_13 * V_13 ,
const char T_1 * V_1 ,
T_2 V_2 , T_4 * V_14 )
{
struct V_15 * V_16 ;
...
F_2 ( V_16 != NULL ) ;
F_7 ( & V_16 -> V_20 ) ;
V_6 = F_12 ( V_25 , V_34 L_4 , F_17 ( & V_16 -> V_35 ) ) ;
F_10 ( & V_16 -> V_20 ) ;
return V_6 ;
}
static int
...
V_6 = F_12 ( V_25 , L_8 , V_37 -> V_41 . V_42 ) ;
} else {
V_6 = F_12 ( V_25 , L_8 , V_16 -> V_43 -> V_44 ) ;
}
return V_6 ;
}
