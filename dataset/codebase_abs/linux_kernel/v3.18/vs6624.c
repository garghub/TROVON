...
static int F_20 ( struct V_2 * V_3 , struct V_87 * V_14 )
{
V_14 -> V_19 = F_4 ( V_3 , V_14 -> V_14 & 0xffff ) ;
V_14 -> V_88 = 1 ;
return 0 ;
}
static int F_21 ( struct V_2 * V_3 , const struct V_87 * V_14 )
{
...
const unsigned * V_91 ;
int V_41 ;
if ( ! F_23 ( V_10 -> V_92 , V_93 ) )
return - V_94 ;
V_91 = V_10 -> V_95 . V_96 ;
if ( V_91 == NULL )
return - V_26 ;
V_41 = F_24 ( & V_10 -> V_95 , * V_91 , V_97 ,
L_1 ) ;
if ( V_41 ) {
F_25 ( V_10 , L_2 , * V_91 ) ;
return V_41 ;
...
F_26 ( 100 ) ;
V_40 = F_27 ( & V_10 -> V_95 , sizeof( * V_40 ) , V_98 ) ;
if ( V_40 == NULL )
return - V_99 ;
V_3 = & V_40 -> V_3 ;
F_28 ( V_3 , V_10 , & V_100 ) ;
