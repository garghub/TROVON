...
if ( V_3 -> V_52 & V_53 ) {
T_1 V_54 ;
V_54 = F_19 ( V_12 -> V_55 + V_46 -> V_66 ) ;
V_54 &= ~ 0xffff ;
V_54 |= V_41 [ V_6 ] ;
F_20 ( V_54 , V_12 -> V_55 + V_46 -> V_66 ) ;
} else {
F_20 ( V_41 [ V_6 ] , V_12 -> V_55 + V_46 -> V_66 ) ;
}
F_16 ( V_12 -> V_21 , L_10 ,
V_46 -> V_66 , V_41 [ V_6 ] ) ;
}
...
int V_6 ;
T_1 V_31 ;
F_16 ( V_3 -> V_21 , L_15 , V_68 , V_23 -> V_4 ) ;
if ( V_3 -> V_52 & V_53 )
V_70 = V_72 ;
else
V_70 = V_73 ;
V_5 -> V_4 = V_23 -> V_4 ;
V_71 = F_29 ( V_23 , L_16 , & V_69 ) ;
if ( ! V_71 ) {
F_10 ( V_3 -> V_21 , L_17 , V_23 -> V_74 ) ;
return - V_16 ;
}
if ( ! V_69 || V_69 % V_70 ) {
F_10 ( V_3 -> V_21 , L_18 , V_23 -> V_74 ) ;
return - V_16 ;
}
V_5 -> V_15 = V_69 / V_70 ;
...
static T_1 V_80 ;
T_1 V_6 = 0 ;
F_16 ( V_3 -> V_21 , L_20 , V_68 , V_23 -> V_4 ) ;
V_79 = & V_3 -> V_48 [ V_68 ] ;
V_79 -> V_4 = V_23 -> V_4 ;
V_79 -> V_65 = F_33 ( V_23 ) ;
if ( V_79 -> V_65 == 0 ) {
F_10 ( V_3 -> V_21 , L_21 , V_23 -> V_74 ) ;
return - V_16 ;
}
V_79 -> V_8 = F_30 ( V_3 -> V_21 ,
V_79 -> V_65 * sizeof( char * ) , V_33 ) ;
F_34 (np, child) {
V_79 -> V_8 [ V_6 ] = V_77 -> V_4 ;
V_5 = & V_3 -> V_8 [ V_80 ++ ] ;
F_28 ( V_77 , V_5 , V_3 , V_6 ++ ) ;
}
return 0 ;
}
...
struct V_2 * V_3 )
{
struct V_22 * V_23 = V_82 -> V_21 . V_83 ;
struct V_22 * V_77 ;
T_1 V_84 = 0 ;
T_1 V_6 = 0 ;
if ( ! V_23 )
...
V_3 -> V_64 = V_84 ;
V_3 -> V_48 = F_30 ( & V_82 -> V_21 , V_84 * sizeof( struct V_78 ) ,
V_33 ) ;
if ( ! V_3 -> V_48 )
return - V_34 ;
V_3 -> V_7 = 0 ;
F_34 (np, child)
V_3 -> V_7 += F_33 ( V_77 ) ;
V_3 -> V_8 = F_30 ( & V_82 -> V_21 , V_3 -> V_7 * sizeof( struct V_1 ) ,
V_33 ) ;
if ( ! V_3 -> V_8 )
return - V_34 ;
F_34 (np, child)
...
V_3 -> V_21 = & V_82 -> V_21 ;
V_12 = F_30 ( & V_82 -> V_21 , sizeof( * V_12 ) , V_33 ) ;
if ( ! V_12 )
return - V_34 ;
V_3 -> V_50 = F_37 ( & V_82 -> V_21 , sizeof( * V_3 -> V_50 ) *
V_3 -> V_15 , V_33 ) ;
if ( ! V_3 -> V_50 )
return - V_34 ;
memset ( V_3 -> V_50 , 0xff , sizeof( * V_3 -> V_50 ) * V_3 -> V_15 ) ;
V_87 = F_38 ( V_82 , V_88 , 0 ) ;
V_12 -> V_55 = F_39 ( & V_82 -> V_21 , V_87 ) ;
if ( F_40 ( V_12 -> V_55 ) )
return F_41 ( V_12 -> V_55 ) ;
V_89 . V_4 = F_8 ( & V_82 -> V_21 ) ;
V_89 . V_14 = V_3 -> V_14 ;
V_89 . V_15 = V_3 -> V_15 ;
V_67 = F_35 ( V_82 , V_3 ) ;
if ( V_67 ) {
...
V_12 -> V_21 = V_3 -> V_21 ;
F_42 ( V_82 , V_12 ) ;
V_12 -> V_90 = F_43 ( & V_89 , & V_82 -> V_21 , V_12 ) ;
if ( ! V_12 -> V_90 ) {
F_10 ( & V_82 -> V_21 , L_25 ) ;
return - V_16 ;
}
...
int F_45 ( struct V_81 * V_82 )
{
struct V_11 * V_12 = F_46 ( V_82 ) ;
F_47 ( V_12 -> V_90 ) ;
return 0 ;
}
