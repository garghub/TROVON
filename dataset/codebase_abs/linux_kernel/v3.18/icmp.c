...
static void F_81 ( struct V_45 * V_46 )
{
const struct V_85 * V_86 ;
struct V_60 * V_52 ;
struct V_2 * V_2 ;
...
static void F_89 ( struct V_45 * V_46 )
{
struct V_150 V_151 ;
struct V_47 V_48 ;
if ( V_46 -> V_43 < 4 )
...
struct V_19 * V_20 = F_39 ( V_46 ) ;
struct V_2 * V_2 = F_26 ( V_20 -> V_25 . V_30 ) ;
if ( ! F_96 ( NULL , V_158 , V_46 ) ) {
struct V_159 * V_160 = F_97 ( V_46 ) ;
int V_161 ;
if ( ! ( V_160 && V_160 -> V_162 [ V_160 -> V_43 - 1 ] -> V_163 . V_31 &
V_164 ) )
goto V_165;
...
void F_105 ( struct V_45 * V_46 , T_1 V_101 )
{
...
if ( V_52 -> type != V_149 ) {
F_106 ( V_46 , V_42 , V_101 ) ;
return;
}
if ( type == V_28 && V_23 == V_29 )
F_107 ( V_46 , V_2 , V_101 , 0 , 0 , V_82 , 0 ) ;
else if ( type == V_174 )
F_108 ( V_46 , V_2 , 0 , 0 , V_82 , 0 ) ;
}
static void T_5 F_109 ( struct V_2 * V_2 )
{
int V_175 ;
F_110 (i)
F_111 ( V_2 -> V_3 . F_1 [ V_175 ] ) ;
F_75 ( V_2 -> V_3 . F_1 ) ;
V_2 -> V_3 . F_1 = NULL ;
}
static int T_6 F_112 ( struct V_2 * V_2 )
{
int V_175 , V_90 ;
V_2 -> V_3 . F_1 =
F_113 ( V_176 * sizeof( struct V_1 * ) , V_177 ) ;
if ( V_2 -> V_3 . F_1 == NULL )
return - V_178 ;
F_110 (i) {
struct V_1 * V_4 ;
V_90 = F_114 ( & V_4 , V_179 ,
V_180 , V_82 , V_2 ) ;
if ( V_90 < 0 )
goto V_181;
V_2 -> V_3 . F_1 [ V_175 ] = V_4 ;
V_4 -> V_182 = 2 * F_115 ( 64 * 1024 ) ;
F_116 ( V_4 , V_183 ) ;
F_42 ( V_4 ) -> V_184 = V_185 ;
}
V_2 -> V_3 . V_148 = 0 ;
V_2 -> V_3 . V_170 = 1 ;
V_2 -> V_3 . V_145 = 1 ;
