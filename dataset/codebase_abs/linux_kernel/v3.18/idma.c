...
if ( ! V_80 -> V_83 )
return;
F_36 ( ( void V_84 * ) V_80 -> V_83 ) ;
V_80 -> V_83 = NULL ;
V_80 -> V_69 = 0 ;
}
static int F_37 ( struct V_77 * V_78 , int V_85 )
{
struct V_6 * V_7 = V_78 -> V_81 [ V_85 ] . V_7 ;
struct V_79 * V_80 = & V_7 -> V_41 ;
V_80 -> V_86 . V_86 = V_78 -> V_87 -> V_86 ;
V_80 -> V_12 = NULL ;
V_80 -> V_86 . type = V_88 ;
V_80 -> V_69 = V_2 . V_3 ;
V_80 -> V_89 = V_73 . V_90 ;
V_80 -> V_83 = ( unsigned char * V_91 ) F_38 ( V_80 -> V_69 , V_80 -> V_89 ) ;
return 0 ;
}
static int F_39 ( struct V_92 * V_93 )
{
struct V_94 * V_87 = V_93 -> V_87 -> V_94 ;
struct V_77 * V_78 = V_93 -> V_78 ;
int V_48 ;
V_48 = F_40 ( V_87 -> V_86 , F_41 ( 32 ) ) ;
if ( V_48 )
return V_48 ;
...
void F_42 ( void V_84 * V_4 , T_1 V_69 )
{
F_32 ( & V_2 . V_14 ) ;
V_2 . V_4 = V_4 ;
V_2 . V_3 = V_69 ;
