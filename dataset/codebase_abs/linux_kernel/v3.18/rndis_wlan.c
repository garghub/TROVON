...
if ( ! V_145 ) {
F_118 ( V_367 , & V_5 -> V_368 ) ;
F_119 ( V_5 -> V_278 , & V_5 -> V_310 ) ;
return;
}
...
static void F_128 ( struct V_309 * V_310 )
{
struct V_1 * V_5 =
F_92 ( V_310 , struct V_1 , V_310 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
if ( F_129 ( V_367 , & V_5 -> V_368 ) )
F_117 ( V_115 ) ;
if ( F_129 ( V_373 , & V_5 -> V_368 ) )
F_125 ( V_115 ) ;
if ( F_129 ( V_374 , & V_5 -> V_368 ) )
F_58 ( V_115 ) ;
}
...
struct V_2 * V_115 = F_80 ( V_3 ) ;
struct V_1 * V_5 = F_1 ( V_115 ) ;
if ( F_131 ( V_374 , & V_5 -> V_368 ) )
return;
F_118 ( V_374 , & V_5 -> V_368 ) ;
F_119 ( V_5 -> V_278 , & V_5 -> V_310 ) ;
}
...
struct V_380 * V_381 ;
enum V_382 V_383 ;
if ( V_81 < F_133 ( struct V_375 , V_89 ) +
sizeof( struct V_380 ) ) {
...
V_90 = V_81 - F_133 ( struct V_375 , V_89 ) ;
...
F_137 ( V_115 -> V_104 , V_126 , V_394 -> V_141 ,
V_396 , V_234 ) ;
}
}
...
V_107 = F_133 ( struct V_398 , V_106 ) +
F_9 ( V_399 -> V_107 ) ;
...
return;
case V_405 :
F_132 ( V_115 , V_376 , V_81 ) ;
return;
case V_406 :
F_136 ( V_115 , V_376 , V_81 ) ;
return;
default:
...
static void F_139 ( struct V_2 * V_115 , void * V_407 , int V_90 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
...
F_118 ( V_373 , & V_5 -> V_368 ) ;
F_119 ( V_5 -> V_278 , & V_5 -> V_310 ) ;
break;
case V_410 :
F_138 ( V_115 , V_399 , V_90 ) ;
break;
default:
...
return;
V_5 -> V_355 = V_294 ;
F_142 ( V_115 -> V_104 , V_428 , V_96 ) ;
}
static void F_143 ( struct V_309 * V_310 )
{
struct V_1 * V_5 =
...
static int F_150 ( struct V_2 * V_115 , struct V_456 * V_457 )
{
struct V_191 * V_191 ;
struct V_1 * V_5 ;
int V_417 , V_81 ;
T_3 V_133 ;
V_191 = F_151 ( & V_458 , sizeof( struct V_1 ) ) ;
if ( ! V_191 )
return - V_97 ;
V_5 = F_74 ( V_191 ) ;
...
F_154 ( & V_5 -> V_310 , F_128 ) ;
F_155 ( & V_5 -> V_434 , F_143 ) ;
F_155 ( & V_5 -> V_279 , F_91 ) ;
V_417 = F_156 ( V_115 , V_457 , V_460 ) ;
if ( V_417 < 0 )
goto V_461;
