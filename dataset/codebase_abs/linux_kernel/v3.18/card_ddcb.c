...
F_32 ( V_15 , V_2 -> V_154 , 0x07 ) ;
F_32 ( V_15 , V_2 -> V_155 , V_2 -> V_81 ) ;
F_32 ( V_15 , V_2 -> V_156 , V_2 -> V_99 ) ;
F_32 ( V_15 , V_2 -> V_157 , V_146 ) ;
return 0 ;
V_153:
F_24 ( V_2 -> V_73 ) ;
V_2 -> V_73 = NULL ;
...
static T_6 F_68 ( int V_159 , void * V_160 )
{
T_5 V_161 ;
struct V_14 * V_15 = (struct V_14 * ) V_160 ;
struct V_18 * V_18 = V_15 -> V_18 ;
V_15 -> V_162 ++ ;
F_42 ( & V_15 -> V_141 ) ;
V_161 = F_36 ( V_15 , V_163 ) ;
if ( ( ( V_161 & V_164 ) != 0x0 ) &&
! F_69 ( V_18 ) ) {
if ( V_15 -> V_165 ) {
F_70 ( V_15 -> V_166 + V_163 ) ;
if ( F_69 ( V_18 ) )
goto exit;
}
F_42 ( & V_15 -> V_167 ) ;
...
static T_6 F_72 ( int V_159 , void * V_160 )
{
struct V_14 * V_15 = (struct V_14 * ) V_160 ;
V_15 -> V_162 ++ ;
F_42 ( & V_15 -> V_141 ) ;
...
static int F_73 ( void * V_169 )
{
int V_170 = 0 , V_90 = 0 ;
struct V_14 * V_15 = (struct V_14 * ) V_169 ;
while ( ! F_74 () ) {
F_35 ( V_15 , & V_15 -> V_2 ) ;
if ( V_115 ) {
V_90 = F_44 (
...
F_63 ( & V_15 -> V_141 ) ;
V_15 -> V_183 = F_80 ( F_73 , V_15 ,
V_84 L_24 ,
V_15 -> V_21 ) ;
if ( F_81 ( V_15 -> V_183 ) ) {
V_90 = F_82 ( V_15 -> V_183 ) ;
V_15 -> V_183 = NULL ;
goto V_184;
}
V_90 = F_83 ( V_15 , V_185 ) ;
if ( V_90 )
goto V_186;
F_63 ( & V_15 -> V_167 ) ;
if ( F_77 ( V_15 ) ) {
V_90 = F_84 ( V_18 -> V_159 , F_68 , V_187 ,
V_84 , V_15 ) ;
} else {
V_90 = F_84 ( V_18 -> V_159 , F_72 , V_187 ,
V_84 , V_15 ) ;
}
if ( V_90 < 0 ) {
F_16 ( & V_18 -> V_20 , L_25 , V_18 -> V_159 ) ;
goto V_188;
}
V_15 -> V_37 = V_38 ;
return 0 ;
