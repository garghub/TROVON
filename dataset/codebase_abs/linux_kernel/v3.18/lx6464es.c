...
struct V_36 * V_37 )
{
return F_27 ( V_4 , V_37 , 0 ) ;
}
static int F_31 ( struct V_3 * V_4 ,
struct V_36 * V_37 )
{
return F_27 ( V_4 , V_37 , 1 ) ;
}
...
static void F_34 ( struct V_1 * V_2 , struct V_29 * V_29 )
{
...
T_2 V_48 = 0 ;
V_5 = F_35 ( V_2 , 0 , V_9 , & V_45 , & V_46 ,
V_47 ) ;
F_2 ( V_2 -> V_13 -> V_14 , L_33 ,
V_45 , V_46 ) ;
V_5 = F_36 ( V_2 , 0 , V_9 , V_40 ,
F_37 ( V_41 ) , F_38 ( V_41 ) ,
& V_48 ) ;
...
V_5 = F_35 ( V_2 , 0 , V_9 , & V_45 , & V_46 , V_47 ) ;
...
static void F_40 ( struct V_1 * V_2 , struct V_29 * V_29 )
{
const unsigned int V_9 = V_29 -> V_9 ;
int V_5 ;
...
static int F_44 ( struct V_3 * V_4 , int V_54 )
{
struct V_1 * V_2 = F_17 ( V_4 ) ;
const int V_9 = ( V_4 -> V_10 == V_11 ) ;
...
{
return F_45 ( V_63 -> V_64 ) ;
}
static int F_54 ( struct V_1 * V_2 )
{
int V_44 ;
T_2 V_65 = F_55 ( V_2 , V_66 ) ;
...
2 ;
V_96 = F_71 ( V_96 ) ;
V_5 = F_72 ( V_2 -> V_13 , ( char * ) V_98 , 0 ,
1 , 1 , & V_27 ) ;
if ( V_5 < 0 )
return V_5 ;
V_27 -> V_26 = V_2 ;
F_73 ( V_27 , V_99 , & V_100 ) ;
F_73 ( V_27 , V_11 , & V_101 ) ;
V_27 -> V_102 = 0 ;
V_27 -> V_103 = true ;
...
F_82 ( V_122 , L_66 ) ;
V_5 = F_83 ( V_2 , 1 , 64 , V_123 ) ;
if ( V_5 < 0 )
return;
for ( V_44 = 0 ; V_44 != 8 ; ++ V_44 ) {
for ( V_124 = 0 ; V_124 != 8 ; ++ V_124 )
F_82 ( V_122 , L_67 , V_123 [ V_44 * 8 + V_124 ] ) ;
F_82 ( V_122 , L_68 ) ;
}
F_82 ( V_122 , L_69 ) ;
V_5 = F_83 ( V_2 , 0 , 64 , V_123 ) ;
if ( V_5 < 0 )
return;
for ( V_44 = 0 ; V_44 != 8 ; ++ V_44 ) {
for ( V_124 = 0 ; V_124 != 8 ; ++ V_124 )
...
static int F_84 ( struct V_125 * V_13 , struct V_1 * V_2 )
{
struct V_119 * V_120 ;
int V_5 = F_85 ( V_13 , L_70 , & V_120 ) ;
if ( V_5 < 0 )
return V_5 ;
F_86 ( V_120 , V_2 , F_81 ) ;
return 0 ;
}
static int F_87 ( struct V_125 * V_13 ,
struct V_126 * V_61 ,
struct V_1 * * V_127 )
{
struct V_1 * V_2 ;
...
if ( V_5 < 0 )
goto V_136;
V_2 -> V_137 = F_95 ( V_61 , 1 ) ;
V_2 -> V_60 = F_96 ( V_2 -> V_137 ,
F_97 ( V_61 , 1 ) ) ;
V_2 -> V_59 = F_98 ( V_61 , 2 ) ;
V_5 = F_99 ( V_61 -> V_58 , V_138 , V_139 ,
V_140 , V_141 , V_2 ) ;
if ( V_5 ) {
...
V_2 -> V_58 = V_61 -> V_58 ;
V_5 = F_100 ( V_13 , V_143 , V_2 , & V_129 ) ;
if ( V_5 < 0 )
goto V_144;
V_5 = F_67 ( V_2 ) ;
if ( V_5 < 0 ) {
...
static int F_103 ( struct V_126 * V_61 ,
...
V_5 = F_104 ( & V_61 -> V_14 , V_152 [ V_14 ] , V_153 [ V_14 ] , V_154 ,
0 , & V_13 ) ;
if ( V_5 < 0 )
return V_5 ;
V_5 = F_87 ( V_13 , V_61 , & V_2 ) ;
if ( V_5 < 0 ) {
F_4 ( V_13 -> V_14 , L_76 ) ;
goto V_155;
}
...
static void F_108 ( struct V_126 * V_61 )
{
F_107 ( F_109 ( V_61 ) ) ;
}
