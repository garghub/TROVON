...
struct V_1 * V_2 , unsigned int V_60 ,
T_2 * V_61 , void * V_41 , bool V_50 )
{
struct V_62 * V_63 ;
int V_64 , V_3 ;
for ( V_3 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
struct V_5 * V_6 = & V_2 -> V_7 [ V_3 ] ;
for ( V_64 = F_50 ( & V_6 -> V_9 , V_6 -> V_10 ) ;
V_64 < V_6 -> V_10 ;
V_64 = F_51 ( & V_6 -> V_9 , V_6 -> V_10 , V_64 + 1 ) ) {
V_63 = F_52 ( V_19 -> V_12 , V_60 + V_64 ) ;
if ( V_63 -> V_46 == V_19 -> V_65 )
V_61 ( V_19 , V_63 , V_41 , V_50 ) ;
}
V_60 += ( 1 << V_2 -> V_37 ) ;
}
}
void F_53 ( struct V_18 * V_19 , T_2 * V_61 ,
void * V_66 )
{
struct V_11 * V_12 = V_19 -> V_12 ;
if ( V_12 -> V_52 )
F_49 ( V_19 , & V_12 -> V_51 , 0 , V_61 , V_66 , true ) ;
F_49 ( V_19 , & V_12 -> V_13 , V_12 -> V_52 , V_61 , V_66 ,
false ) ;
}
static unsigned int F_54 ( struct V_1 * V_2 )
{
unsigned int V_3 , V_67 ;
for ( V_3 = 0 , V_67 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
struct V_5 * V_6 = & V_2 -> V_7 [ V_3 ] ;
V_67 += F_55 ( & V_6 -> V_9 , V_6 -> V_10 ) ;
}
return V_2 -> V_10 - V_67 ;
}
static void F_56 ( struct V_1 * V_2 ,
unsigned int V_10 )
{
unsigned int V_68 = 1U << V_2 -> V_37 ;
unsigned int V_69 = V_10 ;
if ( V_10 ) {
int V_3 ;
for ( V_3 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
V_2 -> V_7 [ V_3 ] . V_10 = F_57 ( V_69 , V_68 ) ;
V_69 -= V_2 -> V_7 [ V_3 ] . V_10 ;
}
}
V_2 -> V_57 = V_70 ;
...
V_73 = F_60 ( V_10 , V_68 ) / V_68 ;
V_2 -> V_7 = F_61 ( V_73 * sizeof( struct V_5 ) ,
V_74 , V_71 ) ;
if ( ! V_2 -> V_7 )
return - V_75 ;
V_2 -> V_4 = V_73 ;
}
V_2 -> V_25 = F_62 ( V_15 * sizeof( * V_2 -> V_25 ) , V_74 ) ;
if ( ! V_2 -> V_25 ) {
F_63 ( V_2 -> V_7 ) ;
return - V_75 ;
}
F_56 ( V_2 , V_10 ) ;
for ( V_3 = 0 ; V_3 < V_15 ; V_3 ++ ) {
F_64 ( & V_2 -> V_25 [ V_3 ] . V_26 ) ;
F_65 ( & V_2 -> V_25 [ V_3 ] . V_56 , V_2 -> V_57 ) ;
}
return 0 ;
}
...
static struct V_11 * F_67 ( struct V_11 * V_12 ,
int V_71 )
{
unsigned int V_10 = V_12 -> V_58 - V_12 -> V_52 ;
if ( F_58 ( & V_12 -> V_13 , V_10 , V_71 , false ) )
goto V_76;
if ( F_58 ( & V_12 -> V_51 , V_12 -> V_52 , V_71 , true ) )
goto V_76;
return V_12 ;
V_76:
F_66 ( & V_12 -> V_13 ) ;
...
struct V_11 * F_68 ( unsigned int V_77 ,
unsigned int V_78 , int V_71 )
{
struct V_11 * V_12 ;
if ( V_77 > V_79 ) {
F_69 ( L_1 ) ;
...
V_12 = F_61 ( sizeof( * V_12 ) , V_74 , V_71 ) ;
if ( ! V_12 )
return NULL ;
V_12 -> V_58 = V_77 ;
V_12 -> V_52 = V_78 ;
return F_67 ( V_12 , V_71 ) ;
}
...
void F_71 ( struct V_11 * V_12 , unsigned int * V_32 )
{
unsigned int V_10 = V_12 -> V_58 - V_12 -> V_52 ;
* V_32 = F_72 () % V_10 ;
}
int F_73 ( struct V_11 * V_12 , unsigned int V_80 )
{
V_80 -= V_12 -> V_52 ;
if ( V_80 > V_12 -> V_58 )
return - V_81 ;
...
T_3 F_74 ( struct V_11 * V_12 , char * V_82 )
{
char * V_83 = V_82 ;
