...
static void F_19 ( int V_76 , int V_77 )
{
unsigned long V_78 ;
int V_22 ;
V_78 = F_20 ( V_79 , V_76 ) ;
...
static void F_22 ( const struct V_80 * V_81 , int V_77 )
{
unsigned int V_76 ;
F_23 (cpu, mask)
F_19 ( V_76 , V_77 ) ;
}
static void F_24 ( const struct V_80 * V_81 , int V_77 )
{
unsigned int V_82 = F_25 () ;
unsigned int V_76 ;
F_23 (cpu, mask) {
if ( V_76 != V_82 )
F_19 ( V_76 , V_77 ) ;
...
static int
F_32 ( const struct V_80 * V_80 ,
const struct V_80 * V_84 ,
unsigned int * V_78 )
{
int unsigned V_76 ;
F_33 (cpu, cpumask, andmask) {
if ( F_34 ( V_76 , V_83 ) )
break;
}
if ( F_35 ( V_76 < V_85 ) ) {
* V_78 = F_20 ( V_79 , V_76 ) | V_46 ;
return 0 ;
}
return - V_86 ;
}
static unsigned int F_36 ( unsigned long V_87 )
{
unsigned int V_88 ;
F_37 ( F_38 () && F_39 () > 1 ) ;
V_88 = V_87 | F_40 ( V_64 ) ;
...
static unsigned long F_41 ( unsigned int V_88 )
{
unsigned long V_87 ;
V_87 = V_88 ;
return V_87 ;
...
{
return F_36 ( F_43 ( V_89 ) ) ;
}
static int F_44 ( int V_90 , int V_91 )
{
return F_42 () >> V_91 ;
}
static void F_45 ( int V_77 )
{
F_46 ( V_92 , V_77 ) ;
}
...
static void F_48 ( int V_22 )
{
F_12 ( V_64 , V_22 << V_39 . V_27 . V_41 ) ;
}
static T_1 int F_49 ( int V_22 )
{
int V_95 ;
for ( V_95 = 0 ; V_95 < F_50 () ; V_95 ++ )
if ( V_22 == V_96 [ V_95 ] . V_22 )
return V_95 ;
F_51 () ;
}
static unsigned char F_52 ( int V_97 )
{
union V_98 V_99 ;
if ( F_10 () )
return V_97 ;
...
V_99 . V_23 = F_54 ( V_100 ) ;
return V_99 . V_101 . V_102 ;
}
static T_1 void F_55 ( unsigned long * V_103 , unsigned long * V_104 )
{
union V_105 V_106 ;
union V_107 V_108 ;
int V_109 ;
for ( V_109 = 0 ; V_109 < F_56 ( V_110 ) ; V_109 ++ ) {
V_106 . V_23 = F_54 ( V_110 [ V_109 ] . V_106 ) ;
if ( V_106 . V_27 . V_111 && V_106 . V_27 . V_103 == 0 ) {
* V_104 = ( 1UL << V_106 . V_27 . V_112 ) ;
V_108 . V_23 = F_54 ( V_110 [ V_109 ] . V_108 ) ;
...
static T_1 void F_57 ( char * V_88 , unsigned long V_103 , int V_115 ,
...
F_59 ( L_8 , V_88 , V_120 , V_120 + V_119 ) ;
if ( V_118 == V_121 )
F_60 ( V_120 , V_119 ) ;
else
F_61 ( V_120 , V_119 ) ;
}
static T_1 void F_62 ( unsigned long V_122 )
{
union V_123 V_124 ;
T_2 V_120 ;
unsigned long V_119 ;
...
V_7 &= V_11 ;
F_63 (nid) {
V_120 = ( ( T_2 ) F_64 ( V_125 ) << V_36 -> V_97 ) |
V_7 ;
F_61 ( V_120 , V_119 ) ;
V_14 = F_65 ( V_120 , V_14 ) ;
V_15 = F_66 ( V_120 , V_15 ) ;
}
V_14 &= V_9 ;
V_15 &= V_9 ;
F_59 ( L_10 ,
...
static T_1 void F_67 ( int V_117 )
{
union V_123 V_124 ;
int V_127 = V_126 ;
V_124 . V_23 = F_54 ( V_128 ) ;
if ( ! V_124 . V_27 . V_111 ) {
F_58 ( L_11 ) ;
return;
}
if ( F_68 () && V_124 . V_101 . V_129 ) {
F_62 ( V_124 . V_23 ) ;
return;
}
F_57 ( L_12 , V_124 . V_27 . V_103 , V_127 , V_127 , V_117 , V_130 ) ;
V_16 = ( ( T_2 ) V_124 . V_27 . V_103 << V_127 ) ;
V_17 = V_16 + ( 1UL << V_127 ) * ( V_117 + 1 ) ;
}
static T_1 void F_69 ( int V_117 )
{
union V_131 V_3 ;
int V_127 = V_132 ;
V_3 . V_23 = F_54 ( V_133 ) ;
if ( V_3 . V_27 . V_111 )
F_57 ( L_13 , V_3 . V_27 . V_103 , V_127 , V_127 , V_117 , V_121 ) ;
else
F_58 ( L_14 ) ;
}
static T_1 void F_70 ( int V_134 , int V_135 , int V_117 )
{
union V_136 V_137 ;
unsigned long V_3 ;
unsigned long V_103 ;
...
V_137 . V_23 = F_54 ( V_145 [ V_134 ] . V_137 ) ;
F_58 ( L_15 ,
...
if ( V_140 >= 0 )
F_57 ( V_88 , V_103 , V_127 , V_139 , V_140 , V_121 ) ;
}
static T_1 void F_71 ( int V_135 , int V_117 )
{
union V_153 V_154 ;
...
F_57 ( L_20 , V_103 , V_127 , V_139 , V_117 , V_121 ) ;
} else {
F_58 ( L_21 ) ;
}
}
...
static void F_76 ( unsigned long V_170 )
{
...
V_174 |= V_177 ;
F_79 ( V_174 ) ;
F_80 ( V_172 , V_178 + V_179 ) ;
}
static void F_81 ( int V_76 )
{
while ( ! F_82 ( V_76 ) -> V_173 . V_180 ) {
struct V_171 * V_172 = & F_82 ( V_76 ) -> V_173 . V_172 ;
F_83 ( V_76 , V_176 | V_177 ) ;
F_84 ( V_172 , F_76 , V_76 ) ;
V_172 -> V_181 = V_178 + V_179 ;
F_85 ( V_172 , V_76 ) ;
F_82 ( V_76 ) -> V_173 . V_180 = 1 ;
V_76 = 0 ;
}
}
static void F_86 ( int V_76 )
{
if ( F_82 ( V_76 ) -> V_173 . V_180 ) {
F_82 ( V_76 ) -> V_173 . V_180 = 0 ;
F_87 ( & F_82 ( V_76 ) -> V_173 . V_172 ) ;
}
F_83 ( V_76 , 0xff ) ;
}
static int F_88 ( struct V_182 * V_183 , unsigned long V_184 ,
void * V_185 )
{
...
F_93 ( L_25 , V_191 , V_194 , V_195 , V_196 ) ;
return V_196 ;
}
void F_96 ( void )
{
...
V_216 +=
F_99 ( F_54 ( V_217 + V_109 * 8 ) ) ;
F_58 ( L_32 ,
F_10 () ? F_50 () :
( F_50 () + 1 ) / 2 ,
F_50 () ) ;
V_119 = sizeof( struct V_96 ) * F_50 () ;
V_96 = F_100 ( V_119 , V_218 ) ;
F_101 ( ! V_96 ) ;
for ( V_95 = 0 ; V_95 < F_50 () ; V_95 ++ )
V_96 [ V_95 ] . V_219 = - 1 ;
F_55 ( & V_203 , & V_204 ) ;
V_119 = sizeof( V_220 [ 0 ] ) * F_102 () ;
V_220 = F_103 ( V_119 , V_218 ) ;
F_101 ( ! V_220 ) ;
memset ( V_220 , 255 , V_119 ) ;
V_119 = sizeof( V_221 [ 0 ] ) * F_104 () ;
V_221 = F_103 ( V_119 , V_218 ) ;
F_101 ( ! V_221 ) ;
memset ( V_221 , 255 , V_119 ) ;
V_95 = 0 ;
for ( V_109 = 0 ; V_109 < V_215 ; V_109 ++ ) {
V_210 = F_54 ( V_217 + V_109 * 8 ) ;
...
V_96 [ V_95 ] . V_222 = 0 ;
V_96 [ V_95 ] . V_201 = 0 ;
F_106 ( & V_96 [ V_95 ] . V_223 ) ;
V_135 = F_65 ( V_22 , V_135 ) ;
V_117 = F_66 ( V_22 , V_117 ) ;
V_95 ++ ;
}
}
F_107 () ;
...
F_73 () ;
F_109 (cpu) {
int V_78 = F_20 ( V_79 , V_76 ) ;
V_125 = F_110 ( V_76 ) ;
F_82 ( V_76 ) -> V_211 = V_211 ;
F_82 ( V_76 ) -> V_229 = V_39 . V_27 . V_41 ;
F_82 ( V_76 ) -> V_37 = V_36 -> V_37 ;
F_82 ( V_76 ) -> V_230 = 64 - V_97 ;
F_82 ( V_76 ) -> V_212 = V_212 ;
V_22 = F_16 ( V_78 ) ;
V_95 = F_49 ( V_22 ) ;
V_205 = V_96 [ V_95 ] . V_222 ;
V_96 [ V_95 ] . V_222 ++ ;
V_96 [ V_95 ] . V_219 = V_125 ;
F_82 ( V_76 ) -> V_231 = V_203 ;
F_82 ( V_76 ) -> V_232 = V_204 ;
F_82 ( V_76 ) -> V_97 = V_97 ;
F_82 ( V_76 ) -> V_207 = V_207 ;
F_82 ( V_76 ) -> V_233 = V_95 ;
F_82 ( V_76 ) -> V_234 = V_205 ;
F_82 ( V_76 ) -> V_22 = V_22 ;
F_82 ( V_76 ) -> V_235 = ( 1UL << ( V_97 + V_207 ) ) - 1 ;
F_82 ( V_76 ) -> V_202 = V_202 ;
F_82 ( V_76 ) -> V_208 = V_208 ;
F_82 ( V_76 ) -> V_236 = V_209 ;
F_82 ( V_76 ) -> V_237 = V_226 ;
F_82 ( V_76 ) -> V_173 . V_238 = F_111 ( V_78 ) ;
V_220 [ V_125 ] = V_95 ;
V_221 [ V_76 ] = V_95 ;
}
F_63 (nid) {
if ( V_220 [ V_125 ] >= 0 )
continue;
V_120 = F_112 ( V_125 ) << V_239 ;
V_22 = F_113 ( F_114 ( V_120 ) ) ;
V_95 = F_49 ( V_22 ) ;
V_220 [ V_125 ] = V_95 ;
}
F_67 ( V_117 ) ;
