...
if ( ! V_166 )
return - V_167 ;
V_6 = F_85 ( & V_165 -> V_110 , sizeof( * V_6 ) , V_113 ) ;
if ( ! V_6 )
return - V_116 ;
F_86 ( V_168 , V_6 -> V_105 . V_169 ) ;
...
F_87 ( & V_6 -> V_105 . V_106 ) ;
V_176 . V_159 = V_6 -> V_105 . V_169 ;
V_6 -> V_23 = F_88 ( V_110 -> V_112 , 0 ) ;
V_6 -> V_115 = F_88 ( V_110 -> V_112 , 1 ) ;
V_6 -> V_119 = F_88 ( V_110 -> V_112 , 2 ) ;
V_6 -> V_18 = F_88 ( V_110 -> V_112 , 3 ) ;
...
if ( V_52 )
goto V_179;
V_19 = F_91 ( V_110 -> V_112 , 0 ) ;
if ( ! V_19 ) {
V_52 = - V_167 ;
goto V_180;
}
F_5 ( V_25 , V_6 -> V_23 + V_181 ) ;
V_52 = F_92 ( & V_165 -> V_110 , V_19 , V_166 -> V_182 , V_183 ,
F_93 ( V_110 ) , V_6 ) ;
if ( V_52 )
goto V_180;
V_6 -> V_19 = V_19 ;
...
F_97 ( & V_6 -> V_105 ) ;
F_5 ( 0 , V_6 -> V_23 + V_186 ) ;
F_104 ( & V_165 -> V_110 , V_6 -> V_19 , V_6 ) ;
F_50 ( V_6 ) ;
...
static int F_105 ( struct V_109 * V_110 )
{
struct V_5 * V_6 = F_106 ( V_110 ) ;
V_6 -> V_187 = F_7 ( V_6 -> V_115 + V_137 ) ;
F_5 ( 0 , V_6 -> V_23 + V_186 ) ;
F_65 ( V_6 ) ;
return 0 ;
}
