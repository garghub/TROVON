...
if ( F_158 ( & V_229 -> V_233 ) & V_241 ) {
V_2 = F_154 ( V_56 ) ;
V_2 -> V_42 -> V_242 ( V_2 , V_229 -> V_243 . V_244 . V_245 ) ;
F_23 ( V_2 ) ;
}
if ( ! V_99 )
return;
...
V_99 -> V_201 = V_253 ;
V_99 -> V_151 = V_231 ;
if ( V_99 -> V_254 . V_230 != & V_2 -> V_15 ) {
V_230 = F_161 ( V_99 -> V_254 . V_230 ,
struct V_98 , V_254 ) ;
}
} else {
...
enum V_257 F_162 ( struct V_226 * V_56 , struct V_229 * V_229 )
{
struct V_1 * V_2 ;
V_2 = F_154 ( V_56 ) ;
if ( F_30 ( V_2 ) )
goto V_68;
if ( F_142 ( V_258 , & V_2 -> V_192 ) ||
V_2 -> V_26 != V_2 -> V_28 ||
! V_2 -> V_42 -> V_240 ) {
F_23 ( V_2 ) ;
goto V_68;
...
struct V_98 * V_260 )
{
struct V_102 * V_103 , * V_261 ;
struct V_98 * V_99 ;
if ( ! V_260 -> V_34 )
return;
F_164 (l, n, &device->ccw_queue) {
V_99 = F_161 ( V_103 , struct V_98 , V_254 ) ;
if ( V_99 -> V_201 == V_228 &&
V_260 -> V_34 == V_99 -> V_34 ) {
V_99 -> V_201 = V_247 ;
}
}
}
...
if ( F_53 ( & V_2 -> V_15 ) )
return;
V_99 = F_161 ( V_2 -> V_15 . V_230 , struct V_98 , V_254 ) ;
if ( ( V_99 -> V_201 == V_202 && V_99 -> V_225 != 0 ) &&
( F_171 ( V_213 , V_99 -> V_225 + V_99 -> V_204 ) ) ) {
if ( F_142 ( V_266 , & V_2 -> V_192 ) ) {
V_99 -> V_198 ++ ;
}
if ( V_2 -> V_42 -> V_267 ( V_99 ) != 0 ) {
F_139 ( & V_2 -> V_56 -> V_57 ,
L_79
L_80 ,
V_99 , ( V_99 -> V_225 / V_268 ) ) ;
V_99 -> V_225 += 5 * V_268 ;
F_149 ( V_2 , 5 * V_268 ) ;
} else {
F_139 ( & V_2 -> V_56 -> V_57 ,
L_81
L_82 , V_99 , ( V_99 -> V_225 / V_268 ) ,
V_99 -> V_198 ) ;
}
}
}
...
void F_180 ( struct V_1 * V_2 , int V_275 )
{
V_2 -> V_255 |= V_275 ;
}
void F_148 ( struct V_1 * V_2 , int V_275 )
{
V_2 -> V_255 &= ~ V_275 ;
if ( ! V_2 -> V_255 )
F_71 ( & V_252 ) ;
...
if ( V_99 -> V_281 )
return 1 ;
return ( ( V_99 -> V_201 != V_263 ) &&
( V_99 -> V_201 != V_280 ) ) ;
} else
return ( V_99 -> V_201 == V_277 ) ;
}
static int F_191 ( struct V_98 * V_282 , int V_283 )
{
struct V_1 * V_2 ;
int V_40 ;
struct V_102 V_15 ;
...
V_282 -> V_201 = V_277 ;
V_2 = V_282 -> V_109 ;
F_182 ( & V_282 -> V_284 , & V_15 ) ;
for ( V_99 = V_282 ; F_190 ( V_99 ) ;
V_99 = F_192 ( & V_15 ,
struct V_98 , V_284 ) ) {
if ( F_187 ( V_99 ) )
continue;
...
F_83 ( V_252 , F_186 ( V_99 ) ) ;
}
V_282 -> V_152 = F_138 () ;
if ( ( V_282 -> V_201 != V_263 ) &&
( V_282 -> V_209 != - V_287 ) )
F_188 ( V_282 , & V_282 -> V_229 ) ;
if ( V_282 -> V_201 == V_263 )
V_40 = 0 ;
else if ( V_282 -> V_209 )
V_40 = V_282 -> V_209 ;
...
static int F_198 ( struct V_102 * V_15 , int V_283 )
{
struct V_1 * V_2 ;
struct V_98 * V_99 , * V_261 ;
int V_40 ;
...
F_83 ( V_252 , F_196 ( V_15 ) ) ;
V_40 = 0 ;
F_175 (cqr, n, ccw_queue, blocklist) {
if ( V_99 -> V_109 != V_99 -> V_289 && ! V_99 -> V_281 &&
( V_99 -> V_201 == V_265 ||
V_99 -> V_201 == V_264 ) )
return - V_66 ;
if ( F_187 ( V_99 ) ) {
...
V_99 -> V_248 = V_249 ;
V_99 -> V_201 = V_228 ;
F_182 ( & V_99 -> V_254 , V_2 -> V_15 . V_230 ) ;
F_75 ( V_2 ) ;
F_176 ( F_147 ( V_2 -> V_56 ) ) ;
F_83 ( V_252 , F_186 ( V_99 ) ) ;
if ( V_99 -> V_201 == V_263 )
...
T_6 V_276 ;
if ( V_99 -> V_201 == V_263 )
F_39 ( V_290 , V_2 , L_1 , L_86 ) ;
else
F_139 ( & V_2 -> V_56 -> V_57 , L_87 ) ;
V_276 = V_2 -> V_42 -> V_291 ( V_99 ) ;
V_276 ( V_99 ) ;
}
...
V_99 -> V_248 = ( void * ) V_101 ;
V_99 -> V_201 = V_277 ;
V_101 -> V_299 = V_99 ;
F_209 ( V_101 ) ;
F_184 ( & V_99 -> V_284 , & V_34 -> V_15 ) ;
F_12 ( & V_99 -> V_254 ) ;
...
V_99 = F_161 ( V_103 , struct V_98 , V_284 ) ;
if ( V_99 -> V_201 != V_263 &&
V_99 -> V_201 != V_280 &&
V_99 -> V_201 != V_264 &&
V_99 -> V_201 != V_265 )
continue;
if ( V_99 -> V_201 == V_265 ) {
V_64 -> V_42 -> V_278 ( V_99 ) ;
goto V_302;
}
if ( V_99 -> V_201 == V_264 ) {
V_276 = V_64 -> V_42 -> V_279 ( V_99 ) ;
if ( F_30 ( V_276 ( V_99 ) ) )
continue;
goto V_302;
}
...
break;
V_99 -> F_168 = F_216 ;
for ( V_169 = 0 ; V_99 != NULL ; V_99 = V_99 -> V_281 , V_169 ++ )
F_166 ( & V_99 -> V_284 , & V_272 ) ;
if ( V_169 > 1 )
goto V_302;
}
F_96 ( & V_34 -> V_38 ) ;
...
V_313 -> V_198 = - 1 ;
V_313 -> V_209 = - V_218 ;
if ( V_313 -> V_201 >= V_228 ) {
F_88 ( F_147 ( V_2 -> V_56 ) ) ;
V_40 = F_195 ( V_313 ) ;
F_87 ( F_147 ( V_2 -> V_56 ) ) ;
} else if ( ( V_313 -> V_201 == V_277 ) ||
( V_313 -> V_201 == V_264 ) ) {
V_313 -> V_201 = V_265 ;
V_40 = 0 ;
...
if ( F_259 ( V_258 , & V_2 -> V_192 ) &&
! F_142 ( V_266 , & V_2 -> V_192 ) ) {
F_23 ( V_2 ) ;
F_258 ( V_56 ) ;
return;
}
...
int F_272 ( struct V_226 * V_56 , int V_352 )
{
struct V_1 * V_2 ;
int V_341 ;
V_2 = F_154 ( V_56 ) ;
...
void F_273 ( struct V_226 * V_56 , int * V_357 )
{
int V_358 ;
T_9 V_359 , V_360 ;
struct V_1 * V_2 ;
...
V_359 = V_2 -> V_216 . V_217 ;
V_2 -> V_216 . V_217 &= ~ V_360 ;
V_2 -> V_216 . V_220 &= ~ V_360 ;
V_2 -> V_216 . V_221 &= ~ V_360 ;
if ( V_359 && ! V_2 -> V_216 . V_217 ) {
F_270 ( & V_2 -> V_56 -> V_57 ,
L_114
L_109 ) ;
F_39 ( V_60 , V_2 ,
...
V_2 -> V_216 . V_220 &= ~ V_360 ;
V_2 -> V_216 . V_221 &= ~ V_360 ;
V_2 -> V_216 . V_222 |= V_360 ;
F_75 ( V_2 ) ;
}
if ( V_357 [ V_358 ] & V_363 ) {
if ( ! ( V_2 -> V_216 . V_217 & V_360 ) &&
! ( V_2 -> V_216 . V_222 & V_360 ) ) {
V_2 -> V_216 . V_222 |= V_360 ;
F_75 ( V_2 ) ;
}
...
char * V_380 = NULL ;
if ( F_285 ( & V_229 -> V_233 ) && ( V_229 -> V_233 . V_381 . V_382 == 0x01 ) ) {
if ( V_229 -> V_233 . V_381 . V_383 )
V_379 = F_286 ( (struct V_383 * ) ( unsigned long )
V_229 -> V_233 . V_381 . V_383 ) ;
...
} else if ( V_229 -> V_243 . V_388 . V_389 . V_390 ) {
V_380 = V_229 -> V_391 ;
}
return V_380 ;
}
