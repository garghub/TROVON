...
static int F_13 ( struct V_19 * V_20 , T_4 V_50 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
T_1 V_48 ;
F_3 ( L_6 , V_16 ) ;
...
static int F_14 ( struct V_19 * V_20 , T_5 V_53 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
T_1 V_48 ;
F_3 ( L_9 , V_16 ,
...
static int F_16 ( struct V_19 * V_20 , T_6 * V_42 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
T_1 V_66 [ 2 ] ;
T_1 V_67 ;
...
static int F_17 ( struct V_19 * V_20 , T_7 * V_76 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
...
static int F_18 ( struct V_19 * V_20 , T_2 * V_77 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
F_3 ( L_6 , V_16 ) ;
if ( V_2 -> V_78 != V_79 )
...
static int F_19 ( struct V_19 * V_20 , T_7 * V_80 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
...
static int F_20 ( struct V_19 * V_20 , T_2 * V_82 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
F_3 ( L_6 , V_16 ) ;
if ( V_2 -> V_78 != V_83 )
...
static int F_21 ( struct V_19 * V_20 , int V_84 ,
T_9 V_85 )
{
struct V_1 * V_2 = V_20 -> V_21 ;
T_1 V_86 [] = {
...
V_90 ,
& V_87 , 0x01 ) ;
V_42 |= F_7 ( V_2 , V_91 , & V_18 , 0x01 ) ;
V_18 &= ~ V_88 ;
V_42 |= F_1 ( V_2 , V_91 , & V_18 , 0x01 ) ;
V_89 [ 0 ] = 0xCB ;
V_89 [ 1 ] = 0x40 ;
V_89 [ 2 ] = 0xCB ;
V_42 |= F_1 ( V_2 ,
...
V_2 -> V_36 = V_100 ;
F_21 ( V_20 , V_96 -> V_121 , V_96 -> V_123 ) ;
return 0 ;
}
...
struct V_19 * F_26 ( const struct V_126 * V_11 ,
struct V_127 * V_15 )
{
struct V_1 * V_2 = NULL ;
int V_128 ;
