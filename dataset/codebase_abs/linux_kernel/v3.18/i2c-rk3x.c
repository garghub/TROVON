...
static void F_22 ( struct V_1 * V_2 , unsigned long V_63 )
{
unsigned long V_64 = F_23 ( V_2 -> V_65 ) ;
unsigned int div ;
div = F_24 ( V_64 , V_63 * 16 ) - 1 ;
F_1 ( V_2 , ( div << 16 ) | ( div & 0xffff ) , V_66 ) ;
}
static int F_25 ( struct V_1 * V_2 , struct V_67 * V_68 , int V_69 )
{
...
V_70 = F_25 ( V_2 , V_68 + V_35 , V_69 - V_35 ) ;
if ( V_70 < 0 ) {
F_15 ( V_2 -> V_45 , L_7 ) ;
break;
}
...
T_1 V_3 ;
int V_96 ;
V_2 = F_36 ( & V_87 -> V_45 , sizeof( struct V_1 ) , V_97 ) ;
if ( ! V_2 )
return - V_98 ;
V_92 = F_37 ( V_99 , V_89 ) ;
V_2 -> V_100 = (struct V_101 * ) V_92 -> V_102 ;
if ( F_38 ( V_87 -> V_45 . V_90 , L_9 ,
& V_2 -> V_80 ) ) {
F_39 ( & V_87 -> V_45 , L_10 ,
V_103 ) ;
V_2 -> V_80 = V_103 ;
...
F_40 ( V_2 -> V_77 . V_104 , L_12 , sizeof( V_2 -> V_77 . V_104 ) ) ;
...
F_41 ( & V_2 -> V_56 ) ;
F_42 ( & V_2 -> V_28 ) ;
V_2 -> V_65 = F_43 ( & V_87 -> V_45 , NULL ) ;
if ( F_44 ( V_2 -> V_65 ) ) {
F_15 ( & V_87 -> V_45 , L_13 ) ;
return F_45 ( V_2 -> V_65 ) ;
}
V_94 = F_46 ( V_87 , V_111 , 0 ) ;
V_2 -> V_5 = F_47 ( & V_87 -> V_45 , V_94 ) ;
if ( F_44 ( V_2 -> V_5 ) )
return F_45 ( V_2 -> V_5 ) ;
V_95 = F_48 ( V_89 , L_14 ) ;
if ( V_2 -> V_100 -> V_112 >= 0 ) {
struct V_113 * V_114 ;
V_114 = F_49 ( V_89 , L_15 ) ;
if ( F_44 ( V_114 ) ) {
F_15 ( & V_87 -> V_45 ,
L_16 ) ;
return F_45 ( V_114 ) ;
...
V_3 = F_50 ( 27 + V_95 ) | F_50 ( 11 + V_95 ) ;
V_70 = F_51 ( V_114 , V_2 -> V_100 -> V_112 , V_3 ) ;
if ( V_70 != 0 ) {
F_15 ( V_2 -> V_45 , L_18 , V_70 ) ;
return V_70 ;
}
}
V_96 = F_52 ( V_87 , 0 ) ;
...
V_70 = F_53 ( & V_87 -> V_45 , V_96 , F_18 ,
0 , F_54 ( & V_87 -> V_45 ) , V_2 ) ;
if ( V_70 < 0 ) {
F_15 ( & V_87 -> V_45 , L_20 ) ;
return V_70 ;
}
