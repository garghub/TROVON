...
int V_11 ;
V_52 = F_17 ( & V_10 -> V_12 ) ;
V_7 = F_18 ( & V_10 -> V_12 , sizeof( * V_7 ) , V_57 ) ;
if ( ! V_7 )
return - V_58 ;
V_2 = & V_7 -> V_1 ;
V_2 -> V_59 = F_13 ;
...
if ( V_10 -> V_54 & V_63 )
V_54 = V_34 ;
else if ( V_10 -> V_54 & V_64 )
V_54 = V_33 ;
if ( V_52 && V_52 -> V_65 )
V_7 -> V_43 . V_65 = V_52 -> V_65 ;
if ( V_52 && V_52 -> type )
V_56 = V_52 -> type ;
else
V_56 = V_10 -> V_66 ;
V_11 = F_20 ( V_2 , V_56 , V_54 ) ;
if ( V_11 )
return V_11 ;
V_50 . V_67 = V_10 -> V_12 . V_67 ;
return F_21 ( & V_7 -> V_43 , NULL , & V_50 ,
V_52 ? V_52 -> V_68 : NULL ,
V_52 ? V_52 -> V_69 : 0 ) ;
}
