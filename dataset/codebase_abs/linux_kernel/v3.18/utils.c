...
{
if ( V_34 -> V_38 != V_39 ) {
* V_32 = F_10 ( F_11 ( F_12 ( ~ F_13 ( * V_32 ) , V_35 ) ,
V_36 ) ) ;
if ( V_34 -> V_38 == V_40 && V_37 )
V_34 -> V_41 = ~ F_11 ( F_12 ( ~ ( V_34 -> V_41 ) , V_35 ) , V_36 ) ;
} else if ( V_37 )
* V_32 = ~ F_10 ( F_11 ( F_12 ( F_13 ( * V_32 ) , V_35 ) ,
V_36 ) ) ;
}
void F_14 ( T_3 * V_32 , struct V_33 * V_34 ,
...
if ( V_34 -> V_38 != V_39 ) {
* V_32 = F_10 ( F_15 ( V_42 , sizeof( V_42 ) ,
~ F_13 ( * V_32 ) ) ) ;
if ( V_34 -> V_38 == V_40 && V_37 )
V_34 -> V_41 = ~ F_15 ( V_42 , sizeof( V_42 ) ,
~ V_34 -> V_41 ) ;
} else if ( V_37 )
* V_32 = ~ F_10 ( F_15 ( V_42 , sizeof( V_42 ) ,
F_13 ( * V_32 ) ) ) ;
}
static void F_16 ( struct V_43 * V_22 )
{
struct V_44 * V_45 =
F_17 ( V_22 , struct V_44 , V_45 ) ;
F_18 ( ! F_19 ( V_45 -> V_46 ) ) ;
F_20 ( V_45 -> V_46 ) ;
F_21 ( V_45 ) ;
}
static void F_22 ( struct V_47 * V_46 )
{
struct V_44 * V_22 ;
V_22 = F_23 ( sizeof( * V_22 ) , V_48 ) ;
if ( ! V_22 )
return;
F_24 ( & V_22 -> V_45 , F_16 ) ;
V_22 -> V_46 = V_46 ;
...
bool F_26 ( void * V_49 , int V_50 , bool * V_51 ,
struct V_47 * V_52 )
{
static F_27 ( V_53 ) ;
unsigned long V_54 ;
