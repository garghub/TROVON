...
V_246 . V_482 = V_483 ;
V_246 . V_484 = 0 ;
V_246 . V_488 = F_108 ( V_45 -> V_17 ) ;
V_246 . V_193 = 0 ;
V_246 . V_489 = F_108 ( V_45 -> V_490 ) ;
V_246 . V_143 = V_491 ;
if ( ( F_188 ( V_6 , & V_28 ,
& V_246 ) ) != 0 ) {
F_190 ( V_33 L_2 , V_6 -> V_34 ,
__FILE__ , __LINE__ , V_35 ) ;
return;
}
if ( V_28 . V_37 || V_28 . V_274 ) {
...
F_118 ( V_495 , V_69 , L_133 ) ;
F_22 ( & V_6 -> V_64 , V_63 ) ;
if ( V_6 -> V_496 -> V_497 == V_498 )
F_191 ( V_6 , V_26 ) ;
V_186 = F_80 ( T_30 , V_499 ) +
sizeof( T_31 ) ;
V_494 = F_59 ( V_186 , V_130 ) ;
if ( ! V_494 ) {
F_13 ( V_33 L_2 ,
V_6 -> V_34 , __FILE__ , __LINE__ , V_35 ) ;
return;
...
V_298 -> V_10 = F_193 ( V_105 -> V_8 ) ;
F_194 ( V_6 , V_494 ) ;
F_21 ( V_494 ) ;
}
static T_6
F_195 ( struct V_5 * V_6 , T_4 V_87 , T_6 V_229 , T_10 V_230 )
{
T_25 * V_246 ;
T_27 * V_28 ;
struct V_86 * V_89 ;
...
V_506 = F_66 ( V_28 -> V_478 ) ;
F_196 ( V_89 , F_180 ( V_89 ) - V_506 ) ;
if ( V_29 & V_509 )
...
if ( V_438 & V_475 ) {
struct V_432 V_433 ;
const void * V_510 = F_197 ( V_6 ,
V_87 ) ;
T_10 V_186 = F_198 ( T_10 , V_423 ,
F_66 ( V_28 -> V_479 ) ) ;
memcpy ( V_89 -> V_392 , V_510 , V_186 ) ;
F_184 ( V_89 -> V_392 , & V_433 ) ;
if ( V_433 . V_435 == 0x5D )
F_192 ( V_6 ,
F_9 ( V_28 -> V_193 ) ) ;
F_199 ( V_6 , V_433 . V_434 , V_433 . V_435 , V_433 . V_388 ) ;
}
switch ( V_29 ) {
case V_511 :
case V_512 :
...
break;
case V_456 :
if ( ( V_506 == 0 ) || ( V_89 -> V_476 > V_506 ) )
V_89 -> V_285 = V_517 << 16 ;
else
V_89 -> V_285 = ( V_507 << 16 ) | V_440 ;
break;
case V_452 :
V_89 -> V_285 = ( V_507 << 16 ) | V_440 ;
if ( ( V_438 & V_475 ) )
...
V_89 -> V_285 = V_288 << 16 ;
else if ( ! V_506 && V_89 -> V_428 [ 0 ] == V_519 ) {
V_28 -> V_439 = V_475 ;
V_28 -> V_441 = V_396 ;
V_89 -> V_285 = ( V_394 << 24 ) |
V_396 ;
...
V_186 = F_80 ( T_33 , V_528 ) + ( V_6 -> V_30 . V_31
* sizeof( V_529 ) ) ;
V_525 = F_59 ( V_186 , V_130 ) ;
if ( ! V_525 ) {
F_13 ( V_33 L_2 ,
V_6 -> V_34 , __FILE__ , __LINE__ , V_35 ) ;
return;
...
V_527 = V_525 -> V_528 [ V_91 ] . V_530 >> 4 ;
if ( V_91 == 0 )
V_6 -> V_30 . V_26 = F_9 ( V_525 ->
V_528 [ 0 ] . V_531 ) ;
V_6 -> V_30 . V_211 [ V_91 ] . V_26 = V_6 -> V_30 . V_26 ;
V_526 = F_9 ( V_525 -> V_528 [ V_91 ] .
V_320 ) ;
if ( V_526 && V_527 < V_532 )
V_527 = V_532 ;
F_203 ( V_6 , V_6 -> V_30 . V_8 ,
V_526 , V_91 , V_527 ) ;
}
V_74:
F_21 ( V_525 ) ;
...
V_186 = F_80 ( T_34 , V_528 ) + ( V_6 -> V_30 . V_31 *
sizeof( V_537 ) ) ;
V_533 = F_59 ( V_186 , V_130 ) ;
if ( ! V_533 ) {
F_13 ( V_33 L_2 ,
V_6 -> V_34 , __FILE__ , __LINE__ , V_35 ) ;
goto V_74;
...
V_6 -> V_536 = V_536 &
V_542 ;
V_6 -> V_30 . V_543 = & V_6 -> V_99 -> V_544 ;
V_6 -> V_30 . V_211 = F_207 ( V_6 -> V_30 . V_31 ,
sizeof( struct V_545 ) , V_130 ) ;
if ( ! V_6 -> V_30 . V_211 ) {
F_13 ( V_33 L_2 ,
V_6 -> V_34 , __FILE__ , __LINE__ , V_35 ) ;
goto V_74;
...
V_528 [ 0 ] . V_531 ) ;
V_6 -> V_30 . V_211 [ V_91 ] . V_26 = V_6 -> V_30 . V_26 ;
V_6 -> V_30 . V_211 [ V_91 ] . V_546 = V_91 ;
F_209 ( V_6 , & V_6 -> V_30 . V_211 [ V_91 ] ,
V_534 , V_6 -> V_30 . V_543 ) ;
}
if ( ( F_12 ( V_6 , & V_28 , & V_27 ,
V_32 , V_6 -> V_30 . V_26 ) ) ) {
F_13 ( V_33 L_2 ,
...
V_550 = F_9 ( V_548 . V_552 ) ;
if ( F_11 ( V_6 , V_550 , & V_68 )
!= 0 ) {
F_13 ( V_33 L_2 ,
V_6 -> V_34 , __FILE__ , __LINE__ , V_35 ) ;
return - 1 ;
...
V_78 -> V_26 = V_26 ;
V_78 -> V_31 = V_548 . V_553 ;
V_78 -> V_68 = V_68 ;
V_78 -> V_8 = V_8 ;
F_3 ( V_33 L_136 \
L_137 , V_6 -> V_34 ,
V_26 , V_550 , ( unsigned long long )
V_78 -> V_8 , V_78 -> V_31 ) ;
if ( ! V_78 -> V_31 )
goto V_554;
V_78 -> V_211 = F_207 ( V_78 -> V_31 ,
sizeof( struct V_545 ) , V_130 ) ;
if ( ! V_78 -> V_211 ) {
F_13 ( V_33 L_2 ,
V_6 -> V_34 , __FILE__ , __LINE__ , V_35 ) ;
...
V_78 -> V_211 [ V_91 ] . V_546 = V_91 ;
if ( ( F_214 ( V_6 ,
& V_78 -> V_211 [ V_91 ] , V_549 ,
V_78 -> V_543 ) ) ) {
F_13 ( V_33 L_2 ,
V_6 -> V_34 , __FILE__ , __LINE__ , V_35 ) ;
V_19 = - 1 ;
...
static T_6
F_217 ( struct V_5 * V_6 , T_4 V_87 , T_6 V_229 , T_10 V_230 )
{
T_15 * V_28 ;
V_28 = F_94 ( V_6 , V_230 ) ;
if ( V_6 -> V_556 . V_232 == V_233 )
return 1 ;
if ( V_6 -> V_556 . V_87 != V_87 )
return 1 ;
V_6 -> V_556 . V_232 |= V_234 ;
if ( V_28 ) {
memcpy ( V_6 -> V_556 . V_230 , V_28 ,
V_28 -> V_235 * 4 ) ;
V_6 -> V_556 . V_232 |= V_236 ;
}
V_6 -> V_556 . V_232 &= ~ V_237 ;
F_95 ( & V_6 -> V_556 . V_238 ) ;
return 1 ;
}
static T_6
F_218 ( struct V_5 * V_6 , T_1 V_8 ,
T_4 V_26 , T_6 V_557 )
{
T_6 V_19 = 1 ;
char * V_221 = NULL ;
...
T_1 V_577 , T_4 V_26 , T_6 V_578 , T_6 V_527 )
{
T_9 V_28 ;
T_8 V_27 ;
struct V_44 * V_45 ;
...
static int
F_220 ( struct V_5 * V_6 , T_4 V_26 , T_6 V_582 ,
T_6 V_583 )
{
T_9 V_28 ;
T_8 V_27 ;
...
F_9 ( V_298 -> V_342 ) ,
F_9 ( V_298 -> V_489 ) ,
V_298 -> V_588 , V_298 -> V_318 ) ;
for ( V_91 = 0 ; V_91 < V_298 -> V_318 ; V_91 ++ ) {
V_26 = F_9 ( V_298 -> V_319 [ V_91 ] . V_320 ) ;
if ( ! V_26 )
continue;
V_578 = V_298 -> V_588 + V_91 ;
V_317 = V_298 -> V_319 [ V_91 ] . V_321 &
V_322 ;
switch ( V_317 ) {
case V_589 :
...
V_527 = V_298 -> V_319 [ V_91 ] . V_592 >> 4 ;
V_587 = V_298 -> V_319 [ V_91 ] . V_592 & 0xF ;
F_3 ( L_164 \
L_165 , V_578 ,
V_26 , V_586 , V_527 , V_587 ) ;
}
}
static int
...
V_550 = F_9 ( V_298 -> V_342 ) ;
if ( V_298 -> V_343 == V_350 )
if ( F_211 ( V_6 , V_550 ) != 0 )
return 0 ;
F_19 ( & V_6 -> V_79 , V_63 ) ;
V_78 = F_37 ( V_6 ,
V_550 ) ;
...
F_9 ( V_298 -> V_477 ) ) ;
if ( V_298 -> V_357 == V_504 )
F_3 ( V_33 L_183 , V_6 -> V_34 ,
V_298 -> V_505 , V_298 -> V_609 ) ;
F_3 ( L_184 ) ;
}
static void
...
static int
F_230 ( struct V_5 * V_6 , T_4 V_26 , T_6 V_629 )
{
T_42 * V_246 ;
T_43 * V_28 ;
T_4 V_87 ;
...
L_209 , V_6 -> V_34 ,
V_26 , V_629 ) ) ;
F_110 ( & V_6 -> V_556 . V_238 ) ;
F_150 ( V_6 , V_87 ) ;
F_112 ( & V_6 -> V_556 . V_238 , 10 * V_271 ) ;
if ( ! ( V_6 -> V_556 . V_232 & V_234 ) ) {
F_13 ( V_33 L_47 ,
V_6 -> V_34 , V_35 ) ;
if ( ! ( V_6 -> V_556 . V_232 & V_272 ) )
V_630 = 1 ;
V_19 = - V_635 ;
goto V_74;
}
if ( V_6 -> V_556 . V_232 & V_236 ) {
V_28 = V_6 -> V_556 . V_230 ;
V_29 = F_9 ( V_28 -> V_37 ) ;
if ( V_29 & V_509 )
V_446 = F_66 ( V_28 -> V_274 ) ;
else
...
static void
F_231 ( struct V_95 * V_96 , void * V_142 )
{
int V_19 ;
...
if ( ! V_45 )
return;
F_230 ( V_6 , V_26 , V_353 -> V_192 ) ;
if ( V_69 )
F_238 ( V_69 , ( void * ) 1 , F_231 ) ;
}
static void
...
V_550 = F_9 ( V_27 . V_552 ) ;
if ( ! F_11 ( V_6 , V_550 , & V_8 ) )
F_203 ( V_6 , V_8 , V_26 ,
V_27 . V_579 , V_532 ) ;
F_230 ( V_6 , V_26 , V_353 -> V_192 ) ;
F_220 ( V_6 , V_26 , 0 , 1 ) ;
...
goto V_74;
V_26 = 0xFFFF ;
while ( ! ( F_212 ( V_6 , & V_28 , & V_548 ,
V_678 , V_26 ) ) ) {
V_29 = F_9 ( V_28 . V_37 ) &
V_38 ;
if ( V_29 != V_39 )
break;
V_26 = F_9 ( V_548 . V_193 ) ;
V_8 = F_6 ( V_548 . V_10 ) ;
F_3 ( L_252 ,
V_26 ,
( unsigned long long ) V_8 ) ;
...
void
F_260 ( struct V_5 * V_6 , int V_687 )
{
switch ( V_687 ) {
case V_688 :
F_106 ( V_6 , F_3 ( V_33
...
F_106 ( V_6 , F_3 ( V_33
L_287 , V_6 -> V_34 , V_35 ) ) ;
if ( V_6 -> V_556 . V_232 & V_237 ) {
V_6 -> V_556 . V_232 |= V_272 ;
F_157 ( V_6 , V_6 -> V_556 . V_87 ) ;
F_95 ( & V_6 -> V_556 . V_238 ) ;
}
...
static void
F_261 ( struct V_5 * V_6 , struct V_290 * V_291 )
{
if ( V_6 -> V_254 ||
V_6 -> V_255 ) {
F_128 ( V_6 , V_291 ) ;
...
static void
V_296 ( struct V_700 * V_295 )
{
struct V_290 * V_291 = F_265 ( V_295 ,
struct V_290 , V_295 ) ;
F_261 ( V_291 -> V_6 , V_291 ) ;
}
T_6
F_266 ( struct V_5 * V_6 , T_6 V_229 ,
T_10 V_230 )
{
struct V_290 * V_291 ;
T_30 * V_28 ;
...
memcpy ( V_291 -> V_298 , V_28 -> V_499 , V_186 ) ;
V_291 -> V_6 = V_6 ;
V_291 -> V_705 = V_28 -> V_705 ;
V_291 -> V_706 = V_28 -> V_706 ;
V_291 -> V_300 = V_300 ;
F_124 ( V_6 , V_291 ) ;
return 1 ;
}
...
static void F_269 ( struct V_708 * V_496 )
{
struct V_98 * V_99 = F_270 ( V_496 ) ;
struct V_5 * V_6 = F_47 ( V_99 ) ;
struct V_308 * V_309 , * V_709 ;
...
static int
F_284 ( struct V_98 * V_99 , unsigned long time )
{
struct V_5 * V_6 = F_47 ( V_99 ) ;
if ( V_628 > 0 ) {
V_6 -> V_48 = 0 ;
...
static int
F_286 ( struct V_708 * V_496 , const struct V_723 * V_71 )
{
struct V_5 * V_6 ;
struct V_98 * V_99 ;
int V_724 ;
...
V_6 -> V_99 = V_99 ;
V_6 -> V_71 = V_728 ++ ;
sprintf ( V_6 -> V_34 , L_297 , V_729 , V_6 -> V_71 ) ;
V_6 -> V_496 = V_496 ;
V_6 -> V_413 = V_413 ;
V_6 -> V_263 = V_263 ;
V_6 -> V_730 = V_730 ;
...
| V_749 ) ;
F_291 ( V_99 , V_750 ) ;
snprintf ( V_6 -> V_751 , sizeof( V_6 -> V_751 ) ,
L_303 , V_6 -> V_71 ) ;
V_6 -> V_292 = F_292 (
V_6 -> V_751 ) ;
if ( ! V_6 -> V_292 ) {
...
static int
F_296 ( struct V_708 * V_496 , T_47 V_160 )
{
struct V_98 * V_99 = F_270 ( V_496 ) ;
struct V_5 * V_6 = F_47 ( V_99 ) ;
T_48 V_755 ;
...
F_298 () ;
F_299 ( V_99 ) ;
V_755 = F_300 ( V_496 , V_160 ) ;
F_3 ( V_33
L_304 ,
V_6 -> V_34 , V_496 , F_301 ( V_496 ) , V_755 ) ;
F_302 ( V_496 ) ;
F_303 ( V_6 ) ;
F_304 ( V_496 , V_755 ) ;
return 0 ;
...
static int
F_305 ( struct V_708 * V_496 )
{
struct V_98 * V_99 = F_270 ( V_496 ) ;
struct V_5 * V_6 = F_47 ( V_99 ) ;
T_48 V_755 = V_496 -> V_756 ;
int V_73 ;
F_3 ( V_33
L_305 ,
V_6 -> V_34 , V_496 , F_301 ( V_496 ) , V_755 ) ;
...
if ( V_73 )
return V_73 ;
F_103 ( V_6 , V_257 , V_758 ) ;
F_309 ( V_99 ) ;
F_285 ( V_6 ) ;
return 0 ;
}
static T_49
F_310 ( struct V_708 * V_496 , T_50 V_160 )
{
struct V_98 * V_99 = F_270 ( V_496 ) ;
struct V_5 * V_6 = F_47 ( V_99 ) ;
F_3 ( V_33 L_306 ,
