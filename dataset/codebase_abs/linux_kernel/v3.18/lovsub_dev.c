...
if ( F_15 ( & V_20 -> V_37 ) && V_20 -> V_28 ) {
F_16 ( V_38 , V_39 , NULL ) ;
F_17 ( V_2 , V_20 -> V_28 , & V_38 , V_40 ) ;
}
F_18 ( F_11 ( V_20 ) ) ;
F_19 ( V_24 ) ;
return V_22 ;
}
static int F_20 ( const struct V_1 * V_2 , struct V_41 * V_42 ,
struct V_43 * V_44 )
{
struct V_6 * V_7 ;
int V_45 ;
F_21 ( V_7 , V_8 , V_46 ) ;
if ( V_7 != NULL ) {
F_22 ( V_44 , & V_7 -> V_47 , V_42 , & V_48 ) ;
V_45 = 0 ;
} else
V_45 = - V_49 ;
return V_45 ;
}
static struct V_19 * F_23 ( const struct V_1 * V_2 ,
struct V_25 * V_50 ,
struct V_51 * V_52 )
{
struct V_19 * V_20 ;
