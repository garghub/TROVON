...
int V_66 ;
V_64 = F_59 ( V_3 , V_67 , 0 ) ;
if ( ! V_64 )
return - V_68 ;
V_5 = F_60 ( sizeof *V_5 , V_69 ) ;
if ( ! V_5 ) {
V_66 = - V_70 ;
goto V_71;
}
...
goto V_81;
F_19 ( 0 , V_5 -> V_8 + V_13 ) ;
F_21 ( V_62 -> V_82 , V_5 -> V_8 + V_83 ) ;
F_21 ( V_84 | V_85 ,
V_5 -> V_8 + V_11 ) ;
F_21 ( V_86 | V_87 | V_88 |
V_89 | V_90 | V_91 |
F_71 ( 15 ) , V_5 -> V_8 + V_92 ) ;
F_21 ( V_62 -> V_93 , V_5 -> V_8 + V_94 ) ;
F_19 ( 0 , V_5 -> V_8 + V_95 ) ;
...
V_101 [ V_102 ] . V_103 = V_62 -> V_104 ;
V_101 [ V_102 ] . V_105 =
sizeof( * V_62 -> V_104 ) ;
V_101 [ V_106 ] . V_103 = V_62 -> V_107 ;
V_101 [ V_106 ] . V_105 = sizeof( * V_62 -> V_107 ) ;
V_66 = F_73 ( & V_3 -> V_3 , V_3 -> V_108 ,
V_101 , F_74 ( V_101 ) ,
V_64 , V_62 -> V_49 , NULL ) ;
if ( ! V_66 )
return 0 ;
...
static int F_83 ( struct V_1 * V_3 , T_3 V_28 )
{
struct V_61 * V_62 = F_58 ( & V_3 -> V_3 ) ;
struct V_5 * V_5 = F_3 ( V_3 ) ;
int V_48 , V_66 ;
V_5 -> V_111 . V_9 = F_84 ( V_5 -> V_8 + V_11 ) ;
V_5 -> V_111 . V_10 = F_18 ( V_5 -> V_8 + V_13 ) ;
for ( V_48 = 0 ; V_48 < 3 ; V_48 ++ ) {
V_5 -> V_111 . V_112 [ V_48 ] =
F_18 ( V_5 -> V_8 + F_32 ( V_48 ) ) ;
V_5 -> V_111 . V_113 [ V_48 ] =
F_18 ( V_5 -> V_8 + F_37 ( V_48 ) ) ;
V_5 -> V_111 . V_114 [ V_48 ] =
...
static int F_85 ( struct V_1 * V_3 )
{
struct V_61 * V_62 = F_58 ( & V_3 -> V_3 ) ;
struct V_5 * V_5 = F_3 ( V_3 ) ;
int V_66 ;
...
if ( ! V_62 -> V_117 )
return 0 ;
F_19 ( V_5 -> V_111 . V_10 , V_5 -> V_8 + V_13 ) ;
F_21 ( V_62 -> V_82 , V_5 -> V_8 + V_83 ) ;
F_21 ( V_5 -> V_111 . V_9 , V_5 -> V_8 + V_11 ) ;
F_21 ( V_86 | V_87 | V_88 |
V_89 | V_90 | V_91 |
F_71 ( 15 ) , V_5 -> V_8 + V_92 ) ;
F_21 ( V_62 -> V_93 , V_5 -> V_8 + V_94 ) ;
...
F_19 ( 0xbf , V_5 -> V_8 + V_51 ) ;
for ( V_48 = 0 ; V_48 < 3 ; V_48 ++ ) {
F_19 ( V_5 -> V_111 . V_112 [ V_48 ] ,
V_5 -> V_8 + F_32 ( V_48 ) ) ;
F_19 ( V_5 -> V_111 . V_113 [ V_48 ] ,
V_5 -> V_8 + F_37 ( V_48 ) ) ;
F_19 ( V_5 -> V_111 . V_114 [ V_48 ] ,
V_5 -> V_8 + F_7 ( V_48 ) ) ;
}
return 0 ;
}
