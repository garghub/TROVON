...
enum V_101 V_102 )
{
T_1 V_103 = F_8 ( V_11 , V_104 ) & 0xfe3e ;
switch ( V_102 ) {
case V_105 :
F_9 ( V_11 , V_104 , V_103 | 0x00c0 ) ;
break;
case V_106 :
F_9 ( V_11 , V_104 , V_103 | 0x01c1 ) ;
break;
case V_107 :
F_9 ( V_11 , V_104 , V_103 | 0x0141 ) ;
break;
case V_108 :
F_9 ( V_11 , V_104 , 0x0001 ) ;
break;
}
V_11 -> V_109 . V_110 = V_102 ;
return 0 ;
}
static void F_36 ( struct V_111 * V_112 )
{
struct V_113 * V_109 =
F_37 ( V_112 , struct V_113 ,
V_114 . V_112 ) ;
struct V_10 * V_11 = F_38 ( V_109 ) ;
F_35 ( V_11 , V_109 -> V_110 ) ;
}
...
F_41 ( V_13 -> V_115 ) ;
F_35 ( V_11 , V_107 ) ;
if ( V_11 -> V_109 . V_116 == V_105 ) {
F_35 ( V_11 , V_106 ) ;
V_11 -> V_109 . V_110 = V_105 ;
F_42 ( V_117 ,
& V_11 -> V_109 . V_114 ,
F_43 ( V_118 ) ) ;
}
...
struct V_12 * V_13 = F_5 ( V_11 ) ;
int V_97 ;
F_45 ( & V_11 -> V_109 . V_114 , F_36 ) ;
V_97 = F_46 ( V_11 ) ;
if ( V_97 < 0 ) {
F_47 ( V_11 -> V_2 , L_3 , V_97 ) ;
return V_97 ;
}
F_35 ( V_11 , V_107 ) ;
V_13 -> V_15 = 0 ;
F_35 ( V_11 , V_106 ) ;
F_48 ( & V_11 -> V_109 . V_114 ,
F_43 ( V_118 ) ) ;
F_49 ( V_11 , V_119 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_120 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_121 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_122 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_123 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_124 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_125 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_126 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_127 , 0x0100 , 0x0100 ) ;
F_49 ( V_11 , V_128 , 0x0100 , 0x0100 ) ;
return 0 ;
}
static int F_50 ( struct V_10 * V_11 )
{
F_51 ( & V_11 -> V_109 . V_114 ) ;
F_35 ( V_11 , V_108 ) ;
return 0 ;
}
...
struct V_12 * V_13 ;
int V_97 ;
V_13 = F_53 ( & V_130 -> V_2 , sizeof( struct V_12 ) ,
V_131 ) ;
if ( V_13 == NULL )
return - V_132 ;
F_54 ( V_130 , V_13 ) ;
V_13 -> V_115 = F_55 ( V_130 , & V_133 ) ;
if ( F_56 ( V_13 -> V_115 ) ) {
V_97 = F_57 ( V_13 -> V_115 ) ;
F_47 ( & V_130 -> V_2 , L_4 ,
V_97 ) ;
return V_97 ;
}
V_97 = F_58 ( & V_130 -> V_2 , & V_134 ,
V_135 , F_17 ( V_135 ) ) ;
if ( V_97 != 0 )
F_47 ( & V_130 -> V_2 , L_5 , V_97 ) ;
return V_97 ;
}
...
struct V_12 * V_13 ;
int V_97 ;
V_13 = F_53 ( & V_137 -> V_2 , sizeof( struct V_12 ) ,
V_131 ) ;
if ( V_13 == NULL )
return - V_132 ;
F_62 ( V_137 , V_13 ) ;
V_13 -> V_115 = F_63 ( V_137 , & V_133 ) ;
if ( F_56 ( V_13 -> V_115 ) ) {
V_97 = F_57 ( V_13 -> V_115 ) ;
F_47 ( & V_137 -> V_2 , L_4 ,
V_97 ) ;
...
V_97 = F_58 ( & V_137 -> V_2 , & V_134 ,
V_135 , F_17 ( V_135 ) ) ;
if ( V_97 != 0 )
F_47 ( & V_137 -> V_2 , L_5 , V_97 ) ;
return V_97 ;
}
static int F_64 ( struct V_136 * V_140 )
{
F_60 ( & V_140 -> V_2 ) ;
return 0 ;
}
