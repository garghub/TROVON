...
T_1 V_52 )
{
struct V_59 * V_117 = V_116 -> V_67 [ V_52 ] ;
if ( V_10 -> V_22 & V_46 )
return 0 ;
return F_38 ( V_10 , V_40 , V_170 ,
...
F_18 ( V_10 ) ;
F_6 ( & V_27 -> V_36 ) ;
F_33 ( & V_2 -> V_124 , & V_27 -> V_37 ) ;
V_2 -> V_130 -> V_71 = 1 ;
F_41 ( V_143 , V_10 , V_116 , V_2 , V_175 ) ;
F_8 ( & V_27 -> V_36 ) ;
if ( ! V_2 -> V_133 || V_181 )
return;
F_25 (pr_reg_tmp, pr_reg_tmp_safe,
...
unsigned char V_3 [ V_136 ] , * V_186 = NULL ;
if ( V_40 -> V_47 -> V_183 != NULL ) {
memset ( & V_3 [ 0 ] , 0 , V_136 ) ;
V_40 -> V_47 -> V_183 ( V_13 , & V_3 [ 0 ] ,
V_136 ) ;
V_186 = & V_3 [ 0 ] ;
}
return F_43 ( V_10 , V_116 , V_186 ) ;
}
...
{
return F_52 ( V_40 -> V_47 -> V_191 ,
& V_40 -> V_192 . V_193 ) ;
}
static void F_53 ( struct V_39 * V_40 )
{
F_54 ( V_40 -> V_47 -> V_191 ,
& V_40 -> V_192 . V_193 ) ;
F_31 ( & V_40 -> V_194 ) ;
}
static int F_55 ( struct V_20 * V_116 )
{
struct V_39 * V_40 = V_116 -> V_42 ;
if ( V_116 -> V_195 )
return 0 ;
...
static void F_56 ( struct V_20 * V_116 )
{
struct V_39 * V_40 = V_116 -> V_42 ;
if ( V_116 -> V_195 ) {
F_31 ( & V_116 -> V_197 ) ;
...
V_212 = F_59 ( sizeof( struct V_211 ) , V_158 ) ;
if ( ! V_212 ) {
F_9 ( L_60 ) ;
return V_226 ;
}
...
V_212 = F_59 ( sizeof( struct V_211 ) ,
V_158 ) ;
if ( ! V_212 ) {
F_9 ( L_60 ) ;
F_32 ( V_205 ) ;
...
V_236 = ( strlen ( V_3 ) + 1 ) ;
V_55 = F_73 ( V_245 , V_3 , V_236 , 0 ) ;
if ( V_55 < 0 )
F_11 ( L_108 , V_250 ) ;
F_74 ( V_245 ) ;
return ( V_55 < 0 ) ? - V_252 : 0 ;
}
static T_2 F_75 ( struct V_9 * V_10 , bool V_121 )
{
unsigned char * V_3 ;
int V_41 ;
if ( ! V_121 ) {
char * V_253 = L_109 ;
V_41 = F_69 ( V_10 , V_253 ) ;
V_10 -> V_28 . V_174 = 0 ;
F_11 ( L_110 ) ;
if ( V_41 )
return V_226 ;
...
V_3 = F_59 ( V_254 , V_158 ) ;
if ( ! V_3 )
return V_255 ;
V_41 = F_68 ( V_10 , V_3 , V_254 ) ;
if ( V_41 < 0 ) {
F_60 ( V_3 ) ;
return V_255 ;
}
...
static T_2
F_76 ( struct V_7 * V_8 , T_3 V_256 , T_3 V_119 ,
bool V_121 , bool V_120 , bool V_257 , enum V_175 V_175 )
{
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_59 * V_51 ;
...
struct V_26 * V_27 = & V_10 -> V_28 ;
unsigned char V_238 [ V_136 ] , * V_186 = NULL ;
T_2 V_55 = V_259 ;
int V_260 = 0 , type ;
if ( ! V_14 || ! V_49 ) {
F_9 ( L_113 ) ;
...
V_55 = F_57 ( V_8 , V_42 ,
V_186 , V_119 , V_120 , V_121 ) ;
if ( V_55 != 0 )
return V_55 ;
}
return F_75 ( V_10 , V_121 ) ;
}
if ( ( V_175 == REGISTER ) && ( V_256 != V_2 -> V_110 ) ) {
F_9 ( L_118
L_119
L_120
L_121 , V_256 ,
...
if ( V_119 ) {
V_2 -> V_180 = F_18 ( V_8 -> V_11 ) ;
V_2 -> V_110 = V_119 ;
F_11 ( L_127
L_128
L_59 , V_8 -> V_262 -> V_48 () ,
( V_175 == V_177 ) ? L_45 : L_29 ,
V_2 -> V_111 -> V_53 ,
V_2 -> V_110 , V_2 -> V_180 ) ;
} else {
V_260 = F_44 (
...
static T_2
F_78 ( struct V_7 * V_8 , int type , int V_264 , T_3 V_256 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_49 * V_49 = V_8 -> V_49 ;
...
static T_2
F_79 ( struct V_7 * V_8 , int type , int V_264 ,
T_3 V_256 )
{
switch ( type ) {
case V_69 :
...
case V_34 :
case V_35 :
return F_78 ( V_8 , type , V_264 , V_256 ) ;
default:
F_9 ( L_148
L_149 , type ) ;
return V_261 ;
...
static T_2
F_80 ( struct V_7 * V_8 , int type , int V_264 ,
T_3 V_256 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_12 * V_14 = V_8 -> V_14 ;
...
static T_2
F_84 ( struct V_7 * V_8 , int type , int V_264 , T_3 V_256 ,
...
static T_2
F_86 ( struct V_7 * V_8 , int type , int V_264 ,
...
case V_34 :
case V_35 :
return F_84 ( V_8 , type , V_264 , V_256 ,
V_119 , V_273 ) ;
default:
F_9 ( L_166
...
struct V_49 * V_49 = V_8 -> V_49 ;
struct V_20 * V_190 , * V_111 , * V_204 = NULL ;
struct V_139 * V_139 ;
...
static unsigned long long F_88 ( unsigned char * V_58 )
{
...
break;
case V_86 :
V_55 = F_79 ( V_8 , type , V_264 , V_256 ) ;
break;
case V_87 :
V_55 = F_80 ( V_8 , type , V_264 , V_256 ) ;
break;
case V_80 :
V_55 = F_81 ( V_8 , V_256 ) ;
break;
case V_81 :
V_55 = F_86 ( V_8 , type , V_264 ,
V_256 , V_119 , V_294 ) ;
break;
case V_82 :
V_55 = F_86 ( V_8 , type , V_264 ,
...
case V_84 :
V_55 = F_76 ( V_8 ,
0 , V_119 , V_121 , V_120 , V_257 , V_177 ) ;
break;
case V_85 :
V_55 = F_87 ( V_8 , V_256 ,
V_119 , V_121 , V_280 ) ;
...
F_28 (pr_reg, &dev->t10_pr.registration_list,
pr_reg_list) {
if ( ( V_295 + 8 ) > ( V_8 -> V_228 - 8 ) )
break;
V_3 [ V_296 ++ ] = ( ( V_2 -> V_110 >> 56 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_2 -> V_110 >> 48 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_2 -> V_110 >> 40 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_2 -> V_110 >> 32 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_2 -> V_110 >> 24 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_2 -> V_110 >> 16 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_2 -> V_110 >> 8 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( V_2 -> V_110 & 0xff ) ;
V_295 += 8 ;
}
F_8 ( & V_10 -> V_28 . V_36 ) ;
V_3 [ 4 ] = ( ( V_295 >> 24 ) & 0xff ) ;
...
struct V_26 * V_27 = & V_10 -> V_28 ;
unsigned char * V_3 ;
T_1 V_298 = 0 , V_295 = 0 , V_299 , V_300 ;
T_1 V_296 = 8 ;
int V_301 = 0 ;
if ( V_8 -> V_228 < 8 ) {
F_9 ( L_227
...
F_26 ( & V_2 -> V_129 ) ;
F_8 ( & V_27 -> V_36 ) ;
V_300 = V_42 -> V_47 -> V_302 (
V_42 , V_267 , V_2 , & V_301 ) ;
if ( ( V_300 + V_295 ) > V_8 -> V_228 ) {
F_61 ( L_228
L_229 , V_8 -> V_228 ) ;
F_6 ( & V_27 -> V_36 ) ;
F_31 ( & V_2 -> V_129 ) ;
...
V_3 [ V_296 ++ ] = ( ( V_140 -> V_234 >> 8 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( V_140 -> V_234 & 0xff ) ;
} else
V_296 += 2 ;
V_299 = V_42 -> V_47 -> V_303 ( V_42 ,
V_267 , V_2 , & V_301 , & V_3 [ V_296 + 4 ] ) ;
F_6 ( & V_27 -> V_36 ) ;
F_31 ( & V_2 -> V_129 ) ;
V_3 [ V_296 ++ ] = ( ( V_299 >> 24 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_299 >> 16 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( ( V_299 >> 8 ) & 0xff ) ;
V_3 [ V_296 ++ ] = ( V_299 & 0xff ) ;
V_298 = ( 24 + V_299 ) ;
V_296 += V_299 ;
V_295 += V_298 ;
}
...
if ( ! V_8 -> V_14 )
return 0 ;
if ( V_10 -> V_308 -> V_309 & V_310 )
return 0 ;
if ( V_10 -> V_178 -> V_311 == V_312 )
return 0 ;
F_6 ( & V_10 -> V_44 ) ;
if ( V_10 -> V_22 & V_46 )
V_55 = F_2 ( V_8 ) ;
