...
V_6 = 0 ;
V_90 = abs ( ( V_353 [ 0 ] * F_80 ( V_332 ) )
- V_4 -> V_17 [ V_82 ] ) ;
for ( V_7 = 1 ; V_7 < F_4 ( V_353 ) ; V_7 ++ ) {
V_340 = abs ( ( V_353 [ V_7 ] * F_80 ( V_332 ) )
- V_4 -> V_17 [ V_82 ] ) ;
if ( V_340 >= V_90 )
continue;
V_6 = V_7 ;
...
static int F_84 ( struct V_269 * V_360 , int V_361 )
{
...
static int F_85 ( struct V_269 * V_360 , int V_366 )
{
struct V_1 * V_2 = V_360 -> V_2 ;
int V_52 , V_9 , V_62 ;
switch ( V_360 -> V_82 ) {
...
V_4 -> V_395 = F_95 ( V_4 -> V_137 . V_2 -> V_28 ,
...
int F_96 ( struct V_1 * V_2 , struct V_400 * V_102 ,
int V_399 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_401 * V_101 ;
...
static void F_99 ( struct V_412 * V_413 )
{
struct V_3 * V_414 = F_100 ( V_413 ,
struct V_3 ,
V_415 . V_413 ) ;
...
F_102 ( V_414 -> V_101 [ 0 ] . V_102 , V_418 ,
V_421 | V_424 ) ;
V_418 = 0 ;
if ( V_52 & V_425 ) {
...
F_102 ( V_414 -> V_101 [ 1 ] . V_102 , V_418 ,
V_421 | V_424 ) ;
F_36 ( V_28 ) ;
}
...
static void F_109 ( struct V_1 * V_2 , T_1 V_429 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_418 ;
V_418 = 0 ;
...
if ( V_429 & 0x80 )
V_418 |= V_434 ;
F_102 ( V_4 -> V_101 [ 0 ] . V_102 , V_418 ,
V_4 -> V_435 ) ;
}
static void F_110 ( struct V_412 * V_413 )
{
struct V_3 * V_4 = F_100 ( V_413 ,
struct V_3 ,
V_436 . V_413 ) ;
...
static void F_111 ( void * V_266 , T_1 V_429 )
{
...
F_1 ( V_2 ) ;
F_108 ( V_2 ) ;
F_102 ( V_4 -> V_101 [ 0 ] . V_102 , V_423 ,
V_421 ) ;
}
}
static void F_112 ( struct V_412 * V_413 )
{
struct V_3 * V_4 = F_100 ( V_413 , struct V_3 ,
V_415 . V_413 ) ;
struct V_4 * V_5 = V_4 -> V_4 ;
struct V_1 * V_2 = V_4 -> V_137 . V_2 ;
F_31 ( V_2 -> V_28 ) ;
...
static void F_115 ( struct V_412 * V_413 )
{
struct V_3 * V_4 = F_100 ( V_413 ,
struct V_3 ,
V_119 . V_413 ) ;
...
int F_116 ( struct V_1 * V_2 , struct V_400 * V_102 ,
...
static void F_117 ( struct V_412 * V_413 )
{
struct V_3 * V_4 = F_100 ( V_413 ,
struct V_3 ,
V_442 . V_413 ) ;
...
{
struct V_4 * V_5 = F_124 ( V_2 -> V_28 -> V_468 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_295 * V_48 = & V_2 -> V_48 ;
unsigned int V_52 ;
int V_63 , V_7 ;
...
switch ( V_5 -> type ) {
case V_158 :
F_126 ( & V_4 -> V_415 , F_99 ) ;
break;
case V_284 :
F_126 ( & V_4 -> V_415 , F_112 ) ;
break;
default:
break;
}
F_126 ( & V_4 -> V_442 , F_117 ) ;
...
F_31 ( V_2 -> V_28 ) ;
V_63 = F_101 ( V_5 -> V_416 , V_490 , & V_52 ) ;
if ( V_63 < 0 ) {
...
V_63 = F_101 ( V_5 -> V_416 , V_496 , & V_52 ) ;
if ( V_63 < 0 ) {
...
F_133 ( V_2 , 0 , 0 ) ;
V_63 = F_128 ( V_4 -> V_4 , V_516 ,
V_517 , L_103 ,
& V_4 -> V_137 ) ;
if ( V_63 == 0 )
V_4 -> V_137 . V_518 = true ;
F_134 ( V_48 , V_519 , F_4 ( V_519 ) ) ;
switch ( V_5 -> type ) {
case V_158 :
F_134 ( V_48 , V_520 ,
F_4 ( V_520 ) ) ;
...
V_491:
if ( V_4 -> V_21 )
F_136 ( V_4 -> V_4 , F_130 ( 6 ) , V_4 ) ;
F_136 ( V_4 -> V_4 , V_487 , V_4 ) ;
F_136 ( V_4 -> V_4 , V_486 , V_4 ) ;
F_136 ( V_4 -> V_4 , V_485 , V_4 ) ;
if ( V_4 -> V_469 )
F_137 ( V_4 -> V_469 , V_4 ) ;
for ( V_7 = 0 ; V_7 < F_4 ( V_4 -> V_255 ) ; V_7 ++ )
F_136 ( V_4 -> V_4 , V_489 + V_7 ,
& V_4 -> V_255 [ V_7 ] ) ;
F_136 ( V_4 -> V_4 , V_516 ,
& V_4 -> V_137 ) ;
F_136 ( V_4 -> V_4 , V_480 , V_2 ) ;
F_136 ( V_4 -> V_4 , V_482 , V_2 ) ;
F_136 ( V_4 -> V_4 , V_481 , V_2 ) ;
return V_63 ;
}
...
static struct V_416 * F_141 ( struct V_417 * V_28 )
{
struct V_4 * V_5 = F_124 ( V_28 -> V_468 ) ;
return V_5 -> V_416 ;
}
static int F_142 ( struct V_528 * V_529 )
{
struct V_3 * V_4 ;
V_4 = F_95 ( & V_529 -> V_28 , sizeof( struct V_3 ) ,
V_381 ) ;
if ( V_4 == NULL )
return - V_530 ;
F_143 ( V_529 , V_4 ) ;
V_4 -> V_4 = F_124 ( V_529 -> V_28 . V_468 ) ;
F_144 ( & V_529 -> V_28 ) ;
F_145 ( & V_529 -> V_28 ) ;
return F_146 ( & V_529 -> V_28 , & V_531 ,
V_494 , F_4 ( V_494 ) ) ;
}
static int F_147 ( struct V_528 * V_529 )
{
F_148 ( & V_529 -> V_28 ) ;
F_149 ( & V_529 -> V_28 ) ;
return 0 ;
}
static int F_150 ( struct V_417 * V_28 )
{
struct V_3 * V_4 = F_124 ( V_28 ) ;
if ( V_4 -> V_21 && ! V_4 -> V_103 )
F_151 ( V_4 -> V_4 -> V_416 , V_107 ,
V_108 ,
V_4 -> V_105 ) ;
return 0 ;
}
static int F_152 ( struct V_417 * V_28 )
{
struct V_3 * V_4 = F_124 ( V_28 ) ;
