...
if ( V_3 ) {
V_3 = F_17 ( V_3 , 1 , ( char * * ) & V_1 -> V_24 . V_25 , 1 ) ;
goto V_35;
}
F_18 ( & V_15 -> V_34 ) ;
...
if ( F_23 ( V_3 ) )
return V_3 ;
V_10 = F_17 ( V_3 , 0 , NULL , 1 ) ;
return V_10 ;
}
static struct V_2 * F_31 ( struct V_1 * V_1 , T_1 V_8 )
{
struct V_2 * V_3 , * V_10 ;
V_3 = F_14 ( V_1 , V_8 , 0 ) ;
if ( F_23 ( V_3 ) )
...
struct V_2 * F_32 ( struct V_1 * V_1 )
{
int V_48 ;
struct V_2 * V_3 ;
V_3 = F_31 ( V_1 , V_49 ) ;
