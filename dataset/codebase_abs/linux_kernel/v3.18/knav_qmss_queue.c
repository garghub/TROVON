...
V_104 -> V_111 = V_126 ;
V_106 -> V_129 += V_109 ;
F_82 ( & V_104 -> V_49 , & V_24 -> V_130 ) ;
F_82 ( & V_104 -> V_131 , V_125 ) ;
} else {
F_77 ( V_24 -> V_25 , L_16 ,
V_38 , V_121 ) ;
V_19 = - V_40 ;
...
void * F_91 ( void * V_118 , T_5 V_96 , unsigned V_133 )
{
struct V_103 * V_104 = V_118 ;
unsigned V_134 ;
void * V_117 ;
V_134 = F_89 ( V_133 , V_104 -> V_106 -> V_108 ) ;
V_117 = F_73 ( V_104 , V_96 ) ;
F_92 ( V_104 -> V_25 , V_96 , V_134 , V_135 ) ;
F_93 ( V_117 ) ;
return V_117 ;
}
int F_94 ( void * V_118 )
...
V_106 -> V_120 = F_97 ( V_97 , V_39 | V_142 |
V_143 ) ;
if ( ! V_106 -> V_120 ) {
V_106 -> V_109 = 0 ;
F_77 ( V_24 -> V_25 , L_19 ,
...
V_106 -> V_144 = V_106 -> V_120 + V_97 ;
V_141 = F_98 ( V_106 -> V_120 ) ;
V_106 -> V_114 = F_99 ( V_24 -> V_25 , V_141 , 0 , V_97 ,
V_145 ) ;
...
F_101 ( & V_104 -> V_131 , & V_106 -> V_130 ) ;
F_74 ( V_24 -> V_25 ,
L_22 ,
V_106 -> V_38 , V_16 , V_106 -> V_108 , V_106 -> V_109 ,
V_106 -> V_148 , V_106 -> V_114 , V_106 -> V_147 ,
V_106 -> V_120 , V_106 -> V_144 ) ;
V_137 = ( V_106 -> V_108 / 16 ) - 1 ;
V_136 -= 5 ;
F_102 (kdev, qmgr) {
V_139 = V_41 -> V_149 + V_16 ;
F_60 ( V_106 -> V_114 , & V_139 -> V_150 ) ;
F_60 ( V_106 -> V_148 , & V_139 -> V_151 ) ;
F_60 ( V_137 << 16 | V_136 ,
& V_139 -> V_152 ) ;
}
return;
...
static const char * F_105 ( struct V_153 * V_125 )
{
const char * V_38 ;
...
V_106 -> V_38 = F_105 ( V_156 ) ;
F_109 ( V_156 , L_26 , & V_106 -> V_16 ) ;
V_19 = F_110 ( V_156 , L_27 , V_157 , 2 ) ;
if ( ! V_19 ) {
V_106 -> V_109 = V_157 [ 0 ] ;
V_106 -> V_108 = V_157 [ 1 ] ;
} else {
...
if ( ! F_111 ( V_156 , L_29 , NULL ) ) {
F_77 ( V_25 , L_30 , V_106 -> V_38 ) ;
F_29 ( V_25 , V_106 ) ;
continue;
}
V_19 = F_109 ( V_156 , L_29 ,
& V_106 -> V_148 ) ;
if ( V_19 ) {
F_77 ( V_25 , L_31 ,
V_106 -> V_38 ) ;
...
struct V_158 * V_159 )
{
struct V_160 * V_161 = F_114 ( V_24 -> V_25 ) ;
struct V_153 * V_125 = V_161 -> V_25 . V_162 ;
T_3 V_157 [ 2 ] ;
if ( ! F_110 ( V_125 , V_38 , V_157 , 2 ) ) {
if ( V_157 [ 0 ] ) {
V_159 -> V_163 = ( T_5 ) V_157 [ 0 ] ;
V_159 -> V_119 = NULL ;
V_159 -> V_97 = V_157 [ 1 ] ;
} else {
V_159 -> V_97 = V_157 [ 1 ] ;
V_159 -> V_119 = F_115 ( V_24 -> V_25 ,
8 * V_159 -> V_97 , & V_159 -> V_163 ,
V_39 ) ;
if ( ! V_159 -> V_119 ) {
F_77 ( V_24 -> V_25 , L_33 ) ;
return - V_40 ;
...
V_159 = & V_24 -> V_164 [ 0 ] ;
F_74 ( V_24 -> V_25 , L_34 ,
V_159 -> V_163 , V_159 -> V_119 , V_159 -> V_97 ) ;
F_60 ( V_159 -> V_163 , & V_41 -> V_165 -> V_166 ) ;
F_60 ( V_159 -> V_97 , & V_41 -> V_165 -> V_167 ) ;
V_159 ++ ;
if ( ! V_159 -> V_97 )
return 0 ;
F_74 ( V_24 -> V_25 , L_35 ,
V_159 -> V_163 , V_159 -> V_119 , V_159 -> V_97 ) ;
F_60 ( V_159 -> V_163 , & V_41 -> V_165 -> V_168 ) ;
}
return 0 ;
}
...
struct V_13 * V_14 ;
struct V_140 * V_41 ;
T_3 V_157 [ 2 ] , V_169 , V_81 , V_16 , V_110 ;
int V_19 , V_107 ;
...
V_19 = F_110 ( V_125 , L_37 , V_157 , 2 ) ;
if ( ! V_19 ) {
V_14 -> V_17 = V_157 [ 0 ] - V_24 -> V_36 ;
V_14 -> V_37 = V_157 [ 1 ] ;
} else {
...
struct V_171 V_172 ;
if ( F_118 ( V_125 , V_107 , & V_172 ) )
break;
V_14 -> V_22 [ V_107 ] . V_10 = F_119 ( & V_172 ) ;
if ( V_14 -> V_22 [ V_107 ] . V_10 == V_173 )
break;
V_14 -> V_174 ++ ;
if ( V_172 . V_175 == 3 )
V_14 -> V_22 [ V_107 ] . V_18 =
( V_172 . args [ 2 ] & 0x0000ff00 ) >> 8 ;
}
V_14 -> V_174 = F_89 ( V_14 -> V_174 , V_14 -> V_37 ) ;
if ( V_14 -> V_174 )
V_14 -> V_20 |= V_21 ;
...
F_102 (kdev, qmgr) {
V_169 = F_121 ( V_41 -> V_42 , V_14 -> V_17 ) ;
V_81 = F_89 ( V_41 -> V_42 + V_41 -> V_37 ,
V_14 -> V_17 + V_14 -> V_37 ) ;
for ( V_16 = V_169 ; V_16 < V_81 ; V_16 ++ ) {
...
V_24 -> V_179 += V_14 -> V_37 ;
return 0 ;
}
static int F_122 ( struct V_34 * V_24 ,
struct V_153 * V_180 )
{
struct V_153 * type , * V_14 ;
int V_19 ;
...
struct V_13 * V_14 )
{
if ( V_14 -> V_47 && V_14 -> V_47 -> V_181 )
V_14 -> V_47 -> V_181 ( V_14 ) ;
F_85 ( & V_14 -> V_49 ) ;
F_29 ( V_24 -> V_25 , V_14 ) ;
}
...
if ( ! V_106 )
break;
F_81 (pool, &region->pools, region_inst)
F_84 ( V_104 ) ;
V_97 = V_106 -> V_144 - V_106 -> V_120 ;
if ( V_97 )
F_104 ( V_106 -> V_120 , V_97 ) ;
F_85 ( & V_106 -> V_49 ) ;
...
static void T_4 * F_128 ( struct V_34 * V_24 ,
struct V_153 * V_125 , int V_110 )
{
struct V_182 V_183 ;
void T_4 * V_139 ;
int V_19 ;
V_19 = F_129 ( V_125 , V_110 , & V_183 ) ;
if ( V_19 ) {
F_77 ( V_24 -> V_25 , L_47 ,
V_125 -> V_38 , V_110 ) ;
return F_27 ( V_19 ) ;
}
V_139 = F_130 ( V_24 -> V_25 , & V_183 ) ;
if ( F_131 ( V_139 ) )
F_77 ( V_24 -> V_25 , L_48 ,
V_110 , V_125 -> V_38 ) ;
return V_139 ;
}
static int F_132 ( struct V_34 * V_24 ,
struct V_153 * V_184 )
{
struct V_155 * V_25 = V_24 -> V_25 ;
struct V_140 * V_41 ;
...
F_128 ( V_24 , V_156 ,
V_191 ) ;
if ( F_131 ( V_41 -> V_45 ) || F_131 ( V_41 -> V_186 ) ||
F_131 ( V_41 -> V_165 ) || F_131 ( V_41 -> V_149 ) ||
F_131 ( V_41 -> V_43 ) || F_131 ( V_41 -> V_44 ) ) {
F_77 ( V_25 , L_53 ) ;
if ( ! F_131 ( V_41 -> V_45 ) )
F_134 ( V_25 , V_41 -> V_45 ) ;
if ( ! F_131 ( V_41 -> V_186 ) )
F_134 ( V_25 , V_41 -> V_186 ) ;
if ( ! F_131 ( V_41 -> V_165 ) )
F_134 ( V_25 , V_41 -> V_165 ) ;
if ( ! F_131 ( V_41 -> V_149 ) )
F_134 ( V_25 , V_41 -> V_149 ) ;
if ( ! F_131 ( V_41 -> V_43 ) )
F_134 ( V_25 , V_41 -> V_43 ) ;
if ( ! F_131 ( V_41 -> V_44 ) )
F_134 ( V_25 , V_41 -> V_44 ) ;
F_29 ( V_25 , V_41 ) ;
continue;
}
F_82 ( & V_41 -> V_49 , & V_24 -> V_184 ) ;
F_133 ( V_25 , L_54 ,
V_41 -> V_42 , V_41 -> V_37 ,
V_41 -> V_45 , V_41 -> V_186 ,
V_41 -> V_165 , V_41 -> V_149 ,
V_41 -> V_43 , V_41 -> V_44 ) ;
}
return 0 ;
}
static int F_135 ( struct V_34 * V_24 ,
struct V_153 * V_192 )
{
struct V_155 * V_25 = V_24 -> V_25 ;
struct V_193 * V_194 ;
...
int V_19 ;
F_108 (pdsps, child) {
V_194 = F_26 ( V_25 , sizeof( * V_194 ) , V_39 ) ;
if ( ! V_194 ) {
F_77 ( V_25 , L_55 ) ;
return - V_40 ;
}
V_194 -> V_38 = F_105 ( V_156 ) ;
V_19 = F_106 ( V_156 , L_56 ,
& V_194 -> V_195 ) ;
if ( V_19 < 0 || ! V_194 -> V_195 ) {
F_77 ( V_25 , L_57 ,
V_194 -> V_38 ) ;
F_29 ( V_25 , V_194 ) ;
continue;
}
F_74 ( V_25 , L_58 , V_194 -> V_38 ,
V_194 -> V_195 ) ;
V_194 -> V_196 =
F_128 ( V_24 , V_156 ,
V_197 ) ;
...
F_128 ( V_24 , V_156 ,
V_202 ) ;
if ( F_131 ( V_194 -> V_201 ) || F_131 ( V_194 -> V_196 ) ||
F_131 ( V_194 -> V_139 ) || F_131 ( V_194 -> V_199 ) ) {
F_77 ( V_25 , L_59 ,
V_194 -> V_38 ) ;
if ( ! F_131 ( V_194 -> V_201 ) )
F_134 ( V_25 , V_194 -> V_201 ) ;
if ( ! F_131 ( V_194 -> V_196 ) )
F_134 ( V_25 , V_194 -> V_196 ) ;
if ( ! F_131 ( V_194 -> V_139 ) )
F_134 ( V_25 , V_194 -> V_139 ) ;
if ( ! F_131 ( V_194 -> V_199 ) )
F_134 ( V_25 , V_194 -> V_199 ) ;
F_29 ( V_25 , V_194 ) ;
continue;
}
F_109 ( V_156 , L_26 , & V_194 -> V_16 ) ;
F_82 ( & V_194 -> V_49 , & V_24 -> V_192 ) ;
F_74 ( V_25 , L_60 ,
V_194 -> V_38 , V_194 -> V_201 , V_194 -> V_196 , V_194 -> V_139 ,
V_194 -> V_199 , V_194 -> V_195 ) ;
}
return 0 ;
}
...
T_3 V_82 , V_80 = 1000 ;
int V_19 ;
V_82 = F_47 ( & V_194 -> V_139 -> V_203 ) & ~ V_204 ;
F_60 ( V_82 , & V_194 -> V_139 -> V_203 ) ;
V_19 = F_54 ( & V_194 -> V_139 -> V_203 , V_80 ,
V_205 ) ;
if ( V_19 < 0 ) {
F_77 ( V_24 -> V_25 , L_61 , V_194 -> V_38 ) ;
return V_19 ;
}
return 0 ;
}
...
struct V_193 * V_194 )
{
int V_107 , V_19 , V_206 ;
const struct V_195 * V_207 ;
T_3 * V_208 ;
V_19 = F_138 ( & V_207 , V_194 -> V_195 , V_24 -> V_25 ) ;
if ( V_19 ) {
F_77 ( V_24 -> V_25 , L_62 ,
V_194 -> V_195 , V_194 -> V_38 ) ;
return V_19 ;
}
F_60 ( V_194 -> V_16 + 1 , V_194 -> V_201 + 0x18 ) ;
V_208 = ( T_3 * ) V_207 -> V_132 ;
V_206 = ( V_207 -> V_97 + sizeof( T_3 ) - 1 ) / sizeof( T_3 ) ;
for ( V_107 = 0 ; V_107 < V_206 ; V_107 ++ )
F_60 ( F_139 ( V_208 [ V_107 ] ) , V_194 -> V_196 + V_107 ) ;
F_140 ( V_207 ) ;
return 0 ;
}
static int F_141 ( struct V_34 * V_24 ,
struct V_193 * V_194 )
{
T_3 V_82 , V_80 = 1000 ;
int V_19 ;
F_60 ( 0xffffffff , V_194 -> V_201 ) ;
while ( F_47 ( V_194 -> V_201 ) != 0xffffffff )
F_57 () ;
V_82 = F_47 ( & V_194 -> V_139 -> V_203 ) ;
V_82 &= ~ ( V_209 | V_210 ) ;
F_60 ( V_82 , & V_194 -> V_139 -> V_203 ) ;
V_82 = F_47 ( & V_194 -> V_139 -> V_203 ) | V_204 ;
F_60 ( V_82 , & V_194 -> V_139 -> V_203 ) ;
V_19 = F_54 ( V_194 -> V_201 , V_80 , 0 ) ;
if ( V_19 < 0 ) {
F_77 ( V_24 -> V_25 ,
L_63 ,
V_194 -> V_38 ) ;
...
static void F_142 ( struct V_34 * V_24 )
{
struct V_193 * V_194 ;
F_143 (kdev, pdsp)
F_136 ( V_24 , V_194 ) ;
...
F_143 (kdev, pdsp) {
V_19 = F_141 ( V_24 , V_194 ) ;
F_5 ( V_19 ) ;
}
return 0 ;
}
static inline struct V_140 * F_145 ( unsigned V_16 )
{
struct V_140 * V_41 ;
F_102 (kdev, qmgr) {
if ( ( V_16 >= V_41 -> V_42 ) &&
...
static int F_146 ( struct V_34 * V_24 ,
struct V_13 * V_14 ,
struct V_1 * V_2 ,
unsigned V_16 )
{
...
V_2 -> V_211 = - 1 ;
V_2 -> V_16 = V_16 ;
F_147 ( V_23 , sizeof( V_23 ) , L_64 , V_16 ) ;
V_2 -> V_23 = F_28 ( V_23 , sizeof( V_23 ) , V_39 ) ;
if ( V_14 -> V_47 && V_14 -> V_47 -> V_212 )
return V_14 -> V_47 -> V_212 ( V_14 , V_2 ) ;
else
return 0 ;
}
static int F_148 ( struct V_34 * V_24 )
{
struct V_13 * V_14 ;
int V_97 , V_16 , V_213 ;
int V_35 = 0 , V_19 = 0 ;
V_97 = sizeof( struct V_1 ) ;
V_24 -> V_214 = F_149 ( V_97 ) ;
V_97 = ( 1 << V_24 -> V_214 ) * V_24 -> V_179 ;
V_24 -> V_215 = F_26 ( V_24 -> V_25 , V_97 , V_39 ) ;
if ( ! V_24 -> V_215 )
return - 1 ;
F_150 (kdev, range) {
if ( V_14 -> V_47 && V_14 -> V_47 -> V_216 )
V_14 -> V_47 -> V_216 ( V_14 ) ;
V_213 = V_35 ;
for ( V_16 = V_14 -> V_17 ;
V_16 < V_14 -> V_17 + V_14 -> V_37 ; V_16 ++ , V_35 ++ ) {
V_19 = F_146 ( V_24 , V_14 ,
F_151 ( V_24 , V_35 ) , V_16 ) ;
if ( V_19 < 0 )
return V_19 ;
}
V_14 -> V_217 =
...
static int F_152 ( struct V_160 * V_161 )
{
struct V_153 * V_125 = V_161 -> V_25 . V_162 ;
struct V_153 * V_184 , * V_180 , * V_154 , * V_192 ;
struct V_155 * V_25 = & V_161 -> V_25 ;
T_3 V_157 [ 2 ] ;
int V_19 ;
if ( ! V_125 ) {
F_77 ( V_25 , L_65 ) ;
...
F_112 ( & V_24 -> V_192 ) ;
F_154 ( & V_161 -> V_25 ) ;
V_19 = F_155 ( & V_161 -> V_25 ) ;
if ( V_19 < 0 ) {
F_77 ( V_25 , L_67 ) ;
return V_19 ;
}
if ( F_110 ( V_125 , L_68 , V_157 , 2 ) ) {
F_77 ( V_25 , L_69 ) ;
V_19 = - V_51 ;
goto V_128;
}
V_24 -> V_36 = V_157 [ 0 ] ;
V_24 -> V_37 = V_157 [ 1 ] ;
V_184 = F_156 ( V_125 , L_70 ) ;
if ( ! V_184 ) {
F_77 ( V_25 , L_71 ) ;
V_19 = - V_51 ;
goto V_128;
}
V_19 = F_132 ( V_24 , V_184 ) ;
F_157 ( V_184 ) ;
if ( V_19 )
goto V_128;
V_192 = F_156 ( V_125 , L_72 ) ;
if ( V_192 ) {
V_19 = F_135 ( V_24 , V_192 ) ;
if ( V_19 )
goto V_128;
V_19 = F_144 ( V_24 ) ;
if ( V_19 )
...
F_157 ( V_192 ) ;
V_180 = F_156 ( V_125 , L_73 ) ;
if ( ! V_180 ) {
F_77 ( V_25 , L_74 ) ;
V_19 = - V_51 ;
goto V_128;
}
V_19 = F_122 ( V_24 , V_180 ) ;
F_157 ( V_180 ) ;
if ( V_19 )
goto V_128;
V_19 = F_113 ( V_24 , L_75 , & V_24 -> V_164 [ 0 ] ) ;
if ( V_19 ) {
F_77 ( V_24 -> V_25 , L_76 ) ;
goto V_128;
}
V_19 = F_113 ( V_24 , L_77 , & V_24 -> V_164 [ 1 ] ) ;
if ( V_19 ) {
}
V_19 = F_116 ( V_24 ) ;
if ( V_19 )
goto V_128;
V_154 = F_156 ( V_125 , L_78 ) ;
if ( ! V_154 ) {
F_77 ( V_25 , L_79 ) ;
goto V_128;
}
V_19 = F_107 ( V_24 , V_154 ) ;
F_157 ( V_154 ) ;
if ( V_19 )
goto V_128;
V_19 = F_148 ( V_24 ) ;
...
F_158 ( L_81 , V_218 | V_219 , NULL , NULL ,
& V_220 ) ;
return 0 ;
V_128:
F_142 ( V_24 ) ;
