...
F_81 ( V_4 ) ;
F_82 ( V_4 , V_165 ) ;
V_9 = F_83 ( F_84 ( V_4 ) , V_164 -> V_173 , V_165 ) ;
if ( V_9 ) {
F_14 ( V_4 ) ;
goto V_172;
}
...
struct V_163 * V_164 , T_10 V_174 , int V_122 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
struct V_3 * V_4 ;
...
F_89 ( V_4 , 0 , V_164 -> V_173 , V_175 ) ;
F_90 ( V_8 , V_4 ) ;
if ( V_6 -> V_11 == V_12 ) {
if ( ( F_91 ( & V_8 -> V_177 ) << 2 ) <= V_8 -> V_178 ) {
F_2 ( 2 , L_42 , V_10 ) ;
V_6 -> V_11 = V_40 ;
F_92 ( V_6 -> V_20 , V_40 ) ;
}
...
return - V_105 ;
V_9 = 0 ;
V_180 = F_94 ( V_8 , V_122 & V_184 , V_174 ) ;
V_181 = F_95 ( V_8 , V_179 ) ;
do {
int V_185 ;
...
if ( V_175 >= V_180 )
break;
F_97 ( F_23 ( V_8 ) , & V_186 , V_187 ) ;
V_9 = F_64 ( V_8 ) ;
if ( V_9 )
;
else if ( V_8 -> V_17 & V_188 )
;
else if ( V_179 )
V_9 = - V_189 ;
else if ( F_98 ( V_190 ) )
...
V_185 = F_102 (unsigned int, skb->len, size) ;
if ( F_103 ( V_164 -> V_173 , V_4 -> V_191 , V_185 ) ) {
F_104 ( & V_8 -> V_32 , V_4 ) ;
if ( V_175 == 0 )
V_175 = - V_192 ;
break;
...
V_6 = F_43 ( V_8 ) ;
if ( V_164 -> V_197 ) {
F_110 ( struct V_98 * , V_111 , V_164 -> V_197 ) ;
V_9 = - V_112 ;
if ( V_164 -> V_198 < sizeof( * V_111 ) )
goto V_107;
...
static int F_112 ( struct V_93 * V_7 , int V_199 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
F_2 ( 1 , L_3 , V_10 , V_6 ) ;
...
static unsigned int F_113 ( struct V_200 * V_200 , struct V_93 * V_7 ,
T_11 * V_186 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
...
static int F_117 ( struct V_93 * V_7 , unsigned int V_209 , unsigned long V_210 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
int V_9 ;
F_2 ( 4 , L_51 , V_10 , V_209 ) ;
V_9 = - V_112 ;
switch ( V_209 ) {
case V_211 : {
long V_212 ;
V_212 = V_8 -> V_213 - F_118 ( V_8 ) ;
if ( V_212 < 0 )
V_212 = 0 ;
V_9 = F_119 ( V_212 , ( unsigned int V_214 * ) V_210 ) ;
break;
}
case V_215 : {
struct V_3 * V_4 ;
...
case V_216 :
if ( V_8 != NULL )
V_9 = F_120 ( V_8 , (struct V_217 V_214 * ) V_210 ) ;
break;
case V_218 :
case V_219 :
case V_220 :
...
static int F_121 ( struct V_93 * V_7 , unsigned int V_209 , unsigned long V_210 )
{
return - V_228 ;
}
static int F_122 ( struct V_93 * V_7 , int V_229 , int V_230 ,
char V_214 * V_231 , unsigned int V_232 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
struct V_233 * V_234 ;
...
switch ( V_230 ) {
case V_242 :
if ( V_232 != sizeof( struct V_233 ) ) {
V_9 = - V_112 ;
goto V_107;
}
V_234 = F_123 ( sizeof( struct V_233 ) , V_243 ) ;
if ( V_234 == NULL ) {
V_9 = - V_69 ;
goto V_107;
}
if ( F_124 ( V_234 , V_231 , V_232 ) ) {
F_41 ( V_234 ) ;
V_9 = - V_192 ;
goto V_107;
}
...
if( V_117 == (struct V_235 * ) NULL ) {
V_117 = F_49 ( V_234 -> V_244 ,
V_119 ) ;
if ( V_117 == NULL ) {
F_41 ( V_234 ) ;
V_9 = - V_69 ;
...
V_117 ,
V_234 -> V_246 ,
V_234 -> V_248 . V_252 . V_254 ,
V_234 -> V_248 . V_252 . V_165 ,
V_250 ) ;
break;
case V_255 :
V_234 -> V_248 . V_256 . string [ V_234 -> V_248 . V_256 . V_165 ] = '\0' ;
F_129 (
V_117 ,
V_234 -> V_246 ,
V_234 -> V_248 . V_256 . string ,
V_250 ) ;
break;
default :
F_41 ( V_234 ) ;
...
V_237 = F_127 ( V_117 ,
V_234 -> V_246 ) ;
if( V_237 == (struct V_236 * ) NULL ) {
F_41 ( V_234 ) ;
V_9 = - V_112 ;
goto V_107;
}
if( V_237 -> V_44 -> V_258 != V_250 ) {
F_2 ( 1 , L_53 , V_10 ) ;
F_41 ( V_234 ) ;
V_9 = - V_129 ;
goto V_107;
...
if ( F_131 ( V_238 , ( int V_214 * ) V_231 ) ) {
V_9 = - V_192 ;
goto V_107;
}
if ( V_8 -> V_26 != V_29 ) {
...
switch ( V_43 -> type ) {
case V_81 :
V_234 -> V_248 . V_249 = V_43 -> V_82 . integer ;
break;
case V_251 :
V_234 -> V_248 . V_252 . V_165 = V_43 -> V_165 ;
memcpy ( V_234 -> V_248 . V_252 . V_254 ,
V_43 -> V_82 . V_262 , V_43 -> V_165 ) ;
break;
case V_255 :
V_234 -> V_248 . V_256 . V_165 = V_43 -> V_165 ;
V_234 -> V_248 . V_256 . V_263 = V_43 -> V_263 ;
memcpy ( V_234 -> V_248 . V_256 . string ,
V_43 -> V_82 . string , V_43 -> V_165 ) ;
V_234 -> V_248 . V_256 . string [ V_43 -> V_165 ] = '\0' ;
break;
case V_264 :
default :
return - V_112 ;
}
V_234 -> V_247 = V_43 -> type ;
return 0 ;
}
static int F_134 ( struct V_93 * V_7 , int V_229 , int V_230 ,
char V_214 * V_231 , int V_214 * V_232 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
struct V_265 V_266 ;
...
switch ( V_230 ) {
case V_271 :
V_269 = sizeof( struct V_265 ) -
sizeof( struct V_267 ) ;
if ( V_165 < V_269 ) {
V_9 = - V_112 ;
goto V_107;
}
V_84 = F_40 ( & V_266 . V_165 , V_6 -> V_89 . V_90 ,
V_6 -> V_91 ) ;
if ( V_84 == NULL ) {
V_9 = - V_189 ;
goto V_107;
}
if ( F_135 ( V_231 , & V_266 , V_269 ) )
V_9 = - V_192 ;
if ( V_266 . V_165 > 2048 ) {
V_9 = - V_112 ;
goto V_272;
}
V_270 = V_269 + ( V_266 . V_165 * sizeof( struct V_267 ) ) ;
if ( V_270 > V_165 )
V_270 = V_165 ;
if ( F_135 ( V_231 + V_269 , V_84 , V_270 - V_269 ) )
V_9 = - V_192 ;
if ( F_119 ( V_270 , V_232 ) )
V_9 = - V_192 ;
V_272:
F_41 ( V_84 ) ;
break;
...
V_268 = V_6 -> V_28 ;
V_165 = sizeof( int ) ;
if ( F_119 ( V_165 , V_232 ) ) {
V_9 = - V_192 ;
goto V_107;
}
if ( F_135 ( V_231 , & V_268 , V_165 ) ) {
V_9 = - V_192 ;
goto V_107;
}
break;
case V_273 :
if ( V_165 != sizeof( struct V_233 ) ) {
V_9 = - V_112 ;
goto V_107;
}
V_234 = F_123 ( sizeof( struct V_233 ) , V_243 ) ;
...
V_9 = F_133 ( V_234 , V_237 -> V_44 ) ;
if( V_9 ) {
F_41 ( V_234 ) ;
goto V_107;
}
if ( F_135 ( V_231 , V_234 ,
sizeof( struct V_233 ) ) ) {
F_41 ( V_234 ) ;
V_9 = - V_192 ;
goto V_107;
...
if ( F_131 ( V_268 , ( int V_214 * ) V_231 ) ) {
V_9 = - V_192 ;
goto V_107;
}
