...
V_58 = F_135 ( V_224 , V_249 , - 1 ) ;
if ( V_58 )
goto V_250;
F_136 ( & V_15 -> V_229 , L_24 ,
V_224 -> V_151 , F_137 ( V_224 ) ) ;
return 0 ;
V_250:
F_138 ( & V_2 -> V_246 ) ;
V_248:
...
void F_141 ( struct V_14 * V_15 , int V_221 )
{
...
struct V_253 * V_191 )
{
if ( V_191 -> V_79 >= F_145 ( V_254 ) )
return - V_21 ;
V_191 -> V_191 = V_254 [ V_191 -> V_79 ] ;
return 0 ;
}
static int F_146 ( struct V_149 * V_19 ,
struct V_251 * V_252 ,
struct V_177 * V_111 )
{
struct V_14 * V_15 = F_147 ( V_19 ) ;
struct V_255 * V_256 = & V_111 -> V_189 ;
if ( V_111 -> V_185 == V_257 ) {
V_256 = F_148 ( V_252 , V_111 -> V_180 ) ;
V_111 -> V_189 = * V_256 ;
return 0 ;
}
F_69 ( & V_15 -> V_122 ) ;
...
if ( V_180 == V_258 ) {
F_99 ( & V_256 -> V_13 , 8 , V_262 ,
F_96 ( V_171 -> V_174 ) - 1 ,
& V_256 -> V_67 , 8 , V_263 , 0 ,
0 ) ;
} else {
struct V_163 * V_164 = & V_15 -> V_165 ;
F_99 ( & V_256 -> V_13 , 8 , V_164 -> V_13 ,
F_96 ( V_171 -> V_174 ) - 1 ,
& V_256 -> V_67 , 8 , V_164 -> V_67 ,
0 , 0 ) ;
}
F_150 ( 1 , V_100 , & V_15 -> V_264 , L_25 , V_256 -> V_13 , V_256 -> V_67 ) ;
}
static int F_151 ( struct V_149 * V_19 ,
struct V_251 * V_252 ,
struct V_177 * V_111 )
{
struct V_14 * V_15 = F_147 ( V_19 ) ;
...
struct V_163 * V_164 = & V_15 -> V_165 ;
int V_152 ;
F_150 ( 1 , V_100 , V_19 , L_26 ,
V_111 -> V_180 , V_256 -> V_191 , V_256 -> V_13 , V_256 -> V_67 ) ;
V_256 -> V_158 = V_159 ;
V_256 -> V_160 = V_161 ;
F_69 ( & V_15 -> V_122 ) ;
if ( F_102 ( & V_15 -> V_2 [ V_261 ] . V_121 ) ||
F_102 ( & V_15 -> V_2 [ V_265 ] . V_121 ) ) {
F_71 ( & V_15 -> V_122 ) ;
return - V_133 ;
}
F_149 ( V_15 , V_256 , V_111 -> V_180 ) ;
if ( V_111 -> V_185 == V_257 ) {
V_256 = F_148 ( V_252 , V_111 -> V_180 ) ;
* V_256 = V_111 -> V_189 ;
F_71 ( & V_15 -> V_122 ) ;
...
V_208 -> V_212 = * F_153 ( V_252 , V_208 -> V_180 ) ;
return 0 ;
}
F_69 ( & V_15 -> V_122 ) ;
if ( V_208 -> V_209 == V_268 ) {
...
return - V_21 ;
F_69 ( & V_15 -> V_122 ) ;
F_154 ( V_15 , & V_208 -> V_212 ) ;
if ( V_208 -> V_185 == V_257 ) {
* F_153 ( V_252 , V_208 -> V_180 ) = V_208 -> V_212 ;
} else {
unsigned long V_44 ;
unsigned int V_152 ;
F_23 ( & V_15 -> V_46 , V_44 ) ;
...
V_58 = F_131 ( & V_19 -> V_182 , V_287 ,
V_15 -> V_181 , 0 ) ;
if ( V_58 )
return V_58 ;
F_133 ( V_275 , 3 ) ;
V_15 -> V_282 = F_159 ( V_275 ,
& V_288 , V_281 ,
F_145 ( V_289 ) - 1 , 0 , 0 ,
V_289 ) ;
if ( V_15 -> V_17 -> V_25 ) {
V_15 -> V_277 = F_160 ( V_275 ,
& V_288 ,
V_276 , V_279 ,
~ 0x981f , V_290 ) ;
V_15 -> V_280 = F_134 ( V_275 ,
& V_288 ,
V_291 , 0 , 0xffff , 1 , 0 ) ;
}
if ( V_275 -> error ) {
