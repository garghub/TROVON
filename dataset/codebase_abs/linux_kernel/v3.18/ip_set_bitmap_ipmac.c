...
static bool
F_34 ( const struct V_21 * V_68 , const struct V_21 * V_69 )
{
const struct V_1 * V_70 = V_68 -> V_44 ;
const struct V_1 * V_71 = V_69 -> V_44 ;
return V_70 -> V_4 == V_71 -> V_4 &&
V_70 -> V_37 == V_71 -> V_37 &&
V_68 -> V_18 == V_69 -> V_18 &&
V_68 -> V_6 == V_69 -> V_6 ;
}
...
T_1 V_4 , T_1 V_37 , T_1 V_72 )
{
V_11 -> V_13 = F_36 ( V_11 -> V_73 ) ;
if ( ! V_11 -> V_13 )
return false ;
if ( V_22 -> V_8 ) {
V_11 -> V_6 = F_36 ( V_22 -> V_8 * V_72 ) ;
if ( ! V_11 -> V_6 ) {
F_37 ( V_11 -> V_13 ) ;
return false ;
}
...
static int
F_38 ( struct V_77 * V_77 , struct V_21 * V_22 , struct V_55 * V_56 [] ,
T_1 V_26 )
{
T_1 V_4 = 0 , V_37 = 0 ;
T_5 V_72 ;
...
if ( V_72 > V_83 + 1 )
return - V_84 ;
V_11 = F_41 ( sizeof( * V_11 ) , V_85 ) ;
if ( ! V_11 )
return - V_86 ;
V_11 -> V_73 = F_42 ( 0 , V_72 - 1 ) ;
V_22 -> V_46 = & V_1 ;
V_22 -> V_8 = F_43 ( V_22 , V_56 ,
sizeof( struct V_5 ) ) ;
if ( ! F_35 ( V_22 , V_11 , V_4 , V_37 , V_72 ) ) {
F_37 ( V_11 ) ;
return - V_86 ;
}
if ( V_56 [ V_60 ] ) {
