...
int V_154 , V_165 ;
struct V_166 * V_167 ;
V_154 = F_62 ( V_163 , sizeof( * V_167 ) , V_168 , V_169 ) ;
if ( V_154 < 0 )
goto V_170;
memset ( V_100 , 0 , sizeof( * V_100 ) ) ;
V_167 = F_63 ( V_163 ) ;
...
V_100 -> V_102 . V_181 = F_64 ( V_42 ) . V_181 ;
...
switch ( V_95 ( V_164 ) ) {
case V_183 :
V_100 -> V_112 = F_66 ( V_164 ) ;
break;
case V_184 :
V_100 -> V_131 = F_67 ( V_164 ) ;
break;
case V_185 :
V_100 -> V_139 = F_66 ( V_164 ) ;
break;
case V_186 :
V_100 -> V_119 = F_67 ( V_164 ) ;
break;
case V_187 :
V_100 -> V_136 = F_66 ( V_164 ) ;
break;
case V_188 :
...
break;
case V_192 :
V_100 -> V_193 = F_67 ( V_164 ) ;
break;
case V_194 :
V_100 -> V_159 = F_67 ( V_164 ) ;
break;
}
}
return 0 ;
...
static int F_68 ( struct V_41 * V_42 , struct V_162 * V_163 )
{
struct V_1 * V_1 = F_69 ( V_42 -> V_195 ) ;
struct V_99 V_100 ;
struct V_2 * V_15 ;
int V_154 ;
V_154 = F_61 ( V_1 , V_42 , V_163 , & V_100 ) ;
if ( V_154 < 0 )
goto V_170;
V_15 = F_6 ( V_1 , V_100 . V_159 ) ;
if ( V_15 == NULL ) {
...
static int F_70 ( struct V_41 * V_42 , struct V_162 * V_163 )
{
struct V_1 * V_1 = F_69 ( V_42 -> V_195 ) ;
struct V_99 V_100 ;
struct V_2 * V_15 ;
...
static int F_71 ( struct V_41 * V_42 , struct V_196 * V_197 )
{
struct V_1 * V_1 = F_69 ( V_42 -> V_195 ) ;
...
struct V_22 * V_23 ;
int V_201 = 0 ;
if ( F_72 ( V_197 -> V_163 ) >= sizeof( struct V_166 ) &&
( (struct V_166 * ) F_63 ( V_197 -> V_163 ) ) -> V_179 & V_202 )
return V_42 -> V_92 ;
V_198 = V_197 -> args [ 0 ] ;
V_200 = V_197 -> args [ 1 ] ;
...
static void F_74 ( int V_97 , int type , T_3 V_64 , int V_205 , struct V_132 * V_133 )
{
...
V_210 = F_76 ( V_44 , V_212 , V_109 ) ;
if ( V_210 == NULL ) {
F_77 ( L_1 , V_216 ) ;
return;
}
}
F_74 ( V_209 , V_73 , V_28 , 32 , V_210 ) ;
if ( ! ( V_27 -> V_217 & V_218 ) )
return;
if ( V_133 -> V_219 && V_133 -> V_219 != F_78 ( 0xFFFFFFFF ) )
F_74 ( V_209 , V_35 , V_133 -> V_219 , 32 , V_210 ) ;
if ( ! F_15 ( V_212 ) && ! ( V_133 -> V_214 & V_215 ) &&
( V_212 != V_28 || V_133 -> V_220 < 32 ) ) {
F_74 ( V_209 ,
V_27 -> V_217 & V_221 ? V_73 : V_37 ,
V_212 , V_133 -> V_220 , V_210 ) ;
if ( V_133 -> V_220 < 31 ) {
F_74 ( V_209 , V_35 , V_212 , 32 , V_210 ) ;
F_74 ( V_209 , V_35 , V_212 | ~ V_109 ,
32 , V_210 ) ;
}
}
}
void F_79 ( struct V_132 * V_133 , struct V_132 * V_222 )
{
struct V_43 * V_44 = V_133 -> V_206 ;
struct V_26 * V_27 = V_44 -> V_27 ;
struct V_132 * V_223 ;
...
int V_230 = 0 ;
if ( V_133 -> V_214 & V_215 ) {
V_210 = F_76 ( V_44 , V_226 , V_133 -> V_211 ) ;
if ( V_210 == NULL ) {
F_77 ( L_1 , V_216 ) ;
return;
}
...
if ( ! ( V_227 & F_81 ) )
F_74 ( V_231 , V_35 , V_133 -> V_219 , 32 , V_210 ) ;
if ( V_228 && V_133 -> V_220 < 31 ) {
if ( ! ( V_227 & F_83 ) )
F_74 ( V_231 , V_35 , V_225 , 32 , V_210 ) ;
if ( ! ( V_227 & F_82 ) )
F_74 ( V_231 , V_35 , V_226 , 32 , V_210 ) ;
}
if ( ! ( V_227 & F_80 ) ) {
F_74 ( V_231 , V_73 , V_133 -> V_137 , 32 , V_210 ) ;
if ( V_229 &&
F_19 ( F_26 ( V_27 ) , V_133 -> V_137 ) != V_73 ) {
if ( F_85 ( F_26 ( V_27 ) , V_133 -> V_137 ) )
F_10 ( F_26 ( V_27 ) ) ;
}
}
#undef F_80
...
static void F_86 ( struct V_234 * V_235 , struct V_2 * V_15 )
{
struct V_32 V_33 ;
struct V_29 V_30 = {
. V_60 = V_235 -> V_236 ,
...
V_235 -> V_154 = F_18 ( V_15 , & V_30 , & V_33 , V_38 ) ;
if ( ! V_235 -> V_154 ) {
V_235 -> V_241 = V_33 . V_241 ;
...
V_1 = F_69 ( V_42 -> V_195 ) ;
V_163 = F_90 ( V_42 ) ;
if ( V_42 -> V_92 < V_243 || V_42 -> V_92 < V_163 -> F_72 ||
F_72 ( V_163 ) < sizeof( * V_235 ) )
return;
V_42 = F_91 ( V_42 , V_144 ) ;
if ( V_42 == NULL )
return;
V_163 = F_90 ( V_42 ) ;
V_235 = (struct V_234 * ) F_63 ( V_163 ) ;
V_15 = F_6 ( V_1 , V_235 -> V_244 ) ;
F_86 ( V_235 , V_15 ) ;
V_181 = F_64 ( V_42 ) . V_181 ;
F_64 ( V_42 ) . V_181 = 0 ;
F_64 ( V_42 ) . V_245 = 0 ;
F_92 ( V_1 -> V_10 . V_246 , V_42 , V_181 , V_247 ) ;
}
static int T_1 F_93 ( struct V_1 * V_1 )
{
struct V_248 * V_195 ;
struct V_249 V_100 = {
. V_250 = F_89 ,
} ;
V_195 = F_94 ( V_1 , V_251 , & V_100 ) ;
if ( V_195 == NULL )
return - V_107 ;
...
static void F_97 ( struct V_26 * V_27 , int V_252 )
{
if ( F_98 ( V_27 , V_252 ) )
F_10 ( F_26 ( V_27 ) ) ;
F_13 ( F_26 ( V_27 ) ) ;
...
static int F_100 ( struct V_253 * V_254 , unsigned long V_255 , void * V_256 )
{
...
static int F_103 ( struct V_253 * V_254 , unsigned long V_255 , void * V_256 )
{
struct V_26 * V_27 = F_104 ( V_256 ) ;
struct V_43 * V_44 ;
struct V_1 * V_1 = F_26 ( V_27 ) ;
if ( V_255 == V_261 ) {
F_97 ( V_27 , 2 ) ;
...
static int T_1 F_108 ( struct V_1 * V_1 )
{
int V_154 ;
T_6 V_264 = sizeof( struct V_22 ) * V_21 ;
V_264 = F_109 ( T_6 , V_264 , V_265 ) ;
...
void T_8 F_121 ( void )
{
F_122 ( V_271 , V_209 , F_70 , NULL , NULL ) ;
F_122 ( V_271 , V_231 , F_68 , NULL , NULL ) ;
F_122 ( V_271 , V_272 , NULL , F_71 , NULL ) ;
F_123 ( & V_273 ) ;
F_124 ( & V_274 ) ;
F_125 ( & V_275 ) ;
F_126 () ;
