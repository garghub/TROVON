...
V_107:
if ( type -> V_109 )
type -> V_109 ( & V_69 . V_98 ) ;
error:
F_31 ( L_24 , V_3 ) ;
return V_3 ;
}
int F_59 ( struct V_3 * V_3 , bool V_110 )
{
int V_29 ;
...
if ( V_29 )
return - V_113 ;
if ( F_29 ( V_114 , & V_3 -> V_45 ) ) {
F_61 () ;
return V_3 -> V_115 . V_116 ;
}
return F_30 ( V_3 ) ;
}
