...
V_5 -> V_12 . V_15 , V_5 -> V_12 . V_14 ,
V_5 -> V_12 . V_13 ) ;
F_30 ( L_7 , V_5 -> V_38 -> V_32 ,
V_2 -> V_42 ) ;
F_30 ( L_8 , V_5 -> V_38 -> V_30 ) ;
F_30 ( L_9 , V_5 -> V_38 -> V_43 ) ;
F_30 ( L_10 , F_12 ( V_2 -> V_20 ) ) ;
F_30 ( L_11 , V_2 -> V_17 ) ;
for ( V_53 = 0 ; V_5 -> V_73 [ V_53 ] != ~ 0 ; V_53 += 2 ) {
T_1 V_37 = V_5 -> V_73 [ V_53 ] ;
T_1 V_74 = V_5 -> V_73 [ V_53 + 1 ] ;
...
void F_32 ( struct V_1 * V_2 , T_1 V_77 )
{
if ( F_24 ( F_31 ( V_2 ) >= V_77 ) )
F_25 ( L_13 , V_2 -> V_17 ) ;
}
int F_33 ( struct V_39 * V_78 , struct V_79 * V_80 ,
...
V_19 = F_36 ( & V_5 -> V_92 , V_5 -> V_7 -> V_93 , V_78 -> V_24 ) ;
if ( V_19 ) {
F_6 ( V_78 -> V_24 , L_15 ,
V_5 -> V_7 -> V_93 , V_19 ) ;
return V_19 ;
}
V_19 = F_36 ( & V_5 -> V_94 , V_5 -> V_7 -> V_95 , V_78 -> V_24 ) ;
if ( V_19 ) {
F_6 ( V_78 -> V_24 , L_16 ,
V_5 -> V_7 -> V_95 , V_19 ) ;
return V_19 ;
...
F_39 ( & V_78 -> V_99 ) ;
V_5 -> V_100 = F_40 ( V_78 , sizeof( * V_5 -> V_38 ) ,
V_101 ) ;
F_41 ( & V_78 -> V_99 ) ;
if ( F_42 ( V_5 -> V_100 ) ) {
V_19 = F_43 ( V_5 -> V_100 ) ;
...
void F_45 ( struct V_5 * V_2 )
{
if ( V_2 -> V_100 ) {
if ( V_2 -> V_103 )
F_46 ( V_2 -> V_100 , V_2 -> V_85 . V_22 ) ;
F_47 ( V_2 -> V_100 ) ;
}
if ( V_2 -> V_92 )
F_48 ( V_2 -> V_92 ) ;
