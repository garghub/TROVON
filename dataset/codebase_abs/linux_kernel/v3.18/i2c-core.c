...
if ( V_33 < 0 )
return V_33 ;
V_33 = F_77 ( & V_44 -> V_39 , true ) ;
if ( V_33 != - V_120 ) {
V_33 = V_91 -> V_117 ( V_44 , F_48 ( V_91 -> V_92 ,
V_44 ) ) ;
if ( V_33 )
F_78 ( & V_44 -> V_39 , true ) ;
}
...
static void F_81 ( struct V_87 * V_39 )
{
struct V_43 * V_44 = F_50 ( V_39 ) ;
struct V_90 * V_91 ;
if ( ! V_44 || ! V_39 -> V_91 )
...
static int F_82 ( struct V_87 * V_39 , T_7 V_122 )
{
struct V_43 * V_44 = F_50 ( V_39 ) ;
struct V_90 * V_91 ;
if ( ! V_44 || ! V_39 -> V_91 )
...
static void F_96 ( struct V_87 * V_39 )
{
F_26 ( F_55 ( V_39 ) ) ;
}
static T_8
F_97 ( struct V_87 * V_39 , struct V_130 * V_131 , char * V_53 )
{
return sprintf ( V_53 , L_17 , V_39 -> type == & V_132 ?
F_55 ( V_39 ) -> V_86 : F_98 ( V_39 ) -> V_86 ) ;
}
static T_8
...
static int F_101 ( const struct V_43 * V_44 )
{
if ( V_44 -> V_16 & V_17 ) {
if ( V_44 -> V_12 > 0x3ff )
return - V_134 ;
...
static int F_102 ( unsigned short V_12 )
{
if ( V_12 < 0x08 || V_12 > 0x77 )
return - V_134 ;
return 0 ;
}
static int F_103 ( struct V_87 * V_39 , void * V_135 )
{
struct V_43 * V_44 = F_50 ( V_39 ) ;
int V_12 = * ( int * ) V_135 ;
...
static int F_104 ( struct V_25 * V_26 , int V_12 )
{
struct V_25 * V_41 = F_105 ( V_26 ) ;
int V_136 ;
V_136 = F_106 ( & V_26 -> V_39 , & V_12 ,
F_103 ) ;
if ( ! V_136 && V_41 )
V_136 = F_104 ( V_41 , V_12 ) ;
return V_136 ;
}
static int F_107 ( struct V_87 * V_39 , void * V_135 )
{
int V_136 ;
if ( V_39 -> type == & V_137 )
V_136 = F_106 ( V_39 , V_135 ,
F_107 ) ;
else
V_136 = F_103 ( V_39 , V_135 ) ;
return V_136 ;
}
static int F_108 ( struct V_25 * V_26 , int V_12 )
{
struct V_25 * V_41 = F_105 ( V_26 ) ;
int V_136 = 0 ;
if ( V_41 )
...
static void F_115 ( struct V_25 * V_40 ,
struct V_43 * V_44 )
{
struct V_29 * V_30 = F_116 ( & V_44 -> V_39 ) ;
if ( V_30 ) {
F_117 ( & V_44 -> V_39 , L_19 , F_118 ( V_30 ) ) ;
return;
}
F_117 ( & V_44 -> V_39 , L_20 , F_119 ( V_40 ) ,
...
F_120 ( & V_44 -> V_39 , V_6 -> V_35 . V_36 ) ;
F_115 ( V_40 , V_44 ) ;
V_33 = F_121 ( & V_44 -> V_39 ) ;
if ( V_33 )
goto V_142;
F_58 ( & V_40 -> V_39 , L_22 ,
...
static int F_125 ( struct V_43 * V_44 )
{
return 0 ;
}
struct V_43 * F_126 ( struct V_25 * V_26 , T_9 V_145 )
{
struct V_5 V_6 = {
F_127 ( L_25 , V_145 ) ,
} ;
...
static void F_128 ( struct V_87 * V_39 )
{
struct V_25 * V_40 = F_98 ( V_39 ) ;
F_129 ( & V_40 -> V_146 ) ;
}
static inline unsigned int F_130 ( struct V_25 * V_26 )
{
unsigned int V_147 = 0 ;
while ( ( V_26 = F_105 ( V_26 ) ) )
V_147 ++ ;
return V_147 ;
}
static T_8
F_131 ( struct V_87 * V_39 , struct V_130 * V_131 ,
...
return - V_134 ;
F_132 ( & V_40 -> V_153 ) ;
F_133 ( & V_44 -> V_154 , & V_40 -> V_155 ) ;
F_134 ( & V_40 -> V_153 ) ;
F_135 ( V_39 , L_32 , L_27 ,
V_6 . type , V_6 . V_12 ) ;
return V_148 ;
}
static T_8
F_136 ( struct V_87 * V_39 , struct V_130 * V_131 ,
const char * V_53 , T_10 V_148 )
{
struct V_25 * V_40 = F_98 ( V_39 ) ;
...
F_137 ( & V_40 -> V_153 ,
F_130 ( V_40 ) ) ;
F_138 (client, next, &adap->userspace_clients,
detected) {
if ( V_44 -> V_12 == V_12 ) {
F_135 ( V_39 , L_34 ,
...
struct V_25 * F_140 ( struct V_87 * V_39 )
{
...
struct V_158 * V_159 ;
F_142 ( & V_160 ) ;
F_143 (devinfo, &__i2c_board_list, list) {
...
static void F_145 ( struct V_25 * V_40 )
{
void * V_136 ;
struct V_164 * V_165 ;
if ( ! V_40 -> V_39 . V_119 )
...
const T_11 * V_12 ;
int V_52 ;
F_58 ( & V_40 -> V_39 , L_38 , V_165 -> V_168 ) ;
if ( F_147 ( V_165 , V_6 . type , sizeof( V_6 . type ) ) < 0 ) {
F_16 ( & V_40 -> V_39 , L_39 ,
V_165 -> V_168 ) ;
continue;
}
V_12 = F_148 ( V_165 , L_40 , & V_52 ) ;
...
V_6 . V_18 = F_150 ( V_165 , 0 ) ;
V_6 . V_119 = F_151 ( V_165 ) ;
V_6 . V_140 = & V_167 ;
if ( F_148 ( V_165 , L_43 , NULL ) )
V_6 . V_16 |= V_118 ;
F_152 ( L_44 , V_96 , V_6 . type ) ;
V_136 = F_15 ( V_40 , & V_6 ) ;
if ( V_136 == NULL ) {
F_16 ( & V_40 -> V_39 , L_45 ,
V_165 -> V_168 ) ;
...
struct V_43 * F_155 ( struct V_164 * V_165 )
{
struct V_87 * V_39 ;
V_39 = F_156 ( & V_144 , NULL , V_165 ,
F_154 ) ;
if ( ! V_39 )
return NULL ;
return F_50 ( V_39 ) ;
}
struct V_25 * F_157 ( struct V_164 * V_165 )
{
struct V_87 * V_39 ;
V_39 = F_156 ( & V_144 , NULL , V_165 ,
F_154 ) ;
...
static int F_160 ( struct V_88 * V_170 , void * V_4 )
{
return F_158 ( F_53 ( V_170 ) , V_4 ) ;
}
static int F_161 ( struct V_25 * V_40 )
{
int V_151 = 0 ;
if ( F_162 ( F_163 ( ! V_144 . V_171 ) ) ) {
V_151 = - V_172 ;
goto V_173;
}
...
if ( V_40 -> V_175 == 0 )
V_40 -> V_175 = V_176 ;
F_117 ( & V_40 -> V_39 , L_53 , V_40 -> V_162 ) ;
V_40 -> V_39 . V_143 = & V_144 ;
V_40 -> V_39 . type = & V_137 ;
V_151 = F_121 ( & V_40 -> V_39 ) ;
if ( V_151 )
goto V_173;
F_58 ( & V_40 -> V_39 , L_54 , V_40 -> V_86 ) ;
#ifdef F_167
V_151 = F_168 ( V_177 , & V_40 -> V_39 ,
V_40 -> V_39 . V_41 ) ;
if ( V_151 )
F_21 ( & V_40 -> V_39 ,
L_55 ) ;
...
F_141 ( V_40 ) ;
F_132 ( & V_180 ) ;
F_170 ( & V_144 , NULL , V_40 , F_160 ) ;
F_134 ( & V_180 ) ;
return 0 ;
V_173:
F_132 ( & V_180 ) ;
F_171 ( & V_181 , V_40 -> V_162 ) ;
F_134 ( & V_180 ) ;
return V_151 ;
}
...
int V_85 ;
F_132 ( & V_180 ) ;
V_85 = F_173 ( & V_181 , V_40 , V_40 -> V_162 , V_40 -> V_162 + 1 ,
V_50 ) ;
F_134 ( & V_180 ) ;
if ( V_85 < 0 )
...
F_138 (client, _n, &driver->clients, detected) {
if ( V_44 -> V_26 == V_26 ) {
F_58 ( & V_26 -> V_39 , L_60 ,
V_44 -> V_86 , V_44 -> V_12 ) ;
F_139 ( & V_44 -> V_154 ) ;
...
static int F_178 ( struct V_87 * V_39 , void * V_184 )
{
struct V_43 * V_44 = F_50 ( V_39 ) ;
...
static int F_179 ( struct V_87 * V_39 , void * V_184 )
{
struct V_43 * V_44 = F_50 ( V_39 ) ;
if ( V_44 )
F_122 ( V_44 ) ;
...
static int F_180 ( struct V_88 * V_170 , void * V_4 )
{
F_177 ( F_53 ( V_170 ) , V_4 ) ;
return 0 ;
}
...
F_134 ( & V_40 -> V_153 ) ;
F_106 ( & V_40 -> V_39 , NULL , F_178 ) ;
F_106 ( & V_40 -> V_39 , NULL , F_179 ) ;
#ifdef F_167
F_184 ( V_177 , & V_40 -> V_39 ,
V_40 -> V_39 . V_41 ) ;
#endif
...
int V_151 ;
F_132 ( & V_180 ) ;
V_151 = F_189 ( & V_144 , NULL , V_4 , F_188 ) ;
F_134 ( & V_180 ) ;
return V_151 ;
}
...
if ( V_39 -> type != & V_137 )
return 0 ;
return F_158 ( V_4 , F_98 ( V_39 ) ) ;
}
int F_191 ( struct V_186 * V_187 , struct V_90 * V_91 )
{
int V_151 ;
if ( F_162 ( F_163 ( ! V_144 . V_171 ) ) )
return - V_172 ;
...
static int F_201 ( struct V_87 * V_39 , void * V_189 )
{
struct V_43 * V_44 = F_50 ( V_39 ) ;
...
void F_202 ( struct V_25 * V_40 , unsigned int V_45 , void * V_191 )
{
struct V_190 V_192 ;
V_192 . V_45 = V_45 ;
V_192 . V_191 = V_191 ;
F_106 ( & V_40 -> V_39 , & V_192 , F_201 ) ;
}
...
int F_211 ( struct V_25 * V_40 , struct V_47 * V_48 , int V_197 )
{
unsigned long V_198 ;
int V_31 , V_199 ;
if ( F_212 ( & V_1 ) ) {
int V_107 ;
for ( V_107 = 0 ; V_107 < V_197 ; V_107 ++ )
...
V_198 = V_200 ;
for ( V_31 = 0 , V_199 = 0 ; V_199 <= V_40 -> V_201 ; V_199 ++ ) {
V_31 = V_40 -> V_174 -> V_202 ( V_40 , V_48 , V_197 ) ;
if ( V_31 != - V_172 )
break;
if ( F_215 ( V_200 , V_198 + V_40 -> V_175 ) )
break;
}
if ( F_212 ( & V_1 ) ) {
int V_107 ;
...
int F_24 ( struct V_25 * V_40 , struct V_47 * V_48 , int V_197 )
{
int V_31 ;
if ( V_40 -> V_174 -> V_202 ) {
#ifdef F_218
...
( V_48 [ V_31 ] . V_16 & V_203 ) ? L_71 : L_72 ) ;
}
#endif
if ( F_219 () || F_220 () ) {
V_31 = F_111 ( V_40 ) ;
...
int F_221 ( const struct V_43 * V_44 , const char * V_53 , int V_148 )
{
int V_31 ;
struct V_25 * V_40 = V_44 -> V_26 ;
struct V_47 V_204 ;
V_204 . V_12 = V_44 -> V_12 ;
V_204 . V_16 = V_44 -> V_16 & V_205 ;
V_204 . V_52 = V_148 ;
V_204 . V_53 = ( char * ) V_53 ;
V_31 = F_24 ( V_40 , & V_204 , 1 ) ;
return ( V_31 == 1 ) ? V_148 : V_31 ;
}
int F_222 ( const struct V_43 * V_44 , char * V_53 , int V_148 )
{
struct V_25 * V_40 = V_44 -> V_26 ;
struct V_47 V_204 ;
int V_31 ;
...
union V_206 V_184 ;
#ifdef F_224
if ( V_12 == 0x73 && ( V_40 -> V_207 & V_208 )
&& F_225 ( V_40 , V_209 ) )
V_71 = F_226 ( V_40 , V_12 , 0 , V_210 , 0 ,
V_211 , & V_184 ) ;
else
#endif
if ( ! ( ( V_12 & ~ 0x07 ) == 0x30 || ( V_12 & ~ 0x0f ) == 0x50 )
&& F_225 ( V_40 , V_212 ) )
V_71 = F_226 ( V_40 , V_12 , 0 , V_213 , 0 ,
V_214 , NULL ) ;
else if ( F_225 ( V_40 , V_215 ) )
V_71 = F_226 ( V_40 , V_12 , 0 , V_210 , 0 ,
V_216 , & V_184 ) ;
else {
F_21 ( & V_40 -> V_39 , L_74 ,
...
static int F_227 ( struct V_43 * V_217 ,
struct V_90 * V_91 )
{
struct V_5 V_6 ;
struct V_25 * V_26 = V_217 -> V_26 ;
int V_12 = V_217 -> V_12 ;
int V_71 ;
V_71 = F_102 ( V_12 ) ;
if ( V_71 ) {
...
{
const unsigned short * V_220 ;
struct V_43 * V_217 ;
int V_107 , V_71 = 0 ;
int V_221 = F_119 ( V_26 ) ;
V_220 = V_91 -> V_220 ;
if ( ! V_91 -> V_218 || ! V_220 )
return 0 ;
if ( V_26 -> V_207 == V_219 ) {
...
if ( ! ( V_26 -> V_207 & V_91 -> V_207 ) )
return 0 ;
V_217 = F_23 ( sizeof( struct V_43 ) , V_50 ) ;
if ( ! V_217 )
return - V_82 ;
V_217 -> V_26 = V_26 ;
for ( V_107 = 0 ; V_220 [ V_107 ] != V_222 ; V_107 += 1 ) {
F_58 ( & V_26 -> V_39 , L_86
L_87 , V_221 , V_220 [ V_107 ] ) ;
V_217 -> V_12 = V_220 [ V_107 ] ;
V_71 = F_227 ( V_217 , V_91 ) ;
if ( F_162 ( V_71 ) )
break;
}
F_26 ( V_217 ) ;
...
{
return F_226 ( V_40 , V_12 , 0 , V_210 , 0 ,
V_214 , NULL ) >= 0 ;
}
struct V_43 *
F_229 ( struct V_25 * V_40 ,
struct V_5 * V_6 ,
unsigned short const * V_223 ,
int (* V_117)( struct V_25 * , unsigned short V_12 ) )
{
int V_107 ;
if ( ! V_117 )
V_117 = F_223 ;
for ( V_107 = 0 ; V_223 [ V_107 ] != V_222 ; V_107 ++ ) {
if ( F_102 ( V_223 [ V_107 ] ) < 0 ) {
F_21 ( & V_40 -> V_39 , L_88
L_89 , V_223 [ V_107 ] ) ;
continue;
}
if ( F_108 ( V_40 , V_223 [ V_107 ] ) ) {
F_58 ( & V_40 -> V_39 , L_90
L_91 , V_223 [ V_107 ] ) ;
continue;
}
if ( V_117 ( V_40 , V_223 [ V_107 ] ) )
break;
}
if ( V_223 [ V_107 ] == V_222 ) {
F_58 ( & V_40 -> V_39 , L_92 ) ;
return NULL ;
}
V_6 -> V_12 = V_223 [ V_107 ] ;
return F_15 ( V_40 , V_6 ) ;
}
struct V_25 * F_230 ( int V_162 )
{
struct V_25 * V_26 ;
F_132 ( & V_180 ) ;
V_26 = F_182 ( & V_181 , V_162 ) ;
if ( V_26 && ! F_231 ( V_26 -> V_187 ) )
V_26 = NULL ;
F_134 ( & V_180 ) ;
return V_26 ;
}
...
static T_4 F_235 ( T_4 V_225 , T_4 * V_171 , T_10 V_148 )
{
int V_107 ;
for ( V_107 = 0 ; V_107 < V_148 ; V_107 ++ )
V_225 = F_234 ( ( V_225 ^ V_171 [ V_107 ] ) << 8 ) ;
return V_225 ;
}
static T_4 F_236 ( T_4 V_226 , struct V_47 * V_204 )
{
T_4 V_12 = ( V_204 -> V_12 << 1 ) | ! ! ( V_204 -> V_16 & V_54 ) ;
V_226 = F_235 ( V_226 , & V_12 , 1 ) ;
return F_235 ( V_226 , V_204 -> V_53 , V_204 -> V_52 ) ;
}
static inline void F_237 ( struct V_47 * V_204 )
{
V_204 -> V_53 [ V_204 -> V_52 ] = F_236 ( 0 , V_204 ) ;
V_204 -> V_52 ++ ;
}
static int F_238 ( T_4 V_227 , struct V_47 * V_204 )
{
T_4 V_228 = V_204 -> V_53 [ -- V_204 -> V_52 ] ;
V_227 = F_236 ( V_227 , V_204 ) ;
if ( V_228 != V_227 ) {
F_183 ( L_93 ,
V_228 , V_227 ) ;
return - V_229 ;
...
V_210 , 0 ,
V_216 , & V_4 ) ;
return ( V_33 < 0 ) ? V_33 : V_4 . V_230 ;
}
T_14 F_31 ( const struct V_43 * V_44 , T_4 V_231 )
{
return F_226 ( V_44 -> V_26 , V_44 -> V_12 , V_44 -> V_16 ,
V_213 , V_231 , V_216 , NULL ) ;
}
...
if ( V_33 )
return V_33 ;
memcpy ( V_234 , & V_4 . V_236 [ 1 ] , V_4 . V_236 [ 0 ] ) ;
return V_4 . V_236 [ 0 ] ;
}
T_14 F_37 ( const struct V_43 * V_44 , T_4 V_56 ,
T_4 V_69 , const T_4 * V_234 )
{
union V_206 V_4 ;
if ( V_69 > V_237 )
V_69 = V_237 ;
V_4 . V_236 [ 0 ] = V_69 ;
memcpy ( & V_4 . V_236 [ 1 ] , V_234 , V_69 ) ;
return F_226 ( V_44 -> V_26 , V_44 -> V_12 , V_44 -> V_16 ,
V_213 , V_56 ,
V_235 , & V_4 ) ;
}
...
unsigned short V_16 ,
char V_239 , T_4 V_56 , int V_240 ,
union V_206 * V_4 )
{
unsigned char V_241 [ V_237 + 3 ] ;
unsigned char V_242 [ V_237 + 2 ] ;
int V_197 = V_239 == V_210 ? 2 : 1 ;
int V_107 ;
T_4 V_243 = 0 ;
int V_33 ;
struct V_47 V_204 [ 2 ] = {
...
case V_214 :
V_204 [ 0 ] . V_52 = 0 ;
V_204 [ 0 ] . V_16 = V_16 | ( V_239 == V_210 ?
V_54 : 0 ) ;
V_197 = 1 ;
break;
case V_216 :
if ( V_239 == V_210 ) {
V_204 [ 0 ] . V_16 = V_54 | V_16 ;
V_197 = 1 ;
}
break;
case V_211 :
...
V_204 [ 0 ] . V_52 = V_4 -> V_236 [ 0 ] + 2 ;
if ( V_204 [ 0 ] . V_52 > V_237 + 2 ) {
F_16 ( & V_26 -> V_39 ,
L_94 ,
V_4 -> V_236 [ 0 ] ) ;
return - V_134 ;
}
for ( V_107 = 1 ; V_107 < V_204 [ 0 ] . V_52 ; V_107 ++ )
V_241 [ V_107 ] = V_4 -> V_236 [ V_107 - 1 ] ;
}
break;
case V_245 :
V_197 = 2 ;
V_239 = V_210 ;
if ( V_4 -> V_236 [ 0 ] > V_237 ) {
F_16 ( & V_26 -> V_39 ,
L_94 ,
V_4 -> V_236 [ 0 ] ) ;
return - V_134 ;
...
case V_238 :
if ( V_239 == V_210 ) {
V_204 [ 1 ] . V_52 = V_4 -> V_236 [ 0 ] ;
} else {
V_204 [ 0 ] . V_52 = V_4 -> V_236 [ 0 ] + 1 ;
if ( V_204 [ 0 ] . V_52 > V_237 + 1 ) {
F_16 ( & V_26 -> V_39 ,
L_94 ,
V_4 -> V_236 [ 0 ] ) ;
return - V_134 ;
}
for ( V_107 = 1 ; V_107 <= V_4 -> V_236 [ 0 ] ; V_107 ++ )
V_241 [ V_107 ] = V_4 -> V_236 [ V_107 ] ;
}
break;
default:
F_16 ( & V_26 -> V_39 , L_95 , V_240 ) ;
return - V_115 ;
}
V_107 = ( ( V_16 & V_246 ) && V_240 != V_214
&& V_240 != V_238 ) ;
if ( V_107 ) {
if ( ! ( V_204 [ 0 ] . V_16 & V_54 ) ) {
if ( V_197 == 1 )
F_237 ( & V_204 [ 0 ] ) ;
else
V_243 = F_236 ( 0 , & V_204 [ 0 ] ) ;
}
if ( V_204 [ V_197 - 1 ] . V_16 & V_54 )
V_204 [ V_197 - 1 ] . V_52 ++ ;
}
V_33 = F_24 ( V_26 , V_204 , V_197 ) ;
if ( V_33 < 0 )
return V_33 ;
if ( V_107 && ( V_204 [ V_197 - 1 ] . V_16 & V_54 ) ) {
V_33 = F_238 ( V_243 , & V_204 [ V_197 - 1 ] ) ;
if ( V_33 < 0 )
return V_33 ;
}
if ( V_239 == V_210 )
...
case V_232 :
case V_244 :
V_4 -> V_233 = V_242 [ 0 ] | ( V_242 [ 1 ] << 8 ) ;
break;
case V_238 :
for ( V_107 = 0 ; V_107 < V_4 -> V_236 [ 0 ] ; V_107 ++ )
V_4 -> V_236 [ V_107 + 1 ] = V_242 [ V_107 ] ;
break;
case V_235 :
case V_245 :
for ( V_107 = 0 ; V_107 < V_242 [ 0 ] + 1 ; V_107 ++ )
V_4 -> V_236 [ V_107 ] = V_242 [ V_107 ] ;
break;
}
return 0 ;
}
T_14 F_226 ( struct V_25 * V_26 , T_9 V_12 , unsigned short V_16 ,
char V_239 , T_4 V_56 , int V_247 ,
union V_206 * V_4 )
{
unsigned long V_198 ;
int V_199 ;
T_14 V_151 ;
F_242 ( V_26 , V_12 , V_16 , V_239 ,
V_56 , V_247 , V_4 ) ;
F_243 ( V_26 , V_12 , V_16 , V_239 ,
V_56 , V_247 ) ;
V_16 &= V_205 | V_246 | V_248 ;
if ( V_26 -> V_174 -> V_249 ) {
F_109 ( V_26 ) ;
V_198 = V_200 ;
for ( V_151 = 0 , V_199 = 0 ; V_199 <= V_26 -> V_201 ; V_199 ++ ) {
V_151 = V_26 -> V_174 -> V_249 ( V_26 , V_12 , V_16 ,
V_239 , V_56 ,
V_247 , V_4 ) ;
if ( V_151 != - V_172 )
break;
...
F_113 ( V_26 ) ;
if ( V_151 != - V_115 || ! V_26 -> V_174 -> V_202 )
goto V_250;
}
V_151 = F_241 ( V_26 , V_12 , V_16 , V_239 ,
V_56 , V_247 , V_4 ) ;
V_250:
F_244 ( V_26 , V_12 , V_16 , V_239 ,
V_56 , V_247 , V_4 ) ;
F_245 ( V_26 , V_12 , V_16 , V_239 ,
V_56 , V_247 , V_151 ) ;
return V_151 ;
}
