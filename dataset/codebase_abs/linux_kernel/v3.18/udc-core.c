...
struct V_31 * V_32 )
{
return V_2 -> V_35 -> V_36 ( V_2 , V_32 ) ;
}
static inline void F_22 ( struct V_1 * V_2 ,
struct V_31 * V_32 )
{
V_2 -> V_35 -> V_37 ( V_2 , V_32 ) ;
}
...
V_41 = V_32 -> V_64 ( V_25 -> V_2 , V_32 ) ;
if ( V_41 )
goto V_44;
V_41 = F_21 ( V_25 -> V_2 , V_32 ) ;
if ( V_41 ) {
V_32 -> V_61 ( V_25 -> V_2 ) ;
goto V_44;
}
...
int F_53 ( const char * V_58 , struct V_31 * V_32 )
{
struct V_24 * V_25 = NULL ;
int V_41 = - V_66 ;
F_14 ( & V_26 ) ;
F_15 (udc, &udc_list, list) {
V_41 = strcmp ( V_58 , F_26 ( & V_25 -> V_9 ) ) ;
if ( ! V_41 )
break;
}
if ( V_41 ) {
...
if ( F_58 ( V_16 , L_16 ) ) {
F_21 ( V_25 -> V_2 , V_25 -> V_32 ) ;
F_52 ( V_25 -> V_2 ) ;
} else if ( F_58 ( V_16 , L_17 ) ) {
F_47 ( V_25 -> V_2 ) ;
F_22 ( V_25 -> V_2 , V_25 -> V_32 ) ;
} else {
F_3 ( V_9 , L_18 , V_16 ) ;
return - V_70 ;
}
...
struct V_24 * V_25 = F_24 ( V_9 , struct V_24 , V_9 ) ;
int V_41 ;
V_41 = F_64 ( V_76 , L_19 , V_25 -> V_2 -> V_58 ) ;
if ( V_41 ) {
F_3 ( V_9 , L_20 ) ;
return V_41 ;
}
