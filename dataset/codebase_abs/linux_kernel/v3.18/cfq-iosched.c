...
static void
F_115 ( struct V_1 * V_90 , struct V_2 * V_3 )
{
...
V_3 -> V_84 = F_116 ( unsigned , V_147 , 1 ) ;
}
static void
F_117 ( struct V_47 * V_48 , struct V_2 * V_3 )
{
...
static void
F_119 ( struct V_1 * V_90 , struct V_2 * V_3 )
{
struct V_2 * V_148 = V_3 ;
bool V_149 ;
V_149 = ! -- V_148 -> V_150 ;
...
static void
F_121 ( struct V_47 * V_48 , struct V_2 * V_3 )
{
struct V_1 * V_90 = & V_48 -> V_152 ;
F_25 ( V_3 -> V_137 < 1 ) ;
V_3 -> V_137 -- ;
...
static inline unsigned int F_123 ( struct V_51 * V_52 ,
unsigned int * V_32 )
{
unsigned int V_155 ;
if ( ! V_52 -> V_109 || V_52 -> V_109 == V_110 ) {
V_155 = F_116 ( unsigned , ( V_110 - V_52 -> V_156 ) ,
1 ) ;
} else {
...
if ( F_124 ( V_52 -> V_109 , V_52 -> V_156 ) )
* V_32 += V_52 -> V_109 -
V_52 -> V_156 ;
}
return V_155 ;
}
static void F_125 ( struct V_47 * V_48 , struct V_2 * V_3 ,
struct V_51 * V_52 )
{
struct V_1 * V_90 = & V_48 -> V_152 ;
...
static void F_132 ( struct V_12 * V_27 )
{
F_49 ( F_28 ( V_27 ) ) ;
}
static T_2 F_133 ( struct V_10 * V_11 , int V_175 )
{
T_2 V_176 = 0 ;
V_176 += F_134 ( V_11 , V_175 ) ;
V_176 += F_134 ( V_11 , V_175 + V_177 ) ;
return V_176 ;
}
static struct V_178 F_135 ( struct V_10 * V_11 ,
int V_175 )
{
struct V_178 V_179 , V_180 ;
V_179 = F_136 ( V_11 , V_175 ) ;
V_180 = F_136 ( V_11 , V_175 + V_177 ) ;
F_47 ( & V_179 , & V_180 ) ;
return V_179 ;
}
static void F_137 ( struct V_12 * V_27 )
{
struct V_2 * V_3 = F_28 ( V_27 ) ;
F_43 ( & V_3 -> V_14 ) ;
F_43 ( & V_3 -> V_46 ) ;
}
static struct V_2 * F_138 ( struct V_47 * V_48 ,
struct V_172 * V_172 )
{
...
struct V_12 * V_27 ;
V_27 = F_139 ( V_172 , V_44 ) ;
if ( ! F_140 ( V_27 ) )
V_3 = F_28 ( V_27 ) ;
}
return V_3 ;
}
static void F_141 ( struct V_51 * V_52 , struct V_2 * V_3 )
{
if ( ! F_57 ( V_52 ) )
V_3 = V_52 -> V_48 -> V_183 ;
V_52 -> V_3 = V_3 ;
...
static T_2 F_142 ( struct V_184 * V_185 ,
struct V_10 * V_11 , int V_175 )
{
struct V_2 * V_3 = F_2 ( V_11 ) ;
if ( ! V_3 -> V_186 )
return 0 ;
return F_143 ( V_185 , V_11 , V_3 -> V_186 ) ;
}
static int F_144 ( struct V_184 * V_185 , void * V_187 )
{
F_145 ( V_185 , F_146 ( F_147 ( V_185 ) ) ,
F_142 , & V_28 ,
0 , false ) ;
return 0 ;
}
static T_2 F_148 ( struct V_184 * V_185 ,
struct V_10 * V_11 , int V_175 )
{
struct V_2 * V_3 = F_2 ( V_11 ) ;
if ( ! V_3 -> V_188 )
return 0 ;
return F_143 ( V_185 , V_11 , V_3 -> V_188 ) ;
}
...
static int F_150 ( struct V_184 * V_185 , void * V_187 )
{
F_151 ( V_185 , L_6 , F_146 ( F_147 ( V_185 ) ) -> V_173 ) ;
return 0 ;
}
static int F_152 ( struct V_184 * V_185 , void * V_187 )
{
F_151 ( V_185 , L_6 , F_146 ( F_147 ( V_185 ) ) -> V_174 ) ;
return 0 ;
}
static T_5 F_153 ( struct V_189 * V_190 ,
char * V_191 , T_6 V_192 , T_7 V_175 ,
bool V_193 )
{
struct V_172 * V_172 = F_146 ( F_154 ( V_190 ) ) ;
struct V_194 V_195 ;
struct V_2 * V_3 ;
int V_196 ;
V_196 = F_155 ( V_172 , & V_28 , V_191 , & V_195 ) ;
if ( V_196 )
return V_196 ;
V_196 = - V_197 ;
V_3 = F_28 ( V_195 . V_27 ) ;
...
char * V_191 , T_6 V_192 , T_7 V_175 )
{
return F_153 ( V_190 , V_191 , V_192 , V_175 , false ) ;
}
static T_5 F_158 ( struct V_189 * V_190 ,
char * V_191 , T_6 V_192 , T_7 V_175 )
{
return F_153 ( V_190 , V_191 , V_192 , V_175 , true ) ;
}
static int F_159 ( struct V_200 * V_201 , struct V_202 * V_203 ,
T_2 V_204 , bool V_193 )
{
struct V_172 * V_172 = F_146 ( V_201 ) ;
struct V_12 * V_27 ;
...
V_172 -> V_174 = V_204 ;
F_161 (blkg, &blkcg->blkg_list, blkcg_node) {
struct V_2 * V_3 = F_28 ( V_27 ) ;
if ( ! V_3 )
continue;
if ( ! V_193 ) {
...
static int F_163 ( struct V_200 * V_201 , struct V_202 * V_203 ,
T_2 V_204 )
{
return F_159 ( V_201 , V_203 , V_204 , false ) ;
}
static int F_164 ( struct V_200 * V_201 ,
struct V_202 * V_203 , T_2 V_204 )
{
return F_159 ( V_201 , V_203 , V_204 , true ) ;
}
static int F_165 ( struct V_184 * V_185 , void * V_187 )
{
F_145 ( V_185 , F_146 ( F_147 ( V_185 ) ) , V_206 ,
& V_28 , F_166 ( V_185 ) -> V_207 , false ) ;
return 0 ;
}
static int F_167 ( struct V_184 * V_185 , void * V_187 )
{
F_145 ( V_185 , F_146 ( F_147 ( V_185 ) ) , V_208 ,
& V_28 , F_166 ( V_185 ) -> V_207 , true ) ;
return 0 ;
}
static T_2 F_168 ( struct V_184 * V_185 ,
struct V_10 * V_11 , int V_175 )
{
T_2 V_176 = F_133 ( V_11 , V_175 ) ;
return F_143 ( V_185 , V_11 , V_176 ) ;
}
static T_2 F_169 ( struct V_184 * V_185 ,
struct V_10 * V_11 , int V_175 )
{
struct V_178 V_176 = F_135 ( V_11 , V_175 ) ;
return F_170 ( V_185 , V_11 , & V_176 ) ;
}
static int F_171 ( struct V_184 * V_185 , void * V_187 )
{
F_145 ( V_185 , F_146 ( F_147 ( V_185 ) ) ,
F_168 , & V_28 ,
F_166 ( V_185 ) -> V_207 , false ) ;
return 0 ;
}
static int F_172 ( struct V_184 * V_185 , void * V_187 )
{
F_145 ( V_185 , F_146 ( F_147 ( V_185 ) ) ,
F_169 , & V_28 ,
F_166 ( V_185 ) -> V_207 , true ) ;
return 0 ;
}
static T_2 F_173 ( struct V_184 * V_185 ,
struct V_10 * V_11 , int V_175 )
{
struct V_2 * V_3 = F_2 ( V_11 ) ;
T_2 V_209 = F_174 ( & V_3 -> V_14 . V_26 ) ;
T_2 V_187 = 0 ;
if ( V_209 ) {
V_187 = F_174 ( & V_3 -> V_14 . V_25 ) ;
V_187 = F_175 ( V_187 , V_209 ) ;
}
F_143 ( V_185 , V_11 , V_187 ) ;
return 0 ;
}
static int F_176 ( struct V_184 * V_185 , void * V_187 )
{
F_145 ( V_185 , F_146 ( F_147 ( V_185 ) ) ,
F_173 , & V_28 ,
0 , false ) ;
...
static inline void
F_141 ( struct V_51 * V_52 , struct V_2 * V_3 ) {
V_52 -> V_3 = V_3 ;
}
...
static struct V_51 *
F_178 ( struct V_47 * V_48 , struct V_131 * V_127 ,
...
static void F_184 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
F_86 ( V_48 , V_52 , L_8 ) ;
F_25 ( ! F_181 ( V_52 ) ) ;
F_185 ( V_52 ) ;
...
static void F_186 ( struct V_113 * V_227 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
const int V_76 = F_93 ( V_227 ) ;
F_25 ( ! V_52 -> V_22 [ V_76 ] ) ;
V_52 -> V_22 [ V_76 ] -- ;
F_188 ( & V_52 -> V_136 , V_227 ) ;
if ( F_181 ( V_52 ) && F_189 ( & V_52 -> V_136 ) ) {
if ( V_52 -> V_223 ) {
F_100 ( & V_52 -> V_221 , V_52 -> V_223 ) ;
V_52 -> V_223 = NULL ;
}
...
static void F_190 ( struct V_113 * V_227 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
struct V_47 * V_48 = V_52 -> V_48 ;
struct V_113 * V_135 ;
V_52 -> V_22 [ F_93 ( V_227 ) ] ++ ;
F_191 ( & V_52 -> V_136 , V_227 ) ;
if ( ! F_181 ( V_52 ) )
F_182 ( V_48 , V_52 ) ;
V_135 = V_52 -> V_222 ;
...
static void F_192 ( struct V_51 * V_52 , struct V_113 * V_227 )
{
F_188 ( & V_52 -> V_136 , V_227 ) ;
V_52 -> V_22 [ F_93 ( V_227 ) ] -- ;
F_39 ( F_193 ( V_227 ) , V_227 -> V_123 ) ;
F_190 ( V_227 ) ;
F_35 ( F_193 ( V_227 ) , V_52 -> V_48 -> V_229 ,
V_227 -> V_123 ) ;
}
static struct V_113 *
F_194 ( struct V_47 * V_48 , struct V_70 * V_70 )
{
...
if ( V_52 )
return F_195 ( & V_52 -> V_136 , F_196 ( V_70 ) ) ;
return NULL ;
}
static void F_197 ( struct V_181 * V_44 , struct V_113 * V_227 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
V_48 -> V_233 ++ ;
F_86 ( V_48 , F_187 ( V_227 ) , L_9 ,
V_48 -> V_233 ) ;
V_48 -> V_228 = F_94 ( V_227 ) + F_198 ( V_227 ) ;
}
static void F_199 ( struct V_181 * V_44 , struct V_113 * V_227 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
F_73 ( ! V_48 -> V_233 ) ;
V_48 -> V_233 -- ;
F_86 ( V_48 , F_187 ( V_227 ) , L_10 ,
V_48 -> V_233 ) ;
}
static void F_200 ( struct V_113 * V_227 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
if ( V_52 -> V_222 == V_227 )
...
static int F_202 ( struct V_181 * V_44 , struct V_113 * * V_237 ,
struct V_70 * V_70 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_113 * V_238 ;
V_238 = F_194 ( V_48 , V_70 ) ;
if ( V_238 && F_203 ( V_238 , V_70 ) ) {
* V_237 = V_238 ;
return V_239 ;
}
return V_240 ;
...
{
if ( type == V_239 ) {
struct V_51 * V_52 = F_187 ( V_237 ) ;
F_192 ( V_52 , V_237 ) ;
}
}
static void F_205 ( struct V_181 * V_44 , struct V_113 * V_237 ,
struct V_70 * V_70 )
{
F_40 ( F_193 ( V_237 ) , V_70 -> V_72 ) ;
}
static void
F_206 ( struct V_181 * V_44 , struct V_113 * V_227 ,
struct V_113 * V_134 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
if ( ! F_207 ( & V_227 -> V_234 ) && ! F_207 ( & V_134 -> V_234 ) &&
F_89 ( V_134 -> V_241 , V_227 -> V_241 ) &&
V_52 == F_187 ( V_134 ) ) {
F_208 ( & V_227 -> V_234 , & V_134 -> V_234 ) ;
V_227 -> V_241 = V_134 -> V_241 ;
}
if ( V_52 -> V_222 == V_134 )
V_52 -> V_222 = V_227 ;
F_200 ( V_134 ) ;
F_40 ( F_193 ( V_227 ) , V_134 -> V_123 ) ;
V_52 = F_187 ( V_134 ) ;
if ( F_181 ( V_52 ) && F_189 ( & V_52 -> V_136 ) &&
V_52 != V_48 -> V_242 )
F_184 ( V_48 , V_52 ) ;
}
static int F_209 ( struct V_181 * V_44 , struct V_113 * V_227 ,
struct V_70 * V_70 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_60 * V_66 ;
...
return false ;
V_52 = F_64 ( V_66 , F_67 ( V_70 ) ) ;
return V_52 == F_187 ( V_227 ) ;
}
static inline void F_210 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
F_211 ( & V_48 -> V_243 ) ;
F_21 ( V_52 -> V_3 ) ;
}
static void F_212 ( struct V_47 * V_48 ,
struct V_51 * V_52 )
{
if ( V_52 ) {
F_86 ( V_48 , V_52 , L_11 ,
...
static void
F_218 ( struct V_47 * V_48 , struct V_51 * V_52 ,
bool V_244 )
{
...
V_48 -> V_242 = NULL ;
if ( V_48 -> V_245 ) {
F_224 ( V_48 -> V_245 -> V_62 . V_64 ) ;
V_48 -> V_245 = NULL ;
}
}
static inline void F_225 ( struct V_47 * V_48 , bool V_244 )
{
struct V_51 * V_52 = V_48 -> V_242 ;
if ( V_52 )
F_218 ( V_48 , V_52 , V_244 ) ;
}
...
static struct V_51 * F_229 ( struct V_47 * V_48 ,
struct V_51 * V_52 )
{
if ( ! V_52 )
V_52 = F_226 ( V_48 ) ;
...
static inline T_4 F_230 ( struct V_47 * V_48 ,
struct V_113 * V_227 )
{
...
static inline int F_231 ( struct V_47 * V_48 , struct V_51 * V_52 ,
struct V_113 * V_227 )
{
return F_230 ( V_48 , V_227 ) <= V_246 ;
}
...
if ( F_189 ( V_127 ) )
return NULL ;
V_212 = F_178 ( V_48 , V_127 , V_218 , & V_30 , NULL ) ;
if ( V_212 )
return V_212 ;
V_212 = F_97 ( V_30 , struct V_51 , V_221 ) ;
if ( F_231 ( V_48 , V_247 , V_212 -> V_222 ) )
return V_212 ;
...
static struct V_51 * F_233 ( struct V_47 * V_48 ,
struct V_51 * V_247 )
{
struct V_51 * V_52 ;
if ( F_54 ( V_247 ) )
...
static bool F_234 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
...
return false ;
if ( F_58 ( V_52 ) &&
! ( F_235 ( V_48 -> V_65 ) && V_48 -> V_50 ) )
return true ;
if ( V_90 -> V_59 == 1 && F_57 ( V_52 ) &&
! F_236 ( V_48 , & V_90 -> V_170 , false ) )
return true ;
F_86 ( V_48 , V_52 , L_14 , V_90 -> V_59 ) ;
return false ;
}
static void F_237 ( struct V_47 * V_48 )
{
struct V_51 * V_52 = V_48 -> V_242 ;
struct V_60 * V_66 ;
unsigned long V_248 , V_249 = 0 ;
if ( F_235 ( V_48 -> V_65 ) && V_48 -> V_50 )
return;
F_73 ( ! F_189 ( & V_52 -> V_136 ) ) ;
F_73 ( F_88 ( V_52 ) ) ;
if ( ! F_234 ( V_48 , V_52 ) ) {
if ( V_48 -> V_250 )
V_249 = V_48 -> V_250 ;
...
return;
V_66 = V_48 -> V_245 ;
if ( ! V_66 || ! F_238 ( & V_66 -> V_62 . V_64 -> V_252 ) )
return;
if ( F_239 ( V_66 -> V_170 . V_253 ) &&
...
V_248 = V_48 -> V_49 ;
F_241 ( & V_48 -> V_243 , V_110 + V_248 ) ;
F_24 ( V_52 -> V_3 ) ;
F_86 ( V_48 , V_52 , L_16 , V_248 ,
V_249 ? 1 : 0 ) ;
}
static void F_242 ( struct V_181 * V_44 , struct V_113 * V_227 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_51 * V_52 = F_187 ( V_227 ) ;
F_86 ( V_48 , V_52 , L_17 ) ;
...
V_52 -> V_166 += F_198 ( V_227 ) ;
F_41 ( V_52 -> V_3 , F_244 ( V_227 ) , V_227 -> V_123 ) ;
}
static struct V_113 * F_245 ( struct V_51 * V_52 )
{
...
static inline int
F_249 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
const int V_257 = V_48 -> V_258 ;
F_73 ( V_52 -> V_82 >= V_80 ) ;
return 2 * V_257 * ( V_80 - V_52 -> V_82 ) ;
}
static int F_250 ( struct V_51 * V_52 )
{
int V_259 , V_260 ;
...
static void F_251 ( struct V_51 * V_52 , struct V_51 * V_214 )
{
int V_259 , V_264 ;
struct V_51 * V_212 ;
if ( ! F_250 ( V_214 ) )
...
static enum V_6 F_252 ( struct V_47 * V_48 ,
...
static void
F_253 ( struct V_47 * V_48 , struct V_2 * V_3 )
{
unsigned V_101 ;
unsigned V_59 ;
struct V_1 * V_90 ;
...
V_59 = V_90 -> V_59 ;
if ( V_59 && ! F_124 ( V_110 , V_48 -> V_161 ) )
return;
V_269:
V_48 -> V_163 = F_252 ( V_48 , V_3 ,
V_48 -> V_165 ) ;
V_90 = F_1 ( V_3 , V_48 -> V_165 , V_48 -> V_163 ) ;
V_59 = V_90 -> V_59 ;
V_106 = F_83 ( V_48 , V_3 ) ;
V_101 = V_106 * V_59 /
F_116 ( unsigned , V_3 -> V_99 [ V_48 -> V_165 ] ,
...
static void F_255 ( struct V_47 * V_48 )
{
struct V_2 * V_3 = F_228 ( V_48 ) ;
V_48 -> V_229 = V_3 ;
if ( V_3 -> V_154 ) {
...
static struct V_51 * F_256 ( struct V_47 * V_48 )
{
...
if ( ! V_48 -> V_235 )
return NULL ;
if ( F_257 ( V_52 ) && ! F_189 ( & V_52 -> V_136 ) )
goto V_273;
if ( F_87 ( V_52 ) && ! F_258 ( V_52 ) ) {
if ( V_52 -> V_3 -> V_137 == 1 && F_189 ( & V_52 -> V_136 )
&& V_52 -> V_251 && F_234 ( V_48 , V_52 ) ) {
V_52 = NULL ;
goto V_274;
} else
goto V_275;
...
if ( F_222 ( V_52 ) && F_58 ( V_52 ) &&
( F_88 ( V_52 ) ||
( V_52 -> V_111 - V_110 > V_110 - V_52 -> V_109 ) ) ) {
F_260 ( V_52 ) ;
F_261 ( V_52 ) ;
}
if ( V_52 -> V_251 && F_234 ( V_48 , V_52 ) ) {
V_52 = NULL ;
goto V_274;
}
V_275:
...
V_52 -> V_3 -> V_251 &&
! F_236 ( V_48 , & V_52 -> V_3 -> V_170 , true ) ) {
V_52 = NULL ;
goto V_274;
}
V_273:
...
if ( ! V_214 )
F_255 ( V_48 ) ;
V_52 = F_229 ( V_48 , V_214 ) ;
V_274:
return V_52 ;
}
static int F_262 ( struct V_51 * V_52 )
{
int V_251 = 0 ;
while ( V_52 -> V_222 ) {
F_242 ( V_52 -> V_48 -> V_65 , V_52 -> V_222 ) ;
V_251 ++ ;
}
F_25 ( ! F_207 ( & V_52 -> V_256 ) ) ;
F_218 ( V_52 -> V_48 , V_52 , 0 ) ;
return V_251 ;
}
static int F_263 ( struct V_47 * V_48 )
{
struct V_51 * V_52 ;
int V_251 = 0 ;
F_225 ( V_48 , 0 ) ;
while ( ( V_52 = F_227 ( V_48 ) ) != NULL ) {
F_212 ( V_48 , V_52 ) ;
V_251 += F_262 ( V_52 ) ;
}
F_25 ( V_48 -> V_74 ) ;
...
static inline bool F_264 ( struct V_47 * V_48 ,
struct V_51 * V_52 )
{
if ( F_88 ( V_52 ) )
return true ;
if ( F_124 ( V_110 + V_48 -> V_49 * V_52 -> V_251 ,
V_52 -> V_111 ) )
return true ;
return false ;
}
...
{
unsigned int V_276 ;
if ( F_234 ( V_48 , V_52 ) && V_48 -> V_255 [ V_277 ] )
return false ;
if ( V_48 -> V_255 [ V_278 ] && ! F_57 ( V_52 ) )
return false ;
V_276 = F_116 (unsigned int, cfqd->cfq_quantum / 2 , 1 ) ;
if ( F_54 ( V_52 ) )
V_276 = 1 ;
if ( V_52 -> V_251 >= V_276 ) {
bool V_279 = false ;
...
V_279 = true ;
if ( V_48 -> V_74 > 1 && F_264 ( V_48 , V_52 ) &&
! V_279 )
return false ;
...
static bool F_266 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
struct V_113 * V_227 ;
F_25 ( F_189 ( & V_52 -> V_136 ) ) ;
if ( ! F_265 ( V_48 , V_52 ) )
return false ;
V_227 = F_245 ( V_52 ) ;
if ( ! V_227 )
V_227 = V_52 -> V_222 ;
F_242 ( V_48 -> V_65 , V_227 ) ;
if ( ! V_48 -> V_245 ) {
struct V_60 * V_66 = F_267 ( V_227 ) ;
F_268 ( & V_66 -> V_62 . V_64 -> V_284 ) ;
V_48 -> V_245 = V_66 ;
}
return true ;
}
static int F_269 ( struct V_181 * V_44 , int V_285 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_51 * V_52 ;
if ( ! V_48 -> V_74 )
...
static void F_274 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
...
static void F_276 ( struct V_61 * V_62 )
{
struct V_60 * V_66 = F_61 ( V_62 ) ;
struct V_47 * V_48 = F_66 ( V_66 ) ;
if ( V_66 -> V_52 [ V_277 ] ) {
F_274 ( V_48 , V_66 -> V_52 [ V_277 ] ) ;
V_66 -> V_52 [ V_277 ] = NULL ;
}
if ( V_66 -> V_52 [ V_278 ] ) {
F_274 ( V_48 , V_66 -> V_52 [ V_278 ] ) ;
V_66 -> V_52 [ V_278 ] = NULL ;
}
}
static void F_277 ( struct V_51 * V_52 , struct V_60 * V_66 )
{
struct V_230 * V_231 = V_232 ;
int V_287 ;
if ( ! F_278 ( V_52 ) )
return;
V_287 = F_279 ( V_66 -> V_82 ) ;
switch ( V_287 ) {
default:
F_280 ( V_288 L_24 , V_287 ) ;
case V_289 :
V_52 -> V_82 = F_281 ( V_231 ) ;
V_52 -> V_287 = F_282 ( V_231 ) ;
break;
case V_290 :
V_52 -> V_82 = F_283 ( V_66 -> V_82 ) ;
V_52 -> V_287 = V_290 ;
break;
case V_291 :
V_52 -> V_82 = F_283 ( V_66 -> V_82 ) ;
...
static void F_285 ( struct V_60 * V_66 , struct V_70 * V_70 )
{
int V_82 = V_66 -> V_62 . V_64 -> V_82 ;
struct V_47 * V_48 = F_66 ( V_66 ) ;
struct V_51 * V_52 ;
if ( F_51 ( ! V_48 ) || F_286 ( V_66 -> V_82 == V_82 ) )
return;
V_52 = V_66 -> V_52 [ V_277 ] ;
if ( V_52 ) {
struct V_51 * V_214 ;
V_214 = F_287 ( V_48 , V_277 , V_66 , V_70 ,
V_293 ) ;
if ( V_214 ) {
...
static void F_289 ( struct V_47 * V_48 , struct V_51 * V_52 ,
T_8 V_294 , bool V_67 )
{
F_101 ( & V_52 -> V_129 ) ;
F_101 ( & V_52 -> V_221 ) ;
...
static void F_293 ( struct V_60 * V_66 , struct V_70 * V_70 )
{
struct V_47 * V_48 = F_66 ( V_66 ) ;
struct V_51 * V_295 ;
T_1 V_296 ;
F_294 () ;
V_296 = F_295 ( V_70 ) -> V_201 . V_296 ;
F_296 () ;
if ( F_51 ( ! V_48 ) || F_286 ( V_66 -> V_297 == V_296 ) )
return;
V_295 = F_64 ( V_66 , 1 ) ;
if ( V_295 ) {
...
static inline void F_293 ( struct V_60 * V_66 , struct V_70 * V_70 ) { }
static struct V_51 *
F_297 ( struct V_47 * V_48 , bool V_67 , struct V_60 * V_66 ,
...
if ( V_52 ) {
F_289 ( V_48 , V_52 , V_232 -> V_294 , V_67 ) ;
F_277 ( V_52 , V_66 ) ;
F_141 ( V_52 , V_3 ) ;
F_86 ( V_48 , V_52 , L_26 ) ;
} else
...
static struct V_51 * *
F_299 ( struct V_47 * V_48 , int V_287 , int V_82 )
{
switch ( V_287 ) {
case V_290 :
...
static struct V_51 *
F_287 ( struct V_47 * V_48 , bool V_67 , struct V_60 * V_66 ,
struct V_70 * V_70 , T_9 V_298 )
{
const int V_287 = F_279 ( V_66 -> V_82 ) ;
const int V_82 = F_283 ( V_66 -> V_82 ) ;
struct V_51 * * V_303 = NULL ;
struct V_51 * V_52 = NULL ;
if ( ! V_67 ) {
V_303 = F_299 ( V_48 , V_287 , V_82 ) ;
V_52 = * V_303 ;
}
if ( ! V_52 )
V_52 = F_297 ( V_48 , V_67 , V_66 , V_70 , V_298 ) ;
if ( ! V_67 && ! ( * V_303 ) ) {
V_52 -> V_263 ++ ;
* V_303 = V_52 ;
}
...
static void
F_301 ( struct V_306 * V_170 , unsigned long V_307 )
{
...
{
if ( F_57 ( V_52 ) ) {
F_301 ( & V_66 -> V_170 , V_48 -> V_49 ) ;
F_301 ( & V_52 -> V_217 -> V_170 ,
V_48 -> V_49 ) ;
}
#ifdef F_303
F_301 ( & V_52 -> V_3 -> V_170 , V_48 -> V_250 ) ;
#endif
}
static void
...
static void
F_305 ( struct V_47 * V_48 , struct V_51 * V_52 ,
struct V_60 * V_66 )
{
int V_316 , V_317 ;
...
V_317 = 0 ;
else if ( ! F_238 ( & V_66 -> V_62 . V_64 -> V_252 ) ||
! V_48 -> V_49 ||
( ! F_307 ( V_52 ) && F_222 ( V_52 ) ) )
V_317 = 0 ;
else if ( F_239 ( V_66 -> V_170 . V_253 ) ) {
...
static bool
F_308 ( struct V_47 * V_48 , struct V_51 * V_214 ,
struct V_113 * V_227 )
{
struct V_51 * V_52 ;
V_52 = V_48 -> V_242 ;
...
return true ;
if ( F_189 ( & V_52 -> V_136 ) && ! F_234 ( V_48 , V_52 ) )
return true ;
if ( ! V_48 -> V_245 || ! F_219 ( V_52 ) )
return false ;
if ( F_231 ( V_48 , V_52 , V_227 ) )
return true ;
return false ;
}
static void F_309 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
...
static void
F_310 ( struct V_47 * V_48 , struct V_51 * V_52 ,
struct V_113 * V_227 )
{
struct V_60 * V_66 = F_267 ( V_227 ) ;
V_48 -> V_235 ++ ;
if ( V_227 -> V_123 & V_124 )
V_52 -> V_236 ++ ;
F_302 ( V_48 , V_52 , V_66 ) ;
F_304 ( V_48 , V_52 , V_227 ) ;
F_305 ( V_48 , V_52 , V_66 ) ;
V_52 -> V_312 = F_94 ( V_227 ) + F_198 ( V_227 ) ;
if ( V_52 == V_48 -> V_242 ) {
if ( F_219 ( V_52 ) ) {
if ( F_244 ( V_227 ) > V_320 ||
V_48 -> V_74 > 1 ) {
F_210 ( V_48 , V_52 ) ;
F_213 ( V_52 ) ;
F_311 ( V_48 -> V_65 ) ;
...
} else if ( F_308 ( V_48 , V_52 , V_227 ) ) {
F_309 ( V_48 , V_52 ) ;
F_311 ( V_48 -> V_65 ) ;
}
}
static void F_313 ( struct V_181 * V_44 , struct V_113 * V_227 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_51 * V_52 = F_187 ( V_227 ) ;
F_86 ( V_48 , V_52 , L_29 ) ;
F_277 ( V_52 , F_267 ( V_227 ) ) ;
V_227 -> V_241 = V_110 + V_48 -> V_321 [ F_93 ( V_227 ) ] ;
F_314 ( & V_227 -> V_234 , & V_52 -> V_256 ) ;
F_190 ( V_227 ) ;
F_35 ( F_193 ( V_227 ) , V_48 -> V_229 ,
V_227 -> V_123 ) ;
F_310 ( V_48 , V_52 , V_227 ) ;
}
static void F_315 ( struct V_47 * V_48 )
{
struct V_51 * V_52 = V_48 -> V_242 ;
...
static bool F_316 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
...
if ( V_52 -> V_3 -> V_137 > 1 )
return false ;
if ( F_236 ( V_48 , & V_52 -> V_3 -> V_170 , true ) )
return false ;
if ( F_87 ( V_52 ) )
return true ;
if ( V_66 && F_239 ( V_66 -> V_170 . V_253 )
&& ( V_52 -> V_111 - V_110 < V_66 -> V_170 . V_254 ) )
return true ;
...
static void F_317 ( struct V_181 * V_44 , struct V_113 * V_227 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
struct V_47 * V_48 = V_52 -> V_48 ;
const int V_76 = F_93 ( V_227 ) ;
...
V_52 -> V_251 -- ;
( F_193 ( V_227 ) ) -> V_251 -- ;
F_42 ( V_52 -> V_3 , F_318 ( V_227 ) ,
F_319 ( V_227 ) , V_227 -> V_123 ) ;
V_48 -> V_255 [ F_57 ( V_52 ) ] -- ;
if ( V_76 ) {
struct V_1 * V_90 ;
F_267 ( V_227 ) -> V_170 . V_171 = V_15 ;
if ( F_181 ( V_52 ) )
V_90 = V_52 -> V_217 ;
else
...
if ( ! F_124 ( V_227 -> V_38 + V_48 -> V_321 [ 1 ] , V_15 ) )
V_48 -> V_282 = V_15 ;
}
#ifdef F_303
...
#endif
if ( V_48 -> V_242 == V_52 ) {
const bool V_325 = F_189 ( & V_52 -> V_136 ) ;
if ( F_88 ( V_52 ) ) {
F_85 ( V_48 , V_52 ) ;
F_320 ( V_52 ) ;
}
...
static inline int F_322 ( struct V_51 * V_52 )
{
if ( F_219 ( V_52 ) && ! F_323 ( V_52 ) ) {
F_324 ( V_52 ) ;
return V_327 ;
}
return V_328 ;
}
static int F_325 ( struct V_181 * V_44 , int V_31 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
struct V_230 * V_231 = V_232 ;
struct V_60 * V_66 ;
...
static void F_327 ( struct V_113 * V_227 )
{
struct V_51 * V_52 = F_187 ( V_227 ) ;
if ( V_52 ) {
const int V_31 = F_328 ( V_227 ) ;
...
static struct V_51 *
F_329 ( struct V_47 * V_48 , struct V_60 * V_66 ,
struct V_51 * V_52 )
{
...
static struct V_51 *
F_331 ( struct V_60 * V_66 , struct V_51 * V_52 )
{
if ( F_250 ( V_52 ) == 1 ) {
...
static int
F_334 ( struct V_181 * V_44 , struct V_113 * V_227 , struct V_70 * V_70 ,
T_9 V_298 )
{
struct V_47 * V_48 = V_44 -> V_68 -> V_69 ;
...
V_52 = F_64 ( V_66 , V_67 ) ;
if ( ! V_52 || V_52 == & V_48 -> V_300 ) {
V_52 = F_287 ( V_48 , V_67 , V_66 , V_70 , V_298 ) ;
F_65 ( V_66 , V_52 , V_67 ) ;
} else {
if ( F_221 ( V_52 ) && F_336 ( V_52 ) ) {
F_86 ( V_48 , V_52 , L_33 ) ;
V_52 = F_331 ( V_66 , V_52 ) ;
if ( ! V_52 )
goto V_272;
}
if ( V_52 -> V_214 )
V_52 = F_329 ( V_48 , V_66 , V_52 ) ;
}
V_52 -> V_261 [ V_31 ] ++ ;
V_52 -> V_263 ++ ;
F_31 ( V_52 -> V_3 ) ;
...
static void F_337 ( struct V_331 * V_332 )
{
struct V_47 * V_48 =
...
static void F_338 ( unsigned long V_333 )
{
...
F_69 ( V_48 ) ;
V_336:
F_340 ( V_48 -> V_65 -> V_45 , V_334 ) ;
}
static void F_341 ( struct V_47 * V_48 )
{
F_342 ( & V_48 -> V_243 ) ;
F_343 ( & V_48 -> V_75 ) ;
}
static void F_344 ( struct V_47 * V_48 )
{
int V_167 ;
for ( V_167 = 0 ; V_167 < V_80 ; V_167 ++ ) {
if ( V_48 -> V_303 [ 0 ] [ V_167 ] )
F_270 ( V_48 -> V_303 [ 0 ] [ V_167 ] ) ;
if ( V_48 -> V_303 [ 1 ] [ V_167 ] )
F_270 ( V_48 -> V_303 [ 1 ] [ V_167 ] ) ;
}
if ( V_48 -> V_305 )
F_270 ( V_48 -> V_305 ) ;
}
static void F_345 ( struct V_337 * V_338 )
{
...
static int F_348 ( struct V_181 * V_44 , struct V_339 * V_338 )
{
struct V_47 * V_48 ;
struct V_12 * V_27 V_340 ;
int V_167 , V_196 ;
struct V_337 * V_341 ;
V_341 = F_349 ( V_44 , V_338 ) ;
if ( ! V_341 )
return - V_342 ;
V_48 = F_350 ( sizeof( * V_48 ) , V_343 , V_44 -> V_138 ) ;
if ( ! V_48 ) {
F_351 ( & V_341 -> V_344 ) ;
return - V_342 ;
}
...
V_48 -> V_152 = V_169 ;
#ifdef F_303
V_196 = F_352 ( V_44 , & V_28 ) ;
if ( V_196 )
goto V_345;
V_48 -> V_183 = F_28 ( V_44 -> V_346 ) ;
#else
V_196 = - V_342 ;
V_48 -> V_183 = F_350 ( sizeof( * V_48 -> V_183 ) ,
...
F_289 ( V_48 , & V_48 -> V_300 , 1 , 0 ) ;
V_48 -> V_300 . V_263 ++ ;
F_160 ( V_44 -> V_45 ) ;
F_141 ( & V_48 -> V_300 , V_48 -> V_183 ) ;
F_33 ( V_48 -> V_183 ) ;
F_162 ( V_44 -> V_45 ) ;
F_353 ( & V_48 -> V_243 ) ;
V_48 -> V_243 . V_350 = F_338 ;
V_48 -> V_243 . V_333 = ( unsigned long ) V_48 ;
F_354 ( & V_48 -> V_75 , F_337 ) ;
V_48 -> V_280 = V_280 ;
...
static T_5
F_355 ( unsigned int V_353 , char * V_354 )
{
return sprintf ( V_354 , L_6 , V_353 ) ;
}
static T_5
F_356 ( unsigned int * V_353 , const char * V_354 , T_6 V_59 )
{
char * V_211 = ( char * ) V_354 ;
* V_353 = F_357 ( V_211 , & V_211 , 10 ) ;
return V_59 ;
}
static int T_10 F_358 ( void )
{
int V_196 ;
if ( ! V_351 )
V_351 = 1 ;
