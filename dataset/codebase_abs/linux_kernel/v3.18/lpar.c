...
static long F_31 ( unsigned long V_33 ,
unsigned long V_65 ,
unsigned long V_24 ,
int V_28 , int V_29 ,
int V_30 , int V_66 )
...
unsigned long V_68 ;
V_68 = F_32 ( V_24 , V_28 , V_30 ) ;
F_15 ( L_14 ,
V_68 , V_33 , V_32 , V_28 ) ;
V_31 = F_33 ( V_32 , V_33 , V_68 ) ;
if ( V_31 == V_53 ) {
F_15 ( L_15 ) ;
return - 1 ;
}
...
static unsigned long F_34 ( unsigned long V_33 )
{
unsigned long V_69 ;
unsigned long V_31 ;
unsigned long V_70 ;
unsigned long V_32 ;
V_32 = 0 ;
V_31 = F_35 ( V_32 , V_33 , & V_69 , & V_70 ) ;
F_23 ( V_31 != V_45 ) ;
return V_69 ;
}
static long F_36 ( unsigned long V_24 , int V_28 , int V_30 )
{
unsigned long V_71 ;
unsigned long V_48 ;
long V_33 ;
unsigned long V_68 , V_34 ;
V_71 = F_37 ( V_24 , V_72 [ V_28 ] . V_73 , V_30 ) ;
V_68 = F_32 ( V_24 , V_28 , V_30 ) ;
V_33 = ( V_71 & V_74 ) * V_51 ;
for ( V_48 = 0 ; V_48 < V_51 ; V_48 ++ ) {
V_34 = F_34 ( V_33 ) ;
if ( F_38 ( V_34 , V_68 ) && ( V_34 & V_37 ) )
return V_33 ;
++ V_33 ;
}
return - 1 ;
}
static void F_39 ( unsigned long V_65 ,
unsigned long V_75 ,
int V_28 , int V_30 )
{
unsigned long V_24 ;
...
V_76 = F_40 ( V_75 , V_30 ) ;
V_24 = F_41 ( V_75 , V_76 , V_30 ) ;
V_33 = F_36 ( V_24 , V_28 , V_30 ) ;
F_23 ( V_33 == - 1 ) ;
V_32 = V_65 & 7 ;
V_31 = F_33 ( V_32 , V_33 , 0 ) ;
F_23 ( V_31 != V_45 ) ;
}
static void F_42 ( unsigned long V_33 , unsigned long V_24 ,
int V_28 , int V_29 ,
int V_30 , int V_66 )
{
unsigned long V_68 ;
...
static void F_43 ( unsigned long * V_33 ,
...
if ( ! F_10 ( V_83 ) ) {
F_42 ( V_33 [ V_48 ] , V_24 [ V_48 ] , V_28 , 0 ,
V_30 , 0 ) ;
} else {
V_78 [ V_79 ] = V_84 | V_85 | V_33 [ V_48 ] ;
V_78 [ V_79 + 1 ] = F_32 ( V_24 [ V_48 ] , V_28 , V_30 ) ;
V_79 += 2 ;
if ( V_79 == 8 ) {
V_64 = F_46 ( V_86 , V_78 ,
...
if ( V_79 ) {
V_78 [ V_79 ] = V_87 ;
V_64 = F_46 ( V_86 , V_78 , V_78 [ 0 ] , V_78 [ 1 ] ,
...
static void F_48 ( unsigned long V_76 ,
unsigned long V_3 ,
unsigned char * V_88 ,
int V_28 , int V_30 )
{
...
V_24 = F_41 ( V_3 , V_76 , V_30 ) ;
V_71 = F_37 ( V_24 , V_73 , V_30 ) ;
if ( V_96 & V_98 )
V_71 = ~ V_71 ;
V_33 = ( V_71 & V_74 ) * V_51 ;
V_33 += V_96 & V_99 ;
...
static void F_51 ( unsigned long V_75 ,
int V_28 , int V_30 )
{
unsigned long V_24 ;
...
V_33 = F_36 ( V_24 , V_28 , V_30 ) ;
F_23 ( V_33 == - 1 ) ;
F_42 ( V_33 , V_24 , V_28 , 0 , V_30 , 0 ) ;
}
static void F_52 ( unsigned long V_100 , int V_66 )
{
unsigned long V_24 ;
unsigned long V_48 , V_79 , V_64 ;
unsigned long V_32 = 0 ;
struct V_101 * V_102 = & F_53 ( V_101 ) ;
int V_80 = ! F_44 ( V_81 ) ;
...
F_54 (pte, psize, vpn, index, shift) {
V_71 = F_37 ( V_24 , V_73 , V_30 ) ;
V_96 = F_55 ( V_103 , V_89 ) ;
if ( V_96 & V_98 )
V_71 = ~ V_71 ;
V_33 = ( V_71 & V_74 ) * V_51 ;
V_33 += V_96 & V_99 ;
...
static int T_2 F_57 ( char * V_104 )
{
...
static int T_2 F_60 ( char * V_104 )
{
char * V_117 ;
V_117 = F_61 ( V_104 ) ;
...
static void F_62 ( struct V_119 * V_119 , int V_120 ,
unsigned long V_121 )
{
int V_48 , V_61 ;
unsigned long V_122 , V_3 ;
V_122 = F_63 () ;
V_3 = F_7 ( ( unsigned long ) F_64 ( V_119 ) ) ;
for ( V_48 = 0 ; V_48 < ( 1 << V_120 ) ; V_48 ++ , V_3 += V_123 ) {
for ( V_61 = 0 ; V_61 < V_123 ; V_61 += V_122 )
F_65 ( V_124 , V_121 , V_3 + V_61 , 0 ) ;
}
}
void F_66 ( struct V_119 * V_119 , int V_120 )
{
if ( ! V_118 || ! F_10 ( V_125 ) )
return;
F_62 ( V_119 , V_120 , V_126 ) ;
}
void F_67 ( void )
{
F_68 ( & V_127 ) ;
...
void F_71 ( unsigned long V_129 , unsigned long * args )
{
unsigned long V_32 ;
unsigned int * V_130 ;
if ( V_129 == V_131 )
...
void F_76 ( long V_129 , unsigned long V_134 ,
unsigned long * V_135 )
{
unsigned long V_32 ;
unsigned int * V_130 ;
...
goto V_133;
( * V_130 ) ++ ;
F_77 ( V_129 , V_134 , V_135 ) ;
F_78 () ;
( * V_130 ) -- ;
V_133:
F_75 ( V_32 ) ;
}
int F_79 ( struct V_136 * V_137 )
{
int V_64 ;
unsigned long V_135 [ V_138 ] ;
V_64 = F_46 ( V_139 , V_135 ) ;
V_137 -> V_140 = V_135 [ 0 ] ;
V_137 -> V_141 = V_135 [ 1 ] ;
...
int F_80 ( struct V_150 * V_151 )
{
int V_64 ;
unsigned long V_135 [ V_138 ] = { 0 } ;
V_64 = F_46 ( V_152 , V_135 ) ;
V_151 -> V_153 = V_135 [ 0 ] ;
V_151 -> V_154 = V_135 [ 1 ] ;
V_151 -> V_155 = V_135 [ 2 ] ;
V_151 -> V_156 = V_135 [ 3 ] ;
