...
static int F_44 ( struct V_101 * V_15 )
{
int V_5 = - V_82 ;
struct V_1 * V_2 ;
F_45 ( & V_15 -> V_36 , L_31 , V_15 -> V_84 ) ;
V_2 = F_46 ( & V_15 -> V_36 , sizeof( struct V_1 ) , V_81 ) ;
if ( ! V_2 )
goto V_89;
V_2 -> V_12 = F_46 ( & V_15 -> V_36 , 3 , V_81 ) ;
if ( ! V_2 -> V_12 )
goto V_89;
V_15 -> V_102 = V_103 ;
if ( V_15 -> V_104 > V_105 )
...
V_2 -> V_15 = V_15 ;
F_49 ( V_15 , V_2 ) ;
V_2 -> V_36 = F_50 ( 0 , & V_106 ) ;
if ( ! V_2 -> V_36 )
goto V_89;
V_2 -> V_36 -> V_39 = V_2 ;
V_2 -> V_36 -> V_107 = & V_2 -> V_15 -> V_36 ;
V_2 -> V_36 -> V_108 -> V_109 [ 0 ] = V_110 ;
V_2 -> V_36 -> V_111 = V_112 | V_113 ;
F_22 ( F_8 ( V_2 ) , L_32 ) ;
V_5 = F_51 ( V_2 -> V_36 ) ;
if ( V_5 )
goto V_114;
...
static int F_56 ( struct V_101 * V_15 )
{
struct V_1 * V_2 = F_57 ( V_15 ) ;
F_22 ( F_8 ( V_2 ) , L_34 ) ;
F_54 ( V_2 -> V_36 ) ;
F_55 ( V_2 -> V_36 ) ;
return 0 ;
