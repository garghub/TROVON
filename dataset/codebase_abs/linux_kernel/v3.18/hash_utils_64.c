...
int F_86 ( struct V_147 * V_148 , unsigned long V_150 , unsigned long V_163 , unsigned long V_133 )
{
...
F_88 ( L_34 , V_148 , V_148 -> V_181 , V_24 ) ;
if ( ! V_24 ) {
F_88 ( L_35 ) ;
V_78 = 1 ;
goto V_177;
...
#ifndef F_34
F_88 ( L_38 , F_98 ( * V_171 ) ) ;
#else
F_88 ( L_39 , F_98 ( * V_171 ) ,
F_98 ( * ( V_171 + V_184 ) ) ) ;
#endif
#ifdef F_34
...
#ifdef F_48
if ( V_14 == V_52 )
V_78 = F_103 ( V_150 , V_163 , V_24 , V_171 , V_133 , V_175 , V_15 ) ;
else
#endif
{
...
V_14 , F_98 ( * V_171 ) ) ;
#ifndef F_34
F_88 ( L_43 , F_98 ( * V_171 ) ) ;
#else
F_88 ( L_44 , F_98 ( * V_171 ) ,
F_98 ( * ( V_171 + V_184 ) ) ) ;
#endif
F_88 ( L_45 , V_78 ) ;
V_177:
...
if ( F_89 ( V_150 ) == V_179 )
V_148 = & V_188 ;
return F_86 ( V_148 , V_150 , V_163 , V_133 ) ;
}
...
#ifdef F_108
if ( F_109 ( F_77 ( V_148 , V_150 ) != V_148 -> V_143 . V_146 ) )
return;
#endif
F_88 ( L_46
...
#endif
V_78 = F_104 ( V_150 , V_163 , V_24 , V_171 , V_133 , V_175 , V_15 ,
F_81 ( V_148 , V_150 ) ) ;
if ( V_78 == - 1 )
...
V_192 += V_191 & V_194 ;
F_88 ( L_49 , V_140 , V_192 , V_191 ) ;
V_31 . V_195 ( V_192 , V_25 , V_14 , V_14 , V_15 , V_175 ) ;
} F_115 () ;
#ifdef F_116
if ( V_175 && F_31 ( V_196 ) &&
V_149 -> V_197 . V_198 &&
F_117 ( V_149 -> V_197 . V_198 -> V_199 ) ) {
F_118 () ;
F_119 ( V_200 ) ;
}
#endif
