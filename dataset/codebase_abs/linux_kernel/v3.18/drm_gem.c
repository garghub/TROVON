...
void
V_59 ( struct V_1 * V_2 , struct V_21 * V_60 )
{
F_3 ( & V_60 -> V_28 ) ;
F_66 ( & V_60 -> V_27 ) ;
}
static int
F_67 ( int V_61 , void * V_62 , void * V_51 )
{
...
void
F_68 ( struct V_1 * V_2 , struct V_21 * V_60 )
{
F_69 ( & V_60 -> V_28 ,
& F_67 , V_60 ) ;
F_70 ( & V_60 -> V_28 ) ;
...
{
struct V_11 * V_12 = (struct V_11 * ) V_63 ;
struct V_1 * V_2 = V_12 -> V_2 ;
F_15 ( ! F_37 ( & V_2 -> V_64 ) ) ;
if ( V_2 -> V_31 -> V_65 != NULL )
V_2 -> V_31 -> V_65 ( V_12 ) ;
}
void F_74 ( struct V_66 * V_67 )
{
struct V_11 * V_12 = V_67 -> V_68 ;
F_40 ( V_12 ) ;
F_19 ( & V_12 -> V_2 -> V_64 ) ;
F_75 ( V_12 -> V_2 , V_67 ) ;
F_21 ( & V_12 -> V_2 -> V_64 ) ;
...
int F_79 ( struct V_11 * V_12 , unsigned long V_69 ,
struct V_66 * V_67 )
{
struct V_1 * V_2 = V_12 -> V_2 ;
F_80 ( & V_2 -> V_64 ) ;
if ( V_69 < V_67 -> V_70 - V_67 -> V_71 )
return - V_29 ;
if ( ! V_2 -> V_31 -> V_72 )
return - V_29 ;
V_67 -> V_73 |= V_74 | V_75 | V_76 | V_77 ;
V_67 -> V_78 = V_2 -> V_31 -> V_72 ;
V_67 -> V_68 = V_12 ;
V_67 -> V_79 = F_81 ( F_82 ( V_67 -> V_73 ) ) ;
F_40 ( V_12 ) ;
F_75 ( V_2 , V_67 ) ;
return 0 ;
}
int F_83 ( struct V_14 * V_15 , struct V_66 * V_67 )
{
struct V_21 * V_80 = V_15 -> V_81 ;
struct V_1 * V_2 = V_80 -> V_82 -> V_2 ;
struct V_11 * V_12 ;
struct V_83 * V_84 ;
int V_35 ;
if ( F_84 ( V_2 ) )
...
F_21 ( & V_2 -> V_64 ) ;
return - V_29 ;
} else if ( ! F_87 ( V_84 , V_15 ) ) {
F_21 ( & V_2 -> V_64 ) ;
return - V_86 ;
}
V_12 = F_88 ( V_84 , struct V_11 , V_20 ) ;
V_35 = F_79 ( V_12 , F_89 ( V_84 ) << V_46 , V_67 ) ;
F_21 ( & V_2 -> V_64 ) ;
return V_35 ;
}
