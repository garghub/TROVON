...
if ( V_47 != F_97 ( V_94 ) -> V_88 ) {
F_98 () ;
V_47 = F_99 ( V_181 , V_179 + 1 , V_183 ) ;
F_100 () ;
}
if ( ! V_47 )
...
static void
F_101 ( struct V_168 * V_169 , struct V_170 * V_171 )
{
T_2 V_184 ;
...
if ( V_169 -> V_173 == NULL )
V_184 = F_95 ( V_169 -> V_176 ,
V_171 -> V_185 ) ;
else
V_184 = F_103 ( V_169 -> V_173 ) ;
F_104 ( V_169 , V_171 , V_184 ) ;
}
static T_4
F_105 ( struct V_168 * V_169 , struct V_170 * V_178 ,
struct V_170 * V_171 )
{
if ( ! F_86 ( V_169 , V_171 , V_152 ) )
return 0 ;
