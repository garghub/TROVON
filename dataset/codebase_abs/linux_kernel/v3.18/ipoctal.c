...
static int F_55 ( struct V_221 * V_20 )
{
int V_88 ;
struct V_1 * V_1 ;
V_1 = F_56 ( sizeof( struct V_1 ) , V_222 ) ;
if ( V_1 == NULL )
return - V_128 ;
V_1 -> V_20 = V_20 ;
...
{
int V_80 ;
V_1 -> V_20 -> V_157 -> V_155 -> V_224 ( V_1 -> V_20 ) ;
for ( V_80 = 0 ; V_80 < V_84 ; V_80 ++ ) {
struct V_2 * V_5 = & V_1 -> V_5 [ V_80 ] ;
F_59 ( V_1 -> V_152 , V_80 ) ;
F_60 ( & V_5 -> V_16 ) ;
...
static void F_62 ( struct V_221 * V_225 )
{
F_58 ( F_6 ( & V_225 -> V_20 ) ) ;
}
static int T_5 F_63 ( void )
{
return F_64 ( & V_226 , V_130 , V_132 ) ;
}
