...
{
struct V_100 * V_101 = F_37 ( V_2 -> V_102 ) ;
struct V_103 * V_104 ;
int V_105 ;
V_104 = F_38 ( V_101 , V_106 , 0 ) ;
if ( ! V_104 ) {
F_39 ( & V_101 -> V_102 , L_2 ) ;
return - V_107 ;
}
V_105 = F_40 ( V_104 ) ;
if ( ! F_41 ( V_2 -> V_102 , V_2 -> V_108 , V_105 ,
F_42 ( V_2 -> V_102 ) ) ) {
F_39 ( V_2 -> V_102 , L_3 ) ;
return - V_109 ;
}
if ( V_2 -> V_13 & V_99 ) {
V_2 -> V_6 = F_43 ( V_2 -> V_102 ,
V_2 -> V_108 ,
V_105 ) ;
if ( V_2 -> V_6 == NULL )
return - V_110 ;
...
struct V_129 * V_129 ;
int V_55 = 0 ;
if ( V_101 -> V_102 . V_130 )
V_101 -> V_131 = F_57 ( V_101 -> V_102 . V_130 , L_4 ) ;
if ( V_101 -> V_131 < 0 || V_101 -> V_131 >= V_125 )
return - V_97 ;
V_127 = F_38 ( V_101 , V_106 , 0 ) ;
if ( ! V_127 )
return - V_107 ;
V_128 = F_38 ( V_101 , V_132 , 0 ) ;
if ( ! V_128 )
return - V_107 ;
if ( V_117 [ V_101 -> V_131 ] ) {
F_39 ( & V_101 -> V_102 , L_5 , V_101 -> V_131 ) ;
return - V_109 ;
}
V_2 = F_58 ( & V_101 -> V_102 , sizeof( struct V_1 ) , V_133 ) ;
if ( ! V_2 )
return - V_110 ;
V_129 = F_59 ( & V_101 -> V_102 , NULL ) ;
if ( F_60 ( V_129 ) )
return F_61 ( V_129 ) ;
V_2 -> V_64 = F_62 ( V_129 ) ;
V_2 -> V_134 = V_135 ;
...
V_2 -> line = V_101 -> V_131 ;
V_2 -> type = V_54 ;
V_2 -> V_23 = 0 ;
V_2 -> V_139 = & V_140 ;
V_2 -> V_59 = 64 ;
V_117 [ V_101 -> V_131 ] = V_2 ;
F_63 ( V_101 , V_2 ) ;
V_55 = F_64 ( & V_141 , V_2 ) ;
if ( V_55 )
V_117 [ V_101 -> V_131 ] = NULL ;
return V_55 ;
}
