...
V_15 -> V_199 . V_200 = F_39 ( 0xfe80000000000000LL ) ;
F_1 ( V_2 , & V_15 -> V_201 [ 8 ] ) ;
}
...
if ( V_207 ) {
F_48 ( & V_207 -> V_187 ) ;
F_49 (ifp, &in6_dev->addr_list, if_list) {
V_208 = (union V_7 * ) & V_209 -> V_46 ;
F_2 ( V_2 , V_208 ) ;
}
F_50 ( & V_207 -> V_187 ) ;
F_51 ( V_207 ) ;
...
{
struct V_18 * V_210 ;
F_53 (&init_net, net_dev) {
struct V_18 * V_211 = F_7 ( V_210 ) ?
F_7 ( V_210 ) : V_210 ;
if ( V_211 == V_2 -> V_5 . V_19 ) {
F_38 ( V_2 ) ;
F_40 ( V_2 , V_210 ) ;
F_45 ( V_2 , V_210 ) ;
}
...
static struct V_1 * F_54 ( struct V_212 * V_213 )
{
int V_214 = 0 , V_9 ;
struct V_1 * V_2 ;
V_2 = (struct V_1 * ) F_55 ( sizeof( struct V_1 ) ) ;
if ( ! V_2 ) {
F_27 ( L_5 ) ;
return NULL ;
}
V_2 -> V_215 = F_25 ( sizeof( struct V_216 ) , V_173 ) ;
if ( ! V_2 -> V_215 )
goto V_217;
memcpy ( & V_2 -> V_5 , V_213 , sizeof( * V_213 ) ) ;
V_2 -> V_190 = F_56 ( & V_218 , NULL , 0 , 0 , V_173 ) ;
if ( V_2 -> V_190 < 0 )
goto V_217;
V_214 = F_57 ( V_2 ) ;
if ( V_214 )
...
goto V_174;
for ( V_9 = 0 ; V_9 < F_36 ( V_198 ) ; V_9 ++ )
if ( F_59 ( & V_2 -> V_32 . V_2 , V_198 [ V_9 ] ) )
goto V_220;
F_60 ( & V_221 ) ;
...
F_63 ( V_2 ) ;
F_64 ( L_6 ,
F_65 ( & V_2 -> V_5 . V_154 -> V_2 ) , F_66 ( V_2 ) ,
F_67 ( V_2 ) , V_2 -> V_197 ,
V_2 -> V_224 ) ;
F_64 ( L_7 ,
F_65 ( & V_2 -> V_5 . V_154 -> V_2 ) , V_2 -> V_190 ) ;
return V_2 ;
V_220:
F_35 ( V_2 ) ;
V_174:
...
F_68 ( V_2 ) ;
V_219:
F_69 ( & V_218 , V_2 -> V_190 ) ;
V_217:
F_29 ( V_2 -> V_215 ) ;
F_70 ( & V_2 -> V_32 ) ;
F_27 ( L_8 , V_189 , V_214 ) ;
return NULL ;
}
static void F_71 ( struct V_225 * V_226 )
{
struct V_1 * V_2 = F_72 ( V_226 , struct V_1 , V_226 ) ;
F_69 ( & V_218 , V_2 -> V_190 ) ;
F_29 ( V_2 -> V_215 ) ;
F_70 ( & V_2 -> V_32 ) ;
}
...
V_229 = V_230 [ V_9 ] ;
if ( V_229 && V_229 -> V_238 . V_239 != V_240 ) {
F_80 ( & V_229 -> V_238 , & V_233 , V_234 ) ;
V_231 . V_17 = V_241 ;
V_231 . V_33 . V_229 = & V_229 -> V_238 ;
V_231 . V_31 = & V_2 -> V_32 ;
F_12 ( & V_231 ) ;
}
}
...
static void F_82 ( struct V_1 * V_2 , T_3 V_17 )
{
switch ( V_17 ) {
case V_243 :
F_78 ( V_2 ) ;
