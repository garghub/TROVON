...
V_155 = F_57 ( V_14 -> V_148 , & V_154 ) ;
if ( V_155 ) {
F_56 ( V_150 , L_5 ) ;
goto V_157;
}
V_14 -> V_147 = F_55 ( V_150 , L_6 ) ;
if ( ! V_14 -> V_147 ) {
F_58 ( V_150 , L_7 ) ;
V_155 = - V_156 ;
goto V_157;
...
static int F_62 ( struct V_1 * V_19 ,
struct V_17 * V_18 )
{
...
V_19 -> V_40 = true ;
V_155 = F_62 ( V_19 , V_18 ) ;
if ( V_155 != - V_198 )
return V_155 ;
}
V_19 -> V_40 = false ;
return F_73 ( V_16 , V_18 ) ;
}
static int F_76 ( struct V_15 * V_16 )
{
struct V_1 * V_19 = F_7 ( V_16 -> V_14 ) ;
int V_121 = V_19 -> V_87 [ V_16 -> V_122 ] ;
F_58 ( & V_16 -> V_150 , L_12 , V_27 ,
V_16 -> V_61 , V_16 -> V_138 , V_16 -> V_139 ) ;
if ( F_46 ( V_121 ) )
F_77 ( V_121 , V_16 -> V_61 & V_64 ? 0 : 1 ) ;
F_45 ( V_16 , V_124 ) ;
return 0 ;
}
...
static int
F_79 ( struct V_13 * V_14 , struct V_201 * V_202 )
{
struct V_1 * V_19 = F_7 ( V_14 ) ;
int V_155 ;
V_155 = F_80 ( V_19 -> V_203 ) ;
if ( V_155 )
return V_155 ;
V_155 = F_80 ( V_19 -> V_204 ) ;
if ( V_155 ) {
F_81 ( V_19 -> V_203 ) ;
return V_155 ;
}
...
static int
F_82 ( struct V_13 * V_14 , struct V_201 * V_202 )
{
struct V_1 * V_19 = F_7 ( V_14 ) ;
F_81 ( V_19 -> V_204 ) ;
F_81 ( V_19 -> V_203 ) ;
...
if ( ! V_208 && ! V_214 ) {
F_56 ( & V_206 -> V_150 , L_13 ) ;
return - V_156 ;
}
V_155 = F_86 ( V_208 , L_14 , & V_215 ) ;
if ( V_155 < 0 ) {
if ( V_214 )
V_215 = V_214 -> V_216 ;
else
...
V_14 = F_87 ( & V_206 -> V_150 ,
sizeof( struct V_1 ) + sizeof( int ) * V_215 ) ;
if ( ! V_14 )
return - V_217 ;
F_88 ( V_206 , V_14 ) ;
V_14 -> V_218 = F_89 ( 1 , 32 ) ;
V_14 -> V_219 = V_206 -> V_220 ;
V_14 -> V_216 = V_215 ;
V_19 = F_7 ( V_14 ) ;
V_19 -> V_146 . V_14 = V_14 ;
for ( V_11 = 0 ; V_11 < V_14 -> V_216 ; V_11 ++ ) {
int V_221 = F_90 ( V_208 , L_15 , V_11 ) ;
if ( ! F_46 ( V_221 ) && V_214 )
V_221 = V_214 -> V_87 [ V_11 ] ;
V_19 -> V_87 [ V_11 ] = V_221 ;
if ( ! F_46 ( V_221 ) )
continue;
V_155 = F_91 ( & V_206 -> V_150 , V_19 -> V_87 [ V_11 ] ,
V_222 ) ;
if ( V_155 ) {
F_56 ( & V_206 -> V_150 , L_16 ) ;
goto V_223;
}
}
V_19 -> V_146 . V_87 = F_45 ;
V_19 -> V_146 . V_224 = F_51 ;
V_19 -> V_146 . V_225 = F_75 ;
V_19 -> V_146 . V_14 -> V_226 = F_76 ;
V_19 -> V_146 . V_14 -> V_227 = F_78 ;
V_19 -> V_146 . V_14 -> V_228 = F_79 ;
V_19 -> V_146 . V_14 -> V_229 = F_82 ;
V_19 -> V_146 . V_14 -> V_230 = V_63 | V_62 | V_64 ;
F_59 ( & V_19 -> V_136 ) ;
V_19 -> V_3 = V_211 ? V_211 -> V_231 :
(struct V_232 * ) V_206 -> V_233 -> V_234 ;
V_152 = F_92 ( V_206 , V_235 , 0 ) ;
V_19 -> V_36 = F_93 ( & V_206 -> V_150 , V_152 ) ;
if ( F_94 ( V_19 -> V_36 ) ) {
V_155 = F_95 ( V_19 -> V_36 ) ;
goto V_223;
}
V_19 -> V_130 = F_96 ( V_206 , 0 ) ;
if ( V_19 -> V_130 < 0 ) {
V_155 = V_19 -> V_130 ;
goto V_223;
}
V_155 = F_97 ( & V_206 -> V_150 , V_19 -> V_130 , F_49 , 0 ,
F_70 ( & V_206 -> V_150 ) , V_19 ) ;
if ( V_155 ) {
F_56 ( & V_206 -> V_150 , L_17 , V_19 -> V_130 , V_155 ) ;
goto V_223;
}
V_19 -> V_204 = F_98 ( & V_206 -> V_150 , L_18 ) ;
if ( F_94 ( V_19 -> V_204 ) ) {
V_155 = F_95 ( V_19 -> V_204 ) ;
goto V_223;
}
V_19 -> V_203 = F_98 ( & V_206 -> V_150 , L_19 ) ;
if ( F_94 ( V_19 -> V_203 ) ) {
V_155 = F_95 ( V_19 -> V_203 ) ;
goto V_223;
}
V_155 = F_99 ( V_19 -> V_203 ) ;
if ( V_155 )
goto V_223;
V_155 = F_99 ( V_19 -> V_204 ) ;
if ( V_155 )
goto V_236;
V_19 -> V_57 = F_100 ( V_19 -> V_203 ) ;
if ( V_19 -> V_3 == & V_237
&& F_54 ( & V_206 -> V_150 , V_19 , V_14 , V_152 ) )
F_56 ( & V_206 -> V_150 , L_20 ) ;
V_19 -> V_3 -> V_196 ( V_19 ) ;
V_19 -> V_3 -> V_135 ( V_19 , 0 ) ;
V_14 -> V_150 . V_209 = V_206 -> V_150 . V_209 ;
V_155 = F_101 ( & V_19 -> V_146 ) ;
if ( V_155 ) {
F_56 ( & V_206 -> V_150 , L_21 , V_155 ) ;
goto V_238;
}
F_102 ( & V_206 -> V_150 , L_22 ) ;
F_81 ( V_19 -> V_204 ) ;
F_81 ( V_19 -> V_203 ) ;
return V_155 ;
V_238:
...
static int F_105 ( struct V_205 * V_206 )
{
struct V_13 * V_14 = F_106 ( V_206 ) ;
struct V_1 * V_19 = F_7 ( V_14 ) ;
F_107 ( & V_19 -> V_146 ) ;
