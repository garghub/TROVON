...
struct V_100 * V_101 ;
void * V_24 ;
V_24 = F_57 ( V_68 , V_115 ) ;
if ( ! V_24 )
goto V_86;
V_101 = F_58 ( V_74 , & V_116 , sizeof( * V_101 ) ) ;
if ( ! V_101 )
goto V_117;
V_101 -> V_112 = V_68 ;
V_101 -> V_111 = V_24 ;
...
static int F_61 ( struct V_73 * V_73 , struct V_74 * V_74 )
{
struct V_97 * V_118 = V_74 -> V_75 ;
struct V_100 * V_101 = (struct V_100 * ) V_118 -> V_102 ;
if ( V_101 -> V_105 )
F_51 ( V_101 -> V_105 ) ;
F_62 ( V_101 -> V_103 ) ;
F_28 ( V_101 -> V_111 ) ;
return F_63 ( V_73 , V_74 ) ;
}
static int F_64 ( struct V_80 * V_81 , char * V_24 , int V_28 )
{
int V_46 = 0 ;
struct V_119 * V_12 ;
char * V_30 ;
...
V_46 += snprintf ( V_24 + V_46 , V_28 - V_46 ,
L_48 ,
F_65 ( V_81 -> V_131 ) , V_81 -> V_132 , V_30 ) ;
V_46 += snprintf ( V_24 + V_46 , V_28 - V_46 ,
L_49 ,
...
static int F_66 ( struct V_73 * V_73 , struct V_74 * V_74 )
{
struct V_80 * V_81 = V_73 -> V_85 ;
char * V_24 = NULL ;
V_24 = ( char * ) F_24 ( V_67 ) ;
if ( ! V_24 )
goto V_86;
F_39 ( V_73 , F_64 ( V_81 , V_24 , V_68 - 1 ) ) ;
V_74 -> V_75 = V_24 ;
return 0 ;
V_86:
return - V_87 ;
...
{
V_81 -> V_166 = F_72 ( V_81 -> V_27 ,
V_177 ) ;
if ( ! V_81 -> V_166 ) {
F_60 ( - V_87 ) ;
goto V_86;
}
V_81 -> V_70 = F_73 ( sizeof( struct V_70 ) ,
V_115 ) ;
if ( ! V_81 -> V_70 ) {
F_60 ( - V_87 ) ;
goto V_86;
