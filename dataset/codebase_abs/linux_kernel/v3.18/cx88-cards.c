...
struct V_122 V_152 ;
V_152 . V_130 = V_153 ;
V_152 . V_58 = & V_2 -> V_4 . V_151 ;
F_35 ( V_2 , V_130 , V_132 , & V_152 ) ;
}
if ( V_2 -> V_4 . V_5 == V_65 ) {
struct V_122 V_154 ;
struct V_79 V_80 ;
...
F_22 ( 1 , L_33 ,
V_80 . V_81 ) ;
F_35 ( V_2 , V_130 , V_132 , & V_154 ) ;
}
F_35 ( V_2 , V_2 , V_155 , 0 ) ;
}
...
V_158 |= V_157 ;
F_39 ( V_69 , V_168 , V_158 ) ;
}
if ( V_145 != V_156 ) {
F_26 ( V_161 L_39 ,
V_18 , V_167 ) ;
F_39 ( V_69 , V_169 , V_167 ) ;
}
return 0 ;
}
...
F_26 ( V_62
L_40 ,
V_2 -> V_18 , F_44 ( V_69 -> V_170 ) ,
( unsigned long long ) F_42 ( V_69 , 0 ) ,
V_69 -> V_70 , V_69 -> V_71 ) ;
return - V_171 ;
}
struct V_1 * F_45 ( struct V_68 * V_69 , int V_172 )
{
struct V_1 * V_2 ;
int V_38 ;
V_2 = F_46 ( sizeof( * V_2 ) , V_173 ) ;
if ( V_2 == NULL )
return NULL ;
F_47 ( & V_2 -> V_174 ) ;
V_2 -> V_175 = V_69 -> V_176 -> V_177 ;
V_2 -> V_178 = F_48 ( V_69 -> V_170 ) ;
V_2 -> V_179 = V_180 | V_181 |
V_182 | V_183 |
V_184 | V_185 ;
F_49 ( & V_2 -> V_186 ) ;
V_2 -> V_172 = V_172 ;
sprintf ( V_2 -> V_18 , L_41 , V_2 -> V_172 ) ;
strcpy ( V_2 -> V_187 . V_18 , V_2 -> V_18 ) ;
if ( F_50 ( NULL , & V_2 -> V_187 ) ) {
F_51 ( V_2 ) ;
return NULL ;
}
if ( F_52 ( & V_2 -> V_188 , 13 ) ) {
F_53 ( & V_2 -> V_187 ) ;
F_51 ( V_2 ) ;
return NULL ;
}
if ( F_52 ( & V_2 -> V_189 , 13 ) ) {
F_54 ( & V_2 -> V_188 ) ;
F_53 ( & V_2 -> V_187 ) ;
F_51 ( V_2 ) ;
return NULL ;
