...
V_118 = ! ! ( V_21 [ 0 ] & F_37 ( 5 ) ) ;
if ( V_118 ) {
V_13 = F_18 ( V_2 , V_5 -> V_64 . V_97 + 8 , V_21 ) ;
if ( V_13 ) {
F_50 ( V_2 , L_19 ,
V_13 ) ;
return V_13 ;
...
V_120 = V_21 [ 0 ] | ( V_21 [ 1 ] << 8 ) ;
V_121 = V_21 [ 2 ] | ( V_21 [ 3 ] << 8 ) ;
V_5 -> V_124 = F_54 ( V_120 , 10 ) ;
V_5 -> V_125 = F_54 ( V_121 , 10 ) ;
F_49 ( V_2 , L_22 ,
V_11 , V_5 -> V_124 , V_5 -> V_125 ) ;
}
}
...
V_129 = ( V_5 -> V_75 + 7 ) / 8 ;
V_130 = ( V_127 && V_128 ) ? V_129 : 0 ;
V_130 += V_129 ;
V_131 = 2 * V_129 ;
V_5 -> V_74 . V_71 = V_129 ;
V_13 = F_8 ( V_2 , V_5 -> V_74 . V_99 + V_130 ,
V_21 , V_131 ) ;
if ( V_13 ) {
F_50 ( V_2 , L_26 ,
V_131 , V_13 ) ;
...
int V_132 = V_63 >> 3 ;
int V_133 = V_63 & 0x07 ;
T_1 V_134 = V_21 [ V_132 ] ;
T_1 V_135 = V_21 [ V_132 + V_129 ] ;
bool V_136 = ( V_134 >> V_133 ) & F_37 ( 0 ) ;
bool V_137 = ( V_135 >> V_133 ) & F_37 ( 0 ) ;
if ( V_136 == 0 ) {
if ( V_137 ) {
V_5 -> V_138 ++ ;
F_11 ( V_63 , & V_5 -> V_76 ) ;
...
static void F_57 ( struct V_1 * V_2 , struct V_139 * V_140 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_141 * V_46 = V_140 -> V_46 ;
int V_13 ;
int V_142 , V_143 , V_63 ;
V_5 -> V_46 = V_46 ;
F_33 ( V_2 , L_30 ) ;
V_13 = F_58 ( V_2 ) ;
if ( V_13 )
...
if ( V_13 )
goto exit;
F_60 ( V_49 , V_46 -> V_144 ) ;
F_61 ( V_46 , V_50 , 1 , V_5 -> V_126 , 0 , 0 ) ;
F_61 ( V_46 , V_51 , 1 , V_5 -> V_48 , 0 , 0 ) ;
if ( V_5 -> V_124 && V_5 -> V_125 ) {
V_142 = ( V_5 -> V_126 - 1 ) / V_5 -> V_124 ;
V_143 = ( V_5 -> V_48 - 1 ) / V_5 -> V_125 ;
F_62 ( V_46 , V_50 , V_142 ) ;
F_62 ( V_46 , V_51 , V_143 ) ;
}
F_61 ( V_46 , V_52 , 0 , 1 , 0 , 0 ) ;
F_61 ( V_46 , V_53 , 0 , 0xff , 0 , 0 ) ;
F_61 ( V_46 , V_54 , 0 , 0x0f , 0 , 0 ) ;
F_61 ( V_46 , V_55 , 0 , 0x0f , 0 , 0 ) ;
F_63 ( V_46 , V_5 -> V_66 , V_145 ) ;
if ( V_5 -> V_138 ) {
F_60 ( V_78 , V_46 -> V_144 ) ;
for ( V_63 = 0 ; V_63 < V_5 -> V_138 ; V_63 ++ )
F_60 ( V_79 + V_63 , V_46 -> V_146 ) ;
if ( V_5 -> V_138 == 1 )
F_60 ( V_147 , V_46 -> V_148 ) ;
}
F_11 ( V_81 , & V_5 -> V_29 ) ;
exit:
F_64 ( V_2 ) ;
...
struct V_139 * V_140 , struct V_149 * V_150 ,
struct V_151 * V_152 , unsigned long * * V_153 , int * F_22 )
{
return - 1 ;
}
static int F_67 ( struct V_1 * V_2 , const struct V_154 * V_155 )
{
struct V_4 * V_5 = NULL ;
int V_13 ;
T_3 V_156 ;
struct V_85 * V_157 ;
struct V_85 * V_158 ;
V_5 = F_68 ( & V_2 -> V_10 , sizeof( struct V_4 ) , V_159 ) ;
if ( ! V_5 )
return - V_160 ;
F_69 ( & V_5 -> V_58 , F_25 ) ;
V_5 -> V_2 = V_2 ;
...
V_5 -> V_83 = ( V_157 -> V_61 >> 3 ) + 1 ;
V_158 = V_2 -> V_163 [ V_166 ]
. V_165 [ V_8 ] ;
if ( ! V_158 ) {
F_50 ( V_2 , L_35 ) ;
V_13 = - V_123 ;
...
V_5 -> V_9 = ( V_158 -> V_61 >> 3 )
+ 1 ;
V_156 = V_5 -> V_9 + V_5 -> V_83 ;
V_5 -> V_7 = F_68 ( & V_2 -> V_10 , V_156 , V_159 ) ;
if ( ! V_5 -> V_7 ) {
V_13 = - V_160 ;
return V_13 ;
}
