...
struct V_131 * * V_66 , unsigned int V_141 , unsigned int V_142 ,
unsigned int V_93 )
{
if ( * V_66 && ( * V_66 ) -> V_135 + ( * V_66 ) -> V_93 == V_141 &&
( * V_66 ) -> V_134 + ( * V_66 ) -> V_93 == V_142 ) {
( * V_66 ) -> V_93 += V_93 ;
} else {
...
{
const struct V_58 * V_91 ;
int V_15 , V_143 = - 1 , V_144 , V_93 ;
unsigned V_141 = 0 , V_142 = 0 ;
struct V_131 * V_66 = NULL ;
F_75 ( V_14 ) ;
F_37 ( V_14 -> V_133 ) ;
V_14 -> V_133 = NULL ;
if ( F_81 ( V_11 -> V_101 ,
...
V_11 -> V_75 ,
V_143 + 1 ) ;
V_91 = F_49 ( V_11 , V_143 ) ;
if ( V_91 -> V_38 . V_43 > 1 )
V_93 = V_91 -> V_38 . V_47 / 8 *
V_91 -> V_38 . V_43 ;
else
V_93 = V_91 -> V_38 . V_47 / 8 ;
V_141 = F_83 ( V_141 , V_93 ) + V_93 ;
}
V_91 = F_49 ( V_11 , V_143 ) ;
if ( V_91 -> V_38 . V_43 > 1 )
V_93 = V_91 -> V_38 . V_47 / 8 *
...
V_93 = V_91 -> V_38 . V_47 / 8 ;
V_142 = F_83 ( V_142 , V_93 ) ;
V_141 = F_83 ( V_141 , V_93 ) ;
V_15 = F_78 ( V_14 , & V_66 , V_141 , V_142 , V_93 ) ;
if ( V_15 )
goto V_145;
V_142 += V_93 ;
V_141 += V_93 ;
...
static void F_85 ( struct V_146 * V_29 )
{
