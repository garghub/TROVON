...
static int F_36 ( struct V_1 * V_2 , T_1 V_85 [ 6 ] )
{
const T_1 V_86 [] = { 0x1f , 0xcc } ;
T_1 V_87 [ 20 ] ;
int V_13 ;
V_13 = - V_66 ;
if ( F_28 ( & V_2 -> V_65 ) < 0 )
...
{
struct V_90 * V_11 ;
V_39 -> V_91 [ 0 ] . V_92 = F_39 ( V_93 , & V_94 ,
& V_39 -> V_40 -> V_95 ) ;
if ( ! V_39 -> V_91 [ 0 ] . V_92 )
return - V_96 ;
if ( ( F_39 ( V_97 , V_39 -> V_91 [ 0 ] . V_92 ,
& V_39 -> V_40 -> V_95 ) ) == NULL )
F_4 ( L_22 ) ;
V_11 = V_39 -> V_40 -> V_98 -> V_99 [ 0 ] ;
if ( V_100 == V_11 -> V_101
&& V_102 == V_11 -> V_103 )
F_21 ( V_39 ) ;
return 0 ;
...
if ( ! V_39 -> V_91 [ 0 ] . V_92 )
return - V_96 ;
if ( F_39 ( V_104 , V_39 -> V_91 [ 0 ] . V_92 , & V_105 ,
& V_39 -> V_40 -> V_95 ) == NULL ) {
F_4 ( L_23 , V_26 ) ;
return - V_96 ;
}
...
{
struct V_1 * V_2 = F_42 ( V_107 ) ;
F_19 ( V_2 ) ;
F_43 ( V_107 ) ;
}
static int F_44 ( struct V_106 * V_107 ,
const struct V_90 * V_11 )
{
if ( 0 == F_45 ( V_107 , & V_108 ,
V_42 , NULL , V_109 ) ||
0 == F_45 ( V_107 , & V_110 ,
V_42 , NULL , V_109 ) )
return 0 ;
