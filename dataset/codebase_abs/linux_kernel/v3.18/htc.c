...
if ( V_61 )
goto V_75;
F_35 ( V_9 , V_9 -> V_19 - V_72 ) ;
}
if ( ( ( int ) V_71 - ( int ) V_72 ) <= 0 )
goto V_75;
if ( V_22 == V_82 ) {
struct V_83 * V_84 = (struct V_83 * ) V_9 -> V_13 ;
switch ( F_34 ( V_84 -> V_28 . V_85 ) ) {
default:
if ( F_36 ( & V_4 -> V_86 ) ) {
F_15 ( V_5 , L_22 ) ;
V_61 = - V_66 ;
...
static const char * F_40 ( enum V_94 V_67 )
{
switch ( V_67 ) {
case V_95 :
return L_25 ;
...
if ( V_4 -> V_112 [ V_56 ] . V_106 == V_106 )
V_115 =
V_4 -> V_112 [ V_56 ] . V_113 ;
}
return V_115 ;
}
...
if ( V_4 -> V_87 < sizeof( V_84 -> V_28 ) + sizeof( V_84 -> V_125 ) ) {
F_46 ( V_5 , L_39 ,
V_4 -> V_87 ) ;
return - V_42 ;
}
V_84 = (struct V_83 * ) V_4 -> V_89 ;
V_85 = F_34 ( V_84 -> V_28 . V_85 ) ;
V_120 = F_34 ( V_84 -> V_125 . V_120 ) ;
V_121 = F_34 ( V_84 -> V_125 . V_121 ) ;
if ( V_85 != V_126 ) {
F_46 ( V_5 , L_40 , V_85 ) ;
return - V_42 ;
}
...
V_117 . V_23 . V_24 = F_3 ;
V_117 . V_23 . V_93 = F_39 ;
V_117 . V_127 = V_128 ;
V_117 . V_106 = V_96 ;
V_61 = F_47 ( V_4 , & V_117 , & V_119 ) ;
if ( V_61 ) {
F_46 ( V_5 , L_43 ,
V_61 ) ;
return V_61 ;
...
V_59 = sizeof( V_84 -> V_28 ) + sizeof( V_84 -> V_141 ) ;
F_48 ( V_9 , V_59 ) ;
memset ( V_9 -> V_13 , 0 , V_59 ) ;
V_84 = (struct V_83 * ) V_9 -> V_13 ;
V_84 -> V_28 . V_85 =
F_19 ( V_142 ) ;
V_29 |= F_49 ( V_137 , V_143 ) ;
if ( V_117 -> V_106 != V_97 ) {
V_29 |= V_144 ;
V_136 = true ;
}
V_130 = & V_84 -> V_141 ;
V_130 -> V_29 = F_19 ( V_29 ) ;
V_130 -> V_106 = F_19 ( V_117 -> V_106 ) ;
F_50 ( & V_4 -> V_86 ) ;
V_61 = F_22 ( V_4 , V_82 , V_9 ) ;
if ( V_61 ) {
F_4 ( V_9 ) ;
return V_61 ;
}
...
V_133 = & V_84 -> V_146 ;
V_85 = F_34 ( V_84 -> V_28 . V_85 ) ;
V_106 = F_34 ( V_133 -> V_106 ) ;
if ( ( V_85 != V_147 ) ||
( V_4 -> V_87 < sizeof( V_84 -> V_28 ) +
sizeof( V_84 -> V_146 ) ) ) {
F_46 ( V_5 , L_47 , V_85 ) ;
return - V_81 ;
}
...
L_48 ,
F_40 ( V_106 ) ,
V_133 -> V_61 , V_133 -> V_22 ) ;
V_119 -> V_148 = V_133 -> V_61 ;
if ( V_133 -> V_61 != V_149 ) {
F_46 ( V_5 , L_49 ,
F_40 ( V_106 ) ,
V_133 -> V_61 ) ;
...
V_134 = (enum V_33 ) V_133 -> V_22 ;
V_135 = F_34 ( V_133 -> V_135 ) ;
V_138:
if ( V_134 >= V_43 )
return - V_81 ;
if ( V_135 == 0 )
...
return - V_81 ;
V_119 -> V_22 = V_134 ;
V_119 -> V_150 = F_34 ( V_133 -> V_135 ) ;
V_2 -> V_106 = V_117 -> V_106 ;
V_2 -> V_109 = V_117 -> V_127 ;
V_2 -> V_108 = F_34 ( V_133 -> V_135 ) ;
V_2 -> V_26 = V_137 ;
V_2 -> V_151 = V_4 -> V_45 ;
V_2 -> V_27 = V_2 -> V_108 /
V_4 -> V_45 ;
if ( V_2 -> V_108 % V_4 -> V_45 )
V_2 -> V_27 ++ ;
V_2 -> V_23 = V_117 -> V_23 ;
V_61 = F_51 ( V_4 -> V_5 ,
V_2 -> V_106 ,
...
F_10 ( V_5 , V_139 ,
L_50 ,
F_40 ( V_2 -> V_106 ) , V_2 -> V_6 ,
V_2 -> V_152 , V_2 -> V_22 ) ;
F_10 ( V_5 , V_139 ,
L_51 ,
V_2 -> V_22 , V_2 -> V_76 , V_2 -> V_153 ) ;
if ( V_136 && V_2 -> V_25 ) {
V_2 -> V_25 = false ;
F_10 ( V_5 , V_139 ,
L_52 ,
F_40 ( V_2 -> V_106 ) , V_134 ) ;
}
return V_61 ;
}
struct V_8 * F_52 ( struct V_7 * V_5 , int V_154 )
{
struct V_8 * V_9 ;
...
if ( ! V_9 )
return - V_140 ;
F_48 ( V_9 , sizeof( V_84 -> V_28 ) + sizeof( V_84 -> V_155 ) ) ;
