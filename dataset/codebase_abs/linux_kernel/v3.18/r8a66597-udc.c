...
static void F_106 ( struct V_1 * V_1 , struct V_57 * V_21 )
{
T_1 V_4 ;
struct V_117 * V_118 ;
T_3 V_242 ;
...
static T_4 F_109 ( int V_252 , void * V_253 )
{
...
static void F_112 ( unsigned long V_253 )
{
struct V_1 * V_1 = (struct V_1 * ) V_253 ;
unsigned long V_274 ;
T_1 V_6 ;
F_113 ( & V_1 -> V_14 , V_274 ) ;
V_6 = F_2 ( V_1 , V_13 ) ;
if ( V_1 -> V_267 > 0 ) {
...
static int F_115 ( struct V_275 * V_276 ,
const struct V_90 * V_91 )
{
struct V_57 * V_21 ;
V_21 = F_116 ( V_276 , struct V_57 , V_21 ) ;
return F_49 ( V_21 , V_91 ) ;
}
static int F_117 ( struct V_275 * V_276 )
{
struct V_57 * V_21 ;
struct V_117 * V_118 ;
unsigned long V_274 ;
...
static struct V_278 * F_118 ( struct V_275 * V_276 ,
T_5 V_279 )
{
struct V_117 * V_118 ;
V_118 = F_119 ( sizeof( struct V_117 ) , V_279 ) ;
if ( ! V_118 )
return NULL ;
F_14 ( & V_118 -> V_22 ) ;
return & V_118 -> V_118 ;
}
static void F_120 ( struct V_275 * V_276 , struct V_278 * V_280 )
{
struct V_117 * V_118 ;
V_118 = F_116 ( V_280 , struct V_117 , V_118 ) ;
F_121 ( V_118 ) ;
}
...
static int F_123 ( struct V_275 * V_276 , struct V_278 * V_280 )
{
struct V_57 * V_21 ;
struct V_117 * V_118 ;
unsigned long V_274 ;
...
static int F_124 ( struct V_275 * V_276 , int V_283 )
{
struct V_57 * V_21 ;
struct V_117 * V_118 ;
unsigned long V_274 ;
...
static int F_125 ( struct V_275 * V_276 )
{
struct V_57 * V_21 ;
unsigned long V_274 ;
V_21 = F_116 ( V_276 , struct V_57 , V_21 ) ;
...
static void F_127 ( struct V_275 * V_276 )
{
struct V_57 * V_21 ;
unsigned long V_274 ;
V_21 = F_116 ( V_276 , struct V_57 , V_21 ) ;
...
static int F_128 ( struct V_286 * V_15 ,
struct V_287 * V_18 )
{
struct V_1 * V_1 = F_129 ( V_15 ) ;
if ( ! V_18
|| V_18 -> V_288 < V_228
|| ! V_18 -> V_239 )
return - V_67 ;
...
V_149 ) & V_266 ;
V_1 -> V_267 = V_268 ;
F_110 ( & V_1 -> V_269 , V_270 + F_111 ( 50 ) ) ;
}
return 0 ;
}
static int F_130 ( struct V_286 * V_15 ,
struct V_287 * V_18 )
{
struct V_1 * V_1 = F_129 ( V_15 ) ;
unsigned long V_274 ;
...
static int F_131 ( struct V_286 * V_289 )
{
struct V_1 * V_1 = F_129 ( V_289 ) ;
return F_2 ( V_1 , V_290 ) & 0x03FF ;
}
static int F_132 ( struct V_286 * V_15 , int V_291 )
{
struct V_1 * V_1 = F_129 ( V_15 ) ;
unsigned long V_274 ;
F_113 ( & V_1 -> V_14 , V_274 ) ;
...
static int F_133 ( struct V_286 * V_15 , int V_292 )
{
struct V_1 * V_1 = F_129 ( V_15 ) ;
if ( V_292 )
V_1 -> V_204 |= 1 << V_293 ;
...
static int T_6 F_134 ( struct V_294 * V_295 )
{
struct V_1 * V_1 = F_135 ( V_295 ) ;
F_136 ( & V_1 -> V_15 ) ;
F_137 ( & V_1 -> V_269 ) ;
F_120 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_210 ) ;
if ( V_1 -> V_46 -> V_47 ) {
F_138 ( V_1 -> V_296 ) ;
}
return 0 ;
}
static void F_139 ( struct V_275 * V_21 , struct V_278 * V_297 )
{
}
...
{
struct V_298 * V_299 ;
V_299 = F_141 ( V_295 , V_300 , L_20 ) ;
V_1 -> V_301 = F_142 ( & V_295 -> V_302 , V_299 ) ;
if ( F_143 ( V_1 -> V_301 ) )
...
V_1 = F_147 ( V_302 , sizeof( struct V_1 ) , V_212 ) ;
if ( V_1 == NULL )
return - V_81 ;
F_148 ( & V_1 -> V_14 ) ;
F_149 ( V_295 , V_1 ) ;
V_1 -> V_46 = F_150 ( V_302 ) ;
V_1 -> V_157 = V_306 == V_310 ;
V_1 -> V_15 . V_311 = & V_312 ;
V_1 -> V_15 . V_288 = V_228 ;
V_1 -> V_15 . V_313 = V_314 ;
F_151 ( & V_1 -> V_269 ) ;
V_1 -> V_269 . V_315 = F_112 ;
V_1 -> V_269 . V_316 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
if ( V_1 -> V_46 -> V_47 ) {
snprintf ( V_304 , sizeof( V_304 ) , L_22 , V_295 -> V_317 ) ;
V_1 -> V_296 = F_152 ( V_302 , V_304 ) ;
if ( F_143 ( V_1 -> V_296 ) ) {
F_17 ( V_302 , L_23 , V_304 ) ;
return F_144 ( V_1 -> V_296 ) ;
}
F_153 ( V_1 -> V_296 ) ;
}
if ( V_1 -> V_46 -> V_318 ) {
V_31 = F_140 ( V_1 , V_295 ) ;
if ( V_31 < 0 )
goto V_319;
}
F_12 ( V_1 ) ;
V_31 = F_154 ( V_302 , V_252 , F_109 , V_320 ,
V_314 , V_1 ) ;
if ( V_31 < 0 ) {
...
F_122 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_321 ,
& V_1 -> V_15 . V_321 ) ;
}
V_21 -> V_1 = V_1 ;
F_14 ( & V_21 -> V_22 ) ;
...
V_1 -> V_210 = F_118 ( & V_1 -> V_21 [ 0 ] . V_21 ,
V_212 ) ;
if ( V_1 -> V_210 == NULL ) {
V_31 = - V_81 ;
goto V_319;
}
V_1 -> V_210 -> V_324 = F_139 ;
V_31 = F_156 ( V_302 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_325;
F_157 ( V_302 , L_25 , V_326 ) ;
return 0 ;
V_325:
F_120 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_210 ) ;
V_319:
