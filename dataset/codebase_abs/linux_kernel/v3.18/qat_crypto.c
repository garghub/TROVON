...
char V_29 [ V_30 ] ;
F_22 ( & V_4 -> V_31 ) ;
F_23 ( V_27 , V_32 , sizeof( V_27 ) ) ;
if ( F_24 ( V_4 , V_33 , V_27 , V_29 ) )
return - V_34 ;
if ( F_25 ( V_29 , 0 , & V_23 ) )
return - V_34 ;
