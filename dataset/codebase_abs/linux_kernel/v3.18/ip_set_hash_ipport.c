...
if ( V_36 [ V_59 ] ) {
V_45 = F_24 ( V_36 [ V_59 ] , & V_41 ) ;
if ( V_45 )
return V_45 ;
if ( V_5 > V_41 )
F_25 ( V_5 , V_41 ) ;
} else if ( V_36 [ V_60 ] ) {
T_3 V_61 = F_20 ( V_36 [ V_60 ] ) ;
if ( ! V_61 || V_61 > 32 )
return - V_62 ;
F_26 ( V_5 , V_41 , V_61 ) ;
}
...
static inline bool
F_32 ( const struct V_63 * V_2 ,
const struct V_63 * V_3 ,
T_1 * V_4 )
{
return F_33 ( & V_2 -> V_5 . V_64 , & V_3 -> V_5 . V_64 ) &&
V_2 -> V_6 == V_3 -> V_6 &&
V_2 -> V_7 == V_3 -> V_7 ;
}
static bool
...
{
if ( F_35 ( V_9 , V_11 , & V_10 -> V_5 . V_64 ) ||
F_4 ( V_9 , V_12 , V_10 -> V_6 ) ||
F_5 ( V_9 , V_13 , V_10 -> V_7 ) )
goto V_14;
return 0 ;
...
{
T_2 V_25 = V_18 -> V_26 -> V_22 [ V_22 ] ;
struct V_63 V_27 = { . V_5 = { . V_65 = { 0 } } } ;
struct V_28 V_29 = F_8 ( V_9 , V_24 , V_18 ) ;
if ( ! F_38 ( V_9 , V_24 -> V_30 & V_31 ,
& V_27 . V_6 , & V_27 . V_7 ) )
return - V_32 ;
F_39 ( V_9 , V_24 -> V_30 & V_33 , & V_27 . V_5 . V_64 ) ;
return V_25 ( V_18 , & V_27 , & V_29 , & V_24 -> V_29 , V_24 -> V_34 ) ;
}
static int
...
return - V_56 ;
if ( ! ( V_44 || V_27 . V_7 == V_66 ) )
V_27 . V_6 = 0 ;
if ( V_22 == V_58 || ! V_44 || ! V_36 [ V_46 ] ) {
V_45 = V_25 ( V_18 , & V_27 , & V_29 , & V_29 , V_30 ) ;
return F_22 ( V_45 , V_30 ) ? 0 : V_45 ;
}
V_6 = F_27 ( V_27 . V_6 ) ;
