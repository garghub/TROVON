...
if ( V_2 -> V_443 . V_444 != V_445 ) {
F_146 ( V_416 , & V_446 ,
V_255 , 0 , 1 , 1 , 1 ) ;
F_146 ( V_416 , & V_446 ,
V_258 , 0 , 0x1f , 1 , 0x1f ) ;
} else {
F_147 ( F_148 ( V_416 , V_255 ) ,
F_60 , V_2 ) ;
F_147 ( F_148 ( V_416 , V_258 ) ,
F_60 , V_2 ) ;
}
F_4 ( V_2 ) ;
...
if ( V_44 )
goto V_442;
V_4 -> V_211 = F_131 ( V_2 , & V_452 , L_67 ) ;
if ( ! V_4 -> V_211 ) {
F_18 ( L_68 ) ;
V_44 = - V_453 ;
goto V_442;
...
V_4 -> V_211 -> V_456 -> V_381 = & V_4 -> V_454 ;
if ( V_2 -> V_5 . V_6 ) {
...
if ( V_2 -> V_343 == V_344 ) {
F_153 ( V_4 -> V_211 , V_465 ) ;
F_153 ( V_4 -> V_211 , V_466 ) ;
}
...
if ( F_3 ( V_2 ) == 1 ) {
V_4 -> V_350 = F_131 ( V_2 , & V_452 ,
L_70 ) ;
V_4 -> V_350 -> V_456 = & V_4 -> V_236 ;
V_4 -> V_350 -> V_456 -> V_381 = & V_4 -> V_455 ;
...
if ( V_333 [ V_2 -> V_334 ] . V_403 . type == V_470 ) {
V_4 -> V_351 = F_131 ( V_2 , & V_471 ,
L_72 ) ;
if ( ! V_4 -> V_351 ) {
F_18 ( L_68 ) ;
V_44 = - V_453 ;
