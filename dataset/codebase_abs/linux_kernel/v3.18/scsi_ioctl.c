...
V_107 = F_39 ( - 1 , V_97 -> V_150 , V_97 -> V_146 ,
0 , NULL , & V_149 ) ;
if ( V_107 < 0 ) {
F_40 ( V_149 ) ;
goto V_145;
...
V_107 = 0 ;
if ( V_97 -> V_131 < V_147 ) {
V_97 -> V_146 = F_41 ( V_149 ,
V_97 -> V_146 ,
V_97 -> V_131 ) ;
V_147 = V_97 -> V_131 ;
}
V_107 = F_42 ( V_4 , V_95 , NULL , (struct V_151 * ) V_149 ,
V_97 -> V_146 ,
V_147 , V_142 ) ;
F_40 ( V_149 ) ;
} else if ( V_97 -> V_131 )
V_107 = F_43 ( V_4 , V_95 , NULL , V_97 -> V_150 , V_97 -> V_131 ,
V_142 ) ;
if ( V_107 )
goto V_145;
V_105 = V_95 -> V_105 ;
...
V_95 -> V_152 = 0 ;
V_126 = V_153 ;
F_44 ( V_4 , V_125 , V_95 , V_128 ) ;
V_97 -> V_154 = F_45 ( V_153 - V_126 ) ;
...
int F_47 ( struct V_3 * V_4 , struct V_124 * V_156 , T_2 V_98 ,
...
if ( V_161 && F_50 ( V_4 , V_95 , V_164 , V_161 , V_172 ) ) {
V_7 = V_183 << 24 ;
goto error;
}
memset ( V_123 , 0 , sizeof( V_123 ) ) ;
...
static int F_51 ( struct V_3 * V_4 , struct V_124 * V_125 ,
int V_89 , int V_168 )
{
struct V_94 * V_95 ;
int V_7 ;
...
V_95 -> V_89 [ 4 ] = V_168 ;
V_95 -> V_100 = 6 ;
V_7 = F_44 ( V_4 , V_125 , V_95 , 0 ) ;
F_46 ( V_95 ) ;
return V_7 ;
}
static inline int F_52 ( struct V_3 * V_4 ,
struct V_124 * V_125 , int V_168 )
{
return F_51 ( V_4 , V_125 , V_185 , V_168 ) ;
}
int F_53 ( struct V_3 * V_4 , struct V_124 * V_125 , T_2 V_98 ,
...
case V_210 :
F_54 ( V_211 L_1 , V_212 -> V_213 ) ;
V_7 = - V_12 ;
if ( ! V_186 )
break;
V_7 = F_47 ( V_4 , V_125 , V_98 , V_186 ) ;
break;
case V_214 :
V_7 = F_52 ( V_4 , V_125 , 0x03 ) ;
break;
case V_215 :
V_7 = F_52 ( V_4 , V_125 , 0x02 ) ;
break;
default:
V_7 = - V_216 ;
}
...
int F_55 ( struct V_217 * V_218 , unsigned int V_89 )
{
...
int F_57 ( struct V_217 * V_218 , T_2 V_98 ,
unsigned int V_89 , void T_1 * V_186 )
{
int V_107 ;
V_107 = F_55 ( V_218 , V_89 ) ;
if ( V_107 < 0 )
return V_107 ;
return F_53 ( V_218 -> V_125 -> V_224 , V_218 -> V_125 , V_98 , V_89 , V_186 ) ;
}
