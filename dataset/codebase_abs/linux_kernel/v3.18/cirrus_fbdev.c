...
return - V_70 ;
V_34 -> V_37 = V_58 ;
V_18 = F_26 ( V_60 -> V_48 , & V_58 -> V_15 , & V_45 , V_52 ) ;
if ( V_18 )
return V_18 ;
V_58 -> V_32 = V_32 ;
V_58 -> V_51 = V_51 ;
...
V_34 -> V_24 = V_74 ;
V_34 -> V_75 = & V_76 ;
F_28 ( V_34 , V_63 -> V_31 [ 0 ] , V_63 -> V_50 ) ;
F_29 ( V_34 , & V_58 -> V_49 , V_57 -> V_77 ,
V_57 -> V_78 ) ;
V_34 -> V_79 = F_30 ( 1 ) ;
if ( ! V_34 -> V_79 ) {
V_18 = - V_70 ;
...
V_34 -> V_72 . V_86 = V_60 -> V_48 -> V_82 . V_83 ;
V_34 -> V_72 . V_87 = V_60 -> V_84 . V_85 ;
V_34 -> V_88 = V_32 ;
V_34 -> V_89 = V_51 ;
V_34 -> V_72 . V_90 = 0 ;
V_34 -> V_72 . V_91 = 0 ;
V_18 = F_31 ( & V_34 -> V_92 , 256 , 0 ) ;
if ( V_18 ) {
F_8 ( L_5 , V_34 -> V_72 . V_73 ) ;
V_18 = - V_70 ;
goto V_80;
}
F_27 ( L_6 , V_34 -> V_72 . V_86 ) ;
F_27 ( L_7 , ( unsigned long ) V_34 -> V_72 . V_86 ) ;
F_27 ( L_8 , ( unsigned long ) V_34 -> V_72 . V_87 ) ;
F_27 ( L_9 , V_63 -> V_50 ) ;
F_27 ( L_10 , V_63 -> V_31 [ 0 ] ) ;
return 0 ;
V_80:
return V_18 ;
}
...
int F_41 ( struct V_59 * V_60 )
{
struct V_1 * V_58 ;
int V_18 ;
int V_95 = 24 ;
V_58 = F_42 ( sizeof( struct V_1 ) , V_96 ) ;
if ( ! V_58 )
return - V_70 ;
V_60 -> V_97 . V_58 = V_58 ;
F_43 ( & V_58 -> V_25 ) ;
F_44 ( V_60 -> V_48 , & V_58 -> V_49 ,
& V_98 ) ;
V_18 = F_45 ( V_60 -> V_48 , & V_58 -> V_49 ,
V_60 -> V_99 , V_100 ) ;
if ( V_18 ) {
F_46 ( V_58 ) ;
return V_18 ;
...
void F_50 ( struct V_59 * V_60 )
{
if ( ! V_60 -> V_97 . V_58 )
return;
F_32 ( V_60 -> V_48 , V_60 -> V_97 . V_58 ) ;
F_46 ( V_60 -> V_97 . V_58 ) ;
V_60 -> V_97 . V_58 = NULL ;
}
