...
if ( ( V_2 -> type == V_90 ) || ( V_2 -> type == V_92 ) ) {
struct V_123 * V_123 ;
F_30 () ;
V_123 = F_31 ( V_2 -> V_59 ) ;
if ( ! V_123 ) {
...
V_61 = F_39 ( V_2 -> type , V_2 -> V_43 , V_33 ,
( void * * ) & V_2 -> V_14 ) ;
if ( V_61 == - V_34 ) {
F_40 ( L_2 ,
V_33 ) ;
...
goto V_120;
V_28 -> V_20 . V_127 += V_2 -> V_59 ;
V_61 = F_41 ( & V_28 -> V_20 , V_33 , V_2 -> V_59 , V_2 -> V_43 ) ;
if ( V_61 ) {
F_2 ( V_33 ) ;
goto V_120;
}
...
goto V_120;
V_28 -> V_20 . V_127 += V_2 -> V_59 ;
V_61 = F_42 ( & V_28 -> V_20 , V_33 , V_2 -> V_43 ) ;
F_2 ( V_33 ) ;
if ( V_61 )
goto V_120;
break;
...
static inline T_2 F_44 ( void * * V_30 , const char * V_33 )
{
...
static struct V_60 * F_45 ( struct V_18 * V_38 )
{
struct V_60 * V_114 ;
void * V_30 ;
int V_17 ;
...
static int F_48 ( struct V_18 * V_129 , struct V_18 * V_130 )
{
int V_17 ;
...
break;
case V_104 :
if ( strcmp ( F_46 ( V_129 -> V_21 ) ,
F_46 ( V_130 -> V_21 ) ) )
return 1 ;
break;
case V_105 :
if ( strcmp ( F_47 ( V_129 -> V_42 ) ,
F_47 ( V_130 -> V_42 ) ) )
return 1 ;
break;
case V_106 :
...
case V_83 :
case V_84 :
if ( ! F_49 ( V_129 -> V_22 [ V_17 ] . V_125 , V_130 -> V_22 [ V_17 ] . V_125 ) )
return 1 ;
break;
case V_85 :
case V_86 :
...
case V_88 :
case V_89 :
if ( ! F_50 ( V_129 -> V_22 [ V_17 ] . V_126 , V_130 -> V_22 [ V_17 ] . V_126 ) )
return 1 ;
break;
default:
...
static inline int F_51 ( struct V_1 * V_131 ,
struct V_1 * V_132 )
{
int V_133 = 0 ;
char * V_13 ;
V_13 = F_52 ( V_132 -> V_13 , V_29 ) ;
if ( F_10 ( ! V_13 ) )
return - V_37 ;
V_131 -> V_13 = V_13 ;
V_133 = F_39 ( V_131 -> type , V_131 -> V_43 , V_131 -> V_13 ,
( void * * ) & V_131 -> V_14 ) ;
if ( V_133 == - V_34 ) {
F_40 ( L_2 ,
V_131 -> V_13 ) ;
...
struct V_15 * F_53 ( struct V_18 * V_134 )
{
...
case V_11 :
case V_12 :
V_61 = F_51 ( & V_136 -> V_22 [ V_17 ] ,
& V_134 -> V_22 [ V_17 ] ) ;
break;
case V_106 :
V_137 = F_52 ( V_134 -> V_24 , V_29 ) ;
if ( F_10 ( ! V_137 ) )
V_61 = - V_37 ;
else
V_136 -> V_24 = V_137 ;
...
static struct V_15 * F_55 ( struct V_15 * V_28 ,
struct V_139 * * V_48 )
{
...
int V_141 ;
if ( V_28 -> V_20 . V_41 ) {
V_141 = F_56 ( V_28 -> V_20 . V_41 -> V_59 ) ;
...
static inline int F_58 ( struct V_15 * V_28 )
{
struct V_15 * V_16 ;
...
static inline int F_67 ( struct V_15 * V_28 )
{
struct V_15 * V_16 ;
struct V_146 * V_21 = V_28 -> V_20 . V_21 ;
struct V_147 * V_42 = V_28 -> V_20 . V_42 ;
...
static void F_73 ( T_4 V_157 , int V_158 , struct V_159 * V_160 )
{
struct V_161 * V_162 ;
struct V_18 * V_163 ;
int V_17 ;
for ( V_17 = 0 ; V_17 < V_164 ; V_17 ++ ) {
F_57 (r, &audit_rules_list[i], list) {
struct V_60 * V_114 ;
V_114 = F_45 ( V_163 ) ;
if ( F_10 ( ! V_114 ) )
break;
V_162 = F_74 ( V_157 , V_158 , V_165 ,
0 , 1 , V_114 ,
...
V_162 = F_74 ( V_157 , V_158 , V_165 , 1 , 1 , NULL , 0 ) ;
if ( V_162 )
F_75 ( V_160 , V_162 ) ;
}
static void F_76 ( char * V_66 , struct V_18 * V_20 , int V_166 )
{
struct V_167 * V_168 ;
T_5 V_169 = F_77 ( & V_170 , F_78 ( V_171 ) ) ;
unsigned int V_172 = F_79 ( V_171 ) ;
if ( ! V_173 )
return;
V_168 = F_80 ( NULL , V_29 , V_174 ) ;
if ( ! V_168 )
return;
F_81 ( V_168 , L_3 , V_169 , V_172 ) ;
F_82 ( V_168 ) ;
F_81 ( V_168 , L_4 ) ;
F_83 ( V_168 , V_66 ) ;
F_84 ( V_168 , V_20 -> V_24 ) ;
F_81 ( V_168 , L_5 , V_20 -> V_39 , V_166 ) ;
F_85 ( V_168 ) ;
}
int F_86 ( int type , T_4 V_157 , int V_158 , void * V_114 ,
T_2 V_115 )
{
int V_61 = 0 ;
struct V_15 * V_28 ;
...
case V_175 :
V_61 = F_58 ( V_28 ) ;
F_76 ( L_6 , & V_28 -> V_20 , ! V_61 ) ;
break;
case V_176 :
V_61 = F_67 ( V_28 ) ;
F_76 ( L_7 , & V_28 -> V_20 , ! V_61 ) ;
break;
default:
V_61 = - V_34 ;
F_88 ( 1 ) ;
...
int F_89 ( struct V_161 * V_177 , int V_158 )
{
T_1 V_157 = F_90 ( V_177 ) . V_157 ;
struct V_178 * V_178 = F_91 ( F_90 ( V_177 ) . V_179 ) ;
struct V_180 * V_181 ;
struct V_182 * V_183 ;
int V_61 = 0 ;
...
if ( ! V_183 )
return - V_37 ;
V_183 -> V_178 = F_92 ( V_178 ) ;
V_183 -> V_157 = V_157 ;
F_93 ( & V_183 -> V_160 ) ;
F_59 ( & V_149 ) ;
F_73 ( V_157 , V_158 , & V_183 -> V_160 ) ;
F_60 ( & V_149 ) ;
V_181 = F_94 ( V_184 , V_183 , L_8 ) ;
if ( F_29 ( V_181 ) ) {
F_95 ( & V_183 -> V_160 ) ;
F_2 ( V_183 ) ;
V_61 = F_87 ( V_181 ) ;
...
int F_96 ( T_1 V_185 , T_1 V_43 , T_1 V_186 )
{
switch ( V_43 ) {
case V_44 :
return ( V_185 == V_186 ) ;
...
int F_98 ( T_6 V_185 , T_1 V_43 , T_6 V_186 )
{
switch ( V_43 ) {
case V_44 :
return F_49 ( V_185 , V_186 ) ;
case V_45 :
return ! F_49 ( V_185 , V_186 ) ;
case V_187 :
return F_99 ( V_185 , V_186 ) ;
case V_188 :
...
int F_103 ( T_7 V_185 , T_1 V_43 , T_7 V_186 )
{
switch ( V_43 ) {
case V_44 :
return F_50 ( V_185 , V_186 ) ;
case V_45 :
return ! F_50 ( V_185 , V_186 ) ;
case V_187 :
return F_104 ( V_185 , V_186 ) ;
case V_188 :
return F_105 ( V_185 , V_186 ) ;
case V_189 :
return F_106 ( V_185 , V_186 ) ;
case V_190 :
return F_107 ( V_185 , V_186 ) ;
case V_98 :
case V_99 :
default:
F_97 () ;
...
int F_109 ( const char * V_193 , const char * V_191 , int V_194 )
{
int V_195 , V_196 ;
const char * V_48 ;
V_195 = strlen ( V_193 ) ;
...
if ( V_196 < V_195 )
return 1 ;
V_194 = V_194 == V_197 ? F_108 ( V_191 ) : V_194 ;
if ( V_196 - V_194 != V_195 )
return 1 ;
V_48 = V_191 + V_194 ;
return strncmp ( V_48 , V_193 , V_195 ) ;
}
static int F_110 ( struct V_18 * V_20 , int type ,
enum V_198 * V_199 )
{
int V_17 ;
...
case V_90 :
V_123 = F_111 ( V_171 ) ;
V_200 = F_96 ( V_123 , V_2 -> V_43 , V_2 -> V_59 ) ;
break;
case V_79 :
V_200 = F_98 ( F_112 () , V_2 -> V_43 , V_2 -> V_125 ) ;
break;
case V_85 :
V_200 = F_103 ( F_113 () , V_2 -> V_43 , V_2 -> V_126 ) ;
break;
case V_83 :
V_200 = F_98 ( F_78 ( V_171 ) ,
V_2 -> V_43 , V_2 -> V_125 ) ;
break;
case V_107 :
V_200 = F_96 ( F_114 ( V_171 ) ,
V_2 -> V_43 , V_2 -> V_59 ) ;
break;
case V_78 :
V_200 = F_96 ( type , V_2 -> V_43 , V_2 -> V_59 ) ;
break;
case V_3 :
case V_4 :
case V_5 :
...
switch ( V_20 -> V_66 ) {
case V_72 : * V_199 = V_202 ; break;
case V_67 : * V_199 = V_203 ; break;
}
return 1 ;
}
int F_117 ( int type )
...
V_133 = 1 ;
F_30 () ;
F_118 (e, &audit_filter_list[AUDIT_FILTER_USER], list) {
V_204 = F_110 ( & V_16 -> V_20 , type , & V_199 ) ;
if ( V_204 ) {
if ( V_204 > 0 && V_199 == V_202 )
V_133 = 0 ;
break;
}
}
...
if ( F_120 ( & V_145 [ V_70 ] ) )
goto V_205;
F_118 (e, &audit_filter_list[AUDIT_FILTER_TYPE],
list) {
int V_17 ;
...
static int F_121 ( struct V_18 * V_163 )
{
...
F_124 ( & V_163 -> V_207 , & V_206 -> V_20 . V_207 ) ;
F_125 ( & V_28 -> V_47 , & V_206 -> V_47 ) ;
F_126 ( & V_163 -> V_47 , & V_206 -> V_20 . V_47 ) ;
}
F_72 ( & V_28 -> V_27 , F_6 ) ;
return V_61 ;
}
