...
struct V_181 * V_182 ;
struct V_181 * V_183 ;
F_58 (list, next, &bus_info_head ) {
V_14 = F_59 ( V_182 , struct V_14 , V_148 ) ;
F_5 ( V_14 ) ;
}
}
void F_60 ( void )
...
struct V_181 * V_183 ;
int V_184 = 0 ;
F_58 (list, next, &ebda_hpc_head) {
V_3 = F_59 ( V_182 , struct V_3 , V_1 ) ;
if ( V_3 -> V_49 == 0 )
F_61 ( V_3 -> V_50 . V_54 . V_55 , ( V_3 -> V_50 . V_54 . V_56 - V_3 -> V_50 . V_54 . V_55 + 1 ) ) ;
else if ( ( V_3 -> V_49 == 1 ) && ( ! V_184 ) ) {
++ V_184 ;
F_62 ( & V_185 ) ;
}
F_6 ( V_3 ) ;
...
struct V_181 * V_182 ;
struct V_181 * V_183 ;
F_58 (list, next, &ibmphp_ebda_pci_rsrc_head) {
V_186 = F_59 ( V_182 , struct V_13 , V_175 ) ;
F_5 ( V_186 ) ;
V_186 = NULL ;
}
}
...
static int F_66 ( struct V_187 * V_188 , const struct V_189 * V_190 )
{
struct V_3 * V_113 ;
F_11 ( L_73 ) ;
F_10 (ctrl, &ebda_hpc_head, ebda_hpc_list) {
if ( V_113 -> V_49 == 1 ) {
if ( ( V_188 -> V_191 == V_113 -> V_50 . V_51 . V_36 ) && ( V_188 -> V_52 -> V_40 == V_113 -> V_50 . V_51 . V_52 ) ) {
V_113 -> V_192 = V_188 ;
F_11 ( L_74 ) ;
F_11 ( L_75 , V_188 -> V_170 , V_188 -> V_193 ) ;
return 0 ;
}
}
}
