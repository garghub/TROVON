...
V_62 . V_68 = V_2 -> V_15 . V_69 ;
V_62 . V_70 = V_2 -> V_15 . V_22 ;
V_62 . V_71 = 0 ;
V_62 . V_72 = 0 ;
V_2 -> V_5 += V_62 . V_38 ;
...
V_2 -> V_65 = NULL ;
F_6 ( V_2 -> V_2 , L_20 ) ;
F_35 (cb, next, &dev->amthif_cmd_list.list, list) {
F_20 ( & V_35 -> V_54 ) ;
if ( ! V_35 -> V_14 )
continue;
V_82 = F_24 ( V_2 , V_35 ) ;
...
int F_40 ( struct V_13 * V_14 , struct V_33 * V_35 ,
struct V_33 * V_88 )
{
...
V_90 = V_91 ;
V_89 = ( V_91 * sizeof( T_5 ) ) - sizeof( struct V_61 ) ;
V_62 . V_38 = V_89 ;
V_62 . V_67 = 0 ;
} else {
return 0 ;
}
F_6 ( V_2 -> V_2 , V_93 , F_44 ( & V_62 ) ) ;
V_42 = F_28 ( V_2 , & V_62 ,
V_2 -> V_29 + V_2 -> V_5 ) ;
if ( V_42 ) {
V_2 -> V_8 = V_9 ;
...
struct V_33 * V_35 ;
unsigned char * V_95 ;
F_47 ( V_62 -> V_70 != V_2 -> V_15 . V_22 ) ;
F_47 ( V_2 -> V_8 != V_96 ) ;
V_95 = V_2 -> V_29 + V_2 -> V_5 ;
F_47 ( V_2 -> V_27 < V_2 -> V_5 + V_62 -> V_38 ) ;
F_48 ( V_2 , V_95 , V_62 -> V_38 ) ;
V_2 -> V_5 += V_62 -> V_38 ;
if ( ! V_62 -> V_67 )
return 0 ;
F_6 ( V_2 -> V_2 , L_24 ,
...
void F_52 ( struct V_1 * V_2 , struct V_33 * V_35 )
{
if ( V_2 -> V_6 != 1 ) {
V_2 -> V_8 = V_85 ;
V_2 -> V_11 = 0 ;
...
const struct V_34 * V_34 , struct V_102 * V_103 )
{
struct V_33 * V_104 = NULL ;
struct V_33 * V_105 = NULL ;
bool V_106 = false ;
F_35 (cb_pos, cb_next, mei_cb_list, list) {
if ( V_34 == V_104 -> V_36 ) {
F_20 ( & V_104 -> V_54 ) ;
if ( V_2 -> V_3 == V_104 ) {
V_2 -> V_3 = NULL ;
...
static bool F_55 ( struct V_1 * V_2 , struct V_34 * V_34 )
{
bool V_106 = false ;
F_54 ( V_2 , V_34 , & V_2 -> V_80 . V_54 ) ;
if ( F_54 ( V_2 , V_34 , & V_2 -> V_101 . V_54 ) )
V_106 = true ;
F_54 ( V_2 , V_34 , & V_2 -> V_107 . V_54 ) ;
if ( F_54 ( V_2 , V_34 , & V_2 -> V_108 . V_54 ) )
V_106 = true ;
if ( F_54 ( V_2 , V_34 , & V_2 -> V_76 . V_54 ) )
V_106 = true ;
if ( F_54 ( V_2 , V_34 , & V_2 -> V_77 . V_54 ) )
V_106 = true ;
if ( V_2 -> V_3 && ! V_106 ) {
...
int F_56 ( struct V_1 * V_2 , struct V_34 * V_34 )
{
if ( V_2 -> V_12 > 0 )
V_2 -> V_12 -- ;
if ( V_2 -> V_65 == V_34 &&
