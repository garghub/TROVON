...
{
int V_69 = 0 ;
V_69 |= F_28 ( & V_36 -> V_67 , V_70 | V_68 ) ;
V_69 |= F_28 ( & V_36 -> V_71 , V_72 ) ;
V_69 |= F_28 ( & V_36 -> V_73 , V_70 ) ;
V_69 |= F_28 ( & V_36 -> V_74 , V_48 ) ;
V_69 |= F_28 ( & V_36 -> V_47 , V_48 | V_75 ) ;
if ( V_69 )
return 1 ;
V_69 |= F_29 ( V_36 -> V_67 ) ;
V_69 |= F_29 ( V_36 -> V_47 ) ;
if ( V_69 )
return 2 ;
V_69 |= F_30 ( & V_36 -> V_64 , 0 ) ;
V_69 |= F_30 ( & V_36 -> V_76 , 0 ) ;
V_69 |= F_30 ( & V_36 -> V_77 , 0 ) ;
V_69 |= F_30 ( & V_36 -> V_78 , V_36 -> V_42 ) ;
if ( V_36 -> V_47 == V_48 )
V_69 |= F_31 ( & V_36 -> V_66 , 1 ) ;
else
V_69 |= F_30 ( & V_36 -> V_66 , 0 ) ;
if ( V_69 )
return 3 ;
return 0 ;
}
...
F_3 ( F_42 ( V_61 ) , V_9 + V_94 ) ;
F_3 ( 0 , V_9 + V_95 ) ;
F_3 ( V_36 | V_96 , V_9 + V_97 ) ;
V_25 = F_36 ( V_2 , V_14 , V_16 , F_39 , 0 ) ;
if ( V_25 )
return V_25 ;
for ( V_39 = 0 ; V_39 < V_16 -> V_24 ; V_39 ++ ) {
unsigned int V_3 = V_17 [ V_39 ] ;
F_3 ( V_3 & 0xff , V_9 + V_94 ) ;
F_3 ( ( V_3 >> 8 ) & 0xff , V_9 + V_95 ) ;
F_3 ( V_36 | V_98 ,
V_9 + V_97 ) ;
V_25 = F_36 ( V_2 , V_14 , V_16 , F_39 , 0 ) ;
if ( V_25 )
...
struct V_13 * V_14 ;
int V_25 ;
V_25 = F_44 ( V_2 , V_101 -> V_102 [ 0 ] , 32 ) ;
if ( V_25 )
return V_25 ;
...
F_14 ( V_2 ) ;
if ( V_101 -> V_102 [ 1 ] ) {
V_25 = F_47 ( V_101 -> V_102 [ 1 ] , F_20 , 0 ,
V_2 -> V_104 , V_2 ) ;
if ( V_25 == 0 ) {
V_2 -> V_51 = V_101 -> V_102 [ 1 ] ;
F_3 ( V_105 ,
V_2 -> V_9 + V_106 ) ;
F_3 ( F_48 ( V_2 -> V_51 ) ,
V_2 -> V_9 + V_107 ) ;
