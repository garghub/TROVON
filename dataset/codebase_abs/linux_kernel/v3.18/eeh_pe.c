...
static void * F_32 ( void * V_12 , void * V_23 )
{
struct V_3 * V_6 = (struct V_3 * ) V_12 ;
int V_41 = * ( ( int * ) V_23 ) ;
struct V_25 * V_26 , * V_27 ;
...
void F_34 ( struct V_3 * V_6 , int V_41 )
{
F_15 ( V_6 , F_32 , & V_41 ) ;
}
...
void F_36 ( struct V_3 * V_6 , int V_55 )
{
F_16 ( V_6 , F_35 , & V_55 ) ;
}
static void * F_37 ( void * V_12 , void * V_23 )
{
struct V_3 * V_6 = (struct V_3 * ) V_12 ;
int V_41 = * ( ( int * ) V_23 ) ;
struct V_25 * V_26 , * V_27 ;
...
void F_38 ( struct V_3 * V_6 , int V_41 )
{
F_15 ( V_6 , F_37 , & V_41 ) ;
}
...
F_41 ( V_26 -> V_30 & 0xFF ) ) ;
V_58 = V_26 -> V_63 ;
V_64 -> V_65 ( V_32 , V_58 + V_66 , 2 , & V_59 ) ;
if ( ! ( V_59 & V_67 ) ) {
F_10 ( L_10 , V_59 ) ;
return;
}
V_64 -> V_65 ( V_32 , V_58 + V_68 , 2 , & V_59 ) ;
if ( V_59 & V_69 ) {
V_64 -> V_65 ( V_32 , V_58 + V_70 , 2 , & V_59 ) ;
if ( V_59 & V_71 ) {
F_10 ( L_11 ) ;
V_59 &= ~ ( V_71 | V_72 ) ;
V_59 |= ( 0x0100 & V_72 ) ;
V_64 -> V_73 ( V_32 , V_58 + V_70 , 2 , V_59 ) ;
F_42 ( 2 * 1000 ) ;
}
}
V_64 -> V_65 ( V_32 , V_58 + V_74 , 2 , & V_59 ) ;
V_59 &= ~ V_75 ;
V_64 -> V_73 ( V_32 , V_58 + V_74 , 2 , V_59 ) ;
V_64 -> V_65 ( V_32 , V_58 + V_76 , 4 , & V_59 ) ;
if ( ! ( V_59 & V_77 ) ) {
F_10 ( L_12 , V_59 ) ;
F_42 ( 1000 ) ;
return;
...
F_42 ( 20 ) ;
V_60 += 20 ;
V_64 -> V_65 ( V_32 , V_58 + V_78 , 2 , & V_59 ) ;
if ( V_59 & V_79 )
break;
}
if ( V_59 & V_79 )
...
V_64 -> V_73 ( V_32 , V_81 * 4 , 4 , V_26 -> V_82 [ V_81 ] ) ;
V_64 -> V_73 ( V_32 , 14 * 4 , 4 , V_26 -> V_82 [ 14 ] ) ;
V_64 -> V_73 ( V_32 , V_83 , 1 ,
F_44 ( V_83 ) ) ;
V_64 -> V_73 ( V_32 , V_84 , 1 ,
F_44 ( V_84 ) ) ;
V_64 -> V_73 ( V_32 , 15 * 4 , 4 , V_26 -> V_82 [ 15 ] ) ;
V_64 -> V_73 ( V_32 , V_85 , 4 , V_26 -> V_82 [ 1 ] ) ;
F_39 ( V_26 , V_32 ) ;
}
...
V_64 -> V_73 ( V_32 , V_81 * 4 , 4 , V_26 -> V_82 [ V_81 ] ) ;
V_64 -> V_73 ( V_32 , 12 * 4 , 4 , V_26 -> V_82 [ 12 ] ) ;
V_64 -> V_73 ( V_32 , V_83 , 1 ,
F_44 ( V_83 ) ) ;
V_64 -> V_73 ( V_32 , V_84 , 1 ,
F_44 ( V_84 ) ) ;
V_64 -> V_73 ( V_32 , 15 * 4 , 4 , V_26 -> V_82 [ 15 ] ) ;
V_64 -> V_65 ( V_32 , V_85 , 4 , & V_86 ) ;
if ( V_26 -> V_82 [ 1 ] & V_87 )
V_86 |= V_87 ;
else
V_86 &= ~ V_87 ;
...
V_86 &= ~ V_88 ;
V_64 -> V_73 ( V_32 , V_85 , 4 , V_86 ) ;
}
static void * F_46 ( void * V_12 , void * V_23 )
{
struct V_25 * V_26 = (struct V_25 * ) V_12 ;
struct V_31 * V_32 = F_47 ( V_26 ) ;
if ( V_26 -> V_55 & V_89 )
F_43 ( V_26 , V_32 ) ;
else
F_45 ( V_26 , V_32 ) ;
...
struct V_31 * V_32 = F_51 ( V_92 ) ;
const char * V_93 = NULL ;
if ( ! V_32 )
goto V_94;
if ( F_52 ( V_92 ) ) {
V_93 = F_53 ( V_32 , L_17 , NULL ) ;
if ( ! V_93 )
V_93 = F_53 ( V_32 , L_18 , NULL ) ;
if ( V_93 )
goto V_94;
V_32 = V_32 -> V_10 ;
if ( ! V_32 )
...
V_26 = F_54 ( & V_6 -> V_11 , struct V_25 , V_36 ) ;
V_47 = F_33 ( V_26 ) ;
if ( V_47 )
V_92 = V_47 -> V_92 ;
}
