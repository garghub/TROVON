...
struct V_80 * V_81 )
{
struct V_64 * V_82 = NULL ;
struct V_57 * V_58 ;
int V_83 = V_2 -> V_14 -> V_15 . V_84 ;
struct V_3 * V_4 = & V_2 -> V_4 [ V_83 ] ;
T_2 V_85 , V_86 ;
int V_48 , V_87 ;
int V_25 = 0 ;
V_25 = F_39 ( V_2 , & V_82 ) ;
...
V_85 = ( V_79 << V_88 ) / 4 ;
V_87 = F_41 ( V_85 , 0xFFFE ) ;
V_25 = F_21 ( V_2 , V_4 , V_87 * 4 + 8 ) ;
if ( V_25 ) {
F_22 ( L_9 , V_25 ) ;
F_42 ( V_2 , & V_82 , NULL ) ;
return F_40 ( V_25 ) ;
}
F_43 ( V_2 , V_82 , V_81 , false ) ;
F_44 ( V_2 , V_82 , V_4 -> V_51 ) ;
for ( V_48 = 0 ; V_48 < V_87 ; V_48 ++ ) {
V_86 = V_85 ;
if ( V_86 > 0xFFFE )
V_86 = 0xFFFE ;
V_85 -= V_86 ;
F_23 ( V_4 , F_24 ( V_89 , 0 , 0 , V_86 ) ) ;
