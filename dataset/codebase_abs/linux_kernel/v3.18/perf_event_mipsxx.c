...
static unsigned int F_91 ( const struct V_76 * V_77 )
{
#ifdef F_92
return ( ( unsigned int ) V_77 -> V_78 << 24 ) |
( V_77 -> V_10 & 0xffff00 ) |
( V_77 -> V_79 & 0xff ) ;
#else
return ( V_77 -> V_10 & 0xffff00 ) |
( V_77 -> V_79 & 0xff ) ;
#endif
}
static const struct V_76 * F_93 ( int V_2 )
{
if ( ( * V_12 . V_80 ) [ V_2 ] . V_10 == 0 )
return F_94 ( - V_68 ) ;
return & ( * V_12 . V_80 ) [ V_2 ] ;
}
static const struct V_76 * F_95 ( T_1 V_81 )
{
...
{
struct V_25 * V_90 , * V_91 = V_26 -> V_92 ;
struct V_5 V_93 ;
memset ( & V_93 , 0 , sizeof( V_93 ) ) ;
if ( F_37 ( & V_93 , & V_91 -> V_43 ) < 0 )
return - V_86 ;
F_97 (sibling, &leader->sibling_list, group_entry) {
if ( F_37 ( & V_93 , & V_90 -> V_43 ) < 0 )
return - V_86 ;
}
if ( F_37 ( & V_93 , & V_26 -> V_43 ) < 0 )
return - V_86 ;
return 0 ;
}
static void F_98 ( struct V_5 * V_6 ,
int V_2 , struct V_94 * V_95 ,
struct V_96 * V_97 )
{
struct V_25 * V_26 = V_6 -> V_51 [ V_2 ] ;
struct V_7 * V_8 = & V_26 -> V_43 ;
F_53 ( V_26 , V_8 , V_2 ) ;
V_95 -> V_29 = V_26 -> V_43 . V_32 ;
if ( ! F_48 ( V_26 , V_8 , V_2 ) )
return;
if ( F_99 ( V_26 , V_95 , V_97 ) )
F_45 ( V_2 ) ;
}
...
static void V_67 ( void * V_103 )
{
int V_1 = ( int ) ( long ) V_103 ;
switch ( V_1 ) {
case 4 :
F_32 ( 3 , 0 ) ;
V_12 . V_36 ( 3 , 0 ) ;
...
{
struct V_107 * V_69 = & V_26 -> V_69 ;
struct V_7 * V_8 = & V_26 -> V_43 ;
const struct V_76 * V_77 ;
int V_48 ;
if ( V_71 == V_26 -> V_69 . type ) {
if ( V_26 -> V_69 . V_81 >= V_108 )
return - V_86 ;
V_77 = F_93 ( V_26 -> V_69 . V_81 ) ;
} else if ( V_72 == V_26 -> V_69 . type ) {
V_77 = F_95 ( V_26 -> V_69 . V_81 ) ;
} else if ( V_70 == V_26 -> V_69 . type ) {
F_87 ( & V_109 ) ;
V_77 = V_12 . V_110 ( V_26 -> V_69 . V_81 ) ;
} else {
return - V_68 ;
}
if ( F_106 ( V_77 ) ) {
if ( V_70 == V_26 -> V_69 . type )
F_82 ( & V_109 ) ;
return F_107 ( V_77 ) ;
}
V_8 -> V_18 = V_20 ;
...
do {
V_119 -- ;
V_6 -> V_17 [ V_119 ] = F_27 ( V_119 ) ;
F_32 ( V_119 , V_6 -> V_17 [ V_119 ] &
~ V_24 ) ;
} while ( V_119 > 0 );
F_47 ( V_23 ) ;
}
...
static T_3 V_56 ( int V_55 , void * V_126 )
{
return V_63 () ;
}
static const struct V_76 * F_115 ( T_1 V_81 )
{
...
V_127 > 127 ? V_132 : V_131 ;
#ifdef F_92
if ( F_127 ( V_127 , V_128 ) )
V_130 . V_78 = V_133 ;
else if ( F_50 ( F_128 ( V_127 ) ) )
V_130 . V_78 = V_104 ;
else
V_130 . V_78 = V_135 ;
#endif
...
static const struct V_76 * F_130 ( T_1 V_81 )
{
unsigned int V_127 = V_81 & 0xff ;
unsigned int V_128 = V_127 & 0x7f ;
V_130 . V_10 = V_143 ;
...
static const struct V_76 * F_131 ( T_1 V_81 )
{
unsigned int V_127 = V_81 & 0xff ;
if ( ( V_127 < 0x01 ) || ( V_127 > 0x3f ) )
return F_94 ( - V_68 ) ;
V_130 . V_10 = V_143 ;
V_130 . V_79 = V_127 ;
return & V_130 ;
...
V_12 . V_33 = ( 1ULL << 31 ) - 1 ;
V_12 . V_167 = ( 1ULL << 31 ) - 1 ;
V_12 . V_35 = 1ULL << 31 ;
V_12 . V_41 = F_6 ;
V_12 . V_36 = F_17 ;
V_145 = 32 ;
}
F_81 ( V_67 , ( void * ) ( long ) V_1 , 1 ) ;
F_134 ( L_23
L_24 , V_12 . V_151 , V_1 , V_145 , V_55 ,
V_55 < 0 ? L_25 : L_26 ) ;
F_137 ( & V_49 , L_27 , V_70 ) ;
return 0 ;
}
