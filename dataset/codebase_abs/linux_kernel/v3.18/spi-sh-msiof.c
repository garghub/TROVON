...
if ( V_100 ) {
V_103 |= V_118 | V_119 ;
F_55 ( V_2 -> V_69 -> V_120 -> V_121 -> V_70 ,
V_2 -> V_122 , V_102 , V_123 ) ;
V_105 = F_52 ( V_2 -> V_69 -> V_120 ,
V_2 -> V_122 , V_102 , V_123 ,
V_113 | V_114 ) ;
if ( ! V_105 ) {
V_84 = - V_115 ;
...
if ( V_101 )
F_57 ( V_2 -> V_69 -> V_110 -> V_121 -> V_70 ,
V_2 -> V_111 , V_102 ,
V_112 ) ;
return 0 ;
V_98:
...
static void F_59 ( T_1 * V_128 , const T_1 * V_129 , unsigned int V_53 )
{
...
static void F_60 ( T_1 * V_128 , const T_1 * V_129 , unsigned int V_53 )
{
if ( ( unsigned long ) V_129 & 3 ) {
while ( V_53 -- ) {
* V_128 ++ = F_61 ( F_24 ( V_129 ) ) ;
V_129 ++ ;
}
} else if ( ( unsigned long ) V_128 & 3 ) {
while ( V_53 -- ) {
F_33 ( F_61 ( * V_129 ++ ) , V_128 ) ;
V_128 ++ ;
}
} else {
while ( V_53 -- )
...
bool V_135 ;
int V_84 ;
F_11 ( V_2 , F_65 ( V_2 -> V_136 ) , V_131 -> V_137 ) ;
while ( V_69 -> V_120 && V_102 > 15 ) {
unsigned int V_138 = F_66 ( V_102 , V_139 * 4 ) ;
if ( V_52 <= 8 ) {
if ( V_138 & 3 )
break;
F_64 = F_59 ;
...
if ( V_50 )
F_64 ( V_2 -> V_140 , V_50 , V_138 / 4 ) ;
V_84 = F_51 ( V_2 , V_50 , V_51 , V_138 ) ;
if ( V_84 == - V_115 ) {
F_67 ( L_5 ,
F_68 ( & V_2 -> V_95 -> V_70 ) ,
F_69 ( & V_2 -> V_95 -> V_70 ) ) ;
...
V_53 = V_102 / V_133 ;
while ( V_53 > 0 ) {
V_134 = F_44 ( V_2 , F_45 , F_46 , V_50 , V_51 ,
V_53 , V_52 ) ;
if ( V_134 < 0 )
return V_134 ;
if ( V_50 )
...
static struct V_142 * F_70 ( struct V_121 * V_70 )
{
struct V_142 * V_143 ;
struct V_67 * V_68 = V_70 -> V_71 ;
T_1 V_144 = 1 ;
V_143 = F_71 ( V_70 , sizeof( struct V_142 ) , V_145 ) ;
if ( ! V_143 )
return NULL ;
F_72 ( V_68 , L_6 , & V_144 ) ;
F_72 ( V_68 , L_7 ,
...
static struct V_149 * F_73 ( struct V_121 * V_70 ,
...
{
struct V_167 * V_95 = V_2 -> V_95 ;
struct V_121 * V_70 = & V_95 -> V_70 ;
const struct V_142 * V_143 = F_81 ( V_70 ) ;
...
V_171 = F_82 ( V_95 , V_174 , 1 ) ;
if ( ! V_171 )
V_171 = F_82 ( V_95 , V_174 , 0 ) ;
V_69 = V_2 -> V_69 ;
V_69 -> V_120 = F_73 ( V_70 , V_159 ,
V_168 ,
V_171 -> V_175 + V_61 ) ;
if ( ! V_69 -> V_120 )
return - V_176 ;
V_69 -> V_110 = F_73 ( V_70 , V_177 ,
V_169 ,
V_171 -> V_175 + V_64 ) ;
if ( ! V_69 -> V_110 )
goto V_178;
V_2 -> V_140 = ( void * ) F_83 ( V_145 | V_179 ) ;
if ( ! V_2 -> V_140 )
goto V_180;
V_2 -> V_141 = ( void * ) F_83 ( V_145 | V_179 ) ;
if ( ! V_2 -> V_141 )
goto V_181;
V_172 = V_69 -> V_120 -> V_121 -> V_70 ;
V_2 -> V_122 = F_84 ( V_172 , V_2 -> V_140 , V_182 ,
V_123 ) ;
if ( F_85 ( V_172 , V_2 -> V_122 ) )
goto V_183;
V_173 = V_69 -> V_110 -> V_121 -> V_70 ;
V_2 -> V_111 = F_84 ( V_173 , V_2 -> V_141 , V_182 ,
V_112 ) ;
if ( F_85 ( V_173 , V_2 -> V_111 ) )
goto V_184;
F_86 ( V_70 , L_13 ) ;
return 0 ;
V_184:
F_87 ( V_172 , V_2 -> V_122 , V_182 , V_123 ) ;
V_183:
F_88 ( ( unsigned long ) V_2 -> V_141 ) ;
V_181:
F_88 ( ( unsigned long ) V_2 -> V_140 ) ;
V_180:
F_79 ( V_69 -> V_110 ) ;
V_178:
F_79 ( V_69 -> V_120 ) ;
...
return;
V_70 = & V_2 -> V_95 -> V_70 ;
F_87 ( V_69 -> V_110 -> V_121 -> V_70 , V_2 -> V_111 ,
V_182 , V_112 ) ;
F_87 ( V_69 -> V_120 -> V_121 -> V_70 , V_2 -> V_122 ,
V_182 , V_123 ) ;
F_88 ( ( unsigned long ) V_2 -> V_141 ) ;
F_88 ( ( unsigned long ) V_2 -> V_140 ) ;
F_79 ( V_69 -> V_110 ) ;
...
static int F_90 ( struct V_167 * V_95 )
{
struct V_170 * V_185 ;
struct V_81 * V_69 ;
...
F_92 ( V_95 , V_2 ) ;
V_2 -> V_69 = V_69 ;
V_187 = F_93 ( V_190 , & V_95 -> V_70 ) ;
if ( V_187 ) {
V_2 -> V_23 = V_187 -> V_11 ;
V_2 -> V_143 = F_70 ( & V_95 -> V_70 ) ;
} else {
V_2 -> V_23 = ( const void * ) V_95 -> V_191 -> V_192 ;
V_2 -> V_143 = F_81 ( & V_95 -> V_70 ) ;
}
if ( ! V_2 -> V_143 ) {
F_48 ( & V_95 -> V_70 , L_15 ) ;
V_84 = - V_193 ;
...
V_185 = F_82 ( V_95 , V_174 , 0 ) ;
V_2 -> V_6 = F_99 ( & V_95 -> V_70 , V_185 ) ;
if ( F_96 ( V_2 -> V_6 ) ) {
V_84 = F_97 ( V_2 -> V_6 ) ;
goto V_194;
}
V_84 = F_100 ( & V_95 -> V_70 , V_188 , F_9 , 0 ,
F_69 ( & V_95 -> V_70 ) , V_2 ) ;
if ( V_84 ) {
F_48 ( & V_95 -> V_70 , L_18 ) ;
goto V_194;
...
if ( V_2 -> V_143 -> V_146 )
V_2 -> V_90 = V_2 -> V_143 -> V_146 ;
if ( V_2 -> V_143 -> V_147 )
V_2 -> V_91 = V_2 -> V_143 -> V_147 ;
V_69 -> V_196 = V_76 | V_77 | V_80 ;
V_69 -> V_196 |= V_79 | V_78 ;
V_69 -> V_197 = V_2 -> V_23 -> V_24 ;
V_69 -> V_198 = V_95 -> V_152 ;
V_69 -> V_70 . V_71 = V_95 -> V_70 . V_71 ;
V_69 -> V_148 = V_2 -> V_143 -> V_148 ;
V_69 -> V_199 = F_38 ;
V_69 -> V_200 = F_41 ;
V_69 -> V_201 = F_102 ( 8 , 32 ) ;
V_69 -> V_202 = true ;
V_69 -> V_203 = F_63 ;
V_84 = F_80 ( V_2 ) ;
if ( V_84 < 0 )
...
static int F_106 ( struct V_167 * V_95 )
{
