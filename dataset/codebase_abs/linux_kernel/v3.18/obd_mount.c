...
sprintf ( V_43 , L_16 , V_56 , F_27 ( V_23 ) ) ;
V_45 = V_11 -> V_50 -> V_58 ? V_11 -> V_50 -> V_58 : L_17 ;
F_4 ( V_38 ) ;
if ( V_38 == NULL ) {
V_15 = - V_16 ;
goto V_57;
...
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_3 ( V_11 != NULL ) ;
F_15 ( V_33 , L_36 , V_2 , F_46 ( & V_11 -> V_98 ) ) ;
if ( F_47 ( & V_11 -> V_98 ) ) {
...
return V_15 ;
V_116 ++ ;
if ( strncmp ( V_116 , L_37 , 3 ) == 0 )
V_15 = V_122 ;
else if ( strncmp ( V_116 , L_38 , 3 ) == 0 )
V_15 = V_123 ;
else
return - V_19 ;
V_116 += 3 ;
if ( strncmp ( V_116 , L_39 , 3 ) == 0 ) {
if ( V_115 != NULL )
* V_115 = V_116 + 3 ;
return V_15 | V_124 ;
}
...
F_65 ( V_33 , L_43 ) ;
if ( F_32 ( V_127 ) )
F_65 ( V_33 , L_44 , V_127 -> V_101 ) ;
F_65 ( V_33 , L_45 , V_127 -> V_54 ) ;
F_65 ( V_33 , L_46 , V_127 -> V_69 ) ;
if ( V_127 -> V_102 )
F_65 ( V_33 , L_47 , V_127 -> V_102 ) ;
if ( V_127 -> V_96 )
F_65 ( V_33 , L_48 ,
V_127 -> V_96 ) ;
if ( V_127 -> V_97 )
...
while ( * V_25 == ' ' || * V_25 == ',' )
V_25 ++ ;
if ( strncmp ( V_25 , L_61 , 11 ) == 0 ) {
V_127 -> V_69 |= V_145 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_62 , 19 ) == 0 ) {
V_127 -> V_96 = F_73 ( int ,
...
V_127 -> V_69 |= V_72 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_65 , 5 ) == 0 ) {
V_127 -> V_69 |= V_146 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_66 , 5 ) == 0 ) {
V_127 -> V_69 |= V_147 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_67 , 7 ) == 0 ) {
V_127 -> V_69 |= V_148 ;
V_142 ++ ;
...
goto V_149;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_68 , 9 ) == 0 ) {
V_127 -> V_69 |= V_150 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_69 , 6 ) == 0 ) {
V_127 -> V_69 |= V_151 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_70 , 6 ) == 0 ) {
V_127 -> V_69 |= V_152 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_71 , 10 ) == 0 ) {
V_127 -> V_69 |= V_153 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_72 , 7 ) == 0 ) {
V_15 = F_69 ( V_127 , V_25 + 7 ) ;
if ( V_15 )
goto V_149;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_73 , 8 ) == 0 ) {
V_15 = F_68 ( V_127 , V_25 + 7 ) ;
if ( V_15 )
goto V_149;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_74 , 3 ) == 0 ) {
V_127 -> V_69 |= V_154 ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_75 , 7 ) == 0 ) {
V_15 = F_70 ( & V_127 -> V_101 , V_25 + 7 ) ;
if ( V_15 )
goto V_149;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_76 , 6 ) == 0 ) {
int V_132 ;
...
strcat ( V_127 -> V_105 , L_77 ) ;
V_142 ++ ;
} else if ( strncmp ( V_25 , L_78 , 4 ) == 0 ) {
V_15 = F_70 ( & V_127 -> V_104 , V_25 + 4 ) ;
if ( V_15 )
goto V_149;
V_142 ++ ;
}
else if ( strncmp ( V_25 , L_79 , 7 ) == 0 ) {
V_137 = V_25 + 7 ;
* V_25 = '\0' ;
break;
}
