...
V_51 = F_27 ( V_5 , V_70 ) ;
V_56 = V_71 ;
if ( V_14 <= F_28 ( V_5 , V_44 -> V_15 . V_72 ) )
V_59 = 0 ;
else
V_59 = F_2 ( V_5 , V_14 ) ;
V_65 = F_29 ( V_5 , V_46 -> V_73 , V_59 ) ;
error = F_30 ( V_51 , & F_31 ( V_5 ) -> V_74 , V_65 , 0 ) ;
if ( error == - V_75 && V_59 == 0 ) {
V_65 = 0 ;
error = F_30 ( V_51 , & F_31 ( V_5 ) -> V_74 , 0 , 0 ) ;
}
if ( error ) {
V_56 = 0 ;
goto V_76;
...
F_34 ( & V_53 , & V_54 ) ;
error = F_35 ( & V_51 , V_44 , V_82 | ( V_48 & ~ V_83 ) , 1 , 0 ,
...
V_2 -> V_39 . V_40 |= V_41 ;
V_2 -> V_15 . V_88 = V_89 ;
F_41 ( V_51 , V_2 , V_90 | V_91 ) ;
} else {
int V_21 ;
V_58 = 0 ;
V_17 = V_9 ;
error = F_42 ( V_51 , V_2 , V_58 , V_59 ,
V_92 , & V_54 , V_65 ,
V_8 , & V_17 , & V_53 ) ;
if ( error )
goto V_93;
...
if ( error )
goto V_93;
F_49 ( V_51 , V_44 , V_97 | V_98 ) ;
F_41 ( V_51 , V_44 , V_91 ) ;
if ( V_5 -> V_99 & ( V_100 | V_101 ) ) {
F_50 ( V_51 ) ;
}
error = F_51 ( & V_51 , & V_53 , & V_57 ) ;
if ( error ) {
goto V_93;
}
error = F_52 ( V_51 , V_71 ) ;
F_53 ( V_62 ) ;
F_53 ( V_63 ) ;
F_53 ( V_64 ) ;
* V_49 = V_2 ;
...
V_51 = F_27 ( V_5 , V_107 ) ;
error = F_30 ( V_51 , & F_31 ( V_5 ) -> V_108 , 0 , 0 ) ;
if ( error ) {
F_56 ( V_51 , 0 ) ;
return error ;
}
...
error = F_61 ( V_51 , V_2 , 0 , V_105 , V_92 , V_17 ,
& V_54 , & V_53 , & V_103 ) ;
if ( error )
goto V_110;
ASSERT ( V_103 ) ;
