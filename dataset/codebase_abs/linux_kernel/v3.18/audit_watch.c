...
struct V_4 * V_80 ,
struct V_4 * V_81 ,
T_2 V_22 , void * V_82 , int V_83 ,
const unsigned char * V_48 , T_2 V_84 )
{
struct V_7 * V_7 ;
struct V_1 * V_2 ;
V_2 = F_6 ( V_80 , struct V_1 , V_6 ) ;
F_67 ( V_78 != V_8 ) ;
switch ( V_83 ) {
case ( V_85 ) :
V_7 = ( (struct V_13 * ) V_82 ) -> V_17 -> V_18 ;
break;
case ( V_86 ) :
V_7 = (struct V_7 * ) V_82 ;
break;
