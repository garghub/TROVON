...
if ( V_46 & V_91 )
return - V_151 ;
if ( V_149 && F_106 ( V_149 , & V_29 . V_88 , sizeof *V_149 ) )
return - V_152 ;
V_150 -> V_153 = V_154 ;
V_150 -> V_155 . V_156 = V_8 ;
V_150 -> V_155 . V_149 = V_149 ;
V_150 -> V_155 . V_21 = F_107 ( V_145 ) ;
}
return error ;
}
...
static int F_111 ( const T_2 V_8 , int V_46 ,
struct V_14 * V_145 ,
struct V_14 T_4 * V_149 )
{
return F_104 ( V_157 , V_46 , V_145 , V_149 ) ;
}
static long F_112 ( struct V_150 * V_150 )
{
return - V_12 ;
}
