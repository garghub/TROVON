...
if ( V_45 > V_97 )
V_45 = V_97 ;
if ( V_45 > 0 && F_74 ( V_76 , V_6 -> V_14 , V_45 ) )
V_45 = - V_102 ;
F_54 ( V_6 ) ;
return V_45 ;
}
static T_4 F_75 ( struct V_91 * V_91 , const char T_5 * V_76 ,
T_6 V_97 , T_7 * V_98 )
{
int V_45 ;
struct V_81 * V_24 = V_91 -> V_96 ;
...
F_25 ( void )
{
if ( F_79 ( V_114 , L_14 , & V_115 ) ) {
F_2 ( V_71 L_15 , V_114 ) ;
return;
}
V_116 = F_80 ( V_117 , L_14 ) ;
if ( F_81 ( V_116 ) )
return;
F_82 ( V_116 , NULL , F_83 ( V_114 , 0 ) , NULL , L_14 ) ;
F_84 ( & V_113 ) ;
F_85 ( & V_118 , F_78 ) ;
}
