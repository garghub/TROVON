...
static int F_160 ( struct V_240 * V_241 )
{
struct V_1 * V_2 ;
struct V_256 * V_257 ;
int V_124 ;
...
V_98 = 320 * 240 * 2 * 2 ;
V_2 -> V_98 = V_98 ;
V_257 = F_163 ( V_241 , V_258 , 0 ) ;
if ( ! V_257 ) {
F_6 ( V_2 -> V_6 , L_32 ) ;
goto V_60;
}
if ( ! F_164 ( V_257 -> V_259 , F_165 ( V_257 ) , V_241 -> V_169 ) ) {
F_6 ( V_2 -> V_6 ,
L_33 ) ;
goto V_60;
}
V_2 -> V_260 = V_257 -> V_259 ;
V_2 -> V_261 = F_165 ( V_257 ) ;
V_2 -> V_10 = F_166 ( V_2 -> V_260 , V_2 -> V_261 ) ;
if ( ! V_2 -> V_10 ) {
F_6 ( V_2 -> V_6 , L_34 ) ;
goto V_60;
}
...
if ( F_168 ( V_124 , F_74 , 0 , V_179 , V_2 ) ) {
F_6 ( V_2 -> V_6 ,
L_36 ) ;
goto V_60;
}
...
static int F_173 ( struct V_240 * V_241 )
{
struct V_1 * V_2 = F_149 ( V_241 ) ;
if ( ! V_2 )
return 0 ;
