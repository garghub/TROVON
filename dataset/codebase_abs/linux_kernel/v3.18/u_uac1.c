...
return - V_66 ;
V_21 = & V_40 -> V_67 ;
V_21 -> V_68 = F_30 ( V_62 , V_69 , 0 ) ;
if ( F_31 ( V_21 -> V_68 ) ) {
int V_70 = F_32 ( V_21 -> V_68 ) ;
ERROR ( V_40 , L_4 ,
V_62 ) ;
V_21 -> V_68 = NULL ;
return V_70 ;
...
static int F_33 ( struct V_41 * V_75 )
{
struct V_20 * V_21 ;
V_21 = & V_75 -> V_67 ;
if ( V_21 -> V_68 )
