...
static int F_60 ( struct V_26 * V_27 , int V_64 )
{
struct V_1 * V_2 = V_27 -> V_29 ;
F_11 ( & V_2 -> V_3 -> V_14 , L_12 , V_33 , V_64 ) ;
return F_9 ( V_2 , 0xdb , V_64 ? 1 : 0 , 0x1 ) ;
}
static int F_61 ( struct V_62 * V_65 , unsigned V_66 ,
int V_5 )
{
struct V_1 * V_2 =
F_62 ( V_65 , struct V_1 , V_62 ) ;
T_1 V_28 [ V_67 ] ;
...
static void F_63 ( struct V_62 * V_65 , unsigned V_66 , int V_5 )
{
struct V_1 * V_2 =
F_62 ( V_65 , struct V_1 , V_62 ) ;
T_1 V_28 [ V_67 ] ;
...
static int F_64 ( struct V_62 * V_65 , unsigned V_66 )
{
struct V_1 * V_2 =
F_62 ( V_65 , struct V_1 , V_62 ) ;
...
struct V_26 * F_65 ( const struct V_69 * V_22 ,
...
int V_7 ;
T_1 V_25 ;
V_2 = F_66 ( sizeof( struct V_1 ) , V_72 ) ;
if ( ! V_2 ) {
V_7 = - V_73 ;
F_67 ( & V_3 -> V_14 , L_15 ,
V_15 ) ;
