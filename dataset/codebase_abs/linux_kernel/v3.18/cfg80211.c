...
static int F_24 ( struct V_20 * V_20 , T_2 V_131 )
{
struct V_82 * V_83 = F_15 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
T_2 V_11 ;
...
static int F_29 ( struct V_20 * V_20 , struct V_164 * V_94 ,
...
static int F_31 ( struct V_20 * V_20 , struct V_164 * V_94 ,
int * V_68 )
{
struct V_82 * V_83 = F_15 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
...
static struct V_20 * F_38 ( struct V_174 * V_22 , T_1 * V_9 )
{
struct V_20 * V_20 ;
struct V_82 * V_83 ;
V_20 = F_39 ( & V_175 , sizeof( * V_83 ) ) ;
if ( ! V_20 )
return NULL ;
V_83 = F_15 ( V_20 ) ;
V_83 -> V_9 = V_9 ;
...
V_83 -> V_178 . V_110 = F_17 ( V_111 ) ;
V_83 -> V_178 . V_179 = V_83 -> V_176 ;
V_83 -> V_178 . V_180 = F_17 ( V_177 ) ;
