...
int F_17 ( T_1 V_9 , int * V_41 , struct V_42 * * V_43 ,
bool V_13 )
{
T_2 V_14 ;
int V_15 = 0 ;
...
static void F_18 ( T_1 V_9 , char * V_46 )
{
struct V_23 V_24 = { V_25 } ;
if ( F_9 ( F_19 ( V_9 , V_47 , & V_24 ) ) )
F_13 ( L_11 ) ;
else {
...
union V_52 * V_53 ;
V_50 = F_17 ( V_54 , & V_34 , & V_44 , false ) ;
if ( V_50 )
goto V_55;
...
F_18 ( V_44 [ V_16 ] . V_39 , V_53 [ V_16 ] . V_56 ) ;
F_18 ( V_44 [ V_16 ] . V_40 , V_53 [ V_16 ] . V_57 ) ;
memcpy ( & V_53 [ V_16 ] . V_58 , & V_44 [ V_16 ] . V_58 ,
sizeof( V_59 ) * ( V_60 - 2 ) ) ;
}
if ( F_21 ( V_49 , V_53 , V_51 ) )
V_50 = - V_31 ;
F_16 ( V_53 ) ;
V_55:
F_16 ( V_44 ) ;
...
for ( V_16 = 0 ; V_16 < V_34 ; V_16 ++ ) {
F_18 ( V_18 [ V_16 ] . V_39 , V_63 [ V_16 ] . V_56 ) ;
F_18 ( V_18 [ V_16 ] . V_40 , V_63 [ V_16 ] . V_57 ) ;
V_63 [ V_16 ] . V_65 = V_18 [ V_16 ] . V_65 ;
V_63 [ V_16 ] . V_66 = V_18 [ V_16 ] . V_66 ;
}
if ( F_21 ( V_49 , V_63 , V_61 ) )
V_50 = - V_31 ;
F_16 ( V_63 ) ;
V_64:
F_16 ( V_18 ) ;
...
static long F_23 ( struct V_2 * V_67 , unsigned int V_68 ,
unsigned long V_69 )
{
int V_50 = 0 ;
...
switch ( V_68 ) {
case V_71 :
V_50 = F_6 ( V_54 , ( int * ) & V_34 ,
& V_18 , false ) ;
F_16 ( V_18 ) ;
if ( ! V_50 )
return F_24 ( V_34 , ( unsigned long T_3 * ) V_69 ) ;
return V_50 ;
case V_72 :
V_50 = F_6 ( V_54 , ( int * ) & V_34 ,
& V_18 , false ) ;
...
if ( ! V_50 )
return F_24 ( V_37 , ( unsigned long T_3 * ) V_69 ) ;
return V_50 ;
case V_73 :
return F_22 ( V_70 ) ;
case V_74 :
V_50 = F_17 ( V_54 , ( int * ) & V_34 ,
& V_44 , false ) ;
F_16 ( V_44 ) ;
if ( ! V_50 )
return F_24 ( V_34 , ( unsigned long T_3 * ) V_69 ) ;
