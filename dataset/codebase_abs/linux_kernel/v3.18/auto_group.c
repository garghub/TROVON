...
static int T_1 F_37 ( char * V_31 )
{
V_26 = 0 ;
return 1 ;
}
int F_38 ( struct V_1 * V_13 , int V_32 )
{
...
if ( V_35 )
return V_35 ;
if ( V_32 < 0 && ! F_40 ( V_30 , V_32 ) )
return - V_39 ;
if ( ! F_41 ( V_40 ) && F_42 ( V_41 , V_33 ) )
return - V_42 ;
V_33 = V_43 / 10 + V_41 ;
V_10 = F_15 ( V_13 ) ;
F_43 ( & V_10 -> V_7 ) ;
V_35 = F_44 ( V_10 -> V_4 , V_44 [ V_32 + 20 ] ) ;
if ( ! V_35 )
V_10 -> V_32 = V_32 ;
F_45 ( & V_10 -> V_7 ) ;
F_11 ( V_10 ) ;
...
void F_46 ( struct V_1 * V_13 , struct V_45 * V_46 )
{
struct V_8 * V_10 = F_15 ( V_13 ) ;
if ( ! F_47 ( V_10 -> V_4 ) )
goto V_27;
F_48 ( & V_10 -> V_7 ) ;
F_49 ( V_46 , L_4 , V_10 -> V_18 , V_10 -> V_32 ) ;
F_50 ( & V_10 -> V_7 ) ;
V_27:
F_11 ( V_10 ) ;
}
int F_51 ( struct V_9 * V_4 , char * V_47 , int V_48 )
{
if ( ! F_47 ( V_4 ) )
return 0 ;
return snprintf ( V_47 , V_48 , L_5 , L_6 , V_4 -> V_8 -> V_18 ) ;
}
