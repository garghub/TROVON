...
static struct V_1 * F_51 ( struct V_8 * V_24 , const T_2 * V_81 ,
struct V_43 * V_44 )
{
struct V_1 * V_2 ;
struct V_17 * V_82 ;
...
struct V_1 *
F_54 ( struct V_43 * V_44 , const T_2 * V_81 )
{
return F_51 ( F_37 ( V_9 ) , V_81 , V_44 ) ;
}
struct V_1 *
F_55 ( struct V_43 * V_44 , const T_2 * V_81 )
{
return F_51 ( F_37 ( V_11 ) , V_81 , V_44 ) ;
}
struct V_1 *
F_56 ( struct V_43 * V_44 , int V_85 )
{
...
F_36 () ;
V_24 = F_37 ( V_9 ) ;
F_52 (gate, tbl->known_gates, list)
if ( V_31 -> V_2 == V_2 ) {
V_88 = - V_89 ;
goto V_90;
}
...
static void F_60 ( struct V_8 * V_24 , struct V_1 * V_2 )
{
struct V_30 * V_31 ;
struct V_27 * V_29 ;
...
struct V_1 * F_64 ( struct V_43 * V_44 ,
const T_2 * V_81 )
{
...
int V_88 ;
T_1 V_103 ;
if ( F_53 ( V_81 , V_44 -> V_60 . V_42 ) )
return F_65 ( - V_104 ) ;
if ( F_66 ( V_81 ) )
return F_65 ( - V_104 ) ;
if ( F_67 ( & V_44 -> V_92 . V_93 . V_105 , 1 , V_106 ) == 0 )
return F_65 ( - V_107 ) ;
F_68 ( & V_10 ) ;
V_24 = F_3 () ;
V_103 = F_25 ( V_81 , V_44 , V_24 ) ;
V_82 = & V_24 -> V_16 [ V_103 ] ;
F_69 ( & V_24 -> V_18 [ V_103 ] ) ;
F_70 (node, bucket, list) {
V_2 = V_83 -> V_2 ;
if ( V_2 -> V_44 == V_44 &&
F_53 ( V_81 , V_2 -> V_81 ) )
goto V_108;
...
F_13 ( & V_100 -> V_84 ) ;
F_73 ( & V_100 -> V_113 ) ;
F_59 ( & V_101 -> V_33 , V_82 ) ;
if ( F_74 ( & V_24 -> V_21 ) >=
V_24 -> V_37 * ( V_24 -> V_20 + 1 ) )
V_102 = 1 ;
V_116 ++ ;
if ( V_102 ) {
F_75 ( V_117 , & V_97 -> V_118 ) ;
F_76 ( & V_99 -> V_119 , & V_44 -> V_120 ) ;
}
V_2 = V_100 ;
V_108:
F_77 ( & V_24 -> V_18 [ V_103 ] ) ;
F_78 ( & V_10 ) ;
return V_2 ;
V_110:
F_10 ( V_100 ) ;
...
static void F_79 ( struct V_121 * V_95 )
{
struct V_8 * V_24 = F_80 ( V_95 , struct V_8 , V_121 ) ;
F_15 ( V_24 , false ) ;
}
void F_81 ( void )
{
...
static void F_90 ( struct V_121 * V_131 )
{
struct V_30 * V_83 = F_80 ( V_131 , struct V_30 , V_95 ) ;
...
static void F_92 ( struct V_8 * V_24 , struct V_30 * V_83 )
{
struct V_1 * V_2 ;
V_2 = V_83 -> V_2 ;
F_69 ( & V_2 -> V_84 ) ;
...
static void F_94 ( struct V_8 * V_24 ,
struct V_43 * V_44 )
{
struct V_1 * V_2 ;
struct V_30 * V_83 ;
...
int F_97 ( struct V_43 * V_44 , const T_2 * V_42 )
{
struct V_8 * V_24 ;
struct V_1 * V_2 ;
struct V_30 * V_83 ;
...
return ( V_74 == V_2 ) ? - V_135 : 0 ;
}
void F_101 ( struct V_43 * V_44 ,
struct V_49 * V_50 )
{
F_49 ( V_50 ) ;
V_44 -> V_92 . V_93 . V_136 . V_137 ++ ;
}
void F_102 ( struct V_1 * V_2 )
{
struct V_49 * V_50 ;
while ( ( V_50 = F_103 ( & V_2 -> V_54 ) ) != NULL )
F_101 ( V_2 -> V_44 , V_50 ) ;
}
void F_104 ( struct V_1 * V_2 , struct V_47 * V_53 )
{
F_16 ( & V_2 -> V_84 ) ;
F_27 ( V_2 , V_53 ) ;
V_2 -> V_127 = 0xffff ;
...
static void F_106 ( struct V_27 * V_28 , bool V_25 )
{
struct V_1 * V_2 ;
struct V_30 * V_83 = F_107 ( V_28 , struct V_30 , V_33 ) ;
V_2 = V_83 -> V_2 ;
F_61 ( V_28 ) ;
if ( V_25 ) {
F_91 ( & V_2 -> V_113 ) ;
...
static int F_108 ( struct V_27 * V_28 , struct V_8 * V_14 )
{
struct V_1 * V_2 ;
struct V_30 * V_83 , * V_101 ;
T_1 V_103 ;
...
if ( V_101 == NULL )
return - V_41 ;
V_83 = F_107 ( V_28 , struct V_30 , V_33 ) ;
V_2 = V_83 -> V_2 ;
V_101 -> V_2 = V_2 ;
...
V_140 -> V_39 = & F_108 ;
V_140 -> V_37 = V_144 ;
V_140 -> V_34 = F_9 ( sizeof( struct V_17 ) , V_15 ) ;
if ( ! V_140 -> V_34 ) {
V_142 = - V_41 ;
goto V_145;
}
...
if ( ( ! ( V_2 -> V_3 & V_132 ) ) &&
( ! ( V_2 -> V_3 & V_7 ) ) &&
F_2 ( V_5 , V_2 -> V_6 + V_147 ) )
F_97 ( V_2 -> V_44 , V_2 -> V_81 ) ;
}
F_38 () ;
}
void F_114 ( void )
