...
static
T_1 F_33 ( char * V_42 , T_1 V_43 ,
unsigned char * V_44 , T_1 V_45 )
{
unsigned int V_46 , V_47 ;
for ( V_47 = V_46 = 0 ; V_46 < V_45 ; V_46 ++ )
V_47 += F_34 ( V_42 + V_47 , V_43 - V_47 ,
L_18 , V_44 [ V_46 ] ,
V_46 == V_45 - 1 ? '\0' : ':' ) ;
return V_47 ;
}
int F_35 ( struct V_2 * V_2 , struct V_48 * V_23 )
{
int V_7 ;
struct V_8 * V_9 = V_23 -> V_9 . V_49 ;
char V_42 [ 32 ] ;
...
F_44 ( V_54 , V_55 , V_56 ,
L_27 ) ;
snprintf ( V_16 . V_53 , sizeof( V_16 . V_53 ) ,
L_28 ) ;
V_7 = F_45 ( & V_16 ,
V_57 ,
V_58 ) ;
