...
{
unsigned int V_49 = F_14 ( V_124 -> V_128 ) ;
unsigned int V_132 = V_40 -> V_133 [ V_49 ] ;
int V_47 ;
for ( V_47 = 0 ; V_47 < V_124 -> V_130 ; V_47 ++ ) {
V_132 = V_88 [ V_47 ] ;
F_36 ( V_132 , V_15 -> V_20 + V_134 ) ;
}
V_40 -> V_133 [ V_49 ] = V_132 ;
return V_124 -> V_130 ;
}
...
if ( V_129 )
return V_129 ;
V_17 -> V_41 = F_45 ( V_139 , 1 ) ;
V_15 -> V_20 = F_45 ( V_139 , 2 ) ;
F_40 ( V_15 ) ;
if ( V_139 -> V_104 ) {
V_129 = F_46 ( V_139 -> V_104 , F_27 ,
...
static int F_51 ( struct V_138 * V_15 ,
const struct V_167 * V_168 )
{
return F_52 ( V_15 , & V_169 ,
V_168 -> V_170 ) ;
}
