...
string = L_8 ;
SPRINTF ( L_9 , string ) ;
SPRINTF ( L_10 , V_4 -> V_107 ) ;
SPRINTF ( L_11 , V_4 -> V_108 ) ;
SPRINTF ( L_12 ) ;
#define F_32 ( T_1 , T_2 ) \
...
static T_4 F_33 ( struct V_81 * V_74 , struct V_110 * V_111 , char * V_112 )
{
struct V_6 * V_7 = F_34 ( V_74 ) ;
return sprintf ( V_112 , L_13 , F_6 ( V_7 -> V_9 ) ) ;
}
static T_4 F_35 ( struct V_81 * V_74 , struct V_110 * V_111 , const char * V_112 ,
T_5 V_113 )
{
struct V_6 * V_7 = F_34 ( V_74 ) ;
