...
switch ( V_45 ) {
case V_215 :
V_209 += F_85 ( V_206 , L_49 ) ;
break;
case V_216 :
V_209 += F_85 ( V_206 , L_9 ) ;
break;
case V_214 :
V_209 += F_85 ( V_206 , L_50 ) ;
break;
}
V_209 += F_85 ( V_206 , L_51 ) ;
return V_209 ;
}
...
V_217 ) ;
if ( V_217 & V_227 )
V_209 += F_85 ( V_206 , L_54 ) ;
if ( V_217 & V_228 )
V_209 += F_85 ( V_206 , L_55 ) ;
if ( V_217 & V_229 )
V_209 += F_85 ( V_206 , L_56 ) ;
if ( V_217 & V_230 )
V_209 += F_85 ( V_206 , L_57 ) ;
if ( V_217 & V_231 )
V_209 += F_85 ( V_206 , L_58 ) ;
if ( V_217 & V_232 )
V_209 += F_85 ( V_206 , L_59 ) ;
if ( V_217 & V_233 )
V_209 += F_85 ( V_206 , L_60 ) ;
else
V_209 += F_85 ( V_206 , L_61 ) ;
V_209 += F_85 ( V_206 , L_51 ) ;
...
V_239 = F_89 ( L_66 , NULL ) ;
if ( ! V_239 )
return - V_241 ;
V_240 = F_90 ( L_67 , V_242 , V_239 , V_1 ,
& V_243 ) ;
if ( V_240 )
V_240 = F_90 ( L_68 , V_242 , V_239 ,
V_1 , & V_244 ) ;
if ( V_240 )
V_240 = F_90 ( L_69 , V_242 , V_239 ,
V_1 , & V_245 ) ;
if ( V_240 )
V_240 = F_90 ( L_70 , V_242 , V_239 ,
V_1 , & V_246 ) ;
if ( V_240 ) {
V_1 -> V_247 = V_239 ;
return 0 ;
...
static void T_10 F_92 ( struct V_1 * V_1 )
{
F_91 ( V_1 -> V_247 ) ;
}
static void T_9 F_93 ( int V_248 , struct V_110 * V_111 )
{
struct V_1 * V_1 = V_111 -> V_114 ;
int V_249 ;
...
8 * V_63 ) ;
V_1 -> V_144 = F_96 ( V_272 * V_63 , V_255 ) ;
if ( ! V_1 -> V_144 )
goto V_276;
V_1 -> V_185 = V_185 ;
V_1 -> V_99 = floor ;
...
static int F_103 ( struct V_188 * V_189 , T_11 V_157 )
{
int floor , V_14 ;
struct V_202 * V_4 ;
struct V_110 * * V_190 , * V_111 ;
...
struct V_202 * V_4 ;
V_23 = - V_285 ;
V_283 = F_106 ( V_189 , V_286 , 0 ) ;
if ( ! V_283 ) {
F_107 ( V_185 , L_77 ) ;
return V_23 ;
}
V_5 = F_108 ( V_185 , V_283 -> V_287 , V_288 ) ;
V_23 = - V_241 ;
...
V_23 = F_114 ( V_111 , V_293 , NULL , NULL ,
0 ) ;
if ( V_23 )
goto V_291;
V_284 ++ ;
...
static int T_10 F_118 ( struct V_188 * V_189 )
{
