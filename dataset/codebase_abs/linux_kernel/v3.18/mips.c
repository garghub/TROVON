...
if ( ( V_88 -> V_41 & V_124 ) == V_125 ) {
T_3 T_4 * V_126 = ( T_3 T_4 * ) ( long ) V_88 -> V_127 ;
if ( F_85 ( V_91 , V_126 ) != 0 )
return - V_131 ;
} else if ( ( V_88 -> V_41 & V_124 ) == V_128 ) {
T_5 T_4 * V_129 = ( T_5 T_4 * ) ( long ) V_88 -> V_127 ;
T_6 V_130 ;
if ( F_85 ( V_130 , V_129 ) != 0 )
return - V_131 ;
V_91 = ( T_2 ) V_130 ;
} else {
return - V_82 ;
...
long F_97 ( struct V_23 * V_24 , unsigned int V_25 ,
unsigned long V_12 )
{
...
case V_137 : {
struct V_87 V_88 ;
if ( F_98 ( & V_88 , V_135 , sizeof( V_88 ) ) )
return - V_131 ;
if ( V_25 == V_136 )
return F_84 ( V_2 , & V_88 ) ;
else
return F_65 ( V_2 , & V_88 ) ;
}
case V_138 : {
...
struct V_139 V_142 ;
unsigned V_143 ;
if ( F_98 ( & V_142 , V_140 , sizeof( V_142 ) ) )
return - V_131 ;
V_143 = V_142 . V_143 ;
V_142 . V_143 = F_99 ( V_144 ) ;
if ( F_100 ( V_140 , & V_142 , sizeof( V_142 ) ) )
return - V_131 ;
if ( V_143 < V_142 . V_143 )
return - V_145 ;
V_141 = V_140 -> V_88 ;
if ( F_100 ( V_141 , V_144 ,
sizeof( V_144 ) ) )
return - V_131 ;
return 0 ;
}
...
struct V_75 V_76 ;
V_67 = - V_131 ;
if ( F_98 ( & V_76 , V_135 , sizeof( V_76 ) ) )
goto V_47;
...
int F_101 ( struct V_9 * V_9 , struct V_149 * log )
{
struct V_27 * V_30 ;
...
long F_105 ( struct V_23 * V_24 , unsigned int V_25 , unsigned long V_12 )
{
long V_67 ;
switch ( V_25 ) {
default:
...
int F_112 ( struct V_1 * V_2 , struct V_161 * V_162 )
{
return - V_26 ;
}
int F_113 ( struct V_1 * V_2 , struct V_161 * V_162 )
{
return - V_26 ;
}
int F_114 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
return V_165 ;
}
int F_115 ( struct V_9 * V_9 , long V_166 )
{
int V_67 ;
switch ( V_166 ) {
case V_167 :
...
int F_119 ( struct V_1 * V_2 , struct V_170 * V_171 )
{
int V_3 ;
for ( V_3 = 1 ; V_3 < F_99 ( V_2 -> V_4 . V_94 ) ; V_3 ++ )
...
int F_120 ( struct V_1 * V_2 , struct V_170 * V_171 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_99 ( V_2 -> V_4 . V_94 ) ; V_3 ++ )
...
static void F_121 ( unsigned long V_173 )
{
...
static enum V_175 F_122 ( struct V_176 * V_177 )
{
struct V_1 * V_2 ;
V_2 = F_123 ( V_177 , struct V_1 , V_4 . V_62 ) ;
...
{
V_13 -> V_178 ( V_2 ) ;
F_126 ( & V_2 -> V_4 . V_62 , V_179 ,
V_180 ) ;
V_2 -> V_4 . V_62 . V_181 = F_122 ;
return 0 ;
}
...
int F_133 ( struct V_65 * V_66 , struct V_1 * V_2 )
{
T_7 V_190 = V_2 -> V_4 . V_191 ;
T_7 V_192 = ( V_190 >> V_193 ) & 0x1f ;
T_7 T_4 * V_194 = ( T_7 T_4 * ) V_2 -> V_4 . V_100 ;
unsigned long V_195 = V_2 -> V_4 . V_196 ;
...
F_59 () ;
F_12 ( L_25 ,
V_190 , V_194 , V_66 , V_2 ) ;
V_198 = F_134 ( V_190 , V_194 , V_66 , V_2 ) ;
if ( V_198 == V_204 ) {
goto V_205;
} else if ( V_198 == V_206 ) {
V_66 -> V_201 = V_207 ;
...
default:
F_36 ( L_30 ,
V_192 , V_194 , F_138 ( V_194 , V_2 ) , V_195 ,
F_75 ( V_2 -> V_4 . V_74 ) ) ;
F_118 ( V_2 ) ;
V_66 -> V_201 = V_207 ;
V_90 = V_208 ;
...
{
int V_90 ;
V_90 = F_141 ( NULL , sizeof( struct V_1 ) , 0 , V_255 ) ;
if ( V_90 )
return V_90 ;
V_256 = V_257 ;
F_19 = V_258 ;
