...
static void F_92 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
...
return;
if ( V_174 & V_177 )
F_96 ( & V_4 -> V_10 , V_5 & V_177 ) ;
if ( V_174 & V_178 )
V_4 -> V_10 . V_17 . V_179 ++ ;
if ( V_174 & V_180 )
F_97 ( & V_4 -> V_10 , V_5 & V_180 ) ;
F_98 ( & V_4 -> V_10 . V_90 -> V_10 . V_181 ) ;
}
static T_7 F_99 ( int V_182 , void * V_183 )
{
...
static unsigned int F_102 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
unsigned int V_198 = 0 ;
unsigned int V_5 = F_5 ( V_4 -> V_10 . V_11 + V_12 ) ;
#define F_103 ( T_8 , T_9 ) \
if (status & uartbit) \
result |= tiocmbit
F_103 ( V_177 , V_199 ) ;
F_103 ( V_178 , V_200 ) ;
...
static void F_104 ( struct V_119 * V_10 , unsigned int V_204 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
unsigned int V_205 ;
V_205 = F_5 ( V_4 -> V_10 . V_11 + V_206 ) ;
#define F_103 ( T_9 , T_8 ) \
if (mctrl & tiocmbit) \
cr |= uartbit; \
else \
cr &= ~uartbit
...
static void F_105 ( struct V_119 * V_10 , int V_219 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
unsigned long V_83 ;
...
static void F_106 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
...
static int F_107 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
unsigned int V_5 ;
...
static void F_108 ( struct V_119 * V_10 ,
unsigned char V_6 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
...
static int F_109 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
int V_225 ;
F_110 ( V_10 -> V_2 ) ;
V_225 = F_111 ( V_4 -> V_226 ) ;
if ( V_225 )
return V_225 ;
V_4 -> V_10 . V_227 = F_112 ( V_4 -> V_226 ) ;
F_42 ( V_138 | V_139 | V_140 | V_141 |
...
static void F_113 ( struct V_3 * V_4 , unsigned int V_220 )
{
...
static int F_114 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
...
goto V_233;
F_42 ( V_4 -> V_92 , V_4 -> V_10 . V_11 + V_94 ) ;
V_225 = F_115 ( V_4 -> V_10 . V_182 , F_99 , 0 , L_21 , V_4 ) ;
if ( V_225 )
goto V_233;
...
static void F_118 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
unsigned int V_205 ;
...
static void
F_121 ( struct V_119 * V_10 , struct V_245 * V_246 ,
struct V_245 * V_247 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
...
V_250 = 16 ;
V_248 = F_122 ( V_10 , V_246 , V_247 , 0 ,
V_10 -> V_227 / V_250 ) ;
#ifdef F_123
if ( V_4 -> V_68 . V_71 )
V_4 -> V_68 . V_72 = F_124 ( 10000000 , V_248 ) ;
#endif
if ( V_248 > V_10 -> V_227 / 16 )
V_249 = F_125 ( V_10 -> V_227 * 8 , V_248 ) ;
else
V_249 = F_125 ( V_10 -> V_227 * 4 , V_248 ) ;
...
static const char * F_128 ( struct V_119 * V_10 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
return V_4 -> V_10 . type == V_278 ? V_4 -> type : NULL ;
}
static void F_129 ( struct V_119 * V_10 )
{
F_130 ( V_10 -> V_49 , V_279 ) ;
}
static int F_131 ( struct V_119 * V_10 )
{
return F_132 ( V_10 -> V_49 , V_279 , L_21 )
!= NULL ? 0 : - V_107 ;
}
static void F_133 ( struct V_119 * V_10 , int V_83 )
{
if ( V_83 & V_280 ) {
V_10 -> type = V_278 ;
F_131 ( V_10 ) ;
...
static int F_134 ( struct V_119 * V_10 , struct V_281 * V_282 )
{
int V_117 = 0 ;
...
static void F_135 ( struct V_119 * V_10 , int V_6 )
{
struct V_3 * V_4 =
F_89 ( V_10 , struct V_3 , V_10 ) ;
while ( F_5 ( V_4 -> V_10 . V_11 + V_12 ) & V_118 )
...
static void
F_136 ( struct V_287 * V_288 , const char * V_289 , unsigned int V_100 )
{
...
F_140 ( & V_4 -> V_10 , V_289 , V_100 , F_135 ) ;
do {
V_5 = F_5 ( V_4 -> V_10 . V_11 + V_12 ) ;
} while ( V_5 & V_164 );
...
static void T_4
F_143 ( struct V_3 * V_4 , int * V_248 ,
int * V_24 , int * V_296 )
{
...
static int T_4 F_144 ( struct V_287 * V_288 , char * V_297 )
{
struct V_3 * V_4 ;
int V_248 = 38400 ;
int V_296 = 8 ;
...
V_4 -> V_10 . V_227 = F_112 ( V_4 -> V_226 ) ;
if ( V_297 )
F_146 ( V_297 , & V_248 , & V_24 , & V_296 , & V_298 ) ;
else
F_143 ( V_4 , & V_248 , & V_24 , & V_296 ) ;
return F_147 ( & V_4 -> V_10 , V_288 , V_248 , V_24 , V_296 , V_298 ) ;
}
static void F_148 ( struct V_119 * V_10 , int V_301 )
{
while ( F_149 ( V_10 -> V_11 + V_12 ) & V_118 )
;
F_150 ( V_301 , V_10 -> V_11 + V_14 ) ;
while ( F_149 ( V_10 -> V_11 + V_12 ) & V_164 )
;
}
static void F_151 ( struct V_287 * V_302 , const char * V_289 , unsigned V_303 )
{
struct V_304 * V_2 = V_302 -> V_81 ;
F_140 ( & V_2 -> V_10 , V_289 , V_303 , F_148 ) ;
}
static int T_4 F_152 ( struct V_304 * V_40 ,
const char * V_305 )
{
if ( ! V_40 -> V_10 . V_11 )
return - V_300 ;
V_40 -> V_302 -> V_306 = F_151 ;
return 0 ;
}
static int F_153 ( int V_291 , struct V_40 * V_2 )
{
struct V_307 * V_308 ;
...
if ( ! V_308 )
return V_117 ;
V_117 = F_155 ( V_308 , L_22 ) ;
if ( F_156 ( V_117 ) ) {
V_310 = true ;
V_117 = V_291 ;
} else {
V_309 = true ;
if ( V_117 >= F_157 ( V_290 ) || V_290 [ V_117 ] != NULL ) {
F_62 ( V_2 , L_23 , V_117 ) ;
V_117 = V_291 ;
}
}
...
static int F_158 ( struct V_1 * V_2 , const struct V_313 * V_314 )
{
struct V_3 * V_4 ;
struct V_315 * V_158 = V_314 -> V_81 ;
void T_10 * V_316 ;
int V_230 , V_117 ;
for ( V_230 = 0 ; V_230 < F_157 ( V_290 ) ; V_230 ++ )
if ( V_290 [ V_230 ] == NULL )
break;
if ( V_230 == F_157 ( V_290 ) )
return - V_107 ;
V_4 = F_159 ( & V_2 -> V_2 , sizeof( struct V_3 ) ,
V_42 ) ;
if ( V_4 == NULL )
return - V_43 ;
V_230 = F_153 ( V_230 , & V_2 -> V_2 ) ;
V_316 = F_160 ( & V_2 -> V_2 , V_2 -> V_317 . V_318 ,
F_161 ( & V_2 -> V_317 ) ) ;
if ( ! V_316 )
return - V_43 ;
V_4 -> V_226 = F_162 ( & V_2 -> V_2 , NULL ) ;
if ( F_163 ( V_4 -> V_226 ) )
return F_164 ( V_4 -> V_226 ) ;
V_4 -> V_158 = V_158 ;
...
static int F_173 ( struct V_40 * V_2 )
{
struct V_3 * V_4 = F_174 ( V_2 ) ;
if ( ! V_4 )
return - V_284 ;
return F_175 ( & V_325 , & V_4 -> V_10 ) ;
}
static int F_176 ( struct V_40 * V_2 )
{
struct V_3 * V_4 = F_174 ( V_2 ) ;
if ( ! V_4 )
return - V_284 ;
return F_177 ( & V_325 , & V_4 -> V_10 ) ;
}
