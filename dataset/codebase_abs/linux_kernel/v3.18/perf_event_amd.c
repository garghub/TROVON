...
V_58 = & F_20 ( V_22 , V_46 ) ;
if ( V_58 -> V_24 ) {
struct V_24 * V_25 = V_58 -> V_24 ;
if ( V_25 -> V_26 == - 1 || -- V_25 -> V_57 == 0 )
F_26 ( V_25 ) ;
V_58 -> V_24 = NULL ;
}
}
...
static T_2 F_31 ( char * V_76 , T_1 V_15 )
{
T_1 V_10 = ( V_15 & V_77 ) |
( V_15 & V_78 ) >> 24 ;
return F_32 ( V_76 , V_15 , V_10 ) ;
}
