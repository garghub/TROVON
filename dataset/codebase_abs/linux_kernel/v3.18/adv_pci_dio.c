...
V_4 = & V_2 -> V_127 [ 2 ] ;
V_4 -> type = V_141 ;
V_4 -> V_129 = V_140 | V_142 ;
V_4 -> V_133 = 2 ;
V_4 -> V_134 = 0xffffffff ;
V_4 -> V_135 = 2 ;
V_4 = & V_2 -> V_127 [ 3 ] ;
V_4 -> type = V_143 ;
V_4 -> V_129 = V_130 | V_140 ;
V_4 -> V_133 = 8 ;
V_4 -> V_134 = 0xffff ;
V_4 -> V_135 = 8 ;
V_4 -> V_144 = F_27 ;
...
const struct V_76 * V_77 = V_2 -> V_78 ;
V_4 -> type = V_128 ;
V_4 -> V_129 = V_130 | V_131 | V_132 | V_9 -> V_146 ;
if ( V_9 -> V_147 > 16 )
V_4 -> V_129 |= V_142 ;
V_4 -> V_133 = V_9 -> V_147 ;
V_4 -> V_134 = 1 ;
...
static unsigned long F_35 ( struct V_152 * V_153 ,
unsigned long V_79 )
{
if ( V_79 != V_112 )
return V_79 ;
if ( F_36 ( V_153 ) < 0 )
return V_79 ;
if ( F_37 ( V_153 , V_154 , L_3 ) == 0 ) {
unsigned long V_155 =
F_38 ( V_153 , V_154 ) + 53 ;
F_7 ( 0x05 , V_155 ) ;
if ( ( F_2 ( V_155 ) & 0x07 ) == 0x02 ) {
F_7 ( 0x02 , V_155 ) ;
if ( ( F_2 ( V_155 ) & 0x07 ) == 0x05 )
V_79 = V_107 ;
}
F_39 ( V_153 , V_154 ) ;
}
...
if ( V_24 )
return V_24 ;
V_2 -> V_13 = F_38 ( V_153 , V_77 -> V_164 ) ;
V_24 = F_46 ( V_2 , V_77 -> V_165 ) ;
if ( V_24 )
return V_24 ;
V_157 = 0 ;
for ( V_11 = 0 ; V_11 < V_166 ; V_11 ++ )
if ( V_77 -> V_167 [ V_11 ] . V_147 ) {
V_4 = & V_2 -> V_127 [ V_157 ] ;
F_32 ( V_2 , V_4 , & V_77 -> V_167 [ V_11 ] ) ;
V_157 ++ ;
}
for ( V_11 = 0 ; V_11 < V_168 ; V_11 ++ )
if ( V_77 -> V_169 [ V_11 ] . V_147 ) {
V_4 = & V_2 -> V_127 [ V_157 ] ;
F_33 ( V_2 , V_4 , & V_77 -> V_169 [ V_11 ] ) ;
V_157 ++ ;
}
for ( V_11 = 0 ; V_11 < V_170 ; V_11 ++ )
for ( V_158 = 0 ; V_158 < V_77 -> V_171 [ V_11 ] . V_12 ; V_158 ++ ) {
V_4 = & V_2 -> V_127 [ V_157 ] ;
...
V_4 = & V_2 -> V_127 [ V_157 ] ;
V_4 -> type = V_128 ;
F_32 ( V_2 , V_4 , & V_77 -> V_173 ) ;
V_157 ++ ;
}
for ( V_11 = 0 ; V_11 < V_174 ; V_11 ++ )
if ( V_77 -> V_175 [ V_11 ] . V_147 ) {
V_4 = & V_2 -> V_127 [ V_157 ] ;
F_34 ( V_2 , V_4 , & V_77 -> V_175 [ V_11 ] ) ;
V_157 ++ ;
}
if ( V_77 -> V_79 == V_124 )
F_31 ( V_2 ) ;
...
static int F_50 ( struct V_152 * V_2 ,
const struct V_176 * V_177 )
{
unsigned long V_79 ;
V_79 = F_35 ( V_2 , V_177 -> V_178 ) ;
return F_51 ( V_2 , & V_179 , V_79 ) ;
}
