...
struct V_12 * V_12 = F_4 ( V_11 -> V_14 ) ;
struct V_15 * V_16 = F_33 ( V_11 ) ;
if ( V_12 -> type == V_95 && F_36 ( V_11 -> V_96 ) )
F_39 ( V_11 -> V_96 ) ;
F_41 ( V_16 ) ;
F_35 ( V_11 , NULL ) ;
}
static void F_42 ( struct V_12 * V_13 , T_3 V_99 )
{
struct V_18 * V_19 = V_13 -> V_19 ;
if ( V_99 & V_100 ) {
...
static T_5 F_44 ( T_6 V_105 , void * V_106 )
{
...
static void F_50 ( struct V_10 * V_11 , bool V_110 )
{
struct V_12 * V_12 = F_4 ( V_11 -> V_14 ) ;
...
{
struct V_26 * V_27 = F_53 ( V_2 ) ;
struct V_114 * V_14 = F_54 ( V_2 ) ;
...
V_12 -> V_113 = 0 ;
if ( F_56 ( V_116 ) ) {
V_12 -> V_113 = F_57 ( V_116 ) ;
F_7 ( & V_19 -> V_111 , 0xffffffff ) ;
}
V_14 -> V_119 = V_12 -> V_113 ;
V_27 -> V_33 = F_50 ;
}
static struct V_114 * F_58 ( struct V_1 * V_2 ,
...
T_3 V_122 ;
int V_66 = 0 ;
V_14 = F_59 ( V_2 , sizeof( struct V_12 ) ) ;
if ( V_14 == NULL ) {
V_66 = - V_87 ;
goto V_123;
}
F_60 ( V_2 , V_14 ) ;
V_66 = F_61 ( V_2 , V_121 , V_105 ) ;
if ( V_66 )
goto V_124;
V_14 -> V_125 = F_32 ;
V_14 -> V_126 = F_40 ;
...
if ( V_66 )
goto V_129;
V_12 -> V_19 = F_63 ( V_121 -> V_130 , F_64 ( V_121 ) ) ;
if ( V_12 -> V_19 == NULL ) {
V_66 = - V_87 ;
goto V_131;
}
...
static void F_73 ( struct V_10 * V_11 , bool V_110 )
{
struct V_1 * V_2 = V_11 -> V_2 . V_30 -> V_30 ;
struct V_26 * V_27 = F_53 ( V_2 ) ;
struct V_140 * V_141 = F_74 ( V_27 ) ;
T_7 V_16 = V_11 -> V_112 ;
int V_142 = V_141 -> V_143 [ V_16 ] ;
bool V_144 = V_141 -> V_145 [ V_16 ] ;
F_51 ( V_142 , V_110 ^ V_144 ) ;
}
...
V_141 -> V_143 = F_77 ( V_148 * sizeof( * V_141 -> V_143 ) , V_86 ) ;
if ( ! V_141 -> V_143 )
return - V_87 ;
memset ( V_141 -> V_143 , - 1 , V_148 * sizeof( * V_141 -> V_143 ) ) ;
V_141 -> V_145 = F_34 ( V_148 * sizeof( * V_141 -> V_145 ) ,
V_86 ) ;
if ( ! V_141 -> V_145 ) {
V_66 = - V_87 ;
goto V_151;
...
int V_142 ;
enum V_152 V_21 ;
V_142 = F_78 ( V_147 , V_149 , & V_21 ) ;
if ( ! F_36 ( V_142 ) ) {
F_29 ( V_2 , L_7 , V_149 , V_142 ) ;
V_66 = V_142 ;
goto V_153;
}
V_66 = F_37 ( V_142 , F_19 ( V_2 ) ) ;
if ( V_66 ) {
...
V_153:
while ( V_149 >= 0 ) {
if ( F_36 ( V_141 -> V_143 [ V_149 ] ) )
F_39 ( V_141 -> V_143 [ V_149 ] ) ;
V_149 -- ;
}
F_41 ( V_141 -> V_145 ) ;
V_141 -> V_145 = NULL ;
...
static int F_89 ( struct V_155 * V_157 )
{
struct V_120 * V_121 ;
int V_105 ;
struct V_114 * V_14 ;
if ( ! F_53 ( & V_157 -> V_2 ) )
return - V_47 ;
V_121 = F_90 ( V_157 , V_158 , 0 ) ;
if ( ! V_121 )
return - V_47 ;
V_105 = F_91 ( V_157 , 0 ) ;
if ( V_105 <= 0 )
return - V_47 ;
V_14 = F_58 ( & V_157 -> V_2 , V_121 , V_105 ) ;
return F_92 ( V_14 ) ;
}
static int F_93 ( struct V_155 * V_157 )
{
return F_88 ( & V_157 -> V_2 ) ;
}
