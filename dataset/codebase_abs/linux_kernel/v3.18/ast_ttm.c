...
V_9 -> V_86 = F_38 ( F_22 ( V_66 -> V_67 , 0 ) ,
F_39 ( V_66 -> V_67 , 0 ) ) ;
return 0 ;
}
...
if ( V_87 & V_92 )
V_28 -> V_90 [ V_88 ++ ] . V_34 = V_45 | V_44 | V_92 ;
if ( V_87 & V_50 )
V_28 -> V_90 [ V_88 ++ ] . V_34 = V_39 | V_50 ;
if ( ! V_88 )
V_28 -> V_90 [ V_88 ++ ] . V_34 = V_39 | V_50 ;
V_28 -> V_51 . V_93 = V_88 ;
V_28 -> V_51 . V_94 = V_88 ;
for ( V_89 = 0 ; V_89 < V_88 ; ++ V_89 ) {
V_28 -> V_90 [ V_89 ] . V_95 = 0 ;
V_28 -> V_90 [ V_89 ] . V_96 = 0 ;
}
}
int F_43 ( struct V_80 * V_66 , int V_15 , int V_97 ,
T_1 V_34 , struct V_27 * * V_98 )
{
struct V_1 * V_9 = V_66 -> V_99 ;
struct V_27 * V_49 ;
T_3 V_100 ;
int V_79 ;
...
F_18 ( V_49 , V_92 | V_50 ) ;
V_100 = F_45 ( & V_9 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_79 = F_46 ( & V_9 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_102 , & V_49 -> V_51 ,
V_97 >> V_62 , false , NULL , V_100 ,
NULL , NULL , F_12 ) ;
if ( V_79 )
return V_79 ;
* V_98 = V_49 ;
...
F_18 ( V_28 , V_103 ) ;
for ( V_89 = 0 ; V_89 < V_28 -> V_51 . V_93 ; V_89 ++ )
V_28 -> V_90 [ V_89 ] . V_34 |= V_106 ;
...
int F_53 ( struct V_52 * V_53 , struct V_109 * V_110 )
{
struct V_111 * V_112 ;
struct V_1 * V_9 ;
if ( F_54 ( V_110 -> V_113 < V_84 ) )
return - V_46 ;
V_112 = V_53 -> V_114 ;
V_9 = V_112 -> V_115 -> V_66 -> V_99 ;
return F_55 ( V_53 , V_110 , & V_9 -> V_4 . V_5 ) ;
}
