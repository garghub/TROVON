...
if ( V_122 )
V_123 = 1 ;
V_127 = F_50 ( V_121 , L_35 , 0 ) ;
if ( V_127 ) {
V_10 = F_49 ( V_127 , & V_109 ,
& V_122 ) ;
if ( V_10 )
goto exit;
V_123 |= V_122 ;
...
V_133 = F_57 ( V_109 [ V_36 ] ) ;
F_20 ( V_3 -> V_11 , L_36 ,
V_128 , V_109 [ V_36 ] ,
( V_132 == V_134 ) ? L_37 : L_38 ,
( V_132 == V_134 ) ?
( V_133 ? L_39 : L_40 ) :
( V_133 ? L_16 : L_14 ) ) ;
V_5 = V_128 - 1 ;
...
static int F_58 ( struct V_138 * V_23 )
{
...
{
struct V_120 * V_121 = V_144 -> V_11 . V_145 ;
const struct V_146 * V_147 ;
struct V_1 * V_7 ;
unsigned int V_148 = - 1 ;
int V_10 ;
int V_36 ;
if ( ! V_121 ) {
F_6 ( & V_144 -> V_11 , L_42 ) ;
...
V_7 = F_60 ( & V_144 -> V_11 , sizeof( struct V_1 ) ,
V_112 ) ;
if ( V_7 == NULL ) {
F_6 ( & V_144 -> V_11 ,
L_43 ) ;
...
V_7 -> V_11 = & V_144 -> V_11 ;
V_7 -> V_44 = F_61 ( V_144 -> V_11 . V_44 ) ;
V_7 -> V_3 = V_149 ;
V_7 -> V_3 . V_11 = & V_144 -> V_11 ;
V_7 -> V_3 . V_76 = - 1 ;
V_147 = F_62 ( V_150 , & V_144 -> V_11 ) ;
if ( ! V_147 ) {
F_6 ( & V_144 -> V_11 , L_44 ) ;
return - V_97 ;
}
V_148 = ( unsigned long ) V_147 -> V_107 ;
switch ( V_148 ) {
case V_151 :
F_63 ( & V_7 -> V_23 ) ;
break;
...
V_7 -> V_3 . V_77 = F_58 ( V_7 -> V_23 ) ;
V_7 -> V_40 = V_7 -> V_23 -> V_155 ;
V_7 -> V_37 = V_7 -> V_23 -> V_156 ;
V_10 = F_67 ( & V_7 -> V_3 ) ;
if ( V_10 ) {
F_6 ( & V_144 -> V_11 , L_47 , V_10 ) ;
return V_10 ;
}
F_68 ( & V_144 -> V_11 , L_48 ) ;
V_157 . V_90 = V_7 -> V_23 -> V_90 ;
V_157 . V_89 = V_7 -> V_23 -> V_89 ;
V_7 -> V_47 = F_69 ( & V_157 , & V_144 -> V_11 , V_7 ) ;
if ( ! V_7 -> V_47 ) {
F_6 ( & V_144 -> V_11 ,
L_49 ) ;
V_10 = - V_27 ;
