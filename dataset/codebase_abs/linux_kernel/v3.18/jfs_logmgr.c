...
unsigned long V_19 ;
F_97 ( V_19 ) ;
F_98 ( log -> V_199 , ( V_26 = log -> V_200 ) , V_19 ) ;
...
V_26 -> V_207 = NULL ;
V_26 -> V_172 = V_77 ;
V_26 -> V_208 = log -> V_164 + ( V_77 << ( V_71 - log -> V_167 ) ) ;
V_26 -> V_87 = 0 ;
return V_26 ;
}
...
static inline void F_102 ( struct V_25 * V_26 )
{
unsigned long V_19 ;
F_38 ( & V_209 , V_19 ) ;
V_26 -> V_210 = V_211 ;
...
V_26 -> V_116 |= V_215 ;
V_214 = F_104 ( V_216 , 1 ) ;
V_214 -> V_217 . V_218 = V_26 -> V_208 << ( log -> V_167 - 9 ) ;
V_214 -> V_219 = log -> V_139 ;
V_214 -> V_220 [ 0 ] . V_221 = V_26 -> V_205 ;
V_214 -> V_220 [ 0 ] . V_222 = V_61 ;
V_214 -> V_220 [ 0 ] . V_223 = V_26 -> V_204 ;
V_214 -> V_224 = 1 ;
V_214 -> V_217 . V_225 = V_61 ;
V_214 -> V_226 = V_227 ;
V_214 -> V_228 = V_26 ;
if ( log -> V_169 ) {
V_214 -> V_217 . V_225 = 0 ;
...
F_106 ( V_26 -> V_206 , ( V_26 -> V_116 != V_215 ) ) ;
return 0 ;
}
...
F_97 ( V_19 ) ;
F_98 ( V_26 -> V_206 , ( V_26 -> V_116 & V_235 ) , V_19 ) ;
...
int F_116 ( struct V_1 * log , T_3 V_241 , int V_242 )
{
int V_93 = - V_96 ;
struct V_3 * V_4 ;
struct V_170 * V_170 ;
...
static int F_117 ( struct V_250 * V_251 , void * V_252 )
{
F_118 ( V_251 ,
L_47
L_48
...
static int F_119 ( struct V_253 * V_253 , struct V_254 * V_254 )
{
return F_120 ( V_254 , F_117 , NULL ) ;
}
