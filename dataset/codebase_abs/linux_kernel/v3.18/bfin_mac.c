...
V_62 -> V_65 = 0 ;
F_195 ( V_236 , & V_62 -> V_260 , F_142 , V_15 ) ;
F_120 ( & V_62 -> V_67 ) ;
...
static int F_201 ( struct V_294 * V_295 )
{
...
static int F_203 ( struct V_294 * V_295 , T_7 V_312 )
{
...
static int F_206 ( struct V_294 * V_295 )
{
struct V_16 * V_313 = F_193 ( V_295 ) ;
struct V_61 * V_62 = F_22 ( V_313 ) ;
if ( V_62 -> V_124 ) {
...
V_315 -> V_105 = F_211 ( sizeof( int ) * V_86 , V_326 ) ;
if ( ! V_315 -> V_105 )
goto V_327;
for ( V_5 = V_125 ; V_5 < V_86 ; ++ V_5 )
V_315 -> V_105 [ V_5 ] = V_148 ;
V_125 = F_212 ( V_316 -> V_328 , 0 , V_86 ) ;
...
static int F_216 ( struct V_294 * V_295 )
{
