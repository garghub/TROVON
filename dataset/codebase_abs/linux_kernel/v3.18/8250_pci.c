...
static bool F_88 ( struct V_164 * V_165 , void * V_166 )
{
struct V_167 * V_168 = V_166 ;
if ( V_168 -> V_169 != V_165 -> V_5 -> V_3 )
return false ;
V_165 -> V_170 = V_168 ;
return true ;
}
...
struct V_10 * V_11 , int V_30 )
{
struct V_2 * V_171 = V_9 -> V_3 ;
struct V_5 * V_3 = V_11 -> V_11 . V_3 ;
struct V_172 * V_173 ;
struct V_167 * V_174 , * V_175 ;
struct V_2 * V_169 ;
int V_93 ;
V_173 = F_90 ( V_3 , sizeof( * V_173 ) , V_176 ) ;
if ( ! V_173 )
return - V_21 ;
V_174 = F_90 ( V_3 , sizeof( * V_174 ) , V_176 ) ;
if ( ! V_174 )
return - V_21 ;
V_175 = F_90 ( V_3 , sizeof( * V_175 ) , V_176 ) ;
if ( ! V_175 )
return - V_21 ;
switch ( V_171 -> V_5 ) {
case V_177 :
...
V_175 -> V_183 = 1 ;
V_175 -> V_184 = 0 ;
V_173 -> V_185 . V_186 = 16 ;
V_174 -> V_183 = 1 ;
V_174 -> V_184 = 0 ;
V_173 -> V_187 . V_188 = 16 ;
V_169 = F_91 ( V_171 -> V_189 , F_92 ( F_93 ( V_171 -> V_190 ) , 0 ) ) ;
V_175 -> V_169 = & V_169 -> V_3 ;
V_174 -> V_169 = & V_169 -> V_3 ;
V_173 -> V_191 = F_88 ;
V_173 -> V_175 = V_175 ;
V_173 -> V_174 = V_174 ;
V_93 = F_51 ( V_9 , V_29 , V_11 , V_30 ) ;
V_11 -> V_11 . V_22 = V_23 ;
V_11 -> V_11 . type = V_192 ;
V_11 -> V_11 . V_32 = ( V_11 -> V_11 . V_32 | V_150 | V_151 ) ;
V_11 -> V_11 . V_193 = F_85 ;
V_11 -> V_11 . V_194 = 64 ;
V_11 -> V_195 = 64 ;
V_11 -> V_173 = V_173 ;
V_11 -> V_196 = V_197 | V_198 ;
F_18 ( V_199 , V_11 -> V_11 . V_26 + V_200 ) ;
return V_93 ;
}
static int
F_94 ( struct V_8 * V_9 ,
...
T_1 V_203 ;
switch ( V_30 ) {
case 0 : V_24 = 0xe000 ; V_203 = 0x40 ; break;
case 1 : V_24 = 0xe008 ; V_203 = 0x48 ; break;
case 2 : V_24 = 0xe010 ; V_203 = 0x50 ; break;
case 3 : V_24 = 0xe018 ; V_203 = 0x58 ; break;
case 4 : V_24 = 0xe020 ; V_203 = 0x60 ; break;
case 5 : V_24 = 0xe028 ; V_203 = 0x68 ; break;
case 6 : V_24 = 0xe030 ; V_203 = 0x70 ; break;
case 7 : V_24 = 0xe038 ; V_203 = 0x78 ; break;
case 8 : V_24 = 0xe040 ; V_203 = 0x80 ; break;
case 9 : V_24 = 0xe048 ; V_203 = 0x88 ; break;
case 10 : V_24 = 0xe050 ; V_203 = 0x90 ; break;
case 11 : V_24 = 0xe058 ; V_203 = 0x98 ; break;
default:
return - V_18 ;
}
if ( V_30 < 4 ) {
V_15 = F_5 ( V_9 -> V_3 , 3 ) ;
V_202 = ( int ) ( V_15 + ( 0x8 * V_30 ) ) ;
}
F_16 ( & V_171 -> V_3 , L_20 ,
V_204 , V_30 , V_24 , V_202 , V_203 ) ;
F_35 ( V_171 , V_203 + 0x00 , 0x01 ) ;
F_35 ( V_171 , V_203 + 0x01 , 0x33 ) ;
F_35 ( V_171 , V_203 + 0x04 , ( T_1 ) ( V_24 & 0xff ) ) ;
F_35 ( V_171 , V_203 + 0x05 , ( T_1 ) ( ( V_24 & 0xff00 ) >> 8 ) ) ;
F_35 ( V_171 , V_203 + 0x06 , V_171 -> V_205 ) ;
V_11 -> V_11 . V_22 = V_27 ;
V_11 -> V_11 . V_24 = V_24 ;
V_11 -> V_11 . V_25 = 0 ;
V_11 -> V_11 . V_26 = NULL ;
...
static void F_98 ( struct V_152 * V_47 )
{
struct V_10 * V_207 = F_99 ( V_47 ) ;
F_100 ( V_207 ) ;
}
static unsigned int F_101 ( struct V_152 * V_47 , int V_13 )
{
struct V_10 * V_207 = F_99 ( V_47 ) ;
unsigned int V_120 ;
...
struct V_10 * V_11 , int V_30 )
{
V_11 -> V_11 . V_32 |= V_210 ;
V_11 -> V_11 . V_211 = F_101 ;
V_11 -> V_11 . V_212 = F_98 ;
return F_97 ( V_9 , V_29 , V_11 , V_30 ) ;
}
static int F_103 ( struct V_2 * V_3 )
{
#if F_104 ( V_213 ) || F_104 ( V_214 )
return - V_45 ;
#else
return 0 ;
#endif
...
F_27 ( 0x00 , V_47 + V_216 ) ;
F_27 ( V_217 , V_47 + V_218 ) ;
F_27 ( 128 , V_47 + V_219 ) ;
F_27 ( 128 , V_47 + V_220 ) ;
F_20 ( V_47 ) ;
return F_51 ( V_9 , V_29 , V_11 , V_30 ) ;
...
static inline int F_109 ( T_4 V_225 , T_4 V_226 )
{
return V_225 == V_227 || V_225 == V_226 ;
}
static struct V_228 * F_110 ( struct V_2 * V_3 )
{
struct V_228 * V_229 ;
for ( V_229 = V_230 ; ; V_229 ++ )
if ( F_109 ( V_229 -> V_4 , V_3 -> V_4 ) &&
F_109 ( V_229 -> V_5 , V_3 -> V_5 ) &&
F_109 ( V_229 -> V_231 , V_3 -> V_6 ) &&
F_109 ( V_229 -> V_232 , V_3 -> V_7 ) )
break;
return V_229 ;
}
...
static int
F_112 ( struct V_2 * V_3 , struct V_28 * V_29 )
{
const struct V_234 * V_235 ;
int V_236 , V_237 , V_238 = - 1 , V_63 ;
if ( ( ( ( V_3 -> V_82 >> 8 ) != V_239 ) &&
( ( V_3 -> V_82 >> 8 ) != V_240 ) ) ||
( V_3 -> V_82 & 0xff ) > 6 )
return - V_45 ;
for ( V_235 = V_241 ;
V_235 < V_241 + F_41 ( V_241 ) ;
V_235 ++ ) {
if ( V_3 -> V_4 == V_235 -> V_4 &&
V_3 -> V_5 == V_235 -> V_5 )
return - V_45 ;
}
V_236 = V_237 = 0 ;
for ( V_63 = 0 ; V_63 < V_17 ; V_63 ++ ) {
if ( F_6 ( V_3 , V_63 ) & V_242 ) {
V_237 ++ ;
if ( V_238 == - 1 )
V_238 = V_63 ;
}
...
static inline int
F_113 ( const struct V_28 * V_29 ,
const struct V_28 * V_243 )
{
return
V_29 -> V_77 == V_243 -> V_77 &&
V_29 -> V_244 == V_243 -> V_244 &&
V_29 -> V_33 == V_243 -> V_33 &&
V_29 -> V_34 == V_243 -> V_34 &&
V_29 -> V_31 == V_243 -> V_31 ;
}
struct V_8 *
F_114 ( struct V_2 * V_3 , const struct V_28 * V_29 )
{
struct V_10 V_245 ;
struct V_8 * V_9 ;
struct V_228 * V_229 ;
...
V_9 = F_116 ( sizeof( struct V_8 ) +
sizeof( unsigned int ) * V_246 ,
V_176 ) ;
if ( ! V_9 ) {
V_9 = F_115 ( - V_21 ) ;
goto V_249;
...
V_245 . V_11 . V_32 = V_250 | V_251 | V_252 ;
V_245 . V_11 . V_144 = V_29 -> V_244 * 16 ;
V_245 . V_11 . V_205 = F_111 ( V_3 , V_29 ) ;
V_245 . V_11 . V_3 = & V_3 -> V_3 ;
for ( V_63 = 0 ; V_63 < V_246 ; V_63 ++ ) {
if ( V_229 -> V_253 ( V_9 , V_29 , & V_245 , V_63 ) )
break;
F_16 ( & V_3 -> V_3 , L_22 ,
V_245 . V_11 . V_24 , V_245 . V_11 . V_205 , V_245 . V_11 . V_22 ) ;
V_9 -> line [ V_63 ] = F_117 ( & V_245 ) ;
if ( V_9 -> line [ V_63 ] < 0 ) {
F_2 ( & V_3 -> V_3 ,
L_23 ,
V_245 . V_11 . V_24 , V_245 . V_11 . V_205 ,
V_245 . V_11 . V_22 , V_9 -> line [ V_63 ] ) ;
break;
}
}
V_9 -> V_254 = V_63 ;
...
struct V_228 * V_229 ;
int V_63 ;
for ( V_63 = 0 ; V_63 < V_9 -> V_254 ; V_63 ++ )
F_119 ( V_9 -> line [ V_63 ] ) ;
for ( V_63 = 0 ; V_63 < V_17 ; V_63 ++ ) {
if ( V_9 -> V_20 [ V_63 ] )
F_20 ( V_9 -> V_20 [ V_63 ] ) ;
...
F_122 ( V_9 -> line [ V_63 ] ) ;
if ( V_9 -> V_229 -> exit )
V_9 -> V_229 -> exit ( V_9 -> V_3 ) ;
}
void F_123 ( struct V_8 * V_9 )
{
int V_63 ;
if ( V_9 -> V_229 -> V_247 )
V_9 -> V_229 -> V_247 ( V_9 -> V_3 ) ;
for ( V_63 = 0 ; V_63 < V_9 -> V_254 ; V_63 ++ )
if ( V_9 -> line [ V_63 ] >= 0 )
F_124 ( V_9 -> line [ V_63 ] ) ;
}
static int
F_125 ( struct V_2 * V_3 , const struct V_234 * V_255 )
{
struct V_228 * V_229 ;
struct V_8 * V_9 ;
const struct V_28 * V_29 ;
...
V_229 = F_110 ( V_3 ) ;
if ( V_229 -> V_256 ) {
V_35 = V_229 -> V_256 ( V_3 ) ;
if ( V_35 )
return V_35 ;
}
if ( V_255 -> V_257 >= F_41 ( V_258 ) ) {
F_2 ( & V_3 -> V_3 , L_24 ,
V_255 -> V_257 ) ;
return - V_18 ;
}
V_29 = & V_258 [ V_255 -> V_257 ] ;
V_35 = F_126 ( V_3 ) ;
F_127 ( V_3 ) ;
if ( V_35 )
return V_35 ;
if ( V_255 -> V_257 == V_259 ) {
memcpy ( & V_143 , V_29 , sizeof( struct V_28 ) ) ;
V_29 = & V_143 ;
V_35 = F_112 ( V_3 , & V_143 ) ;
if ( V_35 )
goto V_260;
} else {
memcpy ( & V_143 , & V_258 [ V_259 ] ,
sizeof( struct V_28 ) ) ;
V_35 = F_112 ( V_3 , & V_143 ) ;
if ( V_35 == 0 && F_113 ( V_29 , & V_143 ) )
F_1 ( L_25 ,
V_3 ) ;
}
V_9 = F_114 ( V_3 , V_29 ) ;
...
{
struct V_8 * V_9 = F_133 ( V_3 ) ;
F_118 ( V_9 ) ;
F_131 ( V_3 ) ;
}
static int F_134 ( struct V_2 * V_3 , T_5 V_261 )
{
struct V_8 * V_9 = F_133 ( V_3 ) ;
if ( V_9 )
F_121 ( V_9 ) ;
F_127 ( V_3 ) ;
F_135 ( V_3 , F_136 ( V_3 , V_261 ) ) ;
return 0 ;
}
...
static T_6 F_140 ( struct V_2 * V_3 )
{
int V_35 ;
V_35 = F_126 ( V_3 ) ;
if ( V_35 )
