...
const char * V_65 = F_47 ( V_24 ) ;
int V_66 ;
int V_67 ;
int V_48 ;
V_4 = F_48 ( V_24 , sizeof( * V_4 ) , V_68 ) ;
if ( ! V_4 ) {
F_49 ( V_24 , L_10 ) ;
return - V_69 ;
}
...
V_17 = F_58 ( V_23 , V_75 , V_48 ) ;
if ( ! V_17 )
break;
V_4 -> V_17 [ V_48 ] . V_4 = V_4 ;
V_4 -> V_17 [ V_48 ] . V_29 = V_17 -> V_76 ;
}
V_4 -> V_77 = V_48 ;
if ( V_4 -> V_77 < 1 ) {
F_49 ( V_24 , L_15 ) ;
...
V_7 -> V_1 = F_60 ( V_24 , V_63 [ V_48 ] -> V_76 ,
F_59 ( V_63 [ V_48 ] ) ) ;
if ( ! V_7 -> V_1 ) {
F_49 ( V_24 , L_17 ) ;
V_67 = - V_78 ;
...
for ( V_48 = 0 ; V_48 < V_4 -> V_77 ; V_48 ++ )
F_17 ( V_4 , V_48 , 1 ) ;
F_10 ( V_4 , V_43 , 0x0 ) ;
V_66 = V_4 -> V_17 [ 0 ] . V_29 ;
V_4 -> V_79 = true ;
for ( V_48 = 1 ; V_48 < V_4 -> V_77 ; V_48 ++ ) {
if ( V_66 != V_4 -> V_17 [ V_48 ] . V_29 ) {
V_4 -> V_79 = false ;
break;
}
}
...
for ( V_48 = 0 ; V_48 < V_4 -> V_77 ; V_48 ++ ) {
if ( F_62 ( V_24 , V_4 -> V_17 [ V_48 ] . V_29 ,
F_37 , 0 , V_65 ,
& V_4 -> V_17 [ V_48 ] ) ) {
F_49 ( V_24 , L_19 ) ;
V_67 = - V_86 ;
...
for ( V_48 = 0 ; V_48 < V_4 -> V_77 ; V_48 ++ )
F_17 ( V_4 , V_48 , 0 ) ;
F_63 ( V_24 , L_20 , V_4 -> V_77 ) ;
if ( V_4 -> V_21 . V_83 ) {
if ( V_4 -> V_21 . V_83 != V_4 -> V_17 [ 0 ] . V_30 )
F_55 ( V_24 , L_21 ,
V_4 -> V_21 . V_83 , V_4 -> V_17 [ 0 ] . V_30 ) ;
}
return 0 ;
V_87:
F_64 ( V_4 -> V_49 ) ;
...
static int F_67 ( struct V_57 * V_23 )
{
struct V_3 * V_4 = F_68 ( V_23 ) ;
F_64 ( V_4 -> V_49 ) ;
F_65 ( & V_23 -> V_24 ) ;
F_66 ( & V_23 -> V_24 ) ;
return 0 ;
