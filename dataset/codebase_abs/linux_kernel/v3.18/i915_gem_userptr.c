...
if ( V_2 -> V_92 != V_93 )
V_2 -> V_94 = 0 ;
F_83 (obj->pages->sgl, &sg_iter, obj->pages->nents, 0 ) {
struct V_70 * V_70 = F_84 ( & V_91 ) ;
if ( V_2 -> V_94 )
F_85 ( V_70 ) ;
F_86 ( V_70 ) ;
F_87 ( V_70 ) ;
...
int
F_91 ( struct V_3 * V_4 , void * V_95 , struct V_96 * V_97 )
{
struct V_11 * V_12 = V_4 -> V_98 ;
struct V_99 * args = V_95 ;
struct V_1 * V_2 ;
int V_19 ;
T_1 V_100 ;
if ( args -> V_54 & ~ ( V_101 |
V_55 ) )
return - V_58 ;
if ( F_92 ( args -> V_102 | args -> V_103 ) )
return - V_58 ;
if ( args -> V_103 > V_12 -> V_104 . V_5 . V_105 )
return - V_106 ;
if ( ! F_93 ( args -> V_54 & V_101 ? V_107 : V_108 ,
( char V_109 * ) ( unsigned long ) args -> V_102 , args -> V_103 ) )
return - V_110 ;
if ( args -> V_54 & V_101 ) {
return - V_59 ;
}
...
if ( V_2 == NULL )
return - V_41 ;
F_95 ( V_4 , & V_2 -> V_5 , args -> V_103 ) ;
F_96 ( V_2 , & V_111 ) ;
V_2 -> V_112 = V_113 ;
V_2 -> V_5 . V_114 = V_115 ;
V_2 -> V_5 . V_116 = V_115 ;
V_2 -> V_8 . V_21 = args -> V_102 ;
V_2 -> V_8 . V_86 = ! ! ( args -> V_54 & V_101 ) ;
V_19 = F_49 ( V_2 ) ;
if ( V_19 == 0 )
V_19 = F_41 ( V_2 , args -> V_54 ) ;
if ( V_19 == 0 )
V_19 = F_97 ( V_97 , & V_2 -> V_5 , & V_100 ) ;
F_98 ( & V_2 -> V_5 ) ;
if ( V_19 )
return V_19 ;
args -> V_100 = V_100 ;
