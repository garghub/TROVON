...
F_67 ( V_4 , & V_113 , V_7 -> V_97 ,
F_52 ) ;
return 0 ;
}
static int F_68 ( struct V_116 * V_117 , unsigned long V_118 ,
void * V_119 )
{
...
{
int V_24 = 0 ;
const struct V_123 * V_65 = V_7 -> V_8 -> V_18 ;
for (; V_24 <= V_7 -> V_8 -> V_16 ; V_24 ++ )
if ( ! strcmp ( V_65 [ V_24 ] . V_12 , L_19 ) ) {
V_7 -> V_120 . V_124 = F_68 ;
V_7 -> V_120 . V_125 = 128 ;
if ( F_71 ( & V_7 -> V_120 ) )
F_17 ( V_7 -> V_44 ,
L_20 ) ;
...
int F_72 ( struct V_126 * V_127 ,
const struct V_128 * V_129 )
{
struct V_1 * V_7 ;
struct V_130 * V_131 ;
int V_51 ;
V_7 = F_73 ( & V_127 -> V_44 , sizeof( * V_7 ) , V_132 ) ;
if ( ! V_7 ) {
F_17 ( & V_127 -> V_44 , L_21 ) ;
return - V_133 ;
}
V_7 -> V_44 = & V_127 -> V_44 ;
V_7 -> V_8 = V_129 ;
V_7 -> V_4 = V_134 ;
F_74 ( & V_7 -> V_28 ) ;
V_131 = F_75 ( V_127 , V_135 , 0 ) ;
V_7 -> V_29 = F_76 ( & V_127 -> V_44 , V_131 ) ;
if ( F_77 ( V_7 -> V_29 ) )
return F_78 ( V_7 -> V_29 ) ;
F_70 ( V_7 ) ;
V_7 -> V_97 = F_79 ( V_127 , 0 ) ;
if ( V_7 -> V_97 < 0 ) {
F_17 ( & V_127 -> V_44 , L_22 ) ;
return V_7 -> V_97 ;
}
V_136 . V_12 = F_62 ( & V_127 -> V_44 ) ;
V_136 . V_13 = V_7 -> V_8 -> V_13 ;
V_136 . V_15 = V_7 -> V_8 -> V_15 ;
V_7 -> V_7 = F_80 ( & V_136 , & V_127 -> V_44 , V_7 ) ;
if ( ! V_7 -> V_7 ) {
F_17 ( & V_127 -> V_44 , L_23 ) ;
return - V_137 ;
}
V_51 = F_61 ( V_7 ) ;
if ( V_51 ) {
...
F_82 ( V_127 , V_7 ) ;
F_83 ( & V_127 -> V_44 , L_24 ) ;
return 0 ;
}
int F_84 ( struct V_126 * V_127 )
{
struct V_1 * V_7 = F_85 ( V_127 ) ;
F_65 ( & V_7 -> V_4 ) ;
F_81 ( V_7 -> V_7 ) ;
F_86 ( & V_7 -> V_120 ) ;
return 0 ;
