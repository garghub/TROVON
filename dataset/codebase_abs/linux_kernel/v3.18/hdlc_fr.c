...
static int F_68 ( struct V_9 * V_14 , unsigned int V_2 , int type )
{
T_3 * V_4 = F_6 ( V_14 ) ;
struct V_5 * V_6 ;
struct V_9 * V_10 ;
...
V_151 = F_10 ( V_6 ) ;
if ( type == V_17 ) {
V_10 = F_69 ( 0 , L_38 , V_153 ,
V_154 ) ;
V_10 -> V_155 &= ~ V_156 ;
} else
V_10 = F_69 ( 0 , L_39 , V_153 , F_66 ) ;
if ( ! V_10 ) {
F_37 ( V_14 , L_40 ) ;
F_15 ( V_4 ) ;
return - V_32 ;
...
static int F_73 ( T_3 * V_4 , unsigned int V_2 , int type )
{
struct V_5 * V_6 ;
struct V_9 * V_10 ;
...
static void F_75 ( struct V_9 * V_14 )
{
T_3 * V_4 = F_6 ( V_14 ) ;
struct V_5 * V_6 = F_3 ( V_4 ) -> V_7 ;
F_3 ( V_4 ) -> V_7 = NULL ;
...
static int F_76 ( struct V_9 * V_10 , struct V_48 * V_49 )
{
T_7 T_8 * V_167 = V_49 -> V_52 . V_60 . V_168 ;
...
case V_53 :
if ( F_6 ( V_10 ) -> V_171 != & V_171 )
return - V_63 ;
V_49 -> V_52 . type = V_172 ;
if ( V_49 -> V_52 . V_56 < V_56 ) {
V_49 -> V_52 . V_56 = V_56 ;
return - V_32 ;
}
if ( F_27 ( V_167 , & F_3 ( V_4 ) -> V_42 , V_56 ) )
return - V_62 ;
return 0 ;
case V_172 :
if ( ! F_77 ( V_173 ) )
...
V_169 . V_130 < 1 ||
V_169 . V_120 < 1 ||
V_169 . V_119 < V_169 . V_120 ||
V_169 . V_119 > 32 ||
( V_169 . V_47 != 0 &&
V_169 . V_47 != 1 ) )
return - V_63 ;
V_170 = V_4 -> V_176 ( V_10 , V_177 , V_178 ) ;
if ( V_170 )
return V_170 ;
if ( F_6 ( V_10 ) -> V_171 != & V_171 ) {
V_170 = F_79 ( V_10 , & V_171 ,
sizeof( struct V_3 ) ) ;
if ( V_170 )
return V_170 ;
F_3 ( V_4 ) -> V_7 = NULL ;
...
memcpy ( & F_3 ( V_4 ) -> V_42 , & V_169 , V_56 ) ;
V_10 -> type = V_179 ;
return 0 ;
case V_180 :
case V_181 :
...
if ( ! F_77 ( V_173 ) )
return - V_174 ;
if ( F_78 ( & V_6 , V_49 -> V_52 . V_60 . V_184 ,
sizeof( T_10 ) ) )
return - V_62 ;
if ( V_6 . V_2 <= 0 || V_6 . V_2 >= 1024 )
return - V_63 ;
if ( V_49 -> V_52 . type == V_182 ||
V_49 -> V_52 . type == V_183 )
V_170 = V_17 ;
else
V_170 = V_147 ;
if ( V_49 -> V_52 . type == V_180 ||
V_49 -> V_52 . type == V_182 )
return F_68 ( V_10 , V_6 . V_2 , V_170 ) ;
else
return F_73 ( V_4 , V_6 . V_2 , V_170 ) ;
}
return - V_63 ;
}
