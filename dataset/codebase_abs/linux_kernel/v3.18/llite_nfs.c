...
static struct V_33 *
F_21 ( struct V_12 * V_13 , struct V_11 * V_14 , struct V_11 * V_34 )
{
struct V_8 * V_8 ;
struct V_33 * V_35 ;
...
static int F_33 ( void * V_51 , const char * V_1 , int V_52 ,
T_4 V_20 , T_5 V_53 , unsigned type )
{
struct V_54 * V_55 = F_34 ( V_1 , struct V_54 , V_56 ) ;
struct V_57 * V_58 = V_51 ;
struct V_11 V_14 ;
F_35 ( & V_14 , & V_55 -> V_59 ) ;
if ( F_4 ( & V_14 , & V_58 -> V_60 ) ) {
memcpy ( V_58 -> V_61 , V_1 , V_52 ) ;
V_58 -> V_61 [ V_52 ] = 0 ;
V_58 -> V_62 = 1 ;
}
return V_58 -> V_62 ;
}
static int F_36 ( struct V_33 * V_33 , char * V_1 ,
struct V_33 * V_63 )
{
struct V_8 * V_64 = V_33 -> V_65 ;
int V_23 ;
struct V_57 V_58 = {
. V_61 = V_1 ,
. V_60 = F_5 ( V_63 -> V_65 ) -> V_10 ,
. V_66 . V_67 = F_33 ,
} ;
if ( ! V_64 || ! F_37 ( V_64 -> V_37 ) ) {
V_23 = - V_68 ;
goto V_69;
}
if ( ! V_64 -> V_70 ) {
...
static struct V_33 * F_41 ( struct V_12 * V_13 , struct V_14 * V_14 ,
int V_74 , int V_75 )
{
struct V_45 * V_46 = (struct V_45 * ) V_14 ;
if ( V_75 != V_50 )
return F_14 ( - V_76 ) ;
return F_21 ( V_13 , & V_46 -> V_48 , & V_46 -> V_49 ) ;
}
static struct V_33 * F_42 ( struct V_12 * V_13 , struct V_14 * V_14 ,
int V_74 , int V_75 )
{
struct V_45 * V_46 = (struct V_45 * ) V_14 ;
if ( V_75 != V_50 )
return F_14 ( - V_76 ) ;
return F_21 ( V_13 , & V_46 -> V_49 , NULL ) ;
}
static struct V_33 * F_43 ( struct V_33 * V_77 )
{
struct V_17 * V_18 = NULL ;
struct V_8 * V_64 = V_77 -> V_65 ;
struct V_15 * V_16 ;
...
int V_23 ;
int V_81 ;
F_44 ( V_64 && F_37 ( V_64 -> V_37 ) ) ;
V_16 = F_7 ( V_64 -> V_82 ) ;
F_10 ( V_24 , L_10 V_25 L_2 ,
V_64 -> V_47 , F_11 ( F_32 ( V_64 ) ) ) ;
V_23 = F_13 ( V_16 , & V_81 ) ;
if ( V_23 != 0 )
return F_14 ( V_23 ) ;
V_22 = F_45 ( NULL , V_64 , NULL , V_80 ,
strlen ( V_80 ) , V_81 ,
V_83 , NULL ) ;
if ( F_23 ( V_22 ) )
return ( void * ) V_22 ;
V_23 = F_46 ( V_16 -> V_32 , V_22 , & V_18 ) ;
F_47 ( V_22 ) ;
if ( V_23 ) {
F_18 ( L_11 , V_23 , V_64 -> V_47 ) ;
return F_14 ( V_23 ) ;
}
V_79 = F_48 ( & V_18 -> V_84 , & V_85 ) ;
F_44 ( V_79 -> V_86 & V_87 ) ;
F_10 ( V_24 , L_12 V_25 L_13 V_25 L_6 ,
F_11 ( F_32 ( V_64 ) ) , F_11 ( & V_79 -> V_88 ) ) ;
V_35 = F_21 ( V_64 -> V_82 , & V_79 -> V_88 , NULL ) ;
F_20 ( V_18 ) ;
return V_35 ;
}
