...
T_2 F_31 ( struct V_5 * V_6 , T_4 V_43 , void * V_29 ,
T_3 V_30 )
{
const struct V_24 * V_25 = V_6 -> V_9 -> V_25 ;
struct V_31 V_32 = {
...
int F_36 ( struct V_47 * V_4 )
{
V_4 -> V_48 . V_12 = & V_13 ;
if ( V_4 -> V_49 )
V_4 -> V_48 . V_49 = F_32 ;
if ( V_4 -> remove )
V_4 -> V_48 . remove = F_34 ;
if ( V_4 -> V_50 )
V_4 -> V_48 . V_50 = F_35 ;
return F_37 ( & V_4 -> V_48 ) ;
}
void F_38 ( struct V_47 * V_4 )
{
F_39 ( & V_4 -> V_48 ) ;
}
