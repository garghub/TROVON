...
{
int V_37 ;
struct V_1 * V_2 = F_41 ( V_70 , struct V_1 ,
V_71 . V_70 ) ;
F_14 ( & V_2 -> V_36 ) ;
for ( V_37 = 0 ; V_37 < V_8 ; V_37 ++ ) {
union V_28 * V_72 = & V_2 -> V_15 [ V_37 ] ;
if ( V_72 -> V_31 . V_46 != V_56 )
continue;
if ( V_2 -> V_48 & ( 1 << V_37 ) && ! V_72 -> V_31 . V_50 )
F_21 ( V_2 , V_37 , false ) ;
}
F_15 ( & V_2 -> V_36 ) ;
}
static void F_42 ( struct V_21 * V_22 ,
struct V_1 * V_2 , int V_34 , int V_73 )
{
int V_37 ;
for ( V_37 = 0 ; V_37 < V_8 ; V_37 ++ ) {
union V_28 * V_72 = & V_2 -> V_15 [ V_37 ] ;
if ( V_72 -> V_31 . V_34 != V_34 )
continue;
if ( V_37 == V_30 )
F_17 ( V_2 , V_22 ) ;
F_15 ( & V_2 -> V_36 ) ;
F_43 ( V_2 -> V_25 , V_57 , V_37 ) ;
F_14 ( & V_2 -> V_36 ) ;
if ( V_73 != V_56 )
continue;
ASSERT ( V_72 -> V_31 . V_46 == V_56 ) ;
V_72 -> V_31 . V_50 = 0 ;
if ( ! V_72 -> V_31 . V_42 && ( V_2 -> V_48 & ( 1 << V_37 ) ) ) {
++ V_2 -> V_74 [ V_37 ] ;
if ( V_2 -> V_74 [ V_37 ] == V_75 ) {
F_44 ( & V_2 -> V_71 , V_76 / 100 ) ;
V_2 -> V_74 [ V_37 ] = 0 ;
F_45 ( V_72 -> V_16 ) ;
} else {
F_21 ( V_2 , V_37 , false ) ;
...
bool F_46 ( struct V_25 * V_25 , int V_34 )
{
struct V_1 * V_2 = V_25 -> V_26 . V_27 ;
F_47 () ;
return F_10 ( V_34 , V_2 -> V_52 ) ;
}
void F_48 ( struct V_21 * V_22 , int V_34 , int V_73 )
{
struct V_1 * V_2 = V_22 -> V_25 -> V_26 . V_27 ;
F_14 ( & V_2 -> V_36 ) ;
F_42 ( V_22 , V_2 , V_34 , V_73 ) ;
F_15 ( & V_2 -> V_36 ) ;
}
static inline struct V_1 * F_49 ( struct V_77 * V_78 )
{
return F_41 ( V_78 , struct V_1 , V_78 ) ;
}
static inline int F_50 ( struct V_1 * V_2 , T_3 V_3 )
{
return ( ( V_3 >= V_2 -> V_79 &&
( V_3 < V_2 -> V_79 + V_80 ) ) ) ;
}
static int F_51 ( struct V_77 * V_81 , T_3 V_3 , int V_82 ,
void * V_58 )
{
struct V_1 * V_2 = F_49 ( V_81 ) ;
T_1 V_5 ;
if ( ! F_50 ( V_2 , V_3 ) )
return - V_83 ;
...
static int F_53 ( struct V_77 * V_81 , T_3 V_3 , int V_82 ,
const void * V_58 )
{
struct V_1 * V_2 = F_49 ( V_81 ) ;
T_1 V_87 ;
...
V_2 -> V_48 = 0 ;
V_2 -> V_12 = 0 ;
memset ( V_2 -> V_74 , 0x00 , V_8 ) ;
F_2 ( V_2 ) ;
F_25 ( V_2 ) ;
}
int F_57 ( struct V_25 * V_25 )
{
struct V_1 * V_2 ;
int V_45 ;
V_2 = F_58 ( sizeof( struct V_1 ) , V_92 ) ;
if ( ! V_2 )
return - V_93 ;
F_59 ( & V_2 -> V_36 ) ;
F_60 ( & V_2 -> V_71 , F_40 ) ;
...
void F_66 ( struct V_25 * V_25 )
{
struct V_1 * V_2 = V_25 -> V_26 . V_27 ;
F_56 ( & V_2 -> V_71 ) ;
if ( V_2 ) {
F_67 ( V_25 , V_96 , & V_2 -> V_78 ) ;
V_25 -> V_26 . V_27 = NULL ;
F_65 ( V_2 ) ;
}
}
int F_68 ( struct V_25 * V_25 , struct V_97 * V_98 )
{
struct V_1 * V_2 = F_69 ( V_25 ) ;
if ( ! V_2 )
return - V_99 ;
F_14 ( & V_2 -> V_36 ) ;
memcpy ( V_98 , V_2 , sizeof( struct V_97 ) ) ;
F_15 ( & V_2 -> V_36 ) ;
return 0 ;
}
int F_70 ( struct V_25 * V_25 , struct V_97 * V_98 )
{
struct V_1 * V_2 = F_69 ( V_25 ) ;
if ( ! V_2 )
return - V_99 ;
F_14 ( & V_2 -> V_36 ) ;
memcpy ( V_2 , V_98 , sizeof( struct V_97 ) ) ;
V_2 -> V_48 = 0 ;
F_25 ( V_2 ) ;
F_30 ( V_25 ) ;
F_23 ( V_2 , V_98 -> V_48 ) ;
