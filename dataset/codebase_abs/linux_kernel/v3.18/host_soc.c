...
int T_8 F_25 ( struct V_13 * V_14 )
{
struct V_15 * V_16 = & V_14 -> V_16 ;
V_16 -> V_17 = F_26 ( V_18 , V_19 * 1 ) ;
if ( ! V_16 -> V_17 )
return - V_20 ;
V_16 -> V_21 = V_22 ;
V_16 -> V_23 = & V_24 ;
...
int T_8 F_28 ( struct V_13 * V_14 )
{
struct V_15 * V_16 = & V_14 -> V_16 ;
int V_26 ;
V_26 = F_29 ( V_16 , & V_14 -> V_27 , & V_14 -> V_28 ) ;
if ( V_26 )
F_30 ( V_16 -> V_17 ) ;
return V_26 ;
}
...
struct V_15 * V_16 ;
int V_26 ;
V_16 = F_32 ( V_32 , sizeof( * V_16 ) , V_36 ) ;
if ( ! V_16 )
return - V_20 ;
V_16 -> V_17 = F_33 ( V_34 , 0 ) ;
if ( ! V_16 -> V_17 )
return - V_20 ;
V_16 -> V_21 = V_22 ;
V_16 -> V_23 = & V_24 ;
