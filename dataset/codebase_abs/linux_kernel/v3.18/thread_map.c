...
struct V_4 * F_10 ( T_1 V_5 , T_1 V_13 , T_2 V_14 )
{
if ( V_5 != - 1 )
return F_2 ( V_5 ) ;
if ( V_13 == - 1 && V_14 != V_30 )
...
static struct V_4 * F_11 ( const char * V_31 )
{
...
char * V_37 ;
struct V_38 * V_39 ;
struct V_40 * V_41 = F_12 ( false , V_31 ) ;
if ( ! V_41 )
return NULL ;
F_13 (pos, slist) {
...
static struct V_4 * F_16 ( const char * V_44 )
{
struct V_4 * V_6 = NULL , * V_32 ;
int V_45 = 0 ;
T_1 V_13 , V_46 = V_36 ;
...
struct V_4 * F_17 ( const char * V_5 , const char * V_13 ,
T_2 V_14 )
{
if ( V_5 )
return F_11 ( V_5 ) ;
...
T_4 F_19 ( struct V_4 * V_6 , T_5 * V_47 )
{
int V_10 ;
