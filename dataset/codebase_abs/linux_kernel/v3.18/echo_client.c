...
F_79 ( L_4 ,
F_94 ( V_131 , 1 ) ) ;
GOTO ( V_137 , V_116 = - V_142 ) ;
}
V_132 = V_134 -> V_8 ;
if ( ! strcmp ( V_134 -> V_143 -> V_144 , V_145 ) ) {
F_79 ( L_5 ) ;
GOTO ( V_137 , V_116 = - V_146 ) ;
}
...
V_170 = * V_93 ;
F_14 ( V_170 ) ;
F_121 ( F_122 ( & V_170 -> V_100 ) != 0 , V_174 L_13 , F_123 ( & V_170 -> V_100 ) ) ;
F_121 ( F_124 ( & V_170 -> V_100 ) == V_175 , V_174 L_13 ,
F_123 ( & V_170 -> V_100 ) ) ;
...
if ( V_116 != 0 )
GOTO ( V_137 , V_11 = F_84 ( V_116 ) ) ;
V_59 = F_128 ( V_26 , F_3 ( V_5 ) , V_172 , & V_69 -> V_33 ) ;
if ( F_126 ( V_59 ) )
GOTO ( V_137 , V_11 = ( void * ) V_59 ) ;
V_11 = F_7 ( V_59 ) ;
if ( V_11 -> V_165 ) {
F_129 ( V_26 , V_59 ) ;
V_11 = F_84 ( - V_42 ) ;
...
F_113 ( V_164 , L_14 , V_22 , V_22 -> V_207 ) ;
...
if ( F_126 ( V_11 ) )
GOTO ( V_263 , V_116 = F_132 ( V_11 ) ) ;
F_131 ( V_11 ) ;
F_113 ( V_164 , L_21 V_174 L_13 , F_123 ( & V_257 -> V_267 ) ) ;
V_263:
if ( V_260 && V_116 )
