...
struct V_330 * V_331 ;
F_132 ( V_23 -> V_2 ) ;
V_331 = F_138 ( V_23 -> V_2 , V_332 ) ;
if ( V_331 ) {
V_331 -> V_333 = 0 ;
F_139 ( V_23 -> V_2 ) ;
}
}
static int F_140 ( struct V_1 * V_2 , int V_40 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_313 ;
if ( V_23 -> V_240 != V_250 )
...
static int F_146 ( struct V_1 * V_2 , int V_355 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_313 ;
if ( V_355 ) {
...
static int F_144 ( struct V_1 * V_2 , T_1 V_3 , long V_40 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_358 ;
...
V_367 |= F_144 ( V_2 , V_3 , V_23 -> V_242 [ V_263 ] ) ;
return V_367 ;
}
...
static void F_149 ( struct V_1 * V_2 , unsigned int V_368 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
if ( V_368 != 0 )
F_20 ( V_2 , V_23 -> V_369 [ 0 ] , 0 ,
...
V_367 |= F_144 ( V_2 , V_3 , V_23 -> V_242 [ V_263 ] ) ;
V_367 |= F_146 ( V_2 , ( V_23 -> V_371 ? 1 : 0 ) ) ;
V_368 = F_148 ( V_2 ) ;
V_367 |= F_140 ( V_2 , 1 ) ;
F_149 ( V_2 , V_368 ) ;
return V_367 ;
}
static int F_143 ( struct V_1 * V_2 , long V_40 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
int V_367 = 0 ;
if ( V_40 )
V_367 = F_151 ( V_2 , V_23 -> V_343 [ 0 ] , 0 ,
V_288 , 0 , V_372 , 3 ) ;
else
V_367 = F_151 ( V_2 , V_23 -> V_343 [ 0 ] , 0 ,
V_288 , 0 , V_372 , 0 ) ;
...
static int F_152 ( struct V_267 * V_268 ,
struct V_269 * V_270 )
{
struct V_1 * V_2 = F_116 ( V_268 ) ;
T_1 V_3 = F_117 ( V_268 ) ;
...
V_373 = F_145 ( V_2 , V_3 , & V_350 ) ;
if ( V_373 ) {
int V_103 = F_153 ( V_268 ) ;
...
( ( V_3 >= V_364 ) && ( V_3 < V_365 ) ) ) {
V_23 -> V_242 [ V_3 - V_244 ] = * V_271 ;
V_389 = F_144 ( V_2 , V_3 , * V_271 ) ;
goto exit;
}
if ( V_3 == V_23 -> V_343 [ 0 ] ) {
V_23 -> V_348 = * V_271 ;
if ( V_23 -> V_338 != V_339 )
V_389 = F_143 ( V_2 , * V_271 ) ;
goto exit;
}
exit:
F_114 ( V_2 ) ;
...
static int F_163 ( struct V_267 * V_268 ,
struct V_269 * V_270 )
{
struct V_1 * V_2 = F_116 ( V_268 ) ;
struct V_22 * V_23 = V_2 -> V_23 ;
...
static int F_165 ( struct V_267 * V_268 , int V_392 ,
...
V_375 = V_268 -> V_304 ;
V_268 -> V_304 = F_127 ( V_3 , V_374 , 0 , V_103 ) ;
V_35 = F_166 ( V_268 , V_392 , V_66 , V_295 ) ;
V_268 -> V_304 = V_375 ;
F_16 ( & V_2 -> V_376 ) ;
break;
case V_353 :
...
V_35 = F_172 ( V_2 , V_23 -> V_396 [ V_263 ] ) ;
if ( V_35 < 0 )
return V_35 ;
}
V_359 = V_360 + V_361 ;
for ( V_263 = 0 ; V_263 < V_359 ; V_263 ++ ) {
V_35 = F_167 ( V_2 , V_366 [ V_263 ] . V_3 ,
V_366 [ V_263 ] . V_285 ,
V_366 [ V_263 ] . V_307 ) ;
if ( V_35 < 0 )
return V_35 ;
}
V_35 = F_167 ( V_2 , V_243 , L_102 , 0 ) ;
if ( V_35 < 0 )
return V_35 ;
V_35 = F_167 ( V_2 , V_259 , L_103 , 1 ) ;
if ( V_35 < 0 )
return V_35 ;
F_169 ( V_2 ) ;
#ifdef F_173
F_130 ( V_2 ) ;
#endif
V_35 = F_174 ( V_2 , & V_23 -> V_397 ) ;
if ( V_35 < 0 )
return V_35 ;
if ( V_23 -> V_398 ) {
V_35 = F_175 ( V_2 , V_23 -> V_398 ,
V_23 -> V_398 ) ;
if ( V_35 < 0 )
return V_35 ;
V_35 = F_176 ( V_2 , & V_23 -> V_257 ) ;
if ( V_35 < 0 )
return V_35 ;
}
if ( V_23 -> V_399 ) {
...
{
struct V_22 * V_23 = V_2 -> V_23 ;
struct V_400 * V_245 = V_23 -> V_401 ;
V_2 -> V_402 = V_245 ;
V_2 -> V_403 = 0 ;
V_245 -> V_285 = L_104 ;
V_245 -> V_10 [ V_404 ] = V_405 ;
V_245 -> V_10 [ V_404 ] . V_3 = V_23 -> V_239 [ 0 ] ;
V_245 -> V_10 [ V_404 ] . V_406 =
V_23 -> V_257 . V_407 ;
V_245 -> V_10 [ V_408 ] = V_409 ;
V_245 -> V_10 [ V_408 ] . V_410 = 1 ;
V_245 -> V_10 [ V_408 ] . V_3 = V_23 -> V_369 [ 0 ] ;
V_2 -> V_403 ++ ;
V_245 ++ ;
V_245 -> V_285 = L_105 ;
V_245 -> V_10 [ V_408 ] = V_409 ;
V_245 -> V_10 [ V_408 ] . V_410 = 1 ;
V_245 -> V_10 [ V_408 ] . V_3 = V_23 -> V_369 [ 1 ] ;
V_2 -> V_403 ++ ;
V_245 ++ ;
V_245 -> V_285 = L_106 ;
V_245 -> V_10 [ V_408 ] = V_409 ;
V_245 -> V_10 [ V_408 ] . V_410 = 1 ;
V_245 -> V_10 [ V_408 ] . V_3 = V_23 -> V_369 [ 2 ] ;
V_2 -> V_403 ++ ;
...
V_245 -> V_10 [ V_404 ] =
V_413 ;
V_245 -> V_10 [ V_404 ] . V_3 = V_23 -> V_398 ;
}
if ( V_23 -> V_399 ) {
V_245 -> V_10 [ V_408 ] =
V_414 ;
V_245 -> V_10 [ V_408 ] . V_3 = V_23 -> V_399 ;
}
V_2 -> V_403 ++ ;
return 0 ;
}
static void F_179 ( struct V_1 * V_2 , T_1 V_415 , T_1 V_416 )
{
if ( V_415 ) {
F_134 ( V_2 , V_415 , V_324 ) ;
if ( F_180 ( V_2 , V_415 ) & V_417 )
F_20 ( V_2 , V_415 , 0 ,
V_418 ,
V_419 ) ;
}
if ( V_416 && ( F_180 ( V_2 , V_416 ) & V_417 ) )
F_20 ( V_2 , V_416 , 0 ,
V_418 , V_420 ) ;
}
static void F_181 ( struct V_1 * V_2 , T_1 V_415 , T_1 V_421 )
{
if ( V_415 ) {
F_134 ( V_2 , V_415 , V_422 ) ;
if ( F_180 ( V_2 , V_415 ) & V_423 )
F_20 ( V_2 , V_415 , 0 ,
V_418 ,
F_182 ( 0 ) ) ;
}
if ( V_421 && ( F_180 ( V_2 , V_421 ) & V_423 ) ) {
F_20 ( V_2 , V_421 , 0 , V_418 ,
F_182 ( 0 ) ) ;
F_183 ( V_2 , V_421 , V_288 , 0 ,
V_372 , 0x5a ) ;
F_183 ( V_2 , V_421 , V_288 , 0 ,
V_424 , 0 ) ;
}
}
static void F_184 ( struct V_1 * V_2 , T_1 V_3 , int V_103 )
{
unsigned int V_425 ;
V_425 = F_185 ( V_2 , V_3 , V_103 == V_289 ?
V_426 : V_427 ) ;
F_186 ( V_2 , V_3 , V_103 , V_425 ) ;
}
static void F_142 ( struct V_1 * V_2 , int V_355 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_313 ;
T_3 V_40 ;
...
F_12 ( V_2 , L_109 ) ;
V_3 = V_2 -> V_435 ;
for ( V_263 = 0 ; V_263 < V_2 -> V_436 ; V_263 ++ , V_3 ++ )
V_2 -> V_437 [ V_263 ] = F_185 ( V_2 , V_3 ,
V_438 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_257 . V_439 ; V_263 ++ )
F_184 ( V_2 , V_23 -> V_239 [ V_263 ] , V_289 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_440 ; V_263 ++ )
F_184 ( V_2 , V_23 -> V_317 [ V_263 ] , V_289 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_441 ; V_263 ++ ) {
F_184 ( V_2 , V_23 -> V_369 [ V_263 ] , V_288 ) ;
F_184 ( V_2 , V_23 -> V_343 [ V_263 ] , V_288 ) ;
}
}
...
for ( V_263 = 0 ; V_263 <= V_366 [ V_262 ] . V_442 ; V_263 ++ ) {
F_38 ( V_2 , V_366 [ V_262 ] . V_266 ,
V_366 [ V_262 ] . V_357 [ V_263 ] ,
V_366 [ V_262 ] . V_443 [ V_263 ] ) ;
}
}
V_313 = V_326 ;
...
static void F_193 ( struct V_1 * V_2 , bool V_452 )
{
...
{
bool V_461 = false ;
const struct V_204 * V_462 ;
const struct V_463 * V_464 ;
if ( F_195 ( & V_464 , V_465 , V_2 -> V_466 -> V_467 -> V_468 ) != 0 )
return false ;
V_462 = (struct V_204 * ) ( V_464 -> V_15 ) ;
...
static void F_200 ( struct V_1 * V_2 , struct V_471 * V_473 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
F_201 ( & V_23 -> V_329 ) ;
F_202 ( V_2 -> V_466 -> V_474 , & V_23 -> V_329 ,
F_6 ( 500 ) ) ;
V_473 -> V_475 -> V_333 = 1 ;
}
static void F_203 ( struct V_1 * V_2 , struct V_471 * V_473 )
{
F_141 ( V_2 ) ;
}
static void F_204 ( struct V_1 * V_2 )
{
F_205 ( V_2 , V_332 , F_200 ) ;
F_205 ( V_2 , V_476 ,
F_203 ) ;
F_205 ( V_2 , V_477 ,
F_199 ) ;
...
F_187 ( V_2 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_440 ; V_263 ++ )
F_179 ( V_2 , V_23 -> V_317 [ V_263 ] , V_23 -> V_239 [ 0 ] ) ;
F_179 ( V_2 , V_480 -> V_483 [ 0 ] , V_23 -> V_398 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_441 ; V_263 ++ )
F_181 ( V_2 , V_23 -> V_343 [ V_263 ] , V_23 -> V_369 [ V_263 ] ) ;
F_181 ( V_2 , V_480 -> V_484 , V_23 -> V_399 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_485 ; V_263 ++ )
F_210 ( V_2 , V_23 -> V_486 [ V_263 ] ) ;
F_132 ( V_2 ) ;
F_141 ( V_2 ) ;
F_139 ( V_2 ) ;
F_114 ( V_2 ) ;
...
V_23 -> V_486 [ 1 ] = V_497 ;
V_23 -> V_485 = 2 ;
F_214 ( & V_23 -> V_329 , F_135 ) ;
F_206 ( V_2 ) ;
F_212 ( V_2 ) ;
V_35 = F_215 ( V_2 , & V_23 -> V_397 , NULL ) ;
if ( V_35 < 0 )
return V_35 ;
V_2 -> V_498 = V_499 ;
V_2 -> V_500 = 1 ;
