...
T_1 V_5 ;
int V_9 ;
for ( V_9 = 0 ; V_9 < F_54 ( V_206 ) ; V_9 ++ )
V_205 -> V_207 [ V_9 ] = F_7 ( V_2 , V_206 [ V_9 ] ) ;
if ( V_2 -> V_39 ) {
V_5 = V_2 -> V_40 + V_41 ;
V_205 -> V_208 [ 0 ] = F_7 ( V_2 , V_5 ) ;
}
if ( V_2 -> V_43 ) {
V_5 = V_2 -> V_40 + V_44 ;
V_205 -> V_208 [ 1 ] = F_7 ( V_2 , V_5 ) ;
}
for ( V_9 = 0 ; V_9 < V_2 -> V_32 ; V_9 ++ )
V_205 -> V_209 [ V_9 ] = F_7 ( V_2 ,
F_13 ( V_9 ) ) ;
return 0 ;
}
static int F_55 ( struct V_47 * V_93 )
{
struct V_1 * V_2 = F_19 ( V_93 ) ;
struct V_204 * V_205 = & V_2 -> V_205 ;
T_1 V_5 ;
int V_9 ;
for ( V_9 = 0 ; V_9 < F_54 ( V_206 ) ; V_9 ++ )
F_6 ( V_2 , V_206 [ V_9 ] , V_205 -> V_207 [ V_9 ] ) ;
if ( V_2 -> V_39 ) {
V_5 = V_2 -> V_40 + V_41 ;
F_6 ( V_2 , V_5 , V_205 -> V_208 [ 0 ] ) ;
}
if ( V_2 -> V_43 ) {
V_5 = V_2 -> V_40 + V_44 ;
F_6 ( V_2 , V_5 , V_205 -> V_208 [ 1 ] ) ;
}
for ( V_9 = 0 ; V_9 < V_2 -> V_32 ; V_9 ++ )
F_6 ( V_2 , F_13 ( V_9 ) ,
V_205 -> V_209 [ V_9 ] ) ;
...
static int F_56 ( struct V_210 * V_211 )
{
struct V_212 * V_213 = V_211 -> V_54 . V_214 ;
struct V_215 * V_216 , * V_217 ;
const char * V_218 ;
int V_50 ;
if ( ! V_213 )
return 0 ;
V_218 = F_57 ( V_213 , L_10 , NULL ) ;
if ( ! V_218 )
return 0 ;
V_216 = F_58 ( & V_211 -> V_54 , L_11 ) ;
if ( F_59 ( V_216 ) ) {
F_39 ( & V_211 -> V_54 , L_12 ) ;
return F_60 ( V_216 ) ;
}
V_217 = F_58 ( NULL , V_218 ) ;
if ( F_59 ( V_217 ) ) {
F_39 ( & V_211 -> V_54 , L_13 ) ;
V_50 = F_60 ( V_217 ) ;
goto V_219;
}
V_50 = F_61 ( V_216 , V_217 ) ;
if ( V_50 ) {
F_39 ( & V_211 -> V_54 , L_14 ) ;
goto V_220;
}
V_220:
F_62 ( V_217 ) ;
...
static struct V_221 * F_63 (
struct V_210 * V_211 )
{
struct V_212 * V_222 = V_211 -> V_54 . V_214 ;
struct V_221 * V_223 = NULL ;
const struct V_224 * V_225 =
F_64 ( V_226 , & V_211 -> V_54 ) ;
struct V_227 V_228 ;
const T_1 * V_229 ;
T_1 V_4 ;
int V_9 , V_50 = 0 ;
if ( V_211 -> V_54 . V_230 ) {
V_223 = V_211 -> V_54 . V_230 ;
return V_223 ;
} else if ( V_225 ) {
V_223 = (struct V_221 * ) V_225 -> V_231 ;
} else {
V_50 = - V_64 ;
goto V_232;
}
V_50 = F_65 ( V_222 , L_15 , & V_4 ) ;
if ( V_50 >= 0 )
V_223 -> V_115 = V_4 ;
V_50 = F_65 ( V_222 , L_16 , & V_4 ) ;
if ( V_50 >= 0 ) {
if ( V_4 < 2 || V_4 > 32 ) {
F_39 ( & V_211 -> V_54 ,
L_17 ) ;
...
V_229 = F_57 ( V_222 , L_18 , & V_4 ) ;
V_4 /= sizeof( T_1 ) ;
if ( V_229 ) {
T_3 * V_233 = F_66 ( & V_211 -> V_54 ,
( sizeof( * V_233 ) * V_4 ) ,
V_234 ) ;
if ( ! V_233 ) {
V_50 = - V_235 ;
...
V_233 [ V_9 ] = F_67 ( & V_229 [ V_9 ] ) ;
V_223 -> V_32 = V_4 ;
V_223 -> V_33 = V_233 ;
}
V_50 = F_68 ( V_222 , L_19 , L_20 ) ;
if ( V_50 < 0 )
goto V_232;
V_50 = F_69 ( V_222 , L_21 , L_22 , V_50 ,
& V_228 ) ;
if ( V_50 < 0 )
goto V_232;
V_223 -> V_236 = V_228 . args [ 0 ] ;
V_50 = F_68 ( V_222 , L_19 , L_23 ) ;
if ( V_50 < 0 )
goto V_232;
V_50 = F_69 ( V_222 , L_21 , L_22 , V_50 ,
& V_228 ) ;
if ( V_50 < 0 )
goto V_232;
V_223 -> V_237 = V_228 . args [ 0 ] ;
V_50 = F_65 ( V_222 , L_24 , & V_4 ) ;
if ( V_50 >= 0 )
V_223 -> V_39 = V_4 ;
V_50 = F_65 ( V_222 , L_25 , & V_4 ) ;
if ( V_50 >= 0 )
V_223 -> V_43 = V_4 ;
V_50 = F_65 ( V_222 , L_26 , & V_4 ) ;
if ( V_50 >= 0 )
V_223 -> V_238 = V_4 ;
V_50 = F_65 ( V_222 , L_27 , & V_4 ) ;
if ( V_50 >= 0 )
V_223 -> V_239 = V_4 ;
return V_223 ;
V_232:
if ( V_50 < 0 ) {
F_39 ( & V_211 -> V_54 , L_28 ,
V_50 ) ;
V_223 = NULL ;
}
return V_223 ;
}
static int F_70 ( struct V_210 * V_211 )
{
struct V_121 * V_122 ;
struct V_123 * V_124 ;
...
struct V_1 * V_2 ;
int V_50 ;
if ( ! V_211 -> V_54 . V_230 && ! V_211 -> V_54 . V_214 ) {
F_39 ( & V_211 -> V_54 , L_29 ) ;
return - V_64 ;
}
V_2 = F_66 ( & V_211 -> V_54 , sizeof( struct V_1 ) ,
V_234 ) ;
if ( ! V_2 )
return - V_235 ;
V_223 = F_63 ( V_211 ) ;
if ( ! V_223 ) {
F_39 ( & V_211 -> V_54 , L_30 ) ;
return - V_64 ;
}
V_241 = F_71 ( V_211 , V_245 , L_31 ) ;
if ( ! V_241 ) {
F_38 ( V_2 -> V_54 ,
L_32 ) ;
V_241 = F_72 ( V_211 , V_245 , 0 ) ;
if ( ! V_241 ) {
F_39 ( & V_211 -> V_54 , L_33 ) ;
return - V_246 ;
}
}
V_242 = F_73 ( & V_211 -> V_54 , V_241 -> V_247 ,
F_74 ( V_241 ) , V_211 -> V_248 ) ;
if ( ! V_242 ) {
F_39 ( & V_211 -> V_54 , L_34 ) ;
return - V_249 ;
}
F_75 ( & V_211 -> V_54 ) ;
V_50 = F_20 ( & V_211 -> V_54 ) ;
if ( F_76 ( V_50 ) ) {
F_39 ( & V_211 -> V_54 , L_35 ) ;
return V_50 ;
}
V_2 -> V_6 = F_77 ( & V_211 -> V_54 , V_241 -> V_247 , F_74 ( V_241 ) ) ;
if ( ! V_2 -> V_6 ) {
F_39 ( & V_211 -> V_54 , L_36 ) ;
V_50 = - V_235 ;
goto V_250;
}
V_2 -> V_115 = V_223 -> V_115 ;
V_2 -> V_114 = V_223 -> V_114 ;
V_2 -> V_32 = V_223 -> V_32 ;
#ifdef F_78
V_2 -> V_205 . V_209 = F_66 ( & V_211 -> V_54 ,
sizeof( T_1 ) * V_2 -> V_32 ,
V_234 ) ;
#endif
V_2 -> V_33 = V_223 -> V_33 ;
V_2 -> V_132 = V_223 -> V_132 ;
V_2 -> V_39 = V_223 -> V_39 ;
V_2 -> V_43 = V_223 -> V_43 ;
V_2 -> V_54 = & V_211 -> V_54 ;
V_244 = F_71 ( V_211 , V_245 , L_37 ) ;
if ( V_244 )
V_2 -> V_150 = true ;
V_122 = & V_2 -> V_122 [ V_38 ] ;
V_124 = & V_2 -> V_124 [ V_38 ] ;
V_122 -> V_251 = V_223 -> V_251 ;
V_122 -> V_252 = V_223 -> V_252 ;
V_122 -> V_253 = V_223 -> V_253 ;
V_122 -> V_254 = V_223 -> V_238 ;
if ( V_244 )
V_122 -> V_255 = V_244 -> V_247 ;
else
V_122 -> V_255 = V_241 -> V_247 + V_223 -> V_256 ;
V_124 -> V_257 = V_122 -> V_255 ;
V_243 = F_72 ( V_211 , V_258 , 0 ) ;
if ( V_243 )
V_122 -> V_259 = V_243 -> V_247 ;
else
V_122 -> V_259 = V_223 -> V_236 ;
if ( V_211 -> V_54 . V_214 )
V_124 -> V_260 = L_20 ;
else
V_124 -> V_260 = & V_122 -> V_259 ;
V_122 = & V_2 -> V_122 [ V_203 ] ;
V_124 = & V_2 -> V_124 [ V_203 ] ;
V_122 -> V_251 = V_223 -> V_251 ;
V_122 -> V_252 = V_223 -> V_252 ;
V_122 -> V_253 = V_223 -> V_253 ;
V_122 -> V_254 = V_223 -> V_239 ;
if ( V_244 )
V_122 -> V_255 = V_244 -> V_247 ;
else
V_122 -> V_255 = V_241 -> V_247 + V_223 -> V_261 ;
V_124 -> V_257 = V_122 -> V_255 ;
if ( V_2 -> V_132 < V_133 ) {
V_2 -> V_40 = V_262 ;
V_2 -> V_150 = true ;
...
V_243 = F_72 ( V_211 , V_258 , 1 ) ;
if ( V_243 )
V_122 -> V_259 = V_243 -> V_247 ;
else
V_122 -> V_259 = V_223 -> V_237 ;
if ( V_211 -> V_54 . V_214 )
V_124 -> V_260 = L_23 ;
else
V_124 -> V_260 = & V_122 -> V_259 ;
...
F_82 ( V_270 ) )
case V_271 :
V_50 = F_85 ( & V_211 -> V_54 ) ;
break;
#endif
default:
F_39 ( & V_211 -> V_54 , L_38 ,
V_2 -> V_132 ) ;
V_50 = - V_64 ;
break;
}
if ( V_50 ) {
F_39 ( & V_211 -> V_54 , L_39 , V_50 ) ;
goto V_250;
}
return 0 ;
V_250:
