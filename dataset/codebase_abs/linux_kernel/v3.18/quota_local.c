...
V_77 -> V_65 = F_104 ( V_77 -> V_55 . V_161 ,
struct V_52 ,
V_55 ) -> V_65 + 1 ;
V_77 -> V_56 = V_13 ;
* V_156 = 0 ;
...
V_148 -> V_165 -> V_56 , V_19 ) ;
if ( V_17 < 0 ) {
F_17 ( V_17 ) ;
goto V_102;
}
V_156 = F_10 ( V_2 , V_148 -> V_165 -> V_65 ,
V_148 -> V_151 ) ;
V_76 = (struct V_6 * )
( V_148 -> V_165 -> V_56 -> V_46 ) ;
F_21 ( V_148 -> V_165 -> V_56 ) ;
F_73 ( V_156 , V_76 -> V_81 ) ;
F_74 ( & V_76 -> V_90 , 1 ) ;
F_22 ( V_148 -> V_165 -> V_56 ) ;
F_23 ( V_16 , V_148 -> V_165 -> V_56 ) ;
V_102:
return V_17 ;
}
