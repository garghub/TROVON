...
static void F_59 ( struct V_145 * V_32 )
{
int V_167 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
...
static int F_60 ( struct V_145 * V_32 )
{
return F_55 ( V_32 -> V_5 ) ;
}
static void F_61 ( struct V_145 * V_32 )
{
int V_80 ;
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
if ( V_32 -> V_71 & V_169 ) {
V_80 = F_62 ( & V_32 -> V_5 -> V_165 ) ;
if ( V_80 < 0 ) {
F_63 ( & V_32 -> V_5 -> V_165 ) ;
goto V_10;
}
...
if ( V_2 && F_71 ( V_2 ) && V_2 -> V_165 . V_170 ) {
...
static int F_72 ( struct V_145 * V_32 )
{
...
if ( ! ( V_32 -> V_178 & V_179 ) ) {
F_81 ( V_32 -> V_180 ) ;
} else if ( V_32 -> V_71 & V_181 ) {
F_39 ( V_32 ) ;
V_32 -> V_107 -> V_182 ( V_32 , 1 ) ;
F_40 ( V_32 ) ;
}
}
F_66 ( V_32 ) ;
...
static int F_84 ( struct V_145 * V_32 )
{
F_69 ( V_32 ) ;
return 0 ;
}
...
int F_86 ( struct V_145 * V_32 )
{
int V_80 , V_167 , V_185 ;
T_1 V_23 , V_149 ;
struct V_12 * V_5 ;
F_6 ( ! V_32 ) ;
F_42 ( ! V_32 -> V_151 ) ;
...
F_87 ( V_32 , & V_186 ) ;
if ( V_32 -> V_187 )
V_32 -> V_160 = V_32 -> V_187 ;
V_149 = F_88 ( V_32 , V_23 ) ;
if ( ! V_149 ) {
V_80 = - V_33 ;
goto V_80;
}
...
V_185 = ( V_23 & 0x70000000 ) >> 28 ;
V_5 -> V_168 = 0 ;
for ( V_167 = 0 ; V_167 < V_185 ; V_167 ++ , V_5 -> V_168 ++ ) {
V_80 = F_5 ( V_32 -> V_5 , V_167 + 1 ) ;
if ( V_80 )
goto remove;
if ( V_32 -> V_71 & V_169 )
F_79 ( & V_5 -> V_1 [ V_167 ] -> V_165 ) ;
}
F_66 ( V_32 ) ;
V_80 = F_89 ( V_32 -> V_5 ) ;
if ( V_80 )
