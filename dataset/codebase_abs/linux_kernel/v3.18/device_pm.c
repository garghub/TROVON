...
T_3 V_52 , int * V_53 , int * V_54 )
{
char V_30 [] = { '_' , 'S' , '0' + V_52 , 'D' , '\0' } ;
T_1 V_19 = V_27 -> V_19 ;
...
int F_43 ( struct V_8 * V_33 , int * V_53 , int V_63 )
{
struct V_7 * V_27 ;
int V_36 , V_55 , V_56 ;
if ( V_63 < V_2 || V_63 > V_6 )
return - V_11 ;
if ( V_63 > V_5 ) {
enum V_64 V_65 ;
V_65 = F_41 ( V_33 , V_66 ) ;
...
return - V_11 ;
if ( V_56 > V_63 ) {
for ( V_56 = V_63 ; V_56 > V_55 ; V_56 -- ) {
if ( V_27 -> V_15 . V_28 [ V_56 ] . V_12 . V_32 )
break;
}
}
if ( V_53 )
...
{
struct V_8 * V_33 ;
V_33 = F_48 ( V_46 , struct V_69 , V_46 ) -> V_33 ;
if ( V_33 ) {
F_49 ( V_33 , 0 ) ;
F_50 ( V_33 ) ;
}
}
static int F_51 ( struct V_7 * V_27 , T_3 V_52 ,
bool V_70 )
{
...
T_2 V_71 ;
int error ;
error = F_52 ( V_27 , V_52 ) ;
if ( error )
return error ;
V_71 = F_53 ( V_42 -> V_72 , V_42 -> V_73 ) ;
if ( F_5 ( V_71 ) ) {
F_54 ( V_27 ) ;
return - V_74 ;
}
...
int F_56 ( struct V_8 * V_75 , bool V_70 )
{
struct V_7 * V_27 ;
if ( ! F_57 ( V_75 ) )
return - V_11 ;
...
return F_51 ( V_27 , V_57 , V_70 ) ;
}
int F_58 ( struct V_8 * V_33 , bool V_70 )
{
struct V_7 * V_27 ;
int error ;
if ( ! F_59 ( V_33 ) )
...
V_77 = F_41 ( V_33 , V_61 ) >
V_62 ;
error = F_51 ( V_27 , V_57 , V_77 ) ;
if ( V_77 && error )
return - V_78 ;
error = F_61 ( V_33 , V_27 , V_57 ) ;
if ( error )
F_51 ( V_27 , V_57 , false ) ;
return error ;
}
...
error = F_51 ( V_27 , V_52 , V_42 ) ;
if ( V_42 && error )
return error ;
error = F_61 ( V_33 , V_27 , V_52 ) ;
if ( error )
...
static void F_86 ( struct V_8 * V_33 , bool V_83 )
{
struct V_7 * V_27 = F_44 ( V_33 ) ;
...
int F_89 ( struct V_8 * V_33 , bool V_86 )
{
struct V_7 * V_27 = F_44 ( V_33 ) ;
if ( ! V_27 )
return - V_22 ;
