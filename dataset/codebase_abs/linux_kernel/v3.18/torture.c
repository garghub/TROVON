...
bool F_69 ( char * V_74 , bool V_75 , int * V_76 )
{
F_28 ( & V_65 ) ;
if ( V_10 != NULL ) {
F_11 ( L_30 ,
...
int F_76 ( int (* F_77)( void * V_1 ) , void * V_1 , char * V_72 , char * V_79 ,
char * V_80 , struct V_34 * * V_35 )
{
int V_5 = 0 ;
F_3 ( V_79 ) ;
* V_35 = F_78 ( F_77 , V_1 , L_4 , V_72 ) ;
if ( F_79 ( * V_35 ) ) {
V_5 = F_80 ( * V_35 ) ;
F_48 ( V_80 ) ;
* V_35 = NULL ;
...
void F_81 ( char * V_79 , struct V_34 * * V_35 )
{
if ( * V_35 == NULL )
return;
F_3 ( V_79 ) ;
