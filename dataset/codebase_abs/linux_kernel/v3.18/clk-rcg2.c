...
unsigned long * V_42 , struct V_13 * * V_43 )
{
unsigned long V_44 ;
V_41 = F_17 ( V_41 , V_25 ) ;
if ( ! V_41 )
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
return F_16 ( V_2 , V_4 -> V_40 , V_25 , V_42 , V_43 ) ;
}
...
struct V_13 * V_61 = * V_43 = F_19 ( V_2 -> V_13 , V_41 -> V_45 ) ;
for (; V_52 -> V_58 ; V_52 ++ ) {
...
T_1 V_32 = F_15 ( V_4 -> V_38 ) - 1 ;
T_1 V_29 ;
struct V_13 * V_61 = F_19 ( V_2 -> V_13 , V_41 . V_45 ) ;
for (; V_52 -> V_58 ; V_52 ++ ) {
V_55 = ( V_25 * V_52 -> V_59 ) / V_52 -> V_58 ;
V_54 = F_31 ( V_61 , V_55 ) ;
if ( ( V_54 < ( V_55 - V_53 ) ) ||
