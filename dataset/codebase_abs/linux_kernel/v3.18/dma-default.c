...
static int F_45 ( struct V_4 * V_5 , struct V_42 * V_43 ,
int V_44 , enum V_33 V_34 , struct V_23 * V_24 )
{
int V_45 ;
for ( V_45 = 0 ; V_45 < V_44 ; V_45 ++ , V_43 ++ ) {
if ( ! F_8 ( V_5 ) )
F_40 ( F_46 ( V_43 ) , V_43 -> V_37 , V_43 -> V_46 ,
V_34 ) ;
#ifdef F_47
V_43 -> V_47 = V_43 -> V_46 ;
#endif
V_43 -> V_48 = F_48 ( V_5 , F_46 ( V_43 ) ) +
V_43 -> V_37 ;
}
return V_44 ;
}
static T_2 F_49 ( struct V_4 * V_5 , struct V_3 * V_3 ,
unsigned long V_37 , T_4 V_20 , enum V_33 V_34 ,
struct V_23 * V_24 )
{
if ( ! F_8 ( V_5 ) )
F_40 ( V_3 , V_37 , V_20 , V_34 ) ;
return F_48 ( V_5 , V_3 ) + V_37 ;
}
static void F_50 ( struct V_4 * V_5 , struct V_42 * V_43 ,
...
int F_55 ( struct V_4 * V_5 , T_2 V_6 )
{
return 0 ;
}
int F_56 ( struct V_4 * V_5 , T_5 V_51 )
{
return F_57 ( V_5 , V_51 ) ;
}
void F_58 ( struct V_4 * V_5 , void * V_29 , T_4 V_20 ,
enum V_33 V_34 )
{
F_59 ( V_34 == V_52 ) ;
if ( ! F_8 ( V_5 ) )
