...
T_1 V_4 [ 2 ] ;
int V_6 ;
F_4 ( & V_2 -> V_8 -> V_17 , L_10 , V_23 , V_41 ) ;
...
if ( V_6 )
goto V_60;
F_28 ( & V_2 -> V_8 -> V_17 , L_14 ) ;
return 0 ;
V_60:
F_4 ( & V_8 -> V_17 , L_12 , V_6 ) ;
F_29 ( V_2 ) ;
return V_6 ;
}
static int F_30 ( struct V_7 * V_8 )
{
struct V_69 * V_2 = F_23 ( V_8 ) ;
F_4 ( & V_8 -> V_17 , L_11 ) ;
F_22 ( V_8 ) ;
if ( V_2 != NULL )
F_29 ( V_2 ) ;
