...
if ( ( V_328 + V_315 ) > V_32 )
V_328 = V_32 - V_315 ;
if ( F_134 ( V_313 -> V_329 , V_38 -> V_30 , V_328 ) ) {
V_16 = - V_273 ;
break;
}
V_315 += V_328 ;
...
if ( ( V_16 >= 0 ) && V_313 -> V_332 ) {
F_137 ( sizeof( struct V_21 ) ) ;
memcpy ( V_313 -> V_332 , & V_5 -> V_42 , sizeof( struct V_21 ) ) ;
V_313 -> V_333 = sizeof( struct V_21 ) ;
}
F_59 ( V_3 ) ;
return V_16 ;
}
...
{
unsigned char V_334 = V_5 -> V_85 & V_231 ;
...
unsigned int F_140 ( struct V_167 * V_168 , int V_335 )
{
unsigned int V_336 = 230 - V_91 ;
if ( V_168 ) {
struct V_337 * V_338 = F_141 ( V_168 -> V_174 ) ;
V_335 -= F_142 ( V_168 ) ;
if ( V_338 -> V_339 )
V_335 -= 21 ;
else
...
struct V_4 * V_5 = F_2 ( V_3 ) ;
int V_340 = F_144 ( int , V_5 -> V_185 , V_5 -> V_90 ) ;
if ( V_193 & V_306 )
return 16 ;
if ( V_198 ) {
T_7 V_335 = F_145 ( V_198 ) ;
V_340 = F_144 ( int , F_140 ( V_198 -> V_168 , V_335 ) , V_340 ) ;
}
return V_340 ;
}
...
int * V_343 )
{
struct V_37 * V_38 = F_147 ( V_3 , V_341 ,
V_342 , V_343 ) ;
if ( V_38 ) {
V_38 -> V_152 = F_148 ( V_344 ) ;
V_38 -> V_345 = V_346 ;
}
return V_38 ;
}
...
int V_183 = 0 ;
T_6 V_347 = 0 ;
int V_165 = V_313 -> V_333 ;
F_150 ( struct V_21 * , V_6 , V_313 -> V_332 ) ;
struct V_37 * V_38 = NULL ;
struct V_39 * V_40 ;
T_6 V_29 ;
unsigned char V_334 ;
long V_180 ;
if ( V_193 & ~ ( V_348 | V_306 | V_318 | V_331 | V_322 | V_349 | V_320 ) )
return - V_250 ;
...
if ( ( V_193 & V_348 ) && V_3 -> V_50 )
F_152 ( V_3 ) ;
V_336 = V_5 -> V_90 ;
V_334 = V_5 -> V_85 & V_231 ;
V_336 = F_143 ( V_3 , V_193 ) ;
if ( V_193 & V_306 ) {
V_314 = & V_5 -> V_48 ;
if ( V_32 > V_336 ) {
V_183 = - V_354 ;
...
V_40 = F_30 ( V_38 ) ;
F_153 ( V_38 , 64 + V_91 ) ;
if ( F_154 ( F_155 ( V_38 , V_29 ) , V_313 -> V_329 , V_29 ) ) {
V_183 = - V_273 ;
goto V_19;
}
if ( V_193 & V_306 ) {
...
V_40 -> V_307 |= 0x20 ;
V_5 -> V_356 += V_29 ;
if ( ( ( V_347 + V_29 ) == V_32 ) && ( V_193 & V_331 ) ) {
V_40 -> V_307 |= 0x40 ;
V_5 -> V_356 = 0 ;
if ( V_334 == V_357 )
V_5 -> V_81 -- ;
...
F_102 ( V_38 ) ;
F_59 ( V_3 ) ;
return V_347 ? V_347 : V_183 ;
V_350:
V_183 = F_157 ( V_3 , V_193 , V_183 ) ;
F_59 ( V_3 ) ;
return V_183 ;
}
static int F_158 ( struct V_359 * V_360 , unsigned long V_361 ,
void * V_213 )
{
...
static struct V_2 * F_163 ( struct V_365 * V_366 )
{
struct V_367 * V_70 = V_366 -> V_368 ;
struct V_2 * V_316 = NULL ;
for( V_70 -> V_369 = 0 ;
V_70 -> V_369 < V_370 ;
++ V_70 -> V_369 ) {
V_316 = F_28 ( & V_10 [ V_70 -> V_369 ] ) ;
if ( V_316 )
break;
}
return V_316 ;
}
static struct V_2 * F_164 ( struct V_365 * V_366 ,
struct V_2 * V_316 )
{
struct V_367 * V_70 = V_366 -> V_368 ;
V_316 = F_165 ( V_316 ) ;
...
static struct V_2 * F_166 ( struct V_365 * V_366 , T_8 * V_372 )
{
struct V_2 * V_3 = F_163 ( V_366 ) ;
if ( V_3 ) {
while( * V_372 && ( V_3 = F_164 ( V_366 , V_3 ) ) )
-- * V_372 ;
}
return * V_372 ? NULL : V_3 ;
}
static void * F_167 ( struct V_365 * V_366 , T_8 V_372 )
{
void * V_373 ;
F_168 ( & V_18 ) ;
V_373 = F_166 ( V_366 , & V_372 ) ;
if ( ! V_373 ) {
F_169 ( & V_18 ) ;
}
return V_373 ;
}
static void * F_170 ( struct V_365 * V_366 , T_8 * V_372 )
{
return * V_372 ? F_167 ( V_366 , * V_372 - 1 ) : V_374 ;
}
static void * F_171 ( struct V_365 * V_366 , void * V_375 , T_8 * V_372 )
{
void * V_373 ;
if ( V_375 == V_374 ) {
V_373 = F_167 ( V_366 , 0 ) ;
...
static void F_172 ( struct V_365 * V_366 , void * V_375 )
{
if ( V_375 && V_375 != V_374 )
F_169 ( & V_18 ) ;
}
static void F_173 ( struct V_21 * V_376 , unsigned char * V_28 )
{
int V_22 ;
switch ( F_4 ( V_376 -> V_25 ) ) {
case 0 :
sprintf ( V_28 , L_4 , V_376 -> V_24 ) ;
break;
default:
for ( V_22 = 0 ; V_22 < F_4 ( V_376 -> V_25 ) ; V_22 ++ ) {
V_28 [ V_22 ] = V_376 -> V_26 [ V_22 ] ;
if ( F_174 ( V_28 [ V_22 ] ) )
V_28 [ V_22 ] = '.' ;
}
V_28 [ V_22 ] = 0 ;
...
static inline void F_176 ( struct V_365 * V_366 , struct V_2 * V_3 )
{
struct V_4 * V_5 = F_2 ( V_3 ) ;
char V_378 [ V_379 ] ;
char V_380 [ V_379 ] ;
...
char V_382 [ V_34 + 3 ] ;
F_173 ( & V_5 -> V_6 , V_381 ) ;
F_173 ( & V_5 -> V_42 , V_382 ) ;
F_177 ( V_366 ,
L_22
L_23 ,
F_53 ( F_4 ( F_31 ( & V_5 -> V_6 ) ) , V_378 ) ,
V_5 -> V_11 ,
V_5 -> V_72 ,
V_5 -> V_73 ,
V_5 -> V_74 ,
...
static int F_178 ( struct V_365 * V_366 , void * V_375 )
{
if ( V_375 == V_374 ) {
F_179 ( V_366 , L_26 ) ;
} else {
...
static int F_180 ( struct V_385 * V_385 , struct V_245 * V_245 )
{
return F_181 ( V_245 , & V_386 ,
sizeof( struct V_367 ) ) ;
}
...
F_189 ( & V_389 ) ;
F_190 ( & V_390 ) ;
F_191 ( L_27 , V_391 , V_154 . V_392 , & V_393 ) ;
F_192 () ;
V_19:
return V_373 ;
}
