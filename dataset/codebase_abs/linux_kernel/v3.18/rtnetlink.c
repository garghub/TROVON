...
V_323 = F_111 ( V_279 [ V_228 ] ) ;
V_325 . V_221 = ( unsigned long ) V_323 -> V_221 ;
V_325 . V_222 = ( unsigned long ) V_323 -> V_222 ;
V_325 . V_223 = ( unsigned short ) V_323 -> V_223 ;
V_325 . V_224 = ( unsigned char ) V_323 -> V_224 ;
V_325 . V_225 = ( unsigned char ) V_323 -> V_225 ;
V_325 . V_226 = ( unsigned char ) V_323 -> V_226 ;
V_27 = V_20 -> V_326 ( V_30 , & V_325 ) ;
if ( V_27 < 0 )
goto V_318;
V_317 |= V_328 ;
}
...
struct V_329 * V_330 ;
int V_293 ;
V_293 = sizeof( V_331 ) + V_30 -> V_229 ;
V_330 = F_146 ( V_293 , V_15 ) ;
if ( ! V_330 ) {
V_27 = - V_332 ;
goto V_318;
}
V_330 -> V_333 = V_30 -> type ;
memcpy ( V_330 -> V_334 , F_111 ( V_279 [ V_230 ] ) ,
V_30 -> V_229 ) ;
V_27 = F_147 ( V_30 , V_330 ) ;
F_24 ( V_330 ) ;
if ( V_27 )
goto V_318;
V_317 |= V_322 ;
...
if ( V_279 [ V_195 ] ) {
unsigned long V_336 = F_119 ( V_279 [ V_195 ] ) ;
if ( V_30 -> V_196 ^ V_336 )
V_317 |= V_328 ;
V_30 -> V_196 = V_336 ;
}
...
if ( V_279 [ V_199 ] ) {
unsigned char V_336 = F_156 ( V_279 [ V_199 ] ) ;
F_82 ( & V_107 ) ;
if ( V_30 -> V_200 ^ V_336 )
V_317 |= V_328 ;
V_30 -> V_200 = V_336 ;
...
V_27 = V_20 -> V_338 ( V_30 , V_168 , V_226 ) ;
if ( V_27 < 0 )
goto V_318;
V_317 |= V_328 ;
}
...
V_27 = - V_177 ;
if ( V_20 -> V_338 )
V_27 = V_20 -> V_338 ( V_30 , V_174 , V_226 ) ;
if ( V_27 < 0 )
goto V_318;
V_317 |= V_328 ;
}
...
char * V_316 , unsigned char V_343 ,
...
V_209 = V_20 -> V_345 () ;
V_27 = - V_332 ;
V_30 = F_168 ( V_20 -> V_346 , V_316 , V_343 ,
...
char V_316 [ V_161 ] ;
struct V_40 * V_279 [ V_280 + 1 ] ;
struct V_40 * V_62 [ V_352 + 1 ] ;
unsigned char V_343 = V_353 ;
int V_27 ;
#ifdef F_173
V_354:
#endif
...
if ( 1 ) {
struct V_40 * V_184 [ V_20 ? V_20 -> V_356 + 1 : 0 ] ;
struct V_40 * V_357 [ V_350 ? V_350 -> V_358 + 1 : 0 ] ;
struct V_40 * * V_56 = NULL ;
struct V_40 * * V_50 = NULL ;
struct V_28 * V_359 ;
if ( V_20 ) {
if ( V_20 -> V_356 && V_62 [ V_60 ] ) {
V_27 = F_157 ( V_184 , V_20 -> V_356 ,
V_62 [ V_60 ] ,
V_20 -> V_360 ) ;
if ( V_27 < 0 )
return V_27 ;
...
! V_20 -> V_367 )
return - V_177 ;
V_27 = V_20 -> V_367 ( V_30 , V_279 , V_56 ) ;
if ( V_27 < 0 )
return V_27 ;
V_317 |= V_328 ;
}
if ( V_62 [ V_54 ] ) {
if ( ! V_350 || ! V_350 -> V_368 )
return - V_177 ;
V_27 = V_350 -> V_368 ( V_38 , V_30 ,
V_279 , V_50 ) ;
if ( V_27 < 0 )
return V_27 ;
V_317 |= V_328 ;
...
if ( V_279 [ V_228 ] || V_279 [ V_212 ] || V_279 [ V_370 ] )
return - V_177 ;
if ( ! V_20 ) {
#ifdef F_173
if ( V_19 [ 0 ] ) {
...
V_359 = F_127 ( V_28 , V_279 ) ;
if ( F_140 ( V_359 ) )
return F_141 ( V_359 ) ;
V_30 = F_167 ( V_359 , V_316 , V_343 , V_20 , V_279 ) ;
if ( F_140 ( V_30 ) ) {
V_27 = F_141 ( V_30 ) ;
goto V_64;
}
...
if ( V_20 -> V_372 ) {
V_27 = V_20 -> V_372 ( V_28 , V_30 , V_279 , V_56 ) ;
if ( V_27 < 0 ) {
if ( V_30 -> V_373 == V_374 )
F_175 ( V_30 ) ;
goto V_64;
...
if ( V_30 == NULL )
return - V_327 ;
V_375 = F_179 ( F_93 ( V_30 , V_143 ) , V_15 ) ;
if ( V_375 == NULL )
return - V_16 ;
V_27 = F_100 ( V_375 , V_30 , V_289 , F_61 ( V_49 ) . V_290 ,
V_75 -> V_291 , 0 , 0 , V_143 ) ;
if ( V_27 < 0 ) {
F_121 ( V_27 == - V_52 ) ;
F_180 ( V_375 ) ;
} else
V_27 = F_65 ( V_375 , V_28 , F_61 ( V_49 ) . V_290 ) ;
return V_27 ;
}
...
int type = V_271 -> V_75 -> V_378 - V_4 ;
if ( V_275 < V_276 || V_275 == V_379 )
continue;
if ( V_10 [ V_275 ] == NULL ||
...
int V_27 = - V_16 ;
T_4 V_381 ;
V_49 = F_179 ( ( V_381 = F_93 ( V_30 , 0 ) ) , V_76 ) ;
if ( V_49 == NULL )
goto V_318;
...
F_67 ( V_49 , V_28 , 0 , V_382 , NULL , V_76 ) ;
return;
V_318:
if ( V_27 < 0 )
F_70 ( V_28 , V_382 , V_27 ) ;
}
static int F_185 ( struct V_48 * V_49 ,
struct V_29 * V_30 ,
T_9 * V_383 , T_5 V_66 , T_5 V_180 ,
int type , unsigned int V_76 ,
int V_384 )
{
struct V_74 * V_75 ;
struct V_385 * V_386 ;
V_75 = F_102 ( V_49 , V_66 , V_180 , type , sizeof( * V_386 ) , V_384 ) ;
if ( ! V_75 )
return - V_52 ;
V_386 = F_103 ( V_75 ) ;
V_386 -> V_387 = V_388 ;
...
V_386 -> V_391 = V_76 ;
V_386 -> V_392 = 0 ;
V_386 -> V_393 = V_30 -> V_192 ;
V_386 -> V_394 = V_395 ;
if ( F_79 ( V_49 , V_396 , V_397 , V_383 ) )
goto V_84;
return F_112 ( V_49 , V_75 ) ;
V_84:
F_113 ( V_49 , V_75 ) ;
...
{
return F_94 ( sizeof( struct V_385 ) ) + F_45 ( V_397 ) ;
}
static void F_187 ( struct V_29 * V_30 , T_9 * V_383 , int type )
{
struct V_28 * V_28 = F_138 ( V_30 ) ;
struct V_48 * V_49 ;
int V_27 = - V_16 ;
V_49 = F_179 ( F_186 () , V_398 ) ;
if ( ! V_49 )
goto V_318;
V_27 = F_185 ( V_49 , V_30 , V_383 , 0 , 0 , type , V_399 , 0 ) ;
if ( V_27 < 0 ) {
F_180 ( V_49 ) ;
goto V_318;
}
F_67 ( V_49 , V_28 , 0 , V_400 , NULL , V_398 ) ;
return;
V_318:
F_70 ( V_28 , V_400 , V_27 ) ;
}
int F_188 ( struct V_385 * V_386 ,
struct V_40 * V_279 [] ,
struct V_29 * V_30 ,
const unsigned char * V_383 ,
T_8 V_76 )
{
int V_27 = - V_297 ;
if ( V_386 -> V_394 && ! ( V_386 -> V_394 & V_395 ) ) {
F_189 ( L_6 , V_30 -> V_194 ) ;
return V_27 ;
}
if ( F_190 ( V_383 ) || F_191 ( V_383 ) )
V_27 = F_192 ( V_30 , V_383 ) ;
else if ( F_193 ( V_383 ) )
V_27 = F_194 ( V_30 , V_383 ) ;
if ( V_27 == - V_21 && ! ( V_76 & V_365 ) )
V_27 = 0 ;
return V_27 ;
}
...
struct V_28 * V_28 = F_115 ( V_49 -> V_272 ) ;
struct V_385 * V_386 ;
struct V_40 * V_279 [ V_401 + 1 ] ;
struct V_29 * V_30 ;
T_9 * V_383 ;
int V_27 ;
V_27 = F_118 ( V_75 , sizeof( * V_386 ) , V_279 , V_401 , NULL ) ;
if ( V_27 < 0 )
return V_27 ;
V_386 = F_103 ( V_75 ) ;
if ( V_386 -> V_393 == 0 ) {
...
V_30 = F_137 ( V_28 , V_386 -> V_393 ) ;
if ( V_30 == NULL ) {
F_189 ( L_8 ) ;
return - V_327 ;
}
if ( ! V_279 [ V_396 ] || F_132 ( V_279 [ V_396 ] ) != V_397 ) {
F_189 ( L_9 ) ;
return - V_297 ;
}
V_383 = F_111 ( V_279 [ V_396 ] ) ;
V_27 = - V_177 ;
if ( ( ! V_386 -> V_391 || V_386 -> V_391 & V_402 ) &&
( V_30 -> V_403 & V_404 ) ) {
struct V_29 * V_405 = F_44 ( V_30 ) ;
const struct V_302 * V_20 = V_405 -> V_159 ;
V_27 = V_20 -> V_406 ( V_386 , V_279 , V_30 , V_383 , V_75 -> V_364 ) ;
if ( V_27 )
goto V_64;
else
V_386 -> V_391 &= ~ V_402 ;
}
if ( ( V_386 -> V_391 & V_399 ) ) {
if ( V_30 -> V_159 -> V_406 )
V_27 = V_30 -> V_159 -> V_406 ( V_386 , V_279 , V_30 , V_383 ,
V_75 -> V_364 ) ;
else
V_27 = F_188 ( V_386 , V_279 , V_30 , V_383 ,
V_75 -> V_364 ) ;
if ( ! V_27 ) {
F_187 ( V_30 , V_383 , V_407 ) ;
V_386 -> V_391 &= ~ V_399 ;
}
}
V_64:
...
int F_196 ( struct V_385 * V_386 ,
struct V_40 * V_279 [] ,
struct V_29 * V_30 ,
const unsigned char * V_383 )
{
int V_27 = - V_297 ;
if ( ! ( V_386 -> V_394 & V_395 ) ) {
F_189 ( L_6 , V_30 -> V_194 ) ;
return V_27 ;
}
if ( F_190 ( V_383 ) || F_191 ( V_383 ) )
V_27 = F_197 ( V_30 , V_383 ) ;
else if ( F_193 ( V_383 ) )
V_27 = F_198 ( V_30 , V_383 ) ;
return V_27 ;
}
...
const struct V_302 * V_20 = V_405 -> V_159 ;
if ( V_20 -> V_408 )
V_27 = V_20 -> V_408 ( V_386 , V_279 , V_30 , V_383 ) ;
if ( V_27 )
goto V_64;
else
V_386 -> V_391 &= ~ V_402 ;
...
if ( V_386 -> V_391 & V_399 ) {
if ( V_30 -> V_159 -> V_408 )
V_27 = V_30 -> V_159 -> V_408 ( V_386 , V_279 , V_30 , V_383 ) ;
else
V_27 = F_196 ( V_386 , V_279 , V_30 , V_383 ) ;
if ( ! V_27 ) {
F_187 ( V_30 , V_383 , V_409 ) ;
V_386 -> V_391 &= ~ V_399 ;
}
}
V_64:
...
goto V_413;
V_27 = F_185 ( V_49 , V_30 , V_412 -> V_383 ,
V_290 , V_180 ,
V_407 , V_399 ,
V_292 ) ;
if ( V_27 < 0 )
...
int V_27 ;
F_203 ( V_30 ) ;
V_27 = F_201 ( V_49 , V_271 , V_30 , & V_275 , & V_30 -> V_415 ) ;
if ( V_27 )
goto V_64;
F_201 ( V_49 , V_271 , V_30 , & V_275 , & V_30 -> V_416 ) ;
V_64:
F_204 ( V_30 ) ;
return V_275 ;
}
...
struct V_29 * V_30 ;
struct V_40 * V_279 [ V_280 + 1 ] ;
struct V_29 * V_417 = NULL ;
struct V_29 * V_405 = NULL ;
const struct V_302 * V_20 = NULL ;
const struct V_302 * V_418 = NULL ;
...
V_284 ) == 0 ) {
if ( V_279 [ V_212 ] )
V_420 = F_119 ( V_279 [ V_212 ] ) ;
}
V_419 = V_112 -> V_191 ;
if ( V_420 ) {
V_405 = F_137 ( V_28 , V_420 ) ;
if ( ! V_405 )
return - V_327 ;
V_20 = V_405 -> V_159 ;
V_417 = V_405 ;
...
if ( V_30 -> V_403 & V_404 ) {
if ( V_418 && V_418 -> V_422 )
V_275 = V_418 -> V_422 ( V_49 , V_271 , V_405 , V_30 ,
V_275 ) ;
}
V_275 = F_202 ( V_49 , V_271 , V_30 , NULL , V_275 ) ;
if ( V_30 -> V_159 -> V_422 )
V_275 = V_30 -> V_159 -> V_422 ( V_49 , V_271 , V_417 , V_30 ,
V_275 ) ;
V_418 = NULL ;
}
V_271 -> args [ 0 ] = V_275 ;
...
( V_405 &&
F_73 ( V_49 , V_212 , V_405 -> V_192 ) ) ||
( V_30 -> V_229 &&
F_79 ( V_49 , V_230 , V_30 -> V_229 , V_30 -> V_231 ) ) ||
( V_30 -> V_192 != V_30 -> V_210 &&
F_73 ( V_49 , V_211 , V_30 -> V_210 ) ) )
goto V_84;
V_424 = F_55 ( V_49 , V_266 ) ;
if ( ! V_424 )
goto V_84;
if ( F_207 ( V_49 , V_425 , V_426 ) ||
F_207 ( V_49 , V_427 , V_423 ) ) {
F_57 ( V_49 , V_424 ) ;
goto V_84;
}
F_56 ( V_49 , V_424 ) ;
...
T_5 V_428 = 0 ;
if ( F_117 ( V_271 -> V_75 ) > sizeof( struct V_111 ) ) {
struct V_40 * V_429 ;
V_429 = F_209 ( V_271 -> V_75 , sizeof( struct V_111 ) ,
V_285 ) ;
if ( V_429 ) {
if ( F_132 ( V_429 ) < sizeof( V_428 ) )
return - V_297 ;
V_428 = F_119 ( V_429 ) ;
}
}
...
const struct V_302 * V_20 = V_30 -> V_159 ;
struct V_29 * V_405 = F_44 ( V_30 ) ;
if ( V_405 && V_405 -> V_159 -> V_430 ) {
if ( V_275 >= V_271 -> args [ 0 ] &&
V_405 -> V_159 -> V_430 (
V_49 , V_290 , V_180 , V_30 , V_428 ) < 0 )
break;
V_275 ++ ;
}
if ( V_20 -> V_430 ) {
if ( V_275 >= V_271 -> args [ 0 ] &&
V_20 -> V_430 ( V_49 , V_290 , V_180 , V_30 ,
V_428 ) < 0 )
break;
V_275 ++ ;
}
...
struct V_48 * V_49 ;
int V_27 = - V_177 ;
V_49 = F_179 ( F_211 () , V_398 ) ;
if ( ! V_49 ) {
V_27 = - V_332 ;
goto V_318;
}
if ( ( ! V_76 || ( V_76 & V_431 ) ) &&
V_405 && V_405 -> V_159 -> V_430 ) {
V_27 = V_405 -> V_159 -> V_430 ( V_49 , 0 , 0 , V_30 , 0 ) ;
if ( V_27 < 0 )
goto V_318;
}
if ( ( V_76 & V_426 ) &&
V_30 -> V_159 -> V_430 ) {
V_27 = V_30 -> V_159 -> V_430 ( V_49 , 0 , 0 , V_30 , 0 ) ;
if ( V_27 < 0 )
goto V_318;
}
F_67 ( V_49 , V_28 , 0 , V_382 , NULL , V_398 ) ;
return 0 ;
V_318:
F_121 ( V_27 == - V_52 ) ;
F_180 ( V_49 ) ;
...
V_432 = F_209 ( V_75 , sizeof( struct V_111 ) , V_266 ) ;
if ( V_432 ) {
F_133 (attr, br_spec, rem) {
if ( F_134 ( V_184 ) == V_425 ) {
if ( F_132 ( V_184 ) < sizeof( V_76 ) )
return - V_297 ;
V_434 = true ;
V_76 = F_214 ( V_184 ) ;
break;
...
if ( ! V_76 || ( V_76 & V_431 ) ) {
struct V_29 * V_405 = F_44 ( V_30 ) ;
if ( ! V_405 || ! V_405 -> V_159 -> V_436 ) {
V_27 = - V_177 ;
goto V_64;
}
V_27 = V_405 -> V_159 -> V_436 ( V_30 , V_75 ) ;
if ( V_27 )
goto V_64;
V_76 &= ~ V_431 ;
}
...
V_27 = V_30 -> V_159 -> V_436 ( V_30 , V_75 ) ;
if ( ! V_27 )
V_76 &= ~ V_426 ;
}
if ( V_434 )
...
if ( ! V_76 || ( V_76 & V_431 ) ) {
struct V_29 * V_405 = F_44 ( V_30 ) ;
if ( ! V_405 || ! V_405 -> V_159 -> V_437 ) {
V_27 = - V_177 ;
goto V_64;
}
V_27 = V_405 -> V_159 -> V_437 ( V_30 , V_75 ) ;
if ( V_27 )
goto V_64;
V_76 &= ~ V_431 ;
}
...
V_27 = V_30 -> V_159 -> V_437 ( V_30 , V_75 ) ;
if ( ! V_27 )
V_76 &= ~ V_426 ;
}
if ( V_434 )
...
return 0 ;
V_45 = ( (struct V_283 * ) F_103 ( V_75 ) ) -> V_440 ;
V_438 = type >> 2 ;
V_19 = type & 3 ;
if ( V_19 != 2 && ! F_217 ( V_49 , V_320 ) )
return - V_321 ;
if ( V_19 == 2 && V_75 -> V_364 & V_441 ) {
struct V_69 * V_70 ;
T_2 V_13 ;
T_3 V_14 ;
T_8 V_442 = 0 ;
...
V_27 = F_218 ( V_70 , V_49 , V_75 , & V_444 ) ;
}
F_1 () ;
return V_27 ;
}
...
static int F_221 ( struct V_446 * V_447 , unsigned long V_448 , void * V_449 )
{
struct V_29 * V_30 = F_222 ( V_449 ) ;
switch ( V_448 ) {
case V_450 :
case V_451 :
case V_452 :
...
F_21 ( L_14 ) ;
F_229 ( & V_472 ) ;
F_20 ( V_12 , V_473 , F_178 ,
F_114 , F_181 ) ;
F_20 ( V_12 , V_474 , F_160 , NULL , NULL ) ;
F_20 ( V_12 , V_289 , F_172 , NULL , NULL ) ;
F_20 ( V_12 , V_475 , F_163 , NULL , NULL ) ;
F_20 ( V_12 , V_476 , NULL , F_183 , NULL ) ;
F_20 ( V_12 , V_477 , NULL , F_183 , NULL ) ;
F_20 ( V_478 , V_407 , F_195 , NULL , NULL ) ;
F_20 ( V_478 , V_409 , F_199 , NULL , NULL ) ;
F_20 ( V_478 , V_479 , NULL , F_205 , NULL ) ;
F_20 ( V_478 , V_473 , NULL , F_208 , NULL ) ;
F_20 ( V_478 , V_475 , F_215 , NULL , NULL ) ;
F_20 ( V_478 , V_474 , F_213 , NULL , NULL ) ;
}
