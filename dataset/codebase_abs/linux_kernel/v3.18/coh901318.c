...
static int
F_95 ( struct V_32 * V_33 , enum V_201 V_202 ,
unsigned long V_203 )
{
unsigned long V_39 ;
struct V_1 * V_2 = F_13 ( V_33 ) ;
...
void F_96 ( struct V_209 * V_210 , const int * V_211 ,
struct V_119 * V_41 )
{
int V_212 ;
int V_6 = 0 ;
struct V_1 * V_2 ;
F_31 ( & V_210 -> V_213 ) ;
for ( V_212 = 0 ; V_211 [ V_212 ] != - 1 ; V_212 += 2 ) {
for ( V_6 = V_211 [ V_212 ] ; V_6 <= V_211 [ V_212 + 1 ] ; V_6 ++ ) {
V_2 = & V_41 -> V_124 [ V_6 ] ;
V_2 -> V_41 = V_41 ;
V_2 -> V_33 . V_89 = V_210 ;
V_2 -> V_36 = V_6 ;
...
static int T_5 F_99 ( struct V_215 * V_216 )
{
int V_110 = 0 ;
struct V_119 * V_41 ;
int V_114 ;
struct V_217 * V_218 ;
V_218 = F_100 ( V_216 , V_219 , 0 ) ;
if ( ! V_218 )
return - V_220 ;
if ( F_101 ( & V_216 -> V_122 ,
V_218 -> V_221 ,
F_102 ( V_218 ) ,
V_216 -> V_122 . V_222 -> V_223 ) == NULL )
return - V_26 ;
V_41 = F_103 ( & V_216 -> V_122 ,
F_104 ( sizeof( struct V_119 ) , 4 ) +
V_27 *
sizeof( struct V_1 ) ,
V_25 ) ;
if ( ! V_41 )
return - V_26 ;
V_41 -> V_124 = ( ( void * ) V_41 ) + F_104 ( sizeof( struct V_119 ) , 4 ) ;
V_41 -> V_44 = F_105 ( & V_216 -> V_122 , V_218 -> V_221 , F_102 ( V_218 ) ) ;
if ( ! V_41 -> V_44 )
return - V_26 ;
V_41 -> V_122 = & V_216 -> V_122 ;
F_97 ( & V_41 -> V_18 . V_42 ) ;
V_41 -> V_18 . V_16 = 0 ;
F_106 ( V_17 , V_41 ) ;
V_114 = F_107 ( V_216 , 0 ) ;
if ( V_114 < 0 )
return V_114 ;
V_110 = F_108 ( & V_216 -> V_122 , V_114 , F_67 , 0 ,
L_26 , V_41 ) ;
if ( V_110 )
return V_110 ;
V_110 = F_109 ( & V_41 -> V_20 , & V_216 -> V_122 ,
sizeof( struct V_3 ) ,
32 ) ;
if ( V_110 )
return V_110 ;
F_96 ( & V_41 -> V_88 , V_224 ,
V_41 ) ;
F_52 ( V_41 -> V_88 . V_225 ) ;
F_53 ( V_96 , V_41 -> V_88 . V_225 ) ;
V_41 -> V_88 . V_226 = F_74 ;
V_41 -> V_88 . V_227 = F_76 ;
V_41 -> V_88 . V_228 = F_84 ;
V_41 -> V_88 . V_229 = F_89 ;
V_41 -> V_88 . V_230 = F_92 ;
V_41 -> V_88 . V_231 = F_95 ;
V_41 -> V_88 . V_122 = & V_216 -> V_122 ;
V_110 = F_110 ( & V_41 -> V_88 ) ;
if ( V_110 )
goto V_232;
F_96 ( & V_41 -> V_233 , V_234 ,
V_41 ) ;
F_52 ( V_41 -> V_233 . V_225 ) ;
F_53 ( V_235 , V_41 -> V_233 . V_225 ) ;
V_41 -> V_233 . V_226 = F_74 ;
V_41 -> V_233 . V_227 = F_76 ;
V_41 -> V_233 . V_236 = F_80 ;
V_41 -> V_233 . V_229 = F_89 ;
V_41 -> V_233 . V_230 = F_92 ;
V_41 -> V_233 . V_231 = F_95 ;
V_41 -> V_233 . V_122 = & V_216 -> V_122 ;
V_41 -> V_233 . V_237 = 2 ;
V_110 = F_110 ( & V_41 -> V_233 ) ;
if ( V_110 )
goto V_238;
V_110 = F_111 ( V_216 -> V_122 . V_239 , F_51 ,
V_41 ) ;
if ( V_110 )
goto V_240;
F_112 ( V_216 , V_41 ) ;
F_113 ( & V_216 -> V_122 , L_27 ,
( T_7 ) V_41 -> V_44 ) ;
return V_110 ;
V_240:
F_114 ( & V_41 -> V_233 ) ;
...
{
struct V_119 * V_41 = F_117 ( V_216 ) ;
F_118 ( V_216 -> V_122 . V_239 ) ;
F_114 ( & V_41 -> V_233 ) ;
F_114 ( & V_41 -> V_88 ) ;
F_115 ( & V_41 -> V_20 ) ;
return 0 ;
