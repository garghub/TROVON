...
L_2
L_3 ,
V_78 -> V_98 -> V_130 . V_131 -> V_132 . V_133 ) ;
V_124 = V_126 ;
}
#endif
if ( ! V_78 -> V_98 -> V_134 -> V_135 || ( V_88 & ~ V_123 ) != 0 ) {
...
{
unsigned long V_148 , V_149 , V_150 , error ;
int V_92 ;
struct V_90 V_91 ;
V_92 = - V_101 ;
...
F_24 ( V_91 ) || ( ( V_91 . V_147 & 0xfff ) && F_22 ( V_91 ) == V_94 ) ||
F_25 ( F_26 ( V_98 ) ) <
V_91 . V_99 + V_91 . V_100 + F_27 ( V_91 ) + F_28 ( V_91 ) ) {
goto V_151;
}
...
L_4
L_5 ,
V_98 -> V_130 . V_131 -> V_132 . V_133 ) ;
V_124 = V_126 ;
}
#endif
F_7 ( V_149 , V_91 . V_99 + V_91 . V_100 + V_91 . V_104 ) ;
F_39 ( V_98 , V_149 , F_28 ( V_91 ) ,
V_91 . V_99 + V_91 . V_100 ) ;
V_92 = 0 ;
goto V_151;
}
error = F_43 ( V_98 , V_149 , V_91 . V_99 + V_91 . V_100 ,
V_137 | V_144 | V_138 ,
...
if ( error != V_149 )
goto V_151;
V_150 = F_6 ( V_91 . V_99 + V_91 . V_100 ) ;
V_148 = V_91 . V_99 + V_91 . V_100 + V_91 . V_104 ;
if ( V_148 > V_150 ) {
error = F_7 ( V_149 + V_150 , V_148 - V_150 ) ;
V_92 = error ;
if ( error != V_149 + V_150 )
goto V_151;
}
V_92 = 0 ;
V_151:
