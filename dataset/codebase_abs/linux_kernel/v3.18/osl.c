...
F_127 () ;
F_130 ( V_167 -> V_168 , V_167 -> V_169 ) ;
F_40 ( V_167 ) ;
}
T_11 F_131 ( struct V_170 * V_168 , T_1 V_169 )
{
struct V_166 * V_167 ;
F_124 ( ( V_160 ,
L_36 ,
V_168 , V_169 ) ) ;
V_167 = F_132 ( sizeof( * V_167 ) , V_60 ) ;
if ( ! V_167 )
return V_162 ;
F_125 ( & V_167 -> V_153 , F_129 ) ;
V_167 -> V_168 = V_168 ;
V_167 -> V_169 = V_169 ;
if ( ! F_133 ( V_171 , & V_167 -> V_153 ) ) {
F_40 ( V_167 ) ;
return V_147 ;
}
return V_68 ;
}
bool F_134 ( struct V_152 * V_153 )
{
return F_133 ( V_171 , V_153 ) ;
}
T_11
F_135 ( T_1 V_172 , T_1 V_173 , T_20 * V_174 )
{
struct V_175 * V_176 = NULL ;
V_176 = F_136 ( sizeof( struct V_175 ) ) ;
if ( ! V_176 )
return V_162 ;
F_137 ( V_176 , V_173 ) ;
* V_174 = ( T_20 * ) V_176 ;
...
T_11 F_138 ( T_20 V_174 )
{
struct V_175 * V_176 = (struct V_175 * ) V_174 ;
if ( ! V_176 )
return V_67 ;
F_124 ( ( V_177 , L_38 , V_174 ) ) ;
F_139 ( ! F_140 ( & V_176 -> V_178 ) ) ;
F_40 ( V_176 ) ;
V_176 = NULL ;
return V_68 ;
}
T_11 F_141 ( T_20 V_174 , T_1 V_179 , V_134 V_180 )
{
T_11 V_156 = V_68 ;
struct V_175 * V_176 = (struct V_175 * ) V_174 ;
long V_181 ;
...
T_11 F_146 ( T_20 V_174 , T_1 V_179 )
{
struct V_175 * V_176 = (struct V_175 * ) V_174 ;
if ( ! V_176 || ( V_179 < 1 ) )
return V_67 ;
...
T_11 F_150 ( T_1 V_151 , void * V_188 )
{
switch ( V_151 ) {
case V_189 :
...
static int T_3 F_151 ( char * V_191 )
{
char * V_192 = V_73 ;
int V_193 = V_194 - 1 ;
if ( ! V_191 || ! * V_191 )
...
static void T_3 F_153 ( unsigned int V_197 )
{
...
void T_3 F_155 ( int V_197 , const struct V_208 * V_209 )
{
...
static int T_3 F_160 ( char * V_191 )
{
...
if ( V_211 != V_214 )
V_217 = 1 ;
V_218 = F_165 ( V_11 , V_216 -> V_222 , V_7 , V_217 ) ;
if ( V_218 ) {
if ( V_211 != V_214 ) {
if ( V_211 == V_213 )
F_12 ( V_223 L_54
...
T_11
F_174 ( char * V_72 , V_134 V_45 , V_134 V_228 , T_25 * * V_229 )
{
* V_229 = F_175 ( V_72 , V_45 , 0 , 0 , NULL ) ;
if ( * V_229 == NULL )
return V_147 ;
else
return V_68 ;
...
F_185 ( V_63 L_62 , V_64 , V_235 ) ;
}
return V_68 ;
}
T_11 T_3 F_186 ( void )
{
V_165 = F_187 ( L_63 , 0 , 1 ) ;
V_164 = F_187 ( L_64 , 0 , 1 ) ;
V_171 = F_188 ( L_65 , 0 ) ;
F_139 ( ! V_165 ) ;
F_139 ( ! V_164 ) ;
F_139 ( ! V_171 ) ;
