...
static int F_37 ( struct V_64 * V_65 , char * V_96 ,
...
T_2 * V_100 ;
T_2 * V_2 ;
if ( ! V_65 -> V_2 -> V_5 . V_101 ) {
F_4 ( V_8 , L_16 , V_25 ) ;
return - 1 ;
}
F_25 ( V_65 -> V_73 , V_97 , V_67 ) ;
V_3 = F_38 ( V_65 -> V_2 -> V_5 . V_102 , V_97 ,
V_98 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_17 , V_25 ) ;
return V_3 ;
}
V_3 = F_10 ( & V_65 -> V_2 -> V_5 . V_101 -> V_12 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_18 , V_25 ) ;
return V_3 ;
}
V_28 = V_65 -> V_103 ? strlen ( V_65 -> V_103 ) : 0 ;
...
if ( V_28 ) {
V_28 = F_33 ( V_99 , V_65 -> V_103 , V_28 , V_67 ) ;
F_39 ( V_99 ) ;
} else {
memset ( V_99 , '\0' , 2 ) ;
}
V_3 = F_11 ( & V_65 -> V_2 -> V_5 . V_101 -> V_12 ,
( char * ) V_99 , 2 * V_28 ) ;
F_40 ( V_99 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_19 , V_25 ) ;
...
V_100 = F_7 ( 2 + ( V_28 * 2 ) , V_10 ) ;
if ( V_100 == NULL ) {
V_3 = - V_11 ;
return V_3 ;
}
V_28 = F_33 ( ( V_89 * ) V_100 , V_65 -> V_86 , V_28 ,
V_67 ) ;
V_3 =
F_11 ( & V_65 -> V_2 -> V_5 . V_101 -> V_12 ,
( char * ) V_100 , 2 * V_28 ) ;
F_40 ( V_100 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_20 ,
...
V_28 = strlen ( V_65 -> V_104 ) ;
V_2 = F_7 ( 2 + ( V_28 * 2 ) , V_10 ) ;
if ( V_2 == NULL ) {
V_3 = - V_11 ;
return V_3 ;
}
V_28 = F_33 ( ( V_89 * ) V_2 , V_65 -> V_104 , V_28 ,
V_67 ) ;
V_3 =
F_11 ( & V_65 -> V_2 -> V_5 . V_101 -> V_12 ,
( char * ) V_2 , 2 * V_28 ) ;
...
V_3 = F_14 ( & V_65 -> V_2 -> V_5 . V_101 -> V_12 ,
V_96 ) ;
if ( V_3 )
F_4 ( V_8 , L_8 , V_25 ) ;
return V_3 ;
...
static int
F_41 ( const struct V_64 * V_65 , char * V_96 )
{
int V_3 ;
struct V_105 * V_106 = (struct V_105 * )
( V_65 -> V_72 . V_27 + V_69 ) ;
unsigned int V_107 ;
V_107 = V_65 -> V_72 . V_28 - ( V_69 +
F_42 ( struct V_105 , V_108 . V_109 [ 0 ] ) ) ;
if ( ! V_65 -> V_2 -> V_5 . V_101 ) {
F_4 ( V_8 , L_16 , V_25 ) ;
return - 1 ;
}
V_3 = F_38 ( V_65 -> V_2 -> V_5 . V_102 ,
V_96 , V_110 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_22 ,
V_25 ) ;
...
if ( V_65 -> V_2 -> V_111 == V_112 )
memcpy ( V_106 -> V_108 . V_109 ,
V_65 -> V_113 -> V_74 , V_114 ) ;
else
memcpy ( V_106 -> V_108 . V_109 ,
V_65 -> V_2 -> V_74 , V_114 ) ;
V_3 = F_11 ( & V_65 -> V_2 -> V_5 . V_101 -> V_12 ,
V_106 -> V_108 . V_109 , V_107 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_5 , V_25 ) ;
return V_3 ;
}
...
if ( V_2 -> V_5 . V_101 )
return 0 ;
V_2 -> V_5 . V_102 = F_2 ( L_23 , 0 , 0 ) ;
if ( F_3 ( V_2 -> V_5 . V_102 ) ) {
F_4 ( V_8 , L_24 ) ;
V_3 = F_5 ( V_2 -> V_5 . V_102 ) ;
V_2 -> V_5 . V_102 = NULL ;
return V_3 ;
}
V_4 = sizeof( struct V_9 ) +
F_6 ( V_2 -> V_5 . V_102 ) ;
V_2 -> V_5 . V_101 = F_7 ( V_4 , V_10 ) ;
if ( ! V_2 -> V_5 . V_101 ) {
F_8 ( V_2 -> V_5 . V_102 ) ;
V_2 -> V_5 . V_102 = NULL ;
return - V_11 ;
}
V_2 -> V_5 . V_101 -> V_12 . V_13 = V_2 -> V_5 . V_102 ;
V_2 -> V_5 . V_101 -> V_12 . V_14 = 0x0 ;
return 0 ;
}
int
...
V_115 = V_69 + sizeof( struct V_105 ) ;
V_116 = V_65 -> V_72 . V_28 ;
V_117 = V_65 -> V_72 . V_27 ;
V_65 -> V_72 . V_27 = F_7 ( V_115 + V_116 , V_10 ) ;
if ( ! V_65 -> V_72 . V_27 ) {
V_3 = V_11 ;
V_65 -> V_72 . V_28 = 0 ;
goto V_118;
}
V_65 -> V_72 . V_28 += V_115 ;
V_106 = (struct V_105 * )
( V_65 -> V_72 . V_27 + V_69 ) ;
V_106 -> V_119 = F_16 ( 0x00000101 ) ;
V_106 -> V_120 = 0 ;
V_106 -> time = F_45 ( F_46 ( V_121 ) ) ;
F_47 ( & V_106 -> V_122 , sizeof( V_106 -> V_122 ) ) ;
V_106 -> V_123 = 0 ;
memcpy ( V_65 -> V_72 . V_27 + V_115 , V_117 , V_116 ) ;
V_3 = F_43 ( V_65 -> V_2 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_27 , V_3 ) ;
goto V_118;
}
V_3 = F_37 ( V_65 , V_96 , V_67 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_28 , V_3 ) ;
goto V_118;
}
...
struct V_129 V_130 ;
unsigned char V_131 [ V_69 ] ;
F_47 ( V_131 , V_69 ) ;
V_125 = F_49 ( L_31 , 0 , V_132 ) ;
if ( F_3 ( V_125 ) ) {
V_3 = F_5 ( V_125 ) ;
F_4 ( V_8 , L_32 ) ;
return V_3 ;
...
F_51 ( & V_127 , V_131 , V_69 ) ;
F_51 ( & V_128 , V_65 -> V_113 -> V_133 , V_134 ) ;
V_3 = F_52 ( & V_130 , & V_128 , & V_127 , V_134 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_34 , V_3 ) ;
F_53 ( V_125 ) ;
return V_3 ;
}
memcpy ( V_65 -> V_72 . V_27 , V_131 , V_69 ) ;
V_65 -> V_72 . V_28 = V_69 ;
F_53 ( V_125 ) ;
return V_3 ;
}
