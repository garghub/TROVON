...
V_197 = F_113 ( V_137 , L_40 , 0 ) ;
if ( V_197 )
V_192 |= F_107 ( V_197 , & V_179 ) ;
if ( V_192 ) {
V_143 = F_110 ( V_137 , L_39 ) ;
if ( V_143 < 0 )
goto exit;
...
if ( V_202 -> V_203 < 0 )
return - V_84 ;
F_17 ( V_58 -> V_53 , L_41 , V_202 -> V_159 , V_202 -> V_162 ) ;
...
F_17 ( V_58 -> V_53 , L_44 , V_202 -> V_160 [ V_60 ] , V_202 -> V_203 ) ;
F_23 ( V_2 -> V_79 ) ;
...
L_57 ,
V_70 ,
V_212 ? V_206 [ V_19 ] : L_58 ,
V_213 ? ( V_209 ? L_59 : L_60 )
: L_58 ,
V_214 ? ( V_32 ? L_61 : L_62 ) : L_58 ) ;
}
F_17 ( V_2 -> V_45 . V_53 ,
L_63 ,
V_70 , V_193 , V_206 [ V_19 ] , V_207 [ V_15 ] ,
V_209 ? L_64 : L_60 ,
V_209 ? ( V_32 ? L_61 : L_62 ) : L_29 ,
V_28 ? L_65 : L_66 ) ;
F_23 ( V_2 -> V_79 ) ;
V_5 = V_70 % V_83 ;
if ( V_210 )
...
F_20 ( & V_217 -> V_53 , L_70 ) ;
return - V_84 ;
}
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_164 ; V_60 ++ ) {
if ( ! V_77 [ V_58 -> V_67 -> V_166 [ V_60 ] . V_144 ] ) {
F_21 ( & V_217 -> V_53 , L_71 , V_60 ) ;
return - V_226 ;
}
...
if ( ! V_58 -> V_216 ) {
F_20 ( & V_217 -> V_53 , L_72 ) ;
return - V_84 ;
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_164 ; V_60 ++ )
F_147 ( V_58 -> V_216 , & V_58 -> V_67 -> V_166 [ V_60 ] ) ;
F_92 ( V_217 , V_58 ) ;
F_96 ( & V_217 -> V_53 , L_73 ) ;
return 0 ;
}
