...
if ( V_2 -> type == V_9 && ! ! F_39 ( V_2 -> V_10 , V_117 -> V_383 ) != V_14 )
...
static void F_52 ( struct V_386 * V_387 )
{
struct V_12 * V_5 = F_19 ( V_387 , struct V_12 ,
V_388 ) ;
struct V_38 * V_24 ;
struct V_19 * V_20 ;
int V_34 , V_74 ;
...
V_20 = V_24 -> V_20 ;
if ( V_5 -> V_389 -> V_390 )
return V_5 -> V_389 -> V_390 ( V_5 , V_20 , V_391 ) ;
V_34 = ( ( V_20 -> V_392 - 1 ) >> 3 ) + 1 + ( V_20 -> V_114 > 0 ) ;
V_75 = F_53 ( V_20 , V_80 ) ;
if ( ! V_75 )
return;
F_54 ( V_20 , V_75 ) ;
V_74 = F_55 ( V_5 , V_75 , V_34 ) ;
if ( V_74 == - V_393 )
F_21 ( V_5 , V_20 -> V_114 , V_75 , V_34 , V_22 ,
V_391 ) ;
F_22 ( V_75 ) ;
}
static int F_56 ( struct V_31 * V_32 , unsigned int type ,
...
int V_394 ;
if ( type == V_395 )
return F_57 ( V_32 , type , V_10 , V_14 ) ;
if ( type != V_385 )
return - 1 ;
if ( ( V_394 = F_49 ( V_5 , type , V_10 , & V_24 ) ) == - 1 ) {
F_28 ( V_32 , L_8 ) ;
return - 1 ;
}
F_58 ( V_24 , V_394 , V_14 ) ;
F_59 ( & V_5 -> V_388 ) ;
return 0 ;
}
...
static void F_64 ( struct V_12 * V_5 )
{
struct V_396 * V_397 = V_5 -> V_124 ;
struct V_398 * V_399 ;
struct V_19 * V_400 ;
int V_16 , V_17 ;
V_399 = & V_5 -> V_401 [ V_113 ] ;
F_5 (rep, &rep_enum->report_list, list)
for ( V_16 = 0 ; V_16 < V_400 -> V_23 ; V_16 ++ ) {
if ( V_400 -> V_24 [ V_16 ] -> V_122 < 1 )
continue;
for ( V_17 = 0 ; V_17 < V_400 -> V_24 [ V_16 ] -> V_25 ; V_17 ++ ) {
F_23 ( V_5 , V_113 , V_400 -> V_24 [ V_16 ] ) ;
if ( V_397 -> V_402 )
V_397 -> V_402 ( V_5 , V_400 -> V_24 [ V_16 ] ,
V_400 -> V_24 [ V_16 ] -> V_2 + V_17 ) ;
}
}
}
static struct V_115 * F_65 ( struct V_12 * V_5 )
{
struct V_115 * V_116 = F_66 ( sizeof( * V_116 ) , V_80 ) ;
struct V_31 * V_31 = F_67 () ;
if ( ! V_116 || ! V_31 ) {
F_22 ( V_116 ) ;
F_68 ( V_31 ) ;
F_69 ( V_5 , L_9 ) ;
...
V_31 -> V_407 = F_8 ;
V_31 -> V_90 = V_5 -> V_90 ;
V_31 -> V_408 = V_5 -> V_408 ;
V_31 -> V_100 = V_5 -> V_100 ;
V_31 -> V_114 . V_409 = V_5 -> V_107 ;
V_31 -> V_114 . V_108 = V_5 -> V_108 ;
V_31 -> V_114 . V_109 = V_5 -> V_109 ;
V_31 -> V_114 . V_110 = V_5 -> V_110 ;
V_31 -> V_32 . V_410 = & V_5 -> V_32 ;
V_116 -> V_117 = V_31 ;
F_71 ( & V_116 -> V_411 , & V_5 -> V_412 ) ;
return V_116 ;
}
static bool F_72 ( struct V_115 * V_116 )
{
int V_16 ;
unsigned long V_413 = 0 ;
for ( V_16 = 0 ; V_16 < F_73 ( V_414 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_130 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_415 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_37 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_416 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_417 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_418 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_374 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_419 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_215 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_420 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_421 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_422 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_423 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_424 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_425 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_73 ( V_426 ) ; V_16 ++ )
V_413 |= V_116 -> V_117 -> V_427 [ V_16 ] ;
return ! ! V_413 ;
}
static void F_74 ( struct V_12 * V_5 ,
struct V_115 * V_116 )
{
struct V_19 * V_20 ;
int V_16 , V_18 ;
...
int F_76 ( struct V_12 * V_5 , unsigned int V_429 )
{
struct V_396 * V_397 = V_5 -> V_124 ;
struct V_19 * V_20 ;
...
F_78 ( & V_5 -> V_388 , F_52 ) ;
if ( ! V_429 ) {
for ( V_16 = 0 ; V_16 < V_5 -> V_430 ; V_16 ++ ) {
struct V_431 * V_432 = & V_5 -> V_433 [ V_16 ] ;
if ( V_432 -> type == V_434 ||
V_432 -> type == V_435 )
if ( F_79 ( V_432 -> V_2 ) )
break;
...
void F_82 ( struct V_12 * V_5 )
{
struct V_115 * V_116 , * V_441 ;
F_30 ( V_5 ) ;
F_83 (hidinput, next, &hid->inputs, list) {
F_75 ( & V_116 -> V_411 ) ;
F_84 ( V_116 -> V_117 ) ;
F_22 ( V_116 ) ;
}
