...
static T_2 F_34 ( struct V_42 * V_43 )
{
return F_35 ( F_36 ( V_43 -> V_44 * 4 / 3 ) ,
1UL << V_43 -> V_36 ) ;
}
...
T_2 V_16 ;
V_16 = V_45 ;
if ( ( V_43 -> V_18 && ! V_43 -> V_12 ) ||
( ! V_43 -> V_18 && ! V_43 -> F_6 ) )
return - V_46 ;
V_43 -> V_36 = F_38 ( T_2 , V_43 -> V_36 ,
F_39 ( V_47 ) ) ;
if ( V_43 -> V_44 )
V_16 = F_34 ( V_43 ) ;
V_15 = F_10 ( V_16 , V_48 ) ;
...
V_2 -> V_32 = F_39 ( V_15 -> V_16 ) ;
memcpy ( & V_2 -> V_3 , V_43 , sizeof( * V_43 ) ) ;
F_20 ( V_2 -> V_15 , V_15 ) ;
if ( ! V_2 -> V_3 . V_13 )
F_40 ( & V_2 -> V_3 . V_13 , sizeof( V_2 -> V_3 . V_13 ) ) ;
return 0 ;
}
...
static int T_5 F_49 ( struct V_1 * V_2 )
{
struct V_14 * V_15 ;
...
struct V_42 V_43 = {
. V_44 = V_62 ,
. V_7 = F_55 ( struct V_50 , V_60 ) ,
. V_19 = F_55 ( struct V_50 , V_55 ) ,
. V_18 = sizeof( int ) ,
. V_12 = V_63 ,
. V_4 = & F_42 ,
. V_39 = F_15 ,
