...
static int F_97 ( struct V_11 * V_6 )
{
struct V_4 * V_5 = F_2 ( V_6 ) ;
int V_201 ;
#ifdef F_87
...
#endif
for ( V_201 = 0 ; V_201 < V_5 -> V_109 . V_110 ; V_201 ++ ) {
F_98 ( & V_5 -> V_100 [ V_201 ] . V_117 ) ;
F_98 ( & V_5 -> V_100 [ V_201 ] . V_122 ) ;
F_99 ( & V_5 -> V_109 , & V_5 -> V_100 [ V_201 ] . V_2 ) ;
V_5 -> V_16 -> V_190 ( & V_5 -> V_100 [ V_201 ] . V_2 , 0 ) ;
}
F_93 ( & V_5 -> V_106 ) ;
F_95 ( & V_5 -> V_109 ) ;
...
static int F_100 ( struct V_248 * V_249 )
{
struct V_208 * V_16 ;
