...
return 1 ;
F_10 ( 7 , L_1 ,
& V_30 . V_50 , F_11 ( V_14 ) , & V_4 -> V_51 . V_50 , 0 ) ;
{
struct V_52 V_19 ;
F_12 ( F_13 ( V_4 ) , V_53 ,
V_26 -> V_54 , & V_30 , V_14 ,
...
& V_15 , & V_16 ) != 1 )
return 1 ;
F_10 ( 7 , L_5 , & V_65 . V_50 , F_11 ( V_14 ) ) ;
V_4 -> V_45 = NULL ;
F_10 ( 7 , L_6 ,
F_28 ( V_26 -> V_54 ) ,
& V_65 . V_50 , F_11 ( V_14 ) , & V_4 -> V_56 . V_50 , 0 ) ;
{
struct V_52 V_19 ;
F_12 ( F_13 ( V_4 ) , V_53 ,
V_26 -> V_54 , & V_65 , V_14 , & V_4 -> V_56 ,
F_29 ( F_11 ( V_4 -> V_60 ) - 1 ) , & V_19 ) ;
V_31 = F_30 ( & V_19 ) ;
if ( ! V_31 ) {
V_31 = F_15 ( & V_19 , V_53 , & V_4 -> V_67 ,
F_29 ( F_11 ( V_4 -> V_68 ) - 1 ) ,
V_6 , V_4 -> V_58 ,
V_23 -> V_59 ) ;
if ( ! V_31 )
return 0 ;
...
static int T_4 F_31 ( struct V_39 * V_39 )
{
int V_20 , V_34 ;
struct V_1 * V_2 ;
struct V_69 * V_70 = F_32 ( V_39 ) ;
if ( ! V_70 )
return - V_71 ;
V_2 = F_33 ( V_39 , & V_72 ) ;
if ( F_34 ( V_2 ) )
...
if ( ! V_74 [ V_20 ] )
continue;
V_34 = F_36 ( V_39 , V_2 , V_2 -> V_54 , V_74 [ V_20 ] ) ;
if ( V_34 )
goto V_75;
F_37 ( L_7 ,
