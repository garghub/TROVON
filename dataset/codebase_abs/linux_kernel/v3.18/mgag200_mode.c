...
if ( V_32 -> V_216 > 2048 || V_32 -> V_217 > 4096 ||
V_32 -> V_218 > 4096 || V_32 -> V_219 > 4096 ||
V_32 -> V_220 > 2048 || V_32 -> V_221 > 4096 ||
V_32 -> V_222 > 4096 || V_32 -> V_223 > 4096 ) {
return V_224 ;
}
if ( V_202 -> V_225 . V_226 ) {
if ( V_202 -> V_225 . V_227 )
V_169 = V_202 -> V_225 . V_169 ;
}
if ( ( V_32 -> V_125 * V_32 -> V_129 * ( V_169 / 8 ) ) > V_7 -> V_228 . V_229 ) {
if ( V_202 -> V_225 . V_226 )
V_202 -> V_225 . V_226 = false ;
return V_224 ;
}
return V_230 ;
}
...
* V_202 )
{
int V_231 = V_202 -> V_232 [ 0 ] ;
if ( V_231 )
return F_78 ( V_202 -> V_5 , V_231 ) ;
return NULL ;
}
static enum V_233 F_79 ( struct V_187
* V_202 , bool V_234 )
{
return V_235 ;
}
...
struct V_187 * V_202 ;
int V_117 ;
V_7 -> V_191 . V_239 = true ;
V_7 -> V_5 -> V_240 . V_241 = V_242 ;
V_7 -> V_5 -> V_240 . V_243 = V_244 ;
V_7 -> V_5 -> V_240 . V_245 = V_7 -> V_228 . V_246 ;
F_51 ( V_7 ) ;
V_195 = F_66 ( V_7 -> V_5 ) ;
if ( ! V_195 ) {
F_33 ( L_5 ) ;
