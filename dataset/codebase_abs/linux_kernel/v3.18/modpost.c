...
static void F_49 ( const char * V_6 , struct V_31 * V_32 ,
T_4 * V_154 )
{
const char * V_33 = F_47 ( V_32 , V_154 ) ;
if ( V_154 -> V_105 == V_157 &&
! ( V_154 -> V_106 & V_158 ) &&
! F_48 ( V_33 , V_159 ) ) {
F_2 ( L_43
L_44
...
static const struct V_160 * F_50 (
const char * V_161 , const char * V_162 )
{
int V_19 ;
int V_163 = sizeof( V_160 ) / sizeof( struct V_160 ) ;
const struct V_160 * V_164 = & V_160 [ 0 ] ;
for ( V_19 = 0 ; V_19 < V_163 ; V_19 ++ ) {
if ( F_48 ( V_161 , V_164 -> V_161 ) &&
F_48 ( V_162 , V_164 -> V_162 ) )
return V_164 ;
V_164 ++ ;
}
return NULL ;
}
static int F_51 ( const struct V_160 * V_165 ,
const char * V_161 , const char * V_166 ,
const char * V_162 , const char * V_167 )
{
if ( F_48 ( V_162 , V_168 ) &&
F_48 ( V_161 , V_169 ) &&
( strncmp ( V_166 , L_47 , strlen ( L_47 ) ) == 0 ) )
return 0 ;
if ( strcmp ( V_162 , L_48 ) == 0 &&
F_48 ( V_161 , V_169 ) &&
( strncmp ( V_166 , L_49 , strlen ( L_49 ) ) == 0 ) )
return 0 ;
if ( F_48 ( V_162 , V_170 ) &&
F_48 ( V_161 , V_169 ) &&
F_48 ( V_166 , V_165 -> V_171 ) )
return 0 ;
if ( F_48 ( V_161 , V_172 ) &&
F_48 ( V_162 , V_173 ) )
return 0 ;
...
static T_5 * F_52 ( struct V_31 * V_32 , T_7 V_175 ,
T_5 * V_176 )
{
T_5 * V_70 ;
T_5 * V_177 = NULL ;
...
if ( V_176 -> V_125 != 0 )
return V_176 ;
V_180 = F_37 ( V_32 , V_176 ) ;
for ( V_70 = V_32 -> V_118 ; V_70 < V_32 -> V_119 ; V_70 ++ ) {
if ( F_37 ( V_32 , V_70 ) != V_180 )
continue;
if ( F_40 ( V_70 -> V_133 ) == V_181 )
continue;
if ( V_70 -> V_126 == V_175 )
return V_70 ;
V_179 = V_70 -> V_126 - V_175 ;
if ( V_179 < 0 )
V_179 = V_175 - V_70 -> V_126 ;
if ( V_179 < V_178 ) {
V_178 = V_179 ;
V_177 = V_70 ;
}
...
static inline int F_53 ( const char * V_4 )
{
return V_4 [ 0 ] == '$' && strchr ( L_50 , V_4 [ 1 ] )
&& ( V_4 [ 2 ] == '\0' || V_4 [ 2 ] == '.' ) ;
}
static inline int F_54 ( struct V_31 * V_32 , T_5 * V_70 )
{
...
static T_5 * F_55 ( struct V_31 * V_32 , T_8 V_175 ,
const char * V_33 )
{
T_5 * V_70 ;
T_5 * V_177 = NULL ;
...
if ( F_56 ( V_70 -> V_124 ) )
continue;
V_182 = F_18 ( V_32 , F_37 ( V_32 , V_70 ) ) ;
if ( strcmp ( V_182 , V_33 ) != 0 )
continue;
if ( ! F_54 ( V_32 , V_70 ) )
continue;
if ( V_70 -> V_126 <= V_175 ) {
if ( ( V_175 - V_70 -> V_126 ) < V_178 ) {
V_178 = V_175 - V_70 -> V_126 ;
V_177 = V_70 ;
} else if ( ( V_175 - V_70 -> V_126 ) == V_178 ) {
V_177 = V_70 ;
}
}
}
...
static char * F_57 ( const char * V_22 )
{
if ( F_48 ( V_22 , V_170 ) ) {
char * V_15 = malloc ( 20 ) ;
char * V_183 = V_15 ;
...
static int F_58 ( T_5 * V_70 )
{
if ( V_70 )
return F_40 ( V_70 -> V_133 ) == V_184 ;
else
return - 1 ;
}
static void F_59 ( const char * const V_185 [ 20 ] )
{
const char * const * V_22 = V_185 ;
while ( * V_22 ) {
...
static void F_60 ( const char * V_6 ,
const struct V_160 * V_165 ,
const char * V_161 ,
...
int V_188 )
{
const char * V_189 , * V_190 ;
const char * V_191 , * V_192 ;
char * V_193 ;
char * V_194 ;
switch ( V_187 ) {
case 0 : V_189 = L_59 ; V_190 = L_15 ; break;
case 1 : V_189 = L_60 ; V_190 = L_61 ; break;
default: V_189 = L_62 ; V_190 = L_15 ; break;
}
switch ( V_188 ) {
case 0 : V_191 = L_59 ; V_192 = L_15 ; break;
case 1 : V_191 = L_60 ; V_192 = L_61 ; break;
default: V_191 = L_62 ; V_192 = L_15 ; break;
}
V_195 ++ ;
if ( ! V_196 )
return;
F_2 ( L_63
L_64 ,
V_6 , V_161 , V_186 , V_189 , V_166 , V_190 , V_191 , V_162 ,
V_167 , V_192 ) ;
switch ( V_165 -> V_165 ) {
case V_197 :
V_193 = F_57 ( V_161 ) ;
...
L_75
L_76 ,
V_166 , V_191 , V_191 , V_167 , V_192 , V_194 , V_167 ) ;
free ( V_194 ) ;
break;
case V_200 : {
V_194 = F_57 ( V_162 ) ;
...
L_92
L_93 ,
V_167 , V_194 , V_194 , V_167 ) ;
free ( V_194 ) ;
break;
}
fprintf ( V_3 , L_58 ) ;
}
static void F_61 ( const char * V_6 , struct V_31 * V_32 ,
T_9 * V_183 , T_5 * V_70 , const char * V_161 )
{
const char * V_162 ;
const struct V_160 * V_165 ;
V_162 = F_18 ( V_32 , F_37 ( V_32 , V_70 ) ) ;
V_165 = F_50 ( V_161 , V_162 ) ;
if ( V_165 ) {
T_5 * V_191 ;
T_5 * V_189 ;
const char * V_167 ;
const char * V_166 ;
V_189 = F_55 ( V_32 , V_183 -> V_206 , V_161 ) ;
V_166 = F_46 ( V_32 , V_189 ) ;
V_191 = F_52 ( V_32 , V_183 -> V_207 , V_70 ) ;
V_167 = F_46 ( V_32 , V_191 ) ;
if ( ! strncmp ( V_166 , L_94 ,
sizeof( L_94 ) - 1 ) )
return;
if ( F_51 ( V_165 ,
V_161 , V_166 , V_162 , V_167 ) ) {
F_60 ( V_6 , V_165 ,
V_161 , V_183 -> V_206 , V_166 ,
F_58 ( V_189 ) , V_162 , V_167 ,
F_58 ( V_191 ) ) ;
}
}
}
static unsigned int * F_62 ( struct V_31 * V_32 ,
T_4 * V_154 , T_9 * V_183 )
{
T_4 * V_69 = V_32 -> V_69 ;
int V_208 = V_154 -> V_109 ;
return ( void * ) V_32 -> V_68 + V_69 [ V_208 ] . V_108 +
V_183 -> V_206 ;
}
static int F_63 ( struct V_31 * V_32 , T_4 * V_154 , T_9 * V_183 )
{
unsigned int V_209 = F_64 ( V_183 -> V_210 ) ;
unsigned int * V_211 = F_62 ( V_32 , V_154 , V_183 ) ;
switch ( V_209 ) {
case V_212 :
V_183 -> V_207 = F_32 ( * V_211 ) ;
break;
case V_213 :
V_183 -> V_207 = F_32 ( * V_211 ) + 4 ;
if ( V_32 -> V_68 -> V_85 == V_214 )
V_183 -> V_207 += V_183 -> V_206 ;
break;
}
return 0 ;
}
static int F_65 ( struct V_31 * V_32 , T_4 * V_154 , T_9 * V_183 )
{
unsigned int V_209 = F_64 ( V_183 -> V_210 ) ;
switch ( V_209 ) {
case V_215 :
V_183 -> V_207 = ( int ) ( long )
( V_32 -> V_118 + F_66 ( V_183 -> V_210 ) ) ;
break;
case V_216 :
case V_217 :
case V_218 :
...
case V_220 :
case V_221 :
V_183 -> V_207 = ( int ) ( long ) ( V_32 -> V_68 +
V_154 -> V_108 +
( V_183 -> V_206 - V_154 -> V_107 ) ) ;
break;
default:
return 1 ;
}
...
static int F_67 ( struct V_31 * V_32 , T_4 * V_154 , T_9 * V_183 )
{
unsigned int V_209 = F_64 ( V_183 -> V_210 ) ;
unsigned int * V_211 = F_62 ( V_32 , V_154 , V_183 ) ;
unsigned int V_222 ;
...
switch ( V_209 ) {
case V_224 :
V_183 -> V_207 = V_222 & 0xffff ;
break;
case V_225 :
V_183 -> V_207 = ( V_222 & 0x03ffffff ) << 2 ;
break;
case V_226 :
V_183 -> V_207 = V_222 ;
break;
...
unsigned int V_228 ;
const char * V_161 ;
T_9 * V_229 = ( void * ) V_32 -> V_68 + V_154 -> V_108 ;
T_9 * V_230 = ( void * ) V_229 + V_154 -> V_100 ;
V_161 = F_47 ( V_32 , V_154 ) ;
V_161 += strlen ( L_95 ) ;
if ( F_48 ( V_161 , V_159 ) )
return;
for ( V_227 = V_229 ; V_227 < V_230 ; V_227 ++ ) {
V_183 . V_206 = F_32 ( V_227 -> V_206 ) ;
#if V_231 == V_232
if ( V_32 -> V_68 -> V_86 == V_233 ) {
unsigned int V_209 ;
V_228 = F_69 ( V_227 -> V_210 ) ;
V_228 = F_32 ( V_228 ) ;
V_209 = F_70 ( V_227 -> V_210 ) ;
V_183 . V_210 = F_71 ( V_228 , V_209 ) ;
} else {
V_183 . V_210 = F_32 ( V_227 -> V_210 ) ;
V_228 = F_66 ( V_183 . V_210 ) ;
}
#else
V_183 . V_210 = F_32 ( V_227 -> V_210 ) ;
V_228 = F_66 ( V_183 . V_210 ) ;
#endif
V_183 . V_207 = F_32 ( V_227 -> V_207 ) ;
V_70 = V_32 -> V_118 + V_228 ;
if ( F_56 ( V_70 -> V_124 ) )
continue;
F_61 ( V_6 , V_32 , & V_183 , V_70 , V_161 ) ;
}
}
static void F_72 ( const char * V_6 , struct V_31 * V_32 ,
T_4 * V_154 )
{
T_5 * V_70 ;
T_10 * V_234 ;
...
unsigned int V_228 ;
const char * V_161 ;
T_10 * V_229 = ( void * ) V_32 -> V_68 + V_154 -> V_108 ;
T_10 * V_230 = ( void * ) V_229 + V_154 -> V_100 ;
V_161 = F_47 ( V_32 , V_154 ) ;
V_161 += strlen ( L_96 ) ;
if ( F_48 ( V_161 , V_159 ) )
return;
for ( V_234 = V_229 ; V_234 < V_230 ; V_234 ++ ) {
V_183 . V_206 = F_32 ( V_234 -> V_206 ) ;
#if V_231 == V_232
if ( V_32 -> V_68 -> V_86 == V_233 ) {
unsigned int V_209 ;
V_228 = F_69 ( V_234 -> V_210 ) ;
V_228 = F_32 ( V_228 ) ;
V_209 = F_70 ( V_234 -> V_210 ) ;
V_183 . V_210 = F_71 ( V_228 , V_209 ) ;
} else {
V_183 . V_210 = F_32 ( V_234 -> V_210 ) ;
V_228 = F_66 ( V_183 . V_210 ) ;
}
#else
V_183 . V_210 = F_32 ( V_234 -> V_210 ) ;
...
case V_235 :
if ( F_63 ( V_32 , V_154 , & V_183 ) )
continue;
break;
case V_236 :
if ( F_65 ( V_32 , V_154 , & V_183 ) )
continue;
break;
case V_233 :
if ( F_67 ( V_32 , V_154 , & V_183 ) )
continue;
break;
}
V_70 = V_32 -> V_118 + V_228 ;
...
static void F_73 ( struct V_10 * V_11 , const char * V_6 ,
struct V_31 * V_32 )
{
int V_19 ;
T_4 * V_69 = V_32 -> V_69 ;
for ( V_19 = 0 ; V_19 < V_32 -> V_99 ; V_19 ++ ) {
F_49 ( V_6 , V_32 , & V_32 -> V_69 [ V_19 ] ) ;
if ( V_69 [ V_19 ] . V_105 == V_237 )
F_68 ( V_6 , V_32 , & V_32 -> V_69 [ V_19 ] ) ;
else if ( V_69 [ V_19 ] . V_105 == V_238 )
F_72 ( V_6 , V_32 , & V_32 -> V_69 [ V_19 ] ) ;
}
}
static char * F_74 ( char * V_22 )
{
T_2 V_239 = strcspn ( V_22 , L_97 ) ;
if ( V_239 && V_22 [ V_239 ] ) {
T_2 V_240 = strspn ( V_22 + V_239 + 1 , L_98 ) ;
if ( V_240 && ( V_22 [ V_239 + V_240 ] == '.' || V_22 [ V_239 + V_240 ] == 0 ) )
V_22 [ V_239 ] = 0 ;
}
return V_22 ;
}
...
V_242 = F_44 ( V_67 . V_114 , V_67 . V_115 , L_99 ) ;
if ( V_67 . V_114 && ! V_242 && ! F_5 ( V_6 ) )
F_2 ( L_100
L_101
L_102 , V_6 ) ;
while ( V_242 ) {
...
V_242 = F_43 ( V_67 . V_114 , V_67 . V_115 ,
L_99 , V_242 ) ;
}
for ( V_70 = V_67 . V_118 ; V_70 < V_67 . V_119 ; V_70 ++ ) {
V_127 = F_74 ( V_67 . V_120 + V_70 -> V_125 ) ;
...
( F_5 ( V_6 ) && V_244 ) )
F_73 ( V_11 , V_6 , & V_67 ) ;
V_241 = F_44 ( V_67 . V_114 , V_67 . V_115 , L_103 ) ;
if ( V_241 )
F_78 ( V_6 , V_241 , V_67 . V_114 ,
V_241 - ( char * ) V_67 . V_68 ) ;
if ( V_241 || ( V_245 && ! F_5 ( V_6 ) ) )
F_79 ( V_6 , V_11 -> V_246 ,
sizeof( V_11 -> V_246 ) - 1 ) ;
F_33 ( & V_67 ) ;
if ( V_247 )
V_11 -> V_141 = F_12 ( L_104 , 0 , V_11 -> V_141 ) ;
}
static void F_80 ( const char * V_50 )
{
T_11 * V_248 = V_249 ;
char V_250 [ V_251 ] ;
if ( strcmp ( V_50 , L_105 ) != 0 ) {
V_248 = fopen ( V_50 , L_106 ) ;
if ( ! V_248 )
F_1 ( L_107 , V_50 ) ;
}
while ( fgets ( V_250 , V_251 , V_248 ) != NULL ) {
if ( F_4 ( V_250 , L_58 ) )
V_250 [ strlen ( V_250 ) - 1 ] = '\0' ;
F_75 ( V_250 ) ;
}
if ( V_248 != V_249 )
fclose ( V_248 ) ;
}
void F_81 ( struct V_252 * V_253 , const char * V_22 , int V_66 )
{
if ( V_253 -> V_51 - V_253 -> V_63 < V_66 ) {
V_253 -> V_51 += V_66 + V_254 ;
V_253 -> V_15 = realloc ( V_253 -> V_15 , V_253 -> V_51 ) ;
}
strncpy ( V_253 -> V_15 + V_253 -> V_63 , V_22 , V_66 ) ;
V_253 -> V_63 += V_66 ;
}
static void F_82 ( enum V_23 exp , const char * V_240 , const char * V_22 )
{
const char * V_255 = F_5 ( V_240 ) ? L_15 : L_16 ;
switch ( exp ) {
case V_37 :
F_1 ( L_108
L_109 , V_240 , V_255 , V_22 ) ;
break;
case V_38 :
F_1 ( L_108
L_110 , V_240 , V_255 , V_22 ) ;
break;
case V_39 :
F_2 ( L_108
L_111 , V_240 , V_255 , V_22 ) ;
break;
case V_35 :
case V_36 :
case V_30 :
...
static void F_83 ( enum V_23 exp , const char * V_240 , const char * V_22 )
{
const char * V_255 = F_5 ( V_240 ) ? L_15 : L_16 ;
switch ( exp ) {
case V_36 :
...
continue;
V_256 = strrchr ( V_11 -> V_14 , '/' ) ;
if ( V_256 )
V_256 ++ ;
else
V_256 = V_11 -> V_14 ;
if ( ! V_11 -> V_17 )
F_82 ( exp -> V_23 , V_256 , exp -> V_14 ) ;
F_83 ( exp -> V_23 , V_256 , exp -> V_14 ) ;
}
}
static void F_85 ( struct V_252 * V_257 , struct V_10 * V_11 )
{
F_86 ( V_257 , L_114 ) ;
F_86 ( V_257 , L_115 ) ;
F_86 ( V_257 , L_116 ) ;
...
static void F_87 ( struct V_252 * V_257 , int V_258 )
{
if ( V_258 )
F_86 ( V_257 , L_127 ) ;
}
static void F_88 ( struct V_252 * V_257 , const char * V_14 )
{
static const char * V_259 = L_128 ;
if ( strncmp ( V_259 , V_14 , strlen ( V_259 ) ) == 0 )
F_86 ( V_257 , L_129 ) ;
}
static int F_89 ( struct V_252 * V_257 , struct V_10 * V_11 )
{
struct V_20 * V_22 , * exp ;
int V_260 = 0 ;
for ( V_22 = V_11 -> V_141 ; V_22 ; V_22 = V_22 -> V_13 ) {
...
static void F_90 ( struct V_252 * V_257 , struct V_10 * V_11 ,
struct V_10 * V_12 )
{
struct V_20 * V_22 ;
struct V_10 * V_240 ;
int V_262 = 1 ;
for ( V_240 = V_12 ; V_240 ; V_240 = V_240 -> V_13 )
V_240 -> V_263 = F_5 ( V_240 -> V_14 ) ;
F_86 ( V_257 , L_58 ) ;
F_86 ( V_257 , L_136 ) ;
F_86 ( V_257 , L_132 ) ;
F_86 ( V_257 , L_137 ) ;
...
V_15 = V_22 -> V_10 -> V_14 ;
F_86 ( V_257 , L_139 , V_262 ? L_15 : L_140 , V_15 ) ;
V_262 = 0 ;
}
F_86 ( V_257 , L_141 ) ;
}
static void F_91 ( struct V_252 * V_257 , struct V_10 * V_11 )
{
if ( V_11 -> V_246 [ 0 ] ) {
F_86 ( V_257 , L_58 ) ;
F_86 ( V_257 , L_142 ,
...
static void F_92 ( struct V_252 * V_257 , const char * V_250 )
{
char * V_264 ;
T_11 * V_64 ;
struct V_52 V_53 ;
V_64 = fopen ( V_250 , L_106 ) ;
if ( ! V_64 )
goto V_265;
if ( F_25 ( fileno ( V_64 ) , & V_53 ) < 0 )
goto V_266;
if ( V_53 . V_59 != V_257 -> V_63 )
goto V_266;
V_264 = F_9 ( malloc ( V_257 -> V_63 ) ) ;
if ( fread ( V_264 , 1 , V_257 -> V_63 , V_64 ) != V_257 -> V_63 )
goto V_267;
if ( memcmp ( V_264 , V_257 -> V_15 , V_257 -> V_63 ) != 0 )
goto V_267;
free ( V_264 ) ;
fclose ( V_64 ) ;
return;
...
fclose ( V_64 ) ;
V_265:
V_64 = fopen ( V_250 , L_143 ) ;
if ( ! V_64 ) {
perror ( V_250 ) ;
exit ( 1 ) ;
}
if ( fwrite ( V_257 -> V_15 , 1 , V_257 -> V_63 , V_64 ) != V_257 -> V_63 ) {
perror ( V_250 ) ;
exit ( 1 ) ;
}
fclose ( V_64 ) ;
}
static void F_93 ( const char * V_250 , unsigned int V_47 )
{
unsigned long V_51 , V_63 = 0 ;
void * V_64 = F_23 ( V_250 , & V_51 ) ;
char * line ;
if ( ! V_64 )
return;
while ( ( line = F_28 ( & V_63 , V_64 , V_51 ) ) ) {
char * V_127 , * V_6 , * V_179 , * V_23 , * V_268 ;
unsigned int V_48 ;
struct V_10 * V_11 ;
struct V_20 * V_22 ;
...
* V_23 ++ = '\0' ;
if ( V_23 && ( ( V_268 = strchr ( V_23 , '\t' ) ) != NULL ) )
* V_268 = '\0' ;
V_48 = strtoul ( line , & V_179 , 16 ) ;
if ( * V_127 == '\0' || * V_6 == '\0' || * V_179 != '\0' )
goto V_269;
V_11 = F_7 ( V_6 ) ;
if ( ! V_11 ) {
if ( F_5 ( V_6 ) )
...
static void F_95 ( const char * V_250 )
{
struct V_252 V_253 = { } ;
struct V_20 * V_20 ;
int V_239 ;
for ( V_239 = 0 ; V_239 < V_26 ; V_239 ++ ) {
V_20 = V_27 [ V_239 ] ;
while ( V_20 ) {
if ( F_94 ( V_20 ) )
F_86 ( & V_253 , L_145 ,
...
int main ( int V_271 , char * * V_272 )
{
struct V_10 * V_11 ;
struct V_252 V_253 = { } ;
char * V_273 = NULL , * V_274 = NULL ;
char * V_275 = NULL , * V_276 = NULL ;
int V_277 ;
int V_260 ;
struct V_278 * V_279 ;
struct V_278 * V_280 = NULL ;
while ( ( V_277 = F_96 ( V_271 , V_272 , L_146 ) ) != - 1 ) {
switch ( V_277 ) {
case 'i' :
V_273 = V_281 ;
break;
...
F_85 ( & V_253 , V_11 ) ;
F_87 ( & V_253 , ! V_270 ) ;
F_88 ( & V_253 , V_11 -> V_14 ) ;
V_260 |= F_89 ( & V_253 , V_11 ) ;
F_90 ( & V_253 , V_11 , V_12 ) ;
F_97 ( & V_253 , V_11 ) ;
F_91 ( & V_253 , V_11 ) ;
sprintf ( V_250 , L_147 , V_11 -> V_14 ) ;
F_92 ( & V_253 , V_250 ) ;
}
if ( V_275 )
F_95 ( V_275 ) ;
