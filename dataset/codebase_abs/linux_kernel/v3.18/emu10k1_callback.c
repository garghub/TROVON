...
V_78 = ( V_6 -> V_121 . V_79 << 1 ) | V_122 ;
F_5 ( V_6 , V_123 , V_16 , V_78 ) ;
F_5 ( V_6 , V_124 , V_16 , V_78 ) ;
#if 0
{
...
#endif
V_79 = V_9 -> V_23 . V_84 ;
V_78 = V_9 -> V_23 . V_24 . V_125 ;
V_78 = ( V_78 << 28 ) | V_79 ;
if ( V_9 -> V_43 < 0xe400 )
V_78 |= V_126 ;
else {
unsigned int V_127 = ( V_9 -> V_43 - 0xe000 ) >> 10 ;
V_78 |= V_127 << 25 ;
}
if ( V_9 -> V_23 . V_68 & V_128 )
V_78 |= V_129 ;
F_5 ( V_6 , V_130 , V_16 , V_78 ) ;
V_78 = ( unsigned int ) V_9 -> V_131 << 16 ;
F_5 ( V_6 , V_35 , V_16 , V_78 | V_9 -> V_132 ) ;
...
F_21 ( struct V_8 * V_9 )
{
unsigned int V_78 , V_133 ;
struct V_5 * V_6 ;
struct V_31 * V_32 ;
V_6 = V_9 -> V_6 ;
V_32 = (struct V_31 * ) V_9 -> V_30 ;
if ( ! V_32 || V_32 -> V_134 < 0 )
return;
#if 0
...
V_133 = F_22 ( V_9 -> V_43 ) ;
#endif
V_78 = V_133 | ( V_9 -> V_46 << 8 ) | V_9 -> V_48 ;
F_5 ( V_6 , V_94 , V_9 -> V_16 , V_78 ) ;
F_5 ( V_6 , V_95 , V_9 -> V_16 , V_133 ) ;
F_5 ( V_6 , V_29 , V_9 -> V_16 , V_9 -> V_23 . V_24 . V_135 | V_28 ) ;
}
static void
...
unsigned char V_138 ;
int V_139 ;
V_137 = ( char ) ( V_9 -> V_23 . V_24 . V_136 >> 8 ) ;
V_138 = ( V_9 -> V_23 . V_24 . V_136 & 0xff ) ;
V_139 = V_9 -> V_82 -> V_140 + V_9 -> V_82 -> V_141 ;
V_137 += ( V_142 * V_139 ) / 1200 ;
F_23 ( V_137 , - 128 , 127 ) ;
V_136 = ( ( unsigned char ) V_137 << 8 ) | V_138 ;
F_5 ( V_6 , V_143 , V_9 -> V_16 , V_136 ) ;
}
static void
...
unsigned char V_145 ;
int V_139 ;
V_137 = ( char ) ( V_9 -> V_23 . V_24 . V_144 >> 8 ) ;
V_145 = V_9 -> V_23 . V_24 . V_144 & 0xff ;
V_139 = V_9 -> V_82 -> V_140 + V_9 -> V_82 -> V_141 ;
V_137 += ( V_142 * V_139 ) / 1200 ;
F_23 ( V_137 , - 128 , 127 ) ;
V_144 = ( ( unsigned char ) V_137 << 8 ) | V_145 ;
F_5 ( V_6 , V_146 , V_9 -> V_16 , V_144 ) ;
}
static void
F_13 ( struct V_5 * V_6 , struct V_8 * V_9 )
{
unsigned int V_58 ;
V_58 = F_14 ( V_6 , V_130 , V_9 -> V_16 ) & ~ V_147 ;
V_58 |= ( V_9 -> V_23 . V_24 . V_125 << 28 ) ;
F_5 ( V_6 , V_130 , V_9 -> V_16 , V_58 ) ;
}
