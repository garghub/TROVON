...
struct V_114 * V_116 =
(struct V_114 * ) V_55 ;
F_42 ( V_50 -> V_33 -> V_33 , L_11 ,
V_116 -> V_46 , V_116 -> V_45 , V_116 -> V_2 ) ;
if ( V_116 -> V_2 == V_117 )
V_50 -> V_17 = V_118 ;
V_50 -> V_2 = 0 ;
}
...
struct V_114 * V_116 =
(struct V_114 * ) V_55 ;
F_42 ( V_50 -> V_33 -> V_33 , L_12 ,
V_116 -> V_46 , V_116 -> V_45 ,
F_3 ( V_116 -> V_2 ) ) ;
if ( V_116 -> V_2 == V_24 )
V_50 -> V_17 = V_120 ;
else
...
int F_56 ( struct V_32 * V_33 , struct V_42 * V_43 )
{
struct V_135 * V_136 ;
struct V_137 * V_138 ;
struct V_80 * V_139 ;
...
struct V_112 * V_129 ;
struct V_106 * V_111 ;
F_57 ( V_43 -> V_44 >= sizeof( V_33 -> V_143 ) ) ;
F_58 ( V_33 , V_33 -> V_143 , V_43 -> V_44 ) ;
