...
{
struct V_139 * V_140 ;
V_140 = F_95 ( V_130 , & V_147 , sizeof( * V_140 ) ) ;
if ( ! V_140 )
return - V_59 ;
V_140 -> V_20 = ( unsigned long ) F_87 ( V_129 ) ;
return 0 ;
}
static void * F_96 ( struct V_123 * V_124 , T_7 * V_125 )
{
return F_89 ( V_124 , V_125 , true ) ;
}
static void * F_97 ( struct V_123 * V_124 , void * V_128 , T_7 * V_133 )
{
return F_88 ( V_124 , V_128 , V_133 , true ) ;
}
static int F_98 ( struct V_123 * V_124 , void * V_128 )
{
const struct V_139 * V_140 = V_124 -> V_108 ;
...
static int F_99 ( struct V_129 * V_129 , struct V_130 * V_130 )
{
struct V_139 * V_140 ;
V_140 = F_95 ( V_130 , & V_148 , sizeof( * V_140 ) ) ;
if ( ! V_140 )
return - V_59 ;
V_140 -> V_20 = ( unsigned long ) F_87 ( V_129 ) ;
return 0 ;
}
struct V_149 * F_100 ( const struct V_101 * V_45 , T_8 * V_150 )
{
unsigned int V_47 = V_45 -> V_151 ;
T_3 V_9 , V_152 = F_101 ( V_47 ) ;
T_3 V_153 ;
struct V_149 * V_154 ;
int V_42 ;
V_154 = F_102 ( sizeof( * V_154 ) * V_152 , V_95 ) ;
if ( V_154 == NULL )
return F_16 ( - V_59 ) ;
...
V_5 = F_102 ( sizeof( struct V_54 ) * V_171 , V_95 ) ;
if ( ! V_5 )
return - V_59 ;
for ( V_9 = 0 ; V_9 < V_171 ; V_9 ++ ) {
F_118 ( & V_5 [ V_9 ] . V_6 ) ;
