...
if ( V_219 >= V_223 )
goto V_220;
V_216 = F_137 ( V_214 , sizeof( * V_216 ) , V_170 ) ;
if ( V_216 == NULL )
goto V_220;
...
static int F_139 ( struct V_213 * V_214 , struct V_215 * V_216 ,
struct V_1 * V_2 )
{
...
F_140 ( F_141 ( V_28 -> V_228 ) , & V_214 -> V_229 ) ;
F_9 ( V_28 , V_11 ) ;
return V_201 ;
}
int F_142 ( struct V_213 * V_214 , struct V_187 * V_188 )
{
struct V_217 * V_218 = F_133 ( V_214 ) ;
struct V_215 * V_216 ;
...
continue;
( void ) F_139 ( V_214 , V_216 , V_2 ) ;
* V_230 = V_216 -> V_184 ;
F_114 ( V_2 , V_129 ) ;
F_138 () ;
F_140 ( sizeof( * V_216 ) , & V_214 -> V_229 ) ;
F_9 ( V_216 , V_11 ) ;
return 0 ;
}
V_183:
...
int F_143 ( int V_233 , int V_234 , struct V_213 * V_214 , struct
...
if ( V_237 )
V_219 += V_237 -> V_228 ;
V_242 = F_137 ( V_214 , F_141 ( V_219 ) , V_170 ) ;
if ( ! V_242 ) {
V_201 = - V_205 ;
goto V_220;
}
...
F_140 ( F_141 ( V_237 -> V_228 ) , & V_214 -> V_229 ) ;
F_9 ( V_237 , V_11 ) ;
}
...
F_138 () ;
if ( V_238 )
return F_142 ( V_214 , & V_188 ) ;
return V_201 ;
}
int F_144 ( struct V_213 * V_214 , struct V_244 * V_245 , int V_72 )
{
int V_201 = 0 ;
struct V_187 V_188 ;
...
if ( V_245 -> V_249 ) {
V_242 = F_137 ( V_214 , F_141 ( V_245 -> V_249 ) ,
V_170 ) ;
if ( ! V_242 ) {
V_201 = - V_205 ;
goto V_220;
...
if ( V_201 ) {
F_145 ( V_214 , V_242 , F_141 ( V_242 -> V_228 ) ) ;
goto V_220;
}
} else {
V_242 = NULL ;
...
F_138 () ;
if ( V_238 )
V_201 = F_142 ( V_214 , & V_188 ) ;
return V_201 ;
}
int F_146 ( struct V_213 * V_214 , struct V_244 * V_245 ,
...
{
struct V_291 * V_292 ;
V_292 = F_186 ( L_18 , V_293 , V_59 -> V_294 , & V_295 ) ;
if ( ! V_292 )
goto V_296;
V_292 = F_186 ( L_19 , V_293 , V_59 -> V_294 ,
& V_297 ) ;
if ( ! V_292 )
goto V_298;
return 0 ;
V_298:
F_187 ( L_18 , V_59 -> V_294 ) ;
V_296:
return - V_299 ;
}
static void T_8 F_188 ( struct V_59 * V_59 )
{
F_187 ( L_19 , V_59 -> V_294 ) ;
F_187 ( L_18 , V_59 -> V_294 ) ;
}
static int F_189 ( struct V_300 * V_301 ,
unsigned long V_302 , void * V_303 )
{
struct V_49 * V_50 = F_190 ( V_303 ) ;
struct V_1 * V_2 ;
switch ( V_302 ) {
case V_304 :
V_2 = F_125 ( V_50 ) ;
