...
int V_154 = V_1 -> V_153 . V_154 ;
int V_155 = V_1 -> V_153 . V_155 ;
T_2 V_88 , V_156 = 0 ;
F_57 ( V_18 -> V_87 , V_155 , V_154 ,
0x21 ) ;
...
F_6 ( V_1 , 0x1100 , & V_18 -> V_87 [ V_89 ] , 64 ) ;
F_6 ( V_1 , 0x1140 , & V_18 -> V_87 [ V_90 ] , 64 ) ;
F_6 ( V_1 , 0x10fb , F_59 ( V_154 , V_155 ) , 5 ) ;
F_6 ( V_1 , 0x1180 , F_60 ( V_142 , V_18 -> V_29 , V_18 -> V_30 ) , 6 ) ;
F_8 ( V_1 , 0x1189 , V_156 ) ;
F_8 ( V_1 , 0x10e0 , V_88 ) ;
...
static void F_67 ( struct V_1 * V_1 , T_1 V_168 )
{
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
T_3 V_169 = F_58 ( V_18 -> V_125 ) ;
T_3 V_170 = V_18 -> V_125 -> V_171 - V_18 -> V_110 ;
T_3 V_172 = V_18 -> V_125 -> V_173 + V_18 -> V_110 ;
T_5 V_174 ;
if ( V_168 < V_175 ) {
if ( V_169 > V_170 )
return;
V_174 = V_169 + V_18 -> V_110 ;
if ( V_174 > V_170 )
V_174 = V_170 ;
if ( V_174 < V_172 )
V_174 = V_172 ;
F_68 ( V_18 -> V_125 , V_174 ) ;
...
static void F_69 ( struct V_1 * V_1 , T_1 V_168 )
{
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
T_3 V_177 = F_58 ( V_18 -> V_81 ) ;
if ( V_168 < V_175 && V_177 < V_18 -> V_81 -> V_171 )
F_68 ( V_18 -> V_81 , V_177 + 1 ) ;
if ( V_168 > V_176 && V_177 > V_18 -> V_81 -> V_173 )
F_68 ( V_18 -> V_81 , V_177 - 1 ) ;
}
...
return;
V_168 = F_71 ( & V_18 -> V_168 ) ;
if ( V_18 -> V_36 == V_82 )
F_69 ( V_1 , V_168 ) ;
else
F_67 ( V_1 , V_168 ) ;
}
static void V_112 ( struct V_178 * V_111 )
{
struct V_18 * V_18 = F_45 ( V_111 , struct V_18 , V_111 ) ;
struct V_1 * V_1 = & V_18 -> V_1 ;
T_3 V_179 = F_58 ( V_18 -> V_138 ) ;
F_66 ( & V_1 -> V_167 ) ;
F_72 ( V_180 , L_43 , V_179 ) ;
V_1 -> V_7 = 0 ;
F_36 ( V_1 , V_179 ) ;
F_64 ( & V_1 -> V_167 ) ;
}
...
{
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
if ( ! ( V_18 -> V_66 & V_183 ) && V_182 == 1 ) {
F_74 ( V_1 -> V_184 , V_185 , 1 ) ;
F_75 ( V_1 -> V_184 ) ;
F_74 ( V_1 -> V_184 , V_185 , 0 ) ;
F_75 ( V_1 -> V_184 ) ;
return 0 ;
}
return - V_95 ;
...
V_187 = ( V_18 -> V_162 * 100 ) /
( V_18 -> V_163 *
V_1 -> V_190 [ 0 ] -> V_191 [ 0 ] . V_3 ) ;
if ( V_187 >= 85 )
V_186 = - 3 ;
else if ( V_187 < 75 )
V_186 = 2 ;
...
if ( V_186 != 0 ) {
V_18 -> V_164 += V_186 ;
if ( V_18 -> V_164 < - 6 || V_18 -> V_164 >= 12 ) {
T_3 V_192 = V_18 -> V_138 -> V_193 . V_17 ;
V_18 -> V_164 = 0 ;
V_186 += V_192 ;
if ( V_186 < V_18 -> V_138 -> V_173 )
V_186 = V_18 -> V_138 -> V_173 ;
else if ( V_186 > V_18 -> V_138 -> V_171 )
V_186 = V_18 -> V_138 -> V_171 ;
if ( V_186 != V_192 ) {
V_18 -> V_138 -> V_193 . V_17 = V_186 ;
F_77 ( V_18 -> V_165 , & V_18 -> V_111 ) ;
}
}
} else {
V_18 -> V_164 = 0 ;
...
struct V_18 * V_18 = (struct V_18 * ) V_1 ;
int V_168 , V_194 ;
static const T_2 V_195 [] = {
0xff , 0xff , 0x00 , 0xc4 , 0xc4 , 0x96
} ;
V_194 = ( V_18 -> V_88 & 0x03 ) == 0 ;
if ( V_182 >= 64 && memcmp ( V_181 , V_195 , 6 ) == 0 ) {
V_168 = ( ( V_181 [ 35 ] >> 2 ) & 3 ) |
( V_181 [ 20 ] << 2 ) |
( V_181 [ 19 ] << 10 ) ;
V_168 += ( ( V_181 [ 35 ] >> 4 ) & 3 ) |
...
( V_181 [ 33 ] << 10 ) ;
V_168 >>= 9 ;
F_79 ( & V_18 -> V_168 , V_168 ) ;
if ( V_194 )
F_76 ( V_1 , V_181 ) ;
F_80 ( V_1 , V_196 , NULL , 0 ) ;
V_182 -= 64 ;
if ( V_182 == 0 )
return;
V_181 += 64 ;
...
F_80 ( V_1 , V_199 , V_181 , V_182 ) ;
}
}
static int F_81 ( struct V_144 * V_145 ,
const struct V_99 * V_26 )
{
return F_82 ( V_145 , V_26 , & V_200 , sizeof( struct V_18 ) ,
V_201 ) ;
}
