...
unsigned long V_193 ;
int V_132 = 0 ;
if ( F_76 ( ! V_10 || ! V_10 -> V_205 || ! V_10 -> V_206 || ! V_7 ) )
return - V_114 ;
V_10 -> V_207 = 0 ;
V_10 -> V_203 = 0 ;
V_78 -> V_84 = 0 ;
...
V_211 = F_81 ( & V_27 -> V_128 , struct V_8 , V_128 ) ;
...
static int F_82 ( struct V_6 * V_7 , int V_213 )
{
struct V_5 * V_27 = F_3 ( V_7 ) ;
struct V_1 * V_11 = V_27 -> V_11 ;
unsigned long V_193 ;
...
V_215 . V_220 = V_221 ;
V_215 . V_222 = F_89 ( V_11 -> V_58 ) ;
V_215 . V_223 = 0 ;
V_215 . V_224 = 0 ;
V_132 = F_85 ( V_11 , & V_215 ) ;
if ( V_132 < 0 ) {
F_90 ( V_11 -> V_119 ,
L_5 ,
V_11 -> V_58 ) ;
...
V_215 . V_220 = V_226 ;
V_215 . V_222 = F_89 ( V_11 -> V_74 ) ;
V_215 . V_223 = F_89 ( V_11 -> V_72 ) ;
V_215 . V_224 = 0 ;
V_132 = F_85 ( V_11 , & V_215 ) ;
if ( V_132 < 0 ) {
F_90 ( V_11 -> V_119 ,
...
if ( V_10 -> V_205 ) {
F_86 ( & V_11 -> V_197 ) ;
V_10 -> V_205 ( & V_11 -> V_27 [ 0 ] . V_7 , V_10 ) ;
F_87 ( & V_11 -> V_197 ) ;
}
}
...
static enum V_230 F_97 ( struct V_1 * V_11 )
{
int V_132 ;
...
static void F_100 ( struct V_249 * V_250 )
{
...
static void F_111 ( struct V_1 * V_11 , bool V_269 )
{
int V_37 ;
...
static T_3 F_113 ( int V_270 , void * V_271 )
{
...
static T_3 F_116 ( int V_270 , void * V_271 )
{
...
V_278 = true ;
F_77 ( & V_11 -> V_209 ) ;
V_10 -> V_207 = F_117 ( V_10 -> V_207 , V_10 -> V_83 ) ;
} else {
F_28 ( V_11 , V_66 , V_78 ) ;
}
}
...
static int F_123 ( struct V_291 * V_291 , struct V_292 * V_292 )
{
return F_124 ( V_292 , F_118 , V_291 -> V_293 ) ;
}
static int F_125 ( struct V_291 * V_291 , struct V_292 * V_292 )
{
return F_124 ( V_292 , F_120 , V_291 -> V_293 ) ;
}
...
if ( ! F_127 ( V_297 ) )
return;
V_295 = F_128 ( V_11 -> V_4 . V_164 , NULL ) ;
if ( F_57 ( V_295 ) || ! V_295 )
goto V_298;
V_296 = F_129 ( L_4 , 0400 , V_295 , V_11 ,
& V_299 ) ;
if ( ! V_296 )
goto V_300;
V_66 = F_129 ( L_44 , 0400 , V_295 , V_11 ,
& V_301 ) ;
if ( ! V_66 )
goto V_302;
V_11 -> V_303 = V_295 ;
...
static int F_132 ( struct V_306 * V_307 )
{
struct V_308 * V_119 = & V_307 -> V_119 ;
struct V_309 * V_147 = F_133 ( V_119 ) ;
struct V_1 * V_11 ;
struct V_310 * V_311 ;
...
V_311 = F_135 ( V_307 , V_312 , 0 ) ;
V_11 -> V_13 = F_136 ( V_119 , V_311 ) ;
if ( F_57 ( V_11 -> V_13 ) )
return F_137 ( V_11 -> V_13 ) ;
V_311 = F_135 ( V_307 , V_312 , 1 ) ;
V_11 -> V_15 = F_136 ( V_119 , V_311 ) ;
if ( F_57 ( V_11 -> V_15 ) )
return F_137 ( V_11 -> V_15 ) ;
F_138 ( & V_11 -> V_197 ) ;
F_139 ( & V_11 -> V_209 , F_100 ) ;
...
if ( F_142 ( V_119 , V_270 , & F_113 , 0 ,
F_140 ( V_119 ) , V_11 ) < 0 ) {
F_34 ( V_119 , L_49 , V_270 ) ;
goto V_316;
}
for ( V_37 = 0 ; V_37 < V_40 ; V_37 ++ ) {
V_270 = F_141 ( V_307 , V_37 + 1 ) ;
if ( V_270 < 0 ) {
F_34 ( V_119 , L_50 , V_37 + 1 ) ;
goto V_316;
}
if ( F_142 ( V_119 , V_270 , & F_116 , 0 ,
...
static int F_144 ( struct V_306 * V_307 )
{
struct V_1 * V_11 = F_145 ( V_307 ) ;
F_131 ( V_11 ) ;
F_146 ( & V_11 -> V_4 ) ;
F_62 ( V_11 -> V_195 ) ;
F_50 ( V_11 ) ;
