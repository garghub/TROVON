...
F_161 ( ( int ) V_346 -> V_441 ,
( int ) sizeof( struct V_393 ) ) ) ) {
V_21 = - V_442 ;
goto V_37;
}
V_21 = F_107 ( NULL , V_206 -> V_443 , & V_438 ,
F_162 ( - V_444 ) ,
0 ) ;
if ( V_21 != 0 )
goto V_37;
if ( F_159 ( V_346 -> V_445 , & V_438 ,
F_161 ( ( int ) V_346 -> V_446 ,
( int ) sizeof( V_438 ) ) ) ) {
V_21 = - V_442 ;
goto V_37;
}
...
F_163 ( V_449 , V_385 ) ;
V_449 -> V_450 = V_451 ;
V_449 -> V_393 = V_206 -> V_20 . V_17 . V_394 ;
}
F_140 ( V_385 ) ;
goto V_37;
}
...
int F_166 ( struct V_1 * exp ,
T_5 V_268 , void * V_270 ,
int V_269 , void * V_455 )
{
struct V_22 * V_23 = F_20 ( exp ) ;
struct V_2 * V_3 ;
char * V_95 ;
...
F_32 ( & V_3 -> V_11 , & V_458 ,
V_73 , sizeof( T_2 ) ) ;
V_21 = F_30 ( V_3 , V_32 , V_459 ) ;
if ( V_21 ) {
F_31 ( V_3 ) ;
return V_21 ;
}
V_95 = F_34 ( & V_3 -> V_11 , & V_457 ) ;
...
V_21 = F_9 ( V_3 ) ;
if ( V_21 == 0 || V_21 == - V_83 ) {
V_95 = F_2 ( & V_3 -> V_11 , & V_460 ) ;
memcpy ( V_455 , V_95 , V_269 ) ;
if ( F_167 ( V_3 ) ) {
if ( F_168 ( V_275 ) )
F_169 ( V_455 ) ;
}
...
static void F_170 ( struct V_461 * V_462 )
{
F_171 ( & V_462 -> V_463 ) ;
F_171 ( & V_462 -> V_464 ) ;
F_172 ( & V_462 -> V_465 ) ;
F_172 ( & V_462 -> V_466 ) ;
F_173 ( & V_462 -> V_467 ) ;
F_173 ( & V_462 -> V_468 . V_469 ) ;
F_173 ( & V_462 -> V_468 . V_470 ) ;
F_173 ( & V_462 -> V_471 ) ;
}
static void F_174 ( struct V_472 * V_462 )
{
struct V_461 * V_473 ;
int V_232 ;
F_171 ( & V_462 -> V_474 ) ;
...
F_173 ( & V_462 -> V_477 ) ;
V_473 = F_175 ( V_462 ) ;
for ( V_232 = 0 ; V_232 < V_462 -> V_475 ; V_232 ++ , V_473 = F_176 ( V_473 ) )
F_170 ( V_473 ) ;
}
static void F_177 ( struct V_330 * V_478 )
{
F_178 ( & V_478 -> V_334 ) ;
F_178 ( & V_478 -> V_339 ) ;
F_178 ( & V_478 -> V_341 ) ;
...
{
struct V_22 * V_23 = F_20 ( exp ) ;
T_2 V_481 = V_480 -> V_482 ;
int V_21 = 0 ;
if ( V_480 -> V_483 != V_484 ) {
F_58 ( L_51 , V_480 -> V_483 ) ;
return - V_280 ;
}
F_5 ( V_485 , L_52 , V_480 -> V_486 , V_480 -> V_487 ,
V_480 -> V_488 , V_480 -> V_483 , V_480 -> V_489 ) ;
if ( V_480 -> V_489 & V_490 ) {
V_21 = F_121 ( V_23 ) ;
} else {
V_21 = F_119 ( V_23 , V_481 ) ;
}
return V_21 ;
}
static int F_179 ( int V_331 , void * V_455 )
{
struct V_330 * V_332 = (struct V_330 * ) V_455 ;
struct V_472 * V_491 = (struct V_472 * ) ( V_332 + 1 ) ;
int V_21 ;
if ( V_331 < sizeof( * V_332 ) + sizeof( * V_491 ) ) {
F_58 ( L_53 , V_331 ,
( int ) ( sizeof( * V_332 ) + sizeof( * V_491 ) ) ) ;
return - V_12 ;
}
...
V_332 -> V_341 , V_491 -> V_475 , V_491 -> V_492 ) ;
V_21 = F_181 ( V_484 , V_332 ) ;
return V_21 ;
}
static int F_182 ( T_2 V_346 , void * V_493 )
{
struct V_22 * V_23 = (struct V_22 * ) V_493 ;
T_2 V_481 = V_346 ;
int V_21 ;
F_5 ( V_165 , L_56 ,
V_481 ) ;
...
{
return F_184 ( V_484 , F_182 ,
( void * ) V_23 ) ;
}
int F_185 ( const struct V_249 * V_250 ,
struct V_1 * exp ,
T_5 V_268 , void * V_270 ,
T_5 V_269 , void * V_455 ,
struct V_494 * V_495 )
{
struct V_22 * V_23 = F_20 ( exp ) ;
int V_21 ;
...
F_75 ( & V_23 -> V_497 ) ;
V_21 = F_186 ( V_23 , V_502 , V_32 ,
V_268 , V_270 , V_269 , V_455 , V_495 ) ;
return V_21 ;
}
if ( F_168 ( V_503 ) ) {
F_187 ( exp -> V_122 ) ;
...
if ( F_168 ( V_505 ) ) {
V_21 = F_179 ( V_269 , V_455 ) ;
return V_21 ;
}
F_58 ( L_57 , ( char * ) V_270 ) ;
return - V_280 ;
}
int F_189 ( const struct V_249 * V_250 , struct V_1 * exp ,
T_2 V_268 , void * V_270 , T_2 * V_269 , void * V_455 ,
struct V_506 * V_139 )
{
int V_21 = - V_280 ;
if ( F_168 ( V_507 ) ) {
...
return - V_280 ;
V_508 = * ( int * ) V_455 ;
if ( V_508 > exp -> V_122 -> V_20 . V_17 . V_510 )
exp -> V_122 -> V_20 . V_17 . V_510 = V_508 ;
V_509 = V_455 ;
* V_509 = exp -> V_122 -> V_20 . V_17 . V_510 ;
return 0 ;
} else if ( F_168 ( V_511 ) ) {
int * V_512 ;
if ( * V_269 != sizeof( int ) )
return - V_280 ;
V_512 = V_455 ;
* V_512 = exp -> V_122 -> V_20 . V_17 . V_219 ;
return 0 ;
} else if ( F_168 ( V_513 ) ) {
int V_508 , * V_514 ;
if ( * V_269 != sizeof( int ) )
return - V_280 ;
V_508 = * ( int * ) V_455 ;
if ( V_508 > exp -> V_122 -> V_20 . V_17 . V_515 )
exp -> V_122 -> V_20 . V_17 . V_515 = V_508 ;
V_514 = V_455 ;
* V_514 = exp -> V_122 -> V_20 . V_17 . V_515 ;
return 0 ;
} else if ( F_168 ( V_516 ) ) {
int * V_517 ;
if ( * V_269 != sizeof( int ) )
...
V_21 = F_166 ( exp , V_268 , V_270 , * V_269 , V_455 ) ;
return V_21 ;
}
int F_190 ( struct V_1 * exp , const struct V_24 * V_86 ,
struct V_6 * V_7 , struct V_2 * * V_60 )
{
struct V_2 * V_3 ;
int V_21 ;
* V_60 = NULL ;
V_3 = F_28 ( F_20 ( exp ) , & V_521 ) ;
if ( V_3 == NULL )
return - V_34 ;
F_29 ( V_3 , & V_41 , V_7 ) ;
V_21 = F_30 ( V_3 , V_32 , V_522 ) ;
if ( V_21 ) {
F_31 ( V_3 ) ;
return V_21 ;
}
...
if ( V_17 -> V_527 != NULL )
F_192 ( V_17 -> V_527 ) ;
V_21 = F_193 ( V_206 , V_206 , V_528 , NULL ) ;
break;
}
case V_529 : {
struct V_530 * V_531 = V_206 -> V_532 ;
F_194 ( V_531 , V_533 ) ;
break;
}
case V_534 :
V_21 = F_193 ( V_206 , V_206 , V_535 , NULL ) ;
if ( V_21 == 0 )
V_21 = F_183 ( V_23 ) ;
break;
case V_536 :
V_21 = F_193 ( V_206 , V_206 , V_537 , NULL ) ;
break;
case V_538 :
case V_539 :
break;
...
{
struct V_16 * V_17 = & exp -> V_122 -> V_20 . V_17 ;
struct V_540 * V_541 = V_17 -> V_527 ;
return F_195 ( NULL , V_541 , V_86 ) ;
}
struct V_393 * F_196 ( struct V_1 * exp )
{
struct V_16 * V_17 = & exp -> V_122 -> V_20 . V_17 ;
return & V_17 -> V_394 ;
}
static int F_197 ( struct V_542 * V_543 )
{
if ( V_543 -> V_544 -> V_545 != V_546 )
return 0 ;
if ( V_543 -> V_547 . V_548 . V_549 & V_550 )
return 0 ;
return 1 ;
}
static int F_198 ( struct V_551 * V_552 )
{
if ( V_552 -> V_553 )
V_552 -> V_553 = NULL ;
return 0 ;
...
{
struct V_554 * V_555 = & V_206 -> V_556 ;
struct V_369 * V_370 ;
int V_21 ;
V_21 = F_200 ( NULL , V_206 , V_555 , V_372 , V_206 ,
& V_557 ) ;
if ( V_21 )
return V_21 ;
V_370 = F_201 ( V_555 , V_372 ) ;
F_202 ( V_370 ) ;
F_139 ( V_370 ) ;
return 0 ;
}
...
static int F_205 ( struct V_205 * V_206 , struct V_558 * V_559 )
{
struct V_16 * V_17 = & V_206 -> V_20 . V_17 ;
...
F_206 ( V_17 -> V_222 ) ;
V_21 = F_208 ( V_206 , V_559 ) ;
if ( V_21 )
goto V_563;
F_209 ( & V_561 ) ;
F_210 ( V_206 , V_561 . V_564 ) ;
F_211 ( V_206 ) ;
F_212 ( V_206 ) ;
F_213 ( V_206 -> V_532 , F_197 ) ;
V_206 -> V_532 -> V_565 = & V_566 ;
V_21 = F_199 ( V_206 ) ;
if ( V_21 ) {
F_214 ( V_206 ) ;
F_58 ( L_59 ) ;
...
static int F_216 ( struct V_1 * exp , int V_567 ,
int V_568 , int V_569 , int V_570 )
{
struct V_205 * V_206 = exp -> V_122 ;
struct V_16 * V_17 = & V_206 -> V_20 . V_17 ;
if ( V_17 -> V_510 < V_567 )
...
static int F_217 ( struct V_205 * V_206 , enum V_571 V_572 )
{
switch ( V_572 ) {
case V_573 :
break;
case V_574 :
if ( V_206 -> V_395 -> V_575 <= 1 )
F_218 ( 0 , V_484 ) ;
F_219 ( V_206 ) ;
F_220 ( V_206 ) ;
F_221 ( V_206 ) ;
...
{
struct V_558 * V_576 = V_131 ;
struct V_560 V_561 = { NULL } ;
int V_21 = 0 ;
F_209 ( & V_561 ) ;
switch ( V_576 -> V_577 ) {
default:
V_21 = F_224 ( V_578 , V_561 . V_564 ,
V_576 , V_206 ) ;
if ( V_21 > 0 )
V_21 = 0 ;
break;
...
int F_225 ( struct V_1 * exp , const struct V_24 * V_86 ,
...
if ( V_3 == NULL )
return - V_34 ;
F_13 ( V_3 , & V_7 -> V_15 . V_585 , V_7 , V_148 , 0 , - 1 , 0 ) ;
F_15 ( V_3 ) ;
F_43 ( sizeof( * V_581 ) <= sizeof( V_3 -> V_586 ) ) ;
V_581 = F_229 ( V_3 ) ;
V_581 -> V_583 = V_7 ;
V_581 -> V_582 = V_584 ;
V_3 -> V_587 = F_226 ;
...
struct V_560 V_561 = { NULL } ;
F_209 ( & V_561 ) ;
V_21 = F_232 ( & V_589 , & V_590 , V_561 . V_591 ,
V_592 , NULL ) ;
return V_21 ;
}
