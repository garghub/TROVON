...
if ( V_53 ) {
F_25 ( V_2 , ' ' ) ;
F_26 ( V_2 , & V_53 -> V_66 , L_5 ) ;
} else if ( V_4 ) {
T_1 V_67 = F_13 ( V_41 , V_6 , V_42 ) ;
if ( V_67 != 0 ) {
F_25 ( V_2 , ' ' ) ;
...
static int F_28 ( struct V_1 * V_2 , void * V_68 , int V_42 )
{
struct V_9 * V_10 = V_68 ;
return F_20 ( V_2 , F_5 ( V_10 , struct V_5 , V_17 ) ,
V_42 ) ;
}
static int F_29 ( struct V_1 * V_2 , void * V_68 )
{
return F_28 ( V_2 , V_68 , 1 ) ;
}
static int F_30 ( struct V_1 * V_2 , void * V_68 )
{
return F_28 ( V_2 , V_68 , 0 ) ;
}
static void * F_31 ( struct V_1 * V_2 , V_60 * V_69 )
{
struct V_40 * V_41 = V_2 -> V_51 ;
struct V_3 * V_4 ;
struct V_9 * V_10 ;
...
static void F_36 ( struct V_1 * V_2 , void * V_73 )
{
struct V_40 * V_41 = V_2 -> V_51 ;
if ( ! F_37 ( V_73 ) ) {
F_9 ( & V_41 -> V_4 -> V_15 ) ;
...
static void * F_39 ( struct V_1 * V_2 , void * V_68 , V_60 * V_69 )
{
struct V_9 * V_10 = V_68 ;
( * V_69 ) ++ ;
...
{
struct V_40 * V_41 ;
V_41 = F_41 ( V_53 , V_75 , sizeof( * V_41 ) ) ;
if ( ! V_41 )
return - V_76 ;
V_41 -> V_43 = V_43 ;
V_41 -> V_4 = F_42 ( V_43 , V_77 ) ;
if ( F_43 ( V_41 -> V_4 ) ) {
int V_78 = F_44 ( V_41 -> V_4 ) ;
F_45 ( V_43 , V_53 ) ;
return V_78 ;
}
return 0 ;
...
{
struct V_1 * V_79 = V_53 -> V_80 ;
struct V_40 * V_41 = V_79 -> V_51 ;
if ( V_41 -> V_4 )
F_47 ( V_41 -> V_4 ) ;
