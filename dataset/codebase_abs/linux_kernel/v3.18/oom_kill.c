...
void F_51 ( struct V_1 * V_7 , T_2 V_26 , int V_65 ,
...
F_8 ( V_7 ) ;
F_56 ( L_5 ,
V_69 , F_57 ( V_7 ) , V_7 -> V_64 , V_17 ) ;
F_10 ( V_7 ) ;
F_58 ( & V_77 ) ;
F_3 (p, t) {
F_59 (child, &t->children, sibling) {
unsigned int V_78 ;
if ( V_71 -> V_9 == V_7 -> V_9 )
continue;
...
V_9 = V_70 -> V_9 ;
F_56 ( L_6 ,
F_57 ( V_70 ) , V_70 -> V_64 , F_61 ( V_70 -> V_9 -> V_63 ) ,
F_61 ( F_17 ( V_70 -> V_9 , V_79 ) ) ,
F_61 ( F_17 ( V_70 -> V_9 , V_80 ) ) ) ;
F_10 ( V_70 ) ;
F_2 () ;
F_38 (p)
if ( V_7 -> V_9 == V_9 && ! F_62 ( V_7 , V_70 ) &&
! ( V_7 -> V_14 & V_15 ) ) {
...
F_57 ( V_7 ) , V_7 -> V_64 ) ;
F_10 ( V_7 ) ;
F_63 ( V_81 , V_82 , V_7 , true ) ;
}
F_6 () ;
F_53 ( V_70 , V_47 ) ;
F_63 ( V_81 , V_82 , V_70 , true ) ;
F_54 ( V_70 ) ;
}
void F_64 ( enum V_24 V_83 , T_2 V_26 ,
...
int F_66 ( struct V_85 * V_86 )
{
return F_67 ( & V_87 , V_86 ) ;
}
int F_68 ( struct V_85 * V_86 )
{
return F_69 ( & V_87 , V_86 ) ;
}
bool F_70 ( struct V_25 * V_25 , T_2 V_26 )
{
struct V_28 * V_29 ;
struct V_27 * V_27 ;
bool V_5 = true ;
F_71 ( & V_88 ) ;
F_72 (zone, z, zonelist, gfp_zone(gfp_mask))
if ( F_73 ( V_89 , & V_27 -> V_14 ) ) {
V_5 = false ;
goto V_90;
}
F_72 (zone, z, zonelist, gfp_zone(gfp_mask))
...
void F_76 ( struct V_25 * V_25 , T_2 V_26 )
{
struct V_28 * V_29 ;
struct V_27 * V_27 ;
F_71 ( & V_88 ) ;
...
void F_78 ( struct V_25 * V_25 , T_2 V_26 ,
...
F_64 ( V_83 , V_26 , V_65 , V_91 ) ;
if ( V_95 && V_6 -> V_9 &&
! F_11 ( V_6 , NULL , V_13 ) &&
V_6 -> signal -> V_19 != V_20 ) {
F_35 ( V_6 ) ;
F_51 ( V_6 , V_26 , V_65 , 0 , V_16 , NULL ,
V_13 ,
L_11 ) ;
goto V_90;
}
...
if ( ! V_7 ) {
F_41 ( NULL , V_26 , V_65 , NULL , V_91 ) ;
F_65 ( L_12 ) ;
}
if ( V_7 != ( void * ) - 1UL ) {
F_51 ( V_7 , V_26 , V_65 , V_17 , V_16 , NULL ,
V_13 , L_13 ) ;
V_94 = 1 ;
}
V_90:
