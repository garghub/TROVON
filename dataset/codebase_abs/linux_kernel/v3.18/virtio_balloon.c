...
static inline void F_29 ( struct V_8 * V_9 , int V_28 ,
T_3 V_29 , T_4 V_30 )
{
F_5 ( V_28 >= V_31 ) ;
...
F_29 ( V_9 , V_28 ++ , V_38 ,
F_33 ( V_33 [ V_39 ] ) ) ;
F_29 ( V_9 , V_28 ++ , V_40 , V_33 [ V_41 ] ) ;
F_29 ( V_9 , V_28 ++ , V_42 , V_33 [ V_43 ] ) ;
F_29 ( V_9 , V_28 ++ , V_44 ,
F_33 ( V_19 . V_45 ) ) ;
F_29 ( V_9 , V_28 ++ , V_46 ,
F_33 ( V_19 . V_47 ) ) ;
...
static void F_36 ( struct V_51 * V_10 )
{
...
T_6 V_52 ;
T_5 V_53 ;
F_38 ( V_9 -> V_10 , struct V_54 , V_25 , & V_52 ) ;
V_53 = F_39 ( V_52 ) ;
return V_53 - V_9 -> V_25 ;
}
static void F_40 ( struct V_8 * V_9 )
{
T_6 V_55 = F_41 ( V_9 -> V_25 ) ;
F_42 ( V_9 -> V_10 , struct V_54 , V_55 ,
& V_55 ) ;
}
static int F_43 ( void * V_56 )
{
struct V_8 * V_9 = V_56 ;
F_44 () ;
while ( ! F_45 () ) {
...
struct V_1 * V_67 , struct V_1 * V_1 , enum V_68 V_69 )
{
struct V_8 * V_9 = F_54 ( V_22 ,
struct V_8 , V_22 ) ;
unsigned long V_70 ;
if ( ! F_55 ( & V_9 -> V_23 ) )
return - V_71 ;
...
static int F_62 ( struct V_51 * V_10 )
{
struct V_8 * V_9 ;
int V_62 ;
V_10 -> V_11 = V_9 = F_63 ( sizeof( * V_9 ) , V_18 ) ;
if ( ! V_9 ) {
V_62 = - V_76 ;
goto V_77;
}
...
F_27 ( V_9 , V_9 -> V_25 ) ;
F_40 ( V_9 ) ;
V_9 -> V_10 -> V_65 -> V_83 ( V_9 -> V_10 ) ;
V_9 -> V_10 -> V_65 -> V_82 ( V_9 -> V_10 ) ;
}
