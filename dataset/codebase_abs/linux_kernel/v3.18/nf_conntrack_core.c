...
void F_173 ( struct V_5 * V_5 , T_1 V_66 , int V_67 )
{
F_166 ( V_5 , F_167 , NULL , V_66 , V_67 ) ;
}
static int F_174 ( void )
{
int V_109 = 0 , V_52 ;
F_164 (cpu) {
struct V_46 * V_8 = & F_175 ( V_193 , V_52 ) ;
...
{
F_191 ( V_197 ) ;
F_192 ( & V_5 -> V_198 , & V_197 ) ;
F_193 ( & V_197 ) ;
}
void F_193 ( struct V_199 * V_200 )
{
int V_201 ;
struct V_5 * V_5 ;
F_194 () ;
V_202:
V_201 = 0 ;
F_195 (net, net_exit_list, exit_list) {
...
void * F_205 ( unsigned int * V_205 , int V_206 )
{
struct V_207 * V_24 ;
unsigned int V_208 , V_10 ;
T_9 V_209 ;
F_206 ( sizeof( struct V_207 ) != sizeof( struct V_192 ) ) ;
V_208 = * V_205 = F_207 ( * V_205 , V_210 / sizeof( struct V_207 ) ) ;
V_209 = V_208 * sizeof( struct V_207 ) ;
V_24 = ( void * ) F_208 ( V_211 | V_212 | V_213 ,
F_172 ( V_209 ) ) ;
if ( ! V_24 ) {
F_209 ( V_214 L_16 ) ;
V_24 = F_210 ( V_209 ) ;
...
F_211 ( & V_24 [ V_10 ] , V_10 ) ;
return V_24 ;
}
int F_212 ( const char * V_215 , struct V_216 * V_217 )
{
int V_10 , V_78 , V_218 ;
...
return - V_226 ;
if ( ! V_227 )
return F_213 ( V_215 , V_217 ) ;
V_218 = F_214 ( V_215 , 0 , & V_219 ) ;
if ( V_218 )
return V_218 ;
if ( ! V_219 )
return - V_187 ;
...
while ( ! F_216 ( & V_225 . V_8 . V_24 [ V_10 ] ) ) {
V_76 = F_217 ( V_225 . V_8 . V_24 [ V_10 ] . V_228 ,
struct V_75 , V_48 ) ;
V_8 = F_61 ( V_76 ) ;
F_25 ( & V_76 -> V_48 ) ;
...
void F_219 ( unsigned long V_229 )
{
int V_52 ;
F_164 (cpu)
F_175 ( V_193 , V_52 ) . V_73 |= V_229 ;
}
int F_220 ( void )
{
int V_230 = 8 ;
...
struct V_50 * V_51 = F_29 ( V_5 -> V_8 . V_53 , V_52 ) ;
F_107 ( & V_51 -> V_54 ) ;
F_211 ( & V_51 -> V_56 , V_247 ) ;
F_211 ( & V_51 -> V_55 , V_248 ) ;
F_211 ( & V_51 -> V_88 , V_249 ) ;
}
V_5 -> V_8 . V_204 = F_234 ( struct V_250 ) ;
if ( ! V_5 -> V_8 . V_204 )
goto V_251;
V_5 -> V_8 . V_203 = F_235 ( V_211 , L_18 , V_5 ) ;
if ( ! V_5 -> V_8 . V_203 )
goto V_252;
V_5 -> V_8 . V_120 = F_236 ( V_5 -> V_8 . V_203 ,
