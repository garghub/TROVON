...
struct V_167 * * V_257 )
{
T_29 * V_413 = ( T_29 * ) V_4 -> V_150 ;
union V_32 V_171 ;
bool V_414 = false ;
F_119 (param, addip, addip_hdr.params) {
T_2 V_20 = F_20 ( V_171 . V_245 -> V_20 ) ;
* V_257 = V_171 . V_245 ;
switch ( V_171 . V_245 -> type ) {
case V_404 :
break;
...
if ( V_412 && ! V_414 )
return false ;
V_20 = F_20 ( V_171 . V_413 -> V_74 . V_20 ) ;
...
V_110 -= V_20 ;
V_419 = F_144 ( V_6 , V_382 , V_110 * 4 ) ;
if ( ! V_419 )
goto V_420;
F_119 (param, addip, addip_hdr.params) {
if ( V_171 . V_245 -> type == V_314 ||
V_171 . V_245 -> type == V_315 )
continue;
...
V_395 = V_429 ;
V_428 = F_20 ( V_419 -> V_150 -> V_20 ) -
sizeof( T_19 ) ;
V_20 = sizeof( T_28 ) ;
V_427 = ( V_372 * ) ( V_419 -> V_2 -> V_163 +
V_20 ) ;
V_428 -= V_20 ;
while ( V_428 > 0 ) {
if ( V_427 -> V_394 == V_396 -> V_394 ) {
switch ( V_427 -> V_74 . type ) {
case V_403 :
return V_402 ;
case V_404 :
V_20 = sizeof( V_372 ) ;
V_398 = ( void * ) V_427 + V_20 ;
V_428 -= V_20 ;
if ( V_428 > 0 )
return V_398 -> V_19 ;
else
...
V_20 = F_20 ( V_427 -> V_74 . V_20 ) ;
V_427 = ( void * ) V_427 + V_20 ;
V_428 -= V_20 ;
}
return V_395 ;
}
...
struct V_3 * V_419 )
{
struct V_3 * V_377 = V_6 -> V_430 ;
union V_353 * V_354 ;
V_372 * V_396 ;
int V_20 = 0 ;
int V_431 = V_377 -> V_2 -> V_18 ;
int V_417 = 0 ;
int V_426 = 1 ;
int V_35 = 0 ;
T_1 V_395 = V_402 ;
...
T_2 V_149 ;
int V_296 ;
V_149 = ( V_435 + 1 ) * sizeof( T_13 ) ;
V_35 = F_21 ( V_6 , V_300 , 0 , V_149 ) ;
if ( ! V_35 )
return NULL ;
V_439 . V_434 = F_16 ( V_434 ) ;
V_35 -> V_21 . V_441 =
F_9 ( V_35 , sizeof( V_439 ) , & V_439 ) ;
for ( V_296 = 0 ; V_296 < V_435 ; V_296 ++ ) {
V_440 . V_112 = V_437 [ V_296 ] . V_112 ;
V_440 . V_107 = V_437 [ V_296 ] . V_107 ;
