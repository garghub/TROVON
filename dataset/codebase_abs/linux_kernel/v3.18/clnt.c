...
static
void F_95 ( struct V_144 * V_153 , struct V_1 * V_2 )
{
if ( V_2 != NULL ) {
F_94 ( V_153 ) ;
V_153 -> V_154 = V_2 ;
...
F_4 ( & V_2 -> V_44 ) ;
F_97 ( & V_153 -> V_155 , & V_2 -> V_90 ) ;
F_6 ( & V_2 -> V_44 ) ;
}
}
void F_98 ( struct V_144 * V_153 , struct V_1 * V_2 )
{
F_94 ( V_153 ) ;
F_95 ( V_153 , V_2 ) ;
}
static void
F_99 ( struct V_144 * V_153 , const struct V_160 * V_161 )
{
if ( V_161 != NULL ) {
...
if ( V_161 -> V_166 != NULL )
V_153 -> V_162 . V_166 = F_100 ( V_161 -> V_166 ) ;
}
}
static void
F_101 ( struct V_144 * V_153 , void * V_167 )
{
}
struct V_144 * F_102 ( const struct V_168 * V_169 )
{
struct V_144 * V_153 ;
V_153 = F_103 ( V_169 ) ;
if ( F_18 ( V_153 ) )
goto V_59;
F_95 ( V_153 , V_169 -> V_170 ) ;
F_99 ( V_153 , V_169 -> V_160 ) ;
if ( V_153 -> V_171 == NULL )
F_104 ( V_153 ) ;
F_58 ( & V_153 -> V_172 ) ;
F_105 ( V_153 ) ;
...
int F_106 ( struct V_1 * V_2 , const struct V_160 * V_161 , int V_97 )
{
struct V_144 * V_153 ;
struct V_168 V_169 = {
. V_170 = V_2 ,
...
int
F_110 ( struct V_1 * V_2 , const struct V_160 * V_161 , int V_97 ,
...
struct V_144 * F_111 ( struct V_181 * V_182 ,
...
void
F_104 ( struct V_144 * V_153 )
{
V_153 -> V_171 = V_193 ;
}
T_4 F_113 ( struct V_1 * V_2 , struct V_194 * V_195 , T_4 V_196 )
{
T_4 V_197 ;
struct V_39 * V_40 ;
F_69 () ;
...
static int F_115 ( struct V_3 * V_3 , struct V_194 * V_202 , T_4 V_203 ,
struct V_194 * V_195 , int V_204 )
{
struct V_205 * V_206 ;
int V_28 ;
V_28 = F_116 ( V_3 , V_202 -> V_128 ,
V_207 , V_208 , & V_206 , 1 ) ;
if ( V_28 < 0 ) {
F_43 ( L_22 , V_28 ) ;
goto V_59;
...
V_28 = F_118 ( V_206 , V_202 , V_203 , 0 ) ;
if ( V_28 < 0 ) {
F_43 ( L_24 , V_28 ) ;
goto V_212;
}
V_28 = F_119 ( V_206 , V_195 , & V_204 ) ;
if ( V_28 < 0 ) {
F_43 ( L_25 , V_28 ) ;
goto V_212;
}
...
static int F_121 ( int V_214 , struct V_194 * V_195 , T_4 V_204 )
{
switch ( V_214 ) {
case V_131 :
...
int F_122 ( struct V_1 * V_2 , struct V_194 * V_195 , T_4 V_204 )
{
struct V_215 V_115 ;
...
V_3 = F_123 ( V_40 -> V_216 ) ;
F_72 () ;
F_124 ( V_202 , 0 ) ;
V_28 = F_115 ( V_3 , V_202 , V_203 , V_195 , V_204 ) ;
F_125 ( V_3 ) ;
if ( V_28 != 0 )
return F_121 ( V_202 -> V_128 , V_195 , V_204 ) ;
return 0 ;
}
void
F_126 ( struct V_1 * V_2 , unsigned int V_217 , unsigned int V_218 )
{
struct V_39 * V_40 ;
F_69 () ;
V_40 = F_71 ( V_2 -> V_45 ) ;
...
static const char * F_135 ( const struct V_144 * V_153 )
{
...
{
struct V_1 * V_2 = V_153 -> V_154 ;
F_43 ( L_31 , V_153 -> V_229 ,
V_2 -> V_16 -> V_18 , V_2 -> V_85 ,
F_135 ( V_153 ) ,
( F_136 ( V_153 ) ? L_32 : L_33 ) ) ;
...
if ( V_182 -> V_250 != NULL )
return;
F_43 ( L_39 , V_153 -> V_229 ) ;
if ( F_136 ( V_153 ) || ! F_145 ( V_260 ) ) {
V_153 -> V_171 = V_239 ;
F_140 ( V_153 , V_151 >> 4 ) ;
return;
}
...
static inline int
F_146 ( struct V_144 * V_153 )
{
return V_153 -> V_186 -> V_185 . V_187 == 0 ;
}
static inline void
F_147 ( struct V_144 * V_153 )
{
V_153 -> V_186 -> V_185 . V_187 = 0 ;
V_153 -> V_186 -> V_262 = 0 ;
}
static inline void
F_148 ( struct V_183 * V_195 , void * V_263 , T_4 V_187 )
{
...
if ( V_265 == NULL )
return;
V_153 -> V_178 = F_151 ( V_153 , V_265 , V_182 , V_266 ,
V_153 -> V_162 . V_164 ) ;
}
static void
...
return;
V_153 -> V_171 = V_297 ;
F_83 ( & V_153 -> V_186 -> V_248 -> V_298 , V_153 ) ;
}
static void
...
break;
default:
F_107 ( V_153 -> V_178 == - V_235 ) ;
F_20 ( V_300 L_52
L_53 , V_153 -> V_178 ) ;
break;
}
F_83 ( & V_182 -> V_248 -> V_298 , V_153 ) ;
}
static void
...
{
struct V_1 * V_2 = V_153 -> V_154 ;
if ( F_164 ( V_153 -> V_186 ) == 0 ) {
F_43 ( L_55 , V_153 -> V_229 ) ;
goto V_304;
}
F_43 ( L_56 , V_153 -> V_229 ) ;
V_153 -> V_305 ++ ;
if ( F_153 ( V_153 ) ) {
F_81 ( V_153 , - V_240 ) ;
return;
...
F_168 ( memcmp ( & V_182 -> V_267 , & V_182 -> V_309 ,
...
V_153 -> V_171 = V_297 ;
if ( V_308 ) {
V_153 -> V_178 = F_170 ( V_153 , V_308 , V_182 , V_266 ,
V_153 -> V_162 . V_165 ) ;
}
F_43 ( L_61 , V_153 -> V_229 ,
V_153 -> V_178 ) ;
return;
V_310:
V_153 -> V_178 = 0 ;
...
static T_6 *
F_150 ( struct V_144 * V_153 )
{
struct V_1 * V_2 = V_153 -> V_154 ;
struct V_181 * V_182 = V_153 -> V_186 ;
T_6 * V_266 = V_182 -> V_311 [ 0 ] . V_264 ;
V_266 = F_171 ( V_182 -> V_248 , V_266 ) ;
* V_266 ++ = V_182 -> V_312 ;
* V_266 ++ = F_172 ( V_313 ) ;
* V_266 ++ = F_172 ( V_314 ) ;
* V_266 ++ = F_172 ( V_2 -> V_82 ) ;
* V_266 ++ = F_172 ( V_2 -> V_85 ) ;
* V_266 ++ = F_172 ( V_153 -> V_162 . V_163 -> V_251 ) ;
V_266 = F_173 ( V_153 , V_266 ) ;
V_182 -> V_315 = F_174 ( & V_182 -> V_311 [ 0 ] , V_266 ) ;
return V_266 ;
}
static T_6 *
F_169 ( struct V_144 * V_153 )
{
struct V_1 * V_2 = V_153 -> V_154 ;
...
goto V_319;
V_266 += 1 ;
if ( ( V_318 = F_175 ( * V_266 ++ ) ) != V_320 ) {
F_43 ( L_64 ,
V_153 -> V_229 , V_31 , V_318 ) ;
error = - V_148 ;
goto V_321;
}
if ( ( V_318 = F_175 ( * V_266 ++ ) ) != V_322 ) {
if ( -- V_187 < 0 )
goto V_319;
switch ( ( V_318 = F_175 ( * V_266 ++ ) ) ) {
case V_323 :
break;
case V_324 :
F_43 ( L_65 ,
...
V_75:
F_81 ( V_153 , error ) ;
F_43 ( L_83 , V_153 -> V_229 ,
V_31 , error ) ;
return F_19 ( error ) ;
V_319:
F_43 ( L_84 , V_153 -> V_229 ,
V_31 ) ;
goto V_321;
}
static void F_177 ( void * V_339 , struct V_340 * V_341 , void * V_342 )
{
}
static int F_178 ( void * V_339 , struct V_340 * V_341 , void * V_342 )
{
return 0 ;
}
...
V_28 = F_106 ( V_2 , & V_161 , V_156 | V_346 ) ;
F_179 ( V_161 . V_166 ) ;
return V_28 ;
}
struct V_144 * F_180 ( struct V_1 * V_2 , struct V_166 * V_347 , int V_97 )
{
struct V_160 V_161 = {
. V_163 = & V_343 ,
. V_166 = V_347 ,
