...
static int F_110 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
struct V_280 V_281 ;
if ( V_141 -> V_149 == 0x02 ) {
V_281 . V_282 = F_113 ( T_1 , V_6 -> V_282 , 2 ) ;
V_281 . V_283 [ 0 ] = 0x00 ;
V_281 . V_283 [ 1 ] = 0x8b ;
V_281 . V_283 [ 2 ] = 0x9e ;
V_281 . V_283 [ 3 ] = 0x33 ;
...
static void F_114 ( struct V_138 * V_139 , bool V_181 )
{
struct V_5 * V_6 = V_139 -> V_6 ;
struct V_286 V_287 ;
T_1 type ;
...
if ( F_115 ( V_6 -> V_292 ) != V_287 . V_289 ||
F_115 ( V_6 -> V_293 ) != V_287 . V_291 )
F_49 ( V_139 , V_294 ,
sizeof( V_287 ) , & V_287 ) ;
if ( V_6 -> V_295 != type )
F_49 ( V_139 , V_296 , 1 , & type ) ;
}
static void F_116 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_129 * V_23 ;
struct V_147 * V_141 ;
bool V_297 , V_298 ;
...
static int F_119 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
struct V_147 * V_141 = V_7 ;
struct V_129 * V_23 ;
...
F_32 ( V_6 ) ;
if ( ! F_40 ( V_6 ) ) {
V_27 = F_118 ( V_6 , V_22 , V_141 -> V_149 ) ;
goto V_256;
}
if ( F_45 ( V_146 , V_6 ) ||
F_45 ( V_180 , V_6 ) ) {
...
static int F_122 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
struct V_147 * V_141 = V_7 ;
struct V_129 * V_23 ;
...
V_27 = F_123 ( V_6 , V_305 , sizeof( V_149 ) , & V_149 ) ;
if ( V_27 < 0 ) {
F_86 ( V_23 ) ;
goto V_256;
}
...
V_27 = F_123 ( V_6 , V_310 , 1 , & V_141 -> V_149 ) ;
if ( V_27 < 0 ) {
F_86 ( V_23 ) ;
goto V_256;
}
...
static int F_125 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 , T_2 V_21 )
{
struct V_147 * V_141 = V_7 ;
bool V_267 ;
T_1 V_24 ;
...
static void F_126 ( struct V_5 * V_6 , T_1 V_24 )
{
...
static int F_127 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 , T_2 V_21 )
{
struct V_147 * V_141 = V_7 ;
struct V_312 V_281 ;
struct V_129 * V_23 ;
...
static T_1 F_130 ( const T_1 * V_119 )
{
T_6 V_149 ;
if ( memcmp ( V_119 , V_321 , 12 ) )
return 128 ;
V_149 = F_131 ( & V_119 [ 12 ] ) ;
if ( V_149 > 0xffff )
return 32 ;
return 16 ;
}
static void F_132 ( struct V_5 * V_6 , T_2 V_322 , T_1 V_24 )
{
struct V_129 * V_23 ;
F_32 ( V_6 ) ;
V_23 = F_45 ( V_322 , V_6 ) ;
...
static void F_133 ( struct V_5 * V_6 , T_1 V_24 )
{
F_11 ( L_10 , V_24 ) ;
F_132 ( V_6 , V_318 , V_24 ) ;
}
static int F_134 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 , T_2 V_21 )
{
...
V_119 -> V_121 = F_130 ( V_141 -> V_119 ) ;
F_135 ( & V_119 -> V_209 , & V_6 -> V_324 ) ;
F_54 ( & V_139 , V_6 ) ;
F_60 ( & V_139 ) ;
F_57 ( & V_139 ) ;
V_27 = F_55 ( & V_139 , F_133 ) ;
if ( V_27 < 0 ) {
if ( V_27 != - V_260 )
goto V_256;
...
{
F_11 ( L_10 , V_24 ) ;
F_132 ( V_6 , V_319 , V_24 ) ;
}
static int F_138 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
static void F_140 ( struct V_5 * V_6 , T_1 V_24 )
{
F_11 ( L_10 , V_24 ) ;
F_132 ( V_6 , V_320 , V_24 ) ;
}
static int F_141 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
static int F_143 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
if ( V_340 -> type == V_344 )
continue;
F_146 ( V_6 , NULL , & V_340 -> V_342 . V_204 , V_340 -> V_149 ,
...
static int F_147 ( struct V_5 * V_6 , T_8 * V_204 ,
...
static int F_148 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
V_27 = F_150 ( V_6 , & V_141 -> V_342 . V_204 ) ;
} else {
T_1 V_346 ;
...
F_152 ( V_6 , & V_141 -> V_342 . V_204 , V_346 ) ;
V_27 = F_153 ( V_6 , & V_141 -> V_342 . V_204 , V_346 ) ;
}
if ( V_27 < 0 ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_351 ,
...
if ( V_141 -> V_352 ) {
if ( V_141 -> V_342 . type == V_343 )
V_228 = F_154 ( V_6 , V_245 ,
& V_141 -> V_342 . V_204 ) ;
else
V_228 = F_154 ( V_6 , V_186 ,
& V_141 -> V_342 . V_204 ) ;
} else {
V_228 = NULL ;
}
...
& V_29 , sizeof( V_29 ) ) ;
F_147 ( V_6 , & V_141 -> V_342 . V_204 , V_141 -> V_342 . type , V_22 ) ;
goto V_268;
}
...
V_235 . V_240 = F_6 ( V_228 -> V_240 ) ;
V_235 . V_241 = 0x13 ;
V_27 = F_123 ( V_6 , V_242 , sizeof( V_235 ) , & V_235 ) ;
if ( V_27 < 0 )
F_86 ( V_23 ) ;
V_268:
F_33 ( V_6 ) ;
...
V_228 = F_154 ( V_6 , V_186 , & V_141 -> V_342 . V_204 ) ;
...
static T_1 F_156 ( T_1 V_365 , T_1 V_346 )
{
switch ( V_365 ) {
case V_186 :
switch ( V_346 ) {
...
V_29 -> V_342 [ V_45 ] . type = F_156 ( V_368 -> type , V_368 -> V_372 ) ;
...
static int F_158 ( struct V_9 * V_22 , struct V_5 * V_6 ,
struct V_375 * V_141 )
{
struct V_129 * V_23 ;
int V_27 ;
...
if ( ! V_23 )
return - V_16 ;
V_27 = F_123 ( V_6 , V_377 ,
sizeof( V_141 -> V_342 . V_204 ) , & V_141 -> V_342 . V_204 ) ;
if ( V_27 < 0 )
F_86 ( V_23 ) ;
return V_27 ;
}
static int F_159 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
struct V_227 * V_228 ;
...
V_228 = F_154 ( V_6 , V_245 , & V_141 -> V_342 . V_204 ) ;
if ( ! V_228 ) {
V_27 = F_10 ( V_22 , V_6 -> V_19 , V_381 ,
V_363 ) ;
goto V_256;
...
V_27 = F_123 ( V_6 , V_386 , sizeof( V_380 ) , & V_380 ) ;
if ( V_27 < 0 )
F_86 ( V_23 ) ;
V_256:
F_33 ( V_6 ) ;
...
static struct V_129 * F_161 ( struct V_227 * V_228 )
{
...
static void F_162 ( struct V_129 * V_23 , T_1 V_24 )
{
struct V_392 V_29 ;
struct V_227 * V_228 = V_23 -> V_130 ;
F_76 ( & V_29 . V_342 . V_204 , & V_228 -> V_247 ) ;
V_29 . V_342 . type = F_156 ( V_228 -> type , V_228 -> V_372 ) ;
...
void F_165 ( struct V_227 * V_228 , bool V_396 )
{
...
static void F_166 ( struct V_227 * V_228 , T_1 V_24 )
{
struct V_129 * V_23 ;
F_11 ( L_16 , V_24 ) ;
V_23 = F_161 ( V_228 ) ;
...
static void F_167 ( struct V_227 * V_228 , T_1 V_24 )
{
struct V_129 * V_23 ;
F_11 ( L_16 , V_24 ) ;
if ( ! V_24 )
...
static int F_168 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
V_399 = V_402 ;
if ( V_141 -> V_342 . type == V_343 ) {
V_228 = F_169 ( V_6 , & V_141 -> V_342 . V_204 , V_398 ,
V_399 ) ;
} else {
T_1 V_346 ;
if ( V_141 -> V_342 . type == V_353 )
...
V_346 = V_355 ;
F_170 ( V_6 , & V_141 -> V_342 . V_204 , V_346 ) ;
V_228 = F_171 ( V_6 , & V_141 -> V_342 . V_204 , V_346 ,
V_398 , V_403 ,
V_404 ) ;
}
if ( F_172 ( V_228 ) ) {
int V_24 ;
if ( F_173 ( V_228 ) == - V_405 )
V_24 = V_255 ;
else
V_24 = V_406 ;
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_391 ,
...
V_23 -> V_130 = F_174 ( V_228 ) ;
if ( ( V_228 -> V_218 == V_238 || V_228 -> V_218 == V_239 ) &&
F_175 ( V_228 , V_398 , V_399 , true ) )
F_162 ( V_23 , 0 ) ;
V_27 = 0 ;
V_268:
F_33 ( V_6 ) ;
...
if ( V_342 -> type == V_343 )
V_228 = F_154 ( V_6 , V_245 , & V_342 -> V_204 ) ;
else
V_228 = F_154 ( V_6 , V_186 , & V_342 -> V_204 ) ;
if ( ! V_228 ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_322 ,
V_363 , V_342 ,
sizeof( * V_342 ) ) ;
...
V_141 . V_410 = V_410 ;
V_27 = F_123 ( V_6 , V_409 , sizeof( V_141 ) , & V_141 ) ;
} else
V_27 = F_123 ( V_6 , V_409 , sizeof( V_342 -> V_204 ) ,
& V_342 -> V_204 ) ;
if ( V_27 < 0 )
F_86 ( V_23 ) ;
V_411:
...
F_11 ( L_7 ) ;
return F_177 ( V_22 , V_6 , & V_141 -> V_342 ,
V_376 ,
V_377 , 0 ) ;
}
static int F_180 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
static int F_181 ( struct V_9 * V_22 , struct V_5 * V_6 ,
void * V_7 , T_2 V_21 )
{
...
static void F_184 ( struct V_138 * V_139 )
{
struct V_5 * V_6 = V_139 -> V_6 ;
struct V_425 V_141 ;
...
static void F_185 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_427 * V_141 ;
struct V_129 * V_23 ;
F_11 ( L_10 , V_24 ) ;
...
static int F_186 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
if ( F_22 ( V_113 , & V_6 -> V_55 ) )
V_27 = F_123 ( V_6 , V_431 ,
0 , NULL ) ;
else
V_27 = F_123 ( V_6 , V_432 , 0 , NULL ) ;
if ( V_27 < 0 )
F_86 ( V_23 ) ;
V_268:
F_33 ( V_6 ) ;
...
T_1 V_24 ;
V_27 = F_189 ( V_6 , & V_141 -> V_342 . V_204 ,
...
T_1 V_24 ;
V_27 = F_190 ( V_6 , & V_141 -> V_342 . V_204 ,
V_141 -> V_440 ,
V_141 -> V_441 ,
V_141 -> V_442 ,
V_141 -> V_443 ) ;
...
F_11 ( L_6 , V_6 -> V_77 ) ;
F_32 ( V_6 ) ;
V_27 = F_192 ( V_6 , & V_141 -> V_342 . V_204 ) ;
if ( V_27 < 0 )
V_24 = V_254 ;
else
V_24 = V_266 ;
...
static int F_193 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_129 * V_23 ;
T_1 type ;
int V_27 ;
...
static void F_194 ( struct V_5 * V_6 , T_1 V_24 )
{
...
static int F_198 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_129 * V_23 ;
int V_27 ;
V_23 = F_45 ( V_474 , V_6 ) ;
...
static void F_199 ( struct V_5 * V_6 , T_1 V_24 )
{
F_11 ( L_20 , V_24 ) ;
F_32 ( V_6 ) ;
if ( V_24 ) {
...
static int F_200 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
static int F_202 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
V_216 = F_203 ( V_6 , & V_141 -> V_342 . V_204 ) ;
if ( ! V_216 ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_478 ,
V_254 , & V_141 -> V_342 ,
sizeof( V_141 -> V_342 ) ) ;
...
F_32 ( V_6 ) ;
V_27 = F_206 ( & V_6 -> V_485 , & V_141 -> V_342 . V_204 ,
V_141 -> V_342 . type ) ;
if ( V_27 < 0 ) {
V_24 = V_3 ;
goto V_411;
...
& V_141 -> V_342 , sizeof( V_141 -> V_342 ) ) ;
F_32 ( V_6 ) ;
V_27 = F_208 ( & V_6 -> V_485 , & V_141 -> V_342 . V_204 ,
V_141 -> V_342 . type ) ;
if ( V_27 < 0 ) {
V_24 = V_254 ;
goto V_411;
...
T_9 V_491 ;
F_11 ( L_6 , V_6 -> V_77 ) ;
V_491 = F_111 ( V_141 -> V_491 ) ;
if ( V_491 > 0x0002 )
return F_10 ( V_22 , V_6 -> V_19 , V_492 ,
V_254 ) ;
F_32 ( V_6 ) ;
V_6 -> V_164 = V_491 ;
V_6 -> V_166 = F_111 ( V_141 -> V_493 ) ;
V_6 -> V_167 = F_111 ( V_141 -> V_494 ) ;
V_6 -> V_168 = F_111 ( V_141 -> V_34 ) ;
...
static void F_210 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_262 V_263 = { NULL , V_6 } ;
if ( V_24 ) {
T_1 V_269 = F_1 ( V_24 ) ;
...
static int F_213 ( struct V_9 * V_22 , struct V_5 * V_6 ,
void * V_7 , T_2 V_21 )
{
...
V_264 ) ;
V_289 = F_111 ( V_141 -> V_289 ) ;
if ( V_289 < 0x0004 || V_289 > 0x4000 )
return F_10 ( V_22 , V_6 -> V_19 , V_502 ,
V_254 ) ;
V_291 = F_111 ( V_141 -> V_291 ) ;
...
static void F_215 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_129 * V_23 ;
F_11 ( L_10 , V_24 ) ;
F_32 ( V_6 ) ;
...
F_54 ( & V_139 , V_6 ) ;
F_114 ( & V_139 , V_141 -> V_149 ) ;
V_27 = F_55 ( & V_139 , F_215 ) ;
if ( V_27 < 0 ) {
V_27 = F_10 ( V_22 , V_6 -> V_19 , V_505 ,
V_3 ) ;
F_86 ( V_23 ) ;
...
static int F_218 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 , T_2 V_21 )
{
struct V_147 * V_141 = V_7 ;
struct V_129 * V_23 ;
struct V_138 V_139 ;
...
static int F_221 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_513 ,
T_2 V_21 )
{
...
static bool F_222 ( struct V_519 * V_518 )
{
...
static int F_223 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_513 ,
T_2 V_21 )
{
...
V_346 = V_355 ;
F_225 ( V_6 , & V_518 -> V_342 . V_204 , V_346 , V_518 -> V_149 ,
V_70 ) ;
}
F_71 ( V_517 , & V_6 -> V_55 ) ;
...
static bool F_226 ( struct V_525 * V_340 )
{
...
F_229 ( V_6 , & V_340 -> V_342 . V_204 , V_346 , type ,
...
static void F_230 ( struct V_129 * V_23 , void * V_7 )
{
...
static void F_231 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_544 * V_141 ;
struct V_227 * V_228 ;
struct V_536 V_263 ;
...
F_32 ( V_6 ) ;
V_263 . V_540 = ! V_24 ;
V_141 = F_232 ( V_6 , V_545 ) ;
if ( ! V_141 ) {
V_141 = F_232 ( V_6 , V_546 ) ;
V_24 = 0 ;
}
if ( ! V_141 ) {
F_144 ( L_28 ) ;
...
V_240 = F_111 ( V_141 -> V_240 ) ;
V_228 = F_233 ( V_6 , V_240 ) ;
if ( ! V_228 ) {
F_144 ( L_29 , V_240 ) ;
goto V_268;
}
...
static int F_234 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
static void F_239 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_555 * V_141 ;
struct V_556 V_29 ;
struct V_557 * V_281 ;
...
F_32 ( V_6 ) ;
V_281 = F_232 ( V_6 , V_558 ) ;
if ( ! V_281 )
goto V_268;
if ( V_281 -> V_559 ) {
T_2 V_240 = F_111 ( V_281 -> V_240 ) ;
V_228 = F_233 ( V_6 , V_240 ) ;
} else {
V_228 = NULL ;
}
...
static int F_240 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
...
static void F_241 ( struct V_9 * V_22 , struct V_5 * V_6 ,
...
static int F_242 ( struct V_9 * V_22 , struct V_5 * V_6 ,
void * V_7 , T_2 V_21 )
{
...
V_27 = F_206 ( & V_6 -> V_299 , & V_141 -> V_342 . V_204 ,
V_141 -> V_342 . type ) ;
if ( V_27 )
goto V_268;
F_109 ( V_6 , NULL ) ;
...
V_570 = V_575 ;
if ( F_243 ( V_6 , & V_141 -> V_342 . V_204 , V_346 ,
V_570 ) < 0 ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_571 ,
V_3 ,
& V_141 -> V_342 , sizeof( V_141 -> V_342 ) ) ;
...
V_572:
F_241 ( V_22 , V_6 , & V_141 -> V_342 . V_204 , V_141 -> V_342 . type , V_141 -> V_566 ) ;
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_571 ,
...
static void F_244 ( struct V_9 * V_22 , struct V_5 * V_6 ,
T_8 * V_204 , T_1 type )
{
struct V_576 V_26 ;
F_76 ( & V_26 . V_342 . V_204 , V_204 ) ;
V_26 . V_342 . type = type ;
F_3 ( V_577 , V_6 , & V_26 , sizeof( V_26 ) , V_22 ) ;
}
static int F_245 ( struct V_9 * V_22 , struct V_5 * V_6 ,
void * V_7 , T_2 V_21 )
{
struct V_578 * V_141 = V_7 ;
int V_27 ;
F_11 ( L_6 , V_6 -> V_77 ) ;
F_32 ( V_6 ) ;
if ( F_26 ( & V_141 -> V_342 . V_204 , V_70 ) ) {
...
T_1 V_346 ;
if ( ! F_149 ( V_141 -> V_342 . type ) ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_581 ,
V_254 ,
& V_141 -> V_342 , sizeof( V_141 -> V_342 ) ) ;
goto V_268;
}
if ( V_141 -> V_342 . type == V_343 ) {
V_27 = F_208 ( & V_6 -> V_299 ,
& V_141 -> V_342 . V_204 ,
V_141 -> V_342 . type ) ;
if ( V_27 ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 ,
...
F_109 ( V_6 , NULL ) ;
F_244 ( V_22 , V_6 , & V_141 -> V_342 . V_204 ,
V_141 -> V_342 . type ) ;
goto V_396;
}
if ( V_141 -> V_342 . type == V_353 )
...
V_346 = V_355 ;
V_580 = F_246 ( V_6 , & V_141 -> V_342 . V_204 ,
V_346 ) ;
if ( ! V_580 ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_581 ,
V_254 ,
...
F_18 ( V_580 ) ;
F_117 ( V_6 ) ;
F_244 ( V_22 , V_6 , & V_141 -> V_342 . V_204 , V_141 -> V_342 . type ) ;
} else {
struct V_579 * V_584 , * V_211 ;
struct V_585 * V_499 , * V_586 ;
if ( V_141 -> V_342 . type ) {
V_27 = F_13 ( V_22 , V_6 -> V_19 , V_581 ,
V_254 ,
& V_141 -> V_342 , sizeof( V_141 -> V_342 ) ) ;
...
F_244 ( V_22 , V_6 , & V_499 -> V_204 , V_499 -> V_587 ) ;
F_87 ( & V_499 -> V_209 ) ;
F_18 ( V_499 ) ;
}
F_109 ( V_6 , NULL ) ;
F_85 (p, tmp, &hdev->le_conn_params, list) {
if ( V_584 -> V_582 == V_583 )
continue;
F_244 ( V_22 , V_6 , & V_584 -> V_342 , V_584 -> V_346 ) ;
F_87 ( & V_584 -> V_566 ) ;
F_87 ( & V_584 -> V_209 ) ;
F_18 ( V_584 ) ;
}
...
static int F_247 ( struct V_9 * V_22 , struct V_5 * V_6 , void * V_7 ,
T_2 V_21 )
{
struct V_588 * V_141 = V_7 ;
const T_2 V_589 = ( ( V_334 - sizeof( * V_141 ) ) /
sizeof( struct V_590 ) ) ;
T_2 V_591 , V_337 ;
int V_45 ;
if ( ! F_38 ( V_6 ) )
return F_10 ( V_22 , V_6 -> V_19 , V_592 ,
V_264 ) ;
V_591 = F_111 ( V_141 -> V_591 ) ;
if ( V_591 > V_589 ) {
F_144 ( L_32 ,
V_591 ) ;
return F_10 ( V_22 , V_6 -> V_19 , V_592 ,
...
F_11 ( L_34 , V_6 -> V_77 , V_591 ) ;
F_32 ( V_6 ) ;
F_248 ( V_6 ) ;
for ( V_45 = 0 ; V_45 < V_591 ; V_45 ++ ) {
struct V_590 * V_148 = & V_141 -> V_580 [ V_45 ] ;
struct V_579 * V_593 ;
T_2 V_594 , V_595 , V_596 , V_276 ;
T_1 V_346 ;
...
V_594 = F_249 ( V_148 -> V_188 ) ;
V_595 = F_249 ( V_148 -> V_190 ) ;
V_596 = F_249 ( V_148 -> V_596 ) ;
V_276 = F_249 ( V_148 -> V_276 ) ;
F_11 ( L_37 ,
V_594 , V_595 , V_596 , V_276 ) ;
if ( F_250 ( V_594 , V_595 , V_596 , V_276 ) < 0 ) {
F_144 ( L_36 ) ;
continue;
}
V_593 = F_170 ( V_6 , & V_148 -> V_342 . V_204 ,
V_346 ) ;
if ( ! V_593 ) {
F_144 ( L_38 ) ;
continue;
...
F_33 ( V_6 ) ;
return F_13 ( V_22 , V_6 -> V_19 , V_592 , 0 , NULL , 0 ) ;
}
static int F_251 ( struct V_9 * V_22 , struct V_5 * V_6 ,
void * V_7 , T_2 V_21 )
{
struct V_601 * V_141 = V_7 ;
bool V_267 ;
int V_27 ;
F_11 ( L_6 , V_6 -> V_77 ) ;
if ( F_40 ( V_6 ) )
return F_10 ( V_22 , V_6 -> V_19 , V_602 ,
V_265 ) ;
if ( V_141 -> V_603 != 0x00 && V_141 -> V_603 != 0x01 )
return F_10 ( V_22 , V_6 -> V_19 , V_602 ,
V_254 ) ;
if ( ! F_22 ( V_66 , & V_6 -> V_61 ) )
return F_10 ( V_22 , V_6 -> V_19 , V_602 ,
...
F_252 ( V_6 ) ;
if ( F_253 ( V_54 , & V_6 -> V_55 ) ) {
F_71 ( V_58 , & V_6 -> V_55 ) ;
F_71 ( V_257 , & V_6 -> V_55 ) ;
F_92 ( V_6 -> V_213 , & V_6 -> V_258 ) ;
} else {
F_71 ( V_604 , & V_6 -> V_153 ) ;
F_254 ( V_6 ) ;
}
}
V_268:
...
static int F_255 ( struct V_9 * V_22 , struct V_5 * V_6 ,
void * V_7 , T_2 V_21 )
{
struct V_605 * V_141 = V_7 ;
bool V_267 ;
int V_27 ;
F_11 ( L_6 , V_6 -> V_77 ) ;
if ( F_40 ( V_6 ) )
...
int F_256 ( struct V_9 * V_22 , struct V_607 * V_608 , T_3 V_609 )
{
void * V_610 ;
T_1 * V_141 ;
struct V_13 * V_14 ;
...
int V_27 ;
F_11 ( L_39 , V_609 ) ;
if ( V_609 < sizeof( * V_14 ) )
return - V_613 ;
V_610 = F_16 ( V_609 , V_15 ) ;
if ( ! V_610 )
return - V_16 ;
if ( F_257 ( V_610 , V_608 -> V_614 , V_609 ) ) {
V_27 = - V_615 ;
goto V_411;
}
V_14 = V_610 ;
V_17 = F_111 ( V_14 -> V_17 ) ;
V_18 = F_111 ( V_14 -> V_18 ) ;
V_21 = F_111 ( V_14 -> V_21 ) ;
if ( V_21 != V_609 - sizeof( * V_14 ) ) {
V_27 = - V_613 ;
goto V_411;
}
if ( V_18 != V_20 ) {
...
V_612 = & V_617 [ V_17 ] ;
if ( ( V_612 -> V_620 && V_21 < V_612 -> V_8 ) ||
( ! V_612 -> V_620 && V_21 != V_612 -> V_8 ) ) {
V_27 = F_10 ( V_22 , V_18 , V_17 ,
V_254 ) ;
goto V_411;
}
if ( V_6 )
F_72 ( V_22 , V_6 ) ;
V_141 = V_610 + sizeof( * V_14 ) ;
V_27 = V_612 -> V_618 ( V_22 , V_6 , V_141 , V_21 ) ;
if ( V_27 < 0 )
goto V_411;
V_27 = V_609 ;
V_411:
...
case V_574 :
case V_573 :
F_82 ( & V_584 -> V_566 , & V_6 -> V_625 ) ;
break;
case V_575 :
F_82 ( & V_584 -> V_566 , & V_6 -> V_626 ) ;
break;
default:
break;
}
...
static void F_262 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_262 V_263 = { NULL , V_6 } ;
F_11 ( L_10 , V_24 ) ;
F_32 ( V_6 ) ;
...
V_141 . V_315 = 0x01 ;
V_141 . V_316 = 0x00 ;
if ( V_141 . V_315 != F_128 ( V_6 ) ||
V_141 . V_316 != F_265 ( V_6 ) )
F_49 ( & V_139 , V_317 ,
sizeof( V_141 ) , & V_141 ) ;
}
if ( F_38 ( V_6 ) ) {
...
V_627 = F_22 ( V_109 , & V_6 -> V_55 ) ;
if ( V_627 != F_22 ( V_304 , & V_6 -> V_153 ) )
F_49 ( & V_139 , V_305 ,
sizeof( V_627 ) , & V_627 ) ;
if ( F_35 ( V_6 ) ) {
F_114 ( & V_139 , false ) ;
...
return F_55 ( & V_139 , F_262 ) ;
}
int F_99 ( struct V_5 * V_6 , T_1 V_629 )
{
struct V_262 V_263 = { NULL , V_6 } ;
T_1 V_630 = V_277 ;
T_1 V_631 [] = { 0 , 0 , 0 } ;
...
F_83 ( V_253 , V_6 , F_103 , & V_263 ) ;
F_83 ( 0 , V_6 , F_104 , & V_630 ) ;
if ( memcmp ( V_6 -> V_178 , V_631 , sizeof( V_631 ) ) != 0 )
F_3 ( V_632 , V_6 ,
V_631 , sizeof( V_631 ) , NULL ) ;
F_101:
...
void F_266 ( struct V_5 * V_6 , int V_27 )
{
struct V_129 * V_23 ;
T_1 V_24 ;
V_23 = F_45 ( V_253 , V_6 ) ;
...
void F_268 ( struct V_5 * V_6 , struct V_635 * V_340 ,
bool V_636 )
{
struct V_637 V_26 ;
...
memcpy ( V_26 . V_340 . V_149 , V_340 -> V_149 , V_639 ) ;
V_26 . V_340 . V_345 = V_340 -> V_345 ;
F_3 ( V_640 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
static T_1 F_269 ( struct V_641 * V_642 )
{
if ( V_642 -> V_529 )
return V_533 ;
return V_532 ;
}
void F_270 ( struct V_5 * V_6 , struct V_641 * V_340 , bool V_636 )
{
struct V_643 V_26 ;
memset ( & V_26 , 0 , sizeof( V_26 ) ) ;
if ( V_340 -> V_587 == V_355 &&
( V_340 -> V_204 . V_499 [ 5 ] & 0xc0 ) != 0xc0 )
V_26 . V_638 = 0x00 ;
else
V_26 . V_638 = V_636 ;
F_76 ( & V_26 . V_340 . V_342 . V_204 , & V_340 -> V_204 ) ;
V_26 . V_340 . V_342 . type = F_156 ( V_186 , V_340 -> V_587 ) ;
V_26 . V_340 . type = F_269 ( V_340 ) ;
...
F_3 ( V_644 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
void F_271 ( struct V_5 * V_6 , struct V_645 * V_518 )
{
struct V_646 V_26 ;
memset ( & V_26 , 0 , sizeof( V_26 ) ) ;
if ( F_26 ( & V_518 -> V_647 , V_70 ) )
V_26 . V_638 = 0x01 ;
else
V_26 . V_638 = 0x00 ;
F_76 ( & V_26 . V_647 , & V_518 -> V_647 ) ;
F_76 ( & V_26 . V_518 . V_342 . V_204 , & V_518 -> V_204 ) ;
V_26 . V_518 . V_342 . type = F_156 ( V_186 , V_518 -> V_346 ) ;
memcpy ( V_26 . V_518 . V_149 , V_518 -> V_149 , sizeof( V_518 -> V_149 ) ) ;
F_3 ( V_648 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
void F_272 ( struct V_5 * V_6 , struct V_649 * V_650 ,
bool V_636 )
{
struct V_651 V_26 ;
memset ( & V_26 , 0 , sizeof( V_26 ) ) ;
if ( V_650 -> V_587 == V_355 &&
( V_650 -> V_204 . V_499 [ 5 ] & 0xc0 ) != 0xc0 )
V_26 . V_638 = 0x00 ;
else
V_26 . V_638 = V_636 ;
F_76 ( & V_26 . V_340 . V_342 . V_204 , & V_650 -> V_204 ) ;
V_26 . V_340 . V_342 . type = F_156 ( V_186 , V_650 -> V_587 ) ;
V_26 . V_340 . V_526 = V_650 -> V_526 ;
memcpy ( V_26 . V_340 . V_149 , V_650 -> V_149 , sizeof( V_650 -> V_149 ) ) ;
F_3 ( V_652 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
void F_273 ( struct V_5 * V_6 , T_8 * V_204 ,
T_1 V_587 , T_1 V_638 , T_2 V_188 ,
T_2 V_190 , T_2 V_596 , T_2 V_276 )
{
struct V_653 V_26 ;
if ( ! F_274 ( V_204 , V_587 ) )
return;
memset ( & V_26 , 0 , sizeof( V_26 ) ) ;
F_76 ( & V_26 . V_342 . V_204 , V_204 ) ;
V_26 . V_342 . type = F_156 ( V_186 , V_587 ) ;
V_26 . V_638 = V_638 ;
V_26 . V_188 = F_6 ( V_188 ) ;
V_26 . V_190 = F_6 ( V_190 ) ;
V_26 . V_596 = F_6 ( V_596 ) ;
V_26 . V_276 = F_6 ( V_276 ) ;
F_3 ( V_654 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
static inline T_2 F_275 ( T_1 * V_172 , T_2 V_655 , T_1 type , T_1 * V_7 ,
T_1 V_8 )
{
V_172 [ V_655 ++ ] = sizeof( type ) + V_8 ;
V_172 [ V_655 ++ ] = type ;
memcpy ( & V_172 [ V_655 ] , V_7 , V_8 ) ;
V_655 += V_8 ;
return V_655 ;
}
void F_276 ( struct V_5 * V_6 , T_8 * V_204 , T_1 V_365 ,
T_1 V_346 , T_6 V_153 , T_1 * V_77 , T_1 V_132 ,
T_1 * V_178 )
{
char V_610 [ 512 ] ;
struct V_656 * V_26 = ( void * ) V_610 ;
T_2 V_655 = 0 ;
F_76 ( & V_26 -> V_342 . V_204 , V_204 ) ;
V_26 -> V_342 . type = F_156 ( V_365 , V_346 ) ;
V_26 -> V_153 = F_277 ( V_153 ) ;
if ( V_132 > 0 )
V_655 = F_275 ( V_26 -> V_172 , 0 , V_137 ,
V_77 , V_132 ) ;
if ( V_178 && memcmp ( V_178 , L_41 , 3 ) != 0 )
V_655 = F_275 ( V_26 -> V_172 , V_655 ,
V_657 , V_178 , 3 ) ;
V_26 -> V_655 = F_6 ( V_655 ) ;
F_3 ( V_658 , V_6 , V_610 ,
sizeof( * V_26 ) + V_655 , NULL ) ;
}
static void F_278 ( struct V_129 * V_23 , void * V_7 )
{
...
static void F_279 ( struct V_129 * V_23 , void * V_7 )
{
struct V_5 * V_6 = V_7 ;
...
F_76 ( & V_29 . V_342 . V_204 , & V_141 -> V_342 . V_204 ) ;
V_29 . V_342 . type = V_141 -> V_342 . type ;
F_147 ( V_6 , & V_141 -> V_342 . V_204 , V_141 -> V_342 . type , V_23 -> V_22 ) ;
F_13 ( V_23 -> V_22 , V_23 -> V_18 , V_23 -> V_17 , 0 , & V_29 , sizeof( V_29 ) ) ;
F_86 ( V_23 ) ;
}
bool F_280 ( struct V_5 * V_6 )
{
struct V_129 * V_23 ;
struct V_147 * V_141 ;
V_23 = F_45 ( V_253 , V_6 ) ;
...
return;
F_83 ( V_359 , V_6 , F_278 , & V_22 ) ;
F_76 ( & V_26 . V_342 . V_204 , V_204 ) ;
V_26 . V_342 . type = F_156 ( V_365 , V_346 ) ;
V_26 . V_241 = V_241 ;
F_3 ( V_661 , V_6 , & V_26 , sizeof( V_26 ) , V_22 ) ;
if ( V_22 )
F_78 ( V_22 ) ;
F_83 ( V_351 , V_6 , F_279 ,
V_6 ) ;
}
void F_282 ( struct V_5 * V_6 , T_8 * V_204 ,
T_1 V_365 , T_1 V_346 , T_1 V_24 )
{
T_1 V_587 = F_156 ( V_365 , V_346 ) ;
struct V_357 * V_141 ;
struct V_358 V_29 ;
struct V_129 * V_23 ;
F_83 ( V_351 , V_6 , F_279 ,
...
return;
if ( V_141 -> V_342 . type != V_587 )
return;
F_76 ( & V_29 . V_342 . V_204 , V_204 ) ;
V_29 . V_342 . type = V_587 ;
F_13 ( V_23 -> V_22 , V_23 -> V_18 , V_359 ,
F_1 ( V_24 ) , & V_29 , sizeof( V_29 ) ) ;
F_86 ( V_23 ) ;
}
void F_283 ( struct V_5 * V_6 , T_8 * V_204 , T_1 V_365 ,
T_1 V_346 , T_1 V_24 )
{
struct V_662 V_26 ;
if ( F_280 ( V_6 ) && F_90 ( V_6 ) == 1 ) {
...
void F_284 ( struct V_5 * V_6 , T_8 * V_204 , T_1 V_664 )
{
struct V_665 V_26 ;
F_76 ( & V_26 . V_342 . V_204 , V_204 ) ;
V_26 . V_342 . type = V_343 ;
V_26 . V_664 = V_664 ;
F_3 ( V_666 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
void F_285 ( struct V_5 * V_6 , T_8 * V_204 ,
T_1 V_24 )
{
struct V_129 * V_23 ;
struct V_667 V_29 ;
...
void F_286 ( struct V_5 * V_6 , T_8 * V_204 ,
T_1 V_24 )
{
struct V_129 * V_23 ;
struct V_667 V_29 ;
...
V_26 . V_342 . type = F_156 ( V_365 , V_346 ) ;
V_26 . V_669 = V_669 ;
V_26 . V_668 = F_28 ( V_668 ) ;
return F_3 ( V_671 , V_6 , & V_26 , sizeof( V_26 ) ,
NULL ) ;
}
...
F_76 ( & V_26 . V_342 . V_204 , V_204 ) ;
V_26 . V_342 . type = F_156 ( V_365 , V_346 ) ;
return F_3 ( V_673 , V_6 , & V_26 , sizeof( V_26 ) ,
NULL ) ;
}
static int F_289 ( struct V_5 * V_6 , T_8 * V_204 ,
T_1 V_365 , T_1 V_346 , T_1 V_24 ,
T_1 V_17 )
{
struct V_129 * V_23 ;
...
return - V_448 ;
F_76 ( & V_29 . V_342 . V_204 , V_204 ) ;
V_29 . V_342 . type = F_156 ( V_365 , V_346 ) ;
...
T_1 V_365 , T_1 V_346 , T_1 V_24 )
{
return F_289 ( V_6 , V_204 , V_365 , V_346 ,
V_24 , V_415 ) ;
}
...
int F_292 ( struct V_5 * V_6 , T_8 * V_204 ,
T_1 V_365 , T_1 V_346 , T_1 V_24 )
{
return F_289 ( V_6 , V_204 , V_365 , V_346 ,
V_24 , V_421 ) ;
}
int F_293 ( struct V_5 * V_6 , T_8 * V_204 ,
T_1 V_365 , T_1 V_346 , T_1 V_24 )
{
return F_289 ( V_6 , V_204 , V_365 , V_346 ,
V_24 ,
...
int F_294 ( struct V_5 * V_6 , T_8 * V_204 ,
...
F_76 ( & V_26 . V_342 . V_204 , V_204 ) ;
V_26 . V_342 . type = F_156 ( V_365 , V_346 ) ;
V_26 . V_410 = F_277 ( V_410 ) ;
V_26 . V_675 = V_675 ;
return F_3 ( V_677 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
void F_295 ( struct V_227 * V_228 , T_1 V_1 )
{
struct V_678 V_26 ;
struct V_129 * V_23 ;
T_1 V_24 = F_1 ( V_1 ) ;
F_76 ( & V_26 . V_342 . V_204 , & V_228 -> V_247 ) ;
V_26 . V_342 . type = F_156 ( V_228 -> type , V_228 -> V_372 ) ;
V_26 . V_24 = V_24 ;
V_23 = F_161 ( V_228 ) ;
F_3 ( V_679 , V_228 -> V_6 , & V_26 , sizeof( V_26 ) ,
V_23 ? V_23 -> V_22 : NULL ) ;
if ( V_23 )
F_162 ( V_23 , V_24 ) ;
}
void F_296 ( struct V_5 * V_6 , T_1 V_24 )
{
struct V_262 V_263 = { NULL , V_6 } ;
bool V_267 ;
if ( V_24 ) {
...
static void F_297 ( struct V_138 * V_139 )
{
struct V_5 * V_6 = V_139 -> V_6 ;
struct V_170 V_141 ;
if ( ! F_58 ( V_6 ) )
...
void F_298 ( struct V_5 * V_6 , T_1 V_181 , T_1 V_24 )
{
struct V_262 V_263 = { NULL , V_6 } ;
struct V_138 V_139 ;
bool V_267 = false ;
...
void F_299 ( struct V_5 * V_6 , T_1 V_181 , T_1 V_24 )
{
struct V_262 V_263 = { NULL , V_6 } ;
bool V_267 = false ;
if ( V_24 ) {
...
static void F_300 ( struct V_129 * V_23 , void * V_7 )
{
struct V_262 * V_263 = V_7 ;
if ( V_263 -> V_22 == NULL ) {
V_263 -> V_22 = V_23 -> V_22 ;
...
void F_301 ( struct V_5 * V_6 , T_1 * V_178 ,
T_1 V_24 )
{
struct V_262 V_263 = { NULL , V_6 , F_1 (status) } ;
F_83 ( V_320 , V_6 , F_300 , & V_263 ) ;
F_83 ( V_318 , V_6 , F_300 , & V_263 ) ;
F_83 ( V_319 , V_6 , F_300 , & V_263 ) ;
if ( ! V_24 )
F_3 ( V_632 , V_6 , V_178 , 3 ,
NULL ) ;
if ( V_263 . V_22 )
F_78 ( V_263 . V_22 ) ;
}
void F_302 ( struct V_5 * V_6 , T_1 * V_77 , T_1 V_24 )
{
struct V_427 V_26 ;
struct V_129 * V_23 ;
if ( V_24 )
return;
memset ( & V_26 , 0 , sizeof( V_26 ) ) ;
memcpy ( V_26 . V_77 , V_77 , V_680 ) ;
memcpy ( V_26 . V_207 , V_6 -> V_207 , V_681 ) ;
V_23 = F_45 ( V_428 , V_6 ) ;
if ( ! V_23 ) {
...
void F_303 ( struct V_5 * V_6 , T_1 * V_440 ,
T_1 * V_441 , T_1 * V_442 ,
T_1 * V_443 , T_1 V_24 )
{
struct V_129 * V_23 ;
...
void F_304 ( struct V_5 * V_6 , T_8 * V_204 , T_1 V_365 ,
T_1 V_346 , T_1 * V_178 , T_10 V_539 , T_6 V_153 ,
T_1 * V_172 , T_2 V_655 , T_1 * V_684 , T_1 V_685 )
{
char V_610 [ 512 ] ;
struct V_686 * V_26 = ( void * ) V_610 ;
T_3 V_687 ;
if ( ! F_201 ( V_6 ) ) {
if ( V_365 == V_245 )
return;
if ( V_365 == V_186 && F_120 ( & V_6 -> V_626 ) )
return;
}
if ( sizeof( * V_26 ) + V_655 + V_685 + 5 > sizeof( V_610 ) )
return;
...
if ( V_655 > 0 )
memcpy ( V_26 -> V_172 , V_172 , V_655 ) ;
if ( V_178 && ! F_305 ( V_26 -> V_172 , V_655 , V_657 ) )
V_655 = F_275 ( V_26 -> V_172 , V_655 , V_657 ,
V_178 , 3 ) ;
if ( V_685 > 0 )
memcpy ( V_26 -> V_172 + V_655 , V_684 , V_685 ) ;
V_26 -> V_655 = F_6 ( V_655 + V_685 ) ;
V_687 = sizeof( * V_26 ) + V_655 + V_685 ;
F_3 ( V_688 , V_6 , V_26 , V_687 , NULL ) ;
}
void F_306 ( struct V_5 * V_6 , T_8 * V_204 , T_1 V_365 ,
T_1 V_346 , T_10 V_539 , T_1 * V_77 , T_1 V_132 )
{
struct V_686 * V_26 ;
char V_610 [ sizeof( * V_26 ) + V_680 + 2 ] ;
T_2 V_655 ;
V_26 = (struct V_686 * ) V_610 ;
memset ( V_610 , 0 , sizeof( V_610 ) ) ;
F_76 ( & V_26 -> V_342 . V_204 , V_204 ) ;
V_26 -> V_342 . type = F_156 ( V_365 , V_346 ) ;
V_26 -> V_539 = V_539 ;
V_655 = F_275 ( V_26 -> V_172 , 0 , V_137 , V_77 ,
V_132 ) ;
V_26 -> V_655 = F_6 ( V_655 ) ;
F_3 ( V_688 , V_6 , V_26 , sizeof( * V_26 ) + V_655 , NULL ) ;
}
void F_307 ( struct V_5 * V_6 , T_1 V_689 )
{
struct V_690 V_26 ;
struct V_129 * V_23 ;
F_11 ( L_42 , V_6 -> V_77 , V_689 ) ;
if ( V_689 )
V_23 = F_45 ( V_447 , V_6 ) ;
else
V_23 = F_45 ( V_474 , V_6 ) ;
...
V_26 . V_689 = V_689 ;
F_3 ( V_691 , V_6 , & V_26 , sizeof( V_26 ) , NULL ) ;
}
static void F_308 ( struct V_5 * V_6 , T_1 V_24 )
{
F_11 ( L_30 , V_6 -> V_77 , V_24 ) ;
}
