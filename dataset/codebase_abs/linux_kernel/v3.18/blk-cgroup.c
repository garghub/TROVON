...
static int F_100 ( struct V_54 * V_29 ,
struct V_101 * V_102 )
{
struct V_103 * V_104 ;
struct V_105 * V_106 ;
...
F_110 (blkg, &q->blkg_list, q_node)
V_76 ++ ;
F_55 ( V_2 -> V_26 ) ;
while ( V_76 -- ) {
V_11 = F_7 ( V_4 -> V_21 , V_97 , V_2 -> V_15 ) ;
if ( ! V_11 ) {
V_28 = - V_33 ;
goto V_111;
}
F_111 ( & V_11 -> V_112 , & V_108 ) ;
}
F_53 ( V_2 -> V_26 ) ;
F_110 (blkg, &q->blkg_list, q_node) {
if ( F_112 ( F_38 ( & V_108 ) ) ) {
...
V_11 = F_113 ( & V_108 , struct V_20 , V_112 ) ;
F_41 ( & V_11 -> V_112 ) ;
F_25 ( & V_8 -> V_13 -> V_37 ) ;
...
{
int V_9 , V_28 ;
if ( F_112 ( V_4 -> V_21 < sizeof( struct V_20 ) ) )
return - V_30 ;
F_120 ( & V_57 ) ;
V_28 = - V_113 ;
for ( V_9 = 0 ; V_9 < V_10 ; V_9 ++ )
