...
static T_2 F_30 ( struct V_1 * V_4 , T_2 * V_60 )
{
T_2 V_61 [ V_62 ] ;
T_2 V_63 [ V_62 ] ;
T_2 V_64 = 0 ;
T_2 V_65 [ V_62 ] , V_66 = 0 ;
int V_8 , V_50 , V_12 = 0 ;
switch ( V_4 -> V_16 ) {
case V_17 :
V_12 = V_28 ;
...
for ( V_50 = 0 ; V_50 < F_11 ( V_4 ) ; V_50 ++ ) {
V_65 [ V_50 ] = ( V_61 [ V_50 ] ^ V_63 [ V_50 ] ) & V_4 -> V_45 [ V_50 ] ;
V_66 += V_65 [ V_50 ] ;
}
if ( ! V_66 )
return 0 ;
...
{
struct V_76 * V_13 = V_4 -> V_13 ;
if ( V_75 != - 1 && ( V_74 -> V_77 & V_78 ) )
F_39 ( & V_13 -> V_14 , L_6 ) ;
return 0 ;
}
static int F_40 ( struct V_1 * V_4 , T_1 V_85 )
{
int V_8 ;
T_2 V_6 [ V_62 ] ;
...
static int F_41 ( struct V_1 * V_4 , T_1 V_85 )
{
int V_8 ;
T_2 V_6 [ V_62 ] ;
...
static int F_42 ( struct V_76 * V_13 ,
const struct V_73 * V_74 )
{
struct V_90 * V_91 ;
struct V_1 * V_4 ;
...
V_4 -> V_13 = V_13 ;
V_4 -> V_16 = V_74 -> V_77 & ( V_17 | V_19 ) ;
F_35 ( & V_4 -> V_21 ) ;
F_22 ( V_4 , V_74 -> V_77 & V_95 ) ;
if ( V_4 -> V_16 == V_17 )
V_8 = F_40 ( V_4 , V_85 ) ;
else
V_8 = F_41 ( V_4 , V_85 ) ;
...
if ( V_8 )
return V_8 ;
V_8 = F_34 ( V_4 , V_74 , V_75 ) ;
if ( V_8 )
return V_8 ;
if ( V_91 && V_91 -> V_96 ) {
V_8 = V_91 -> V_96 ( V_13 , V_4 -> V_2 . V_36 ,
V_4 -> V_2 . V_10 , V_91 -> V_97 ) ;
if ( V_8 < 0 )
F_39 ( & V_13 -> V_14 , L_7 , V_8 ) ;
}
F_46 ( V_13 , V_4 ) ;
return 0 ;
}
...
{
struct V_90 * V_91 = F_44 ( & V_13 -> V_14 ) ;
struct V_1 * V_4 = F_48 ( V_13 ) ;
int V_8 = 0 ;
if ( V_91 && V_91 -> V_98 ) {
V_8 = V_91 -> V_98 ( V_13 , V_4 -> V_2 . V_36 ,
V_4 -> V_2 . V_10 , V_91 -> V_97 ) ;
if ( V_8 < 0 ) {
F_6 ( & V_13 -> V_14 , L_8 ,
L_9 , V_8 ) ;
