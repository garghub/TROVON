...
struct V_36 * V_37 = F_52 ( V_43 , struct V_36 , V_43 ) ;
unsigned long V_38 ;
if ( V_1 -> V_75 == NULL ) {
F_21 ( V_43 , V_48 ) ;
return;
...
F_13 ( & V_1 -> V_40 , V_38 ) ;
F_53 ( & V_37 -> V_42 , & V_1 -> V_41 ) ;
F_15 ( & V_1 -> V_40 , V_38 ) ;
}
static int F_54 ( struct V_120 * V_121 , unsigned int V_128 )
{
struct V_1 * V_1 = F_50 ( V_121 ) ;
if ( V_1 -> V_75 == NULL )
return - V_58 ;
...
{
struct V_1 * V_1 = F_52 ( V_130 , struct V_1 , V_130 ) ;
F_57 ( & V_1 -> V_130 ) ;
F_58 ( & V_1 -> V_131 ) ;
F_32 ( V_1 ) ;
}
...
V_1 -> V_130 . V_148 = F_56 ;
V_4 = F_64 ( V_1 -> V_62 , & V_1 -> V_130 ) ;
if ( V_4 < 0 ) {
F_24 ( V_1 -> V_62 , L_8 ) ;
goto V_149;
}
