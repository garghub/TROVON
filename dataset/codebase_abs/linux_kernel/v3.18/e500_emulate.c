...
#ifdef F_32
case V_88 :
V_10 -> V_12 . V_89 [ V_90 ] = V_55 ;
break;
case V_91 :
V_10 -> V_12 . V_89 [ V_92 ] = V_55 ;
break;
case V_93 :
V_10 -> V_12 . V_89 [ V_94 ] = V_55 ;
break;
#endif
#ifdef F_33
case V_88 :
V_10 -> V_12 . V_89 [ V_95 ] = V_55 ;
break;
case V_91 :
V_10 -> V_12 . V_89 [ V_96 ] = V_55 ;
break;
#endif
case V_97 :
V_10 -> V_12 . V_89 [ V_98 ] = V_55 ;
break;
#ifdef F_29
case V_99 :
V_10 -> V_12 . V_89 [ V_6 ] = V_55 ;
break;
case V_100 :
V_10 -> V_12 . V_89 [ V_8 ] = V_55 ;
break;
#endif
default:
V_28 = F_34 ( V_10 , V_54 , V_55 ) ;
}
return V_28 ;
}
int F_35 ( struct V_9 * V_10 , int V_54 , T_1 * V_55 )
{
struct V_38 * V_39 = F_13 ( V_10 ) ;
int V_28 = V_16 ;
switch ( V_54 ) {
...
break;
case V_66 :
* V_55 = ( V_101 ) V_10 -> V_12 . V_22 -> V_67 ;
break;
case V_69 :
...
if ( ! F_36 ( V_10 , V_108 ) )
return V_14 ;
* V_55 = V_10 -> V_12 . V_109 [ 0 ] ;
break;
case V_110 :
if ( ! F_36 ( V_10 , V_108 ) )
return V_14 ;
* V_55 = V_10 -> V_12 . V_109 [ 1 ] ;
break;
case V_74 :
* V_55 = V_39 -> V_40 ;
break;
...
break;
case V_113 :
* V_55 = V_10 -> V_12 . V_114 ;
break;
case V_115 :
if ( ! F_36 ( V_10 , V_108 ) )
return V_14 ;
* V_55 = V_10 -> V_12 . V_116 ;
break;
case V_86 :
* V_55 = V_10 -> V_12 . V_87 ;
break;
#ifdef F_32
case V_88 :
* V_55 = V_10 -> V_12 . V_89 [ V_90 ] ;
break;
case V_91 :
* V_55 = V_10 -> V_12 . V_89 [ V_92 ] ;
break;
case V_93 :
* V_55 = V_10 -> V_12 . V_89 [ V_94 ] ;
break;
#endif
#ifdef F_33
case V_88 :
* V_55 = V_10 -> V_12 . V_89 [ V_95 ] ;
break;
case V_91 :
* V_55 = V_10 -> V_12 . V_89 [ V_96 ] ;
break;
#endif
case V_97 :
* V_55 = V_10 -> V_12 . V_89 [ V_98 ] ;
break;
#ifdef F_29
case V_99 :
* V_55 = V_10 -> V_12 . V_89 [ V_6 ] ;
break;
case V_100 :
* V_55 = V_10 -> V_12 . V_89 [ V_8 ] ;
break;
#endif
default:
V_28 = F_37 ( V_10 , V_54 , V_55 ) ;
}
return V_28 ;
}
