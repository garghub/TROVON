...
V_25 -> V_78 [ V_55 ] = F_35 ( V_81 [ V_55 ] . V_85 ,
& V_25 -> V_86 -> V_55 ,
V_81 [ V_55 ] . type ,
& V_87 ,
& V_25 -> V_84 [ V_55 ] ) ;
if ( ! V_25 -> V_78 [ V_55 ] )
return - V_53 ;
if ( F_7 ( V_25 -> V_28 -> V_1 , V_81 [ V_55 ] . V_83 - 1 ,
& V_79 ) ) {
F_36 ( V_25 -> V_78 [ V_55 ] , 0 ) ;
} else {
V_79 = ! V_79 ;
F_36 ( V_25 -> V_78 [ V_55 ] , V_79 ) ;
}
V_7 = F_37 ( V_25 -> V_78 [ V_55 ] ) ;
if ( V_7 ) {
F_38 ( V_25 -> V_78 [ V_55 ] ) ;
return V_7 ;
}
...
for ( V_75 = 0 ; V_75 < V_77 ; V_75 ++ )
if ( F_17 ( V_81 [ V_75 ] . V_137 , & V_25 -> V_41 ) )
F_34 ( V_25 , V_75 ) ;
F_32 ( V_25 ) ;
F_71 ( V_25 ) ;
if ( ! F_80 () ) {
...
static int F_82 ( struct V_86 * V_129 )
{
