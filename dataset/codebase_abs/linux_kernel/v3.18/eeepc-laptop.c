...
static T_3 F_96 ( void (* F_97)( int ) , const char * V_15 , T_4 V_19 )
{
int V_20 , V_10 ;
V_20 = F_11 ( V_15 , & V_10 ) ;
if ( V_20 < 0 )
...
V_124 -> V_18 . V_129 = & V_8 -> V_33 -> V_18 ;
...
static void F_126 ( struct V_134 * V_17 , T_5 V_70 )
{
struct V_7 * V_8 = F_127 ( V_17 ) ;
T_7 V_19 ;
if ( V_70 > V_135 )
return;
V_19 = V_8 -> V_136 [ V_70 % 128 ] ++ ;
F_128 ( V_17 -> V_137 . V_138 ,
F_129 ( & V_17 -> V_18 ) , V_70 ,
V_19 ) ;
...
static int F_138 ( struct V_134 * V_17 )
{
struct V_7 * V_8 ;
int V_6 ;
F_136 ( V_154 L_7 ) ;
...
return - V_35 ;
V_8 -> V_1 = V_17 -> V_1 ;
strcpy ( F_139 ( V_17 ) , V_155 ) ;
strcpy ( F_140 ( V_17 ) , V_156 ) ;
V_17 -> V_157 = V_8 ;
V_8 -> V_17 = V_17 ;
V_8 -> V_99 = V_99 ;
F_130 ( V_8 ) ;
...
static int F_142 ( struct V_134 * V_17 )
{
struct V_7 * V_8 = F_127 ( V_17 ) ;
F_113 ( V_8 ) ;
F_81 ( V_8 ) ;
