...
static void F_65 ( struct F_1 * V_22 )
{
F_63 ( V_22 -> V_68 ) ;
F_51 ( V_22 ) ;
}
...
{
struct F_1 * V_22 = F_67 ( V_146 , struct F_1 , V_146 ) ;
F_65 ( V_22 ) ;
}
static void F_68 ( struct F_1 * V_22 )
{
if ( F_69 ( & V_22 -> V_147 ) )
F_70 ( & V_22 -> V_146 , F_66 ) ;
}
void F_71 ( struct V_1 * V_2 , struct F_1 * V_22 )
{
V_79 V_148 = F_72 ( V_22 -> V_68 -> V_18 ) ;
F_73 ( V_148 , & V_2 -> V_149 ) ;
F_68 ( V_22 ) ;
}
bool F_74 ( struct V_1 * V_2 , struct F_1 * V_22 )
{
V_79 V_148 = F_72 ( V_22 -> V_68 -> V_18 ) ;
if ( V_148 <= V_150 &&
F_75 ( & V_2 -> V_149 ) + V_148 < V_150 ) {
F_76 ( & V_22 -> V_147 ) ;
F_77 ( V_148 , & V_2 -> V_149 ) ;
return true ;
}
return false ;
}
static struct V_137 * F_78 ( struct V_137 * V_22 )
{
struct V_21 * V_151 ;
struct V_137 * V_152 ;
int V_5 , V_70 , V_153 = V_22 -> V_18 ;
F_22 ( sizeof( struct V_21 ) !=
sizeof( struct V_23 ) ) ;
V_151 = F_61 ( V_22 -> V_144 , V_153 * sizeof( struct V_21 ) ,
V_85 ) ;
if ( ! V_151 ) {
V_5 = - V_8 ;
goto V_154;
}
V_5 = F_38 ( V_151 , V_153 , NULL , & V_70 ) ;
if ( V_5 )
goto V_155;
V_152 = V_22 ;
V_22 = F_79 ( V_152 , F_72 ( V_70 ) , 0 ) ;
if ( ! V_22 ) {
V_22 = V_152 ;
V_5 = - V_8 ;
goto V_155;
...
V_22 -> V_18 = V_70 ;
V_5 = F_38 ( V_151 , V_153 , V_22 -> V_156 , & V_70 ) ;
if ( V_5 )
goto V_155;
F_80 ( V_22 ) ;
F_51 ( V_151 ) ;
...
static struct V_137 * F_82 ( struct V_137 * V_22 )
{
int V_5 ;
V_22 -> V_157 = NULL ;
V_22 -> V_158 = false ;
...
int F_84 ( struct V_137 * * V_159 , struct V_141 * V_139 )
{
unsigned int V_140 = F_59 ( V_139 ) ;
struct V_137 * V_22 ;
if ( V_139 -> V_6 == NULL )
return - V_84 ;
V_22 = F_85 ( F_72 ( V_139 -> V_18 ) , 0 ) ;
if ( ! V_22 )
return - V_8 ;
...
void F_88 ( struct V_137 * V_22 )
{
F_63 ( V_22 ) ;
}
int F_89 ( struct V_138 * V_139 , struct V_1 * V_2 )
{
struct F_1 * V_22 , * V_152 ;
unsigned int V_140 = F_59 ( V_139 ) ;
unsigned int V_160 = F_72 ( V_139 -> V_18 ) ;
struct V_137 * V_68 ;
int V_5 ;
if ( F_3 ( V_2 , V_161 ) )
return - V_10 ;
...
if ( ! V_68 )
return - V_8 ;
if ( F_90 ( V_68 -> V_144 , V_139 -> V_6 , V_140 ) ) {
F_91 ( V_68 ) ;
return - V_162 ;
}
...
int F_98 ( struct V_1 * V_2 , struct V_21 T_4 * V_164 ,
unsigned int V_18 )
{
struct V_141 * V_139 ;
struct F_1 * V_6 ;
...
goto V_165;
V_131 = - V_162 ;
if ( F_100 ( V_164 , V_139 -> V_6 , F_59 ( V_139 ) ) )
goto V_165;
V_131 = V_139 -> V_18 ;
V_165:
F_101 ( V_2 ) ;
