...
if ( ! V_153 )
V_158 = F_104 ( V_49 , V_123 ) ;
V_150 = F_105 ( V_158 , V_151 ) ;
if ( V_151 && V_123 > 0 )
F_106 ( & V_151 -> V_73 ) ;
if ( ! V_153 )
F_100 ( V_150 ) ;
...
static struct V_37 *
F_108 ( struct V_48 * V_49 , struct V_157 * V_158 ,
...
char V_30 [ V_164 ] ;
if ( F_110 ( V_30 , V_55 , V_164 ) < V_164 ) {
F_111 () ;
F_13 ( L_1 , V_30 ) ;
F_112 () ;
V_34 = F_26 ( V_55 ) ;
...
F_116 ( F_117 ( V_126 ) , & V_170 ) ;
if ( ! F_118 ( V_49 ) )
V_126 -> V_40 |= V_171 ;
}
V_126 -> V_39 = V_39 ;
if ( ! V_34 -> V_172 || ( V_28 = V_34 -> V_172 ( V_126 , V_161 [ V_173 ] ) ) == 0 ) {
if ( F_119 ( V_126 ) ) {
V_126 -> V_174 =
F_120 ( struct V_175 ) ;
if ( ! V_126 -> V_174 )
goto V_176;
V_126 -> V_177 = F_121 ( struct V_178 ) ;
if ( ! V_126 -> V_177 )
goto V_176;
}
if ( V_161 [ V_99 ] ) {
...
if ( ( V_126 -> V_42 != V_43 ) &&
! ( V_126 -> V_40 & V_44 ) &&
( ! V_51 || ! ( V_51 -> V_40 & V_181 ) ) )
V_180 = F_123 ( V_126 ) ;
else
V_180 = F_117 ( V_126 ) ;
V_28 = F_124 ( & V_126 -> V_182 ,
V_126 -> V_174 ,
& V_126 -> V_183 ,
V_180 ,
V_161 [ V_179 ] ) ;
...
static int F_128 ( struct V_37 * V_126 , struct V_54 * * V_161 )
{
struct V_78 * V_186 , * V_82 = NULL ;
int V_28 = 0 ;
if ( V_161 [ V_173 ] ) {
if ( V_126 -> V_34 -> V_187 == NULL )
return - V_27 ;
V_28 = V_126 -> V_34 -> V_187 ( V_126 , V_161 [ V_173 ] ) ;
if ( V_28 )
return V_28 ;
}
if ( V_161 [ V_99 ] ) {
...
static int F_130 ( struct V_37 * V_3 , struct V_37 * V_51 , int V_188 )
{
struct V_189 V_190 ;
if ( V_3 -> V_34 -> V_17 == NULL )
return 0 ;
V_190 . V_191 . V_192 = V_190 . V_191 . V_193 = V_190 . V_191 . V_194 = 0 ;
V_190 . V_191 . V_195 = V_196 ;
V_190 . V_188 = V_188 ;
V_190 . V_51 = V_51 ;
V_3 -> V_34 -> V_17 -> V_22 ( V_3 , & V_190 . V_191 ) ;
return V_190 . V_191 . V_192 ? - V_197 : 0 ;
}
static int
V_196 ( struct V_37 * V_3 , unsigned long V_53 , struct V_198 * V_191 )
{
struct V_37 * V_23 ;
const struct V_18 * V_19 = V_3 -> V_34 -> V_17 ;
struct V_189 * V_190 = (struct V_189 * ) V_191 ;
V_23 = V_19 -> V_23 ( V_3 , V_53 ) ;
if ( V_23 ) {
if ( V_23 == V_190 -> V_51 || V_190 -> V_188 > 7 )
return - V_197 ;
return F_130 ( V_23 , V_190 -> V_51 , V_190 -> V_188 + 1 ) ;
}
return 0 ;
}
...
return - V_36 ;
V_28 = F_135 ( V_121 , sizeof( * V_201 ) , V_161 , V_202 , NULL ) ;
if ( V_28 < 0 )
return V_28 ;
...
V_158 = V_51 -> V_34 -> V_17 -> V_217 ( V_51 , V_201 ) ;
else if ( V_51 )
V_158 = V_51 -> V_158 ;
else
V_158 = F_104 ( V_49 , 0 ) ;
V_3 = F_108 ( V_49 , V_158 , V_51 ,
...
{
struct V_175 T_8 * V_174 = NULL ;
struct V_178 T_8 * V_177 = NULL ;
struct V_200 * V_201 ;
struct V_148 * V_221 ;
...
if ( F_144 ( V_97 , V_163 , V_3 -> V_34 -> V_10 ) )
goto V_100;
...
if ( F_146 ( & V_224 , V_174 , & V_3 -> V_182 ) < 0 ||
F_147 ( & V_224 , & V_3 -> V_182 , & V_3 -> V_183 ) < 0 ||
F_148 ( & V_224 , V_177 , & V_3 -> V_237 , V_146 ) < 0 )
goto V_100;
if ( F_149 ( & V_224 ) < 0 )
goto V_100;
...
V_28 = - V_159 ;
if ( V_19 -> V_187 )
V_28 = V_19 -> V_187 ( V_3 , V_149 , V_218 , V_161 , & V_257 ) ;
if ( V_28 == 0 )
...
static int F_163 ( struct V_37 * V_3 , unsigned long V_53 , struct V_198 * V_190 )
{
struct V_264 * V_265 = (struct V_264 * ) V_190 ;
...
V_190 . V_191 . V_195 = F_163 ;
V_190 . V_97 = V_97 ;
V_190 . V_247 = V_247 ;
V_190 . V_191 . V_192 = 0 ;
V_190 . V_191 . V_193 = V_247 -> args [ 1 ] ;
V_190 . V_191 . V_194 = 0 ;
V_3 -> V_34 -> V_17 -> V_22 ( V_3 , & V_190 . V_191 ) ;
V_247 -> args [ 1 ] = V_190 . V_191 . V_194 ;
...
V_158 = F_24 ( V_49 ) ;
if ( V_158 &&
F_165 ( V_158 -> V_50 , V_97 , V_201 , V_247 ,
& V_268 , V_267 ) < 0 )
goto V_253;
V_253:
V_247 -> args [ 0 ] = V_268 ;
...
struct V_271 * V_272 )
{
T_9 V_273 = V_97 -> V_273 ;
int V_28 ;
for (; V_270 ; V_270 = F_169 ( V_270 -> V_9 ) ) {
if ( V_270 -> V_273 != V_273 &&
V_270 -> V_273 != F_170 ( V_274 ) )
continue;
V_28 = V_270 -> V_275 ( V_97 , V_270 , V_272 ) ;
if ( V_28 >= 0 ) {
#ifdef F_171
if ( V_28 != V_276 && V_97 -> V_277 )
V_97 -> V_277 = F_172 ( V_97 -> V_277 , 0 ) ;
#endif
return V_28 ;
}
}
...
int F_173 ( struct V_96 * V_97 , const struct V_269 * V_270 ,
struct V_271 * V_272 )
{
int V_28 = 0 ;
#ifdef F_171
const struct V_269 * V_278 = V_270 ;
V_279:
#endif
V_28 = F_168 ( V_97 , V_270 , V_272 ) ;
#ifdef F_171
if ( V_28 == V_276 ) {
T_2 V_280 = F_174 ( V_97 -> V_277 ) ;
V_270 = V_278 ;
if ( V_280 ++ >= V_281 ) {
F_175 ( L_5 ,
V_270 -> V_3 -> V_34 -> V_10 ,
...
V_97 -> V_277 = F_172 ( V_97 -> V_277 , V_280 ) ;
goto V_279;
}
#endif
return V_28 ;
}
void F_177 ( struct V_269 * V_270 )
{
V_270 -> V_34 -> V_185 ( V_270 ) ;
F_14 ( V_270 -> V_34 -> V_33 ) ;
F_178 ( V_270 , V_95 ) ;
}
void F_179 ( struct V_269 T_10 * * V_284 )
{
struct V_269 * V_270 ;
while ( ( V_270 = F_127 ( * V_284 ) ) != NULL ) {
F_180 ( * V_284 , V_270 -> V_9 ) ;
F_177 ( V_270 ) ;
}
}
static int F_181 ( struct V_285 * V_219 , void * V_286 )
{
struct V_287 V_288 ;
F_182 ( V_113 , & V_288 ) ;
F_183 ( V_219 , L_6 ,
( T_2 ) V_289 , ( T_2 ) F_184 ( 1 ) ,
1000000 ,
( T_2 ) V_290 / ( T_2 ) F_185 ( F_186 ( V_288 ) ) ) ;
return 0 ;
}
static int F_187 ( struct V_291 * V_291 , struct V_292 * V_292 )
{
return F_188 ( V_292 , F_181 , NULL ) ;
}
static int T_11 F_189 ( struct V_147 * V_147 )
{
struct V_293 * V_294 ;
V_294 = F_190 ( L_7 , 0 , V_147 -> V_295 , & V_296 ) ;
if ( V_294 == NULL )
return - V_91 ;
return 0 ;
}
static void T_12 F_191 ( struct V_147 * V_147 )
{
F_192 ( L_7 , V_147 -> V_295 ) ;
}
static int T_11 F_189 ( struct V_147 * V_147 )
{
return 0 ;
...
F_1 ( & V_301 ) ;
F_1 ( & V_302 ) ;
F_196 ( V_303 , V_243 , F_137 , NULL , NULL ) ;
F_196 ( V_303 , V_210 , F_131 , NULL , NULL ) ;
F_196 ( V_303 , V_204 , F_131 , F_157 , NULL ) ;
F_196 ( V_303 , V_261 , F_160 , NULL , NULL ) ;
F_196 ( V_303 , V_262 , F_160 , NULL , NULL ) ;
F_196 ( V_303 , V_259 , F_160 , F_166 , NULL ) ;
return 0 ;
}
