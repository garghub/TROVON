...
V_2 -> V_108 = F_42 ( V_101 , V_105 ) ;
if ( V_2 -> V_108 == NULL ) {
F_40 ( V_2 -> V_7 -> V_13 , L_3 ,
V_101 ) ;
F_43 ( V_2 -> V_104 ) ;
return - V_96 ;
}
V_2 -> V_109 = F_44 ( ( void * ) V_2 -> V_108 ) ;
if ( V_2 -> V_109 == V_19 ) {
V_2 -> V_109 = F_45 ( V_2 -> V_7 -> V_12 . V_13 . V_14 ,
V_2 -> V_108 ,
V_101 ,
V_18 ) ;
V_2 -> V_110 = 1 ;
} else {
F_46 ( V_2 -> V_7 -> V_12 . V_13 . V_14 ,
V_2 -> V_109 , V_101 ,
V_18 ) ;
V_2 -> V_110 = 0 ;
}
...
static int F_47 ( struct V_6 * V_7 , unsigned char V_76 )
{
struct V_1 * V_2 = & V_7 -> V_39 [ V_76 ] ;
struct V_93 T_4 * V_94 ;
T_1 V_111 , V_112 ;
...
F_51 ( & V_7 -> V_23 , V_130 ) ;
V_134:
F_40 ( V_7 -> V_13 , L_8 , V_2 -> V_2 . V_21 ) ;
return - V_147 ;
}
...
V_173 = 0x1 ;
if ( V_173 != V_2 -> V_91 ) {
F_40 ( V_2 -> V_7 -> V_13 , L_12 ) ;
return - V_174 ;
}
V_158 = F_62 ( V_157 ) ;
if ( F_11 ( & V_2 -> V_9 ) ) {
F_40 ( V_2 -> V_7 -> V_13 , L_13 , V_2 -> V_21 ) ;
} else {
V_4 = F_12 ( V_2 -> V_9 . V_24 , struct V_3 , V_9 ) ;
...
V_227 = F_48 ( V_7 , V_27 , V_114 ) ;
if ( V_227 != 0 ) {
F_96 ( F_97 ( V_2 -> V_82 ) ) ;
F_75 ( V_7 -> V_13 , L_27 , V_2 -> V_27 ) ;
return - V_103 ;
}
F_75 ( V_7 -> V_13 , L_28 , V_2 -> V_27 ) ;
return 0 ;
}
...
F_75 ( V_7 -> V_13 , L_29 , V_226 ? V_2 -> V_2 . V_21 : NULL ) ;
return - V_103 ;
}
F_50 ( & V_7 -> V_23 , V_130 ) ;
F_10 ( V_2 , - V_20 ) ;
...
if ( V_2 -> V_32 != V_37 )
F_43 ( V_2 -> V_145 ) ;
F_75 ( V_7 -> V_13 , L_30 , V_226 -> V_21 ) ;
return 0 ;
}
static struct V_233 * F_99 ( struct V_225 * V_226 , T_6 V_234 )
{
struct V_3 * V_4 ;
V_4 = F_42 ( sizeof( * V_4 ) , V_234 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_4 . V_15 = V_19 ;
F_100 ( & V_4 -> V_9 ) ;
...
V_4 -> V_4 . V_15 = F_45 ( V_2 -> V_7 -> V_12 . V_13 . V_14 ,
V_4 -> V_4 . V_87 ,
V_4 -> V_4 . V_16 ,
F_4 ( V_2 )
? V_17 :
...
F_110 ( V_7 , V_245 ) ;
F_7 ( & V_7 -> V_23 ) ;
V_7 -> V_231 -> V_246 ( & V_7 -> V_12 ) ;
F_9 ( & V_7 -> V_23 ) ;
return 0 ;
}
static void F_112 ( struct V_6 * V_7 , T_1 V_25 , T_1 V_247 ,
T_1 V_16 )
{
V_7 -> V_248 = ( T_2 ) V_25 ;
V_7 -> V_249 = V_250 ;
...
static void F_113 ( struct V_225 * V_226 , struct V_233 * V_235 )
{
struct V_3 * V_4 = F_95 ( V_235 , struct V_3 , V_4 ) ;
V_4 -> V_4 . V_87 = NULL ;
F_43 ( V_4 ) ;
}
static void F_114 ( struct V_6 * V_7 , T_2 V_251 , T_1 V_25 ,
T_1 V_247 , T_1 V_16 )
{
T_1 V_252 = 0 ;
struct V_3 * V_4 ;
...
int V_245 = V_247 & V_116 ;
struct V_1 * V_258 = & V_7 -> V_39 [ V_245 ] ;
T_1 V_111 ;
if ( ! V_258 -> V_2 . V_114 )
goto V_259;
...
V_4 = F_95 ( F_99 ( & V_2 -> V_2 , V_261 ) ,
struct V_3 , V_4 ) ;
V_4 -> V_4 . V_16 = 2 ;
V_4 -> V_4 . V_87 = V_7 -> V_262 ;
* ( T_1 * ) V_4 -> V_4 . V_87 = F_115 ( V_252 ) ;
V_4 -> V_4 . V_5 = - V_10 ;
V_4 -> V_4 . V_22 = 0 ;
V_4 -> V_4 . V_236 = F_113 ;
V_7 -> V_42 = V_33 ;
...
struct V_263 * V_264 )
{
T_1 V_265 = F_116 ( V_264 -> V_265 ) ;
T_1 V_266 = F_116 ( V_264 -> V_266 ) ;
T_1 V_267 = F_116 ( V_264 -> V_267 ) ;
F_110 ( V_7 , 0 ) ;
if ( V_264 -> V_268 & V_33 )
V_7 -> V_42 = V_33 ;
else
...
switch ( V_264 -> V_269 ) {
case V_270 :
if ( ( V_264 -> V_268 & ( V_33 | V_271 ) )
!= ( V_33 | V_272 ) )
break;
F_114 ( V_7 , V_264 -> V_268 , V_265 , V_266 ,
V_267 ) ;
return;
case V_273 :
if ( V_264 -> V_268 != ( V_37 | V_272 |
V_254 ) )
break;
F_112 ( V_7 , V_265 , V_266 , V_267 ) ;
return;
case V_274 :
case V_275 :
...
V_7 -> V_276 = 0 ;
if ( V_7 -> V_231 -> V_279 )
V_7 -> V_231 -> V_279 ( & V_7 -> V_12 ) ;
}
static void F_119 ( struct V_6 * V_7 )
{
T_2 V_280 ;
V_280 = F_120 ( & V_7 -> V_28 -> V_281 ) ;
if ( V_280 & V_282 ) {
if ( ( V_7 -> V_249 ) != V_277 )
F_117 ( V_7 ) ;
} else {
...
int V_63 , V_285 = 0 ;
if ( ( V_7 -> V_249 == V_250 )
&& ( F_120 ( & V_7 -> V_28 -> V_284 ) == 0 ) )
F_28 ( & V_7 -> V_28 -> V_284 , V_7 -> V_248 ) ;
for ( V_63 = ( V_175 - 1 ) ; ( ( V_63 >= 0 ) && ( V_285 == 0 ) ) ; V_63 -- ) {
V_2 = & V_7 -> V_39 [ V_63 ] ;
...
static T_7 F_126 ( int V_286 , void * V_287 )
{
...
unsigned long V_130 ;
F_50 ( & V_7 -> V_23 , V_130 ) ;
V_288 = F_14 ( & V_7 -> V_28 -> V_51 ) &
F_14 ( & V_7 -> V_28 -> V_46 ) ;
F_15 ( & V_7 -> V_28 -> V_51 , V_288 ) ;
if ( V_288 & V_290 ) {
F_119 ( V_7 ) ;
V_288 &= ~ V_290 ;
V_5 = V_291 ;
...
static int F_127 ( struct V_242 * V_12 ,
struct V_293 * V_231 )
{
struct V_6 * V_7 ;
unsigned long V_130 ;
...
F_50 ( & V_7 -> V_23 , V_130 ) ;
V_231 -> V_231 . V_294 = NULL ;
V_7 -> V_231 = V_231 ;
V_7 -> V_12 . V_135 = V_231 -> V_295 ;
F_52 ( V_7 ) ;
F_15 ( & V_7 -> V_28 -> V_51 , 0xffff ) ;
F_15 ( & V_7 -> V_28 -> V_46 , V_296 ) ;
V_7 -> V_249 = V_297 ;
V_7 -> V_40 = V_41 ;
V_7 -> V_42 = V_37 ;
F_51 ( & V_7 -> V_23 , V_130 ) ;
F_128 ( V_7 -> V_13 , L_38 , V_7 -> V_12 . V_21 ,
V_231 -> V_231 . V_21 ) ;
return 0 ;
}
...
static struct V_6 * F_130 ( struct V_299 * V_300 )
{
struct V_6 * V_7 ;
...
T_8 V_101 ;
T_3 V_306 ;
V_7 = F_42 ( sizeof( * V_7 ) , V_261 ) ;
if ( V_7 == NULL ) {
F_40 ( & V_300 -> V_13 , L_40 ) ;
goto V_307;
}
V_7 -> V_13 = & V_300 -> V_13 ;
V_306 = * F_131 ( V_302 , 1 , & V_101 , NULL ) ;
V_7 -> V_243 = F_37 ( V_306 ) ;
...
goto V_307;
for ( V_63 = 0 ; V_63 < V_175 ; V_63 ++ ) {
F_15 ( & V_305 -> V_310 [ V_63 ] , ( T_1 ) V_92 ) ;
...
V_314 = V_7 -> V_28 ;
F_28 ( & V_314 -> V_148 , 0x01 ) ;
F_28 ( & V_314 -> V_148 , 0x00 ) ;
F_15 ( & V_314 -> V_46 , 0 ) ;
F_28 ( & V_314 -> V_64 , 0 ) ;
F_15 ( & V_314 -> V_51 , V_315 ) ;
return 0 ;
}
...
F_100 ( & V_2 -> V_9 ) ;
if ( V_76 != 0 )
F_104 ( & V_2 -> V_2 . V_318 , & V_7 -> V_12 . V_318 ) ;
V_2 -> V_12 = & V_7 -> V_12 ;
return 0 ;
}
static void F_137 ( struct V_319 * V_13 )
{
...
unsigned int V_63 ;
const void * V_322 ;
V_321 = F_139 ( V_323 , & V_300 -> V_13 ) ;
if ( ! V_321 )
return - V_103 ;
V_322 = F_140 ( V_302 , L_41 , NULL ) ;
if ( ! V_322 || strcmp ( V_322 , L_42 ) )
return - V_147 ;
V_7 = F_130 ( V_300 ) ;
if ( ! V_7 ) {
F_40 ( & V_300 -> V_13 , L_43 ) ;
return - V_96 ;
}
V_7 -> V_53 = ( unsigned long ) V_321 -> V_162 ;
V_7 -> V_28 = F_141 ( V_302 , 0 ) ;
if ( ! V_7 -> V_28 ) {
V_237 = - V_96 ;
goto V_324;
}
...
V_7 -> V_12 . V_326 = & V_7 -> V_39 [ 0 ] . V_2 ;
F_100 ( & V_7 -> V_12 . V_318 ) ;
V_7 -> V_12 . V_135 = V_232 ;
V_7 -> V_12 . V_21 = V_327 ;
...
V_237 = F_48 ( V_7 , 0 , & V_328 ) ;
if ( V_237 )
goto V_329;
V_7 -> V_190 = F_142 ( & V_300 -> V_13 , 256 , V_261 ) ;
if ( V_7 -> V_190 == NULL ) {
F_40 ( V_7 -> V_13 , L_44 ) ;
V_237 = - V_96 ;
goto V_330;
}
V_7 -> V_262 = F_142 ( & V_300 -> V_13 , 2 , V_261 ) ;
if ( V_7 -> V_262 == NULL ) {
V_237 = - V_96 ;
goto V_330;
}
V_7 -> V_331 = F_44 ( ( void * ) V_7 -> V_190 ) ;
if ( V_7 -> V_331 == V_19 ) {
V_7 -> V_331 = F_45 (
V_7 -> V_12 . V_13 . V_14 ,
V_7 -> V_190 ,
...
F_46 ( V_7 -> V_12 . V_13 . V_14 ,
V_7 -> V_331 , 256 ,
V_17 ) ;
}
F_143 ( & V_7 -> V_182 , F_74 ,
( unsigned long ) V_7 ) ;
V_7 -> V_333 = F_144 ( V_302 , 0 ) ;
if ( ! V_7 -> V_333 ) {
V_237 = - V_103 ;
goto V_334;
}
V_237 = F_145 ( V_7 -> V_333 , F_126 , 0 ,
V_327 , V_7 ) ;
if ( V_237 ) {
F_40 ( V_7 -> V_13 , L_45 ,
V_7 -> V_333 , V_237 ) ;
...
static int F_151 ( struct V_299 * V_13 , T_9 V_43 )
{
return - V_338 ;
}
static int F_152 ( struct V_299 * V_13 )
{
return - V_338 ;
}
static int F_153 ( struct V_299 * V_300 )
{
struct V_6 * V_7 = F_154 ( V_300 ) ;
struct V_1 * V_2 ;
unsigned int V_101 ;
F_155 ( F_1 ) ;
F_156 ( & V_7 -> V_12 ) ;
