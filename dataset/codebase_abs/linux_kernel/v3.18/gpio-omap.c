...
static int F_90 ( struct V_1 * V_2 , struct V_84 * V_122 )
{
int V_123 ;
static int V_9 ;
int V_124 = 0 ;
...
V_125 = F_91 ( & V_2 -> V_4 ) ;
if ( V_125 ) {
F_45 ( V_2 -> V_61 , L_9 , V_125 ) ;
return V_125 ;
}
#ifdef F_32
V_124 = F_92 ( - 1 , 0 , V_2 -> V_71 , 0 ) ;
if ( V_124 < 0 ) {
F_45 ( V_2 -> V_61 , L_10 ) ;
return - V_134 ;
}
#endif
V_125 = F_93 ( & V_2 -> V_4 , V_122 ,
V_124 , F_51 ,
V_77 ) ;
if ( V_125 ) {
F_45 ( V_2 -> V_61 , L_11 , V_125 ) ;
F_94 ( & V_2 -> V_4 ) ;
return - V_134 ;
}
F_95 ( & V_2 -> V_4 , V_122 ,
...
int V_62 = F_59 ( V_2 -> V_4 . V_88 , V_123 ) ;
if ( V_2 -> V_104 ) {
...
V_122 = F_102 ( V_61 , sizeof( * V_122 ) , V_146 ) ;
if ( ! V_122 )
return - V_147 ;
V_122 -> V_148 = F_60 ,
V_122 -> V_149 = F_62 ,
...
V_122 -> V_116 = F_30 ,
V_122 -> V_117 = F_47 ,
V_122 -> V_150 = F_103 ( & V_92 -> V_61 ) ;
V_143 = F_104 ( V_92 , V_151 , 0 ) ;
if ( F_105 ( ! V_143 ) ) {
F_45 ( V_61 , L_13 ) ;
return - V_134 ;
}
V_2 -> V_62 = V_143 -> V_152 ;
V_2 -> V_61 = V_61 ;
V_2 -> V_4 . V_61 = V_61 ;
V_2 -> V_32 = V_141 -> V_32 ;
V_2 -> V_95 = V_141 -> V_153 ;
V_2 -> V_71 = V_141 -> V_154 ;
V_2 -> V_104 = V_141 -> V_104 ;
V_2 -> V_42 = V_141 -> V_42 ;
V_2 -> V_13 = V_141 -> V_13 ;
#ifdef F_106
V_2 -> V_4 . V_137 = F_107 ( V_136 ) ;
#endif
if ( V_136 ) {
if ( ! F_108 ( V_136 , L_14 ) )
V_2 -> V_155 = true ;
} else {
V_2 -> V_155 = V_141 -> V_155 ;
if ( V_2 -> V_155 )
V_2 -> V_156 =
V_141 -> V_156 ;
}
...
V_2 -> V_18 = F_11 ;
F_109 ( & V_2 -> V_65 ) ;
V_143 = F_104 ( V_92 , V_157 , 0 ) ;
V_2 -> V_5 = F_110 ( V_61 , V_143 ) ;
if ( F_85 ( V_2 -> V_5 ) ) {
F_111 ( V_2 -> V_4 . V_88 ) ;
...
F_70 ( V_2 ) ;
F_83 ( V_2 ) ;
V_125 = F_90 ( V_2 , V_122 ) ;
if ( V_125 )
return V_125 ;
F_80 ( V_2 ) ;
F_50 ( V_2 -> V_61 ) ;
F_115 ( & V_2 -> V_136 , & V_158 ) ;
return 0 ;
}
...
T_2 V_161 , V_162 ;
F_34 ( & V_2 -> V_65 , V_60 ) ;
V_161 = V_2 -> V_15 . V_34 & V_2 -> V_15 . V_44 ;
if ( V_161 )
F_8 ( V_161 | V_2 -> V_15 . V_40 ,
V_2 -> V_5 + V_2 -> V_13 -> V_40 ) ;
V_162 = V_2 -> V_15 . V_36 & V_2 -> V_15 . V_44 ;
if ( V_162 )
F_8 ( V_162 | V_2 -> V_15 . V_38 ,
...
V_2 -> V_166 = F_6 ( V_2 -> V_5 +
V_2 -> V_13 -> V_23 ) ;
V_159 = V_2 -> V_15 . V_40 ;
V_160 = V_2 -> V_15 . V_38 ;
V_159 &= ~ V_2 -> V_47 ;
V_160 &= ~ V_2 -> V_47 ;
F_8 ( V_159 , V_2 -> V_5 + V_2 -> V_13 -> V_40 ) ;
F_8 ( V_160 , V_2 -> V_5 + V_2 -> V_13 -> V_38 ) ;
V_2 -> V_167 = true ;
V_163:
if ( V_2 -> V_156 )
V_2 -> V_168 =
...
static int F_117 ( struct V_90 * V_61 )
{
struct V_91 * V_92 = F_67 ( V_61 ) ;
struct V_1 * V_2 = F_68 ( V_92 ) ;
T_2 V_12 = 0 , V_169 , V_170 , V_171 ;
unsigned long V_60 ;
int V_172 ;
F_34 ( & V_2 -> V_65 , V_60 ) ;
if ( V_2 -> V_155 && ! V_2 -> V_173 ) {
F_118 ( V_2 ) ;
if ( V_2 -> V_156 )
V_2 -> V_168 =
V_2 -> V_156 ( V_2 -> V_61 ) ;
...
V_170 &= V_2 -> V_166 ;
V_171 = V_12 & V_2 -> V_15 . V_38 ;
V_171 &= ~ ( V_2 -> V_166 ) ;
V_169 = V_12 & ( ~ ( V_2 -> V_15 . V_40 ) &
~ ( V_2 -> V_15 . V_38 ) ) ;
V_169 |= V_170 | V_171 ;
if ( V_169 ) {
T_2 V_174 , V_175 ;
V_174 = F_6 ( V_2 -> V_5 + V_2 -> V_13 -> V_34 ) ;
V_175 = F_6 ( V_2 -> V_5 + V_2 -> V_13 -> V_36 ) ;
if ( ! V_2 -> V_13 -> V_176 ) {
F_8 ( V_174 | V_169 , V_2 -> V_5 +
V_2 -> V_13 -> V_34 ) ;
F_8 ( V_175 | V_169 , V_2 -> V_5 +
V_2 -> V_13 -> V_36 ) ;
}
if ( V_2 -> V_13 -> V_176 ) {
F_8 ( V_174 | V_12 , V_2 -> V_5 +
V_2 -> V_13 -> V_34 ) ;
F_8 ( V_175 | V_12 , V_2 -> V_5 +
V_2 -> V_13 -> V_36 ) ;
}
F_8 ( V_174 , V_2 -> V_5 + V_2 -> V_13 -> V_34 ) ;
F_8 ( V_175 , V_2 -> V_5 + V_2 -> V_13 -> V_36 ) ;
}
V_2 -> V_167 = false ;
F_36 ( & V_2 -> V_65 , V_60 ) ;
return 0 ;
}
void F_120 ( int V_177 )
{
struct V_1 * V_2 ;
F_121 (bank, &omap_gpio_list, node) {
if ( ! F_26 ( V_2 ) || ! V_2 -> V_155 )
continue;
V_2 -> V_164 = V_177 ;
F_122 ( V_2 -> V_61 ) ;
}
...
{
struct V_179 * V_13 = V_178 -> V_13 ;
void T_1 * V_5 = V_178 -> V_5 ;
V_178 -> V_15 . V_55 = F_6 ( V_5 + V_13 -> V_55 ) ;
V_178 -> V_15 . V_16 = F_6 ( V_5 + V_13 -> V_14 ) ;
V_178 -> V_15 . V_44 = F_6 ( V_5 + V_13 -> V_43 ) ;
V_178 -> V_15 . V_34 = F_6 ( V_5 + V_13 -> V_34 ) ;
V_178 -> V_15 . V_36 = F_6 ( V_5 + V_13 -> V_36 ) ;
V_178 -> V_15 . V_38 = F_6 ( V_5 + V_13 -> V_38 ) ;
V_178 -> V_15 . V_40 = F_6 ( V_5 + V_13 -> V_40 ) ;
V_178 -> V_15 . V_75 = F_6 ( V_5 + V_13 -> V_72 ) ;
V_178 -> V_15 . V_180 = F_6 ( V_5 + V_13 -> V_180 ) ;
if ( V_13 -> V_18 && V_178 -> V_13 -> V_20 )
V_178 -> V_15 . V_19 = F_6 ( V_5 + V_13 -> V_18 ) ;
else
V_178 -> V_15 . V_19 = F_6 ( V_5 + V_13 -> V_19 ) ;
V_178 -> V_173 = true ;
}
...
F_8 ( V_2 -> V_15 . V_180 ,
V_2 -> V_5 + V_2 -> V_13 -> V_180 ) ;
}
static inline void F_118 ( struct V_1 * V_178 ) {}
