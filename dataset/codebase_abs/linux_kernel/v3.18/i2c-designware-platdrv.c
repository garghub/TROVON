...
V_2 -> V_33 = F_31 ( ( V_75 ) V_74 * V_48 + 500000 ,
1000000 ) ;
}
if ( ! V_2 -> V_27 ) {
T_1 V_76 = F_32 ( V_2 ) ;
...
return V_46 ;
F_34 ( V_2 ) ;
V_46 = F_35 ( & V_5 -> V_2 , V_2 -> V_45 , V_77 , V_78 ,
V_5 -> V_79 , V_2 ) ;
if ( V_46 ) {
...
static int F_49 ( struct V_87 * V_2 )
{
struct V_4 * V_5 = F_50 ( V_2 ) ;
struct V_1 * V_88 = F_9 ( V_5 ) ;
F_46 ( V_88 ) ;
F_51 ( V_88 -> V_3 ) ;
return 0 ;
}
static int F_52 ( struct V_87 * V_2 )
{
struct V_4 * V_5 = F_50 ( V_2 ) ;
struct V_1 * V_88 = F_9 ( V_5 ) ;
F_30 ( V_88 -> V_3 ) ;
