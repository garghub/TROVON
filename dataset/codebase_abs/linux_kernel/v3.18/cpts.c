...
if ( V_75 -> V_92 + V_87 < V_80 + V_93 + sizeof( * V_79 ) )
return 0 ;
if ( F_41 ( V_76 & V_94 ) )
V_81 = V_82 + V_80 + V_95 ;
else
V_81 = V_82 + V_80 ;
V_79 = ( T_6 * ) ( V_82 + V_80 + V_93 ) ;
return ( V_78 == ( * V_81 & 0xf ) && V_77 == F_42 ( * V_79 ) ) ;
}
static T_3 F_43 ( struct V_8 * V_8 , struct V_74 * V_75 , int V_96 )
{
T_3 V_55 = 0 ;
struct V_1 * V_2 ;
struct V_34 * V_35 , * V_36 ;
unsigned int V_97 = F_44 ( V_75 ) ;
unsigned long V_46 ;
T_6 V_79 ;
T_7 V_98 ;
if ( V_97 == V_99 )
...
V_98 = ( V_2 -> V_5 >> V_100 ) & V_101 ;
V_79 = ( V_2 -> V_5 >> V_102 ) & V_103 ;
if ( V_96 == F_3 ( V_2 ) &&
F_39 ( V_75 , V_97 , V_79 , V_98 ) ) {
...
V_105 -> V_107 = F_48 ( V_55 ) ;
}
void F_49 ( struct V_8 * V_8 , struct V_74 * V_75 )
{
T_3 V_55 ;
struct V_104 V_105 ;
if ( ! ( F_50 ( V_75 ) -> V_108 & V_109 ) )
return;
...
if ( F_34 ( V_8 -> clock ) ) {
V_111 = F_55 ( V_8 -> clock ) ;
V_8 -> clock = NULL ;
return V_111 ;
}
F_56 ( & V_8 -> V_49 ) ;
V_8 -> V_32 . V_113 = F_13 ;
V_8 -> V_32 . V_114 = F_57 ( 32 ) ;
V_8 -> V_48 = V_44 ;
V_8 -> V_32 . V_44 = V_44 ;
V_8 -> V_32 . V_110 = V_110 ;
F_58 ( & V_8 -> V_27 ) ;
F_58 ( & V_8 -> V_22 ) ;
for ( V_18 = 0 ; V_18 < V_115 ; V_18 ++ )
F_17 ( & V_8 -> V_116 [ V_18 ] . V_23 , & V_8 -> V_22 ) ;
F_32 ( V_72 , V_8 ) ;
F_6 ( V_8 , V_66 , V_67 ) ;
F_6 ( V_8 , V_68 , V_69 ) ;
F_20 ( & V_8 -> V_49 , V_46 ) ;
