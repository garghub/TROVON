...
V_118 |= V_130 ;
if ( V_91 -> V_14 -> V_15 & V_131 )
V_118 |= V_132 ;
if ( V_2 -> V_3 )
V_118 |= V_133 ;
F_29 ( V_91 -> V_14 -> V_134 , V_2 -> V_69 + V_135 ) ;
F_29 ( V_91 -> V_14 -> V_136 , V_2 -> V_69 + V_137 ) ;
}
F_54 ( V_91 -> V_138 , V_2 -> V_69 + V_139 ) ;
F_45 ( V_91 -> V_140 , V_2 -> V_69 + V_141 ) ;
F_45 ( V_118 , V_2 -> V_69 + V_142 ) ;
F_30 ( V_2 , 1 ) ;
}
...
static T_6 F_57 ( int V_65 , void * V_145 )
{
...
if ( V_2 -> V_3 ) {
V_77 = F_16 ( V_2 , V_14 ) ;
V_14 -> V_106 = V_14 -> V_136 * V_14 -> V_134 ;
...
F_29 ( V_151 , V_2 -> V_69 + V_84 ) ;
case V_152 :
if ( ! V_83 -> V_153 )
break;
F_52 ( V_2 , V_83 -> V_153 ) ;
if ( F_53 ( V_83 -> V_153 ) & V_120 ) {
V_77 = F_37 ( V_2 ,
V_154 ) ;
if ( V_77 ) {
V_2 -> V_146 = V_147 ;
...
static T_6 F_58 ( int V_65 , void * V_145 )
{
struct V_1 * V_2 = V_145 ;
struct V_113 * V_91 = V_2 -> V_91 ;
T_2 V_156 , V_76 , V_114 ;
V_156 = F_38 ( V_2 -> V_69 + V_84 ) ;
V_114 = V_156 ;
V_156 &= ~ V_2 -> V_68 ;
V_114 &= ~ ( V_104 | V_109 |
V_154 | V_151 ) ;
if ( V_114 != V_156 )
F_29 ( V_114 & ~ V_156 , V_2 -> V_69 + V_84 ) ;
if ( V_156 & V_157 ) {
F_29 ( V_157 , V_2 -> V_69 + V_84 ) ;
F_59 ( V_2 -> V_8 ) ;
V_156 &= ~ V_157 ;
}
if ( V_2 -> V_83 && V_91 && V_156 ) {
if ( F_50 ( 0 , & V_2 -> V_85 ) ) {
F_60 ( & V_2 -> V_86 ) ;
V_76 = F_32 ( V_2 -> V_69 + V_79 ) ;
if ( V_76 & V_158 ) {
...
F_26 ( V_2 , V_156 , false ) ;
F_29 ( V_156 , V_2 -> V_69 + V_84 ) ;
return V_162 ;
}
}
return V_155 ;
}
static int F_61 ( struct V_1 * V_2 , int V_163 )
{
int div = 0 ;
int V_164 ;
F_31 ( V_2 ) ;
F_62 ( V_2 -> V_165 , V_166 ) ;
V_164 = F_63 ( V_2 -> V_165 ) ;
while ( V_164 > V_163 && div < 7 ) {
++ div ;
V_164 >>= 1 ;
}
F_29 ( div , V_2 -> V_69 + V_167 ) ;
return V_164 ;
}
...
static void F_65 ( struct V_60 * V_8 , struct V_168 * V_169 )
{
struct V_1 * V_2 = F_22 ( V_8 ) ;
if ( V_169 -> clock )
F_61 ( V_2 , V_169 -> clock ) ;
switch ( V_169 -> V_170 ) {
case V_171 :
F_33 ( V_2 ) ;
if ( F_66 ( V_2 -> V_172 -> V_173 ) )
...
static void F_70 ( struct V_60 * V_8 , int V_180 )
{
struct V_1 * V_2 = F_22 ( V_8 ) ;
F_26 ( V_2 , V_157 , V_180 ) ;
}
static int F_71 ( struct V_23 * V_24 , int V_181 ,
const char * V_182 , bool V_183 , int V_184 )
{
int V_32 ;
if ( ! F_66 ( V_181 ) )
return 0 ;
V_32 = F_72 ( V_181 , V_182 ) ;
if ( V_32 ) {
F_7 ( V_24 , L_8 , V_182 , V_32 ) ;
return V_32 ;
}
if ( V_183 )
F_73 ( V_181 , V_184 ) ;
...
struct V_185 * V_186 )
{
struct V_187 * V_172 = V_186 -> V_24 . V_188 ;
int V_32 = 0 ;
if ( ! V_172 )
return 0 ;
if ( ! V_172 -> V_189 )
...
V_8 -> V_190 |= V_193 ;
if ( F_66 ( V_172 -> V_194 ) ) {
V_32 = F_76 ( V_8 , V_172 -> V_194 , 0 ) ;
if ( V_32 )
return V_32 ;
}
if ( F_66 ( V_172 -> V_195 ) ) {
V_32 = F_77 ( V_8 , V_172 -> V_195 ) ;
if ( V_32 )
return V_32 ;
}
return F_71 ( & V_186 -> V_24 , V_172 -> V_173 ,
L_9 , true , V_172 -> V_174 ) ;
}
static void F_78 ( struct V_185 * V_186 )
{
struct V_187 * V_172 = V_186 -> V_24 . V_188 ;
if ( ! V_172 )
return;
...
{
T_5 V_196 = F_81 ( V_197 ) ;
if ( V_2 -> V_172 && V_2 -> V_172 -> V_198 )
V_196 -= 3 ;
return V_196 ;
}
...
struct V_1 * V_2 ;
struct V_187 * V_172 ;
V_172 = V_186 -> V_24 . V_188 ;
V_8 = F_83 ( sizeof( struct V_1 ) , & V_186 -> V_24 ) ;
if ( ! V_8 ) {
F_7 ( & V_186 -> V_24 , L_10 ) ;
return - V_59 ;
}
V_2 = F_22 ( V_8 ) ;
V_2 -> V_172 = V_172 ;
V_2 -> V_65 = F_84 ( V_186 , 0 ) ;
if ( V_2 -> V_65 < 0 ) {
V_32 = V_2 -> V_65 ;
F_7 ( & V_186 -> V_24 , L_11 , V_32 ) ;
goto V_199;
}
V_2 -> V_165 = F_85 ( & V_186 -> V_24 , L_12 ) ;
if ( F_86 ( V_2 -> V_165 ) ) {
V_32 = F_87 ( V_2 -> V_165 ) ;
F_7 ( & V_186 -> V_24 , L_13 ) ;
goto V_199;
}
V_2 -> V_47 = F_88 ( V_186 , V_200 , 0 ) ;
V_2 -> V_69 = F_89 ( & V_186 -> V_24 , V_2 -> V_47 ) ;
if ( F_86 ( V_2 -> V_69 ) ) {
V_32 = F_87 ( V_2 -> V_69 ) ;
F_7 ( & V_186 -> V_24 , L_14 ) ;
goto V_199;
}
V_32 = F_90 ( V_197 , F_80 ( V_2 ) ) ;
if ( V_32 ) {
F_7 ( & V_186 -> V_24 , L_15 , V_32 ) ;
goto V_199;
}
V_32 = F_75 ( V_8 , V_186 ) ;
if ( V_32 )
...
V_8 -> V_209 = ( V_172 && V_172 -> V_198 ) ? 0 : V_210 ;
V_8 -> V_209 |= V_211 ;
V_8 -> V_212 = ( 1 << 10 ) - 1 ;
V_8 -> V_213 = ( 1 << 15 ) - 1 ;
V_8 -> V_214 = V_8 -> V_212 * V_8 -> V_213 ;
V_8 -> V_215 = 128 ;
V_8 -> V_216 = V_8 -> V_214 ;
V_2 -> V_8 = V_8 ;
V_2 -> V_186 = V_186 ;
...
V_32 = F_97 ( V_8 ) ;
if ( V_32 ) {
F_7 ( & V_186 -> V_24 , L_17 , V_32 ) ;
goto V_218;
}
F_98 ( & V_186 -> V_24 , L_18 ) ;
F_98 ( & V_186 -> V_24 , L_19 ,
V_2 -> V_3 ? L_20 : L_21 ,
( V_8 -> V_209 & V_210 ) ? 4 : 1 ) ;
return 0 ;
V_218:
...
if ( V_2 -> V_3 )
F_1 ( V_2 ) ;
F_100 ( V_197 , F_80 ( V_2 ) ) ;
V_199:
F_101 ( V_8 ) ;
return V_32 ;
}
static int F_102 ( struct V_185 * V_186 )
{
struct V_1 * V_2 = F_103 ( V_186 ) ;
F_104 ( & V_2 -> V_86 ) ;
F_26 ( V_2 , 0xff , false ) ;
F_33 ( V_2 ) ;
F_105 ( V_2 -> V_8 ) ;
...
F_108 ( V_197 , F_80 ( V_2 ) ) ;
return 0 ;
}
static int F_109 ( struct V_23 * V_24 )
{
struct V_1 * V_2 = F_107 ( V_24 ) ;
F_110 ( V_197 , F_80 ( V_2 ) ) ;
return 0 ;
}
