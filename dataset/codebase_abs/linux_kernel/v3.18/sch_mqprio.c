...
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = F_3 ( V_2 ) ;
struct V_1 * V_31 , * V_45 ;
unsigned int V_7 ;
for ( V_7 = 0 ; V_7 < V_4 -> V_9 ; V_7 ++ ) {
V_31 = V_6 -> V_8 [ V_7 ] ;
V_45 = F_22 ( V_31 -> V_30 , V_31 ) ;
if ( V_45 )
F_4 ( V_45 ) ;
if ( V_7 < V_4 -> V_26 )
F_23 ( V_31 ) ;
...
static struct V_29 * F_24 ( struct V_1 * V_2 ,
unsigned long V_46 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned long V_7 = V_46 - 1 - F_25 ( V_4 ) ;
if ( V_7 >= V_4 -> V_9 )
return NULL ;
return F_14 ( V_4 , V_7 ) ;
}
static int F_26 ( struct V_1 * V_2 , unsigned long V_46 , struct V_1 * V_47 ,
struct V_1 * * V_45 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_29 * V_30 = F_24 ( V_2 , V_46 ) ;
if ( ! V_30 )
return - V_19 ;
if ( V_4 -> V_42 & V_48 )
F_27 ( V_4 ) ;
...
static int F_29 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = F_3 ( V_2 ) ;
unsigned char * V_51 = F_30 ( V_50 ) ;
struct V_13 V_28 = { 0 } ;
struct V_1 * V_31 ;
unsigned int V_15 ;
V_2 -> V_52 . V_53 = 0 ;
...
static struct V_1 * F_37 ( struct V_1 * V_2 , unsigned long V_46 )
{
struct V_29 * V_30 = F_24 ( V_2 , V_46 ) ;
if ( ! V_30 )
return NULL ;
...
static unsigned long F_38 ( struct V_1 * V_2 , T_1 V_67 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned int V_7 = F_18 ( V_67 ) ;
if ( V_7 > V_4 -> V_9 + F_25 ( V_4 ) )
return 0 ;
return V_7 ;
}
static void F_39 ( struct V_1 * V_2 , unsigned long V_46 )
{
}
static int F_40 ( struct V_1 * V_2 , unsigned long V_46 ,
...
static int F_41 ( struct V_1 * V_2 , unsigned long V_46 ,
struct V_76 * V_77 )
...
struct V_79 V_55 = { 0 } ;
struct V_80 V_54 = { 0 } ;
struct V_72 V_73 = V_4 -> V_62 [ V_46 - 1 ] ;
F_34 ( V_77 -> V_78 ) ;
for ( V_15 = V_73 . V_24 ; V_15 < V_73 . V_24 + V_73 . V_25 ; V_15 ++ ) {
struct V_29 * V_52 = F_14 ( V_4 , V_15 ) ;
V_31 = F_31 ( V_52 -> V_31 ) ;
F_32 ( F_33 ( V_31 ) ) ;
V_53 += V_31 -> V_52 . V_53 ;
...
F_32 ( V_77 -> V_78 ) ;
if ( F_42 ( V_77 , NULL , & V_54 ) < 0 ||
F_43 ( V_77 , NULL , & V_55 , V_53 ) < 0 )
return - 1 ;
} else {
struct V_29 * V_30 = F_24 ( V_2 , V_46 ) ;
V_2 = V_30 -> V_66 ;
if ( F_42 ( V_77 , NULL , & V_2 -> V_54 ) < 0 ||
F_43 ( V_77 , NULL ,
& V_2 -> V_55 , V_2 -> V_52 . V_53 ) < 0 )
return - 1 ;
}
return 0 ;
}
static void F_44 ( struct V_1 * V_2 , struct V_81 * V_82 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned long V_7 ;
if ( V_82 -> V_83 )
