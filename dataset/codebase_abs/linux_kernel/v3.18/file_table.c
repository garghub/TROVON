...
if ( ( V_32 & V_41 ) &&
F_31 ( V_34 -> V_42 || V_34 -> V_43 || V_34 -> V_44 ) )
V_32 |= V_45 ;
if ( ( V_32 & V_46 ) &&
F_31 ( V_34 -> V_14 || V_34 -> V_47 || V_34 -> V_48 ) )
V_32 |= V_49 ;
V_3 -> V_50 = V_32 ;
V_3 -> V_51 = V_34 ;
if ( ( V_32 & ( V_41 | V_46 ) ) == V_41 )
F_32 ( V_31 -> V_37 -> V_38 ) ;
return V_3 ;
}
...
struct V_52 * V_53 = V_3 -> V_35 . V_53 ;
struct V_54 * V_54 = V_3 -> V_36 ;
F_34 () ;
F_35 ( V_3 ) ;
F_36 ( V_3 ) ;
F_37 ( V_3 ) ;
if ( F_18 ( V_3 -> V_55 & V_56 ) ) {
if ( V_3 -> V_51 -> V_57 )
V_3 -> V_51 -> V_57 ( - 1 , V_3 , 0 ) ;
}
F_38 ( V_3 ) ;
if ( V_3 -> V_51 -> V_58 )
V_3 -> V_51 -> V_58 ( V_54 , V_3 ) ;
F_39 ( V_3 ) ;
if ( F_18 ( F_40 ( V_54 -> V_59 ) && V_54 -> V_60 != NULL &&
! ( V_3 -> V_50 & V_61 ) ) ) {
F_41 ( V_54 -> V_60 ) ;
}
F_42 ( V_3 -> V_51 ) ;
F_43 ( V_3 -> V_26 . V_62 ) ;
if ( ( V_3 -> V_50 & ( V_41 | V_46 ) ) == V_41 )
F_44 ( V_54 ) ;
if ( V_3 -> V_50 & V_63 ) {
F_45 ( V_54 ) ;
F_46 ( V_53 ) ;
...
{
struct V_66 * V_67 = F_50 ( & V_68 ) ;
struct V_66 * V_69 ;
for (; V_67 ; V_67 = V_69 ) {
V_69 = F_51 ( V_67 ) ;
F_33 ( F_52 ( V_67 , struct V_3 , V_5 . V_70 ) ) ;
}
}
static void F_53 ( struct V_71 * V_72 )
{
F_33 ( F_2 ( V_72 , struct V_3 , V_5 . V_6 ) ) ;
}
void F_54 ( void )
{
F_49 ( NULL ) ;
...
if ( F_31 ( ! F_57 () && ! ( V_74 -> V_76 & V_77 ) ) ) {
F_58 ( & V_3 -> V_5 . V_6 , F_53 ) ;
if ( ! F_59 ( V_74 , & V_3 -> V_5 . V_6 , true ) )
return;
}
if ( F_60 ( & V_3 -> V_5 . V_70 , & V_68 ) )
F_61 ( & V_78 , 1 ) ;
}
}
...
void T_5 F_65 ( unsigned long V_79 )
{
unsigned long V_80 ;
