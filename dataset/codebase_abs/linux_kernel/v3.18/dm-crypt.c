...
static struct V_89 * F_68 ( struct V_2 * V_3 ,
struct V_6 * V_7 )
{
...
struct V_89 * V_90 )
{
struct V_92 V_93 = F_73 ( V_63 -> V_64 , V_63 -> V_83 ) ;
struct V_92 V_94 = F_73 ( V_63 -> V_82 , V_63 -> V_85 ) ;
struct V_6 * V_7 ;
T_1 * V_5 ;
int V_31 ;
V_7 = F_67 ( V_3 , V_90 ) ;
...
V_7 -> V_63 = V_63 ;
F_74 ( & V_7 -> V_66 , 1 ) ;
F_75 ( & V_7 -> V_66 , V_93 . V_95 , 1 << V_79 ,
V_93 . V_96 ) ;
F_74 ( & V_7 -> V_69 , 1 ) ;
F_75 ( & V_7 -> V_69 , V_94 . V_95 , 1 << V_79 ,
V_94 . V_96 ) ;
F_76 ( V_63 -> V_64 , & V_63 -> V_83 , 1 << V_79 ) ;
F_76 ( V_63 -> V_82 , & V_63 -> V_85 , 1 << V_79 ) ;
if ( V_3 -> V_97 ) {
V_31 = V_3 -> V_97 -> V_98 ( V_3 , V_5 , V_7 ) ;
if ( V_31 < 0 )
return V_31 ;
}
F_77 ( V_90 , & V_7 -> V_66 , & V_7 -> V_69 ,
1 << V_79 , V_5 ) ;
...
if ( ! V_63 -> V_90 )
V_63 -> V_90 = F_81 ( V_3 -> V_101 , V_102 ) ;
F_82 ( V_63 -> V_90 , V_3 -> V_4 [ V_100 ] ) ;
F_83 ( V_63 -> V_90 ,
V_103 | V_27 ,
V_104 , F_67 ( V_3 , V_63 -> V_90 ) ) ;
}
static void F_84 ( struct V_2 * V_3 ,
struct V_89 * V_90 , struct V_81 * V_105 )
{
struct V_106 * V_107 = F_85 ( V_105 , V_3 -> V_108 ) ;
...
static struct V_81 * F_94 ( struct V_106 * V_107 , unsigned V_113 ,
unsigned * V_114 )
{
...
unsigned V_59 , V_121 ;
struct V_122 * V_122 ;
V_115 = F_95 ( V_102 , V_116 , V_3 -> V_43 ) ;
if ( ! V_115 )
return NULL ;
F_96 ( V_107 , V_115 ) ;
* V_114 = 0 ;
...
if ( ! F_97 ( V_115 , V_122 , V_121 , 0 ) ) {
F_86 ( V_122 , V_3 -> V_123 ) ;
break;
}
V_113 -= V_121 ;
}
...
static void F_99 ( struct V_2 * V_3 , struct V_81 * V_115 )
{
unsigned int V_59 ;
struct V_92 * V_126 ;
F_100 (bv, clone, i) {
F_101 ( ! V_126 -> V_95 ) ;
F_86 ( V_126 -> V_95 , V_3 -> V_123 ) ;
V_126 -> V_95 = NULL ;
}
}
static void F_102 ( struct V_106 * V_107 , struct V_2 * V_3 ,
...
static void F_103 ( struct V_106 * V_107 )
{
F_89 ( & V_107 -> V_128 ) ;
}
...
if ( ! F_105 ( & V_107 -> V_128 ) )
return;
if ( V_107 -> V_63 . V_90 )
F_84 ( V_3 , V_107 -> V_63 . V_90 , V_105 ) ;
if ( V_107 != F_85 ( V_105 , V_3 -> V_108 ) )
F_86 ( V_107 , V_3 -> V_129 ) ;
if ( F_106 ( ! V_127 ) )
F_107 ( V_105 , error ) ;
else {
...
static void F_108 ( struct V_81 * V_115 , int error )
{
struct V_106 * V_107 = V_115 -> V_130 ;
struct V_2 * V_3 = V_107 -> V_3 ;
unsigned V_131 = F_51 ( V_115 ) ;
if ( F_109 ( ! F_110 ( V_115 , V_132 ) && ! error ) )
error = - V_133 ;
if ( V_131 == V_65 )
F_99 ( V_3 , V_115 ) ;
F_98 ( V_115 ) ;
...
static void F_96 ( struct V_106 * V_107 , struct V_81 * V_115 )
{
struct V_2 * V_3 = V_107 -> V_3 ;
V_115 -> V_130 = V_107 ;
V_115 -> V_135 = F_108 ;
...
static int F_112 ( struct V_106 * V_107 , T_4 V_140 )
{
struct V_2 * V_3 = V_107 -> V_3 ;
struct V_81 * V_105 = V_107 -> V_105 ;
struct V_81 * V_115 ;
V_115 = F_113 ( V_105 , V_140 , V_3 -> V_43 ) ;
if ( ! V_115 )
return 1 ;
F_103 ( V_107 ) ;
F_96 ( V_107 , V_115 ) ;
...
static void F_115 ( struct V_106 * V_107 )
{
struct V_81 * V_115 = V_107 -> V_63 . V_82 ;
F_114 ( V_115 ) ;
}
static void F_116 ( struct V_143 * V_144 )
{
struct V_106 * V_107 = F_117 ( V_144 , struct V_106 , V_144 ) ;
if ( F_51 ( V_107 -> V_105 ) == V_134 ) {
F_103 ( V_107 ) ;
if ( F_112 ( V_107 , V_102 ) )
V_107 -> error = - V_42 ;
F_104 ( V_107 ) ;
} else
F_115 ( V_107 ) ;
...
{
struct V_2 * V_3 = V_107 -> V_3 ;
F_119 ( & V_107 -> V_144 , F_116 ) ;
F_120 ( V_3 -> V_145 , & V_107 -> V_144 ) ;
}
static void F_121 ( struct V_106 * V_107 , int V_146 )
{
struct V_81 * V_115 = V_107 -> V_63 . V_82 ;
struct V_2 * V_3 = V_107 -> V_3 ;
if ( F_109 ( V_107 -> error < 0 ) ) {
F_99 ( V_3 , V_115 ) ;
F_98 ( V_115 ) ;
F_104 ( V_107 ) ;
return;
}
F_101 ( V_107 -> V_63 . V_85 . V_110 ) ;
V_115 -> V_84 . V_141 = V_3 -> V_142 + V_107 -> V_77 ;
if ( V_146 )
F_118 ( V_107 ) ;
else
...
static void F_122 ( struct V_106 * V_107 )
{
struct V_2 * V_3 = V_107 -> V_3 ;
struct V_81 * V_115 ;
struct V_106 * V_147 ;
...
int V_31 ;
F_103 ( V_107 ) ;
F_65 ( V_3 , & V_107 -> V_63 , NULL , V_107 -> V_105 , V_77 ) ;
while ( V_149 ) {
V_115 = F_94 ( V_107 , V_149 , & V_114 ) ;
if ( F_109 ( ! V_115 ) ) {
V_107 -> error = - V_42 ;
break;
}
...
V_77 += F_123 ( V_115 ) ;
F_103 ( V_107 ) ;
V_31 = F_87 ( V_3 , & V_107 -> V_63 ) ;
if ( V_31 < 0 )
V_107 -> error = - V_133 ;
V_148 = F_105 ( & V_107 -> V_63 . V_109 ) ;
if ( V_148 ) {
F_121 ( V_107 , 0 ) ;
if ( F_109 ( V_31 < 0 ) )
break;
...
if ( F_109 ( V_114 ) )
F_124 ( V_150 , V_151 / 100 ) ;
if ( F_109 ( ! V_148 && V_149 ) ) {
V_147 = F_81 ( V_3 -> V_129 , V_102 ) ;
F_102 ( V_147 , V_107 -> V_3 , V_107 -> V_105 , V_77 ) ;
F_103 ( V_147 ) ;
F_65 ( V_3 , & V_147 -> V_63 , NULL ,
V_107 -> V_105 , V_77 ) ;
...
static void F_125 ( struct V_106 * V_107 )
{
F_104 ( V_107 ) ;
}
...
int V_31 = 0 ;
F_103 ( V_107 ) ;
F_65 ( V_3 , & V_107 -> V_63 , V_107 -> V_105 , V_107 -> V_105 ,
V_107 -> V_77 ) ;
V_31 = F_87 ( V_3 , & V_107 -> V_63 ) ;
if ( V_31 < 0 )
V_107 -> error = - V_133 ;
if ( F_105 ( & V_107 -> V_63 . V_109 ) )
F_125 ( V_107 ) ;
F_104 ( V_107 ) ;
}
...
error = V_3 -> V_97 -> V_99 ( V_3 , F_69 ( V_3 , V_7 ) , V_7 ) ;
if ( error < 0 )
V_107 -> error = - V_133 ;
F_84 ( V_3 , F_68 ( V_3 , V_7 ) , V_107 -> V_105 ) ;
if ( ! F_105 ( & V_63 -> V_109 ) )
return;
if ( F_51 ( V_107 -> V_105 ) == V_134 )
F_125 ( V_107 ) ;
...
{
struct V_2 * V_3 = V_107 -> V_3 ;
F_119 ( & V_107 -> V_144 , F_128 ) ;
F_120 ( V_3 -> V_154 , & V_107 -> V_144 ) ;
}
static int F_129 ( T_1 * V_22 , char * V_155 , unsigned int V_113 )
{
char V_156 [ 3 ] ;
unsigned int V_59 ;
V_156 [ 2 ] = '\0' ;
...
static int F_133 ( struct V_2 * V_3 , char * V_157 )
{
unsigned V_59 ;
int V_21 ;
...
V_3 -> V_163 = F_148 ( V_164 , V_41 ) ;
if ( ! V_3 -> V_163 )
goto V_173;
V_165 = V_164 ;
V_169 = F_149 ( & V_165 , L_17 ) ;
V_35 = F_149 ( & V_169 , L_19 ) ;
if ( ! V_169 )
V_3 -> V_52 = 1 ;
...
if ( ! V_3 -> V_35 )
goto V_173;
V_166 = F_149 ( & V_165 , L_17 ) ;
V_168 = F_149 ( & V_165 , L_17 ) ;
V_167 = F_149 ( & V_168 , L_19 ) ;
if ( V_165 )
F_151 ( L_22 ) ;
...
static int F_153 ( struct V_32 * V_33 , unsigned int V_184 , char * * V_185 )
{
struct V_2 * V_3 ;
...
V_3 -> V_23 = V_23 ;
V_33 -> V_161 = V_3 ;
V_171 = F_147 ( V_33 , V_185 [ 0 ] , V_185 [ 1 ] ) ;
if ( V_171 < 0 )
goto V_40;
V_171 = - V_42 ;
V_3 -> V_129 = F_154 ( V_194 , V_195 ) ;
if ( ! V_3 -> V_129 ) {
V_33 -> error = L_44 ;
goto V_40;
}
V_3 -> V_91 = sizeof( struct V_89 ) ;
V_3 -> V_91 += F_155 ( F_1 ( V_3 ) ) ;
V_3 -> V_91 = F_70 ( V_3 -> V_91 , F_156 ( struct V_6 ) ) ;
if ( F_71 ( F_1 ( V_3 ) ) < V_196 ) {
V_188 = - ( V_3 -> V_91 + sizeof( struct V_6 ) )
& F_71 ( F_1 ( V_3 ) ) ;
} else {
V_188 = F_71 ( F_1 ( V_3 ) ) ;
}
V_3 -> V_101 = F_157 ( V_194 , V_3 -> V_91 +
...
F_70 ( sizeof( struct V_106 ) + V_3 -> V_91 +
sizeof( struct V_6 ) + V_188 + V_3 -> V_8 ,
V_197 ) ;
V_3 -> V_123 = F_158 ( V_198 , 0 ) ;
if ( ! V_3 -> V_123 ) {
V_33 -> error = L_46 ;
goto V_40;
}
V_3 -> V_43 = F_159 ( V_194 , 0 ) ;
if ( ! V_3 -> V_43 ) {
V_33 -> error = L_47 ;
goto V_40;
}
...
V_3 -> V_87 = V_187 ;
if ( F_160 ( V_33 , V_185 [ 3 ] , F_161 ( V_33 -> V_199 ) , & V_3 -> V_137 ) ) {
V_33 -> error = L_50 ;
goto V_40;
}
...
V_190 . V_184 = V_184 ;
V_190 . V_185 = V_185 ;
V_171 = F_162 ( V_193 , & V_190 , & V_186 , & V_33 -> error ) ;
if ( V_171 )
goto V_40;
V_191 = F_163 ( & V_190 ) ;
if ( V_186 == 1 && V_191 &&
...
V_171 = - V_42 ;
V_3 -> V_145 = F_164 ( L_54 , V_201 , 1 ) ;
if ( ! V_3 -> V_145 ) {
V_33 -> error = L_55 ;
goto V_40;
}
V_3 -> V_154 = F_164 ( L_56 ,
V_202 | V_201 , 1 ) ;
if ( ! V_3 -> V_154 ) {
V_33 -> error = L_57 ;
goto V_40;
...
static int F_165 ( struct V_32 * V_33 , struct V_81 * V_81 )
{
struct V_106 * V_107 ;
struct V_2 * V_3 = V_33 -> V_161 ;
if ( F_109 ( V_81 -> V_139 & ( V_205 | V_206 ) ) ) {
V_81 -> V_136 = V_3 -> V_137 -> V_138 ;
if ( F_123 ( V_81 ) )
V_81 -> V_84 . V_141 = V_3 -> V_142 +
F_166 ( V_33 , V_81 -> V_84 . V_141 ) ;
return V_207 ;
}
V_107 = F_85 ( V_81 , V_3 -> V_108 ) ;
F_102 ( V_107 , V_3 , V_81 , F_166 ( V_33 , V_81 -> V_84 . V_141 ) ) ;
V_107 -> V_63 . V_90 = (struct V_89 * ) ( V_107 + 1 ) ;
if ( F_51 ( V_107 -> V_105 ) == V_134 ) {
if ( F_112 ( V_107 , V_208 ) )
F_118 ( V_107 ) ;
} else
F_111 ( V_107 ) ;
return V_209 ;
...
break;
case V_215 :
F_168 ( L_58 , V_3 -> V_163 ) ;
if ( V_3 -> V_23 > 0 )
for ( V_59 = 0 ; V_59 < V_3 -> V_23 ; V_59 ++ )
F_168 ( L_59 , V_3 -> V_22 [ V_59 ] ) ;
else
F_168 ( L_17 ) ;
F_168 ( L_60 , ( unsigned long long ) V_3 -> V_87 ,
...
{
struct V_2 * V_3 = V_33 -> V_161 ;
F_139 ( V_217 , & V_3 -> V_26 ) ;
}
static int F_170 ( struct V_32 * V_33 )
{
struct V_2 * V_3 = V_33 -> V_161 ;
if ( ! F_171 ( V_160 , & V_3 -> V_26 ) ) {
F_172 ( L_62 ) ;
return - V_218 ;
}
return 0 ;
...
{
struct V_2 * V_3 = V_33 -> V_161 ;
F_141 ( V_217 , & V_3 -> V_26 ) ;
}
static int F_174 ( struct V_32 * V_33 , unsigned V_184 , char * * V_185 )
{
struct V_2 * V_3 = V_33 -> V_161 ;
int V_171 = - V_37 ;
if ( V_184 < 2 )
...
if ( ! F_171 ( V_217 , & V_3 -> V_26 ) ) {
F_151 ( L_64 ) ;
return - V_37 ;
}
if ( V_184 == 3 && ! strcasecmp ( V_185 [ 1 ] , L_65 ) ) {
V_171 = F_138 ( V_3 , V_185 [ 2 ] ) ;
if ( V_171 )
return V_171 ;
if ( V_3 -> V_97 && V_3 -> V_97 -> V_183 )
V_171 = V_3 -> V_97 -> V_183 ( V_3 ) ;
...
static int F_175 ( struct V_32 * V_33 , struct V_220 * V_221 ,
struct V_92 * V_222 , int V_223 )
{
struct V_2 * V_3 = V_33 -> V_161 ;
struct V_224 * V_225 = F_176 ( V_3 -> V_137 -> V_138 ) ;
if ( ! V_225 -> V_226 )
return V_223 ;
V_221 -> V_136 = V_3 -> V_137 -> V_138 ;
V_221 -> V_141 = V_3 -> V_142 + F_166 ( V_33 , V_221 -> V_141 ) ;
return F_177 ( V_223 , V_225 -> V_226 ( V_225 , V_221 , V_222 ) ) ;
}
