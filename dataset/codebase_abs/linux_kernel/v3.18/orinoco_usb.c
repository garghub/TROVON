...
if ( F_43 ( V_208 -> V_223 ) != 64 )
F_40 ( L_56 ) ;
if ( V_208 -> V_224 != ( 2 | V_225 ) )
F_40 ( L_57 ,
V_208 -> V_224 ) ;
V_12 -> V_94 = F_119 ( V_15 ,
V_208 ->
V_224 ) ;
V_12 -> V_92 -> V_64 =
F_18 ( V_27 , V_110 ) ;
...
if ( F_124 ( V_42 , 0 , 0 , & V_226 ) != 0 ) {
V_12 -> V_22 = NULL ;
F_31 ( L_70 , V_72 ) ;
goto error;
}
V_12 -> V_22 = V_42 -> V_227 ;
goto exit;
error:
F_100 ( V_12 ) ;
if ( V_12 -> V_22 ) {
...
static void F_127 ( struct V_201 * V_228 )
{
struct V_11 * V_12 = F_128 ( V_228 ) ;
F_126 ( V_228 , NULL ) ;
F_100 ( V_12 ) ;
