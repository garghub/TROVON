...
( V_16 . V_77 != V_78 ) )
return V_72 ;
if ( ( V_65 -> V_11 >= V_16 . V_79 ) &&
( V_65 -> V_12 < ( V_16 . V_79 + V_16 . V_73 ) ) ) {
V_65 -> V_18 = 1 ;
return V_74 ;
}
return V_72 ;
...
int F_57 ( struct V_56 * V_87 , T_12 V_123 , T_17 V_11 , T_17 V_12 ,
T_18 V_13 )
{
int V_124 ;
...
V_124 = - V_126 ;
V_2 = F_11 ( V_123 , V_11 , V_12 , V_13 ) ;
if ( V_2 == NULL ) {
F_58 ( V_87 , L_28 ) ;
V_124 = - V_115 ;
} else if ( ! F_43 ( V_87 , V_2 , 0 ) ) {
F_58 ( V_87 , V_127 L_29 ,
& V_2 -> V_3 ) ;
} else {
if ( V_96 )
V_6 = F_59 ( & V_122 ,
...
int F_61 ( T_12 V_123 , T_17 V_11 , T_17 V_12 )
{
struct V_1 * V_2 ;
F_15 ( & V_23 ) ;
F_9 (cfg, &pci_mmcfg_list, list)
if ( V_2 -> V_8 == V_123 && V_2 -> V_9 == V_11 &&
V_2 -> V_17 == V_12 ) {
F_62 ( & V_2 -> V_5 ) ;
F_63 () ;
F_64 ( V_2 ) ;
