...
static void F_22 ( struct V_38 * V_39 , void * V_1 )
{
struct V_3 * V_4 = V_1 ;
if ( V_4 -> V_25 )
F_23 ( V_4 -> V_25 ) ;
}
static int F_24 ( struct V_38 * V_39 , void * V_1 )
{
struct V_3 * V_4 = V_1 ;
struct V_42 * V_43 = F_25 ( V_39 ) ;
