...
unsigned int V_18 ;
int V_35 ;
V_9 = F_18 ( V_28 -> V_16 , sizeof( * V_9 ) , V_36 ) ;
if ( V_9 == NULL )
return - V_37 ;
V_9 -> V_26 = V_26 ;
switch ( V_26 ) {
...
case V_43 :
default:
V_18 = V_28 -> V_44 -> V_45 [ V_26 ] . V_18 ;
break;
}
V_35 = F_19 ( V_28 -> V_46 , & V_9 -> V_6 , & V_47 ,
V_18 ) ;
if ( V_35 < 0 )
return V_35 ;
F_20 ( & V_9 -> V_6 , & V_48 ) ;
...
V_32 ? & V_32 -> V_3 . V_10 . V_51 : NULL ;
return F_21 ( V_28 , V_9 , V_50 , V_34 ) ;
}
case V_19 :
