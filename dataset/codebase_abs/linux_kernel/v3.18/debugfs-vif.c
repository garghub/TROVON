...
static T_1 F_23 ( struct V_3 * V_4 , char * V_39 ,
T_2 V_40 , T_3 * V_41 )
{
struct V_8 * V_9 = F_2 ( V_4 ) ;
struct V_1 * V_2 = V_9 -> V_2 ;
...
static T_1 F_26 ( struct V_47 * V_47 ,
char T_4 * V_48 ,
T_2 V_40 , T_3 * V_41 )
{
struct V_3 * V_4 = V_47 -> V_49 ;
...
static T_1 F_30 ( struct V_3 * V_4 , char * V_39 ,
T_2 V_40 , T_3 * V_41 )
{
struct V_8 * V_9 = F_2 ( V_4 ) ;
struct V_1 * V_2 = V_9 -> V_2 ;
...
{
struct V_131 * V_132 = V_4 -> V_133 ;
struct V_8 * V_9 = F_2 ( V_4 ) ;
char V_39 [ 100 ] ;
if ( ! V_132 || V_9 -> V_132 )
return;
V_9 -> V_132 = F_35 ( L_59 , V_132 ) ;
V_9 -> V_2 = V_2 ;
if ( ! V_9 -> V_132 ) {
F_36 ( V_2 , L_60 ,
V_132 -> V_134 . V_135 ) ;
...
( ( V_4 -> type == V_57 && ! V_4 -> V_139 ) ||
( V_4 -> type == V_57 && V_4 -> V_139 &&
V_2 -> V_140 -> V_141 . V_142 & V_143 ) ) )
F_37 ( V_144 , V_9 -> V_132 , V_145 |
V_146 ) ;
F_37 ( V_147 , V_9 -> V_132 , V_146 ) ;
F_37 ( V_130 , V_9 -> V_132 ,
V_146 | V_145 ) ;
if ( V_4 -> type == V_57 && ! V_4 -> V_139 &&
V_9 == V_2 -> V_148 )
F_37 ( V_149 , V_9 -> V_132 ,
V_146 | V_145 ) ;
snprintf ( V_39 , 100 , L_61 ,
V_132 -> V_150 -> V_150 -> V_134 . V_135 ,
V_132 -> V_150 -> V_134 . V_135 ,
V_132 -> V_134 . V_135 ,
V_9 -> V_132 -> V_134 . V_135 ) ;
V_9 -> V_151 = F_38 ( V_132 -> V_134 . V_135 ,
V_2 -> V_133 , V_39 ) ;
if ( ! V_9 -> V_151 )
F_36 ( V_2 , L_62 ,
V_132 -> V_134 . V_135 ) ;
