...
F_22 ( & V_26 -> V_31 ) ;
if ( ! V_16 -> V_32 )
F_17 ( V_16 , & V_67 -> V_20 , V_26 -> V_7 , V_5 ) ;
F_25 ( & V_26 -> V_31 ) ;
V_45:
F_47 ( 6 , L_8 ,
F_48 ( V_26 -> V_7 , & V_67 -> V_20 ) ,
F_48 ( V_5 -> V_7 , & V_5 -> V_9 ) , F_49 ( V_5 -> V_60 ) ) ;
return V_5 ;
}
static int T_3 F_53 ( struct V_36 * V_36 )
{
...
static void T_4 F_57 ( struct V_36 * V_36 )
{
struct V_34 * V_35 = F_28 ( V_36 ) ;
F_58 ( V_35 -> V_77 ) ;
if ( ! F_54 ( V_36 , & V_71 ) )
...
static int T_3 F_53 ( struct V_36 * V_36 ) { return 0 ; }
static void T_4 F_57 ( struct V_36 * V_36 ) { }
