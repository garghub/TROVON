...
static int F_27 ( struct V_2 * V_3 , int V_29 )
{
struct V_1 * V_10 = F_1 ( V_3 ) ;
...
struct V_1 * V_10 ;
int V_9 ;
V_10 = F_29 ( & V_5 -> V_12 , sizeof( * V_10 ) , V_34 ) ;
if ( ! V_10 ) {
F_14 ( V_12 , L_11 ) ;
V_9 = - V_35 ;
goto V_27;
...
V_10 -> V_5 = V_5 ;
V_10 -> V_26 = F_30 ( V_12 , L_12 ) ;
if ( F_31 ( V_10 -> V_26 ) ) {
F_14 ( V_12 , L_13 ) ;
return F_32 ( V_10 -> V_26 ) ;
}
V_10 -> V_14 = V_32 -> V_14 ;
V_9 = F_33 ( V_12 , V_10 -> V_14 , L_14 ) ;
if ( V_9 ) {
F_14 ( V_12 , L_15 ) ;
return V_9 ;
}
F_34 ( & V_10 -> V_3 , V_5 , & V_36 ) ;
F_35 ( V_12 ) ;
V_9 = F_25 ( V_12 ) ;
if ( V_9 )
goto V_37;
