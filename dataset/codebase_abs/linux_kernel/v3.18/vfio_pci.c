...
{
struct V_178 * V_179 = V_55 ;
struct V_180 * V_181 = F_100 ( V_4 -> V_182 ) ;
if ( V_181 != & V_183 )
return - V_184 ;
if ( V_179 -> V_185 == V_179 -> V_186 )
return - V_134 ;
V_179 -> V_63 [ V_179 -> V_185 ] = F_95 ( & V_4 -> V_11 ) ;
if ( ! V_179 -> V_63 [ V_179 -> V_185 ] )
return - V_76 ;
V_179 -> V_185 ++ ;
return 0 ;
}
...
return;
if ( F_49 ( V_2 -> V_4 , F_40 ,
& V_73 , V_78 ) || ! V_73 )
return;
V_179 . V_186 = V_73 ;
V_179 . V_63 = F_66 ( V_73 , sizeof( struct V_173 * ) , V_136 ) ;
if ( ! V_179 . V_63 )
return;
if ( F_49 ( V_2 -> V_4 ,
F_99 , & V_179 , V_78 ) )
goto V_188;
for ( V_73 = 0 ; V_73 < V_179 . V_185 ; V_73 ++ ) {
V_187 = F_96 ( V_179 . V_63 [ V_73 ] ) ;
if ( V_187 -> V_38 )
V_38 = true ;
if ( V_187 -> V_42 )
goto V_188;
