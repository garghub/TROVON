...
case V_223 :
default:
V_220 = ( * V_219 + V_221 / 2 ) / V_221 ;
break;
case V_224 :
V_220 = ( * V_219 ) / V_221 ;
break;
case V_225 :
V_220 = ( * V_219 + V_221 - 1 ) / V_221 ;
break;
}
* V_219 = V_221 * V_220 ;
return V_220 - 1 ;
...
int V_234 = 0 ;
unsigned int V_235 ;
V_234 |= F_146 ( & V_3 -> V_131 ,
V_197 | V_233 | V_132 ) ;
V_234 |= F_146 ( & V_3 -> V_134 ,
V_141 | V_132 | V_183 ) ;
V_234 |= F_146 ( & V_3 -> V_137 ,
V_141 | V_132 | V_197 ) ;
V_234 |= F_146 ( & V_3 -> V_236 , V_160 ) ;
V_234 |= F_146 ( & V_3 -> V_159 , V_160 | V_237 ) ;
if ( V_234 )
return 1 ;
V_234 |= F_147 ( V_3 -> V_131 ) ;
V_234 |= F_147 ( V_3 -> V_134 ) ;
V_234 |= F_147 ( V_3 -> V_137 ) ;
V_234 |= F_147 ( V_3 -> V_159 ) ;
if ( V_234 )
return 2 ;
switch ( V_3 -> V_131 ) {
case V_197 :
case V_233 :
V_234 |= F_148 ( & V_3 -> V_130 , 0 ) ;
break;
case V_132 :
V_234 |= F_149 ( & V_3 -> V_130 , 39 ) ;
break;
}
if ( V_3 -> V_134 == V_132 )
V_234 |= F_149 ( & V_3 -> V_135 , 39 ) ;
if ( V_3 -> V_137 == V_132 )
V_234 |= F_149 ( & V_3 -> V_140 , 39 ) ;
#define F_150 200000
#define F_151 2000000000
if ( V_3 -> V_134 == V_141 ) {
V_234 |= F_152 ( & V_3 -> V_135 ,
F_150 ) ;
V_234 |= F_149 ( & V_3 -> V_135 ,
F_151 ) ;
} else {
}
if ( V_3 -> V_137 == V_141 ) {
V_234 |= F_152 ( & V_3 -> V_140 ,
F_150 ) ;
V_234 |= F_149 ( & V_3 -> V_140 ,
F_151 ) ;
} else {
}
V_234 |= F_148 ( & V_3 -> V_238 , V_3 -> V_139 ) ;
if ( V_3 -> V_159 == V_160 )
V_234 |= F_152 ( & V_3 -> V_232 , 1 ) ;
else
V_234 |= F_148 ( & V_3 -> V_232 , 0 ) ;
if ( V_234 )
return 3 ;
if ( V_3 -> V_134 == V_141 ) {
V_235 = V_3 -> V_135 ;
F_142 ( & V_235 , V_3 -> V_165 ) ;
V_234 |= F_148 ( & V_3 -> V_135 , V_235 ) ;
}
if ( V_3 -> V_137 == V_141 ) {
V_235 = V_3 -> V_140 ;
F_142 ( & V_235 , V_3 -> V_165 ) ;
V_234 |= F_148 ( & V_3 -> V_140 , V_235 ) ;
if ( V_3 -> V_134 == V_141 ) {
V_235 = V_3 -> V_140 * V_3 -> V_238 ;
V_234 |= F_152 ( & V_3 -> V_135 ,
V_235 ) ;
}
}
...
if ( F_158 ( V_22 , V_119 ) )
F_11 ( V_2 , F_156 ( V_120 ) , V_22 -> V_240 ) ;
V_119 [ 1 ] = F_10 ( V_2 , F_159 ( V_120 ) ) ;
return V_24 -> V_178 ;
}
...
unsigned long V_120 = ( unsigned long ) V_22 -> V_36 ;
int V_30 ;
V_30 = F_161 ( V_2 , V_22 , V_24 , V_119 , 0 ) ;
if ( V_30 )
return V_30 ;
F_11 ( V_2 , F_156 ( V_120 ) , V_22 -> V_241 ) ;
return V_24 -> V_178 ;
}
...
static void F_165 ( struct V_1 * V_2 , T_1 V_245 )
{
F_11 ( V_2 , V_121 , V_246 ) ;
F_11 ( V_2 , V_247 , V_245 ) ;
F_11 ( V_2 , V_121 , V_248 ) ;
}
...
{
struct V_250 * V_251 = F_168 ( V_2 ) ;
struct V_34 * V_35 = V_2 -> V_36 ;
void * V_14 ;
T_7 V_252 ;
V_14 = F_169 ( V_251 , V_253 , & V_252 ) ;
if ( ! V_14 )
return - V_254 ;
V_35 -> V_153 . V_154 = V_14 ;
V_35 -> V_153 . V_181 = V_252 ;
V_14 = F_169 ( V_251 , V_253 , & V_252 ) ;
if ( ! V_14 )
return - V_254 ;
V_35 -> V_180 . V_154 = V_14 ;
V_35 -> V_180 . V_181 = V_252 ;
return 0 ;
}
...
int V_8 ;
int V_30 ;
F_1 ( V_2 , V_256 | V_257 | V_258 ,
V_42 ) ;
F_3 ( V_259 |
( V_260 << V_261 ) | V_262 |
V_263 , V_2 -> V_6 + V_264 ) ;
F_3 ( V_265 , V_2 -> V_6 + V_266 ) ;
...
return V_30 ;
for ( V_8 = 0 ; V_8 < 2 ; V_8 ++ ) {
F_3 ( V_267 , V_2 -> V_6 + V_269 ) ;
F_1 ( V_2 , V_27 , V_10 ) ;
V_30 = F_15 ( V_2 , NULL , NULL , F_13 , 0 ) ;
if ( V_30 )
return V_30 ;
}
F_3 ( V_270 , V_2 -> V_6 + V_271 ) ;
F_3 ( V_272 | V_273 , V_2 -> V_6 + V_274 ) ;
F_3 ( V_272 | V_273 | V_61 ,
V_2 -> V_6 + V_274 + 4 ) ;
F_3 ( V_275 , V_2 -> V_6 + V_276 ) ;
F_3 ( ( T_2 ) V_35 -> V_180 . V_181 ,
V_2 -> V_6 + V_182 ) ;
F_3 ( 0 , V_2 -> V_6 + V_277 ) ;
F_3 ( 0 , V_2 -> V_6 + V_278 ) ;
...
#endif
F_3 ( 0 , V_2 -> V_6 + V_279 ) ;
V_255 = V_35 -> V_153 . V_181 +
( V_280 * sizeof( T_2 ) ) ;
F_3 ( ( T_2 ) V_255 , V_2 -> V_6 + V_281 ) ;
F_3 ( ( T_2 ) ( V_255 + sizeof( T_2 ) ) ,
V_2 -> V_6 + V_282 ) ;
...
V_2 -> V_6 + F_22 ( 0 ) ) ;
F_3 ( V_284 , V_2 -> V_6 + F_22 ( 1 ) ) ;
F_3 ( V_285 , V_2 -> V_6 + V_276 ) ;
F_25 ( V_2 ) ;
V_30 = F_25 ( V_2 ) ;
if ( V_30 )
return V_30 ;
for ( V_62 = 0 ; V_62 < V_286 ; V_62 ++ ) {
V_30 = F_23 ( V_2 , V_62 , 0 ) ;
if ( V_30 )
return V_30 ;
}
F_166 ( V_2 ) ;
F_165 ( V_2 , ( F_10 ( V_2 , V_144 ) &
V_287 ) ) ;
F_155 ( V_2 ) ;
return 0 ;
}
...
struct V_21 * V_22 ;
int V_30 ;
V_35 = F_174 ( V_2 , sizeof( * V_35 ) ) ;
if ( ! V_35 )
return - V_254 ;
V_30 = F_175 ( V_2 ) ;
if ( V_30 )
return V_30 ;
V_2 -> V_6 = F_176 ( V_251 , 0 ) ;
if ( ! V_2 -> V_6 )
return - V_254 ;
F_3 ( 0 , V_2 -> V_6 + V_171 ) ;
F_3 ( V_289 , V_2 -> V_6 + V_42 ) ;
V_30 = F_167 ( V_2 ) ;
if ( V_30 )
return V_30 ;
if ( V_251 -> V_163 ) {
V_30 = F_177 ( V_251 -> V_163 , F_130 , V_290 ,
V_2 -> V_291 , V_2 ) ;
if ( V_30 == 0 )
V_2 -> V_163 = V_251 -> V_163 ;
}
V_30 = F_178 ( V_2 , 6 ) ;
if ( V_30 )
return V_30 ;
...
V_2 -> V_6 + V_55 ) ;
F_165 ( V_2 , 0 ) ;
F_3 ( V_320 , V_2 -> V_6 + V_42 ) ;
F_3 ( V_321 , V_2 -> V_6 + V_276 ) ;
}
}
F_181 ( V_2 ) ;
F_170 ( V_2 ) ;
}
static int F_182 ( struct V_250 * V_2 ,
const struct V_322 * V_323 )
{
return F_183 ( V_2 , & V_324 , V_323 -> V_325 ) ;
}
