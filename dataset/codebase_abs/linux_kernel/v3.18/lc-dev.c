...
static
int F_46 ( struct V_21 * V_22 , void * V_51 )
{
struct V_16 * V_52 = V_51 ;
struct V_16 * V_16 = F_15 ( V_22 ) ;
if ( V_16 == V_52 ) {
F_47 ( V_16 ) ;
return 1 ;
...
char V_53 [ V_32 ] , V_54 [ V_32 ] ;
F_23 ( V_53 , sizeof( V_53 ) , & V_16 -> V_26 ) ;
F_25 ( V_54 , sizeof( V_54 ) , & V_16 -> V_25 ) ;
F_51 ( V_22 , L_4 ,
V_53 , V_54 ,
V_16 -> V_22 . V_55 -> V_56 ,
V_7 ? F_44 ( & ( V_7 -> V_16 . V_22 ) ) : L_5 ) ;
F_45 ( V_16 ) ;
F_10 ( & V_16 -> V_23 -> V_57 ) ;
F_16 ( V_16 -> V_23 ) ;
F_52 ( V_16 ) ;
...
struct V_16 * V_16 ;
char V_53 [ V_32 ] , V_54 [ V_32 ] ;
F_23 ( V_53 , sizeof( V_53 ) , V_23 -> V_26 ) ;
F_25 ( V_54 , sizeof( V_54 ) , & V_23 -> V_25 ) ;
V_16 = F_55 ( sizeof( struct V_16 ) , V_59 ) ;
if ( V_16 == NULL ) {
F_56 ( V_22 , L_6 ,
V_53 ) ;
return;
