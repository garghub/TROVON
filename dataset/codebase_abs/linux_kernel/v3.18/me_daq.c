...
unsigned int V_16 = F_4 ( V_11 -> V_17 ) ;
unsigned int V_37 = F_12 ( V_11 -> V_17 ) ;
unsigned int V_31 = V_9 -> V_49 [ V_16 ] ;
int V_50 ;
V_36 -> V_21 |= V_51 ;
F_6 ( V_36 -> V_21 , V_7 -> V_24 + V_25 ) ;
V_36 -> V_21 |= V_52 ;
F_6 ( V_36 -> V_21 , V_7 -> V_24 + V_25 ) ;
for ( V_50 = 0 ; V_50 < V_11 -> V_26 ; V_50 ++ ) {
V_36 -> V_53 &= ~ ( 0x0880 >> V_16 ) ;
if ( V_37 == 0 )
V_36 -> V_53 |=
( ( V_54 | V_55 ) >> V_16 ) ;
else if ( V_37 == 1 )
...
F_6 ( V_36 -> V_53 , V_7 -> V_24 + V_57 ) ;
F_9 ( V_7 -> V_24 + V_58 ) ;
for ( V_50 = 0 ; V_50 < V_11 -> V_26 ; V_50 ++ ) {
V_31 = V_12 [ V_50 ] ;
F_6 ( V_31 , V_7 -> V_24 + V_59 + ( V_16 << 1 ) ) ;
}
V_9 -> V_49 [ V_16 ] = V_31 ;
F_9 ( V_7 -> V_24 + V_60 ) ;
return V_11 -> V_26 ;
...
unsigned int V_63 ;
unsigned int V_50 ;
F_17 ( 0x00 , V_36 -> V_64 + V_65 ) ;
V_62 = F_9 ( V_7 -> V_24 + V_66 ) ;
F_1 ( 1 ) ;
F_18 ( 0x00 , V_7 -> V_24 + 0x0 ) ;
F_1 ( 1 ) ;
if ( V_61 < 16 )
return - V_67 ;
V_63 = ( ( ( unsigned int ) V_12 [ 0 ] & 0xff ) << 24 ) +
( ( ( unsigned int ) V_12 [ 1 ] & 0xff ) << 16 ) +
( ( ( unsigned int ) V_12 [ 2 ] & 0xff ) << 8 ) +
( ( unsigned int ) V_12 [ 3 ] & 0xff ) ;
for ( V_50 = 0 ; V_50 < V_63 ; V_50 ++ )
F_18 ( ( V_12 [ 16 + V_50 ] & 0xff ) , V_7 -> V_24 + 0x0 ) ;
for ( V_50 = 0 ; V_50 < 5 ; V_50 ++ )
F_18 ( 0x00 , V_7 -> V_24 + 0x0 ) ;
V_62 = F_19 ( V_36 -> V_64 + V_65 ) ;
if ( V_62 & V_68 ) {
F_17 ( 0x00 , V_36 -> V_64 + V_65 ) ;
F_20 ( V_7 -> V_69 , L_1 ) ;
return - V_70 ;
...
V_7 -> V_80 = V_77 ;
V_7 -> V_81 = V_77 -> V_82 ;
V_36 = F_25 ( V_7 , sizeof( * V_36 ) ) ;
if ( ! V_36 )
return - V_83 ;
V_19 = F_26 ( V_7 ) ;
if ( V_19 )
return V_19 ;
V_36 -> V_64 = F_27 ( V_75 , 0 ) ;
if ( ! V_36 -> V_64 )
return - V_83 ;
V_7 -> V_24 = F_27 ( V_75 , 2 ) ;
if ( ! V_7 -> V_24 )
return - V_83 ;
if ( V_77 -> V_84 ) {
V_19 = F_28 ( V_7 , & F_23 ( V_7 ) -> V_7 ,
V_85 ,
F_16 , 0 ) ;
if ( V_19 < 0 )
return V_19 ;
...
{
return F_35 ( V_7 , & V_110 , V_109 -> V_111 ) ;
}
