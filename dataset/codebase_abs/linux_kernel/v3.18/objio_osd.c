...
{
unsigned int V_175 ;
V_175 = F_63 ( V_171 , V_173 , V_174 ) ;
if ( ! V_175 || V_171 -> V_176 + V_174 -> V_177 >
( unsigned long ) V_171 -> V_178 )
return 0 ;
return F_64 ( V_175 , V_174 -> V_177 ) ;
}
static void F_65 ( struct V_170 * V_171 , struct V_172 * V_174 )
{
F_66 ( V_171 , V_174 ) ;
if ( F_12 ( V_171 -> V_179 == NULL ) )
return;
V_171 -> V_178 = ( void * )
F_6 ( V_171 -> V_179 ) -> V_77 . V_180 ;
}
static bool F_67 ( T_5 V_103 , struct V_181 * V_77 ,
unsigned long * V_182 )
{
T_8 V_183 ;
unsigned V_184 ;
...
F_68 ( V_103 , V_184 , & V_183 ) ;
if ( ! V_183 )
return true ;
* V_182 = V_184 - V_183 ;
return false ;
}
static void F_69 ( struct V_170 * V_171 , struct V_172 * V_174 )
{
unsigned long V_182 = 0 ;
T_5 V_187 ;
if ( V_171 -> V_188 == NULL )
V_187 = F_50 ( V_171 -> V_189 ) - F_70 ( V_174 ) ;
else
V_187 = F_71 ( V_171 -> V_188 ) ;
F_72 ( V_171 , V_174 , V_187 ) ;
if ( F_12 ( V_171 -> V_179 == NULL ) )
return;
if ( V_174 -> V_190 ||
! F_67 ( V_174 -> V_191 * V_118 ,
& F_6 ( V_171 -> V_179 ) -> V_77 ,
& V_182 ) ) {
V_171 -> V_178 = ( void * ) V_182 ;
} else {
V_171 -> V_178 = ( void * )
F_6 ( V_171 -> V_179 ) -> V_77 . V_180 ;
}
