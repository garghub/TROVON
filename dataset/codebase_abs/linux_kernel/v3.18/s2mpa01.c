...
struct V_7 * V_8 ;
int V_65 ;
V_8 = F_12 ( & V_52 -> V_50 , sizeof( * V_8 ) , V_66 ) ;
if ( ! V_8 )
return - V_67 ;
for ( V_65 = 0 ; V_65 < V_68 ; V_65 ++ )
V_59 [ V_65 ] . V_69 = V_70 [ V_65 ] . V_69 ;
if ( V_54 -> V_50 -> V_71 ) {
V_62 = F_13 ( V_54 -> V_50 -> V_71 ,
L_2 ) ;
if ( ! V_62 ) {
F_8 ( & V_52 -> V_50 ,
L_3 ) ;
...
struct V_3 * V_4 ;
if ( V_57 )
V_64 . V_75 = V_57 -> V_70 [ V_65 ] . V_76 ;
else
V_64 . V_75 = V_59 [ V_65 ] . V_75 ;
if ( V_62 )
V_64 . V_71 = V_59 [ V_65 ] . V_71 ;
V_4 = F_16 ( & V_52 -> V_50 ,
& V_70 [ V_65 ] , & V_64 ) ;
if ( F_17 ( V_4 ) ) {
F_8 ( & V_52 -> V_50 , L_4 ,
