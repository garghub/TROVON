...
static int F_18 ( struct V_1 * V_2 , const struct V_24 * V_17 )
{
int V_25 ;
T_3 V_26 ;
char * V_27 ;
...
if ( V_25 )
return 0 ;
V_25 = F_20 ( V_2 , L_1 , V_27 ) ;
F_21 ( V_27 , V_26 ) ;
return V_25 ;
}
static inline int F_18 ( struct V_1 * V_2 , const struct V_24 * V_17 )
{
return 0 ;
}
static int F_22 ( struct V_1 * V_2 , const struct V_24 * V_17 )
{
...
V_6 , V_8 ) )
goto V_37;
if ( F_36 ( V_2 , V_17 , V_46 ) )
goto V_37;
if ( ! ( F_37 ( V_47 , & V_17 -> V_48 ) ) )
if ( F_20 ( V_2 , L_4 ) )
goto V_37;
if ( F_1 ( V_2 , & V_17 -> V_45 [ V_49 ] . V_4 ,
V_6 , V_8 ) )
goto V_37;
if ( F_36 ( V_2 , V_17 , V_49 ) )
goto V_37;
if ( F_37 ( V_50 , & V_17 -> V_48 ) )
if ( F_20 ( V_2 , L_5 ) )
goto V_37;
#if F_38 ( V_51 )
if ( F_20 ( V_2 , L_6 , V_17 -> V_52 ) )
goto V_37;
#endif
if ( F_18 ( V_2 , V_17 ) )
goto V_37;
#ifdef F_39
if ( F_20 ( V_2 , L_7 , F_40 ( V_17 ) ) )
goto V_37;
#endif
if ( F_22 ( V_2 , V_17 ) )
goto V_37;
if ( F_20 ( V_2 , L_8 , F_41 ( & V_17 -> V_35 . V_36 ) ) )
goto V_37;
V_25 = 0 ;
V_37:
F_42 ( V_17 ) ;
...
static int F_43 ( struct V_53 * V_53 , struct V_54 * V_54 )
{
return F_44 ( V_53 , V_54 , & V_55 ,
sizeof( struct V_12 ) ) ;
}
static void * F_45 ( struct V_1 * V_10 , T_1 * V_21 )
{
struct V_11 * V_11 = F_3 ( V_10 ) ;
int V_56 ;
if ( * V_21 == 0 )
...
continue;
* V_21 = V_56 + 1 ;
return F_47 ( V_11 -> V_17 . V_59 , V_56 ) ;
}
return NULL ;
}
static void * F_48 ( struct V_1 * V_10 , void * V_23 , T_1 * V_21 )
{
struct V_11 * V_11 = F_3 ( V_10 ) ;
int V_56 ;
...
static void F_49 ( struct V_1 * V_10 , void * V_23 )
{
}
static int F_50 ( struct V_1 * V_10 , void * V_23 )
{
struct V_11 * V_11 = F_3 ( V_10 ) ;
unsigned int V_60 = F_41 ( & V_11 -> V_17 . V_61 ) ;
...
static int F_51 ( struct V_53 * V_53 , struct V_54 * V_54 )
{
return F_44 ( V_53 , V_54 , & V_78 ,
sizeof( struct V_79 ) ) ;
}
static int F_52 ( struct V_11 * V_11 )
{
struct V_80 * V_81 ;
V_81 = F_53 ( L_12 , 0440 , V_11 -> V_82 , & V_83 ) ;
if ( ! V_81 )
goto V_84;
V_81 = F_53 ( L_12 , V_85 , V_11 -> V_86 ,
& V_87 ) ;
if ( ! V_81 )
goto V_88;
return 0 ;
...
if ( V_11 -> V_98 != & V_99 )
V_91 [ 0 ] . V_100 = NULL ;
V_11 -> V_17 . V_101 = F_58 ( V_11 , L_13 , V_91 ) ;
if ( ! V_11 -> V_17 . V_101 )
goto V_102;
return 0 ;
V_102:
...
{
struct V_11 * V_11 ;
F_66 (net, net_exit_list, exit_list) {
F_60 ( V_11 ) ;
F_55 ( V_11 ) ;
}
F_67 ( V_108 ) ;
