...
T_3 F_98 ( int V_167 , void * V_168 )
{
return F_99 ( V_167 , V_168 , F_97 ) ;
}
...
unsigned int F_108 ( struct V_68 * V_69 , int V_176 ,
T_1 * V_177 )
{
struct V_1 * V_2 = V_69 -> V_19 -> V_2 ;
struct V_39 V_40 ;
...
int F_110 ( struct V_18 * V_19 , unsigned int V_182 ,
unsigned long V_20 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
struct V_34 * V_3 = & V_2 -> V_3 ;
...
static int F_111 ( struct V_1 * V_2 , unsigned int V_182 ,
unsigned long V_20 )
{
struct V_34 * V_3 = & V_2 -> V_3 ;
F_36 ( L_32 , V_2 -> V_64 ) ;
...
return F_110 ( & V_2 -> V_19 , V_182 , V_20 ) ;
}
int F_113 ( struct V_18 * V_19 , unsigned int * V_188 ,
unsigned long V_20 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
...
if ( F_107 ( V_2 , 0 ) )
V_182 |= ( 1 << 0 ) ;
if ( V_189 && F_107 ( V_2 , 1 ) )
V_182 |= ( 1 << 1 ) ;
V_2 -> V_5 -> V_31 ( V_2 , 0 ) ;
F_36 ( L_33 , V_182 ) ;
V_172 = F_111 ( V_2 , V_182 , V_20 ) ;
if ( V_172 && ( V_172 != - V_16 || F_114 ( V_19 ) ) ) {
F_115 ( V_19 , L_34 , V_172 ) ;
return V_172 ;
}
V_188 [ 0 ] = F_108 ( & V_19 -> V_24 [ 0 ] ,
V_182 & ( 1 << 0 ) , & V_178 ) ;
if ( V_189 && V_178 != 0x81 )
V_188 [ 1 ] = F_108 ( & V_19 -> V_24 [ 1 ] ,
V_182 & ( 1 << 1 ) , & V_178 ) ;
...
{
struct V_169 * V_170 = & V_19 -> V_171 ;
const unsigned long * V_191 = F_117 ( V_170 ) ;
bool V_192 ;
int V_172 ;
V_172 = F_118 ( V_19 , V_191 , V_20 , & V_192 ,
F_18 ) ;
if ( V_192 )
...
void F_119 ( struct V_18 * V_19 , unsigned int * V_188 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
F_120 ( V_19 , V_188 ) ;
if ( V_188 [ 0 ] != V_179 )
...
F_73 ( V_2 -> V_135 , V_42 ) ;
if ( ( V_196 == V_199 ||
V_196 == F_116 ) && ! F_114 ( & V_2 -> V_19 ) )
V_196 = NULL ;
F_125 ( V_2 , V_2 -> V_5 -> V_200 , V_195 , V_196 ,
V_2 -> V_5 -> V_201 ) ;
}
...
static int F_127 ( struct V_213 * V_214 , int V_215 )
{
int V_173 ;
V_215 = V_215 * 2 ;
for ( V_173 = 0 ; V_173 < 2 ; V_173 ++ ) {
if ( F_128 ( V_214 , V_215 + V_173 ) == 0 ||
F_129 ( V_214 , V_215 + V_173 ) == 0 )
return 0 ;
}
return 1 ;
}
int F_130 ( struct V_216 * V_217 )
{
struct V_24 * V_218 = V_217 -> V_69 ;
struct V_213 * V_214 = F_131 ( V_218 ) ;
...
if ( F_132 ( V_2 ) )
continue;
if ( ! F_127 ( V_214 , V_173 ) ) {
V_2 -> V_5 = & V_223 ;
continue;
}
V_172 = F_133 ( V_214 , 0x3 << V_221 ,
F_134 ( V_218 ) ) ;
if ( V_172 ) {
F_135 ( V_218 ,
L_39 ,
...
F_126 ( & V_2 -> V_3 ) ;
F_138 ( V_2 , L_40 ,
( unsigned long long ) F_128 ( V_214 , V_221 ) ,
( unsigned long long ) F_128 ( V_214 , V_221 + 1 ) ) ;
V_219 |= 1 << V_173 ;
}
if ( ! V_219 ) {
F_139 ( V_218 , L_41 ) ;
...
int F_140 ( struct V_213 * V_214 ,
const struct F_27 * const * V_225 ,
struct V_216 * * V_226 )
{
struct V_216 * V_217 ;
int V_172 ;
if ( ! F_141 ( & V_214 -> V_69 , NULL , V_227 ) )
return - V_228 ;
V_217 = F_142 ( & V_214 -> V_69 , V_225 , 2 ) ;
if ( ! V_217 ) {
F_139 ( & V_214 -> V_69 , L_42 ) ;
V_172 = - V_228 ;
goto V_125;
}
V_172 = F_130 ( V_217 ) ;
if ( V_172 )
goto V_125;
F_143 ( & V_214 -> V_69 , NULL ) ;
* V_226 = V_217 ;
return 0 ;
V_125:
F_144 ( & V_214 -> V_69 , NULL ) ;
return V_172 ;
}
int F_145 ( struct V_216 * V_217 ,
T_5 V_229 ,
struct V_230 * V_231 )
{
struct V_24 * V_69 = V_217 -> V_69 ;
struct V_213 * V_214 = F_131 ( V_69 ) ;
const char * V_232 = F_134 ( V_217 -> V_69 ) ;
int V_233 = 0 , V_172 ;
V_172 = F_146 ( V_217 ) ;
if ( V_172 )
return V_172 ;
...
T_1 V_235 , V_219 ;
F_147 ( V_214 , V_236 , & V_235 ) ;
V_219 = ( 1 << 2 ) | ( 1 << 0 ) ;
if ( ( V_235 & V_219 ) != V_219 )
V_233 = 1 ;
}
if ( ! F_141 ( V_69 , NULL , V_227 ) )
return - V_228 ;
if ( ! V_233 && V_214 -> V_167 ) {
int V_173 ;
V_172 = F_148 ( V_69 , V_214 -> V_167 , V_229 ,
V_237 , V_232 , V_217 ) ;
if ( V_172 )
goto V_238;
for ( V_173 = 0 ; V_173 < 2 ; V_173 ++ ) {
if ( F_132 ( V_217 -> V_220 [ V_173 ] ) )
continue;
F_138 ( V_217 -> V_220 [ V_173 ] , L_43 , V_214 -> V_167 ) ;
}
} else if ( V_233 ) {
if ( ! F_132 ( V_217 -> V_220 [ 0 ] ) ) {
V_172 = F_148 ( V_69 , F_149 ( V_214 ) ,
V_229 , V_237 ,
V_232 , V_217 ) ;
if ( V_172 )
goto V_238;
F_138 ( V_217 -> V_220 [ 0 ] , L_43 ,
F_149 ( V_214 ) ) ;
}
if ( ! F_132 ( V_217 -> V_220 [ 1 ] ) ) {
V_172 = F_148 ( V_69 , F_150 ( V_214 ) ,
V_229 , V_237 ,
V_232 , V_217 ) ;
if ( V_172 )
goto V_238;
F_138 ( V_217 -> V_220 [ 1 ] , L_43 ,
F_150 ( V_214 ) ) ;
}
}
V_172 = F_151 ( V_217 , V_231 ) ;
V_238:
if ( V_172 == 0 )
F_143 ( V_69 , NULL ) ;
else
...
static const struct F_27 * F_152 (
const struct F_27 * const * V_225 )
{
int V_173 ;
...
#ifdef F_62
if ( V_242 )
V_172 = F_155 ( V_214 , V_225 , & V_217 ) ;
else
#endif
V_172 = F_140 ( V_214 , V_225 , & V_217 ) ;
if ( V_172 )
goto V_238;
V_217 -> V_245 = V_240 ;
V_217 -> V_42 |= V_241 ;
...
if ( V_242 ) {
F_156 ( V_214 ) ;
V_172 = F_145 ( V_217 , V_246 , V_231 ) ;
} else
#endif
V_172 = F_145 ( V_217 , F_98 , V_231 ) ;
V_238:
if ( V_172 == 0 )
F_143 ( & V_214 -> V_69 , NULL ) ;
else
...
{
return F_153 ( V_214 , V_225 , V_231 , V_240 , V_247 , 0 ) ;
}
static void F_158 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = V_82 -> V_2 ;
...
V_243 = 0 ;
F_159 (qc->sg, sg, qc->n_elem, si) {
T_6 V_252 , V_86 ;
T_6 V_253 , V_254 ;
V_252 = ( T_6 ) F_160 ( V_113 ) ;
V_253 = F_161 ( V_113 ) ;
while ( V_253 ) {
V_86 = V_252 & 0xffff ;
V_254 = V_253 ;
...
V_254 = 0x10000 - V_86 ;
V_249 [ V_243 ] . V_252 = F_162 ( V_252 ) ;
V_249 [ V_243 ] . V_255 = F_162 ( V_254 & 0xffff ) ;
...
V_249 [ V_243 - 1 ] . V_255 |= F_162 ( V_256 ) ;
}
static void F_163 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = V_82 -> V_2 ;
struct V_248 * V_249 = V_2 -> V_250 ;
struct V_112 * V_113 ;
...
V_249 [ V_243 ] . V_252 = F_162 ( V_252 ) ;
if ( V_257 == 0 ) {
V_249 [ V_243 ] . V_255 = F_162 ( 0x8000 ) ;
V_257 = 0x8000 ;
V_249 [ ++ V_243 ] . V_252 = F_162 ( V_252 + 0x8000 ) ;
}
V_249 [ V_243 ] . V_255 = F_162 ( V_257 ) ;
F_32 ( L_45 , V_243 , V_252 , V_254 ) ;
V_243 ++ ;
V_253 -= V_254 ;
V_252 += V_254 ;
...
void F_165 ( struct V_81 * V_82 )
{
if ( ! ( V_82 -> V_42 & V_258 ) )
return;
F_163 ( V_82 ) ;
}
unsigned int F_166 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = V_82 -> V_2 ;
struct V_18 * V_19 = V_82 -> V_69 -> V_19 ;
if ( ! F_167 ( V_82 -> V_40 . V_101 ) )
return F_91 ( V_82 ) ;
F_25 ( V_2 , V_82 -> V_69 -> V_148 , 1 , 0 ) ;
switch ( V_82 -> V_40 . V_101 ) {
case V_259 :
...
unsigned int F_168 ( struct V_1 * V_2 , struct V_81 * V_82 )
{
struct V_109 * V_110 = & V_2 -> V_19 . V_111 ;
T_1 V_261 = 0 ;
bool V_262 = false ;
unsigned int V_263 ;
if ( V_2 -> V_90 == V_91 && F_167 ( V_82 -> V_40 . V_101 ) ) {
...
V_263 = F_96 ( V_2 , V_82 , V_262 ) ;
if ( F_41 ( V_82 -> V_126 ) && F_167 ( V_82 -> V_40 . V_101 ) )
F_64 ( V_110 , L_47 , V_261 ) ;
return V_263 ;
}
T_3 V_246 ( int V_167 , void * V_168 )
{
return F_99 ( V_167 , V_168 , F_168 ) ;
}
...
T_1 V_274 ;
F_174 () ;
F_175 ( V_2 -> V_275 , V_2 -> V_3 . V_272 + V_276 ) ;
...
int F_182 ( struct V_213 * V_214 )
{
unsigned long V_242 = F_128 ( V_214 , 4 ) ;
T_1 V_284 ;
if ( V_242 == 0 )
return - V_285 ;
V_284 = F_183 ( V_242 + 0x02 ) ;
F_184 ( V_284 & 0x60 , V_242 + 0x02 ) ;
V_284 = F_183 ( V_242 + 0x02 ) ;
if ( V_284 & 0x80 )
return - V_286 ;
return 0 ;
}
static void F_185 ( struct V_216 * V_217 , const char * V_287 )
{
int V_173 ;
F_139 ( V_217 -> V_69 , L_48 , V_287 ) ;
for ( V_173 = 0 ; V_173 < 2 ; V_173 ++ ) {
V_217 -> V_220 [ V_173 ] -> V_280 = 0 ;
V_217 -> V_220 [ V_173 ] -> V_281 = 0 ;
}
}
void F_186 ( struct V_216 * V_217 )
{
struct V_24 * V_218 = V_217 -> V_69 ;
struct V_213 * V_214 = F_131 ( V_218 ) ;
int V_173 , V_172 ;
...
V_172 = F_187 ( V_214 , V_288 ) ;
if ( V_172 )
F_185 ( V_217 , L_50 ) ;
if ( ! V_172 ) {
V_172 = F_188 ( V_214 , V_288 ) ;
if ( V_172 )
F_185 ( V_217 ,
L_51 ) ;
}
V_172 = F_133 ( V_214 , 1 << 4 , F_134 ( V_218 ) ) ;
if ( V_172 ) {
F_185 ( V_217 , L_52 ) ;
return;
}
V_217 -> V_222 = F_137 ( V_214 ) ;
for ( V_173 = 0 ; V_173 < 2 ; V_173 ++ ) {
struct V_1 * V_2 = V_217 -> V_220 [ V_173 ] ;
...
V_217 -> V_42 |= V_290 ;
F_138 ( V_2 , L_53 ,
( unsigned long long ) F_128 ( V_214 , 4 ) + 8 * V_173 ) ;
}
}
int F_155 ( struct V_213 * V_214 ,
const struct F_27 * const * V_225 ,
struct V_216 * * V_226 )
{
int V_172 ;
V_172 = F_140 ( V_214 , V_225 , V_226 ) ;
if ( V_172 )
return V_172 ;
F_186 ( * V_226 ) ;
return 0 ;
}
int F_189 ( struct V_213 * V_214 ,
const struct F_27 * const * V_225 ,
struct V_230 * V_231 , void * V_240 ,
int V_241 )
{
return F_153 ( V_214 , V_225 , V_231 , V_240 , V_241 , 1 ) ;
}
void F_190 ( struct V_1 * V_2 )
{
F_191 ( & V_2 -> V_157 , F_88 ) ;
V_2 -> V_21 = V_291 ;
V_2 -> V_37 = 0xFF ;
}
int T_7 F_192 ( void )
{
V_152 = F_193 ( L_54 , V_292 , V_293 ) ;
if ( ! V_152 )
return - V_228 ;
return 0 ;
}
