...
{
return V_30 [
( F_10 ( V_4 -> V_5 -> V_31 [ 0 ] ) << 1 ) |
F_10 ( V_4 -> V_5 -> V_31 [ 1 ] ) ] ;
}
static inline void F_11 ( struct V_3 * V_4 )
{
F_2 ( V_4 -> V_5 -> V_31 [ 0 ] ,
V_32 [ ( V_4 -> V_33 - 10 ) / 2 ] [ 0 ] ) ;
F_2 ( V_4 -> V_5 -> V_31 [ 1 ] ,
V_32 [ ( V_4 -> V_33 - 10 ) / 2 ] [ 1 ] ) ;
}
...
char * V_39 )
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
return sprintf ( V_39 , L_2 , V_4 -> V_25 ) ;
}
static T_2 F_16 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
const char * V_39 ,
T_3 V_17 )
{
...
static T_2 F_20 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
char * V_39 )
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
...
static T_2 F_21 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
...
static T_2 F_23 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
const char * V_39 , T_3 V_17 )
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
...
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
return sprintf ( V_39 , L_2 , V_4 -> V_33 ) ;
}
static T_2 F_27 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
const char * V_39 , T_3 V_17 )
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
...
F_19 ( & V_4 -> V_43 ) ;
return V_9 < 0 ? V_9 : sprintf ( V_39 , L_2 , V_9 ) ;
}
static T_2 F_33 ( struct V_35 * V_36 ,
struct V_37 * V_38 , const char * V_39 , T_3 V_17 )
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
unsigned char V_8 ;
int V_9 ;
...
struct V_78 V_79 [] = {
{ V_4 -> V_5 -> V_55 , V_76 , L_10 } ,
{ V_4 -> V_5 -> V_6 [ 0 ] , V_75 , L_11 } ,
{ V_4 -> V_5 -> V_6 [ 1 ] , V_75 , L_12 } ,
{ V_4 -> V_5 -> V_31 [ 0 ] , V_75 , L_13 } ,
{ V_4 -> V_5 -> V_31 [ 0 ] , V_75 , L_14 } ,
} ;
...
struct V_3 * V_4 ;
int V_9 ;
if ( V_81 -> V_36 . V_82 == NULL )
return - V_42 ;
V_59 = F_44 ( & V_81 -> V_36 , sizeof( * V_4 ) ) ;
if ( ! V_59 )
return - V_83 ;
V_4 = F_14 ( V_59 ) ;
V_4 -> V_5 = V_81 -> V_36 . V_82 ;
V_9 = F_38 ( V_4 ) ;
if ( V_9 < 0 )
return V_9 ;
F_45 ( V_81 , V_59 ) ;
