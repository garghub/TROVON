...
break;
case V_113 :
if ( V_42 && ! F_36 ( V_40 -> V_114 , V_115 ) &&
! F_36 ( V_40 -> V_114 , V_116 ) ) {
V_43 = - V_117 ;
break;
}
if ( V_37 < sizeof( int ) )
...
goto V_46;
else if ( V_37 < sizeof( struct V_125 ) ||
V_37 & 0x7 || V_37 > 8 * 255 )
goto V_46;
V_43 = - V_117 ;
if ( V_35 != V_123 && ! F_36 ( V_40 -> V_114 , V_116 ) )
break;
V_19 = F_37 ( V_2 , V_39 -> V_19 , V_35 ,
(struct V_125 T_1 * ) V_36 ,
V_37 ) ;
if ( F_38 ( V_19 ) ) {
V_43 = F_39 ( V_19 ) ;
break;
...
V_43 = - V_126 ;
if ( V_35 == V_123 && V_19 && V_19 -> V_94 ) {
struct V_127 * V_128 = V_19 -> V_94 ;
switch ( V_128 -> type ) {
#if F_40 ( V_129 )
case V_130 :
if ( V_128 -> V_131 != 2 ||
...
V_43 = F_43 ( V_40 , V_2 , & V_143 , & V_145 , V_19 , & V_146 ,
& V_146 , & V_146 ) ;
if ( V_43 )
goto V_151;
V_150:
...
{
int V_246 ;
if ( V_34 == V_247 && V_2 -> V_8 != V_9 )
return V_73 . V_248 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
if ( V_34 != V_249 )
return - V_12 ;
V_246 = F_16 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
#ifdef F_59
if ( V_246 == - V_12 && V_35 != V_225 &&
V_35 != V_226 ) {
F_21 ( V_2 ) ;
V_246 = F_60 ( V_2 , V_250 , V_35 , V_36 ,
V_37 ) ;
F_57 ( V_2 ) ;
}
#endif
...
if ( V_34 == V_247 && V_2 -> V_8 != V_9 ) {
if ( V_73 . V_251 != NULL )
return V_73 . V_251 ( V_2 , V_34 , V_35 ,
V_36 , V_37 ) ;
return V_73 . V_248 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
}
if ( V_34 != V_249 )
...
int V_35 , char T_1 * V_36 , int V_252 )
{
struct V_125 * V_253 ;
if ( ! V_19 )
return 0 ;
...
if ( ! V_253 )
return 0 ;
V_252 = F_65 (unsigned int, len, ipv6_optlen(hdr)) ;
if ( F_66 ( V_36 , V_253 , V_252 ) )
return - V_44 ;
return V_252 ;
}
static int F_67 ( struct V_1 * V_2 , int V_34 , int V_35 ,
char T_1 * V_36 , int T_1 * V_37 , unsigned int V_257 )
{
struct V_38 * V_39 = F_12 ( V_2 ) ;
int V_252 ;
int V_41 ;
...
if ( V_252 < F_52 ( 0 ) )
return - V_126 ;
if ( F_41 ( & V_207 , V_36 , F_52 ( 0 ) ) )
return - V_44 ;
if ( V_207 . V_258 . V_189 != V_56 )
return - V_62 ;
F_21 ( V_2 ) ;
V_246 = F_69 ( V_2 , & V_207 ,
(struct V_206 T_1 * ) V_36 , V_37 ) ;
F_57 ( V_2 ) ;
return V_246 ;
}
case V_141 :
...
F_57 ( V_2 ) ;
if ( V_259 ) {
F_71 ( V_2 , & V_143 , V_259 ) ;
F_33 ( V_259 ) ;
} else {
if ( V_39 -> V_84 . V_85 . V_86 ) {
struct V_135 V_262 ;
V_262 . V_138 = V_39 -> V_171 ? V_39 -> V_171 :
V_39 -> V_139 . V_138 ;
V_262 . V_140 = V_39 -> V_171 ? V_2 -> V_61 : V_39 -> V_139 . V_140 ;
F_72 ( & V_143 , V_249 , V_134 , sizeof( V_262 ) , & V_262 ) ;
}
if ( V_39 -> V_84 . V_85 . V_90 ) {
int V_263 = V_39 -> V_158 ;
F_72 ( & V_143 , V_249 , V_264 , sizeof( V_263 ) , & V_263 ) ;
}
if ( V_39 -> V_84 . V_85 . V_108 ) {
int V_106 = ( int ) F_73 ( V_39 -> V_265 ) ;
F_72 ( & V_143 , V_249 , V_105 , sizeof( V_106 ) , & V_106 ) ;
}
if ( V_39 -> V_84 . V_85 . V_88 ) {
struct V_135 V_262 ;
V_262 . V_138 = V_39 -> V_171 ? V_39 -> V_171 :
V_39 -> V_139 . V_138 ;
V_262 . V_140 = V_39 -> V_171 ? V_2 -> V_61 :
V_39 -> V_139 . V_140 ;
F_72 ( & V_143 , V_249 , V_87 , sizeof( V_262 ) , & V_262 ) ;
}
if ( V_39 -> V_84 . V_85 . V_92 ) {
int V_263 = V_39 -> V_158 ;
F_72 ( & V_143 , V_249 , V_91 , sizeof( V_263 ) , & V_263 ) ;
}
if ( V_39 -> V_84 . V_85 . V_110 ) {
V_167 V_266 = V_39 -> V_265 ;
F_72 ( & V_143 , V_249 , V_109 , sizeof( V_266 ) , & V_266 ) ;
}
}
V_252 -= V_143 . V_152 ;
return F_74 ( V_252 , V_37 ) ;
}
case V_216 :
{
struct V_267 * V_268 ;
...
V_268 = F_76 ( V_2 ) ;
if ( V_268 )
V_271 . V_272 = F_77 ( V_268 ) ;
F_78 () ;
if ( ! V_271 . V_272 )
return - V_60 ;
if ( F_74 ( V_252 , V_37 ) )
return - V_44 ;
if ( F_66 ( V_36 , & V_271 , V_252 ) )
return - V_44 ;
return 0 ;
}
case V_113 :
...
if ( V_41 < 0 )
V_41 = F_17 ( V_2 ) -> V_273 . V_274 -> V_155 ;
break;
}
case V_160 :
V_41 = V_39 -> V_161 ;
...
break;
case V_162 :
V_41 = ( V_166 int ) F_80 ( ( V_275 ) V_39 -> V_168 ) ;
break;
case V_212 :
V_41 = V_39 -> V_215 ;
break;
...
struct V_276 V_277 ;
int V_257 ;
if ( V_252 < sizeof( V_277 ) )
return - V_126 ;
if ( F_41 ( & V_277 , V_36 , sizeof( V_277 ) ) )
return - V_44 ;
...
V_41 = F_81 ( V_2 , & V_277 , V_257 ) ;
if ( V_41 < 0 )
return V_41 ;
if ( F_74 ( V_252 , V_37 ) )
return - V_44 ;
if ( F_66 ( V_36 , & V_277 , V_252 ) )
return - V_44 ;
return 0 ;
}
case V_227 :
...
V_252 = F_65 (unsigned int, sizeof(int), len) ;
if ( F_74 ( V_252 , V_37 ) )
return - V_44 ;
if ( F_66 ( V_36 , & V_41 , V_252 ) )
return - V_44 ;
return 0 ;
}
...
int V_246 ;
if ( V_34 == V_247 && V_2 -> V_8 != V_9 )
return V_73 . V_281 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
if ( V_34 != V_249 )
return - V_12 ;
V_246 = F_67 ( V_2 , V_34 , V_35 , V_36 , V_37 , 0 ) ;
#ifdef F_59
if ( V_246 == - V_12 && V_35 != V_141 ) {
int V_252 ;
if ( F_18 ( V_252 , V_37 ) )
return - V_44 ;
F_21 ( V_2 ) ;
V_246 = F_83 ( V_2 , V_250 , V_35 , V_36 ,
& V_252 ) ;
F_57 ( V_2 ) ;
if ( V_246 >= 0 )
V_246 = F_74 ( V_252 , V_37 ) ;
}
#endif
return V_246 ;
}
int F_84 ( struct V_1 * V_2 , int V_34 , int V_35 ,
char T_1 * V_36 , int T_1 * V_37 )
{
int V_246 ;
if ( V_34 == V_247 && V_2 -> V_8 != V_9 ) {
if ( V_73 . V_282 != NULL )
return V_73 . V_282 ( V_2 , V_34 , V_35 ,
V_36 , V_37 ) ;
return V_73 . V_281 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
}
if ( V_34 != V_249 )
return - V_12 ;
if ( V_35 == V_205 )
return F_85 ( V_2 , V_34 , V_35 , V_36 , V_37 ,
F_82 ) ;
V_246 = F_67 ( V_2 , V_34 , V_35 , V_36 , V_37 ,
V_283 ) ;
#ifdef F_59
if ( V_246 == - V_12 && V_35 != V_141 ) {
int V_252 ;
