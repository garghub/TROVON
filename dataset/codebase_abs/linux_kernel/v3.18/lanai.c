...
static int F_29 ( const struct V_1 * V_2 , int V_31 ,
V_17 V_33 )
{
V_17 V_34 ;
F_28 ( V_2 , V_33 , V_31 ) ;
...
static int F_32 ( const struct V_1 * V_2 , V_17 V_33 )
{
int V_31 , V_36 = 0 ;
...
T_5 V_102 ;
V_17 V_103 ;
#define F_63 ( T_6 ) do { lanai->conf1 = x; conf1_write(lanai); \
} while (0)
...
static inline const T_5 * F_74 ( const struct V_1 * V_2 )
{
...
L_70 ,
V_159 , F_7 ( & V_40 -> V_51 . V_6 ) ) ;
if ( ( T_6 = & V_16 [ - 2 ] ) < V_40 -> V_51 . V_6 . V_13 )
T_6 = & V_40 -> V_51 . V_6 . V_16 [ - 2 ] ;
F_109 () ;
V_11 = F_72 ( T_6 ) & 0xffff ;
if ( F_22 ( V_159 != F_38 ( V_11 ) ) ) {
F_31 (KERN_INFO DEV_LABEL L_71
L_72 ,
lvcc->rx.atmvcc->dev->number, lvcc->vci, size, n) ;
V_40 -> V_166 . T_6 . V_170 . V_171 ++ ;
goto V_172;
}
...
static T_10 F_162 ( int V_243 , void * V_244 )
{
...
{
int V_266 = 0 ;
int T_6 , V_267 , V_268 = F_177 ( & V_52 -> V_74 ) ;
if ( V_268 == 0 )
return 0 ;
if ( V_268 < 0 ) {
V_266 = 1 ;
...
static int F_180 ( struct V_274 * V_275 )
{
...
V_40 -> V_51 . V_46 = V_46 ;
V_40 -> V_166 . V_174 = 0 ;
V_40 -> V_166 . T_6 . V_170 . V_171 = 0 ;
V_40 -> V_166 . T_6 . V_170 . V_209 = 0 ;
V_40 -> V_166 . T_6 . V_170 . V_211 = 0 ;
V_40 -> V_166 . T_6 . V_170 . V_212 = 0 ;
if ( V_46 -> V_52 . V_53 == V_186 )
V_2 -> V_256 ++ ;
}
...
static int F_200 ( struct V_274 * V_275 , T_11 * V_150 , char * V_317 )
{
struct V_1 * V_2 = (struct V_1 * ) V_275 -> V_276 ;
T_11 V_318 = * V_150 ;
struct V_39 * V_40 ;
