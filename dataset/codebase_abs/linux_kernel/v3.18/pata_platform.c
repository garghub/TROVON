...
F_9 ( V_39 ) ) ;
V_47 -> V_14 . V_61 = F_8 ( V_5 , V_40 -> V_52 ,
F_9 ( V_40 ) ) ;
} else {
V_47 -> V_14 . V_17 = F_10 ( V_5 , V_39 -> V_52 ,
F_9 ( V_39 ) ) ;
V_47 -> V_14 . V_61 = F_10 ( V_5 , V_40 -> V_52 ,
F_9 ( V_40 ) ) ;
}
if ( ! V_47 -> V_14 . V_17 || ! V_47 -> V_14 . V_61 ) {
F_11 ( V_5 , L_3 ) ;
return - V_54 ;
}
V_47 -> V_14 . V_62 = V_47 -> V_14 . V_61 ;
F_4 ( & V_47 -> V_14 , V_42 ) ;
F_7 ( V_47 , L_4 , V_48 ? L_5 : L_6 ,
( unsigned long long ) V_39 -> V_52 ,
( unsigned long long ) V_40 -> V_52 ) ;
return F_12 ( V_45 , V_49 , V_49 ? V_63 : NULL ,
V_50 , & V_64 ) ;
}
...
struct V_38 * V_40 ;
struct V_38 * V_41 ;
struct V_67 * V_68 = F_14 ( & V_66 -> V_5 ) ;
if ( ( V_66 -> V_69 != 3 ) && ( V_66 -> V_69 != 2 ) ) {
F_11 ( & V_66 -> V_5 , L_7 ) ;
return - V_70 ;
}
V_39 = F_15 ( V_66 , V_71 , 0 ) ;
if ( V_39 == NULL ) {
V_39 = F_15 ( V_66 , V_51 , 0 ) ;
if ( F_16 ( V_39 == NULL ) )
return - V_70 ;
}
V_40 = F_15 ( V_66 , V_71 , 1 ) ;
if ( V_40 == NULL ) {
V_40 = F_15 ( V_66 , V_51 , 1 ) ;
if ( F_16 ( V_40 == NULL ) )
return - V_70 ;
}
V_41 = F_15 ( V_66 , V_72 , 0 ) ;
return F_5 ( & V_66 -> V_5 , V_39 , V_40 , V_41 ,
V_68 ? V_68 -> V_42 : 0 ,
V_58 ) ;
}
