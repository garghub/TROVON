...
static void F_36 ( struct V_91 * V_14 , int V_121 )
{
struct V_1 * V_2 = (struct V_1 * ) V_14 ;
unsigned long V_85 ;
unsigned char V_103 ;
...
unsigned long V_85 ;
unsigned char V_108 ;
int V_123 = F_38 ( V_2 -> V_14 . V_82 , F_25 ,
V_124 , L_1 , V_2 ) ;
if ( V_123 )
return V_123 ;
F_26 ( & V_2 -> V_14 . V_87 , V_85 ) ;
...
static void F_41 ( int V_155 , int * V_156 , int * V_157 )
{
int V_158 , V_159 ;
if ( V_155 == 0 ) {
* V_156 = 0 ;
...
static void F_42 ( struct V_1 * V_2 , unsigned int V_161 ,
...
static void F_44 ( struct V_91 * V_14 , struct V_188 * V_189 ,
struct V_188 * V_190 )
{
struct V_1 * V_2 = (struct V_1 * ) V_14 ;
unsigned long V_85 ;
unsigned int V_155 = F_45 ( V_14 , V_189 , V_190 , 0 , 4000000 ) ;
unsigned int V_163 = F_46 ( V_14 , V_155 ) ;
F_26 ( & V_2 -> V_14 . V_87 , V_85 ) ;
F_42 ( V_2 , V_189 -> V_191 , V_189 -> V_192 , V_155 , V_163 ) ;
F_27 ( & V_2 -> V_14 . V_87 , V_85 ) ;
}
...
static int F_51 ( struct V_91 * V_14 , struct V_194 * V_195 )
{
return - V_196 ;
}
static void F_52 ( struct V_91 * V_14 , int V_197 )
{
struct V_1 * V_2 = (struct V_1 * ) V_14 ;
F_1 ( V_2 ) ;
F_6 ( V_197 , & V_2 -> V_5 -> V_29 . V_117 ) ;
}
static void F_53 ( struct V_198 * V_199 , const char * V_200 , unsigned V_158 )
{
struct V_1 * V_2 = & V_201 [ V_199 -> V_37 ] ;
unsigned long V_85 ;
int V_202 = 1 ;
if ( V_2 -> V_14 . V_203 || V_204 )
V_202 = F_54 ( & V_2 -> V_14 . V_87 , V_85 ) ;
else
F_26 ( & V_2 -> V_14 . V_87 , V_85 ) ;
F_55 ( & V_2 -> V_14 , V_200 , V_158 , F_52 ) ;
F_1 ( V_2 ) ;
if ( V_202 )
F_27 ( & V_2 -> V_14 . V_87 , V_85 ) ;
}
static int F_56 ( struct V_198 * V_199 , char * V_205 )
{
struct V_1 * V_2 = & V_201 [ V_199 -> V_37 ] ;
unsigned long V_85 ;
...
F_58 ( V_199 , V_2 -> V_14 . V_209 -> V_210 ) ;
...
V_65 ;
F_6 ( V_2 -> V_58 , & V_2 -> V_5 -> V_29 . V_60 ) ;
V_163 = F_46 ( & V_2 -> V_14 , V_155 ) ;
F_42 ( V_2 , V_199 -> V_161 , 0 , V_155 , V_163 ) ;
F_31 ( & V_2 -> V_14 , V_99 | V_95 ) ;
F_27 ( & V_2 -> V_14 . V_87 , V_85 ) ;
return 0 ;
}
static inline struct V_198 * F_60 ( void )
{
return & V_226 ;
}
...
V_2 -> V_14 . V_233 = F_62 ( & V_228 -> V_231 [ 0 ] , V_229 ,
sizeof( union V_234 ) ,
L_1 ) ;
if ( ! V_2 -> V_14 . V_233 )
return - V_235 ;
...
static int F_63 ( struct V_227 * V_228 )
{
static int V_250 ;
struct V_1 * V_2 ;
int V_123 ;
V_2 = & V_201 [ V_250 * 2 ] ;
V_123 = F_61 ( & V_2 [ 0 ] , V_228 ,
0 ,
( V_250 * 2 ) + 0 ) ;
if ( V_123 )
goto V_251;
V_123 = F_61 ( & V_2 [ 1 ] , V_228 ,
sizeof( union V_234 ) ,
( V_250 * 2 ) + 1 ) ;
if ( V_123 )
goto V_252;
F_64 ( F_60 () , V_228 -> V_209 . V_210 ,
& V_207 , V_2 [ 0 ] . V_14 . line ,
false ) ;
F_64 ( F_60 () , V_228 -> V_209 . V_210 ,
& V_207 , V_2 [ 1 ] . V_14 . line ,
false ) ;
V_123 = F_65 ( & V_207 , & V_2 [ 0 ] . V_14 ) ;
if ( V_123 )
goto V_253;
V_123 = F_65 ( & V_207 , & V_2 [ 1 ] . V_14 ) ;
if ( V_123 )
goto V_254;
F_66 ( V_228 , & V_2 [ 0 ] ) ;
V_250 ++ ;
...
static int F_69 ( struct V_227 * V_228 )
{
struct V_1 * V_2 = F_70 ( V_228 ) ;
F_67 ( & V_207 , & V_2 [ 1 ] . V_14 ) ;
F_67 ( & V_207 , & V_2 [ 0 ] . V_14 ) ;
F_68 ( & V_228 -> V_231 [ 0 ] ,
V_2 [ 1 ] . V_14 . V_233 ,
sizeof( union V_234 ) ) ;
...
if ( V_257 ) {
V_201 = F_74 ( sizeof( struct V_1 ) *
V_257 , V_258 ) ;
if ( ! V_201 )
return - V_235 ;
V_123 = F_75 ( & V_207 , V_257 ) ;
if ( V_123 ) {
F_76 ( V_201 ) ;
V_201 = NULL ;
return V_123 ;
