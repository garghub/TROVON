...
V_2 = F_54 ( & V_92 -> V_7 , sizeof( * V_2 ) , V_102 ) ;
if ( ! V_2 )
return - V_103 ;
if ( V_97 )
F_55 ( V_97 , L_19 ,
...
V_84 = F_54 ( & V_92 -> V_7 , sizeof( * V_84 ) , V_102 ) ;
if ( ! V_84 )
return - V_103 ;
V_2 -> V_7 = & V_92 -> V_7 ;
...
V_84 -> V_107 = F_51 ;
V_84 -> V_108 = F_50 ;
V_58 = F_57 ( V_2 -> V_7 , NULL , & V_109 , V_101 ) ;
if ( F_39 ( V_58 ) ) {
F_4 ( & V_92 -> V_7 , L_22 ) ;
return F_58 ( V_58 ) ;
}
