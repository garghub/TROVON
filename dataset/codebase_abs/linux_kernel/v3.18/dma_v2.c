...
struct V_32 *
F_94 ( struct V_13 * V_14 , T_1 V_104 ,
...
V_37 = 0 ;
do {
T_8 V_110 = F_96 ( T_8 , V_106 , 1 << V_2 -> V_70 ) ;
V_18 = F_14 ( V_2 , V_36 + V_37 ) ;
V_20 = V_18 -> V_20 ;
V_20 -> V_25 = V_110 ;
V_20 -> V_21 = 0 ;
...
static T_9 F_99 ( struct V_13 * V_14 , char * V_115 )
{
struct V_1 * V_2 = F_7 ( V_14 ) ;
return sprintf ( V_115 , L_15 , F_21 ( V_2 ) ) ;
}
int F_100 ( struct V_63 * V_64 , int V_116 )
{
