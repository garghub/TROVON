...
V_73 = F_33 ( V_73 , V_81 ) ;
V_13 = F_34 ( V_9 , V_11 -> V_19 , V_73 , 0 ,
V_82 , 0 , 0x0000 , & V_67 ) ;
if ( V_13 ) {
F_35 ( V_9 , L_1 ) ;
goto V_83;
...
V_13 = F_42 ( & V_2 -> V_88 , 256 , 0 ) ;
if ( V_13 ) {
V_13 = - V_86 ;
goto V_87;
}
V_2 -> V_7 = V_6 ;
F_43 ( V_9 , & V_6 -> V_65 , & V_69 , V_67 ) ;
V_65 = & V_6 -> V_65 ;
V_63 = & V_65 -> V_89 ;
V_6 -> V_47 . V_63 = V_63 ;
V_6 -> V_47 . V_48 = V_2 ;
strcpy ( V_2 -> V_90 . V_91 , L_4 ) ;
if ( V_92 )
V_2 -> V_17 = V_93 | V_18 ;
else
V_2 -> V_17 = V_93 | V_94 |
...
V_2 -> V_17 |= V_97 ;
V_2 -> V_59 = & V_98 ;
V_2 -> V_90 . V_99 = V_67 -> V_100 . V_101 . V_102 . V_89 +
V_67 -> V_100 . V_101 . V_102 . V_103 ;
V_2 -> V_90 . V_104 = V_73 ;
V_2 -> V_105 = F_44 ( V_65 -> V_67 ) ;
V_2 -> V_106 = V_73 ;
F_45 ( V_2 , V_63 -> V_78 , V_63 -> V_79 ) ;
F_46 ( V_2 , & V_6 -> V_47 , V_61 -> V_107 , V_61 -> V_108 ) ;
V_2 -> V_109 = V_11 -> V_109 ;
if ( ! V_2 -> V_109 ) {
V_13 = - V_86 ;
goto V_87;
}
V_2 -> V_110 . V_73 = 64 * 1024 ;
V_2 -> V_110 . V_111 = 8 ;
V_2 -> V_110 . V_112 = 32 ;
V_2 -> V_110 . V_17 = V_113 ;
V_2 -> V_110 . V_114 = 1 ;
F_7 ( & V_9 -> V_85 ) ;
if ( V_11 -> V_19 && ! V_92 ) {
V_13 = - V_16 ;
...
static int
F_55 ( struct V_8 * V_9 , struct V_5 * V_6 )
{
...
struct V_5 * V_6 ;
int V_13 ;
V_6 = F_64 ( sizeof( struct V_5 ) , V_120 ) ;
if ( ! V_6 )
return - V_86 ;
V_6 -> V_9 = V_9 ;
V_11 -> V_6 = V_6 ;
V_6 -> V_47 . V_121 = & V_122 ;
V_13 = F_65 ( V_9 , & V_6 -> V_47 ,
F_66 ( V_9 ) ? 2 : 1 , 4 ) ;
if ( V_13 ) {
F_67 ( V_6 ) ;
return V_13 ;
...
{
struct V_10 * V_11 = V_9 -> V_12 ;
V_11 -> V_6 -> V_123 = V_11 -> V_6 -> V_47 . V_48 -> V_17 ;
V_11 -> V_6 -> V_47 . V_48 -> V_17 |= V_18 ;
}
void F_72 ( struct V_8 * V_9 )
{
struct V_10 * V_11 = V_9 -> V_12 ;
V_11 -> V_6 -> V_47 . V_48 -> V_17 = V_11 -> V_6 -> V_123 ;
}
void F_73 ( struct V_8 * V_9 , int V_14 )
{
struct V_10 * V_11 = V_9 -> V_12 ;
F_74 ( V_11 -> V_6 -> V_47 . V_48 , V_14 ) ;
}
