...
{
F_1 ( V_2 , V_77 , V_4 & V_78 ) ;
}
static T_2 F_31 ( struct V_1 * V_2 )
{
return V_79 & F_5 ( V_2 , V_75 ) ;
}
...
static int F_36 ( struct V_1 * V_2 , int V_85 , int V_86 )
{
if ( V_2 -> V_38 . V_83 ||
V_2 -> V_84 . V_83 ) {
...
V_2 -> V_38 . V_83 = F_37 ( V_85 , V_87 ) ;
if ( ! V_2 -> V_38 . V_83 )
return - V_88 ;
V_2 -> V_38 . V_89 = V_85 ;
V_2 -> V_38 . V_90 = FALSE ;
V_2 -> V_38 . V_91 = V_92 ;
V_2 -> V_38 . V_4 = V_2 -> V_38 . V_83 ;
V_2 -> V_84 . V_83 = V_2 -> V_7 + V_36 ;
V_2 -> V_84 . V_89 = V_35 ;
return 0 ;
}
static int F_38 ( struct V_93 * V_94 , struct V_95 * V_15 )
{
...
unsigned long V_5 ;
F_2 ( & V_2 -> V_6 , V_5 ) ;
V_2 -> V_84 . V_32 = F_42 ( V_94 ,
V_2 -> V_84 . V_83 ,
V_2 -> V_84 . V_89 ) ;
F_4 ( & V_2 -> V_6 , V_5 ) ;
if ( V_2 -> V_84 . V_32 > V_2 -> V_84 . V_89 )
V_2 -> V_84 . V_32 = V_2 -> V_84 . V_89 ;
F_1 ( V_2 , V_98 , V_2 -> V_84 . V_32 ) ;
F_1 ( V_2 , V_99 , V_100 | V_101 ) ;
} else
goto V_97;
F_43 ( V_94 ) ;
return 0 ;
...
static int F_44 ( struct V_95 * V_15 , struct V_102 * V_102 , int V_103 )
{
return 0 ;
}
static struct V_104 * F_45 ( struct V_95 * V_15 )
{
struct V_1 * V_2 = F_39 ( V_15 ) ;
return & V_2 -> V_15 -> V_37 ;
}
static int F_46 ( struct V_95 * V_15 )
{
struct V_1 * V_2 = F_39 ( V_15 ) ;
int V_105 ;
F_47 ( V_2 -> V_106 ) ;
...
F_10 ( V_2 , 2 ) ;
F_12 ( V_2 , 9600 ) ;
V_2 -> V_108 = F_48 ( V_15 , & V_2 -> V_109 , V_110 ) ;
if ( ! V_2 -> V_108 ) {
V_105 = - V_111 ;
goto V_107;
}
...
static int F_52 ( struct V_95 * V_15 )
{
struct V_1 * V_2 = F_39 ( V_15 ) ;
if ( V_2 -> V_108 ) {
F_53 ( V_2 -> V_108 ) ;
...
static int T_5 F_54 ( struct V_112 * V_113 )
{
struct V_95 * V_15 ;
struct V_1 * V_2 ;
struct V_114 * V_115 ;
int V_65 ;
int V_105 = - V_88 ;
V_115 = F_55 ( V_113 , V_116 , 0 ) ;
V_65 = F_56 ( V_113 , 0 ) ;
if ( ! V_115 || V_65 < 0 ) {
F_11 ( & V_113 -> V_14 , L_28 ) ;
goto exit;
}
...
goto exit;
V_2 = F_39 ( V_15 ) ;
V_2 -> V_7 = F_58 ( V_115 -> V_117 , F_59 ( V_115 ) ) ;
if ( ! V_2 -> V_7 ) {
V_105 = - V_118 ;
F_11 ( & V_113 -> V_14 , L_29 ) ;
goto V_119;
}
V_105 = F_36 ( V_2 , V_120 , V_121 ) ;
if ( V_105 )
goto V_122;
V_2 -> V_106 = F_60 ( & V_113 -> V_14 , NULL ) ;
if ( F_61 ( V_2 -> V_106 ) ) {
F_11 ( & V_113 -> V_14 , L_30 ) ;
goto V_123;
}
F_62 ( & V_2 -> V_109 ) ;
V_15 -> V_124 = & V_125 ;
V_15 -> V_65 = V_65 ;
V_2 -> V_15 = V_15 ;
V_2 -> V_109 . V_126 . V_127 &= V_128 ;
V_2 -> V_109 . V_129 . V_127 = 1 ;
F_63 ( & V_2 -> V_6 ) ;
F_64 ( & V_2 -> V_109 ) ;
V_105 = F_65 ( V_15 ) ;
if ( V_105 )
goto V_130;
F_66 ( V_113 , V_15 ) ;
if ( F_67 ( V_65 , F_28 , V_131 , L_31 , V_2 ) ) {
F_68 ( & V_113 -> V_14 , L_32 ) ;
goto V_130;
}
F_50 ( & V_113 -> V_14 , L_33 ) ;
goto exit;
V_130:
F_69 ( V_2 -> V_106 ) ;
V_123:
...
static int T_6 F_72 ( struct V_112 * V_113 )
{
struct V_95 * V_15 = F_73 ( V_113 ) ;
struct V_1 * V_2 = F_39 ( V_15 ) ;
if ( ! V_2 )
return 0 ;
F_74 ( V_15 ) ;
