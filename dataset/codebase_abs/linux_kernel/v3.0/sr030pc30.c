...
int V_8 ;
if ( F_33 ( V_26 == NULL , L_5 ) )
return - V_96 ;
if ( ! V_21 )
F_10 ( V_3 , false , true ) ;
if ( V_26 -> V_97 ) {
V_8 = V_26 -> V_97 ( & V_6 -> V_98 , V_21 ) ;
if ( V_8 )
return V_8 ;
}
if ( V_21 ) {
...
int V_8 ;
if ( V_26 -> V_97 ) {
V_8 = V_26 -> V_97 ( & V_6 -> V_98 , 1 ) ;
if ( V_8 )
return V_8 ;
}
V_8 = F_7 ( V_6 , V_100 ) ;
if ( V_26 -> V_97 )
V_26 -> V_97 ( & V_6 -> V_98 , 0 ) ;
if ( V_8 < 0 ) {
F_35 ( & V_6 -> V_98 , L_6 , V_60 ) ;
return V_8 ;
}
return V_8 == V_101 ? 0 : - V_102 ;
}
static int F_36 ( struct V_5 * V_6 ,
const struct V_103 * V_58 )
{
struct V_1 * V_4 ;
struct V_2 * V_3 ;
const struct V_95 * V_26
...
if ( V_8 )
return V_8 ;
V_4 = F_37 ( sizeof( * V_4 ) , V_105 ) ;
if ( ! V_4 )
return - V_96 ;
V_3 = & V_4 -> V_3 ;
strcpy ( V_3 -> V_106 , V_107 ) ;
V_4 -> V_26 = V_6 -> V_98 . V_99 ;
F_38 ( V_3 , V_6 , & V_108 ) ;
V_4 -> V_10 = - 1 ;
V_4 -> V_36 = 1 ;
V_4 -> V_23 = 1 ;
