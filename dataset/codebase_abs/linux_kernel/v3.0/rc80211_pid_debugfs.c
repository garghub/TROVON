...
V_47 = V_47 < V_50 ?
V_47 : V_50 ;
V_52 = snprintf ( V_49 , V_47 , L_1 , V_7 -> V_15 , V_7 -> V_13 ) ;
switch ( V_7 -> type ) {
case V_23 :
V_52 += snprintf ( V_49 + V_52 , V_47 - V_52 , L_2 ,
! ( V_7 -> V_5 . V_21 & V_56 ) ,
V_7 -> V_5 . V_22 . V_8 . V_57 [ 0 ] . V_58 ) ;
break;
case V_26 :
V_52 += snprintf ( V_49 + V_52 , V_47 - V_52 , L_3 ,
V_7 -> V_5 . V_24 , V_7 -> V_5 . V_25 ) ;
break;
case V_27 :
V_52 += snprintf ( V_49 + V_52 , V_47 - V_52 , L_4 ,
V_7 -> V_5 . V_24 , V_7 -> V_5 . V_25 ) ;
break;
case V_32 :
V_52 += snprintf ( V_49 + V_52 , V_47 - V_52 ,
L_5 ,
V_7 -> V_5 . V_28 , V_7 -> V_5 . V_29 ,
V_7 -> V_5 . V_30 , V_7 -> V_5 . V_31 ) ;
break;
}
V_52 += snprintf ( V_49 + V_52 , V_47 - V_52 , L_6 ) ;
F_3 ( & V_38 -> V_9 , V_8 ) ;
if ( F_17 ( V_2 , V_49 , V_52 ) )
return - V_59 ;
return V_52 ;
}
void F_18 ( void * V_60 , void * V_61 ,
struct V_62 * V_63 )
{
struct V_35 * V_64 = V_61 ;
V_64 -> V_65 = F_19 ( L_7 , V_66 ,
V_63 , V_64 ,
& V_67 ) ;
}
void F_20 ( void * V_60 , void * V_61 )
{
struct V_35 * V_64 = V_61 ;
F_21 ( V_64 -> V_65 ) ;
}
