...
if ( ( V_28 -> V_66 ? V_28 -> V_66 -> V_42 : 0 ) != V_42 ) {
F_22 ( V_43 , V_67 ) ;
goto V_65;
}
if ( V_28 -> V_68 -> V_69 ( V_28 , V_11 , V_14 ) ) {
F_22 ( V_43 , V_70 ) ;
goto V_65;
}
if ( F_30 ( V_28 ) ) {
...
V_42 = 0 ;
V_28 -> V_68 -> V_79 ( V_28 , V_14 ) ;
V_28 -> V_80 . V_81 += V_11 -> V_4 ;
V_28 -> V_80 . V_82 ++ ;
F_31 ( & V_28 -> V_60 ) ;
F_16 ( V_11 ) -> V_38 = V_12 ;
V_30 = V_28 -> V_30 ;
...
return V_28 -> V_30 -> V_33 -> V_87 ( V_11 , V_48 ) ;
}
V_65:
F_31 ( & V_28 -> V_60 ) ;
V_53:
