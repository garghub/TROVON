...
V_1 -> V_49 [ 3 ] , ( unsigned int ) V_1 -> V_50 [ V_51 ] ,
V_1 -> V_52 ,
V_1 -> V_16 , V_1 -> V_53 ,
...
static T_8 F_55 ( struct V_98 * V_25 ,
struct V_99 * V_100 ,
char * V_77 )
{
T_7 * V_63 = F_54 ( V_25 ) ;
...
return snprintf ( V_77 , sizeof( V_108 ) + 1 , L_19 , V_63 -> V_108 ) ;
}
...
return snprintf ( V_77 , sizeof( V_110 ) + 1 , L_19 , V_63 -> V_110 ) ;
}
...
return snprintf ( V_77 , sizeof( V_112 ) + 1 , L_19 , V_63 -> V_112 ) ;
}
...
V_117 = V_69 ;
return snprintf ( V_77 , strlen ( V_70 [ V_117 ] ) + 7 , L_21 ,
V_70 [ V_117 ] ) ;
}
...
static void F_61 ( struct V_98 * V_25 )
{
}
static int F_62 ( struct V_101 * V_1 )
{
F_63 ( & V_1 -> V_25 ) ;
V_1 -> V_25 . type = & V_119 ;
V_1 -> V_25 . V_120 = & V_121 ;
F_64 ( & V_1 -> V_25 , L_22 , V_1 -> V_46 ) ;
V_1 -> V_25 . V_105 = & V_1 -> V_24 -> V_25 ;
return F_65 ( & V_1 -> V_25 ) ;
}
static void F_66 ( struct V_101 * V_1 )
{
F_67 ( & V_1 -> V_25 ) ;
F_68 ( & V_1 -> V_25 ) ;
}
static void F_69 ( struct V_98 * V_25 )
{
T_7 * V_63 = F_54 ( V_25 ) ;
F_15 ( V_63 ) ;
}
static long F_70 ( struct V_101 * V_1 ,
int V_122 )
{
struct V_98 * V_25 ;
...
V_25 -> type = & V_124 ;
V_25 -> V_120 = & V_121 ;
F_64 ( V_25 , L_23 , V_1 -> V_62 , V_122 ) ;
V_25 -> V_105 = & V_1 -> V_25 ;
V_1 -> V_63 [ V_122 ] -> V_123 = 1 ;
return F_65 ( V_25 ) ;
}
static void F_71 ( struct V_101 * V_1 , int V_122 ,
int V_125 )
{
...
T_14 V_126 , V_127 ;
do {
V_20 = F_73 ( V_1 -> V_128 , V_1 -> V_19 ) ;
if ( V_20 == V_1 -> V_19 )
return NULL ;
} while ( F_74 ( V_20 & ( V_129 - 1 ) ,
...
static T_2 * F_76 ( T_1 * V_1 )
{
T_2 * V_2 ;
T_4 V_28 ;
T_14 V_126 , V_127 ;
V_2 = ( T_2 * ) F_77 ( V_1 -> V_24 ,
sizeof( T_2 ) , & V_126 ) ;
if ( V_2 == NULL )
return NULL ;
memset ( V_2 , 0 , sizeof( T_2 ) ) ;
...
static void F_79 ( T_1 * V_1 , T_2 * V_2 )
{
int V_20 ;
V_20 = V_2 - V_1 -> V_130 ;
F_80 ( V_20 & ( V_129 - 1 ) ,
...
static void F_81 ( T_1 * V_1 , T_2 * V_2 )
{
T_4 V_28 ;
...
F_78 ( V_1 -> V_24 , sizeof( T_2 ) , V_2 ,
( T_14 ) F_82 ( V_1 , ( T_12 ) V_2 -> V_5 ) ) ;
}
static inline T_1 * F_83 ( struct V_142 * V_143 )
{
return V_143 -> V_144 -> V_145 ;
}
static inline T_7 * F_84 ( struct V_142 * V_143 )
{
return V_143 -> V_75 ;
}
static int F_85 ( struct V_146 * V_147 , T_15 V_148 )
{
T_1 * V_1 = F_83 ( V_147 -> V_149 ) ;
T_7 * V_63 = F_84 ( V_147 -> V_149 ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_24 , V_147 -> V_149 -> V_150 ) ;
if ( V_63 -> V_57 )
return - V_58 ;
if ( V_63 -> V_65 == 0 ) {
if ( F_87 ( V_147 -> V_151 ) != 0 ) {
if ( F_87 ( V_147 -> V_151 ) & 0x0f ) {
return - V_152 ;
...
static int F_89 ( struct V_146 * V_147 , T_15 V_148 )
{
int V_73 ;
F_90 ( & V_156 ) ;
V_73 = F_85 ( V_147 , V_148 ) ;
F_91 ( & V_156 ) ;
return V_73 ;
}
static int F_92 ( struct V_142 * V_143 , T_15 V_148 )
{
T_1 * V_1 ;
T_7 * V_63 ;
F_90 ( & V_156 ) ;
V_1 = F_83 ( V_143 ) ;
V_63 = F_84 ( V_143 ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_25 , V_143 -> V_150 ) ;
V_63 -> V_118 -- ;
V_1 -> V_118 -- ;
F_91 ( & V_156 ) ;
return 0 ;
}
static int F_93 ( struct V_146 * V_147 , T_15 V_148 ,
unsigned V_157 , unsigned long V_158 )
{
int V_73 ;
F_90 ( & V_156 ) ;
V_73 = F_94 ( V_147 , V_148 , V_157 , V_158 ) ;
F_91 ( & V_156 ) ;
return V_73 ;
}
...
case V_172 :
case V_173 :
return F_93 ( V_147 , V_148 , V_157 , V_158 ) ;
case V_174 :
return F_96 ( V_147 , V_148 , V_157 , V_158 ) ;
case V_175 :
...
( T_16 T_9 * ) V_158 ;
T_17 V_178 ;
T_17 T_9 * V_179 = F_98 ( sizeof( V_178 ) ) ;
int V_80 ;
T_12 V_180 ;
V_80 = 0 ;
V_80 |=
...
sizeof( V_178 . V_183 ) ) ;
V_80 |= F_99 ( V_178 . V_184 , & V_177 -> V_184 ) ;
V_80 |= F_99 ( V_180 , & V_177 -> V_77 ) ;
V_178 . V_77 = F_100 ( V_180 ) ;
V_80 |= F_101 ( V_179 , & V_178 , sizeof( V_178 ) ) ;
if ( V_80 )
return - V_85 ;
V_80 = F_93 ( V_147 , V_148 , V_185 , ( unsigned long ) V_179 ) ;
if ( V_80 )
return V_80 ;
V_80 |=
F_102 ( & V_177 -> V_183 , & V_179 -> V_183 ,
sizeof( V_177 -> V_183 ) ) ;
if ( V_80 )
return - V_85 ;
return V_80 ;
...
sizeof( V_178 . V_183 ) ) ;
V_80 |= F_99 ( V_178 . V_184 , & V_177 -> V_184 ) ;
V_80 |= F_99 ( V_178 . V_186 , & V_177 -> V_186 ) ;
V_80 |= F_99 ( V_180 , & V_177 -> V_77 ) ;
V_178 . V_77 = F_100 ( V_180 ) ;
V_80 |= F_101 ( V_179 , & V_178 , sizeof( V_178 ) ) ;
if ( V_80 )
return - V_85 ;
V_80 = F_93 ( V_147 , V_148 , V_187 , ( unsigned long ) V_179 ) ;
if ( V_80 )
return V_80 ;
V_80 |=
F_102 ( & V_177 -> V_183 , & V_179 -> V_183 ,
...
static int F_103 ( struct V_146 * V_147 , struct V_188 * V_189 )
{
T_7 * V_63 = F_84 ( V_147 -> V_149 ) ;
if ( ! V_63 -> V_190 )
return - V_152 ;
...
static int F_106 ( T_1 * V_1 , void T_9 * V_196 )
{
T_20 V_197 ;
if ( ! V_196 )
return - V_82 ;
V_197 . V_198 = F_107 ( V_1 -> V_24 -> V_120 ) ;
V_197 . V_120 = V_1 -> V_24 -> V_120 -> V_199 ;
V_197 . V_200 = V_1 -> V_24 -> V_201 ;
V_197 . V_48 = V_1 -> V_48 ;
if ( F_101 ( V_196 , & V_197 , sizeof( T_20 ) ) )
return - V_85 ;
return 0 ;
}
static int F_108 ( T_1 * V_1 , void T_9 * V_196 )
{
T_21 V_202 ;
if ( ! V_196 )
return - V_82 ;
V_202 . V_203 = F_109 ( & V_1 -> V_204 -> V_205 . V_206 ) ;
V_202 . V_102 = F_109 ( & V_1 -> V_204 -> V_205 . V_207 ) ;
if ( F_101
( V_196 , & V_202 , sizeof( T_21 ) ) )
return - V_85 ;
return 0 ;
}
static int F_110 ( T_1 * V_1 , void T_9 * V_196 )
{
T_21 V_202 ;
unsigned long V_13 ;
int V_20 ;
...
return - V_82 ;
F_11 ( & V_1 -> V_14 , V_13 ) ;
F_111 ( V_202 . V_203 , & ( V_1 -> V_204 -> V_205 . V_206 ) ) ;
F_111 ( V_202 . V_102 , & ( V_1 -> V_204 -> V_205 . V_207 ) ) ;
F_111 ( V_208 , V_1 -> V_209 + V_210 ) ;
for ( V_20 = 0 ; V_20 < V_211 ; V_20 ++ ) {
if ( ! ( F_109 ( V_1 -> V_209 + V_210 ) & V_208 ) )
break;
F_112 ( 1000 ) ;
}
F_13 ( & V_1 -> V_14 , V_13 ) ;
...
static int F_113 ( T_1 * V_1 , void T_9 * V_196 )
{
T_22 V_213 ;
int V_20 ;
if ( ! V_196 )
...
V_213 [ V_20 ] = F_114 ( & V_1 -> V_204 -> V_214 [ V_20 ] ) ;
if ( F_101 ( V_196 , V_213 , sizeof( T_22 ) ) )
return - V_85 ;
return 0 ;
}
static int F_115 ( T_1 * V_1 , void T_9 * V_196 )
{
T_22 V_213 ;
unsigned long V_13 ;
int V_20 ;
...
F_11 ( & V_1 -> V_14 , V_13 ) ;
for ( V_20 = 0 ; V_20 < 16 ; V_20 ++ )
F_116 ( V_213 [ V_20 ] , & V_1 -> V_204 -> V_214 [ V_20 ] ) ;
F_111 ( V_208 , V_1 -> V_209 + V_210 ) ;
for ( V_20 = 0 ; V_20 < V_211 ; V_20 ++ ) {
if ( ! ( F_109 ( V_1 -> V_209 + V_210 ) & V_208 ) )
break;
...
static int F_117 ( T_1 * V_1 , void T_9 * V_196 )
{
T_23 V_215 ;
if ( ! V_196 )
return - V_82 ;
V_215 = F_109 ( & V_1 -> V_204 -> V_216 ) ;
if ( F_101 ( V_196 , & V_215 , sizeof( T_23 ) ) )
return - V_85 ;
return 0 ;
}
...
if ( ! V_196 )
return - V_82 ;
V_217 = F_109 ( & V_1 -> V_204 -> V_217 ) ;
if ( F_101 ( V_196 , & V_217 , sizeof( T_24 ) ) )
return - V_85 ;
return 0 ;
}
...
if ( ! V_196 )
return - V_82 ;
if ( F_101 ( V_196 , & V_219 , sizeof( T_26 ) ) )
return - V_85 ;
return 0 ;
}
...
V_221 . V_223 = 0 ;
if ( F_101 ( V_196 , & V_221 , sizeof( T_27 ) ) )
return - V_85 ;
return 0 ;
}
static int F_122 ( T_1 * V_1 , void T_9 * V_196 )
{
T_17 V_224 ;
T_2 * V_2 ;
char * V_225 = NULL ;
...
if ( F_101 ( V_196 , & V_224 , sizeof( T_17 ) ) ) {
F_15 ( V_225 ) ;
F_81 ( V_1 , V_2 ) ;
return - V_85 ;
}
if ( V_224 . V_182 . Type . V_228 == V_237 ) {
if ( F_101 ( V_224 . V_77 , V_225 , V_224 . V_184 ) ) {
F_15 ( V_225 ) ;
F_81 ( V_1 , V_2 ) ;
return - V_85 ;
}
...
static int F_125 ( T_1 * V_1 , void T_9 * V_196 )
{
T_19 * V_238 ;
T_2 * V_2 ;
...
V_225 = F_126 ( V_247 * sizeof( char * ) , V_23 ) ;
if ( ! V_225 ) {
V_241 = - V_84 ;
goto V_245;
}
...
if ( F_101 ( V_196 , V_238 , sizeof( * V_238 ) ) ) {
F_81 ( V_1 , V_2 ) ;
V_241 = - V_85 ;
goto V_245;
}
...
for ( V_20 = 0 ; V_20 < V_240 ; V_20 ++ ) {
if ( F_101 ( V_248 , V_225 [ V_20 ] , V_239 [ V_20 ] ) ) {
F_81 ( V_1 , V_2 ) ;
V_241 = - V_85 ;
goto V_245;
}
...
F_86 ( & V_1 -> V_24 -> V_25 , L_26 ,
V_157 , V_158 ) ;
switch ( V_157 ) {
case V_159 :
return F_106 ( V_1 , V_196 ) ;
case V_160 :
return F_108 ( V_1 , V_196 ) ;
case V_161 :
return F_110 ( V_1 , V_196 ) ;
case V_162 :
return F_113 ( V_1 , V_196 ) ;
case V_163 :
return F_115 ( V_1 , V_196 ) ;
case V_164 :
return F_117 ( V_1 , V_196 ) ;
case V_165 :
...
case V_173 :
return F_121 ( V_1 , V_143 , V_196 ) ;
case V_185 :
return F_122 ( V_1 , V_196 ) ;
case V_187 :
return F_125 ( V_1 , V_196 ) ;
case V_249 :
case V_250 :
case V_251 :
case V_252 :
...
case V_255 :
case V_256 :
return F_128 ( V_143 -> V_144 , V_143 , V_148 , V_157 , V_196 ) ;
case V_257 :
case V_258 :
case V_259 :
case V_260 :
...
int V_262 = V_1 -> V_263 ;
int V_20 ;
if ( ( F_73 ( V_1 -> V_128 , V_1 -> V_19 ) ) == V_1 -> V_19 )
return;
...
F_132 ( V_1 -> V_24 , V_28 . V_36 , V_269 [ V_271 ] . V_37 ,
V_270 ) ;
++ V_271 ;
}
F_86 ( & V_1 -> V_24 -> V_25 , L_27 , V_266 ) ;
if ( V_266 -> V_11 == V_273 )
V_266 -> V_274 = V_2 -> V_132 -> V_275 ;
F_133 ( V_266 , ( V_266 -> V_276 == 0 ) ? 0 : - V_277 ) ;
F_11 ( & V_1 -> V_14 , V_13 ) ;
F_79 ( V_1 , V_2 ) ;
F_129 ( V_1 ) ;
F_13 ( & V_1 -> V_14 , V_13 ) ;
...
static void F_135 ( T_1 * V_1 , int V_280 ,
...
* V_110 = '\0' ;
* V_112 = '\0' ;
V_282 = F_126 ( sizeof( T_30 ) , V_23 ) ;
if ( ! V_282 )
return;
F_134 ( V_1 , V_278 , V_280 ) ;
V_281 = F_136 ( V_1 , V_283 , V_282 , sizeof( * V_282 ) , 0 ,
V_278 , V_284 ) ;
if ( V_281 == V_285 ) {
...
static void F_137 ( T_1 * V_1 , int V_280 ,
...
V_77 = F_126 ( F_138 , V_23 ) ;
if ( ! V_77 )
return;
memset ( V_107 , 0 , V_287 ) ;
F_134 ( V_1 , V_278 , V_280 ) ;
V_281 = F_136 ( V_1 , V_283 , V_77 ,
F_138 , 0x83 , V_278 , V_284 ) ;
if ( V_281 == V_285 )
memcpy ( V_107 , & V_77 [ 8 ] , V_287 ) ;
F_15 ( V_77 ) ;
return;
}
static int F_139 ( T_1 * V_1 , struct V_142 * V_143 ,
int V_122 )
{
V_143 -> V_144 = F_140 ( V_288 , & V_1 -> V_14 ) ;
if ( ! V_143 -> V_144 )
goto V_289;
sprintf ( V_143 -> V_150 , L_28 , V_1 -> V_62 , V_122 ) ;
...
F_141 ( V_143 -> V_144 , V_1 -> V_24 -> V_297 ) ;
F_142 ( V_143 -> V_144 , V_1 -> V_298 ) ;
F_143 ( V_143 -> V_144 , V_1 -> V_299 ) ;
F_144 ( V_143 -> V_144 , F_131 ) ;
...
static void F_149 ( T_1 * V_1 , int V_122 ,
int V_301 , int V_302 )
{
struct V_142 * V_143 ;
T_30 * V_303 = NULL ;
...
V_305 -> V_300 = V_300 ;
V_305 -> V_66 = V_304 + 1 ;
F_135 ( V_1 , V_122 , V_305 -> V_108 ,
V_305 -> V_110 , V_305 -> V_112 ) ;
F_137 ( V_1 , V_122 , V_305 -> V_107 ,
sizeof( V_305 -> V_107 ) ) ;
...
F_153 ( & V_1 -> V_24 -> V_25 , L_29 , V_122 ) ;
F_11 ( & V_1 -> V_14 , V_13 ) ;
V_1 -> V_63 [ V_122 ] -> V_57 = 1 ;
F_13 ( & V_1 -> V_14 , V_13 ) ;
V_73 = F_154 ( V_1 , V_122 , 0 , V_302 ) ;
}
if ( V_73 )
goto V_313;
...
F_155 ( V_143 , V_1 -> V_63 [ V_122 ] -> V_66 ) ;
if ( V_122 || V_301 ) {
if ( F_139 ( V_1 , V_143 , V_122 ) != 0 ) {
F_156 ( V_1 , V_122 ) ;
F_157 ( V_1 , V_122 ) ;
F_153 ( & V_1 -> V_24 -> V_25 , L_30 ,
V_122 ) ;
-- V_1 -> V_52 ;
}
}
...
return;
V_306:
F_18 ( & V_1 -> V_24 -> V_25 , L_31 ) ;
goto V_313;
}
static int F_158 ( T_1 * V_1 , int V_314 )
{
int V_20 ;
T_7 * V_63 ;
...
static void F_156 ( T_1 * V_1 , int V_122 )
{
F_159 ( V_1 -> V_142 [ V_122 ] ) ;
V_1 -> V_142 [ V_122 ] = NULL ;
}
static int F_160 ( T_1 * V_1 , unsigned char V_114 [] ,
int V_314 )
{
int V_122 ;
V_122 = F_158 ( V_1 , V_314 ) ;
if ( V_122 == - 1 )
return - 1 ;
if ( ! V_1 -> V_142 [ V_122 ] ) {
V_1 -> V_142 [ V_122 ] =
...
static int F_127 ( T_1 * V_1 , int V_301 ,
int V_302 )
{
int V_52 ;
T_31 * V_318 = NULL ;
...
V_1 -> V_57 = 1 ;
F_13 ( & V_1 -> V_14 , V_13 ) ;
V_318 = F_126 ( sizeof( T_31 ) , V_23 ) ;
if ( V_318 == NULL )
goto V_306;
V_319 = F_136 ( V_1 , V_322 , V_318 ,
sizeof( T_31 ) ,
0 , V_153 , V_284 ) ;
if ( V_319 == V_285 )
V_320 = F_163 ( * ( V_323 * ) V_318 -> V_324 ) ;
else {
F_153 ( & V_1 -> V_24 -> V_25 ,
L_34 ) ;
V_320 = 0 ;
...
if ( ! V_321 ) {
V_122 = F_160 ( V_1 , V_114 , 0 ) ;
if ( V_122 == - 1 )
goto V_313;
}
F_149 ( V_1 , V_122 , V_301 , V_302 ) ;
}
V_313:
F_15 ( V_318 ) ;
V_1 -> V_57 = 0 ;
...
static int F_154 ( T_1 * V_1 , int V_122 ,
int V_326 , int V_302 )
{
int V_20 ;
struct V_142 * V_143 ;
...
static int F_166 ( T_1 * V_1 , T_2 * V_2 , T_13 V_157 , void * V_225 ,
...
break;
default:
F_153 ( & V_1 -> V_24 -> V_25 , L_38 , V_157 ) ;
return V_348 ;
}
} else if ( V_11 == V_349 ) {
switch ( V_157 ) {
...
static int T_11 F_167 ( T_1 * V_1 , unsigned char * V_278 ,
T_32 V_354 )
{
T_2 * V_2 ;
int V_355 ;
...
if ( ! V_2 )
return - V_84 ;
V_355 = F_166 ( V_1 , V_2 , V_351 , NULL , 0 , 0 ,
V_153 , V_349 ) ;
...
case V_365 :
F_153 ( & V_1 -> V_24 -> V_25 , L_49
L_51 , V_2 -> V_182 . V_336 [ 0 ] ) ;
V_355 = V_348 ;
break;
case V_366 :
F_153 ( & V_1 -> V_24 -> V_25 , L_52
...
break;
case V_369 :
F_153 ( & V_1 -> V_24 -> V_25 , L_57 ) ;
V_355 = V_348 ;
break;
default:
F_153 ( & V_1 -> V_24 -> V_25 , L_58
L_59 , V_2 -> V_182 . V_336 [ 0 ] ,
V_2 -> V_132 -> V_192 ) ;
V_355 = V_348 ;
}
return V_355 ;
...
static int F_136 ( T_1 * V_1 , T_13 V_157 , void * V_225 , T_10 V_332 ,
...
if ( ! V_2 )
return - V_84 ;
V_355 = F_166 ( V_1 , V_2 , V_157 , V_225 , V_332 , V_333 ,
V_278 , V_11 ) ;
if ( V_355 == V_285 )
V_355 = F_170 ( V_1 , V_2 , 1 ) ;
F_81 ( V_1 , V_2 ) ;
return V_355 ;
}
static void F_152 ( T_1 * V_1 , int V_280 ,
T_6 V_304 ,
unsigned int V_300 ,
T_30 * V_303 ,
T_7 * V_63 )
...
F_153 ( & V_1 -> V_24 -> V_25 , L_63 ) ;
}
}
static void
F_151 ( T_1 * V_1 , int V_280 , T_6 * V_304 ,
unsigned int * V_300 )
{
T_33 * V_77 ;
int V_319 ;
unsigned char V_278 [ 8 ] ;
V_77 = F_126 ( sizeof( T_33 ) , V_23 ) ;
if ( ! V_77 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_31 ) ;
return;
}
F_134 ( V_1 , V_278 , V_280 ) ;
V_319 = F_136 ( V_1 , V_342 , V_77 ,
sizeof( T_33 ) , 0 , V_278 , V_284 ) ;
if ( V_319 == V_285 ) {
* V_304 = F_163 ( * ( V_323 * ) V_77 -> V_304 ) ;
* V_300 = F_163 ( * ( V_323 * ) V_77 -> V_300 ) ;
} else {
F_153 ( & V_1 -> V_24 -> V_25 , L_64 ) ;
* V_304 = 0 ;
* V_300 = V_378 ;
}
F_15 ( V_77 ) ;
}
static void F_150 ( T_1 * V_1 , int V_280 ,
T_6 * V_304 , unsigned int * V_300 )
{
T_34 * V_77 ;
int V_319 ;
unsigned char V_278 [ 8 ] ;
V_77 = F_126 ( sizeof( T_34 ) , V_23 ) ;
if ( ! V_77 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_31 ) ;
return;
}
F_134 ( V_1 , V_278 , V_280 ) ;
V_319 = F_136 ( V_1 , V_343 ,
V_77 , sizeof( T_34 ) ,
0 , V_278 , V_284 ) ;
if ( V_319 == V_285 ) {
* V_304 = F_172 ( * ( V_379 * ) V_77 -> V_304 ) ;
* V_300 = F_163 ( * ( V_323 * ) V_77 -> V_300 ) ;
} else {
F_153 ( & V_1 -> V_24 -> V_25 , L_64 ) ;
* V_304 = 0 ;
...
F_173 ( & V_1 -> V_24 -> V_25 , L_65 ,
( unsigned long long ) * V_304 + 1 , * V_300 ) ;
F_15 ( V_77 ) ;
}
static int F_174 ( struct V_142 * V_143 )
{
T_1 * V_1 = F_83 ( V_143 ) ;
T_7 * V_63 = F_84 ( V_143 ) ;
int V_280 ;
...
F_152 ( V_1 , V_280 , V_304 , V_300 ,
V_303 , V_63 ) ;
F_145 ( V_63 -> V_144 , V_63 -> V_300 ) ;
F_155 ( V_143 , V_63 -> V_66 ) ;
F_15 ( V_303 ) ;
return 0 ;
}
static void T_35 * F_175 ( T_36 V_381 , T_36 V_332 )
{
T_36 V_382 = ( ( T_36 ) V_381 ) & V_383 ;
T_36 V_384 = ( ( T_36 ) V_381 ) - V_382 ;
void T_35 * V_385 = F_176 ( V_382 , V_384 + V_332 ) ;
...
T_2 * V_2 ;
while ( ! F_8 ( & V_1 -> V_15 ) ) {
V_2 = F_177 ( V_1 -> V_15 . V_386 , T_2 , V_10 ) ;
...
static inline unsigned int F_179 ( unsigned int V_391 ,
...
V_393 = V_401 ;
V_398 = F_179 ( V_397 , V_392 ,
V_393 , V_394 ) ;
if ( V_157 -> V_132 -> V_194 != V_195 ) {
if ( V_157 -> V_266 -> V_11 != V_273 )
F_153 ( & V_1 -> V_24 -> V_25 , L_67
L_68 ,
...
static inline void F_181 ( T_1 * V_1 , T_2 * V_157 ,
int V_405 )
{
int V_395 = 0 ;
...
V_266 -> V_276 = 0 ;
if ( V_405 )
V_266 -> V_276 = F_179 ( 0 , 0 , 0 , V_406 ) ;
if ( V_157 -> V_132 -> V_192 == 0 )
goto V_407;
switch ( V_157 -> V_132 -> V_192 ) {
case V_193 :
V_266 -> V_276 = F_180 ( V_1 , V_157 , & V_395 ) ;
break;
case V_360 :
...
L_46 , V_157 ) ;
V_266 -> V_276 = F_179 ( V_356 ,
V_157 -> V_132 -> V_192 , V_399 ,
( V_157 -> V_266 -> V_11 == V_273 ) ?
V_400 : V_409 ) ;
break;
case V_363 :
F_153 ( & V_1 -> V_24 -> V_25 , L_77
L_48 , V_157 ) ;
V_266 -> V_276 = F_179 ( V_356 ,
V_157 -> V_132 -> V_192 , V_399 ,
( V_157 -> V_266 -> V_11 == V_273 ) ?
...
V_395 = 1 ;
F_153 ( & V_1 -> V_24 -> V_25 , L_83 , V_157 ) ;
V_157 -> V_373 ++ ;
} else
F_153 ( & V_1 -> V_24 -> V_25 ,
L_84 , V_157 ) ;
...
break;
case V_411 :
F_153 ( & V_1 -> V_24 -> V_25 , L_85 , V_157 ) ;
V_266 -> V_276 = F_179 ( V_356 ,
V_157 -> V_132 -> V_192 , V_399 ,
( V_157 -> V_266 -> V_11 == V_273 ) ?
V_400 : V_409 ) ;
break;
case V_369 :
F_153 ( & V_1 -> V_24 -> V_25 , L_86 , V_157 ) ;
V_266 -> V_276 = F_179 ( V_356 ,
V_157 -> V_132 -> V_192 , V_399 ,
V_157 -> V_266 -> V_11 == V_273 ?
V_400 : V_409 ) ;
...
static inline T_12 F_183 ( T_12 V_412 )
{
#define F_184 0x10
return V_412 & F_184 ;
}
static inline T_12 F_185 ( T_12 V_412 )
{
#define F_186 5
return V_412 >> F_186 ;
}
static inline T_12 F_82 ( T_1 * V_1 , T_12 V_412 )
{
...
static inline void F_189 ( T_12 * V_412 )
{
* V_412 |= F_184 ;
}
static inline void F_190 ( T_12 * V_412 , T_12 V_413 )
{
* V_412 |= ( V_413 << F_186 ) ;
}
...
V_2 -> V_7 . V_232 = 0 ;
F_190 ( & V_2 -> V_7 . V_234 . V_33 , V_2 -> V_137 ) ;
F_189 ( & V_2 -> V_7 . V_234 . V_33 ) ;
memcpy ( & V_2 -> V_7 . V_233 , V_63 -> V_116 , sizeof( V_63 -> V_116 ) ) ;
V_2 -> V_182 . V_337 = 10 ;
V_2 -> V_182 . Type . Type = V_284 ;
V_2 -> V_182 . Type . V_338 = V_339 ;
V_2 -> V_182 . Type . V_228 =
( F_195 ( V_416 ) == V_428 ) ? V_237 : V_230 ;
V_2 -> V_182 . V_340 = 0 ;
V_2 -> V_182 . V_336 [ 0 ] =
( F_195 ( V_416 ) == V_428 ) ? V_1 -> V_307 : V_1 -> V_309 ;
V_414 = F_196 ( V_416 ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_88 ,
( int ) F_196 ( V_416 ) , ( int ) F_197 ( V_416 ) ) ;
F_198 ( V_418 , V_1 -> V_298 ) ;
V_415 = F_199 ( V_329 , V_416 , V_418 ) ;
if ( V_2 -> V_182 . Type . V_228 == V_237 )
V_419 = V_272 ;
else
V_419 = V_38 ;
...
V_28 . V_36 = ( V_139 ) F_200 ( V_1 -> V_24 , F_201 ( & V_418 [ V_20 ] ) ,
V_418 [ V_20 ] . V_429 ,
...
if ( V_415 > V_1 -> V_55 )
V_1 -> V_55 = V_415 ;
F_86 ( & V_1 -> V_24 -> V_25 , L_89
L_90 ,
F_197 ( V_416 ) , V_415 , V_420 ) ;
...
V_2 -> V_182 . V_336 [ 6 ] = 0 ;
V_2 -> V_182 . V_336 [ 7 ] = ( F_197 ( V_416 ) >> 8 ) & 0xff ;
V_2 -> V_182 . V_336 [ 8 ] = F_197 ( V_416 ) & 0xff ;
V_2 -> V_182 . V_336 [ 9 ] = V_2 -> V_182 . V_336 [ 11 ] = V_2 -> V_182 . V_336 [ 12 ] = 0 ;
} else {
T_12 V_430 = F_202 ( V_414 ) ;
V_2 -> V_182 . V_337 = 16 ;
V_2 -> V_182 . V_336 [ 1 ] = 0 ;
...
V_2 -> V_182 . V_336 [ 10 ] = ( F_197 ( V_416 ) >> 24 ) & 0xff ;
V_2 -> V_182 . V_336 [ 11 ] = ( F_197 ( V_416 ) >> 16 ) & 0xff ;
V_2 -> V_182 . V_336 [ 12 ] = ( F_197 ( V_416 ) >> 8 ) & 0xff ;
V_2 -> V_182 . V_336 [ 13 ] = F_197 ( V_416 ) & 0xff ;
...
static inline int F_209 ( T_1 * V_1 , T_12 V_436 ,
T_12 V_437 )
{
if ( F_210 ( V_436 >= V_1 -> V_19 ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_92 , V_437 ) ;
return 1 ;
}
return 0 ;
}
...
static inline T_12 F_214 ( T_1 * V_1 )
{
T_12 V_439 ;
...
static inline T_12 F_215 ( T_1 * V_1 , T_12 V_437 )
{
T_12 V_436 ;
T_2 * V_2 ;
V_436 = F_185 ( V_437 ) ;
if ( F_209 ( V_1 , V_436 , V_437 ) )
return F_214 ( V_1 ) ;
V_2 = V_1 -> V_130 + V_436 ;
F_211 ( V_1 , V_2 , V_437 ) ;
return F_214 ( V_1 ) ;
...
T_2 * V_2 = NULL ;
V_138 V_445 , V_446 ;
V_446 = F_82 ( V_1 , V_437 ) ;
F_217 (c, &h->cmpQ, list) {
V_445 = F_82 ( V_1 , V_2 -> V_5 ) ;
if ( V_445 == V_446 ) {
F_211 ( V_1 , V_2 , V_437 ) ;
return F_214 ( V_1 ) ;
}
}
F_209 ( V_1 , V_1 -> V_19 + 1 , V_437 ) ;
return F_214 ( V_1 ) ;
}
...
if ( F_3 ( V_1 -> V_435 ) )
return 0 ;
F_173 ( & V_1 -> V_24 -> V_25 , L_93
L_94 ) ;
return 1 ;
}
static T_37 F_219 ( int V_448 , void * V_449 )
{
T_1 * V_1 = V_449 ;
unsigned long V_13 ;
T_12 V_437 ;
...
static void F_224 ( struct V_101 * V_1 )
{
...
F_86 ( & V_1 -> V_24 -> V_25 , L_103 ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_104 ) ;
for ( V_20 = 0 ; V_20 < 4 ; V_20 ++ )
V_468 [ V_20 ] = F_114 ( & ( V_469 -> V_470 [ V_20 ] ) ) ;
V_468 [ 4 ] = '\0' ;
F_86 ( & V_1 -> V_24 -> V_25 , L_105 , V_468 ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_106 ,
F_109 ( & ( V_469 -> V_471 ) ) ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_107 ,
F_109 ( & ( V_469 -> V_472 ) ) ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_108 ,
F_109 ( & ( V_469 -> V_473 ) ) ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_109 ,
F_109 ( & ( V_469 -> V_205 . V_474 ) ) ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_110 ,
F_109 ( & ( V_469 -> V_205 . V_206 ) ) ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_111 ,
F_109 ( & ( V_469 -> V_205 . V_207 ) ) ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_112 ,
F_109 ( & ( V_469 -> V_475 ) ) ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_113 ,
F_109 ( & ( V_469 -> V_217 ) ) ) ;
for ( V_20 = 0 ; V_20 < 16 ; V_20 ++ )
V_468 [ V_20 ] = F_114 ( & ( V_469 -> V_214 [ V_20 ] ) ) ;
V_468 [ 16 ] = '\0' ;
F_86 ( & V_1 -> V_24 -> V_25 , L_114 , V_468 ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_115 ,
F_109 ( & ( V_469 -> V_216 ) ) ) ;
}
static int F_233 ( struct V_476 * V_24 , unsigned long V_477 )
{
...
V_479 = F_234 ( V_24 , V_20 ) & V_482 ;
if ( V_479 == V_483 )
V_429 += 4 ;
else {
V_478 = F_234 ( V_24 , V_20 ) &
V_484 ;
switch ( V_478 ) {
case V_485 :
case V_486 :
...
static void F_235 ( int V_488 [] , int V_489 ,
int V_490 , int * V_491 )
{
...
static void T_11 F_238 ( T_1 * V_1 )
{
int V_20 ;
...
static T_11 void F_240 ( T_1 * V_1 ,
T_12 V_494 )
{
V_138 V_495 ;
...
V_1 -> V_440 = V_1 -> V_443 ;
V_495 = F_109 ( & ( V_1 -> V_204 -> V_498 ) ) ;
F_235 ( V_496 , F_44 ( V_496 ) , V_1 -> V_298 ,
V_1 -> V_6 ) ;
F_111 ( V_496 [ 0 ] , & V_1 -> V_499 -> V_500 ) ;
F_111 ( V_496 [ 1 ] , & V_1 -> V_499 -> V_501 ) ;
F_111 ( V_496 [ 2 ] , & V_1 -> V_499 -> V_502 ) ;
F_111 ( V_496 [ 3 ] , & V_1 -> V_499 -> V_503 ) ;
F_111 ( V_496 [ 4 ] , & V_1 -> V_499 -> V_504 ) ;
F_111 ( V_496 [ 5 ] , & V_1 -> V_499 -> V_505 ) ;
F_111 ( V_496 [ 6 ] , & V_1 -> V_499 -> V_506 ) ;
F_111 ( V_496 [ 7 ] , & V_1 -> V_499 -> V_507 ) ;
F_111 ( V_1 -> V_444 , & V_1 -> V_499 -> V_508 ) ;
F_111 ( 1 , & V_1 -> V_499 -> V_509 ) ;
F_111 ( 0 , & V_1 -> V_499 -> V_510 ) ;
F_111 ( 0 , & V_1 -> V_499 -> V_511 ) ;
F_111 ( V_1 -> V_512 , & V_1 -> V_499 -> V_513 ) ;
F_111 ( 0 , & V_1 -> V_499 -> V_514 ) ;
F_111 ( V_4 | V_494 ,
& ( V_1 -> V_204 -> V_205 . V_474 ) ) ;
F_111 ( V_208 , V_1 -> V_209 + V_210 ) ;
F_238 ( V_1 ) ;
V_497 = F_109 ( & ( V_1 -> V_204 -> V_473 ) ) ;
if ( ! ( V_497 & V_4 ) )
F_153 ( & V_1 -> V_24 -> V_25 , L_117
L_118 ) ;
}
static void T_11 F_242 ( T_1 * V_1 )
{
V_138 V_515 ;
F_86 ( & V_1 -> V_24 -> V_25 , L_119 ) ;
V_515 = F_109 ( & ( V_1 -> V_204 -> V_472 ) ) ;
if ( ! ( V_515 & V_516 ) )
return;
F_86 ( & V_1 -> V_24 -> V_25 , L_120 ) ;
if ( ( sizeof( T_2 ) % 32 ) != 0 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_121 ,
L_122 ,
( int ) sizeof( T_2 ) ,
L_123 ) ;
return;
}
V_1 -> V_443 = ( V_139 * ) F_77 (
...
F_153 ( & V_1 -> V_24 -> V_25 , L_126 ) ;
}
V_522:
#endif
V_1 -> V_50 [ V_51 ] = V_1 -> V_24 -> V_448 ;
return;
}
static int T_11 F_248 ( struct V_476 * V_24 , T_12 * V_48 )
{
int V_20 ;
T_12 V_528 , V_529 ;
V_528 = V_24 -> V_530 ;
...
{
T_39 V_534 ;
( void ) F_250 ( V_1 -> V_24 , V_535 , & V_534 ) ;
return ( ( V_534 & V_536 ) == 0 ) ;
}
static int T_11 F_251 ( struct V_476 * V_24 ,
unsigned long * V_537 )
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_481 ; V_20 ++ )
if ( F_234 ( V_24 , V_20 ) & V_538 ) {
* V_537 = F_252 ( V_24 , V_20 ) ;
F_86 ( & V_24 -> V_25 , L_128 ,
* V_537 ) ;
return 0 ;
}
...
static int T_11 F_253 ( struct V_476 * V_24 ,
void T_35 * V_209 , int V_539 )
#define F_254 1
#define F_255 0
{
int V_20 , V_540 ;
...
static int T_11 F_257 ( struct V_476 * V_24 ,
void T_35 * V_209 , T_12 * V_547 , T_40 * V_548 ,
T_40 * V_549 )
{
* V_547 = F_109 ( V_209 + V_550 ) ;
* V_549 = F_109 ( V_209 + V_551 ) ;
* V_547 &= ( T_12 ) 0x0000ffff ;
* V_548 = F_233 ( V_24 , * V_547 ) ;
if ( * V_548 == - 1 ) {
...
T_12 V_495 ;
int V_281 ;
V_281 = F_257 ( V_1 -> V_24 , V_1 -> V_209 , & V_547 ,
& V_548 , & V_549 ) ;
if ( V_281 )
return V_281 ;
V_1 -> V_204 = F_175 ( F_252 ( V_1 -> V_24 ,
V_548 ) + V_549 , sizeof( V_1 -> V_204 ) ) ;
if ( ! V_1 -> V_204 )
return - V_84 ;
V_281 = F_259 ( V_1 -> V_204 ) ;
if ( V_281 )
return V_281 ;
V_495 = F_109 ( & V_1 -> V_204 -> V_498 ) ;
V_1 -> V_499 = F_175 ( F_252 ( V_1 -> V_24 ,
V_548 ) + V_549 + V_495 ,
sizeof( * V_1 -> V_499 ) ) ;
if ( ! V_1 -> V_499 )
return - V_84 ;
...
static void T_11 F_260 ( struct V_101 * V_1 )
{
V_1 -> V_444 = F_109 ( & ( V_1 -> V_204 -> V_552 ) ) ;
if ( V_447 && V_1 -> V_444 > 32 )
V_1 -> V_444 = 32 ;
if ( V_1 -> V_444 < 16 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_133
L_134
L_135 ,
V_1 -> V_444 ) ;
V_1 -> V_444 = 16 ;
...
static void T_11 F_261 ( T_1 * V_1 )
{
F_260 ( V_1 ) ;
V_1 -> V_19 = V_1 -> V_444 - 4 - V_553 ;
V_1 -> V_298 = F_109 ( & ( V_1 -> V_204 -> V_554 ) ) ;
V_1 -> V_30 = 31 ;
if ( V_1 -> V_298 > 512 ) {
V_1 -> V_30 = 32 ;
...
{
if ( ( F_114 ( & V_1 -> V_204 -> V_470 [ 0 ] ) != 'C' ) ||
( F_114 ( & V_1 -> V_204 -> V_470 [ 1 ] ) != 'I' ) ||
( F_114 ( & V_1 -> V_204 -> V_470 [ 2 ] ) != 'S' ) ||
( F_114 ( & V_1 -> V_204 -> V_470 [ 3 ] ) != 'S' ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_136 ) ;
return false ;
}
return true ;
}
static inline void F_263 ( T_1 * V_1 )
{
#ifdef F_264
T_12 V_555 ;
V_555 = F_109 ( & ( V_1 -> V_204 -> V_556 ) ) ;
V_555 |= 0x100 ;
F_111 ( V_555 , & ( V_1 -> V_204 -> V_556 ) ) ;
#endif
}
...
return;
V_557 = F_109 ( V_1 -> V_209 + V_559 ) ;
V_557 |= 0x8000 ;
F_111 ( V_557 , V_1 -> V_209 + V_559 ) ;
F_266 ( V_1 -> V_24 , V_560 , & V_558 ) ;
V_558 |= 0x1 ;
F_267 ( V_1 -> V_24 , V_560 , V_558 ) ;
}
static int T_11 F_268 ( T_1 * V_1 )
{
int V_561 , V_80 ;
V_561 = F_248 ( V_1 -> V_24 , & V_1 -> V_48 ) ;
if ( V_561 < 0 )
return - V_533 ;
V_1 -> V_47 = V_532 [ V_561 ] . V_47 ;
V_1 -> V_387 = * ( V_532 [ V_561 ] . V_387 ) ;
if ( F_249 ( V_1 ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_137 ) ;
return - V_533 ;
}
V_80 = F_269 ( V_1 -> V_24 ) ;
if ( V_80 ) {
...
V_80 = F_270 ( V_1 -> V_24 , L_139 ) ;
if ( V_80 ) {
F_153 ( & V_1 -> V_24 -> V_25 ,
L_140 ) ;
return V_80 ;
}
F_86 ( & V_1 -> V_24 -> V_25 , L_141 , V_1 -> V_24 -> V_448 ) ;
F_86 ( & V_1 -> V_24 -> V_25 , L_142 , V_1 -> V_48 ) ;
F_243 ( V_1 ) ;
V_80 = F_251 ( V_1 -> V_24 , & V_1 -> V_562 ) ;
if ( V_80 )
goto V_563;
V_1 -> V_209 = F_175 ( V_1 -> V_562 , 0x250 ) ;
if ( ! V_1 -> V_209 ) {
V_80 = - V_84 ;
goto V_563;
}
V_80 = F_253 ( V_1 -> V_24 , V_1 -> V_209 , F_254 ) ;
if ( V_80 )
goto V_563;
V_80 = F_258 ( V_1 ) ;
if ( V_80 )
...
static int F_273 ( struct V_476 * V_24 )
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_564 ; V_20 ++ ) {
if ( ! V_268 [ V_20 ] ) {
T_1 * V_1 ;
...
static void F_274 ( T_1 * V_1 )
{
int V_20 ;
V_268 [ V_1 -> V_62 ] = NULL ;
for ( V_20 = 0 ; V_20 < V_1 -> V_64 + 1 ; V_20 ++ )
if ( V_1 -> V_142 [ V_20 ] != NULL )
F_159 ( V_1 -> V_142 [ V_20 ] ) ;
F_15 ( V_1 ) ;
}
static T_11 int F_275 ( struct V_476 * V_24 , unsigned char V_566 , unsigned char type )
{
typedef struct {
T_41 V_567 ;
T_42 V_182 ;
...
static const T_10 V_569 = sizeof( T_44 ) + sizeof( V_134 ) ;
T_44 * V_157 ;
T_14 V_570 ;
T_29 V_571 , V_412 ;
void T_35 * V_209 ;
int V_20 , V_80 ;
V_209 = F_276 ( F_252 ( V_24 , 0 ) , F_277 ( V_24 , 0 ) ) ;
if ( V_209 == NULL )
return - V_84 ;
V_80 = F_278 ( V_24 , F_279 ( 32 ) ) ;
if ( V_80 ) {
F_271 ( V_209 ) ;
return - V_84 ;
}
V_157 = F_77 ( V_24 , V_569 , & V_570 ) ;
if ( V_157 == NULL ) {
F_271 ( V_209 ) ;
return - V_84 ;
}
...
V_157 -> V_567 . V_8 = 0 ;
V_157 -> V_567 . V_29 = 0 ;
V_157 -> V_567 . V_234 . V_33 = V_571 ;
V_157 -> V_567 . V_234 . V_35 = 0 ;
memset ( & V_157 -> V_567 . V_233 . V_335 , 0 , 8 ) ;
V_157 -> V_182 . V_337 = 16 ;
V_157 -> V_182 . Type . Type = V_349 ;
V_157 -> V_182 . Type . V_338 = V_572 ;
V_157 -> V_182 . Type . V_228 = V_229 ;
V_157 -> V_182 . V_340 = 0 ;
V_157 -> V_182 . V_336 [ 0 ] = V_566 ;
V_157 -> V_182 . V_336 [ 1 ] = type ;
memset ( & V_157 -> V_182 . V_336 [ 2 ] , 0 , 14 ) ;
V_157 -> V_568 . V_34 . V_33 = V_571 + sizeof( T_44 ) ;
V_157 -> V_568 . V_34 . V_35 = 0 ;
V_157 -> V_568 . V_37 = sizeof( V_134 ) ;
F_111 ( V_571 , V_209 + V_573 ) ;
for ( V_20 = 0 ; V_20 < 10 ; V_20 ++ ) {
V_412 = F_109 ( V_209 + V_574 ) ;
if ( ( V_412 & ~ 3 ) == V_571 )
break;
F_256 ( V_575 ) ;
}
...
F_78 ( V_24 , V_569 , V_157 , V_570 ) ;
if ( V_412 & 2 ) {
F_18 ( & V_24 -> V_25 , L_147 ,
V_566 , type ) ;
return - V_277 ;
}
F_173 ( & V_24 -> V_25 , L_148 ,
V_566 , type ) ;
return 0 ;
}
static int F_280 ( struct V_476 * V_24 ,
void * T_35 V_209 , T_12 V_577 )
{
T_39 V_578 ;
int V_56 ;
if ( V_577 ) {
F_173 ( & V_24 -> V_25 , L_149 ) ;
F_111 ( V_577 , V_209 + V_210 ) ;
} else {
V_56 = F_245 ( V_24 , V_579 ) ;
if ( V_56 == 0 ) {
F_18 ( & V_24 -> V_25 ,
L_150
L_151 ) ;
...
F_250 ( V_24 , V_56 + V_580 , & V_578 ) ;
V_578 &= ~ V_581 ;
V_578 |= V_582 ;
F_281 ( V_24 , V_56 + V_580 , V_578 ) ;
F_256 ( 500 ) ;
V_578 &= ~ V_581 ;
V_578 |= V_583 ;
F_281 ( V_24 , V_56 + V_580 , V_578 ) ;
...
static T_11 void F_282 ( char * V_584 , int V_40 )
{
memset ( V_584 , 0 , V_40 ) ;
strncpy ( V_584 , L_153 V_585 , V_40 - 1 ) ;
}
static T_11 int F_259 (
T_38 T_35 * V_204 )
{
char * V_584 ;
int V_20 , V_332 = sizeof( V_204 -> V_584 ) ;
V_584 = F_17 ( V_332 , V_23 ) ;
if ( ! V_584 )
return - V_84 ;
F_282 ( V_584 , V_332 ) ;
for ( V_20 = 0 ; V_20 < V_332 ; V_20 ++ )
F_116 ( V_584 [ V_20 ] , & V_204 -> V_584 [ V_20 ] ) ;
F_15 ( V_584 ) ;
return 0 ;
}
static T_11 void F_283 (
T_38 T_35 * V_204 , unsigned char * V_586 )
{
int V_20 ;
for ( V_20 = 0 ; V_20 < sizeof( V_204 -> V_584 ) ; V_20 ++ )
V_586 [ V_20 ] = F_114 ( & V_204 -> V_584 [ V_20 ] ) ;
}
static T_11 int F_284 (
T_38 T_35 * V_204 )
{
char * V_586 , * V_587 ;
int V_281 , V_332 = sizeof( V_204 -> V_584 ) ;
V_587 = F_17 ( 2 * V_332 , V_23 ) ;
if ( ! V_587 )
return - V_84 ;
V_586 = V_587 + V_332 ;
F_282 ( V_587 , V_332 ) ;
F_283 ( V_204 , V_586 ) ;
V_281 = ! memcmp ( V_586 , V_587 , V_332 ) ;
F_15 ( V_587 ) ;
return V_281 ;
}
static T_11 int F_285 ( struct V_476 * V_24 )
{
T_40 V_549 ;
T_12 V_547 ;
T_40 V_548 ;
...
F_286 ( V_24 ) ;
F_287 ( V_24 ) ;
V_281 = F_251 ( V_24 , & V_562 ) ;
if ( V_281 )
return V_281 ;
V_209 = F_175 ( V_562 , 0x250 ) ;
if ( ! V_209 )
return - V_84 ;
V_281 = F_257 ( V_24 , V_209 , & V_547 ,
& V_548 , & V_549 ) ;
if ( V_281 )
goto V_591;
V_204 = F_175 ( F_252 ( V_24 ,
V_548 ) + V_549 , sizeof( * V_204 ) ) ;
if ( ! V_204 ) {
V_281 = - V_84 ;
goto V_591;
}
...
V_281 = F_280 ( V_24 , V_209 , V_577 ) ;
if ( V_281 )
goto V_595;
F_288 ( V_24 ) ;
V_281 = F_269 ( V_24 ) ;
if ( V_281 ) {
F_153 ( & V_24 -> V_25 , L_160 ) ;
goto V_595;
}
F_281 ( V_24 , 4 , V_589 ) ;
F_256 ( V_596 ) ;
F_173 ( & V_24 -> V_25 , L_161 ) ;
V_281 = F_253 ( V_24 , V_209 , F_255 ) ;
if ( V_281 ) {
...
goto V_595;
if ( V_281 ) {
F_153 ( & V_24 -> V_25 , L_166
L_167 ) ;
V_281 = - V_590 ;
} else {
F_173 ( & V_24 -> V_25 , L_168 ) ;
}
V_595:
F_271 ( V_204 ) ;
V_591:
...
static T_11 int F_289 ( struct V_476 * V_24 )
{
int V_281 , V_20 ;
if ( ! V_447 )
return 0 ;
...
static T_11 int F_291 ( T_1 * V_1 )
{
V_1 -> V_128 = F_17 (
F_292 ( V_1 -> V_19 , V_129 ) *
sizeof( unsigned long ) , V_23 ) ;
V_1 -> V_130 = F_77 ( V_1 -> V_24 ,
V_1 -> V_19 * sizeof( T_2 ) ,
& ( V_1 -> V_131 ) ) ;
V_1 -> V_133 = F_77 ( V_1 -> V_24 ,
V_1 -> V_19 * sizeof( V_134 ) ,
& ( V_1 -> V_135 ) ) ;
if ( ( V_1 -> V_128 == NULL )
|| ( V_1 -> V_130 == NULL )
|| ( V_1 -> V_133 == NULL ) ) {
F_18 ( & V_1 -> V_24 -> V_25 , L_173 ) ;
return - V_84 ;
}
return 0 ;
}
static T_11 int F_293 ( T_1 * V_1 )
{
int V_20 ;
V_1 -> V_424 = F_126 ( V_1 -> V_444 *
...
if ( ! F_299 ( V_1 -> V_50 [ V_51 ] , F_298 ,
V_599 , V_1 -> V_46 , V_1 ) )
return 0 ;
F_18 ( & V_1 -> V_24 -> V_25 , L_178 ,
V_1 -> V_50 [ V_51 ] , V_1 -> V_46 ) ;
return - 1 ;
}
static int T_11 F_300 ( T_1 * V_1 )
{
if ( F_167 ( V_1 , V_153 , V_600 ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_179 ) ;
return - V_277 ;
}
F_173 ( & V_1 -> V_24 -> V_25 , L_180 ) ;
if ( F_253 ( V_1 -> V_24 , V_1 -> V_209 , F_255 ) ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_181 ) ;
return - 1 ;
}
F_173 ( & V_1 -> V_24 -> V_25 , L_182 ) ;
if ( F_253 ( V_1 -> V_24 , V_1 -> V_209 , F_254 ) ) {
...
static void F_301 ( T_1 * V_1 )
{
int V_62 = V_1 -> V_62 ;
F_302 ( V_1 -> V_50 [ V_51 ] , V_1 ) ;
#ifdef F_244
if ( V_1 -> V_525 )
F_303 ( V_1 -> V_24 ) ;
else if ( V_1 -> V_527 )
...
F_15 ( V_1 -> V_6 ) ;
if ( V_1 -> V_443 )
F_78 ( V_1 -> V_24 , V_1 -> V_444 * sizeof( V_139 ) ,
V_1 -> V_443 , V_1 -> V_512 ) ;
if ( V_1 -> V_499 )
F_271 ( V_1 -> V_499 ) ;
if ( V_1 -> V_204 )
...
if ( V_1 -> V_209 )
F_271 ( V_1 -> V_209 ) ;
F_305 ( V_1 -> V_290 , V_1 -> V_46 ) ;
F_66 ( V_1 ) ;
F_272 ( V_1 -> V_24 ) ;
F_15 ( V_1 ) ;
V_268 [ V_62 ] = NULL ;
}
static int T_11 F_306 ( struct V_476 * V_24 ,
...
if ( F_62 ( V_1 ) )
goto V_607;
if ( ! F_309 ( V_24 , F_279 ( 64 ) ) )
V_604 = 1 ;
else if ( ! F_309 ( V_24 , F_279 ( 32 ) ) )
V_604 = 0 ;
else {
F_18 ( & V_1 -> V_24 -> V_25 , L_186 ) ;
goto V_608;
}
if ( V_20 < V_609 )
V_1 -> V_290 = V_610 + V_20 ;
V_281 = F_310 ( V_1 -> V_290 , V_1 -> V_46 ) ;
if ( V_281 == - V_58 || V_281 == - V_82 ) {
F_18 ( & V_1 -> V_24 -> V_25 ,
L_187
L_188 , V_1 -> V_290 , V_1 -> V_46 , V_20 ) ;
goto V_608;
} else {
if ( V_20 >= V_609 )
V_1 -> V_290 = V_281 ;
}
V_1 -> V_387 . V_611 ( V_1 , V_612 ) ;
V_281 = F_296 ( V_1 , F_222 , F_221 ) ;
if ( V_281 )
goto V_613;
F_173 ( & V_1 -> V_24 -> V_25 , L_189 ,
V_1 -> V_46 , V_24 -> V_98 , F_311 ( V_24 ) ,
V_1 -> V_50 [ V_51 ] , V_604 ? L_172 : L_190 ) ;
if ( F_291 ( V_1 ) )
goto V_614;
if ( F_293 ( V_1 ) )
goto V_614;
...
F_13 ( & V_1 -> V_14 , V_13 ) ;
F_302 ( V_1 -> V_50 [ V_51 ] , V_1 ) ;
V_281 = F_296 ( V_1 , F_220 ,
F_219 ) ;
if ( V_281 ) {
F_153 ( & V_1 -> V_24 -> V_25 , L_191
L_192 ) ;
goto V_614;
}
V_281 = F_300 ( V_1 ) ;
...
F_173 ( & V_1 -> V_24 -> V_25 , L_194 ) ;
F_173 ( & V_1 -> V_24 -> V_25 ,
L_195 ) ;
V_1 -> V_387 . V_611 ( V_1 , V_615 ) ;
F_256 ( 10000 ) ;
V_1 -> V_387 . V_611 ( V_1 , V_612 ) ;
V_281 = F_284 ( V_1 -> V_204 ) ;
if ( V_281 )
F_173 ( & V_1 -> V_24 -> V_25 ,
L_196 ) ;
F_301 ( V_1 ) ;
...
static void F_315 ( struct V_476 * V_24 )
{
T_1 * V_1 ;
char * V_616 ;
int V_319 ;
...
static void T_45 F_317 ( struct V_476 * V_24 )
{
T_1 * V_1 ;
int V_20 , V_22 ;
if ( F_316 ( V_24 ) == NULL ) {
F_18 ( & V_24 -> V_25 , L_201 ) ;
return;
}
V_1 = F_316 ( V_24 ) ;
V_20 = V_1 -> V_62 ;
if ( V_268 [ V_20 ] == NULL ) {
F_18 ( & V_24 -> V_25 , L_202 ) ;
return;
}
F_90 ( & V_1 -> V_455 ) ;
F_224 ( V_1 ) ;
...
static int T_46 F_320 ( void )
{
int V_80 ;
F_241 ( sizeof( T_2 ) % V_617 ) ;
F_321 (KERN_INFO DRIVER_NAME L_203 ) ;
V_80 = F_322 ( & V_121 ) ;
if ( V_80 )
return V_80 ;
V_103 = F_323 ( F_228 , NULL , L_204 ) ;
if ( F_324 ( V_103 ) ) {
V_80 = F_325 ( V_103 ) ;
goto V_618;
}
...
static void T_47 F_329 ( void )
{
int V_20 ;
F_330 ( & V_619 ) ;
for ( V_20 = 0 ; V_20 < V_564 ; V_20 ++ ) {
if ( V_268 [ V_20 ] != NULL ) {
F_153 ( & V_268 [ V_20 ] -> V_24 -> V_25 ,
L_205 ) ;
F_317 ( V_268 [ V_20 ] -> V_24 ) ;
}
}
F_327 ( V_103 ) ;
if ( V_90 )
