...
static int F_16 ( struct V_11 * * V_13 , const struct V_14 * V_15 , int V_16 , int V_17 , int V_18 , const char * V_29 , T_4 V_3 , struct V_1 * V_2 )
{
...
F_19 ( & V_32 ) ;
F_40 ( L_20 , V_26 >> 4 ) ;
F_40 ( L_21 , V_26 >> 4 , V_37 ) ;
if ( F_40 ( L_22 , V_5 , V_26 ) > 0 )
F_40 ( L_23 , V_5 ) ;
F_18 ( & V_32 ) ;
V_12 = F_36 ( V_37 , V_26 ) ;
if ( V_12 )
...
if ( V_46 ) {
int V_47 = 0 ;
const struct V_14 * V_48 = V_45 -> V_49 ;
V_45 -> V_49 = V_46 ;
F_19 ( & V_32 ) ;
if ( V_45 -> V_49 -> V_50 )
V_47 = V_45 -> V_49 -> V_50 ( V_44 , V_45 ) ;
if ( V_47 ) {
F_41 ( V_45 -> V_49 ) ;
V_45 -> V_49 = F_39 ( V_48 ) ;
}
