...
return 1 ;
V_75 = V_14 -> V_79 ;
V_76 = F_21 ( V_6 , V_12 + sizeof( V_18 ) + sizeof( V_15 ) , & V_75 ) ;
if ( V_76 < 0 )
return 1 ;
if ( V_75 != V_26 &&
V_75 != V_27 )
...
V_81 = F_24 ( V_6 , & V_80 , - 1 , NULL ) ;
if ( V_81 < 0 ) {
F_16 ( L_2 ) ;
return V_82 ;
}
if ( V_81 == V_27 || V_81 == V_26 ) {
V_38 = F_7 ( V_6 , V_80 ,
sizeof( V_37 ) , & V_37 ) ;
if ( V_38 == NULL )
return false ;
...
if ( F_20 ( V_6 , V_80 , & V_81 , & V_29 , & V_30 ,
& V_40 , & V_39 ) )
return false ;
} else {
return false ;
}
V_2 = F_25 ( F_14 ( V_6 -> V_62 ) , V_81 ,
V_29 , V_30 , V_40 , V_39 , V_32 -> V_63 , V_64 ) ;
if ( V_2 != NULL ) {
bool V_65 ;
bool V_66 = true ;
