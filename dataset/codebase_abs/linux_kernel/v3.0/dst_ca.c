...
struct V_46 * V_57 ;
int V_70 = 0 ;
if ( ( V_57 = F_34 ( sizeof ( struct V_46 ) , V_71 ) ) == NULL ) {
F_5 ( V_6 , V_16 , 1 , L_41 ) ;
return - V_72 ;
}
F_5 ( V_6 , V_7 , 1 , L_42 ) ;
...
static long F_36 ( struct V_78 * V_78 , unsigned int V_79 , unsigned long V_80 )
{
struct V_81 * V_82 ;
struct V_8 * V_9 ;
struct V_48 * V_49 ;
struct V_37 * V_38 ;
struct V_46 * V_47 ;
void T_2 * V_39 = ( void T_2 * ) V_80 ;
int V_70 = 0 ;
F_8 ( & V_83 ) ;
V_82 = V_78 -> V_84 ;
V_9 = (struct V_8 * ) V_82 -> V_85 ;
V_47 = F_34 ( sizeof ( struct V_46 ) , V_71 ) ;
V_49 = F_34 ( sizeof ( struct V_48 ) , V_71 ) ;
V_38 = F_34 ( sizeof ( struct V_37 ) , V_71 ) ;
if ( ! V_47 || ! V_49 || ! V_38 ) {
F_5 ( V_6 , V_16 , 1 , L_41 ) ;
V_70 = - V_72 ;
goto V_73;
...
static int F_38 ( struct V_94 * V_94 , struct V_78 * V_78 )
{
F_5 ( V_6 , V_7 , 1 , L_77 , V_78 ) ;
F_39 ( V_95 ) ;
return 0 ;
}
static int F_40 ( struct V_94 * V_94 , struct V_78 * V_78 )
{
F_5 ( V_6 , V_7 , 1 , L_78 ) ;
F_41 ( V_95 ) ;
return 0 ;
}
static T_4 F_42 ( struct V_78 * V_78 , char T_2 * V_96 , T_5 V_4 , T_6 * V_64 )
{
T_4 V_97 = 0 ;
F_5 ( V_6 , V_7 , 1 , L_79 ) ;
return V_97 ;
}
static T_4 F_43 ( struct V_78 * V_78 , const char T_2 * V_96 , T_5 V_4 , T_6 * V_64 )
{
F_5 ( V_6 , V_7 , 1 , L_80 ) ;
return 0 ;
}
struct V_81 * F_44 ( struct V_8 * V_98 , struct V_99 * V_99 )
{
struct V_81 * V_82 ;
F_5 ( V_6 , V_16 , 1 , L_81 ) ;
if ( F_45 ( V_99 , & V_82 , & V_100 , V_98 , V_101 ) == 0 ) {
V_98 -> V_102 = V_82 ;
return V_98 -> V_102 ;
}
return NULL ;
