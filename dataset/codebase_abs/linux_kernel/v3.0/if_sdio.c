...
static void F_54 ( struct V_95 * V_6 )
{
int V_4 ;
struct V_1 * V_2 ;
T_2 V_96 ;
F_6 ( V_22 ) ;
V_2 = F_55 ( V_6 ) ;
V_96 = F_2 ( V_2 -> V_6 , V_97 , & V_4 ) ;
if ( V_4 || ! V_96 )
goto V_25;
F_7 ( L_29 , ( unsigned ) V_96 ) ;
F_43 ( V_2 -> V_6 , ~ V_96 , V_97 , & V_4 ) ;
if ( V_4 )
goto V_25;
V_2 -> V_19 -> V_98 = 1 ;
if ( V_96 & V_99 )
...
static int F_57 ( struct V_95 * V_6 ,
...
unsigned int V_11 ;
struct V_54 * V_55 ;
struct V_103 * V_104 = V_6 -> V_2 -> V_104 ;
F_6 ( V_22 ) ;
for ( V_21 = 0 ; V_21 < V_6 -> V_2 -> V_105 ; V_21 ++ ) {
if ( sscanf ( V_6 -> V_2 -> V_106 [ V_21 ] ,
L_30 , & V_11 ) == 1 )
break;
if ( sscanf ( V_6 -> V_2 -> V_106 [ V_21 ] ,
L_31 , & V_11 ) == 1 )
break;
if ( ! strcmp ( V_6 -> V_2 -> V_106 [ V_21 ] , L_32 ) ) {
V_11 = V_12 ;
break;
}
}
if ( V_21 == V_6 -> V_2 -> V_105 ) {
F_26 ( L_33 ) ;
return - V_107 ;
}
...
V_2 -> V_88 = F_59 ( L_34 ) ;
F_60 ( & V_2 -> V_56 , F_27 ) ;
for ( V_21 = 0 ; V_21 < F_61 ( V_80 ) ; V_21 ++ ) {
...
T_2 V_116 ;
V_6 -> V_2 -> V_117 |= V_118 ;
V_116 = F_63 ( V_6 , V_119 , & V_4 ) ;
if ( V_4 )
goto V_120;
V_116 |= V_121 ;
F_64 ( V_6 , V_116 , V_119 , & V_4 ) ;
if ( V_4 )
goto V_120;
}
V_2 -> V_48 = F_2 ( V_6 , V_122 , & V_4 ) ;
if ( V_4 )
goto V_120;
V_2 -> V_48 |= F_2 ( V_6 , V_122 + 1 , & V_4 ) << 8 ;
if ( V_4 )
goto V_120;
V_2 -> V_48 |= F_2 ( V_6 , V_122 + 2 , & V_4 ) << 16 ;
if ( V_4 )
goto V_120;
F_31 ( V_6 ) ;
F_65 ( V_6 , V_2 ) ;
F_7 ( L_36
L_37 ,
V_6 -> V_123 , V_6 -> V_124 , V_6 -> V_125 ,
V_11 , ( unsigned ) V_2 -> V_48 ) ;
V_4 = F_42 ( V_2 ) ;
if ( V_4 )
goto V_126;
V_19 = F_66 ( V_2 , & V_6 -> V_77 ) ;
if ( ! V_19 ) {
V_4 = - V_35 ;
goto V_126;
}
...
memset ( & V_90 , 0 , sizeof( V_90 ) ) ;
F_7 ( L_38 ) ;
if ( F_50 ( V_19 , V_133 , & V_90 , sizeof( V_90 ) ,
V_92 , ( unsigned long ) & V_90 ) )
F_68 ( V_19 -> V_77 , L_39 ) ;
}
V_4 = F_69 ( V_19 ) ;
...
static void F_75 ( struct V_95 * V_6 )
{
struct V_1 * V_2 ;
struct V_54 * V_55 ;
F_6 ( V_22 ) ;
V_2 = F_55 ( V_6 ) ;
if ( V_137 && ( V_2 -> V_11 == V_14 ) ) {
struct V_89 V_90 ;
memset ( & V_90 , 0 , sizeof( V_90 ) ) ;
F_7 ( L_40 ) ;
if ( F_50 ( V_2 -> V_19 , V_138 ,
...
static int F_78 ( struct V_125 * V_77 )
{
struct V_95 * V_6 = F_79 ( V_77 ) ;
int V_4 ;
struct V_1 * V_2 = F_55 ( V_6 ) ;
T_5 V_20 = F_80 ( V_6 ) ;
F_81 ( V_77 , L_43 ,
F_82 ( V_6 ) , V_20 ) ;
if ( V_2 -> V_19 -> V_139 == V_140 ) {
F_81 ( V_77 , L_44 ) ;
return - V_141 ;
}
if ( ! ( V_20 & V_142 ) ) {
...
if ( V_4 )
return V_4 ;
return F_84 ( V_6 , V_143 ) ;
}
static int F_86 ( struct V_125 * V_77 )
{
struct V_95 * V_6 = F_79 ( V_77 ) ;
struct V_1 * V_2 = F_55 ( V_6 ) ;
int V_4 ;
F_81 ( V_77 , L_46 , F_82 ( V_6 ) ) ;
V_4 = F_87 ( V_2 -> V_19 ) ;
return V_4 ;
}
