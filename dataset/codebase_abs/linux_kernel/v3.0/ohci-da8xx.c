...
V_19 -> V_71 = V_63 -> V_72 ;
V_19 -> V_73 = V_63 -> V_74 - V_63 -> V_72 + 1 ;
if ( ! F_33 ( V_19 -> V_71 , V_19 -> V_73 , V_75 ) ) {
F_11 ( & V_61 -> V_21 , L_13 ) ;
error = - V_76 ;
goto V_70;
}
V_19 -> V_30 = F_34 ( V_19 -> V_71 , V_19 -> V_73 ) ;
if ( ! V_19 -> V_30 ) {
F_35 ( & V_61 -> V_21 , L_14 ) ;
error = - V_67 ;
goto V_77;
...
static inline void
F_44 ( struct V_18 * V_19 , struct V_60 * V_61 )
{
struct V_12 * V_13 = V_61 -> V_21 . V_24 ;
V_13 -> V_80 ( NULL ) ;
F_39 ( V_19 ) ;
...
static int F_45 ( struct V_60 * V_21 )
{
return F_26 ( & V_81 , V_21 ) ;
}
static int F_46 ( struct V_60 * V_21 )
{
struct V_18 * V_19 = F_47 ( V_21 ) ;
F_44 ( V_19 , V_21 ) ;
F_48 ( V_21 , NULL ) ;
return 0 ;
}
static int F_49 ( struct V_60 * V_21 , T_3 V_82 )
{
struct V_18 * V_19 = F_47 ( V_21 ) ;
struct V_25 * V_26 = F_10 ( V_19 ) ;
if ( F_50 ( V_83 , V_26 -> V_84 ) )
F_51 ( 5 ) ;
V_26 -> V_84 = V_83 ;
F_1 ( 0 ) ;
V_19 -> V_85 = V_86 ;
V_21 -> V_21 . V_87 . V_88 = V_89 ;
return 0 ;
}
static int F_52 ( struct V_60 * V_21 )
{
struct V_18 * V_19 = F_47 ( V_21 ) ;
struct V_25 * V_26 = F_10 ( V_19 ) ;
if ( F_50 ( V_83 , V_26 -> V_84 ) )
