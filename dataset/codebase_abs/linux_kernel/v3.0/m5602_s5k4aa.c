...
if ( V_5 < 0 )
return V_5 ;
V_5 = F_10 ( & V_1 -> V_23 , V_6 [ V_42 ] ) ;
if ( V_5 < 0 )
return V_5 ;
V_5 = F_14 ( & V_1 -> V_23 , V_6 [ V_43 ] ) ;
if ( V_5 < 0 )
return V_5 ;
return F_15 ( & V_1 -> V_23 , V_6 [ V_44 ] ) ;
}
...
static int F_18 ( struct V_23 * V_23 , T_3 * V_47 )
{
...
static int F_21 ( struct V_23 * V_23 , T_3 * V_47 )
{
struct V_1 * V_1 = (struct V_1 * ) V_23 ;
T_2 * V_6 = V_1 -> V_33 ;
* V_47 = V_6 [ V_44 ] ;
...
static int F_10 ( struct V_23 * V_23 , T_3 V_47 )
{
struct V_1 * V_1 = (struct V_1 * ) V_23 ;
T_2 * V_6 = V_1 -> V_33 ;
T_1 V_15 = V_48 ;
