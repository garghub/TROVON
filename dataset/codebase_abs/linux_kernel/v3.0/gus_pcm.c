...
int F_100 ( struct V_1 * V_2 , int V_151 , int V_152 , struct V_153 * * V_154 )
{
struct V_155 * V_156 ;
struct V_133 * V_157 ;
struct V_153 * V_150 ;
...
* V_154 = NULL ;
V_156 = V_2 -> V_156 ;
V_158 = ! V_2 -> V_78 && ! V_2 -> V_159 && ! V_2 -> V_160 ? 1 : 0 ;
V_90 = F_101 ( V_156 ,
V_2 -> V_78 ? L_4 : L_5 ,
V_151 ,
V_2 -> V_47 . V_161 / 2 ,
...
return V_90 ;
V_150 -> V_3 = V_2 ;
F_102 ( V_150 , V_162 , & V_163 ) ;
for ( V_9 = V_150 -> V_164 [ V_162 ] . V_9 ; V_9 ; V_9 = V_9 -> V_165 )
F_103 ( V_9 , V_166 ,
F_104 () ,
...
V_150 -> V_168 = V_169 ;
if ( V_158 ) {
F_102 ( V_150 , V_170 , & V_171 ) ;
if ( V_2 -> V_47 . V_110 == V_2 -> V_47 . V_122 )
V_150 -> V_167 |= V_172 ;
F_103 ( V_150 -> V_164 [ V_170 ] . V_9 ,
V_166 , F_104 () ,
64 * 1024 , V_2 -> V_47 . V_110 > 3 ? 128 * 1024 : 64 * 1024 ) ;
}
strcpy ( V_150 -> V_173 , V_150 -> V_174 ) ;
if ( V_2 -> V_78 ) {
sprintf ( V_150 -> V_173 + strlen ( V_150 -> V_173 ) , L_6 , V_2 -> V_175 + 'A' ) ;
}
strcat ( V_150 -> V_173 , L_7 ) ;
V_2 -> V_150 = V_150 ;
if ( V_2 -> V_176 )
V_157 = F_105 ( & V_177 , V_2 ) ;
else
V_157 = F_105 ( & V_178 , V_2 ) ;
if ( ( V_90 = F_106 ( V_156 , V_157 ) ) < 0 )
return V_90 ;
V_157 -> V_174 . V_179 = V_152 ;
if ( V_154 )
* V_154 = V_150 ;
return 0 ;
}
