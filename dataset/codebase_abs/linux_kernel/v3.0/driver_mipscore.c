...
if ( V_13 -> V_30 . V_4 ) {
F_19 ( & V_13 -> V_30 , & V_39 , & V_40 , & V_41 ) ;
} else if ( V_13 -> V_33 . V_4 ) {
F_20 ( & V_13 -> V_33 , & V_39 , & V_40 , & V_41 ) ;
} else
return 0 ;
if ( ( V_39 == V_43 ) || ( V_13 -> V_44 == 0x5365 ) ) {
V_42 = 200000000 ;
} else {
V_42 = F_21 ( V_39 , V_40 , V_41 ) ;
}
if ( V_39 == V_45 ) {
V_42 *= 2 ;
}
