...
if ( V_28 >= 0 && F_31 ( V_28 , V_73 , V_74 , L_5 , ( void * ) V_2 ) ) {
F_30 ( V_71 L_6 , V_28 ) ;
F_15 ( V_2 ) ;
return - V_72 ;
}
...
V_2 -> V_24 . V_76 = 25 ;
V_2 -> V_24 . V_77 = 1 ;
if ( ( V_42 = F_33 ( V_3 , V_78 , V_2 , & V_44 ) ) < 0 ) {
F_15 ( V_2 ) ;
return V_42 ;
}
* V_41 = V_2 ;
...
for ( V_80 = 1 , V_82 = 0xab ; V_80 < 4 ; V_80 ++ , V_82 ++ ) {
V_81 = V_80 << 18 ;
F_35 ( V_2 , V_81 , V_82 ) ;
F_35 ( V_2 , V_81 + 1 , V_82 + 1 ) ;
if ( F_36 ( V_2 , V_81 ) != V_82 ||
F_36 ( V_2 , V_81 + 1 ) != V_82 + 1 ||
F_36 ( V_2 , 0L ) != 0xaa )
break;
}
#if 1
V_2 -> V_24 . V_83 = V_80 << 18 ;
#else
V_2 -> V_24 . V_83 = 256 * 1024 ;
#endif
for ( V_79 = 0 , V_81 = V_2 -> V_24 . V_83 ; V_79 < 4 ; V_79 ++ , V_81 -= 256 * 1024 ) {
V_2 -> V_24 . V_84 . V_85 [ V_79 ] . V_86 =
V_2 -> V_24 . V_84 . V_85 [ V_79 ] . V_87 = 0 ;
V_2 -> V_24 . V_84 . V_88 [ V_79 ] . V_86 = V_79 << 18 ;
V_2 -> V_24 . V_84 . V_88 [ V_79 ] . V_87 = V_81 > 0 ? 256 * 1024 : 0 ;
}
V_2 -> V_24 . V_84 . V_85 [ 0 ] . V_87 = V_2 -> V_24 . V_83 ;
return 0 ;
}
static int F_17 ( struct V_1 * V_2 , int V_89 )
{
struct V_35 * V_3 ;
unsigned long V_17 ;
int V_28 , V_29 , V_31 ;
static unsigned char V_90 [ 16 ] =
{ 0 , 0 , 1 , 3 , 0 , 2 , 0 , 4 , 0 , 1 , 0 , 5 , 6 , 0 , 0 , 7 } ;
static unsigned char V_91 [ 8 ] =
{ 6 , 1 , 0 , 2 , 0 , 3 , 4 , 5 } ;
if ( F_37 ( ! V_2 ) )
return - V_92 ;
V_3 = V_2 -> V_3 ;
...
#endif
F_9 ( & V_2 -> V_20 , V_17 ) ;
F_38 ( 5 , F_28 ( V_2 , V_96 ) ) ;
F_38 ( V_2 -> V_93 , F_28 ( V_2 , V_97 ) ) ;
F_38 ( 0x00 , F_28 ( V_2 , V_98 ) ) ;
F_38 ( 0 , F_28 ( V_2 , V_96 ) ) ;
F_11 ( & V_2 -> V_20 , V_17 ) ;
F_39 ( 100 ) ;
F_9 ( & V_2 -> V_20 , V_17 ) ;
F_38 ( 0x00 | V_2 -> V_93 , F_28 ( V_2 , V_97 ) ) ;
F_38 ( V_29 , F_28 ( V_2 , V_98 ) ) ;
if ( V_89 ) {
F_38 ( 0x40 | V_2 -> V_93 , F_28 ( V_2 , V_97 ) ) ;
F_38 ( V_28 , F_28 ( V_2 , V_98 ) ) ;
}
F_11 ( & V_2 -> V_20 , V_17 ) ;
F_39 ( 100 ) ;
F_9 ( & V_2 -> V_20 , V_17 ) ;
...
V_3 = V_2 -> V_3 ;
F_9 ( & V_2 -> V_20 , V_17 ) ;
F_38 ( 0x20 , F_28 ( V_2 , V_96 ) ) ;
V_99 = F_42 ( F_28 ( V_2 , V_96 ) ) ;
V_100 = F_42 ( F_28 ( V_2 , V_101 ) ) ;
F_11 ( & V_2 -> V_20 , V_17 ) ;
F_43 ( L_14 , V_2 -> V_24 . V_36 , V_99 , V_100 ) ;
strcpy ( V_3 -> V_102 , L_15 ) ;
strcpy ( V_3 -> V_103 , L_16 ) ;
if ( ( V_99 != 255 && ( V_99 & 0x06 ) ) || ( V_100 >= 5 && V_100 != 255 ) ) {
if ( V_100 >= 5 && V_100 <= 9 ) {
V_2 -> V_104 = 1 ;
if ( V_100 == 5 )
V_2 -> V_105 = 1 ;
V_3 -> V_103 [ 27 ] = '3' ;
V_3 -> V_103 [ 29 ] = V_100 == 5 ? '5' : '7' ;
}
if ( V_100 >= 10 && V_100 != 255 ) {
if ( V_100 >= 10 && V_100 <= 11 ) {
strcpy ( V_3 -> V_102 , L_17 ) ;
strcpy ( V_3 -> V_103 , L_18 ) ;
V_2 -> V_106 = 1 ;
} else if ( V_100 == 0x30 ) {
strcpy ( V_3 -> V_102 , L_19 ) ;
strcpy ( V_3 -> V_103 , L_20 ) ;
V_2 -> V_22 = 1 ;
} else if ( V_100 == 0x50 ) {
strcpy ( V_3 -> V_102 , L_21 ) ;
strcpy ( V_3 -> V_103 , L_22 ) ;
V_2 -> V_95 = 1 ;
} else {
F_30 ( V_71 L_23 , V_2 -> V_24 . V_36 , V_100 , V_99 ) ;
F_30 ( V_71 L_24 ) ;
}
}
}
strcpy ( V_3 -> V_107 , V_3 -> V_103 ) ;
V_2 -> V_108 = 1 ;
F_12 ( V_2 ) ;
return 0 ;
}
