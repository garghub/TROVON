...
F_68 ( V_39 , V_214 -> V_52 , V_214 -> V_224 ) ;
F_69 ( V_214 ) ;
F_32 ( V_82 , V_39 -> V_125 ) ;
F_3 ( V_2 , V_33 , V_101 ,
L_18
...
if ( V_214 ) {
F_91 ( V_39 , V_214 -> V_52 , V_214 -> V_224 ) ;
F_69 ( V_214 ) ;
}
F_67 ( V_4 ) ;
F_92 ( & V_197 -> V_51 ) ;
...
static T_1
F_99 ( struct V_1 * V_2 , struct V_3 * V_4 ,
void * V_195 , T_1 V_196 )
{
struct V_40 * V_41 ;
V_41 = (struct V_40 * ) V_195 ;
...
struct V_38 * V_39 = V_2 -> V_39 ;
struct V_40 * V_41 = (struct V_40 * ) V_195 ;
F_118 ( V_2 , & V_39 -> V_64 . V_67 [ V_39 -> V_64 . V_243 ] ,
V_4 -> V_244 , 0 , V_245 ) ;
F_39 ( V_2 , V_4 , V_41 , V_163 ) ;
return V_4 -> V_72 ;
}
...
{
T_1 V_249 , V_85 ;
T_1 (* F_134) ( struct V_1 * , struct V_3 * , void * ,
T_1 );
T_1 V_250 = 0 ;
if ( F_66 ( V_4 ) )
V_250 = 1 ;
...
F_134 = V_252 [ ( V_249 * V_253 ) + V_196 ] ;
V_85 = ( F_134 ) ( V_2 , V_4 , V_195 , V_196 ) ;
if ( V_250 ) {
F_3 ( V_2 , V_70 , V_34 ,
L_26 ,
