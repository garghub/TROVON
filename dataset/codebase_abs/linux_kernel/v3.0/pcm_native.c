...
if ( V_30 < 0 )
goto V_304;
if ( ! F_197 ( V_8 -> V_11 -> V_305 ) ) {
V_30 = - V_33 ;
goto V_306;
}
F_134 ( & V_220 , V_228 ) ;
F_135 ( & V_8 -> V_307 , & V_220 ) ;
F_198 ( & V_8 -> V_308 ) ;
while ( 1 ) {
V_30 = F_190 ( V_217 , V_8 , V_14 , & V_245 ) ;
if ( V_30 >= 0 )
break;
if ( V_30 == - V_225 ) {
if ( V_217 -> V_214 & V_222 ) {
...
F_138 ( & V_8 -> V_307 , & V_220 ) ;
F_200 ( & V_8 -> V_308 ) ;
if ( V_30 < 0 )
goto V_310;
return V_30 ;
V_310:
F_202 ( V_8 -> V_11 -> V_305 ) ;
V_306:
...
F_37 ( V_3 ) ;
if ( ! V_30 )
if ( F_214 ( V_315 , V_151 ) )
V_30 = - V_33 ;
return V_30 ;
}
static int F_215 ( struct V_2 * V_3 ,
struct F_215 T_2 * V_316 )
{
struct V_5 * V_6 = V_3 -> V_6 ;
struct F_215 V_317 ;
volatile struct V_318 * V_93 ;
volatile struct V_319 * V_121 ;
int V_30 ;
memset ( & V_317 , 0 , sizeof( V_317 ) ) ;
if ( F_216 ( V_317 . V_79 , ( unsigned T_2 * ) & ( V_316 -> V_79 ) ) )
return - V_33 ;
if ( F_61 ( & V_317 . V_320 . V_121 , & ( V_316 -> V_320 . V_121 ) , sizeof( struct V_319 ) ) )
return - V_33 ;
V_93 = V_6 -> V_93 ;
V_121 = V_6 -> V_121 ;
if ( V_317 . V_79 & V_321 ) {
...
F_36 ( V_3 ) ;
if ( ! ( V_317 . V_79 & V_322 ) )
V_121 -> V_142 = V_317 . V_320 . V_121 . V_142 ;
else
V_317 . V_320 . V_121 . V_142 = V_121 -> V_142 ;
if ( ! ( V_317 . V_79 & V_323 ) )
V_121 -> V_122 = V_317 . V_320 . V_121 . V_122 ;
else
V_317 . V_320 . V_121 . V_122 = V_121 -> V_122 ;
V_317 . V_157 . V_93 . V_94 = V_93 -> V_94 ;
V_317 . V_157 . V_93 . V_143 = V_93 -> V_143 ;
V_317 . V_157 . V_93 . V_140 = V_93 -> V_140 ;
V_317 . V_157 . V_93 . V_136 = V_93 -> V_136 ;
F_37 ( V_3 ) ;
if ( F_10 ( V_316 , & V_317 , sizeof( V_317 ) ) )
return - V_33 ;
return 0 ;
}
static int F_217 ( struct V_2 * V_3 , int T_2 * V_324 )
{
struct V_5 * V_6 = V_3 -> V_6 ;
int V_325 ;
if ( F_216 ( V_325 , V_324 ) )
return - V_33 ;
...
switch ( V_330 ) {
case V_331 :
return F_214 ( V_332 , ( int T_2 * ) V_325 ) ? - V_33 : 0 ;
case V_333 :
return F_8 ( V_3 , V_325 ) ;
case V_334 :
return 0 ;
case V_335 :
return F_217 ( V_3 , V_325 ) ;
case V_336 :
return F_30 ( V_3 , V_325 ) ;
case V_337 :
return F_54 ( V_3 , V_325 ) ;
case V_338 :
return F_55 ( V_3 ) ;
case V_339 :
return F_60 ( V_3 , V_325 ) ;
case V_340 :
return F_67 ( V_3 , V_325 ) ;
case V_341 :
return F_69 ( V_3 , V_325 ) ;
case V_342 :
...
return F_212 ( V_3 ) ;
case V_350 :
return F_213 ( V_3 , V_325 ) ;
case V_351 :
return F_215 ( V_3 , V_325 ) ;
#ifdef F_219
case V_352 :
return F_220 ( V_3 , V_325 ) ;
case V_353 :
return F_221 ( V_3 , V_325 ) ;
#endif
case V_354 :
...
int V_151 ;
F_36 ( V_3 ) ;
V_151 = F_103 ( V_3 , ( int ) ( unsigned long ) V_325 ) ;
F_37 ( V_3 ) ;
return V_151 ;
}
}
...
if ( V_6 -> V_93 -> V_94 == V_95 )
return - V_98 ;
if ( F_214 ( 0 , & V_361 -> V_132 ) )
return - V_33 ;
if ( F_61 ( & V_360 , V_361 , sizeof( V_360 ) ) )
return - V_33 ;
V_132 = F_223 ( V_3 , V_360 . V_362 , V_360 . V_91 ) ;
F_224 ( V_132 , & V_361 -> V_132 ) ;
...
if ( V_6 -> V_108 > 128 )
return - V_62 ;
if ( F_214 ( 0 , & V_366 -> V_132 ) )
return - V_33 ;
if ( F_61 ( & V_365 , V_366 , sizeof( V_365 ) ) )
return - V_33 ;
V_367 = F_31 ( V_365 . V_367 ,
sizeof( void * ) * V_6 -> V_108 ) ;
if ( F_32 ( V_367 ) )
return F_33 ( V_367 ) ;
V_132 = F_225 ( V_3 , V_367 , V_365 . V_91 ) ;
F_11 ( V_367 ) ;
F_224 ( V_132 , & V_366 -> V_132 ) ;
return V_132 < 0 ? V_132 : 0 ;
}
case V_368 :
{
...
return F_218 ( V_217 , V_3 , V_330 , V_325 ) ;
}
...
if ( F_61 ( & V_360 , V_361 , sizeof( V_360 ) ) )
return - V_33 ;
V_132 = F_227 ( V_3 , V_360 . V_362 , V_360 . V_91 ) ;
F_224 ( V_132 , & V_361 -> V_132 ) ;
return V_132 < 0 ? V_132 : 0 ;
}
case V_372 :
...
if ( F_32 ( V_367 ) )
return F_33 ( V_367 ) ;
V_132 = F_228 ( V_3 , V_367 , V_365 . V_91 ) ;
F_11 ( V_367 ) ;
F_224 ( V_132 , & V_366 -> V_132 ) ;
return V_132 < 0 ? V_132 : 0 ;
}
...
static long F_229 ( struct V_217 * V_217 , unsigned int V_330 ,
unsigned long V_325 )
{
struct V_244 * V_245 ;
V_245 = V_217 -> V_247 ;
if ( ( ( V_330 >> 8 ) & 0xff ) != 'A' )
return - V_357 ;
return F_222 ( V_217 , V_245 -> V_3 , V_330 ,
( void T_2 * ) V_325 ) ;
}
static long F_230 ( struct V_217 * V_217 , unsigned int V_330 ,
unsigned long V_325 )
{
struct V_244 * V_245 ;
V_245 = V_217 -> V_247 ;
if ( ( ( V_330 >> 8 ) & 0xff ) != 'A' )
return - V_357 ;
return F_226 ( V_217 , V_245 -> V_3 , V_330 ,
( void T_2 * ) V_325 ) ;
}
...
switch ( V_3 -> V_14 ) {
case V_134 :
V_132 = F_222 ( NULL , V_3 , V_330 ,
( void T_2 * ) V_325 ) ;
break;
case V_302 :
V_132 = F_226 ( NULL , V_3 , V_330 ,
( void T_2 * ) V_325 ) ;
break;
default:
V_132 = - V_62 ;
...
static T_7 F_232 ( struct V_217 * V_217 , char T_2 * V_362 , T_8 V_253 ,
T_9 * V_373 )
{
struct V_244 * V_245 ;
struct V_2 * V_3 ;
...
V_132 = F_227 ( V_3 , V_362 , V_253 ) ;
if ( V_132 > 0 )
V_132 = F_235 ( V_6 , V_132 ) ;
return V_132 ;
}
static T_7 F_236 ( struct V_217 * V_217 , const char T_2 * V_362 ,
T_8 V_253 , T_9 * V_373 )
{
struct V_244 * V_245 ;
struct V_2 * V_3 ;
...
return - V_62 ;
V_253 = F_234 ( V_6 , V_253 ) ;
V_132 = F_223 ( V_3 , V_362 , V_253 ) ;
if ( V_132 > 0 )
V_132 = F_235 ( V_6 , V_132 ) ;
return V_132 ;
}
static T_7 F_237 ( struct V_374 * V_375 , const struct V_376 * V_377 ,
...
if ( V_6 -> V_93 -> V_94 == V_95 )
return - V_98 ;
if ( V_378 > 1024 || V_378 != V_6 -> V_108 )
return - V_62 ;
if ( ! F_233 ( V_6 , V_377 -> V_381 ) )
return - V_62 ;
V_91 = F_238 ( V_6 , V_377 -> V_381 ) ;
V_367 = F_9 ( sizeof( void * ) * V_378 , V_31 ) ;
if ( V_367 == NULL )
return - V_32 ;
for ( V_40 = 0 ; V_40 < V_378 ; ++ V_40 )
V_367 [ V_40 ] = V_377 [ V_40 ] . V_382 ;
V_132 = F_228 ( V_3 , V_367 , V_91 ) ;
if ( V_132 > 0 )
V_132 = F_235 ( V_6 , V_132 ) ;
F_11 ( V_367 ) ;
return V_132 ;
}
static T_7 F_239 ( struct V_374 * V_375 , const struct V_376 * V_377 ,
unsigned long V_378 , T_9 V_379 )
{
struct V_244 * V_245 ;
struct V_2 * V_3 ;
...
if ( V_6 -> V_93 -> V_94 == V_95 )
return - V_98 ;
if ( V_378 > 128 || V_378 != V_6 -> V_108 ||
! F_233 ( V_6 , V_377 -> V_381 ) )
return - V_62 ;
V_91 = F_238 ( V_6 , V_377 -> V_381 ) ;
V_367 = F_9 ( sizeof( void * ) * V_378 , V_31 ) ;
if ( V_367 == NULL )
...
default:
V_256 = V_386 | V_387 | V_385 ;
break;
}
F_37 ( V_3 ) ;
return V_256 ;
}
static int F_243 ( struct V_388 * V_389 ,
struct V_390 * V_391 )
{
...
if ( V_395 != F_246 ( sizeof( struct V_318 ) ) )
return - V_62 ;
V_389 -> V_400 = & V_401 ;
V_389 -> V_392 = V_3 ;
V_389 -> V_396 |= V_402 ;
...
static int F_247 ( struct V_388 * V_389 ,
struct V_390 * V_391 )
{
struct V_2 * V_3 = V_389 -> V_392 ;
struct V_5 * V_6 ;
...
return - V_62 ;
V_395 = V_389 -> V_398 - V_389 -> V_399 ;
if ( V_395 != F_246 ( sizeof( struct V_319 ) ) )
return - V_62 ;
V_389 -> V_400 = & V_403 ;
V_389 -> V_392 = V_3 ;
V_389 -> V_396 |= V_402 ;
...
F_248 ( struct V_2 * V_3 , unsigned long V_404 )
{
void * V_405 = V_3 -> V_6 -> V_406 + V_404 ;
#if F_38 ( V_407 ) && F_38 ( V_408 )
if ( V_3 -> V_409 . V_410 . type == V_411 )
return F_244 ( F_249 ( V_405 ) ) ;
#endif
#if F_38 ( V_412 ) && F_38 ( V_413 )
if ( V_3 -> V_409 . V_410 . type == V_411 ) {
T_11 V_414 = V_3 -> V_6 -> V_415 + V_404 ;
V_414 -= F_250 ( V_3 -> V_409 . V_410 . V_410 ) ;
return F_251 ( V_414 >> V_416 ) ;
}
#endif
return F_244 ( V_405 ) ;
}
static int F_252 ( struct V_388 * V_389 ,
struct V_390 * V_391 )
{
struct V_2 * V_3 = V_389 -> V_392 ;
struct V_5 * V_6 ;
...
if ( V_373 > V_292 - V_418 )
return V_393 ;
if ( V_3 -> V_26 -> V_394 )
V_394 = V_3 -> V_26 -> V_394 ( V_3 , V_373 ) ;
else
V_394 = F_248 ( V_3 , V_373 ) ;
if ( ! V_394 )
return V_393 ;
F_245 ( V_394 ) ;
V_391 -> V_394 = V_394 ;
...
return F_255 ( V_3 -> V_409 . V_410 . V_410 ,
V_389 ,
V_3 -> V_6 -> V_406 ,
V_3 -> V_6 -> V_415 ,
V_389 -> V_398 - V_389 -> V_399 ) ;
#elif F_38 ( V_407 ) && F_38 ( V_408 )
if ( V_3 -> V_409 . V_410 . type == V_411 &&
! F_256 ( V_3 -> V_409 . V_410 . V_410 ) )
V_389 -> V_419 = F_257 ( V_389 -> V_419 ) ;
#endif
V_389 -> V_400 = & V_420 ;
return 0 ;
}
...
V_389 -> V_396 |= V_421 ;
V_395 = V_389 -> V_398 - V_389 -> V_399 ;
V_373 = V_389 -> V_422 << V_416 ;
if ( F_259 ( V_389 , V_389 -> V_399 ,
( V_3 -> V_6 -> V_415 + V_373 ) >> V_416 ,
V_395 , V_389 -> V_419 ) )
return - V_225 ;
return 0 ;
}
...
if ( ( T_8 ) V_395 > V_292 )
return - V_62 ;
if ( V_373 > V_292 - V_395 )
return - V_62 ;
V_389 -> V_400 = & V_424 ;
V_389 -> V_392 = V_3 ;
if ( V_3 -> V_26 -> V_425 )
V_30 = V_3 -> V_26 -> V_425 ( V_3 , V_389 ) ;
else
V_30 = F_253 ( V_3 , V_389 ) ;
if ( ! V_30 )
F_261 ( & V_3 -> V_102 ) ;
return V_30 ;
}
static int F_262 ( struct V_217 * V_217 , struct V_388 * V_389 )
{
struct V_244 * V_245 ;
struct V_2 * V_3 ;
unsigned long V_373 ;
...
if ( V_245 -> V_427 )
return - V_92 ;
return V_318 ( V_3 , V_217 , V_389 ) ;
case V_428 :
if ( V_245 -> V_427 )
return - V_92 ;
return V_319 ( V_3 , V_217 , V_389 ) ;
default:
return F_260 ( V_3 , V_217 , V_389 ) ;
}
return 0 ;
}
static int F_263 ( int V_234 , struct V_217 * V_217 , int V_429 )
{
struct V_244 * V_245 ;
struct V_2 * V_3 ;
struct V_5 * V_6 ;
...
return - V_92 ;
V_6 = V_3 -> V_6 ;
return F_264 ( V_234 , V_217 , V_429 , & V_6 -> V_430 ) ;
}
...
V_35 -> V_79 = V_432 -> V_79 ;
for ( V_40 = 0 ; V_40 < F_266 ( V_432 -> V_433 ) ; V_40 ++ )
V_35 -> V_433 [ V_40 ] . V_65 [ 0 ] = V_432 -> V_433 [ V_40 ] ;
memcpy ( V_35 -> V_434 , V_432 -> V_434 , sizeof( V_432 -> V_434 ) ) ;
V_35 -> V_54 = F_267 ( V_432 -> V_54 ) ;
V_35 -> V_66 = F_267 ( V_432 -> V_66 ) ;
V_35 -> V_4 = V_432 -> V_4 ;
V_35 -> V_56 = V_432 -> V_56 ;
V_35 -> V_58 = V_432 -> V_58 ;
V_35 -> V_59 = V_432 -> V_59 ;
V_35 -> V_53 = V_432 -> V_53 ;
}
static void F_268 ( struct V_431 * V_432 ,
struct V_34 * V_35 )
{
unsigned int V_40 ;
memset ( V_432 , 0 , sizeof( * V_432 ) ) ;
V_432 -> V_79 = V_35 -> V_79 ;
for ( V_40 = 0 ; V_40 < F_266 ( V_432 -> V_433 ) ; V_40 ++ )
V_432 -> V_433 [ V_40 ] = V_35 -> V_433 [ V_40 ] . V_65 [ 0 ] ;
memcpy ( V_432 -> V_434 , V_35 -> V_434 , sizeof( V_432 -> V_434 ) ) ;
V_432 -> V_54 = F_269 ( V_35 -> V_54 ) ;
V_432 -> V_66 = F_269 ( V_35 -> V_66 ) ;
V_432 -> V_4 = V_35 -> V_4 ;
V_432 -> V_56 = V_35 -> V_56 ;
V_432 -> V_58 = V_35 -> V_58 ;
V_432 -> V_59 = V_35 -> V_59 ;
V_432 -> V_53 = V_35 -> V_53 ;
}
...
V_30 = F_12 ( V_3 , V_35 ) ;
F_268 ( V_432 , V_35 ) ;
if ( F_10 ( V_435 , V_432 , sizeof( * V_432 ) ) ) {
if ( ! V_30 )
V_30 = - V_33 ;
}
F_11 ( V_432 ) ;
...
default:
return ( unsigned long ) V_6 -> V_406 + V_373 ;
}
}
