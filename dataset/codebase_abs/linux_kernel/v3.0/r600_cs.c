...
} else if ( V_140 -> V_117 . V_165 & V_182 ) {
V_69 [ V_95 ] |= F_55 ( V_75 ) ;
...
V_40 -> V_199 [ V_64 ] = V_40 -> V_48 [ V_64 ] ;
} else {
V_77 = F_51 ( V_61 , & V_140 ) ;
if ( V_77 ) {
F_54 ( V_61 -> V_71 , L_38 , V_105 ) ;
...
V_69 [ V_95 ] = V_40 -> V_44 [ V_64 ] ;
V_40 -> V_209 [ V_64 ] = V_40 -> V_48 [ V_64 ] ;
} else {
V_77 = F_51 ( V_61 , & V_140 ) ;
if ( V_77 ) {
F_54 ( V_61 -> V_71 , L_38 , V_105 ) ;
...
case V_311 :
default:
F_13 ( V_61 -> V_71 , L_40 , F_65 ( V_294 ) ) ;
return - V_17 ;
}
V_1 = F_66 ( V_295 ) ;
if ( ! F_3 ( V_1 , V_61 -> V_5 ) ) {
...
F_13 ( V_61 -> V_71 , L_47 , V_66 , V_20 , V_21 , V_23 ) ;
return - V_17 ;
}
V_297 = F_34 ( V_61 , V_95 + 3 ) << 8 ;
...
V_77 = F_22 ( V_61 ) ;
if ( V_77 ) {
F_13 ( V_61 -> V_71 , L_54 , V_72 , __LINE__ ) ;
return V_77 ;
}
break;
case V_322 :
...
V_77 = F_22 ( V_61 ) ;
if ( V_77 ) {
F_13 ( V_61 -> V_71 , L_56 , V_72 , __LINE__ , V_95 ) ;
return V_77 ;
}
break;
case V_323 :
...
if ( V_61 -> V_78 && ( V_63 + V_284 ) > F_14 ( V_140 -> V_200 ) ) {
F_13 ( V_61 -> V_71 , L_65 ,
V_63 + V_284 , F_14 ( V_140 -> V_200 ) ) ;
V_69 [ V_95 + 1 + ( V_41 * 7 ) + 1 ] = F_14 ( V_140 -> V_200 ) ;
}
