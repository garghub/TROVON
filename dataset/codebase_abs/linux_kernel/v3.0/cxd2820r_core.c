...
V_76 [ 0 ] . V_6 = sizeof( V_75 ) - 1 ;
}
memcpy ( & V_75 [ 2 ] , V_10 [ 0 ] . V_8 , V_10 [ 0 ] . V_6 ) ;
return F_2 ( V_2 -> V_3 , V_76 , V_74 ) ;
}
struct V_70 * F_66 ( struct V_22 * V_23 )
{
struct V_1 * V_2 = V_23 -> V_24 ;
return & V_2 -> V_69 ;
}
struct V_22 * F_67 ( const struct V_77 * V_18 ,
...
T_1 V_21 ;
if ( V_23 == NULL ) {
V_2 = F_68 ( sizeof( struct V_1 ) , V_78 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_3 = V_3 ;
memcpy ( & V_2 -> V_18 , V_18 , sizeof( struct V_77 ) ) ;
F_69 ( & V_2 -> V_43 ) ;
V_2 -> V_42 = - 1 ;
...
if ( V_7 || V_21 != 0xe1 )
goto error;
memcpy ( & V_2 -> V_23 [ 0 ] . V_51 , & V_79 [ 0 ] ,
sizeof( struct V_80 ) ) ;
memcpy ( & V_2 -> V_23 [ 1 ] . V_51 , & V_79 [ 1 ] ,
sizeof( struct V_80 ) ) ;
V_2 -> V_23 [ 0 ] . V_24 = V_2 ;
V_2 -> V_23 [ 1 ] . V_24 = V_2 ;
F_70 ( V_2 -> V_69 . V_81 ,
L_12 ,
sizeof( V_2 -> V_69 . V_81 ) ) ;
V_2 -> V_69 . V_82 = & V_83 ;
V_2 -> V_69 . V_84 = NULL ;
F_71 ( & V_2 -> V_69 , V_2 ) ;
if ( F_72 ( & V_2 -> V_69 ) < 0 ) {
