...
static int T_4 F_13 ( struct V_9 * V_10 )
{
int V_2 ;
...
static int T_4 F_30 ( struct V_53 * V_54 )
{
...
F_36 ( & V_10 -> V_6 , F_3 ) ;
V_2 = F_37 ( V_60 , NULL , F_9 ,
V_65 , V_66 , V_10 ) ;
if ( V_2 ) {
F_15 ( & V_54 -> V_33 , L_7 , V_60 ) ;
goto V_67;
}
V_2 = F_13 ( V_10 ) ;
if ( V_2 )
...
V_13 -> V_69 = V_66 ;
V_13 -> V_70 . V_71 = V_72 ;
V_13 -> V_73 [ 0 ] = F_38 ( V_74 ) | F_38 ( V_75 ) ;
V_13 -> V_76 [ F_39 ( V_77 ) ] = F_38 ( V_77 ) ;
V_13 -> V_78 = F_27 ;
V_13 -> V_79 = F_29 ;
F_40 ( V_13 , V_10 ) ;
F_41 ( V_13 , V_24 , 0 , V_80 , 0 , 0 ) ;
F_41 ( V_13 , V_25 , 0 , V_80 , 0 , 0 ) ;
F_41 ( V_13 , V_14 , 0x0 , 0xff , 0 , 0 ) ;
V_2 = F_42 ( V_13 ) ;
if ( V_2 ) {
F_15 ( & V_54 -> V_33 , L_8 ) ;
goto V_68;
...
static int T_5 F_46 ( struct V_53 * V_54 )
{
struct V_9 * V_10 = F_47 ( V_54 ) ;
unsigned int V_60 = F_32 ( V_54 , L_6 ) ;
F_48 ( V_10 -> V_1 , V_34 ) ;
F_43 ( V_60 , V_10 ) ;
F_35 ( V_54 , NULL ) ;
F_49 ( V_10 -> V_13 ) ;
