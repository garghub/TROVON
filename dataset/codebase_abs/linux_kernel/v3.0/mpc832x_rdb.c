...
#ifdef V_36
F_27 () ;
if ( ( V_10 = F_28 ( NULL , L_15 ) ) != NULL ) {
F_29 ( V_10 ) ;
F_30 ( V_10 ) ;
for ( V_10 = NULL ; ( V_10 = F_28 ( V_10 , L_16 ) ) != NULL ; )
F_31 ( V_10 ) ;
}
#endif
}
...
F_30 ( V_10 ) ;
#ifdef V_36
V_10 = F_23 ( NULL , NULL , L_18 ) ;
if ( ! V_10 ) {
V_10 = F_35 ( NULL , L_19 ) ;
if ( ! V_10 )
return;
}
F_38 ( V_10 , 0 , V_40 , V_41 ) ;
F_30 ( V_10 ) ;
#endif
}
static int T_1 F_39 ( void )
{
unsigned long V_42 = F_40 () ;
return F_41 ( V_42 , L_20 ) ;
}
