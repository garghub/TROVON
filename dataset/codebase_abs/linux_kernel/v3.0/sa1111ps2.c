...
static void F_21 ( struct V_22 * V_15 )
{
struct V_3 * V_3 = V_15 -> V_24 ;
F_3 ( 0 , V_3 -> V_7 + V_31 ) ;
F_22 ( V_3 -> V_26 -> V_1 [ 0 ] ) ;
V_3 -> V_29 = 0 ;
F_19 ( V_3 -> V_26 -> V_1 [ 1 ] , V_3 ) ;
F_19 ( V_3 -> V_26 -> V_1 [ 0 ] , V_3 ) ;
F_23 ( V_3 -> V_26 ) ;
}
static void T_2 F_24 ( struct V_3 * V_3 )
{
int V_32 = 100 ;
while ( V_32 -- ) {
...
static unsigned int T_2 F_25 ( struct V_3 * V_3 ,
unsigned int V_33 )
{
unsigned int V_23 ;
...
static int T_2 F_27 ( struct V_3 * V_3 )
{
unsigned int V_36 ;
int V_27 = 0 ;
V_36 = F_25 ( V_3 , V_37 ) ;
...
static int T_2 F_28 ( struct V_40 * V_26 )
{
struct V_3 * V_3 ;
struct V_22 * V_22 ;
int V_27 ;
...
static int T_3 F_38 ( struct V_40 * V_26 )
{
struct V_3 * V_3 = F_39 ( V_26 ) ;
F_40 ( V_3 -> V_15 ) ;
F_36 ( V_26 -> V_50 . V_51 ,
V_26 -> V_50 . V_52 - V_26 -> V_50 . V_51 + 1 ) ;
F_32 ( V_26 , NULL ) ;
