...
int V_137 ;
struct V_138 * V_139 = F_66 ( V_59 ) -> V_138 ;
if ( V_139 == NULL )
goto V_130;
V_136 = ( const struct V_135 * ) & V_139 -> V_140 ;
V_137 = F_68 ( V_136 ) ;
if ( V_137 == V_141 ) {
V_136 = & F_40 ( V_59 ) -> V_37 ;
V_137 = F_68 ( V_136 ) ;
}
if ( ( V_137 & V_142 ) == 0 )
goto V_132;
...
V_122 = F_69 ( F_5 ( V_3 ) , & V_119 , V_126 , V_117 -> V_36 ,
V_94 -> V_34 . V_144 , F_70 ( V_85 ) ,
V_94 -> V_34 . V_19 ) ;
if ( F_71 ( V_122 ) ) {
V_3 -> V_12 . V_145 ++ ;
goto V_130;
...
V_120 = V_117 -> V_147 ;
if ( V_120 )
V_56 = F_73 ( & V_122 -> V_126 ) - V_3 -> V_148 - V_94 -> V_128 ;
else
V_56 = F_66 ( V_59 ) ? F_73 ( F_66 ( V_59 ) ) : V_3 -> V_56 ;
if ( F_66 ( V_59 ) )
F_66 ( V_59 ) -> V_149 -> V_150 ( F_66 ( V_59 ) , V_56 ) ;
if ( V_59 -> V_86 == F_8 ( V_87 ) ) {
V_120 |= ( V_89 -> V_147 & F_8 ( V_151 ) ) ;
if ( ( V_89 -> V_147 & F_8 ( V_151 ) ) &&
V_56 < F_74 ( V_89 -> V_152 ) ) {
F_62 ( V_59 , V_73 , V_76 , F_75 ( V_56 ) ) ;
F_72 ( V_122 ) ;
goto V_130;
}
}
...
V_124 = F_79 ( V_123 ) + V_125 + V_122 -> V_126 . V_162 ;
if ( F_80 ( V_59 ) < V_124 || F_81 ( V_59 ) ||
( F_82 ( V_59 ) && ! F_83 ( V_59 , 0 ) ) ) {
struct V_58 * V_163 = F_84 ( V_59 , V_124 ) ;
if ( V_124 > V_3 -> V_164 )
V_3 -> V_164 = V_124 ;
if ( ! V_163 ) {
F_72 ( V_122 ) ;
...
* V_176 = 0 ;
* ( T_6 * ) V_176 = F_92 ( ( void * ) ( V_35 + 1 ) , V_59 -> V_116 - sizeof( struct V_61 ) ) ;
}
}
F_93 ( V_59 ) ;
V_7 = F_58 ( V_3 -> V_7 ) ;
...
V_123 = F_95 ( F_5 ( V_3 ) , V_94 -> V_34 . V_19 ) ;
if ( V_123 ) {
...
static int
F_96 ( struct V_2 * V_3 , struct V_184 * V_185 , int V_186 )
{
int V_187 = 0 ;
struct V_42 V_63 ;
struct V_13 * V_23 ;
...
V_23 = NULL ;
if ( V_3 == V_26 -> V_41 ) {
if ( F_97 ( & V_63 , V_185 -> V_189 . V_190 , sizeof( V_63 ) ) ) {
V_187 = - V_191 ;
break;
}
...
if ( F_98 ( V_185 -> V_189 . V_190 , & V_63 , sizeof( V_63 ) ) )
V_187 = - V_191 ;
break;
case V_192 :
case V_193 :
...
if ( F_98 ( V_185 -> V_189 . V_190 , & V_23 -> V_34 , sizeof( V_63 ) ) )
V_187 = - V_191 ;
} else
...
static int F_103 ( struct V_2 * V_3 , int V_206 )
{
struct V_13 * V_94 = F_11 ( V_3 ) ;
if ( V_206 < 68 ||
...
static int F_104 ( struct V_58 * V_59 , struct V_2 * V_3 ,
unsigned short type ,
const void * V_37 , const void * V_36 , unsigned int V_116 )
{
struct V_13 * V_23 = F_11 ( V_3 ) ;
struct V_61 * V_35 = (struct V_61 * ) F_88 ( V_59 , V_23 -> V_128 ) ;
T_2 * V_63 = ( T_2 * ) ( V_35 + 1 ) ;
...
static int F_105 ( const struct V_58 * V_59 , unsigned char * V_207 )
{
const struct V_61 * V_35 = ( const struct V_61 * ) F_106 ( V_59 ) ;
...
return - V_208 ;
V_23 -> V_209 = V_3 -> V_20 ;
F_109 ( F_108 ( V_3 ) , V_23 -> V_34 . V_35 . V_37 ) ;
}
return 0 ;
}
...
struct V_210 * V_211 ;
V_211 = F_111 ( F_5 ( V_3 ) , V_23 -> V_209 ) ;
if ( V_211 )
F_112 ( V_211 , V_23 -> V_34 . V_35 . V_37 ) ;
}
return 0 ;
}
...
static void F_118 ( struct V_25 * V_26 , struct V_223 * V_224 )
{
int V_44 ;
...
while ( V_23 != NULL ) {
F_119 ( V_23 -> V_3 , V_224 ) ;
V_23 = F_16 ( V_23 -> V_47 ) ;
}
}
}
}
static int T_8 F_120 ( struct V_18 * V_18 )
{
struct V_25 * V_26 = F_7 ( V_18 , V_27 ) ;
int V_187 ;
...
static void T_9 F_122 ( struct V_18 * V_18 )
{
struct V_25 * V_26 ;
F_123 ( V_229 ) ;
V_26 = F_7 ( V_18 , V_27 ) ;
...
static int F_127 ( struct V_230 * V_231 [] , struct V_230 * V_62 [] )
{
T_2 V_39 ;
if ( ! V_62 )
return 0 ;
V_39 = 0 ;
if ( V_62 [ V_232 ] )
V_39 |= F_128 ( V_62 [ V_232 ] ) ;
if ( V_62 [ V_233 ] )
V_39 |= F_128 ( V_62 [ V_233 ] ) ;
if ( V_39 & ( V_71 | V_70 ) )
return - V_197 ;
return 0 ;
}
static int F_129 ( struct V_230 * V_231 [] , struct V_230 * V_62 [] )
{
T_1 V_37 ;
if ( V_231 [ V_234 ] ) {
if ( F_130 ( V_231 [ V_234 ] ) != V_235 )
return - V_197 ;
if ( ! F_131 ( F_132 ( V_231 [ V_234 ] ) ) )
return - V_208 ;
}
if ( ! V_62 )
goto V_79;
if ( V_62 [ V_236 ] ) {
memcpy ( & V_37 , F_132 ( V_62 [ V_236 ] ) , 4 ) ;
if ( ! V_37 )
return - V_197 ;
}
V_79:
return F_127 ( V_231 , V_62 ) ;
}
static void F_133 ( struct V_230 * V_62 [] ,
struct V_42 * V_34 )
{
...
return;
if ( V_62 [ V_237 ] )
V_34 -> V_19 = F_134 ( V_62 [ V_237 ] ) ;
if ( V_62 [ V_232 ] )
V_34 -> V_108 = F_128 ( V_62 [ V_232 ] ) ;
if ( V_62 [ V_233 ] )
V_34 -> V_175 = F_128 ( V_62 [ V_233 ] ) ;
if ( V_62 [ V_238 ] )
V_34 -> V_38 = F_135 ( V_62 [ V_238 ] ) ;
if ( V_62 [ V_239 ] )
V_34 -> V_144 = F_135 ( V_62 [ V_239 ] ) ;
if ( V_62 [ V_240 ] )
V_34 -> V_35 . V_36 = F_135 ( V_62 [ V_240 ] ) ;
if ( V_62 [ V_236 ] )
V_34 -> V_35 . V_37 = F_135 ( V_62 [ V_236 ] ) ;
if ( V_62 [ V_241 ] )
V_34 -> V_35 . V_80 = F_136 ( V_62 [ V_241 ] ) ;
if ( V_62 [ V_242 ] )
V_34 -> V_35 . V_85 = F_136 ( V_62 [ V_242 ] ) ;
if ( ! V_62 [ V_243 ] || F_136 ( V_62 [ V_243 ] ) )
...
static int F_140 ( struct V_18 * V_245 , struct V_2 * V_3 , struct V_230 * V_231 [] ,
struct V_230 * V_62 [] )
{
struct V_13 * V_50 ;
struct V_18 * V_18 = F_5 ( V_3 ) ;
...
static int F_142 ( struct V_2 * V_3 , struct V_230 * V_231 [] ,
struct V_230 * V_62 [] )
{
struct V_13 * V_23 , * V_50 ;
struct V_18 * V_18 = F_5 ( V_3 ) ;
...
static T_10 F_143 ( const struct V_2 * V_3 )
{
return
F_144 ( 4 ) +
F_144 ( 2 ) +
...
static int F_145 ( struct V_58 * V_59 , const struct V_2 * V_3 )
{
struct V_13 * V_23 = F_11 ( V_3 ) ;
struct V_42 * V_63 = & V_23 -> V_34 ;
F_146 ( V_59 , V_237 , V_63 -> V_19 ) ;
F_147 ( V_59 , V_232 , V_63 -> V_108 ) ;
F_147 ( V_59 , V_233 , V_63 -> V_175 ) ;
F_148 ( V_59 , V_238 , V_63 -> V_38 ) ;
F_148 ( V_59 , V_239 , V_63 -> V_144 ) ;
F_148 ( V_59 , V_240 , V_63 -> V_35 . V_36 ) ;
F_148 ( V_59 , V_236 , V_63 -> V_35 . V_37 ) ;
F_149 ( V_59 , V_241 , V_63 -> V_35 . V_80 ) ;
F_149 ( V_59 , V_242 , V_63 -> V_35 . V_85 ) ;
F_149 ( V_59 , V_243 , ! ! ( V_63 -> V_35 . V_147 & F_8 ( V_151 ) ) ) ;
return 0 ;
V_248:
return - V_249 ;
}
