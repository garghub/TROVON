...
struct V_254 * V_255 ;
T_16 * V_256 ;
if ( V_245 == sizeof( struct V_257 ) )
V_252 = 0 ;
else if ( V_245 == sizeof( struct V_258 ) )
V_252 = 1 ;
else if ( V_245 == sizeof( struct V_246 ) )
V_252 = 2 ;
else if ( V_245 == ( sizeof( struct V_257 ) + 12 ) )
V_252 = 0 ;
else
return - V_144 ;
V_248 = F_72 ( V_245 , V_259 ) ;
if ( V_248 == NULL ) {
...
V_248 -> V_265 = V_250 -> V_266 ;
F_73 ( V_250 , V_267 , & V_253 ) ;
V_248 -> V_268 = V_253 ;
V_248 -> V_269 = V_250 -> V_270 ;
V_248 -> V_271 = V_250 -> V_272 ;
if ( V_252 == 1 ) {
V_248 -> V_273 . V_15 . V_274 . V_275 = V_250 -> V_276 -> V_277 ;
V_248 -> V_273 . V_15 . V_274 . V_278 = F_74 ( V_250 -> V_279 ) ;
V_248 -> V_273 . V_15 . V_274 . V_280 = F_75 ( V_250 -> V_279 ) ;
} else if ( V_252 == 2 ) {
V_248 -> V_273 . V_15 . V_274 . V_275 = V_250 -> V_276 -> V_277 ;
V_248 -> V_273 . V_15 . V_274 . V_278 = F_74 ( V_250 -> V_279 ) ;
V_248 -> V_273 . V_15 . V_274 . V_280 = F_75 ( V_250 -> V_279 ) ;
V_248 -> V_273 . V_281 = F_76 ( V_250 -> V_276 ) ;
}
V_248 -> V_282 = 0 ;
if ( V_1 -> V_283 ) {
F_77 (sdev, ioc->sh) {
V_256 = V_255 -> V_284 ;
if ( V_256 == NULL || V_256 -> V_285 == NULL )
continue;
...
V_248 -> V_288 = V_1 -> V_90 . V_288 . V_289 ;
V_248 -> V_290 = V_1 -> V_291 ;
strncpy ( V_248 -> V_292 , V_293 , V_294 ) ;
V_248 -> V_292 [ V_294 - 1 ] = '\0' ;
V_248 -> V_295 = 0 ;
V_248 -> V_296 = V_1 -> V_297 [ V_251 ] . V_298 ;
V_248 -> V_299 [ 0 ] = V_248 -> V_299 [ 1 ] = 0 ;
if ( F_78 ( ( char T_9 * ) V_136 , V_248 , V_245 ) ) {
F_6 ( V_97 L_60
L_65 ,
...
{
struct V_300 T_9 * V_247 = ( void T_9 * ) V_136 ;
struct V_300 V_248 ;
T_1 * V_1 ;
T_16 * V_256 ;
char * V_301 ;
...
V_44 V_251 ;
struct V_254 * V_255 ;
if ( F_41 ( & V_248 , V_247 , sizeof( struct V_300 ) ) ) {
...
V_1 -> V_14 ) ) ;
V_305 = V_248 . V_16 . V_260 - sizeof( T_8 ) ;
V_304 = V_305 / sizeof( int ) ;
V_251 = V_248 . V_16 . V_251 ;
if ( V_304 <= 0 ) {
F_6 ( V_97 L_70 ,
V_1 -> V_14 , __FILE__ , __LINE__ ) ;
...
V_287 )
continue;
V_303 = ( V_256 -> V_285 -> V_306 ) ? 0x80 : V_256 -> V_303 ;
* V_302 = ( ( ( V_44 ) V_303 << 16 ) + ( V_256 -> V_285 -> V_307 << 8 ) +
( V_256 -> V_285 -> V_308 ) ) ;
V_302 ++ ;
V_282 ++ ;
-- V_304 ;
...
if ( F_78 ( V_247 -> V_309 , V_301 , V_305 ) ) {
F_6 ( V_97 L_66
L_71 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_302 ) ;
F_70 ( V_301 ) ;
return - V_144 ;
}
F_70 ( V_301 ) ;
...
{
struct V_310 T_9 * V_247 = ( void T_9 * ) V_136 ;
struct V_310 V_248 ;
T_1 * V_1 ;
int V_139 ;
if ( F_41 ( & V_248 , V_247 , sizeof( struct V_310 ) ) ) {
...
V_1 -> V_14 ) ) ;
#ifdef F_79
V_248 . V_311 = V_1 -> V_312 ;
#else
V_248 . V_311 = V_1 -> V_239 -> V_266 ;
#endif
strncpy ( V_248 . V_14 , V_1 -> V_14 , V_313 ) ;
V_248 . V_14 [ V_313 - 1 ] = '\0' ;
strncpy ( V_248 . V_314 , V_1 -> V_315 , V_316 ) ;
V_248 . V_314 [ V_316 - 1 ] = '\0' ;
if ( F_78 ( ( char T_9 * ) V_136 , & V_248 , sizeof( struct V_310 ) ) ) {
F_6 ( V_97 L_72
L_76 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_247 ) ;
return - V_144 ;
...
{
struct V_317 T_9 * V_247 = ( void T_9 * ) V_136 ;
struct V_317 V_248 ;
T_1 * V_1 ;
int V_139 ;
if ( F_41 ( & V_248 , V_247 , sizeof( struct V_317 ) ) ) {
...
if ( F_78 ( ( char T_9 * ) V_136 , & V_248 , sizeof( struct V_317 ) ) ) {
F_6 ( V_97 L_77
L_81 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_247 ) ;
return - V_144 ;
...
{
struct V_320 T_9 * V_247 = ( void T_9 * ) V_136 ;
struct V_320 V_248 ;
T_1 * V_1 ;
int V_139 ;
if ( F_41 ( & V_248 , V_247 , sizeof( struct V_320 ) ) ) {
...
V_1 -> V_14 ) ) ;
if ( V_1 -> V_126 == NULL ) {
int V_12 = V_319 * sizeof( V_321 ) ;
V_1 -> V_126 = F_66 ( V_12 , V_259 ) ;
if ( ! V_1 -> V_126 ) {
F_6 ( V_97
L_86 ,
V_1 -> V_14 ) ;
...
{
struct V_324 T_9 * V_247 = ( void T_9 * ) V_136 ;
struct V_324 V_248 ;
T_1 * V_1 ;
int V_139 ;
int V_305 , V_325 , V_326 ;
if ( F_41 ( & V_248 , V_247 , sizeof( struct V_324 ) ) ) {
...
V_1 -> V_14 ) ) ;
V_305 = V_248 . V_16 . V_260 - sizeof( T_8 ) ;
V_325 = V_305 / sizeof( V_321 ) ;
V_326 = V_319 < V_325 ? V_319 : V_325 ;
if ( ( V_326 < 1 ) || ! V_1 -> V_126 )
return - V_215 ;
V_1 -> V_123 = 0 ;
V_305 = V_326 * sizeof( V_321 ) ;
if ( F_78 ( V_247 -> V_327 , V_1 -> V_126 , V_305 ) ) {
F_6 ( V_97 L_87
L_91 ,
...
{
struct V_328 T_9 * V_247 = ( void T_9 * ) V_136 ;
struct V_328 V_248 ;
T_1 * V_1 ;
int V_139 ;
int V_329 ;
if ( F_41 ( & V_248 , V_247 , sizeof( struct V_328 ) ) ) {
...
if ( V_1 -> V_330 == NULL )
return - V_74 ;
if ( F_41 ( V_1 -> V_330 , V_247 -> V_332 , V_329 ) ) {
F_6 ( V_97 L_92
L_96
...
V_1 -> V_90 . V_333 = V_329 ;
return 0 ;
}
static int
F_52 ( unsigned long V_136 )
{
struct V_334 T_9 * V_247 = ( void T_9 * ) V_136 ;
struct V_334 V_248 ;
T_1 * V_1 ;
int V_139 ;
int V_3 ;
if ( F_41 ( & V_248 , V_247 , sizeof( struct V_334 ) ) ) {
...
V_3 = F_82 ( V_248 , & V_247 -> V_335 ) ;
return V_3 ;
}
static int
F_82 ( struct V_334 V_248 , void T_9 * V_336 )
{
T_1 * V_1 ;
T_2 * V_57 = NULL ;
V_203 * V_16 ;
...
unsigned long V_106 ;
V_44 V_109 ;
V_338 . V_211 = V_339 . V_211 = NULL ;
V_338 . V_212 = V_339 . V_212 = 0 ;
if ( ( ( V_139 = F_42 ( V_248 . V_16 . V_139 , & V_1 ) ) < 0 ) ||
( V_1 == NULL ) ) {
...
if ( F_41 ( V_57 , V_336 , V_248 . V_345 * 4 ) ) {
F_6 ( V_97 L_102
L_105 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_336 ) ;
V_109 = - 1 ;
V_3 = - V_144 ;
goto V_348;
}
V_16 -> V_19 = F_59 ( V_344 ) ;
V_109 = V_16 -> V_17 ;
...
int V_369 ;
V_95 V_308 ;
V_308 = ( V_1 -> V_370 == 0 ) ? 256 : V_1 -> V_370 ;
if ( V_365 -> V_80 > V_308 ) {
F_6 ( V_97 L_102
L_109 ,
V_1 -> V_14 , __FILE__ , __LINE__ ) ;
...
V_365 -> V_55 &= ~ V_372 ;
V_365 -> V_55 |= F_83 ( V_1 ) ;
if ( V_248 . V_373 > V_374 )
V_365 -> V_38 = V_374 ;
else
V_365 -> V_38 = V_248 . V_373 ;
V_365 -> V_375 =
F_59 ( V_1 -> V_376
+ ( V_43 * V_46 ) ) ;
F_77 (sdev, ioc->sh) {
struct V_377 * V_378 = V_377 ( V_255 ) ;
T_19 * V_285 = V_378 -> V_284 ;
if ( V_285 == NULL )
continue;
if ( ( V_365 -> V_80 == V_285 -> V_308 ) &&
( V_365 -> V_81 == V_285 -> V_307 ) &&
( V_285 -> V_286 & V_379 ) )
V_366 = V_380 ;
}
if ( V_248 . V_347 > 0 ) {
...
V_365 -> V_383 = F_59 ( V_368 | V_366 ) ;
V_365 -> V_384 = F_59 ( V_369 ) ;
} else {
F_6 ( V_97 L_102
L_111 ,
V_1 -> V_14 , __FILE__ , __LINE__ ) ;
...
case V_388 :
{
T_20 * V_389 = ( T_20 * ) V_57 ;
V_95 V_390 , V_391 ;
if ( sizeof( T_14 ) == sizeof( V_392 ) ) {
V_390 = F_59 ( ( V_95 ) ( ( V_392 ) V_1 -> V_393 >> 32 ) ) ;
V_391 = F_59 ( ( V_95 ) ( ( V_392 ) V_1 -> V_394 >> 32 ) ) ;
} else {
V_390 = 0 ;
V_391 = 0 ;
}
if ( ( V_389 -> V_198 != 0 ) || ( V_389 -> V_395 != V_1 -> V_90 . V_395 ) ||
( V_389 -> V_396 != V_1 -> V_90 . V_396 ) ||
( V_389 -> V_397 != F_84 ( V_1 -> V_25 ) ) ||
( V_389 -> V_398 != V_390 ) ||
( V_389 -> V_399 != V_391 ) ) {
F_6 ( V_97 L_102
L_114 ,
...
V_337 = ( char * ) ( ( ( int * ) V_57 ) + V_248 . V_345 ) ;
V_343 = 0 ;
if ( V_248 . V_347 > 0 )
V_342 ++ ;
if ( V_248 . V_346 > 0 )
...
V_343 |= V_248 . V_347 ;
V_339 . V_212 = V_248 . V_347 ;
V_339 . V_211 = F_67 (
V_1 -> V_239 , V_339 . V_212 , & V_341 ) ;
if ( V_339 . V_211 == NULL ) {
V_3 = - V_74 ;
goto V_348;
} else {
V_1 -> V_210 ( V_337 , V_343 , V_341 ) ;
V_337 += V_1 -> V_205 ;
if ( F_41 ( V_339 . V_211 ,
V_248 . V_405 ,
V_339 . V_212 ) ) {
...
L_117
L_118 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_248 . V_405 ) ;
V_3 = - V_144 ;
goto V_348;
}
}
...
V_338 . V_211 = F_67 ( V_1 -> V_239 ,
V_338 . V_212 , & V_340 ) ;
if ( V_338 . V_211 == NULL ) {
V_3 = - V_74 ;
goto V_348;
} else {
V_1 -> V_210 ( V_337 , V_343 , V_340 ) ;
}
}
} else {
V_1 -> V_210 ( V_337 , V_343 , ( T_14 ) - 1 ) ;
}
...
F_63 ( V_190 , V_1 , V_57 ) ;
V_68 = ( V_248 . V_68 > 0 ) ? V_248 . V_68 : V_407 ;
V_213:
...
if ( V_248 . V_408 < V_1 -> V_25 ) {
V_12 = F_7 ( V_248 . V_408 ,
4 * V_1 -> V_4 . V_9 [ 2 ] ) ;
} else {
...
L_102
L_123 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_248 . V_409 ) ;
V_3 = - V_215 ;
goto V_348;
}
}
...
if ( ( V_1 -> V_4 . V_21 & V_22 ) &&
( V_248 . V_346 > 0 ) && ( V_338 . V_211 ) ) {
if ( F_78 ( V_248 . V_411 ,
V_338 . V_211 , V_248 . V_346 ) ) {
F_6 ( V_97 L_102
L_125 ,
V_1 -> V_14 , __FILE__ , __LINE__ ,
V_248 . V_411 ) ;
...
if ( V_339 . V_211 != NULL ) {
F_69 ( V_1 -> V_239 ,
V_339 . V_212 , ( void * ) V_339 . V_211 , V_341 ) ;
}
if ( V_338 . V_211 != NULL ) {
F_69 ( V_1 -> V_239 ,
...
V_1 -> V_14 ) ) ;
V_250 = (struct V_249 * ) V_1 -> V_239 ;
V_248 . V_418 = V_250 -> V_418 ;
V_248 . V_266 = V_250 -> V_266 ;
V_248 . V_419 = V_250 -> V_270 ;
V_248 . V_272 = V_250 -> V_272 ;
V_248 . V_279 = V_250 -> V_279 ;
V_248 . V_276 = V_250 -> V_276 -> V_277 ;
if ( V_1 -> V_283 != NULL )
V_248 . V_420 = V_1 -> V_283 -> V_420 ;
else
V_248 . V_420 = - 1 ;
V_248 . V_421 [ 0 ] = V_1 -> V_90 . V_288 . Struct . V_422 >= 10 ?
( ( V_1 -> V_90 . V_288 . Struct . V_422 / 10 ) + '0' ) : '0' ;
V_248 . V_421 [ 1 ] = ( V_1 -> V_90 . V_288 . Struct . V_422 % 10 ) + '0' ;
V_248 . V_421 [ 2 ] = '.' ;
V_248 . V_421 [ 3 ] = V_1 -> V_90 . V_288 . Struct . V_423 >= 10 ?
( ( V_1 -> V_90 . V_288 . Struct . V_423 / 10 ) + '0' ) : '0' ;
V_248 . V_421 [ 4 ] = ( V_1 -> V_90 . V_288 . Struct . V_423 % 10 ) + '0' ;
V_248 . V_421 [ 5 ] = '.' ;
V_248 . V_421 [ 6 ] = V_1 -> V_90 . V_288 . Struct . V_424 >= 10 ?
( ( V_1 -> V_90 . V_288 . Struct . V_424 / 10 ) + '0' ) : '0' ;
V_248 . V_421 [ 7 ] = ( V_1 -> V_90 . V_288 . Struct . V_424 % 10 ) + '0' ;
V_248 . V_421 [ 8 ] = '.' ;
V_248 . V_421 [ 9 ] = V_1 -> V_90 . V_288 . Struct . V_425 >= 10 ?
( ( V_1 -> V_90 . V_288 . Struct . V_425 / 10 ) + '0' ) : '0' ;
V_248 . V_421 [ 10 ] = ( V_1 -> V_90 . V_288 . Struct . V_425 % 10 ) + '0' ;
V_248 . V_421 [ 11 ] = '\0' ;
V_16 . V_426 = 0 ;
V_16 . V_427 = 0 ;
V_16 . V_356 = 0 ;
V_16 . V_354 = V_428 ;
V_414 . V_429 . V_16 = & V_16 ;
V_414 . V_430 = - 1 ;
V_414 . V_431 = 0 ;
V_414 . V_432 = V_433 ;
V_414 . V_236 = 0 ;
V_414 . V_68 = 10 ;
strncpy ( V_248 . V_434 , L_130 , 24 ) ;
if ( F_86 ( V_1 , & V_414 ) == 0 ) {
if ( V_414 . V_429 . V_16 -> V_427 > 0 ) {
V_414 . V_432 = V_435 ;
V_412 = F_67 ( V_1 -> V_239 , V_16 . V_427 * 4 , & V_413 ) ;
if ( V_412 ) {
V_414 . V_430 = V_413 ;
if ( F_86 ( V_1 , & V_414 ) == 0 ) {
T_25 * V_302 = ( T_25 * ) V_412 ;
if ( strlen ( V_302 -> V_436 ) > 1 ) {
strncpy ( V_248 . V_434 , V_302 -> V_436 , 24 ) ;
V_248 . V_434 [ 24 - 1 ] = '\0' ;
}
}
F_69 ( V_1 -> V_239 , V_16 . V_427 * 4 , V_412 , V_413 ) ;
V_412 = NULL ;
}
}
}
...
V_248 . V_451 = 0 ;
if ( V_1 -> V_283 != NULL ) {
T_26 * V_452 = F_88 ( V_1 -> V_283 ) ;
if ( V_452 && ( V_252 == 1 ) ) {
V_248 . V_449 = V_1 -> V_449 ;
V_248 . V_450 = V_1 -> V_450 ;
V_248 . V_451 = V_1 -> V_451 ;
}
}
if ( ( V_57 = F_18 ( V_190 , V_1 ) ) == NULL ) {
F_22 ( V_1 , F_6 ( V_73
...
V_415 = ( T_24 * ) V_57 ;
V_416 = ( V_203 * ) V_57 ;
memset ( V_415 , 0 , sizeof( T_24 ) ) ;
V_415 -> V_17 = V_363 ;
V_415 -> V_453 = V_454 ;
V_415 -> V_19 = V_416 -> V_19 ;
V_415 -> V_198 = V_455 ;
V_415 -> V_456 = 0x01 ;
V_415 -> V_384 = F_84 ( 0x04 ) ;
if ( V_250 -> V_279 & 1 )
V_415 -> V_457 = 0xB2 ;
else
V_415 -> V_457 = 0xB0 ;
V_412 = F_67 ( V_1 -> V_239 , 4 , & V_413 ) ;
if ( ! V_412 )
goto V_23;
V_1 -> V_210 ( ( char * ) & V_415 -> V_191 ,
( V_406 | 4 ) , V_413 ) ;
V_67 = 0 ;
F_62 ( V_1 -> V_4 . V_18 ,
V_415 -> V_19 ) ;
...
if ( V_1 -> V_4 . V_21 & V_24 )
V_248 . V_299 = * ( V_95 * ) V_412 ;
V_23:
F_25 (ioc->ioctl_cmds.status)
F_62 ( V_1 -> V_4 . V_18 , 0 ) ;
if ( V_412 )
F_69 ( V_1 -> V_239 , 4 , V_412 , V_413 ) ;
if ( F_78 ( ( char T_9 * ) V_136 , & V_248 , sizeof( T_21 ) ) ) {
F_6 ( V_97 L_133
L_134 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_247 ) ;
return - V_144 ;
...
if ( ( V_1 -> V_52 == V_53 ) || ( V_1 -> V_52 == V_78 ) )
return 0 ;
if ( ( V_1 -> V_464 . V_465 == 0 ) || ( V_1 -> V_283 == NULL ) )
return 0 ;
if ( V_1 -> V_283 -> V_420 != V_248 . V_16 . V_466 )
return - V_146 ;
V_460 = V_1 -> V_464 . V_465 * 4 ;
V_458 = ( T_28 * ) F_67 ( V_1 -> V_239 , V_460 , & V_461 ) ;
if ( V_458 ) {
V_16 . V_426 = V_1 -> V_464 . V_467 ;
V_16 . V_427 = V_460 ;
V_16 . V_356 = 0 ;
V_16 . V_354 = V_468 ;
V_414 . V_429 . V_16 = & V_16 ;
...
V_414 . V_68 = 0 ;
V_414 . V_430 = V_461 ;
V_414 . V_431 = ( V_248 . V_16 . V_307 << 8 ) | V_248 . V_16 . V_308 ;
if ( ( V_3 = F_86 ( V_1 , & V_414 ) ) == 0 ) {
V_463 = F_9 ( V_458 -> V_469 ) ;
V_248 . V_470 = V_463 & V_471 ?
V_448 : V_472 ;
if ( V_463 & V_473 ) {
V_462 = ( V_463 & V_474 ) >> 8 ;
if ( V_462 < 0x09 )
...
F_69 ( V_1 -> V_239 , V_460 , ( V_44 * ) V_458 , V_461 ) ;
}
V_248 . V_482 = - 1 ;
V_248 . V_483 = - 1 ;
V_248 . V_484 = - 1 ;
...
V_414 . V_68 = 0 ;
V_414 . V_430 = - 1 ;
if ( ( F_86 ( V_1 , & V_414 ) == 0 ) && ( V_414 . V_429 . V_16 -> V_427 > 0 ) ) {
V_414 . V_432 = V_435 ;
V_460 = ( int ) V_414 . V_429 . V_16 -> V_427 * 4 ;
V_459 = ( T_29 * ) F_67 (
V_1 -> V_239 , V_460 , & V_461 ) ;
if ( V_459 ) {
V_414 . V_430 = V_461 ;
V_414 . V_431 = ( V_248 . V_16 . V_307 << 8 ) | V_248 . V_16 . V_308 ;
if ( ( V_3 = F_86 ( V_1 , & V_414 ) ) == 0 ) {
V_248 . V_482 = ( V_95 ) F_8 ( V_459 -> V_486 ) ;
V_248 . V_483 = ( V_95 ) F_8 ( V_459 -> V_487 ) ;
V_248 . V_484 = ( V_95 ) F_8 ( V_459 -> V_488 ) ;
}
F_69 ( V_1 -> V_239 , V_460 , ( V_44 * ) V_459 , V_461 ) ;
}
}
V_452 = F_88 ( V_1 -> V_283 ) ;
if ( V_452 != NULL )
V_248 . V_485 = V_452 -> V_489 [ V_248 . V_16 . V_308 ] ;
if ( F_78 ( ( char T_9 * ) V_136 , & V_248 , sizeof( T_27 ) ) ) {
F_6 ( V_97 L_139
L_71 ,
V_1 -> V_14 , __FILE__ , __LINE__ , V_247 ) ;
return - V_144 ;
...
static int
F_89 ( struct V_129 * V_490 , unsigned int V_135 ,
unsigned long V_136 )
{
struct V_491 V_492 ;
struct V_165 V_493 ;
T_1 * V_143 = NULL ;
int V_139 , V_140 ;
int V_2 = ( V_490 -> V_141 & V_142 ) ;
int V_133 ;
if ( F_41 ( & V_492 , ( char T_9 * ) V_136 , sizeof( V_492 ) ) )
return - V_144 ;
V_140 = V_492 . V_139 & 0xFF ;
if ( ( ( V_139 = F_42 ( V_140 , & V_143 ) ) < 0 ) ||
( V_143 == NULL ) ) {
...
V_143 -> V_14 ) ) ;
V_493 . V_139 = V_139 ;
V_493 . V_169 = V_492 . V_169 ;
V_493 . V_168 = F_90 ( V_492 . V_168 ) ;
V_133 = F_58 ( V_493 . V_139 , V_493 . V_168 , V_493 . V_169 ) ;
F_17 ( & V_143 -> V_4 . V_5 ) ;
return V_133 ;
}
static int
F_91 ( struct V_129 * V_490 , unsigned int V_135 ,
unsigned long V_136 )
{
struct V_494 V_495 ;
struct V_494 T_9 * V_247 = (struct V_494 T_9 * ) V_136 ;
struct V_334 V_248 ;
T_1 * V_143 = NULL ;
int V_139 , V_140 ;
int V_2 = ( V_490 -> V_141 & V_142 ) ;
int V_133 ;
if ( F_41 ( & V_495 , ( char T_9 * ) V_136 , sizeof( V_495 ) ) )
return - V_144 ;
V_140 = V_495 . V_16 . V_139 & 0xFF ;
if ( ( ( V_139 = F_42 ( V_140 , & V_143 ) ) < 0 ) ||
( V_143 == NULL ) ) {
...
V_143 -> V_14 ) ) ;
V_248 . V_16 . V_139 = V_495 . V_16 . V_139 ;
V_248 . V_16 . V_251 = V_495 . V_16 . V_251 ;
V_248 . V_68 = V_495 . V_68 ;
V_248 . V_408 = V_495 . V_408 ;
V_248 . V_346 = V_495 . V_346 ;
V_248 . V_347 = V_495 . V_347 ;
V_248 . V_373 = V_495 . V_373 ;
V_248 . V_345 = V_495 . V_345 ;
V_248 . V_409 = ( char T_9 * ) ( unsigned long ) V_495 . V_409 ;
V_248 . V_411 = ( char T_9 * ) ( unsigned long ) V_495 . V_411 ;
V_248 . V_405 = ( char T_9 * ) ( unsigned long ) V_495 . V_405 ;
V_248 . V_410 = ( char T_9 * ) ( unsigned long ) V_495 . V_410 ;
V_133 = F_82 ( V_248 , & V_247 -> V_335 ) ;
F_17 ( & V_143 -> V_4 . V_5 ) ;
return V_133 ;
}
static long F_92 ( struct V_129 * V_496 , unsigned int V_135 , unsigned long V_136 )
{
long V_133 ;
F_15 ( & V_134 ) ;
switch ( V_135 ) {
...
case V_160 :
case V_151 :
V_133 = F_40 ( V_496 , V_135 , V_136 ) ;
break;
case V_499 :
V_133 = F_91 ( V_496 , V_135 , V_136 ) ;
break;
case V_500 :
V_133 = F_89 ( V_496 , V_135 , V_136 ) ;
break;
default:
V_133 = - V_501 ;
break;
...
static int
F_93 ( struct V_249 * V_250 , const struct V_502 * V_308 )
{
T_1 * V_1 = F_94 ( V_250 ) ;
F_95 ( & V_1 -> V_4 . V_5 ) ;
F_96 ( & V_1 -> V_4 . V_51 ) ;
...
++ V_504 ;
V_190 = F_102 ( F_4 , V_508 ,
L_147 ) ;
if ( ! V_190 || V_190 >= V_511 ) {
F_6 (KERN_ERR MYNAM L_148 ) ;
F_103 ( & V_509 ) ;
V_503 = - V_220 ;
goto V_510;
}
V_72 = F_102 ( F_12 , V_508 ,
L_149 ) ;
if ( ! V_72 || V_72 >= V_511 ) {
F_6 (KERN_ERR MYNAM L_148 ) ;
F_104 ( V_190 ) ;
