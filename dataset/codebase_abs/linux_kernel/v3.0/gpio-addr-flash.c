...
V_29 = F_14 ( V_22 , V_33 , 0 ) ;
if ( ! V_28 || ! V_29 || ! V_29 -> V_34 )
return - V_35 ;
V_24 = sizeof( int ) * V_29 -> V_34 ;
V_2 = F_15 ( sizeof( * V_2 ) + V_24 , V_36 ) ;
if ( ! V_2 )
return - V_37 ;
V_2 -> V_9 = V_29 -> V_34 ;
V_2 -> V_8 = ( void * ) ( unsigned long ) V_29 -> V_38 ;
V_2 -> V_7 = ( void * ) ( V_2 + 1 ) ;
V_2 -> V_6 = F_16 ( V_28 ) ;
...
V_2 -> V_11 . V_43 = F_9 ;
V_2 -> V_11 . V_44 = F_11 ;
V_2 -> V_11 . V_45 = V_26 -> V_46 ;
V_2 -> V_11 . V_47 = V_2 -> V_6 * ( 1 << V_2 -> V_9 ) ;
V_2 -> V_11 . V_14 = F_17 ( V_28 -> V_38 , V_2 -> V_11 . V_47 ) ;
V_2 -> V_11 . V_48 = V_49 ;
V_2 -> V_11 . V_50 = ( unsigned long ) V_2 ;
F_18 ( V_22 , V_2 ) ;
V_4 = 0 ;
do {
if ( F_19 ( V_2 -> V_8 [ V_4 ] , V_40 ) ) {
...
V_2 -> V_52 = F_24 ( V_28 -> V_39 , & V_2 -> V_11 ) ;
if ( ! V_2 -> V_52 ) {
...
V_23 = F_25 ( V_2 -> V_52 , V_54 ,
& V_26 -> V_55 , 0 ) ;
if ( V_23 > 0 ) {
F_20 (KERN_NOTICE PFX L_3 ) ;
F_22 ( V_26 -> V_55 ) ;
} else if ( V_26 -> V_23 ) {
F_20 (KERN_NOTICE PFX L_4 ) ;
V_23 = V_26 -> V_23 ;
} else {
F_20 (KERN_NOTICE PFX L_5 ) ;
V_23 = 0 ;
}
F_26 ( V_2 -> V_52 , V_26 -> V_55 , V_23 ) ;
return 0 ;
}
static int T_6 F_27 ( struct V_21 * V_22 )
{
struct V_1 * V_2 = F_28 ( V_22 ) ;
T_1 V_4 = 0 ;
do {
F_21 ( V_2 -> V_8 [ V_4 ] ) ;
} while ( ++ V_4 < V_2 -> V_9 );
