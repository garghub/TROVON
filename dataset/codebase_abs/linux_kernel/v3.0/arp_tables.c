...
F_15 ( const struct V_77 * V_78 )
{
return F_16 ( (struct V_77 * ) V_78 ) ;
}
static inline struct V_77 *
F_17 ( const void * V_79 , unsigned int V_80 )
{
...
struct V_1 * V_84 )
{
static const char V_85 [ V_19 ] V_86 ( ( F_19 ( sizeof( long ) ) ) ) ;
...
V_91 = V_84 -> V_91 ;
V_89 = V_91 -> V_95 [ F_24 () ] ;
V_78 = F_17 ( V_89 , V_91 -> V_96 [ V_81 ] ) ;
V_88 = F_17 ( V_89 , V_91 -> V_97 [ V_81 ] ) ;
V_92 . V_82 = V_82 ;
V_92 . V_83 = V_83 ;
V_92 . V_98 = V_81 ;
V_92 . V_99 = V_100 ;
...
F_27 ( V_78 -> V_103 , F_21 ( V_71 -> V_22 ) , 1 ) ;
V_102 = F_15 ( V_78 ) ;
...
if ( V_107 < 0 ) {
if ( V_107 != V_109 ) {
V_87 = ( unsigned ) ( - V_107 ) - 1 ;
break;
}
V_78 = V_88 ;
V_88 = F_17 ( V_89 , V_88 -> V_110 ) ;
continue;
}
if ( V_89 + V_107
!= F_26 ( V_78 ) ) {
...
static inline void F_44 ( struct V_77 * V_78 )
{
struct V_145 V_73 ;
struct V_76 * V_102 ;
V_102 = F_16 ( V_78 ) ;
...
static int F_45 ( struct V_90 * V_115 , void * V_117 ,
...
break;
++ V_9 ;
if ( strcmp ( F_16 ( V_149 ) -> V_104 . V_123 . V_94 ,
V_152 ) == 0 )
++ V_115 -> V_153 ;
}
F_11 ( L_36 , V_10 ) ;
...
static void F_48 ( const struct V_90 * V_102 ,
struct V_144 V_103 [] )
{
struct V_77 * V_149 ;
unsigned int V_155 ;
unsigned int V_9 ;
F_47 (cpu) {
T_4 * V_156 = & F_49 ( V_157 , V_155 ) ;
V_9 = 0 ;
F_46 (iter, t->entries[cpu], t->size) {
T_5 V_158 , V_120 ;
unsigned int V_159 ;
do {
V_159 = F_50 ( V_156 ) ;
...
} while ( F_51 ( V_156 , V_159 ) );
F_27 ( V_103 [ V_9 ] , V_158 , V_120 ) ;
++ V_9 ;
}
}
}
static struct V_144 * F_52 ( const struct V_1 * V_84 )
{
unsigned int V_160 ;
struct V_144 * V_103 ;
...
static int F_55 ( unsigned int V_162 ,
...
if ( F_38 ( V_103 ) )
return F_39 ( V_103 ) ;
V_166 = V_91 -> V_95 [ F_56 () ] ;
if ( F_57 ( V_163 , V_166 , V_162 ) != 0 ) {
V_10 = - V_167 ;
goto V_168;
}
...
V_102 = F_15 ( V_78 ) ;
if ( F_57 ( V_163 + V_164 + V_78 -> V_122
+ F_58 ( struct V_76 ,
V_104 . V_123 . V_94 ) ,
V_102 -> V_104 . V_105 . V_106 -> V_94 ,
...
static void F_60 ( void * V_169 , const void * V_54 )
{
int V_107 = * ( V_170 * ) V_54 ;
if ( V_107 > 0 )
V_107 += F_61 ( V_100 , V_107 ) ;
memcpy ( V_169 , & V_107 , sizeof( V_107 ) ) ;
}
static int F_62 ( void T_6 * V_169 , const void * V_54 )
{
V_170 V_171 = * ( int * ) V_54 ;
if ( V_171 > 0 )
V_171 -= F_61 ( V_100 , V_171 ) ;
return F_57 ( V_169 , & V_171 , sizeof( V_171 ) ) ? - V_167 : 0 ;
}
static int F_63 ( const struct V_77 * V_78 ,
...
V_102 = F_15 ( V_78 ) ;
V_164 += F_64 ( V_102 -> V_104 . V_105 . V_106 ) ;
V_115 -> V_126 -= V_164 ;
V_10 = F_65 ( V_100 , V_172 , V_164 ) ;
if ( V_10 )
return V_10 ;
for ( V_9 = 0 ; V_9 < V_118 ; V_9 ++ ) {
if ( V_2 -> V_96 [ V_9 ] &&
...
static int F_66 ( const struct V_90 * V_2 ,
struct V_90 * V_115 )
{
struct V_77 * V_149 ;
void * V_166 ;
...
if ( ! V_115 || ! V_2 )
return - V_130 ;
memcpy ( V_115 , V_2 , F_58 ( struct V_90 , V_95 ) ) ;
V_115 -> V_174 = 0 ;
V_166 = V_2 -> V_95 [ F_56 () ] ;
F_67 ( V_100 , V_2 -> V_150 ) ;
F_46 (iter, loc_cpu_entry, info->size) {
V_10 = F_63 ( V_149 , V_2 , V_166 , V_115 ) ;
if ( V_10 != 0 )
return V_10 ;
}
return 0 ;
}
static int F_68 ( struct V_175 * V_175 , void T_6 * V_123 ,
...
if ( F_69 ( V_94 , V_123 , sizeof( V_94 ) ) != 0 )
return - V_167 ;
V_94 [ V_177 - 1 ] = '\0' ;
#ifdef F_70
if ( V_176 )
F_71 ( V_100 ) ;
#endif
V_102 = F_72 ( F_73 ( V_175 , V_100 , V_94 ) ,
L_42 , V_94 ) ;
if ( V_102 && ! F_38 ( V_102 ) ) {
struct V_178 V_2 ;
...
static int F_77 ( struct V_175 * V_175 , struct V_181 T_6 * V_182 ,
const int * V_8 )
{
int V_10 ;
struct V_181 V_183 ;
...
if ( F_69 ( & V_183 , V_182 , sizeof( V_183 ) ) != 0 )
return - V_167 ;
...
V_102 = F_73 ( V_175 , V_100 , V_183 . V_94 ) ;
if ( V_102 && ! F_38 ( V_102 ) ) {
const struct V_90 * V_91 = V_102 -> V_91 ;
F_11 ( L_45 ,
V_91 -> V_150 ) ;
if ( V_183 . V_126 == V_91 -> V_126 )
V_10 = F_55 ( V_91 -> V_126 ,
V_102 , V_182 -> V_184 ) ;
else {
F_11 ( L_46 ,
...
static int F_78 ( struct V_175 * V_175 , const char * V_94 ,
unsigned int V_116 ,
struct V_90 * V_115 ,
unsigned int V_186 ,
void T_6 * V_187 )
...
struct V_77 * V_149 ;
V_10 = 0 ;
V_103 = F_53 ( V_186 * sizeof( struct V_144 ) ) ;
if ( ! V_103 ) {
V_10 = - V_161 ;
goto V_83;
}
...
V_188 = F_79 ( V_102 , V_186 , V_115 , & V_10 ) ;
if ( ! V_188 )
goto V_191;
F_11 ( L_48 ,
...
F_40 ( V_102 -> V_138 ) ;
F_48 ( V_188 , V_103 ) ;
V_189 = V_188 -> V_95 [ F_56 () ] ;
F_46 (iter, loc_cpu_old_entry, oldinfo->size)
F_44 ( V_149 ) ;
F_80 ( V_188 ) ;
if ( F_57 ( V_187 , V_103 ,
...
static int F_81 ( struct V_175 * V_175 , const void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
struct V_147 V_179 ;
...
void * V_166 ;
struct V_77 * V_149 ;
if ( F_69 ( & V_179 , V_123 , sizeof( V_179 ) ) != 0 )
return - V_167 ;
if ( V_179 . V_186 >= V_192 / sizeof( struct V_144 ) )
return - V_161 ;
V_179 . V_94 [ sizeof( V_179 . V_94 ) - 1 ] = 0 ;
V_115 = F_82 ( V_179 . V_126 ) ;
if ( ! V_115 )
return - V_161 ;
V_166 = V_115 -> V_95 [ F_56 () ] ;
if ( F_69 ( V_166 , V_123 + sizeof( V_179 ) ,
V_179 . V_126 ) != 0 ) {
V_10 = - V_167 ;
goto V_193;
}
V_10 = F_45 ( V_115 , V_166 , & V_179 ) ;
if ( V_10 != 0 )
goto V_193;
F_11 ( L_49 ) ;
V_10 = F_78 ( V_175 , V_179 . V_94 , V_179 . V_116 , V_115 ,
V_179 . V_186 , V_179 . V_103 ) ;
if ( V_10 )
goto V_194;
return 0 ;
V_194:
F_46 (iter, loc_cpu_entry, newinfo->size)
F_44 ( V_149 ) ;
V_193:
F_80 ( V_115 ) ;
return V_10 ;
}
static int F_83 ( struct V_175 * V_175 , const void T_6 * V_123 ,
...
return - V_130 ;
V_197 = F_84 ( V_8 - V_126 ) ;
if ( ! V_197 )
return - V_161 ;
if ( F_69 ( V_197 , V_123 + V_126 , V_8 - V_126 ) != 0 ) {
V_10 = - V_167 ;
goto free;
}
V_102 = F_73 ( V_175 , V_100 , V_94 ) ;
if ( ! V_102 || F_38 ( V_102 ) ) {
V_10 = V_102 ? F_39 ( V_102 ) : - V_180 ;
goto free;
}
...
V_93 = F_23 () ;
F_46 (iter, loc_cpu_entry, private->size) {
...
static inline void F_85 ( struct V_173 * V_78 )
{
struct V_76 * V_102 ;
V_102 = F_86 ( V_78 ) ;
F_40 ( V_102 -> V_104 . V_105 . V_106 -> V_138 ) ;
...
static int
F_88 ( struct V_173 * V_78 , void * * V_204 ,
...
static int F_90 ( const char * V_94 ,
unsigned int V_116 ,
struct V_90 * * V_207 ,
void * * V_208 ,
unsigned int V_162 ,
...
F_71 ( V_100 ) ;
F_67 ( V_100 , V_150 ) ;
F_46 (iter0, entry0, total_size) {
V_10 = F_87 ( V_211 , V_2 , & V_126 ,
V_117 ,
V_117 + V_162 ,
V_141 ,
V_142 ,
...
V_210 = V_115 -> V_95 [ F_56 () ] ;
V_119 = V_210 ;
V_126 = V_162 ;
F_46 (iter0, entry0, total_size) {
V_10 = F_88 ( V_211 , & V_119 , & V_126 ,
V_94 , V_115 , V_210 ) ;
if ( V_10 != 0 )
break;
}
...
goto V_193;
V_9 = 0 ;
F_46 (iter1, entry1, newinfo->size) {
V_10 = F_34 ( V_212 , V_94 ) ;
if ( V_10 != 0 )
break;
++ V_9 ;
if ( strcmp ( F_16 ( V_212 ) -> V_104 . V_123 . V_94 ,
V_152 ) == 0 )
++ V_115 -> V_153 ;
}
if ( V_10 ) {
int V_214 = V_9 ;
V_209 -= V_9 ;
F_46 (iter0, entry0, newinfo->size) {
if ( V_214 -- > 0 )
continue;
if ( V_209 -- == 0 )
break;
...
static int F_91 ( struct V_175 * V_175 , void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
struct V_215 V_179 ;
...
return - V_161 ;
V_166 = V_115 -> V_95 [ F_56 () ] ;
if ( F_69 ( V_166 , V_123 + sizeof( V_179 ) , V_179 . V_126 ) != 0 ) {
V_10 = - V_167 ;
goto V_193;
}
V_10 = F_90 ( V_179 . V_94 , V_179 . V_116 ,
...
static int F_94 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
if ( ! F_95 ( V_219 ) )
...
switch ( V_218 ) {
case V_221 :
V_10 = F_91 ( F_96 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_222 :
V_10 = F_83 ( F_96 ( V_217 ) , V_123 , V_8 , 1 ) ;
break;
default:
F_11 ( L_56 , V_218 ) ;
V_10 = - V_130 ;
...
static int F_97 ( struct V_77 * V_78 , void T_6 * * V_204 ,
T_7 * V_126 ,
struct V_144 * V_103 ,
unsigned int V_9 )
{
struct V_76 * V_102 ;
struct V_173 T_6 * V_223 ;
T_8 V_122 , V_128 ;
T_7 V_206 ;
int V_10 ;
V_206 = * V_126 ;
V_223 = (struct V_173 T_6 * ) * V_204 ;
if ( F_57 ( V_223 , V_78 , sizeof( struct V_77 ) ) != 0 ||
F_57 ( & V_223 -> V_103 , & V_103 [ V_9 ] ,
sizeof( V_103 [ V_9 ] ) ) != 0 )
return - V_167 ;
...
V_102 = F_16 ( V_78 ) ;
V_10 = F_98 ( V_102 , V_204 , V_126 ) ;
if ( V_10 )
return V_10 ;
V_128 = V_78 -> V_128 - ( V_206 - * V_126 ) ;
if ( F_99 ( V_122 , & V_223 -> V_122 ) != 0 ||
F_99 ( V_128 , & V_223 -> V_128 ) != 0 )
return - V_167 ;
return 0 ;
}
static int F_100 ( unsigned int V_162 ,
struct V_1 * V_84 ,
void T_6 * V_163 )
{
struct V_144 * V_103 ;
...
V_119 = V_163 ;
V_126 = V_162 ;
F_46 (iter, loc_cpu_entry, total_size) {
V_10 = F_97 ( V_149 , & V_119 ,
& V_126 , V_103 , V_9 ++ ) ;
if ( V_10 != 0 )
break;
}
...
static int F_101 ( struct V_175 * V_175 ,
struct V_224 T_6 * V_182 ,
int * V_8 )
{
int V_10 ;
struct V_224 V_183 ;
struct V_1 * V_102 ;
if ( * V_8 < sizeof( V_183 ) ) {
F_11 ( L_57 , * V_8 , sizeof( V_183 ) ) ;
return - V_130 ;
}
if ( F_69 ( & V_183 , V_182 , sizeof( V_183 ) ) != 0 )
return - V_167 ;
if ( * V_8 != sizeof( struct V_224 ) + V_183 . V_126 ) {
F_11 ( L_58 ,
...
static int F_102 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 ,
int * V_8 )
{
int V_10 ;
if ( ! F_95 ( V_219 ) )
...
switch ( V_218 ) {
case V_225 :
V_10 = F_68 ( F_96 ( V_217 ) , V_123 , V_8 , 1 ) ;
break;
case V_226 :
V_10 = F_101 ( F_96 ( V_217 ) , V_123 , V_8 ) ;
break;
default:
V_10 = F_103 ( V_217 , V_218 , V_123 , V_8 ) ;
}
return V_10 ;
}
static int F_104 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 , unsigned int V_8 )
{
int V_10 ;
if ( ! F_95 ( V_219 ) )
return - V_220 ;
switch ( V_218 ) {
case V_221 :
V_10 = F_81 ( F_96 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_222 :
V_10 = F_83 ( F_96 ( V_217 ) , V_123 , V_8 , 0 ) ;
break;
default:
F_11 ( L_56 , V_218 ) ;
V_10 = - V_130 ;
...
static int F_103 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 , int * V_8 )
{
int V_10 ;
if ( ! F_95 ( V_219 ) )
return - V_220 ;
switch ( V_218 ) {
case V_225 :
V_10 = F_68 ( F_96 ( V_217 ) , V_123 , V_8 , 0 ) ;
break;
case V_226 :
V_10 = F_77 ( F_96 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_227 : {
struct V_228 V_229 ;
if ( * V_8 != sizeof( V_229 ) ) {
...
if ( F_69 ( & V_229 , V_123 , sizeof( V_229 ) ) != 0 ) {
V_10 = - V_167 ;
break;
}
V_229 . V_94 [ sizeof( V_229 . V_94 ) - 1 ] = 0 ;
F_72 ( F_105 ( V_100 , V_229 . V_94 ,
V_229 . V_136 , 1 , & V_10 ) ,
L_60 , V_229 . V_94 ) ;
break;
}
...
struct V_1 * F_106 ( struct V_175 * V_175 ,
const struct V_1 * V_84 ,
const struct V_147 * V_148 )
{
int V_10 ;
...
V_10 = F_45 ( V_115 , V_166 , V_148 ) ;
F_11 ( L_62 , V_10 ) ;
if ( V_10 != 0 )
goto V_232;
V_231 = F_107 ( V_175 , V_84 , & V_230 , V_115 ) ;
if ( F_38 ( V_231 ) ) {
V_10 = F_39 ( V_231 ) ;
goto V_232;
}
...
void F_108 ( struct V_1 * V_84 )
{
struct V_90 * V_91 ;
void * V_166 ;
struct V_233 * V_234 = V_84 -> V_138 ;
struct V_77 * V_149 ;
V_91 = F_109 ( V_84 ) ;
V_166 = V_91 -> V_95 [ F_56 () ] ;
F_46 (iter, loc_cpu_entry, private->size)
...
static int T_9 F_110 ( struct V_175 * V_175 )
{
return F_111 ( V_175 , V_100 ) ;
}
static void T_10 F_112 ( struct V_175 * V_175 )
{
F_113 ( V_175 , V_100 ) ;
}
