...
return;
V_4 -> V_25 ( V_4 , V_5 , V_6 , V_7 , V_8 , V_9 ) ;
}
...
F_11 ( & V_4 -> V_30 ) ;
F_9 ( V_27 ) ;
F_3 ( V_4 , V_4 -> V_13 . V_31 . V_19 . V_20 , V_4 -> V_13 . V_31 . V_19 . V_21 ,
V_32 , 0 , 0 ) ;
F_12 ( & V_4 -> V_33 ) ;
F_13 ( V_4 ) ;
F_14 ( & V_34 . V_35 ) ;
...
static void F_16 ( struct V_36 * V_36 )
{
T_1 V_8 ;
struct V_3 * V_4 ;
struct V_3 * V_37 ;
...
static void F_23 ( struct V_40 * V_31 ,
struct V_36 * V_36 )
{
struct V_3 * V_4 ;
struct V_3 * V_37 ;
...
F_20 (sub, sub_temp, &subscriber->subscription_list,
subscription_list) {
if ( ! memcmp ( V_31 , & V_4 -> V_13 . V_31 , sizeof( struct V_40 ) ) ) {
V_41 = 1 ;
break;
}
}
...
static struct V_3 * F_24 ( struct V_40 * V_31 ,
struct V_36 * V_36 )
{
struct V_3 * V_4 ;
int V_2 ;
V_2 = ! ( V_31 -> V_23 & ( V_24 | V_42 ) ) ;
if ( V_31 -> V_23 & F_1 ( V_43 , V_2 ) ) {
V_31 -> V_23 &= ~ F_1 ( V_43 , V_2 ) ;
F_23 ( V_31 , V_36 ) ;
return NULL ;
}
if ( F_25 ( & V_34 . V_35 ) >= V_44 ) {
F_26 ( L_1 ,
V_44 ) ;
F_16 ( V_36 ) ;
return NULL ;
...
V_4 -> V_19 . type = F_1 ( V_31 -> V_19 . type , V_2 ) ;
V_4 -> V_19 . V_20 = F_1 ( V_31 -> V_19 . V_20 , V_2 ) ;
V_4 -> V_19 . V_21 = F_1 ( V_31 -> V_19 . V_21 , V_2 ) ;
V_4 -> V_28 = F_1 ( V_31 -> V_28 , V_2 ) ;
V_4 -> V_23 = F_1 ( V_31 -> V_23 , V_2 ) ;
if ( ( ! ( V_4 -> V_23 & V_24 ) ==
! ( V_4 -> V_23 & V_42 ) ) ||
...
V_4 -> V_25 = F_3 ;
F_28 ( & V_4 -> V_46 ) ;
F_29 ( & V_4 -> V_30 , & V_36 -> V_30 ) ;
V_4 -> V_18 = V_36 -> V_8 ;
V_4 -> V_2 = V_2 ;
memcpy ( & V_4 -> V_13 . V_31 , V_31 , sizeof( struct V_40 ) ) ;
F_30 ( & V_34 . V_35 ) ;
if ( V_4 -> V_28 != V_29 ) {
F_31 ( & V_4 -> V_33 ,
( V_47 ) F_7 , ( unsigned long ) V_4 ) ;
F_32 ( & V_4 -> V_33 , V_4 -> V_28 ) ;
}
return V_4 ;
}
...
struct V_36 * V_36 ;
T_1 V_60 ;
V_36 = F_37 ( sizeof( struct V_36 ) , V_45 ) ;
if ( V_36 == NULL ) {
F_26 ( L_4 ) ;
return;
}
