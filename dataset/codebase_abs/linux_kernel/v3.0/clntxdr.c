...
static void F_8 ( struct V_14 * V_15 , const T_1 V_18 )
{
T_4 * V_17 ;
V_17 = F_7 ( V_15 , 4 ) ;
* V_17 = F_9 ( V_18 ) ;
...
const T_5 * V_21 , const unsigned int V_22 )
{
T_4 * V_17 ;
F_3 ( V_22 > V_23 ) ;
...
{
F_3 ( V_32 -> V_28 > V_33 ) ;
F_10 ( V_15 , ( T_5 * ) & V_32 -> V_21 , V_32 -> V_28 ) ;
}
...
static int F_23 ( struct V_14 * V_15 , struct V_43 * V_44 )
{
...
static void F_25 ( struct V_14 * V_15 , const char * V_56 )
{
T_3 V_22 = strlen ( V_56 ) ;
T_4 * V_17 ;
F_3 ( V_22 > V_57 ) ;
V_17 = F_7 ( V_15 , 4 + V_22 ) ;
F_11 ( V_17 , V_56 , V_22 ) ;
