...
{
int V_58 = - V_206 ;
struct V_98 * T_6 = F_95 ( V_207 , V_208 ,
0 , false , & V_209 ) ;
if ( T_6 == NULL )
return - V_210 ;
if ( F_96 ( T_6 , L_55 ) ) {
V_58 = F_97 ( T_6 , & V_209 ) ;
V_21 = T_6 -> V_211 . V_212 . V_21 [ 0 ] ;
V_213 = T_6 -> V_211 . V_212 . V_214 ;
V_215 = T_6 -> V_211 . V_212 . V_21 [ V_216 ] ;
}
F_98 ( T_6 ) ;
return V_58 ;
}
...
if ( V_213 && V_21 ) {
printf ( L_57 ,
( double ) V_213 / ( double ) V_21 * 100.0 ,
V_213 , V_21 , V_215 ) ;
}
if ( V_167 && V_168 ) {
printf ( L_58 ,
...
{
char * V_219 , * V_178 , * V_142 = F_107 ( V_220 ) ;
for ( V_178 = strtok_r ( V_142 , L_75 , & V_219 ) ;
V_178 ; V_178 = strtok_r ( NULL , L_75 , & V_219 ) ) {
...
static int F_109 ( int V_223 , const char * * V_224 )
{
unsigned int V_225 , V_12 , V_51 ;
const char * * V_226 ;
V_225 = F_110 ( V_227 ) + V_223 - 1 ;
V_226 = calloc ( V_225 + 1 , sizeof( char * ) ) ;
if ( V_226 == NULL )
return - V_210 ;
for ( V_12 = 0 ; V_12 < F_110 ( V_227 ) ; V_12 ++ )
V_226 [ V_12 ] = F_107 ( V_227 [ V_12 ] ) ;
for ( V_51 = 1 ; V_51 < ( unsigned int ) V_223 ; V_51 ++ , V_12 ++ )
V_226 [ V_12 ] = V_224 [ V_51 ] ;
F_11 ( V_12 != V_225 ) ;
return F_111 ( V_12 , V_226 , NULL ) ;
}
int F_112 ( int V_223 , const char * * V_224 , const char * T_13 V_39 )
{
V_223 = F_113 ( V_223 , V_224 , V_228 , V_229 ,
V_230 ) ;
if ( ! V_223 )
F_108 ( V_229 , V_228 ) ;
if ( ! strcmp ( V_224 [ 0 ] , L_78 ) )
return F_114 ( V_223 , V_224 , T_13 ) ;
F_115 () ;
if ( ! strncmp ( V_224 [ 0 ] , L_79 , 3 ) ) {
return F_109 ( V_223 , V_224 ) ;
} else if ( ! strncmp ( V_224 [ 0 ] , L_80 , 3 ) ) {
V_184 = & V_231 ;
if ( V_223 > 1 ) {
V_223 = F_113 ( V_223 , V_224 , V_222 , V_221 , 0 ) ;
if ( V_223 )
F_108 ( V_221 , V_222 ) ;
}
F_106 () ;
F_100 () ;
} else if ( ! strcmp ( V_224 [ 0 ] , L_81 ) ) {
V_184 = & V_232 ;
F_106 () ;
F_103 () ;
} else if ( ! strncmp ( V_224 [ 0 ] , L_82 , 3 ) ) {
V_184 = & V_233 ;
if ( V_223 ) {
V_223 = F_113 ( V_223 , V_224 , V_234 , V_235 , 0 ) ;
if ( V_223 )
F_108 ( V_235 , V_234 ) ;
}
F_105 () ;
