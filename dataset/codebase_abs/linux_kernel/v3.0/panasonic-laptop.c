...
F_23 ( V_2 -> V_19 , V_64 , V_62 ) ;
if ( ! F_24 ( V_61 ,
V_62 & 0xf , V_62 & 0x80 , false ) )
F_7 ( ( V_22 ,
L_9 , V_62 ) ) ;
}
static void F_25 ( struct V_18 * V_19 , T_4 V_65 )
{
...
V_60 -> V_69 = V_70 ;
V_60 -> V_71 . V_72 = V_73 ;
V_60 -> V_71 . V_74 = 0x0001 ;
V_60 -> V_71 . V_75 = 0x0001 ;
V_60 -> V_71 . V_76 = 0x0100 ;
error = F_28 ( V_60 , V_77 , NULL ) ;
if ( error ) {
F_7 ( ( V_22 ,
L_11 ) ) ;
goto V_78;
...
V_2 = F_36 ( sizeof( struct V_1 ) , V_82 ) ;
if ( ! V_2 ) {
F_7 ( ( V_22 ,
L_15 ) ) ;
return - V_66 ;
}
V_2 -> V_37 = F_36 ( sizeof( T_4 ) * ( V_33 + 1 ) , V_82 ) ;
if ( ! V_2 -> V_37 ) {
V_62 = - V_66 ;
goto V_83;
}
...
V_2 -> V_33 = V_33 ;
V_19 -> V_84 = V_2 ;
strcpy ( F_37 ( V_19 ) , V_85 ) ;
strcpy ( F_38 ( V_19 ) , V_86 ) ;
V_62 = F_26 ( V_2 ) ;
if ( V_62 ) {
F_7 ( ( V_22 ,
L_16 ) ) ;
...
memset ( & V_42 , 0 , sizeof( struct V_80 ) ) ;
V_42 . type = V_89 ;
V_42 . V_90 = V_2 -> V_37 [ V_47 ] ;
V_2 -> V_91 = F_39 ( L_18 , NULL , V_2 ,
& V_92 , & V_42 ) ;
if ( F_40 ( V_2 -> V_91 ) ) {
V_62 = F_41 ( V_2 -> V_91 ) ;
goto V_88;
}
V_2 -> V_91 -> V_42 . V_43 = V_2 -> V_37 [ V_40 ] ;
V_2 -> V_59 = V_2 -> V_37 [ V_58 ] ;
V_62 = F_42 ( & V_19 -> V_49 . V_93 , & V_94 ) ;
if ( V_62 )
goto V_95;
return 0 ;
V_95:
...
static int F_46 ( struct V_18 * V_19 , int type )
{
struct V_1 * V_2 = F_17 ( V_19 ) ;
if ( ! V_19 || ! V_2 )
return - V_23 ;
F_47 ( & V_19 -> V_49 . V_93 , & V_94 ) ;
F_43 ( V_2 -> V_91 ) ;
F_32 ( V_2 ) ;
F_11 ( V_2 -> V_37 ) ;
F_11 ( V_2 ) ;
