...
continue;
F_3 ( L_7 , V_16 -> V_18 , V_16 -> V_19 , V_16 -> V_20 ) ;
}
F_3 ( L_8 ) ;
}
...
static inline unsigned long F_13 ( int V_25 , unsigned long V_26 )
{
struct V_13 * V_15 ;
struct V_16 * V_16 ;
if( F_10 ( & V_27 ) ) {
...
static inline int F_16 ( unsigned long V_30 )
{
unsigned long V_25 ;
struct V_16 * V_16 ;
struct V_13 * V_15 ;
...
inline unsigned long F_22 ( unsigned long V_36 , int V_25 , int V_26 )
{
unsigned long V_30 ;
unsigned long V_37 ;
if( ! V_25 )
...
V_30 = F_13 ( V_25 , V_26 ) ;
if( ! F_24 ( V_36 , V_30 , V_25 ) )
return ( V_30 + V_37 ) ;
F_3 ( L_13 , V_36 , V_30 , V_25 ) ;
F_11 () ;
return 0 ;
}
void F_25 ( void * V_30 )
...
void * F_26 ( unsigned long V_25 , unsigned long V_26 )
{
unsigned long V_36 ;
unsigned long V_30 ;
unsigned long V_40 ;
...
#endif
V_25 = ( ( V_25 + ( V_29 - 1 ) ) & V_32 ) ;
if( ( V_36 = F_27 ( V_41 , F_28 ( V_25 ) ) ) == 0 )
return NULL ;
if( ( V_30 = ( unsigned long ) F_22 ( V_36 , V_25 , V_26 ) ) == 0 ) {
F_29 ( V_36 , F_28 ( V_25 ) ) ;
return NULL ;
}
V_40 = F_30 ( V_30 ) ;
if( F_31 ( V_36 , V_40 , V_25 ) < 0 ) {
F_25 ( ( void * ) V_30 ) ;
F_29 ( V_36 , F_28 ( V_25 ) ) ;
return NULL ;
}
