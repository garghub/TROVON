...
V_66 -> V_72 = F_47 ( 0 , 0 , 3 ) ;
V_66 -> V_73 = V_74 | V_75 ;
return 0 ;
}
static int F_48 ( struct V_63 * V_63 , void * V_76 , struct V_77 * V_78 )
{
static const char * V_79 [ 4 ] = {
L_3 ,
L_4 ,
L_5 ,
L_6
...
if ( V_78 -> V_3 > 3 )
return - V_80 ;
F_46 ( V_78 -> V_69 , V_79 [ V_78 -> V_3 ] , sizeof( V_78 -> V_69 ) ) ;
V_78 -> type = V_81 ;
V_78 -> V_82 = 0 ;
V_78 -> V_83 = 0 ;
V_78 -> V_44 = V_84 ;
...
static int F_49 ( struct V_63 * V_63 , void * V_76 , unsigned int * V_86 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
* V_86 = V_2 -> V_52 ;
return 0 ;
}
static int F_50 ( struct V_63 * V_63 , void * V_76 , unsigned int V_86 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
if ( V_86 > 3 )
return - V_80 ;
...
static int F_53 ( struct V_63 * V_63 , void * V_76 , T_4 * V_44 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
* V_44 = V_2 -> V_44 ;
return 0 ;
}
static int F_54 ( struct V_63 * V_63 , void * V_76 , T_4 * V_44 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
int V_88 = 0 ;
V_2 -> V_44 = * V_44 ;
...
static int F_55 ( struct V_63 * V_63 , void * V_64 ,
struct V_92 * V_93 )
{
switch ( V_93 -> V_94 ) {
case V_95 :
return F_56 ( V_93 , 0 , 255 , 1 , 139 ) ;
case V_96 :
return F_56 ( V_93 , 0 , 255 , 1 , 70 ) ;
case V_97 :
return F_56 ( V_93 , 0 , 255 , 1 , 64 ) ;
case V_98 :
return F_56 ( V_93 , 0 , 255 , 1 , 0 ) ;
}
return - V_80 ;
}
...
static int F_58 ( struct V_63 * V_63 , void * V_64 ,
struct V_99 * V_100 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
int V_88 = 0 ;
...
static int F_59 ( struct V_63 * V_63 , void * V_76 , struct V_102 * V_103 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
...
static int F_60 ( struct V_63 * V_63 , void * V_76 , struct V_102 * V_103 )
{
struct V_104 * V_105 = & V_103 -> V_103 . V_105 ;
...
static int F_61 ( struct V_63 * V_63 , void * V_76 , struct V_102 * V_103 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
struct V_104 * V_105 = & V_103 -> V_103 . V_105 ;
int V_88 = F_60 ( V_63 , V_76 , V_103 ) ;
if ( V_88 )
return V_88 ;
F_51 ( & V_2 -> V_87 ) ;
V_2 -> V_48 = V_105 -> V_48 ;
...
static int F_62 ( struct V_63 * V_63 , void * V_76 , struct V_116 * V_103 )
{
...
static T_5 F_63 ( struct V_63 * V_63 , char T_3 * V_53 ,
T_6 V_13 , T_7 * V_119 )
{
struct V_1 * V_2 = F_45 ( V_63 ) ;
int V_58 ;
...
int V_120 , V_121 ;
int V_9 ;
static const unsigned char V_122 [] = {
0x4c , 0x30 , 0x00 , 0xe8 ,
0xb6 , 0xe2 , 0x00 , 0x00 ,
0xff , 0xff , 0x00 , 0x00 ,
0x00 , 0x00 , 0x78 , 0x98 ,
...
V_2 -> V_60 = F_65 ( V_123 , 0x800 ) ;
if ( ! V_2 -> V_60 )
return - V_124 ;
if ( ! F_66 ( 0x9a01 , 1 , L_9 ) ) {
F_67 ( V_125 L_10 ) ;
F_68 ( V_2 -> V_60 ) ;
return - V_126 ;
}
if ( ! F_66 ( V_2 -> V_5 , 3 , L_1 ) ) {
F_67 ( V_125 L_11 , V_2 -> V_5 ) ;
F_69 ( 0x9a01 , 1 ) ;
F_68 ( V_2 -> V_60 ) ;
return - V_126 ;
}
...
V_131 = F_74 ( NULL , V_68 ) ;
if ( V_131 < 0 ) {
F_73 ( V_68 , L_17 ) ;
return V_131 ;
}
F_46 ( V_2 -> V_134 . V_69 , V_68 -> V_69 , sizeof( V_2 -> V_134 . V_69 ) ) ;
V_2 -> V_134 . V_68 = V_68 ;
V_2 -> V_134 . V_135 = & V_136 ;
V_2 -> V_134 . V_137 = & V_138 ;
V_2 -> V_134 . V_139 = V_140 ;
F_75 ( & V_2 -> V_134 , V_2 ) ;
F_76 ( & V_2 -> V_87 ) ;
V_2 -> V_44 = V_141 ;
V_2 -> V_49 = 240 ;
...
F_10 ( V_2 , 0 ) ;
F_39 ( V_2 , 0 ) ;
if ( F_77 ( & V_2 -> V_134 , V_142 , V_143 ) < 0 ) {
F_78 ( & V_2 -> V_68 ) ;
F_69 ( V_2 -> V_5 , 3 ) ;
F_69 ( 0x9a01 , 1 ) ;
F_68 ( V_2 -> V_60 ) ;
