...
struct V_197 * V_198 ;
int V_199 , V_155 ;
V_196 = V_39 -> V_38 . V_200 ;
V_199 = sizeof( struct V_65 ) + sizeof( struct V_33 ) ;
V_35 = F_55 ( V_199 , V_201 ) ;
if ( ! V_35 ) {
F_42 ( & V_39 -> V_38 , L_8 ) ;
return - V_202 ;
}
V_2 = F_55 ( sizeof( struct V_203 ) , V_201 ) ;
if ( ! V_2 ) {
V_155 = - V_202 ;
goto V_204;
}
...
V_35 -> V_36 = V_34 ;
V_35 -> V_38 . V_205 = & V_39 -> V_38 ;
V_35 -> V_206 = V_207 ;
V_2 -> V_39 = V_39 ;
V_2 -> type = F_56 ( V_39 ) -> V_208 ;
F_52 ( V_35 ) ;
V_198 = F_57 ( V_39 , V_209 , 0 ) ;
if ( ! V_198 ) {
F_42 ( & V_39 -> V_38 , L_9 ) ;
return - V_210 ;
goto V_211;
}
V_2 -> V_212 = F_58 ( V_198 -> V_169 , F_59 ( V_198 ) ,
V_39 -> V_213 ) ;
if ( ! V_2 -> V_212 ) {
F_42 ( & V_39 -> V_38 , L_10 ) ;
V_155 = - V_214 ;
...
V_2 -> V_3 = F_60 ( V_198 -> V_169 , F_59 ( V_198 ) ) ;
if ( ! V_2 -> V_3 ) {
F_42 ( & V_39 -> V_38 , L_11 ) ;
V_155 = - V_216 ;
goto V_217;
...
V_34 -> V_178 |= V_218 ;
if ( V_2 -> type != V_186 ) {
V_198 = F_57 ( V_39 , V_209 , 1 ) ;
if ( ! V_198 ) {
F_42 ( & V_39 -> V_38 , L_12 ) ;
return - V_210 ;
goto V_211;
}
V_2 -> V_219 = F_58 ( V_198 -> V_169 , F_59 ( V_198 ) ,
V_39 -> V_213 ) ;
if ( ! V_2 -> V_219 ) {
F_42 ( & V_39 -> V_38 , L_13 ) ;
V_155 = - V_214 ;
...
V_2 -> V_6 = F_60 ( V_198 -> V_169 , F_59 ( V_198 ) ) ;
if ( ! V_2 -> V_6 ) {
F_42 ( & V_39 -> V_38 , L_14 ) ;
V_155 = - V_220 ;
goto V_221;
}
V_2 -> V_103 = F_55 ( V_222 , V_201 ) ;
if ( ! V_2 -> V_103 ) {
V_155 = - V_202 ;
goto V_223;
}
V_2 -> V_104 = F_55 ( 128 , V_201 ) ;
if ( ! V_2 -> V_104 ) {
V_155 = - V_202 ;
goto V_224;
}
V_35 -> V_225 = 0 ;
V_34 -> V_226 = V_35 -> V_105 ;
} else {
V_198 = F_57 ( V_39 , V_209 , 1 ) ;
if ( ! V_198 ) {
F_42 ( & V_39 -> V_38 , L_15 ) ;
...
V_2 -> V_228 = F_58 ( V_198 -> V_169 , F_59 ( V_198 ) ,
V_39 -> V_213 ) ;
if ( ! V_2 -> V_228 ) {
F_42 ( & V_39 -> V_38 , L_16 ) ;
V_155 = - V_214 ;
...
V_2 -> V_122 = F_60 ( V_198 -> V_169 , F_59 ( V_198 ) ) ;
if ( ! V_2 -> V_122 ) {
F_42 ( & V_39 -> V_38 , L_17 ) ;
V_155 = - V_220 ;
goto V_229;
}
V_2 -> V_162 = V_2 -> V_212 -> V_169 ;
F_43 = F_31 ;
V_198 = F_57 ( V_39 , V_230 , 0 ) ;
if ( V_198 ) {
F_61 ( & V_2 -> V_148 ) ;
F_43 = F_35 ;
V_155 = F_62 ( V_198 -> V_169 , F_32 ,
V_231 , L_18 , & V_2 ) ;
if ( V_155 ) {
F_42 ( & V_39 -> V_38 , L_19 ) ;
goto V_232;
...
V_155 = F_64 ( V_35 , V_234 , & V_2 -> V_235 , 0 ) ;
if ( V_155 > 0 )
F_65 ( V_35 , V_2 -> V_235 , V_155 ) ;
else if ( V_155 <= 0 && V_196 && V_196 -> V_235 )
F_65 ( V_35 , V_196 -> V_235 , V_196 -> V_236 ) ;
else
V_155 = F_65 ( V_35 , NULL , 0 ) ;
F_66 ( V_39 , V_35 ) ;
return 0 ;
V_232:
if ( V_2 -> V_122 )
...
static int T_6 F_70 ( struct V_194 * V_39 )
{
