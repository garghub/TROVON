...
static int F_93 ( T_1 V_15 )
{
int V_124 = 0 ;
struct V_125 * V_126 ;
V_126 = F_94 ( V_15 , & V_124 ) ;
if ( ! V_126 || V_124 )
return - V_127 ;
return 0 ;
}
static int F_95 ( char * V_128 ,
struct V_3 * V_129 , enum V_11 V_12 , int V_14 )
{
char * V_130 [ 4 ] , * V_131 , * V_132 = NULL , * V_133 = NULL ;
int V_82 ;
...
while ( ( V_131 = F_96 ( & V_128 , L_9 ) ) != NULL ) {
if ( ! * V_131 )
continue;
V_130 [ V_87 ++ ] = V_131 ;
if ( V_87 == 3 )
...
if ( ! V_133 )
return - V_137 ;
V_82 = F_97 ( V_132 , 10 , & V_134 ) ;
if ( V_82 )
return - V_137 ;
V_82 = F_97 ( V_133 , 10 , & V_135 ) ;
if ( V_82 )
return - V_137 ;
V_15 = F_98 ( V_134 , V_135 ) ;
V_82 = F_93 ( V_15 ) ;
if ( V_82 )
return V_82 ;
V_129 -> V_15 = V_15 ;
...
switch ( V_12 ) {
case V_138 :
V_82 = F_97 ( V_130 [ 1 ] , 10 , & V_136 ) ;
if ( V_82 || ( V_136 < V_139 && V_136 > 0 ) ||
V_136 > V_140 )
return - V_137 ;
V_129 -> V_12 = V_12 ;
V_129 -> V_14 = V_14 ;
V_129 -> V_92 . V_21 = V_136 ;
break;
case V_141 :
switch( V_14 ) {
case V_28 :
case V_30 :
V_82 = F_99 ( V_130 [ 1 ] , 10 , & V_27 ) ;
if ( V_82 )
return - V_137 ;
V_129 -> V_12 = V_12 ;
V_129 -> V_14 = V_14 ;
V_129 -> V_92 . V_27 = V_27 ;
break;
case V_33 :
case V_35 :
V_82 = F_99 ( V_130 [ 1 ] , 10 , & V_32 ) ;
if ( V_82 )
return - V_137 ;
if ( V_32 > V_142 )
return - V_137 ;
V_129 -> V_12 = V_12 ;
V_129 -> V_14 = V_14 ;
V_129 -> V_92 . V_32 = ( unsigned int ) V_32 ;
break;
}
break;
default:
...
{
struct V_3 * V_4 ;
V_4 = F_9 ( V_2 , V_15 , V_138 ,
V_143 ) ;
if ( V_4 )
return V_4 -> V_92 . V_21 ;
else
return V_2 -> V_21 ;
}
...
{
struct V_3 * V_4 ;
V_4 = F_9 ( V_2 , V_15 , V_141 ,
V_28 ) ;
if ( V_4 )
return V_4 -> V_92 . V_27 ;
else
return - 1 ;
}
...
static void F_107 ( struct V_3 * V_144 ,
struct V_3 * V_129 )
{
switch( V_144 -> V_12 ) {
case V_138 :
V_144 -> V_92 . V_21 = V_129 -> V_92 . V_21 ;
break;
case V_141 :
switch( V_129 -> V_14 ) {
case V_28 :
case V_30 :
V_144 -> V_92 . V_27 = V_129 -> V_92 . V_27 ;
break;
case V_33 :
case V_35 :
V_144 -> V_92 . V_32 = V_129 -> V_92 . V_32 ;
}
break;
default:
F_100 () ;
...
static int F_110 ( struct V_16 * V_146 , struct V_7 * V_8 ,
const char * V_147 )
{
int V_82 = 0 ;
char * V_128 ;
struct V_3 * V_129 , * V_4 ;
struct V_1 * V_2 ;
int V_148 = 0 ;
enum V_11 V_12 = F_4 ( V_8 -> V_13 ) ;
int V_14 = F_6 ( V_8 -> V_13 ) ;
V_128 = F_111 ( V_147 , V_149 ) ;
if ( ! V_128 )
return - V_76 ;
V_129 = F_112 ( sizeof( * V_129 ) , V_149 ) ;
if ( ! V_129 ) {
V_82 = - V_76 ;
goto V_150;
}
V_82 = F_95 ( V_128 , V_129 , V_12 , V_14 ) ;
if ( V_82 )
goto V_151;
V_2 = F_11 ( V_146 ) ;
F_76 ( & V_2 -> V_77 ) ;
V_4 = F_9 ( V_2 , V_129 -> V_15 , V_12 , V_14 ) ;
if ( ! V_4 ) {
if ( ! F_106 ( V_129 ) ) {
F_1 ( V_2 , V_129 ) ;
V_148 = 1 ;
...
static void
F_114 ( struct V_153 * V_154 , struct V_3 * V_4 )
{
switch( V_4 -> V_12 ) {
case V_138 :
if ( V_4 -> V_14 == V_143 )
F_115 ( V_154 , L_11 , F_82 ( V_4 -> V_15 ) ,
...
case V_28 :
case V_30 :
F_115 ( V_154 , L_12 , F_82 ( V_4 -> V_15 ) ,
...
struct V_1 * V_2 , struct V_153 * V_154 )
{
struct V_3 * V_4 ;
if ( ! F_117 ( & V_2 -> V_6 ) ) {
F_76 ( & V_2 -> V_77 ) ;
...
static int F_118 ( struct V_16 * V_146 , struct V_7 * V_8 ,
struct V_153 * V_154 )
{
struct V_1 * V_2 ;
enum V_11 V_12 = F_4 ( V_8 -> V_13 ) ;
int V_155 = F_6 ( V_8 -> V_13 ) ;
V_2 = F_11 ( V_146 ) ;
switch( V_12 ) {
case V_138 :
switch( V_155 ) {
...
enum V_114 type , bool V_156 , bool V_157 )
{
struct V_9 * V_10 ;
struct V_84 * V_85 ;
T_3 V_158 = 0 ;
...
continue;
if ( V_157 )
V_158 += F_90 ( V_10 , V_103 ,
V_10 -> V_15 , type ) ;
else {
F_76 ( & V_10 -> V_54 ) ;
V_158 += F_91 ( V_10 , V_103 ,
V_10 -> V_15 , type ) ;
F_80 ( & V_10 -> V_54 ) ;
}
}
...
if ( V_156 )
V_103 -> V_104 ( V_103 , L_13 , V_158 ) ;
F_69 () ;
return 0 ;
}
static int F_120 ( struct V_16 * V_146 , struct V_7 * V_8 ,
struct V_102 * V_103 )
{
struct V_1 * V_2 ;
enum V_11 V_12 = F_4 ( V_8 -> V_13 ) ;
...
static T_2 F_122 ( struct V_16 * V_146 , struct V_7 * V_8 ) {
struct V_1 * V_2 ;
enum V_11 V_12 = F_4 ( V_8 -> V_13 ) ;
int V_155 = F_6 ( V_8 -> V_13 ) ;
V_2 = F_11 ( V_146 ) ;
...
static int
F_123 ( struct V_16 * V_146 , struct V_7 * V_8 , T_2 V_92 )
{
struct V_1 * V_2 ;
enum V_11 V_12 = F_4 ( V_8 -> V_13 ) ;
int V_155 = F_6 ( V_8 -> V_13 ) ;
...
static int F_124 ( struct V_176 * V_177 , struct V_16 * V_16 )
{
return F_125 ( V_16 , V_177 , V_178 ,
F_126 ( V_178 ) ) ;
}
static void F_127 ( struct V_176 * V_177 , struct V_16 * V_16 )
{
...
V_10 = F_129 ( V_2 -> V_80 . V_180 , struct V_9 ,
V_79 ) ;
...
static struct F_13 *
F_133 ( struct V_176 * V_177 , struct V_16 * V_16 )
{
struct V_1 * V_2 ;
struct V_16 * V_183 = V_16 -> V_183 ;
if ( ! V_183 ) {
V_2 = & V_182 ;
goto V_184;
}
V_2 = F_112 ( sizeof( * V_2 ) , V_149 ) ;
if ( ! V_2 )
return F_134 ( - V_76 ) ;
V_2 -> V_21 = V_185 ;
V_184:
...
static int F_137 ( struct V_16 * V_146 , struct V_19 * V_20 )
{
struct V_186 * V_187 ;
int V_82 = 0 ;
F_138 ( V_20 ) ;
V_187 = V_20 -> V_186 ;
if ( V_187 && F_139 ( & V_187 -> V_188 ) > 1 )
V_82 = - V_137 ;
F_140 ( V_20 ) ;
return V_82 ;
}
static void F_141 ( struct V_16 * V_146 , struct V_19 * V_20 )
{
struct V_186 * V_187 ;
F_138 ( V_20 ) ;
V_187 = V_20 -> V_186 ;
