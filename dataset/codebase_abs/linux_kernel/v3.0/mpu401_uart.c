...
if ( ! F_10 ( V_2 ) )
break;
V_60 = V_2 -> V_7 ( V_2 , F_11 ( V_2 ) ) ;
if ( F_16 ( V_59 , & V_2 -> V_11 ) )
F_42 ( V_2 -> V_52 , & V_60 , 1 ) ;
}
}
...
static void F_46 ( struct V_61 * V_27 )
{
struct V_1 * V_2 = V_27 -> V_49 ;
if ( V_2 -> V_62 && V_2 -> V_19 >= 0 )
...
V_2 -> V_62 = V_62 ;
if ( V_65 -> V_80 [ 0 ] )
snprintf ( V_27 -> V_81 , sizeof( V_27 -> V_81 ) , L_11 ,
V_65 -> V_80 ) ;
else
sprintf ( V_27 -> V_81 , L_12 , V_65 -> V_82 , V_66 ) ;
if ( V_69 ) {
F_57 ( V_27 , V_83 ,
& V_84 ) ;
V_27 -> V_14 |= V_85 ;
