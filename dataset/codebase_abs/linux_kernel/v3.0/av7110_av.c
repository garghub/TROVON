...
switch ( V_181 ) {
case V_187 :
V_16 -> V_144 . V_188 = V_189 ;
if ( V_16 -> V_144 . V_141 == V_145 )
V_18 = F_9 ( V_16 , V_33 ) ;
else
V_18 = F_57 ( V_16 , V_190 ,
V_16 -> V_144 . V_191 ? 0 : 1 ) ;
if ( ! V_18 )
V_16 -> V_192 = V_193 ;
break;
case V_194 :
V_16 -> V_192 = V_193 ;
if ( V_16 -> V_144 . V_188 == V_195 ) {
V_16 -> V_144 . V_188 = V_196 ;
V_18 = F_57 ( V_16 , V_197 , 0 ) ;
if ( V_18 )
break;
}
if ( V_16 -> V_144 . V_141 == V_145 ) {
...
break;
case V_198 :
V_16 -> V_144 . V_188 = V_195 ;
if ( V_16 -> V_22 & V_33 )
V_18 = F_5 ( V_16 , V_25 , V_199 , 0 ) ;
else
...
break;
case V_203 :
V_16 -> V_144 . V_141 = ( V_204 ) V_183 ;
break;
case V_205 :
V_16 -> V_144 . V_191 = ( int ) V_183 ;
break;
case V_184 :
memcpy ( V_182 , & V_16 -> V_144 , sizeof( struct V_206 ) ) ;
break;
case V_185 :
V_18 = F_49 ( V_16 , V_182 , V_161 -> V_167 ) ;
break;
case V_186 :
memcpy ( V_182 , & V_16 -> V_207 , sizeof( V_208 ) ) ;
break;
case V_209 :
{
T_9 V_210 = ( T_9 ) V_183 ;
...
if ( V_18 < 0 )
break;
V_16 -> V_144 . V_218 = V_210 ;
V_18 = F_5 ( V_16 , V_67 , V_219 ,
1 , V_16 -> V_212 ) ;
break;
}
case V_220 :
...
F_59 ( & V_16 -> V_85 ) ;
V_18 = F_56 ( V_16 , V_225 -> V_226 , V_225 -> V_227 ,
V_161 -> V_167 & V_160 ) ;
break;
}
case V_228 :
...
if ( V_16 -> V_22 & V_33 ) {
if ( V_16 -> V_192 != V_233 )
V_18 = F_5 ( V_16 , V_25 , V_234 , 2 , 0 , 0 ) ;
if ( ! V_18 )
V_18 = F_57 ( V_16 , V_235 , V_183 ) ;
} else {
V_18 = F_57 ( V_16 , V_197 , 0 ) ;
if ( ! V_18 )
V_18 = F_57 ( V_16 , V_190 , 0 ) ;
if ( ! V_18 )
V_18 = F_57 ( V_16 , V_235 , V_183 ) ;
}
if ( ! V_18 ) {
...
static int F_60 ( struct V_161 * V_161 ,
unsigned int V_181 , void * V_182 )
{
struct V_163 * V_164 = V_161 -> V_165 ;
struct V_16 * V_16 = V_164 -> V_7 ;
...
V_18 = F_61 ( V_16 , V_246 ) ;
if ( ! V_18 )
V_16 -> V_140 . V_188 = V_247 ;
break;
case V_248 :
if ( V_16 -> V_140 . V_141 == V_142 )
V_18 = F_7 ( V_16 , V_28 ) ;
if ( ! V_18 )
V_18 = F_61 ( V_16 , V_249 ) ;
if ( ! V_18 )
V_16 -> V_140 . V_188 = V_250 ;
break;
case V_251 :
V_18 = F_61 ( V_16 , V_246 ) ;
if ( ! V_18 )
V_16 -> V_140 . V_188 = V_252 ;
break;
case V_253 :
if ( V_16 -> V_140 . V_188 == V_252 ) {
V_16 -> V_140 . V_188 = V_250 ;
V_18 = F_61 ( V_16 , V_249 | V_254 ) ;
}
break;
case V_255 :
V_16 -> V_140 . V_141 = ( V_256 ) V_183 ;
break;
case V_257 :
{
V_18 = F_61 ( V_16 , V_183 ? V_246 : V_249 ) ;
if ( ! V_18 )
V_16 -> V_140 . V_258 = ( int ) V_183 ;
break;
}
case V_259 :
V_16 -> V_140 . V_260 = ( int ) V_183 ;
V_18 = F_61 ( V_16 , V_183 ? V_261 : V_262 ) ;
break;
case V_263 :
if ( F_62 ( V_16 -> V_264 ) < 0x2621 )
V_18 = - V_143 ;
V_16 -> V_140 . V_265 = ( int ) V_183 ;
break;
case V_266 :
V_16 -> V_140 . V_267 = ( V_268 ) V_183 ;
switch( V_16 -> V_140 . V_267 ) {
case V_269 :
V_18 = F_61 ( V_16 , V_270 ) ;
if ( ! V_18 ) {
if ( V_16 -> V_59 == V_61 )
...
break;
case V_244 :
memcpy ( V_182 , & V_16 -> V_140 , sizeof( struct V_275 ) ) ;
break;
case V_276 :
if ( F_62 ( V_16 -> V_264 ) < 0x2621 )
* ( unsigned int * ) V_182 = V_277 | V_278 | V_279 ;
else
* ( unsigned int * ) V_182 = V_277 | V_280 | V_281 |
V_278 | V_279 ;
break;
case V_282 :
F_59 ( & V_16 -> V_86 ) ;
...
case V_284 :
{
struct V_285 * V_286 = (struct V_285 * ) V_182 ;
V_18 = F_18 ( V_16 , V_286 -> V_57 , V_286 -> V_58 ) ;
break;
}
case V_287 :
break;
...
static int F_63 ( struct V_288 * V_288 , struct V_161 * V_161 )
{
struct V_163 * V_164 = V_161 -> V_165 ;
struct V_16 * V_16 = V_164 -> V_7 ;
int V_52 ;
F_4 ( 2 , L_2 , V_16 ) ;
if ( ( V_52 = F_64 ( V_288 , V_161 ) ) < 0 )
return V_52 ;
if ( ( V_161 -> V_167 & V_168 ) != V_169 ) {
F_59 ( & V_16 -> V_86 ) ;
F_59 ( & V_16 -> V_85 ) ;
V_16 -> V_191 = 1 ;
V_16 -> V_140 . V_260 = 1 ;
V_16 -> V_144 . V_141 = V_289 ;
V_16 -> V_150 . V_155 = V_16 -> V_150 . V_153 = 0 ;
}
return 0 ;
}
static int F_65 ( struct V_288 * V_288 , struct V_161 * V_161 )
{
struct V_163 * V_164 = V_161 -> V_165 ;
struct V_16 * V_16 = V_164 -> V_7 ;
F_4 ( 2 , L_2 , V_16 ) ;
...
return F_66 ( V_288 , V_161 ) ;
}
static int F_67 ( struct V_288 * V_288 , struct V_161 * V_161 )
{
struct V_163 * V_164 = V_161 -> V_165 ;
struct V_16 * V_16 = V_164 -> V_7 ;
int V_52 = F_64 ( V_288 , V_161 ) ;
F_4 ( 2 , L_2 , V_16 ) ;
if ( V_52 < 0 )
return V_52 ;
F_59 ( & V_16 -> V_86 ) ;
V_16 -> V_140 . V_141 = V_290 ;
return 0 ;
}
static int F_68 ( struct V_288 * V_288 , struct V_161 * V_161 )
{
struct V_163 * V_164 = V_161 -> V_165 ;
struct V_16 * V_16 = V_164 -> V_7 ;
F_4 ( 2 , L_2 , V_16 ) ;
...
int F_69 ( struct V_16 * V_16 )
{
V_16 -> V_140 . V_260 = 0 ;
V_16 -> V_140 . V_258 = 0 ;
V_16 -> V_140 . V_188 = V_247 ;
V_16 -> V_140 . V_141 = V_290 ;
V_16 -> V_140 . V_267 = V_269 ;
V_16 -> V_140 . V_265 = 0 ;
V_16 -> V_144 . V_191 = 0 ;
V_16 -> V_144 . V_188 = V_189 ;
V_16 -> V_144 . V_141 = V_289 ;
V_16 -> V_144 . V_291 = V_292 ;
V_16 -> V_144 . V_218 = V_214 ;
V_16 -> V_221 = V_292 ;
V_16 -> V_212 = V_215 ;
F_70 ( & V_16 -> V_150 . V_157 ) ;
F_71 ( & V_16 -> V_150 . V_152 ) ;
V_16 -> V_150 . V_153 = V_16 -> V_150 . V_155 = 0 ;
V_16 -> V_150 . V_156 = 0 ;
memset ( & V_16 -> V_207 , 0 , sizeof ( V_208 ) ) ;
F_72 ( & V_16 -> V_293 , & V_16 -> V_294 ,
& V_295 , V_16 , V_296 ) ;
F_72 ( & V_16 -> V_293 , & V_16 -> V_297 ,
& V_298 , V_16 , V_299 ) ;
return 0 ;
}
void F_73 ( struct V_16 * V_16 )
{
F_74 ( V_16 -> V_297 ) ;
F_74 ( V_16 -> V_294 ) ;
}
int F_75 ( struct V_16 * V_16 )
{
void (* F_76 [])( T_1 * , int , void * ) = { F_29 , play_video_cb }
