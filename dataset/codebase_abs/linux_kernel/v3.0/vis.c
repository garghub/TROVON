...
static int F_12 ( void * V_23 , int V_25 )
{
struct V_3 * V_3 = V_23 ;
struct V_19 * V_26 ;
unsigned char * V_27 ;
...
static T_4 F_21 ( char * V_45 , struct V_33 * V_39 )
{
struct V_41 * V_8 ;
struct V_14 * V_42 ;
T_2 V_46 = 0 ;
...
static T_4 F_23 ( char * V_45 , struct V_48 * V_8 ,
T_3 * V_49 , bool V_40 )
{
if ( V_40 && V_8 -> V_50 == 0 )
...
{
struct V_7 * V_8 ;
V_8 = F_19 ( sizeof( struct V_7 ) , V_44 ) ;
if ( ! V_8 )
return;
...
if ( ! V_6 -> V_32 )
return NULL ;
V_84 . V_13 = F_43 ( sizeof( struct V_19 ) ) ;
if ( ! V_84 . V_13 )
return NULL ;
...
V_4 = F_19 ( sizeof( struct V_3 ) , V_44 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_13 = F_43 ( sizeof( struct V_19 ) +
...
V_26 = (struct V_19 * ) F_44 ( V_4 -> V_13 ,
sizeof( struct V_19 ) +
V_78 ) ;
F_49 ( & V_4 -> V_5 ) ;
F_50 ( & V_4 -> V_10 ) ;
...
V_4 -> V_89 = V_90 ;
V_4 -> V_6 = V_6 ;
memcpy ( V_26 , V_19 , sizeof( struct V_19 ) + V_78 ) ;
* V_79 = 1 ;
if ( V_80 )
...
struct V_100 * V_100 ;
struct V_98 * V_99 ;
struct V_3 * V_4 = (struct V_3 * ) V_6 -> V_107 ;
...
V_26 -> V_57 = 0 ;
F_62 ( V_4 -> V_13 , sizeof( struct V_19 ) ) ;
if ( V_26 -> V_96 == V_71 ) {
V_101 = F_56 ( V_6 , V_4 ) ;
if ( V_101 < 0 )
return - 1 ;
...
for ( V_29 = 0 ; V_29 < V_28 -> V_25 ; V_29 ++ ) {
V_34 = & V_28 -> V_37 [ V_29 ] ;
F_18 (tt_local_entry, node, head, hash_entry) {
V_8 = (struct V_48 * )
F_44 ( V_4 -> V_13 ,
sizeof( * V_8 ) ) ;
...
V_55 = V_99 -> V_112 ;
memcpy ( V_124 , V_99 -> V_43 , V_30 ) ;
F_58 ( V_99 ) ;
V_123 = F_66 ( V_4 -> V_13 , V_44 ) ;
if ( V_123 )
F_67 ( V_123 , V_55 , V_124 ) ;
}
F_16 () ;
}
}
...
V_123 = F_66 ( V_4 -> V_13 , V_44 ) ;
if ( V_123 )
F_67 ( V_123 , V_99 -> V_112 , V_99 -> V_43 ) ;
V_70:
if ( V_99 )
F_58 ( V_99 ) ;
if ( V_100 )
...
memcpy ( V_26 -> V_87 , V_56 -> V_59 -> V_115 , V_30 ) ;
V_26 -> V_109 -- ;
if ( F_54 ( V_26 -> V_91 ) )
F_65 ( V_6 , V_4 ) ;
else
...
{
struct V_127 * V_127 =
F_2 ( V_126 , struct V_127 , V_126 ) ;
struct V_6 * V_6 =
F_2 ( V_127 , struct V_6 , V_128 ) ;
struct V_3 * V_4 ;
F_4 ( & V_6 -> V_72 ) ;
F_63 ( V_6 ) ;
if ( F_60 ( V_6 ) == 0 ) {
...
static void F_82 ( struct V_14 * V_15 , void * V_135 )
{
struct V_3 * V_4 ;
