...
V_70 = F_37 ( V_57 , 0 ) & V_75 ;
V_2 -> V_4 = F_38 ( V_70 , V_73 ) ;
V_69 = F_37 ( V_57 , 2 ) & V_75 ;
V_2 -> V_63 = F_38 ( V_69 , V_74 ) ;
V_68 = F_37 ( V_57 , 3 ) & V_75 ;
...
V_58 = V_67 / ( V_2 -> V_84 * ( sizeof( V_88 ) + V_89 ) ) ;
V_2 -> V_90 = F_45 ( V_58 / 2 , V_91 ) ;
V_2 -> V_92 = V_58 - V_2 -> V_90 ;
V_2 -> V_93 = V_2 -> V_84 * sizeof( V_88 ) *
( V_2 -> V_90 + V_2 -> V_92 ) ;
F_35 ( V_94 L_5
L_6 ,
V_2 -> type == V_47 ? L_7 :
V_2 -> type == V_81 ? L_8 : L_9 ,
...
F_46 ( 0x0041 , & V_2 -> V_4 -> V_95 ) ;
if ( F_47 ( V_57 -> V_61 , V_96 , V_97 , L_11 , V_2 ) ) {
F_35 ( V_98 L_12 ,
V_57 -> V_61 ) ;
F_21 ( V_57 ) ;
return - V_99 ;
...
T_10 * V_101 = F_49 ( V_30 ) ;
V_1 -> V_10 = V_58 ;
F_50 ( & V_1 -> V_102 ) ;
V_30 -> V_61 = V_2 -> V_61 ;
V_30 -> V_103 = V_68 ;
V_30 -> V_104 = V_68 + V_67 - 1 ;
V_30 -> V_105 = 50 ;
V_30 -> V_106 = & V_107 ;
V_101 -> V_108 = V_109 ;
V_101 -> V_110 = V_111 ;
...
{
if ( V_113 < 1000000 || V_113 > 80000000 ) {
F_35 ( V_72 L_16 ) ;
return - V_54 ;
}
if ( V_86 != 0 && V_86 != 1 ) {
