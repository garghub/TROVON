...
char * V_49 ;
if ( V_4 -> V_18 &&
( V_4 -> V_18 -> V_60 != V_4 -> V_11 ) ) {
V_49 = F_41 ( & V_2 -> V_5 -> V_25 ) ;
if ( ! F_21 ( V_61 , & V_4 -> V_11 -> V_12 ) && V_49
&& ( V_49 [ 0 ] == 0x10 ) && ( V_49 [ 7 ] == 0x0F )
&& ( V_49 [ 8 ] == 0x67 ) ) {
F_42 ( V_4 -> V_11 ) ;
F_43 ( V_4 -> V_11 ) ;
}
if ( V_4 -> V_11 -> V_62 & V_63 ) {
F_4 ( V_64 , V_4 -> V_11 ,
L_216
L_217 , V_4 ,
F_44 ( & V_4 -> V_18 -> V_60 -> V_15 -> V_21 ) ) ;
}
F_45 ( V_4 ) ;
V_2 -> V_11 = V_4 -> V_18 -> V_60 ;
V_2 -> V_19 = F_40 ;
return V_2 ;
} else
return NULL ;
...
if ( ( V_65 == NULL ) && ( V_49 [ 0 ] & V_66 ) ) {
V_65 = F_27 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 0 ] & V_67 ) ) {
V_65 = F_11 ( V_2 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 0 ] & V_68 ) ) {
V_65 = F_28 ( V_2 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 0 ] & V_69 ) ) {
V_65 = F_29 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 0 ] & V_70 ) ) {
V_65 = F_31 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 0 ] & V_71 ) ) {
V_65 = F_34 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 1 ] & V_72 ) ) {
V_65 = F_35 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 1 ] & V_73 ) ) {
V_65 = F_36 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 2 ] & V_55 ) ) {
V_65 = F_37 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 1 ] & V_74 ) ) {
V_65 = F_38 ( V_2 , V_49 ) ;
}
if ( ( V_65 == NULL ) && ( V_49 [ 1 ] & V_75 ) ) {
V_65 = F_39 ( V_2 ) ;
}
if ( V_65 == NULL ) {
V_65 = V_2 ;
...
V_76 = V_59 -> V_5 -> V_25 . V_83 . V_84 . V_76 ;
if ( V_76 == 0 ) {
F_4 ( V_30 , V_10 , L_8 ,
L_223
L_224 ) ;
...
if ( V_82 -> V_41 == V_86 ) {
V_80 = V_4 -> V_38 ;
memcpy ( V_78 , & V_80 -> V_87 ,
sizeof( struct V_77 ) ) ;
} else
memcpy ( V_78 , V_4 -> V_38 , sizeof( struct V_77 ) ) ;
V_81 = V_2 -> V_38 + sizeof( struct V_77 ) ;
if ( ( V_49 [ 3 ] == 0x01 ) && ( V_81 [ 1 ] & 0x01 ) ) {
return F_1 ( V_59 , V_31 ) ;
}
if ( ( V_49 [ 7 ] & 0x3F ) == 0x01 ) {
V_81 [ 0 ] = 0x81 ;
...
V_81 [ 5 ] = V_49 [ 30 ] ;
V_81 [ 7 ] = V_49 [ 31 ] ;
memcpy ( & ( V_81 [ 8 ] ) , & ( V_49 [ 11 ] ) , 8 ) ;
V_35 = V_2 -> V_40 ;
memset ( V_35 , 0 , sizeof( struct V_34 ) ) ;
V_35 -> V_41 = V_88 ;
V_35 -> V_12 = V_89 ;
V_35 -> V_43 = 16 ;
V_35 -> V_44 = ( V_45 ) ( V_46 ) V_78 ;
V_35 ++ ;
memset ( V_35 , 0 , sizeof( struct V_34 ) ) ;
V_35 -> V_41 = V_90 ;
V_35 -> V_12 = V_89 ;
V_35 -> V_43 = 16 ;
V_35 -> V_44 = ( V_45 ) ( V_46 ) V_81 ;
V_35 ++ ;
V_35 -> V_41 = V_91 ;
V_35 -> V_44 = V_76 ;
V_2 -> V_12 = V_59 -> V_12 ;
...
static struct V_1 *
F_50 ( struct V_1 * V_92 , char * V_49 )
{
struct V_9 * V_10 = V_92 -> V_11 ;
V_45 V_76 = 0 ;
struct V_1 * V_4 ;
struct V_1 * V_2 ;
char * V_81 ;
...
{
if ( ( V_49 [ 24 ] & V_97 ) || ( V_49 [ 1 ] & 0x10 ) ) {
F_12 ( & V_10 -> V_15 -> V_21 , L_230
L_231 , V_49 [ 22 ] ,
V_49 [ 23 ] , V_49 [ 11 ] , V_49 [ 12 ] ) ;
} else if ( V_49 [ 24 ] & V_98 ) {
F_25 ( & V_10 -> V_15 -> V_21 , L_232
L_231 , V_49 [ 22 ] ,
V_49 [ 23 ] , V_49 [ 11 ] , V_49 [ 12 ] ) ;
}
}
...
{
struct V_9 * V_10 = V_2 -> V_11 ;
if ( F_60 ( & V_2 -> V_5 -> V_25 . V_83 ) & ( V_102
| V_103 ) ) {
F_4 ( V_30 , V_10 , L_8 ,
L_245 ) ;
V_2 = F_22 ( V_2 , NULL ) ;
...
if ( V_4 -> V_109 == 1 ) {
V_105 = 0 ;
V_106 = 64 + sizeof( struct V_107 ) + sizeof( struct V_108 ) ;
} else {
V_105 = 2 ;
V_106 = 0 ;
}
...
V_107 = V_2 -> V_40 ;
V_108 = (struct V_108 * ) & V_107 [ 1 ] ;
* V_107 = * ( (struct V_107 * ) V_4 -> V_40 ) ;
V_107 -> V_108 = ( long ) V_108 ;
} else if ( V_35 -> V_41 == V_111 ) {
V_2 -> V_40 = V_4 -> V_40 ;
} else {
V_35 = V_2 -> V_40 ;
V_35 -> V_41 = V_112 ;
...
static int F_65 ( struct V_1 * V_113 ,
struct V_1 * V_114 )
{
char * V_115 , * V_116 ;
if ( V_113 -> V_11 != V_114 -> V_11 )
return 0 ;
V_115 = F_41 ( & V_113 -> V_25 ) ;
V_116 = F_41 ( & V_114 -> V_25 ) ;
if ( ! V_115 != ! V_116 )
return 0 ;
if ( ! V_115 && ! V_116 ) {
if ( ( F_60 ( & V_113 -> V_25 . V_83 ) & ( V_102 |
V_103 ) ) ==
( F_60 ( & V_114 -> V_25 . V_83 ) & ( V_102 |
V_103 ) ) )
return 1 ;
}
if ( ! ( V_115 && V_116 &&
( memcmp ( V_115 , V_116 , 3 ) == 0 ) &&
( V_115 [ 27 ] == V_116 [ 27 ] ) &&
( V_115 [ 25 ] == V_116 [ 25 ] ) ) ) {
return 0 ;
}
...
do {
V_119 = F_65 ( V_117 , V_4 -> V_5 ) ;
V_118 = V_4 ;
V_4 = V_4 -> V_5 ;
} while ( ( V_4 -> V_5 != NULL ) && ( ! V_119 ) );
if ( ! V_119 ) {
return NULL ;
}
return V_118 ;
...
static struct V_1 *
F_68 ( struct V_1 * V_117 ,
struct V_1 * V_2 )
{
struct V_9 * V_10 = V_117 -> V_11 ;
struct V_1 * V_120 = V_117 ;
