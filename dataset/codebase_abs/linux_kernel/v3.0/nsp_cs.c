...
static int F_57 ( struct V_227 * V_12 , char * V_31 , char * * V_243 ,
T_5 V_107 , int V_35 , int V_244 )
{
int V_192 ;
char * V_245 = V_31 ;
int V_246 ;
...
SPRINTF ( L_63 , V_12 -> V_46 , V_12 -> V_46 + V_10 -> V_252 - 1 ) ;
SPRINTF ( L_64 , V_12 -> V_253 ) ;
SPRINTF ( L_65 ) ;
switch ( V_170 ) {
case V_254 :
SPRINTF ( L_66 ) ;
...
SPRINTF ( L_70 ) ;
F_58 ( & ( V_10 -> V_239 ) , V_248 ) ;
SPRINTF ( L_71 , V_10 -> V_14 ) ;
F_59 ( & ( V_10 -> V_239 ) , V_248 ) ;
SPRINTF ( L_72 ) ;
...
V_247 = 1000000 / ( V_10 -> V_45 [ V_192 ] . V_42 * 4 ) ;
SPRINTF ( L_79 ,
V_247 / 1000 ,
V_247 % 1000 ,
...
V_246 = V_245 - ( V_31 + V_107 ) ;
if( V_246 < 0 ) {
* V_243 = NULL ;
return 0 ;
}
V_246 = F_34 ( V_246 , V_35 ) ;
* V_243 = V_31 + V_107 ;
return V_246 ;
}
...
static int F_63 ( struct V_258 * V_259 )
{
V_179 * V_180 ;
T_2 * V_10 = & V_231 ;
int V_132 ;
F_12 ( V_48 , L_9 ) ;
V_180 = F_64 ( sizeof( * V_180 ) , V_260 ) ;
if ( V_180 == NULL ) { return - V_261 ; }
V_180 -> V_262 = V_259 ;
V_259 -> V_263 = V_180 ;
V_10 -> V_233 = V_180 ;
F_12 ( V_48 , L_81 , V_180 ) ;
V_132 = F_65 ( V_259 ) ;
F_12 ( V_48 , L_82 , V_259 ) ;
return V_132 ;
}
static void F_66 ( struct V_258 * V_259 )
{
F_12 ( V_48 , L_83 , V_259 ) ;
( ( V_179 * ) V_259 -> V_263 ) -> V_264 = 1 ;
F_67 ( V_259 ) ;
F_68 ( V_259 -> V_263 ) ;
V_259 -> V_263 = NULL ;
}
static int F_69 ( struct V_258 * V_262 , void * V_265 )
{
T_2 * V_10 = V_265 ;
if ( V_262 -> V_266 == 0 )
return - V_267 ;
if ( F_70 ( V_262 ) != 0 )
goto V_268;
if ( F_71 ( V_262 -> V_269 [ 2 ] ) ) {
V_262 -> V_269 [ 2 ] -> V_248 |= ( V_270 |
V_271 |
V_272 ) ;
if ( V_262 -> V_269 [ 2 ] -> V_273 < 0x1000 )
V_262 -> V_269 [ 2 ] -> V_273 = 0x1000 ;
if ( F_72 ( V_262 , V_262 -> V_269 [ 2 ] , 0 ) != 0 )
goto V_268;
if ( F_73 ( V_262 , V_262 -> V_269 [ 2 ] ,
V_262 -> V_274 ) != 0 )
goto V_268;
V_10 -> V_238 = ( unsigned long )
F_74 ( V_262 -> V_269 [ 2 ] -> V_243 ,
F_71 ( V_262 -> V_269 [ 2 ] ) ) ;
V_10 -> V_252 = F_71 ( V_262 -> V_269 [ 2 ] ) ;
}
return 0 ;
V_268:
F_12 ( V_48 , L_84 ) ;
...
{
int V_132 ;
V_179 * V_180 = V_259 -> V_263 ;
struct V_227 * V_12 ;
T_2 * V_10 = & V_231 ;
F_12 ( V_48 , L_9 ) ;
V_259 -> V_275 |= V_276 | V_277 |
V_278 | V_279 | V_280 |
V_281 ;
V_132 = F_76 ( V_259 , F_69 , V_10 ) ;
if ( V_132 )
goto V_282;
if ( F_77 ( V_259 , F_47 ) )
goto V_282;
...
if ( V_283 ) {
if ( V_259 -> V_269 [ 0 ] ) {
F_79 ( V_259 -> V_269 [ 0 ] -> V_243 ,
F_71 ( V_259 -> V_269 [ 0 ] ) ) ;
}
if ( V_259 -> V_269 [ 1 ] ) {
F_79 ( V_259 -> V_269 [ 1 ] -> V_243 ,
F_71 ( V_259 -> V_269 [ 1 ] ) ) ;
}
}
V_10 -> V_47 = V_259 -> V_269 [ 0 ] -> V_243 ;
V_10 -> V_237 = F_71 ( V_259 -> V_269 [ 0 ] ) ;
V_10 -> V_234 = V_259 -> V_173 ;
F_12 ( V_48 , L_85 ,
...
static void F_67 ( struct V_258 * V_259 )
{
V_179 * V_180 = V_259 -> V_263 ;
T_2 * V_10 = NULL ;
if ( V_180 -> V_12 == NULL ) {
...
static int F_85 ( struct V_258 * V_259 )
{
V_179 * V_180 = V_259 -> V_263 ;
T_2 * V_10 ;
F_12 ( V_48 , L_89 ) ;
...
static int F_86 ( struct V_258 * V_259 )
{
V_179 * V_180 = V_259 -> V_263 ;
T_2 * V_10 ;
F_12 ( V_48 , L_91 ) ;
