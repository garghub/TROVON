...
if ( ! V_2 )
return - V_100 ;
if ( ! F_48 ( V_93 -> V_101 , F_49 ( V_93 ) , V_89 -> V_102 ) ) {
F_28 ( & V_89 -> V_31 , L_21 ) ;
V_94 = - V_61 ;
goto V_103;
}
V_2 -> V_5 = F_50 ( V_93 -> V_101 , F_49 ( V_93 ) ) ;
if ( ! V_2 -> V_5 ) {
F_28 ( & V_89 -> V_31 , L_22 ) ;
V_94 = - V_84 ;
goto V_104;
...
F_53 ( & V_2 -> V_75 ) ;
F_54 ( & V_2 -> V_49 ) ;
V_94 = F_55 ( V_73 , F_34 , 0 , V_89 -> V_102 , V_2 ) ;
if ( V_94 ) {
F_28 ( & V_89 -> V_31 , L_23 ) ;
goto V_106;
}
