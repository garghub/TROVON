...
int V_72 ;
unsigned int V_73 = 0 ;
V_72 = F_44 ( V_68 -> V_74 . V_75 -> V_76 ) ;
F_47 ( V_68 , & V_9 [ V_72 ] . V_11 , V_46 ) ;
F_47 ( V_68 , & V_9 [ V_72 ] . V_10 , V_46 ) ;
if ( V_13 == NULL )
return 0 ;
if ( F_32 ( V_72 , 0 ) )
V_73 |= V_77 | V_78 ;
...
static T_3 F_48 ( struct V_68 * V_68 , char T_4 * V_65 , T_5 V_59 ,
T_7 * V_81 )
{
int V_72 = F_44 ( V_68 -> V_74 . V_75 -> V_76 ) ;
if ( ! F_32 ( V_72 , ( V_68 -> V_70 & V_71 ) ? 0 : 1 ) ) {
return 0 ;
}
return F_35 ( V_72 , V_65 , V_59 ) ;
}
static T_3 F_49 ( struct V_68 * V_68 , const char T_4 * V_65 ,
T_5 V_59 , T_7 * V_81 )
{
int V_72 ;
struct V_16 * V_66 ;
...
F_53 ( & V_9 [ V_7 ] . V_42 , 0 ) ;
F_54 ( & V_9 [ V_7 ] . V_63 ) ;
V_84 = F_55 ( V_92 , NULL , F_56 ( V_88 , V_7 ) , NULL ,
L_21 , V_89 , V_7 ) ;
if ( F_57 ( V_84 ) ) {
V_85 = F_58 ( V_84 ) ;
goto V_93;
