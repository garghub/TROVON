...
static int T_6 F_120 ( struct V_248 * V_15 )
{
struct V_60 * V_51 ;
struct V_1 * V_2 ;
int V_13 = 0 ;
...
if ( V_13 < 0 ) {
if ( F_127 ( V_2 ) )
F_66 ( & V_15 -> V_51 , V_219 L_106
L_107 , V_15 -> V_216 , V_13 ) ;
goto V_254;
}
V_51 -> V_255 = V_256 ;
...
if ( V_13 ) {
if ( F_127 ( V_2 ) )
F_66 ( & V_15 -> V_51 , L_108 V_219
L_109 , V_13 ) ;
goto V_262;
}
F_78 ( & V_51 -> V_51 , V_219 L_110 ) ;
return 0 ;
V_262:
...
static int T_7 F_134 ( struct V_248 * V_15 )
{
struct V_1 * V_2 = F_135 ( & V_15 -> V_51 ) ;
if ( F_5 ( V_2 ) )
F_6 (KERN_DEBUG DRV_NAME L_111 ) ;
F_136 ( V_2 -> V_202 ) ;
F_132 ( V_15 -> V_216 , V_2 ) ;
F_133 ( V_2 -> V_202 ) ;
return 0 ;
