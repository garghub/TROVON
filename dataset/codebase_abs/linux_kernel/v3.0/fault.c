...
F_50 ( & V_8 -> V_69 ) ;
F_51 ( V_71 , 1 , 0 , V_5 , V_9 ) ;
if ( V_54 & V_64 )
F_51 ( V_72 , 1 , 0 , V_5 , V_9 ) ;
else if ( V_54 & V_73 )
F_51 ( V_74 , 1 , 0 , V_5 , V_9 ) ;
if ( F_52 ( ! ( V_54 & ( V_63 | V_55 | V_60 ) ) ) )
return 0 ;
if ( V_54 & V_75 ) {
F_53 () ;
return 0 ;
...
static int T_5
F_54 ( unsigned long V_9 , unsigned int V_1 ,
struct V_4 * V_5 )
{
unsigned int V_80 ;
T_1 * V_10 , * V_81 ;
...
static int
F_62 ( unsigned long V_9 , unsigned int V_1 , struct V_4 * V_5 )
{
F_36 ( V_9 , V_1 , V_5 ) ;
return 0 ;
}
static int
F_63 ( unsigned long V_9 , unsigned int V_1 , struct V_4 * V_5 )
{
return 1 ;
}
void T_6
F_64 ( int V_87 , int (* F_65)( unsigned long , unsigned int , struct V_4 * ) ,
int V_24 , int V_25 , const char * V_88 )
{
if ( V_87 < 0 || V_87 >= F_66 ( V_89 ) )
F_67 () ;
V_89 [ V_87 ] . F_65 = F_65 ;
V_89 [ V_87 ] . V_24 = V_24 ;
V_89 [ V_87 ] . V_25 = V_25 ;
...
T_7 void T_8
F_68 ( unsigned long V_9 , unsigned int V_1 , struct V_4 * V_5 )
{
const struct V_89 * V_90 = V_89 + F_1 ( V_1 ) ;
struct V_26 V_91 ;
if ( ! V_90 -> F_65 ( V_9 , V_1 & ~ V_52 , V_5 ) )
return;
F_9 ( V_12 L_14 ,
V_90 -> V_88 , V_1 , V_9 ) ;
V_91 . V_36 = V_90 -> V_24 ;
...
F_69 ( L_15 , V_5 , & V_91 , V_1 , 0 ) ;
}
void T_6
F_70 ( int V_87 , int (* F_65)( unsigned long , unsigned int , struct V_4 * ) ,
int V_24 , int V_25 , const char * V_88 )
{
if ( V_87 < 0 || V_87 >= F_66 ( V_92 ) )
F_67 () ;
V_92 [ V_87 ] . F_65 = F_65 ;
V_92 [ V_87 ] . V_24 = V_24 ;
V_92 [ V_87 ] . V_25 = V_25 ;
...
T_7 void T_8
F_71 ( unsigned long V_9 , unsigned int V_93 , struct V_4 * V_5 )
{
const struct V_89 * V_90 = V_92 + F_1 ( V_93 ) ;
struct V_26 V_91 ;
if ( ! V_90 -> F_65 ( V_9 , V_93 | V_52 , V_5 ) )
return;
F_9 ( V_12 L_16 ,
V_90 -> V_88 , V_93 , V_9 ) ;
V_91 . V_36 = V_90 -> V_24 ;
...
V_91 . V_38 = V_90 -> V_25 ;
V_91 . V_39 = ( void V_40 * ) V_9 ;
F_69 ( L_15 , V_5 , & V_91 , V_93 , 0 ) ;
}
static int T_6 F_72 ( void )
{
if ( F_73 () >= V_94 ) {
F_64 ( 4 , F_54 , V_43 , V_44 ,
L_17 ) ;
}
if ( F_73 () >= V_95 ) {
F_64 ( 3 , F_63 , V_43 , V_44 ,
L_18 ) ;
F_64 ( 6 , F_63 , V_43 , V_44 ,
L_18 ) ;
}
return 0 ;
}
