...
{
return V_29 -> V_50 . V_51 && V_29 -> V_50 . V_51 -> V_129 &&
V_29 -> V_127 . V_130 && V_29 -> V_127 . V_130 -> V_129 ;
}
int F_49 ( struct V_28 * V_29 , unsigned long V_131 )
{
struct V_132 * V_133 = NULL ;
int V_54 ;
unsigned long V_134 = V_29 -> V_39 -> V_88 * V_135 ;
if ( V_29 -> V_125 == NULL ) {
if ( F_50 ( V_29 , V_136 ) )
V_133 = & V_29 -> V_39 -> V_100 ;
V_29 -> V_125 = F_51 ( V_133 ,
V_29 -> V_121 ,
V_29 -> V_123 ) ;
if ( F_20 ( V_29 -> V_125 ) ) {
V_29 -> V_125 = NULL ;
return F_21 ( V_29 -> V_125 ) ;
}
V_29 -> V_125 -> V_137 = F_50 ( V_29 , V_138 ) ;
}
V_54 = F_52 ( & V_29 -> V_50 ) ;
if ( V_54 < 0 )
return V_54 ;
while ( ! F_48 ( V_29 ) ) {
V_54 = - V_139 ;
if ( V_134 && F_53 ( V_140 , V_131 + V_134 ) )
return V_54 ;
F_14 ( L_47 ) ;
V_54 = F_54 ( V_29 -> V_118 ,
F_48 ( V_29 ) || ( V_29 -> V_119 < 0 ) ,
V_134 ) ;
if ( V_54 == - V_141 || V_54 == - V_142 )
return V_54 ;
if ( V_29 -> V_119 < 0 )
return V_29 -> V_119 ;
}
...
{
int V_43 ;
unsigned long V_131 = V_140 ;
F_14 ( L_48 ) ;
F_56 ( & V_29 -> V_117 ) ;
V_43 = F_49 ( V_29 , V_131 ) ;
F_57 ( & V_29 -> V_117 ) ;
return V_43 ;
}
