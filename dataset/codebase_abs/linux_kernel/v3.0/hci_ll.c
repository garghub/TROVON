...
struct V_7 * V_8 = V_3 -> V_9 ;
F_2 ( L_10 , V_3 , V_6 ) ;
memcpy ( F_25 ( V_6 , 1 ) , & F_26 ( V_6 ) -> V_28 , 1 ) ;
F_19 ( & V_8 -> V_19 , V_23 ) ;
switch ( V_8 -> V_20 ) {
case V_21 :
F_2 ( L_11 ) ;
...
static inline int F_27 ( struct V_7 * V_8 , int V_30 )
{
register int V_31 = F_28 ( V_8 -> V_22 ) ;
F_2 ( L_16 , V_30 , V_31 ) ;
if ( ! V_30 ) {
F_29 ( V_8 -> V_22 ) ;
} else if ( V_30 > V_31 ) {
...
static int F_30 ( struct V_2 * V_3 , void * V_36 , int V_37 )
{
struct V_7 * V_8 = V_3 -> V_9 ;
register char * V_38 ;
struct V_39 * V_40 ;
...
V_8 -> V_22 -> V_15 = ( void * ) V_3 -> V_16 ;
F_26 ( V_8 -> V_22 ) -> V_28 = type ;
}
return V_37 ;
}
