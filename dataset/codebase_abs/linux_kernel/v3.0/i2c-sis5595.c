...
int * V_10 ;
int V_11 = - V_12 ;
for ( V_10 = V_13 ; * V_10 != 0 ; V_10 ++ ) {
struct V_6 * V_14 ;
V_14 = F_6 ( V_15 , * V_10 , NULL ) ;
if ( V_14 ) {
F_7 ( & V_7 -> V_14 , L_1 , * V_10 ) ;
F_8 ( V_14 ) ;
return - V_12 ;
}
}
...
if ( V_25 != 0x00 ) {
F_10 ( & V_24 -> V_14 , L_9 , V_25 ) ;
F_4 ( V_28 , V_25 & 0xff ) ;
F_4 ( V_29 , V_25 >> 8 ) ;
if ( ( V_25 = F_1 ( V_28 ) + ( F_1 ( V_29 ) << 8 ) ) != 0x00 ) {
F_10 ( & V_24 -> V_14 , L_10 , V_25 ) ;
return - V_30 ;
} else {
F_10 ( & V_24 -> V_14 , L_11 ) ;
}
...
static int T_2 F_23 ( struct V_6 * V_14 , const struct V_66 * V_67 )
{
int V_68 ;
if ( F_5 ( V_14 ) ) {
F_7 ( & V_14 -> V_14 , L_18 ) ;
