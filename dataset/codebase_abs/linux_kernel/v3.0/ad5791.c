...
struct V_29 * V_30 ;
int V_10 , V_62 = 0 , V_63 = 0 ;
V_30 = F_28 ( sizeof( * V_30 ) , V_64 ) ;
if ( V_30 == NULL ) {
V_10 = - V_65 ;
goto V_66;
}
F_29 ( V_2 , V_30 ) ;
V_30 -> V_67 = F_30 ( & V_2 -> V_23 , L_6 ) ;
if ( ! F_31 ( V_30 -> V_67 ) ) {
V_10 = F_32 ( V_30 -> V_67 ) ;
if ( V_10 )
goto V_68;
...
if ( ! F_31 ( V_30 -> V_69 ) && ! F_31 ( V_30 -> V_67 ) )
V_30 -> V_49 = ( V_62 - V_63 ) / 1000 ;
else if ( V_60 )
...
V_30 -> V_34 =
& V_76 [ F_24 ( V_2 ) -> V_77 ] ;
V_30 -> V_44 = F_35 ( V_30 -> V_34 -> V_78 ( V_30 -> V_49 ) )
...
V_30 -> V_28 -> V_23 . V_82 = & V_2 -> V_23 ;
V_30 -> V_28 -> V_83 = ( void * ) ( V_30 ) ;
V_30 -> V_28 -> V_84 = & V_85 ;
V_30 -> V_28 -> V_86 = V_87 ;
V_10 = F_37 ( V_30 -> V_28 ) ;
if ( V_10 )
