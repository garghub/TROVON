...
{
struct V_39 * V_40 ;
while ( ( V_40 = F_75 ( & V_36 -> V_47 ) ) &&
( V_36 -> V_45 & V_58 ) )
F_72 ( V_40 , V_36 -> V_32 ) ;
}
void F_76 ( struct V_35 * V_36 , struct V_37 * V_46 )
{
F_14 ( & V_36 -> V_57 ) ;
F_23 ( V_36 , V_46 ) ;
V_36 -> V_99 = 0xffff ;
...
static void F_78 ( struct V_19 * V_20 , bool V_17 )
{
struct V_35 * V_36 ;
struct V_55 * V_56 = F_79 ( V_20 , struct V_55 , V_86 ) ;
V_36 = V_56 -> V_36 ;
F_69 ( V_20 ) ;
if ( V_17 ) {
F_68 ( & V_36 -> V_79 ) ;
...
static int F_80 ( struct V_19 * V_20 , struct V_1 * V_7 )
{
struct V_35 * V_36 ;
struct V_55 * V_56 , * V_68 ;
T_1 V_71 ;
...
if ( V_68 == NULL )
return - V_29 ;
V_56 = F_79 ( V_20 , struct V_55 , V_86 ) ;
V_36 = V_56 -> V_36 ;
V_68 -> V_36 = V_36 ;
