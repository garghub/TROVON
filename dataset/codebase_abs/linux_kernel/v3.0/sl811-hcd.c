...
{
return F_95 ( V_224 , F_90 , F_96 ( V_223 ) -> V_225 ) ;
}
static void F_86 ( struct V_1 * V_1 )
{
V_1 -> V_226 = F_97 ( V_227 , 0 , NULL , & V_228 , V_1 ) ;
}
...
F_103 ( V_4 -> V_15 . V_16 ,
V_1 -> V_14 -> V_231 ) ;
V_4 -> V_232 = V_1 -> V_14 -> V_233 * 2 ;
}
F_1 ( V_1 , 1 ) ;
return 0 ;
}
static int T_6
F_104 ( struct V_234 * V_45 )
{
...
F_87 ( V_1 ) ;
F_106 ( V_4 ) ;
V_236 = F_107 ( V_45 , V_237 , 1 ) ;
if ( V_236 )
F_108 ( V_1 -> V_29 ) ;
V_236 = F_107 ( V_45 , V_237 , 0 ) ;
if ( V_236 )
F_108 ( V_1 -> V_238 ) ;
F_109 ( V_4 ) ;
return 0 ;
...
static int T_7
F_110 ( struct V_234 * V_45 )
{
struct V_3 * V_4 ;
struct V_1 * V_1 ;
struct V_235 * V_27 , * V_225 , * V_239 ;
int V_240 ;
void T_2 * V_238 ;
void T_2 * V_29 ;
int V_142 ;
...
V_27 = F_107 ( V_45 , V_237 , 0 ) ;
V_225 = F_107 ( V_45 , V_237 , 1 ) ;
V_142 = - V_248 ;
if ( ! V_27 || ! V_225 ) {
V_27 = F_107 ( V_45 , V_249 , 0 ) ;
V_225 = F_107 ( V_45 , V_249 , 1 ) ;
if ( ! V_27 || ! V_225 )
return - V_147 ;
V_242 = 1 ;
V_238 = ( void T_2 * ) ( unsigned long ) V_27 -> F_22 ;
V_29 = ( void T_2 * ) ( unsigned long ) V_225 -> F_22 ;
} else {
V_238 = F_111 ( V_27 -> F_22 , 1 ) ;
if ( V_238 == NULL ) {
V_142 = - V_146 ;
goto V_250;
}
V_29 = F_111 ( V_225 -> F_22 , 1 ) ;
if ( V_29 == NULL ) {
V_142 = - V_146 ;
goto V_251;
}
}
V_4 = F_112 ( & V_252 , & V_45 -> V_45 , F_113 ( & V_45 -> V_45 ) ) ;
if ( ! V_4 ) {
V_142 = - V_146 ;
goto V_253;
}
...
V_1 -> V_161 . V_225 = ( unsigned long ) V_1 ;
V_1 -> V_238 = V_238 ;
V_1 -> V_29 = V_29 ;
F_91 ( & V_1 -> V_82 ) ;
F_1 ( V_1 , 0 ) ;
...
V_243 |= V_260 ;
V_142 = F_116 ( V_4 , V_240 , V_261 | V_243 ) ;
if ( V_142 != 0 )
goto V_259;
F_86 ( V_1 ) ;
return V_142 ;
...
static int
F_117 ( struct V_234 * V_45 , T_8 V_9 )
{
struct V_3 * V_4 = F_105 ( V_45 ) ;
struct V_1 * V_1 = F_47 ( V_4 ) ;
int V_142 = 0 ;
...
static int
F_118 ( struct V_234 * V_45 )
{
struct V_3 * V_4 = F_105 ( V_45 ) ;
struct V_1 * V_1 = F_47 ( V_4 ) ;
if ( ! V_1 -> V_5 || ! F_102 ( & V_4 -> V_15 . V_267 -> V_45 ) ) {
V_1 -> V_5 = 0 ;
F_1 ( V_1 , 1 ) ;
F_119 ( V_4 -> V_15 . V_267 ) ;
return 0 ;
}
return F_85 ( V_4 ) ;
}
