...
static void F_83 ( struct V_10 * V_10 , unsigned long V_12 )
{
F_26 ( V_12 ) ;
F_26 ( F_71 ( V_10 ) ) ;
F_81 ( V_10 , 0 ) ;
...
if ( V_99 )
V_20 = F_69 ( V_41 -> V_49 ) -> V_106 -> V_107 ;
else {
...
void F_104 ( struct V_41 * V_114 , T_4 V_115 , int V_43 )
{
T_3 V_42 ;
int V_101 = V_77 - V_114 -> V_22 ;
int V_116 = 1 << V_101 ;
struct V_103 * V_20 =
F_69 ( V_114 -> V_49 ) -> V_106 -> V_107 ;
struct V_1 * V_2 ;
struct V_10 * V_10 ;
unsigned int V_12 ;
for ( V_42 = V_115 & ~ ( V_116 - 1 ) ; V_42 < V_115 + V_43 ;
V_42 += V_116 ) {
V_10 = F_105 ( V_20 , V_42 >> V_101 ) ;
if ( ! V_10 )
continue;
for ( V_12 = 0 ; V_12 < V_61 ; V_12 += V_62 ) {
V_2 = F_17 ( V_10 , V_12 ) ;
...
static int F_106 ( struct V_117 * V_118 , void * V_119 )
{
F_107 ( V_118 ,
L_23
L_24
