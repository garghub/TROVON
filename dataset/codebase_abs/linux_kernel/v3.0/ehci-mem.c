...
static inline struct V_14 * F_16 ( struct V_14 * V_15 )
{
F_17 ( ! V_15 -> V_26 ) ;
V_15 -> V_26 ++ ;
return V_15 ;
...
static int F_24 ( struct V_1 * V_2 , T_2 V_12 )
{
int V_38 ;
V_2 -> V_13 = F_25 ( L_3 ,
F_23 ( V_2 ) -> V_32 . V_33 ,
...
V_2 -> V_31 [ V_38 ] = V_2 -> V_18 -> V_21 ;
} else {
for ( V_38 = 0 ; V_38 < V_2 -> V_34 ; V_38 ++ )
V_2 -> V_31 [ V_38 ] = F_3 ( V_2 ) ;
}
V_2 -> V_37 = F_27 ( V_2 -> V_34 , sizeof( void * ) , V_12 ) ;
if ( V_2 -> V_37 != NULL )
return 0 ;
V_25:
F_11 ( V_2 , L_7 ) ;
