...
struct V_85 * V_86 )
{
strncpy ( V_86 -> V_87 , V_88 , 32 ) ;
strncpy ( V_86 -> V_89 , V_90 , 32 ) ;
strncpy ( V_86 -> V_91 , L_5 , 32 ) ;
strncpy ( V_86 -> V_92 , L_6 , 32 ) ;
V_86 -> V_93 = 0 ;
V_86 -> V_94 = F_13 ( V_2 ) ;
}
static void F_24 ( struct V_1 * V_2 , struct V_95 * V_96 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
if ( V_8 && V_8 -> V_97 )
...
static int F_26 ( struct V_1 * V_2 , struct V_95 * V_96 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
...
return - V_57 ;
else if ( V_96 -> V_101 & V_100 && ! F_25 () )
return - V_57 ;
V_6 -> V_102 = V_96 -> V_101 ;
F_27 ( & V_2 -> V_103 , V_6 -> V_102 ) ;
return 0 ;
}
