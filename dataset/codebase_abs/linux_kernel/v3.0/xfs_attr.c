...
if ( error )
goto V_66;
if ( ( error = F_65 ( & V_51 , V_22 , 0LL , V_24 ,
( ! ( V_33 -> V_62 & V_63 )
? 1 : 0 ) ) ) )
goto V_66;
F_42 ( V_51 , V_22 , V_67 ) ;
...
ASSERT ( V_113 != NULL ) ;
V_122 = V_113 -> V_123 ;
if ( F_85 ( F_86 ( V_122 -> V_124 . V_125 . V_126 ) != V_127 ) ) {
F_87 ( L_1 , V_128 ,
...
if ( V_113 ) {
V_145 = V_113 -> V_123 ;
switch ( F_86 ( V_145 -> V_124 . V_125 . V_126 ) ) {
case V_147 :
F_99 ( V_76 ) ;
F_72 ( NULL , V_113 ) ;
V_113 = NULL ;
...
case V_127 :
V_122 = V_113 -> V_123 ;
if ( V_97 -> V_21 > F_100 ( V_122 -> V_148 [
F_86 ( V_122 -> V_124 . V_83 ) - 1 ] . V_21 ) ) {
F_99 ( V_76 ) ;
F_72 ( NULL , V_113 ) ;
V_113 = NULL ;
} else if ( V_97 -> V_21 <=
F_100 ( V_122 -> V_148 [ 0 ] . V_21 ) ) {
F_99 ( V_76 ) ;
F_72 ( NULL , V_113 ) ;
V_113 = NULL ;
}
...
V_145 = V_113 -> V_123 ;
if ( F_86 ( V_145 -> V_124 . V_125 . V_126 )
== V_127 )
break;
if ( F_85 ( F_86 ( V_145 -> V_124 . V_125 . V_126 )
!= V_147 ) ) {
F_87 ( L_3 ,
V_128 ,
V_76 -> V_22 -> V_28 ,
...
V_146 = V_145 -> V_146 ;
for ( V_144 = 0 ; V_144 < F_86 ( V_145 -> V_124 . V_83 ) ;
V_146 ++ , V_144 ++ ) {
if ( V_97 -> V_21
<= F_100 ( V_146 -> V_21 ) ) {
V_97 -> V_101 = F_100 ( V_146 -> V_149 ) ;
F_102 ( V_76 ,
V_146 ) ;
break;
}
}
if ( V_144 == F_86 ( V_145 -> V_124 . V_83 ) ) {
F_72 ( NULL , V_113 ) ;
return ( 0 ) ;
}
F_72 ( NULL , V_113 ) ;
...
for (; ; ) {
V_122 = V_113 -> V_123 ;
if ( F_85 ( F_86 ( V_122 -> V_124 . V_125 . V_126 )
!= V_127 ) ) {
F_87 ( L_4 ,
V_128 ,
V_76 -> V_22 -> V_28 , V_122 ) ;
...
break;
V_97 -> V_101 = F_100 ( V_122 -> V_124 . V_125 . V_150 ) ;
F_72 ( NULL , V_113 ) ;
error = F_70 ( NULL , V_76 -> V_22 , V_97 -> V_101 , - 1 ,
& V_113 , V_24 ) ;
if ( error )
...
while ( V_20 > 0 ) {
V_155 = V_152 ;
error = F_103 ( args -> V_51 , args -> V_22 , ( V_159 ) V_158 ,
args -> V_121 ,
V_160 | V_161 ,
NULL , 0 , V_151 , & V_155 , NULL ) ;
if ( error )
return ( error ) ;
ASSERT ( V_155 >= 1 ) ;
for ( V_144 = 0 ; ( V_144 < V_155 ) && ( V_20 > 0 ) ; V_144 ++ ) {
ASSERT ( ( V_151 [ V_144 ] . V_162 != V_163 ) &&
( V_151 [ V_144 ] . V_162 != V_164 ) ) ;
V_153 = F_104 ( V_33 , V_151 [ V_144 ] . V_162 ) ;
V_157 = F_105 ( V_33 , V_151 [ V_144 ] . V_165 ) ;
error = F_106 ( V_33 , V_33 -> V_166 , V_153 ,
V_157 , V_167 | V_168 ,
& V_113 ) ;
if ( error )
return ( error ) ;
V_156 = ( V_20 < F_107 ( V_113 ) )
? V_20 : F_107 ( V_113 ) ;
F_108 ( V_113 , 0 , V_156 , V_154 , V_169 ) ;
F_109 ( V_113 ) ;
V_154 += V_156 ;
V_20 -= V_156 ;
V_158 += V_151 [ V_144 ] . V_165 ;
}
}
ASSERT ( V_20 == 0 ) ;
return ( 0 ) ;
...
V_170 = 0 ;
error = F_110 ( args -> V_51 , args -> V_22 , V_157 , & V_170 ,
V_24 ) ;
if ( error ) {
return ( error ) ;
}
args -> V_119 = V_158 = ( T_21 ) V_170 ;
args -> V_121 = V_157 ;
while ( V_157 > 0 ) {
F_35 ( args -> V_40 , args -> V_39 ) ;
V_155 = 1 ;
error = F_103 ( args -> V_51 , V_22 , ( V_159 ) V_158 ,
V_157 ,
V_160 | V_161 |
V_172 ,
...
F_35 ( args -> V_40 , args -> V_39 ) ;
V_155 = 1 ;
error = F_103 ( NULL , V_22 , ( V_159 ) V_158 ,
args -> V_121 ,
V_160 | V_161 ,
args -> V_39 , 0 , & V_151 , & V_155 ,
NULL ) ;
if ( error ) {
return ( error ) ;
}
...
ASSERT ( ( V_151 . V_162 != V_163 ) &&
( V_151 . V_162 != V_164 ) ) ;
V_153 = F_104 ( V_33 , V_151 . V_162 ) ,
V_157 = F_105 ( V_33 , V_151 . V_165 ) ;
V_113 = F_111 ( V_33 -> V_166 , V_153 , V_157 ,
V_167 | V_168 ) ;
ASSERT ( V_113 ) ;
ASSERT ( ! F_112 ( V_113 ) ) ;
V_156 = ( V_20 < F_107 ( V_113 ) ) ? V_20 :
F_107 ( V_113 ) ;
F_108 ( V_113 , 0 , V_156 , V_171 , V_173 ) ;
if ( V_156 < F_107 ( V_113 ) )
F_113 ( V_113 , V_156 , F_107 ( V_113 ) - V_156 ) ;
if ( ( error = F_114 ( V_33 , V_113 ) ) ) {
return ( error ) ;
}
V_171 += V_156 ;
V_20 -= V_156 ;
...
F_35 ( args -> V_40 , args -> V_39 ) ;
V_155 = 1 ;
error = F_103 ( NULL , args -> V_22 , ( V_159 ) V_158 ,
args -> V_121 ,
V_160 | V_161 ,
args -> V_39 , 0 , & V_151 , & V_155 ,
args -> V_40 ) ;
...
V_153 = F_104 ( V_33 , V_151 . V_162 ) ,
V_157 = F_105 ( V_33 , V_151 . V_165 ) ;
V_113 = F_115 ( V_33 -> V_166 , V_153 , V_157 , V_175 ) ;
if ( V_113 ) {
F_116 ( V_113 ) ;
F_117 ( V_113 ) ;
F_109 ( V_113 ) ;
