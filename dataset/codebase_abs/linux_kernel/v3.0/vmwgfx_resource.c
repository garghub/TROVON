...
V_61 -> V_62 [ 0 ] . V_83 == 64 &&
V_61 -> V_77 == V_102 ) {
V_61 -> V_63 . V_64 = F_31 ( 64 * 64 * 4 , V_24 ) ;
if ( V_61 -> V_63 . V_64 ) {
memset ( V_61 -> V_63 . V_64 , 0x00 , 64 * 64 * 4 ) ;
} else {
F_24 ( L_5 ) ;
V_21 = - V_25 ;
goto V_101;
...
int F_53 ( struct V_40 * V_41 , void * V_42 ,
struct V_43 * V_44 )
{
union V_105 * V_46 =
(union V_105 * ) V_42 ;
...
V_86 = F_1 ( V_4 , struct V_85 , V_4 ) ;
V_61 = & V_86 -> V_61 ;
V_21 = F_54 ( V_48 , & V_86 -> V_4 , V_55 , NULL ) ;
if ( F_14 ( V_21 != 0 ) ) {
F_24 ( L_8 ) ;
goto V_106;
}
...
static T_7 F_57 ( struct V_108 * V_109 ,
unsigned long V_110 )
{
static T_7 V_111 = ~ 0 ;
T_7 V_112 =
...
F_57 ( V_122 -> V_109 ,
( V_31 + V_113 - 1 ) >> V_124 ) ;
V_21 = F_63 ( V_116 , V_117 , false , false ) ;
if ( F_14 ( V_21 != 0 ) ) {
F_62 ( & V_6 -> V_4 ) ;
return V_21 ;
}
...
int F_69 ( struct V_40 * V_41 , void * V_42 ,
struct V_43 * V_44 )
{
struct V_11 * V_12 = F_35 ( V_41 ) ;
union V_128 * V_46 =
...
V_21 = F_61 ( V_12 , & V_127 -> V_7 , V_93 -> V_31 ,
& V_135 , true ,
& F_66 ) ;
if ( F_14 ( V_21 != 0 ) )
goto V_136;
