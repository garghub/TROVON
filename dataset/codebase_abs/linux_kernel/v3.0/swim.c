...
static int T_4 F_53 ( struct V_135 * V_55 ,
enum V_23 V_24 )
{
...
static int T_4 F_54 ( struct V_135 * V_55 )
{
int V_75 ;
int V_136 ;
struct V_1 T_1 * V_2 = V_55 -> V_2 ;
...
V_55 -> V_144 = F_57 ( F_34 , & V_55 -> V_145 ) ;
if ( ! V_55 -> V_144 ) {
V_75 = - V_142 ;
goto V_143;
}
...
V_55 -> V_138 [ V_136 ] . V_113 -> V_144 = V_55 -> V_144 ;
F_58 ( V_55 -> V_138 [ V_136 ] . V_113 , 2880 ) ;
F_59 ( V_55 -> V_138 [ V_136 ] . V_113 ) ;
}
F_60 ( F_61 ( V_141 , 0 ) , 256 , V_152 ,
F_51 , NULL , V_55 ) ;
return 0 ;
V_143:
F_62 ( V_141 , L_3 ) ;
while ( V_136 -- )
F_63 ( V_55 -> V_138 [ V_136 ] . V_113 ) ;
return V_75 ;
}
static int T_4 F_64 ( struct V_153 * V_132 )
{
struct V_154 * V_155 ;
struct V_1 T_1 * V_156 ;
struct V_135 * V_55 ;
int V_56 ;
V_155 = F_65 ( V_132 , V_157 , 0 ) ;
if ( ! V_155 ) {
V_56 = - V_158 ;
goto V_106;
}
if ( ! F_66 ( V_155 -> V_159 , F_67 ( V_155 ) , V_160 ) ) {
V_56 = - V_100 ;
goto V_106;
}
V_156 = F_68 ( V_155 -> V_159 , F_67 ( V_155 ) ) ;
if ( ! V_156 ) {
return - V_142 ;
goto V_161;
}
...
V_55 = F_69 ( sizeof( struct V_135 ) , V_164 ) ;
if ( ! V_55 ) {
V_56 = - V_142 ;
goto V_163;
}
...
F_72 ( V_156 ) ;
V_161:
F_73 ( V_155 -> V_159 , F_67 ( V_155 ) ) ;
V_106:
return V_56 ;
}
static int T_5 F_74 ( struct V_153 * V_132 )
{
struct V_135 * V_55 = F_75 ( V_132 ) ;
int V_136 ;
struct V_154 * V_155 ;
F_76 ( F_61 ( V_141 , 0 ) , 256 ) ;
for ( V_136 = 0 ; V_136 < V_55 -> V_137 ; V_136 ++ ) {
F_77 ( V_55 -> V_138 [ V_136 ] . V_113 ) ;
F_63 ( V_55 -> V_138 [ V_136 ] . V_113 ) ;
}
F_62 ( V_141 , L_3 ) ;
F_78 ( V_55 -> V_144 ) ;
