...
static void F_29 ( T_7 * V_82 , T_1 V_83 , T_1 V_84 , T_1 V_85 , T_1 V_71 )
{
V_82 -> V_83 = V_83 ;
V_82 -> V_86 = ( T_1 ) V_87 ;
V_82 -> V_88 = 0 ;
...
static int F_30 ( T_6 * V_21 , const struct V_93 * V_94 )
{
T_2 * V_95 = & V_5 ;
T_7 V_96 , V_97 ;
...
F_29 ( & V_96 ,
V_83 ,
V_84 , V_85 , V_101 | V_71 ) ;
V_95 -> V_102 = F_32 ( & V_96 ) ;
F_29 ( & V_96 ,
V_83 ,
V_84 , V_85 , V_103 | V_71 ) ;
V_95 -> V_104 = F_32 ( & V_96 ) ;
F_29 ( & V_97 ,
( T_1 ) V_105 ,
V_84 , V_85 , V_106 ) ;
V_95 -> V_107 = F_32 ( & V_97 ) ;
V_95 -> V_15 = F_33 ( V_95 -> V_107 ,
V_95 -> V_102 ,
F_27 ,
( void * ) V_95 ) ;
V_95 -> V_8 = F_33 ( V_95 -> V_104 ,
V_95 -> V_107 ,
F_28 ,
( void * ) V_95 ) ;
V_95 -> V_108 = ( void * ) F_34 ( V_95 -> V_15 ,
V_109 ) ;
V_95 -> V_110 = ( void * ) F_34 ( V_95 -> V_8 ,
V_109 ) ;
( void ) F_35 ( V_21 ) ;
F_36 ( V_95 -> V_15 ) ;
F_36 ( V_95 -> V_8 ) ;
...
static void F_37 ( struct V_111 * V_112 , T_2 * V_4 )
{
int V_63 ;
unsigned long * V_113 = V_112 -> V_114 ;
for ( V_63 = 0 ; V_63 < 8 ; V_63 ++ )
* V_113 ++ = V_4 -> V_115 + ( V_63 << V_116 ) ;
* V_113 = V_4 -> V_115 + ( 14 << V_116 ) ;
}
static int F_38 ( struct V_117 * V_82 )
{
T_2 * V_4 = & V_5 ;
struct V_118 * V_119 ;
struct V_120 * V_121 ;
int V_122 = 0 ;
struct V_111 V_112 , * V_123 [] = { & V_112 } ;
#if F_39 ( F_15 )
char * V_124 = L_4 ;
#elif F_39 ( V_125 )
char * V_124 = L_5 ;
...
V_4 -> V_80 = F_40 ( V_82 , 0 ) ;
V_119 = F_41 ( V_82 , V_126 , 0 ) ;
if ( V_119 == NULL ) {
F_42 ( L_6 , V_127 , V_82 -> V_128 ) ;
V_122 = - V_129 ;
goto V_130;
}
if ( V_4 -> V_80 < 0 ) {
F_42 ( L_7 , V_127 , V_82 -> V_128 ) ;
V_122 = - V_129 ;
goto V_130;
}
if ( ! F_43 ( V_119 -> V_131 , F_44 ( V_119 ) , V_82 -> V_75 ) ) {
F_42 ( L_8 , V_127 ) ;
V_122 = - V_132 ;
goto V_130;
}
V_4 -> V_115 = ( T_1 ) F_45 ( V_119 -> V_131 , F_44 ( V_119 ) ) ;
if ( V_4 -> V_115 == 0 ) {
V_122 = - V_133 ;
goto V_130;
}
...
V_122 = F_46 ( & V_134 , V_123 , 1 , & V_121 ) ;
if ( V_122 )
goto V_130;
V_5 . V_21 = V_121 -> V_135 [ 0 ] ;
F_47 ( V_82 , V_121 ) ;
F_4 ( V_136 L_9 , V_124 ) ;
V_130:
return V_122 ;
}
static int F_48 ( struct V_117 * V_82 )
{
struct V_118 * V_119 ;
struct V_120 * V_121 = F_49 ( V_82 ) ;
T_2 * V_4 = & V_5 ;
F_50 ( V_121 ) ;
F_51 ( ( void * ) V_4 -> V_115 ) ;
V_119 = F_41 ( V_82 , V_126 , 0 ) ;
F_52 ( V_119 -> V_131 , F_44 ( V_119 ) ) ;
return 0 ;
}
