...
V_3 -> V_96 = F_51 ( V_96 -> V_109 , V_96 -> V_110 - V_96 -> V_109 + 1 ) ;
if ( ! V_3 -> V_96 ) {
F_4 ( & V_19 -> V_20 , L_14 ) ;
goto V_108;
}
F_27 ( V_3 , V_51 , 0 ) ;
F_27 ( V_3 , V_46 , 0 ) ;
V_38 = F_52 ( V_54 , F_34 , 0 , L_15 , V_3 ) ;
if ( V_38 ) {
F_4 ( & V_19 -> V_20 , L_16 ) ;
goto V_111;
}
...
T_5 V_92 ;
V_78 -> V_112 = V_96 -> V_109 + V_113 ;
F_54 ( V_92 ) ;
F_55 ( V_114 , V_92 ) ;
V_3 -> V_10 . V_9 = F_56 ( V_92 , F_41 , V_78 ) ;
}
...
strcpy ( V_64 -> V_117 , L_18 ) ;
strcpy ( V_64 -> V_65 , L_18 ) ;
sprintf ( V_64 -> V_118 , L_19 ) ;
V_38 = F_37 ( V_3 ) ;
if ( V_38 ) {
F_4 ( & V_19 -> V_20 , L_20 ) ;
goto V_119;
...
F_58 ( V_19 , V_64 ) ;
F_59 ( & V_19 -> V_20 , L_22 ,
V_3 -> V_96 , F_60 ( & V_3 -> V_10 . V_9 -> V_20 -> V_80 ) ) ;
return V_38 ;
V_119:
F_61 ( V_3 -> V_10 . V_9 ) ;
V_3 -> V_10 . V_9 = NULL ;
...
static int F_66 ( struct V_93 * V_19 , T_6 V_120 )
{
struct V_94 * V_64 = F_67 ( V_19 ) ;
...
static int F_68 ( struct V_93 * V_19 )
{
struct V_94 * V_64 = F_67 ( V_19 ) ;
struct V_2 * V_3 = V_64 -> V_68 ;
F_25 ( V_3 -> V_87 ) ;
...
static int T_7 F_69 ( struct V_93 * V_19 )
{
struct V_94 * V_64 = F_67 ( V_19 ) ;
