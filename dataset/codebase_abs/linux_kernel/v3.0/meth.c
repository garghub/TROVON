...
static int T_5 F_51 ( struct V_161 * V_162 )
{
struct V_1 * V_2 ;
struct V_9 * V_10 ;
int V_163 ;
V_2 = F_52 ( sizeof( struct V_9 ) ) ;
if ( ! V_2 )
return - V_39 ;
V_2 -> V_164 = & V_165 ;
V_2 -> V_166 = V_167 ;
V_2 -> V_68 = V_168 ;
V_2 -> V_169 = ( unsigned long ) & V_6 -> V_7 ;
memcpy ( V_2 -> V_5 , V_170 , 6 ) ;
V_10 = F_10 ( V_2 ) ;
F_53 ( & V_10 -> V_20 ) ;
F_54 ( V_2 , & V_162 -> V_2 ) ;
V_163 = F_55 ( V_2 ) ;
...
static int T_6 F_57 ( struct V_161 * V_162 )
{
struct V_1 * V_2 = F_58 ( V_162 ) ;
F_59 ( V_2 ) ;
F_56 ( V_2 ) ;
F_60 ( V_162 , NULL ) ;
return 0 ;
