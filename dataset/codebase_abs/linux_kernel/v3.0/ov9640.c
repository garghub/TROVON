...
int V_5 = 0 ;
if ( ! V_26 -> V_16 . V_140 ||
F_33 ( V_26 -> V_16 . V_140 ) -> V_141 != V_26 -> V_142 ) {
F_3 ( & V_2 -> V_16 , L_8 ) ;
V_5 = - V_143 ;
goto V_14;
}
V_5 = F_1 ( V_2 , V_144 , & V_135 ) ;
if ( V_5 )
goto V_14;
V_5 = F_1 ( V_2 , V_145 , & V_136 ) ;
if ( V_5 )
goto V_14;
V_5 = F_1 ( V_2 , V_146 , & V_137 ) ;
if ( V_5 )
goto V_14;
V_5 = F_1 ( V_2 , V_147 , & V_138 ) ;
if ( V_5 )
goto V_14;
switch ( F_34 ( V_135 , V_136 ) ) {
case V_148 :
V_139 = L_9 ;
V_38 -> V_50 = V_149 ;
V_38 -> V_51 = 2 ;
...
V_38 = F_37 ( sizeof( struct V_37 ) , V_154 ) ;
if ( ! V_38 ) {
F_3 ( & V_2 -> V_16 ,
L_14 ) ;
return - V_155 ;
}
F_38 ( & V_38 -> V_156 , V_2 , & V_157 ) ;
V_26 -> V_158 = & V_159 ;
V_5 = F_31 ( V_26 , V_2 ) ;
if ( V_5 ) {
V_26 -> V_158 = NULL ;
