...
V_72 . V_84 = V_85 ;
V_72 . V_86 = V_68 -> V_74 ;
V_72 . V_87 = F_34 ( V_62 , & V_68 -> V_88 ) ;
if ( V_72 . V_87 )
V_72 . V_89 = F_35 ( ~ 0 ) ;
V_72 . V_90 = F_36 ( V_62 , & V_68 -> V_88 ) ;
if ( V_72 . V_90 )
V_72 . V_91 = F_35 ( ~ 0 ) ;
V_72 . V_92 = V_68 -> V_93 ;
V_35 = F_37 ( V_63 , V_45 , & V_72 ,
( V_44 ? ( V_81 * ) & V_44 -> V_48 : NULL ) ) ;
V_78:
return V_35 ;
}
static int F_38 ( struct V_29 * V_30 , struct V_7 * V_8 ,
T_2 * * V_36 )
{
...
{
F_41 ( V_107 L_6 ) ;
if ( F_49 ( & V_121 , V_85 ) < 0 ) {
F_41 ( V_107 L_7 , V_108 ) ;
goto V_122;
}
if ( F_49 ( & V_123 , V_85 ) < 0 ) {
F_41 ( V_107 L_8 , V_108 ) ;
goto V_124;
}
if ( F_50 ( F_6 ) < 0 ) {
F_41 ( V_107 L_9 , V_108 ) ;
goto V_125;
}
return 0 ;
V_125:
...
{
if ( F_53 ( F_6 ) < 0 )
F_41 ( V_107 L_10 , V_108 ) ;
if ( F_51 ( & V_123 , V_85 ) < 0 )
F_41 ( V_107 L_11 , V_108 ) ;
if ( F_51 ( & V_121 , V_85 ) < 0 )
F_41 ( V_107 L_12 , V_108 ) ;
}
