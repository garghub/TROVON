...
F_32 ( V_53 , V_54 ) ;
F_33 ( V_53 ) ;
while ( ( V_49 = F_34 ( V_47 , V_48 , L_9 , V_55 , NULL ) ) != - 1 ) {
V_12 = (enum V_12 ) V_49 ;
switch ( V_49 ) {
case V_14 :
V_56 = 1 ;
...
unsigned int V_64 ;
F_35 ( & V_63 , NULL ) ;
V_64 = ( unsigned int ) ( ( V_63 . V_65 + 1 ) * ( V_63 . V_66 + 1 ) ) ;
srand ( V_64 ) ;
break;
}
case '?' :
...
switch ( V_12 ) {
case V_69 : V_23 = L_43 ; break;
case V_70 : V_23 = L_44 ; break;
case V_71 : V_23 = L_45 ; break;
case V_72 : V_23 = L_46 ; break;
case V_61 : V_23 = L_47 ; break;
default: break;
}
if ( ! V_50 ( V_23 , & V_51 ) )
F_40 ( V_23 , V_73 ) ;
else if ( ! V_50 ( L_48 , & V_51 ) )
F_40 ( L_48 , V_73 ) ;
break;
default:
break;
...
void F_12 ( V_4 , T_2 , T_3 )
char * V_4 ;
int T_2 ;
T_4 * T_3 ;
{
if ( fgets ( V_4 , T_2 , T_3 ) == NULL )
fprintf ( V_67 , L_54 ) ;
}
