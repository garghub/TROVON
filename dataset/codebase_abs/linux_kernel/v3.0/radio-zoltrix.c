...
if ( V_25 -> V_35 > 0 )
return - V_16 ;
F_15 ( V_25 -> V_36 , L_5 , sizeof( V_25 -> V_36 ) ) ;
V_25 -> type = V_37 ;
V_25 -> V_38 = 88 * 16000 ;
V_25 -> V_39 = 108 * 16000 ;
V_25 -> V_40 = V_41 | V_42 ;
...
struct V_34 * V_25 )
{
return V_25 -> V_35 ? - V_16 : 0 ;
}
static int F_19 ( struct V_22 * V_22 , void * V_23 ,
struct V_48 * V_12 )
{
struct V_1 * V_2 = F_17 ( V_22 ) ;
if ( V_12 -> V_49 != 0 || V_12 -> type != V_37 )
return - V_16 ;
if ( F_9 ( V_2 , V_12 -> V_50 ) != 0 )
return - V_16 ;
return 0 ;
}
...
switch ( V_52 -> V_53 ) {
case V_54 :
return F_22 ( V_52 , 0 , 1 , 1 , 1 ) ;
case V_55 :
return F_22 ( V_52 , 0 , 65535 , 4096 , 65535 ) ;
}
return - V_16 ;
}
...
static int F_25 ( struct V_22 * V_59 , void * V_23 , unsigned int * V_15 )
{
* V_15 = 0 ;
return 0 ;
}
static int F_26 ( struct V_22 * V_59 , void * V_23 , unsigned int V_15 )
{
return V_15 ? - V_16 : 0 ;
}
...
{
V_18 -> V_35 = 0 ;
F_15 ( V_18 -> V_36 , L_6 , sizeof( V_18 -> V_36 ) ) ;
V_18 -> V_43 = V_61 ;
return 0 ;
}
...
struct V_9 * V_10 = & V_2 -> V_10 ;
int V_63 ;
F_15 ( V_10 -> V_36 , L_7 , sizeof( V_10 -> V_36 ) ) ;
V_2 -> V_7 = V_7 ;
if ( V_2 -> V_7 == - 1 ) {
F_30 ( V_10 , L_8 ) ;
return - V_16 ;
...
V_2 -> V_4 = 0 ;
V_2 -> V_14 = 1 ;
F_15 ( V_2 -> V_66 . V_36 , V_10 -> V_36 , sizeof( V_2 -> V_66 . V_36 ) ) ;
V_2 -> V_66 . V_10 = V_10 ;
V_2 -> V_66 . V_67 = & V_68 ;
V_2 -> V_66 . V_69 = & V_70 ;
V_2 -> V_66 . V_71 = V_72 ;
F_35 ( & V_2 -> V_66 , V_2 ) ;
if ( F_36 ( & V_2 -> V_66 , V_73 , V_74 ) < 0 ) {
F_37 ( V_10 ) ;
F_33 ( V_2 -> V_7 , 2 ) ;
return - V_16 ;
}
