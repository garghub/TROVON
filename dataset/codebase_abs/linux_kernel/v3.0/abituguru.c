...
struct V_69 * V_70 = F_19 ( V_68 ) ;
struct V_1 * V_2 = F_22 ( V_66 ) ;
T_1 V_28 = ( F_26 ( V_22 , NULL , 10 ) * 255 +
V_2 -> V_73 [ V_70 -> V_72 ] / 2 ) /
V_2 -> V_73 [ V_70 -> V_72 ] ;
T_3 V_30 = V_23 ;
F_27 ( & V_2 -> V_77 ) ;
if ( V_2 -> V_46 [ V_70 -> V_72 ] [ V_70 -> V_74 ] != V_28 ) {
T_1 V_78 = V_2 -> V_46 [ V_70 -> V_72 ] [ V_70 -> V_74 ] ;
V_2 -> V_46 [ V_70 -> V_72 ] [ V_70 -> V_74 ] = V_28 ;
if ( F_12 ( V_2 , V_35 + 2 ,
V_70 -> V_72 , V_2 -> V_46 [ V_70 -> V_72 ] ,
3 ) <= V_70 -> V_74 ) {
V_2 -> V_46 [ V_70 -> V_72 ] [ V_70 -> V_74 ] = V_78 ;
V_30 = - V_13 ;
}
}
F_28 ( & V_2 -> V_77 ) ;
...
struct V_69 * V_70 = F_19 ( V_68 ) ;
struct V_1 * V_2 = F_22 ( V_66 ) ;
T_1 V_28 = ( F_26 ( V_22 , NULL , 10 ) * 255 + V_76 / 2 ) /
V_76 ;
T_3 V_30 = V_23 ;
if ( ( V_28 < V_53 ) ||
( V_28 > V_54 ) )
...
T_1 V_78 = V_2 -> V_52 [ V_70 -> V_72 ] [ V_70 -> V_74 ] ;
V_2 -> V_52 [ V_70 -> V_72 ] [ V_70 -> V_74 ] = V_28 ;
if ( F_12 ( V_2 , V_80 + 2 ,
V_70 -> V_72 , V_2 -> V_52 [ V_70 -> V_72 ] ,
2 ) <= V_70 -> V_74 ) {
V_2 -> V_52 [ V_70 -> V_72 ] [ V_70 -> V_74 ] = V_78 ;
V_30 = - V_13 ;
}
}
F_28 ( & V_2 -> V_77 ) ;
...
struct V_69 * V_70 = F_19 ( V_68 ) ;
struct V_1 * V_2 = F_22 ( V_66 ) ;
int V_82 = F_26 ( V_22 , NULL , 10 ) ;
T_3 V_30 = V_23 ;
T_1 V_78 ;
F_27 ( & V_2 -> V_77 ) ;
V_78 = V_2 -> V_46 [ V_70 -> V_72 ] [ 0 ] ;
if ( V_82 )
V_2 -> V_46 [ V_70 -> V_72 ] [ 0 ] |= V_70 -> V_74 ;
else
V_2 -> V_46 [ V_70 -> V_72 ] [ 0 ] &= ~ V_70 -> V_74 ;
if ( ( V_2 -> V_46 [ V_70 -> V_72 ] [ 0 ] != V_78 ) &&
( F_12 ( V_2 ,
V_35 + 2 , V_70 -> V_72 ,
V_2 -> V_46 [ V_70 -> V_72 ] , 3 ) < 1 ) ) {
V_2 -> V_46 [ V_70 -> V_72 ] [ 0 ] = V_78 ;
V_30 = - V_13 ;
}
F_28 ( & V_2 -> V_77 ) ;
return V_30 ;
...
T_1 V_78 ;
F_27 ( & V_2 -> V_77 ) ;
V_78 = V_2 -> V_52 [ V_70 -> V_72 ] [ 0 ] ;
if ( V_82 )
V_2 -> V_52 [ V_70 -> V_72 ] [ 0 ] |= V_70 -> V_74 ;
else
V_2 -> V_52 [ V_70 -> V_72 ] [ 0 ] &= ~ V_70 -> V_74 ;
if ( ( V_2 -> V_52 [ V_70 -> V_72 ] [ 0 ] != V_78 ) &&
( F_12 ( V_2 ,
V_80 + 2 , V_70 -> V_72 ,
V_2 -> V_52 [ V_70 -> V_72 ] , 2 ) < 1 ) ) {
V_2 -> V_52 [ V_70 -> V_72 ] [ 0 ] = V_78 ;
V_30 = - V_13 ;
}
F_28 ( & V_2 -> V_77 ) ;
return V_30 ;
...
struct V_69 * V_70 = F_19 ( V_68 ) ;
struct V_1 * V_2 = F_22 ( V_66 ) ;
T_1 V_61 , V_28 = ( F_26 ( V_22 , NULL , 10 ) +
V_83 [ V_70 -> V_74 ] / 2 ) /
V_83 [ V_70 -> V_74 ] ;
T_3 V_30 = V_23 ;
...
T_1 V_78 = V_2 -> V_58 [ V_70 -> V_72 ] [ V_70 -> V_74 ] ;
...
struct V_69 * V_70 = F_19 ( V_68 ) ;
struct V_1 * V_2 = F_22 ( V_66 ) ;
unsigned long V_28 = F_26 ( V_22 , NULL , 10 ) - 1 ;
T_3 V_30 = V_23 ;
F_27 ( & V_2 -> V_77 ) ;
if ( V_28 < V_2 -> V_59 [ V_45 ] ) {
T_1 V_78 = V_2 -> V_58 [ V_70 -> V_72 ] [ 0 ] ;
T_1 V_86 = V_2 -> V_60 [ V_45 ] [ V_28 ] ;
V_2 -> V_58 [ V_70 -> V_72 ] [ 0 ] &= 0xF0 ;
V_2 -> V_58 [ V_70 -> V_72 ] [ 0 ] |= V_86 ;
if ( V_2 -> V_58 [ V_70 -> V_72 ] [ 0 ] != V_78 ) {
if ( F_12 ( V_2 , V_84 + 1 ,
V_70 -> V_72 ,
V_2 -> V_58 [ V_70 -> V_72 ] ,
5 ) < 1 ) {
V_2 -> V_58 [ V_70 -> V_72 ] [ 0 ] = V_78 ;
V_30 = - V_13 ;
}
}
}
...
struct V_69 * V_70 = F_19 ( V_68 ) ;
struct V_1 * V_2 = F_22 ( V_66 ) ;
T_1 V_78 , V_89 = F_26 ( V_22 , NULL , 10 ) ;
T_3 V_30 = V_23 ;
F_27 ( & V_2 -> V_77 ) ;
V_78 = V_2 -> V_58 [ V_70 -> V_72 ] [ 0 ] ;
switch ( V_89 ) {
case 0 :
...
if ( ! ( V_2 = F_44 ( sizeof( struct V_1 ) , V_99 ) ) )
return - V_100 ;
...
static int F_60 ( struct V_91 * V_92 , T_6 V_3 )
{
struct V_1 * V_2 = F_57 ( V_92 ) ;
F_27 ( & V_2 -> V_77 ) ;
return 0 ;
