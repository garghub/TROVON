...
if ( F_61 ( V_43 , F_41 , V_98 , L_16 , ( void * ) V_2 ) ) {
F_19 ( V_28 L_18 , V_43 ) ;
return - V_97 ;
}
V_2 -> V_43 = V_43 ;
...
if ( V_95 < 0 )
return V_95 ;
return F_64 ( V_91 , V_99 , V_2 , & V_93 ) ;
}
int F_65 ( struct V_90 * V_91 , struct V_1 * V_2 ,
int V_88 , struct V_100 * * V_101 )
{
struct V_100 * V_102 ;
int V_95 ;
V_95 = F_66 ( V_91 , L_20 , V_88 , 1 , 1 , & V_102 ) ;
if ( V_95 < 0 )
return V_95 ;
...
V_115 -> type = V_117 ;
V_115 -> V_66 = 1 ;
V_115 -> V_59 . V_118 . V_119 = 8 ;
if ( V_115 -> V_59 . V_118 . V_120 > 7 )
V_115 -> V_59 . V_118 . V_120 = 7 ;
strcpy ( V_115 -> V_59 . V_118 . V_110 , V_116 [ V_115 -> V_59 . V_118 . V_120 ] ) ;
return 0 ;
}
static int F_71 ( struct V_112 * V_113 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
V_122 -> V_59 . V_118 . V_120 [ 0 ] = F_13 ( V_2 , V_123 ) & 7 ;
return 0 ;
}
static int F_73 ( struct V_112 * V_113 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
unsigned long V_18 ;
unsigned char V_124 , V_125 ;
int V_126 ;
if ( V_122 -> V_59 . V_118 . V_120 [ 0 ] > 8 )
return - V_44 ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_124 = F_13 ( V_2 , V_123 ) ;
V_125 = ( V_122 -> V_59 . V_118 . V_120 [ 0 ] & 7 ) | ( V_124 & ~ 15 ) ;
V_126 = V_125 != V_124 ;
if ( V_126 )
F_11 ( V_2 , V_123 , V_125 ) ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
return V_126 ;
}
static int F_74 ( struct V_112 * V_113 , struct V_114 * V_115 )
{
int V_127 = ( V_113 -> V_128 >> 16 ) & 0xff ;
V_115 -> type = V_127 == 1 ? V_129 : V_130 ;
V_115 -> V_66 = 1 ;
V_115 -> V_59 . integer . V_131 = 0 ;
V_115 -> V_59 . integer . V_132 = V_127 ;
return 0 ;
}
static int F_75 ( struct V_112 * V_113 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
unsigned long V_18 ;
int V_11 = V_113 -> V_128 & 0xff ;
int V_133 = ( V_113 -> V_128 >> 8 ) & 0xff ;
int V_127 = ( V_113 -> V_128 >> 16 ) & 0xff ;
int V_134 = ( V_113 -> V_128 >> 24 ) & 0xff ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_122 -> V_59 . integer . V_59 [ 0 ] = ( F_13 ( V_2 , V_11 ) >> V_133 ) & V_127 ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
if ( V_134 )
V_122 -> V_59 . integer . V_59 [ 0 ] = V_127 - V_122 -> V_59 . integer . V_59 [ 0 ] ;
return 0 ;
}
static int F_76 ( struct V_112 * V_113 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
unsigned long V_18 ;
int V_11 = V_113 -> V_128 & 0xff ;
...
int V_126 ;
unsigned char V_124 , V_125 ;
V_125 = ( V_122 -> V_59 . integer . V_59 [ 0 ] & V_127 ) ;
if ( V_134 )
V_125 = V_127 - V_125 ;
V_125 <<= V_133 ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_124 = F_13 ( V_2 , V_11 ) ;
V_125 = ( V_124 & ~ ( V_127 << V_133 ) ) | V_125 ;
V_126 = V_125 != V_124 ;
if ( V_126 )
F_11 ( V_2 , V_11 , V_125 ) ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
...
static int F_77 ( struct V_112 * V_113 , struct V_114 * V_115 )
{
int V_127 = ( V_113 -> V_128 >> 24 ) & 0xff ;
V_115 -> type = V_127 == 1 ? V_129 : V_130 ;
V_115 -> V_66 = 2 ;
V_115 -> V_59 . integer . V_131 = 0 ;
V_115 -> V_59 . integer . V_132 = V_127 ;
...
static int F_78 ( struct V_112 * V_113 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
unsigned long V_18 ;
int V_135 = V_113 -> V_128 & 0xff ;
int V_136 = ( V_113 -> V_128 >> 8 ) & 0xff ;
int V_137 = ( V_113 -> V_128 >> 16 ) & 0x07 ;
int V_138 = ( V_113 -> V_128 >> 19 ) & 0x07 ;
int V_127 = ( V_113 -> V_128 >> 24 ) & 0xff ;
int V_134 = ( V_113 -> V_128 >> 22 ) & 1 ;
...
if ( V_135 != V_136 ) {
if ( V_136 < 0xa0 )
V_140 = F_13 ( V_2 , V_136 ) ;
else
V_140 = F_10 ( V_2 , V_136 ) ;
} else
V_140 = V_139 ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
V_122 -> V_59 . integer . V_59 [ 0 ] = ( V_139 >> V_137 ) & V_127 ;
V_122 -> V_59 . integer . V_59 [ 1 ] = ( V_140 >> V_138 ) & V_127 ;
if ( V_134 ) {
V_122 -> V_59 . integer . V_59 [ 0 ] = V_127 - V_122 -> V_59 . integer . V_59 [ 0 ] ;
V_122 -> V_59 . integer . V_59 [ 1 ] = V_127 - V_122 -> V_59 . integer . V_59 [ 1 ] ;
}
return 0 ;
}
static int F_79 ( struct V_112 * V_113 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
unsigned long V_18 ;
int V_135 = V_113 -> V_128 & 0xff ;
...
int V_134 = ( V_113 -> V_128 >> 22 ) & 1 ;
int V_126 ;
unsigned char V_141 , V_142 , V_143 , V_144 ;
V_141 = V_122 -> V_59 . integer . V_59 [ 0 ] & V_127 ;
V_142 = V_122 -> V_59 . integer . V_59 [ 1 ] & V_127 ;
if ( V_134 ) {
V_141 = V_127 - V_141 ;
V_142 = V_127 - V_142 ;
}
...
if ( V_136 < 0xa0 )
V_144 = F_13 ( V_2 , V_136 ) ;
else
V_144 = F_10 ( V_2 , V_136 ) ;
V_141 = ( V_143 & ~ ( V_127 << V_137 ) ) | V_141 ;
V_142 = ( V_144 & ~ ( V_127 << V_138 ) ) | V_142 ;
V_126 = V_141 != V_143 || V_142 != V_144 ;
if ( V_126 ) {
if ( V_135 < 0xa0 )
...
V_143 = F_10 ( V_2 , V_135 ) ;
V_141 = ( V_143 & ~ ( ( V_127 << V_137 ) | ( V_127 << V_138 ) ) ) | V_141 | V_142 ;
V_126 = V_141 != V_143 ;
if ( V_126 ) {
if ( V_135 < 0xa0 )
F_11 ( V_2 , V_135 , V_141 ) ;
...
if ( F_81 ( ! V_2 || ! V_91 ) )
return - V_44 ;
strcpy ( V_91 -> V_146 , F_58 ( V_2 ) ) ;
for ( V_145 = 0 ; V_145 < F_82 ( V_147 ) ; V_145 ++ ) {
if ( ( V_95 = F_83 ( V_91 , F_84 ( & V_147 [ V_145 ] , V_2 ) ) ) < 0 )
return V_95 ;
}
