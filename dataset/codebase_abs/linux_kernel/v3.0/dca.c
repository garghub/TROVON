...
struct V_17 * T_3
F_18 ( struct V_7 * V_12 , void T_4 * V_40 )
{
struct V_17 * V_18 ;
struct V_20 * V_21 ;
T_1 * V_1 = NULL ;
...
static int F_28 ( void T_4 * V_40 , T_2 V_63 )
{
int V_64 = 0 ;
T_5 V_65 ;
T_2 V_60 ;
...
return 0 ;
do {
V_65 = F_29 ( V_40 + V_60 + ( V_64 * sizeof( T_5 ) ) ) ;
V_64 ++ ;
} while ( ( V_65 & V_66 ) == 0 );
return V_64 ;
}
struct V_17 * T_3
F_30 ( struct V_7 * V_12 , void T_4 * V_40 )
{
struct V_17 * V_18 ;
struct V_20 * V_21 ;
int V_64 ;
...
static int F_32 ( struct V_17 * V_18 , struct V_19 * V_15 )
{
struct V_20 * V_21 = F_10 ( V_18 ) ;
struct V_7 * V_12 ;
int V_22 ;
...
static int F_35 ( void * V_40 , T_2 V_63 )
{
int V_64 = 0 ;
T_5 V_65 ;
T_2 V_60 ;
V_60 = F_24 ( V_40 + V_63 + V_76 ) ;
if ( V_60 == 0 )
return 0 ;
do {
V_65 = F_29 ( V_40 + V_60 + ( V_64 * sizeof( T_5 ) ) ) ;
...
struct V_17 * T_3
F_36 ( struct V_7 * V_12 , void T_4 * V_40 )
{
struct V_17 * V_18 ;
struct V_20 * V_21 ;
int V_64 ;
...
V_21 -> V_30 = V_40 + V_63 ;
V_21 -> V_27 = V_64 ;
V_67 = F_24 ( V_21 -> V_30 + V_84 ) ;
if ( ( V_67 & V_85 ) == 0 ) {
V_67 |= V_85 ;
F_12 ( V_67 ,
V_21 -> V_30 + V_84 ) ;
}
V_68 = F_24 ( V_21 -> V_30 + V_86 ) ;
if ( ( V_68 & V_87 ) == 0 ) {
V_68 |= V_87 ;
F_12 ( V_68 ,
V_21 -> V_30 + V_86 ) ;
...
V_34 = V_1 . V_80 >> ( 8 * V_22 ) ;
V_21 -> V_1 [ V_22 ] = V_34 & V_90 ;
}
V_41 = F_21 ( V_18 , & V_12 -> V_15 ) ;
if ( V_41 ) {
F_22 ( V_18 ) ;
