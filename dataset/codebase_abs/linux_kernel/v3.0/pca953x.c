...
struct V_64 * V_65 = V_8 -> V_12 . V_66 ;
int V_5 , V_16 = 0 ;
if ( V_65 -> V_39 != - 1
&& ( V_62 -> V_67 & V_68 ) ) {
int V_69 ;
...
if ( V_79 == NULL )
return NULL ;
V_65 = F_40 ( sizeof( struct V_64 ) , V_82 ) ;
if ( V_65 == NULL ) {
F_4 ( & V_8 -> V_12 , L_6 ) ;
return NULL ;
}
V_65 -> V_83 = - 1 ;
V_4 = F_41 ( V_79 , L_7 , & V_80 ) ;
if ( V_4 ) {
if ( V_80 != sizeof( * V_4 ) )
F_38 ( & V_8 -> V_12 , L_8 ,
V_79 -> V_84 ) ;
...
static int T_4 F_43 ( struct V_1 * V_2 , int V_85 )
{
int V_5 ;
...
static int T_4 F_44 ( struct V_1 * V_2 , int V_85 )
{
int V_5 ;
T_1 V_4 = 0 ;
F_1 ( V_2 , V_88 , 0x0 ) ;
...
static int T_4 F_45 ( struct V_63 * V_8 ,
const struct V_61 * V_62 )
{
struct V_64 * V_65 ;
struct V_1 * V_2 ;
int V_5 = 0 ;
V_2 = F_40 ( sizeof( struct V_1 ) , V_82 ) ;
if ( V_2 == NULL )
return - V_91 ;
V_65 = V_8 -> V_12 . V_66 ;
if ( V_65 == NULL ) {
...
V_2 -> V_33 = V_65 -> V_83 ;
V_2 -> V_38 = V_65 -> V_38 ;
V_2 -> V_9 = V_62 -> V_67 & ( V_10 | V_11 ) ;
F_28 ( & V_2 -> V_17 ) ;
F_15 ( V_2 , V_62 -> V_67 & V_93 ) ;
if ( V_2 -> V_9 == V_10 )
F_43 ( V_2 , V_65 -> V_85 ) ;
...
goto V_94;
if ( V_65 -> V_95 ) {
V_5 = V_65 -> V_95 ( V_8 , V_2 -> V_6 . V_32 ,
V_2 -> V_6 . V_7 , V_65 -> V_96 ) ;
if ( V_5 < 0 )
F_38 ( & V_8 -> V_12 , L_11 , V_5 ) ;
}
F_48 ( V_8 , V_2 ) ;
return 0 ;
V_94:
...
static int F_50 ( struct V_63 * V_8 )
{
struct V_64 * V_65 = V_8 -> V_12 . V_66 ;
struct V_1 * V_2 = F_51 ( V_8 ) ;
int V_5 = 0 ;
if ( V_65 -> V_97 ) {
V_5 = V_65 -> V_97 ( V_8 , V_2 -> V_6 . V_32 ,
V_2 -> V_6 . V_7 , V_65 -> V_96 ) ;
if ( V_5 < 0 ) {
F_4 ( & V_8 -> V_12 , L_12 ,
L_13 , V_5 ) ;
