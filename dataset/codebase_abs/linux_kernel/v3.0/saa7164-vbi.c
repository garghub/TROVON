...
static int F_51 ( struct V_122 * V_29 ,
struct V_172 * V_15 )
{
switch ( V_15 -> V_12 ) {
case V_102 :
...
int F_63 ( struct V_53 * V_53 , void * V_54 , struct V_163 * V_78 )
{
...
struct V_23 * F_72 ( struct V_1 * V_2 )
{
struct V_23 * V_24 = NULL ;
struct V_3 * V_4 = V_2 -> V_4 ;
V_58 V_197 ;
F_5 ( & V_2 -> V_25 ) ;
if ( ! F_73 ( & V_2 -> V_198 . V_27 ) ) {
V_24 = F_74 ( & V_2 -> V_198 . V_27 ,
struct V_23 , V_27 ) ;
if ( V_199 ) {
V_197 = F_75 ( 0 , V_24 -> V_200 , V_24 -> V_201 ) ;
if ( V_197 != V_24 -> V_197 ) {
F_14 ( V_47 L_47 ,
V_6 ,
...
static T_2 F_76 ( struct V_53 * V_53 , char T_3 * V_202 ,
T_4 V_138 , T_5 * V_183 )
{
struct V_55 * V_56 = V_53 -> V_57 ;
struct V_1 * V_2 = V_56 -> V_2 ;
...
static unsigned int F_83 ( struct V_53 * V_53 , T_7 * V_216 )
{
