...
static inline struct V_6 * F_9 ( unsigned V_8 )
{
return V_1 [ V_8 ] . V_7 ;
}
...
int (* F_81)( struct V_6 * V_7 , void * V_88 ) )
{
struct V_6 * V_7 = NULL ;
unsigned long V_11 ;
int V_16 ;
...
int F_87 ( const struct V_8 * V_98 , T_3 V_99 )
{
int V_16 , V_27 ;
for ( V_16 = 0 ; V_16 < V_99 ; V_16 ++ , V_98 ++ ) {
V_27 = F_86 ( V_98 -> V_8 , V_98 -> V_11 , V_98 -> V_3 ) ;
if ( V_27 )
goto V_100;
}
return 0 ;
...
void F_88 ( const struct V_8 * V_98 , T_3 V_99 )
{
while ( V_99 -- )
F_55 ( ( V_98 ++ ) -> V_8 ) ;
}
...
int F_92 ( unsigned V_8 , unsigned V_104 )
{
unsigned long V_11 ;
struct V_6 * V_7 ;
struct V_1 * V_4 = & V_1 [ V_8 ] ;
...
void F_94 ( unsigned V_8 , int V_38 )
{
struct V_6 * V_7 ;
V_7 = F_9 ( V_8 ) ;
F_84 ( V_7 -> V_95 ) ;
...
static void F_97 ( struct V_108 * V_109 , struct V_6 * V_7 )
{
unsigned V_16 ;
...
V_111 ? L_7 : L_30 ,
V_7 -> V_101
? ( V_7 -> V_101 ( V_7 , V_16 ) ? L_31 : L_32 )
: L_33 ) ;
F_98 ( V_109 , L_34 ) ;
}
}
static int F_99 ( struct V_108 * V_109 , void * V_112 )
{
struct V_6 * V_7 = NULL ;
unsigned V_8 ;
int V_113 = 0 ;
...
if ( V_29 )
F_98 ( V_109 , L_36 ,
V_29 -> V_114 ? V_29 -> V_114 -> V_69 : L_37 ,
F_100 ( V_29 ) ) ;
if ( V_7 -> V_3 )
F_98 ( V_109 , L_38 , V_7 -> V_3 ) ;
if ( V_7 -> V_95 )
F_98 ( V_109 , L_39 ) ;
F_98 ( V_109 , L_40 ) ;
V_113 = 1 ;
...
static int F_101 ( struct V_116 * V_116 , struct V_117 * V_117 )
{
return F_102 ( V_117 , F_99 , NULL ) ;
}
static int T_1 F_103 ( void )
{
( void ) F_104 ( L_41 , V_118 | V_119 ,
NULL , NULL , & V_120 ) ;
return 0 ;
}
