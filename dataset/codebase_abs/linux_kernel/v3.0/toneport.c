...
static int F_5 ( struct V_21 * V_12 , int V_22 , int V_23 )
{
int V_24 ;
V_24 = F_9 ( V_12 , F_10 ( V_12 , 0 ) , 0x67 ,
V_25 | V_26 | V_27 ,
V_22 , V_23 , NULL , 0 , V_28 * V_29 ) ;
if ( V_24 < 0 ) {
F_11 ( L_1 , V_24 ) ;
return V_24 ;
}
...
V_33 -> type = V_34 ;
V_33 -> V_18 = 1 ;
V_33 -> V_20 . integer . V_35 = 0 ;
V_33 -> V_20 . integer . V_36 = 256 ;
return 0 ;
}
static int F_13 ( struct V_30 * V_31 ,
struct V_37 * V_38 )
{
struct V_39 * V_40 = F_14 ( V_31 ) ;
V_38 -> V_20 . integer . V_20 [ 0 ] = V_40 -> V_41 ;
return 0 ;
}
...
{
struct V_39 * V_40 = F_14 ( V_31 ) ;
if ( V_38 -> V_20 . integer . V_20 [ 0 ] == V_40 -> V_41 )
return 0 ;
V_40 -> V_41 = V_38 -> V_20 . integer . V_20 [ 0 ] ;
if ( V_40 -> V_41 > 0 )
F_16 ( V_40 , V_42 ) ;
else
F_17 ( V_40 , V_42 ) ;
...
V_33 -> type = V_45 ;
V_33 -> V_18 = 1 ;
V_33 -> V_20 . V_46 . V_47 = V_43 ;
if ( V_33 -> V_20 . V_46 . V_48 >= V_43 )
V_33 -> V_20 . V_46 . V_48 = V_43 - 1 ;
strcpy ( V_33 -> V_20 . V_46 . V_49 ,
V_44 [ V_33 -> V_20 . V_46 . V_48 ] . V_49 ) ;
return 0 ;
}
...
V_38 -> V_20 . V_46 . V_48 [ 0 ] = V_50 -> V_51 ;
return 0 ;
}
...
struct V_8 * V_50 =
(struct V_8 * ) V_40 -> V_11 ;
if ( V_38 -> V_20 . V_46 . V_48 [ 0 ] == V_50 -> V_51 )
return 0 ;
V_50 -> V_51 = V_38 -> V_20 . V_46 . V_48 [ 0 ] ;
F_5 ( V_50 -> V_11 . V_12 ,
...
F_25 ( V_50 ) ;
F_38 ( & V_50 -> V_68 ) ;
V_50 -> V_68 . V_69 = V_70 + V_71 * V_29 ;
V_50 -> V_68 . V_72 = F_22 ;
V_50 -> V_68 . V_73 = ( unsigned long ) V_50 ;
F_39 ( & V_50 -> V_68 ) ;
return 0 ;
}
