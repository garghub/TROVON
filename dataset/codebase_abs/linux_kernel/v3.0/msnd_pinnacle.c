...
static int T_1 F_70 ( int V_162 , int V_163 , int V_164 )
{
F_19 ( V_163 , V_162 ) ;
F_19 ( V_164 , V_162 + 1 ) ;
if ( V_164 != F_17 ( V_162 + 1 ) ) {
F_25 (KERN_ERR LOGNAME L_48 ) ;
return - V_57 ;
}
return 0 ;
}
static int T_1 F_71 ( int V_162 , int V_165 , T_2 V_46 )
{
if ( F_70 ( V_162 , V_166 , V_165 ) )
return - V_57 ;
if ( F_70 ( V_162 , V_167 , F_3 ( V_46 ) ) )
return - V_57 ;
if ( F_70 ( V_162 , V_168 , F_5 ( V_46 ) ) )
return - V_57 ;
return 0 ;
}
static int T_1 F_72 ( int V_162 , int V_165 , T_2 V_46 )
{
if ( F_70 ( V_162 , V_166 , V_165 ) )
return - V_57 ;
if ( F_70 ( V_162 , V_169 , F_3 ( V_46 ) ) )
return - V_57 ;
if ( F_70 ( V_162 , V_170 , F_5 ( V_46 ) ) )
return - V_57 ;
return 0 ;
}
static int T_1 F_73 ( int V_162 , int V_165 , T_2 V_36 )
{
if ( F_70 ( V_162 , V_166 , V_165 ) )
return - V_57 ;
if ( F_70 ( V_162 , V_171 , F_5 ( V_36 ) ) )
return - V_57 ;
if ( F_70 ( V_162 , V_172 , V_173 ) )
return - V_57 ;
return 0 ;
}
static int T_1 F_74 ( int V_162 , int V_165 , int V_174 )
{
T_2 V_175 ;
V_174 >>= 8 ;
V_175 = ( T_2 ) ( V_174 & 0xfff ) ;
if ( F_70 ( V_162 , V_166 , V_165 ) )
return - V_57 ;
if ( F_70 ( V_162 , V_176 , F_3 ( V_175 ) ) )
return - V_57 ;
if ( F_70 ( V_162 , V_177 , F_5 ( V_175 ) ) )
return - V_57 ;
if ( V_175 && F_70 ( V_162 , V_178 ,
V_179 | V_180 ) )
return - V_57 ;
return 0 ;
}
static int T_1 F_75 ( int V_162 , int V_165 )
{
if ( F_70 ( V_162 , V_166 , V_165 ) )
return - V_57 ;
if ( F_70 ( V_162 , V_181 , V_182 ) )
return - V_57 ;
return 0 ;
}
static int T_1 F_76 ( int V_162 , int V_165 , T_2 V_183 ,
T_2 V_184 , T_2 V_36 , int V_174 )
{
if ( F_70 ( V_162 , V_166 , V_165 ) )
return - V_57 ;
if ( F_71 ( V_162 , V_165 , V_183 ) )
return - V_57 ;
if ( F_72 ( V_162 , V_165 , V_184 ) )
return - V_57 ;
if ( F_73 ( V_162 , V_165 , V_36 ) )
return - V_57 ;
if ( F_74 ( V_162 , V_165 , V_174 ) )
return - V_57 ;
if ( F_75 ( V_162 , V_165 ) )
return - V_57 ;
return 0 ;
}
static int T_1 F_77 ( int V_162 )
{
int V_185 ;
F_25 (KERN_INFO LOGNAME L_49 ) ;
for ( V_185 = 0 ; V_185 < 4 ; ++ V_185 )
if ( F_76 ( V_162 , V_185 , 0 , 0 , 0 , 0 ) )
return - V_57 ;
return 0 ;
}
static int T_1 F_78 ( struct V_133 * V_186 , unsigned int V_185 )
{
if ( V_46 [ V_185 ] == V_153 )
return 0 ;
if ( V_36 [ V_185 ] == V_153 || V_174 [ V_185 ] == V_153 ) {
...
#else
if ( V_46 [ V_185 ] < 0x100 || V_46 [ V_185 ] > 0x3e0 || ( V_46 [ V_185 ] % 0x10 ) != 0 ) {
F_25 (KERN_ERR LOGNAME
L_54
L_55 ) ;
return 0 ;
...
#ifndef F_10
if ( V_162 [ V_185 ] == V_153 ) {
F_25 (KERN_INFO LOGNAME L_60 ) ;
} else if ( V_162 [ V_185 ] != 0x250 && V_162 [ V_185 ] != 0x260 && V_162 [ V_185 ] != 0x270 ) {
...
static int T_1 F_79 ( struct V_133 * V_186 , unsigned int V_187 )
{
int V_112 ;
struct V_58 * V_59 ;
struct V_1 * V_2 ;
...
V_112 = F_81 ( V_188 [ V_187 ] , V_189 [ V_187 ] , V_190 ,
...
switch ( V_36 [ V_187 ] ) {
case 5 :
V_2 -> V_191 = V_192 ; break;
case 7 :
V_2 -> V_191 = V_193 ; break;
case 9 :
V_2 -> V_191 = V_194 ; break;
case 10 :
V_2 -> V_191 = V_195 ; break;
case 11 :
V_2 -> V_191 = V_196 ; break;
case 12 :
V_2 -> V_191 = V_197 ; break;
}
switch ( V_174 [ V_187 ] ) {
case 0xb0000 :
...
case 0xe8000 :
V_2 -> V_73 = V_203 ; break;
}
#else
F_25 (KERN_INFO LOGNAME L_63 ,
cfg[idx]) ;
if ( ! F_23 ( V_162 [ V_187 ] , 2 , L_64 ) ) {
...
V_112 = F_76 ( V_162 [ V_187 ] , 0 ,
V_46 [ V_187 ] , 0 ,
V_36 [ V_187 ] , V_174 [ V_187 ] ) ;
if ( V_112 )
goto V_205;
if ( V_152 [ V_187 ] != V_153
&& V_157 [ V_187 ] != V_206 ) {
F_25 (KERN_INFO LOGNAME
L_66 ,
mpu_io[idx], mpu_irq[idx]) ;
V_112 = F_76 ( V_162 [ V_187 ] , 1 ,
V_152 [ V_187 ] , 0 ,
V_157 [ V_187 ] , 0 ) ;
if ( V_112 )
goto V_205;
}
if ( V_207 [ V_187 ] != V_153
&& V_208 [ V_187 ] != V_153
&& V_209 [ V_187 ] != V_206 ) {
F_25 (KERN_INFO LOGNAME
L_67 ,
ide_io0[idx], ide_io1[idx], ide_irq[idx]) ;
V_112 = F_76 ( V_162 [ V_187 ] , 2 ,
V_207 [ V_187 ] , V_208 [ V_187 ] ,
V_209 [ V_187 ] , 0 ) ;
if ( V_112 )
goto V_205;
}
if ( V_210 [ V_187 ] != V_153 ) {
F_25 (KERN_INFO LOGNAME
L_68 ,
joystick_io[idx]) ;
V_112 = F_76 ( V_162 [ V_187 ] , 3 ,
V_210 [ V_187 ] , 0 ,
0 , 0 ) ;
if ( V_112 )
goto V_205;
...
static int T_5 F_85 ( struct V_133 * V_186 , unsigned int V_114 )
{
F_68 ( F_86 ( V_186 ) ) ;
F_84 ( V_186 , NULL ) ;
return 0 ;
}
static int T_1 F_87 ( struct V_220 * V_221 ,
...
struct V_1 * V_2 ;
int V_226 ;
for ( ; V_187 < V_227 ; V_187 ++ ) {
if ( F_80 ( V_187 ) )
break;
}
if ( V_187 >= V_227 )
return - V_67 ;
V_224 = F_88 ( V_221 , V_223 -> V_228 [ 0 ] . V_189 , NULL ) ;
if ( ! V_224 )
return - V_67 ;
V_225 = F_88 ( V_221 , V_223 -> V_228 [ 1 ] . V_189 , NULL ) ;
if ( ! V_225 )
return - V_67 ;
...
if ( ! F_89 ( V_225 ) && F_90 ( V_225 ) < 0 ) {
F_25 ( V_229 L_72 ) ;
return - V_147 ;
}
V_226 = F_81 ( V_188 [ V_187 ] , V_189 [ V_187 ] , V_190 ,
sizeof( struct V_1 ) , & V_59 ) ;
if ( V_226 < 0 )
return V_226 ;
V_2 = V_59 -> V_60 ;
V_2 -> V_59 = V_59 ;
F_82 ( V_59 , & V_221 -> V_59 -> V_114 ) ;
V_46 [ V_187 ] = F_91 ( V_224 , 0 ) ;
V_36 [ V_187 ] = F_92 ( V_224 , 0 ) ;
V_174 [ V_187 ] = F_93 ( V_224 , 0 ) ;
V_152 [ V_187 ] = F_91 ( V_225 , 0 ) ;
V_157 [ V_187 ] = F_92 ( V_225 , 0 ) ;
F_1 ( V_2 ) ;
#ifdef F_10
V_2 -> type = V_211 ;
#else
...
static void T_5 F_95 ( struct V_220 * V_221 )
{
F_68 ( F_96 ( V_221 ) ) ;
F_94 ( V_221 , NULL ) ;
}
