...
V_179 = F_1 ( V_36 ) ;
F_3 ( V_179 | ( 1 << V_52 -> V_187 ) , V_36 ) ;
V_67 = V_176 -> V_82 ;
F_6 ( V_90 , L_54 ,
V_174 -> V_180 , V_52 -> V_187 , V_67 ,
...
static struct V_173 *
F_58 ( struct V_171 * V_174 , T_7 V_196 )
{
struct V_53 * V_54 ;
F_6 ( V_75 , L_60 , V_76 , V_174 , V_196 ) ;
if ( ! V_174 )
return NULL ;
V_54 = F_59 ( sizeof( struct V_53 ) , V_196 ) ;
if ( ! V_54 )
return NULL ;
F_60 ( & V_54 -> V_57 ) ;
return & V_54 -> V_54 ;
...
static void
F_61 ( struct V_171 * V_174 , struct V_173 * V_197 )
{
struct V_51 * V_52 = F_49 ( V_174 ) ;
struct V_53 * V_54 = F_52 ( V_197 ) ;
F_6 ( V_75 , L_61 , V_76 , V_174 , V_197 ) ;
if ( ! V_52 || ! V_197 || ( ! V_52 -> V_176 && V_174 -> V_180 != V_181 ) )
return;
F_62 ( ! F_27 ( & V_54 -> V_57 ) ) ;
F_63 ( V_54 ) ;
}
static int F_64 ( struct V_171 * V_174 , struct V_173 * V_197 ,
T_7 V_198 )
{
struct V_53 * V_54 = F_52 ( V_197 ) ;
struct V_51 * V_52 = F_49 ( V_174 ) ;
...
int V_97 = 0 ;
unsigned long V_158 ;
if ( F_65 ( ! V_174 || ( ! V_52 -> V_176 && V_52 -> V_52 . V_180 != V_181 ) ) ) {
F_6 ( V_90 , L_62 , V_76 ) ;
return - V_184 ;
}
V_63 = V_52 -> V_63 ;
...
F_55 ( V_158 ) ;
if ( F_65 ( ! V_197 || ! V_197 -> V_59
|| ! V_197 -> V_74 || ! F_27 ( & V_54 -> V_57 ) ) ) {
if ( ! V_197 )
F_6 ( V_90 , L_63 , V_76 ) ;
else {
F_6 ( V_90 , L_64 ,
V_76 , ! V_197 -> V_59 , ! V_197 -> V_74 ,
! F_27 ( & V_54 -> V_57 ) ) ;
}
F_56 ( V_158 ) ;
return - V_184 ;
...
static int F_67 ( struct V_171 * V_174 , struct V_173 * V_197 )
{
struct V_51 * V_52 = F_49 ( V_174 ) ;
struct V_60 * V_61 ;
int V_200 = - V_184 ;
...
F_6 ( V_75 ,
L_67 ,
V_54 , V_174 -> V_180 , V_197 -> V_72 , V_197 -> V_74 ) ;
F_23 ( V_52 , V_54 , - V_202 ) ;
}
F_56 ( V_158 ) ;
return V_200 ;
}
...
static int F_69 ( struct V_172 * V_203 )
{
int V_67 ;
F_6 ( V_75 , L_69 , V_76 ) ;
V_67 = F_1 ( V_204 ) << 8 ;
...
static int F_70 ( struct V_172 * V_203 )
{
F_6 ( V_90 , L_69 , V_76 ) ;
return 0 ;
}
...
static int F_72 ( struct V_60 * V_61 , int V_207 )
{
F_6 ( V_90 , L_69 , V_76 ) ;
...
if ( V_61 -> V_140 && V_61 -> V_140 -> V_211 )
V_61 -> V_140 -> V_211 ( & V_61 -> V_142 ) ;
}
F_75 ( V_61 ) ;
}
}
...
static int F_76 ( struct V_172 * V_142 , int V_212 )
{
struct V_60 * V_61 = F_51 ( V_142 ) ;
F_6 ( V_90 , L_69 , V_76 ) ;
V_61 -> V_213 = ( V_212 != 0 ) ;
...
static int F_77 ( struct V_172 * V_142 , int V_207 )
{
struct V_60 * V_61 = F_51 ( V_142 ) ;
F_6 ( V_90 , L_69 , V_76 ) ;
F_72 ( V_61 , V_207 ? 0 : 1 ) ;
...
static T_6 F_78 ( int V_214 , void * V_154 )
{
struct V_60 * V_63 = V_154 ;
unsigned int V_3 ;
F_6 ( V_90 , L_69 , V_76 ) ;
V_3 = F_79 ( V_208 -> V_215 ) ? 1 : 0 ;
if ( V_208 -> V_216 )
V_3 = ! V_3 ;
if ( V_3 != V_63 -> V_213 )
F_76 ( & V_63 -> V_142 , V_3 ) ;
...
static int F_80 ( struct V_172 * V_203 , unsigned V_217 )
{
F_6 ( V_90 , L_69 , V_76 ) ;
...
static void F_81 ( enum V_220 V_221 )
{
if ( ! V_208 )
return;
if ( V_208 -> V_209 ) {
V_208 -> V_209 ( V_222 ) ;
} else if ( F_73 ( V_208 -> V_210 ) ) {
int V_3 ;
switch ( V_221 ) {
case V_223 :
V_3 = 1 ;
...
{
T_1 V_64 ;
F_60 ( & V_63 -> V_142 . V_225 ) ;
F_60 ( & V_63 -> V_142 . V_226 -> V_225 ) ;
V_63 -> V_92 = V_93 ;
for ( V_64 = 0 ; V_64 < V_65 ; V_64 ++ ) {
struct V_51 * V_52 = & V_63 -> V_52 [ V_64 ] ;
if ( V_64 != 0 )
F_66 ( & V_52 -> V_52 . V_225 , & V_63 -> V_142 . V_225 ) ;
V_52 -> V_63 = V_63 ;
V_52 -> V_176 = NULL ;
V_52 -> V_56 = 0 ;
F_60 ( & V_52 -> V_57 ) ;
...
int F_84 ( struct V_228 * V_140 ,
int (* F_85)( struct V_172 * ) )
{
struct V_60 * V_61 = V_201 ;
int V_200 ;
...
if ( V_61 -> V_140 )
return - V_230 ;
if ( ! F_85 || ! V_140 -> V_141 || V_140 -> V_160 < V_163 ) {
F_9 ( V_231 L_72 ,
F_85 , V_140 -> V_141 , V_140 -> V_160 ) ;
return - V_184 ;
}
#if F_86 ( V_232 )
if ( ! V_140 -> V_233 ) {
...
if ( ( V_200 = F_87 ( & V_61 -> V_142 . V_63 ) ) != 0 ) {
F_9 ( V_231 L_74 , V_200 ) ;
goto V_234;
}
F_6 ( V_90 , L_75 ,
V_140 -> V_140 . V_180 ) ;
if ( ( V_200 = F_85 ( & V_61 -> V_142 ) ) != 0 ) {
...
F_75 ( V_61 ) ;
F_83 ( V_61 ) ;
V_200 = F_104 ( V_170 , F_46 ,
V_253 , V_248 , V_61 ) ;
if ( V_200 != 0 ) {
F_94 ( V_63 , L_84 , V_170 , V_200 ) ;
V_200 = - V_230 ;
goto V_254;
}
F_91 ( V_63 , L_85 , V_170 ) ;
if ( V_208 && V_208 -> V_215 > 0 ) {
V_200 = F_105 ( V_208 -> V_215 , L_86 ) ;
if ( V_200 < 0 ) {
F_94 ( V_63 , L_87 ) ;
goto V_255;
}
V_214 = F_106 ( V_208 -> V_215 ) ;
if ( V_214 < 0 ) {
F_94 ( V_63 , L_88 ) ;
goto V_256;
}
V_200 = F_104 ( V_214 , F_78 ,
V_253 | V_257
| V_258 | V_259 ,
V_248 , V_61 ) ;
if ( V_200 != 0 ) {
...
F_91 ( V_63 , L_85 , V_214 ) ;
} else {
V_61 -> V_213 = 1 ;
}
if ( V_208 && ! V_208 -> V_209 &&
F_73 ( V_208 -> V_210 ) ) {
V_200 = F_107 ( V_208 -> V_210 ,
V_208 -> V_216 ?
V_260 : V_261 ,
L_90 ) ;
if ( V_200 )
...
static int F_119 ( struct V_235 * V_236 , T_8 V_267 )
{
F_81 ( V_222 ) ;
return 0 ;
}
static int F_120 ( struct V_235 * V_236 )
{
F_81 ( V_223 ) ;
return 0 ;
}
