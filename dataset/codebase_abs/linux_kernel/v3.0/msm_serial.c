...
T_2 V_162 ;
int V_113 ;
V_160 = F_59 ( V_157 , V_163 ,
L_4 ) ;
if ( F_39 ( ! V_160 ) )
return - V_170 ;
V_162 = F_55 ( V_160 ) ;
if ( ! F_61 ( V_2 -> V_164 , V_162 , L_5 ) )
return - V_171 ;
V_2 -> V_165 = F_62 ( V_2 -> V_164 , V_162 ) ;
if ( ! V_2 -> V_165 ) {
V_113 = - V_171 ;
goto V_172;
}
V_161 = F_59 ( V_157 , V_163 ,
L_3 ) ;
if ( V_161 ) {
V_162 = F_55 ( V_161 ) ;
if ( ! F_61 ( V_161 -> V_169 , V_162 ,
L_5 ) ) {
V_113 = - V_171 ;
goto V_172;
}
V_7 -> V_166 = F_62 ( V_161 -> V_169 , V_162 ) ;
if ( ! V_7 -> V_166 ) {
V_113 = - V_171 ;
goto V_173;
}
...
static void F_63 ( struct V_1 * V_2 , int V_119 )
{
struct V_7 * V_7 = F_5 ( V_2 ) ;
int V_113 ;
if ( V_119 & V_174 ) {
...
static int F_64 ( struct V_1 * V_2 , struct V_177 * V_178 )
{
...
static void F_65 ( struct V_1 * V_2 , unsigned int V_17 ,
unsigned int V_181 )
{
struct V_7 * V_7 = F_5 ( V_2 ) ;
switch ( V_17 ) {
...
static inline struct V_1 * F_67 ( unsigned int line )
{
...
static void F_69 ( struct V_185 * V_186 , const char * V_187 ,
unsigned int V_19 )
{
struct V_1 * V_2 ;
struct V_7 * V_7 ;
F_70 ( V_186 -> V_188 < 0 || V_186 -> V_188 >= V_189 ) ;
V_2 = F_67 ( V_186 -> V_188 ) ;
V_7 = F_5 ( V_2 ) ;
F_25 ( & V_2 -> V_66 ) ;
F_71 ( V_2 , V_187 , V_19 , F_68 ) ;
F_26 ( & V_2 -> V_66 ) ;
}
static int T_3 F_72 ( struct V_185 * V_186 , char * V_190 )
{
struct V_1 * V_2 ;
struct V_7 * V_7 ;
...
F_33 ( V_2 ) ;
if ( V_190 )
F_73 ( V_190 , & V_86 , & V_192 , & V_3 , & V_191 ) ;
V_3 = 8 ;
V_192 = 'n' ;
V_191 = 'n' ;
F_6 ( V_2 , V_146 | V_147 ,
...
F_66 ( V_193 L_7 , V_2 -> line ) ;
return F_74 ( V_2 , V_186 , V_86 , V_192 , V_3 , V_191 ) ;
}
static int T_3 F_75 ( struct V_156 * V_157 )
{
struct V_7 * V_7 ;
struct V_159 * V_159 ;
struct V_1 * V_2 ;
...
return - V_170 ;
F_66 ( V_193 L_8 , V_157 -> V_194 ) ;
V_2 = F_67 ( V_157 -> V_194 ) ;
V_2 -> V_158 = & V_157 -> V_158 ;
V_7 = F_5 ( V_2 ) ;
if ( F_59 ( V_157 , V_163 , L_3 ) )
V_7 -> V_52 = 1 ;
else
V_7 -> V_52 = 0 ;
if ( V_7 -> V_52 ) {
V_7 -> V_109 = F_76 ( & V_157 -> V_158 , L_9 ) ;
V_7 -> V_110 = F_76 ( & V_157 -> V_158 , L_10 ) ;
} else {
V_7 -> V_109 = F_76 ( & V_157 -> V_158 , L_11 ) ;
V_7 -> V_110 = F_77 ( - V_195 ) ;
}
if ( F_39 ( F_35 ( V_7 -> V_109 ) || ( F_35 ( V_7 -> V_110 ) &&
V_7 -> V_52 ) ) )
return F_78 ( V_7 -> V_109 ) ;
if ( V_7 -> V_52 )
F_79 ( V_7 -> V_109 , 7372800 ) ;
V_2 -> V_196 = F_80 ( V_7 -> V_109 ) ;
F_66 ( V_193 L_12 , V_2 -> V_196 ) ;
V_159 = F_59 ( V_157 , V_163 ,
L_4 ) ;
if ( F_39 ( ! V_159 ) )
return - V_170 ;
