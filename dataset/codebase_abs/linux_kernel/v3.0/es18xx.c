...
V_43 = F_101 ( V_74 , V_182 , V_2 , & V_179 ) ;
if ( V_43 < 0 ) {
F_91 ( V_74 ) ;
return V_43 ;
}
...
int V_43 ;
unsigned int V_183 ;
strcpy ( V_74 -> V_184 , V_2 -> V_158 -> V_114 ) ;
for ( V_183 = 0 ; V_183 < F_103 ( V_185 ) ; V_183 ++ ) {
struct V_102 * V_186 ;
V_186 = F_104 ( & V_185 [ V_183 ] , V_2 ) ;
if ( V_2 -> V_30 & V_86 ) {
switch ( V_183 ) {
case 0 :
V_2 -> V_92 = V_186 ;
...
if ( ( V_43 = F_105 ( V_74 , V_186 ) ) < 0 )
return V_43 ;
}
if ( V_2 -> V_30 & V_38 ) {
for ( V_183 = 0 ; V_183 < F_103 ( V_188 ) ; V_183 ++ ) {
if ( ( V_43 = F_105 ( V_74 , F_104 ( & V_188 [ V_183 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
} else {
for ( V_183 = 0 ; V_183 < F_103 ( V_189 ) ; V_183 ++ ) {
if ( ( V_43 = F_105 ( V_74 , F_104 ( & V_189 [ V_183 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
}
if ( V_2 -> V_30 & V_147 ) {
for ( V_183 = 0 ; V_183 < F_103 ( V_190 ) ; V_183 ++ ) {
if ( ( V_43 = F_105 ( V_74 , F_104 ( & V_190 [ V_183 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
}
switch ( V_2 -> V_109 ) {
...
case 0x1869 :
case 0x1879 :
if ( ( V_43 = F_105 ( V_74 , F_104 ( & V_192 , V_2 ) ) ) < 0 )
return V_43 ;
break;
}
if ( V_2 -> V_30 & V_145 ) {
for ( V_183 = 0 ; V_183 < F_103 ( V_193 ) ; V_183 ++ ) {
if ( ( V_43 = F_105 ( V_74 , F_104 ( & V_193 [ V_183 ] , V_2 ) ) ) < 0 )
return V_43 ;
}
}
if ( V_2 -> V_30 & V_86 ) {
for ( V_183 = 0 ; V_183 < F_103 ( V_194 ) ; V_183 ++ ) {
struct V_102 * V_186 ;
V_186 = F_104 ( & V_194 [ V_183 ] , V_2 ) ;
if ( V_183 == 0 )
V_2 -> V_90 = V_186 ;
else
V_2 -> V_88 = V_186 ;
...
if ( V_2 -> V_109 != 0x1868 ) {
V_43 = F_105 ( V_74 , F_104 ( & V_195 ,
V_2 ) ) ;
if ( V_43 < 0 )
return V_43 ;
}
if ( V_2 -> V_109 == 0x1869 ) {
for ( V_183 = 0 ; V_183 < F_103 ( V_196 ) ; V_183 ++ ) {
V_43 = F_105 ( V_74 ,
F_104 ( & V_196 [ V_183 ] ,
V_2 ) ) ;
if ( V_43 < 0 )
...
V_43 = F_105 ( V_74 , F_104 ( & V_197 ,
V_2 ) ) ;
if ( V_43 < 0 )
return V_43 ;
} else if ( V_2 -> V_109 == 0x1879 ) {
for ( V_183 = 0 ; V_183 < F_103 ( V_198 ) ; V_183 ++ ) {
V_43 = F_105 ( V_74 ,
F_104 ( & V_198 [ V_183 ] ,
V_2 ) ) ;
if ( V_43 < 0 )
...
static int T_1 F_106 ( int V_199 , struct V_200 * V_201 )
{
if ( F_107 ( V_201 ) < 0 ) {
...
if ( F_108 ( V_201 ) ) {
F_109 ( F_110 ( V_201 ) , F_111 ( V_201 ) ) ;
F_112 ( 0x27 , F_113 ( V_201 , 0 ) ) ;
if ( V_139 [ V_199 ] != V_141 )
F_112 ( 0x28 , F_113 ( V_201 , 0 ) ) ;
F_112 ( 0x72 , F_113 ( V_201 , 0 ) ) ;
F_114 () ;
}
V_6 [ V_199 ] = F_115 ( V_201 , 0 ) ;
V_140 [ V_199 ] = F_115 ( V_201 , 1 ) ;
V_139 [ V_199 ] = F_115 ( V_201 , 2 ) ;
V_68 [ V_199 ] = F_116 ( V_201 , 0 ) ;
V_55 [ V_199 ] = F_116 ( V_201 , 1 ) ;
V_71 [ V_199 ] = F_113 ( V_201 , 0 ) ;
F_117 ( L_38 , V_6 [ V_199 ] , V_140 [ V_199 ] , V_139 [ V_199 ] ) ;
F_117 ( L_39 , V_68 [ V_199 ] , V_55 [ V_199 ] , V_71 [ V_199 ] ) ;
return 0 ;
}
static int T_1 F_118 ( int V_199 , struct V_1 * V_2 ,
struct V_200 * V_201 )
{
V_2 -> V_199 = V_201 ;
if ( F_106 ( V_199 , V_2 -> V_199 ) < 0 )
return - V_48 ;
return 0 ;
}
static int T_1 F_119 ( int V_199 , struct V_1 * V_2 ,
struct V_202 * V_74 ,
const struct V_203 * V_89 )
{
V_2 -> V_199 = F_120 ( V_74 , V_89 -> V_204 [ 0 ] . V_89 , NULL ) ;
if ( V_2 -> V_199 == NULL )
return - V_48 ;
V_2 -> V_205 = F_120 ( V_74 , V_89 -> V_204 [ 1 ] . V_89 , NULL ) ;
if ( V_2 -> V_205 == NULL )
return - V_48 ;
if ( F_107 ( V_2 -> V_205 ) < 0 ) {
F_4 (KERN_ERR PFX L_40 ) ;
return - V_95 ;
}
F_117 ( L_41 ,
( unsigned long long ) F_115 ( V_2 -> V_205 , 0 ) ) ;
if ( F_106 ( V_199 , V_2 -> V_199 ) < 0 )
return - V_48 ;
return 0 ;
}
static int F_121 ( int V_199 , struct V_73 * * V_206 )
{
return F_122 ( V_207 [ V_199 ] , V_89 [ V_199 ] , V_208 ,
sizeof( struct V_1 ) , V_206 ) ;
}
static int T_1 F_123 ( struct V_73 * V_74 , int V_199 )
{
struct V_1 * V_2 = V_74 -> V_75 ;
struct V_209 * V_210 ;
int V_43 ;
V_43 = F_97 ( V_74 ,
V_6 [ V_199 ] , V_139 [ V_199 ] , V_140 [ V_199 ] ,
V_71 [ V_199 ] , V_68 [ V_199 ] , V_55 [ V_199 ] ) ;
if ( V_43 < 0 )
return V_43 ;
sprintf ( V_74 -> V_211 , L_28 , V_2 -> V_109 ) ;
sprintf ( V_74 -> V_212 , L_29 , V_2 -> V_109 ) ;
if ( V_68 [ V_199 ] != V_55 [ V_199 ] )
sprintf ( V_74 -> V_213 , L_42 ,
V_74 -> V_212 ,
V_2 -> V_6 ,
V_71 [ V_199 ] , V_68 [ V_199 ] , V_55 [ V_199 ] ) ;
else
sprintf ( V_74 -> V_213 , L_43 ,
V_74 -> V_212 ,
V_2 -> V_6 ,
V_71 [ V_199 ] , V_68 [ V_199 ] ) ;
...
if ( V_43 < 0 )
return V_43 ;
if ( V_140 [ V_199 ] > 0 && V_140 [ V_199 ] != V_141 ) {
if ( F_124 ( V_74 , V_140 [ V_199 ] , V_140 [ V_199 ] + 2 ,
V_214 , 0 , & V_210 ) < 0 ) {
F_4 (KERN_WARNING PFX
L_44 ,
fm_port[dev]) ;
} else {
V_43 = F_125 ( V_210 , 0 , 1 , NULL ) ;
if ( V_43 < 0 )
return V_43 ;
}
}
if ( V_139 [ V_199 ] > 0 && V_139 [ V_199 ] != V_141 ) {
V_43 = F_126 ( V_74 , 0 , V_215 ,
V_139 [ V_199 ] , 0 ,
V_71 [ V_199 ] , 0 , & V_2 -> V_83 ) ;
if ( V_43 < 0 )
return V_43 ;
}
return F_127 ( V_74 ) ;
}
static int T_1 F_128 ( struct V_155 * V_201 , unsigned int V_199 )
{
return V_216 [ V_199 ] && ! F_129 ( V_199 ) ;
}
static int T_1 F_130 ( int V_199 , struct V_155 * V_217 )
{
struct V_73 * V_74 ;
int V_43 ;
V_43 = F_121 ( V_199 , & V_74 ) ;
if ( V_43 < 0 )
return V_43 ;
F_131 ( V_74 , V_217 ) ;
if ( ( V_43 = F_123 ( V_74 , V_199 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_43 ;
}
F_133 ( V_217 , V_74 ) ;
...
static int F_139 ( struct V_155 * V_199 , unsigned int V_223 ,
T_4 V_168 )
{
return F_87 ( F_138 ( V_199 ) , V_168 ) ;
}
static int F_140 ( struct V_155 * V_199 , unsigned int V_223 )
{
return F_90 ( F_138 ( V_199 ) ) ;
}
static int T_1 F_141 ( struct V_200 * V_201 ,
...
if ( F_108 ( V_201 ) )
return - V_225 ;
for (; V_199 < V_226 ; V_199 ++ ) {
if ( V_216 [ V_199 ] && V_227 [ V_199 ] )
break;
}
if ( V_199 >= V_226 )
return - V_9 ;
...
if ( V_43 < 0 )
return V_43 ;
if ( ( V_43 = F_118 ( V_199 , V_74 -> V_75 , V_201 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_43 ;
}
F_131 ( V_74 , & V_201 -> V_199 ) ;
if ( ( V_43 = F_123 ( V_74 , V_199 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_43 ;
}
...
static void T_5 F_143 ( struct V_200 * V_201 )
{
F_132 ( F_144 ( V_201 ) ) ;
F_142 ( V_201 , NULL ) ;
}
static int F_145 ( struct V_200 * V_201 , T_4 V_168 )
{
return F_87 ( F_144 ( V_201 ) , V_168 ) ;
}
static int F_146 ( struct V_200 * V_201 )
{
return F_90 ( F_144 ( V_201 ) ) ;
}
static int T_1 F_147 ( struct V_202 * V_228 ,
const struct V_203 * V_229 )
{
static int V_199 ;
struct V_73 * V_74 ;
int V_230 ;
...
if ( V_199 >= V_226 )
return - V_9 ;
V_230 = F_121 ( V_199 , & V_74 ) ;
if ( V_230 < 0 )
return V_230 ;
if ( ( V_230 = F_119 ( V_199 , V_74 -> V_75 , V_228 , V_229 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_230 ;
}
F_131 ( V_74 , & V_228 -> V_74 -> V_199 ) ;
if ( ( V_230 = F_123 ( V_74 , V_199 ) ) < 0 ) {
F_132 ( V_74 ) ;
return V_230 ;
}
F_148 ( V_228 , V_74 ) ;
...
static void T_5 F_149 ( struct V_202 * V_228 )
{
F_132 ( F_150 ( V_228 ) ) ;
F_148 ( V_228 , NULL ) ;
}
static int F_151 ( struct V_202 * V_228 , T_4 V_168 )
{
return F_87 ( F_150 ( V_228 ) , V_168 ) ;
}
static int F_152 ( struct V_202 * V_228 )
{
