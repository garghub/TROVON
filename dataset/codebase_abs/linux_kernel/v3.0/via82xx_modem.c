...
static int T_3 F_60 ( struct V_13 * V_14 )
{
struct V_126 * V_121 ;
int V_49 ;
V_14 -> V_118 = 0 ;
...
static int T_3 F_66 ( struct V_13 * V_14 )
{
struct V_143 V_47 ;
int V_49 ;
...
static void T_3 F_70 ( struct V_13 * V_14 )
{
struct V_154 * V_155 ;
...
static int F_79 ( struct V_5 * V_6 , T_4 V_173 )
{
struct V_174 * V_127 = F_80 ( V_6 ) ;
...
static int T_3 F_99 ( struct V_174 * V_127 ,
struct V_5 * V_6 ,
int V_181 ,
int V_182 ,
unsigned int V_150 ,
...
if ( ( V_49 = F_105 ( V_127 , V_189 , V_14 , & V_145 ) ) < 0 ) {
F_95 ( V_14 ) ;
return V_49 ;
}
F_93 ( V_6 ) ;
...
static int T_3 F_107 ( struct V_5 * V_6 ,
...
unsigned int V_9 ;
int V_49 ;
V_49 = F_108 ( V_193 , V_194 , V_195 , 0 , & V_127 ) ;
if ( V_49 < 0 )
return V_49 ;
V_192 = V_191 -> V_196 ;
switch ( V_192 ) {
...
static void T_5 F_112 ( struct V_5 * V_6 )
{
F_110 ( F_80 ( V_6 ) ) ;
F_111 ( V_6 , NULL ) ;
}
