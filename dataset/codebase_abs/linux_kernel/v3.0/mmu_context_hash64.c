...
void F_16 ( unsigned long V_7 , struct V_1 * V_19 )
{
int V_35 = V_28 ;
if ( ! F_11 ( V_23 ) )
return;
...
int F_19 ( struct V_39 * V_40 , struct V_1 * V_19 )
{
int V_12 ;
V_12 = F_18 () ;
if ( V_12 < 0 )
...
V_19 -> V_4 . V_42 = V_12 ;
#ifdef F_23
V_19 -> V_4 . V_27 = F_24 ( sizeof( T_1 ) , V_15 ) ;
if ( ! V_19 -> V_4 . V_27 ) {
F_25 ( V_12 ) ;
F_26 ( V_19 ) ;
V_19 -> V_4 . V_42 = V_43 ;
...
void F_28 ( struct V_1 * V_19 )
{
#ifdef F_23
F_16 ( V_19 -> V_4 . V_7 , V_19 ) ;
F_29 ( V_19 -> V_4 . V_27 ) ;
V_19 -> V_4 . V_27 = NULL ;
#endif
F_25 ( V_19 -> V_4 . V_42 ) ;
