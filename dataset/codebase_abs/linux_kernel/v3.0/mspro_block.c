...
static int F_10 ( struct V_4 * V_5 , T_1 V_3 )
{
return F_4 ( V_5 ) ;
}
...
V_44 = F_79 ( sizeof( struct V_27 ) , V_200 ) ;
if ( ! V_44 ) {
V_10 = - V_152 ;
goto V_209;
}
...
static int F_81 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_179 * V_156 = V_13 -> V_156 ;
int V_10 = 0 ;
...
F_89 ( V_8 -> V_157 , V_233 ) ;
F_90 ( V_8 -> V_157 , V_234 ) ;
F_91 ( V_8 -> V_157 ,
V_233 * V_8 -> V_59 ) ;
V_8 -> V_5 -> V_235 = V_235 ;
V_8 -> V_5 -> V_236 = V_18 << V_19 ;
V_8 -> V_5 -> V_237 = & V_238 ;
V_8 -> V_14 = 1 ;
V_8 -> V_5 -> V_9 = V_8 ;
V_8 -> V_5 -> V_157 = V_8 -> V_157 ;
V_8 -> V_5 -> V_239 = & V_13 -> V_42 ;
sprintf ( V_8 -> V_5 -> V_240 , L_79 , V_18 ) ;
...
struct V_7 * V_8 ;
int V_10 = 0 ;
V_8 = F_79 ( sizeof( struct V_7 ) , V_200 ) ;
if ( ! V_8 )
return - V_152 ;
F_98 ( V_13 , V_8 ) ;
V_8 -> V_13 = V_13 ;
...
if ( V_10 )
goto V_242;
V_10 = F_100 ( & V_13 -> V_42 . V_243 , & V_8 -> V_207 ) ;
if ( V_10 )
goto V_242;
V_10 = F_82 ( V_13 ) ;
if ( ! V_10 ) {
...
F_101 ( & V_13 -> V_42 . V_243 , & V_8 -> V_207 ) ;
V_242:
F_98 ( V_13 , NULL ) ;
F_95 ( V_8 ) ;
F_7 ( V_8 ) ;
...
static int F_105 ( struct V_99 * V_13 , T_6 V_247 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
struct V_7 * V_248 ;
struct V_179 * V_156 = V_13 -> V_156 ;
struct V_27 * V_44 , * V_249 ;
unsigned char V_45 ;
F_2 ( & V_156 -> V_250 ) ;
V_248 = F_79 ( sizeof( struct V_7 ) , V_200 ) ;
if ( ! V_248 ) {
V_10 = - V_152 ;
goto V_251;
}
...
if ( F_81 ( V_13 ) )
goto V_242;
for ( V_45 = 0 ; V_248 -> V_207 . V_208 [ V_45 ]
&& V_8 -> V_207 . V_208 [ V_45 ] ; ++ V_45 ) {
V_44 = F_12 ( V_248 -> V_207 . V_208 [ V_45 ] ) ;
V_249 = F_12 ( V_8 -> V_207 . V_208 [ V_45 ] ) ;
if ( V_44 -> V_212 == V_33
&& V_249 -> V_212 == V_44 -> V_212 ) {
if ( memcmp ( V_44 -> V_48 , V_249 -> V_48 , V_44 -> V_46 ) )
break;
V_8 -> V_241 = 1 ;
break;
}
