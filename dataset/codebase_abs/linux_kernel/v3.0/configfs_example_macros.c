...
static inline struct V_18 * F_15 ( struct V_2 * V_3 )
{
return V_3 ? F_2 ( F_4 ( V_3 ) , struct V_18 , V_19 ) : NULL ;
}
static struct V_2 * F_16 ( struct V_20 * V_19 , const char * V_21 )
{
struct V_15 * V_15 ;
V_15 = F_17 ( sizeof( struct V_15 ) , V_22 ) ;
if ( ! V_15 )
return F_18 ( - V_23 ) ;
F_19 ( & V_15 -> V_3 , V_21 ,
& V_24 ) ;
...
static struct V_20 * F_22 ( struct V_20 * V_19 , const char * V_21 )
{
struct V_18 * V_18 ;
V_18 = F_17 ( sizeof( struct V_18 ) ,
V_22 ) ;
if ( ! V_18 )
return F_18 ( - V_23 ) ;
F_23 ( & V_18 -> V_19 , V_21 ,
