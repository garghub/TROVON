...
{
const struct V_10 * V_11 = V_2 -> V_6 . V_44 ;
struct V_8 * V_9 ;
struct V_12 * V_12 ;
int V_5 ;
int error ;
...
V_9 = F_25 ( sizeof( struct V_8 ) , V_47 ) ;
V_12 = F_26 () ;
if ( ! V_9 || ! V_12 ) {
F_3 ( & V_2 -> V_6 , L_9 ) ;
error = - V_48 ;
...
V_12 -> V_53 = F_20 ;
V_12 -> V_54 = F_22 ;
V_12 -> V_6 . V_55 = & V_2 -> V_6 ;
V_12 -> V_56 [ 0 ] = F_27 ( V_57 ) | F_27 ( V_58 ) ;
V_12 -> V_59 = sizeof( V_9 -> V_22 [ 0 ] ) ;
V_12 -> V_60 = F_28 ( V_9 -> V_22 ) ;
V_12 -> V_21 = V_9 -> V_22 ;
F_29 ( V_12 , V_30 , V_31 ) ;
F_30 ( V_12 , V_9 ) ;
F_6 ( V_9 , V_11 ) ;
error = F_31 ( V_2 -> V_25 , NULL , F_13 ,
V_61 | V_62 ,
V_2 -> V_50 , V_9 ) ;
if ( error ) {
F_3 ( & V_2 -> V_6 , L_10 ) ;
...
static int T_4 F_38 ( struct V_1 * V_2 )
{
...
static int F_41 ( struct V_64 * V_6 )
{
...
static int F_45 ( struct V_64 * V_6 )
{
struct V_1 * V_2 = F_42 ( V_6 ) ;
if ( F_43 ( & V_2 -> V_6 ) )
F_46 ( V_2 -> V_25 ) ;
