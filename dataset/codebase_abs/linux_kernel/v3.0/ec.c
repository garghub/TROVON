...
static int F_52 ( struct V_1 * V_2 , T_1 * V_8 )
{
int V_57 ;
T_1 V_52 ;
...
int F_53 ( struct V_1 * V_2 , T_1 V_67 ,
T_3 V_68 , T_4 V_69 ,
void * V_8 )
{
struct V_70 * V_71 =
F_54 ( sizeof( struct V_70 ) , V_72 ) ;
if ( ! V_71 )
return - V_73 ;
V_71 -> V_67 = V_67 ;
V_71 -> V_68 = V_68 ;
...
V_71 -> V_8 = V_8 ;
F_28 ( & V_2 -> V_43 ) ;
F_55 ( & V_71 -> V_74 , & V_2 -> V_75 ) ;
F_39 ( & V_2 -> V_43 ) ;
return 0 ;
}
void F_56 ( struct V_1 * V_2 , T_1 V_67 )
{
struct V_70 * V_71 , * V_39 ;
F_28 ( & V_2 -> V_43 ) ;
F_57 (handler, tmp, &ec->list, node) {
if ( V_67 == V_71 -> V_67 ) {
F_58 ( & V_71 -> V_74 ) ;
F_59 ( V_71 ) ;
}
...
if ( ( V_17 = F_52 ( V_2 , & V_77 ) ) )
return V_17 ;
F_62 (handler, &ec->list, node) {
if ( V_77 == V_71 -> V_67 ) {
V_78 = F_63 ( sizeof( * V_71 ) , V_72 ) ;
if ( ! V_78 )
return - V_73 ;
memcpy ( V_78 , V_71 , sizeof( * V_78 ) ) ;
F_3 ( V_5 L_14 , V_77 ) ;
return F_64 ( ( V_78 -> V_69 ) ?
V_79 : V_80 ,
F_60 , V_78 ) ;
}
}
...
static int F_66 ( struct V_1 * V_2 , T_1 V_26 )
{
if ( V_26 & V_27 ) {
if ( ! F_15 ( V_28 , & V_2 -> V_9 ) ) {
F_3 ( V_5 L_15 ) ;
...
static struct V_1 * F_70 ( void )
{
struct V_1 * V_2 = F_54 ( sizeof( struct V_1 ) , V_72 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_9 = 1 << V_28 ;
F_71 ( & V_2 -> V_43 ) ;
...
int V_77 = 0 ;
T_5 V_17 ;
V_17 = F_76 ( V_68 , V_105 , & V_104 ) ;
if ( F_77 ( V_17 ) && sscanf ( V_102 , L_17 , & V_77 ) == 1 ) {
F_53 ( V_2 , V_77 , V_68 , NULL , NULL ) ;
}
return V_98 ;
}
static T_5
F_78 ( T_3 V_68 , T_2 V_106 , void * V_100 , void * * V_107 )
{
T_5 V_17 ;
unsigned long long V_39 = 0 ;
struct V_1 * V_2 = V_100 ;
V_2 -> V_4 = V_2 -> V_6 = 0 ;
V_17 = F_79 ( V_68 , V_108 ,
V_109 , V_2 ) ;
if ( F_31 ( V_17 ) )
return V_17 ;
V_17 = F_80 ( V_68 , L_18 , NULL , & V_39 ) ;
if ( F_31 ( V_17 ) )
return V_17 ;
V_2 -> V_50 = V_39 ;
V_39 = 0 ;
F_80 ( V_68 , L_19 , NULL , & V_39 ) ;
V_2 -> V_45 = V_39 ;
V_2 -> V_68 = V_68 ;
return V_110 ;
}
...
{
F_33 ( NULL , V_2 -> V_50 ) ;
if ( F_31 ( F_87 ( V_2 -> V_68 ,
V_113 , & F_69 ) ) )
F_32 ( V_5 L_22 ) ;
if ( F_31 ( F_85 ( NULL , V_2 -> V_50 ,
& F_67 ) ) )
F_32 ( V_5 L_23 ) ;
F_24 ( V_111 , & V_2 -> V_9 ) ;
}
...
struct V_1 * V_2 = NULL ;
int V_10 ;
strcpy ( F_89 ( V_116 ) , V_117 ) ;
strcpy ( F_90 ( V_116 ) , V_118 ) ;
if ( V_119 &&
( V_119 -> V_68 == V_116 -> V_68 ||
V_119 -> V_68 == V_120 ) ) {
V_2 = V_119 ;
V_119 = NULL ;
} else {
...
if ( F_78 ( V_116 -> V_68 , 0 , V_2 , NULL ) !=
V_110 ) {
F_59 ( V_2 ) ;
return - V_42 ;
}
F_91 ( V_121 , V_2 -> V_68 , 1 ,
F_75 , NULL , V_2 , NULL ) ;
if ( ! V_60 )
V_60 = V_2 ;
V_116 -> V_122 = V_2 ;
F_92 ( ! F_93 ( V_2 -> V_6 , 1 , L_24 ) ,
L_25 , V_2 -> V_6 ) ;
F_92 ( ! F_93 ( V_2 -> V_4 , 1 , L_26 ) ,
L_27 , V_2 -> V_4 ) ;
F_36 ( V_5 L_28 ,
...
static int F_94 ( struct V_115 * V_116 , int type )
{
struct V_1 * V_2 ;
struct V_70 * V_71 , * V_39 ;
if ( ! V_116 )
...
static int F_98 ( const struct V_129 * V_130 )
{
V_131 = 1 ;
return 0 ;
}
...
V_119 -> V_68 = V_120 ;
F_104 ( V_120 , V_135 -> V_130 , & V_119 -> V_68 ) ;
if ( ! V_132 )
goto V_140;
V_133 = F_105 ( V_119 , sizeof( struct V_1 ) , V_72 ) ;
if ( ! V_133 )
return - V_73 ;
}
if ( V_131 )
return - V_47 ;
F_84 (KERN_DEBUG PREFIX L_31 ) ;
V_17 = F_106 ( V_141 [ 0 ] . V_130 , F_78 ,
V_119 , NULL ) ;
if ( F_31 ( V_17 ) || ! V_119 -> V_68 )
goto error;
if ( V_133 ) {
if ( V_133 -> V_4 != V_119 -> V_4 ||
V_133 -> V_6 != V_119 -> V_6 ||
V_133 -> V_50 != V_119 -> V_50 ||
V_133 -> V_68 != V_119 -> V_68 )
F_36 ( V_5 L_32
L_33
L_34
L_35 ) ;
