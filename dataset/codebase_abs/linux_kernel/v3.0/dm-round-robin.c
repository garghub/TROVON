...
if ( ( V_14 == 1 ) && ( sscanf ( V_15 [ 0 ] , L_4 , & V_26 ) != 1 ) ) {
* error = L_5 ;
return - V_28 ;
}
...
static void F_14 ( struct V_12 * V_13 , struct V_18 * V_29 )
{
struct V_7 * V_8 = (struct V_7 * ) V_13 -> V_17 ;
struct V_3 * V_4 = V_29 -> V_25 ;
F_15 ( & V_4 -> V_6 , & V_8 -> V_11 ) ;
}
static int F_16 ( struct V_12 * V_13 , struct V_18 * V_29 )
{
struct V_7 * V_8 = (struct V_7 * ) V_13 -> V_17 ;
struct V_3 * V_4 = V_29 -> V_25 ;
