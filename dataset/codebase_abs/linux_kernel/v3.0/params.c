...
static T_4 int F_43 ( struct V_68 * V_69 ,
...
V_28 = V_69 -> V_74 -> V_28 ;
V_72 = V_69 -> V_74 -> V_75 . V_72 ;
}
V_71 = F_44 ( V_69 -> V_74 ,
sizeof( * V_69 -> V_74 ) + sizeof( V_69 -> V_74 -> V_72 [ 0 ] ) * ( V_28 + 1 ) ,
V_4 ) ;
if ( ! V_71 ) {
F_7 ( V_69 -> V_74 ) ;
V_16 = - V_36 ;
...
V_72 = F_44 ( V_72 , sizeof( V_71 -> V_75 . V_72 [ 0 ] ) * ( V_28 + 2 ) , V_4 ) ;
if ( ! V_72 ) {
V_16 = - V_36 ;
goto V_77;
}
memset ( V_71 , 0 , sizeof( * V_71 ) ) ;
memset ( & V_71 -> V_72 [ V_28 ] , 0 , sizeof( V_71 -> V_72 [ V_28 ] ) ) ;
memset ( & V_72 [ V_28 ] , 0 , sizeof( V_72 [ V_28 ] ) ) ;
V_71 -> V_75 . V_17 = L_20 ;
V_71 -> V_75 . V_72 = V_72 ;
F_45 ( & V_71 -> V_72 [ V_28 ] . V_59 . V_78 ) ;
V_71 -> V_72 [ V_28 ] . V_8 = V_34 ;
V_71 -> V_72 [ V_28 ] . V_59 . V_79 = F_38 ;
V_71 -> V_72 [ V_28 ] . V_59 . V_80 = F_40 ;
V_71 -> V_72 [ V_28 ] . V_59 . V_78 . V_17 = ( char * ) V_17 ;
V_71 -> V_72 [ V_28 ] . V_59 . V_78 . V_81 = V_34 -> V_73 ;
V_71 -> V_28 = V_28 + 1 ;
for ( V_28 = 0 ; V_28 < V_71 -> V_28 ; V_28 ++ )
V_71 -> V_75 . V_72 [ V_28 ] = & V_71 -> V_72 [ V_28 ] . V_59 . V_78 ;
V_71 -> V_75 . V_72 [ V_28 ] = NULL ;
V_69 -> V_74 = V_71 ;
return 0 ;
V_77:
F_7 ( V_71 ) ;
...
if ( V_82 [ V_12 ] . V_73 == 0 )
continue;
V_16 = F_43 ( & V_61 -> V_83 , & V_82 [ V_12 ] , V_82 [ V_12 ] . V_17 ) ;
if ( V_16 )
return V_16 ;
V_14 = true ;
}
if ( ! V_14 )
return 0 ;
V_16 = F_48 ( & V_61 -> V_83 . V_84 , & V_61 -> V_83 . V_74 -> V_75 ) ;
if ( V_16 )
F_46 ( & V_61 -> V_83 ) ;
return V_16 ;
}
void F_49 ( struct V_60 * V_61 )
{
if ( V_61 -> V_83 . V_74 ) {
F_50 ( & V_61 -> V_83 . V_84 , & V_61 -> V_83 . V_74 -> V_75 ) ;
F_46 ( & V_61 -> V_83 ) ;
}
}
...
static struct V_68 * T_5 F_52 ( const char * V_17 )
{
struct V_68 * V_69 ;
struct V_85 * V_84 ;
int V_16 ;
...
V_69 = F_55 ( sizeof( struct V_68 ) , V_4 ) ;
F_30 ( ! V_69 ) ;
V_69 -> V_61 = V_87 ;
V_69 -> V_84 . V_88 = V_86 ;
V_16 = F_56 ( & V_69 -> V_84 , & V_89 , NULL ,
L_12 , V_17 ) ;
if ( V_16 ) {
F_57 ( & V_69 -> V_84 ) ;
F_20 ( V_32
...
static void T_5 F_59 ( const char * V_17 ,
struct V_13 * V_82 ,
unsigned int V_90 )
{
struct V_68 * V_69 ;
...
return;
if ( V_69 -> V_74 )
F_50 ( & V_69 -> V_84 , & V_69 -> V_74 -> V_75 ) ;
V_16 = F_43 ( V_69 , V_82 , V_82 -> V_17 + V_90 ) ;
F_30 ( V_16 ) ;
V_16 = F_48 ( & V_69 -> V_84 , & V_69 -> V_74 -> V_75 ) ;
F_30 ( V_16 ) ;
F_60 ( & V_69 -> V_84 , V_91 ) ;
F_57 ( & V_69 -> V_84 ) ;
}
...
unsigned int V_92 ;
char V_93 [ V_94 ] ;
for ( V_34 = V_95 ; V_34 < V_96 ; V_34 ++ ) {
char * V_97 ;
if ( V_34 -> V_73 == 0 )
continue;
V_97 = strchr ( V_34 -> V_17 , '.' ) ;
if ( ! V_97 ) {
strcpy ( V_93 , L_23 ) ;
V_92 = 0 ;
} else {
V_92 = V_97 - V_34 -> V_17 + 1 ;
F_37 ( V_93 , V_34 -> V_17 , V_92 ) ;
}
F_59 ( V_93 , V_34 , V_92 ) ;
}
}
T_2 F_62 ( struct V_58 * V_59 ,
struct V_60 * V_61 , char * V_62 )
{
struct V_98 * V_99 =
F_63 ( V_59 , struct V_98 , V_59 ) ;
return sprintf ( V_62 , L_24 , V_99 -> V_100 ) ;
}
static void T_5 F_64 ( void )
{
const struct V_98 * * V_3 ;
struct V_68 * V_69 ;
int V_16 ;
for ( V_3 = V_101 ; V_3 < V_102 ; V_3 ++ ) {
const struct V_98 * V_99 = * V_3 ;
V_69 = F_52 ( V_99 -> V_103 ) ;
if ( V_69 ) {
V_16 = F_65 ( & V_69 -> V_84 , & V_99 -> V_59 . V_78 ) ;
F_60 ( & V_69 -> V_84 , V_91 ) ;
F_57 ( & V_69 -> V_84 ) ;
}
}
}
static T_2 F_66 ( struct V_85 * V_84 ,
struct V_65 * V_78 ,
char * V_62 )
{
struct V_58 * V_65 ;
...
if ( ! V_65 -> V_79 )
return - V_104 ;
V_29 = V_65 -> V_79 ( V_65 , V_69 -> V_61 , V_62 ) ;
return V_29 ;
}
static T_2 F_68 ( struct V_85 * V_84 ,
struct V_65 * V_78 ,
const char * V_62 , T_3 V_48 )
{
struct V_58 * V_65 ;
...
if ( ! V_65 -> V_80 )
return - V_104 ;
V_29 = V_65 -> V_80 ( V_65 , V_69 -> V_61 , V_62 , V_48 ) ;
return V_29 ;
}
static int F_69 ( struct V_88 * V_88 , struct V_85 * V_84 )
{
struct V_105 * V_106 = F_70 ( V_84 ) ;
if ( V_106 == & V_89 )
return 1 ;
return 0 ;
}
