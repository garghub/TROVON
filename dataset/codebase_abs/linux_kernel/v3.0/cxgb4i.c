...
if ( V_5 -> V_19 < 0 ) {
F_82 ( L_43 , V_227 -> V_231 ) ;
return - V_232 ;
}
F_32 ( V_5 , V_131 ) ;
F_83 ( V_5 ) ;
V_5 -> V_21 = F_138 ( V_130 -> V_21 , V_5 -> V_225 -> V_233 , V_227 , 0 ) ;
if ( ! V_5 -> V_21 ) {
F_82 ( L_44 , V_227 -> V_231 ) ;
goto V_234;
}
F_83 ( V_5 ) ;
...
F_34 ( V_2 , V_5 , V_166 ) ;
if ( ! V_5 -> V_235 )
V_5 -> V_235 = F_139 ( V_5 -> V_225 ) ;
F_140 ( V_130 -> V_149 , V_5 -> V_235 , & V_5 -> V_15 ) ;
V_5 -> V_23 = F_141 ( V_227 ) ;
V_5 -> V_24 = ( ( F_142 ( V_227 ) & 0x7F ) ) << 1 ;
V_230 = V_130 -> V_236 / V_130 -> V_237 ;
V_5 -> V_238 = F_143 ( V_227 ) * V_230 ;
V_230 = V_130 -> V_239 / V_130 -> V_237 ;
V_5 -> V_20 = V_130 -> V_240 [ F_143 ( V_227 ) * V_230 ] ;
...
F_21 ( 1 << V_42 | 1 << V_43 ,
L_45 ,
V_5 , V_229 -> V_29 , V_227 -> V_231 , V_5 -> V_23 ,
...
int F_144 ( struct V_133 * V_44 )
{
int V_241 ;
if ( V_242 > V_243 )
V_242 = V_243 ;
V_241 = F_145 ( V_44 , V_244 ,
V_242 ) ;
if ( V_241 < 0 )
return V_241 ;
V_44 -> V_245 = F_132 ;
...
static inline void F_146 ( struct V_252 * V_13 ,
unsigned int V_253 , unsigned int V_108 ,
unsigned int V_254 )
{
struct V_255 * V_256 = (struct V_255 * ) ( V_13 + 1 ) ;
F_147 ( V_13 , V_253 , 0 , 0 ) ;
V_13 -> V_58 = F_35 ( F_148 ( V_257 ) | ( 1 << 23 ) ) ;
V_13 -> V_108 = F_35 ( F_149 ( V_108 >> 5 ) ) ;
V_13 -> V_258 = F_35 ( F_150 ( V_254 >> 5 ) ) ;
V_13 -> V_259 = F_35 ( F_45 ( V_253 - sizeof( V_13 -> V_260 ) , 16 ) ) ;
V_256 -> V_261 = F_35 ( F_148 ( V_262 ) ) ;
V_256 -> V_7 = F_35 ( V_108 ) ;
}
static int F_151 ( struct V_133 * V_44 , unsigned int V_29 ,
...
unsigned int V_253 = F_152 ( sizeof( struct V_252 ) +
...
F_154 ( V_272 , V_264 , V_267 , V_268 ) ;
}
F_28 ( V_44 -> V_45 [ V_29 ] , V_2 ) ;
return 0 ;
}
static int F_155 ( struct V_4 * V_5 , struct V_263 * V_264 ,
...
if ( V_81 > V_277 )
V_81 = V_277 ;
V_187 = F_151 ( V_5 -> V_44 , V_5 -> V_29 , V_264 ,
...
static void F_156 ( struct V_278 * V_279 , unsigned int V_280 ,
unsigned int V_22 , unsigned int V_265 )
{
unsigned int V_88 , V_81 ;
int V_187 ;
...
if ( V_81 > V_277 )
V_81 = V_277 ;
V_187 = F_151 ( V_279 -> V_44 , V_279 -> V_29 , NULL ,
V_22 , V_81 , NULL , 0 ) ;
if ( V_187 < 0 )
break;
}
}
static int F_157 ( struct V_4 * V_5 , unsigned int V_48 ,
...
V_13 -> V_286 = F_158 ( F_159 ( V_282 ) | F_160 ( V_5 -> V_20 ) ) ;
V_13 -> V_287 = F_158 ( 0 ) ;
V_13 -> V_288 = F_20 ( 0x3 << 8 ) ;
V_13 -> V_95 = F_20 ( V_281 << 8 ) ;
F_15 ( V_2 , V_275 , V_5 -> V_29 ) ;
F_21 ( 1 << V_42 | 1 << V_43 ,
L_48 , V_5 , V_5 -> V_48 , V_281 ) ;
F_28 ( V_5 -> V_44 -> V_45 [ V_5 -> V_29 ] , V_2 ) ;
return 0 ;
}
static int F_161 ( struct V_4 * V_5 , unsigned int V_48 ,
...
F_15 ( V_2 , V_275 , V_5 -> V_29 ) ;
F_21 ( 1 << V_42 | 1 << V_43 ,
L_49 , V_5 , V_5 -> V_48 , V_289 , V_290 ) ;
F_28 ( V_5 -> V_44 -> V_45 [ V_5 -> V_29 ] , V_2 ) ;
return 0 ;
}
static int F_162 ( struct V_133 * V_44 )
{
struct V_129 * V_130 = F_72 ( V_44 ) ;
struct V_269 * V_270 = V_44 -> V_270 ;
...
V_187 = F_165 ( V_44 , V_130 -> V_298 -> V_299 . V_300 ,
...
F_166 ( V_295 ) ;
F_167 ( V_130 -> V_45 [ 0 ] , V_294 , V_295 ) ;
V_44 -> V_305 = F_161 ;
V_44 -> V_306 = F_157 ;
V_44 -> V_307 = F_155 ;
V_44 -> V_308 = F_156 ;
...
static void * F_168 ( const struct V_129 * V_130 )
{
struct V_133 * V_44 ;
struct V_228 * V_229 ;
int V_88 , V_241 ;
V_44 = F_169 ( sizeof( * V_130 ) , V_130 -> V_321 ) ;
if ( ! V_44 ) {
F_40 ( L_55 , V_130 ) ;
return NULL ;
}
...
V_130 -> V_45 [ 0 ] -> V_231 , V_130 -> V_237 , V_130 -> V_236 ,
...
V_44 -> V_335 = & V_336 ;
V_44 -> V_96 = F_170 ( F_142 ( V_130 -> V_45 [ 0 ] ) ) << 8 ;
F_40 ( L_58 ,
V_44 , V_130 -> V_45 [ 0 ] -> V_231 , V_44 -> V_96 ) ;
V_241 = F_162 ( V_44 ) ;
if ( V_241 ) {
F_40 ( L_59 , V_44 ) ;
goto V_337;
...
static int F_174 ( void * V_55 , const T_2 * V_343 ,
...
if ( ! V_2 )
goto V_348;
F_175 ( V_2 , & V_343 [ 1 ] , V_7 ) ;
} else {
if ( F_30 ( * ( V_349 * ) V_343 != * ( V_349 * ) V_345 -> V_350 ) ) {
F_40 ( L_61 ,
V_345 -> V_350 , F_176 ( * V_343 ) ,
F_176 ( * ( V_351 * ) V_345 -> V_350 ) ,
V_345 -> V_352 ) ;
return 0 ;
}
V_2 = F_177 ( V_345 , V_353 , V_353 ) ;
if ( F_30 ( ! V_2 ) )
goto V_348;
}
...
static int F_178 ( void * V_55 , enum V_358 V_49 )
{
struct V_133 * V_44 = V_55 ;
switch ( V_49 ) {
case V_359 :
...
{
int V_241 ;
F_180 ( V_363 L_70 , V_364 ) ;
V_241 = F_181 ( & V_336 , & V_341 ) ;
if ( V_241 < 0 )
return V_241 ;
F_182 ( V_365 , & V_366 ) ;
return 0 ;
