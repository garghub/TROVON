...
F_7 ( V_9 , V_10 , 8 * sizeof( V_19 ) + sizeof( V_20 ) , V_18 ) ;
V_2 -> V_21 = F_8 ( V_9 ) ;
V_2 -> V_22 = F_8 ( V_9 ) ;
V_2 -> V_23 = F_8 ( V_9 ) ;
V_2 -> V_24 = F_8 ( V_9 ) ;
...
V_2 -> V_27 = F_9 ( V_9 ) ;
V_2 -> V_6 = F_8 ( V_9 ) ;
V_2 -> V_7 = F_10 ( V_2 -> V_6 , sizeof( * V_2 -> V_7 ) , V_16 ) ;
if ( V_2 -> V_7 == NULL )
goto V_28;
V_3 = F_8 ( V_9 ) ;
...
void * V_38 = NULL ;
struct V_39 V_40 ;
F_7 ( V_9 , V_10 , sizeof( V_20 ) * 2 + 1 + sizeof( V_19 ) , V_18 ) ;
V_29 = F_9 ( V_9 ) ;
V_34 = F_11 ( V_9 ) ;
* V_9 += sizeof( V_20 ) ;
V_30 = F_8 ( V_9 ) ;
...
V_8 = F_8 ( V_9 ) ;
V_33 = F_9 ( V_9 ) ;
F_12 ( V_9 , & V_36 , sizeof( V_36 ) ) ;
F_13 ( & V_36 ) ;
F_12 ( V_9 , & V_40 , sizeof( V_40 ) ) ;
* V_9 += sizeof( V_19 ) ;
F_14 ( V_9 , V_10 , V_30 , V_18 ) ;
* V_9 += V_30 ;
if ( V_34 >= 2 ) {
F_14 ( V_9 , V_10 , V_37 , V_18 ) ;
V_38 = * V_9 ;
...
F_14 ( V_9 , V_10 , V_3 , V_18 ) ;
V_2 -> V_46 = V_3 ;
V_2 -> V_47 = F_10 ( V_3 , sizeof( V_19 ) , V_16 ) ;
if ( ! V_2 -> V_47 )
goto V_28;
F_7 ( V_9 , V_10 , sizeof( V_19 ) * ( V_3 + 1 ) , V_18 ) ;
for ( V_4 = 0 ; V_4 < V_3 ; V_4 ++ )
V_2 -> V_47 [ V_4 ] = F_8 ( V_9 ) ;
V_2 -> V_48 = F_8 ( V_9 ) ;
F_15 ( L_2 , V_2 -> V_21 ) ;
return V_2 ;
V_28:
