...
int F_12 ( struct V_26 * V_27 , const char * V_67 , ... )
{
T_3 args ;
int V_57 ;
...
static int F_27 ( struct V_69 * V_69 )
{
struct V_38 * V_39 ;
V_39 = F_10 ( sizeof( * V_39 ) , V_45 ) ;
if ( ! V_39 )
return - V_46 ;
V_39 -> V_56 = F_28 ( V_69 , V_70 ,
1 , NULL , NULL , V_71 ) ;
if ( ! V_39 -> V_56 ) {
F_29 ( V_68
L_21 ) ;
...
static void F_31 ( struct V_69 * V_69 )
{
struct V_38 * V_39 ;
F_16 ( & V_55 ) ;
F_17 (ue_sk, &uevent_sock_list, list) {
if ( F_32 ( V_39 -> V_56 ) == V_69 )
goto V_75;
}
F_22 ( & V_55 ) ;
return;
