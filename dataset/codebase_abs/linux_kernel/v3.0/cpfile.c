...
void * V_11 ;
unsigned long V_37 ;
int V_26 , V_38 , V_39 , V_15 , V_40 ;
if ( F_25 ( V_35 == 0 || V_35 > V_36 ) ) {
F_41 ( V_41 L_1
L_2 , V_42 ,
( unsigned long long ) V_35 , ( unsigned long long ) V_36 ) ;
return - V_27 ;
}
F_27 ( & F_2 ( V_2 ) -> V_28 ) ;
V_26 = F_19 ( V_2 , & V_23 ) ;
...
goto V_29;
V_37 = 0 ;
for ( V_4 = V_35 ; V_4 < V_36 ; V_4 += V_38 ) {
V_38 = F_6 ( V_2 , V_4 , V_36 ) ;
...
V_11 = F_34 ( V_24 -> V_31 , V_33 ) ;
V_14 = F_16 (
V_2 , V_4 , V_24 , V_11 ) ;
V_39 = 0 ;
for ( V_40 = 0 ; V_40 < V_38 ; V_40 ++ , V_14 = ( void * ) V_14 + V_19 ) {
F_14 ( F_42 ( V_14 ) ) ;
if ( ! F_29 ( V_14 ) ) {
F_18 ( V_14 ) ;
V_39 ++ ;
...
struct V_44 * V_45 )
{
V_45 -> V_46 = F_11 ( V_14 -> V_47 ) ;
V_45 -> V_48 = F_44 ( V_14 -> V_49 ) ;
V_45 -> V_50 = F_44 ( V_14 -> V_51 ) ;
V_45 -> V_52 = F_44 ( V_14 -> V_53 ) ;
V_45 -> V_54 = F_44 ( V_14 -> V_55 ) ;
V_45 -> V_56 = F_44 ( V_14 -> V_57 ) ;
V_45 -> V_58 = F_44 ( V_14 -> V_59 . V_60 ) ;
}
static T_3 F_45 ( struct V_1 * V_2 , T_1 * V_61 ,
void * V_62 , unsigned V_63 , T_2 V_64 )
{
struct V_13 * V_14 ;
struct V_44 * V_45 = V_62 ;
struct V_9 * V_10 ;
T_2 V_19 = F_2 ( V_2 ) -> V_18 ;
T_1 V_65 = F_26 ( V_2 ) , V_4 = * V_61 ;
void * V_11 ;
int V_12 , V_26 ;
int V_38 , V_40 ;
if ( V_4 == 0 )
return - V_32 ;
F_46 ( & F_2 ( V_2 ) -> V_28 ) ;
for ( V_12 = 0 ; V_4 < V_65 && V_12 < V_64 ; V_4 += V_38 ) {
V_38 = F_6 ( V_2 , V_4 , V_65 ) ;
...
V_11 = F_34 ( V_10 -> V_31 , V_33 ) ;
V_14 = F_16 ( V_2 , V_4 , V_10 , V_11 ) ;
for ( V_40 = 0 ; V_40 < V_38 && V_12 < V_64 ; V_40 ++ , V_14 = ( void * ) V_14 + V_19 ) {
if ( ! F_29 ( V_14 ) ) {
F_43 ( V_2 , V_14 ,
V_45 ) ;
V_45 = ( void * ) V_45 + V_63 ;
...
static T_3 F_48 ( struct V_1 * V_2 , T_1 * V_61 ,
void * V_62 , unsigned V_63 , T_2 V_64 )
{
struct V_9 * V_10 ;
struct V_17 * V_25 ;
...
T_3 F_49 ( struct V_1 * V_2 , T_1 * V_61 , int V_71 ,
void * V_62 , unsigned V_63 , T_2 V_64 )
{
switch ( V_71 ) {
case V_72 :
return F_45 ( V_2 , V_61 , V_62 , V_63 , V_64 ) ;
case V_73 :
return F_48 ( V_2 , V_61 , V_62 , V_63 , V_64 ) ;
default:
return - V_27 ;
}
}
...
T_1 V_5 = V_4 ;
T_3 V_64 ;
V_64 = F_45 ( V_2 , & V_5 , & V_45 , sizeof( V_45 ) , 1 ) ;
if ( V_64 < 0 )
return V_64 ;
else if ( V_64 == 0 || V_45 . V_48 != V_4 )
return - V_32 ;
else if ( F_51 ( & V_45 ) )
return - V_74 ;
...
V_11 = F_34 ( V_24 -> V_31 , V_33 ) ;
V_14 = F_16 ( V_2 , V_4 , V_24 , V_11 ) ;
V_14 -> V_59 . V_60 = F_55 ( V_7 ) ;
V_14 -> V_59 . V_82 = F_55 ( V_79 ) ;
F_56 ( V_14 ) ;
F_36 ( V_11 , V_33 ) ;
V_11 = F_34 ( V_78 -> V_31 , V_33 ) ;
V_76 = F_52 (
V_2 , V_79 , V_78 , V_11 ) ;
V_76 -> V_60 = F_55 ( V_4 ) ;
F_36 ( V_11 , V_33 ) ;
...
V_11 = F_34 ( V_24 -> V_31 , V_33 ) ;
V_14 = F_16 ( V_2 , V_4 , V_24 , V_11 ) ;
V_14 -> V_59 . V_60 = F_55 ( 0 ) ;
V_14 -> V_59 . V_82 = F_55 ( 0 ) ;
F_58 ( V_14 ) ;
F_36 ( V_11 , V_33 ) ;
V_11 = F_34 ( V_23 -> V_31 , V_33 ) ;
V_25 = F_15 ( V_2 , V_23 , V_11 ) ;
...
int F_60 ( struct V_1 * V_2 , T_1 V_4 , int V_71 )
{
int V_26 ;
switch ( V_71 ) {
case V_72 :
...
struct V_1 * V_2 ;
int V_99 ;
V_2 = F_64 ( V_94 , NULL , V_100 ) ;
if ( F_25 ( ! V_2 ) )
return - V_101 ;
if ( ! ( V_2 -> V_102 & V_103 ) )
goto V_66;
V_99 = F_65 ( V_2 , V_104 , 0 ) ;
if ( V_99 )
goto V_105;
F_66 ( V_2 , V_95 ,
sizeof( struct V_17 ) ) ;
