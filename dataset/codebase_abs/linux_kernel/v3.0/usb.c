...
static int F_17 ( struct V_25 * V_19 , struct V_43 * V_44 )
{
struct V_18 * V_45 ;
V_45 = F_12 ( V_19 ) ;
if ( F_18 ( V_44 , L_3 , V_45 -> V_39 -> V_46 ) )
return - V_47 ;
if ( F_18 ( V_44 , L_4 , V_45 -> V_48 ) )
return - V_47 ;
return 0 ;
}
static int F_17 ( struct V_25 * V_19 , struct V_43 * V_44 )
...
static int F_19 ( struct V_25 * V_19 )
{
return 0 ;
}
...
static int F_22 ( struct V_25 * V_19 )
{
return F_23 ( V_19 , V_51 ) ;
}
static int F_24 ( struct V_25 * V_19 )
{
return F_21 ( V_19 , V_52 ) ;
}
static int F_25 ( struct V_25 * V_19 )
{
return F_23 ( V_19 , V_53 ) ;
}
static int F_26 ( struct V_25 * V_19 )
{
return F_21 ( V_19 , V_54 ) ;
}
static int F_27 ( struct V_25 * V_19 )
{
return F_23 ( V_19 , V_55 ) ;
}
static int F_28 ( struct V_25 * V_19 )
{
return F_21 ( V_19 , V_56 ) ;
}
static char * F_29 ( struct V_25 * V_19 , T_1 * V_57 )
{
struct V_18 * V_45 ;
V_45 = F_12 ( V_19 ) ;
return F_30 ( V_58 , L_5 ,
V_45 -> V_39 -> V_46 , V_45 -> V_48 ) ;
}
static unsigned F_31 ( struct V_59 * V_39 )
{
struct V_37 * V_38 = F_32 ( V_39 , struct V_37 , V_60 ) ;
return V_38 -> V_61 ;
}
struct V_18 * F_33 ( struct V_18 * V_62 ,
struct V_59 * V_39 , unsigned V_63 )
{
struct V_18 * V_19 ;
struct V_37 * V_37 = F_32 ( V_39 , struct V_37 , V_60 ) ;
unsigned V_64 = 0 ;
V_19 = F_34 ( sizeof( * V_19 ) , V_58 ) ;
if ( ! V_19 )
return NULL ;
if ( ! F_35 ( F_13 ( V_39 ) ) ) {
F_16 ( V_19 ) ;
...
F_37 ( & V_19 -> V_19 , F_38 ( V_39 -> V_70 ) ) ;
V_19 -> V_71 = V_72 ;
F_39 ( & V_19 -> V_73 , 0 ) ;
F_40 ( & V_19 -> V_74 . V_75 ) ;
V_19 -> V_74 . V_9 . V_76 = V_77 ;
V_19 -> V_74 . V_9 . V_78 = V_79 ;
F_41 ( V_19 , & V_19 -> V_74 , false ) ;
V_19 -> V_80 = 1 ;
if ( F_42 ( ! V_62 ) ) {
V_19 -> V_81 [ 0 ] = '0' ;
V_19 -> V_82 = 0 ;
V_19 -> V_19 . V_62 = V_39 -> V_70 ;
F_43 ( & V_19 -> V_19 , L_6 , V_39 -> V_46 ) ;
V_64 = 1 ;
} else {
if ( V_62 -> V_81 [ 0 ] == '0' ) {
...
F_43 ( & V_19 -> V_19 , L_9 , V_39 -> V_46 , V_19 -> V_81 ) ;
}
V_19 -> V_84 = V_63 ;
V_19 -> V_39 = V_39 ;
V_19 -> V_62 = V_62 ;
...
V_19 -> V_90 = V_37 -> V_91 ;
V_19 -> V_92 = F_31 ( V_39 ) ? 1 : 0 ;
}
return V_19 ;
}
struct V_18 * F_46 ( struct V_18 * V_19 )
{
if ( V_19 )
F_47 ( & V_19 -> V_19 ) ;
return V_19 ;
...
struct V_17 * F_49 ( struct V_17 * V_23 )
{
if ( V_23 )
F_47 ( & V_23 -> V_19 ) ;
return V_23 ;
}
void F_50 ( struct V_17 * V_23 )
{
if ( V_23 )
F_10 ( & V_23 -> V_19 ) ;
}
int F_51 ( struct V_18 * V_36 ,
...
int F_55 ( struct V_18 * V_19 )
{
return F_56 ( V_19 ) ;
}
int F_57 ( char * V_104 , unsigned V_105 ,
...
void * F_58 ( struct V_18 * V_19 , T_2 V_105 , T_3 V_111 ,
T_4 * V_112 )
{
if ( ! V_19 || ! V_19 -> V_39 )
return NULL ;
return F_59 ( V_19 -> V_39 , V_105 , V_111 , V_112 ) ;
}
void F_60 ( struct V_18 * V_19 , T_2 V_105 , void * V_113 ,
T_4 V_112 )
{
if ( ! V_19 || ! V_19 -> V_39 )
return;
if ( ! V_113 )
return;
F_61 ( V_19 -> V_39 , V_105 , V_113 , V_112 ) ;
}
int F_62 ( void )
{
return V_114 ;
}
static int F_63 ( struct V_115 * V_116 , unsigned long V_117 ,
void * V_26 )
{
...
{
V_121 = F_69 ( L_11 , NULL ) ;
if ( ! V_121 )
return - V_122 ;
V_123 = F_70 ( L_12 , 0444 ,
V_121 , NULL ,
& V_124 ) ;
if ( ! V_123 ) {
F_71 ( V_121 ) ;
