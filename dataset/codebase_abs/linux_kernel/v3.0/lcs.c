...
static inline void
F_107 ( struct V_18 * V_19 , struct V_155 * V_156 )
{
struct V_157 * V_158 ;
struct V_103 * V_104 ;
struct V_70 * V_71 ;
...
for ( V_158 = F_109 ( V_156 -> V_161 ) ;
V_158 != NULL ; V_158 = F_109 ( V_158 -> V_162 ) ) {
F_104 ( V_158 -> V_163 , V_159 , V_19 -> V_76 ) ;
if ( ( V_71 -> V_71 . V_141 == V_158 -> V_163 ) &&
( memcmp ( V_159 , & V_71 -> V_71 . V_126 ,
V_127 ) == 0 ) )
break;
}
if ( V_158 == NULL )
...
F_110 ( struct V_18 * V_19 , struct V_157 * V_158 , char * V_159 )
{
...
if ( ( V_149 -> V_71 . V_141 == V_158 -> V_163 ) &&
( memcmp ( V_159 , & V_149 -> V_71 . V_126 ,
V_127 ) == 0 ) ) {
V_71 = V_149 ;
break;
}
...
static inline void
F_111 ( struct V_18 * V_19 , struct V_155 * V_156 )
{
struct V_157 * V_158 ;
struct V_70 * V_71 ;
char V_159 [ V_160 ] ;
unsigned long V_34 ;
F_9 ( 4 , V_62 , L_65 ) ;
for ( V_158 = F_109 ( V_156 -> V_161 ) ; V_158 != NULL ;
V_158 = F_109 ( V_158 -> V_162 ) ) {
F_104 ( V_158 -> V_163 , V_159 , V_19 -> V_76 ) ;
V_71 = F_110 ( V_19 , V_158 , V_159 ) ;
if ( V_71 != NULL )
continue;
...
memcpy ( & V_71 -> V_71 . V_126 , V_159 , V_127 ) ;
V_71 -> V_71 . V_141 = V_158 -> V_163 ;
V_71 -> V_74 = V_75 ;
F_27 ( & V_19 -> V_68 , V_34 ) ;
...
struct V_18 * V_19 ;
F_9 ( 4 , V_62 , L_69 ) ;
V_19 = (struct V_18 * ) V_76 -> V_167 ;
if ( ! F_33 ( V_19 , V_164 ) )
F_123 ( & V_19 -> V_168 ) ;
#endif
}
static long
F_124 ( struct V_169 * V_170 , struct V_171 * V_171 )
{
if ( ! F_125 ( V_171 ) )
return 0 ;
switch ( F_126 ( V_171 ) ) {
...
static int
F_128 ( struct V_169 * V_170 , struct V_171 * V_171 )
{
int V_173 , V_174 ;
char * V_175 ;
V_175 = ( char * ) V_171 -> V_176 ;
V_174 = V_171 -> V_177 . V_93 . V_174 ;
V_173 = V_171 -> V_177 . V_93 . V_173 ;
...
static void
F_130 ( struct V_169 * V_170 , unsigned long V_192 , struct V_171 * V_171 )
{
struct V_18 * V_19 ;
struct V_5 * V_6 ;
int V_20 , V_86 ;
int V_174 , V_173 ;
F_131 ( F_132 () ) . V_193 [ V_194 ] ++ ;
if ( F_124 ( V_170 , V_171 ) )
return;
V_19 = F_133 ( V_170 ) ;
if ( V_19 -> V_26 . V_77 == V_170 )
V_6 = & V_19 -> V_26 ;
else
V_6 = & V_19 -> V_27 ;
V_174 = V_171 -> V_177 . V_93 . V_174 ;
V_173 = V_171 -> V_177 . V_93 . V_173 ;
F_39 ( 5 , V_62 , L_82 , F_50 ( & V_170 -> V_76 ) ) ;
F_39 ( 5 , V_62 , L_83 , V_171 -> V_177 . V_93 . V_174 ,
V_171 -> V_177 . V_93 . V_173 ) ;
F_39 ( 5 , V_62 , L_83 , V_171 -> V_177 . V_93 . V_195 ,
V_171 -> V_177 . V_93 . V_196 ) ;
V_20 = F_128 ( V_170 , V_171 ) ;
if ( V_20 || ( V_173 & V_197 ) ) {
F_127 ( & V_170 -> V_76 ,
L_84
L_85 ,
...
if ( ( V_6 -> V_15 != V_48 ) &&
( V_171 -> V_177 . V_93 . V_195 & V_199 ) &&
( V_171 -> V_177 . V_93 . V_200 != 0 ) ) {
V_86 = (struct V_30 * ) F_134 ( ( V_81 ) V_171 -> V_177 . V_93 . V_200 )
- V_6 -> V_29 ;
if ( ( V_171 -> V_177 . V_93 . V_196 & V_201 ) ||
( V_171 -> V_177 . V_93 . V_174 & V_202 ) )
V_86 = ( V_86 - 1 ) & ( V_9 - 1 ) ;
while ( V_6 -> V_49 != V_86 ) {
F_67 ( V_6 ,
V_6 -> V_10 + V_6 -> V_49 ) ;
...
if ( ( V_171 -> V_177 . V_93 . V_173 & V_203 ) ||
( V_171 -> V_177 . V_93 . V_173 & V_204 ) ||
( V_171 -> V_177 . V_93 . V_173 & V_184 ) )
V_6 -> V_15 = V_83 ;
else if ( V_171 -> V_177 . V_93 . V_196 & V_201 )
V_6 -> V_15 = V_89 ;
if ( V_171 -> V_177 . V_93 . V_195 & V_205 ) {
if ( V_171 -> V_177 . V_93 . V_206 != 0 ) {
F_57 ( V_6 -> V_77 , ( V_81 ) V_6 ) ;
return;
}
V_6 -> V_15 = V_84 ;
}
if ( V_171 -> V_177 . V_93 . V_195 & V_207 )
V_6 -> V_15 = V_82 ;
F_135 ( & V_6 -> V_17 ) ;
}
static void
...
static void
F_137 ( struct V_5 * V_6 , struct V_85 * V_88 )
{
struct V_18 * V_19 ;
F_9 ( 5 , V_62 , L_88 ) ;
F_68 ( V_6 , V_88 ) ;
V_19 = F_138 ( V_6 , struct V_18 , V_27 ) ;
if ( F_139 ( V_19 -> V_76 ) && F_140 ( V_19 -> V_76 ) )
F_121 ( V_19 -> V_76 ) ;
F_79 ( & V_19 -> V_67 ) ;
V_19 -> V_66 -- ;
...
static int
F_141 ( struct V_18 * V_19 , struct V_208 * V_209 ,
struct V_153 * V_76 )
{
struct V_40 * V_210 ;
int V_20 = V_211 ;
...
V_19 -> V_65 -> V_43 = F_137 ;
V_19 -> V_65 -> V_33 = 0 ;
}
V_210 = (struct V_40 * )
( V_19 -> V_65 -> V_11 + V_19 -> V_65 -> V_33 ) ;
V_19 -> V_65 -> V_33 += V_209 -> V_218 + sizeof( struct V_40 ) ;
V_210 -> V_41 = V_19 -> V_65 -> V_33 ;
V_210 -> type = V_19 -> V_21 ;
V_210 -> V_96 = V_19 -> V_130 ;
F_145 ( V_209 , V_210 + 1 , V_209 -> V_218 ) ;
F_82 ( & V_19 -> V_67 ) ;
V_19 -> V_212 . V_221 += V_209 -> V_218 ;
V_19 -> V_212 . V_222 ++ ;
F_142 ( V_209 ) ;
F_121 ( V_19 -> V_76 ) ;
F_79 ( & V_19 -> V_67 ) ;
...
static int
F_146 ( struct V_208 * V_209 , struct V_153 * V_76 )
{
struct V_18 * V_19 ;
int V_20 ;
F_9 ( 5 , V_62 , L_90 ) ;
V_19 = (struct V_18 * ) V_76 -> V_167 ;
V_20 = F_141 ( V_19 , V_209 , V_76 ) ;
return V_20 ;
}
static int
...
static int
F_153 ( struct V_18 * V_19 )
{
int V_20 ;
F_9 ( 3 , V_8 , L_94 ) ;
if ( V_19 -> V_26 . V_15 != V_83 &&
V_19 -> V_27 . V_15 != V_83 &&
V_19 -> V_26 . V_15 != V_198 &&
V_19 -> V_27 . V_15 != V_198 &&
V_19 -> V_15 == V_166 ) {
F_42 ( V_19 ) ;
...
static void
F_154 ( struct V_228 * V_229 )
{
struct V_18 * V_19 = F_138 ( V_229 , struct V_18 , V_168 ) ;
F_9 ( 5 , V_62 , L_95 ) ;
if ( F_38 ( V_19 , V_191 ) )
F_155 ( V_230 , V_19 , L_96 ) ;
#ifdef F_18
if ( F_38 ( V_19 , V_164 ) )
F_155 ( F_113 , V_19 , L_97 ) ;
#endif
}
static void
F_156 ( struct V_18 * V_19 , struct V_92 * V_93 )
{
F_9 ( 5 , V_62 , L_98 ) ;
if ( V_93 -> V_117 == V_231 ) {
switch( V_93 -> V_31 ) {
...
static void
F_158 ( struct V_18 * V_19 , char * V_233 , unsigned int V_234 )
{
struct V_208 * V_209 ;
F_9 ( 5 , V_62 , L_101 ) ;
if ( V_19 -> V_76 == NULL ||
...
memcpy ( F_160 ( V_209 , V_234 ) , V_233 , V_234 ) ;
V_209 -> V_216 = V_19 -> V_236 ( V_209 , V_19 -> V_76 ) ;
V_19 -> V_212 . V_237 += V_234 ;
V_19 -> V_212 . V_238 ++ ;
if ( V_209 -> V_216 == F_143 ( V_239 ) )
* ( ( V_39 * ) V_209 -> V_240 ) = ++ V_19 -> V_23 ;
F_161 ( V_209 ) ;
}
static void
...
V_94 V_41 ;
F_9 ( 5 , V_62 , L_103 ) ;
V_241 = (struct V_40 * ) V_88 -> V_11 ;
if ( V_241 -> V_41 == V_42 ) {
F_9 ( 4 , V_62 , L_104 ) ;
return;
}
V_19 = F_138 ( V_6 , struct V_18 , V_26 ) ;
V_41 = 0 ;
while ( V_241 -> V_41 != 0 ) {
if ( V_241 -> V_41 <= 0 ||
V_241 -> V_41 > V_12 ||
...
if ( V_241 -> type == V_95 )
F_156 ( V_19 , (struct V_92 * ) V_241 ) ;
else if ( V_241 -> type == V_223 ||
V_241 -> type == V_224 ||
V_241 -> type == V_225 )
F_158 ( V_19 , ( char * ) ( V_241 + 1 ) ,
V_241 -> V_41 - V_41 -
sizeof( struct V_40 ) ) ;
else
;
V_41 = V_241 -> V_41 ;
V_241 -> V_41 = V_42 ;
V_241 = (struct V_40 * ) ( V_88 -> V_11 + V_41 ) ;
}
F_65 ( & V_19 -> V_26 , V_88 ) ;
}
static struct V_244 *
F_162 ( struct V_153 * V_76 )
{
struct V_18 * V_19 ;
F_9 ( 4 , V_62 , L_105 ) ;
V_19 = (struct V_18 * ) V_76 -> V_167 ;
...
static T_3
F_165 ( struct V_246 * V_76 , struct V_247 * V_248 , char * V_159 )
{
struct V_18 * V_19 ;
V_19 = F_166 ( V_76 ) ;
if ( ! V_19 )
return 0 ;
return sprintf ( V_159 , L_110 , V_19 -> V_130 ) ;
}
static T_3
F_167 ( struct V_246 * V_76 , struct V_247 * V_248 , const char * V_159 , T_4 V_33 )
{
struct V_18 * V_19 ;
int V_249 ;
V_19 = F_166 ( V_76 ) ;
if ( ! V_19 )
return 0 ;
sscanf ( V_159 , L_111 , & V_249 ) ;
V_19 -> V_130 = V_249 ;
return V_33 ;
}
static T_3
F_168 ( struct V_246 * V_76 , struct V_247 * V_248 , char * V_159 )
{
struct V_250 * V_251 ;
V_251 = F_169 ( V_76 ) ;
if ( ! V_251 )
return - V_252 ;
return sprintf ( V_159 , L_112 , V_253 [ V_251 -> V_170 [ 0 ] -> V_254 . V_255 ] ) ;
}
static T_3
F_170 ( struct V_246 * V_76 , struct V_247 * V_248 , char * V_159 )
{
struct V_18 * V_19 ;
V_19 = F_166 ( V_76 ) ;
return V_19 ? sprintf ( V_159 , L_113 , V_19 -> V_24 ) : 0 ;
}
static T_3
F_171 ( struct V_246 * V_76 , struct V_247 * V_248 , const char * V_159 , T_4 V_33 )
{
struct V_18 * V_19 ;
int V_249 ;
V_19 = F_166 ( V_76 ) ;
...
static T_3
F_172 ( struct V_246 * V_76 , struct V_247 * V_248 ,
const char * V_159 , T_4 V_33 )
{
struct V_18 * V_19 = F_166 ( V_76 ) ;
char * V_149 ;
int V_226 ;
if ( ! V_19 )
return - V_256 ;
if ( V_19 -> V_15 != V_166 )
return - V_61 ;
V_226 = F_173 ( V_159 , & V_149 , 16 ) ;
if ( V_226 == 1 )
F_129 ( V_19 ) ;
return V_33 ;
}
static int
F_174 ( struct V_250 * V_257 )
{
struct V_18 * V_19 ;
int V_258 ;
if ( ! F_175 ( & V_257 -> V_76 ) )
...
V_258 = F_177 ( & V_257 -> V_76 . V_259 , & V_260 ) ;
if ( V_258 ) {
F_15 ( V_19 ) ;
F_176 ( & V_257 -> V_76 ) ;
return V_258 ;
}
F_178 ( & V_257 -> V_76 , V_19 ) ;
V_257 -> V_170 [ 0 ] -> V_261 = F_130 ;
V_257 -> V_170 [ 1 ] -> V_261 = F_130 ;
V_19 -> V_262 = V_257 ;
F_179 ( & V_19 -> V_168 , F_154 ) ;
V_19 -> V_60 = 0 ;
V_19 -> V_57 = 0 ;
V_19 -> V_58 = 0 ;
return 0 ;
...
static int
F_180 ( struct V_250 * V_257 )
{
struct V_18 * V_19 ;
F_9 ( 2 , V_8 , L_115 ) ;
V_19 = F_166 ( & V_257 -> V_76 ) ;
if ( V_19 -> V_76 -> V_263 != V_264 )
return 0 ;
F_181 ( V_19 -> V_76 , & V_257 -> V_76 ) ;
return F_182 ( V_19 -> V_76 ) ;
}
static int
F_183 ( struct V_250 * V_257 )
{
struct V_18 * V_19 ;
...
V_19 -> V_26 . V_77 = V_257 -> V_170 [ 0 ] ;
V_19 -> V_27 . V_77 = V_257 -> V_170 [ 1 ] ;
V_266 = V_19 -> V_15 ;
V_20 = F_184 ( V_19 -> V_26 . V_77 ) ;
if ( V_20 )
goto V_267;
V_20 = F_184 ( V_19 -> V_27 . V_77 ) ;
if ( V_20 )
goto V_268;
F_9 ( 3 , V_8 , L_117 ) ;
F_40 ( V_19 ) ;
...
goto V_165;
V_19 -> V_76 = V_76 ;
V_19 -> V_76 -> V_167 = V_19 ;
V_19 -> V_76 -> V_273 = & V_274 ;
memcpy ( V_19 -> V_76 -> V_275 , V_19 -> V_124 , V_127 ) ;
#ifdef F_18
if ( ! F_100 ( V_19 ) )
V_19 -> V_76 -> V_273 = & V_276 ;
#endif
V_269:
F_26 ( V_19 , 0xffffffff ) ;
if ( V_266 == V_277 ) {
F_122 ( V_19 -> V_76 ) ;
V_19 -> V_76 -> V_34 |= V_245 ;
F_120 ( V_19 -> V_76 ) ;
F_121 ( V_19 -> V_76 ) ;
V_19 -> V_15 = V_166 ;
} else {
...
if ( F_180 ( V_257 ) != 0 )
goto V_165;
F_102 ( L_124 , V_19 -> V_76 -> V_232 ,
( V_19 -> V_143 & V_278 ) ?
L_125 : L_126 ) ;
F_102 ( L_127 , V_19 -> V_76 -> V_232 ,
( V_19 -> V_143 & V_147 ) ?
L_125 : L_126 ) ;
return 0 ;
V_165:
F_188 ( V_19 -> V_27 . V_77 ) ;
V_268:
F_188 ( V_19 -> V_26 . V_77 ) ;
V_267:
return - V_252 ;
}
static int
F_189 ( struct V_250 * V_257 , int V_279 )
{
struct V_18 * V_19 ;
enum V_265 V_266 ;
int V_258 ;
...
F_16 ( 3 , V_8 , & V_19 , sizeof( void * ) ) ;
V_266 = V_19 -> V_15 ;
V_258 = F_163 ( V_19 -> V_76 ) ;
V_258 = F_188 ( V_19 -> V_26 . V_77 ) ;
V_258 = F_188 ( V_19 -> V_27 . V_77 ) ;
if ( V_266 == V_166 ) {
V_19 -> V_15 = V_277 ;
}
if ( V_258 )
...
static int
F_190 ( struct V_250 * V_257 )
{
return F_189 ( V_257 , 0 ) ;
}
static int
V_230 ( void * V_281 )
{
...
int V_20 = 0 ;
if ( V_19 -> V_15 == V_277 )
V_20 = F_183 ( V_19 -> V_262 ) ;
if ( V_19 -> V_76 )
F_197 ( V_19 -> V_76 ) ;
if ( V_20 ) {
F_127 ( & V_19 -> V_262 -> V_76 , L_135
L_136 ) ;
}
return V_20 ;
}
static int F_198 ( struct V_250 * V_262 )
{
return 0 ;
}
static void F_199 ( struct V_250 * V_262 )
{
return;
}
static int F_200 ( struct V_250 * V_262 )
{
struct V_18 * V_19 = F_166 ( & V_262 -> V_76 ) ;
return F_194 ( V_19 ) ;
}
static int F_201 ( struct V_250 * V_262 )
{
struct V_18 * V_19 = F_166 ( & V_262 -> V_76 ) ;
return F_196 ( V_19 ) ;
}
static int F_202 ( struct V_250 * V_262 )
{
struct V_18 * V_19 = F_166 ( & V_262 -> V_76 ) ;
return F_196 ( V_19 ) ;
}
static T_3
F_203 ( struct V_283 * V_284 , const char * V_159 ,
T_4 V_33 )
{
int V_285 ;
V_285 = F_204 ( V_286 ,
...
goto V_267;
V_286 = F_206 ( L_139 ) ;
V_20 = F_125 ( V_286 ) ? F_126 ( V_286 ) : 0 ;
if ( V_20 )
goto V_290;
V_20 = F_207 ( & V_289 ) ;
if ( V_20 )
