...
if ( F_47 ( V_71 ) || F_48 ( & V_2 -> V_34 ) ) {
if ( F_22 ( V_2 ) & V_75 )
F_49 ( & V_2 -> V_34 ) ;
return 0 ;
}
while( ! ( F_22 ( V_2 ) & V_72 ) && ! F_47 ( V_71 ) ) {
...
static void F_57 ( struct V_52 * V_34 , int V_81 )
{
F_2 ( L_13 , V_4 ) ;
}
...
struct V_1 * V_2 = (struct V_1 * ) V_34 ;
F_2 ( L_13 , V_4 ) ;
return V_2 -> V_34 . type == V_82 ? L_24 : NULL ;
}
...
static void F_63 ( struct V_52 * V_34 , int V_83 )
{
struct V_1 * V_2 = (struct V_1 * ) V_34 ;
F_2 ( L_13 , V_4 ) ;
V_2 -> V_34 . type = V_82 ;
}
static int F_64 ( struct V_52 * V_34 , struct V_84 * V_85 )
{
F_2 ( L_13 , V_4 ) ;
return 0 ;
}
...
V_2 -> V_5 <<= 1 ;
V_2 -> V_6 <<= 1 ;
V_34 -> V_100 = F_68 ( V_34 , V_87 , V_88 , 0 , F_8 () / 16 ) ;
F_9 ( V_2 , F_11 ( V_2 ) & ~ V_50 ) ;
F_13 ( V_2 , F_15 ( V_2 ) & ~ V_51 ) ;
...
F_9 ( V_2 , F_11 ( V_2 ) & ~ V_50 ) ;
F_19 () ;
F_69 ( V_34 , V_87 -> V_90 , V_34 -> V_100 ) ;
F_13 ( V_2 , F_15 ( V_2 ) | V_51 ) ;
F_19 () ;
F_70 ( & V_2 -> V_34 . V_37 , V_83 ) ;
}
static int T_3
F_71 ( struct V_101 * V_102 , char * V_103 )
{
struct V_1 * V_2 ;
int V_104 = 57600 ;
int V_105 = 8 ;
...
return - V_110 ;
if ( V_103 )
F_72 ( V_103 , & V_104 , & V_106 , & V_105 , & V_107 ) ;
return F_73 ( & V_2 -> V_34 , V_102 , V_104 , V_106 , V_105 , V_107 ) ;
}
...
static void
F_76 ( struct V_101 * V_102 , const char * V_112 , unsigned int V_113 )
{
struct V_1 * V_2 = V_111 [ V_102 -> V_108 ] ;
unsigned long V_83 ;
F_67 ( & V_2 -> V_34 . V_37 , V_83 ) ;
if ( F_11 ( V_2 ) & V_50 )
F_77 ( & V_2 -> V_34 , V_112 , V_113 , F_74 ) ;
else {
while ( F_22 ( V_2 ) & V_72 )
F_75 () ;
F_3 ( V_2 , 0xffff ) ;
...
static int F_78 ( struct V_114 * V_63 )
{
struct V_1 * V_115 = F_79 ( V_63 ) ;
F_59 ( V_63 , L_13 , V_4 ) ;
if ( V_115 )
F_80 ( & V_116 , & V_115 -> V_34 ) ;
return 0 ;
}
static int F_81 ( struct V_114 * V_63 )
{
struct V_1 * V_115 = F_79 ( V_63 ) ;
F_59 ( V_63 , L_13 , V_4 ) ;
if ( V_115 )
...
static int T_4 F_83 ( struct V_117 * V_118 )
{
struct V_119 * V_120 ;
struct V_1 * V_115 ;
int V_62 = 0 ;
F_59 ( & V_118 -> V_63 , L_13 , V_4 ) ;
if ( V_118 -> V_121 < 0 || V_118 -> V_121 >= V_109 ) {
F_41 ( & V_118 -> V_63 , L_28 ) ;
return - V_122 ;
}
if ( V_111 [ V_118 -> V_121 ] == NULL ) {
V_111 [ V_118 -> V_121 ] =
F_84 ( sizeof( struct V_1 ) , V_123 ) ;
...
V_62 = F_85 (
( unsigned short * ) V_118 -> V_63 . V_125 , V_126 ) ;
if ( V_62 ) {
F_41 ( & V_118 -> V_63 ,
L_30 ) ;
goto V_127;
}
F_86 ( & V_115 -> V_34 . V_37 ) ;
V_115 -> V_34 . V_128 = V_129 ,
V_115 -> V_34 . V_130 = & V_131 ;
V_115 -> V_34 . line = V_118 -> V_121 ;
V_115 -> V_34 . V_132 = V_133 ;
V_115 -> V_34 . V_83 = V_134 ;
V_120 = F_87 ( V_118 , V_135 , 0 ) ;
if ( V_120 == NULL ) {
F_41 ( & V_118 -> V_63 , L_31 ) ;
V_62 = - V_122 ;
goto V_136;
}
V_115 -> V_34 . V_137 = F_88 ( V_120 -> V_138 , F_89 ( V_120 ) ) ;
if ( ! V_115 -> V_34 . V_137 ) {
F_41 ( & V_118 -> V_63 , L_32 ) ;
V_62 = - V_139 ;
goto V_136;
}
V_115 -> V_34 . V_140 = V_120 -> V_138 ;
V_115 -> V_34 . V_30 = F_90 ( V_118 , 0 ) ;
if ( ( int ) V_115 -> V_34 . V_30 < 0 ) {
F_41 ( & V_118 -> V_63 , L_33 ) ;
V_62 = - V_122 ;
goto V_141;
}
V_115 -> V_65 = F_90 ( V_118 , 1 ) ;
if ( V_115 -> V_65 < 0 ) {
...
#ifdef F_42
V_120 = F_87 ( V_118 , V_142 , 0 ) ;
if ( V_120 == NULL )
V_115 -> V_53 = - 1 ;
else
V_115 -> V_53 = V_120 -> V_138 ;
V_120 = F_87 ( V_118 , V_142 , 1 ) ;
if ( V_120 == NULL )
V_115 -> V_58 = - 1 ;
else
V_115 -> V_58 = V_120 -> V_138 ;
if ( V_115 -> V_58 >= 0 )
F_91 ( V_115 -> V_58 , V_126 ) ;
#endif
}
#ifdef F_92
if ( ! F_93 ( V_118 ) ) {
...
F_94 ( & V_118 -> V_63 , V_115 ) ;
V_62 = F_95 ( & V_116 , & V_115 -> V_34 ) ;
#ifdef F_92
}
#endif
if ( ! V_62 )
...
static int T_5 F_99 ( struct V_117 * V_118 )
{
struct V_1 * V_115 = F_100 ( V_118 ) ;
F_59 ( & V_118 -> V_63 , L_13 , V_4 ) ;
F_94 ( & V_118 -> V_63 , NULL ) ;
if ( V_115 ) {
F_101 ( & V_116 , & V_115 -> V_34 ) ;
#ifdef F_102
if ( V_115 -> V_58 >= 0 )
F_103 ( V_115 -> V_58 ) ;
#endif
