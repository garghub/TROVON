...
static T_2 F_53 ( struct V_58 * V_58 ,
struct V_59 * V_60 , char * V_12 )
{
...
T_2 F_58 ( struct V_58 * V_58 , char * V_12 )
{
...
F_61 ( V_27 ) ;
F_62 ( V_27 ) ;
F_63 ( V_27 -> V_163 -> V_164 , V_27 ) ;
if ( V_27 -> V_143 )
F_64 ( V_27 -> V_163 ) ;
}
static int T_5 F_65 ( struct V_165 * V_163 ,
...
goto V_178;
F_70 ( V_163 ) ;
V_169 = F_71 ( & V_179 , sizeof( struct V_26 ) ) ;
if ( ! V_169 )
goto V_178;
V_169 -> V_164 = V_163 -> V_164 ;
V_169 -> V_180 = F_72 ( V_163 , 0 ) ;
V_169 -> V_173 = V_173 ;
V_169 -> V_181 = 16 ;
V_27 = (struct V_26 * ) V_169 -> V_29 ;
V_27 -> V_182 = V_169 ;
V_27 -> V_163 = V_163 ;
V_27 -> V_183 = V_179 . V_183 ;
V_27 -> V_115 = V_169 -> V_173 ;
V_27 -> V_137 = V_167 ;
F_73 ( & V_27 -> V_20 ) ;
V_27 -> V_83 = F_74 ( sizeof( struct V_82 ) * ( V_169 -> V_52 + V_81 ) , V_184 ) ;
if ( ! V_27 -> V_83 )
goto V_185;
F_75 ( & V_27 -> V_186 ) ;
V_27 -> V_187 = V_188 ;
if ( ( * V_3 [ V_167 ] . V_189 ) ( V_27 ) )
goto V_190;
V_27 -> V_162 = F_76 ( V_191 , V_27 , V_71 ) ;
if ( F_77 ( V_27 -> V_162 ) ) {
F_22 ( V_70 L_23 ) ;
error = F_78 ( V_27 -> V_162 ) ;
goto V_192;
}
if ( V_3 [ V_167 ] . V_176 & V_177 )
if ( F_68 ( V_163 , F_67 ( 32 ) ) )
goto V_192;
V_27 -> V_193 = V_3 [ V_167 ] . V_194 ;
error = F_79 ( V_27 ) ;
if ( error < 0 )
goto V_192;
if ( ( V_3 [ V_167 ] . V_176 & V_195 ) &&
( V_169 -> V_196 > 34 ) ) {
V_169 -> V_196 = 34 ;
V_169 -> V_197 = ( V_169 -> V_196 * 8 ) + 112 ;
}
if ( ( V_3 [ V_167 ] . V_176 & V_198 ) &&
( V_169 -> V_196 > 17 ) ) {
V_169 -> V_196 = 17 ;
V_169 -> V_197 = ( V_169 -> V_196 * 8 ) + 112 ;
}
error = F_80 ( V_163 ,
( V_27 -> V_145 . V_199 & V_200 ) ?
( V_169 -> V_197 << 9 ) : 65536 ) ;
if ( error )
goto V_192;
if ( V_3 [ V_167 ] . V_176 & V_195 )
...
V_27 -> V_201 = 0 ;
if ( V_27 -> V_202 || V_36 || V_27 -> V_30 )
V_169 -> V_154 = V_27 -> V_193 ;
else
V_169 -> V_154 = 0 ;
F_81 ( V_27 , 0 ) ;
F_82 ( V_27 ) ;
F_83 ( & V_27 -> V_20 , V_171 ) ;
V_169 -> V_155 = V_27 -> V_49 ;
if ( V_169 -> V_155 < V_27 -> V_203 )
V_169 -> V_155 = V_27 -> V_203 ;
if ( V_169 -> V_155 < V_204 )
V_169 -> V_155 = V_204 ;
else
V_169 -> V_205 = V_169 -> V_155 ;
V_169 -> V_206 = V_207 ;
F_84 ( V_163 , V_169 ) ;
error = F_85 ( V_169 , & V_163 -> V_40 ) ;
if ( error )
goto V_192;
F_86 ( V_169 ) ;
return 0 ;
...
F_87 ( V_27 ) ;
if ( V_27 -> V_208 )
F_88 ( V_27 -> V_163 , V_27 -> V_209 , V_27 -> V_208 ,
V_27 -> V_210 ) ;
F_7 ( V_27 -> V_211 ) ;
F_89 ( V_27 , 0 ) ;
F_7 ( V_27 -> V_83 ) ;
...
static void F_92 ( struct V_165 * V_40 )
{
struct V_41 * V_169 = F_93 ( V_40 ) ;
F_94 ( V_169 ) ;
F_59 ( (struct V_26 * ) V_169 -> V_29 ) ;
}
static void T_7 F_95 ( struct V_165 * V_163 )
{
struct V_41 * V_169 = F_93 ( V_163 ) ;
