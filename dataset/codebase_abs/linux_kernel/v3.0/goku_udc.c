...
static int F_96 ( struct V_232 * V_75 , const struct V_238 * V_239 )
{
...
int V_136 ;
if ( V_186 ) {
F_97 ( L_123 , F_98 ( V_75 ) ) ;
return - V_30 ;
}
if ( ! V_75 -> V_216 ) {
F_99 ( V_243 L_124 , F_98 ( V_75 ) ) ;
V_136 = - V_62 ;
goto V_244;
}
V_10 = F_21 ( sizeof *V_10 , V_245 ) ;
if ( V_10 == NULL ) {
F_100 ( L_125 , F_98 ( V_75 ) ) ;
V_136 = - V_246 ;
goto V_244;
}
F_101 ( & V_10 -> V_38 ) ;
...
V_240 = F_91 ( V_75 , 0 ) ;
V_241 = F_92 ( V_75 , 0 ) ;
if ( ! F_104 ( V_240 , V_241 , V_251 ) ) {
F_12 ( V_10 , L_128 ) ;
V_136 = - V_30 ;
goto V_244;
}
V_10 -> V_235 = 1 ;
V_242 = F_105 ( V_240 , V_241 ) ;
if ( V_242 == NULL ) {
F_12 ( V_10 , L_129 ) ;
V_136 = - V_252 ;
goto V_244;
...
F_67 ( V_10 ) ;
F_66 ( V_10 ) ;
if ( F_106 ( V_75 -> V_216 , F_77 , V_255 ,
V_251 , V_10 ) != 0 ) {
...
F_107 ( V_75 ) ;
#ifdef F_86
F_108 ( V_233 , 0 , NULL , F_63 , V_10 ) ;
#endif
V_186 = V_10 ;
V_136 = F_109 ( & V_10 -> V_20 . V_10 ) ;
if ( V_136 ) {
F_110 ( & V_10 -> V_20 . V_10 ) ;
goto V_244;
}
V_10 -> V_237 = 1 ;
return 0 ;
