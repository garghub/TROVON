...
#ifdef F_8
V_82 = V_49 ;
V_81 = V_48 . V_60 + V_48 . V_61 + V_26 - 1 ;
#else
V_82 = 32 ;
V_81 = V_48 . V_60 + V_48 . V_61 ;
#endif
F_3 ( & V_4 -> V_5 -> V_6 ) ;
error = F_4 ( V_80 & V_83 , V_81 ) ;
F_5 ( & V_4 -> V_5 -> V_6 ) ;
if ( error != ( V_80 & V_83 ) ) {
F_37 ( V_84 , V_4 , 0 ) ;
return error ;
}
error = V_34 -> V_9 -> V_63 -> V_85 ( V_34 -> V_9 ,
( char T_2 * ) V_80 ,
V_48 . V_60 + V_48 . V_61 , & V_82 ) ;
if ( ( signed long ) error < 0 ) {
F_37 ( V_84 , V_4 , 0 ) ;
return error ;
}
F_38 ( V_80 , V_80 + V_48 . V_60 + V_48 . V_61 ) ;
} else {
...
F_40 ( V_87
L_2 ,
V_34 -> V_9 -> V_57 . V_58 -> V_88 . V_89 ) ;
}
if ( ! V_34 -> V_9 -> V_63 -> V_64 || ( ( V_49 & ~ V_83 ) != 0 ) ) {
T_4 V_82 = V_49 ;
F_3 ( & V_4 -> V_5 -> V_6 ) ;
F_4 ( F_33 ( V_48 ) , V_48 . V_60 + V_48 . V_61 ) ;
F_5 ( & V_4 -> V_5 -> V_6 ) ;
V_34 -> V_9 -> V_63 -> V_85 ( V_34 -> V_9 ,
( char T_2 * ) F_33 ( V_48 ) ,
V_48 . V_60 + V_48 . V_61 , & V_82 ) ;
F_38 ( ( unsigned long ) F_33 ( V_48 ) ,
( unsigned long ) F_33 ( V_48 ) +
V_48 . V_60 + V_48 . V_61 ) ;
goto V_90;
}
F_3 ( & V_4 -> V_5 -> V_6 ) ;
error = F_41 ( V_34 -> V_9 , F_33 ( V_48 ) , V_48 . V_60 ,
V_91 | V_92 ,
V_93 | V_94 | V_95 | V_96 ,
V_49 ) ;
F_5 ( & V_4 -> V_5 -> V_6 ) ;
...
F_3 ( & V_4 -> V_5 -> V_6 ) ;
error = F_41 ( V_34 -> V_9 , F_34 ( V_48 ) , V_48 . V_61 ,
V_91 | V_97 | V_92 ,
V_93 | V_94 | V_95 | V_96 ,
V_49 + V_48 . V_60 ) ;
F_5 ( & V_4 -> V_5 -> V_6 ) ;
...
F_40 ( V_87
L_3 ,
V_9 -> V_57 . V_58 -> V_88 . V_89 ) ;
}
F_3 ( & V_4 -> V_5 -> V_6 ) ;
F_4 ( V_107 , V_48 . V_60 + V_48 . V_61 + V_48 . V_67 ) ;
F_5 ( & V_4 -> V_5 -> V_6 ) ;
V_9 -> V_63 -> V_85 ( V_9 , ( char T_2 * ) V_107 ,
V_48 . V_60 + V_48 . V_61 , & V_82 ) ;
F_38 ( ( unsigned long ) V_107 ,
( unsigned long ) V_107 + V_48 . V_60 + V_48 . V_61 ) ;
V_51 = 0 ;
goto V_109;
}
F_3 ( & V_4 -> V_5 -> V_6 ) ;
error = F_41 ( V_9 , V_107 , V_48 . V_60 + V_48 . V_61 ,
V_91 | V_97 | V_92 ,
V_93 | V_94 | V_95 ,
F_27 ( V_48 ) ) ;
F_5 ( & V_4 -> V_5 -> V_6 ) ;
