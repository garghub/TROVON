...
if ( F_14 ( & V_10 ) ) {
if ( ( V_44 = F_6 ( & V_6 , & V_24 , V_3 , V_27 , 1 ) ) )
return V_44 ;
F_4 ( & V_6 -> V_9 , & V_10 ) ;
...
if ( F_14 ( & V_10 ) ) {
if ( ( V_44 = F_6 ( & V_6 , & V_24 , V_3 , V_29 , 1 ) ) )
return V_44 ;
F_4 ( & V_6 -> V_9 , & V_10 ) ;
...
if ( F_14 ( & V_10 ) ) {
if ( ( V_44 = F_6 ( & V_6 , & V_24 , V_3 , V_31 , 1 ) ) )
return V_44 ;
F_4 ( & V_6 -> V_9 , & V_10 ) ;
...
while ( V_73 ) {
V_61 = F_22 ( V_37 , V_73 ) ;
F_9 ( L_43 , V_72 , V_73 -> V_33 ) ;
if ( ! V_61 ) {
F_2 ( L_44 ) ;
return - V_77 ;
}
if ( ! V_74 ) {
if ( ( V_73 -> V_15 != V_61 -> V_15 ) && ( ( V_83 = V_73 -> V_15 - 1 - V_61 -> V_15 ) >= V_68 -> V_19 ) ) {
F_9 ( L_45 , V_83 ) ;
if ( ( V_83 < V_81 ) || ( V_81 == 0 ) ) {
if ( ( V_61 -> V_15 % V_86 ) == 0 ) {
V_5 = 1 ;
...
if ( ! V_73 -> V_67 ) {
if ( ( V_61 -> V_17 != V_73 -> V_17 ) && ( ( V_83 = V_61 -> V_17 - ( V_73 -> V_17 + 1 ) ) >= V_68 -> V_19 ) ) {
F_9 ( L_45 , V_83 ) ;
if ( ( V_83 < V_81 ) || ( V_81 == 0 ) ) {
...
if ( V_74 ) {
if ( V_74 -> V_33 != V_73 -> V_33 ) {
if ( ( V_73 -> V_15 != V_61 -> V_15 ) &&
( ( V_83 = V_73 -> V_15 - 1 - V_61 -> V_15 ) >= V_68 -> V_19 ) ) {
if ( ( V_83 < V_81 ) || ( V_81 == 0 ) ) {
if ( ( V_61 -> V_15 % V_86 ) == 0 ) {
V_5 = 1 ;
V_81 = V_83 ;
...
if ( ( V_83 = V_73 -> V_15 - 1 - V_74 -> V_17 - 1 ) >= V_68 -> V_19 ) {
if ( ( V_83 < V_81 ) || ( V_81 == 0 ) ) {
...
while ( V_61 ) {
if ( ( V_83 = V_61 -> V_17 - V_61 -> V_15 ) >= V_68 -> V_19 ) {
if ( ( V_83 < V_81 ) || ( V_81 == 0 ) ) {
if ( ( V_61 -> V_15 % V_86 ) == 0 ) {
V_5 = 1 ;
V_81 = V_83 ;
...
while ( V_68 ) {
F_33 ( L_71 , V_68 -> V_33 ) ;
F_33 ( L_72 , V_68 -> V_4 , V_68 -> V_13 ) ;
F_33 ( L_73 , V_68 -> V_15 , V_68 -> V_17 , V_68 -> V_19 ) ;
if ( V_68 -> V_67 )
V_68 = V_68 -> V_67 ;
else if ( V_68 -> V_70 )
V_68 = V_68 -> V_70 ;
