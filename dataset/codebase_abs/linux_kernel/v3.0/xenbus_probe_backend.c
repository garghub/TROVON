...
return - V_26 ;
if ( F_9 ( V_17 , L_8 , V_19 -> V_3 ) )
return - V_26 ;
if ( F_9 ( V_17 , L_9 , V_23 -> V_27 ) )
return - V_26 ;
if ( V_15 -> V_28 ) {
V_21 = F_10 ( V_15 -> V_28 ) ;
if ( V_21 && V_21 -> V_29 )
...
F_6 ( L_5 ) ;
V_3 = F_12 ( V_32 , L_12 , V_23 -> V_27 , type , V_4 ) ;
if ( ! V_3 )
return - V_26 ;
...
{
int V_42 , V_43 ;
V_42 = F_25 ( V_10 , V_15 -> V_3 , L_13 , L_14 , & V_43 ) ;
if ( V_42 != 1 )
V_43 = 0 ;
return V_43 ;
}
