...
int V_52 = ( V_38 . V_21 . V_23 == V_53 ) ;
V_2 -> V_36 |= V_22 ;
if ( ( V_52 && V_48 != V_2 -> V_36 ) ||
( ! V_52 && ! V_38 . V_21 . V_25 ) )
V_49 = F_2 ( V_2 , V_37 ) ;
else
V_49 = 0 ;
}
F_15 ( V_38 . V_16 , V_37 , V_49 == 0 ) ;
}
F_16 ( & V_2 -> V_50 ) ;
return V_49 ;
}
...
int V_27 ;
for ( V_27 = 0 ; V_27 < V_8 ; V_27 ++ ) {
union V_18 * V_55 = & V_2 -> V_15 [ V_27 ] ;
if ( V_55 -> V_21 . V_28 != V_28 )
continue;
F_16 ( & V_2 -> V_50 ) ;
...
if ( V_54 != V_24 )
continue;
ASSERT ( V_55 -> V_21 . V_23 == V_24 ) ;
V_55 -> V_21 . V_25 = 0 ;
if ( ! V_55 -> V_21 . V_22 && ( V_2 -> V_36 & ( 1 << V_27 ) ) )
F_2 ( V_2 , V_27 ) ;
}
}
void F_19 ( struct V_34 * V_34 , int V_28 , int V_54 )
{
struct V_1 * V_2 = V_34 -> V_56 . V_57 ;
F_20 () ;
...
static inline struct V_1 * F_22 ( struct V_58 * V_59 )
{
return F_23 ( V_59 , struct V_1 , V_59 ) ;
}
...
static int F_25 ( struct V_58 * V_62 , T_3 V_3 , int V_63 ,
void * V_29 )
{
struct V_1 * V_2 = F_22 ( V_62 ) ;
T_1 V_5 ;
if ( ! F_24 ( V_2 , V_3 ) )
return - V_64 ;
...
static int F_27 ( struct V_58 * V_62 , T_3 V_3 , int V_63 ,
const void * V_29 )
{
struct V_1 * V_2 = F_22 ( V_62 ) ;
T_1 V_68 ;
...
struct V_1 * V_2 ;
int V_49 ;
V_2 = F_31 ( sizeof( struct V_1 ) , V_71 ) ;
if ( ! V_2 )
return - V_72 ;
F_32 ( & V_2 -> V_50 ) ;
V_34 -> V_56 . V_57 = V_2 ;
...
struct V_1 * V_2 = V_34 -> V_56 . V_57 ;
if ( V_2 ) {
F_39 ( V_34 , V_75 , & V_2 -> V_59 ) ;
V_34 -> V_56 . V_57 = NULL ;
F_37 ( V_2 ) ;
}
}
int F_40 ( struct V_34 * V_34 , struct V_76 * V_77 )
{
struct V_1 * V_2 = F_41 ( V_34 ) ;
if ( ! V_2 )
return - V_78 ;
F_14 ( & V_2 -> V_50 ) ;
memcpy ( V_77 , V_2 , sizeof( struct V_76 ) ) ;
F_16 ( & V_2 -> V_50 ) ;
return 0 ;
}
int F_42 ( struct V_34 * V_34 , struct V_76 * V_77 )
{
struct V_1 * V_2 = F_41 ( V_34 ) ;
if ( ! V_2 )
return - V_78 ;
F_14 ( & V_2 -> V_50 ) ;
memcpy ( V_2 , V_77 , sizeof( struct V_76 ) ) ;
F_4 ( V_2 ) ;
F_16 ( & V_2 -> V_50 ) ;
return 0 ;
}
