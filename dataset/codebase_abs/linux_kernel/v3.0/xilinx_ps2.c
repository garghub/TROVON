...
if ( F_18 ( V_38 -> V_17 . V_45 , 0 , & V_40 ) == V_47 ) {
F_6 ( V_17 , L_6 ) ;
return - V_48 ;
}
V_2 = F_19 ( sizeof( struct V_1 ) , V_49 ) ;
if ( ! V_2 ) {
F_6 ( V_17 , L_7 ) ;
return - V_50 ;
}
...
snprintf ( V_16 -> V_63 , sizeof( V_16 -> V_63 ) ,
...
static int T_6 F_28 ( struct V_37 * V_64 )
{
struct V_42 * V_17 = & V_64 -> V_17 ;
struct V_1 * V_2 = F_29 ( V_17 ) ;
struct V_39 V_41 ;
F_30 ( & V_2 -> V_16 ) ;
F_31 ( V_2 -> V_6 ) ;
if ( F_17 ( V_64 -> V_17 . V_45 , 0 , & V_41 ) )
F_6 ( V_17 , L_5 ) ;
else
F_26 ( V_41 . V_51 , F_22 ( & V_41 ) ) ;
F_27 ( V_2 ) ;
F_20 ( V_17 , NULL ) ;
return 0 ;
}
