...
static int F_23 ( struct V_41 * V_42 , struct V_62 * V_63 )
{
struct V_1 * V_2 = V_42 -> V_44 ;
int V_64 ;
int V_65 ;
...
V_64 = F_4 ( V_2 , 0x00 ) & 0xf ;
V_65 = F_4 ( V_2 , 0x01 ) >> 4 ;
V_66 = F_4 ( V_2 , 0x01 ) & 0xf ;
F_5 ( V_2 , 0x84 , 0x01 , 0x01 ) ;
F_5 ( V_2 , 0x84 , 0x01 , 0x00 ) ;
F_5 ( V_2 , 0x00 , 0x0f , V_64 ) ;
F_5 ( V_2 , 0x01 , 0xf0 , V_65 << 4 ) ;
F_5 ( V_2 , 0x01 , 0x0f , V_66 ) ;
...
F_12 ( V_2 , V_63 -> V_72 . V_73 . V_31 ) ;
F_8 ( V_2 , V_63 -> V_72 . V_73 . V_79 / 1000 ) ;
F_9 ( V_2 , V_68 , V_63 -> V_72 . V_73 . V_79 / 1000 ) ;
F_10 ( V_2 , V_69 ) ;
F_13 ( V_2 , V_38 ) ;
if ( V_63 -> V_72 . V_73 . V_31 == V_35 ||
V_63 -> V_72 . V_73 . V_31 == V_36 )
...
static int F_27 ( struct V_41 * V_42 , struct V_62 * V_63 )
{
struct V_1 * V_2 = V_42 -> V_44 ;
int V_83 , V_84 ;
V_83 = F_4 ( V_2 , 0x00 ) ;
V_84 = F_4 ( V_2 , 0x83 ) ;
V_63 -> V_82 = V_2 -> V_81 ;
V_63 -> V_38 = ( V_84 & 0x08 ) ? V_40 : V_39 ;
if ( V_2 -> V_10 -> V_74 )
V_63 -> V_38 = ( V_63 -> V_38 == V_40 ) ? V_39 : V_40 ;
V_63 -> V_72 . V_73 . V_79 = F_7 ( V_2 ) * 1000 ;
V_63 -> V_72 . V_73 . V_85 = V_86 ;
switch ( ( V_83 >> 4 ) & 0x7 ) {
case 0 :
V_63 -> V_72 . V_73 . V_31 = V_32 ;
break;
case 1 :
V_63 -> V_72 . V_73 . V_31 = V_33 ;
break;
case 2 :
V_63 -> V_72 . V_73 . V_31 = V_35 ;
break;
case 3 :
V_63 -> V_72 . V_73 . V_31 = V_36 ;
break;
case 4 :
V_63 -> V_72 . V_73 . V_31 = V_34 ;
break;
}
return 0 ;
}
...
struct V_41 * F_30 ( const struct V_87 * V_10 ,
struct V_88 * V_14 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_31 ( sizeof( struct V_1 ) , V_89 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_14 = V_14 ;
...
goto error;
memcpy ( & V_2 -> V_90 . V_75 , & V_91 , sizeof( struct V_92 ) ) ;
V_2 -> V_90 . V_44 = V_2 ;
return & V_2 -> V_90 ;
error:
F_29 ( V_2 ) ;
