...
V_187 = V_200 ;
V_200 += 0x10 ;
F_29 ( V_201 L_34 , V_187 ) ;
}
if ( ! V_188 ) {
V_188 = V_200 ;
V_200 += 0x10 ;
F_29 ( V_201 L_35 , V_188 ) ;
}
...
F_3 ( V_202 , F_9 ( V_2 , V_203 ) ) ;
F_10 ( 100 ) ;
F_3 ( 0 , F_9 ( V_2 , V_203 ) ) ;
F_10 ( 100 ) ;
F_3 ( V_204 | V_205 | ( V_184 ? V_206 : 0 ) , F_9 ( V_2 , V_203 ) ) ;
F_15 ( F_9 ( V_2 , V_60 ) ) ;
#if 1
F_11 ( V_2 , V_207 , 0 ) ;
#else
...
F_3 ( V_2 -> V_65 = ~ ( V_208 | V_209 | V_210 ) , F_9 ( V_2 , V_66 ) ) ;
F_15 ( F_9 ( V_2 , V_60 ) ) ;
F_11 ( V_2 , V_36 , 0 ) ;
F_11 ( V_2 , V_211 , 0 ) ;
F_11 ( V_2 , V_212 , 0 ) ;
F_19 ( V_2 , V_34 , 8000 ) ;
F_11 ( V_2 , V_213 , V_2 -> V_167 = 0x80 ) ;
F_11 ( V_2 , V_214 , V_2 -> V_168 = 0x00 ) ;
F_11 ( V_2 , V_215 , V_2 -> V_170 = 0x05 ) ;
F_11 ( V_2 , V_216 , V_2 -> V_169 = 0x00 ) ;
...
#endif
V_2 -> V_231 = F_16 ( V_2 , V_232 ) ;
if ( ( V_115 = F_112 ( V_84 , V_233 , V_2 , & V_190 ) ) < 0 ) {
F_92 ( V_2 ) ;
return V_115 ;
}
F_79 ( V_2 ) ;
...
static int F_114 ( struct V_234 * V_235 )
{
struct V_1 * V_2 = V_235 -> V_73 ;
F_3 ( V_2 -> V_65 &= ~ V_236 , F_9 ( V_2 , V_66 ) ) ;
return 0 ;
}
...
V_235 -> V_240 = F_114 ;
V_235 -> V_241 = F_115 ;
V_239 = & V_72 -> V_242 [ V_243 ] ;
for ( V_158 = 0 ; V_158 < F_74 ( V_244 ) ; V_158 ++ )
if ( ( V_115 = F_75 ( V_84 , F_76 ( & V_244 [ V_158 ] , V_2 ) ) ) < 0 )
return V_115 ;
return 0 ;
}
...
V_115 = F_118 ( V_253 [ V_174 ] , V_87 [ V_174 ] , V_254 , 0 , & V_84 ) ;
if ( V_115 < 0 )
return V_115 ;
for ( V_158 = 0 ; V_158 < 5 ; V_158 ++ ) {
if ( F_108 ( V_123 , V_158 ) == 0 ||
! ( F_119 ( V_123 , V_158 ) & V_255 ) ) {
F_120 ( V_84 ) ;
return - V_251 ;
}
}
...
strcpy ( V_84 -> V_256 , L_40 ) ;
strcpy ( V_84 -> V_257 , L_3 ) ;
sprintf ( V_84 -> V_258 , L_41 ,
V_84 -> V_257 ,
V_2 -> V_231 ,
...
if ( ( V_115 = F_123 ( V_249 , 0 , 1 , NULL ) ) < 0 ) {
F_120 ( V_84 ) ;
return V_115 ;
}
F_82 ( V_2 ) ;
