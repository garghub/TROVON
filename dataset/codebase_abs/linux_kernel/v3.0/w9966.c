...
V_65 -> V_72 = F_26 ( 0 , 33 , 0 ) ;
V_65 -> V_73 = V_74 | V_75 ;
return 0 ;
}
static int F_27 ( struct V_62 * V_62 , void * V_76 , struct V_77 * V_78 )
{
if ( V_78 -> V_79 > 0 )
return - V_80 ;
F_25 ( V_78 -> V_68 , L_4 , sizeof( V_78 -> V_68 ) ) ;
V_78 -> type = V_81 ;
V_78 -> V_82 = 0 ;
V_78 -> V_83 = 0 ;
V_78 -> V_84 = 0 ;
...
static int F_28 ( struct V_62 * V_62 , void * V_76 , unsigned int * V_86 )
{
* V_86 = 0 ;
return 0 ;
}
static int F_29 ( struct V_62 * V_62 , void * V_76 , unsigned int V_86 )
{
return ( V_86 > 0 ) ? - V_80 : 0 ;
}
static int F_30 ( struct V_62 * V_62 , void * V_63 ,
struct V_87 * V_88 )
{
switch ( V_88 -> V_89 ) {
case V_90 :
return F_31 ( V_88 , 0 , 255 , 1 , 128 ) ;
case V_91 :
return F_31 ( V_88 , - 64 , 64 , 1 , 64 ) ;
case V_92 :
return F_31 ( V_88 , - 64 , 64 , 1 , 64 ) ;
case V_93 :
return F_31 ( V_88 , - 128 , 127 , 1 , 0 ) ;
}
return - V_80 ;
}
...
static int F_33 ( struct V_62 * V_62 , void * V_63 ,
struct V_94 * V_95 )
{
struct V_1 * V_2 = F_24 ( V_62 ) ;
int V_96 = 0 ;
...
static int F_36 ( struct V_62 * V_62 , void * V_76 , struct V_100 * V_101 )
{
struct V_1 * V_2 = F_24 ( V_62 ) ;
...
static int F_37 ( struct V_62 * V_62 , void * V_76 , struct V_100 * V_101 )
{
struct V_102 * V_103 = & V_101 -> V_101 . V_103 ;
if ( V_103 -> V_51 < 2 )
V_103 -> V_51 = 2 ;
...
static int F_38 ( struct V_62 * V_62 , void * V_76 , struct V_100 * V_101 )
{
struct V_1 * V_2 = F_24 ( V_62 ) ;
struct V_102 * V_103 = & V_101 -> V_101 . V_103 ;
int V_96 = F_37 ( V_62 , V_76 , V_101 ) ;
if ( V_96 )
return V_96 ;
F_34 ( & V_2 -> V_98 ) ;
F_3 ( V_2 ) ;
V_96 = F_21 ( V_2 , 0 , 0 , 1023 , 1023 , V_103 -> V_51 , V_103 -> V_52 ) ;
F_5 ( V_2 ) ;
F_35 ( & V_2 -> V_98 ) ;
return V_96 ;
}
static int F_39 ( struct V_62 * V_62 , void * V_76 , struct V_112 * V_101 )
{
...
if ( V_101 -> V_79 > 0 )
return - V_80 ;
* V_101 = V_113 [ V_101 -> V_79 ] ;
V_101 -> type = type ;
return 0 ;
}
static T_1 F_40 ( struct V_62 * V_62 , char T_2 * V_115 ,
T_3 V_116 , T_4 * V_117 )
{
struct V_1 * V_2 = F_24 ( V_62 ) ;
...
static int F_44 ( struct V_1 * V_2 , struct V_127 * V_128 )
{
...
V_2 -> V_7 = F_47 ( V_128 , L_6 , NULL , NULL , NULL , 0 , NULL ) ;
if ( V_2 -> V_7 == NULL ) {
F_22 ( L_8 ) ;
return - 1 ;
}
...
F_5 ( V_2 ) ;
F_25 ( V_2 -> V_137 . V_68 , V_70 , sizeof( V_2 -> V_137 . V_68 ) ) ;
V_2 -> V_137 . V_67 = V_67 ;
V_2 -> V_137 . V_138 = & V_139 ;
V_2 -> V_137 . V_140 = & V_141 ;
V_2 -> V_137 . V_142 = V_143 ;
F_48 ( & V_2 -> V_137 , V_2 ) ;
F_49 ( & V_2 -> V_98 ) ;
if ( F_50 ( & V_2 -> V_137 , V_144 , V_145 ) < 0 )
return - 1 ;
F_1 ( V_2 , V_146 , V_146 ) ;
F_51 ( V_67 , L_10 ,
V_2 -> V_10 -> V_68 ) ;
...
{
if ( F_2 ( V_2 , V_146 , V_146 ) ) {
F_53 ( & V_2 -> V_137 ) ;
F_1 ( V_2 , V_146 , 0 ) ;
}
if ( F_2 ( V_2 , V_136 , V_136 ) ) {
F_3 ( V_2 ) ;
F_8 ( V_2 -> V_10 , V_147 ) ;
F_5 ( V_2 ) ;
}
...
{
int V_22 ;
for ( V_22 = 0 ; V_22 < V_148 ; V_22 ++ ) {
if ( V_149 [ V_22 ] . V_5 != 0 )
continue;
if ( strcmp ( V_150 [ V_22 ] , L_11 ) == 0 || strcmp ( V_150 [ V_22 ] , V_128 -> V_68 ) == 0 ) {
if ( F_44 ( & V_149 [ V_22 ] , V_128 ) != 0 )
F_52 ( & V_149 [ V_22 ] ) ;
break;
}
}
...
int V_22 ;
for ( V_22 = 0 ; V_22 < V_148 ; V_22 ++ )
if ( V_149 [ V_22 ] . V_5 != 0 && V_149 [ V_22 ] . V_10 == V_128 )
F_52 ( & V_149 [ V_22 ] ) ;
}
