...
static inline void F_19 ( struct V_16 * V_17 , T_6 * V_18 ,
unsigned long V_6 , unsigned long V_7 , T_1 V_2 ,
int V_8 )
{
T_2 * V_5 ;
...
static inline void F_26 ( struct V_16 * V_17 , T_7 * V_22 ,
unsigned long V_6 , unsigned long V_7 , T_1 V_2 ,
int V_8 )
{
T_6 * V_18 ;
...
if ( F_35 ( V_22 ) )
continue;
F_26 ( V_17 , V_22 , V_6 , V_19 , V_2 ,
V_8 ) ;
} while ( V_22 ++ , V_6 = V_19 , V_6 != V_7 );
F_36 ( V_17 , V_23 , V_7 ) ;
}
int
F_37 ( struct V_16 * V_17 , struct V_16 * * V_24 ,
...
* V_24 = F_39 ( V_4 , * V_24 , V_23 , V_7 , V_25 ,
V_17 -> V_40 , V_17 -> V_41 , V_31 , F_40 ( V_17 ) ) ;
if ( * V_24 ) {
V_17 = * V_24 ;
goto V_42;
}
* V_24 = V_17 ;
if ( V_23 != V_17 -> V_39 ) {
error = F_41 ( V_4 , V_17 , V_23 , 1 ) ;
if ( error )
goto V_43;
}
if ( V_7 != V_17 -> V_44 ) {
error = F_41 ( V_4 , V_17 , V_7 , 0 ) ;
if ( error )
goto V_43;
}
V_42:
...
F_42 ( V_25 ) ) ;
if ( F_43 ( V_17 ) ) {
V_17 -> V_45 = F_42 ( V_25 & ~ V_35 ) ;
V_8 = 1 ;
}
F_44 ( V_4 , V_23 , V_7 ) ;
if ( F_45 ( V_17 ) )
F_46 ( V_17 , V_23 , V_7 , V_17 -> V_45 ) ;
else
F_30 ( V_17 , V_23 , V_7 , V_17 -> V_45 , V_8 ) ;
F_47 ( V_4 , V_23 , V_7 ) ;
F_48 ( V_4 , V_26 , V_17 -> V_41 , - V_28 ) ;
F_48 ( V_4 , V_25 , V_17 -> V_41 , V_28 ) ;
F_49 ( V_17 ) ;
return 0 ;
V_43:
F_50 ( V_30 ) ;
