...
if ( V_276 . V_290 && ! V_92 ) {
if ( ! F_82 ( V_276 . V_290 , 1 , L_12 ) )
F_31 ( V_97 L_13 , V_276 . V_290 ) ;
else
V_92 = V_276 . V_290 ;
}
if ( V_276 . clock == 0 )
V_276 . clock = V_291 ;
#ifndef F_83
if( F_82 ( V_276 . V_292 , 1 , L_14 ) )
{
F_43 ( V_276 . V_88 ) ;
F_4 ( V_276 . V_292 , 0 ) ;
F_8 ( V_276 . V_292 , V_125 , V_231 ) ;
F_5 ( 100 ) ;
F_8 ( V_276 . V_292 , V_106 , 0x55 ) ;
F_5 ( 5 ) ;
if ( F_1 ( V_276 . V_292 , V_106 ) != 0x55 )
V_284 = 0 ;
F_45 ( V_276 . V_88 ) ;
F_84 ( V_276 . V_292 , 1 ) ;
}
...
if ( V_284 )
{
V_95 [ 2 * V_94 ] . V_9 = V_276 . V_292 ;
V_95 [ 2 * V_94 ] . V_25 = V_276 . V_293 ;
V_95 [ 2 * V_94 ] . V_88 = V_276 . V_88 ;
V_95 [ 2 * V_94 + 1 ] . V_9 = V_276 . V_294 ;
V_95 [ 2 * V_94 + 1 ] . V_25 = V_276 . V_295 ;
V_95 [ 2 * V_94 + 1 ] . V_88 = V_276 . V_88 ;
V_99 [ V_94 ] . V_100 = V_276 . V_292 ;
V_99 [ V_94 ] . V_101 = V_276 . V_294 ;
V_99 [ V_94 ] . V_88 = V_276 . V_88 ;
}
for ( V_279 = 0 ; V_279 < 2 ; V_279 ++ )
{
sprintf ( V_280 , L_15 , V_296 , 2 * V_94 + V_279 ) ;
...
V_95 [ 2 * V_94 + V_279 ] . V_46 = V_276 . V_297 ;
#ifdef F_83
F_31 ( V_224 L_16 ,
V_280 ,
...
return - V_218 ;
V_272 . V_308 = F_57 ( V_8 , V_272 . V_309 ) ;
...
if ( ! V_200 || F_80 ( & V_272 , V_200 , sizeof( V_272 ) ) )
return - V_218 ;
return F_56 ( V_8 , V_272 . V_309 , V_272 . V_308 ) ;
case V_311 :
if ( ! F_79 ( V_285 ) ) return - V_286 ;
...
memcpy ( V_37 -> V_248 , V_314 -> V_315 , V_37 -> V_256 ) ;
return 0 ;
}
