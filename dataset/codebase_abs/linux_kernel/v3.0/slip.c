...
V_22 = F_65 ( sizeof( * V_2 ) , V_33 , F_55 ) ;
if ( ! V_22 )
return NULL ;
V_22 -> V_92 = V_91 ;
}
...
static int F_68 ( struct V_56 * V_15 )
{
struct V_1 * V_2 ;
int V_4 ;
if ( ! F_69 ( V_116 ) )
...
static void F_75 ( struct V_56 * V_15 )
{
struct V_1 * V_2 = V_15 -> V_57 ;
...
static int F_78 ( struct V_56 * V_15 )
{
F_75 ( V_15 ) ;
return 0 ;
}
...
case V_133 :
#ifdef F_31
if ( F_63 ( V_137 , & V_2 -> V_49 ) )
F_32 ( V_137 , & V_2 -> V_49 ) ;
#endif
if ( ! F_79 ( V_105 , & V_2 -> V_49 ) &&
( V_2 -> V_18 > 2 ) )
F_16 ( V_2 ) ;
F_32 ( V_138 , & V_2 -> V_49 ) ;
V_2 -> V_18 = 0 ;
...
static int F_80 ( struct V_56 * V_15 , struct V_141 * V_141 ,
...
if ( F_81 ( ( void T_3 * ) V_143 , V_2 -> V_22 -> V_33 , V_144 ) )
return - V_146 ;
return 0 ;
case V_147 :
if ( F_82 ( V_2 -> V_27 , V_44 ) )
return - V_146 ;
return 0 ;
case V_148 :
if ( F_83 ( V_144 , V_44 ) )
...
return 0 ;
case V_154 :
if ( F_82 ( V_2 -> V_128 , V_44 ) )
return - V_146 ;
return 0 ;
#endif
default:
return F_86 ( V_15 , V_141 , V_142 , V_143 ) ;
}
}
static long F_87 ( struct V_56 * V_15 , struct V_141 * V_141 ,
unsigned int V_142 , unsigned long V_143 )
{
switch ( V_142 ) {
case V_145 :
...
case V_153 :
case V_154 :
return F_80 ( V_15 , V_141 , V_142 ,
( unsigned long ) F_88 ( V_143 ) ) ;
}
return - V_155 ;
}
static int F_89 ( struct V_23 * V_22 , struct V_156 * V_157 , int V_142 )
{
struct V_1 * V_2 = F_36 ( V_22 ) ;
...
F_17 ( V_37 L_14 ) ;
#endif
V_93 = F_92 ( sizeof( struct V_23 * ) * V_106 ,
V_12 ) ;
if ( ! V_93 ) {
F_17 ( V_163 L_15 ) ;
return - V_164 ;
}
V_161 = F_93 ( V_165 , & V_166 ) ;
if ( V_161 != 0 ) {
...
F_29 ( V_55 , & V_2 -> V_49 ) ;
F_84 ( & V_2 -> V_114 , V_53 + V_2 -> V_128 * V_62 ) ;
}
V_61:
F_42 ( & V_2 -> V_14 ) ;
}
...
F_29 ( V_137 , & V_2 -> V_49 ) ;
F_84 ( & V_2 -> V_111 , V_53 + V_2 -> V_126 * V_62 ) ;
}
V_61:
F_42 ( & V_2 -> V_14 ) ;
}
