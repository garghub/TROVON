...
int T_2 F_10 ( struct V_9 * V_10 , int V_8 , int V_7 )
{
struct V_11 * V_12 = F_11 ( & V_10 -> V_12 ) ;
struct V_13 T_3 * V_14 = V_12 -> V_15 ;
...
void F_22 ( struct V_9 * V_10 , int V_8 )
{
struct V_11 * V_12 = F_11 ( & V_10 -> V_12 ) ;
struct V_13 T_3 * V_14 = V_12 -> V_15 ;
T_1 V_22 ;
F_23 ( V_12 , L_10 V_16 , V_8 ) ;
if ( ! ( V_12 -> V_29 & V_30 ) )
return;
F_14 ( & V_12 -> V_21 ) ;
V_22 = F_16 ( & V_14 -> V_22 ) ;
...
void F_25 ( struct V_9 * V_10 , int V_8 )
{
struct V_11 * V_12 = F_11 ( & V_10 -> V_12 ) ;
struct V_13 T_3 * V_14 = V_12 -> V_15 ;
T_1 V_22 ;
F_23 ( V_12 , L_12 V_16 , V_8 ) ;
if ( ! ( V_12 -> V_29 & V_30 ) )
return;
V_22 = F_16 ( & V_14 -> V_22 ) ;
V_22 &= ~ ( 0x00080000u >> V_8 ) ;
...
F_27 ( ! V_12 || V_12 -> V_24 == 0 ) ;
V_14 = V_12 -> V_15 ;
F_14 ( & V_12 -> V_21 ) ;
F_12 ( V_12 , L_13 V_16 , V_8 ) ;
F_15 ( & V_14 -> V_22 , F_16 ( & V_14 -> V_22 ) & ~ F_28 ( V_8 ) ) ;
-- V_12 -> V_24 ;
F_17 ( & V_12 -> V_21 ) ;
}
...
void * F_30 ( struct V_9 * V_10 , void * V_32 )
{
struct V_11 * V_12 = F_11 ( & V_10 -> V_12 ) ;
...
V_33 -> V_35 = 0 ;
V_33 -> V_36 = 0 ;
F_31 ( V_34 , V_12 -> V_15 , sizeof( struct V_13 ) ) ;
return V_34 + 1 ;
}
static int T_2 F_32 ( struct V_9 * V_10 )
{
...
V_40 = - V_41 ;
V_12 -> V_15 = (struct V_13 T_3 * ) F_36 ( V_34 . V_46 ,
sizeof( struct V_13 ) ) ;
if ( V_12 -> V_15 == NULL ) {
F_13 ( V_17 L_16 ,
V_38 -> V_19 ) ;
...
if ( F_37 ( V_10 -> V_12 . V_18 , L_17 , NULL ) )
V_12 -> V_29 |= V_30 ;
if ( F_38 ( V_10 -> V_12 . V_18 , L_18 ) )
V_12 -> V_29 |= V_30 ;
F_24 ( V_12 , L_19 ,
...
static int T_4 F_42 ( struct V_9 * V_10 )
{
struct V_11 * V_12 = F_11 ( & V_10 -> V_12 ) ;
F_40 ( & V_10 -> V_12 , NULL ) ;
F_43 ( V_12 -> V_24 != 0 ) ;
