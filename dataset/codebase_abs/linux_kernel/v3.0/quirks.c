...
static void F_162 ( struct V_1 * V_2 , struct V_254 * V_255 ,
struct V_254 * V_18 )
{
while ( V_255 < V_18 ) {
if ( ( V_255 -> V_167 == V_2 -> V_167 || V_255 -> V_167 == ( T_3 ) V_256 ) &&
( V_255 -> V_94 == V_2 -> V_94 || V_255 -> V_94 == ( T_3 ) V_256 ) ) {
F_163 ( & V_2 -> V_2 , L_104 , V_255 -> V_257 ) ;
V_255 -> V_257 ( V_2 ) ;
}
V_255 ++ ;
}
}
void F_164 ( enum V_258 V_259 , struct V_1 * V_2 )
{
struct V_254 * V_19 , * V_18 ;
switch( V_259 ) {
case V_260 :
V_19 = V_261 ;
V_18 = V_262 ;
...
static int F_167 ( struct V_1 * V_2 , int V_286 )
{
int V_223 ;
if ( V_2 -> V_11 == V_287 ) {
V_223 = F_113 ( V_2 , V_288 ) ;
if ( ! V_223 )
return - V_289 ;
if ( V_286 )
return 0 ;
...
static int F_169 ( struct V_1 * V_2 , int V_286 )
{
int V_223 ;
V_223 = F_113 ( V_2 , V_290 ) ;
if ( ! V_223 )
return - V_289 ;
if ( V_286 )
return 0 ;
...
int F_170 ( struct V_1 * V_2 , int V_286 )
{
const struct V_293 * V_3 ;
for ( V_3 = V_293 ; V_3 -> V_294 ; V_3 ++ ) {
if ( ( V_3 -> V_167 == V_2 -> V_167 ||
V_3 -> V_167 == ( T_3 ) V_256 ) &&
( V_3 -> V_94 == V_2 -> V_94 ||
V_3 -> V_94 == ( T_3 ) V_256 ) )
return V_3 -> V_294 ( V_2 , V_286 ) ;
}
return - V_289 ;
}
