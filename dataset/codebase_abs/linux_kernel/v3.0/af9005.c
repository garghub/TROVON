...
V_49 -> V_88 = F_38 ( V_49 -> V_86 ) ;
return 0 ;
}
static int F_39 ( struct V_1 * V_2 , T_3 * V_89 , int * V_90 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
int V_14 , V_6 ;
T_2 V_10 [ 5 ] ;
...
F_40 ( L_67 , V_6 ) ;
F_7 ( ( V_11 + 6 ) , V_6 , F_40 ) ;
V_14 = V_92 ( V_2 , & V_11 [ 6 ] , V_6 , V_89 , V_90 ) ;
if ( V_14 ) {
F_2 ( L_68 ) ;
return V_14 ;
} else {
...
V_14 =
F_8 ( V_49 -> V_86 , V_95 , 0 ) ;
if ( V_14 )
return V_14 ;
F_43 ( L_71 ) ;
return 0 ;
}
static int F_44 ( struct V_85 * V_49 , int V_96 ,
T_1 V_97 , int V_76 )
{
T_2 V_98 = V_96 & 0x1f ;
int V_14 ;
...
V_118 = F_50 ( V_119 ) ;
V_120 = F_50 ( V_121 ) ;
if ( V_92 == NULL || V_118 == NULL || V_120 == NULL ) {
F_2 ( L_79 ) ;
V_112 . V_122 . V_123 . V_124 = NULL ;
} else {
V_112 . V_122 . V_123 . V_125 = V_118 ;
V_112 . V_122 . V_123 . V_126 = * V_120 ;
}
return 0 ;
}
