...
V_81 -> V_6 = F_74 ( V_131 . V_143 , V_131 . V_144 - V_131 . V_143 + 1 ) ;
if ( ! V_81 -> V_6 ) {
F_71 ( V_104 , L_13 ) ;
V_82 = - V_56 ;
goto V_142;
...
V_2 -> V_4 = F_77 ( V_132 ) ;
for ( V_40 = 0 ; V_40 < V_146 ; V_40 ++ ) {
int V_147 ;
enum V_148 V_98 ;
V_147 = F_78 ( V_37 , V_40 , & V_98 ) ;
V_2 -> V_29 [ V_40 ] = V_147 ;
V_2 -> V_149 [ V_40 ] = V_98 & V_150 ;
if ( ! F_79 ( V_147 ) ) {
if ( V_40 < V_151 ) {
F_71 ( V_104 , L_17 ,
V_40 , V_147 ) ;
...
for ( V_136 = 0 ; V_136 < V_153 ; V_136 ++ ) {
V_2 -> V_154 [ V_136 ] = F_83 ( V_37 , V_136 ) ;
if ( F_84 ( V_2 -> V_154 [ V_136 ] ) ) {
V_82 = F_85 ( V_2 -> V_154 [ V_136 ] ) ;
...
F_80 ( V_104 , L_35 , V_81 -> V_6 , V_133 ) ;
F_38 ( V_2 , V_58 ) ;
if ( V_2 -> V_162 != V_166 ) {
F_38 ( V_2 , V_26 ) ;
F_90 ( V_2 -> V_162 , V_167 ) ;
} else {
F_38 ( V_2 , V_27 ) ;
F_90 ( V_2 -> V_165 , V_167 >> 3 ) ;
}
F_3 ( & V_2 -> V_6 -> V_20 , 0xffff ) ;
F_3 ( & V_2 -> V_6 -> V_21 , 0 ) ;
V_82 = F_91 ( V_81 , V_133 , V_158 ) ;
if ( V_82 < 0 )
goto V_168;
F_92 ( V_2 ) ;
return 0 ;
...
F_93 ( V_133 ) ;
V_161:
F_94 ( V_2 -> V_10 -> V_19 , V_81 ) ;
V_159:
F_95 ( V_2 -> V_10 ) ;
V_156:
V_155:
while ( -- V_136 >= 0 )
F_96 ( V_2 -> V_154 [ V_136 ] ) ;
V_152:
while ( -- V_40 >= 0 ) {
if ( F_79 ( V_2 -> V_29 [ V_40 ] ) )
F_97 ( V_2 -> V_29 [ V_40 ] ) ;
}
F_98 ( V_132 ) ;
V_145:
...
static int T_6 F_101 ( struct V_127 * V_104 )
{
struct V_80 * V_81 = F_102 ( V_104 ) ;
struct V_1 * V_2 = F_47 ( V_81 ) ;
int V_40 ;
int V_136 ;
F_103 ( V_81 ) ;
...
static int T_6 F_106 ( struct V_125 * V_126 )
{
return F_101 ( & V_126 -> V_104 ) ;
}
