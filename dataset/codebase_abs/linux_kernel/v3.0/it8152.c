...
int T_1 F_15 ( struct V_24 * V_25 , T_2 V_26 , T_2 V_27 )
{
if ( ( V_25 -> V_28 == V_29 ) &&
( V_25 -> V_30 == V_31 ) ) {
if ( ( V_25 -> V_32 >> 8 ) == V_33 )
...
static int F_20 ( struct V_30 * V_25 )
{
if ( V_25 -> V_40 == & V_55 ) {
if ( V_25 -> V_56 )
* V_25 -> V_56 = ( V_57 - 1 ) | V_58 ;
V_25 -> V_59 = ( V_57 - 1 ) | V_58 ;
F_21 ( V_25 , 2048 , 4096 ) ;
}
return 0 ;
}
...
int F_24 ( struct V_30 * V_25 , T_4 V_60 , T_5 V_46 )
{
F_25 ( V_25 , L_1 ,
V_61 , V_60 , V_46 ) ;
return ( V_25 -> V_40 == & V_55 ) &&
( ( V_60 + V_46 - V_58 ) >= V_57 ) ;
}
