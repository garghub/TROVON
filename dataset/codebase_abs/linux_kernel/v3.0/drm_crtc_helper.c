...
F_4 ( L_20 , V_74 -> V_93 [ V_84 ] -> V_21 . V_22 ,
F_5 ( V_74 -> V_93 [ V_84 ] ) ) ;
V_74 -> V_93 [ V_84 ] -> V_46 = V_96 ;
}
}
F_21 ( V_15 ) ;
} else if ( V_80 ) {
...
struct V_98 * V_99 )
{
V_51 -> V_100 = V_99 -> V_100 ;
V_51 -> V_101 = V_99 -> V_101 ;
V_51 -> V_102 = V_99 -> V_102 ;
V_51 -> V_103 = V_99 -> V_104 ;
V_51 -> V_105 = V_99 -> V_105 ;
return 0 ;
}
