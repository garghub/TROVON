...
static int F_55 ( struct V_99 * V_14 , void * V_106 )
{
if ( ( V_14 -> V_15 [ 1 ] -> V_107 ) || ( V_14 -> V_15 [ 1 ] -> V_107 < 8 ) )
return - V_65 ;
V_14 -> V_15 [ 0 ] -> V_62 &= ~ V_108 ;
V_14 -> V_15 [ 0 ] -> V_62 |= V_109 ;
return F_56 ( V_14 ) ;
}
...
T_2 * V_9 = V_100 -> V_102 ;
int V_25 ;
V_100 -> V_15 [ 0 ] -> V_107 = 8 ;
if ( F_57 ( V_100 , F_55 , NULL ) < 0 )
goto V_110;
V_25 = F_58 ( V_100 , F_22 ) ;
if ( V_25 != 0 )
goto V_110;
V_25 = F_59 ( V_100 ) ;
if ( V_25 != 0 )
