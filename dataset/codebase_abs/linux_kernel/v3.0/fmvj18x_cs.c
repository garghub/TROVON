...
struct V_153 * V_154 )
{
strcpy ( V_154 -> V_155 , V_156 ) ;
strcpy ( V_154 -> V_157 , V_158 ) ;
sprintf ( V_154 -> V_159 , L_40 , V_5 -> V_62 ) ;
}
static int F_74 ( struct V_4 * V_5 , struct V_160 * V_161 ) {
return 0 ;
}
...
F_81 (ha, dev) {
unsigned int V_171 = F_82 ( V_172 , V_170 -> V_173 ) >> 26 ;
