...
static int F_51 ( struct V_100 * V_90 , T_3 V_101 )
{
...
static int F_52 ( struct V_100 * V_90 )
{
struct V_35 * V_36 = F_38 ( V_90 ) ;
struct V_2 * V_3 = F_21 ( V_36 ) ;
