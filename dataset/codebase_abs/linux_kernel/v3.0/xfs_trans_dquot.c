...
( V_65 ) - V_62 ) ;
if ( V_47 -> V_26 < 0 )
ASSERT ( F_20 ( V_60 -> V_67 ) >=
( V_65 ) - V_47 -> V_26 ) ;
#endif
if ( V_61 )
F_21 ( & V_60 -> V_64 , ( V_65 ) V_61 ) ;
if ( V_47 -> V_26 )
F_21 ( & V_60 -> V_67 , ( V_65 ) V_47 -> V_26 ) ;
if ( V_62 )
F_21 ( & V_60 -> V_66 , ( V_65 ) V_62 ) ;
if ( V_60 -> V_68 ) {
F_22 ( V_1 -> V_39 , V_60 ) ;
F_23 ( V_1 -> V_39 , V_60 ) ;
}
...
ASSERT ( V_2 -> V_72 >= F_20 ( V_2 -> V_63 . V_66 ) ) ;
ASSERT ( V_2 -> V_73 >= F_20 ( V_2 -> V_63 . V_67 ) ) ;
F_25 ( V_2 ) ;
return 0 ;
V_113:
F_25 ( V_2 ) ;
...
T_1 * V_1 )
{
V_1 -> V_20 = F_44 ( V_140 -> V_141 , V_142 ) ;
}
void
F_45 (
T_1 * V_1 )
