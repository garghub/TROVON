...
struct V_41 V_42 ;
T_2 V_83 ;
V_83 = F_29 ( V_43 , L_6 , V_82 ) ;
memcpy ( & V_42 . V_29 , & V_83 , sizeof( void * ) ) ;
V_42 . V_24 = ( char * ) F_30 ( V_43 , L_7 , V_82 ) ;
V_42 . V_50 = ( int ) F_29 ( V_43 , L_8 , V_82 ) ;
if ( V_84 -> V_42 )
V_84 -> V_42 ( & V_42 , V_43 , T_4 , T_5 , V_45 ) ;
}
static void
F_31 ( void * V_82 ,
struct V_43 * V_43 V_44 ,
...
V_68 . V_24 = ( char * ) F_30 ( V_43 , L_7 , V_82 ) ;
if ( V_84 -> V_42 )
V_84 -> V_68 ( & V_68 , V_43 , T_4 , T_5 , V_45 ) ;
}
static void
F_32 ( void * V_82 ,
struct V_43 * V_43 V_44 ,
...
V_74 . V_24 = ( char * ) F_30 ( V_43 , L_7 , V_82 ) ;
if ( V_84 -> V_42 )
V_84 -> V_74 ( & V_74 , V_43 , T_4 , T_5 , V_45 ) ;
}
static void
F_33 ( void * V_82 ,
struct V_43 * V_43 V_44 ,
...
V_78 . V_24 = ( char * ) F_30 ( V_43 , L_7 , V_82 ) ;
if ( V_84 -> V_42 )
V_84 -> V_78 ( & V_78 , V_43 , T_4 , T_5 , V_45 ) ;
}
static void
...
type = F_35 ( V_82 ) ;
V_43 = F_36 ( type ) ;
if ( ! strcmp ( V_43 -> V_24 , L_9 ) )
F_28 ( V_82 , V_43 , T_4 , T_5 , V_45 ) ;
if ( ! strcmp ( V_43 -> V_24 , L_10 ) )
F_31 ( V_82 , V_43 , T_4 , T_5 , V_45 ) ;
if ( ! strcmp ( V_43 -> V_24 , L_11 ) )
F_32 ( V_82 , V_43 , T_4 , T_5 , V_45 ) ;
if ( ! strcmp ( V_43 -> V_24 , L_12 ) )
F_33 ( V_82 , V_43 , T_4 , T_5 , V_45 ) ;
}
static void F_37 ( int V_85 , int V_86 )
{
int V_22 ;
const char * V_24 [ 4 ] =
{ L_13 , L_14 , L_15 , L_16 } ;
F_38 ( L_17 ) ;
F_38 ( L_18 , V_85 , V_86 ) ;
F_38 ( L_19 , ( double ) V_85 / ( double ) V_86 * 100 ) ;
F_38 ( L_20 ) ;
...
F_38 ( L_30 , V_5 -> V_58 ) ;
F_38 ( L_30 , V_5 -> V_76 ) ;
F_38 ( L_31 V_89 L_32 , V_5 -> V_70 ) ;
F_38 ( L_31 V_89 L_32 , V_5 -> V_71 ) ;
F_38 ( L_31 V_89 L_32 , V_5 -> V_19 == V_21 ?
0 : V_5 -> V_19 ) ;
F_38 ( L_33 ) ;
}
F_37 ( V_85 , V_86 ) ;
...
while ( V_4 ) {
V_5 = F_2 ( V_4 , struct V_1 , V_7 ) ;
V_90 = F_43 ( V_91 , V_5 -> V_2 ) ;
F_38 ( L_36 , V_5 -> V_2 , V_90 -> V_92 ) ;
V_4 = F_44 ( V_4 ) ;
} ;
}
...
static int F_47 ( union V_96 * V_43 ,
struct V_97 * V_98 ,
struct V_99 * T_6 V_44 ,
struct V_100 * V_101 )
{
struct V_45 * V_45 = F_43 ( V_101 , V_98 -> V_2 ) ;
if ( V_45 == NULL ) {
F_48 ( L_40 ,
V_43 -> V_102 . type ) ;
return - 1 ;
}
F_34 ( V_98 -> V_103 , V_98 -> T_4 , V_98 -> time , V_45 ) ;
return 0 ;
}
static int F_49 ( void )
{
V_91 = F_50 ( V_104 , V_105 , 0 , false , & V_106 ) ;
if ( ! V_91 )
F_9 ( L_41 ) ;
return F_51 ( V_91 , & V_106 ) ;
}
...
static int F_55 ( int V_107 , const char * * V_108 )
{
unsigned int V_109 , V_22 , V_110 ;
const char * * V_111 ;
V_109 = F_56 ( V_112 ) + V_107 - 1 ;
V_111 = calloc ( V_109 + 1 , sizeof( char * ) ) ;
if ( V_111 == NULL )
return - V_113 ;
for ( V_22 = 0 ; V_22 < F_56 ( V_112 ) ; V_22 ++ )
V_111 [ V_22 ] = F_57 ( V_112 [ V_22 ] ) ;
for ( V_110 = 1 ; V_110 < ( unsigned int ) V_107 ; V_110 ++ , V_22 ++ )
V_111 [ V_22 ] = V_108 [ V_110 ] ;
F_4 ( V_22 != V_109 ) ;
return F_58 ( V_22 , V_111 , NULL ) ;
}
int F_59 ( int V_107 , const char * * V_108 , const char * T_7 V_44 )
{
unsigned int V_22 ;
F_60 () ;
for ( V_22 = 0 ; V_22 < V_93 ; V_22 ++ )
F_10 ( V_114 + V_22 ) ;
V_107 = F_61 ( V_107 , V_108 , V_115 , V_116 ,
V_117 ) ;
if ( ! V_107 )
F_62 ( V_116 , V_115 ) ;
if ( ! strncmp ( V_108 [ 0 ] , L_42 , 3 ) ) {
return F_55 ( V_107 , V_108 ) ;
} else if ( ! strncmp ( V_108 [ 0 ] , L_43 , 6 ) ) {
V_84 = & V_118 ;
if ( V_107 ) {
V_107 = F_61 ( V_107 , V_108 ,
V_119 , V_120 , 0 ) ;
if ( V_107 )
F_62 ( V_120 , V_119 ) ;
}
F_53 () ;
} else if ( ! strcmp ( V_108 [ 0 ] , L_44 ) ) {
return F_63 ( V_107 , V_108 , T_7 ) ;
} else if ( ! strcmp ( V_108 [ 0 ] , L_45 ) ) {
if ( V_107 ) {
V_107 = F_61 ( V_107 , V_108 ,
V_121 , V_122 , 0 ) ;
if ( V_107 )
