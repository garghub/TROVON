...
static int T_1 F_12 ( struct V_37 * V_38 )
{
struct V_1 * V_1 ;
struct V_34 * V_3 ;
struct V_2 * V_2 ;
int V_7 , error ;
V_1 = F_13 ( sizeof( struct V_1 ) , V_39 ) ;
if ( ! V_1 )
return - V_40 ;
V_3 = F_14 () ;
if ( ! V_3 ) {
...
V_3 -> V_44 = 50 ;
V_2 = V_3 -> V_4 ;
V_2 -> V_45 [ 0 ] = F_16 ( V_46 ) | F_16 ( V_47 ) ;
V_2 -> V_48 = L_1 ;
V_2 -> V_49 = L_2 ;
V_2 -> V_50 = V_1 -> V_5 ;
V_2 -> V_51 = sizeof( unsigned short ) ;
V_2 -> V_52 = F_17 ( V_42 ) ;
V_2 -> V_35 . V_53 = & V_38 -> V_35 ;
V_2 -> V_54 . V_55 = V_56 ;
for ( V_7 = 0 ; V_7 < 128 ; V_7 ++ )
if ( V_1 -> V_5 [ V_7 ] )
F_18 ( V_1 -> V_5 [ V_7 ] , V_2 -> V_57 ) ;
F_19 ( V_58 , V_2 -> V_57 ) ;
F_20 ( V_2 , V_17 , V_18 ) ;
error = F_21 ( V_1 -> V_3 ) ;
if ( error )
...
static int T_2 F_25 ( struct V_37 * V_38 )
{
struct V_1 * V_1 = F_26 ( V_38 ) ;
F_15 ( V_38 , NULL ) ;
F_27 ( V_1 -> V_3 ) ;
F_23 ( V_1 -> V_3 ) ;
F_24 ( V_1 ) ;
