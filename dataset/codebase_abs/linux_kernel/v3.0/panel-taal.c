...
static int F_48 ( struct V_68 * V_11 )
{
...
V_8 = V_65 -> V_79 ( V_7 , V_69 ) ;
}
F_53 ( & V_19 -> V_75 ) ;
return V_8 ;
}
static int F_54 ( struct V_68 * V_11 )
{
if ( V_11 -> V_70 . V_71 == V_72 &&
V_11 -> V_70 . V_73 == V_72 )
return V_11 -> V_70 . V_74 ;
return 0 ;
}
...
* V_84 = V_7 -> V_83 . V_82 . V_86 ;
* V_85 = V_7 -> V_83 . V_82 . V_87 ;
} else {
* V_85 = V_7 -> V_83 . V_82 . V_86 ;
* V_84 = V_7 -> V_83 . V_82 . V_87 ;
}
}
static T_3 F_57 ( struct V_88 * V_11 ,
struct V_89 * V_90 , char * V_27 )
{
...
if ( V_8 )
return V_8 ;
return snprintf ( V_27 , V_94 , L_7 , V_91 ) ;
}
static T_3 F_59 ( struct V_88 * V_11 ,
struct V_89 * V_90 , char * V_27 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
...
if ( V_8 )
return V_8 ;
return snprintf ( V_27 , V_94 , L_8 , V_37 , V_38 , V_39 ) ;
}
static T_3 F_60 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
char * V_27 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
...
V_45 = V_19 -> V_97 ;
V_95 = L_9 ;
if ( V_45 >= 0 && V_45 < F_61 ( V_98 ) )
V_95 = V_98 [ V_45 ] ;
V_96 = snprintf ( V_27 , V_94 , L_10 , V_95 ) ;
return V_96 < V_94 - 1 ? V_96 : V_94 - 1 ;
}
static T_3 F_62 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
const char * V_27 , T_4 V_99 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
int V_4 ;
int V_8 ;
for ( V_4 = 0 ; V_4 < F_61 ( V_98 ) ; V_4 ++ ) {
if ( F_63 ( V_98 [ V_4 ] , V_27 ) )
break;
}
if ( V_4 == F_61 ( V_98 ) )
return - V_80 ;
...
static T_3 F_64 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
char * V_27 )
{
int V_96 ;
int V_4 ;
for ( V_4 = 0 , V_96 = 0 ;
V_96 < V_94 && V_4 < F_61 ( V_98 ) ; V_4 ++ )
V_96 += snprintf ( & V_27 [ V_96 ] , V_94 - V_96 , L_11 ,
V_4 ? L_12 : L_13 , V_98 [ V_4 ] ,
V_4 == F_61 ( V_98 ) - 1 ? L_14 : L_13 ) ;
return V_96 < V_94 ? V_96 : V_94 - 1 ;
}
static T_3 F_65 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
const char * V_27 , T_4 V_99 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
...
static T_3 F_67 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
char * V_27 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
...
V_102 = V_19 -> V_60 ;
F_53 ( & V_19 -> V_75 ) ;
return snprintf ( V_27 , V_94 , L_15 , V_102 ) ;
}
static T_3 F_68 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
const char * V_27 , T_4 V_99 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
...
static T_3 F_69 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
char * V_27 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
...
static T_3 F_70 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
const char * V_27 , T_4 V_99 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
...
static T_3 F_71 ( struct V_88 * V_11 ,
struct V_89 * V_90 ,
char * V_27 )
{
struct V_6 * V_7 = F_58 ( V_11 ) ;
...
V_7 -> V_83 . V_111 = V_112 ;
V_7 -> V_83 . V_82 = V_32 -> V_82 ;
V_7 -> V_113 . V_114 = 24 ;
...
F_82 ( & V_7 -> V_11 , V_19 ) ;
F_72 ( V_7 ) ;
memset ( & V_70 , 0 , sizeof( struct V_108 ) ) ;
if ( ! V_65 -> V_79 )
V_19 -> V_76 = true ;
if ( V_19 -> V_76 )
V_70 . V_123 = 255 ;
...
V_70 . V_123 = 127 ;
V_70 . type = V_124 ;
V_109 = F_83 ( F_84 ( & V_7 -> V_11 ) , & V_7 -> V_11 ,
V_7 , & V_125 , & V_70 ) ;
if ( F_6 ( V_109 ) ) {
V_8 = F_8 ( V_109 ) ;
goto V_126;
...
V_19 -> V_109 = V_109 ;
V_109 -> V_70 . V_71 = V_72 ;
V_109 -> V_70 . V_73 = V_72 ;
if ( V_19 -> V_76 )
V_109 -> V_70 . V_74 = 255 ;
else
V_109 -> V_70 . V_74 = 127 ;
...
{
struct V_6 * V_7 = V_17 ;
F_49 ( & V_7 -> V_11 , L_39 , V_13 ) ;
F_52 ( V_7 ) ;
}
static T_6 V_130 ( int V_154 , void * V_17 )
{
struct V_6 * V_7 = V_17 ;
struct V_18 * V_19 = F_31 ( & V_7 -> V_11 ) ;
int V_155 ;
int V_8 ;
V_155 = F_107 ( & V_19 -> V_117 , 1 , 0 ) ;
if ( V_155 ) {
F_34 ( & V_19 -> V_134 ) ;
...
{
struct V_18 * V_19 = F_109 ( V_159 , struct V_18 ,
V_134 . V_159 ) ;
...
struct V_16 * V_65 = F_12 ( V_7 ) ;
int V_8 ;
F_49 ( & V_7 -> V_11 , L_42 , V_51 , V_52 , V_53 , V_54 ) ;
F_50 ( & V_19 -> V_75 ) ;
F_51 ( V_7 ) ;
V_8 = F_47 ( V_7 ) ;
if ( V_8 )
...
if ( V_8 )
goto V_13;
if ( V_19 -> V_147 && V_65 -> V_127 ) {
V_19 -> V_156 . V_51 = V_51 ;
V_19 -> V_156 . V_52 = V_52 ;
V_19 -> V_156 . V_53 = V_53 ;
V_19 -> V_156 . V_54 = V_54 ;
F_112 () ;
F_113 ( & V_19 -> V_134 ,
F_14 ( 250 ) ) ;
F_78 ( & V_19 -> V_117 , 1 ) ;
