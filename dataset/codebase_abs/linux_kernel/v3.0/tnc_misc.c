...
return 0 ;
V_38:
F_26 ( L_11 , V_25 , V_26 , V_29 ) ;
F_27 ( V_11 , V_31 ) ;
F_12 ( V_31 ) ;
return - V_53 ;
}
struct V_1 * F_28 ( struct V_10 * V_11 ,
struct V_20 * V_21 ,
...
int F_33 ( struct V_10 * V_11 , struct V_20 * V_21 ,
void * V_58 )
{
union V_12 V_51 , * V_13 = & V_21 -> V_13 ;
int V_29 , type = F_22 ( V_11 , V_13 ) ;
struct V_59 * V_60 ;
V_60 = F_34 ( V_11 , V_21 -> V_25 ) ;
if ( V_60 )
V_29 = F_35 ( V_60 , V_58 , type , V_21 -> V_27 ,
V_21 -> V_25 , V_21 -> V_26 ) ;
else
