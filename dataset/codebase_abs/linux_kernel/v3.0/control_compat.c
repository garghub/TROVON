...
static inline long F_29 ( struct V_55 * V_55 , unsigned int V_57 , unsigned long V_58 )
{
struct V_12 * V_13 ;
struct V_59 * V_60 ;
void T_1 * V_61 = F_6 ( V_58 ) ;
int V_8 ;
V_13 = V_55 -> V_62 ;
...
case V_72 :
case V_73 :
return F_31 ( V_55 , V_57 , ( unsigned long ) V_61 ) ;
case V_74 :
return F_1 ( V_13 -> V_2 , V_61 ) ;
case V_75 :
return F_7 ( V_13 , V_61 ) ;
case V_76 :
return F_23 ( V_13 -> V_2 , V_61 ) ;
case V_77 :
return F_25 ( V_13 , V_61 ) ;
case V_78 :
return F_27 ( V_13 , V_61 , 0 ) ;
case V_79 :
return F_27 ( V_13 , V_61 , 1 ) ;
}
F_16 ( & V_80 ) ;
F_32 (p, &snd_control_compat_ioctls, list) {
if ( V_60 -> V_81 ) {
V_8 = V_60 -> V_81 ( V_13 -> V_2 , V_13 , V_57 , V_58 ) ;
if ( V_8 != - V_82 ) {
F_18 ( & V_80 ) ;
return V_8 ;
}
