...
int type , V_53 ;
T_1 V_16 ;
T_3 V_54 = 0 , V_55 = F_27 ( V_49 -> V_22 ) ;
F_7 ( L_8 ,
F_8 ( V_46 ) , V_3 -> V_25 , V_3 -> V_26 ) ;
V_16 = F_10 ( V_2 , V_46 , V_56 , V_57 ) ;
if ( V_16 )
goto V_58;
V_16 = V_59 ;
if ( ! V_3 -> V_25 )
...
goto V_58;
F_29 ( V_46 , V_61 ) ;
V_52 = F_30 ( V_3 -> V_26 , V_46 -> V_12 , V_3 -> V_25 ) ;
if ( F_31 ( V_52 ) ) {
V_16 = F_3 ( F_32 ( V_52 ) ) ;
goto V_62;
}
F_14 ( V_47 , V_27 ) ;
V_16 = F_33 ( V_47 , V_46 -> V_9 , V_52 , V_46 ) ;
if ( ! V_16 && ! V_52 -> V_63 )
V_16 = V_64 ;
F_34 ( V_52 ) ;
if ( V_16 ) {
...
V_49 -> V_67 = V_53 ;
if ( type != V_78 ) {
if ( type != V_71 && type != V_70 ) {
V_54 = 0 ;
} else if ( type == V_70 && ! ( V_49 -> V_21 & V_73 ) ) {
type = V_74 ;
} else {
if ( ! V_54 )
V_54 = V_55 ;
...
V_49 -> V_21 &= ~ V_73 ;
V_16 = V_60 ;
if ( V_50 && type != ( V_50 -> V_69 & V_68 ) )
goto V_62;
}
V_16 = 0 ;
if ( ! V_50 ) {
V_16 = F_36 ( V_2 , V_46 , V_3 -> V_26 , V_3 -> V_25 ,
V_49 , type , V_54 , V_47 ) ;
} else if ( type == V_78 ) {
F_7 ( L_10 ,
...
static T_1
F_38 ( struct V_1 * V_2 , struct V_24 * V_3 ,
void * V_4 )
{
T_1 V_16 ;
F_7 ( L_11 , F_8 ( & V_3 -> V_8 ) ,
V_3 -> V_25 , V_3 -> V_26 ) ;
V_16 = F_39 ( V_2 , & V_3 -> V_8 , - V_56 , V_3 -> V_26 , V_3 -> V_25 ) ;
F_16 ( & V_3 -> V_8 ) ;
return V_16 ;
}
static T_1
F_40 ( struct V_1 * V_2 , struct V_79 * V_3 ,
void * V_4 )
{
T_1 V_16 ;
F_7 ( L_12 ,
F_8 ( & V_3 -> V_80 ) , V_3 -> V_81 , V_3 -> V_82 ) ;
F_7 ( L_13 ,
F_8 ( & V_3 -> V_83 ) , V_3 -> V_84 , V_3 -> V_85 ) ;
V_16 = F_41 ( V_2 , & V_3 -> V_80 , V_3 -> V_82 , V_3 -> V_81 ,
& V_3 -> V_83 , V_3 -> V_85 , V_3 -> V_84 ) ;
F_16 ( & V_3 -> V_80 ) ;
F_16 ( & V_3 -> V_83 ) ;
return V_16 ;
}
static T_1
F_42 ( struct V_1 * V_2 , struct V_86 * V_3 ,
void * V_4 )
{
T_1 V_16 ;
F_7 ( L_14 ,
...
V_3 -> V_84 ,
V_3 -> V_85 ) ;
V_16 = F_43 ( V_2 , & V_3 -> V_83 , V_3 -> V_85 , V_3 -> V_84 ,
& V_3 -> V_80 ) ;
F_16 ( & V_3 -> V_80 ) ;
F_16 ( & V_3 -> V_83 ) ;
return V_16 ;
...
V_3 -> V_84 , V_3 -> V_85 ) ;
F_14 ( & V_88 , V_27 ) ;
V_16 = F_45 ( V_2 , & V_3 -> V_80 , V_3 -> V_82 , V_3 -> V_81 ,
V_3 -> V_85 , V_3 -> V_84 ,
& V_88 , & V_3 -> V_20 ) ;
F_16 ( & V_3 -> V_80 ) ;
F_16 ( & V_88 ) ;
...
static T_1
F_46 ( struct V_1 * V_2 , struct V_45 * V_3 ,
struct V_14 * V_4 )
{
T_1 V_16 ;
...
V_3 -> V_20 . V_21 &= ~ V_73 ;
F_14 ( & V_4 -> V_8 , V_27 ) ;
V_16 = F_36 ( V_2 , & V_3 -> V_8 , V_3 -> V_26 , V_3 -> V_25 ,
& V_3 -> V_20 , V_56 , 0 , & V_4 -> V_8 ) ;
F_16 ( & V_3 -> V_8 ) ;
return F_5 ( V_16 , V_4 ) ;
}
static T_1
F_47 ( struct V_1 * V_2 , struct V_24 * V_3 ,
void * V_4 )
{
T_1 V_16 ;
...
static T_1
F_48 ( struct V_1 * V_2 , struct V_89 * V_3 ,
struct V_90 * V_4 )
{
int V_34 ;
T_1 V_16 ;
...
static T_1
F_51 ( struct V_1 * V_2 , struct V_15 * V_3 ,
struct V_95 * V_4 )
{
T_1 V_16 ;
F_7 ( L_21 , F_8 ( & V_3 -> V_8 ) ) ;
V_16 = F_52 ( V_2 , & V_3 -> V_8 , & V_4 -> V_96 ,
V_18 ) ;
F_16 ( & V_3 -> V_8 ) ;
return V_16 ;
}
...
int V_146 ;
for ( V_146 = 0 ; V_146 < F_54 ( V_99 ) ; V_146 ++ ) {
if ( V_99 [ V_146 ] . V_98 == V_97 )
return V_99 [ V_146 ] . V_16 ;
}
F_20 ( V_147 L_22 , V_97 ) ;
return V_103 ;
}
