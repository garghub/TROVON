...
V_2 -> V_57 = V_53 [ V_48 ] . V_58 ;
V_2 -> V_59 = V_53 [ V_48 ] . V_60 ;
V_2 -> V_61 = V_53 [ V_48 ] . V_62 ;
break;
}
}
if ( V_48 == F_15 ( V_53 ) ) {
...
F_5 ( V_2 , V_79 ) | 0x08 ) ;
F_1 ( V_2 , V_80 , 0 ) ;
while ( V_65 < V_64 -> V_76 ) {
if ( ( V_64 -> V_76 - V_65 ) > V_67 )
V_66 = V_67 ;
else
V_66 = V_64 -> V_76 - V_65 ;
F_6 ( V_2 , V_81 ,
...
static int F_20 ( struct V_24 * V_25 , int V_84 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
F_2 ( 1 , L_27 , V_15 , V_84 ) ;
if ( V_84 == V_85 )
F_1 ( V_2 , V_86 ,
F_5 ( V_2 , V_86 ) | 0x20 ) ;
else
...
static int F_22 ( struct V_24 * V_25 , int V_118 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
struct V_5 * V_6 = & V_2 -> V_6 ;
...
static int F_23 ( struct V_24 * V_25 , int V_120 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
F_2 ( 1 , L_27 , V_15 , V_120 ) ;
F_1 ( V_2 , V_78 , 0x21 ) ;
F_1 ( V_2 , V_121 , 0x00 ) ;
if ( V_120 ) {
F_1 ( V_2 , V_122 , 0x80 | 0x20 ) ;
F_1 ( V_2 , V_123 , 0xc0 ) ;
} else {
F_1 ( V_2 , V_122 , 0x00 ) ;
F_1 ( V_2 , V_123 , 0x01 ) ;
...
{
struct V_1 * V_2 = V_25 -> V_28 ;
F_2 ( 1 , L_28 , V_15 , V_62 -> V_125 ) ;
if ( V_62 -> V_126 . V_127 . V_47 != V_2 -> V_47 ) {
F_14 ( V_25 , V_62 -> V_126 . V_127 . V_47 ) ;
F_13 ( V_25 , V_62 -> V_126 . V_127 . V_47 ) ;
}
if ( V_25 -> V_128 . V_129 . V_130 ) {
if ( V_25 -> V_128 . V_131 )
V_25 -> V_128 . V_131 ( V_25 , 1 ) ;
V_25 -> V_128 . V_129 . V_130 ( V_25 , V_62 ) ;
if ( V_25 -> V_128 . V_131 )
V_25 -> V_128 . V_131 ( V_25 , 0 ) ;
}
F_1 ( V_2 , V_89 , 0x57 ) ;
F_1 ( V_2 , V_132 , 0x3B ) ;
return 0 ;
...
int V_7 = 0 , V_48 ;
F_2 ( 1 , L_8 , V_15 ) ;
for ( V_48 = 0 ; V_48 < F_15 ( V_133 ) ; V_48 ++ )
F_1 ( V_2 , V_133 [ V_48 ] . V_3 , V_133 [ V_48 ] . V_4 ) ;
if ( V_2 -> V_83 == 0 )
V_7 = F_16 ( V_25 ) ;
F_23 ( V_25 , V_6 -> V_134 ) ;
F_20 ( V_25 , V_6 -> V_84 ) ;
...
static int F_26 ( struct V_24 * V_25 , T_5 * V_135 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
T_1 V_3 ;
* V_135 = 0 ;
...
static int F_27 ( struct V_24 * V_25 , T_3 * V_141 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
static T_3 V_142 ;
T_3 V_143 ;
T_4 V_144 ;
F_2 ( 1 , L_8 , V_15 ) ;
if ( F_5 ( V_2 , V_145 ) & 0x01 ) {
V_144 = F_5 ( V_2 , V_146 ) << 8 |
F_5 ( V_2 , V_147 ) ;
V_143 = F_5 ( V_2 , V_148 ) << 8 |
F_5 ( V_2 , V_149 ) ;
V_144 *= 100000000 ;
V_144 *= 2 ;
V_144 = F_28 ( V_144 , ( V_143 * 32 ) + 1 ) ;
V_142 = ( T_3 ) V_144 ;
F_1 ( V_2 , V_132 , 0x39 ) ;
}
* V_141 = V_142 ;
...
static int F_30 ( struct V_24 * V_25 , T_2 * V_153 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
T_1 V_151 ;
int V_48 , V_7 = - V_30 ;
F_2 ( 1 , L_8 , V_15 ) ;
V_151 = F_5 ( V_2 , V_152 ) ;
for ( V_48 = 0 ; V_48 < F_15 ( V_154 ) ; V_48 ++ ) {
if ( V_151 <= V_154 [ V_48 ] . V_88 ) {
* V_153 = V_154 [ V_48 ] . V_4 ;
V_7 = 0 ;
break;
}
}
...
static int F_31 ( struct V_24 * V_25 , T_3 * V_155 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
F_2 ( 1 , L_8 , V_15 ) ;
* V_155 = F_5 ( V_2 , V_156 ) << 8 |
F_5 ( V_2 , V_157 ) ;
if ( * V_155 == 0xFFFF )
F_1 ( V_2 , V_158 , 0x80 ) ;
return 0 ;
...
struct V_1 * V_2 = V_25 -> V_28 ;
F_2 ( 1 , L_8 , V_15 ) ;
V_62 -> V_84 = F_5 ( V_2 , V_86 )
& 0x20 ? V_159 : V_160 ;
return F_21 ( V_2 , & V_62 -> V_126 . V_127 ) ;
}
...
V_2 -> V_83 = 0 ;
V_2 -> V_47 = V_45 ;
if ( F_5 ( V_2 , V_168 ) != 0x048 )
goto error;
memcpy ( & V_2 -> V_169 . V_128 , & V_170 ,
sizeof( struct V_171 ) ) ;
V_2 -> V_169 . V_28 = V_2 ;
F_35 ( & V_2 -> V_169 ) ;
if ( F_14 ( & V_2 -> V_169 , V_45 ) != 0 )
goto error;
if ( F_13 ( & V_2 -> V_169 , V_45 ) != 0 )
goto error;
F_22 ( & V_2 -> V_169 , 0 ) ;
return & V_2 -> V_169 ;
error:
