...
#endif
V_4 -> V_10 = V_10 ;
strcpy ( V_50 -> V_100 , V_4 -> V_7 ) ;
sprintf ( V_50 -> V_101 , L_23 , V_50 -> V_100 ) ;
#if F_19 ( F_18 ) || F_19 ( F_6 )
sprintf ( V_50 -> V_102 , L_24 ,
V_50 -> V_101 , V_56 -> V_7 ,
V_4 -> V_42 + 4 , V_10 , V_32 , V_86 ) ;
#else
sprintf ( V_50 -> V_102 , L_25 ,
V_50 -> V_101 , V_56 -> V_7 , V_4 -> V_42 + 4 , V_10 , V_32 ) ;
#endif
if ( V_34 <= 0 || V_34 == V_94 )
V_91 = NULL ;
else {
error = F_49 ( V_50 , 0 , V_103 ,
V_34 , 0 , V_35 , V_98 , & V_91 ) ;
if ( error )
F_8 ( V_43 L_26 ,
V_34 ) ;
}
...
#endif
if ( ! V_105 && F_51 ( V_50 , V_82 , V_82 + 2 ,
V_108 , 0 , & V_105 ) < 0 ) {
F_8 ( V_43 L_27 ,
V_82 , V_82 + 4 - 1 ) ;
}
if ( V_105 ) {
error = F_52 ( V_105 , 0 , 1 , & V_93 ) ;
if ( error < 0 )
return error ;
}
}
...
static int F_54 ( struct V_49 * * V_109 )
{
struct V_49 * V_50 ;
int V_55 ;
V_55 = F_55 ( V_60 , V_81 , V_110 ,
...
static int T_1 F_56 ( struct V_112 * V_113 ,
unsigned int V_114 )
{
#ifdef F_7
if ( V_115 )
...
static int T_1 F_57 ( struct V_112 * V_113 ,
unsigned int V_114 )
{
struct V_49 * V_50 ;
int error ;
static long V_116 [] = { 0x300 , 0x310 , 0x320 , 0x330 , - 1 } ;
#ifdef F_6
static int V_117 [] = { 5 , 9 , 10 , 11 , 7 , - 1 } ;
#else
static int V_117 [] = { 9 , 10 , 11 , 7 , - 1 } ;
#endif
static int V_118 [] = { 5 , 9 , 10 , 7 , - 1 } ;
static int V_119 [] = { 3 , 1 , 0 , - 1 } ;
#if F_19 ( F_18 ) || F_19 ( F_6 )
static int V_120 [] [ 2 ] = { { 1 , - 1 } , { 0 , - 1 } , { - 1 , - 1 } , { 0 , - 1 } } ;
#endif
if ( V_34 == V_94 ) {
if ( ( V_34 = F_1 ( V_116 , 2 ) ) < 0 ) {
F_8 ( V_25 L_28 ) ;
return - V_46 ;
}
}
if ( V_10 == V_121 ) {
if ( ( V_10 = F_58 ( V_117 ) ) < 0 ) {
F_8 ( V_25 L_29 ) ;
return - V_46 ;
}
}
if ( V_35 == V_121 ) {
if ( ( V_35 = F_58 ( V_118 ) ) < 0 ) {
F_8 ( V_25 L_30 ) ;
return - V_46 ;
}
}
if ( V_32 == V_122 ) {
if ( ( V_32 = F_59 ( V_119 ) ) < 0 ) {
F_8 ( V_25 L_31 ) ;
return - V_46 ;
}
}
...
static int T_3 F_64 ( struct V_112 * V_113 ,
unsigned int V_114 )
{
F_61 ( F_65 ( V_113 ) ) ;
F_63 ( V_113 , NULL ) ;
...
static int T_1 F_66 ( struct V_73 * V_123 ,
const struct V_74 * V_75 )
{
struct V_49 * V_50 ;
int error , V_124 ;
...
static void T_3 F_68 ( struct V_73 * V_123 )
{
F_61 ( F_69 ( V_123 ) ) ;
F_67 ( V_123 , NULL ) ;
V_115 = 0 ;
