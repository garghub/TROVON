...
static int T_1 F_20 ( int V_1 , int V_2 , int V_3 )
{
T_4 V_20 ;
T_4 V_21 ;
T_4 V_22 ;
T_3 type ;
int V_23 ;
V_20 = F_21 ( V_1 , V_2 , V_3 , V_24 ) ;
if ( V_20 == 0xffff )
return - 1 ;
V_21 = F_21 ( V_1 , V_2 , V_3 , V_25 ) ;
V_22 = F_21 ( V_1 , V_2 , V_3 , V_26 ) ;
for ( V_23 = 0 ; V_27 [ V_23 ] . V_28 != NULL ; V_23 ++ ) {
if ( ( ( V_27 [ V_23 ] . V_21 == V_29 ) ||
( V_27 [ V_23 ] . V_21 == V_21 ) ) &&
( ( V_27 [ V_23 ] . V_22 == V_29 ) ||
( V_27 [ V_23 ] . V_22 == V_22 ) ) &&
( ! ( ( V_27 [ V_23 ] . V_20 ^ V_20 ) &
