...
struct V_34 * V_35 ;
struct V_251 * V_252 ;
V_252 = F_42 ( V_2 -> V_9 , struct V_251 , V_9 ) ;
V_35 = F_10 ( V_2 ) ;
F_35 ( V_2 , V_246 ) ;
return 0 ;
}
...
V_35 = F_10 ( V_2 ) ;
V_35 -> V_2 = V_2 ;
V_32 = F_44 ( V_2 , 16 , 16 , V_35 -> V_254 ) ;
if ( V_32 < 0 ) {
...
V_32 = F_45 ( V_2 -> V_9 , F_27 ( V_35 -> V_247 ) ,
V_35 -> V_247 ) ;
if ( V_32 ) {
F_14 ( V_2 -> V_9 , L_37 , V_32 ) ;
return V_32 ;
}
V_35 -> V_257 [ 0 ] . V_258 = V_259 ;
V_35 -> V_257 [ 1 ] . V_258 = V_260 ;
V_35 -> V_257 [ 2 ] . V_258 = V_261 ;
V_35 -> V_257 [ 3 ] . V_258 = V_262 ;
V_35 -> V_257 [ 4 ] . V_258 = V_263 ;
V_35 -> V_257 [ 5 ] . V_258 = V_264 ;
V_35 -> V_257 [ 6 ] . V_258 = V_265 ;
V_35 -> V_257 [ 7 ] . V_258 = V_266 ;
for ( V_154 = 0 ; V_154 < F_27 ( V_35 -> V_247 ) ; V_154 ++ ) {
V_32 = F_46 ( V_35 -> V_247 [ V_154 ] . V_267 ,
& V_35 -> V_257 [ V_154 ] ) ;
if ( V_32 ) {
F_14 ( V_2 -> V_9 ,
L_38 ,
...
V_268:
F_50 ( F_27 ( V_35 -> V_247 ) , V_35 -> V_247 ) ;
return V_32 ;
}
static int T_4 F_51 ( struct V_299 * V_300 )
{
struct V_34 * V_35 ;
int V_32 ;
V_35 = F_52 ( sizeof *V_35 , V_301 ) ;
if ( ! V_35 )
return - V_302 ;
V_35 -> V_254 = V_303 ;
F_53 ( V_300 , V_35 ) ;
...
static int T_5 F_56 ( struct V_299 * V_300 )
{
F_57 ( & V_300 -> V_9 ) ;
F_55 ( F_58 ( V_300 ) ) ;
return 0 ;
}
static T_4 int F_59 ( struct V_251 * V_252 ,
...
static T_5 int F_61 ( struct V_251 * V_308 )
{
F_57 ( & V_308 -> V_9 ) ;
F_55 ( F_62 ( V_308 ) ) ;
return 0 ;
