...
int F_25 ( int V_11 , int V_15 , unsigned int V_23 )
{
struct V_2 * V_3 ;
V_3 = F_8 ( V_11 , V_15 ) ;
if ( V_3 == NULL )
...
struct V_2 * F_30 ( char * V_27 )
{
int V_4 ;
struct V_2 * V_3 ;
for ( V_4 = 0 ; V_4 < V_7 ; V_4 ++ ) {
if ( ( V_3 = F_28 ( V_4 ) ) != NULL ) {
...
void F_32 ( struct V_2 * V_3 , int V_28 , int V_29 )
{
unsigned long V_5 ;
struct V_30 * V_31 ;
if ( V_3 == NULL )
...
F_4 ( & V_3 -> V_17 , V_5 ) ;
V_34:
while ( ( V_31 = F_33 ( V_3 -> V_20 ) ) != NULL ) {
if ( F_34 ( & V_3 -> V_22 -> V_35 . V_36 ,
& V_31 -> V_37 . time . V_35 ) ) {
V_31 = F_35 ( V_3 -> V_20 ) ;
if ( V_31 )
F_36 ( V_31 , V_28 , V_29 ) ;
...
while ( ( V_31 = F_33 ( V_3 -> V_21 ) ) != NULL ) {
if ( F_37 ( & V_3 -> V_22 -> V_38 ,
& V_31 -> V_37 . time . time ) ) {
V_31 = F_35 ( V_3 -> V_21 ) ;
if ( V_31 )
F_36 ( V_31 , V_28 , V_29 ) ;
...
int F_38 ( struct V_30 * V_31 , int V_28 , int V_29 )
{
int V_39 , V_40 ;
struct V_2 * V_3 ;
if ( F_39 ( ! V_31 ) )
...
switch ( V_31 -> V_37 . V_5 & V_43 ) {
case V_44 :
V_40 = F_41 ( V_3 -> V_20 , V_31 ) ;
break;
case V_45 :
default:
V_40 = F_41 ( V_3 -> V_21 , V_31 ) ;
break;
}
if ( V_40 < 0 ) {
F_31 ( V_3 ) ;
...
static inline int F_42 ( struct V_2 * V_3 , int V_11 )
{
return ( V_3 -> V_13 == V_11 ) || ( ! V_3 -> V_15 && ! V_3 -> V_14 ) ;
}
static int F_43 ( struct V_2 * V_3 , int V_11 )
{
unsigned long V_5 ;
int V_47 ;
F_3 ( & V_3 -> V_12 , V_5 ) ;
...
int F_45 ( int V_25 , int V_11 )
{
struct V_2 * V_3 = F_28 ( V_25 ) ;
int V_47 ;
unsigned long V_5 ;
if ( ! V_3 )
return 0 ;
...
int F_46 ( int V_25 , int V_11 , int V_15 )
{
struct V_2 * V_3 = F_28 ( V_25 ) ;
if ( V_3 == NULL )
return - V_26 ;
...
V_49 = F_52 ( V_3 -> V_22 , V_53 -> V_54 ) ;
if ( V_49 >= 0 )
V_49 = F_53 ( V_3 -> V_22 , V_53 -> V_55 ) ;
if ( V_49 >= 0 && V_53 -> V_56 > 0 )
V_49 = F_54 ( V_3 -> V_22 , V_53 -> V_57 ,
V_53 -> V_56 ) ;
F_44 ( V_3 ) ;
F_31 ( V_3 ) ;
return V_49 ;
}
int F_26 ( int V_25 , int V_11 , int V_58 )
{
struct V_2 * V_9 ;
V_9 = F_28 ( V_25 ) ;
if ( V_9 == NULL )
...
break;
case V_77 :
F_52 ( V_3 -> V_22 , V_66 -> V_68 . V_9 . V_78 . V_79 ) ;
F_68 ( V_3 , V_66 , V_28 , V_29 ) ;
break;
case V_80 :
...
if ( F_39 ( ! V_66 ) )
return - V_26 ;
V_3 = F_28 ( V_66 -> V_68 . V_9 . V_9 ) ;
if ( V_3 == NULL )
return - V_26 ;
if ( ! F_43 ( V_3 , V_66 -> V_69 . V_11 ) ) {
F_31 ( V_3 ) ;
return - V_48 ;
}
...
V_89 = 0 ;
F_77 ( V_88 , L_2 , V_3 -> V_9 , V_3 -> V_27 ) ;
F_77 ( V_88 , L_3 , V_3 -> V_13 ) ;
F_77 ( V_88 , L_4 , V_3 -> V_15 ? L_5 : L_6 ) ;
F_77 ( V_88 , L_7 , F_78 ( V_3 -> V_21 ) ) ;
F_77 ( V_88 , L_8 , F_78 ( V_3 -> V_20 ) ) ;
F_77 ( V_88 , L_9 , V_51 -> V_61 ? L_10 : L_11 ) ;
F_77 ( V_88 , L_12 , V_51 -> V_55 ) ;
F_77 ( V_88 , L_13 , V_51 -> V_54 ) ;
F_77 ( V_88 , L_14 , V_89 ) ;
F_77 ( V_88 , L_15 , V_51 -> V_38 . V_90 , V_51 -> V_38 . V_91 ) ;
F_77 ( V_88 , L_16 , V_51 -> V_35 . V_36 ) ;
F_77 ( V_88 , L_17 ) ;
F_31 ( V_3 ) ;
}
}
