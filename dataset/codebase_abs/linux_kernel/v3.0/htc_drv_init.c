...
F_77 ( V_218 ) |
F_77 ( V_219 ) ;
V_12 -> V_13 -> V_206 &= ~ V_220 ;
V_12 -> V_221 = 4 ;
V_12 -> V_222 = 5000 ;
V_12 -> V_223 = 10 ;
V_12 -> V_224 = sizeof( struct V_225 ) ;
V_12 -> V_226 = sizeof( struct V_227 ) ;
V_12 -> V_228 = sizeof( struct V_229 ) +
sizeof( struct V_230 ) + 4 ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_132 )
V_12 -> V_13 -> V_231 [ V_134 ] =
& V_2 -> V_133 [ V_134 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_142 )
V_12 -> V_13 -> V_231 [ V_143 ] =
& V_2 -> V_133 [ V_143 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_232 ) {
if ( V_2 -> V_10 -> V_100 . V_101 & V_132 )
F_49 ( V_2 ,
& V_2 -> V_133 [ V_134 ] . V_233 ) ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_142 )
F_49 ( V_2 ,
& V_2 -> V_133 [ V_143 ] . V_233 ) ;
}
F_78 ( V_12 , V_55 -> V_234 ) ;
}
...
if ( V_26 )
return - V_125 ;
V_2 -> V_238 = F_81 ( V_236 . V_239 ) ;
V_2 -> V_240 = F_81 ( V_236 . V_241 ) ;
snprintf ( V_12 -> V_13 -> V_242 , V_243 , L_16 ,
V_2 -> V_238 ,
V_2 -> V_240 ) ;
F_22 ( V_2 -> V_8 , L_17 ,
V_2 -> V_238 ,
...
if ( error != 0 )
goto V_249;
error = F_83 ( & V_55 -> V_250 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_251;
V_57 = & V_55 -> V_250 ;
...
goto V_258;
if ( ! F_89 ( V_57 ) ) {
error = F_90 ( V_12 -> V_13 , V_57 -> V_259 ) ;
if ( error )
goto V_260;
}
error = F_91 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_92 ( V_2 -> V_10 , V_247 , sizeof( V_247 ) ) ;
F_93 ( V_12 -> V_13 , L_22 , V_247 ) ;
F_94 ( V_2 ) ;
F_95 ( V_2 ) ;
return 0 ;
V_260:
...
int F_96 ( struct V_261 * V_262 , struct V_263 * V_8 ,
T_1 V_24 , char * V_161 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_97 ( sizeof( struct V_1 ) , & V_264 ) ;
if ( ! V_12 )
return - V_165 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_102 ( struct V_261 * V_262 , bool V_267 )
{
if ( V_262 -> V_265 ) {
if ( V_267 )
V_262 -> V_265 -> V_10 -> V_169 |= V_268 ;
F_9 ( V_262 -> V_265 ) ;
F_100 ( V_262 -> V_265 ) ;
F_101 ( V_262 -> V_265 -> V_12 ) ;
}
}
void F_103 ( struct V_261 * V_262 )
{
F_104 ( V_262 -> V_265 , V_269 ) ;
}
int F_105 ( struct V_261 * V_262 )
{
struct V_1 * V_2 = V_262 -> V_265 ;
int V_26 ;
V_26 = F_1 ( V_2 ) ;
if ( V_26 )
return V_26 ;
