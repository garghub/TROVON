...
V_40 = V_95 | V_96
| V_97 ;
F_6 ( V_5 -> V_9 , V_98 , V_40 ) ;
}
break;
case V_94 :
V_40 = V_95 | V_96 | V_97 ;
F_29 ( V_5 -> V_9 , V_98 , V_40 , 0 ) ;
break;
}
V_5 -> V_92 . V_93 = V_88 ;
return 0 ;
}
static T_1 F_30 ( int V_99 , void * V_40 )
{
...
if ( V_102 )
F_34 ( V_67 -> V_107 . V_123 , V_102 , V_30 ) ;
if ( V_103 )
F_34 ( V_67 -> V_107 . V_124 , V_121 ,
V_121 ) ;
F_35 ( V_67 -> V_5 -> V_118 , L_3 ,
V_102 , V_30 ) ;
F_35 ( V_67 -> V_5 -> V_118 , L_4 , V_103 ) ;
return V_125 ;
}
...
{
struct V_66 * V_67 = F_24 ( V_5 ) ;
struct V_137 * V_92 = & V_5 -> V_92 ;
int V_22 , V_68 ;
V_67 -> V_5 = V_5 ;
V_5 -> V_9 = V_67 -> V_104 ;
for ( V_22 = 0 ; V_22 < 4 ; V_22 ++ ) {
V_68 = F_39 ( V_67 -> V_99 [ V_22 ] , NULL ,
F_30 , V_138 ,
V_67 -> V_41 [ V_22 ] , V_67 ) ;
if ( V_68 < 0 ) {
F_40 ( V_5 -> V_118 , L_5 ) ;
...
F_43 ( V_92 , V_141 ,
F_10 ( V_141 ) ) ;
F_44 ( V_92 , V_142 , F_10 ( V_142 ) ) ;
return 0 ;
V_139:
while ( -- V_22 >= 0 )
F_45 ( V_67 -> V_99 [ V_22 ] , V_67 ) ;
return V_68 ;
}
...
static int T_2 F_47 ( struct V_143 * V_144 )
{
struct V_145 * V_146 = F_48 ( V_144 -> V_118 . V_147 ) ;
struct V_66 * V_67 ;
struct V_148 * V_149 ;
int V_22 , V_68 ;
V_67 = F_49 ( sizeof( struct V_66 ) , V_150 ) ;
if ( V_67 == NULL )
return - V_151 ;
V_67 -> V_146 = V_146 ;
V_67 -> V_104 = ( V_146 -> V_152 == V_153 ) ? V_146 -> V_154
: V_146 -> V_155 ;
F_50 ( V_144 , V_67 ) ;
for ( V_22 = 0 ; V_22 < 4 ; V_22 ++ ) {
V_149 = F_51 ( V_144 , V_156 , V_22 ) ;
if ( ! V_149 ) {
F_40 ( & V_144 -> V_118 , L_7 ) ;
goto V_139;
}
V_67 -> V_99 [ V_22 ] = V_149 -> V_157 + V_146 -> V_158 ;
strncpy ( V_67 -> V_41 [ V_22 ] , V_149 -> V_41 , V_159 ) ;
}
V_68 = F_52 ( & V_144 -> V_118 , & V_160 ,
V_161 , F_10 ( V_161 ) ) ;
if ( V_68 ) {
F_40 ( & V_144 -> V_118 , L_8 ) ;
goto V_139;
}
return V_68 ;
V_139:
...
static int T_3 F_54 ( struct V_143 * V_144 )
{
struct V_66 * V_67 = F_55 ( V_144 ) ;
F_56 ( & V_144 -> V_118 ) ;
F_50 ( V_144 , NULL ) ;
F_53 ( V_67 ) ;
return 0 ;
