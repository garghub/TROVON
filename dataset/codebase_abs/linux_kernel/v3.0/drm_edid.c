...
if ( V_1 [ 0 ] == 0x00 ) {
int V_5 = 0 ;
for ( V_2 = 0 ; V_2 < sizeof( V_6 ) ; V_2 ++ )
if ( V_1 [ V_2 ] == V_6 [ V_2 ] )
V_5 ++ ;
if ( V_5 == 8 ) ;
else if ( V_5 >= 6 ) {
F_2 ( L_1 ) ;
memcpy ( V_1 , V_6 , sizeof( V_6 ) ) ;
} else {
goto V_7;
}
}
...
if ( V_1 ) {
F_4 ( V_11 L_5 ) ;
F_5 ( V_11 , V_12 , V_1 , V_8 ) ;
F_4 ( V_11 L_6 ) ;
}
return 0 ;
}
bool F_6 ( struct V_4 * V_4 )
{
int V_2 ;
T_1 * V_13 = ( T_1 * ) V_4 ;
if ( ! V_4 )
return false ;
for ( V_2 = 0 ; V_2 <= V_4 -> V_14 ; V_2 ++ )
if ( ! F_1 ( V_13 + V_2 * V_8 ) )
return false ;
return true ;
}
static int
F_7 ( struct V_15 * V_16 , unsigned char * V_17 ,
int V_18 , int V_19 )
{
...
V_21 = F_8 ( V_16 , V_24 , 2 ) ;
} while ( V_21 != 2 && -- V_22 );
return V_21 == 2 ? 0 : - 1 ;
}
static bool F_9 ( T_1 * V_29 , int V_30 )
{
int V_2 ;
T_2 * V_1 = ( T_2 * ) V_29 ;
...
static T_1 *
F_10 ( struct V_31 * V_32 , struct V_15 * V_16 )
{
int V_2 , V_33 = 0 , V_34 = 0 ;
T_1 * V_18 , * V_35 ;
if ( ( V_18 = F_11 ( V_8 , V_36 ) ) == NULL )
return NULL ;
for ( V_2 = 0 ; V_2 < 4 ; V_2 ++ ) {
if ( F_7 ( V_16 , V_18 , 0 , V_8 ) )
goto V_37;
if ( F_1 ( V_18 ) )
break;
if ( V_2 == 0 && F_9 ( V_18 , V_8 ) ) {
V_32 -> V_38 ++ ;
goto V_39;
}
}
...
if ( V_18 [ 0x7e ] == 0 )
return V_18 ;
V_35 = F_12 ( V_18 , ( V_18 [ 0x7e ] + 1 ) * V_8 , V_36 ) ;
if ( ! V_35 )
goto V_37;
V_18 = V_35 ;
...
V_18 [ 0x7e ] = V_34 ;
V_35 = F_12 ( V_18 , ( V_34 + 1 ) * V_8 , V_36 ) ;
if ( ! V_35 )
goto V_37;
V_18 = V_35 ;
}
...
{
unsigned char V_37 ;
return ( F_7 ( V_16 , & V_37 , 0 , 1 ) == 0 ) ;
}
struct V_4 * F_17 ( struct V_31 * V_32 ,
struct V_15 * V_16 )
{
struct V_4 * V_4 = NULL ;
if ( F_16 ( V_16 ) )
V_4 = (struct V_4 * ) F_10 ( V_32 , V_16 ) ;
V_32 -> V_41 . V_1 = ( char * ) V_4 ;
return V_4 ;
}
static bool F_18 ( struct V_4 * V_4 , char * V_42 )
{
char F_18 [ 3 ] ;
F_18 [ 0 ] = ( ( V_4 -> V_43 [ 0 ] & 0x7c ) >> 2 ) + '@' ;
F_18 [ 1 ] = ( ( ( V_4 -> V_43 [ 0 ] & 0x3 ) << 3 ) |
( ( V_4 -> V_43 [ 1 ] & 0xe0 ) >> 5 ) ) + '@' ;
F_18 [ 2 ] = ( V_4 -> V_43 [ 1 ] & 0x1f ) + '@' ;
return ! strncmp ( F_18 , V_42 , 3 ) ;
}
static T_2 F_19 ( struct V_4 * V_4 )
{
struct V_44 * V_45 ;
int V_2 ;
for ( V_2 = 0 ; V_2 < F_20 ( V_46 ) ; V_2 ++ ) {
V_45 = & V_46 [ V_2 ] ;
if ( F_18 ( V_4 , V_45 -> V_42 ) &&
( F_21 ( V_4 ) == V_45 -> V_47 ) )
return V_45 -> V_48 ;
}
return 0 ;
...
V_52 = F_24 ( & V_32 -> V_54 ,
struct V_49 , V_57 ) ;
F_25 (cur_mode, t, &connector->probed_modes, head) {
V_51 -> type &= ~ V_58 ;
if ( V_51 == V_52 )
continue;
...
struct V_49 * F_28 ( struct V_59 * V_40 ,
...
static void
F_31 ( T_1 * V_69 , T_3 * V_70 , void * V_71 )
{
int V_2 , V_72 = 0 ;
...
{
unsigned int V_2 , V_72 = F_32 ( ( int ) V_69 [ 0x02 ] , 6 ) ;
T_1 * V_75 = V_69 + 5 ;
if ( V_69 [ 0x01 ] != 1 )
return;
for ( V_2 = 0 ; V_2 < V_72 ; V_2 ++ )
...
static void
F_34 ( T_1 * V_1 , T_3 * V_70 , void * V_71 )
{
int V_2 ;
struct V_4 * V_4 = (struct V_4 * ) V_1 ;
if ( V_4 == NULL )
...
static void
F_35 ( struct V_76 * V_50 , void * V_81 )
{
T_1 * V_82 = ( T_1 * ) V_50 ;
if ( V_82 [ 3 ] == V_83 )
if ( V_82 [ 15 ] & 0x10 )
...
if ( V_4 -> V_10 >= 4 ) {
bool V_21 ;
F_34 ( ( T_1 * ) V_4 , F_35 , & V_21 ) ;
return V_21 ;
}
return ( ( V_4 -> V_84 & V_85 ) != 0 ) ;
}
static void
F_37 ( struct V_76 * V_50 , void * V_81 )
{
T_1 * V_82 = ( T_1 * ) V_50 ;
...
static struct V_49 *
F_45 ( struct V_31 * V_32 , struct V_4 * V_4 ,
...
F_46 (m, &connector->probed_modes, head)
if ( V_95 -> V_67 == V_60 && V_95 -> V_68 == V_61 &&
F_29 ( V_95 ) == V_96 )
return NULL ;
if ( V_60 == 1366 && V_61 == 768 && V_96 == 60 ) {
V_63 = F_47 ( V_40 , 1366 , 768 , V_96 , 0 , 0 ,
false ) ;
V_63 -> V_67 = 1366 ;
...
case V_89 :
V_63 = F_48 ( V_40 , V_60 , V_61 , V_96 , 0 , 0 ) ;
if ( F_49 ( V_63 ) > F_38 ( V_4 ) ) {
F_15 ( V_63 ) ;
V_63 = F_50 ( V_40 , V_60 , V_61 ,
V_96 , 0 , 0 ,
F_40 ( V_4 ) ,
F_39 ( V_4 ) ,
F_41 ( V_4 ) ,
...
break;
case V_88 :
V_63 = F_47 ( V_40 , V_60 , V_61 , V_96 , 0 , 0 ,
false ) ;
break;
}
return V_63 ;
...
static struct V_49 * F_52 ( struct V_59 * V_40 ,
struct V_4 * V_4 ,
struct V_76 * V_118 ,
T_2 V_48 )
{
...
V_63 -> type = V_141 ;
if ( V_48 & V_142 )
V_118 -> V_143 = F_55 ( 1088 ) ;
V_63 -> clock = F_56 ( V_118 -> V_143 ) * 10 ;
V_63 -> V_67 = V_120 ;
...
if ( V_48 & V_158 ) {
V_63 -> V_152 = V_4 -> V_159 * 10 ;
V_63 -> V_155 = V_4 -> V_160 * 10 ;
}
return V_63 ;
}
static bool
F_58 ( const struct V_49 * V_63 )
{
...
static T_2
F_61 ( struct V_4 * V_4 , T_1 * V_50 )
{
if ( V_50 [ 9 ] == 0 || V_50 [ 9 ] == 255 )
return 0 ;
if ( V_4 -> V_10 >= 4 && V_50 [ 10 ] == 0x04 )
return ( V_50 [ 9 ] * 10000 ) - ( ( V_50 [ 12 ] >> 2 ) * 250 ) ;
return V_50 [ 9 ] * 10000 + 5001 ;
}
static bool
F_62 ( const struct V_49 * V_63 , struct V_4 * V_4 ,
struct V_76 * V_118 )
{
T_2 V_167 ;
T_1 * V_50 = ( T_1 * ) V_118 ;
if ( ! F_59 ( V_63 , V_4 , V_50 ) )
return false ;
if ( ! F_60 ( V_63 , V_4 , V_50 ) )
return false ;
if ( ( V_167 = F_61 ( V_4 , V_50 ) ) )
if ( V_63 -> clock > V_167 )
return false ;
if ( V_4 -> V_10 >= 4 && V_50 [ 10 ] == 0x04 )
if ( V_50 [ 13 ] && V_63 -> V_67 > 8 * ( V_50 [ 13 ] + ( 256 * ( V_50 [ 12 ] & 0x3 ) ) ) )
return false ;
if ( F_58 ( V_63 ) && ! F_36 ( V_4 ) )
return false ;
return true ;
}
static int
F_63 ( struct V_31 * V_32 , struct V_4 * V_4 ,
struct V_76 * V_118 )
{
int V_2 , V_168 = 0 ;
struct V_49 * V_169 ;
struct V_59 * V_40 = V_32 -> V_40 ;
for ( V_2 = 0 ; V_2 < V_64 ; V_2 ++ ) {
if ( F_62 ( V_66 + V_2 , V_4 , V_118 ) ) {
V_169 = F_30 ( V_40 , & V_66 [ V_2 ] ) ;
if ( V_169 ) {
F_64 ( V_32 , V_169 ) ;
V_168 ++ ;
}
...
static void
F_65 ( struct V_76 * V_118 , void * V_170 )
{
struct V_171 * V_71 = V_170 ;
struct V_172 * V_81 = & V_118 -> V_81 . V_173 ;
int V_174 = ( V_71 -> V_4 -> V_86 & V_87 ) ;
if ( V_174 && V_81 -> type == V_83 )
V_71 -> V_168 += F_63 ( V_71 -> V_32 ,
V_71 -> V_4 ,
V_118 ) ;
}
static int
F_66 ( struct V_31 * V_32 , struct V_4 * V_4 )
{
struct V_171 V_71 = {
V_32 , V_4 , 0 , 0 , 0
} ;
...
static int
F_68 ( struct V_31 * V_32 , struct V_76 * V_118 )
{
...
static void
F_69 ( struct V_76 * V_118 , void * V_170 )
{
struct V_171 * V_71 = V_170 ;
struct V_172 * V_81 = & V_118 -> V_81 . V_173 ;
if ( V_81 -> type == V_177 )
V_71 -> V_168 += F_68 ( V_71 -> V_32 , V_118 ) ;
}
static int
F_70 ( struct V_31 * V_32 , struct V_4 * V_4 )
{
struct V_59 * V_40 = V_32 -> V_40 ;
unsigned long V_178 = V_4 -> V_179 . V_180 |
( V_4 -> V_179 . V_181 << 8 ) |
( ( V_4 -> V_179 . V_182 & 0x80 ) << 9 ) ;
int V_2 , V_168 = 0 ;
struct V_171 V_71 = {
V_32 , V_4 , 0 , 0 , 0
} ;
...
static void
F_71 ( struct V_76 * V_118 , void * V_170 )
{
struct V_171 * V_71 = V_170 ;
struct V_172 * V_81 = & V_118 -> V_81 . V_173 ;
struct V_31 * V_32 = V_71 -> V_32 ;
struct V_4 * V_4 = V_71 -> V_4 ;
if ( V_81 -> type == V_185 ) {
int V_2 ;
for ( V_2 = 0 ; V_2 < 6 ; V_2 ++ ) {
struct V_94 * V_186 ;
...
static int
F_72 ( struct V_31 * V_32 , struct V_4 * V_4 )
{
int V_2 , V_168 = 0 ;
struct V_171 V_71 = {
V_32 , V_4 , 0 , 0 , 0
...
static void
F_74 ( struct V_76 * V_118 , void * V_170 )
{
struct V_171 * V_71 = V_170 ;
struct V_172 * V_81 = & V_118 -> V_81 . V_173 ;
if ( V_81 -> type == V_198 )
V_71 -> V_168 += F_73 ( V_71 -> V_32 , V_118 ) ;
}
static int
F_75 ( struct V_31 * V_32 , struct V_4 * V_4 )
{
struct V_171 V_71 = {
V_32 , V_4 , 0 , 0 , 0
} ;
if ( F_67 ( V_4 , 1 , 2 ) )
F_34 ( ( T_1 * ) V_4 , F_74 , & V_71 ) ;
return V_71 . V_168 ;
}
static void
F_76 ( struct V_76 * V_118 , void * V_170 )
{
struct V_171 * V_71 = V_170 ;
struct V_49 * V_169 ;
if ( V_118 -> V_143 ) {
V_169 = F_52 ( V_71 -> V_32 -> V_40 ,
V_71 -> V_4 , V_118 ,
V_71 -> V_48 ) ;
if ( ! V_169 )
return;
if ( V_71 -> V_199 )
V_169 -> type |= V_58 ;
F_64 ( V_71 -> V_32 , V_169 ) ;
V_71 -> V_168 ++ ;
V_71 -> V_199 = 0 ;
}
}
static int
F_77 ( struct V_31 * V_32 , struct V_4 * V_4 ,
T_2 V_48 )
{
struct V_171 V_71 = {
V_32 ,
...
if ( V_71 . V_199 && ! F_67 ( V_4 , 1 , 3 ) )
V_71 . V_199 =
( V_4 -> V_86 & V_200 ) ;
F_34 ( ( T_1 * ) V_4 , F_76 , & V_71 ) ;
return V_71 . V_168 ;
}
T_1 * F_78 ( struct V_4 * V_4 )
{
T_1 * V_201 = NULL ;
int V_2 ;
if ( V_4 == NULL || V_4 -> V_14 == 0 )
return NULL ;
for ( V_2 = 0 ; V_2 < V_4 -> V_14 ; V_2 ++ ) {
V_201 = ( T_1 * ) V_4 + V_8 * ( V_2 + 1 ) ;
if ( V_201 [ 0 ] == V_79 )
break;
}
if ( V_2 == V_4 -> V_14 )
...
struct V_212 * V_213 )
{
V_213 -> V_152 = V_4 -> V_159 * 10 ;
V_213 -> V_155 = V_4 -> V_160 * 10 ;
V_213 -> V_214 = 0 ;
V_213 -> V_215 = 0 ;
if ( V_4 -> V_10 < 4 )
return;
...
int F_82 ( struct V_31 * V_32 , struct V_4 * V_4 )
{
int V_229 = 0 ;
T_2 V_48 ;
if ( V_4 == NULL ) {
...
if ( ! F_6 ( V_4 ) ) {
F_13 ( V_32 -> V_40 -> V_40 , L_15 ,
F_14 ( V_32 ) ) ;
return 0 ;
}
V_48 = F_19 ( V_4 ) ;
V_229 += F_77 ( V_32 , V_4 , V_48 ) ;
V_229 += F_75 ( V_32 , V_4 ) ;
V_229 += F_72 ( V_32 , V_4 ) ;
V_229 += F_70 ( V_32 , V_4 ) ;
V_229 += F_66 ( V_32 , V_4 ) ;
...
int F_83 ( struct V_31 * V_32 ,
int V_67 , int V_68 )
{
int V_2 , V_230 , V_229 = 0 ;
struct V_49 * V_63 ;
struct V_59 * V_40 = V_32 -> V_40 ;
V_230 = sizeof( V_66 ) / sizeof( struct V_49 ) ;
if ( V_67 < 0 )
V_67 = 0 ;
if ( V_68 < 0 )
V_68 = 0 ;
