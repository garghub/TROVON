...
static struct V_18 * F_50 ( struct V_70 * V_71 )
{
struct V_18 * V_18 = F_51 ( V_71 ) ;
int V_78 = V_79 | 0755 ;
struct V_23 * V_24 ;
if ( V_18 ) {
V_24 = F_11 ( V_18 ) ;
...
V_18 -> V_81 = F_54 () ;
V_18 -> V_82 -> V_83 = & V_84 ;
V_18 -> V_85 = V_18 -> V_86 = V_18 -> V_87 = V_88 ;
F_55 ( V_18 ) ;
V_18 -> V_89 = & V_90 ;
V_18 -> V_91 = & V_92 ;
}
...
static struct V_18 * F_56 ( struct V_18 * V_93 ,
struct V_38 * V_38 ,
int V_78 )
{
struct V_70 * V_71 = V_93 -> V_94 ;
struct V_18 * V_18 = F_51 ( V_71 ) ;
struct V_23 * V_24 ;
if ( ! V_18 )
return NULL ;
...
static int F_60 ( struct V_18 * V_102 ,
struct V_38 * V_38 ,
int V_78 )
{
int V_20 ;
struct V_18 * V_18 = NULL ;
struct V_103 * V_104 = & V_38 -> V_105 ;
struct V_23 * V_24 ;
struct V_106 * V_107 ;
F_9 ( 0 , L_9 , V_104 -> V_108 , V_104 -> V_5 ) ;
if ( V_104 -> V_108 >= V_109 ) {
V_20 = - V_6 ;
F_9 ( V_110 , L_10 ) ;
goto V_28;
}
V_18 = F_56 ( V_102 , V_38 , V_78 | V_79 ) ;
if ( ! V_18 ) {
V_20 = - V_31 ;
F_47 ( V_20 ) ;
goto V_28;
...
static int F_66 ( struct V_18 * V_102 ,
struct V_38 * V_38 ,
int V_78 ,
struct V_111 * V_112 )
{
int V_20 = 0 ;
struct V_18 * V_18 ;
struct V_103 * V_5 = & V_38 -> V_105 ;
F_9 ( 0 , L_12 , V_5 -> V_108 , V_5 -> V_5 ) ;
if ( V_5 -> V_108 >= V_113 ||
V_5 -> V_5 [ 0 ] == '$' ) {
V_20 = - V_6 ;
F_9 ( V_110 , L_13 , V_5 -> V_108 ,
V_5 -> V_5 ) ;
goto V_28;
}
V_18 = F_56 ( V_102 , V_38 , V_78 | V_96 ) ;
if ( ! V_18 ) {
V_20 = - V_31 ;
F_47 ( V_20 ) ;
goto V_28;
...
static int F_67 ( struct V_18 * V_102 ,
struct V_38 * V_38 )
{
int V_20 ;
struct V_18 * V_18 = V_38 -> V_41 ;
...
if ( V_20 < 0 ) {
F_9 ( V_110 , L_15 ,
V_38 -> V_105 . V_108 , V_38 -> V_105 . V_5 , V_20 ) ;
goto V_28;
}
V_20 = F_68 ( V_102 , V_38 ) ;
V_28:
return V_20 ;
}
...
static struct V_38 * F_71 ( struct V_128 * V_129 ,
int V_11 , const char * V_130 , void * V_114 )
{
return F_72 ( V_129 , V_11 , V_114 , F_69 ) ;
}
