...
F_32 ( F_33 ( V_3 ) ) ;
V_55 = F_34 ( V_3 , V_8 -> V_57 [ 1 ] . V_58 , V_65 ) ;
if ( V_55 != 0 )
goto V_64;
return 0 ;
V_64:
...
V_32 = F_38 ( V_67 ) ;
if ( V_32 < 0 ) {
F_39 ( L_19 , V_3 -> V_4 . V_68 ) ;
F_40 ( V_3 ) ;
return V_32 ;
}
return 0 ;
}
static int T_3 F_41 ( struct V_7 * V_69 )
{
return F_23 ( & V_70 , V_69 ) ;
}
static int T_4 F_42 ( struct V_7 * V_69 )
{
struct V_2 * V_3 = F_43 ( V_69 ) ;
F_18 ( V_3 , V_69 ) ;
return 0 ;
}
