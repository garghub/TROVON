...
static void *
F_65 ( struct V_34 * V_35 , T_5 V_28 , T_6 * V_109 , T_7 V_39 )
{
struct V_6 * V_6 ;
void * V_85 ;
V_6 = F_53 ( V_35 ) ;
...
V_183 = F_109 ( V_156 , & V_182 ) ;
V_156 = V_182 ;
} while ( F_110 ( V_183 ) );
F_5 ( V_72 L_70 , F_111 ( V_150 ) , V_150 -> V_184 ) ;
}
static void T_8
F_112 ( struct V_6 * V_6 , T_10 V_156 )
{
unsigned int V_110 ;
int V_185 ;
V_6 -> V_110 = V_111 ;
...
if ( F_118 ( V_183 ) )
return 1 ;
V_183 = F_119 ( V_34 -> V_156 , & V_188 ) ;
if ( F_118 ( V_183 ) )
return 1 ;
if ( strncmp ( L_71 , V_188 -> V_189 . string , 7 ) == 0 ) {
V_1 += V_190 ;
if ( ! V_31 )
V_31 = F_61 ( V_191 , 16 ) ;
}
...
if ( ! V_6 )
return 1 ;
F_112 ( V_6 , V_34 -> V_156 ) ;
return 0 ;
}
static int T_8
F_121 ( void )
{
if ( ! F_122 ( L_72 ) && ! F_122 ( L_73 ) )
return 0 ;
#if F_123 ( V_192 )
if ( F_124 () ) {
V_193 = & V_194 ;
...
#if F_123 ( V_192 ) || F_123 ( V_196 )
if ( F_122 ( L_73 ) ) {
extern void V_197 ( void ) ;
V_197 () ;
}
#endif
#ifdef F_90
...
static int F_131 ( struct V_34 * V_35 , T_2 V_53 )
{
return ( ( V_53 & 0xFFFFFFFFUL ) == 0xFFFFFFFFUL ) ;
}
static int F_132 ( struct V_34 * V_35 , T_6 V_200 )
{
return 0 ;
}
static int T_8
