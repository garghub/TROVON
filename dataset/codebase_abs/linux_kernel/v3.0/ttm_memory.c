...
F_7 ( & V_9 -> V_10 ) ;
if ( F_14 ( V_57 ) )
( void ) F_36 ( V_9 -> V_53 , & V_9 -> V_39 ) ;
}
static void F_37 ( struct V_25 * V_9 ,
struct V_3 * V_58 ,
T_2 V_59 )
{
unsigned int V_28 ;
...
void F_38 ( struct V_25 * V_9 ,
T_2 V_59 )
{
return F_37 ( V_9 , NULL , V_59 ) ;
}
static int F_39 ( struct V_25 * V_9 ,
struct V_3 * V_58 ,
T_2 V_59 , bool V_60 )
{
T_2 V_61 ;
...
static int F_40 ( struct V_25 * V_9 ,
struct V_3 * V_58 ,
T_2 V_63 ,
bool V_64 , bool V_65 )
{
...
int F_41 ( struct V_25 * V_9 , T_2 V_63 ,
bool V_64 , bool V_65 )
{
return F_40 ( V_9 , NULL , V_63 , V_64 ,
V_65 ) ;
}
int F_42 ( struct V_25 * V_9 ,
struct V_68 * V_68 ,
bool V_64 , bool V_65 )
{
struct V_3 * V_4 = NULL ;
#ifdef F_29
if ( F_43 ( V_68 ) && V_9 -> V_51 != NULL )
V_4 = V_9 -> V_51 ;
#else
if ( V_9 -> V_52 && F_44 ( V_68 ) > 0x00100000UL )
V_4 = V_9 -> V_49 ;
#endif
return F_40 ( V_9 , V_4 , V_21 , V_64 ,
V_65 ) ;
}
void F_45 ( struct V_25 * V_9 , struct V_68 * V_68 )
{
struct V_3 * V_4 = NULL ;
#ifdef F_29
if ( F_43 ( V_68 ) && V_9 -> V_51 != NULL )
