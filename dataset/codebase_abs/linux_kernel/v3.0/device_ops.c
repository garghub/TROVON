...
if ( V_2 -> V_7 -> V_27 != V_29 ||
( ( V_19 -> V_24 . V_38 . V_39 . V_40 & V_41 ) &&
! ( V_19 -> V_24 . V_38 . V_39 . V_40 & V_42 ) ) ||
V_2 -> V_7 -> V_3 . V_43 )
return - V_37 ;
V_20 = F_10 ( V_19 , V_3 ) ;
if ( V_20 )
...
int F_48 ( struct V_1 * V_2 , T_3 V_87 )
{
struct V_18 * V_19 = F_7 ( V_2 -> V_21 . V_22 ) ;
struct V_88 V_89 ;
struct V_81 V_82 ;
int V_90 = 0 , V_20 , V_91 ;
if ( V_87 )
V_87 &= V_19 -> V_33 ;
else
V_87 = V_19 -> V_33 ;
...
if ( ! ( V_87 & ( 0x80 >> V_91 ) ) )
continue;
V_82 . V_83 = V_19 -> V_24 . V_25 . V_82 [ V_91 ] ;
V_20 = F_49 ( V_82 , & V_89 ) ;
if ( V_20 )
return V_20 ;
if ( ! V_89 . V_92 )
...
if ( ! V_89 . V_93 )
V_90 = 1 ;
V_90 = V_90 ? F_50 ( V_90 , ( int ) V_89 . V_90 ) : V_89 . V_90 ;
}
return V_90 ;
}
...
if ( V_2 -> V_7 -> V_27 != V_29 )
return - V_73 ;
if ( ! F_52 ( & V_19 -> V_24 . V_38 ) ||
! ( F_53 ( & V_19 -> V_24 . V_38 ) & V_94 ) )
return - V_6 ;
return F_54 ( V_19 ) ;
}
int
