...
static int F_279 ( const char T_7 * V_208 ,
struct V_364 * V_365 , char * * V_366 )
{
char * V_367 = F_280 ( V_208 ) ;
int error ;
if ( F_78 ( V_367 ) )
return F_79 ( V_367 ) ;
error = F_281 ( V_367 , V_365 ) ;
if ( error )
F_282 ( V_367 ) ;
else
* V_366 = V_367 ;
...
static int F_283 ( struct V_257 * V_347 , struct V_56 * V_354 ,
struct V_257 * V_355 , bool V_334 )
{
struct V_56 * V_56 = V_347 -> V_258 ;
int error ;
...
return - V_368 ;
if ( F_284 ( V_56 ) || F_285 ( V_56 ) )
return - V_369 ;
if ( ! F_286 ( V_56 -> V_343 ) )
return - V_369 ;
if ( V_334 ) {
if ( ( F_287 () != V_56 -> V_341 ) && ! F_288 ( V_370 ) )
return - V_369 ;
if ( ! F_289 ( V_56 -> V_342 ) && ! F_288 ( V_370 ) )
return - V_369 ;
}
if ( ! V_334 ) {
error = F_278 ( V_56 , V_371 ) ;
if ( error )
return error ;
}
F_23 ( & V_56 -> V_113 ) ;
...
const char T_7 * V_372 ,
const char T_7 * V_373 ,
bool V_334 )
{
struct V_257 * V_355 ;
struct V_364 V_365 ;
...
if ( ! V_1 ( F_13 ( V_56 -> V_77 ) ) )
return - V_357 ;
error = F_293 ( V_375 , V_372 , 0 , & V_374 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
error = F_279 ( V_373 , & V_365 , & V_263 ) ;
if ( error ) {
F_56 ( error ) ;
goto V_53;
}
error = - V_368 ;
if ( V_374 . V_376 != V_365 . V_208 . V_376 )
goto V_377;
V_355 = F_294 ( & V_365 , 0 ) ;
error = F_79 ( V_355 ) ;
if ( F_78 ( V_355 ) ) {
...
error = F_295 ( V_365 . V_208 . V_376 ) ;
if ( error ) {
F_56 ( error ) ;
goto V_378;
}
error = F_283 ( V_374 . V_257 ,
V_365 . V_208 . V_257 -> V_258 ,
V_355 , V_334 ) ;
F_296 ( V_365 . V_208 . V_376 ) ;
V_378:
F_297 ( V_355 ) ;
V_116:
F_25 ( & V_365 . V_208 . V_257 -> V_258 -> V_113 ) ;
V_377:
F_298 ( & V_365 . V_208 ) ;
F_282 ( V_263 ) ;
V_53:
