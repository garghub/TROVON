...
V_4 -> V_21 = V_22 ;
F_8 ( & V_2 -> V_23 ) ;
F_9 ( V_2 -> V_6 , V_2 -> V_8 , 0 ) ;
F_10 ( V_2 -> V_8 , V_2 -> V_6 ) ;
F_11 ( V_2 -> V_8 , V_2 ) ;
F_12 ( & V_2 -> V_24 ) ;
return V_2 ;
V_7:
...
static struct V_26 * F_17 ( struct V_1 * V_27 ,
T_1 V_28 )
{
struct V_26 * V_29 ;
F_18 (phy, &cnfg->phys, node)
if ( V_29 -> V_30 == V_28 )
return V_29 ;
return NULL ;
}
...
static struct V_31 * F_19 ( struct V_1 * V_27 ,
enum V_32 V_33 )
{
struct V_26 * V_29 ;
F_18 (phy, &cnfg->phys, node) {
...
static int F_20 ( struct V_1 * V_27 , int V_37 )
{
struct V_26 * V_29 ;
F_18 (phy, &cnfg->phys, node)
...
int F_21 ( struct V_40 * V_40 , struct V_41 * V_42 )
{
T_1 V_43 ;
struct V_1 * V_25 = F_22 ( V_40 ) ;
F_23 ( V_42 != NULL ) ;
F_24 ( V_25 -> V_8 , V_42 ) ;
V_43 = V_42 -> V_30 ;
if ( V_43 != 0 ) {
struct V_41 * V_44 ;
V_44 = F_25 ( V_25 -> V_6 , V_43 ) ;
if ( V_44 != NULL )
F_11 ( V_44 , NULL ) ;
} else
F_26 ( L_2 ) ;
F_27 ( V_25 -> V_8 , V_43 , V_42 ) ;
F_13 () ;
if ( V_42 -> V_45 != NULL )
...
static int F_28 ( struct V_1 * V_27 ,
struct V_48 * V_49 ,
struct V_50 * V_51 )
{
struct V_31 * V_31 ;
...
F_23 ( sizeof( V_51 -> V_67 . V_83 . V_84 ) > 10 ) ;
...
int F_29 ( struct V_40 * V_40 , struct V_48 * V_95 ,
...
F_23 ( V_25 != NULL ) ;
F_30 () ;
V_99 = F_28 ( V_25 , V_95 , & V_88 ) ;
if ( V_99 )
goto V_100;
V_29 = F_17 ( V_25 , V_88 . V_28 ) ;
if ( ! V_29 ) {
V_99 = - V_39 ;
goto V_100;
}
...
F_23 ( V_88 . V_28 == V_29 -> V_30 ) ;
F_23 ( V_29 -> V_36 -> V_30 ==
V_88 . V_28 ) ;
F_23 ( V_29 -> V_102 -> V_30 ==
V_88 . V_28 ) ;
* V_38 = V_29 -> V_38 ;
* V_97 = 2 ;
* V_96 =
V_103 [ V_88 . V_63 ] + ( V_29 -> V_104 ? 1 : 0 ) ;
F_32 () ;
F_33 ( V_25 -> V_8 , V_88 . V_28 ) ;
return F_34 ( V_25 -> V_8 , & V_88 , V_42 ) ;
V_100:
F_32 () ;
return V_99 ;
}
...
F_26 ( L_8
L_9 ) ;
F_27 ( V_27 -> V_8 , V_43 , NULL ) ;
goto V_100;
}
F_23 ( V_27 != NULL ) ;
F_23 ( V_28 != 0 ) ;
V_110 = F_17 ( V_27 , V_28 ) ;
if ( V_110 == NULL ) {
F_31 ( L_10
L_11 ) ;
goto V_100;
...
F_23 ( V_110 != NULL ) ;
F_23 ( V_110 -> V_30 == V_28 ) ;
F_23 ( V_110 -> V_102 != NULL ) ;
F_23 ( V_110 -> V_102 -> V_30 == V_28 ) ;
V_105 -> V_30 = V_43 ;
switch ( V_108 ) {
case V_64 :
...
void
F_42 ( struct V_1 * V_27 , enum V_117 V_118 ,
struct V_111 * V_113 , struct V_41 * V_102 ,
enum V_32 V_35 ,
bool V_119 , bool V_120 )
{
struct V_41 * V_98 ;
struct V_41 * V_121 = NULL ;
struct V_26 * V_110 ;
int V_122 ;
T_1 V_28 ;
F_43 ( & V_27 -> V_24 ) ;
for ( V_122 = 0 ; V_122 < 7 ; V_122 ++ ) {
V_28 = ( V_113 -> V_38 + V_122 ) & 0x7 ;
if ( V_28 == 0 )
continue;
if ( F_17 ( V_27 , V_28 ) == NULL )
goto V_123;
}
F_4 ( L_14 ) ;
goto V_124;
...
F_46 ( & V_110 -> V_128 , & V_27 -> V_23 ) ;
V_124:
F_47 ( & V_27 -> V_24 ) ;
}
int F_48 ( struct V_1 * V_27 , struct V_41 * V_102 ,
bool V_34 )
{
struct V_26 * V_110 ;
F_30 () ;
V_110 = F_17 ( V_27 , V_102 -> V_30 ) ;
if ( V_110 == NULL ) {
F_32 () ;
return - V_39 ;
}
...
if ( V_34 ) {
F_49 ( V_110 -> V_36 ) ;
F_50 ( V_27 -> V_6 , V_110 -> V_36 ,
V_102 -> V_30 ) ;
} else {
F_51 ( V_27 -> V_6 , V_102 -> V_30 ) ;
F_52 ( V_110 -> V_36 ) ;
}
F_32 () ;
return 0 ;
}
int F_53 ( struct V_1 * V_27 , struct V_41 * V_102 )
{
struct V_41 * V_98 , * V_129 ;
T_2 V_28 ;
struct V_26 * V_110 ;
F_2 () ;
F_43 ( & V_27 -> V_24 ) ;
...
F_23 ( V_28 == V_110 -> V_30 ) ;
F_23 ( V_102 == V_110 -> V_102 ) ;
F_23 ( V_102 -> V_30 == V_28 ) ;
F_23 ( V_110 -> V_36 -> V_30 == V_28 ) ;
F_54 ( & V_110 -> V_128 ) ;
F_13 () ;
if ( F_55 ( V_110 -> V_36 ) != 0 ) {
F_56 ( L_15 ) ;
F_46 ( & V_110 -> V_128 , & V_27 -> V_23 ) ;
F_47 ( & V_27 -> V_24 ) ;
return - V_130 ;
