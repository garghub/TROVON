...
F_33 ( V_18 , & V_29 , V_7 -> V_22 [ 0 ] ) ;
if ( V_29 . V_23 != V_54 || V_29 . type != V_52 )
break;
V_20 = F_3 ( V_5 , V_7 , V_11 , V_12 ) ;
if ( V_20 )
return V_20 ;
...
struct V_1 * F_39 ( struct V_2 * V_3 ,
struct V_4 * V_5 ,
struct V_6 * V_7 , T_2 V_38 ,
const char * V_11 , T_3 V_12 ,
int V_48 )
...
if ( F_40 ( V_5 , V_18 , V_26 ) )
return NULL ;
V_56 = F_41 ( V_18 , V_7 -> V_22 [ 0 ] ) ;
while ( V_57 < V_56 ) {
V_58 = sizeof( * V_26 ) +
F_42 ( V_18 , V_26 ) +
F_43 ( V_18 , V_26 ) ;
...
int V_13 = 0 ;
V_18 = V_7 -> V_21 [ 0 ] ;
V_59 = sizeof( * V_20 ) + F_42 ( V_18 , V_20 ) +
F_43 ( V_18 , V_20 ) ;
V_60 = F_41 ( V_18 , V_7 -> V_22 [ 0 ] ) ;
if ( V_59 == V_60 ) {
V_13 = F_46 ( V_3 , V_5 , V_7 ) ;
} else {
unsigned long V_14 = ( unsigned long ) V_20 ;
unsigned long V_61 ;
V_61 = F_47 ( V_18 , V_7 -> V_22 [ 0 ] ) ;
F_48 ( V_18 , V_14 , V_14 + V_59 ,
V_60 - ( V_14 + V_59 - V_61 ) ) ;
V_13 = F_49 ( V_3 , V_5 , V_7 ,
V_60 - V_59 , 1 ) ;
}
return V_13 ;
}
...
if ( type == V_35 )
V_62 = V_66 ;
if ( F_42 ( V_18 , V_26 ) > V_62 ) {
F_51 ( V_65 L_2 ,
( unsigned ) F_43 ( V_18 , V_26 ) ) ;
return 1 ;
}
if ( F_43 ( V_18 , V_26 ) > F_12 ( V_5 ) ) {
F_51 ( V_65 L_3 ,
( unsigned ) F_43 ( V_18 , V_26 ) ) ;
return 1 ;
}
