...
long V_64 = 0 ;
F_43 ( V_2 ) ;
for ( V_85 = V_56 -> V_76 , V_83 = V_56 -> V_86 ; V_83 > 0 ;
V_83 -- , V_85 ++ ) {
unsigned long V_87 = V_85 -> V_88 ;
char T_3 * V_89 = V_85 -> V_90 ;
while ( V_87 ) {
V_13 = F_13 ( & V_6 -> V_16 ,
struct V_12 , V_18 ) ;
V_15 = V_13 -> V_15 ;
...
V_11 = F_54 ( & V_6 -> V_91 , V_89 , V_11 , 1 ) ;
V_31 = V_11 ;
if ( V_31 < 0 )
goto V_74;
...
static unsigned int F_60 ( struct V_93 * V_93 , struct V_54 * V_1 ,
T_4 * V_30 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
static void * F_62 ( const char * V_97 , T_5 type , T_5 V_94 )
{
return F_63 ( V_97 , type , V_94 ) ;
}
static void F_64 ( void * V_7 )
{
F_65 ( V_7 ) ;
}
static int F_66 ( void * V_7 , const T_6 * V_98 , unsigned int V_99 )
{
return F_67 ( V_7 , V_98 , V_99 ) ;
}
