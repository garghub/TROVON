...
sprintf ( V_2 -> V_259 , L_54 , V_2 -> V_258 , V_2 -> V_215 [ 0 ] . V_255 , V_2 -> V_215 [ 1 ] . V_255 , V_2 -> V_213 ) ;
F_81 ( & V_2 -> V_260 ) ;
V_2 -> V_261 = 0 ;
V_2 -> V_262 = 0 ;
F_81 ( & V_2 -> V_263 ) ;
...
F_84 ( & V_2 -> V_136 , 0 ) ;
F_82 ( & V_2 -> V_170 ) ;
F_85 ( & V_2 -> V_266 , V_267 , ( unsigned long ) V_2 ) ;
V_2 -> V_212 = V_268 ;
for ( V_66 = 0 ; V_66 < V_2 -> V_212 ; V_66 ++ ) {
struct V_202 * V_195 ;
char V_269 [ 16 ] ;
...
V_203 = V_270 [ V_209 ] + V_66 ;
snprintf ( V_269 , sizeof( V_269 ) , L_55 , V_271 [ V_209 ] ? V_271 [ V_209 ] : L_56 , V_66 ) ;
V_12 = F_86 ( V_203 , V_269 , V_272 , 0 , & V_195 ) ;
if ( V_12 < 0 ) {
F_2 ( V_18 L_57 , V_66 ) ;
F_52 ( V_2 ) ;
return V_12 ;
}
strcpy ( V_195 -> V_273 , V_254 ) ;
sprintf ( V_195 -> V_258 , L_58 , V_2 -> V_258 , V_66 ) ;
