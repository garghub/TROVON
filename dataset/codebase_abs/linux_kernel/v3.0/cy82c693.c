...
T_3 V_23 , V_24 ;
if ( V_1 -> V_6 > 0 ) {
V_16 = F_5 ( V_16 -> V_25 , V_16 -> V_26 + 1 ) ;
if ( ! V_16 ) {
F_6 ( V_27 L_1
L_2 ,
V_2 -> V_28 ) ;
...
F_7 ( V_2 , V_2 -> V_29 , & V_22 , V_19 , 1 ) ;
V_23 = F_8 ( V_22 . V_30 - 1 , 0 , 15 ) |
( F_8 ( V_22 . V_31 - 1 , 0 , 15 ) << 4 ) ;
V_24 = F_8 ( V_22 . V_32 - 1 , 0 , 15 ) |
( F_8 ( V_22 . V_33 - 1 , 0 , 15 ) << 4 ) ;
if ( ( V_2 -> V_34 & 1 ) == 0 ) {
F_9 ( V_16 , V_35 , & V_20 ) ;
V_20 &= ( ~ 0xF ) ;
...
static int T_4 F_14 ( struct V_15 * V_16 , const struct V_45 * V_46 )
{
struct V_15 * V_47 ;
int V_48 = - V_49 ;
if ( ( V_16 -> V_50 >> 8 ) == V_51 &&
F_13 ( V_16 -> V_26 ) == 1 ) {
V_47 = F_5 ( V_16 -> V_25 , V_16 -> V_26 + 1 ) ;
V_48 = F_15 ( V_16 , V_47 , & V_52 , NULL ) ;
if ( V_48 )
F_16 ( V_47 ) ;
}
return V_48 ;
