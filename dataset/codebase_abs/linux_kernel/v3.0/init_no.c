...
V_6 = ( unsigned long ) F_2 ( V_7 ) ;
memset ( ( void * ) V_6 , 0 , V_7 ) ;
F_3 ( V_8 ) ;
...
V_36 = F_7 ( ( unsigned long ) ( & V_20 ) ) ;
for (; V_36 + V_7 < ( unsigned long ) ( & V_21 ) ; V_36 += V_7 ) {
F_12 ( F_13 ( V_36 ) ) ;
F_14 ( F_13 ( V_36 ) ) ;
F_15 ( V_36 ) ;
V_30 ++ ;
