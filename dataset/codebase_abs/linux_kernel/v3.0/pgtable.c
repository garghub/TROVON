...
int F_53 ( struct V_41 * V_42 ,
unsigned long V_3 , T_4 * V_48 ,
T_4 V_44 , int V_45 )
{
int V_46 = ! F_54 ( * V_48 , V_44 ) ;
F_55 ( V_3 & ~ V_49 ) ;
if ( V_46 && V_45 ) {
* V_48 = V_44 ;
F_56 ( V_42 -> V_47 , V_3 , V_48 ) ;
F_57 ( V_42 , V_3 , V_3 + V_50 ) ;
}
return V_46 ;
}
...
if ( V_51 )
F_61 ( V_42 -> V_47 , V_35 , V_43 ) ;
return V_51 ;
}
int F_62 ( struct V_41 * V_42 ,
...
( unsigned long * ) V_48 ) ;
if ( V_51 )
F_64 ( V_42 -> V_47 , V_35 , V_48 ) ;
return V_51 ;
}
int F_65 ( struct V_41 * V_42 ,
unsigned long V_3 , T_1 * V_43 )
{
int V_53 ;
V_53 = F_58 ( V_42 , V_3 , V_43 ) ;
if ( V_53 )
F_52 ( V_42 , V_3 ) ;
return V_53 ;
}
