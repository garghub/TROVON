...
{
if ( F_10 () )
F_11 ( L_12 , ( const char * ) V_40 -> V_41 ) ;
return V_42 ;
}
static inline struct V_43 *
F_12 ( const void * V_44 , unsigned int V_45 )
{
return (struct V_43 * ) ( V_44 + V_45 ) ;
}
static inline bool F_13 ( const struct V_9 * V_6 )
{
...
F_14 ( const struct V_43 * V_48 )
{
return F_15 ( (struct V_43 * ) V_48 ) ;
}
static inline int
F_16 ( const struct V_43 * V_49 , const struct V_43 * V_48 ,
const char * V_50 , const char * * V_51 ,
const char * * V_52 , unsigned int * V_53 )
{
const struct V_54 * V_55 = ( void * ) F_14 ( V_49 ) ;
...
static void F_17 ( const struct V_37 * V_38 ,
unsigned int V_68 ,
...
unsigned int V_53 = 0 ;
V_75 = V_74 -> V_78 [ F_18 () ] ;
V_76 = F_12 ( V_75 , V_74 -> V_79 [ V_68 ] ) ;
V_50 = V_51 = V_80 [ V_68 ] ;
V_52 = V_65 [ V_81 ] ;
F_19 (iter, root, private->size - private->hook_entry[hook])
if ( F_16 ( V_77 , V_48 , V_50 ,
& V_51 , & V_52 , & V_53 ) != 0 )
break;
F_20 ( V_82 , V_68 , V_38 , V_70 , V_71 , & V_83 ,
L_13 ,
V_72 , V_51 , V_52 , V_53 ) ;
}
unsigned int
...
struct V_1 * V_84 )
{
static const char V_85 [ V_86 ] V_87 ( ( F_22 ( sizeof( long ) ) ) ) ;
...
V_89 = F_29 ( V_74 -> V_89 , V_91 ) ;
V_90 = * V_89 ;
V_48 = F_12 ( V_75 , V_74 -> V_79 [ V_68 ] ) ;
F_30 ( L_14 ,
V_84 -> V_59 , V_68 , V_90 ,
F_12 ( V_75 , V_74 -> V_103 [ V_68 ] ) ) ;
do {
...
F_33 ( V_48 -> V_109 , V_38 -> V_110 , 1 ) ;
V_55 = F_15 ( V_48 ) ;
F_26 ( V_55 -> V_57 . V_58 . V_56 ) ;
#if F_34 ( V_111 ) || \
F_34 ( V_112 )
if ( F_35 ( V_38 -> V_113 ) )
F_17 ( V_38 , V_68 , V_70 , V_71 ,
V_84 -> V_59 , V_74 , V_48 ) ;
#endif
...
static void F_42 ( struct V_104 * V_135 , struct V_136 * V_136 )
{
struct V_137 V_40 ;
V_40 . V_136 = V_136 ;
...
static int
F_45 ( struct V_104 * V_135 , struct V_142 * V_40 )
{
const struct V_9 * V_6 = V_40 -> V_143 ;
int V_12 ;
V_40 -> V_107 = V_135 -> V_57 . V_58 . V_107 ;
V_40 -> V_108 = V_135 -> V_61 ;
V_12 = F_46 ( V_40 , V_135 -> V_57 . V_144 - sizeof( * V_135 ) ,
...
static int
F_47 ( struct V_104 * V_135 , struct V_142 * V_40 )
{
struct V_145 * V_107 ;
int V_12 ;
V_107 = F_48 ( V_100 , V_135 -> V_57 . V_128 . V_59 ,
...
return 0 ;
V_147:
F_43 ( V_135 -> V_57 . V_58 . V_107 -> V_139 ) ;
return V_12 ;
}
static int F_51 ( struct V_43 * V_48 , struct V_136 * V_136 , const char * V_59 )
{
struct V_47 * V_55 = F_15 ( V_48 ) ;
struct V_148 V_40 = {
. V_136 = V_136 ,
. V_84 = V_59 ,
. V_143 = V_48 ,
...
int V_12 ;
V_12 = F_52 ( & V_40 , V_55 -> V_57 . V_141 - sizeof( * V_55 ) ,
...
static int
F_53 ( struct V_43 * V_48 , struct V_136 * V_136 , const char * V_59 ,
unsigned int V_130 )
{
struct V_47 * V_55 ;
struct V_150 * V_56 ;
...
V_152 . V_99 = V_100 ;
F_32 (ematch, e) {
V_12 = F_47 ( V_105 , & V_152 ) ;
if ( V_12 != 0 )
goto V_153;
++ V_151 ;
}
V_55 = F_15 ( V_48 ) ;
V_56 = F_54 ( V_100 , V_55 -> V_57 . V_128 . V_59 ,
...
V_12 = F_51 ( V_48 , V_136 , V_59 ) ;
if ( V_12 )
goto V_147;
return 0 ;
V_147:
F_43 ( V_55 -> V_57 . V_58 . V_56 -> V_139 ) ;
V_153:
F_32 (ematch, e) {
if ( V_151 -- == 0 )
break;
...
static void
F_58 ( struct V_43 * V_48 , struct V_136 * V_136 )
{
struct V_159 V_40 ;
struct V_47 * V_55 ;
struct V_104 * V_105 ;
...
F_43 ( V_40 . V_56 -> V_139 ) ;
}
static int
F_59 ( struct V_136 * V_136 , struct V_73 * V_121 , void * V_122 ,
...
return V_12 ;
++ V_162 ;
if ( strcmp ( F_15 ( V_77 ) -> V_57 . V_128 . V_59 ,
V_60 ) == 0 )
++ V_121 -> V_117 ;
}
...
if ( ! F_39 ( V_121 , V_161 -> V_102 , V_122 ) )
return - V_165 ;
V_162 = 0 ;
F_19 (iter, entry0, newinfo->size) {
V_12 = F_53 ( V_77 , V_136 , V_161 -> V_59 , V_161 -> V_130 ) ;
if ( V_12 != 0 )
break;
++ V_162 ;
}
...
} while ( F_64 ( V_49 , V_168 ) );
F_33 ( V_109 [ V_162 ] , V_167 , V_125 ) ;
++ V_162 ;
}
}
}
static struct V_158 * F_65 ( const struct V_1 * V_84 )
{
unsigned int V_169 ;
struct V_158 * V_109 ;
...
if ( F_49 ( V_109 ) )
return F_50 ( V_109 ) ;
V_175 = V_74 -> V_78 [ F_69 () ] ;
if ( F_70 ( V_172 , V_175 , V_171 ) != 0 ) {
V_12 = - V_176 ;
goto V_177;
}
...
if ( V_179 > 0 )
V_179 -= F_74 ( V_82 , V_179 ) ;
return F_70 ( V_20 , & V_179 , sizeof( V_179 ) ) ? - V_176 : 0 ;
}
...
F_32 (ematch, e)
V_173 += F_77 ( V_105 -> V_57 . V_58 . V_107 ) ;
V_55 = F_14 ( V_48 ) ;
V_173 += F_78 ( V_55 -> V_57 . V_58 . V_56 ) ;
V_121 -> V_130 -= V_173 ;
V_12 = F_79 ( V_82 , V_180 , V_173 ) ;
if ( V_12 )
return V_12 ;
for ( V_162 = 0 ; V_162 < V_123 ; V_162 ++ ) {
if ( V_2 -> V_79 [ V_162 ] &&
...
if ( ! V_121 || ! V_2 )
return - V_140 ;
memcpy ( V_121 , V_2 , F_71 ( struct V_73 , V_78 ) ) ;
V_121 -> V_182 = 0 ;
V_175 = V_2 -> V_78 [ F_69 () ] ;
F_81 ( V_82 , V_2 -> V_163 ) ;
F_19 (iter, loc_cpu_entry, info->size) {
V_12 = F_76 ( V_77 , V_2 , V_175 , V_121 ) ;
if ( V_12 != 0 )
return V_12 ;
}
return 0 ;
}
static int F_82 ( struct V_136 * V_136 , void T_4 * V_128 ,
...
F_85 ( V_82 ) ;
#endif
V_55 = F_86 ( F_87 ( V_136 , V_82 , V_59 ) ,
L_44 , V_59 ) ;
if ( V_55 && ! F_49 ( V_55 ) ) {
struct V_185 V_2 ;
...
if ( F_83 ( & V_190 , V_189 , sizeof( V_190 ) ) != 0 )
return - V_176 ;
...
V_55 = F_87 ( V_136 , V_82 , V_190 . V_59 ) ;
if ( V_55 && ! F_49 ( V_55 ) ) {
const struct V_73 * V_74 = V_55 -> V_74 ;
F_8 ( L_47 , V_74 -> V_163 ) ;
...
struct V_43 * V_77 ;
V_12 = 0 ;
V_109 = F_66 ( V_193 * sizeof( struct V_158 ) ) ;
if ( ! V_109 ) {
V_12 = - V_170 ;
goto V_71;
}
...
void * V_175 ;
struct V_43 * V_77 ;
if ( F_83 ( & V_186 , V_128 , sizeof( V_186 ) ) != 0 )
return - V_176 ;
...
if ( ! V_121 )
return - V_170 ;
V_175 = V_121 -> V_78 [ F_69 () ] ;
if ( F_83 ( V_175 , V_128 + sizeof( V_186 ) ,
V_186 . V_130 ) != 0 ) {
V_12 = - V_176 ;
goto V_200;
}
V_12 = F_59 ( V_136 , V_121 , V_175 , & V_186 ) ;
if ( V_12 != 0 )
goto V_200;
F_8 ( L_51 ) ;
...
if ( ! V_204 )
return - V_170 ;
if ( F_83 ( V_204 , V_128 + V_130 , V_110 - V_130 ) != 0 ) {
V_12 = - V_176 ;
goto free;
}
V_55 = F_87 ( V_136 , V_82 , V_59 ) ;
if ( ! V_55 || F_49 ( V_55 ) ) {
V_12 = V_55 ? F_50 ( V_55 ) : - V_187 ;
goto free;
}
...
F_33 ( V_77 -> V_109 , V_204 [ V_162 ] . V_167 , V_204 [ V_162 ] . V_125 ) ;
++ V_162 ;
}
F_36 ( V_93 ) ;
V_208:
...
if ( F_70 ( V_210 , V_48 , sizeof( struct V_43 ) ) != 0 ||
F_70 ( & V_210 -> V_109 , & V_109 [ V_162 ] ,
...
struct V_104 * V_105 ;
F_32 (ematch, e)
F_43 ( V_105 -> V_57 . V_58 . V_107 -> V_139 ) ;
V_55 = F_105 ( V_48 ) ;
F_43 ( V_55 -> V_57 . V_58 . V_56 -> V_139 ) ;
}
static int
...
F_8 ( L_53 , V_48 ) ;
if ( ( unsigned long ) V_48 % F_57 ( struct V_181 ) != 0 ||
...
break;
++ V_162 ;
if ( strcmp ( F_15 ( V_220 ) -> V_57 . V_128 . V_59 ,
V_60 ) == 0 )
++ V_121 -> V_117 ;
}
if ( V_12 ) {
...
static int
F_119 ( struct V_136 * V_136 , struct V_231 T_4 * V_189 ,
int * V_110 )
{
int V_12 ;
struct V_231 V_190 ;
...
switch ( V_226 ) {
case V_232 :
V_12 = F_82 ( F_117 ( V_225 ) , V_128 , V_110 , 1 ) ;
break;
case V_233 :
...
switch ( V_226 ) {
case V_232 :
V_12 = F_82 ( F_117 ( V_225 ) , V_128 , V_110 , 0 ) ;
break;
case V_233 :
...
V_12 = F_59 ( V_136 , V_121 , V_175 , V_161 ) ;
if ( V_12 != 0 )
goto V_240;
V_239 = F_125 ( V_136 , V_84 , & V_238 , V_121 ) ;
if ( F_49 ( V_239 ) ) {
V_12 = F_50 ( V_239 ) ;
goto V_240;
}
...
static inline bool
F_128 ( T_7 V_243 , T_7 V_244 , T_7 V_245 ,
T_7 type , T_7 V_246 ,
bool V_247 )
{
return ( ( V_243 == 0xFF ) ||
...
if ( V_40 -> V_94 != 0 )
return false ;
V_249 = F_130 ( V_38 , V_40 -> V_97 , sizeof( V_250 ) , & V_250 ) ;
if ( V_249 == NULL ) {
F_8 ( L_65 ) ;
V_40 -> V_98 = true ;
return false ;
}
return F_128 ( V_252 -> type ,
V_252 -> V_246 [ 0 ] ,
V_252 -> V_246 [ 1 ] ,
...
if ( V_12 < 0 )
goto V_255;
V_12 = F_138 ( V_256 , F_139 ( V_256 ) ) ;
if ( V_12 < 0 )
goto V_257;
V_12 = F_140 ( V_258 , F_139 ( V_258 ) ) ;
if ( V_12 < 0 )
goto V_259;
V_12 = F_141 ( & V_260 ) ;
if ( V_12 < 0 )
