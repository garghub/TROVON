...
{
struct V_63 * V_64 ;
V_64 = F_3 ( sizeof( struct V_63 ) , V_20 ) ;
if ( ! V_64 )
return NULL ;
...
void
F_24 ( struct V_1 * V_2 , struct V_63 * V_64 )
{
...
{
struct V_63 * V_67 ;
V_67 = F_3 ( sizeof( struct V_63 ) , V_20 ) ;
if ( ! V_67 )
return NULL ;
...
void
F_26 ( struct V_1 * V_2 , struct V_63 * V_69 )
{
...
void
F_27 ( struct V_1 * V_2 , struct V_18 * V_49 )
{
struct V_63 * V_70 ;
unsigned long V_71 ;
if ( ! V_49 )
...
V_70 = F_28 ( V_49 , struct V_63 , V_65 ) ;
F_15 ( & V_70 -> V_65 . V_51 ) ;
if ( V_70 -> V_75 == - 1 ) {
( V_2 -> V_76 [ V_77 ] . V_78 )
( V_2 , V_70 ) ;
