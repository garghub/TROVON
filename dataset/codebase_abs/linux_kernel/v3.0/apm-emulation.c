...
static int F_25 ( struct V_59 * V_59 , struct V_18 * V_40 )
{
struct V_12 * V_13 = V_40 -> V_23 ;
V_40 -> V_23 = NULL ;
F_26 ( & V_14 ) ;
...
static int F_30 ( struct V_59 * V_59 , struct V_18 * V_40 )
{
struct V_12 * V_13 ;
V_13 = F_31 ( sizeof( * V_13 ) , V_61 ) ;
if ( V_13 ) {
V_13 -> V_44 = F_32 ( V_62 ) ;
...
static int F_34 ( struct V_68 * V_69 , void * V_70 )
{
struct V_1 V_2 ;
char * V_71 ;
V_2 . V_72 = 0xff ;
...
static int F_36 ( struct V_59 * V_59 , struct V_18 * V_18 )
{
return F_37 ( V_18 , F_34 , NULL ) ;
}
static int F_38 ( void * V_42 )
{
do {
T_1 V_9 ;
F_12 ( V_79 ,
...
static int T_9 F_60 ( char * V_106 )
{
while ( ( V_106 != NULL ) && ( * V_106 != '\0' ) ) {
if ( strncmp ( V_106 , L_9 , 3 ) == 0 )
V_96 = 1 ;
if ( strncmp ( V_106 , L_10 , 2 ) == 0 )
V_96 = 0 ;
V_106 = strchr ( V_106 , ',' ) ;
if ( V_106 != NULL )
V_106 += strspn ( V_106 , L_11 ) ;
}
return 1 ;
}
void F_61 ( T_1 V_9 )
