...
static int F_35 ( struct V_75 * V_65 ,
struct V_76 * V_77 , struct V_69 * V_64 )
{
int V_42 = 0 ;
if ( ! V_65 -> V_21 -> V_78 )
V_65 -> V_21 -> V_78 = & V_79 ;
if ( ! V_65 -> V_21 -> V_80 )
V_65 -> V_21 -> V_80 = 0xffffffff ;
if ( V_77 -> V_81 -> V_82 . V_83 ) {
V_42 = F_31 ( V_64 ,
V_16 ) ;
if ( V_42 )
goto V_47;
}
if ( V_77 -> V_81 -> V_84 . V_83 ) {
V_42 = F_31 ( V_64 ,
V_85 ) ;
if ( V_42 )
goto V_86;
...
static int T_3 F_37 ( struct V_87 * V_88 )
{
return F_38 ( & V_88 -> V_21 , & V_89 ) ;
}
static int T_4 F_39 ( struct V_87 * V_88 )
{
F_40 ( & V_88 -> V_21 ) ;
return 0 ;
}
