...
static int T_2 F_36 ( struct V_11 * V_12 )
{
unsigned short V_13 ;
char V_23 [ 100 ] ;
V_1 -> V_16 = V_12 -> V_17 ;
...
F_34 () ;
V_88 = 1 ;
sprintf ( V_23 , L_19 , V_13 ) ;
F_39 ( V_23 , V_12 ) ;
return 1 ;
}
static int T_2 F_40 ( struct V_11 * V_12 )
{
struct V_89 * V_90 ;
int V_91 ;
if ( ! V_88 )
return 0 ;
V_90 = F_8 ( V_12 -> V_17 , 2 , L_20 ) ;
if ( ! V_90 ) {
F_6 ( V_19 L_21 ) ;
return 0 ;
}
...
static int F_44 ( void * V_100 , int V_101 )
{
switch ( V_101 )
{
case V_102 :
...
static void F_45 ( void * V_100 , int V_101 )
{
return;
}
static void F_46 ( void * V_100 )
{
if ( V_93 )
if ( ! F_17 ( V_1 , V_94 , V_93 , V_34 | V_35 ) )
{
...
static int F_47 ( void * V_100 , T_4 * V_105 )
{
...
static int F_48 ( void * V_100 , unsigned int V_55 , void T_3 * V_56 , int V_107 )
{
T_4 * V_105 ;
T_5 * V_108 ;
T_6 V_109 ;
...
return 0 ;
case V_112 :
V_105 = F_49 ( sizeof( T_4 ) ) ;
if ( V_105 == NULL )
return - V_113 ;
if ( F_50 ( V_105 , V_56 , sizeof( T_4 ) ) ) {
F_51 ( V_105 ) ;
return - V_53 ;
}
V_110 = F_47 ( V_100 , V_105 ) ;
F_51 ( V_105 ) ;
return V_110 ;
case V_114 :
V_108 = F_49 ( sizeof( T_5 ) ) ;
if ( V_108 == NULL )
return - V_113 ;
if ( F_50 ( V_108 , V_56 , sizeof( T_5 ) ) ) {
F_51 ( V_108 ) ;
return - V_53 ;
}
...
F_53 ( & V_115 , V_32 ) ;
V_108 -> V_106 = V_3 ;
V_110 = F_54 ( V_56 , V_108 , sizeof( T_5 ) ) ;
F_51 ( V_108 ) ;
...
F_53 ( & V_115 , V_32 ) ;
if ( F_54 ( V_56 , V_108 , sizeof( T_5 ) ) )
V_110 = - V_53 ;
F_51 ( V_108 ) ;
return V_110 ;
case V_117 :
if ( F_50 ( & V_109 , V_56 , sizeof( V_109 ) ) )
return - V_53 ;
F_52 ( & V_115 , V_32 ) ;
if ( ! F_15 ( V_1 , 0x00d0 ) ) {
F_53 ( & V_115 , V_32 ) ;
...
V_109 . V_118 = V_23 ;
F_53 ( & V_115 , V_32 ) ;
if ( F_54 ( V_56 , & V_109 , sizeof( V_109 ) ) )
return - V_53 ;
return 0 ;
case V_119 :
if ( F_50 ( & V_109 , V_56 , sizeof( V_109 ) ) )
...
static int T_2 F_55 ( struct V_11 * V_12 )
{
volatile int V_91 ;
struct V_89 * V_90 ;
int V_123 = - 999 ;
if ( ! V_88 )
return 0 ;
if ( ! F_8 ( V_12 -> V_17 , 4 , L_27 ) ) {
F_6 ( V_19 L_28 ) ;
return 0 ;
}
V_90 = F_8 ( V_12 -> V_17 + 4 , 4 , L_29 ) ;
if ( ! V_90 ) {
F_6 ( V_19 L_28 ) ;
F_9 ( V_12 -> V_17 , 4 ) ;
return 0 ;
...
for ( V_91 = 0 ; V_91 < 100000 && ( F_41 ( V_12 -> V_17 + V_124 ) &
V_125 ) ; V_91 ++ )
;
F_56 ( ( 0x0b ) , V_12 -> V_17 + V_124 ) ;
for ( V_91 = 0 ; ( F_41 ( V_12 -> V_17 + V_126 ) & V_127 ) &&
( V_91 < 100000 ) ; V_91 ++ )
;
if ( ! F_57 ( V_12 , V_90 ) )
goto V_92;
...
static inline void T_7 F_61 ( struct V_11 * V_12 )
{
F_62 ( V_12 ) ;
}
static inline void T_7 F_63 ( struct V_11 * V_12 )
{
F_64 ( V_12 ) ;
}
...
if( ! F_7 ( & V_135 ) )
return - V_137 ;
F_6 ( V_86 L_34 , F_3 ( F_4 ( V_20 ) ) & 0x00ff ) ;
F_6 ( V_86 L_35 ) ;
F_33 () ;
F_34 () ;
F_9 ( V_136 , 0x10 ) ;
...
static int T_2 F_68 ( char * V_150 )
{
int V_151 [ 7 ] ;
V_150 = F_69 ( V_150 , F_70 ( V_151 ) , V_151 ) ;
V_136 = V_151 [ 1 ] ;
V_139 = V_151 [ 2 ] ;
V_140 = V_151 [ 3 ] ;
V_141 = V_151 [ 4 ] ;
