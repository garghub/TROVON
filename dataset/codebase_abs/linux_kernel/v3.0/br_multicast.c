...
V_189 = (struct V_102 * ) F_146 ( V_195 ) ;
F_21 ( V_32 ) -> V_199 = 1 ;
...
int F_147 ( struct V_29 * V_30 , struct V_123 * V_64 ,
struct V_31 * V_32 )
{
F_21 ( V_32 ) -> V_34 = 0 ;
F_21 ( V_32 ) -> V_199 = 0 ;
...
static void F_148 ( unsigned long V_51 )
{
...
int F_156 ( struct V_29 * V_30 , unsigned long V_212 )
{
int V_66 = - V_213 ;
F_153 ( & V_30 -> V_52 ) ;
if ( ! F_34 ( V_30 -> V_53 ) )
...
int F_157 ( struct V_123 * V_27 , unsigned long V_212 )
{
