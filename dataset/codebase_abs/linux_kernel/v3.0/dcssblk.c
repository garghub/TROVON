...
F_55 ( & V_4 -> V_2 ) ;
V_26 = F_56 ( & V_4 -> V_2 , & V_75 ) ;
if ( V_26 )
goto V_76;
V_26 = F_56 ( & V_4 -> V_2 , & V_77 ) ;
if ( V_26 )
goto V_76;
V_26 = F_56 ( & V_4 -> V_2 , & V_78 ) ;
if ( V_26 )
goto V_76;
F_57 ( V_4 -> V_14 ) ;
switch ( V_4 -> V_32 ) {
...
static T_1
F_58 ( struct V_1 * V_2 , struct V_39 * V_40 , const char * V_41 , T_2 V_44 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
int V_26 , V_24 ;
...
static int
F_60 ( struct V_80 * V_81 , T_3 V_82 )
{
struct V_3 * V_4 ;
int V_26 ;
V_4 = V_81 -> V_83 -> V_66 ;
...
static int
F_62 ( struct V_85 * V_86 , T_3 V_82 )
{
struct V_3 * V_4 = V_86 -> V_66 ;
struct V_5 * V_6 ;
int V_26 ;
if ( ! V_4 ) {
V_26 = - V_73 ;
...
static int
V_68 ( struct V_87 * V_88 , struct V_89 * V_89 )
{
struct V_3 * V_4 ;
struct V_90 * V_91 ;
unsigned long V_92 ;
...
int V_24 ;
V_95 = 0 ;
V_4 = V_89 -> V_96 -> V_83 -> V_66 ;
if ( V_4 == NULL )
goto V_97;
if ( ( V_89 -> V_98 & 7 ) != 0 || ( V_89 -> V_99 & 4095 ) != 0 )
goto V_97;
if ( ( ( V_89 -> V_99 >> 9 ) + V_89 -> V_98 )
> F_64 ( V_89 -> V_96 -> V_83 ) ) {
goto V_97;
}
if ( V_4 -> V_42 ) {
...
F_67 (bvec, bio, i) {
V_93 = ( unsigned long )
F_68 ( V_91 -> V_101 ) + V_91 -> V_102 ;
V_94 = V_4 -> V_23 + ( V_92 << 12 ) + V_95 ;
if ( F_69 ( ( V_93 & 4095 ) != 0 ) || ( V_91 -> V_103 & 4095 ) != 0 )
goto V_97;
if ( F_65 ( V_89 ) == V_104 ) {
memcpy ( ( void * ) V_93 , ( void * ) V_94 ,
V_91 -> V_103 ) ;
} else {
memcpy ( ( void * ) V_94 , ( void * ) V_93 ,
V_91 -> V_103 ) ;
}
V_95 += V_91 -> V_103 ;
}
...
static int
F_72 ( struct V_80 * V_81 , T_4 V_105 ,
void * * V_106 , unsigned long * V_107 )
{
struct V_3 * V_4 ;
unsigned long V_108 ;
V_4 = V_81 -> V_83 -> V_66 ;
...
if ( V_105 % ( V_109 / 512 ) )
return - V_12 ;
V_108 = V_105 / ( V_109 / 512 ) ;
if ( ( V_108 + 1 ) * V_109 - 1 > V_4 -> V_20 - V_4 -> V_23 )
return - V_110 ;
* V_106 = ( void * ) ( V_4 -> V_23 + V_108 * V_109 ) ;
* V_107 = F_73 ( * V_106 ) >> V_111 ;
return 0 ;
}
static void
F_74 ( void )
{
int V_26 , V_24 , V_25 , V_112 ;
char V_41 [ V_113 + 1 ] ;
struct V_3 * V_4 ;
for ( V_24 = 0 ; ( V_24 < V_113 ) && ( V_114 [ V_24 ] != '\0' ) ;
V_24 ++ ) {
for ( V_25 = V_24 ; ( V_114 [ V_25 ] != ',' ) &&
( V_114 [ V_25 ] != '\0' ) &&
( V_114 [ V_25 ] != '(' ) &&
( V_25 < V_113 ) ; V_25 ++ )
{
V_41 [ V_25 - V_24 ] = V_114 [ V_25 ] ;
}
V_41 [ V_25 - V_24 ] = '\0' ;
V_26 = F_43 ( V_55 , NULL , V_41 , V_25 - V_24 ) ;
if ( ( V_26 >= 0 ) && ( V_114 [ V_25 ] == '(' ) ) {
for ( V_112 = 0 ; ( V_41 [ V_112 ] != ':' ) && ( V_41 [ V_112 ] != '\0' ) ; V_112 ++ )
V_41 [ V_112 ] = toupper ( V_41 [ V_112 ] ) ;
V_41 [ V_112 ] = '\0' ;
if ( ! strncmp ( & V_114 [ V_25 ] , L_28 , 7 ) ) {
F_17 ( & V_36 ) ;
V_4 = F_9 ( V_41 ) ;
F_18 ( & V_36 ) ;
if ( V_4 )
...
V_26 = F_56 ( V_55 , & V_121 ) ;
if ( V_26 )
goto V_122;
V_26 = F_56 ( V_55 , & V_123 ) ;
if ( V_26 )
goto V_122;
V_26 = F_90 ( 0 , V_118 ) ;
if ( V_26 < 0 )
