...
static void F_39 ( struct V_26 * V_27 , T_2 V_14 , int V_75 )
{
...
void F_45 ( struct V_12 * V_12 , int V_13 , T_2 V_14 , int V_81 )
{
T_5 V_82 ;
if ( V_81 ) {
...
static inline struct V_56 * F_46 ( struct V_83 * V_84 )
{
...
static inline int F_48 ( T_6 V_86 )
{
return ( ( V_86 >= V_87 ) &&
( V_86 < V_87 + V_88 ) ) ;
}
static int F_49 ( struct V_83 * V_89 ,
T_6 V_86 , int V_90 , const void * V_69 )
{
struct V_56 * V_50 = F_46 ( V_89 ) ;
...
break;
case V_101 :
F_44 ( V_12 , V_86 , V_92 -> V_100 | ( V_14 << 8 ) ) ;
V_92 -> V_96 = V_99 ;
break;
}
}
...
static int F_52 ( struct V_83 * V_89 ,
...
V_3 -> V_21 = 0xff ;
V_3 -> V_22 = ( V_64 != 2 ) ;
F_44 ( V_50 -> V_12 , V_64 , 0 ) ;
}
F_51 ( & V_50 -> V_18 . V_20 ) ;
F_41 ( & V_50 -> V_18 . V_28 . V_49 , 0 ) ;
V_50 -> V_18 . V_53 = 1 ;
}
static void F_56 ( struct V_106 * V_107 , bool V_108 )
{
...
struct V_56 * F_57 ( struct V_12 * V_12 , T_2 V_79 )
{
struct V_56 * V_50 ;
struct V_26 * V_18 ;
int V_102 ;
V_50 = F_58 ( sizeof( struct V_56 ) , V_110 ) ;
if ( ! V_50 )
return NULL ;
V_50 -> V_66 = F_59 ( V_12 ) ;
if ( V_50 -> V_66 < 0 ) {
...
F_51 ( & V_50 -> V_18 . V_20 ) ;
F_55 ( V_50 ) ;
V_50 -> V_109 . V_114 = F_56 ;
F_68 ( V_12 , 0 , & V_50 -> V_109 ) ;
F_69 ( & V_50 -> V_84 , & V_115 ) ;
V_102 = F_70 ( V_12 , V_116 , & V_50 -> V_84 ) ;
if ( V_102 < 0 )
goto V_117;
if ( V_79 & V_118 ) {
F_69 ( & V_50 -> V_85 , & V_119 ) ;
V_102 = F_70 ( V_12 , V_116 ,
& V_50 -> V_85 ) ;
if ( V_102 < 0 )
goto V_120;
}
return V_50 ;
V_120:
F_71 ( V_12 , V_116 , & V_50 -> V_84 ) ;
V_117:
F_72 ( V_12 , 0 , & V_50 -> V_109 ) ;
F_73 ( V_12 , & V_18 -> V_46 ) ;
F_64 ( V_12 , V_50 -> V_66 ) ;
F_74 ( V_50 -> V_51 ) ;
F_60 ( V_50 ) ;
...
void F_75 ( struct V_12 * V_12 )
{
struct V_57 * V_30 ;
if ( V_12 -> V_16 . V_17 ) {
F_71 ( V_12 , V_116 , & V_12 -> V_16 . V_17 -> V_84 ) ;
F_71 ( V_12 , V_116 ,
& V_12 -> V_16 . V_17 -> V_85 ) ;
F_72 ( V_12 , 0 ,
...
F_64 ( V_12 , V_12 -> V_16 . V_17 -> V_66 ) ;
F_51 ( & V_12 -> V_16 . V_17 -> V_18 . V_20 ) ;
F_74 ( V_12 -> V_16 . V_17 -> V_51 ) ;
F_60 ( V_12 -> V_16 . V_17 ) ;
}
}
