...
if ( F_50 ( V_85 -> V_60 ) ) {
T_3 V_57 = ( F_51 ( V_85 -> V_58 ) ) ?
V_85 -> V_57 : V_85 -> V_65 ;
V_57 = F_52 ( V_57 ) ;
if ( V_57 > V_6 -> V_89 )
V_6 -> V_89 = V_57 ;
if ( F_53 ( V_57 , V_6 -> V_89 ) )
V_6 -> V_89 = V_57 ;
}
if ( ! F_51 ( V_85 -> V_58 ) )
goto V_87;
...
if ( V_22 -> V_32 - V_83 < V_68 )
goto V_87;
V_84 = V_22 -> V_33 + V_83 ;
if ( V_65 < V_6 -> V_34 + 1 || F_53 ( V_6 -> V_34 , V_65 ) ) {
