...
static int F_151 ( struct V_254 * V_255 )
{
struct V_3 * V_4 = F_59 ( V_255 -> V_89 ) ;
struct V_169 * V_170 = F_118 ( V_143 ( V_255 ) ) ;
struct V_5 * V_296 ;
...
unsigned long V_39 , V_171 = V_360 ;
int V_40 = 0 ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
V_356 = NULL ;
F_19 (evt, &vhost->sent, queue) {
...
static int F_152 ( struct V_131 * V_8 )
{
...
static int F_154 ( struct V_131 * V_8 )
{
struct V_254 * V_255 = V_8 -> V_231 ;
struct V_3 * V_4 = F_59 ( V_255 -> V_89 ) ;
int V_363 , V_365 ;
...
F_153 ( V_8 ) ;
F_77 ( V_4 ) ;
V_363 = F_149 ( V_255 , V_366 ) ;
V_365 = F_140 ( V_255 , V_367 , L_43 ) ;
if ( ! V_363 && ! V_365 )
V_47 = F_145 ( V_4 , V_255 , F_144 ) ;
V_95 ;
return V_47 ;
}
static void F_155 ( struct V_254 * V_255 , void * V_41 )
{
unsigned long * V_47 = V_41 ;
* V_47 |= F_149 ( V_255 , V_368 ) ;
}
static int F_156 ( struct V_131 * V_8 )
{
struct V_254 * V_255 = V_8 -> V_231 ;
struct V_3 * V_4 = F_59 ( V_255 -> V_89 ) ;
struct V_143 * V_144 = V_143 ( V_255 ) ;
...
F_153 ( V_8 ) ;
F_77 ( V_4 ) ;
F_157 ( V_144 , & V_363 , F_155 ) ;
V_365 = F_140 ( V_255 , V_369 , L_44 ) ;
if ( ! V_363 && ! V_365 )
...
{
struct V_145 * V_146 = F_160 ( V_170 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
struct V_169 * V_370 ;
struct V_254 * V_255 ;
unsigned long V_47 ;
...
static const struct V_371 * F_162 ( T_2 V_372 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_5 ( V_373 ) ; V_44 ++ )
if ( V_373 [ V_44 ] . V_372 == V_372 )
return & V_373 [ V_44 ] ;
return & V_374 ;
}
static const char * F_163 ( enum V_375 V_72 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_5 ( V_376 ) ; V_44 ++ )
if ( V_376 [ V_44 ] . V_72 == V_72 )
return V_376 [ V_44 ] . V_346 ;
return L_46 ;
}
static void F_164 ( struct V_377 * V_18 ,
struct V_3 * V_4 )
{
const struct V_371 * V_346 = F_162 ( V_18 -> V_378 ) ;
struct V_64 * V_65 ;
F_64 ( V_4 , V_346 -> V_234 , L_47
L_48 , V_346 -> V_346 , V_18 -> V_24 , V_18 -> V_379 , V_18 -> V_174 ,
F_163 ( V_18 -> V_380 ) ) ;
switch ( V_18 -> V_378 ) {
case V_381 :
switch ( V_18 -> V_380 ) {
...
case V_395 :
F_19 (tgt, &vhost->targets, queue) {
if ( ! V_18 -> V_24 && ! V_18 -> V_379 && ! V_18 -> V_174 )
break;
if ( V_18 -> V_24 && V_65 -> V_24 != V_18 -> V_24 )
continue;
if ( V_18 -> V_379 && V_65 -> V_173 . V_175 != V_18 -> V_379 )
continue;
if ( V_18 -> V_174 && V_65 -> V_173 . V_174 != V_18 -> V_174 )
continue;
if ( V_65 -> V_396 && V_18 -> V_378 == V_393 )
V_65 -> V_397 = 1 ;
if ( ! V_65 -> V_396 || V_18 -> V_378 == V_395 ) {
F_12 ( V_65 , V_68 ) ;
F_15 ( V_4 ) ;
}
}
...
break;
default:
F_21 ( V_4 -> V_98 , L_49 , V_18 -> V_378 ) ;
break;
} ;
}
static void F_165 ( struct V_402 * V_18 , struct V_3 * V_4 )
{
long V_47 ;
...
static int F_166 ( struct V_145 * V_146 , unsigned long time )
{
unsigned long V_39 ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
int V_136 = 0 ;
...
return - V_411 ;
F_37 ( V_146 -> V_122 , V_39 ) ;
V_255 -> V_280 = ( void * ) ( unsigned long ) V_4 -> V_412 ++ ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return 0 ;
}
static int F_168 ( struct V_143 * V_144 )
{
struct V_145 * V_146 = F_58 ( V_144 -> V_98 . V_147 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
unsigned long V_39 = 0 ;
F_37 ( V_146 -> V_122 , V_39 ) ;
V_144 -> V_280 = ( void * ) ( unsigned long ) V_4 -> V_412 ++ ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return 0 ;
}
...
if ( V_255 -> V_415 ) {
F_170 ( V_255 , V_284 ) ;
F_171 ( V_255 , V_255 -> V_416 ) ;
} else
F_172 ( V_255 , V_255 -> V_416 ) ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return 0 ;
}
static int F_173 ( struct V_254 * V_255 , int V_417 ,
int V_418 )
{
if ( V_418 != V_419 )
return - V_420 ;
...
static int F_175 ( struct V_254 * V_255 , int V_422 )
{
if ( V_255 -> V_415 ) {
F_170 ( V_255 , V_422 ) ;
if ( V_422 )
...
static T_5 F_176 ( struct V_231 * V_98 ,
struct V_423 * V_424 , char * V_425 )
{
struct V_145 * V_146 = F_177 ( V_98 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
return snprintf ( V_425 , V_101 , L_61 ,
...
static T_5 F_179 ( struct V_231 * V_98 ,
struct V_423 * V_424 , char * V_425 )
{
struct V_145 * V_146 = F_177 ( V_98 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
return snprintf ( V_425 , V_101 , L_61 ,
V_4 -> V_152 -> V_153 . V_426 ) ;
}
...
struct V_145 * V_146 = F_177 ( V_98 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
return snprintf ( V_425 , V_101 , L_62 , V_4 -> V_152 -> V_153 . V_298 ) ;
}
...
struct V_145 * V_146 = F_177 ( V_98 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
return snprintf ( V_425 , V_101 , L_63 , V_4 -> V_152 -> V_153 . V_204 ) ;
}
...
int V_208 ;
F_37 ( V_146 -> V_122 , V_39 ) ;
V_208 = snprintf ( V_425 , V_101 , L_62 , V_4 -> V_234 ) ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return V_208 ;
}
static T_5 F_184 ( struct V_231 * V_98 ,
struct V_423 * V_424 ,
const char * V_425 , T_6 V_427 )
{
struct V_145 * V_146 = F_177 ( V_98 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
unsigned long V_39 = 0 ;
F_37 ( V_146 -> V_122 , V_39 ) ;
V_4 -> V_234 = F_185 ( V_425 , NULL , 10 ) ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return strlen ( V_425 ) ;
}
static T_5 F_186 ( struct V_428 * V_429 , struct V_430 * V_431 ,
struct V_432 * V_433 ,
char * V_425 , T_7 V_434 , T_6 V_427 )
{
struct V_231 * V_98 = F_69 ( V_431 , struct V_231 , V_431 ) ;
struct V_145 * V_146 = F_177 ( V_98 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
unsigned long V_39 = 0 ;
int V_129 = V_435 ;
char * V_436 = ( char * ) V_4 -> V_14 ;
if ( V_434 > V_129 )
return 0 ;
if ( V_434 + V_427 > V_129 ) {
V_129 -= V_434 ;
V_427 = V_129 ;
}
F_37 ( V_146 -> V_122 , V_39 ) ;
memcpy ( V_425 , & V_436 [ V_434 ] , V_427 ) ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return V_427 ;
}
static struct V_377 * F_187 ( struct V_3 * V_4 )
{
struct V_437 * V_99 = & V_4 -> V_99 ;
struct V_377 * V_18 ;
...
static struct V_402 * F_189 ( struct V_3 * V_4 )
{
...
static T_8 F_190 ( int V_112 , void * V_438 )
{
struct V_3 * V_4 = (struct V_3 * ) V_438 ;
unsigned long V_39 ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_191 ( F_23 ( V_4 -> V_98 ) ) ;
F_192 ( & V_4 -> V_113 ) ;
...
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
while ( ! V_136 ) {
while ( ( V_206 = F_187 ( V_4 ) ) != NULL ) {
F_164 ( V_206 , V_4 ) ;
V_206 -> V_217 = 0 ;
F_194 () ;
}
while ( ( V_18 = F_189 ( V_4 ) ) != NULL ) {
F_165 ( V_18 , V_4 ) ;
V_18 -> V_217 = 0 ;
F_194 () ;
}
F_195 ( V_108 ) ;
if ( ( V_206 = F_187 ( V_4 ) ) != NULL ) {
F_191 ( V_108 ) ;
F_164 ( V_206 , V_4 ) ;
V_206 -> V_217 = 0 ;
F_194 () ;
} else if ( ( V_18 = F_189 ( V_4 ) ) != NULL ) {
F_191 ( V_108 ) ;
F_165 ( V_18 , V_4 ) ;
V_18 -> V_217 = 0 ;
F_194 () ;
...
static int F_197 ( struct V_64 * V_65 ,
void (* V_103) ( struct V_64 * ) )
{
if ( ++ V_65 -> V_96 > V_441 ) {
F_12 ( V_65 , V_68 ) ;
...
static int F_198 ( T_1 V_39 )
{
int V_44 ;
int V_315 = ( V_39 & 0x0f00 ) >> 8 ;
for ( V_44 = 0 ; V_44 < F_5 ( V_442 ) ; V_44 ++ )
if ( V_442 [ V_44 ] . V_315 == V_315 )
return V_44 ;
return 0 ;
}
...
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_443 * V_38 = & V_2 -> V_33 -> V_444 ;
struct V_445 * V_446 = & V_38 -> V_446 ;
T_3 V_36 = V_38 -> V_297 . V_36 ;
int V_127 , V_447 = V_235 ;
V_4 -> V_448 -- ;
F_12 ( V_65 , V_449 ) ;
switch ( V_36 ) {
case V_358 :
F_200 ( V_65 , L_64 ,
V_446 -> type , V_446 -> V_39 , V_446 -> V_450 ) ;
if ( V_446 -> type == V_276 ) {
V_127 = F_198 ( V_446 -> V_39 ) ;
if ( V_442 [ V_127 ] . V_117 ) {
if ( V_446 -> V_39 & V_451 ) {
V_65 -> V_396 = 0 ;
V_65 -> V_173 . V_452 = 0 ;
if ( V_446 -> V_450 & V_453 )
V_65 -> V_173 . V_452 |= V_454 ;
if ( V_446 -> V_450 & V_455 )
V_65 -> V_173 . V_452 |= V_456 ;
V_65 -> V_70 = 1 ;
} else
F_12 ( V_65 , V_68 ) ;
} else if ( V_442 [ V_127 ] . V_57 )
F_197 ( V_65 , V_457 ) ;
else
F_12 ( V_65 , V_68 ) ;
} else
...
V_447 += F_197 ( V_65 , V_459 ) ;
else if ( V_65 -> V_397 )
V_447 += F_197 ( V_65 , V_459 ) ;
else if ( F_8 ( V_38 -> V_36 , V_38 -> error ) )
V_447 += F_197 ( V_65 , V_457 ) ;
else
F_12 ( V_65 , V_68 ) ;
F_201 ( V_65 , V_447 , L_65 ,
...
V_444 -> V_297 . V_298 = 1 ;
V_444 -> V_297 . V_32 = V_461 ;
V_444 -> V_297 . V_300 = sizeof( * V_444 ) ;
V_444 -> V_24 = V_65 -> V_24 ;
V_444 -> V_446 . type = V_276 ;
V_444 -> V_446 . V_39 = V_451 ;
V_444 -> V_446 . V_450 = V_455 ;
F_12 ( V_65 , V_462 ) ;
...
F_200 ( V_65 , L_67 ) ;
if ( V_65 -> V_173 . V_175 &&
V_65 -> V_173 . V_175 != F_203 ( V_38 -> V_450 . V_175 ) ) {
V_4 -> V_90 = 1 ;
F_200 ( V_65 , L_68 ) ;
break;
}
V_65 -> V_173 . V_174 = F_203 ( V_38 -> V_450 . V_174 ) ;
V_65 -> V_173 . V_175 = F_203 ( V_38 -> V_450 . V_175 ) ;
V_65 -> V_173 . V_281 = V_65 -> V_24 ;
memcpy ( & V_65 -> V_450 , & V_38 -> V_450 ,
sizeof( V_65 -> V_450 ) ) ;
...
static void V_459 ( struct V_64 * V_65 )
{
struct V_305 * V_306 ;
struct V_3 * V_4 = V_65 -> V_4 ;
struct V_1 * V_2 ;
...
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_297 . V_298 = 1 ;
V_10 -> V_297 . V_32 = V_467 ;
V_10 -> V_297 . V_300 = sizeof( * V_10 ) ;
V_10 -> V_468 = V_65 -> V_24 ;
F_12 ( V_65 , V_462 ) ;
if ( F_109 ( V_2 , V_4 , V_304 ) ) {
V_4 -> V_448 -- ;
F_12 ( V_65 , V_449 ) ;
...
static int F_207 ( struct V_314 * V_10 ,
struct V_64 * V_65 )
{
if ( memcmp ( & V_10 -> V_343 . V_469 [ 2 ] , & V_65 -> V_173 . V_175 ,
sizeof( V_65 -> V_173 . V_175 ) ) )
return 1 ;
if ( memcmp ( & V_10 -> V_343 . V_469 [ 4 ] , & V_65 -> V_173 . V_174 ,
sizeof( V_65 -> V_173 . V_174 ) ) )
return 1 ;
if ( V_10 -> V_343 . V_469 [ 6 ] != V_65 -> V_24 )
return 1 ;
return 0 ;
}
...
default:
F_12 ( V_65 , V_68 ) ;
V_470 = ( V_10 -> V_343 . V_469 [ 1 ] & 0x00ff0000 ) >> 16 ;
V_59 = ( V_10 -> V_343 . V_469 [ 1 ] & 0x0000ff00 ) >> 8 ;
F_209 ( V_65 , L_75 ,
...
F_125 ( struct V_314 , V_7 ) ;
V_10 -> V_344 . V_208 = sizeof( V_10 -> V_7 ) ;
V_10 -> V_7 . V_282 = sizeof( V_10 -> V_343 . V_471 ) ;
V_10 -> V_7 . V_256 = sizeof( V_10 -> V_343 . V_469 ) ;
V_10 -> V_7 . V_8 . V_207 = ( T_2 ) V_2 -> V_18 . V_218 +
F_125 ( struct V_314 , V_343 ) +
F_125 ( struct V_472 , V_471 ) ;
V_10 -> V_7 . V_8 . V_208 = sizeof( V_10 -> V_343 . V_471 ) ;
V_10 -> V_7 . V_38 . V_207 = ( T_2 ) V_2 -> V_18 . V_218 +
F_125 ( struct V_314 , V_343 ) +
F_125 ( struct V_472 , V_469 ) ;
V_10 -> V_7 . V_38 . V_208 = sizeof( V_10 -> V_343 . V_469 ) ;
}
...
V_10 -> V_343 . V_471 [ 0 ] = V_474 ;
memcpy ( & V_10 -> V_343 . V_471 [ 2 ] , & V_4 -> V_152 -> V_153 . V_175 ,
sizeof( V_4 -> V_152 -> V_153 . V_175 ) ) ;
memcpy ( & V_10 -> V_343 . V_471 [ 4 ] , & V_4 -> V_152 -> V_153 . V_174 ,
sizeof( V_4 -> V_152 -> V_153 . V_174 ) ) ;
V_10 -> V_343 . V_471 [ 6 ] = V_4 -> V_152 -> V_153 . V_24 & 0x00ffffff ;
if ( F_214 ( & V_65 -> V_138 ) )
F_215 ( & V_65 -> V_138 , V_16 + ( V_475 * V_178 ) ) ;
else {
V_65 -> V_138 . V_41 = ( unsigned long ) V_65 ;
V_65 -> V_138 . V_249 = V_16 + ( V_475 * V_178 ) ;
V_65 -> V_138 . V_250 = ( void (*) ( unsigned long ) ) F_212 ;
F_112 ( & V_65 -> V_138 ) ;
}
F_12 ( V_65 , V_462 ) ;
if ( F_109 ( V_2 , V_4 , V_476 ) ) {
V_4 -> V_448 -- ;
F_50 ( & V_65 -> V_138 ) ;
F_12 ( V_65 , V_449 ) ;
F_73 ( & V_65 -> V_150 , F_68 ) ;
...
case V_458 :
default:
if ( ( V_38 -> V_36 & V_480 ) == V_480 &&
V_38 -> error == V_481 &&
V_38 -> V_59 == V_482 )
F_12 ( V_65 , V_68 ) ;
else if ( F_8 ( V_38 -> V_36 , V_38 -> error ) )
V_447 += F_197 ( V_65 , V_479 ) ;
else
F_12 ( V_65 , V_68 ) ;
F_201 ( V_65 , V_447 , L_82 ,
F_6 ( V_38 -> V_36 , V_38 -> error ) , V_38 -> V_36 , V_38 -> error ,
F_11 ( V_38 -> V_62 ) , V_38 -> V_62 ,
...
V_478 -> V_297 . V_298 = 1 ;
V_478 -> V_297 . V_32 = V_483 ;
V_478 -> V_297 . V_300 = sizeof( * V_478 ) ;
V_478 -> V_379 = V_65 -> V_173 . V_175 ;
F_12 ( V_65 , V_462 ) ;
if ( F_109 ( V_2 , V_4 , V_304 ) ) {
V_4 -> V_448 -- ;
F_12 ( V_65 , V_449 ) ;
...
static int F_217 ( struct V_3 * V_4 , T_2 V_24 )
{
struct V_64 * V_65 ;
unsigned long V_39 ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
V_65 -> V_4 = V_4 ;
V_65 -> V_396 = 1 ;
V_65 -> V_279 = V_4 -> V_412 ++ ;
F_111 ( & V_65 -> V_138 ) ;
F_219 ( & V_65 -> V_150 ) ;
F_196 ( V_65 , F_206 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_44 ( & V_65 -> V_130 , & V_4 -> V_486 ) ;
V_310:
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
return 0 ;
}
...
T_3 V_492 = V_38 -> V_297 . V_36 ;
int V_447 = V_235 ;
switch ( V_492 ) {
case V_358 :
F_26 ( V_4 , L_85 ) ;
V_4 -> V_487 = V_38 -> V_493 ;
F_14 ( V_4 , V_75 ) ;
break;
case V_458 :
V_447 += F_56 ( V_4 ) ;
...
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_297 . V_298 = 1 ;
V_10 -> V_297 . V_32 = V_494 ;
V_10 -> V_297 . V_300 = sizeof( * V_10 ) ;
V_10 -> V_495 = V_4 -> V_496 ;
V_10 -> V_497 . V_207 = V_4 -> V_498 ;
V_10 -> V_497 . V_208 = V_4 -> V_496 ;
F_14 ( V_4 , V_76 ) ;
if ( ! F_109 ( V_2 , V_4 , V_304 ) )
F_26 ( V_4 , L_88 ) ;
else
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_3 V_492 = V_2 -> V_33 -> V_499 . V_297 . V_36 ;
...
V_4 -> V_117 = 1 ;
V_501 = F_223 ( ( V_503 ) ( V_38 -> V_190 >> 9 ) , V_191 ) ;
F_130 ( V_4 -> V_98 , L_93 ,
V_38 -> V_183 , V_38 -> V_210 , V_38 -> V_426 ,
V_38 -> V_212 , V_501 ) ;
F_224 ( V_4 -> V_89 ) = V_38 -> V_174 ;
F_225 ( V_4 -> V_89 ) = V_38 -> V_174 ;
F_226 ( V_4 -> V_89 ) = V_38 -> V_175 ;
F_227 ( V_4 -> V_89 ) = V_38 -> V_24 ;
F_228 ( V_4 -> V_89 ) = V_504 ;
F_229 ( V_4 -> V_89 ) = 0 ;
if ( V_38 -> V_450 . V_505 [ 0 ] & 0x80000000 )
F_229 ( V_4 -> V_89 ) |= V_506 ;
if ( V_38 -> V_450 . V_507 [ 0 ] & 0x80000000 )
F_229 ( V_4 -> V_89 ) |= V_508 ;
if ( V_38 -> V_450 . V_509 [ 0 ] & 0x80000000 )
F_229 ( V_4 -> V_89 ) |= V_510 ;
F_230 ( V_4 -> V_89 ) =
V_38 -> V_450 . V_297 . V_511 & 0x0fff ;
V_4 -> V_89 -> V_512 = V_38 -> V_201 - V_203 ;
...
V_10 -> V_297 . V_298 = 1 ;
V_10 -> V_297 . V_32 = V_515 ;
V_10 -> V_297 . V_300 = sizeof( struct V_514 ) ;
V_10 -> V_497 . V_207 = V_4 -> V_516 ;
V_10 -> V_497 . V_208 = sizeof( * V_4 -> V_152 ) ;
F_14 ( V_4 , V_76 ) ;
if ( ! F_109 ( V_2 , V_4 , V_304 ) )
F_26 ( V_4 , L_94 ) ;
else
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_3 V_492 = V_2 -> V_33 -> V_517 . V_297 . V_36 ;
F_41 ( V_2 ) ;
switch ( V_492 ) {
case V_358 :
if ( F_95 ( & V_4 -> V_248 ) &&
...
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_297 . V_298 = 1 ;
V_10 -> V_297 . V_32 = V_520 ;
V_10 -> V_297 . V_300 = sizeof( struct V_519 ) ;
F_14 ( V_4 , V_77 ) ;
if ( ! F_109 ( V_2 , V_4 , V_304 ) )
F_26 ( V_4 , L_96 ) ;
else
...
static void F_236 ( struct V_3 * V_4 , int V_128 )
{
if ( V_128 & V_390 )
F_237 ( V_4 -> V_89 , F_238 () , V_521 , 0 ) ;
if ( ( V_128 & V_94 ) &&
V_4 -> V_72 >= V_166 )
F_237 ( V_4 -> V_89 , F_238 () , V_522 , 0 ) ;
if ( ( V_128 & V_386 ) &&
V_4 -> V_72 == V_88 )
F_237 ( V_4 -> V_89 , F_238 () , V_523 , 0 ) ;
}
static void F_239 ( struct V_64 * V_65 )
{
struct V_3 * V_4 = V_65 -> V_4 ;
struct V_169 * V_170 ;
unsigned long V_39 ;
F_200 ( V_65 , L_97 ) ;
V_170 = F_240 ( V_4 -> V_89 , 0 , & V_65 -> V_173 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
F_200 ( V_65 , L_99 ) ;
V_65 -> V_170 = V_170 ;
V_170 -> V_524 = V_65 -> V_450 . V_297 . V_511 & 0x0fff ;
V_170 -> V_525 = 0 ;
V_65 -> V_148 = V_170 -> V_526 ;
if ( V_65 -> V_450 . V_505 [ 0 ] & 0x80000000 )
V_170 -> V_525 |= V_506 ;
if ( V_65 -> V_450 . V_507 [ 0 ] & 0x80000000 )
V_170 -> V_525 |= V_508 ;
if ( V_65 -> V_450 . V_509 [ 0 ] & 0x80000000 )
V_170 -> V_525 |= V_510 ;
if ( V_170 -> V_527 )
F_243 ( V_170 -> V_527 , 1 ) ;
} else
...
{
int V_47 , V_530 = - V_214 ;
struct V_231 * V_98 = V_4 -> V_98 ;
struct V_107 * V_108 = F_23 ( V_98 ) ;
struct V_111 * V_18 = & V_4 -> V_18 ;
V_92 ;
V_18 -> V_100 = (struct V_402 * ) F_252 ( V_213 ) ;
if ( ! V_18 -> V_100 )
return - V_214 ;
V_18 -> V_129 = V_101 / sizeof( * V_18 -> V_100 ) ;
V_18 -> V_118 = F_253 ( V_98 , V_18 -> V_100 ,
V_101 , V_119 ) ;
if ( F_254 ( V_98 , V_18 -> V_118 ) )
goto V_531;
V_530 = V_47 = F_24 ( V_123 , V_108 -> V_110 ,
V_18 -> V_118 , V_101 ) ;
if ( V_47 == V_532 )
V_530 = V_47 = F_36 ( V_4 ) ;
if ( V_47 == V_124 )
...
V_530 = 0 ;
F_255 ( & V_4 -> V_113 , ( void * ) F_193 , ( unsigned long ) V_4 ) ;
if ( ( V_47 = F_256 ( V_108 -> V_112 , F_190 , 0 , V_534 , V_4 ) ) ) {
...
{
struct V_437 * V_536 = & V_4 -> V_99 ;
V_92 ;
F_258 ( V_4 -> V_484 ) ;
F_70 ( V_4 -> V_14 ) ;
F_93 ( V_4 -> V_98 , V_4 -> V_496 , V_4 -> V_488 ,
V_4 -> V_498 ) ;
F_93 ( V_4 -> V_98 , sizeof( * V_4 -> V_152 ) ,
V_4 -> V_152 , V_4 -> V_516 ) ;
F_259 ( V_4 -> V_220 ) ;
F_33 ( V_4 -> V_98 , V_536 -> V_118 ,
V_536 -> V_129 * sizeof( * V_536 -> V_100 ) , V_119 ) ;
F_34 ( ( unsigned long ) V_536 -> V_100 ) ;
V_95 ;
}
...
struct V_231 * V_98 = V_4 -> V_98 ;
V_92 ;
V_536 -> V_100 = (struct V_377 * ) F_252 ( V_213 ) ;
if ( ! V_536 -> V_100 ) {
F_21 ( V_98 , L_107 ) ;
goto V_537;
}
V_536 -> V_129 = V_101 / sizeof( struct V_377 ) ;
V_536 -> V_118 = F_253 ( V_98 , V_536 -> V_100 ,
V_536 -> V_129 * sizeof( * V_536 -> V_100 ) ,
V_119 ) ;
if ( F_254 ( V_98 , V_536 -> V_118 ) ) {
F_21 ( V_98 , L_108 ) ;
goto V_538;
}
V_4 -> V_220 = F_261 ( V_534 , V_98 ,
V_539 * sizeof( struct V_226 ) ,
...
V_4 -> V_496 = sizeof( V_4 -> V_488 -> V_24 [ 0 ] ) * V_542 ;
V_4 -> V_488 = F_88 ( V_98 , V_4 -> V_496 ,
& V_4 -> V_498 , V_213 ) ;
if ( ! V_4 -> V_488 ) {
F_21 ( V_98 , L_111 ) ;
goto V_543;
...
static void F_263 ( struct V_548 * V_549 )
{
struct V_3 * V_4 = F_69 ( V_549 , struct V_3 ,
V_528 ) ;
struct V_64 * V_65 ;
struct V_169 * V_170 ;
unsigned long V_39 ;
...
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_239 ( V_65 ) ;
} else if ( F_264 ( & V_170 -> V_98 ) ) {
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_200 ( V_65 , L_113 ) ;
F_265 ( V_170 , V_65 -> V_173 . V_452 ) ;
F_266 ( & V_170 -> V_98 ) ;
}
F_73 ( & V_65 -> V_150 , F_68 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
static int F_267 ( struct V_107 * V_108 , const struct V_551 * V_149 )
{
struct V_3 * V_4 ;
struct V_145 * V_146 ;
...
V_146 -> V_513 = V_191 ;
V_146 -> V_557 = V_558 ;
V_146 -> V_559 = V_146 -> V_560 ;
V_4 = F_59 ( V_146 ) ;
F_269 ( & V_4 -> V_248 ) ;
F_269 ( & V_4 -> free ) ;
F_269 ( & V_4 -> V_486 ) ;
sprintf ( V_4 -> V_48 , V_534 ) ;
V_4 -> V_89 = V_146 ;
V_4 -> V_98 = V_98 ;
V_4 -> V_184 = - 1 ;
V_4 -> V_234 = V_234 ;
...
F_270 ( & V_4 -> V_91 ) ;
F_270 ( & V_4 -> V_176 ) ;
F_271 ( & V_4 -> V_528 , F_263 ) ;
F_272 ( & V_4 -> V_333 ) ;
if ( ( V_47 = F_260 ( V_4 ) ) )
goto V_561;
V_4 -> V_562 = F_273 ( F_248 , V_4 , L_116 , V_534 ,
V_146 -> V_560 ) ;
if ( F_274 ( V_4 -> V_562 ) ) {
F_21 ( V_98 , L_117 ,
F_275 ( V_4 -> V_562 ) ) ;
...
if ( ( V_47 = F_276 ( V_146 , V_98 ) ) )
goto V_566;
F_277 ( V_146 ) = V_567 ;
if ( ( V_47 = F_278 ( & V_146 -> V_568 . V_431 ,
& V_569 ) ) ) {
F_21 ( V_98 , L_120 , V_47 ) ;
goto V_570;
}
if ( F_279 ( V_146 ) -> V_527 )
F_243 ( F_279 ( V_146 ) -> V_527 , 1 ) ;
F_280 ( V_98 , V_4 ) ;
F_281 ( & V_571 ) ;
F_44 ( & V_4 -> V_130 , & V_572 ) ;
F_282 ( & V_571 ) ;
F_25 ( V_4 ) ;
F_283 ( V_146 ) ;
return 0 ;
...
static int F_287 ( struct V_107 * V_108 )
{
struct V_3 * V_4 = F_103 ( & V_108 -> V_98 ) ;
unsigned long V_39 ;
V_92 ;
F_288 ( & V_4 -> V_89 -> V_568 . V_431 , & V_569 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_18 ( V_4 , V_73 ) ;
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_77 ( V_4 ) ;
...
static int F_290 ( struct V_231 * V_98 )
{
unsigned long V_39 ;
struct V_3 * V_4 = F_103 ( V_98 ) ;
struct V_107 * V_108 = F_23 ( V_98 ) ;
...
static unsigned long F_291 ( struct V_107 * V_108 )
{
unsigned long V_573 = V_202 * sizeof( union V_307 ) ;
return V_573 + ( ( 512 * 1024 ) * V_552 . V_574 ) ;
}
...
if ( ! F_293 ( V_575 ) )
return - V_576 ;
F_294 (KERN_INFO IBMVFC_NAMEL_121 ,
