...
int V_78 = 0 ;
F_37 ( & V_28 -> V_79 ) ;
V_78 = F_28 ( V_5 , V_28 , V_51 , V_3 ) ;
F_38 ( & V_28 -> V_79 ) ;
return V_78 ;
}
static inline T_6 F_39 ( T_7 V_80 )
{
return ( ( ( V_81 V_82 ) V_80 >> V_83 ) ^ ( V_81 V_82 ) V_80 )
& V_84 ;
}
static int F_40 ( struct V_9 * V_9 , struct V_85 * V_86 )
{
struct V_85 * V_87 ;
T_6 V_88 ;
T_7 V_80 = V_86 -> V_80 ;
...
F_44 ( & V_86 -> V_95 , & V_90 -> V_96 [ V_88 ] ) ;
F_34 ( & V_5 -> V_97 ) ;
V_94:
F_45 ( & V_90 -> V_92 ) ;
return V_78 ;
}
static void F_46 ( struct V_9 * V_9 , struct V_85 * V_86 )
{
struct V_89 * V_90 = F_8 ( V_9 ) ;
struct V_4 * V_5 = F_41 ( V_9 , V_91 ) ;
F_42 ( & V_90 -> V_92 ) ;
...
F_31 ( V_28 -> V_38 ) ,
V_86 -> V_66 , F_31 ( V_86 -> V_80 ) ) ;
V_28 -> V_35 = V_86 ;
if ( V_86 -> V_102 )
V_98 = V_86 -> V_102 ( V_86 , V_28 ) ;
goto V_94;
}
}
F_38 ( & V_90 -> V_92 ) ;
