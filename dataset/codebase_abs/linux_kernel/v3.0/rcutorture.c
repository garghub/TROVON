...
V_116 [ V_39 ] += F_116 ( V_110 , V_61 ) [ V_39 ] ;
V_117 [ V_39 ] += F_116 ( V_111 , V_61 ) [ V_39 ] ;
}
}
...
static inline void
F_130 ( struct V_132 * V_46 , char * V_133 )
{
F_3 ( V_122 L_35 V_64
L_45
L_46
...
F_2 ( & V_87 ) ;
F_86 ( L_52 ) ;
V_139 [ V_61 ] = F_134 ( F_85 , NULL ,
L_8 ) ;
if ( F_135 ( V_139 [ V_61 ] ) ) {
V_140 = F_136 ( V_139 [ V_61 ] ) ;
F_86 ( L_53 ) ;
V_118 ++ ;
V_139 [ V_61 ] = NULL ;
F_4 ( & V_87 ) ;
...
F_137 ( V_139 [ V_61 ] , V_61 ) ;
F_138 ( V_139 [ V_61 ] ) ;
F_4 ( & V_87 ) ;
return 0 ;
}
static int F_139 ( struct V_1 * V_141 ,
...
& V_165 , & V_166 , & V_167 , } ;
F_2 ( & V_5 ) ;
for ( V_39 = 0 ; V_39 < F_147 ( V_157 ) ; V_39 ++ ) {
V_46 = V_157 [ V_39 ] ;
...
V_6 = V_7 ;
F_44 ( & V_18 ) ;
for ( V_39 = 0 ; V_39 < F_147 ( V_172 ) ; V_39 ++ ) {
V_172 [ V_39 ] . V_45 = 0 ;
...
F_71 (cpu) {
for ( V_39 = 0 ; V_39 < V_43 + 1 ; V_39 ++ ) {
F_116 ( V_110 , V_61 ) [ V_39 ] = 0 ;
F_116 ( V_111 , V_61 ) [ V_39 ] = 0 ;
}
}
F_86 ( L_69 ) ;
V_100 = F_149 ( F_92 , NULL ,
L_15 ) ;
if ( F_135 ( V_100 ) ) {
V_156 = F_136 ( V_100 ) ;
F_150 ( L_70 ) ;
...
V_127 = F_151 ( V_128 * sizeof( V_127 [ 0 ] ) ,
V_174 ) ;
if ( V_127 == NULL ) {
F_150 ( L_71 ) ;
V_156 = - V_175 ;
...
for ( V_39 = 0 ; V_39 < V_128 ; V_39 ++ ) {
F_86 ( L_72 ) ;
V_127 [ V_39 ] = F_149 ( F_99 , NULL ,
L_18 ) ;
if ( F_135 ( V_127 [ V_39 ] ) ) {
V_156 = F_136 ( V_127 [ V_39 ] ) ;
F_150 ( L_73 ) ;
V_127 [ V_39 ] = NULL ;
goto V_173;
}
}
V_126 = F_151 ( V_36 * sizeof( V_126 [ 0 ] ) ,
V_174 ) ;
if ( V_126 == NULL ) {
F_150 ( L_71 ) ;
V_156 = - V_175 ;
...
for ( V_39 = 0 ; V_39 < V_36 ; V_39 ++ ) {
F_86 ( L_74 ) ;
V_126 [ V_39 ] = F_149 ( F_109 , NULL ,
L_21 ) ;
if ( F_135 ( V_126 [ V_39 ] ) ) {
V_156 = F_136 ( V_126 [ V_39 ] ) ;
F_150 ( L_75 ) ;
V_126 [ V_39 ] = NULL ;
goto V_173;
}
...
if ( V_135 ) {
V_125 = F_124 () - 1 ;
if ( ! F_152 ( & V_124 , V_174 ) ) {
V_156 = - V_175 ;
F_150 ( L_78 ) ;
goto V_173;
}
V_152 = F_149 ( F_128 , NULL ,
L_40 ) ;
if ( F_135 ( V_152 ) ) {
F_143 ( V_124 ) ;
V_156 = F_136 ( V_152 ) ;
