...
int
F_18 ( struct V_4 * V_5 , struct V_25 * V_26 )
{
struct V_2 * V_3 ;
int V_6 ;
V_3 = F_6 ( 2 , 17 ) ;
...
F_19 ( ( ( unsigned char * ) V_3 -> V_14 ) + 1 , 16 ) ;
...
if( V_5 -> V_37 == 0 )
return 0 ;
F_22 ( 5 , L_11 , V_5 -> V_38 ,
V_5 -> V_37 ) ;
V_6 = F_23 ( V_5 , V_39 , V_5 -> V_37 ) ;
if ( V_6 )
return V_6 ;
V_5 -> V_37 = 0 ;
return F_23 ( V_5 , V_40 , 1 ) ;
}
int
F_24 ( struct V_4 * V_5 , int V_41 )
{
return F_25 ( V_5 -> V_42 ,
( V_5 -> V_43 == V_44 ) ) ;
}
int
F_26 ( struct V_4 * V_5 , int V_41 )
{
struct V_45 * V_46 ;
F_22 ( 6 , L_12 , V_41 ) ;
if ( V_41 <= 0 ) {
...
V_5 -> V_47 . V_49 = V_46 ;
V_5 -> V_47 . V_48 = V_41 ;
F_22 ( 6 , L_14 , V_5 -> V_47 . V_48 ) ;
return 0 ;
}
int
F_29 ( struct V_4 * V_5 , int V_41 )
{
F_3 ( 6 , L_15 ) ;
V_5 -> V_47 . V_48 = 0 ;
return 0 ;
...
V_5 -> V_35 ) ;
V_56 = F_31 ( V_56 , V_58 , V_54 ) ;
V_56 = F_10 ( V_56 , V_15 , 0 , NULL ) ;
return F_32 ( V_5 , V_3 ) ;
}
int
F_33 ( struct V_4 * V_5 , int V_54 )
{
struct V_2 * V_3 ;
struct V_55 * V_56 ;
int V_6 ;
...
{
int V_6 ;
if ( ( V_6 = F_23 ( V_5 , V_73 , 1 ) ) < 0 )
return V_6 ;
do {
if ( ( V_6 = F_23 ( V_5 , V_74 , 1 ) ) < 0 )
return V_6 ;
if ( ( V_6 = F_23 ( V_5 , V_68 , 1 ) ) < 0 )
return V_6 ;
} while ( V_6 == 0 );
return F_23 ( V_5 , V_40 , 1 ) ;
}
...
V_3 -> V_10 = V_80 ;
F_9 ( V_3 -> V_12 , V_34 , 1 , V_5 -> V_35 ) ;
F_49 ( V_3 -> V_12 + 1 , V_81 ,
V_5 -> V_47 . V_49 ) ;
F_3 ( 6 , L_20 ) ;
return V_3 ;
}
void
F_50 ( struct V_4 * V_5 , struct V_2 * V_3 )
{
V_3 -> V_10 = V_82 ;
F_9 ( V_3 -> V_12 , V_34 , 1 , V_5 -> V_35 ) ;
F_51 ( V_3 -> V_12 + 1 , V_83 ,
V_5 -> V_47 . V_49 ) ;
F_9 ( V_3 -> V_12 + 2 , V_60 , 0 , NULL ) ;
F_10 ( V_3 -> V_12 + 3 , V_15 , 0 , NULL ) ;
F_3 ( 6 , L_21 ) ; }
struct V_2 *
F_52 ( struct V_4 * V_5 , T_2 V_41 )
{
struct V_2 * V_3 ;
V_3 = F_6 ( 2 , 0 ) ;
if ( F_7 ( V_3 ) ) {
