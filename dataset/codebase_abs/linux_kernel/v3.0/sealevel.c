...
void T_2 F_28 ( struct V_37 * V_38 )
{
int V_39 ;
F_29 ( & V_38 -> V_40 ) ;
for ( V_39 = 0 ; V_39 < 2 ; V_39 ++ ) {
struct V_2 * V_12 = V_38 -> V_3 [ V_39 ] . V_17 -> V_11 ;
F_30 ( V_12 ) ;
F_27 ( V_12 ) ;
}
F_31 ( V_38 -> V_40 . V_30 , & V_38 -> V_40 ) ;
F_32 ( V_38 -> V_40 . V_41 . V_42 ) ;
F_32 ( V_38 -> V_40 . V_41 . V_43 ) ;
F_33 ( 0 , V_38 -> V_29 ) ;
F_34 ( V_38 -> V_29 , 8 ) ;
F_35 ( V_38 ) ;
}
...
{
V_44 = F_37 ( V_45 , V_30 , V_43 , V_42 , V_46 ) ;
return V_44 ? 0 : - V_47 ;
}
