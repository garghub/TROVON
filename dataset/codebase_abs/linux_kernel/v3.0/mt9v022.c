...
unsigned long V_29 ;
if ( ! V_28 -> V_43 . V_123 ||
F_39 ( V_28 -> V_43 . V_123 ) -> V_124 != V_28 -> V_125 )
return - V_100 ;
V_12 = F_5 ( V_9 , V_126 ) ;
...
struct V_30 * V_31 = F_18 ( V_28 ) ;
F_21 ( & V_28 -> V_43 , L_12 ,
V_28 -> V_43 . V_123 , V_28 -> V_133 ) ;
if ( V_31 -> V_134 )
V_31 -> V_134 ( V_31 ) ;
}
static int F_44 ( struct V_23 * V_24 , T_4 * V_135 )
{
struct V_8 * V_9 = F_14 ( V_24 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
* V_135 = V_7 -> V_67 ;
...
static int F_45 ( struct V_23 * V_24 , unsigned int V_136 ,
enum V_2 * V_3 )
{
struct V_8 * V_9 = F_14 ( V_24 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
...
{
struct V_7 * V_7 ;
struct V_27 * V_28 = V_9 -> V_43 . V_139 ;
struct V_140 * V_141 = F_47 ( V_9 -> V_43 . V_123 ) ;
struct V_30 * V_31 ;
int V_13 ;
if ( ! V_28 ) {
F_42 ( & V_9 -> V_43 , L_13 ) ;
...
V_7 = F_50 ( sizeof( struct V_7 ) , V_143 ) ;
if ( ! V_7 )
return - V_144 ;
F_51 ( & V_7 -> V_10 , V_9 , & V_145 ) ;
V_7 -> V_14 = V_146 ;
V_28 -> V_147 = & V_111 ;
V_7 -> V_67 = 1 ;
V_7 -> V_53 . V_59 = V_60 ;
