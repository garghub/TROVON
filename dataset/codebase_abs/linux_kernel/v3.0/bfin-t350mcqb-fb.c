...
static int T_5 F_52 ( struct V_96 * V_97 )
{
#ifndef F_53
struct V_98 V_99 ;
#endif
...
V_100 -> V_123 = & V_124 ;
V_100 -> V_12 = V_125 ;
V_49 -> V_42 = F_57 ( NULL , V_100 -> V_70 . V_72 +
V_126 ,
& V_49 -> V_127 , V_128 ) ;
if ( NULL == V_49 -> V_42 ) {
F_30 (KERN_ERR DRIVER_NAME
...
V_49 -> V_92 = F_59 ( V_97 , 0 ) ;
if ( V_49 -> V_92 < 0 ) {
V_101 = - V_65 ;
goto V_136;
}
V_101 = F_60 ( V_49 -> V_92 , F_49 , V_137 ,
L_11 , V_49 ) ;
if ( V_101 < 0 ) {
F_30 (KERN_ERR DRIVER_NAME
L_12 ) ;
...
V_143 = F_65 ( V_45 , NULL , & V_144 ) ;
V_143 -> V_99 . V_145 = 255 , F_30 ( V_146 L_16 ) ;
#endif
return 0 ;
V_138:
F_66 ( V_49 -> V_92 , V_49 ) ;
...
F_67 ( & V_100 -> V_133 ) ;
V_134:
F_68 ( NULL , V_100 -> V_70 . V_72 + V_126 ,
...
static int T_6 F_71 ( struct V_96 * V_97 )
{
struct V_48 * V_100 = F_72 ( V_97 ) ;
struct V_1 * V_49 = V_100 -> V_51 ;
F_64 ( V_100 ) ;
F_70 ( V_32 ) ;
F_66 ( V_49 -> V_92 , V_49 ) ;
if ( V_49 -> V_42 != NULL )
F_68 ( NULL , V_100 -> V_70 . V_72 +
V_126 , V_49 -> V_42 ,
V_49 -> V_127 ) ;
F_67 ( & V_100 -> V_133 ) ;
#ifndef F_53
...
static int F_75 ( struct V_96 * V_97 , T_7 V_147 )
{
struct V_48 * V_100 = F_72 ( V_97 ) ;
