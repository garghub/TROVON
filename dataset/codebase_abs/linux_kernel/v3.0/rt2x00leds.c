...
unsigned long V_28 ;
unsigned long V_29 ;
snprintf ( V_27 , sizeof( V_27 ) , L_2 ,
V_2 -> V_30 -> V_22 , F_10 ( V_2 -> V_24 -> V_25 ) ) ;
if ( V_2 -> V_20 . V_9 & V_31 ) {
snprintf ( V_22 , sizeof( V_22 ) , L_3 , V_27 ) ;
V_26 = F_6 ( V_2 ,
& V_2 -> V_20 ,
V_22 ) ;
if ( V_26 )
...
if ( V_2 -> V_18 . V_9 & V_31 ) {
snprintf ( V_22 , sizeof( V_22 ) , L_4 , V_27 ) ;
V_26 = F_6 ( V_2 ,
& V_2 -> V_18 ,
V_22 ) ;
if ( V_26 )
...
if ( V_2 -> V_6 . V_9 & V_31 ) {
snprintf ( V_22 , sizeof( V_22 ) , L_5 , V_27 ) ;
V_26 = F_6 ( V_2 ,
& V_2 -> V_6 ,
V_22 ) ;
if ( V_26 )
