...
V_203 -> V_209 = 0 ;
F_132 ( & V_203 -> V_210 , & F_65 ( V_95 ) -> V_117 ) ;
F_132 ( & V_203 -> V_211 , & F_65 ( V_95 ) -> V_118 ) ;
V_32 -> V_128 = V_205 ;
} else
#endif
{
F_133 ( V_32 , sizeof( struct V_103 ) ) ;
F_73 ( V_32 ) ;
F_134 ( V_32 , F_65 ( V_95 ) , sizeof( struct V_103 ) ) ;
F_133 ( V_32 , sizeof( * V_203 ) ) ;
F_131 ( V_32 ) ;
V_203 = (struct V_202 * ) F_63 ( V_32 ) ;
V_203 -> V_206 = 0 ;
V_203 -> V_207 = assert ;
...
static int
F_141 ( struct V_1 * V_4 , T_6 V_201 , struct V_31 * V_32 )
{
bool V_214 = false ;
int V_12 ;
struct V_59 * V_161 ;
...
F_145 ( & V_161 -> V_94 . V_164 . V_165 , V_32 ) ;
V_12 = 0 ;
}
F_37 ( & V_67 ) ;
return V_12 ;
}
static int F_146 ( struct V_1 * V_4 , struct V_217 * V_63 )
{
int line ;
struct V_59 * V_161 , * V_48 ;
...
static int F_147 ( struct V_221 * V_222 ,
...
#ifdef F_151
V_12 = - V_45 ;
if ( ! F_152 ( V_2 , L_13 , 0 , & V_228 ) )
goto V_229;
if ( ! F_152 ( V_2 , L_14 , 0 , & V_230 ) )
goto V_231;
#endif
return 0 ;
#ifdef F_151
...
goto V_236;
#ifdef F_27
if ( F_159 ( & V_237 , V_119 ) < 0 ) {
F_140 ( V_238 L_16 ) ;
V_12 = - V_30 ;
goto V_239;
}
#endif
F_160 ( V_240 , V_241 , NULL , V_242 ) ;
return 0 ;
#ifdef F_27
V_239:
F_161 ( & V_235 ) ;
...
static int F_165 ( struct V_2 * V_2 , struct V_1 * V_4 ,
...
V_161 -> V_246 |= V_247 ;
F_91 ( & V_64 ) ;
F_144 ( & V_161 -> V_49 , & V_4 -> V_54 [ line ] ) ;
F_92 ( & V_64 ) ;
V_214 = false ;
F_36 ( & V_67 ) ;
...
static int F_167 ( struct V_1 * V_4 , struct V_248 * V_249 )
{
int V_12 = 0 ;
struct V_2 * V_2 = F_168 ( V_249 ) ;
F_88 () ;
F_91 ( & V_64 ) ;
if ( F_169 ( V_4 -> V_212 == NULL ) ) {
V_4 -> V_212 = V_249 ;
...
struct V_248 * F_171 ( struct V_2 * V_2 , struct V_31 * V_32 )
{
struct V_1 * V_4 ;
struct V_5 V_107 = {
. V_108 = V_32 -> V_133 ,
...
int F_172 ( struct V_248 * V_249 , int V_251 , char T_8 * V_252 , unsigned int V_253 )
{
int V_204 ;
struct V_181 V_79 ;
struct V_217 V_63 ;
...
struct V_2 * V_2 = F_168 ( V_249 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , F_173 ( V_249 ) -> V_254 ? : V_44 ) ;
if ( V_4 == NULL )
return - V_76 ;
if ( V_251 != V_255 ) {
if ( V_249 != V_4 -> V_212 && ! F_174 ( V_256 ) )
return - V_25 ;
}
switch ( V_251 ) {
case V_255 :
if ( V_249 -> V_257 != V_258 ||
F_175 ( V_249 ) -> V_259 != V_260 )
return - V_261 ;
if ( V_253 < sizeof( int ) )
return - V_27 ;
return F_167 ( V_4 , V_249 ) ;
case V_262 :
return F_170 ( V_249 ) ;
case V_263 :
if ( V_253 < sizeof( V_79 ) )
return - V_27 ;
if ( F_176 ( & V_79 , V_252 , sizeof( V_79 ) ) )
return - V_264 ;
if ( V_79 . V_184 >= V_180 )
return - V_244 ;
F_88 () ;
...
if ( V_253 < sizeof( T_6 ) )
return - V_27 ;
if ( F_176 ( & V_201 , V_252 , sizeof( T_6 ) ) )
return - V_264 ;
F_88 () ;
...
return - V_27 ;
if ( F_176 ( & V_63 , V_252 , sizeof( V_63 ) ) )
return - V_264 ;
F_88 () ;
if ( V_251 == V_267 )
V_204 = F_146 ( V_4 , & V_63 ) ;
else
V_204 = F_165 ( V_2 , V_4 , & V_63 , V_249 == V_4 -> V_212 ) ;
F_87 () ;
return V_204 ;
case V_268 :
{
int V_78 ;
if ( F_177 ( V_78 , ( int T_8 * ) V_252 ) )
return - V_264 ;
V_4 -> V_269 = ! ! V_78 ;
return 0 ;
}
...
int F_178 ( struct V_248 * V_249 , int V_251 , char T_8 * V_252 ,
int T_8 * V_253 )
{
int V_275 ;
int V_276 ;
...
if ( F_177 ( V_275 , V_253 ) )
return - V_264 ;
V_275 = F_179 ( int , V_275 , sizeof( int ) ) ;
if ( V_275 < 0 )
return - V_27 ;
if ( F_180 ( V_275 , V_253 ) )
return - V_264 ;
if ( F_181 ( V_252 , & V_276 , V_275 ) )
return - V_264 ;
return 0 ;
}
int F_182 ( struct V_248 * V_249 , int V_278 , void T_8 * V_10 )
{
struct V_279 V_280 ;
struct V_281 V_282 ;
struct V_68 * V_79 ;
...
switch ( V_278 ) {
case V_283 :
if ( F_176 ( & V_282 , V_10 , sizeof( V_282 ) ) )
return - V_264 ;
...
F_35 ( & V_64 ) ;
if ( F_181 ( V_10 , & V_282 , sizeof( V_282 ) ) )
return - V_264 ;
return 0 ;
}
F_35 ( & V_64 ) ;
return - V_156 ;
case V_288 :
if ( F_176 ( & V_280 , V_10 , sizeof( V_280 ) ) )
return - V_264 ;
F_33 ( & V_64 ) ;
...
F_35 ( & V_64 ) ;
if ( F_181 ( V_10 , & V_280 , sizeof( V_280 ) ) )
return - V_264 ;
return 0 ;
}
F_35 ( & V_64 ) ;
...
int F_183 ( struct V_248 * V_249 , unsigned int V_278 , void T_8 * V_10 )
{
struct V_294 V_280 ;
struct V_295 V_282 ;
struct V_68 * V_79 ;
...
static inline int F_184 ( struct V_31 * V_32 )
{
F_185 ( F_61 ( F_137 ( V_32 ) -> V_81 ) , F_186 ( F_137 ( V_32 ) ) ,
V_296 ) ;
return F_187 ( V_32 ) ;
}
static int F_188 ( struct V_2 * V_2 , struct V_1 * V_4 ,
...
if ( V_311 )
F_188 ( V_2 , V_4 , V_311 , V_66 , V_305 ) ;
}
V_305 = V_65 ;
}
}
if ( V_305 != - 1 ) {
F_188 ( V_2 , V_4 , V_32 , V_66 , V_305 ) ;
return 0 ;
}
V_310:
F_78 ( V_32 ) ;
...
V_319 = (struct V_318 * ) F_133 ( V_32 , F_199 ( 0 ) ) ;
...
goto V_321;
V_316 = (struct V_315 * ) F_133 ( V_32 , F_201 ( sizeof( * V_316 ) ) ) ;
V_316 -> V_322 = 0 ;
...
struct V_1 * V_4 ;
struct V_59 * V_66 ;
struct V_332 * V_333 = (struct V_332 * ) F_137 ( V_32 ) ;
V_4 = F_1 ( V_2 , V_44 ) ;
if ( V_4 == NULL )
return - V_76 ;
F_33 ( & V_64 ) ;
...
F_131 ( V_311 ) ;
F_133 ( V_311 , sizeof( struct V_103 ) ) ;
F_73 ( V_311 ) ;
V_337 = F_65 ( V_311 ) ;
V_337 -> V_166 = 0 ;
V_337 -> V_338 = 0 ;
...
V_337 -> V_340 = V_341 ;
V_337 -> V_301 = 0 ;
F_132 ( & V_337 -> V_117 , & V_333 -> V_334 . V_335 ) ;
F_132 ( & V_337 -> V_118 , & V_333 -> V_336 . V_335 ) ;
V_12 = F_141 ( V_4 , V_79 , V_311 ) ;
F_35 ( & V_64 ) ;
return V_12 ;
}
...
{
struct V_2 * V_2 = F_168 ( V_32 -> V_249 ) ;
struct V_1 * V_4 ;
struct V_59 * V_63 ;
