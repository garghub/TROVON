...
V_2 -> V_30 = V_13 -> V_30 ;
V_5 = F_18 ( V_17 , V_31 , V_32 , V_13 -> V_15 ) ;
if ( ! V_5 ) {
V_19 = - V_33 ;
goto V_29;
}
...
int F_22 ( struct V_37 * V_38 , int V_39 )
{
...
static struct V_64 * F_31 ( struct V_65 * V_46 )
{
if ( ! V_46 )
return & V_66 ;
else
...
static struct V_68 * F_32 ( T_1 * V_69 , T_1 * V_70 ,
struct V_64 * V_71 )
{
T_1 V_72 = * V_69 & V_73 ;
if ( * V_70 & V_74 ) {
...
int F_34 ( struct V_65 * V_46 , T_1 V_69 , T_1 V_70 ,
...
{
struct V_88 * V_89 = F_42 ( V_101 , struct V_88 , V_102 ) ;
F_39 ( V_92 , V_89 ) ;
}
void F_43 ( struct V_65 * V_46 , T_1 V_69 , T_1 V_70 ,
void (* F_35)( struct V_37 * , void * ) , void * V_43 )
{
