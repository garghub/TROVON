...
struct V_57 * V_58 ;
int error ;
if ( V_2 -> V_51 != V_52 && V_2 -> V_51 != V_59 )
return 0 ;
...
enum V_92 V_93 )
{
struct V_94 * V_94 = F_34 ( V_91 ,
struct V_94 , V_91 ) ;
F_30 ( V_94 -> V_2 , V_93 ) ;
}
static int F_35 ( struct V_1 * V_2 )
{
static T_3 V_95 = F_36 ( 0 ) ;
long V_96 ;
struct V_94 * V_97 ;
struct V_90 * V_91 ;
int error ;
if ( V_2 -> V_51 != V_52 )
return 0 ;
V_2 -> V_97 = V_97 = F_37 ( sizeof( struct V_94 ) , V_63 ) ;
if ( ! V_97 )
return - V_65 ;
V_96 = ( long ) F_38 ( & V_95 ) - 1 ;
snprintf ( V_97 -> V_98 , sizeof( V_97 -> V_98 ) , L_5 , V_96 ) ;
V_97 -> V_2 = V_2 ;
V_91 = & V_97 -> V_91 ;
V_91 -> V_98 = V_97 -> V_98 ;
V_91 -> V_99 = F_33 ;
error = F_39 ( & V_2 -> V_61 -> V_6 , V_91 ) ;
if ( error ) {
F_40 ( V_97 ) ;
V_2 -> V_97 = NULL ;
return error ;
...
if( V_2 -> V_51 == V_54 )
return 0 ;
V_2 -> V_100 -> V_6 = V_2 -> V_61 ;
if ( F_8 ( V_2 -> V_100 , V_63 ) )
return - V_101 ;
return 0 ;
}
...
static int F_48 ( struct V_55 * V_56 , const struct V_103 * V_104 )
{
struct V_105 * V_61 = F_49 ( V_56 ) ;
struct V_1 * V_2 ;
struct V_5 * V_5 ;
struct V_57 * V_106 ;
int V_107 , error ;
for ( V_107 = 0 ; V_108 [ V_107 ] . V_109 ; V_107 ++ ) {
if ( ( F_50 ( V_61 -> V_110 . V_109 ) == V_108 [ V_107 ] . V_109 ) &&
( F_50 ( V_61 -> V_110 . V_111 ) == V_108 [ V_107 ] . V_111 ) )
break;
}
...
V_2 -> V_100 = F_17 ( 0 , V_63 ) ;
if ( ! V_2 -> V_100 ) {
error = - V_65 ;
goto V_69;
}
V_2 -> V_61 = V_61 ;
V_2 -> V_7 = V_108 [ V_107 ] . V_7 ;
V_2 -> V_51 = V_108 [ V_107 ] . V_51 ;
if ( V_2 -> V_51 == V_113 ) {
...
for ( V_107 = 0 ; V_127 [ V_107 ] >= 0 ; V_107 ++ )
F_45 ( V_5 , V_127 [ V_107 ] ) ;
}
for ( V_107 = 0 ; V_128 [ V_107 ] >= 0 ; V_107 ++ )
F_57 ( V_128 [ V_107 ] , V_5 -> V_129 ) ;
if ( V_2 -> V_51 == V_52 || V_2 -> V_51 == V_54 ) {
for ( V_107 = 0 ; V_130 [ V_107 ] >= 0 ; V_107 ++ )
F_57 ( V_130 [ V_107 ] , V_5 -> V_129 ) ;
} else {
for ( V_107 = 0 ; V_131 [ V_107 ] >= 0 ; V_107 ++ )
F_57 ( V_131 [ V_107 ] , V_5 -> V_129 ) ;
}
if ( V_2 -> V_7 & V_20 ) {
for ( V_107 = 0 ; V_132 [ V_107 ] >= 0 ; V_107 ++ )
F_57 ( V_132 [ V_107 ] , V_5 -> V_129 ) ;
} else {
for ( V_107 = 0 ; V_133 [ V_107 ] >= 0 ; V_107 ++ )
F_45 ( V_5 , V_133 [ V_107 ] ) ;
}
if ( V_2 -> V_7 & V_15 ) {
for ( V_107 = 0 ; V_134 [ V_107 ] >= 0 ; V_107 ++ )
F_57 ( V_134 [ V_107 ] , V_5 -> V_129 ) ;
} else {
for ( V_107 = 0 ; V_135 [ V_107 ] >= 0 ; V_107 ++ )
F_45 ( V_5 , V_135 [ V_107 ] ) ;
}
error = F_14 ( V_56 , V_2 ) ;
if ( error )
goto V_136;
...
if ( error )
goto V_138;
V_106 = & V_56 -> V_70 -> V_71 [ 0 ] . V_72 ;
F_18 ( V_2 -> V_100 , V_61 ,
F_58 ( V_61 , V_106 -> V_73 ) ,
V_2 -> V_53 , V_62 , F_9 ,
V_2 , V_106 -> V_74 ) ;
V_2 -> V_100 -> V_75 = V_2 -> V_112 ;
V_2 -> V_100 -> V_76 |= V_77 ;
error = F_59 ( V_2 -> V_6 ) ;
if ( error )
goto V_139;
...
V_106 = & V_56 -> V_70 -> V_71 [ 1 ] . V_72 ;
F_61 ( V_2 -> V_41 , V_61 ,
F_62 ( V_61 , V_106 -> V_73 ) ,
V_2 -> V_141 , V_62 , F_12 , V_2 ) ;
V_2 -> V_100 -> V_6 = V_2 -> V_61 ;
error = F_8 ( V_2 -> V_100 , V_63 ) ;
if ( error )
goto V_144;
}
return 0 ;
...
F_64 ( V_5 ) ;
V_137: F_23 ( V_2 ) ;
V_136: F_24 ( V_2 -> V_100 ) ;
V_69: F_20 ( V_61 , V_62 , V_2 -> V_53 , V_2 -> V_112 ) ;
V_66: F_65 ( V_5 ) ;
F_40 ( V_2 ) ;
return error ;
}
