...
V_2 -> V_152 [ V_19 ] . V_154 -
V_2 -> V_152 [ V_19 ] . V_153 + 1 ) ;
}
}
if ( V_2 -> V_9 )
F_76 ( V_2 -> V_9 ) ;
...
{
struct V_1 * V_2 = V_156 -> V_157 ;
return F_71 ( V_2 ) ;
}
static void T_2 F_80 ( struct V_1 * V_2 )
{
struct V_158 * V_159 ;
for ( V_159 = V_2 -> V_144 -> V_160 ; V_159 ; V_159 = V_159 -> V_160 ) {
if ( strcmp ( V_159 -> V_120 , L_2 ) == 0 ) {
if ( F_81 ( V_159 , L_3 ) )
V_2 -> V_123 = 0 ;
break;
}
...
static int T_2 F_83 ( struct V_1 * V_2 )
{
struct V_158 * V_161 ;
struct V_158 * V_162 ;
...
|| F_82 ( L_9 ) )
V_2 -> V_176 = 1 ;
V_2 -> V_144 = F_86 ( NULL , L_10 ) ;
V_161 = F_87 ( V_2 -> V_144 ) ;
if ( ! V_2 -> V_144 )
V_2 -> V_144 = F_86 ( NULL , L_11 ) ;
if ( ! V_2 -> V_144 ) {
V_2 -> V_144 = F_86 ( NULL , L_12 ) ;
if ( V_2 -> V_144 && V_2 -> V_144 -> V_160 &&
V_2 -> V_144 -> V_160 -> V_160 ) {
if ( F_81 ( V_2 -> V_144 -> V_160 -> V_160 ,
L_13 ) )
V_2 -> V_177 = 1 ;
}
}
...
return - V_168 ;
if ( ! V_161 ) {
V_161 = F_86 ( NULL , L_14 ) ;
while ( V_161 && V_161 -> V_160 != V_2 -> V_144 )
V_161 = F_86 ( V_161 , L_14 ) ;
}
if ( ! V_161 ) {
F_77 ( V_2 -> V_144 ) ;
V_2 -> V_144 = NULL ;
...
V_163 = F_88 ( V_161 , L_15 , NULL ) ;
if ( V_163 && * V_163 < 16 )
V_2 -> V_169 = * V_163 ;
V_163 = F_88 ( V_161 , L_16 , NULL ) ;
if ( V_163 ) {
F_89 ( V_178 L_17
L_18
L_19 ) ;
...
V_163 = F_88 ( V_161 , L_31 , NULL ) ;
if ( V_163 )
V_2 -> V_184 = * V_163 ;
V_162 = F_86 ( NULL , L_32 ) ;
V_2 -> V_185 = ( V_162 != NULL ) ;
F_77 ( V_162 ) ;
V_166 = F_90 ( V_2 -> V_144 , V_186 ) ;
if ( V_166 == NULL )
F_89 ( V_187 L_33 ) ;
else {
struct V_188 * V_9 = NULL ;
F_91 (pdev) {
struct V_158 * V_189 = F_92 ( V_9 ) ;
if ( V_189 && V_189 == V_166 -> V_190 ) {
V_2 -> V_9 = V_9 ;
break;
}
}
...
L_35 ) ;
F_80 ( V_2 ) ;
V_163 = F_88 ( V_161 , L_36 , & V_164 ) ;
if ( ! V_163 )
V_163 = F_88 ( V_161 , L_37 , & V_164 ) ;
if ( V_163 ) {
int V_19 ;
V_2 -> V_96 = 0 ;
for ( V_164 /= sizeof( int ) ; V_164 > 0 ; -- V_164 ) {
unsigned int V_191 = * V_163 ++ ;
if ( V_191 >= 0x10000 )
V_191 >>= 16 ;
for ( V_19 = 0 ; V_19 < V_2 -> V_24 ; ++ V_19 ) {
if ( V_191 == V_2 -> V_23 [ V_19 ] ) {
V_2 -> V_96 |= ( 1 << V_19 ) ;
break;
}
}
...
static int F_93 ( struct V_192 * V_193 ,
struct V_194 * V_195 )
{
struct V_1 * V_2 = F_94 ( V_193 ) ;
V_195 -> V_196 . integer . V_196 [ 0 ] = V_2 -> V_197 ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_94 ( V_193 ) ;
if ( V_195 -> V_196 . integer . V_196 [ 0 ] != V_2 -> V_197 ) {
V_2 -> V_197 = ! ! V_195 -> V_196 . integer . V_196 [ 0 ] ;
if ( V_2 -> V_133 )
V_2 -> V_133 ( V_2 , 1 ) ;
return 1 ;
}
...
struct V_1 * V_2 = F_94 ( V_193 ) ;
if ( V_2 -> V_198 )
V_195 -> V_196 . integer . V_196 [ 0 ] = V_2 -> V_198 ( V_2 ) ;
else
V_195 -> V_196 . integer . V_196 [ 0 ] = 0 ;
return 0 ;
}
int T_2 F_97 ( struct V_1 * V_2 )
{
int V_113 ;
V_2 -> V_197 = 1 ;
V_113 = F_98 ( V_2 -> V_115 , F_99 ( & V_199 [ 0 ] , V_2 ) ) ;
if ( V_113 < 0 ) {
F_89 ( V_200 L_38 ) ;
return V_113 ;
}
V_2 -> V_201 = F_99 ( & V_199 [ 1 ] , V_2 ) ;
return F_98 ( V_2 -> V_115 , V_2 -> V_201 ) ;
}
int T_2 F_100 ( struct V_202 * V_115 , struct V_1 * * V_203 )
{
struct V_1 * V_2 ;
struct V_158 * V_189 ;
int V_19 , V_113 ;
...
if ( ( V_113 = F_83 ( V_2 ) ) < 0 )
goto V_210;
if ( F_1 ( V_2 , & V_2 -> V_32 . V_49 , V_211 + 1 ) < 0 ||
F_1 ( V_2 , & V_2 -> V_33 . V_49 , V_211 + 1 ) < 0 ||
...
if ( F_103 ( V_189 -> V_160 , V_19 ,
& V_2 -> V_152 [ V_19 ] ) ) {
F_89 ( V_200 L_41
L_42 , V_19 , V_212 [ V_19 ] ) ;
V_113 = - V_168 ;
goto V_210;
}
if ( F_104 ( V_2 -> V_152 [ V_19 ] . V_153 ,
V_2 -> V_152 [ V_19 ] . V_154 -
V_2 -> V_152 [ V_19 ] . V_153 + 1 ,
V_212 [ V_19 ] ) == NULL ) {
F_89 ( V_200 L_43
L_44 ,
V_19 , V_212 [ V_19 ] , & V_2 -> V_152 [ V_19 ] ) ;
V_113 = - V_168 ;
goto V_210;
}
V_2 -> V_151 |= ( 1 << V_19 ) ;
}
V_204 = V_2 -> V_152 [ 0 ] . V_153 ;
V_205 = V_2 -> V_152 [ 1 ] . V_153 ;
V_206 = V_205 + 0x100 ;
} else {
static char * V_212 [] = {
L_39 , L_45 , L_46 } ;
...
V_204 = V_2 -> V_152 [ 0 ] . V_153 ;
V_205 = V_2 -> V_152 [ 1 ] . V_153 ;
V_206 = V_2 -> V_152 [ 2 ] . V_153 ;
}
V_2 -> V_38 = F_105 ( V_204 , 0x1000 ) ;
V_2 -> V_32 . V_35 = F_105 ( V_205 , 0x100 ) ;
V_2 -> V_33 . V_35 = F_105 ( V_206 , 0x100 ) ;
if ( V_2 -> V_137 <= V_179 ) {
V_128 = F_106 ( V_189 , 0 ) ;
if ( F_107 ( V_128 , F_68 , 0 ,
L_47 , ( void * ) V_2 ) ) {
F_69 ( V_200 L_48 ,
V_128 ) ;
V_113 = - V_76 ;
...
V_128 = F_106 ( V_189 , 1 ) ;
if ( F_107 ( V_128 , F_66 , 0 , L_49 , ( void * ) V_2 ) ) {
F_69 ( V_200 L_48 , V_128 ) ;
V_113 = - V_76 ;
goto V_210;
}
V_2 -> V_147 = V_128 ;
V_128 = F_106 ( V_189 , 2 ) ;
if ( F_107 ( V_128 , F_67 , 0 , L_50 , ( void * ) V_2 ) ) {
F_69 ( V_200 L_48 , V_128 ) ;
V_113 = - V_76 ;
goto V_210;
}
...
if ( V_2 -> V_175 ) {
V_2 -> V_150 = F_105 ( 0xf301a000 , 0x1000 ) ;
F_108 ( V_2 -> V_150 + 0x190 ) ;
} else if ( V_2 -> V_176 ) {
struct V_158 * V_159 ;
for ( V_159 = V_2 -> V_144 -> V_160 ; V_159 ; V_159 = V_159 -> V_160 ) {
if ( strcmp ( V_159 -> V_120 , L_2 ) == 0 ) {
struct V_213 V_191 ;
if ( F_103 ( V_159 , 0 , & V_191 ) == 0 )
V_2 -> V_149 =
F_105 ( V_191 . V_153 , 0x40 ) ;
break;
}
}
if ( V_2 -> V_149 )
F_109 ( V_2 -> V_149 + 0x37 , 3 ) ;
}
F_63 ( V_2 ) ;
if ( ( V_113 = F_110 ( V_115 , V_214 , V_2 , & V_208 ) ) < 0 )
goto V_210;
* V_203 = V_2 ;
return 0 ;
V_210:
...
{
unsigned long V_215 ;
F_112 ( V_2 -> V_115 , V_216 ) ;
if ( V_2 -> V_217 )
V_2 -> V_217 ( V_2 ) ;
F_113 ( V_2 -> V_112 ) ;
F_114 ( & V_2 -> V_62 , V_215 ) ;
F_33 ( V_2 ) ;
F_115 ( & V_2 -> V_62 , V_215 ) ;
if ( V_2 -> V_128 >= 0 )
F_116 ( V_2 -> V_128 ) ;
if ( V_2 -> V_147 >= 0 )
F_116 ( V_2 -> V_147 ) ;
