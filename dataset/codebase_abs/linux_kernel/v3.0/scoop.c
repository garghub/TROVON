...
static int T_2 F_19 ( struct V_27 * V_32 )
{
struct V_3 * V_33 ;
struct V_34 * V_35 ;
...
F_22 ( & V_33 -> V_20 ) ;
V_35 = V_32 -> V_2 . V_44 ;
V_33 -> V_5 = F_23 ( V_37 -> V_45 , V_37 -> V_46 - V_37 -> V_45 + 1 ) ;
if ( ! V_33 -> V_5 ) {
V_39 = - V_43 ;
goto V_47;
}
F_24 ( V_32 , V_33 ) ;
F_25 ( L_1 , ( unsigned int ) V_37 -> V_45 , V_33 -> V_5 ) ;
F_3 ( 0x0140 , V_33 -> V_5 + V_6 ) ;
F_1 ( & V_32 -> V_2 ) ;
F_3 ( 0x0000 , V_33 -> V_5 + V_48 ) ;
F_3 ( V_35 -> V_49 & 0xffff , V_33 -> V_5 + V_23 ) ;
F_3 ( V_35 -> V_50 & 0xffff , V_33 -> V_5 + V_15 ) ;
V_33 -> V_30 = V_35 -> V_30 ;
V_33 -> V_31 = V_35 -> V_31 ;
V_33 -> V_18 . V_5 = - 1 ;
if ( V_35 -> V_51 != 0 ) {
V_33 -> V_18 . V_52 = F_26 ( & V_32 -> V_2 ) ;
V_33 -> V_18 . V_5 = V_35 -> V_51 ;
V_33 -> V_18 . V_53 = 12 ;
V_33 -> V_18 . V_54 = F_6 ;
V_33 -> V_18 . V_55 = F_10 ;
V_33 -> V_18 . V_56 = F_11 ;
...
static int T_3 F_31 ( struct V_27 * V_32 )
{
