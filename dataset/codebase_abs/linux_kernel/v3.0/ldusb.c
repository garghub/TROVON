...
V_2 -> V_70 = V_2 -> V_71 ? F_47 ( V_2 -> V_71 -> V_97 ) :
V_80 -> V_87 . V_98 ;
...
V_2 -> V_47 = V_99 > V_2 -> V_45 -> V_100 ? V_99 : V_2 -> V_45 -> V_100 ;
if ( V_2 -> V_71 )
V_2 -> V_76 = V_101 > V_2 -> V_71 -> V_100 ? V_101 : V_2 -> V_71 -> V_100 ;
F_53 ( V_4 , V_2 ) ;
V_16 = F_54 ( V_4 , & V_102 ) ;
if ( V_16 ) {
F_11 ( & V_4 -> V_2 , L_23 ) ;
...
static void F_56 ( struct V_36 * V_4 )
{
struct V_1 * V_2 ;
int V_103 ;
V_2 = F_20 ( V_4 ) ;
