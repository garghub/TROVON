...
static inline T_2 F_8 ( T_2 V_26 , struct V_27 * V_28 )
{
V_26 &= 0xffff ;
V_26 >>= 16 - V_28 -> V_16 ;
...
static int T_1 F_13 ( struct V_8 * V_9 ,
struct V_35 * V_36 )
{
...
static struct V_8 * T_1 F_22 ( struct V_51 * V_36 )
{
struct V_37 * V_38 ;
struct V_8 * V_9 ;
V_9 = F_23 ( sizeof( struct V_37 ) + sizeof( T_3 ) * 16 ,
V_36 ) ;
if ( ! V_9 )
return NULL ;
V_38 = V_9 -> V_38 ;
...
static int F_26 ( struct V_35 * V_74 , T_4 V_75 )
{
...
static int T_1 F_35 ( struct V_35 * V_74 ,
const struct V_79 * V_52 )
{
struct V_37 * V_38 ;
struct V_8 * V_9 ;
int V_39 ;
...
static void T_5 F_45 ( struct V_35 * V_74 )
{
struct V_8 * V_9 = F_27 ( V_74 ) ;
struct V_37 * V_38 = V_9 -> V_38 ;
F_46 ( V_9 ) ;
...
static int T_6 F_47 ( char * V_92 )
{
char * V_93 ;
if ( ! V_92 || ! * V_92 )
return 0 ;
while ( ( V_93 = F_48 ( & V_92 , L_11 ) ) != NULL ) {
if ( ! * V_93 )
continue;
if ( ! strcmp ( V_93 , L_12 ) )
V_89 = 1 ;
else if ( ! strcmp ( V_93 , L_13 ) )
V_84 = 1 ;
else if ( ! strcmp ( V_93 , L_14 ) )
V_86 = 1 ;
else
V_88 = V_93 ;
}
