...
static int F_17 ( struct V_1 * V_26 , struct V_2 * V_3 ,
struct V_27 * V_28 ,
struct V_27 * V_29 ,
T_1 V_16 , void * V_30 ,
int V_31 , T_2 V_32 ,
...
if ( ( V_16 & V_40 ) ||
( V_56 & V_26 -> V_20 ) )
V_51 = F_22 ( V_26 -> V_59 . V_60 ,
& V_58 ) ;
if ( V_3 && ( ( V_16 & V_40 ) ||
( V_56 & V_3 -> V_57 ) ) ) {
V_52 = F_22 ( V_3 -> V_61 . V_60 ,
& V_58 ) ;
V_51 = F_22 ( V_26 -> V_59 . V_60 ,
& V_58 ) ;
}
...
V_53 = V_54 = NULL ;
if ( V_51 ) {
V_28 = F_23 ( F_22 ( V_51 , & V_58 ) ,
struct V_27 , V_62 . V_63 ) ;
V_53 = V_28 -> V_37 ;
}
if ( V_52 ) {
V_29 = F_23 ( F_22 ( V_52 , & V_58 ) ,
struct V_27 , V_64 . V_65 ) ;
V_54 = V_29 -> V_37 ;
}
if ( V_53 > V_54 ) {
V_19 = F_17 ( V_26 , NULL , V_28 , NULL , V_16 , V_30 ,
V_31 , V_32 , V_33 , & V_35 ) ;
V_54 = NULL ;
} else if ( V_54 > V_53 ) {
V_19 = F_17 ( V_26 , V_3 , NULL , V_29 , V_16 , V_30 ,
V_31 , V_32 , V_33 , & V_35 ) ;
V_53 = NULL ;
} else {
V_19 = F_17 ( V_26 , V_3 , V_28 , V_29 ,
