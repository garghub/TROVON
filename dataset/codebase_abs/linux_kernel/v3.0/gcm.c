...
goto V_92;
V_18 = F_78 ( V_69 ) ;
V_86 = F_95 ( V_84 , struct V_85 , V_93 . V_64 ) ;
V_7 = F_96 ( & V_18 -> V_20 , & V_86 -> V_93 ,
V_69 ) ;
if ( V_7 )
goto V_94;
F_97 ( & V_18 -> V_22 , V_69 ) ;
V_7 = F_98 ( & V_18 -> V_22 , V_79 , 0 ,
F_99 ( V_82 -> type ,
V_82 -> V_88 ) ) ;
if ( V_7 )
goto V_95;
V_22 = F_100 ( & V_18 -> V_22 ) ;
...
V_69 -> V_101 . V_99 = 1 ;
V_69 -> V_101 . V_108 = V_22 -> V_108 | ( F_101 ( V_109 ) - 1 ) ;
...
static struct V_68 * F_105 ( struct V_76 * * V_77 )
{
int V_7 ;
const char * V_121 ;
char V_79 [ V_103 ] ;
...
static void F_107 ( struct V_68 * V_69 )
{
...
static struct V_68 * F_108 ( struct V_76 * * V_77 )
{
int V_7 ;
const char * V_79 ;
const char * V_80 ;
...
static int F_109 ( struct V_13 * V_122 , const V_5 * V_15 ,
unsigned int V_16 )
{
...
V_28 ) ;
V_7 = F_111 ( V_124 , V_15 , V_16 ) ;
F_14 ( V_122 , F_12 ( V_124 ) &
V_29 ) ;
return V_7 ;
}
static int F_112 ( struct V_13 * V_122 ,
unsigned int V_37 )
{
struct V_123 * V_18 = F_9 ( V_122 ) ;
switch ( V_37 ) {
...
return F_113 ( V_18 -> V_124 , V_37 ) ;
}
static struct V_2 * F_114 ( struct V_2 * V_3 )
{
struct V_2 * V_126 = F_5 ( V_3 ) ;
struct V_13 * V_14 = F_3 ( V_3 ) ;
struct V_123 * V_18 = F_9 ( V_14 ) ;
struct V_13 * V_124 = V_18 -> V_124 ;
V_5 * V_24 = F_4 ( ( V_5 * ) ( V_126 + 1 ) + F_115 ( V_124 ) ,
F_2 ( V_124 ) + 1 ) ;
memcpy ( V_24 , V_18 -> V_125 , 4 ) ;
memcpy ( V_24 + 4 , V_3 -> V_24 , 8 ) ;
F_116 ( V_126 , V_124 ) ;
F_117 ( V_126 , V_3 -> V_64 . V_127 , V_3 -> V_64 . F_7 ,
V_3 -> V_64 . V_10 ) ;
F_118 ( V_126 , V_3 -> V_45 , V_3 -> V_42 , V_3 -> V_40 , V_24 ) ;
F_119 ( V_126 , V_3 -> V_63 , V_3 -> V_57 ) ;
return V_126 ;
}
...
static int F_124 ( struct V_67 * V_36 )
{
struct V_68 * V_69 = ( void * ) V_36 -> V_70 ;
...
static void F_127 ( struct V_67 * V_36 )
{
struct V_123 * V_18 = F_62 ( V_36 ) ;
F_128 ( V_18 -> V_124 ) ;
}
static struct V_68 * F_129 ( struct V_76 * * V_77 )
{
struct V_81 * V_82 ;
struct V_68 * V_69 ;
struct V_128 * V_129 ;
...
V_129 = F_78 ( V_69 ) ;
F_130 ( V_129 , V_69 ) ;
V_7 = F_131 ( V_129 , V_130 , 0 ,
F_99 ( V_82 -> type , V_82 -> V_88 ) ) ;
if ( V_7 )
goto V_131;
V_101 = F_132 ( V_129 ) ;
V_7 = - V_38 ;
...
V_69 -> V_101 . V_115 = F_124 ;
V_69 -> V_101 . V_116 = F_127 ;
V_69 -> V_101 . V_112 . V_117 = F_109 ;
V_69 -> V_101 . V_112 . V_118 = F_112 ;
V_69 -> V_101 . V_112 . V_119 = F_120 ;
V_69 -> V_101 . V_112 . V_120 = F_122 ;
...
static void F_134 ( struct V_68 * V_69 )
{
F_135 ( F_78 ( V_69 ) ) ;
F_29 ( V_69 ) ;
}
static inline struct V_135 * F_136 (
struct V_2 * V_3 )
{
unsigned long V_4 = F_2 ( F_3 ( V_3 ) ) ;
return ( void * ) F_4 ( ( V_5 * ) F_5 ( V_3 ) , V_4 + 1 ) ;
}
static int F_137 ( struct V_13 * V_122 , const V_5 * V_15 ,
unsigned int V_16 )
{
...
static int F_138 ( struct V_13 * V_122 ,
unsigned int V_37 )
{
struct V_136 * V_18 = F_9 ( V_122 ) ;
if ( V_37 != 16 )
...
static struct V_2 * F_139 ( struct V_2 * V_3 ,
int V_137 )
{
struct V_13 * V_14 = F_3 ( V_3 ) ;
struct V_136 * V_18 = F_9 ( V_14 ) ;
struct V_135 * V_138 = F_136 ( V_3 ) ;
...
struct V_141 * V_142 ;
V_5 * V_143 ;
V_5 * V_24 = F_4 ( ( V_5 * ) ( V_138 + 1 ) + F_115 ( V_18 -> V_124 ) ,
F_2 ( V_18 -> V_124 ) + 1 ) ;
memcpy ( V_24 , V_18 -> V_125 , 4 ) ;
memcpy ( V_24 + 4 , V_3 -> V_24 , 8 ) ;
if ( V_137 )
...
V_142 = F_140 ( V_42 ) ;
V_143 = F_141 ( V_142 ) ? NULL : F_142 ( V_142 ) + V_42 -> V_144 ;
F_33 ( V_140 , 2 ) ;
F_34 ( V_140 , V_3 -> V_24 , 8 ) ;
F_143 ( V_140 , V_42 , V_143 == V_3 -> V_24 + 8 , 2 ) ;
V_57 += 8 + V_3 -> V_40 - ( V_137 ? 0 : V_37 ) ;
F_33 ( V_63 , 2 ) ;
F_144 ( V_63 , F_140 ( V_3 -> V_63 ) , V_3 -> V_63 -> V_145 ,
V_3 -> V_63 -> V_144 ) ;
F_143 ( V_63 , V_140 , 0 , 2 ) ;
F_116 ( V_126 , V_18 -> V_124 ) ;
F_117 ( V_126 , V_3 -> V_64 . V_127 , V_3 -> V_64 . F_7 ,
V_3 -> V_64 . V_10 ) ;
F_118 ( V_126 , V_139 , V_139 , V_137 ? 0 : V_37 , V_24 ) ;
F_119 ( V_126 , V_63 , V_57 ) ;
return V_126 ;
}
...
static int F_147 ( struct V_67 * V_36 )
{
struct V_68 * V_69 = ( void * ) V_36 -> V_70 ;
struct V_128 * V_129 = F_78 ( V_69 ) ;
...
static void F_148 ( struct V_67 * V_36 )
{
struct V_136 * V_18 = F_62 ( V_36 ) ;
F_128 ( V_18 -> V_124 ) ;
}
static struct V_68 * F_149 ( struct V_76 * * V_77 )
{
struct V_81 * V_82 ;
struct V_68 * V_69 ;
struct V_128 * V_129 ;
...
V_69 -> V_101 . V_115 = F_147 ;
V_69 -> V_101 . V_116 = F_148 ;
V_69 -> V_101 . V_112 . V_117 = F_137 ;
V_69 -> V_101 . V_112 . V_118 = F_138 ;
V_69 -> V_101 . V_112 . V_119 = F_145 ;
V_69 -> V_101 . V_112 . V_120 = F_146 ;
V_69 -> V_101 . V_112 . V_134 = L_6 ;
V_35:
return V_69 ;
V_132:
...
static void F_150 ( struct V_68 * V_69 )
{
F_135 ( F_78 ( V_69 ) ) ;
F_29 ( V_69 ) ;
}
static int T_5 F_151 ( void )
{
int V_7 ;
V_51 = F_16 ( 16 , V_30 ) ;
if ( ! V_51 )
