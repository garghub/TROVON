...
static void F_159 ( T_6 V_256 , unsigned long V_94 )
{
struct V_68 * V_69 = V_3 ;
if ( F_58 ( ! V_2 ) )
return;
if ( ! ( V_256 & V_257 ) )
return;
if ( ( V_69 -> V_94 & V_258 ) && ! ( V_256 & V_259 ) )
return;
if ( ! ( V_256 & V_260 ) )
return;
if ( F_6 ( F_160 ( V_94 ) ) )
...
static int F_163 ( struct V_68 * V_69 , struct V_7 * V_8 )
{
if ( ! V_8 -> V_197 ) {
if ( V_8 -> V_40 ) {
if ( V_69 -> V_170 )
...
if ( ! V_8 -> V_197 && ( V_69 -> V_271 & V_260 ) ) {
if ( V_8 -> V_40 ) {
if ( ! F_149 ( V_69 , V_8 , V_272 ) )
return 0 ;
} else {
...
static int F_164 ( struct V_68 * V_69 ,
struct V_7 * V_8 )
{
...
static inline int F_163 ( struct V_68 * V_69 ,
struct V_7 * V_8 )
{
return 1 ;
}
...
enum V_54 V_182 )
{
unsigned int V_274 = 1 << V_182 , V_5 = 1 ;
if ( F_64 ( F_9 ( V_110 ) -> V_57 & V_274 ) )
return 1 ;
if ( ! F_1 () )
return 0 ;
if ( F_58 ( F_9 ( V_110 ) -> V_57 & V_274 ) ) {
F_4 () ;
return 1 ;
}
F_9 ( V_110 ) -> V_57 |= V_274 ;
...
void F_166 ( struct V_64 * V_65 , const char * V_61 ,
struct V_92 * V_52 , int V_63 )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_105 ; V_13 ++ )
V_65 -> V_104 [ V_13 ] = NULL ;
#ifdef F_167
V_65 -> V_26 = F_168 () ;
#endif
if ( F_6 ( ! V_61 ) ) {
...
static int F_169 ( struct V_64 * V_65 , unsigned int V_63 ,
int V_197 , int V_40 , int V_216 , int V_266 ,
...
V_8 -> V_39 = F_10 () ;
#endif
if ( V_216 == 2 && ! F_163 ( V_69 , V_8 ) )
return 0 ;
if ( ! F_149 ( V_69 , V_8 , V_275 ) )
return 0 ;
V_218 = V_24 - V_10 ;
if ( F_6 ( V_218 >= V_97 ) )
return 0 ;
...
static int
F_171 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( ! F_8 () )
return 0 ;
...
static int F_172 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( F_58 ( ! V_2 ) )
return 0 ;
...
return 0 ;
if ( V_69 -> V_71 <= 0 )
return F_171 ( V_69 , V_65 , V_12 ) ;
return 1 ;
}
static int F_173 ( struct V_7 * V_8 , struct V_64 * V_65 )
{
if ( V_8 -> V_192 == V_65 )
return 1 ;
if ( V_8 -> V_276 ) {
...
static int
F_174 ( struct V_64 * V_65 , const char * V_61 ,
...
static int F_176 ( struct V_68 * V_69 ,
struct V_64 * V_65 , unsigned long V_12 )
{
struct V_7 * V_8 ;
unsigned int V_70 ;
V_70 = V_69 -> V_71 - 1 ;
V_8 = V_69 -> V_73 + V_70 ;
if ( V_8 -> V_192 != V_65 || V_8 -> V_276 )
return F_175 ( V_69 , V_65 , V_12 ) ;
V_69 -> V_71 -- ;
...
static void
F_177 ( struct V_64 * V_65 , int V_284 , unsigned long V_12 )
{
struct V_68 * V_69 = V_3 ;
if ( ! F_172 ( V_69 , V_65 , V_12 ) )
return;
if ( V_284 ) {
...
static int F_178 ( struct V_64 * V_65 )
{
struct V_68 * V_69 = V_3 ;
int V_13 ;
for ( V_13 = 0 ; V_13 < V_69 -> V_71 ; V_13 ++ ) {
...
static void F_162 ( unsigned long V_94 )
{
#if F_179 ( V_285 ) && F_179 ( F_57 ) && \
F_179 ( V_286 )
if ( ! V_2 )
return;
if ( F_160 ( V_94 ) ) {
...
void F_180 ( struct V_64 * V_65 , const char * V_61 ,
struct V_92 * V_52 , unsigned int V_63 ,
unsigned long V_12 )
{
unsigned long V_94 ;
...
V_3 -> V_4 = 1 ;
F_162 ( V_94 ) ;
if ( F_174 ( V_65 , V_61 , V_52 , V_63 , V_12 ) )
F_129 ( V_3 ) ;
V_3 -> V_4 = 0 ;
F_66 ( V_94 ) ;
}
void F_181 ( struct V_64 * V_65 , unsigned int V_63 ,
...
F_162 ( V_94 ) ;
V_3 -> V_4 = 1 ;
F_182 ( V_65 , V_63 , V_197 , V_40 , V_216 , V_193 , V_12 ) ;
F_169 ( V_65 , V_63 , V_197 , V_40 , V_216 ,
F_160 ( V_94 ) , V_193 , V_12 , 0 ) ;
V_3 -> V_4 = 0 ;
F_66 ( V_94 ) ;
}
void F_183 ( struct V_64 * V_65 , int V_284 ,
unsigned long V_12 )
{
unsigned long V_94 ;
if ( F_58 ( V_3 -> V_4 ) )
...
V_3 -> V_4 = 1 ;
F_184 ( V_65 , V_12 ) ;
F_177 ( V_65 , V_284 , V_12 ) ;
V_3 -> V_4 = 0 ;
F_66 ( V_94 ) ;
}
int F_185 ( struct V_64 * V_65 )
{
unsigned long V_94 ;
int V_5 = 0 ;
if ( F_58 ( V_3 -> V_4 ) )
...
static int
F_188 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( ! F_8 () )
return 0 ;
...
static void
F_189 ( struct V_64 * V_65 , unsigned long V_12 )
{
struct V_68 * V_69 = V_3 ;
struct V_7 * V_8 , * V_217 ;
struct V_23 * V_25 ;
...
static void
F_191 ( struct V_64 * V_65 , unsigned long V_12 )
{
struct V_68 * V_69 = V_3 ;
struct V_7 * V_8 , * V_217 ;
struct V_23 * V_25 ;
...
void F_193 ( struct V_64 * V_65 , unsigned long V_12 )
{
unsigned long V_94 ;
if ( F_58 ( ! V_38 ) )
return;
...
void F_195 ( struct V_64 * V_65 , unsigned long V_12 )
{
unsigned long V_94 ;
if ( F_58 ( ! V_38 ) )
return;
...
static void F_197 ( struct V_6 * V_24 )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_107 ; V_13 ++ ) {
if ( V_109 [ V_13 ] . V_24 == V_24 )
F_198 ( & V_109 [ V_13 ] . V_113 ) ;
}
F_198 ( & V_24 -> V_102 ) ;
F_198 ( & V_24 -> V_99 ) ;
V_24 -> V_52 = NULL ;
}
static inline int F_199 ( const void * V_82 , void * V_78 , unsigned long V_294 )
{
return V_82 >= V_78 && V_82 < V_78 + V_294 ;
}
void F_200 ( void * V_78 , unsigned long V_294 )
{
...
if ( F_85 ( V_111 ) )
continue;
F_201 (class, next, head, hash_entry) {
if ( F_199 ( V_24 -> V_52 , V_78 , V_294 ) )
F_197 ( V_24 ) ;
else if ( F_199 ( V_24 -> V_61 , V_78 , V_294 ) )
F_197 ( V_24 ) ;
}
}
if ( V_295 )
...
static void
F_204 ( struct V_68 * V_69 , const void * V_299 ,
...
static inline int F_205 ( const void * V_299 , unsigned long V_301 ,
const void * V_302 , unsigned long V_303 )
{
return V_302 + V_303 <= V_299 ||
V_299 + V_301 <= V_302 ;
}
void F_206 ( const void * V_299 , unsigned long V_301 )
{
struct V_68 * V_69 = V_3 ;
struct V_7 * V_8 ;
unsigned long V_94 ;
...
for ( V_13 = 0 ; V_13 < V_69 -> V_71 ; V_13 ++ ) {
V_8 = V_69 -> V_73 + V_13 ;
if ( F_205 ( V_299 , V_301 , V_8 -> V_192 ,
sizeof( * V_8 -> V_192 ) ) )
continue;
F_204 ( V_69 , V_299 , V_299 + V_301 , V_8 ) ;
break;
}
F_100 ( V_94 ) ;
}
static void F_207 ( struct V_68 * V_69 )
{
if ( ! F_8 () )
return;
if ( V_134 )
...
void F_217 ( const char * V_313 , const int line )
{
struct V_68 * V_69 = V_3 ;
#ifndef F_218
if ( ! F_8 () )
