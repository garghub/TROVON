inline T_1 F_1 ( const char * V_1 , T_1 V_2 )
{
if ( V_2 > 0 && V_1 [ V_2 - 1 ] == '\n' )
return V_2 - 1 ;
else
...
2000 ) ;
if ( V_5 < 0 )
F_6 ( & V_4 -> V_10 -> V_11 , L_5 , V_5 ) ;
}
static T_4 F_13 ( struct V_22 * V_11 ,
struct V_23 * V_24 , char * V_1 )
{
struct V_25 * V_8 = F_14 ( V_11 ) ;
struct V_3 * V_4 = F_15 ( V_8 ) ;
return snprintf ( V_1 , V_4 -> V_19 , L_6 , V_4 -> V_20 ) ;
}
