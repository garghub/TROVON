...
int
F_52 ( struct V_54 * V_55 , char * V_100 , char * * V_236 , T_6 V_237 , int V_8 , int V_238 )
{
#ifdef F_50
char * V_239 ;
char V_240 [ 128 ] ;
...
if ( V_238 ) {
V_100 [ V_8 ] = '\0' ;
for ( V_239 = V_100 ; * V_239 ; ) {
while ( ',' == * V_239 || ' ' == * V_239 )
++ V_239 ;
if ( ! strncmp ( V_239 , L_90 , 6 ) ) {
V_214 -> args = F_44 ( V_239 + 6 , & V_239 , 0 ) & V_231 ;
} else if ( ! strncmp ( V_239 , L_91 , 11 ) ) {
V_15 = F_44 ( V_239 + 11 , & V_239 , 0 ) ;
if ( V_15 < V_69 || V_15 > V_71 )
V_15 = V_221 ;
V_214 -> V_68 = V_15 ;
} else if ( ! strncmp ( V_239 , L_92 , 7 ) ) {
V_15 = F_44 ( V_239 + 7 , & V_239 , 0 ) ;
V_214 -> V_126 =
V_214 -> V_26 [ F_12 ( ( unsigned int ) V_15 ,
V_214 -> V_26 ) ] . V_27 ;
} else if ( ! strncmp ( V_239 , L_93 , 7 ) ) {
F_48 ( V_214 , ( int ) F_44 ( V_239 + 7 , & V_239 , 0 ) ) ;
} else if ( ! strncmp ( V_239 , L_94 , 5 ) ) {
V_214 -> V_223 = F_44 ( V_239 + 5 , & V_239 , 0 ) ;
} else if ( ! strncmp ( V_239 , L_95 , 6 ) ) {
V_214 -> V_91 = F_44 ( V_239 + 6 , & V_239 , 0 ) ;
} else if ( ! strncmp ( V_239 , L_96 , 7 ) ) {
V_214 -> V_80 = F_44 ( V_239 + 7 , & V_239 , 0 ) ;
} else if ( ! strncmp ( V_239 , L_97 , 6 ) ) {
V_214 -> V_95 =
F_53 ( V_239 + 6 , & V_239 , 0 ) ? V_232 : V_233 ;
} else if ( ! strncmp ( V_239 , L_98 , 5 ) ) {
V_15 = ! ! F_53 ( V_239 + 5 , & V_239 , 0 ) ;
if ( V_15 != V_214 -> V_29 )
F_48 ( V_214 , 0xff ) ;
V_214 -> V_29 = V_15 ;
} else if ( ! strncmp ( V_239 , L_99 , 7 ) ) {
V_15 = F_44 ( V_239 + 7 , & V_239 , 0 ) ;
...
sprintf ( V_240 , L_104 , V_214 -> V_79 [ V_15 ] ) ;
strcat ( V_239 , V_240 ) ;
}
strcat ( V_239 , L_105 ) ;
for ( V_15 = 0 ; V_15 < 7 ; V_15 ++ ) {
sprintf ( V_240 , L_104 , V_214 -> V_82 [ V_15 ] ) ;
strcat ( V_239 , V_240 ) ;
}
}
#ifdef F_25
...
strcat ( V_239 , L_106 ) ;
for ( V_15 = 0 ; V_15 < 7 ; V_15 ++ ) {
sprintf ( V_240 , L_107 , V_214 -> V_62 [ V_15 ] ) ;
strcat ( V_239 , V_240 ) ;
}
strcat ( V_239 , L_108 ) ;
for ( V_15 = 0 ; V_15 < 7 ; V_15 ++ ) {
sprintf ( V_240 , L_107 , V_214 -> V_74 [ V_15 ] ) ;
strcat ( V_239 , V_240 ) ;
}
strcat ( V_239 , L_109 ) ;
for ( V_15 = 0 ; V_15 < 7 ; V_15 ++ ) {
sprintf ( V_240 , L_107 , V_214 -> V_159 [ V_15 ] ) ;
strcat ( V_239 , V_240 ) ;
}
sprintf ( V_240 ,
L_110 ,
