...
T_1 V_25 [ V_18 ] ;
do {
memcpy ( V_25 , V_20 , V_18 ) ;
F_13 ( V_24 , V_20 , V_18 ) ;
F_10 ( F_14 ( V_16 ) , V_20 , V_24 ) ;
memcpy ( V_24 , V_25 , V_18 ) ;
F_13 ( V_24 , V_20 , V_18 ) ;
V_20 += V_18 ;
} while ( ( V_19 -= V_18 ) >= V_18 );
...
struct V_26 * V_23 , struct V_26 * V_20 ,
unsigned int V_19 )
{
struct V_14 V_15 ;
struct V_27 * V_16 = V_13 -> V_16 ;
...
V_30 -> V_38 . V_47 = & V_48 ;
V_30 -> V_38 . V_46 |= F_37 ( V_49 ) - 1 ;
V_30 -> V_38 . V_50 . V_51 = V_38 -> V_45 ;
V_30 -> V_38 . V_50 . V_52 = V_38 -> V_53 . V_54 ;
V_30 -> V_38 . V_50 . V_55 = V_38 -> V_53 . V_56 ;
V_30 -> V_38 . V_57 = sizeof( struct V_5 ) ;
V_30 -> V_38 . V_58 = F_24 ;
V_30 -> V_38 . V_59 = F_29 ;
V_30 -> V_38 . V_50 . V_60 = F_1 ;
V_30 -> V_38 . V_50 . V_61 = F_16 ;
V_30 -> V_38 . V_50 . V_62 = F_23 ;
V_42:
F_38 ( V_38 ) ;
return V_30 ;
}
