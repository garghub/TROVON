...
static int F_83 ( struct V_90 * V_69 )
{
struct V_1 * V_2 = F_43 ( V_69 ) ;
struct V_91 * V_92 = V_69 -> V_92 ;
struct V_66 * V_63 ;
...
if ( V_193 )
* V_193 = NULL ;
if ( ( V_116 = F_94 ( V_2 -> V_111 , L_2 , V_191 , 32 , 1 , & V_51 ) ) < 0 )
return V_116 ;
V_51 -> V_16 = V_2 ;
F_95 ( V_51 , V_194 , & V_195 ) ;
F_95 ( V_51 , V_196 , & V_197 ) ;
V_51 -> V_198 = 0 ;
...
int T_4 F_97 ( struct V_1 * V_2 , int V_191 , struct V_192 * * V_193 )
{
struct V_192 * V_51 ;
int V_116 ;
if ( V_193 )
* V_193 = NULL ;
if ( ( V_116 = F_94 ( V_2 -> V_111 , L_3 , V_191 , 0 , 1 , & V_51 ) ) < 0 )
return V_116 ;
V_51 -> V_16 = V_2 ;
F_95 ( V_51 , V_196 , & V_200 ) ;
V_51 -> V_198 = 0 ;
...
if ( V_193 )
* V_193 = NULL ;
if ( ( V_116 = F_94 ( V_2 -> V_111 , L_7 , V_191 , 1 , 0 , & V_51 ) ) < 0 )
return V_116 ;
V_51 -> V_16 = V_2 ;
F_95 ( V_51 , V_194 , & V_202 ) ;
V_51 -> V_198 = 0 ;
...
if ( V_193 )
* V_193 = NULL ;
if ( ( V_116 = F_94 ( V_2 -> V_111 , L_8 , V_191 , 1 , 0 , & V_51 ) ) < 0 )
return V_116 ;
V_51 -> V_16 = V_2 ;
F_95 ( V_51 , V_194 , & V_204 ) ;
V_51 -> V_198 = 0 ;
...
static int F_100 ( struct V_96 * V_206 , struct V_207 * V_208 )
{
V_208 -> type = V_209 ;
V_208 -> V_210 = 1 ;
return 0 ;
}
static int F_101 ( struct V_96 * V_206 ,
struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_103 ( struct V_96 * V_206 ,
struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
unsigned int V_5 ;
...
static int F_104 ( struct V_96 * V_206 , struct V_207 * V_208 )
{
V_208 -> type = V_209 ;
V_208 -> V_210 = 1 ;
return 0 ;
}
static int F_105 ( struct V_96 * V_206 ,
struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_106 ( struct V_96 * V_206 , struct V_207 * V_208 )
{
V_208 -> type = V_209 ;
V_208 -> V_210 = 1 ;
return 0 ;
}
static int F_107 ( struct V_96 * V_206 ,
struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_109 ( struct V_96 * V_206 , struct V_207 * V_217 )
{
static const char * const V_218 [ 3 ] = { L_6 , L_10 , L_11 } ;
return F_110 ( V_217 , 1 , 3 , V_218 ) ;
}
static int F_111 ( struct V_96 * V_206 , struct V_211 * V_213 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
T_3 V_8 ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_113 ( struct V_96 * V_206 ,
struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
...
static int F_115 ( struct V_96 * V_206 , struct V_207 * V_208 )
{
...
static int F_116 ( struct V_96 * V_206 , struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
unsigned int V_8 = V_206 -> V_223 ;
...
static int F_118 ( struct V_96 * V_206 ,
struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
...
static int F_119 ( struct V_96 * V_206 , struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
...
static int F_121 ( struct V_1 * V_2 , int V_237 )
{
T_3 V_8 , V_164 ;
unsigned long V_29 ;
F_24 ( & V_2 -> V_30 , V_29 ) ;
...
static int F_122 ( struct V_1 * V_2 , int V_237 , int V_241 )
{
T_3 V_8 ;
unsigned long V_29 ;
F_24 ( & V_2 -> V_30 , V_29 ) ;
...
static int F_123 ( struct V_96 * V_206 , struct V_211 * V_212 )
{
struct V_1 * V_2 = F_102 ( V_206 ) ;
int V_237 = ( int ) V_206 -> V_223 ;
V_212 -> V_213 . integer . V_213 [ 0 ] = F_121 ( V_2 , V_237 ) ;
return 0 ;
}
...
struct V_1 * V_2 = F_102 ( V_206 ) ;
int V_237 = ( int ) V_206 -> V_223 ;
if ( F_121 ( V_2 , V_237 ) != V_212 -> V_213 . integer . V_213 [ 0 ] ) {
F_122 ( V_2 , V_237 , ! ! V_212 -> V_213 . integer . V_213 [ 0 ] ) ;
V_212 -> V_213 . integer . V_213 [ 0 ] = F_121 ( V_2 , V_237 ) ;
return 1 ;
}
return 0 ;
}
static int F_125 ( struct V_96 * V_206 ,
struct V_207 * V_208 )
{
V_208 -> type = V_227 ;
V_208 -> V_210 = 2 ;
...
static void F_128 ( struct V_244 * V_245 )
{
...
int T_4 F_130 ( struct V_1 * V_2 , int V_247 )
{
struct V_248 V_15 ;
struct V_96 * V_97 ;
struct V_90 * V_69 ;
...
return V_116 ;
V_2 -> V_246 -> V_176 = F_128 ;
V_2 -> V_246 -> V_253 = 1 ;
memset ( & V_15 , 0 , sizeof( V_15 ) ) ;
V_15 . V_16 = V_2 ;
V_15 . V_176 = F_129 ;
if ( ( V_116 = F_131 ( V_2 -> V_246 , & V_15 , & V_2 -> V_15 ) ) < 0 )
return V_116 ;
F_132 ( V_2 -> V_15 , V_254 ,
V_255 | V_256 , 0 ) ;
for ( V_46 = 0 ; V_46 < F_133 ( V_257 ) ; V_46 ++ ) {
if ( ( V_116 = F_134 ( V_2 -> V_111 , F_135 ( & V_257 [ V_46 ] , V_2 ) ) ) < 0 )
return V_116 ;
}
if ( F_32 ( ! V_2 -> V_203 ) )
return - V_258 ;
if ( ( V_116 = F_134 ( V_2 -> V_111 , V_97 = F_135 ( & V_259 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_203 -> V_191 ;
if ( ( V_116 = F_134 ( V_2 -> V_111 , V_97 = F_135 ( & V_260 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_203 -> V_191 ;
if ( ( V_116 = F_134 ( V_2 -> V_111 , V_97 = F_135 ( & V_261 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_203 -> V_191 ;
V_2 -> V_187 = V_97 ;
if ( V_2 -> V_22 == V_128 &&
( V_116 = F_134 ( V_2 -> V_111 , V_97 = F_135 ( & V_262 , V_2 ) ) ) < 0 )
return V_116 ;
if ( V_247 ) {
if ( ( V_116 = F_134 ( V_2 -> V_111 , F_135 ( & V_263 , V_2 ) ) ) < 0 )
return V_116 ;
}
V_69 = V_2 -> V_51 -> V_264 [ V_194 ] . V_69 ;
for ( V_46 = 0 ; V_46 < 32 ; ++ V_46 ) {
V_97 = F_135 ( & V_265 , V_2 ) ;
if ( ! V_97 )
return - V_56 ;
V_97 -> V_113 . V_191 = V_2 -> V_51 -> V_191 ;
V_97 -> V_113 . V_243 = V_46 ;
V_97 -> V_223 = ( unsigned long ) V_69 ;
if ( ( V_116 = F_134 ( V_2 -> V_111 , V_97 ) ) < 0 )
return V_116 ;
...
static int F_136 ( struct V_267 * V_168 )
{
struct V_1 * V_2 ;
unsigned long V_29 ;
unsigned int V_210 ;
...
static int F_138 ( struct V_267 * V_168 )
{
struct V_1 * V_2 ;
unsigned long V_29 ;
V_2 = F_137 ( V_168 ) ;
...
int T_4 F_140 ( struct V_1 * V_2 , int V_191 )
{
...
V_274 . V_191 = V_191 ;
V_274 . V_243 = 0 ;
if ( ( V_116 = F_141 ( V_2 -> V_111 , L_2 , & V_274 , & V_168 ) ) >= 0 ) {
...
F_143 ( V_283 , L_14 , V_25 , F_9 ( V_2 , V_25 ) ) ;
}
static int T_4 F_144 ( struct V_285 * V_111 , struct V_1 * V_2 )
{
struct V_280 * V_281 ;
if ( ! F_145 ( V_111 , L_15 , & V_281 ) )
F_146 ( V_281 , V_2 , F_142 ) ;
return 0 ;
}
static void F_147 ( struct V_286 * V_143 )
{
T_1 V_17 ;
F_148 ( V_143 , V_287 , & V_17 ) ;
#if 0
if (cmd & 0x03) {
#endif
F_149 ( V_143 , V_287 , V_17 & 0xfc ) ;
F_149 ( V_143 , V_287 , V_17 | 0x03 ) ;
F_149 ( V_143 , V_287 , V_17 & 0xfc ) ;
F_150 ( V_143 , V_288 , 0 ) ;
F_150 ( V_143 , V_289 , 0 ) ;
#if 0
...
static int T_4 F_156 ( struct V_1 * V_2 )
{
long V_294 , V_308 ;
int V_44 , V_71 , V_8 ;
T_1 * V_309 ;
...
V_2 -> V_317 = V_318 ;
V_294 = F_157 ( V_308 , 0x100 ) +
F_157 ( V_2 -> V_311 * 2 * V_47 , 0x100 ) +
F_157 ( V_2 -> V_313 * 2 * V_165 , 0x100 ) +
F_157 ( V_2 -> V_315 * 2 * V_319 , 0x100 ) +
V_2 -> V_317 ;
if ( F_50 ( V_142 , F_51 ( V_2 -> V_143 ) ,
V_294 , & V_2 -> V_320 ) < 0 )
return - V_56 ;
...
V_309 += F_157 ( V_308 , 0x100 ) ;
V_310 += F_157 ( V_308 , 0x100 ) ;
...
V_309 = ( char * ) F_157 ( ( unsigned long ) V_309 , 0x100 ) ;
V_310 = F_157 ( V_310 , 0x100 ) ;
V_2 -> V_324 = V_309 ;
V_2 -> V_325 = V_310 ;
...
F_55 ( & V_2 -> V_320 ) ;
F_162 ( V_2 -> V_340 ) ;
F_150 ( V_2 -> V_143 , 0x40 , V_2 -> V_344 ) ;
F_165 ( V_2 -> V_143 ) ;
F_166 ( V_2 -> V_292 ) ;
F_166 ( V_2 -> V_298 ) ;
F_77 ( V_2 ) ;
...
static int F_167 ( struct V_345 * V_191 )
{
struct V_1 * V_2 = V_191 -> V_346 ;
return F_158 ( V_2 ) ;
}
int F_168 ( struct V_286 * V_143 , T_10 V_347 )
{
struct V_285 * V_111 = F_169 ( V_143 ) ;
...
F_165 ( V_143 ) ;
F_173 ( V_143 ) ;
F_174 ( V_143 , F_175 ( V_143 , V_347 ) ) ;
return 0 ;
}
int F_176 ( struct V_286 * V_143 )
{
struct V_285 * V_111 = F_169 ( V_143 ) ;
struct V_1 * V_2 = V_111 -> V_16 ;
unsigned int V_25 ;
...
int T_4 F_184 ( struct V_285 * V_111 ,
struct V_286 * V_143 ,
...
* V_355 = NULL ;
if ( ( V_116 = F_178 ( V_143 ) ) < 0 )
return V_116 ;
V_2 = F_79 ( sizeof( * V_2 ) , V_172 ) ;
if ( V_2 == NULL ) {
F_165 ( V_143 ) ;
return - V_56 ;
}
...
V_2 -> V_359 = F_187 ( V_143 , 0 ) ;
V_2 -> V_4 = F_188 ( V_2 -> V_359 , 0x8000 ) ;
F_181 ( V_143 ) ;
V_2 -> V_62 = - 1 ;
if ( ( V_2 -> V_340 = F_189 ( V_2 -> V_359 , 0x8000 , L_2 ) ) == NULL ) {
F_17 ( V_12 L_24 , V_2 -> V_359 , V_2 -> V_359 + 0x8000 - 1 ) ;
F_158 ( V_2 ) ;
return - V_13 ;
}
if ( F_190 ( V_143 -> V_161 , F_73 , V_360 ,
L_2 , V_2 ) ) {
...
#ifdef F_159
V_2 -> V_341 = F_191 ( V_349 * sizeof( T_2 ) ) ;
if ( V_2 -> V_341 == NULL ) {
F_158 ( V_2 ) ;
return - V_56 ;
}
#endif
if ( ( V_116 = F_192 ( V_111 , V_361 , V_2 , & V_250 ) ) < 0 ) {
F_158 ( V_2 ) ;
return V_116 ;
}
F_144 ( V_111 , V_2 ) ;
F_193 ( V_111 , & V_143 -> V_293 ) ;
* V_355 = V_2 ;
return 0 ;
}
