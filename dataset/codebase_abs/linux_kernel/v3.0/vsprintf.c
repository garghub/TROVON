...
{
if ( V_1 [ 0 ] == '0' ) {
if ( TOLOWER ( V_1 [ 1 ] ) == 'x' && isxdigit ( V_1 [ 2 ] ) )
return 16 ;
else
return 8 ;
} else {
...
unsigned long long F_2 ( const char * V_1 , char * * V_2 , unsigned int V_3 )
{
unsigned long long V_4 = 0 ;
if ( ! V_3 )
V_3 = F_1 ( V_1 ) ;
if ( V_3 == 16 && V_1 [ 0 ] == '0' && TOLOWER ( V_1 [ 1 ] ) == 'x' )
V_1 += 2 ;
while ( isxdigit ( * V_1 ) ) {
unsigned int V_5 ;
V_5 = isdigit ( * V_1 ) ? * V_1 - '0' : TOLOWER ( * V_1 ) - 'a' + 10 ;
if ( V_5 >= V_3 )
break;
V_4 = V_4 * V_3 + V_5 ;
V_1 ++ ;
...
unsigned long F_3 ( const char * V_1 , char * * V_2 , unsigned int V_3 )
{
return F_2 ( V_1 , V_2 , V_3 ) ;
}
long F_4 ( const char * V_1 , char * * V_2 , unsigned int V_3 )
{
if ( * V_1 == '-' )
return - F_3 ( V_1 + 1 , V_2 , V_3 ) ;
return F_3 ( V_1 , V_2 , V_3 ) ;
}
long long F_5 ( const char * V_1 , char * * V_2 , unsigned int V_3 )
{
if ( * V_1 == '-' )
return - F_2 ( V_1 + 1 , V_2 , V_3 ) ;
return F_2 ( V_1 , V_2 , V_3 ) ;
}
static T_1
int F_6 ( const char * * V_6 )
{
int V_7 = 0 ;
while ( isdigit ( * * V_6 ) )
V_7 = V_7 * 10 + * ( ( * V_6 ) ++ ) - '0' ;
...
static T_1
char * F_7 ( char * V_8 , unsigned V_9 )
{
...
static T_1
char * F_9 ( char * V_8 , unsigned long long V_14 )
{
while ( 1 ) {
unsigned V_15 ;
if ( V_14 < 100000 )
return F_7 ( V_8 , V_14 ) ;
V_15 = F_10 ( V_14 , 100000 ) ;
V_8 = F_8 ( V_8 , V_15 ) ;
}
}
static T_1
char * F_11 ( char * V_8 , char * V_16 , unsigned long long V_14 ,
struct V_17 V_18 )
{
...
static T_1
char * F_13 ( char * V_8 , char * V_16 , void * V_39 ,
...
F_17 ( V_5 , NULL , NULL , NULL , V_41 ) ;
return string ( V_8 , V_16 , V_41 , V_18 ) ;
#else
V_18 . V_30 = 2 * sizeof( void * ) ;
V_18 . V_24 |= V_25 | V_26 | V_28 ;
V_18 . V_3 = 16 ;
return F_11 ( V_8 , V_16 , V_5 , V_18 ) ;
#endif
}
static T_1
char * F_18 ( char * V_8 , char * V_16 , struct V_43 * V_44 ,
...
#define F_21 ((2 * sizeof(resource_size_t)) + 4)
#define F_22 (2 * sizeof(res->flags))
#define F_23 sizeof("[mem - 64bit pref window disabled]")
#define F_24 sizeof("[mem - flags 0x]")
char V_41 [ F_25 ( 2 * F_21 + F_23 ,
2 * F_21 + F_22 + F_24 ) ] ;
...
V_52 = F_11 ( V_52 , V_53 , V_44 -> V_61 , * V_55 ) ;
if ( V_44 -> V_61 != V_44 -> V_16 ) {
* V_52 ++ = '-' ;
V_52 = F_11 ( V_52 , V_53 , V_44 -> V_16 , * V_55 ) ;
}
if ( V_54 ) {
if ( V_44 -> V_24 & V_62 )
...
V_52 = F_11 ( V_52 , V_53 , V_44 -> V_24 , V_51 ) ;
}
* V_52 ++ = ']' ;
* V_52 = '\0' ;
return string ( V_8 , V_16 , V_41 , V_18 ) ;
...
static T_1
char * F_26 ( char * V_8 , char * V_16 , T_2 * V_66 ,
struct V_17 V_18 , const char * V_45 )
{
...
static T_1
char * F_28 ( char * V_52 , const T_2 * V_66 , const char * V_45 )
{
int V_7 ;
bool V_69 = ( V_45 [ 0 ] == 'i' ) ;
int V_70 ;
...
for ( V_7 = 0 ; V_7 < 4 ; V_7 ++ ) {
char V_72 [ 3 ] ;
int V_19 = F_7 ( V_72 , V_66 [ V_70 ] ) - V_72 ;
if ( V_69 ) {
if ( V_19 < 3 )
* V_52 ++ = '0' ;
if ( V_19 < 2 )
...
static T_1
char * F_30 ( char * V_52 , const char * V_66 )
{
int V_7 , V_73 , V_74 ;
...
if ( V_81 )
* V_52 ++ = ':' ;
V_52 = F_28 ( V_52 , & V_84 . V_86 [ 12 ] , L_15 ) ;
}
* V_52 = '\0' ;
return V_52 ;
}
static T_1
char * F_35 ( char * V_52 , const char * V_66 , const char * V_45 )
{
int V_7 ;
for ( V_7 = 0 ; V_7 < 8 ; V_7 ++ ) {
V_52 = F_27 ( V_52 , * V_66 ++ ) ;
...
static T_1
char * F_36 ( char * V_8 , char * V_16 , const T_2 * V_66 ,
struct V_17 V_18 , const char * V_45 )
{
...
static T_1
char * F_39 ( const char * V_45 , char * V_8 , char * V_16 , void * V_39 ,
struct V_17 V_18 )
{
if ( ! V_39 && * V_45 != 'K' ) {
if ( V_18 . V_30 == - 1 )
...
case 's' :
case 'B' :
return F_13 ( V_8 , V_16 , V_39 , V_18 , * V_45 ) ;
case 'R' :
case 'r' :
return F_18 ( V_8 , V_16 , V_39 , V_18 , V_45 ) ;
case 'M' :
case 'm' :
return F_26 ( V_8 , V_16 , V_39 , V_18 , V_45 ) ;
case 'I' :
case 'i' :
switch ( V_45 [ 1 ] ) {
case '6' :
return F_36 ( V_8 , V_16 , V_39 , V_18 , V_45 ) ;
case '4' :
...
V_18 . V_3 = 16 ;
return F_11 ( V_8 , V_16 , ( unsigned long ) V_39 , V_18 ) ;
}
static T_1
int F_45 ( const char * V_45 , struct V_17 * V_18 )
{
...
V_101:
V_18 -> V_101 = - 1 ;
if ( * V_45 == 'h' || TOLOWER ( * V_45 ) == 'l' ||
TOLOWER ( * V_45 ) == 'z' || * V_45 == 't' ) {
V_18 -> V_101 = * V_45 ++ ;
if ( F_46 ( V_18 -> V_101 == * V_45 ) ) {
if ( V_18 -> V_101 == 'l' ) {
V_18 -> V_101 = 'L' ;
++ V_45 ;
...
break;
case V_105 :
V_121 = F_39 ( V_45 + 1 , V_121 , V_16 , va_arg ( args , void * ) ,
V_18 ) ;
while ( isalnum ( * V_45 ) )
V_45 ++ ;
break;
...
V_121 = F_11 ( V_121 , V_16 , V_14 , V_18 ) ;
}
}
if ( V_120 > 0 ) {
if ( V_121 < V_16 )
...
int F_48 ( char * V_8 , T_4 V_120 , const char * V_45 , T_5 args )
{
int V_7 ;
...
int F_50 ( char * V_8 , T_4 V_120 , const char * V_45 , ... )
{
T_5 args ;
int V_7 ;
va_start ( args , V_45 ) ;
V_7 = F_48 ( V_8 , V_120 , V_45 , args ) ;
va_end ( args ) ;
return V_7 ;
}
...
int F_51 ( T_6 * V_128 , T_4 V_120 , const char * V_45 , T_5 args )
{
struct V_17 V_18 = { 0 } ;
char * V_121 , * V_16 ;
V_121 = ( char * ) V_128 ;
...
return ( T_6 * ) ( F_53 ( V_121 , sizeof( T_6 ) ) ) - V_128 ;
#undef F_52
}
int F_54 ( char * V_8 , T_4 V_120 , const char * V_45 , const T_6 * V_128 )
{
struct V_17 V_18 = { 0 } ;
char * V_121 , * V_16 ;
...
case V_105 :
V_121 = F_39 ( V_45 + 1 , V_121 , V_16 , F_55 ( void * ) , V_18 ) ;
while ( isalnum ( * V_45 ) )
V_45 ++ ;
break;
case V_107 :
...
break;
case V_115 :
V_14 = F_55 (unsigned char) ;
break;
case V_114 :
V_14 = F_55 (signed char) ;
break;
case V_117 :
V_14 = F_55 (unsigned short) ;
break;
case V_116 :
V_14 = F_55 ( short ) ;
break;
case V_119 :
V_14 = F_55 (unsigned int) ;
break;
default:
V_14 = F_55 ( int ) ;
}
...
int F_56 ( T_6 * V_128 , T_4 V_120 , const char * V_45 , ... )
{
T_5 args ;
int V_132 ;
va_start ( args , V_45 ) ;
V_132 = F_51 ( V_128 , V_120 , V_45 , args ) ;
va_end ( args ) ;
return V_132 ;
}
...
* V_6 = ( T_4 ) F_3 ( V_121 , & V_133 , V_3 ) ;
}
break;
default:
if ( V_135 ) {
int * V_7 = ( int * ) va_arg ( args , int * ) ;
* V_7 = ( int ) F_4 ( V_121 , & V_133 , V_3 ) ;
} else {
unsigned int * V_7 = ( unsigned int * ) va_arg (args, unsigned int*) ;
* V_7 = ( unsigned int ) F_3 ( V_121 , & V_133 , V_3 ) ;
}
break;
}
V_14 ++ ;
