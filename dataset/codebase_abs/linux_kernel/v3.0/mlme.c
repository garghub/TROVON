...
if ( V_6 -> V_21 [ V_14 ] &&
memcmp ( V_6 -> V_21 [ V_14 ] -> V_22 . V_13 , V_13 , V_23 ) == 0 ) {
F_5 ( V_6 -> V_21 [ V_14 ] ) ;
F_6 ( & V_6 -> V_21 [ V_14 ] -> V_22 ) ;
V_6 -> V_21 [ V_14 ] = NULL ;
V_38 = true ;
...
if ( V_6 -> V_35 == V_41 && V_39 ) {
T_3 V_42 ;
bool V_43 ;
V_42 = F_3 ( V_12 -> V_16 . V_44 . V_42 ) ;
V_43 = memcmp ( V_12 -> V_45 , V_2 -> V_46 , V_23 ) != 0 ;
F_20 ( V_2 , NULL , 0 , V_42 , V_43 ) ;
...
if ( ! V_74 . V_32 )
return - V_92 ;
return V_10 -> V_84 -> V_44 ( & V_10 -> V_8 , V_2 , & V_74 , V_6 ) ;
}
...
if ( V_6 -> V_40 ) {
V_74 . V_32 = & V_6 -> V_40 -> V_22 ;
V_10 -> V_84 -> V_44 ( & V_10 -> V_8 , V_2 , & V_74 , V_6 ) ;
if ( V_6 -> V_40 ) {
F_5 ( V_6 -> V_40 ) ;
F_6 ( & V_6 -> V_40 -> V_22 ) ;
V_6 -> V_40 = NULL ;
...
const T_1 * V_3 , T_2 V_4 , T_5 * V_98 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
...
if ( ! F_77 ( V_12 -> V_135 ) )
return - V_79 ;
V_133 = F_3 ( V_12 -> V_135 ) & V_117 ;
if ( ! ( V_6 -> V_8 -> V_113 [ V_6 -> V_118 ] . V_136 & F_64 ( V_133 >> 4 ) ) )
return - V_79 ;
if ( F_78 ( V_12 -> V_135 ) &&
V_12 -> V_16 . V_137 . V_138 != V_139 ) {
int V_75 = 0 ;
F_4 ( V_6 ) ;
switch ( V_6 -> V_118 ) {
case V_140 :
...
case V_145 :
case V_146 :
if ( memcmp ( V_12 -> V_13 , V_2 -> V_46 , V_23 ) )
V_75 = - V_79 ;
break;
case V_147 :
if ( memcmp ( V_12 -> V_45 , V_12 -> V_13 , V_23 ) ) {
V_75 = - V_79 ;
break;
}
break;
...
if ( memcmp ( V_12 -> V_45 , V_2 -> V_46 , V_23 ) != 0 )
return - V_79 ;
return V_10 -> V_84 -> V_134 ( & V_10 -> V_8 , V_2 , V_63 , V_130 ,
V_100 , V_131 ,
V_132 , V_3 , V_4 , V_98 ) ;
}
bool F_79 ( struct V_1 * V_2 , int V_148 , const T_1 * V_3 ,
T_2 V_4 , T_4 V_55 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
...
int V_151 ;
bool V_152 = false ;
T_7 V_153 = V_12 -> V_135 &
F_69 ( V_115 | V_117 ) ;
T_3 V_133 ;
V_133 = ( F_3 ( V_12 -> V_135 ) & V_117 ) >> 4 ;
if ( ! ( V_150 -> V_119 & F_64 ( V_133 ) ) )
return false ;
V_59 = V_3 + F_80 ( V_12 -> V_135 ) ;
V_151 = V_4 - F_80 ( V_12 -> V_135 ) ;
F_66 ( & V_6 -> V_121 ) ;
F_67 (reg, &wdev->mgmt_registrations, list) {
if ( V_110 -> V_106 != V_153 )
continue;
if ( V_110 -> V_108 > V_151 )
continue;
if ( memcmp ( V_110 -> V_123 , V_59 , V_110 -> V_108 ) )
continue;
if ( F_81 ( V_10 , V_2 , V_110 -> V_124 , V_148 ,
V_3 , V_4 , V_55 ) )
continue;
V_152 = true ;
break;
...
const T_1 * V_3 , T_2 V_4 , bool V_154 , T_4 V_55 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_83 ( V_10 , V_2 , V_98 , V_3 , V_4 , V_154 , V_55 ) ;
}
...
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_85 ( V_10 , V_2 , V_156 , V_55 ) ;
}
void F_86 ( struct V_1 * V_2 ,
const T_1 * V_157 , T_6 V_158 , T_4 V_55 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_87 ( V_10 , V_2 , V_157 , V_158 , V_55 ) ;
}
