...
{
struct V_187 * V_48 =
(struct V_187 * ) V_184 -> V_15 ;
struct V_66 * V_67 = F_4 ( V_12 ) ;
struct V_188 const * V_189 = V_67 -> V_21 -> V_188 ;
unsigned long V_190 ;
T_1 V_191 = V_48 -> V_191 ;
memset ( V_184 -> V_15 , 0 , sizeof( V_184 -> V_15 ) ) ;
V_48 -> V_191 = V_191 ;
if ( V_184 -> V_13 != 0 ||
( V_191 != V_17 && V_191 != 0xFF ) )
V_184 -> V_7 |= V_14 ;
if ( V_189 -> V_192 )
V_48 -> V_193 = V_67 -> V_21 -> V_100 - 1 ;
else
V_48 -> V_193 = 250 ;
V_48 -> V_194 = 4 ;
V_48 -> V_195 = V_196 ;
F_43 ( & V_67 -> V_197 , V_190 ) ;
if ( V_189 -> V_192 )
V_48 -> V_198 = F_44 ( V_67 -> V_21 , V_189 -> V_192 ) ;
else
V_48 -> V_198 = V_67 -> V_199 ;
V_48 -> V_200 = F_7 ( V_67 -> V_201 ) ;
V_48 -> V_202 = F_7 ( V_67 -> V_203 ) ;
V_48 -> V_204 = F_5 ( V_67 -> V_205 ) ;
V_48 -> V_206 [ 0 ] = V_67 -> V_207 [ 0 ] ;
V_48 -> V_206 [ 1 ] = V_67 -> V_207 [ 1 ] ;
V_48 -> V_206 [ 2 ] = V_67 -> V_207 [ 2 ] ;
V_48 -> V_206 [ 3 ] = V_67 -> V_207 [ 3 ] ;
V_48 -> V_206 [ 4 ] = V_67 -> V_207 [ 4 ] ;
F_45 ( & V_67 -> V_197 , V_190 ) ;
return F_1 ( (struct V_1 * ) V_184 ) ;
}
...
int V_73 ;
if ( V_184 -> V_13 != 0 ||
( V_48 -> V_191 != V_17 && V_48 -> V_191 != 0xFF ) ) {
V_184 -> V_7 |= V_14 ;
...
F_43 ( & V_67 -> V_197 , V_190 ) ;
if ( V_189 -> V_192 )
V_7 = F_44 ( V_67 -> V_21 , V_189 -> V_192 ) ;
else
V_7 = V_67 -> V_199 ;
if ( V_7 == V_208 ) {
V_67 -> V_201 = F_9 ( V_48 -> V_200 ) ;
V_67 -> V_203 = F_9 ( V_48 -> V_202 ) ;
V_67 -> V_205 = F_26 ( V_48 -> V_204 ) ;
V_67 -> V_207 [ 0 ] = V_48 -> V_206 [ 0 ] ;
V_67 -> V_207 [ 1 ] = V_48 -> V_206 [ 1 ] ;
V_67 -> V_207 [ 2 ] = V_48 -> V_206 [ 2 ] ;
V_67 -> V_207 [ 3 ] = V_48 -> V_206 [ 3 ] ;
V_67 -> V_207 [ 4 ] = V_48 -> V_206 [ 4 ] ;
if ( V_189 -> V_192 ) {
F_47 ( V_67 -> V_21 , V_189 -> V_209 ,
V_67 -> V_203 ) ;
F_47 ( V_67 -> V_21 , V_189 -> V_210 ,
V_67 -> V_201 ) ;
} else
V_67 -> V_199 = V_211 ;
}
...
case V_213 :
V_73 = ( V_189 -> V_214 ) ?
F_44 ( V_67 -> V_21 , V_189 -> V_214 ) :
V_67 -> V_215 ;
break;
case V_216 :
V_73 = ( V_189 -> V_217 ) ?
F_44 ( V_67 -> V_21 , V_189 -> V_217 ) :
V_67 -> V_218 ;
break;
case V_219 :
V_73 = ( V_189 -> V_220 ) ?
F_44 ( V_67 -> V_21 , V_189 -> V_220 ) :
V_67 -> V_221 ;
break;
case V_222 :
V_73 = ( V_189 -> V_223 ) ?
F_44 ( V_67 -> V_21 , V_189 -> V_223 ) :
V_67 -> V_224 ;
break;
case V_225 :
V_73 = ( V_189 -> V_226 ) ?
F_44 ( V_67 -> V_21 , V_189 -> V_226 ) :
V_67 -> V_227 ;
break;
default:
V_73 = 0 ;
...
V_7 = V_67 -> V_199 ;
V_48 -> V_198 = F_5 ( V_7 ) ;
for ( V_135 = 0 ; V_135 < F_33 ( V_67 -> V_207 ) ; V_135 ++ )
V_48 -> V_229 [ V_135 ] = ( V_7 != V_208 ) ? 0 :
F_7 (
F_48 ( V_67 , V_189 , V_67 -> V_207 [ V_135 ] ) ) ;
return F_1 ( (struct V_1 * ) V_184 ) ;
}
...
struct V_11 * V_12 , T_1 V_17 )
{
struct V_232 * V_48 = (struct V_232 * )
V_184 -> V_15 ;
struct V_66 * V_67 = F_4 ( V_12 ) ;
struct V_233 V_234 ;
T_1 V_191 = V_48 -> V_191 ;
F_53 ( V_67 -> V_21 , & V_234 ) ;
V_234 . V_235 -= V_67 -> V_236 ;
V_234 . V_237 -=
V_67 -> V_238 ;
V_234 . V_239 -= V_67 -> V_240 ;
V_234 . V_241 += V_67 -> V_242 ;
V_234 . V_241 -= V_67 -> V_243 ;
V_234 . V_244 -= V_67 -> V_245 ;
V_234 . V_246 -= V_67 -> V_247 ;
V_234 . V_248 -= V_67 -> V_249 ;
V_234 . V_250 -= V_67 -> V_251 ;
V_234 . V_252 -= V_67 -> V_253 ;
V_234 . V_254 -= V_67 -> V_255 ;
V_234 . V_256 -=
V_67 -> V_257 ;
V_234 . V_258 -=
V_67 -> V_259 ;
V_234 . V_260 -= V_67 -> V_261 ;
V_234 . V_260 += V_67 -> V_262 ;
memset ( V_184 -> V_15 , 0 , sizeof( V_184 -> V_15 ) ) ;
V_48 -> V_191 = V_191 ;
if ( V_184 -> V_13 != 0 ||
( V_191 != V_17 && V_191 != 0xFF ) )
V_184 -> V_7 |= V_14 ;
if ( V_234 . V_235 > 0xFFFFUL )
V_48 -> V_235 = F_5 ( 0xFFFF ) ;
else
V_48 -> V_235 =
F_5 ( ( T_4 ) V_234 . V_235 ) ;
if ( V_234 . V_237 > 0xFFUL )
V_48 -> V_237 = 0xFF ;
else
V_48 -> V_237 =
( T_1 ) V_234 . V_237 ;
if ( V_234 . V_239 > 0xFFUL )
V_48 -> V_239 = 0xFF ;
else
V_48 -> V_239 = ( T_1 ) V_234 . V_239 ;
if ( V_234 . V_241 > 0xFFFFUL )
V_48 -> V_241 = F_5 ( 0xFFFF ) ;
else
V_48 -> V_241 =
F_5 ( ( T_4 ) V_234 . V_241 ) ;
if ( V_234 . V_244 > 0xFFFFUL )
V_48 -> V_244 = F_5 ( 0xFFFF ) ;
else
V_48 -> V_244 =
F_5 ( ( T_4 ) V_234 . V_244 ) ;
if ( V_234 . V_246 > 0xFFFFUL )
V_48 -> V_246 = F_5 ( 0xFFFF ) ;
else
V_48 -> V_246 =
F_5 ( ( T_4 ) V_234 . V_246 ) ;
if ( V_234 . V_256 > 0xFUL )
V_234 . V_256 = 0xFUL ;
if ( V_234 . V_258 > 0xFUL )
V_234 . V_258 = 0xFUL ;
V_48 -> V_263 = ( V_234 . V_256 << 4 ) |
V_234 . V_258 ;
if ( V_234 . V_260 > 0xFFFFUL )
V_48 -> V_260 = F_5 ( 0xFFFF ) ;
else
V_48 -> V_260 = F_5 ( ( T_4 ) V_234 . V_260 ) ;
if ( V_234 . V_248 > 0xFFFFFFFFUL )
V_48 -> V_248 = F_7 ( 0xFFFFFFFF ) ;
else
V_48 -> V_248 = F_7 ( ( T_2 ) V_234 . V_248 ) ;
if ( V_234 . V_250 > 0xFFFFFFFFUL )
V_48 -> V_250 = F_7 ( 0xFFFFFFFF ) ;
else
V_48 -> V_250 = F_7 ( ( T_2 ) V_234 . V_250 ) ;
if ( V_234 . V_252 > 0xFFFFFFFFUL )
V_48 -> V_252 = F_7 ( 0xFFFFFFFF ) ;
else
V_48 -> V_252 =
F_7 ( ( T_2 ) V_234 . V_252 ) ;
if ( V_234 . V_254 > 0xFFFFFFFFUL )
...
{
struct V_264 * V_48 =
(struct V_264 * ) V_184 -> V_15 ;
struct V_66 * V_67 = F_4 ( V_12 ) ;
V_60 V_265 , V_266 , V_267 , V_268 , V_269 ;
T_1 V_191 = V_48 -> V_191 ;
F_55 ( V_67 -> V_21 , & V_265 , & V_266 , & V_267 ,
& V_268 , & V_269 ) ;
V_265 -= V_67 -> V_249 ;
V_266 -= V_67 -> V_251 ;
V_267 -= V_67 -> V_253 ;
...
( V_191 != V_17 && V_191 != 0xFF ) )
V_184 -> V_7 |= V_14 ;
V_48 -> V_248 = F_51 ( V_265 ) ;
V_48 -> V_250 = F_51 ( V_266 ) ;
V_48 -> V_252 = F_51 ( V_267 ) ;
V_48 -> V_254 = F_51 ( V_268 ) ;
V_48 -> V_270 = F_51 ( V_67 -> V_271 ) ;
...
F_53 ( V_67 -> V_21 , & V_234 ) ;
if ( V_48 -> V_206 & V_278 )
V_67 -> V_236 = V_234 . V_235 ;
if ( V_48 -> V_206 & V_279 )
V_67 -> V_238 =
V_234 . V_237 ;
if ( V_48 -> V_206 & V_280 )
V_67 -> V_240 = V_234 . V_239 ;
if ( V_48 -> V_206 & V_281 )
V_67 -> V_243 =
V_234 . V_241 + V_67 -> V_242 ;
if ( V_48 -> V_206 & V_282 )
...
if ( V_48 -> V_206 & V_286 ) {
V_67 -> V_262 = 0 ;
V_67 -> V_261 = V_234 . V_260 ;
}
if ( V_48 -> V_206 & V_287 )
V_67 -> V_249 = V_234 . V_248 ;
if ( V_48 -> V_206 & V_288 )
V_67 -> V_251 = V_234 . V_250 ;
if ( V_48 -> V_206 & V_289 )
V_67 -> V_253 = V_234 . V_252 ;
if ( V_48 -> V_206 & V_290 )
V_67 -> V_255 = V_234 . V_254 ;
...
static int F_58 ( struct V_11 * V_12 , int V_299 ,
T_1 V_149 , struct V_300 * V_301 ,
struct V_300 * V_302 )
{
...
if ( V_67 -> V_304 &&
F_59 ( V_305 , V_67 -> V_304 ) ) {
V_67 -> V_304 = 0 ;
V_67 -> V_77 = 0 ;
}
if ( ( V_299 & V_306 ) == 0 && V_67 -> V_76 != 0 &&
V_67 -> V_76 != V_2 -> V_76 &&
( V_2 -> V_3 == V_75 ||
( V_2 -> V_3 == V_307 &&
V_67 -> V_77 >= 2 ) ) ) {
...
struct V_300 * V_302 )
{
struct V_183 * V_184 = (struct V_183 * ) V_302 ;
int V_73 ;
* V_302 = * V_301 ;
if ( V_184 -> V_27 != 1 ) {
V_184 -> V_7 |= V_303 ;
...
int F_61 ( struct V_11 * V_12 , int V_299 , T_1 V_149 ,
struct V_330 * V_331 , struct V_332 * V_333 ,
struct V_300 * V_301 , struct V_300 * V_302 )
{
int V_73 ;
switch ( V_301 -> V_334 . V_5 ) {
case V_6 :
case V_335 :
V_73 = F_58 ( V_12 , V_299 , V_149 ,
V_301 , V_302 ) ;
goto V_74;
case V_336 :
V_73 = F_60 ( V_12 , V_149 , V_301 , V_302 ) ;
goto V_74;
default:
V_73 = V_9 ;
}
