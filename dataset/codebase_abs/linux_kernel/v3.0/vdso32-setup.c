...
return;
V_107 = V_84 ;
F_21 ( V_108 , F_22 ( V_109 [ 0 ] ) << V_110 ,
V_84 ? V_111 : V_112 ) ;
F_23 () ;
}
int T_1 F_24 ( void )
{
void * V_113 = ( void * ) F_25 ( V_114 ) ;
const void * V_115 ;
T_7 V_116 ;
V_109 [ 0 ] = F_26 ( V_113 ) ;
#ifdef F_27
...
memcpy ( V_113 , V_115 , V_116 ) ;
F_7 ( V_113 ) ;
return 0 ;
}
int F_30 ( struct V_123 * V_124 , int V_125 )
{
struct V_126 * V_127 = V_128 -> V_127 ;
unsigned long V_129 ;
int V_130 = 0 ;
bool V_131 ;
if ( V_2 == V_132 )
...
V_129 = F_32 ( NULL , 0 , V_136 , 0 , 0 ) ;
if ( F_33 ( V_129 ) ) {
V_130 = V_129 ;
goto V_137;
}
}
V_128 -> V_127 -> V_138 . V_139 = ( void * ) V_129 ;
if ( V_140 || ! V_131 ) {
V_130 = F_34 ( V_127 , V_129 , V_136 ,
V_100 | V_102 |
V_101 | V_141 | V_103 |
V_106 ,
V_109 ) ;
...
V_137:
if ( V_130 )
V_128 -> V_127 -> V_138 . V_139 = NULL ;
F_37 ( & V_127 -> V_133 ) ;
return V_130 ;
}
static T_1 int F_38 ( void )
{
F_39 ( V_144 ) ;
return 0 ;
}
const char * F_40 ( struct V_145 * V_146 )
{
if ( V_146 -> V_94 && V_146 -> V_95 == ( long ) V_146 -> V_94 -> V_138 . V_139 )
return L_3 ;
return NULL ;
}
struct V_145 * F_41 ( struct V_126 * V_127 )
{
if ( V_127 && V_127 -> V_138 . V_139 == ( void * ) V_135 )
return & V_93 ;
return NULL ;
}
int F_42 ( struct V_126 * V_127 , unsigned long V_129 )
{
const struct V_145 * V_146 = F_41 ( V_127 ) ;
return V_146 && V_129 >= V_146 -> V_95 && V_129 < V_146 -> V_97 ;
}
int F_43 ( unsigned long V_129 )
{
return 0 ;
}
