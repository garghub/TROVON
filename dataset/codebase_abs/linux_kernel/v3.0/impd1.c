...
struct V_74 * V_75 ;
unsigned long V_76 ;
V_76 = V_17 -> V_56 . V_30 + V_73 -> V_77 ;
V_75 = F_21 ( sizeof( struct V_74 ) , V_58 ) ;
if ( ! V_75 )
continue;
F_26 ( & V_75 -> V_17 , L_10 , V_17 -> V_53 , V_73 -> V_77 >> 12 ) ;
V_75 -> V_17 . V_23 = & V_17 -> V_17 ;
V_75 -> V_29 . V_30 = V_17 -> V_56 . V_30 + V_73 -> V_77 ;
V_75 -> V_29 . V_78 = V_75 -> V_29 . V_30 + V_57 - 1 ;
V_75 -> V_29 . V_79 = V_80 ;
V_75 -> V_81 [ 0 ] = V_17 -> V_81 ;
V_75 -> V_81 [ 1 ] = V_17 -> V_81 ;
V_75 -> V_82 = V_73 -> V_53 ;
V_75 -> V_17 . V_83 = V_73 -> V_83 ;
V_33 = F_27 ( V_75 , & V_17 -> V_56 ) ;
if ( V_33 ) {
F_28 ( & V_75 -> V_17 , L_11 , V_33 ) ;
F_29 ( V_75 ) ;
}
}
return 0 ;
...
static int F_30 ( struct V_16 * V_17 , void * V_6 )
{
F_31 ( V_17 ) ;
return 0 ;
}
static void F_32 ( struct V_51 * V_17 )
{
struct V_4 * V_5 = F_33 ( V_17 ) ;
int V_52 ;
F_34 ( & V_17 -> V_17 , NULL , F_30 ) ;
for ( V_52 = 0 ; V_52 < F_23 ( V_5 -> V_69 ) ; V_52 ++ )
F_35 ( V_5 -> V_69 [ V_52 ] ) ;
F_22 ( V_17 , NULL ) ;
F_19 ( V_5 -> V_11 ) ;
