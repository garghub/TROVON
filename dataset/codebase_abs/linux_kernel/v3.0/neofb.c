...
int V_161 ;
F_37 ( L_8 ) ;
V_161 = ( V_46 -> V_116 * V_46 -> V_66 + V_46 -> V_115 ) >> 2 ;
V_161 *= ( V_46 -> V_84 + 7 ) / 8 ;
F_16 () ;
...
static int T_9 F_59 ( struct V_20 * V_21 ,
struct V_224 * V_225 )
{
struct V_3 * V_4 = V_21 -> V_4 ;
F_37 ( L_9 ) ;
...
static int T_9 F_66 ( struct V_20 * V_21 ,
struct V_224 * V_225 , int V_231 )
{
F_37 ( L_15 ) ;
...
static int T_9 F_73 ( struct V_20 * V_21 )
{
struct V_3 * V_4 = V_21 -> V_4 ;
...
static int T_9 F_76 ( struct V_20 * V_21 )
{
struct V_3 * V_4 = V_21 -> V_4 ;
int V_245 = 896 ;
int V_99 = 65000 ;
...
static struct V_20 * T_9 F_77 ( struct V_224 * V_225 , const struct
V_248 * V_249 )
{
struct V_20 * V_21 ;
struct V_3 * V_4 ;
...
static int T_9 F_82 ( struct V_224 * V_225 ,
...
static void T_10 F_89 ( struct V_224 * V_225 )
{
...
static int T_11 F_92 ( char * V_279 )
{
char * V_280 ;
F_37 ( L_48 ) ;
if ( ! V_279 || ! * V_279 )
