...
V_39 -> V_69 =
F_23 ( & V_48 [ V_43 + 6 ] ) ;
V_39 -> V_71 = V_48 [ V_43 + 9 ] ;
V_39 -> V_72 = V_48 [ V_43 + 11 ] ;
V_43 += 12 ;
}
} else if ( V_47 ) {
if ( V_39 -> type == V_63 )
...
V_86 , V_85 ,
V_84 , 3 ) ;
} while ( ( error < 0 || V_84 [ 1 ] != 4 ) && V_41 ++ < 5 );
} else if ( V_39 -> type != V_87 ) {
do {
V_84 [ 0 ] = 2 ;
V_84 [ 1 ] = 2 ;
error = F_5 ( V_2 , V_86 ,
...
V_39 -> V_93 = 0 ;
V_39 -> V_94 = 0 ;
if ( ( V_39 -> type != V_87 ) && ( V_39 -> type != V_63 ) &&
( V_39 -> type != V_67 ) )
goto V_32;
if ( F_28 ( V_89 , V_95 , & V_37 ) ) {
if ( F_28 ( & V_89 -> V_96 [ 0 ] ,
V_53 , & V_37 ) ) {
F_29 ( L_4 ) ;
error = 1 ;
...
static struct V_97 * F_30 ( struct V_40 * V_27 )
{
struct V_97 * V_98 ;
...
V_98 = F_30 ( V_27 ) ;
if ( ! V_98 ) {
V_98 = F_22 ( sizeof( struct V_97 ) , V_31 ) ;
if ( ! V_98 ) {
V_16 = - V_50 ;
goto V_32;
}
F_34 ( & V_98 -> V_99 ) ;
V_98 -> V_27 = V_27 ;
F_35 ( & V_98 -> V_101 , & V_102 ) ;
}
V_14 -> V_103 = & V_98 -> V_103 ;
V_32:
F_17 ( & V_100 ) ;
return V_16 ;
}
static void F_36 ( struct V_99 * V_99 )
{
struct V_97 * V_98 =
F_37 ( V_99 , struct V_97 , V_99 ) ;
F_16 ( & V_100 ) ;
F_38 ( & V_98 -> V_101 ) ;
F_17 ( & V_100 ) ;
F_24 ( V_98 ) ;
...
struct V_97 * V_98 ;
if ( V_14 -> V_103 ) {
V_98 = F_37 ( V_14 -> V_103 , struct V_97 , V_103 ) ;
F_40 ( & V_98 -> V_99 , F_36 ) ;
V_14 -> V_103 = NULL ;
}
}
static int F_41 ( struct V_1 * V_2 , const struct V_104 * V_3 )
{
struct V_40 * V_27 = F_3 ( V_2 ) ;
struct V_105 * V_96 ;
struct V_14 * V_14 ;
...
V_22 = & V_14 -> V_22 ;
V_22 -> V_39 = * ( (struct V_38 * ) V_3 -> V_106 ) ;
V_39 = & V_22 -> V_39 ;
if ( V_39 -> V_64 > V_109 ) {
error = - V_107 ;
goto V_108;
}
V_22 -> V_98 = F_43 ( V_27 , V_109 ,
V_31 , & V_14 -> V_110 ) ;
if ( ! V_22 -> V_98 ) {
error = - V_50 ;
goto V_108;
...
V_14 -> V_2 = V_2 ;
F_45 ( & V_14 -> V_29 ) ;
F_46 ( V_27 , V_14 -> V_112 , sizeof( V_14 -> V_112 ) ) ;
F_47 ( V_14 -> V_112 , L_5 , sizeof( V_14 -> V_112 ) ) ;
V_22 -> V_113 = V_26 ;
V_96 = & V_2 -> V_90 -> V_96 [ 0 ] . V_10 ;
error = F_27 ( V_2 , V_39 ) ;
if ( error )
goto V_114;
F_48 ( V_39 ) ;
F_49 ( V_22 -> V_115 , V_39 -> V_115 , sizeof( V_22 -> V_115 ) ) ;
if ( V_39 -> V_116 & V_117 ) {
F_47 ( V_22 -> V_115 ,
V_39 -> V_61 == V_75 ?
L_6 : L_7 ,
...
V_26 -> V_115 = V_22 -> V_115 ;
V_26 -> V_27 . V_118 = & V_2 -> V_27 ;
V_26 -> V_33 = F_13 ;
V_26 -> V_119 = F_19 ;
F_50 ( V_27 , & V_26 -> V_3 ) ;
F_51 ( V_26 , V_14 ) ;
F_52 ( V_26 , V_22 ) ;
F_53 ( V_14 -> V_30 , V_27 ,
F_54 ( V_27 , V_96 -> V_120 ) ,
V_22 -> V_98 , V_39 -> V_64 ,
F_7 , V_14 , V_96 -> V_121 ) ;
V_14 -> V_30 -> V_122 = V_14 -> V_110 ;
V_14 -> V_30 -> V_123 |= V_124 ;
error = F_55 ( V_26 ) ;
if ( error )
goto V_125;
F_25 ( V_2 , V_39 ) ;
...
return 0 ;
V_125: F_39 ( V_22 ) ;
V_114: F_57 ( V_14 -> V_30 ) ;
V_111: F_58 ( V_27 , V_109 , V_22 -> V_98 , V_14 -> V_110 ) ;
V_108: F_59 ( V_26 ) ;
F_24 ( V_14 ) ;
return error ;
}
...
F_56 ( V_2 , NULL ) ;
F_20 ( V_14 -> V_30 ) ;
F_62 ( V_14 -> V_22 . V_113 ) ;
F_57 ( V_14 -> V_30 ) ;
F_58 ( F_3 ( V_2 ) , V_109 ,
V_14 -> V_22 . V_98 , V_14 -> V_110 ) ;
F_39 ( & V_14 -> V_22 ) ;
F_24 ( V_14 ) ;
}
static int F_63 ( struct V_1 * V_2 , T_1 V_126 )
{
struct V_14 * V_14 = F_61 ( V_2 ) ;
F_16 ( & V_14 -> V_29 ) ;
F_20 ( V_14 -> V_30 ) ;
