...
static int T_2 F_59 ( struct V_140 * V_141 , char * V_146 )
{
struct V_3 * V_4 ;
int V_98 = 38400 ;
int V_145 = 8 ;
...
V_4 -> V_2 . V_90 = F_35 ( V_4 -> V_88 ) ;
if ( V_146 )
F_60 ( V_146 , & V_98 , & V_34 , & V_145 , & V_147 ) ;
else
F_58 ( V_4 , & V_98 , & V_34 , & V_145 ) ;
return F_61 ( & V_4 -> V_2 , V_141 , V_98 , V_34 , V_145 , V_147 ) ;
}
static int F_62 ( struct V_150 * V_81 , const struct V_151 * V_152 )
{
struct V_3 * V_4 ;
void T_3 * V_153 ;
int V_154 , V_135 ;
for ( V_154 = 0 ; V_154 < F_63 ( V_143 ) ; V_154 ++ )
if ( V_143 [ V_154 ] == NULL )
break;
if ( V_154 == F_63 ( V_143 ) ) {
V_135 = - V_131 ;
...
V_4 = F_64 ( sizeof( struct V_3 ) , V_155 ) ;
if ( ! V_4 ) {
V_135 = - V_156 ;
goto V_89;
}
V_153 = F_65 ( V_81 -> V_157 . V_158 , F_66 ( & V_81 -> V_157 ) ) ;
if ( ! V_153 ) {
V_135 = - V_156 ;
goto free;
}
V_4 -> V_88 = F_67 ( & V_81 -> V_81 , NULL ) ;
if ( F_68 ( V_4 -> V_88 ) ) {
V_135 = F_69 ( V_4 -> V_88 ) ;
goto V_159;
}
...
static int F_75 ( struct V_150 * V_81 )
{
struct V_3 * V_4 = F_76 ( V_81 ) ;
int V_154 ;
F_70 ( V_81 , NULL ) ;
F_77 ( & V_166 , & V_4 -> V_2 ) ;
for ( V_154 = 0 ; V_154 < F_63 ( V_143 ) ; V_154 ++ )
...
static int F_78 ( struct V_150 * V_81 , T_4 V_14 )
{
struct V_3 * V_4 = F_76 ( V_81 ) ;
if ( V_4 )
F_79 ( & V_166 , & V_4 -> V_2 ) ;
...
static int F_80 ( struct V_150 * V_81 )
{
struct V_3 * V_4 = F_76 ( V_81 ) ;
if ( V_4 )
F_81 ( & V_166 , & V_4 -> V_2 ) ;
