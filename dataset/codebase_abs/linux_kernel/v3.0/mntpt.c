...
V_37 = F_28 ( V_35 -> V_56 ) ;
memcpy ( V_40 , L_9 , 5 ) ;
strcpy ( V_40 + 5 , V_37 -> V_57 -> V_58 -> V_30 ) ;
if ( V_37 -> V_57 -> type == V_59 || V_41 )
strcat ( V_40 , L_10 ) ;
F_9 ( L_11 , V_39 , V_40 ) ;
V_38 = F_29 ( & V_60 , 0 , V_39 , V_40 ) ;
F_9 ( L_12 , V_38 ) ;
...
struct V_34 * F_31 ( struct V_61 * V_61 )
{
struct V_34 * V_62 ;
F_2 ( L_14 , V_61 -> V_38 -> V_63 , V_61 -> V_23 -> V_29 . V_30 ) ;
V_62 = F_19 ( V_61 -> V_23 ) ;
if ( F_5 ( V_62 ) )
return V_62 ;
F_32 ( V_62 ) ;
