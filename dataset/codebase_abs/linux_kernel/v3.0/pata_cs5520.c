...
static int T_1 F_5 ( struct V_6 * V_7 , const struct V_17 * V_18 )
{
...
F_18 ( V_8 -> V_43 [ 0 ] ,
L_5 , V_19 [ 0 ] , V_20 [ 0 ] ) ;
F_19 ( V_8 -> V_43 [ 0 ] , 4 , 0 , L_6 ) ;
V_34 = & V_8 -> V_43 [ 1 ] -> V_34 ;
V_34 -> V_44 = V_31 [ 2 ] ;
V_34 -> V_45 = V_31 [ 3 ] ;
V_34 -> V_46 = V_31 [ 3 ] ;
V_34 -> V_47 = V_31 [ 4 ] + 8 ;
...
F_18 ( V_8 -> V_43 [ 1 ] ,
L_5 , V_19 [ 1 ] , V_20 [ 1 ] ) ;
F_19 ( V_8 -> V_43 [ 1 ] , 4 , 8 , L_6 ) ;
F_20 ( V_7 ) ;
V_36 = F_21 ( V_8 ) ;
if ( V_36 )
return V_36 ;
for ( V_35 = 0 ; V_35 < 2 ; V_35 ++ ) {
static const int V_48 [] = { 14 , 15 } ;
struct V_1 * V_2 = V_8 -> V_43 [ V_35 ] ;
if ( F_22 ( V_2 ) )
continue;
V_36 = F_23 ( & V_7 -> V_9 , V_48 [ V_2 -> V_13 ] ,
V_49 , 0 , V_50 , V_8 ) ;
if ( V_36 )
return V_36 ;
F_18 ( V_2 , L_7 , V_48 [ V_35 ] ) ;
}
return F_24 ( V_8 , & V_51 ) ;
}
static int F_25 ( struct V_6 * V_7 )
{
struct V_32 * V_8 = F_26 ( & V_7 -> V_9 ) ;
T_2 V_30 ;
int V_36 ;
V_36 = F_27 ( V_7 ) ;
if ( V_36 )
...
static int F_29 ( struct V_6 * V_7 , T_4 V_52 )
{
struct V_32 * V_8 = F_26 ( & V_7 -> V_9 ) ;
int V_36 = 0 ;
V_36 = F_30 ( V_8 , V_52 ) ;
