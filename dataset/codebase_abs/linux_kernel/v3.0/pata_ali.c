...
if ( F_21 ( V_68 -> V_70 [ 0 ] ) == V_71 )
return - V_69 ;
return 0 ;
}
static void F_22 ( struct V_72 * V_57 , unsigned int * V_73 )
{
T_1 V_74 ;
int V_75 = 4 << V_57 -> V_7 -> V_12 ;
if ( V_76 ) {
F_5 ( V_76 , 0x58 , & V_74 ) ;
V_74 &= ~ V_75 ;
F_9 ( V_76 , 0x58 , V_74 ) ;
...
F_5 ( V_2 , 0x4a , & V_77 ) ;
F_9 ( V_2 , 0x4a , V_77 | 0x20 ) ;
F_5 ( V_2 , 0x4B , & V_77 ) ;
if ( V_2 -> V_79 < 0xC2 )
V_77 &= 0x7F ;
if ( V_2 -> V_79 >= 0xc2 )
V_77 |= 0x01 ;
F_9 ( V_2 , 0x4B , V_77 | 0x08 ) ;
F_5 ( V_2 , 0x53 , & V_77 ) ;
if ( V_2 -> V_79 >= 0xc7 )
V_77 |= 0x03 ;
else
...
V_78 = F_25 ( 0 , F_26 ( 0 , 0 ) ) ;
if ( V_78 && V_78 -> V_80 == V_81 && V_76 ) {
F_5 ( V_76 , 0x79 , & V_77 ) ;
if ( V_2 -> V_79 == 0xC2 )
F_9 ( V_76 , 0x79 , V_77 | 0x04 ) ;
else if ( V_2 -> V_79 > 0xC2 && V_2 -> V_79 < 0xC5 )
F_9 ( V_76 , 0x79 , V_77 | 0x02 ) ;
}
F_27 ( V_78 ) ;
F_28 ( V_2 ) ;
}
static int F_29 ( struct V_1 * V_2 , const struct V_82 * V_24 )
{
...
static const struct V_83 V_102 = {
. V_61 = V_85 | V_91 |
V_92 ,
. V_86 = V_87 ,
. V_93 = V_94 ,
...
static const struct V_83 V_103 = {
. V_61 = V_85 | V_91 |
V_92 ,
. V_86 = V_87 ,
. V_93 = V_94 ,
...
static const struct V_83 V_106 = {
. V_61 = V_85 | V_92 ,
. V_86 = V_87 ,
. V_93 = V_94 ,
. V_97 = V_107 ,
...
const struct V_83 * V_109 [] = { NULL , NULL } ;
T_1 V_77 ;
int V_110 ;
V_110 = F_30 ( V_2 ) ;
if ( V_110 )
...
if ( V_2 -> V_79 < 0x20 ) {
V_109 [ 0 ] = & V_84 ;
} else if ( V_2 -> V_79 < 0xC2 ) {
V_109 [ 0 ] = & V_90 ;
} else if ( V_2 -> V_79 == 0xC2 ) {
V_109 [ 0 ] = & V_99 ;
} else if ( V_2 -> V_79 == 0xC3 ) {
V_109 [ 0 ] = & V_102 ;
} else if ( V_2 -> V_79 == 0xC4 ) {
V_109 [ 0 ] = & V_103 ;
} else
V_109 [ 0 ] = & V_106 ;
F_24 ( V_2 ) ;
if ( V_76 && V_2 -> V_79 >= 0x20 && V_2 -> V_79 < 0xC2 ) {
F_5 ( V_76 , 0x5E , & V_77 ) ;
if ( ( V_77 & 0x1E ) == 0x12 )
V_109 [ 0 ] = & V_96 ;
}
if ( ! V_109 [ 0 ] -> V_93 && ! V_109 [ 0 ] -> V_97 )
return F_31 ( V_2 , V_109 , & V_111 , NULL , 0 ) ;
else
return F_32 ( V_2 , V_109 , & V_111 , NULL , 0 ) ;
}
static int F_33 ( struct V_1 * V_2 )
{
struct V_112 * V_8 = F_34 ( & V_2 -> V_9 ) ;
int V_110 ;
V_110 = F_35 ( V_2 ) ;
if ( V_110 )
return V_110 ;
