...
static int T_4 F_32 ( struct V_27 * V_28 , unsigned int V_29 )
{
#ifdef F_4
if ( V_24 == 0 ) {
struct V_30 * V_31 ;
...
static int T_4 F_39 ( struct V_27 * V_28 , unsigned int V_29 )
{
F_40 ( & V_17 ) ;
if ( F_21 () )
return - V_26 ;
...
static int T_5 F_46 ( struct V_27 * V_28 , unsigned int V_29 )
{
F_47 ( & V_9 ) ;
if ( V_6 > 0 ) {
F_42 ( V_6 ) ;
