...
#endif
V_135 = F_111 ( V_224 , V_242 , V_6 , & V_237 ) ;
if ( V_135 < 0 ) {
F_93 ( V_6 ) ;
return V_135 ;
}
...
int F_113 ( struct V_5 * V_6 , int V_226 , struct V_245 * * V_246 )
{
struct V_245 * V_217 ;
int V_135 ;
...
if ( V_135 < 0 )
return V_135 ;
F_115 ( V_217 , V_247 , & V_248 ) ;
F_115 ( V_217 , V_249 , & V_250 ) ;
V_217 -> V_251 = V_6 ;
V_217 -> V_252 = 0 ;
if ( V_6 -> V_104 )
V_217 -> V_252 |= V_253 ;
...
{
struct V_5 * V_6 = V_109 -> V_251 ;
V_6 -> V_109 = NULL ;
}
int F_119 ( struct V_5 * V_6 , int V_226 , struct V_108 * * V_257 )
{
struct V_108 * V_109 ;
struct V_258 V_259 ;
int V_135 ;
V_259 . V_260 = V_261 ;
V_259 . V_262 = V_263 ;
V_259 . V_224 = V_6 -> V_224 -> V_264 ;
V_259 . V_226 = V_226 ;
V_259 . V_265 = 0 ;
if ( ( V_135 = F_120 ( V_6 -> V_224 , L_38 , & V_259 , & V_109 ) ) < 0 )
return V_135 ;
strcpy ( V_109 -> V_255 , F_102 ( V_6 ) ) ;
V_109 -> V_251 = V_6 ;
V_109 -> V_266 = F_118 ;
V_109 -> V_177 = V_267 ;
V_6 -> V_109 = V_109 ;
...
static int F_121 ( struct V_268 * V_269 ,
struct V_270 * V_271 )
{
static char * V_272 [ 4 ] = {
L_65 , L_66 , L_67 , L_68
...
char * * V_275 = V_272 ;
struct V_5 * V_6 = F_122 ( V_269 ) ;
if ( F_123 ( ! V_6 -> V_224 ) )
return - V_52 ;
V_271 -> type = V_276 ;
V_271 -> V_137 = 2 ;
V_271 -> V_14 . V_277 . V_278 = 4 ;
if ( V_271 -> V_14 . V_277 . V_279 > 3 )
V_271 -> V_14 . V_277 . V_279 = 3 ;
if ( ! strcmp ( V_6 -> V_224 -> V_280 , L_71 ) )
V_275 = V_274 ;
switch ( V_6 -> V_30 ) {
case V_88 :
V_275 = V_274 ;
...
strcpy ( V_271 -> V_14 . V_277 . V_255 , V_275 [ V_271 -> V_14 . V_277 . V_279 ] ) ;
return 0 ;
}
static int F_124 ( struct V_268 * V_269 ,
struct V_281 * V_282 )
{
struct V_5 * V_6 = F_122 ( V_269 ) ;
unsigned long V_22 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_282 -> V_14 . V_277 . V_279 [ 0 ] = ( V_6 -> V_18 [ V_75 ] & V_283 ) >> 6 ;
V_282 -> V_14 . V_277 . V_279 [ 1 ] = ( V_6 -> V_18 [ V_76 ] & V_283 ) >> 6 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
return 0 ;
}
static int F_125 ( struct V_268 * V_269 ,
struct V_281 * V_282 )
{
struct V_5 * V_6 = F_122 ( V_269 ) ;
unsigned long V_22 ;
unsigned short V_284 , V_285 ;
int V_286 ;
if ( V_282 -> V_14 . V_277 . V_279 [ 0 ] > 3 ||
V_282 -> V_14 . V_277 . V_279 [ 1 ] > 3 )
return - V_52 ;
V_284 = V_282 -> V_14 . V_277 . V_279 [ 0 ] << 6 ;
V_285 = V_282 -> V_14 . V_277 . V_279 [ 1 ] << 6 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_284 = ( V_6 -> V_18 [ V_75 ] & ~ V_283 ) | V_284 ;
V_285 = ( V_6 -> V_18 [ V_76 ] & ~ V_283 ) | V_285 ;
V_286 = V_284 != V_6 -> V_18 [ V_75 ] ||
V_285 != V_6 -> V_18 [ V_76 ] ;
F_12 ( V_6 , V_75 , V_284 ) ;
F_12 ( V_6 , V_76 , V_285 ) ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
...
int F_126 ( struct V_268 * V_269 ,
struct V_270 * V_271 )
{
int V_287 = ( V_269 -> V_288 >> 16 ) & 0xff ;
V_271 -> type = V_287 == 1 ? V_289 : V_290 ;
V_271 -> V_137 = 1 ;
V_271 -> V_14 . integer . V_291 = 0 ;
V_271 -> V_14 . integer . V_292 = V_287 ;
return 0 ;
}
int F_127 ( struct V_268 * V_269 ,
struct V_281 * V_282 )
{
struct V_5 * V_6 = F_122 ( V_269 ) ;
unsigned long V_22 ;
int V_13 = V_269 -> V_288 & 0xff ;
int V_293 = ( V_269 -> V_288 >> 8 ) & 0xff ;
int V_287 = ( V_269 -> V_288 >> 16 ) & 0xff ;
int V_294 = ( V_269 -> V_288 >> 24 ) & 0xff ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_282 -> V_14 . integer . V_14 [ 0 ] = ( V_6 -> V_18 [ V_13 ] >> V_293 ) & V_287 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
if ( V_294 )
V_282 -> V_14 . integer . V_14 [ 0 ] = V_287 - V_282 -> V_14 . integer . V_14 [ 0 ] ;
return 0 ;
}
int F_128 ( struct V_268 * V_269 ,
struct V_281 * V_282 )
{
struct V_5 * V_6 = F_122 ( V_269 ) ;
unsigned long V_22 ;
...
int V_286 ;
unsigned short V_8 ;
V_8 = ( V_282 -> V_14 . integer . V_14 [ 0 ] & V_287 ) ;
if ( V_294 )
V_8 = V_287 - V_8 ;
V_8 <<= V_293 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_8 = ( V_6 -> V_18 [ V_13 ] & ~ ( V_287 << V_293 ) ) | V_8 ;
V_286 = V_8 != V_6 -> V_18 [ V_13 ] ;
F_12 ( V_6 , V_13 , V_8 ) ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
return V_286 ;
}
int F_129 ( struct V_268 * V_269 ,
struct V_270 * V_271 )
{
int V_287 = ( V_269 -> V_288 >> 24 ) & 0xff ;
V_271 -> type = V_287 == 1 ? V_289 : V_290 ;
V_271 -> V_137 = 2 ;
V_271 -> V_14 . integer . V_291 = 0 ;
V_271 -> V_14 . integer . V_292 = V_287 ;
...
int F_130 ( struct V_268 * V_269 ,
struct V_281 * V_282 )
{
struct V_5 * V_6 = F_122 ( V_269 ) ;
unsigned long V_22 ;
int V_295 = V_269 -> V_288 & 0xff ;
int V_296 = ( V_269 -> V_288 >> 8 ) & 0xff ;
int V_297 = ( V_269 -> V_288 >> 16 ) & 0x07 ;
int V_298 = ( V_269 -> V_288 >> 19 ) & 0x07 ;
int V_287 = ( V_269 -> V_288 >> 24 ) & 0xff ;
int V_294 = ( V_269 -> V_288 >> 22 ) & 1 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_282 -> V_14 . integer . V_14 [ 0 ] = ( V_6 -> V_18 [ V_295 ] >> V_297 ) & V_287 ;
V_282 -> V_14 . integer . V_14 [ 1 ] = ( V_6 -> V_18 [ V_296 ] >> V_298 ) & V_287 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
if ( V_294 ) {
V_282 -> V_14 . integer . V_14 [ 0 ] = V_287 - V_282 -> V_14 . integer . V_14 [ 0 ] ;
V_282 -> V_14 . integer . V_14 [ 1 ] = V_287 - V_282 -> V_14 . integer . V_14 [ 1 ] ;
}
return 0 ;
}
int F_131 ( struct V_268 * V_269 ,
struct V_281 * V_282 )
{
struct V_5 * V_6 = F_122 ( V_269 ) ;
unsigned long V_22 ;
...
V_299 = V_282 -> V_14 . integer . V_14 [ 0 ] & V_287 ;
V_300 = V_282 -> V_14 . integer . V_14 [ 1 ] & V_287 ;
if ( V_294 ) {
V_299 = V_287 - V_299 ;
V_300 = V_287 - V_300 ;
}
...
F_23 ( & V_6 -> V_23 , V_22 ) ;
if ( V_295 != V_296 ) {
V_299 = ( V_6 -> V_18 [ V_295 ] & ~ ( V_287 << V_297 ) ) | V_299 ;
V_300 = ( V_6 -> V_18 [ V_296 ] & ~ ( V_287 << V_298 ) ) | V_300 ;
V_286 = V_299 != V_6 -> V_18 [ V_295 ] ||
V_300 != V_6 -> V_18 [ V_296 ] ;
F_12 ( V_6 , V_295 , V_299 ) ;
F_12 ( V_6 , V_296 , V_300 ) ;
} else {
V_287 = ( V_287 << V_297 ) | ( V_287 << V_298 ) ;
V_299 = ( V_6 -> V_18 [ V_295 ] & ~ V_287 ) | V_299 | V_300 ;
V_286 = V_299 != V_6 -> V_18 [ V_295 ] ;
F_12 ( V_6 , V_295 , V_299 ) ;
}
F_24 ( & V_6 -> V_23 , V_22 ) ;
...
unsigned int V_301 ;
int V_135 ;
int V_137 = F_38 ( V_302 ) ;
if ( F_123 ( ! V_6 || ! V_6 -> V_217 ) )
return - V_52 ;
V_224 = V_6 -> V_224 ;
strcpy ( V_224 -> V_303 , V_6 -> V_217 -> V_255 ) ;
if ( V_6 -> V_30 & V_84 )
V_137 = 11 ;
else if ( V_6 -> V_30 == V_192 )
V_137 = 9 ;
for ( V_301 = 0 ; V_301 < V_137 ; V_301 ++ ) {
V_135 = F_133 ( V_224 ,
F_134 ( & V_302 [ V_301 ] ,
V_6 ) ) ;
if ( V_135 < 0 )
...
const struct V_304 * F_135 ( int V_305 )
{
return V_305 == V_247 ?
& V_248 : & V_250 ;
}
