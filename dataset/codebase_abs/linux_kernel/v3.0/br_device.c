...
static struct V_28 * F_38 ( struct V_3 * V_4 ,
struct V_28 * V_15 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
...
static int F_43 ( struct V_3 * V_4 , int V_36 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
if ( V_36 < 68 || V_36 > F_44 ( V_6 ) )
return - V_37 ;
V_4 -> V_38 = V_36 ;
#ifdef F_4
F_45 ( & V_6 -> V_39 . V_10 , V_40 , V_36 ) ;
#endif
return 0 ;
}
static int F_46 ( struct V_3 * V_4 , void * V_41 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
...
static void F_51 ( struct V_3 * V_4 , struct V_50 * V_51 )
{
...
static T_2 F_52 ( struct V_3 * V_4 , T_2 V_57 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_53 ( V_6 , V_57 ) ;
}
static void F_54 ( struct V_3 * V_58 )
{
}
...
F_56 (p, n, &br->port_list, list) {
F_57 ( V_41 ) ;
}
}
static int F_58 ( struct V_3 * V_4 , struct V_61 * V_62 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_59 * V_41 , * V_60 ;
int V_63 = 0 ;
...
int F_59 ( struct V_59 * V_41 )
{
struct V_65 * V_66 ;
int V_63 = 0 ;
V_66 = F_60 ( sizeof( * V_41 -> V_66 ) , V_67 ) ;
V_63 = - V_27 ;
if ( ! V_66 )
goto V_26;
V_66 -> V_4 = V_41 -> V_4 ;
F_61 ( V_66 -> V_68 , V_41 -> V_4 -> V_69 , V_70 ) ;
V_63 = F_62 ( V_66 ) ;
if ( V_63 ) {
F_63 ( V_66 ) ;
goto V_26;
...
static int F_66 ( struct V_3 * V_4 , struct V_3 * V_71 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_67 ( V_6 , V_71 ) ;
}
static int F_68 ( struct V_3 * V_4 , struct V_3 * V_71 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_69 ( V_6 , V_71 ) ;
}
