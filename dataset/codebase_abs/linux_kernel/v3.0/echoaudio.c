...
static int T_5 F_97 ( struct V_3 * V_4 )
{
struct V_132 * V_133 ;
int V_6 ;
#ifdef F_41
...
static T_6 F_159 ( int V_205 , void * V_206 )
{
...
static T_5 int F_172 ( struct V_220 * V_141 ,
struct V_221 * V_74 ,
struct V_3 * * V_222 )
{
struct V_3 * V_4 ;
...
F_100 ( ( L_65 ,
V_4 -> V_74 , V_4 -> V_205 , V_4 -> V_74 -> V_233 ) ) ;
...
V_4 -> V_234 = V_4 -> V_215 . V_94 ;
V_4 -> V_214 = (struct V_214 * ) V_4 -> V_215 . V_19 ;
V_6 = F_184 ( V_4 , V_4 -> V_74 -> V_134 , V_4 -> V_74 -> V_233 ) ;
if ( V_6 >= 0 )
V_6 = F_185 ( V_4 ) ;
if ( V_6 < 0 ) {
F_100 ( ( L_67 , V_6 ) ) ;
...
F_100 ( ( L_68 ) ) ;
if ( ( V_6 = F_186 ( V_141 , V_235 , V_4 , & V_225 ) ) < 0 ) {
F_165 ( V_4 ) ;
return V_6 ;
}
* V_222 = V_4 ;
...
static int T_5 F_187 ( struct V_221 * V_74 ,
...
F_100 ( ( L_69 ) ) ;
V_12 = 0 ;
V_6 = F_188 ( V_54 [ V_135 ] , V_172 [ V_135 ] , V_243 , 0 , & V_141 ) ;
if ( V_6 < 0 )
return V_6 ;
...
strcpy ( V_141 -> V_244 , L_70 V_229 ) ;
strcpy ( V_141 -> V_143 , V_4 -> V_245 ) ;
V_238 = L_71 ;
if ( V_237 -> V_134 == 0x3410 )
V_238 = L_72 ;
sprintf ( V_141 -> V_246 , L_73 ,
V_141 -> V_143 , V_237 -> V_247 & 0x000f , V_238 ,
V_4 -> V_228 , V_4 -> V_205 ) ;
if ( ( V_6 = F_97 ( V_4 ) ) < 0 ) {
F_6 ( V_11 L_74 , V_6 ) ;
F_190 ( V_141 ) ;
...
#endif
#ifdef F_41
V_249 . V_62 = F_42 ( V_4 ) * F_104 ( V_4 ) ;
if ( ( V_6 = F_192 ( V_4 -> V_141 , F_193 ( & V_249 , V_4 ) ) ) < 0 )
goto V_250;
#ifdef F_194
V_6 = F_192 ( V_4 -> V_141 ,
F_193 ( & V_251 , V_4 ) ) ;
...
#endif
#ifdef F_195
if ( ( V_6 = F_192 ( V_4 -> V_141 , F_193 ( & V_253 , V_4 ) ) ) < 0 )
goto V_250;
#endif
#ifdef F_196
if ( ! V_4 -> V_254 )
if ( ( V_6 = F_192 ( V_4 -> V_141 , F_193 ( & V_255 , V_4 ) ) ) < 0 )
goto V_250;
#endif
#ifdef F_197
...
goto V_250;
#ifdef F_198
V_259 . V_62 = F_123 ( V_4 ) * F_104 ( V_4 ) ;
...
if ( ( V_6 = F_192 ( V_4 -> V_141 , F_193 ( & V_263 , V_4 ) ) ) < 0 )
goto V_250;
#endif
#ifdef F_201
V_4 -> V_190 = 0 ;
...
if ( V_4 -> V_190 > 1 ) {
V_4 -> V_187 = F_193 ( & V_264 , V_4 ) ;
if ( ( V_6 = F_192 ( V_4 -> V_141 , V_4 -> V_187 ) ) < 0 )
goto V_250;
}
#endif
#ifdef F_101
if ( ( V_6 = F_192 ( V_4 -> V_141 , F_193 ( & V_265 , V_4 ) ) ) < 0 )
goto V_250;
#endif
#ifdef F_202
if ( V_4 -> V_266 )
if ( ( V_6 = F_192 ( V_4 -> V_141 , F_193 ( & V_267 , V_4 ) ) ) < 0 )
goto V_250;
#endif
V_6 = F_203 ( V_141 ) ;
if ( V_6 < 0 )
goto V_250;
F_6 ( V_268 L_76 , V_141 -> V_246 ) ;
F_204 ( V_74 , V_4 ) ;
V_135 ++ ;
return 0 ;
V_250:
...
static int F_205 ( struct V_221 * V_74 , T_7 V_119 )
{
struct V_3 * V_4 = F_206 ( V_74 ) ;
F_100 ( ( L_78 ) ) ;
F_207 ( V_4 -> V_142 ) ;
F_207 ( V_4 -> V_148 ) ;
#ifdef F_162
...
static int F_213 ( struct V_221 * V_74 )
{
struct V_3 * V_4 = F_206 ( V_74 ) ;
struct V_214 * V_273 , * V_274 ;
V_41 V_275 ;
int V_6 ;
F_100 ( ( L_80 ) ) ;
F_214 ( V_74 ) ;
V_274 = F_215 ( sizeof( struct V_3 ) , V_52 ) ;
if ( V_274 == NULL )
return - V_53 ;
V_273 = V_4 -> V_214 ;
memcpy ( V_274 , V_273 , sizeof( struct V_214 ) ) ;
V_6 = F_184 ( V_4 , V_4 -> V_74 -> V_134 , V_4 -> V_74 -> V_233 ) ;
if ( V_6 < 0 ) {
F_12 ( V_274 ) ;
F_100 ( ( L_81 , V_6 ) ) ;
...
F_100 ( ( L_83 ) ) ;
memcpy ( & V_273 -> V_276 , & V_274 -> V_276 ,
sizeof( V_273 -> V_276 ) ) ;
memcpy ( & V_273 -> V_277 , & V_274 -> V_277 ,
sizeof( V_273 -> V_277 ) ) ;
memcpy ( & V_273 -> V_278 , & V_274 -> V_278 ,
sizeof( V_273 -> V_278 ) ) ;
F_12 ( V_274 ) ;
if ( F_183 ( V_74 -> V_205 , F_159 , V_232 ,
V_229 , V_4 ) ) {
...
static void T_8 F_218 ( struct V_221 * V_74 )
{
struct V_3 * V_4 ;
V_4 = F_206 ( V_74 ) ;
if ( V_4 )
