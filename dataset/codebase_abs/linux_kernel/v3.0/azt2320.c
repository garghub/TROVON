...
static int T_1 F_9 ( unsigned long V_14 , unsigned char V_23 )
{
int V_24 ;
unsigned long V_25 ;
V_25 = V_26 + V_27 / 10 ;
...
static int T_1 F_13 ( unsigned long V_14 )
{
int error ;
...
struct V_32 * V_33 ;
struct V_34 * V_35 ;
error = F_16 ( V_36 [ V_1 ] , V_7 [ V_1 ] , V_37 ,
...
F_18 ( V_5 , & V_29 -> V_5 -> V_1 ) ;
if ( ( error = F_13 ( V_14 [ V_1 ] ) ) ) {
F_17 ( V_5 ) ;
return error ;
}
error = F_19 ( V_5 , V_16 [ V_1 ] , - 1 ,
V_19 [ V_1 ] ,
V_17 [ V_1 ] , V_18 [ V_1 ] ,
V_39 , 0 , & V_33 ) ;
if ( error < 0 ) {
...
if ( ( error = F_25 ( V_35 , 1 , 2 ) ) < 0 ) {
F_17 ( V_5 ) ;
return error ;
}
if ( ( error = F_26 ( V_35 , 0 , 1 , NULL ) ) < 0 ) {
F_17 ( V_5 ) ;
return error ;
}
}
...
static void T_2 F_30 ( struct V_4 * V_29 )
{
F_17 ( F_31 ( V_29 ) ) ;
F_28 ( V_29 , NULL ) ;
}
static int F_32 ( struct V_4 * V_29 , T_3 V_51 )
{
struct V_31 * V_5 = F_31 ( V_29 ) ;
...
static int F_34 ( struct V_4 * V_29 )
{
struct V_31 * V_5 = F_31 ( V_29 ) ;
struct V_2 * V_3 = V_5 -> V_38 ;
struct V_32 * V_33 = V_3 -> V_33 ;
