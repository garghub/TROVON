...
while ( ! F_2 () ) {
F_3 ( & V_7 -> V_9 ) ;
V_8 = F_4 ( & V_7 -> V_10 , & V_3 , sizeof( V_3 ) ) ;
if ( ! V_8 ) {
F_5 ( V_11 ) ;
if ( F_2 () )
F_5 ( V_12 ) ;
...
V_15 -> V_7 -> V_15 = V_15 ;
V_15 -> V_7 -> V_44 = ~ 0 ;
V_25 = F_34 ( & V_15 -> V_7 -> V_10 ,
sizeof( struct V_2 ) * V_45 ,
V_43 ) ;
if ( V_25 < 0 )
goto V_46;
F_35 ( & V_15 -> V_7 -> V_9 ) ;
V_15 -> V_7 -> V_40 = F_36 ( F_1 , V_15 -> V_7 ,
L_5 , V_15 -> V_47 ) ;
if ( F_37 ( V_15 -> V_7 -> V_40 ) ) {
V_25 = F_38 ( V_15 -> V_7 -> V_40 ) ;
goto V_46;
}
F_9 ( & V_13 ) ;
F_39 ( & V_15 -> V_7 -> V_48 , & V_49 ) ;
F_10 (handler, &ir_raw_handler_list, list)
if ( V_5 -> V_50 )
V_5 -> V_50 ( V_15 ) ;
F_11 ( & V_13 ) ;
