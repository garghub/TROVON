...
static struct V_2 * F_63 ( struct V_72 * V_72 , struct V_73 * V_2 , int V_74 , T_3 V_75 )
{
struct V_2 * V_3 ;
V_3 = F_64 ( V_72 , V_76 , V_75 , & V_77 ) ;
if ( ! V_3 )
return NULL ;
F_65 ( V_2 , V_3 ) ;
F_66 ( & F_23 ( V_3 ) -> V_78 ) ;
...
static int F_70 ( struct V_72 * V_72 , struct V_73 * V_2 , int V_83 ,
int V_84 )
{
struct V_2 * V_3 ;
F_2 ( L_11 , V_2 ) ;
...
return - V_87 ;
V_2 -> V_88 = & V_89 ;
V_3 = F_63 ( V_72 , V_2 , V_83 , V_19 ) ;
if ( ! V_3 )
return - V_36 ;
F_62 ( V_3 , NULL ) ;
return 0 ;
}
static int F_71 ( struct V_73 * V_2 , struct V_90 * V_91 , int V_92 )
{
...
static int F_74 ( struct V_73 * V_2 , struct V_90 * V_91 , int V_101 , int V_102 )
{
struct V_93 * V_94 = (struct V_93 * ) V_91 ;
struct V_2 * V_3 = V_2 -> V_3 ;
int V_26 = 0 ;
...
goto V_35;
V_26 = F_75 ( V_3 , V_38 ,
F_76 ( V_3 , V_102 & V_103 ) ) ;
V_35:
F_61 ( V_3 ) ;
return V_26 ;
}
static int F_77 ( struct V_73 * V_2 , int V_104 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_26 = 0 ;
F_2 ( L_13 , V_3 , V_104 ) ;
...
static int F_78 ( struct V_73 * V_2 , struct V_73 * V_107 , int V_102 )
{
F_79 ( V_108 , V_109 ) ;
...
V_111 = F_80 ( V_3 , V_102 & V_103 ) ;
F_2 ( L_14 , V_3 , V_111 ) ;
F_81 ( F_82 ( V_3 ) , & V_108 ) ;
while ( ! ( V_110 = F_54 ( V_3 , V_107 ) ) ) {
F_83 ( V_112 ) ;
if ( ! V_111 ) {
V_26 = - V_113 ;
break;
...
static int F_88 ( struct V_73 * V_2 , struct V_90 * V_91 , int * V_43 , int V_116 )
{
struct V_93 * V_94 = (struct V_93 * ) V_91 ;
struct V_2 * V_3 = V_2 -> V_3 ;
F_2 ( L_16 , V_2 , V_3 ) ;
...
static int F_89 ( struct V_117 * V_118 , struct V_73 * V_2 ,
...
static int F_91 ( struct V_73 * V_2 , int V_122 , int V_123 , char T_5 * V_124 , unsigned int V_125 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_26 = 0 ;
F_2 ( L_7 , V_3 ) ;
...
static int F_92 ( struct V_73 * V_2 , int V_123 , char T_5 * V_124 , int T_5 * V_125 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_127 V_128 ;
struct V_129 V_130 ;
...
static int F_95 ( struct V_73 * V_2 , int V_122 , int V_123 , char T_5 * V_124 , int T_5 * V_125 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_43 , V_26 = 0 ;
F_2 ( L_7 , V_3 ) ;
if ( V_122 == V_136 )
return F_92 ( V_2 , V_123 , V_124 , V_125 ) ;
if ( F_93 ( V_43 , V_125 ) )
return - V_51 ;
F_60 ( V_3 ) ;
switch ( V_123 ) {
...
static int F_96 ( struct V_73 * V_2 , int V_137 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_26 = 0 ;
F_2 ( L_16 , V_2 , V_3 ) ;
...
static int F_97 ( struct V_73 * V_2 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_26 = 0 ;
F_2 ( L_16 , V_2 , V_3 ) ;
...
static void F_100 ( struct V_11 * V_17 )
{
struct V_2 * V_27 ;
...
static int F_103 ( struct V_15 * V_16 , T_2 * V_22 , T_1 type )
{
register struct V_2 * V_3 ;
struct V_54 * V_55 ;
int V_144 = 0 ;
if ( type != V_32 && type != V_31 )
return - V_47 ;
...
static int F_104 ( struct V_12 * V_13 , T_1 V_14 )
{
F_2 ( L_21 , V_13 , F_24 ( & V_13 -> V_23 ) , V_14 ) ;
if ( V_13 -> type != V_32 && V_13 -> type != V_31 )
return - V_47 ;
if ( ! V_14 ) {
struct V_11 * V_17 ;
V_17 = F_11 ( V_13 , V_14 ) ;
...
F_17 ( V_13 , F_105 ( V_14 ) ) ;
return 0 ;
}
static int F_106 ( struct V_12 * V_13 , T_1 V_147 )
{
F_2 ( L_22 , V_13 , V_147 ) ;
if ( V_13 -> type != V_32 && V_13 -> type != V_31 )
return - V_47 ;
F_17 ( V_13 , F_105 ( V_147 ) ) ;
return 0 ;
}
static int F_107 ( struct V_12 * V_13 , struct V_44 * V_45 )
{
struct V_11 * V_17 = V_13 -> V_18 ;
if ( ! V_17 )
goto V_52;
...
static int F_108 ( struct V_148 * V_149 , void * V_150 )
{
struct V_2 * V_3 ;
struct V_54 * V_55 ;
F_109 ( & V_58 . V_20 ) ;
F_46 (sk, node, &sco_sk_list.head) {
F_110 ( V_149 , L_24 , F_24 ( & F_23 ( V_3 ) -> V_21 ) ,
...
{
return F_113 ( V_152 , F_108 , V_151 -> V_153 ) ;
}
int T_6 F_114 ( void )
{
int V_26 ;
