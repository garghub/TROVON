...
if ( F_37 ( V_13 -> V_36 , F_13 , V_73 | V_74 ,
L_5 , V_13 ) ) {
F_35 ( V_13 -> V_15 , V_63 ) ;
return - V_75 ;
}
...
F_12 ( & V_2 -> V_30 , 0 ) ;
F_33 ( V_65 L_7 ,
V_76 , V_13 -> V_15 , V_13 -> V_36 , V_2 -> V_66 , V_77 [ V_55 ] ) ;
return 0 ;
}
...
F_35 ( V_13 -> V_15 , V_63 ) ;
F_33 ( V_65 L_8 ,
V_76 , V_13 -> V_15 , V_13 -> V_36 ) ;
return 0 ;
}
static int F_40 ( struct V_1 * V_2 , const char * V_78 )
{
unsigned int V_66 ;
if ( ! strncmp ( V_78 , L_9 , 3 ) ) {
V_66 = F_41 ( V_78 + 3 , NULL , 10 ) ;
if ( V_66 >= 3 && V_66 <= 48 )
V_2 -> V_66 = V_66 * 100 ;
}
if ( strchr ( V_78 , '*' ) )
...
static int F_42 ( struct V_12 * V_13 , struct V_79 * V_80 ,
...
break;
case V_87 :
sprintf ( V_82 -> V_88 . V_89 , L_10 , V_2 -> V_66 / 100 ) ;
if ( V_2 -> V_31 <= 0 )
strcat ( V_82 -> V_88 . V_89 , ( ! V_2 -> V_31 ) ? L_11 : L_12 ) ;
if ( F_44 ( V_80 -> V_90 , V_82 , sizeof( struct V_81 ) ) )
return - V_91 ;
return 0 ;
case V_92 :
if ( F_45 ( V_13 ) || ! F_46 ( V_93 ) )
return - V_69 ;
V_82 -> V_88 . V_89 [ sizeof( V_82 -> V_88 . V_89 ) - 1 ] = '\0' ;
return F_40 ( V_2 , V_82 -> V_88 . V_89 ) ;
case V_94 :
strcpy ( V_82 -> V_88 . V_89 , L_13 ) ;
if ( F_44 ( V_80 -> V_90 , V_82 , sizeof( struct V_81 ) ) )
return - V_91 ;
return 0 ;
case V_95 :
...
if ( F_47 ( & V_84 , V_80 -> V_90 , sizeof( V_84 ) ) )
return - V_91 ;
switch ( V_84 . V_83 ) {
default:
return - V_86 ;
#ifdef F_2
case V_98 :
V_84 . V_88 . V_99 . V_100 = V_2 -> V_30 . V_101 ;
V_84 . V_88 . V_99 . V_102 = V_2 -> V_5 . V_9 ;
V_84 . V_88 . V_99 . V_103 = V_2 -> V_5 . V_10 ;
break;
#endif
}
if ( F_44 ( V_80 -> V_90 , & V_84 , sizeof( V_84 ) ) )
return - V_91 ;
return 0 ;
}
...
struct V_1 * V_2 ;
char V_109 [ V_110 ] ;
sprintf ( V_109 , L_14 , V_104 ) ;
if ( ! V_111 [ V_104 ] )
V_106 = 0 ;
if ( ! V_106 )
V_51 [ V_104 ] = V_36 [ V_104 ] = 0 ;
V_13 = F_49 ( & V_112 ,
sizeof( struct V_1 ) ,
V_109 , V_51 [ V_104 ] , V_36 [ V_104 ] , 0 ) ;
if ( F_50 ( V_13 ) )
break;
V_2 = F_14 ( V_13 ) ;
if ( V_106 && F_40 ( V_2 , V_111 [ V_104 ] ) )
V_106 = 0 ;
V_2 -> V_66 = V_66 [ V_104 ] ;
V_105 ++ ;
V_113 [ V_104 ] = V_13 ;
...
int V_104 ;
for( V_104 = 0 ; V_104 < V_108 ; V_104 ++ ) {
struct V_12 * V_13 = V_113 [ V_104 ] ;
if ( V_13 )
F_52 ( V_13 ) ;
}
}
static int T_3 F_53 ( char * V_114 )
{
static unsigned V_115 ;
int V_116 [ 4 ] ;
if ( V_115 >= V_108 )
return 0 ;
V_114 = F_54 ( V_114 , 4 , V_116 ) ;
if ( V_116 [ 0 ] < 2 )
return 0 ;
V_111 [ V_115 ] = V_114 ;
V_51 [ V_115 ] = V_116 [ 1 ] ;
