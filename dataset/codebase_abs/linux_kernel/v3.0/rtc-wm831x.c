...
static T_3 F_21 ( int V_31 , void * V_25 )
{
struct V_5 * V_5 = V_25 ;
F_20 ( V_5 -> V_32 , 1 , V_33 | V_36 ) ;
return V_35 ;
}
static int F_22 ( struct V_1 * V_2 )
{
struct V_37 * V_38 = F_23 ( V_2 ) ;
struct V_5 * V_5 = F_2 ( & V_38 -> V_2 ) ;
int V_9 , V_39 ;
if ( V_5 -> V_29 && F_24 ( & V_38 -> V_2 ) )
V_39 = V_27 ;
else
V_39 = 0 ;
...
V_27 , 0 ) ;
if ( V_9 != 0 )
F_4 ( & V_38 -> V_2 , L_16 , V_9 ) ;
return 0 ;
}
static int F_27 ( struct V_37 * V_38 )
{
struct V_6 * V_6 = F_2 ( V_38 -> V_2 . V_40 ) ;
struct V_5 * V_5 ;
int V_41 = F_28 ( V_38 , L_17 ) ;
int V_42 = F_28 ( V_38 , L_18 ) ;
int V_9 = 0 ;
V_5 = F_29 ( sizeof( * V_5 ) , V_43 ) ;
if ( V_5 == NULL )
return - V_44 ;
F_30 ( V_38 , V_5 ) ;
V_5 -> V_6 = V_6 ;
V_9 = F_3 ( V_6 , V_11 ) ;
if ( V_9 < 0 ) {
F_4 ( & V_38 -> V_2 , L_1 , V_9 ) ;
goto V_45;
}
if ( V_9 & V_27 )
V_5 -> V_29 = 1 ;
F_31 ( & V_38 -> V_2 , 1 ) ;
V_5 -> V_32 = F_32 ( L_19 , & V_38 -> V_2 ,
& V_46 , V_47 ) ;
if ( F_33 ( V_5 -> V_32 ) ) {
V_9 = F_34 ( V_5 -> V_32 ) ;
goto V_45;
}
V_9 = F_35 ( V_41 , NULL , F_21 ,
V_48 , L_20 ,
V_5 ) ;
if ( V_9 != 0 ) {
F_4 ( & V_38 -> V_2 , L_21 ,
...
static int T_4 F_37 ( struct V_37 * V_38 )
{
struct V_5 * V_5 = F_38 ( V_38 ) ;
int V_41 = F_28 ( V_38 , L_17 ) ;
int V_42 = F_28 ( V_38 , L_18 ) ;
F_39 ( V_42 , V_5 ) ;
F_39 ( V_41 , V_5 ) ;
