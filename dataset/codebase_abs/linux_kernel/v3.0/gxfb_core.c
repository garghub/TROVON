...
static struct V_8 * T_1 F_22 ( struct V_48 * V_36 )
{
struct V_37 * V_38 ;
struct V_8 * V_9 ;
...
static int F_26 ( struct V_35 * V_71 , T_4 V_72 )
{
...
static int T_1 F_35 ( struct V_35 * V_71 ,
const struct V_76 * V_49 )
{
struct V_37 * V_38 ;
struct V_8 * V_9 ;
int V_39 ;
...
F_42 ( V_71 , V_9 ) ;
F_34 ( V_86 L_10 , V_9 -> V_69 , V_9 -> V_20 . V_49 ) ;
return 0 ;
V_80:
if ( V_9 -> V_46 ) {
F_43 ( V_9 -> V_46 ) ;
...
static void T_5 F_46 ( struct V_35 * V_71 )
{
struct V_8 * V_9 = F_27 ( V_71 ) ;
struct V_37 * V_38 = V_9 -> V_38 ;
F_47 ( V_9 ) ;
F_43 ( ( void V_87 * ) V_9 -> V_46 ) ;
F_44 ( V_71 , 0 ) ;
F_43 ( V_38 -> V_40 ) ;
F_44 ( V_71 , 3 ) ;
F_43 ( V_38 -> V_42 ) ;
...
static int T_6 F_48 ( char * V_88 )
{
char * V_89 ;
if ( ! V_88 || ! * V_88 )
return 0 ;
while ( ( V_89 = F_49 ( & V_88 , L_11 ) ) != NULL ) {
if ( ! * V_89 )
continue;
V_84 = V_89 ;
}
