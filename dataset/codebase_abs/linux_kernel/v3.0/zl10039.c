...
F_2 ( L_1 , V_15 ) ;
F_2 ( L_8 ,
V_28 -> V_31 , V_28 -> V_32 . V_33 . V_34 ) ;
div = ( V_28 -> V_31 * 1000 ) / 126387 ;
V_30 = ( V_28 -> V_32 . V_33 . V_34 * 27 ) / 32000 ;
V_29 = ( ( V_30 * 5088 ) / 1011100 ) - 1 ;
V_5 [ 0 ] = ( div >> 8 ) & 0x7f ;
V_5 [ 1 ] = ( div >> 0 ) & 0xff ;
V_5 [ 2 ] = 0x1D ;
V_5 [ 3 ] = 0x40 ;
...
if ( V_21 -> V_24 . V_25 )
V_21 -> V_24 . V_25 ( V_21 , 1 ) ;
V_23 = F_6 ( V_2 , V_35 , 0x0A ) ;
if ( V_23 < 0 )
goto error;
V_23 = F_4 ( V_2 , V_36 , V_5 , sizeof( V_5 ) ) ;
if ( V_23 < 0 )
goto error;
V_23 = F_6 ( V_2 , V_35 , 0x6A ) ;
if ( V_23 < 0 )
goto error;
if ( V_21 -> V_24 . V_25 )
V_21 -> V_24 . V_25 ( V_21 , 0 ) ;
...
T_1 V_11 , struct V_37 * V_16 )
{
struct V_1 * V_2 = NULL ;
F_2 ( L_1 , V_15 ) ;
V_2 = F_13 ( sizeof( struct V_1 ) , V_38 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_16 = V_16 ;
V_2 -> V_11 = V_11 ;
...
if ( V_21 -> V_24 . V_25 )
V_21 -> V_24 . V_25 ( V_21 , 0 ) ;
V_2 -> V_39 = V_2 -> V_39 & 0x0f ;
switch ( V_2 -> V_39 ) {
case V_40 :
strcpy ( V_21 -> V_24 . V_41 . V_42 . V_43 ,
L_10 ) ;
break;
default:
F_2 ( L_11 , V_2 -> V_39 ) ;
...
memcpy ( & V_21 -> V_24 . V_41 , & V_44 , sizeof( struct V_45 ) ) ;
V_21 -> V_22 = V_2 ;
F_2 ( L_12 , V_11 ) ;
return V_21 ;
error:
