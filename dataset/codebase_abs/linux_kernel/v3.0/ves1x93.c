...
static int F_19 ( struct V_46 * V_47 , struct V_69 * V_70 )
{
struct V_1 * V_2 = V_47 -> V_48 ;
if ( V_47 -> V_71 . V_72 . V_73 ) {
V_47 -> V_71 . V_72 . V_73 ( V_47 , V_70 ) ;
if ( V_47 -> V_71 . V_74 ) V_47 -> V_71 . V_74 ( V_47 , 0 ) ;
}
F_7 ( V_2 , V_70 -> V_22 ) ;
F_8 ( V_2 , V_70 -> V_75 . V_76 . V_77 ) ;
F_10 ( V_2 , V_70 -> V_75 . V_76 . V_78 ) ;
V_2 -> V_22 = V_70 -> V_22 ;
return 0 ;
}
static int F_20 ( struct V_46 * V_47 , struct V_69 * V_70 )
{
struct V_1 * V_2 = V_47 -> V_48 ;
int V_79 ;
V_79 = ( ( int ) ( ( char ) ( F_4 ( V_2 , 0x0a ) << 1 ) ) ) / 2 ;
V_79 = ( V_79 * ( int ) ( V_70 -> V_75 . V_76 . V_78 / 1000 / 8 ) ) / 16 ;
V_70 -> V_80 -= V_79 ;
if ( V_2 -> V_22 == V_26 )
V_70 -> V_22 = ( F_4 ( V_2 , 0x0f ) & 2 ) ?
V_24 : V_25 ;
V_70 -> V_75 . V_76 . V_77 = F_9 ( V_2 ) ;
return 0 ;
}
...
static int F_24 ( struct V_46 * V_47 , int V_81 )
{
struct V_1 * V_2 = V_47 -> V_48 ;
if ( V_81 ) {
...
struct V_46 * F_25 ( const struct V_82 * V_9 ,
struct V_83 * V_14 )
{
struct V_1 * V_2 = NULL ;
T_1 V_84 ;
...
V_2 -> V_21 = V_89 ;
V_2 -> V_51 = V_90 ;
V_2 -> V_50 = sizeof( V_89 ) ;
break;
default:
goto error;
}
memcpy ( & V_2 -> V_91 . V_71 , & V_92 , sizeof( struct V_93 ) ) ;
V_2 -> V_91 . V_48 = V_2 ;
return & V_2 -> V_91 ;
error:
F_23 ( V_2 ) ;
