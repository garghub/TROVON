...
{
static int V_103 ;
static const struct V_104 V_105 = {
. V_106 = V_107 ,
. V_108 = V_109 ,
. V_110 = V_111 ,
. V_112 = & V_113 ,
...
struct V_79 * V_7 ;
const struct V_104 * V_114 [] = { & V_105 , NULL } ;
int V_90 ;
if ( ! V_103 ++ )
F_43 ( V_115 , & V_6 -> V_8 , L_31 V_116 L_32 ) ;
V_90 = F_47 ( V_6 ) ;
if ( V_90 )
return V_90 ;
F_6 ( V_115 L_33 ,
V_6 -> V_19 ) ;
V_7 = F_48 ( & V_6 -> V_8 , V_114 , V_83 ) ;
if ( ! V_7 ) {
F_43 ( V_98 , & V_6 -> V_8 ,
L_34 ) ;
V_90 = - V_77 ;
...
V_90 = F_36 ( V_7 ) ;
if ( V_90 ) {
F_43 ( V_98 , & V_6 -> V_8 , L_35 ) ;
goto V_117;
}
F_49 ( V_6 ) ;
V_90 = F_50 ( V_7 , V_6 -> V_118 , V_119 ,
V_120 , & V_121 ) ;
if ( V_90 )
F_43 ( V_98 , & V_6 -> V_8 , L_36 ) ;
V_117:
return V_90 ;
}
static int F_51 ( struct V_5 * V_6 )
{
struct V_79 * V_7 = F_52 ( & V_6 -> V_8 ) ;
int V_90 ;
V_90 = F_53 ( V_6 ) ;
if ( V_90 )
return V_90 ;
