...
F_48 () ;
F_49 (c) {
if ( ! strcmp ( V_130 -> V_132 , L_8 ) && V_130 -> V_38 == 0 )
break;
}
F_50 () ;
if ( V_130 ) {
...
static unsigned long F_60 ( void * V_135 )
{
return F_61 ( F_62 ( V_135 ) ) ;
}
static void F_41 ( struct V_1 * V_2 ,
struct V_30 * V_30 )
{
int V_136 ;
int V_137 = V_40 / sizeof( V_2 -> V_109 [ 0 ] ) ;
for ( V_136 = 0 ; V_136 < V_2 -> V_108 ; V_136 ++ )
V_2 -> V_109 [ V_136 ] = F_60 ( V_2 -> V_106 + V_136 * V_40 ) ;
for ( V_136 = 0 ; V_136 * V_137 < V_2 -> V_108 ; V_136 ++ )
V_2 -> V_6 -> V_138 [ V_136 ] = F_60 ( & V_2 -> V_109 [ V_136 * V_137 ] ) ;
V_2 -> V_6 -> V_15 = V_30 -> V_43 . V_45 ;
V_2 -> V_6 -> V_16 = V_30 -> V_43 . V_44 ;
V_2 -> V_6 -> V_77 = V_30 -> V_43 . V_56 ;
V_2 -> V_6 -> V_42 = V_30 -> V_41 . V_42 ;
V_2 -> V_6 -> V_139 = V_30 -> V_41 . V_80 ;
...
V_96 = F_67 ( V_142 , V_92 -> V_146 , L_11 , L_12 ,
F_68 ( V_2 -> V_6 ) ) ;
if ( V_96 )
goto V_147;
V_96 = F_67 ( V_142 , V_92 -> V_146 , L_13 , L_14 ,
V_140 ) ;
if ( V_96 )
goto V_147;
V_96 = F_67 ( V_142 , V_92 -> V_146 , L_15 , L_16 ,
V_148 ) ;
if ( V_96 )
goto V_147;
V_96 = F_67 ( V_142 , V_92 -> V_146 , L_17 , L_18 ) ;
if ( V_96 )
goto V_147;
V_96 = F_69 ( V_142 , 0 ) ;
if ( V_96 ) {
