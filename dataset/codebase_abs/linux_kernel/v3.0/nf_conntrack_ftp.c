...
struct V_36 * V_60 = & F_21 ( V_42 ) -> F_19 . V_60 ;
struct V_61 * exp ;
union V_62 * V_63 ;
struct V_15 V_16 = {} ;
unsigned int V_13 ;
...
V_16 . V_26 = F_27 ( V_42 ) ;
memcpy ( V_16 . V_18 . V_74 , & V_42 -> V_75 [ V_38 ] . V_76 . V_1 . V_18 . V_74 ,
sizeof( V_16 . V_18 . V_74 ) ) ;
for ( V_13 = 0 ; V_13 < F_28 ( V_77 [ V_38 ] ) ; V_13 ++ ) {
V_64 = F_12 ( V_56 , V_52 ,
V_77 [ V_38 ] [ V_13 ] . V_30 ,
V_77 [ V_38 ] [ V_13 ] . V_31 ,
V_77 [ V_38 ] [ V_13 ] . V_32 ,
...
if ( V_64 == - 1 ) {
F_5 ( L_19 ,
V_77 [ V_38 ] [ V_13 ] . V_30 , F_26 ( V_54 -> V_35 ) , V_52 ) ;
V_7 = V_78 ;
goto V_79;
} else if ( V_64 == 0 ) {
V_7 = V_69 ;
...
V_63 = & V_42 -> V_75 [ ! V_38 ] . V_76 . V_4 . V_18 ;
if ( ( V_16 . V_26 == F_27 ( V_42 ) ) &&
memcmp ( & V_16 . V_18 . V_74 , & V_42 -> V_75 [ V_38 ] . V_76 . V_1 . V_18 . V_74 ,
sizeof( V_16 . V_18 . V_74 ) ) ) {
if ( V_16 . V_26 == V_27 ) {
F_5 ( L_21 ,
& V_16 . V_18 . V_19 ,
& V_42 -> V_75 [ V_38 ] . V_76 . V_1 . V_18 . V_19 ) ;
} else {
F_5 ( L_22 ,
V_16 . V_18 . V_29 ,
V_42 -> V_75 [ V_38 ] . V_76 . V_1 . V_18 . V_29 ) ;
}
if ( ! V_80 ) {
V_7 = V_69 ;
goto V_81;
...
F_30 ( exp , V_82 , V_16 . V_26 ,
& V_42 -> V_75 [ ! V_38 ] . V_76 . V_1 . V_18 , V_63 ,
V_83 , NULL , & V_16 . V_20 . V_21 . V_22 ) ;
V_66 = F_31 ( V_84 ) ;
if ( V_66 && V_42 -> V_85 & V_86 )
V_7 = V_66 ( V_45 , V_50 , V_77 [ V_38 ] [ V_13 ] . V_87 ,
V_59 , V_58 , exp ) ;
else {
if ( F_32 ( exp ) != 0 )
V_7 = V_78 ;
...
if ( V_90 [ V_13 ] [ V_88 ] . V_91 == NULL )
continue;
F_5 ( L_23
L_24 ,
V_90 [ V_13 ] [ V_88 ] . V_76 . V_1 . V_26 , V_92 [ V_13 ] ) ;
F_36 ( & V_90 [ V_13 ] [ V_88 ] ) ;
}
}
F_37 ( V_72 ) ;
...
{
int V_13 , V_88 = - 1 , V_7 = 0 ;
char * V_93 ;
V_72 = F_39 ( 65536 , V_94 ) ;
if ( ! V_72 )
return - V_95 ;
if ( V_89 == 0 )
V_92 [ V_89 ++ ] = V_96 ;
for ( V_13 = 0 ; V_13 < V_89 ; V_13 ++ ) {
V_90 [ V_13 ] [ 0 ] . V_76 . V_1 . V_26 = V_27 ;
V_90 [ V_13 ] [ 1 ] . V_76 . V_1 . V_26 = V_28 ;
for ( V_88 = 0 ; V_88 < 2 ; V_88 ++ ) {
V_90 [ V_13 ] [ V_88 ] . V_76 . V_1 . V_20 . V_21 . V_22 = F_8 ( V_92 [ V_13 ] ) ;
V_90 [ V_13 ] [ V_88 ] . V_76 . V_4 . V_97 = V_83 ;
V_90 [ V_13 ] [ V_88 ] . V_98 = & V_99 ;
V_90 [ V_13 ] [ V_88 ] . V_91 = V_100 ;
V_90 [ V_13 ] [ V_88 ] . F_19 = F_19 ;
V_93 = & V_101 [ V_13 ] [ V_88 ] [ 0 ] ;
if ( V_92 [ V_13 ] == V_96 )
sprintf ( V_93 , L_25 ) ;
else
sprintf ( V_93 , L_26 , V_92 [ V_13 ] ) ;
V_90 [ V_13 ] [ V_88 ] . V_102 = V_93 ;
F_5 ( L_27
L_24 ,
V_90 [ V_13 ] [ V_88 ] . V_76 . V_1 . V_26 , V_92 [ V_13 ] ) ;
V_7 = F_40 ( & V_90 [ V_13 ] [ V_88 ] ) ;
if ( V_7 ) {
F_41 ( V_103 L_28
L_29 ,
V_90 [ V_13 ] [ V_88 ] . V_76 . V_1 . V_26 , V_92 [ V_13 ] ) ;
