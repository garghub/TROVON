...
static int F_35 ( struct V_8 * V_9 , struct V_38 * V_39 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
V_2 -> V_11 = & V_56 ;
return F_24 ( V_9 , V_39 ) ;
}
static int F_36 ( struct V_8 * V_9 , struct V_6 * V_7 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
...
if ( V_57 == NULL )
goto V_59;
F_38 ( V_7 , V_47 , sizeof( V_39 ) , & V_39 ) ;
return F_39 ( V_7 , V_57 ) ;
V_59:
F_40 ( V_7 , V_57 ) ;
return - V_60 ;
}
static int F_41 ( struct V_8 * V_9 , struct V_61 * V_62 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
struct V_63 V_64 = {
...
return F_42 ( V_62 , & V_64 , sizeof( V_64 ) ) ;
}
static int F_43 ( struct V_8 * V_9 , unsigned long V_67 ,
...
static int F_45 ( struct V_8 * V_9 , unsigned long V_73 , struct V_8 * V_74 ,
struct V_8 * * V_75 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
if ( V_74 == NULL )
...
static struct V_8 * F_46 ( struct V_8 * V_9 , unsigned long V_73 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
return V_2 -> V_11 ;
}
static unsigned long F_47 ( struct V_8 * V_9 , T_1 V_76 )
{
return 1 ;
}
static void F_48 ( struct V_8 * V_9 , unsigned long V_73 )
{
}
static void F_49 ( struct V_8 * V_9 , struct V_77 * V_78 )
{
if ( ! V_78 -> V_79 ) {
