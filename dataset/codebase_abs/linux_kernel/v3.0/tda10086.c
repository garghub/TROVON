...
{
T_1 V_63 ;
F_3 ( L_6 , V_16 , V_44 -> V_61 . V_62 . V_64 ) ;
switch( V_44 -> V_61 . V_62 . V_64 ) {
case V_65 :
V_63 = 0x00 ;
break;
case V_66 :
...
F_1 ( V_2 , 0x02 , 0x35 ) ;
V_2 -> V_76 = false ;
if ( V_22 -> V_77 . V_78 . V_79 ) {
V_22 -> V_77 . V_78 . V_79 ( V_22 , V_44 ) ;
if ( V_22 -> V_77 . V_80 )
V_22 -> V_77 . V_80 ( V_22 , 0 ) ;
if ( V_22 -> V_77 . V_78 . V_81 )
V_22 -> V_77 . V_78 . V_81 ( V_22 , & V_74 ) ;
if ( V_22 -> V_77 . V_80 )
V_22 -> V_77 . V_80 ( V_22 , 0 ) ;
}
V_75 = V_44 -> V_82 - V_74 ;
V_75 = ( ( 1 << 16 ) * V_75 ) / ( V_28 / 1000 ) ;
F_1 ( V_2 , 0x3d , 0x80 | ( ( V_75 >> 8 ) & 0x7f ) ) ;
F_1 ( V_2 , 0x3e , V_75 ) ;
...
V_2 -> V_60 = V_44 -> V_61 . V_62 . V_60 ;
V_2 -> V_82 = V_44 -> V_82 ;
return 0 ;
}
static int F_20 ( struct V_21 * V_22 , struct V_43 * V_44 )
{
struct V_1 * V_2 = V_22 -> V_23 ;
T_1 V_20 ;
int V_57 ;
T_4 V_83 ;
F_3 ( L_3 , V_16 ) ;
if ( V_44 -> V_61 . V_62 . V_60 < 500000 )
return - V_39 ;
V_83 = F_4 ( V_2 , 0x52 ) ;
V_83 |= ( F_4 ( V_2 , 0x51 ) << 8 ) ;
if ( V_83 & 0x8000 )
V_83 |= 0xffffffffffff0000ULL ;
V_83 = ( V_83 * ( V_28 / 1000ULL ) ) ;
F_17 ( V_83 , ( 1ULL << 15 ) * ( 1ULL << 1 ) ) ;
V_44 -> V_82 = ( int ) V_2 -> V_82 + ( int ) V_83 ;
V_20 = F_4 ( V_2 , 0x0c ) ;
if ( V_20 & 0x80 ) {
switch( V_20 & 0x40 ) {
case 0x00 :
...
V_44 -> V_61 . V_62 . V_60 = V_2 -> V_60 + V_57 ;
V_20 = ( F_4 ( V_2 , 0x0d ) & 0x70 ) >> 4 ;
switch( V_20 ) {
case 0x00 :
V_44 -> V_61 . V_62 . V_64 = V_65 ;
break;
case 0x01 :
V_44 -> V_61 . V_62 . V_64 = V_66 ;
break;
case 0x02 :
V_44 -> V_61 . V_62 . V_64 = V_67 ;
break;
case 0x03 :
V_44 -> V_61 . V_62 . V_64 = V_68 ;
break;
case 0x04 :
V_44 -> V_61 . V_62 . V_64 = V_69 ;
break;
case 0x05 :
V_44 -> V_61 . V_62 . V_64 = V_70 ;
break;
case 0x06 :
V_44 -> V_61 . V_62 . V_64 = V_71 ;
break;
case 0x07 :
V_44 -> V_61 . V_62 . V_64 = V_72 ;
break;
}
return 0 ;
}
static int F_21 ( struct V_21 * V_22 , T_6 * V_84 )
{
struct V_1 * V_2 = V_22 -> V_23 ;
T_1 V_20 ;
F_3 ( L_3 , V_16 ) ;
...
T_1 V_90 ;
F_3 ( L_3 , V_16 ) ;
V_90 = 0xff - F_4 ( V_2 , 0x43 ) ;
* signal = ( V_90 << 8 ) | V_90 ;
return 0 ;
}
static int F_23 ( struct V_21 * V_22 , T_7 * V_91 )
{
struct V_1 * V_2 = V_22 -> V_23 ;
T_1 V_92 ;
F_3 ( L_3 , V_16 ) ;
V_92 = 0xff - F_4 ( V_2 , 0x1c ) ;
* V_91 = ( V_92 << 8 ) | V_92 ;
return 0 ;
}
static int F_24 ( struct V_21 * V_22 , T_5 * V_93 )
{
struct V_1 * V_2 = V_22 -> V_23 ;
F_3 ( L_3 , V_16 ) ;
* V_93 = F_4 ( V_2 , 0x18 ) & 0x7f ;
F_1 ( V_2 , 0x18 , 0x00 ) ;
F_1 ( V_2 , 0x18 , 0x80 ) ;
return 0 ;
}
static int F_25 ( struct V_21 * V_22 , T_5 * V_94 )
{
struct V_1 * V_2 = V_22 -> V_23 ;
F_3 ( L_3 , V_16 ) ;
* V_94 = 0 ;
...
static int F_27 ( struct V_21 * V_22 , int V_95 )
{
struct V_1 * V_2 = V_22 -> V_23 ;
F_3 ( L_3 , V_16 ) ;
if ( V_95 ) {
...
static int F_28 ( struct V_21 * V_22 , struct V_96 * V_97 )
{
if ( V_97 -> V_98 . V_61 . V_62 . V_60 > 20000000 ) {
V_97 -> V_99 = 50 ;
V_97 -> V_100 = 2000 ;
V_97 -> V_101 = 8000 ;
} else if ( V_97 -> V_98 . V_61 . V_62 . V_60 > 12000000 ) {
V_97 -> V_99 = 100 ;
V_97 -> V_100 = 1500 ;
V_97 -> V_101 = 9000 ;
} else if ( V_97 -> V_98 . V_61 . V_62 . V_60 > 8000000 ) {
V_97 -> V_99 = 100 ;
V_97 -> V_100 = 1000 ;
V_97 -> V_101 = 8000 ;
} else if ( V_97 -> V_98 . V_61 . V_62 . V_60 > 4000000 ) {
V_97 -> V_99 = 100 ;
V_97 -> V_100 = 500 ;
V_97 -> V_101 = 7000 ;
} else if ( V_97 -> V_98 . V_61 . V_62 . V_60 > 2000000 ) {
V_97 -> V_99 = 200 ;
V_97 -> V_100 = ( V_97 -> V_98 . V_61 . V_62 . V_60 / 8000 ) ;
V_97 -> V_101 = 14 * V_97 -> V_100 ;
} else {
V_97 -> V_99 = 200 ;
V_97 -> V_100 = ( V_97 -> V_98 . V_61 . V_62 . V_60 / 8000 ) ;
V_97 -> V_101 = 18 * V_97 -> V_100 ;
}
return 0 ;
}
...
struct V_21 * F_31 ( const struct V_102 * V_13 ,
struct V_103 * V_15 )
{
struct V_1 * V_2 ;
F_3 ( L_3 , V_16 ) ;
V_2 = F_32 ( sizeof( struct V_1 ) , V_104 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_13 = V_13 ;
V_2 -> V_15 = V_15 ;
...
memcpy ( & V_2 -> V_105 . V_77 , & V_106 , sizeof( struct V_107 ) ) ;
V_2 -> V_105 . V_23 = V_2 ;
return & V_2 -> V_105 ;
}
