...
V_2 -> V_120 = V_121 ;
F_9 ( 0 , V_2 -> V_3 + V_21 ) ;
if ( F_35 ( V_2 -> V_112 , F_31 , V_122 , L_1 , V_2 ) )
F_36 ( V_123 L_2
...
static int F_40 ( struct V_1 * V_2 , struct V_124 * V_125 )
{
if ( ( V_125 -> type != V_126 ) && ( V_125 -> type != V_119 ) )
return - V_127 ;
return 0 ;
}
int T_2 F_41 ( struct V_128 * V_129 )
{
struct V_1 * V_2 ;
int V_130 ;
for ( V_130 = 0 ; ( ( V_130 < V_131 ) && ( V_129 [ V_130 ] . V_132 ) ) ; V_130 ++ ) {
V_2 = & V_133 [ V_130 ] . V_2 ;
V_2 -> line = V_130 ;
V_2 -> type = V_119 ;
V_2 -> V_132 = V_129 [ V_130 ] . V_132 ;
V_2 -> V_3 = ( V_129 [ V_130 ] . V_3 ) ? V_129 [ V_130 ] . V_3 :
( unsigned char V_134 * ) V_2 -> V_132 ;
V_2 -> V_135 = V_136 ;
V_2 -> V_112 = V_129 [ V_130 ] . V_112 ;
V_2 -> V_137 = V_42 ;
V_2 -> V_24 = V_138 ;
V_2 -> V_139 = & V_140 ;
}
...
static void F_42 ( struct V_141 * V_142 , const char V_143 )
{
struct V_1 * V_2 = & ( V_133 + V_142 -> V_144 ) -> V_2 ;
int V_130 ;
for ( V_130 = 0 ; ( V_130 < 0x10000 ) ; V_130 ++ ) {
if ( F_2 ( V_2 -> V_3 + V_4 ) & V_106 )
break;
}
F_9 ( V_143 , V_2 -> V_3 + V_104 ) ;
for ( V_130 = 0 ; ( V_130 < 0x10000 ) ; V_130 ++ ) {
if ( F_2 ( V_2 -> V_3 + V_4 ) & V_106 )
break;
}
}
static void F_43 ( struct V_141 * V_142 , const char * V_145 , unsigned int V_146 )
{
for (; ( V_146 ) ; V_146 -- , V_145 ++ ) {
F_42 ( V_142 , * V_145 ) ;
if ( * V_145 == '\n' )
F_42 ( V_142 , '\r' ) ;
}
}
static int T_2 F_44 ( struct V_141 * V_142 , char * V_147 )
{
struct V_1 * V_2 ;
int V_36 = V_148 ;
int V_149 = 8 ;
int V_90 = 'n' ;
int V_150 = 'n' ;
if ( ( V_142 -> V_144 < 0 ) || ( V_142 -> V_144 >= V_131 ) )
V_142 -> V_144 = 0 ;
V_2 = & V_133 [ V_142 -> V_144 ] . V_2 ;
if ( V_2 -> V_3 == 0 )
return - V_151 ;
if ( V_147 )
F_45 ( V_147 , & V_36 , & V_90 , & V_149 , & V_150 ) ;
return F_46 ( V_2 , V_142 , V_36 , V_90 , V_149 , V_150 ) ;
}
...
static int T_3 F_49 ( struct V_153 * V_154 )
{
struct V_128 * V_129 = V_154 -> V_155 . V_156 ;
struct V_1 * V_2 ;
int V_130 ;
for ( V_130 = 0 ; ( ( V_130 < V_131 ) && ( V_129 [ V_130 ] . V_132 ) ) ; V_130 ++ ) {
V_2 = & V_133 [ V_130 ] . V_2 ;
...
V_2 -> V_132 = V_129 [ V_130 ] . V_132 ;
V_2 -> V_3 = ( V_129 [ V_130 ] . V_3 ) ? V_129 [ V_130 ] . V_3 :
( unsigned char V_134 * ) V_129 [ V_130 ] . V_132 ;
V_2 -> V_135 = V_136 ;
V_2 -> V_112 = V_129 [ V_130 ] . V_112 ;
V_2 -> V_137 = V_42 ;
V_2 -> V_139 = & V_140 ;
...
static int T_4 F_51 ( struct V_153 * V_154 )
{
struct V_1 * V_2 ;
int V_130 ;
