...
V_8 . V_21 = F_29 ( V_31 -> V_36 ) ;
V_8 . V_9 = V_31 -> V_34 & V_37 ;
if ( ( V_8 . type == V_38 ) ||
( V_8 . type == V_39 ) ) {
V_8 . V_28 = V_31 -> V_40 ;
if ( V_8 . type == V_39 )
V_8 . V_29 = ( ( V_31 -> V_36 & 0x1800 ) >> 11 ) ;
}
F_16 ( V_1 , V_8 ) ;
F_27 ( V_1 , V_8 ) ;
F_5 ( V_6 , V_8 ) ;
...
struct V_1 * V_1 = V_6 -> V_1 ;
V_60 = V_45 -> V_45 . V_63 ;
V_45 -> V_45 . V_62 = V_45 -> V_45 . V_56 ;
for ( V_59 = ( V_45 -> V_45 . V_56 >> 2 ) ; V_59 > 0 ; V_59 -- ) {
V_61 = * V_60 | * ( V_60 + 1 ) << 8 |
* ( V_60 + 2 ) << 16 | * ( V_60 + 3 ) << 24 ;
F_3 ( V_61 , V_1 -> V_4 +
F_68 ( V_6 -> V_9 ) ) ;
...
static void F_83 ( struct V_41 * V_6 ,
struct V_51 * V_45 )
{
}
...
static void F_85 ( struct V_5 * V_6 , T_1 V_123 )
{
struct V_1 * V_1 = V_6 -> V_1 ;
T_1 V_4 = F_2 ( V_1 -> V_4 + F_86 ( V_6 -> V_9 ) ) ;
V_4 &= ~ V_124 ;
V_4 |= V_123 & V_124 ;
F_3 ( V_4 , V_1 -> V_4 + F_86 ( V_6 -> V_9 ) ) ;
}
...
V_45 -> V_45 . V_77 = V_77 ;
F_75 ( & V_6 -> V_1 -> V_49 ) ;
V_45 -> V_45 . V_125 ( & V_6 -> V_6 , & V_45 -> V_45 ) ;
F_76 ( & V_6 -> V_1 -> V_49 ) ;
if ( V_6 -> V_9 ) {
F_46 ( V_6 ) ;
if ( ! F_34 ( & V_6 -> V_47 ) )
...
F_3 ( ( T_1 ) V_45 -> V_45 . V_63 , V_6 -> V_1 -> V_4 +
F_90 ( V_6 -> V_9 ) ) ;
V_3 = F_91 ( V_45 -> V_45 . V_56 ) | V_126 |
V_127 | V_128 | V_129 ;
F_3 ( V_3 , V_6 -> V_1 -> V_4 + F_89 ( V_6 -> V_9 ) ) ;
F_3 ( 0x0 , V_6 -> V_1 -> V_4 + F_92 ( V_6 -> V_9 ) ) ;
F_1 ( V_6 -> V_1 , V_130 ,
F_93 ( V_6 -> V_9 ) ) ;
}
...
T_5 V_137 ;
T_2 * V_60 = NULL ;
V_137 = F_98 ( NULL , V_45 -> V_45 . V_63 , V_45 -> V_45 . V_56 , V_138 ) ;
if ( F_99 ( NULL , V_137 ) ) {
F_43 ( V_45 -> V_45 . V_63 ) ;
F_50 ( V_66 L_10 ) ;
}
F_100 ( NULL , V_137 , V_45 -> V_45 . V_56 , V_138 ) ;
F_1 ( V_6 -> V_1 , V_54 ,
F_96 ( V_6 -> V_9 ) ) ;
V_60 = V_45 -> V_45 . V_63 ;
V_45 -> V_45 . V_63 = ( T_2 * ) V_137 ;
F_88 ( V_6 , V_45 ) ;
F_94 ( V_6 ) ;
V_45 -> V_45 . V_63 = V_60 ;
if ( V_137 )
F_101 ( NULL , V_137 , V_45 -> V_45 . V_56 , V_138 ) ;
}
...
static T_6 F_112 ( int V_147 , void * V_148 )
{
...
int F_119 ( struct V_191 * V_174 ,
int (* F_120)( struct V_192 * ) )
{
...
V_194 = F_121 ( & V_1 -> V_73 . V_198 ) ;
if ( V_194 ) {
F_12 ( L_31 , V_194 ) ;
goto error;
}
V_194 = F_120 ( & V_1 -> V_73 ) ;
if ( V_194 ) {
F_12 ( L_32 , V_194 ) ;
F_122 ( & V_1 -> V_73 . V_198 ) ;
goto error;
}
return 0 ;
error:
...
static int F_124 ( struct V_192 * V_200 , int V_201 )
{
return 0 ;
}
static int T_7 F_125 ( struct V_202 * V_203 )
{
struct V_1 * V_1 = F_126 ( & V_203 -> V_198 ) ;
F_127 ( V_1 -> V_4 ) ;
F_128 ( F_129 ( V_203 , 0 ) , V_1 ) ;
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_101 ) ;
F_43 ( V_1 ) ;
return 0 ;
}
static int T_8 F_130 ( struct V_202 * V_203 )
{
...
int V_80 = 0 ;
int V_59 ;
V_205 = F_131 ( V_203 , V_208 , 0 ) ;
if ( ! V_205 ) {
V_80 = - V_195 ;
F_12 ( L_33 ) ;
goto V_209;
}
V_206 = F_131 ( V_203 , V_210 , 0 ) ;
if ( ! V_206 ) {
V_80 = - V_195 ;
F_132 ( & V_203 -> V_198 ,
L_34 ) ;
...
V_4 = F_133 ( V_205 -> V_211 , F_134 ( V_205 ) ) ;
if ( V_4 == NULL ) {
V_80 = - V_212 ;
F_12 ( L_36 ) ;
goto V_209;
...
F_135 ( & V_1 -> V_49 ) ;
F_136 ( & V_203 -> V_198 , V_1 ) ;
V_1 -> V_73 . V_213 = & V_214 ;
F_137 ( & V_1 -> V_73 . V_198 ) ;
F_138 ( & V_1 -> V_73 . V_198 , L_39 ) ;
V_1 -> V_73 . V_215 = 1 ;
...
V_1 -> V_4 = V_4 ;
V_80 = F_139 ( V_206 -> V_211 , F_112 , V_221 | V_222 ,
V_220 , V_1 ) ;
if ( V_80 < 0 ) {
F_12 ( L_40 , V_80 ) ;
goto V_209;
}
V_80 = F_139 ( V_207 -> V_211 , F_112 ,
V_221 | V_222 , V_220 , V_1 ) ;
if ( V_80 < 0 ) {
F_12 ( L_41 , V_80 ) ;
goto V_209;
}
...
if ( V_59 != 0 ) {
F_41 ( & V_1 -> V_6 [ V_59 ] -> V_6 . V_223 ) ;
F_56 ( & V_1 -> V_6 [ V_59 ] -> V_6 . V_223 ,
& V_1 -> V_73 . V_223 ) ;
}
V_6 -> V_1 = V_1 ;
F_41 ( & V_6 -> V_47 ) ;
V_6 -> V_6 . V_219 = V_224 [ V_59 ] ;
V_6 -> V_6 . V_213 = & V_225 ;
V_6 -> V_6 . V_21 = V_226 ;
}
V_1 -> V_6 [ 0 ] -> V_6 . V_21 = V_227 ;
V_1 -> V_6 [ 0 ] -> V_9 = 0 ;
V_1 -> V_73 . V_102 = & V_1 -> V_6 [ 0 ] -> V_6 ;
F_41 ( & V_1 -> V_73 . V_102 -> V_223 ) ;
V_193 = V_1 ;
