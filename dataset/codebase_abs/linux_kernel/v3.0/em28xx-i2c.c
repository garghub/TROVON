...
if ( V_2 -> V_52 == V_53 || V_2 -> V_52 == V_54 ) {
return 0 ;
}
V_2 -> V_55 . V_3 = 0xa0 >> 1 ;
V_40 = F_16 ( & V_2 -> V_55 , & V_4 , 0 ) ;
if ( V_40 < 0 ) {
F_17 ( L_18 ) ;
memset ( V_46 , 0 , V_5 ) ;
return - V_21 ;
...
if ( 0 == ( V_33 % 16 ) )
F_13 ( V_56 L_21 , V_2 -> V_57 , V_33 ) ;
F_13 ( L_15 , V_46 [ V_33 ] ) ;
if ( 15 == ( V_33 % 16 ) )
F_13 ( L_16 ) ;
}
if ( V_49 -> V_59 == 0x9567eb1a )
V_2 -> V_43 = F_14 ( V_46 , V_5 , 32 ) ;
F_13 ( V_56 L_22 ,
V_2 -> V_57 , V_49 -> V_59 , V_2 -> V_43 ) ;
F_13 ( V_56 L_23 , V_2 -> V_57 ) ;
switch ( V_49 -> V_60 >> 4 & 0x3 ) {
case 0 :
F_13 ( V_56 L_24 , V_2 -> V_57 ) ;
break;
case 1 :
F_13 ( V_56 L_25 ,
V_2 -> V_57 ) ;
...
if ( V_49 -> V_60 & 1 << 3 )
F_13 ( V_56 L_28 , V_2 -> V_57 ) ;
if ( V_49 -> V_60 & 1 << 2 )
F_13 ( V_56 L_29 , V_2 -> V_57 ) ;
switch ( V_49 -> V_60 & 0x3 ) {
case 0 :
F_13 ( V_56 L_30 , V_2 -> V_57 ) ;
break;
case 1 :
F_13 ( V_56 L_31 , V_2 -> V_57 ) ;
break;
case 2 :
F_13 ( V_56 L_32 , V_2 -> V_57 ) ;
break;
case 3 :
F_13 ( V_56 L_33 , V_2 -> V_57 ) ;
break;
}
F_13 ( V_56 L_34 ,
V_2 -> V_57 ,
...
static T_1 F_19 ( struct V_26 * V_65 )
{
return V_66 ;
}
...
unsigned char V_4 ;
int V_33 , V_32 ;
memset ( V_67 , 0 , F_21 ( V_67 ) ) ;
for ( V_33 = 0 ; V_33 < F_21 ( V_68 ) ; V_33 ++ ) {
V_2 -> V_55 . V_3 = V_33 ;
V_32 = F_16 ( & V_2 -> V_55 , & V_4 , 0 ) ;
if ( V_32 < 0 )
continue;
V_67 [ V_33 ] = V_33 ;
F_13 ( V_56 L_35 ,
V_2 -> V_57 , V_33 << 1 , V_68 [ V_33 ] ? V_68 [ V_33 ] : L_36 ) ;
}
V_2 -> V_69 = F_14 ( V_67 ,
F_21 ( V_67 ) , 32 ) ;
}
...
V_2 -> V_27 = V_71 ;
V_2 -> V_27 . V_2 . V_72 = & V_2 -> V_73 -> V_2 ;
strcpy ( V_2 -> V_27 . V_57 , V_2 -> V_57 ) ;
V_2 -> V_27 . V_31 = V_2 ;
F_23 ( & V_2 -> V_27 , & V_2 -> V_74 ) ;
V_70 = F_24 ( & V_2 -> V_27 ) ;
if ( V_70 < 0 ) {
F_17 ( L_37 ,
V_75 , V_70 ) ;
...
V_2 -> V_55 = V_76 ;
V_2 -> V_55 . V_77 = & V_2 -> V_27 ;
V_70 = F_15 ( V_2 , V_2 -> V_46 , sizeof( V_2 -> V_46 ) ) ;
if ( ( V_70 < 0 ) && ( V_70 != - V_21 ) ) {
F_17 ( L_38 ,
V_75 , V_70 ) ;
return V_70 ;
