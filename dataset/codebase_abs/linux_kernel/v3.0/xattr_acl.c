...
struct V_6 * V_59 , struct V_1 * V_1 ,
struct V_6 * V_6 )
{
struct V_8 * V_9 ;
int V_60 = 0 ;
...
static T_1 F_53 ( struct V_1 * V_1 , char * V_73 ,
T_1 V_74 , const char * V_2 ,
T_1 V_75 , int type )
{
...
return 0 ;
if ( V_73 && V_4 <= V_74 )
memcpy ( V_73 , V_50 , V_4 ) ;
return V_4 ;
}
static T_1 F_54 ( struct V_1 * V_1 , char * V_73 ,
T_1 V_74 , const char * V_2 ,
T_1 V_75 , int type )
{
