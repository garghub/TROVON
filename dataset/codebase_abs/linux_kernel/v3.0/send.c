...
F_77 ( V_149 L_2 , V_115 -> V_145 ) ;
V_30 = - V_150 ;
goto V_35;
}
if ( V_115 -> V_151 ) {
if ( V_115 -> V_151 < sizeof( * V_141 ) || V_141 -> V_152 != V_153 ) {
V_30 = - V_122 ;
goto V_35;
}
...
if ( V_139 ) {
V_4 -> V_38 . V_61 = F_81 ( V_4 , ceil ( V_139 , V_133 ) ) ;
if ( ! V_4 -> V_38 . V_61 ) {
V_30 = - V_34 ;
goto V_35;
}
V_30 = F_82 ( V_4 , V_115 -> V_159 , V_139 ) ;
if ( V_30 )
goto V_35;
}
V_4 -> V_38 . V_39 = 1 ;
V_4 -> V_104 = V_143 ;
if ( V_67 -> V_160 && V_67 -> V_160 -> V_161 == V_143 )
V_2 = V_67 -> V_160 ;
else {
V_2 = F_83 ( V_67 -> V_156 , V_143 ,
V_67 -> V_162 ,
V_138 -> V_140 -> V_163 ) ;
if ( F_22 ( V_2 ) ) {
V_30 = F_23 ( V_2 ) ;
...
F_85 ( V_2 ) ;
V_30 = F_86 ( V_2 -> V_165 , V_110 , V_144 , V_67 ) ;
if ( V_30 ) {
V_67 -> V_166 = 1 ;
goto V_35;
}
while ( ! F_58 ( V_67 , V_2 , V_4 , V_67 -> V_167 ,
V_110 , & V_111 ) ) {
F_18 ( V_168 ) ;
if ( V_139 > F_59 ( V_67 ) ) {
V_30 = - V_169 ;
...
V_147 = F_87 ( * F_88 ( V_140 ) ,
F_58 ( V_67 , V_2 , V_4 ,
V_67 -> V_167 ,
V_110 ,
& V_111 ) ,
V_147 ) ;
F_62 ( L_5 , V_111 , V_147 ) ;
if ( V_147 > 0 || V_147 == V_171 )
continue;
V_30 = V_147 ;
if ( V_30 == 0 )
V_30 = - V_172 ;
...
F_18 ( V_173 ) ;
if ( ! F_28 ( V_174 , & V_2 -> V_26 ) )
F_16 ( V_2 ) ;
F_3 ( V_4 ) ;
return V_139 ;
V_35:
if ( V_134 )
F_89 ( V_67 , F_90 ( V_4 -> V_58 ) , 1 ) ;
if ( V_4 )
F_3 ( V_4 ) ;
return V_30 ;
}
int
F_91 ( struct V_1 * V_2 , T_4 V_110 )
{
struct V_3 * V_4 ;
unsigned long V_6 ;
int V_30 = 0 ;
...
V_4 -> V_38 . V_39 = 1 ;
F_85 ( V_2 ) ;
V_30 = F_86 ( V_2 -> V_165 , V_110 , 1 , NULL ) ;
if ( V_30 )
goto V_35;
F_4 ( & V_2 -> V_19 , V_6 ) ;
F_46 ( & V_4 -> V_42 , & V_2 -> V_24 ) ;
