...
static T_3 F_12 ( struct V_9 * V_10 , T_4 V_18 )
{
T_3 V_19 = F_13 ( V_18 , V_10 -> V_20 ) ;
return V_19 / V_10 -> V_15 ;
}
static void F_14 ( struct V_7 * V_8 , T_4 * V_21 )
{
struct V_9 * V_10 = F_3 ( V_8 ) ;
T_5 V_22 = 2 * V_10 -> V_23 ;
const T_5 V_24 = V_10 -> V_17 ;
T_4 V_18 = V_21 ? * V_21 : F_15 () ;
if ( F_12 ( V_10 , V_18 ) >= 2 ) {
V_22 = F_7 ( V_8 ) ;
V_22 = F_16 ( V_22 , 2 * V_10 -> V_23 ) ;
}
if ( V_10 -> V_25 > 0 ) {
V_10 -> V_17 = F_17 ( ( ( T_5 ) V_10 -> V_26 ) << 6 , V_22 ) ;
V_10 -> V_17 = F_16 ( V_10 -> V_17 , ( ( ( T_5 ) V_10 -> V_14 ) << 6 ) / V_27 ) ;
} else if ( F_13 ( V_18 , V_10 -> V_28 ) - ( V_29 ) V_10 -> V_15 >= 0 ) {
V_10 -> V_17 = F_17 ( 2 * V_10 -> V_17 , V_22 ) ;
V_10 -> V_17 = F_16 ( V_10 -> V_17 ,
...
static inline void F_18 ( struct V_9 * V_10 , int V_30 )
{
const T_6 V_31 = V_10 -> V_14 ;
V_10 -> V_14 = F_19 ( V_10 -> V_14 , V_30 , 9 ) ;
if ( V_10 -> V_14 != V_31 )
F_10 ( V_10 ) ;
}
...
V_10 -> V_17 = F_16 ( V_10 -> V_17 / 2 ,
( ( ( T_5 ) V_10 -> V_14 ) << 6 ) / V_27 ) ;
F_10 ( V_10 ) ;
} else {
F_24 ( V_10 -> V_25 && ! V_10 -> V_26 ) ;
...
V_35 = F_16 ( V_10 -> V_42 , 2 * V_10 -> V_16 ) ;
V_37:
F_26 ( V_8 , & V_10 -> V_44 ,
V_45 + F_27 ( V_35 ) ) ;
V_41:
...
F_40 ( & V_63 -> V_68 ) ;
V_18 = F_15 () ;
V_64 = F_41 ( V_8 , F_13 ( V_18 , V_63 -> V_21 ) ) ;
V_10 -> V_15 = F_19 ( V_10 -> V_15 , V_64 , 9 ) ;
if ( V_10 -> V_12 == V_5 ) {
F_2 ( V_8 , V_6 ) ;
if ( V_10 -> V_42 == 0 ) {
V_10 -> V_17 = F_7 ( V_8 ) ;
...
if ( V_131 ) {
const T_3 V_132 = V_47 -> V_30 - F_64 ( V_47 ) -> V_133 * 4 ;
V_10 -> V_125 = F_19 ( V_10 -> V_125 , V_132 , 9 ) ;
V_10 -> V_114 += V_132 ;
}
...
if ( V_138 != 0 )
V_10 -> V_124 = F_19 ( V_10 -> V_124 , V_138 , 9 ) ;
