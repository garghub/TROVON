...
static int
F_36 ( void * V_5 , struct V_41 * V_68 )
{
struct V_41 * V_42 = V_5 ;
return V_42 == V_68 ;
}
static int
F_37 ( void * V_5 , struct V_41 * V_66 )
{
struct V_41 * V_42 = V_5 ;
if ( V_42 -> V_69 ) {
if ( V_42 -> V_70 )
...
static int
F_42 ( void * V_73 , struct V_6 * V_7 )
{
struct V_74 * V_75 = V_73 ;
return V_75 == V_7 -> V_9 -> V_10 . V_76 -> V_77 ;
}
int
F_43 ( struct V_74 * V_75 )
{
int V_65 ;
V_65 = F_31 ( V_75 , F_25 , F_42 ) ;
return V_65 ? - V_78 : 0 ;
}
static int
F_44 ( void * V_73 , struct V_41 * V_42 )
{
return F_45 ( F_46 ( V_42 ) , V_73 ) ;
}
int
F_47 ( struct V_79 * V_80 )
{
int V_65 ;
V_65 = F_31 ( V_80 , F_44 , NULL ) ;
return V_65 ? - V_78 : 0 ;
}
