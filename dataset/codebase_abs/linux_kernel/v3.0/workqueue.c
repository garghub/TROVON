...
static bool F_170 ( struct V_13 * V_17 , struct V_159 * V_160 ,
bool V_175 )
{
struct V_54 * V_54 = NULL ;
struct V_23 * V_43 ;
...
F_107 ( & V_43 -> V_81 ) ;
if ( V_36 -> V_9 -> V_177 == 1 || V_36 -> V_9 -> V_10 & V_131 )
F_164 ( & V_36 -> V_9 -> V_170 ) ;
else
F_173 ( & V_36 -> V_9 -> V_170 ) ;
...
bool F_174 ( struct V_13 * V_17 )
{
struct V_159 V_160 ;
if ( F_170 ( V_17 , & V_160 , true ) ) {
F_168 ( & V_160 . V_146 ) ;
F_21 ( & V_160 . V_17 ) ;
return true ;
} else
...
static bool F_175 ( struct V_23 * V_43 , struct V_13 * V_17 )
{
struct V_159 V_160 ;
struct V_54 * V_54 ;
F_113 ( & V_43 -> V_81 ) ;
...
static bool F_176 ( struct V_13 * V_17 )
{
bool V_93 = false ;
int V_1 ;
F_171 () ;
...
static int F_178 ( struct V_13 * V_17 )
{
struct V_23 * V_43 ;
int V_93 = - 1 ;
if ( ! F_89 ( V_94 , F_10 ( V_17 ) ) )
...
{
return F_179 ( V_17 , NULL ) ;
}
bool F_181 ( struct V_96 * V_97 )
{
if ( F_182 ( & V_97 -> V_100 ) )
F_82 ( F_61 () ,
F_40 ( & V_97 -> V_17 ) -> V_9 , & V_97 -> V_17 ) ;
return F_174 ( & V_97 -> V_17 ) ;
}
bool F_183 ( struct V_96 * V_97 )
{
if ( F_182 ( & V_97 -> V_100 ) )
F_82 ( F_61 () ,
F_40 ( & V_97 -> V_17 ) -> V_9 , & V_97 -> V_17 ) ;
...
{
return F_179 ( & V_97 -> V_17 , & V_97 -> V_100 ) ;
}
int F_185 ( struct V_13 * V_17 )
{
return F_85 ( V_180 , V_17 ) ;
}
int F_186 ( int V_1 , struct V_13 * V_17 )
{
return F_86 ( V_1 , V_180 , V_17 ) ;
}
int F_187 ( struct V_96 * V_97 ,
unsigned long V_98 )
{
return F_92 ( V_180 , V_97 , V_98 ) ;
}
int F_188 ( int V_1 ,
struct V_96 * V_97 , unsigned long V_98 )
{
return F_93 ( V_1 , V_180 , V_97 , V_98 ) ;
}
int F_189 ( T_2 V_14 )
{
int V_1 ;
struct V_13 T_3 * V_181 ;
V_181 = F_190 ( struct V_13 ) ;
if ( ! V_181 )
return - V_182 ;
F_191 () ;
F_192 (cpu) {
struct V_13 * V_17 = F_28 ( V_181 , V_1 ) ;
F_111 ( V_17 , V_14 ) ;
F_186 ( V_1 , V_17 ) ;
}
F_192 (cpu)
F_174 ( F_28 ( V_181 , V_1 ) ) ;
F_193 () ;
F_194 ( V_181 ) ;
return 0 ;
}
...
int F_196 ( T_2 V_183 , struct V_184 * V_185 )
{
if ( ! F_197 () ) {
V_183 ( & V_185 -> V_17 ) ;
return 0 ;
}
F_111 ( & V_185 -> V_17 , V_183 ) ;
F_185 ( & V_185 -> V_17 ) ;
return 1 ;
}
int F_198 ( void )
...
{
const T_4 V_186 = sizeof( struct V_27 ) ;
const T_4 V_187 = F_200 ( T_4 , 1 << V_40 ,
F_201 (unsigned long long) ) ;
#ifdef F_27
bool V_188 = ! ( V_9 -> V_10 & V_11 ) ;
#else
bool V_188 = false ;
#endif
if ( V_188 )
V_9 -> V_28 . V_29 = F_202 ( V_186 , V_187 ) ;
else {
void * V_189 ;
V_189 = F_109 ( V_186 + V_187 + sizeof( void * ) , V_116 ) ;
if ( V_189 ) {
V_9 -> V_28 . V_30 = F_203 ( V_189 , V_187 ) ;
* ( void * * ) ( V_9 -> V_28 . V_30 + 1 ) = V_189 ;
}
}
F_33 ( ! F_204 ( V_9 -> V_28 . V_66 , V_187 ) ) ;
return V_9 -> V_28 . V_66 ? 0 : - V_182 ;
}
...
static int F_206 ( int V_90 , unsigned int V_10 ,
const char * V_190 )
{
int V_191 = V_10 & V_11 ? V_192 : V_193 ;
if ( V_90 < 1 || V_90 > V_191 )
F_207 ( V_194 L_3
L_4 ,
V_90 , V_190 , 1 , V_191 ) ;
return F_208 ( V_90 , 1 , V_191 ) ;
}
struct V_8 * F_209 ( const char * V_190 ,
unsigned int V_10 ,
int V_90 ,
struct V_195 * V_196 ,
const char * V_197 )
...
if ( V_10 & V_131 ) {
struct V_54 * V_133 ;
if ( ! F_212 ( & V_9 -> V_132 , V_116 ) )
goto V_200;
V_9 -> V_133 = V_133 = F_108 () ;
if ( ! V_133 )
goto V_200;
V_133 -> V_57 = F_118 ( F_146 , V_9 , L_5 , V_190 ) ;
if ( F_119 ( V_133 -> V_57 ) )
goto V_200;
...
F_160 (cpu, wq) {
struct V_27 * V_36 = F_25 ( V_1 , V_9 ) ;
if ( ! V_36 -> V_89 && F_46 ( & V_36 -> V_92 ) )
continue;
if ( ++ V_206 == 10 ||
( V_206 % 100 == 0 && V_206 <= 1000 ) )
F_207 ( V_194 L_6
L_7 ,
V_9 -> V_190 , V_206 ) ;
goto V_207;
...
void F_218 ( struct V_8 * V_9 , int V_90 )
{
unsigned int V_1 ;
V_90 = F_206 ( V_90 , V_9 -> V_10 , V_9 -> V_190 ) ;
F_213 ( & V_202 ) ;
V_9 -> V_177 = V_90 ;
F_160 (cpu, wq) {
struct V_23 * V_43 = F_22 ( V_1 ) ;
...
bool F_219 ( unsigned int V_1 , struct V_8 * V_9 )
{
struct V_27 * V_36 = F_25 ( V_1 , V_9 ) ;
return ! F_46 ( & V_36 -> V_92 ) ;
}
unsigned int F_220 ( struct V_13 * V_17 )
{
struct V_23 * V_43 = F_42 ( V_17 ) ;
return V_43 ? V_43 -> V_1 : V_7 ;
}
unsigned int F_221 ( struct V_13 * V_17 )
{
struct V_23 * V_43 = F_42 ( V_17 ) ;
unsigned long V_10 ;
unsigned int V_93 = 0 ;
...
static int T_5 F_222 ( void * V_129 )
{
...
if ( F_224 ( false , V_215 ) < 0 )
break;
}
do {
V_211 = F_223 ( ! F_46 ( & V_43 -> V_55 ) ) ;
while ( ! F_46 ( & V_43 -> V_55 ) )
F_124 ( F_54 ( & V_43 -> V_55 ,
struct V_54 , V_56 ) ) ;
} while ( V_43 -> V_52 && V_211 >= 0 );
F_13 ( ! F_46 ( & V_43 -> V_55 ) ) ;
F_80 (worker, i, pos, gcwq) {
...
continue;
F_16 ( V_114 ) ;
F_73 ( F_25 ( V_43 -> V_1 , V_180 ) , V_114 ,
V_54 -> V_117 . V_107 ,
F_29 ( V_142 ) ) ;
}
V_43 -> V_10 &= ~ V_50 ;
...
static void T_5 F_225 ( struct V_23 * V_43 , int V_16 )
__releases( &gcwq->lock
static int T_6 F_226 ( struct V_217 * V_218 ,
unsigned long V_219 ,
void * V_220 )
{
unsigned int V_1 = ( unsigned long ) V_220 ;
struct V_23 * V_43 = F_22 ( V_1 ) ;
struct V_58 * V_221 = NULL ;
struct V_54 * V_222 ( V_223 ) ;
unsigned long V_10 ;
V_219 &= ~ V_224 ;
switch ( V_219 ) {
case V_225 :
V_221 = F_118 ( F_222 , V_43 ,
L_8 , V_1 ) ;
if ( F_119 ( V_221 ) )
return F_227 ( F_228 ( V_221 ) ) ;
F_120 ( V_221 , V_1 ) ;
case V_226 :
F_33 ( V_43 -> V_227 ) ;
V_223 = F_112 ( V_43 , false ) ;
if ( ! V_223 ) {
if ( V_221 )
F_125 ( V_221 ) ;
return V_228 ;
...
switch ( V_219 ) {
case V_225 :
F_33 ( V_43 -> V_136 || V_43 -> V_212 != V_216 ) ;
V_43 -> V_136 = V_221 ;
V_43 -> V_212 = V_229 ;
F_56 ( V_43 -> V_136 ) ;
F_225 ( V_43 , V_213 ) ;
...
static int F_229 ( void * V_238 )
{
struct V_239 * V_240 = V_238 ;
V_240 -> V_93 = V_240 -> V_183 ( V_240 -> V_241 ) ;
F_141 ( & V_240 -> V_242 ) ;
return 0 ;
}
long F_230 ( unsigned int V_1 , long (* V_183)( void * ) , void * V_241 )
{
struct V_58 * V_243 ;
struct V_239 V_240 = {
. V_242 = F_163 ( V_240 . V_242 ) ,
. V_183 = V_183 ,
. V_241 = V_241 ,
} ;
V_243 = F_118 ( F_229 , & V_240 , L_9 ) ;
if ( F_119 ( V_243 ) )
return F_228 ( V_243 ) ;
F_120 ( V_243 , V_1 ) ;
F_56 ( V_243 ) ;
...
struct V_8 * V_9 ;
F_113 ( & V_43 -> V_81 ) ;
F_33 ( V_43 -> V_10 & V_208 ) ;
V_43 -> V_10 |= V_208 ;
F_72 (wq, &workqueues, list) {
struct V_27 * V_36 = F_25 ( V_1 , V_9 ) ;
if ( V_36 && V_9 -> V_10 & V_204 )
V_36 -> V_90 = 0 ;
}
F_107 ( & V_43 -> V_81 ) ;
}
...
V_43 -> V_10 |= V_231 ;
F_110 ( & V_43 -> V_55 ) ;
for ( V_80 = 0 ; V_80 < V_246 ; V_80 ++ )
F_237 ( & V_43 -> V_69 [ V_80 ] ) ;
F_238 ( & V_43 -> V_111 ) ;
V_43 -> V_111 . V_104 = F_126 ;
V_43 -> V_111 . V_35 = ( unsigned long ) V_43 ;
F_239 ( & V_43 -> V_134 , F_131 ,
( unsigned long ) V_43 ) ;
F_240 ( & V_43 -> V_122 ) ;
V_43 -> V_212 = V_216 ;
F_241 ( & V_43 -> V_113 ) ;
...
V_180 = F_243 ( L_10 , 0 , 0 ) ;
V_247 = F_243 ( L_11 , 0 , 0 ) ;
V_248 = F_243 ( L_12 , V_86 , 0 ) ;
V_249 = F_243 ( L_13 , V_11 ,
V_192 ) ;
V_250 = F_243 ( L_14 ,
V_204 , 0 ) ;
F_33 ( ! V_180 || ! V_247 || ! V_248 ||
! V_249 || ! V_250 ) ;
return 0 ;
}
