...
struct V_20 * V_21 = F_6 ( V_14 , V_22 ) ;
if ( V_3 == V_21 -> V_43 )
F_13 ( V_21 -> V_29 [ 0 ] , NULL ) ;
else
F_11 ( V_21 , F_19 ( V_3 ) ) ;
F_26 ( V_3 ) ;
}
static int F_27 ( struct V_44 * V_45 , T_3 V_46 )
{
const struct V_47 * V_24 = ( const struct V_47 * ) V_45 -> V_48 ;
const int type = F_28 ( V_45 ) -> type ;
const int V_49 = F_28 ( V_45 ) -> V_49 ;
struct V_13 * V_19 ;
int V_50 ;
switch ( type ) {
default:
...
static inline void F_32 ( const struct V_47 * V_65 ,
struct V_44 * V_45 )
{
struct V_47 * V_66 = F_33 ( V_45 ) ;
if ( F_34 ( V_65 -> V_67 ) )
F_35 ( V_66 ) ;
}
...
{
struct V_13 * V_68 ;
const struct V_47 * V_24 = F_33 ( V_45 ) ;
F_29 () ;
V_68 = F_4 ( F_25 ( V_45 -> V_3 ) , V_24 -> V_25 , V_24 -> V_26 ) ;
if ( V_68 != NULL ) {
struct V_4 * V_7 ;
if ( ! F_37 ( NULL , V_69 , V_45 ) ) {
F_31 () ;
F_38 ( V_45 ) ;
return 0 ;
}
...
static T_4 F_45 ( struct V_44 * V_45 , struct V_2 * V_3 )
{
...
struct V_80 * V_81 ;
struct V_2 * V_82 ;
const struct V_47 * V_83 = F_33 ( V_45 ) ;
struct V_47 * V_24 ;
unsigned int V_84 ;
T_1 V_85 = V_77 -> V_26 ;
struct V_86 V_87 ;
int V_88 ;
if ( V_45 -> V_72 != F_41 ( V_73 ) )
goto V_89;
if ( V_67 & 1 )
V_67 = V_83 -> V_67 ;
if ( ! V_85 ) {
if ( ( V_81 = F_46 ( V_45 ) ) == NULL ) {
V_3 -> V_12 . V_90 ++ ;
goto V_89;
}
if ( ( V_85 = V_81 -> V_91 ) == 0 )
...
V_78 |= V_83 -> V_79 & F_41 ( V_97 ) ;
if ( V_78 ) {
V_88 = F_51 ( & V_81 -> V_85 ) - sizeof( struct V_47 ) ;
if ( V_88 < 68 ) {
V_3 -> V_12 . V_96 ++ ;
F_50 ( V_81 ) ;
goto V_89;
...
if ( F_52 ( V_45 ) )
F_52 ( V_45 ) -> V_98 -> V_99 ( F_52 ( V_45 ) , V_88 ) ;
if ( ( V_83 -> V_79 & F_41 ( V_97 ) ) &&
V_88 < F_53 ( V_83 -> V_100 ) ) {
F_54 ( V_45 , V_52 , V_55 ,
F_55 ( V_88 ) ) ;
F_50 ( V_81 ) ;
goto V_89;
...
V_84 = ( F_57 ( V_82 ) + sizeof( struct V_47 ) ) ;
if ( F_58 ( V_45 ) < V_84 || F_59 ( V_45 ) ||
( F_60 ( V_45 ) && ! F_61 ( V_45 , 0 ) ) ) {
struct V_44 * V_101 = F_62 ( V_45 , V_84 ) ;
if ( ! V_101 ) {
F_50 ( V_81 ) ;
V_3 -> V_12 . V_102 ++ ;
F_63 ( V_45 ) ;
...
if ( V_45 -> V_104 )
F_64 ( V_101 , V_45 -> V_104 ) ;
F_63 ( V_45 ) ;
V_45 = V_101 ;
V_83 = F_33 ( V_45 ) ;
}
V_45 -> V_105 = V_45 -> V_71 ;
F_65 ( V_45 , sizeof( struct V_47 ) ) ;
F_40 ( V_45 ) ;
memset ( & ( F_66 ( V_45 ) -> V_106 ) , 0 , sizeof( F_66 ( V_45 ) -> V_106 ) ) ;
F_66 ( V_45 ) -> V_27 &= ~ ( V_107 | V_108 |
V_109 ) ;
F_67 ( V_45 ) ;
F_68 ( V_45 , & V_81 -> V_85 ) ;
V_24 = F_33 ( V_45 ) ;
...
V_82 = F_73 ( F_25 ( V_3 ) , V_68 -> V_23 . V_94 ) ;
if ( V_82 ) {
...
static int
F_74 ( struct V_2 * V_3 , struct V_116 * V_117 , int V_118 )
{
int V_50 = 0 ;
struct V_30 V_119 ;
struct V_13 * V_19 ;
...
V_19 = NULL ;
if ( V_3 == V_21 -> V_43 ) {
if ( F_75 ( & V_119 , V_117 -> V_121 . V_122 , sizeof( V_119 ) ) ) {
V_50 = - V_123 ;
break;
}
...
if ( F_76 ( V_117 -> V_121 . V_122 , & V_119 , sizeof( V_119 ) ) )
V_50 = - V_123 ;
break;
case V_124 :
case V_125 :
...
V_119 . V_24 . V_111 != 5 || ( V_119 . V_24 . V_79 & F_41 ( ~ V_97 ) ) )
goto V_128;
if ( V_119 . V_24 . V_60 )
V_119 . V_24 . V_79 |= F_41 ( V_97 ) ;
...
if ( F_76 ( V_117 -> V_121 . V_122 , & V_19 -> V_23 , sizeof( V_119 ) ) )
V_50 = - V_123 ;
} else
...
static int F_81 ( struct V_2 * V_3 , int V_135 )
{
...
F_72 ( V_3 ) ;
V_3 -> V_7 = F_84 ( struct V_4 ) ;
if ( ! V_3 -> V_7 )
return - V_149 ;
return 0 ;
}
static int T_7 F_85 ( struct V_2 * V_3 )
{
struct V_13 * V_68 = F_19 ( V_3 ) ;
...
static void F_86 ( struct V_20 * V_21 , struct V_150 * V_151 )
{
int V_32 ;
...
static int T_7 F_88 ( struct V_14 * V_14 )
{
struct V_20 * V_21 = F_6 ( V_14 , V_22 ) ;
int V_50 ;
...
static void T_8 F_90 ( struct V_14 * V_14 )
{
struct V_20 * V_21 = F_6 ( V_14 , V_22 ) ;
F_91 ( V_158 ) ;
F_92 () ;
F_86 ( V_21 , & V_158 ) ;
F_87 ( V_21 -> V_43 , & V_158 ) ;
F_93 ( & V_158 ) ;
F_94 () ;
}
