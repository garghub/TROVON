...
for ( V_9 = 0 ; V_9 < V_20 -> V_151 ; V_9 ++ ) {
if ( V_20 -> V_152 [ V_9 ] . V_92 & V_153 )
V_124 = V_20 -> V_152 [ V_9 ] . V_154 ;
if ( V_20 -> V_152 [ V_9 ] . V_92 & V_155 )
V_35 = V_20 -> V_152 [ V_9 ] . V_154 ;
}
return F_90 ( & V_20 -> V_20 , V_30 , V_124 , V_35 , V_135 ) ;
}
static int T_8 F_97 ( struct V_150 * V_20 )
{
F_94 ( & V_20 -> V_20 ) ;
return 0 ;
}
static int T_7 F_98 ( struct V_150 * V_156 )
{
struct V_152 V_157 ;
T_9 V_124 ;
const T_4 * V_30 ;
int V_35 , V_135 , V_123 ;
V_30 = F_99 ( V_156 -> V_20 . V_158 , L_45 , NULL ) ;
V_123 = F_100 ( V_156 -> V_20 . V_158 , 0 , & V_157 ) ;
if ( V_123 ) {
F_46 ( & V_156 -> V_20 , L_46 ) ;
return V_123 ;
}
V_124 = V_157 . V_154 ;
V_35 = F_101 ( V_156 -> V_20 . V_158 , 0 ) ;
V_135 = V_136 ;
if ( F_102 ( V_156 -> V_20 . V_158 , L_47 , NULL ) )
V_135 = V_159 ;
return F_90 ( & V_156 -> V_20 , V_30 ? F_103 ( V_30 ) : 0 ,
V_124 , V_35 , V_135 ) ;
}
static int T_8 F_104 ( struct V_150 * V_156 )
{
F_94 ( & V_156 -> V_20 ) ;
return 0 ;
}
static inline int T_10 F_105 ( void )
{
F_106 ( L_48 ) ;
return F_107 ( & V_160 ) ;
}
static inline void T_11 F_108 ( void )
{
F_109 ( & V_160 ) ;
}
static inline int T_10 F_105 ( void ) { return 0 ; }
static inline void T_11 F_108 ( void ) { }
static int T_10 F_110 ( void )
{
int V_123 ;
V_130 = F_111 ( V_130 , L_49 ) ;
if ( V_130 <= 0 ) {
V_123 = - V_143 ;
goto V_161;
}
