...
int V_8 ;
T_2 V_10 , V_11 ;
if ( ( V_8 = F_5 ( V_2 , V_4 , & V_10 ) ) )
return V_8 ;
if ( ( V_8 = F_5 ( V_2 , V_3 , & V_11 ) ) )
return V_8 ;
switch ( V_5 ) {
case 0 :
* V_7 = ( ( T_1 ) ( V_11 & 0x03 ) << 8 ) + ( T_1 ) V_10 ;
break;
case 2 :
* V_7 = ( ( T_1 ) ( V_11 & 0x0C ) << 6 ) + ( T_1 ) V_10 ;
break;
case 4 :
* V_7 = ( ( T_1 ) ( V_11 & 0x30 ) << 4 ) + ( T_1 ) V_10 ;
break;
case 6 :
* V_7 = ( ( T_1 ) ( V_11 & 0xC0 ) << 2 ) + ( T_1 ) V_10 ;
break;
default:
F_6 ( L_1 ) ;
return - V_12 ;
...
if ( V_8 )
return V_8 ;
V_28 = ( ( T_3 ) V_30 << 16 ) + ( ( T_3 ) V_11 << 8 ) + V_10 ;
...
if ( V_8 )
return V_8 ;
* V_45 = ( ( T_3 ) V_30 << 16 ) + ( ( T_3 ) V_11 << 8 ) + V_10 ;
V_8 =
F_5 ( V_17 -> V_2 , V_56 ,
& V_10 ) ;
if ( V_8 )
...
V_8 = F_12 ( V_14 , & V_17 -> V_73 ,
& V_17 -> V_74 ) ;
if ( V_8 == 0 ) {
F_13 ( V_14 ) ;
if ( V_17 -> V_74 > 0 ) {
V_71 =
( T_4 ) V_17 -> V_73 * ( T_4 ) 1000000000 ;
V_72 = ( T_4 ) V_17 -> V_74 ;
V_17 -> V_75 = F_16 ( V_71 , V_72 ) ;
} else {
V_17 -> V_75 = 0xffffffff ;
}
}
V_8 = F_11 ( V_14 , & V_17 -> V_76 ,
& V_17 -> V_77 ,
& V_17 -> V_27 ) ;
if ( V_8 == 0 ) {
V_8 = F_14 ( V_14 ) ;
...
{
struct V_16 * V_17 = V_14 -> V_18 ;
if ( F_18 ( V_79 , V_17 -> V_80 ) ) {
F_10 ( L_12 ) ;
if ( F_15 ( V_14 ) )
F_6 ( L_13 ) ;
V_17 -> V_80 = V_79 + 250 * V_81 / 1000 ;
}
return 0 ;
}
static int F_19 ( struct V_13 * V_14 , T_5 * V_82 )
{
struct V_16 * V_17 = V_14 -> V_18 ;
T_2 V_9 ;
int V_8 ;
if ( V_14 -> V_83 . V_84 . V_85 == NULL )
return - V_86 ;
* V_82 = 0 ;
V_8 = F_8 ( V_17 -> V_2 , V_87 ,
V_88 , V_89 , & V_9 ) ;
if ( V_8 )
return V_8 ;
if ( V_9 )
* V_82 |= V_90 ;
V_8 = F_8 ( V_17 -> V_2 , V_91 ,
V_92 , V_93 ,
& V_9 ) ;
if ( V_8 )
return V_8 ;
...
static int F_21 ( struct V_13 * V_14 , T_3 * V_75 )
{
struct V_16 * V_17 = V_14 -> V_18 ;
if ( V_14 -> V_83 . V_84 . V_85 == NULL )
return - V_86 ;
...
static int F_22 ( struct V_13 * V_14 , T_3 * V_78 )
{
struct V_16 * V_17 = V_14 -> V_18 ;
if ( V_14 -> V_83 . V_84 . V_85 == NULL )
return - V_86 ;
...
static int F_24 ( struct V_13 * V_14 , T_1 * V_110 )
{
return - V_111 ;
}
static int F_25 ( struct V_1 * V_2 , T_6 V_112 )
{
T_2 V_10 , V_11 , V_30 , V_113 , V_114 [ 4 ] ;
int V_8 ;
T_3 V_115 ;
T_3 V_116 ;
T_3 V_117 ;
...
V_10 = ( T_2 ) ( V_115 & 0x000000FF ) ;
V_11 = ( T_2 ) ( ( V_115 & 0x0000FF00 ) >> 8 ) ;
...
if ( V_8 )
return V_8 ;
V_10 = ( T_2 ) ( ( V_119 & 0x0000003F ) ) ;
V_11 = ( T_2 ) ( ( V_119 & 0x00003FC0 ) >> 6 ) ;
...
if ( V_8 )
return V_8 ;
V_10 = ( T_2 ) ( ( V_116 & 0x000000FF ) ) ;
V_11 = ( T_2 ) ( ( V_116 & 0x0000FF00 ) >> 8 ) ;
...
if ( V_8 )
return V_8 ;
V_10 = ( T_2 ) ( V_117 & 0x000000FF ) ;
V_11 = ( T_2 ) ( ( V_117 & 0x0000FF00 ) >> 8 ) ;
...
if ( V_8 )
return V_8 ;
V_10 = ( T_2 ) ( ( V_118 & 0x000000FF ) ) ;
V_11 = ( T_2 ) ( ( V_118 & 0x0000FF00 ) >> 8 ) ;
...
if ( V_8 )
return V_8 ;
V_10 = ( T_2 ) ( ( V_120 & 0x0000003F ) ) ;
V_11 = ( T_2 ) ( ( V_120 & 0x00003FC0 ) >> 6 ) ;
...
static int F_27 ( struct V_13 * V_14 , int V_127 )
{
struct V_16 * V_17 = V_14 -> V_18 ;
T_2 V_9 = V_127 ;
int V_8 ;
F_10 ( L_16 , V_127 ? L_17 : L_18 ) ;
V_8 = F_28 ( V_17 -> V_2 , 0x03 , & V_9 , 1 , NULL , 0 ) ;
return V_8 ;
}
static int F_29 ( struct V_13 * V_14 )
{
struct V_16 * V_17 = V_14 -> V_18 ;
struct V_128 * V_129 = V_14 -> V_130 -> V_131 ;
int V_8 , V_132 , V_133 ;
T_2 V_9 , V_10 = 0 , V_11 = 0 , V_30 = 0 ;
T_2 V_114 [ 2 ] ;
T_1 V_134 ;
F_10 ( L_19 ) ;
F_10 ( L_20 ) ;
...
V_137 , & V_9 ) ) )
return V_8 ;
if ( V_9 & ( V_138 [ V_139 - 1 ] << V_140 ) )
break;
F_30 ( 10 ) ;
}
if ( V_132 == 150 )
return - V_141 ;
V_8 = F_2 ( V_17 -> V_2 , 0xb200 , 0xa9 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , V_142 , 0x07 ) ;
if ( V_8 )
return V_8 ;
V_9 = 0x01 ;
V_8 = F_28 ( V_17 -> V_2 , 0x03 , & V_9 , 1 , NULL , 0 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , V_142 , 0x00 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , 0xb200 , 0xa1 ) ;
if ( V_8 )
return V_8 ;
V_9 = V_138 [ V_139 - 1 ] << V_140 ;
if ( ( V_8 =
F_3 ( V_17 -> V_2 , V_137 ,
V_140 , V_139 , 1 ) ) )
return V_8 ;
V_8 = F_3 ( V_17 -> V_2 , V_137 ,
V_140 , V_139 , 0 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , 0xaefc , 0 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_22 ) ;
if ( ( V_8 =
...
V_154 , V_155 , 0 ) ) )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , 0xa16c , 1 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , 0xa3c1 , 0 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_26 ) ;
if ( ( V_8 = F_25 ( V_17 -> V_2 , V_121 ) ) )
return V_8 ;
F_10 ( L_27 ) ;
if ( ( V_8 =
F_3 ( V_17 -> V_2 , V_156 ,
...
V_21 , 1 ) ) )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , 0xa601 , 0 ) ;
F_10 ( L_30 ) ;
if ( ( V_8 = F_2 ( V_17 -> V_2 , 0xaefb , 0x01 ) ) )
return V_8 ;
F_10 ( L_31 ) ;
V_133 = sizeof( V_162 ) / sizeof( V_163 ) ;
for ( V_132 = 0 ; V_132 < V_133 ; V_132 ++ ) {
if ( ( V_8 =
F_3 ( V_17 -> V_2 , V_162 [ V_132 ] . V_164 ,
V_162 [ V_132 ] . V_5 ,
...
V_11 = V_162 [ V_132 ] . V_165 ;
if ( V_162 [ V_132 ] . V_164 == 0xae1a )
V_10 = V_162 [ V_132 ] . V_165 ;
if ( V_162 [ V_132 ] . V_164 == V_166 )
V_17 -> V_167 = V_162 [ V_132 ] . V_165 ;
if ( V_162 [ V_132 ] . V_164 == V_168 )
V_17 -> V_169 = V_162 [ V_132 ] . V_165 ;
if ( V_162 [ V_132 ] . V_164 == V_170 )
V_17 -> V_171 = V_162 [ V_132 ] . V_165 ;
if ( V_162 [ V_132 ] . V_164 == V_172 )
V_17 -> V_173 = V_162 [ V_132 ] . V_165 ;
}
V_17 -> V_174 =
( ( T_3 ) V_30 << 16 ) + ( ( T_3 ) V_11 << 8 ) + ( T_3 ) V_10 ;
F_10 ( L_32 ) ;
V_8 =
F_4 ( V_17 -> V_2 ,
V_175 ,
...
return V_8 ;
V_8 =
F_4 ( V_17 -> V_2 , 0xA60E , 0xA60A , 4 , 2 ,
& V_17 -> V_181 ) ;
if ( V_8 )
return V_8 ;
V_8 =
F_4 ( V_17 -> V_2 , 0xA60E , 0xA60B , 6 , 2 ,
& V_17 -> V_182 ) ;
if ( V_8 )
return V_8 ;
if ( V_14 -> V_83 . V_84 . V_85 == NULL ) {
...
if ( F_32 ( V_184 , V_14 , & V_129 -> V_183 -> V_185 ,
& V_186 , V_134 ) == NULL ) {
F_10 ( L_35 ) ;
return - V_86 ;
}
...
case 3 :
case 9 :
if ( F_32 ( V_187 , V_14 , & V_129 -> V_183 -> V_185 ,
& V_188 ) == NULL ) {
F_10 ( L_36 ) ;
return - V_86 ;
}
...
static int F_34 ( struct V_13 * V_14 , int V_190 )
{
struct V_16 * V_17 = V_14 -> V_18 ;
if ( V_190 ) {
V_17 -> V_100 ++ ;
...
if ( V_8 )
return V_8 ;
V_8 = F_3 ( V_17 -> V_2 , V_197 , 2 , 1 , 0 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_42 ) ;
V_10 = ( T_2 ) ( V_17 -> V_174 & 0x000000ff ) ;
V_11 = ( T_2 ) ( ( V_17 -> V_174 & 0x0000ff00 ) >> 8 ) ;
V_30 = ( T_2 ) ( ( V_17 -> V_174 & 0x00ff0000 ) >> 16 ) ;
V_8 = F_2 ( V_17 -> V_2 , 0xae1a , V_10 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , 0xae19 , V_11 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_17 -> V_2 , 0xae18 , V_30 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_43 ) ;
V_8 =
...
return V_8 ;
V_8 =
F_1 ( V_17 -> V_2 , 0xA60E , 0xA60A , 4 , 2 ,
V_17 -> V_181 ) ;
if ( V_8 )
return V_8 ;
V_8 =
F_1 ( V_17 -> V_2 , 0xA60E , 0xA60B , 6 , 2 ,
V_17 -> V_182 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_44 ) ;
V_8 = F_26 ( V_17 -> V_2 , V_192 -> V_194 . V_195 . V_196 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_25 ( V_17 -> V_2 , V_192 -> V_194 . V_195 . V_196 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_45 ) ;
V_8 = F_2 ( V_17 -> V_2 , 0xaefd , 0 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_46 ) ;
V_8 =
...
return V_8 ;
F_10 ( L_47 ) ;
V_8 = V_14 -> V_83 . V_84 . V_198 ( V_14 , V_192 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_48 ) ;
V_9 = 0 ;
V_8 = F_36 ( V_17 -> V_2 , 0xffff , & V_9 , 1 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_49 ) ;
V_8 =
...
struct V_13 * F_40 ( struct V_1 * V_2 )
{
struct V_16 * V_17 = NULL ;
V_17 = F_41 ( sizeof( struct V_16 ) , V_240 ) ;
if ( V_17 == NULL )
goto error;
F_10 ( L_82 ) ;
V_17 -> V_2 = V_2 ;
V_17 -> V_100 = 0 ;
memcpy ( & V_17 -> V_241 . V_83 , & V_242 ,
sizeof( struct V_243 ) ) ;
V_17 -> V_241 . V_18 = V_17 ;
return & V_17 -> V_241 ;
error:
return NULL ;
}
