...
static T_1 F_8 ( struct V_10 * V_11 , char * V_12 )
{
...
static T_1 F_11 ( struct V_10 * V_11 , char * V_12 )
{
T_1 V_14 = 0 ;
int V_15 , V_18 ;
struct V_2 * V_3 = F_4 ( V_6 , V_11 -> V_1 ) ;
...
static int F_12 ( struct V_2 * V_3 , unsigned int V_22 )
{
int V_23 ;
...
if ( F_4 ( V_6 , V_1 ) )
return - V_32 ;
V_3 = F_20 ( sizeof( struct V_2 ) , V_33 ) ;
if ( ( V_3 ) == NULL )
return - V_34 ;
V_30 = F_16 ( V_1 ) ;
if ( V_30 == NULL ) {
...
static int T_2 F_26 ( struct V_43 * V_52 ,
unsigned long V_53 ,
void * V_54 )
{
