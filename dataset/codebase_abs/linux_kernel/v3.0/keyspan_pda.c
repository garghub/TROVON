...
static void F_43 ( struct V_6 * V_7 , int V_67 )
{
struct V_11 * V_12 = V_7 -> V_12 ;
if ( V_12 -> V_14 ) {
if ( V_67 )
...
if ( 0 ) { ; }
#ifdef F_48
else if ( F_49 ( V_12 -> V_14 -> V_74 . V_75 ) == V_76 )
V_69 = L_20 ;
#endif
#ifdef F_50
else if ( ( F_49 ( V_12 -> V_14 -> V_74 . V_75 ) == V_77 ) ||
( F_49 ( V_12 -> V_14 -> V_74 . V_75 ) == V_78 ) )
V_69 = L_21 ;
#endif
else {
...
if ( F_51 ( & V_73 , V_69 , & V_12 -> V_14 -> V_14 ) ) {
...
if ( V_23 )
goto V_90;
F_65 (KERN_INFO KBUILD_MODNAME L_27 DRIVER_VERSION L_28
DRIVER_DESC L_29 ) ;
return 0 ;
V_90:
#ifdef F_50
