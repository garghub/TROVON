...
V_3 = F_16 ( sizeof( struct V_2 ) , V_22 ) ;
V_6 = F_17 () ;
if ( ! V_3 || ! V_6 )
goto V_47;
V_3 -> V_5 = F_18 ( V_16 , V_48 ,
V_22 , & V_3 -> V_49 ) ;
if ( ! V_3 -> V_5 )
goto V_47;
V_3 -> V_21 = F_19 ( 0 , V_22 ) ;
if ( ! V_3 -> V_21 )
goto V_50;
V_3 -> V_16 = V_16 ;
V_3 -> V_7 = V_6 ;
if ( V_16 -> V_51 )
F_20 ( V_3 -> V_52 , V_16 -> V_51 ,
sizeof( V_3 -> V_52 ) ) ;
if ( V_16 -> V_53 ) {
if ( V_16 -> V_51 )
F_21 ( V_3 -> V_52 , L_4 , sizeof( V_3 -> V_52 ) ) ;
F_21 ( V_3 -> V_52 , V_16 -> V_53 , sizeof( V_3 -> V_52 ) ) ;
}
if ( ! strlen ( V_3 -> V_52 ) )
...
F_22 ( V_16 -> V_54 . V_55 ) ,
F_22 ( V_16 -> V_54 . V_56 ) ) ;
F_23 ( V_16 , V_3 -> V_57 , sizeof( V_3 -> V_57 ) ) ;
F_21 ( V_3 -> V_57 , L_6 , sizeof( V_3 -> V_57 ) ) ;
V_6 -> V_52 = V_3 -> V_52 ;
V_6 -> V_57 = V_3 -> V_57 ;
F_24 ( V_16 , & V_6 -> V_58 ) ;
...
V_6 -> V_63 = F_6 ;
V_6 -> V_64 = F_8 ;
F_28 ( V_3 -> V_21 , V_16 , V_38 , V_3 -> V_5 ,
( V_39 > 8 ? 8 : V_39 ) ,
F_1 , V_3 , V_37 -> V_65 ) ;
