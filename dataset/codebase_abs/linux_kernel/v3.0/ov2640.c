...
int V_7 ;
if ( ! V_27 -> V_10 . V_110 ||
F_35 ( V_27 -> V_10 . V_110 ) -> V_111 != V_27 -> V_112 ) {
F_27 ( & V_3 -> V_10 , L_10 ) ;
V_7 = - V_113 ;
goto V_21;
}
...
struct V_123 * V_124 = F_39 ( V_3 -> V_10 . V_110 ) ;
struct V_29 * V_30 ;
int V_7 ;
if ( ! V_27 ) {
F_27 ( & V_124 -> V_10 , L_14 ) ;
return - V_33 ;
}
V_30 = F_14 ( V_27 ) ;
if ( ! V_30 ) {
...
V_45 = F_41 ( sizeof( struct V_1 ) , V_127 ) ;
if ( ! V_45 ) {
F_27 ( & V_124 -> V_10 ,
L_17 ) ;
return - V_128 ;
