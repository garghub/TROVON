...
{
struct V_1 * V_2 = F_14 ( V_45 , struct V_1 , V_45 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = F_3 ( V_6 ) ;
...
static T_3 F_15 ( struct V_42 * V_43 , struct V_44 * V_45 ,
struct V_46 * V_47 ,
char * V_48 , T_4 V_49 , T_5 V_50 )
{
struct V_1 * V_2 = F_14 ( V_45 , struct V_1 , V_45 ) ;
...
static int T_6 F_16 ( struct V_5 * V_6 )
{
struct V_54 * V_55 ;
struct V_56 * V_57 ;
...
void T_1 * V_9 ;
int V_60 = 0 ;
V_57 = F_17 ( V_6 , V_61 , 0 ) ;
if ( ! V_57 )
return - V_62 ;
V_8 = F_18 ( & V_6 -> V_2 , sizeof( * V_8 ) , V_63 ) ;
if ( ! V_8 )
return - V_64 ;
V_8 -> V_50 = V_57 -> V_65 - V_57 -> V_66 + 1 ;
if ( ! F_19 ( & V_6 -> V_2 , V_57 -> V_66 , V_8 -> V_50 ,
V_6 -> V_67 ) )
return - V_68 ;
V_9 = F_20 ( & V_6 -> V_2 , V_57 -> V_66 , V_8 -> V_50 ) ;
if ( ! V_9 )
return - V_64 ;
V_8 -> V_51 = V_9 ;
V_8 -> V_53 = V_8 -> V_50 - V_69 ;
V_8 -> V_10 = V_9 + V_8 -> V_53 ;
F_21 ( & V_8 -> V_70 ) ;
V_8 -> V_70 . V_71 . V_67 = L_2 ;
V_8 -> V_70 . V_71 . V_72 = V_73 | V_74 ;
V_8 -> V_70 . V_75 = F_13 ;
V_8 -> V_70 . V_76 = F_15 ;
V_8 -> V_70 . V_50 = V_8 -> V_53 ;
V_9 = V_8 -> V_10 ;
V_59 = F_8 ( V_9 + V_29 ) ;
if ( V_59 & V_77 ) {
V_59 &= V_28 ;
...
if ( ! ( F_8 ( V_9 + V_20 ) & V_78 ) )
F_22 ( & V_6 -> V_2 , L_3 ) ;
V_8 -> V_39 = V_40 ;
F_23 ( V_6 , V_8 ) ;
V_55 = F_24 ( V_6 -> V_67 , & V_6 -> V_2 ,
& V_79 , V_80 ) ;
if ( F_25 ( V_55 ) )
return F_26 ( V_55 ) ;
V_8 -> V_55 = V_55 ;
V_60 = F_27 ( & V_6 -> V_2 . V_45 , & V_8 -> V_70 ) ;
if ( V_60 ) {
F_11 ( & V_6 -> V_2 , L_4 ) ;
F_28 ( V_55 ) ;
}
...
static int T_7 F_29 ( struct V_5 * V_6 )
{
struct V_7 * V_8 = F_3 ( V_6 ) ;
F_30 ( & V_6 -> V_2 . V_45 , & V_8 -> V_70 ) ;
F_28 ( V_8 -> V_55 ) ;
return 0 ;
}
static T_8 int F_31 ( void )
{
return F_32 ( & V_81 ) ;
}
static T_9 void F_33 ( void )
{
F_34 ( & V_81 ) ;
}
