...
int T_1 F_23 ( struct V_39 * V_6 ,
struct V_45 * V_30 )
{
struct V_26 * V_27 = V_6 -> V_16 . V_46 ;
struct V_47 * V_16 = & V_6 -> V_16 ;
struct V_1 * V_2 ;
struct V_37 * V_25 ;
int V_23 = 0 ;
if ( V_27 == NULL ) {
...
if ( V_27 -> V_49 <= 0 || V_27 -> V_50 <= 0 || V_27 -> V_29 == NULL ) {
F_9 ( V_16 , L_6 ) ;
return - V_48 ;
}
V_2 = F_24 ( sizeof( struct V_1 ) , V_51 ) ;
if ( V_2 == NULL ) {
F_9 ( V_16 , L_7 ) ;
return - V_52 ;
}
V_2 -> V_7 . V_6 . V_12 = V_53 | F_25 ( 1 ) ;
V_2 -> V_16 = V_16 ;
V_2 -> V_30 = V_30 ;
V_2 -> V_36 = V_54 ;
V_2 -> V_28 = V_27 ;
...
int F_34 ( struct V_1 * V_25 , T_3 V_60 )
{
int V_23 ;
F_4 ( V_25 -> V_16 , L_12 , V_61 , V_60 . V_62 ) ;
if ( V_60 . V_62 == V_63 ) {
V_23 = F_13 ( V_25 , V_54 ) ;
if ( V_25 -> V_28 -> V_64 == V_65 ) {
F_3 ( V_25 , V_66 , V_25 -> V_67 |
V_68 |
V_69 ) ;
V_25 -> V_32 = 0 ;
}
...
int F_35 ( struct V_1 * V_25 )
{
F_30 ( V_25 -> V_16 , L_13 , V_25 -> V_36 ) ;
if ( V_25 -> V_28 -> V_64 == V_65 ) {
F_3 ( V_25 , V_66 , 0x00 ) ;
}
return F_13 ( V_25 , V_58 ) ;
}
void F_36 ( struct V_1 * V_25 )
{
F_13 ( V_25 , V_54 ) ;
}
