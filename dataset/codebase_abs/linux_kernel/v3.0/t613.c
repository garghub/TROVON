...
V_97 += 2 ;
V_10 -= 2 ;
if ( V_97 [ 0 ] == 0xff && V_97 [ 1 ] == 0xd8 )
V_98 = V_99 ;
else if ( V_97 [ V_10 - 2 ] == 0xff && V_97 [ V_10 - 1 ] == 0xd9 )
V_98 = V_100 ;
else
V_98 = V_101 ;
F_33 ( V_1 , V_98 , V_97 , V_10 ) ;
}
static int F_34 ( struct V_1 * V_1 , T_3 V_18 )
{
struct V_23 * V_23 = (struct V_23 * ) V_1 ;
V_23 -> V_49 = V_18 ;
if ( V_1 -> V_102 )
...
static int F_35 ( struct V_1 * V_1 , T_3 * V_18 )
{
struct V_23 * V_23 = (struct V_23 * ) V_1 ;
* V_18 = V_23 -> V_49 ;
return 0 ;
}
static int F_36 ( struct V_1 * V_1 , T_3 V_18 )
{
struct V_23 * V_23 = (struct V_23 * ) V_1 ;
V_23 -> V_47 = V_18 ;
if ( V_1 -> V_102 )
...
struct V_23 * V_23 = (struct V_23 * ) V_1 ;
T_2 V_103 , V_104 ;
V_103 = V_23 -> V_47 + V_23 -> V_49 + V_23 -> V_51 ;
V_104 = V_18 * 3 ;
V_23 -> V_47 = V_23 -> V_47 * V_104 / V_103 ;
if ( V_23 -> V_47 > 0x40 )
V_23 -> V_47 = 0x40 ;
else if ( V_23 -> V_47 < 0x10 )
V_23 -> V_47 = 0x10 ;
V_23 -> V_49 = V_23 -> V_49 * V_104 / V_103 ;
if ( V_23 -> V_49 > 0x40 )
V_23 -> V_49 = 0x40 ;
else if ( V_23 -> V_49 < 0x10 )
V_23 -> V_49 = 0x10 ;
V_23 -> V_51 = V_23 -> V_51 * V_104 / V_103 ;
if ( V_23 -> V_51 > 0x40 )
V_23 -> V_51 = 0x40 ;
...
struct V_105 * V_106 )
{
static const char * V_107 [ 3 ] = { L_12 , L_13 , L_14 } ;
switch ( V_106 -> V_22 ) {
case V_108 :
if ( ( unsigned ) V_106 -> V_2 >= F_15 ( V_107 ) )
break;
strcpy ( ( char * ) V_106 -> V_109 , V_107 [ V_106 -> V_2 ] ) ;
return 0 ;
case V_110 :
if ( ( unsigned ) V_106 -> V_2 < F_15 ( V_111 ) ) {
strncpy ( ( char * ) V_106 -> V_109 ,
V_111 [ V_106 -> V_2 ] ,
sizeof V_106 -> V_109 ) ;
return 0 ;
}
...
const struct V_21 * V_22 )
{
return F_62 ( V_113 , V_22 , & V_114 , sizeof( struct V_23 ) ,
V_115 ) ;
}
