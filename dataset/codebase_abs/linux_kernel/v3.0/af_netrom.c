...
break;
case V_74 :
V_76 = V_34 -> V_75 / ( 60 * V_55 ) ;
break;
default:
return - V_63 ;
}
V_77 = F_45 (unsigned int, len, sizeof(int)) ;
if ( F_46 ( V_77 , V_60 ) )
return - V_65 ;
return F_47 ( V_59 , & V_76 , V_77 ) ? - V_65 : 0 ;
}
static int F_48 ( struct V_56 * V_10 , int V_78 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
F_49 ( V_11 ) ;
if ( V_11 -> V_28 != V_29 ) {
memset ( & F_11 ( V_11 ) -> V_79 , 0 , V_80 ) ;
V_11 -> V_81 = V_78 ;
V_11 -> V_28 = V_29 ;
F_50 ( V_11 ) ;
return 0 ;
...
static int F_51 ( struct V_83 * V_83 , struct V_56 * V_10 , int V_84 ,
int V_85 )
{
struct V_10 * V_11 ;
struct V_33 * V_34 ;
if ( ! F_14 ( V_83 , & V_22 ) )
return - V_86 ;
if ( V_10 -> type != V_87 || V_84 != 0 )
return - V_88 ;
V_11 = F_52 ( V_83 , V_89 , V_90 , & V_91 ) ;
if ( V_11 == NULL )
return - V_92 ;
V_34 = F_11 ( V_11 ) ;
F_53 ( V_10 , V_11 ) ;
...
static struct V_10 * F_57 ( struct V_10 * V_107 )
{
struct V_10 * V_11 ;
struct V_33 * V_34 , * V_108 ;
if ( V_107 -> V_109 != V_87 )
return NULL ;
V_11 = F_52 ( F_58 ( V_107 ) , V_89 , V_90 , V_107 -> V_110 ) ;
if ( V_11 == NULL )
return NULL ;
V_34 = F_11 ( V_11 ) ;
F_53 ( NULL , V_11 ) ;
V_11 -> V_109 = V_107 -> V_109 ;
V_11 -> V_111 = V_107 -> V_111 ;
V_11 -> V_95 = V_107 -> V_95 ;
V_11 -> V_112 = V_107 -> V_112 ;
V_11 -> V_113 = V_107 -> V_113 ;
V_11 -> V_28 = V_114 ;
F_59 ( V_11 , V_107 ) ;
F_54 ( & V_34 -> V_96 ) ;
F_54 ( & V_34 -> V_97 ) ;
...
F_55 ( V_11 ) ;
V_108 = F_11 ( V_107 ) ;
V_34 -> V_67 = V_108 -> V_67 ;
V_34 -> V_69 = V_108 -> V_69 ;
V_34 -> V_71 = V_108 -> V_71 ;
V_34 -> V_73 = V_108 -> V_73 ;
V_34 -> V_75 = V_108 -> V_75 ;
V_34 -> V_104 = V_108 -> V_104 ;
V_34 -> V_16 = V_108 -> V_16 ;
V_34 -> V_106 = V_108 -> V_106 ;
return V_11 ;
}
...
static int F_64 ( struct V_56 * V_10 , struct V_125 * V_126 , int V_127 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_33 * V_34 = F_11 ( V_11 ) ;
struct V_128 * V_26 = (struct V_128 * ) V_126 ;
struct V_1 * V_2 ;
T_3 * V_129 ;
T_1 * V_130 ;
F_49 ( V_11 ) ;
...
if ( V_127 < sizeof( struct V_132 ) || V_127 > sizeof( struct V_128 ) ) {
F_50 ( V_11 ) ;
return - V_64 ;
}
if ( V_127 < ( V_26 -> V_133 . V_134 * sizeof( T_1 ) + sizeof( struct V_132 ) ) ) {
F_50 ( V_11 ) ;
return - V_64 ;
}
if ( V_26 -> V_133 . V_135 != V_136 ) {
F_50 ( V_11 ) ;
return - V_64 ;
}
if ( ( V_2 = F_66 ( & V_26 -> V_133 . V_137 ) ) == NULL ) {
F_50 ( V_11 ) ;
return - V_138 ;
}
if ( V_26 -> V_133 . V_134 == 1 ) {
if ( ! F_67 ( V_139 ) ) {
F_68 ( V_2 ) ;
F_50 ( V_11 ) ;
return - V_140 ;
}
V_34 -> V_79 = V_26 -> V_141 [ 0 ] ;
V_34 -> V_27 = V_26 -> V_133 . V_137 ;
} else {
V_130 = & V_26 -> V_133 . V_137 ;
V_129 = F_69 ( F_70 () ) ;
if ( V_129 ) {
V_34 -> V_79 = V_129 -> V_142 ;
F_71 ( V_129 ) ;
} else {
if ( V_143 && ! F_67 ( V_139 ) ) {
F_50 ( V_11 ) ;
...
static int F_73 ( struct V_56 * V_10 , struct V_125 * V_126 ,
int V_127 , int V_145 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_33 * V_34 = F_11 ( V_11 ) ;
struct V_132 * V_26 = (struct V_132 * ) V_126 ;
T_1 * V_130 = NULL ;
T_3 * V_129 ;
struct V_1 * V_2 ;
int V_146 = 0 ;
F_49 ( V_11 ) ;
if ( V_11 -> V_28 == V_114 && V_10 -> V_49 == V_147 ) {
V_10 -> V_49 = V_148 ;
goto V_149;
}
if ( V_11 -> V_28 == V_120 && V_10 -> V_49 == V_147 ) {
V_10 -> V_49 = V_150 ;
V_146 = - V_151 ;
goto V_149;
}
...
V_34 -> V_49 = V_115 ;
F_38 ( V_11 ) ;
if ( V_11 -> V_28 != V_114 && ( V_145 & V_156 ) ) {
V_146 = - V_157 ;
goto V_149;
}
if ( V_11 -> V_28 == V_155 ) {
...
static int F_86 ( struct V_56 * V_10 , struct V_125 * V_126 ,
int * V_165 , int V_166 )
{
struct V_128 * V_167 = (struct V_128 * ) V_126 ;
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_33 * V_34 = F_11 ( V_11 ) ;
F_49 ( V_11 ) ;
if ( V_166 != 0 ) {
...
V_167 -> V_133 . V_135 = V_136 ;
V_167 -> V_133 . V_134 = 1 ;
V_167 -> V_133 . V_137 = V_34 -> V_79 ;
memset ( V_167 -> V_141 , 0 , sizeof( V_167 -> V_141 ) ) ;
V_167 -> V_141 [ 0 ] = V_34 -> V_40 ;
* V_165 = sizeof( struct V_128 ) ;
} else {
V_167 -> V_133 . V_135 = V_136 ;
V_167 -> V_133 . V_134 = 0 ;
V_167 -> V_133 . V_137 = V_34 -> V_27 ;
* V_165 = sizeof( struct V_132 ) ;
}
F_50 ( V_11 ) ;
return 0 ;
}
...
struct V_10 * V_169 ;
struct V_33 * V_170 ;
T_1 * V_171 , * V_37 , * V_129 ;
unsigned short V_172 , V_173 ;
unsigned short V_174 , V_175 ;
unsigned short V_176 , V_145 , V_104 , V_177 ;
int V_178 ;
V_46 -> V_11 = NULL ;
...
V_170 -> V_36 = V_41 % 256 ;
V_41 ++ ;
if ( V_104 < V_170 -> V_104 )
V_170 -> V_104 = V_104 ;
if ( V_46 -> V_77 == 37 ) {
V_177 = V_46 -> V_44 [ 36 ] * 256 + V_46 -> V_44 [ 35 ] ;
if ( V_177 * V_55 < V_170 -> V_67 )
V_170 -> V_67 = V_177 * V_55 ;
V_170 -> V_106 = 1 ;
} else {
V_170 -> V_106 = 0 ;
}
...
struct V_196 * V_197 , T_4 V_77 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_33 * V_34 = F_11 ( V_11 ) ;
struct V_132 * V_198 = (struct V_132 * ) V_197 -> V_199 ;
int V_146 ;
struct V_132 V_167 ;
struct V_45 * V_46 ;
unsigned char * V_200 ;
...
V_167 = * V_198 ;
if ( F_20 ( & V_34 -> V_40 , & V_167 . V_137 ) != 0 ) {
V_146 = - V_152 ;
goto V_206;
}
...
V_167 . V_135 = V_136 ;
V_167 . V_137 = V_34 -> V_40 ;
}
if ( V_77 > 65536 ) {
V_146 = - V_210 ;
goto V_206;
}
V_201 = V_77 + V_181 + V_182 ;
if ( ( V_46 = F_100 ( V_11 , V_201 , V_197 -> V_202 & V_203 , & V_146 ) ) == NULL )
goto V_206;
F_101 ( V_46 , V_201 - V_77 ) ;
F_89 ( V_46 ) ;
...
* V_200 ++ = V_211 ;
F_103 ( V_46 , V_77 ) ;
if ( F_104 ( F_105 ( V_46 ) , V_197 -> V_212 , V_77 ) ) {
F_39 ( V_46 ) ;
V_146 = - V_65 ;
goto V_206;
}
...
{
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_132 * V_167 = (struct V_132 * ) V_197 -> V_199 ;
T_4 V_213 ;
struct V_45 * V_46 ;
int V_214 ;
F_49 ( V_11 ) ;
...
F_109 ( V_46 , 0 , V_197 -> V_212 , V_213 ) ;
if ( V_167 != NULL ) {
V_167 -> V_135 = V_136 ;
F_110 ( V_46 , 7 , V_167 -> V_137 . V_216 ,
V_80 ) ;
}
...
V_243 = V_2 -> V_246 ;
F_126 ( V_240 , L_3 , F_127 ( V_244 , & V_34 -> V_79 ) ) ;
