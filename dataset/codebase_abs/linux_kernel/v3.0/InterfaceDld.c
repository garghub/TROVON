...
static int F_22 ( unsigned char * V_52 ,
unsigned char * V_10 , unsigned int V_7 )
{
int V_32 = V_26 ;
T_5 V_30 = F_23 ( V_53 ) ;
if( ( V_7 -sizeof( unsigned int ) ) < 4 )
...
while( V_7 )
{
if( * ( unsigned int * ) & V_52 [ V_7 ] !=
* ( unsigned int * ) & V_10 [ V_7 ] )
{
...
static INT F_27 ( T_5 V_30 , V_50 V_57 , T_8 V_36 ,
T_9 V_56 )
{
unsigned int V_7 = 0 ;
int V_32 = V_26 ;
...
if ( V_26 != ( V_32 = F_22 ( V_52 , V_57 , V_7 ) ) )
{
break;
}
V_56 += V_7 ;
...
INT F_21 ( T_5 V_30 , unsigned char * V_57 , unsigned int V_36 ,
unsigned long V_56 )
{
INT V_58 = V_26 ;
