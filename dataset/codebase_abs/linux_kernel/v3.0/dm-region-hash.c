...
void F_56 ( struct V_1 * V_2 , int V_65 )
{
...
V_2 -> log -> type -> V_70 ( V_2 -> log , V_10 -> V_12 ) ;
F_50 ( V_10 , 1 ) ;
F_29 ( V_10 , V_2 -> V_39 ) ;
}
...
F_63 ( & V_10 -> V_54 ) ;
F_64 ( & V_2 -> V_31 ) ;
V_2 -> log -> type -> V_73 ( V_2 -> log , V_10 -> V_12 ) ;
} else
F_64 ( & V_2 -> V_31 ) ;
F_47 ( & V_2 -> V_24 ) ;
}
...
{
struct V_6 * V_6 ;
for ( V_6 = V_15 -> V_74 ; V_6 ; V_6 = V_6 -> V_75 ) {
if ( V_6 -> V_62 & V_63 )
continue;
...
if ( F_40 ( V_2 -> V_38 ) ) {
V_10 -> V_50 = V_53 ;
} else if ( V_10 -> V_50 == V_64 ) {
F_67 ( & V_10 -> V_54 , & V_2 -> V_35 ) ;
} else if ( V_10 -> V_50 == V_72 ) {
V_10 -> V_50 = V_52 ;
...
T_1 V_5 ;
struct V_9 * V_10 ;
V_57 = V_2 -> log -> type -> V_77 ( V_2 -> log , & V_5 ) ;
if ( V_57 <= 0 )
return V_57 ;
F_48 ( & V_2 -> V_24 ) ;
V_10 = F_46 ( V_2 , V_5 ) ;
...
{
return V_2 -> log -> type -> V_71 ( V_2 -> log ) ;
}
