...
{
V_37 -> V_79 = F_56 ( V_71 , V_18 , & V_37 -> V_107 ) ;
if ( ! V_37 -> V_79 ) {
return - V_19 ;
}
F_54 ( V_37 ) ;
...
{
memset ( V_37 -> V_79 , 0 , V_100 ) ;
F_18 ( V_71 , V_37 -> V_79 , V_37 -> V_107 ) ;
}
...
{
V_9 -> V_108 . V_109 = sizeof( struct V_67 ) ;
return F_58 ( V_9 ) ;
}
static int F_61 ( struct V_8 * V_9 )
{
V_9 -> V_110 . V_109 = sizeof( struct V_44 ) ;
return F_58 ( V_9 ) ;
}
...
static int F_63 ( struct V_8 * V_9 , T_3 V_111 , T_2 V_112 ,
int V_113 , T_2 V_114 , const T_3 * V_115 , int V_116 )
{
struct V_54 * V_55 = F_26 ( V_9 ) ;
struct V_3 * V_39 ;
struct V_30 * V_31 ;
...
T_2 V_118 , V_119 ;
F_9 ( V_100 < V_120 ) ;
V_117 = F_56 ( V_71 , V_18 , & V_118 ) ;
if ( ! V_117 )
return - V_19 ;
V_31 = F_56 ( V_38 , V_18 , & V_119 ) ;
if ( ! V_31 ) {
F_18 ( V_71 , V_117 , V_118 ) ;
return - V_19 ;
}
V_39 = F_15 () ;
if ( ! V_39 ) {
F_18 ( V_71 , V_117 , V_118 ) ;
F_18 ( V_38 , V_31 , V_119 ) ;
return - V_121 ;
}
memcpy ( V_117 , V_115 , V_116 ) ;
memset ( V_117 + V_116 , 0 , V_120 - V_116 ) ;
...
const T_3 * V_115 , int V_116 , unsigned V_128 )
{
...
struct V_104 * V_37 ;
struct V_54 * V_55 = F_26 ( V_9 ) ;
const struct V_15 * V_134 ;
V_37 = V_50 ? & V_55 -> V_50 : & V_55 -> V_78 ;
V_132 = V_37 -> V_79 + V_37 -> V_105 ;
V_134 = F_7 ( V_9 ) ;
V_133 = V_134 -> V_133 | ( V_47 << 6 ) ;
#ifndef F_69
V_133 ^= 0xAA000000 ;
#endif
* ( T_2 * ) V_132 = F_28 ( V_133 ) ;
V_132 += sizeof( V_133 ) ;
memcpy ( V_132 , V_134 -> V_135 , V_128 ) ;
V_132 += V_128 ;
V_129 = V_37 -> V_107 + V_37 -> V_105
+ sizeof( V_134 -> V_133 ) ;
V_130 = V_129 + V_128 ;
V_113 = V_132 - ( V_37 -> V_79 + V_37 -> V_105 ) ;
V_131 = V_37 -> V_107 + V_37 -> V_105 ;
V_37 -> V_105 += V_113 ;
V_37 -> V_106 |= V_136 ;
if ( ! V_50 )
V_37 -> V_106 |= V_137 ;
V_85 = F_63 ( V_9 , V_138 , V_130 ,
V_113 , V_131 , V_115 , V_116 ) ;
if ( V_85 )
return V_85 ;
return F_63 ( V_9 , V_139 , V_129 ,
V_113 , V_131 , V_115 , V_116 ) ;
}
...
V_39 -> V_141 = V_142 ;
V_39 -> V_61 = 0 ;
V_39 -> V_124 = V_37 -> V_107 ;
V_39 -> V_53 = V_37 -> V_107 + sizeof( T_2 ) ;
V_39 -> V_125 = V_143 ;
V_39 -> V_113 = V_37 -> V_105 ;
V_39 -> V_24 |= V_77 ;
F_64 ( & V_55 -> V_75 ) ;
F_65 ( V_101 , F_2 ( V_39 ) ) ;
F_66 ( F_67 ( V_101 ) ) ;
...
if ( V_144 & V_148 ) {
switch ( V_116 ) {
case 16 : V_145 = V_149 | V_150 ; break;
case 24 : V_145 = V_151 | V_152 ; break;
case 32 : V_145 = V_153 | V_154 ; break;
default:
* V_22 |= V_155 ;
return - V_156 ;
}
...
const T_2 * V_158 = ( const T_2 * ) V_115 ;
if ( F_13 ( ! ( ( V_158 [ 0 ] ^ V_158 [ 2 ] ) | ( V_158 [ 1 ] ^ V_158 [ 3 ] ) ) ||
! ( ( V_158 [ 2 ] ^ V_158 [ 4 ] ) | ( V_158 [ 3 ] ^ V_158 [ 5 ] ) ) ) )
{
* V_22 |= V_159 ;
return - V_156 ;
}
...
T_2 V_160 [ V_161 ] ;
if ( F_72 ( V_160 , V_115 ) == 0 ) {
* V_22 |= V_162 ;
}
}
* ( T_2 * ) V_132 = F_28 ( V_144 ) ;
V_132 += sizeof( V_144 ) ;
memcpy ( V_132 , V_115 , V_116 ) ;
if ( V_116 < V_163 && ! ( V_144 & V_148 ) ) {
memset ( V_132 + V_116 , 0 , V_163 - V_116 ) ;
V_116 = V_163 ;
}
V_37 -> V_105 = sizeof( V_144 ) + V_116 ;
V_37 -> V_106 |= V_164 ;
if ( ( V_144 & V_148 ) && ! V_50 ) {
return F_70 ( V_9 ) ;
}
...
struct V_165 * V_166 , unsigned V_167 ,
struct V_30 * V_31 , T_4 V_22 ,
enum V_168 V_37 )
{
for (; V_167 > 0 ; V_166 = F_74 ( V_166 ) ) {
unsigned V_169 = F_75 ( V_167 , V_166 -> V_170 ) ;
struct V_30 * V_171 ;
T_2 V_172 ;
void * V_173 ;
V_167 -= V_169 ;
V_173 = F_76 ( F_77 ( V_166 ) ) + V_166 -> V_174 ;
V_171 = F_56 ( V_38 , V_22 , & V_172 ) ;
if ( ! V_171 ) {
V_31 = NULL ;
break;
}
F_78 ( V_166 ) = F_79 ( V_2 , V_173 , V_169 , V_37 ) ;
V_31 -> V_34 = V_171 ;
V_31 -> V_35 = V_172 ;
V_31 = V_171 ;
V_31 -> V_74 = F_78 ( V_166 ) ;
V_31 -> V_36 = V_169 ;
V_31 -> V_37 = V_37 ;
}
V_31 -> V_34 = NULL ;
...
static int F_80 ( struct V_175 * V_9 , const T_3 * V_115 ,
unsigned int V_116 )
{
struct V_54 * V_55 = F_81 ( V_9 ) ;
T_2 * V_22 = & V_9 -> V_62 . V_146 ;
int V_85 ;
F_82 ( & V_55 -> V_76 ) ;
F_64 ( & V_55 -> V_75 ) ;
F_54 ( & V_55 -> V_50 ) ;
F_54 ( & V_55 -> V_78 ) ;
V_55 -> V_50 . V_106 = V_176 ;
V_55 -> V_78 . V_106 = V_176 ;
V_85 = F_71 ( & V_9 -> V_62 , 0 , V_115 , V_116 ) ;
if ( V_85 )
goto V_177;
V_85 = F_71 ( & V_9 -> V_62 , 1 , V_115 , V_116 ) ;
if ( V_85 )
goto V_177;
if ( * V_22 & V_162 ) {
if ( * V_22 & V_178 ) {
...
static int F_84 ( struct V_175 * V_9 , const T_3 * V_115 ,
unsigned int V_116 )
{
struct V_54 * V_55 = F_81 ( V_9 ) ;
if ( V_116 < V_179 )
return - V_156 ;
memcpy ( V_55 -> V_180 , V_115 + ( V_116 - V_179 ) ,
V_179 ) ;
V_116 -= V_179 ;
return F_80 ( V_9 , V_115 , V_116 ) ;
}
static int F_85 ( struct V_65 * V_41 , int V_50 )
{
struct V_175 * V_9 = F_86 ( V_41 ) ;
struct V_54 * V_55 = F_81 ( V_9 ) ;
unsigned V_181 = F_87 ( V_9 ) ;
struct V_104 * V_37 ;
struct V_3 * V_39 ;
unsigned int V_167 = V_41 -> V_167 ;
enum V_168 V_182 = V_183 ;
struct V_67 * V_45 = F_25 ( V_41 ) ;
struct V_30 V_184 ;
T_4 V_22 = V_41 -> V_62 . V_22 & V_185 ?
V_18 : V_186 ;
if ( F_88 ( V_101 ) )
return - V_121 ;
if ( F_89 ( & V_55 -> V_75 ) )
...
V_39 -> V_42 . V_66 = V_41 ;
V_39 -> V_124 = V_37 -> V_107 ;
V_39 -> V_125 = V_37 -> V_106 ;
V_39 -> V_113 = V_37 -> V_105 ;
V_39 -> V_140 = 0 ;
V_39 -> V_141 = V_167 ;
F_66 ( V_181 && ! V_41 -> V_187 ) ;
memcpy ( V_39 -> V_188 , V_41 -> V_187 , V_181 ) ;
if ( V_41 -> V_52 != V_41 -> V_68 ) {
struct V_30 V_189 ;
V_39 -> V_125 |= V_190 ;
F_66 ( V_41 -> V_68 -> V_170 < V_167 ) ;
V_45 -> V_68 = NULL ;
if ( ! F_73 ( V_2 , V_41 -> V_68 , V_167 , & V_189 ,
V_22 , V_191 ) )
goto V_192;
V_182 = V_193 ;
...
V_45 -> V_52 = NULL ;
if ( ! F_73 ( V_2 , V_41 -> V_52 , V_167 , & V_184 ,
V_22 , V_182 ) )
goto V_194;
V_45 -> V_52 = V_184 . V_34 ;
V_39 -> V_61 = V_184 . V_35 ;
V_39 -> V_24 |= V_64 ;
F_65 ( V_101 , F_2 ( V_39 ) ) ;
F_66 ( F_67 ( V_101 ) ) ;
return - V_195 ;
...
int V_85 ;
memcpy ( V_188 , V_55 -> V_180 , V_179 ) ;
memcpy ( V_188 + V_179 , V_187 , V_197 ) ;
* ( V_198 * ) ( V_188 + V_179 + V_197 ) =
F_28 ( 1 ) ;
V_41 -> V_187 = V_188 ;
V_85 = F_85 ( V_41 , 1 ) ;
V_41 -> V_187 = V_187 ;
...
static int F_93 ( struct V_165 * V_166 , unsigned V_199 ,
unsigned int V_167 )
{
int V_174 = 0 ;
if ( ! V_167 )
return 0 ;
for (; ; ) {
if ( V_199 < V_174 + V_166 -> V_170 )
break;
V_174 += V_166 -> V_170 ;
V_166 = F_74 ( V_166 ) ;
}
return ( V_199 + V_167 > V_174 + V_166 -> V_170 ) ;
}
...
unsigned V_181 = F_96 ( V_9 ) ;
unsigned V_47 = F_22 ( V_9 ) ;
struct V_104 * V_37 ;
struct V_3 * V_39 ;
unsigned int V_49 ;
struct V_30 * V_31 , V_184 ;
struct V_44 * V_45 = F_20 ( V_41 ) ;
T_4 V_22 = V_41 -> V_62 . V_22 & V_185 ?
V_18 : V_186 ;
if ( F_88 ( V_101 ) )
...
V_39 -> V_141 = V_201 ;
V_39 -> V_122 = 0 ;
V_39 -> V_123 = V_41 -> V_202 + V_181 + V_49 ;
F_66 ( V_181 && ! V_41 -> V_188 ) ;
memcpy ( V_39 -> V_188 , V_41 -> V_188 , V_181 ) ;
if ( V_41 -> V_52 != V_41 -> V_68 ) {
F_29 () ;
}
V_31 = F_73 ( V_2 , V_41 -> V_203 , V_41 -> V_202 , & V_184 ,
V_22 , V_193 ) ;
V_45 -> V_60 = V_184 . V_34 ;
V_39 -> V_61 = V_184 . V_35 ;
if ( ! V_31 )
goto V_177;
F_97 ( & V_45 -> V_204 , 1 ) ;
F_98 ( & V_45 -> V_204 , V_188 , V_181 ) ;
V_31 = F_73 ( V_2 , & V_45 -> V_204 , V_181 , V_31 , V_22 ,
V_183 ) ;
if ( ! V_31 )
goto V_205;
...
struct V_54 * V_55 = F_95 ( V_9 ) ;
T_2 * V_22 = & V_9 -> V_62 . V_146 ;
unsigned V_128 = F_100 ( V_9 ) -> V_207 ;
int V_85 ;
...
static int F_102 ( struct V_46 * V_9 , const T_3 * V_115 ,
unsigned int V_213 )
{
struct V_54 * V_55 = F_95 ( V_9 ) ;
struct V_214 * V_215 = (struct V_214 * ) V_115 ;
struct V_216 * V_217 ;
...
V_115 += F_107 ( V_215 -> V_222 ) ;
V_213 -= F_107 ( V_215 -> V_222 ) ;
if ( V_213 < V_55 -> V_208 )
goto V_218;
V_55 -> V_209 = V_213 - V_55 -> V_208 ;
memcpy ( V_55 -> V_210 , V_115 + V_55 -> V_209 , V_55 -> V_208 ) ;
memcpy ( V_55 -> V_211 , V_115 , V_55 -> V_209 ) ;
...
{
unsigned V_181 = F_96 ( F_21 ( V_41 ) ) ;
return F_94 ( V_41 , 1 , V_41 -> V_202 + V_181 ,
V_41 -> V_49 , V_41 -> V_188 ) ;
}
static int F_110 ( struct V_40 * V_41 )
{
unsigned V_181 = F_96 ( F_21 ( V_41 ) ) ;
return F_94 ( V_41 , 0 , V_41 -> V_202 + V_181 ,
V_41 -> V_49 , V_41 -> V_188 ) ;
}
...
struct V_54 * V_55 = F_95 ( V_9 ) ;
unsigned V_169 , V_181 = F_96 ( V_9 ) ;
T_5 V_224 ;
if ( ! V_55 -> V_225 ) {
F_113 ( V_55 -> V_226 , V_181 ) ;
V_55 -> V_225 = 1 ;
}
memcpy ( V_41 -> V_227 . V_188 , V_55 -> V_226 , V_181 ) ;
V_169 = V_181 ;
if ( V_181 > sizeof( V_228 ) ) {
memset ( V_41 -> V_229 , 0 , V_181 - sizeof( V_228 ) ) ;
V_169 = sizeof( V_228 ) ;
}
V_224 = F_114 ( V_41 -> V_224 ) ;
memcpy ( V_41 -> V_229 + V_181 - V_169 , & V_224 , V_169 ) ;
return F_94 ( & V_41 -> V_227 , 1 , V_41 -> V_227 . V_202 ,
V_41 -> V_227 . V_49 + V_181 , V_41 -> V_229 ) ;
}
...
V_234 -> V_241 = V_242 |
V_243 ;
if ( ! V_234 -> V_244 . V_245 )
V_234 -> V_244 . V_245 = F_80 ;
if ( ! V_234 -> V_244 . V_50 )
V_234 -> V_244 . V_50 = F_90 ;
if ( ! V_234 -> V_244 . V_78 )
V_234 -> V_244 . V_78 = F_91 ;
V_234 -> V_246 = F_60 ;
} else {
V_234 -> V_239 = & V_247 ;
V_234 -> V_241 = V_248 |
V_243 ;
V_234 -> V_249 . V_245 = F_102 ;
V_234 -> V_249 . V_250 = F_101 ;
V_234 -> V_249 . V_50 = F_109 ;
V_234 -> V_249 . V_78 = F_110 ;
V_234 -> V_249 . V_251 = F_111 ;
V_234 -> V_246 = F_61 ;
}
V_234 -> V_252 = sizeof( struct V_54 ) ;
V_234 -> V_253 = V_254 ;
V_234 -> V_255 = 3 ;
V_234 -> V_256 = 300 ;
V_234 -> V_257 = F_62 ;
