...
{
int V_5 ;
struct V_8 * V_9 = F_37 ( sizeof *V_9 , V_48 ) ;
if ( ! V_9 ) {
V_5 = - V_49 ;
goto V_23;
}
F_38 ( V_47 , V_9 ) ;
V_9 -> V_20 = F_37 ( sizeof( * V_9 -> V_20 ) * V_50 , V_48 ) ;
if ( V_9 -> V_20 == NULL ) {
V_5 = - V_49 ;
goto V_51;
}
V_9 -> V_11 = F_37 ( sizeof( * V_9 -> V_11 ) * V_52 , V_48 ) ;
if ( V_9 -> V_11 == NULL ) {
V_5 = - V_49 ;
goto V_53;
}
...
V_9 -> V_7 -> V_55 = V_47 -> V_2 . V_56 -> V_55 ;
V_9 -> V_7 -> V_2 . V_57 = & V_47 -> V_2 ;
V_9 -> V_7 -> V_58 = & V_59 ;
V_9 -> V_7 -> V_60 = ( void * ) ( V_9 ) ;
V_9 -> V_7 -> V_61 = V_62 ;
V_5 = F_41 ( V_9 -> V_7 ) ;
if ( V_5 )
goto V_63;
