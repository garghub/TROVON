...
static T_3
int F_42 ( struct V_98 * V_99 , struct V_2 * V_3 )
{
struct V_100 * V_85 = V_99 -> V_85 ;
...
static void
F_47 ( struct V_98 * V_99 , struct V_2 * V_3 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
int V_91 ;
if ( V_11 -> V_34 )
...
for ( V_91 = 0 ; V_91 < V_96 ; V_91 ++ )
if ( V_11 -> V_97 [ V_91 ] )
F_48 ( V_11 -> V_70 , V_11 -> V_97 [ V_91 ] ) ;
F_49 ( V_11 ) ;
}
int T_3 F_50 ( struct V_98 * V_99 )
{
struct V_1 * V_11 ;
int V_67 , V_113 ;
V_113 = sizeof( * V_11 ) + ( V_96 * sizeof( struct V_9 * ) ) ;
