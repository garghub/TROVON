...
F_96 ( V_94 , V_157 , sizeof( V_158 ) , & V_158 ) ;
return V_94 -> V_62 ;
V_159:
return - 1 ;
}
...
V_169 . V_24 = V_2 -> V_24 ;
V_169 . V_171 = V_2 -> V_68 ;
V_169 . V_172 = V_2 -> V_76 ;
V_169 . V_173 = V_2 -> V_60 ;
...
static void
F_107 ( struct V_91 * V_92 , struct V_174 * V_108 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_175 * V_16 ;
struct V_1 * V_2 ;
...
unsigned int V_176 ;
for ( V_176 = 0 ; V_176 < V_14 -> V_100 . V_178 ; V_176 ++ ) {
F_108 (cl, n, &q->clhash.hash[i], cl_common.hnode)
F_117 ( V_2 ) ;
}
V_14 -> V_6 = V_134 ;
F_73 ( & V_14 -> V_90 ) ;
...
for ( V_176 = 0 ; V_176 < V_14 -> V_100 . V_178 ; V_176 ++ ) {
F_121 (cl, n, next, &q->clhash.hash[i],
cl_common.hnode)
F_76 ( V_92 , V_2 ) ;
}
F_122 ( & V_14 -> V_100 ) ;
...
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
unsigned char * V_187 = F_124 ( V_94 ) ;
struct V_184 V_185 ;
V_185 . V_154 = V_14 -> V_154 ;
F_96 ( V_94 , V_110 , sizeof( V_185 ) , & V_185 ) ;
return V_94 -> V_62 ;
V_159:
F_125 ( V_94 , V_187 ) ;
return - 1 ;
...
F_42 ( V_2 , F_48 ( V_94 ) ) ;
F_131 ( & V_2 -> V_121 , V_94 ) ;
V_92 -> V_14 . V_86 ++ ;
return V_147 ;
}
static struct V_93 *
F_132 ( struct V_91 * V_92 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_1 * V_2 ;
struct V_93 * V_94 ;
...
if ( V_2 -> V_85 -> V_95 -> V_192 != NULL &&
( V_62 = V_2 -> V_85 -> V_95 -> V_192 ( V_2 -> V_85 ) ) > 0 ) {
if ( V_2 -> V_85 -> V_14 . V_86 == 0 ) {
F_41 ( V_2 , 0 , 0 ) ;
F_44 ( V_2 ) ;
} else {
