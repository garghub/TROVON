...
static T_1 F_18 ( struct V_18 * V_18 , const char T_2 * V_24 ,
T_3 V_25 , T_4 * V_26 )
{
if ( V_25 ) {
if ( ! V_21 ) {
...
static long F_20 ( struct V_18 * V_18 , unsigned int V_30 ,
unsigned long V_31 )
{
int V_14 ;
int V_32 , V_33 = - V_12 ;
...
switch ( V_30 ) {
case V_38 :
return F_21 ( V_37 . V_36 , & V_36 ,
sizeof( V_36 ) ) ? - V_29 : 0 ;
case V_39 :
F_10 ( & V_14 ) ;
return F_22 ( V_14 , V_37 . V_27 ) ;
case V_40 :
return F_22 ( 0 , V_37 . V_27 ) ;
case V_41 :
if ( F_19 ( V_32 , V_37 . V_27 ) )
return - V_29 ;
if ( V_32 & V_42 ) {
F_6 () ;
V_33 = 0 ;
...
return 0 ;
case V_45 :
if ( F_19 ( V_34 , V_37 . V_27 ) )
return - V_29 ;
if ( F_8 ( V_34 ) )
return - V_12 ;
F_7 () ;
case V_46 :
return F_22 ( V_13 , V_37 . V_27 ) ;
default:
return - V_47 ;
}
}
...
{
int V_55 ;
F_5 (KERN_INFO PFX DRIVER_VERSION) ;
if ( F_8 ( V_13 ) ) {
F_8 ( V_56 ) ;
F_5 (KERN_INFO PFX
L_4 ,
