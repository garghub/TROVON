...
unsigned long V_20 = F_14 ( V_11 , NULL , 10 ) ;
F_15 ( & V_3 -> V_21 ) ;
V_3 -> V_17 [ V_14 ] = F_2 ( ( ( V_20 * 958 ) / 10000 ) + 3 , 0 , 255 ) ;
F_5 ( V_3 , V_22 [ V_14 ] , V_3 -> V_17 [ V_14 ] ) ;
F_16 ( & V_3 -> V_21 ) ;
return V_19 ;
}
...
F_5 ( V_3 , V_23 [ V_14 ] , V_3 -> V_18 [ V_14 ] ) ;
F_16 ( & V_3 -> V_21 ) ;
return V_19 ;
}
...
{
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , V_3 -> V_24 [ 0 ] * 250 ) ;
}
static T_2 F_24 ( struct V_7 * V_8 , struct V_9 * V_10 ,
char * V_11 )
{
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , V_3 -> V_25 [ 0 ] * 1000 ) ;
}
...
{
struct V_2 * V_3 = F_13 ( V_8 ) ;
int V_20 = F_27 ( V_11 , NULL , 10 ) ;
F_15 ( & V_3 -> V_21 ) ;
V_3 -> V_25 [ 0 ] = F_2 ( ( V_20 + 500 ) / 1000 , 0 , 255 ) ;
F_5 ( V_3 , V_27 [ 0 ] , V_3 -> V_25 [ 0 ] ) ;
F_16 ( & V_3 -> V_21 ) ;
return V_19 ;
}
...
int V_14 = V_13 -> V_15 ;
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , F_30 ( V_3 -> V_24 [ V_14 ] ) ) ;
}
...
int V_14 = V_13 -> V_15 ;
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , F_32 ( V_3 -> V_25 [ V_14 ] ) ) ;
}
...
int V_20 = F_27 ( V_11 , NULL , 10 ) ;
F_15 ( & V_3 -> V_21 ) ;
V_3 -> V_25 [ V_14 ] = F_2 ( F_35 ( V_20 ) , 0 , 255 ) ;
F_5 ( V_3 , V_27 [ V_14 ] , V_3 -> V_25 [ V_14 ] ) ;
F_16 ( & V_3 -> V_21 ) ;
return V_19 ;
}
...
int V_14 = V_13 -> V_15 ;
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , F_38 ( V_3 -> V_29 [ V_14 ] ,
F_39 ( V_3 -> V_30 [ V_14 ] ) ) ) ;
}
...
int V_14 = V_13 -> V_15 ;
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , F_38 ( V_3 -> V_31 [ V_14 ] ,
F_39 ( V_3 -> V_30 [ V_14 ] ) ) ) ;
}
...
int V_14 = V_13 -> V_15 ;
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , F_39 ( V_3 -> V_30 [ V_14 ] ) ) ;
}
...
int V_14 = V_13 -> V_15 ;
struct V_2 * V_3 = F_13 ( V_8 ) ;
int V_20 = F_14 ( V_11 , NULL , 10 ) ;
F_15 ( & V_3 -> V_21 ) ;
V_3 -> V_31 [ V_14 ] = F_1 ( V_20 , F_39 ( V_3 -> V_30 [ V_14 ] ) ) ;
F_5 ( V_3 , F_43 ( V_14 ) , V_3 -> V_31 [ V_14 ] ) ;
F_16 ( & V_3 -> V_21 ) ;
return V_19 ;
}
...
unsigned long V_20 = F_14 ( V_11 , NULL , 10 ) ;
int V_14 = V_13 -> V_15 ;
int V_32 = F_3 ( V_3 , V_33 ) ;
long V_34 = F_38 ( V_3 -> V_31 [ V_14 ] ,
F_39 ( V_3 -> V_30 [ V_14 ] ) ) ;
F_15 ( & V_3 -> V_21 ) ;
switch ( V_20 ) {
case 1 : V_3 -> V_30 [ V_14 ] = 0 ; break;
case 2 : V_3 -> V_30 [ V_14 ] = 1 ; break;
case 4 : V_3 -> V_30 [ V_14 ] = 2 ; break;
case 8 : V_3 -> V_30 [ V_14 ] = 3 ; break;
default:
F_45 ( V_8 , L_2
L_3 , V_20 ) ;
F_16 ( & V_3 -> V_21 ) ;
...
V_3 -> V_31 [ V_14 ] = F_1 ( V_34 , F_39 ( V_3 -> V_30 [ V_14 ] ) ) ;
F_5 ( V_3 , F_43 ( V_14 ) , V_3 -> V_31 [ V_14 ] ) ;
V_32 = ( V_32 & 0x0f ) | ( V_3 -> V_30 [ 1 ] << 6 ) | ( V_3 -> V_30 [ 0 ] << 4 ) ;
F_5 ( V_3 , V_33 , V_32 ) ;
F_16 ( & V_3 -> V_21 ) ;
return V_19 ;
}
...
{
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_1 , V_3 -> V_36 ) ;
}
static T_2 F_47 ( struct V_7 * V_8 , struct V_9 * V_10 ,
char * V_11 )
{
int V_37 = F_8 ( V_10 ) -> V_15 ;
struct V_2 * V_3 = F_9 ( V_8 ) ;
return sprintf ( V_11 , L_4 , ( V_3 -> V_36 >> V_37 ) & 1 ) ;
}
static T_2 F_48 ( struct V_7 * V_8 , struct V_9
* V_38 , char * V_11 )
{
struct V_2 * V_3 = F_13 ( V_8 ) ;
return sprintf ( V_11 , L_5 , V_3 -> V_39 ) ;
}
...
struct V_2 * V_3 ;
int V_44 = 0 , V_45 ;
V_43 = F_50 ( V_41 , V_46 , 0 ) ;
if ( ! F_51 ( V_43 -> V_47 , V_48 ,
V_49 . V_50 . V_39 ) ) {
F_45 ( & V_41 -> V_8 , L_6 ,
( unsigned long ) V_43 -> V_47 , ( unsigned long ) V_43 -> V_51 ) ;
return - V_52 ;
}
if ( ! ( V_3 = F_52 ( sizeof( struct V_2 ) , V_53 ) ) ) {
V_44 = - V_54 ;
goto V_55;
}
F_53 ( V_41 , V_3 ) ;
...
V_62:
for ( V_45 = 0 ; V_45 < F_57 ( V_63 ) ; V_45 ++ )
F_63 ( & V_41 -> V_8 . V_56 , & V_63 [ V_45 ] ) ;
for ( V_45 = 0 ; V_45 < F_57 ( V_61 ) ; V_45 ++ )
F_63 ( & V_41 -> V_8 . V_56 , & V_61 [ V_45 ] ) ;
F_63 ( & V_41 -> V_8 . V_56 , & V_57 ) ;
V_58:
F_53 ( V_41 , NULL ) ;
F_64 ( V_3 ) ;
V_55:
...
static int T_4 F_66 ( struct V_40 * V_41 )
{
struct V_2 * V_3 = F_67 ( V_41 ) ;
int V_45 ;
F_68 ( V_3 -> V_64 ) ;
for ( V_45 = 0 ; V_45 < F_57 ( V_63 ) ; V_45 ++ )
F_63 ( & V_41 -> V_8 . V_56 , & V_63 [ V_45 ] ) ;
...
V_3 -> V_29 [ V_45 ] = F_3 ( V_3 ,
F_70 ( V_45 ) ) ;
V_3 -> V_31 [ V_45 ] = F_3 ( V_3 ,
F_43 ( V_45 ) ) ;
}
V_67 = F_3 ( V_3 , V_73 ) ;
...
V_45 = F_3 ( V_3 , V_33 ) ;
V_3 -> V_30 [ 0 ] = ( V_45 >> 4 ) & 0x03 ;
V_3 -> V_30 [ 1 ] = V_45 >> 6 ;
V_3 -> V_36 = F_3 ( V_3 , V_76 ) |
( F_3 ( V_3 , V_77 ) << 8 ) ;
if ( ! V_3 -> V_29 [ 0 ] && V_3 -> V_31 [ 0 ] ) {
V_3 -> V_36 |= 0x40 ;
} else if ( V_3 -> V_29 [ 0 ] && ! V_3 -> V_31 [ 0 ] ) {
V_3 -> V_36 &= ~ 0x40 ;
}
if ( ! V_3 -> V_29 [ 1 ] && V_3 -> V_31 [ 1 ] ) {
V_3 -> V_36 |= 0x80 ;
} else if ( V_3 -> V_29 [ 1 ] && ! V_3 -> V_31 [ 1 ] ) {
V_3 -> V_36 &= ~ 0x80 ;
}
V_3 -> V_69 = V_68 ;
V_3 -> V_71 = 1 ;
