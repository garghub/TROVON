...
if ( V_2 -> V_3 != V_22 )
return V_5 ;
if ( V_2 -> V_10 == (sizeof( unsigned long ) * 3 ) ) {
if ( V_52 -> V_53 . V_54 == true )
V_51 = V_5 ;
else {
V_52 -> V_53 . V_54 = true ;
...
if ( V_2 -> V_3 != V_4 )
return V_5 ;
if ( F_25 ( V_38 , V_61 ) == true )
V_50 = V_62 ;
else if ( F_25 ( V_38 , V_43 ) == true )
V_50 = V_63 ;
else if ( F_25 ( V_38 , V_64 ) == true )
V_50 = V_65 ;
else
V_50 = V_66 ;
* ( V_11 * ) V_2 -> V_12 = V_50 ;
