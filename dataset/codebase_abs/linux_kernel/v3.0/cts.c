...
static int F_21 ( struct V_1 * V_20 )
{
struct V_35 * V_36 = ( void * ) V_20 -> V_37 ;
struct V_38 * V_39 = F_22 ( V_36 ) ;
...
static void F_26 ( struct V_1 * V_20 )
{
struct V_5 * V_6 = F_2 ( V_20 ) ;
F_27 ( V_6 -> V_8 ) ;
}
static struct V_35 * F_28 ( struct V_41 * * V_42 )
{
struct V_35 * V_36 ;
struct V_43 * V_44 ;
int V_9 ;
