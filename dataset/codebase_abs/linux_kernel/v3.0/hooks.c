...
static int F_198 ( struct V_19 * V_19 , int V_302 , unsigned V_69 )
{
const struct V_7 * V_7 = F_52 () ;
struct V_251 V_252 ;
T_2 V_238 ;
...
V_252 . V_257 . V_19 = V_19 ;
if ( V_476 )
V_252 . V_478 . V_479 |= V_480 ;
V_238 = F_114 ( V_19 -> V_226 , V_302 ) ;
return F_100 ( V_7 , V_19 , V_238 , & V_252 , V_69 ) ;
}
static int F_199 ( struct V_52 * V_52 , struct V_481 * V_481 )
{
const struct V_7 * V_7 = F_52 () ;
unsigned int V_482 = V_481 -> V_482 ;
if ( V_482 & V_483 ) {
V_482 &= ~ ( V_484 | V_485 | V_486 |
V_483 ) ;
if ( ! V_482 )
return 0 ;
}
if ( V_482 & ( V_486 | V_487 | V_488 |
V_489 | V_490 | V_491 ) )
return F_105 ( V_7 , V_52 , V_492 ) ;
...
const void * V_469 , T_7 V_497 , int V_69 )
{
struct V_19 * V_19 = V_52 -> V_56 ;
struct V_20 * V_21 = V_19 -> V_30 ;
struct V_31 * V_32 ;
...
if ( V_47 )
return V_47 ;
V_47 = F_54 ( V_469 , V_497 , & V_272 ) ;
if ( V_47 == - V_86 ) {
if ( ! F_202 ( V_499 ) )
return V_47 ;
V_47 = F_205 ( V_469 , V_497 , & V_272 ) ;
}
if ( V_47 )
return V_47 ;
...
static int F_211 ( const struct V_19 * V_19 , const char * V_64 , void * * V_214 , bool V_502 )
{
T_2 V_497 ;
int error ;
char * V_83 = NULL ;
...
if ( ! V_469 || ! V_497 )
return - V_501 ;
V_47 = F_54 ( ( void * ) V_469 , V_497 , & V_272 ) ;
if ( V_47 )
return V_47 ;
V_21 -> V_14 = V_272 ;
V_21 -> V_114 = 1 ;
...
static int F_213 ( struct V_19 * V_19 , char * V_214 , T_7 V_504 )
{
...
static void F_214 ( const struct V_19 * V_19 , T_2 * V_505 )
{
struct V_20 * V_21 = V_19 -> V_30 ;
* V_505 = V_21 -> V_14 ;
}
...
if ( ! V_302 )
return 0 ;
if ( V_14 == V_38 -> V_14 && V_38 -> V_506 == V_21 -> V_14 &&
V_38 -> V_507 == F_217 () )
return 0 ;
...
static int F_220 ( struct V_36 * V_36 , unsigned int V_508 ,
unsigned long V_509 )
{
const struct V_7 * V_7 = F_52 () ;
int error = 0 ;
...
static int F_221 ( struct V_36 * V_36 , unsigned long V_522 , int V_523 )
{
const struct V_7 * V_7 = F_52 () ;
int V_47 = 0 ;
if ( V_524 &&
( V_522 & V_525 ) && ( ! V_36 || ( ! V_523 && ( V_522 & V_526 ) ) ) ) {
V_47 = F_90 ( V_7 , V_7 , V_527 ) ;
if ( V_47 )
goto error;
}
if ( V_36 ) {
T_2 V_255 = V_306 ;
if ( V_523 && ( V_522 & V_526 ) )
V_255 |= V_310 ;
if ( V_522 & V_525 )
V_255 |= V_304 ;
...
static int F_222 ( struct V_36 * V_36 , unsigned long V_528 ,
unsigned long V_522 , unsigned long V_69 ,
unsigned long V_529 , unsigned long V_530 )
{
int V_47 = 0 ;
T_2 V_14 = F_14 () ;
if ( V_529 < V_531 ) {
V_47 = F_35 ( V_14 , V_14 , V_532 ,
V_533 , NULL ) ;
if ( V_47 )
return V_47 ;
}
V_47 = F_223 ( V_36 , V_528 , V_522 , V_69 , V_529 , V_530 ) ;
if ( V_47 || V_530 )
return V_47 ;
if ( V_534 )
V_522 = V_528 ;
return F_221 ( V_36 , V_522 ,
( V_69 & V_535 ) == V_536 ) ;
}
static int F_224 ( struct V_537 * V_538 ,
unsigned long V_528 ,
unsigned long V_522 )
{
const struct V_7 * V_7 = F_52 () ;
...
V_522 = V_528 ;
if ( V_524 &&
( V_522 & V_525 ) && ! ( V_538 -> V_539 & V_540 ) ) {
int V_47 = 0 ;
if ( V_538 -> V_541 >= V_538 -> V_542 -> V_543 &&
V_538 -> V_544 <= V_538 -> V_542 -> V_545 ) {
V_47 = F_90 ( V_7 , V_7 , V_546 ) ;
} else if ( ! V_538 -> V_547 &&
V_538 -> V_541 <= V_538 -> V_542 -> V_548 &&
V_538 -> V_544 >= V_538 -> V_542 -> V_548 ) {
V_47 = F_92 ( V_8 , V_549 ) ;
} else if ( V_538 -> V_547 && V_538 -> V_550 ) {
V_47 = F_107 ( V_7 , V_538 -> V_547 , V_551 ) ;
}
if ( V_47 )
return V_47 ;
}
return F_221 ( V_538 -> V_547 , V_522 , V_538 -> V_539 & V_552 ) ;
}
static int F_225 ( struct V_36 * V_36 , unsigned int V_508 )
{
const struct V_7 * V_7 = F_52 () ;
return F_107 ( V_7 , V_36 , V_553 ) ;
}
static int F_226 ( struct V_36 * V_36 , unsigned int V_508 ,
unsigned long V_509 )
{
const struct V_7 * V_7 = F_52 () ;
int V_554 = 0 ;
...
if ( ( V_36 -> V_316 & V_317 ) && ! ( V_509 & V_317 ) ) {
V_554 = F_107 ( V_7 , V_36 , V_310 ) ;
break;
}
case V_556 :
case V_557 :
...
struct V_568 * V_569 , int V_570 )
{
struct V_36 * V_36 ;
T_2 V_14 = F_10 ( V_248 ) ;
T_2 V_228 ;
struct V_37 * V_38 ;
V_36 = F_229 ( V_569 , struct V_36 , V_571 ) ;
V_38 = V_36 -> V_40 ;
if ( ! V_570 )
V_228 = F_89 ( V_572 ) ;
else
...
V_38 = V_36 -> V_40 ;
V_21 = V_19 -> V_30 ;
V_38 -> V_506 = V_21 -> V_14 ;
V_38 -> V_507 = F_217 () ;
return F_104 ( V_7 , V_19 , F_116 ( V_36 ) , 0 ) ;
}
static int F_232 ( unsigned long V_573 )
{
return F_92 ( V_8 , V_574 ) ;
}
static int F_233 ( struct V_7 * V_7 , T_9 V_575 )
{
struct V_10 * V_11 ;
V_11 = F_7 ( sizeof( struct V_10 ) , V_575 ) ;
if ( ! V_11 )
return - V_24 ;
V_7 -> V_16 = V_11 ;
return 0 ;
...
struct V_10 * V_11 ;
V_370 = V_331 -> V_16 ;
V_11 = F_236 ( V_370 , sizeof( struct V_10 ) , V_575 ) ;
if ( ! V_11 )
return - V_24 ;
V_330 -> V_16 = V_11 ;
return 0 ;
...
static int F_238 ( struct V_7 * V_330 , T_2 V_505 )
{
struct V_10 * V_11 = V_330 -> V_16 ;
T_2 V_14 = F_14 () ;
int V_576 ;
V_576 = F_35 ( V_14 , V_505 ,
V_577 ,
V_578 ,
NULL ) ;
if ( V_576 == 0 ) {
...
static int F_240 ( char * V_580 )
{
T_2 V_14 ;
struct V_251 V_252 ;
V_14 = F_10 ( V_8 ) ;
F_95 ( & V_252 , V_581 ) ;
V_252 . V_257 . V_580 = V_580 ;
return F_35 ( V_14 , V_15 , V_262 ,
V_582 , & V_252 ) ;
}
static int F_241 ( struct V_17 * V_127 , T_10 V_583 )
{
...
static void F_244 ( struct V_17 * V_127 , T_2 * V_505 )
{
* V_505 = F_10 ( V_127 ) ;
}
static int F_245 ( struct V_17 * V_127 , int V_587 )
{
int V_47 ;
V_47 = F_246 ( V_127 , V_587 ) ;
if ( V_47 )
return V_47 ;
return F_92 ( V_127 , V_588 ) ;
}
static int F_247 ( struct V_17 * V_127 , int V_589 )
{
int V_47 ;
V_47 = F_248 ( V_127 , V_589 ) ;
if ( V_47 )
return V_47 ;
return F_92 ( V_127 , V_588 ) ;
}
...
static int F_250 ( struct V_17 * V_127 , unsigned int V_591 ,
struct V_417 * V_592 )
{
struct V_417 * V_593 = V_127 -> signal -> V_418 + V_591 ;
if ( V_593 -> V_425 != V_592 -> V_425 )
...
static int F_255 ( struct V_17 * V_127 , struct V_595 * V_596 ,
int V_227 , T_2 V_505 )
{
T_2 V_228 ;
int V_47 ;
...
static int F_258 ( struct V_598 * V_599 ,
struct V_251 * V_252 , T_11 * V_600 )
{
int V_601 , V_602 , V_576 = - V_86 ;
struct V_603 V_604 , * V_605 ;
V_601 = F_259 ( V_599 ) ;
V_605 = F_260 ( V_599 , V_601 , sizeof( V_604 ) , & V_604 ) ;
if ( V_605 == NULL )
goto V_66;
V_602 = V_605 -> V_606 * 4 ;
if ( V_602 < sizeof( V_604 ) )
goto V_66;
V_252 -> V_257 . V_607 . V_608 . V_609 = V_605 -> V_609 ;
V_252 -> V_257 . V_607 . V_608 . V_610 = V_605 -> V_610 ;
V_576 = 0 ;
if ( V_600 )
* V_600 = V_605 -> V_166 ;
switch ( V_605 -> V_166 ) {
case V_168 : {
struct V_611 V_612 , * V_613 ;
if ( F_261 ( V_605 -> V_614 ) & V_615 )
break;
V_601 += V_602 ;
V_613 = F_260 ( V_599 , V_601 , sizeof( V_612 ) , & V_612 ) ;
if ( V_613 == NULL )
break;
V_252 -> V_257 . V_607 . V_616 = V_613 -> V_617 ;
V_252 -> V_257 . V_607 . V_618 = V_613 -> V_619 ;
break;
}
case V_169 : {
...
break;
V_601 += V_602 ;
V_622 = F_260 ( V_599 , V_601 , sizeof( V_621 ) , & V_621 ) ;
if ( V_622 == NULL )
break;
V_252 -> V_257 . V_607 . V_616 = V_622 -> V_617 ;
V_252 -> V_257 . V_607 . V_618 = V_622 -> V_619 ;
break;
}
case V_623 : {
...
break;
V_601 += V_602 ;
V_626 = F_260 ( V_599 , V_601 , sizeof( V_625 ) , & V_625 ) ;
if ( V_626 == NULL )
break;
V_252 -> V_257 . V_607 . V_616 = V_626 -> V_627 ;
V_252 -> V_257 . V_607 . V_618 = V_626 -> V_628 ;
break;
}
default:
break;
...
static int F_262 ( struct V_598 * V_599 ,
struct V_251 * V_252 , T_11 * V_600 )
{
T_11 V_629 ;
int V_576 = - V_86 , V_601 ;
struct V_630 V_631 , * V_632 ;
V_601 = F_259 ( V_599 ) ;
V_632 = F_260 ( V_599 , V_601 , sizeof( V_631 ) , & V_631 ) ;
if ( V_632 == NULL )
goto V_66;
F_263 ( & V_252 -> V_257 . V_607 . V_633 . V_609 , & V_632 -> V_609 ) ;
F_263 ( & V_252 -> V_257 . V_607 . V_633 . V_610 , & V_632 -> V_610 ) ;
V_576 = 0 ;
V_629 = V_632 -> V_629 ;
V_601 += sizeof( V_631 ) ;
V_601 = F_264 ( V_599 , V_601 , & V_629 ) ;
if ( V_601 < 0 )
goto V_66;
if ( V_600 )
* V_600 = V_629 ;
...
static int F_265 ( struct V_598 * V_599 , struct V_251 * V_252 ,
char * * V_634 , int V_635 , T_11 * V_600 )
{
char * V_636 ;
int V_576 ;
switch ( V_252 -> V_257 . V_607 . V_170 ) {
case V_177 :
V_576 = F_258 ( V_599 , V_252 , V_600 ) ;
if ( V_576 )
goto V_637;
V_636 = ( char * ) ( V_635 ? & V_252 -> V_257 . V_607 . V_608 . V_609 :
& V_252 -> V_257 . V_607 . V_608 . V_610 ) ;
goto V_638;
#if F_266 ( V_639 ) || F_266 ( V_640 )
case V_178 :
V_576 = F_262 ( V_599 , V_252 , V_600 ) ;
if ( V_576 )
goto V_637;
V_636 = ( char * ) ( V_635 ? & V_252 -> V_257 . V_607 . V_633 . V_609 :
& V_252 -> V_257 . V_607 . V_633 . V_610 ) ;
goto V_638;
#endif
default:
V_636 = NULL ;
...
static int F_267 ( struct V_598 * V_599 , T_4 V_170 , T_2 * V_14 )
{
int V_554 ;
T_2 V_641 ;
T_2 V_642 ;
T_2 V_643 ;
F_268 ( V_599 , & V_641 ) ;
F_269 ( V_599 , V_170 , & V_643 , & V_642 ) ;
V_554 = F_270 ( V_642 , V_643 , V_641 , V_14 ) ;
if ( F_102 ( V_554 ) ) {
F_38 ( V_61
L_40
L_41 ) ;
...
return F_87 ( V_11 -> V_14 , V_11 -> V_14 , V_644 , NULL ,
V_645 ) ;
}
static int F_272 ( struct V_17 * V_18 , struct V_647 * V_648 , T_2 V_238 )
{
struct V_649 * V_650 = V_648 -> V_651 ;
struct V_251 V_252 ;
T_2 V_240 = F_10 ( V_18 ) ;
if ( V_650 -> V_14 == V_15 )
return 0 ;
F_95 ( & V_252 , V_652 ) ;
V_252 . V_257 . V_607 . V_648 = V_648 ;
return F_35 ( V_240 , V_650 -> V_14 , V_650 -> V_28 , V_238 , & V_252 ) ;
}
...
if ( V_653 )
return 0 ;
V_644 = F_71 ( V_170 , type , V_166 ) ;
V_47 = F_271 ( V_11 , V_644 , & V_272 ) ;
if ( V_47 )
return V_47 ;
return F_35 ( V_11 -> V_14 , V_272 , V_644 , V_654 , NULL ) ;
}
static int F_274 ( struct V_655 * V_647 , int V_170 ,
int type , int V_166 , int V_653 )
{
const struct V_10 * V_11 = F_15 () ;
struct V_20 * V_21 = F_275 ( V_647 ) -> V_30 ;
struct V_649 * V_650 ;
int V_554 = 0 ;
...
V_554 = F_271 ( V_11 , V_21 -> V_28 , & ( V_21 -> V_14 ) ) ;
if ( V_554 )
return V_554 ;
}
V_21 -> V_114 = 1 ;
if ( V_647 -> V_648 ) {
V_650 = V_647 -> V_648 -> V_651 ;
V_650 -> V_14 = V_21 -> V_14 ;
V_650 -> V_28 = V_21 -> V_28 ;
V_554 = F_276 ( V_647 -> V_648 , V_170 ) ;
}
return V_554 ;
}
static int F_277 ( struct V_655 * V_647 , struct V_656 * V_657 , int V_658 )
{
struct V_647 * V_648 = V_647 -> V_648 ;
T_4 V_170 ;
int V_554 ;
V_554 = F_272 ( V_8 , V_648 , V_659 ) ;
if ( V_554 )
goto V_66;
V_170 = V_648 -> V_660 ;
...
V_665 = F_261 ( V_662 -> V_667 ) ;
V_636 = ( char * ) & V_662 -> V_668 . V_669 ;
} else {
V_664 = (struct V_663 * ) V_657 ;
V_665 = F_261 ( V_664 -> V_670 ) ;
V_636 = ( char * ) & V_664 -> V_671 . V_672 ;
}
if ( V_665 ) {
int V_673 , V_674 ;
F_278 ( & V_673 , & V_674 ) ;
if ( V_665 < V_675 ( V_676, V_673 ) || V_665 > V_674 ) {
V_554 = F_279 ( V_648 -> V_677 ,
V_665 , & V_14 ) ;
if ( V_554 )
goto V_66;
F_95 ( & V_252 , V_652 ) ;
V_252 . V_257 . V_607 . V_616 = F_280 ( V_665 ) ;
V_252 . V_257 . V_607 . V_170 = V_170 ;
V_554 = F_35 ( V_650 -> V_14 , V_14 ,
V_650 -> V_28 ,
V_678 , & V_252 ) ;
if ( V_554 )
goto V_66;
...
V_252 . V_257 . V_607 . V_170 = V_170 ;
if ( V_170 == V_177 )
V_252 . V_257 . V_607 . V_608 . V_609 = V_662 -> V_668 . V_669 ;
else
F_263 ( & V_252 . V_257 . V_607 . V_633 . V_609 , & V_664 -> V_671 ) ;
V_554 = F_35 ( V_650 -> V_14 , V_14 ,
V_650 -> V_28 , V_666 , & V_252 ) ;
if ( V_554 )
goto V_66;
}
V_66:
...
static int F_282 ( struct V_655 * V_647 , struct V_656 * V_657 , int V_658 )
{
struct V_647 * V_648 = V_647 -> V_648 ;
struct V_649 * V_650 = V_648 -> V_651 ;
int V_554 ;
V_554 = F_272 ( V_8 , V_648 , V_683 ) ;
if ( V_554 )
return V_554 ;
if ( V_650 -> V_28 == V_179 ||
V_650 -> V_28 == V_183 ) {
...
V_554 = F_279 ( V_648 -> V_677 , V_665 , & V_14 ) ;
if ( V_554 )
goto V_66;
V_228 = ( V_650 -> V_28 == V_179 ) ?
V_685 : V_686 ;
F_95 ( & V_252 , V_652 ) ;
V_252 . V_257 . V_607 . V_618 = F_280 ( V_665 ) ;
V_252 . V_257 . V_607 . V_170 = V_648 -> V_660 ;
V_554 = F_35 ( V_650 -> V_14 , V_14 , V_650 -> V_28 , V_228 , & V_252 ) ;
if ( V_554 )
goto V_66;
}
V_554 = F_283 ( V_648 , V_657 ) ;
V_66:
return V_554 ;
}
static int F_284 ( struct V_655 * V_647 , int V_687 )
{
return F_272 ( V_8 , V_647 -> V_648 , V_688 ) ;
}
static int F_285 ( struct V_655 * V_647 , struct V_655 * V_689 )
{
int V_554 ;
struct V_20 * V_21 ;
struct V_20 * V_123 ;
V_554 = F_272 ( V_8 , V_647 -> V_648 , V_690 ) ;
if ( V_554 )
return V_554 ;
V_123 = F_275 ( V_689 ) -> V_30 ;
V_21 = F_275 ( V_647 ) -> V_30 ;
V_123 -> V_28 = V_21 -> V_28 ;
V_123 -> V_14 = V_21 -> V_14 ;
V_123 -> V_114 = 1 ;
return 0 ;
}
static int F_286 ( struct V_655 * V_647 , struct V_691 * V_692 ,
int V_497 )
{
return F_272 ( V_8 , V_647 -> V_648 , V_693 ) ;
}
static int F_287 ( struct V_655 * V_647 , struct V_691 * V_692 ,
int V_497 , int V_69 )
{
return F_272 ( V_8 , V_647 -> V_648 , V_694 ) ;
}
static int F_288 ( struct V_655 * V_647 )
{
return F_272 ( V_8 , V_647 -> V_648 , V_695 ) ;
}
static int F_289 ( struct V_655 * V_647 )
{
return F_272 ( V_8 , V_647 -> V_648 , V_695 ) ;
}
static int F_290 ( struct V_655 * V_647 , int V_696 , int V_697 )
{
int V_554 ;
V_554 = F_272 ( V_8 , V_647 -> V_648 , V_698 ) ;
if ( V_554 )
return V_554 ;
return F_291 ( V_647 , V_696 , V_697 ) ;
}
static int F_292 ( struct V_655 * V_647 , int V_696 ,
int V_697 )
{
return F_272 ( V_8 , V_647 -> V_648 , V_699 ) ;
}
static int F_293 ( struct V_655 * V_647 , int V_700 )
{
return F_272 ( V_8 , V_647 -> V_648 , V_701 ) ;
}
static int F_294 ( struct V_647 * V_647 ,
struct V_647 * V_702 ,
struct V_647 * V_703 )
{
struct V_649 * V_704 = V_647 -> V_651 ;
struct V_649 * V_705 = V_702 -> V_651 ;
struct V_649 * V_706 = V_703 -> V_651 ;
struct V_251 V_252 ;
int V_554 ;
F_95 ( & V_252 , V_652 ) ;
V_252 . V_257 . V_607 . V_648 = V_702 ;
V_554 = F_35 ( V_704 -> V_14 , V_705 -> V_14 ,
V_705 -> V_28 ,
V_707 , & V_252 ) ;
if ( V_554 )
return V_554 ;
V_706 -> V_708 = V_704 -> V_14 ;
V_554 = F_295 ( V_705 -> V_14 , V_704 -> V_14 ,
& V_706 -> V_14 ) ;
if ( V_554 )
return V_554 ;
...
static int F_296 ( struct V_655 * V_647 ,
struct V_655 * V_702 )
{
struct V_649 * V_709 = V_647 -> V_648 -> V_651 ;
struct V_649 * V_710 = V_702 -> V_648 -> V_651 ;
struct V_251 V_252 ;
F_95 ( & V_252 , V_652 ) ;
V_252 . V_257 . V_607 . V_648 = V_702 -> V_648 ;
return F_35 ( V_709 -> V_14 , V_710 -> V_14 , V_710 -> V_28 , V_711 ,
& V_252 ) ;
}
static int F_297 ( int V_712 , char * V_636 , T_4 V_170 ,
T_2 V_708 ,
struct V_251 * V_252 )
{
int V_554 ;
T_2 V_713 ;
T_2 V_714 ;
V_554 = F_298 ( V_712 , & V_713 ) ;
if ( V_554 )
return V_554 ;
V_554 = F_35 ( V_708 , V_713 ,
V_715 , V_716 , V_252 ) ;
if ( V_554 )
return V_554 ;
V_554 = F_281 ( V_636 , V_170 , & V_714 ) ;
if ( V_554 )
return V_554 ;
return F_35 ( V_708 , V_714 ,
V_717 , V_718 , V_252 ) ;
}
static int F_299 ( struct V_647 * V_648 , struct V_598 * V_599 ,
T_4 V_170 )
{
int V_554 = 0 ;
struct V_649 * V_650 = V_648 -> V_651 ;
T_2 V_719 = V_650 -> V_14 ;
struct V_251 V_252 ;
char * V_636 ;
F_95 ( & V_252 , V_652 ) ;
V_252 . V_257 . V_607 . V_720 = V_599 -> V_721 ;
V_252 . V_257 . V_607 . V_170 = V_170 ;
V_554 = F_265 ( V_599 , & V_252 , & V_636 , 1 , NULL ) ;
if ( V_554 )
return V_554 ;
if ( F_4 () ) {
V_554 = F_35 ( V_719 , V_599 -> V_722 , V_723 ,
V_724 , & V_252 ) ;
if ( V_554 )
return V_554 ;
}
V_554 = F_300 ( V_650 , V_599 , V_170 , & V_252 ) ;
if ( V_554 )
return V_554 ;
V_554 = F_301 ( V_650 -> V_14 , V_599 , & V_252 ) ;
return V_554 ;
}
static int F_302 ( struct V_647 * V_648 , struct V_598 * V_599 )
{
int V_554 ;
struct V_649 * V_650 = V_648 -> V_651 ;
T_4 V_170 = V_648 -> V_660 ;
T_2 V_719 = V_650 -> V_14 ;
struct V_251 V_252 ;
char * V_636 ;
T_11 V_725 ;
...
if ( V_170 != V_177 && V_170 != V_178 )
return 0 ;
if ( V_170 == V_178 && V_599 -> V_166 == F_280 ( V_727 ) )
V_170 = V_177 ;
if ( ! V_728 )
return F_299 ( V_648 , V_599 , V_170 ) ;
V_725 = F_4 () ;
V_726 = F_303 () || F_304 () ;
if ( ! V_725 && ! V_726 )
return 0 ;
...
if ( V_726 ) {
T_2 V_708 ;
V_554 = F_267 ( V_599 , V_170 , & V_708 ) ;
if ( V_554 )
return V_554 ;
V_554 = F_297 ( V_599 -> V_721 , V_636 , V_170 ,
V_708 , & V_252 ) ;
if ( V_554 ) {
F_305 ( V_599 , V_554 , 0 ) ;
return V_554 ;
}
V_554 = F_35 ( V_719 , V_708 , V_729 ,
V_730 , & V_252 ) ;
if ( V_554 )
F_305 ( V_599 , V_554 , 0 ) ;
}
...
static int F_306 ( struct V_655 * V_647 , char T_12 * V_731 ,
int T_12 * V_732 , unsigned V_84 )
{
int V_554 = 0 ;
char * V_733 ;
T_2 V_734 ;
struct V_649 * V_650 = V_647 -> V_648 -> V_651 ;
T_2 V_708 = V_646 ;
if ( V_650 -> V_28 == V_174 ||
V_650 -> V_28 == V_179 )
V_708 = V_650 -> V_708 ;
...
static int F_309 ( struct V_655 * V_647 , struct V_598 * V_599 , T_2 * V_505 )
{
T_2 V_738 = V_646 ;
T_4 V_170 ;
if ( V_599 && V_599 -> V_166 == F_280 ( V_727 ) )
V_170 = V_177 ;
else if ( V_599 && V_599 -> V_166 == F_280 ( V_739 ) )
V_170 = V_178 ;
else if ( V_647 )
V_170 = V_647 -> V_648 -> V_660 ;
else
goto V_66;
if ( V_647 && V_170 == V_171 )
F_214 ( F_275 ( V_647 ) , & V_738 ) ;
else if ( V_599 )
F_267 ( V_599 , V_170 , & V_738 ) ;
V_66:
* V_505 = V_738 ;
if ( V_738 == V_646 )
return - V_86 ;
...
static int F_310 ( struct V_647 * V_648 , int V_170 , T_9 V_740 )
{
struct V_649 * V_650 ;
V_650 = F_7 ( sizeof( * V_650 ) , V_740 ) ;
if ( ! V_650 )
return - V_24 ;
V_650 -> V_708 = V_27 ;
V_650 -> V_14 = V_27 ;
...
static void F_312 ( struct V_647 * V_648 )
{
struct V_649 * V_650 = V_648 -> V_651 ;
V_648 -> V_651 = NULL ;
F_313 ( V_650 ) ;
...
static void F_314 ( const struct V_647 * V_648 , struct V_647 * V_703 )
{
struct V_649 * V_650 = V_648 -> V_651 ;
struct V_649 * V_741 = V_703 -> V_651 ;
V_741 -> V_14 = V_650 -> V_14 ;
V_741 -> V_708 = V_650 -> V_708 ;
V_741 -> V_28 = V_650 -> V_28 ;
F_311 ( V_741 ) ;
}
static void F_315 ( struct V_647 * V_648 , T_2 * V_505 )
{
if ( ! V_648 )
* V_505 = V_742 ;
else {
...
static void F_316 ( struct V_647 * V_648 , struct V_655 * V_325 )
{
struct V_20 * V_21 = F_275 ( V_325 ) -> V_30 ;
struct V_649 * V_650 = V_648 -> V_651 ;
if ( V_648 -> V_660 == V_177 || V_648 -> V_660 == V_178 ||
V_648 -> V_660 == V_171 )
V_21 -> V_14 = V_650 -> V_14 ;
V_650 -> V_28 = V_21 -> V_28 ;
}
static int F_317 ( struct V_647 * V_648 , struct V_598 * V_599 ,
struct V_743 * V_744 )
{
struct V_649 * V_650 = V_648 -> V_651 ;
int V_554 ;
...
if ( V_170 == V_178 && V_599 -> V_166 == F_280 ( V_727 ) )
V_170 = V_177 ;
V_554 = F_267 ( V_599 , V_170 , & V_745 ) ;
if ( V_554 )
return V_554 ;
if ( V_745 == V_646 ) {
V_744 -> V_505 = V_650 -> V_14 ;
V_744 -> V_738 = V_646 ;
} else {
V_554 = F_295 ( V_650 -> V_14 , V_745 , & V_272 ) ;
if ( V_554 )
return V_554 ;
V_744 -> V_505 = V_272 ;
V_744 -> V_738 = V_745 ;
...
static void F_319 ( struct V_647 * V_703 ,
const struct V_743 * V_744 )
{
struct V_649 * V_741 = V_703 -> V_651 ;
V_741 -> V_14 = V_744 -> V_505 ;
V_741 -> V_708 = V_744 -> V_738 ;
F_320 ( V_703 , V_744 -> V_746 -> V_170 ) ;
}
static void F_321 ( struct V_647 * V_648 , struct V_598 * V_599 )
{
T_4 V_170 = V_648 -> V_660 ;
struct V_649 * V_650 = V_648 -> V_651 ;
if ( V_170 == V_178 && V_599 -> V_166 == F_280 ( V_727 ) )
V_170 = V_177 ;
F_267 ( V_599 , V_170 , & V_650 -> V_708 ) ;
}
...
static void F_329 ( struct V_647 * V_648 )
{
struct V_649 * V_650 = V_648 -> V_651 ;
V_650 -> V_14 = F_14 () ;
V_650 -> V_28 = V_752 ;
}
static int F_330 ( struct V_647 * V_648 )
{
struct V_649 * V_650 = V_648 -> V_651 ;
T_2 V_14 = F_14 () ;
int V_554 ;
V_554 = F_35 ( V_14 , V_650 -> V_14 , V_752 ,
V_754 , NULL ) ;
if ( V_554 )
return V_554 ;
V_554 = F_35 ( V_14 , V_14 , V_752 ,
V_755 , NULL ) ;
if ( V_554 )
return V_554 ;
V_650 -> V_14 = V_14 ;
...
static int F_331 ( struct V_647 * V_648 , struct V_598 * V_599 )
{
int V_554 = 0 ;
T_2 V_228 ;
struct V_756 * V_757 ;
struct V_649 * V_650 = V_648 -> V_651 ;
if ( V_599 -> V_84 < F_332 ( 0 ) ) {
V_554 = - V_86 ;
goto V_66;
}
V_757 = F_333 ( V_599 ) ;
V_554 = F_334 ( V_650 -> V_28 , V_757 -> V_758 , & V_228 ) ;
if ( V_554 ) {
if ( V_554 == - V_86 ) {
F_335 ( V_8 -> V_759 , V_12 , V_760 ,
L_42
L_43 ,
V_757 -> V_758 , V_650 -> V_28 ) ;
if ( ! V_3 || F_336 () )
V_554 = 0 ;
}
if ( V_554 == - V_761 )
...
V_554 = F_272 ( V_8 , V_648 , V_228 ) ;
V_66:
return V_554 ;
}
static unsigned int F_337 ( struct V_598 * V_599 , int V_712 ,
T_4 V_170 )
{
int V_554 ;
char * V_636 ;
...
if ( ! V_725 && ! V_726 )
return V_763 ;
if ( F_267 ( V_599 , V_170 , & V_708 ) != 0 )
return V_764 ;
F_95 ( & V_252 , V_652 ) ;
V_252 . V_257 . V_607 . V_720 = V_712 ;
V_252 . V_257 . V_607 . V_170 = V_170 ;
if ( F_265 ( V_599 , & V_252 , & V_636 , 1 , NULL ) != 0 )
return V_764 ;
if ( V_726 ) {
V_554 = F_297 ( V_712 , V_636 , V_170 ,
V_708 , & V_252 ) ;
if ( V_554 ) {
F_305 ( V_599 , V_554 , 1 ) ;
return V_764 ;
...
if ( V_725 )
if ( F_35 ( V_708 , V_599 -> V_722 ,
V_723 , V_765 , & V_252 ) )
return V_764 ;
if ( V_762 )
if ( F_338 ( V_599 , V_170 , V_708 ) != 0 )
return V_764 ;
return V_763 ;
}
static unsigned int F_339 ( unsigned int V_766 ,
struct V_598 * V_599 ,
const struct V_767 * V_768 ,
const struct V_767 * V_66 ,
int (* F_340)( struct V_598 * ) )
{
return F_337 ( V_599 , V_768 -> V_712 , V_177 ) ;
}
static unsigned int F_341 ( unsigned int V_766 ,
struct V_598 * V_599 ,
const struct V_767 * V_768 ,
const struct V_767 * V_66 ,
int (* F_340)( struct V_598 * ) )
{
return F_337 ( V_599 , V_768 -> V_712 , V_178 ) ;
}
static unsigned int F_342 ( struct V_598 * V_599 ,
T_4 V_170 )
{
T_2 V_14 ;
if ( ! F_303 () )
return V_763 ;
if ( V_599 -> V_648 ) {
struct V_649 * V_650 = V_599 -> V_648 -> V_651 ;
V_14 = V_650 -> V_14 ;
} else
V_14 = V_15 ;
if ( F_338 ( V_599 , V_170 , V_14 ) != 0 )
return V_764 ;
return V_763 ;
}
static unsigned int F_343 ( unsigned int V_766 ,
struct V_598 * V_599 ,
const struct V_767 * V_768 ,
const struct V_767 * V_66 ,
int (* F_340)( struct V_598 * ) )
{
return F_342 ( V_599 , V_177 ) ;
}
static unsigned int F_344 ( struct V_598 * V_599 ,
int V_712 ,
T_4 V_170 )
{
struct V_647 * V_648 = V_599 -> V_648 ;
struct V_649 * V_650 ;
struct V_251 V_252 ;
char * V_636 ;
T_11 V_600 ;
...
V_252 . V_257 . V_607 . V_720 = V_712 ;
V_252 . V_257 . V_607 . V_170 = V_170 ;
if ( F_265 ( V_599 , & V_252 , & V_636 , 0 , & V_600 ) )
return V_764 ;
if ( F_4 () )
if ( F_35 ( V_650 -> V_14 , V_599 -> V_722 ,
V_723 , V_769 , & V_252 ) )
return F_345 ( - V_770 ) ;
if ( F_346 ( V_650 -> V_14 , V_599 , & V_252 , V_600 ) )
return F_345 ( - V_770 ) ;
return V_763 ;
}
static unsigned int F_347 ( struct V_598 * V_599 , int V_712 ,
T_4 V_170 )
{
T_2 V_771 ;
T_2 V_708 ;
...
T_11 V_726 ;
if ( ! V_728 )
return F_344 ( V_599 , V_712 , V_170 ) ;
#ifdef F_348
if ( F_349 ( V_599 ) != NULL && F_349 ( V_599 ) -> V_772 != NULL )
return V_763 ;
#endif
V_725 = F_4 () ;
V_726 = F_303 () || F_304 () ;
...
V_252 . V_257 . V_607 . V_720 = V_712 ;
V_252 . V_257 . V_607 . V_170 = V_170 ;
if ( F_265 ( V_599 , & V_252 , & V_636 , 0 , NULL ) )
return V_764 ;
if ( V_725 )
if ( F_35 ( V_708 , V_599 -> V_722 ,
V_723 , V_771 , & V_252 ) )
...
static unsigned int F_350 ( unsigned int V_766 ,
struct V_598 * V_599 ,
const struct V_767 * V_768 ,
const struct V_767 * V_66 ,
int (* F_340)( struct V_598 * ) )
{
return F_347 ( V_599 , V_66 -> V_712 , V_177 ) ;
}
static unsigned int F_351 ( unsigned int V_766 ,
struct V_598 * V_599 ,
const struct V_767 * V_768 ,
const struct V_767 * V_66 ,
int (* F_340)( struct V_598 * ) )
{
return F_347 ( V_599 , V_66 -> V_712 , V_178 ) ;
}
static int F_352 ( struct V_647 * V_648 , struct V_598 * V_599 )
{
int V_554 ;
V_554 = F_353 ( V_648 , V_599 ) ;
if ( V_554 )
return V_554 ;
return F_331 ( V_648 , V_599 ) ;
}
static int F_354 ( struct V_598 * V_599 , int V_776 )
{
int V_554 ;
struct V_251 V_252 ;
T_2 V_14 ;
V_554 = F_355 ( V_599 , V_776 ) ;
if ( V_554 )
return V_554 ;
F_95 ( & V_252 , V_256 ) ;
V_252 . V_257 . V_249 = V_776 ;
F_356 ( V_8 , & V_14 ) ;
...
static void F_358 ( struct V_777 * V_228 )
{
struct V_778 * V_21 = V_228 -> V_16 ;
V_228 -> V_16 = NULL ;
F_28 ( V_21 ) ;
}
static int F_359 ( struct V_779 * V_692 )
{
struct V_780 * V_781 ;
...
static void F_360 ( struct V_779 * V_692 )
{
struct V_780 * V_781 = V_692 -> V_16 ;
V_692 -> V_16 = NULL ;
F_28 ( V_781 ) ;
}
static int F_361 ( struct V_777 * V_782 ,
T_2 V_238 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
...
static int F_364 ( struct V_786 * V_787 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_357 ( V_8 , & V_787 -> V_788 , V_789 ) ;
if ( V_47 )
return V_47 ;
...
static void F_365 ( struct V_786 * V_787 )
{
F_358 ( & V_787 -> V_788 ) ;
}
static int F_366 ( struct V_786 * V_787 , int V_791 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
static int F_367 ( struct V_786 * V_787 , int V_508 )
{
int V_554 ;
int V_238 ;
switch ( V_508 ) {
...
V_554 = F_361 ( & V_787 -> V_788 , V_238 ) ;
return V_554 ;
}
static int F_368 ( struct V_786 * V_787 , struct V_779 * V_692 , int V_791 )
{
struct V_778 * V_21 ;
struct V_780 * V_781 ;
struct V_251 V_252 ;
...
static int F_369 ( struct V_786 * V_787 , struct V_779 * V_692 ,
struct V_17 * V_237 ,
long type , int V_151 )
{
struct V_778 * V_21 ;
...
static int F_370 ( struct V_809 * V_810 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_357 ( V_8 , & V_810 -> V_811 , V_812 ) ;
if ( V_47 )
return V_47 ;
...
static void F_371 ( struct V_809 * V_810 )
{
F_358 ( & V_810 -> V_811 ) ;
}
static int F_372 ( struct V_809 * V_810 , int V_814 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
static int F_373 ( struct V_809 * V_810 , int V_508 )
{
int V_238 ;
int V_554 ;
switch ( V_508 ) {
...
V_554 = F_361 ( & V_810 -> V_811 , V_238 ) ;
return V_554 ;
}
static int F_374 ( struct V_809 * V_810 ,
char T_12 * V_824 , int V_814 )
{
T_2 V_238 ;
if ( V_814 & V_825 )
V_238 = V_826 ;
...
V_238 = V_826 | V_827 ;
return F_361 ( & V_810 -> V_811 , V_238 ) ;
}
...
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_357 ( V_8 , & V_829 -> V_830 , V_831 ) ;
if ( V_47 )
return V_47 ;
...
static void F_376 ( struct V_828 * V_829 )
{
F_358 ( & V_829 -> V_830 ) ;
}
static int F_377 ( struct V_828 * V_829 , int V_833 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
static int F_378 ( struct V_828 * V_829 , int V_508 )
{
int V_554 ;
T_2 V_238 ;
switch ( V_508 ) {
...
V_554 = F_361 ( & V_829 -> V_830 , V_238 ) ;
return V_554 ;
}
static int F_379 ( struct V_828 * V_829 ,
...
V_238 = V_842 ;
return F_361 ( & V_829 -> V_830 , V_238 ) ;
}
static int F_380 ( struct V_777 * V_853 , short V_98 )
{
T_2 V_255 = 0 ;
V_255 = 0 ;
if ( V_98 & V_854 )
...
if ( V_255 == 0 )
return 0 ;
return F_361 ( V_853 , V_255 ) ;
}
static void F_381 ( struct V_777 * V_853 , T_2 * V_505 )
{
...
char * V_64 , void * V_469 , T_7 V_497 )
{
struct V_10 * V_11 ;
struct V_17 * V_387 ;
struct V_7 * V_330 ;
...
error = F_54 ( V_469 , V_497 , & V_14 ) ;
if ( error == - V_86 && ! strcmp ( V_64 , L_47 ) ) {
if ( ! F_202 ( V_499 ) )
return error ;
error = F_205 ( V_469 , V_497 ,
& V_14 ) ;
}
if ( error )
return error ;
...
static int F_390 ( T_2 V_505 , char * * V_453 , T_2 * V_867 )
{
return F_47 ( V_505 , V_453 , V_867 ) ;
}
static int F_391 ( const char * V_453 , T_2 V_867 , T_2 * V_505 )
{
return F_54 ( V_453 , V_867 , V_505 ) ;
}
static void F_392 ( char * V_453 , T_2 V_867 )
{
F_28 ( V_453 ) ;
}
static int F_393 ( struct V_19 * V_19 , void * V_279 , T_2 V_868 )
{
return F_212 ( V_19 , V_472 , V_279 , V_868 , 0 ) ;
}
static int F_394 ( struct V_52 * V_52 , void * V_279 , T_2 V_868 )
{
return F_395 ( V_52 , V_67 , V_279 , V_868 , 0 ) ;
}
static int F_396 ( struct V_19 * V_19 , void * * V_279 , T_2 * V_868 )
{
int V_84 = 0 ;
...
static int F_397 ( struct V_785 * V_869 , const struct V_7 * V_7 ,
unsigned long V_69 )
{
const struct V_10 * V_11 ;
struct V_870 * V_871 ;
...
V_11 = V_7 -> V_16 ;
if ( V_11 -> V_373 )
V_871 -> V_14 = V_11 -> V_373 ;
else
V_871 -> V_14 = V_11 -> V_14 ;
V_869 -> V_16 = V_871 ;
return 0 ;
}
static void F_398 ( struct V_785 * V_869 )
{
struct V_870 * V_871 = V_869 -> V_16 ;
V_869 -> V_16 = NULL ;
F_28 ( V_871 ) ;
}
static int F_399 ( T_13 V_872 ,
const struct V_7 * V_7 ,
T_14 V_228 )
{
struct V_785 * V_785 ;
...
V_785 = F_400 ( V_872 ) ;
V_871 = V_785 -> V_16 ;
return F_35 ( V_14 , V_871 -> V_14 , V_280 , V_228 , NULL ) ;
}
static int F_401 ( struct V_785 * V_785 , char * * V_873 )
{
...
static void F_407 ( struct V_41 * V_42 , void * V_878 )
{
F_62 ( V_42 , NULL ) ;
}
void F_408 ( void )
...
goto V_66;
F_38 ( V_74 L_58 ) ;
V_554 = F_411 ( V_879 , F_39 ( V_879 ) ) ;
if ( V_554 )
F_8 ( L_59 , V_554 ) ;
#if F_266 ( V_639 ) || F_266 ( V_640 )
V_554 = F_411 ( V_880 , F_39 ( V_880 ) ) ;
if ( V_554 )
F_8 ( L_60 , V_554 ) ;
#endif
V_66:
