...
static int F_83 ( struct V_198 * V_107 )
{
struct V_1 * V_2 = V_107 -> V_199 ;
return F_76 ( V_2 ) ;
}
static int T_4 F_84 ( struct V_200 * V_110 ,
struct V_201 * V_118 ,
int V_126 ,
struct V_1 * * V_202 )
{
struct V_1 * V_2 ;
int V_96 ;
static struct V_203 V_169 = {
. V_204 = F_83 ,
} ;
* V_202 = NULL ;
if ( ( V_96 = F_85 ( V_118 ) ) < 0 )
return V_96 ;
V_2 = F_86 ( sizeof( * V_2 ) , V_205 ) ;
if ( V_2 == NULL ) {
F_81 ( V_118 ) ;
return - V_206 ;
}
...
if ( ( V_96 = F_93 ( V_110 , V_210 , V_2 , & V_169 ) ) < 0 ) {
F_76 ( V_2 ) ;
return V_96 ;
}
F_94 ( V_110 , & V_118 -> V_211 ) ;
#ifdef F_77
V_2 -> V_120 . V_15 = V_2 ;
V_2 -> V_120 . V_169 = & V_212 ;
sprintf ( V_2 -> V_120 . V_213 , L_13 , F_95 ( V_118 ) ) ;
if ( ( V_126 & V_127 ) > 0 &&
( V_126 & V_127 ) < 4 ) {
if ( F_96 ( & V_2 -> V_120 ) ) {
F_9 ( V_20 L_14 ) ;
...
F_97 ( V_2 -> V_120 . V_110 , V_125 [ ( V_126 & V_127 ) - 1 ] . V_116 , sizeof( V_2 -> V_120 . V_110 ) ) ;
#endif
* V_202 = V_2 ;
return 0 ;
}
static int T_4 F_98 ( struct V_201 * V_118 ,
...
V_96 = F_99 ( V_222 [ V_211 ] , V_223 [ V_211 ] , V_224 , 0 , & V_110 ) ;
if ( V_96 < 0 )
return V_96 ;
if ( ( V_96 = F_84 ( V_110 , V_118 , V_126 [ V_211 ] , & V_2 ) ) < 0 ) {
F_100 ( V_110 ) ;
return V_96 ;
}
V_110 -> V_15 = V_2 ;
strcpy ( V_110 -> V_225 , L_4 ) ;
strcpy ( V_110 -> V_226 , L_16 ) ;
strcat ( V_110 -> V_226 , V_2 -> V_101 ? L_17 : L_18 ) ;
sprintf ( V_110 -> V_227 , L_19 ,
V_110 -> V_226 , V_2 -> V_11 , V_2 -> V_84 ) ;
if ( V_2 -> V_126 & V_186 )
goto V_228;
...
if ( ( V_96 = F_102 ( V_110 , F_7 ( V_2 , V_232 ) ,
F_7 ( V_2 , V_233 ) ,
V_234 , 1 , & V_218 ) ) < 0 ) {
F_100 ( V_110 ) ;
return V_96 ;
}
if ( ( V_96 = F_103 ( V_218 , 0 , 1 , NULL ) ) < 0 ) {
F_100 ( V_110 ) ;
return V_96 ;
}
V_228:
...
static void T_6 F_106 ( struct V_201 * V_118 )
{
F_100 ( F_107 ( V_118 ) ) ;
F_105 ( V_118 , NULL ) ;
}
static int F_108 ( struct V_201 * V_118 , T_7 V_235 )
{
struct V_200 * V_110 = F_107 ( V_118 ) ;
...
F_111 ( V_2 -> V_13 ) ;
F_111 ( V_2 -> V_165 ) ;
for ( V_167 = 0 ; V_167 < F_12 ( V_237 ) ; V_167 ++ )
V_2 -> V_237 [ V_167 ] = F_3 ( V_2 -> V_11 + V_237 [ V_167 ] ) ;
F_81 ( V_118 ) ;
F_112 ( V_118 ) ;
F_113 ( V_118 , F_114 ( V_118 , V_235 ) ) ;
return 0 ;
}
static int F_115 ( struct V_201 * V_118 )
{
struct V_200 * V_110 = F_107 ( V_118 ) ;
struct V_1 * V_2 = V_110 -> V_15 ;
int V_167 ;
...
F_119 ( V_2 -> V_165 ) ;
for ( V_167 = 0 ; V_167 < F_12 ( V_237 ) ; V_167 ++ )
F_4 ( V_2 -> V_237 [ V_167 ] , V_2 -> V_11 + V_237 [ V_167 ] ) ;
F_109 ( V_110 , V_239 ) ;
return 0 ;
}
