...
goto V_245 ;
if ( V_14 )
memcpy ( ( char * ) V_94 , ( char * ) V_93 + 2 , 6 ) ;
V_94 += 8 ;
V_93 += 8 ;
V_22 -= 8 ;
break ;
...
if ( V_254 & ~ 1 )
goto V_256 ;
F_29 ( V_75 -> V_260 = V_254 ) ;
break ;
case V_261 :
if ( ! ( V_254 & V_262 ) )
goto V_256 ;
F_29 ( V_75 -> V_263 = V_254 ) ;
break ;
case V_264 :
if ( V_254 < 2 || V_254 > 30 )
goto V_256 ;
F_29 ( V_75 -> V_265 = V_254 ) ;
break ;
case V_266 :
if ( V_253 & ~ 1 )
goto V_256 ;
F_29 ( V_75 -> V_267 = V_253 ) ;
break ;
case V_268 :
if ( V_255 < ( long ) 0x478bf51L )
goto V_256 ;
F_29 ( V_75 -> V_269 = V_255 ) ;
break ;
#ifdef F_21
case V_108 :
if ( V_255 > 1562 )
goto V_256 ;
if ( V_14 && V_2 -> V_75 . V_270 != V_255 ) {
V_2 -> V_271 . V_272 = TRUE ;
V_2 -> V_75 . V_270 = V_255 ;
}
break ;
case V_109 :
if ( V_255 < 50 || V_255 > 5000 )
goto V_256 ;
if ( V_14 && V_2 -> V_75 . V_270 &&
V_2 -> V_75 . V_273 != V_255 ) {
V_2 -> V_271 . V_272 = TRUE ;
V_2 -> V_75 . V_273 = V_255 ;
}
break ;
case V_110 :
if ( V_255 > - F_30 ( 5 ) || V_255 < - F_30 ( 165 ) )
goto V_256 ;
F_29 ( V_75 -> V_274 = V_255 ) ;
break ;
case V_111 :
if ( V_255 < 1 || V_255 > 4478 )
goto V_256 ;
F_29 ( V_75 -> V_275 = V_255 ) ;
break ;
case V_112 :
if ( ( V_255 & 0xffff ) != 1 )
goto V_256 ;
F_29 ( V_75 -> V_276 = V_255 ) ;
break ;
case V_113 :
if ( V_254 > 1 )
goto V_256 ;
F_29 ( V_75 -> V_277 = V_254 ) ;
break ;
#endif
#ifdef F_22
case V_114 :
if ( V_253 != V_278 && V_253 != V_279 )
goto V_256 ;
F_29 ( V_75 -> V_280 = V_253 ) ;
break ;
case V_115 :
if ( V_253 > 100 )
goto V_256 ;
...
break ;
case V_285 :
F_29 ( V_89 -> V_286 = V_254 ) ;
break ;
case V_287 :
F_29 ( V_89 -> V_288 = V_254 ) ;
break ;
case V_289 :
if ( V_253 & ~ 1 )
goto V_256 ;
...
break ;
case V_116 :
F_29 ( V_89 -> V_293 = V_255 ) ;
break ;
case V_294 :
if ( V_255 > 1562 )
goto V_256 ;
F_29 ( V_252 -> V_295 = V_255 ) ;
#ifdef F_21
if ( V_14 )
F_32 ( V_2 ) ;
#endif
...
if ( V_255 > 5000 )
goto V_256 ;
if ( V_255 != 0 && V_252 -> V_295 == 0 )
goto V_256 ;
F_29 ( V_252 -> V_297 = V_255 ) ;
#ifdef F_21
if ( V_14 )
F_32 ( V_2 ) ;
#endif
...
break ;
case V_300 :
if ( V_255 > 0x00BEBC20L )
goto V_256 ;
#ifdef F_22
if ( V_14 && V_75 -> V_280 == V_278 )
goto V_256 ;
#endif
F_29 ( V_252 -> V_301 = V_255 ) ;
break ;
case V_302 :
F_29 ( V_252 -> V_303 = V_255 ) ;
goto V_304 ;
case V_305 :
F_29 ( V_252 -> V_306 = V_255 ) ;
goto V_304 ;
case V_307 :
F_29 ( V_252 -> V_308 = V_255 ) ;
V_304:
if ( V_14 && F_34 ( V_2 ) ) {
F_35 ( V_2 , V_309 ) ;
V_2 -> V_6 . V_310 = 1 ;
F_31 ( V_2 , V_311 , V_312 ) ;
}
break ;
case V_313 :
if ( V_253 > 1 )
goto V_256 ;
F_29 ( V_91 -> V_314 = V_253 ) ;
break ;
case V_315 :
...
break ;
case V_320 :
if ( F_36 ( V_2 , V_321 , ( int ) V_254 , 0 ) )
goto V_256 ;
break ;
case V_322 :
if ( F_36 ( V_2 , V_323 , ( int ) V_254 ,
F_20 ( V_2 , V_100 ) ) )
goto V_256 ;
break ;
default :
...
{
const struct V_20 * V_21 ;
for ( V_21 = V_325 ; V_21 -> V_68 && V_21 -> V_68 != V_87 ; V_21 ++ )
;
...
void F_5 ( struct V_1 * V_2 , struct V_5 * V_6 , char * V_327 )
{
int V_22 ;
struct V_16 * V_17 ;
char * V_96 ;
...
F_37 ( V_2 ) ;
#ifdef F_38
if ( V_2 -> V_331 . V_332 < 2 )
#else
if ( V_331 . V_332 < 2 )
#endif
return ;
#ifdef F_27
V_330 = V_6 -> V_37 + sizeof( struct V_5 ) ;
#endif
printf ( L_8 , V_327 ) ;
...
#endif
V_328 = V_17 -> V_50 ;
if ( ( V_328 < 0 ) || ( V_328 > ( int ) ( V_22 - V_51 ) ) ) {
V_328 = V_22 - V_51 ;
printf ( L_15 ) ;
break ;
}
...
V_328 ++ ;
#ifdef F_40
printf ( L_20 , * V_82 ++ & 0xff , V_22 ? ( ( V_328 & 7 ) ? L_21 : L_22 ) : L_23 ) ;
#else
printf ( L_24 , * V_82 ++ & 0xff , V_22 ? ( ( V_328 & 7 ) ? L_21 : L_22 ) : L_23 ) ;
#endif
}
}
