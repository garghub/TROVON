...
V_9 = F_3 ( V_7 ) ;
F_36 ( V_47 , V_7 ) ;
V_9 -> V_23 = F_37 ( sizeof( * V_9 -> V_23 ) * V_51 , V_52 ) ;
if ( V_9 -> V_23 == NULL ) {
V_5 = - V_50 ;
goto V_53;
}
V_9 -> V_11 = F_37 ( sizeof( * V_9 -> V_11 ) * V_54 , V_52 ) ;
if ( V_9 -> V_11 == NULL ) {
V_5 = - V_50 ;
goto V_55;
}
...
V_9 -> V_56 = & V_57 [ 0 ] ;
F_38 ( & V_9 -> V_10 ) ;
V_7 -> V_58 = V_47 -> V_2 . V_59 -> V_58 ;
V_7 -> V_2 . V_60 = & V_47 -> V_2 ;
V_7 -> V_61 = & V_62 ;
V_7 -> V_63 = V_64 ;
for ( V_48 = 0 ; V_48 < V_65 ; V_48 ++ )
V_9 -> V_66 [ V_48 ] = 1 << V_48 ;
V_7 -> V_66 = V_9 -> V_66 ;
V_5 = F_39 ( V_7 ) ;
if ( V_5 )
goto V_67;
...
static T_7 int F_52 ( void )
{
return F_53 ( & V_74 ) ;
}
static T_8 void F_54 ( void )
{
F_55 ( & V_74 ) ;
}
