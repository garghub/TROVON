...
static int T_1 F_16 ( struct V_94 * V_95 )
{
struct V_62 * V_63 ;
struct V_5 * V_6 = F_17 ( sizeof( struct V_5 ) , V_96 ) ;
struct V_97 * V_21 = F_9 ( V_95 -> V_68 . V_69 ) ;
F_18 ( & V_95 -> V_68 , V_6 ) ;
V_6 -> V_21 = V_21 ;
switch ( V_95 -> V_98 ) {
case V_99 :
...
F_21 ( V_21 , & V_6 -> V_7 , V_10 ) ;
if ( V_95 -> V_98 == V_101 )
F_4 ( V_6 ) ;
return F_22 ( & V_95 -> V_68 , V_63 ) ;
}
