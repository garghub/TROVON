...
static int F_32 ( struct V_1 * V_2 , T_3 V_139 )
{
F_28 ( V_2 , V_130 ) ;
return 0 ;
}
...
{
struct V_19 * V_20 = F_8 ( V_2 ) ;
struct V_140 * V_141 = F_35 ( V_2 -> V_5 ) ;
T_2 * V_120 = V_2 -> V_120 ;
int V_22 , V_21 ;
V_22 = F_36 ( V_2 , 7 , 9 , V_20 -> V_142 ) ;
if ( V_22 != 0 ) {
F_10 ( V_2 -> V_5 , L_10 , V_22 ) ;
return V_22 ;
}
for ( V_21 = 0 ; V_21 < F_9 ( V_20 -> V_131 ) ; V_21 ++ )
V_20 -> V_131 [ V_21 ] . V_143 = V_144 [ V_21 ] ;
...
static T_4 int F_40 ( struct V_173 * V_174 ,
const struct V_175 * V_176 )
{
struct V_19 * V_20 ;
int V_22 ;
V_20 = F_41 ( sizeof( struct V_19 ) , V_177 ) ;
if ( V_20 == NULL )
return - V_178 ;
F_42 ( V_174 , V_20 ) ;
V_20 -> V_142 = V_179 ;
...
static T_5 int F_45 ( struct V_173 * V_182 )
{
F_46 ( & V_182 -> V_5 ) ;
F_44 ( F_47 ( V_182 ) ) ;
return 0 ;
