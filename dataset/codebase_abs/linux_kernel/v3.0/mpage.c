...
struct V_10 * V_10 = F_36 ( V_71 -> V_75 , struct V_10 , V_76 ) ;
F_3 ( & V_10 -> V_12 ) ;
F_37 ( & V_10 -> V_76 ) ;
if ( ! F_38 ( V_10 , V_14 ,
V_10 -> V_61 , V_68 ) ) {
...
int F_43 ( struct V_10 * V_10 , T_3 V_45 )
{
struct V_1 * V_1 = NULL ;
T_1 V_42 = 0 ;
struct V_27 V_43 ;
...
static int F_44 ( struct V_10 * V_10 , struct V_77 * V_78 ,
void * V_79 )
{
struct V_80 * V_81 = V_79 ;
struct V_1 * V_1 = V_81 -> V_1 ;
...
V_82 = V_87 >> V_36 ;
if ( V_10 -> V_61 >= V_82 ) {
unsigned V_90 = V_87 & ( V_48 - 1 ) ;
if ( V_10 -> V_61 > V_82 || ! V_90 )
goto V_60;
F_25 ( V_10 , V_90 , V_48 ) ;
}
if ( V_1 && V_81 -> V_42 != V_53 [ 0 ] - 1 )
V_1 = F_12 ( V_91 , V_1 ) ;
V_67:
if ( V_1 == NULL ) {
V_1 = F_14 ( V_19 , V_53 [ 0 ] << ( V_46 - 9 ) ,
...
int
F_55 ( struct V_69 * V_14 ,
struct V_77 * V_78 , T_3 V_45 )
{
struct V_73 V_74 ;
int V_88 ;
F_35 ( & V_74 ) ;
