...
F_117 ( & V_13 -> V_236 ) ;
F_117 ( & V_13 -> V_238 ) ;
F_118 ( V_11 -> V_192 , & V_13 -> V_189 ) ;
F_118 ( V_11 -> V_192 , & V_13 -> V_257 ) ;
F_119 ( & V_11 -> V_219 , V_13 -> V_219 ) ;
V_215 -> V_252 = NULL ;
F_115 ( V_13 ) ;
return 0 ;
}
static int F_120 ( struct V_215 * V_215 , struct V_288 * V_289 )
{
struct V_12 * V_13 = V_215 -> V_252 ;
return F_121 ( F_93 ( V_13 ) , V_289 ) ;
}
static T_2 F_122 ( struct V_215 * V_215 , char T_3 * V_259 ,
T_4 V_88 , T_5 * V_260 )
{
struct V_12 * V_13 = V_215 -> V_252 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
static unsigned int F_123 ( struct V_215 * V_215 , T_6 * V_265 )
{
struct V_12 * V_13 = V_215 -> V_252 ;
struct V_10 * V_11 = V_13 -> V_11 ;
struct V_281 V_282 ;
...
static int F_124 ( struct V_215 * V_215 , void * V_216 ,
struct V_298 * V_234 )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
V_125 = F_129 ( V_11 -> V_34 . V_26 * 4 , V_11 -> V_22 . V_26 ) ;
V_126 = F_129 ( V_11 -> V_34 . V_31 * 4 , V_11 -> V_22 . V_31 ) ;
if ( V_133 == V_124 ) {
...
if ( V_13 -> V_115 > 8 )
V_13 -> V_115 = 8 ;
if ( F_133 ( V_13 -> V_114 , V_234 -> V_146 . V_122 . V_114 ,
...
int F_134 ( struct V_215 * V_215 , void * V_216 , struct V_1 * V_120 )
{
const struct V_1 * V_199 ;
if ( ( V_120 -> V_2 < V_313 ||
V_120 -> V_2 >= V_314 ) &&
...
static int F_135 ( struct V_215 * V_215 , void * V_216 ,
struct V_318 * V_3 )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
V_3 -> V_324 = 1 ;
if ( V_319 == V_11 -> V_36 ) {
int V_325 = F_136 ( V_326 ) ;
int V_327 = F_136 ( V_328 ) ;
if ( 0 != ( V_325 & 0x40 ) )
V_3 -> V_329 |= V_330 ;
if ( 0 != ( V_327 & 0x40 ) )
V_3 -> V_329 |= V_331 ;
...
static int F_137 ( struct V_215 * V_215 , void * V_216 , unsigned int * V_3 )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
* V_3 = V_11 -> V_36 ;
...
static int F_139 ( struct V_215 * V_215 , void * V_216 ,
struct V_335 * V_236 )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
F_140 ( V_236 -> F_104 , V_338 [ V_11 -> V_339 ] . V_20 ,
sizeof( V_236 -> F_104 ) ) ;
sprintf ( V_236 -> V_340 , L_19 , F_141 ( V_11 -> V_192 ) ) ;
V_236 -> V_341 = V_342 ;
V_236 -> V_343 =
V_344 |
V_345 |
...
if ( V_310 <= 0 )
V_236 -> V_343 |= V_351 ;
if ( ( V_336 == V_352 ) || ( V_336 == V_269 ) )
V_236 -> V_343 &= ~ V_348 ;
return 0 ;
}
int F_142 ( struct V_10 * V_11 , struct V_12 * V_13 , T_7 * V_2 )
{
unsigned long V_217 ;
unsigned int V_3 ;
T_7 V_353 ;
...
if ( V_357 [ 0 ] == 'L' || V_357 [ 0 ] == 'l' ) {
if ( V_357 [ 1 ] == 'C' || V_357 [ 1 ] == 'c' )
V_353 = V_358 ;
else
V_353 = V_359 ;
} else {
if ( V_357 [ 0 ] == 'D' || V_357 [ 0 ] == 'd' )
V_353 = V_360 ;
else
V_353 = V_356 ;
}
for ( V_3 = 0 ; V_3 < V_354 ; V_3 ++ ) {
if ( V_353 == V_355 [ V_3 ] . V_2 )
break;
}
if ( V_3 == V_354 )
return - V_129 ;
...
static int F_144 ( struct V_215 * V_215 , void * V_216 , T_7 * V_2 )
{
struct V_12 * V_13 = V_216 ;
return F_142 ( V_13 -> V_11 , V_13 , V_2 ) ;
}
...
static int F_146 ( struct V_215 * V_215 , void * V_216 ,
struct V_361 * V_236 )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
V_236 -> type != V_362 )
return - V_129 ;
V_236 -> V_363 = V_11 -> V_22 ;
V_236 -> V_364 = V_11 -> V_25 ;
V_236 -> V_365 . V_366 = 1 ;
V_236 -> V_365 . V_367 = 1 ;
if ( V_11 -> V_21 -> V_2 & V_32 ) {
V_236 -> V_365 . V_366 = 11 ;
V_236 -> V_365 . V_367 = 10 ;
}
if ( V_11 -> V_21 -> V_2 & V_368 ) {
V_236 -> V_365 . V_366 = 54 ;
V_236 -> V_365 . V_367 = 59 ;
}
return 0 ;
}
static int F_147 ( struct V_215 * V_215 , void * V_234 , struct V_369 * V_370 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
if ( V_370 -> type != V_235 &&
V_370 -> type != V_362 )
return - V_129 ;
V_370 -> V_120 = V_11 -> V_34 ;
return 0 ;
}
static int F_148 ( struct V_215 * V_215 , void * V_234 , struct V_369 * V_370 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
struct V_371 * V_110 = & V_11 -> V_22 ;
if ( V_370 -> type != V_235 &&
V_370 -> type != V_362 )
return - V_129 ;
if ( V_370 -> V_120 . V_31 < 0 )
return - V_129 ;
if ( V_370 -> V_120 . V_26 < 0 )
return - V_129 ;
if ( F_8 ( V_13 -> V_11 , V_232 ) )
return - V_261 ;
if ( F_8 ( V_13 -> V_11 , V_239 ) )
return - V_261 ;
if ( V_370 -> V_120 . V_28 < V_110 -> V_28 )
V_370 -> V_120 . V_28 = V_110 -> V_28 ;
if ( V_370 -> V_120 . V_28 > V_110 -> V_28 + V_110 -> V_31 )
V_370 -> V_120 . V_28 = V_110 -> V_28 + V_110 -> V_31 ;
if ( V_370 -> V_120 . V_31 > V_110 -> V_28 - V_370 -> V_120 . V_28 + V_110 -> V_31 )
V_370 -> V_120 . V_31 = V_110 -> V_28 - V_370 -> V_120 . V_28 + V_110 -> V_31 ;
if ( V_370 -> V_120 . V_23 < V_110 -> V_23 )
V_370 -> V_120 . V_23 = V_110 -> V_23 ;
if ( V_370 -> V_120 . V_23 > V_110 -> V_23 + V_110 -> V_26 )
V_370 -> V_120 . V_23 = V_110 -> V_23 + V_110 -> V_26 ;
if ( V_370 -> V_120 . V_26 > V_110 -> V_23 - V_370 -> V_120 . V_23 + V_110 -> V_26 )
V_370 -> V_120 . V_26 = V_110 -> V_23 - V_370 -> V_120 . V_23 + V_110 -> V_26 ;
V_11 -> V_34 = V_370 -> V_120 ;
return 0 ;
}
static int F_149 ( struct V_215 * V_215 , void * V_216 ,
struct V_372 * V_373 )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
strcpy ( V_373 -> V_20 , L_20 ) ;
V_373 -> type = V_374 ;
V_373 -> V_375 = V_376 |
V_377 |
V_378 |
V_379 ;
V_373 -> V_380 = 0xffffffffUL ;
V_373 -> V_381 = F_150 ( V_11 ) ;
V_373 -> V_382 = F_151 ( V_373 -> V_381 ) ;
}
if ( 0 != ( F_136 ( V_326 ) & 0x03 ) )
V_373 -> signal = 0xffff ;
return 0 ;
}
static int F_152 ( struct V_215 * V_215 , void * V_216 ,
struct V_372 * V_373 )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
int V_383 , V_384 , V_139 ;
V_139 = F_87 ( & V_11 -> V_219 , V_13 -> V_219 ) ;
if ( 0 != V_139 )
return V_139 ;
V_384 = V_11 -> V_385 . V_384 ;
if ( V_269 == V_384 ) {
V_383 = F_150 ( V_11 ) ;
V_384 = F_151 ( V_373 -> V_381 ) ;
}
if ( V_384 != V_373 -> V_382 )
V_11 -> V_385 . V_384 = V_373 -> V_382 ;
return 0 ;
}
...
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
V_234 -> type = V_13 -> V_244 ? V_387 : V_374 ;
V_234 -> V_388 = V_11 -> V_389 ;
return 0 ;
}
...
if ( 0 != V_234 -> V_227 )
return - V_129 ;
if ( 0 == V_13 -> V_244 && V_374 != V_234 -> type )
return - V_129 ;
if ( 1 == V_13 -> V_244 && V_387 != V_234 -> type )
return - V_129 ;
F_4 ( & V_11 -> V_16 ) ;
V_11 -> V_389 = V_234 -> V_388 ;
F_18 ( V_11 , V_227 , V_390 , V_234 ) ;
F_143 ( V_11 ) ;
F_5 ( & V_11 -> V_16 ) ;
return 0 ;
}
static int F_155 ( struct V_215 * V_215 , void * V_216 , struct V_391 * V_109 )
{
strcpy ( V_109 -> V_20 , L_21 ) ;
return 0 ;
}
static int F_156 ( struct V_215 * V_215 , void * V_216 , struct V_391 * V_109 )
{
return 0 ;
}
static int F_157 ( struct V_215 * V_215 , void * V_234 , enum V_392 * V_393 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
* V_393 = F_158 ( & V_11 -> V_219 ) ;
return 0 ;
}
static int F_159 ( struct V_215 * V_215 , void * V_234 ,
enum V_392 V_219 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
return F_160 ( & V_11 -> V_219 , & V_13 -> V_219 , V_219 ) ;
}
static int F_161 ( struct V_215 * V_215 , void * V_216 ,
struct V_394 * V_234 )
{
if ( V_234 -> V_320 >= V_8 )
return - V_129 ;
F_140 ( V_234 -> V_395 , V_9 [ V_234 -> V_320 ] . V_20 ,
sizeof( V_234 -> V_395 ) ) ;
...
static int F_163 ( struct V_215 * V_215 , void * V_234 ,
struct V_396 * V_397 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
static int F_166 ( struct V_215 * V_215 , void * V_234 , unsigned int V_402 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
unsigned long V_217 ;
...
static int F_167 ( struct V_215 * V_215 , void * V_216 ,
struct V_403 * V_393 )
{
struct V_12 * V_13 = V_216 ;
return F_168 ( F_93 ( V_13 ) , V_393 ) ;
}
static int F_169 ( struct V_215 * V_215 , void * V_216 ,
struct V_404 * V_110 )
{
struct V_12 * V_13 = V_216 ;
return F_170 ( F_93 ( V_13 ) , V_110 ) ;
}
static int F_171 ( struct V_215 * V_215 , void * V_216 , struct V_404 * V_110 )
{
struct V_12 * V_13 = V_216 ;
return F_172 ( F_93 ( V_13 ) , V_110 ) ;
}
static int F_173 ( struct V_215 * V_215 , void * V_216 , struct V_404 * V_110 )
{
struct V_12 * V_13 = V_216 ;
return F_174 ( F_93 ( V_13 ) , V_110 ,
V_215 -> V_262 & V_263 ) ;
}
static int F_175 ( struct V_215 * V_215 , void * V_216 ,
enum V_243 type )
{
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
...
return - V_261 ;
return F_176 ( F_93 ( V_13 ) ) ;
}
static int F_177 ( struct V_215 * V_215 , void * V_216 ,
enum V_243 type )
{
int V_139 ;
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
int V_405 = F_95 ( V_13 ) ;
V_139 = F_114 ( F_93 ( V_13 ) ) ;
if ( V_139 < 0 )
return V_139 ;
F_9 ( V_11 , V_13 , V_405 ) ;
return 0 ;
}
static int F_178 ( struct V_215 * V_215 , void * V_13 ,
struct V_406 * V_407 )
{
return 0 ;
}
...
struct V_12 * V_13 = V_216 ;
struct V_10 * V_11 = V_13 -> V_11 ;
if ( ! F_180 ( & V_101 -> V_409 ) )
return - V_129 ;
V_101 -> V_90 = F_136 ( V_101 -> V_101 ) ;
V_101 -> V_184 = 1 ;
return 0 ;
}
...
struct V_10 * V_11 = V_13 -> V_11 ;
strcpy ( V_236 -> V_337 , L_18 ) ;
F_140 ( V_236 -> F_104 , V_338 [ V_11 -> V_339 ] . V_20 , sizeof( V_236 -> F_104 ) ) ;
sprintf ( V_236 -> V_340 , L_19 , F_141 ( V_11 -> V_192 ) ) ;
V_236 -> V_341 = V_342 ;
V_236 -> V_343 = V_348 ;
return 0 ;
...
return - V_129 ;
memset ( V_373 , 0 , sizeof( * V_373 ) ) ;
strcpy ( V_373 -> V_20 , L_23 ) ;
V_373 -> type = V_387 ;
F_18 ( V_11 , V_227 , V_410 , V_373 ) ;
if ( V_11 -> V_35 -> V_411 == V_412 ) {
V_373 -> signal = 0xf800 - ( ( F_136 ( 0x581 ) & 0x1f ) << 11 ) ;
V_373 -> V_381 = ( F_136 ( 0x529 ) & 0x08 ) ?
V_413 : V_414 ;
}
return 0 ;
}
...
static int F_186 ( struct V_215 * V_416 , void * V_216 , unsigned int * V_3 )
{
* V_3 = 0 ;
return 0 ;
}
static int F_187 ( struct V_215 * V_215 , void * V_216 ,
struct V_391 * V_109 )
{
...
static int F_189 ( struct V_215 * V_416 , void * V_216 , unsigned int V_3 )
{
return 0 ;
}
static int F_190 ( struct V_215 * V_215 , void * V_13 , T_7 * V_19 )
{
return 0 ;
}
static int F_191 ( struct V_215 * V_215 , void * V_216 ,
struct V_1 * V_120 )
{
const struct V_1 * V_199 ;
if ( V_120 -> V_2 < V_313 ||
...
{
if ( V_197 < 2 || V_197 > V_417 )
V_197 = 2 ;
if ( V_418 < 0 || V_418 > V_419 )
V_418 = V_419 ;
V_418 = ( V_418 + V_420 - 1 ) & V_421 ;
V_11 -> V_55 = F_1 ( V_200 ) -> V_422 ;
V_11 -> V_58 = F_1 ( V_203 ) -> V_422 ;
V_11 -> V_62 = F_1 ( V_202 ) -> V_422 ;
V_11 -> V_60 = F_1 ( V_204 ) -> V_422 ;
V_11 -> V_208 = F_1 ( V_207 ) -> V_422 ;
V_11 -> V_206 = 1 ;
V_11 -> V_57 = F_1 ( V_209 ) -> V_422 ;
V_11 -> V_214 = F_1 ( V_213 ) -> V_422 ;
if ( V_11 -> V_229 && V_11 -> V_214 )
V_11 -> V_229 |= V_230 ;
V_11 -> V_423 = 0 ;
F_193 ( & V_11 -> V_176 . V_424 ) ;
F_194 ( & V_11 -> V_176 . V_177 ) ;
V_11 -> V_176 . V_177 . V_425 = V_426 ;
V_11 -> V_176 . V_177 . V_259 = ( unsigned long ) ( & V_11 -> V_176 ) ;
V_11 -> V_176 . V_11 = V_11 ;
if ( V_338 [ V_11 -> V_339 ] . V_427 )
F_195 ( V_11 ) ;
return 0 ;
}
int F_195 ( struct V_10 * V_11 )
{
int V_428 = V_338 [ V_11 -> V_339 ] . V_427 ;
int V_429 ;
unsigned int V_430 = V_338 [ V_11 -> V_339 ] . V_430 ;
F_17 ( V_431 , V_427 [ V_428 ] [ 0 ] ) ;
V_429 = V_427 [ V_428 ] [ 1 ] ;
if ( V_430 & V_432 )
V_429 &= ~ V_433 ;
F_17 ( V_434 , V_429 ) ;
F_17 ( V_435 , V_427 [ V_428 ] [ 2 ] ) ;
F_17 ( V_436 , V_427 [ V_428 ] [ 4 ] ) ;
V_429 = V_427 [ V_428 ] [ 5 ] ;
if ( V_430 & V_437 )
V_429 &= ~ V_438 ;
if ( V_430 & V_439 )
...
F_17 ( V_445 , V_429 ) ;
F_17 ( V_446 , V_427 [ V_428 ] [ 7 ] ) ;
F_17 ( V_447 , V_427 [ V_428 ] [ 8 ] ) ;
F_17 ( V_448 , V_427 [ V_428 ] [ 3 ] ) ;
return 0 ;
}
...
{
static const char * V_449 [] = {
L_24 , L_25 , L_26 , L_27 } ;
T_8 V_450 , V_451 ;
V_450 = F_136 ( V_326 ) ;
V_451 = F_136 ( V_328 ) ;
F_6 ( L_28 ,
( V_450 & 0x40 ) ? L_29 : L_30 ,
( V_451 & 0x40 ) ? L_31 : L_32 ,
V_449 [ V_450 & 0x03 ] ) ;
V_11 -> V_42 = ( V_450 & 0x40 ) || ( V_451 & 0x40 ) || ! ( V_451 & 0x1 ) ;
if ( V_11 -> V_42 ) {
if ( V_11 -> V_214 )
V_11 -> V_423 = 1 ;
F_88 ( V_11 ) ;
...
if ( ( V_451 & 0x80 ) && ! V_41 && ! V_11 -> V_42 )
F_198 ( V_52 , 0x20 ) ;
else
F_199 ( V_52 , 0x20 ) ;
if ( V_11 -> V_452 && V_11 -> V_452 -> V_453 )
V_11 -> V_452 -> V_453 ( V_11 ) ;
}
void F_200 ( struct V_10 * V_11 , unsigned long V_329 )
{
enum V_123 V_124 ;
F_201 ( & V_11 -> V_233 ) ;
if ( V_11 -> V_176 . V_190 ) {
...
V_11 -> V_176 . V_190 -> V_163 . V_455 = V_11 -> V_454 ;
F_202 ( V_11 , & V_11 -> V_176 , V_276 ) ;
}
F_203 ( V_11 , & V_11 -> V_176 ) ;
V_275:
F_204 ( & V_11 -> V_233 ) ;
}
