...
static int F_29 ( struct V_61 * V_13 , unsigned V_107 )
{
struct V_1 * V_2 = F_12 ( V_13 ) ;
...
static T_2 int F_30 ( struct V_115 * V_116 )
{
struct V_65 * V_65 = F_31 ( V_116 -> V_13 . V_117 ) ;
struct V_118 * V_101 ;
struct V_119 * V_120 ;
struct V_61 * V_121 ;
struct V_1 * V_2 ;
struct V_122 * V_123 ;
int V_124 , V_5 ;
V_123 = F_32 ( V_65 -> V_13 ) ;
if ( ! V_123 )
return - V_42 ;
V_120 = V_123 -> V_125 ;
V_2 = F_33 ( sizeof( * V_2 ) , V_126 ) ;
if ( ! V_2 )
return - V_127 ;
F_34 ( & V_2 -> V_12 ) ;
V_2 -> V_6 = V_65 ;
...
for ( V_124 = 0 ; V_124 < V_135 ; V_124 ++ , V_101 ++ , V_120 ++ ) {
V_2 -> V_101 [ V_124 ] = V_101 ;
V_2 -> V_136 [ V_124 ] . V_137 = V_101 -> V_137 ;
V_2 -> V_136 [ V_124 ] . V_15 = V_124 ;
V_2 -> V_136 [ V_124 ] . V_138 = V_101 -> V_114 ;
if ( V_124 == V_20 || V_124 == V_22 ) {
V_2 -> V_136 [ V_124 ] . V_139 = & V_140 ;
} else if ( V_124 == V_24 ) {
if ( F_36 ( V_65 ) == V_130 )
V_2 -> V_136 [ V_124 ] . V_139 = & V_141 ;
else
V_2 -> V_136 [ V_124 ] . V_139 = & V_140 ;
} else {
if ( F_36 ( V_65 ) == V_130 )
V_2 -> V_136 [ V_124 ] . V_139 = & V_142 ;
else
V_2 -> V_136 [ V_124 ] . V_139 = & V_143 ;
}
V_2 -> V_136 [ V_124 ] . type = V_144 ;
V_2 -> V_136 [ V_124 ] . V_145 = V_146 ;
V_121 = F_38 ( & V_2 -> V_136 [ V_124 ] ,
V_65 -> V_13 , V_120 , V_2 ) ;
if ( F_39 ( V_121 ) ) {
F_5 ( V_65 -> V_13 ,
L_4 ,
...
V_5:
while ( -- V_124 >= 0 )
F_41 ( V_2 -> V_121 [ V_124 ] ) ;
F_42 ( V_2 ) ;
return V_5 ;
}
static int T_3 F_43 ( struct V_115 * V_116 )
{
struct V_1 * V_1 = F_44 ( V_116 ) ;
int V_124 ;
for ( V_124 = 0 ; V_124 < V_135 ; V_124 ++ )
F_41 ( V_1 -> V_121 [ V_124 ] ) ;
F_42 ( V_1 ) ;
return 0 ;
}
