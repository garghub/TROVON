...
struct V_3 * V_103 )
{
struct V_3 * V_104 = V_2 -> V_4 ;
T_5 V_105 ;
int V_44 , V_106 ;
if ( V_104 == NULL || V_103 == V_104 )
return 0 ;
if ( F_34 ( V_2 -> V_9 . V_40 ) -> V_81 < 6 || ! V_107 )
return F_64 ( V_2 ) ;
V_106 = F_65 ( V_104 , V_103 ) ;
V_105 = V_2 -> V_108 ;
if ( V_105 <= V_104 -> V_109 [ V_106 ] )
return 0 ;
if ( V_105 == V_104 -> V_110 ) {
struct V_111 * V_112 ;
V_112 = F_5 ( sizeof( * V_112 ) , V_28 ) ;
if ( V_112 == NULL )
return - V_100 ;
V_44 = F_66 ( V_104 , NULL , V_112 ) ;
if ( V_44 ) {
F_13 ( V_112 ) ;
return V_44 ;
}
...
V_104 -> V_109 [ V_106 ] = V_105 ;
return F_67 ( V_103 , V_104 , V_105 - 1 ) ;
}
static int
...
static bool
F_73 ( struct V_119 * V_96 )
{
return ( ( V_96 -> V_120 | V_96 -> V_121 ) & 0x7 ) == 0 ;
}
static int
...
int V_70 ;
for ( V_70 = 0 ; V_70 < V_25 ; V_70 ++ ) {
char T_3 * V_122 = ( char T_3 * ) ( V_71 ) V_96 [ V_70 ] . V_72 ;
int V_123 ;
if ( V_96 [ V_70 ] . V_73 >
V_124 / sizeof( struct V_37 ) )
return - V_45 ;
V_123 = V_96 [ V_70 ] . V_73 *
sizeof( struct V_37 ) ;
if ( ! F_75 ( V_125 , V_122 , V_123 ) )
return - V_63 ;
if ( ! F_75 ( V_126 , V_122 , V_123 ) )
return - V_63 ;
if ( F_76 ( V_122 , V_123 ) )
return - V_63 ;
}
...
struct V_1 * V_2 ;
F_31 (obj, objects, exec_list) {
T_5 V_127 = V_2 -> V_9 . V_12 ;
T_5 V_128 = V_2 -> V_9 . V_13 ;
...
if ( F_34 ( V_40 ) -> V_81 >= 4 )
V_132 |= V_134 ;
if ( V_4 -> V_135 ( V_4 , V_132 , 0 ) ) {
F_82 ( V_4 ) ;
return;
}
V_112 = F_5 ( sizeof( * V_112 ) , V_28 ) ;
if ( V_112 == NULL || F_66 ( V_4 , V_78 , V_112 ) ) {
F_82 ( V_4 ) ;
F_13 ( V_112 ) ;
}
}
static int
F_83 ( struct V_39 * V_40 , void * V_136 ,
struct V_77 * V_78 ,
struct V_119 * args ,
struct V_67 * V_96 )
{
...
V_44 = F_74 ( V_96 , args -> V_143 ) ;
if ( V_44 )
return V_44 ;
switch ( args -> V_86 & V_144 ) {
case V_145 :
case V_146 :
V_4 = & V_58 -> V_4 [ V_147 ] ;
break;
...
V_142 = args -> V_86 & V_152 ;
switch ( V_142 ) {
case V_153 :
case V_154 :
case V_155 :
if ( V_4 == & V_58 -> V_4 [ V_147 ] &&
V_142 != V_58 -> V_156 ) {
if ( F_34 ( V_40 ) -> V_81 < 4 )
return - V_45 ;
if ( F_34 ( V_40 ) -> V_81 > 5 &&
...
V_139 = F_87 ( args -> V_158 * sizeof( * V_139 ) ,
V_28 ) ;
if ( V_139 == NULL ) {
V_44 = - V_100 ;
goto V_159;
...
if ( F_55 ( V_139 ,
(struct V_138 T_3 * ) ( V_71 )
args -> V_160 ,
sizeof( * V_139 ) * args -> V_158 ) ) {
V_44 = - V_63 ;
goto V_159;
}
}
...
F_35 ( & V_76 ) ;
for ( V_70 = 0 ; V_70 < args -> V_143 ; V_70 ++ ) {
struct V_1 * V_2 ;
V_2 = F_16 ( F_57 ( V_40 , V_78 ,
V_96 [ V_70 ] . V_33 ) ) ;
if ( & V_2 -> V_9 == NULL ) {
...
V_137 -> V_9 . V_11 |= V_133 ;
V_44 = F_72 ( V_4 , & V_76 ) ;
if ( V_44 )
goto V_93;
V_105 = F_82 ( V_4 ) ;
for ( V_70 = 0 ; V_70 < F_90 ( V_4 -> V_109 ) ; V_70 ++ ) {
if ( V_105 < V_4 -> V_109 [ V_70 ] ) {
V_44 = F_91 ( V_40 ) ;
if ( V_44 )
goto V_93;
F_88 ( V_4 -> V_109 [ V_70 ] ) ;
...
F_92 ( V_4 , V_105 ) ;
V_140 = V_137 -> V_48 + args -> V_120 ;
V_141 = args -> V_121 ;
if ( V_139 ) {
for ( V_70 = 0 ; V_70 < args -> V_158 ; V_70 ++ ) {
V_44 = F_93 ( V_40 , & V_139 [ V_70 ] ,
...
V_44 = V_4 -> V_165 ( V_4 , V_140 , V_141 ) ;
if ( V_44 )
goto V_93;
}
F_77 ( & V_76 , V_4 , V_105 ) ;
...
int
F_94 ( struct V_39 * V_40 , void * V_136 ,
struct V_77 * V_78 )
{
struct V_166 * args = V_136 ;
struct V_119 V_167 ;
struct V_168 * V_85 = NULL ;
struct V_67 * V_169 = NULL ;
int V_44 , V_70 ;
if ( args -> V_143 < 1 ) {
F_17 ( L_18 , args -> V_143 ) ;
return - V_45 ;
}
V_85 = F_52 ( sizeof( * V_85 ) , args -> V_143 ) ;
V_169 = F_52 ( sizeof( * V_169 ) , args -> V_143 ) ;
if ( V_85 == NULL || V_169 == NULL ) {
F_17 ( L_22 ,
args -> V_143 ) ;
F_53 ( V_85 ) ;
F_53 ( V_169 ) ;
...
for ( V_70 = 0 ; V_70 < args -> V_143 ; V_70 ++ ) {
V_169 [ V_70 ] . V_33 = V_85 [ V_70 ] . V_33 ;
V_169 [ V_70 ] . V_73 = V_85 [ V_70 ] . V_73 ;
V_169 [ V_70 ] . V_72 = V_85 [ V_70 ] . V_72 ;
V_169 [ V_70 ] . V_91 = V_85 [ V_70 ] . V_91 ;
V_169 [ V_70 ] . V_49 = V_85 [ V_70 ] . V_49 ;
if ( F_34 ( V_40 ) -> V_81 < 4 )
V_169 [ V_70 ] . V_86 = V_87 ;
else
V_169 [ V_70 ] . V_86 = 0 ;
}
V_167 . V_171 = args -> V_171 ;
V_167 . V_143 = args -> V_143 ;
V_167 . V_120 = args -> V_120 ;
V_167 . V_121 = args -> V_121 ;
V_167 . V_163 = args -> V_163 ;
V_167 . V_164 = args -> V_164 ;
V_167 . V_158 = args -> V_158 ;
V_167 . V_160 = args -> V_160 ;
V_167 . V_86 = V_146 ;
V_44 = F_83 ( V_40 , V_136 , V_78 , & V_167 , V_169 ) ;
if ( ! V_44 ) {
for ( V_70 = 0 ; V_70 < args -> V_143 ; V_70 ++ )
V_85 [ V_70 ] . V_49 = V_169 [ V_70 ] . V_49 ;
V_44 = F_95 ( (struct V_170 T_3 * )
( V_71 ) args -> V_171 ,
V_85 ,
sizeof( * V_85 ) * args -> V_143 ) ;
if ( V_44 ) {
...
int
F_96 ( struct V_39 * V_40 , void * V_136 ,
struct V_77 * V_78 )
{
struct V_119 * args = V_136 ;
struct V_67 * V_169 = NULL ;
int V_44 ;
if ( args -> V_143 < 1 ) {
F_17 ( L_26 , args -> V_143 ) ;
return - V_45 ;
}
V_169 = F_87 ( sizeof( * V_169 ) * args -> V_143 ,
V_28 | V_172 | V_173 ) ;
if ( V_169 == NULL )
V_169 = F_52 ( sizeof( * V_169 ) ,
args -> V_143 ) ;
if ( V_169 == NULL ) {
F_17 ( L_22 ,
args -> V_143 ) ;
...
V_44 = F_83 ( V_40 , V_136 , V_78 , args , V_169 ) ;
if ( ! V_44 ) {
V_44 = F_95 ( (struct V_170 T_3 * )
( V_71 ) args -> V_171 ,
V_169 ,
