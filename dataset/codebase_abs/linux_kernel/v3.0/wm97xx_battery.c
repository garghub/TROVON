...
if ( F_22 ( V_9 -> V_37 ) ) {
V_49 = F_23 ( V_9 -> V_37 , L_4 ) ;
if ( V_49 )
goto V_53;
V_49 = F_24 ( V_9 -> V_37 ) ;
if ( V_49 )
goto V_54;
V_49 = F_25 ( F_26 ( V_9 -> V_37 ) ,
F_15 , V_55 ,
L_5 , V_5 ) ;
if ( V_49 )
goto V_54;
...
if ( V_9 -> V_32 >= 0 )
V_50 ++ ;
V_56 = F_27 ( V_50 * sizeof( * V_56 ) , V_57 ) ;
if ( ! V_56 )
goto V_58;
V_56 [ V_51 ++ ] = V_33 ;
if ( V_9 -> V_37 >= 0 )
...
static int T_3 F_34 ( struct V_48 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_5 . V_7 ;
struct V_8 * V_9 = V_4 -> V_10 ;
if ( V_9 && F_22 ( V_9 -> V_37 ) ) {
F_32 ( F_26 ( V_9 -> V_37 ) , V_5 ) ;
F_33 ( V_9 -> V_37 ) ;
}
F_35 ( & V_34 ) ;
