...
static int F_35 ( T_3 type , T_4 V_50 , T_4 V_51 )
{
int V_8 ;
F_11 ( & V_10 ) ;
...
static int F_36 ( struct V_64 * V_65 , void * V_66 )
{
int V_8 ;
T_3 V_67 = 0 ;
V_8 = F_10 ( & V_67 ) ;
...
{
return F_39 ( V_69 , F_36 , NULL ) ;
}
static int F_40 ( void * V_70 , T_4 * V_1 )
{
* V_1 = V_71 ;
return 0 ;
}
...
if ( ! V_71 )
return - V_29 ;
return F_35 ( V_71 , V_72 , V_73 ) ;
}
static int F_43 ( struct V_74 * V_6 )
{
if ( ( V_6 -> V_75 !=
...
if ( ! V_81 )
goto V_90;
V_81 = F_51 ( L_25 , V_91 | V_93 ,
V_89 , NULL , & V_94 ) ;
if ( ! V_81 )
goto V_90;
V_81 = F_52 ( L_26 , V_91 | V_93 ,
V_89 , & V_72 ) ;
if ( ! V_81 )
goto V_90;
V_81 = F_52 ( L_27 , V_91 | V_93 ,
V_89 , & V_73 ) ;
if ( ! V_81 )
goto V_90;
V_81 = F_51 ( L_28 , V_93 ,
