...
switch ( V_201 ) {
case V_204 :
if ( V_102 -> V_205 != V_206 )
goto exit;
if ( V_102 -> V_109 -> V_207 )
V_16 = V_102 -> V_109 -> V_207 ( V_102 ) ;
break;
case V_208 :
case V_209 :
case V_210 :
case V_211 :
if ( V_102 -> V_205 != V_212 )
goto exit;
if ( V_102 -> V_109 -> V_213 )
V_16 = V_102 -> V_109 -> V_213 ( V_102 ) ;
break;
default:
V_16 = - V_60 ;
}
...
if ( V_83 -> V_41 )
if ( F_65 ( V_83 -> V_41 , V_83 -> V_80 ) )
F_66 ( V_203 -> V_214 , L_27 ) ;
if ( V_83 -> V_42 )
F_26 ( V_83 -> V_42 ) ;
if ( V_27 -> V_39 == V_40 ) {
if ( V_83 -> V_29 . V_42 [ 0 ] ) {
...
F_69 ( V_2 -> V_9 . V_103 , V_216 , sizeof( V_2 -> V_9 . V_103 ) ) ;
}
static int F_70 ( struct V_202 * V_203 )
{
int V_57 ;
F_6 ( L_28 ) ;
for ( V_57 = 0 ; V_57 < V_203 -> V_217 ; V_57 ++ ) {
struct V_1 * V_2 = V_203 -> V_218 [ V_57 ] ;
F_64 ( V_2 ) ;
F_68 ( V_2 ) ;
}
return 0 ;
}
static int F_71 ( struct V_1 * V_2 , unsigned long V_80 ,
unsigned long V_41 )
{
struct V_26 * V_27 = F_25 ( V_2 ) ;
struct V_202 * V_203 = V_27 -> V_203 ;
...
if ( V_16 ) {
F_66 ( V_203 -> V_214 , L_31 ) ;
return - V_221 ;
}
if ( V_27 -> V_39 != V_40 ) {
V_42 = F_75 ( V_41 , V_80 ) ;
if ( ! V_42 ) {
F_66 ( V_203 -> V_214 , L_32 ) ;
F_65 ( V_41 , V_80 ) ;
return - V_221 ;
}
F_6 ( L_33 , V_41 , V_42 ) ;
...
static int F_77 ( struct V_1 * V_2 , unsigned long V_80 ,
unsigned long V_41 )
{
struct V_26 * V_27 = F_25 ( V_2 ) ;
struct V_202 * V_203 = V_27 -> V_203 ;
...
if ( ! V_80 ) {
T_2 V_20 , V_22 ;
V_102 -> V_109 -> V_222 ( V_102 , & V_20 , & V_22 ) ;
if ( V_27 -> V_39 == V_40 ) {
V_80 = F_79 ( F_21 ( V_20 , V_22 , V_12 ) ,
F_21 ( V_22 , V_20 , V_12 ) ) ;
F_6 ( L_35 ,
V_20 * V_22 * V_12 , V_80 ) ;
} else {
...
if ( ! V_80 )
return 0 ;
return F_71 ( V_2 , V_80 , V_41 ) ;
}
static enum V_54 F_80 ( enum V_184 V_223 )
{
enum V_54 V_55 ;
switch ( V_223 ) {
case V_191 :
...
static int F_81 ( const char * V_232 , int V_233 ,
...
if ( V_236 >= V_233 )
return - V_60 ;
V_80 = F_83 ( V_19 + 1 , & V_19 ) ;
if ( ! V_80 )
return - V_60 ;
V_41 = 0 ;
if ( * V_19 == '@' ) {
V_41 = F_82 ( V_19 + 1 , & V_19 , 16 ) ;
if ( ! V_41 )
return - V_60 ;
}
V_235 [ V_236 ] = V_41 ;
...
static int F_84 ( struct V_202 * V_203 )
{
int V_57 , V_16 ;
...
if ( V_239 && F_81 ( V_239 , 10 ,
V_237 , V_238 ) ) {
F_66 ( V_203 -> V_214 , L_36 ) ;
memset ( & V_237 , 0 , sizeof( V_237 ) ) ;
memset ( & V_238 , 0 , sizeof( V_238 ) ) ;
}
if ( V_203 -> V_214 -> V_240 ) {
struct V_241 * V_242 ;
V_242 = V_203 -> V_214 -> V_240 ;
for ( V_57 = 0 ; V_57 < V_242 -> V_243 . V_244 ; ++ V_57 ) {
if ( ! V_237 [ V_57 ] ) {
unsigned long V_80 ;
unsigned long V_41 ;
V_80 = V_242 -> V_243 . V_30 [ V_57 ] . V_80 ;
V_41 = V_242 -> V_243 . V_30 [ V_57 ] . V_41 ;
V_237 [ V_57 ] = V_80 ;
V_238 [ V_57 ] = V_41 ;
}
}
...
for ( V_57 = 0 ; V_57 < V_203 -> V_217 ; V_57 ++ ) {
struct V_26 * V_27 = F_25 ( V_203 -> V_218 [ V_57 ] ) ;
struct V_82 * V_83 ;
V_83 = V_27 -> V_30 ;
F_6 ( L_37 ,
V_57 ,
...
int F_85 ( struct V_1 * V_2 , unsigned long V_80 , int type )
{
struct V_26 * V_27 = F_25 ( V_2 ) ;
struct V_202 * V_203 = V_27 -> V_203 ;
struct V_101 * V_102 = F_32 ( V_2 ) ;
...
V_16 = F_71 ( V_2 , V_80 , 0 ) ;
if ( V_16 ) {
if ( V_245 )
F_71 ( V_2 , V_245 , V_246 ) ;
if ( V_83 -> V_80 == 0 )
F_68 ( V_2 ) ;
return V_16 ;
}
...
static int F_86 ( struct V_202 * V_203 , struct V_1 * V_2 )
{
struct V_6 * V_7 = & V_2 -> V_7 ;
struct V_101 * V_102 = F_32 ( V_2 ) ;
struct V_26 * V_27 = F_25 ( V_2 ) ;
...
V_242 = V_203 -> V_214 -> V_240 ;
if ( V_242 -> V_243 . V_30 [ V_103 ] . V_254 ) {
enum V_54 V_55 ;
enum V_184 V_255 ;
V_255 = V_242 -> V_243 . V_30 [ V_103 ] . V_255 ;
V_55 = F_80 ( V_255 ) ;
if ( V_55 < 0 ) {
V_16 = V_55 ;
goto V_148;
...
if ( V_16 )
goto V_148;
V_16 = F_87 ( & V_2 -> V_197 , 256 , 0 ) ;
if ( V_16 )
F_66 ( V_203 -> V_214 , L_43 ) ;
V_148:
return V_16 ;
}
static void F_88 ( struct V_202 * V_203 , struct V_1 * V_2 )
{
F_89 ( & V_2 -> V_197 ) ;
}
static void F_90 ( struct V_202 * V_203 )
{
int V_57 ;
F_6 ( L_44 ) ;
if ( V_203 == NULL )
return;
for ( V_57 = 0 ; V_57 < V_203 -> V_217 ; V_57 ++ )
F_91 ( V_203 -> V_218 [ V_57 ] ) ;
F_70 ( V_203 ) ;
for ( V_57 = 0 ; V_57 < V_203 -> V_217 ; V_57 ++ ) {
F_88 ( V_203 , V_203 -> V_218 [ V_57 ] ) ;
F_92 ( V_203 -> V_218 [ V_57 ] ) ;
}
for ( V_57 = 0 ; V_57 < V_203 -> V_256 ; V_57 ++ ) {
if ( V_203 -> V_257 [ V_57 ] -> V_205 != V_258 )
V_203 -> V_257 [ V_57 ] -> V_109 -> V_259 ( V_203 -> V_257 [ V_57 ] ) ;
F_93 ( V_203 -> V_257 [ V_57 ] ) ;
}
F_94 ( V_203 -> V_214 , NULL ) ;
F_95 ( V_203 ) ;
}
static int F_96 ( struct V_202 * V_203 )
{
int V_16 , V_57 ;
V_203 -> V_217 = 0 ;
F_6 ( L_45 , V_260 ) ;
for ( V_57 = 0 ; V_57 < V_260 ; V_57 ++ ) {
struct V_1 * V_2 ;
struct V_26 * V_27 ;
V_2 = F_97 ( sizeof( struct V_26 ) ,
V_203 -> V_214 ) ;
if ( V_2 == NULL ) {
F_66 ( V_203 -> V_214 ,
L_46 ) ;
...
F_68 ( V_2 ) ;
V_203 -> V_218 [ V_57 ] = V_2 ;
V_27 = F_25 ( V_2 ) ;
V_27 -> V_203 = V_203 ;
V_27 -> V_103 = V_57 ;
V_27 -> V_30 = & V_203 -> V_261 [ V_57 ] ;
V_27 -> V_30 -> V_103 = V_57 ;
F_98 ( & V_27 -> V_30 -> V_262 ) ;
V_27 -> V_39 = V_263 ? V_40 :
V_264 ;
V_27 -> V_147 = V_265 ;
V_203 -> V_217 ++ ;
}
F_6 ( L_47 ) ;
for ( V_57 = 0 ; V_57 < F_99 ( V_203 -> V_217 , V_203 -> V_105 ) ; V_57 ++ ) {
struct V_26 * V_27 = F_25 ( V_203 -> V_218 [ V_57 ] ) ;
...
F_48 ( V_27 -> V_30 ) ;
if ( V_16 ) {
F_66 ( V_203 -> V_214 , L_50 ) ;
return V_16 ;
}
}
F_6 ( L_51 ) ;
for ( V_57 = 0 ; V_57 < V_203 -> V_217 ; V_57 ++ ) {
V_16 = F_100 ( V_203 -> V_218 [ V_57 ] ) ;
if ( V_16 != 0 ) {
F_66 ( V_203 -> V_214 ,
L_52 , V_57 ) ;
return V_16 ;
...
F_48 ( V_27 -> V_30 ) ;
if ( V_16 ) {
F_66 ( V_203 -> V_214 , L_54 ) ;
return V_16 ;
}
}
if ( V_203 -> V_217 > 0 ) {
struct V_26 * V_27 = F_25 ( V_203 -> V_218 [ 0 ] ) ;
if ( V_27 -> V_105 > 0 ) {
...
static int F_101 ( const char * V_266 ,
struct V_115 * V_116 , T_3 * V_267 )
{
struct V_1 * V_2 ;
struct V_6 * V_7 ;
struct V_268 * V_249 ;
int V_16 ;
#ifdef F_102
if ( strcmp ( V_266 , L_57 ) == 0 ) {
* V_116 = V_269 ;
* V_267 = 24 ;
return 0 ;
} else if ( strcmp ( V_266 , L_58 ) == 0 ) {
* V_116 = V_270 ;
* V_267 = 24 ;
return 0 ;
}
...
V_7 = NULL ;
V_249 = NULL ;
V_2 = F_103 ( sizeof( * V_2 ) , V_271 ) ;
if ( V_2 == NULL ) {
V_16 = - V_221 ;
goto V_148;
}
V_7 = F_103 ( sizeof( * V_7 ) , V_271 ) ;
if ( V_7 == NULL ) {
V_16 = - V_221 ;
goto V_148;
}
V_249 = F_103 ( sizeof( * V_249 ) , V_271 ) ;
if ( V_249 == NULL ) {
V_16 = - V_221 ;
goto V_148;
}
V_2 -> V_249 = V_249 ;
V_16 = F_104 ( V_7 , V_2 , V_266 , NULL , 0 , NULL , 24 ) ;
if ( V_16 == 0 ) {
V_16 = - V_60 ;
goto V_148;
}
V_116 -> V_118 = F_105 ( V_7 -> V_117 ) ;
...
V_116 -> V_272 = V_7 -> V_75 ;
V_116 -> V_273 = V_7 -> V_76 ;
switch ( V_7 -> V_13 ) {
case 16 :
* V_267 = 16 ;
break;
...
struct V_101 * V_102 , char * V_266 )
{
int V_16 ;
T_3 V_267 ;
struct V_115 V_116 , V_274 ;
V_16 = F_101 ( V_266 , & V_116 , & V_267 ) ;
if ( V_16 )
return V_16 ;
V_203 -> V_275 [ V_203 -> V_276 ] . V_277 = V_102 ;
V_203 -> V_275 [ V_203 -> V_276 ] . V_267 = V_267 ;
++ V_203 -> V_276 ;
if ( V_102 -> V_109 -> V_278 ) {
V_16 = V_102 -> V_109 -> V_278 ( V_102 , & V_116 ) ;
if ( V_16 )
return V_16 ;
} else {
if ( V_102 -> V_109 -> V_114 ) {
V_102 -> V_109 -> V_114 ( V_102 , & V_274 ) ;
if ( V_274 . V_272 != V_116 . V_272 ||
V_274 . V_273 != V_116 . V_273 )
return - V_60 ;
}
}
if ( V_102 -> V_109 -> V_279 )
V_102 -> V_109 -> V_279 ( V_102 , & V_116 ) ;
return 0 ;
}
...
{
int V_57 ;
F_107 ( V_277 -> V_109 -> V_280 == NULL ) ;
for ( V_57 = 0 ; V_57 < V_203 -> V_276 ; ++ V_57 ) {
if ( V_277 == V_203 -> V_275 [ V_57 ] . V_277 )
return V_203 -> V_275 [ V_57 ] . V_267 ;
}
return V_277 -> V_109 -> V_280 ( V_277 ) ;
}
static int F_108 ( struct V_202 * V_203 )
{
char * V_281 , * V_282 , * V_283 ;
int V_16 = 0 ;
V_281 = F_109 ( V_284 , V_271 ) ;
if ( ! V_281 )
return - V_221 ;
V_282 = V_281 ;
while ( ! V_16 && ( V_283 = F_110 ( & V_282 , L_59 ) ) != NULL ) {
char * V_19 , * V_285 , * V_266 ;
struct V_101 * V_102 ;
int V_57 ;
V_19 = strchr ( V_283 , ':' ) ;
if ( ! V_19 ) {
...
V_102 = NULL ;
for ( V_57 = 0 ; V_57 < V_203 -> V_256 ; ++ V_57 ) {
if ( strcmp ( V_203 -> V_257 [ V_57 ] -> V_286 ,
V_285 ) == 0 ) {
V_102 = V_203 -> V_257 [ V_57 ] ;
break;
}
}
if ( ! V_102 ) {
...
static int F_111 ( struct V_202 * V_203 ,
struct V_101 * V_277 )
{
struct V_287 * V_288 = V_277 -> V_109 ;
int V_16 ;
V_16 = V_288 -> V_289 ( V_277 ) ;
if ( V_16 ) {
F_112 ( V_203 -> V_214 , L_60 ,
V_277 -> V_286 ) ;
return V_16 ;
}
if ( V_277 -> V_160 & V_290 ) {
T_2 V_20 , V_22 ;
if ( V_288 -> V_291 ) {
V_16 = V_288 -> V_291 ( V_277 , 1 ) ;
if ( V_16 ) {
F_66 ( V_203 -> V_214 , L_61 ) ;
return V_16 ;
}
}
if ( V_288 -> V_292 ) {
V_16 = V_288 -> V_292 ( V_277 ,
V_293 ) ;
if ( V_16 ) {
F_66 ( V_203 -> V_214 ,
L_62 ) ;
...
V_288 -> V_222 ( V_277 , & V_20 , & V_22 ) ;
V_16 = V_288 -> V_294 ( V_277 , 0 , 0 , V_20 , V_22 ) ;
if ( V_16 ) {
F_66 ( V_203 -> V_214 ,
L_63 ) ;
return V_16 ;
...
static int F_113 ( struct V_296 * V_297 )
{
...
F_6 ( L_64 ) ;
if ( V_297 -> V_299 != 0 ) {
F_66 ( & V_297 -> V_214 , L_65 ) ;
V_16 = - V_300 ;
goto V_301;
}
V_203 = F_103 ( sizeof( struct V_202 ) , V_271 ) ;
if ( V_203 == NULL ) {
V_16 = - V_221 ;
goto V_301;
}
if ( V_263 && ! F_114 () && ! F_115 () ) {
V_263 = 0 ;
F_112 ( & V_297 -> V_214 , L_66
L_67 ) ;
}
F_116 ( & V_203 -> V_302 ) ;
V_203 -> V_214 = & V_297 -> V_214 ;
F_117 ( V_297 , V_203 ) ;
V_16 = 0 ;
V_203 -> V_256 = 0 ;
V_277 = NULL ;
...
F_119 ( V_277 ) ;
if ( ! V_277 -> V_109 ) {
F_66 ( & V_297 -> V_214 , L_68 ) ;
V_16 = - V_300 ;
}
V_203 -> V_257 [ V_203 -> V_256 ++ ] = V_277 ;
}
if ( V_16 )
goto V_303;
if ( V_203 -> V_256 == 0 ) {
F_66 ( & V_297 -> V_214 , L_69 ) ;
V_16 = - V_60 ;
goto V_303;
}
V_203 -> V_105 = F_120 () ;
for ( V_57 = 0 ; V_57 < V_203 -> V_105 ; V_57 ++ )
V_203 -> V_106 [ V_57 ] = F_121 ( V_57 ) ;
V_203 -> V_304 = F_122 () ;
for ( V_57 = 0 ; V_57 < V_203 -> V_304 ; V_57 ++ )
V_203 -> V_305 [ V_57 ] = F_123 ( V_57 ) ;
if ( V_284 && strlen ( V_284 ) > 0 ) {
if ( F_108 ( V_203 ) )
F_112 ( & V_297 -> V_214 , L_70 ) ;
}
V_16 = F_96 ( V_203 ) ;
if ( V_16 )
goto V_303;
for ( V_57 = 0 ; V_57 < V_203 -> V_304 ; V_57 ++ ) {
struct V_306 * V_307 ;
V_307 = V_203 -> V_305 [ V_57 ] ;
V_16 = V_307 -> V_159 ( V_307 ) ;
if ( V_16 )
F_112 ( V_203 -> V_214 , L_71 ) ;
}
F_6 ( L_72 ) ;
V_139 = F_121 ( 0 ) ;
if ( V_139 -> V_158 && V_139 -> V_158 -> V_308 ) {
V_298 = V_139 -> V_158 -> V_308 ;
} else {
F_112 ( & V_297 -> V_214 , L_73 ) ;
V_298 = NULL ;
}
if ( V_298 ) {
V_16 = F_111 ( V_203 , V_298 ) ;
if ( V_16 ) {
F_66 ( V_203 -> V_214 ,
L_74
L_75 ) ;
...
F_90 ( V_203 ) ;
V_301:
F_66 ( & V_297 -> V_214 , L_78 ) ;
return V_16 ;
}
static int F_125 ( struct V_296 * V_297 )
{
struct V_202 * V_203 = F_126 ( V_297 ) ;
F_127 ( V_203 ) ;
F_90 ( V_203 ) ;
return 0 ;
}
