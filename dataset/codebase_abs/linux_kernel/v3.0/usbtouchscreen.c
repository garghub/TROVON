...
return;
F_50 ( V_2 -> V_29 , V_88 , V_2 -> V_14 ) ;
if ( V_89 ) {
F_51 ( V_2 -> V_29 , V_30 , V_2 -> V_13 ) ;
F_51 ( V_2 -> V_29 , V_31 , V_2 -> V_12 ) ;
} else {
F_51 ( V_2 -> V_29 , V_30 , V_2 -> V_12 ) ;
F_51 ( V_2 -> V_29 , V_31 , V_2 -> V_13 ) ;
}
if ( type -> V_90 )
F_51 ( V_2 -> V_29 , V_91 , V_2 -> V_15 ) ;
F_52 ( V_2 -> V_29 ) ;
}
...
if ( F_55 ( ( V_93 > 0 ) && ( V_93 <= V_95 - V_94 ) ) ) {
F_49 ( V_2 , V_92 + V_94 , V_93 ) ;
} else {
...
static int F_59 ( struct V_109 * V_29 )
{
struct V_1 * V_2 = F_60 ( V_29 ) ;
int V_110 ;
V_2 -> V_111 -> V_9 = F_2 ( V_2 -> V_6 ) ;
V_110 = F_61 ( V_2 -> V_6 ) ? - V_112 : 0 ;
if ( V_110 < 0 )
goto V_113;
if ( ! V_2 -> type -> V_114 ) {
...
static void F_63 ( struct V_109 * V_29 )
{
struct V_1 * V_2 = F_60 ( V_29 ) ;
int V_110 ;
if ( ! V_2 -> type -> V_114 )
...
struct V_1 * V_2 )
{
F_71 ( V_5 , V_2 -> type -> V_99 ,
V_2 -> V_83 , V_2 -> V_124 ) ;
F_20 ( V_2 -> V_92 ) ;
}
static struct V_125 *
F_72 ( struct V_53 * V_6 )
{
int V_22 ;
for ( V_22 = 0 ; V_22 < V_6 -> V_60 . V_61 ; V_22 ++ )
...
return - V_39 ;
V_62 = F_72 ( V_118 -> V_54 ) ;
if ( ! V_62 )
return - V_64 ;
V_2 = F_74 ( sizeof( struct V_1 ) , V_46 ) ;
V_109 = F_75 () ;
if ( ! V_2 || ! V_109 )
goto V_130;
...
V_2 -> V_29 = V_109 ;
if ( V_5 -> V_133 )
F_77 ( V_2 -> V_134 , V_5 -> V_133 , sizeof( V_2 -> V_134 ) ) ;
if ( V_5 -> V_135 ) {
if ( V_5 -> V_133 )
F_78 ( V_2 -> V_134 , L_16 , sizeof( V_2 -> V_134 ) ) ;
F_78 ( V_2 -> V_134 , V_5 -> V_135 , sizeof( V_2 -> V_134 ) ) ;
}
if ( ! strlen ( V_2 -> V_134 ) )
snprintf ( V_2 -> V_134 , sizeof( V_2 -> V_134 ) ,
L_17 ,
F_79 ( V_5 -> V_136 . V_137 ) ,
F_79 ( V_5 -> V_136 . V_138 ) ) ;
F_80 ( V_5 , V_2 -> V_139 , sizeof( V_2 -> V_139 ) ) ;
F_78 ( V_2 -> V_139 , L_18 , sizeof( V_2 -> V_139 ) ) ;
V_109 -> V_134 = V_2 -> V_134 ;
V_109 -> V_139 = V_2 -> V_139 ;
F_81 ( V_5 , & V_109 -> V_127 ) ;
V_109 -> V_9 . V_140 = & V_118 -> V_9 ;
F_82 ( V_109 , V_2 ) ;
V_109 -> V_141 = F_59 ;
V_109 -> V_142 = F_63 ;
V_109 -> V_143 [ 0 ] = F_83 ( V_144 ) | F_83 ( V_145 ) ;
V_109 -> V_146 [ F_84 ( V_88 ) ] = F_83 ( V_88 ) ;
