...
F_14 ( V_50 , struct V_52 , V_54 . V_53 ) ;
struct V_11 * V_12 = F_22 ( V_53 ) ;
V_10 [ sizeof V_12 -> V_62 ] = '\0' ;
memcpy ( V_10 , V_12 -> V_62 , sizeof V_12 -> V_62 ) ;
strcat ( V_10 , L_6 ) ;
return strlen ( V_10 ) ;
}
...
struct V_11 * V_12 = F_22 ( V_53 ) ;
int V_5 ;
if ( V_16 < 5 || memcmp ( V_10 , L_11 , 5 ) || ! V_12 -> V_63 ) {
V_5 = - V_6 ;
goto V_7;
}
V_5 = F_30 ( V_12 -> V_64 ) ;
...
static T_1 F_31 ( struct V_50 * V_50 ,
struct V_51 * V_28 , char * V_10 )
{
struct V_52 * V_53 =
F_14 ( V_50 , struct V_52 , V_54 . V_53 ) ;
...
static T_1 F_33 ( struct V_50 * V_50 ,
struct V_51 * V_28 , char * V_10 )
{
struct V_52 * V_53 =
F_14 ( V_50 , struct V_52 , V_54 . V_53 ) ;
...
int F_34 ( struct V_71 * V_54 , T_5 V_72 ,
struct V_25 * V_26 )
{
struct V_8 * V_9 ;
struct V_11 * V_12 = F_35 ( V_54 ) ;
int V_5 ;
if ( ! V_72 || V_72 > V_12 -> V_73 ) {
F_6 ( V_12 , L_14
L_15 , V_72 ) ;
V_5 = - V_74 ;
goto V_7;
}
V_9 = & V_12 -> V_75 [ V_72 - 1 ] ;
V_5 = F_36 ( & V_9 -> V_31 , & V_76 , V_26 ,
L_16 ) ;
if ( V_5 ) {
F_6 ( V_12 , L_17
L_18 , V_5 , V_72 ) ;
...
{
struct V_71 * V_53 = & V_12 -> V_82 . V_54 ;
int V_21 , V_5 ;
for ( V_21 = 0 ; V_21 < F_40 ( V_83 ) ; ++ V_21 ) {
V_5 = F_41 ( & V_53 -> V_53 , V_83 [ V_21 ] ) ;
if ( V_5 )
return V_5 ;
}
return 0 ;
...
struct V_8 * V_9 ;
int V_21 ;
for ( V_21 = 0 ; V_21 < V_12 -> V_73 ; V_21 ++ ) {
V_9 = & V_12 -> V_75 [ V_21 ] ;
F_38 ( & V_9 -> V_31 ) ;
F_38 ( & V_9 -> V_37 ) ;
}
