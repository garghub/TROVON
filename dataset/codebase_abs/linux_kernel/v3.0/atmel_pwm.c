...
V_2 -> V_22 = * V_56 ;
V_2 -> V_55 = V_55 ;
V_2 -> V_5 = F_31 ( V_53 -> V_61 , V_53 -> V_62 - V_53 -> V_61 + 1 ) ;
if ( ! V_2 -> V_5 )
goto V_63;
V_2 -> V_29 = F_32 ( & V_12 -> V_11 , L_6 ) ;
if ( F_33 ( V_2 -> V_29 ) ) {
V_21 = F_34 ( V_2 -> V_29 ) ;
V_2 -> V_29 = NULL ;
goto V_63;
}
V_21 = F_35 ( V_55 , F_21 , 0 , V_12 -> V_64 , V_2 ) ;
if ( V_21 < 0 )
goto V_63;
V_1 = V_2 ;
F_36 ( V_12 , V_2 ) ;
...
static int T_5 F_40 ( struct V_51 * V_12 )
{
