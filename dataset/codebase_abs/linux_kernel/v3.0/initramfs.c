...
static long T_1 F_7 ( char T_3 * V_15 , T_4 V_16 )
{
struct V_17 V_18 [ 2 ] ;
V_18 [ 0 ] . V_19 = V_16 ;
V_18 [ 0 ] . V_20 = 0 ;
...
static void T_1 F_9 ( const char * V_8 , T_4 V_16 )
{
...
struct V_95 * V_96 ;
int V_97 ;
V_94 = F_38 ( ( const char T_3 V_98 * ) L_13 , V_99 , 0 ) ;
F_66 ( V_94 < 0 ) ;
if ( V_94 < 0 )
return;
V_29 = F_67 ( V_100 , V_14 ) ;
F_66 ( ! V_29 ) ;
if ( ! V_29 ) {
F_52 ( V_94 ) ;
return;
...
V_96 = V_29 ;
V_97 = F_68 ( V_94 , V_96 , V_100 ) ;
while ( V_97 > 0 ) {
while ( V_97 > 0 ) {
struct V_59 V_60 ;
int V_101 ;
V_101 = F_33 ( V_96 -> V_102 , & V_60 ) ;
F_69 ( V_101 ) ;
if ( ! V_101 ) {
if ( F_34 ( V_60 . V_61 ) )
F_35 ( V_96 -> V_102 ) ;
...
F_72 ( V_107 L_15
L_16 , V_104 ) ;
V_94 = F_38 ( ( const char T_3 V_98 * ) L_17 ,
V_65 | V_66 , 0700 ) ;
if ( V_94 >= 0 ) {
F_51 ( V_94 , ( char * ) V_92 ,
V_93 - V_92 ) ;
