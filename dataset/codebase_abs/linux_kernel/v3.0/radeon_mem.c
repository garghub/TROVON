...
void F_9 ( struct V_5 * V_6 , struct V_1 * V_12 )
{
struct V_1 * V_2 ;
if ( ! V_12 || ! V_12 -> V_10 )
return;
...
static struct V_1 * * F_11 ( T_1 * V_18 , int V_19 )
{
switch ( V_19 ) {
case V_20 :
return & V_18 -> V_21 ;
...
int F_12 ( struct V_24 * V_25 , void * V_26 , struct V_5 * V_6 )
{
T_1 * V_18 = V_25 -> V_27 ;
T_2 * V_28 = V_26 ;
...
int F_15 ( struct V_24 * V_25 , void * V_26 , struct V_5 * V_6 )
{
T_1 * V_18 = V_25 -> V_27 ;
T_3 * V_34 = V_26 ;
struct V_1 * V_29 , * * V_12 ;
