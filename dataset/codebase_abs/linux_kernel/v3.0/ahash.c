...
static void F_47 ( struct V_68 * V_69 , struct V_65 * V_58 )
{
F_48 ( V_69 , L_1 ) ;
F_48 ( V_69 , L_2 , V_58 -> V_70 & V_71 ?
L_3 : L_4 ) ;
F_48 ( V_69 , L_5 , V_58 -> V_72 ) ;
F_48 ( V_69 , L_6 ,
F_49 ( V_58 ) -> V_73 ) ;
}
struct V_2 * F_50 ( const char * V_74 , T_3 type ,
T_3 V_39 )
{
return F_51 ( V_74 , & V_63 , type , V_39 ) ;
}
static int F_52 ( struct V_1 * V_58 )
{
struct V_65 * V_24 = & V_58 -> V_4 . V_24 ;
if ( V_58 -> V_4 . V_73 > V_11 / 8 ||
V_58 -> V_4 . V_75 > V_11 / 8 )
return - V_76 ;
V_24 -> V_62 = & V_63 ;
V_24 -> V_70 &= ~ V_77 ;
V_24 -> V_70 |= V_78 ;
...
if ( V_19 )
return V_19 ;
return F_58 ( V_80 , F_59 ( V_82 ) ) ;
}
void F_60 ( struct V_83 * V_82 )
{
F_61 ( F_62 ( V_82 ) ) ;
F_63 ( V_81 ( V_82 ) ) ;
}
...
struct V_83 * V_82 )
{
return F_65 ( & V_85 -> V_24 , & V_58 -> V_24 , V_82 ,
& V_63 ) ;
}
struct V_86 * F_66 ( struct V_87 * V_88 , T_3 type , T_3 V_39 )
{
struct V_65 * V_58 ;
V_58 = F_67 ( V_88 , & V_63 , type , V_39 ) ;
return F_68 ( V_58 ) ? F_69 ( V_58 ) : F_49 ( V_58 ) ;
}
