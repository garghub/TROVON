...
struct V_61 * V_62 , char * V_63 )
{
return sprintf ( V_63 , L_17 , F_4 ( V_4 ) -> V_5 ) ;
}
...
if ( V_24 )
goto V_43;
V_24 = F_52 ( & V_21 -> V_4 , & V_73 ) ;
if ( V_24 )
goto V_74;
V_24 = F_52 ( & V_21 -> V_4 , & V_75 ) ;
if ( V_24 )
goto V_76;
V_24 = F_52 ( & V_21 -> V_4 , & V_77 ) ;
if ( V_24 )
goto V_78;
return 0 ;
V_78:
...
static int F_54 ( struct V_18 * V_19 , const char * type )
{
int V_24 = 0 ;
char * * V_79 ;
unsigned int V_80 = 0 ;
int V_81 ;
V_79 = F_55 ( V_25 , V_19 -> V_82 , type , & V_80 ) ;
if ( F_56 ( V_79 ) )
return F_57 ( V_79 ) ;
for ( V_81 = 0 ; V_81 < V_80 ; V_81 ++ ) {
V_24 = V_19 -> V_41 ( V_19 , type , V_79 [ V_81 ] ) ;
if ( V_24 )
break;
}
F_6 ( V_79 ) ;
...
int V_24 = 0 ;
char * * V_79 ;
unsigned int V_81 , V_80 ;
V_79 = F_55 ( V_25 , V_19 -> V_82 , L_5 , & V_80 ) ;
if ( F_56 ( V_79 ) )
return F_57 ( V_79 ) ;
for ( V_81 = 0 ; V_81 < V_80 ; V_81 ++ ) {
V_24 = F_54 ( V_19 , V_79 [ V_81 ] ) ;
if ( V_24 )
break;
}
F_6 ( V_79 ) ;
...
static unsigned int F_59 ( const char * V_83 , char V_84 )
{
unsigned int V_81 , V_85 = 0 ;
for ( V_81 = 0 ; V_83 [ V_81 ] ; V_81 ++ )
if ( V_83 [ V_81 ] == V_84 )
V_85 ++ ;
return V_85 ;
}
static int F_60 ( const char * V_83 , char V_84 , unsigned int V_32 )
{
unsigned int V_81 ;
for ( V_81 = 0 ; V_83 [ V_81 ] ; V_81 ++ )
if ( V_83 [ V_81 ] == V_84 ) {
...
return ( V_32 == 0 ) ? V_81 : - V_86 ;
}
void F_61 ( const char * V_15 , struct V_18 * V_19 )
{
int V_87 , V_88 ;
struct V_3 * V_4 ;
char type [ V_65 ] ;
const char * V_89 , * V_82 ;
if ( F_59 ( V_15 , '/' ) < 2 )
return;
V_87 = F_16 ( V_25 , V_15 , L_5 ) ;
if ( ! V_87 ) {
F_41 ( V_15 , & V_19 -> V_19 ) ;
return;
}
V_89 = strchr ( V_15 , '/' ) + 1 ;
snprintf ( type , V_65 , L_18 , ( int ) strcspn ( V_89 , L_19 ) , V_89 ) ;
type [ V_65 - 1 ] = '\0' ;
V_88 = F_60 ( V_15 , '/' , V_19 -> V_90 ) ;
if ( V_88 < 0 )
return;
V_82 = F_62 ( V_69 , L_18 , V_88 , V_15 ) ;
if ( ! V_82 )
return;
V_4 = F_38 ( V_82 , & V_19 -> V_19 ) ;
if ( ! V_4 )
F_47 ( V_19 , type , V_82 ) ;
else
F_32 ( & V_4 -> V_4 ) ;
...
if ( F_76 () ) {
T_4 V_119 = 0 ;
V_24 = F_84 ( V_120 , & V_119 ) ;
if ( V_24 )
goto V_105;
V_115 = ( int ) V_119 ;
V_24 = F_84 ( V_121 , & V_119 ) ;
if ( V_24 )
goto V_105;
V_106 = ( unsigned long ) V_119 ;
V_118 = F_85 ( V_106 << V_109 , V_122 ) ;
} else {
V_115 = V_107 -> V_116 ;
V_106 = V_107 -> V_108 ;
V_118 = F_83 ( V_106 ) ;
