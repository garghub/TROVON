...
if ( V_2 -> V_52 && V_51 < 38 ) {
T_2 V_53 , V_54 ;
V_54 = V_2 -> V_11 ( V_2 , V_55 ) ;
V_54 . V_55 . V_56 = V_51 - 6 ;
V_2 -> V_20 ( V_2 , V_55 , V_54 ) ;
V_53 = V_2 -> V_11 ( V_2 , V_57 ) ;
V_53 . V_57 . V_58 = V_3 ? V_22 : 0x1fff ;
V_53 . V_57 . V_59 = V_3 ;
V_2 -> V_20 ( V_2 , V_57 , V_53 ) ;
}
break;
}
}
...
{
int V_63 = 6 + V_2 -> V_52 * 32 ;
V_2 -> V_64 += V_3 ? 1 : - 1 ;
if ( V_62 -> V_51 >= V_63 )
V_2 -> V_65 += V_3 ? 1 : - 1 ;
if ( ! V_2 -> V_66 && V_2 -> V_64 == V_3 )
F_18 ( V_2 , V_3 ) ;
if ( V_2 -> V_66 ) {
F_17 \
( V_2 , V_62 -> V_51 , V_62 -> V_22 , V_3 ) ;
if ( V_2 -> V_65 > 0 )
F_18 ( V_2 , 1 ) ;
else if ( V_62 -> V_22 == 0x2000 )
F_18 ( V_2 , V_3 ) ;
else
F_18 ( V_2 , 0 ) ;
}
...
int V_68 ;
T_2 V_69 ;
for ( V_68 = 0 ; V_68 < 6 + 32 * V_2 -> V_52 ; V_68 ++ )
F_17 ( V_2 , V_68 , 0x1fff , 0 ) ;
F_8 ( V_2 , 0 , 0x1fe0 ) ;
F_9 ( V_2 , 0 ) ;
V_69 = V_2 -> V_11 ( V_2 , V_44 ) ;
V_69 . V_44 . V_70 = 1 ;
V_69 . V_44 . V_71 = 0 ;
V_2 -> V_20 ( V_2 , V_44 , V_69 ) ;
F_5 ( V_2 , 1 ) ;
}
