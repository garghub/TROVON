...
F_53 ( V_166 , V_233 ) )
return true ;
return ! ! F_53 ( V_166 , V_234 ) ;
}
int F_87 ( struct V_2 * V_166 )
{
static T_8 V_4 = F_88 ( 0 ) ;
int V_97 ;
if ( F_34 ( V_166 -> V_235 & V_236 ) )
return - V_237 ;
if ( ! ( V_166 -> V_182 & V_238 )
&& ( F_86 ( V_166 ) || ( V_166 -> V_182 & V_239 ) ) )
return - V_162 ;
...
return F_96 ( V_97 ) ;
F_97 ( & V_166 -> V_106 ) ;
V_166 -> V_106 . V_240 = F_21 ;
V_166 -> V_106 . V_168 = & V_241 ;
V_166 -> V_28 = F_98 ( V_242 ,
...
int F_105 ( struct V_141 * V_142 , struct V_246 * V_247 ,
const char * V_248 )
{
int V_97 ;
V_142 -> V_130 . V_144 = V_142 -> V_144 ;
V_142 -> V_130 . V_168 = & V_241 ;
V_142 -> V_130 . V_247 = V_247 ;
V_142 -> V_130 . V_248 = V_248 ;
F_99 ( & V_142 -> V_212 ) ;
F_106 ( & V_142 -> V_211 ) ;
V_97 = F_107 ( & V_142 -> V_130 ) ;
if ( V_97 )
return V_97 ;
V_97 = F_108 ( & V_142 -> V_130 , & V_249 ) ;
if ( V_97 )
F_109 ( & V_142 -> V_130 ) ;
return V_97 ;
}
...
for ( V_45 = 0 ; V_45 < F_113 ( V_252 ) ; V_45 ++ )
if ( V_251 -> V_253 -> V_254 [ V_45 ] )
return 1 ;
}
return 0 ;
}
