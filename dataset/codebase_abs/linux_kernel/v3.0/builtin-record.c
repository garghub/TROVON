...
F_19 () ;
exit ( V_99 ) ;
} else if ( V_95 == V_100 && V_68 ) {
F_4 ( L_2
L_3 ) ;
} else if ( V_95 == V_101 && V_66 ) {
V_66 = false ;
if ( ! V_67 && ! V_70 && ! V_89 )
V_34 -> V_43 &= ~ V_69 ;
goto V_90;
...
if ( V_123 -> V_75 [ V_127 ] . V_18 )
F_6 ( & V_123 -> V_75 [ V_127 ] ) ;
}
...
if ( V_23 )
break;
V_95 = F_68 ( V_123 -> V_170 , V_123 -> V_171 , - 1 ) ;
V_136 ++ ;
}
if ( V_23 ) {
for ( V_127 = 0 ; V_127 < V_123 -> V_87 -> V_172 ; V_127 ++ ) {
struct V_29 * V_82 ;
F_16 (pos, &evsel_list->entries, node) {
for ( V_169 = 0 ;
V_169 < V_123 -> V_93 -> V_172 ;
V_169 ++ )
F_69 ( F_70 ( V_82 , V_127 , V_169 ) ,
V_173 ) ;
}
}
}
...
if ( V_123 == NULL )
return - V_176 ;
V_131 = F_73 ( V_131 , V_132 , V_177 , V_178 ,
V_179 ) ;
if ( ! V_131 && V_77 == - 1 && V_78 == - 1 &&
! V_64 && ! V_68 )
F_74 ( V_178 , V_177 ) ;
if ( V_180 && V_181 ) {
fprintf ( V_115 , L_43
