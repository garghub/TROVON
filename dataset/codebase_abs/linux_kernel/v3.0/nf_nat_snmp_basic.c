...
static unsigned char F_19 ( unsigned int V_11 ,
unsigned int V_12 ,
unsigned short * V_29 )
{
...
static unsigned char F_20 ( struct V_1 * V_2 ,
struct V_34 * * V_35 )
{
...
* V_35 = F_13 ( sizeof( struct V_34 ) + V_4 ,
V_23 ) ;
if ( * V_35 == NULL ) {
F_16 ( V_39 ) ;
if ( F_14 () )
...
break;
case V_54 :
if ( ! F_18 ( V_2 , V_6 , ( unsigned long * * ) & V_38 , & V_4 ) ) {
F_16 ( V_39 ) ;
return 0 ;
}
...
static unsigned char F_21 ( struct V_1 * V_2 ,
struct V_62 * V_63 )
{
...
* V_67 = F_23 ( F_24 ( V_70 , 4 , ~ F_25 ( * V_67 ) ) ) ;
}
static inline void F_26 ( unsigned char * V_5 ,
unsigned char * V_71 ,
const struct V_72 * V_73 ,
T_2 * V_74 )
{
if ( V_73 -> V_75 == F_27 ( V_71 ) ) {
T_3 V_76 ;
if ( V_77 )
...
static unsigned char F_29 ( struct V_1 * V_2 ,
struct V_80 * V_81 ,
const struct V_72 * V_73 ,
T_2 * V_74 )
{
...
if ( V_12 != V_42 || V_13 != V_17 || V_11 != V_45 )
return 0 ;
if ( ! F_18 ( V_2 , V_6 , & V_81 -> V_39 , & V_81 -> V_61 ) )
return 0 ;
if ( ! F_6 ( V_2 , & V_6 , & V_12 , & V_13 , & V_11 ) )
goto V_82;
...
if ( V_4 != 4 )
goto V_87;
F_26 ( V_2 -> V_5 , V_2 -> V_7 - 4 , V_73 , V_74 ) ;
if ( ! F_6 ( V_2 , & V_6 , & V_12 , & V_13 , & V_11 ) )
goto V_87;
if ( V_12 != V_42 || V_13 != V_17 || V_11 != V_64 )
goto V_87;
...
return 1 ;
V_87:
F_16 ( ( unsigned long * ) V_81 -> V_86 ) ;
V_82:
F_16 ( V_81 -> V_39 ) ;
return 0 ;
}
static void F_30 ( const unsigned char * V_3 , T_1 V_4 )
{
T_1 V_91 ;
...
static int F_31 ( unsigned char * V_92 ,
T_4 V_4 ,
const struct V_72 * V_73 ,
T_2 * V_74 )
{
...
if ( V_94 == V_104 ) {
struct V_80 V_81 ;
unsigned char V_108 = F_29 ( & V_2 , & V_81 , V_73 , V_74 ) ;
if ( V_108 ) {
F_16 ( V_81 . V_39 ) ;
F_16 ( ( unsigned long * ) V_81 . V_86 ) ;
} else
...
struct V_114 * V_115 )
{
struct V_116 * V_117 = F_33 ( V_115 ) ;
struct V_118 * V_119 = (struct V_118 * ) ( ( V_120 * ) V_117 + V_117 -> V_121 ) ;
T_4 V_122 = F_34 ( V_119 -> V_4 ) ;
T_4 V_123 = V_122 - sizeof( struct V_118 ) ;
int V_124 = F_35 ( V_113 ) ;
struct V_72 V_73 ;
if ( V_124 == V_125 ) {
V_73 . V_75 = F_27 ( & V_111 -> V_126 [ V_124 ] . V_127 . V_128 . V_129 . V_130 ) ;
V_73 . V_78 = F_27 ( & V_111 -> V_126 [ ! V_124 ] . V_127 . V_131 . V_129 . V_130 ) ;
} else {
V_73 . V_75 = F_27 ( & V_111 -> V_126 [ V_124 ] . V_127 . V_128 . V_129 . V_130 ) ;
V_73 . V_78 = F_27 ( & V_111 -> V_126 [ ! V_124 ] . V_127 . V_131 . V_129 . V_130 ) ;
}
...
return V_132 ;
if ( ! F_31 ( ( unsigned char * ) V_119 + sizeof( struct V_118 ) ,
...
static int F_36 ( struct V_114 * V_115 , unsigned int V_135 ,
struct V_110 * V_111 ,
enum V_112 V_113 )
{
int V_124 = F_35 ( V_113 ) ;
unsigned int V_108 ;
const struct V_116 * V_117 = F_33 ( V_115 ) ;
const struct V_118 * V_119 = (struct V_118 * ) ( ( V_120 * ) V_117 + V_117 -> V_121 ) ;
if ( V_119 -> V_136 == F_37 ( V_137 ) && V_124 != V_138 )
return V_132 ;
if ( V_119 -> V_139 == F_37 ( V_140 ) && V_124 != V_125 )
return V_132 ;
if ( ! ( V_111 -> V_141 & V_142 ) )
return V_132 ;
if ( F_34 ( V_119 -> V_4 ) != V_115 -> V_4 - ( V_117 -> V_121 << 2 ) ) {
if ( F_14 () )
F_28 ( V_133 L_25 ,
& V_117 -> V_143 , & V_117 -> V_144 ) ;
return V_134 ;
}
if ( ! F_38 ( V_115 , V_115 -> V_4 ) )
return V_134 ;
F_39 ( & V_145 ) ;
V_108 = F_32 ( V_111 , V_113 , V_115 ) ;
F_40 ( & V_145 ) ;
return V_108 ;
}
