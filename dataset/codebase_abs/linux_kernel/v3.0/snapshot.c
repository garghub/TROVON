...
V_8 += F_25 ( V_8 * sizeof( struct V_27 ) , V_3 ) ;
return 2 * V_8 ;
}
...
static struct V_11 * F_76 ( struct V_46 * V_46 , unsigned long V_55 )
{
struct V_11 * V_11 ;
if ( ! F_62 ( V_55 ) )
return NULL ;
...
static inline void F_80 ( long * V_85 , long * V_86 )
{
int V_81 ;
for ( V_81 = V_3 / sizeof( long ) ; V_81 ; V_81 -- )
* V_85 ++ = * V_86 ++ ;
}
static void F_81 ( void * V_85 , struct V_11 * V_87 )
{
if ( F_77 ( V_87 ) ) {
F_80 ( V_85 , F_82 ( V_87 ) ) ;
} else {
...
F_84 ( struct V_46 * V_46 , unsigned long V_55 )
{
return F_67 ( V_46 ) ?
F_69 ( V_46 , V_55 ) : F_76 ( V_46 , V_55 ) ;
}
static void F_85 ( unsigned long V_88 , unsigned long V_89 )
{
...
static inline void F_85 ( unsigned long V_88 , unsigned long V_89 )
{
F_81 ( F_82 ( F_70 ( V_88 ) ) ,
F_70 ( V_89 ) ) ;
}
static void
F_89 ( struct V_31 * V_94 , struct V_31 * V_95 )
{
struct V_46 * V_46 ;
unsigned long V_55 ;
F_33 (zone) {
...
static unsigned long F_92 ( unsigned long V_101 , T_2 V_102 )
{
...
static unsigned long F_93 ( unsigned long V_101 ,
unsigned long V_104 )
{
unsigned long V_105 ;
if ( V_104 <= V_99 )
...
if ( V_101 < V_105 )
V_105 = V_101 ;
return F_92 ( V_105 , V_106 ) ;
}
static unsigned long F_94 ( unsigned long V_101 )
{
return F_92 ( V_101 , V_106 | V_107 ) ;
}
static unsigned long F_95 ( T_3 V_108 , T_3 V_109 , T_3 V_110 )
{
V_108 *= V_109 ;
F_96 ( V_108 , V_110 ) ;
return ( unsigned long ) V_108 ;
}
static unsigned long F_97 ( unsigned long V_101 ,
unsigned long V_111 ,
unsigned long V_112 )
{
unsigned long V_105 = F_95 ( V_101 , V_111 , V_112 ) ;
return F_92 ( V_105 , V_106 | V_107 ) ;
}
static inline unsigned long F_94 ( unsigned long V_101 )
{
return 0 ;
}
static inline unsigned long F_97 ( unsigned long V_101 ,
unsigned long V_111 ,
unsigned long V_112 )
{
return 0 ;
...
static unsigned long F_99 ( unsigned long V_116 )
{
unsigned long V_24 ;
V_24 = F_100 ( V_117 )
+ F_100 ( V_118 )
...
V_104 = 0 ;
if ( V_24 < V_38 )
V_24 = F_103 (unsigned long, pages, max_size) ;
F_104 ( V_116 - V_24 ) ;
V_126 = F_94 ( V_111 / 2 ) ;
V_105 = ( V_124 - V_123 ) - V_126 ;
V_38 = F_93 ( V_105 , V_104 ) ;
if ( V_38 < V_105 ) {
V_105 -= V_38 ;
V_38 += V_126 ;
V_126 = F_94 ( V_105 ) ;
...
V_105 = V_123 - V_24 ;
V_24 = F_97 ( V_105 , V_111 , V_124 ) ;
V_126 += V_24 ;
V_105 -= V_24 ;
V_24 = F_93 ( V_105 , V_104 ) ;
V_126 += F_94 ( V_105 - V_24 ) ;
V_38 += V_126 + V_24 ;
}
F_98 () ;
V_132:
...
static unsigned int F_106 ( unsigned int V_134 )
{
...
static unsigned int
F_106 ( unsigned int V_134 ) { return 0 ; }
static int F_107 ( unsigned int V_101 , unsigned int V_134 )
{
struct V_46 * V_46 ;
...
static inline int F_108 ( int V_7 )
{
V_93 = F_3 ( V_136 | V_137 , V_7 ) ;
return V_93 ? 0 : - V_42 ;
}
static inline unsigned int
F_109 ( struct V_31 * V_32 , unsigned int V_134 )
{
...
static inline int F_108 ( int V_7 ) { return 0 ; }
static inline unsigned int
F_109 ( struct V_31 * V_32 , unsigned int V_81 ) { return 0 ; }
static int
F_110 ( struct V_31 * V_95 , struct V_31 * V_94 ,
...
if ( ! F_107 ( V_101 , V_134 ) ) {
F_57 ( V_139 L_12 ) ;
return - V_42 ;
}
if ( F_110 ( & V_95 , & V_94 , V_101 , V_134 ) ) {
F_57 ( V_139 L_13 ) ;
return - V_42 ;
}
F_112 ( NULL ) ;
...
{
memcpy ( & V_141 -> V_142 , F_114 () , sizeof( struct V_143 ) ) ;
V_141 -> V_144 = V_145 ;
return 0 ;
}
static char * F_115 ( struct V_140 * V_141 )
{
if ( V_141 -> V_144 != V_145 )
return L_15 ;
if ( strcmp ( V_141 -> V_142 . V_146 , F_114 () -> V_146 ) )
return L_16 ;
if ( strcmp ( V_141 -> V_142 . V_147 , F_114 () -> V_147 ) )
return L_17 ;
if ( strcmp ( V_141 -> V_142 . V_148 , F_114 () -> V_148 ) )
return L_18 ;
if ( strcmp ( V_141 -> V_142 . V_149 , F_114 () -> V_149 ) )
return L_19 ;
return NULL ;
}
unsigned long F_116 ( void )
{
return V_96 + V_97 + 1 ;
}
static int F_117 ( struct V_140 * V_141 )
{
...
static inline void
F_118 ( unsigned long * V_152 , struct V_31 * V_32 )
{
int V_153 ;
for ( V_153 = 0 ; V_153 < V_3 / sizeof( long ) ; V_153 ++ ) {
V_152 [ V_153 ] = F_51 ( V_32 ) ;
if ( F_90 ( V_152 [ V_153 ] == V_62 ) )
break;
}
}
...
if ( F_72 ( V_11 ) ) {
void * V_156 ;
V_156 = F_86 ( V_11 , V_91 ) ;
F_88 ( V_93 , V_156 ) ;
F_87 ( V_156 , V_91 ) ;
V_155 -> V_93 = V_93 ;
} else {
V_155 -> V_93 = F_82 ( V_11 ) ;
}
}
V_155 -> V_33 ++ ;
return V_3 ;
...
static void
F_123 ( struct V_31 * V_85 , struct V_31 * V_86 )
{
unsigned long V_55 ;
F_22 ( V_86 ) ;
V_55 = F_51 ( V_86 ) ;
...
static int F_124 ( struct V_140 * V_141 )
{
char * V_157 ;
V_157 = F_115 ( V_141 ) ;
...
static int F_126 ( unsigned long * V_152 , struct V_31 * V_32 )
{
int V_153 ;
for ( V_153 = 0 ; V_153 < V_3 / sizeof( long ) ; V_153 ++ ) {
if ( F_90 ( V_152 [ V_153 ] == V_62 ) )
...
static unsigned int F_127 ( struct V_31 * V_32 )
{
unsigned long V_55 ;
unsigned int V_79 = 0 ;
F_22 ( V_32 ) ;
...
static int
F_128 ( struct V_31 * V_32 , unsigned int * V_159 )
{
unsigned int V_138 ;
...
static void *
F_129 ( struct V_11 * V_11 , struct V_19 * V_20 )
{
struct V_162 * V_163 ;
void * V_156 ;
if ( F_59 ( V_11 ) && F_5 ( V_11 ) ) {
...
if ( V_164 ) {
void * V_85 ;
V_85 = F_86 ( V_164 , V_91 ) ;
F_88 ( V_85 , V_93 ) ;
F_87 ( V_85 , V_91 ) ;
V_164 = NULL ;
}
}
static inline int F_132 ( void )
{
return ! V_164 ;
}
static inline void F_133 ( void )
{
if ( V_161 )
F_40 ( V_161 , V_58 ) ;
if ( V_93 )
...
static unsigned int
F_127 ( struct V_31 * V_32 ) { return 0 ; }
static inline int
F_128 ( struct V_31 * V_32 , unsigned int * V_159 )
{
return 0 ;
...
static inline int F_132 ( void ) { return 1 ; }
static inline void F_133 ( void ) {}
static int
F_135 ( struct V_31 * V_170 , struct V_31 * V_32 )
{
unsigned int V_101 , V_134 ;
...
static void * F_136 ( struct V_31 * V_32 , struct V_19 * V_20 )
{
struct V_163 * V_163 ;
struct V_11 * V_11 ;
...
error = F_126 ( V_93 , & V_94 ) ;
if ( error )
return error ;
if ( V_155 -> V_33 == V_97 + 1 ) {
error = F_135 ( & V_95 , & V_94 ) ;
if ( error )
return error ;
F_19 ( & V_20 , V_136 , V_10 ) ;
F_22 ( & V_95 ) ;
V_98 = NULL ;
V_155 -> V_93 = F_136 ( & V_95 , & V_20 ) ;
V_155 -> V_176 = 0 ;
if ( F_138 ( V_155 -> V_93 ) )
return F_139 ( V_155 -> V_93 ) ;
}
} else {
F_131 () ;
V_155 -> V_93 = F_136 ( & V_95 , & V_20 ) ;
...
static inline void
F_142 ( struct V_11 * V_177 , struct V_11 * V_178 , void * V_152 )
{
void * V_179 , * V_180 ;
V_179 = F_86 ( V_177 , V_91 ) ;
V_180 = F_86 ( V_178 , V_92 ) ;
F_88 ( V_152 , V_179 ) ;
F_88 ( V_179 , V_180 ) ;
F_88 ( V_180 , V_152 ) ;
F_87 ( V_180 , V_92 ) ;
...
return - V_42 ;
while ( V_163 ) {
F_142 ( V_163 -> F_88 , V_163 -> V_165 , V_152 ) ;
V_163 = V_163 -> V_18 ;
}
F_12 ( V_152 , V_58 ) ;
return 0 ;
