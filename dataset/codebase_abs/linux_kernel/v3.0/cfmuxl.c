...
F_15 ( V_21 -> V_35 [ V_30 ] , V_27 ) ;
F_8 ( & V_21 -> V_15 ) ;
}
return V_27 ;
}
static struct V_1 * F_19 ( struct V_2 * V_21 , struct V_36 * V_36 )
{
struct V_1 * V_19 ;
...
F_15 ( V_21 -> V_32 [ V_30 ] , V_19 ) ;
F_8 ( & V_21 -> V_14 ) ;
}
return V_19 ;
}
struct V_1 * F_20 ( struct V_1 * V_18 , T_1 V_25 )
{
struct V_1 * V_27 ;
struct V_2 * V_21 = F_12 ( V_18 ) ;
int V_30 = V_25 % V_34 ;
