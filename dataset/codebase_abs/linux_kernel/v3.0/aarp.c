...
static void F_14 ( struct V_6 * V_7 , struct V_17 * V_45 ,
...
static void F_19 ( struct V_1 * * V_50 , struct V_6 * V_7 )
{
struct V_1 * V_51 ;
while ( * V_50 )
if ( ( * V_50 ) -> V_7 == V_7 ) {
...
static void F_20 ( unsigned long V_55 )
{
int V_56 ;
F_21 ( & V_57 ) ;
...
static int F_24 ( struct V_66 * V_67 , unsigned long V_68 ,
void * V_69 )
{
struct V_6 * V_7 = V_69 ;
int V_56 ;
if ( ! F_25 ( F_26 ( V_7 ) , & V_70 ) )
return V_71 ;
if ( V_68 == V_72 ) {
F_21 ( & V_57 ) ;
for ( V_56 = 0 ; V_56 < V_58 ; V_56 ++ ) {
...
{
struct V_1 * V_2 = F_30 ( sizeof( * V_2 ) , V_16 ) ;
if ( V_2 )
F_31 ( & V_2 -> V_3 ) ;
return V_2 ;
}
static struct V_1 * F_32 ( struct V_1 * V_73 ,
struct V_6 * V_7 ,
struct V_17 * V_18 )
{
while ( V_73 ) {
...
void F_33 ( struct V_6 * V_7 , struct V_17 * V_74 )
{
int V_75 = V_74 -> V_35 % ( V_58 - 1 ) ;
struct V_1 * V_2 ;
F_21 ( & V_57 ) ;
V_2 = F_32 ( V_61 [ V_75 ] , V_7 , V_74 ) ;
if ( V_2 )
V_2 -> V_52 = V_44 - 1 ;
F_22 ( & V_57 ) ;
}
static struct V_17 * F_34 ( struct V_6 * V_7 ,
struct V_17 * V_74 )
{
int V_75 = V_74 -> V_35 % ( V_58 - 1 ) ;
struct V_1 * V_2 = F_32 ( V_61 [ V_75 ] , V_7 , V_74 ) ;
...
V_74 -> V_85 . V_33 = F_36 ( V_77 -> V_86 . V_33 ) ;
...
int F_39 ( struct V_76 * V_92 , struct V_17 * V_74 )
{
int V_75 , V_97 = - V_98 ;
struct V_1 * V_99 ;
unsigned int V_95 ;
...
int F_40 ( struct V_6 * V_7 , struct V_14 * V_15 ,
...
static int F_47 ( struct V_14 * V_15 , struct V_6 * V_7 ,
...
if ( V_7 -> type != V_116 )
goto V_137;
if ( ! F_41 ( V_15 , sizeof( * V_132 ) ) )
goto V_137;
V_27 = F_36 ( V_132 -> V_27 ) ;
...
if ( ! V_2 || V_7 != V_2 -> V_7 )
break;
memcpy ( V_2 -> V_104 , V_132 -> V_29 , V_5 ) ;
F_45 ( & V_60 [ V_75 ] , V_2 , V_75 ) ;
if ( ! V_63 )
F_23 ( & V_62 ,
V_44 + V_65 ) ;
break;
...
V_74 . V_35 = V_132 -> V_34 ;
V_74 . V_33 = V_132 -> V_32 ;
F_14 ( V_7 , V_134 , & V_74 , V_132 -> V_29 ) ;
break;
}
V_139:
F_22 ( & V_57 ) ;
...
static struct V_1 * F_56 ( struct V_144 * V_145 , T_3 * V_146 )
{
...
static void * F_57 ( struct V_151 * V_152 , T_3 * V_146 )
__acquires( V_57 )
{
...
V_145 -> V_148 = V_59 ;
V_145 -> V_147 = 0 ;
return * V_146 ? F_56 ( V_145 , V_146 ) : V_154 ;
}
static void * F_59 ( struct V_151 * V_152 , void * V_155 , T_3 * V_146 )
{
struct V_1 * V_99 = V_155 ;
struct V_144 * V_145 = V_152 -> V_153 ;
++ * V_146 ;
if ( V_155 == V_154 )
V_99 = F_56 ( V_145 , NULL ) ;
else if ( V_99 -> V_53 )
V_99 = V_99 -> V_53 ;
else {
++ V_145 -> V_147 ;
...
static void F_60 ( struct V_151 * V_152 , void * V_155 )
__releases( V_57 )
{
F_61 ( & V_57 ) ;
}
static const char * F_62 ( unsigned long V_156 )
{
static char V_157 [ 32 ] ;
sprintf ( V_157 , L_2 , V_156 / V_158 , ( ( V_156 % V_158 ) * 100 ) / V_158 ) ;
return V_157 ;
}
static int F_63 ( struct V_151 * V_152 , void * V_155 )
{
struct V_144 * V_145 = V_152 -> V_153 ;
struct V_1 * V_99 = V_155 ;
...
F_65 ( V_152 , L_7 , V_99 -> V_104 ) ;
F_65 ( V_152 , L_8 ,
F_62 ( ( long ) V_99 -> V_52 - ( long ) V_159 ) ) ;
if ( V_145 -> V_148 == V_60 )
F_65 ( V_152 , L_9 ,
F_62 ( V_159 - V_99 -> V_43 ) ,
V_99 -> V_42 ) ;
else
F_64 ( V_152 , L_10 ) ;
F_65 ( V_152 , L_11 ,
...
static int F_66 ( struct V_161 * V_161 , struct V_162 * V_162 )
{
return F_67 ( V_162 , & V_163 ,
sizeof( struct V_144 ) ) ;
}
void F_68 ( void )
{
