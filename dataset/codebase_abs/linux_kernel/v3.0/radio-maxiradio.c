...
return - V_32 ;
F_18 ( & V_11 -> V_33 ) ;
F_15 ( V_20 -> V_34 , L_7 , sizeof( V_20 -> V_34 ) ) ;
V_20 -> type = V_35 ;
V_20 -> V_36 = V_37 ;
V_20 -> V_38 = V_39 ;
V_20 -> V_40 = V_41 | V_42 ;
...
struct V_30 * V_20 )
{
return V_20 -> V_31 ? - V_32 : 0 ;
}
static int F_21 ( struct V_17 * V_48 , void * V_18 , unsigned int * V_49 )
{
* V_49 = 0 ;
return 0 ;
}
static int F_22 ( struct V_17 * V_48 , void * V_18 , unsigned int V_49 )
{
return V_49 ? - V_32 : 0 ;
}
...
{
V_51 -> V_31 = 0 ;
F_15 ( V_51 -> V_34 , L_8 , sizeof( V_51 -> V_34 ) ) ;
V_51 -> V_43 = V_52 ;
return 0 ;
}
...
struct V_50 * V_51 )
{
return V_51 -> V_31 ? - V_32 : 0 ;
}
static int F_25 ( struct V_17 * V_17 , void * V_18 ,
struct V_53 * V_54 )
{
struct V_1 * V_11 = F_14 ( V_17 ) ;
if ( V_54 -> V_55 != 0 || V_54 -> type != V_35 )
return - V_32 ;
if ( V_54 -> V_56 < V_37 || V_54 -> V_56 > V_39 ) {
F_7 ( V_11 , 1 , L_9 ,
V_54 -> V_56 / 16000 ,
V_54 -> V_56 % 16000 * 100 / 16000 ,
V_37 / 16000 , V_39 / 16000 ) ;
return - V_32 ;
}
F_18 ( & V_11 -> V_33 ) ;
V_11 -> V_13 = V_54 -> V_56 ;
...
static int T_3 F_32 ( struct V_65 * V_24 , const struct V_66 * V_67 )
{
struct V_1 * V_11 ;
struct V_2 * V_3 ;
int V_68 = - V_69 ;
V_11 = F_33 ( sizeof( * V_11 ) , V_70 ) ;
if ( V_11 == NULL ) {
F_34 ( & V_24 -> V_11 , L_11 ) ;
return - V_69 ;
}
...
V_11 -> V_64 = 1 ;
V_11 -> V_13 = V_37 ;
F_15 ( V_3 -> V_34 , L_12 , sizeof( V_3 -> V_34 ) ) ;
V_68 = F_36 ( & V_24 -> V_11 , V_3 ) ;
if ( V_68 < 0 ) {
F_37 ( V_3 , L_13 ) ;
goto V_71;
}
...
F_15 ( V_11 -> V_74 . V_34 , V_3 -> V_34 , sizeof( V_11 -> V_74 . V_34 ) ) ;
V_11 -> V_74 . V_3 = V_3 ;
V_11 -> V_74 . V_75 = & V_76 ;
V_11 -> V_74 . V_77 = & V_78 ;
V_11 -> V_74 . V_79 = V_80 ;
F_42 ( & V_11 -> V_74 , V_11 ) ;
if ( F_43 ( & V_11 -> V_74 , V_81 , V_82 ) < 0 ) {
F_37 ( V_3 , L_16 ) ;
goto V_73;
}
F_44 ( V_3 , L_17 V_83 L_18 ) ;
F_44 ( V_3 , L_19 ,
V_11 -> V_5 ) ;
return 0 ;
V_73:
...
static void T_4 F_48 ( struct V_65 * V_24 )
{
