...
int F_45 ( struct V_19 * V_20 , struct V_23 * V_59 ,
struct V_66 * V_67 )
{
struct V_23 * V_24 ;
int V_16 = - 1 ;
...
V_118 -> V_123 = 0 ;
V_118 -> V_124 = 0 ;
V_31 = F_11 ( V_20 , V_125 ) ;
if ( V_31 == NULL )
goto V_34;
if ( F_53 ( V_20 , V_24 , V_15 , V_77 ) < 0 )
goto V_34;
F_14 ( V_20 , V_31 ) ;
V_120 -> V_126 = F_51 ( V_20 ) - V_79 ;
return V_20 -> V_127 ;
V_34:
V_128:
F_13 ( V_20 , V_79 ) ;
...
if ( V_24 -> V_39 == NULL )
goto V_90;
V_120 = F_84 ( V_20 , V_113 , V_130 -> V_133 , V_45 , sizeof( * V_118 ) ) ;
V_118 = F_72 ( V_120 ) ;
V_118 -> V_121 = V_122 ;
V_118 -> V_123 = 0 ;
V_118 -> V_124 = 0 ;
...
if ( V_31 == NULL )
goto V_34;
V_25 = V_24 -> V_39 -> V_137 ( V_20 , & V_136 , V_45 , V_24 ) ;
if ( V_25 < 0 )
goto V_34;
if ( V_25 == 0 )
goto V_138;
...
F_19 ( V_24 -> V_39 -> V_42 ) ;
F_33 ( V_24 ) ;
V_25 = F_85 ( V_20 , V_129 , V_113 , V_141 ,
V_130 -> V_139 & V_142 ) ;
if ( V_25 > 0 )
return 0 ;
return V_25 ;
...
static int
F_86 ( struct V_129 * V_129 , struct V_30 * V_82 , struct V_119 * V_130 ,
T_1 V_113 , int V_116 )
{
int V_27 , V_16 ;
struct V_30 * V_88 [ V_36 + 1 ] ;
...
if ( V_16 < 0 )
return V_16 ;
if ( V_116 == V_45 && V_130 -> V_139 & V_140 ) {
if ( V_88 [ 1 ] != NULL )
...
F_49 ( V_98 , 0 ) ;
V_16 = F_85 ( V_20 , V_129 , V_113 , V_141 ,
V_130 -> V_139 & V_142 ) ;
if ( V_16 > 0 )
return 0 ;
return V_16 ;
...
static int F_88 ( struct V_129 * V_129 , struct V_23 * V_24 ,
...
F_14 ( V_20 , V_31 ) ;
V_120 -> V_126 = F_51 ( V_20 ) - V_79 ;
F_89 ( V_20 ) . V_143 = V_141 ;
V_25 = F_85 ( V_20 , V_129 , V_113 , V_141 , V_115 & V_142 ) ;
if ( V_25 > 0 )
V_25 = 0 ;
return V_25 ;
V_34:
...
static int
F_90 ( struct V_129 * V_129 , struct V_30 * V_82 , struct V_119 * V_130 ,
T_1 V_113 , int V_84 )
{
int V_16 = 0 ;
struct V_23 * V_59 ;
...
V_16 = F_88 ( V_129 , V_59 , V_113 , V_114 , V_144 , V_130 -> V_139 ) ;
for ( V_24 = V_59 ; V_24 ; V_24 = V_59 ) {
V_59 = V_24 -> V_63 ;
F_33 ( V_24 ) ;
}
...
static int F_91 ( struct V_19 * V_20 , struct V_119 * V_130 , void * V_145 )
{
struct V_129 * V_129 = F_92 ( V_20 -> V_146 ) ;
struct V_30 * V_147 [ V_89 + 1 ] ;
T_1 V_113 = V_20 ? F_89 ( V_20 ) . V_113 : 0 ;
int V_16 = 0 , V_84 = 0 ;
V_16 = F_93 ( V_130 , sizeof( struct V_117 ) , V_147 , V_89 , NULL ) ;
if ( V_16 < 0 )
return V_16 ;
if ( V_147 [ V_125 ] == NULL ) {
F_94 ( L_7 ) ;
...
switch ( V_130 -> V_148 ) {
case V_144 :
if ( V_130 -> V_139 & V_149 )
V_84 = 1 ;
V_150:
V_16 = F_90 ( V_129 , V_147 [ V_125 ] , V_130 , V_113 , V_84 ) ;
if ( V_16 == - V_92 )
goto V_150;
break;
case V_45 :
V_16 = F_86 ( V_129 , V_147 [ V_125 ] , V_130 ,
V_113 , V_45 ) ;
break;
case V_46 :
V_16 = F_86 ( V_129 , V_147 [ V_125 ] , V_130 ,
...
{
struct V_30 * V_151 , * V_152 [ V_89 + 1 ] ;
struct V_30 * V_88 [ V_36 + 1 ] ;
struct V_30 * V_82 [ V_153 + 1 ] ;
struct V_30 * V_40 ;
if ( F_93 ( V_130 , sizeof( struct V_117 ) , V_82 , V_153 , NULL ) < 0 )
return NULL ;
V_151 = V_82 [ V_125 ] ;
if ( V_151 == NULL )
return NULL ;
if ( F_97 ( V_88 , V_36 , F_98 ( V_151 ) ,
F_99 ( F_78 ( V_151 ) ) , NULL ) < 0 )
return NULL ;
if ( V_88 [ 1 ] == NULL )
return NULL ;
if ( F_97 ( V_152 , V_89 , F_98 ( V_88 [ 1 ] ) ,
F_78 ( V_88 [ 1 ] ) , NULL ) < 0 )
return NULL ;
V_40 = V_152 [ V_91 ] ;
return V_40 ;
...
V_120 = F_84 ( V_20 , F_89 ( V_22 -> V_20 ) . V_113 , V_22 -> V_120 -> V_133 ,
V_22 -> V_120 -> V_148 , sizeof( * V_118 ) ) ;
V_118 = F_72 ( V_120 ) ;
V_118 -> V_121 = V_122 ;
V_118 -> V_123 = 0 ;
V_118 -> V_124 = 0 ;
...
if ( V_31 == NULL )
goto V_34;
V_16 = V_85 -> V_137 ( V_20 , V_22 , V_46 , & V_24 ) ;
if ( V_16 < 0 )
goto V_34;
if ( V_16 > 0 ) {
F_14 ( V_20 , V_31 ) ;
...
{
F_103 ( V_155 , V_144 , F_91 , NULL ) ;
F_103 ( V_155 , V_45 , F_91 , NULL ) ;
F_103 ( V_155 , V_46 , F_91 , F_100 ) ;
return 0 ;
}
