...
V_7 -> V_6 . V_18 . V_23 = & V_24 ;
F_21 ( & V_7 -> V_6 . V_18 , ( void * ) & ( V_7 -> V_6 ) ) ;
return & V_7 -> V_6 ;
}
...
static int F_23 ( struct V_9 * V_10 , T_1 V_25 )
{
if ( V_10 -> V_3 != V_25 ) {
V_10 -> V_3 = V_25 ;
if ( V_10 -> V_26 -> V_27 )
...
static int F_25 ( struct V_9 * V_10 , int V_4 )
{
if ( V_10 -> V_4 != V_4 ) {
V_10 -> V_4 = V_4 ;
if ( V_10 -> V_26 -> V_27 )
...
int V_11 ;
struct V_1 * V_7 = F_5 ( V_10 ) ;
T_2 * V_30 = F_29 ( V_10 -> V_3 , V_8 ) ;
memcpy ( V_30 , V_28 , V_10 -> V_3 - sizeof( V_29 ) ) ;
memcpy ( V_30 + V_10 -> V_3 - sizeof( V_29 ) ,
& V_29 , sizeof( V_29 ) ) ;
V_11 = F_30 ( & V_7 -> V_7 , V_28 , V_10 -> V_3 ) ;
if ( V_11 != V_10 -> V_3 ) {
F_16 ( V_30 ) ;
return - V_31 ;
}
...
T_1 V_32 , char T_4 * V_2 )
{
int V_11 , V_33 ;
struct V_1 * V_7 = F_5 ( V_10 ) ;
V_11 = F_32 ( & V_7 -> V_7 , V_2 , V_10 -> V_3 * V_32 , & V_33 ) ;
return V_33 ;
}
