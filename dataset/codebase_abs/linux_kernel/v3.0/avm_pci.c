...
if ( ( V_2 -> V_24 & V_25 ) && ! ( V_2 -> V_24 & V_47 ) )
F_19 ( V_2 , L_7 , V_43 , V_21 -> V_57 -> V_58 ) ;
V_45 = V_21 -> V_57 -> V_13 ;
V_44 = ( T_2 * ) V_45 ;
F_27 ( V_21 -> V_57 , V_43 ) ;
V_21 -> V_60 -= V_43 ;
...
struct V_62 * V_63 ;
if ( V_21 -> V_2 -> V_24 & V_25 )
F_19 ( V_21 -> V_2 , L_9 , V_21 -> V_20 , V_61 ) ;
if ( V_61 & V_64 ) {
if ( V_61 & V_65 ) {
if ( V_21 -> V_2 -> V_24 & V_25 )
F_19 ( V_21 -> V_2 , L_10 ) ;
...
memcpy ( F_32 ( V_63 , V_21 -> V_8 . V_26 . V_48 ) ,
V_21 -> V_8 . V_26 . V_51 , V_21 -> V_8 . V_26 . V_48 ) ;
F_33 ( & V_21 -> V_71 , V_63 ) ;
}
V_21 -> V_8 . V_26 . V_48 = 0 ;
F_21 ( V_21 , V_72 ) ;
...
F_19 ( V_21 -> V_2 , L_13 , V_21 -> V_20 , V_61 ) ;
V_21 -> V_8 . V_26 . V_48 = 0 ;
}
}
}
...
F_59 ( 10 ) ;
F_31 ( V_125 L_22 , F_3 ( V_2 -> V_8 . V_9 . V_10 + 3 ) ) ;
}
static int
...
F_31 ( V_125 L_28 , V_7 , V_138 ) ;
V_2 -> V_139 = & F_13 ;
V_2 -> V_140 = & F_14 ;
break;
default:
F_31 ( V_70 L_29 , V_2 -> V_28 ) ;
return ( 0 ) ;
}
F_31 ( V_125 L_30 ,
( V_2 -> V_28 == V_29 ) ? L_31 : L_32 ,
...
F_67 ( V_2 , ( V_2 -> V_28 == V_29 ) ? L_33 : L_34 ) ;
return ( 1 ) ;
}
static int T_5 F_68 ( struct V_1 * V_2 )
{
return ( 1 ) ;
}
static int T_5 F_68 ( struct V_1 * V_2 )
...
static int T_5 F_78 ( struct V_1 * V_2 )
{
return ( 1 ) ;
}
static int T_5 F_78 ( struct V_1 * V_2 )
...
int T_5
F_82 ( struct V_158 * V_159 )
{
struct V_1 * V_2 = V_159 -> V_2 ;
char V_160 [ 64 ] ;
int V_161 ;
strcpy ( V_160 , V_162 ) ;
F_31 ( V_125 L_41 , F_83 ( V_160 ) ) ;
if ( V_2 -> V_163 != V_164 )
return ( 0 ) ;
if ( V_159 -> V_165 [ 1 ] ) {
