...
F_8 ( L_4 , V_7 , V_2 -> V_5 , V_2 -> V_10 . V_11 ) ;
for ( V_4 = 0 ; V_4 < F_9 ( V_12 ) ; V_4 ++ ) {
if ( V_12 [ V_4 ] . V_13 != V_2 -> V_5 )
continue;
if ( F_2 ( F_10 ( V_12 [ V_4 ] . V_14 ) , V_12 [ V_4 ] . V_15 ) < 0 ) {
F_3 ( L_2 ,
V_7 , V_2 -> V_5 , F_10 ( V_12 [ V_4 ] . V_14 ) ) ;
V_3 = - V_8 ;
goto error;
}
if ( F_4 ( F_10 ( V_12 [ V_4 ] . V_14 ) ) < 0 ) {
F_3 ( L_3 ,
V_7 , V_2 -> V_5 , F_10 ( V_12 [ V_4 ] . V_14 ) ) ;
V_3 = - V_9 ;
goto error;
...
return F_11 ( V_2 , V_12 , F_9 ( V_12 ) ) ;
error:
for (; V_4 >= 0 ; V_4 -- ) {
F_5 ( F_10 ( V_12 [ V_4 ] . V_14 ) ) ;
}
return ( V_3 ) ;
}
...
switch ( V_2 -> V_5 ) {
case 0 :
V_17 -> V_23 = F_15 ( V_24 ) ? 0 : 1 ;
V_17 -> V_25 = F_15 ( V_6 ) ? 1 : 0 ;
