...
V_38 = F_10 ( V_34 -> V_59 ) ;
V_9 -> V_10 -> V_60 = V_37 ;
V_9 -> V_10 -> V_61 = V_39 = V_37 + V_38 ;
F_11 ( & V_9 -> V_10 -> V_55 ) ;
V_41 = F_12 ( V_32 , V_37 , V_38 ,
V_42 | V_62 , V_45 ,
F_9 ( V_34 -> V_63 ) ) ;
F_13 ( & V_9 -> V_10 -> V_55 ) ;
if ( V_41 < 0 && V_41 > - 1024 )
goto V_57;
V_40 = V_39 + F_10 ( V_34 -> V_64 ) ;
V_9 -> V_10 -> V_65 = V_9 -> V_10 -> V_66 = V_40 ;
F_11 ( & V_9 -> V_10 -> V_55 ) ;
V_41 = F_12 ( NULL , V_39 , V_40 - V_39 ,
V_42 | V_62 , V_46 | V_47 , 0 ) ;
F_13 ( & V_9 -> V_10 -> V_55 ) ;
if ( V_41 > 0 || V_41 < - 1024 )
V_41 = 0 ;
V_57:
...
static int
F_14 ( struct V_1 * V_2 , struct V_67 * V_68 )
{
int V_41 ;
unsigned int V_69 ;
unsigned long V_70 ;
...
V_9 -> V_79 = V_80 ;
F_18 ( V_2 ) ;
V_9 -> V_81 . V_82 = 0xc0000000 ;
V_9 -> V_81 . V_83 = 0x80000000 ;
...
static int F_25 ( struct V_32 * V_89 )
{
return - V_24 ;
}
