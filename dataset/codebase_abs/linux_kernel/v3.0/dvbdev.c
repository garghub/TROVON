...
static int F_47 ( struct V_39 * V_32 , struct V_79 * V_80 )
{
struct V_3 * V_4 = F_48 ( V_32 ) ;
F_49 ( V_80 , L_6 , V_4 -> V_47 -> V_54 ) ;
F_49 ( V_80 , L_7 , V_57 [ V_4 -> type ] ) ;
F_49 ( V_80 , L_8 , V_4 -> V_30 ) ;
return 0 ;
}
static char * F_50 ( struct V_39 * V_32 , T_2 * V_81 )
{
struct V_3 * V_4 = F_48 ( V_32 ) ;
...
if ( ( V_82 = F_53 ( V_32 , V_53 , L_10 ) ) != 0 ) {
F_16 ( V_43 L_11 , V_56 ) ;
return V_82 ;
}
F_54 ( & V_83 , & V_84 ) ;
if ( ( V_82 = F_55 ( & V_83 , V_32 , V_53 ) ) != 0 ) {
F_16 ( V_43 L_12 ) ;
goto error;
}
V_55 = F_56 ( V_85 , L_13 ) ;
