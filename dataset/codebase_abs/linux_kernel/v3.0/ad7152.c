...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_6 , V_2 -> V_24 ) ;
}
...
V_2 -> V_24 = V_17 [ V_15 ] . V_18 ;
V_25 |= 0x18 | V_17 [ V_15 ] . V_27 ;
F_5 ( V_2 , V_26 , V_25 ) ;
return V_5 ;
}
F_3 ( V_9 , L_7 ) ;
...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_5 , V_2 -> V_29 ) ;
}
...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_5 , V_2 -> V_32 ) ;
}
...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_5 , V_2 -> V_35 ) ;
}
...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_5 , V_2 -> V_38 ) ;
}
...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_8 , V_2 -> V_41 ) ;
}
...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_8 , V_2 -> V_43 ) ;
}
...
struct V_19 * V_20 = F_8 ( V_9 ) ;
struct V_1 * V_2 = V_20 -> V_21 ;
return sprintf ( V_14 , L_8 , V_2 -> V_45 ) ;
}
...
{
int V_8 = 0 ;
struct V_1 * V_2 = F_28 ( sizeof( * V_2 ) , V_49 ) ;
if ( V_2 == NULL ) {
V_8 = - V_50 ;
goto V_51;
}
...
V_2 -> V_52 -> V_18 = V_48 -> V_18 ;
V_2 -> V_52 -> V_9 . V_54 = & V_7 -> V_9 ;
V_2 -> V_52 -> V_55 = & V_56 ;
...
static T_6 int F_37 ( void )
{
return F_38 ( & V_60 ) ;
}
static T_7 void F_39 ( void )
{
F_40 ( & V_60 ) ;
}
