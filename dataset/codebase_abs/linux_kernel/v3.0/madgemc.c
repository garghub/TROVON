...
L_5 ) ) {
F_12 ( V_31 L_6 , V_13 -> V_32 , V_2 -> V_22 ) ;
V_2 -> V_22 += V_33 ;
V_4 = - V_15 ;
goto V_29;
}
...
F_18 ( V_2 , V_11 ) ;
if ( V_11 -> V_39 != 0x4d ) {
F_12 ( V_31 L_7 , V_2 -> V_28 , V_11 -> V_39 ) ;
goto V_40;
}
if ( ( V_11 -> V_41 != 0x08 ) && ( V_11 -> V_41 != 0x0d ) ) {
F_12 ( V_31 L_8 , V_2 -> V_28 , V_11 -> V_41 ) ;
V_4 = - V_42 ;
goto V_40;
}
...
F_12 ( L_17 , V_2 -> V_28 ) ;
switch( V_11 -> V_35 ) {
case 0 : F_12 ( L_18 ) ; break;
case 1 : F_12 ( L_19 ) ; break;
case 2 : F_12 ( L_20 ) ; break;
case 3 : F_12 ( L_21 ) ; break;
}
F_12 ( L_22 , ( V_11 -> V_36 ) ? L_23 : L_24 ) ;
...
int V_96 = 0 ;
V_96 += sprintf ( V_93 + V_96 , L_29 ) ;
if ( V_95 ) {
V_96 += sprintf ( V_93 + V_96 , L_30 , V_95 -> V_43 ) ;
V_96 += sprintf ( V_93 + V_96 , L_31 , V_95 -> V_44 ) ;
V_96 += sprintf ( V_93 + V_96 , L_32 , ( V_95 -> V_38 ) ? L_14 : L_15 ) ;
V_96 += sprintf ( V_93 + V_96 , L_33 , ( V_95 -> V_37 ) ? 16 : 4 ) ;
V_96 += sprintf ( V_93 + V_96 , L_34 , ( V_9 -> V_59 == V_60 ) ? 16 : 4 ) ;
V_96 += sprintf ( V_93 + V_96 , L_35 , V_2 -> V_28 ) ;
V_96 += sprintf ( V_93 + V_96 , L_36 , V_2 -> V_22 ) ;
V_96 += sprintf ( V_93 + V_96 , L_37 , V_2 -> V_27 ) ;
V_96 += sprintf ( V_93 + V_96 , L_38 , V_95 -> V_34 ) ;
V_96 += sprintf ( V_93 + V_96 , L_39 ) ;
switch( V_95 -> V_35 ) {
case 0 : V_96 += sprintf ( V_93 + V_96 , L_18 ) ; break;
case 1 : V_96 += sprintf ( V_93 + V_96 , L_19 ) ; break;
case 2 : V_96 += sprintf ( V_93 + V_96 , L_20 ) ; break;
case 3 : V_96 += sprintf ( V_93 + V_96 , L_21 ) ; break;
}
V_96 += sprintf ( V_93 + V_96 , L_22 , ( V_95 -> V_36 ) ? L_23 : L_24 ) ;
V_96 += sprintf ( V_93 + V_96 , L_40 ,
V_2 -> V_51 ) ;
} else
V_96 += sprintf ( V_93 + V_96 , L_41 ) ;
return V_96 ;
}
