...
for ( V_15 = 0 ; V_15 < V_174 -> V_180 ; V_15 ++ , V_28 -> V_74 . V_75 ++ ) {
...
F_18 ( & V_8 -> V_3 . V_197 , & V_28 -> V_74 . V_193 ) ;
if ( V_174 -> V_198 == V_199 )
V_8 -> V_148 = 7 - V_15 ;
else
V_8 -> V_148 = V_15 ;
V_8 -> V_200 = & F_101 ( V_28 ) -> V_201 [ V_15 ] ;
F_102 ( & V_8 -> V_17 ) ;
V_8 -> V_30 = 1 << V_15 ;
F_76 ( & V_8 -> V_9 ) ;
F_76 ( & V_8 -> V_54 ) ;
...
F_34 ( V_28 , V_77 . V_84 , V_28 -> V_78 ) ;
F_34 ( V_28 , V_77 . ERROR , V_28 -> V_78 ) ;
F_103 ( V_202 , V_28 -> V_74 . V_203 ) ;
F_103 ( V_204 , V_28 -> V_74 . V_203 ) ;
if ( V_174 -> V_205 )
F_103 ( V_206 , V_28 -> V_74 . V_203 ) ;
V_28 -> V_74 . V_4 = & V_172 -> V_4 ;
V_28 -> V_74 . V_207 = F_71 ;
V_28 -> V_74 . V_208 = F_79 ;
V_28 -> V_74 . V_209 = F_55 ;
V_28 -> V_74 . V_210 = F_61 ;
V_28 -> V_74 . V_211 = F_66 ;
V_28 -> V_74 . V_212 = F_67 ;
V_28 -> V_74 . V_213 = F_70 ;
F_38 ( V_28 , V_169 , V_170 ) ;
F_104 ( V_214 L_43 ,
F_105 ( & V_172 -> V_4 ) , V_28 -> V_74 . V_75 ) ;
F_106 ( & V_28 -> V_74 ) ;
return 0 ;
V_192:
F_107 ( V_28 -> V_190 ) ;
