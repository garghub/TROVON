...
static int F_77 ( struct V_32 * V_33 , struct V_86 * V_87 )
{
struct V_1 * V_9 ;
int V_68 , V_11 = 0 ;
unsigned long V_10 ;
...
static void F_78 ( struct V_32 * V_33 , struct V_86 * V_87 )
{
struct V_1 * V_9 ;
unsigned long V_10 ;
int V_37 = V_92 ;
...
{
int V_63 ;
V_56 = F_87 ( V_101 * sizeof( V_57 ) , V_69 ) ;
if ( ! V_56 )
return - V_81 ;
V_57 = V_101 ;
for ( V_63 = 0 ; V_63 < V_57 ; V_63 ++ )
...
F_100 ( L_43 ) ;
V_68 = F_101 ( & ( V_124 . V_125 ) , & V_126 ) ;
if ( V_68 )
F_102 ( V_64 L_44 , V_68 ) ;
return 0 ;
}
