...
char * V_56 ;
V_31 = F_21 ( 65536 , V_57 ) ;
if ( ! V_31 )
return - V_58 ;
if ( V_52 == 0 )
V_55 [ V_52 ++ ] = V_59 ;
for ( V_50 = 0 ; V_50 < V_52 ; V_50 ++ ) {
V_53 [ V_50 ] [ 0 ] . V_21 . V_45 . V_54 = V_60 ;
V_53 [ V_50 ] [ 1 ] . V_21 . V_45 . V_54 = V_61 ;
for ( V_51 = 0 ; V_51 < 2 ; V_51 ++ ) {
...
V_56 = & V_69 [ V_50 ] [ V_51 ] [ 0 ] ;
if ( V_55 [ V_50 ] == V_59 )
sprintf ( V_56 , L_6 ) ;
else
sprintf ( V_56 , L_7 , V_55 [ V_50 ] ) ;
V_53 [ V_50 ] [ V_51 ] . V_70 = V_56 ;
F_8 ( L_8
L_5 ,
V_53 [ V_50 ] [ V_51 ] . V_21 . V_45 . V_54 , V_55 [ V_50 ] ) ;
