...
V_1 -> V_12 = F_33 ( V_80 , 0 ) ;
if ( V_1 -> V_12 < 0 ) {
F_34 ( V_33 , L_2 ) ;
V_20 = V_1 -> V_12 ;
goto V_86;
}
V_82 = F_35 ( V_80 , V_87 , 0 ) ;
if ( ! V_82 ) {
F_34 ( V_33 , L_3 ) ;
V_20 = - V_53 ;
goto V_86;
...
V_1 -> V_4 = F_38 ( V_1 -> V_88 , V_1 -> V_90 ) ;
if ( ! V_1 -> V_4 ) {
F_34 ( V_33 , L_5 ) ;
V_20 = - V_85 ;
goto V_93;
...
F_39 ( V_80 , V_1 ) ;
V_1 -> V_30 = F_40 ( V_80 -> V_91 , & V_80 -> V_33 ,
& V_94 , V_95 ) ;
if ( F_41 ( V_1 -> V_30 ) ) {
F_34 ( V_33 , L_6 ,
F_42 ( V_1 -> V_30 ) ) ;
...
F_46 ( V_1 -> V_4 ) ;
V_93:
F_47 ( V_1 -> V_88 , V_1 -> V_90 ) ;
V_86:
F_48 ( V_1 ) ;
return V_20 ;
}
static int T_6 F_49 ( struct V_79 * V_80 )
{
struct V_1 * V_1 = F_50 ( V_80 ) ;
F_44 ( & V_80 -> V_33 , 0 ) ;
F_1 ( V_1 , 0 , V_97 ) ;
F_51 ( V_1 -> V_12 , V_1 ) ;
F_45 ( V_1 -> V_30 ) ;
