...
F_23 ( L_7 , F_56 ( & ( F_15 ( V_2 , V_149 , 0 ) -> V_36 ) ) ) ;
F_23 ( V_150 L_8 ) ;
F_23 ( V_23 L_9
L_10 ,
...
F_23 ( L_7 , F_56 ( & ( F_15 ( V_2 , V_149 , 1 ) -> V_36 ) ) ) ;
F_23 ( L_8 ) ;
F_23 ( V_23 L_11
L_12 ,
...
F_3 ( F_21 ( V_2 ) + V_155 , V_4 ) ) ;
F_23 ( V_23 L_13 , F_3 ( V_7 , V_4 ) ,
F_3 ( V_9 , V_4 ) , F_3 ( V_156 , V_4 ) ) ;
#ifndef F_16
F_27 ( V_4 , V_57 ) ;
#endif
}
static T_8 F_72 ( struct V_53 * V_54 , struct V_1 * V_3 )
{
T_1 * V_2 = F_8 ( V_3 ) ;
T_2 * V_4 = F_11 ( V_2 ) ;
V_18 T_5 * V_12 ;
...
F_27 ( V_4 , V_57 ) ;
if ( V_35 > V_56 ) {
F_75 ( F_18 ( V_4 ) + V_55 , V_54 -> V_59 , V_56 ) ;
F_27 ( V_4 , V_57 + 1 ) ;
F_75 ( F_18 ( V_4 ) , V_54 -> V_59 + V_56 , V_35 - V_56 ) ;
} else
F_75 ( F_18 ( V_4 ) + V_55 , V_54 -> V_59 , V_35 ) ;
#ifndef F_16
F_27 ( V_4 , 0 ) ;
#endif
F_30 ( V_35 , & V_12 -> V_35 ) ;
F_32 ( V_157 , & V_12 -> V_36 ) ;
...
static T_6 T_9 F_78 ( T_2 * V_4 , T_3 T_5 * V_159 ,
T_6 V_160 )
{
T_6 V_25 = V_160 &= ~ 3 ;
T_6 V_161 = F_47 ( V_4 ) ;
F_27 ( V_4 , ( V_25 - 4 ) / V_161 ) ;
do {
V_25 -= 4 ;
if ( ( V_25 + 4 ) % V_161 == 0 )
F_27 ( V_4 , V_25 / V_161 ) ;
F_31 ( V_25 ^ 0x12345678 , V_159 + V_25 % V_161 ) ;
} while ( V_25 > 0 );
for ( V_25 = 0 ; V_25 < V_160 ; V_25 += 4 ) {
if ( V_25 % V_161 == 0 )
F_27 ( V_4 , V_25 / V_161 ) ;
if ( F_79 ( V_159 + V_25 % V_161 ) != ( V_25 ^ 0x12345678 ) )
break;
}
return V_25 ;
}
static void T_9 F_80 ( T_2 * V_4 , int V_162 )
{
F_33 ( V_162 , V_163 , V_4 ) ;
F_33 ( V_162 , V_164 , V_4 ) ;
F_33 ( V_162 , V_165 , V_4 ) ;
F_33 ( 0 , V_166 , V_4 ) ;
F_33 ( 0x03 , V_167 , V_4 ) ;
F_33 ( 0 , F_35 ( 0 ) , V_4 ) ;
F_33 ( 0 , F_7 ( 0 ) , V_4 ) ;
