...
{
struct V_141 * V_141 = V_2 -> V_141 ;
if ( V_141 -> V_157 ( V_141 , V_167 ) )
return 0 ;
V_141 -> V_162 ( V_141 , V_167 ) ;
return 0 ;
}
static int F_34 ( struct V_1 * V_2 , unsigned char V_168 , int type )
{
struct V_169 * V_169 = V_2 -> V_34 [ V_170 ] ;
if ( V_168 )
V_169 -> V_171 ( V_169 , V_2 -> V_144 [ type ] ) ;
else
V_169 -> V_172 ( V_169 , V_2 -> V_144 [ type ] ) ;
V_169 -> V_99 ( V_169 ) ;
return 0 ;
}
static int
F_35 ( struct V_1 * V_2 , unsigned int * V_147 , int type )
{
struct V_143 * V_143 = F_28 ( V_2 -> V_144 [ type ] , struct V_143 , V_146 ) ;
return V_143 -> V_58 -> V_152 ( V_143 , V_147 ) ;
}
static int
F_36 ( struct V_1 * V_2 , unsigned int V_147 , int type )
{
struct V_143 * V_143 = F_28 ( V_2 -> V_144 [ type ] , struct V_143 , V_146 ) ;
V_143 -> V_58 -> V_154 ( V_143 , V_147 ) ;
V_143 -> V_58 -> V_99 ( V_143 ) ;
...
static int F_37 ( struct V_1 * V_2 , unsigned char V_168 )
{
return F_34 ( V_2 , V_168 , V_173 ) ;
}
static int F_38 ( struct V_1 * V_2 , unsigned char V_168 )
{
return F_34 ( V_2 , V_168 , V_174 ) ;
}
static int F_39 ( struct V_1 * V_2 , unsigned char V_168 )
{
return F_34 ( V_2 , V_168 , V_175 ) ;
}
static int F_40 ( struct V_1 * V_2 , unsigned char V_168 )
{
return F_34 ( V_2 , V_168 , V_176 ) ;
}
static int F_41 ( struct V_1 * V_2 , unsigned char V_168 )
{
return F_34 ( V_2 , V_168 , V_177 ) ;
}
static int F_42 ( struct V_1 * V_2 , unsigned char V_168 )
{
return F_34 ( V_2 , V_168 , V_145 ) ;
}
static int F_43 ( struct V_1 * V_2 , unsigned char V_168 )
{
return F_34 ( V_2 , V_168 , V_178 ) ;
}
static int F_44 ( struct V_1 * V_2 , unsigned int * V_147 )
{
return F_35 ( V_2 , V_147 , V_145 ) ;
}
static int F_45 ( struct V_1 * V_2 , unsigned int V_147 )
{
return F_36 ( V_2 , V_147 , V_145 ) ;
}
static int F_46 ( struct V_1 * V_2 , unsigned char V_168 )
{
struct V_179 V_180 = { 0 } ;
struct V_143 * V_143 ;
int V_44 ;
struct V_121 * V_122 = V_2 -> V_122 ;
struct V_71 * V_181 [ 2 ] = { NULL } ;
unsigned int V_182 = 0 ;
F_11 ( & V_2 -> V_69 ) ;
V_143 = F_28 ( V_2 -> V_144 [ V_145 ] , struct V_143 , V_146 ) ;
V_180 . V_51 = V_168 ? 1 : V_2 -> V_51 ;
V_180 . V_183 = V_168 ? 1 : 0 ;
V_44 = V_143 -> V_58 -> V_184 ( V_143 , & V_180 ) ;
if ( V_168 ) {
V_182 = V_185 ;
} else {
V_122 -> V_127 ( V_122 , V_186 ,
& V_181 [ 0 ] , & V_181 [ 1 ] ) ;
V_143 -> V_58 -> V_155 ( V_143 , V_181 [ 0 ] ) ;
V_143 -> V_58 -> V_156 ( V_143 , V_181 [ 1 ] ) ;
if ( V_2 -> V_139 != V_2 -> V_57 )
V_44 = F_26 ( V_2 , V_2 -> V_57 ) ;
}
V_143 -> V_58 -> V_154 ( V_143 , V_182 ) ;
V_143 -> V_58 -> V_99 ( V_143 ) ;
F_12 ( & V_2 -> V_69 ) ;
return V_44 ;
}
...
V_122 -> V_159 ( V_122 , V_160 , NULL ) ;
V_122 -> V_161 ( V_122 , V_160 , NULL ) ;
V_122 -> V_159 ( V_122 , V_188 , NULL ) ;
V_122 -> V_161 ( V_122 , V_188 , NULL ) ;
}
if ( V_2 -> V_144 ) {
V_169 = (struct V_169 * ) V_2 -> V_34 [ V_170 ] ;
for ( V_47 = 0 ; V_47 < V_2 -> V_189 ; V_47 ++ ) {
V_146 = V_2 -> V_144 [ V_47 ] ;
if ( V_146 -> type < V_177 ) {
V_143 = F_28 ( V_146 , struct V_143 , V_146 ) ;
V_143 -> V_58 -> V_190 ( V_143 ) ;
V_143 -> V_58 -> V_191 ( V_143 ) ;
} else {
V_187 = F_28 ( V_146 , struct V_187 , V_146 ) ;
}
V_169 -> V_192 ( V_169 , V_146 ) ;
}
F_14 ( V_2 -> V_144 ) ;
V_2 -> V_144 = NULL ;
}
if ( V_2 -> V_49 ) {
V_76 = V_2 -> V_34 [ V_77 ] ;
for ( V_47 = 0 ; V_47 < V_2 -> V_193 ; V_47 ++ )
...
if ( V_2 -> V_122 )
F_50 ( V_2 -> V_122 ) ;
for ( V_47 = 0 ; V_47 < V_195 ; V_47 ++ ) {
if ( V_196 [ V_47 ] . V_197 && V_2 -> V_34 [ V_47 ] )
V_196 [ V_47 ] . V_197 ( V_2 -> V_34 [ V_47 ] ) ;
}
if ( V_2 -> V_141 )
F_51 ( (struct V_141 * ) V_2 -> V_141 ) ;
if ( V_2 -> V_8 ) {
F_52 ( V_2 -> V_8 ) ;
V_2 -> V_8 = NULL ;
}
...
{
struct V_1 * V_2 = V_199 -> V_200 ;
return F_48 ( V_2 ) ;
}
static int T_3 F_54 ( struct V_1 * V_2 , unsigned int V_201 )
{
const struct V_202 * V_203 ;
const struct V_202 * V_204 ;
T_4 V_205 , V_206 ;
switch ( V_2 -> V_207 ) {
case V_208 :
V_2 -> V_209 = L_2 ;
...
V_205 = V_2 -> V_213 -> V_214 ;
V_206 = V_2 -> V_213 -> V_215 ;
}
V_203 = F_55 ( V_205 , V_206 , V_204 ) ;
if ( V_203 ) {
if ( V_203 -> V_216 < 0 ) {
F_5 ( V_28 L_4
L_5 ,
...
V_2 -> V_220 = V_221 [ V_2 -> V_217 ] ;
F_56 ( L_6 ,
V_2 -> V_209 , V_2 -> V_220 ,
V_205 , V_206 ) ;
return 0 ;
}
int T_3 F_57 ( struct V_1 * V_2 )
{
enum V_222 V_47 ;
int V_44 ;
V_223 [ V_224 ] . V_225 = V_2 -> V_209 ;
for ( V_47 = 0 ; V_47 < V_226 ; V_47 ++ ) {
if ( ! V_223 [ V_47 ] . V_227 )
continue;
V_44 = V_223 [ V_47 ] . V_227 ( V_2 , V_47 ,
V_223 [ V_47 ] . V_225 ) ;
if ( V_44 ) {
F_5 ( V_28 L_4
L_7 , V_47 ) ;
...
int V_47 , V_44 ;
V_44 = F_59 ( V_2 -> V_213 , V_2 -> V_207 , V_2 -> V_217 , & V_141 ) ;
if ( V_44 ) {
F_5 ( V_28 L_8 ) ;
return V_44 ;
}
...
V_229 . V_57 = V_2 -> V_57 ;
V_229 . V_51 = V_2 -> V_51 ;
V_229 . V_230 = F_3 ( V_2 , 0 ) ;
V_44 = V_141 -> V_231 ( V_141 , & V_229 ) ;
if ( V_44 < 0 )
return V_44 ;
for ( V_47 = 0 ; V_47 < V_195 ; V_47 ++ ) {
if ( ! V_196 [ V_47 ] . V_227 )
continue;
V_44 = V_196 [ V_47 ] . V_227 ( V_2 -> V_141 , & V_2 -> V_34 [ V_47 ] ) ;
if ( V_44 ) {
F_5 ( V_28 L_4
L_9 , V_47 ) ;
return V_44 ;
...
struct V_76 * V_76 ;
int V_44 , V_47 ;
V_2 -> V_144 = F_10 ( sizeof( void * ) * ( V_234 ) , V_66 ) ;
if ( ! V_2 -> V_144 )
return - V_67 ;
V_2 -> V_163 = F_10 ( sizeof( void * ) * ( 2 * 2 ) , V_66 ) ;
if ( ! V_2 -> V_163 )
return - V_67 ;
V_2 -> V_79 = F_10 ( sizeof( void * ) * ( 2 * 2 ) , V_66 ) ;
if ( ! V_2 -> V_79 )
return - V_67 ;
...
V_169 = (struct V_169 * ) V_2 -> V_34 [ V_170 ] ;
V_233 . V_51 = V_2 -> V_51 ;
for ( V_47 = 0 , V_2 -> V_189 = 0 ; V_47 < V_234 - 1 ; V_47 ++ ) {
V_233 . type = V_47 ;
V_44 = V_169 -> V_235 ( V_169 , & V_233 ,
...
V_108 . V_51 = V_2 -> V_51 ;
V_108 . V_52 = V_115 ;
for ( V_47 = 0 , V_2 -> V_194 = 0 ; V_47 < ( 2 * 2 ) ; V_47 ++ ) {
V_44 = V_33 -> V_54 ( V_33 , & V_108 ,
...
V_74 = V_2 -> V_34 [ V_75 ] ;
V_110 . V_51 = 8 ;
for ( V_47 = 0 , V_2 -> V_80 = 0 ; V_47 < ( 2 * 1 ) ; V_47 ++ ) {
...
V_110 . V_51 = 8 ;
for ( V_47 = 0 ; V_47 < ( 2 * 1 ) ; V_47 ++ ) {
V_44 = V_74 -> V_119 ( V_74 , & V_110 ,
(struct V_78 * * ) & V_2 -> V_79 [ 2 * 1 + V_47 ] ) ;
if ( V_44 )
return V_44 ;
V_2 -> V_80 ++ ;
}
V_76 = V_2 -> V_34 [ V_77 ] ;
V_112 . V_51 = V_2 -> V_51 ;
for ( V_47 = 0 , V_2 -> V_193 = 0 ; V_47 < ( 2 * 4 ) ; V_47 ++ ) {
...
static void
F_61 ( struct V_33 * V_33 , struct V_187 * V_187 ,
...
struct V_78 * V_78 ;
int V_47 = 0 ;
V_181 [ 0 ] = & V_187 -> V_146 . V_238 ;
V_181 [ 1 ] = & V_187 -> V_146 . V_239 ;
for ( V_47 = 0 ; V_47 < 2 ; V_47 ++ ) {
V_42 = V_163 [ V_47 ] ;
V_78 = V_79 [ V_47 ] ;
V_78 -> V_58 -> V_11 ( V_78 , V_42 , V_181 [ V_47 ] ) ;
V_33 -> V_136 ( V_33 , V_42 ) ;
}
V_33 -> V_99 ( V_33 ) ;
V_42 = V_163 [ 0 ] ;
...
V_187 -> V_58 -> V_240 ( V_187 , & ( V_163 [ 0 ] -> V_71 ) ) ;
V_187 -> V_58 -> V_241 ( V_187 , & ( V_163 [ 1 ] -> V_71 ) ) ;
V_187 -> V_58 -> V_242 ( V_187 , 1 ) ;
V_187 -> V_58 -> V_243 ( V_187 , 1 ) ;
V_187 -> V_58 -> V_99 ( V_187 ) ;
V_33 -> V_99 ( V_33 ) ;
}
...
int V_47 , V_124 ;
V_122 = V_2 -> V_122 ;
for ( V_47 = V_244 , V_124 = V_173 ; V_47 <= V_186 ; V_47 ++ , V_124 ++ ) {
V_122 -> V_127 ( V_122 , V_47 , & V_181 [ 0 ] , & V_181 [ 1 ] ) ;
V_143 = F_28 ( V_2 -> V_144 [ V_124 ] , struct V_143 , V_146 ) ;
V_143 -> V_58 -> V_155 ( V_143 , V_181 [ 0 ] ) ;
V_143 -> V_58 -> V_156 ( V_143 , V_181 [ 1 ] ) ;
}
V_187 = F_28 ( V_2 -> V_144 [ V_177 ] , struct V_187 , V_146 ) ;
F_61 ( V_2 -> V_34 [ V_35 ] , V_187 ,
...
V_42 = V_2 -> V_163 [ 3 ] ;
V_122 -> V_161 ( V_122 , V_164 , & V_42 -> V_71 ) ;
V_187 = F_28 ( V_2 -> V_144 [ V_178 ] , struct V_187 , V_146 ) ;
F_61 ( V_2 -> V_34 [ V_35 ] , V_187 ,
(struct V_42 * * ) & V_2 -> V_163 [ 0 ] ,
(struct V_78 * * ) & V_2 -> V_79 [ 0 ] ) ;
V_42 = V_2 -> V_163 [ 0 ] ;
V_122 -> V_159 ( V_122 , V_188 , & V_42 -> V_71 ) ;
V_42 = V_2 -> V_163 [ 1 ] ;
V_122 -> V_161 ( V_122 , V_188 , & V_42 -> V_71 ) ;
for ( V_47 = V_245 , V_124 = 0 ; V_47 <= V_246 ; V_47 ++ , V_124 += 2 ) {
...
static int F_63 ( struct V_1 * V_2 , T_5 V_168 )
{
int V_47 ;
struct V_141 * V_141 = V_2 -> V_141 ;
F_64 ( V_2 -> V_247 , V_248 ) ;
for ( V_47 = V_249 ; V_47 < V_250 ; V_47 ++ ) {
if ( ! V_2 -> V_251 [ V_47 ] )
continue;
F_65 ( V_2 -> V_251 [ V_47 ] ) ;
}
F_47 ( V_2 ) ;
V_141 -> V_252 ( V_141 , V_168 ) ;
return 0 ;
}
...
V_229 . V_51 = V_2 -> V_51 ;
V_229 . V_230 = F_3 ( V_2 , 0 ) ;
return V_141 -> V_253 ( V_141 , & V_229 ) ;
}
...
if ( V_44 < 0 )
return V_44 ;
F_64 ( V_2 -> V_247 , V_254 ) ;
return 0 ;
}
int T_3 F_70 ( struct V_255 * V_247 , struct V_256 * V_213 ,
unsigned int V_57 , unsigned int V_51 ,
int V_207 , unsigned int V_201 ,
struct V_1 * * V_257 )
{
struct V_1 * V_2 ;
static struct V_258 V_58 = {
. V_259 = F_53 ,
} ;
int V_44 ;
* V_257 = NULL ;
...
V_44 = F_72 ( & V_2 -> V_8 , V_213 ) ;
if ( V_44 < 0 )
goto V_55;
V_44 = F_58 ( V_2 ) ;
if ( V_44 < 0 )
goto V_55;
V_44 = F_73 ( V_2 , (struct V_121 * * ) & V_2 -> V_122 ) ;
if ( V_44 ) {
F_5 ( V_28 L_16 ) ;
goto V_55;
}
...
if ( ! V_2 -> V_73 )
goto V_55;
V_44 = F_75 ( V_247 , V_261 , V_2 , & V_58 ) ;
if ( V_44 < 0 )
goto V_55;
F_76 ( V_247 , & V_213 -> V_199 ) ;
* V_257 = V_2 ;
return 0 ;
V_55:
F_48 ( V_2 ) ;
