...
V_214 = 1 ;
if ( V_131 )
V_214 = F_90 (unsigned long, char_time, timeout) ;
...
if ( F_78 ( V_197 ) )
break;
if ( V_131 && F_92 ( V_91 , V_213 + V_131 ) )
break;
}
F_93 ( V_217 ) ;
if ( ! V_215 )
...
static int F_95 ( struct V_14 * V_15 , struct V_205 * V_206 ,
struct V_1 * V_2 )
{
#ifdef F_96
F_96 ( V_218 , V_197 ) ;
#else
struct V_219 V_218 = { V_197 , NULL } ;
#endif
struct V_112 * V_38 = V_2 -> V_38 ;
int V_94 ;
int V_220 = 0 , V_221 = 0 ;
...
F_77 ( & V_2 -> V_212 ) ;
#ifdef F_97
return ( ( V_2 -> V_17 & V_222 ) ?
- V_223 : - V_198 ) ;
#else
return - V_223 ;
#endif
}
if ( ( V_206 -> V_224 & V_225 ) ||
( V_15 -> V_17 & ( 1 << V_101 ) ) ) {
V_2 -> V_17 |= V_211 ;
return 0 ;
}
...
static int F_102 ( int line , struct V_1 * * V_227 )
{
struct V_1 * V_2 ;
struct V_112 * V_228 ;
V_228 = V_229 + line ;
...
V_2 = F_103 ( sizeof( struct V_1 ) , V_96 ) ;
if ( ! V_2 ) {
V_228 -> V_140 -- ;
return - V_97 ;
}
...
#endif
V_2 -> V_7 = V_8 ;
V_2 -> V_150 = V_228 -> V_150 ;
V_2 -> V_17 = V_228 -> V_17 ;
V_2 -> V_132 = V_228 -> V_132 ;
V_2 -> line = line ;
F_105 ( & V_2 -> V_30 , F_28 , ( unsigned long ) V_2 ) ;
V_2 -> V_38 = V_228 ;
if ( V_228 -> V_2 ) {
F_106 ( V_2 ) ;
* V_227 = V_228 -> V_2 ;
...
static int F_107 ( struct V_14 * V_15 , struct V_205 * V_206 )
{
struct V_1 * V_2 ;
int V_94 , line ;
line = V_15 -> V_230 ;
if ( ( line < 0 ) || ( line >= V_231 ) ) {
return - V_171 ;
}
V_94 = F_102 ( line , & V_2 ) ;
if ( V_94 ) {
...
static inline void F_108 ( struct V_232 * V_233 , struct V_112 * V_38 )
{
struct V_1 * V_2 = V_38 -> V_2 , V_234 ;
char V_235 [ 30 ] , V_170 , V_31 ;
unsigned long V_17 ;
F_109 ( V_233 , L_54 , V_38 -> line ) ;
if ( ! V_2 ) {
V_2 = & V_234 ;
V_2 -> V_7 = V_8 ;
V_2 -> V_17 = V_38 -> V_17 ;
...
strcat ( V_235 , L_59 ) ;
if ( V_2 -> V_118 ) {
F_109 ( V_233 , L_60 , V_38 -> V_119 / V_2 -> V_118 ) ;
}
F_109 ( V_233 , L_61 , V_38 -> V_36 . V_62 , V_38 -> V_36 . V_44 ) ;
if ( V_38 -> V_36 . V_50 )
F_109 ( V_233 , L_62 , V_38 -> V_36 . V_50 ) ;
if ( V_38 -> V_36 . V_49 )
F_109 ( V_233 , L_63 , V_38 -> V_36 . V_49 ) ;
if ( V_38 -> V_36 . V_48 )
F_109 ( V_233 , L_64 , V_38 -> V_36 . V_48 ) ;
if ( V_38 -> V_36 . V_51 )
F_109 ( V_233 , L_65 , V_38 -> V_36 . V_51 ) ;
F_109 ( V_233 , L_66 , V_235 + 1 ) ;
}
static int F_110 ( struct V_232 * V_233 , void * V_236 )
{
F_109 ( V_233 , L_67 , V_237 ) ;
F_108 ( V_233 , & V_229 [ 0 ] ) ;
return 0 ;
}
static int F_111 ( struct V_238 * V_238 , struct V_205 * V_205 )
{
return F_112 ( V_205 , F_110 , NULL ) ;
}
static void F_113 ( void )
{
F_3 ( V_239 L_68 , V_240 , V_237 ) ;
}
static int T_4 F_114 ( struct V_241 * V_242 )
{
unsigned long V_17 ;
struct V_112 * V_38 ;
int error ;
...
V_38 -> V_119 = V_261 ;
V_38 -> V_132 = 1 ;
error = F_34 ( V_262 , F_27 , 0 , L_72 , V_38 ) ;
if ( error )
goto V_263;
error = F_34 ( V_264 , F_26 , V_265 ,
L_73 , V_38 ) ;
if ( error )
goto V_266;
F_6 ( V_17 ) ;
...
F_7 () ;
F_8 ( V_17 ) ;
V_10 . V_267 |= ( V_13 | V_12 ) ;
V_10 . V_267 &= ~ ( V_68 | V_69 | V_70 ) ;
F_118 ( V_242 , V_38 ) ;
return 0 ;
V_266:
F_40 ( V_262 , V_38 ) ;
...
static int T_5 F_121 ( struct V_241 * V_242 )
{
int error ;
struct V_112 * V_38 = F_122 ( V_242 ) ;
struct V_1 * V_2 = V_38 -> V_2 ;
F_123 ( & V_2 -> V_30 ) ;
if ( ( error = F_119 ( V_243 ) ) )
F_3 ( L_74 ,
error ) ;
F_120 ( V_243 ) ;
V_229 [ 0 ] . V_2 = NULL ;
...
{
return F_125 ( & V_268 , F_114 ) ;
}
static void T_5 F_126 ( void )
{
F_127 ( & V_268 ) ;
}
static void F_128 ( char V_141 )
{
V_20 . V_61 = ( unsigned char ) V_141 | 0x100 ;
while ( ! ( V_20 . V_32 & 0x2000 ) )
F_129 () ;
}
static void F_130 ( struct V_269 * V_270 , const char * V_271 ,
unsigned V_140 )
{
...
static struct V_272 * F_131 ( struct V_269 * V_141 , int * V_230 )
{
* V_230 = 0 ;
return V_243 ;
}
