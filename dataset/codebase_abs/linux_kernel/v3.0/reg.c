...
struct V_95 V_120 ;
F_14 () ;
V_102 = V_80 -> V_105 [ V_118 -> V_96 . V_98 ] ;
V_96 = & V_102 -> V_107 [ V_99 ] ;
if ( F_61 ( V_96 -> V_81 != V_118 -> V_96 . V_81 ) )
return;
if ( V_96 -> V_121 )
return;
V_96 -> V_121 = true ;
if ( V_80 -> V_63 & V_122 )
return;
V_120 . V_81 = V_96 -> V_81 ;
V_120 . V_63 = V_96 -> V_63 ;
if ( V_96 -> V_63 & V_75 ) {
V_96 -> V_63 &= ~ V_75 ;
V_119 = true ;
}
...
struct V_101 * V_102 ;
F_14 () ;
if ( ! V_80 -> V_105 [ V_118 -> V_96 . V_98 ] )
return;
V_102 = V_80 -> V_105 [ V_118 -> V_96 . V_98 ] ;
for ( V_16 = 0 ; V_16 < V_102 -> V_106 ; V_16 ++ )
F_60 ( V_80 , V_16 , V_118 ) ;
}
...
return 0 ;
case V_87 :
V_136 = F_52 ( V_7 -> V_104 ) ;
if ( F_75 ( ! F_11 ( V_135 -> V_8 ) ) )
return - V_64 ;
if ( V_7 -> V_86 ==
V_87 ) {
if ( V_136 != V_80 ) {
...
static void F_82 ( struct V_134 * V_149 )
{
int V_28 = 0 ;
struct V_80 * V_80 = NULL ;
enum V_92 V_86 = V_149 -> V_86 ;
F_6 ( ! V_149 -> V_8 ) ;
if ( F_83 ( V_149 -> V_104 ) )
V_80 = F_52 ( V_149 -> V_104 ) ;
if ( V_149 -> V_86 == V_94 &&
! V_80 ) {
F_4 ( V_149 ) ;
return;
}
V_28 = F_80 ( V_80 , V_149 ) ;
if ( V_28 == - V_138 && V_80 &&
V_80 -> V_63 & V_111 ) {
F_59 ( V_80 , V_86 ) ;
return;
...
static void F_93 ( struct V_134 * V_25 )
{
...
struct V_134 * V_25 ;
F_6 ( ! V_8 ) ;
V_25 = F_18 ( sizeof( struct V_134 ) , V_19 ) ;
if ( ! V_25 )
return - V_20 ;
V_25 -> V_104 = V_154 ;
V_25 -> V_8 [ 0 ] = V_8 [ 0 ] ;
...
{
char V_8 [ 2 ] ;
struct V_118 * V_118 , * V_166 ;
struct V_134 * V_149 , * V_151 ;
F_101 ( V_167 ) ;
F_20 ( & V_34 ) ;
F_20 ( & V_1 ) ;
F_3 () ;
...
! F_103 ( V_170 -> V_81 ) ) ) ) )
return 0 ;
V_118 = F_18 ( sizeof( struct V_118 ) , V_171 ) ;
if ( ! V_118 )
return - V_20 ;
F_49 ( L_38
L_39 ,
...
F_106 ( V_170 -> V_81 ) ,
F_107 ( V_80 ) ) ;
memcpy ( & V_118 -> V_96 , V_170 ,
sizeof( struct V_95 ) ) ;
F_89 ( & V_152 ) ;
F_27 ( & V_118 -> V_31 , & V_153 ) ;
F_90 ( & V_152 ) ;
F_28 ( & V_147 ) ;
return 0 ;
}
...
return - V_64 ;
V_117 = F_114 ( V_103 ) ;
V_117 -> V_172 [ 0 ] = V_6 -> V_8 [ 0 ] ;
V_117 -> V_172 [ 1 ] = V_6 -> V_8 [ 1 ] ;
V_117 -> V_158 = V_7 -> V_163 ;
F_6 ( V_173 == V_6 ) ;
F_4 ( V_6 ) ;
V_6 = NULL ;
F_3 () ;
