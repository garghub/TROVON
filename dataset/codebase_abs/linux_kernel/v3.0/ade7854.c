...
int F_19 ( struct V_10 * V_11 , struct V_1 * V_2 )
{
int V_6 ;
V_11 -> V_31 = F_20 ( sizeof( * V_11 -> V_31 ) * V_32 , V_33 ) ;
if ( V_11 -> V_31 == NULL ) {
V_6 = - V_34 ;
goto V_35;
}
V_11 -> V_36 = F_20 ( sizeof( * V_11 -> V_36 ) * V_37 , V_33 ) ;
if ( V_11 -> V_36 == NULL ) {
V_6 = - V_34 ;
goto V_38;
}
...
V_11 -> V_9 -> V_2 . V_41 = V_2 ;
V_11 -> V_9 -> V_42 = & V_43 ;
V_11 -> V_9 -> V_44 = ( void * ) ( V_11 ) ;
V_11 -> V_9 -> V_45 = V_46 ;
V_6 = F_23 ( V_11 -> V_9 ) ;
if ( V_6 )
goto V_47;
