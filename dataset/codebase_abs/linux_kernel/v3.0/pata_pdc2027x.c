...
long V_78 ;
V_78 = F_28 ( V_4 ) ;
F_31 ( V_99 , V_4 -> V_53 , L_30 , V_78 / 1000 ) ;
F_22 ( V_4 , V_78 , V_79 ) ;
return 0 ;
}
static void F_32 ( struct V_100 * V_101 , void T_1 * V_102 )
{
V_101 -> V_103 =
V_101 -> V_104 = V_102 ;
V_101 -> V_105 =
V_101 -> V_106 = V_102 + 0x05 ;
V_101 -> V_107 = V_102 + 0x0a ;
V_101 -> V_108 = V_102 + 0x0f ;
V_101 -> V_109 = V_102 + 0x10 ;
V_101 -> V_110 = V_102 + 0x15 ;
V_101 -> V_111 = V_102 + 0x1a ;
V_101 -> V_112 =
V_101 -> V_113 = V_102 + 0x1f ;
V_101 -> V_114 =
V_101 -> V_115 = V_102 + 0x81a ;
}
static int T_5 F_33 ( struct V_116 * V_117 , const struct V_118 * V_119 )
{
static int V_120 ;
static const unsigned long V_121 [] = { 0x17c0 , 0x15c0 } ;
static const unsigned long V_122 [] = { 0x1000 , 0x1008 } ;
unsigned int V_79 = ( unsigned int ) V_119 -> V_123 ;
...
int V_127 , V_54 ;
if ( ! V_120 ++ )
F_31 ( V_128 , & V_117 -> V_53 , L_31 V_129 L_32 ) ;
V_4 = F_34 ( & V_117 -> V_53 , V_125 , 2 ) ;
if ( ! V_4 )
return - V_130 ;
V_54 = F_35 ( V_117 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_36 ( V_117 , 1 << V_6 , V_131 ) ;
if ( V_54 )
return V_54 ;
V_4 -> V_5 = F_37 ( V_117 ) ;
V_54 = F_38 ( V_117 , V_132 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_39 ( V_117 , V_132 ) ;
if ( V_54 )
return V_54 ;
V_70 = V_4 -> V_5 [ V_6 ] ;
for ( V_127 = 0 ; V_127 < 2 ; V_127 ++ ) {
struct V_1 * V_2 = V_4 -> V_133 [ V_127 ] ;
F_32 ( & V_2 -> V_134 , V_70 + V_121 [ V_127 ] ) ;
V_2 -> V_134 . V_135 = V_70 + V_122 [ V_127 ] ;
F_40 ( V_2 , V_6 , - 1 , L_33 ) ;
F_40 ( V_2 , V_6 , V_121 [ V_127 ] , L_34 ) ;
}
if ( F_30 ( V_4 , V_79 ) != 0 )
return - V_136 ;
F_41 ( V_117 ) ;
return F_42 ( V_4 , V_117 -> V_137 , V_138 ,
V_139 , & V_140 ) ;
}
