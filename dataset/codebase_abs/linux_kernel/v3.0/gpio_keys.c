...
if ( ! V_8 -> V_27 )
V_49 |= V_55 ;
error = F_38 ( V_40 , F_28 , V_49 , V_46 , V_6 ) ;
if ( error < 0 ) {
F_35 ( V_48 , L_6 ,
V_40 , error ) ;
goto V_51;
...
static int T_3 F_43 ( struct V_44 * V_45 )
{
struct V_59 * V_60 = V_45 -> V_48 . V_61 ;
struct V_12 * V_13 ;
struct V_47 * V_48 = & V_45 -> V_48 ;
struct V_31 * V_32 ;
int V_19 , error ;
int V_62 = 0 ;
V_13 = F_44 ( sizeof( struct V_12 ) +
V_60 -> V_63 * sizeof( struct V_5 ) ,
V_20 ) ;
V_32 = F_45 () ;
if ( ! V_13 || ! V_32 ) {
F_35 ( V_48 , L_7 ) ;
...
F_47 ( V_45 , V_13 ) ;
F_48 ( V_32 , V_13 ) ;
V_32 -> V_65 = V_60 -> V_65 ? : V_45 -> V_65 ;
V_32 -> V_66 = L_8 ;
V_32 -> V_48 . V_57 = & V_45 -> V_48 ;
V_32 -> V_67 = F_40 ;
V_32 -> V_68 = F_42 ;
V_32 -> V_69 . V_70 = V_71 ;
V_32 -> V_69 . V_72 = 0x0001 ;
V_32 -> V_69 . V_73 = 0x0001 ;
V_32 -> V_69 . V_74 = 0x0100 ;
if ( V_60 -> V_75 )
F_12 ( V_76 , V_32 -> V_77 ) ;
for ( V_19 = 0 ; V_19 < V_60 -> V_63 ; V_19 ++ ) {
struct V_30 * V_8 = & V_60 -> V_78 [ V_19 ] ;
struct V_5 * V_6 = & V_13 -> V_23 [ V_19 ] ;
unsigned int type = V_8 -> type ? : V_2 ;
V_6 -> V_32 = V_32 ;
V_6 -> V_8 = V_8 ;
...
if ( V_8 -> V_62 )
V_62 = 1 ;
F_49 ( V_32 , type , V_8 -> V_24 ) ;
}
error = F_50 ( & V_45 -> V_48 . V_79 , & V_80 ) ;
if ( error ) {
F_35 ( V_48 , L_9 ,
error ) ;
goto V_50;
...
return 0 ;
V_51:
F_53 ( & V_45 -> V_48 . V_79 , & V_80 ) ;
V_50:
while ( -- V_19 >= 0 ) {
F_54 ( F_5 ( V_60 -> V_78 [ V_19 ] . V_9 ) , & V_13 -> V_23 [ V_19 ] ) ;
if ( V_13 -> V_23 [ V_19 ] . V_10 )
F_6 ( & V_13 -> V_23 [ V_19 ] . V_11 ) ;
F_55 ( & V_13 -> V_23 [ V_19 ] . V_38 ) ;
F_39 ( V_60 -> V_78 [ V_19 ] . V_9 ) ;
}
F_47 ( V_45 , NULL ) ;
V_64:
F_56 ( V_32 ) ;
...
static int T_4 F_57 ( struct V_44 * V_45 )
{
struct V_59 * V_60 = V_45 -> V_48 . V_61 ;
struct V_12 * V_13 = F_58 ( V_45 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
int V_19 ;
F_53 ( & V_45 -> V_48 . V_79 , & V_80 ) ;
F_52 ( & V_45 -> V_48 , 0 ) ;
for ( V_19 = 0 ; V_19 < V_60 -> V_63 ; V_19 ++ ) {
int V_40 = F_5 ( V_60 -> V_78 [ V_19 ] . V_9 ) ;
F_54 ( V_40 , & V_13 -> V_23 [ V_19 ] ) ;
if ( V_13 -> V_23 [ V_19 ] . V_10 )
F_6 ( & V_13 -> V_23 [ V_19 ] . V_11 ) ;
F_55 ( & V_13 -> V_23 [ V_19 ] . V_38 ) ;
F_39 ( V_60 -> V_78 [ V_19 ] . V_9 ) ;
