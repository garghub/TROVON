...
{
struct V_8 * V_9 = (struct V_8 * ) V_2 -> V_36 ;
if( V_9 -> V_26 . V_33 != F_5 ( V_37 ) )
{
F_3 ( V_38 L_2 , V_2 -> V_4 -> V_39 , F_7 ( V_9 -> V_26 . V_33 ) ) ;
return 0 ;
}
return F_8 ( V_9 -> V_17 . V_5 , V_2 ) ;
}
...
V_2 -> V_4 = V_4 ;
F_10 ( V_2 ) ;
V_9 = (struct V_8 * ) F_11 ( V_2 ) ;
F_12 ( V_2 , V_10 ) ;
return V_9 -> V_26 . V_33 ;
}
int F_13 ( struct V_3 * V_4 , int V_40 )
{
if ( ( V_40 < 68 ) || ( V_40 > 65280 ) )
return - V_41 ;
V_4 -> V_42 = V_40 ;
return 0 ;
}
int F_14 ( struct V_3 * V_4 , void * V_43 )
{
struct V_44 * V_45 = V_43 ;
if ( F_15 ( V_4 ) )
return - V_46 ;
memcpy ( V_4 -> V_24 , V_45 -> V_47 , V_4 -> V_48 ) ;
return 0 ;
}
int F_16 ( struct V_3 * V_4 , struct V_49 * V_43 )
{
V_43 -> V_50 = 0 ;
...
V_4 -> V_48 = V_59 ;
V_4 -> V_60 = 25 ;
memset ( V_4 -> V_61 , 0xFF , V_59 ) ;
V_4 -> V_62 = 0 ;
}
struct V_3 * F_18 ( int V_63 )
{
return F_19 ( V_63 , L_3 , F_17 ) ;
}
