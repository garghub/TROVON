...
int F_10 ( T_1 V_15 , T_1 V_16 , T_1 V_17 , T_1 * V_18 )
{
int V_14 ;
T_1 V_19 [] = { 0x00 } ;
struct V_20 V_21 [ 2 ] ;
...
V_14 = F_11 ( & V_22 [ V_15 ] . V_29 , V_21 , 2 ) ;
if ( V_14 == 2 )
V_14 = 0 ;
else if ( V_14 >= 0 )
V_14 = - V_30 ;
...
int F_12 ( T_1 V_15 , T_1 V_16 , T_1 V_17 , T_1 V_1 )
{
int V_14 ;
T_1 V_31 [ 2 ] = { V_17 , V_1 } ;
struct V_20 V_21 ;
...
V_21 . V_27 = 2 ;
V_21 . V_28 = V_31 ;
V_14 = F_11 ( & V_22 [ V_15 ] . V_29 , & V_21 , 1 ) ;
if ( V_14 == 1 )
V_14 = 0 ;
else if ( V_14 >= 0 )
V_14 = - V_30 ;
...
int F_13 ( T_1 V_15 , T_1 V_16 , T_1 V_17 , T_1 * V_32 , int V_33 )
{
int V_14 ;
T_1 V_19 [] = { 0x00 } ;
struct V_20 V_21 [ 2 ] ;
...
struct V_34 * F_14 ( enum V_35 V_36 )
{
