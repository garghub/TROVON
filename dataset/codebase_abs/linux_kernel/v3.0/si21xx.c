...
static int F_22 ( struct V_18 * V_19 , struct V_95 * V_96 )
{
F_3 ( L_16 , V_15 ) ;
return 0 ;
}
static int F_23 ( struct V_18 * V_19 , struct V_95 * V_96 )
{
F_3 ( L_16 , V_15 ) ;
return 0 ;
}
...
bool V_114 [ V_113 ] ;
int V_42 ;
int V_115 [ V_113 ] = { 200 , 192 , 193 , 194 , 195 ,
196 , 204 , 205 , 206 , 207
} ;
int V_116 ;
int V_117 ;
...
F_3 ( L_17 , V_15 ) ;
if ( V_100 -> V_121 != V_122 ) {
F_3 ( L_18 ,
V_15 , V_100 -> V_121 ) ;
return - V_123 ;
}
for ( V_34 = 0 ; V_34 < V_113 ; ++ V_34 )
V_112 [ V_34 ] = V_114 [ V_34 ] = false ;
V_116 = - 700000 ;
V_117 = - 100000 ;
V_118 = 0 ;
V_119 = 0 ;
V_120 = 10 * V_100 -> V_124 ;
V_33 = V_100 -> V_125 / 100 ;
V_42 = V_43 ;
V_109 = ( V_120 - V_118 ) - ( ( V_119 * 200 )
+ ( V_33 * 135 ) ) / 200 ;
V_108 = ( V_120 - V_118 ) + ( ( V_119 * 200 )
+ ( V_33 * 135 ) ) / 200 ;
V_106 = 100000 *
( ( ( V_120 - V_118 ) -
( V_117 + V_116 ) / 2 )
/ 100000 ) ;
V_107 = ( V_120 - V_118 ) - V_106 ;
for ( V_34 = 0 ; V_34 < V_113 ; ++ V_34 ) {
V_110 = ( ( V_120 - V_118 ) / ( V_115 [ V_34 ] * 2500 ) ) *
( V_115 [ V_34 ] * 2500 ) + V_115 [ V_34 ] * 2500 ;
V_111 = ( ( V_120 - V_118 ) / ( V_115 [ V_34 ] * 2500 ) ) *
( V_115 [ V_34 ] * 2500 ) ;
if ( ( ( V_109 < V_110 ) && ( V_110 < V_108 ) ) ||
( ( V_109 < V_111 ) && ( V_111 < V_108 ) ) )
V_114 [ V_34 ] = true ;
}
for ( V_34 = 0 ; V_34 < V_113 ; ++ V_34 ) {
V_110 = ( ( V_120 - V_118 ) / ( V_115 [ V_34 ] * 5000 ) ) *
( V_115 [ V_34 ] * 5000 ) + V_115 [ V_34 ] * 5000 ;
V_111 = ( ( V_120 - V_118 ) / ( V_115 [ V_34 ] * 5000 ) ) *
( V_115 [ V_34 ] * 5000 ) ;
if ( ( ( V_109 < V_110 ) && ( V_110 < V_108 ) ) ||
( ( V_109 < V_111 ) && ( V_111 < V_108 ) ) )
V_112 [ V_34 ] = true ;
...
if ( V_104 > 207 || V_104 < 192 )
V_104 = 200 ;
V_103 = ( ( 0x4000 * ( V_107 / 10 ) ) /
( ( V_104 ) * 1000 ) ) ;
V_102 = ( T_1 ) ( V_106 / 100000 ) ;
V_89 [ 0 ] = V_104 ;
V_89 [ 1 ] = V_102 ;
V_89 [ 2 ] = V_103 & 0xFF ;
V_89 [ 3 ] = V_103 >> 8 & 0xFF ;
V_42 |= F_1 ( V_2 , V_126 , & V_89 [ 0 ] , 0x04 ) ;
V_2 -> V_36 = V_104 ;
F_21 ( V_19 , V_100 -> V_125 , V_100 -> V_127 ) ;
return 0 ;
}
...
T_1 V_128 ;
F_3 ( L_6 , V_15 ) ;
F_7 ( V_2 , V_58 , & V_128 , 0x01 ) ;
V_128 |= 1 << 6 ;
F_1 ( V_2 , V_58 , & V_128 , 0x01 ) ;
V_2 -> V_129 = 0 ;
return 0 ;
}
...
struct V_18 * F_28 ( const struct V_130 * V_11 ,
struct V_131 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_132 ;
F_3 ( L_6 , V_15 ) ;
V_2 = F_29 ( sizeof( struct V_1 ) , V_133 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_11 = V_11 ;
V_2 -> V_14 = V_14 ;
...
V_2 -> V_78 = V_79 ;
V_132 = F_6 ( V_2 , V_58 ) ;
F_4 ( V_2 , V_58 , V_132 | 0x40 ) ;
F_9 ( 200 ) ;
V_132 = F_6 ( V_2 , 0x00 ) ;
if ( V_132 != 0x04 && V_132 != 0x14 )
goto error;
memcpy ( & V_2 -> V_134 . V_135 , & V_136 ,
sizeof( struct V_137 ) ) ;
V_2 -> V_134 . V_20 = V_2 ;
return & V_2 -> V_134 ;
error:
