...
static void
V_121 ( struct V_92 * V_93 , enum V_95 V_96 )
{
switch ( V_96 ) {
case V_99 :
F_43 ( V_93 , V_111 ) ;
...
static void
V_112 ( struct V_92 * V_93 , enum V_95 V_96 )
{
switch ( V_96 ) {
case V_100 :
F_34 ( V_93 , F_33 ) ;
...
static void
V_127 ( struct V_92 * V_93 , enum V_95 V_96 )
{
switch ( V_96 ) {
case V_100 :
case V_129 :
...
T_2 V_132 [ 2 ] = { 0 , 0 } ;
if ( V_93 -> V_133 < 32 )
V_132 [ 0 ] = 1 << V_93 -> V_133 ;
else
V_132 [ 1 ] = 1 << ( V_93 -> V_133 - 32 ) ;
F_59 ( V_131 . V_134 , V_135 , V_136 , 0 ) ;
V_131 . V_137 [ 0 ] = F_25 ( V_132 [ 0 ] ) ;
V_131 . V_137 [ 1 ] = F_25 ( V_132 [ 1 ] ) ;
V_131 . V_138 = 1 ;
F_60 ( & V_93 -> V_139 , & V_131 , sizeof( V_131 ) ,
V_140 , V_93 ) ;
F_61 ( V_93 -> V_110 -> V_14 , & V_93 -> V_139 ) ;
}
static void
...
struct V_142 * V_143 ;
struct V_144 * V_145 ;
struct V_14 * V_14 = V_93 -> V_110 -> V_14 ;
void T_3 * V_77 ;
unsigned long V_23 ;
...
V_23 = ( unsigned long ) & V_145 [ V_93 -> V_133 ] . V_158 ;
F_23 ( V_93 -> V_68 & V_147 ,
V_77 + V_23 ) ;
V_23 = ( unsigned long ) & V_145 [ V_93 -> V_133 ] . V_159 ;
F_23 ( ( V_93 -> V_68 & V_160 ) | 0x80 ,
V_77 + V_23 ) ;
V_23 = ( unsigned long ) & V_145 [ V_93 -> V_133 ] . V_161 ;
F_23 ( ( V_93 -> V_162 -> V_163 << 16 ) |
( V_93 -> V_164 << 8 ) |
( V_93 -> V_165 . V_166 & V_167 ) | V_93 -> V_168 ,
V_77 + V_23 ) ;
V_23 = ( unsigned long ) & V_145 [ V_93 -> V_133 ] . V_169 ;
...
V_132 [ 1 ] = 1 << ( V_93 -> V_133 - 32 ) ;
F_59 ( V_131 . V_134 , V_135 , V_189 , 0 ) ;
V_131 . V_190 = 0 ;
V_131 . V_191 [ 0 ] = 0 ;
V_131 . V_191 [ 1 ] = 0 ;
V_131 . V_137 [ 0 ] = F_25 ( V_132 [ 0 ] ) ;
...
{
struct V_197 V_198 ;
F_59 ( V_198 . V_134 , V_135 , V_194 , 0 ) ;
V_198 . V_133 = V_93 -> V_133 ;
memcpy ( & V_198 . V_196 , ( void * ) & V_196 -> V_199 , V_200 ) ;
F_60 ( & V_93 -> V_139 , & V_198 , sizeof( V_198 ) ,
F_64 , V_93 ) ;
F_61 ( V_93 -> V_110 -> V_14 , & V_93 -> V_139 ) ;
}
static int
...
F_67 ( & V_93 -> V_110 -> V_14 -> V_207 , V_201 ) ;
return 1 ;
}
return 0 ;
}
...
F_10 ( & V_93 -> V_204 ) ;
F_5 ( & V_93 -> V_139 . V_9 ) ;
if ( V_215 -> V_221 == V_117 )
V_93 -> V_68 |= V_173 ;
V_93 -> V_106 = ( V_215 -> V_222 ) ?
V_107 : V_109 ;
F_81 ( V_93 , V_110 , V_215 ) ;
V_93 -> V_162 = F_82 ( & V_93 -> V_110 -> V_14 -> V_223 ,
V_215 -> V_224 ) ;
F_2 (qe, &rx->rxp_q) {
...
struct V_14 * V_14 = V_93 -> V_110 -> V_14 ;
struct V_195 * V_201 ;
F_84 ( & V_93 -> V_110 -> V_14 -> V_223 , V_93 -> V_162 ) ;
V_93 -> V_162 = NULL ;
V_93 -> V_115 = 0 ;
while ( ! F_3 ( & V_93 -> V_218 ) ) {
F_4 ( & V_93 -> V_218 , & V_201 ) ;
F_5 ( & V_201 -> V_9 ) ;
F_85 ( & V_93 -> V_110 -> V_14 -> V_233 , V_201 ) ;
}
if ( V_93 -> V_114 ) {
F_5 ( & V_93 -> V_114 -> V_9 ) ;
F_85 ( & V_93 -> V_110 -> V_14 -> V_233 ,
V_93 -> V_114 ) ;
V_93 -> V_114 = NULL ;
}
...
static void
F_91 ( struct V_213 * V_110 , enum V_239 V_176 )
{
F_48 ( V_110 , V_240 ) ;
if ( V_110 -> V_93 . V_133 < 32 )
V_110 -> V_14 -> V_241 . V_242 [ 0 ] |= ( ( T_2 ) 1 << V_110 -> V_93 . V_133 ) ;
else
V_110 -> V_14 -> V_241 . V_242 [ 1 ] |= ( ( T_2 )
1 << ( V_110 -> V_93 . V_133 - 32 ) ) ;
}
static void
F_92 ( struct V_92 * V_93 )
{
V_93 -> V_243 = F_91 ;
V_93 -> V_244 = V_93 -> V_110 ;
V_93 -> V_118 &= ~ V_245 ;
F_48 ( V_93 , V_97 ) ;
}
static void
F_93 ( struct V_213 * V_110 , enum V_239 V_176 )
{
F_48 ( V_110 , V_246 ) ;
if ( V_110 -> V_93 . V_133 < 32 )
V_110 -> V_14 -> V_241 . V_242 [ 0 ] &= ~ ( T_2 ) 1 << V_110 -> V_93 . V_133 ;
...
enum V_239
F_98 ( struct V_213 * V_110 , T_1 * V_251 ,
void (* F_99)( struct V_252 * , struct V_213 * ,
enum V_239 ) )
{
struct V_92 * V_93 = & V_110 -> V_93 ;
if ( V_93 -> V_114 == NULL ) {
V_93 -> V_114 =
F_100 ( & V_93 -> V_110 -> V_14 -> V_233 ) ;
if ( V_93 -> V_114 == NULL )
return V_253 ;
F_5 ( & V_93 -> V_114 -> V_9 ) ;
}
memcpy ( V_93 -> V_114 -> V_199 , V_251 , V_200 ) ;
V_93 -> V_115 ++ ;
V_93 -> V_254 = F_99 ;
V_93 -> V_255 = V_110 -> V_14 -> V_252 ;
F_48 ( V_93 , V_101 ) ;
return V_94 ;
}
enum V_239
F_101 ( struct V_213 * V_110 , T_1 * V_199 ,
void (* F_99)( struct V_252 * , struct V_213 * ,
enum V_239 ) )
{
struct V_92 * V_93 = & V_110 -> V_93 ;
...
if ( F_99 )
(* F_99)( V_110 -> V_14 -> V_252 , V_110 , V_94 ) ;
return V_94 ;
}
}
...
V_201 = F_103 ( & V_93 -> V_110 -> V_14 -> V_207 ) ;
if ( V_201 == NULL )
return V_256 ;
F_5 ( & V_201 -> V_9 ) ;
...
enum V_239
F_104 ( struct V_213 * V_110 , int V_19 , T_1 * V_257 ,
void (* F_99)( struct V_252 * , struct V_213 * ,
enum V_239 ) )
{
struct V_92 * V_93 = & V_110 -> V_93 ;
...
void
F_105 ( struct V_213 * V_110 , int V_264 )
{
struct V_92 * V_93 = & V_110 -> V_93 ;
int V_265 = ( V_264 >> 5 ) ;
...
void
F_106 ( struct V_213 * V_110 , int V_264 )
{
struct V_92 * V_93 = & V_110 -> V_93 ;
int V_265 = ( V_264 >> 5 ) ;
int V_266 = ( 1 << ( V_264 & 0x1F ) ) ;
...
static void F_107 ( struct V_213 * V_110 )
{
struct V_216 * V_217 ;
struct V_8 * V_267 ;
F_2 (qe_rxp, &rx->rxp_q) {
V_217 = (struct V_216 * ) V_267 ;
V_110 -> V_268 ( V_110 -> V_14 -> V_252 , V_217 -> V_269 . V_270 ) ;
}
F_108 ( V_110 , V_94 ) ;
}
static void F_109 ( struct V_213 * V_110 ,
enum V_271 V_96 )
{
switch ( V_96 ) {
case V_272 :
...
break;
default:
F_38 ( V_110 -> V_14 , V_96 ) ;
break;
}
}
static void F_110 ( struct V_213 * V_110 )
{
struct V_216 * V_217 ;
struct V_8 * V_267 ;
...
V_277 -> V_279 = F_113 ( & V_110 -> V_14 -> V_280 ) ;
F_114 ( V_277 ) ;
V_110 -> V_281 ( V_110 -> V_14 -> V_252 , V_277 -> V_282 ) ;
if ( V_278 ) {
F_114 ( V_278 ) ;
V_110 -> V_281 ( V_110 -> V_14 -> V_252 , V_278 -> V_282 ) ;
}
F_115 ( & V_217 -> V_269 ) ;
}
F_92 ( & V_110 -> V_93 ) ;
}
static void V_273 ( struct V_213 * V_110 ,
enum V_271 V_96 )
{
switch ( V_96 ) {
case V_274 :
...
F_119 ( & V_110 -> V_14 -> V_280 . V_285 ) ;
}
void
V_284 ( struct V_213 * V_110 , enum V_271 V_96 )
{
switch ( V_96 ) {
case V_275 :
F_120 ( & V_110 -> V_14 -> V_280 . V_285 ) ;
F_34 ( V_110 , F_109 ) ;
F_116 ( V_110 ) ;
F_95 ( & V_110 -> V_93 ) ;
break;
...
void
F_121 ( struct V_213 * V_110 )
{
F_94 ( & V_110 -> V_93 ) ;
}
void
V_283 ( struct V_213 * V_110 , enum V_271 V_96 )
{
switch ( V_96 ) {
case V_246 :
F_34 ( V_110 , V_286 ) ;
...
void
V_286 ( struct V_213 * V_110 , enum V_271 V_96 )
{
struct V_216 * V_217 = NULL ;
struct V_8 * V_9 ;
switch ( V_96 ) {
...
{
struct V_291 V_131 ;
F_59 ( V_131 . V_134 , V_135 , V_292 , 0 ) ;
V_131 . V_293 [ 0 ] = F_25 ( V_290 [ 0 ] ) ;
V_131 . V_293 [ 1 ] = F_25 ( V_290 [ 1 ] ) ;
F_60 ( & V_217 -> V_139 , & V_131 , sizeof( V_131 ) ,
V_294 , V_217 ) ;
F_61 ( V_217 -> V_110 -> V_14 , & V_217 -> V_139 ) ;
}
void
...
struct V_302 * V_303 ;
T_2 V_75 ;
struct V_14 * V_14 = V_227 -> V_110 -> V_14 ;
void T_3 * V_77 ;
unsigned long V_23 ;
V_303 = & V_227 -> V_303 ;
...
struct V_300 V_301 ;
T_2 V_75 ;
struct V_14 * V_14 = V_269 -> V_110 -> V_14 ;
void T_3 * V_77 ;
unsigned long V_23 ;
V_303 = & V_269 -> V_303 ;
V_301 = * ( (struct V_300 * ) ( V_303 -> V_304 ) ) ;
...
V_217 = (struct V_216 * ) V_267 ;
F_112 ( V_217 , V_277 , V_278 ) ;
V_110 -> V_93 . V_162 -> V_185 [ V_20 ] . V_186 = V_277 -> V_230 ;
V_110 -> V_93 . V_162 -> V_185 [ V_20 ] . V_187 =
( V_278 ? V_278 -> V_230 : 0 ) ;
V_20 ++ ;
}
}
...
{
struct V_8 * V_9 = NULL ;
struct V_213 * V_110 = NULL ;
F_4 ( & V_241 -> V_340 , & V_9 ) ;
if ( V_9 ) {
V_241 -> V_335 -- ;
V_110 = (struct V_213 * ) V_9 ;
F_5 ( V_9 ) ;
F_6 ( & V_110 -> V_9 , & V_241 -> V_341 ) ;
}
return V_110 ;
}
static void
F_132 ( struct V_333 * V_241 , struct V_213 * V_110 )
{
F_5 ( & V_110 -> V_9 ) ;
F_6 ( & V_110 -> V_9 , & V_241 -> V_340 ) ;
V_241 -> V_335 ++ ;
}
static void
F_133 ( struct V_213 * V_110 , struct V_14 * V_14 )
{
V_110 -> V_14 = V_14 ;
V_110 -> V_342 = 0 ;
F_10 ( & V_110 -> V_343 ) ;
V_110 -> V_288 . V_344 = V_345 ;
V_110 -> V_288 . V_346 = V_110 ;
V_110 -> V_288 . V_347 = 0 ;
V_110 -> V_247 = NULL ;
V_110 -> V_248 = NULL ;
}
...
static void
F_137 ( struct V_213 * V_110 , struct V_216 * V_217 )
{
F_6 ( & V_217 -> V_9 , & V_110 -> V_343 ) ;
}
static void
...
static void
F_139 ( struct V_213 * V_110 , int V_360 )
{
F_5 ( & V_110 -> V_9 ) ;
F_10 ( & V_110 -> V_343 ) ;
V_110 -> V_14 = NULL ;
V_110 -> V_93 . V_133 = V_360 ;
F_5 ( & V_110 -> V_139 . V_9 ) ;
V_110 -> V_247 = NULL ;
V_110 -> V_248 = NULL ;
}
...
F_140 ( & V_217 -> V_110 -> V_288 ) ;
}
void
V_345 ( void * V_193 )
{
struct V_213 * V_110 = (struct V_213 * ) V_193 ;
F_48 ( V_110 , V_289 ) ;
}
static void
F_141 ( void * V_193 , struct V_213 * V_110 ,
enum V_239 V_176 )
{
...
static void
F_143 ( struct V_213 * V_110 )
{
V_110 -> V_342 |= V_362 ;
if ( V_110 -> V_342 & V_363 )
F_48 ( V_110 , V_272 ) ;
}
static void
F_144 ( struct V_213 * V_110 )
{
V_110 -> V_342 &= ~ V_362 ;
if ( V_110 -> V_250 == ( V_364 ) F_109 )
F_141 ( & V_110 -> V_14 -> V_241 , V_110 , V_94 ) ;
else {
V_110 -> V_247 = F_141 ;
V_110 -> V_248 = & V_110 -> V_14 -> V_241 ;
F_48 ( V_110 , V_274 ) ;
}
}
static void
F_145 ( struct V_213 * V_110 )
{
V_110 -> V_342 &= ~ V_362 ;
V_110 -> V_342 |= V_365 ;
F_48 ( V_110 , V_275 ) ;
...
int
F_151 ( struct V_213 * V_110 )
{
return F_97 ( V_379 , V_110 -> V_250 ) ;
}
void
...
F_133 ( V_110 , V_14 ) ;
V_110 -> V_418 = V_418 ;
V_110 -> type = V_334 -> V_438 ;
V_110 -> V_439 = V_417 -> V_439 ;
V_110 -> V_440 = V_417 -> V_440 ;
V_110 -> V_441 = V_417 -> V_441 ;
V_110 -> V_442 = V_417 -> V_442 ;
V_110 -> V_268 = V_417 -> V_268 ;
V_110 -> V_281 = V_417 -> V_281 ;
if ( V_110 -> V_14 -> V_241 . V_367 & V_368 ) {
switch ( V_110 -> type ) {
case V_443 :
if ( ! ( V_110 -> V_14 -> V_241 . V_367 &
V_370 ) )
V_110 -> V_342 |= V_362 ;
break;
case V_369 :
if ( V_110 -> V_14 -> V_241 . V_367 & V_370 )
V_110 -> V_342 |= V_362 ;
break;
}
}
...
if ( V_110 -> V_441 )
V_110 -> V_441 ( V_252 , V_217 -> V_269 . V_270 ) ;
}
F_80 ( & V_110 -> V_93 , V_110 , V_334 ) ;
F_34 ( V_110 , F_109 ) ;
return V_110 ;
}
void
F_159 ( struct V_213 * V_110 )
{
struct V_333 * V_241 = & V_110 -> V_14 -> V_241 ;
struct V_2 * V_3 = & V_110 -> V_14 -> V_3 ;
struct V_276 * V_277 = NULL ;
struct V_276 * V_278 = NULL ;
struct V_216 * V_217 ;
struct V_8 * V_9 ;
F_83 ( & V_110 -> V_93 ) ;
while ( ! F_3 ( & V_110 -> V_343 ) ) {
F_4 ( & V_110 -> V_343 , & V_217 ) ;
F_112 ( V_217 , V_277 , V_278 ) ;
if ( V_110 -> V_440 )
V_110 -> V_440 ( V_110 -> V_14 -> V_252 , V_277 -> V_282 ) ;
V_277 -> V_282 = NULL ;
V_277 -> V_217 = NULL ;
V_277 -> V_110 = NULL ;
F_128 ( V_241 , V_277 ) ;
if ( V_278 ) {
if ( V_110 -> V_440 )
V_110 -> V_440 ( V_110 -> V_14 -> V_252 , V_278 -> V_282 ) ;
V_278 -> V_282 = NULL ;
V_278 -> V_217 = NULL ;
V_278 -> V_110 = NULL ;
F_128 ( V_241 , V_278 ) ;
...
if ( V_110 -> V_442 )
V_110 -> V_442 ( V_110 -> V_14 -> V_252 , V_217 -> V_269 . V_270 ) ;
...
void
F_160 ( struct V_213 * V_110 )
{
if ( V_110 -> V_250 != ( V_461 ) F_109 )
return;
V_110 -> V_342 |= V_363 ;
if ( V_110 -> V_342 & V_362 )
F_48 ( V_110 , V_272 ) ;
}
void
F_161 ( struct V_213 * V_110 , enum V_462 type ,
...
V_131 . V_134 . V_496 = V_135 ;
V_131 . V_134 . V_497 = V_498 ;
V_131 . V_134 . V_499 . V_500 . V_501 = 0 ;
V_131 . V_293 [ 0 ] = F_25 ( V_495 [ 0 ] ) ;
V_131 . V_293 [ 1 ] = F_25 ( V_495 [ 1 ] ) ;
F_60 ( & V_465 -> V_139 , & V_131 , sizeof( V_131 ) ,
V_502 , V_465 ) ;
F_61 ( V_465 -> V_14 , & V_465 -> V_139 ) ;
}
static void
...
V_131 . V_137 [ 0 ] = 0 ;
V_131 . V_137 [ 1 ] = 0 ;
V_131 . V_191 [ 0 ] = F_25 ( V_510 [ 0 ] ) ;
V_131 . V_191 [ 1 ] = F_25 ( V_510 [ 1 ] ) ;
F_60 ( & V_465 -> V_139 , & V_131 , sizeof( V_131 ) ,
V_514 , V_465 ) ;
F_61 ( V_465 -> V_14 , & V_465 -> V_139 ) ;
}
