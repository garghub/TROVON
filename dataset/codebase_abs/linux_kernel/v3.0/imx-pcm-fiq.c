...
static int F_32 ( struct V_49 * V_50 , struct V_51 * V_52 ,
struct V_53 * V_54 )
{
int V_42 ;
V_42 = F_33 ( V_50 , V_52 , V_54 ) ;
if ( V_42 )
return V_42 ;
if ( V_52 -> V_55 -> V_56 . V_57 ) {
struct V_6 * V_7 =
V_54 -> V_58 [ V_16 ] . V_7 ;
struct V_59 * V_60 = & V_7 -> V_30 ;
V_61 = ( unsigned long ) V_60 -> V_62 ;
}
if ( V_52 -> V_55 -> V_63 . V_57 ) {
struct V_6 * V_7 =
V_54 -> V_58 [ V_64 ] . V_7 ;
struct V_59 * V_60 = & V_7 -> V_30 ;
V_65 = ( unsigned long ) V_60 -> V_62 ;
}
F_34 ( & V_66 ,
& V_67 - & V_66 ) ;
return 0 ;
...
static int T_2 F_39 ( struct V_70 * V_71 )
{
struct V_72 * V_73 = F_40 ( V_71 ) ;
int V_42 ;
V_42 = F_41 ( & V_69 ) ;
if ( V_42 ) {
F_42 ( & V_71 -> V_74 , L_1 , V_42 ) ;
return V_42 ;
}
F_36 ( V_73 -> V_75 , 1 ) ;
V_68 = V_73 -> V_75 ;
...
static int T_3 F_44 ( struct V_70 * V_71 )
{
F_45 ( & V_71 -> V_74 ) ;
return 0 ;
}
