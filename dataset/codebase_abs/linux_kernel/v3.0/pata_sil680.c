...
int V_75 , V_48 ;
if ( ! V_72 ++ )
F_26 ( V_76 , & V_10 -> V_12 , L_7 V_77 L_8 ) ;
V_75 = F_27 ( V_10 ) ;
if ( V_75 )
return V_75 ;
...
F_33 ( V_10 ) ;
V_74 = V_11 -> V_83 [ V_80 ] ;
V_11 -> V_85 [ 0 ] -> V_43 . V_45 = V_74 + 0x00 ;
V_11 -> V_85 [ 0 ] -> V_43 . V_86 = V_74 + 0x80 ;
V_11 -> V_85 [ 0 ] -> V_43 . V_87 = V_74 + 0x8a ;
V_11 -> V_85 [ 0 ] -> V_43 . V_88 = V_74 + 0x8a ;
F_34 ( & V_11 -> V_85 [ 0 ] -> V_43 ) ;
V_11 -> V_85 [ 1 ] -> V_43 . V_45 = V_74 + 0x08 ;
V_11 -> V_85 [ 1 ] -> V_43 . V_86 = V_74 + 0xc0 ;
V_11 -> V_85 [ 1 ] -> V_43 . V_87 = V_74 + 0xca ;
V_11 -> V_85 [ 1 ] -> V_43 . V_88 = V_74 + 0xca ;
F_34 ( & V_11 -> V_85 [ 1 ] -> V_43 ) ;
return F_35 ( V_11 , V_10 -> V_89 , V_90 ,
V_91 , & V_92 ) ;
V_79:
return F_36 ( V_10 , V_71 , & V_92 , NULL , 0 ) ;
}
static int F_37 ( struct V_9 * V_10 )
{
struct V_73 * V_11 = F_38 ( & V_10 -> V_12 ) ;
int V_48 , V_75 ;
V_75 = F_39 ( V_10 ) ;
if ( V_75 )
return V_75 ;
