...
F_85 ( V_153 ) ;
F_86 ( V_153 , V_235 , & V_37 -> V_236 ) ;
F_87 ( V_153 , V_237 , & V_37 -> V_238 ) ;
F_79 ( V_239 L_12 ,
V_37 -> V_238 , V_153 -> V_240 , V_37 -> V_236 ) ;
strcpy ( V_147 -> V_241 , L_7 ) ;
strcpy ( V_147 -> V_242 , L_7 ) ;
for ( V_229 = V_243 ; V_229 -> V_236 ; V_229 ++ ) {
if ( V_244 [ V_225 ] ) {
if ( V_229 -> V_236 == V_244 [ V_225 ] )
break;
} else if ( V_229 -> V_236 == V_37 -> V_236 )
break;
}
V_37 -> V_43 = V_229 ;
if ( V_244 [ V_225 ] ) {
F_79 ( V_239 L_13
L_14 ,
V_229 -> V_184 , V_37 -> V_236 , V_244 [ V_225 ] ) ;
}
sprintf ( V_147 -> V_245 , L_15 ,
V_229 -> V_184 , V_37 -> V_9 , V_37 -> V_152 ) ;
F_72 ( V_37 , 0 ) ;
V_64 = F_88 ( V_147 , V_246 , V_37 , & V_144 ) ;
if ( V_64 < 0 ) {
F_59 ( V_37 ) ;
return V_64 ;
}
...
static void F_89 ( struct V_247 * V_164 , int V_248 )
{
F_11 ( (struct V_1 * ) ( V_164 -> V_157 ) , V_248 ) ;
}
static void F_90 ( struct V_247 * V_164 , int V_248 )
{
F_12 ( (struct V_1 * ) ( V_164 -> V_157 ) , V_248 ) ;
}
static unsigned char F_91 ( struct V_247 * V_164 , int V_38 )
{
return ( unsigned char ) F_1 ( (struct V_1 * ) ( V_164 -> V_157 ) ,
V_164 -> V_9 + V_38 , 0 ) ;
}
static void F_92 ( struct V_247 * V_164 , int V_12 , int V_38 )
{
...
V_64 = F_98 ( V_278 [ V_225 ] , V_279 [ V_225 ] , V_280 , 0 , & V_147 ) ;
if ( V_64 < 0 )
return V_64 ;
...
static int F_109 ( struct V_227 * V_153 , T_6 V_282 )
{
