...
static int F_53 ( char * V_144 , int V_129 , struct V_50 * V_27 )
{
F_6 ( L_51 , V_129 , V_144 , V_129 ) ;
F_6 ( L_52 ) ;
return ( V_129 ) ;
}
static int F_54 ( struct V_50 * V_27 , char * V_144 , char * * V_145 , T_11 V_128 , int V_129 , int V_146 )
{
...
#endif
if ( V_146 )
return ( F_53 ( V_144 , V_129 , V_27 ) ) ;
F_23 ( V_27 -> V_56 , V_31 ) ;
SPRINTF ( L_53 , V_27 -> V_150 , V_147 -> V_140 , V_147 -> V_142 ) ;
...
SPRINTF ( L_62 , V_132 ) ;
SPRINTF ( L_63 ) ;
for ( V_6 = V_149 = 0 ; V_6 < V_132 ; V_6 ++ )
if ( V_94 [ V_6 ] . V_73 ) {
V_149 ++ ;
SPRINTF ( L_64 , V_6 ) ;
}
SPRINTF ( V_149 ? L_65 : L_66 ) ;
SPRINTF ( L_67 ) ;
SPRINTF ( L_62 , V_72 ) ;
SPRINTF ( L_68 , V_147 -> V_70 ) ;
SPRINTF ( L_63 ) ;
for ( V_6 = V_149 = 0 ; V_6 < V_72 ; V_6 ++ )
if ( V_68 [ V_6 ] . V_73 ) {
V_149 ++ ;
SPRINTF ( L_64 , V_6 ) ;
}
...
F_24 ( V_27 -> V_56 , V_31 ) ;
* V_145 = V_144 + V_128 ;
if ( ( V_148 - V_144 ) < V_128 )
return ( 0 ) ;
else if ( ( V_148 - V_144 - V_128 ) < V_129 )
return ( V_148 - V_144 - V_128 ) ;
else
return ( V_129 ) ;
}
static T_1 int F_55 ( struct V_151 * V_152 )
{
short V_153 = 0 , V_154 , V_155 , V_6 , V_156 ;
short V_157 [ V_7 ] ;
unsigned V_18 ;
T_3 * V_27 = NULL ;
struct V_50 * V_71 ;
...
F_3 ( V_159 ) ;
#endif
for ( V_6 = 0 ; V_6 < V_160 ; V_161 [ V_6 ++ ] = NULL ) ;
for ( V_6 = 0 ; V_6 < V_7 ; V_157 [ V_6 ++ ] = - 1 ) ;
V_152 -> V_162 = L_48 ;
V_152 -> V_163 = & F_54 ;
F_27 () ;
for ( V_156 = 0 ; V_156 < V_7 ; V_156 ++ ) {
for ( V_154 = 0 ; V_154 < V_164 ; V_154 ++ )
for ( V_155 = 0 ; V_155 < V_165 ; V_155 ++ ) {
for ( V_6 = 0 ; V_6 < V_156 ; V_6 ++ )
if ( V_157 [ V_6 ] == V_154 )
break;
if ( V_6 == V_156 ) {
void T_12 * V_166 = F_57 ( V_167 [ V_154 ] + V_168 [ V_155 ] . V_169 ,
V_168 [ V_155 ] . V_43 ) ;
short V_170 = 1 ;
if ( V_166 )
V_170 = F_58 ( V_166 , V_168 [ V_155 ] . V_171 , V_168 [ V_155 ] . V_43 ) ;
F_59 ( V_166 ) ;
if ( V_170 )
goto V_172;
}
...
F_6 ( L_72 , V_167 [ V_154 ] ) ;
#endif
if ( V_11 [ V_156 ] . V_12 < 0 )
continue;
if ( V_158 == V_160 )
continue;
V_18 = V_11 [ V_156 ] . V_18 ;
F_6 ( L_73 , V_18 ) ;
if ( F_60 ( V_18 , 4 , L_48 ) ) {
F_6 ( L_74 , V_18 ) ;
...
F_6 ( L_76 ) ;
if ( F_18 ( V_18 + V_96 ) == 1 ) {
V_71 = F_62 ( V_152 , sizeof( T_3 ) ) ;
if ( V_71 == NULL )
goto V_173;
V_27 = ( T_3 * ) V_71 -> V_117 ;
F_6 ( L_77 , ( int ) V_27 ) ;
memset ( V_27 , 0 , sizeof( T_3 ) ) ;
V_27 -> V_12 = V_11 [ V_156 ] . V_12 ;
V_27 -> V_15 = V_11 [ V_156 ] . V_15 ;
V_27 -> V_18 = V_18 ;
V_27 -> V_95 = 0 ;
V_27 -> V_19 = V_11 [ V_156 ] . V_19 ;
V_27 -> V_21 = V_11 [ V_156 ] . V_21 ;
V_27 -> V_71 = V_161 [ V_158 ] = V_71 ;
V_158 ++ ;
...
struct V_184 * V_185 , T_13 V_186 , int * V_187 )
{
char V_188 [ V_189 ] ;
F_6 ( L_85 ,
