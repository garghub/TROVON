...
V_101 -> V_86 = 1 ;
V_101 -> V_104 = F_38 ( V_4 -> V_110 , 0 , V_101 -> V_102 . V_65 ,
V_133 ) ;
if ( F_39 ( V_101 -> V_104 ) ) {
V_101 -> V_104 = 0 ;
V_124 = - V_129 ;
...
V_101 -> V_105 = F_40 ( V_4 -> V_110 , V_101 -> V_104 ) ;
if ( V_101 -> V_105 == NULL ) {
V_124 = - V_129 ;
goto V_132;
}
...
V_101 -> V_105 -> V_106 -> V_108 , V_109 ) ;
V_104 = F_43 ( V_4 -> V_110 , V_101 -> V_104 ) ;
...
V_192 = F_38 ( V_4 -> V_110 , 0 , V_65 ,
V_133 ) ;
if ( F_39 ( V_192 ) )
return - V_129 ;
if ( F_37 ( F_43 ( V_4 -> V_110 , V_192 ) ,
( V_194 void V_195 * )
V_2 -> V_153 . V_154 , V_65 ) ) {
F_26 ( V_4 -> V_110 , V_192 ) ;
return - V_131 ;
}
...
F_56 ( V_2 , V_287 ) ;
F_10 ( V_4 , ( ( V_45 -> V_64 - 2 ) << V_312 ) |
( ( V_45 -> V_64 * 2 / 3 ) << V_313 ) ,
V_39 , V_314 ) ;
V_45 = & V_2 -> V_297 [ V_315 ] ;
F_10 ( V_4 , ( 0 << V_316 ) |
( ( V_45 -> V_63 - 1 ) << V_317 ) ,
V_39 , V_318 ) ;
F_10 ( V_4 , 0 << V_319 ,
...
<< V_321 ,
V_39 , V_322 ) ;
F_65 ( V_2 , V_2 -> V_323 . V_324 , 0 , 0 ) ;
V_45 = & V_2 -> V_297 [ V_325 ] ;
F_10 ( V_4 , ( 0 << V_326 ) |
( V_45 -> V_63 << V_327 ) ,
V_39 , V_328 ) ;
F_10 ( V_4 , ( 0 << V_329 ) |
...
static int F_87 ( struct V_1 * V_2 , T_1 V_350 )
{
int V_351 = 0 ;
switch ( ( V_2 -> V_338 & 3 ) | V_350 ) {
case V_339 | V_352 :
...
{
struct V_358 * V_359 = & V_2 -> V_201 . V_360 ;
struct V_361 V_350 ;
memset ( & V_350 , 0 , sizeof( V_350 ) ) ;
V_350 . type = V_362 ;
F_90 ( V_359 , & V_350 ) ;
}
static void F_91 ( struct V_1 * V_2 , T_1 V_363 )
{
unsigned long V_114 ;
if ( V_363 & V_364 ) {
F_23 ( V_2 ) ;
...
struct V_368 * V_369 ;
int V_370 = 0 ;
if ( F_50 ( & V_2 -> V_323 . V_371 ) )
goto V_132;
if ( V_2 -> V_95 == V_337 && V_2 -> V_372 ) {
V_370 = 1 ;
V_2 -> V_372 = 0 ;
goto V_132;
}
...
V_369 = F_94 ( & V_2 -> V_323 , V_2 -> error ) ;
if ( V_369 != NULL ) {
F_66 ( V_2 , V_369 -> V_373 ) ;
V_370 = 1 ;
}
V_200 -> V_95 |= V_374 ;
if ( V_2 -> V_95 == V_375 &&
...
int F_99 ( struct V_1 * V_2 , T_1 V_363 )
{
if ( V_2 -> V_95 == V_193 )
return 0 ;
if ( V_363 & V_376 )
...
static int F_100 ( struct V_378 * V_379 , struct V_368 * V_369 )
{
struct V_1 * V_2 = & V_379 -> V_4 -> V_196 ;
if ( ! ( V_2 -> V_299 & V_300 ) )
return - V_380 ;
F_66 ( V_2 , V_369 -> V_373 ) ;
V_2 -> V_372 = 1 ;
...
static long F_101 ( struct V_276 * V_381 , unsigned int V_382 , void * V_383 )
{
struct V_1 * V_2 = F_102 ( V_381 ) ;
int V_124 ;
switch ( V_382 ) {
case V_384 :
F_81 ( & V_2 -> V_341 ) ;
V_124 = F_57 ( V_2 , V_383 ) ;
F_83 ( & V_2 -> V_341 ) ;
break;
default:
return - V_385 ;
...
static int F_103 ( struct V_276 * V_381 , struct V_386 * V_387 ,
struct V_388 * V_389 )
{
if ( V_389 -> type != V_362 )
return - V_57 ;
return F_104 ( V_387 , V_389 ) ;
}
static int F_105 ( struct V_276 * V_381 , struct V_386 * V_387 ,
struct V_388 * V_389 )
{
return F_106 ( V_387 , V_389 ) ;
}
static int F_107 ( struct V_276 * V_381 , int V_86 )
{
struct V_1 * V_2 = F_102 ( V_381 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_124 = 0 ;
...
static struct V_44 *
F_8 ( struct V_1 * V_2 , struct V_392 * V_387 ,
unsigned int V_285 , enum V_393 V_294 )
{
if ( V_294 == V_394 )
return F_110 ( V_387 , V_285 ) ;
else
return & V_2 -> V_297 [ V_285 ] ;
}
static void
F_111 ( struct V_1 * V_2 , struct V_392 * V_387 ,
unsigned int V_285 , struct V_44 * V_395 ,
enum V_393 V_294 )
{
struct V_44 * V_45 ;
const struct V_278 * V_396 ;
unsigned int V_63 = V_395 -> V_63 ;
unsigned int V_64 = V_395 -> V_64 ;
unsigned int V_397 ;
switch ( V_285 ) {
case V_61 :
for ( V_397 = 0 ; V_397 < F_112 ( V_398 ) ; V_397 ++ ) {
if ( V_395 -> V_87 == V_398 [ V_397 ] )
break;
}
if ( V_397 >= F_112 ( V_398 ) )
V_395 -> V_87 = V_88 ;
V_395 -> V_63 = F_113 ( T_1 , V_63 , 32 , 4096 ) ;
V_395 -> V_64 = F_113 ( T_1 , V_64 , 32 , 4096 ) ;
break;
case V_315 :
V_45 = F_8 ( V_2 , V_387 , V_61 , V_294 ) ;
memcpy ( V_395 , V_45 , sizeof( * V_395 ) ) ;
V_395 -> V_63 = F_113 ( T_1 , V_63 , 32 , ( V_395 -> V_63 + 15 ) & ~ 15 ) ;
V_395 -> V_63 &= ~ 15 ;
V_395 -> V_64 = F_113 ( T_1 , V_64 , 32 , V_395 -> V_64 ) ;
break;
case V_325 :
V_45 = F_8 ( V_2 , V_387 , V_61 , V_294 ) ;
memcpy ( V_395 , V_45 , sizeof( * V_395 ) ) ;
V_396 = F_74 ( V_395 -> V_87 ) ;
V_395 -> V_87 = V_396 -> V_399 ;
V_395 -> V_63 = F_113 ( T_1 , V_63 , 32 , V_395 -> V_63 ) ;
V_395 -> V_64 = F_113 ( T_1 , V_64 , 32 , V_395 -> V_64 - 1 ) ;
break;
}
V_395 -> V_400 = V_401 ;
V_395 -> V_402 = V_403 ;
}
static int F_114 ( struct V_276 * V_381 ,
struct V_392 * V_387 ,
struct V_404 * V_87 )
{
struct V_1 * V_2 = F_102 ( V_381 ) ;
...
switch ( V_87 -> V_285 ) {
case V_61 :
if ( V_87 -> V_293 >= F_112 ( V_398 ) )
return - V_57 ;
V_87 -> V_87 = V_398 [ V_87 -> V_293 ] ;
break;
case V_315 :
case V_325 :
if ( V_87 -> V_293 != 0 )
return - V_57 ;
V_45 = F_8 ( V_2 , V_387 , V_61 ,
V_394 ) ;
V_87 -> V_87 = V_45 -> V_87 ;
break;
default:
...
static int F_115 ( struct V_276 * V_381 ,
struct V_392 * V_387 ,
struct V_405 * V_406 )
{
struct V_1 * V_2 = F_102 ( V_381 ) ;
...
if ( V_406 -> V_293 != 0 )
return - V_57 ;
V_45 . V_87 = V_406 -> V_87 ;
V_45 . V_63 = 1 ;
V_45 . V_64 = 1 ;
F_111 ( V_2 , V_387 , V_406 -> V_285 , & V_45 , V_394 ) ;
V_406 -> V_50 = V_45 . V_63 ;
V_406 -> V_51 = V_45 . V_64 ;
if ( V_45 . V_87 != V_406 -> V_87 )
return - V_57 ;
V_45 . V_87 = V_406 -> V_87 ;
V_45 . V_63 = - 1 ;
V_45 . V_64 = - 1 ;
F_111 ( V_2 , V_387 , V_406 -> V_285 , & V_45 , V_394 ) ;
V_406 -> V_407 = V_45 . V_63 ;
V_406 -> V_408 = V_45 . V_64 ;
return 0 ;
}
static int F_116 ( struct V_276 * V_381 , struct V_392 * V_387 ,
struct V_280 * V_395 )
{
struct V_1 * V_2 = F_102 ( V_381 ) ;
struct V_44 * V_45 ;
V_45 = F_8 ( V_2 , V_387 , V_395 -> V_285 , V_395 -> V_294 ) ;
if ( V_45 == NULL )
return - V_57 ;
V_395 -> V_45 = * V_45 ;
return 0 ;
}
static int F_117 ( struct V_276 * V_381 , struct V_392 * V_387 ,
struct V_280 * V_395 )
{
struct V_1 * V_2 = F_102 ( V_381 ) ;
struct V_44 * V_45 ;
...
if ( V_45 == NULL )
return - V_57 ;
F_111 ( V_2 , V_387 , V_395 -> V_285 , & V_395 -> V_45 , V_395 -> V_294 ) ;
* V_45 = V_395 -> V_45 ;
if ( V_395 -> V_285 == V_61 ) {
V_45 = F_8 ( V_2 , V_387 , V_315 ,
V_395 -> V_294 ) ;
* V_45 = V_395 -> V_45 ;
F_111 ( V_2 , V_387 , V_315 , V_45 ,
V_395 -> V_294 ) ;
V_45 = F_8 ( V_2 , V_387 , V_325 ,
V_395 -> V_294 ) ;
* V_45 = V_395 -> V_45 ;
F_111 ( V_2 , V_387 , V_325 , V_45 ,
V_395 -> V_294 ) ;
}
return 0 ;
}
static int F_118 ( struct V_276 * V_381 , struct V_392 * V_387 )
{
struct V_280 V_45 ;
memset ( & V_45 , 0 , sizeof( V_45 ) ) ;
V_45 . V_285 = V_61 ;
V_45 . V_294 = V_387 ? V_394 : V_62 ;
V_45 . V_45 . V_87 = V_88 ;
V_45 . V_45 . V_63 = 4096 ;
V_45 . V_45 . V_64 = 4096 ;
F_117 ( V_381 , V_387 , & V_45 ) ;
return 0 ;
}
static int F_119 ( struct V_409 * V_202 ,
const struct V_284 * V_410 ,
const struct V_284 * V_411 , T_1 V_114 )
{
struct V_276 * V_381 = F_72 ( V_202 ) ;
struct V_1 * V_2 = F_102 ( V_381 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_410 -> V_293 | F_120 ( V_411 -> V_202 ) ) {
case V_61 | V_412 :
if ( ! ( V_114 & V_413 ) ) {
V_2 -> V_215 = V_414 ;
break;
...
if ( V_2 -> V_215 != V_414 )
return - V_103 ;
if ( V_411 -> V_202 == & V_4 -> V_415 . V_201 . V_202 )
V_2 -> V_215 = V_416 ;
else if ( V_411 -> V_202 == & V_4 -> V_417 . V_201 . V_202 )
V_2 -> V_215 = V_418 ;
else if ( V_411 -> V_202 == & V_4 -> V_419 . V_201 . V_202 )
V_2 -> V_215 = V_420 ;
else
V_2 -> V_215 = V_237 ;
break;
...
{
struct V_276 * V_381 = & V_2 -> V_201 ;
struct V_284 * V_288 = V_2 -> V_288 ;
struct V_409 * V_423 = & V_381 -> V_202 ;
int V_124 ;
V_2 -> V_215 = V_414 ;
F_122 ( V_381 , & V_424 ) ;
V_381 -> V_425 = & V_426 ;
F_123 ( V_381 -> V_427 , L_17 , sizeof( V_381 -> V_427 ) ) ;
V_381 -> V_428 = 1 << 16 ;
F_124 ( V_381 , V_2 ) ;
V_381 -> V_114 |= V_429 | V_430 ;
V_381 -> V_431 = V_432 ;
V_288 [ V_61 ] . V_114 = V_433 ;
V_288 [ V_325 ] . V_114 = V_434 ;
V_288 [ V_315 ] . V_114 = V_434 ;
V_423 -> V_435 = & V_436 ;
V_124 = F_125 ( V_423 , V_437 , V_288 , 0 ) ;
if ( V_124 < 0 )
return V_124 ;
F_118 ( V_381 , NULL ) ;
V_2 -> V_323 . type = V_438 ;
V_2 -> V_323 . V_435 = & V_439 ;
V_2 -> V_323 . V_4 = F_2 ( V_2 ) ;
V_2 -> V_323 . V_440 = F_126 ( 4096 * 4096 ) * 3 ;
V_2 -> V_323 . V_441 = 32 ;
V_124 = F_127 ( & V_2 -> V_323 , L_18 ) ;
if ( V_124 < 0 )
return V_124 ;
V_124 = F_128 ( & V_2 -> V_201 . V_202 , V_315 ,
& V_2 -> V_323 . V_379 . V_202 , 0 , 0 ) ;
if ( V_124 < 0 )
return V_124 ;
return 0 ;
}
...
{
int V_124 ;
V_124 = F_134 ( V_359 , & V_2 -> V_201 ) ;
if ( V_124 < 0 )
goto error;
V_124 = F_135 ( & V_2 -> V_323 , V_359 ) ;
if ( V_124 < 0 )
goto error;
return 0 ;
error:
...
F_139 ( & V_2 -> V_341 ) ;
V_2 -> V_338 = V_342 ;
F_140 ( & V_2 -> V_94 . V_120 , F_33 ) ;
V_2 -> V_94 . V_95 = V_96 ;
F_141 ( & V_2 -> V_94 . V_121 ) ;
F_137 ( & V_2 -> V_94 . V_115 ) ;
V_2 -> V_172 . V_258 = 0 ;
V_2 -> V_172 . V_250 = 0 ;
V_2 -> V_172 . V_173 = 0 ;
V_2 -> V_172 . V_248 = 0 ;
...
F_26 ( V_4 -> V_110 , V_2 -> V_153 . V_154 ) ;
}
