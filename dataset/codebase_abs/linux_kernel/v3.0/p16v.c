...
int T_3 F_42 ( struct V_9 * V_10 , int V_29 , struct V_85 * * V_86 )
{
struct V_85 * V_25 ;
struct V_6 * V_7 ;
int V_14 ;
...
V_103 -> type = V_116 ;
V_103 -> V_105 = 1 ;
V_103 -> V_106 . V_117 . V_118 = 8 ;
if ( V_103 -> V_106 . V_117 . V_119 > 7 )
V_103 -> V_106 . V_117 . V_119 = 7 ;
strcpy ( V_103 -> V_106 . V_117 . V_94 , V_115 [ V_103 -> V_106 . V_117 . V_119 ] ) ;
return 0 ;
}
...
{
struct V_9 * V_10 = F_49 ( V_101 ) ;
V_110 -> V_106 . V_117 . V_119 [ 0 ] = V_10 -> V_120 ;
return 0 ;
}
...
T_1 V_123 ;
T_1 V_124 ;
V_121 = V_110 -> V_106 . V_117 . V_119 [ 0 ] ;
if ( V_121 > 7 )
return - V_75 ;
V_122 = ( V_10 -> V_120 != V_121 ) ;
if ( V_122 ) {
V_10 -> V_120 = V_121 ;
V_124 = ( V_121 << 28 ) | ( V_121 << 24 ) | ( V_121 << 20 ) | ( V_121 << 16 ) ;
V_123 = F_34 ( V_10 , V_74 , 0 ) & 0xffff ;
F_23 ( V_10 , V_74 , 0 , V_124 | V_123 ) ;
}
return V_122 ;
}
...
struct V_102 * V_103 )
{
static char * V_115 [ 4 ] = { L_11 , L_12 , L_13 , L_14 , } ;
V_103 -> type = V_116 ;
V_103 -> V_105 = 1 ;
V_103 -> V_106 . V_117 . V_118 = 4 ;
if ( V_103 -> V_106 . V_117 . V_119 > 3 )
V_103 -> V_106 . V_117 . V_119 = 3 ;
strcpy ( V_103 -> V_106 . V_117 . V_94 , V_115 [ V_103 -> V_106 . V_117 . V_119 ] ) ;
return 0 ;
}
...
{
struct V_9 * V_10 = F_49 ( V_101 ) ;
V_110 -> V_106 . V_117 . V_119 [ 0 ] = V_10 -> V_125 ;
return 0 ;
}
...
if ( V_121 > 3 )
return - V_75 ;
V_122 = ( V_10 -> V_125 != V_121 ) ;
if ( V_122 ) {
V_10 -> V_125 = V_121 ;
V_41 = F_34 ( V_10 , V_126 , 0 ) & 0xfffc ;
F_23 ( V_10 , V_126 , 0 , V_41 | V_121 ) ;
}
return V_122 ;
}
int T_3 F_57 ( struct V_9 * V_10 )
{
int V_40 , V_14 ;
struct V_127 * V_26 = V_10 -> V_26 ;
for ( V_40 = 0 ; V_40 < F_58 ( V_128 ) ; V_40 ++ ) {
if ( ( V_14 = F_59 ( V_26 , F_60 ( & V_128 [ V_40 ] ,
V_10 ) ) ) < 0 )
return V_14 ;
}
return 0 ;
}
int T_3 F_61 ( struct V_9 * V_10 )
{
V_10 -> V_129 = F_62 ( V_130 * 4 * 0x80 ) ;
if ( ! V_10 -> V_129 )
return - V_16 ;
return 0 ;
}
...
for ( V_40 = 0 ; V_40 < 0x80 ; V_40 ++ , V_121 ++ )
* V_121 = F_34 ( V_10 , V_40 , V_131 ) ;
}
