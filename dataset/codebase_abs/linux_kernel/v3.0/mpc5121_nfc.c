...
int V_107 = 0 ;
int V_108 , V_74 ;
V_108 = ( F_50 ( V_109 ) >> 4 ) & 0xF ;
if ( ( V_108 != 2 ) && ( V_108 != 3 ) ) {
F_42 ( V_34 , L_10 , V_108 ) ;
return - V_110 ;
}
...
V_107 = F_53 ( V_43 , 0 , & V_100 ) ;
if ( V_107 ) {
F_42 ( V_34 , L_14 ) ;
return V_107 ;
}
V_105 = F_54 ( V_43 , L_15 , & V_74 ) ;
if ( ! V_105 || V_74 != sizeof( * V_105 ) ) {
F_42 ( V_34 , L_16 ) ;
return - V_46 ;
}
V_103 = V_100 . V_113 ;
V_104 = V_100 . V_114 - V_100 . V_113 + 1 ;
if ( ! F_55 ( V_34 , V_103 , V_104 , V_115 ) ) {
F_42 ( V_34 , L_17 ) ;
return - V_90 ;
}
V_8 -> V_9 = F_56 ( V_34 , V_103 , V_104 ) ;
if ( ! V_8 -> V_9 ) {
F_42 ( V_34 , L_18 ) ;
return - V_45 ;
}
...
F_64 ( & V_8 -> V_29 ) ;
V_107 = F_65 ( V_34 , V_8 -> V_25 , & F_14 , 0 , V_115 ,
V_2 ) ;
if ( V_107 ) {
F_42 ( V_34 , L_26 ) ;
goto error;
}
if ( F_66 ( V_2 , F_67 ( V_105 ) ) ) {
F_42 ( V_34 , L_27 ) ;
F_68 ( V_34 , V_8 -> V_25 , V_2 ) ;
V_107 = - V_110 ;
goto error;
}
...
F_69 ( V_34 , V_2 ) ;
V_107 = F_70 ( V_2 , V_146 , & V_102 , 0 ) ;
#ifdef F_71
if ( V_107 == 0 )
V_107 = F_72 ( V_34 , V_43 , & V_102 ) ;
#endif
if ( V_107 < 0 ) {
F_42 ( V_34 , L_29 ) ;
F_68 ( V_34 , V_8 -> V_25 , V_2 ) ;
...
static int T_9 F_74 ( struct V_95 * V_96 )
{
struct V_93 * V_34 = & V_96 -> V_34 ;
