...
F_10 ( V_4 , 0 ) ;
F_6 ( V_25 L_4 ,
V_26 , V_11 -> V_27 , F_11 ( V_11 ) ,
F_12 () , V_11 , F_13 ( V_11 ) ) ;
if ( ! F_14 ( V_4 ) ) {
unsigned int V_28 = V_29 * 43 / 64 ;
unsigned int V_30 = V_29 ;
unsigned char V_31 ;
T_1 * V_32 ;
F_6 ( V_25 L_5 ) ;
F_4 ( NULL , V_4 , & V_4 -> V_14 , 0 , V_25 ) ;
F_6 ( V_25 L_6 ) ;
V_32 = ( T_1 * ) V_4 -> V_32 - V_28 ;
if ( V_32 < ( T_1 * ) V_33 || F_15 ( V_32 , V_31 ) ) {
V_32 = ( T_1 * ) V_4 -> V_32 ;
V_30 = V_30 - V_28 + 1 ;
}
for ( V_21 = 0 ; V_21 < V_30 ; V_21 ++ , V_32 ++ ) {
if ( V_32 < ( T_1 * ) V_33 ||
F_15 ( V_32 , V_31 ) ) {
F_6 ( L_7 ) ;
break;
}
if ( V_32 == ( T_1 * ) V_4 -> V_32 )
F_6 ( L_8 , V_31 ) ;
else
F_6 ( L_9 , V_31 ) ;
}
...
int F_16 ( unsigned long V_32 )
{
unsigned short V_34 ;
if ( V_32 < V_33 )
return 0 ;
if ( F_15 ( ( unsigned short * ) V_32 , V_34 ) )
return 0 ;
return V_34 == 0x0b0f ;
}
