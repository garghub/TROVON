...
} else if ( F_12 ( & V_48 , V_25 , sizeof( V_48 ) ) ) {
V_4 = - V_26 ;
goto V_24;
}
if ( V_50 . V_31 >= 20 && V_50 . V_25 < 512 ) {
memcpy ( & V_48 , & V_50 , sizeof( V_48 ) ) ;
V_50 . V_31 = V_48 . V_31 ;
V_50 . V_25 = V_48 . V_25 ;
V_50 . V_55 = V_48 . V_55 ;
V_50 . V_56 = 0 ;
...
if ( V_69 & V_70 )
F_25 ( V_57 , L_15 ,
V_2 -> V_11 , V_44 - 1 , V_46 ) ;
if ( V_50 . V_56 == 0 )
V_50 . V_56 = V_44 ;
F_13 ( V_50 . V_56 , V_43 ) ;
if ( V_2 -> V_35 & V_71 ) {
F_35 () ;
F_36 ( V_43 + 2 , V_51 , V_45 - 1 ) ;
F_35 () ;
F_37 ( V_51 [ V_45 - 1 ] , V_43 + V_45 + 1 ) ;
} else
F_36 ( V_43 + 2 , V_51 , V_45 ) ;
F_35 () ;
V_4 = sizeof( V_50 ) ;
V_24:
F_38 ( V_51 ) ;
