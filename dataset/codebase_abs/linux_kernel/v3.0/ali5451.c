...
static int F_143 ( struct V_249 * V_184 )
{
struct V_1 * V_2 = V_184 -> V_250 ;
F_127 ( V_2 ) ;
return 0 ;
}
...
V_251 = 32 ;
F_125 ( V_34 ) ;
F_150 ( V_34 , V_258 , & V_253 ) ;
if ( ( V_253 & V_259 ) != V_259 ) {
V_253 |= V_259 ;
F_151 ( V_34 , V_258 , V_253 ) ;
}
F_125 ( V_34 ) ;
if ( F_139 ( V_2 ) ) {
F_127 ( V_2 ) ;
...
V_2 -> V_48 . V_260 = 0 ;
if ( V_2 -> V_19 == V_20 )
V_2 -> V_16 . V_17 . V_21 = V_261 ;
else
V_2 -> V_16 . V_17 . V_21 = V_262 ;
V_2 -> V_16 . V_17 . V_18 = V_261 ;
V_2 -> V_16 . V_17 . V_263 = V_150 ;
V_2 -> V_16 . V_17 . V_60 = V_148 ;
V_2 -> V_16 . V_17 . V_86 = V_232 ;
V_2 -> V_16 . V_17 . V_46 = V_149 ;
V_2 -> V_16 . V_45 . V_263 = 0x00 ;
...
F_16 ( L_54 ) ;
V_153 = F_154 ( V_187 , V_265 , V_2 , & V_213 ) ;
if ( V_153 < 0 ) {
F_127 ( V_2 ) ;
return V_153 ;
}
F_155 ( V_187 , & V_34 -> V_266 ) ;
for ( V_113 = 0 ; V_113 < V_50 ; V_113 ++ )
...
#ifdef F_130
V_2 -> V_223 = F_156 ( sizeof( * V_2 -> V_223 ) , V_257 ) ;
if ( ! V_2 -> V_223 )
F_12 ( V_163 L_56 ) ;
#endif
F_24 ( V_2 ) ;
...
int V_153 ;
F_16 ( L_58 ) ;
V_153 = F_158 ( V_269 , V_270 , V_271 , 0 , & V_187 ) ;
if ( V_153 < 0 )
return V_153 ;
V_153 = F_144 ( V_187 , V_34 , V_272 , V_273 , & V_2 ) ;
if ( V_153 < 0 )
goto error;
V_187 -> V_24 = V_2 ;
F_16 ( L_59 ) ;
...
goto error;
F_136 ( V_2 ) ;
strcpy ( V_187 -> V_274 , L_61 ) ;
strcpy ( V_187 -> V_275 , L_46 ) ;
sprintf ( V_187 -> V_276 , L_62 ,
V_187 -> V_275 , V_2 -> V_3 , V_2 -> V_96 ) ;
F_16 ( L_63 ) ;
V_153 = F_159 ( V_187 ) ;
if ( V_153 < 0 )
goto error;
