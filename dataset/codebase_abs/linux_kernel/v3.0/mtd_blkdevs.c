...
if ( V_13 -> V_27 ) {
F_53 ( V_89 , V_67 -> V_7 ) ;
V_67 -> V_7 -> V_90 . V_91 = V_92 ;
}
V_70 -> V_93 = V_67 -> V_7 ;
V_67 -> V_46 = F_54 ( F_23 , V_67 ,
L_4 , V_13 -> V_86 , V_67 -> V_55 -> V_94 ) ;
if ( F_55 ( V_67 -> V_46 ) ) {
V_51 = F_56 ( V_67 -> V_46 ) ;
goto V_95;
}
V_70 -> V_96 = & V_67 -> V_55 -> V_3 ;
if ( V_67 -> V_79 )
F_57 ( V_70 , 1 ) ;
F_58 ( V_70 ) ;
if ( V_67 -> V_97 ) {
V_51 = F_59 ( & F_60 ( V_70 ) -> V_98 ,
V_67 -> V_97 ) ;
F_61 ( V_51 ) ;
}
return 0 ;
...
static void F_69 ( struct V_101 * V_55 )
{
struct V_12 * V_13 ;
...
static void F_71 ( struct V_101 * V_55 )
{
struct V_12 * V_13 ;
if ( V_55 -> type == V_104 )
return;
F_44 (tr, &blktrans_majors, list)
V_13 -> V_105 ( V_13 , V_55 ) ;
}
