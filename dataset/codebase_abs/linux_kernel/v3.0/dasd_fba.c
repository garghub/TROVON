...
V_146 = sprintf (page, KERN_ERR PRINTK_HEADER
L_20 ,
dev_name(&device->cdev->dev)) ;
V_146 += sprintf (page + len, KERN_ERR PRINTK_HEADER
L_21 , req,
...
if ( V_77 -> V_150 . V_151 . V_152 . V_153 ) {
...
F_56 ( V_155 L_3 , V_142 ) ;
V_143 = V_85 -> V_108 ;
for ( V_145 = V_143 ; V_145 -> V_14 & ( V_109 | V_114 ) ; V_145 ++ ) ;
V_144 = F_57 ( V_143 + 8 , V_145 ) ;
V_146 = sprintf (page, KERN_ERR PRINTK_HEADER
L_27 , req) ;
while ( V_143 <= V_144 ) {
V_146 += sprintf (page + len, KERN_ERR PRINTK_HEADER
...
F_56 ( V_155 L_3 , V_142 ) ;
V_146 = 0 ;
if ( V_143 < ( (struct V_4 * ) ( V_115 ) V_77 -> V_81 . V_30 . V_156 ) - 2 ) {
V_143 = ( (struct V_4 * ) ( V_115 ) V_77 -> V_81 . V_30 . V_156 ) - 2 ;
V_146 += sprintf (page + len, KERN_ERR PRINTK_HEADER L_30 ) ;
}
V_144 = F_57 ( (struct V_4 * ) ( V_115 ) V_77 -> V_81 . V_30 . V_156 + 2 , V_145 ) ;
while ( V_143 <= V_144 ) {
V_146 += sprintf (page + len, KERN_ERR PRINTK_HEADER
L_28 ,
act, ((int *) act)[0], ((int *) act)[1]) ;
