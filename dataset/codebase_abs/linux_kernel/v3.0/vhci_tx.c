...
F_13 ( & V_35 , 1 ) ;
V_31 [ 0 ] . V_37 = & V_35 ;
V_31 [ 0 ] . V_38 = sizeof( V_35 ) ;
V_32 += sizeof( V_35 ) ;
if ( ! F_4 ( V_3 -> V_9 ) && V_3 -> V_39 > 0 ) {
V_31 [ 1 ] . V_37 = V_3 -> V_40 ;
V_31 [ 1 ] . V_38 = V_3 -> V_39 ;
V_32 += V_3 -> V_39 ;
}
...
V_34 = F_17 ( V_8 -> V_43 . V_45 , & V_29 , V_31 , 3 , V_32 ) ;
if ( V_34 != V_32 ) {
F_18 ( L_3 , V_34 ,
V_32 ) ;
F_19 ( V_36 ) ;
...
F_2 ( L_5 , V_48 -> V_14 ) ;
V_35 . V_11 . V_12 = V_50 ;
V_35 . V_11 . V_14 = V_48 -> V_14 ;
V_35 . V_11 . V_10 = V_8 -> V_10 ;
V_35 . V_11 . V_18 = 0 ;
V_35 . V_20 . V_51 . V_14 = V_48 -> V_52 ;
F_13 ( & V_35 , 1 ) ;
V_31 [ 0 ] . V_37 = & V_35 ;
V_31 [ 0 ] . V_38 = sizeof( V_35 ) ;
V_32 += sizeof( V_35 ) ;
V_34 = F_17 ( V_8 -> V_43 . V_45 , & V_29 , V_31 , 1 , V_32 ) ;
if ( V_34 != V_32 ) {
F_18 ( L_3 , V_34 ,
V_32 ) ;
F_16 ( & V_8 -> V_43 , V_46 ) ;
