...
switch ( V_104 -> V_108 . V_109 . V_110 ) {
case V_111 :
...
V_107 . V_126 = 0 ;
V_107 . V_127 = 0 ;
F_13 ( V_20 , V_128 , V_129 , ( T_1 * ) & V_107 , sizeof( V_107 ) , NULL , 0 ) ;
F_13 ( V_20 , V_128 , V_130 , ( T_1 * ) & V_107 , sizeof( V_107 ) , NULL , 0 ) ;
F_17 ( V_20 ) ;
if ( ( V_21 = F_26 ( V_20 , V_104 -> V_131 ) ) < 0 )
return V_21 ;
...
static int F_29 ( struct V_55 * V_56 , struct V_132 * V_133 )
{
V_133 -> V_134 = 1000 ;
V_133 -> V_135 = 0 ;
V_133 -> V_136 = 0 ;
...
int V_21 , V_22 ;
F_5 ( L_14 ) ;
if ( ( V_21 = V_20 -> V_11 -> V_145 ( V_56 , & V_144 , V_146 ) ) < 0 ) {
V_7 ( L_15 , V_146 , V_21 ) ;
return V_21 ;
}
F_5 ( L_16 , V_144 -> V_90 ) ;
V_6 = V_144 -> V_92 ;
for ( V_22 = 0 ; V_22 < V_144 -> V_90 ; ) {
V_10 = F_34 ( * ( ( T_5 * ) & V_6 [ V_22 ] ) ) ;
V_5 = F_34 ( * ( ( T_5 * ) & V_6 [ V_22 + 2 ] ) ) ;
F_5 ( L_17 , V_10 , V_5 , V_144 -> V_90 ) ;
...
memset ( & V_83 , 0 , 1 ) ;
V_83 . V_172 = 1 ;
F_13 ( V_20 , V_173 , V_174 , ( T_1 * ) & V_83 , sizeof( V_83 ) , NULL , 0 ) ;
return 0 ;
}
struct V_55 * F_41 ( const struct V_175 * V_11 ,
struct V_176 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_21 ;
...
goto error;
F_5 ( L_31 , V_18 . V_181 . V_182 , V_18 . V_181 . V_183 ) ;
if ( ( V_18 . V_181 . V_182 != 0x1 && V_18 . V_181 . V_183 != 0xb ) &&
( V_18 . V_181 . V_182 != 0x8 && V_18 . V_181 . V_183 != 0x0 ) )
goto error;
F_44 ( L_32 , V_18 . V_181 . V_182 , V_18 . V_181 . V_183 ) ;
F_37 ( V_2 ) ;
return & V_2 -> V_165 ;
error:
F_31 ( V_2 ) ;
