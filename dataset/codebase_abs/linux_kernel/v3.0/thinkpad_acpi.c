...
static const struct V_3 V_324 [] V_305 = {
{
. V_6 = V_15 ,
. V_9 = V_8 , . V_11 = V_8 ,
. V_13 = V_302 ,
...
if ( V_17 )
goto V_334;
if ( F_7 ( V_131 , & V_325 , L_104 , L_105 ) ) {
if ( ( V_325 >> 8 ) != 1 ) {
F_8 ( L_106 ,
V_325 ) ;
F_8 ( L_107 , V_335 ) ;
...
V_328 = F_4 ( V_324 ,
F_98 ( V_324 ) ) ;
F_23 ( V_328 >= F_98 ( V_304 ) ) ;
F_20 ( V_55 | V_298 ,
L_119 , V_328 ) ;
memcpy ( V_214 , & V_304 [ V_328 ] ,
F_182 ) ;
F_188 ( V_210 , V_216 , V_217 ) ;
V_210 -> V_339 = F_183 ;
V_210 -> V_340 = V_341 ;
V_210 -> V_213 = V_214 ;
for ( V_42 = 0 ; V_42 < V_341 ; V_42 ++ ) {
if ( V_214 [ V_42 ] != V_215 ) {
F_188 ( V_210 , V_342 ,
V_214 [ V_42 ] ) ;
} else {
...
if ( V_189 . V_190 ) {
F_188 ( V_210 , V_343 , V_295 ) ;
F_120 ( V_210 ,
V_295 , V_326 ) ;
}
if ( V_189 . V_208 ) {
F_188 ( V_210 , V_343 , V_211 ) ;
F_120 ( V_210 ,
V_211 , V_327 ) ;
}
if ( V_189 . V_344 && F_189 () ) {
F_74 ( L_120
L_121
L_122 ) ;
F_31 ( L_123
...
static bool F_190 ( const T_7 V_331 ,
bool * V_346 ,
bool * V_347 )
{
unsigned int V_212 = V_331 & 0xfff ;
* V_346 = true ;
* V_347 = false ;
if ( V_212 > 0 && V_212 <= V_341 ) {
V_212 -- ;
if ( ! ( V_196 & ( 1 << V_212 ) ) ) {
F_125 ( V_212 ) ;
* V_346 = false ;
...
static bool F_191 ( const T_7 V_331 ,
bool * V_346 ,
bool * V_347 )
{
* V_346 = true ;
...
static bool F_193 ( const T_7 V_331 ,
bool * V_346 ,
bool * V_347 )
{
* V_346 = true ;
...
static bool F_194 ( const T_7 V_331 ,
bool * V_346 ,
bool * V_347 )
{
* V_346 = true ;
...
static bool F_195 ( const T_7 V_331 ,
bool * V_346 ,
bool * V_347 )
{
bool V_367 = true ;
...
switch ( V_331 >> 12 ) {
case 1 :
V_375 = F_190 ( V_331 , & V_346 ,
& V_347 ) ;
break;
case 2 :
V_375 = F_191 ( V_331 , & V_346 ,
& V_347 ) ;
break;
case 3 :
switch ( V_331 ) {
...
break;
case 4 :
V_375 = F_193 ( V_331 , & V_346 ,
& V_347 ) ;
break;
case 5 :
V_375 = F_194 ( V_331 , & V_346 ,
& V_347 ) ;
break;
case 6 :
V_375 = F_195 ( V_331 , & V_346 ,
& V_347 ) ;
break;
case 7 :
if ( V_189 . V_190 &&
...
static int F_209 ( enum V_383 V_110 )
{
int V_30 ;
F_17 ( V_142 ,
L_167 ,
...
static int F_219 ( enum V_383 V_110 )
{
int V_30 ;
F_17 ( V_142 ,
L_177 ,
...
static int F_228 ( enum V_383 V_110 )
{
int V_30 ;
F_17 ( V_142 ,
L_187 ,
...
{
if ( ! F_7 ( V_414 , NULL , L_211 , L_9 , ( V_207 ) ? 1 : 0 ) )
return - V_50 ;
return 0 ;
}
...
static void F_244 ( struct V_438 * V_439 )
{
struct V_440 * V_63 =
F_245 ( V_439 , struct V_440 , V_439 ) ;
if ( F_137 ( V_66 == V_67 ) )
F_243 ( ( V_63 -> V_441 != V_442 ) ) ;
}
static void F_246 ( struct V_443 * V_444 ,
enum V_445 V_446 )
{
struct V_440 * V_63 =
F_245 ( V_444 ,
...
V_448 : V_442 ;
F_247 ( V_449 , & V_63 -> V_439 ) ;
}
static enum V_445 F_248 ( struct V_443 * V_444 )
{
return ( F_242 () == 1 ) ? V_450 : V_447 ;
}
...
F_184 ( V_453 ) ;
F_250 ( & V_454 . V_439 , F_244 ) ;
V_189 . V_434 = ( V_48 || V_437 ) && ! V_455 ;
if ( V_189 . V_434 )
V_189 . V_433 =
...
static inline bool F_266 ( const unsigned int V_458 )
{
#ifdef F_267
return false ;
#else
...
static int F_268 ( const unsigned int V_458 )
{
int V_30 ;
enum V_460 V_461 ;
switch ( V_462 ) {
...
static int F_269 ( const unsigned int V_458 ,
...
static void F_270 ( struct V_438 * V_439 )
{
struct V_440 * V_63 =
F_245 ( V_439 , struct V_440 , V_439 ) ;
if ( F_137 ( V_66 == V_67 ) )
F_269 ( V_63 -> V_458 , V_63 -> V_441 ) ;
}
static void F_271 ( struct V_443 * V_444 ,
enum V_445 V_446 )
{
struct V_440 * V_63 = F_245 ( V_444 ,
struct V_440 , V_443 ) ;
if ( V_446 == V_447 )
V_63 -> V_441 = V_442 ;
...
static int F_272 ( struct V_443 * V_444 ,
...
static enum V_445 F_273 ( struct V_443 * V_444 )
{
int V_70 ;
struct V_440 * V_63 = F_245 ( V_444 ,
struct V_440 , V_443 ) ;
V_70 = F_268 ( V_63 -> V_458 ) ;
...
F_253 ( & V_478 [ V_42 ] . V_443 ) ;
}
F_36 ( V_478 ) ;
}
static int T_1 F_275 ( unsigned int V_458 )
{
int V_70 ;
V_478 [ V_458 ] . V_458 = V_458 ;
if ( ! V_479 [ V_458 ] )
return 0 ;
V_478 [ V_458 ] . V_443 . V_480 = & F_271 ;
V_478 [ V_458 ] . V_443 . V_481 = & F_272 ;
if ( V_462 == V_463 )
V_478 [ V_458 ] . V_443 . V_482 =
& F_273 ;
V_478 [ V_458 ] . V_443 . V_51 = V_479 [ V_458 ] ;
F_250 ( & V_478 [ V_458 ] . V_439 , F_270 ) ;
V_70 = F_251 ( & V_156 -> V_157 ,
& V_478 [ V_458 ] . V_443 ) ;
if ( V_70 < 0 )
...
static enum V_483 T_1 F_276 ( void )
{
T_4 V_30 ;
if ( F_6 () ) {
...
return - V_72 ;
while ( ( V_162 = F_44 ( & V_128 ) ) ) {
if ( sscanf ( V_162 , L_262 , & V_458 ) != 1 || V_458 < 0 || V_458 > 15 )
return - V_92 ;
...
static int F_285 ( int V_493 , T_18 * V_38 )
{
int V_160 ;
T_19 V_494 ;
char V_495 [ 5 ] ;
...
static int F_286 ( struct V_506 * V_120 )
{
int V_17 , V_42 ;
int V_222 ;
V_222 = 8 ;
...
V_17 = F_285 ( V_42 , & V_120 -> V_507 [ V_42 ] ) ;
if ( V_17 )
return V_17 ;
}
return V_222 ;
...
F_31 ( L_269 ) ;
for ( V_42 = 0 ; V_42 < V_222 ; V_42 ++ ) {
if ( V_160 . V_507 [ V_42 ] != V_508 )
F_287 ( L_270 , ( int ) ( V_160 . V_507 [ V_42 ] / 1000 ) ) ;
else
F_287 ( L_271 ) ;
}
F_287 ( L_272 ) ;
...
V_512 = V_513 = 0 ;
for ( V_42 = 0 ; V_42 < 8 ; V_42 ++ ) {
if ( F_11 ( V_496 + V_42 , & V_160 ) ) {
V_512 |= V_160 ;
} else {
V_512 = 0 ;
break;
}
if ( F_11 ( V_500 + V_42 , & V_160 ) ) {
V_513 |= V_160 ;
} else {
V_512 = 0 ;
break;
...
F_82 ( V_89 , L_281 , V_160 . V_507 [ V_42 ] / 1000 ) ;
F_82 ( V_89 , L_42 , V_160 . V_507 [ V_42 ] / 1000 ) ;
} else
F_82 ( V_89 , L_282 ) ;
return 0 ;
}
...
static int F_299 ( struct V_536 * V_537 )
{
unsigned int V_56 =
...
if ( F_296 ( & V_552 ) < 0 )
return 1 ;
memset ( & V_538 , 0 , sizeof( struct V_554 ) ) ;
V_538 . type = V_560 ;
V_538 . V_561 = V_519 ;
V_538 . V_446 = V_552 & V_528 ;
V_542 = F_306 ( V_562 ,
NULL , NULL ,
& V_563 ,
& V_538 ) ;
if ( F_148 ( V_542 ) ) {
int V_70 = F_307 ( V_542 ) ;
V_542 = NULL ;
F_8 ( L_308 ) ;
return V_70 ;
}
...
if ( F_158 ( & V_577 ) < 0 )
return;
if ( F_139 ( ! F_11 ( V_578 , & V_520 ) ) )
goto V_527;
V_520 &= V_569 ;
V_521 = F_130 ( V_250 ) ;
if ( V_520 != ( V_521 & V_569 ) ) {
V_521 &= ~ V_569 ;
V_521 |= V_520 ;
F_295 ( V_521 , V_250 ) ;
F_20 ( V_573 ,
...
static int F_323 ( const T_6 V_579 )
{
int V_70 ;
T_6 V_120 , V_222 ;
if ( V_579 > V_580 )
...
static int F_324 ( const T_6 V_579 )
{
F_20 ( V_573 ,
L_333 , V_579 ) ;
return F_323 ( V_579 ) ;
...
static int F_327 ( struct V_587 * V_588 ,
struct V_589 * V_590 )
{
V_590 -> type = V_591 ;
V_590 -> V_35 = 1 ;
V_590 -> V_38 . integer . V_592 = 0 ;
V_590 -> V_38 . integer . V_129 = V_580 ;
return 0 ;
}
static int F_328 ( struct V_587 * V_588 ,
struct V_593 * V_594 )
{
T_6 V_120 ;
int V_70 ;
...
if ( V_70 < 0 )
return V_70 ;
V_594 -> V_38 . integer . V_38 [ 0 ] = V_120 & V_576 ;
return 0 ;
}
static int F_329 ( struct V_587 * V_588 ,
struct V_593 * V_594 )
{
F_80 ( L_334 , L_335 ,
V_594 -> V_38 . integer . V_38 [ 0 ] ) ;
return F_324 ( V_594 -> V_38 . integer . V_38 [ 0 ] ) ;
}
static int F_330 ( struct V_587 * V_588 ,
struct V_593 * V_594 )
{
T_6 V_120 ;
int V_70 ;
...
static int F_331 ( struct V_587 * V_588 ,
struct V_593 * V_594 )
{
F_80 ( L_334 , L_336 ,
V_594 -> V_38 . integer . V_38 [ 0 ] ?
L_40 : L_1 ) ;
return F_321 ( ! V_594 -> V_38 . integer . V_38 [ 0 ] ) ;
}
...
struct V_587 * V_598 ;
int V_70 ;
V_70 = F_338 ( V_599 , V_600 , V_601 ,
sizeof( struct V_581 ) , & V_596 ) ;
if ( V_70 < 0 || ! V_596 ) {
F_8 ( L_337 , V_70 ) ;
return 1 ;
}
...
V_63 = V_596 -> V_583 ;
V_63 -> V_596 = V_596 ;
F_339 ( V_596 -> V_79 , V_602 ,
sizeof( V_596 -> V_79 ) ) ;
F_339 ( V_596 -> V_603 , V_604 ,
sizeof( V_596 -> V_603 ) ) ;
snprintf ( V_596 -> V_605 , sizeof( V_596 -> V_605 ) , L_338 ,
( V_7 . V_606 ) ?
V_7 . V_606 : L_339 ) ;
snprintf ( V_596 -> V_607 , sizeof( V_596 -> V_607 ) ,
L_340 , V_596 -> V_603 , V_578 ,
( V_7 . V_606 ) ?
V_7 . V_606 : L_341 ) ;
if ( V_572 ) {
V_608 . V_609 = F_329 ;
...
if ( ! V_189 . V_574 ) {
V_597 = F_340 ( & V_608 , NULL ) ;
V_70 = F_341 ( V_596 , V_597 ) ;
if ( V_70 < 0 ) {
F_8 ( L_342 ,
V_70 ) ;
goto V_334;
}
V_63 -> V_586 = & V_597 -> V_146 ;
}
V_598 = F_340 ( & V_612 , NULL ) ;
V_70 = F_341 ( V_596 , V_598 ) ;
if ( V_70 < 0 ) {
F_8 ( L_343 , V_70 ) ;
goto V_334;
}
V_63 -> V_584 = & V_598 -> V_146 ;
F_342 ( V_596 , & V_156 -> V_157 ) ;
V_70 = F_343 ( V_596 ) ;
if ( V_70 < 0 ) {
F_8 ( L_344 , V_70 ) ;
goto V_334;
...
V_629 -- ;
continue;
} else if ( sscanf ( V_162 , L_367 , & V_631 ) == 1 &&
V_631 >= 0 && V_631 <= V_580 ) {
V_629 = V_631 ;
continue;
}
...
F_80 ( L_370 ,
L_371 ,
V_630 ? L_1 : L_40 , V_629 ) ;
V_70 = F_319 ( V_630 | V_629 ) ;
}
F_325 () ;
return ( V_70 == - V_568 ) ? - V_288 : V_70 ;
}
...
static void F_348 ( T_6 * V_635 )
{
if ( F_139 ( V_189 . V_634 ) ) {
if ( * V_635 != V_633 ) {
V_189 . V_634 = 0 ;
} else {
* V_635 = V_636 ;
...
if ( V_189 . V_637 ) {
T_6 V_638 ;
if ( F_12 ( V_639 , & V_638 ) < 0 )
return false ;
V_638 &= 0xFEU ;
if ( F_14 ( V_639 , V_638 ) < 0 )
return false ;
}
return true ;
}
...
switch ( V_642 ) {
case V_643 :
if ( F_139 ( ! F_7 ( V_644 , & V_120 , NULL , L_62 ) ) )
return - V_50 ;
if ( F_137 ( V_30 ) )
* V_30 = V_120 & 0x07 ;
break;
case V_645 :
if ( F_139 ( ! F_11 ( V_646 , & V_120 ) ) )
return - V_50 ;
if ( F_137 ( V_30 ) ) {
* V_30 = V_120 ;
F_348 ( V_30 ) ;
...
static int F_354 ( unsigned int * V_648 )
{
T_6 V_649 , V_650 ;
switch ( V_642 ) {
case V_645 :
...
static int F_355 ( unsigned int * V_648 )
{
T_6 V_649 , V_650 ;
bool V_70 ;
switch ( V_642 ) {
...
case V_654 :
if ( V_56 >= 0 && V_56 <= 7 ) {
if ( ! F_7 ( V_655 , NULL , NULL , L_9 , V_56 ) )
return - V_50 ;
} else
return - V_92 ;
break;
...
V_120 &= 0x07 ;
V_120 |= 4 ;
if ( ! F_7 ( V_655 , NULL , NULL , L_9 , V_120 ) )
V_70 = - V_50 ;
else
V_70 = 0 ;
break;
...
break;
case V_654 :
if ( ! F_7 ( V_655 , NULL , NULL , L_9 , 0x00 ) )
V_70 = - V_50 ;
else
V_641 = 0 ;
break;
...
switch ( V_653 ) {
case V_656 :
if ( V_648 >= 0 && V_648 <= 65535 ) {
if ( ! F_7 ( V_660 , NULL , NULL , L_377 ,
V_648 , V_648 , V_648 ) )
V_70 = - V_50 ;
} else
V_70 = - V_92 ;
...
static void F_365 ( struct V_438 * V_665 )
{
int V_70 ;
if ( V_66 != V_67 )
return;
...
if ( V_17 < 0 )
return V_17 ;
return snprintf ( V_128 , V_103 , L_385 , V_648 ) ;
}
...
char * V_128 )
{
return snprintf ( V_128 , V_103 , L_385 , V_664 ) ;
}
...
static void F_385 ( const unsigned int V_688 )
{
if ( V_542 ) {
switch ( V_688 ) {
case V_689 :
...
L_432 , V_65 -> V_51 ) ;
if ( V_65 -> V_91 ) {
T_20 V_666 = V_301 -> V_705 ;
if ( ! V_666 )
V_666 = V_706 ;
if ( V_65 -> V_102 )
V_666 |= V_707 ;
V_701 = F_394 ( V_65 -> V_51 , V_666 , V_698 ,
& V_708 , V_65 ) ;
if ( ! V_701 ) {
F_8 ( L_433 , V_65 -> V_51 ) ;
V_101 = - V_72 ;
...
return 0 ;
V_120 = F_400 ( V_714 ) ;
V_711 -> V_715 = F_401 ( V_120 , V_81 ) ;
if ( V_120 && ! V_711 -> V_715 )
return - V_82 ;
if ( ! F_397 ( V_711 -> V_715 , 'E' ) )
return 0 ;
V_711 -> V_10 = V_711 -> V_715 [ 0 ]
| ( V_711 -> V_715 [ 1 ] << 8 ) ;
V_711 -> V_187 = ( V_711 -> V_715 [ 4 ] << 8 )
| V_711 -> V_715 [ 5 ] ;
while ( ( V_157 = F_402 ( V_716 , NULL , V_157 ) ) ) {
if ( sscanf ( V_157 -> V_51 ,
L_437 ,
V_713 ) == 1 ) {
V_713 [ sizeof( V_713 ) - 1 ] = 0 ;
V_713 [ strcspn ( V_713 , L_438 ) ] = 0 ;
V_711 -> V_606 = F_401 ( V_713 , V_81 ) ;
if ( ! V_711 -> V_606 )
return - V_82 ;
if ( F_397 ( V_713 , 'H' ) ) {
V_711 -> V_12 = V_713 [ 0 ]
| ( V_713 [ 1 ] << 8 ) ;
V_711 -> V_188 = ( V_713 [ 4 ] << 8 )
| V_713 [ 5 ] ;
} else {
F_31 ( L_439
L_440 ,
...
V_711 -> V_718 = F_401 ( V_120 , V_81 ) ;
if ( ! V_711 -> V_718 )
return - V_82 ;
}
V_120 = F_400 ( V_719 ) ;
V_711 -> V_720 = F_401 ( V_120 , V_81 ) ;
if ( V_120 && ! V_711 -> V_720 )
return - V_82 ;
return 0 ;
}
...
if ( ! F_6 () && ! F_5 () )
return - V_72 ;
V_721 = ( V_7 . V_718 != NULL ) ||
( V_7 . V_12 != 0 ) ||
F_105 () ;
F_22 ( L_442 , V_723 , & V_430 ) ;
if ( ! V_430 ) {
if ( V_721 )
F_8 ( L_443 ) ;
return - V_72 ;
...
static int T_1 F_406 ( const char * V_638 , struct V_726 * V_727 )
{
unsigned int V_42 ;
struct V_64 * V_65 ;
if ( ! V_727 || ! V_727 -> V_51 || ! V_638 )
return - V_92 ;
for ( V_42 = 0 ; V_42 < F_98 ( V_728 ) ; V_42 ++ ) {
V_65 = V_728 [ V_42 ] . V_63 ;
F_407 ( V_65 == NULL ) ;
if ( ! V_65 || ! V_65 -> V_51 )
continue;
if ( strcmp ( V_65 -> V_51 , V_727 -> V_51 ) == 0 && V_65 -> V_102 ) {
if ( strlen ( V_638 ) > sizeof( V_728 [ V_42 ] . V_729 ) - 2 )
return - V_730 ;
strcpy ( V_728 [ V_42 ] . V_729 , V_638 ) ;
strcat ( V_728 [ V_42 ] . V_729 , L_26 ) ;
return 0 ;
}
}
return - V_92 ;
...
V_698 = F_418 ( V_740 , V_741 ) ;
if ( ! V_698 ) {
F_8 ( L_450 V_740 L_272 ) ;
F_408 () ;
return - V_72 ;
}
V_101 = F_419 ( & V_737 ) ;
...
V_210 -> V_51 = L_459 ;
V_210 -> V_747 = V_745 L_460 ;
V_210 -> V_146 . V_748 = V_749 ;
...
F_304 () ;
for ( V_42 = 0 ; V_42 < F_98 ( V_728 ) ; V_42 ++ ) {
V_101 = F_392 ( & V_728 [ V_42 ] ) ;
if ( V_101 >= 0 && * V_728 [ V_42 ] . V_729 )
V_101 = V_728 [ V_42 ] . V_63 -> V_102 ( V_728 [ V_42 ] . V_729 ) ;
if ( V_101 < 0 ) {
F_408 () ;
return V_101 ;
}
