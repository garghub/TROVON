...
static int T_4 F_29 ( struct V_112 * V_113 )
{
...
if ( V_72 )
goto V_119;
V_116 = F_33 ( V_113 , V_120 , 0 ) ;
if ( ! V_116 ) {
V_72 = - V_121 ;
goto V_119;
}
V_116 = F_34 ( V_116 -> V_41 , F_35 ( V_116 ) , V_113 -> V_122 ) ;
if ( ! V_116 ) {
V_72 = - V_123 ;
goto V_119;
}
V_2 -> V_116 = V_116 ;
V_2 -> V_4 = F_36 ( V_116 -> V_41 , F_35 ( V_116 ) ) ;
if ( ! V_2 -> V_4 ) {
V_72 = - V_121 ;
goto V_119;
}
strcpy ( V_9 -> V_27 . V_124 , V_113 -> V_122 ) ;
V_9 -> V_125 = & V_126 ;
V_9 -> V_27 . type = V_127 ;
...
F_45 ( V_2 -> V_4 ) ;
if ( V_2 -> V_116 )
F_46 ( V_2 -> V_116 -> V_41 , F_35 ( V_2 -> V_116 ) ) ;
F_28 ( V_9 ) ;
if ( & V_9 -> V_118 )
F_47 ( & V_9 -> V_118 ) ;
if ( V_2 -> V_13 -> V_140 )
V_2 -> V_13 -> V_140 ( V_113 ) ;
F_48 ( V_9 ) ;
F_31 ( V_113 , NULL ) ;
return V_72 ;
}
static int T_5 F_49 ( struct V_112 * V_113 )
{
struct V_8 * V_9 = F_50 ( V_113 ) ;
struct V_1 * V_2 = V_9 -> V_10 ;
F_51 ( V_9 ) ;
F_19 ( V_2 -> V_62 ) ;
F_44 ( V_2 -> V_62 ) ;
