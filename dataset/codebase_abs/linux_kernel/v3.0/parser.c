...
int F_8 ( T_1 * V_1 , int * V_14 )
{
return F_5 ( V_1 , V_14 , 0 ) ;
}
int F_9 ( T_1 * V_1 , int * V_14 )
{
...
T_2 F_11 ( char * V_22 , const T_1 * V_23 , T_2 V_24 )
{
T_2 V_18 = V_23 -> V_9 - V_23 -> V_7 ;
if ( V_24 ) {
T_2 V_5 = V_18 >= V_24 ? V_24 - 1 : V_18 ;
memcpy ( V_22 , V_23 -> V_7 , V_5 ) ;
V_22 [ V_5 ] = '\0' ;
}
return V_18 ;
}
char * F_12 ( const T_1 * V_1 )
{
T_2 V_25 = V_1 -> V_9 - V_1 -> V_7 + 1 ;
char * V_2 = F_6 ( V_25 , V_19 ) ;
if ( V_2 )
F_11 ( V_2 , V_1 , V_25 ) ;
return V_2 ;
}
