...
{
struct V_5 * V_6 = V_2 -> V_6 ;
return F_29 ( V_2 -> V_63 -> V_64 -> V_36 , V_62 ,
V_6 -> V_65 ,
V_6 -> V_12 ,
V_6 -> V_66 ) ;
}
static void F_30 ( struct V_67 * V_63 )
{
F_31 ( V_63 ) ;
}
static int F_32 ( struct V_68 * V_64 ,
struct V_69 * V_70 , struct V_67 * V_63 )
{
if ( ! V_64 -> V_36 -> V_71 )
V_64 -> V_36 -> V_71 = & V_72 ;
if ( ! V_64 -> V_36 -> V_73 )
V_64 -> V_36 -> V_73 = F_33 ( 32 ) ;
F_34 ( V_63 , V_74 ,
V_64 -> V_36 , 4 * 1024 , ( 4 * 1024 ) - 1 ) ;
return 0 ;
}
static int T_6 F_35 ( struct V_75 * V_76 )
{
return F_36 ( & V_76 -> V_36 , & V_77 ) ;
}
static int T_7 F_37 ( struct V_75 * V_76 )
{
F_38 ( & V_76 -> V_36 ) ;
return 0 ;
}
static int T_8 F_39 ( void )
{
return F_40 ( & V_78 ) ;
}
