...
F_37 ( V_199 L_25 ,
V_94 -> V_200 -> V_201 , V_94 -> V_202 >> 3 , V_94 -> V_202 & 7 ,
V_94 -> V_142 ) ;
F_87 ( V_94 ) ;
if ( F_88 ( V_94 , F_89 ( 64 ) ) ) {
...
V_71 = F_91 ( & V_205 , sizeof( struct V_1 ) ) ;
if ( ! V_71 ) {
F_37 ( V_87 L_28 ) ;
goto V_206;
}
V_2 = (struct V_1 * ) V_71 -> V_148 ;
V_2 -> V_69 = (struct V_207 * ) V_163 -> V_208 ;
V_2 -> V_94 = V_94 ;
V_2 -> V_71 = V_71 ;
V_2 -> V_85 = 0 ;
V_2 -> V_128 = 0 ;
...
if ( V_2 -> V_69 -> V_214 ( V_2 ) )
goto V_215;
if ( V_2 -> V_69 -> V_216 ( V_2 , 20000 ) ) {
F_37 ( V_87 L_29 ,
V_2 -> V_71 -> V_88 ) ;
goto V_217;
}
if ( V_2 -> V_69 -> V_218 ) {
if ( V_2 -> V_69 -> V_218 ( V_2 ) ) {
F_37 ( V_87 L_30 ,
V_2 -> V_71 -> V_88 ) ;
goto V_217;
}
}
if ( V_2 -> V_69 -> V_219 ( V_2 , & V_192 ) ) {
F_37 ( V_87 L_31 ,
V_2 -> V_71 -> V_88 ) ;
goto V_217;
}
V_2 -> V_182 = F_93 ( F_54 ( V_192 . V_182 ) ,
V_220 ) ;
V_2 -> V_166 = F_54 ( V_192 . V_166 ) ;
V_2 -> V_221 = F_54 ( V_192 . V_222 ) ;
V_2 -> V_154 = F_54 ( V_192 . V_223 ) ;
V_2 -> V_189 = F_54 ( V_192 . V_189 ) ;
V_2 -> V_224 = F_54 ( V_192 . V_224 ) ;
V_2 -> V_225 = F_54 ( V_192 . V_225 ) ;
if ( V_2 -> V_189 > 0x01020000 ||
V_2 -> V_224 > 0x01020000 )
V_2 -> V_128 = 1 ;
V_71 -> V_226 = F_54 ( V_192 . V_227 ) >> 9 ;
V_71 -> V_228 = F_54 ( V_192 . V_166 ) ;
V_71 -> V_229 = F_54 ( V_192 . V_223 ) ;
V_71 -> V_230 = F_54 ( V_192 . V_182 ) ;
V_71 -> V_231 = F_54 ( V_192 . V_182 ) ;
V_71 -> V_232 = 16 ;
V_197 = sizeof( struct V_44 )
+ sizeof( struct V_145 ) * ( V_2 -> V_154 - 1 ) ;
if ( ( V_197 & 0x1f ) != 0 )
V_197 = ( V_197 + 0x1f ) & ~ 0x1f ;
memset ( & V_193 , 0 , sizeof( struct V_81 ) ) ;
V_193 . V_233 = F_21 ( V_71 -> V_88 ) ;
V_193 . V_234 = F_94 ( V_71 -> V_88 ) ;
V_193 . V_235 = F_94 ( V_197 ) ;
if ( V_2 -> V_69 -> V_193 ( V_2 , & V_193 ) ) {
F_37 ( V_87 L_32 ,
V_2 -> V_71 -> V_88 ) ;
goto V_217;
}
F_95 ( V_94 , V_71 ) ;
if ( F_96 ( V_94 -> V_142 , F_58 , V_236 ,
V_204 , V_2 ) ) {
F_37 ( V_87 L_33 ,
V_2 -> V_71 -> V_88 , V_94 -> V_142 ) ;
goto V_217;
}
F_12 ( L_34 , V_197 , V_2 -> V_182 ) ;
V_2 -> V_197 = V_197 ;
V_195 = F_82 ( & V_94 -> V_184 ,
V_2 -> V_197 * V_2 -> V_182 + 0x20 ,
& V_194 , V_190 ) ;
if ( ! V_195 ) {
F_37 ( V_87 L_35 ,
V_2 -> V_71 -> V_88 ) ;
...
V_2 -> V_50 [ V_5 ] . V_51 = V_195 ;
V_2 -> V_50 [ V_5 ] . V_158 = V_194 >> 5 ;
V_2 -> V_50 [ V_5 ] . V_89 = V_5 ;
F_51 ( V_2 , & V_2 -> V_50 [ V_5 ] ) ;
V_195 = ( char * ) V_195 + V_2 -> V_197 ;
V_194 = V_194 + V_2 -> V_197 ;
}
if ( F_36 ( V_2 ) )
goto V_240;
...
{
T_1 V_244 ;
V_244 = F_2 ( & V_2 -> V_6 . V_7 . V_8 -> V_83 ) ;
F_4 ( V_244 |
V_26 | V_29 ,
& V_2 -> V_6 . V_7 . V_8 -> V_83 ) ;
