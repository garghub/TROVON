...
case V_50 :
case V_51 :
args . V_172 . V_375 = V_152 ;
break;
case V_49 :
case V_52 :
if ( V_8 -> V_14 & V_36 )
args . V_172 . V_375 = V_376 ;
else
args . V_172 . V_375 = V_377 ;
break;
case V_53 :
case V_55 :
case V_54 :
args . V_172 . V_375 = V_378 ;
break;
case V_111 :
case V_112 :
if ( V_8 -> V_63 & ( V_99 ) )
args . V_172 . V_375 = V_379 ;
else if ( V_8 -> V_63 & ( V_26 ) )
args . V_172 . V_375 = V_380 ;
else
args . V_172 . V_375 = V_381 ;
break;
case V_115 :
case V_116 :
if ( V_8 -> V_63 & ( V_99 ) )
...
args . V_172 . V_375 = V_382 ;
break;
}
break;
case 2 :
args . V_178 . V_340 = V_282 -> V_337 ;
args . V_178 . V_383 = F_31 ( V_2 ) ;
switch ( V_8 -> V_48 ) {
case V_56 :
case V_58 :
case V_59 :
...
switch ( V_163 -> V_230 ) {
case 0 :
args . V_178 . V_384 = V_385 ;
break;
case 1 :
args . V_178 . V_384 = V_386 ;
break;
case 2 :
args . V_178 . V_384 = V_387 ;
break;
case 3 :
args . V_178 . V_384 = V_388 ;
break;
case 4 :
args . V_178 . V_384 = V_389 ;
break;
case 5 :
args . V_178 . V_384 = V_390 ;
break;
}
break;
case V_54 :
args . V_178 . V_384 = V_391 ;
break;
case V_112 :
if ( V_8 -> V_63 & ( V_99 ) )
args . V_178 . V_384 = V_392 ;
else if ( V_8 -> V_63 & ( V_26 ) )
args . V_178 . V_384 = V_392 ;
else
args . V_178 . V_384 = V_393 ;
break;
case V_116 :
if ( V_8 -> V_63 & ( V_99 ) )
args . V_178 . V_384 = V_392 ;
...
struct V_8 * V_8 = F_2 ( V_2 ) ;
struct V_282 * V_282 = F_39 ( V_2 -> V_281 ) ;
if ( ( V_4 -> V_395 -> V_396 == 0x71C5 ) &&
( V_4 -> V_395 -> V_397 == 0x106b ) &&
( V_4 -> V_395 -> V_398 == 0x0080 ) ) {
if ( V_8 -> V_14 & V_36 ) {
T_1 V_399 = F_46 ( V_400 ) ;
V_399 &= ~ V_401 ;
V_399 &= ~ V_402 ;
F_47 ( V_400 , V_399 ) ;
}
...
if ( F_35 ( V_6 ) ) {
if ( V_97 -> V_87 & V_98 )
F_47 ( V_403 + V_282 -> V_404 ,
V_405 ) ;
else
F_47 ( V_403 + V_282 -> V_404 , 0 ) ;
} else {
if ( V_97 -> V_87 & V_98 )
F_47 ( V_406 + V_282 -> V_404 ,
V_407 ) ;
else
F_47 ( V_406 + V_282 -> V_404 , 0 ) ;
}
}
}
...
if ( V_62 -> V_14 & V_22 )
args . V_418 . V_422 = F_25 ( V_22 ) ;
else if ( V_62 -> V_14 & V_25 )
args . V_418 . V_422 = F_25 ( V_25 ) ;
else if ( V_62 -> V_14 & V_26 ) {
args . V_418 . V_422 = F_25 ( V_26 ) ;
if ( V_167 >= 3 )
args . V_418 . V_160 = V_423 ;
} else if ( V_62 -> V_14 & V_23 ) {
args . V_418 . V_422 = F_25 ( V_23 ) ;
if ( V_167 >= 3 )
args . V_418 . V_160 = V_423 ;
}
F_26 ( V_6 -> V_132 . V_133 , V_109 , ( T_1 * ) & args ) ;
...
if ( V_62 -> V_14 & V_26 ) {
if ( V_425 & ( V_432 | V_433 ) )
return V_430 ;
}
if ( V_62 -> V_14 & V_23 ) {
if ( V_425 & ( V_434 | V_435 ) )
return V_430 ;
else if ( V_425 & ( V_436 | V_437 ) )
return V_430 ;
}
return V_438 ;
}
...
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_100 * V_20 = F_81 ( sizeof( struct V_100 ) , V_445 ) ;
if ( ! V_20 )
return NULL ;
V_20 -> V_103 = F_82 ( V_6 ) ;
return V_20 ;
...
struct V_162 * V_163 = F_81 ( sizeof( struct V_162 ) , V_445 ) ;
if ( ! V_163 )
return NULL ;
V_163 -> V_179 = true ;
V_163 -> V_230 = - 1 ;
...
V_8 = F_81 ( sizeof( struct V_8 ) , V_445 ) ;
if ( ! V_8 )
return;
V_2 = & V_8 -> V_305 ;
switch ( V_6 -> V_447 ) {
...
if ( V_8 -> V_14 & ( V_15 ) ) {
V_8 -> V_449 = V_453 ;
F_85 ( V_4 , V_2 , & V_454 , V_455 ) ;
V_8 -> V_102 = F_86 ( V_8 ) ;
} else {
F_85 ( V_4 , V_2 , & V_454 , V_456 ) ;
V_8 -> V_102 = F_83 ( V_8 ) ;
}
F_87 ( V_2 , & V_457 ) ;
break;
case V_111 :
F_85 ( V_4 , V_2 , & V_454 , V_458 ) ;
V_8 -> V_102 = F_80 ( V_8 ) ;
F_87 ( V_2 , & V_459 ) ;
break;
case V_115 :
