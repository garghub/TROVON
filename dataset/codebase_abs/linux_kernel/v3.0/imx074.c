...
static unsigned long F_21 ( struct V_67 * V_68 )
{
return 0 ;
}
...
{
struct V_1 * V_40 ;
struct V_67 * V_68 = V_3 -> V_25 . V_97 ;
struct V_12 * V_14 = F_26 ( V_3 -> V_25 . V_98 ) ;
struct V_99 * V_100 ;
int V_18 ;
if ( ! V_68 ) {
F_27 ( & V_3 -> V_25 , L_4 ) ;
...
V_40 = F_30 ( sizeof( struct V_1 ) , V_102 ) ;
if ( ! V_40 )
return - V_103 ;
