...
static bool F_43 ( struct V_15 * V_16 )
{
if ( F_8 ( V_16 , V_60 ) == 1 )
return false ;
return true ;
}
static void F_44 ( struct V_15 * V_16 , T_1 V_1 )
{
struct V_61 * V_62 ;
struct V_61 * V_25 ;
struct V_63 * V_64 ;
...
static void F_58 ( struct V_15 * V_16 , char * V_74 )
{
T_2 V_8 = V_13 ;
T_1 V_1 ;
...
static void F_60 ( T_1 V_1 , T_5 V_75 , void * V_76 )
{
...
static int F_65 ( struct V_70 * V_70 ,
T_6 * V_12 )
{
...
static void F_66 ( struct V_70 * V_70 )
{
F_67 ( V_70 -> V_80 ) ;
F_67 ( V_70 ) ;
}
...
{
int V_81 = - V_41 ;
struct V_63 * V_64 = F_69 ( 0 , 1 ) ;
if ( ! V_64 ) {
F_50 ( L_27 ) ;
return - V_19 ;
}
V_16 -> V_70 = F_70 ( sizeof( struct V_70 ) , V_82 ) ;
if ( ! V_16 -> V_70 )
goto V_83;
V_16 -> V_70 -> V_80 = F_70 ( sizeof( struct V_84 ) ,
V_82 ) ;
if ( ! V_16 -> V_70 -> V_80 )
goto V_85;
V_16 -> V_70 -> V_79 = V_16 ;
...
F_65 ( V_16 -> V_70 ,
& V_16 -> V_70 -> V_80 -> V_89 ) ;
V_81 = F_71 ( V_16 -> V_70 , V_64 , 0 , L_28 ) ;
if ( V_81 ) {
F_50 ( L_29 , V_81 ) ;
goto V_90;
}
...
static int F_72 ( void * V_76 , bool V_65 )
{
T_1 V_1 = V_76 ;
...
if ( V_14 < 0 )
return V_14 ;
* V_91 = F_74 ( V_56 , & V_16 -> V_39 -> V_25 , type ,
& V_93 , V_1 ) ;
if ( ! * V_91 )
return - V_23 ;
F_75 ( * V_91 , F_8 ( V_16 , V_17 ) != 1 ) ;
V_14 = F_76 ( * V_91 ) ;
if ( V_14 ) {
F_77 ( * V_91 ) ;
* V_91 = NULL ;
...
int V_14 = 0 ;
F_82 ( & V_16 -> V_69 ) ;
V_14 = F_73 ( V_16 , & V_16 -> V_68 ,
L_33 , V_97 ,
V_60 ) ;
if ( V_14 && V_14 != - V_19 )
goto exit;
V_14 = F_73 ( V_16 , & V_16 -> V_94 ,
L_34 , V_98 ,
V_99 ) ;
if ( V_14 && V_14 != - V_19 )
goto exit;
V_14 = F_73 ( V_16 , & V_16 -> V_95 ,
L_35 , V_100 ,
V_101 ) ;
if ( V_14 && V_14 != - V_19 )
goto exit;
V_14 = F_73 ( V_16 , & V_16 -> V_96 ,
L_36 , V_102 ,
V_103 ) ;
if ( V_14 && V_14 != - V_19 )
goto exit;
...
static int F_83 ( struct V_24 * V_24 )
{
...
static void F_87 ( int V_12 )
{
V_12 = F_88 ( V_12 , 0 , 255 ) ;
V_12 = V_12 * 100 / 255 ;
F_89 ( V_107 , V_12 ) ;
}
...
static T_3 F_93 ( void (* F_94)( int ) , const char * V_22 , T_4 V_9 )
{
int V_26 , V_12 ;
V_26 = F_11 ( V_22 , V_9 , & V_12 ) ;
if ( V_26 > 0 )
...
static T_3 F_95 ( int (* F_96)( void ) , char * V_22 )
{
return sprintf ( V_22 , L_5 , F_96 () ) ;
}
static T_3
F_97 ( struct V_24 * V_25 , struct V_33 * V_34 , char * V_22 )
{
...
{
struct V_15 * V_16 = F_105 ( V_118 ) ;
return F_8 ( V_16 , V_119 ) ;
}
static int F_106 ( struct V_117 * V_118 , int V_12 )
{
struct V_15 * V_16 = F_105 ( V_118 ) ;
...
{
return F_106 ( V_118 , V_118 -> V_120 . V_121 ) ;
}
...
static void F_124 ( struct V_140 * V_24 , T_5 V_75 )
{
struct V_15 * V_16 = F_125 ( V_24 ) ;
T_7 V_9 ;
if ( V_75 > V_141 )
return;
V_9 = V_16 -> V_142 [ V_75 % 128 ] ++ ;
F_126 ( V_24 , V_75 , V_9 ) ;
F_127 ( V_24 -> V_143 . V_144 ,
F_128 ( & V_24 -> V_25 ) , V_75 ,
V_9 ) ;
...
F_129 ( V_16 -> V_139 , V_75 ,
1 , true ) ;
}
} else {
F_129 ( V_16 -> V_139 , V_75 , 1 , true ) ;
}
}
...
if ( ! V_149 )
return;
if ( strcmp ( V_149 , L_45 ) == 0 || strcmp ( V_149 , L_46 ) == 0 ) {
V_16 -> V_37 = true ;
F_117 ( L_47
L_48 , V_149 ) ;
F_117 ( L_49 ) ;
}
if ( strcmp ( V_149 , L_50 ) == 0 || strcmp ( V_149 , L_51 ) == 0 ||
strcmp ( V_149 , L_52 ) == 0 ) {
V_16 -> V_104 = true ;
F_117 ( L_53 ) ;
}
}
static void F_132 ( struct V_15 * V_16 , int V_17 , const char * V_56 )
{
int V_151 ;
if ( ! ( V_16 -> V_20 & ( 1 << V_17 ) )
...
{
F_132 ( V_16 , V_152 , L_56 ) ;
F_132 ( V_16 , V_153 , L_57 ) ;
F_132 ( V_16 , V_154 , L_58 ) ;
F_132 ( V_16 , V_49 , L_59 ) ;
}
static int T_8 F_134 ( struct V_15 * V_16 )
{
unsigned int V_155 ;
int V_14 ;
V_14 = F_135 ( V_16 -> V_24 ) ;
if ( V_14 )
return V_14 ;
...
V_155 = V_157 | V_158 ;
F_136 ( L_61 , V_155 ) ;
if ( F_1 ( V_16 -> V_1 , L_62 , V_155 ) ) {
F_50 ( L_63 ) ;
return - V_19 ;
}
if ( F_3 ( V_16 -> V_1 , L_64 , & V_16 -> V_20 ) ) {
F_50 ( L_65 ) ;
return - V_19 ;
}
F_133 ( V_16 ) ;
F_117 ( L_66 , V_16 -> V_20 ) ;
return 0 ;
}
static void T_8 F_137 ( struct V_15 * V_16 )
{
if ( F_8 ( V_16 , V_159 ) == 0 )
F_6 ( V_16 , V_159 , 1 ) ;
}
static int T_8 F_138 ( struct V_140 * V_24 )
{
struct V_15 * V_16 ;
int V_14 ;
F_136 ( V_160 L_7 ) ;
V_16 = F_70 ( sizeof( struct V_15 ) , V_82 ) ;
if ( ! V_16 )
return - V_41 ;
V_16 -> V_1 = V_24 -> V_1 ;
strcpy ( F_139 ( V_24 ) , V_161 ) ;
strcpy ( F_140 ( V_24 ) , V_162 ) ;
V_24 -> V_163 = V_16 ;
V_16 -> V_24 = V_24 ;
V_16 -> V_104 = V_104 ;
F_130 ( V_16 ) ;
...
static int F_142 ( struct V_140 * V_24 , int type )
{
struct V_15 * V_16 = F_125 ( V_24 ) ;
F_113 ( V_16 ) ;
F_78 ( V_16 ) ;
