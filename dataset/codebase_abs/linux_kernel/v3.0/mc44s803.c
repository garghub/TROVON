...
{
struct V_1 * V_2 = V_23 -> V_24 ;
T_1 V_58 , V_59 , V_60 , V_61 , V_62 , V_63 , V_64 , V_3 ;
int V_25 ;
V_2 -> V_65 = V_57 -> V_65 ;
V_58 = V_66 / 1000000 ;
V_59 = V_66 / 100000 ;
V_60 = ( V_57 -> V_65 + V_67 + 500000 ) / 1000000 ;
V_64 = V_66 / V_58 * V_60 ;
V_62 = ( ( 60 * V_60 ) + ( V_58 / 2 ) ) / V_58 ;
V_64 = V_64 - V_57 -> V_65 ;
V_61 = ( V_64 - V_68 + 50000 ) / 100000 ;
...
static int F_11 ( struct V_22 * V_23 , T_1 * V_65 )
{
struct V_1 * V_2 = V_23 -> V_24 ;
* V_65 = V_2 -> V_65 ;
return 0 ;
}
struct V_22 * F_12 ( struct V_22 * V_23 ,
struct V_80 * V_12 , struct V_81 * V_8 )
{
struct V_1 * V_2 ;
T_1 V_15 ;
T_2 V_82 ;
int V_17 ;
V_15 = 0 ;
V_2 = F_13 ( sizeof( struct V_1 ) , V_83 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_8 = V_8 ;
V_2 -> V_12 = V_12 ;
