...
if ( V_35 > V_27 -> V_16 )
return - V_44 ;
if ( ( V_36 + V_35 ) > V_27 -> V_16 )
return - V_44 ;
V_20 = 0 ;
while ( V_20 < V_27 -> V_45 && V_35 >= V_42 [ V_20 ] . V_46 )
V_20 ++ ;
V_20 -- ;
if ( V_35 & ( V_42 [ V_20 ] . V_47 - 1 ) )
return - V_44 ;
V_40 = V_20 ;
while ( V_20 < V_27 -> V_45 && ( V_35 + V_36 ) >= V_42 [ V_20 ] . V_46 )
V_20 ++ ;
V_20 -- ;
if ( ( V_35 + V_36 ) & ( V_42 [ V_20 ] . V_47 - 1 ) )
return - V_44 ;
V_38 = V_35 >> V_5 -> V_48 ;
V_15 = V_35 - ( V_38 << V_5 -> V_48 ) ;
V_20 = V_40 ;
while( V_36 ) {
int V_16 = V_42 [ V_20 ] . V_47 ;
...
V_35 += V_16 ;
V_36 -= V_16 ;
if ( V_35 == V_42 [ V_20 ] . V_46 + V_16 * V_42 [ V_20 ] . V_50 )
V_20 ++ ;
if ( V_15 >> V_5 -> V_48 ) {
V_15 = 0 ;
V_38 ++ ;
