...
V_19 = & F_46 ( V_56 , V_53 ) ;
F_20 ( & V_19 -> V_26 ) ;
F_21 (s2, tmp, &listeners->list, list) {
if ( V_52 -> V_29 == V_29 )
goto V_57;
}
F_47 ( & V_21 -> V_27 , & V_19 -> V_27 ) ;
V_21 = NULL ;
V_57:
F_24 ( & V_19 -> V_26 ) ;
}
...
static int F_48 ( struct V_58 * V_59 , struct V_49 * V_50 )
{
char * V_60 ;
int V_61 ;
int V_48 ;
...
static struct V_34 * F_53 ( struct V_4 * V_7 , int type , T_4 V_29 )
{
...
: V_67 ;
#ifdef F_54
if ( F_55 ( V_7 , V_68 , 0 , NULL ) < 0 )
goto V_69;
#endif
V_59 = F_56 ( V_7 , V_64 ) ;
if ( ! V_59 )
goto V_69;
if ( F_55 ( V_7 , type , sizeof( V_29 ) , & V_29 ) < 0 )
goto V_69;
V_48 = F_57 ( V_7 , V_70 , sizeof( struct V_34 ) ) ;
if ( ! V_48 )
goto V_69;
F_58 ( V_7 , V_59 ) ;
return F_59 ( V_48 ) ;
...
static int F_60 ( struct V_4 * V_7 , struct V_1 * V_2 )
{
int V_17 = 0 ;
struct V_4 * V_71 ;
struct V_72 * V_35 ;
...
if ( ! V_59 )
return - V_14 ;
V_73 = F_61 ( V_2 -> V_76 [ V_77 ] ) ;
V_74 = F_62 ( V_73 , & V_75 ) ;
if ( ! V_74 )
return 0 ;
V_6 = F_63 ( sizeof( struct V_72 ) ) ;
...
static T_2 F_70 ( void )
{
T_2 V_6 ;
V_6 = F_63 ( sizeof( T_4 ) ) +
F_63 ( sizeof( struct V_34 ) ) + F_63 ( 0 ) ;
#ifdef F_54
V_6 += F_63 ( 0 ) ;
#endif
return V_6 ;
...
return V_17 ;
V_17 = - V_14 ;
V_29 = F_61 ( V_2 -> V_76 [ V_86 ] ) ;
V_35 = F_53 ( V_71 , V_65 , V_29 ) ;
if ( ! V_35 )
goto V_69;
V_17 = F_29 ( V_29 , V_35 ) ;
if ( V_17 < 0 )
...
return V_17 ;
V_17 = - V_14 ;
V_41 = F_61 ( V_2 -> V_76 [ V_87 ] ) ;
V_35 = F_53 ( V_71 , V_88 , V_41 ) ;
if ( ! V_35 )
goto V_69;
V_17 = F_35 ( V_41 , V_35 ) ;
if ( V_17 < 0 )
...
static int F_73 ( struct V_4 * V_7 , struct V_1 * V_2 )
{
if ( V_2 -> V_76 [ V_81 ] )
return F_66 ( V_2 ) ;
...
static struct V_34 * F_74 ( struct V_32 * V_33 )
{
struct V_89 * V_90 = V_33 -> signal ;
struct V_34 * V_35 ;
if ( V_90 -> V_35 || F_75 ( V_33 ) )
goto V_48;
V_35 = F_76 ( V_91 , V_9 ) ;
F_77 ( & V_33 -> V_46 -> V_47 ) ;
if ( ! V_90 -> V_35 ) {
...
void F_80 ( struct V_32 * V_33 , int V_92 )
{
int V_17 ;
struct V_18 * V_19 ;
struct V_34 * V_35 ;
...
if ( V_17 < 0 )
return;
V_35 = F_53 ( V_71 , V_65 , V_33 -> V_29 ) ;
if ( ! V_35 )
goto V_69;
F_25 ( V_33 , V_35 ) ;
if ( ! V_93 || ! V_92 )
goto V_95;
V_35 = F_53 ( V_71 , V_88 , V_33 -> V_41 ) ;
if ( ! V_35 )
goto V_69;
...
V_91 = F_84 ( V_34 , V_97 ) ;
F_85 (i) {
F_45 ( & ( F_46 ( V_56 , V_96 ) . V_27 ) ) ;
F_86 ( & ( F_46 ( V_56 , V_96 ) . V_26 ) ) ;
}
}
