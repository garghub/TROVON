...
static int F_21 ( struct V_51 * V_52 , struct V_71 * V_72 )
{
struct V_1 * V_2 = V_52 -> V_55 ;
if ( V_52 -> V_73 . V_74 . V_75 ) {
V_52 -> V_73 . V_74 . V_75 ( V_52 , V_72 ) ;
if ( V_52 -> V_73 . V_76 ) V_52 -> V_73 . V_76 ( V_52 , 0 ) ;
}
F_6 ( V_2 , V_72 -> V_20 ) ;
F_7 ( V_2 , V_72 -> V_77 . V_78 . V_79 ) ;
F_9 ( V_2 , V_72 -> V_77 . V_78 . V_80 ) ;
F_1 ( V_2 , 0x00 , 0x3c ) ;
F_1 ( V_2 , 0x00 , 0x04 ) ;
return 0 ;
}
static int F_22 ( struct V_51 * V_52 , struct V_71 * V_72 )
{
struct V_1 * V_2 = V_52 -> V_55 ;
V_72 -> V_20 = ( F_5 ( V_2 , 0x0e ) & 0x80 ) ?
V_81 : V_82 ;
V_72 -> V_77 . V_78 . V_79 = F_8 ( V_2 ) ;
return 0 ;
}
...
struct V_51 * F_30 ( const struct V_84 * V_10 ,
struct V_85 * V_14 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_31 ( sizeof( struct V_1 ) , V_86 ) ;
if ( V_2 == NULL ) goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_14 = V_14 ;
if ( ( F_5 ( V_2 , 0x00 ) ) != 0x05 ) goto error;
memcpy ( & V_2 -> V_87 . V_73 , & V_88 , sizeof( struct V_89 ) ) ;
V_2 -> V_87 . V_55 = V_2 ;
return & V_2 -> V_87 ;
error:
F_29 ( V_2 ) ;
