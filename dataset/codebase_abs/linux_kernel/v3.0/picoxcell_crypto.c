...
static int T_9 F_122 ( struct V_214 * V_215 ,
unsigned V_225 , T_4 V_15 ,
T_4 V_17 , T_4 V_39 ,
struct V_1 * V_226 , T_4 V_227 )
{
int V_61 , V_121 , V_228 = - V_107 ;
struct V_229 * V_230 , * V_206 ;
struct V_4 * V_5 = F_123 ( & V_215 -> V_62 , sizeof( * V_5 ) ,
V_231 ) ;
if ( ! V_5 )
return - V_82 ;
V_5 -> V_225 = V_225 ;
...
V_5 -> V_226 = V_226 ;
V_5 -> V_227 = V_227 ;
V_5 -> V_232 = F_124 ( & V_215 -> V_62 ) ;
V_230 = F_125 ( V_215 , V_233 , 0 ) ;
V_206 = F_125 ( V_215 , V_234 , 0 ) ;
if ( ! V_230 || ! V_206 ) {
F_126 ( & V_215 -> V_62 , L_5 ) ;
return - V_235 ;
}
if ( ! F_127 ( & V_215 -> V_62 , V_230 -> V_236 , F_128 ( V_230 ) ,
V_5 -> V_232 ) )
return - V_82 ;
V_5 -> V_7 = F_129 ( & V_215 -> V_62 , V_230 -> V_236 , F_128 ( V_230 ) ) ;
if ( ! V_5 -> V_7 ) {
F_126 ( & V_215 -> V_62 , L_6 ) ;
return - V_82 ;
}
if ( F_130 ( & V_215 -> V_62 , V_206 -> V_236 , F_104 , 0 ,
V_5 -> V_232 , V_5 ) ) {
F_126 ( V_5 -> V_62 , L_7 ) ;
return - V_169 ;
}
V_5 -> V_62 = & V_215 -> V_62 ;
V_5 -> V_14 = V_5 -> V_7 + V_237 ;
V_5 -> V_16 = V_5 -> V_7 + V_238 ;
V_5 -> V_65 = F_131 ( V_5 -> V_232 , V_5 -> V_62 ,
V_63 * sizeof( struct V_49 ) , 8 , V_239 ) ;
if ( ! V_5 -> V_65 )
return - V_82 ;
F_132 ( & V_5 -> V_170 ) ;
V_5 -> V_216 = F_133 ( & V_215 -> V_62 , NULL ) ;
if ( F_71 ( V_5 -> V_216 ) ) {
F_134 ( & V_215 -> V_62 , L_8 ) ;
F_135 ( & V_215 -> V_62 , & V_240 ) ;
return F_136 ( V_5 -> V_216 ) ;
}
if ( F_116 ( V_5 -> V_216 ) ) {
F_134 ( & V_215 -> V_62 , L_9 ) ;
F_137 ( V_5 -> V_216 ) ;
return - V_205 ;
}
V_121 = F_138 ( & V_215 -> V_62 , & V_240 ) ;
if ( V_121 ) {
F_114 ( V_5 -> V_216 ) ;
F_137 ( V_5 -> V_216 ) ;
return V_121 ;
...
F_7 ( V_241 | V_242 ,
V_5 -> V_7 + V_243 ) ;
F_139 ( & V_5 -> V_159 , F_105 ,
( unsigned long ) V_5 ) ;
F_140 ( & V_5 -> V_163 ) ;
F_140 ( & V_5 -> V_195 ) ;
F_140 ( & V_5 -> V_166 ) ;
V_5 -> V_164 = 0 ;
F_141 ( & V_5 -> V_138 , F_106 ,
( unsigned long ) V_5 ) ;
F_142 ( V_215 , V_5 ) ;
F_140 ( & V_5 -> V_244 ) ;
for ( V_61 = 0 ; V_61 < V_5 -> V_227 ; ++ V_61 ) {
V_5 -> V_226 [ V_61 ] . V_5 = V_5 ;
V_121 = F_143 ( & V_5 -> V_226 [ V_61 ] . V_3 ) ;
if ( ! V_121 ) {
F_63 ( & V_5 -> V_226 [ V_61 ] . V_245 ,
& V_5 -> V_244 ) ;
V_228 = 0 ;
}
if ( V_121 )
F_126 ( V_5 -> V_62 , L_10 ,
V_5 -> V_226 [ V_61 ] . V_3 . V_177 ) ;
else
F_144 ( V_5 -> V_62 , L_11 ,
V_5 -> V_226 [ V_61 ] . V_3 . V_177 ) ;
}
...
static int T_10 F_145 ( struct V_214 * V_215 )
{
...
static int T_9 F_148 ( struct V_214 * V_215 )
{
return F_122 ( V_215 , V_247 ,
V_248 ,
V_249 ,
V_250 , V_251 ,
F_149 ( V_251 ) ) ;
}
static int T_9 F_150 ( struct V_214 * V_215 )
{
return F_122 ( V_215 , V_252 ,
V_253 ,
V_254 , V_255 ,
V_256 , F_149 ( V_256 ) ) ;
}
