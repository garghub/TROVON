...
if ( V_68 && V_68 -> V_95 ) {
int V_96 = sizeof( struct V_97 ) + V_68 -> V_95 ;
V_15 -> V_68 = F_31 ( V_96 , V_98 ) ;
...
{
struct V_101 V_102 ;
F_35 ( & V_102 , 0 , V_34 -> V_103 , F_36 ( V_34 ) ,
V_104 , V_105 ,
F_37 ( V_34 ) ,
( V_68 && V_68 -> V_106 ) ? V_68 -> V_107 : V_15 -> V_91 ,
V_15 -> V_90 , V_41 -> V_46 , V_41 -> V_47 ) ;
F_38 ( V_13 , F_39 ( & V_102 ) ) ;
V_77 = F_40 ( F_16 ( V_34 ) , & V_102 ) ;
if ( F_41 ( V_77 ) ) {
F_22 ( V_13 ) ;
goto V_82;
}
}
V_13 -> V_108 = V_73 -> V_108 ? : F_42 ( & V_77 -> V_53 , V_109 ) ;
F_43 ( F_44 ( V_34 ) , V_13 -> V_43 ,
& V_13 -> V_110 , & V_13 -> V_108 ,
V_15 -> V_20 , & V_78 ,
F_42 ( & V_77 -> V_53 , V_111 ) ) ;
V_15 -> V_78 = V_78 ;
