...
static int T_3 F_36 ( struct V_74 * V_75 )
{
struct V_76 * V_77 ;
struct V_78 V_79 ;
int V_80 ;
...
if ( ! F_42 ( V_79 . V_22 , sizeof( struct V_90 ) ,
V_87 ) ) {
F_14 (KERN_ERR DRIVER_NAME L_7
L_12 ) ;
V_80 = - V_91 ;
...
V_8 -> V_92 = V_79 . V_22 ;
V_8 -> V_65 = F_43 ( V_79 . V_22 , sizeof( struct V_90 ) ) ;
if ( ! V_8 -> V_65 ) {
F_14 (KERN_ERR DRIVER_NAME L_7
L_13 ) ;
V_80 = - V_39 ;
...
F_44 ( V_8 -> V_65 ) ;
V_93:
F_45 ( V_79 . V_22 , sizeof( struct V_90 ) ) ;
V_89:
F_10 ( V_8 ) ;
F_46 () ;
V_86:
...
F_46 () ;
F_44 ( V_8 -> V_65 ) ;
F_45 ( V_8 -> V_92 , sizeof( struct V_90 ) ) ;
F_40 ( V_8 -> V_16 ) ;
F_10 ( V_8 ) ;
V_8 = NULL ;
return 0 ;
