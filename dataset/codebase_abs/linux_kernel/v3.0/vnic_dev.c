...
if ( ! F_53 ( V_2 ) )
return 0 ;
return V_2 -> V_136 . V_141 ;
}
T_3 F_56 ( struct V_1 * V_2 )
{
if ( ! F_53 ( V_2 ) )
return 0 ;
return V_2 -> V_136 . V_142 ;
}
T_3 F_57 ( struct V_1 * V_2 )
{
if ( ! F_53 ( V_2 ) )
return 0 ;
return V_2 -> V_136 . V_143 ;
}
T_3 F_58 ( struct V_1 * V_2 )
{
if ( ! F_53 ( V_2 ) )
return 0 ;
return V_2 -> V_136 . V_144 ;
}
...
void * V_3 , struct V_147 * V_49 , struct V_4 * V_5 ,
unsigned int V_6 )
{
if ( ! V_2 ) {
...
int F_65 ( struct V_1 * V_2 , T_2 * V_150 , T_3 V_14 )
{
T_4 V_74 , V_75 = V_14 ;
int V_56 = 1000 ;
T_5 V_151 ;
void * V_152 ;
int V_153 ;
V_152 = F_12 ( V_2 -> V_49 , V_14 , & V_151 ) ;
if ( ! V_152 )
return - V_51 ;
memcpy ( V_152 , V_150 , V_14 ) ;
V_74 = V_151 ;
V_153 = F_27 ( V_2 , V_154 , & V_74 , & V_75 , V_56 ) ;
F_14 ( V_2 -> V_49 , V_14 , V_152 , V_151 ) ;
return V_153 ;
}
int F_66 ( struct V_1 * V_2 , int V_155 )
{
T_4 V_74 , V_75 = 0 ;
int V_56 = 1000 ;
V_74 = ( V_155 ? V_156 : 0 ) ;
return F_27 ( V_2 , V_157 , & V_74 , & V_75 , V_56 ) ;
}
static int F_67 ( struct V_1 * V_2 , enum V_54 V_55 ,
int * V_61 )
{
T_4 V_74 = V_55 , V_75 = 0 ;
int V_56 = 1000 ;
int V_153 ;
V_153 = F_27 ( V_2 , V_158 , & V_74 , & V_75 , V_56 ) ;
if ( ! V_153 )
* V_61 = ( int ) V_74 ;
return V_153 ;
}
...
{
return F_67 ( V_2 , V_157 , V_61 ) ;
}
int F_69 ( struct V_1 * V_2 , int * V_61 )
{
return F_67 ( V_2 , V_140 , V_61 ) ;
}
