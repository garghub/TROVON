...
F_84 ( V_132 L_18 , ( char ) ( ( V_130 & 0x0F ) + 'A' - 1 ) ) ;
else {
for ( V_6 = 0 ; V_6 < F_81 ( V_133 ) ; V_6 ++ ) {
struct V_16 * V_134 ;
V_123 = F_82 ( V_2 -> V_126 , ( V_134 = F_83 ( & V_133 [ V_6 ] , V_2 ) ) ) ;
if ( V_123 < 0 )
return V_123 ;
if ( V_6 > 1 )
V_134 -> V_130 . V_135 = V_2 -> V_136 -> V_135 ;
}
}
F_11 ( V_2 ) ;
}
...
static const unsigned short V_139 [] = {
0x0441 ,
0x0180 ,
0x0201 ,
0x0605 ,
...
V_140 = V_137 ;
for (; * V_140 != ( unsigned short ) - 1 ; V_140 += 2 )
F_31 ( V_2 , V_140 [ 0 ] , V_140 [ 1 ] ) ;
if ( V_2 -> V_61 . V_62 != V_63 &&
V_2 -> V_61 . V_62 != V_64 ) {
for ( V_140 = V_139 ; * V_140 != ( unsigned short ) - 1 ; V_140 ++ )
F_24 ( V_2 , V_15 , * V_140 | 0x200000 , 24 ) ;
V_31 -> V_101 = 1 ;
F_71 ( V_2 , 1 ) ;
}
F_11 ( V_2 ) ;
...
static int T_1 F_88 ( struct V_1 * V_2 )
{
struct V_30 * V_31 ;
int V_6 , V_123 ;
V_31 = F_89 ( sizeof( * V_31 ) , V_143 ) ;
if ( ! V_31 )
return - V_144 ;
V_2 -> V_31 = V_31 ;
if ( V_2 -> V_61 . V_62 == V_125 ) {
...
V_2 -> V_72 = F_89 ( sizeof( struct V_146 ) , V_143 ) ;
if ( ! V_2 -> V_72 )
return - V_144 ;
V_2 -> V_147 = 1 ;
V_123 = F_85 ( V_2 ) ;
