...
if ( V_24 )
goto V_27;
V_24 = V_7 -> V_64 . V_65 -> V_67 ( V_7 -> V_66 ) ;
V_27:
F_14 ( & V_7 -> V_60 ) ;
return V_24 ? V_24 : V_21 ;
}
...
{
int V_93 ;
V_93 = F_50 ( & V_2 -> V_94 , & V_95 ) ;
if ( V_93 )
return V_93 ;
V_93 = F_50 ( & V_2 -> V_94 , & V_96 ) ;
if ( V_93 )
F_51 ( & V_2 -> V_94 , & V_95 ) ;
return 0 ;
}
