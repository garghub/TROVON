...
static int F_37 ( struct V_77 * V_78 , struct V_79 * V_80 ,
struct V_75 * V_76 )
{
struct V_81 * V_82 = F_38 ( V_80 -> V_13 -> V_14 ) ;
struct V_72 * V_14 ;
struct V_83 * V_84 ;
int V_53 ;
int V_12 ;
...
V_84 = F_40 ( V_82 , V_86 , V_53 ) ;
if ( ! V_84 ) {
V_12 = - V_87 ;
goto exit;
}
V_14 -> V_10 [ V_53 ] . V_88 = V_84 ;
V_12 = F_41 ( V_14 , & V_14 -> V_10 [ V_53 ] ) ;
if ( V_12 )
goto exit;
}
return F_42 ( V_76 , V_89 ,
...
static bool F_44 ( struct V_33 * V_34 , void * V_90 )
{
struct V_9 * V_10 = V_90 ;
char * V_91 ;
bool V_92 = false ;
V_91 = F_45 ( V_93 , L_5 , V_10 -> V_88 -> V_94 ,
( int ) V_10 -> V_88 -> V_95 ) ;
if ( strcmp ( F_46 ( V_34 -> V_39 -> V_14 ) , V_91 ) == 0 ) {
V_34 -> V_96 = & V_10 -> V_97 ;
V_92 = true ;
}
F_47 ( V_91 ) ;
...
if ( V_10 -> V_19 == V_41 ) {
V_99 -> V_102 = V_55 -> V_103 + V_104 ;
V_99 -> V_105 = 0 ;
} else {
V_99 -> V_102 = 0 ;
V_99 -> V_105 = V_55 -> V_103 + V_106 ;
}
F_49 ( V_100 ) ;
F_50 ( V_107 , V_100 ) ;
V_10 -> V_33 = F_51 ( V_100 , F_44 , V_10 ) ;
if ( ! V_10 -> V_33 ) {
F_52 ( V_108
L_6 ,
V_10 -> V_19 == V_41 ?
...
static int F_54 ( struct V_109 * V_13 )
{
F_55 ( V_13 , & V_72 ) ;
return 0 ;
}
static int F_56 ( struct V_109 * V_13 )
{
...
F_26 ( F_58 ( V_57 + V_106 ) , V_57 + V_104 ) ;
for ( V_53 = 0 ; V_53 < 2 ; V_53 ++ ) {
...
static int T_6 F_59 ( struct V_81 * V_82 )
{
return F_60 ( & V_82 -> V_14 , & V_110 ) ;
}
static int T_7 F_61 ( struct V_81 * V_82 )
{
F_62 ( & V_82 -> V_14 ) ;
return 0 ;
}
