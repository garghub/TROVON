...
V_36 = F_82 ( V_10 , V_253 , & V_250 ) ;
if ( V_36 != V_134 ) {
F_31 (KERN_ERR DEV_LABEL L_110
L_111 , lanai->number, result) ;
return - V_254 ;
}
V_36 = F_163 ( L_112 , V_250 , NULL ) ;
if ( V_36 != 0 )
return V_36 ;
V_36 = F_172 ( V_10 , V_255 , 0 ) ;
if ( V_36 != V_134 ) {
F_31 (KERN_ERR DEV_LABEL L_113
L_114 , lanai->number, result) ;
return - V_254 ;
}
F_81 ( V_2 , 1 ) ;
F_81 ( V_2 , 0 ) ;
...
return 0 ;
if ( V_52 -> V_74 . V_75 != V_256 &&
V_40 -> V_67 . V_46 != NULL && V_40 -> V_67 . V_46 != V_46 )
return 0 ;
if ( V_52 -> V_74 . V_75 == V_76 &&
V_2 -> V_259 != NULL && V_2 -> V_259 != V_46 )
return 0 ;
}
if ( V_52 -> V_53 == V_186 && V_2 -> V_257 == 0 &&
V_52 -> V_184 . V_75 != V_256 ) {
const struct V_39 * V_260 = V_2 -> V_179 [ 0 ] ;
if ( V_260 != NULL && V_260 -> V_51 . V_46 != NULL )
return 0 ;
V_2 -> V_27 &= ~ V_258 ;
F_20 ( V_2 ) ;
}
...
const struct V_45 * V_46 , short * V_261 , T_1 * V_262 )
{
switch ( * V_261 ) {
case V_263 :
* V_261 = 0 ;
...
switch ( * V_262 ) {
case V_265 :
for ( * V_262 = V_266 ; * V_262 < V_2 -> V_177 ;
( * V_262 ) ++ )
if ( F_174 ( V_2 , * V_262 , V_46 ) )
return 0 ;
return - V_264 ;
default:
if ( * V_262 >= V_2 -> V_177 || * V_262 < 0 ||
! F_174 ( V_2 , * V_262 , V_46 ) )
return - V_264 ;
}
return 0 ;
}
...
{
int V_267 = 0 ;
int T_7 , V_268 , V_269 = F_177 ( & V_52 -> V_74 ) ;
if ( V_269 == 0 )
return 0 ;
if ( V_269 < 0 ) {
V_267 = 1 ;
...
{
F_16 ( V_2 , F_176 ( & V_2 -> V_259 -> V_52 ) , V_272 ) ;
...
static int T_4 F_180 ( struct V_275 * V_276 )
{
struct V_1 * V_2 = (struct V_1 * ) V_276 -> V_277 ;
unsigned long V_278 ;
int V_36 ;
F_24 ( L_116 ) ;
V_2 -> V_199 = V_276 -> V_199 ;
V_2 -> V_177 = V_216 ;
...
V_276 -> V_279 . V_280 = 0 ;
V_276 -> V_279 . V_281 = 0 ;
while ( 1 << V_276 -> V_279 . V_281 < V_2 -> V_177 )
V_276 -> V_279 . V_281 ++ ;
V_276 -> V_282 = V_283 ;
if ( ( V_36 = F_166 ( V_2 ) ) != 0 )
goto error;
V_278 = V_2 -> V_10 -> V_284 [ 0 ] . V_13 ;
V_2 -> V_22 = ( T_3 ) F_182 ( V_278 , V_285 ) ;
if ( V_2 -> V_22 == NULL ) {
...
V_2 -> V_25 &= ~ ( V_287 | V_29 |
V_288 ) ;
V_2 -> V_25 |= F_183 ( V_289 ) ;
F_16 ( V_2 , V_2 -> V_25 | V_287 , V_26 ) ;
F_25 ( 1000 ) ;
F_18 ( V_2 ) ;
V_36 = F_163 ( L_118 ,
F_13 ( V_2 , V_30 ) , & V_2 -> V_290 ) ;
if ( V_36 != 0 )
goto V_291;
if ( ( V_36 = F_61 ( V_2 ) ) != 0 )
goto V_291;
...
if ( ( V_36 = F_115 ( V_2 ) ) != 0 )
goto V_295;
V_2 -> V_27 = ( V_2 -> V_177 >= 512 ? V_296 : 0 ) |
V_297 | V_298 ;
F_19 ( V_2 ) ;
F_16 ( V_2 , V_299 , V_300 ) ;
F_16 ( V_2 , 0 , V_272 ) ;
if ( ( V_36 = F_184 ( V_2 -> V_10 -> V_243 , F_162 , V_301 ,
V_302 , V_2 ) ) != 0 ) {
F_31 (KERN_ERR DEV_LABEL L_119 ) ;
goto V_303;
}
F_185 () ;
F_76 ( V_2 , V_192 & ~ ( V_241 | V_242 ) ) ;
V_2 -> V_25 = ( V_2 -> V_25 & ~ V_304 ) |
F_186 ( V_305 ) |
V_292 | V_293 ;
F_18 ( V_2 ) ;
...
F_18 ( V_2 ) ;
#endif
memcpy ( V_276 -> V_306 , F_74 ( V_2 ) , V_307 ) ;
F_156 ( V_2 ) ;
F_31 (KERN_NOTICE DEV_LABEL L_120
L_121 , lanai->number, (int) lanai->pci->revision,
(unsigned long) lanai->base, lanai->pci->irq, atmdev->esi) ;
F_31 (KERN_NOTICE DEV_LABEL L_122
L_123 , lanai->number,
lanai->type==lanai2 ? L_124 : L_125 , (unsigned int) lanai->serialno,
...
static void F_189 ( struct V_275 * V_276 )
{
struct V_1 * V_2 = (struct V_1 * ) V_276 -> V_277 ;
F_31 (KERN_INFO DEV_LABEL L_126 ,
lanai->number) ;
F_159 ( V_2 ) ;
#ifdef F_21
V_2 -> V_25 = F_13 ( V_2 , V_26 ) & ~ V_29 ;
...
{
struct V_39 * V_40 = (struct V_39 * ) V_46 -> V_277 ;
struct V_1 * V_2 = (struct V_1 * ) V_46 -> V_308 -> V_277 ;
if ( V_40 == NULL )
return;
F_193 ( V_309 , & V_46 -> V_82 ) ;
F_193 ( V_310 , & V_46 -> V_82 ) ;
...
int V_36 = 0 ;
int V_4 = V_46 -> V_4 ;
short V_313 = V_46 -> V_313 ;
if ( ( F_195 ( V_310 , & V_46 -> V_82 ) ) ||
( V_313 == V_314 ) || ( V_4 == V_315 ) )
return - V_254 ;
V_2 = (struct V_1 * ) V_46 -> V_308 -> V_277 ;
V_36 = F_175 ( V_2 , V_46 , & V_313 , & V_4 ) ;
if ( F_22 ( V_36 != 0 ) )
goto V_172;
F_196 ( V_312 , & V_46 -> V_82 ) ;
if ( V_46 -> V_52 . V_53 != V_186 && V_46 -> V_52 . V_53 != V_54 )
return - V_254 ;
F_24 ( V_302 L_127 , V_2 -> V_199 ,
( int ) V_313 , V_4 ) ;
V_40 = V_2 -> V_179 [ V_4 ] ;
if ( V_40 == NULL ) {
V_40 = F_122 () ;
...
V_40 -> V_311 ++ ;
if ( V_46 -> V_52 . V_184 . V_75 != V_256 ) {
F_6 ( V_40 -> V_51 . V_46 == NULL , L_128 ,
V_4 ) ;
if ( V_46 -> V_52 . V_53 == V_186 ) {
if ( V_2 -> V_257 == 0 )
V_36 = F_59 ( V_2 ) ;
...
if ( V_46 -> V_52 . V_74 . V_75 != V_256 ) {
F_6 ( V_40 -> V_67 . V_46 == NULL , L_129 ,
V_4 ) ;
...
static int F_200 ( struct V_275 * V_276 , T_12 * V_150 , char * V_318 )
{
struct V_1 * V_2 = (struct V_1 * ) V_276 -> V_277 ;
T_12 V_319 = * V_150 ;
struct V_39 * V_40 ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , V_302 L_134
L_135 ,
V_276 -> V_199 , V_2 -> type == V_320 ? L_124 : L_125 ,
( unsigned int ) V_2 -> V_97 ,
( unsigned int ) V_2 -> V_98 , V_2 -> V_177 ) ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_136 ,
V_2 -> V_290 , ( int ) V_2 -> V_10 -> V_321 ) ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_137 ,
& V_2 -> V_95 [ V_96 ] ) ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_138
L_139 , ( V_2 -> V_123 & V_128 ) ? 1 : 0 ,
( V_2 -> V_123 & V_129 ) ? 1 : 0 ,
( V_2 -> V_123 & V_130 ) ? 1 : 0 ,
( V_2 -> V_123 & V_131 ) ? 1 : 0 ) ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_140
L_141 , F_7 ( & V_2 -> V_195 ) ,
V_2 -> V_257 ? F_7 ( & V_2 -> V_92 ) : 0 ) ;
if ( V_319 -- == 0 ) {
F_144 ( V_2 ) ;
return sprintf ( V_318 , L_142
L_143 ,
V_2 -> V_166 . V_210 , V_2 -> V_166 . V_221 ,
V_2 -> V_166 . V_220 , V_2 -> V_166 . V_219 ) ;
}
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_144
L_145 ,
V_2 -> V_166 . V_322 ,
V_2 -> V_166 . V_323 ,
V_2 -> V_166 . V_324 ) ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_146
L_147 , V_2 -> V_166 . V_325 ,
V_2 -> V_166 . V_326 ) ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_148
L_149 , V_2 -> V_166 . V_202 ,
V_2 -> V_166 . V_201 ,
V_2 -> V_166 . V_204 ) ;
if ( V_319 -- == 0 )
return sprintf ( V_318 , L_150 ,
...
if ( ( V_40 = V_2 -> V_179 [ V_319 ] ) != NULL )
break;
( * V_150 ) ++ ;
}
V_319 = sprintf ( V_318 , L_151 , ( T_1 ) V_319 ,
V_40 -> V_311 , V_40 -> V_166 . V_174 ) ;
if ( V_40 -> V_51 . V_46 != NULL ) {
V_319 += sprintf ( & V_318 [ V_319 ] , L_152 ,
V_40 -> V_51 . V_46 -> V_52 . V_53 == V_54 ? 5 : 0 ) ;
if ( V_40 -> V_51 . V_46 -> V_52 . V_53 == V_54 )
V_319 += sprintf ( & V_318 [ V_319 ] , L_153
L_154
L_155 ,
F_7 ( & V_40 -> V_51 . V_6 ) ,
V_40 -> V_166 . T_7 . V_170 . V_171 ,
...
V_319 += sprintf ( & V_318 [ V_319 ] , L_156
L_157 ,
V_40 -> V_67 . V_46 -> V_52 . V_53 == V_54 ? 5 : 0 ,
F_7 ( & V_40 -> V_67 . V_6 ) ,
V_40 -> V_67 . V_46 == V_2 -> V_259 ? 'C' : 'U' ,
F_85 ( V_40 ) ? 'Y' : 'N' ) ;
V_318 [ V_319 ++ ] = '\n' ;
V_318 [ V_319 ] = '\0' ;
V_172:
...
V_276 = F_203 ( V_302 , & V_10 -> V_308 , & V_329 , - 1 , NULL ) ;
if ( V_276 == NULL ) {
F_31 (KERN_ERR DEV_LABEL
L_159 ) ;
F_191 ( V_2 ) ;
...
V_276 -> V_277 = V_2 ;
V_2 -> V_10 = V_10 ;
V_2 -> type = (enum V_330 ) V_328 -> V_331 ;
V_36 = F_180 ( V_276 ) ;
if ( V_36 != 0 ) {
F_24 ( L_160 , - V_36 ) ;
F_204 ( V_276 ) ;
