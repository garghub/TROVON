...
static void F_117 ( struct V_202 * V_203 )
{
if ( V_203 -> V_204 ) {
if ( V_203 -> V_205 &&
V_203 -> V_204 != F_118 ( V_203 -> V_205 ) ) {
F_119 ( V_203 -> V_205 , V_203 -> V_204 ) ;
F_119 ( V_203 -> V_206 , 0 ) ;
F_38 ( L_26 ,
V_203 -> V_205 -> V_181 , & V_203 -> V_204 ) ;
} else if ( V_203 -> V_204 !=
F_118 ( V_203 -> V_206 ) ) {
F_119 ( V_203 -> V_206 , V_203 -> V_204 ) ;
F_38 ( L_26 ,
V_203 -> V_206 -> V_181 , & V_203 -> V_204 ) ;
}
} else if ( F_118 ( V_203 -> V_206 ) ) {
if ( V_203 -> V_205 )
F_119 ( V_203 -> V_205 , 0 ) ;
F_119 ( V_203 -> V_206 , 0 ) ;
}
...
V_2 -> V_96 = 0 ;
V_2 -> V_41 = F_121 ( V_167 , V_201 -> V_211 , V_206 ) ;
if ( ! V_2 -> V_41 ) {
F_98 ( L_28 ) ;
return - V_212 ;
}
F_69 ( V_2 ) ;
V_2 -> V_18 = F_122 ( V_167 , & V_117 , V_2 ) ;
if ( V_2 -> V_18 < 0 ) {
F_98 ( L_29 ) ;
goto V_213;
}
...
V_4 -> V_142 = (struct V_143 * ) V_2 ;
F_32 ( V_4 , F_17 ) ;
V_2 -> V_109 = V_2 -> V_101 = F_123 ( V_167 ) -> V_214 - 1 ;
V_2 -> V_107 = 0 ;
V_2 -> V_30 = F_124 ( V_2 , F_125 ( V_201 ) ) ;
F_115 ( V_2 ) ;
V_2 -> V_163 = 0 ;
F_14 ( 1 << V_35 | 1 << V_36 ,
L_30 ,
...
unsigned int V_81 ;
int V_219 ;
if ( V_167 -> V_220 ( V_167 , V_221 , & V_81 ) < 0 ||
V_167 -> V_220 ( V_167 , V_222 , & V_216 ) < 0 ||
V_167 -> V_220 ( V_167 , V_223 , & V_218 ) < 0 ) {
F_127 ( L_31 , V_167 ) ;
return - V_212 ;
}
if ( V_224 > V_225 )
V_224 = V_225 ;
V_219 = F_128 ( V_39 , V_226 ,
V_224 ) ;
if ( V_219 < 0 )
return V_219 ;
F_40 ( V_81 ) ;
...
static inline void F_129 ( struct V_3 * V_4 , unsigned int V_234 )
{
struct V_235 * V_10 = (struct V_235 * ) V_4 -> V_11 ;
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_236 ) ) ;
V_10 -> V_237 = F_3 ( F_130 ( V_234 >> 5 ) |
F_131 ( V_238 ) ) ;
V_10 -> V_87 = F_3 ( F_132 ( V_239 >> 5 ) |
F_133 ( ( V_239 >> 3 ) + 1 ) ) ;
}
static int F_134 ( struct V_1 * V_2 , struct V_240 * V_197 ,
unsigned int V_31 , unsigned int V_241 ,
struct V_242 * V_243 )
{
struct V_208 * V_39 = V_2 -> V_39 ;
struct V_244 * V_245 = V_39 -> V_245 ;
unsigned int V_246 = ( V_31 << V_247 ) + V_245 -> V_248 ;
int V_82 ;
F_14 ( 1 << V_192 ,
L_33 ,
V_2 , V_31 , V_241 , V_243 ) ;
for ( V_82 = 0 ; V_82 < V_241 ; V_82 ++ , V_31 ++ , V_246 += V_239 ) {
struct V_3 * V_4 = F_37 ( sizeof( struct V_235 ) +
V_239 , 0 , V_77 ) ;
if ( ! V_4 )
return - V_137 ;
F_129 ( V_4 , V_246 ) ;
F_135 ( (struct V_249 * ) ( V_4 -> V_11 +
sizeof( struct V_235 ) ) ,
V_197 , V_243 , V_82 * V_250 ) ;
V_4 -> V_12 = V_251 ;
F_26 ( V_39 -> V_40 , V_4 ) ;
}
return 0 ;
}
static void F_136 ( struct V_202 * V_203 , unsigned int V_252 ,
unsigned int V_31 , unsigned int V_241 )
{
...
F_14 ( 1 << V_192 ,
L_34 ,
V_39 , V_31 , V_241 , V_252 ) ;
for ( V_82 = 0 ; V_82 < V_241 ; V_82 ++ , V_31 ++ , V_246 += V_239 ) {
struct V_3 * V_4 = F_37 ( sizeof( struct V_235 ) +
V_239 , 0 , V_77 ) ;
if ( ! V_4 ) {
F_98 ( L_35 ,
V_252 , V_31 , V_82 , V_241 ) ;
continue;
}
F_129 ( V_4 , V_246 ) ;
V_4 -> V_12 = V_251 ;
...
unsigned int V_46 , int V_253 , bool V_254 )
{
struct V_3 * V_4 = F_37 ( sizeof( struct V_255 ) , 0 ,
V_199 ) ;
struct V_255 * V_10 ;
T_2 V_256 = V_253 < V_257 ? V_253 : 0 ;
F_14 ( 1 << V_192 ,
L_36 , V_2 , V_46 , V_253 ) ;
if ( ! V_4 )
return - V_137 ;
V_10 = (struct V_255 * ) V_4 -> V_11 ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_16 ) ) ;
F_5 ( V_10 ) = F_3 ( F_6 ( V_258 , V_46 ) ) ;
V_10 -> V_254 = F_138 ( V_254 ? 0 : 1 ) ;
V_10 -> V_259 = 0 ;
V_10 -> V_260 = F_139 ( 31 ) ;
V_10 -> V_261 = F_140 ( 0xF0000000 ) ;
V_10 -> V_256 = F_140 ( V_256 << 28 ) ;
V_4 -> V_12 = V_251 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
static int F_141 ( struct V_1 * V_2 , unsigned int V_46 ,
int V_262 , int V_263 , int V_254 )
{
struct V_3 * V_4 = F_37 ( sizeof( struct V_255 ) , 0 ,
V_199 ) ;
struct V_255 * V_10 ;
T_2 V_256 = ( V_262 ? 1 : 0 ) | ( V_263 ? 2 : 0 ) ;
F_14 ( 1 << V_192 ,
L_37 , V_2 , V_46 , V_262 , V_263 ) ;
if ( ! V_4 )
return - V_137 ;
V_10 = (struct V_255 * ) V_4 -> V_11 ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_16 ) ) ;
...
V_10 -> V_259 = 0 ;
V_10 -> V_260 = F_139 ( 31 ) ;
V_10 -> V_261 = F_140 ( 0x0F000000 ) ;
V_10 -> V_256 = F_140 ( V_256 << 24 ) ;
V_4 -> V_12 = V_251 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
static void F_142 ( struct V_208 * V_39 )
{
...
static int F_144 ( struct V_208 * V_39 )
{
struct V_42 * V_53 = (struct V_42 * ) V_39 -> V_40 ;
struct V_244 * V_245 = V_53 -> V_264 ;
struct V_265 V_266 ;
unsigned int V_267 [ 4 ] ;
int V_163 ;
if ( V_245 ) {
F_145 ( & V_245 -> V_268 ) ;
F_127 ( L_39 ,
...
V_163 = V_53 -> V_220 ( V_53 , V_270 , & V_266 ) ;
if ( V_163 < 0 ) {
F_98 ( L_40 ,
V_53 -> V_181 , V_163 ) ;
return V_163 ;
}
V_163 = F_146 ( V_39 , V_266 . V_248 , V_266 . V_271 ,
V_266 . V_272 , V_266 . V_273 ) ;
if ( V_163 < 0 )
return V_163 ;
V_245 = V_39 -> V_245 ;
V_266 . V_274 = V_245 -> V_275 << V_276 ;
F_147 ( V_267 ) ;
V_266 . V_271 = V_266 . V_248 + ( V_245 -> V_277 << V_247 ) ;
V_163 = V_53 -> V_220 ( V_53 , V_278 , & V_266 ) ;
if ( V_163 < 0 ) {
F_127 ( L_41 ,
V_53 -> V_181 , V_163 ) ;
F_143 ( V_39 ) ;
...
F_38 ( L_42
L_43 ,
V_53 , V_245 -> V_277 , V_245 -> V_283 , V_245 -> V_275 ,
V_245 -> V_284 , V_245 -> V_272 , V_266 . V_272 ,
V_245 -> V_273 , V_266 . V_273 ) ;
return 0 ;
}
static void F_148 ( struct V_42 * V_167 )
{
struct V_208 * V_39 = F_149 ( V_167 ) ;
if ( ! V_39 || V_39 -> V_38 & V_285 ) {
F_38 ( L_44 , V_39 , V_39 ? V_39 -> V_38 : 0 ) ;
return;
}
F_150 ( V_39 ) ;
}
static void F_151 ( struct V_42 * V_167 )
{
struct V_208 * V_39 = F_149 ( V_167 ) ;
struct V_286 * V_286 = F_152 ( V_167 ) ;
int V_82 , V_163 ;
if ( V_39 ) {
F_38 ( L_45 , V_39 ) ;
return;
}
V_39 = F_153 ( 0 , V_286 -> V_287 . V_288 ) ;
if ( ! V_39 ) {
F_127 ( L_46 , V_167 ) ;
return;
}
V_39 -> V_38 = V_289 | V_290 ;
V_39 -> V_40 = V_167 ;
V_39 -> V_291 = V_286 -> V_291 ;
V_39 -> V_179 = V_286 -> V_216 ;
V_39 -> V_288 = V_286 -> V_287 . V_288 ;
V_39 -> V_292 = V_286 -> V_287 . V_292 ;
V_39 -> V_293 = V_294 ;
V_39 -> V_295 = V_97 ;
V_39 -> V_296 = V_8 ;
V_39 -> V_297 = V_298 ;
V_39 -> V_299 = V_300 ;
V_39 -> V_301 = sizeof( struct V_170 ) ;
V_39 -> V_302 = F_142 ;
V_39 -> V_303 = & V_304 ;
V_163 = F_144 ( V_39 ) ;
if ( V_163 ) {
...
V_163 = F_154 ( V_39 , V_306 , V_225 ,
& V_307 , V_308 ) ;
if ( V_163 )
goto V_305;
for ( V_82 = 0 ; V_82 < V_39 -> V_288 ; V_82 ++ )
V_39 -> V_210 [ V_82 ] -> V_204 =
F_118 ( V_39 -> V_179 [ V_82 ] ) ;
F_38 ( L_49 ,
...
static void F_155 ( struct V_42 * V_167 , T_1 V_309 , T_1 V_216 )
{
struct V_208 * V_39 = F_149 ( V_167 ) ;
F_14 ( 1 << V_35 ,
L_50 ,
V_167 , V_39 , V_309 , V_216 ) ;
if ( ! V_39 )
return;
switch ( V_309 ) {
case V_310 :
...
{
int V_219 ;
F_157 ( V_312 L_51 , V_313 ) ;
V_219 = F_158 ( & V_304 , & V_308 ) ;
if ( V_219 < 0 )
return V_219 ;
F_159 ( & V_117 ) ;
return 0 ;
