...
static int F_56 ( struct V_1 * V_2 , struct V_102 * V_103 )
{
unsigned long V_9 ;
T_1 V_104 ;
F_6 ( & V_2 -> V_11 , V_9 ) ;
...
static int T_3 F_73 ( struct V_60 * V_61 ,
struct V_135 * V_136 ,
struct V_137 * V_138 )
{
struct V_1 * V_2 = F_26 ( V_61 ) ;
...
V_63 = F_77 ( & V_61 -> V_41 , V_61 -> V_134 ,
...
static int T_3 F_81 ( struct V_60 * V_61 )
{
...
unsigned long V_62 ;
int V_63 = 0 ;
V_2 = F_82 ( sizeof( struct V_1 ) , V_156 ) ;
if ( V_2 == NULL ) {
F_83 ( V_157 L_7 ) ;
return - V_147 ;
}
...
F_85 ( V_61 , V_2 ) ;
V_2 -> V_41 = & V_61 -> V_41 ;
V_138 = F_74 ( V_61 , V_140 , 0 ) ;
if ( ! V_138 ) {
V_63 = - V_147 ;
F_14 ( V_2 -> V_41 , L_8 ) ;
goto V_158;
}
V_2 -> V_5 = F_76 ( V_138 -> V_143 , F_86 ( V_138 ) ) ;
if ( ! V_2 -> V_5 ) {
V_63 = - V_147 ;
F_14 ( V_2 -> V_41 , L_9 ) ;
goto V_158;
...
memcpy ( V_2 -> V_108 , V_166 , sizeof( V_166 ) ) ;
F_73 ( V_61 , V_136 , V_138 ) ;
F_87 ( V_2 -> V_41 , L_12 ) ;
return 0 ;
V_165:
F_35 ( V_61 ) ;
...
static int T_5 F_89 ( struct V_60 * V_61 )
{
int V_63 ;
struct V_1 * V_2 = F_26 ( V_61 ) ;
F_78 ( V_61 ) ;
