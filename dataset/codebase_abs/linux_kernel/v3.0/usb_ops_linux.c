...
if ( V_27 == V_95 -> V_107 [ V_87 ] ) {
V_95 -> V_108 [ V_87 ] = false ;
break;
}
}
if ( V_35 -> V_40 )
...
return V_5 ;
for ( V_87 = 0 ; V_87 < 8 ; V_87 ++ ) {
if ( V_95 -> V_108 [ V_87 ] == false ) {
F_38 ( & V_92 -> V_114 , V_111 ) ;
V_92 -> V_106 ++ ;
V_95 -> V_108 [ V_87 ] = true ;
switch ( V_99 -> V_101 ) {
case 1 :
case 2 :
V_92 -> V_102 ++ ;
...
V_95 -> V_115 [ V_87 ] = ( V_116 ) V_42 ;
V_27 = V_95 -> V_107 [ V_87 ] ;
break;
}
}
V_112 = false ;
