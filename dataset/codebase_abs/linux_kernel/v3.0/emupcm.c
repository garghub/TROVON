...
static int F_78 ( struct V_12 * V_7 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
...
V_2 -> V_207 = F_3 ;
V_2 -> V_9 = V_7 ;
F_80 ( V_14 , 0 , V_208 , & V_209 ) ;
F_80 ( V_14 , 0 , V_210 , & V_211 ) ;
return 0 ;
}
static int F_81 ( struct V_12 * V_7 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
V_2 -> V_207 = NULL ;
V_2 -> V_9 = NULL ;
...
static int F_87 ( struct V_12 * V_7 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
V_2 -> V_207 = NULL ;
V_2 -> V_11 = NULL ;
...
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_88 ( V_2 -> V_181 , L_2 , V_243 , 32 , 1 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_89 ( V_246 , V_247 , & V_248 ) ;
F_89 ( V_246 , V_249 , & V_250 ) ;
V_246 -> V_251 = 0 ;
V_246 -> V_252 = V_253 ;
strcpy ( V_246 -> V_254 , L_3 ) ;
V_2 -> V_246 = V_246 ;
for ( V_7 = V_246 -> V_255 [ V_247 ] . V_7 ; V_7 ; V_7 = V_7 -> V_256 )
if ( ( V_23 = F_90 ( V_7 , V_257 , F_91 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ) < 0 )
return V_23 ;
for ( V_7 = V_246 -> V_255 [ V_249 ] . V_7 ; V_7 ; V_7 = V_7 -> V_256 )
F_90 ( V_7 , V_259 , F_91 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ;
if ( V_245 )
* V_245 = V_246 ;
return 0 ;
}
int T_2 F_92 ( struct V_1 * V_2 , int V_243 , struct V_244 * * V_245 )
{
struct V_244 * V_246 ;
struct V_12 * V_7 ;
int V_23 ;
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_88 ( V_2 -> V_181 , L_2 , V_243 , 1 , 0 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_89 ( V_246 , V_247 , & V_260 ) ;
V_246 -> V_251 = 0 ;
V_246 -> V_252 = V_253 ;
...
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_88 ( V_2 -> V_181 , L_5 , V_243 , 0 , 1 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_89 ( V_246 , V_249 , & V_262 ) ;
V_246 -> V_251 = 0 ;
strcpy ( V_246 -> V_254 , L_6 ) ;
V_2 -> V_263 = V_246 ;
F_94 ( V_246 , V_259 , F_91 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ;
if ( V_245 )
* V_245 = V_246 ;
return 0 ;
}
static int F_95 ( struct V_173 * V_264 , struct V_265 * V_266 )
{
struct V_1 * V_2 = F_96 ( V_264 ) ;
int V_226 = V_2 -> V_78 ? 64 : 32 ;
V_266 -> type = V_267 ;
V_266 -> V_268 = V_226 ;
...
static int F_97 ( struct V_173 * V_264 , struct V_272 * V_273 )
{
struct V_1 * V_2 = F_96 ( V_264 ) ;
int V_226 = V_2 -> V_78 ? 64 : 32 ;
int V_121 ;
...
static void F_99 ( struct V_1 * V_2 , void * V_15 )
{
struct V_12 * V_7 = V_15 ;
F_2 ( V_7 ) ;
}
static void F_100 ( unsigned short * V_278 ,
...
static void F_101 ( struct V_12 * V_7 ,
...
while ( V_290 > V_291 ) {
V_268 = V_291 + 1 ;
F_100 ( ( unsigned short * ) V_2 -> V_286 . V_292 . V_293 + V_291 ,
...
static int F_102 ( struct V_12 * V_7 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
F_103 ( V_7 , & V_246 -> V_294 , F_101 ) ;
return 0 ;
}
...
static int F_108 ( struct V_12 * V_7 , int V_157 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
int V_158 = 0 ;
...
#endif
V_158 = F_110 ( V_2 , F_99 , V_246 -> V_300 , V_7 , & V_246 -> V_317 ) ;
if ( V_158 < 0 )
goto V_318;
F_102 ( V_7 ) ;
...
case V_163 :
case V_164 :
F_111 ( V_2 , V_246 -> V_317 ) ; V_246 -> V_317 = NULL ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_301 , 0 , 0 ) ;
V_246 -> V_291 = F_107 ( V_246 -> V_21 ) ;
V_246 -> V_281 = 0 ;
break;
...
static T_1 F_112 ( struct V_12 * V_7 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
T_3 V_16 ;
...
return F_113 ( V_7 , & V_246 -> V_294 , V_16 ) ;
}
static int F_114 ( struct V_12 * V_7 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
struct V_13 * V_14 = V_7 -> V_14 ;
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
...
int T_2 F_116 ( struct V_1 * V_2 , int V_243 , struct V_244 * * V_245 )
{
struct V_244 * V_246 ;
struct V_173 * V_174 ;
int V_23 ;
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_88 ( V_2 -> V_181 , L_7 , V_243 , 8 , 1 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_89 ( V_246 , V_247 , & V_324 ) ;
F_89 ( V_246 , V_249 , & V_325 ) ;
V_246 -> V_251 = 0 ;
...
V_174 = F_117 ( & V_327 , V_2 ) ;
if ( ! V_174 )
return - V_113 ;
V_174 -> V_177 . V_243 = V_243 ;
F_118 ( V_2 -> V_181 , V_174 ) ;
F_94 ( V_246 , V_259 , F_91 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ;
return 0 ;
}
