...
if ( ( V_2 -> V_14 [ V_49 ] -> V_34 = F_56 ( V_78 ,
L_6 , F_24 , V_76 ,
V_2 -> V_14 [ V_49 ] ) ) < 0 ) {
F_57 ( V_66 ) ;
return - V_77 ;
...
F_59 ( V_2 -> V_14 [ V_44 ] -> V_34 ) & ~ V_79 ) ;
F_58 ( V_2 -> V_14 [ V_49 ] -> V_34 ,
F_59 ( V_2 -> V_14 [ V_49 ] -> V_34 ) & ~ V_79 ) ;
F_57 ( V_66 ) ;
V_2 -> V_42 = V_42 ;
return 0 ;
}
static unsigned short
F_60 ( struct V_80 * V_56 , unsigned short V_81 )
{
...
V_82 = V_2 -> V_6 -> V_60 & 0xffff ;
F_3 ( & V_2 -> V_5 ) ;
return V_82 ;
}
static void
F_61 ( struct V_80 * V_56 , unsigned short V_81 , unsigned short V_87 )
{
struct V_1 * V_2 = V_56 -> V_43 ;
T_1 V_60 ;
int V_28 ;
...
F_66 ( V_2 -> V_96 -> V_32 ) ;
F_54 ( & V_2 -> V_5 ) ;
F_67 ( F_68 ( V_99 ) & ~ 0x02 , V_99 ) ;
V_2 -> V_6 -> V_100 = V_101 | V_102 ;
F_69 ( 10 ) ;
V_2 -> V_6 -> V_100 = V_102 ;
F_69 ( 10 ) ;
V_2 -> V_6 -> V_7 = V_103 ;
...
V_2 -> V_6 -> V_7 = 0x0 ;
F_70 ( 5 ) ;
if ( ( V_52 = V_89 ( V_2 -> V_67 , 0 , & V_93 , V_2 , & V_90 ) ) < 0 )
return V_52 ;
memset ( & V_56 , 0 , sizeof( V_56 ) ) ;
V_56 . V_43 = V_2 ;
if ( ( V_52 = F_71 ( V_90 , & V_56 , & V_2 -> V_56 ) ) < 0 )
return V_52 ;
return 0 ;
}
void
F_72 ( struct V_104 * V_67 )
{
...
strcpy ( V_67 -> V_107 , L_12 ) ;
strcpy ( V_67 -> V_108 , L_13 ) ;
sprintf ( V_67 -> V_109 , L_14 ) ;
if ( ( V_52 = F_78 ( V_67 ) ) < 0 ) {
F_77 ( V_67 ) ;
return V_52 ;
}
