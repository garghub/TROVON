...
static void T_2
F_3 ( unsigned int V_31 , bool V_32 )
{
int V_33 = 0 , V_34 = 0 ;
if( V_31 == 0 ) {
if( ! V_32 )
...
static bool T_2
F_14 ( struct V_95 * V_96 , T_4 * V_97 )
{
...
static void T_2
F_15 ( struct V_76 * V_77 , struct V_95 * V_96 , int V_116 )
{
...
static int
F_20 ( struct V_76 * V_77 , int V_132 , T_3 V_119 )
{
T_5 V_42 = 0 , V_43 , V_133 ;
#ifdef F_21
if( V_77 -> V_122 == V_134 ) {
...
{
int V_33 = 0 ;
T_5 V_42 = V_37 [ V_124 ] . V_42 ;
T_5 V_43 = V_37 [ V_124 ] . V_43 ;
V_77 -> V_125 = 0 ;
...
static T_3
F_35 ( struct V_76 * V_77 , T_3 * V_158 , T_3 * V_159 )
{
T_4 V_147 , V_160 , V_161 , V_162 , V_163 ;
T_3 V_164 = 0 ;
( * V_158 ) = ( * V_159 ) = 0 ;
...
{
T_4 V_174 , V_175 , V_176 , V_177 = 0 , V_178 , V_179 ;
bool V_180 = true ;
switch( V_173 ) {
case V_181 :
V_174 = 0x00 ;
...
{
struct V_76 * V_77 = (struct V_76 * ) V_82 -> V_77 ;
F_45 ( V_77 -> V_198 , V_156 , ( T_3 ) V_197 ) ;
}
unsigned int
...
{
struct V_76 * V_77 = (struct V_76 * ) V_82 -> V_77 ;
F_48 ( V_77 -> V_198 , V_156 , ( T_4 ) V_197 ) ;
}
unsigned int
...
static int
F_67 ( struct V_76 * V_77 , struct V_200 * V_201 )
{
if( V_201 -> V_267 > ( V_201 -> V_210 - V_201 -> V_42 ) ) {
return - V_232 ;
}
if( V_201 -> V_268 > ( V_201 -> V_269 - V_201 -> V_43 ) ) {
return - V_232 ;
}
V_77 -> V_270 = ( V_201 -> V_268 * V_201 -> V_210 ) + V_201 -> V_267 ;
switch( V_201 -> V_202 ) {
case 32 :
break;
case 16 :
...
V_77 -> V_270 += ( V_77 -> V_271 >> 2 ) ;
F_65 ( V_77 , V_77 -> V_270 ) ;
F_66 ( V_77 , V_77 -> V_270 ) ;
return 0 ;
}
static int
F_68 ( struct V_234 * V_235 , int V_272 )
{
return 0 ;
}
static int
F_69 ( struct V_234 * V_235 , int V_272 )
{
return 0 ;
}
static int
F_70 ( unsigned V_273 , unsigned V_222 , unsigned V_224 , unsigned V_225 ,
unsigned V_227 , struct V_234 * V_235 )
{
struct V_76 * V_77 = (struct V_76 * ) V_235 -> V_236 ;
if( V_273 >= F_51 ( & V_235 -> V_201 ) )
return 1 ;
...
{
int V_279 ;
if( ( V_279 = F_63 ( & V_235 -> V_201 , 1 , V_235 ) ) )
return V_279 ;
F_73 ( & V_235 -> V_280 , - 1 , V_235 ) ;
return 0 ;
}
static int
...
{
struct V_76 * V_77 = (struct V_76 * ) V_235 -> V_236 ;
unsigned int V_126 = 0 , V_127 = 0 , V_281 = 0 ;
unsigned int V_237 = 0 , V_238 = 0 , V_208 ;
int V_239 = 0 ;
int V_148 , V_282 , V_283 ;
bool V_284 = false ;
T_3 V_241 ;
V_126 = V_201 -> V_242 + V_201 -> V_42 + V_201 -> V_243 + V_201 -> V_244 ;
V_127 = V_201 -> V_245 + V_201 -> V_246 + V_201 -> V_247 ;
...
V_282 = 0 ;
while( ( V_37 [ V_282 ] . V_38 [ 0 ] != 0 ) &&
( V_37 [ V_282 ] . V_42 <= V_201 -> V_42 ) ) {
if( ( V_37 [ V_282 ] . V_42 == V_201 -> V_42 ) &&
( V_37 [ V_282 ] . V_43 == V_201 -> V_43 ) &&
( V_37 [ V_282 ] . V_250 == V_201 -> V_202 ) ) {
if( ( V_283 = F_20 ( V_77 , V_282 ,
V_77 -> V_157 ) ) > 0 ) {
V_239 = 1 ;
V_282 = V_283 ;
break;
...
V_282 = 0 ;
while( V_37 [ V_282 ] . V_38 [ 0 ] != 0 ) {
if( ( V_201 -> V_42 <= V_37 [ V_282 ] . V_42 ) &&
( V_201 -> V_43 <= V_37 [ V_282 ] . V_43 ) &&
( V_201 -> V_202 == V_37 [ V_282 ] . V_250 ) ) {
if( ( V_283 = F_20 ( V_77 , V_282 ,
V_77 -> V_157 ) ) > 0 ) {
V_239 = 1 ;
V_282 = V_283 ;
...
( V_77 -> V_261 != V_127 ) ) &&
( V_77 -> V_263 == V_201 -> V_241 ) ) {
if( V_77 -> V_265 [ V_37 [ V_282 ] . V_38 [ V_77 -> V_130 ] ] ) {
V_148 =
V_77 -> V_265 [ V_37 [ V_282 ] . V_38 [ V_77 -> V_130 ] ] ;
} else if( V_77 -> V_9 != - 1 ) {
V_148 = V_77 -> V_9 ;
} else {
V_148 = 60 ;
...
V_281 = F_25 ( V_77 , V_148 , V_282 ) ;
if( V_284 ) {
if( ! V_281 ) V_281 = V_37 [ V_282 ] . V_125 ;
V_201 -> V_241 = ( T_3 ) ( 1000000000 / F_76 ( & V_77 -> V_82 ,
V_37 [ V_282 ] . V_38 [ V_77 -> V_130 ] ,
V_281 ) ) ;
F_77 ( & V_77 -> V_82 ,
V_37 [ V_282 ] . V_38 [ V_77 -> V_130 ] ,
V_281 , V_201 ) ;
...
F_58 ( V_77 , V_201 ) ;
if( V_201 -> V_267 < 0 ) V_201 -> V_267 = 0 ;
...
if( V_201 -> V_269 > V_208 ) {
V_201 -> V_269 = V_208 ;
}
}
if( V_201 -> V_269 <= V_201 -> V_43 ) {
V_201 -> V_269 = V_201 -> V_43 ;
}
} else {
if( V_201 -> V_43 != V_201 -> V_269 ) {
V_201 -> V_269 = V_201 -> V_43 ;
}
V_201 -> V_267 = 0 ;
V_201 -> V_268 = 0 ;
...
if( V_201 -> V_267 > V_201 -> V_210 - V_201 -> V_42 ) {
V_201 -> V_267 = V_201 -> V_210 - V_201 -> V_42 - 1 ;
}
if( V_201 -> V_268 > V_201 -> V_269 - V_201 -> V_43 ) {
V_201 -> V_268 = V_201 -> V_269 - V_201 -> V_43 - 1 ;
}
V_201 -> V_222 . V_285 =
V_201 -> V_224 . V_285 =
V_201 -> V_225 . V_285 =
...
return - V_232 ;
if( V_201 -> V_267 + V_235 -> V_201 . V_42 > V_235 -> V_201 . V_210 ||
V_201 -> V_268 + V_235 -> V_201 . V_43 > V_235 -> V_201 . V_269 )
return - V_232 ;
if( ( V_279 = F_67 ( V_77 , V_201 ) ) < 0 )
return V_279 ;
V_235 -> V_201 . V_267 = V_201 -> V_267 ;
...
V_77 -> V_307 . V_356 = ( T_5 ) ( V_77 -> V_357 + 32 ) ;
V_77 -> V_307 . V_358 = ( T_5 ) ( V_77 -> V_359 + 32 ) ;
V_77 -> V_307 . V_360 = V_77 -> V_361 / 1024 ;
V_77 -> V_307 . V_362 = V_77 -> V_271 ;
...
case V_372 :
if( F_34 ( V_77 ) )
return F_88 ( ( T_3 ) 1 , V_294 ) ;
else
return F_88 ( ( T_3 ) 0 , V_294 ) ;
case V_373 :
if( V_77 -> V_305 ++ < 10 )
F_4 ( V_72
L_47 ) ;
...
break;
case V_378 :
return F_88 ( ( T_3 ) ( ( ( V_77 -> V_357 + 32 ) << 16 ) | ( ( V_77 -> V_359 + 32 ) & 0xffff ) ) ,
V_294 ) ;
case V_379 :
...
static int
F_73 ( struct V_385 * V_280 , int V_386 , struct V_234 * V_235 )
{
struct V_76 * V_77 = (struct V_76 * ) V_235 -> V_236 ;
memset ( V_280 , 0 , sizeof( struct V_385 ) ) ;
F_93 ( V_280 -> V_387 , V_77 -> V_388 , sizeof( V_280 -> V_387 ) ) ;
F_94 ( & V_235 -> V_389 ) ;
V_280 -> V_390 = V_77 -> V_391 + V_77 -> V_271 ;
V_280 -> V_392 = V_77 -> V_209 ;
F_95 ( & V_235 -> V_389 ) ;
V_280 -> type = V_393 ;
V_280 -> V_394 = 0 ;
V_280 -> V_395 = ( V_77 -> V_203 == 8 ) ? V_396 : V_397 ;
V_280 -> V_398 = 1 ;
V_280 -> V_399 = ( V_77 -> V_4 ) ? 1 : 0 ;
V_280 -> V_400 = 0 ;
V_280 -> V_401 = V_77 -> V_211 ;
V_280 -> V_402 = V_77 -> V_403 ;
V_280 -> V_404 = V_77 -> V_405 ;
if( V_77 -> V_122 == V_134 ) {
V_280 -> V_207 = V_406 ;
...
static void T_2
F_105 ( struct V_76 * V_77 )
{
unsigned char V_97 [ 256 ] ;
unsigned short V_117 , V_118 , V_33 ;
T_4 V_156 , V_481 = 0 , V_482 = 0 ;
T_5 V_42 , V_43 ;
...
static int T_2
F_106 ( struct V_76 * V_77 , T_5 type , T_5 V_487 )
{
...
{
T_4 V_491 , V_492 , V_493 , V_494 , V_495 = 0 ;
T_5 V_496 = 0 , V_497 = 0 ;
T_5 V_498 = 0 , V_499 = 0 ;
T_5 V_500 = 0 , V_501 = 0 ;
int V_502 , V_489 ;
...
F_56 ( V_153 , V_551 , ( T_4 ) ( V_548 & 0xff ) ) ;
V_77 -> V_326 |= V_544 ;
}
#endif
#ifdef F_18
...
V_552 = ( T_3 ) ( V_77 -> V_320 - V_77 -> V_328 ) ;
...
static T_3 T_2
F_124 ( struct V_76 * V_77 )
{
T_3 V_164 = V_77 -> V_2 * 1024 ;
T_3 V_602 = V_77 -> V_320 - V_77 -> V_603 - V_77 -> V_328 ;
T_3 V_604 ;
if( V_77 -> V_122 == V_134 ) {
...
static T_3 T_2
F_125 ( struct V_76 * V_77 )
{
T_3 V_606 = V_77 -> V_320 - V_77 -> V_603 - V_77 -> V_328 ;
T_3 V_164 = 0 ;
...
static struct V_607 *
F_129 ( struct V_622 * V_623 , T_3 V_618 )
{
struct V_607 * V_631 ;
struct V_607 * V_632 ;
int V_633 = 0 ;
...
static struct V_607 *
F_132 ( struct V_622 * V_623 , T_3 V_266 )
{
struct V_607 * V_631 ;
struct V_607 * V_636 ;
struct V_607 * V_617 ;
...
V_608 = F_129 ( & V_77 -> V_611 , ( T_3 ) V_640 -> V_618 ) ;
if( V_608 == NULL ) {
...
static void
F_137 ( struct V_76 * V_77 , T_3 V_266 )
{
struct V_607 * V_608 ;
if( ( ! V_77 ) || ( V_77 -> V_308 != V_309 ) || ( V_77 -> V_641 ) )
return;
...
void
F_138 ( struct V_416 * V_418 , T_3 V_266 )
{
struct V_76 * V_77 = F_136 ( V_418 ) ;
F_137 ( V_77 , V_266 ) ;
}
...
{
T_4 V_642 = 0 , V_643 = 0 , V_647 = 0 , V_648 = 0 , V_649 = 0 ;
int V_650 = 0 ;
...
T_4 V_667 , V_668 , V_669 , V_670 , V_671 ;
...
static int T_2
F_147 ( void T_6 * V_695 , struct V_76 * V_77 )
{
void T_6 * V_696 ;
int V_697 ;
...
static void T_2
F_156 ( struct V_76 * V_77 , unsigned int * V_700 ,
unsigned int V_701 )
{
if ( * V_700 < ( V_701 << 20 ) )
return;
...
static int T_2
F_157 ( struct V_76 * V_77 )
{
void T_6 * V_702 = V_77 -> V_569 ;
unsigned short V_117 ;
unsigned char V_156 ;
int V_33 , V_34 ;
...
static int T_2
F_161 ( struct V_76 * V_77 , int V_703 , int V_704 ,
int V_705 , int V_706 ,
unsigned int V_700 )
{
void T_6 * V_707 = V_77 -> V_569 ;
unsigned short V_708 ;
unsigned int V_709 , V_710 , V_711 , V_712 , V_713 ;
unsigned int V_714 , V_715 , V_716 ;
static const unsigned short V_717 [ 17 ] [ 5 ] = {
...
static void T_2
F_162 ( struct V_416 * V_418 , unsigned int V_700 )
{
struct V_76 * V_77 = F_136 ( V_418 ) ;
int V_33 , V_34 , V_704 ;
int V_705 , V_706 ;
...
static void T_2
F_163 ( struct V_416 * V_418 )
{
struct V_76 * V_77 = F_136 ( V_418 ) ;
unsigned char * V_718 = V_77 -> V_82 . V_84 ;
T_4 V_156 , V_719 , V_720 , V_721 , V_722 , V_723 , V_724 , V_725 , V_726 ;
T_5 V_99 , V_727 , V_728 = 0 ;
unsigned int V_700 ;
if( ! V_77 -> V_82 . V_83 )
V_718 = NULL ;
F_56 ( V_153 , 0x05 , 0x86 ) ;
...
static void T_2
F_165 ( struct V_76 * V_77 , int V_732 )
{
unsigned int V_33 ;
T_4 V_156 ;
...
static int T_2
F_166 ( struct V_76 * V_77 , struct V_416 * V_733 ,
...
static int T_2
F_169 ( struct V_76 * V_77 , int V_737 ,
...
static void T_2
F_171 ( struct V_76 * V_77 , T_4 V_749 )
{
T_4 V_719 , V_720 , V_721 ;
int V_99 ;
static const T_4 V_750 [ 8 * 3 ] = {
0x16 , 0x01 , 0x01 ,
0x3e , 0x03 , 0x01 ,
0x7c , 0x08 , 0x01 ,
0x79 , 0x06 , 0x01 ,
...
static void T_2
F_172 ( struct V_76 * V_77 , T_4 V_749 )
{
...
static void T_2
F_174 ( struct V_76 * V_77 , T_4 V_749 )
{
unsigned char * V_718 = V_77 -> V_514 ;
static const T_4 V_752 [ 8 ] = {
0x88 , 0xaa , 0x48 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00
} ;
static const T_4 V_753 [ 8 ] = {
0x44 , 0x77 , 0x77 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00
} ;
static const T_4 V_754 [ 8 ] = {
...
static int T_2
F_176 ( struct V_416 * V_418 )
{
struct V_76 * V_77 = F_136 ( V_418 ) ;
unsigned char * V_718 = V_77 -> V_514 ;
struct V_416 * V_733 = NULL ;
const T_4 * V_756 , * V_757 ;
T_4 V_719 , V_720 , V_721 , V_722 , V_723 , V_156 , V_755 ;
T_3 V_758 , V_749 , V_759 ;
int V_33 , V_34 , V_709 , V_99 ;
static const T_4 V_760 [ 3 ] = { 0xf6 , 0x0d , 0x00 } ;
static const T_4 V_761 [ 2 ] = { 0xa3 , 0xfb } ;
static const T_4 V_762 [ 3 ] = { 0xc0 , 0x11 , 0x00 } ;
static const T_4 V_752 [ 8 ] = {
0x88 , 0xaa , 0x48 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00
} ;
static const T_4 V_753 [ 8 ] = {
...
static const T_4 V_769 [ 3 * 8 ] = {
0xf0 , 0xf0 , 0xf0 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 ,
0x05 , 0x02 , 0x02 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 ,
0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00
} ;
static const T_4 V_770 [ 2 * 8 ] = {
...
V_756 = ( const T_4 * ) & V_718 [ V_99 ] ;
V_757 = ( const T_4 * ) & V_718 [ V_99 + 0x20 ] ;
}
for( V_33 = 0 ; V_33 < 2 ; V_33 ++ ) {
if( V_33 == 0 ) {
V_759 = F_178 ( ( ( T_3 * ) V_756 ) [ V_749 ] ) ;
V_758 = 0x6b ;
} else {
V_759 = F_178 ( ( ( T_3 * ) V_757 ) [ V_749 ] ) ;
V_758 = 0x6e ;
}
V_156 = 0x00 ;
...
V_759 = F_179 ( ( ( const T_5 * ) V_756 ) [ V_749 ] ) ;
V_156 = 0x80 ;
...
static int T_2
F_181 ( struct V_416 * V_418 , const struct V_777 * V_778 )
{
...
#if F_2 ( V_27 ) || F_2 ( V_28 )
unsigned char T_6 * V_820 = F_154 ( 0x400 , 0x100 ) ;
if( V_820 ) {
...
V_77 -> V_811 . V_43 = V_77 -> V_811 . V_269 = V_77 -> V_256 ;
V_77 -> V_811 . V_202 = V_77 -> V_203 ;
F_58 ( V_77 , & V_77 -> V_811 ) ;
V_77 -> V_811 . V_241 = ( T_3 ) ( 1000000000 /
...
if( V_77 -> V_811 . V_269 < V_77 -> V_811 . V_43 ) {
V_77 -> V_811 . V_269 = V_77 -> V_811 . V_43 ;
}
}
...
V_782 -> V_280 = V_77 -> V_847 ;
V_782 -> V_848 = V_77 -> V_569 + V_77 -> V_271 ;
V_782 -> V_849 = & V_850 ;
V_782 -> V_278 = V_77 -> V_278 ;
...
static void T_8 F_204 ( struct V_416 * V_418 )
{
struct V_76 * V_77 = F_136 ( V_418 ) ;
