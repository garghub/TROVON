...
static T_1 F_3 ( struct V_2 * V_3 , struct V_4 * V_5 , char * V_6 )
{
...
struct V_7 * V_8 ;
int V_35 ;
V_8 = F_14 ( sizeof( struct V_7 ) , V_36 ) ;
if ( ! V_8 ) {
V_35 = - V_37 ;
goto exit;
}
...
F_16 ( & V_8 -> V_39 ) ;
F_17 ( V_32 ) ;
if ( ( V_35 = F_18 ( & V_32 -> V_3 . V_40 , & V_41 ) ) )
goto V_42;
V_8 -> V_43 = F_19 ( & V_32 -> V_3 ) ;
if ( F_20 ( V_8 -> V_43 ) ) {
V_35 = F_21 ( V_8 -> V_43 ) ;
goto V_44;
}
...
{
struct V_7 * V_8 = F_26 ( V_13 ) ;
F_27 ( V_8 -> V_43 ) ;
F_22 ( & V_13 -> V_3 . V_40 , & V_41 ) ;
F_23 ( V_8 ) ;
return 0 ;
}
static struct V_7 * F_4 ( struct V_2 * V_3 )
{
struct V_12 * V_13 = F_28 ( V_3 ) ;
struct V_7 * V_8 = F_26 ( V_13 ) ;
F_29 ( & V_8 -> V_39 ) ;
if ( F_30 ( V_48 , V_8 -> V_49 + V_50 * 2 ) || ! V_8 -> V_38 ) {
F_10 ( & V_13 -> V_3 , L_5 ) ;
V_8 -> V_51 = F_9 ( V_13 ,
V_52 ) ;
V_8 -> V_53 = F_9 ( V_13 ,
