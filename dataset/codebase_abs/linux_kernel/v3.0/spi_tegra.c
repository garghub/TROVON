...
if ( ! F_39 ( V_83 -> V_95 , ( V_83 -> V_96 - V_83 -> V_95 ) + 1 ,
F_40 ( & V_80 -> V_60 ) ) ) {
V_84 = - V_97 ;
goto V_94;
}
V_2 -> V_98 = V_83 -> V_95 ;
V_2 -> V_4 = F_41 ( V_83 -> V_95 , V_83 -> V_96 - V_83 -> V_95 + 1 ) ;
if ( ! V_2 -> V_4 ) {
F_35 ( & V_80 -> V_60 , L_5 ) ;
V_84 = - V_85 ;
goto V_99;
}
V_2 -> V_33 = F_42 ( & V_80 -> V_60 , NULL ) ;
if ( F_43 ( V_2 -> V_33 ) ) {
F_35 ( & V_80 -> V_60 , L_6 ) ;
V_84 = F_44 ( V_2 -> V_33 ) ;
goto V_100;
...
V_2 -> V_24 = F_47 ( & V_80 -> V_60 , sizeof( T_2 ) * V_15 ,
& V_2 -> V_103 , V_104 ) ;
if ( ! V_2 -> V_24 ) {
F_35 ( & V_80 -> V_60 , L_8 ) ;
V_84 = - V_85 ;
...
V_2 -> V_8 . V_69 = F_21 ;
V_2 -> V_8 . V_106 = 1 ;
V_2 -> V_8 . V_107 = V_2 -> V_103 ;
V_2 -> V_8 . V_108 = 32 ;
V_2 -> V_8 . V_109 = V_2 -> V_98 + V_110 ;
V_2 -> V_8 . V_111 = 32 ;
V_2 -> V_8 . V_112 = 4 ;
V_2 -> V_8 . V_113 = V_114 [ V_80 -> V_88 ] ;
V_2 -> V_8 . V_60 = V_2 ;
V_84 = F_48 ( V_27 ) ;
if ( V_84 < 0 )
goto V_115;
return V_84 ;
V_115:
F_49 ( & V_80 -> V_60 , sizeof( T_2 ) * V_15 ,
V_2 -> V_24 , V_2 -> V_103 ) ;
V_105:
F_50 ( V_2 -> V_10 ) ;
V_102:
...
F_52 ( V_2 -> V_4 ) ;
V_99:
F_53 ( V_83 -> V_95 , ( V_83 -> V_96 - V_83 -> V_95 ) + 1 ) ;
V_94:
F_54 ( V_27 ) ;
return V_84 ;
}
static int T_4 F_55 ( struct V_79 * V_80 )
{
struct V_81 * V_27 ;
struct V_1 * V_2 ;
struct V_82 * V_83 ;
