...
V_4 -> V_19 . V_20 . V_21 &&
( F_4 ( V_4 -> V_19 . V_20 . V_21 ) == V_22 ||
F_5 ( V_10 ,
F_4 ( V_4 -> V_19 . V_20 . V_21 ) ) ) &&
V_4 -> V_19 . V_20 . V_23 &&
( F_4 ( V_4 -> V_19 . V_20 . V_23 ) == V_22 ||
F_5 ( V_10 ,
F_4 ( V_4 -> V_19 . V_20 . V_23 ) ) ) ;
if ( F_6 ( F_7 ( ! V_8 , V_10 ,
V_24 ,
V_25 ) ) ) {
if ( V_7 )
...
F_3 ( V_4 -> V_16 ) <=
V_2 -> V_17 -> V_18 ( V_2 , V_5 ) &&
( F_2 ( V_4 -> V_19 . V_37 . V_21 ) == V_38 ||
F_2 ( V_4 -> V_19 . V_37 . V_21 ) < V_32 ) &&
V_4 -> V_19 . V_37 . V_21 &&
( F_2 ( V_4 -> V_19 . V_37 . V_23 ) == V_38 ||
F_2 ( V_4 -> V_19 . V_37 . V_23 ) < V_32 ) &&
V_4 -> V_19 . V_37 . V_23 ;
if ( F_6 ( F_7 ( ! V_33 , V_2 -> V_11 ,
V_39 ,
V_40 ) ) ) {
if ( V_7 )
F_8 ( V_7 , V_26 ) ;
...
if ( ( error = F_23 ( V_10 , V_60 , V_10 -> V_65 ,
F_24 ( V_7 ) , V_10 -> V_66 , 0 , & V_7 ) ) ) {
F_19 ( V_59 , error ) ;
* V_58 = NULL ;
return error ;
}
...
static inline T_7 F_26 ( struct V_1 * V_2 )
{
return ( V_2 -> V_41 & V_42 ) ?
V_67 :
V_68 ;
}
static inline T_7 F_27 ( struct V_1 * V_2 )
{
return ( V_2 -> V_41 & V_42 ) ?
...
{
struct V_76 * V_77 ;
V_77 = F_36 ( V_2 -> V_34 . V_55 . V_78 , V_2 -> V_34 . V_55 . V_79 ) ;
...
ASSERT ( V_83 != V_86 ) ;
V_85 = F_40 ( V_10 , V_83 ) ;
V_7 = F_41 ( V_60 , V_10 -> V_65 , V_85 , V_10 -> V_66 , V_84 ) ;
ASSERT ( V_7 ) ;
ASSERT ( ! F_25 ( V_7 ) ) ;
return V_7 ;
}
...
struct V_3 * V_4 ;
T_4 * V_7 ;
V_4 = F_37 ( V_2 , V_5 , & V_7 ) ;
F_14 ( V_2 , V_4 , V_5 , V_7 ) ;
if ( V_2 -> V_41 & V_42 )
return F_4 ( V_4 -> V_19 . V_20 . V_23 ) == V_22 ;
else
return F_2 ( V_4 -> V_19 . V_37 . V_23 ) == V_38 ;
}
STATIC int
F_45 (
T_3 * V_2 ,
...
ASSERT ( V_83 != V_86 ) ;
V_85 = F_40 ( V_10 , V_83 ) ;
if ( ( error = F_23 ( V_10 , V_60 , V_10 -> V_65 , V_85 ,
V_10 -> V_66 , V_84 , & V_7 ) ) ) {
return error ;
}
ASSERT ( ! V_7 || ! F_25 ( V_7 ) ) ;
...
ASSERT ( V_83 != V_86 ) ;
V_85 = F_40 ( V_10 , V_83 ) ;
F_51 ( V_10 -> V_65 , V_85 , V_10 -> V_66 * V_98 ) ;
}
void
F_52 (
T_5 * V_10 ,
...
{
int V_100 = 0 ;
T_2 V_101 = F_4 ( V_4 -> V_19 . V_20 . V_21 ) ;
T_2 V_102 = F_4 ( V_4 -> V_19 . V_20 . V_23 ) ;
if ( ( V_99 & V_103 ) && V_101 != V_22 ) {
F_50 ( V_2 -> V_11 , V_101 , 1 ) ;
V_100 ++ ;
}
if ( ( V_99 & V_104 ) && V_102 != V_22 ) {
F_50 ( V_2 -> V_11 , V_102 , 1 ) ;
V_100 ++ ;
}
return V_100 ;
}
...
F_52 ( V_2 -> V_11 , V_2 -> V_34 . V_35 . V_87 ,
V_101 , 1 ) ;
V_100 ++ ;
}
...
return 0 ;
V_2 -> V_64 [ V_105 ] |= V_99 ;
V_4 = F_38 ( V_2 -> V_52 [ V_105 ] ) ;
if ( V_2 -> V_41 & V_42 )
return F_53 ( V_2 , V_99 , V_4 ) ;
return F_54 ( V_2 , V_99 , V_4 ) ;
}
STATIC void
F_56 (
T_3 * V_2 ,
...
struct V_3 * V_55 ;
if ( V_2 -> V_52 [ V_105 ] )
F_20 ( V_2 -> V_53 , V_2 -> V_52 [ V_105 ] ) ;
V_2 -> V_52 [ V_105 ] = V_7 ;
V_2 -> V_64 [ V_105 ] = 0 ;
V_55 = F_38 ( V_7 ) ;
if ( V_2 -> V_41 & V_42 ) {
if ( F_4 ( V_55 -> V_19 . V_20 . V_21 ) == V_22 )
V_2 -> V_64 [ V_105 ] |= V_103 ;
if ( F_4 ( V_55 -> V_19 . V_20 . V_23 ) == V_22 )
V_2 -> V_64 [ V_105 ] |= V_104 ;
} else {
if ( F_2 ( V_55 -> V_19 . V_37 . V_21 ) == V_38 )
V_2 -> V_64 [ V_105 ] |= V_103 ;
if ( F_2 ( V_55 -> V_19 . V_37 . V_23 ) == V_38 )
V_2 -> V_64 [ V_105 ] |= V_104 ;
}
}
STATIC int
...
{
if ( V_2 -> V_41 & V_42 )
return F_4 ( V_48 -> V_20 ) == V_22 ;
else
return F_2 ( V_48 -> V_37 ) == V_38 ;
}
STATIC void
F_58 (
struct V_1 * V_2 ,
...
struct V_3 * V_59 )
{
V_59 -> V_12 = F_60 ( V_13 [ V_2 -> V_14 ] ) ;
V_59 -> V_15 = F_64 ( V_5 ) ;
V_59 -> V_16 = F_64 ( V_108 ) ;
if ( V_2 -> V_41 & V_42 ) {
V_59 -> V_19 . V_20 . V_21 = F_59 ( V_22 ) ;
V_59 -> V_19 . V_20 . V_23 = F_59 ( V_22 ) ;
} else {
V_59 -> V_19 . V_37 . V_21 = F_60 ( V_38 ) ;
V_59 -> V_19 . V_37 . V_23 = F_60 ( V_38 ) ;
}
}
STATIC int
F_65 (
...
{
if ( V_2 -> V_41 & V_42 )
V_48 -> V_20 = F_59 ( F_67 ( V_2 -> V_11 ,
F_24 ( V_7 ) ) ) ;
else {
V_48 -> V_37 = F_60 ( F_68 ( V_2 -> V_11 ,
F_24 ( V_7 ) ) ) ;
}
}
STATIC T_10
...
{
if ( V_2 -> V_41 & V_42 ) {
ASSERT ( F_4 ( V_48 -> V_20 ) != V_22 ) ;
return F_40 ( V_2 -> V_11 , F_4 ( V_48 -> V_20 ) ) ;
} else {
ASSERT ( V_2 -> V_34 . V_35 . V_87 != V_89 ) ;
ASSERT ( F_2 ( V_48 -> V_37 ) != V_38 ) ;
return F_43 ( V_2 -> V_11 , V_2 -> V_34 . V_35 . V_87 ,
F_2 ( V_48 -> V_37 ) ) ;
}
}
STATIC void
...
ASSERT ( ! ( V_117 & V_118 ) ) ;
V_85 = F_69 ( V_2 , V_48 ) ;
* V_81 = F_41 ( V_2 -> V_53 , V_10 -> V_65 , V_85 ,
V_10 -> V_66 , V_117 ) ;
ASSERT ( * V_81 ) ;
ASSERT ( ! F_25 ( * V_81 ) ) ;
* V_4 = F_38 ( * V_81 ) ;
...
ASSERT ( ! ( V_117 & V_118 ) ) ;
V_85 = F_69 ( V_2 , V_48 ) ;
error = F_23 ( V_10 , V_2 -> V_53 , V_10 -> V_65 , V_85 ,
...
{
ASSERT ( V_126 >= 0 ) ;
memcpy ( V_124 , V_125 , V_126 * F_27 ( V_2 ) ) ;
}
STATIC void
F_76 (
struct V_1 * V_2 ,
...
ASSERT ( V_126 >= 0 ) ;
ASSERT ( V_128 == 1 || V_128 == - 1 ) ;
V_124 = ( char * ) V_48 + ( V_128 * F_27 ( V_2 ) ) ;
memmove ( V_124 , V_48 , V_126 * F_27 ( V_2 ) ) ;
}
STATIC void
F_79 (
struct V_1 * V_2 ,
...
F_81 ( V_2 , V_7 , V_93 , V_94 ) ;
if ( V_7 ) {
struct V_3 * V_4 = F_38 ( V_7 ) ;
int V_5 = F_34 ( V_4 ) ;
F_82 ( V_2 -> V_53 , V_7 ,
F_30 ( V_2 , V_93 , V_5 ) ,
F_30 ( V_2 , V_94 + 1 , V_5 ) - 1 ) ;
} else {
F_83 ( V_2 -> V_53 , V_2 -> V_34 . V_55 . V_78 ,
F_84 ( V_2 -> V_34 . V_55 . V_79 ) ) ;
}
...
V_4 = F_37 ( V_2 , V_105 , & V_7 ) ;
#ifdef F_92
error = F_14 ( V_2 , V_4 , V_105 , V_7 ) ;
if ( error )
goto V_136;
#endif
if ( ++ V_2 -> V_63 [ V_105 ] <= F_93 ( V_4 ) )
break;
F_55 ( V_2 , V_105 , V_104 ) ;
}
if ( V_105 == V_2 -> V_51 ) {
if ( V_2 -> V_41 & V_82 )
goto V_138;
...
for ( V_4 = F_37 ( V_2 , V_105 , & V_7 ) ; V_105 > V_5 ; ) {
union V_47 * V_140 ;
V_140 = F_33 ( V_2 , V_2 -> V_63 [ V_105 ] , V_4 ) ;
...
V_7 = V_2 -> V_52 [ V_5 ] ;
if ( V_7 && F_24 ( V_7 ) == F_69 ( V_2 , V_143 ) ) {
* V_144 = F_38 ( V_7 ) ;
return 0 ;
}
...
if ( V_148 > 0 && -- V_145 < 1 )
V_145 = 1 ;
V_143 = F_33 ( V_2 , V_145 , V_4 ) ;
#ifdef F_92
error = F_18 ( V_2 , V_143 , 0 , V_5 ) ;
if ( error )
goto V_136;
#endif
V_2 -> V_63 [ V_5 ] = V_145 ;
...
V_4 = F_37 ( V_2 , 0 , & V_7 ) ;
#ifdef F_92
error = F_14 ( V_2 , V_4 , 0 , V_7 ) ;
if ( error )
goto V_136;
#endif
V_48 = V_2 -> V_63 [ 0 ] ;
V_159 = F_31 ( V_2 , V_48 , V_4 ) ;
...
V_5 == V_2 -> V_51 - 1 )
goto V_138;
V_102 = F_37 ( V_2 , V_5 , & V_164 ) ;
#ifdef F_92
error = F_14 ( V_2 , V_102 , V_5 , V_164 ) ;
if ( error )
goto V_136;
#endif
...
union V_75 * V_172 ;
union V_47 * V_173 ;
V_172 = F_32 ( V_2 , V_163 , V_101 ) ;
V_167 = F_32 ( V_2 , 1 , V_102 ) ;
V_173 = F_33 ( V_2 , V_163 , V_101 ) ;
V_168 = F_33 ( V_2 , 1 , V_102 ) ;
#ifdef F_92
error = F_18 ( V_2 , V_168 , 0 , V_5 ) ;
if ( error )
goto V_136;
#endif
...
F_32 ( V_2 , V_163 - 1 , V_101 ) , V_172 ) ) ;
} else {
union V_74 * V_175 ;
V_175 = F_31 ( V_2 , V_163 , V_101 ) ;
V_169 = F_31 ( V_2 , 1 , V_102 ) ;
F_74 ( V_2 , V_175 , V_169 , 1 ) ;
F_85 ( V_2 , V_162 , V_163 , V_163 ) ;
ASSERT ( V_2 -> V_17 -> V_176 ( V_2 ,
F_31 ( V_2 , V_163 - 1 , V_101 ) , V_175 ) ) ;
}
F_105 ( V_101 , V_163 ) ;
...
error = F_18 ( V_2 , V_168 , V_50 + 1 , V_5 ) ;
if ( error )
goto V_136;
}
#endif
...
( V_5 == V_2 -> V_51 - 1 ) )
goto V_138;
V_101 = F_37 ( V_2 , V_5 , & V_162 ) ;
#ifdef F_92
error = F_14 ( V_2 , V_101 , V_5 , V_162 ) ;
if ( error )
goto V_136;
#endif
...
union V_75 * V_167 ;
union V_47 * V_168 ;
V_172 = F_32 ( V_2 , V_188 , V_101 ) ;
V_173 = F_33 ( V_2 , V_188 , V_101 ) ;
V_167 = F_32 ( V_2 , 1 , V_102 ) ;
V_168 = F_33 ( V_2 , 1 , V_102 ) ;
#ifdef F_92
for ( V_50 = V_188 ; V_50 < V_165 ; V_50 ++ ) {
error = F_18 ( V_2 , V_173 , V_50 , V_5 ) ;
if ( error )
goto V_136;
}
#endif
...
if ( error )
goto V_136;
memcpy ( V_195 , V_4 , F_26 ( V_2 ) ) ;
F_111 ( & V_4 -> V_15 , 1 ) ;
F_105 ( V_4 , 1 ) ;
V_2 -> V_51 ++ ;
V_2 -> V_63 [ V_5 + 1 ] = 1 ;
V_146 = F_32 ( V_2 , 1 , V_4 ) ;
V_196 = F_32 ( V_2 , 1 , V_195 ) ;
F_73 ( V_2 , V_196 , V_146 , F_93 ( V_195 ) ) ;
V_197 = F_33 ( V_2 , 1 , V_195 ) ;
#ifdef F_92
for ( V_50 = 0 ; V_50 < F_3 ( V_195 -> V_16 ) ; V_50 ++ ) {
error = F_18 ( V_2 , V_143 , V_50 , V_5 ) ;
if ( error )
goto V_136;
}
#endif
...
V_4 = F_37 ( V_2 , V_2 -> V_51 - 1 , & V_7 ) ;
#ifdef F_92
error = F_14 ( V_2 , V_4 , V_2 -> V_51 - 1 , V_7 ) ;
if ( error )
goto V_136;
#endif
...
F_79 ( V_2 , V_201 , 1 , 2 ) ;
F_75 ( V_2 ,
F_33 ( V_2 , 1 , V_59 ) , & V_166 , 1 ) ;
F_75 ( V_2 ,
F_33 ( V_2 , 2 , V_59 ) , & V_179 , 1 ) ;
F_86 ( V_2 , V_201 , 1 , 2 ) ;
F_56 ( V_2 , V_2 -> V_51 , V_201 ) ;
...
struct V_205 * V_78 = V_2 -> V_34 . V_55 . V_78 ;
struct V_76 * V_77 = F_36 ( V_78 , V_79 ) ;
struct V_3 * V_4 ;
struct V_3 * V_195 ;
union V_75 * V_146 ;
union V_75 * V_196 ;
...
int error ;
error = F_18 ( V_2 , V_197 , V_50 , V_5 - 1 ) ;
if ( error ) {
F_80 ( V_2 , V_141 ) ;
return error ;
}
...
union V_75 * V_172 ;
union V_47 * V_173 ;
V_172 = F_32 ( V_2 , V_48 + 1 , V_4 ) ;
V_173 = F_33 ( V_2 , V_48 + 1 , V_4 ) ;
#ifdef F_92
...
V_50 = F_46 ( V_178 , V_5 ) ;
F_107 ( V_50 == 1 , V_136 ) ;
V_102 = F_37 ( V_178 , V_5 , & V_164 ) ;
#ifdef F_92
error = F_14 ( V_178 , V_102 , V_5 , V_164 ) ;
if ( error )
goto V_136;
#endif
...
union V_75 * V_167 ;
union V_47 * V_168 ;
V_172 = F_32 ( V_2 , V_163 + 1 , V_101 ) ;
V_173 = F_33 ( V_2 , V_163 + 1 , V_101 ) ;
V_167 = F_32 ( V_2 , 1 , V_102 ) ;
V_168 = F_33 ( V_2 , 1 , V_102 ) ;
#ifdef F_92
