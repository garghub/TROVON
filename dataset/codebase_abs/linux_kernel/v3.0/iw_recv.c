...
F_5 ( V_71 & 7 ) ;
V_29 = F_74 ( V_2 -> V_3 , V_123 ) ;
V_119 = V_29 + V_72 ;
V_120 = ( void * ) V_113 -> V_124 [ V_115 ] + V_114 ;
...
struct V_7 * V_8 , T_1 V_125 ,
struct V_126 * V_127 )
{
struct V_5 * V_6 = V_37 -> V_40 ;
struct V_65 * V_66 = V_6 -> V_128 ;
struct V_33 * V_129 , * V_99 ;
F_2 ( L_14 , V_6 , V_66 , V_8 ,
V_125 ) ;
if ( V_125 < sizeof( struct V_33 ) ) {
F_32 ( V_37 , L_15
L_16
L_17
L_7 ,
...
V_125 -= sizeof( struct V_33 ) ;
V_129 = & V_6 -> V_130 [ V_8 - V_6 -> V_16 ] ;
if ( ! F_79 ( V_129 ) ) {
F_32 ( V_37 , L_15
L_18
L_19 ,
...
V_127 -> V_132 = F_81 ( V_129 -> V_101 ) ;
V_127 -> V_133 = 1 ;
if ( V_129 -> V_102 )
F_82 ( V_37 , V_129 -> V_102 ) ;
if ( V_129 -> V_134 == 0 && V_129 -> V_135 == 0 && V_125 == 0 ) {
F_17 ( V_136 ) ;
F_1 ( V_8 -> V_9 ) ;
return;
}
...
V_6 -> V_128 = V_66 ;
V_99 = & V_66 -> V_34 . V_76 ;
memcpy ( V_99 , V_129 , sizeof( * V_99 ) ) ;
V_6 -> V_137 = F_44 ( V_99 -> V_77 ) ;
F_2 ( L_20 , V_6 , V_66 ,
V_6 -> V_137 , V_99 -> V_138 ) ;
} else {
V_99 = & V_66 -> V_34 . V_76 ;
if ( V_99 -> V_139 != V_129 -> V_139 ||
V_99 -> V_77 != V_129 -> V_77 ||
V_99 -> V_134 != V_129 -> V_134 ||
V_99 -> V_135 != V_129 -> V_135 ) {
F_32 ( V_37 ,
L_21 ) ;
return;
}
...
V_6 -> V_137 = 0 ;
V_6 -> V_128 = NULL ;
if ( V_66 -> V_34 . V_76 . V_138 == V_140 )
F_73 ( V_37 , V_66 ) ;
else {
F_84 ( V_37 , V_37 -> V_50 , V_37 -> V_141 ,
& V_66 -> V_34 , V_142 ,
V_123 ) ;
V_127 -> V_143 = F_81 ( V_99 -> V_139 ) ;
V_127 -> V_144 = 1 ;
}
if ( V_99 -> V_138 & V_145 ) {
F_80 ( V_146 ) ;
...
void F_85 ( struct V_147 * V_148 , void * V_149 )
{
struct V_36 * V_37 = V_149 ;
struct V_5 * V_6 = V_37 -> V_40 ;
F_2 ( L_22 , V_37 , V_148 ) ;
F_17 ( V_150 ) ;
F_86 ( & V_6 -> V_151 ) ;
...
struct V_152 V_153 ;
struct V_7 * V_8 ;
while ( F_88 ( V_6 -> V_154 , 1 , & V_153 ) > 0 ) {
F_2 ( L_23 ,
( unsigned long long ) V_153 . V_24 , V_153 . V_155 , V_153 . V_125 ,
F_44 ( V_153 . V_156 . V_157 ) ) ;
F_17 ( V_158 ) ;
V_8 = & V_6 -> V_16 [ F_89 ( & V_6 -> V_17 ) ] ;
F_7 ( V_6 , V_8 ) ;
if ( F_28 ( V_37 ) || F_90 ( V_37 ) ) {
if ( V_153 . V_155 == V_159 ) {
F_78 ( V_37 , V_8 , V_153 . V_125 , V_127 ) ;
} else {
F_32 ( V_37 , L_24
L_25
L_7 , & V_37 -> V_50 ,
...
void F_92 ( unsigned long V_160 )
{
struct V_5 * V_6 = (struct V_5 * ) V_160 ;
struct V_36 * V_37 = V_6 -> V_37 ;
struct V_126 V_127 = { 0 , } ;
F_87 ( V_6 , & V_127 ) ;
F_93 ( V_6 -> V_154 , V_161 ) ;
F_87 ( V_6 , & V_127 ) ;
if ( V_127 . V_144 )
F_50 ( V_6 , V_127 . V_143 , V_127 . V_92 ) ;
if ( V_127 . V_133 && V_127 . V_132 > V_6 -> V_162 ) {
F_94 ( V_37 , V_127 . V_132 , NULL ) ;
V_6 -> V_162 = V_127 . V_132 ;
}
if ( F_28 ( V_37 ) )
F_66 ( V_6 ) ;
if ( F_95 ( & V_6 -> V_17 ) )
