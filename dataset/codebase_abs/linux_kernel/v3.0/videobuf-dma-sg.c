...
if ( F_6 ( V_10 [ 0 ] ) )
goto V_13;
F_7 ( & V_4 [ 0 ] , V_10 [ 0 ] , V_8 - V_11 , V_11 ) ;
V_12 -= V_8 - V_11 ;
...
V_55 -> V_57 -- ;
if ( 0 == V_55 -> V_57 ) {
F_12 ( 1 , L_13 , V_55 , V_61 ) ;
F_38 ( V_61 ) ;
for ( V_7 = 0 ; V_7 < V_62 ; V_7 ++ ) {
if ( NULL == V_61 -> V_63 [ V_7 ] )
continue;
V_19 = V_61 -> V_63 [ V_7 ] -> V_20 ;
if ( ! V_19 )
continue;
F_14 ( V_19 -> V_21 , V_22 ) ;
if ( V_61 -> V_63 [ V_7 ] -> V_55 != V_55 )
continue;
V_61 -> V_63 [ V_7 ] -> V_55 = NULL ;
V_61 -> V_63 [ V_7 ] -> V_64 = 0 ;
V_61 -> V_65 -> V_66 ( V_61 , V_61 -> V_63 [ V_7 ] ) ;
}
F_39 ( V_61 ) ;
F_35 ( V_55 ) ;
}
...
if ( V_17 == V_61 -> V_63 [ V_27 ] ) {
V_12 = F_47 ( V_61 -> V_63 [ V_27 ] -> V_80 ) ;
break;
}
}
if ( ! V_12 ) {
...
if ( NULL == V_61 -> V_63 [ V_7 ] )
continue;
V_61 -> V_63 [ V_7 ] -> V_55 = V_55 ;
V_61 -> V_63 [ V_7 ] -> V_64 = V_53 -> V_58 + V_12 ;
V_12 += F_47 ( V_61 -> V_63 [ V_7 ] -> V_80 ) ;
}
V_55 -> V_57 = 1 ;
V_55 -> V_61 = V_61 ;
V_53 -> V_87 = & V_88 ;
...
V_53 -> V_56 = V_55 ;
F_12 ( 1 , L_17 ,
V_55 , V_61 , V_53 -> V_58 , V_53 -> V_59 , V_53 -> V_85 , V_27 , V_28 ) ;
V_84 = 0 ;
V_86:
return V_84 ;
}
...
struct V_101 * V_102 )
{
F_54 ( V_61 , V_65 , V_47 , V_97 , type , V_100 , V_95 ,
V_20 , & V_94 , V_102 ) ;
}
