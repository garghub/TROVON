...
if ( ( V_13 -> V_39 = F_17 ( V_56 , & V_57 , & V_13 -> V_52 -> V_58 ) ) != NULL ) {
V_55 -> V_59 = 0 ;
return 0 ;
}
if ( ( V_13 -> V_39 = F_17 ( V_60 , & V_61 , & V_13 -> V_52 -> V_58 ) ) != NULL ) {
V_55 -> V_59 = 1 ;
return 0 ;
}
return - V_62 ;
...
{
struct V_54 * V_55 = V_13 -> V_52 -> V_46 ;
if ( ! F_17 ( V_63 , V_13 -> V_39 , 0x60 , NULL , V_64 ) )
return - V_65 ;
if ( V_55 -> V_59 )
V_13 -> V_39 -> V_48 . V_49 . V_66 = F_15 ;
return 0 ;
}
...
F_1 ( V_2 , V_72 , 0 , V_47 , 4 , NULL , 0 ) ;
if ( V_69 [ 1 ] != 0 )
{
for ( V_17 = 0 ; V_17 < V_2 -> V_31 . V_73 . V_74 . V_75 ; V_17 ++ ) {
if ( F_20 ( & V_2 -> V_31 . V_73 . V_74 . V_76 [ V_17 ] ) == V_69 [ 1 ] &&
F_21 ( & V_2 -> V_31 . V_73 . V_74 . V_76 [ V_17 ] ) == V_69 [ 2 ] ) {
* V_67 = V_2 -> V_31 . V_73 . V_74 . V_76 [ V_17 ] . V_77 ;
* V_68 = V_78 ;
return 0 ;
}
}
...
if ( V_69 [ 0 ] != 0 )
F_22 ( L_2 , V_69 [ 0 ] , V_69 [ 1 ] , V_69 [ 2 ] , V_69 [ 3 ] , V_69 [ 4 ] ) ;
return 0 ;
}
...
{
struct V_1 * V_2 ;
int V_83 = F_24 ( V_80 , & V_84 , V_85 , & V_2 ,
V_86 ) ;
if ( V_83 == 0 ) {
T_1 V_47 [ 4 ] = { 0 } ;
if ( V_2 != NULL ) {
V_47 [ 0 ] = 1 ;
F_1 ( V_2 , V_87 , 0 , V_47 , 4 , NULL , 0 ) ;
V_47 [ 0 ] = 0 ;
F_1 ( V_2 , V_72 , 0 , V_47 , 4 , NULL , 0 ) ;
}
}
