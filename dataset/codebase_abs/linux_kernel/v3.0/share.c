...
memset ( V_36 , 0 , sizeof( struct V_1 ) ) ;
V_36 -> V_30 = V_30 ;
V_36 -> V_31 = V_31 ;
V_36 -> V_32 = V_32 ;
...
struct V_1 * V_2 = F_38 ( V_9 , struct V_1 , V_21 ) ;
if ( V_2 -> V_63 != V_37 )
break;
}
...
struct V_5 *
F_49 ( struct V_1 * V_11 , const char * V_28 ,
int (* F_50)( void * ) , void (* F_51)( void * ) ,
void (* F_52)( void * ) ,
int V_47 , void * V_75 )
{
struct V_5 * V_36 ;
...
if ( ! F_53 ( V_11 -> V_34 -> V_80 ) ) {
return NULL ;
}
F_26 ( V_11 ) ;
V_36 = F_31 ( sizeof( struct V_5 ) , V_39 ) ;
if ( V_36 == NULL ) {
F_32 ( V_40 L_8 , V_11 -> V_28 , V_28 ) ;
goto V_81;
}
V_36 -> V_82 = F_31 ( sizeof( struct V_7 ) , V_39 ) ;
if ( V_36 -> V_82 == NULL ) {
F_32 ( V_40 L_8 , V_11 -> V_28 , V_28 ) ;
goto V_83;
}
...
struct V_1 * F_65 ( unsigned long V_30 )
{
struct V_1 * V_11 , * V_102 = NULL ;
if ( F_15 ( & V_16 ) )
F_12 () ;
