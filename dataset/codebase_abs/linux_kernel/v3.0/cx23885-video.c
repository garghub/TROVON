...
struct V_196 * V_169 )
{
if ( F_89 ( V_169 -> V_197 >= F_2 ( V_4 ) ) )
return - V_47 ;
F_86 ( V_169 -> V_198 , V_4 [ V_169 -> V_197 ] . V_39 ,
sizeof( V_169 -> V_198 ) ) ;
V_169 -> V_171 = V_4 [ V_169 -> V_197 ] . V_2 ;
return 0 ;
}
...
static int F_101 ( struct V_127 * V_127 , void * V_167 , T_2 * V_203 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_167 ) -> V_8 ;
F_8 ( 1 , L_5 , V_6 ) ;
F_21 ( & V_8 -> V_56 ) ;
...
static int F_102 ( struct V_7 * V_8 , struct V_204 * V_3 )
{
...
if ( V_215 >= 4 )
return - V_47 ;
if ( 0 == F_28 ( V_215 ) -> type )
return - V_47 ;
V_3 -> V_197 = V_215 ;
V_3 -> type = V_216 ;
strcpy ( V_3 -> V_39 , V_205 [ F_28 ( V_215 ) -> type ] ) ;
if ( ( V_66 == F_28 ( V_215 ) -> type ) ||
( V_212 == F_28 ( V_215 ) -> type ) ) {
V_3 -> type = V_217 ;
V_3 -> V_218 = V_219 ;
}
return 0 ;
...
struct V_42 * V_43 )
{
V_43 -> V_44 = F_108 ( V_222 , V_43 -> V_44 ) ;
if ( F_89 ( V_43 -> V_44 == 0 ) )
return - V_47 ;
return F_19 ( V_43 ) ;
}
...
{
struct V_7 * V_8 = ( (struct V_52 * ) V_167 ) -> V_8 ;
if ( F_89 ( V_108 == V_8 -> V_194 ) )
return - V_47 ;
if ( 0 != V_224 -> V_197 )
return - V_47 ;
strcpy ( V_224 -> V_39 , L_34 ) ;
V_224 -> type = V_225 ;
V_224 -> V_226 = V_227 ;
V_224 -> V_228 = 0xffffffffUL ;
V_224 -> signal = 0xffff ;
return 0 ;
}
...
if ( F_89 ( V_108 == V_8 -> V_194 ) )
return - V_47 ;
V_169 -> type = V_53 -> V_130 ? V_230 : V_225 ;
V_169 -> V_231 = V_8 -> V_232 ;
F_15 ( V_8 , V_233 , V_234 , V_169 ) ;
return 0 ;
}
static int F_114 ( struct V_7 * V_8 , struct V_229 * V_169 )
{
if ( F_89 ( V_108 == V_8 -> V_194 ) )
return - V_47 ;
if ( F_89 ( V_169 -> V_233 != 0 ) )
return - V_47 ;
F_21 ( & V_8 -> V_56 ) ;
V_8 -> V_232 = V_169 -> V_231 ;
F_15 ( V_8 , V_233 , V_235 , V_169 ) ;
F_115 ( 10 ) ;
F_22 ( & V_8 -> V_56 ) ;
return 0 ;
}
...
struct V_52 * V_53 = V_167 ;
struct V_7 * V_8 = V_53 -> V_8 ;
if ( F_89 ( 0 == V_53 -> V_130 && V_169 -> type != V_225 ) )
return - V_47 ;
if ( F_89 ( 1 == V_53 -> V_130 && V_169 -> type != V_230 ) )
return - V_47 ;
return
F_114 ( V_8 , V_169 ) ;
}
...
F_37 ( V_8 , V_10 ) ;
F_121 ( & V_8 -> V_141 , V_236 ) ;
}
int F_122 ( struct V_7 * V_8 , T_1 V_237 )
{
T_1 V_238 , V_11 ;
int V_239 = 0 ;
V_238 = F_123 ( V_81 ) ;
...
memcpy ( & V_244 , & V_245 ,
sizeof( V_244 ) ) ;
strcpy ( V_244 . V_39 , L_47 ) ;
V_8 -> V_28 = V_245 . V_246 ;
F_133 ( & V_8 -> V_116 . V_15 ) ;
F_133 ( & V_8 -> V_116 . V_87 ) ;
V_8 -> V_116 . V_24 . V_247 = F_117 ;
...
F_35 ( V_8 , 0x01 ) ;
if ( ( V_248 != V_8 -> V_194 ) &&
( ( V_8 -> V_249 == 0 ) || ( V_8 -> V_249 == 1 ) ) ) {
struct V_250 * V_251 = NULL ;
if ( V_8 -> V_252 )
V_251 = F_136 ( & V_8 -> V_36 ,
& V_8 -> V_253 [ V_8 -> V_249 ] . V_254 ,
L_48 , V_8 -> V_252 , NULL ) ;
else
V_251 = F_136 ( & V_8 -> V_36 ,
& V_8 -> V_253 [ V_8 -> V_249 ] . V_254 ,
...
V_257 . V_258 = V_259 ;
V_257 . type = V_8 -> V_194 ;
V_257 . V_260 = F_138 ( V_251 ) ;
V_257 . V_261 = V_262 ;
F_30 ( V_251 , V_233 , V_263 , & V_257 ) ;
if ( V_8 -> V_41 == V_264 ) {
struct V_265 V_164 = {
. V_266 = V_267 ,
. V_268 = 64
...
F_30 ( V_251 , V_233 , V_271 , & V_270 ) ;
}
}
}
V_8 -> V_243 = F_16 ( V_8 , V_8 -> V_33 ,
& V_245 , L_49 ) ;
V_179 = F_139 ( V_8 -> V_243 , V_132 ,
V_272 [ V_8 -> V_273 ] ) ;
if ( V_179 < 0 ) {
F_3 ( V_220 L_50 ,
V_8 -> V_39 ) ;
