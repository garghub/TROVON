...
struct V_1 * V_2 = V_4 -> V_2 ;
F_17 ( ! V_2 -> V_38 ) ;
memcpy ( & V_4 -> V_14 , & V_58 , sizeof( V_4 -> V_14 ) ) ;
memcpy ( & V_4 -> V_59 , & V_60 , sizeof( V_4 -> V_59 ) ) ;
memcpy ( & V_4 -> V_54 , & V_61 ,
sizeof( V_4 -> V_54 ) ) ;
V_4 -> V_14 . V_2 . V_62 = & V_2 -> V_63 -> V_2 ;
F_18 ( V_4 -> V_14 . V_56 , V_4 -> V_2 -> V_56 , sizeof( V_4 -> V_14 . V_56 ) ) ;
V_4 -> V_59 . V_64 = V_4 ;
V_4 -> V_14 . V_15 = V_4 ;
F_19 ( & V_4 -> V_14 , & V_2 -> V_65 ) ;
F_20 ( & V_4 -> V_14 ) ;
V_4 -> V_54 . V_66 = & V_4 -> V_14 ;
if ( 0 == V_4 -> V_67 ) {
if ( V_68 )
F_13 ( V_2 , & V_4 -> V_54 ) ;
} else
