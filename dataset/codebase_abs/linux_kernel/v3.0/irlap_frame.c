...
void F_34 ( struct V_1 * V_2 , int V_60 )
{
struct V_3 * V_30 ;
struct V_85 * V_32 ;
...
F_8 ( 4 , L_15 , V_26 ) ;
F_47 ( V_2 , F_43 ( V_4 ) , V_2 -> V_36 , V_37 ) ;
V_2 -> V_106 -= 1 ;
}
}
void F_48 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_3 * V_30 ;
int V_107 ;
F_49 ( & V_2 -> V_108 ) ;
...
if ( V_2 -> V_105 ) {
F_47 ( V_2 , F_43 ( V_4 ) , V_2 -> V_36 , V_114 ) ;
F_34 ( V_2 , V_114 ) ;
V_2 -> V_105 = FALSE ;
} else {
V_4 -> V_47 [ 1 ] |= V_41 ;
...
void F_56 ( struct V_1 * V_2 , int V_60 )
{
struct V_3 * V_30 ;
struct V_3 * V_4 ;
F_12 (self != NULL, return;) ;
F_12 (self->magic == LAP_MAGIC, return;) ;
F_57 (&self->wx_list, skb) {
F_58 ( V_2 , & V_2 -> V_116 ) ;
V_30 = F_59 ( V_4 , V_35 ) ;
if ( ! V_30 ) {
F_8 ( 0 , L_17 , V_26 ) ;
...
void F_61 ( struct V_1 * V_2 , int V_60 )
{
struct V_3 * V_30 ;
struct V_3 * V_4 ;
F_12 (self != NULL, return;) ;
...
void F_66 ( struct V_1 * V_2 , T_1 V_36 , T_3 V_43 ,
struct V_3 * V_127 )
{
struct V_3 * V_30 ;
struct V_128 * V_32 ;
...
int F_68 ( struct V_3 * V_4 , struct V_134 * V_18 ,
...
T_1 V_39 ;
int V_33 = - 1 ;
if ( ! F_69 ( F_70 ( V_18 ) , & V_138 ) )
goto V_139;
V_2 = (struct V_1 * ) V_18 -> V_140 ;
if ( ! V_2 || V_2 -> V_7 != V_8 )
goto V_141;
if ( ( V_4 = F_71 ( V_4 , V_35 ) ) == NULL ) {
F_28 ( L_28 , V_26 ) ;
goto V_141;
}
if ( ! F_18 ( V_4 , 2 ) ) {
...
break;
case V_57 :
F_40 ( V_2 , V_4 , & V_46 , V_60 ) ;
break;
case V_146 :
F_67 ( V_2 , V_4 , & V_46 , V_60 ) ;
break;
case V_51 :
F_41 ( V_2 , V_4 , & V_46 ) ;
break;
