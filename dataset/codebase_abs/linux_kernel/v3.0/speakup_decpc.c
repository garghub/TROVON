...
static const char * F_25 ( struct V_14 * V_15 , const char * V_48 )
{
T_2 V_21 ;
while ( ( V_21 = * V_48 ) ) {
if ( V_21 == '\n' )
...
int V_49 = 0 , V_50 = 0 ;
F_27 ( L_3 , V_15 -> V_51 ) ;
for ( V_49 = 0 ; V_52 [ V_49 ] ; V_49 ++ ) {
if ( F_28 ( V_52 [ V_49 ] , V_27 ) ) {
F_12 ( L_4 ,
V_52 [ V_49 ] , V_27 ) ;
continue;
}
