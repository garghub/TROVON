...
int V_64 , V_160 = 1000 , V_299 = 1 ;
struct V_300 V_301 , V_302 ;
if ( V_2 -> V_217 -> clock != 48000 )
return;
V_303:
V_295 = V_2 -> V_129 [ 0 ] -> V_304 [ 0 ] . V_82 ;
if ( ! V_295 || V_295 -> V_305 . V_286 < V_306 ) {
F_18 ( V_33 L_18 ) ;
return;
}
V_46 = & V_2 -> V_90 [ V_132 ] ;
V_46 -> V_59 = V_295 -> V_305 . V_6 ;
V_46 -> V_53 = V_46 -> V_54 = V_306 ;
V_46 -> V_82 = NULL ;
if ( F_50 ( V_2 -> V_20 [ 0 ] , V_307 , 48000 ) < 0 ) {
...
do {
V_64 = F_1 ( V_2 , V_46 -> V_50 + V_65 ) ;
V_297 = F_3 ( V_2 , V_46 -> V_50 + V_46 -> V_161 ) ;
if ( V_297 == 0 ) {
F_17 ( 10 ) ;
continue;
}
...
V_296 /= 4 ;
V_298 = V_302 . V_310 - V_301 . V_310 ;
V_298 *= 1000000 ;
V_298 += ( V_302 . V_311 - V_301 . V_311 ) / 1000 ;
F_111 ( V_312 L_21 , V_313 , V_298 , V_296 ) ;
if ( V_298 == 0 ) {
F_18 ( V_17 L_22 ) ;
goto V_308;
}
V_296 *= 1000 ;
V_296 = ( V_296 / V_298 ) * 1000 + ( ( V_296 % V_298 ) * 1000 ) / V_298 ;
if ( V_296 < 40000 || V_296 >= 60000 ) {
F_111 ( V_312 L_23 , V_296 ) ;
goto V_308;
} else if ( V_296 > 40500 && V_296 < 41500 )
V_2 -> V_217 -> clock = 41000 ;
else if ( V_296 > 43600 && V_296 < 44600 )
V_2 -> V_217 -> clock = 44100 ;
else if ( V_296 < 47500 || V_296 > 48500 )
V_2 -> V_217 -> clock = ( V_2 -> V_217 -> clock * 48000 ) / V_296 ;
V_309:
F_111 ( V_312 L_24 , V_2 -> V_217 -> clock ) ;
F_136 ( V_2 -> V_20 [ 0 ] , V_307 , 0 ) ;
}
static int T_4 F_137 ( struct V_1 * V_2 )
{
struct V_287 * V_204 = V_2 -> V_204 ;
const struct V_314 * V_315 ;
V_315 = F_101 ( V_204 , V_316 ) ;
if ( ! V_315 )
return 0 ;
F_111 ( V_312 L_25 ,
V_204 -> V_317 , V_204 -> V_318 , V_315 -> V_319 ) ;
V_2 -> V_217 -> clock = V_315 -> V_319 ;
return 1 ;
}
static void F_138 ( struct V_320 * V_321 ,
struct V_322 * V_323 )
{
struct V_1 * V_2 = V_321 -> V_22 ;
unsigned int V_26 ;
F_139 ( V_323 , L_26 ) ;
if ( V_2 -> V_137 == V_138 )
return;
V_26 = F_5 ( V_2 , F_16 ( V_13 ) ) ;
F_139 ( V_323 , L_27 , F_5 ( V_2 , F_16 ( V_145 ) ) ) ;
F_139 ( V_323 , L_28 , V_26 ) ;
if ( V_2 -> V_137 == V_155 )
F_139 ( V_323 , L_29 , F_5 ( V_2 , F_16 ( V_237 ) ) ) ;
F_139 ( V_323 , L_30 ) ;
if ( V_26 & V_2 -> V_10 ) {
int V_78 ;
...
{
struct V_320 * V_321 ;
if ( ! F_141 ( V_2 -> V_197 , L_38 , & V_321 ) )
F_142 ( V_321 , V_2 , F_138 ) ;
}
static int F_143 ( struct V_324 * V_191 )
{
struct V_1 * V_2 = V_191 -> V_325 ;
return F_112 ( V_2 ) ;
}
...
static struct V_330 V_335 [ 4 ] = {
{ V_279 , 0 } ,
{ V_278 , 0x10 } ,
{ V_277 , 0x20 } ,
{ V_280 , 0x70 } ,
} ;
static struct V_330 V_336 [ 6 ] = {
{ V_337 , 0x40 } ,
{ V_338 , 0x50 } ,
{ V_339 , 0x60 } ,
{ V_340 , 0x70 } ,
...
V_2 -> V_236 = 3 ;
V_2 -> V_11 = V_354 ;
V_2 -> V_28 = V_355 | V_356 | V_357 ;
break;
case V_144 :
V_2 -> V_236 = 3 ;
V_2 -> V_11 = V_358 ;
V_2 -> V_28 = V_355 | V_356 | V_359 ;
break;
default:
V_2 -> V_236 = 2 ;
V_2 -> V_11 = V_354 ;
V_2 -> V_28 = V_355 | V_356 ;
break;
}
for ( V_78 = 0 ; V_78 < V_2 -> V_236 ; V_78 ++ )
...
V_2 -> V_83 = V_204 -> V_83 ;
if ( ( V_123 = F_151 ( V_197 , V_360 , V_2 , & V_225 ) ) < 0 ) {
F_112 ( V_2 ) ;
return V_123 ;
}
F_152 ( V_197 , & V_204 -> V_361 ) ;
* V_326 = V_2 ;
return 0 ;
}
static int T_4 F_153 ( struct V_287 * V_204 )
{
const struct V_314 * V_362 ;
V_362 = F_101 ( V_204 , V_363 ) ;
if ( V_362 ) {
if ( V_362 -> V_319 )
F_154 ( V_312 L_43
L_44 , V_362 -> V_195 ) ;
...
int V_123 ;
struct V_366 * V_195 ;
V_123 = F_156 ( V_367 , V_368 , V_369 , 0 , & V_197 ) ;
if ( V_123 < 0 )
return V_123 ;
if ( V_210 < 0 )
V_210 = F_153 ( V_204 ) ;
strcpy ( V_197 -> V_370 , L_47 ) ;
if ( ! V_210 ) {
switch ( V_365 -> V_371 ) {
case V_154 :
strcpy ( V_197 -> V_370 , L_48 ) ;
break;
case V_155 :
strcpy ( V_197 -> V_370 , L_49 ) ;
}
}
strcpy ( V_197 -> V_202 , L_8 ) ;
for ( V_195 = V_372 ; V_195 -> V_368 ; V_195 ++ ) {
if ( V_204 -> V_191 == V_195 -> V_368 ) {
strcpy ( V_197 -> V_202 , V_195 -> V_373 ) ;
break;
}
}
if ( V_88 < 0 ) {
if ( V_365 -> V_371 == V_154 )
V_88 = 1 ;
else
V_88 = 0 ;
}
if ( ( V_123 = F_144 ( V_197 , V_204 , V_365 -> V_371 ,
& V_2 ) ) < 0 ) {
F_157 ( V_197 ) ;
return V_123 ;
}
V_197 -> V_22 = V_2 ;
if ( ( V_123 = F_93 ( V_2 , V_218 , V_374 ) ) < 0 ) {
F_157 ( V_197 ) ;
return V_123 ;
}
if ( ( V_123 = F_89 ( V_2 ) ) < 0 ) {
...
F_140 ( V_2 ) ;
snprintf ( V_197 -> V_375 , sizeof( V_197 -> V_375 ) ,
L_50 , V_197 -> V_202 ,
