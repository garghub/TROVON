...
unsigned long V_34 ;
#endif
F_2 ( V_51 L_10 , V_48 , V_49 & 0xffff , ++ V_52 ) ;
#ifdef F_39
F_2 ( L_11 ) ;
#endif
#ifdef F_40
...
static int T_2 F_50 ( char * V_61 )
{
if ( ! V_61 )
return - V_62 ;
V_63 = F_51 ( V_61 , NULL , 0 ) ;
return 0 ;
}
static int T_2 F_52 ( char * V_61 )
{
V_64 = F_51 ( V_61 , NULL , 0 ) ;
if ( V_64 > 8192 )
V_64 = 8192 ;
return 1 ;
}
