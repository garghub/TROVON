...
V_71:
error = F_14 ( V_69 , 8 , V_77 . V_78 ) ;
if ( error )
return - V_67 ;
if ( ! F_15 ( V_69 , 8 , V_77 . V_78 ) ) {
F_7 ( & V_64 -> V_4 , L_24 ,
V_69 ) ;
return - V_67 ;
}
F_16 ( V_64 , V_76 , & V_16 ) ;
if ( V_68 ) {
F_17 ( V_64 , V_76 , V_16 & 0xfe ) ;
F_18 ( V_64 , V_66 -> V_72 , V_69 ) ;
F_17 ( V_64 , V_76 , V_16 | 0x01 ) ;
F_10 ( & V_64 -> V_4 , L_25
L_26 , V_69 ) ;
} else if ( ! ( V_16 & 0x01 ) ) {
if ( V_70 ) {
