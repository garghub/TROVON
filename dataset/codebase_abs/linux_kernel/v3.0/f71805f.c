...
struct V_43 * V_44 = F_44 ( V_41 ) ;
int V_15 = V_44 -> V_45 ;
unsigned long V_3 = F_65 ( V_42 , NULL , 10 ) ;
if ( V_3 > 255 )
return - V_51 ;
F_25 ( & V_9 -> V_17 ) ;
V_9 -> V_38 [ V_15 ] = V_3 ;
...
{
struct V_8 * V_9 = F_24 ( V_14 ) ;
struct V_57 * V_44 = F_71 ( V_41 ) ;
int V_58 = V_44 -> V_15 ;
int V_16 = V_44 -> V_45 ;
return sprintf ( V_42 , L_1 ,
F_17 ( V_9 -> V_32 [ V_58 ] . V_33 [ V_16 ] ) ) ;
}
...
int V_58 = V_44 -> V_15 ;
int V_16 = V_44 -> V_45 ;
unsigned long V_3 = F_48 ( V_42 , NULL , 10 ) ;
F_25 ( & V_9 -> V_17 ) ;
V_9 -> V_32 [ V_58 ] . V_33 [ V_16 ] = F_18 ( V_3 ) ;
F_20 ( V_9 , F_34 ( V_58 , V_16 ) ,
V_9 -> V_32 [ V_58 ] . V_33 [ V_16 ] ) ;
F_42 ( & V_9 -> V_17 ) ;
return V_46 ;
}
...
unsigned long V_3 = F_65 ( V_42 , NULL , 10 ) ;
F_25 ( & V_9 -> V_17 ) ;
V_9 -> V_32 [ V_58 ] . V_34 [ V_16 ] = F_13 ( V_3 ) ;
F_22 ( V_9 , F_35 ( V_58 , V_16 ) ,
V_9 -> V_32 [ V_58 ] . V_34 [ V_16 ] ) ;
F_42 ( & V_9 -> V_17 ) ;
return V_46 ;
}
...
struct V_43 * V_44 = F_44 ( V_41 ) ;
int V_59 = V_44 -> V_45 ;
return sprintf ( V_42 , L_3 , ( V_9 -> V_39 >> V_59 ) & 1 ) ;
}
static T_3 F_85 ( struct V_13 * V_14 , struct V_40
* V_41 , char * V_42 )
{
struct V_8 * V_9 = F_24 ( V_14 ) ;
return sprintf ( V_42 , L_7 , V_9 -> V_60 ) ;
}
static void T_5 F_86 ( struct V_8 * V_9 )
{
T_1 V_2 ;
int V_61 ;
V_2 = F_19 ( V_9 , V_62 ) ;
if ( ( V_2 & 0x41 ) != 0x01 ) {
F_87 (KERN_DEBUG DRVNAME L_8
L_9 ) ;
F_20 ( V_9 , V_62 , ( V_2 | 0x01 ) & ~ 0x40 ) ;
}
for ( V_61 = 0 ; V_61 < 3 ; V_61 ++ ) {
V_9 -> V_37 [ V_61 ] = F_19 ( V_9 ,
F_38 ( V_61 ) ) ;
if ( V_9 -> V_37 [ V_61 ] & V_63 ) {
V_9 -> V_37 [ V_61 ] &= ~ V_63 ;
F_20 ( V_9 , F_38 ( V_61 ) ,
V_9 -> V_37 [ V_61 ] ) ;
}
...
static int T_5 F_88 ( struct V_64 * V_65 )
{
struct V_66 * V_67 = V_65 -> V_14 . V_68 ;
struct V_8 * V_9 ;
struct V_69 * V_70 ;
int V_61 , V_71 ;
...
if ( ! ( V_9 = F_89 ( sizeof( struct V_8 ) , V_73 ) ) ) {
V_71 = - V_74 ;
F_90 ( L_12 ) ;
goto exit;
}
V_70 = F_91 ( V_65 , V_75 , 0 ) ;
if ( ! F_92 ( V_70 -> V_76 + V_11 , 2 , V_77 ) ) {
V_71 = - V_78 ;
F_93 ( & V_65 -> V_14 , L_13 ,
( unsigned long ) ( V_70 -> V_76 + V_11 ) ,
( unsigned long ) ( V_70 -> V_76 + V_11 + 1 ) ) ;
goto V_79;
}
V_9 -> V_10 = V_70 -> V_76 ;
V_9 -> V_60 = V_72 [ V_67 -> V_80 ] ;
F_94 ( & V_9 -> V_17 ) ;
F_95 ( V_65 , V_9 ) ;
switch ( V_67 -> V_80 ) {
case V_81 :
...
F_86 ( V_9 ) ;
if ( ( V_71 = F_96 ( & V_65 -> V_14 . V_52 , & V_84 ) ) )
goto V_85;
if ( V_9 -> V_22 & ( 1 << 4 ) ) {
if ( ( V_71 = F_96 ( & V_65 -> V_14 . V_52 ,
& V_86 [ 0 ] ) ) )
goto V_87;
}
if ( V_9 -> V_22 & ( 1 << 8 ) ) {
...
for ( V_61 = 0 ; V_61 < 3 ; V_61 ++ ) {
if ( ! ( V_9 -> V_37 [ V_61 ] & V_7 ) ) {
if ( ( V_71 = F_97 ( & V_65 -> V_14 . V_52 ,
V_88 [ V_61 ] ) ) )
goto V_87;
}
if ( V_9 -> V_37 [ V_61 ] & V_55 ) {
if ( ( V_71 = F_67 ( & V_65 -> V_14 . V_52 ,
V_53 [ V_61 ] ,
V_54 | V_56 ) ) ) {
F_93 ( & V_65 -> V_14 , L_5 ,
V_61 + 1 ) ;
...
V_9 -> V_89 = F_98 ( & V_65 -> V_14 ) ;
if ( F_99 ( V_9 -> V_89 ) ) {
V_71 = F_100 ( V_9 -> V_89 ) ;
F_93 ( & V_65 -> V_14 , L_14 , V_71 ) ;
goto V_87;
}
return 0 ;
V_87:
F_101 ( & V_65 -> V_14 . V_52 , & V_84 ) ;
for ( V_61 = 0 ; V_61 < 4 ; V_61 ++ )
F_101 ( & V_65 -> V_14 . V_52 , & V_86 [ V_61 ] ) ;
F_101 ( & V_65 -> V_14 . V_52 , & V_90 ) ;
V_85:
F_102 ( V_70 -> V_76 + V_11 , 2 ) ;
V_79:
F_95 ( V_65 , NULL ) ;
F_103 ( V_9 ) ;
exit:
...
static int T_6 F_104 ( struct V_64 * V_65 )
{
struct V_8 * V_9 = F_105 ( V_65 ) ;
struct V_69 * V_70 ;
int V_61 ;
F_106 ( V_9 -> V_89 ) ;
F_101 ( & V_65 -> V_14 . V_52 , & V_84 ) ;
...
static int T_7 F_107 ( unsigned short V_91 ,
...
if ( V_71 )
goto V_95;
V_71 = F_110 ( V_65 , & V_70 , 1 ) ;
if ( V_71 ) {
F_90 ( L_16 , V_71 ) ;
goto V_95;
}
V_71 = F_111 ( V_65 , V_67 ,
sizeof( struct V_66 ) ) ;
if ( V_71 ) {
F_90 ( L_17 ) ;
goto V_95;
...
static int T_7 F_114 ( int V_96 , unsigned short * V_91 ,
struct V_66 * V_67 )
{
int V_71 = - V_97 ;
T_2 V_98 ;
...
if ( V_98 != V_100 )
goto exit;
V_98 = V_101 ? V_101 : F_4 ( V_96 , V_102 ) ;
switch ( V_98 ) {
case V_103 :
V_67 -> V_80 = V_81 ;
break;
...
unsigned short V_91 ;
struct V_66 V_67 ;
if ( F_114 ( 0x2e , & V_91 , & V_67 )
&& F_114 ( 0x4e , & V_91 , & V_67 ) )
return - V_97 ;
V_71 = F_118 ( & V_110 ) ;
if ( V_71 )
goto exit;
V_71 = F_107 ( V_91 , & V_67 ) ;
if ( V_71 )
goto V_111;
return 0 ;
V_111:
