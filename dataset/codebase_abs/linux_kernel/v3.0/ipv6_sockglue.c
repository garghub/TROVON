...
V_43 = F_44 ( V_40 , & V_143 , & V_145 , V_19 , & V_146 , & V_146 ,
& V_146 ) ;
if ( V_43 )
goto V_151;
V_150:
...
F_57 ( V_2 ) ;
if ( V_250 ) {
int V_238 = F_71 ( V_2 , & V_143 , V_250 ) ;
F_33 ( V_250 ) ;
if ( V_238 )
return V_238 ;
} else {
...
struct V_135 V_253 ;
V_253 . V_138 = V_39 -> V_165 ? V_39 -> V_165 :
V_39 -> V_139 . V_138 ;
V_39 -> V_165 ? F_42 ( & V_253 . V_140 , & V_39 -> V_61 ) :
F_42 ( & V_253 . V_140 , & ( V_39 -> V_139 . V_140 ) ) ;
F_72 ( & V_143 , V_241 , V_134 , sizeof( V_253 ) , & V_253 ) ;
}
if ( V_39 -> V_84 . V_85 . V_90 ) {
int V_254 = V_39 -> V_158 ;
F_72 ( & V_143 , V_241 , V_255 , sizeof( V_254 ) , & V_254 ) ;
}
...
V_39 -> V_165 ? F_42 ( & V_253 . V_140 , & V_39 -> V_61 ) :
F_42 ( & V_253 . V_140 , & ( V_39 -> V_139 . V_140 ) ) ;
F_72 ( & V_143 , V_241 , V_87 , sizeof( V_253 ) , & V_253 ) ;
}
if ( V_39 -> V_84 . V_85 . V_92 ) {
int V_254 = V_39 -> V_158 ;
F_72 ( & V_143 , V_241 , V_91 , sizeof( V_254 ) , & V_254 ) ;
}
}
V_244 -= V_143 . V_152 ;
...
V_257 = F_75 ( V_2 ) ;
if ( V_257 )
V_260 . V_261 = F_76 ( V_257 ) ;
F_77 () ;
if ( ! V_260 . V_261 )
return - V_60 ;
if ( F_73 ( V_244 , V_37 ) )
return - V_44 ;
if ( F_66 ( V_36 , & V_260 , V_244 ) )
return - V_44 ;
return 0 ;
break;
}
...
if ( V_41 < 0 )
V_41 = F_17 ( V_2 ) -> V_262 . V_263 -> V_155 ;
break;
}
case V_159 :
V_41 = V_39 -> V_160 ;
...
int V_238 ;
if ( V_34 == V_239 && V_2 -> V_8 != V_9 )
return V_73 . V_264 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
if( V_34 != V_241 )
return - V_12 ;
...
if ( V_34 == V_239 && V_2 -> V_8 != V_9 ) {
if ( V_73 . V_265 != NULL )
return V_73 . V_265 ( V_2 , V_34 , V_35 ,
V_36 , V_37 ) ;
return V_73 . V_264 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
}
if ( V_34 != V_241 )
