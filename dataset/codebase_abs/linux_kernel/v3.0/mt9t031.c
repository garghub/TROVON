...
struct V_16 * V_17 = F_2 ( V_116 -> V_117 ,
struct V_16 , V_42 ) ;
struct V_13 * V_14 = F_45 ( V_17 ) ;
struct V_2 * V_3 = F_16 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
int V_7 ;
T_3 V_33 , V_34 ;
...
static int F_50 ( struct V_13 * V_14 , T_4 * V_122 )
{
struct V_2 * V_3 = F_16 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
* V_122 = V_1 -> V_53 ;
...
static int F_51 ( struct V_13 * V_14 , unsigned int V_123 ,
enum V_124 * V_81 )
{
if ( V_123 )
return - V_20 ;
...
struct V_128 * V_129 = F_53 ( V_3 -> V_42 . V_117 ) ;
int V_7 ;
if ( V_17 ) {
struct V_23 * V_24 = F_21 ( V_17 ) ;
if ( ! V_24 ) {
