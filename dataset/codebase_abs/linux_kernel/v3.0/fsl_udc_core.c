...
if ( V_4 -> V_376 == V_381 ) {
if ( ! F_126 ( V_375 -> V_351 , V_375 -> V_382 - V_375 -> V_351 + 1 ,
V_358 ) ) {
...
V_54 = F_127 ( V_375 -> V_351 , F_128 ( V_375 ) ) ;
if ( ! V_54 ) {
V_206 = - V_200 ;
goto V_383;
}
V_4 -> V_384 = ( void * ) V_54 ;
if ( V_4 -> V_385 && V_4 -> V_385 ( V_365 ) ) {
V_206 = - V_219 ;
goto V_386;
}
F_9 ( V_4 ) ;
...
V_9 -> V_273 = ( V_84 & V_391 ) * 2 ;
V_9 -> V_331 = F_130 ( V_365 , 0 ) ;
if ( ! V_9 -> V_331 ) {
V_206 = - V_219 ;
goto V_390;
}
V_206 = F_131 ( V_9 -> V_331 , F_107 , V_392 ,
V_358 , V_9 ) ;
if ( V_206 != 0 ) {
F_35 ( L_126 ,
V_9 -> V_331 , V_206 ) ;
...
V_383:
if ( V_4 -> V_376 == V_381 )
F_141 ( V_375 -> V_351 , V_375 -> V_382 - V_375 -> V_351 + 1 ) ;
V_378:
F_59 ( V_9 ) ;
V_9 = NULL ;
return V_206 ;
}
static int T_11 F_142 ( struct V_364 * V_365 )
{
...
static int F_147 ( struct V_364 * V_365 , T_12 V_401 )
{
F_41 ( V_9 ) ;
return 0 ;
}
...
static int F_149 ( struct V_362 * V_35 , T_12 V_401 )
{
struct V_19 * V_20 = V_9 ;
T_1 V_402 , V_68 ;
...
static int F_151 ( struct V_362 * V_35 )
{
F_42 ( L_137 , V_108 ,
V_9 -> V_21 , V_9 -> V_403 ) ;
if ( V_9 -> V_403 ) {
