...
static struct V_131 * F_58 ( struct V_92 * V_93 ,
enum V_132 type ,
char * V_133 , T_1 V_15 )
{
int V_29 ;
...
static T_6 F_67 ( struct V_92 * V_93 ,
...
V_21 = F_29 ( & V_19 , V_66 ) ;
if ( F_19 ( V_21 ) )
return sprintf ( V_144 , L_12 , V_19 ) ;
return sprintf ( V_144 , L_13 ) ;
}
static T_6 F_68 ( struct V_92 * V_93 ,
struct V_142 * V_143 , const char * V_144 , T_7 V_145 )
{
T_1 V_59 = F_69 ( V_144 , NULL , 10 ) ;
T_2 V_21 = F_30 ( V_59 , V_66 ) ;
if ( F_13 ( V_21 ) )
return - V_146 ;
return V_145 ;
}
static T_6 F_70 ( struct V_92 * V_93 , struct V_142 * V_143 ,
char * V_144 )
{
switch ( V_1 -> type ) {
case V_85 :
return sprintf ( V_144 , L_14 ) ;
case V_86 :
return sprintf ( V_144 , L_15 ) ;
case V_87 :
return sprintf ( V_144 , L_16 ) ;
default:
return sprintf ( V_144 , L_17 ) ;
}
}
static void F_71 ( T_1 V_26 , void * V_147 )
{
struct V_18 V_148 = { V_49 , NULL } ;
union V_50 * V_51 ;
struct V_149 V_108 ;
T_2 V_21 ;
T_5 V_150 ;
const struct V_151 * V_152 ;
V_21 = F_72 ( V_26 , & V_148 ) ;
if ( V_21 != V_31 ) {
F_48 ( L_18 , V_21 ) ;
return;
}
V_51 = (union V_50 * ) V_148 . V_23 ;
if ( ! V_51 )
return;
if ( V_51 -> type != V_52 ) {
F_48 ( L_19 , V_51 -> type ) ;
...
V_108 = * ( (struct V_149 * ) V_51 -> V_53 . V_23 ) ;
F_14 ( V_51 ) ;
switch ( V_108 . V_153 ) {
case V_154 :
V_150 = V_108 . V_150 ;
...
default:
F_48 ( L_22 ,
V_108 . V_153 , V_108 . V_156 ) ;
break;
}
}
static T_2
F_76 ( struct V_160 * V_110 ,
struct V_161 * V_108 )
{
T_2 V_21 ;
union V_50 * V_51 ;
struct V_18 V_20 = { sizeof( struct V_160 ) , V_110 } ;
struct V_18 V_113 = { V_49 , NULL } ;
...
* V_108 = * ( (struct V_161 * ) V_51 -> V_53 . V_23 ) ;
F_14 ( V_51 ) ;
return V_21 ;
}
...
V_155 -> V_133 = L_26 ;
V_155 -> V_164 = L_27 ;
V_155 -> V_165 . V_166 = V_167 ;
V_29 = F_81 ( V_155 , V_168 , NULL ) ;
if ( V_29 )
goto V_169;
V_21 = F_82 ( V_141 ,
F_71 , NULL ) ;
...
static int T_4 F_90 ( struct V_173 * V_92 )
{
int V_29 ;
if ( F_5 ( V_5 ) ) {
V_29 = F_33 ( & V_92 -> V_93 ) ;
...
static int F_91 ( struct V_173 * V_92 )
{
if ( F_5 ( V_5 ) )
F_35 () ;
if ( F_5 ( V_7 ) )
...
static int F_92 ( struct V_173 * V_93 ,
T_8 V_121 )
{
T_1 V_26 ;
struct V_177 * V_127 = & V_1 -> V_127 ;
if ( ! V_127 )
return - V_136 ;
if ( F_5 ( V_5 ) ) {
F_29 ( & V_26 , V_5 ) ;
...
static int F_93 ( struct V_173 * V_92 )
{
struct V_177 * V_127 = & V_1 -> V_127 ;
if ( ! V_127 )
return - V_136 ;
...
static void F_94 ( struct V_173 * V_92 )
{
struct V_177 * V_127 = & V_1 -> V_127 ;
if ( ! V_127 )
return;
...
static int F_95 ( struct V_173 * V_92 )
{
if ( F_5 ( V_66 ) )
F_96 ( & V_92 -> V_93 , & V_178 ) ;
F_96 ( & V_92 -> V_93 , & V_179 ) ;
return 0 ;
}
...
{
F_100 ( V_1 -> V_183 . V_83 ) ;
F_100 ( V_1 -> V_183 . V_184 ) ;
}
static int F_101 ( void )
{
V_1 -> V_183 . V_184 = F_102 ( L_2 , NULL ) ;
if ( ! V_1 -> V_183 . V_184 ) {
F_42 ( L_28 ) ;
return - V_136 ;
}
V_1 -> V_183 . V_83 = F_103 ( L_29 , V_185 ,
V_1 -> V_183 . V_184 ,
& V_1 -> V_183 . V_186 ) ;
if ( ! V_1 -> V_183 . V_83 )
goto V_187;
