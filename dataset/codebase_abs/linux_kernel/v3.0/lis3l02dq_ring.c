...
static T_3 F_20 ( int V_5 , void * V_48 )
{
struct V_49 * V_50 = V_48 ;
struct V_7 * V_8 = V_50 -> V_51 ;
struct V_15 * V_16 = V_8 -> V_16 ;
int V_44 = 0 ;
T_6 V_52 = V_16 -> V_22 -> V_25 ( V_16 ) ;
char * V_20 = F_8 ( V_52 , V_26 ) ;
if ( V_20 == NULL ) {
F_21 ( V_8 -> V_53 . V_54 ,
L_1 ) ;
return - V_27 ;
...
if ( V_16 -> V_55 )
* ( V_56 * ) ( ( ( V_57 ) V_20 + V_44
+ sizeof( V_56 ) - 1 ) & ~ ( sizeof( V_56 ) - 1 ) )
= V_50 -> V_58 ;
V_16 -> V_22 -> V_59 ( V_16 , ( T_2 * ) V_20 , V_50 -> V_58 ) ;
F_22 ( V_8 -> V_12 ) ;
F_10 ( V_20 ) ;
return V_13 ;
}
static int
F_23 ( struct V_60 * V_53 , bool V_61 )
{
int V_19 ;
T_2 V_62 ;
bool V_63 ;
struct V_7 * V_8 = F_24 ( V_53 ) ;
struct V_9 * V_10 = F_3 ( V_8 ) ;
V_19 = F_25 ( V_8 ,
V_64 ,
& V_62 ) ;
...
static int F_29 ( struct V_67 * V_12 )
{
struct V_7 * V_8 = V_12 -> V_51 ;
struct V_9 * V_10 = F_3 ( V_8 ) ;
int V_35 ;
for ( V_35 = 0 ; V_35 < 5 ; V_35 ++ )
if ( F_30 ( F_31 ( V_10 -> V_46 -> V_5 ) ) )
F_11 ( V_8 , NULL ) ;
else
break;
if ( V_35 == 5 )
...
int V_19 ;
struct V_9 * V_10 = F_3 ( V_8 ) ;
V_10 -> V_12 = F_34 ( L_3 , V_8 -> V_71 ) ;
if ( ! V_10 -> V_12 ) {
V_19 = - V_27 ;
goto V_65;
}
V_10 -> V_12 -> V_53 . V_54 = & V_10 -> V_46 -> V_53 ;
V_10 -> V_12 -> V_72 = V_73 ;
V_10 -> V_12 -> V_51 = V_8 ;
V_10 -> V_12 -> V_74 = & F_28 ;
V_10 -> V_12 -> V_75 = & F_29 ;
