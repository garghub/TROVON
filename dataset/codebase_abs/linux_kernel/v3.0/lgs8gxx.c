...
V_88 -> V_99 . V_100 . V_101 ( V_88 , V_98 ) ;
if ( V_88 -> V_99 . V_102 )
V_88 -> V_99 . V_102 ( V_88 , 0 ) ;
}
F_19 ( V_2 ) ;
F_6 ( 10 ) ;
return 0 ;
...
F_2 ( L_12 , V_17 ) ;
V_98 -> V_103 = V_104 ;
V_98 -> V_105 . V_106 . V_107 = V_108 ;
V_98 -> V_105 . V_106 . V_109 = V_110 ;
V_98 -> V_105 . V_106 . V_111 = V_110 ;
V_98 -> V_105 . V_106 . V_112 = V_113 ;
V_98 -> V_105 . V_106 . V_114 = V_115 ;
V_98 -> V_105 . V_106 . V_116 = V_117 ;
V_98 -> V_105 . V_106 . V_118 = V_119 ;
return 0 ;
}
static
...
static int F_33 ( struct V_87 * V_88 , T_5 * V_125 )
{
struct V_1 * V_2 = V_88 -> V_89 ;
T_4 V_5 ;
T_1 V_28 , V_48 = 0 ;
...
T_1 V_132 [ 2 ] , V_133 ;
F_2 ( L_22 , V_17 ) ;
F_4 ( V_2 , 0x3F , & V_132 [ 0 ] ) ;
F_4 ( V_2 , 0x3E , & V_132 [ 1 ] ) ;
V_131 = V_132 [ 0 ] ;
V_131 <<= 8 ;
V_131 |= V_132 [ 1 ] ;
F_2 ( L_23 , V_131 ) ;
...
static int F_38 ( struct V_87 * V_88 , T_6 * V_137 )
{
struct V_1 * V_2 = V_88 -> V_89 ;
T_1 V_28 ;
* V_137 = 0 ;
...
static int F_39 ( struct V_87 * V_88 , T_2 * V_138 )
{
* V_138 = 0 ;
F_2 ( L_30 , V_17 , * V_138 ) ;
return 0 ;
...
static int F_42 ( struct V_87 * V_88 , T_2 * V_140 )
{
struct V_1 * V_2 = V_88 -> V_89 ;
T_1 V_141 , V_142 , V_28 ;
T_2 V_143 = 0 , V_144 = 0 ;
int V_29 ;
F_2 ( L_12 , V_17 ) ;
F_40 ( V_2 ) ;
...
F_41 ( V_2 ) ;
if ( V_2 -> V_12 -> V_14 == V_15 ) {
V_142 = 0x28 ; V_141 = 0x2C ;
} else {
V_142 = 0xD0 ; V_141 = 0xD4 ;
}
for ( V_29 = 0 ; V_29 < 4 ; V_29 ++ ) {
V_143 <<= 8 ;
F_4 ( V_2 , V_142 + 3 - V_29 , & V_28 ) ;
V_143 |= V_28 ;
}
for ( V_29 = 0 ; V_29 < 4 ; V_29 ++ ) {
V_144 <<= 8 ;
...
F_2 ( L_31 , V_144 , V_143 ) ;
if ( V_143 == 0 )
* V_140 = 0 ;
else
* V_140 = V_144 * 100 / V_143 ;
F_2 ( L_32 , V_17 , * V_140 ) ;
return 0 ;
}
static int F_43 ( struct V_87 * V_88 , int V_145 )
{
struct V_1 * V_2 = V_88 -> V_89 ;
if ( V_2 -> V_12 -> V_146 == 0 )
return 0 ;
if ( V_145 ) {
T_1 V_131 = 0x80 | V_2 -> V_12 -> V_146 ;
return F_1 ( V_2 , 0x01 , V_131 ) ;
}
...
return NULL ;
V_2 = F_45 ( sizeof( struct V_1 ) , V_148 ) ;
if ( V_2 == NULL )
goto V_149;
V_2 -> V_12 = V_12 ;
V_2 -> V_18 = V_18 ;
