...
static inline unsigned F_19 ( struct V_1 * V_2 ,
T_1 V_48 )
{
...
V_74 |= 0x2000 ;
V_66 = ( T_2 * ) F_26 ( V_6 , V_2 , V_64 , V_70 ) ;
* V_66 ++ = F_30 ( V_72 ) ;
* V_66 ++ = F_30 ( V_74 ) ;
return V_66 ;
}
...
void F_55 ( struct V_3 * V_4 , unsigned char V_97 ,
unsigned short V_113 , T_1 V_48 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
int V_114 = 0 ;
if ( V_97 == V_118 )
V_114 = F_50 ( V_6 -> V_120 . V_103 ) ;
if ( V_113 == 0 )
V_113 = F_50 ( V_6 -> V_120 . V_121 ) ;
F_51 ( V_4 , V_97 , V_113 , V_48 , V_4 -> V_22 , V_114 ,
V_6 -> V_120 . V_111 , V_6 -> V_67 , V_6 -> V_68 ) ;
}
...
unsigned char * V_66 ;
T_1 V_48 = V_56 ;
if ( ( V_2 = F_12 ( V_4 , V_126 + 2 , V_48 ) ) == NULL )
return;
F_16 ( V_2 , V_126 ) ;
V_66 = F_46 ( V_2 , 2 ) ;
F_20 ( V_2 ) -> V_80 = 0x10 ;
...
T_1 V_131 = ( V_97 == V_132 ) ? V_4 -> V_96 : V_56 ;
...
F_62 ( V_2 ) , 2 ) ) ;
V_130 = V_134 | V_135 ;
if ( V_6 -> V_19 . V_136 & V_137 )
V_130 |= V_138 ;
if ( V_6 -> V_19 . V_136 & V_139 )
V_130 |= V_140 ;
* F_46 ( V_2 , 1 ) = V_130 ;
...
V_129 = ( T_3 ) F_50 ( V_6 -> V_102 . V_103 ) ;
* F_46 ( V_2 , 1 ) = V_129 ;
if ( V_129 > 0 )
memcpy ( F_46 ( V_2 , V_129 ) , V_6 -> V_102 . V_111 , V_129 ) ;
V_6 -> V_63 = F_17 ( V_4 ) ;
V_6 -> V_112 = F_59 ;
V_50 -> V_148 = V_149 ;
F_1 ( V_2 ) ;
