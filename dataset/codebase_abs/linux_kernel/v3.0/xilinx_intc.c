...
void * V_4 = V_34 -> V_22 ;
F_4 ( L_6 ) ;
return F_20 ( V_34 , F_21 ( V_4 + V_35 ) ) ;
}
static void F_22 ( unsigned int V_3 , struct V_36 * V_37 )
{
struct V_38 * V_39 = F_23 ( V_37 ) ;
unsigned int V_40 = F_24 () ;
if ( V_40 )
F_25 ( V_40 ) ;
V_39 -> V_41 ( & V_37 -> V_1 ) ;
}
