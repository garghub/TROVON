...
while ( F_23 ( V_1 -> V_9 ) ) {
V_24 = F_17 ( T_2 , V_1 ) ;
V_23 -> V_15 [ V_23 -> V_17 ++ ] = V_24 ;
V_25 = F_24 ( V_1 ) ;
V_1 -> V_9 = F_25 ( V_24 , V_25 , V_1 -> V_9 ) ;
}
if ( F_26 ( V_1 -> V_9 ) )
V_1 -> V_9 = 0 ;
V_28:
...
if ( ! V_29 -> V_14 )
F_27 ( V_1 ) ;
return ( V_29 -> V_17 && ( V_29 -> V_19 & 0xc7 ) == 0x5 ) ;
}
...
F_27 ( V_1 ) ;
if ( V_1 -> V_29 . V_17 ) {
V_29 = ( T_2 ) V_1 -> V_29 . V_19 ;
if ( V_1 -> V_6 != 2 &&
F_13 ( V_29 ) != 3 && F_34 ( V_29 ) == 4 ) {
V_1 -> V_31 . V_19 = F_17 ( T_2 , V_1 ) ;
V_1 -> V_31 . V_17 = 1 ;
}
}
V_1 -> V_31 . V_14 = 1 ;
...
F_33 ( V_1 ) ;
if ( V_1 -> V_29 . V_17 ) {
V_30 = F_13 ( V_1 -> V_29 . V_19 ) ;
V_32 = F_34 ( V_1 -> V_29 . V_19 ) ;
V_33 = F_36 ( V_1 -> V_31 . V_19 ) ;
if ( V_30 == 3 )
goto V_35;
if ( V_30 == 1 ) {
V_1 -> V_34 . V_19 = F_17 ( char , V_1 ) ;
V_1 -> V_34 . V_17 = 1 ;
} else if ( V_1 -> V_6 == 2 ) {
if ( ( V_30 == 0 && V_32 == 6 ) || V_30 == 2 ) {
V_1 -> V_34 . V_19 =
F_17 ( short , V_1 ) ;
V_1 -> V_34 . V_17 = 2 ;
}
} else {
if ( ( V_30 == 0 && V_32 == 5 ) || V_30 == 2 ||
( V_30 == 0 && V_33 == 5 ) ) {
V_1 -> V_34 . V_19 = F_17 ( int , V_1 ) ;
V_1 -> V_34 . V_17 = 4 ;
}
}
}
...
switch ( V_1 -> V_6 ) {
case 2 :
V_1 -> V_36 . V_19 = F_17 ( short , V_1 ) ;
V_1 -> V_36 . V_17 = 2 ;
break;
case 4 :
V_1 -> V_36 . V_19 = F_17 ( int , V_1 ) ;
V_1 -> V_36 . V_17 = 4 ;
break;
case 8 :
V_1 -> V_36 . V_19 = F_17 ( int , V_1 ) ;
...
V_1 -> V_36 . V_14 = V_1 -> V_37 . V_14 = 1 ;
}
static void F_38 ( struct V_1 * V_1 )
{
switch ( V_1 -> V_5 ) {
case 2 :
V_1 -> V_38 . V_19 = F_17 ( short , V_1 ) ;
V_1 -> V_38 . V_17 = 2 ;
break;
case 4 :
case 8 :
...
V_1 -> V_40 . V_19 = F_17 (unsigned short, insn) ;
V_1 -> V_40 . V_17 = 2 ;
V_1 -> V_39 . V_14 = V_1 -> V_40 . V_14 = 1 ;
}
...
if ( ! V_1 -> V_38 . V_14 )
F_41 ( V_1 ) ;
V_1 -> V_49 = ( unsigned char ) ( ( unsigned long ) V_1 -> V_4
