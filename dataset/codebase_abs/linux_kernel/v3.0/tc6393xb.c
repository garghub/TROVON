...
static int T_3 F_57 ( struct V_1 * V_3 )
{
struct V_61 * V_62 = V_3 -> V_3 . V_63 ;
struct V_5 * V_5 ;
struct V_64 * V_65 , * V_66 ;
int V_67 , V_68 ;
V_65 = F_58 ( V_3 , V_69 , 0 ) ;
if ( ! V_65 )
return - V_70 ;
V_5 = F_59 ( sizeof *V_5 , V_71 ) ;
if ( ! V_5 ) {
V_67 = - V_72 ;
goto V_73;
}
...
V_66 -> V_77 = L_4 ;
V_66 -> V_27 = V_65 -> V_27 ;
V_66 -> V_78 = V_65 -> V_27 + 0xff ;
V_66 -> V_6 = V_69 ;
V_67 = F_66 ( V_65 , V_66 ) ;
if ( V_67 )
goto V_79;
V_5 -> V_8 = F_67 ( V_66 -> V_27 , F_68 ( V_66 ) ) ;
if ( ! V_5 -> V_8 ) {
V_67 = - V_72 ;
goto V_80;
}
...
goto V_83;
F_19 ( 0 , V_5 -> V_8 + V_13 ) ;
F_21 ( V_62 -> V_84 , V_5 -> V_8 + V_85 ) ;
F_21 ( V_86 | V_87 ,
V_5 -> V_8 + V_11 ) ;
F_21 ( V_88 | V_89 | V_90 |
V_91 | V_92 | V_93 |
F_70 ( 15 ) , V_5 -> V_8 + V_94 ) ;
F_21 ( V_62 -> V_95 , V_5 -> V_8 + V_96 ) ;
F_19 ( 0 , V_5 -> V_8 + V_97 ) ;
F_19 ( 0xbf , V_5 -> V_8 + V_51 ) ;
F_71 ( V_98 L_5 ,
F_13 ( V_5 -> V_8 + V_99 ) ,
( unsigned long ) V_65 -> V_27 , V_5 -> V_44 ) ;
V_5 -> V_32 . V_38 = - 1 ;
if ( V_62 -> V_36 >= 0 ) {
V_67 = F_39 ( V_5 , V_62 -> V_36 ) ;
if ( V_67 )
goto V_100;
}
F_48 ( V_3 ) ;
...
V_103 [ V_104 ] . V_63 = V_62 -> V_105 ;
V_103 [ V_104 ] . V_106 =
sizeof( * V_62 -> V_105 ) ;
V_103 [ V_107 ] . V_63 = V_62 -> V_108 ;
V_103 [ V_107 ] . V_106 = sizeof( * V_62 -> V_108 ) ;
V_67 = F_72 ( & V_3 -> V_3 , V_3 -> V_109 ,
V_103 , F_73 ( V_103 ) ,
V_65 , V_62 -> V_49 ) ;
if ( ! V_67 )
return 0 ;
...
static int T_4 F_80 ( struct V_1 * V_3 )
{
struct V_61 * V_62 = V_3 -> V_3 . V_63 ;
struct V_5 * V_5 = F_3 ( V_3 ) ;
int V_67 ;
...
static int F_83 ( struct V_1 * V_3 , T_5 V_28 )
{
struct V_61 * V_62 = V_3 -> V_3 . V_63 ;
struct V_5 * V_5 = F_3 ( V_3 ) ;
int V_48 , V_67 ;
V_5 -> V_112 . V_9 = F_84 ( V_5 -> V_8 + V_11 ) ;
