...
V_108 = V_42 -> V_106 ;
for ( V_107 = 0 ; V_107 < F_25 ( V_42 -> V_55 ) ; V_107 ++ )
V_109 += F_67 ( V_108 [ V_107 ] ) ;
F_68 ( V_109 ) ;
return V_109 ;
}
...
struct V_111 * V_112 )
{
int V_113 , V_114 , V_115 , V_116 , V_117 ;
int V_118 = 0 ;
struct V_111 V_119 ;
void * V_104 = NULL ;
struct V_120 * V_121 = & V_2 -> V_73 ;
...
V_113 = * V_110 ;
if ( F_71 ( V_121 , V_112 , & V_114 , & V_113 ) == 0 ) {
if ( V_113 < * V_110 )
* V_110 = V_113 ;
goto V_33;
}
...
V_113 = V_114 = V_116 = 0 ;
V_117 = - 1 ;
V_115 = F_23 ( V_36 -> V_57 . V_58 . V_60 ) ;
while ( ( V_114 = F_72 ( V_104 , V_115 , V_116 ) ) != - 1 ) {
if ( V_114 == V_115 ) {
break;
}
if ( V_114 == V_116 ) {
...
V_103 = V_109 = V_101 = 0 ;
V_115 = F_23 ( V_36 -> V_57 . V_58 . V_60 ) ;
while ( ( V_101 = F_72 ( V_104 , V_115 , V_103 ) )
!= - 1 ) {
if ( ( V_101 < V_115 ) && ( V_101 == V_103 ) ) {
V_109 ++ ;
V_103 ++ ;
continue;
}
...
V_42 -> V_61 = F_92 ( V_136 ) ;
V_36 -> V_57 . V_58 . V_60 = F_92 ( V_137 ) ;
V_36 -> V_57 . V_58 . V_59 = 0 ;
