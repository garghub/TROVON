...
if ( V_18 >= 32 && V_18 <= 64 )
V_20 = 0 ;
else if ( V_18 >= 4000 && V_18 <= 8000 )
V_20 = 1 ;
else
return - V_16 ;
return F_4 ( V_5 , V_19 , V_11 , V_20 ) ;
}
static void F_11 ( struct V_22 * V_23 , struct V_2 * V_3 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
struct V_5 * V_5 = V_1 -> V_5 ;
int V_24 , V_25 ;
