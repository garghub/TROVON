...
int F_5 ( struct V_5 * V_6 , T_1 V_35 )
{
T_1 V_36 ;
V_36 = V_35 / V_13 . V_14 ;
...
int F_6 ( struct V_5 * V_6 , T_2 V_8 , T_3 * V_9 )
{
T_1 V_40 , V_41 ;
if ( ! F_19 ( V_6 , V_8 , V_9 ) )
return ( V_28 ) ;
...
{
if ( F_21 ( V_6 , ( V_40 == V_17 ) ? V_46 : V_47 ) )
{
if ( V_12 == V_21 )
return ( ERROR ) ;
continue;
...
V_30 = ERROR ;
#else
if ( V_12 == V_45 ) return ( V_28 ) ;
#endif
return ( ERROR ) ;
}
int F_21 ( struct V_5 * V_6 , T_1 V_48 )
{
T_3 V_49 ;
V_49 = V_15 . V_16 ;
if ( F_9 () )
...
if ( V_48 == V_46 )
V_31 = V_46 ;
for( V_15 . V_16 = 0 ; V_15 . V_16 < V_13 . V_14 ; V_15 . V_16 ++ )
{
if ( F_22 ( V_6 ) )
{
if ( V_12 == V_21 )
...
{
V_26 = V_15 . V_25 ;
for( V_24 = V_50 [ V_15 . V_22 ] ; V_24 < V_13 . V_51 ; V_24 ++ )
{
...
for( V_24 = 0 ; V_24 < V_50 [ V_15 . V_22 ] ; V_24 ++ )
{
if ( ! F_25 ( V_29 [ V_15 . V_22 ] , V_24 ) )
{
F_26 ( V_29 [ V_15 . V_22 ] , V_24 ) ;
...
if ( F_27 ( V_6 ) )
{
if ( V_12 == V_21 ) return ( ERROR ) ;
if ( F_28 ( V_6 ) ) return ( ERROR ) ;
}
else
F_12 ( V_29 [ V_15 . V_22 ] , V_15 . V_25 ) ;
}
...
{ V_12 = V_21 ; V_30 = ERROR ; return ( ERROR ) ; }
if ( F_31 ( V_52 , V_53 ) )
{ V_12 = V_21 ; V_30 = ERROR ; return ( ERROR ) ; }
}
...
{ V_12 = V_21 ; V_30 = ERROR ; return ( ERROR ) ; }
if ( F_39 () )
{ V_12 = V_20 ; return ( ERROR ) ; }
V_15 . V_25 = V_26 ;
return ( V_28 ) ;
}
int F_19 ( struct V_5 * V_6 , T_2 V_8 , T_3 * V_9 )
{
int V_1 ;
T_1 V_41 ;
if ( V_15 . V_25 == V_27 )
...
{ V_12 = V_21 ; V_30 = ERROR ; return ( ERROR ) ; }
if ( F_33 ( V_19 ) )
{ V_12 = V_42 ; return ( ERROR ) ; }
if ( ! F_34 ( V_19 ) )
return ( V_28 ) ;
if ( ! F_35 ( V_9 , V_19 ) )
{ V_12 = V_45 ; return ( ERROR ) ; }
}
V_12 = V_17 ;
return ( ERROR ) ;
}
...
{
V_15 . V_22 = 0 ; V_15 . V_16 = 0 ;
for ( V_15 . V_25 = 0 ; V_15 . V_25 < ( V_13 . V_51 - V_13 . V_37 - 1 ) ; V_15 . V_25 ++ )
{
if ( F_43 ( V_6 , V_19 ) )
{
F_29 ( V_6 ) ;
...
if ( V_3 [ V_15 . V_22 ] == NULL )
{
V_3 [ V_15 . V_22 ] = F_45 ( V_60 * sizeof( T_2 ) , V_61 ) ;
if ( V_3 [ V_15 . V_22 ] == NULL )
return ( ERROR ) ;
}
V_15 . V_16 = 0 ;
{
for( V_15 . V_23 = 0 ; V_15 . V_23 < V_13 . V_37 ; V_15 . V_23 ++ )
V_3 [ V_15 . V_22 ] [ V_15 . V_23 ] = V_27 ;
for( V_15 . V_25 = 0 ; V_15 . V_25 < ( V_62 / 8 ) ; V_15 . V_25 ++ )
V_29 [ V_15 . V_22 ] [ V_15 . V_25 ] = 0x00 ;
for( V_15 . V_25 = 0 ; V_15 . V_25 < V_13 . V_51 ; V_15 . V_25 ++ )
{
