...
{
return V_17 -> V_36 -> V_38 -> V_42 == * ( V_43 * ) V_41 ;
}
...
static int F_54 ( struct V_19 * V_27 ,
struct V_18 * V_21 ,
struct V_6 * V_7 )
{
F_55 ( V_21 ) ;
...
F_58 ( V_17 . V_24 ) ;
F_26 ( & V_21 -> V_81 ) ;
V_7 -> V_78 . V_79 = V_45 -> V_79 ;
V_7 -> V_78 . V_80 = V_45 -> V_80 ;
F_31 ( & V_21 -> V_81 ) ;
}
F_20 ( & V_17 ) ;
V_16:
...
V_83 = V_7 -> V_84 . V_83 ;
V_36 = V_27 -> V_23 . V_36 ;
return F_60 ( V_21 -> V_77 , V_36 , V_21 , V_83 ) ;
}
static int F_61 ( struct V_19 * V_27 ,
struct V_18 * V_21 ,
struct V_6 * V_7 )
{
V_7 -> V_85 . V_86 = 0 ;
if ( V_86 ( V_27 -> V_23 . V_36 ) )
V_7 -> V_85 . V_86 = 1 ;
return 0 ;
}
...
V_1 = V_7 -> V_17 ;
type = V_7 -> V_88 . V_13 . type ;
V_7 -> V_88 . V_16 . V_54 = V_54 = 0 ;
V_7 -> V_88 . V_16 . V_87 = V_87 = 0 ;
if ( ! V_27 || V_7 -> V_58 == - 1 ) {
if ( F_63 ( type ) )
V_8 = F_18 ( V_1 , V_89 , & V_17 ) ;
else
V_8 = F_16 ( V_1 , & V_17 , F_23 , & type ) ;
if ( V_8 )
goto V_16;
V_54 = F_64 ( V_17 . V_36 -> V_38 -> V_42 ) ;
V_8 = 0 ;
if ( V_17 . V_36 -> V_37 == V_17 . V_24 ) {
V_8 = 1 ;
V_87 = V_17 . V_36 -> V_38 -> V_39 ;
}
} else {
V_43 V_90 = V_21 -> V_77 -> V_42 ;
V_8 = F_16 ( V_1 , & V_17 , F_22 , & V_90 ) ;
if ( V_8 )
goto V_16;
V_54 = F_64 ( V_90 ) ;
V_8 = F_65 ( V_17 . V_24 ) ;
...
V_7 -> V_88 . V_16 . V_54 = V_54 ;
V_7 -> V_88 . V_16 . V_87 = V_87 ;
F_20 ( & V_17 ) ;
V_16:
return V_8 ;
}
static T_4 F_67 ( unsigned int V_5 )
{
static struct {
int V_5 ;
T_4 V_91 ;
...
unsigned int V_107 = F_68 ( V_5 ) ;
return ( V_107 >= F_69 ( V_92 ) ) ? NULL : V_92 [ V_107 ] . V_91 ;
}
static int F_70 ( unsigned int V_108 , struct V_6 T_2 * V_109 )
{
struct V_6 * V_7 ;
struct V_19 * V_27 ;
struct V_18 * V_21 ;
unsigned int V_110 , V_5 ;
T_4 V_91 = NULL ;
int V_8 = 0 ;
if ( ! F_71 ( V_111 ) )
return - V_112 ;
...
V_117:
V_8 = V_91 ( V_27 , V_21 , V_7 ) ;
if ( V_27 )
F_52 ( V_27 ) ;
V_116:
if ( V_8 >= 0 && F_75 ( V_109 , V_7 , V_120 ) )
V_8 = - V_15 ;
V_16:
F_9 ( V_7 ) ;
return V_8 ;
}
static long V_6 ( struct V_19 * V_19 , T_5 V_108 , T_6 V_121 )
{
int V_8 ;
V_8 = F_70 ( V_108 , (struct V_6 T_2 * ) V_121 ) ;
return ( long ) V_8 ;
}
static long F_76 ( struct V_19 * V_19 , T_5 V_108 , T_6 V_121 )
{
return ( long ) V_6 ( V_19 , V_108 , ( T_6 ) F_77 ( V_121 ) ) ;
}
int F_78 ( void )
{
int V_122 ;
