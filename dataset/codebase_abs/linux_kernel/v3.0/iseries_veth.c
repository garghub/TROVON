...
static inline int F_97 ( struct V_43 * V_44 , T_5 V_171 )
{
int V_208 = 0 ;
int V_66 ;
unsigned long V_47 ;
...
static inline void F_100 ( struct V_209 * V_210 ,
unsigned char * V_21 , unsigned long V_211 )
{
unsigned long V_212 ;
int V_66 = 1 ;
V_210 [ 0 ] . V_138 = F_101 ( V_21 ) ;
V_210 [ 0 ] . V_213 = F_102 ( V_211 ,
V_214 - ( ( unsigned long ) V_21 & ~ V_215 ) ) ;
V_212 = V_210 [ 0 ] . V_213 ;
while ( V_212 < V_211 ) {
V_210 [ V_66 ] . V_138 = F_101 ( V_21 + V_212 ) ;
V_210 [ V_66 ] . V_213 = F_102 ( V_211 - V_212 , V_214 ) ;
...
V_184 = F_104 ( V_211 , V_226 ) ;
if ( ! V_184 )
continue;
F_100 ( V_221 , V_184 -> V_20 , V_211 ) ;
V_92 = F_105 ( V_17 ,
V_46 -> V_51 . V_65 ,
V_227 ,
V_2 -> V_18 ,
...
static int F_115 ( struct V_168 * V_170 , const struct V_236 * V_237 )
{
