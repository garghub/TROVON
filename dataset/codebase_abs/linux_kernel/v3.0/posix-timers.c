...
static void
V_27 ( struct V_1 * V_2 , struct V_110 * V_111 )
{
T_3 V_72 , V_112 , V_113 ;
struct V_44 * V_45 = & V_2 -> V_46 . V_47 . V_45 ;
memset ( V_111 , 0 , sizeof( struct V_110 ) ) ;
V_113 = V_2 -> V_46 . V_47 . V_48 ;
if ( V_113 . V_49 )
V_111 -> V_114 = F_18 ( V_113 ) ;
else if ( ! F_63 ( V_45 ) &&
( V_2 -> V_69 & ~ V_70 ) != V_85 )
return;
V_72 = V_45 -> V_51 -> V_52 () ;
if ( V_113 . V_49 && ( V_2 -> V_54 & V_115 ||
( V_2 -> V_69 & ~ V_70 ) == V_85 ) )
V_2 -> V_50 += ( unsigned int ) F_26 ( V_45 , V_72 , V_113 ) ;
V_112 = F_64 ( F_65 ( V_45 ) , V_72 ) ;
if ( V_112 . V_49 <= 0 ) {
if ( ( V_2 -> V_69 & ~ V_70 ) != V_85 )
V_111 -> V_116 . V_117 = 1 ;
} else
V_111 -> V_116 = F_18 ( V_112 ) ;
}
static int
V_25 ( struct V_1 * V_2 , int V_3 ,
struct V_110 * V_118 , struct V_110 * V_119 )
{
struct V_44 * V_45 = & V_2 -> V_46 . V_47 . V_45 ;
enum V_120 V_121 ;
if ( V_119 )
...
~ V_115 ;
V_2 -> V_53 = 0 ;
if ( ! V_118 -> V_116 . V_123 && ! V_118 -> V_116 . V_117 )
return 0 ;
V_121 = V_3 & V_124 ? V_125 : V_126 ;
F_60 ( & V_2 -> V_46 . V_47 . V_45 , V_2 -> V_59 , V_121 ) ;
V_2 -> V_46 . V_47 . V_45 . V_127 = F_36 ;
F_67 ( V_45 , F_68 ( V_118 -> V_116 ) ) ;
V_2 -> V_46 . V_47 . V_48 = F_68 ( V_118 -> V_114 ) ;
if ( ( ( V_2 -> V_69 & ~ V_70 ) == V_85 ) ) {
if ( V_121 == V_126 ) {
...
{
struct V_11 * V_128 = F_59 ( V_45 -> V_59 ) ;
if ( F_72 ( ! V_128 || ! V_128 -> V_28 ) )
return - V_129 ;
return V_128 -> V_28 ( V_45 ) ;
}
...
void F_75 ( struct V_133 * V_134 )
{
struct V_1 * V_93 ;
while ( ! F_76 ( & V_134 -> V_135 ) ) {
V_93 = F_77 ( V_134 -> V_135 . V_136 , struct V_1 , V_131 ) ;
F_73 ( V_93 ) ;
}
}
static int V_19 ( const T_1 V_5 , int V_3 ,
struct V_6 * V_137 , struct V_6 T_6 * V_138 )
{
return F_78 ( V_137 , V_138 , V_3 & V_124 ?
V_125 : V_126 ,
V_5 ) ;
}
long F_79 ( struct V_139 * V_139 )
{
T_1 V_5 = V_139 -> V_140 . V_141 ;
struct V_11 * V_128 = F_59 ( V_5 ) ;
if ( F_72 ( ! V_128 || ! V_128 -> V_20 ) )
return - V_129 ;
return V_128 -> V_20 ( V_139 ) ;
}
