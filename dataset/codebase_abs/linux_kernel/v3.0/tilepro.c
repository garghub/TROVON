...
unsigned long V_182 = F_118 ( V_181 -> V_183 ) ;
int V_179 = V_35 ;
if ( ! V_35 ) {
void * V_17 = F_119 ( V_182 ) + V_181 -> V_184 ;
F_14 ( F_120 ( V_181 -> V_183 ) ) ;
F_117 ( V_17 , V_181 -> V_126 , 0 ) ;
}
V_176 = ( ( V_80 ) V_182 << V_185 ) + V_181 -> V_184 ;
V_171 [ V_47 ] . V_177 = V_176 ;
V_171 [ V_47 ] . V_178 = V_176 >> 32 ;
V_171 [ V_47 ] . V_6 = V_181 -> V_126 ;
V_171 [ V_47 ] . V_179 = V_179 ;
V_47 ++ ;
}
return V_47 ;
}
static int F_121 ( struct V_31 * V_32 , struct V_50 * V_51 )
{
struct V_53 * V_54 = F_28 ( V_51 ) ;
int V_8 = F_2 () ;
struct V_15 * V_16 = V_54 -> V_82 [ V_8 ] ;
...
struct V_186 * V_187 = F_122 ( V_32 ) ;
unsigned int V_188 = V_187 -> V_189 * 4 ;
unsigned char * V_190 = F_123 ( V_32 ) ;
...
unsigned int V_173 = F_124 ( V_32 ) - V_196 ;
unsigned int V_197 = V_173 + V_32 -> V_198 ;
unsigned int V_199 = V_175 -> V_200 ;
unsigned int V_201 = V_175 -> V_202 ;
T_2 V_203 [ ( V_204 + 3 ) / 4 ] ;
T_14 * V_205 = ( T_14 * ) V_203 ;
unsigned int V_206 =
F_115 ( V_205 -> V_171 , V_32 , V_5 + V_196 , V_173 ) ;
T_15 V_207 = F_125 ( V_206 , V_196 ) ;
T_14 V_208 = {
. V_209 = true ,
. V_210 = V_196 ,
. V_211 = V_191 ,
...
unsigned int V_59 ;
F_14 ( V_32 -> V_97 != F_126 ( V_219 ) ) ;
F_14 ( V_187 -> V_97 != V_220 ) ;
F_14 ( V_32 -> V_98 != V_221 ) ;
F_14 ( V_206 > V_222 ) ;
F_14 ( V_201 <= 1 ) ;
* V_205 = V_208 ;
memcpy ( & V_205 -> V_171 [ V_206 ] , V_5 , V_196 ) ;
F_127 ( & V_43 -> V_59 ) ;
F_127 ( & V_43 -> V_217 ) ;
F_100 () ;
F_128 ( & V_54 -> V_58 , V_214 ) ;
if ( F_129 ( V_43 ) == 0 ) {
V_215 = F_25 ( V_43 , V_55 , V_56 , 0 ) ;
if ( V_215 == 0 ) {
V_223:
F_130 ( & V_54 -> V_58 , V_214 ) ;
return V_224 ;
}
}
V_216 = V_43 -> V_216 ;
...
memcpy ( & V_43 -> V_226 [ V_217 ] , V_205 , V_207 ) ;
V_217 = V_218 ;
V_59 = V_43 -> V_59 ;
V_43 -> V_44 [ V_59 ] = V_32 ;
F_26 ( V_59 ) ;
...
static int F_131 ( struct V_31 * V_32 , struct V_50 * V_51 )
{
struct V_53 * V_54 = F_28 ( V_51 ) ;
int V_8 = F_2 () ;
struct V_15 * V_16 = V_54 -> V_82 [ V_8 ] ;
...
unsigned int V_56 = 8 ;
unsigned int V_2 , V_215 = 0 ;
unsigned int V_207 = sizeof( V_231 ) ;
unsigned int V_216 , V_217 , V_218 ;
unsigned int V_59 ;
V_231 V_226 [ V_222 ] ;
if ( ! V_16 -> V_147 )
...
#endif
#ifdef F_45
F_5 ( V_5 , F_124 ( V_32 ) , L_40 ) ;
#endif
if ( V_175 -> V_200 != 0 )
return F_121 ( V_32 , V_51 ) ;
V_206 = F_115 ( V_171 , V_32 , V_5 , F_124 ( V_32 ) ) ;
...
* ( V_231 * ) & V_43 -> V_226 [ V_217 ] = V_226 [ V_2 ] ;
V_217 = V_218 ;
}
V_59 = V_43 -> V_59 ;
V_43 -> V_44 [ V_59 ] = V_32 ;
...
static int F_135 ( struct V_50 * V_51 , struct V_243 * V_244 , int V_205 )
{
return - V_245 ;
}
static struct V_246 * F_136 ( struct V_50 * V_51 )
{
struct V_53 * V_54 = F_28 ( V_51 ) ;
T_2 V_100 = 0 ;
T_2 V_227 = 0 ;
...
V_228 += V_54 -> V_82 [ V_2 ] -> V_85 . V_228 ;
}
}
V_54 -> V_85 . V_100 = V_100 ;
V_54 -> V_85 . V_101 = V_101 ;
V_54 -> V_85 . V_227 = V_227 ;
V_54 -> V_85 . V_228 = V_228 ;
return & V_54 -> V_85 ;
}
static int F_137 ( struct V_50 * V_51 , int V_247 )
{
F_77 ( L_43 ) ;
if ( ( V_247 < 68 ) || ( V_247 > 1500 ) )
return - V_248 ;
V_51 -> V_249 = V_247 ;
return 0 ;
}
static int F_138 ( struct V_50 * V_51 , void * V_250 )
{
struct V_251 * V_252 = V_250 ;
if ( ! F_139 ( V_252 -> V_253 ) )
return - V_248 ;
memcpy ( V_51 -> V_96 , V_252 -> V_253 , V_51 -> V_254 ) ;
return 0 ;
}
static int F_140 ( struct V_50 * V_51 )
{
struct V_53 * V_54 = F_28 ( V_51 ) ;
char V_255 [ 32 ] ;
int V_3 ;
T_16 V_256 = { . V_79 = V_257 } ;
int V_114 ;
strcpy ( V_255 , V_51 -> V_136 ) ;
V_3 = strlen ( V_255 ) ;
V_255 [ V_3 ] = V_255 [ V_3 - 1 ] ;
V_255 [ V_3 - 1 ] = '/' ;
V_3 ++ ;
strcpy ( V_255 + V_3 , V_35 ? L_44 : L_45 ) ;
V_54 -> V_117 = F_141 ( ( V_118 ) V_255 , 0 ) ;
F_77 ( L_46 ,
V_255 , V_54 -> V_117 , & V_54 -> V_117 ) ;
if ( V_54 -> V_117 < 0 ) {
if ( V_54 -> V_117 == V_258 )
F_81 ( V_144 L_47 ,
V_255 ) ;
...
V_256 . V_238 . V_259 = V_260 ;
V_256 . V_238 . V_252 = V_261 ;
V_114 = F_67 ( V_54 -> V_117 , 0 ,
( V_118 ) V_51 -> V_96 , V_51 -> V_254 ,
V_256 . V_79 ) ;
F_77 ( L_49 , V_114 ) ;
if ( V_114 <= 0 ) {
F_81 ( V_144 L_50 ,
...
static struct V_50 * F_146 ( const char * V_136 )
{
int V_114 ;
struct V_50 * V_51 ;
struct V_53 * V_54 ;
V_51 = F_147 ( sizeof( * V_54 ) , V_136 , F_143 ) ;
if ( ! V_51 ) {
F_68 ( L_52 , V_136 ) ;
return NULL ;
}
...
V_54 -> V_51 = V_51 ;
F_148 ( & V_54 -> V_164 , F_102 ) ;
F_149 ( & V_54 -> V_58 ) ;
V_54 -> V_122 = F_150 ( V_275 | V_276 , V_123 ) ;
if ( ! V_54 -> V_122 ) {
F_151 ( V_51 ) ;
return NULL ;
}
V_54 -> V_43 = F_152 ( V_54 -> V_122 ) ;
V_114 = F_153 ( V_51 ) ;
if ( V_114 ) {
F_68 ( L_53 , V_51 -> V_136 , V_114 ) ;
F_154 ( V_54 -> V_122 , V_123 ) ;
F_151 ( V_51 ) ;
return NULL ;
}
V_114 = F_140 ( V_51 ) ;
...
{
int V_2 ;
for ( V_2 = 0 ; V_2 < V_277 ; V_2 ++ ) {
if ( V_278 [ V_2 ] ) {
struct V_50 * V_51 = V_278 [ V_2 ] ;
struct V_53 * V_54 = F_28 ( V_51 ) ;
F_155 ( V_51 ) ;
...
static int T_17 F_158 ( char * V_279 )
{
int V_280 = F_159 ( V_279 , & V_131 ) ;
if ( V_280 != 0 ) {
F_49 ( L_55 ,
V_279 ) ;
} else {
