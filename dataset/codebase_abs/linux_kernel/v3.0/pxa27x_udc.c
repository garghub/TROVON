...
static void F_98 ( struct V_4 * V_5 , int V_196 )
{
if ( V_196 ) {
if ( F_99 ( V_5 -> V_197 -> V_198 ) )
F_100 ( V_5 -> V_197 -> V_198 ,
! V_5 -> V_197 -> V_199 ) ;
if ( V_5 -> V_197 -> V_200 )
V_5 -> V_197 -> V_200 ( V_201 ) ;
} else {
if ( F_99 ( V_5 -> V_197 -> V_198 ) )
F_100 ( V_5 -> V_197 -> V_198 ,
V_5 -> V_197 -> V_199 ) ;
if ( V_5 -> V_197 -> V_200 )
V_5 -> V_197 -> V_200 ( V_202 ) ;
}
V_5 -> V_203 = V_196 ;
}
static int F_101 ( struct V_204 * V_205 )
{
struct V_4 * V_5 = F_102 ( V_205 ) ;
return ( F_3 ( V_5 , V_38 ) & 0x7ff ) ;
}
static int F_103 ( struct V_204 * V_205 )
{
struct V_4 * V_5 = F_102 ( V_205 ) ;
...
{
int V_207 ;
V_207 = ( ( V_5 -> V_203 ) && ( V_5 -> V_11 ) ) ;
V_207 &= ( ( V_5 -> V_208 ) || ( ! V_5 -> V_209 ) ) ;
return V_207 ;
}
static int F_105 ( struct V_4 * V_5 )
{
int V_210 ;
V_210 = ( ( ! V_5 -> V_203 ) || ( ! V_5 -> V_11 ) ) ;
V_210 |= ( ( ! V_5 -> V_208 ) && ( V_5 -> V_209 ) ) ;
return V_210 ;
}
static int F_106 ( struct V_204 * V_205 , int V_211 )
{
struct V_4 * V_5 = F_102 ( V_205 ) ;
if ( ! F_99 ( V_5 -> V_197 -> V_198 ) && ! V_5 -> V_197 -> V_200 )
return - V_112 ;
F_98 ( V_5 , V_211 ) ;
if ( F_104 ( V_5 ) )
F_107 ( V_5 ) ;
...
static int F_109 ( struct V_204 * V_205 , int V_211 )
{
struct V_4 * V_5 = F_102 ( V_205 ) ;
V_5 -> V_208 = V_211 ;
if ( F_104 ( V_5 ) )
...
static int F_110 ( struct V_204 * V_205 , unsigned V_212 )
{
struct V_4 * V_5 ;
V_5 = F_102 ( V_205 ) ;
if ( V_5 -> V_209 )
return F_111 ( V_5 -> V_209 , V_212 ) ;
return - V_112 ;
}
...
int V_48 ;
struct V_44 * V_45 ;
F_53 ( & V_90 -> V_78 . V_214 ) ;
F_53 ( & V_90 -> V_78 . V_215 -> V_214 ) ;
...
for ( V_48 = 1 ; V_48 < V_104 ; V_48 ++ )
F_61 ( & V_90 -> V_91 [ V_48 ] . V_138 . V_214 ,
& V_90 -> V_78 . V_214 ) ;
}
...
int F_118 ( struct V_221 * V_11 ,
int (* F_119)( struct V_204 * ) )
{
struct V_4 * V_5 = V_222 ;
int V_223 ;
if ( ! V_11 || V_11 -> V_173 < V_216 || ! F_119
...
F_98 ( V_5 , 1 ) ;
V_223 = F_120 ( & V_5 -> V_78 . V_90 ) ;
if ( V_223 ) {
F_19 ( V_5 -> V_90 , L_72 , V_223 ) ;
goto V_227;
}
V_223 = F_119 ( & V_5 -> V_78 ) ;
if ( V_223 ) {
F_19 ( V_5 -> V_90 , L_73 ,
V_11 -> V_11 . V_16 , V_223 ) ;
goto V_228;
}
F_50 ( V_5 -> V_90 , L_74 ,
V_11 -> V_11 . V_16 ) ;
if ( V_5 -> V_209 ) {
V_223 = F_121 ( V_5 -> V_209 , & V_5 -> V_78 ) ;
if ( V_223 ) {
F_19 ( V_5 -> V_90 , L_75 ) ;
goto V_229;
}
...
static void F_123 ( struct V_4 * V_5 , struct V_221 * V_11 )
{
int V_48 ;
...
int F_124 ( struct V_221 * V_11 )
{
struct V_4 * V_5 = V_222 ;
if ( ! V_5 )
return - V_10 ;
if ( ! V_11 || V_11 != V_5 -> V_11 || ! V_11 -> V_230 )
return - V_172 ;
F_123 ( V_5 , V_11 ) ;
F_108 ( V_5 ) ;
F_98 ( V_5 , 0 ) ;
...
if ( F_59 ( F_37 ( V_45 ) ) )
goto V_237;
V_234 . V_233 [ V_48 ] = F_9 ( V_45 , V_156 ) ;
}
V_235 = ! F_37 ( V_45 ) ;
while ( ! F_37 ( V_45 ) ) {
V_48 = F_9 ( V_45 , V_156 ) ;
...
F_42 ( V_45 , L_78 ,
V_234 . V_232 . V_238 , V_234 . V_232 . V_239 ,
F_96 ( V_234 . V_232 . V_240 ) , F_96 ( V_234 . V_232 . V_241 ) ,
F_96 ( V_234 . V_232 . V_242 ) ) ;
if ( F_59 ( V_235 ) )
goto V_237;
if ( V_234 . V_232 . V_238 & V_150 )
F_40 ( V_5 , V_181 ) ;
else
F_40 ( V_5 , V_182 ) ;
F_33 ( V_45 , V_57 | V_63 ) ;
F_66 ( & V_45 -> V_148 , V_145 ) ;
V_48 = V_5 -> V_11 -> V_225 ( & V_5 -> V_78 , & V_234 . V_232 ) ;
F_69 ( & V_45 -> V_148 , V_145 ) ;
if ( V_48 < 0 )
goto V_237;
V_12:
...
F_42 ( V_45 , L_79 ,
F_9 ( V_45 , V_56 ) , V_48 ) ;
F_33 ( V_45 , V_59 | V_243 ) ;
F_40 ( V_5 , V_189 ) ;
goto V_12;
}
static void F_127 ( struct V_4 * V_5 , int V_244 , int V_245 )
{
T_1 V_246 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
V_246 = F_9 ( V_45 , V_56 ) ;
F_42 ( V_45 , L_80 ,
F_41 ( V_5 ) , V_47 , V_246 , F_9 ( V_45 , V_69 ) ,
( V_244 << 1 | V_245 ) ) ;
if ( V_246 & V_60 ) {
F_42 ( V_45 , L_81 ) ;
F_74 ( V_45 , - V_247 ) ;
...
static void F_130 ( int V_255 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
T_1 V_256 = F_3 ( V_5 , V_36 ) & V_257 ;
T_1 V_258 = F_3 ( V_5 , V_37 ) & V_259 ;
if ( V_256 & V_260 ) {
V_5 -> V_44 [ 0 ] . V_39 . V_68 ++ ;
F_29 ( V_5 , V_36 , F_131 ( 0 , V_260 ) ) ;
F_127 ( V_5 , ! ! ( V_256 & V_261 ) ,
! ! ( V_256 & V_262 ) ) ;
}
V_256 >>= 2 ;
for ( V_48 = 1 ; V_256 != 0 && V_48 < 16 ; V_256 >>= 2 , V_48 ++ ) {
if ( ! ( V_256 & V_260 ) )
continue;
F_29 ( V_5 , V_36 , F_131 ( V_48 , V_260 ) ) ;
...
for ( V_48 = 16 ; V_258 != 0 && V_48 < 24 ; V_258 >>= 2 , V_48 ++ ) {
F_29 ( V_5 , V_37 , F_131 ( V_48 - 16 , V_260 ) ) ;
if ( ! ( V_258 & V_260 ) )
continue;
F_56 ( V_48 >= F_132 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_132 ( V_5 -> V_44 ) ) {
...
V_5 -> V_39 . V_41 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_264 )
V_5 -> V_11 -> V_264 ( & V_5 -> V_78 ) ;
F_43 ( V_5 ) ;
}
...
V_5 -> V_39 . V_42 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_266 )
V_5 -> V_11 -> V_266 ( & V_5 -> V_78 ) ;
}
static void F_135 ( struct V_4 * V_5 )
{
unsigned V_92 , V_93 , V_98 , V_267 ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
F_29 ( V_5 , V_37 , V_268 ) ;
V_5 -> V_39 . V_43 ++ ;
...
memset ( & V_5 -> V_39 , 0 , sizeof V_5 -> V_39 ) ;
F_74 ( V_45 , - V_236 ) ;
F_33 ( V_45 , V_243 | V_63 ) ;
F_43 ( V_5 ) ;
}
static T_5 F_137 ( int V_255 , void * V_270 )
{
struct V_4 * V_5 = V_270 ;
T_1 V_256 = F_3 ( V_5 , V_36 ) ;
T_1 V_258 = F_3 ( V_5 , V_37 ) ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
T_1 V_271 ;
F_138 ( V_5 -> V_90 , L_88
L_89 , V_256 , V_258 , V_109 ) ;
V_271 = V_258 & 0xf8000000 ;
if ( F_59 ( V_271 & V_263 ) )
F_133 ( V_5 ) ;
if ( F_59 ( V_271 & V_265 ) )
F_134 ( V_5 ) ;
...
if ( F_59 ( V_271 & V_269 ) )
F_136 ( V_5 ) ;
if ( ( V_256 & V_257 ) | ( V_258 & V_259 ) )
F_130 ( V_255 , V_5 ) ;
return V_272 ;
}
static int T_2 F_139 ( struct V_273 * V_274 )
{
struct V_275 * V_276 ;
struct V_4 * V_5 = & V_277 ;
int V_223 = 0 , V_278 ;
V_276 = F_140 ( V_274 , V_279 , 0 ) ;
if ( ! V_276 )
return - V_280 ;
V_5 -> V_255 = F_141 ( V_274 , 0 ) ;
if ( V_5 -> V_255 < 0 )
return V_5 -> V_255 ;
V_5 -> V_90 = & V_274 -> V_90 ;
V_5 -> V_197 = V_274 -> V_90 . V_281 ;
V_5 -> V_209 = F_142 () ;
V_278 = V_5 -> V_197 -> V_198 ;
if ( F_99 ( V_278 ) ) {
V_223 = F_143 ( V_278 , L_90 ) ;
if ( V_223 == 0 )
F_144 ( V_278 ,
V_5 -> V_197 -> V_199 ) ;
}
if ( V_223 ) {
F_19 ( & V_274 -> V_90 , L_91 ,
V_278 , V_223 ) ;
return V_223 ;
}
V_5 -> V_213 = F_145 ( & V_274 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_213 ) ) {
V_223 = F_146 ( V_5 -> V_213 ) ;
goto V_282;
}
V_223 = - V_283 ;
V_5 -> V_276 = F_147 ( V_276 -> V_284 , F_148 ( V_276 ) ) ;
if ( ! V_5 -> V_276 ) {
F_19 ( & V_274 -> V_90 , L_92 ) ;
goto V_285;
}
F_149 ( & V_5 -> V_78 . V_90 ) ;
V_5 -> V_78 . V_90 . V_286 = & V_274 -> V_90 ;
V_5 -> V_78 . V_90 . V_287 = NULL ;
V_5 -> V_208 = 0 ;
V_222 = V_5 ;
F_150 ( V_274 , V_5 ) ;
F_113 ( V_5 ) ;
F_49 ( V_5 ) ;
V_223 = F_151 ( V_5 -> V_255 , F_137 ,
V_288 , V_14 , V_5 ) ;
if ( V_223 != 0 ) {
F_19 ( V_5 -> V_90 , L_93 ,
V_14 , V_289 , V_223 ) ;
...
static int T_6 F_154 ( struct V_273 * V_270 )
{
struct V_4 * V_5 = F_155 ( V_270 ) ;
int V_278 = V_5 -> V_197 -> V_198 ;
F_124 ( V_5 -> V_11 ) ;
F_156 ( V_5 -> V_255 , V_5 ) ;
F_20 ( V_5 ) ;
if ( F_99 ( V_278 ) )
...
static void F_159 ( struct V_273 * V_270 )
{
struct V_4 * V_5 = F_155 ( V_270 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_108 ( V_5 ) ;
}
static int F_160 ( struct V_273 * V_270 , T_7 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_155 ( V_270 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
V_5 -> V_246 = F_9 ( V_45 , V_56 ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_291 = F_9 ( V_45 , V_56 ) ;
V_45 -> V_292 = F_9 ( V_45 , V_17 ) ;
F_42 ( V_45 , L_94 ,
V_45 -> V_291 , V_45 -> V_292 ) ;
}
F_108 ( V_5 ) ;
V_5 -> V_293 = V_5 -> V_203 ;
F_98 ( V_5 , 0 ) ;
...
static int F_161 ( struct V_273 * V_270 )
{
int V_48 ;
struct V_4 * V_5 = F_155 ( V_270 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
F_35 ( V_45 , V_56 , V_5 -> V_246 & ( V_59 | V_61 ) ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
F_35 ( V_45 , V_56 , V_45 -> V_291 ) ;
F_35 ( V_45 , V_17 , V_45 -> V_292 ) ;
F_42 ( V_45 , L_94 ,
V_45 -> V_291 , V_45 -> V_292 ) ;
}
F_98 ( V_5 , V_5 -> V_293 ) ;
...
if ( ! F_164 () && ! F_165 () )
return - V_10 ;
F_166 ( V_294 L_95 , V_14 , V_15 ) ;
return F_167 ( & V_295 , F_139 ) ;
}
