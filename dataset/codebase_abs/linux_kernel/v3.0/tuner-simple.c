...
const struct V_142 * V_39 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
switch ( V_4 -> type ) {
case V_88 :
case V_89 :
if ( V_39 -> V_143 . V_144 . V_140 == V_145 &&
V_39 -> V_41 >= 158870000 )
V_141 [ 3 ] |= 0x08 ;
break;
case V_146 :
V_141 [ 3 ] |= ( V_39 -> V_41 < 161000000 ) ? 1 :
( V_39 -> V_41 < 444000000 ) ? 2 : 4 ;
if ( V_39 -> V_143 . V_144 . V_140 == V_145 )
V_141 [ 3 ] |= 1 << 3 ;
break;
case V_47 :
...
unsigned int V_147 ;
if ( V_148 [ V_4 -> V_78 ] )
V_147 = V_148 [ V_4 -> V_78 ] ;
else
switch ( V_39 -> V_143 . V_149 . V_150 ) {
case V_151 :
case V_152 :
V_147 = 1 ;
break;
...
F_13 ( V_2 , & V_141 [ 2 ] , & V_141 [ 3 ] , V_147 ) ;
break;
}
default:
break;
...
if ( V_135 < 0 )
return 0 ;
div = ( ( V_41 + V_40 -> V_155 ) * 62500 + V_98 +
V_36 -> V_154 / 2 ) / V_36 -> V_154 ;
V_141 [ 0 ] = div >> 8 ;
V_141 [ 1 ] = div & 0xff ;
V_141 [ 2 ] = V_42 ;
V_141 [ 3 ] = V_43 ;
...
return ( div * V_36 -> V_154 ) - V_40 -> V_155 ;
}
...
if ( V_156 < 5 )
return - V_22 ;
V_41 = F_30 ( V_2 , V_141 + 1 , V_39 ) ;
if ( V_41 == 0 )
return - V_22 ;
V_141 [ 0 ] = V_4 -> V_7 . V_76 ;
V_4 -> V_41 = V_41 ;
V_4 -> V_140 = ( V_2 -> V_157 . V_158 . type == V_159 ) ?
V_39 -> V_143 . V_144 . V_140 : 0 ;
return 5 ;
}
...
V_160 = V_4 -> V_41 ;
V_161 = V_4 -> V_140 ;
V_135 = F_31 ( V_2 , V_39 , V_141 , 5 ) ;
if ( V_135 != 5 )
goto V_162;
if ( V_2 -> V_157 . V_163 . V_164 )
V_2 -> V_157 . V_163 . V_164 ( V_2 ) ;
if ( V_2 -> V_157 . V_165 )
V_2 -> V_157 . V_165 ( V_2 , 1 ) ;
...
T_3 V_176 [ 1 ] ;
struct V_177 V_178 = {
. V_76 = V_171 , . V_179 = V_180 ,
. V_141 = V_176 , . V_181 = 1 ,
} ;
if ( V_2 -> V_157 . V_165 )
V_2 -> V_157 . V_165 ( V_2 , 1 ) ;
if ( 1 != F_43 ( V_170 , & V_178 , 1 ) )
F_42 ( V_174 L_34
L_35 ,
F_44 ( V_170 ) , V_171 ,
V_182 [ type ] . V_27 ) ;
if ( V_2 -> V_157 . V_165 )
V_2 -> V_157 . V_165 ( V_2 , 0 ) ;
}
F_36 ( & V_168 ) ;
V_172 = F_45 ( struct V_3 , V_4 ,
V_183 ,
V_170 , V_171 ,
L_36 ) ;
switch ( V_172 ) {
...
F_46 ( L_42
L_41 ,
V_4 -> V_78 , V_148 [ V_4 -> V_78 ] ) ;
}
F_47 ( V_2 -> V_157 . V_185 . V_158 . V_27 , V_4 -> V_36 -> V_27 ,
sizeof( V_2 -> V_157 . V_185 . V_158 . V_27 ) ) ;
return V_2 ;
}
