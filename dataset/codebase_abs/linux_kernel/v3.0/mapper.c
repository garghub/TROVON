...
if ( ! F_16 ( V_2 , V_48 , V_72 , V_13 ) ) {
while ( 1 ) {
V_74 [ ++ V_76 ] = V_72 ;
if ( V_72 >= 0 )
V_72 = V_2 -> V_90 [ V_72 ] ;
else
V_72 = V_2 -> V_91 [ - 1 - V_72 ] ;
if ( V_72 == 0 )
break;
}
}
}
for ( V_87 = 0 ; V_87 < V_86 -> V_92 ; V_87 ++ ) {
V_53 = 0 ;
switch ( V_86 -> V_93 [ V_87 ] . V_94 ) {
case V_95 :
V_29 [ 0 ] = V_86 -> V_93 [ V_87 ] . V_96 ;
if ( V_76 >= 0 ) {
