...
goto V_40;
V_25 = - V_48 ;
for ( V_47 = F_28 ( V_6 ) -> V_49 - 1 ; V_47 >= 0 ; V_47 -- )
if ( F_7 ( V_4 ) -> V_16 [ V_47 ] )
goto V_50;
V_25 = 0 ;
V_50:
F_8 ( V_4 ) ;
...
T_1
F_32 ( struct V_5 * V_6 , struct V_3 * V_4 )
{
...
void
F_33 ( T_3 V_62 , struct V_63 * V_64 )
{
T_1 V_65 ;
T_1 V_66 ;
...
void
F_37 ( struct V_5 * V_6 , const char * V_93 , const char * V_94 , ... )
{
T_5 args ;
va_start ( args , V_94 ) ;
vsnprintf ( V_95 , sizeof( V_95 ) , V_94 , args ) ;
va_end ( args ) ;
F_38 ( V_96 L_5 , V_6 -> V_97 ,
V_93 , V_95 ) ;
if ( ! ( V_6 -> V_98 & V_99 ) )
F_38 ( V_100 L_6 ) ;
V_6 -> V_98 |= V_99 ;
...
vsnprintf ( V_95 , sizeof( V_95 ) , V_94 , args ) ;
va_end ( args ) ;
F_38 ( V_100 L_7 , V_6 -> V_97 ,
V_93 , V_95 ) ;
}
int
F_40 ( const unsigned char * V_13 , int V_101 )
{
int V_102 ;
if ( V_101 > 30 )
#ifdef F_41
...
int
F_42 ( unsigned char * V_105 , struct V_27 * V_27 )
{
int V_101 = F_43 ( V_27 -> V_106 . V_101 , 30u ) ;
* V_105 ++ = V_101 ;
