...
T_2 long long F_42 ( struct V_9 * V_10 )
{
long long V_30 = 0 ;
F_43 ( V_10 -> V_10 [ 9 ] ) ;
if ( F_44 ( V_60 ) &&
...
V_30 = - 1LL ;
if ( F_46 ( F_44 ( V_61 ) ) )
F_47 ( V_10 , V_10 -> V_10 [ 9 ] ) ;
if ( F_46 ( V_62 -> V_63 ) )
F_48 ( F_39 () , V_10 -> V_10 [ 1 ] ,
V_10 -> V_10 [ 2 ] , V_10 -> V_10 [ 3 ] ,
V_10 -> V_10 [ 4 ] , V_10 -> V_10 [ 5 ] ) ;
return V_30 ? : V_10 -> V_10 [ 9 ] ;
}
T_2 void F_49 ( struct V_9 * V_10 )
{
int V_64 ;
if ( F_46 ( V_62 -> V_63 ) )
F_50 ( F_51 ( V_10 -> V_10 [ 9 ] ) ,
V_10 -> V_10 [ 9 ] ) ;
if ( F_46 ( F_44 ( V_61 ) ) )
F_52 ( V_10 , V_10 -> V_10 [ 9 ] ) ;
V_64 = F_44 ( V_22 ) ;
if ( V_64 || F_44 ( V_60 ) )
F_53 ( V_10 , V_64 ) ;
}
T_2 void F_54 ( unsigned long long V_65 , struct V_9 * V_10 )
{
F_55 () ;
V_10 -> V_16 &= ~ V_21 ;
F_56 ( V_66 , V_62 ) ;
}
void F_57 ( struct V_1 * V_20 )
{
F_13 ( V_20 ) ;
}
