...
V_9 -> V_45 = ( V_43 . V_46 - V_43 . V_44 + 1 ) >> V_18 ;
V_9 -> V_47 = V_9 -> V_20 + V_9 -> V_45 - 1 ;
V_9 -> V_48 = V_49 ;
V_9 -> V_50 = V_51 ;
F_2 ( V_2 -> V_15 ,
L_7
...
static int T_2 F_15 ( struct V_52 * V_53 )
{
struct V_54 T_3 * V_24 ;
struct V_1 * V_2 ;
struct V_5 * V_6 ;
T_1 V_55 ;
int V_56 , V_17 ;
V_24 = F_16 ( F_17 ( V_53 -> V_57 ) ) ;
if ( V_24 == NULL )
return - V_58 ;
V_59 = V_60 ;
V_55 = F_7 ( & V_24 -> V_61 ) ;
F_2 ( & V_53 -> V_15 , L_9 , V_55 ) ;
V_17 = 0 ;
if ( V_55 & V_62 )
V_17 |= 0x1 ;
if ( V_55 & V_63 )
...
F_2 ( & V_53 -> V_15 , L_11 ,
F_7 ( & V_24 -> V_25 ) ) ;
V_2 = F_19 ( sizeof( struct V_5 ) , 1 ,
V_17 == 3 ? 2 : 1 , V_53 -> V_57 ) ;
if ( V_2 == NULL )
return - V_64 ;
V_6 = V_2 -> V_7 ;
V_6 -> V_24 = V_24 ;
...
static int T_4 F_23 ( struct V_52 * V_53 )
{
struct V_1 * V_2 = F_24 ( & V_53 -> V_15 ) ;
if ( V_2 )
F_22 ( V_2 ) ;
return 0 ;
}
