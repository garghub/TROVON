...
static int F_65 ( T_4 * V_128 , int V_129 , T_3 V_83 ,
T_3 V_82 , const void * V_29 )
{
struct V_11 * V_12 = V_128 -> V_42 ;
T_3 V_84 ;
struct V_2 * V_3 ;
if ( V_82 == 0 )
return - V_113 ;
...
static int F_67 ( T_4 * V_128 , int V_129 , T_3 V_83 ,
unsigned V_134 , T_3 * V_82 , void * V_10 )
{
struct V_11 * V_12 = V_128 -> V_42 ;
struct V_2 * V_3 ;
if ( ( V_134 < 0 ) || ( V_134 % 2 ) )
...
static int F_68 ( T_4 * V_128 , T_3 V_135 , T_3 V_136 , T_3 V_137 ,
...
V_3 = F_16 ( V_12 , V_141 , V_130 ) ;
if ( ! V_3 )
return - V_131 ;
return F_60 ( V_12 , V_3 , sizeof( V_29 ) , & V_29 ,
V_133 , NULL , 0 , NULL ) ;
}
static int F_69 ( T_4 * V_128 , T_3 V_135 , T_3 V_136 ,
struct V_139 * V_140 )
{
struct V_11 * V_12 = V_128 -> V_42 ;
struct V_2 * V_3 ;
...
static int F_70 ( struct V_142 * V_128 , int V_129 ,
...
static int F_72 ( struct V_142 * V_128 , T_5 * V_147 ,
T_6 V_148 , T_3 V_149 )
{
struct V_11 * V_12 = V_128 -> V_42 ;
struct V_2 * V_3 ;
...
V_147 [ 1 ] = F_50 ( 0x0800 ) ;
return F_60 ( V_12 , V_3 , sizeof( V_29 ) , & V_29 ,
V_133 , & V_147 [ 2 ] , V_149 - 4 ,
NULL ) ;
}
static int F_73 ( struct V_142 * V_128 , T_6 V_151 )
{
struct V_11 * V_12 = V_128 -> V_42 ;
struct V_2 * V_3 ;
T_7 V_29 = F_74 ( V_151 ) ;
V_3 = F_16 ( V_12 , V_152 , V_130 ) ;
if ( ! V_3 )
return - V_131 ;
return F_60 ( V_12 , V_3 , sizeof( V_29 ) , & V_29 ,
V_133 , NULL , 0 , NULL ) ;
}
static int F_75 ( struct V_142 * V_128 )
{
struct V_11 * V_12 = V_128 -> V_42 ;
struct V_2 * V_3 ;
V_3 = F_16 ( V_12 , V_153 , V_130 ) ;
if ( ! V_3 )
return - V_131 ;
return F_60 ( V_12 , V_3 , 0 , NULL ,
V_133 , NULL , 0 , NULL ) ;
}
static int F_76 ( struct V_142 * V_128 , const char * V_10 ,
T_6 V_108 , T_6 V_143 )
{
struct V_11 * V_12 = V_128 -> V_42 ;
struct V_2 * V_3 ;
...
if ( F_31 )
return F_31 ;
V_3 = F_16 ( V_12 , V_155 , V_130 ) ;
if ( ! V_3 )
return - V_131 ;
return F_60 ( V_12 , V_3 , V_143 , V_10 ,
V_133 , NULL , 0 , NULL ) ;
}
static int F_77 ( struct V_142 * V_128 , const char * V_10 ,
T_6 V_108 , T_6 V_143 )
{
T_6 V_156 ;
T_6 V_157 ;
...
F_31 = F_76 ( V_128 , & V_10 [ V_156 - V_108 ] ,
V_156 , V_157 ) ;
if ( F_31 )
break;
V_156 += V_157 ;
...
static T_8 F_79 ( struct V_159 * V_160 , struct V_40 * V_39 )
{
struct V_41 * V_42 = F_29 ( V_39 ) ;
struct V_43 * V_44 = & V_42 -> V_44 ;
...
static int F_91 ( struct V_142 * V_128 , T_3 V_88 , T_3 * V_183 )
{
* V_183 = V_38 ;
return 0 ;
}
...
F_5 ( ! V_12 ) ;
V_12 -> V_68 = 0 ;
F_95 ( V_128 , V_185 , V_186 ) ;
F_95 ( V_128 , V_187 , V_146 ) ;
F_96 ( V_12 -> V_92 ) ;
F_52 ( V_12 ) ;
V_90 = F_65 ( V_128 , 0 , V_188 ,
F_51 ( 2 ) , L_43 ) ;
if ( V_90 < 0 ) {
F_59 (KERN_ERR PFX L_44 , retval) ;
return V_90 ;
}
V_90 = F_69 ( V_128 , V_189 , 0 , NULL ) ;
if ( V_90 < 0 ) {
...
static void F_107 ( T_9 * V_199 ,
unsigned long * V_32 ) __acquires( V_199 )
{
F_62 ( V_199 ) ;
}
static void F_108 ( T_9 * V_199 ,
unsigned long * V_32 ) __releases( V_199 )
{
F_63 ( V_199 ) ;
}
static void F_109 ( T_9 * V_199 ) __acquires( V_199 )
{
F_62 ( V_199 ) ;
}
static void F_110 ( T_9 * V_199 ) __releases( V_199 )
{
F_63 ( V_199 ) ;
}
...
F_116 ( & V_12 -> V_48 ) ;
V_12 -> V_15 = V_15 ;
V_128 -> V_210 = ( void V_211 V_212 * ) & V_12 -> V_213 ;
V_128 -> V_214 = V_215 ;
V_128 -> V_42 = V_12 ;
V_128 -> V_216 = & V_217 ;
