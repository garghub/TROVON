...
struct V_5 * V_163 ;
long V_164 ;
V_6 = F_52 ( V_159 , struct V_1 , V_165 ) ;
V_163 = F_53 ( F_54 ( V_6 -> V_27 ) ) ;
V_164 = V_6 -> V_23 - F_55 ( V_6 -> V_22 ) ;
if ( ( V_95 == V_166 && V_164 > 0 ) ||
( V_95 == V_167 && V_164 < 0 ) ) {
...
{
V_6 -> V_165 . V_168 = F_51 ;
return F_57 ( & V_6 -> V_165 ,
V_169 ) ;
}
...
static int T_4 F_60 ( struct V_170 * V_171 ,
enum V_172 V_3 )
{
struct V_1 * V_6 ;
struct V_29 * V_30 ;
...
V_152 = F_61 ( V_171 , 0 ) ;
if ( V_152 < 0 ) {
F_11 ( & V_171 -> V_27 , L_35 ) ;
return - V_177 ;
}
V_163 = F_62 ( sizeof( struct V_1 ) , & V_171 -> V_27 ) ;
if ( ! V_163 )
return - V_129 ;
F_63 ( V_171 , V_163 ) ;
V_6 = V_163 -> V_10 ;
V_6 -> V_27 = & V_171 -> V_27 ;
V_6 -> V_3 = V_3 ;
V_174 = F_64 ( V_171 , V_178 , 0 ) ;
if ( V_174 == NULL ) {
F_11 ( & V_171 -> V_27 , L_36 ) ;
V_175 = - V_179 ;
goto V_180;
}
V_176 = F_65 ( V_174 ) ;
V_6 -> V_181 = F_66 ( V_174 -> V_182 , V_176 , V_171 -> V_183 ) ;
if ( V_6 -> V_181 == NULL ) {
F_11 ( & V_171 -> V_27 , L_37 ) ;
V_175 = - V_177 ;
goto V_180;
}
V_6 -> V_12 = F_67 ( V_174 -> V_182 , V_176 ) ;
if ( V_6 -> V_12 == NULL ) {
F_11 ( & V_171 -> V_27 , L_38 ) ;
V_175 = - V_179 ;
goto V_184;
}
V_6 -> V_98 = V_6 -> V_12 + ( ( V_3 == V_4 ) ? V_185 : V_186 ) ;
F_5 ( L_39 ) ;
strcpy ( V_163 -> V_13 . V_187 , V_188 ) ;
V_51 = F_30 ( V_6 -> V_12 + V_85 ) ;
F_6 ( V_51 & ~ V_84 , V_6 -> V_12 + V_85 ) ;
V_163 -> V_13 . type = V_189 ;
V_163 -> V_13 . V_190 = 0 ;
V_163 -> V_13 . V_191 = 0 ;
V_163 -> V_13 . V_192 = 0 ;
V_163 -> V_13 . V_193 = 0 ;
V_163 -> V_13 . V_194 = V_195 ;
V_163 -> V_16 . V_196 = 0 ;
V_163 -> V_16 . V_197 = V_198 ;
V_163 -> V_16 . V_199 = 0 ;
V_163 -> V_16 . V_200 = V_201 ;
V_163 -> V_202 = & V_203 ;
V_163 -> V_96 = V_204 ;
V_163 -> V_107 = & V_6 -> V_205 ;
for ( V_33 = 0 ; V_33 < 256 ; V_33 ++ )
V_6 -> V_99 [ V_33 ] = V_151 ;
V_175 = F_68 ( V_152 , F_50 , V_206 , V_171 -> V_183 , V_6 ) ;
if ( V_175 ) {
F_11 ( & V_171 -> V_27 , L_40 , V_152 , V_175 ) ;
V_175 = - V_207 ;
goto V_208;
}
...
V_126 >>= 3 ;
if ( V_163 -> V_13 . V_126 < V_126 )
V_163 -> V_13 . V_126 = V_126 ;
}
V_175 = F_41 ( V_163 ) ;
if ( V_175 ) {
F_40 ( V_209 L_44 , V_175 ) ;
V_175 = - V_129 ;
goto V_211;
}
F_5 ( L_45 ) ;
V_163 -> V_16 . V_34 = V_30 -> V_34 ;
V_163 -> V_16 . V_17 = V_30 -> V_17 ;
V_163 -> V_16 . V_35 = V_30 -> V_36 ;
F_47 ( V_163 ) ;
F_9 ( & V_163 -> V_16 , V_163 ) ;
V_175 = F_56 ( V_6 ) ;
if ( V_175 < 0 ) {
F_11 ( & V_171 -> V_27 , L_46 ) ;
goto V_212;
}
V_175 = F_74 ( V_163 ) ;
if ( V_175 < 0 ) {
...
V_175 = F_75 ( & V_171 -> V_27 , & V_214 ) ;
if ( V_175 ) {
F_40 ( V_209 L_48 ) ;
}
F_40 ( V_215 L_49 ,
V_163 -> V_216 , V_163 -> V_13 . V_187 ) ;
return 0 ;
V_213:
F_58 ( V_6 ) ;
V_212:
...
F_79 ( V_6 -> V_12 ) ;
V_184:
F_80 ( V_174 -> V_182 , V_176 ) ;
V_180:
F_63 ( V_171 , NULL ) ;
F_81 ( V_163 ) ;
return V_175 ;
}
static int T_4 F_82 ( struct V_170 * V_171 )
{
return F_60 ( V_171 , V_217 ) ;
}
static int T_4 F_83 ( struct V_170 * V_171 )
{
return F_60 ( V_171 , V_4 ) ;
}
static int T_7 F_84 ( struct V_170 * V_171 )
{
struct V_5 * V_163 = F_53 ( V_171 ) ;
struct V_1 * V_6 = V_163 -> V_10 ;
int V_152 ;
F_85 ( V_163 ) ;
F_58 ( V_6 ) ;
F_35 ( V_6 , 0 ) ;
...
F_78 ( V_152 , V_6 ) ;
F_79 ( V_6 -> V_12 ) ;
F_80 ( V_6 -> V_181 -> V_182 , F_65 ( V_6 -> V_181 ) ) ;
F_63 ( V_171 , NULL ) ;
F_81 ( V_163 ) ;
return 0 ;
}
static int F_86 ( struct V_170 * V_27 , T_8 V_218 )
{
struct V_5 * V_163 = F_53 ( V_27 ) ;
struct V_1 * V_6 = V_163 -> V_10 ;
F_35 ( V_6 , 0 ) ;
F_73 ( 1 ) ;
F_76 ( V_6 -> V_22 ) ;
...
static int F_87 ( struct V_170 * V_27 )
{
struct V_5 * V_163 = F_53 ( V_27 ) ;
struct V_1 * V_6 = V_163 -> V_10 ;
F_72 ( V_6 -> V_22 ) ;
