...
F_35 ( V_43 , & V_3 -> V_68 , & V_3 -> V_15 . V_26 ) ;
if ( V_3 -> V_68 . V_69 == NULL ) {
V_42 = - V_70 ;
goto V_67;
}
return 0 ;
V_67:
V_3 -> V_15 . V_26 . V_71 ( & V_3 -> V_15 . V_26 , & V_3 -> V_63 ) ;
V_65:
V_3 -> V_15 . V_26 . V_71 ( & V_3 -> V_15 . V_26 , & V_3 -> V_58 ) ;
V_62:
F_36 ( & V_3 -> V_56 ) ;
V_57:
F_37 ( & V_3 -> V_15 ) ;
...
V_34 = F_5 ( V_74 , struct V_76 , V_78 ) ;
V_77 = F_31 ( & V_72 -> V_43 , & V_34 -> V_3 ) ;
if ( V_77 < 0 ) {
F_30 ( V_44 L_13 ,
V_34 -> V_3 . V_32 , V_77 ) ;
goto V_7;
...
void F_43 ( struct V_33 * V_72 )
{
F_44 ( V_72 ) ;
F_45 ( & V_72 -> V_43 ) ;
}
struct V_76 * F_41 (
struct V_33 * V_72 , int V_79 )
{
struct V_73 * V_74 , * V_75 ;
struct V_76 * V_34 , * V_80 = NULL ;
F_19 ( & V_72 -> V_29 ) ;
F_42 (list, q, &f->felist) {
V_34 = F_5 ( V_74 , struct V_76 , V_78 ) ;
if ( V_34 -> V_79 == V_79 ) {
...
int F_46 ( struct V_33 * V_72 ,
struct V_41 * V_81 )
{
struct V_73 * V_74 , * V_75 ;
struct V_76 * V_34 = NULL ;
int V_80 = 0 ;
F_19 ( & V_72 -> V_29 ) ;
F_42 (list, q, &f->felist) {
V_34 = F_5 ( V_74 , struct V_76 , V_78 ) ;
if ( V_34 -> V_3 . V_27 == V_81 ) {
V_80 = V_34 -> V_79 ;
break;
}
}
...
{
struct V_76 * V_34 ;
V_34 = F_48 ( sizeof( struct V_76 ) , V_82 ) ;
if ( V_34 == NULL )
goto V_83;
V_34 -> V_79 = V_79 ;
F_28 ( & V_34 -> V_3 . V_29 ) ;
F_19 ( & V_72 -> V_29 ) ;
F_12 ( & V_34 -> V_78 , & V_72 -> V_78 ) ;
F_23 ( & V_72 -> V_29 ) ;
V_83:
return V_34 ;
}
void F_44 ( struct V_33 * V_72 )
{
struct V_73 * V_74 , * V_75 ;
struct V_76 * V_34 ;
F_19 ( & V_72 -> V_29 ) ;
F_42 (list, q, &f->felist) {
V_34 = F_5 ( V_74 , struct V_76 , V_78 ) ;
if ( V_34 -> V_3 . V_68 . V_69 ) {
F_49 ( & V_34 -> V_3 . V_68 ) ;
V_34 -> V_3 . V_15 . V_26 . V_71 ( & V_34 -> V_3 . V_15 . V_26 ,
& V_34 -> V_3 . V_63 ) ;
V_34 -> V_3 . V_15 . V_26 . V_71 ( & V_34 -> V_3 . V_15 . V_26 ,
& V_34 -> V_3 . V_58 ) ;
F_36 ( & V_34 -> V_3 . V_56 ) ;
