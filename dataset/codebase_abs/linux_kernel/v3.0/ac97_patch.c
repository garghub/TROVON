...
{
int V_7 ;
if ( ( V_7 = F_1 ( V_2 , V_264 , F_42 ( V_264 ) ) ) < 0 )
return V_7 ;
if ( V_2 -> V_63 & V_64 ) {
if ( ( V_7 = F_1 ( V_2 , V_265 , F_42 ( V_265 ) ) ) < 0 )
return V_7 ;
}
if ( V_2 -> V_52 != V_266 )
F_4 ( V_2 , L_47 ,
...
V_2 -> V_52 = 0x414c4723 ;
V_2 -> V_159 . V_270 = ( V_2 -> V_52 == 0x414c4722 ||
V_2 -> V_52 == 0x414c4723 ) ;
F_35 ( V_2 , V_263 ,
...
F_35 ( V_2 , V_272 , 0x0808 ) ;
F_35 ( V_2 , V_273 , 0x0808 ) ;
return 0 ;
}
...
static int F_145 ( struct V_14 * V_28 , struct V_29 * V_30 )
{
static char * V_274 [ 3 ] = { L_48 , L_49 , L_50 } ;
static char * V_275 [ 4 ] = { L_48 , L_51 , L_52 , L_50 } ;
struct V_1 * V_2 = F_14 ( V_28 ) ;
V_30 -> type = V_33 ;
V_30 -> V_5 = 1 ;
V_30 -> V_21 . V_34 . V_35 = V_2 -> V_159 . V_270 ? 4 : 3 ;
if ( V_30 -> V_21 . V_34 . V_36 >= V_30 -> V_21 . V_34 . V_35 )
V_30 -> V_21 . V_34 . V_36 = V_30 -> V_21 . V_34 . V_35 - 1 ;
strcpy ( V_30 -> V_21 . V_34 . V_10 ,
V_2 -> V_159 . V_270 ?
V_275 [ V_30 -> V_21 . V_34 . V_36 ] :
V_274 [ V_30 -> V_21 . V_34 . V_36 ] ) ;
return 0 ;
}
static int F_146 ( struct V_14 * V_28 , struct V_37 * V_38 )
{
struct V_1 * V_2 = F_14 ( V_28 ) ;
unsigned short V_47 ;
V_47 = V_2 -> V_48 [ V_261 ] ;
V_47 = ( V_47 >> 12 ) & 3 ;
if ( V_2 -> V_159 . V_270 && V_47 == 3 )
V_47 = 0 ;
V_38 -> V_21 . V_34 . V_36 [ 0 ] = V_47 ;
return 0 ;
}
static int F_147 ( struct V_14 * V_28 , struct V_37 * V_38 )
{
struct V_1 * V_2 = F_14 ( V_28 ) ;
...
{
int V_7 ;
if ( ( V_7 = F_1 ( V_2 , V_276 , F_42 ( V_276 ) ) ) < 0 )
return V_7 ;
if ( V_2 -> V_63 & V_64 ) {
if ( ( V_7 = F_1 ( V_2 , V_277 , F_42 ( V_277 ) ) ) < 0 )
return V_7 ;
}
return 0 ;
}
...
int V_281 ;
V_260 = F_21 ( V_2 ) ;
F_9 ( V_2 , V_282 , ( 1 << 4 ) | ( 1 << 5 ) ,
V_260 ? ( 1 << 5 ) : ( 1 << 4 ) ) ;
F_9 ( V_2 , V_283 , 7 << 12 ,
V_260 ? ( 2 << 12 ) : ( 0 << 12 ) ) ;
V_260 = F_22 ( V_2 ) ;
F_9 ( V_2 , V_282 , ( 1 << 12 ) | ( 1 << 13 ) ,
V_260 ? ( 1 << 12 ) : ( 1 << 13 ) ) ;
F_9 ( V_2 , V_283 , 7 << 4 ,
V_260 ? ( 5 << 4 ) : ( 1 << 4 ) ) ;
V_281 = F_25 ( V_2 ) ;
...
{
int V_7 ;
if ( ( V_7 = F_1 ( V_2 , V_285 , F_42 ( V_285 ) ) ) < 0 )
return V_7 ;
if ( V_2 -> V_63 & V_64 ) {
if ( ( V_7 = F_1 ( V_2 , V_277 , F_42 ( V_277 ) ) ) < 0 )
return V_7 ;
...
{
return F_1 ( V_2 , V_292 , F_42 ( V_292 ) ) ;
}
...
static int F_159 ( struct V_14 * V_28 , struct V_29 * V_30 )
{
...
static int F_160 ( struct V_14 * V_28 , struct V_37 * V_38 )
{
struct V_1 * V_2 = F_14 ( V_28 ) ;
unsigned short V_47 ;
V_47 = V_2 -> V_48 [ V_295 ] ;
...
static int F_161 ( struct V_14 * V_28 , struct V_37 * V_38 )
{
struct V_1 * V_2 = F_14 ( V_28 ) ;
return F_9 ( V_2 , V_295 ,
0x01 << 1 ,
...
F_9 ( V_2 , V_296 , 1 << 10 ,
F_21 ( V_2 ) ? ( 1 << 10 ) : 0 ) ;
F_9 ( V_2 , V_296 , 0x3000 ,
F_22 ( V_2 ) ? 0x1000 : 0x2000 ) ;
}
static int F_163 ( struct V_1 * V_2 )
{
return F_1 ( V_2 , V_297 , F_42 ( V_297 ) ) ;
}
static int F_164 ( struct V_1 * V_2 )
{
return F_1 ( V_2 , V_298 , F_42 ( V_298 ) ) ;
}
static int F_165 ( struct V_1 * V_2 )
{
unsigned short V_47 ;
V_2 -> V_41 = & V_299 ;
V_2 -> V_74 |= V_300 | V_294 ;
F_35 ( V_2 , V_301 , 0x8000 ) ;
F_35 ( V_2 , V_168 , 0x8000 ) ;
V_47 = F_8 ( V_2 , V_302 ) ;
if ( V_47 & V_303 ) {
F_35 ( V_2 , V_295 ,
...
{
static unsigned short V_304 [ 3 ] [ 2 ] = {
{ 0x0008 , 0x0000 } ,
{ 0x0000 , 0x0008 } ,
{ 0x0000 , 0x0008 } ,
} ;
static unsigned short V_305 [ 3 ] [ 2 ] = {
{ 0x0000 , 0x1000 } ,
{ 0x1000 , 0x0000 } ,
{ 0x0000 , 0x1000 } ,
} ;
static unsigned short V_306 [ 3 ] [ 2 ] = {
{ 0x0000 , 0x0400 } ,
{ 0x0000 , 0x0400 } ,
{ 0x0000 , 0x0400 } ,
} ;
static unsigned short V_307 [ 3 ] [ 2 ] = {
{ 0x2000 , 0x0880 } ,
{ 0x0000 , 0x2880 } ,
{ 0x2000 , 0x0800 } ,
} ;
unsigned short V_47 = 0 ;
V_47 |= V_304 [ V_2 -> V_159 . V_270 ] [ F_19 ( V_2 ) ] ;
V_47 |= V_305 [ V_2 -> V_159 . V_270 ] [ F_20 ( V_2 ) ] ;
V_47 |= V_306 [ V_2 -> V_159 . V_270 ] [ F_21 ( V_2 ) ] ;
V_47 |= V_307 [ V_2 -> V_159 . V_270 ] [ F_22 ( V_2 ) ] ;
F_9 ( V_2 , V_308 , 0x3c88 , V_47 ) ;
}
static int F_167 ( struct V_14 * V_28 , struct V_29 * V_30 )
{
...
static int F_168 ( struct V_14 * V_28 , struct V_37 * V_38 )
{
struct V_1 * V_2 = F_14 ( V_28 ) ;
if ( V_2 -> V_48 [ V_309 ] & 0x1 )
V_38 -> V_21 . V_34 . V_36 [ 0 ] = 2 ;
else if ( V_2 -> V_48 [ V_310 ] & 0x2 )
V_38 -> V_21 . V_34 . V_36 [ 0 ] = 1 ;
else
V_38 -> V_21 . V_34 . V_36 [ 0 ] = 0 ;
return 0 ;
}
static int F_169 ( struct V_14 * V_28 , struct V_37 * V_38 )
{
struct V_1 * V_2 = F_14 ( V_28 ) ;
if ( V_38 -> V_21 . V_34 . V_36 [ 0 ] == 2 )
return F_9 ( V_2 , V_309 , 0x1 , 0x1 ) ;
F_9 ( V_2 , V_309 , 0x1 , 0 ) ;
return F_9 ( V_2 , V_310 , 0x2 ,
V_38 -> V_21 . V_34 . V_36 [ 0 ] == 1 ? 0x2 : 0 ) ;
}
static int F_170 ( struct V_1 * V_2 )
{
return F_1 ( V_2 , V_311 , F_42 ( V_311 ) ) ;
}
static int F_171 ( struct V_1 * V_2 )
{
return F_1 ( V_2 , V_312 , F_42 ( V_312 ) ) ;
}
static int F_172 ( struct V_1 * V_2 )
{
unsigned short V_47 ;
V_2 -> V_74 |= V_294 ;
F_35 ( V_2 , V_301 , 0x8808 ) ;
...
V_314 = F_8 ( V_2 , 0x60 ) ;
V_2 -> V_159 . V_270 = V_314 & 1 ;
F_35 ( V_2 , V_26 , V_47 ) ;
} else if ( V_2 -> V_52 == V_315 )
V_2 -> V_159 . V_270 = 2 ;
V_2 -> V_41 = & V_316 ;
V_2 -> V_63 |= V_64 ;
F_35 ( V_2 , V_302 , 0x05c0 ) ;
F_35 ( V_2 , V_310 , 0x0001 ) ;
V_2 -> V_60 [ V_61 ] = V_62 ;
#if 0
...
{
return F_1 ( V_2 , V_317 , F_42 ( V_317 ) ) ;
}
...
static struct V_14 * F_154 ( struct V_1 * V_2 ,
const char * V_10 )
{
struct V_12 V_52 ;
...
static int F_175 ( struct V_1 * V_2 , char * V_10 ,
const unsigned int * V_11 , const char * * V_320 )
{
struct V_14 * V_15 ;
const char * * V_321 ;
int V_7 ;
V_15 = F_176 ( V_10 , V_11 ) ;
if ( ! V_15 )
return - V_322 ;
V_7 = F_2 ( V_2 -> V_8 -> V_9 , V_15 ) ;
if ( V_7 < 0 )
return V_7 ;
for ( V_321 = V_320 ; * V_321 ; V_321 ++ ) {
struct V_14 * V_323 ;
V_323 = F_154 ( V_2 , * V_321 ) ;
if ( ! V_323 ) {
F_177 ( L_63 , * V_321 ) ;
continue;
}
V_7 = F_178 ( V_15 , V_323 ) ;
if ( V_7 < 0 )
return V_7 ;
}
return 0 ;
...
int V_7 ;
if ( F_61 ( V_2 , 0x5a , 9 ) )
if ( ( V_7 = F_1 ( V_2 , & V_324 [ 0 ] , 1 ) ) < 0 )
return V_7 ;
if ( ( V_7 = F_1 ( V_2 , & V_324 [ 1 ] , F_42 ( V_324 ) - 1 ) ) < 0 )
return V_7 ;
V_15 = F_154 ( V_2 , L_47 ) ;
if ( ! V_15 )
return - V_46 ;
...
static int F_181 ( struct V_14 * V_28 ,
struct V_29 * V_30 )
{
...
static int F_182 ( struct V_14 * V_28 ,
struct V_37 * V_38 )
{
T_2 V_328 , V_329 ;
struct V_1 * V_330 ;
V_330 = F_14 ( V_28 ) ;
V_328 = F_8 ( V_330 , 0x7a ) >> 14 ;
V_329 = F_8 ( V_330 , 0x20 ) >> 8 ;
V_38 -> V_21 . V_34 . V_36 [ 0 ] = ( V_328 << 1 ) + V_329 ;
return 0 ;
}
static int F_183 ( struct V_14 * V_28 ,
struct V_37 * V_38 )
{
T_2 V_328 , V_329 , V_331 ;
struct V_1 * V_330 ;
V_330 = F_14 ( V_28 ) ;
V_328 = V_38 -> V_21 . V_34 . V_36 [ 0 ] >> 1 ;
V_329 = V_38 -> V_21 . V_34 . V_36 [ 0 ] & 1 ;
V_331 = F_8 ( V_330 , 0x7a ) ;
F_35 ( V_330 , 0x7a , ( V_331 & 0x3FFF ) + ( V_328 << 14 ) ) ;
V_331 = F_8 ( V_330 , 0x20 ) ;
F_35 ( V_330 , 0x20 , ( V_331 & 0xFEFF ) + ( V_329 << 8 ) ) ;
return 0 ;
}
...
struct V_1 * V_330 = F_14 ( V_28 ) ;
F_7 ( & V_330 -> V_25 ) ;
V_335 = F_8 ( V_330 , V_26 ) & V_27 ;
F_9 ( V_330 , V_26 , V_27 , 0 ) ;
V_336 = F_8 ( V_330 , 0x60 ) &
V_334 [ V_28 -> V_43 ] . V_20 ;
F_9 ( V_330 , V_26 , V_27 , V_335 ) ;
F_10 ( & V_330 -> V_25 ) ;
V_38 -> V_21 . V_34 . V_36 [ 0 ] = V_336 >>
V_334 [ V_28 -> V_43 ] . V_122 ;
return 0 ;
}
...
struct V_29 * V_30 )
{
static const char * V_337 [] = { L_73 , L_74 } ;
return F_11 ( V_28 , V_30 , V_337 , 2 ) ;
}
...
{
int V_7 ;
if ( ( V_7 = F_1 ( V_2 , V_339 , F_42 ( V_339 ) ) ) < 0 )
return V_7 ;
if ( ( V_7 = F_1 ( V_2 , V_340 , F_42 ( V_340 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
...
{
int V_6 , V_7 ;
for ( V_6 = 0 ; V_6 < F_42 ( V_342 ) ; V_6 ++ )
if ( ( V_7 = F_2 ( V_2 -> V_8 -> V_9 , F_196 ( & V_342 [ V_6 ] , V_2 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
...
{
int V_6 , V_7 ;
for ( V_6 = 0 ; V_6 < F_42 ( V_345 ) ; V_6 ++ )
if ( ( V_7 = F_2 ( V_2 -> V_8 -> V_9 , F_196 ( & V_345 [ V_6 ] , V_2 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
