...
F_64 ( V_46 , NULL , 0 , & V_151 -> V_60 , V_151 -> V_77 , V_151 -> type ,
V_151 -> V_153 ) ;
}
F_25 ( V_46 ) ;
F_26 ( V_46 ) ;
...
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_157 , V_48 ) ;
F_23 ( V_46 ) ;
V_34 = F_66 ( V_46 , & V_73 -> V_60 ) ;
if ( V_34 < 0 ) {
V_34 = F_1 ( V_2 , V_3 , V_157 , - V_34 ) ;
goto V_133;
}
V_34 = 0 ;
if ( ! F_19 ( V_51 , & V_46 -> V_41 ) || ! V_73 -> V_158 )
goto V_133;
V_156 = F_67 ( V_46 , V_159 , & V_73 -> V_60 ) ;
if ( V_156 ) {
struct V_160 V_161 ;
F_6 ( V_156 -> V_162 , & V_161 . V_162 ) ;
V_161 . V_163 = 0x13 ;
V_34 = F_41 ( V_46 , V_164 , 0 , NULL ) ;
}
V_133:
F_25 ( V_46 ) ;
F_26 ( V_46 ) ;
...
V_156 = F_67 ( V_46 , V_159 , & V_73 -> V_60 ) ;
if ( ! V_156 )
V_156 = F_67 ( V_46 , V_167 , & V_73 -> V_60 ) ;
if ( ! V_156 ) {
...
F_6 ( V_156 -> V_162 , & V_161 . V_162 ) ;
V_161 . V_163 = 0x13 ;
V_34 = F_41 ( V_46 , V_164 , sizeof( V_161 ) , & V_161 ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_79:
F_25 ( V_46 ) ;
...
static int F_69 ( struct V_1 * V_2 , T_1 V_3 , unsigned char * V_21 ,
T_1 V_16 )
{
struct V_37 * V_46 ;
struct V_175 * V_73 ;
...
V_73 = ( void * ) V_21 ;
if ( V_16 != sizeof( * V_73 ) )
return F_1 ( V_2 , V_3 , V_178 , V_76 ) ;
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_178 , V_48 ) ;
F_23 ( V_46 ) ;
if ( ! F_19 ( V_51 , & V_46 -> V_41 ) ) {
V_34 = F_1 ( V_2 , V_3 , V_178 , V_86 ) ;
goto V_79;
}
V_4 = F_29 ( V_2 , V_178 , V_3 , V_21 , V_16 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
goto V_79;
}
F_24 ( & V_177 . V_60 , & V_73 -> V_60 ) ;
V_177 . V_153 = V_73 -> V_153 ;
memcpy ( V_177 . V_179 , V_73 -> V_179 , 16 ) ;
V_34 = F_41 ( V_46 , V_180 , sizeof( V_177 ) , & V_177 ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_79:
F_25 ( V_46 ) ;
...
V_4 = F_29 ( V_2 , V_182 , V_3 ,
V_21 , V_16 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
goto V_79;
}
V_34 = F_41 ( V_46 , V_183 , sizeof( V_73 -> V_60 ) ,
& V_73 -> V_60 ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_79:
...
V_73 = ( void * ) V_21 ;
if ( V_16 != sizeof( * V_73 ) )
return F_1 ( V_2 , V_3 , V_185 , V_76 ) ;
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_185 , V_48 ) ;
F_23 ( V_46 ) ;
V_46 -> V_186 = V_73 -> V_186 ;
F_2 ( L_11 , V_46 -> V_66 ,
V_46 -> V_186 ) ;
F_25 ( V_46 ) ;
F_26 ( V_46 ) ;
return F_9 ( V_2 , V_3 , V_185 , NULL , 0 ) ;
}
static inline struct V_68 * F_72 ( struct V_155 * V_156 )
{
struct V_37 * V_46 = V_156 -> V_46 ;
struct V_30 * V_31 ;
F_13 (p, &cmd_list) {
struct V_68 * V_4 ;
V_4 = F_16 ( V_31 , struct V_68 , V_39 ) ;
...
static void F_73 ( struct V_68 * V_4 , T_2 V_5 )
{
struct V_189 V_17 ;
struct V_155 * V_156 = V_4 -> V_188 ;
F_24 ( & V_17 . V_60 , & V_156 -> V_174 ) ;
V_17 . V_5 = V_5 ;
F_9 ( V_4 -> V_2 , V_4 -> V_3 , V_187 , & V_17 , sizeof( V_17 ) ) ;
V_156 -> V_190 = NULL ;
V_156 -> V_191 = NULL ;
V_156 -> V_192 = NULL ;
F_74 ( V_156 ) ;
...
static void F_75 ( struct V_155 * V_156 , T_2 V_5 )
{
struct V_68 * V_4 ;
F_2 ( L_12 , V_5 ) ;
V_4 = F_72 ( V_156 ) ;
...
static int F_76 ( struct V_1 * V_2 , T_1 V_3 , unsigned char * V_21 , T_1 V_16 )
{
struct V_37 * V_46 ;
struct V_193 * V_73 ;
struct V_68 * V_4 ;
...
V_73 = ( void * ) V_21 ;
if ( V_16 != sizeof( * V_73 ) )
return F_1 ( V_2 , V_3 , V_187 , V_76 ) ;
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_187 , V_48 ) ;
F_23 ( V_46 ) ;
if ( V_73 -> V_196 == 0x03 ) {
V_194 = V_197 ;
V_195 = V_198 ;
...
V_156 = F_77 ( V_46 , V_159 , & V_73 -> V_60 , V_194 , V_195 ) ;
if ( F_78 ( V_156 ) ) {
V_34 = F_79 ( V_156 ) ;
goto V_133;
}
if ( V_156 -> V_190 ) {
F_74 ( V_156 ) ;
V_34 = F_1 ( V_2 , V_3 , V_187 , V_80 ) ;
goto V_133;
}
V_4 = F_29 ( V_2 , V_187 , V_3 , V_21 , V_16 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
F_74 ( V_156 ) ;
goto V_133;
...
V_156 -> V_191 = F_75 ;
V_156 -> V_192 = F_75 ;
V_156 -> V_186 = V_73 -> V_196 ;
V_4 -> V_188 = V_156 ;
if ( V_156 -> V_201 == V_202 &&
F_80 ( V_156 , V_194 , V_195 ) )
F_73 ( V_4 , 0 ) ;
V_34 = 0 ;
V_133:
F_25 ( V_46 ) ;
...
static int F_81 ( struct V_1 * V_2 , T_1 V_3 , unsigned char * V_21 ,
T_1 V_16 , int V_203 )
{
struct V_204 * V_73 = ( void * ) V_21 ;
T_1 V_205 , V_206 ;
struct V_68 * V_4 ;
struct V_37 * V_46 ;
int V_34 ;
...
if ( V_16 != sizeof( * V_73 ) )
return F_1 ( V_2 , V_3 , V_205 , V_76 ) ;
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_205 , V_48 ) ;
F_23 ( V_46 ) ;
if ( ! F_19 ( V_51 , & V_46 -> V_41 ) ) {
V_34 = F_1 ( V_2 , V_3 , V_205 , V_86 ) ;
goto V_79;
}
V_4 = F_29 ( V_2 , V_205 , V_3 , V_21 , V_16 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
goto V_79;
}
V_34 = F_41 ( V_46 , V_206 , sizeof( V_73 -> V_60 ) , & V_73 -> V_60 ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_79:
F_25 ( V_46 ) ;
...
static int F_82 ( struct V_1 * V_2 , T_1 V_3 , unsigned char * V_21 ,
T_1 V_16 )
{
struct V_211 * V_212 = ( void * ) V_21 ;
struct V_213 V_214 ;
struct V_37 * V_46 ;
struct V_68 * V_4 ;
int V_34 ;
F_2 ( L_10 ) ;
if ( V_16 != sizeof( * V_212 ) )
return F_1 ( V_2 , V_3 , V_215 , V_76 ) ;
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_215 , V_48 ) ;
F_23 ( V_46 ) ;
V_4 = F_29 ( V_2 , V_215 , V_3 , V_21 , V_16 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
goto V_79;
}
memcpy ( V_214 . V_66 , V_212 -> V_66 , sizeof( V_214 . V_66 ) ) ;
V_34 = F_41 ( V_46 , V_216 , sizeof( V_214 ) ,
& V_214 ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_79:
...
static int F_83 ( struct V_1 * V_2 , T_1 V_3 )
{
struct V_37 * V_46 ;
struct V_68 * V_4 ;
int V_34 ;
...
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_217 ,
V_48 ) ;
F_23 ( V_46 ) ;
if ( ! F_19 ( V_51 , & V_46 -> V_41 ) ) {
V_34 = F_1 ( V_2 , V_3 , V_217 ,
V_86 ) ;
goto V_133;
}
if ( ! ( V_46 -> V_61 [ 6 ] & V_218 ) ) {
V_34 = F_1 ( V_2 , V_3 , V_217 ,
V_219 ) ;
goto V_133;
}
if ( F_35 ( V_217 , V_3 ) ) {
V_34 = F_1 ( V_2 , V_3 , V_217 , V_80 ) ;
goto V_133;
}
V_4 = F_29 ( V_2 , V_217 , V_3 , NULL , 0 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
goto V_133;
}
V_34 = F_41 ( V_46 , V_220 , 0 , NULL ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_133:
F_25 ( V_46 ) ;
...
{
struct V_37 * V_46 ;
struct V_221 * V_73 = ( void * ) V_21 ;
int V_34 ;
F_2 ( L_15 , V_3 ) ;
if ( V_16 != sizeof( * V_73 ) )
return F_1 ( V_2 , V_3 , V_222 ,
V_76 ) ;
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_222 ,
V_48 ) ;
F_23 ( V_46 ) ;
V_34 = F_85 ( V_46 , & V_73 -> V_60 , V_73 -> V_223 ,
V_73 -> V_224 ) ;
if ( V_34 < 0 )
V_34 = F_1 ( V_2 , V_3 , V_222 , - V_34 ) ;
else
V_34 = F_9 ( V_2 , V_3 , V_222 , NULL ,
0 ) ;
F_25 ( V_46 ) ;
F_26 ( V_46 ) ;
return V_34 ;
}
static int F_86 ( struct V_1 * V_2 , T_1 V_3 ,
...
V_48 ) ;
F_23 ( V_46 ) ;
V_34 = F_87 ( V_46 , & V_73 -> V_60 ) ;
if ( V_34 < 0 )
V_34 = F_1 ( V_2 , V_3 , V_226 ,
- V_34 ) ;
else
V_34 = F_9 ( V_2 , V_3 , V_226 ,
NULL , 0 ) ;
F_25 ( V_46 ) ;
F_26 ( V_46 ) ;
return V_34 ;
...
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_229 , V_48 ) ;
F_89 ( V_46 ) ;
V_4 = F_29 ( V_2 , V_229 , V_3 , NULL , 0 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
goto V_79;
}
memset ( & V_73 , 0 , sizeof( V_73 ) ) ;
memcpy ( & V_73 . V_227 , V_227 , 3 ) ;
V_73 . V_113 = 0x08 ;
V_73 . V_230 = 0x00 ;
V_34 = F_41 ( V_46 , V_231 , sizeof( V_73 ) , & V_73 ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_79:
F_90 ( V_46 ) ;
...
V_46 = F_22 ( V_3 ) ;
if ( ! V_46 )
return F_1 ( V_2 , V_3 , V_232 , V_48 ) ;
F_89 ( V_46 ) ;
V_4 = F_29 ( V_2 , V_232 , V_3 , NULL , 0 ) ;
if ( ! V_4 ) {
V_34 = - V_13 ;
goto V_79;
}
V_34 = F_41 ( V_46 , V_233 , 0 , NULL ) ;
if ( V_34 < 0 )
F_36 ( V_4 ) ;
V_79:
F_90 ( V_46 ) ;
...
int F_92 ( struct V_1 * V_2 , struct V_234 * V_235 , T_3 V_236 )
{
unsigned char * V_237 ;
struct V_8 * V_9 ;
T_1 V_14 , V_3 , V_16 ;
...
if ( V_236 < sizeof( * V_9 ) )
return - V_76 ;
V_237 = F_14 ( V_236 , V_238 ) ;
if ( ! V_237 )
return - V_13 ;
if ( F_93 ( V_237 , V_235 -> V_239 , V_236 ) ) {
V_34 = - V_240 ;
goto V_241;
}
V_9 = (struct V_8 * ) V_237 ;
V_14 = F_61 ( & V_9 -> V_14 ) ;
V_3 = F_61 ( & V_9 -> V_3 ) ;
V_16 = F_61 ( & V_9 -> V_16 ) ;
if ( V_16 != V_236 - sizeof( * V_9 ) ) {
V_34 = - V_76 ;
goto V_241;
}
switch ( V_14 ) {
...
break;
case V_75 :
V_34 = F_38 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_85 :
V_34 = F_40 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_87 :
V_34 = F_42 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_96 :
V_34 = F_47 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_127 :
V_34 = F_55 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_132 :
V_34 = F_56 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_137 :
V_34 = F_58 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_141 :
V_34 = F_59 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_147 :
V_34 = F_60 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_157 :
V_34 = F_65 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_166 :
V_34 = V_158 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_170 :
V_34 = F_68 ( V_2 , V_3 ) ;
break;
case V_178 :
V_34 = F_69 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_182 :
V_34 = F_70 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_185 :
V_34 = F_71 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_187 :
V_34 = F_76 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_207 :
V_34 = F_81 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 , 1 ) ;
break;
case V_209 :
V_34 = F_81 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 , 0 ) ;
break;
case V_215 :
V_34 = F_82 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_217 :
V_34 = F_83 ( V_2 , V_3 ) ;
break;
case V_222 :
V_34 = F_84 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) , V_16 ) ;
break;
case V_226 :
V_34 = F_86 ( V_2 , V_3 , V_237 + sizeof( * V_9 ) ,
V_16 ) ;
break;
case V_229 :
V_34 = F_88 ( V_2 , V_3 ) ;
...
int F_94 ( T_1 V_3 )
{
return F_43 ( V_242 , V_3 , NULL , 0 , NULL ) ;
}
int F_95 ( T_1 V_3 )
{
return F_43 ( V_243 , V_3 , NULL , 0 , NULL ) ;
}
static void F_96 ( struct V_68 * V_4 , void * V_21 )
{
struct V_72 * V_73 = V_4 -> V_69 ;
struct V_244 * V_134 = V_21 ;
...
int F_97 ( T_1 V_3 , T_2 V_50 )
{
struct V_72 V_11 ;
struct V_244 V_134 = { V_50 , NULL } ;
int V_245 ;
F_32 ( V_75 , V_3 , F_96 , & V_134 ) ;
V_11 . V_77 = V_50 ;
V_245 = F_43 ( V_246 , V_3 , & V_11 , sizeof( V_11 ) , V_134 . V_2 ) ;
if ( V_134 . V_2 )
F_28 ( V_134 . V_2 ) ;
return V_245 ;
}
int F_98 ( T_1 V_3 , T_2 V_54 )
{
struct V_72 V_11 ;
struct V_244 V_134 = { V_54 , NULL } ;
int V_245 ;
F_32 ( V_85 , V_3 , F_96 , & V_134 ) ;
V_11 . V_77 = V_54 ;
V_245 = F_43 ( V_247 , V_3 , & V_11 , sizeof( V_11 ) ,
V_134 . V_2 ) ;
if ( V_134 . V_2 )
F_28 ( V_134 . V_2 ) ;
return V_245 ;
}
int F_99 ( T_1 V_3 , T_2 V_52 )
{
struct V_72 V_11 ;
struct V_244 V_134 = { V_52 , NULL } ;
int V_245 ;
F_32 ( V_87 , V_3 , F_96 , & V_134 ) ;
V_11 . V_77 = V_52 ;
V_245 = F_43 ( V_248 , V_3 , & V_11 , sizeof( V_11 ) , V_134 . V_2 ) ;
if ( V_134 . V_2 )
F_28 ( V_134 . V_2 ) ;
return V_245 ;
}
int F_100 ( T_1 V_3 , struct V_249 * V_151 , T_2 V_250 )
{
struct V_251 V_11 ;
...
return F_43 ( V_253 , V_3 , & V_11 , sizeof( V_11 ) , NULL ) ;
}
int F_101 ( T_1 V_3 , V_171 * V_60 )
{
struct V_254 V_11 ;
F_24 ( & V_11 . V_60 , V_60 ) ;
return F_43 ( V_255 , V_3 , & V_11 , sizeof( V_11 ) , NULL ) ;
}
static void F_102 ( struct V_68 * V_4 , void * V_21 )
{
...
int F_103 ( T_1 V_3 , V_171 * V_60 )
{
struct V_257 V_11 ;
struct V_1 * V_2 = NULL ;
int V_34 ;
F_32 ( V_166 , V_3 , F_102 , & V_2 ) ;
F_24 ( & V_11 . V_60 , V_60 ) ;
V_34 = F_43 ( V_258 , V_3 , & V_11 , sizeof( V_11 ) , V_2 ) ;
if ( V_2 )
F_28 ( V_2 ) ;
return V_34 ;
}
...
if ( ! V_4 )
return - V_135 ;
V_34 = F_1 ( V_4 -> V_2 , V_3 , V_166 , V_259 ) ;
F_36 ( V_4 ) ;
return V_34 ;
}
int F_105 ( T_1 V_3 , V_171 * V_60 , T_2 V_5 )
{
struct V_260 V_11 ;
F_24 ( & V_11 . V_60 , V_60 ) ;
V_11 . V_5 = V_5 ;
return F_43 ( V_261 , V_3 , & V_11 , sizeof( V_11 ) , NULL ) ;
}
int F_106 ( T_1 V_3 , V_171 * V_60 , T_2 V_262 )
{
struct V_263 V_11 ;
F_24 ( & V_11 . V_60 , V_60 ) ;
V_11 . V_262 = V_262 ;
return F_43 ( V_264 , V_3 , & V_11 , sizeof( V_11 ) ,
NULL ) ;
}
int F_107 ( T_1 V_3 , V_171 * V_60 , T_2 V_5 )
{
struct V_68 * V_4 ;
struct V_265 V_17 ;
int V_34 ;
...
F_24 ( & V_17 . V_60 , V_60 ) ;
V_17 . V_5 = V_5 ;
V_34 = F_9 ( V_4 -> V_2 , V_3 , V_178 , & V_17 ,
sizeof( V_17 ) ) ;
F_36 ( V_4 ) ;
return V_34 ;
}
int F_108 ( T_1 V_3 , V_171 * V_60 , T_2 V_5 )
{
struct V_68 * V_4 ;
struct V_265 V_17 ;
int V_34 ;
...
int F_109 ( T_1 V_3 , V_171 * V_60 , T_5 V_266 ,
T_2 V_267 )
{
struct V_268 V_11 ;
F_2 ( L_14 , V_3 ) ;
F_24 ( & V_11 . V_60 , V_60 ) ;
V_11 . V_267 = V_267 ;
F_110 ( V_266 , & V_11 . V_266 ) ;
return F_43 ( V_269 , V_3 , & V_11 , sizeof( V_11 ) ,
NULL ) ;
}
static int F_111 ( T_1 V_3 , V_171 * V_60 , T_2 V_5 ,
T_2 V_14 )
{
struct V_68 * V_4 ;
struct V_270 V_17 ;
...
{
return F_111 ( V_3 , V_60 , V_5 ,
V_207 ) ;
}
int F_113 ( T_1 V_3 , V_171 * V_60 , T_2 V_5 )
{
return F_111 ( V_3 , V_60 , V_5 ,
V_209 ) ;
}
...
int F_115 ( T_1 V_3 , T_2 * V_66 , T_2 V_5 )
{
struct V_68 * V_4 ;
struct V_37 * V_46 ;
struct V_211 V_11 ;
int V_34 ;
memset ( & V_11 , 0 , sizeof( V_11 ) ) ;
memcpy ( V_11 . V_66 , V_66 , V_273 ) ;
V_4 = F_35 ( V_215 , V_3 ) ;
if ( ! V_4 )
goto V_274;
if ( V_5 ) {
V_34 = F_1 ( V_4 -> V_2 , V_3 , V_215 , V_259 ) ;
goto V_79;
}
V_46 = F_22 ( V_3 ) ;
if ( V_46 ) {
...
V_34 = F_9 ( V_4 -> V_2 , V_3 , V_215 , & V_11 ,
sizeof( V_11 ) ) ;
if ( V_34 < 0 )
goto V_79;
V_274:
V_34 = F_43 ( V_275 , V_3 , & V_11 , sizeof( V_11 ) ,
V_4 ? V_4 -> V_2 : NULL ) ;
V_79:
if ( V_4 )
F_36 ( V_4 ) ;
...
int F_116 ( T_1 V_3 , T_2 * V_223 , T_2 * V_224 ,
T_2 V_5 )
{
struct V_68 * V_4 ;
int V_34 ;
...
return - V_135 ;
if ( V_5 ) {
V_34 = F_1 ( V_4 -> V_2 , V_3 , V_217 ,
V_259 ) ;
} else {
struct V_276 V_17 ;
memcpy ( V_17 . V_223 , V_223 , sizeof( V_17 . V_223 ) ) ;
memcpy ( V_17 . V_224 , V_224 , sizeof( V_17 . V_224 ) ) ;
V_34 = F_9 ( V_4 -> V_2 , V_3 , V_217 ,
& V_17 , sizeof( V_17 ) ) ;
}
F_36 ( V_4 ) ;
return V_34 ;
}
int F_117 ( T_1 V_3 , V_171 * V_60 , T_2 * V_62 , T_6 V_277 ,
T_2 * V_119 )
{
struct V_278 V_11 ;
memset ( & V_11 , 0 , sizeof( V_11 ) ) ;
...
return F_43 ( V_279 , V_3 , & V_11 , sizeof( V_11 ) , NULL ) ;
}
int F_118 ( T_1 V_3 , V_171 * V_60 , T_2 * V_66 )
{
struct V_280 V_11 ;
memset ( & V_11 , 0 , sizeof( V_11 ) ) ;
F_24 ( & V_11 . V_60 , V_60 ) ;
memcpy ( V_11 . V_66 , V_66 , V_273 ) ;
return F_43 ( V_281 , V_3 , & V_11 , sizeof( V_11 ) , NULL ) ;
}
int F_119 ( T_1 V_3 , T_2 V_282 )
{
return F_43 ( V_283 , V_3 , & V_282 ,
sizeof( V_282 ) , NULL ) ;
}
