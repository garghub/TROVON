...
if ( V_27 -> V_43 > 0 )
return - V_44 ;
F_15 ( V_27 -> V_45 , L_4 , sizeof( V_27 -> V_45 ) ) ;
V_27 -> type = V_46 ;
V_27 -> V_47 = 87.5 * 16000 ;
V_27 -> V_48 = 108 * 16000 ;
V_27 -> V_49 = V_50 | V_51 ;
V_27 -> V_52 = V_53 ;
if ( F_12 ( V_2 ) )
...
switch ( V_61 -> V_62 ) {
case V_63 :
return F_22 ( V_61 , 0 , 1 , 1 , 1 ) ;
case V_64 :
return F_22 ( V_61 , 0 , 65535 , 2048 , 65535 ) ;
case V_65 :
case V_66 :
return F_22 ( V_61 , 0 , 65535 , 4370 , 32768 ) ;
}
return - V_44 ;
}
...
return 0 ;
case V_64 :
V_68 -> V_69 = V_2 -> V_13 * 2048 ;
return 0 ;
case V_65 :
V_68 -> V_69 = V_2 -> V_16 * 4370 ;
return 0 ;
case V_66 :
V_68 -> V_69 = V_2 -> V_19 * 4370 ;
return 0 ;
}
return - V_44 ;
}
...
static int F_25 ( struct V_31 * V_70 , void * V_32 , unsigned int * V_26 )
{
* V_26 = 0 ;
return 0 ;
}
static int F_26 ( struct V_31 * V_70 , void * V_32 , unsigned int V_26 )
{
return V_26 ? - V_44 : 0 ;
}
...
{
V_72 -> V_43 = 0 ;
F_15 ( V_72 -> V_45 , L_5 , sizeof( V_72 -> V_45 ) ) ;
V_72 -> V_52 = V_73 ;
return 0 ;
}
...
int V_77 ;
F_15 ( V_76 -> V_45 , L_6 , sizeof( V_76 -> V_45 ) ) ;
V_2 -> V_23 = V_23 ;
V_2 -> V_22 = 0xf ;
F_30 ( & V_2 -> V_12 ) ;
if ( V_2 -> V_23 == - 1 ) {
...
F_15 ( V_2 -> V_79 . V_45 , V_76 -> V_45 , sizeof( V_2 -> V_79 . V_45 ) ) ;
V_2 -> V_79 . V_76 = V_76 ;
V_2 -> V_79 . V_80 = & V_81 ;
V_2 -> V_79 . V_82 = & V_83 ;
V_2 -> V_79 . V_84 = V_85 ;
