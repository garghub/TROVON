...
error = F_19 ( V_14 , F_23 , V_17 ) ;
if ( error )
return F_22 ( error ) ;
F_37 ( V_14 , ( V_17 & V_38 ) ? V_43 : 0 ) ;
return 0 ;
}
STATIC int
F_38 (
...
{
int error = 0 ;
while ( F_52 ( & V_14 -> V_51 ) > 0 )
F_18 ( 100 ) ;
F_49 ( V_14 ) ;
F_53 ( F_52 ( & V_14 -> V_51 ) != 0 ) ;
error = F_54 ( V_14 , 1 ) ;
if ( error )
F_55 ( V_14 , L_1
L_2 ) ;
...
struct V_55 * V_56 )
{
struct V_13 * V_14 = F_62 ( F_63 ( V_56 ) ,
struct V_13 , V_53 ) ;
int error ;
if ( ! ( V_14 -> V_57 & V_58 ) ) {
...
struct V_13 * V_14 = V_2 -> V_10 ;
struct V_15 * V_16 ;
V_16 = F_20 ( V_14 , F_16 ( V_14 , V_2 -> V_5 ) ) ;
F_4 ( & V_16 -> V_72 ) ;
F_4 ( & V_2 -> V_4 ) ;
F_78 ( V_16 , V_2 ) ;
F_82 ( V_2 , V_8 ) ;
...
V_30 = 0 ;
V_20 = 0 ;
while ( ( V_16 = F_98 ( V_14 , V_30 , V_66 ) ) ) {
...
if ( ! V_24 [ V_26 ] )
continue;
error = F_88 ( V_24 [ V_26 ] , V_16 , V_17 ) ;
if ( error && V_19 != V_11 )
V_19 = error ;
}
* V_81 -= V_25 ;
...
int V_81 = V_90 -> V_81 ;
T_6 V_92 = V_90 -> V_92 ;
V_14 = F_62 ( V_88 , struct V_13 , V_93 ) ;
if ( V_81 ) {
F_65 ( V_14 ) ;
F_64 ( V_14 -> V_62 ) ;
if ( ! ( V_92 & V_94 ) )
