...
if ( V_5 )
return V_5 ;
if ( V_91 [ 0 ] || V_91 [ 1 ] || V_91 [ 2 ] ||
V_91 [ 3 ] || V_91 [ 4 ] || V_91 [ 5 ] )
goto V_92;
F_61 ( 1 ) ;
}
return - V_85 ;
...
V_2 -> V_58 = V_61 -> V_58 ;
V_5 = F_105 ( V_99 , V_147 , V_2 , & V_130 ) ;
if ( V_5 < 0 )
goto V_148;
V_5 = F_70 ( V_2 ) ;
if ( V_5 < 0 ) {
...
if ( V_5 < 0 )
return V_5 ;
V_5 = F_106 ( V_99 , F_107 ( & V_149 ,
V_2 ) ) ;
if ( V_5 < 0 )
return V_5 ;
F_108 ( V_99 , & V_61 -> V_150 ) ;
* V_128 = V_2 ;
return 0 ;
V_148:
F_51 ( V_61 -> V_58 , V_2 ) ;
...
V_5 = F_110 ( V_157 [ V_150 ] , V_158 [ V_150 ] , V_159 , 0 , & V_99 ) ;
if ( V_5 < 0 )
return V_5 ;
...
strcpy ( V_99 -> V_161 , L_79 ) ;
strcpy ( V_99 -> V_162 , L_80 ) ;
sprintf ( V_99 -> V_163 , L_81 ,
V_99 -> V_162 , V_2 -> V_143 ,
V_2 -> V_59 , V_2 -> V_58 ) ;
V_5 = F_111 ( V_99 ) ;
if ( V_5 < 0 )
goto V_160;
...
static void T_6 F_114 ( struct V_127 * V_61 )
{
F_113 ( F_115 ( V_61 ) ) ;
F_112 ( V_61 , NULL ) ;
}
