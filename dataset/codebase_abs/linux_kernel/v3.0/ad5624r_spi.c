...
struct V_18 * V_19 ;
int V_15 , V_37 = 0 ;
V_19 = F_15 ( sizeof( * V_19 ) , V_38 ) ;
if ( V_19 == NULL ) {
V_15 = - V_39 ;
goto V_40;
}
F_16 ( V_2 , V_19 ) ;
V_19 -> V_41 = F_17 ( & V_2 -> V_10 , L_8 ) ;
if ( ! F_18 ( V_19 -> V_41 ) ) {
V_15 = F_19 ( V_19 -> V_41 ) ;
if ( V_15 )
goto V_42;
...
V_19 -> V_17 -> V_10 . V_47 = & V_2 -> V_10 ;
V_19 -> V_17 -> V_48 = F_21 ( V_2 ) -> V_48 ;
V_19 -> V_17 -> V_49 = & V_50 ;
V_19 -> V_17 -> V_51 = ( void * ) ( V_19 ) ;
V_19 -> V_17 -> V_52 = V_53 ;
V_15 = F_23 ( V_19 -> V_17 ) ;
if ( V_15 )
goto V_54;
...
static int T_7 F_28 ( struct V_1 * V_2 )
{
