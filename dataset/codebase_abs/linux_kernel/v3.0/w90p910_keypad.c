...
V_4 -> V_59 = V_2 -> V_10 ;
V_4 -> V_60 = sizeof( V_2 -> V_10 [ 0 ] ) ;
V_4 -> V_61 = F_29 ( V_2 -> V_10 ) ;
F_30 ( V_4 , V_2 ) ;
V_4 -> V_62 [ 0 ] = F_31 ( V_63 ) | F_31 ( V_64 ) ;
F_32 ( V_4 , V_11 , V_12 ) ;
F_33 ( V_39 , V_8 ,
V_4 -> V_59 , V_4 -> V_65 ) ;
error = F_34 ( V_2 -> V_13 , F_8 ,
V_66 , V_36 -> V_49 , V_2 ) ;
if ( error ) {
F_17 ( & V_36 -> V_22 , L_8 ) ;
goto V_67;
...
F_39 ( V_2 -> V_17 ) ;
V_51:
F_40 ( V_41 -> V_48 , F_23 ( V_41 ) ) ;
V_46:
F_41 ( V_4 ) ;
F_42 ( V_2 ) ;
return error ;
}
static int T_3 F_43 ( struct V_35 * V_36 )
{
struct V_1 * V_2 = F_44 ( V_36 ) ;
struct V_40 * V_41 ;
F_37 ( V_2 -> V_13 , V_36 ) ;
F_38 ( V_2 -> V_26 ) ;
F_45 ( V_2 -> V_4 ) ;
