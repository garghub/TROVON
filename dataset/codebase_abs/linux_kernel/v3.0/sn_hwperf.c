...
static long F_64 ( struct V_121 * V_122 , T_9 V_52 , unsigned long V_98 )
{
struct V_123 V_97 ;
struct V_70 * V_124 ;
struct V_2 * V_29 ;
...
V_96 = F_65 ( & V_97 , ( const void V_127 * ) V_98 ,
sizeof( struct V_123 ) ) ;
if ( V_96 != 0 ) {
V_96 = - V_128 ;
goto error;
...
if ( V_52 & V_130 ) {
V_96 = F_65 ( V_31 , ( const void V_127 * ) V_97 . V_129 , V_97 . V_5 ) ;
if ( V_96 != 0 ) {
V_96 = - V_128 ;
goto error;
}
...
if ( V_97 . V_5 < F_66 () * sizeof( struct V_2 ) ) {
V_96 = - V_10 ;
goto error;
} else
...
if ( V_52 & V_139 ) {
V_96 = F_67 ( ( void V_127 * ) V_97 . V_129 , V_31 , V_97 . V_5 ) ;
if ( V_96 != 0 ) {
V_96 = - V_128 ;
goto error;
}
...
int F_71 ( struct V_147 * V_147 , struct V_121 * V_121 )
{
int V_4 ;
struct V_38 * V_148 ;
struct V_2 * V_6 ;
...
V_4 = F_72 ( V_121 , & V_149 ) ;
V_148 = V_121 -> V_150 ;
V_148 -> V_71 = V_6 ;
}
return V_4 ;
}
int F_73 ( struct V_147 * V_147 , struct V_121 * V_121 )
{
struct V_38 * V_148 = V_121 -> V_150 ;
F_6 ( V_148 -> V_71 ) ;
return F_74 ( V_147 , V_121 ) ;
}
int F_75 ( T_5 V_44 ,
T_5 * V_49 , T_5 * V_50 )
{
