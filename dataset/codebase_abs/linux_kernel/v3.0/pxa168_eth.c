...
static int F_95 ( struct V_224 * V_225 , int V_16 , int V_226 )
{
...
static int F_97 ( struct V_21 * V_22 , struct V_234 * V_235 ,
int V_103 )
{
struct V_1 * V_2 = F_14 ( V_22 ) ;
if ( V_2 -> V_18 != NULL )
return F_98 ( V_2 -> V_18 , V_235 , V_103 ) ;
return - V_236 ;
}
static struct V_237 * F_99 ( struct V_1 * V_2 , int V_16 )
{
...
static void F_101 ( struct V_1 * V_2 , int V_161 , int V_162 )
{
struct V_237 * V_18 = V_2 -> V_18 ;
F_10 ( V_2 ) ;
F_102 ( V_2 -> V_22 , F_103 ( & V_18 -> V_22 ) , 0 , V_243 ) ;
if ( V_161 == 0 ) {
V_18 -> V_244 = V_245 ;
V_18 -> V_161 = 0 ;
V_18 -> V_162 = 0 ;
...
if ( V_2 -> V_251 -> V_252 )
V_2 -> V_251 -> V_252 () ;
V_2 -> V_18 = F_99 ( V_2 , V_2 -> V_251 -> V_16 & 0x1f ) ;
if ( V_2 -> V_18 != NULL )
F_101 ( V_2 , V_2 -> V_251 -> V_161 , V_2 -> V_251 -> V_162 ) ;
F_29 ( V_2 , NULL , V_22 -> V_94 ) ;
return 0 ;
}
...
struct V_1 * V_2 = F_14 ( V_22 ) ;
int V_182 ;
V_182 = F_106 ( V_2 -> V_18 ) ;
if ( V_182 == 0 )
V_182 = F_107 ( V_2 -> V_18 , V_103 ) ;
return V_182 ;
}
static int F_40 ( struct V_21 * V_22 , struct V_102 * V_103 )
{
struct V_1 * V_2 = F_14 ( V_22 ) ;
return F_108 ( V_2 -> V_18 , V_103 ) ;
}
...
static int F_110 ( struct V_261 * V_262 )
{
struct V_1 * V_2 = NULL ;
...
V_2 -> V_22 = V_22 ;
V_2 -> V_265 = V_265 ;
V_264 = F_116 ( V_262 , V_268 , 0 ) ;
if ( V_264 == NULL ) {
V_182 = - V_231 ;
goto V_269;
}
V_2 -> V_4 = F_117 ( V_264 -> V_65 , V_264 -> V_35 - V_264 -> V_65 + 1 ) ;
if ( V_2 -> V_4 == NULL ) {
V_182 = - V_85 ;
goto V_269;
}
V_264 = F_116 ( V_262 , V_270 , 0 ) ;
F_77 ( ! V_264 ) ;
...
F_77 ( V_2 -> V_15 > 2 ) ;
F_121 ( V_22 , & V_2 -> V_49 , F_87 , V_2 -> V_29 ) ;
...
V_2 -> V_238 -> V_285 = F_95 ;
V_2 -> V_238 -> V_286 = F_96 ;
snprintf ( V_2 -> V_238 -> V_287 , V_288 , L_30 , V_262 -> V_287 ) ;
V_2 -> V_238 -> V_81 = & V_262 -> V_22 ;
V_2 -> V_238 -> V_289 = 0xffffffff ;
V_182 = F_124 ( V_2 -> V_238 ) ;
if ( V_182 )
goto V_290;
F_68 ( V_2 ) ;
V_182 = F_105 ( V_22 ) ;
...
static int F_133 ( struct V_261 * V_262 )
{
struct V_21 * V_22 = F_134 ( V_262 ) ;
struct V_1 * V_2 = F_14 ( V_22 ) ;
if ( V_2 -> V_71 ) {
...
static int F_139 ( struct V_261 * V_262 )
{
return - V_292 ;
}
static int F_140 ( struct V_261 * V_262 , T_6 V_293 )
{
return - V_292 ;
}
