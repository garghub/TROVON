...
{
struct V_30 * V_44 , * V_45 , * V_46 ;
if ( ! F_19 () )
return - V_47 ;
V_44 = F_20 ( NULL , L_53 ) ;
if ( V_44 == NULL )
return - V_47 ;
for ( V_45 = NULL ; ( V_45 = F_21 ( V_44 , V_45 ) ) != NULL ; )
if ( ! strcmp ( V_45 -> V_43 , L_54 ) ||
F_22 ( V_45 , L_55 ) )
break;
for ( V_46 = NULL ;
V_45 && ( V_46 = F_21 ( V_45 , V_46 ) ) != NULL ; ) {
struct V_24 * V_25 ;
V_25 = F_13 ( V_46 , 0 ) ;
if ( V_25 == NULL ) {
F_5 ( V_21 L_56
...
struct V_24 * V_25 ;
while ( ! F_26 ( & V_49 ) ) {
V_25 = F_27 ( V_49 . V_50 , struct V_24 , V_48 ) ;
F_28 ( & V_25 -> V_48 ) ;
F_29 ( & V_25 -> V_36 ) ;
}
}
