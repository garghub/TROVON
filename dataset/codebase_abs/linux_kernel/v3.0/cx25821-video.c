...
V_13 =
F_9 ( V_11 -> V_16 . V_22 , struct V_12 , V_17 . V_18 ) ;
...
int F_22 ( struct V_8 * V_9 , struct V_46 * V_47 , unsigned int V_48 )
{
F_6 ( 1 , L_2 , V_7 ) ;
if ( V_47 -> V_49 & V_48 )
return 1 ;
...
void F_27 ( struct V_8 * V_9 , struct V_46 * V_47 , unsigned int V_53 )
{
...
return 0 ;
V_13 =
F_9 ( V_11 -> V_19 . V_22 , struct V_12 , V_17 . V_18 ) ;
if ( NULL == V_75 ) {
...
F_55 ( V_9 , V_4 ) ;
F_56 ( V_9 -> V_37 ,
& V_9 -> V_51 [ V_4 ] . V_84 . V_98 ,
V_9 -> V_51 [ V_4 ] . V_92 -> V_73 ,
0x11 , 0 ) ;
V_9 -> V_51 [ V_4 ] . V_92 = & V_111 [ V_4 ] ;
V_9 -> V_51 [ V_4 ] . V_97 = NULL ;
V_9 -> V_51 [ V_4 ] . V_49 = 0 ;
F_33 ( V_9 -> V_51 [ V_4 ] . V_92 -> V_93 ,
0xffffffff ) ;
...
void F_70 ( struct V_117 * V_11 , struct V_122 * V_17 )
{
struct V_12 * V_13 =
F_63 ( V_17 , struct V_12 , V_17 ) ;
F_69 ( V_11 , V_13 ) ;
...
V_75 =
F_9 ( V_11 -> V_16 . V_75 , struct V_12 , V_17 . V_18 ) ;
...
V_9 -> V_132 = V_47 -> V_52 ;
V_167 =
( V_9 -> V_51 [ V_168 ] . V_138 ==
V_139 ) ? V_5 : V_175 ;
V_47 -> V_79 = F_3 ( V_167 ) ;
F_83 ( & V_9 -> V_51 [ V_168 ] . V_176 , & V_47 -> V_176 ) ;
F_84 ( & V_47 -> V_84 , & V_177 ,
& V_9 -> V_37 -> V_9 , & V_9 -> V_86 ,
V_152 ,
V_148 ,
sizeof( struct V_12 ) , V_47 , NULL ) ;
F_6 ( 1 , L_26 ) ;
F_24 ( & V_172 ) ;
return 0 ;
}
...
int F_112 ( struct V_154 * V_154 , void * V_192 , struct V_194 * V_195 )
{
struct V_46 * V_47 = V_192 ;
...
int F_100 ( struct V_154 * V_154 , void * V_192 , struct V_194 * V_195 )
{
struct V_2 * V_79 ;
enum V_123 V_124 ;
...
V_215 = 576 ;
if ( V_216 == V_124 ) {
V_124 = ( V_195 -> V_79 . V_199 . V_78 > V_215 / 2 )
? V_148 : V_144 ;
}
switch ( V_124 ) {
case V_144 :
...
int F_113 ( struct V_154 * V_154 , void * V_192 , struct V_217 * V_218 )
{
struct V_8 * V_9 = ( (struct V_46 * ) V_192 ) -> V_9 ;
...
int F_117 ( struct V_154 * V_154 , void * V_192 , struct V_233 * V_205 )
{
struct V_46 * V_47 = V_192 ;
return F_118 ( F_71 ( V_47 ) , V_205 ) ;
}
int F_119 ( struct V_154 * V_154 , void * V_192 , struct V_204 * V_205 )
{
struct V_46 * V_47 = V_192 ;
...
int F_125 ( struct V_154 * V_154 , void * V_195 , enum V_234 V_176 )
{
struct V_46 * V_47 = V_195 ;
struct V_8 * V_9 = ( (struct V_46 * ) V_195 ) -> V_9 ;
return F_126 ( & V_9 -> V_51 [ V_47 -> V_52 ]
. V_176 , & V_47 -> V_176 , V_176 ) ;
}
...
int F_130 ( struct V_154 * V_154 , void * V_192 , struct V_235 * V_4 )
{
struct V_8 * V_9 = ( (struct V_46 * ) V_192 ) -> V_9 ;
F_6 ( 1 , L_2 , V_7 ) ;
...
int F_133 ( struct V_154 * V_154 , void * V_192 , struct V_243 * V_195 )
{
struct V_46 * V_47 = V_192 ;
struct V_8 * V_9 = V_47 -> V_9 ;
V_195 -> V_244 = V_9 -> V_245 ;
F_18 ( V_9 , V_246 , V_247 , V_195 ) ;
return 0 ;
}
int F_134 ( struct V_8 * V_9 , struct V_243 * V_195 )
{
F_23 ( & V_9 -> V_50 ) ;
V_9 -> V_245 = V_195 -> V_244 ;
F_18 ( V_9 , V_246 , V_248 , V_195 ) ;
F_135 ( 10 ) ;
F_24 ( & V_9 -> V_50 ) ;
return 0 ;
}
int F_136 ( struct V_154 * V_154 , void * V_192 , struct V_243 * V_195 )
{
struct V_46 * V_47 = V_192 ;
struct V_8 * V_9 ;
int V_99 ;
...
if ( ! F_138 ( & V_250 -> V_251 ) )
return - V_133 ;
F_18 ( V_9 , V_33 , V_252 , V_250 ) ;
return 0 ;
}
...
if ( ! F_138 ( & V_250 -> V_251 ) )
return - V_133 ;
F_18 ( V_9 , V_33 , V_253 , V_250 ) ;
return 0 ;
}
int F_140 ( struct V_154 * V_154 , void * V_192 , struct V_254 * V_255 )
{
struct V_8 * V_9 = ( (struct V_46 * ) V_192 ) -> V_9 ;
...
int F_141 ( struct V_154 * V_154 , void * V_192 , struct V_254 * V_255 )
{
struct V_8 * V_9 = ( (struct V_46 * ) V_192 ) -> V_9 ;
struct V_46 * V_47 = V_192 ;
int V_99 ;
...
static int F_142 ( struct V_260 * V_261 )
{
int V_4 ;
...
static const struct V_260 * F_144 ( unsigned int V_262 )
{
unsigned int V_4 ;
for ( V_4 = 0 ; V_4 < V_265 ; V_4 ++ )
...
int F_145 ( struct V_154 * V_154 , void * V_192 , struct V_210 * V_211 )
{
struct V_8 * V_9 = ( (struct V_46 * ) V_192 ) -> V_9 ;
struct V_46 * V_47 = V_192 ;
const struct V_260 * V_268 ;
V_268 = F_144 ( V_211 -> V_262 ) ;
if ( NULL == V_268 )
return - V_133 ;
switch ( V_211 -> V_262 ) {
case V_269 :
V_211 -> V_270 = V_9 -> V_51 [ V_47 -> V_52 ] . V_271 ;
break;
case V_272 :
V_211 -> V_270 = V_9 -> V_51 [ V_47 -> V_52 ] . V_273 ;
break;
case V_274 :
V_211 -> V_270 = V_9 -> V_51 [ V_47 -> V_52 ] . V_275 ;
break;
case V_276 :
V_211 -> V_270 = V_9 -> V_51 [ V_47 -> V_52 ] . V_277 ;
break;
}
return 0 ;
}
...
case V_279 :
case V_280 :
if ( V_211 -> V_270 < V_268 -> V_281 )
V_211 -> V_270 = V_268 -> V_281 ;
if ( V_211 -> V_270 > V_268 -> V_282 )
V_211 -> V_270 = V_268 -> V_282 ;
break;
default:
;
}
switch ( V_211 -> V_262 ) {
case V_269 :
V_9 -> V_51 [ V_88 ] . V_271 = V_211 -> V_270 ;
F_146 ( V_9 , V_211 -> V_270 , V_88 ) ;
break;
case V_272 :
V_9 -> V_51 [ V_88 ] . V_273 = V_211 -> V_270 ;
F_147 ( V_9 , V_211 -> V_270 , V_88 ) ;
break;
case V_274 :
V_9 -> V_51 [ V_88 ] . V_275 = V_211 -> V_270 ;
F_148 ( V_9 , V_211 -> V_270 , V_88 ) ;
break;
case V_276 :
V_9 -> V_51 [ V_88 ] . V_277 = V_211 -> V_270 ;
F_149 ( V_9 , V_211 -> V_270 , V_88 ) ;
break;
}
V_99 = 0 ;
return V_99 ;
...
F_111 ( V_9 , & V_268 , V_88 ) ;
}
}
int F_150 ( struct V_154 * V_154 , void * V_192 , struct V_284 * V_285 )
{
struct V_8 * V_9 = ( (struct V_46 * ) V_192 ) -> V_9 ;
if ( V_285 -> type != V_152 )
return - V_133 ;
V_285 -> V_286 . V_287 = V_285 -> V_286 . V_288 = 0 ;
V_285 -> V_286 . V_77 = 720 ;
V_285 -> V_286 . V_78 = V_9 -> V_32 == V_141 ? 576 : 480 ;
V_285 -> V_289 . V_290 =
...
int F_151 ( struct V_154 * V_154 , void * V_192 , struct V_293 * V_294 )
{
struct V_8 * V_9 = ( (struct V_46 * ) V_192 ) -> V_9 ;
struct V_46 * V_47 = V_192 ;
int V_99 ;
...
int F_152 ( struct V_154 * V_154 , void * V_192 , struct V_293 * V_294 )
{
return - V_133 ;
}
...
static long F_154 ( struct V_154 * V_154 , unsigned int V_295 ,
unsigned long V_296 )
{
struct V_46 * V_47 = V_154 -> V_157 ;
struct V_8 * V_9 = V_47 -> V_9 ;
...
static long F_157 ( struct V_154 * V_154 , unsigned int V_295 ,
unsigned long V_296 )
{
struct V_46 * V_47 = V_154 -> V_157 ;
struct V_8 * V_9 = V_47 -> V_9 ;
...
static long F_160 ( struct V_154 * V_154 , unsigned int V_295 ,
unsigned long V_296 )
{
struct V_46 * V_47 = V_154 -> V_157 ;
struct V_8 * V_9 = V_47 -> V_9 ;
...
static long F_163 ( struct V_154 * V_154 , unsigned int V_295 ,
unsigned long V_296 )
{
struct V_46 * V_47 = V_154 -> V_157 ;
struct V_8 * V_9 = V_47 -> V_9 ;
...
F_104 ( V_9 , V_77 , V_315 ) ;
break;
case V_320 :
V_299 -> V_327 = F_35 ( V_299 -> V_328 ) ;
break;
case V_321 :
F_33 ( V_299 -> V_328 , V_299 -> V_327 ) ;
break;
case V_322 :
V_270 =
F_164 ( & V_9 -> V_329 [ 0 ] ,
...
struct V_46 * V_47 = V_154 -> V_157 ;
if ( V_47 -> V_52 == V_332 ) {
V_331 = F_154 ( V_154 , V_295 , V_296 ) ;
return V_331 ;
} else if ( V_47 -> V_52 == V_333 ) {
V_331 = F_157 ( V_154 , V_295 , V_296 ) ;
return V_331 ;
} else if ( V_47 -> V_52 == V_334 ) {
V_331 = F_160 ( V_154 , V_295 , V_296 ) ;
V_331 = F_163 ( V_154 , V_295 , V_296 ) ;
return V_331 ;
}
return F_167 ( V_154 , V_295 , V_296 ) ;
}
