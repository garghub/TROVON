...
return - V_25 ;
F_14 () ;
V_7 = F_15 ( V_15 , sizeof( * V_22 ) , V_20 , V_21 , V_26 ) ;
if ( V_7 < 0 )
return V_7 ;
V_22 = F_16 ( V_15 ) ;
if ( V_20 [ V_27 ] == NULL )
...
struct V_9 * V_22 ;
struct V_14 * V_15 ;
V_15 = F_21 ( V_6 , V_33 , V_34 , V_1 , sizeof( * V_22 ) , 0 ) ;
if ( V_15 == NULL )
return - V_12 ;
V_22 = F_16 ( V_15 ) ;
V_22 -> V_35 = V_36 ;
...
return - V_25 ;
F_14 () ;
V_7 = F_15 ( V_15 , sizeof( * V_60 ) , V_20 , V_77 , V_78 ) ;
if ( V_7 < 0 )
return V_7 ;
V_60 = F_16 ( V_15 ) ;
if ( V_60 -> V_65 != V_66 || V_60 -> V_71 != V_72 )
return - V_28 ;
if ( V_20 [ V_74 ] == NULL || V_20 [ V_75 ] == NULL )
return - V_28 ;
V_58 = F_17 ( V_20 [ V_74 ] ) ;
if ( V_58 & 3 )
return - V_28 ;
V_3 = F_18 ( V_17 , F_35 ( V_20 [ V_75 ] ) ) ;
if ( V_3 == NULL )
return - V_30 ;
if ( V_15 -> V_31 == V_79 )
V_7 = F_36 ( V_3 , V_58 ) ;
...
int T_3 F_40 ( void )
{
int V_7 = F_41 ( V_80 , V_32 , F_11 , NULL ) ;
if ( V_7 )
return V_7 ;
F_41 ( V_80 , V_81 , F_11 , NULL ) ;
F_41 ( V_80 , V_82 , NULL , F_25 ) ;
F_41 ( V_80 , V_79 , F_34 , NULL ) ;
F_41 ( V_80 , V_83 , F_34 , NULL ) ;
F_41 ( V_80 , V_84 , NULL , F_38 ) ;
return 0 ;
}
