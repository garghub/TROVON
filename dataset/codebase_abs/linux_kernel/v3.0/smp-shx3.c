...
F_15 ( 104 + V_8 , F_1 ,
V_17 | V_18 , L_2 , ( void * ) ( long ) V_8 ) ;
for ( V_8 = 0 ; V_8 < V_15 ; V_8 ++ )
F_16 ( V_8 , true ) ;
}
static void F_17 ( unsigned int V_4 , unsigned long V_19 )
{
if ( F_18 () )
F_4 ( V_19 , F_19 ( V_4 ) ) ;
else
F_4 ( F_20 ( V_19 ) , F_19 ( V_4 ) ) ;
if ( ! ( F_3 ( F_9 ( V_4 ) ) & V_20 ) )
F_4 ( V_20 , F_9 ( V_4 ) ) ;
while ( ! ( F_3 ( F_9 ( V_4 ) ) & V_20 ) )
F_21 () ;
F_4 ( V_21 | V_10 , F_9 ( V_4 ) ) ;
}
...
{
unsigned long V_22 = 0xfe410070 + ( V_4 * 4 ) ;
F_24 ( V_4 >= 4 ) ;
F_4 ( 1 << ( V_3 << 2 ) , V_22 ) ;
}
...
static int T_2
F_26 ( struct V_23 * V_24 , unsigned long V_25 , void * V_26 )
{
