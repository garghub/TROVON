...
static int F_20 ( struct V_38 * V_39 , unsigned int V_52 )
{
F_18 ( & V_31 ) ;
if ( V_52 )
V_18 |= V_20 ;
...
static int F_23 ( struct V_38 * V_39 , struct V_53 * V_11 )
{
T_2 V_29 ;
memcpy ( & V_11 -> time , & V_36 , sizeof( struct V_1 ) ) ;
V_29 = V_18 ;
V_11 -> V_52 = ( V_29 & V_20 ) ? 1 : 0 ;
V_11 -> V_54 = ( V_29 & V_21 ) ? 1 : 0 ;
return 0 ;
}
static int F_24 ( struct V_38 * V_39 , struct V_53 * V_11 )
{
int V_16 ;
F_18 ( & V_31 ) ;
V_16 = F_5 ( & V_11 -> time ) ;
...
static int F_25 ( struct V_38 * V_39 , struct V_55 * V_56 )
{
F_26 ( V_56 , L_4 , ( T_2 ) V_57 ) ;
F_26 ( V_56 , L_5 , ( T_2 ) V_18 ) ;
return 0 ;
}
...
F_29 ( & V_26 -> V_39 , 1 ) ;
V_28 = F_30 ( V_26 -> V_60 , & V_26 -> V_39 , & V_61 ,
V_62 ) ;
if ( F_31 ( V_28 ) )
return F_32 ( V_28 ) ;
F_33 ( V_26 , V_28 ) ;
