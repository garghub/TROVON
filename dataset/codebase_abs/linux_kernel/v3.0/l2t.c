...
V_5 -> V_55 [ V_93 ] . V_29 = V_93 ;
V_5 -> V_55 [ V_93 ] . V_41 = V_71 ;
F_63 ( & V_5 -> V_55 [ V_93 ] . V_56 ) ;
F_52 ( & V_5 -> V_55 [ V_93 ] . V_6 , 0 ) ;
}
return V_5 ;
}
static inline void * F_64 ( struct V_94 * V_95 , T_4 V_96 )
{
struct V_1 * V_55 = V_95 -> V_97 ;
return V_96 >= V_50 ? NULL : & V_55 [ V_96 ] ;
}
static void * F_65 ( struct V_94 * V_95 , T_4 * V_96 )
{
return * V_96 ? F_64 ( V_95 , * V_96 - 1 ) : V_98 ;
}
static void * F_66 ( struct V_94 * V_95 , void * V_99 , T_4 * V_96 )
{
V_99 = F_64 ( V_95 , * V_96 ) ;
if ( V_99 )
++ * V_96 ;
...
static void F_67 ( struct V_94 * V_95 , void * V_99 )
{
}
static char F_68 ( const struct V_1 * V_2 )
{
switch ( V_2 -> V_41 ) {
case V_60 : return 'V' ;
case V_59 : return 'S' ;
...
static int F_69 ( struct V_94 * V_95 , void * V_99 )
{
if ( V_99 == V_98 )
F_70 ( V_95 , L_2
L_3 ) ;
...
sprintf ( V_100 , V_2 -> V_15 ? L_4 : L_5 , V_2 -> V_13 ) ;
F_71 ( V_95 , L_6 ,
V_2 -> V_29 , V_100 , V_2 -> V_37 ,
V_2 -> V_3 & V_101 , F_1 ( V_2 ) , V_2 -> V_35 ,
F_68 ( V_2 ) , F_40 ( & V_2 -> V_6 ) ,
V_2 -> V_18 ? V_2 -> V_18 -> V_62 -> V_102 : L_7 ) ;
F_38 ( & V_2 -> V_56 ) ;
}
return 0 ;
}
static int F_72 ( struct V_103 * V_103 , struct V_104 * V_104 )
{
int V_105 = F_73 ( V_104 , & V_106 ) ;
if ( ! V_105 ) {
struct V_19 * V_20 = V_103 -> V_107 ;
struct V_94 * V_95 = V_104 -> V_108 ;
V_95 -> V_97 = V_20 -> V_54 -> V_55 ;
}
return V_105 ;
}
