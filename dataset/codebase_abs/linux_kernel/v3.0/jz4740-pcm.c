...
int F_35 ( struct V_66 * V_62 , struct V_67 * V_68 ,
struct V_53 * V_54 )
{
int V_69 = 0 ;
if ( ! V_62 -> V_60 -> V_70 )
V_62 -> V_60 -> V_70 = & V_71 ;
if ( ! V_62 -> V_60 -> V_72 )
V_62 -> V_60 -> V_72 = F_36 ( 32 ) ;
if ( V_68 -> V_73 -> V_74 . V_75 ) {
V_69 = F_31 ( V_54 ,
V_12 ) ;
if ( V_69 )
goto V_15;
}
if ( V_68 -> V_73 -> V_76 . V_75 ) {
V_69 = F_31 ( V_54 ,
V_27 ) ;
if ( V_69 )
goto V_15;
...
static int T_3 F_37 ( struct V_77 * V_78 )
{
return F_38 ( & V_78 -> V_60 , & V_79 ) ;
}
static int T_4 F_39 ( struct V_77 * V_78 )
{
F_40 ( & V_78 -> V_60 ) ;
return 0 ;
}
