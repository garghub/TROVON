...
V_38 = F_13 ( V_6 -> V_52 -> V_53 , V_43 , V_35 ,
V_45 , 0 ) ;
if ( F_14 ( V_38 ) )
return ( void * ) V_38 ;
V_31 = 0 ;
F_15 (chunk, &umem->chunk_list, list)
V_31 += V_50 -> V_54 ;
...
V_31 = 0 ;
F_15 (chunk, &umem->chunk_list, list) {
for ( V_20 = 0 ; V_20 < V_50 -> V_54 ; V_20 ++ ) {
void * V_40 ;
V_40 = F_17 ( F_18 ( & V_50 -> V_55 [ V_20 ] ) ) ;
if ( ! V_40 ) {
V_10 = F_5 ( - V_51 ) ;
goto V_13;
}
...
int F_23 ( struct V_2 * V_3 , T_1 * V_55 ,
int V_62 , T_1 V_34 )
{
...
T_2 V_65 ;
int V_10 ;
if ( V_62 > V_59 -> V_9 . V_37 ) {
V_10 = - V_51 ;
goto V_13;
}
V_63 = & F_11 ( V_3 -> V_32 ) -> V_18 ;
F_24 ( & V_63 -> V_66 , V_64 ) ;
V_59 -> V_9 . V_33 = V_34 ;
V_59 -> V_9 . V_34 = V_34 ;
V_65 = 1 << V_59 -> V_61 ;
V_59 -> V_9 . V_35 = V_62 * V_65 ;
V_19 = 0 ;
V_31 = 0 ;
V_65 = 1 << V_59 -> V_61 ;
for ( V_20 = 0 ; V_20 < V_62 ; V_20 ++ ) {
V_59 -> V_9 . V_22 [ V_19 ] -> V_39 [ V_31 ] . V_40 = ( void * ) V_55 [ V_20 ] ;
V_59 -> V_9 . V_22 [ V_19 ] -> V_39 [ V_31 ] . V_35 = V_65 ;
if ( ++ V_31 == V_21 ) {
V_19 ++ ;
V_31 = 0 ;
}
...
int F_26 ( struct V_67 * V_68 )
{
struct V_1 * V_59 ;
struct V_17 * V_63 ;
unsigned long V_64 ;
F_15 (fmr, fmr_list, ibfmr.list) {
V_63 = & F_11 ( V_59 -> V_3 . V_32 ) -> V_18 ;
F_24 ( & V_63 -> V_66 , V_64 ) ;
V_59 -> V_9 . V_33 = 0 ;
V_59 -> V_9 . V_34 = 0 ;
V_59 -> V_9 . V_35 = 0 ;
