...
static int F_32 ( struct V_64 * V_59 , struct V_33 * V_65 ,
struct V_55 * V_3 )
{
int V_23 = 0 ;
if ( ! V_59 -> V_57 -> V_66 )
V_59 -> V_57 -> V_66 = & V_67 ;
if ( ! V_59 -> V_57 -> V_68 )
V_59 -> V_57 -> V_68 = F_33 ( 32 ) ;
if ( V_65 -> V_69 -> V_70 . V_71 ) {
V_23 = F_28 ( V_3 ,
V_19 ) ;
if ( V_23 )
goto V_40;
}
if ( V_65 -> V_69 -> V_72 . V_71 ) {
V_23 = F_28 ( V_3 ,
V_73 ) ;
if ( V_23 )
goto V_40;
...
static int T_3 F_34 ( struct V_74 * V_75 )
{
return F_35 ( & V_75 -> V_57 , & V_76 ) ;
}
static int T_4 F_36 ( struct V_74 * V_75 )
{
F_37 ( & V_75 -> V_57 ) ;
return 0 ;
}
