...
int F_52 ( T_1 V_1 , T_1 V_2 ,
T_2 V_3 , T_1 V_76 ,
struct V_55 * V_56 , int V_77 , struct V_71 * V_70 ,
unsigned V_47 )
{
struct V_71 V_78 ;
T_1 V_74 , V_75 ;
...
int F_55 ( int (* F_56)( T_1 V_88 , T_1 V_1 , T_1 V_2 ,
T_2 V_3 , T_1 V_8 ,
T_1 * V_89 ) ,
T_1 V_90 , T_1 V_1 , T_1 V_2 ,
T_2 V_3 , T_1 V_8 )
{
struct V_91 * V_92 ;
int V_12 = 0 ;
V_92 = F_57 ( sizeof( * V_92 ) , V_52 ) ;
if ( ! V_92 ) {
V_12 = - V_93 ;
goto V_51;
}
...
static inline int F_58 ( T_1 V_95 , T_1 V_96 )
{
return ( V_95 == V_96 || V_95 == V_97 || V_96 == V_97 ) ;
}
static int F_59 ( T_1 V_88 , T_1 V_8 , T_1 V_1 , T_1 V_2 , T_2 V_3 ,
T_1 V_61 )
{
int V_44 , V_12 = 0 ;
unsigned long V_64 ;
struct V_22 * V_68 , * V_32 , * V_98 = NULL ;
struct V_33 * V_34 ;
struct V_35 * V_36 ;
T_4 * V_48 ;
V_32 = F_38 () ;
...
F_41 ( V_32 , V_1 , V_2 , V_3 , & V_98 -> V_57 . V_56 ) ;
switch ( V_88 ) {
case V_101 :
V_32 -> V_57 . V_56 . V_79 |= V_8 ;
break;
case V_102 :
case V_103 :
V_32 -> V_57 . V_56 . V_79 &= ~ V_8 ;
break;
case V_104 :
V_32 -> V_57 . V_56 . V_81 |= V_8 ;
break;
case V_105 :
V_32 -> V_57 . V_56 . V_81 &= ~ V_8 ;
break;
case V_106 :
V_32 -> V_57 . V_56 . V_80 |= V_8 ;
break;
case V_107 :
V_32 -> V_57 . V_56 . V_80 &= ~ V_8 ;
break;
...
int V_12 = 0 , V_108 ;
F_60 () ;
for ( V_92 = V_94 ; V_92 ; V_92 = V_92 -> V_36 ) {
if ( V_92 -> V_90 & V_109 ) {
V_108 = V_92 -> F_56 ( V_109 ,
0 , 0 , 0 , 0 , NULL ) ;
if ( ! V_12 )
V_12 = V_108 ;
}
...
if ( F_63 ( ! V_32 ) ) {
F_19 () ;
F_64 ( V_1 , V_2 , V_3 , V_56 ) ;
F_16 () ;
V_32 = F_48 ( V_1 , V_2 , V_3 , V_56 ) ;
} else {
...
T_1 V_76 , struct V_71 * V_114 ,
unsigned V_47 )
{
struct V_55 V_56 ;
int V_12 , V_115 ;
V_12 = F_62 ( V_1 , V_2 , V_3 , V_76 , 0 , & V_56 ) ;
V_115 = F_52 ( V_1 , V_2 , V_3 , V_76 , & V_56 , V_12 , V_114 ,
V_47 ) ;
if ( V_115 )
return V_115 ;
return V_12 ;
