...
switch ( V_7 -> V_115 ) {
case V_116 :
return ! F_37 ( V_114 -> V_117 , V_7 -> V_118 ) ;
case V_119 :
return ! F_37 ( V_114 -> V_120 , V_7 -> V_118 ) ;
default:
return 1 ;
}
}
...
{
struct V_74 * V_75 = F_21 ( V_73 ) ;
struct V_113 * V_77 = (struct V_113 * ) F_39 ( V_75 ) ;
struct V_122 * V_123 = F_40 ( V_75 ) ;
struct V_124 * V_125 = F_41 ( V_75 ) ;
...
F_3 ( V_125 -> V_20 ) , V_97 ) ;
F_47 ( V_65 , 0 , V_73 -> V_137 ,
( void * ) V_123 -> V_138 - ( void * ) V_75 , V_126 ) ;
F_48 ( V_7 , false , V_128 , V_126 ) ;
memcpy ( F_49 ( V_65 ) , V_97 , sizeof( * V_97 ) ) ;
F_50 ( V_7 -> V_64 , V_65 ) ;
V_7 -> V_139 -- ;
V_73 -> V_137 = NULL ;
}
...
T_1 V_146 ;
V_140 . V_111 = 0 ;
V_140 . V_147 = F_53 ( V_125 -> V_148 ) ;
V_140 . V_40 = ( V_123 -> V_149 & V_150 ) ?
V_45 : V_41 ;
V_140 . V_151 =
F_54 ( F_22 ( V_123 -> V_152 ) ,
V_140 . V_40 ) ;
...
V_140 . signal , T_6 ,
T_7 ) ;
V_114 = (struct V_113 * ) F_39 ( V_75 ) ;
V_146 = F_36 ( V_7 , V_114 ) ;
F_56 ( V_7 , L_22 ,
V_146 ? '*' : ' ' ,
F_22 ( V_123 -> V_152 ) ,
V_140 . signal , V_140 . signal ,
V_140 . V_84 ) ;
F_57 ( V_7 , F_22 ( V_123 -> V_126 ) ,
V_114 ) ;
if ( V_146 ) {
V_7 -> V_46 . V_162 =
F_3 ( V_125 -> V_163 ) ;
V_7 -> V_46 . V_164 = F_53 ( V_125 -> V_148 ) ;
...
V_92 = F_59 ( F_3 ( V_170 -> V_173 ) ) ;
if ( ( V_92 >= V_174 ) || ( V_92 < 0 ) ) {
F_5 ( V_7 , L_23 ,
V_174 ) ;
return - V_175 ;
}
V_170 -> V_176 [ V_92 ] . V_166 = F_60 ( V_166 ) ;
V_170 -> V_176 [ V_92 ] . V_126 = F_60 ( V_126 ) ;
V_92 ++ ;
V_170 -> V_173 = F_60 ( F_61 ( V_92 ) |
F_62 ( V_168 ) ) ;
return 0 ;
}
void F_63 ( struct V_6 * V_7 , struct V_54 * V_55 )
{
...
if ( V_179 )
F_64 ( V_178 ,
F_65 ( & V_55 -> V_180 [ V_53 ] , V_181 ) ,
F_66 ( & V_55 -> V_180 [ V_53 ] , V_126 ) ,
V_182 ) ;
for ( V_8 = 1 ; V_8 < V_179 ; V_8 ++ )
F_64 ( V_178 , F_3 ( V_170 -> V_176 [ V_8 ] . V_166 ) ,
...
int V_185 , int V_186 )
{
T_3 V_187 = F_69 ( V_7 -> V_64 , V_79 ) -> V_187 ;
T_3 V_1 = F_70 ( V_187 & 0xffff , V_19 ) ;
T_3 V_188 ;
int V_2 ;
T_1 V_189 ;
T_1 V_190 ;
...
static T_1 F_73 ( struct V_6 * V_7 , int V_185 , T_3 V_197 )
{
unsigned long V_198 ;
struct V_199 * V_200 ;
if ( V_185 == V_201 )
return V_201 ;
F_74 ( & V_7 -> V_202 , V_198 ) ;
V_200 = & V_7 -> V_203 [ V_185 ] ;
V_200 -> V_204 . V_204 . V_205 = V_206 ;
V_200 -> V_204 . V_207 = F_75 ( V_197 ) ;
V_200 -> V_204 . V_208 = V_209 ;
F_76 ( V_7 , & V_200 -> V_204 , V_210 ) ;
F_77 ( & V_7 -> V_202 , V_198 ) ;
F_72 ( V_7 , L_27 ,
V_185 , V_197 ) ;
return V_185 ;
}
...
V_212 ,
~ V_213 ) ;
F_80 ( V_7 , V_214 , V_215 ,
V_216 , 5000 ) ;
}
static int F_81 ( struct V_6 * V_7 , struct V_217 * V_218 )
{
F_82 ( V_7 , F_83 ( 0 ) , V_218 -> V_219 ) ;
F_82 ( V_7 , F_84 ( 0 ) ,
V_218 -> V_220 ) ;
F_82 ( V_7 , F_85 ( 0 ) , 0 ) ;
F_82 ( V_7 , F_86 ( 0 ) ,
...
F_89 ( V_7 , V_232 , 0x01 ) ;
F_89 ( V_7 , V_233 , 0x3f ) ;
F_89 ( V_7 , V_234 , 0x010000 ) ;
F_89 ( V_7 , V_235 , 0x030002 ) ;
F_89 ( V_7 , V_236 , 0x000004 ) ;
F_89 ( V_7 , V_237 , 0x000005 ) ;
F_82 ( V_7 , V_238 ,
V_7 -> V_46 . V_239 ) ;
F_82 ( V_7 , V_240 ,
V_241 |
...
F_106 ( V_7 ) ;
F_81 ( V_7 , V_218 ) ;
F_82 ( V_7 , F_85 ( 0 ) , V_218 -> V_282 & ~ 7 ) ;
V_248 = F_90 ( V_7 ) ;
if ( V_248 )
return V_248 ;
F_107 ( V_283 , & V_7 -> V_20 ) ;
return 0 ;
}
...
static int F_115 ( int V_285 , int V_286 )
{
return ( V_285 - V_286 ) * ( - 11 ) / 100 ;
}
static inline int F_116 ( int V_107 )
{
return ( ( V_107 < - 260 ) || ( V_107 > 25 ) ) ? 1 : 0 ;
}
int F_117 ( struct V_6 * V_7 )
{
return F_118 ( V_7 , V_287 ) ;
}
...
if ( V_291 < 0 ) {
F_121 ( V_7 , L_43 , V_291 ) ;
V_291 = - V_291 ;
} else if ( V_291 == 0 )
F_121 ( V_7 , L_44 ) ;
else
F_121 ( V_7 , L_45 , V_291 ) ;
if ( V_291 < V_292 ) {
F_121 ( V_7 , L_46 ) ;
return 0 ;
}
...
static inline T_1 F_122 ( int V_53 )
{
if ( V_53 < 0 )
return 0 ;
if ( V_53 >= V_293 )
...
static void F_123 ( struct V_6 * V_7 , T_2 V_294 ,
...
V_301 = F_70 ( V_297 -> V_304 , V_295 [ V_305 ] ) ;
V_301 = F_70 ( V_301 , V_7 -> V_306 ) ;
V_300 -> V_307 = V_301 ;
...
V_8 ++ , ++ V_308 ) {
int V_331 ;
V_301 = F_70 ( V_297 -> V_332 , V_295 [ V_8 ] ) ;
...
static int F_131 ( struct V_296 * V_297 )
{
T_10 V_339 ;
#if 0
...
int F_134 ( struct V_6 * V_7 , T_10 V_301 )
{
struct V_296 * V_297 ;
T_10 V_339 ;
T_1 V_342 ;
...
F_121 ( V_7 , L_55 , V_301 ) ;
V_7 -> V_306 = V_301 ;
for ( V_8 = 0 ; V_8 < V_7 -> V_346 ; V_8 ++ ) {
V_297 = & V_7 -> V_347 [ V_8 ] ;
V_342 = F_133 ( V_297 ) ;
V_339 = F_131 ( V_297 ) ;
V_339 = F_70 ( V_301 , V_339 ) ;
...
V_375 -> V_93 &=
~ ( V_380 | V_381 ) ;
V_375 -> V_93 |= F_140 ( V_7 ) ;
V_248 = F_141 ( V_7 , V_354 ) ;
if ( V_248 ) {
F_5 ( V_7 , L_58 ) ;
return - V_175 ;
}
...
V_248 = F_147 ( V_7 , V_7 -> V_386 , true ) ;
if ( V_248 ) {
F_5 ( V_7 , L_69 , V_248 ) ;
return V_248 ;
}
...
static void F_151 ( struct V_392 * V_393 )
{
struct V_6 * V_7 = F_152 ( V_393 , struct V_6 ,
V_46 . V_389 . V_393 ) ;
if ( F_126 ( V_378 , & V_7 -> V_20 ) )
return;
F_153 ( & V_7 -> V_394 ) ;
...
static T_3 F_155 ( struct V_6 * V_7 ,
...
T_9 V_422 ( V_349 ) ;
int V_248 ;
T_10 V_423 = F_70 ( V_297 -> V_340 ,
V_295 [ V_1 ] ) ;
V_417 = & V_297 -> V_308 [ V_1 ] ;
V_248 = F_156 ( V_7 , V_423 ,
V_297 -> V_328 ,
& V_349 ) ;
if ( V_248 ) {
F_5 ( V_7 , L_76 ) ;
...
int V_248 ;
F_82 ( V_7 , F_86 ( 0 ) , 0 ) ;
V_248 = F_113 ( V_7 , V_425 ,
V_426 , 1000 ) ;
if ( V_248 < 0 )
F_5 ( V_7 , L_77 ) ;
return 0 ;
}
int F_161 ( struct V_6 * V_7 , struct V_54 * V_55 )
{
int V_52 = V_55 -> V_57 . V_358 ;
struct V_427 * V_428 = V_7 -> V_46 . V_429 ;
V_428 -> V_430 [ V_52 ] = F_60 ( ( T_2 ) V_55 -> V_57 . V_431 ) ;
F_82 ( V_7 , F_162 ( V_52 ) , 0 ) ;
F_82 ( V_7 , F_163 ( V_52 ) , 0 ) ;
F_82 ( V_7 , F_112 ( V_52 ) ,
V_432 |
V_433 |
V_434 |
...
static T_3 F_164 ( T_1 V_437 , T_3 V_126 )
{
switch ( V_437 ) {
case V_384 :
...
static T_3 F_165 ( const struct V_440 * V_184 ,
T_1 * V_361 )
{
...
if ( V_452 )
* V_452 = V_201 ;
V_253 = F_167 ( V_7 , V_354 , V_166 , 0 , NULL , & V_185 ) ;
if ( V_253 ) {
F_5 ( V_7 , L_78 , V_166 ) ;
return V_253 ;
}
...
int V_253 ;
if ( V_457 ) {
V_253 = F_166 ( V_7 , V_456 -> V_461 . V_118 ,
& V_459 -> V_462 ) ;
if ( V_253 )
return V_253 ;
F_73 ( V_7 , V_459 -> V_462 ,
( V_7 -> V_40 == V_41 ) ?
V_463 : V_464 ) ;
F_169 ( V_7 -> V_64 , V_459 -> V_462 ) ;
return 0 ;
}
return F_170 ( V_7 , V_459 -> V_462 ,
V_456 -> V_461 . V_118 ) ;
}
...
for ( V_8 = 0 ; V_8 < F_171 ( V_3 ) ; V_8 ++ ) {
V_53 = V_3 [ V_8 ] . V_470 ;
V_469 [ V_53 ] . V_207 =
F_172 ( V_3 [ V_8 ] . V_17 , 0 ) ;
...
V_467 . V_476 = 0 ;
V_248 = F_129 ( V_7 , V_477 , sizeof( V_467 ) ,
& V_467 ) ;
if ( V_248 )
return V_248 ;
V_467 . V_476 = 1 ;
return F_129 ( V_7 , V_477 , sizeof( V_467 ) ,
& V_467 ) ;
}
...
unsigned int F_177 ( struct V_6 * V_7 ,
...
F_15 ( V_503 > V_508 ) ;
V_502 -> V_504 . V_126 = F_75 ( ( T_3 ) V_503 ) ;
V_502 -> V_504 . V_2 = V_2 ;
...
V_7 -> V_513 [ V_515 ] = F_51 ;
}
void F_180 ( struct V_6 * V_7 )
{
F_181 ( & V_7 -> V_46 . V_389 ,
F_151 ) ;
}
void F_182 ( struct V_6 * V_7 )
{
F_183 ( & V_7 -> V_46 . V_389 ) ;
}
...
T_2 V_520 ;
F_7 ( V_7 , L_82 ) ;
V_520 = F_185 ( V_7 , V_521 ) ;
for ( V_519 = V_522 ;
V_519 < V_522 + V_126 ;
V_519 += sizeof( T_2 ) , V_516 ++ ) {
V_520 = F_185 ( V_7 , V_519 ) ;
if ( V_520 != F_3 ( * V_516 ) ) {
F_5 ( V_7 , L_83
L_84 ,
V_522 ,
...
F_89 ( V_7 , V_535 , V_525 ) ;
F_89 ( V_7 , V_536 , V_526 ) ;
F_89 ( V_7 , V_537 , V_527 ) ;
F_89 ( V_7 , V_538 , V_528 ) ;
for ( V_530 = V_522 ;
V_530 < V_522 + V_126 ;
...
F_89 ( V_7 , V_540 ,
V_541 ) ;
F_89 ( V_7 , V_521 , V_126 / sizeof( T_2 ) ) ;
F_89 ( V_7 , V_542 ,
V_543 ) ;
for ( V_8 = 0 ; V_8 < 100 ; V_8 ++ ) {
V_529 = F_185 ( V_7 , V_542 ) ;
if ( ! ( V_529 & V_543 ) )
break;
F_97 ( 10 ) ;
}
