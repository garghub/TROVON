...
V_98 -> V_106 - V_98 -> V_105 + 1 , L_11 ) )
return - V_107 ;
V_101 = ( unsigned long ) F_55 ( & V_91 -> V_104 , V_98 -> V_105 ,
V_98 -> V_106 - V_98 -> V_105 + 1 ) ;
if ( ! V_101 )
return - V_107 ;
...
F_56 ( L_12 , V_101 , V_99 ) ;
V_96 = F_57 ( & V_124 , V_94 , 1 ) ;
if ( ! V_96 )
return - V_125 ;
V_96 -> V_126 [ 0 ] -> V_79 = V_101 ;
V_100 = F_58 ( V_96 , & V_124 , V_94 ) ;
if ( V_100 ) {
F_59 ( V_96 ) ;
return V_100 ;
}
...
static int T_8 F_61 ( struct V_90 * V_91 )
{
struct V_95 * V_96 = F_62 ( V_91 ) ;
F_63 ( V_96 ) ;
return 0 ;
}
static int F_64 ( struct V_90 * V_104 )
{
struct V_95 * V_96 = F_62 ( V_104 ) ;
T_5 * V_4 = V_96 -> V_126 [ 0 ] ;
F_39 ( V_4 ) ;
return 0 ;
}
static int T_7 F_65 ( void )
{
return F_66 ( & V_127 , F_51 ) ;
}
