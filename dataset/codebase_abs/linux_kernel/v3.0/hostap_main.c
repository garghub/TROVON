...
F_79 ( V_7 ) ;
if ( V_10 ) {
V_10 -> V_206 . V_207 = & V_10 -> V_207 ;
V_7 -> V_206 = & V_10 -> V_206 ;
}
V_7 -> V_208 = & V_209 ;
V_7 -> V_210 = V_211 ;
switch( type ) {
...
V_227 ,
& V_226 , sizeof( V_226 ) , 1 ) >= 0 ) {
V_3 -> V_228 = ( V_229 ) F_88 ( V_226 . V_230 ) ;
V_3 -> V_231 = ( V_229 ) F_88 ( V_226 . V_232 ) ;
V_3 -> V_233 = ( V_229 ) F_88 ( V_226 . V_234 ) ;
V_3 -> V_235 = V_141 ;
} else
V_11 = - 1 ;
} else {
if ( V_3 -> F_26 -> V_94 ( V_3 -> V_7 , V_236 ,
& V_226 , sizeof( V_226 ) , 1 ) >= 0 ) {
V_3 -> V_228 = F_88 ( V_226 . V_230 ) ;
V_3 -> V_231 = F_89 (
F_88 ( V_226 . V_232 ) ) ;
V_3 -> V_233 = F_89 (
F_88 ( V_226 . V_234 ) ) ;
...
int F_90 ( T_2 * V_3 , T_1 * V_237 , T_3 V_238 ,
T_1 * V_239 , T_5 V_240 )
{
struct V_51 * V_161 ;
struct V_241 * V_242 ;
struct V_243 * V_244 ;
struct V_1 * V_7 = V_3 -> V_7 ;
V_161 = F_91 ( V_245 + V_240 ) ;
if ( V_161 == NULL )
return - V_46 ;
V_242 = (struct V_241 * )
F_92 ( V_161 , V_245 ) ;
memset ( V_242 , 0 , V_245 ) ;
V_242 -> V_142 = F_33 ( V_246 | V_238 ) ;
memcpy ( V_242 -> V_247 , V_237 , V_15 ) ;
memcpy ( V_242 -> V_248 , V_7 -> V_14 , V_15 ) ;
memcpy ( V_242 -> V_249 , V_237 , V_15 ) ;
if ( V_239 )
memcpy ( F_92 ( V_161 , V_240 ) , V_239 , V_240 ) ;
V_244 = (struct V_243 * ) V_161 -> V_61 ;
...
int F_57 ( T_2 * V_3 , T_3 V_252 )
{
union V_253 V_254 ;
int V_11 ;
T_4 V_64 = F_33 ( V_252 ) ;
if ( V_3 -> V_70 != V_75 ||
memcmp ( V_3 -> V_249 , L_45 , V_15 ) == 0 ||
memcmp ( V_3 -> V_249 , L_46 , V_15 ) == 0 )
return 0 ;
V_11 = F_90 ( V_3 , V_3 -> V_249 , V_255 ,
( T_1 * ) & V_64 , 2 ) ;
memset ( V_254 . V_256 . V_188 , 0 , V_15 ) ;
F_96 ( V_3 -> V_7 , V_257 , & V_254 , NULL ) ;
return V_11 ;
}
static int T_6 F_97 ( void )
{
if ( V_258 . V_259 != NULL ) {
V_260 = F_98 ( L_47 , V_258 . V_259 ) ;
if ( ! V_260 )
F_10 ( V_23 L_48
L_49 ) ;
} else
