...
V_4 -> V_36 = 0xfffe4000 ;
V_4 -> V_1 = V_5 ;
V_30 . V_37 = ( volatile unsigned char * ) 0xfffe4000 ;
V_30 . V_38 = ( volatile unsigned char * ) 0xfffe4001 ;
V_15 = F_4 ( V_4 ) ;
V_15 -> V_39 = 0xff ;
V_15 -> V_40 = 0 ;
V_15 -> V_41 = V_42 ;
F_11 ( V_4 , V_30 , F_3 , F_8 , V_43 ) ;
if ( F_12 ( V_5 , F_1 , 0 ,
L_2 , V_4 ) )
goto V_44;
if ( F_12 ( V_45 , F_1 , 0 ,
...
{
F_16 ( V_10 -> V_12 -> V_13 -> V_48 ) ;
F_17 ( V_10 ) ;
F_18 ( V_10 -> V_12 -> V_13 -> V_48 ) ;
return V_49 ;
}
