...
V_102 += V_120 -> V_102 ;
V_103 += V_120 -> V_103 ;
V_109 = F_60 ( V_109 , V_120 -> V_109 ) ;
V_120 = F_61 ( V_120 ) ;
} while ( V_120 != V_81 );
V_102 += V_114 -> V_102 ;
V_103 += V_114 -> V_103 ;
F_62 ( V_81 , & V_106 , & V_107 ) ;
V_109 = F_60 ( V_109 , V_114 -> V_109 ) ;
}
V_97 = F_63 ( V_81 , V_21 ) ;
...
V_84 ? F_71 ( V_84 ) : 0 ,
V_110 ,
V_84 ? ( V_98 ? V_84 -> V_125 : 1 ) : 0 ,
V_84 ? ( V_98 ? V_84 -> V_126 : 1 ) : 0 ,
( V_98 && V_84 ) ? V_84 -> V_127 : 0 ,
V_88 ,
V_87 ,
V_81 -> V_59 . signal . V_114 [ 0 ] & 0x7fffffffUL ,
V_81 -> V_61 . V_114 [ 0 ] & 0x7fffffffUL ,
V_94 . V_114 [ 0 ] & 0x7fffffffUL ,
V_95 . V_114 [ 0 ] & 0x7fffffffUL ,
V_89 ,
0UL ,
0UL ,
V_81 -> V_128 ,
...
int F_74 ( struct V_1 * V_2 , struct V_20 * V_21 ,
struct V_22 * V_22 , struct V_3 * V_81 )
{
...
struct V_22 * V_22 , struct V_3 * V_81 )
{
unsigned long V_11 = 0 , V_131 = 0 , V_132 = 0 , V_133 = 0 , V_134 = 0 ;
struct V_83 * V_84 = F_46 ( V_81 ) ;
if ( V_84 ) {
V_11 = F_77 ( V_84 , & V_132 , & V_133 , & V_134 , & V_131 ) ;
F_48 ( V_84 ) ;
}
F_17 ( V_2 , L_30 ,
V_11 , V_131 , V_132 , V_133 , V_134 ) ;
return 0 ;
}
