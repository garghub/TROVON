...
if ( V_6 -> V_7 != V_6 -> V_75 )
F_4 ( V_4 , V_9 , V_6 -> V_75 ) ;
F_34 ( V_6 ) ;
return 0 ;
}
static int F_24 ( struct V_3 * V_4 , T_6 V_16 )
{
int V_30 = F_37 ( V_4 , V_16 ) ;
if ( V_30 < 0 )
return V_30 ;
return F_38 ( V_30 ) ;
}
static int F_4 ( struct V_3 * V_4 , T_6 V_16 , T_1 V_79 )
{
return F_39 ( V_4 , V_16 , F_38 ( V_79 ) ) ;
}
...
int V_27 ;
F_16 ( & V_6 -> V_32 ) ;
if ( F_40 ( V_80 , V_6 -> V_81 + V_82 ) || ! V_6 -> V_83 ) {
V_27 = F_24 ( V_4 , V_84 ) ;
if ( V_27 < 0 ) {
V_30 = F_41 ( V_27 ) ;
goto abort;
