...
long F_20 ( unsigned long V_8 , unsigned long V_21 , T_1 T_7 * V_34 )
{
struct V_1 * V_2 = V_22 -> V_2 ;
struct V_3 * V_4 = & V_2 -> V_5 . V_4 ;
T_1 * * V_23 , * V_24 ;
...
unsigned long V_26 , V_27 ;
int V_35 ;
if ( ( V_8 & ~ V_36 ) || ( V_21 & ~ V_36 ) ||
V_8 >= V_37 || V_21 >= V_37 || V_8 + V_21 > V_37 )
return - V_38 ;
if ( F_21 ( V_2 , V_8 , V_21 ) )
return - V_38 ;
if ( ! V_34 ) {
F_16 ( V_8 , V_21 ) ;
return 0 ;
}
if ( ! F_22 ( V_39 , V_34 , ( V_21 >> V_31 ) * sizeof( T_1 ) ) )
return - V_40 ;
F_17 ( & V_2 -> V_28 ) ;
...
F_19 ( & V_2 -> V_28 ) ;
V_35 = - V_40 ;
if ( F_27 ( V_24 , V_34 , V_25 * sizeof( T_1 ) ) )
goto V_44;
V_34 += V_25 ;
F_17 ( & V_2 -> V_28 ) ;
F_4 ( V_2 , V_8 , V_25 ) ;
