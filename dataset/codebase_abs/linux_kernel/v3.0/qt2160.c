...
{
struct V_11 * V_12 =
F_20 ( V_33 , struct V_11 , V_29 . V_33 ) ;
F_8 ( & V_12 -> V_2 -> V_9 , L_9 ) ;
F_7 ( V_12 ) ;
F_16 ( V_12 ) ;
}
static int T_4 F_21 ( struct V_1 * V_2 , T_1 V_34 )
{
int V_18 ;
V_18 = F_3 ( V_2 , V_34 ) ;
if ( V_18 ) {
...
static int T_4 F_22 ( struct V_1 * V_2 , T_1 V_34 , T_1 V_10 )
{
int error ;
error = F_3 ( V_2 , V_34 ) ;
if ( error ) {
...
F_24 ( & V_2 -> V_9 , L_14 ,
V_36 >> 4 , V_36 & 0xf , V_37 ) ;
return true ;
}
static int T_4 F_25 ( struct V_1 * V_2 ,
const struct V_42 * V_35 )
{
struct V_11 * V_12 ;
struct V_13 * V_14 ;
int V_19 ;
...
if ( ! F_23 ( V_2 ) )
return - V_44 ;
V_12 = F_27 ( sizeof( struct V_11 ) , V_45 ) ;
V_14 = F_28 () ;
if ( ! V_12 || ! V_14 ) {
F_4 ( & V_2 -> V_9 , L_16 ) ;
error = - V_46 ;
...
V_14 -> V_35 . V_49 = V_50 ;
V_14 -> V_51 = V_12 -> V_24 ;
V_14 -> V_52 = sizeof( V_12 -> V_24 [ 0 ] ) ;
V_14 -> V_53 = F_31 ( V_54 ) ;
F_32 ( V_55 , V_14 -> V_56 ) ;
F_33 ( V_57 , V_14 -> V_56 ) ;
for ( V_19 = 0 ; V_19 < F_31 ( V_54 ) ; V_19 ++ ) {
V_12 -> V_24 [ V_19 ] = V_54 [ V_19 ] ;
F_32 ( V_54 [ V_19 ] , V_14 -> V_58 ) ;
}
F_33 ( V_59 , V_14 -> V_58 ) ;
error = F_22 ( V_2 , V_60 , 1 ) ;
if ( error ) {
F_4 ( & V_2 -> V_9 , L_18 ) ;
goto V_47;
}
