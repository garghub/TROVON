...
static int T_5 F_24 ( struct V_1 * V_2 )
{
...
static int T_5 F_25 ( struct V_1 * V_2 )
{
T_2 V_70 ;
int V_71 ;
F_1 ( V_2 , V_18 , V_24 ) ;
...
static int T_5 F_26 ( struct V_73 * V_74 )
{
int V_14 , V_20 = 0 ;
struct V_1 * V_2 ;
struct V_75 * V_76 ;
...
V_2 -> V_66 = V_76 -> V_89 ;
V_2 -> V_67 = V_76 -> V_67 ;
if ( ! F_31 ( V_2 -> V_86 , V_2 -> V_88 , V_78 -> V_90 ) ) {
F_17 ( V_2 -> V_12 , L_15 ) ;
goto V_85;
}
V_2 -> V_7 = F_32 ( V_2 -> V_86 , V_2 -> V_88 ) ;
F_33 ( & V_2 -> V_16 ) ;
V_2 -> V_14 = V_14 ;
V_20 = F_34 ( V_2 -> V_14 , F_11 , 0 , V_91 , V_2 ) ;
if ( V_20 < 0 ) {
F_17 ( V_2 -> V_12 , L_16 ) ;
goto V_92;
}
...
V_2 -> V_21 = V_94 ;
V_2 -> V_21 . V_12 . V_95 = & V_74 -> V_12 ;
V_2 -> V_21 . V_96 = V_74 -> V_97 >= 0 ? V_74 -> V_97 : 0 ;
F_35 ( & V_2 -> V_21 , V_2 ) ;
F_36 ( V_74 , V_2 ) ;
V_20 = F_37 ( & V_2 -> V_21 ) ;
if ( V_20 < 0 ) {
...
V_92:
F_40 ( V_2 -> V_7 ) ;
F_41 ( V_2 -> V_86 , V_2 -> V_88 ) ;
V_85:
F_42 ( V_2 ) ;
V_81:
return V_20 ;
}
static int T_6 F_43 ( struct V_73 * V_74 )
{
