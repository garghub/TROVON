...
static void F_89 ( struct V_179 * V_180 ,
struct V_181 * V_182 )
{
struct V_1 * V_2 = V_180 -> V_21 ;
unsigned int V_25 ;
F_90 ( V_182 , L_14 ) ;
if ( V_2 -> V_131 == V_134 )
return;
...
{
struct V_179 * V_180 ;
if ( ! F_92 ( V_2 -> V_115 , L_23 , & V_180 ) )
F_93 ( V_180 , V_2 , F_89 ) ;
}
static int F_94 ( struct V_183 * V_108 )
{
struct V_1 * V_2 = V_108 -> V_184 ;
return F_66 ( V_2 ) ;
}
...
unsigned int V_186 ;
struct V_32 * V_32 ;
static struct V_187 V_147 = {
. V_188 = F_94 ,
} ;
static struct V_189 V_190 [ 2 ] = {
{ V_161 , 0 } ,
{ V_162 , 0x10 } ,
} ;
struct V_189 * V_129 ;
...
if ( V_131 == V_134 )
V_32 -> V_197 = ( V_32 -> V_36 - 0x40 ) / 0x10 ;
}
V_2 -> V_46 = ( V_131 == V_168 ) ? 0 : 1 ;
if ( F_102 ( V_124 , F_54 ( V_125 ) ,
V_2 -> V_68 * sizeof( T_2 ) * V_198 * 2 ,
& V_2 -> V_170 ) < 0 ) {
F_66 ( V_2 ) ;
return - V_192 ;
}
...
for ( V_58 = 0 ; V_58 < V_2 -> V_68 ; V_58 ++ ) {
V_32 = & V_2 -> V_69 [ V_58 ] ;
V_32 -> V_34 = ( ( T_2 * ) V_2 -> V_170 . V_171 ) + ( V_58 * V_198 * 2 ) ;
V_32 -> V_38 = V_2 -> V_170 . V_6 + ( V_58 * sizeof( T_2 ) * V_198 * 2 ) ;
V_186 |= V_32 -> V_67 ;
}
V_2 -> V_65 = V_199 ;
V_2 -> V_67 = V_186 ;
...
if ( ( V_102 = F_103 ( V_115 , V_200 , V_2 , & V_147 ) ) < 0 ) {
F_66 ( V_2 ) ;
return V_102 ;
}
F_104 ( V_115 , & V_125 -> V_201 ) ;
* V_185 = V_2 ;
return 0 ;
}
...
int V_102 ;
struct V_204 * V_113 ;
V_102 = F_106 ( V_205 , V_206 , V_207 , 0 , & V_115 ) ;
if ( V_102 < 0 )
return V_102 ;
strcpy ( V_115 -> V_208 , L_27 ) ;
strcpy ( V_115 -> V_123 , L_6 ) ;
for ( V_113 = V_209 ; V_113 -> V_206 ; V_113 ++ ) {
if ( V_125 -> V_108 == V_113 -> V_206 ) {
strcpy ( V_115 -> V_123 , V_113 -> V_210 ) ;
break;
}
}
strcat ( V_115 -> V_123 , L_28 ) ;
if ( ( V_102 = F_95 ( V_115 , V_125 , V_203 -> V_211 , & V_2 ) ) < 0 ) {
F_107 ( V_115 ) ;
return V_102 ;
}
V_115 -> V_21 = V_2 ;
