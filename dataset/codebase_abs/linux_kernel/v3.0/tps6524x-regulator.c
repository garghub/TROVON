...
static int F_20 ( struct V_33 * V_34 , int V_43 , int V_44 ,
unsigned * V_35 )
{
const struct V_36 * V_37 ;
struct V_1 * V_2 ;
...
if ( V_37 -> V_38 & V_39 )
return - V_21 ;
for ( V_45 = 0 ; V_45 < V_37 -> V_41 ; V_45 ++ )
if ( V_43 <= V_37 -> V_42 [ V_45 ] &&
V_44 >= V_37 -> V_42 [ V_45 ] )
break;
if ( V_45 >= V_37 -> V_41 )
V_45 = V_37 -> V_41 - 1 ;
* V_35 = V_37 -> V_42 [ V_45 ] ;
return F_16 ( V_2 , & V_37 -> V_46 , V_45 ) ;
}
...
return - V_19 ;
return V_37 -> V_42 [ V_22 ] ;
}
static int F_23 ( struct V_33 * V_34 , int V_47 ,
int V_48 )
{
const struct V_36 * V_37 ;
struct V_1 * V_2 ;
...
if ( V_37 -> V_38 & V_49 )
return - V_21 ;
for ( V_45 = 0 ; V_45 < V_37 -> V_50 ; V_45 ++ )
if ( V_47 <= V_37 -> V_51 [ V_45 ] &&
V_48 >= V_37 -> V_51 [ V_45 ] )
break;
if ( V_45 >= V_37 -> V_50 )
return - V_21 ;
return F_16 ( V_2 , & V_37 -> V_52 , V_45 ) ;
}
...
if ( V_37 -> V_38 & V_49 )
return V_37 -> V_53 ;
V_22 = F_15 ( V_2 , & V_37 -> V_52 ) ;
if ( V_22 < 0 )
return V_22 ;
if ( F_22 ( V_22 >= V_37 -> V_50 ) )
return - V_19 ;
return V_37 -> V_51 [ V_22 ] ;
}
...
V_2 = F_18 ( V_34 ) ;
V_37 = & V_36 [ F_19 ( V_34 ) ] ;
return F_15 ( V_2 , & V_37 -> V_54 ) ;
}
static int F_28 ( struct V_55 * V_15 )
{
struct V_1 * V_2 = F_29 ( V_15 ) ;
int V_45 ;
if ( ! V_2 )
return 0 ;
for ( V_45 = 0 ; V_45 < V_56 ; V_45 ++ ) {
if ( V_2 -> V_34 [ V_45 ] )
F_30 ( V_2 -> V_34 [ V_45 ] ) ;
V_2 -> V_34 [ V_45 ] = NULL ;
}
...
static int T_3 F_33 ( struct V_55 * V_15 )
{
struct V_1 * V_2 ;
struct V_57 * V_16 = & V_15 -> V_16 ;
...
V_2 = F_34 ( sizeof( struct V_1 ) , V_61 ) ;
if ( ! V_2 ) {
F_14 ( V_16 , L_7 ) ;
return - V_62 ;
}
...
V_2 -> V_15 = F_35 ( V_15 ) ;
F_36 ( & V_2 -> V_23 ) ;
for ( V_45 = 0 ; V_45 < V_56 ; V_45 ++ , V_37 ++ , V_59 ++ ) {
V_2 -> V_63 [ V_45 ] . V_64 = V_37 -> V_64 ;
V_2 -> V_63 [ V_45 ] . V_65 = V_45 ;
V_2 -> V_63 [ V_45 ] . V_41 = V_37 -> V_41 ;
V_2 -> V_63 [ V_45 ] . V_66 = & V_67 ;
V_2 -> V_63 [ V_45 ] . type = V_68 ;
V_2 -> V_63 [ V_45 ] . V_69 = V_70 ;
if ( V_37 -> V_38 & V_39 )
V_2 -> V_63 [ V_45 ] . V_41 = 1 ;
V_2 -> V_34 [ V_45 ] = F_37 ( & V_2 -> V_63 [ V_45 ] , V_16 ,
V_59 , V_2 ) ;
if ( F_38 ( V_2 -> V_34 [ V_45 ] ) ) {
V_22 = F_39 ( V_2 -> V_34 [ V_45 ] ) ;
V_2 -> V_34 [ V_45 ] = NULL ;
goto V_71;
}
}
