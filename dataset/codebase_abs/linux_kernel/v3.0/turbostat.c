...
if ( V_10 )
fprintf ( V_9 , L_33 , V_32 -> V_19 ) ;
if ( V_11 )
fprintf ( V_9 , L_33 , V_32 -> V_20 ) ;
if ( V_12 )
fprintf ( V_9 , L_33 , V_32 -> V_1 ) ;
}
if ( V_13 ) {
if ( ! V_38 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_39 / V_32 -> V_21 ) ;
else
fprintf ( V_9 , L_35 ) ;
}
if ( V_14 ) {
...
fprintf ( V_9 , L_36 , 1.0 * V_32 -> V_21 / V_41 / V_33 ) ;
if ( V_13 ) {
if ( ! V_42 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_43 / V_32 -> V_21 ) ;
else
fprintf ( V_9 , L_35 ) ;
}
if ( V_13 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_22 / V_32 -> V_21 ) ;
if ( V_13 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_23 / V_32 -> V_21 ) ;
if ( V_15 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_24 / V_32 -> V_21 ) ;
if ( V_15 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_26 / V_32 -> V_21 ) ;
if ( V_13 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_27 / V_32 -> V_21 ) ;
if ( V_13 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_28 / V_32 -> V_21 ) ;
if ( V_15 )
fprintf ( V_9 , L_34 , 100.0 * V_32 -> V_29 / V_32 -> V_21 ) ;
if ( V_16 )
fprintf ( V_9 , L_39 , V_32 -> V_30 ) ;
putc ( '\n' , V_9 ) ;
}
...
V_47 -> V_30 = V_45 -> V_30 ;
if ( V_48 ) {
fprintf ( V_9 , L_60 , V_46 -> V_1 ) ;
F_6 ( V_46 ) ;
fprintf ( V_9 , L_61 , V_46 -> V_1 ) ;
F_6 ( V_45 ) ;
V_48 = 0 ;
}
}
...
T_3 * V_78 ;
int V_19 ;
sprintf ( V_77 , L_72 , V_1 ) ;
V_78 = fopen ( V_77 , L_73 ) ;
if ( V_78 == NULL ) {
perror ( V_77 ) ;
exit ( 1 ) ;
}
fscanf ( V_78 , L_74 , & V_19 ) ;
fclose ( V_78 ) ;
return V_19 ;
}
int F_20 ( int V_1 )
...
T_3 * V_78 ;
int V_20 ;
sprintf ( V_77 , L_75 , V_1 ) ;
V_78 = fopen ( V_77 , L_73 ) ;
if ( V_78 == NULL ) {
perror ( V_77 ) ;
exit ( 1 ) ;
}
fscanf ( V_78 , L_74 , & V_20 ) ;
fclose ( V_78 ) ;
return V_20 ;
}
...
int V_80 ;
int V_3 ;
V_79 = fopen ( V_81 , L_73 ) ;
if ( V_79 == NULL ) {
perror ( V_81 ) ;
exit ( 1 ) ;
}
V_3 = fscanf ( V_79 , L_76 ) ;
if ( V_3 != 0 ) {
perror ( L_77 ) ;
exit ( 1 ) ;
}
...
if ( ! V_3 )
F_9 ( V_74 ) ;
fprintf ( V_9 , L_95 , V_34 . V_35 + V_34 . V_36 / 1000000.0 ) ;
return 0 ;
}
...
int V_112 ;
V_50 = V_105 [ 0 ] ;
while ( ( V_112 = F_46 ( V_111 , V_105 , L_96 ) ) != - 1 ) {
switch ( V_112 ) {
case 'v' :
V_67 ++ ;
break;
...
break;
case 'M' :
sscanf ( V_113 , L_97 , & V_16 ) ;
if ( V_67 > 1 )
fprintf ( V_9 , L_98 , V_16 ) ;
break;
default:
F_37 () ;
}
