...
{
return F_121 ( V_166 , F_118 , F_122 ( V_213 ) -> V_260 ) ;
}
static T_11 * F_123 ( T_1 * V_9 )
{
return V_261 ;
}
static const struct V_262 * F_124 ( T_1 * V_9 )
{
return V_263 ;
}
static int F_125 ( struct V_264 * V_265 , T_12 V_266 )
{
struct V_1 * V_6 ;
F_2 ( & V_211 ) ;
...
static int F_126 ( struct V_2 * V_3 , T_12 V_266 )
{
...
static int F_127 ( struct V_264 * V_265 , T_12 V_266 ,
unsigned int V_24 , unsigned long V_148 )
{
...
int V_39 ;
F_2 ( & V_211 ) ;
V_39 = F_128 ( V_9 , V_265 , V_24 , V_148 ) ;
if ( V_39 == - V_268 )
...
V_6 -> V_10 . V_279 = F_113 ;
F_134 ( & V_6 -> V_10 , F_135 ( & V_9 -> V_278 ) ) ;
if ( F_136 ( & V_6 -> V_10 ) )
goto V_280;
V_6 -> V_9 = V_9 ;
V_6 -> V_251 = & V_281 ;
...
if ( F_146 ( V_255 , L_59 , & V_287 ) ) {
F_17 ( V_42 L_62
L_63 ) ;
error = - V_224 ;
goto V_288;
}
error = F_147 ( & V_281 . V_285 ) ;
if ( error )
goto V_289;
return 0 ;
V_289:
