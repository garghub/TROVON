...
F_80 ( & V_153 -> V_156 ) ;
F_81 ( & V_153 -> V_158 ) ;
V_153 -> V_169 = F_82 ( F_68 , V_153 , L_51 , V_145 ) ;
return V_153 -> V_169 ;
}
...
static void T_5 F_85 ( struct V_143 * V_144 , int V_145 )
{
...
unsigned long V_170 ;
F_28 ( & V_153 -> V_154 , V_170 ) ;
F_87 ( & V_153 -> V_156 , & V_171 ) ;
while ( ! F_65 ( & V_171 ) ) {
V_2 = F_66 ( V_153 -> V_156 . V_161 , struct V_1 , V_121 ) ;
F_88 ( & V_2 -> V_121 ) ;
F_59 ( V_2 , F_89 ( V_144 -> V_160 ) ) ;
}
F_30 ( & V_153 -> V_154 , V_170 ) ;
}
static int T_5 F_90 ( struct V_172 * V_173 ,
unsigned long V_174 ,
void * V_175 )
{
...
if ( ! V_126 )
return 0 ;
V_144 = F_98 ( sizeof( struct V_143 ) , V_189 ) ;
if ( V_144 == NULL )
return - V_24 ;
F_79 ( & V_144 -> V_148 ) ;
V_144 -> V_149 = F_95 ( V_147 ) ;
V_144 -> V_160 = F_99 ( struct V_152 ) ;
if ( V_144 -> V_160 == NULL ) {
F_100 ( V_144 ) ;
return - V_190 ;
}
