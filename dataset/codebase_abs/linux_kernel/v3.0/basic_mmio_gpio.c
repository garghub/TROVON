...
int T_2 F_36 ( struct V_3 * V_4 )
{
int V_35 = F_37 ( & V_4 -> V_8 ) ;
F_38 ( V_4 ) ;
return V_35 ;
}
int T_3 F_39 ( struct V_3 * V_4 ,
struct V_23 * V_24 ,
unsigned long V_36 ,
void T_1 * V_28 ,
void T_1 * V_20 ,
...
F_41 ( & V_4 -> V_16 ) ;
V_4 -> V_8 . V_24 = V_24 ;
V_4 -> V_8 . V_39 = F_42 ( V_24 ) ;
V_4 -> V_8 . V_40 = - 1 ;
V_4 -> V_8 . V_41 = V_4 -> V_6 ;
V_38 = F_34 ( V_4 , V_28 , V_20 , V_29 ) ;
if ( V_38 )
return V_38 ;
V_38 = F_32 ( V_24 , V_4 , V_37 ) ;
if ( V_38 )
return V_38 ;
V_38 = F_35 ( V_4 , V_31 , V_32 ) ;
if ( V_38 )
return V_38 ;
V_4 -> V_2 = V_4 -> V_10 ( V_4 -> V_11 ) ;
return V_38 ;
}
static void T_1 * F_43 ( struct V_42 * V_43 ,
const char * V_44 ,
T_4 V_45 ,
int * V_35 )
{
...
V_48 = V_47 -> V_48 ;
if ( ! F_46 ( V_24 , V_48 , V_36 , V_47 -> V_44 ) ) {
* V_35 = - V_50 ;
return NULL ;
}
V_38 = F_47 ( V_24 , V_48 , V_36 ) ;
if ( ! V_38 ) {
* V_35 = - V_51 ;
return NULL ;
}
...
static int T_3 F_48 ( struct V_42 * V_43 )
{
struct V_23 * V_24 = & V_43 -> V_24 ;
struct V_46 * V_47 ;
void T_1 * V_28 ;
...
int V_35 ;
struct V_3 * V_4 ;
struct V_52 * V_53 = F_49 ( V_24 ) ;
V_47 = F_44 ( V_43 , V_49 , L_2 ) ;
if ( ! V_47 )
return - V_27 ;
V_36 = F_45 ( V_47 ) ;
V_28 = F_43 ( V_43 , L_2 , V_36 , & V_35 ) ;
if ( ! V_28 )
return V_35 ? V_35 : - V_27 ;
V_20 = F_43 ( V_43 , L_3 , V_36 , & V_35 ) ;
if ( V_35 )
return V_35 ;
V_29 = F_43 ( V_43 , L_4 , V_36 , & V_35 ) ;
if ( V_35 )
return V_35 ;
V_31 = F_43 ( V_43 , L_5 , V_36 , & V_35 ) ;
if ( V_35 )
return V_35 ;
V_32 = F_43 ( V_43 , L_6 , V_36 , & V_35 ) ;
if ( V_35 )
return V_35 ;
V_25 = ! strcmp ( F_50 ( V_43 ) -> V_44 , L_7 ) ;
V_4 = F_51 ( & V_43 -> V_24 , sizeof( * V_4 ) , V_54 ) ;
if ( ! V_4 )
return - V_51 ;
V_35 = F_39 ( V_4 , V_24 , V_36 , V_28 , V_20 , V_29 , V_31 , V_32 , V_25 ) ;
if ( V_35 )
return V_35 ;
if ( V_53 ) {
V_4 -> V_8 . V_40 = V_53 -> V_40 ;
if ( V_53 -> V_41 > 0 )
V_4 -> V_8 . V_41 = V_53 -> V_41 ;
}
F_52 ( V_43 , V_4 ) ;
return F_53 ( & V_4 -> V_8 ) ;
}
static int T_2 F_54 ( struct V_42 * V_43 )
{
struct V_3 * V_4 = F_55 ( V_43 ) ;
return F_36 ( V_4 ) ;
}
