...
static inline void F_4 ( T_2 V_3 , T_2 V_4 ) {}
static void F_11 ( struct V_10 * V_11 , T_3 V_5 , int V_12 )
{
if ( V_12 == 0 )
F_4 (
V_5 & ( V_13 | V_14 ) , V_5 ) ;
...
static void F_27 ( struct V_10 * V_8 , unsigned int V_32 )
{
...
static void F_52 ( char V_63 , const char * V_64 )
{
T_4 V_65 = F_53 ( V_66 ) ;
if ( ( V_65 & 0xffff0000 ) == 0x7ff00000 )
F_54 ( ( V_65 & 0xffff ) | 0x7ee00000 , V_66 ) ;
F_50 () ;
}
...
static void T_1 F_61 ( struct V_74 * V_75 ,
struct V_76 * V_77 , char * * V_78 , struct V_79 * V_80 )
{
F_62 () ;
V_80 -> V_81 = 1 ;
V_80 -> V_82 [ 0 ] . V_83 = 0xa0000000 ;
V_80 -> V_82 [ 0 ] . V_53 = ( 64 * 1024 * 1024 ) ;
}
