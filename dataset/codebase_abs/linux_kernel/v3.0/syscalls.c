...
long F_12 ( int V_5 , int V_26 , T_5 V_27 , T_5 V_28 ,
T_5 V_29 , T_5 V_30 )
{
return F_13 ( V_5 , ( V_31 ) V_27 << 32 | V_28 ,
( V_31 ) V_29 << 32 | V_30 , V_26 ) ;
}
void F_14 ( unsigned long V_32 , unsigned long V_33 , unsigned long V_34 ,
unsigned long V_35 , unsigned long V_36 , unsigned long V_37 ,
struct V_38 * V_39 )
{
F_15 ( L_1
L_2 , V_39 -> V_40 [ 0 ] , V_32 , V_33 , V_34 , V_35 , V_36 , V_37 , V_39 ,
V_23 , F_16 () ) ;
}
void F_17 ( unsigned long V_32 )
{
F_15 ( L_3 , V_32 , V_23 , F_16 () ) ;
}
