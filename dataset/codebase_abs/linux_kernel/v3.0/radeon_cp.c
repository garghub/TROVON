...
V_1 -> V_4 |= V_322 ;
V_17 = F_131 ( V_83 , F_132 ( V_83 -> V_121 , 2 ) ,
F_133 ( V_83 -> V_121 , 2 ) , V_455 ,
...
int F_136 ( struct V_82 * V_83 , struct V_458 * V_239 )
{
struct V_211 * V_212 ;
unsigned long V_459 ;
int V_17 ;
...
if ( ! V_212 )
return - V_307 ;
V_459 = F_137 (unsigned long, SAREA_MAX, PAGE_SIZE) ;
V_17 = F_131 ( V_83 , 0 , V_459 , V_460 , V_461 ,
& V_212 -> V_377 ) ;
if ( V_17 ) {
F_36 ( L_74 ) ;
F_138 ( V_212 ) ;
...
void F_139 ( struct V_82 * V_83 , struct V_458 * V_239 )
{
...
V_212 -> V_241 = NULL ;
if ( V_212 -> V_377 )
F_141 ( V_83 , V_212 -> V_377 ) ;
F_138 ( V_212 ) ;
V_239 -> V_240 = NULL ;
}
int F_142 ( struct V_82 * V_83 )
{
int V_17 ;
T_10 * V_464 ;
T_2 * V_1 = V_83 -> V_84 ;
V_1 -> V_250 . V_315 = V_465 ;
V_1 -> V_401 = F_132 ( V_83 -> V_121 , 0 ) ;
V_17 = F_131 ( V_83 , V_1 -> V_401 ,
F_133 ( V_83 -> V_121 , 0 ) , V_466 ,
V_467 , & V_464 ) ;
if ( V_17 != 0 )
return V_17 ;
return 0 ;
}
int F_135 ( struct V_82 * V_83 )
{
T_2 * V_1 = V_83 -> V_84 ;
F_38 ( L_14 ) ;
F_143 ( V_83 , V_1 -> V_18 ) ;
...
V_186 [ V_1 -> V_186 . V_187 + V_97 ] = F_145 () ;
