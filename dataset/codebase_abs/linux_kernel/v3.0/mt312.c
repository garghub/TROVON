...
const T_1 V_109 [ 3 ] = { 0x00 , 0x40 , 0x80 } ;
F_4 ( L_12 , V_19 , V_107 -> V_110 ) ;
if ( ( V_107 -> V_110 < V_56 -> V_111 . V_112 . V_113 )
|| ( V_107 -> V_110 > V_56 -> V_111 . V_112 . V_114 ) )
return - V_76 ;
if ( ( V_107 -> V_115 < V_33 )
|| ( V_107 -> V_115 > V_32 ) )
return - V_76 ;
if ( ( V_107 -> V_116 . V_117 . V_118 < V_56 -> V_111 . V_112 . V_119 )
|| ( V_107 -> V_116 . V_117 . V_118 > V_56 -> V_111 . V_112 . V_120 ) )
return - V_76 ;
if ( ( V_107 -> V_116 . V_117 . V_121 < V_122 )
|| ( V_107 -> V_116 . V_117 . V_121 > V_52 ) )
return - V_76 ;
if ( ( V_107 -> V_116 . V_117 . V_121 == V_123 )
|| ( V_107 -> V_116 . V_117 . V_121 == V_124 ) )
return - V_76 ;
switch ( V_2 -> V_62 ) {
case V_125 :
V_7 = F_6 ( V_2 , V_58 , & V_108 ) ;
if ( V_7 < 0 )
return V_7 ;
if ( V_107 -> V_116 . V_117 . V_118 >= 30000000 ) {
if ( V_2 -> V_59 == 6 ) {
V_2 -> V_59 = 9 ;
V_7 = F_13 ( V_56 ) ;
if ( V_7 < 0 )
...
if ( V_56 -> V_111 . V_127 . V_128 ) {
V_56 -> V_111 . V_127 . V_128 ( V_56 , V_107 ) ;
if ( V_56 -> V_111 . V_129 )
V_56 -> V_111 . V_129 ( V_56 , 0 ) ;
}
V_34 = F_8 ( V_107 -> V_116 . V_117 . V_118 * 4 , 15625 ) ;
V_5 [ 0 ] = ( V_34 >> 8 ) & 0x3f ;
V_5 [ 1 ] = ( V_34 >> 0 ) & 0xff ;
V_5 [ 2 ] = V_109 [ V_107 -> V_115 ] | V_45 [ V_107 -> V_116 . V_117 . V_121 ] ;
V_5 [ 3 ] = 0x40 ;
if ( V_107 -> V_116 . V_117 . V_118 < 10000000 )
V_5 [ 3 ] |= 0x04 ;
V_5 [ 4 ] = 0x01 ;
...
struct V_1 * V_2 = V_56 -> V_57 ;
int V_7 ;
V_7 = F_10 ( V_2 , & V_107 -> V_115 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_11 ( V_2 , & V_107 -> V_116 . V_117 . V_118 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_12 ( V_2 , & V_107 -> V_116 . V_117 . V_121 ) ;
if ( V_7 < 0 )
return V_7 ;
return 0 ;
}
static int F_27 ( struct V_55 * V_56 , int V_130 )
{
struct V_1 * V_2 = V_56 -> V_57 ;
T_1 V_25 = 0x00 ;
int V_7 ;
...
struct V_55 * F_32 ( const struct V_136 * V_12 ,
struct V_137 * V_17 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_33 ( sizeof( struct V_1 ) , V_138 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_12 = V_12 ;
V_2 -> V_17 = V_17 ;
if ( F_6 ( V_2 , V_139 , & V_2 -> V_62 ) < 0 )
goto error;
memcpy ( & V_2 -> V_140 . V_111 , & V_141 ,
sizeof( struct V_142 ) ) ;
V_2 -> V_140 . V_57 = V_2 ;
switch ( V_2 -> V_62 ) {
case V_125 :
strcpy ( V_2 -> V_140 . V_111 . V_112 . V_143 , L_13 ) ;
V_2 -> V_43 = V_144 ;
V_2 -> V_59 = 9 ;
break;
case V_126 :
strcpy ( V_2 -> V_140 . V_111 . V_112 . V_143 , L_14 ) ;
V_2 -> V_43 = V_144 ;
V_2 -> V_59 = 6 ;
break;
case V_63 :
strcpy ( V_2 -> V_140 . V_111 . V_112 . V_143 , L_15 ) ;
V_2 -> V_43 = V_145 ;
V_2 -> V_59 = 9 ;
break;
default:
