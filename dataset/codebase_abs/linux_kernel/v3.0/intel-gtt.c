...
int V_163 = - V_46 ;
if ( V_15 . V_188 ) {
int V_196 = V_15 . V_66 . V_82 / V_14 ;
int V_197 = V_15 . V_66 . V_153 ;
F_88 ( V_196 , V_197 - V_196 ) ;
V_15 . V_188 = false ;
}
if ( V_83 == 1 && type == V_74 )
...
{
int V_163 ;
V_163 = F_92 ( V_15 . V_84 -> V_201 , & V_15 . V_202 , V_14 ,
V_14 , V_203 , 0 ,
V_204 , V_15 . V_84 ) ;
return V_163 ;
}
...
int V_163 ;
T_1 V_205 ;
F_24 ( V_15 . V_84 , V_206 , & V_205 ) ;
if ( ! ( V_205 & 0x1 ) ) {
F_91 () ;
V_15 . V_207 = 1 ;
F_94 ( V_15 . V_84 , V_206 , ( V_15 . V_202 . V_196 & 0xffffffff ) | 0x1 ) ;
} else {
V_205 &= ~ 1 ;
V_15 . V_207 = 1 ;
V_15 . V_202 . V_196 = V_205 ;
V_15 . V_202 . V_197 = V_205 + V_14 ;
V_163 = F_95 ( & V_208 , & V_15 . V_202 ) ;
if ( V_163 )
V_15 . V_207 = 0 ;
}
}
...
T_1 V_209 , V_210 ;
int V_163 ;
F_24 ( V_15 . V_84 , V_211 + 4 , & V_209 ) ;
F_24 ( V_15 . V_84 , V_211 , & V_210 ) ;
if ( ! ( V_210 & 0x1 ) ) {
F_91 () ;
V_15 . V_207 = 1 ;
F_94 ( V_15 . V_84 , V_211 + 4 ,
F_97 ( V_15 . V_202 . V_196 ) ) ;
F_94 ( V_15 . V_84 , V_211 , ( V_15 . V_202 . V_196 & 0xffffffff ) | 0x1 ) ;
} else {
T_8 V_212 ;
V_210 &= ~ 0x1 ;
V_212 = ( ( T_8 ) V_209 << 32 ) | V_210 ;
V_15 . V_207 = 1 ;
V_15 . V_202 . V_196 = V_212 ;
V_15 . V_202 . V_197 = V_212 + V_14 ;
V_163 = F_95 ( & V_208 , & V_15 . V_202 ) ;
if ( V_163 )
V_15 . V_207 = 0 ;
}
...
if ( V_83 == 6 )
return;
V_15 . V_202 . V_213 = L_13 ;
V_15 . V_202 . V_71 = V_214 ;
if ( V_147 || V_83 >= 4 ) {
F_96 () ;
} else {
F_93 () ;
...
if ( V_15 . V_202 . V_196 )
V_15 . V_215 = F_99 ( V_15 . V_202 . V_196 , V_14 ) ;
if ( ! V_15 . V_215 )
F_76 ( & V_15 . V_16 -> V_42 ,
L_14 ) ;
}
...
unsigned int V_71 )
{
unsigned int V_216 = V_71 & ~ V_217 ;
unsigned int V_218 = V_71 & V_217 ;
T_1 V_72 ;
if ( V_216 == V_190 )
V_72 = V_219 | V_73 ;
else if ( V_216 == V_220 ) {
...
V_15 . V_37 = V_29 + V_227 ;
}
F_98 () ;
return 0 ;
}
static int F_108 ( T_5 V_86 )
{
struct V_228 * V_229 ;
V_229 = F_109 ( V_230 , V_86 , NULL ) ;
if ( V_229 && F_110 ( V_229 -> V_231 ) != 0 ) {
V_229 = F_109 ( V_230 ,
V_86 , V_229 ) ;
}
if ( ! V_229 )
...
int F_111 ( struct V_228 * V_232 ,
struct V_23 * V_24 )
{
int V_10 , V_233 ;
V_15 . V_50 = NULL ;
for ( V_10 = 0 ; V_234 [ V_10 ] . V_213 != NULL ; V_10 ++ ) {
if ( F_108 ( V_234 [ V_10 ] . V_235 ) ) {
V_15 . V_50 =
V_234 [ V_10 ] . V_236 ;
break;
}
...
V_24 -> V_238 = & V_15 ;
V_24 -> V_42 = V_232 ;
V_15 . V_84 = F_112 ( V_232 ) ;
F_30 ( & V_232 -> V_42 , L_15 , V_234 [ V_10 ] . V_213 ) ;
V_233 = V_15 . V_50 -> V_239 ;
if ( F_113 ( V_15 . V_16 , F_114 ( V_233 ) ) )
F_76 ( & V_15 . V_16 -> V_42 ,
L_16 , V_233 ) ;
else
F_115 ( V_15 . V_16 ,
