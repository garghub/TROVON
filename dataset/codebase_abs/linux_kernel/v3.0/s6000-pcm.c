...
struct V_8 * V_4 = V_32 -> V_7 ;
struct V_10 * V_38 =
F_2 ( V_4 -> V_18 , V_32 -> V_37 [ 0 ] . V_2 ) ;
F_50 ( V_38 -> V_29 , V_32 ) ;
F_51 ( V_32 ) ;
}
static int F_52 ( struct V_74 * V_75 ,
struct V_76 * V_77 , struct V_31 * V_32 )
{
struct V_8 * V_4 = V_32 -> V_7 ;
struct V_10 * V_38 ;
int V_78 ;
...
static int T_5 F_56 ( struct V_86 * V_87 )
{
return F_57 ( & V_87 -> V_41 , & V_88 ) ;
}
static int T_6 F_58 ( struct V_86 * V_87 )
{
F_59 ( & V_87 -> V_41 ) ;
return 0 ;
}
