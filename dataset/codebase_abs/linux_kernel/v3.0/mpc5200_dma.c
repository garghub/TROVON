...
static int F_36 ( struct V_66 * V_61 , struct V_67 * V_68 ,
struct V_69 * V_60 )
{
...
V_5 = F_43 ( V_89 . V_94 , 1 + V_89 . V_95 - V_89 . V_94 ) ;
if ( ! V_5 ) {
F_31 ( & V_86 -> V_49 , L_11 ) ;
return - V_93 ;
}
V_3 = F_44 ( sizeof *V_3 , V_96 ) ;
if ( ! V_3 ) {
V_91 = - V_82 ;
goto V_97;
}
V_90 = F_45 ( V_86 -> V_49 . V_92 , L_12 , & V_70 ) ;
...
V_87 = V_89 . V_94 + F_49 ( struct V_4 , V_103 . V_104 ) ;
V_3 -> V_14 . V_24 =
F_50 ( V_3 -> V_100 , 10 , V_87 , 512 ) ;
V_3 -> V_9 . V_24 =
F_51 ( V_3 -> V_100 , 10 , V_87 ) ;
if ( ! V_3 -> V_14 . V_24 ||
! V_3 -> V_9 . V_24 ) {
F_31 ( & V_86 -> V_49 , L_14 ) ;
V_91 = - V_93 ;
...
V_3 -> V_14 . V_1 =
F_52 ( V_3 -> V_14 . V_24 ) ;
V_57 = F_53 ( V_3 -> V_1 , & F_1 , V_113 ,
L_15 , V_3 ) ;
V_57 |= F_53 ( V_3 -> V_14 . V_1 , & F_7 , V_113 ,
L_16 , & V_3 -> V_14 ) ;
V_57 |= F_53 ( V_3 -> V_9 . V_1 , & F_7 , V_113 ,
L_17 , & V_3 -> V_9 ) ;
if ( V_57 ) {
V_91 = - V_93 ;
goto V_114;
...
F_54 ( & V_86 -> V_49 , V_3 ) ;
return F_55 ( & V_86 -> V_49 , & V_115 ) ;
V_114:
F_56 ( V_3 -> V_1 , V_3 ) ;
F_56 ( V_3 -> V_14 . V_1 , & V_3 -> V_14 ) ;
F_56 ( V_3 -> V_9 . V_1 , & V_3 -> V_9 ) ;
V_98:
F_57 ( V_3 ) ;
V_97:
F_58 ( V_5 ) ;
