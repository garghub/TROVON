...
struct V_4 * V_5 = V_2 -> V_6 ;
F_49 ( V_5 != NULL ) ;
V_5 = F_50 ( sizeof( struct V_4 ) , V_56 ) ;
if ( ! V_5 )
return - V_59 ;
F_51 ( & V_5 -> V_60 ) ;
F_52 ( & V_5 -> V_21 ) ;
...
static void F_63 ( struct V_4 * V_5 , T_3 V_74 , int V_75 , T_3 V_76 )
{
unsigned long * V_43 , * V_63 ;
unsigned int V_25 ;
T_3 V_77 , V_78 ;
...
while ( V_74 < V_78 ) {
V_77 = F_64 ( T_3 , F_65 ( V_74 + 1 , V_73 ) , V_78 ) - V_74 ;
V_25 = F_30 ( V_5 , V_74 ) ;
V_43 = F_34 ( V_5 , V_25 ) ;
V_63 = V_43 + F_66 ( V_74 ) ;
...
int F_67 ( struct V_1 * V_2 , T_2 V_80 , int V_81 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
...
V_70 = F_71 ( F_65 ( V_80 , V_93 ) ) ;
V_82 = F_65 ( V_70 , 64 ) >> V_37 ;
if ( F_72 ( V_2 ) ) {
...
V_50 = F_65 ( V_82 * sizeof( long ) , V_100 ) >> V_36 ;
V_55 = V_5 -> V_38 ;
if ( V_50 == V_55 ) {
F_74 ( V_5 -> V_29 != NULL ) ;
V_86 = V_5 -> V_29 ;
...
if ( V_89 ) {
if ( V_81 ) {
F_63 ( V_5 , V_83 , 0xff , V_82 - V_83 ) ;
V_5 -> V_92 += V_70 - V_84 ;
} else
F_63 ( V_5 , V_83 , 0x00 , V_82 - V_83 ) ;
}
if ( V_50 < V_55 ) {
...
void F_84 ( struct V_1 * V_2 , T_3 V_74 , T_3 V_45 ,
unsigned long * V_104 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_43 , * V_63 ;
...
F_17 ( V_2 , V_25 ) ;
if ( V_108 -> V_19 & V_115 )
F_90 ( V_106 -> V_110 [ 0 ] . V_111 ) ;
F_91 ( V_106 ) ;
if ( F_92 ( & V_108 -> V_116 ) )
F_93 ( & V_108 -> V_117 ) ;
}
static void F_94 ( struct V_107 * V_108 , int V_27 , int V_118 ) __must_hold( T_4 )
{
struct V_106 * V_106 = F_95 ( V_56 , 1 ) ;
struct V_1 * V_2 = V_108 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_24 * V_24 ;
unsigned int V_76 ;
...
V_76 = F_64 (unsigned int, PAGE_SIZE,
...
V_106 -> V_129 = V_119 ;
F_96 ( V_106 , V_24 , V_76 , 0 ) ;
V_106 -> V_109 = V_108 ;
V_106 -> V_130 = F_87 ;
if ( F_75 ( V_2 , ( V_118 & V_131 ) ? V_132 : V_133 ) ) {
V_106 -> V_134 |= V_118 ;
F_97 ( V_106 , - V_114 ) ;
} else {
F_98 ( V_118 , V_106 ) ;
F_99 ( V_76 >> 9 , & V_2 -> V_135 ) ;
}
}
static int F_100 ( struct V_1 * V_2 , int V_118 , unsigned V_136 ) __must_hold( T_4 )
{
struct V_107 V_108 = {
. V_2 = V_2 ,
. V_116 = F_101 ( 1 ) ,
. V_117 = F_102 ( V_108 . V_117 ) ,
. V_19 = V_136 ? V_115 : 0 ,
} ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
V_139 = V_5 -> V_92 ;
F_68 ( V_8 , L_31 ,
F_108 ( V_140 , V_139 << ( V_142 - 10 ) ) , V_139 ) ;
return V_88 ;
}
int F_109 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_100 ( V_2 , V_143 , 0 ) ;
}
int F_110 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_100 ( V_2 , V_131 , 0 ) ;
}
int F_111 ( struct V_1 * V_2 , unsigned V_144 ) __must_hold( T_4 )
{
return F_100 ( V_2 , V_131 , V_144 ) ;
}
int F_112 ( struct V_1 * V_2 , unsigned int V_25 ) __must_hold( T_4 )
{
struct V_107 V_108 = {
. V_2 = V_2 ,
. V_116 = F_101 ( 1 ) ,
...
static unsigned long F_113 ( struct V_1 * V_2 , unsigned long V_147 ,
...
F_55 (!b) return V_46 ;
F_55 (!b->bm_pages) return V_46 ;
F_69 ( & V_5 -> V_60 ) ;
if ( V_152 & V_5 -> V_23 )
F_117 ( V_2 ) ;
V_46 = F_113 ( V_2 , V_147 , V_148 , V_42 ) ;
F_70 ( & V_5 -> V_60 ) ;
return V_46 ;
}
unsigned long F_118 ( struct V_1 * V_2 , unsigned long V_147 )
{
return F_116 ( V_2 , V_147 , 0 ) ;
}
unsigned long F_119 ( struct V_1 * V_2 , unsigned long V_147 )
{
return F_113 ( V_2 , V_147 , 0 , V_126 ) ;
}
unsigned long F_120 ( struct V_1 * V_2 , unsigned long V_147 )
{
return F_113 ( V_2 , V_147 , 1 , V_126 ) ;
}
static int F_121 ( struct V_1 * V_2 , const unsigned long V_102 ,
...
static int F_124 ( struct V_1 * V_2 , const unsigned long V_102 ,
...
F_117 ( V_2 ) ;
V_75 = F_121 ( V_2 , V_102 , V_153 , V_154 ) ;
F_78 ( & V_5 -> V_60 , V_19 ) ;
return V_75 ;
}
int F_125 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_153 )
{
return F_124 ( V_2 , V_102 , V_153 , 1 ) ;
}
int F_126 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_153 )
{
return - F_124 ( V_2 , V_102 , V_153 , 0 ) ;
}
...
V_70 = F_59 ( V_160 [ V_46 ] ) ;
V_160 [ V_46 ] = ~ 0UL ;
V_5 -> V_92 += V_69 - V_70 ;
}
F_36 ( V_160 , V_42 ) ;
}
void F_128 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_153 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long V_161 = F_65 ( V_102 , V_69 ) ;
...
F_69 ( & V_5 -> V_60 ) ;
F_121 ( V_2 , V_102 , V_153 , 1 ) ;
F_70 ( & V_5 -> V_60 ) ;
return;
}
F_69 ( & V_5 -> V_60 ) ;
if ( V_161 )
F_121 ( V_2 , V_102 , V_161 - 1 , 1 ) ;
V_163 = V_161 >> ( 3 + V_36 ) ;
V_164 = V_162 >> ( 3 + V_36 ) ;
V_159 = F_66 ( V_161 >> V_37 ) ;
V_71 = V_73 ;
for ( V_27 = V_163 ; V_27 < V_164 ; V_27 ++ ) {
F_127 ( V_2 -> V_6 , V_27 , V_159 , V_71 ) ;
F_70 ( & V_5 -> V_60 ) ;
F_62 () ;
V_159 = 0 ;
F_69 ( & V_5 -> V_60 ) ;
}
V_71 = F_66 ( V_162 >> V_37 ) ;
F_127 ( V_2 -> V_6 , V_164 , V_159 , V_71 ) ;
if ( V_162 <= V_153 )
F_121 ( V_2 , V_162 , V_153 , 1 ) ;
F_70 ( & V_5 -> V_60 ) ;
}
int F_129 ( struct V_1 * V_2 , const unsigned long V_39 )
{
unsigned long V_19 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_43 ;
...
int F_131 ( struct V_1 * V_2 , const unsigned long V_102 , const unsigned long V_153 )
{
unsigned long V_19 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_43 = NULL ;
...
V_75 += ( 0 != F_130 ( V_39 - ( V_27 << ( V_36 + 3 ) ) , V_43 ) ) ;
}
}
if ( V_43 )
F_37 ( V_43 ) ;
...
int F_132 ( struct V_1 * V_2 , unsigned long V_165 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_117 ( V_2 ) ;
V_102 = F_133 ( V_165 ) ;
V_153 = F_134 ( ( T_3 ) F_133 ( V_165 + 1 ) , V_5 -> V_79 ) ;
V_138 = 0 ;
if ( V_102 < V_5 -> V_79 ) {
int V_166 = V_153 - V_102 ;
V_43 = F_34 ( V_5 , F_30 ( V_5 , V_102 ) ) ;
V_63 = V_43 + F_66 ( V_102 ) ;
while ( V_166 -- )
V_138 += F_59 ( * V_63 ++ ) ;
F_37 ( V_43 ) ;
} else {
...
unsigned long F_135 ( struct V_1 * V_2 , unsigned long V_167 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_43 , * V_63 ;
unsigned long V_168 ;
...
V_168 = V_5 -> V_92 ;
V_102 = V_167 * V_169 ;
V_153 = F_64 ( T_3 , V_102 + V_169 , V_5 -> V_79 ) ;
F_74 ( ( V_153 - 1 ) >> ( V_36 - V_37 + 3 )
== V_102 >> ( V_36 - V_37 + 3 ) ) ;
V_138 = 0 ;
if ( V_102 < V_5 -> V_79 ) {
