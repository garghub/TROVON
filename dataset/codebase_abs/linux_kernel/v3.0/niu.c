...
{
unsigned long V_1132 , V_1133 , V_1134 , V_1135 ;
struct V_495 * V_627 ;
int V_26 ;
...
V_1136:
V_4 -> V_11 -> V_1137 . V_561 = V_1132 ;
V_4 -> V_11 -> V_1137 . V_562 = V_1135 ;
V_4 -> V_11 -> V_1137 . V_526 = V_1133 ;
V_4 -> V_11 -> V_1137 . V_600 = V_1134 ;
}
static void F_411 ( struct V_3 * V_4 )
{
unsigned long V_1132 , V_1134 , V_1135 ;
struct V_566 * V_589 ;
int V_26 ;
...
V_1136:
V_4 -> V_11 -> V_1137 . V_572 = V_1132 ;
V_4 -> V_11 -> V_1137 . V_573 = V_1135 ;
V_4 -> V_11 -> V_1137 . V_1138 = V_1134 ;
}
static struct V_1139 * F_412 ( struct V_308 * V_11 )
{
struct V_3 * V_4 = F_396 ( V_11 ) ;
if ( F_413 ( V_11 ) ) {
F_409 ( V_4 ) ;
...
V_1585 . V_1595 . V_1596 = F_599 ( V_1232 -> V_1597 ) ;
V_1585 . V_1595 . V_1597 = V_1232 -> V_1597 -> V_1598 ;
V_1585 . V_1595 . V_511 = F_600 ( V_1232 -> V_1594 ) ;
...
F_601 ( V_1232 , V_1586 + V_1600 , & V_1588 ) ;
V_1588 &= ~ V_1601 ;
V_1588 |= ( V_1602 |
V_1603 |
V_1604 |
V_1605 |
V_1606 ) ;
F_602 ( V_1232 , V_1586 + V_1600 , V_1588 ) ;
V_1587 = F_603 ( 44 ) ;
...
T_1 * V_1610 , T_7 V_1564 )
{
unsigned long V_1611 = F_625 ( V_487 ) ;
unsigned long V_485 = F_626 ( V_1564 , V_1611 ) ;
if ( V_485 == 0UL )
return NULL ;
memset ( ( char * ) V_485 , 0 , V_512 << V_1611 ) ;
* V_1610 = F_627 ( V_485 ) ;
return ( void * ) V_485 ;
}
...
{
unsigned long V_1611 = F_625 ( V_487 ) ;
F_629 ( ( unsigned long ) V_1566 , V_1611 ) ;
}
...
V_4 = F_396 ( V_11 ) ;
memset ( & V_1585 , 0 , sizeof( V_1585 ) ) ;
V_1585 . V_1614 = F_636 ( V_1523 -> V_11 . V_1525 ) ;
V_4 -> V_25 = F_563 ( V_4 , & V_1585 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_509 ;
...
F_592 ( V_11 ) ;
V_4 -> V_1504 = F_637 ( & V_1523 -> V_1615 [ 1 ] , 0 ,
F_638 ( & V_1523 -> V_1615 [ 1 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1504 ) {
...
V_4 -> V_1616 = F_637 ( & V_1523 -> V_1615 [ 2 ] , 0 ,
F_638 ( & V_1523 -> V_1615 [ 2 ] ) ,
L_230 ) ;
if ( ! V_4 -> V_1616 ) {
...
V_4 -> V_1617 = F_637 ( & V_1523 -> V_1615 [ 3 ] , 0 ,
F_638 ( & V_1523 -> V_1615 [ 3 ] ) ,
L_232 ) ;
if ( ! V_4 -> V_1617 ) {
...
V_1609:
if ( V_4 -> V_1616 ) {
F_640 ( & V_1523 -> V_1615 [ 2 ] , V_4 -> V_1616 ,
F_638 ( & V_1523 -> V_1615 [ 2 ] ) ) ;
V_4 -> V_1616 = NULL ;
}
if ( V_4 -> V_1617 ) {
F_640 ( & V_1523 -> V_1615 [ 3 ] , V_4 -> V_1617 ,
F_638 ( & V_1523 -> V_1615 [ 3 ] ) ) ;
V_4 -> V_1617 = NULL ;
}
if ( V_4 -> V_1504 ) {
F_640 ( & V_1523 -> V_1615 [ 1 ] , V_4 -> V_1504 ,
F_638 ( & V_1523 -> V_1615 [ 1 ] ) ) ;
V_4 -> V_1504 = NULL ;
}
V_1608:
