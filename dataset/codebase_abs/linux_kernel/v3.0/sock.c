...
struct V_34 V_8 ;
struct V_7 T_1 * V_35 ;
V_35 = F_19 ( sizeof( * V_35 ) ) ;
if ( F_7 ( & V_8 , ( void T_1 * ) V_5 , sizeof( V_8 ) ) )
return - V_21 ;
if ( F_18 ( V_8 . V_22 , & V_35 -> V_22 ) ||
F_18 ( V_8 . V_23 , & V_35 -> V_23 ) ||
F_18 ( V_8 . V_36 , & V_35 -> V_36 ) ||
F_18 ( V_8 . V_37 , & V_35 -> V_37 ) ||
F_18 ( F_17 ( V_8 . V_38 ) , & V_35 -> V_38 ) ||
F_18 ( V_8 . V_39 , & V_35 -> V_39 ) ||
F_18 ( V_8 . V_40 , & V_35 -> V_40 ) ||
F_18 ( V_8 . V_41 , & V_35 -> V_41 ) ||
F_18 ( V_8 . V_42 , & V_35 -> V_42 ) ||
F_18 ( V_8 . V_43 , & V_35 -> V_43 ) ||
F_18 ( V_8 . V_44 , & V_35 -> V_44 ) ||
F_18 ( V_8 . V_45 , & V_35 -> V_45 ) ||
F_11 ( & V_35 -> V_46 [ 0 ] , & V_8 . V_46 [ 0 ] , 128 ) )
return - V_21 ;
V_5 = ( unsigned long ) V_35 ;
}
return F_5 ( V_2 , V_4 , V_5 ) ;
}
static int F_20 ( struct V_47 * V_47 , struct V_1 * V_2 , int V_48 ,
int V_49 )
{
struct V_2 * V_3 ;
F_2 ( L_3 , V_2 ) ;
