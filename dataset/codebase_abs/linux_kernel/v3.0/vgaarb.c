...
unsigned long V_24 ;
F_10 ( L_7 , V_28 ) ;
V_95 = F_30 ( sizeof( struct V_94 ) , V_71 ) ;
if ( V_95 == NULL )
return - V_99 ;
...
static int F_62 ( struct V_119 * V_119 , struct V_92 * V_92 )
{
struct V_94 * V_95 = V_92 -> V_96 ;
struct V_104 * V_105 ;
unsigned long V_24 ;
...
static int F_63 ( struct V_124 * V_125 , unsigned long V_126 ,
void * V_127 )
{
struct V_128 * V_129 = V_127 ;
struct V_10 * V_11 = F_64 ( V_129 ) ;
bool V_130 = false ;
F_10 ( L_7 , V_28 ) ;
if ( V_126 == V_131 )
V_130 = F_29 ( V_11 ) ;
