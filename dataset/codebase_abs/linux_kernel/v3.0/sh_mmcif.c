...
if ( V_48 -> V_181 )
V_48 -> V_181 ( V_2 -> V_7 , V_177 -> V_179 ) ;
if ( ! V_2 -> V_182 ) {
F_19 ( V_2 , V_2 -> V_7 -> V_8 . V_49 ) ;
F_53 ( & V_2 -> V_7 -> V_8 ) ;
V_2 -> V_182 = true ;
}
} else if ( V_177 -> V_179 == V_183 || ! V_177 -> clock ) {
F_25 ( V_2 , 0 ) ;
if ( V_177 -> V_179 == V_183 ) {
if ( V_2 -> V_182 ) {
F_54 ( & V_2 -> V_7 -> V_8 ) ;
F_24 ( V_2 ) ;
V_2 -> V_182 = false ;
...
return V_48 -> V_185 ( V_2 -> V_7 ) ;
}
static void F_56 ( struct V_167 * V_168 )
{
F_57 ( V_168 , 0 ) ;
}
static T_4 F_58 ( int V_187 , void * V_188 )
{
...
static int T_5 F_59 ( struct V_201 * V_202 )
{
int V_27 = 0 , V_187 [ 2 ] ;
struct V_167 * V_168 ;
struct V_1 * V_2 ;
...
void T_6 * V_3 ;
char V_205 [ 8 ] ;
V_187 [ 0 ] = F_60 ( V_202 , 0 ) ;
V_187 [ 1 ] = F_60 ( V_202 , 1 ) ;
if ( V_187 [ 0 ] < 0 || V_187 [ 1 ] < 0 ) {
F_32 ( & V_202 -> V_8 , L_25 ) ;
return - V_206 ;
}
V_204 = F_61 ( V_202 , V_207 , 0 ) ;
if ( ! V_204 ) {
F_32 ( & V_202 -> V_8 , L_26 ) ;
return - V_206 ;
}
V_3 = F_62 ( V_204 -> V_208 , F_63 ( V_204 ) ) ;
if ( ! V_3 ) {
F_32 ( & V_202 -> V_8 , L_27 ) ;
return - V_209 ;
}
...
V_168 = F_64 ( sizeof( struct V_1 ) , & V_202 -> V_8 ) ;
if ( ! V_168 ) {
V_27 = - V_209 ;
goto V_210;
}
...
V_2 -> V_5 = V_3 ;
V_2 -> V_66 = 1000 ;
snprintf ( V_205 , sizeof( V_205 ) , L_29 , V_202 -> V_211 ) ;
V_2 -> V_212 = F_65 ( & V_202 -> V_8 , V_205 ) ;
if ( F_66 ( V_2 -> V_212 ) ) {
F_32 ( & V_202 -> V_8 , L_30 , V_205 ) ;
V_27 = F_67 ( V_2 -> V_212 ) ;
goto V_213;
}
F_68 ( V_2 -> V_212 ) ;
V_2 -> V_47 = F_69 ( V_2 -> V_212 ) ;
V_2 -> V_7 = V_202 ;
F_23 ( & V_2 -> V_83 ) ;
F_70 ( & V_2 -> V_169 ) ;
V_168 -> V_214 = & V_215 ;
V_168 -> V_216 = V_2 -> V_47 ;
if ( V_168 -> V_216 < 51200000 )
V_168 -> V_217 = V_168 -> V_216 / 128 ;
else if ( V_168 -> V_216 < 102400000 )
V_168 -> V_217 = V_168 -> V_216 / 256 ;
else
V_168 -> V_217 = V_168 -> V_216 / 512 ;
if ( V_7 -> V_218 )
V_168 -> V_219 = V_7 -> V_218 ;
V_168 -> V_220 = V_221 ;
if ( V_7 -> V_220 )
V_168 -> V_220 |= V_7 -> V_220 ;
V_168 -> V_222 = 32 ;
V_168 -> V_223 = 512 ;
V_168 -> V_224 = V_225 * V_168 -> V_222 ;
V_168 -> V_226 = V_168 -> V_224 / V_168 -> V_223 ;
V_168 -> V_227 = V_168 -> V_224 ;
F_28 ( V_2 ) ;
F_71 ( V_202 , V_2 ) ;
F_72 ( & V_202 -> V_8 ) ;
V_2 -> V_182 = false ;
...
goto V_228;
F_74 ( V_168 ) ;
F_30 ( V_2 -> V_5 , V_81 , V_229 ) ;
V_27 = F_75 ( V_187 [ 0 ] , F_58 , 0 , L_31 , V_2 ) ;
if ( V_27 ) {
F_32 ( & V_202 -> V_8 , L_32 ) ;
goto V_230;
}
V_27 = F_75 ( V_187 [ 1 ] , F_58 , 0 , L_33 , V_2 ) ;
if ( V_27 ) {
F_76 ( V_187 [ 0 ] , V_2 ) ;
F_32 ( & V_202 -> V_8 , L_34 ) ;
goto V_230;
...
static int T_7 F_84 ( struct V_201 * V_202 )
{
struct V_1 * V_2 = F_85 ( V_202 ) ;
int V_187 [ 2 ] ;
F_53 ( & V_202 -> V_8 ) ;
F_78 ( V_2 -> V_168 ) ;
F_30 ( V_2 -> V_5 , V_81 , V_229 ) ;
