...
static int F_14 ( struct V_2 * V_3 , struct V_32 * V_33 )
{
struct V_6 * V_7 = F_4 ( V_3 ) ;
return F_15 ( V_7 , V_33 , V_34 , 0 ) ;
}
...
struct V_2 * V_3 ;
int V_37 ;
if ( ! F_9 ( V_7 -> V_12 , V_38 ) )
return - V_39 ;
F_17 ( V_7 , L_9 ,
V_7 -> V_40 << 1 , V_7 -> V_12 -> V_41 ) ;
V_8 = F_18 ( sizeof( struct V_1 ) , V_42 ) ;
if ( V_8 == NULL )
return - V_43 ;
V_3 = & V_8 -> V_3 ;
F_19 ( V_3 , V_7 , & V_44 ) ;
V_8 -> V_26 = V_18 ;
V_8 -> V_20 = 0 ;
V_37 = F_8 ( V_3 , V_19 , sizeof( V_19 ) ) ;
if ( V_37 >= 0 ) {
V_37 = F_3 ( V_3 , 0x07 , V_21 | V_22 ) ;
V_37 = F_3 ( V_3 , 0x07 , V_21 ) ;
V_37 = F_6 ( V_3 , 0x12 ) ;
F_12 ( 1 , V_17 , V_3 , L_10 , V_37 & 1 ) ;
}
if ( V_37 < 0 )
F_12 ( 1 , V_17 , V_3 , L_11 , V_37 ) ;
return 0 ;
}
