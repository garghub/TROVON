...
switch ( V_8 -> V_69 ) {
case V_70 :
V_53 = F_27 ( V_96 , V_29 -> V_53 , ( 0xc2 >> 1 ) ,
NULL , V_97 ) ;
break;
case V_76 :
V_53 = F_27 ( V_96 , V_29 -> V_53 , ( 0xc2 >> 1 ) ,
...
break;
case V_79 :
V_53 = F_27 ( V_96 , V_29 -> V_53 , ( 0xc0 >> 1 ) ,
& V_29 -> V_32 -> V_73 , V_98 ) ;
break;
case V_82 :
V_53 = F_27 ( V_99 , V_29 -> V_53 , & V_29 -> V_32 -> V_73 ,
& V_100 ) ;
break;
case V_85 :
if ( V_87 ) {
...
break;
case V_92 :
V_53 = F_27 ( V_102 , V_29 -> V_53 ,
& V_103 , & V_29 -> V_32 -> V_73 ) ;
if ( V_53 ) {
V_53 = F_27 ( V_99 , V_29 -> V_53 ,
...
T_1 V_105 [ 2 ] ;
int V_11 ;
V_11 = F_1 ( V_2 , V_12 , sizeof( V_12 ) , V_105 , sizeof( V_105 ) ) ;
if ( V_11 )
return V_11 ;
if ( V_105 [ 0 ] ) {
F_31 ( L_12 , V_19 , V_105 [ 1 ] ) ;
F_32 ( V_2 -> V_106 , 0x08 << 8 | V_105 [ 1 ] , 0 ) ;
}
return 0 ;
}
...
if ( V_108 -> V_112 < 1 )
return - V_95 ;
V_11 = F_34 ( V_108 , & V_113 , V_114 , & V_2 ,
V_115 ) ;
if ( V_11 )
return V_11 ;
V_111 = F_35 ( V_108 , 0 ) ;
...
V_11 = F_36 ( V_2 -> V_16 , V_111 -> V_116 . V_117 ,
V_111 -> V_116 . V_118 ) ;
if ( V_11 )
return V_11 ;
return F_18 ( V_2 ) ;
