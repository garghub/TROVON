...
F_143 ( V_270 , V_4 ) ;
memcpy ( V_16 -> V_187 , V_271 , sizeof( V_271 ) ) ;
V_270 -> V_176 = V_4 -> V_176 ;
V_270 -> V_272 = V_4 -> V_272 ;
V_270 -> V_273 = V_4 -> V_273 ;
V_270 -> V_2 . V_274 = V_4 -> V_275 ;
V_270 -> V_2 . V_276 = V_4 -> V_276 ;
V_270 -> V_2 . V_196 = V_4 -> V_196 ;
V_270 -> V_2 . V_193 = V_4 -> V_193 ;
V_270 -> V_114 . V_172 = V_4 -> V_114 . V_172 ;
V_270 -> V_187 = & V_16 -> V_187 ;
V_270 -> V_277 = V_186 ;
V_270 -> V_278 = sizeof( V_16 -> V_187 [ 0 ] ) ;
F_144 ( V_270 , V_184 , V_185 ) ;
F_145 ( V_279 , V_270 -> V_280 ) ;
for ( V_19 = 0 ; V_19 < V_186 ; V_19 ++ )
F_144 ( V_270 , V_281 , V_16 -> V_187 [ V_19 ] ) ;
error = F_146 ( V_270 ) ;
if ( error ) {
F_97 ( V_4 , L_100 ) ;
F_147 ( V_270 ) ;
...
{
struct V_269 * V_270 = V_16 -> V_183 ;
V_16 -> V_183 = NULL ;
if ( V_270 )
F_149 ( V_270 ) ;
}
static inline int F_150 ( struct V_15 * V_16 , struct V_1 * V_10 )
{
return 0 ;
}
static inline void F_151 ( struct V_15 * V_16 )
{
}
static int F_152 ( struct V_3 * V_4 , struct V_15 * V_16 )
{
int error ;
error = F_96 ( V_4 ) ;
if ( error )
...
F_98 ( V_4 , L_101 ,
F_66 ( & V_4 -> V_114 ) ) ;
error = F_141 ( V_16 , F_153 ( V_247 , V_4 ) ) ;
if ( error )
goto V_177;
error = F_150 ( V_16 , F_153 ( V_248 , V_4 ) ) ;
if ( error )
goto V_177;
error = F_49 ( V_16 ) ;
if ( error )
...
static int F_154 ( struct V_3 * V_4 , struct V_15 * V_16 )
{
int error ;
error = F_96 ( V_4 ) ;
if ( error )
...
error = F_53 ( & V_4 -> V_114 , & V_290 ) ;
if ( error ) {
F_97 ( V_4 , L_9 ) ;
goto V_291;
}
if ( V_16 -> V_22 & V_194 )
error = F_154 ( V_4 , V_16 ) ;
else
error = F_152 ( V_4 , V_16 ) ;
if ( error )
goto V_292;
F_92 ( V_189 L_108 ) ;
return 0 ;
V_292:
F_56 ( & V_4 -> V_114 , & V_290 ) ;
V_291:
