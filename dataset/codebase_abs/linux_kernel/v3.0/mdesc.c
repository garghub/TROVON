...
static void T_3 F_55 ( T_4 * V_86 ,
struct V_1 * V_2 ,
T_2 V_87 )
{
const T_2 * V_88 = F_34 ( V_2 , V_87 , L_29 , NULL ) ;
const T_2 * V_89 = F_34 ( V_2 , V_87 , L_30 , NULL ) ;
const T_2 * V_90 = F_34 ( V_2 , V_87 , L_31 , NULL ) ;
const char * type ;
int V_91 ;
type = F_34 ( V_2 , V_87 , L_32 , & V_91 ) ;
switch ( * V_88 ) {
case 1 :
if ( F_56 ( type , L_33 , V_91 ) ) {
V_86 -> V_92 = * V_89 ;
V_86 -> V_93 = * V_90 ;
} else if ( F_56 ( type , L_34 , V_91 ) ) {
V_86 -> V_94 = * V_89 ;
V_86 -> V_95 = * V_90 ;
}
break;
...
static void T_3 F_57 ( struct V_1 * V_2 , T_2 V_87 , int V_98 )
{
T_2 V_32 ;
F_32 (a, hp, mp, MDESC_ARC_TYPE_BACK) {
T_2 V_99 = F_33 ( V_2 , V_32 ) ;
const char * V_34 ;
const T_2 * V_31 ;
V_34 = F_49 ( V_2 , V_99 ) ;
if ( ! strcmp ( V_34 , L_36 ) ) {
V_31 = F_34 ( V_2 , V_99 , L_4 , NULL ) ;
if ( * V_31 < V_85 )
F_58 ( * V_31 ) . V_98 = V_98 ;
} else {
T_2 V_100 ;
F_32 (j, hp, t, MDESC_ARC_TYPE_BACK) {
T_2 V_101 = F_33 ( V_2 , V_100 ) ;
const char * V_102 ;
V_102 = F_49 ( V_2 , V_101 ) ;
if ( strcmp ( V_102 , L_36 ) )
continue;
V_31 = F_34 ( V_2 , V_101 , L_4 , NULL ) ;
if ( * V_31 < V_85 )
F_58 ( * V_31 ) . V_98 = V_98 ;
}
}
...
static void T_3 F_59 ( struct V_1 * V_2 )
{
int V_103 ;
T_2 V_87 ;
V_103 = 1 ;
...
const char * type ;
int V_46 ;
V_88 = F_34 ( V_2 , V_87 , L_29 , NULL ) ;
if ( * V_88 != 1 )
continue;
type = F_34 ( V_2 , V_87 , L_32 , & V_46 ) ;
...
static void T_3 F_60 ( struct V_1 * V_2 , T_2 V_87 , int V_104 )
{
T_2 V_32 ;
F_32 (a, hp, mp, MDESC_ARC_TYPE_BACK) {
T_2 V_99 = F_33 ( V_2 , V_32 ) ;
...
V_31 = F_34 ( V_2 , V_99 , L_4 , NULL ) ;
if ( * V_31 < V_85 )
F_58 ( * V_31 ) . V_104 = V_104 ;
}
}
static void T_3 F_61 ( struct V_1 * V_2 , const char * V_105 )
{
int V_103 ;
T_2 V_87 ;
V_103 = 0 ;
...
static void T_3 F_62 ( struct V_1 * V_2 )
{
F_61 ( V_2 , L_39 ) ;
F_61 ( V_2 , L_40 ) ;
}
static void T_3 F_63 ( const T_2 * V_42 , unsigned int * V_106 ,
unsigned char V_107 )
{
T_2 V_64 ;
if ( ! V_42 )
...
if ( ! V_64 || V_64 >= 64 )
goto V_108;
* V_106 = ( ( 1U << V_64 ) * 64U ) - 1U ;
return;
V_108:
* V_106 = ( ( 1U << V_107 ) * 64U ) - 1U ;
}
static void T_3 F_64 ( struct V_1 * V_2 , T_2 V_87 ,
struct V_109 * V_110 )
{
const T_2 * V_64 ;
V_64 = F_34 ( V_2 , V_87 , L_41 , NULL ) ;
F_63 ( V_64 , & V_110 -> V_111 , 7 ) ;
V_64 = F_34 ( V_2 , V_87 , L_42 , NULL ) ;
F_63 ( V_64 , & V_110 -> V_112 , 7 ) ;
V_64 = F_34 ( V_2 , V_87 , L_43 , NULL ) ;
F_63 ( V_64 , & V_110 -> V_113 , 6 ) ;
V_64 = F_34 ( V_2 , V_87 , L_44 , NULL ) ;
F_63 ( V_64 , & V_110 -> V_114 , 2 ) ;
}
static void * T_3 F_65 ( void * (* F_36)( struct V_1 * , T_2 , int , void * ) , void * V_115 , T_5 * V_106 )
{
struct V_1 * V_2 = F_20 () ;
void * V_61 = NULL ;
T_2 V_87 ;
F_29 (hp, mp, L_36 ) {
const T_2 * V_31 = F_34 ( V_2 , V_87 , L_4 , NULL ) ;
int V_116 = * V_31 ;
#ifdef F_53
if ( V_116 >= V_85 ) {
F_37 ( V_117 L_45
...
continue;
#endif
V_61 = F_36 ( V_2 , V_87 , V_116 , V_115 ) ;
if ( V_61 )
goto V_51;
}
V_51:
...
static void * T_3 F_67 ( struct V_1 * V_2 , T_2 V_87 , int V_116 , void * V_115 )
{
V_118 ++ ;
#ifdef F_53
F_68 ( V_116 , true ) ;
...
void T_3 F_69 ( T_5 * V_106 )
{
if ( V_119 != V_120 )
return;
V_118 = 0 ;
F_65 ( F_67 , NULL , V_106 ) ;
}
static void * T_3 F_70 ( struct V_1 * V_2 , T_2 V_87 , int V_116 , void * V_115 )
{
const T_2 * V_121 = F_34 ( V_2 , V_87 , L_47 , NULL ) ;
struct V_109 * V_110 ;
T_4 * V_86 ;
T_2 V_32 ;
#ifndef F_53
...
F_64 ( V_2 , V_87 , V_110 ) ;
F_32 (a, hp, mp, MDESC_ARC_TYPE_FWD) {
T_2 V_100 , V_99 = F_33 ( V_2 , V_32 ) ;
const char * V_124 ;
V_124 = F_49 ( V_2 , V_99 ) ;
if ( ! strcmp ( V_124 , L_35 ) ) {
F_55 ( V_86 , V_2 , V_99 ) ;
continue;
}
...
void T_3 F_72 ( T_5 * V_106 )
{
struct V_1 * V_2 ;
F_65 ( F_70 , NULL , V_106 ) ;
#ifdef F_53
V_125 = 1 ;
#endif
V_2 = F_20 () ;
...
static T_6 F_74 ( struct V_126 * V_126 , char T_7 * V_127 ,
T_8 V_46 , T_9 * V_128 )
{
struct V_1 * V_2 = F_20 () ;
int V_129 ;
...
if ( V_46 < V_2 -> V_3 )
V_129 = - V_131 ;
else if ( F_75 ( V_127 , & V_2 -> V_5 , V_2 -> V_3 ) )
V_129 = - V_132 ;
F_24 ( V_2 ) ;
return V_129 ;
}
