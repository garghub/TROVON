...
static int
F_38 ( struct V_12 * V_13 , struct V_14 * V_50 )
{
struct V_108 * V_6 ;
if ( F_5 ( V_13 , V_50 ) )
return 0 ;
...
static void
F_39 ( struct V_3 * V_4 , struct V_14 * V_50 )
{
V_4 -> V_22 = & V_23 [ V_111 ] ;
}
static int
F_40 ( struct V_12 * V_13 , struct V_14 * V_112 ,
struct V_14 * V_113 )
{
struct V_114 * V_6 ;
if ( F_5 ( V_13 , V_112 ) )
...
static int
F_41 ( struct V_14 * V_112 , struct V_51 * V_117 ,
...
static int
F_42 ( struct V_14 * V_14 , struct V_14 * V_50 , struct V_51 * V_52 )
{
struct V_120 V_43 = {
. V_121 = F_15 ( V_14 ) ,
. V_122 = F_15 ( V_50 ) ,
...
static int
F_43 ( struct V_14 * V_50 , struct V_38 * V_38 , struct V_79 * V_79 ,
...
V_86 -> V_43 . V_130 . V_131 = V_38 -> V_91 . V_52 ;
V_86 -> V_43 . V_130 . V_132 = V_38 -> V_91 . V_54 ;
...
static int
F_44 ( struct V_14 * V_50 , struct V_38 * V_38 , struct V_39 * V_40 )
{
struct V_85 * V_86 ;
int V_65 = V_40 -> V_90 ;
int V_27 = - V_58 ;
...
V_86 -> V_43 . V_135 . V_52 = V_38 -> V_91 . V_52 ;
V_86 -> V_43 . V_135 . V_54 = V_38 -> V_91 . V_54 ;
...
static int
F_45 ( struct V_14 * V_50 , struct V_51 * V_52 )
{
struct V_37 * V_57 ;
struct V_53 V_43 = {
. V_44 = F_15 ( V_50 ) ,
...
static int
F_46 ( struct V_38 * V_38 , struct V_48 * V_64 ,
...
static int
F_49 ( struct V_14 * V_50 , struct V_38 * V_38 , struct V_39 * V_40 ,
T_4 V_145 )
{
struct V_85 * V_86 ;
T_1 V_65 = V_40 -> V_90 ;
...
F_50 ( V_145 ) , F_51 ( V_145 ) ) ;
V_40 -> V_90 &= ~ F_34 () ;
V_86 = F_26 () ;
if ( V_86 == NULL )
goto V_78;
V_86 -> V_4 . V_22 = & V_23 [ V_146 ] ;
V_86 -> V_43 . V_147 . V_44 = F_15 ( V_50 ) ;
V_86 -> V_43 . V_147 . V_52 = V_38 -> V_91 . V_52 ;
V_86 -> V_43 . V_147 . V_54 = V_38 -> V_91 . V_54 ;
V_86 -> V_43 . V_147 . V_40 = V_40 ;
V_86 -> V_43 . V_147 . V_145 = V_145 ;
switch ( V_40 -> V_90 & V_148 ) {
case V_149 :
V_86 -> V_43 . V_147 . type = V_150 ;
break;
case V_151 :
V_86 -> V_43 . V_147 . type = V_152 ;
break;
case V_153 :
V_86 -> V_43 . V_147 . type = V_154 ;
break;
case V_155 :
V_86 -> V_43 . V_147 . type = V_156 ;
break;
default:
V_27 = - V_157 ;
goto V_78;
...
static int
F_52 ( struct V_33 * V_34 , struct V_18 * V_19 ,
struct V_158 * V_159 )
{
struct V_3 V_4 = {
. V_22 = & V_23 [ V_160 ] ,
...
static int
F_53 ( struct V_1 * V_17 , struct V_18 * V_19 ,
struct V_20 * V_21 )
{
struct V_3 V_4 = {
. V_22 = & V_23 [ V_24 ] ,
...
static int
F_54 ( struct V_33 * V_34 , struct V_18 * V_19 ,
struct V_20 * V_21 )
{
int V_27 ;
V_27 = F_53 ( V_34 -> V_17 , V_19 , V_21 ) ;
if ( V_27 && V_34 -> V_35 -> V_36 != V_34 -> V_17 )
V_27 = F_53 ( V_34 -> V_35 -> V_36 , V_19 , V_21 ) ;
return V_27 ;
}
static int
...
static int F_56 ( struct V_12 * V_13 , struct V_163 * V_86 )
{
...
static void F_57 ( struct V_163 * V_86 , struct V_3 * V_4 )
{
V_4 -> V_22 = & V_23 [ V_165 ] ;
}
static int F_58 ( struct V_12 * V_13 , struct V_166 * V_86 )
{
if ( F_5 ( V_13 , V_86 -> V_14 ) )
return - V_164 ;
if ( V_13 -> V_15 >= 0 )
F_59 ( V_86 -> V_14 , V_86 -> V_6 . V_29 ) ;
return 0 ;
}
static void F_60 ( struct V_166 * V_86 , struct V_3 * V_4 )
{
V_4 -> V_22 = & V_23 [ V_167 ] ;
}
static int F_61 ( struct V_12 * V_13 , struct V_166 * V_86 )
{
if ( F_5 ( V_13 , V_86 -> V_14 ) )
return - V_164 ;
...
static void F_62 ( struct V_166 * V_86 , struct V_3 * V_4 )
{
V_4 -> V_22 = & V_23 [ V_168 ] ;
}
static int
F_63 ( struct V_169 * V_170 , int V_171 , struct V_172 * V_173 )
{
struct V_14 * V_14 = V_170 -> V_174 . V_38 -> V_41 ;
return F_64 ( F_65 ( V_14 ) -> V_175 , V_171 , V_173 ) ;
}
