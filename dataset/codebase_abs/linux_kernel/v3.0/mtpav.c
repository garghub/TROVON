...
static int T_4 F_34 ( struct V_1 * V_71 )
{
...
V_71 -> V_13 = V_13 ;
if ( F_37 ( V_69 , F_31 , V_76 , L_3 , V_71 ) ) {
F_36 ( V_74 L_4 , V_69 ) ;
return - V_75 ;
}
V_71 -> V_69 = V_69 ;
...
sprintf ( V_29 -> V_77 , L_5 , ( V_29 -> V_36 % V_2 -> V_4 ) + 1 ) ;
else if ( V_29 -> V_36 >= 8 && V_29 -> V_36 < V_2 -> V_4 * 2 )
sprintf ( V_29 -> V_77 , L_6 , ( V_29 -> V_36 % V_2 -> V_4 ) + 1 ) ;
else if ( V_29 -> V_36 == V_2 -> V_4 * 2 )
strcpy ( V_29 -> V_77 , L_7 ) ;
else if ( V_29 -> V_36 == V_2 -> V_4 * 2 + 1 )
strcpy ( V_29 -> V_77 , L_8 ) ;
else
strcpy ( V_29 -> V_77 , L_9 ) ;
}
static int T_4 F_39 ( struct V_1 * V_71 )
{
int V_11 ;
struct V_78 * V_79 ;
struct V_28 * V_29 ;
...
V_29 = F_42 ( V_81 , struct V_28 , V_81 ) ;
F_38 ( V_71 , V_29 ) ;
V_29 -> V_84 = & V_85 ;
}
...
V_79 -> V_87 |= V_88 | V_89 |
V_90 ;
sprintf ( V_79 -> V_77 , L_11 ) ;
return 0 ;
}
static void F_43 ( struct V_91 * V_83 )
{
struct V_1 * V_92 = V_83 -> V_34 ;
unsigned long V_37 ;
F_13 ( & V_92 -> V_38 , V_37 ) ;
if ( V_92 -> V_53 > 0 )
F_22 ( V_92 ) ;
...
int V_95 ;
struct V_1 * V_25 ;
V_95 = F_47 ( V_96 , V_97 , V_98 , sizeof( * V_25 ) , & V_83 ) ;
if ( V_95 < 0 )
return V_95 ;
V_25 = V_83 -> V_34 ;
F_48 ( & V_25 -> V_38 ) ;
...
if ( V_95 < 0 )
goto V_101;
strcpy ( V_83 -> V_102 , L_12 ) ;
strcpy ( V_83 -> V_103 , L_13 ) ;
snprintf ( V_83 -> V_104 , sizeof( V_83 -> V_104 ) ,
L_14 , V_13 ) ;
F_15 ( V_25 ) ;
F_50 ( V_83 , & V_94 -> V_94 ) ;
V_95 = F_51 ( V_25 -> V_83 ) ;
...
goto V_101;
F_52 ( V_94 , V_83 ) ;
F_53 ( V_105 L_15 , V_69 , V_13 ) ;
return 0 ;
V_101:
F_54 ( V_83 ) ;
return V_95 ;
}
static int T_5 F_55 ( struct V_93 * V_106 )
{
F_54 ( F_56 ( V_106 ) ) ;
F_52 ( V_106 , NULL ) ;
return 0 ;
...
{
int V_95 ;
if ( ( V_95 = F_58 ( & V_107 ) ) < 0 )
return V_95 ;
V_108 = F_59 ( V_109 , - 1 , NULL , 0 ) ;
if ( ! F_60 ( V_108 ) ) {
if ( F_56 ( V_108 ) )
return 0 ;
F_61 ( V_108 ) ;
