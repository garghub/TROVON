...
const char * V_128 ;
if ( ! V_29 -> V_24 . V_129 ||
F_34 ( V_29 -> V_24 . V_129 ) -> V_130 != V_29 -> V_131 )
return - V_132 ;
V_126 = F_7 ( V_3 , V_133 ) ;
V_127 = F_7 ( V_3 , V_134 ) ;
switch ( F_35 ( V_126 , V_127 ) ) {
case V_135 :
V_128 = L_3 ;
V_19 -> V_61 = V_136 ;
break;
...
static int F_37 ( struct V_16 * V_17 , unsigned int V_141 ,
enum V_74 * V_26 )
{
if ( V_141 >= F_27 ( V_76 ) )
return - V_66 ;
...
struct V_145 * V_146 = F_39 ( V_3 -> V_24 . V_129 ) ;
struct V_31 * V_32 ;
int V_8 ;
if ( ! V_29 ) {
F_12 ( & V_3 -> V_24 , L_7 ) ;
...
V_19 = F_41 ( sizeof( * V_19 ) , V_149 ) ;
if ( ! V_19 )
return - V_150 ;
V_19 -> V_38 = V_32 -> V_19 ;
F_42 ( & V_19 -> V_4 , V_3 , & V_151 ) ;
V_29 -> V_152 = & V_153 ;
V_8 = F_33 ( V_29 , V_3 ) ;
if ( V_8 ) {
V_29 -> V_152 = NULL ;
