...
V_20 = V_17 >> 1 ;
V_18 = ( unsigned short * ) V_15 ;
V_19 = ( unsigned short * ) V_16 ;
while ( V_20 -- ) {
* V_18 ++ = * V_19 ++ ;
V_18 ++ ;
}
...
F_53 ( & V_4 -> V_136 , V_138 + 4 * V_150 / 100 ) ;
F_27 ( V_26 ) ;
return;
}
F_8 ( V_26 ) ;
...
static int T_5 F_55 ( struct V_154 * V_155 , const int type )
{
static unsigned V_156 ;
static const char V_157 [] = L_24 ;
char V_84 [ 10 ] ;
struct V_25 * V_26 ;
struct V_3 * V_4 ;
...
F_11 ( V_163 ) ;
if ( V_155 )
snprintf ( V_84 , sizeof( V_84 ) , L_8 , F_56 ( V_155 ) ) ;
else {
V_29 = 0 ;
V_26 = V_164 ;
while ( V_26 ) {
...
snprintf ( V_84 , sizeof( V_84 ) , V_157 , V_29 ) ;
}
...
static void T_7 F_69 ( struct V_154 * V_155 )
{
...
static int T_5 F_74 ( struct V_154 * V_26 )
{
...
static int T_7 F_76 ( struct V_154 * V_26 )
{
F_77 ( V_26 ) ;
F_69 ( V_26 ) ;
return 0 ;
