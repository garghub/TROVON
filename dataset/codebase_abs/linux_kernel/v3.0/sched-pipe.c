...
V_13 = F_6 ( V_4 [ 0 ] , & V_6 , sizeof( int ) ) ;
V_13 = F_7 ( V_5 [ 1 ] , & V_6 , sizeof( int ) ) ;
}
} else {
for ( V_7 = 0 ; V_7 < V_19 ; V_7 ++ ) {
V_13 = F_7 ( V_4 [ 1 ] , & V_6 , sizeof( int ) ) ;
V_13 = F_6 ( V_5 [ 0 ] , & V_6 , sizeof( int ) ) ;
}
}
F_5 ( & V_10 , NULL ) ;
F_8 ( & V_10 , & V_9 , & V_11 ) ;
if ( V_15 ) {
V_16 = F_9 ( V_15 , & V_14 , 0 ) ;
assert ( ( V_16 == V_15 ) && F_10 ( V_14 ) ) ;
} else {
exit ( 0 ) ;
}
switch ( V_20 ) {
