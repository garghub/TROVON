...
int V_45 = 0 , V_22 ;
V_28 -> V_52 = V_53 ;
V_2 -> V_112 = V_28 -> V_112 ;
V_45 = F_27 ( V_2 , 7 , 9 , V_113 ) ;
if ( V_45 < 0 ) {
F_28 ( V_2 -> V_16 , L_14 , V_45 ) ;
return V_45 ;
}
for ( V_22 = 0 ; V_22 < F_3 ( V_114 ) ; V_22 ++ )
F_12 ( V_2 , V_114 [ V_22 ] , 0x100 , 0x100 ) ;
...
static T_4 int F_31 ( struct V_116 * V_117 ,
const struct V_118 * V_119 )
{
struct V_27 * V_28 ;
int V_45 ;
V_28 = F_32 ( sizeof( struct V_27 ) , V_120 ) ;
if ( V_28 == NULL )
return - V_121 ;
F_33 ( V_117 , V_28 ) ;
V_28 -> V_112 = V_117 ;
V_45 = F_34 ( & V_117 -> V_16 ,
& V_122 , & V_123 , 1 ) ;
if ( V_45 < 0 )
F_35 ( V_28 ) ;
return V_45 ;
}
static T_5 int F_36 ( struct V_116 * V_124 )
{
F_37 ( & V_124 -> V_16 ) ;
F_35 ( F_38 ( V_124 ) ) ;
return 0 ;
