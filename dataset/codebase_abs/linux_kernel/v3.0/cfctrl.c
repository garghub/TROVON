...
F_5 ( F_6 ( struct V_1 , V_10 . V_11 ) == 0 ) ;
memset ( & V_7 , 0 , sizeof( V_7 ) ) ;
V_7 . V_12 = 0xff ;
memset ( V_8 , 0 , sizeof( * V_8 ) ) ;
F_7 ( & V_8 -> V_10 , 0 , & V_7 , false ) ;
F_8 ( & V_8 -> V_13 , 1 ) ;
F_8 ( & V_8 -> V_14 , 1 ) ;
V_8 -> V_10 . V_11 . V_15 = V_16 ;
sprintf ( V_8 -> V_10 . V_11 . V_17 , L_2 ) ;
...
void F_12 ( struct V_6 * V_11 )
{
struct V_24 * V_25 , * V_26 ;
struct V_1 * V_2 = F_13 ( V_11 ) ;
F_14 ( & V_2 -> V_22 ) ;
F_15 (p, tmp, &ctrl->list, list) {
F_16 ( & V_25 -> V_23 ) ;
F_17 ( V_25 ) ;
}
F_18 ( & V_2 -> V_22 ) ;
...
static bool F_20 ( const struct V_24 * V_54 ,
const struct V_24 * V_55 )
{
if ( V_54 -> V_3 != V_55 -> V_3 )
return false ;
if ( V_54 -> V_3 == V_56 )
return F_19 ( & V_54 -> V_57 , & V_55 -> V_57 ) ;
else
...
F_14 ( & V_2 -> V_22 ) ;
F_22 ( & V_2 -> V_13 ) ;
V_59 -> V_60 = F_23 ( & V_2 -> V_13 ) ;
F_24 ( & V_59 -> V_23 , & V_2 -> V_23 ) ;
F_18 ( & V_2 -> V_22 ) ;
}
static struct V_24 * F_25 ( struct V_1 * V_2 ,
struct V_24 * V_59 )
{
struct V_24 * V_25 , * V_26 , * V_61 ;
V_61 = F_26 ( & V_2 -> V_23 , struct V_24 , V_23 ) ;
F_15 (p, tmp, &ctrl->list, list) {
if ( F_20 ( V_59 , V_25 ) ) {
if ( V_25 != V_61 )
F_4 ( L_3 ) ;
...
int F_42 ( struct V_6 * V_11 , T_1 V_87 ,
struct V_6 * V_88 )
{
int V_77 ;
struct V_1 * V_1 = F_13 ( V_11 ) ;
...
F_5 ( sizeof( V_107 . V_38 . V_45 . V_17 )
>= V_82 ) ;
for ( V_106 = 0 ;
V_106 < V_82
&& F_45 ( V_5 ) ; V_106 ++ ) {
