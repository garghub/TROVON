...
static int T_5 F_82 ( struct V_95 * V_96 ,
...
static int T_5 F_86 ( struct V_95 * V_96 )
{
struct V_11 * V_12 ;
struct V_101 * V_102 = V_96 -> V_19 . V_103 ;
int V_20 = V_21 [ V_102 -> type ] ;
int V_22 = V_23 [ V_102 -> type ] ;
int V_81 , V_99 ;
T_2 V_104 , V_2 ;
V_12 = F_87 ( sizeof( struct V_11 ) , V_105 ) ;
if ( ! V_12 )
return - V_106 ;
V_12 -> V_13 = F_88 ( V_96 , V_107 , 0 ) -> V_108 ;
V_12 -> type = V_102 -> type ;
V_12 -> V_35 =
( V_12 -> type == V_17 || V_12 -> type == V_38 ) ? 0 : 1 ;
F_89 ( & V_12 -> V_25 ) ;
F_90 ( V_96 , V_12 ) ;
V_104 = F_13 ( V_12 , V_109 ) ;
if ( V_104 & 0x04 ) {
F_91 ( & V_96 -> V_19 , L_6 ) ;
V_81 = - V_110 ;
goto V_111;
...
if ( ( ( V_12 -> V_48 >> ( V_99 * 2 ) ) & 3 ) == 3 )
V_81 = 1 ;
break;
case V_56 :
V_81 = ( V_12 -> V_48 & 0x15 ) != 0x15 ;
break;
case V_38 :
V_81 = V_12 -> V_48 & 0x20 ;
break;
...
F_93 ( & V_96 -> V_19 ,
L_8 ,
( unsigned int ) V_12 -> V_48 ) ;
V_81 = - V_110 ;
goto V_113;
}
V_81 = F_82 ( V_96 , & V_128 [ 0 ] [ 0 ] ,
F_92 ( V_128 [ 0 ] ) * V_20 ) ;
if ( V_81 )
goto V_113;
if ( V_42 [ V_12 -> type ] ) {
...
V_130:
for ( V_99 = 0 ; V_99 < V_20 ; V_99 ++ )
F_94 ( & V_96 -> V_19 , L_12 , V_99 + 1 ,
( V_12 -> V_48 & ( 1 << 2 * V_99 ) ) ?
L_13 : L_14 ) ;
}
V_12 -> V_137 = F_95 ( & V_96 -> V_19 ) ;
if ( F_96 ( V_12 -> V_137 ) ) {
V_81 = F_97 ( V_12 -> V_137 ) ;
V_12 -> V_137 = NULL ;
goto V_113;
}
return 0 ;
...
static int F_98 ( struct V_95 * V_96 )
{
struct V_11 * V_12 = F_100 ( V_96 ) ;
int V_20 = V_21 [ V_12 -> type ] ;
int V_22 = V_23 [ V_12 -> type ] ;
int V_99 ;
T_2 V_104 = F_13 ( V_12 , V_109 ) ;
if ( V_12 -> V_137 )
F_101 ( V_12 -> V_137 ) ;
F_85 ( & V_96 -> V_19 , & V_112 ) ;
if ( V_104 & 0x01 ) {
switch ( V_12 -> type ) {
case V_17 :
if ( V_12 -> V_83 & 0x10 )
...
static int T_6 F_102 ( int V_138 , unsigned short * V_139 ,
struct V_101 * V_102 )
{
T_1 V_140 ;
int V_81 = F_5 ( V_138 ) ;
if ( V_81 )
return V_81 ;
V_140 = F_4 ( V_138 , V_141 ) ;
if ( V_140 != V_142 ) {
F_103 ( L_15 ) ;
V_81 = - V_110 ;
goto exit;
}
V_140 = V_143 ? V_143 : F_4 ( V_138 , V_144 ) ;
switch ( V_140 ) {
case V_145 :
V_102 -> type = V_54 ;
break;
...
F_8 ( V_138 , V_160 ) ;
if ( ! ( F_1 ( V_138 , V_161 ) & 0x01 ) ) {
F_105 ( L_17 ) ;
V_81 = - V_110 ;
goto exit;
}
* V_139 = F_4 ( V_138 , V_162 ) ;
if ( * V_139 == 0 ) {
F_105 ( L_18 ) ;
V_81 = - V_110 ;
goto exit;
...
V_81 = 0 ;
F_104 ( L_19 ,
V_94 [ V_102 -> type ] , ( unsigned int ) * V_139 ,
( int ) F_1 ( V_138 , V_164 ) ) ;
exit:
F_9 ( V_138 ) ;
return V_81 ;
}
static int T_6 F_106 ( unsigned short V_139 ,
...
int V_81 ;
V_169 = F_107 ( V_4 , V_139 ) ;
if ( ! V_169 )
return - V_106 ;
V_166 . V_170 = V_169 -> V_170 ;
V_81 = F_108 ( & V_166 ) ;
if ( V_81 )
goto V_171;
V_81 = F_109 ( V_169 , & V_166 , 1 ) ;
if ( V_81 ) {
F_7 ( L_20 ) ;
goto V_171;
}
V_81 = F_110 ( V_169 , V_102 ,
sizeof( struct V_101 ) ) ;
if ( V_81 ) {
F_7 ( L_21 ) ;
goto V_171;
...
if ( F_102 ( 0x2e , & V_139 , & V_102 ) &&
F_102 ( 0x4e , & V_139 , & V_102 ) )
goto exit;
V_81 = F_114 ( & V_172 ) ;
if ( V_81 )
goto exit;
V_81 = F_106 ( V_139 , & V_102 ) ;
if ( V_81 )
goto V_173;
return 0 ;
V_173:
