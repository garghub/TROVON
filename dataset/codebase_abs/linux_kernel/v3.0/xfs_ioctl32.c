...
break;
case V_127 :
V_109 [ V_27 ] . V_119 = F_39 ( V_94 -> V_128 . V_129 ) ;
if ( V_109 [ V_27 ] . V_119 )
break;
...
error = - F_46 ( F_32 ( V_92 -> V_107 ) , V_132 . V_137 ,
V_132 . V_138 ) ;
V_135:
F_34 ( V_92 ) ;
return error ;
...
unsigned long V_59 )
{
struct V_140 * V_140 = V_139 -> V_128 . V_92 -> V_107 ;
...
if ( F_1 ( & V_1 , V_95 ) )
return - F_4 ( V_11 ) ;
V_66 = F_51 ( V_66 , struct V_185 ) ;
return F_52 ( V_142 , V_140 , V_139 , V_144 , V_66 , & V_1 ) ;
}
case V_186 :
...
if ( F_24 ( & V_83 , V_95 ) )
return - F_4 ( V_11 ) ;
return F_55 ( V_139 , & V_83 ) ;
}
case V_203 : {
struct V_201 V_83 ;
if ( F_24 ( & V_83 , V_95 ) )
return - F_4 ( V_11 ) ;
return F_56 ( V_139 , & V_83 ) ;
}
case V_204 :
