...
static int F_18 ( struct V_6 * V_7 , T_2 V_78 )
{
F_16 ( V_7 , V_77 ) ;
return 0 ;
}
...
if ( V_13 == V_83 )
continue;
V_79 [ 0 ] = ( V_13 << 1 ) | ( ( V_80 [ V_13 ] >> 8 ) & 0x0001 ) ;
V_79 [ 1 ] = V_80 [ V_13 ] & 0x00ff ;
V_7 -> V_84 ( V_7 -> V_85 , V_79 , 2 ) ;
}
F_16 ( V_7 , V_74 ) ;
return 0 ;
}
...
{
struct V_21 * V_22 = F_7 ( V_7 ) ;
struct V_86 * V_75 = & V_7 -> V_75 ;
int V_87 = 0 ;
T_1 V_88 ;
V_87 = F_21 ( V_7 , 7 , 9 , V_22 -> V_89 ) ;
if ( V_87 < 0 ) {
F_10 ( V_7 -> V_48 , L_3 , V_87 ) ;
return V_87 ;
}
V_87 = F_22 ( V_7 ) ;
if ( V_87 < 0 ) {
...
V_88 = F_2 ( V_7 , V_90 ) ;
F_3 ( V_7 , V_90 , V_88 | 0x100 ) ;
V_88 = F_2 ( V_7 , V_91 ) ;
F_3 ( V_7 , V_91 , V_88 | 0x0100 ) ;
V_88 = F_2 ( V_7 , V_92 ) ;
F_3 ( V_7 , V_92 , V_88 | 0x0100 ) ;
V_88 = F_2 ( V_7 , V_93 ) ;
F_3 ( V_7 , V_93 , V_88 | 0x0100 ) ;
V_88 = F_2 ( V_7 , V_94 ) ;
F_3 ( V_7 , V_94 , V_88 | 0x0100 ) ;
F_16 ( V_7 , V_74 ) ;
F_23 ( V_7 , V_95 ,
F_5 ( V_95 ) ) ;
F_24 ( V_75 , V_96 ,
F_5 ( V_96 ) ) ;
F_25 ( V_75 , V_97 , F_5 ( V_97 ) ) ;
return 0 ;
}
...
static int T_4 F_27 ( struct V_98 * V_99 )
{
struct V_21 * V_22 ;
int V_87 ;
V_22 = F_28 ( sizeof( struct V_21 ) , V_100 ) ;
if ( V_22 == NULL )
return - V_101 ;
V_22 -> V_89 = V_102 ;
F_29 ( V_99 , V_22 ) ;
...
static int T_5 F_32 ( struct V_98 * V_99 )
{
F_33 ( & V_99 -> V_48 ) ;
F_31 ( F_34 ( V_99 ) ) ;
return 0 ;
}
static T_4 int F_35 ( struct V_105 * V_106 ,
...
F_36 ( V_106 , V_22 ) ;
V_22 -> V_89 = V_109 ;
V_87 = F_30 ( & V_106 -> V_48 ,
& V_103 , & V_104 , 1 ) ;
if ( V_87 < 0 )
F_31 ( V_22 ) ;
return V_87 ;
}
static T_5 int F_37 ( struct V_105 * V_110 )
{
F_33 ( & V_110 -> V_48 ) ;
F_31 ( F_38 ( V_110 ) ) ;
return 0 ;
