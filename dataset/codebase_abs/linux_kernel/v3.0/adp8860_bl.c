...
struct V_32 * V_33 ;
int V_5 , V_34 ;
V_15 = F_17 ( sizeof( * V_15 ) * V_29 -> V_35 , V_36 ) ;
if ( V_15 == NULL ) {
F_3 ( & V_2 -> V_6 , L_2 ) ;
return - V_37 ;
}
...
V_5 |= F_4 ( V_2 , V_93 ,
F_31 ( V_29 -> V_94 , 0 ) ) ;
V_5 |= F_4 ( V_2 , V_95 , F_18 ( V_29 -> V_96 ,
V_29 -> V_97 ) ) ;
V_5 |= F_6 ( V_2 , V_59 , V_98 | V_64 | V_99 |
( V_9 -> V_100 ? V_101 : 0 ) ) ;
return V_5 ;
}
static T_5 F_32 ( struct V_102 * V_6 , char * V_103 , int V_3 )
{
...
if ( error < 0 )
return error ;
return sprintf ( V_103 , L_7 , V_10 ) ;
}
static T_5 F_34 ( struct V_102 * V_6 , const char * V_103 ,
T_6 V_104 , int V_3 )
{
struct V_8 * V_9 = F_33 ( V_6 ) ;
unsigned long V_4 ;
...
static T_5 F_36 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
return F_32 ( V_6 , V_103 , V_77 ) ;
}
static T_5 F_37 ( struct V_102 * V_6 ,
struct V_105 * V_106 , const char * V_103 , T_6 V_104 )
{
return F_34 ( V_6 , V_103 , V_104 , V_77 ) ;
}
static T_5 F_38 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
return F_32 ( V_6 , V_103 , V_73 ) ;
}
static T_5 F_39 ( struct V_102 * V_6 ,
struct V_105 * V_106 , const char * V_103 , T_6 V_104 )
{
return F_34 ( V_6 , V_103 , V_104 , V_73 ) ;
}
static T_5 F_40 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
return F_32 ( V_6 , V_103 , V_61 ) ;
}
static T_5 F_41 ( struct V_102 * V_6 ,
struct V_105 * V_106 , const char * V_103 , T_6 V_104 )
{
struct V_8 * V_9 = F_33 ( V_6 ) ;
...
static T_5 F_42 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
return F_32 ( V_6 , V_103 , V_79 ) ;
}
static T_5 F_43 ( struct V_102 * V_6 ,
struct V_105 * V_106 ,
const char * V_103 , T_6 V_104 )
{
return F_34 ( V_6 , V_103 , V_104 , V_79 ) ;
}
static T_5 F_44 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
return F_32 ( V_6 , V_103 , V_75 ) ;
}
static T_5 F_45 ( struct V_102 * V_6 ,
struct V_105 * V_106 ,
const char * V_103 , T_6 V_104 )
{
return F_34 ( V_6 , V_103 , V_104 , V_75 ) ;
}
static T_5 F_46 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
return F_32 ( V_6 , V_103 , V_71 ) ;
}
static T_5 F_47 ( struct V_102 * V_6 ,
struct V_105 * V_106 ,
const char * V_103 , T_6 V_104 )
{
return F_34 ( V_6 , V_103 , V_104 , V_71 ) ;
}
static T_5 F_48 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
struct V_8 * V_9 = F_33 ( V_6 ) ;
int error ;
...
return error ;
V_107 += ( V_10 & 0x1F ) << 8 ;
return sprintf ( V_103 , L_7 , V_107 ) ;
}
static T_5 F_49 ( struct V_102 * V_6 ,
struct V_105 * V_106 , char * V_103 )
{
struct V_8 * V_9 = F_33 ( V_6 ) ;
int error ;
...
if ( error < 0 )
return error ;
return sprintf ( V_103 , L_7 ,
( ( V_10 >> V_110 ) & V_111 ) + 1 ) ;
}
static T_5 F_50 ( struct V_102 * V_6 ,
struct V_105 * V_106 ,
const char * V_103 , T_6 V_104 )
{
struct V_8 * V_9 = F_33 ( V_6 ) ;
...
V_65 . V_127 = V_58 ;
F_56 ( & V_9 -> V_11 ) ;
V_56 = F_57 ( F_58 ( & V_2 -> V_6 ) ,
& V_2 -> V_6 , V_9 , & V_128 , & V_65 ) ;
if ( F_59 ( V_56 ) ) {
F_3 ( & V_2 -> V_6 , L_11 ) ;
V_5 = F_60 ( V_56 ) ;
goto V_119;
...
static int F_67 ( struct V_1 * V_2 , T_8 V_133 )
{
F_10 ( V_2 , V_59 , V_99 ) ;
return 0 ;
}
