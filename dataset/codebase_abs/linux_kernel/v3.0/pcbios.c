...
static int F_13 ( unsigned int V_35 , unsigned int V_36 ,
unsigned int V_37 , int V_38 , int V_39 , T_2 V_40 )
{
unsigned long V_41 = 0 ;
unsigned long V_14 ;
...
static struct V_45 * T_1 F_14 ( void )
{
union V_46 * V_47 ;
unsigned char V_48 ;
int V_49 , V_12 ;
for ( V_47 = (union V_46 * ) F_15 ( 0xe0000 ) ;
V_47 <= (union V_46 * ) F_15 ( 0xffff0 ) ;
++ V_47 ) {
long V_50 ;
if ( F_16 ( & V_47 -> V_51 . V_16 , V_50 ) )
continue;
...
V_61 = F_19 ( sizeof( struct V_58 ) + V_60 . V_69 , V_66 ) ;
if ( V_61 ) {
...
int F_21 ( struct V_75 * V_76 , int V_77 , int V_78 )
{
int V_62 ;
__asm__("lcall *(%%esi); cld\n\t"
"jc 1f\n\t"
