...
V_2 -> V_31 -> V_38 ,
V_2 -> V_31 -> V_64 ) ;
if ( V_2 -> V_31 -> V_62 -> V_65 &&
V_23 & V_29 )
V_24 = V_2 -> V_31 -> V_62 -> V_65 (
V_2 -> V_31 -> V_64 ,
V_28 , 400 ) ;
if ( V_2 -> V_31 -> V_62 -> V_66 &&
V_23 & V_30 )
V_25 = V_2 -> V_31 -> V_62 -> V_66 (
V_2 -> V_31 -> V_64 ,
V_28 + V_24 , 512 - V_24 ) ;
V_27 = false ;
}
...
static int F_34 ( struct V_88 * V_88 , struct V_89 * V_89 )
{
struct V_20 * V_21 ;
struct V_17 * V_18 ;
int V_90 ;
...
return V_90 ;
V_18 = V_89 -> V_92 ;
V_21 = F_36 ( sizeof( struct V_20 ) , V_93 ) ;
if ( ! V_21 ) {
F_37 ( V_88 , V_89 ) ;
return - V_94 ;
}
...
static int F_38 ( struct V_88 * V_88 , struct V_89 * V_89 )
{
struct V_17 * V_18 = V_89 -> V_92 ;
F_39 ( V_18 -> V_22 ) ;
V_18 -> V_22 = NULL ;
return F_37 ( V_88 , V_89 ) ;
}
