...
static int F_42 ( struct V_69 * V_70 , unsigned V_71 ,
unsigned V_72 , void * V_73 )
{
int V_74 ;
T_3 V_75 = 0 ;
for ( V_74 = 0 ; V_74 < 8 ; V_74 ++ ) {
int V_76 = V_71 + V_74 + 8 ;
if ( F_23 ( V_76 , L_9 ) ) {
F_30 ( & V_70 -> V_38 , L_10 , V_74 ) ;
continue;
}
if ( F_43 ( V_76 ) ) {
F_30 ( & V_70 -> V_38 , L_11 , V_74 ) ;
F_25 ( V_76 ) ;
continue;
}
V_75 |= ! ! F_44 ( V_76 ) << V_74 ;
...
T_4 V_79 , V_80 ;
V_81 = F_9 ( V_82 ) ;
F_36 ( L_13 , ( V_81 & 0xf0 ) >> 4 , ( V_81 & 0x0f ) ) ;
V_79 = ( F_47 ( V_83 ) & 0x0000ffff ) | ( V_77 << 16 ) ;
V_80 = ( F_47 ( V_84 ) & 0xffff0000 ) | V_77 ;
F_48 ( V_79 , V_83 ) ;
F_48 ( V_80 , V_84 ) ;
V_85 = F_37 ;
F_41 () ;
