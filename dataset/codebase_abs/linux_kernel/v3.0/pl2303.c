...
static void F_24 ( struct V_36 * V_28 , int V_69 )
{
struct V_12 * V_13 = F_14 ( V_28 ) ;
unsigned long V_39 ;
T_2 V_42 ;
...
F_4 ( L_5 , V_33 , V_28 -> V_47 ) ;
if ( V_13 -> type != V_22 ) {
F_29 ( V_4 -> V_7 , V_28 -> V_73 -> V_74 ) ;
F_29 ( V_4 -> V_7 , V_28 -> V_75 -> V_74 ) ;
} else {
F_5 ( 8 , 0 , V_4 ) ;
F_5 ( 9 , 0 , V_4 ) ;
}
