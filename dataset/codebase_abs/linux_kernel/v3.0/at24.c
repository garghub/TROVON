...
V_60 = V_56 -> V_62 ;
V_6 . V_65 = F_29 ( V_60 & F_30 ( V_66 ) ) ;
V_60 >>= V_66 ;
V_6 . V_7 = V_60 & F_30 ( V_67 ) ;
V_6 . V_45 = 1 ;
F_25 ( V_9 , & V_6 ) ;
V_6 . V_68 = NULL ;
V_6 . V_69 = NULL ;
...
V_3 = F_36 ( sizeof( struct V_2 ) +
V_59 * sizeof( struct V_1 * ) , V_77 ) ;
if ( ! V_3 ) {
V_58 = - V_78 ;
goto V_64;
}
...
V_3 -> V_59 = V_59 ;
F_38 ( & V_3 -> V_79 ) ;
V_3 -> V_79 . V_40 . V_80 = L_8 ;
V_3 -> V_79 . V_40 . V_81 = V_6 . V_7 & V_82 ? V_83 : V_84 ;
V_3 -> V_79 . V_85 = F_15 ;
V_3 -> V_79 . V_86 = V_6 . V_65 ;
V_3 -> V_48 . V_85 = F_23 ;
V_57 = ! ( V_6 . V_7 & V_54 ) ;
if ( V_57 ) {
...
V_3 -> V_48 . V_88 = F_24 ;
V_3 -> V_79 . V_88 = F_22 ;
V_3 -> V_79 . V_40 . V_81 |= V_89 ;
if ( V_44 > V_18 )
V_44 = V_18 ;
if ( V_19 && V_44 > V_21 )
V_44 = V_21 ;
V_3 -> V_44 = V_44 ;
V_3 -> V_46 = F_39 ( V_44 + 2 , V_77 ) ;
if ( ! V_3 -> V_46 ) {
V_58 = - V_78 ;
goto V_90;
}
...
V_58 = F_41 ( & V_9 -> V_30 . V_38 , & V_3 -> V_79 ) ;
if ( V_58 )
goto V_92;
F_42 ( V_9 , V_3 ) ;
F_43 ( & V_9 -> V_30 , L_11 ,
V_3 -> V_79 . V_86 , V_9 -> V_80 ,
...
F_46 ( V_3 ) ;
V_64:
F_8 ( & V_9 -> V_30 , L_17 , V_58 ) ;
return V_58 ;
}
static int T_8 F_47 ( struct V_1 * V_9 )
{
struct V_2 * V_3 ;
int V_5 ;
V_3 = F_48 ( V_9 ) ;
F_49 ( & V_9 -> V_30 . V_38 , & V_3 -> V_79 ) ;
