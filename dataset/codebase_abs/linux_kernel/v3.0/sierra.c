...
V_77 -> V_97 = 0 ;
F_65 ( & V_77 -> V_43 ) ;
return V_144 ? - V_145 : 0 ;
}
static int F_79 ( struct V_29 * V_146 )
{
struct V_12 * V_13 = F_80 ( V_146 ) ;
...
if ( V_50 )
goto V_150;
F_85 (KERN_INFO KBUILD_MODNAME L_38 DRIVER_VERSION L_39
DRIVER_DESC L_40 ) ;
return 0 ;
V_150:
F_86 ( & V_147 ) ;
