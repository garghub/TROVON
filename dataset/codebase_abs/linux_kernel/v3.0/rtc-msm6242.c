...
static int T_1 F_15 ( struct V_38 * V_11 )
{
struct V_39 * V_40 ;
struct V_1 * V_2 ;
struct V_41 * V_42 ;
int error ;
V_40 = F_16 ( V_11 , V_43 , 0 ) ;
if ( ! V_40 )
return - V_44 ;
V_2 = F_17 ( sizeof( * V_2 ) , V_45 ) ;
if ( ! V_2 )
return - V_46 ;
V_2 -> V_4 = F_18 ( V_40 -> V_47 , F_19 ( V_40 ) ) ;
if ( ! V_2 -> V_4 ) {
error = - V_46 ;
goto V_48;
}
F_20 ( V_11 , V_2 ) ;
V_42 = F_21 ( L_2 , & V_11 -> V_11 , & V_49 ,
V_50 ) ;
if ( F_22 ( V_42 ) ) {
error = F_23 ( V_42 ) ;
goto V_51;
...
static int T_2 F_26 ( struct V_38 * V_11 )
{
