...
static void F_39 ( int V_16 )
{
F_21 ( ( L_7 ) ) ;
if ( V_88 && ! V_54 ) {
V_89:
if ( F_40 ( V_16 , V_87 , V_86 ) ) {
if ( V_90 == V_91 ) {
F_25 ( F_41 ( V_92 ) , V_93 ) ;
if ( ++ V_94 < F_42 ( V_2 ) ) {
F_43 ( V_16 ) ;
...
static void F_54 ( unsigned long V_31 )
{
...
F_53 ( F_52 ( V_127 ) , 512 , 0 ) ;
if ( ! F_15 ( V_108 ) )
F_25 ( V_127 , V_93 ) ;
} else {
F_53 ( V_112 , V_143 [ V_77 ] * 512 , 0 ) ;
V_84 = V_18 ;
V_144 = V_87 ;
V_145 = V_86 ;
F_25 ( F_41 ( V_92 ) , V_93 ) ;
...
static void F_57 ( unsigned long V_31 )
{
F_58 ( V_73 ) ;
if ( ! V_52 ) goto V_148;
F_49 ( NULL ) ;
...
static void F_61 ( int V_31 )
{
unsigned long V_12 ;
F_21 ( ( L_29 ) ) ;
F_7 () ;
V_99 = 0 ;
if ( F_62 ( & V_7 ) && F_63 ( V_7 . V_149 , V_4 + 5 ) )
F_4 ( & V_7 , V_4 + 5 ) ;
else
F_5 () ;
F_3 () ;
...
static unsigned int F_65 ( struct V_150 * V_135 ,
unsigned int V_151 )
{
...
static int F_67 ( struct V_150 * V_135 )
{
struct V_152 * V_66 = V_135 -> V_153 ;
unsigned int V_16 = V_66 - V_134 ;
if ( F_66 ( V_16 , & V_43 ) ||
...
static int F_74 ( struct V_175 * V_176 , T_3 V_177 ,
...
if ( F_75 ( V_187 , & V_184 , sizeof( V_184 ) ) )
return - V_192 ;
return 0 ;
}
switch ( V_178 ) {
...
return - V_196 ;
if ( F_76 ( & V_186 , V_187 , sizeof( V_186 ) ) )
return - V_192 ;
if ( F_65 ( V_135 , 0 ) )
F_67 ( V_135 ) ;
if ( V_24 . V_12 & V_136 )
...
if ( V_168 -> V_195 != 1 && V_168 -> V_195 != - 1 )
return - V_196 ;
if ( F_76 ( & V_181 , V_187 , sizeof( V_181 ) ) )
return - V_192 ;
return F_34 ( V_16 , type , & V_181 ) ;
case V_204 :
V_26 = NULL ;
V_157 [ V_16 ] . V_81 = 0 ;
F_56 ( V_168 -> V_135 , V_205 * 2 ) ;
case V_206 :
case V_207 :
V_84 = - 1 ;
F_22 ( V_16 , & V_154 ) ;
...
int V_209 ;
F_79 ( & V_210 ) ;
V_209 = F_74 ( V_176 , V_177 , V_178 , V_208 ) ;
F_80 ( & V_210 ) ;
return V_209 ;
}
static void T_5 F_81 ( int V_16 )
{
V_24 . V_40 = 0 ;
V_26 = NULL ;
if ( ! F_82 ( V_16 ) )
...
static int F_85 ( struct V_175 * V_176 , T_3 V_177 )
{
struct V_152 * V_66 = V_176 -> V_180 -> V_153 ;
int type = F_86 ( V_176 -> V_224 ) >> 2 ;
F_21 ( ( L_46 , type ) ) ;
...
static int F_87 ( struct V_175 * V_176 , T_3 V_177 )
{
int V_209 ;
F_79 ( & V_210 ) ;
V_209 = F_85 ( V_176 , V_177 ) ;
F_80 ( & V_210 ) ;
return V_209 ;
}
static int F_88 ( struct V_150 * V_135 , T_3 V_177 )
{
struct V_152 * V_66 = V_135 -> V_153 ;
F_79 ( & V_210 ) ;
if ( V_66 -> V_195 < 0 )
...
static struct V_230 * F_89 ( T_6 V_231 , int * V_232 , void * V_233 )
{
int V_16 = * V_232 & 3 ;
int type = * V_232 >> 2 ;
...
V_134 [ V_234 ] . V_135 -> V_166 = F_95 ( F_73 ,
& V_242 ) ;
if ( ! V_134 [ V_234 ] . V_135 -> V_166 )
goto V_237;
F_56 ( V_134 [ V_234 ] . V_135 , V_205 * 2 ) ;
F_96 ( V_134 [ V_234 ] . V_135 ) ;
}
F_97 ( F_98 ( V_236 , 0 ) , 256 , V_243 ,
F_89 , NULL , NULL ) ;
F_32 ( V_137 L_52 ,
V_77 == 0 ? 'D' : V_77 == 1 ? 'H' : 'E' ,
V_88 ? L_34 : L_53 ) ;
...
static int T_5 F_102 ( char * V_245 )
{
int V_246 [ 3 + V_167 ] ;
int V_234 ;
if ( ! V_235 )
return 0 ;
V_245 = F_103 ( V_245 , 3 + V_167 , V_246 ) ;
if ( V_246 [ 0 ] < 1 ) {
F_32 ( V_59 L_54 ) ;
return 0 ;
}
...
{
int V_234 ;
F_105 ( F_98 ( V_236 , 0 ) , 256 ) ;
for ( V_234 = 0 ; V_234 < V_167 ; V_234 ++ ) {
struct V_161 * V_162 = V_134 [ V_234 ] . V_135 -> V_166 ;
F_106 ( V_134 [ V_234 ] . V_135 ) ;
F_99 ( V_134 [ V_234 ] . V_135 ) ;
F_100 ( V_162 ) ;
}
F_101 ( V_236 , L_48 ) ;
