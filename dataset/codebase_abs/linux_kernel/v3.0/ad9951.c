...
V_27 [ 0 ] = V_28 ;
V_27 [ 1 ] = 0 ;
V_27 [ 2 ] = V_29 | V_30 | V_31 | V_32 ;
V_27 [ 3 ] = V_33 | V_34 | V_35 ;
V_27 [ 4 ] = 0 ;
F_3 ( & V_17 -> V_21 ) ;
V_10 . V_6 = 5 ;
V_10 . V_19 = & V_27 ;
...
static int T_4 F_9 ( struct V_39 * V_40 )
{
struct V_16 * V_17 ;
int V_11 = 0 ;
V_17 = F_10 ( sizeof( * V_17 ) , V_41 ) ;
if ( V_17 == NULL ) {
V_11 = - V_42 ;
goto V_23;
}
...
static int T_5 F_18 ( struct V_39 * V_40 )
{
struct V_16 * V_17 = F_19 ( V_40 ) ;
F_20 ( V_17 -> V_15 ) ;
F_17 ( V_17 ) ;
return 0 ;
}
