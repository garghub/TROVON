...
if ( ( V_7 & V_16 ) == 0 ) {
F_4 ( V_17 L_1 , V_7 ) ;
F_5 ( V_2 , V_15 , ( V_7 & ( ~ V_18 ) ) | V_16 ) ;
F_6 ( 50 ) ;
V_7 = F_3 ( V_2 , V_15 + V_8 ) ;
F_5 ( V_2 , V_15 , V_7 | V_18 | V_16 ) ;
}
F_5 ( V_2 , V_19 , V_3 ) ;
F_5 ( V_2 , V_20 , 0 ) ;
...
V_16 | V_18 |
V_22 ) ;
F_5 ( V_2 , V_15 , V_23 | V_21 |
V_16 | V_18 |
V_22 ) ;
} else {
F_5 ( V_2 , V_15 , V_23 | V_24 |
V_21 | V_16 | V_18 |
V_22 ) ;
}
...
if ( F_3 ( V_2 , V_28 + V_8 ) & V_29 )
goto V_30;
F_7 ( 10 ) ;
}
F_4 ( V_26 L_3 , V_4 , V_3 ) ;
V_6 = 0xffff ;
goto V_27;
V_30:
#if 0
...
#endif
V_6 = F_3 ( V_2 , V_14 + V_8 ) ;
V_27:
V_2 -> V_12 ( V_2 , - 1 ) ;
return V_6 ;
}
static unsigned short F_8 ( struct V_31 * V_32 ,
unsigned short V_3 )
{
...
{
void T_2 * V_38 ;
unsigned int V_39 = V_8 >> 16 ;
V_8 = V_8 & 0xffff ;
if ( F_2 ( ( V_8 & 3 ) || ( V_37 & 3 ) ) )
return - V_11 ;
V_38 = V_2 -> V_40 . V_41 [ V_39 + 1 ] . V_42 + V_8 ;
V_37 /= sizeof( T_1 ) ;
while ( V_37 -- > 0 ) {
F_12 ( * V_36 ++ , V_38 ) ;
V_38 += sizeof( T_1 ) ;
...
struct V_1 * V_2 = F_32 ( V_95 ) ;
T_3 V_110 ;
struct V_101 * V_102 = V_95 -> V_100 -> V_33 ;
if ( F_2 ( ! V_102 -> V_111 ) )
return - V_112 ;
#ifdef F_36
...
V_168 -> V_178 [ V_57 ] . V_33 &&
! V_168 -> V_178 [ V_57 ] . V_123 ) {
V_102 = V_168 -> V_178 [ V_57 ] . V_33 ;
F_73 ( V_102 -> V_95 ) ;
}
}
}
...
{
struct V_1 * V_2 = V_224 -> V_33 ;
V_2 -> V_225 = NULL ;
}
static void F_101 ( struct V_31 * V_32 )
{
struct V_1 * V_2 = V_32 -> V_33 ;
if ( F_2 ( V_32 != V_2 -> V_32 [ V_9 ] &&
V_32 != V_2 -> V_32 [ V_10 ] ) )
return;
if ( V_32 == V_2 -> V_32 [ V_9 ] ) {
V_2 -> V_32 [ V_9 ] = NULL ;
V_2 -> V_226 = NULL ;
}
else
...
int V_3 = V_228 -> V_237 ;
unsigned int V_34 = F_22 ( V_2 , V_3 ) ;
V_236 -> V_232 . integer . V_232 [ 0 ] = 0xffff - ( V_34 >> 16 ) ;
V_236 -> V_232 . integer . V_232 [ 1 ] = 0xffff - ( V_34 & 0xffff ) ;
return 0 ;
}
...
struct V_1 * V_2 = F_104 ( V_228 ) ;
int V_3 = V_228 -> V_237 ;
unsigned int V_34 = ( ( 0xffff - V_236 -> V_232 . integer . V_232 [ 0 ] ) << 16 |
( 0xffff - V_236 -> V_232 . integer . V_232 [ 1 ] ) ) ;
unsigned int V_238 = F_22 ( V_2 , V_3 ) ;
int V_239 = ( V_238 != V_34 ) ;
if ( V_239 ) {
F_16 ( V_2 , V_3 , V_34 ) ;
}
return V_239 ;
...
struct V_1 * V_2 = F_104 ( V_228 ) ;
unsigned short V_34 ;
V_34 = F_134 ( V_2 -> V_32 [ V_9 ] , V_262 ) ;
V_236 -> V_232 . integer . V_232 [ 0 ] = ( V_34 & 0x200 ) ? 0 : 1 ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_104 ( V_228 ) ;
return F_136 ( V_2 -> V_32 [ V_9 ] ,
V_262 , 0x200 ,
V_236 -> V_232 . integer . V_232 [ 0 ] ? 0 : 0x200 ) ;
}
static void F_137 ( struct V_31 * V_32 )
{
unsigned long V_263 ;
int V_43 ;
F_138 ( V_32 , V_264 , 0 ) ;
...
F_134 ( V_32 , V_268 ) ;
F_134 ( V_32 , V_269 ) ;
V_267 = F_134 ( V_32 , V_270 ) ;
if ( V_267 != 0xffff && ( V_267 & 1 ) != 0 )
return;
F_138 ( V_32 , V_271 , 0x8a05 ) ;
if ( ( V_43 = F_134 ( V_32 , V_271 ) ) == 0x8a05 )
return;
F_6 ( 10 ) ;
...
V_43 = F_141 ( V_2 -> V_225 , & V_32 , & V_2 -> V_32 [ V_272 ] ) ;
return V_43 ;
}
F_6 ( 10 ) ;
}
...
#ifdef F_36
if ( V_2 -> V_287 == 1 ) {
unsigned int V_293 = V_2 -> V_32 [ V_9 ] -> V_282 & 0xffff ;
...
{
struct V_1 * V_2 = V_95 -> V_185 -> V_33 ;
V_2 -> V_12 ( V_2 , 1 ) ;
F_150 ( & V_2 -> V_79 ) ;
V_2 -> V_298 |= V_299 ;
V_2 -> V_190 |= V_300 ;
...
F_5 ( V_2 , V_369 , V_22 ) ;
#endif
F_5 ( V_2 , V_15 , V_18 | V_22 ) ;
#ifdef F_36
F_5 ( V_2 , V_369 , V_18 | V_22 ) ;
#endif
F_18 ( 10 ) ;
F_5 ( V_2 , V_363 , V_370 ) ;
...
#endif
F_5 ( V_2 , V_15 , V_16 | V_18 | V_22 ) ;
#ifdef F_36
F_5 ( V_2 , V_369 , V_16 | V_18 | V_22 ) ;
#endif
V_362 = 150 ;
while ( V_362 -- > 0 ) {
...
int F_211 ( struct V_425 * V_201 , T_12 V_430 )
{
struct V_280 * V_215 = F_212 ( V_201 ) ;
struct V_1 * V_2 = V_215 -> V_33 ;
int V_57 , V_431 ;
F_213 ( V_215 , V_432 ) ;
V_2 -> V_420 = 1 ;
F_214 ( V_2 -> V_183 ) ;
...
F_190 ( V_201 ) ;
F_216 ( V_201 ) ;
F_217 ( V_201 , F_218 ( V_201 , V_430 ) ) ;
return 0 ;
}
int F_219 ( struct V_425 * V_201 )
{
struct V_280 * V_215 = F_212 ( V_201 ) ;
struct V_1 * V_2 = V_215 -> V_33 ;
int V_431 ;
...
if ( ( V_43 = F_235 ( V_215 , V_469 , V_2 , & V_142 ) ) < 0 ) {
F_184 ( V_2 ) ;
return V_43 ;
}
F_178 ( V_215 , V_2 ) ;
