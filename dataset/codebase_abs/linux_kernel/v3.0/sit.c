...
V_139 = F_80 ( F_53 ( V_3 ) , & V_143 , NULL ,
V_128 , V_134 -> V_25 ,
0 , 0 ,
V_155 , F_81 ( V_117 ) ,
V_118 -> V_23 . V_27 ) ;
...
if ( V_136 ) {
V_144 = F_84 ( & V_139 -> V_128 ) - sizeof( struct V_91 ) ;
if ( V_144 < 68 ) {
V_3 -> V_12 . V_159 ++ ;
F_83 ( V_139 ) ;
goto V_146;
...
if ( V_118 -> V_23 . V_24 . V_26 && F_76 ( V_90 ) )
F_76 ( V_90 ) -> V_161 -> V_162 ( F_76 ( V_90 ) , V_144 ) ;
if ( V_90 -> V_67 > V_144 ) {
F_85 ( V_90 , V_163 , 0 , V_144 ) ;
F_83 ( V_139 ) ;
goto V_146;
}
}
...
V_141 = F_87 ( V_140 ) + sizeof( struct V_91 ) ;
if ( F_88 ( V_90 ) < V_141 || F_89 ( V_90 ) ||
( F_90 ( V_90 ) && ! F_91 ( V_90 , 0 ) ) ) {
struct V_89 * V_164 = F_92 ( V_90 , V_141 ) ;
if ( ! V_164 ) {
F_83 ( V_139 ) ;
V_3 -> V_12 . V_165 ++ ;
F_93 ( V_90 ) ;
...
if ( V_90 -> V_167 )
F_94 ( V_164 , V_90 -> V_167 ) ;
F_93 ( V_90 ) ;
V_90 = V_164 ;
V_135 = F_49 ( V_90 ) ;
}
V_90 -> V_168 = V_90 -> V_121 ;
F_95 ( V_90 , sizeof( struct V_91 ) ) ;
F_65 ( V_90 ) ;
memset ( & ( F_66 ( V_90 ) -> V_169 ) , 0 , sizeof( F_66 ( V_90 ) -> V_169 ) ) ;
F_66 ( V_90 ) -> V_29 = 0 ;
F_96 ( V_90 ) ;
F_97 ( V_90 , & V_139 -> V_128 ) ;
V_24 = F_63 ( V_90 ) ;
V_24 -> V_170 = 4 ;
V_24 -> V_171 = sizeof( struct V_91 ) >> 2 ;
V_24 -> V_137 = V_136 ;
V_24 -> V_122 = V_155 ;
V_24 -> V_117 = F_98 ( V_117 , F_99 ( V_135 ) ) ;
...
if ( V_24 -> V_26 ) {
struct V_138 * V_139 = F_80 ( F_53 ( V_3 ) , & V_143 , NULL ,
V_24 -> V_26 , V_24 -> V_25 ,
0 , 0 ,
V_155 ,
F_81 ( V_24 -> V_117 ) ,
...
V_140 = F_103 ( F_53 ( V_3 ) , V_118 -> V_23 . V_27 ) ;
if ( V_140 ) {
...
static int
F_104 ( struct V_2 * V_3 , struct V_176 * V_177 , int V_178 )
{
int V_80 = 0 ;
struct V_32 V_79 ;
struct V_60 V_59 ;
...
F_105 ( & V_40 . V_41 , & V_19 -> V_40 . V_41 ) ;
...
goto V_184;
F_109 ( & V_41 , & V_40 . V_41 ,
V_40 . V_43 ) ;
if ( ! F_110 ( & V_41 , & V_40 . V_41 ) )
goto V_184;
if ( V_40 . V_44 )
V_42 = V_40 . V_42 &
F_19 ( 0xffffffffUL <<
...
static int F_111 ( struct V_2 * V_3 , int V_199 )
{
...
F_102 ( V_3 ) ;
V_3 -> V_7 = F_114 ( struct V_4 ) ;
if ( ! V_3 -> V_7 )
return - V_76 ;
return 0 ;
}
static int T_8 F_115 ( struct V_2 * V_3 )
{
struct V_13 * V_118 = F_17 ( V_3 ) ;
...
static void T_9 F_116 ( struct V_20 * V_21 , struct V_212 * V_86 )
{
int V_34 ;
...
static int T_8 F_118 ( struct V_14 * V_14 )
{
struct V_20 * V_21 = F_6 ( V_14 , V_22 ) ;
int V_80 ;
...
F_23 ( V_21 -> V_39 , V_14 ) ;
V_80 = F_115 ( V_21 -> V_39 ) ;
if ( V_80 )
goto V_218;
F_15 ( V_21 -> V_39 , V_21 ) ;
if ( ( V_80 = F_119 ( V_21 -> V_39 ) ) )
goto V_219;
return 0 ;
V_219:
F_54 ( V_21 -> V_39 ) ;
...
static void T_9 F_120 ( struct V_14 * V_14 )
{
struct V_20 * V_21 = F_6 ( V_14 , V_22 ) ;
F_121 ( V_220 ) ;
F_122 () ;
F_116 ( V_21 , & V_220 ) ;
F_117 ( V_21 -> V_39 , & V_220 ) ;
F_123 ( & V_220 ) ;
F_124 () ;
}
