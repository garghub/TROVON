...
if ( V_6 -> V_11 && ( V_43 & V_39 ) ) {
unsigned V_45 = ( V_6 -> V_11 + 1 ) >> 1 ;
* V_8 ++ = V_37 ;
* V_8 ++ = 1 + V_45 ;
* V_8 ++ = V_6 -> V_11 ;
memcpy ( V_8 , V_6 -> V_14 , V_45 ) ;
V_8 += V_45 ;
}
if ( V_6 -> V_12 && ( V_43 & V_41 ) ) {
unsigned V_45 = ( V_6 -> V_12 % 2 ) ?
V_6 -> V_12 / 2 + 1 :
V_6 -> V_12 / 2 ;
* V_8 ++ = V_40 ;
* V_8 ++ = 1 + V_45 ;
...
int F_4 ( struct V_1 * V_2 , struct V_46 * V_47 ,
struct V_3 * V_48 , struct V_5 * V_49 )
{
struct V_50 * V_51 = F_5 ( V_47 ) ;
struct V_3 * V_52 = & V_51 -> V_4 ;
struct V_3 V_53 ;
int V_10 ;
memset ( & V_53 , 0 , sizeof( V_53 ) ) ;
memcpy ( V_48 , V_52 , sizeof( * V_48 ) ) ;
V_10 = F_1 ( V_2 , & V_53 , V_49 , & V_51 -> V_54 ) ;
if ( V_10 < 0 )
return V_10 ;
