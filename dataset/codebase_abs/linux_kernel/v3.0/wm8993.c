...
static int F_44 ( struct V_1 * V_2 , T_3 V_235 )
{
struct V_32 * V_33 = F_8 ( V_2 ) ;
int V_39 = V_33 -> V_39 ;
int V_38 = V_33 -> V_38 ;
...
static T_4 int F_46 ( struct V_236 * V_237 ,
const struct V_238 * V_239 )
{
struct V_32 * V_33 ;
int V_37 ;
V_33 = F_47 ( sizeof( struct V_32 ) , V_240 ) ;
if ( V_33 == NULL )
return - V_241 ;
F_48 ( V_237 , V_33 ) ;
V_37 = F_49 ( & V_237 -> V_40 ,
& V_242 , & V_243 , 1 ) ;
if ( V_37 < 0 )
F_50 ( V_33 ) ;
return V_37 ;
}
static T_5 int F_51 ( struct V_236 * V_244 )
{
F_52 ( & V_244 -> V_40 ) ;
F_50 ( F_53 ( V_244 ) ) ;
return 0 ;
