...
static void F_114 ( struct V_224 * V_180 )
{
F_1 () ;
}
static int T_7 F_115 ( struct V_224 * V_225 )
{
struct V_24 * V_25 = F_116 ( V_225 ) ;
if ( V_25 -> V_39 )
return - V_174 ;
V_25 -> F_53 = 0 ;
F_53 ( V_25 ) ;
...
static int F_118 ( struct V_224 * V_25 , T_8 V_261 )
{
...
static int F_119 ( struct V_224 * V_25 )
{
struct V_24 * V_134 = F_116 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
...
{
F_121 ( L_103 , V_230 , V_262 ) ;
return F_122 ( & V_263 , F_91 ) ;
}
