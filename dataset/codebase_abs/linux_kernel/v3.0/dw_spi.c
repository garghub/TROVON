...
V_12 = F_69 ( V_9 -> V_97 , F_35 , V_165 ,
L_28 , V_9 ) ;
if ( V_12 < 0 ) {
F_29 ( & V_82 -> V_83 , L_29 ) ;
goto V_166;
}
V_82 -> V_167 = V_168 | V_169 ;
V_82 -> V_170 = V_9 -> V_170 ;
V_82 -> V_171 = V_9 -> V_172 ;
V_82 -> V_173 = F_52 ;
V_82 -> V_174 = F_50 ;
V_82 -> V_103 = F_47 ;
F_65 ( V_9 ) ;
if ( V_9 -> V_65 && V_9 -> V_65 -> V_175 ) {
V_12 = V_9 -> V_65 -> V_175 ( V_9 ) ;
if ( V_12 ) {
F_70 ( & V_82 -> V_83 , L_30 ) ;
V_9 -> V_62 = 0 ;
}
