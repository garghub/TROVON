...
static int F_34 ( struct V_72 * V_72 , struct V_1 * V_1 )
{
struct V_3 * V_4 = (struct V_3 * ) V_1 -> V_5 ;
...
F_3 ( & V_4 -> V_10 ) ;
F_35 (req, tmp, &vcp->vc_pending, uc_chain) {
F_17 ( & V_26 -> V_43 ) ;
if ( V_26 -> V_48 & V_69 ) {
F_13 ( V_26 -> V_47 , sizeof( struct V_30 ) ) ;
F_29 ( V_26 ) ;
...
F_35 (req, tmp, &vcp->vc_processing, uc_chain) {
F_17 ( & V_26 -> V_43 ) ;
V_26 -> V_48 |= V_49 ;
F_18 ( & V_26 -> V_50 ) ;
}
