...
if ( ! V_75 -- )
return sprintf ( V_110 , L_33 , V_35 -> V_111 ) ;
if ( ! V_75 -- )
return sprintf ( V_110 , L_34 , V_108 -> V_112 ) ;
if ( ! V_75 -- )
...
case V_116 :
return sprintf ( V_110 , L_38 ) ;
default:
return sprintf ( V_110 , L_39 ) ;
}
}
return 0 ;
}
...
F_50 ( V_35 , L_42 , V_18 , V_5 -> V_101 . V_118 . V_119 ) ;
return - V_104 ;
}
F_73 ( & V_35 -> V_120 ) ;
if ( V_35 -> V_97 ) {
...
& V_35 -> V_73 : & V_35 -> V_63 ;
F_105 ( V_94 , L_60 , V_18 , V_11 -> V_89 , V_83 ? L_61 : L_62 , V_11 ) ;
}
#endif
...
{
F_61 ( L_68 , V_18 , V_199 ) ;
if ( sizeof( struct V_69 ) > F_136 ( struct V_6 , V_200 ) ) {
F_57 ( V_201 L_69 , V_202 ) ;
return - V_203 ;
}
if ( ( V_147 > V_204 )
|| ( V_174 > V_205 )
...
static int F_138 ( const unsigned char * V_58 , int V_50 )
{
unsigned char V_90 [ 256 ] ;
int V_83 = 0 , V_190 = 0 ;
for ( V_83 = 0 ; V_83 < V_50 ; ) {
V_90 [ 0 ] = '\0' ;
sprintf ( V_90 , L_70 , V_83 ) ;
for ( V_190 = 0 ; ( V_190 < 16 ) && ( V_83 < V_50 ) ; V_190 ++ , V_83 ++ )
sprintf ( V_90 , L_71 , V_90 , V_58 [ V_83 ] ) ;
F_61 ( L_31 , V_90 ) ;
}
return V_83 ;
}
