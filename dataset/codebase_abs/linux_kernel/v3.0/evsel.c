...
if ( type & V_78 ) {
if ( F_29 ( V_50 , V_53 , sizeof( V_67 -> V_79 -> V_42 ) ) )
return - V_69 ;
V_67 -> V_79 = (struct V_80 * ) V_53 ;
if ( F_29 ( V_50 , V_53 , V_67 -> V_79 -> V_42 ) )
return - V_69 ;
V_53 += 1 + V_67 -> V_79 -> V_42 ;
}
if ( type & V_81 ) {
T_3 * V_56 = ( T_3 * ) V_53 ;
