...
if ( F_18 ( V_16 + V_27 , L_4 , 4 ) == 0 ) {
V_27 += V_28 ;
continue;
}
if ( F_18 ( V_16 + V_27 , L_5 , 3 ) == 0 ) {
V_27 += V_28 ;
continue;
}
if ( F_18 ( V_16 + V_27 , L_6 , 11 ) == 0 ) {
V_27 += V_28 ;
continue;
}
...
static struct V_32 * F_19 ( struct V_33 * V_34 ,
...
V_35 = F_20 ( & V_36 , 0 , V_20 , V_22 ) ;
F_12 ( V_22 ) ;
F_12 ( V_20 ) ;
return V_35 ;
}
static void F_21 ( const struct V_18 * V_19 )
{
F_22 ( 1 , L_7 , V_19 -> V_37 ) ;
F_22 ( 1 , L_8 , V_19 -> V_8 ) ;
F_22 ( 1 , L_9 , V_19 -> V_38 , V_19 -> V_39 ) ;
F_22 ( 1 , L_10 , V_19 -> V_40 ,
V_19 -> V_30 ) ;
}
