...
static int F_10 ( struct V_33 * V_12 )
{
T_1 V_34 ;
T_2 V_35 ;
F_11 ( V_12 , 0xF8 , & V_34 ) ;
...
static int F_14 ( struct V_33 * V_12 , const struct V_7 * V_8 )
{
T_2 V_36 ;
...
const struct V_37 * V_48 [] = { & V_38 , NULL } ;
if ( ( V_8 -> V_13 & V_49 ) && V_50 == 0 )
return - V_51 ;
if ( V_8 -> V_13 & V_52 )
if ( ! F_10 ( V_12 ) )
return - V_51 ;
...
return F_19 ( V_12 , V_48 , & V_65 , ( void * ) V_8 , 0 ) ;
}
