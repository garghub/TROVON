...
F_19 ( V_42 , V_11 -> V_30 ) ;
memcpy ( F_20 ( V_42 , V_11 -> V_26 ) , V_11 -> V_19 , V_11 -> V_26 ) ;
}
return V_42 ;
}
static struct V_41 *
...
if ( ( V_42 = F_18 ( V_11 -> V_26 + V_11 -> V_30 ) ) ) {
F_19 ( V_42 , V_11 -> V_30 ) ;
memcpy ( F_20 ( V_42 , V_11 -> V_26 ) , V_11 -> V_17 , V_11 -> V_26 ) ;
}
return V_42 ;
}
struct V_41 *
...
if ( V_42 -> V_35 == 0 ) {
memcpy ( F_20 ( V_57 , V_11 -> V_26 ) , V_11 -> V_17 , V_11 -> V_26 ) ;
