...
void F_6 ( struct V_6 * V_7 , unsigned int V_22 ,
void * V_23 )
{
if ( V_7 -> V_24 != 0 )
return;
F_7 ( & V_7 -> V_2 , V_22 , V_23 ) ;
}
static T_1 F_8 ( struct V_1 * V_25 )
{
return V_26 ;
}
...
{
struct V_9 * V_10 = V_7 -> V_10 ;
F_2 ( V_13 , L_4 , V_14 , V_7 -> V_27 ) ;
memcpy ( & V_7 -> V_2 , & V_28 ,
sizeof( V_7 -> V_2 ) ) ;
memcpy ( & V_7 -> V_29 , & V_30 ,
sizeof( V_7 -> V_29 ) ) ;
memcpy ( & V_7 -> V_31 , & V_32 ,
sizeof( V_7 -> V_31 ) ) ;
V_7 -> V_2 . V_10 . V_33 = & V_10 -> V_34 -> V_10 ;
F_10 ( V_7 -> V_2 . V_35 , V_7 -> V_10 -> V_35 ,
sizeof( V_7 -> V_2 . V_35 ) ) ;
V_7 -> V_29 . V_36 = V_7 ;
V_7 -> V_2 . V_8 = V_7 ;
F_11 ( & V_7 -> V_2 , V_7 ) ;
F_12 ( & V_7 -> V_2 ) ;
V_7 -> V_31 . V_37 = & V_7 -> V_2 ;
if ( 0 != V_7 -> V_24 )
F_3 ( V_19 L_5 ,
V_10 -> V_35 , V_7 -> V_27 ) ;
return V_7 -> V_24 ;
