...
static void T_2 F_41 ( int V_21 , struct V_43 * V_44 )
{
struct V_45 * V_46 = F_42 ( V_44 ) ;
F_25 () ;
F_43 ( V_47 ) ;
F_26 ( V_21 ) ;
F_44 ( ( unsigned long ) & V_48 ) ;
F_21 ( ( F_20 () & ~ V_19 ) | V_17 ) ;
F_22 ( 0 ) ;
F_13 ( F_12 () | V_11 ) ;
F_45 ( F_46 ( V_44 ) ) ;
F_47 ( ( unsigned long ) V_46 ) ;
...
static void T_1 F_54 ( unsigned int V_57 )
{
F_55 () ;
}
