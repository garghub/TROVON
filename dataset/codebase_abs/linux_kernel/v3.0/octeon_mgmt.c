...
snprintf ( V_152 , sizeof( V_152 ) , V_153 , L_8 , V_2 -> V_4 ) ;
...
F_5 ( V_171 , V_156 . V_9 ) ;
V_158 . V_9 = 0 ;
V_158 . V_10 . V_172 = V_2 -> V_42 >> 3 ;
V_158 . V_10 . V_173 = V_43 ;
F_5 ( F_93 ( V_4 ) , V_158 . V_9 ) ;
V_160 . V_9 = 0 ;
V_160 . V_10 . V_174 = V_2 -> V_35 >> 3 ;
V_160 . V_10 . V_175 = V_18 ;
F_5 ( F_94 ( V_4 ) , V_160 . V_9 ) ;
...
if ( F_98 ( V_2 -> V_190 , F_75 , 0 , V_16 -> V_149 ,
V_16 ) ) {
F_99 ( V_2 -> V_30 , L_9 , V_2 -> V_190 ) ;
goto V_191;
}
V_164 . V_9 = 0 ;
V_164 . V_10 . V_192 = 0 ;
F_5 ( F_100 ( V_4 ) , V_164 . V_9 ) ;
V_166 . V_9 = 0 ;
V_166 . V_10 . V_193 = 1 ;
F_5 ( F_101 ( V_4 ) , V_166 . V_9 ) ;
V_6 . V_9 = 0 ;
V_6 . V_10 . V_11 = 1 ;
V_6 . V_10 . V_12 = 1 ;
F_5 ( F_4 ( V_4 ) , V_6 . V_9 ) ;
...
F_18 ( & V_2 -> V_41 , V_22 ) ;
V_2 -> V_44 [ V_2 -> V_169 ] = V_20 . V_27 ;
V_2 -> V_169 = ( V_2 -> V_169 + 1 ) % V_43 ;
V_2 -> V_46 ++ ;
F_6 ( & V_2 -> V_41 . V_8 , V_7 ) ;
...
struct V_212 * V_213 )
{
strncpy ( V_213 -> V_214 , V_215 , sizeof( V_213 -> V_214 ) ) ;
strncpy ( V_213 -> V_216 , V_217 , sizeof( V_213 -> V_216 ) ) ;
strncpy ( V_213 -> V_218 , L_11 , sizeof( V_213 -> V_218 ) ) ;
strncpy ( V_213 -> V_219 , L_11 , sizeof( V_213 -> V_219 ) ) ;
V_213 -> V_220 = 0 ;
V_213 -> V_221 = 0 ;
V_213 -> V_222 = 0 ;
V_213 -> V_223 = 0 ;
...
static int T_2 F_121 ( struct V_227 * V_228 )
{
struct V_229 * V_230 ;
struct V_15 * V_16 ;
struct V_1 * V_2 ;
...
V_2 -> V_30 = & V_228 -> V_30 ;
V_2 -> V_4 = V_228 -> V_232 ;
snprintf ( V_16 -> V_149 , V_233 , L_12 , V_2 -> V_4 ) ;
V_230 = F_125 ( V_228 , V_234 , 0 ) ;
if ( ! V_230 )
goto V_235;
V_2 -> V_190 = V_230 -> V_236 ;
F_126 ( & V_2 -> V_8 ) ;
F_127 ( & V_2 -> V_41 ) ;
F_127 ( & V_2 -> V_26 ) ;
F_128 ( & V_2 -> V_137 ,
...
V_16 -> V_239 = & V_240 ;
for ( V_99 = 0 ; V_99 < 6 ; V_99 ++ )
V_16 -> V_119 [ V_99 ] = V_241 -> V_242 [ V_99 ] ;
V_16 -> V_119 [ 5 ] += V_2 -> V_4 ;
if ( V_2 -> V_4 >= V_241 -> V_243 )
F_99 ( & V_228 -> V_30 ,
L_13 ,
V_16 -> V_149 , V_16 -> V_119 ) ;
if ( F_129 ( V_16 ) )
goto V_235;
F_130 ( & V_228 -> V_30 , L_14 V_217 L_15 ) ;
return 0 ;
V_235:
F_131 ( V_16 ) ;
return - V_244 ;
}
static int T_3 F_132 ( struct V_227 * V_228 )
{
struct V_15 * V_16 = F_133 ( & V_228 -> V_30 ) ;
F_134 ( V_16 ) ;
F_131 ( V_16 ) ;
return 0 ;
}
