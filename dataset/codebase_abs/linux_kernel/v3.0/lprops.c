...
V_83 = 0 ;
F_46 (lprops, &c->freeable_list, list) {
if ( V_2 -> free + V_2 -> V_6 != V_8 -> V_41 ) {
F_36 ( L_8
L_6 , V_2 -> V_54 ,
V_2 -> free , V_2 -> V_6 , V_2 -> V_25 ) ;
...
F_46 (lprops, &c->frdi_idx_list, list) {
if ( V_2 -> free + V_2 -> V_6 != V_8 -> V_41 ) {
F_36 ( L_12
L_6 , V_2 -> V_54 ,
V_2 -> free , V_2 -> V_6 , V_2 -> V_25 ) ;
...
V_79:
if ( V_78 ) {
F_48 ( L_19 , V_3 , V_83 , V_78 ) ;
F_49 () ;
F_50 ( V_8 , V_10 , V_3 ) ;
}
}
static int F_51 ( struct V_7 * V_8 ,
const struct V_1 * V_24 , int V_90 ,
struct V_75 * V_61 )
{
struct V_91 * V_92 ;
struct V_93 * V_94 ;
int V_3 , V_54 = V_24 -> V_54 , V_95 = 0 , V_96 = 0 , free , V_6 , V_97 ;
void * V_98 = NULL ;
V_3 = V_24 -> V_25 & V_26 ;
if ( V_3 != V_27 ) {
V_3 = F_17 ( V_8 , V_24 ) ;
...
V_98 = F_52 ( V_8 -> V_41 , V_100 , V_101 ) ;
if ( ! V_98 )
return - V_102 ;
...
V_95 = - 1 ;
F_46 (snod, &sleb->nodes, list) {
int V_99 , V_106 = 0 ;
F_56 () ;
if ( V_95 == - 1 )
V_95 = ( V_94 -> type == V_107 ) ? 1 : 0 ;
if ( V_95 && V_94 -> type != V_107 ) {
F_36 ( L_23 ,
V_54 , V_94 -> V_108 ) ;
goto V_109;
}
if ( V_94 -> type == V_107 ) {
struct V_110 * V_111 = V_94 -> V_112 ;
F_57 ( V_8 , F_58 ( V_8 , V_111 ) , & V_94 -> V_113 ) ;
V_106 = F_59 ( V_111 -> V_106 ) ;
}
V_99 = F_60 ( V_8 , & V_94 -> V_113 , V_106 , V_54 ,
V_94 -> V_108 , V_95 ) ;
if ( V_99 ) {
if ( V_99 < 0 )
goto V_109;
V_96 += F_29 ( V_94 -> V_114 , 8 ) ;
}
}
free = V_8 -> V_41 - V_92 -> V_115 ;
V_6 = V_92 -> V_115 - V_96 ;
...
if ( V_95 && V_24 -> free + V_24 -> V_6 == free + V_6 &&
V_54 != V_8 -> V_116 ) {
free = V_24 -> free ;
V_6 = V_24 -> V_6 ;
}
...
if ( ! ( V_84 & V_86 ) )
return 0 ;
for ( V_83 = 0 ; V_83 < V_8 -> V_118 ; V_83 ++ ) {
V_78 = F_65 ( & V_8 -> V_119 [ V_83 ] . V_120 ) ;
if ( V_78 )
return V_78 ;
}
memset ( & V_61 , 0 , sizeof( struct V_75 ) ) ;
V_78 = F_66 ( V_8 , V_8 -> V_55 , V_8 -> V_121 - 1 ,
( V_122 ) F_51 ,
& V_61 ) ;
if ( V_78 && V_78 != - V_123 )
goto V_79;
