...
F_8 ( L_35 ) ;
F_34 ( & V_3 -> V_19 -> V_129 ) ;
V_91 = F_35 ( V_9 -> V_38 , 0 , V_68 , V_130 | V_131 ,
V_132 | V_133 , 0 ) ;
F_36 ( & V_3 -> V_19 -> V_129 ) ;
if ( ! V_91 || F_18 ( V_91 ) ) {
if ( ! V_91 )
...
F_2 ( L_39 , ( int ) - V_93 ) ;
F_38 ( V_3 -> V_19 , V_91 , V_68 ) ;
F_38 ( V_3 -> V_19 , V_94 , V_26 ) ;
V_31 = V_93 ;
goto V_118;
}
V_82 = ( unsigned long * ) ( V_92 + ( F_26 ( V_90 -> V_136 ) - V_68 ) ) ;
V_99 = V_94 ;
V_100 = V_26 ;
} else {
...
if ( F_18 ( V_93 ) ) {
F_2 ( L_41 , ( int ) - V_93 ) ;
F_38 ( V_3 -> V_19 , V_91 , V_68 + V_95 + V_101 +
V_70 * sizeof( unsigned long ) ) ;
V_31 = V_93 ;
goto V_118;
}
...
if ( V_98 & V_119 )
F_2 ( L_42 ,
( int ) V_91 , 0x00ffffff & F_26 ( V_90 -> V_137 ) , F_26 ( V_90 -> V_112 ) ) ;
...
V_3 -> V_19 -> V_138 = ( V_3 -> V_19 -> V_66 + 3 ) & ~ 3 ;
V_3 -> V_19 -> V_139 . V_140 = V_99 + V_100 - V_97 ;
}
if ( V_98 & V_119 )
F_2 ( L_43 ,
...
V_87 -> V_72 [ V_65 ] . V_137 = ( 0x00ffffff & F_26 ( V_90 -> V_137 ) ) + V_91 ;
...
unsigned long V_64 , V_143 ;
V_143 = F_26 ( V_82 [ V_105 ] ) ;
if ( F_40 ( V_143 , & V_142 ) )
continue;
V_64 = F_41 ( V_143 ) ;
...
static int F_19 ( int V_65 , struct V_61 * V_144 )
{
struct V_8 V_9 ;
int V_145 ;
char V_28 [ 16 ] ;
...
V_145 = F_49 ( & V_9 ) ;
if ( ! F_18 ( V_145 ) )
V_145 = F_25 ( & V_9 , V_144 , V_65 , NULL ) ;
F_50 ( V_9 . V_146 ) ;
V_147:
F_51 ( V_9 . V_38 ) ;
F_52 ( V_9 . V_38 ) ;
...
static int F_53 ( struct V_8 * V_9 , struct V_149 * V_150 )
{
struct V_61 V_87 ;
...
V_97 += V_18 - 1 ;
V_145 = F_25 ( V_9 , & V_87 , 0 , & V_97 ) ;
if ( F_18 ( V_145 ) )
return V_145 ;
for ( V_105 = 0 ; V_105 < V_70 ; V_105 ++ )
if ( V_87 . V_72 [ V_105 ] . V_73 )
for ( V_152 = 0 ; V_152 < V_70 ; V_152 ++ )
( - ( V_152 + 1 ) ) [ ( unsigned long * ) ( V_87 . V_72 [ V_105 ] . V_67 ) ] =
( V_87 . V_72 [ V_152 ] . V_73 ) ?
V_87 . V_72 [ V_152 ] . V_67 : V_153 ;
F_55 ( V_9 ) ;
V_3 -> V_98 &= ~ V_154 ;
F_56 ( & V_155 ) ;
V_13 = ( ( V_3 -> V_19 -> V_139 . V_140 + V_97 + 3 ) & ~ 3 ) - 4 ;
F_8 ( L_47 , ( int ) V_13 ) ;
for ( V_105 = F_54 - 1 ; V_105 >= V_9 -> V_13 ; V_105 -- )
* ( char * ) -- V_13 =
( ( char * ) F_57 ( V_9 -> V_156 [ V_105 / V_157 ] ) ) [ V_105 % V_157 ] ;
V_12 = ( unsigned long * ) F_3 ( V_13 , V_9 ) ;
V_151 = V_87 . V_72 [ 0 ] . V_137 ;
#ifdef F_17
for ( V_105 = V_70 - 1 ; V_105 > 0 ; V_105 -- ) {
if ( V_87 . V_72 [ V_105 ] . V_73 ) {
-- V_12 ; F_5 ( V_151 , V_12 ) ;
V_151 = V_87 . V_72 [ V_105 ] . V_137 ;
}
}
#endif
V_3 -> V_19 -> V_158 = ( unsigned long ) V_12 ;
#ifdef F_58
F_58 ( V_150 ) ;
#endif
F_8 ( L_48 ,
( int ) V_150 , ( int ) V_151 , ( int ) V_3 -> V_19 -> V_158 ) ;
F_59 ( V_150 , V_151 , V_3 -> V_19 -> V_158 ) ;
return 0 ;
}
