...
{
while ( V_29 -- > 0 && V_56 ) {
T_3 V_57 = V_15 -> V_58 % V_15 -> V_59 ;
T_3 V_60 = V_15 -> V_58 / V_15 -> V_59 ;
T_3 V_37 ;
V_57 += V_15 -> V_61 ;
V_60 += V_15 -> V_62 ;
switch ( V_15 -> V_52 ) {
case V_53 :
V_37 = ( V_57 / V_15 -> V_63 ) * 640 +
V_15 -> V_63 - 1 - V_57 +
( V_60 / 8 ) * V_15 -> V_63 ;
break;
case V_55 :
V_37 = ( V_15 -> V_63 - 1 - V_57 ) / 8 + V_60 * V_15 -> V_63 / 8 ;
break;
default:
V_37 = 0 ;
F_23 ( V_64 L_4 ,
...
( int ) V_37 , ( int ) V_57 , ( int ) V_60 ) ;
return - V_65 ;
}
switch ( V_15 -> V_52 ) {
case V_53 :
V_15 -> V_28 [ V_37 ] &= ~ ( 1 << ( V_60 % 8 ) ) ;
break;
case V_55 :
V_15 -> V_28 [ V_37 ] &= ~ ( 1 << ( V_57 % 8 ) ) ;
break;
default:
;
}
...
V_67 = V_37 + 1 ;
if ( V_72 % ( V_15 -> V_63 ) != 0 )
V_74 = ( V_72 / ( V_15 -> V_63 ) + 1 ) * ( V_15 -> V_63 ) ;
else
V_74 = V_72 ;
if ( V_73 < V_69 )
V_75 = V_69 ;
...
if ( V_15 -> V_54 == V_40 ) {
if ( V_73 < V_69 / 2 )
V_15 -> V_62 = ( V_69 / 2 - V_73 ) / 2 ;
} else {
if ( V_73 < V_69 )
V_15 -> V_62 = ( V_69 - V_73 ) / 2 ;
}
if ( V_72 < ( V_15 -> V_63 ) )
V_15 -> V_61 = ( ( V_15 -> V_63 ) - V_72 ) / 2 ;
}
V_68 = V_15 -> V_59 * V_15 -> V_71 ;
...
if ( V_15 -> V_58 % V_15 -> V_59 != 0 )
V_80 = F_22 ( V_15 , V_15 -> V_66 ,
V_15 -> V_59 -
( V_15 -> V_58 %
V_15 -> V_59 ) ) ;
if ( V_80 < 0 )
