...
for ( V_21 = 0 ; V_21 < F_11 ( V_32 ) ; V_21 ++ ) {
...
#ifdef F_15
if ( ! F_4 ( V_7 . V_46 ) ) {
memcpy ( V_7 . V_47 , V_7 . V_46 , V_19 ) ;
memcpy ( V_7 . V_48 , V_7 . V_46 , V_19 ) ;
if ( F_16 (
& F_1 ) < 0 )
F_2 (KERN_ERR PFX L_10 ) ;
}
#endif
}
void T_2 F_17 ( void )
...
if ( ! V_9 . V_10 [ 0 ] )
F_18 ( L_11 ) ;
F_2 (KERN_INFO PFX L_12 , board.name) ;
if ( F_19 () != V_9 . V_49 )
F_18 ( L_13 ) ;
}
int T_2 F_20 ( void )
