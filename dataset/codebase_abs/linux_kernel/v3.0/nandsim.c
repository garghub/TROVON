...
V_275 = V_210 -> V_49 / 512 ;
V_276 = ( V_274 * 13 + 7 ) / 8 ;
if ( ( V_210 -> V_51 < 64 ) || ! V_275 ) {
F_5 ( L_164 ) ;
V_253 = - V_14 ;
goto error;
}
if ( ( V_276 * V_275 + 2 ) > V_210 -> V_51 ) {
F_5 ( L_165 , V_274 ) ;
V_253 = - V_14 ;
goto error;
}
V_36 -> V_261 . V_262 = V_277 ;
V_36 -> V_261 . V_47 = 512 ;
V_36 -> V_261 . V_278 = V_276 ;
F_44 ( L_166 , V_274 , V_36 -> V_261 . V_47 ) ;
}
V_253 = F_99 ( V_210 ) ;
if ( V_253 ) {
F_5 ( L_167 ) ;
...
if ( V_279 ) {
T_1 V_280 = ( T_1 ) V_210 -> V_53 << V_279 ;
if ( V_280 >> V_279 != V_210 -> V_53 ) {
F_5 ( L_168 ) ;
goto V_281;
}
V_210 -> V_47 = V_280 ;
V_36 -> V_282 = V_280 ;
V_36 -> V_283 = F_22 ( V_210 -> V_53 ) + V_279 - 1 ;
