...
struct V_6 * V_7 = F_31 ( sizeof *V_7 , V_92 ) ;
if ( ! V_7 ) {
V_5 = - V_93 ;
goto V_25;
}
...
V_7 -> V_94 = V_90 -> V_94 ;
F_32 ( V_87 , V_7 ) ;
V_7 -> V_23 = F_31 ( sizeof( * V_7 -> V_23 ) * V_95 , V_92 ) ;
if ( V_7 -> V_23 == NULL ) {
V_5 = - V_93 ;
goto V_96;
}
V_7 -> V_9 = F_31 ( sizeof( * V_7 -> V_9 ) * V_97 , V_92 ) ;
if ( V_7 -> V_9 == NULL ) {
V_5 = - V_93 ;
goto V_98;
}
...
V_7 -> V_2 -> V_100 = F_16 ( V_7 -> V_10 ) -> V_100 ;
V_7 -> V_2 -> V_24 . V_101 = & V_87 -> V_24 ;
V_7 -> V_2 -> V_102 = & V_103 ;
V_7 -> V_2 -> V_104
= F_35 ( V_105 ) ;
if ( V_90 && V_90 -> V_106 )
