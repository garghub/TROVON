...
V_109 = F_41 ( F_42 ( V_2 ) , V_107 -> V_113 . V_114 ) ;
V_26 = - V_115 ;
if ( ! V_116 &&
! ( V_4 -> V_117 || V_4 -> V_118 ) &&
V_107 -> V_113 . V_114 != F_43 ( V_119 ) &&
V_109 != V_120 &&
V_109 != V_121 &&
V_109 != V_122 )
goto V_30;
V_108 = F_44 ( V_107 -> V_123 ) ;
V_26 = - V_124 ;
if ( V_108 && V_108 < V_125 && ! F_32 ( V_126 ) )
goto V_30;
F_15 ( V_2 ) ;
V_26 = - V_27 ;
if ( V_2 -> V_9 != V_10 || V_4 -> V_18 )
goto V_127;
V_4 -> V_128 = V_4 -> V_129 = V_107 -> V_113 . V_114 ;
if ( V_109 == V_121 || V_109 == V_122 )
V_4 -> V_129 = 0 ;
...
F_30 () ;
V_227 = & V_4 -> V_235 . V_236 . V_237 . V_238 ;
V_229 = F_94 ( F_42 ( V_2 ) , V_227 , V_2 , V_225 , V_4 -> V_129 ,
V_4 -> V_135 , V_4 -> V_22 ,
V_2 -> V_87 , F_87 ( V_2 ) ,
V_2 -> V_239 ) ;
if ( ! F_88 ( V_229 ) ) {
...
int V_299 ;
F_123 (i) {
V_298 += * ( ( ( unsigned long * ) F_124 ( V_296 [ 0 ] , V_299 ) ) + V_297 ) ;
V_298 += * ( ( ( unsigned long * ) F_124 ( V_296 [ 1 ] , V_299 ) ) + V_297 ) ;
}
return V_298 ;
}
T_7 F_125 ( void T_6 * V_296 [] , int V_297 , T_3 V_300 )
{
T_7 V_298 = 0 ;
int V_301 ;
F_123 (cpu) {
...
T_7 V_306 , V_307 ;
unsigned int V_308 ;
V_302 = F_124 ( F_126 ( V_296 ) , V_301 ) ;
V_305 = (struct V_304 * ) ( V_302 + V_300 ) ;
do {
V_308 = F_127 ( V_305 ) ;
V_306 = * ( ( ( T_7 * ) V_302 ) + V_297 ) ;
} while ( F_128 ( V_305 , V_308 ) );
V_303 = F_124 ( F_129 ( V_296 ) , V_301 ) ;
V_305 = (struct V_304 * ) ( V_303 + V_300 ) ;
do {
V_308 = F_130 ( V_305 ) ;
V_307 = * ( ( ( T_7 * ) V_303 ) + V_297 ) ;
} while ( F_131 ( V_305 , V_308 ) );
V_298 += V_306 + V_307 ;
}
return V_298 ;
}
int F_132 ( void T_6 * V_309 [ 2 ] , T_3 V_310 , T_3 V_311 )
{
F_133 ( V_309 == NULL ) ;
V_309 [ 0 ] = F_134 ( V_310 , V_311 ) ;
if ( ! V_309 [ 0 ] )
goto V_312;
V_309 [ 1 ] = F_134 ( V_310 , V_311 ) ;
if ( ! V_309 [ 1 ] )
goto V_313;
return 0 ;
V_313:
...
void F_136 ( void T_6 * V_309 [ 2 ] )
{
F_133 ( V_309 == NULL ) ;
F_135 ( V_309 [ 0 ] ) ;
F_135 ( V_309 [ 1 ] ) ;
V_309 [ 0 ] = V_309 [ 1 ] = NULL ;
}
static T_8 int F_137 ( struct V_37 * V_37 )
{
if ( F_132 ( ( void T_6 * * ) V_37 -> V_296 . V_315 ,
sizeof( struct V_316 ) ,
F_138 ( struct V_316 ) ) < 0 )
goto V_317;
if ( F_132 ( ( void T_6 * * ) V_37 -> V_296 . V_318 ,
sizeof( struct V_319 ) ,
F_138 ( struct V_319 ) ) < 0 )
goto V_320;
if ( F_132 ( ( void T_6 * * ) V_37 -> V_296 . V_321 ,
sizeof( struct V_322 ) ,
F_138 ( struct V_322 ) ) < 0 )
goto V_323;
if ( F_132 ( ( void T_6 * * ) V_37 -> V_296 . V_324 ,
sizeof( struct V_325 ) ,
F_138 ( struct V_325 ) ) < 0 )
goto V_326;
if ( F_132 ( ( void T_6 * * ) V_37 -> V_296 . V_327 ,
sizeof( struct V_325 ) ,
F_138 ( struct V_325 ) ) < 0 )
goto V_328;
if ( F_132 ( ( void T_6 * * ) V_37 -> V_296 . V_329 ,
sizeof( struct V_330 ) ,
F_138 ( struct V_330 ) ) < 0 )
goto V_331;
if ( F_132 ( ( void T_6 * * ) V_37 -> V_296 . V_332 ,
sizeof( struct V_333 ) ,
...
return 0 ;
V_334:
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_329 ) ;
V_331:
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_327 ) ;
V_328:
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_324 ) ;
V_326:
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_321 ) ;
V_323:
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_318 ) ;
V_320:
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_315 ) ;
V_317:
return - V_314 ;
}
static T_9 void F_140 ( struct V_37 * V_37 )
{
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_332 ) ;
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_329 ) ;
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_327 ) ;
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_324 ) ;
F_136 ( ( void T_6 * * ) V_37 -> V_296 . V_321 ) ;
...
struct V_213 * V_338 ;
int V_292 = - V_27 ;
F_144 ( sizeof( struct V_339 ) > sizeof( V_336 -> V_340 ) ) ;
V_341 = F_145 ( 65536 / 8 , V_71 ) ;
if ( ! V_341 )
goto V_30;
V_292 = F_146 ( & V_342 , 1 ) ;
if ( V_292 )
...
F_149 () ;
#endif
if ( F_150 ( & V_351 , V_352 ) < 0 )
F_80 ( V_353 L_9 ) ;
if ( F_150 ( & V_354 , V_264 ) < 0 )
F_80 ( V_353 L_10 ) ;
if ( F_150 ( & V_355 , V_356 ) < 0 )
F_80 ( V_353 L_11 ) ;
#ifdef F_151
if ( F_150 ( & V_357 , V_358 ) < 0 )
F_80 ( V_353 L_12 ) ;
#endif
for ( V_338 = & V_219 [ 0 ] ; V_338 < & V_219 [ V_217 ] ; ++ V_338 )
F_152 ( V_338 ) ;
for ( V_337 = V_359 ; V_337 < & V_359 [ V_360 ] ; ++ V_337 )
F_74 ( V_337 ) ;
F_153 () ;
F_154 () ;
F_155 () ;
