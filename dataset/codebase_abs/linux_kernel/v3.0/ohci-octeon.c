...
return - V_27 ;
V_9 -> V_28 = V_19 -> V_29 ;
V_9 -> V_30 = V_19 -> V_31 - V_19 -> V_29 + 1 ;
if ( ! F_21 ( V_9 -> V_28 , V_9 -> V_30 ,
V_32 ) ) {
F_17 ( & V_16 -> V_22 , L_5 ) ;
V_12 = - V_33 ;
goto V_34;
}
V_17 = F_22 ( V_9 -> V_28 , V_9 -> V_30 ) ;
if ( ! V_17 ) {
F_17 ( & V_16 -> V_22 , L_6 ) ;
V_12 = - V_27 ;
goto V_35;
...
#endif
F_24 ( V_11 ) ;
V_12 = F_25 ( V_9 , V_20 , V_39 | V_40 ) ;
if ( V_12 ) {
F_26 ( & V_16 -> V_22 , L_7 , V_12 ) ;
goto V_41;
}
F_27 ( V_16 , V_9 ) ;
return 0 ;
