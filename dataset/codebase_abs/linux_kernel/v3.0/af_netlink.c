...
static struct V_7 * F_5 ( struct V_8 * V_9 , T_1 V_10 )
{
...
static inline struct V_2 * F_32 ( struct V_29 * V_29 , int V_30 ,
T_1 V_10 )
{
...
static inline struct V_7 * F_37 ( T_3 V_36 )
{
if ( V_36 <= V_37 )
...
static inline void F_41 ( struct V_7 * V_11 , T_3 V_36 )
{
if ( V_36 <= V_37 )
F_42 ( V_11 ) ;
else
...
static inline int F_81 ( struct V_68 * V_2 , unsigned int V_97 )
{
...
static inline struct V_143 * F_112 ( struct V_143 * V_144 ,
T_5 V_150 )
{
int V_151 ;
F_113 ( V_144 ) ;
...
static inline int F_121 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
int V_156 ;
struct V_1 * V_14 = F_1 ( V_3 ) ;
V_156 = - V_133 ;
...
return F_13 ( & V_3 -> V_20 ) > V_3 -> V_146 ;
}
return - 1 ;
}
static inline int F_133 ( struct V_2 * V_3 ,
struct V_160 * V_161 )
{
struct V_1 * V_14 = F_1 ( V_3 ) ;
int V_162 ;
...
static inline int F_140 ( struct V_2 * V_3 ,
struct V_178 * V_161 )
{
struct V_1 * V_14 = F_1 ( V_3 ) ;
int V_156 = 0 ;
...
V_230 = F_190 ( V_144 , V_15 , V_235 , sizeof( V_51 ) , V_236 ) ;
if ( ! V_230 )
goto V_233;
memcpy ( F_191 ( V_230 ) , & V_51 , sizeof( V_51 ) ) ;
if ( F_127 ( V_3 , V_144 ) )
F_103 ( V_144 ) ;
else {
F_110 ( & V_3 -> V_17 , V_144 ) ;
...
int F_192 ( struct V_2 * V_132 , struct V_143 * V_144 ,
const struct V_229 * V_230 ,
int (* V_234)( struct V_143 * V_144 ,
struct V_228 * ) ,
...
void F_193 ( struct V_143 * V_238 , struct V_229 * V_230 , int V_60 )
{
struct V_143 * V_144 ;
struct V_229 * V_239 ;
struct V_240 * V_241 ;
T_3 V_242 = sizeof( * V_241 ) ;
if ( V_60 )
V_242 += F_194 ( V_230 ) ;
V_144 = F_195 ( V_242 , V_74 ) ;
if ( ! V_144 ) {
struct V_2 * V_3 ;
V_3 = F_32 ( F_35 ( V_238 -> V_3 ) ,
V_238 -> V_3 -> V_56 ,
F_150 ( V_238 ) . V_10 ) ;
if ( V_3 ) {
V_3 -> V_128 = V_129 ;
...
V_239 = F_196 ( V_144 , F_150 ( V_238 ) . V_10 , V_230 -> V_243 ,
V_244 , V_242 , 0 ) ;
V_241 = F_191 ( V_239 ) ;
V_241 -> error = V_60 ;
memcpy ( & V_241 -> V_197 , V_230 , V_60 ? V_230 -> F_194 : sizeof( * V_230 ) ) ;
F_122 ( V_238 -> V_3 , V_144 , F_150 ( V_238 ) . V_10 , V_215 ) ;
}
int F_197 ( struct V_143 * V_144 , int (* V_15)( struct V_143 * ,
struct V_229 * ) )
{
struct V_229 * V_230 ;
int V_60 ;
while ( V_144 -> V_51 >= F_198 ( 0 ) ) {
int V_245 ;
V_230 = F_199 ( V_144 ) ;
V_60 = 0 ;
if ( V_230 -> F_194 < V_246 || V_144 -> V_51 < V_230 -> F_194 )
return 0 ;
if ( ! ( V_230 -> V_247 & V_248 ) )
goto V_249;
if ( V_230 -> V_250 < V_251 )
goto V_249;
V_60 = V_15 ( V_144 , V_230 ) ;
if ( V_60 == - V_237 )
goto V_252;
V_249:
if ( V_230 -> V_247 & V_253 || V_60 )
F_193 ( V_144 , V_230 , V_60 ) ;
V_252:
V_245 = F_200 ( V_230 -> F_194 ) ;
if ( V_245 > V_144 -> V_51 )
V_245 = V_144 -> V_51 ;
F_201 ( V_144 , V_245 ) ;
}
...
int F_202 ( struct V_2 * V_3 , struct V_143 * V_144 , T_1 V_10 ,
unsigned int V_6 , int V_254 , T_5 V_4 )
{
int V_60 = 0 ;
if ( V_6 ) {
int V_255 = 0 ;
...
V_60 = F_203 ( V_3 , V_144 , V_255 , V_6 , V_4 ) ;
}
if ( V_254 ) {
int V_256 ;
V_256 = F_204 ( V_3 , V_144 , V_10 ) ;
if ( ! V_60 || V_60 == - V_177 )
V_60 = V_256 ;
}
return V_60 ;
}
static struct V_2 * F_205 ( struct V_257 * V_258 , T_7 V_259 )
{
struct V_260 * V_261 = V_258 -> V_262 ;
int V_45 , V_263 ;
struct V_2 * V_264 ;
struct V_33 * V_34 ;
T_7 V_265 = 0 ;
...
for ( V_263 = 0 ; V_263 <= V_9 -> V_13 ; V_263 ++ ) {
F_33 (s, node, &hash->table[j]) {
if ( F_35 ( V_264 ) != F_206 ( V_258 ) )
continue;
if ( V_265 == V_259 ) {
V_261 -> V_266 = V_45 ;
V_261 -> V_267 = V_263 ;
...
static void * F_207 ( struct V_257 * V_258 , T_7 * V_259 )
__acquires( T_2 )
{
F_27 ( & T_2 ) ;
return * V_259 ? F_205 ( V_258 , * V_259 - 1 ) : V_268 ;
}
static void * F_208 ( struct V_257 * V_258 , void * V_269 , T_7 * V_259 )
{
struct V_2 * V_264 ;
struct V_260 * V_261 ;
int V_45 , V_263 ;
++ * V_259 ;
if ( V_269 == V_268 )
return F_205 ( V_258 , 0 ) ;
V_261 = V_258 -> V_262 ;
V_264 = V_269 ;
do {
V_264 = F_209 ( V_264 ) ;
} while ( V_264 && F_35 ( V_264 ) != F_206 ( V_258 ) );
if ( V_264 )
return V_264 ;
V_45 = V_261 -> V_266 ;
V_263 = V_261 -> V_267 + 1 ;
do {
struct V_8 * V_9 = & V_31 [ V_45 ] . V_9 ;
for (; V_263 <= V_9 -> V_13 ; V_263 ++ ) {
V_264 = F_210 ( & V_9 -> V_11 [ V_263 ] ) ;
while ( V_264 && F_35 ( V_264 ) != F_206 ( V_258 ) )
V_264 = F_209 ( V_264 ) ;
if ( V_264 ) {
V_261 -> V_266 = V_45 ;
...
static void F_211 ( struct V_257 * V_258 , void * V_269 )
__releases( T_2 )
{
F_29 ( & T_2 ) ;
}
static int F_212 ( struct V_257 * V_258 , void * V_269 )
{
if ( V_269 == V_268 )
F_213 ( V_258 ,
L_3
...
struct V_2 * V_264 = V_269 ;
struct V_1 * V_14 = F_1 ( V_264 ) ;
F_214 ( V_258 , L_5 ,
V_264 ,
V_264 -> V_56 ,
V_14 -> V_10 ,
...
static int F_218 ( struct V_136 * V_136 , struct V_134 * V_134 )
{
return F_219 ( V_136 , V_134 , & V_271 ,
sizeof( struct V_260 ) ) ;
}
int F_220 ( struct V_272 * V_273 )
{
return F_221 ( & V_93 , V_273 ) ;
}
int F_222 ( struct V_272 * V_273 )
{
return F_223 ( & V_93 , V_273 ) ;
}
static int T_8 F_224 ( struct V_29 * V_29 )
{
#ifdef F_225
if ( ! F_226 ( V_29 , L_6 , 0 , & V_274 ) )
return - V_64 ;
#endif
return 0 ;
}
static void T_9 F_227 ( struct V_29 * V_29 )
{
#ifdef F_225
F_228 ( V_29 , L_6 ) ;
#endif
}
static void T_10 F_229 ( void )
{
struct V_58 * V_58 ;
int V_22 = 32 ;
V_58 = F_38 ( sizeof( * V_58 ) + F_87 ( V_22 ) , V_74 ) ;
...
F_230 ( L_7 ) ;
F_14 () ;
V_31 [ V_275 ] . V_22 = V_22 ;
F_176 ( V_31 [ V_275 ] . V_58 , V_58 ) ;
V_31 [ V_275 ] . V_79 = V_276 ;
V_31 [ V_275 ] . V_87 = 1 ;
F_24 () ;
}
...
unsigned long V_278 ;
unsigned int V_279 ;
int V_60 = F_232 ( & V_75 , 0 ) ;
if ( V_60 != 0 )
goto V_88;
F_233 ( sizeof( struct V_280 ) > sizeof( V_277 -> V_15 ) ) ;
V_31 = F_234 ( V_85 , sizeof( * V_31 ) , V_74 ) ;
if ( ! V_31 )
goto F_230;
if ( V_281 >= ( 128 * 1024 ) )
V_278 = V_281 >> ( 21 - V_282 ) ;
else
V_278 = V_281 >> ( 23 - V_282 ) ;
V_279 = F_235 ( V_278 ) - 1 + V_282 ;
V_278 = ( 1UL << V_279 ) / sizeof( struct V_7 ) ;
V_279 = F_235 ( F_236 ( V_278 , ( unsigned long ) V_66 ) ) - 1 ;
for ( V_45 = 0 ; V_45 < V_85 ; V_45 ++ ) {
struct V_8 * V_9 = & V_31 [ V_45 ] . V_9 ;
