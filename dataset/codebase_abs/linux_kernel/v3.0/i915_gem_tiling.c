...
static bool
F_8 ( struct V_1 * V_2 , int V_29 , int V_30 , int V_31 )
{
int V_32 ;
if ( V_31 == V_33 )
return true ;
...
static bool
F_11 ( struct V_37 * V_38 , int V_31 )
{
T_3 V_30 ;
if ( V_31 == V_33 )
return true ;
...
struct V_37 * V_38 ;
int V_48 = 0 ;
V_38 = F_13 ( F_14 ( V_2 , V_46 , args -> V_49 ) ) ;
if ( & V_38 -> V_39 == NULL )
return - V_50 ;
if ( ! F_8 ( V_2 ,
...
{
struct V_1 * V_2 = V_38 -> V_39 . V_2 ;
T_1 * V_3 = V_2 -> V_4 ;
int V_67 = V_38 -> V_39 . V_30 >> V_68 ;
int V_65 ;
if ( V_3 -> V_26 . V_27 != V_22 )
return;
if ( V_38 -> V_69 == NULL )
return;
for ( V_65 = 0 ; V_65 < V_67 ; V_65 ++ ) {
char V_70 = F_27 ( V_38 -> V_71 [ V_65 ] ) >> 17 ;
if ( ( V_70 & 0x1 ) !=
( F_28 ( V_65 , V_38 -> V_69 ) != 0 ) ) {
F_23 ( V_38 -> V_71 [ V_65 ] ) ;
F_29 ( V_38 -> V_71 [ V_65 ] ) ;
}
}
