...
int V_34 = 0 ;
V_6 = F_6 ( sizeof( struct V_5 ) + sizeof( struct V_1 ) , V_35 ) ;
if ( ! V_6 ) {
F_7 ( V_36 L_2 ) ;
V_31 = - V_37 ;
goto V_38;
...
V_30 = F_8 ( V_28 , V_39 , 0 ) ;
if ( ! V_30 ) {
V_31 = - V_40 ;
goto V_38;
}
V_22 = F_9 ( V_30 -> V_41 , F_10 ( V_30 ) ) ;
if ( ! V_22 ) {
F_7 ( V_36 L_3 ) ;
V_31 = - V_42 ;
goto V_38;
...
#ifdef F_13
V_2 -> V_57 = L_4 ;
V_34 = F_14 ( V_2 , V_58 , & V_33 , 0 ) ;
#endif
if ( V_34 <= 0 ) {
V_34 = V_9 -> V_59 ;
V_33 = V_9 -> V_60 ;
}
V_31 = F_15 ( V_2 , V_33 , V_34 ) ;
if ( V_31 ) {
F_16 ( V_2 ) ;
goto V_56;
}
...
static int T_7 F_19 ( struct V_27 * V_28 )
{
