...
F_31 ( & F_32 ( V_9 ) -> V_37 , V_38 ) ;
F_31 ( & F_32 ( V_9 ) -> V_37 , V_39 ) ;
F_31 ( & F_32 ( V_9 ) -> V_40 , 1 ) ;
F_31 ( & F_32 ( V_9 ) -> V_41 , 0 ) ;
F_31 ( & F_32 ( V_9 ) -> V_42 , V_38 ) ;
F_31 ( & F_32 ( V_9 ) -> V_42 , V_39 ) ;
F_31 ( & F_32 ( V_9 ) -> V_43 , 1 ) ;
F_31 ( & F_32 ( V_9 ) -> V_44 , 0 ) ;
F_31 ( & F_32 ( V_9 ) -> V_41 , V_45 ) ;
F_31 ( & F_32 ( V_9 ) -> V_44 , V_45 ) ;
}
static int F_33 ( struct V_8 * V_9 )
{
return ! ( F_34 ( & F_32 ( V_9 ) -> V_46 ) & V_47 ) ;
}
static int F_35 ( struct V_8 * V_9 )
{
return ! ( F_34 ( & F_32 ( V_9 ) -> V_48 ) & V_49 ) ;
}
static int F_36 ( struct V_8 * V_9 )
{
return F_34 ( & F_32 ( V_9 ) -> V_46 )
& F_34 ( & F_32 ( V_9 ) -> V_44 )
& V_45 ;
}
static int F_37 ( struct V_8 * V_9 )
{
return F_34 ( & F_32 ( V_9 ) -> V_48 )
& F_34 ( & F_32 ( V_9 ) -> V_41 )
& V_45 ;
}
...
{
unsigned long V_50 ;
V_50 = F_34 ( & F_32 ( V_9 ) -> V_44 ) ;
V_50 &= ~ V_45 ;
F_31 ( & F_32 ( V_9 ) -> V_44 , V_50 ) ;
}
static void F_40 ( struct V_8 * V_9 )
{
unsigned long V_51 ;
V_51 = F_34 ( & F_32 ( V_9 ) -> V_41 ) ;
V_51 |= V_45 ;
F_31 ( & F_32 ( V_9 ) -> V_41 , V_51 ) ;
}
...
F_31 ( & F_32 ( V_9 ) -> V_41 ,
( V_9 -> V_16 >> 16 ) & 0x7f ) ;
F_31 ( & F_32 ( V_9 ) -> V_44 , V_9 -> V_16 & 0x7f ) ;
}
...
int V_62 ;
V_61 = F_34 ( & V_58 -> V_61 ) ;
V_62 = ( V_9 -> V_63 & 0xf00 ) >> 8 ;
if ( F_57 ( V_62 , & V_61 ) ||
F_57 ( V_62 + 16 , & V_61 ) )
return F_29 ( V_9 ) ;
return V_64 ;
}
static int F_58 ( struct V_8 * V_9 , int V_65 )
{
struct V_66 * V_67 ;
int V_62 ;
char V_68 [ 10 ] ;
...
return 0 ;
V_62 = ( V_9 -> V_63 & 0xf00 ) >> 8 ;
snprintf ( V_68 , sizeof( V_68 ) , L_5 , V_62 ) ;
V_67 = F_60 ( V_9 -> V_69 , V_68 ) ;
if ( F_61 ( V_67 ) ) {
F_62 ( V_9 -> V_69 , L_6 ) ;
return - V_57 ;
}
F_63 ( V_9 -> V_69 , L_7 , V_68 , V_65 ? L_8 : L_9 ) ;
if ( V_65 )
F_64 ( V_67 ) ;
else
F_65 ( V_67 ) ;
...
F_67 ( struct V_8 * V_9 )
{
return V_71 -> V_72 ( V_9 ) ? V_73 : 0 ;
}
static void
F_68 ( struct V_8 * V_9 , unsigned int V_74 )
{
if ( V_74 & V_75 )
F_3 ( & F_5 ( V_9 ) -> V_76 , V_77 ) ;
else
F_3 ( & F_5 ( V_9 ) -> V_78 , V_77 ) ;
}
static unsigned int
F_69 ( struct V_8 * V_9 )
{
unsigned int V_79 = V_80 ;
T_6 V_81 = F_20 ( & F_5 ( V_9 ) -> V_82 ) ;
if ( ! ( V_81 & V_83 ) )
V_79 |= V_84 ;
if ( ! ( V_81 & V_85 ) )
V_79 |= V_86 ;
...
struct V_1 T_1 * V_2 = F_5 ( V_9 ) ;
F_20 ( & V_2 -> V_82 ) ;
F_3 ( & V_2 -> V_94 , V_95 | V_96 ) ;
V_9 -> V_16 |= V_97 ;
F_2 ( & V_2 -> V_19 , V_9 -> V_16 ) ;
}
static void
F_77 ( struct V_8 * V_9 , int V_98 )
{
unsigned long V_90 ;
F_73 ( & V_9 -> V_91 , V_90 ) ;
if ( V_98 == - 1 )
F_3 ( & F_5 ( V_9 ) -> V_99 , V_100 ) ;
else
F_3 ( & F_5 ( V_9 ) -> V_99 , V_101 ) ;
F_74 ( & V_9 -> V_91 , V_90 ) ;
}
static int
F_78 ( struct V_8 * V_9 )
...
int V_79 ;
if ( V_71 -> clock ) {
V_79 = V_71 -> clock ( V_9 , 1 ) ;
if ( V_79 )
return V_79 ;
}
V_79 = F_79 ( V_9 -> V_36 , V_102 ,
V_9 -> V_34 , L_10 , V_9 ) ;
if ( V_79 )
return V_79 ;
F_3 ( & V_2 -> V_99 , V_103 ) ;
...
unsigned int V_30 ;
V_109 = 0 ;
switch ( V_28 -> V_112 & V_113 ) {
case V_114 : V_109 |= V_115 ;
break;
case V_116 : V_109 |= V_117 ;
break;
case V_118 : V_109 |= V_119 ;
break;
case V_120 :
default: V_109 |= V_121 ;
}
if ( V_28 -> V_112 & V_122 ) {
V_109 |= ( V_28 -> V_112 & V_123 ) ?
V_124 : V_125 ;
} else
V_109 |= V_126 ;
V_110 = 0 ;
...
F_3 ( & V_2 -> V_136 , V_109 ) ;
F_3 ( & V_2 -> V_136 , V_110 ) ;
V_30 = V_71 -> V_137 ( V_9 , V_28 , V_29 ) ;
F_85 ( V_9 , V_28 -> V_112 , V_30 ) ;
if ( F_86 ( V_9 , V_28 -> V_112 ) )
F_76 ( V_9 ) ;
F_3 ( & V_2 -> V_99 , V_107 ) ;
F_3 ( & V_2 -> V_99 , V_108 ) ;
F_74 ( & V_9 -> V_91 , V_90 ) ;
...
F_89 ( V_9 -> V_63 , sizeof( struct V_1 ) ) ;
}
static int
F_90 ( struct V_8 * V_9 )
{
int V_141 ;
if ( V_9 -> V_90 & V_139 )
V_9 -> V_140 = F_91 ( V_9 -> V_63 ,
sizeof( struct V_1 ) ) ;
if ( ! V_9 -> V_140 )
return - V_142 ;
V_141 = F_92 ( V_9 -> V_63 , sizeof( struct V_1 ) ,
L_10 ) != NULL ? 0 : - V_143 ;
if ( V_141 && ( V_9 -> V_90 & V_139 ) ) {
F_54 ( V_9 -> V_140 ) ;
V_9 -> V_140 = NULL ;
}
return V_141 ;
...
return - V_142 ;
if ( ( V_146 -> V_36 != V_9 -> V_36 ) ||
( V_146 -> V_148 != V_149 ) ||
( V_146 -> V_150 != V_9 -> V_31 ) ||
( V_146 -> V_151 != ( void * ) V_9 -> V_63 ) ||
( V_146 -> V_152 != 0 ) )
return - V_142 ;
return 0 ;
}
...
unsigned char V_89 , V_156 ;
unsigned short V_81 ;
while ( V_71 -> V_157 ( V_9 ) ) {
V_89 = V_71 -> V_158 ( V_9 ) ;
#ifdef F_96
if ( F_97 ( V_9 , V_89 ) ) {
V_9 -> V_159 = 0 ;
...
F_3 ( & F_5 ( V_9 ) -> V_99 , V_172 ) ;
}
F_99 ( V_154 , V_89 , V_156 ) ;
if ( V_81 & V_173 ) {
F_99 ( V_154 , 0 , V_174 ) ;
V_9 -> V_161 . V_175 ++ ;
}
...
while ( V_71 -> V_180 ( V_9 ) ) {
V_71 -> V_178 ( V_9 , V_177 -> V_181 [ V_177 -> V_182 ] ) ;
...
if ( V_211 [ V_222 ] == V_221 -> V_69 . V_223 )
break;
if ( V_222 >= V_214 )
return - V_142 ;
F_111 ( L_24 ,
V_211 [ V_222 ] -> V_215 , V_222 ) ;
V_31 = F_115 ( V_221 -> V_69 . V_223 ) ;
if ( V_31 == 0 ) {
F_63 ( & V_221 -> V_69 , L_21 ) ;
return - V_142 ;
}
V_9 = & V_205 [ V_222 ] ;
F_116 ( & V_9 -> V_91 ) ;
...
V_9 -> V_216 = & V_217 ;
V_9 -> V_69 = & V_221 -> V_69 ;
V_79 = F_114 ( V_221 -> V_69 . V_223 , 0 , & V_213 ) ;
if ( V_79 )
return V_79 ;
V_9 -> V_63 = V_213 . V_218 ;
if ( ! V_9 -> V_63 ) {
F_63 ( & V_221 -> V_69 , L_25 ) ;
return - V_142 ;
}
V_71 -> V_227 ( V_9 , V_221 -> V_69 . V_223 ) ;
if ( V_9 -> V_36 == V_60 ) {
F_63 ( & V_221 -> V_69 , L_26 ) ;
return - V_142 ;
}
F_63 ( & V_221 -> V_69 , L_27 ,
( void * ) V_9 -> V_63 , V_9 -> V_36 , V_9 -> V_31 ) ;
V_79 = F_123 ( & V_228 , V_9 ) ;
if ( V_79 )
return V_79 ;
F_124 ( & V_221 -> V_69 , ( void * ) V_9 ) ;
return 0 ;
}
static int
F_125 ( struct V_220 * V_221 )
{
struct V_8 * V_9 = F_126 ( & V_221 -> V_69 ) ;
F_124 ( & V_221 -> V_69 , NULL ) ;
if ( V_9 )
F_127 ( & V_228 , V_9 ) ;
return 0 ;
}
...
{
struct V_8 * V_9 = (struct V_8 * ) F_126 ( & V_221 -> V_69 ) ;
if ( V_9 )
F_129 ( & V_228 , V_9 ) ;
return 0 ;
}
