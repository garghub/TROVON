...
static void F_101 ( struct V_158 * V_120 )
{
struct V_5 * V_6 =
...
struct V_163 * V_164 = ( void * ) V_101 -> V_145 ;
if ( V_101 -> V_165 == V_166 ) {
V_160 = ( void * ) & V_101 -> V_167 ;
F_104 ( & V_6 -> V_7 , V_160 -> V_168 ,
V_160 -> V_169 ) ;
} else if ( V_101 -> V_165 == V_170 ) {
V_160 = ( void * ) & V_101 -> V_167 ;
F_105 ( & V_6 -> V_7 , V_160 -> V_168 ,
V_160 -> V_169 ) ;
} else if ( F_106 ( V_164 -> V_150 ) &&
V_164 -> V_37 . V_171 . V_172 == V_173 ) {
int V_148 = V_101 -> V_148 ;
F_36 ( & V_30 -> V_174 ) ;
V_53 = F_107 ( V_6 , V_164 -> V_16 ) ;
if ( V_53 ) {
switch ( V_164 -> V_37 . V_171 . V_37 . V_175 . V_176 ) {
case V_177 :
F_108 (
V_30 , V_53 , V_164 , V_148 ) ;
break;
case V_178 :
F_109 ( V_30 , V_53 ,
V_164 , V_148 ) ;
...
F_38 ( & V_30 -> V_174 ) ;
} else if ( F_96 ( V_164 -> V_150 ) ) {
struct V_141 * V_142 = ( void * ) V_164 ;
F_18 ( V_142 -> V_150 &
F_111 ( V_180 ) ) ;
F_18 ( ! ( V_142 -> V_181 &
F_111 ( V_182 ) ) ) ;
...
F_47 ( V_6 , false ) ;
F_86 ( V_6 -> V_2 ) ;
V_17 = F_131 ( V_30 , V_6 , V_196 , V_186 ) ;
if ( V_17 )
type = V_6 -> V_7 . type ;
F_120 ( V_6 , type ) ;
...
V_6 -> V_7 . V_201 . V_202 =
F_134 ( V_6 -> V_30 ,
V_6 -> V_30 -> V_74 . V_81 . V_203 -> V_204 ) ;
V_6 -> V_205 = 0 ;
if ( type == V_63 )
V_6 -> V_37 . V_206 . V_207 = false ;
return 0 ;
}
...
{
struct V_5 * V_6 ;
T_6 V_208 , V_209 , V_14 , V_210 , V_211 ;
T_5 * V_212 ;
T_5 V_213 [ V_20 ] ;
int V_103 ;
memcpy ( V_2 -> V_76 , V_30 -> V_74 . V_75 -> V_76 , V_20 ) ;
if ( F_23 ( V_30 -> V_74 . V_75 -> V_214 ) &&
V_30 -> V_74 . V_75 -> V_215 <= 1 )
return;
F_36 ( & V_30 -> V_216 ) ;
switch ( type ) {
case V_23 :
...
break;
default:
for ( V_103 = 0 ; V_103 < V_30 -> V_74 . V_75 -> V_215 ; V_103 ++ ) {
bool V_217 = false ;
F_11 (sdata, &local->interfaces, list) {
if ( memcmp ( V_30 -> V_74 . V_75 -> V_218 [ V_103 ] . V_14 ,
V_6 -> V_7 . V_14 , V_20 ) == 0 ) {
V_217 = true ;
break;
}
...
if ( ! V_217 ) {
memcpy ( V_2 -> V_76 ,
V_30 -> V_74 . V_75 -> V_218 [ V_103 ] . V_14 ,
V_20 ) ;
break;
}
}
if ( F_23 ( V_30 -> V_74 . V_75 -> V_214 ) )
break;
V_212 = V_30 -> V_74 . V_75 -> V_214 ;
V_208 = ( ( T_6 ) V_212 [ 0 ] << 5 * 8 ) | ( ( T_6 ) V_212 [ 1 ] << 4 * 8 ) |
( ( T_6 ) V_212 [ 2 ] << 3 * 8 ) | ( ( T_6 ) V_212 [ 3 ] << 2 * 8 ) |
( ( T_6 ) V_212 [ 4 ] << 1 * 8 ) | ( ( T_6 ) V_212 [ 5 ] << 0 * 8 ) ;
if ( F_136 ( V_208 ) + F_137 ( V_208 ) != F_138 ( V_208 ) ) {
F_4 ( V_11 L_5 ) ;
break;
}
V_212 = V_30 -> V_74 . V_75 -> V_76 ;
V_209 = ( ( T_6 ) V_212 [ 0 ] << 5 * 8 ) | ( ( T_6 ) V_212 [ 1 ] << 4 * 8 ) |
( ( T_6 ) V_212 [ 2 ] << 3 * 8 ) | ( ( T_6 ) V_212 [ 3 ] << 2 * 8 ) |
( ( T_6 ) V_212 [ 4 ] << 1 * 8 ) | ( ( T_6 ) V_212 [ 5 ] << 0 * 8 ) ;
V_211 = 1ULL << F_136 ( V_208 ) ;
V_210 = ( V_209 & V_208 ) ;
V_14 = ( V_209 & ~ V_208 ) | ( V_210 & V_208 ) ;
do {
bool V_217 = false ;
V_213 [ 5 ] = V_14 >> 0 * 8 ;
V_213 [ 4 ] = V_14 >> 1 * 8 ;
...
struct V_1 * * V_219 , enum V_27 type ,
struct V_220 * V_221 )
{
struct V_1 * V_32 ;
struct V_5 * V_6 = NULL ;
int V_17 , V_103 ;
F_10 () ;
V_32 = F_140 ( sizeof( * V_6 ) + V_30 -> V_74 . V_222 ,
V_12 , F_99 , V_30 -> V_74 . V_147 ) ;
if ( ! V_32 )
return - V_90 ;
F_141 ( V_32 , F_142 ( V_30 -> V_74 . V_75 ) ) ;
V_32 -> V_223 = V_30 -> V_224 +
4 * 6
+ 2 + 2 + 2 + 2
+ 6
+ 8
...
V_6 = F_146 ( V_32 ) ;
V_32 -> V_230 = & V_6 -> V_187 ;
memcpy ( V_6 -> V_7 . V_14 , V_32 -> V_34 , V_20 ) ;
memcpy ( V_6 -> V_12 , V_32 -> V_12 , V_231 ) ;
V_6 -> V_187 . V_75 = V_30 -> V_74 . V_75 ;
V_6 -> V_30 = V_30 ;
V_6 -> V_2 = V_32 ;
#ifdef F_147
V_6 -> V_232 = true ;
...
struct V_235 * V_236 ;
V_236 = V_30 -> V_74 . V_75 -> V_237 [ V_103 ] ;
V_6 -> V_238 [ V_103 ] =
V_236 ? ( 1 << V_236 -> V_239 ) - 1 : 0 ;
}
F_120 ( V_6 , type ) ;
if ( V_221 ) {
V_32 -> V_230 -> V_207 = V_221 -> V_207 ;
if ( type == V_63 )
V_6 -> V_37 . V_206 . V_207 = V_221 -> V_207 ;
}
V_17 = F_148 ( V_32 ) ;
if ( V_17 )
goto V_229;
F_36 ( & V_30 -> V_216 ) ;
F_149 ( & V_6 -> V_61 , & V_30 -> V_240 ) ;
F_38 ( & V_30 -> V_216 ) ;
if ( V_219 )
* V_219 = V_32 ;
return 0 ;
...
const char * V_242 )
{
if ( ! ( V_30 -> V_74 . V_81 . V_40 & V_243 ) )
return 0 ;
#ifdef F_3
F_158 ( V_30 -> V_74 . V_75 , L_6 , V_242 ) ;
#endif
V_30 -> V_74 . V_81 . V_40 &= ~ V_243 ;
return V_244 ;
}
...
struct V_5 * V_6 ;
int V_245 = 0 ;
bool V_246 = false , V_161 = false , V_247 = false ;
struct V_248 * V_249 ;
...
F_11 (sdata, &local->interfaces, list) {
if ( ! F_6 ( V_6 ) ) {
V_6 -> V_7 . V_201 . V_253 = true ;
continue;
}
V_6 -> V_254 = V_6 -> V_7 . V_201 . V_253 ;
if ( V_6 -> V_7 . type == V_63 &&
! V_6 -> V_37 . V_206 . V_255 ) {
V_6 -> V_7 . V_201 . V_253 = true ;
continue;
}
if ( V_6 -> V_7 . type == V_33 &&
! V_6 -> V_37 . V_256 . V_257 ) {
V_6 -> V_7 . V_201 . V_253 = true ;
continue;
}
V_245 ++ ;
...
V_246 = true ;
V_249 -> V_6 -> V_7 . V_201 . V_253 = false ;
}
if ( V_30 -> V_106 ) {
V_161 = true ;
V_30 -> V_106 -> V_7 . V_201 . V_253 = false ;
}
if ( V_30 -> V_258 )
V_247 = true ;
F_11 (sdata, &local->interfaces, list) {
if ( V_6 -> V_254 == V_6 -> V_7 . V_201 . V_253 )
continue;
if ( ! F_6 ( V_6 ) )
continue;
F_29 ( V_6 , V_259 ) ;
}
if ( V_246 || V_161 || V_247 )
V_250 |= V_260 ;
else
V_251 |= V_260 ;
if ( V_245 )
...
static int F_166 ( struct V_263 * V_264 ,
unsigned long V_88 ,
void * V_32 )
{
struct V_1 * V_2 = V_32 ;
...
if ( V_88 != V_265 )
return 0 ;
if ( ! V_2 -> V_230 || ! V_2 -> V_230 -> V_75 )
return 0 ;
if ( V_2 -> V_230 -> V_75 -> V_266 != V_267 )
return 0 ;
V_6 = F_2 ( V_2 ) ;
memcpy ( V_6 -> V_12 , V_2 -> V_12 , V_231 ) ;
F_167 ( V_6 ) ;
return 0 ;
}
int F_168 ( void )
