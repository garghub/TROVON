...
V_9 = F_21 ( sizeof( struct V_8 ) , V_30 ) ;
if ( V_9 == NULL ) {
F_20 ( & V_3 -> V_6 , L_7 ) ;
return - V_31 ;
}
...
F_23 ( V_3 ) ;
V_9 -> V_3 = V_3 ;
V_28 = F_24 ( V_5 -> V_13 , L_8 ) ;
if ( V_28 ) {
F_20 ( & V_3 -> V_6 ,
L_9 ) ;
goto V_33;
}
V_28 = F_25 ( V_5 -> V_13 , 1 ) ;
if ( V_28 )
goto V_34;
V_28 = F_24 ( V_5 -> V_14 ,
L_10 ) ;
...
V_28 = F_25 ( V_5 -> V_14 , 0 ) ;
if ( V_28 )
goto V_35;
if ( V_5 -> V_36 ) {
V_9 -> V_11 = F_26 ( NULL , V_5 -> V_36 ) ;
if ( F_27 ( V_9 -> V_11 ) ) {
F_28 ( L_12 ,
V_37 ) ;
goto V_35;
...
static int T_3 F_35 ( struct V_2 * V_3 )
{
struct V_8 * V_9 = F_6 ( & V_3 -> V_6 ) ;
