...
static void F_23 ( struct V_6 * V_7 , const struct V_70 * V_71 )
{
struct V_72 * V_73 = & V_7 -> V_73 ;
struct V_74 * V_75 = V_7 -> V_11 ;
unsigned int V_76 = V_71 -> V_15 & V_77 ;
int V_78 = 0 ;
if ( V_71 -> V_79 != V_7 -> V_80 ) {
F_24 ( V_71 -> V_79 , V_73 -> V_81 ) ;
V_7 -> V_80 = V_71 -> V_79 ;
F_25 ( V_7 ) ;
V_78 = 1 ;
}
if ( V_71 -> V_15 & V_82 ) {
F_24 ( V_71 -> V_83 , V_73 -> V_84 ) ;
V_75 -> V_85 = V_71 -> V_83 ;
} else if ( V_78 )
F_24 ( V_75 -> V_85 , V_73 -> V_84 ) ;
if ( V_76 && ( V_71 -> V_15 & V_86 ) ) {
F_26 ( ! V_73 -> V_81 ) ;
F_24 ( V_71 -> V_87 , V_73 -> V_88 ) ;
F_24 ( V_71 -> V_89 , V_73 -> V_90 ) ;
F_24 ( V_71 -> V_91 , V_73 -> V_92 ) ;
F_24 ( V_71 -> V_93 , V_73 -> V_94 ) ;
F_24 ( V_71 -> V_95 , V_73 -> V_96 ) ;
F_27 ( L_3 ,
V_71 -> V_87 ,
V_71 -> V_89 ,
V_71 -> V_91 ,
...
if ( V_76 ) {
F_24 ( V_71 -> V_97 , V_73 -> V_88 ) ;
F_24 ( V_71 -> V_98 , V_73 -> V_90 ) ;
F_24 ( V_71 -> V_99 , V_73 -> V_92 ) ;
F_24 ( V_71 -> V_100 , V_73 -> V_94 ) ;
F_24 ( V_71 -> V_101 , V_73 -> V_96 ) ;
F_27 ( L_4 ,
V_71 -> V_97 ,
V_71 -> V_98 ,
V_71 -> V_99 ,
...
if ( V_102 < 0 )
return V_102 ;
V_75 = F_30 ( & V_2 -> V_12 , sizeof( struct V_74 ) , V_103 ) ;
if ( V_75 == NULL )
return - V_104 ;
V_7 -> V_11 = V_75 ;
return 0 ;
...
V_105 &= 3 ;
if ( V_15 & V_106 ) {
static const T_2 V_107 [ 4 ] = { 0x00 , 0x60 , 0x00 , 0x20 } ;
T_2 V_108 ;
F_15 ( V_2 , 0x43 , & V_108 ) ;
if ( V_15 & V_109 )
V_108 &= 0x7F ;
...
static int F_32 ( struct V_1 * V_2 , const struct V_110 * V_65 )
{
...
static const struct V_111 V_120 = {
. V_15 = V_113 ,
. V_114 = V_115 ,
. V_116 = V_117 ,
. V_118 = & V_121 ,
} ;
static const struct V_111 V_122 = {
. V_15 = V_113 ,
. V_114 = V_115 ,
. V_116 = V_117 ,
. V_19 = V_56 ,
...
static const struct V_111 V_123 = {
. V_15 = V_113 ,
. V_114 = V_115 ,
. V_116 = V_117 ,
. V_19 = V_20 ,
...
static const struct V_111 V_124 = {
. V_15 = V_113 ,
. V_114 = V_115 ,
. V_116 = V_117 ,
. V_19 = V_22 ,
...
static const struct V_111 V_125 = {
. V_15 = V_113 ,
. V_114 = V_115 ,
. V_116 = V_117 ,
. V_19 = V_47 ,
...
const struct V_111 * V_126 [] = { NULL , NULL } ;
struct V_1 * V_127 ;
const struct V_8 * V_9 ;
static int V_128 ;
T_2 V_105 ;
T_1 V_129 ;
unsigned long V_15 = V_65 -> V_130 ;
int V_131 ;
if ( ! V_128 ++ )
F_33 ( V_132 , & V_2 -> V_12 , L_5 V_133 L_6 ) ;
V_131 = F_34 ( V_2 ) ;
if ( V_131 )
return V_131 ;
if ( V_15 & V_134 )
V_126 [ 1 ] = & V_135 ;
for ( V_9 = V_136 ; V_9 -> V_65 != V_137 ;
V_9 ++ )
if ( ( V_127 = F_35 ( V_138 +
! ! ( V_9 -> V_15 & V_139 ) ,
V_9 -> V_65 , NULL ) ) ) {
T_2 V_140 = V_127 -> V_141 ;
F_36 ( V_127 ) ;
if ( ( V_65 -> V_83 == 0x0415 || V_65 -> V_83 == 0x3164 ) &&
( V_9 -> V_65 != V_65 -> V_83 ) )
continue;
if ( V_140 >= V_9 -> V_142 && V_140 <= V_9 -> V_143 )
break;
}
if ( ! ( V_9 -> V_15 & V_28 ) ) {
F_15 ( V_2 , 0x40 , & V_105 ) ;
...
return F_39 ( V_2 , V_126 , & V_147 , ( void * ) V_9 , 0 ) ;
}
