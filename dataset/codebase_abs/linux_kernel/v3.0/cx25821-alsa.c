...
goto error;
V_76 =
F_39 ( V_2 -> V_57 , & V_4 -> V_16 , V_17 -> V_84 ,
V_2 -> V_78 , V_2 -> V_79 ,
1 ) ;
if ( V_76 < 0 ) {
F_40 ( L_7 ) ;
...
V_121 | V_122 , V_2 -> V_6 -> V_42 , V_2 ) ;
if ( V_62 < 0 ) {
F_28 ( L_13 ,
V_2 -> V_6 -> V_42 , V_6 -> V_57 -> V_46 ) ;
goto error;
}
...
strcpy ( V_104 -> V_123 , L_12 ) ;
sprintf ( V_104 -> V_124 , L_16 , V_2 -> V_6 -> V_42 ,
V_2 -> V_120 , V_2 -> V_46 ) ;
strcpy ( V_104 -> V_125 , L_17 ) ;
F_40 ( L_18 ,
V_104 -> V_118 , V_111 ) ;
V_62 = F_62 ( V_104 ) ;
if ( V_62 < 0 ) {
...
V_6 = F_67 ( V_128 , struct V_5 , V_130 ) ;
F_56 ( V_6 ) ;
}
F_68 ( & V_129 ) ;
if ( V_6 == NULL )
