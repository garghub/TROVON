...
int F_182 ( void )
{
return F_178 ( & V_102 -> V_196 ) ;
}
int F_183 ( const struct V_6 * V_197 ,
const struct V_6 * V_198 )
{
return F_24 ( V_197 -> V_32 , V_198 -> V_32 ) ;
}
void F_184 ( struct V_6 * V_35 )
{
struct V_17 * V_17 ;
V_17 = F_4 ( V_35 ) -> V_5 . V_2 -> V_17 ;
F_115 ( & V_199 ) ;
snprintf ( V_200 , V_201 ,
V_17 ? ( const char * ) V_17 -> V_202 . V_203 : L_10 ) ;
F_132 ( V_204 , V_205 ,
V_35 -> V_32 ) ;
F_53 ( V_206 L_11 ,
V_35 -> V_207 , V_200 , V_204 ) ;
F_116 ( & V_199 ) ;
}
void F_185 ( void )
{
...
static int F_186 ( struct V_208 * V_209 , void * V_210 )
{
struct V_211 * V_211 ;
struct V_6 * V_35 ;
char * V_92 ;
...
V_93 = - V_212 ;
V_211 = V_209 -> V_145 ;
V_35 = F_187 ( V_211 , V_213 ) ;
if ( ! V_35 )
goto V_214;
V_93 = - V_48 ;
F_58 () ;
V_5 = F_5 ( V_35 , V_4 ) ;
V_93 = F_188 ( V_5 -> V_2 , V_92 , V_96 ) ;
if ( V_93 < 0 )
goto V_215;
F_189 ( V_209 , V_92 ) ;
F_190 ( V_209 , '\n' ) ;
...
static int F_192 ( struct V_216 * V_216 , struct V_161 * V_161 )
{
struct V_211 * V_211 = F_193 ( V_216 ) -> V_211 ;
return F_194 ( V_161 , F_186 , V_211 ) ;
}
void F_195 ( struct V_208 * V_209 , struct V_6 * V_7 )
{
F_196 ( V_209 , L_12 ) ;
F_197 ( V_209 , & V_7 -> V_32 ) ;
F_196 ( V_209 , L_13 ) ;
F_196 ( V_209 , L_14 ) ;
F_198 ( V_209 , & V_7 -> V_32 ) ;
F_196 ( V_209 , L_13 ) ;
}
