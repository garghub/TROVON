...
F_279 ( V_354 , V_358 , & V_509 ) ;
F_279 ( V_354 , V_356 , & V_510 ) ;
V_354 -> V_176 = V_511 ;
return 0 ;
}
...
{
int V_65 , V_515 , V_516 ;
switch ( V_11 -> V_14 ) {
case V_16 :
V_11 -> V_314 = L_179 ;
V_11 -> V_401 = V_11 -> V_404 = V_517 ;
V_11 -> V_400 = V_11 -> V_403 = V_518 ;
break;
case V_20 :
V_11 -> V_314 = L_180 ;
V_11 -> V_401 = V_11 -> V_404 = V_519 ;
V_11 -> V_400 = V_11 -> V_403 = V_520 ;
break;
case V_19 :
V_65 = F_12 ( V_11 , V_24 ) ;
V_515 = ( V_65 & V_521 ) ? 0 : 4 ;
V_516 = ( V_65 & V_522 ) ? 0 : 4 ;
V_11 -> V_314 = L_181 ;
V_11 -> V_401 = V_492 + V_515 ;
V_11 -> V_400 = V_523 + V_515 ;
V_11 -> V_399 = V_524 + V_515 ;
V_11 -> V_404 = V_492 + V_516 ;
V_11 -> V_403 = V_523 + V_516 ;
V_11 -> V_402 = V_524 + V_516 ;
break;
case V_15 :
V_11 -> V_314 = L_182 ;
V_11 -> V_401 = V_11 -> V_404 = V_525 ;
V_11 -> V_400 = V_11 -> V_403 = V_526 ;
break;
case V_17 :
V_11 -> V_314 = L_183 ;
V_11 -> V_401 = V_527 - 1 ;
...
sprintf ( V_168 -> V_528 , L_190 , V_11 -> V_314 ,
...
if ( F_281 ( & V_530 , V_529 , & V_11 -> V_2 -> V_6 ) ) {
F_15 ( V_52 L_198 , V_529 ) ;
return - V_531 ;
}
if ( V_530 -> V_5 < sizeof( V_11 -> V_39 ) ) {
F_15 ( V_52 L_199 ,
( int ) V_530 -> V_5 , ( int ) sizeof( V_11 -> V_39 ) ) ;
F_282 ( V_530 ) ;
return - V_116 ;
}
memcpy ( V_11 -> V_39 , V_530 -> V_60 , sizeof( V_11 -> V_39 ) ) ;
F_282 ( V_530 ) ;
V_11 -> V_26 |= V_53 ;
if ( ( V_297 = F_19 ( V_11 ) ) < 0 )
return V_297 ;
...
F_285 ( V_11 -> V_2 , V_534 , & V_11 -> V_18 ) ;
V_11 -> V_18 &= 0xff ;
F_286 ( V_11 -> V_2 , V_535 , 0xFF ) ;
strcpy ( V_168 -> V_536 , L_201 ) ;
strcpy ( V_168 -> V_537 , L_202 ) ;
if ( V_11 -> V_18 < 0xa )
return - V_538 ;
...
if ( ( V_11 -> V_23 = F_291 ( V_11 -> V_318 , V_539 ) ) == NULL ) {
F_15 ( V_52 L_206 , V_11 -> V_318 , V_11 -> V_318 + V_539 - 1 ) ;
return - V_126 ;
}
if ( F_292 ( V_2 -> V_317 , F_219 , V_540 ,
L_171 , V_11 ) ) {
...
V_297 = F_300 ( V_282 [ V_6 ] , V_135 [ V_6 ] , V_545 ,
