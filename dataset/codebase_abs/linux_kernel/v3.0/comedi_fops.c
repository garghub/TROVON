...
V_77 . V_80 = V_81 ;
V_77 . V_82 = V_10 -> V_69 ;
memcpy ( V_77 . V_83 , V_10 -> V_51 -> V_83 , V_54 ) ;
memcpy ( V_77 . V_53 , V_10 -> V_53 , V_54 ) ;
if ( V_78 )
...
struct V_65 * V_66 ;
V_87 =
F_36 ( V_10 -> V_69 , sizeof( struct V_25 ) ,
V_89 ) ;
if ( ! V_87 )
return - V_58 ;
...
V_126 . V_132 = F_41 ( V_64 , V_126 . V_132 ) ;
F_42 ( V_64 , V_126 . V_132 ) ;
if ( ! ( F_37 ( V_66 ) & ( V_136 |
V_93 ) )
...
return - V_52 ;
V_140 = F_46 ( sizeof( unsigned int ) * V_141 , V_89 ) ;
if ( ! V_140 ) {
F_6 ( L_3 ) ;
V_43 = - V_58 ;
goto error;
...
V_139 =
F_46 ( sizeof( struct V_39 ) * V_138 . V_142 , V_89 ) ;
if ( ! V_139 ) {
F_6 ( L_3 ) ;
V_43 = - V_58 ;
goto error;
...
V_43 = F_47 ( V_10 , V_139 + V_86 , V_140 , V_1 ) ;
if ( V_43 < 0 )
goto error;
...
static int F_50 ( struct V_39 * V_144 ,
unsigned int * V_140 )
{
if ( V_144 -> V_143 < 1 )
return - V_70 ;
...
static int F_47 ( struct V_9 * V_10 , struct V_39 * V_144 ,
...
V_43 = F_47 ( V_10 , & V_144 , V_140 , V_1 ) ;
if ( V_43 < 0 )
goto error;
...
V_64 -> V_2 . V_140 = NULL ;
V_64 -> V_2 . V_207 =
F_46 ( V_64 -> V_2 . V_209 * sizeof( int ) , V_89 ) ;
if ( ! V_64 -> V_2 . V_207 ) {
F_6 ( L_27 ) ;
V_43 = - V_58 ;
goto V_210;
...
if ( V_205 . V_207 ) {
V_207 =
F_46 ( V_205 . V_209 * sizeof( int ) , V_89 ) ;
if ( ! V_207 ) {
F_6 ( L_27 ) ;
V_43 = - V_58 ;
goto V_210;
...
V_43 = F_54 ( V_66 , V_205 . V_209 , V_207 ) ;
if ( V_43 < 0 ) {
F_6 ( L_29 ) ;
goto V_210;
}
...
static int F_60 ( struct V_9 * V_10 , struct V_65 * V_66 )
{
int V_43 = 0 ;
if ( ( F_37 ( V_66 ) & V_93 ) && V_66 -> V_221 )
V_43 = V_66 -> V_221 ( V_10 , V_66 ) ;
F_43 ( V_10 , V_66 ) ;
return V_43 ;
}
static void F_61 ( struct V_222 * V_223 )
{
struct V_63 * V_64 ;
struct V_9 * V_10 ;
V_64 = V_223 -> V_224 ;
...
static int F_62 ( struct V_1 * V_1 , struct V_222 * V_226 )
{
const unsigned V_4 = F_2 ( V_1 -> V_5 -> V_6 ) ;
struct V_7 * V_8 =
F_3 ( V_4 ) ;
...
static unsigned int F_66 ( struct V_1 * V_1 , T_1 * V_242 )
{
...
V_78 = F_34 ( V_8 ) ;
if ( V_78 ) {
F_67 ( V_1 , & V_78 -> V_64 -> V_243 , V_242 ) ;
if ( ! V_78 -> V_102
|| F_68 ( V_78 -> V_64 ) > 0
|| ! ( F_37 ( V_78 ) &
V_93 ) ) {
...
V_79 = F_35 ( V_8 ) ;
if ( V_79 ) {
F_67 ( V_1 , & V_79 -> V_64 -> V_243 , V_242 ) ;
F_44 ( V_79 -> V_64 ,
V_79 -> V_64 -> V_76 ) ;
if ( ! V_79 -> V_102
|| ! ( F_37 ( V_79 ) &
...
static T_2 F_71 ( struct V_1 * V_1 , const char V_17 * V_248 ,
T_3 V_249 , T_4 * V_250 )
{
struct V_65 * V_66 ;
struct V_63 * V_64 ;
...
F_74 ( V_260 ) ;
F_76 ( & V_64 -> V_243 , & V_242 ) ;
V_18:
return V_252 ? V_252 : V_67 ;
}
static T_2 F_77 ( struct V_1 * V_1 , char V_17 * V_248 , T_3 V_249 ,
T_4 * V_250 )
{
struct V_65 * V_66 ;
struct V_63 * V_64 ;
...
void F_43 ( struct V_9 * V_10 , struct V_65 * V_66 )
{
...
static int F_78 ( struct V_262 * V_262 , struct V_1 * V_1 )
{
...
static int F_82 ( struct V_262 * V_262 , struct V_1 * V_1 )
{
const unsigned V_4 = F_2 ( V_262 ) ;
struct V_7 * V_8 =
F_3 ( V_4 ) ;
...
static int F_83 ( int V_272 , struct V_1 * V_1 , int V_273 )
{
const unsigned V_4 = F_2 ( V_1 -> V_5 -> V_6 ) ;
struct V_7 * V_8 =
F_3 ( V_4 ) ;
struct V_9 * V_10 = V_8 -> V_12 ;
return F_84 ( V_272 , V_1 , V_273 , & V_10 -> V_274 ) ;
}
...
V_67 = F_88 ( F_89 ( V_266 , 0 ) ,
V_281 , L_46 ) ;
if ( V_67 )
return - V_190 ;
F_90 ( & V_282 , & V_283 ) ;
V_282 . V_284 = V_267 ;
F_91 ( & V_282 . V_285 , L_46 ) ;
if ( F_92 ( & V_282 , F_89 ( V_266 , 0 ) , V_281 ) ) {
F_93 ( F_89 ( V_266 , 0 ) ,
V_281 ) ;
return - V_190 ;
}
V_286 = F_94 ( V_267 , L_46 ) ;
if ( F_95 ( V_286 ) ) {
F_51 ( V_261 L_47 ) ;
F_96 ( & V_282 ) ;
F_93 ( F_89 ( V_266 , 0 ) ,
...
F_102 ( V_286 ) ;
F_96 ( & V_282 ) ;
F_93 ( F_89 ( V_266 , 0 ) , V_281 ) ;
F_103 () ;
}
void F_104 ( const struct V_9 * V_10 , const char * V_66 )
{
F_51 ( V_261 L_48 , V_10 -> V_4 ,
V_10 -> V_51 -> V_83 , V_66 ) ;
}
void F_105 ( struct V_9 * V_10 , struct V_65 * V_66 )
{
struct V_63 * V_64 = V_66 -> V_64 ;
unsigned V_204 = 0 ;
unsigned V_287 = 0 ;
...
if ( V_287 ) {
F_56 ( V_66 , V_287 , V_204 ) ;
}
if ( V_64 -> V_212 & V_66 -> V_64 -> V_288 ) {
if ( F_37 ( V_66 ) & V_219 ) {
F_106 ( & V_64 -> V_243 ) ;
if ( V_66 -> V_92 & V_135 )
F_107 ( & V_10 -> V_274 , V_289 , V_290 ) ;
if ( V_66 -> V_92 & V_137 )
F_107 ( & V_10 -> V_274 , V_289 , V_291 ) ;
} else {
if ( V_64 -> V_292 )
...
unsigned F_37 ( struct V_65 * V_66 )
{
unsigned long V_101 ;
unsigned V_204 ;
F_57 ( & V_66 -> V_203 , V_101 ) ;
...
unsigned V_86 ;
int V_67 ;
V_296 = F_113 ( sizeof( struct V_7 ) , V_89 ) ;
if ( V_296 == NULL )
return - V_58 ;
V_296 -> V_12 = F_113 ( sizeof( struct V_9 ) , V_89 ) ;
if ( V_296 -> V_12 == NULL ) {
F_39 ( V_296 ) ;
return - V_58 ;
}
...
V_296 -> V_12 -> V_4 = V_86 ;
V_297 = F_114 ( V_286 , NULL ,
F_89 ( V_266 , V_86 ) , NULL ,
V_295 , L_51 , V_86 ) ;
if ( ! F_95 ( V_297 ) )
V_296 -> V_12 -> V_299 = V_297 ;
F_115 ( V_297 , V_296 ) ;
V_67 = F_116 ( V_297 , & V_300 ) ;
if ( V_67 ) {
F_51 ( V_261
L_52
L_53 ,
...
unsigned V_86 ;
int V_67 ;
V_296 = F_46 ( sizeof( struct V_7 ) , V_89 ) ;
if ( V_296 == NULL )
return - V_58 ;
V_296 -> V_12 = V_10 ;
V_296 -> V_84 = V_66 ;
...
V_66 -> V_4 = V_86 ;
V_297 = F_114 ( V_286 , V_10 -> V_299 ,
F_89 ( V_266 , V_86 ) , NULL , NULL ,
L_54 , V_10 -> V_4 ,
( int ) ( V_66 - V_10 -> V_71 ) ) ;
if ( ! F_95 ( V_297 ) )
V_66 -> V_299 = V_297 ;
...
if ( V_66 -> V_4 < 0 )
return;
F_101 ( V_66 -> V_4 >= V_281 ) ;
F_101 ( V_66 -> V_4 < V_306 ) ;
F_57 ( & V_298 , V_101 ) ;
V_296 = V_280 [ V_66 -> V_4 ] ;
V_280 [ V_66 -> V_4 ] = NULL ;
F_58 ( & V_298 , V_101 ) ;
if ( V_66 -> V_299 ) {
F_117 ( V_286 , F_89 ( V_266 , V_66 -> V_4 ) ) ;
V_66 -> V_299 = NULL ;
}
F_39 ( V_296 ) ;
}
...
static T_2 F_121 ( struct V_12 * V_10 ,
struct V_309 * V_301 , char * V_248 )
{
T_2 V_67 ;
struct V_7 * V_296 = F_122 ( V_10 ) ;
unsigned V_310 = 0 ;
...
static T_2 F_123 ( struct V_12 * V_10 ,
struct V_309 * V_301 ,
...
static T_2 F_125 ( struct V_12 * V_10 ,
struct V_309 * V_301 , char * V_248 )
{
T_2 V_67 ;
struct V_7 * V_296 = F_122 ( V_10 ) ;
