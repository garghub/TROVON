...
static T_1 F_52 ( struct V_51 * V_16 , struct V_52 * V_53 , char * V_54 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
return sprintf ( V_54 , L_5 , V_1 -> V_58 ? L_11 : L_12 ) ;
}
static T_1 F_53 ( struct V_51 * V_16 , struct V_52 * V_53 , const char * V_54 , T_2 V_55 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
int V_4 ;
V_4 = V_55 ;
...
static void F_54 ( struct V_51 * V_16 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
F_20 ( V_1 ) ;
F_19 ( V_59 ) ;
...
if ( ! F_73 ( & V_73 -> V_61 , & V_49 -> V_62 ) ) {
V_73 = F_74 ( V_73 -> V_61 . V_32 ,
struct V_1 , V_61 ) ;
break;
}
V_73 = V_49 ;
...
void F_78 ( struct V_1 * V_1 , struct V_41 * V_28 )
{
F_55 ( V_1 ) ;
F_29 ( V_1 , V_28 , V_36 ) ;
}
...
static T_1 F_82 ( struct V_56 * V_3 , char * V_54 )
{
struct V_2 * V_74 = F_50 ( V_3 ) ;
return sprintf ( V_54 , L_5 , V_74 -> V_58 ? L_11 : L_12 ) ;
}
static T_1 F_83 ( struct V_56 * V_3 , const char * V_54 , T_2 V_55 )
{
struct V_2 * V_74 = F_50 ( V_3 ) ;
int V_4 ;
V_4 = V_55 ;
...
static int F_85 ( struct V_51 * V_16 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
F_5 ( V_1 ) ;
return 0 ;
...
static void F_87 ( struct V_51 * V_16 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
F_86 ( V_1 ) ;
}
...
int F_89 ( struct V_2 * V_3 , struct V_41 * V_28 , const char * V_76 )
{
bool V_58 = V_3 -> V_58 ;
int error ;
V_3 -> V_17 . V_64 = & V_57 ;
...
static int F_94 ( struct V_51 * V_16 , struct V_56 * V_3 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
struct V_2 * V_74 = F_50 ( V_3 ) ;
...
static int F_95 ( struct V_51 * V_16 , struct V_78 * V_79 )
{
struct V_1 * V_1 ;
if ( ! V_16 )
return - V_18 ;
...
static int F_98 ( struct V_51 * V_16 )
{
struct V_1 * V_1 = F_41 ( V_16 ) ;
F_29 ( V_1 , NULL , V_37 ) ;
return 0 ;
