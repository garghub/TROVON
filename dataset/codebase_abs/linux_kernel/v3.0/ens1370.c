...
#endif
F_153 ( V_26 ) ;
V_1 -> V_184 = V_26 -> V_268 ;
#ifdef F_48
#if 0
ensoniq->ctrl = ES_1370_CDC_EN | ES_1370_SERR_DISABLE |
ES_1370_PCLKDIVO(ES_1370_SRTODIV(8000));
#else
V_1 -> V_75 = V_269 | F_56 ( F_57 ( 8000 ) ) ;
#endif
V_1 -> V_68 = 0 ;
#else
V_1 -> V_75 = 0 ;
...
#endif
F_139 ( V_1 ) ;
if ( ( V_141 = F_164 ( V_142 , V_272 , V_1 , & V_192 ) ) < 0 ) {
F_130 ( V_1 ) ;
return V_141 ;
}
F_127 ( V_1 ) ;
...
{
struct V_273 * V_274 = V_1 -> V_274 ;
unsigned char V_163 , V_213 , V_275 ;
if ( V_274 == NULL )
return;
F_33 ( & V_1 -> V_67 ) ;
V_213 = V_1 -> V_276 & V_277 ? V_278 : 0 ;
while ( V_213 ) {
V_163 = F_167 ( F_3 ( V_1 , V_279 ) ) ;
if ( ( V_163 & V_213 ) == 0 )
break;
V_275 = F_167 ( F_3 ( V_1 , V_280 ) ) ;
F_168 ( V_1 -> V_281 , & V_275 , 1 ) ;
}
F_34 ( & V_1 -> V_67 ) ;
F_33 ( & V_1 -> V_67 ) ;
V_213 = V_1 -> V_276 & V_282 ? V_283 : 0 ;
while ( V_213 ) {
V_163 = F_167 ( F_3 ( V_1 , V_279 ) ) ;
if ( ( V_163 & V_213 ) == 0 )
break;
if ( F_169 ( V_1 -> V_284 , & V_275 , 1 ) != 1 ) {
V_1 -> V_253 &= ~ V_285 ;
F_140 ( V_1 -> V_253 , F_3 ( V_1 , V_254 ) ) ;
V_213 &= ~ V_283 ;
} else {
F_140 ( V_275 , F_3 ( V_1 , V_280 ) ) ;
}
}
F_34 ( & V_1 -> V_67 ) ;
}
static int F_170 ( struct V_286 * V_55 )
{
struct V_1 * V_1 = V_55 -> V_274 -> V_20 ;
F_44 ( & V_1 -> V_67 ) ;
V_1 -> V_276 |= V_277 ;
V_1 -> V_281 = V_55 ;
if ( ! ( V_1 -> V_276 & V_282 ) ) {
...
F_8 ( V_1 -> V_75 |= V_287 , F_3 ( V_1 , V_38 ) ) ;
}
F_51 ( & V_1 -> V_67 ) ;
return 0 ;
}
static int F_172 ( struct V_286 * V_55 )
{
struct V_1 * V_1 = V_55 -> V_274 -> V_20 ;
F_44 ( & V_1 -> V_67 ) ;
if ( ! ( V_1 -> V_276 & V_282 ) ) {
...
F_140 ( V_1 -> V_253 &= ~ V_288 , F_3 ( V_1 , V_254 ) ) ;
}
V_1 -> V_281 = NULL ;
V_1 -> V_276 &= ~ V_277 ;
F_51 ( & V_1 -> V_67 ) ;
...
static int F_173 ( struct V_286 * V_55 )
{
struct V_1 * V_1 = V_55 -> V_274 -> V_20 ;
F_44 ( & V_1 -> V_67 ) ;
V_1 -> V_276 |= V_282 ;
...
static int F_174 ( struct V_286 * V_55 )
{
struct V_1 * V_1 = V_55 -> V_274 -> V_20 ;
F_44 ( & V_1 -> V_67 ) ;
if ( ! ( V_1 -> V_276 & V_277 ) ) {
...
F_140 ( V_1 -> V_253 &= ~ V_285 , F_3 ( V_1 , V_254 ) ) ;
}
V_1 -> V_284 = NULL ;
V_1 -> V_276 &= ~ V_282 ;
F_51 ( & V_1 -> V_67 ) ;
...
static void F_175 ( struct V_286 * V_55 , int V_289 )
{
unsigned long V_290 ;
struct V_1 * V_1 = V_55 -> V_274 -> V_20 ;
int V_216 ;
F_176 ( & V_1 -> V_67 , V_290 ) ;
if ( V_289 ) {
if ( ( V_1 -> V_253 & V_288 ) == 0 ) {
...
F_177 ( & V_1 -> V_67 , V_290 ) ;
}
static void F_178 ( struct V_286 * V_55 , int V_289 )
{
unsigned long V_290 ;
struct V_1 * V_1 = V_55 -> V_274 -> V_20 ;
unsigned char V_275 ;
...
( F_167 ( F_3 ( V_1 , V_279 ) ) & V_283 ) ) {
if ( F_169 ( V_55 , & V_275 , 1 ) != 1 ) {
V_1 -> V_253 &= ~ V_285 ;
} else {
F_140 ( V_275 , F_3 ( V_1 , V_280 ) ) ;
}
...
if ( V_291 )
* V_291 = NULL ;
if ( ( V_141 = F_182 ( V_1 -> V_142 , L_7 , V_27 , 1 , 1 , & V_274 ) ) < 0 )
return V_141 ;
#ifdef F_48
strcpy ( V_274 -> V_149 , L_36 ) ;
#else
strcpy ( V_274 -> V_149 , L_37 ) ;
#endif
F_183 ( V_274 , V_292 , & V_293 ) ;
F_183 ( V_274 , V_294 , & V_295 ) ;
V_274 -> V_148 |= V_296 | V_297 |
V_298 ;
V_274 -> V_20 = V_1 ;
V_1 -> V_274 = V_274 ;
if ( V_291 )
...
static T_5 V_266 ( int V_239 , void * V_299 )
{
struct V_1 * V_1 = V_299 ;
...
if ( V_163 & V_305 )
F_166 ( V_1 ) ;
if ( ( V_163 & V_303 ) && V_1 -> V_63 )
F_184 ( V_1 -> V_63 ) ;
if ( ( V_163 & V_304 ) && V_1 -> V_65 )
F_184 ( V_1 -> V_65 ) ;
if ( ( V_163 & V_302 ) && V_1 -> V_61 )
F_184 ( V_1 -> V_61 ) ;
return V_306 ;
}
...
V_141 = F_186 ( V_208 [ V_220 ] , V_207 [ V_220 ] , V_314 , 0 , & V_142 ) ;
if ( V_141 < 0 )
return V_141 ;
...
#endif
#ifdef F_45
if ( ( V_141 = F_97 ( V_1 , V_128 [ V_220 ] , V_315 [ V_220 ] ) ) < 0 ) {
F_187 ( V_142 ) ;
return V_141 ;
}
#endif
...
F_112 ( V_1 , V_220 ) ;
strcpy ( V_142 -> V_316 , V_317 ) ;
strcpy ( V_142 -> V_318 , L_33 ) ;
sprintf ( V_142 -> V_319 , L_38 ,
V_142 -> V_318 ,
V_142 -> V_316 ,
V_1 -> V_232 ,
V_1 -> V_239 ) ;
