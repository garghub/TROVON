...
struct V_41 * V_42 = NULL ;
int V_51 , V_68 ;
V_68 = F_30 ( V_5 , 0 , ( unsigned long * ) & V_2 -> V_67 ) ;
if ( V_68 < 0 )
return V_68 ;
V_42 = V_2 -> V_42 ;
V_51 = V_42 -> V_50 . V_51 ;
...
struct V_41 * V_42 = NULL ;
V_2 = F_33 ( sizeof( struct V_1 ) , V_73 ) ;
if ( ! V_2 )
return - V_74 ;
V_12 -> V_75 = 9 ;
V_15 = F_34 ( V_12 ) ;
...
V_2 -> V_12 = V_12 ;
V_2 -> V_23 = & V_12 -> V_23 ;
V_2 -> V_43 = (struct V_39 * ) V_12 -> V_23 . V_77 ;
if ( ! V_2 -> V_43 ) {
F_9 ( & V_12 -> V_23 , L_4 ) ;
goto V_76;
}
...
static int F_46 ( struct V_72 * V_12 , T_6 V_86 )
{
int V_15 = 0 ;
struct V_1 * V_2 = F_27 ( & V_12 -> V_23 ) ;
