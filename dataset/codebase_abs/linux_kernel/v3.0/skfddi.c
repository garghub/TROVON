...
memcpy ( V_6 -> V_55 , V_8 -> V_32 . V_53 . V_54 , 6 ) ;
F_34 ( V_8 , 0 ) ;
return 0 ;
V_51:
if ( V_49 -> V_42 ) {
...
static T_4 V_56 ( int V_22 , void * V_59 )
{
struct V_5 * V_6 = V_59 ;
struct V_7 * V_8 ;
T_3 * V_49 ;
...
static struct V_65 * F_56 ( struct V_5 * V_6 )
{
struct V_7 * V_49 = F_14 ( V_6 ) ;
V_49 -> V_25 . V_66 . V_67 [ 0 ] = 0x1234 ;
V_49 -> V_25 . V_66 . V_67 [ 1 ] = 0x5678 ;
#if 0
...
#endif
return (struct V_65 * ) & V_49 -> V_25 . V_66 ;
}
...
static int F_66 ( struct V_5 * V_6 , void * V_79 )
{
struct V_7 * V_8 = F_14 ( V_6 ) ;
struct V_80 * V_81 = (struct V_80 * ) V_79 ;
T_3 * V_49 = & V_8 -> V_25 ;
unsigned long V_68 ;
memcpy ( V_6 -> V_55 , V_81 -> V_82 , V_83 ) ;
F_58 ( & V_49 -> V_50 , V_68 ) ;
F_54 ( V_8 ) ;
F_60 ( & V_49 -> V_50 , V_68 ) ;
return 0 ;
}
static int F_67 ( struct V_5 * V_6 , struct V_84 * V_85 , int V_86 )
{
struct V_7 * V_8 = F_14 ( V_6 ) ;
T_3 * V_48 = & V_8 -> V_25 ;
struct V_87 V_88 ;
int V_89 = 0 ;
if ( F_68 ( & V_88 , V_85 -> V_90 , sizeof( struct V_87 ) ) )
return - V_91 ;
switch ( V_88 . V_86 ) {
case V_92 :
V_88 . V_93 = sizeof( V_48 -> V_66 ) ;
V_89 = F_69 ( V_88 . V_94 , F_56 ( V_6 ) , V_88 . V_93 )
? - V_91 : 0 ;
break;
case V_95 :
if ( ! F_70 ( V_96 ) ) {
...
memset ( & V_48 -> V_66 , 0 , sizeof( V_48 -> V_66 ) ) ;
}
break;
default:
F_3 ( L_26 , V_6 -> V_41 , V_88 . V_86 ) ;
V_89 = - V_98 ;
}
return V_89 ;
}
static T_5 F_71 ( struct V_99 * V_100 ,
struct V_5 * V_6 )
{
struct V_7 * V_8 = F_14 ( V_6 ) ;
T_3 * V_49 = & V_8 -> V_25 ;
F_2 ( L_27 ) ;
if ( ! ( V_100 -> V_93 >= V_101 && V_100 -> V_93 <= V_102 ) ) {
V_49 -> V_66 . V_103 . V_104 ++ ;
F_42 ( V_6 ) ;
F_72 ( V_100 ) ;
return V_105 ;
}
...
F_58 ( & V_49 -> V_50 , V_68 ) ;
V_107 = V_100 -> V_94 [ 0 ] ;
V_108 = ( V_107 & V_113 ) ? V_114 : V_115 ;
#ifdef F_76
if ( ( V_107 & ~ ( V_113 | V_116 ) ) == V_117 ) {
if ( ! V_8 -> V_118 . V_119 )
V_107 &= ~ V_113 ;
else {
if ( V_8 -> V_120 . V_121 ) {
...
#endif
V_112 = F_77 ( V_8 , V_107 , 1 , V_100 -> V_93 , V_108 ) ;
if ( ( V_112 & ( V_122 | V_123 ) ) == 0 ) {
if ( ( V_112 & V_124 ) != 0 ) {
F_2 ( L_30 ) ;
} else if ( ( V_112 & V_125 ) != 0 ) {
F_2 ( L_31 , V_49 -> V_6 -> V_41 ) ;
} else {
F_2 ( L_32 ,
V_49 -> V_6 -> V_41 ) ;
}
F_78 ( & V_49 -> V_36 , V_100 ) ;
F_60 ( & V_49 -> V_50 , V_68 ) ;
return;
}
V_49 -> V_28 ++ ;
F_79 ( V_100 -> V_94 , V_8 -> V_32 . V_53 . V_54 ) ;
V_110 = (struct V_109 * ) F_80 ( V_8 , V_108 ) ;
V_111 = F_81 ( & V_49 -> V_2 , V_100 -> V_94 ,
V_100 -> V_93 , V_126 ) ;
if ( V_112 & V_123 ) {
V_110 -> V_127 . V_100 = V_100 ;
V_110 -> V_127 . V_128 = V_111 ;
}
F_82 ( V_8 , V_100 -> V_94 , V_111 , V_100 -> V_93 ,
V_112 | V_129 | V_130 | V_131 ) ;
if ( ! ( V_112 & V_123 ) ) {
F_83 ( & V_49 -> V_2 , V_111 ,
V_100 -> V_93 , V_126 ) ;
F_84 ( V_100 ) ;
...
static void F_79 ( unsigned char * V_132 , unsigned char * V_133 )
{
unsigned char V_134 ;
if ( ( ( ( unsigned long ) V_132 [ 1 + 6 ] ) & ~ 0x01 ) != 0 )
return;
if ( ( unsigned short ) V_132 [ 1 + 10 ] != 0 )
return;
V_134 = V_132 [ 1 + 6 ] & 0x01 ;
memcpy ( & V_132 [ 1 + 6 ] , V_133 , 6 ) ;
V_132 [ 8 ] |= V_134 ;
}
...
void * F_86 ( struct V_7 * V_8 , unsigned int V_135 )
{
void * V_136 ;
F_2 ( L_35 , V_135 ) ;
V_136 = ( void * ) ( V_8 -> V_25 . V_42 + V_8 -> V_25 . V_52 ) ;
if ( ( V_8 -> V_25 . V_52 + V_135 ) > V_8 -> V_25 . V_43 ) {
F_3 ( L_36 , V_135 ) ;
return NULL ;
}
V_8 -> V_25 . V_52 += V_135 ;
F_2 ( L_37 ) ;
F_2 ( L_38 , ( V_137 ) V_136 ) ;
F_2 ( L_39 , ( V_137 )
( V_8 -> V_25 . V_44 +
( ( char * ) V_136 - ( char * ) V_8 -> V_25 . V_42 ) ) ) ;
return V_136 ;
}
void * F_87 ( struct V_7 * V_8 , unsigned int V_135 )
{
char * V_136 ;
F_2 ( L_40 ) ;
V_136 = F_86 ( V_8 , V_135 ) ;
V_135 = ( V_138 ) ( 16 - ( ( ( unsigned long ) V_136 ) & 15UL ) ) ;
V_135 = V_135 % 16 ;
F_2 ( L_41 , V_135 ) ;
F_2 ( L_42 ) ;
if ( ! F_86 ( V_8 , V_135 ) ) {
...
unsigned long F_88 ( struct V_7 * V_8 , void * V_136 )
{
return V_8 -> V_25 . V_44 +
( ( char * ) V_136 - ( char * ) V_8 -> V_25 . V_42 ) ;
}
T_7 F_89 ( struct V_7 * V_8 , void * V_136 , int V_93 , int V_139 )
{
return V_8 -> V_25 . V_44 +
( ( char * ) V_136 - ( char * ) V_8 -> V_25 . V_42 ) ;
}
void F_90 ( struct V_7 * V_8 , volatile union V_140 * V_141 , int V_139 )
{
if ( V_139 & V_142 ) {
T_3 * V_49 = & V_8 -> V_25 ;
volatile struct V_143 * V_144 = & V_141 -> V_144 ;
if ( V_144 -> V_145 . V_100 && V_144 -> V_145 . V_128 ) {
int V_30 = V_49 -> V_30 ;
F_83 ( & V_49 -> V_2 , V_144 -> V_145 . V_128 ,
V_30 , V_146 ) ;
V_144 -> V_145 . V_128 = 0 ;
}
}
}
void F_91 ( struct V_7 * V_8 , volatile struct V_109 * V_110 )
{
struct V_99 * V_100 ;
F_2 ( L_44 ) ;
if ( ! ( V_100 = V_110 -> V_127 . V_100 ) ) {
F_2 ( L_45 ) ;
return;
}
V_110 -> V_127 . V_100 = NULL ;
F_83 ( & V_8 -> V_25 . V_2 , V_110 -> V_127 . V_128 ,
V_100 -> V_93 , V_126 ) ;
V_110 -> V_127 . V_128 = 0 ;
V_8 -> V_25 . V_66 . V_103 . V_147 ++ ;
V_8 -> V_25 . V_66 . V_103 . V_148 += V_100 -> V_93 ;
F_84 ( V_100 ) ;
F_2 ( L_46 ) ;
}
void F_92 ( unsigned char * V_149 , int V_150 )
{
int V_151 , V_152 ;
unsigned char V_153 [ 255 ] , V_154 [ 10 ] ;
if ( V_150 > 64 ) {
V_150 = 64 ;
}
F_3 ( V_155 L_47 ) ;
for ( V_151 = 0 , V_152 = 0 ; V_151 < V_150 / 8 ; V_151 ++ , V_152 += 8 )
F_3 ( V_155 L_48 ,
V_149 [ V_152 + 0 ] , V_149 [ V_152 + 1 ] , V_149 [ V_152 + 2 ] , V_149 [ V_152 + 3 ] ,
V_149 [ V_152 + 4 ] , V_149 [ V_152 + 5 ] , V_149 [ V_152 + 6 ] , V_149 [ V_152 + 7 ] ) ;
strcpy ( V_153 , L_49 ) ;
for ( V_151 = 0 ; V_151 < V_150 % 8 ; V_151 ++ ) {
sprintf ( V_154 , L_50 , V_149 [ V_152 + V_151 ] ) ;
strcat ( V_153 , V_154 ) ;
}
F_3 ( V_155 L_2 , V_153 ) ;
F_3 ( V_155 L_51 ) ;
}
void F_93 ( struct V_7 * V_8 , volatile struct V_143 * V_156 ,
int V_157 , int V_93 )
{
T_3 * V_49 = & V_8 -> V_25 ;
struct V_99 * V_100 ;
unsigned char * V_136 , * V_158 ;
...
V_100 = V_156 -> V_145 . V_100 ;
if ( ! V_100 ) {
F_2 ( L_54 ) ;
V_8 -> V_25 . V_66 . V_103 . V_162 ++ ;
goto V_161;
}
V_136 = V_100 -> V_94 ;
F_92 ( V_100 -> V_94 , V_93 ) ;
if ( ( V_136 [ 1 + 6 ] & V_163 ) == 0 )
V_160 = 0 ;
else {
int V_164 ;
F_2 ( L_55 ) ;
V_158 = V_136 + V_165 ;
V_159 = F_94 ( * ( ( V_166 * ) V_158 ) ) ;
V_160 = V_159 & V_167 ;
if ( V_93 < ( int ) ( V_165 + V_160 ) ) {
F_3 ( L_56 ) ;
goto V_161;
}
V_136 [ 1 + 6 ] &= ~ V_163 ;
V_136 = V_158 + V_160 ;
for ( V_164 = V_165 ; V_164 ; V_164 -- )
* -- V_136 = * -- V_158 ;
F_95 ( V_100 , V_160 ) ;
V_93 -= V_160 ;
V_160 = 0 ;
}
V_8 -> V_25 . V_66 . V_103 . V_168 ++ ;
V_8 -> V_25 . V_66 . V_103 . V_169 += V_93 ;
if ( V_136 [ 1 ] & 0x01 ) {
V_8 -> V_25 . V_66 . V_103 . V_170 ++ ;
}
V_156 -> V_145 . V_100 = NULL ;
F_96 ( V_100 , V_93 ) ;
V_100 -> V_171 = F_97 ( V_100 , V_49 -> V_6 ) ;
F_98 ( V_100 ) ;
F_99 ( V_8 , V_172 ) ;
return;
V_161:
F_2 ( L_57 ) ;
F_100 ( V_8 , V_156 , V_157 ) ;
V_8 -> V_25 . V_66 . V_103 . V_162 ++ ;
}
void F_100 ( struct V_7 * V_8 , volatile struct V_143 * V_156 ,
int V_157 )
{
volatile struct V_143 * V_173 ;
volatile struct V_143 * V_174 ;
struct V_99 * V_100 ;
int V_30 ;
unsigned char * V_175 ;
T_6 V_176 ;
...
V_173 = V_174 -> V_177 ;
V_156 = F_101 ( V_8 ) ;
V_100 = V_174 -> V_145 . V_100 ;
if ( V_100 == NULL ) {
F_2 ( L_59 ) ;
V_100 = F_102 ( V_30 + 3 , V_178 ) ;
if ( V_100 ) {
V_156 -> V_145 . V_100 = V_100 ;
F_103 ( V_100 , 3 ) ;
F_104 ( V_100 , V_30 ) ;
V_175 = V_100 -> V_94 ;
V_176 = F_81 ( & V_8 -> V_25 . V_2 ,
V_175 ,
V_30 ,
V_146 ) ;
V_156 -> V_145 . V_128 = V_176 ;
} else {
F_2 ( L_60 ) ;
V_156 -> V_145 . V_100 = NULL ;
V_175 = V_8 -> V_25 . V_45 ;
...
void F_108 ( struct V_7 * V_8 , volatile struct V_143 * V_156 ,
int V_157 )
{
struct V_99 * V_100 ;
F_2 ( L_64 ) ;
...
T_3 * V_49 = & V_8 -> V_25 ;
int V_30 = V_49 -> V_30 ;
F_83 ( & V_49 -> V_2 , V_156 -> V_145 . V_128 ,
V_30 , V_146 ) ;
F_72 ( V_100 ) ;
V_156 -> V_145 . V_100 = NULL ;
}
...
int F_109 ( struct V_7 * V_8 , int V_93 , int V_107 ,
char * V_179 , int V_180 )
{
struct V_99 * V_100 ;
F_2 ( L_66 , V_93 ) ;
if ( V_93 != V_180 || V_93 < V_165 || ! V_179 ) {
F_2 ( L_67 ) ;
F_2 ( L_68 ,
V_93 , V_180 , ( unsigned long ) V_179 ) ;
return 0 ;
}
V_100 = F_102 ( V_93 + 3 , V_178 ) ;
if ( ! V_100 ) {
F_2 ( L_69 ) ;
return 0 ;
}
F_103 ( V_100 , 3 ) ;
F_104 ( V_100 , V_93 ) ;
F_110 ( V_100 , V_179 , V_93 ) ;
V_100 -> V_171 = F_97 ( V_100 , V_8 -> V_25 . V_6 ) ;
F_98 ( V_100 ) ;
return 0 ;
}
...
void F_112 ( struct V_7 * V_8 , T_7 V_89 )
{
F_2 ( L_70 ) ;
if ( V_89 & V_181 )
F_2 ( L_71 ) ;
...
void F_114 ( struct V_7 * V_8 , int V_198 )
{
F_2 ( L_88 ) ;
switch ( V_198 ) {
case 0 :
...
void F_115 ( struct V_7 * V_8 , int V_199 )
{
#ifdef F_116
char * V_153 ;
switch ( V_199 ) {
...
void F_117 ( struct V_7 * V_8 , int V_209 )
{
#ifdef F_116
char * V_153 ;
switch ( V_209 ) {
...
void F_118 ( struct V_7 * V_8 , int V_218 )
{
#ifdef F_116
char * V_153 ;
switch ( V_218 ) {
