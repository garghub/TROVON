...
if ( ( V_21 = F_140 ( V_132 , V_253 , V_103 , & V_250 ) ) < 0 ) {
F_129 ( V_103 ) ;
return V_21 ;
}
...
static void
F_142 ( struct V_254 * V_255 ,
struct V_256 * V_257 )
{
struct V_102 * V_103 = V_255 -> V_115 ;
struct V_109 * V_11 ;
int V_12 ;
struct V_7 * V_8 = NULL ;
...
if ( ! V_103 )
return;
F_143 ( V_257 , L_48 , V_103 -> V_132 -> V_258 ) ;
F_143 ( V_257 , L_49 ,
...
F_143 ( V_257 , L_53 , V_12 , V_81 , V_82 ) ;
}
F_143 ( V_257 ,
L_54 ,
V_8 -> V_75 , V_8 -> V_59 ,
...
while ( V_12 >= 2 ) {
V_12 -= 2 ;
F_143 ( V_257 , L_59 , V_13 [ V_12 ] , V_13 [ V_12 + 1 ] ) ;
}
F_143 ( V_257 , L_60 ) ;
}
...
{
struct V_254 * V_255 ;
if ( ! F_146 ( V_103 -> V_132 , L_61 , & V_255 ) )
F_147 ( V_255 , V_103 , F_142 ) ;
}
...
V_136 . V_115 = V_103 ;
V_136 . V_265 = V_266 ;
if ( ( V_21 = V_259 ( V_103 -> V_132 , 0 , & V_250 , V_103 , & V_260 ) ) < 0 )
return V_21 ;
V_103 -> V_267 = V_260 ;
V_136 . V_130 = V_103 -> V_130 ;
if ( ( V_21 = F_149 ( V_260 , & V_136 , & V_103 -> V_136 ) ) < 0 )
return V_21 ;
return V_21 ;
}
static int T_5
F_150 ( struct V_129 * V_130 , const struct V_268 * V_91 )
{
static int V_149 ;
struct V_269 * V_269 ;
if ( V_149 >= V_270 )
...
static int T_5
F_158 ( struct V_129 * V_130 , const struct V_268 * V_277 )
{
static int V_149 ;
struct V_131 * V_132 ;
struct V_102 * V_103 ;
...
V_21 = F_159 ( V_278 [ V_149 ] , V_91 [ V_149 ] , V_279 , 0 , & V_132 ) ;
if ( V_21 < 0 )
return V_21 ;
...
F_161 ( V_103 -> V_130 , V_287 , V_20 ) ;
if ( V_284 [ V_149 ] ) {
V_20 = V_284 [ V_149 ] ;
F_161 ( V_103 -> V_130 , V_288 , V_20 ) ;
V_21 = F_162 ( V_132 , 0 , V_289 ,
...
V_103 -> V_294 = V_20 ;
V_21 = F_164 ( V_103 -> V_293 , 0 , 1 , NULL ) ;
if ( V_21 < 0 )
F_17 ( V_275
L_66 ) ;
}
...
if ( V_274 [ V_149 ] ) {
V_20 = V_274 [ V_149 ] ;
F_161 ( V_103 -> V_130 , V_295 , V_20 ) ;
V_103 -> V_296 = V_20 ;
}
#endif
strcpy ( V_132 -> V_297 , L_40 ) ;
strcpy ( V_132 -> V_298 , L_67 ) ;
#ifdef F_160
snprintf ( V_132 -> V_258 , sizeof( V_132 -> V_258 ) ,
L_68 ,
V_132 -> V_298 , V_103 -> V_68 , V_103 -> V_236 , V_103 -> V_290 ,
V_103 -> V_294 , V_103 -> V_296 ) ;
#else
snprintf ( V_132 -> V_258 , sizeof( V_132 -> V_258 ) ,
L_69 ,
V_132 -> V_298 , V_103 -> V_68 , V_103 -> V_236 , V_103 -> V_290 ,
