...
F_43 ( ~ ( T_2 ) 0 , V_41 + V_72 ) ;
F_43 ( ~ ( T_2 ) 0 , V_41 + V_73 ) ;
F_45 ( V_41 ) ;
}
...
{
int V_77 = 1 , V_78 = 0 ;
if ( V_40 -> V_79 == 0x8086 && V_40 -> V_80 == 0x283a ) {
const char * V_81 = F_47 ( V_82 ) ;
const char * V_83 = F_47 ( V_84 ) ;
if ( V_81 && ! strcmp ( V_81 , L_9 ) &&
V_83 && ! strcmp ( V_83 , L_10 ) )
V_77 = 0 ;
}
if ( V_77 && ( V_75 & V_85 ) ) {
F_30 ( & V_40 -> V_46 , L_11 ) ;
...
F_54 ( V_40 ) ;
V_116:
V_74 = V_41 + F_61 ( F_40 ( V_41 ) ) ;
V_114 = F_52 ( V_74 + V_122 , V_123 , 0 ,
5000 , 10 ) ;
if ( V_114 ) {
V_23 = F_40 ( V_74 + V_122 ) ;
F_27 ( & V_40 -> V_46 ,
L_22
L_23 , V_23 ) ;
}
V_23 = F_40 ( V_74 + V_124 ) ;
V_23 &= ~ ( V_125 | V_126 ) ;
F_43 ( V_23 , V_74 + V_124 ) ;
V_114 = F_52 ( V_74 + V_122 , V_127 , 1 ,
V_128 , 125 ) ;
if ( V_114 ) {
V_23 = F_40 ( V_74 + V_122 ) ;
F_27 ( & V_40 -> V_46 ,
