...
static int F_31 ( struct V_5 * V_6 , T_3 V_155 )
{
F_27 ( V_6 , V_143 ) ;
return 0 ;
}
...
T_1 * V_128 ;
V_73 = F_16 ( V_6 ) ;
V_112 = F_36 ( V_6 , 7 , 9 , V_73 -> V_156 ) ;
if ( V_112 < 0 ) {
F_14 ( V_6 -> V_48 , L_16 , V_112 ) ;
return V_112 ;
}
for ( V_71 = 0 ; V_71 < F_9 ( V_73 -> V_144 ) ; V_71 ++ )
V_73 -> V_144 [ V_71 ] . V_157 = V_158 [ V_71 ] ;
...
V_128 = V_6 -> V_131 ;
for ( V_71 = 0 ; V_71 < F_9 ( V_161 ) ; ++ V_71 )
V_128 [ V_161 [ V_71 ] ] |= 0x100 ;
V_128 [ V_162 ] |= V_163 ;
V_6 -> V_129 = 1 ;
F_38 ( V_6 , V_164 ,
F_9 ( V_164 ) ) ;
...
static int T_5 F_39 ( struct V_165 * V_166 )
{
struct V_72 * V_73 ;
int V_112 ;
V_73 = F_40 ( sizeof *V_73 , V_167 ) ;
if ( ! V_73 )
return - V_168 ;
V_73 -> V_156 = V_169 ;
F_41 ( V_166 , V_73 ) ;
V_112 = F_42 ( & V_166 -> V_48 ,
& V_170 , & V_171 , 1 ) ;
if ( V_112 < 0 )
F_43 ( V_73 ) ;
return V_112 ;
}
static int T_6 F_44 ( struct V_165 * V_166 )
{
F_45 ( & V_166 -> V_48 ) ;
F_43 ( F_46 ( V_166 ) ) ;
return 0 ;
}
static T_5 int F_47 ( struct V_172 * V_173 ,
...
V_73 -> V_156 = V_176 ;
F_48 ( V_173 , V_73 ) ;
V_112 = F_42 ( & V_173 -> V_48 ,
& V_170 , & V_171 , 1 ) ;
if ( V_112 < 0 )
F_43 ( V_73 ) ;
return V_112 ;
}
static T_6 int F_49 ( struct V_172 * V_177 )
{
F_45 ( & V_177 -> V_48 ) ;
F_43 ( F_50 ( V_177 ) ) ;
return 0 ;
