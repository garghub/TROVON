...
static int F_15 ( struct V_2 * V_4 , struct V_1 * V_1 , int V_13 ,
struct V_5 * V_6 )
{
struct V_2 * V_2 ;
int V_3 ;
...
static int F_20 ( struct V_2 * V_4 , struct V_1 * V_1 , int V_13 , T_2 V_21 )
{
struct V_2 * V_2 ;
int V_3 ;
if ( ! F_21 ( V_21 ) )
...
goto V_28;
F_8 ( V_4 -> V_12 ) ;
V_2 = F_17 ( V_4 , V_29 | V_30 ) ;
V_3 = F_18 ( V_2 ) ;
if ( F_12 ( V_2 ) )
goto V_31;
if ( V_26 > F_26 ( V_25 ) -> V_32 -> V_33 ) {
V_2 -> V_14 = & V_34 ;
V_2 -> V_18 -> V_19 = & V_20 ;
...
V_2 -> V_14 = & V_36 ;
memcpy ( F_24 ( V_2 ) -> V_37 . V_38 , V_23 , V_26 ) ;
V_2 -> V_39 = V_26 - 1 ;
}
F_19 ( V_2 ) ;
V_3 = F_1 ( V_1 , V_2 ) ;
...
static int F_31 ( struct V_2 * V_4 , struct V_1 * V_1 , int V_13 )
{
struct V_2 * V_2 ;
int V_3 = - V_44 ;
if ( V_4 -> V_42 >= V_43 )
...
struct V_53 * V_53 ;
int V_3 = - V_54 ;
V_52 = F_34 ( V_4 , & V_1 -> V_8 , & V_53 ) ;
if ( ! V_52 )
goto V_31;
V_3 = F_35 ( V_4 , V_52 , V_53 ) ;
if ( V_3 )
goto V_31;
V_2 -> V_45 = V_4 -> V_45 ;
F_4 ( V_2 ) ;
...
static int F_38 ( struct V_2 * V_56 , struct V_1 * V_40 ,
...
goto V_48;
V_3 = - V_54 ;
V_69 = F_34 ( V_57 , & V_58 -> V_8 , & V_68 ) ;
if ( ! V_69 )
goto V_48;
F_41 ( V_57 , V_69 , V_68 , V_59 ) ;
V_60 -> V_45 = V_46 ;
if ( V_62 )
F_42 ( V_60 ) ;
F_4 ( V_60 ) ;
