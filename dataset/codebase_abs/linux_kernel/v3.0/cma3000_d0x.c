...
V_10 = F_3 ( V_2 , V_22 , L_5 ) ;
V_11 = ( V_10 & V_23 ) >> 1 ;
V_12 = ( V_10 & V_24 ) >> 7 ;
V_2 -> V_7 = V_25 [ V_11 ] [ V_12 ] ;
if ( V_2 -> V_7 == 0 )
return V_15 ;
F_1 ( V_2 , & V_3 , & V_4 , & V_5 ) ;
...
int V_38 ;
if ( V_2 -> V_39 == V_40 ) {
V_10 = ( V_2 -> V_11 << 1 ) | V_41 ;
} else if ( V_2 -> V_39 == V_42 ) {
V_10 = ( V_2 -> V_11 << 1 ) | V_43 ;
} else {
F_11 ( V_2 -> V_33 ,
L_10 ) ;
V_10 = ( V_2 -> V_11 << 1 ) | V_43 ;
...
{
const struct V_36 * V_37 = V_33 -> V_60 ;
struct V_1 * V_2 ;
struct V_17 * V_17 ;
int V_61 ;
int error ;
...
V_2 = F_22 ( sizeof( struct V_1 ) , V_64 ) ;
V_17 = F_23 () ;
if ( ! V_2 || ! V_17 ) {
error = - V_65 ;
goto V_66;
...
F_24 ( & V_2 -> V_54 ) ;
V_2 -> V_11 = V_37 -> V_11 ;
if ( V_2 -> V_11 < V_67 || V_2 -> V_11 > V_53 ) {
V_2 -> V_11 = V_68 ;
F_25 ( V_33 ,
L_16 ) ;
}
...
F_27 ( V_17 , V_27 ,
- V_2 -> V_39 , V_2 -> V_39 , V_37 -> V_77 , 0 ) ;
F_27 ( V_17 , V_28 ,
- V_2 -> V_39 , V_2 -> V_39 , V_37 -> V_78 , 0 ) ;
F_27 ( V_17 , V_18 , 0 , 1 , 0 , 0 ) ;
F_28 ( V_17 , V_2 ) ;
error = F_6 ( V_2 ) ;
if ( error )
goto V_66;
V_61 = F_3 ( V_2 , V_79 , L_18 ) ;
if ( V_61 < 0 ) {
error = V_61 ;
goto V_66;
}
F_29 ( L_19 , V_61 ) ;
error = F_30 ( V_8 , NULL , F_2 ,
V_37 -> V_80 | V_81 ,
L_20 , V_2 ) ;
if ( error ) {
F_9 ( V_33 , L_21 ) ;
