...
static int F_19 ( T_2 V_39 )
{
return V_39 == V_49 || V_39 == V_48 ;
}
...
static int F_24 ( struct V_56 * V_57 , unsigned int V_4 )
{
int V_58 = F_25 ( V_57 -> V_59 ) ;
T_3 V_60 ;
if ( V_58 >= 0 && V_58 < 128 )
return F_26 ( V_58 , V_4 ) ;
if ( V_57 -> V_59 == V_61 )
return F_27 ( V_4 ) ;
switch ( V_57 -> V_59 ) {
case V_62 :
