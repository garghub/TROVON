...
const struct V_86 * V_22 = V_6 -> V_22 ;
struct V_14 * V_14 = V_6 -> V_15 ;
long V_87 = 0 ;
T_3 V_88 ;
T_1 V_89 = 0 ;
...
if ( V_88 > V_49 )
V_88 = V_49 ;
V_87 = V_22 -> V_23 ( V_6 , V_16 , 0 ,
& V_29 , & V_30 ) ;
if ( V_87 == - V_33 ) {
F_15 ( & V_60 ) ;
V_87 = V_22 -> V_23 ( V_6 , V_16 , 1 ,
& V_29 , & V_30 ) ;
F_26 ( & V_60 ) ;
if ( ! V_87 )
F_13 ( V_6 , V_16 ) ;
...
F_40 ( V_14 -> V_74 , V_94 ) ;
V_95 -> V_96 = V_6 -> V_96 ;
V_81 = F_41 ( V_10 , & V_20 , & V_49 , F_42 ( V_14 -> V_97 ) ) ;
if ( V_81 )
goto V_98;
if ( V_49 == 0 )
goto V_98;
...
goto V_98;
F_44 ( V_10 ) ;
V_81 = F_35 ( V_10 , V_11 , V_49 , V_20 , V_13 ) ;
V_98:
V_95 -> V_96 = NULL ;
V_93:
F_26 ( & V_14 -> V_91 ) ;
