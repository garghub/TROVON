...
V_5 -> V_43 = V_43 ;
V_5 -> V_60 = F_25 ( V_31 -> V_61 ) ;
V_5 -> V_62 = V_50 >> V_5 -> V_60 ;
V_5 -> V_63 = V_64 - V_5 -> V_60 ;
V_5 -> V_65 = V_5 -> V_60 - V_66 ;
if ( V_5 -> V_17 & V_67 )
V_5 -> V_68 = V_31 -> V_69 ;
else {
V_5 -> V_70 = F_26 ( F_19 ( V_31 -> V_71 ) ) ;
memcpy ( V_5 -> V_72 , V_31 -> V_73 , sizeof( V_5 -> V_72 ) ) ;
memcpy ( V_5 -> V_74 , V_31 -> V_75 , sizeof( V_5 -> V_72 ) ) ;
}
V_5 -> V_76 = V_31 -> V_56 ;
V_5 -> V_77 = V_31 -> V_55 ;
V_23:
...
V_5 -> V_25 = V_25 ;
if ( V_25 == V_29 ) {
V_31 -> V_71 = F_22 ( F_28 ( V_5 -> log -> V_82 -> V_83 ) ) ;
V_31 -> V_84 = F_22 ( V_5 -> log -> V_85 ) ;
} else if ( V_25 == V_26 ) {
if ( V_31 -> V_51 & F_22 ( V_86 ) )
V_31 -> V_51 |= F_22 ( V_87 ) ;
}
F_29 ( V_33 ) ;
F_30 ( V_33 ) ;
...
int F_18 ( struct V_1 * V_2 , struct V_32 * * V_88 )
{
* V_88 = F_31 ( V_2 , V_89 >> V_2 -> V_90 ) ;
if ( * V_88 )
return 0 ;
* V_88 = F_31 ( V_2 , V_91 >> V_2 -> V_90 ) ;
if ( * V_88 )
return 0 ;
return - V_13 ;
}
...
{
struct V_92 * log = F_2 ( V_2 ) -> log ;
struct V_93 V_93 ;
V_93 . V_94 = 0 ;
V_93 . V_95 = 0 ;
V_93 . type = F_32 ( V_96 ) ;
V_93 . V_97 = 0 ;
V_93 . V_98 = F_22 ( F_28 ( V_2 -> V_99 -> V_83 ) ) ;
F_33 ( log , NULL , & V_93 , NULL ) ;
return 0 ;
}
