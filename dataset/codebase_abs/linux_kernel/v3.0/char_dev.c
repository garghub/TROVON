...
return V_15 ;
V_15 = - V_51 ;
V_44 -> V_54 = F_39 ( V_40 -> V_37 ) ;
if ( ! V_44 -> V_54 )
goto V_55;
if ( V_44 -> V_54 -> V_56 ) {
V_15 = V_44 -> V_54 -> V_56 ( V_42 , V_44 ) ;
if ( V_15 )
goto V_55;
}
return 0 ;
...
static struct V_39 * F_44 ( T_2 V_30 , int * V_57 , void * V_58 )
{
struct V_33 * V_40 = V_58 ;
return & V_40 -> V_38 ;
}
static int F_45 ( T_2 V_30 , void * V_58 )
{
struct V_33 * V_40 = V_58 ;
...
V_40 -> V_30 = V_30 ;
V_40 -> V_26 = V_26 ;
return F_46 ( V_49 , V_30 , V_26 , NULL , F_44 , F_45 , V_40 ) ;
}
static void F_47 ( T_2 V_30 , unsigned V_26 )
{
F_48 ( V_49 , V_30 , V_26 ) ;
}
void F_27 ( struct V_33 * V_40 )
{
F_47 ( V_40 -> V_30 , V_40 -> V_26 ) ;
F_24 ( & V_40 -> V_38 ) ;
}
static void F_49 ( struct V_39 * V_38 )
{
...
void F_53 ( struct V_33 * V_33 , const struct V_31 * V_32 )
{
...
static struct V_39 * F_54 ( T_2 V_30 , int * V_57 , void * V_58 )
{
if ( F_55 ( L_3 , F_15 ( V_30 ) , F_16 ( V_30 ) ) > 0 )
F_55 ( L_4 , F_15 ( V_30 ) ) ;
return NULL ;
}
void T_3 F_56 ( void )
