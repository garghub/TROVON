...
static T_2 F_23 ( int V_15 , void * V_21 )
{
int V_1 = F_2 () ;
F_8 ( V_1 , 0xff ) ;
return F_24 () ;
}
static int T_3 F_25 ( int V_22 , unsigned long V_23 ,
unsigned long V_24 )
{
char * V_25 ;
int V_26 , V_1 = - 1 ;
...
V_25 = F_29 ( V_27 , L_1 ,
V_1 , V_22 ) ;
if ( ! F_30 ( V_23 , V_24 , V_25 ) ) {
F_31 ( L_2
L_3 ,
V_1 , V_22 ) ;
return - V_28 ;
}
V_2 [ V_1 ] = F_32 ( V_23 , V_24 ) ;
if ( ! V_2 [ V_1 ] ) {
F_31 ( L_4
L_5 ,
V_1 , V_22 , V_23 ) ;
...
static int T_3 F_34 ( struct V_30 * V_31 ,
unsigned int * V_32 )
{
unsigned int V_33 ;
const T_4 * V_34 ;
...
int V_35 ;
int V_36 = 0 ;
V_34 = F_35 ( V_31 , L_6 , & V_33 ) ;
F_36 ( ( V_34 == NULL ) || ( V_33 != 2 * sizeof( T_4 ) ) ) ;
if ( V_34 ) {
* V_32 = F_37 ( V_34 , 1 ) ;
if ( V_33 >= 2 * sizeof( T_4 ) )
V_36 = F_37 ( V_34 + 1 , 1 ) ;
}
V_34 = F_35 ( V_31 , L_7 , & V_33 ) ;
if ( ! V_34 ) {
F_38 ( L_8 ) ;
return - 1 ;
}
V_35 = ( F_39 ( V_31 ) + F_40 ( V_31 ) ) * 4 ;
if ( ( ( V_33 % V_35 ) != 0 )
|| ( V_36 && ( V_36 != ( V_33 / V_35 ) ) ) ) {
F_38 ( L_9 ,
V_33 / V_35 , V_36 ) ;
...
struct V_37 V_38 ;
int V_39 ;
V_39 = F_41 ( V_31 , V_26 , & V_38 ) ;
if ( V_39 ) {
F_38 ( L_10
L_11 , * V_32 , V_39 ) ;
return - 1 ;
}
if ( F_25 ( * V_32 , V_38 . V_40 , V_38 . V_41 - V_38 . V_40 ) )
return - 1 ;
( * V_32 ) ++ ;
}
return 0 ;
