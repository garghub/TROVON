...
struct V_18 * V_19 = F_14 ( V_16 ) ;
int V_20 = V_19 -> V_21 ;
unsigned long V_1 = F_19 ( V_17 , NULL , 10 ) ;
F_20 ( & V_9 -> V_26 ) ;
...
struct V_18 * V_19 = F_14 ( V_16 ) ;
int V_20 = V_19 -> V_21 ;
return sprintf ( V_17 , L_1 , F_6 ( V_9 -> V_27 [ V_20 ] ) ) ;
}
...
struct V_18 * V_19 = F_14 ( V_16 ) ;
int V_20 = V_19 -> V_21 ;
return sprintf ( V_17 , L_1 , F_7 ( V_9 -> V_28 [ V_20 ] ) ) ;
}
...
struct V_18 * V_19 = F_14 ( V_16 ) ;
int V_20 = V_19 -> V_21 ;
int V_1 = F_29 ( V_17 , NULL , 10 ) ;
F_20 ( & V_9 -> V_26 ) ;
V_9 -> V_28 [ V_20 ] = F_5 ( V_1 ) ;
F_10 ( V_9 , V_30 [ V_20 ] ,
V_9 -> V_28 [ V_20 ] ) ;
F_22 ( & V_9 -> V_26 ) ;
return V_25 ;
...
struct V_18 * V_19 = F_14 ( V_16 ) ;
int V_20 = V_19 -> V_21 ;
return sprintf ( V_17 , L_2 , F_32 ( V_9 -> V_32 [ V_20 ] ,
F_33 ( V_9 -> V_33 [ V_20 ] ) ) ) ;
}
...
F_32 ( V_9 -> V_34 [ V_20 ] , F_33 ( V_9 -> V_33 [ V_20 ] ) ) ) ;
}
...
struct V_18 * V_19 = F_14 ( V_16 ) ;
int V_20 = V_19 -> V_21 ;
return sprintf ( V_17 , L_2 , F_33 ( V_9 -> V_33 [ V_20 ] ) ) ;
}
...
int V_1 = F_29 ( V_17 , NULL , 10 ) ;
F_20 ( & V_9 -> V_26 ) ;
V_9 -> V_34 [ V_20 ] = F_4 ( V_1 , F_33 ( V_9 -> V_33 [ V_20 ] ) ) ;
F_10 ( V_9 , F_37 ( V_20 + 1 ) , V_9 -> V_34 [ V_20 ] ) ;
F_22 ( & V_9 -> V_26 ) ;
return V_25 ;
}
...
F_20 ( & V_9 -> V_26 ) ;
V_35 = F_8 ( V_9 , V_36 ) ;
V_9 -> V_33 [ V_20 ] = F_39 ( V_1 ) ;
V_35 = ( V_35 & 0x0f ) | ( V_9 -> V_33 [ 1 ] << 6 ) | ( V_9 -> V_33 [ 0 ] << 4 ) ;
F_10 ( V_9 , V_36 , V_35 ) ;
F_22 ( & V_9 -> V_26 ) ;
return V_25 ;
}
static T_3 F_40 ( struct V_13 * V_14 , struct V_15 * V_19 , char * V_17 ) {
struct V_8 * V_9 = F_13 ( V_14 ) ;
return sprintf ( V_17 , L_3 , V_9 -> V_37 ) ;
}
static T_3 F_41 ( struct V_13 * V_14 , struct V_15 * V_19 ,
char * V_17 )
{
int V_38 = F_14 ( V_19 ) -> V_21 ;
struct V_8 * V_9 = F_13 ( V_14 ) ;
return sprintf ( V_17 , L_3 , ( V_9 -> V_37 >> V_38 ) & 1 ) ;
}
static T_3 F_42 ( struct V_13 * V_14 , struct V_15
* V_39 , char * V_17 )
{
struct V_8 * V_9 = F_18 ( V_14 ) ;
return sprintf ( V_17 , L_4 , V_9 -> V_40 ) ;
}
static int T_5 F_43 ( struct V_41 * V_42 )
{
struct V_8 * V_9 ;
struct V_43 * V_44 ;
int V_45 ;
V_44 = F_44 ( V_42 , V_46 , 0 ) ;
if ( ! F_45 ( V_44 -> V_47 , V_48 ,
V_49 . V_50 . V_40 ) ) {
F_46 ( & V_42 -> V_14 , L_5 ,
( unsigned long ) V_44 -> V_47 , ( unsigned long ) V_44 -> V_51 ) ;
return - V_52 ;
}
if ( ! ( V_9 = F_47 ( sizeof( struct V_8 ) , V_53 ) ) ) {
V_45 = - V_54 ;
goto V_55;
}
F_48 ( V_42 , V_9 ) ;
...
F_49 ( & V_9 -> V_26 ) ;
F_50 ( V_9 ) ;
if ( ( V_45 = F_51 ( & V_42 -> V_14 . V_56 , & V_57 ) ) )
goto V_58;
V_9 -> V_59 = F_52 ( & V_42 -> V_14 ) ;
if ( F_53 ( V_9 -> V_59 ) ) {
V_45 = F_54 ( V_9 -> V_59 ) ;
goto V_60;
}
...
static int T_6 F_58 ( struct V_41 * V_42 )
{
struct V_8 * V_9 = F_59 ( V_42 ) ;
F_60 ( V_9 -> V_59 ) ;
F_55 ( & V_42 -> V_14 . V_56 , & V_57 ) ;
F_57 ( V_9 -> V_11 , V_48 ) ;
F_48 ( V_42 , NULL ) ;
...
{
int V_10 = F_8 ( V_9 , V_36 ) ;
V_9 -> V_33 [ 0 ] = ( V_10 >> 4 ) & 0x03 ;
V_9 -> V_33 [ 1 ] = V_10 >> 6 ;
}
...
V_9 -> V_32 [ V_65 - 1 ] =
F_8 ( V_9 , F_64 ( V_65 ) ) ;
V_9 -> V_34 [ V_65 - 1 ] = F_8 ( V_9 ,
F_37 ( V_65 ) ) ;
}
for ( V_65 = 0 ; V_65 <= 2 ; V_65 ++ ) {
V_9 -> V_27 [ V_65 ] = F_8 ( V_9 ,
V_70 [ V_65 ] ) << 2 ;
V_9 -> V_28 [ V_65 ] =
F_8 ( V_9 ,
V_30 [ V_65 ] ) ;
