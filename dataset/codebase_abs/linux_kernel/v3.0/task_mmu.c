...
if ( V_87 > V_158 -> V_165 )
V_158 -> V_165 = V_87 ;
V_158 -> V_166 [ F_102 ( V_97 ) ] ++ ;
}
static int F_103 ( T_4 * V_107 , unsigned long V_91 ,
unsigned long V_67 , struct V_93 * V_94 )
{
struct V_157 * V_158 ;
T_5 * V_109 ;
...
V_24 * V_108 ;
V_158 = V_94 -> V_40 ;
V_167 = V_108 = F_55 ( V_94 -> V_4 , V_107 , V_91 , & V_109 ) ;
do {
struct V_97 * V_97 ;
int V_168 ;
if ( ! F_41 ( * V_108 ) )
continue;
V_97 = F_42 ( V_158 -> V_35 , V_91 , * V_108 ) ;
if ( ! V_97 )
continue;
if ( F_104 ( V_97 ) )
continue;
...
continue;
F_97 ( V_97 , V_158 , F_47 ( * V_108 ) ) ;
} while ( V_108 ++ , V_91 += V_26 , V_91 != V_67 );
F_56 ( V_167 , V_109 ) ;
return 0 ;
}
static int F_106 ( V_24 * V_108 , unsigned long V_141 ,
...
static int F_109 ( struct V_1 * V_2 , void * V_52 )
{
struct V_171 * V_172 = V_2 -> V_40 ;
struct V_32 * V_173 = & V_172 -> V_174 ;
struct V_34 * V_35 = V_52 ;
struct V_157 * V_158 = & V_172 -> V_158 ;
struct V_54 * V_54 = V_35 -> V_61 ;
struct V_3 * V_4 = V_35 -> V_37 ;
struct V_93 V_94 = {} ;
struct V_175 * V_176 ;
...
V_94 . V_40 = V_158 ;
V_94 . V_4 = V_4 ;
V_176 = F_110 ( V_173 -> V_44 , V_35 , V_35 -> V_76 ) ;
F_111 ( V_120 , sizeof( V_120 ) , V_176 , 0 ) ;
F_112 ( V_176 ) ;
...
goto V_49;
if ( V_158 -> V_164 )
F_5 ( V_2 , L_37 , V_158 -> V_164 ) ;
if ( V_158 -> V_160 )
F_5 ( V_2 , L_38 , V_158 -> V_160 ) ;
if ( V_158 -> V_159 != V_158 -> V_164 && V_158 -> V_159 != V_158 -> V_160 )
F_5 ( V_2 , L_39 , V_158 -> V_159 ) ;
if ( V_158 -> V_165 > 1 )
F_5 ( V_2 , L_40 , V_158 -> V_165 ) ;
if ( V_158 -> V_161 )
F_5 ( V_2 , L_41 , V_158 -> V_161 ) ;
if ( V_158 -> V_162 < V_158 -> V_159 && ! F_59 ( V_35 ) )
F_5 ( V_2 , L_42 , V_158 -> V_162 ) ;
if ( V_158 -> V_163 )
F_5 ( V_2 , L_43 , V_158 -> V_163 ) ;
F_113 (n, N_HIGH_MEMORY)
if ( V_158 -> V_166 [ V_177 ] )
F_5 ( V_2 , L_44 , V_177 , V_158 -> V_166 [ V_177 ] ) ;
V_49:
F_36 ( V_2 , '\n' ) ;
if ( V_2 -> V_87 < V_2 -> V_88 )
V_2 -> V_42 = ( V_35 != V_173 -> V_36 ) ? V_35 -> V_76 : 0 ;
return 0 ;
}
static int F_114 ( struct V_53 * V_53 , struct V_54 * V_54 )
{
struct V_171 * V_33 ;
int V_57 = - V_58 ;
V_33 = F_24 ( sizeof( * V_33 ) , V_59 ) ;
if ( V_33 ) {
V_33 -> V_174 . V_45 = F_25 ( V_53 ) ;
V_57 = F_26 ( V_54 , & V_178 ) ;
if ( ! V_57 ) {
struct V_1 * V_2 = V_54 -> V_60 ;
V_2 -> V_40 = V_33 ;
} else {
