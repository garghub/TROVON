...
V_27 -> V_31 = V_4 -> V_31 ;
F_7 ( L_10 ) ;
V_27 -> V_32 = F_20 ( F_21 ( V_2 ) , & V_4 -> V_12 ) ;
F_7 ( L_11 , F_10 ( V_27 -> V_32 ) ) ;
return V_28 ;
}
static void F_22 ( struct V_38 * V_39 , void * V_40 )
{
F_7 ( L_12 , V_39 -> V_41 ,
- V_39 -> V_42 ) ;
}
static void F_23 ( void * V_40 )
{
F_24 ( V_40 ) ;
}
static T_1 F_25 ( struct V_1 * V_2 , T_2 V_43 , struct V_3 * V_4 ,
T_1 (* F_26)( struct V_1 * , struct V_3 * , struct V_29 * ) )
{
struct V_5 * V_9 ;
struct V_44 * V_45 ;
T_1 V_46 ;
...
if ( V_45 == NULL )
return V_47 ;
V_46 = F_26 ( V_2 , V_4 , & V_45 -> V_48 ) ;
if ( V_46 != 0 ) {
F_24 ( V_45 ) ;
return V_46 ;
}
V_45 -> V_49 = V_50 ;
if ( F_28 ( V_45 , V_43 , & V_51 ) < 0 )
return V_47 ;
return V_28 ;
}
...
static T_1
F_41 ( struct V_1 * V_2 , struct V_57 * V_4 ,
void * V_27 )
{
F_7 ( L_23 ) ;
if ( ! F_42 ( V_2 ) ) {
...
static T_1
F_46 ( struct V_1 * V_2 , struct V_29 * V_4 ,
void * V_27 )
{
if ( ! V_13 )
return V_28 ;
F_7 ( L_25 ) ;
F_47 ( & V_4 -> V_31 , V_4 -> V_32 ) ;
return V_28 ;
}
