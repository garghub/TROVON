...
if ( ! V_51 [ V_45 ] )
return - V_52 ;
V_36 = F_32 ( V_53 [ V_45 ] , L_13 , V_54 , 0 , & V_44 ) ;
if ( V_36 < 0 ) {
F_33 ( V_55 L_14 , V_45 ) ;
return V_36 ;
}
...
sprintf ( V_46 , L_18 ,
F_34 ( V_42 -> V_59 -> V_63 . V_64 ) ,
F_34 ( V_42 -> V_59 -> V_63 . V_65 ) ) ;
F_35 ( V_44 , V_46 ) ;
F_36 ( V_44 , & V_42 -> V_59 -> V_42 ) ;
V_2 = F_37 ( sizeof( struct V_1 ) , V_66 ) ;
if ( ! V_2 ) {
V_36 = - V_12 ;
goto error;
}
...
V_42 -> V_22 = V_2 ;
F_38 ( & V_2 -> V_67 ) ;
V_36 = F_39 ( V_44 , L_19 , 0 , 0 , 1 , & V_48 ) ;
if ( V_36 < 0 )
goto V_68;
V_48 -> V_69 = 0 ;
V_48 -> V_70 = V_2 ;
...
static int F_45 ( struct V_3 * V_42 )
{
