...
if ( V_36 < 0 || V_36 > V_27 -> V_21 ) {
F_9 ( & V_30 ) ;
return - V_38 ;
}
F_9 ( & V_30 ) ;
return ( V_24 -> V_37 = V_36 ) ;
}
static T_2 F_11 ( struct V_24 * V_24 , char T_3 * V_3 ,
T_4 V_39 , T_1 * V_40 )
{
struct V_26 * V_27 = V_24 -> V_33 ;
return F_12 ( V_3 , V_39 , V_40 , V_27 -> V_20 , V_27 -> V_21 ) ;
}
static int F_13 ( struct V_23 * V_23 , struct V_24 * V_24 )
{
struct V_26 * V_27 = V_24 -> V_33 ;
F_8 ( V_27 -> V_20 ) ;
F_8 ( V_27 ) ;
...
{
V_2 -> V_42 = F_19 ( F_20 ( & V_2 -> V_43 -> V_44 ) ,
V_45 , V_41 , V_2 , & V_46 ) ;
}
