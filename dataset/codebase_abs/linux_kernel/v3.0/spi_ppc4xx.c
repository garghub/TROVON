...
static int T_4 F_27 ( struct V_73 * V_74 )
{
struct V_5 * V_6 ;
struct V_75 * V_12 ;
struct V_76 * V_77 ;
...
V_41 | V_42 | V_59 | V_51 ;
V_77 -> V_12 -> V_56 = V_85 ;
V_83 = F_36 ( NULL , NULL , L_12 ) ;
if ( V_83 == NULL ) {
F_8 ( V_8 , L_13 ) ;
V_84 = - V_100 ;
goto F_24;
}
V_86 = F_37 ( V_83 , L_14 , NULL ) ;
if ( V_86 == NULL ) {
F_8 ( V_8 , L_15 ) ;
F_38 ( V_83 ) ;
V_84 = - V_100 ;
...
V_6 -> V_32 >>= 2 ;
F_38 ( V_83 ) ;
V_84 = F_39 ( V_80 , 0 , & V_78 ) ;
if ( V_84 ) {
F_8 ( V_8 , L_16 ) ;
goto F_24;
}
V_6 -> V_101 = V_78 . V_102 ;
V_6 -> V_103 = V_78 . V_104 - V_78 . V_102 + 1 ;
if ( V_6 -> V_103 < sizeof( struct V_105 ) ) {
F_8 ( V_8 , L_17 ) ;
V_84 = - V_30 ;
goto F_24;
}
V_6 -> V_106 = F_40 ( V_80 , 0 ) ;
V_84 = F_41 ( V_6 -> V_106 , F_16 ,
V_107 , L_18 , ( void * ) V_6 ) ;
if ( V_84 ) {
F_8 ( V_8 , L_19 ) ;
goto F_24;
}
if ( ! F_42 ( V_6 -> V_101 , V_6 -> V_103 , V_108 ) ) {
F_8 ( V_8 , L_20 ) ;
V_84 = - V_109 ;
goto V_110;
}
V_6 -> V_16 = F_43 ( V_6 -> V_101 , sizeof( struct V_105 ) ) ;
if ( ! V_6 -> V_16 ) {
F_8 ( V_8 , L_21 ) ;
V_84 = - V_111 ;
goto V_112;
...
static int T_5 F_50 ( struct V_73 * V_74 )
{
struct V_75 * V_12 = F_51 ( & V_74 -> V_8 ) ;
