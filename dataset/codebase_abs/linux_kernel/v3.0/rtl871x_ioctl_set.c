...
T_1 V_40 = true ;
struct V_12 * V_13 = & V_7 -> V_14 ;
if ( ( V_38 [ 0 ] == 0x00 && V_38 [ 1 ] == 0x00 && V_38 [ 2 ] == 0x00 &&
V_38 [ 3 ] == 0x00 && V_38 [ 4 ] == 0x00 && V_38 [ 5 ] == 0x00 ) ||
( V_38 [ 0 ] == 0xFF && V_38 [ 1 ] == 0xFF && V_38 [ 2 ] == 0xFF &&
V_38 [ 3 ] == 0xFF && V_38 [ 4 ] == 0xFF && V_38 [ 5 ] == 0xFF ) ) {
V_40 = false ;
return V_40 ;
}
F_14 ( & V_13 -> V_41 , V_39 ) ;
