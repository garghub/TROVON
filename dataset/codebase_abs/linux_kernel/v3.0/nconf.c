...
{
struct V_57 V_137 = F_95 () ;
if ( V_15 && V_15 -> V_64 && F_96 ( V_15 ) ) {
if ( V_15 -> V_64 -> V_138 ) {
F_97 ( & V_137 , L_45 , V_62 , V_15 -> V_64 -> V_138 ) ;
F_98 ( & V_137 , _ ( F_99 ( V_15 ) ) ) ;
F_98 ( & V_137 , L_46 ) ;
F_100 ( & V_137 , V_15 -> V_64 ) ;
} else {
F_98 ( & V_137 , _ ( F_99 ( V_15 ) ) ) ;
}
} else {
...
if ( V_5 != NULL )
F_104 ( V_5 ) ;
V_5 = F_105 ( V_8 - 2 , V_103 - 2 , 2 , 1 ) ;
F_76 ( V_5 , TRUE ) ;
V_97 = V_8 - 7 ;
V_107 = V_103 - 6 ;
F_106 ( V_5 ) ;
}
int main ( int V_153 , char * * V_154 )
{
char * V_155 ;
setlocale ( V_156 , L_22 ) ;
F_107 ( V_157 , V_158 ) ;
F_108 ( V_157 ) ;
F_109 ( V_154 [ 1 ] ) ;
F_102 ( NULL ) ;
...
F_119 ( V_29 , V_164 ) ;
F_120 ( V_29 , L_62 ) ;
F_121 ( V_29 , V_6 [ V_165 ] ) ;
F_122 ( V_29 , V_6 [ V_166 ] ) ;
F_123 ( V_29 , V_6 [ V_167 ] ) ;
F_40 ( F_124 () ) ;
F_21 () ;
if ( F_125 ( F_22 ( 1 ) ) == FALSE ) {
F_5 ( V_5 ,
_ ( L_3 ) ,
_ ( V_168 ) ) ;
}
