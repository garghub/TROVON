...
unsigned long V_12 ;
F_2 ( V_12 ) ;
V_56 = F_11 ( V_30 + 1 , V_42 ) ;
if ( ! V_56 ) {
F_5 ( V_12 ) ;
return - V_43 ;
}
memcpy ( V_56 , V_5 , V_30 + 1 ) ;
if ( strchr ( L_20 , * V_56 ) ) {
F_18 ( V_57 , V_51 ) ;
F_7 ( L_24 ) ;
F_12 ( V_56 ) ;
...
F_2 ( V_12 ) ;
if ( * V_87 == 'd' || * V_87 == 'r' )
V_86 = F_36 ( 0 , V_79 -> V_85 , 3 ) ;
else
V_86 = F_36 ( V_87 , V_79 -> V_85 , 3 ) ;
F_5 ( V_12 ) ;
return V_30 ;
}
T_1 F_37 ( struct V_1 * V_2 , struct V_3 * V_4 ,
char * V_5 )
{
int V_66 = 0 ;
struct V_76 * V_88 ;
