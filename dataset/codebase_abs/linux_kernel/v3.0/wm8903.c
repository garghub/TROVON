...
static T_4 int F_61 ( struct V_256 * V_257 ,
const struct V_258 * V_259 )
{
struct V_20 * V_21 ;
int V_48 ;
V_21 = F_62 ( sizeof( struct V_20 ) , V_199 ) ;
if ( V_21 == NULL )
return - V_260 ;
F_63 ( V_257 , V_21 ) ;
V_21 -> V_184 = V_257 -> V_184 ;
V_48 = F_64 ( & V_257 -> V_34 ,
& V_261 , & V_262 , 1 ) ;
if ( V_48 < 0 )
F_42 ( V_21 ) ;
return V_48 ;
}
static T_5 int F_65 ( struct V_256 * V_263 )
{
F_66 ( & V_263 -> V_34 ) ;
F_42 ( F_67 ( V_263 ) ) ;
return 0 ;
