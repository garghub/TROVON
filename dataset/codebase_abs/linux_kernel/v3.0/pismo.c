...
static unsigned int T_1 F_4 ( unsigned int V_12 )
{
V_12 &= 15 ;
if ( V_12 > 2 )
return 0 ;
...
static int T_1 F_5 ( struct V_4 * V_5 , void * V_13 ,
T_2 V_14 , T_3 V_15 )
{
int V_16 ;
struct V_17 V_18 [] = {
...
static int T_1 F_8 ( struct V_8 * V_9 , int V_24 ,
struct V_25 * V_26 , const char * V_27 , void * V_28 , T_3 V_29 )
{
struct V_1 * V_6 ;
struct V_30 V_31 = { } ;
T_4 V_32 = V_26 -> V_32 ;
...
static int T_1 F_14 ( struct V_8 * V_9 , int V_24 ,
struct V_25 * V_26 )
{
struct V_38 V_39 = {
. V_12 = V_26 -> V_12 ,
...
static int T_1 F_15 ( struct V_8 * V_9 , int V_24 ,
struct V_25 * V_26 )
{
struct V_41 V_39 = {
. V_42 = V_26 -> V_12 ,
...
static void T_1 F_16 ( struct V_8 * V_9 , int V_24 ,
const struct V_43 * V_44 , T_4 V_32 )
{
...
static int T_1 F_24 ( struct V_4 * V_5 ,
