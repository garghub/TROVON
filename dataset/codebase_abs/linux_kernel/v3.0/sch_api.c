...
if ( V_83 == NULL )
goto V_85;
F_37 ( V_82 , V_72 , sizeof( V_67 -> V_75 ) , & V_67 -> V_75 ) ;
F_38 ( V_82 , V_83 ) ;
return V_82 -> V_86 ;
V_85:
return - 1 ;
...
} while ( F_12 ( V_41 , V_126 ) && -- V_108 > 0 );
return V_108 > 0 ? V_126 : 0 ;
}
...
V_161 = F_105 ( V_111 ) ;
V_28 = F_108 ( & V_111 -> V_163 , & V_111 -> V_164 ,
V_161 , V_146 [ V_160 ] ) ;
if ( V_28 )
goto V_159;
}
...
V_167 = F_110 ( V_111 -> V_67 ) ;
F_106 ( V_111 -> V_67 , V_67 ) ;
F_33 ( V_167 ) ;
if ( V_146 [ V_160 ] ) {
if ( V_111 -> V_33 & V_162 )
goto V_11;
F_112 ( & V_111 -> V_163 , & V_111 -> V_164 ,
F_107 ( V_111 ) ,
V_146 [ V_160 ] ) ;
}
V_11:
...
static int F_113 ( struct V_30 * V_3 , struct V_30 * V_43 , int V_169 )
{
struct V_170 V_171 ;
...
return - V_178 ;
return F_113 ( V_23 , V_171 -> V_43 , V_171 -> V_169 + 1 ) ;
}
return 0 ;
}
static int F_114 ( struct V_81 * V_82 , struct V_132 * V_106 , void * V_171 )
{
struct V_131 * V_131 = F_115 ( V_82 -> V_180 ) ;
struct V_181 * V_182 = F_116 ( V_106 ) ;
...
int V_28 ;
V_41 = F_117 ( V_131 , V_182 -> V_185 ) ;
if ( ! V_41 )
return - V_186 ;
V_28 = F_118 ( V_106 , sizeof( * V_182 ) , V_146 , V_183 , NULL ) ;
if ( V_28 < 0 )
return V_28 ;
if ( V_133 ) {
if ( V_133 != V_36 ) {
...
static int F_119 ( struct V_81 * V_82 , struct V_132 * V_106 , void * V_171 )
{
struct V_131 * V_131 = F_115 ( V_82 -> V_180 ) ;
struct V_181 * V_182 ;
struct V_47 * V_146 [ V_183 + 1 ] ;
...
static int F_122 ( struct V_81 * V_82 , struct V_30 * V_3 , T_1 V_133 ,
T_1 V_197 , T_1 V_198 , T_2 V_33 , int V_199 )
{
struct V_181 * V_182 ;
struct V_132 * V_200 ;
unsigned char * V_201 = F_123 ( V_82 ) ;
struct V_202 V_203 ;
struct V_63 * V_67 ;
V_200 = F_124 ( V_82 , V_197 , V_198 , V_199 , sizeof( * V_182 ) , V_33 ) ;
V_182 = F_116 ( V_200 ) ;
V_182 -> V_204 = V_205 ;
V_182 -> V_206 = 0 ;
V_182 -> V_207 = 0 ;
...
V_182 -> V_209 = F_125 ( & V_3 -> V_57 ) ;
F_126 ( V_82 , V_148 , V_3 -> V_46 -> V_10 ) ;
...
goto V_85;
if ( F_127 ( V_82 , V_212 , V_213 , V_214 ,
F_107 ( V_3 ) , & V_203 ) < 0 )
goto V_85;
if ( V_3 -> V_46 -> V_215 && V_3 -> V_46 -> V_215 ( V_3 , & V_203 ) < 0 )
goto V_85;
if ( F_128 ( & V_203 , & V_3 -> V_163 ) < 0 ||
F_129 ( & V_203 , & V_3 -> V_163 , & V_3 -> V_164 ) < 0 ||
F_130 ( & V_203 , & V_3 -> V_211 ) < 0 )
goto V_85;
if ( F_131 ( & V_203 ) < 0 )
goto V_85;
V_200 -> V_216 = F_123 ( V_82 ) - V_201 ;
return V_82 -> V_86 ;
V_217:
V_85:
F_132 ( V_82 , V_201 ) ;
...
static bool F_133 ( struct V_30 * V_3 )
{
return ( V_3 -> V_33 & V_34 ) ? true : false ;
}
static int F_85 ( struct V_131 * V_131 , struct V_81 * V_218 ,
struct V_132 * V_106 , T_1 V_133 ,
struct V_30 * V_134 , struct V_30 * V_135 )
{
struct V_81 * V_82 ;
T_1 V_197 = V_218 ? F_134 ( V_218 ) . V_197 : 0 ;
V_82 = F_135 ( V_219 , V_60 ) ;
if ( ! V_82 )
return - V_220 ;
if ( V_134 && ! F_133 ( V_134 ) ) {
if ( F_122 ( V_82 , V_134 , V_133 , V_197 , V_106 -> V_221 ,
0 , V_189 ) < 0 )
goto V_152;
}
if ( V_135 && ! F_133 ( V_135 ) ) {
if ( F_122 ( V_82 , V_135 , V_133 , V_197 , V_106 -> V_221 ,
V_134 ? V_192 : 0 , V_222 ) < 0 )
goto V_152;
}
if ( V_82 -> V_86 )
return F_136 ( V_82 , V_131 , V_197 , V_223 ,
V_106 -> V_191 & V_224 ) ;
V_152:
F_137 ( V_82 ) ;
return - V_27 ;
}
static int F_138 ( struct V_30 * V_31 , struct V_81 * V_82 ,
struct V_225 * V_226 ,
int * V_227 , int V_228 )
{
...
if ( ! F_133 ( V_3 ) &&
F_122 ( V_82 , V_3 , V_3 -> V_35 , F_134 ( V_226 -> V_82 ) . V_197 ,
...
static int F_139 ( struct V_81 * V_82 , struct V_225 * V_226 )
{
struct V_131 * V_131 = F_115 ( V_82 -> V_180 ) ;
int V_233 , V_230 ;
int V_234 , V_228 ;
...
V_228 = 0 ;
V_230 = 0 ;
if ( F_138 ( V_41 -> V_39 , V_82 , V_226 , & V_230 , V_228 ) < 0 )
goto V_232;
V_142 = F_13 ( V_41 ) ;
if ( V_142 &&
F_138 ( V_142 -> V_42 , V_82 , V_226 ,
& V_230 , V_228 ) < 0 )
goto V_232;
V_235:
V_233 ++ ;
...
static int F_143 ( struct V_81 * V_82 , struct V_132 * V_106 , void * V_171 )
{
struct V_131 * V_131 = F_115 ( V_82 -> V_180 ) ;
struct V_181 * V_182 = F_116 ( V_106 ) ;
struct V_47 * V_146 [ V_183 + 1 ] ;
...
if ( V_28 == 0 )
F_144 ( V_131 , V_82 , V_106 , V_3 , V_45 , V_240 ) ;
goto V_11;
case V_242 :
V_28 = F_144 ( V_131 , V_82 , V_106 , V_3 , V_45 , V_239 ) ;
goto V_11;
default:
V_28 = - V_27 ;
goto V_11;
...
if ( V_28 == 0 )
F_144 ( V_131 , V_82 , V_106 , V_3 , V_236 , V_239 ) ;
V_11:
if ( V_45 )
V_19 -> V_21 ( V_3 , V_45 ) ;
return V_28 ;
}
static int F_145 ( struct V_81 * V_82 , struct V_30 * V_3 ,
unsigned long V_45 ,
T_1 V_197 , T_1 V_198 , T_2 V_33 , int V_199 )
{
struct V_181 * V_182 ;
...
static int F_144 ( struct V_131 * V_131 , struct V_81 * V_218 ,
...
if ( ! V_82 )
return - V_220 ;
if ( F_145 ( V_82 , V_3 , V_45 , V_197 , V_106 -> V_221 , 0 , V_199 ) < 0 ) {
F_137 ( V_82 ) ;
return - V_27 ;
}
return F_136 ( V_82 , V_131 , V_197 , V_223 ,
...
static int F_146 ( struct V_30 * V_3 , unsigned long V_45 , struct V_179 * V_171 )
{
struct V_243 * V_244 = (struct V_243 * ) V_171 ;
return F_145 ( V_244 -> V_82 , V_3 , V_45 , F_134 ( V_244 -> V_226 -> V_82 ) . V_197 ,
V_244 -> V_226 -> V_200 -> V_221 , V_231 , V_239 ) ;
}
static int F_147 ( struct V_30 * V_3 , struct V_81 * V_82 ,
...
static int F_148 ( struct V_30 * V_31 , struct V_81 * V_82 ,
struct V_181 * V_182 , struct V_225 * V_226 ,
int * V_245 , int V_246 )
{
struct V_30 * V_3 ;
if ( ! V_31 )
return 0 ;
if ( F_147 ( V_31 , V_82 , V_182 , V_226 , V_245 , V_246 ) < 0 )
return - 1 ;
F_6 (q, &root->list, list) {
if ( F_147 ( V_3 , V_82 , V_182 , V_226 , V_245 , V_246 ) < 0 )
return - 1 ;
}
return 0 ;
}
static int F_149 ( struct V_81 * V_82 , struct V_225 * V_226 )
{
struct V_181 * V_182 = (struct V_181 * ) F_116 ( V_226 -> V_200 ) ;
struct V_131 * V_131 = F_115 ( V_82 -> V_180 ) ;
struct V_141 * V_142 ;
struct V_40 * V_41 ;
int V_247 , V_246 ;
if ( V_226 -> V_200 -> V_216 < F_150 ( sizeof( * V_182 ) ) )
return 0 ;
V_41 = F_151 ( V_131 , V_182 -> V_185 ) ;
if ( ! V_41 )
return 0 ;
V_246 = V_226 -> args [ 0 ] ;
V_247 = 0 ;
if ( F_148 ( V_41 -> V_39 , V_82 , V_182 , V_226 , & V_247 , V_246 ) < 0 )
goto V_232;
V_142 = F_13 ( V_41 ) ;
if ( V_142 &&
F_148 ( V_142 -> V_42 , V_82 , V_182 , V_226 ,
& V_247 , V_246 ) < 0 )
goto V_232;
V_232:
V_226 -> args [ 0 ] = V_247 ;
...
int F_152 ( struct V_81 * V_82 , struct V_248 * V_249 ,
struct V_250 * V_251 )
{
...
int F_156 ( struct V_81 * V_82 , struct V_248 * V_249 ,
struct V_250 * V_251 )
{
int V_28 = 0 ;
#ifdef F_154
struct V_248 * V_257 = V_249 ;
V_258:
#endif
V_28 = F_152 ( V_82 , V_249 , V_251 ) ;
#ifdef F_154
if ( V_28 == V_255 ) {
T_1 V_259 = F_157 ( V_82 -> V_256 ) ;
V_249 = V_257 ;
if ( V_259 ++ >= V_260 ) {
if ( F_158 () )
F_159 ( L_3
...
V_82 -> V_256 = F_155 ( V_82 -> V_256 , V_259 ) ;
goto V_258;
}
#endif
return V_28 ;
...
F_1 ( & V_278 ) ;
F_1 ( & V_279 ) ;
F_177 ( V_280 , V_222 , F_119 , NULL ) ;
F_177 ( V_280 , V_189 , F_114 , NULL ) ;
F_177 ( V_280 , V_281 , F_114 , F_139 ) ;
F_177 ( V_280 , V_239 , F_143 , NULL ) ;
F_177 ( V_280 , V_240 , F_143 , NULL ) ;
F_177 ( V_280 , V_242 , F_143 , F_149 ) ;
return 0 ;
}
