...
static int F_148 ( struct V_276 * V_13 , T_6 V_283 )
{
struct V_1 * V_2 = F_138 ( V_13 ) ;
F_38 ( V_2 , V_85 ) ;
F_40 ( V_2 , V_86 ) ;
...
F_151 ( V_13 , F_152 ( V_13 , V_283 ) ) ;
return 0 ;
}
static int F_153 ( struct V_276 * V_13 )
{
int V_172 ;
F_151 ( V_13 , V_285 ) ;
F_154 ( V_13 ) ;
...
static int F_156 ( struct V_276 * V_13 ,
...
if ( F_131 ( V_2 ) )
goto V_290;
if ( F_160 ( V_13 -> V_255 , F_126 , V_291 , V_289 ,
V_2 ) ) {
