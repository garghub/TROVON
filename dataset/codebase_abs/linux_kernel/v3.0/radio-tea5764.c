...
V_39 -> V_66 = V_68 ;
V_39 -> V_31 = F_13 ( V_2 ) ;
V_39 -> signal = F_21 ( V_16 -> V_64 ) * 0xffff / 0xf ;
V_39 -> V_69 = F_22 ( V_16 -> V_64 ) ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_17 ( V_36 ) ;
if ( V_71 -> V_72 != 0 || V_71 -> type != V_55 )
return - V_54 ;
if ( V_71 -> V_73 == 0 ) {
F_7 ( V_2 ) ;
}
if ( V_71 -> V_73 < ( V_57 * V_58 ) )
return - V_54 ;
if ( V_71 -> V_73 > ( V_60 * V_58 ) )
return - V_54 ;
F_6 ( V_2 ) ;
F_10 ( V_2 , ( V_71 -> V_73 * 125 ) / 2 ) ;
return 0 ;
}
...
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_27 ( V_76 ) ; V_3 ++ ) {
if ( V_75 -> V_77 && V_75 -> V_77 == V_76 [ V_3 ] . V_77 ) {
memcpy ( V_75 , & ( V_76 [ V_3 ] ) , sizeof( * V_75 ) ) ;
return 0 ;
}
}
return - V_54 ;
...
static int F_30 ( struct V_36 * V_82 , void * V_37 , unsigned int * V_3 )
{
* V_3 = 0 ;
return 0 ;
}
static int F_31 ( struct V_36 * V_82 , void * V_37 , unsigned int V_3 )
{
if ( V_3 != 0 )
return - V_54 ;
return 0 ;
...
static int T_2 F_34 ( struct V_8 * V_86 ,
const struct V_87 * V_77 )
{
struct V_1 * V_2 ;
struct V_13 * V_16 ;
int V_88 ;
F_35 ( L_5 ) ;
V_2 = F_36 ( sizeof( struct V_1 ) , V_89 ) ;
if ( ! V_2 )
return - V_90 ;
F_37 ( & V_2 -> V_91 ) ;
V_2 -> V_8 = V_86 ;
...
goto V_92;
V_16 = & V_2 -> V_5 ;
F_35 ( L_6 , V_16 -> V_93 , V_16 -> V_94 ) ;
if ( V_16 -> V_93 != V_95 ||
( V_16 -> V_94 & 0x0fff ) != V_96 ) {
F_11 ( L_7 ) ;
V_88 = - V_54 ;
goto V_92;
}
...
memcpy ( V_2 -> V_42 , & V_97 ,
sizeof( V_97 ) ) ;
F_39 ( V_86 , V_2 ) ;
F_40 ( V_2 -> V_42 , V_2 ) ;
V_2 -> V_42 -> V_98 = & V_2 -> V_91 ;
F_1 ( V_2 ) ;
F_12 ( V_2 , V_34 ) ;
F_14 ( V_2 , 1 ) ;
F_7 ( V_2 ) ;
V_88 = F_41 ( V_2 -> V_42 , V_99 , V_100 ) ;
if ( V_88 < 0 ) {
F_11 ( L_8 ) ;
goto V_101;
}
...
static int T_3 F_45 ( struct V_8 * V_86 )
{
