...
static int F_48 ( int V_95 , struct V_2 * V_2 , int V_96 )
{
struct V_4 * V_5 = V_2 -> V_13 ;
return F_49 ( V_95 , V_2 , V_96 , & V_5 -> V_97 ) ;
}
...
V_5 -> V_15 . V_103 = F_53 ( F_54 ( V_99 ) , V_5 -> V_100 ) ;
#ifdef F_55
F_56 ( & V_5 -> V_21 , F_7 ) ;
F_57 ( & V_5 -> V_29 , F_12 , ( unsigned long ) V_5 ) ;
#endif
F_58 ( & V_5 -> V_7 , & V_104 ) ;
...
{
if ( F_60 ( & V_5 -> V_7 , V_5 -> V_15 . V_103 , 1 ) )
F_61 ( V_106 L_2 ,
V_5 -> V_102 , F_54 ( V_99 ) , V_5 -> V_100 ) ;
else
F_52 ( L_3 , V_5 -> V_102 ,
F_54 ( V_99 ) , V_5 -> V_100 ) ;
}
