...
if ( V_16 -> V_14 . V_54 ) {
V_16 -> V_14 . V_54 ( V_16 -> V_14 . V_39 , V_16 ,
V_36 -> V_55 , V_34 ) ;
} else {
F_9 ( 0 , L_7 , V_3 ) ;
}
}
void F_41 ( struct V_13 * V_16 , T_6 V_56 )
{
F_9 ( 2 , L_5 , V_3 ) ;
...
static void * F_43 ( struct V_57 * V_58 , T_7 * V_59 )
{
struct V_13 * V_16 ;
T_7 V_60 = 0 ;
F_44 ( & V_1 -> V_61 ) ;
...
static void * F_47 ( struct V_57 * V_58 , void * V_62 , T_7 * V_59 )
{
++ * V_59 ;
return ( void * ) F_46 ( V_1 ) ;
}
static void F_48 ( struct V_57 * V_58 , void * V_62 )
{
F_49 ( & V_1 -> V_61 ) ;
}
static int F_50 ( struct V_57 * V_58 , void * V_62 )
{
const struct V_13 * V_16 = V_62 ;
F_13 (self->magic == IRCOMM_MAGIC, return -EINVAL; ) ;
if( V_16 -> line < 0x10 )
F_51 ( V_58 , L_10 , V_16 -> line ) ;
else
F_51 ( V_58 , L_11 , V_16 -> line - 0x10 ) ;
F_51 ( V_58 ,
L_12 ,
V_63 [ V_16 -> V_64 ] ,
V_16 -> V_65 , V_16 -> V_30 ) ;
...
static int F_53 ( struct V_69 * V_69 , struct V_70 * V_70 )
{
return F_54 ( V_70 , & V_71 ) ;
}
