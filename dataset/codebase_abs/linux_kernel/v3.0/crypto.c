...
int F_73 ( struct V_130 * V_131 )
{
struct V_7 * V_8 =
& F_47 ( V_131 -> V_132 ) -> V_8 ;
struct V_53 * V_54 =
& F_74 (
V_131 -> V_133 ) -> V_54 ;
int V_29 ;
...
static int F_75 ( char * V_136 )
{
T_3 V_137 , V_138 ;
V_137 = F_76 ( V_136 ) ;
V_138 = F_76 ( V_136 + 4 ) ;
if ( ( V_137 ^ V_139 ) == V_138 )
return 0 ;
F_10 ( V_39 , L_56
L_57 , V_137 , V_138 ,
V_139 ) ;
...
T_3 V_16 ;
V_16 = F_76 ( V_140 ) ;
for ( V_67 = 0 ; V_67 < ( ( sizeof( V_142 )
/ sizeof( struct V_143 ) ) ) ; V_67 ++ )
if ( V_16 & V_142 [ V_67 ] . V_144 ) {
V_8 -> V_16 |= V_142 [ V_67 ] . V_145 ;
} else
V_8 -> V_16 &= ~ ( V_142 [ V_67 ] . V_145 ) ;
...
static void F_78 ( char * V_140 , T_1 * V_146 )
{
T_3 V_137 , V_138 ;
F_67 ( & V_137 , ( V_147 / 2 ) ) ;
V_138 = ( V_137 ^ V_139 ) ;
...
for ( V_67 = 0 ; V_67 < ( ( sizeof( V_142 )
/ sizeof( struct V_143 ) ) ) ; V_67 ++ )
if ( V_8 -> V_16 & V_142 [ V_67 ] . V_145 )
V_16 |= V_142 [ V_67 ] . V_144 ;
V_16 |= ( ( ( ( V_20 ) V_8 -> V_128 ) << 24 ) & 0xFF000000 ) ;
F_79 ( V_16 , V_140 ) ;
( * V_146 ) = 4 ;
}
V_20 F_81 ( char * V_27 , T_1 V_148 )
{
int V_67 ;
V_20 V_149 = 0 ;
struct V_150 * V_151 =
...
for ( V_67 = 0 ; V_67 < F_82 ( V_152 ) ; V_67 ++ )
if ( strcmp ( V_27 , V_151 [ V_67 ] . V_156 ) == 0 ) {
V_149 = V_151 [ V_67 ] . V_157 ;
break;
}
}
return V_149 ;
}
int F_83 ( char * V_158 , V_20 V_157 )
{
int V_18 = 0 ;
int V_67 ;
V_158 [ 0 ] = '\0' ;
for ( V_67 = 0 ; V_67 < F_82 ( V_152 ) ; V_67 ++ )
if ( V_157 == V_152 [ V_67 ] . V_157 )
strcpy ( V_158 , V_152 [ V_67 ] . V_156 ) ;
if ( V_158 [ 0 ] == '\0' ) {
F_10 ( V_42 , L_61
L_62 , V_157 ) ;
V_18 = - V_80 ;
...
{
V_20 V_159 [ V_160 ] ;
V_20 * V_161 = V_159 + V_162 ;
int V_18 ;
V_18 = F_56 ( V_159 , 0 , V_160 ,
V_88 ) ;
if ( V_18 < V_160 )
...
static int F_88 ( char * V_140 , T_1 V_166 ,
T_1 * V_65 ,
struct V_7 * V_8 ,
struct V_130 * V_131 )
{
...
static int
F_90 ( struct V_130 * V_131 ,
char * V_163 , T_1 V_167 )
{
int V_18 ;
V_18 = F_50 ( V_131 -> V_132 , V_163 ,
0 , V_167 ) ;
if ( V_18 < 0 )
F_12 ( V_23 L_65
L_66 , V_25 , V_18 ) ;
...
static int
F_91 ( struct V_130 * V_131 ,
char * V_140 , T_1 V_65 )
{
int V_18 ;
V_18 = F_92 ( V_131 , V_168 , V_140 ,
V_65 , 0 ) ;
return V_18 ;
}
static unsigned long F_93 ( T_5 V_169 ,
unsigned int V_170 )
{
struct V_68 * V_68 ;
V_68 = F_94 ( V_169 | V_171 , V_170 ) ;
if ( V_68 )
...
V_167 = V_8 -> V_110 ;
V_170 = F_97 ( V_167 ) ;
V_163 = ( char * ) F_93 ( V_32 , V_170 ) ;
if ( ! V_163 ) {
F_12 ( V_23 L_69 , V_25 ) ;
V_18 = - V_33 ;
goto V_24;
}
V_18 = F_88 ( V_163 , V_167 , & V_65 , V_8 ,
V_131 ) ;
if ( F_19 ( V_18 ) ) {
F_12 ( V_23 L_70 ,
V_25 , V_18 ) ;
...
if ( V_8 -> V_16 & V_109 )
V_18 = F_91 ( V_131 , V_163 ,
V_65 ) ;
else
V_18 = F_90 ( V_131 , V_163 ,
V_167 ) ;
if ( V_18 ) {
F_12 ( V_23 L_71
L_25 , V_25 , V_18 ) ;
...
V_172:
F_98 ( ( unsigned long ) V_163 , V_170 ) ;
V_24:
return V_18 ;
}
static int F_99 ( struct V_7 * V_8 ,
char * V_163 , int * V_141 ,
int V_173 )
{
int V_18 = 0 ;
T_3 V_164 ;
...
V_8 -> V_110 = ( ( ( T_1 ) V_165
* ( T_1 ) V_164 ) ) ;
( * V_141 ) = ( sizeof( V_174 ) + sizeof( V_175 ) ) ;
if ( ( V_173 == V_176 )
&& ( V_8 -> V_110
< V_111 ) ) {
V_18 = - V_80 ;
...
void F_85 ( const char * V_140 , struct V_88 * V_88 )
{
struct V_53 * V_54 ;
struct V_7 * V_8 ;
T_6 V_159 ;
V_8 = & F_47 ( V_88 ) -> V_8 ;
V_54 =
& F_74 ( V_88 -> V_177 ) -> V_54 ;
if ( V_54 -> V_16 & V_115 ) {
V_159 = F_102 ( F_103 ( V_88 ) ) ;
if ( V_8 -> V_16 & V_109 )
V_159 += V_8 -> V_110 ;
} else
V_159 = F_104 ( V_140 ) ;
F_105 ( V_88 , ( T_2 ) V_159 ) ;
V_8 -> V_16 |= V_178 ;
}
static int F_106 ( char * V_140 ,
struct V_7 * V_8 ,
struct V_130 * V_131 ,
int V_173 )
{
...
V_131 -> V_133 ) -> V_54 ;
V_35 = V_162 ;
V_18 = F_75 ( V_140 + V_35 ) ;
if ( V_18 )
goto V_24;
if ( ! ( V_8 -> V_16 & V_178 ) )
F_85 ( V_140 , V_131 -> V_132 ) ;
V_35 += V_147 ;
V_18 = F_77 ( V_8 , ( V_140 + V_35 ) ,
& V_141 ) ;
if ( V_18 ) {
F_10 ( V_42 , L_73 ) ;
goto V_24;
...
F_101 ( V_8 ) ;
V_18 = F_107 ( V_8 , ( V_140 + V_35 ) ,
V_131 ) ;
V_24:
return V_18 ;
}
int F_108 ( char * V_140 , struct V_88 * V_89 )
{
struct V_130 * V_180 =
F_47 ( V_89 ) -> V_181 -> V_182 ;
T_7 V_65 ;
int V_18 = 0 ;
V_65 = F_109 ( V_180 , V_168 ,
V_140 , V_107 ) ;
if ( V_65 < 0 ) {
if ( F_19 ( V_38 > 0 ) )
F_12 ( V_183 L_79
...
int F_110 ( struct V_130 * V_130 ,
struct V_88 * V_88 )
{
V_20 V_159 [ V_160 ] ;
V_20 * V_161 = V_159 + V_162 ;
int V_18 ;
V_18 = F_109 ( F_111 ( V_130 ) ,
V_168 , V_159 ,
V_160 ) ;
if ( V_18 < V_160 )
return V_18 >= 0 ? - V_80 : V_18 ;
...
int F_112 ( struct V_130 * V_131 )
{
int V_18 = 0 ;
char * V_140 = NULL ;
struct V_88 * V_89 = V_131 -> V_132 ;
struct V_7 * V_8 =
& F_47 ( V_89 ) -> V_8 ;
struct V_53 * V_54 =
& F_74 (
...
V_18 = F_56 ( V_140 , 0 , V_8 -> V_82 ,
V_89 ) ;
if ( V_18 >= 0 )
V_18 = F_106 ( V_140 , V_8 ,
V_131 ,
V_176 ) ;
if ( V_18 ) {
memset ( V_140 , 0 , V_71 ) ;
V_18 = F_108 ( V_140 , V_89 ) ;
if ( V_18 ) {
F_12 ( V_39 L_83
L_84 ) ;
V_18 = - V_80 ;
