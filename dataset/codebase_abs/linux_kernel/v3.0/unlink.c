...
F_45 ( & V_14 -> V_15 ) ;
F_25 ( & V_3 -> V_57 ) ;
while ( ! F_46 ( & V_14 -> V_59 ) ) {
if ( ! F_39 ( & V_14 -> V_15 ) )
break;
V_2 = F_47 ( V_14 -> V_59 . V_60 , struct V_1 , V_58 ) ;
F_48 ( & V_2 -> V_58 ) ;
F_26 ( & V_3 -> V_57 ) ;
...
F_58 ( V_2 -> V_69 , F_59 ( V_66 ) ) ;
F_60 ( V_2 -> V_69 , V_2 -> V_70 ) ;
}
static void F_61 ( void * V_19 )
{
struct V_65 * V_2 = V_19 ;
...
static void F_63 ( struct V_17 * V_18 , void * V_19 )
{
struct V_65 * V_2 = V_19 ;
...
static struct V_17 *
F_64 ( struct V_12 * V_66 , struct V_12 * V_67 ,
struct V_6 * V_69 , struct V_6 * V_70 )
{
struct V_65 * V_2 ;
struct V_30 V_31 = { } ;
struct V_35 V_36 = {
...
V_2 -> args . V_74 = & V_69 -> V_9 ;
V_2 -> args . V_67 = F_30 ( V_67 ) ;
V_2 -> args . V_75 = & V_70 -> V_9 ;
V_2 -> V_27 . V_72 = & V_2 -> V_72 ;
V_2 -> V_27 . V_73 = & V_2 -> V_73 ;
F_29 ( V_66 -> V_23 ) ;
F_14 ( V_2 -> V_66 ) -> F_69 ( & V_31 , V_66 ) ;
return F_34 ( & V_36 ) ;
}
int
...
const int V_77 = sizeof( F_71 ( V_6 -> V_48 ) ) * 2 ;
...
sprintf ( V_80 , L_3 ,
V_77 , V_77 ,
( unsigned long long ) F_71 ( V_6 -> V_48 ) ) ;
F_74 ( V_6 -> V_48 ) ;
V_81 = NULL ;
do {
