...
int V_78 ;
T_1 V_79 ;
T_2 V_80 = V_73 ? V_73 -> V_80 : F_14 ( V_81 ) ;
T_2 V_33 = 0 ;
struct V_4 V_82 ;
if ( V_76 -> V_36 . V_40 == V_83 &&
V_80 == 0 ) {
...
V_76 -> V_36 . V_40 != V_87 )
return V_84 ;
if ( V_76 -> V_36 . V_42 == V_88 ||
( ( V_76 -> V_36 . V_42 & V_89 ) ==
V_89 ) )
return V_84 ;
} else if ( V_76 -> V_36 . V_37 == V_90 ||
V_76 -> V_36 . V_37 == V_91 ||
V_76 -> V_36 . V_37 == V_92 ) {
if ( V_76 -> V_36 . V_40 != V_86 &&
V_76 -> V_36 . V_40 != V_41 )
...
V_77 -> V_36 . V_79 |= F_27 ( 1 << 15 ) ;
if ( V_76 -> V_36 . V_40 == V_87 )
return V_84 | V_85 ;
return V_84 | V_97 ;
}
