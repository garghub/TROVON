...
int F_17 ( struct V_4 * * V_4 , struct V_1 * V_21 , struct V_25 * V_26 )
{
struct V_5 V_6 ;
int error ;
...
void F_22 ( struct V_4 * V_4 , struct V_1 * V_33 ,
struct V_1 * V_34 )
{
struct V_22 * V_23 = F_10 ( V_4 ) ;
unsigned long V_27 = F_13 ( V_34 ) ;
F_23 ( ! F_1 ( & V_23 -> V_24 , V_33 ) ) ;
F_24 ( V_4 ) ;
V_23 -> V_24 = * V_34 ;
V_4 -> V_31 = V_27 ;
F_25 ( V_4 , V_27 ) ;
...
V_4 = F_27 ( V_26 , V_27 , F_9 , V_21 ) ;
if ( ! V_4 )
return NULL ;
F_23 ( V_4 -> V_29 & V_30 ) ;
return V_4 ;
}
int F_28 ( struct V_4 * * V_4 , struct V_25 * V_26 )
{
int error = - V_28 ;
* V_4 = F_29 ( V_26 ) ;
if ( * V_4 ) {
