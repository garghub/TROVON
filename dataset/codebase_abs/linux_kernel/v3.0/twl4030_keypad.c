...
V_22 -> V_72 = L_7 ;
V_22 -> V_73 = L_8 ;
V_22 -> V_57 . V_74 = & V_54 -> V_57 ;
V_22 -> V_75 . V_76 = V_77 ;
V_22 -> V_75 . V_78 = 0x0001 ;
V_22 -> V_75 . V_79 = 0x0001 ;
V_22 -> V_75 . V_80 = 0x0003 ;
V_22 -> V_81 = V_2 -> V_29 ;
V_22 -> V_82 = sizeof( V_2 -> V_29 [ 0 ] ) ;
V_22 -> V_83 = F_26 ( V_2 -> V_29 ) ;
F_27 ( V_60 , V_26 ,
V_22 -> V_81 , V_22 -> V_84 ) ;
error = F_28 ( V_22 ) ;
if ( error ) {
...
static int T_6 F_36 ( struct V_53 * V_54 )
{
