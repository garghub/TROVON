...
static void F_33 ( void * V_32 , T_1 V_65 )
{
struct V_1 * V_1 = V_32 ;
int V_10 ;
T_1 V_9 ;
...
V_1 -> V_64 ++ ;
F_23 ( & V_1 -> V_52 ) ;
V_10 = F_9 ( V_1 , V_65 , & V_9 ) ;
if ( V_10 == 0 ) {
F_13 ( V_1 -> V_28 , L_18 , V_9 ) ;
return;
}
if ( V_1 -> V_64 > 1 ) {
F_30 ( V_1 ) ;
...
static int T_6 F_34 ( struct V_66 * V_67 )
{
struct V_1 * V_1 ;
struct V_68 * V_69 ;
int V_10 , V_31 ;
T_1 V_70 ;
V_1 = F_35 ( sizeof( * V_1 ) , V_71 ) ;
if ( ! V_1 ) {
F_13 ( & V_67 -> V_28 , L_19 ) ;
V_10 = - V_72 ;
goto V_73;
...
V_1 -> V_28 = & V_67 -> V_28 ;
F_36 ( V_67 , V_1 ) ;
V_69 = F_37 ( V_67 , V_74 , 0 ) ;
if ( ! V_69 ) {
F_13 ( & V_67 -> V_28 , L_20 ) ;
V_10 = - V_75 ;
goto V_76;
}
V_1 -> V_3 = F_38 ( V_69 -> V_77 , V_78 ) ;
if ( ! V_1 -> V_3 ) {
F_13 ( & V_67 -> V_28 , L_21 ) ;
V_10 = - V_17 ;
goto V_79;
}
V_1 -> V_60 = F_39 ( & V_67 -> V_28 , L_22 ) ;
if ( F_40 ( V_1 -> V_60 ) ) {
F_13 ( & V_67 -> V_28 , L_23 ) ;
V_10 = F_41 ( V_1 -> V_60 ) ;
goto V_80;
}
V_1 -> V_63 = F_39 ( & V_67 -> V_28 , L_24 ) ;
if ( F_40 ( V_1 -> V_63 ) ) {
F_13 ( & V_67 -> V_28 , L_25 ) ;
V_10 = F_41 ( V_1 -> V_63 ) ;
goto V_81;
...
V_10 = F_46 ( V_31 , F_14 , V_86 , L_28 , V_1 ) ;
if ( V_10 < 0 ) {
F_13 ( & V_67 -> V_28 , L_29 ) ;
goto V_85;
}
...
static int F_50 ( struct V_66 * V_67 )
{
struct V_1 * V_1 = F_51 ( V_67 ) ;
F_52 ( & V_1 -> V_52 ) ;
if ( V_1 -> V_56 ) {
F_13 ( & V_67 -> V_28 , L_31 ) ;
F_23 ( & V_1 -> V_52 ) ;
