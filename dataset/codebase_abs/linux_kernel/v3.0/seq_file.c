...
int F_26 ( struct V_4 * V_13 , struct V_55 * V_55 , char * V_46 )
{
char * V_20 ;
T_4 V_21 = F_21 ( V_13 , & V_20 ) ;
int V_52 = - 1 ;
if ( V_21 ) {
char * V_5 = F_27 ( V_55 , V_20 , V_21 ) ;
if ( ! F_6 ( V_5 ) ) {
char * V_47 = F_19 ( V_20 , V_5 , V_46 ) ;
if ( V_47 )
V_52 = V_47 - V_20 ;
...
int F_28 ( struct V_4 * V_13 , const unsigned long * V_56 ,
unsigned int V_57 )
{
if ( V_13 -> V_18 < V_13 -> V_21 ) {
int V_50 = F_29 ( V_13 -> V_20 + V_13 -> V_18 ,
V_13 -> V_21 - V_13 -> V_18 , V_56 , V_57 ) ;
if ( V_13 -> V_18 + V_50 < V_13 -> V_21 ) {
V_13 -> V_18 += V_50 ;
return 0 ;
}
...
int F_30 ( struct V_4 * V_13 , const unsigned long * V_56 ,
unsigned int V_57 )
{
if ( V_13 -> V_18 < V_13 -> V_21 ) {
...
static void * F_33 ( struct V_4 * V_5 , void * V_58 , T_1 * V_15 )
{
++ * V_15 ;
return NULL ;
}
static void F_34 ( struct V_4 * V_5 , void * V_58 )
{
}
...
{
struct V_4 * V_61 = V_1 -> V_6 ;
F_8 ( V_61 -> V_60 ) ;
V_61 -> V_60 = NULL ;
return F_16 ( V_44 , V_1 ) ;
}
void * F_38 ( struct V_1 * V_49 , const struct V_2 * V_62 ,
int V_63 )
{
int V_64 ;
void * V_60 ;
...
int F_40 ( struct V_1 * V_67 , const struct V_2 * V_62 ,
int V_63 )
{
return F_38 ( V_67 , V_62 , V_63 ) ? 0 : - V_8 ;
}
...
int F_43 ( struct V_4 * V_61 , const void * V_59 , T_4 V_50 )
{
if ( V_61 -> V_18 + V_50 < V_61 -> V_21 ) {
memcpy ( V_61 -> V_20 + V_61 -> V_18 , V_59 , V_50 ) ;
V_61 -> V_18 += V_50 ;
return 0 ;
}
V_61 -> V_18 = V_61 -> V_21 ;
...
struct V_68 * F_44 ( struct V_68 * V_69 , T_1 V_15 )
{
struct V_68 * V_70 ;
F_45 (lh, head)
if ( V_15 -- == 0 )
...
struct V_68 * F_46 ( struct V_68 * V_69 , T_1 V_15 )
{
if ( ! V_15 )
return V_69 ;
return F_44 ( V_69 , V_15 - 1 ) ;
}
struct V_68 * F_47 ( void * V_58 , struct V_68 * V_69 , T_1 * V_29 )
{
struct V_68 * V_70 ;
V_70 = ( (struct V_68 * ) V_58 ) -> V_26 ;
++ * V_29 ;
return V_70 == V_69 ? NULL : V_70 ;
}
struct V_71 * F_48 ( struct V_72 * V_69 , T_1 V_15 )
{
struct V_71 * V_73 ;
F_49 (node, head)
if ( V_15 -- == 0 )
...
struct V_71 * F_50 ( struct V_72 * V_69 , T_1 V_15 )
{
if ( ! V_15 )
return V_74 ;
return F_48 ( V_69 , V_15 - 1 ) ;
}
struct V_71 * F_51 ( void * V_58 , struct V_72 * V_69 ,
T_1 * V_29 )
{
struct V_71 * V_73 = V_58 ;
++ * V_29 ;
if ( V_58 == V_74 )
return V_69 -> V_75 ;
else
...
struct V_71 * F_52 ( struct V_72 * V_69 ,
T_1 V_15 )
{
struct V_71 * V_73 ;
F_53 (node, head)
...
struct V_71 * F_54 ( struct V_72 * V_69 ,
T_1 V_15 )
{
if ( ! V_15 )
return V_74 ;
return F_52 ( V_69 , V_15 - 1 ) ;
}
struct V_71 * F_55 ( void * V_58 ,
struct V_72 * V_69 ,
T_1 * V_29 )
{
struct V_71 * V_73 = V_58 ;
++ * V_29 ;
if ( V_58 == V_74 )
return F_56 ( V_69 -> V_75 ) ;
else
return F_56 ( V_73 -> V_26 ) ;
}
