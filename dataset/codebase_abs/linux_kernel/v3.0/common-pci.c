...
int F_26 ( struct V_45 * V_46 , T_4 V_51 , T_5 V_25 )
{
return ( V_46 -> V_33 == & V_47 ) && ( ( V_51 + V_25 ) >= V_49 ) ;
}
void T_6 F_27 ( void )
{
...
F_16 ( V_64 , 4 , V_56 + V_65 ) ;
F_16 ( V_66 , 4 , V_56 + V_49 ) ;
...
struct V_32 * T_7 F_38 ( int V_75 , struct V_76 * V_77 )
{
return F_39 ( V_77 -> V_95 , & V_96 , V_77 ) ;
}
int F_40 ( struct V_45 * V_46 , T_8 V_97 )
{
if ( V_97 >= V_49 - 1 )
return 0 ;
return - V_98 ;
