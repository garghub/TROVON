...
V_63 = F_29 ( V_2 , V_64 ) ;
F_47 ( V_63 , & V_9 -> V_12 , & V_9 -> V_13 , V_9 -> V_14 , type , V_9 -> V_41 ) ;
F_48 ( V_2 , V_9 -> T_4 -> V_8 ) ;
}
void F_48 ( struct V_1 * V_2 , struct V_7 * V_8 )
{
unsigned char * V_63 ;
V_2 -> V_66 = F_49 ( V_2 , F_50 ( V_8 ) ) ;
V_63 = F_29 ( V_2 , 1 ) ;
* V_63 = 0x00 ;
F_51 ( V_2 ) ;
}
int F_52 ( T_1 * V_9 , unsigned short V_67 )
{
if ( V_9 -> V_46 == V_67 ) {
F_53 ( V_9 , V_67 ) ;
F_54 ( V_9 ) ;
