...
V_2 -> V_51 = F_3 ( V_42 -> V_51 ) ;
if ( V_40 ) {
signal = (struct V_43 * ) V_40 ;
memset ( signal , 0 , sizeof( struct V_43 ) ) ;
signal -> V_52 = V_53 ;
...
signal -> V_54 =
F_11 ( V_2 -> V_48 , V_2 -> V_49 ) ;
signal -> V_55 =
F_11 ( V_2 -> V_50 , V_2 -> V_51 ) ;
signal -> V_56 =
F_11 ( V_2 -> V_44 , V_2 -> V_45 ) ;
signal -> V_57 =
F_11 ( V_2 -> V_46 , V_2 -> V_47 ) ;
signal -> V_49 = V_2 -> V_49 ;
signal -> V_51 = V_2 -> V_51 ;
...
T_1 V_60 = F_3 ( V_59 -> V_60 ) ;
T_1 V_61 = F_3 ( V_59 -> V_61 ) ;
T_2 V_62 ;
...
{
struct V_70 * V_71 =
(struct V_70 * ) & V_4 -> V_21 . V_71 ;
struct V_72 * V_73 ;
if ( V_40 ) {
V_73 = (struct V_72 * ) V_40 ;
V_73 -> V_74 = F_15 ( V_71 -> V_74 ) ;
V_73 -> V_75 = F_15 ( V_71 -> V_75 ) ;
V_73 -> V_76 = F_15 ( V_71 -> V_76 ) ;
V_73 -> V_77 = F_15 ( V_71 -> V_77 ) ;
V_73 -> V_78 = F_15 ( V_71 -> V_78 ) ;
V_73 -> V_79 = F_15 ( V_71 -> V_79 ) ;
V_73 -> V_80 = F_15 ( V_71 -> V_80 ) ;
V_73 -> V_81 = F_15 ( V_71 -> V_81 ) ;
V_73 -> V_82 = F_15 ( V_71 -> V_82 ) ;
V_73 -> V_83 = F_15 ( V_71 -> V_83 ) ;
V_73 -> V_84 = F_15 ( V_71 -> V_84 ) ;
V_73 -> V_85 = F_15 ( V_71 -> V_85 ) ;
V_73 -> V_86 [ 0 ] =
F_15 ( V_71 -> V_87 [ 0 ] ) ;
V_73 -> V_86 [ 1 ] =
F_15 ( V_71 -> V_87 [ 1 ] ) ;
...
static int F_20 ( struct V_1 * V_2 , void * V_40 )
{
...
void * V_40 )
{
struct V_176 * V_177 = & V_4 -> V_21 . V_178 ;
struct V_176 * V_179 ;
if ( V_40 ) {
V_179 = (struct V_176 * ) V_40 ;
V_179 -> V_180 = V_177 -> V_180 ;
memcpy ( V_179 -> V_181 , V_177 -> V_181 ,
sizeof( char ) * 128 ) ;
memcpy ( V_2 -> V_181 , V_177 -> V_181 , 128 ) ;
}
return 0 ;
}
static int F_34 ( T_1 type , struct V_3 * V_4 ,
void * V_40 )
{
struct V_182 * V_183 ;
struct V_184 * V_185 ;
if ( V_40 ) {
V_183 = (struct V_182 * ) V_40 ;
V_185 = (struct V_184 * ) V_40 ;
switch ( type ) {
case V_186 :
{
struct V_187 * V_188 ;
...
V_183 -> V_190 = F_35 (
( T_2 ) F_3 ( V_188 -> V_190 ) ) ;
V_183 -> V_66 = F_35 ( ( T_2 ) V_188 -> V_66 ) ;
break;
}
case V_194 :
{
...
T_1 V_216 , void * V_217 )
{
int V_101 = 0 ;
struct V_8 * V_9 = V_2 -> V_9 ;
struct V_3 * V_4 =
(struct V_3 * ) V_217 ;
void * V_40 = V_9 -> V_16 -> V_40 ;
if ( V_4 -> V_15 != V_218 ) {
F_1 ( V_2 , V_4 ) ;
return - 1 ;
}
...
break;
case V_224 :
V_101 = F_21 ( V_2 , V_4 , V_40 ) ;
break;
case V_20 :
V_101 = F_42 ( V_2 , V_4 , V_40 ) ;
break;
case V_225 :
V_101 = F_43 ( V_2 , V_4 ) ;
break;
...
break;
case V_231 :
V_101 = F_14 ( V_2 , V_4 , V_40 ) ;
break;
case V_232 :
V_101 = F_10 ( V_2 , V_4 , V_40 ) ;
break;
case V_233 :
V_101 = F_12 ( V_2 , V_4 , V_40 ) ;
break;
case V_110 :
V_101 = F_24 ( V_2 , V_4 ) ;
break;
case V_234 :
V_101 = F_32 ( V_2 , V_4 , V_40 ) ;
break;
case V_235 :
V_101 = F_33 ( V_2 , V_4 , V_40 ) ;
break;
case V_236 :
case V_237 :
break;
