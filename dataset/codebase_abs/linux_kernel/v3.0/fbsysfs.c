...
static T_2 F_50 ( struct V_3 * V_3 ,
struct V_35 * V_36 ,
const char * V_18 , T_1 V_37 )
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
...
V_1 -> V_62 [ V_43 ] = V_58 [ V_43 ] ;
F_52 ( & V_1 -> V_10 ) ;
return V_37 ;
}
static T_2 F_53 ( struct V_3 * V_3 ,
struct V_35 * V_36 , char * V_18 )
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
T_2 V_63 = 0 ;
...
F_55 ( V_1 -> V_4 , V_1 ) ;
V_1 -> V_64 |= V_65 ;
for ( V_43 = 0 ; V_43 < F_56 ( V_66 ) ; V_43 ++ ) {
error = F_57 ( V_1 -> V_4 , & V_66 [ V_43 ] ) ;
if ( error )
break;
}
if ( error ) {
while ( -- V_43 >= 0 )
F_58 ( V_1 -> V_4 , & V_66 [ V_43 ] ) ;
V_1 -> V_64 &= ~ V_65 ;
}
return 0 ;
}
...
void F_60 ( struct V_1 * V_1 , T_4 V_67 , T_4 V_68 , T_4 F_18 )
{
unsigned int V_43 , V_69 , V_37 , V_70 = ( F_18 - V_68 ) ;
F_51 ( & V_1 -> V_10 ) ;
V_1 -> V_62 [ 0 ] = V_67 ;
for ( V_69 = 1 ; V_69 < ( V_59 / 16 ) ; ++ V_69 )
V_1 -> V_62 [ V_69 ] = V_68 ;
V_37 = V_59 * 15 / 16 ;
