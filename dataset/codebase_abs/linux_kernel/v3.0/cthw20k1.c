...
{
return ! ( V_53 -> V_179 == V_185 || V_53 -> V_179 == V_186 ) ;
}
static int F_116 ( struct V_197 * V_198 )
{
unsigned int V_199 , V_200 , V_201 , V_202 , V_203 , V_204 ;
unsigned int V_205 , V_206 , V_207 , V_208 , V_209 ;
unsigned int V_210 ;
unsigned int V_48 [ 4 ] = { 0 } ;
unsigned int V_211 ;
void * V_212 ;
int V_55 ;
const T_1 V_213 = F_117 ( 'C' , 'T' , 'L' , 'X' ) ;
const T_1 V_214 = F_117 ( 'C' , 'T' , 'L' , '-' ) ;
const T_1 V_215 = F_117 ( 'C' , 'T' , 'L' , 'F' ) ;
const T_1 V_216 = F_117 ( 'C' , 'T' , 'L' , 'i' ) ;
const T_1 V_217 = F_117 ( 'C' , 'T' , 'L' , 'A' ) ;
const T_1 V_218 = F_117 ( 'C' , 'T' , 'L' , 'Z' ) ;
const T_1 V_219 = F_117 ( 'C' , 'T' , 'L' , 'L' ) ;
V_211 = F_118 ( V_198 , 0 ) ;
V_212 = F_119 ( V_211 , F_120 ( V_198 , 0 ) ) ;
if ( ! V_212 )
return - V_220 ;
for ( V_55 = 0 ; V_55 < 4 ; V_55 ++ )
V_48 [ V_55 ] = F_121 ( V_212 + V_221 ) ;
if ( V_48 [ 0 ] == V_217 ) {
V_210 = ( ( V_48 [ 1 ] == V_218 && V_48 [ 2 ] == V_219
&& V_48 [ 3 ] == V_217 ) || ( V_48 [ 1 ] == V_217
&& V_48 [ 2 ] == V_218 && V_48 [ 3 ] == V_219 ) ) ;
} else if ( V_48 [ 0 ] == V_218 ) {
V_210 = ( V_48 [ 1 ] == V_219
&& V_48 [ 2 ] == V_217 && V_48 [ 3 ] == V_217 ) ;
} else if ( V_48 [ 0 ] == V_219 ) {
V_210 = ( V_48 [ 1 ] == V_217
&& V_48 [ 2 ] == V_217 && V_48 [ 3 ] == V_218 ) ;
} else {
V_210 = 0 ;
}
if ( ! V_210 ) {
...
F_123 ( V_198 , V_222 , & V_199 ) ;
F_123 ( V_198 , V_223 , & V_200 ) ;
F_123 ( V_198 , V_224 , & V_201 ) ;
F_123 ( V_198 , V_225 , & V_202 ) ;
F_123 ( V_198 , V_226 , & V_203 ) ;
F_123 ( V_198 , V_227 , & V_204 ) ;
F_123 ( V_198 , V_228 , & V_206 ) ;
F_123 ( V_198 , V_229 , & V_207 ) ;
F_123 ( V_198 , V_230 , & V_208 ) ;
F_123 ( V_198 , V_231 , & V_209 ) ;
F_123 ( V_198 , V_232 , & V_205 ) ;
F_124 ( V_198 , V_233 , 0x87654321 ) ;
F_124 ( V_198 , V_222 , V_204 ) ;
F_124 ( V_198 , V_233 , 0x12345678 ) ;
F_124 ( V_198 , V_223 , V_200 ) ;
F_124 ( V_198 , V_224 , V_201 ) ;
F_124 ( V_198 , V_225 , V_202 ) ;
F_124 ( V_198 , V_226 , V_203 ) ;
F_124 ( V_198 , V_228 , V_206 ) ;
F_124 ( V_198 , V_229 , V_207 ) ;
F_124 ( V_198 , V_230 , V_208 ) ;
F_124 ( V_198 , V_231 , V_209 ) ;
F_124 ( V_198 , V_232 , V_205 ) ;
F_125 ( V_213 , ( V_212 + V_221 ) ) ;
F_125 ( V_214 , ( V_212 + V_221 ) ) ;
F_125 ( V_215 , ( V_212 + V_221 ) ) ;
F_125 ( V_216 , ( V_212 + V_221 ) ) ;
F_122 ( V_212 ) ;
return 0 ;
}
static T_3 F_126 ( int V_206 , void * V_234 )
{
struct V_53 * V_53 = V_234 ;
unsigned int V_235 ;
V_235 = F_30 ( V_53 , V_236 ) ;
if ( ! V_235 )
return V_237 ;
if ( V_53 -> V_238 )
V_53 -> V_238 ( V_53 -> V_239 , V_235 ) ;
F_28 ( V_53 , V_236 , V_235 ) ;
return V_240 ;
}
static int F_127 ( struct V_53 * V_53 )
{
int V_241 ;
struct V_197 * V_198 = V_53 -> V_198 ;
V_241 = F_128 ( V_198 ) ;
if ( V_241 < 0 )
return V_241 ;
if ( F_129 ( V_198 , V_242 ) < 0 ||
F_130 ( V_198 , V_242 ) < 0 ) {
F_93 ( V_161 L_4
L_5 ,
V_242 ) ;
...
if ( ! V_53 -> V_211 ) {
V_241 = F_131 ( V_198 , L_6 ) ;
if ( V_241 < 0 )
goto V_244;
if ( V_53 -> V_179 == V_186 )
V_53 -> V_211 = F_118 ( V_198 , 5 ) ;
else
V_53 -> V_211 = F_118 ( V_198 , 0 ) ;
}
if ( V_53 -> V_179 == V_186 ) {
V_241 = F_116 ( V_198 ) ;
if ( V_241 )
...
if ( V_53 -> V_206 < 0 ) {
V_241 = F_132 ( V_198 -> V_206 , F_126 , V_246 ,
L_7 , V_53 ) ;
if ( V_241 < 0 ) {
F_93 ( V_161 L_8 , V_198 -> V_206 ) ;
goto V_245;
}
V_53 -> V_206 = V_198 -> V_206 ;
}
F_133 ( V_198 ) ;
return 0 ;
V_245:
...
{
if ( V_53 -> V_206 >= 0 )
F_139 ( V_53 -> V_206 , V_53 ) ;
V_53 -> V_206 = - 1 ;
if ( V_53 -> V_212 )
F_122 ( ( void * ) V_53 -> V_212 ) ;
V_53 -> V_212 = ( unsigned long ) NULL ;
if ( V_53 -> V_211 )
F_134 ( V_53 -> V_198 ) ;
V_53 -> V_211 = 0 ;
F_135 ( V_53 -> V_198 ) ;
...
static int F_140 ( struct V_53 * V_53 , struct V_247 * V_152 )
{
int V_241 ;
unsigned int V_171 ;
T_1 V_48 ;
struct V_178 V_248 = { 0 } ;
struct V_196 V_249 = { 0 } ;
struct V_151 V_250 = { 0 } ;
struct V_156 V_251 = { 0 } ;
V_241 = F_127 ( V_53 ) ;
if ( V_241 )
return V_241 ;
V_241 = F_95 ( V_53 , V_152 -> V_13 ) ;
if ( V_241 < 0 )
return V_241 ;
V_241 = F_96 ( V_53 ) ;
if ( V_241 < 0 )
...
switch ( V_53 -> V_179 ) {
case V_180 :
F_28 ( V_53 , V_258 , 0x13fe ) ;
break;
case V_185 :
F_28 ( V_53 , V_258 , 0x00e6 ) ;
break;
case V_186 :
F_28 ( V_53 , V_258 , 0x00c2 ) ;
break;
default:
F_28 ( V_53 , V_258 , 0x01e6 ) ;
break;
}
V_251 . V_160 = V_152 -> V_160 ;
V_241 = F_92 ( V_53 , & V_251 ) ;
if ( V_241 < 0 )
return V_241 ;
V_250 . V_155 = V_152 -> V_155 ;
V_241 = F_91 ( V_53 , & V_250 ) ;
if ( V_241 < 0 )
return V_241 ;
V_248 . V_155 = V_152 -> V_155 ;
V_241 = F_103 ( V_53 , & V_248 ) ;
if ( V_241 < 0 )
return V_241 ;
V_249 . V_155 = V_152 -> V_155 ;
V_249 . V_190 = V_183 ;
V_249 . V_191 = 0 ;
V_241 = F_114 ( V_53 , & V_249 ) ;
if ( V_241 < 0 )
return V_241 ;
V_48 = F_30 ( V_53 , V_259 ) ;
V_48 |= 0x1 ;
F_28 ( V_53 , V_259 , V_48 ) ;
return 0 ;
}
static int F_141 ( struct V_53 * V_53 , T_4 V_6 )
{
struct V_197 * V_198 = V_53 -> V_198 ;
F_136 ( V_53 ) ;
if ( V_53 -> V_179 == V_186 ) {
F_124 ( V_198 , V_233 , 0x0 ) ;
}
F_135 ( V_198 ) ;
F_142 ( V_198 ) ;
F_143 ( V_198 , F_144 ( V_198 , V_6 ) ) ;
return 0 ;
}
static int F_145 ( struct V_53 * V_53 , struct V_247 * V_152 )
{
struct V_197 * V_198 = V_53 -> V_198 ;
F_143 ( V_198 , V_260 ) ;
F_146 ( V_198 ) ;
...
static T_1 F_30 ( struct V_53 * V_53 , T_1 V_261 )
{
T_1 V_262 ;
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_264 , V_47 ) ;
F_149 ( V_261 , V_53 -> V_211 + 0x0 ) ;
V_262 = F_150 ( V_53 -> V_211 + 0x4 ) ;
F_151 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_264 , V_47 ) ;
return V_262 ;
}
static void F_28 ( struct V_53 * V_53 , T_1 V_261 , T_1 V_48 )
{
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_264 , V_47 ) ;
F_149 ( V_261 , V_53 -> V_211 + 0x0 ) ;
F_149 ( V_48 , V_53 -> V_211 + 0x4 ) ;
F_151 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_264 , V_47 ) ;
}
static T_1 F_98 ( struct V_53 * V_53 , T_1 V_261 )
{
T_1 V_262 ;
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_265 , V_47 ) ;
F_149 ( V_261 , V_53 -> V_211 + 0x10 ) ;
V_262 = F_150 ( V_53 -> V_211 + 0x14 ) ;
F_151 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_265 , V_47 ) ;
return V_262 ;
}
static void F_99 ( struct V_53 * V_53 , T_1 V_261 , T_1 V_48 )
{
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_265 , V_47 ) ;
F_149 ( V_261 , V_53 -> V_211 + 0x10 ) ;
F_149 ( V_48 , V_53 -> V_211 + 0x14 ) ;
F_151 (
& F_148 ( V_53 , struct V_263 , V_53 ) -> V_265 , V_47 ) ;
}
int T_5 F_152 ( struct V_53 * * V_266 )
{
struct V_263 * V_263 ;
* V_266 = NULL ;
V_263 = F_2 ( sizeof( * V_263 ) , V_4 ) ;
if ( ! V_263 )
return - V_5 ;
F_153 ( & V_263 -> V_264 ) ;
F_153 ( & V_263 -> V_265 ) ;
...
if ( V_53 -> V_211 )
F_138 ( V_53 ) ;
F_4 ( F_148 ( V_53 , struct V_263 , V_53 ) ) ;
return 0 ;
}
