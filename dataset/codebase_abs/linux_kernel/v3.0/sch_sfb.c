...
int V_60 = V_49 | V_61 ;
if ( V_15 -> V_62 > 0 ) {
unsigned long V_63 = V_15 -> V_64 + V_15 -> V_62 ;
if ( F_25 ( F_26 ( V_40 , V_63 ) ) ) {
F_16 ( V_15 ) ;
V_15 -> V_64 = V_40 ;
} else if ( F_25 ( ! V_15 -> V_34 && V_15 -> V_65 > 0 &&
F_26 ( V_40 , V_63 - V_15 -> V_65 ) ) ) {
V_15 -> V_34 = true ;
}
}
if ( V_15 -> V_46 ) {
...
V_7 ^= 1 ;
V_1 ( V_3 ) -> V_8 [ V_7 ] = 0 ;
if ( F_25 ( V_58 >= V_15 -> V_68 || V_54 -> V_15 . V_24 >= V_15 -> V_63 ) ) {
V_54 -> V_69 . V_70 ++ ;
if ( V_58 >= V_15 -> V_68 )
V_15 -> V_71 . V_72 ++ ;
else
...
V_63 = V_90 -> V_63 ;
if ( V_63 == 0 )
V_63 = F_46 ( T_1 , F_47 ( V_54 ) -> V_96 , 1 ) ;
V_55 = F_48 ( V_54 , & V_97 , V_63 ) ;
if ( F_49 ( V_55 ) )
return F_50 ( V_55 ) ;
F_51 ( V_54 ) ;
...
F_42 ( V_15 -> V_56 ) ;
V_15 -> V_56 = V_55 ;
V_15 -> V_62 = F_53 ( V_90 -> V_62 ) ;
V_15 -> V_65 = F_53 ( V_90 -> V_65 ) ;
V_15 -> V_64 = V_40 ;
V_15 -> V_63 = V_63 ;
V_15 -> V_28 = V_90 -> V_28 ;
V_15 -> V_27 = V_90 -> V_27 ;
...
V_54 -> V_69 . V_100 = V_15 -> V_56 -> V_69 . V_100 ;
V_99 = F_58 ( V_3 , V_101 ) ;
