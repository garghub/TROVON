...
struct V_20 * V_21 = F_19 ( V_27 ) ;
unsigned long V_29 ;
unsigned long V_1 = F_20 ( V_17 , NULL , 10 ) ;
int V_5 ;
F_21 ( & V_21 -> V_28 ) ;
V_29 = F_5 ( V_21 -> V_24 [ V_18 ] ,
F_14 ( V_21 -> V_23 [ V_18 ] ) ) ;
...
V_21 -> V_24 [ V_18 ] =
F_4 ( V_29 , F_14 ( V_21 -> V_23 [ V_18 ] ) ) ;
F_22 ( V_27 , F_23 ( V_18 ) , V_21 -> V_24 [ V_18 ] ) ;
F_24 ( & V_21 -> V_28 ) ;
return V_25 ;
}
static int F_27 ( T_5 V_5 , char * V_17 , int V_18 )
{
int V_32 = 0 ;
switch ( V_18 ) {
case 1 : case 2 :
V_32 = sprintf ( V_17 , L_1 , F_28 ( V_5 ) ) ;
break;
case 0 : case 3 : default:
V_32 = sprintf ( V_17 , L_1 , F_7 ( V_5 ) ) ;
break;
}
return V_32 ;
}
...
{
struct V_20 * V_21 = F_13 ( V_14 ) ;
return sprintf ( V_17 , L_2 , V_21 -> V_35 ) ;
}
static T_2 F_35 ( struct V_13 * V_14 , struct V_15 * V_16 ,
char * V_17 )
{
int V_36 = F_12 ( V_16 ) -> V_19 ;
struct V_20 * V_21 = F_13 ( V_14 ) ;
return sprintf ( V_17 , L_2 , ( V_21 -> V_35 >> V_36 ) & 1 ) ;
}
...
V_39 = F_41 ( V_45 ) ;
if ( V_46 [ 0 ] == V_39 && V_46 [ 1 ] == V_41 ) {
for ( V_38 = 2 ; V_38 <= 3 ; V_38 ++ ) {
if ( V_46 [ V_38 ] < 0x48 ||
V_46 [ V_38 ] > 0x4f ) {
F_42 ( & V_27 -> V_14 , L_3
L_4 ,
...
if ( ( V_40 = F_56 ( & V_27 -> V_14 . V_67 , & V_68 ) ) )
goto V_69;
...
static int F_26 ( struct V_26 * V_27 , T_5 V_5 )
{
struct V_20 * V_21 = F_19 ( V_27 ) ;
struct V_26 * V_72 ;
int V_73 , V_74 ;
...
switch ( V_5 & 0xff ) {
case 0x50 :
V_73 = F_64 ( F_65 ( V_72 , 0 ) ) ;
break;
case 0x52 :
V_73 = F_48 ( V_72 , 1 ) ;
break;
case 0x53 :
V_73 = F_64 ( F_65 ( V_72 , 2 ) ) ;
break;
case 0x55 :
default:
V_73 = F_64 ( F_65 ( V_72 , 3 ) ) ;
break;
}
}
if ( V_74 > 2 )
...
static void F_22 ( struct V_26 * V_27 , T_5 V_5 , T_5 V_75 )
{
struct V_20 * V_21 = F_19 ( V_27 ) ;
struct V_26 * V_72 ;
int V_74 ;
...
break;
case 0x53 :
F_66 ( V_72 , 2 , F_64 ( V_75 ) ) ;
break;
case 0x55 :
F_66 ( V_72 , 3 , F_64 ( V_75 ) ) ;
break;
}
}
if ( V_74 > 2 )
...
int V_38 ;
F_21 ( & V_21 -> V_28 ) ;
if ( F_68 ( V_77 , V_21 -> V_78 + V_79 + V_79 / 2 )
|| ! V_21 -> V_80 ) {
F_69 ( & V_27 -> V_14 , L_13 ) ;
for ( V_38 = 0 ; V_38 < 7 ; V_38 ++ ) {
V_21 -> V_81 [ V_38 ] = F_26 ( V_27 ,
F_70 ( V_38 ) ) ;
V_21 -> V_82 [ V_38 ] = F_26 ( V_27 ,
F_71 ( V_38 ) ) ;
V_21 -> V_83 [ V_38 ] = F_26 ( V_27 ,
F_72 ( V_38 ) ) ;
}
for ( V_38 = 0 ; V_38 < 3 ; V_38 ++ ) {
V_21 -> V_22 [ V_38 ] = F_26 ( V_27 ,
F_73 ( V_38 ) ) ;
V_21 -> V_24 [ V_38 ] = F_26 ( V_27 ,
F_23 ( V_38 ) ) ;
}
for ( V_38 = 1 ; V_38 <= 4 ; V_38 ++ ) {
V_21 -> V_7 [ V_38 - 1 ] = F_26 ( V_27 ,
F_74 ( V_38 ) ) ;
V_21 -> V_84 [ V_38 - 1 ] = F_26 ( V_27 ,
F_75 ( V_38 ) ) ;
V_21 -> V_85 [ V_38 - 1 ] = F_26 ( V_27 ,
F_76 ( V_38 ) ) ;
}
V_38 = F_26 ( V_27 , V_30 ) ;
V_21 -> V_33 = V_38 & 0x0f ;
V_21 -> V_33 |= ( F_26 ( V_27 ,
V_86 ) & 0x01 ) << 4 ;
V_21 -> V_23 [ 0 ] = ( V_38 >> 4 ) & 0x03 ;
V_21 -> V_23 [ 1 ] = ( V_38 >> 6 ) & 0x03 ;
V_21 -> V_23 [ 2 ] = ( F_26 ( V_27 ,
V_31 ) >> 6 ) & 0x03 ;
V_21 -> V_12 = F_26 ( V_27 , V_37 ) ;
V_21 -> V_35 = F_26 ( V_27 , V_87 ) +
( F_26 ( V_27 , V_88 ) << 8 ) ;
V_21 -> V_78 = V_77 ;
V_21 -> V_80 = 1 ;
F_69 ( & V_27 -> V_14 , L_14 ) ;
