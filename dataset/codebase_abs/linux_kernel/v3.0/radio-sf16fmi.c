...
if ( V_14 -> V_24 > 0 )
return - V_25 ;
F_14 ( V_14 -> V_26 , L_4 , sizeof( V_14 -> V_26 ) ) ;
V_14 -> type = V_27 ;
V_14 -> V_28 = V_29 ;
V_14 -> V_30 = V_31 ;
V_14 -> V_32 = V_33 | V_34 ;
...
struct V_23 * V_14 )
{
return V_14 -> V_24 ? - V_25 : 0 ;
}
static int F_18 ( struct V_11 * V_11 , void * V_12 ,
struct V_40 * V_41 )
{
struct V_4 * V_4 = F_16 ( V_11 ) ;
if ( V_41 -> V_42 != 0 || V_41 -> type != V_27 )
return - V_25 ;
if ( V_41 -> V_43 < V_29 ||
V_41 -> V_43 > V_31 )
return - V_25 ;
F_8 ( V_4 , ( V_41 -> V_43 / 800 ) * 800 ) ;
return 0 ;
}
...
static int F_24 ( struct V_11 * V_51 , void * V_12 , unsigned int * V_52 )
{
* V_52 = 0 ;
return 0 ;
}
static int F_25 ( struct V_11 * V_51 , void * V_12 , unsigned int V_52 )
{
return V_52 ? - V_25 : 0 ;
}
...
{
V_54 -> V_24 = 0 ;
F_14 ( V_54 -> V_26 , L_5 , sizeof( V_54 -> V_26 ) ) ;
V_54 -> V_35 = V_55 ;
return 0 ;
}
...
struct V_53 * V_54 )
{
return V_54 -> V_24 ? - V_25 : 0 ;
}
static int T_1 F_28 ( void )
{
int V_52 = 0 ;
while ( V_56 [ V_52 ] . V_57 != 0 && V_58 == NULL ) {
V_58 = F_29 ( NULL , V_56 [ V_52 ] . V_59 ,
V_56 [ V_52 ] . V_60 , NULL ) ;
V_52 ++ ;
}
if ( ! V_58 )
...
int V_10 , V_52 ;
int V_69 [] = { 0 , 0x284 , 0x384 } ;
if ( V_3 < 0 ) {
for ( V_52 = 0 ; V_52 < F_37 ( V_69 ) ; V_52 ++ ) {
V_3 = V_69 [ V_52 ] ;
if ( V_3 == 0 ) {
V_3 = F_28 () ;
if ( V_3 < 0 )
...
F_14 ( V_68 -> V_26 , L_11 , sizeof( V_68 -> V_26 ) ) ;
V_4 -> V_3 = V_3 ;
V_10 = F_40 ( NULL , V_68 ) ;
if ( V_10 < 0 ) {
F_39 ( V_4 -> V_3 , 2 ) ;
...
F_14 ( V_4 -> V_72 . V_26 , V_68 -> V_26 , sizeof( V_4 -> V_72 . V_26 ) ) ;
V_4 -> V_72 . V_68 = V_68 ;
V_4 -> V_72 . V_73 = & V_74 ;
V_4 -> V_72 . V_75 = & V_76 ;
V_4 -> V_72 . V_77 = V_78 ;
