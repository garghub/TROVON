...
F_33 ( V_40 , V_37 ) ;
V_25 [ V_1 -> V_14 ] = F_29 ( sizeof( struct V_50 ) , V_44 ) ;
if ( ! V_25 [ V_1 -> V_14 ] ) {
F_9 ( V_19 L_13 ) ;
goto V_51;
}
memcpy ( V_25 [ V_1 -> V_14 ] , & V_52 , sizeof( struct V_50 ) ) ;
if ( V_39 )
V_25 [ V_1 -> V_14 ] -> V_39 = V_39 ;
V_25 [ V_1 -> V_14 ] -> V_1 = V_1 ;
V_25 [ V_1 -> V_14 ] -> V_53 = F_29 ( sizeof( struct V_54 ) , V_44 ) ;
if ( ! V_25 [ V_1 -> V_14 ] -> V_53 ) {
F_9 ( V_15 L_13 ) ;
goto V_55;
}
memcpy ( V_25 [ V_1 -> V_14 ] -> V_53 , & V_56 , sizeof( struct V_54 ) ) ;
...
static int T_3 F_42 ( char * V_64 )
{
int V_65 [ 3 ] ;
V_64 = F_43 ( V_64 , F_44 ( V_65 ) , V_65 ) ;
V_61 = V_65 [ 1 ] ;
V_17 = V_65 [ 2 ] ;
return 1 ;
}
