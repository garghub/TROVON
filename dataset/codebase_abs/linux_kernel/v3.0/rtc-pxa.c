...
V_46 = F_16 ( V_21 -> V_50 , F_8 , V_48 ,
L_3 , V_45 ) ;
if ( V_46 < 0 ) {
F_17 ( V_45 , L_2 , V_21 -> V_50 ,
V_46 ) ;
goto V_51;
}
return 0 ;
...
static int F_22 ( struct V_44 * V_45 , unsigned int V_52 )
{
struct V_21 * V_21 = F_15 ( V_45 ) ;
F_20 ( & V_21 -> V_31 ) ;
if ( V_52 )
...
{
struct V_21 * V_21 = F_15 ( V_45 ) ;
F_6 ( V_21 , V_53 , F_1 ( V_2 ) ) ;
F_6 ( V_21 , V_54 , F_2 ( V_2 ) ) ;
return 0 ;
}
static int F_25 ( struct V_44 * V_45 , struct V_55 * V_56 )
{
struct V_21 * V_21 = F_15 ( V_45 ) ;
T_1 V_23 , V_57 , V_58 ;
V_57 = F_5 ( V_21 , V_59 ) ;
V_58 = F_5 ( V_21 , V_60 ) ;
F_3 ( V_57 , V_58 , & V_56 -> time ) ;
V_23 = F_5 ( V_21 , V_24 ) ;
V_56 -> V_52 = ( V_23 & V_32 ) ? 1 : 0 ;
V_56 -> V_61 = ( V_23 & V_35 ) ? 1 : 0 ;
return 0 ;
}
static int F_26 ( struct V_44 * V_45 , struct V_55 * V_56 )
{
struct V_21 * V_21 = F_15 ( V_45 ) ;
T_1 V_23 ;
F_20 ( & V_21 -> V_31 ) ;
F_6 ( V_21 , V_59 , F_1 ( & V_56 -> time ) ) ;
F_6 ( V_21 , V_60 , F_2 ( & V_56 -> time ) ) ;
V_23 = F_5 ( V_21 , V_24 ) ;
if ( V_56 -> V_52 )
V_23 |= V_32 ;
else
...
static int F_27 ( struct V_44 * V_45 , struct V_62 * V_63 )
{
struct V_21 * V_21 = F_15 ( V_45 ) ;
F_28 ( V_63 , L_4 , F_5 ( V_21 , V_64 ) ) ;
F_28 ( V_63 , L_5 ,
( F_5 ( V_21 , V_24 ) & V_34 ) ? L_6 : L_7 ) ;
F_28 ( V_63 , L_8 ,
( F_5 ( V_21 , V_24 ) & V_33 ) ? L_6 : L_7 ) ;
F_28 ( V_63 , L_9 , F_5 ( V_21 , V_65 ) ) ;
return 0 ;
}
...
int V_46 ;
T_1 V_66 ;
V_21 = F_30 ( sizeof( struct V_21 ) , V_67 ) ;
if ( ! V_21 )
return - V_68 ;
F_31 ( & V_21 -> V_31 ) ;
F_32 ( V_29 , V_21 ) ;
V_46 = - V_69 ;
V_21 -> V_70 = F_33 ( V_29 , V_71 , 0 ) ;
if ( ! V_21 -> V_70 ) {
F_17 ( V_45 , L_10 ) ;
goto V_72;
}
...
V_21 -> V_50 = F_34 ( V_29 , 1 ) ;
if ( V_21 -> V_50 < 0 ) {
F_17 ( V_45 , L_12 ) ;
goto V_72;
}
V_46 = - V_68 ;
V_21 -> V_73 = F_35 ( V_21 -> V_70 -> V_74 ,
F_36 ( V_21 -> V_70 ) ) ;
if ( ! V_21 -> V_73 ) {
F_17 ( & V_29 -> V_45 , L_13 ) ;
goto V_75;
...
F_4 ( V_21 , V_33 | V_32 | V_34 ) ;
V_21 -> V_42 = F_38 ( L_16 , & V_29 -> V_45 , & V_78 ,
V_79 ) ;
V_46 = F_39 ( V_21 -> V_42 ) ;
if ( F_40 ( V_21 -> V_42 ) ) {
F_17 ( V_45 , L_17 , V_46 ) ;
