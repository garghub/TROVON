...
{
if ( ( V_57 ) F_6 ( F_41 ( V_47 ) ) -> V_3 == ( V_57 ) V_56 )
return 1 ;
return 0 ;
}
...
static T_5 int F_57 ( T_2 V_82 , const char * V_15 , int V_83 )
{
char V_84 [ 17 ] ;
unsigned int V_16 = V_83 ;
if ( V_16 > sizeof( V_84 ) - 1 )
V_16 = sizeof( V_84 ) - 1 ;
V_84 [ V_16 ] = '\0' ;
memcpy ( V_84 , V_15 , V_16 ) ;
F_17 ( V_24 , F_58 ( V_84 ) ) ;
return V_16 ;
}
