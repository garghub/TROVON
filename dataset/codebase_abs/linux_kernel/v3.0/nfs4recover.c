...
static int
F_30 ( struct V_36 * V_37 , T_4 * V_60 )
{
const struct V_1 * V_34 ;
struct V_61 * V_62 ;
F_31 ( V_56 ) ;
...
if ( V_20 < 0 )
return V_20 ;
V_62 = F_32 ( F_33 ( V_37 ) , F_34 ( V_38 -> V_40 . V_47 ) , V_63 ,
F_35 () ) ;
V_20 = F_21 ( V_62 ) ;
if ( F_11 ( V_62 ) )
goto V_8;
V_20 = F_36 ( V_62 , F_28 , & V_56 ) ;
F_37 ( V_62 ) ;
F_38 ( & V_37 -> V_41 -> V_42 , V_64 ) ;
while ( ! F_39 ( & V_56 ) ) {
V_58 = F_40 ( V_56 . V_65 , struct V_57 , V_59 ) ;
...
static int
F_46 ( struct V_36 * V_67 , struct V_36 * V_68 )
{
int V_20 ;
if ( F_47 ( V_68 -> V_69 . V_50 , false ) )
return 0 ;
V_20 = F_43 ( V_67 -> V_41 , V_68 ) ;
if ( V_20 )
F_45 ( L_9 ,
V_68 -> V_69 . V_50 ) ;
return 0 ;
...
if ( V_20 )
F_45 ( L_10
L_11 , V_38 -> V_40 . V_36 -> V_69 . V_50 ) ;
}
static int
F_49 ( struct V_36 * V_67 , struct V_36 * V_68 )
{
if ( V_68 -> V_69 . V_22 != V_43 - 1 ) {
F_45 ( L_12 ,
V_68 -> V_69 . V_50 ) ;
return 0 ;
}
