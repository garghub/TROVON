...
V_18 += V_16 ;
V_17 = V_18 - V_19 ;
V_15 = F_4 ( V_8 , V_28 - V_17 ) ;
V_14 = F_4 ( V_6 , V_28 - V_17 - V_15 ) ;
V_13 = V_8 - V_15 ;
V_12 = V_6 - V_14 ;
...
V_10 -> V_46 = V_42 ;
V_10 -> V_47 = V_43 ;
if ( ! F_8 ( V_10 -> V_47 , V_10 -> V_46 , L_5 ) ) {
F_6 ( V_44 L_6 ) ;
V_40 = - V_41 ;
goto V_45;
}
V_10 -> V_26 = F_9 ( V_10 -> V_47 , V_10 -> V_46 ) ;
if ( ! V_10 -> V_26 ) {
F_6 ( V_44 L_7 ) ;
goto V_48;
}
