...
static void F_31 ( struct V_1 * V_4 , int V_2 )
{
int V_6 = F_25 ( V_2 ) ;
F_32 ( V_6 , ( void * ) ( unsigned long ) V_2 ) ;
F_2 ( V_2 , NULL ) ;
}
static long F_33 ( struct V_19 * V_19 ,
...
static unsigned int F_37 ( struct V_19 * V_19 , T_6 * V_84 )
{
unsigned int V_85 = V_86 | V_87 ;
struct V_1 * V_4 = V_19 -> V_28 ;
F_38 ( V_19 , & V_4 -> V_13 , V_84 ) ;
if ( V_4 -> V_10 != V_4 -> V_9 )
V_85 |= V_88 | V_89 ;
if ( V_4 -> V_17 )
V_85 = V_90 ;
...
static int F_39 ( int V_91 , struct V_19 * V_92 , int V_93 )
{
struct V_1 * V_4 = V_92 -> V_28 ;
return F_40 ( V_91 , V_92 , V_93 , & V_4 -> V_14 ) ;
}
static int F_41 ( struct V_94 * V_94 , struct V_19 * V_92 )
{
struct V_1 * V_4 ;
V_4 = F_42 ( sizeof( * V_4 ) , V_40 ) ;
if ( V_4 == NULL )
return - V_41 ;
V_4 -> V_45 = F_43 ( V_40 , L_2 , V_95 -> V_96 ) ;
if ( V_4 -> V_45 == NULL ) {
F_44 ( V_4 ) ;
return - V_41 ;
}
...
F_46 ( & V_4 -> V_31 ) ;
V_92 -> V_28 = V_4 ;
return F_47 ( V_94 , V_92 ) ;
}
static int F_48 ( struct V_94 * V_94 , struct V_19 * V_92 )
{
int V_38 ;
struct V_1 * V_4 = V_92 -> V_28 ;
F_23 ( & V_8 ) ;
