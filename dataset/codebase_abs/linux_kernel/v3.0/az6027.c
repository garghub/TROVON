...
case V_61 :
V_55 = 1 ;
V_8 = F_34 ( & V_17 -> V_20 -> V_62 , & V_57 , 1 ) ;
break;
case V_63 :
V_55 = 2 ;
V_8 = F_34 ( & V_17 -> V_20 -> V_62 , & V_57 , 1 ) ;
...
V_17 -> V_53 = F_40 ( & V_65 , & V_17 -> V_20 -> V_62 ) ;
if ( V_17 -> V_53 ) {
F_12 ( L_13 , V_65 . V_66 ) ;
if ( F_41 ( V_17 -> V_53 , & V_67 , & V_17 -> V_20 -> V_62 ) ) {
F_12 ( L_14 , V_67 . V_68 ) ;
V_17 -> V_53 -> V_69 . V_70 = F_33 ;
F_29 ( V_17 ) ;
} else {
V_17 -> V_53 = NULL ;
}
...
static int F_47 ( struct V_77 * V_17 , struct V_57 V_78 [] , int V_79 )
{
struct V_1 * V_2 = F_48 ( V_17 ) ;
int V_36 = 0 , V_80 = 0 , V_60 = 0 ;
int V_8 ;
T_2 V_5 ;
T_2 V_4 ;
int V_81 ;
...
if ( V_78 [ V_36 ] . V_58 == 0x99 ) {
V_3 = 0xBE ;
V_5 = 0 ;
V_4 = V_78 [ V_36 ] . V_55 [ 0 ] & 0x00ff ;
V_81 = 1 ;
F_9 ( V_2 , V_3 , V_4 , V_5 , V_27 , V_81 ) ;
}
if ( V_78 [ V_36 ] . V_58 == 0xd0 ) {
if ( V_36 + 1 < V_79 && ( V_78 [ V_36 + 1 ] . V_59 & V_83 ) ) {
V_3 = 0xB9 ;
V_5 = ( ( ( V_78 [ V_36 ] . V_55 [ 0 ] << 8 ) & 0xff00 ) | ( V_78 [ V_36 ] . V_55 [ 1 ] & 0x00ff ) ) ;
V_4 = V_78 [ V_36 ] . V_58 + ( V_78 [ V_36 ] . V_60 << 8 ) ;
V_81 = V_78 [ V_36 + 1 ] . V_60 + 6 ;
V_8 = F_1 ( V_2 , V_3 , V_4 , V_5 , V_27 , V_81 ) ;
V_60 = V_78 [ V_36 + 1 ] . V_60 ;
for ( V_80 = 0 ; V_80 < V_60 ; V_80 ++ )
V_78 [ V_36 + 1 ] . V_55 [ V_80 ] = V_27 [ V_80 + 5 ] ;
V_36 ++ ;
} else {
V_3 = 0xBD ;
V_5 = ( ( ( V_78 [ V_36 ] . V_55 [ 0 ] << 8 ) & 0xff00 ) | ( V_78 [ V_36 ] . V_55 [ 1 ] & 0x00ff ) ) ;
V_4 = V_78 [ V_36 ] . V_58 + ( 2 << 8 ) ;
V_81 = V_78 [ V_36 ] . V_60 - 2 ;
V_60 = V_78 [ V_36 ] . V_60 - 2 ;
for ( V_80 = 0 ; V_80 < V_60 ; V_80 ++ )
V_27 [ V_80 ] = V_78 [ V_36 ] . V_55 [ V_80 + 2 ] ;
F_9 ( V_2 , V_3 , V_4 , V_5 , V_27 , V_81 ) ;
}
}
if ( V_78 [ V_36 ] . V_58 == 0xc0 ) {
if ( V_78 [ V_36 ] . V_59 & V_83 ) {
V_3 = 0xB9 ;
V_5 = 0x0 ;
V_4 = V_78 [ V_36 ] . V_58 ;
V_81 = V_78 [ V_36 ] . V_60 + 6 ;
V_8 = F_1 ( V_2 , V_3 , V_4 , V_5 , V_27 , V_81 ) ;
V_60 = V_78 [ V_36 ] . V_60 ;
for ( V_80 = 0 ; V_80 < V_60 ; V_80 ++ )
V_78 [ V_36 ] . V_55 [ V_80 ] = V_27 [ V_80 + 5 ] ;
} else {
V_3 = 0xBD ;
V_5 = V_78 [ V_36 ] . V_55 [ 0 ] & 0x00FF ;
V_4 = V_78 [ V_36 ] . V_58 + ( 1 << 8 ) ;
V_81 = V_78 [ V_36 ] . V_60 - 1 ;
V_60 = V_78 [ V_36 ] . V_60 - 1 ;
for ( V_80 = 0 ; V_80 < V_60 ; V_80 ++ )
V_27 [ V_80 ] = V_78 [ V_36 ] . V_55 [ V_80 + 1 ] ;
F_9 ( V_2 , V_3 , V_4 , V_5 , V_27 , V_81 ) ;
}
}
}
...
static T_3 F_49 ( struct V_77 * V_84 )
{
return V_85 ;
}
int F_50 ( struct V_86 * V_11 ,
struct V_87 * V_88 ,
struct V_89 * * V_90 ,
int * V_91 )
{
