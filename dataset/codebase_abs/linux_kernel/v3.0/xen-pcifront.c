...
F_71 ( & V_118 ) ;
if ( ! V_119 ) {
F_23 ( & V_4 -> V_23 -> V_24 , L_38 ) ;
V_119 = V_4 ;
} else {
F_18 ( & V_4 -> V_23 -> V_24 , L_39 ) ;
V_28 = - V_120 ;
}
F_72 ( & V_118 ) ;
return V_28 ;
...
V_136 = snprintf ( V_137 , sizeof( V_137 ) , L_59 , V_61 ) ;
...
V_141 )
goto V_43;
V_28 = F_99 ( V_138 , V_4 -> V_23 -> V_139 , L_63 , L_56 ,
& V_147 ) ;
if ( V_28 != 1 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
...
V_28 = F_99 ( V_138 , V_4 -> V_23 -> V_139 , V_137 , L_56 ,
& V_98 ) ;
if ( V_28 != 1 )
V_98 = V_151 ;
if ( V_98 != V_144 )
continue;
V_150 = snprintf ( V_137 , sizeof( V_137 ) , L_66 , V_61 ) ;
if ( F_101 ( V_150 >= ( sizeof( V_137 ) - 1 ) ) ) {
V_28 = - V_89 ;
goto V_43;
}
V_28 = F_99 ( V_138 , V_4 -> V_23 -> V_139 , V_137 ,
L_67 , & V_5 , & V_6 , & V_148 , & V_149 ) ;
if ( V_28 != 4 ) {
if ( V_28 >= 0 )
V_28 = - V_66 ;
F_93 ( V_4 -> V_23 , V_28 ,
