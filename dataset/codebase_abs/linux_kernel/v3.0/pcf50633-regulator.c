...
static int F_11 ( enum V_26 V_27 ,
T_1 V_2 )
{
int V_1 ;
switch ( V_27 ) {
...
return - V_14 ;
V_12 = V_15 [ V_10 ] + 1 ;
return F_13 ( V_9 , V_12 ) & V_29 ;
}
static int T_2 F_19 ( struct V_30 * V_31 )
{
struct V_3 * V_4 ;
struct V_8 * V_9 ;
V_9 = F_20 ( V_31 -> V_32 . V_33 ) ;
V_4 = F_21 ( & V_34 [ V_31 -> V_27 ] , & V_31 -> V_32 ,
V_31 -> V_32 . V_35 , V_9 ) ;
if ( F_22 ( V_4 ) )
return F_23 ( V_4 ) ;
F_24 ( V_31 , V_4 ) ;
if ( V_9 -> V_36 -> V_37 )
V_9 -> V_36 -> V_37 ( V_9 , V_31 -> V_27 ) ;
return 0 ;
}
static int T_3 F_25 ( struct V_30 * V_31 )
{
struct V_3 * V_4 = F_26 ( V_31 ) ;
F_24 ( V_31 , NULL ) ;
F_27 ( V_4 ) ;
return 0 ;
}
