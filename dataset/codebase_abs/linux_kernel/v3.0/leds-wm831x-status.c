...
V_49 = F_19 ( sizeof( struct V_3 ) , V_56 ) ;
if ( ! V_49 )
return - V_57 ;
F_20 ( & V_43 -> V_33 , V_49 ) ;
V_49 -> V_22 = V_22 ;
...
V_48 . V_40 = F_21 ( & V_43 -> V_33 ) ;
F_22 ( & V_49 -> V_6 ) ;
F_23 ( & V_49 -> V_2 , F_1 ) ;
F_24 ( & V_49 -> V_12 ) ;
V_49 -> V_7 = F_25 ( V_22 , V_49 -> V_23 ) ;
if ( V_49 -> V_7 & V_9 )
V_49 -> V_20 = V_60 ;
else
V_49 -> V_20 = V_21 ;
...
V_49 -> V_13 = V_48 . V_61 - 1 ;
}
V_49 -> V_63 . V_40 = V_48 . V_40 ;
V_49 -> V_63 . V_64 = V_48 . V_64 ;
V_49 -> V_63 . V_65 = F_8 ;
V_49 -> V_63 . V_66 = F_11 ;
V_30 = F_26 ( V_22 -> V_33 , & V_49 -> V_63 ) ;
if ( V_30 < 0 ) {
F_18 ( & V_43 -> V_33 , L_5 , V_30 ) ;
goto V_67;
}
V_30 = F_27 ( V_49 -> V_63 . V_33 , & V_68 ) ;
if ( V_30 != 0 )
F_18 ( & V_43 -> V_33 ,
L_6 , V_30 ) ;
return 0 ;
