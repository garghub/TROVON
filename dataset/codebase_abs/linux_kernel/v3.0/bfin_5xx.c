...
V_4 -> V_2 . V_194 = F_143 ( V_187 -> V_207 ,
V_187 -> V_208 - V_187 -> V_207 ) ;
if ( ! V_4 -> V_2 . V_194 ) {
F_137 ( & V_184 -> V_190 , L_21 ) ;
V_188 = - V_209 ;
goto V_206;
}
V_4 -> V_2 . V_210 = V_187 -> V_207 ;
V_4 -> V_2 . V_12 = F_144 ( V_184 , 0 ) ;
if ( V_4 -> V_2 . V_12 < 0 ) {
F_137 ( & V_184 -> V_190 , L_22 ) ;
V_188 = - V_191 ;
goto V_211;
}
V_4 -> V_124 = F_144 ( V_184 , 1 ) ;
if ( V_4 -> V_124 < 0 ) {
...
#if F_28 ( F_83 ) || \
F_28 ( F_8 )
V_187 = F_142 ( V_184 , V_213 , 0 ) ;
if ( V_187 == NULL )
V_4 -> V_5 = - 1 ;
else
V_4 -> V_5 = V_187 -> V_207 ;
V_187 = F_142 ( V_184 , V_213 , 1 ) ;
if ( V_187 == NULL )
V_4 -> V_10 = - 1 ;
else
...
F_149 ( & V_184 -> V_190 , V_4 ) ;
V_188 = F_150 ( & V_185 , & V_4 -> V_2 ) ;
#ifdef F_147
}
#endif
if ( ! V_188 )
...
static int T_7 F_154 ( struct V_183 * V_184 )
{
struct V_3 * V_4 = F_132 ( V_184 ) ;
F_149 ( & V_184 -> V_190 , NULL ) ;
if ( V_4 ) {
F_155 ( & V_185 , & V_4 -> V_2 ) ;
#ifdef F_83
if ( V_4 -> V_10 >= 0 )
...
static int F_161 ( struct V_183 * V_184 )
{
struct V_186 * V_187 ;
int V_188 ;
if ( V_184 -> V_189 < 0 || V_184 -> V_189 >= V_180 ) {
...
struct V_172 T_5 * F_162 ( unsigned int V_2 ,
unsigned int V_217 )
{
struct V_126 V_218 ;
char V_219 [ 20 ] ;
if ( V_2 < 0 || V_2 >= V_180 )
return NULL ;
snprintf ( V_219 , 20 , V_196 L_27 , V_2 ) ;
F_158 ( & V_220 ,
V_219 ) ;
F_159 ( V_221 , 1 , 0 ) ;
if ( ! V_182 . V_2 . V_194 )
