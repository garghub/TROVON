...
if ( V_20 ) {
F_3 ( L_9 ,
V_23 , __LINE__ , F_11 ( V_20 ) ) ;
F_12 ( V_8 , V_9 , V_10 , V_11 , V_12 ) ;
return - V_24 ;
}
F_13 ( V_8 , V_9 , V_10 , V_11 , V_12 , V_13 , V_14 ) ;
if ( V_18 )
* V_18 = V_13 ;
if ( V_19 )
* V_19 = V_14 ;
...
int F_14 ( unsigned int V_25 , const char * V_26 ,
T_1 * V_27 )
{
return F_8 ( V_28 ,
F_6 ( L_12 , V_25 ) ,
...
int F_15 ( unsigned int V_25 , T_1 * V_29 )
{
int V_20 ;
V_20 = F_8 ( V_28 ,
F_6 ( L_12 , V_25 ) ,
...
int F_19 ( unsigned int V_25 , unsigned int V_33 ,
T_1 * V_35 )
{
int V_20 ;
V_20 = F_8 ( V_28 ,
...
int T_2 F_28 ( enum V_30 V_31 ,
int (* F_29)( const struct V_47 * V_48 ) )
{
int V_20 = 0 ;
struct V_47 V_48 ;
F_3 ( L_37 , V_23 , __LINE__ , V_31 ) ;
V_48 . V_31 = V_31 ;
V_20 = F_30 ( V_48 . V_31 , 0 , & V_48 . V_25 ) ;
if ( V_20 ) {
F_3 ( L_29 , V_23 , __LINE__ ) ;
return V_20 ;
}
V_20 = F_15 ( V_48 . V_25 , & V_48 . V_29 ) ;
if ( V_20 ) {
...
int F_30 ( enum V_30 V_31 , unsigned int V_53 ,
unsigned int * V_25 )
{
unsigned int V_7 ;
enum V_30 type ;
...
int F_31 ( const struct V_47 * V_48 ,
enum V_39 V_40 , unsigned int * V_41 )
{
int V_20 = 0 ;
unsigned int V_55 ;
...
int F_43 ( unsigned int V_68 , T_1 * V_69 )
{
return F_8 ( V_21 ,
F_6 ( L_55 , 0 ) ,
F_7 ( L_57 , V_68 ) ,
...
int F_44 ( unsigned int V_70 , T_1 * V_71 )
{
return F_8 ( V_21 ,
F_6 ( L_55 , 0 ) ,
F_7 ( L_57 , 0 ) ,
...
int F_46 ( T_1 * V_73 , T_1 * V_71 , T_1 * V_72 )
{
int V_20 ;
T_1 V_70 ;
F_47 ( & V_70 ) ;
...
int F_55 ( T_1 * V_81 , unsigned int * V_80 )
{
int V_20 ;
* V_80 = 0 ;
V_20 = F_51 ( V_81 ) ;
...
int F_57 ( unsigned int V_83 , T_1 * V_84 )
{
return F_8 ( V_28 ,
F_6 ( L_69 , V_83 ) ,
0 ,
...
int F_60 ( unsigned int V_83 , T_1 * V_86 )
{
int V_20 ;
T_1 V_84 ;
* V_86 = 0 ;
...
int F_61 ( unsigned int V_83 , T_1 * V_87 ,
T_1 * V_88 )
{
int V_20 ;
T_1 V_84 ;
...
int F_62 ( const struct V_47 * V_48 )
{
int V_20 = 0 ;
unsigned int V_55 ;
F_3 ( L_73 , V_23 , __LINE__ ,
V_48 -> V_25 , V_48 -> V_33 ) ;
for ( V_55 = 0 ; V_55 < 10 ; V_55 ++ ) {
enum V_39 V_40 ;
unsigned int V_41 ;
...
F_3 ( L_80
L_81 ,
V_23 , __LINE__ , V_48 -> V_25 , V_48 -> V_33 , V_59 ,
V_60 , V_61 , V_62 ) ;
...
{
int V_20 = 0 ;
F_3 ( L_84 , V_23 , __LINE__ , V_48 -> V_25 ) ;
