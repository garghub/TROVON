...
static struct V_8 * F_18 ( struct V_30 * V_31 ,
struct V_35 * V_36 )
{
int V_39 , V_33 ;
...
for ( V_39 = 0 ; V_39 < V_44 ; ++ V_39 ) {
struct V_8 * V_49 = F_18 ( V_31 , V_42 [ V_39 ] ) ;
if ( V_49 && V_49 != V_9 ) {
F_21 ( V_31 -> V_2 , L_6 ) ;
V_16 = - V_19 ;
goto V_21;
...
V_16 = F_33 ( V_7 , V_23 , V_9 -> V_22 -> type ) ;
if ( V_16 ) {
F_21 ( V_2 , L_9 ) ;
goto V_21;
}
...
for ( V_39 = 0 ; V_39 < V_31 -> V_40 ; V_39 ++ ) {
int V_33 ;
for ( V_33 = 0 ; V_33 < F_39 ( V_64 ) ; V_33 ++ ) {
V_16 = F_40 ( V_31 -> V_41 [ V_39 ] -> V_2 ,
& V_64 [ V_33 ] ) ;
if ( V_16 ) {
F_21 ( V_31 -> V_2 , L_13
L_14 ) ;
...
void F_41 ( struct V_30 * V_31 )
{
int V_39 , V_33 ;
F_22 ( L_15 ) ;
for ( V_39 = 0 ; V_39 < V_31 -> V_40 ; V_39 ++ ) {
for ( V_33 = 0 ; V_33 < F_39 ( V_64 ) ; V_33 ++ )
F_42 ( V_31 -> V_41 [ V_39 ] -> V_2 ,
& V_64 [ V_33 ] ) ;
}
}
