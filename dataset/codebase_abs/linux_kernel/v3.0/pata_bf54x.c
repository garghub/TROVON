...
void T_1 * V_12 = ( void T_1 * ) V_6 -> V_13 . V_14 ;
unsigned short V_168 = F_23 ( V_12 ) ;
if ( F_68 ( V_12 ) & ( V_169 | V_170 ) )
V_167 |= V_171 ;
if ( V_168 & ( V_172 | V_173 | V_174 |
V_175 ) )
V_167 |= V_176 ;
if ( V_168 & ( V_177 | V_178 | V_179 ) )
V_167 |= V_180 | V_176 ;
F_4 ( V_6 -> V_25 , L_15 , V_167 ) ;
return V_167 ;
}
...
void T_1 * V_12 = ( void T_1 * ) V_6 -> V_13 . V_14 ;
unsigned int V_183 = V_181 >> 1 ;
unsigned short * V_184 = ( V_185 * ) V_94 ;
if ( V_182 == V_186 )
F_32 ( V_12 , V_183 , V_184 ) ;
else
F_30 ( V_12 , V_183 , V_184 ) ;
if ( F_70 ( V_181 & 0x01 ) ) {
unsigned short V_187 [ 1 ] = { 0 } ;
unsigned char * V_188 = V_94 + V_181 - 1 ;
if ( V_182 == V_186 ) {
F_32 ( V_12 , 1 , V_187 ) ;
memcpy ( V_188 , V_187 , 1 ) ;
} else {
memcpy ( V_187 , V_188 , 1 ) ;
F_30 ( V_12 , 1 , V_187 ) ;
}
V_183 ++ ;
}
...
if ( V_160 [ 1 ] != V_189 )
F_40 ( V_6 , 0 ) ;
if ( V_160 [ 0 ] == V_189 && V_160 [ 1 ] == V_189 ) {
return;
}
F_25 ( V_12 , V_103 , V_6 -> V_101 ) ;
}
...
struct V_132 * V_133 )
{
struct V_190 * V_191 = & V_6 -> V_24 . V_192 ;
T_2 V_85 , V_167 = 0 ;
F_81 ( L_24 ,
V_6 -> V_127 , V_133 -> V_97 . V_193 , V_6 -> V_149 ) ;
switch ( V_6 -> V_149 ) {
case V_194 :
if ( ! ( V_133 -> V_25 -> V_99 & V_195 ) )
goto V_196;
break;
case V_150 :
if ( V_133 -> V_97 . V_193 == V_197 ||
V_133 -> V_97 . V_193 == V_198 ) {
V_167 = V_6 -> V_199 -> V_200 ( V_6 ) ;
F_81 ( L_25 ,
V_6 -> V_127 , V_167 ) ;
if ( ! ( V_167 & V_176 ) )
goto V_196;
V_6 -> V_199 -> V_201 ( V_133 ) ;
if ( F_70 ( V_167 & V_180 ) ) {
V_133 -> V_163 |= V_202 ;
V_6 -> V_149 = V_203 ;
}
...
V_85 = V_6 -> V_199 -> V_205 ( V_6 ) ;
if ( V_85 & V_206 )
goto V_207;
V_85 = V_6 -> V_199 -> V_208 ( V_6 ) ;
if ( F_70 ( V_85 & V_206 ) )
goto V_207;
V_6 -> V_199 -> V_209 ( V_6 ) ;
F_82 ( V_6 , V_133 , V_85 , 0 ) ;
if ( F_70 ( V_133 -> V_163 ) && ( V_133 -> V_97 . V_193 == V_197 ||
V_133 -> V_97 . V_193 == V_198 ) )
F_83 ( V_191 , L_26 , V_167 ) ;
V_207:
return 1 ;
V_196:
V_6 -> V_210 . V_196 ++ ;
#ifdef F_84
if ( ( V_6 -> V_210 . V_196 % 1000 ) == 0 ) {
V_6 -> V_199 -> V_211 ( V_6 , 0 ) ;
F_65 ( V_6 , V_212 , L_27 ) ;
return 1 ;
}
#endif
...
static T_3 F_85 ( int V_213 , void * V_214 )
{
struct V_215 * V_216 = V_214 ;
unsigned int V_86 ;
unsigned int V_217 = 0 ;
unsigned long V_99 ;
F_86 ( & V_216 -> V_218 , V_99 ) ;
for ( V_86 = 0 ; V_86 < V_216 -> V_219 ; V_86 ++ ) {
struct V_5 * V_6 = V_216 -> V_220 [ V_86 ] ;
struct V_132 * V_133 ;
V_133 = F_87 ( V_6 , V_6 -> V_24 . V_221 ) ;
if ( V_133 && ( ! ( V_133 -> V_97 . V_99 & V_222 ) ) )
V_217 |= F_80 ( V_6 , V_133 ) ;
}
F_88 ( & V_216 -> V_218 , V_99 ) ;
return F_89 ( V_217 ) ;
}
static int F_90 ( struct V_215 * V_216 )
{
void T_1 * V_12 = ( void T_1 * ) V_216 -> V_220 [ 0 ] -> V_13 . V_14 ;
int V_223 ;
unsigned short V_85 ;
F_10 ( V_12 , 0 ) ;
F_12 () ;
F_8 ( V_12 , F_9 ( V_12 ) | V_224 ) ;
F_63 ( 30 ) ;
F_8 ( V_12 , F_9 ( V_12 ) & ~ V_224 ) ;
F_91 ( 2 ) ;
V_223 = 10000000 ;
...
} while ( -- V_223 && ( V_85 & V_206 ) );
F_10 ( V_12 , 1 ) ;
F_12 () ;
return ( ! V_223 ) ;
}
static int T_4 F_92 ( struct V_225 * V_226 )
{
int V_227 = 0 ;
struct V_228 * V_229 ;
struct V_215 * V_216 ;
...
{ & V_233 [ V_227 ] , NULL } ;
if ( F_70 ( V_226 -> V_234 != 2 ) ) {
F_79 ( & V_226 -> V_25 , L_28 ) ;
return - V_235 ;
}
V_229 = F_93 ( V_226 , V_236 , 0 ) ;
if ( V_229 == NULL )
return - V_235 ;
while ( V_233 [ V_227 ] . V_143 > 0 &&
V_58 [ V_230 ] > V_2 ) {
V_230 -- ;
V_233 [ V_227 ] . V_143 >>= 1 ;
}
V_216 = F_94 ( & V_226 -> V_25 , V_232 , 1 ) ;
if ( ! V_216 )
return - V_237 ;
V_216 -> V_220 [ 0 ] -> V_13 . V_14 = ( void * ) V_229 -> V_238 ;
if ( F_95 ( V_239 , L_29 ) ) {
F_79 ( & V_226 -> V_25 , L_30 ) ;
return - V_240 ;
}
if ( F_90 ( V_216 ) ) {
F_96 ( V_239 ) ;
F_79 ( & V_226 -> V_25 , L_31 ) ;
return - V_240 ;
}
if ( F_97 ( V_216 , F_98 ( V_226 , 0 ) ,
F_85 , V_241 , & V_242 ) != 0 ) {
F_96 ( V_239 ) ;
F_79 ( & V_226 -> V_25 , L_32 ) ;
return - V_243 ;
}
F_99 ( & V_226 -> V_25 , V_216 ) ;
return 0 ;
}
static int T_5 F_100 ( struct V_225 * V_226 )
{
struct V_122 * V_25 = & V_226 -> V_25 ;
struct V_215 * V_216 = F_101 ( V_25 ) ;
F_102 ( V_216 ) ;
F_99 ( & V_226 -> V_25 , NULL ) ;
F_96 ( V_239 ) ;
return 0 ;
}
static int F_103 ( struct V_225 * V_226 , T_6 V_244 )
{
struct V_215 * V_216 = F_101 ( & V_226 -> V_25 ) ;
if ( V_216 )
return F_104 ( V_216 , V_244 ) ;
else
return 0 ;
}
