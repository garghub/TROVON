...
if ( ! V_90 -> V_27 . V_92 )
goto V_143;
V_9 = F_33 ( V_272 , V_90 -> V_27 . V_92 , & V_270 ) ;
if ( ! V_9 ) {
F_43 ( V_109 L_36 ,
V_2 -> V_55 ) ;
goto V_143;
...
F_43 ( V_109 L_37 , V_2 -> V_55 ) ;
goto V_143;
}
V_90 -> V_27 . V_92 -> V_273 = F_46 ;
V_104 = F_47 ( & V_2 -> V_91 , V_274 , V_2 ,
& V_2 -> V_56 -> V_2 , V_275 , 0 , NULL ) ;
if ( ! V_104 ) {
...
if ( V_2 -> V_120 == V_121 ) {
struct V_276 V_277 ;
static int V_3 = V_278 | V_279 ;
V_277 . V_40 = V_280 ;
V_277 . V_28 = & V_3 ;
F_13 ( V_2 , V_40 , V_281 , & V_277 ) ;
