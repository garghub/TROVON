...
static int F_13 ( struct V_16 * V_17 , struct V_18 * V_50 , int V_5 )
{
struct V_36 * V_37 = (struct V_36 * ) V_17 ;
...
if ( V_37 -> V_52 && V_37 -> V_52 != ( ( F_14 ( V_4 -> V_53 ) >> 20 ) & 0xff ) )
return 0 ;
return 1 ;
}
static int F_15 ( struct V_16 * V_17 , struct V_54 * V_55 ,
struct V_56 * V_57 ,
struct V_58 * * V_59 )
{
int V_60 = - V_61 ;
struct V_2 * V_2 = F_16 ( V_55 -> V_62 ) ;
...
if ( V_57 -> V_67 )
F_18 ( & V_63 -> V_39 . V_47 , V_59 [ V_68 ] ,
sizeof( struct V_42 ) ) ;
if ( V_57 -> V_69 )
F_18 ( & V_63 -> V_15 . V_47 , V_59 [ V_70 ] ,
sizeof( struct V_42 ) ) ;
...
static int F_19 ( struct V_16 * V_17 , struct V_56 * V_57 ,
struct V_58 * * V_59 )
{
struct V_36 * V_63 = (struct V_36 * ) V_17 ;
...
return 0 ;
if ( V_57 -> V_67 &&
F_20 ( V_59 [ V_68 ] , & V_63 -> V_39 . V_47 , sizeof( struct V_42 ) ) )
return 0 ;
if ( V_57 -> V_69 &&
F_20 ( V_59 [ V_70 ] , & V_63 -> V_15 . V_47 , sizeof( struct V_42 ) ) )
return 0 ;
return 1 ;
}
static int F_21 ( struct V_16 * V_17 , struct V_54 * V_55 ,
struct V_56 * V_57 )
{
struct V_36 * V_63 = (struct V_36 * ) V_17 ;
...
V_57 -> V_71 = V_63 -> V_52 ;
if ( V_63 -> V_15 . V_40 )
F_22 ( V_55 , V_70 , sizeof( struct V_42 ) ,
& V_63 -> V_15 . V_47 ) ;
if ( V_63 -> V_39 . V_40 )
F_22 ( V_55 , V_68 , sizeof( struct V_42 ) ,
& V_63 -> V_39 . V_47 ) ;
return 0 ;
V_72:
return - V_66 ;
}
static T_2 F_23 ( struct V_73 * V_74 )
{
return 0x3FFF ;
}
...
return F_29 ( V_74 ) ;
V_2 -> V_11 . V_12 = V_74 ;
V_60 = F_30 ( V_2 -> V_11 . V_12 , 0 ,
V_77 , 0 ) ;
if ( V_60 )
goto V_78;
V_60 = F_30 ( V_2 -> V_11 . V_12 ,
0x7FFE , V_79 , 0 ) ;
if ( V_60 )
goto V_78;
V_48:
