...
struct V_7 * V_8 = V_31 -> V_33 ;
struct V_63 V_64 ;
T_2 V_65 = 0 , V_48 , V_46 , V_47 ;
T_1 V_1 [ V_3 ] ;
T_1 V_66 , V_49 , V_50 ;
F_5 ( V_20 , V_23 , 1 , L_12 ) ;
if ( V_31 -> V_67 . V_68 ) {
F_5 ( V_20 , V_23 , 1 , L_13 ) ;
V_31 -> V_67 . V_68 ( V_31 , & V_64 ) ;
}
V_65 = V_64 . V_69 . V_70 . V_71 ;
V_9 = F_8 ( V_8 , V_43 , 0x4d | V_44 ) ;
if ( V_9 < 0 )
return V_9 ;
V_1 [ V_72 ] = 0xeb ;
V_9 = F_8 ( V_8 , V_72 , V_1 [ V_72 ] ) ;
if ( V_9 < 0 )
return V_9 ;
if ( V_45 <= 1075000 )
V_50 = 1 ;
...
for ( V_62 = V_73 ;
( V_62 -> V_74 != 0 ) && ! F_15 ( V_45 , V_62 -> V_75 , V_62 -> V_74 ) ;
V_62 ++ ) ;
if ( V_62 -> V_74 == 0 ) {
F_16 ( V_76 L_14 , V_35 , V_45 ) ;
return - V_26 ;
}
V_1 [ V_51 ] = ( V_1 [ V_51 ] & ~ V_77 ) | V_62 -> V_25 ;
...
if ( V_65 >= 15000000 )
V_66 = 9 ;
else if ( V_65 >= 5000000 )
V_66 = 11 ;
else
V_66 = 14 ;
V_1 [ V_78 ] = ( 0x10 & ~ V_79 ) | V_66 ;
V_1 [ V_78 ] &= ~ V_80 ;
V_1 [ V_78 ] |= ( 1 << 5 ) ;
V_9 = F_8 ( V_8 , V_78 , V_1 [ V_78 ] ) ;
if ( V_9 < 0 )
return V_9 ;
V_1 [ V_81 ] = 0xcc ;
...
F_5 ( V_20 , V_23 , 1 ,
L_15 ,
V_45 , V_65 , ( unsigned int ) V_66 , ( unsigned int ) V_50 ,
...
const struct V_99 * V_13 ,
struct V_100 * V_19 )
{
struct V_7 * V_8 = NULL ;
V_8 = F_23 ( sizeof ( struct V_7 ) , V_101 ) ;
if ( V_8 == NULL )
goto error;
V_8 -> V_13 = V_13 ;
V_8 -> V_19 = V_19 ;
V_8 -> V_102 = V_31 ;
V_8 -> V_60 = V_13 -> V_89 / 1000 ;
V_31 -> V_33 = V_8 ;
V_31 -> V_67 . V_103 = V_104 ;
F_16 ( L_16 , V_35 ) ;
return V_31 ;
error:
F_24 ( V_8 ) ;
