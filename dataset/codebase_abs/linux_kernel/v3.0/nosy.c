...
F_37 ( & V_2 -> V_63 ) ;
F_69 ( & V_2 -> V_3 ) ;
V_2 -> V_27 = F_70 ( F_71 ( V_38 , 0 ) ,
V_104 ) ;
V_2 -> V_94 = F_72 ( V_2 -> V_37 ,
sizeof( struct V_93 ) , & V_2 -> V_89 ) ;
V_2 -> V_70 = F_72 ( V_2 -> V_37 ,
sizeof( struct V_93 ) , & V_2 -> V_95 ) ;
V_2 -> V_72 = F_72 ( V_2 -> V_37 ,
V_105 , & V_2 -> V_97 ) ;
if ( V_2 -> V_94 == NULL ||
V_2 -> V_70 == NULL ||
V_2 -> V_72 == NULL ) {
...
V_2 -> V_94 -> V_107 = F_73 ( V_2 -> V_95 ) ;
V_2 -> V_70 -> V_107 = F_73 ( V_108 ) ;
V_2 -> V_70 -> V_109 = F_73 ( V_108 ) ;
V_2 -> V_70 -> V_5 [ 0 ] . V_110 =
F_73 ( V_111 | V_112 | 2044 ) ;
...
F_73 ( V_111 | V_112 | 2048 ) ;
V_2 -> V_70 -> V_5 [ V_101 ] . V_113 = F_73 ( V_100 ) ;
}
V_2 -> V_70 -> V_5 [ V_101 - 1 ] . V_110 |= F_73 ( V_114 ) ;
