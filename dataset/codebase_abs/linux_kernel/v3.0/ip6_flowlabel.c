...
static struct V_1 *
F_36 ( struct V_2 * V_2 , struct V_52 * V_53 , char T_3 * V_54 ,
int V_55 , int * V_56 )
{
struct V_1 * V_4 = NULL ;
int V_57 ;
...
V_59 = F_41 ( V_2 , & V_65 , & V_66 , V_4 -> V_10 , & V_67 ,
& V_67 , & V_67 ) ;
if ( V_59 )
goto V_61;
V_59 = - V_60 ;
...
static int F_48 ( struct V_90 * V_91 , struct V_90 * V_92 )
{
if ( V_91 == V_92 )
return 0 ;
...
static int F_49 ( struct V_18 * V_94 , struct V_18 * V_95 )
{
if ( V_94 == V_95 )
return 0 ;
...
return 1 ;
if ( F_48 ( V_94 -> V_42 , V_95 -> V_42 ) )
return 1 ;
if ( F_48 ( V_94 -> V_43 , V_95 -> V_43 ) )
return 1 ;
if ( F_48 ( (struct V_90 * ) V_94 -> V_44 , (struct V_90 * ) V_95 -> V_44 ) )
return 1 ;
return 0 ;
}
static inline void F_50 ( struct V_34 * V_35 , struct V_32 * V_33 ,
struct V_1 * V_4 )
{
F_12 ( & V_36 ) ;
V_33 -> V_4 = V_4 ;
...
int F_51 ( struct V_30 * V_31 , char T_3 * V_54 , int V_55 )
{
int V_96 ( V_59 ) ;
struct V_2 * V_2 = F_52 ( V_31 ) ;
struct V_34 * V_35 = F_30 ( V_31 ) ;
struct V_52 V_53 ;
...
if ( V_53 . V_102 & ~ V_29 )
return - V_60 ;
V_4 = F_36 ( V_2 , & V_53 , V_54 , V_55 , & V_59 ) ;
if ( V_4 == NULL )
return V_59 ;
...
goto V_112;
V_59 = - V_60 ;
if ( ! F_53 ( & V_99 -> V_78 , & V_4 -> V_78 ) ||
F_49 ( V_99 -> V_10 , V_4 -> V_10 ) )
goto V_112;
V_59 = - V_62 ;
if ( V_97 == NULL )
goto V_112;
...
goto V_61;
V_59 = - V_62 ;
if ( V_97 == NULL || ( V_59 = F_47 ( V_31 ) ) != 0 )
goto V_61;
V_99 = F_26 ( V_2 , V_4 , V_53 . V_102 ) ;
if ( V_99 != NULL )
goto V_111;
if ( ! V_53 . V_102 ) {
if ( F_54 ( & ( (struct V_52 T_3 * ) V_54 ) -> V_102 ,
...
static struct V_1 * F_55 ( struct V_115 * V_116 )
{
struct V_1 * V_4 = NULL ;
struct V_117 * V_118 = F_56 ( V_116 ) ;
struct V_2 * V_2 = F_57 ( V_116 ) ;
...
static struct V_1 * F_58 ( struct V_115 * V_116 , struct V_1 * V_4 )
{
struct V_117 * V_118 = F_56 ( V_116 ) ;
struct V_2 * V_2 = F_57 ( V_116 ) ;
V_4 = V_4 -> V_6 ;
...
static struct V_1 * F_59 ( struct V_115 * V_116 , T_4 V_121 )
{
struct V_1 * V_4 = F_55 ( V_116 ) ;
if ( V_4 )
while ( V_121 && ( V_4 = F_58 ( V_116 , V_4 ) ) != NULL )
-- V_121 ;
return V_121 ? NULL : V_4 ;
}
static void * F_60 ( struct V_115 * V_116 , T_4 * V_121 )
__acquires( V_8 )
{
F_5 ( & V_8 ) ;
return * V_121 ? F_59 ( V_116 , * V_121 - 1 ) : V_122 ;
}
static void * F_61 ( struct V_115 * V_116 , void * V_123 , T_4 * V_121 )
{
struct V_1 * V_4 ;
if ( V_123 == V_122 )
V_4 = F_55 ( V_116 ) ;
else
V_4 = F_58 ( V_116 , V_123 ) ;
++ * V_121 ;
return V_4 ;
}
static void F_62 ( struct V_115 * V_116 , void * V_123 )
__releases( V_8 )
{
F_7 ( & V_8 ) ;
}
static int F_63 ( struct V_115 * V_116 , void * V_123 )
{
if ( V_123 == V_122 )
F_64 ( V_116 , L_1 ,
...
static int F_66 ( struct V_124 * V_124 , struct V_125 * V_125 )
{
return F_67 ( V_124 , V_125 , & V_126 ,
sizeof( struct V_117 ) ) ;
}
static int T_5 F_68 ( struct V_2 * V_2 )
{
if ( ! F_69 ( V_2 , L_11 ,
V_127 , & V_128 ) )
return - V_62 ;
...
static void T_2 F_70 ( struct V_2 * V_2 )
{
F_71 ( V_2 , L_11 ) ;
}
...
static void T_2 F_72 ( struct V_2 * V_2 )
{
F_25 ( V_2 ) ;
F_70 ( V_2 ) ;
}
