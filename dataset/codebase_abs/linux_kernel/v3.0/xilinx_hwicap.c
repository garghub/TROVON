...
static int T_6 F_21 ( struct V_53 * V_21 , int V_54 ,
...
V_2 -> V_70 = V_56 -> V_71 ;
V_2 -> V_72 = V_56 -> V_73 ;
V_2 -> V_74 = V_56 -> V_73 - V_56 -> V_71 + 1 ;
if ( ! F_26 ( V_2 -> V_70 ,
V_2 -> V_74 , V_64 ) ) {
F_19 ( V_21 , L_12 ,
...
V_2 -> V_59 = V_59 ;
V_2 -> V_21 = V_21 ;
V_2 -> V_75 = F_27 ( V_2 -> V_70 , V_2 -> V_74 ) ;
if ( ! V_2 -> V_75 ) {
F_19 ( V_21 , L_13 ) ;
goto V_76;
}
...
F_29 ( & V_2 -> V_48 , & V_77 ) ;
V_2 -> V_48 . V_78 = V_79 ;
V_60 = F_30 ( & V_2 -> V_48 , V_59 , 1 ) ;
if ( V_60 ) {
F_19 ( V_21 , L_15 ) ;
goto V_80;
}
F_31 ( V_81 , V_21 , V_59 , NULL , L_16 , V_64 , V_54 ) ;
return 0 ;
V_80:
F_32 ( V_2 -> V_75 ) ;
V_76:
F_33 ( V_56 -> V_71 , V_2 -> V_74 ) ;
V_69:
F_34 ( V_2 ) ;
V_68:
F_17 ( & V_61 ) ;
...
static int T_8 F_35 ( struct V_53 * V_21 )
{
struct V_1 * V_2 ;
V_2 = (struct V_1 * ) F_36 ( V_21 ) ;
if ( ! V_2 )
return 0 ;
F_37 ( V_81 , V_2 -> V_59 ) ;
F_38 ( & V_2 -> V_48 ) ;
F_32 ( V_2 -> V_75 ) ;
F_33 ( V_2 -> V_70 , V_2 -> V_74 ) ;
F_34 ( V_2 ) ;
F_25 ( V_21 , NULL ) ;
F_17 ( & V_61 ) ;
V_63 [ F_39 ( V_21 -> V_59 ) - V_67 ] = 0 ;
F_12 ( & V_61 ) ;
return 0 ;
}
static int T_6 F_40 ( struct V_82 * V_83 ,
const struct V_57 * V_9 )
{
struct V_55 V_84 ;
...
V_86 = F_41 ( V_83 -> V_21 . V_88 , 0 , & V_84 ) ;
if ( V_86 ) {
F_19 ( & V_83 -> V_21 , L_17 ) ;
return V_86 ;
}
V_54 = F_42 ( V_83 -> V_21 . V_88 , L_18 , NULL ) ;
V_87 = & V_89 ;
V_85 = F_42 ( V_83 -> V_21 . V_88 , L_19 , NULL ) ;
if ( V_85 ) {
if ( ! strcmp ( V_85 , L_20 ) ) {
V_87 = & V_90 ;
...
static inline int F_40 ( struct V_82 * V_83 ,
const struct V_57 * V_9 )
{
return - V_65 ;
}
static int T_6 F_43 ( struct V_82 * V_92 )
{
const struct V_93 * V_94 ;
struct V_55 * V_84 ;
const struct V_58 * V_87 ;
const char * V_85 ;
V_94 = F_44 ( V_95 , & V_92 -> V_21 ) ;
if ( V_94 )
return F_40 ( V_92 , V_94 -> V_96 ) ;
V_84 = F_45 ( V_92 , V_97 , 0 ) ;
if ( ! V_84 )
return - V_98 ;
V_87 = & V_89 ;
V_85 = V_92 -> V_21 . V_99 ;
...
return F_21 ( & V_92 -> V_21 , V_92 -> V_54 , V_84 ,
& V_100 , V_87 ) ;
}
static int T_8 F_46 ( struct V_82 * V_92 )
{
return F_35 ( & V_92 -> V_21 ) ;
}
