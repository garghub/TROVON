...
switch ( V_5 ) {
case 1 :
* V_6 = F_5 ( F_15 ( V_12 , V_4 ) ) ;
break;
case 2 :
* V_6 = F_6 ( F_15 ( V_12 , V_4 ) ) ;
break;
case 4 :
* V_6 = F_7 ( F_15 ( V_12 , V_4 ) ) ;
break;
}
F_10 ( 0 , 0xCF8 ) ;
F_8 ( & V_9 , V_7 ) ;
...
static int F_16 ( unsigned int V_1 , unsigned int V_2 ,
unsigned int V_3 , int V_4 , int V_5 , T_1 V_6 )
{
unsigned long V_7 ;
int V_12 , V_13 ;
...
switch ( V_5 ) {
case 1 :
F_10 ( ( V_10 ) V_6 , F_15 ( V_12 , V_4 ) ) ;
break;
case 2 :
F_11 ( ( V_11 ) V_6 , F_15 ( V_12 , V_4 ) ) ;
break;
case 4 :
F_3 ( ( T_1 ) V_6 , F_15 ( V_12 , V_4 ) ) ;
break;
}
F_10 ( 0 , 0xCF8 ) ;
F_8 ( & V_9 , V_7 ) ;
...
static int T_2 F_17 ( struct V_15 * V_16 )
{
T_1 V_17 = 0 ;
int V_18 , V_3 ;
if ( V_19 & V_20 )
return 1 ;
F_18 ( V_21 , & V_18 , NULL , NULL ) ;
if ( V_18 >= 2001 )
return 1 ;
...
if ( F_7 ( 0xCF8 ) == 0x80000000 && F_17 ( & V_32 ) ) {
V_31 = 1 ;
}
F_3 ( V_30 , 0xCF8 ) ;
F_22 ( V_7 ) ;
