...
{
struct V_13 * V_14 = V_9 -> V_9 . V_15 ;
static const char * V_71 [] = { L_2 , NULL } ;
int V_64 , V_65 ;
int V_72 ;
struct V_11 * V_12 ;
unsigned long V_73 = V_14 -> V_74 ;
struct V_75 * V_76 ;
V_76 = F_27 ( V_9 , V_77 , 0 ) ;
if ( ! V_76 )
return - V_78 ;
V_12 = F_28 ( & V_9 -> V_9 , sizeof( * V_12 ) , V_79 ) ;
if ( ! V_12 )
return - V_80 ;
if ( ! F_29 ( & V_9 -> V_9 , V_76 -> V_81 ,
F_30 ( V_76 ) , F_31 ( & V_9 -> V_9 ) ) )
return - V_82 ;
V_12 -> V_16 = F_32 ( & V_9 -> V_9 , V_76 -> V_81 ,
F_30 ( V_76 ) ) ;
if ( ! V_12 -> V_16 )
return - V_82 ;
V_64 = V_14 -> V_64 ? : 20 ;
...
if ( V_14 -> V_89 != 1 ) {
V_8 -> V_36 = V_72 ;
V_8 -> V_104 = F_40 ( V_79 , L_6 ,
F_31 ( & V_9 -> V_9 ) , V_72 ) ;
} else {
V_8 -> V_36 = - 1 ;
V_8 -> V_104 = F_41 ( F_31 ( & V_9 -> V_9 ) ,
V_79 ) ;
}
if ( ! V_8 -> V_104 ) {
F_42 ( V_8 ) ;
...
V_88 = F_43 ( V_3 , V_71 ,
& V_12 -> V_109 [ V_72 ] , 0 ) ;
F_44 ( V_3 , V_12 -> V_109 [ V_72 ] , V_88 ) ;
V_12 -> V_110 [ V_72 ] = V_3 ;
}
return 0 ;
}
static int T_5 F_45 ( struct V_1 * V_9 )
{
struct V_11 * V_12 = F_3 ( V_9 ) ;
int V_72 ;
F_38 ( V_9 , NULL ) ;
...
return 0 ;
for ( V_72 = 0 ; V_72 < V_87 ; V_72 ++ ) {
struct V_2 * V_3 = V_12 -> V_110 [ V_72 ] ;
struct V_4 * V_5 ;
struct V_7 * V_8 ;
if ( ! V_3 )
continue;
