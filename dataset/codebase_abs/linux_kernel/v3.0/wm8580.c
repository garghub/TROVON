...
V_46 -> V_56 = V_41 ;
V_11 = F_15 ( V_9 , V_57 ) ;
F_16 ( V_9 , V_57 , V_11 | V_47 ) ;
if ( ! V_40 || ! V_41 )
return 0 ;
F_16 ( V_9 , V_58 + V_42 , V_20 . V_36 & 0x1ff ) ;
F_16 ( V_9 , V_59 + V_42 , ( V_20 . V_36 >> 9 ) & 0x1ff ) ;
F_16 ( V_9 , V_60 + V_42 ,
( V_20 . V_36 >> 18 & 0xf ) | ( V_20 . V_34 << 4 ) ) ;
V_11 = F_15 ( V_9 , V_61 + V_42 ) ;
V_11 &= ~ 0x1b ;
V_11 |= V_20 . V_33 | V_20 . V_30 << 1 |
V_20 . V_29 << 3 ;
F_16 ( V_9 , V_61 + V_42 , V_11 ) ;
V_11 = F_15 ( V_9 , V_57 ) ;
F_16 ( V_9 , V_57 , V_11 & ~ V_47 ) ;
return 0 ;
}
...
unsigned int V_96 ;
int V_97 ;
V_95 = F_15 ( V_9 , V_90 + V_38 -> V_82 -> V_83 ) ;
V_96 = F_15 ( V_9 , V_89 + V_38 -> V_82 -> V_83 ) ;
...
F_16 ( V_9 , V_90 + V_38 -> V_82 -> V_83 , V_95 ) ;
F_16 ( V_9 , V_89 + V_38 -> V_82 -> V_83 , V_96 ) ;
return 0 ;
}
