...
struct V_4 * F_41 ( struct V_25 * V_26 , int V_53 )
{
struct V_4 * V_5 ;
T_1 V_54 = V_41 ;
if ( V_26 -> V_55 && V_53 )
V_54 |= V_56 ;
V_5 = F_28 ( sizeof( struct V_4 ) + V_53 , V_54 ) ;
if ( ! V_5 )
return NULL ;
V_5 -> V_22 = & V_5 -> V_57 ;
F_42 ( V_5 -> V_22 ) ;
...
V_5 -> V_23 . V_90 = V_91 ;
V_5 -> V_49 = F_49 ( V_92 , V_5 ,
L_7 , V_5 -> V_29 ) ;
if ( F_50 ( V_5 -> V_49 ) ) {
F_21 ( V_93 L_8 ,
V_5 -> V_29 , F_51 ( V_5 -> V_49 ) ) ;
goto V_94;
}
F_52 ( V_5 -> V_27 ) ;
return V_5 ;
...
struct V_4 * F_53 ( struct V_25 * V_26 , int V_53 )
{
struct V_4 * V_5 = F_41 ( V_26 , V_53 ) ;
if ( ! V_26 -> V_95 ) {
F_21 ( V_93 L_9
L_10 , V_26 -> V_31 ) ;
F_54 () ;
...
static int F_59 ( struct V_1 * V_2 , void * V_98 )
{
struct V_4 * V_99 ;
unsigned short * V_100 = ( unsigned short * ) V_98 ;
V_99 = F_3 ( V_2 ) ;
return V_99 -> V_29 == * V_100 ;
}
struct V_4 * F_60 ( unsigned short V_100 )
{
struct V_1 * V_101 ;
struct V_4 * V_5 = NULL ;
V_101 = F_61 ( & V_89 , NULL , & V_100 ,
F_59 ) ;
if ( V_101 ) {
V_5 = F_62 ( F_3 ( V_101 ) ) ;
F_2 ( V_101 ) ;
...
{
return V_2 -> type == & V_87 ;
}
int F_68 ( struct V_4 * V_5 , struct V_102 * V_103 )
{
if ( F_69 ( ! V_5 -> V_46 ) ) {
F_21 ( V_18
L_11
