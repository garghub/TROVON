...
} else if ( V_96 -> V_9 == ( 4 + sizeof( V_128 ) )
&& 0 == memcmp ( V_8 , V_128 ,
sizeof( V_128 ) ) ) {
F_15 ( & V_16 -> V_25 , V_20 ) ;
V_16 -> V_20 |= V_90 ;
...
static int F_64 ( struct V_85 * V_84 )
{
int V_80 = 0 ;
struct V_6 * V_7 = V_84 -> V_7 [ 0 ] ;
struct V_15 * V_16 = NULL ;
F_19 ( L_3 , V_14 ) ;
V_16 = F_65 ( sizeof( struct V_15 ) , V_86 ) ;
if ( V_16 == NULL ) {
F_14 ( & V_7 -> V_13 , L_47 , V_14 ) ;
return - V_102 ;
}
F_66 ( & V_16 -> V_129 ) ;
F_67 ( & V_16 -> V_25 ) ;
F_68 ( & V_16 -> V_27 ) ;
V_16 -> V_129 . V_8 = ( unsigned long ) V_16 ;
V_16 -> V_129 . V_132 = F_63 ;
V_16 -> V_7 = V_7 ;
V_16 -> V_18 = 0 ;
V_16 -> V_20 = 0 ;
V_16 -> V_40 = 0 ;
...
static void F_70 ( struct V_85 * V_84 )
{
struct V_6 * V_7 = V_84 -> V_7 [ 0 ] ;
struct V_15 * V_16 = F_33 ( V_7 ) ;
F_19 ( L_3 , V_14 ) ;
...
static void F_72 ( struct V_85 * V_84 )
{
struct V_6 * V_7 = V_84 -> V_7 [ 0 ] ;
struct V_15 * V_16 = F_33 ( V_7 ) ;
F_19 ( L_3 , V_14 ) ;
...
if ( V_118 )
goto V_136;
F_76 (KERN_INFO KBUILD_MODNAME L_48 DRIVER_VERSION L_49
DRIVER_DESC L_50 ) ;
return 0 ;
V_136:
F_77 ( & V_133 ) ;
