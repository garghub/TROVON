...
V_65 = F_73 ( V_2 . V_135 , F_25 , V_136 ,
V_137 , & V_2 ) ;
if ( V_65 ) {
F_10 ( L_16 , V_22 , V_65 ) ;
goto V_138;
...
static void T_7 F_77 ( T_10 V_139 )
{
T_10 V_4 ;
int V_65 ;
V_4 = ( V_139 & ( 0x0fUL << 32 ) ) >> ( 32 - 20 ) |
( 0x03UL << 24 ) |
( 0x0fUL << 12 ) |
( V_140 ) ;
V_65 = F_78 ( 0x100 , 0x007 , V_4 , 0 , 0 ) ;
if ( V_65 )
F_10 ( L_17 , V_22 ,
V_65 ) ;
}
...
static int T_7 F_81 ( struct V_151 * V_152 )
{
int V_66 , V_65 ;
T_8 V_129 , V_131 ;
F_82 ( ! F_83 ( V_153 ) ) ;
F_82 ( V_152 -> V_154 != V_155 ) ;
V_2 . V_125 = V_152 ;
V_65 = F_84 ( V_152 ) ;
if ( V_65 )
return - V_130 ;
...
F_85 ( V_152 , V_152 -> V_126 , V_129 , V_131 ,
V_157 ) ;
V_65 = F_64 () ;
if ( V_65 )
goto V_158;
F_86 ( V_152 , V_152 -> V_159 ,
V_157 ,
0 ,
NULL ,
F_87 ( V_160 , V_161 ) ) ;
V_152 -> V_159 -> V_162 = V_140 ;
V_65 = F_88 ( V_152 -> V_159 ) ;
if ( V_65 ) {
F_10 ( L_19 , V_22 ) ;
goto V_163;
}
F_77 ( V_152 -> V_159 -> V_127 ) ;
V_2 . V_98 = V_99 ;
if ( F_68 () ) {
V_65 = - V_130 ;
goto V_164;
}
V_65 = F_89 ( V_165 , V_166 , V_167 , 0 , & V_2 . V_9 ) ;
if ( V_65 < 0 )
goto V_168;
strcpy ( V_2 . V_9 -> V_169 , L_20 ) ;
strcpy ( V_2 . V_9 -> V_170 , L_20 ) ;
strcpy ( V_2 . V_9 -> V_171 , L_21 ) ;
for ( V_66 = 0 ; V_66 < F_90 ( V_172 ) ; V_66 ++ ) {
V_65 = F_91 ( V_2 . V_9 ,
F_92 ( & V_172 [ V_66 ] , & V_2 ) ) ;
if ( V_65 < 0 )
goto V_173;
...
goto V_173;
V_2 . V_94 -> V_174 = & V_2 ;
strcpy ( V_2 . V_94 -> V_175 , L_22 ) ;
F_94 ( V_2 . V_94 , V_176 ,
& V_177 ) ;
V_2 . V_94 -> V_178 = V_179 ;
V_65 = F_95 ( V_2 . V_94 ,
V_180 ,
& V_152 -> V_181 ,
V_182 ,
...
V_2 . V_53 ) ;
F_80 ( & V_2 ) ;
F_97 ( V_2 . V_9 , & V_152 -> V_181 ) ;
V_65 = F_98 ( V_2 . V_9 ) ;
if ( V_65 < 0 )
goto V_186;
F_10 ( L_26 ,
V_2 . V_9 -> V_171 , V_2 . V_98 ) ;
return 0 ;
V_186:
F_99 ( & V_2 . V_125 -> V_181 ,
V_161 ,
V_2 . V_183 ,
V_2 . V_53 ) ;
V_185:
...
static int F_104 ( struct V_151 * V_152 )
{
int V_65 ;
F_10 ( L_27 , V_22 , V_152 -> V_154 ) ;
