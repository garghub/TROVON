...
struct V_21 * V_45 = F_26 ( V_2 ) -> V_21 ;
...
V_22 = F_28 ( V_45 -> V_46 , V_45 -> V_47 , V_6 ) ;
if ( F_29 ( V_22 ) )
return F_30 ( V_22 ) ;
}
if ( F_31 ( V_22 , V_43 ) == 0 ) {
...
char V_51 [ V_52 ] ;
F_32 ( V_51 , V_22 , V_6 ) ;
V_50 = F_33 ( V_2 , V_6 , F_34 ( V_2 -> V_53 ) , V_51 ,
NULL , V_2 -> V_54 ) ;
if ( V_50 < 0 ) {
F_13 ( V_22 ) ;
return - V_33 ;
...
static T_2 F_36 ( struct V_1 * V_2 , struct V_5 * V_6 )
{
struct V_25 * V_26 = F_37 ( V_6 ) ;
struct V_3 * V_59 , * V_8 ;
int V_60 ;
int V_61 ;
int V_62 = F_38 ( V_2 ) ;
...
switch ( F_35 ( V_2 , V_43 , V_65 ) ) {
case 0 :
if ( F_41 ( V_66 ) ) {
unsigned int V_71 = F_42 ( V_2 ) ;
if ( ! F_43 ( V_66 ) &&
...
static struct V_82 * F_54 ( struct V_5 * V_6 ,
struct V_82 * V_83 )
{
struct V_25 * V_18 = F_37 ( V_6 ) ;
V_83 -> V_74 = V_18 -> V_74 ;
...
static int F_55 ( struct V_5 * V_6 , int V_84 )
{
struct V_25 * V_18 = F_37 ( V_6 ) ;
struct V_3 * V_8 ;
if ( V_84 < 68 )
...
V_26 = F_37 ( V_6 ) ;
F_61 ( V_26 -> V_86 . V_103 , V_6 -> V_104 , V_105 ) ;
V_50 = F_62 ( & V_26 -> V_86 ) ;
if ( V_50 ) {
F_63 ( V_6 ) ;
F_60 ( V_6 ) ;
