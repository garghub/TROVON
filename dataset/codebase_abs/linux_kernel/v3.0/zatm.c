...
F_21 ( L_35 ) ;
V_12 = F_9 ( V_24 ) ;
V_34 = sizeof( struct V_63 * ) * V_12 -> V_78 ;
V_12 -> V_79 = F_43 ( V_34 , V_121 ) ;
...
F_21 ( L_61 ) ;
V_12 = F_9 ( V_24 ) ;
V_12 -> V_162 = F_68 ( sizeof( struct V_63 * ) *
V_12 -> V_78 , V_121 ) ;
...
static T_2 F_69 ( int V_191 , void * V_192 )
{
struct V_23 * V_24 ;
struct V_12 * V_12 ;
T_1 V_193 ;
...
static void T_3 F_71 ( struct V_12 * V_12 , unsigned long V_13 ,
unsigned short V_209 )
{
int error ;
if ( ( error = F_72 ( V_12 -> V_210 , V_209 , V_13 ) ) )
F_3 (KERN_ERR DEV_LABEL L_73 ,
error) ;
}
static unsigned long T_3 F_73 ( struct V_12 * V_12 ,
unsigned short V_209 )
{
unsigned int V_13 ;
int error ;
if ( ( error = F_74 ( V_12 -> V_210 , V_209 , & V_13 ) ) )
F_3 (KERN_ERR DEV_LABEL L_74 ,
error) ;
return V_13 ;
}
static void T_3 F_75 ( struct V_12 * V_12 ,
unsigned long V_46 , int V_211 , unsigned short V_209 )
{
unsigned long V_13 ;
int V_10 ;
for ( V_10 = V_211 - 1 ; V_10 >= 0 ; V_10 -- ) {
V_13 = V_212 | ( ( ( V_46 >> V_10 ) & 1 ) ? V_213 : 0 ) ;
F_71 ( V_12 , V_13 , V_209 ) ;
F_71 ( V_12 , V_13 | V_214 , V_209 ) ;
F_71 ( V_12 , V_13 , V_209 ) ;
}
}
static void T_3 F_76 ( struct V_12 * V_12 ,
unsigned char * V_215 , unsigned short V_209 )
{
int V_10 ;
* V_215 = 0 ;
for ( V_10 = 8 ; V_10 ; V_10 -- ) {
F_71 ( V_12 , V_212 , V_209 ) ;
F_71 ( V_12 , V_212 | V_214 , V_209 ) ;
* V_215 <<= 1 ;
if ( F_73 ( V_12 , V_209 ) & V_216 ) * V_215 |= 1 ;
F_71 ( V_12 , V_212 , V_209 ) ;
}
}
static unsigned char T_3 F_77 ( struct V_23 * V_24 ,
unsigned short V_209 , int V_32 , int V_217 )
{
...
F_71 ( V_12 , V_212 , V_209 ) ;
F_75 ( V_12 , V_220 , V_221 , V_209 ) ;
F_75 ( V_12 , V_10 >> 1 , V_222 , V_209 ) ;
F_76 ( V_12 , V_218 + V_10 + V_217 , V_209 ) ;
F_76 ( V_12 , V_218 + V_10 + 1 - V_217 , V_209 ) ;
F_71 ( V_12 , 0 , V_209 ) ;
}
memcpy ( V_24 -> V_223 , V_218 + V_32 , V_224 ) ;
return memcmp ( V_24 -> V_223 , L_75 , V_224 ) ;
}
static void T_3 F_78 ( struct V_23 * V_24 )
{
if ( F_77 ( V_24 , V_225 , V_226 , 1 ) ) return;
( void ) F_77 ( V_24 , V_227 , V_228 , 0 ) ;
}
static int T_3 F_79 ( struct V_23 * V_24 )
{
struct V_12 * V_12 ;
struct V_210 * V_210 ;
...
F_80 ( & V_12 -> V_38 ) ;
V_210 = V_12 -> V_210 ;
V_12 -> V_234 = F_81 ( V_210 , 0 ) ;
V_12 -> V_191 = V_210 -> V_191 ;
if ( ( error = F_82 ( V_210 , V_235 , & V_229 ) ) ) {
F_3 (KERN_ERR DEV_LABEL L_77 ,
dev->number,error) ;
return - V_174 ;
}
if ( ( error = F_83 ( V_210 , V_235 ,
V_229 | V_236 | V_237 ) ) ) {
...
static int T_3 F_85 ( struct V_23 * V_24 )
{
...
V_12 -> V_61 [ V_10 ] = 0 ;
error = F_86 ( V_12 -> V_191 , F_69 , V_259 , V_260 , V_24 ) ;
if ( error < 0 ) {
...
if ( ! V_272 [ V_10 ] )
continue;
V_58 = F_87 ( V_254 , 2 * F_88 ( V_10 ) , & V_271 ) ;
if ( ! V_58 ) {
error = - V_122 ;
goto V_273;
}
...
L_97 , dev->number) ;
F_89 ( V_254 , 2 * F_88 ( V_10 ) , V_58 , V_271 ) ;
error = - V_274 ;
goto V_273;
}
F_21 ( L_98 , V_58 , V_58 + F_88 ( V_10 ) ) ;
V_12 -> V_61 [ V_10 ] = ( unsigned long ) V_58 ;
V_12 -> V_271 [ V_10 ] = V_271 ;
V_12 -> V_67 [ V_10 ] = ( V_12 -> V_61 [ V_10 ] + F_88 ( V_10 ) ) &
0xffff ;
F_5 ( V_271 >> 16 , F_90 ( V_10 ) ) ;
F_5 ( V_271 , F_91 ( V_10 ) ) ;
F_5 ( V_12 -> V_67 [ V_10 ] , F_92 ( V_10 ) ) ;
...
V_273:
while ( V_10 -- > 0 ) {
F_89 ( V_254 , 2 * F_88 ( V_10 ) ,
( void * ) V_12 -> V_61 [ V_10 ] ,
V_12 -> V_271 [ V_10 ] ) ;
}
F_93 ( V_12 -> V_191 , V_24 ) ;
goto V_261;
}
...
F_63 ( F_29 ( V_64 ) ) ;
V_64 -> V_282 = NULL ;
F_95 ( V_283 , & V_64 -> V_30 ) ;
}
static int F_96 ( struct V_63 * V_64 )
{
struct V_12 * V_12 ;
struct V_92 * V_92 ;
...
F_98 ( V_281 , & V_64 -> V_30 ) ;
return 0 ;
}
static int F_99 ( struct V_63 * V_64 , struct V_286 * V_94 , int V_30 )
{
F_3 ( L_103 ) ;
return - V_287 ;
}
static int F_100 ( struct V_23 * V_24 , unsigned int V_209 , void T_5 * V_288 )
{
struct V_12 * V_12 ;
unsigned long V_30 ;
V_12 = F_9 ( V_24 ) ;
switch ( V_209 ) {
case V_289 :
if ( ! F_101 ( V_290 ) ) return - V_291 ;
case V_292 :
{
struct V_293 V_294 ;
int V_25 ;
if ( F_102 ( V_25 ,
& ( (struct V_295 T_5 * ) V_288 ) -> V_296 ) )
return - V_297 ;
...
static int F_105 ( struct V_63 * V_64 , int V_301 , int V_302 ,
void T_5 * V_303 , int V_304 )
{
return - V_174 ;
}
static int F_106 ( struct V_63 * V_64 , int V_301 , int V_302 ,
void T_5 * V_303 , unsigned int V_304 )
{
return - V_174 ;
}
static int F_107 ( struct V_63 * V_64 , struct V_26 * V_27 )
{
int error ;
F_2 ( L_104 , ( unsigned long ) V_27 , 0 ) ;
if ( ! F_29 ( V_64 ) -> V_152 || ! F_97 ( V_281 , & V_64 -> V_30 ) ) {
if ( V_64 -> V_155 ) V_64 -> V_155 ( V_64 , V_27 ) ;
else F_108 ( V_27 ) ;
return - V_174 ;
}
...
static void F_109 ( struct V_23 * V_24 , unsigned char V_13 ,
unsigned long V_14 )
{
struct V_12 * V_12 ;
V_12 = F_9 ( V_24 ) ;
...
static unsigned char F_110 ( struct V_23 * V_24 , unsigned long V_14 )
{
struct V_12 * V_12 ;
V_12 = F_9 ( V_24 ) ;
V_15 ;
...
static int T_3 F_111 ( struct V_210 * V_210 ,
const struct V_308 * V_309 )
{
struct V_23 * V_24 ;
struct V_12 * V_12 ;
int V_310 = - V_122 ;
V_12 = F_68 ( sizeof( * V_12 ) , V_121 ) ;
if ( ! V_12 ) {
F_3 ( V_311 L_106 , V_260 ) ;
goto V_273;
}
V_24 = F_112 ( V_260 , & V_210 -> V_24 , & V_312 , - 1 , NULL ) ;
if ( ! V_24 )
goto V_313;
V_310 = F_113 ( V_210 ) ;
if ( V_310 < 0 )
goto V_314;
V_310 = F_114 ( V_210 , V_260 ) ;
if ( V_310 < 0 )
goto V_315;
V_12 -> V_210 = V_210 ;
V_24 -> V_282 = V_12 ;
V_12 -> V_251 = ( int ) V_309 -> V_316 ;
if ( ( V_310 = F_79 ( V_24 ) ) || ( V_310 = F_85 ( V_24 ) ) )
goto V_317;
F_115 ( V_210 , V_24 ) ;
V_12 -> V_318 = V_319 ;
V_319 = V_24 ;
