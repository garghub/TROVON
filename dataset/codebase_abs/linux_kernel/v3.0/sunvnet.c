...
const char * V_107 ;
V_107 = F_121 ( V_120 , V_199 , L_24 , NULL ) ;
if ( ! V_107 || strcmp ( V_107 , L_25 ) )
continue;
...
F_110 ( & V_5 -> V_127 ) ;
V_159 = 0 ;
if ( F_121 ( V_120 , V_204 -> V_208 , L_30 , NULL ) != NULL )
V_159 = 1 ;
V_5 -> V_159 = V_159 ;
F_55 ( & V_18 -> V_112 , V_110 ) ;
if ( V_159 )
...
F_133 ( L_31 ,
V_18 -> V_17 -> V_107 , V_5 -> V_124 , V_159 ? L_32 : L_33 ) ;
F_58 ( & V_5 -> V_12 ) ;
F_134 ( V_120 ) ;
return 0 ;
V_216:
