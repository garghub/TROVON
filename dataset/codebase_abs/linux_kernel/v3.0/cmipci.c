...
V_2 -> V_92 = 0 ;
V_2 -> V_210 = 2 ;
V_2 -> V_311 = V_358 [ V_317 ] ;
if ( V_232 -> V_222 != V_359 &&
V_232 -> V_222 != V_360 )
F_138 ( V_2 ) ;
if ( V_2 -> V_46 )
...
sprintf ( V_149 -> V_368 , L_29 , V_7 ) ;
if ( V_2 -> V_92 < 68 )
sprintf ( V_353 , L_30 , V_2 -> V_92 ) ;
else
V_353 [ 0 ] = '\0' ;
sprintf ( V_149 -> V_307 , L_31 ,
V_149 -> V_368 , V_353 , V_2 -> V_5 , V_2 -> V_174 ) ;
if ( ( V_161 = F_173 ( V_149 , V_369 , V_2 , & V_349 ) ) < 0 ) {
F_152 ( V_2 ) ;
return V_161 ;
}
if ( V_2 -> V_92 >= 39 ) {
V_7 = F_11 ( V_2 , V_370 + 1 ) ;
...
V_351 = V_371 [ V_317 ] ;
switch ( V_351 ) {
case 0x320 : V_7 = V_372 ; break;
case 0x310 : V_7 = V_373 ; break;
case 0x300 : V_7 = V_374 ; break;
case 0x330 : V_7 = V_375 ; break;
default:
V_351 = 0 ; break;
}
if ( V_351 > 0 ) {
...
return V_161 ;
if ( V_351 > 0 ) {
if ( ( V_161 = F_174 ( V_149 , 0 , V_377 ,
V_351 ,
( V_352 ?
V_378 : 0 ) ,
V_2 -> V_174 , 0 , & V_2 -> V_183 ) ) < 0 ) {
...
V_161 = F_178 ( V_384 [ V_317 ] , V_150 [ V_317 ] , V_385 , 0 , & V_149 ) ;
if ( V_161 < 0 )
return V_161 ;
switch ( V_232 -> V_222 ) {
case V_290 :
...
static int F_184 ( struct V_346 * V_232 , T_6 V_386 )
{
...
V_2 -> V_389 [ V_10 ] = F_101 ( V_2 , V_389 [ V_10 ] ) ;
F_1 ( V_2 , V_103 , 0 ) ;
F_155 ( V_232 ) ;
F_187 ( V_232 ) ;
F_188 ( V_232 , F_189 ( V_232 , V_386 ) ) ;
return 0 ;
}
...
for ( V_10 = 0 ; V_10 < F_18 ( V_389 ) ; V_10 ++ )
F_100 ( V_2 , V_389 [ V_10 ] , V_2 -> V_389 [ V_10 ] ) ;
F_185 ( V_149 , V_391 ) ;
return 0 ;
}
