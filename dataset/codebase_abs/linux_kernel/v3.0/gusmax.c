...
if ( F_27 ( V_44 , F_6 , V_61 , L_13 , ( void * ) V_11 ) ) {
...
if ( V_33 < 0 )
goto V_52;
sprintf ( V_20 -> V_66 + strlen ( V_20 -> V_66 ) , L_15 , V_2 -> V_5 . V_6 , V_44 , V_45 ) ;
if ( V_46 >= 0 )
sprintf ( V_20 -> V_66 + strlen ( V_20 -> V_66 ) , L_16 , V_46 ) ;
F_34 ( V_20 , V_40 ) ;
V_33 = F_35 ( V_20 ) ;
if ( V_33 < 0 )
goto V_52;
...
static int T_3 F_38 ( struct V_39 * V_67 , unsigned int V_18 )
{
F_37 ( F_39 ( V_67 ) ) ;
F_36 ( V_67 , NULL ) ;
return 0 ;
