...
static int T_6 F_21 ( struct V_49 * V_50 )
{
...
break;
default:
F_15 (KERN_INFO PFX L_6 , ret) ;
break;
}
return V_53 ;
}
static int T_7 F_23 ( struct V_49 * V_50 )
{
if ( ! V_19 )
F_9 () ;
F_24 ( & V_55 ) ;
...
static int F_26 ( struct V_49 * V_50 , T_8 V_58 )
{
return F_9 () ;
}
...
static int T_9 F_28 ( void )
{
int V_5 ;
if ( ! F_29 () )
return - V_57 ;
F_15 (KERN_INFO PFX L_7 , DRV_VERSION) ;
V_5 = F_30 ( & V_59 ) ;
if ( V_5 )
return V_5 ;
V_49 = F_31 ( V_37 ,
...
static void T_10 F_35 ( void )
{
F_36 ( V_49 ) ;
F_34 ( & V_59 ) ;
F_15 (KERN_INFO PFX L_8 ) ;
}
