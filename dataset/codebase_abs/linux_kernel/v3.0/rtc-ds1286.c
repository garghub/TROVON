...
if ( ! V_2 )
return - V_75 ;
V_2 -> V_76 = V_70 -> V_77 - V_70 -> V_78 + 1 ;
if ( ! F_26 ( V_70 -> V_78 , V_2 -> V_76 , V_66 -> V_79 ) ) {
V_71 = - V_80 ;
goto V_81;
}
V_2 -> V_82 = V_70 -> V_78 ;
V_2 -> V_4 = F_27 ( V_2 -> V_82 , V_2 -> V_76 ) ;
if ( ! V_2 -> V_4 ) {
V_71 = - V_75 ;
goto V_81;
}
...
F_34 ( V_2 -> V_4 ) ;
if ( V_2 -> V_82 )
F_35 ( V_2 -> V_82 , V_2 -> V_76 ) ;
F_36 ( V_2 ) ;
return V_71 ;
}
static int T_3 F_37 ( struct V_65 * V_66 )
{
struct V_1 * V_2 = F_38 ( V_66 ) ;
F_33 ( V_2 -> V_68 ) ;
F_34 ( V_2 -> V_4 ) ;
F_35 ( V_2 -> V_82 , V_2 -> V_76 ) ;
F_36 ( V_2 ) ;
