...
static T_1 F_12 ( struct V_17 * V_17 , const char T_2 * V_18 ,
T_3 V_19 , T_4 * V_20 )
{
if ( V_19 ) {
if ( ! V_21 ) {
...
static int F_14 ( struct V_26 * V_26 , struct V_17 * V_17 )
{
if ( F_15 ( 0 , & V_27 ) )
return - V_28 ;
F_8 () ;
return F_16 ( V_26 , V_17 ) ;
}
static int F_17 ( struct V_26 * V_26 , struct V_17 * V_17 )
{
if ( V_23 == 42 )
F_9 () ;
else {
...
static long F_19 ( struct V_17 * V_17 , unsigned int V_29 , unsigned long V_30 )
{
...
switch ( V_29 ) {
case V_41 :
return F_20 ( V_31 , & V_34 , sizeof( V_34 ) ) ? - V_25 : 0 ;
case V_42 :
case V_43 :
return F_21 ( 0 , V_32 ) ;
case V_44 :
