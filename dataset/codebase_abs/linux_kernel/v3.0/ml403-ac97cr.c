...
V_46 = F_41 ( V_69 , 0 ) ;
if ( F_64 ( V_46 , F_40 , V_123 ,
F_65 ( & V_69 -> V_124 ) , ( void * ) V_16 ) ) {
F_47 (KERN_ERR SND_ML403_AC97CR_DRIVER L_26
L_64 ,
irq) ;
F_57 ( V_16 ) ;
...
V_40 = F_67 ( V_110 , V_125 , V_16 , & V_113 ) ;
if ( V_40 < 0 ) {
F_3 ( V_126 , L_67 ) ;
F_57 ( V_16 ) ;
return V_40 ;
...
struct V_129 V_8 ;
int V_40 ;
static struct V_130 V_113 = {
. V_131 = V_132 ,
. V_133 = F_44 ,
} ;
F_3 ( V_74 , L_70 ) ;
V_40 = V_127 ( V_16 -> V_110 , 0 , & V_113 , NULL , & V_128 ) ;
if ( V_40 < 0 )
return V_40 ;
...
static int T_6
F_71 ( struct V_15 * V_16 , int V_139 ,
struct V_140 * * V_141 )
{
struct V_140 * V_142 ;
int V_40 ;
if ( V_141 )
* V_141 = NULL ;
V_40 = F_72 ( V_16 -> V_110 , L_72 , V_139 , 1 , 1 ,
& V_142 ) ;
if ( V_40 < 0 )
return V_40 ;
F_73 ( V_142 , V_143 ,
...
int V_40 ;
int V_124 = V_69 -> V_150 ;
if ( V_124 >= V_151 )
return - V_152 ;
if ( ! V_153 [ V_124 ] )
return - V_154 ;
V_40 = F_77 ( V_155 [ V_124 ] , V_150 [ V_124 ] , V_156 , 0 , & V_110 ) ;
if ( V_40 < 0 )
return V_40 ;
...
F_3 ( V_74 , L_77 ) ;
strcpy ( V_110 -> V_157 , V_158 ) ;
strcpy ( V_110 -> V_159 , L_78 ) ;
sprintf ( V_110 -> V_160 , L_79 ,
V_110 -> V_159 , V_110 -> V_157 ,
( unsigned long ) V_16 -> V_118 , V_16 -> V_46 ,
V_16 -> V_51 , V_124 + 1 ) ;
F_79 ( V_110 , & V_69 -> V_124 ) ;
V_40 = F_80 ( V_110 ) ;
if ( V_40 < 0 ) {
F_78 ( V_110 ) ;
return V_40 ;
