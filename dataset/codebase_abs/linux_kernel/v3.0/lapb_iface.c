...
int F_22 ( struct V_7 * V_8 , struct V_32 * V_33 )
{
struct V_1 * V_2 ;
int V_12 = V_34 ;
F_23 ( & V_13 ) ;
...
case V_46 :
#if V_50 > 1
F_35 ( V_51 L_2 , V_2 -> V_8 ) ;
#endif
#if V_50 > 0
F_35 ( V_51 L_3 , V_2 -> V_8 ) ;
#endif
F_37 ( V_2 , V_53 , V_54 , V_55 ) ;
V_2 -> V_30 = V_31 ;
F_24 ( V_2 ) ;
V_12 = V_52 ;
goto V_44;
...
V_2 -> V_30 = V_56 ;
#if V_50 > 1
F_35 ( V_51 L_4 , V_2 -> V_8 ) ;
#endif
#if V_50 > 0
F_35 ( V_51 L_5 , V_2 -> V_8 ) ;
#endif
V_12 = V_36 ;
V_44:
F_5 ( V_2 ) ;
...
int F_38 ( struct V_7 * V_8 , struct V_57 * V_58 )
{
struct V_1 * V_2 = F_14 ( V_8 ) ;
int V_12 = V_34 ;
if ( ! V_2 )
...
int F_41 ( struct V_7 * V_8 , struct V_57 * V_58 )
{
struct V_1 * V_2 = F_14 ( V_8 ) ;
int V_12 = V_34 ;
if ( V_2 ) {
...
void F_43 ( struct V_1 * V_2 , int V_59 )
{
if ( V_2 -> V_33 . V_60 )
V_2 -> V_33 . V_60 ( V_2 -> V_8 , V_59 ) ;
}
void F_44 ( struct V_1 * V_2 , int V_59 )
{
if ( V_2 -> V_33 . V_61 )
V_2 -> V_33 . V_61 ( V_2 -> V_8 , V_59 ) ;
}
void F_45 ( struct V_1 * V_2 , int V_59 )
{
if ( V_2 -> V_33 . V_62 )
V_2 -> V_33 . V_62 ( V_2 -> V_8 , V_59 ) ;
}
void F_46 ( struct V_1 * V_2 , int V_59 )
{
if ( V_2 -> V_33 . V_63 )
V_2 -> V_33 . V_63 ( V_2 -> V_8 , V_59 ) ;
}
int F_47 ( struct V_1 * V_2 , struct V_57 * V_58 )
{
if ( V_2 -> V_33 . V_64 )
return V_2 -> V_33 . V_64 ( V_2 -> V_8 , V_58 ) ;
F_48 ( V_58 ) ;
return V_65 ;
}
