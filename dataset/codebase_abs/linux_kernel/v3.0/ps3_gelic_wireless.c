...
static int F_76 ( struct V_41 * V_282 ,
struct V_57 * V_58 ,
union V_48 * V_49 , char * V_60 )
{
strcpy ( V_60 , L_72 ) ;
...
F_79 ( V_17 ) ;
V_21 -> V_197 = V_202 ;
F_82 (target, tmp, &wl->network_list, list) {
V_293 -> V_206 = 0 ;
if ( F_83 ( V_293 -> V_204 + V_21 -> V_203 ,
V_193 ) ) {
F_79 ( V_293 -> V_151 ) ;
V_293 -> V_151 = NULL ;
F_84 ( & V_293 -> V_299 , & V_21 -> V_300 ) ;
}
}
...
memcpy ( V_293 -> V_151 , V_192 , V_192 -> V_34 ) ;
...
static void F_88 ( struct V_147 * * V_303 ,
struct V_147 * V_304 ,
int * V_305 ,
int * V_306 )
{
...
static
struct V_147 * F_89 ( struct V_20 * V_21 )
{
struct V_147 * V_192 ;
struct V_147 * V_307 ;
int V_306 , V_305 ;
...
if ( V_311 ) {
F_6 ( L_98 , V_24 ) ;
V_310 -> V_126 = F_91 ( V_313 ) ;
} else {
F_6 ( L_99 , V_24 ) ;
V_310 -> V_126 = F_91 ( V_314 ) ;
}
} else {
F_6 ( L_100 , V_24 ) ;
V_310 -> V_126 = F_91 ( V_315 ) ;
}
V_17 = F_21 ( V_21 , V_9 ,
V_310 , sizeof( * V_310 ) ) ;
if ( ! V_17 )
...
F_79 ( V_17 ) ;
V_199:
F_80 ( ( unsigned long ) V_310 ) ;
F_6 ( L_19 , V_24 ) ;
return V_43 ;
}
static const char * F_92 ( enum V_317 V_318 )
{
switch ( V_318 ) {
case V_319 :
return L_101 ;
...
V_144 -> V_126 = F_91 ( V_126 ) ;
V_144 -> V_275 = F_91 ( V_21 -> V_275 ) ;
#ifdef F_20
F_6 ( L_109 , V_24 ,
F_92 ( V_144 -> V_126 ) ,
( V_144 -> V_275 == V_276 ) ?
...
unsigned long V_330 ;
F_6 ( L_13 , V_24 ) ;
V_329 = (struct V_328 * ) F_78 ( V_39 ) ;
if ( ! V_329 )
return - V_292 ;
memset ( V_329 , 0 , sizeof( * V_329 ) ) ;
V_329 -> V_331 = F_91 ( V_332 ) ;
V_329 -> V_333 = F_91 ( V_334 ) ;
V_329 -> V_335 = F_91 ( V_327 -> V_207 ) ;
switch ( V_21 -> V_223 ) {
case V_224 :
V_329 -> V_223 = F_91 ( V_224 ) ;
break;
case V_239 :
V_329 -> V_223 = F_91 ( V_239 ) ;
break;
}
#ifdef F_20
F_55 ( V_21 ) ;
...
F_30 ( V_21 , NULL ) ;
V_21 -> V_45 = V_339 ;
F_100 ( F_32 ( F_10 ( V_21 ) ) ) ;
if ( V_212 )
F_29 ( & V_21 -> V_44 ) ;
}
static const char * F_101 ( enum V_345 V_341 )
{
...
V_43 = F_94 ( V_21 , V_307 ) ;
if ( V_43 )
F_18 ( L_138 , V_24 , V_43 ) ;
V_356:
F_29 ( & V_21 -> V_195 ) ;
V_199:
F_29 ( & V_21 -> V_44 ) ;
}
void F_105 ( struct V_41 * V_42 , T_1 V_31 )
{
struct V_20 * V_21 = F_26 ( F_40 ( V_42 ) ) ;
if ( V_31 & V_357 ) {
F_6 ( L_139 , V_24 ) ;
...
if ( V_31 & V_358 ) {
F_6 ( L_140 , V_24 ) ;
F_106 ( V_21 -> V_359 , & V_21 -> V_353 , 0 ) ;
}
}
static struct V_41 * T_8 F_107 ( struct V_18 * V_19 )
{
struct V_41 * V_42 ;
struct V_351 * V_352 ;
struct V_20 * V_21 ;
unsigned int V_73 ;
F_6 ( L_77 , V_24 ) ;
V_42 = F_108 ( sizeof( struct V_351 ) +
sizeof( struct V_20 ) ) ;
F_6 ( L_141 , V_24 , V_42 , V_19 ) ;
if ( ! V_42 )
return NULL ;
strcpy ( V_42 -> V_61 , L_142 ) ;
V_352 = F_40 ( V_42 ) ;
V_352 -> V_42 = V_42 ;
V_352 -> V_19 = V_19 ;
V_352 -> type = V_360 ;
V_21 = F_26 ( V_352 ) ;
F_6 ( L_143 , V_24 , V_21 , V_352 ) ;
V_21 -> V_361 = F_22 ( sizeof( struct V_147 ) *
V_362 , V_39 ) ;
if ( ! V_21 -> V_361 )
goto V_363;
V_21 -> V_40 = F_109 ( L_144 ) ;
if ( ! V_21 -> V_40 )
goto V_364;
V_21 -> V_359 = F_109 ( L_145 ) ;
if ( ! V_21 -> V_359 )
goto V_365;
F_110 ( & V_21 -> V_300 ) ;
F_110 ( & V_21 -> V_302 ) ;
for ( V_73 = 0 ; V_73 < V_362 ; V_73 ++ )
F_111 ( & V_21 -> V_361 [ V_73 ] . V_299 ,
& V_21 -> V_300 ) ;
F_13 ( & V_21 -> V_30 ) ;
F_112 ( & V_21 -> V_353 , F_102 ) ;
F_112 ( & V_21 -> V_355 , F_103 ) ;
F_113 ( & V_21 -> V_195 ) ;
F_113 ( & V_21 -> V_44 ) ;
F_13 ( & V_21 -> V_291 ) ;
F_17 ( & V_21 -> V_291 ) ;
...
V_367:
V_43 = F_104 ( & V_21 -> V_355 , 0 ) ;
F_6 ( L_151 , V_24 , V_43 ) ;
return V_43 ;
}
static int F_119 ( struct V_41 * V_42 )
{
struct V_18 * V_19 = F_120 ( V_42 ) ;
F_6 ( L_152 , V_24 , V_42 ) ;
F_121 ( V_19 ) ;
F_63 ( V_42 ) ;
F_122 ( V_42 ) ;
...
struct V_16 * V_17 ;
if ( V_21 -> V_197 == V_198 )
F_95 ( & V_21 -> V_291 , V_340 ) ;
V_17 = F_21 ( V_21 , V_4 , NULL , 0 ) ;
F_79 ( V_17 ) ;
F_30 ( V_21 , NULL ) ;
}
static int F_125 ( struct V_41 * V_42 )
{
struct V_351 * V_352 = F_40 ( V_42 ) ;
struct V_20 * V_21 = F_26 ( V_352 ) ;
struct V_18 * V_19 = F_120 ( V_42 ) ;
...
static void T_8 F_129 ( struct V_41 * V_42 )
{
struct V_20 * V_21 ;
V_21 = F_26 ( F_40 ( V_42 ) ) ;
F_8 ( ! V_21 ) ;
...
int T_8 F_130 ( struct V_18 * V_19 )
{
int V_43 ;
struct V_41 * V_42 ;
F_6 ( L_77 , V_24 ) ;
...
if ( ! V_42 )
return - V_292 ;
F_131 ( V_42 , & V_19 -> V_56 -> V_380 ) ;
F_129 ( V_42 ) ;
V_43 = F_132 ( V_42 , V_19 ) ;
if ( V_43 )
goto V_381;
