...
strcpy ( V_10 -> V_81 , ( V_12 -> type == V_14 ) ? L_1 : L_2 ) ;
strcpy ( V_10 -> V_82 , ( V_12 -> type == V_14 ) ? L_16 : L_17 ) ;
sprintf ( V_10 -> V_83 , L_18 ,
V_10 -> V_82 ,
V_12 -> V_16 -> V_84 ,
V_33 [ V_18 ] ,
V_32 [ V_18 ] ) ;
...
static int T_1 F_46 ( struct V_85 * V_23 ,
unsigned int V_18 )
{
if ( ! V_86 [ V_18 ] || F_47 ( V_18 ) )
return 0 ;
if ( V_31 [ V_18 ] == V_39 ) {
...
static int T_1 F_48 ( struct V_85 * V_23 ,
unsigned int V_18 )
{
struct V_9 * V_10 ;
int V_4 ;
...
static int T_3 F_52 ( struct V_85 * V_87 ,
unsigned int V_18 )
{
F_50 ( F_53 ( V_87 ) ) ;
F_51 ( V_87 , NULL ) ;
...
static int F_54 ( struct V_85 * V_18 , unsigned int V_88 ,
T_4 V_89 )
{
return F_29 ( F_53 ( V_18 ) ) ;
}
static int F_55 ( struct V_85 * V_18 , unsigned int V_88 )
{
return F_33 ( F_53 ( V_18 ) ) ;
}
static int T_1 F_56 ( struct V_19 * V_90 ,
...
if ( V_92 < 0 )
return V_92 ;
if ( ( V_92 = F_11 ( V_18 , V_10 -> V_44 , V_90 , V_91 ) ) < 0 ) {
F_14 (KERN_ERR PFX L_21 ) ;
F_50 ( V_10 ) ;
return V_92 ;
}
F_49 ( V_10 , & V_90 -> V_10 -> V_18 ) ;
if ( ( V_92 = F_37 ( V_10 , V_18 ) ) < 0 ) {
F_50 ( V_10 ) ;
return V_92 ;
}
F_57 ( V_90 , V_10 ) ;
...
static void T_3 F_58 ( struct V_19 * V_90 )
{
F_50 ( F_59 ( V_90 ) ) ;
F_57 ( V_90 , NULL ) ;
}
static int F_60 ( struct V_19 * V_90 , T_4 V_89 )
{
return F_29 ( F_59 ( V_90 ) ) ;
}
static int F_61 ( struct V_19 * V_90 )
{
return F_33 ( F_59 ( V_90 ) ) ;
}
