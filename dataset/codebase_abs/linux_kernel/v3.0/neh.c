...
void F_46 ( struct V_4 * V_5 , void * V_53 , T_4 V_54 )
{
struct V_13 * V_14 = & V_5 -> V_15 . V_14 ;
void * V_55 ;
struct V_39 * V_40 ;
...
void F_48 ( struct V_4 * V_5 , int error )
{
struct V_2 * V_3 ;
unsigned long V_22 ;
for (; ; ) {
...
V_3 = F_50 ( & V_5 -> V_35 , struct V_2 , V_26 ) ;
F_27 ( V_5 , V_3 ) ;
F_25 ( & V_5 -> V_33 , V_22 ) ;
F_30 ( & V_3 -> V_27 ) ;
F_34 ( V_3 , NULL , error ) ;
