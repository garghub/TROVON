...
V_2 -> V_8 |= ( 1 << V_7 ) ;
snprintf ( V_2 -> V_51 [ V_7 ] , sizeof( V_2 -> V_51 [ V_7 ] ) ,
L_7 , V_34 [ V_7 ] ) ;
snprintf ( V_2 -> V_52 [ V_7 ] , sizeof( V_2 -> V_52 [ V_7 ] ) ,
L_8 , V_2 -> V_9 -> V_10 -> V_51 , V_7 ) ;
V_3 -> V_51 = V_2 -> V_51 [ V_7 ] ;
V_3 -> V_52 = V_2 -> V_52 [ V_7 ] ;
V_3 -> V_53 . V_54 = V_55 ;
V_3 -> V_53 . V_56 = 0x0003 ;
V_3 -> V_53 . V_57 = V_34 [ V_7 ] ;
V_3 -> V_53 . V_58 = 0x0100 ;
F_27 ( V_3 , V_2 ) ;
V_3 -> V_59 = F_9 ;
V_3 -> V_60 = F_15 ;
V_3 -> V_61 [ 0 ] = F_28 ( V_62 ) | F_28 ( V_63 ) ;
F_29 ( V_3 , V_11 , - 1 , 1 , 0 , 0 ) ;
F_29 ( V_3 , V_14 , - 1 , 1 , 0 , 0 ) ;
for ( V_38 = 0 ; V_38 < V_34 [ V_7 ] ; V_38 ++ )
F_30 ( V_64 [ V_38 ] , V_3 -> V_65 ) ;
V_30 = F_31 ( V_2 -> V_4 [ V_7 ] ) ;
if ( V_30 )
goto V_66;
}
if ( ! V_2 -> V_8 ) {
