...
V_3 -> V_171 = V_171 ;
V_3 -> V_20 = V_20 ;
V_3 -> V_69 = F_76 ( V_69 -> V_186 , V_69 -> V_187 - V_69 -> V_186 + 1 ) ;
if ( ! V_3 -> V_69 ) {
F_5 ( & V_20 -> V_21 , L_28 ) ;
goto V_188;
}
if ( F_66 ( V_169 -> V_164 ) ) {
if ( F_77 ( V_169 -> V_164 , L_29 ) ) {
F_5 ( & V_20 -> V_21 , L_30 ) ;
V_3 -> V_164 = - V_189 ;
} else {
F_78 ( V_169 -> V_164 , 1 ) ;
...
F_79 ( V_130 , & V_20 -> V_21 ) ;
F_65 ( V_3 ) ;
F_34 ( V_3 , V_163 , V_76 ) ;
F_34 ( V_3 , V_63 , F_31 ( V_3 , V_61 ) | V_119 ) ;
V_44 = F_80 ( V_130 , 0 , & V_173 , V_3 , & V_3 -> V_128 ) ;
if ( V_44 ) {
F_5 ( & V_20 -> V_21 , L_31 ) ;
goto V_190;
}
...
if ( F_21 () ) {
if ( V_169 -> V_191 . V_159 ) {
struct V_157 * V_158 = & V_169 -> V_191 ;
T_5 V_192 ;
V_158 -> V_193 = V_69 -> V_186 + V_194 + 2 ;
F_81 ( V_192 ) ;
F_82 ( V_195 , V_192 ) ;
V_3 -> V_24 . V_26 = F_83 ( V_192 , F_64 ,
V_158 ) ;
F_50 ( & V_3 -> V_20 -> V_21 , L_33 ,
F_84 ( & V_3 -> V_24 . V_26 -> V_21 -> V_160 ) ) ;
F_10 ( V_126 , & V_3 -> V_30 ) ;
}
if ( V_169 -> V_196 . V_159 ) {
struct V_157 * V_158 = & V_169 -> V_196 ;
T_5 V_192 ;
V_158 -> V_197 = V_69 -> V_186 + V_198 + 2 ;
F_81 ( V_192 ) ;
F_82 ( V_195 , V_192 ) ;
V_3 -> V_24 . V_25 = F_83 ( V_192 , F_64 ,
V_158 ) ;
F_50 ( & V_3 -> V_20 -> V_21 , L_34 ,
F_84 ( & V_3 -> V_24 . V_25 -> V_21 -> V_160 ) ) ;
F_10 ( V_127 , & V_3 -> V_30 ) ;
}
...
static int F_95 ( struct V_165 * V_20 , T_6 V_200 )
{
struct V_166 * V_130 = F_96 ( V_20 ) ;
...
static int F_97 ( struct V_165 * V_20 )
{
struct V_166 * V_130 = F_96 ( V_20 ) ;
struct V_2 * V_3 = V_130 -> V_141 ;
F_72 ( V_3 -> V_171 ) ;
...
static int T_7 F_98 ( struct V_165 * V_20 )
{
struct V_166 * V_130 = F_96 ( V_20 ) ;
