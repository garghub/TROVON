...
V_16 -> V_97 = V_97 ;
F_41 ( V_11 , V_25 ) ;
V_16 -> V_38 = & V_100 [ V_94 -> V_101 ] ;
V_16 -> V_11 = V_11 ;
V_25 -> V_102
= F_42 ( sizeof( * V_25 -> V_102 ) *
...
. V_9 ;
V_25 -> V_47 . V_104 = & V_11 -> V_47 ;
V_25 -> V_105 = V_94 -> V_105 ;
V_25 -> V_106 = V_16 -> V_38 -> V_106 ;
V_25 -> V_107 = V_108 ;
V_30 = F_33 ( V_16 ) ;
if ( V_30 < 0 )
goto V_109;
...
goto V_110;
V_95 = 1 ;
V_30 = F_45 ( V_25 -> V_111 , 0 ,
V_16 -> V_38 -> V_112 ,
V_16 -> V_38 -> V_113 ) ;
if ( V_30 )
goto V_110;
if ( V_11 -> V_60 ) {
V_30 = F_46 ( V_16 -> V_11 -> V_60 ,
NULL ,
& F_22 ,
V_114 | V_115 ,
L_3 ,
...
{
struct V_24 * V_25 = F_54 ( V_11 ) ;
struct V_15 * V_16 = F_6 ( V_25 ) ;
struct V_96 * V_97 = V_16 -> V_97 ;
if ( V_11 -> V_60 )
F_55 ( V_16 -> V_11 -> V_60 , V_25 ) ;
F_47 ( V_25 -> V_111 ) ;
F_48 ( V_25 ) ;
F_30 ( V_25 -> V_102 ) ;
if ( ! F_38 ( V_97 ) ) {
...
static T_10 int F_56 ( void )
{
return F_57 ( & V_117 ) ;
}
static T_11 void F_58 ( void )
{
F_59 ( & V_117 ) ;
}
