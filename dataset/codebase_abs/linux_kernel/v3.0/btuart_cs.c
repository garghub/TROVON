...
static int F_53 ( struct V_116 * V_13 , void * V_124 )
{
int * V_125 = V_124 ;
if ( V_125 == 0 )
V_13 -> V_126 = 16 ;
if ( ( V_13 -> V_14 [ 0 ] -> V_127 != 8 ) || ( V_13 -> V_14 [ 0 ] -> V_15 == 0 ) )
return - V_128 ;
V_13 -> V_14 [ 0 ] -> V_127 = 8 ;
V_13 -> V_14 [ 0 ] -> V_45 &= ~ V_129 ;
V_13 -> V_14 [ 0 ] -> V_45 |= V_130 ;
return F_54 ( V_13 ) ;
}
static int F_55 ( struct V_116 * V_13 ,
void * V_124 )
{
static unsigned int V_131 [ 5 ] = { 0x3f8 , 0x2f8 , 0x3e8 , 0x2e8 , 0x0 } ;
int V_132 ;
if ( V_13 -> V_126 > 3 )
return - V_91 ;
V_13 -> V_14 [ 0 ] -> V_45 &= ~ V_129 ;
...
V_13 -> V_14 [ 0 ] -> V_15 = V_131 [ V_132 ] ;
V_13 -> V_126 = V_131 [ V_132 ] ? 16 : 3 ;
if ( ! F_54 ( V_13 ) )
return 0 ;
}
return - V_91 ;
...
if ( ! F_56 ( V_117 , F_53 , & V_125 ) )
goto V_134;
if ( ! F_56 ( V_117 , F_55 , NULL ) )
goto V_134;
F_5 ( L_10 ) ;
goto V_135;
V_134:
V_133 = F_57 ( V_117 , F_21 ) ;
if ( V_133 != 0 )
goto V_135;
V_133 = F_58 ( V_117 ) ;
if ( V_133 != 0 )
