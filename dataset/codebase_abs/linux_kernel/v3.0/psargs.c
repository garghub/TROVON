...
break;
case V_83 :
V_79 -> V_30 . V_31 . integer =
( ( ( T_1 ) F_29 ( V_2 -> V_3 ) << 8 ) ) ;
V_2 -> V_3 ++ ;
V_79 -> V_30 . V_31 . integer |= F_29 ( V_2 -> V_3 ) ;
V_2 -> V_3 ++ ;
break;
default:
break;
...
struct V_1 * V_2 ,
T_1 V_60 , union V_18 * * V_85 )
{
union V_18 * V_19 = NULL ;
union V_18 * V_86 = NULL ;
union V_18 * V_79 ;
T_1 V_87 ;
T_3 V_21 = V_33 ;
F_33 ( V_88 , V_2 ) ;
...
V_19 -> V_30 . V_31 . V_84 = ( T_1 )
F_28 ( V_2 -> V_90 ,
V_2 -> V_3 ) ;
V_19 -> V_95 . V_96 = V_2 -> V_3 ;
V_2 -> V_3 = V_2 -> V_90 ;
}
break;
case V_97 :
