...
V_44 -> V_45 . V_142 = V_134 -> V_138 - V_134 -> V_139 ;
V_136 = F_43 ( V_134 -> V_139 ,
...
V_44 = F_46 ( sizeof( struct V_7 ) , & V_133 -> V_144 ) ;
if ( ! V_44 )
return - V_141 ;
V_8 = V_44 -> V_56 ;
V_8 -> V_44 = V_44 ;
...
F_49 ( & V_8 -> V_18 ) ;
F_50 ( & V_8 -> V_17 , F_25 ) ;
V_8 -> V_147 = F_51 ( V_8 -> V_44 -> V_64 . V_76 * V_8 -> V_39 ,
V_148 ) ;
F_15 ( V_41 L_24 ,
V_8 -> V_39 , V_8 -> V_40 ) ;
V_8 -> V_9 . V_149 = F_3 ;
...
static int F_56 ( struct V_153 * V_144 ,
struct V_154 * V_155 )
{
if ( V_42 )
return 0 ;
...
static void F_58 ( struct V_153 * V_144 ,
struct V_154 * V_155 )
{
if ( V_144 != & V_42 -> V_144 )
return;
