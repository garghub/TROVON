...
int V_69 = V_35 [ V_66 ] . V_70 - V_35 [ V_66 ] . V_71 + 1 ;
if ( ( V_35 [ V_66 ] . V_71 != 0 ) &&
( ( V_35 [ V_66 ] . V_68 & V_72 ) != 0 ) ) {
F_19 ( F_20 ( V_35 [ V_66 ] . V_71 ) ,
V_69 , 0 ) ;
V_67 += V_35 [ V_66 ] . V_70 -
V_35 [ V_66 ] . V_71 + 1 ;
F_8 ( L_22 ,
V_35 [ V_66 ] . V_73 , V_35 [ V_66 ] . V_71 ,
V_35 [ V_66 ] . V_70 -
V_35 [ V_66 ] . V_71 + 1 ) ;
}
}
...
{
V_76 = ( unsigned long ) F_25 ( V_2 , NULL , 0 ) ;
return 0 ;
}
static int T_1 F_26 ( char * V_2 )
{
#if 0
...
V_78 = F_27 ( L_29 ) ;
if ( V_78 && V_76 && V_77 ) {
V_78 -> V_71 = F_22 ( V_76 - 0x80000000 ) ;
V_78 -> V_70 = V_78 -> V_71 + V_77 - 1 ;
F_8 ( L_30 ,
V_78 -> V_71 , V_78 -> V_70 ) ;
}
}
struct V_78 * F_27 ( const char * V_73 )
{
int V_66 ;
for ( V_66 = 0 ; V_35 [ V_66 ] . V_68 != 0 ; V_66 ++ ) {
if ( strcmp ( V_35 [ V_66 ] . V_73 , V_73 ) == 0 )
return & V_35 [ V_66 ] ;
}
return NULL ;
}
void F_28 ( void * V_79 , int V_69 )
{
unsigned long V_80 ;
unsigned long V_70 ;
V_80 = ( ( unsigned long ) V_79 + ( V_81 - 1 ) ) & V_82 ;
V_70 = ( ( unsigned long ) V_79 + V_69 ) & V_82 ;
for (; V_80 < V_70 ; V_80 += V_81 ) {
F_29 ( F_30 ( F_31 ( V_80 ) ) ) ;
F_32 ( F_30 ( F_31 ( V_80 ) ) ) ;
F_33 ( ( unsigned long ) F_31 ( V_80 ) ) ;
}
}
int F_34 ( void )
{
