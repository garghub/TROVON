...
T_3 V_75 ;
V_73 -= V_21 -> V_45 . V_76 + F_23 ( V_37 -> V_2 ) ;
V_75 = V_73 & ( V_74 - 1 ) ;
V_73 &= ~ ( V_74 - 1 ) ;
if ( V_21 -> V_45 . V_77 != V_78 ) {
T_3 V_79 = ( ( V_27 - 1 ) & 7 ) + 1 ;
V_73 -= V_27 - V_79 ;
V_73 += F_64 ( T_3 , V_27 - V_79 , V_75 ) ;
}
return V_73 - 2 ;
}
static void F_65 ( struct V_17 * V_18 , struct V_80 * V_81 ,
T_2 type , T_2 V_82 , int V_83 , T_1 V_84 )
{
struct V_85 * V_85 = F_66 ( V_18 -> V_86 ) ;
const struct V_87 * V_88 = ( const struct V_87 * ) V_18 -> V_19 ;
struct V_22 * V_23 = (struct V_22 * ) ( V_18 -> V_19 + V_83 ) ;
struct V_20 * V_21 ;
if ( type != V_89 &&
type != V_90 )
return;
V_21 = F_67 ( V_85 , V_18 -> V_91 , ( const V_92 * ) & V_88 -> V_93 ,
V_23 -> V_50 , V_49 , V_94 ) ;
if ( ! V_21 )
return;
F_68 ( V_95 L_3 ,
F_69 ( V_23 -> V_50 ) , & V_88 -> V_93 ) ;
F_70 ( V_21 ) ;
}
...
struct V_1 * V_2 ;
int V_16 ;
V_2 = F_74 ( V_21 -> V_2 -> V_96 , 0 , 0 ) ;
V_16 = F_75 ( V_2 ) ;
if ( F_76 ( V_2 ) )
goto error;
V_37 -> V_2 = V_2 ;
V_16 = F_77 ( V_2 , V_21 -> V_2 -> V_97 ,
( V_21 -> V_2 -> V_98 + 7 ) / 8 ) ;
if ( V_16 )
goto error;
V_16 = F_78 ( V_2 , V_21 -> V_2 -> V_99 / 8 ) ;
if ( V_16 )
goto error;
error:
return V_16 ;
...
V_16 = - V_110 ;
if ( ( V_21 -> V_45 . V_46 & V_47 ) ) {
if ( snprintf ( V_106 , V_107 ,
L_4 ,
V_21 -> V_111 ? V_21 -> V_111 -> V_96 : L_5 ,
V_21 -> V_109 -> V_96 ) >= V_107 )
goto error;
} else {
if ( snprintf ( V_106 , V_107 ,
L_6 ,
...
goto error;
V_37 -> V_2 = V_2 ;
V_108 = ( V_21 -> V_111 ? ( V_21 -> V_111 -> V_98 + 7 ) / 8 : 0 ) +
( V_21 -> V_109 -> V_98 + 7 ) / 8 + F_80 ( sizeof( * V_101 ) ) ;
V_16 = - V_38 ;
V_104 = F_8 ( V_108 , V_112 ) ;
if ( ! V_104 )
goto error;
V_105 = V_104 ;
V_103 = ( void * ) V_105 ;
V_103 -> V_113 = V_114 ;
V_103 -> V_115 = F_81 ( sizeof( * V_101 ) ) ;
V_101 = F_82 ( V_103 ) ;
V_105 += F_80 ( sizeof( * V_101 ) ) ;
if ( V_21 -> V_111 ) {
struct V_116 * V_117 ;
memcpy ( V_105 , V_21 -> V_111 -> V_97 , ( V_21 -> V_111 -> V_98 + 7 ) / 8 ) ;
V_105 += ( V_21 -> V_111 -> V_98 + 7 ) / 8 ;
V_117 = F_83 ( V_21 -> V_111 -> V_96 , 0 ) ;
F_84 ( ! V_117 ) ;
V_16 = - V_66 ;
if ( V_117 -> V_118 . V_119 . V_120 / 8 !=
F_23 ( V_2 ) ) {
F_85 ( V_121 L_7 ,
V_21 -> V_111 -> V_96 ,
F_23 ( V_2 ) ,
V_117 -> V_118 . V_119 . V_120 / 8 ) ;
goto V_122;
}
V_16 = F_78 (
V_2 , V_21 -> V_111 -> V_123 / 8 ) ;
if ( V_16 )
goto V_122;
}
V_101 -> V_124 = F_86 ( ( V_21 -> V_109 -> V_98 + 7 ) / 8 ) ;
memcpy ( V_105 , V_21 -> V_109 -> V_97 , ( V_21 -> V_109 -> V_98 + 7 ) / 8 ) ;
V_16 = F_77 ( V_2 , V_104 , V_108 ) ;
V_122:
F_19 ( V_104 ) ;
error:
return V_16 ;
...
V_2 = V_37 -> V_2 ;
V_37 -> V_44 = 0 ;
V_21 -> V_45 . V_76 = sizeof( struct V_22 ) +
F_2 ( V_2 ) ;
switch ( V_21 -> V_45 . V_77 ) {
case V_126 :
if ( V_21 -> V_127 . V_128 != V_94 )
V_21 -> V_45 . V_76 += V_129 +
( sizeof( struct V_87 ) - sizeof( struct V_130 ) ) ;
break;
case V_131 :
break;
case V_78 :
V_21 -> V_45 . V_76 += sizeof( struct V_87 ) ;
break;
default:
goto error;
}
...
V_21 -> V_45 . V_132 = V_74 + 1 + F_23 ( V_37 -> V_2 ) ;
error:
return V_16 ;
}
static int T_4 F_89 ( void )
{
if ( F_90 ( & V_133 , V_94 ) < 0 ) {
F_68 ( V_121 L_8 ) ;
return - V_134 ;
}
