...
F_4 ( ( ( ( 1000000 / V_55 ) + 1 ) << 10 ) , & V_29 -> V_30 ) ;
V_56 = & V_29 -> V_57 ;
V_15 = F_11 ( NULL , V_58 ) ;
V_50 = F_36 ( V_15 , V_46 , V_59 , L_16 , NULL ) ;
if ( V_50 ) {
F_27 ( V_36 L_17 ,
V_50 ) ;
return;
...
{
unsigned long V_7 ;
struct V_61 * V_62 = & V_63 [ V_64 + ( 14 - 1 ) ] ;
F_3 ( V_7 ) ;
V_62 -> V_65 = V_66 [ 0 ] ;
V_62 -> V_67 = V_66 [ 1 ] ;
V_62 -> V_68 = V_66 [ 2 ] ;
...
V_71 = ( V_51 / sizeof( T_3 ) ) - 1 ;
for ( V_49 = 0 ; V_49 < V_71 ; V_49 ++ ) {
V_9 [ V_49 ] = ( void V_54 * )
( unsigned long ) V_53 [ V_49 ] ;
}
V_11 = ( void V_54 * )
( unsigned long ) V_53 [ V_71 ] ;
F_40 () ;
F_4 ( ~ V_72 , & V_11 -> V_12 ) ;
for ( V_49 = 0 ; ! F_41 ( V_49 , NULL , & V_70 ) ; V_49 ++ )
F_4 ( ~ 0x17fff , & V_9 [ V_70 ] -> V_13 ) ;
if ( V_71 == 4 )
F_4 ( 0 , & V_11 -> V_28 ) ;
F_42 ( V_73 , F_24 , V_74 ) ;
F_42 ( V_75 , F_31 , V_74 ) ;
