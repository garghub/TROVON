...
if ( ! V_87 )
return - V_177 ;
V_189 = F_34 ( L_17 , NULL , V_92 ) ;
if ( ! V_189 )
return - V_93 ;
return F_24 ( & V_189 -> V_43 , & V_190 ) ;
}
static void F_91 ( struct V_90 * V_91 )
{
if ( strcmp ( V_91 -> V_180 , V_183 ) == 0 )
F_62 ( ( unsigned long ) F_63 ( 0 ) ) ;
while ( F_92 ( F_93 () , V_191 ) == V_192 )
F_94 () ;
for (; ; ) ;
}
...
{
int V_50 ;
for ( V_50 = 0 ; V_50 < V_193 ; V_50 ++ ) {
if ( F_96 ( V_64 , V_194 [ V_50 ] -> V_180 ) ) {
if ( V_194 [ V_50 ] -> V_195 ) {
return V_194 [ V_50 ] -> V_195 ;
} else {
V_91 -> V_196 = V_194 [ V_50 ] ;
return V_51 ;
}
}
}
...
struct V_44 * V_45 , char * V_46 )
{
return sprintf ( V_46 , L_3 , V_197 . V_196 -> V_180 ) ;
}
static T_4 F_98 ( struct V_42 * V_43 ,
struct V_44 * V_45 ,
const char * V_64 , T_5 V_51 )
{
return F_95 ( V_64 , & V_197 , V_51 ) ;
}
static void F_99 ( char * V_198 )
{
F_80 () ;
V_197 . V_196 -> V_199 ( & V_197 ) ;
F_64 ( NULL ) ;
}
static T_4 F_100 ( struct V_42 * V_43 ,
struct V_44 * V_45 , char * V_46 )
{
return sprintf ( V_46 , L_3 , V_200 . V_196 -> V_180 ) ;
}
static T_4 F_101 ( struct V_42 * V_43 ,
struct V_44 * V_45 ,
const char * V_64 , T_5 V_51 )
{
return F_95 ( V_64 , & V_200 , V_51 ) ;
}
static void F_102 ( void )
{
V_200 . V_196 -> V_199 ( & V_200 ) ;
F_91 ( & V_200 ) ;
}
static T_4 F_103 ( struct V_42 * V_43 ,
struct V_44 * V_45 , char * V_46 )
{
return sprintf ( V_46 , L_3 , V_201 . V_196 -> V_180 ) ;
}
static T_4 F_104 ( struct V_42 * V_43 ,
struct V_44 * V_45 ,
const char * V_64 , T_5 V_51 )
{
return F_95 ( V_64 , & V_201 , V_51 ) ;
}
static void F_105 ( void )
{
F_80 () ;
V_201 . V_196 -> V_199 ( & V_201 ) ;
F_91 ( & V_201 ) ;
}
static T_4 F_106 ( struct V_42 * V_43 ,
struct V_44 * V_45 , char * V_46 )
{
return sprintf ( V_46 , L_3 , V_202 . V_196 -> V_180 ) ;
}
...
{
F_80 () ;
V_202 . V_196 -> V_199 ( & V_202 ) ;
F_91 ( & V_202 ) ;
}
static void T_3 F_109 ( void )
{
V_203 = F_34 ( L_18 , NULL ,
V_92 ) ;
if ( ! V_203 )
goto V_204;
if ( F_74 ( & V_203 -> V_43 ,
...
static void T_3 F_113 ( char * V_115 , char * V_210 , int V_211 )
{
int V_212 , V_213 ;
V_213 = 0 ;
for ( V_212 = 0 ; V_210 [ V_212 ] != 0 ; V_212 ++ ) {
if ( V_210 [ V_212 ] == '"' )
continue;
V_115 [ V_213 ++ ] = V_210 [ V_212 ] ;
if ( V_213 >= V_211 )
break;
}
}
static int T_3 F_114 ( char * V_214 )
{
if ( ! V_87 )
return 1 ;
F_113 ( V_182 , V_214 , 127 ) ;
V_182 [ 127 ] = 0 ;
V_197 . V_196 = & V_215 ;
return 1 ;
}
static int T_3 F_115 ( char * V_214 )
{
if ( ! V_87 )
return 1 ;
F_113 ( V_184 , V_214 , 127 ) ;
V_184 [ 127 ] = 0 ;
V_200 . V_196 = & V_215 ;
return 1 ;
}
static int T_3 F_116 ( char * V_214 )
{
if ( ! V_87 )
return 1 ;
F_113 ( V_186 , V_214 , 127 ) ;
V_186 [ 127 ] = 0 ;
V_201 . V_196 = & V_215 ;
return 1 ;
}
static int T_3 F_117 ( char * V_214 )
{
if ( ! V_87 )
return 1 ;
F_113 ( V_188 , V_214 , 127 ) ;
V_188 [ 127 ] = 0 ;
V_202 . V_196 = & V_215 ;
return 1 ;
}
static int F_118 ( struct V_216 * V_217 ,
unsigned long V_218 , void * V_88 )
{
F_102 () ;
return V_219 ;
}
...
V_38 . V_88 . V_39 . V_220 = V_28 -> V_38 . V_39 . V_220 ;
V_38 . V_88 . V_39 . V_221 = V_28 -> V_38 . V_39 . V_221 ;
break;
case V_8 :
strncpy ( V_38 . V_88 . V_222 . V_180 , V_150 ,
sizeof( V_38 . V_88 . V_222 . V_180 ) ) ;
break;
case V_10 :
break;
}
...
return;
V_29 |= V_32 ;
V_210 = ( void * ) ( unsigned long ) V_231 . V_232 ;
V_115 = ( void * ) V_233 ;
memmove ( V_115 , V_210 , V_159 ) ;
V_231 . V_232 = V_233 ;
}
void F_124 ( struct V_234 * V_235 )
{
F_125 ( & V_236 ) ;
F_126 ( & V_235 -> V_237 , & V_238 ) ;
F_127 ( & V_236 ) ;
}
void F_128 ( struct V_234 * V_235 )
{
F_125 ( & V_236 ) ;
F_129 ( & V_235 -> V_237 ) ;
F_127 ( & V_236 ) ;
...
{
struct V_234 * V_235 ;
F_131 (reset, &rcall, list)
V_235 -> V_199 () ;
}
void F_132 ( void )
{
struct V_239 * V_240 ;
V_240 = (struct V_239 * ) ( unsigned long ) F_133 () ;
V_240 -> V_241 = V_231 . V_241 ;
V_242 = ( V_243 ) ( unsigned long ) V_240 ;
F_134 ( 0 ) ;
F_135 ( 0 , 28 ) ;
V_231 . V_244 . V_245 = V_246 & ~ V_247 ;
V_231 . V_244 . V_20 =
V_248 | ( unsigned long ) V_249 ;
V_231 . V_250 . V_245 = V_246 & ~ V_247 ;
V_231 . V_250 . V_20 =
V_248 | ( unsigned long ) V_251 ;
F_130 () ;
}
