...
static void F_118 ( struct V_1 * V_39 ,
struct V_121 * V_122 )
{
struct V_91 * V_59 ;
struct V_230 * V_231 ;
...
V_271 -> V_236 . V_235 . V_275 = sizeof( struct V_26 ) ;
...
V_9 ) {
enum V_276 V_277 ;
if ( F_120 ( & V_271 -> V_27 . V_136 ,
V_39 -> V_3 -> V_145 ,
V_4 ,
V_39 -> V_3 -> V_278 ) ==
V_152 )
goto V_99;
V_277 = F_121 ( & V_271 -> V_27 . V_136 ) ;
if ( V_277 == V_279 )
goto V_138;
if ( V_277 == V_280 ) {
...
F_122 ( & V_272 -> V_27 . V_27 ,
& V_272 -> V_265 , V_122 ,
V_39 -> V_3 ,
F_123 ( & V_271 -> V_27 . V_136 ) ,
V_59 -> V_60 -> V_248 ) ;
goto V_99;
}
}
...
static void F_125 ( struct V_42 * V_43 )
{
struct V_133 * V_134 ;
unsigned long V_281 ;
if ( F_126 ( & V_43 -> V_72 ) ) {
...
V_134 -> V_222 += V_282 ;
if ( V_281 ) {
F_132 (list_item, &mad_agent_priv->wait_list) {
V_283 = F_128 ( V_284 ,
struct V_133 ,
V_87 ) ;
if ( F_129 ( V_134 -> V_222 ,
V_283 -> V_222 ) )
break;
}
}
...
V_284 = & V_43 -> V_72 ;
F_115 ( & V_134 -> V_87 , V_284 ) ;
if ( V_43 -> V_72 . V_180 == & V_134 -> V_87 ) {
F_127 ( & V_43 -> V_75 ) ;
F_130 ( V_43 -> V_59 -> V_39 -> V_103 ,
& V_43 -> V_75 , V_281 ) ;
}
}
void F_133 ( struct V_133 * V_134 ,
int V_218 )
{
...
static void F_136 ( struct V_1 * V_39 ,
struct V_121 * V_122 )
{
...
F_117 ( V_134 , & V_114 ) ;
if ( V_288 ) {
V_40 = F_84 ( V_59 -> V_60 , & V_288 -> V_144 ,
& V_206 ) ;
if ( V_40 ) {
...
static void F_137 ( struct V_91 * V_59 )
{
struct V_133 * V_134 ;
struct V_105 * V_106 ;
unsigned long V_6 ;
...
static void F_138 ( struct V_1 * V_39 ,
struct V_121 * V_122 )
{
struct V_105 * V_106 ;
struct V_91 * V_59 ;
...
V_106 = (struct V_105 * ) ( unsigned long ) V_122 -> V_118 ;
V_59 = V_106 -> V_108 -> V_59 ;
if ( V_106 -> V_108 == & V_59 -> V_291 )
return;
V_134 = F_53 ( V_106 , struct V_133 ,
V_106 ) ;
if ( V_122 -> V_123 == V_292 ) {
if ( V_134 -> V_289 ) {
struct V_143 * V_206 ;
V_134 -> V_289 = 0 ;
...
static void F_140 ( struct V_300 * V_301 )
{
struct V_1 * V_39 ;
struct V_121 V_122 ;
V_39 = F_53 ( V_301 , struct V_1 , V_301 ) ;
F_141 ( V_39 -> V_302 , V_303 ) ;
while ( F_142 ( V_39 -> V_302 , 1 , & V_122 ) == 1 ) {
...
V_64 ) ;
F_4 ( & V_43 -> V_70 , V_6 ) ;
V_134 = F_143 ( V_43 , V_112 ) ;
if ( ! V_134 || V_134 -> V_123 != V_124 ) {
F_5 ( & V_43 -> V_70 , V_6 ) ;
return - V_41 ;
}
V_306 = ( ! V_134 -> V_222 || V_134 -> V_80 > 1 ) ;
if ( ! V_218 ) {
V_134 -> V_123 = V_292 ;
V_134 -> V_80 -= ( V_134 -> V_222 > 0 ) ;
}
...
void F_145 ( struct V_34 * V_104 ,
struct V_111 * V_112 )
{
F_144 ( V_104 , V_112 , 0 ) ;
}
static void V_79 ( struct V_300 * V_301 )
{
struct V_42 * V_43 ;
struct V_137 * V_138 ;
struct V_42 * V_141 ;
...
struct V_113 V_114 ;
V_43 =
F_53 ( V_301 , struct V_42 , V_78 ) ;
F_4 ( & V_43 -> V_70 , V_6 ) ;
while ( ! F_126 ( & V_43 -> V_77 ) ) {
V_138 = F_128 ( V_43 -> V_77 . V_180 ,
struct V_137 ,
V_158 ) ;
F_46 ( & V_138 -> V_158 ) ;
F_5 ( & V_43 -> V_70 , V_6 ) ;
...
static int F_146 ( struct V_133 * V_134 )
{
int V_40 ;
if ( ! V_134 -> V_225 )
return - V_309 ;
...
static void V_76 ( struct V_300 * V_301 )
{
struct V_42 * V_43 ;
struct V_133 * V_134 ;
struct V_113 V_114 ;
unsigned long V_6 , V_281 ;
V_43 = F_53 ( V_301 , struct V_42 ,
V_75 . V_301 ) ;
V_114 . V_270 = 0 ;
F_4 ( & V_43 -> V_70 , V_6 ) ;
while ( ! F_126 ( & V_43 -> V_72 ) ) {
V_134 = F_128 ( V_43 -> V_72 . V_180 ,
struct V_133 ,
V_87 ) ;
if ( F_129 ( V_134 -> V_222 , V_282 ) ) {
V_281 = V_134 -> V_222 - V_282 ;
if ( ( long ) V_281 <= 0 )
V_281 = 1 ;
F_130 ( V_43 -> V_59 ->
...
static void F_148 ( struct V_312 * V_302 , void * V_313 )
{
struct V_1 * V_39 = V_302 -> V_314 ;
unsigned long V_6 ;
F_4 ( & V_7 , V_6 ) ;
if ( ! F_126 ( & V_39 -> V_315 ) )
F_70 ( V_39 -> V_103 , & V_39 -> V_301 ) ;
F_5 ( & V_7 , V_6 ) ;
}
static int F_124 ( struct V_91 * V_59 ,
struct V_139 * V_27 )
{
unsigned long V_6 ;
int V_316 , V_40 ;
...
sizeof V_140 -> V_236 ,
V_274 ) ;
V_140 -> V_236 . V_273 = V_187 . V_210 ;
V_318 . V_118 = ( unsigned long ) & V_140 -> V_236 . V_106 ;
V_140 -> V_236 . V_106 . V_108 = V_291 ;
F_4 ( & V_291 -> V_70 , V_6 ) ;
V_316 = ( ++ V_291 -> V_110 < V_291 -> V_214 ) ;
F_29 ( & V_140 -> V_236 . V_106 . V_109 , & V_291 -> V_109 ) ;
F_5 ( & V_291 -> V_70 , V_6 ) ;
V_40 = F_149 ( V_59 -> V_60 , & V_318 , & V_319 ) ;
if ( V_40 ) {
F_4 ( & V_291 -> V_70 , V_6 ) ;
...
static void F_150 ( struct V_91 * V_59 )
{
struct V_230 * V_231 ;
struct V_139 * V_271 ;
struct V_105 * V_106 ;
if ( ! V_59 -> V_60 )
return;
while ( ! F_126 ( & V_59 -> V_291 . V_109 ) ) {
V_106 = F_128 ( V_59 -> V_291 . V_109 . V_180 ,
struct V_105 , V_109 ) ;
V_231 = F_53 ( V_106 ,
struct V_230 ,
V_106 ) ;
...
static int F_151 ( struct V_1 * V_39 )
{
int V_40 , V_23 ;
struct V_293 * V_254 ;
struct V_117 * V_60 ;
...
for ( V_23 = 0 ; V_23 < V_320 ; V_23 ++ ) {
V_60 = V_39 -> V_59 [ V_23 ] . V_60 ;
if ( ! V_60 )
continue;
V_254 -> V_294 = V_321 ;
V_254 -> V_120 = 0 ;
V_254 -> V_322 = ( V_60 -> V_248 == 0 ) ? 0 : V_323 ;
V_40 = F_139 ( V_60 , V_254 , V_298 |
V_324 | V_325 ) ;
if ( V_40 ) {
...
V_254 -> V_294 = V_295 ;
V_254 -> V_327 = V_328 ;
V_40 = F_139 ( V_60 , V_254 , V_298 | V_329 ) ;
if ( V_40 ) {
F_62 (KERN_ERR PFX L_27
L_30 , i, ret) ;
goto V_99;
...
continue;
V_40 = F_124 ( & V_39 -> V_59 [ V_23 ] , NULL ) ;
if ( V_40 ) {
...
static void F_152 ( struct V_330 * V_331 , void * V_332 )
{
struct V_91 * V_59 = V_332 ;
F_62 (KERN_ERR PFX L_34 ,
event->event, qp_info->qp->qp_num) ;
}
static void F_153 ( struct V_91 * V_59 ,
struct V_107 * V_108 )
{
V_108 -> V_59 = V_59 ;
V_108 -> V_110 = 0 ;
...
static void F_154 ( struct V_1 * V_39 ,
struct V_91 * V_59 )
{
V_59 -> V_39 = V_39 ;
F_153 ( V_59 , & V_59 -> V_209 ) ;
F_153 ( V_59 , & V_59 -> V_291 ) ;
F_22 ( & V_59 -> V_215 ) ;
F_21 ( & V_59 -> V_95 ) ;
V_59 -> V_97 = NULL ;
V_59 -> V_96 = 0 ;
...
static int F_155 ( struct V_91 * V_59 ,
enum V_10 V_11 )
{
struct V_333 V_334 ;
int V_40 ;
memset ( & V_334 , 0 , sizeof V_334 ) ;
V_334 . V_335 = V_59 -> V_39 -> V_302 ;
V_334 . V_336 = V_59 -> V_39 -> V_302 ;
V_334 . V_337 = V_338 ;
V_334 . V_339 . V_340 = V_341 ;
V_334 . V_339 . V_342 = V_343 ;
V_334 . V_339 . V_344 = V_345 ;
V_334 . V_339 . V_346 = V_347 ;
V_334 . V_11 = V_11 ;
V_334 . V_4 = V_59 -> V_39 -> V_4 ;
V_334 . V_332 = V_59 ;
V_334 . V_348 = F_152 ;
V_59 -> V_60 = F_156 ( V_59 -> V_39 -> V_66 , & V_334 ) ;
if ( F_19 ( V_59 -> V_60 ) ) {
F_62 (KERN_ERR PFX L_35 ,
get_spl_qp_index(qp_type)) ;
V_40 = F_157 ( V_59 -> V_60 ) ;
goto error;
}
V_59 -> V_209 . V_214 = V_341 ;
V_59 -> V_291 . V_214 = V_343 ;
return 0 ;
error:
return V_40 ;
}
static void F_158 ( struct V_91 * V_59 )
{
if ( ! V_59 -> V_60 )
return;
F_159 ( V_59 -> V_60 ) ;
...
F_21 ( & V_39 -> V_82 ) ;
F_22 ( & V_39 -> V_87 ) ;
F_154 ( V_39 , & V_39 -> V_59 [ 0 ] ) ;
F_154 ( V_39 , & V_39 -> V_59 [ 1 ] ) ;
V_349 = V_341 + V_343 ;
V_351 = F_161 ( V_3 , V_4 ) == V_352 ;
if ( V_351 )
V_349 *= 2 ;
V_39 -> V_302 = F_162 ( V_39 -> V_3 ,
F_148 ,
NULL , V_39 , V_349 , 0 ) ;
if ( F_19 ( V_39 -> V_302 ) ) {
F_62 (KERN_ERR PFX L_37 ) ;
V_40 = F_157 ( V_39 -> V_302 ) ;
goto V_69;
}
V_39 -> V_66 = F_163 ( V_3 ) ;
if ( F_19 ( V_39 -> V_66 ) ) {
F_62 (KERN_ERR PFX L_38 ) ;
V_40 = F_157 ( V_39 -> V_66 ) ;
goto V_86;
}
V_39 -> V_65 = F_18 ( V_39 -> V_66 , V_67 ) ;
if ( F_19 ( V_39 -> V_65 ) ) {
F_62 (KERN_ERR PFX L_39 ) ;
V_40 = F_157 ( V_39 -> V_65 ) ;
goto V_353;
}
if ( V_351 ) {
V_40 = F_155 ( & V_39 -> V_59 [ 0 ] , V_12 ) ;
if ( V_40 )
goto V_354;
}
V_40 = F_155 ( & V_39 -> V_59 [ 1 ] , V_13 ) ;
if ( V_40 )
goto V_355;
snprintf ( V_350 , sizeof V_350 , L_40 , V_4 ) ;
V_39 -> V_103 = F_164 ( V_350 ) ;
if ( ! V_39 -> V_103 ) {
V_40 = - V_63 ;
goto V_356;
}
F_24 ( & V_39 -> V_301 , F_140 ) ;
F_4 ( & V_7 , V_6 ) ;
F_29 ( & V_39 -> V_315 , & V_357 ) ;
F_5 ( & V_7 , V_6 ) ;
V_40 = F_151 ( V_39 ) ;
if ( V_40 ) {
...
static int F_169 ( struct V_2 * V_3 , int V_4 )
{
struct V_1 * V_39 ;
unsigned long V_6 ;
F_4 ( & V_7 , V_6 ) ;
...
{
int V_359 , V_360 , V_23 ;
if ( F_171 ( V_3 -> V_145 ) != V_361 )
return;
if ( V_3 -> V_145 == V_146 ) {
V_359 = 0 ;
V_360 = 0 ;
...
for ( V_23 = V_359 ; V_23 <= V_360 ; V_23 ++ ) {
if ( F_160 ( V_3 , V_23 ) ) {
...
for ( V_23 = 0 ; V_23 < V_363 ; V_23 ++ , V_364 ++ ) {
if ( F_173 ( V_3 , V_364 ) )
F_62 (KERN_ERR PFX L_47
L_45 ,
...
{
int V_40 ;
V_343 = F_176 ( V_343 , V_365 ) ;
V_343 = F_177 ( V_343 , V_366 ) ;
V_341 = F_176 ( V_341 , V_365 ) ;
V_341 = F_177 ( V_341 , V_366 ) ;
V_153 = F_178 ( L_48 ,
sizeof( struct V_139 ) ,
0 ,
V_367 ,
