...
int V_30 = V_251 , V_252 = 0 , V_253 = 0 ;
union V_68 V_69 ;
if ( V_283 -> V_75 . V_391 . V_315 > 0 ) {
int V_254 = V_283 -> V_75 . V_391 . V_309 ;
int V_256 ;
struct V_257 V_258 = { V_263 , 0 , L_8 } ;
V_101 = F_8 ( V_1 , V_260 , 0 , NULL , & V_69 ) ;
V_256 = V_69 . V_75 ;
if ( ! ( V_283 -> V_75 . V_391 . V_203 & V_210 ) ) {
V_258 . V_143 = V_283 -> V_75 . V_391 . V_315 > sizeof ( V_283 -> V_75 . V_391 . V_258 ) ?
sizeof ( V_283 -> V_75 . V_391 . V_258 ) : V_283 -> V_75 . V_391 . V_315 ;
memcpy ( V_258 . V_258 , V_283 -> V_75 . V_391 . V_258 , V_258 . V_143 ) ;
if ( V_258 . V_143 == 32 )
V_258 . type = V_263 ;
if ( ( V_254 < 0 ) || ( V_254 > 3 ) )
V_254 = V_256 ;
...
int V_254 = ( V_283 -> V_75 . V_391 . V_203 & V_255 ) - 1 ;
if ( ( V_254 >= 0 ) && ( V_254 <= 3 ) ) {
V_101 |=
F_17 ( V_1 , V_260 , 0 ,
& V_254 ) ;
} else {
if ( ! ( V_283 -> V_75 . V_391 . V_203 & V_266 ) ) {
return - V_11 ;
}
}
}
if ( V_283 -> V_75 . V_391 . V_203 & V_211 ) {
}
if ( V_283 -> V_75 . V_391 . V_203 & V_267 )
V_252 = 1 ;
if ( ( V_283 -> V_75 . V_391 . V_203 & V_268 ) || V_250 ) {
V_30 = V_269 ;
V_252 = 1 ;
V_253 = 1 ;
}
if ( ( V_283 -> V_75 . V_391 . V_203 & V_266 ) || V_250 ) {
V_101 |=
F_17 ( V_1 , V_52 , 0 , & V_30 ) ;
V_101 |=
F_17 ( V_1 , V_53 , 0 , & V_252 ) ;
...
{
T_1 * V_1 = F_12 ( V_91 ) ;
int V_392 , V_280 , V_273 , V_234 = 0 ;
struct V_274 * V_275 ;
V_280 = V_283 -> V_75 . V_393 . V_280 ;
V_392 = V_390 - V_394 ;
if ( V_392 < 0 || V_392 < V_280 )
return - V_11 ;
V_273 = sizeof( * V_275 ) + V_280 ;
V_275 = F_66 ( V_273 , V_276 ) ;
if ( V_275 == NULL )
return - V_277 ;
#define F_67 0
...
V_275 -> V_278 = - 1 ;
V_275 -> V_39 = V_280 ;
memcpy ( V_275 -> V_63 , V_283 -> V_75 . V_393 . V_63 , V_280 ) ;
V_234 = F_70 ( V_1 , V_279 , V_275 , V_280 ) ;
if ( V_234 == 0 ) {
V_275 -> type = ( F_67 << 2 ) |
( F_69 << 4 ) ;
V_234 = F_70 ( V_1 , V_279 , V_275 , V_280 ) ;
...
static int
F_126 ( struct V_90 * V_190 , struct V_389 * V_283 )
{
return - V_120 ;
}
static int
F_127 ( struct V_90 * V_91 ,
struct V_389 * V_283 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
struct V_95 V_96 ;
...
V_96 . V_200 = V_395 ;
V_96 . V_203 = 0 ;
for ( V_114 = 0 ; V_114 < F_33 ( V_396 , ( int ) V_225 -> V_177 ) ; V_114 ++ )
V_191 = F_37 ( V_91 , & V_96 , V_191 ,
V_98 + V_397 ,
& ( V_225 -> V_225 [ V_114 ] ) ,
V_74 ) ;
...
static int
F_128 ( struct V_90 * V_91 , struct V_137 * V_398 )
{
struct V_389 * V_283 ;
int V_234 = 0 ;
T_2 V_116 ;
F_2 ( V_9 L_38 , V_398 -> V_143 ) ;
if ( V_398 -> V_143 < sizeof( struct V_389 ) ||
V_398 -> V_143 > V_399 || ! V_398 -> V_346 )
return - V_11 ;
V_283 = F_129 ( V_398 -> V_346 , V_398 -> V_143 ) ;
if ( F_130 ( V_283 ) )
return F_131 ( V_283 ) ;
switch ( V_283 -> V_200 ) {
case V_400 :
F_2 ( V_9 L_39 ,
V_91 -> V_118 ) ;
V_234 = F_124 ( V_91 , V_283 , V_398 -> V_143 ) ;
break;
case V_401 :
F_2 ( V_9 L_40 ,
V_91 -> V_118 ) ;
V_234 = F_125 ( V_91 , V_283 ,
V_398 -> V_143 ) ;
break;
case V_402 :
F_2 ( V_9 L_41 ,
V_91 -> V_118 ) ;
V_234 = F_126 ( V_91 , V_283 ) ;
break;
case V_403 :
F_2 ( V_9 L_42 ,
V_91 -> V_118 ) ;
V_234 = F_127 ( V_91 , V_283 ) ;
break;
case V_404 :
F_2 ( V_9 L_43 ,
V_91 -> V_118 ) ;
V_116 = 1 ;
V_234 = F_132 ( V_91 , NULL , & V_116 , NULL ) ;
break;
case V_405 :
F_2 ( V_9 L_44 ,
V_91 -> V_118 ) ;
...
if ( V_234 == 0 && F_133 ( V_398 -> V_346 , V_283 , V_398 -> V_143 ) )
V_234 = - V_406 ;
F_9 ( V_283 ) ;
return V_234 ;
}
static int
F_132 ( struct V_90 * V_91 , struct V_95 * V_96 ,
T_3 * V_116 , char * V_98 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
...
static int
F_134 ( struct V_90 * V_91 , struct V_95 * V_96 ,
T_3 * V_116 , char * V_98 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
* V_116 = V_1 -> V_125 ;
...
static int
F_135 ( struct V_90 * V_91 , struct V_95 * V_96 ,
T_3 * V_116 , char * V_98 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
V_1 -> V_128 =
...
static int
F_136 ( struct V_90 * V_91 , struct V_95 * V_96 ,
T_3 * V_116 , char * V_98 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
* V_116 = ( V_1 -> V_128 == V_407 ) ;
return 0 ;
}
static int
F_137 ( struct V_90 * V_91 , struct V_95 * V_96 ,
T_3 * V_116 , char * V_98 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
V_1 -> V_409 = * V_116 ;
F_2 ( L_48 , V_91 -> V_118 , * V_116 ) ;
return 0 ;
}
static int
F_138 ( struct V_90 * V_91 , struct V_95 * V_96 ,
struct V_137 * V_63 , char * V_98 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
struct V_381 * V_410 ;
int V_234 = - V_127 ;
F_2 ( L_49 , V_91 -> V_118 , V_1 -> V_409 ) ;
V_63 -> V_143 = 0 ;
if ( F_19 ( V_1 ) >= V_102 ) {
V_234 =
F_139 ( V_1 -> V_91 , V_411 ,
V_1 -> V_409 , V_98 , 256 ,
& V_410 ) ;
F_2 ( L_50 , V_91 -> V_118 , V_234 ) ;
if ( V_234 || ! V_410
|| V_410 -> V_384 -> V_412 == V_413 ) {
if ( V_410 ) {
F_122 ( V_410 ) ;
}
F_2 ( L_51 , V_91 -> V_118 ) ;
...
if ( ! V_234 ) {
V_63 -> V_143 = V_410 -> V_384 -> V_143 ;
memcpy ( V_98 , V_410 -> V_63 , V_63 -> V_143 ) ;
F_122 ( V_410 ) ;
F_2 ( L_52 , V_91 -> V_118 , V_63 -> V_143 ) ;
}
}
return V_234 ;
}
static int
F_140 ( struct V_90 * V_91 , struct V_95 * V_96 ,
struct V_137 * V_63 , char * V_98 )
{
T_1 * V_1 = F_12 ( V_91 ) ;
struct V_381 * V_410 ;
int V_234 = 0 , V_414 = V_413 ;
F_2 ( L_53 , V_91 -> V_118 , V_1 -> V_409 ,
V_63 -> V_143 ) ;
if ( F_19 ( V_1 ) >= V_102 ) {
V_234 =
F_139 ( V_1 -> V_91 , V_415 ,
V_1 -> V_409 , V_98 , V_63 -> V_143 ,
& V_410 ) ;
F_2 ( L_50 , V_91 -> V_118 , V_234 ) ;
if ( V_234 || ! V_410
|| V_410 -> V_384 -> V_412 == V_413 ) {
...
F_24 ( & V_1 -> V_119 ) ;
F_142 ( V_1 , V_27 , & V_75 ) ;
if ( ( V_116 -> V_63 . V_143 == 0 ) && ( V_1 -> V_416 . V_417 > 0 ) )
V_75 &= ~ V_23 ;
else if ( ( V_116 -> V_63 . V_143 > 0 ) && ( V_1 -> V_416 . V_417 == 0 ) )
V_75 |= V_23 ;
F_3 ( V_1 , V_27 , & V_75 ) ;
F_143 ( V_1 , & V_324 , 1 ) ;
F_25 ( & V_1 -> V_119 ) ;
return F_144 ( V_91 , V_96 , V_116 , V_98 ) ;
}
int
F_145 ( struct V_90 * V_91 , struct V_418 * V_419 , int V_200 )
{
struct V_420 * V_421 = (struct V_420 * ) V_419 ;
int V_234 = - 1 ;
switch ( V_200 ) {
case V_395 :
if ( ! F_146 ( V_422 ) )
return - V_423 ;
V_234 = F_128 ( V_91 , & V_421 -> V_75 . V_63 ) ;
return V_234 ;
}
return - V_120 ;
}
