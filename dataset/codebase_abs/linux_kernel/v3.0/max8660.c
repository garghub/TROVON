...
static int F_12 ( struct V_12 * V_13 , unsigned V_17 )
{
if ( V_17 > V_30 )
return - V_19 ;
...
static int F_14 ( struct V_12 * V_13 , int V_24 , int V_25 ,
unsigned int * V_26 )
{
struct V_1 * V_1 = F_5 ( V_13 ) ;
T_1 V_17 ;
...
static int F_18 ( struct V_12 * V_13 , unsigned V_17 )
{
if ( V_17 > V_37 )
return - V_19 ;
...
static int F_20 ( struct V_12 * V_13 , int V_24 ,
...
static int T_2 F_21 ( struct V_43 * V_10 ,
...
V_13 [ V_50 ] = F_24 ( & V_71 [ V_51 ] , & V_10 -> V_11 ,
V_47 -> V_64 [ V_50 ] . V_48 ,
V_1 ) ;
if ( F_25 ( V_13 [ V_50 ] ) ) {
V_7 = F_26 ( V_13 [ V_50 ] ) ;
...
static int T_3 F_31 ( struct V_43 * V_10 )
{
struct V_1 * V_1 = F_32 ( V_10 ) ;
int V_50 ;
