...
static int T_7 F_32 ( struct V_5 * V_6 )
{
struct V_12 * V_13 = V_6 -> V_2 . V_14 ;
struct V_7 * V_8 = NULL ;
struct V_78 * V_79 ;
...
V_8 = F_34 ( sizeof( * V_8 ) , V_89 ) ;
if ( ! V_8 )
return - V_81 ;
V_8 -> V_9 = V_13 -> V_9 ;
if ( ! V_8 -> V_9 ) {
V_8 -> V_9 = F_35 ( V_79 -> V_90 , V_79 -> V_91 - V_79 -> V_90 + 1 ) ;
if ( ! V_8 -> V_9 )
goto V_92;
}
V_8 -> V_41 = F_36 ( V_6 , 0 ) ;
...
F_39 ( & V_8 -> V_16 ) ;
F_40 ( V_6 , V_8 ) ;
V_8 -> V_62 = F_41 ( V_82 , & V_6 -> V_2 , V_84 , V_99 ) ;
if ( F_42 ( V_8 -> V_62 ) ) {
V_80 = F_43 ( V_8 -> V_62 ) ;
goto V_92;
}
V_100 . V_75 = V_13 -> V_77 ;
V_80 = F_44 ( & V_6 -> V_2 . V_70 , & V_100 ) ;
if ( V_80 ) {
F_45 ( V_8 -> V_62 ) ;
goto V_92;
}
