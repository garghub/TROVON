...
static int F_31 ( struct V_26 * V_27 , struct V_58 * V_34 )
{
struct V_1 * V_2 ;
F_14 ( V_34 == NULL ) ;
V_2 = F_32 ( V_34 ) ;
...
static void F_34 ( struct V_11 * V_4 )
{
struct V_1 * V_2 ;
V_2 = V_4 -> V_30 ;
F_14 ( V_2 == NULL ) ;
...
static int F_35 ( struct V_11 * V_4 )
{
struct V_1 * V_2 ;
struct V_58 * V_34 ;
char V_13 [ 64 ] ;
...
return - V_62 ;
if ( ! F_36 ( V_63 ) && ! F_36 ( V_64 ) )
return - V_65 ;
sprintf ( V_13 , L_7 , V_4 -> V_13 ) ;
V_34 = F_37 ( sizeof( * V_2 ) , V_13 , V_66 ) ;
V_2 = F_32 ( V_34 ) ;
V_2 -> V_4 = F_38 ( V_4 ) ;
V_2 -> V_34 = V_34 ;
F_2 ( V_2 , V_4 ) ;
...
static void F_46 ( struct V_11 * V_4 )
{
...
static int F_56 ( struct V_58 * V_34 )
{
F_57 ( V_34 ) ;
return 0 ;
}
static int F_58 ( struct V_58 * V_34 )
{
F_45 ( V_34 ) ;
return 0 ;
}
...
struct V_92 * V_71 ;
struct V_92 * V_93 ;
F_61 (node, _tmp, &ser_list) {
V_2 = F_62 ( V_71 , struct V_1 , V_71 ) ;
F_48 ( V_2 -> V_34 ) ;
F_49 ( V_2 -> V_34 ) ;
F_50 ( V_71 ) ;
}
