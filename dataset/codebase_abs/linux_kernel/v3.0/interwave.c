...
V_112 ) ;
if ( V_113 >= 0 )
sprintf ( V_16 -> V_129 + strlen ( V_16 -> V_129 ) , L_34 , V_113 ) ;
V_18 = F_64 ( V_16 ) ;
if ( V_18 < 0 )
return V_18 ;
V_10 -> V_46 = V_46 ;
...
static int T_1 F_65 ( int V_13 , struct V_130 * V_131 )
{
struct V_15 * V_16 ;
int V_18 ;
V_18 = F_51 ( V_13 , & V_16 ) ;
...
static int T_1 F_69 ( struct V_130 * V_100 ,
unsigned int V_13 )
{
if ( ! V_132 [ V_13 ] )
return 0 ;
...
static int T_1 F_71 ( struct V_130 * V_100 ,
unsigned int V_13 )
{
int V_18 ;
static int V_134 [] = { 5 , 11 , 12 , 9 , 7 , 15 , 3 , - 1 } ;
static int V_135 [] = { 0 , 1 , 3 , 5 , 6 , 7 , - 1 } ;
if ( V_39 [ V_13 ] == V_136 ) {
if ( ( V_39 [ V_13 ] = F_72 ( V_134 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_35 ) ;
return - V_102 ;
}
}
if ( V_105 [ V_13 ] == V_137 ) {
if ( ( V_105 [ V_13 ] = F_73 ( V_135 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_36 ) ;
return - V_102 ;
}
}
if ( V_106 [ V_13 ] == V_137 ) {
if ( ( V_106 [ V_13 ] = F_73 ( V_135 ) ) < 0 ) {
...
static long V_138 [] = { 0x210 , 0x220 , 0x230 , 0x240 , 0x250 , 0x260 } ;
int V_53 ;
for ( V_53 = 0 ; V_53 < F_33 ( V_138 ) ; V_53 ++ ) {
V_5 [ V_13 ] = V_138 [ V_53 ] ;
...
static int T_3 F_74 ( struct V_130 * V_131 , unsigned int V_13 )
{
F_67 ( F_75 ( V_131 ) ) ;
F_68 ( V_131 , NULL ) ;
return 0 ;
}
static int T_1 F_76 ( struct V_96 * V_139 ,
...
if ( V_7 < 0 )
return V_7 ;
if ( ( V_7 = F_42 ( V_13 , V_16 -> V_107 , V_139 , V_140 ) ) < 0 ) {
F_67 ( V_16 ) ;
return V_7 ;
}
F_66 ( V_16 , & V_139 -> V_16 -> V_13 ) ;
...
static void T_3 F_78 ( struct V_96 * V_139 )
{
F_67 ( F_79 ( V_139 ) ) ;
F_77 ( V_139 , NULL ) ;
}
