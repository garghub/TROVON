...
int V_128 ;
V_128 = F_48 ( V_2 -> V_118 ) ;
if ( ( V_5 >= V_2 -> V_29 ) || ( ! V_2 -> V_131 ) ||
( V_117 > V_128 ) || ( V_128 != 10000 ) ||
( ( V_117 != 0 ) && ( V_117 <= 10 ) ) )
return - V_105 ;
V_2 -> V_130 = V_128 ;
V_2 -> V_7 [ V_5 ] . V_117 = ( T_1 ) V_117 ;
F_49 ( V_9 , V_5 , V_117 , V_128 ) ;
return 0 ;
}
int F_52 ( struct V_104 * V_57 ,
int V_5 , struct V_132 * V_133 )
{
struct V_1 * V_2 = F_43 ( V_57 ) ;
if ( V_5 >= V_2 -> V_29 )
return - V_105 ;
V_133 -> V_5 = V_5 ;
memcpy ( & V_133 -> V_22 , V_2 -> V_7 [ V_5 ] . V_60 , V_64 ) ;
V_133 -> V_117 = V_2 -> V_7 [ V_5 ] . V_117 ;
V_133 -> V_109 = V_2 -> V_7 [ V_5 ] . V_54 ;
V_133 -> V_110 = V_2 -> V_7 [ V_5 ] . V_55 ;
return 0 ;
}
