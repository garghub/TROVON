...
static int T_1 F_5 ( struct V_1 * V_1 , int V_23 )
{
...
static int T_1 F_8 ( struct V_1 * V_1 )
{
...
static void T_1 F_10 ( struct V_1 * V_1 , struct V_2 * V_39 )
{
struct V_2 * V_24 = V_1 -> V_25 ;
struct V_40 * V_41 ;
V_41 = V_24 -> V_25 . V_42 ;
...
static void T_1 F_12 ( struct V_1 * V_1 )
{
struct V_2 * V_24 = V_1 -> V_25 ;
struct V_40 * V_41 ;
V_41 = V_24 -> V_25 . V_42 ;
...
static void T_1 F_14 ( struct V_1 * V_1 )
{
struct V_2 * V_24 = V_1 -> V_25 ;
...
static void T_1 F_15 ( struct V_1 * V_1 , struct V_2 * V_3 )
{
...
static void T_1 F_16 ( struct V_1 * V_1 , struct V_2 * V_39 )
{
F_10 ( V_1 , V_39 ) ;
F_12 ( V_1 ) ;
F_14 ( V_1 ) ;
...
static void F_17 ( struct V_1 * V_1 , T_2 V_55 , unsigned long V_58 )
{
F_18 ( V_55 , V_1 -> V_27 + ( V_58 * 4UL ) ) ;
}
static T_2 F_19 ( struct V_1 * V_1 , unsigned long V_58 )
{
return F_20 ( V_1 -> V_27 + ( V_58 * 4UL ) ) ;
}
static T_3 F_21 ( struct V_1 * V_1 , void * V_59 ,
T_4 V_60 , int V_61 )
{
struct V_2 * V_24 = V_1 -> V_25 ;
...
static void F_25 ( struct V_1 * V_1 , T_3 V_65 ,
T_4 V_60 , int V_61 )
{
struct V_2 * V_24 = V_1 -> V_25 ;
...
static void F_39 ( struct V_1 * V_1 , T_5 V_65 , T_5 V_100 ,
T_5 V_101 , int V_102 , T_2 V_103 )
{
T_5 V_96 ;
F_40 ( ! ( V_103 & V_104 ) ) ;
...
static int T_1 F_44 ( struct V_2 * V_24 ,
struct V_2 * V_39 ,
int V_23 )
{
...
static int T_1 F_53 ( struct V_2 * V_24 )
{
...
static int T_6 F_55 ( struct V_2 * V_24 )
{
