...
if ( ! ( V_118 -> V_59 & V_125 ) ) {
if ( V_118 -> V_59 & V_126 )
F_72 ( V_71 , V_15 , V_83 , V_111 ) ;
else
F_73 ( V_71 , V_15 , V_83 , V_111 ) ;
}
#ifdef F_46
F_43 ( V_2 , L_5 , V_14 ) ;
#endif
...
static enum V_127 F_77 ( struct V_68 * V_69 ,
T_4 V_60 ,
struct V_128 * V_129 )
{
struct V_1 * V_2 = F_36 ( V_69 ) ;
...
V_131 = V_69 -> V_60 ;
F_40 ( & V_2 -> V_61 , V_59 ) ;
F_78 ( V_129 , V_130 , V_131 , 0 ) ;
return F_79 ( V_60 , V_130 , V_131 ) ;
}
static T_6 F_80 ( int V_133 , void * V_134 )
{
...
static void F_82 ( unsigned long V_134 )
{
...
static T_6 F_84 ( int V_133 , void * V_134 )
{
struct V_144 * V_145 = V_134 ;
struct V_1 * V_2 ;
unsigned int V_146 = 0 ;
T_1 V_147 , V_148 ;
int V_43 ;
V_147 = ( V_145 -> V_17 & V_149 ) ? F_85 ( V_145 -> V_4 )
: F_86 ( V_145 -> V_4 ) ;
V_148 = 0xff000000 ;
F_87 ( V_145 -> V_71 , L_24 , V_147 ) ;
for ( V_43 = 0 ; V_43 < V_150 ; V_43 ++ ) {
V_2 = V_145 -> V_2 [ V_43 ] ;
if ( ! V_2 )
continue;
if ( V_147 & V_148 ) {
F_87 ( V_145 -> V_71 , L_25 , V_2 -> V_151 ) ;
F_80 ( V_133 , V_2 ) ;
V_146 ++ ;
}
V_147 &= ~ V_148 ;
...
struct V_1 * V_2 ;
int V_43 ;
if ( V_145 -> V_133 != V_152 ) {
F_87 ( V_145 -> V_71 , L_26 ) ;
F_90 ( V_145 -> V_133 , V_145 ) ;
return;
}
for ( V_43 = 0 ; V_43 < V_150 ; V_43 ++ ) {
V_2 = V_145 -> V_2 [ V_43 ] ;
if ( V_2 && V_2 -> V_133 != V_152 ) {
F_43 ( V_2 , L_27 ) ;
F_90 ( V_2 -> V_133 , V_2 ) ;
}
}
}
static int F_91 ( struct V_144 * V_145 )
{
struct V_1 * V_2 ;
int V_153 ;
int V_43 ;
if ( V_145 -> V_133 != V_152 ) {
F_87 ( V_145 -> V_71 , L_28 ) ;
V_153 = F_92 ( V_145 -> V_133 , F_84 , V_154 ,
L_29 , V_145 ) ;
return V_153 ;
}
for ( V_43 = 0 ; V_43 < V_150 ; V_43 ++ ) {
...
F_43 ( V_2 , L_31 ) ;
V_153 = F_92 ( V_2 -> V_133 , F_80 , V_154 ,
L_32 , V_2 ) ;
if ( V_153 ) {
F_23 ( V_2 , L_33 ) ;
goto V_156;
...
static int T_7 F_93 ( struct V_144 * V_145 ,
struct V_157 * V_76 , T_1 V_17 , const char * V_158 )
{
struct V_1 * V_2 ;
struct V_159 V_160 ;
int V_161 ;
V_2 = F_94 ( sizeof( * V_2 ) , V_162 ) ;
if ( ! V_2 ) {
F_95 ( V_145 -> V_71 , L_34 ) ;
V_161 = - V_72 ;
goto V_163;
}
V_2 -> V_4 = F_96 ( V_76 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_95 ( V_145 -> V_71 , L_35 ) ;
V_161 = - V_72 ;
goto V_164;
}
V_161 = F_97 ( V_76 , 0 , & V_160 ) ;
if ( V_161 ) {
F_95 ( V_145 -> V_71 , L_36 ) ;
goto V_165;
}
V_2 -> V_17 = V_17 ;
if ( ! V_145 -> V_17 )
V_145 -> V_17 = V_2 -> V_17 ;
F_98 ( V_145 -> V_17 != V_2 -> V_17 ) ;
V_2 -> V_71 = V_145 -> V_71 ;
V_2 -> V_151 = ( ( V_160 . V_166 - 0x100 ) & 0xfff ) >> 7 ;
if ( V_2 -> V_151 >= V_150 ) {
F_95 ( V_145 -> V_71 , L_37 ) ;
V_161 = - V_105 ;
goto V_165;
}
V_145 -> V_2 [ V_2 -> V_151 ] = V_2 ;
F_99 ( & V_2 -> V_141 , F_82 , ( unsigned long ) V_2 ) ;
snprintf ( V_2 -> V_70 , sizeof( V_2 -> V_70 ) , L_38 , V_2 -> V_151 ) ;
F_18 ( V_2 ) ;
F_5 ( V_2 , 0 ) ;
switch ( V_2 -> V_17 & V_18 ) {
case V_19 :
...
F_44 ( & V_2 -> V_77 ) ;
V_2 -> V_107 = true ;
V_2 -> V_62 . V_119 = & V_145 -> V_62 ;
V_2 -> V_133 = F_101 ( V_76 , 0 ) ;
F_59 ( & V_2 -> V_62 . V_157 , & V_145 -> V_62 . V_170 ) ;
V_145 -> V_62 . V_171 ++ ;
F_102 ( V_145 -> V_71 , L_39 , V_2 -> V_151 , V_158 ,
V_2 -> V_133 != V_152 ? V_2 -> V_133 : V_145 -> V_133 ) ;
return 0 ;
V_165:
F_103 ( V_2 -> V_4 ) ;
V_164:
...
static int T_7 F_107 ( struct V_172 * V_173 )
{
struct V_144 * V_145 ;
struct V_157 * V_58 ;
int V_161 ;
V_145 = F_94 ( sizeof( * V_145 ) , V_162 ) ;
if ( ! V_145 ) {
F_95 ( & V_173 -> V_71 , L_40 ) ;
V_161 = - V_72 ;
goto V_163;
}
V_145 -> V_71 = & V_173 -> V_71 ;
F_44 ( & V_145 -> V_62 . V_170 ) ;
V_145 -> V_4 = F_96 ( V_173 -> V_71 . V_174 , 0 ) ;
if ( ! V_145 -> V_4 ) {
F_95 ( & V_173 -> V_71 , L_35 ) ;
V_161 = - V_72 ;
goto V_175;
}
V_145 -> V_133 = F_101 ( V_173 -> V_71 . V_174 , 0 ) ;
F_108 ( V_176 , V_145 -> V_62 . V_177 ) ;
F_108 ( V_178 , V_145 -> V_62 . V_177 ) ;
F_108 ( V_179 , V_145 -> V_62 . V_177 ) ;
F_108 ( V_180 , V_145 -> V_62 . V_177 ) ;
V_145 -> V_62 . V_181 = F_47 ;
V_145 -> V_62 . V_182 = F_56 ;
V_145 -> V_62 . V_183 = F_58 ;
V_145 -> V_62 . V_184 = F_60 ;
V_145 -> V_62 . V_185 = F_63 ;
V_145 -> V_62 . V_186 = F_77 ;
V_145 -> V_62 . V_187 = F_76 ;
V_145 -> V_62 . V_188 = F_68 ;
V_145 -> V_62 . V_189 = F_69 ;
V_145 -> V_62 . V_71 = & V_173 -> V_71 ;
F_109 ( & ( V_173 -> V_71 ) , F_110 ( 36 ) ) ;
F_111 ( & V_173 -> V_71 , V_145 ) ;
...
struct V_144 * V_145 ;
unsigned int V_43 ;
V_145 = F_116 ( & V_173 -> V_71 ) ;
F_117 ( & V_145 -> V_62 ) ;
F_89 ( V_145 ) ;
for ( V_43 = 0 ; V_43 < V_150 ; V_43 ++ ) {
if ( V_145 -> V_2 [ V_43 ] )
F_105 ( V_145 -> V_2 [ V_43 ] ) ;
}
F_103 ( V_145 -> V_4 ) ;
F_111 ( & V_173 -> V_71 , NULL ) ;
F_104 ( V_145 ) ;
return 0 ;
}
