...
static int F_23 ( struct V_92 * V_55 ,
struct V_27 * V_28 , int V_93 )
{
struct V_12 * V_13 ;
unsigned int V_43 ;
int V_52 ;
...
if ( ! V_13 -> V_46 )
continue;
if ( V_13 -> V_16 . V_53 & V_94 )
V_13 -> V_95 = 0 ;
if ( ! V_13 -> V_96 )
continue;
if ( ! V_93 )
V_52 = F_16 ( V_55 , V_97 , V_13 -> V_28 -> V_14 ,
...
int F_24 ( struct V_47 * V_48 , int V_93 )
{
struct V_27 * V_28 ;
int V_52 = 0 ;
F_12 (entity, &chain->entities, chain) {
V_52 = F_23 ( V_48 -> V_55 , V_28 , V_93 ) ;
if ( V_52 < 0 )
goto V_73;
}
V_73:
...
V_101 -> V_11 = V_2 -> V_80 ( V_2 , V_6 ,
F_4 ( V_13 , V_98 ) ) ;
if ( V_2 -> V_25 == V_81 ) {
V_69 = V_2 -> V_86 ;
for ( V_43 = 0 ; V_43 < V_2 -> V_84 ; ++ V_43 , ++ V_69 ) {
if ( V_69 -> V_11 == V_101 -> V_11 ) {
V_101 -> V_11 = V_43 ;
break;
}
}
...
F_4 ( V_13 , V_60 ) ) ;
V_102 = V_2 -> V_80 ( V_2 , V_8 ,
F_4 ( V_13 , V_62 ) ) ;
V_85 = V_2 -> V_80 ( V_2 , V_9 ,
F_4 ( V_13 , V_64 ) ) ;
if ( V_85 == 0 )
V_85 = 1 ;
V_101 -> V_11 = F_3 + ( V_101 -> V_11 - F_3 + V_85 / 2 ) / V_85 * V_85 ;
V_101 -> V_11 = F_27 ( V_101 -> V_11 , F_3 , V_102 ) ;
V_11 = V_101 -> V_11 ;
break;
case V_87 :
V_101 -> V_11 = F_27 ( V_101 -> V_11 , 0 , 1 ) ;
V_11 = V_101 -> V_11 ;
break;
case V_81 :
if ( V_101 -> V_11 < 0 || V_101 -> V_11 >= V_2 -> V_84 )
return - V_104 ;
V_11 = V_2 -> V_86 [ V_101 -> V_11 ] . V_11 ;
if ( V_13 -> V_16 . V_53 & V_63 ) {
if ( ! V_13 -> V_65 ) {
V_52 = F_15 ( V_48 , V_13 ) ;
if ( V_52 < 0 )
...
if ( ! V_13 -> V_95 && ( V_13 -> V_16 . V_17 * 8 ) != V_2 -> V_17 ) {
if ( ( V_13 -> V_16 . V_53 & V_75 ) == 0 ) {
memset ( F_4 ( V_13 , V_98 ) ,
0 , V_13 -> V_16 . V_17 ) ;
} else {
...
static void F_28 ( struct V_92 * V_55 ,
const struct V_12 * V_13 , struct V_107 * V_16 )
{
struct V_108 {
struct V_109 V_14 ;
T_7 V_28 ;
...
static const struct V_108 V_110 [] = {
...
unsigned int V_43 ;
for ( V_43 = 0 ; V_43 < F_30 ( V_110 ) ; ++ V_43 ) {
if ( ! F_31 ( V_55 -> V_111 , & V_110 [ V_43 ] . V_14 ) )
continue;
if ( V_110 [ V_43 ] . V_28 == V_13 -> V_28 -> V_14 &&
V_110 [ V_43 ] . V_57 == V_16 -> V_57 ) {
V_16 -> V_53 = V_110 [ V_43 ] . V_53 ;
return;
}
}
}
static int F_32 ( struct V_92 * V_55 ,
const struct V_12 * V_13 , struct V_107 * V_16 )
{
T_7 * V_4 ;
int V_52 ;
...
V_52 = F_16 ( V_55 , V_114 , V_13 -> V_28 -> V_14 , V_55 -> V_56 ,
V_16 -> V_57 , V_4 , 2 ) ;
if ( V_52 < 0 ) {
F_14 ( V_51 ,
L_2 ,
...
static int F_36 ( struct V_92 * V_55 ,
struct V_12 * V_13 )
{
struct V_107 V_16 ;
int V_52 ;
...
F_14 ( V_51 , L_6
L_7 , V_16 . V_28 ,
V_16 . V_57 , V_55 -> V_120 -> V_121 , V_13 -> V_28 -> V_14 ) ;
return V_52 ;
}
...
F_12 (entity, &chain->entities, chain) {
if ( F_10 ( V_28 ) == V_36 &&
V_28 -> V_14 == V_123 -> V_126 )
break;
}
if ( V_28 -> V_14 != V_123 -> V_126 ) {
F_14 ( V_51 , L_8 ,
V_123 -> V_126 ) ;
return - V_127 ;
}
...
if ( V_123 -> V_3 == V_97 &&
F_39 ( V_4 , V_123 -> V_4 , V_17 ) ) {
V_52 = - V_130 ;
goto V_73;
}
V_52 = F_16 ( V_48 -> V_55 , V_123 -> V_3 , V_123 -> V_126 ,
V_48 -> V_55 -> V_56 , V_123 -> V_57 , V_4 , V_17 ) ;
if ( V_52 < 0 )
goto V_73;
if ( V_123 -> V_3 != V_97 &&
F_40 ( V_123 -> V_4 , V_4 , V_17 ) )
V_52 = - V_130 ;
V_73:
F_35 ( V_4 ) ;
F_20 ( & V_48 -> V_70 ) ;
...
for ( V_43 = 0 ; V_43 < V_28 -> V_44 ; ++ V_43 ) {
V_13 = & V_28 -> V_45 [ V_43 ] ;
if ( ! V_13 -> V_46 || ! V_13 -> V_106 ||
( V_13 -> V_16 . V_53 & V_131 ) == 0 )
continue;
F_42 ( V_132 L_10 ,
...
static int F_37 ( struct V_92 * V_55 , struct V_12 * V_13 ,
const struct V_107 * V_16 )
{
int V_52 = 0 ;
memcpy ( & V_13 -> V_16 , V_16 , sizeof( * V_16 ) ) ;
F_43 ( & V_13 -> V_16 . V_133 ) ;
V_13 -> V_15 = F_44 ( V_13 -> V_16 . V_17 * V_134 + 1 ,
V_112 ) ;
if ( V_13 -> V_15 == NULL ) {
V_52 = - V_113 ;
goto V_73;
...
V_55 -> V_120 -> V_121 , V_13 -> V_28 -> V_14 ) ;
V_73:
if ( V_52 < 0 )
F_35 ( V_13 -> V_15 ) ;
return V_52 ;
}
static int F_45 ( struct V_92 * V_55 ,
struct V_12 * V_13 , const struct V_1 * V_2 )
{
struct V_1 * V_42 ;
unsigned int V_17 ;
V_42 = F_46 ( V_2 , sizeof( * V_2 ) , V_112 ) ;
if ( V_42 == NULL )
return - V_113 ;
V_17 = sizeof( * V_2 -> V_86 ) * V_2 -> V_84 ;
V_42 -> V_86 = F_46 ( V_2 -> V_86 , V_17 , V_112 ) ;
if ( V_42 -> V_86 == NULL ) {
F_35 ( V_42 ) ;
return - V_113 ;
}
...
V_42 -> V_105 = F_8 ;
V_42 -> V_13 = & V_13 -> V_16 ;
F_47 ( & V_42 -> V_135 , & V_13 -> V_16 . V_133 ) ;
F_14 ( V_51 ,
L_13 ,
...
static void F_51 ( struct V_92 * V_55 ,
struct V_27 * V_28 )
{
struct V_139 {
struct V_109 V_14 ;
...
static const struct V_139 V_140 [] = {
{ { F_29 ( 0x13d3 , 0x509b ) } , 9 } ,
{ { F_29 ( 0x1c4f , 0x3000 ) } , 6 } ,
{ { F_29 ( 0x5986 , 0x0241 ) } , 2 } ,
} ;
static const struct V_139 V_141 [] = {
{ { F_29 ( 0x06f8 , 0x3005 ) } , 9 } ,
} ;
const struct V_139 * V_142 ;
unsigned int V_17 ;
unsigned int V_143 ;
unsigned int V_43 ;
T_7 * V_45 ;
...
V_142 = V_140 ;
V_143 = F_30 ( V_140 ) ;
V_45 = V_28 -> V_144 . V_145 ;
V_17 = V_28 -> V_144 . V_146 ;
break;
case V_30 :
V_142 = V_141 ;
V_143 = F_30 ( V_141 ) ;
V_45 = V_28 -> V_147 . V_145 ;
V_17 = V_28 -> V_147 . V_146 ;
break;
default:
return;
}
for ( V_43 = 0 ; V_43 < V_143 ; ++ V_43 ) {
if ( ! F_31 ( V_55 -> V_111 , & V_142 [ V_43 ] . V_14 ) )
continue;
if ( V_142 [ V_43 ] . V_90 >= 8 * V_17 ||
! F_5 ( V_45 , V_142 [ V_43 ] . V_90 ) )
continue;
F_14 ( V_51 , L_20
L_21 , V_28 -> V_14 , V_142 [ V_43 ] . V_90 ) ;
F_6 ( V_45 , V_142 [ V_43 ] . V_90 ) ;
}
}
static void F_52 ( struct V_92 * V_55 , struct V_12 * V_13 )
{
const struct V_107 * V_16 = V_148 ;
const struct V_107 * V_149 = V_16 + F_30 ( V_148 ) ;
const struct V_1 * V_2 = V_150 ;
...
int F_53 ( struct V_92 * V_55 )
{
struct V_27 * V_28 ;
unsigned int V_43 ;
F_12 (entity, &dev->entities, list) {
struct V_12 * V_13 ;
unsigned int V_146 = 0 , V_44 = 0 ;
T_2 * V_145 = NULL ;
if ( F_10 ( V_28 ) == V_36 ) {
V_145 = V_28 -> V_37 . V_145 ;
V_146 = V_28 -> V_37 . V_146 ;
} else if ( F_10 ( V_28 ) == V_34 ) {
V_145 = V_28 -> V_144 . V_145 ;
V_146 = V_28 -> V_144 . V_146 ;
} else if ( F_10 ( V_28 ) == V_30 ) {
V_145 = V_28 -> V_147 . V_145 ;
V_146 = V_28 -> V_147 . V_146 ;
}
F_51 ( V_55 , V_28 ) ;
for ( V_43 = 0 ; V_43 < V_146 ; ++ V_43 )
V_44 += F_54 ( V_145 [ V_43 ] ) ;
if ( V_44 == 0 )
continue;
...
static void F_55 ( struct V_92 * V_55 ,
struct V_12 * V_13 )
{
