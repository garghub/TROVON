...
char V_94 [ 6 ] ;
int V_95 , V_30 ;
V_2 = F_41 ( sizeof( struct V_1 ) , V_96 ) ;
if ( F_39 ( ! V_2 ) )
return - V_97 ;
F_42 ( & V_2 -> V_31 ) ;
V_30 = F_43 ( V_46 , 0 ) ;
...
V_2 -> V_100 = V_30 ;
V_2 -> V_101 = F_43 ( V_46 , 1 ) ;
V_2 -> V_102 = F_43 ( V_46 , 2 ) ;
V_92 = F_45 ( V_46 , V_103 , 0 ) ;
if ( F_39 ( V_92 == NULL ) ) {
V_30 = - V_98 ;
F_44 ( & V_46 -> V_33 , L_8 ) ;
goto V_99;
...
V_2 -> V_104 = F_46 ( V_92 ) ;
V_2 -> V_92 = F_47 ( V_92 -> V_105 , V_2 -> V_104 , V_46 -> V_106 ) ;
if ( F_39 ( ! V_2 -> V_92 ) ) {
V_30 = - V_107 ;
goto V_99;
}
V_2 -> V_5 = F_48 ( V_2 -> V_92 -> V_105 , V_2 -> V_104 ) ;
if ( F_39 ( ! V_2 -> V_5 ) ) {
V_30 = - V_87 ;
goto V_108;
}
...
V_2 -> V_65 = V_111 ;
if ( V_46 -> V_33 . V_112 ) {
struct V_113 * V_114 = V_46 -> V_33 . V_112 ;
V_2 -> V_65 |= V_114 -> V_65 ;
}
if ( V_2 -> V_101 <= 0 ) {
V_30 = F_52 ( V_2 -> V_100 , F_13 ,
V_115 , L_10 , V_2 ) ;
if ( F_39 ( V_30 ) ) {
F_44 ( & V_46 -> V_33 ,
L_11 , V_30 ,
...
F_63 ( V_2 -> V_5 ) ;
V_108:
F_64 ( V_2 -> V_92 -> V_105 , V_2 -> V_104 ) ;
V_99:
F_65 ( V_2 ) ;
return V_30 ;
}
static int T_3 F_66 ( struct V_45 * V_46 )
{
struct V_1 * V_2 = F_26 ( V_46 ) ;
F_67 ( V_2 -> V_10 ) ;
F_14 ( & V_46 -> V_33 , 0 ) ;
...
static void F_68 ( struct V_32 * V_33 , int V_42 )
{
struct V_45 * V_46 = F_25 ( V_33 ) ;
struct V_1 * V_2 = F_26 ( V_46 ) ;
F_69 ( V_2 -> V_100 , V_42 ) ;
