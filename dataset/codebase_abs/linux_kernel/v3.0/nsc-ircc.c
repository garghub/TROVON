...
memset ( V_32 -> V_56 . V_59 , 0 , V_32 -> V_56 . V_57 ) ;
V_32 -> V_58 . V_59 =
...
memset ( V_32 -> V_58 . V_59 , 0 , V_32 -> V_58 . V_57 ) ;
...
F_5 ( 2 , L_30 , V_16 , V_101 , V_102 , V_24 , V_103 , V_104 , V_105 , V_87 , V_106 ) ;
F_8 ( V_98 , V_4 ) ;
V_87 = F_7 ( V_4 + 1 ) & 0x01 ;
if ( ! V_87 ) {
F_8 ( V_99 , V_4 ) ;
...
if ( V_166 ) {
F_70 ( & V_32 -> V_170 ) ;
V_167 = V_32 -> V_170 . V_171 - V_32 -> V_172 . V_171 ;
if ( V_167 < 0 )
V_167 += 1000000 ;
if ( V_166 > V_167 ) {
V_166 -= V_167 ;
...
V_166 = V_166 / 125 ;
F_53 ( V_81 , V_173 ) ;
F_8 ( V_166 & 0xff , V_81 + V_174 ) ;
F_8 ( ( V_166 >> 8 ) & 0x0f , V_81 + V_175 ) ;
F_8 ( V_176 , V_81 + V_177 ) ;
V_32 -> V_27 . V_157 = V_178 ;
F_53 ( V_81 , V_124 ) ;
...
F_53 ( V_81 , V_124 ) ;
F_8 ( V_181 , V_81 + V_140 ) ;
F_71 ( V_32 , V_81 ) ;
}
V_180:
if ( ( V_32 -> V_69 . free < V_182 ) && ( V_32 -> V_159 == 0 ) )
F_63 ( V_32 -> V_36 ) ;
F_8 ( V_141 , V_81 + V_142 ) ;
V_30 -> V_160 = V_161 ;
F_64 ( & V_32 -> V_37 , V_156 ) ;
...
static void F_71 ( struct V_31 * V_32 , int V_81 )
{
int V_183 ;
V_183 = F_7 ( V_81 + V_142 ) ;
F_53 ( V_81 , V_124 ) ;
F_8 ( F_7 ( V_81 + V_133 ) & ~ V_184 , V_81 + V_133 ) ;
V_32 -> V_27 . V_157 = V_178 ;
F_53 ( V_81 , V_121 ) ;
F_8 ( V_185 | V_186 | V_122 , V_81 + V_123 ) ;
F_72 ( V_32 -> V_27 . V_23 ,
( ( V_187 * ) V_32 -> V_69 . V_168 [ V_32 -> V_69 . V_71 ] . V_169 -
V_32 -> V_58 . V_59 ) + V_32 -> V_63 ,
V_32 -> V_69 . V_168 [ V_32 -> V_69 . V_71 ] . V_70 ,
V_188 ) ;
F_53 ( V_81 , V_124 ) ;
F_8 ( F_7 ( V_81 + V_133 ) | V_151 | V_184 | V_189 , V_81 + V_133 ) ;
F_8 ( V_183 , V_81 + V_142 ) ;
}
static int F_73 ( int V_81 , T_5 * V_190 , int V_70 , int V_41 )
{
int V_191 = 0 ;
T_5 V_141 ;
F_5 ( 4 , L_8 , V_16 ) ;
V_141 = F_7 ( V_81 + V_142 ) ;
F_53 ( V_81 , V_124 ) ;
if ( ! ( F_74 ( V_81 + V_192 ) & V_193 ) ) {
F_5 ( 4 , L_44 ,
V_16 ) ;
V_41 -= 17 ;
}
while ( ( V_41 -- > 0 ) && ( V_191 < V_70 ) ) {
F_8 ( V_190 [ V_191 ++ ] , V_81 + V_194 ) ;
}
F_5 ( 4 , L_45 ,
V_16 , V_41 , V_191 , V_70 ) ;
F_8 ( V_141 , V_81 + V_142 ) ;
return V_191 ;
}
...
F_53 ( V_81 , V_124 ) ;
F_8 ( F_7 ( V_81 + V_133 ) & ~ V_184 , V_81 + V_133 ) ;
if ( F_7 ( V_81 + V_195 ) & V_196 ) {
V_32 -> V_36 -> V_163 . V_197 ++ ;
V_32 -> V_36 -> V_163 . V_198 ++ ;
F_8 ( V_196 , V_81 + V_195 ) ;
} else {
V_32 -> V_36 -> V_163 . V_199 ++ ;
}
V_32 -> V_69 . V_71 ++ ;
V_32 -> V_69 . V_70 -- ;
if ( V_32 -> V_69 . V_70 ) {
...
F_8 ( F_7 ( V_81 + V_133 ) & ~ V_184 , V_81 + V_133 ) ;
F_53 ( V_81 , V_121 ) ;
F_8 ( V_186 | V_122 , V_81 + V_123 ) ;
V_32 -> V_27 . V_157 = V_158 ;
V_32 -> V_56 . V_68 = V_32 -> V_56 . V_59 ;
F_53 ( V_81 , V_124 ) ;
F_8 ( V_128 | V_129 , V_81 + V_130 ) ;
V_32 -> V_200 . V_70 = V_32 -> V_200 . V_201 = 0 ;
V_32 -> V_200 . V_72 = V_32 -> V_200 . V_59 = 0 ;
...
static int F_76 ( struct V_31 * V_32 , int V_81 )
{
struct V_200 * V_200 ;
struct V_154 * V_155 ;
T_5 V_203 ;
...
V_141 = F_7 ( V_81 + V_142 ) ;
F_53 ( V_81 , V_137 ) ;
while ( ( V_203 = F_7 ( V_81 + V_204 ) ) & V_205 ) {
V_70 = F_7 ( V_81 + V_206 ) | ( ( F_7 ( V_81 + V_207 ) & 0x1f ) << 8 ) ;
if ( V_200 -> V_72 >= V_208 ) {
F_5 ( 0 , L_46 , V_16 ) ;
continue;
}
V_200 -> V_209 [ V_200 -> V_72 ] . V_203 = V_203 ;
V_200 -> V_209 [ V_200 -> V_72 ] . V_70 = V_70 ;
V_200 -> V_201 += V_70 ;
V_200 -> V_72 ++ ;
V_200 -> V_70 ++ ;
}
while ( V_200 -> V_70 > 0 ) {
V_203 = V_200 -> V_209 [ V_200 -> V_59 ] . V_203 ;
V_70 = V_200 -> V_209 [ V_200 -> V_59 ] . V_70 ;
V_200 -> V_201 -= V_70 ;
V_200 -> V_59 ++ ;
V_200 -> V_70 -- ;
if ( V_203 & V_210 ) {
if ( V_203 & V_211 ) {
V_32 -> V_36 -> V_163 . V_212 += V_70 ;
} else {
...
if ( V_203 & V_219 )
V_32 -> V_36 -> V_163 . V_220 ++ ;
if ( V_203 & V_221 )
V_32 -> V_36 -> V_163 . V_220 ++ ;
} else {
if ( V_200 -> V_201 < V_32 -> V_27 . V_41 ) {
F_53 ( V_81 , V_124 ) ;
if ( F_7 ( V_81 + V_192 ) & V_222 ) {
V_200 -> V_59 -- ;
V_200 -> V_70 ++ ;
V_200 -> V_201 += V_70 ;
V_200 -> V_209 [ V_200 -> V_59 ] . V_203 = V_203 ;
V_200 -> V_209 [ V_200 -> V_59 ] . V_70 = V_70 ;
F_53 ( V_81 , V_173 ) ;
F_8 ( 0x02 , V_81 + V_174 ) ;
F_8 ( 0x00 , V_81 + V_175 ) ;
F_8 ( V_176 , V_81 + V_177 ) ;
...
V_32 -> V_56 . V_68 += V_70 ;
V_32 -> V_36 -> V_163 . V_224 += V_70 ;
V_32 -> V_36 -> V_163 . V_225 ++ ;
V_155 -> V_30 = V_32 -> V_36 ;
F_81 ( V_155 ) ;
V_155 -> V_226 = F_82 ( V_227 ) ;
F_83 ( V_155 ) ;
}
}
F_8 ( V_141 , V_81 + V_142 ) ;
...
V_81 = V_32 -> V_27 . V_21 ;
do {
V_228 = F_7 ( V_81 + V_229 ) ;
F_85 ( V_32 -> V_36 , & V_32 -> V_36 -> V_163 ,
& V_32 -> V_56 , V_228 ) ;
} while ( F_7 ( V_81 + V_192 ) & V_222 );
}
static void F_86 ( struct V_31 * V_32 , int V_230 )
{
int V_191 ;
if ( V_230 & V_231 ) {
V_191 = F_73 ( V_32 -> V_27 . V_21 ,
V_32 -> V_58 . V_68 ,
V_32 -> V_58 . V_70 ,
V_32 -> V_27 . V_41 ) ;
V_32 -> V_58 . V_68 += V_191 ;
V_32 -> V_58 . V_70 -= V_191 ;
V_32 -> V_27 . V_157 = V_178 ;
if ( V_32 -> V_58 . V_70 > 0 )
V_32 -> V_146 = V_165 ;
else {
...
static void F_87 ( struct V_31 * V_32 , int V_81 ,
int V_230 )
{
T_5 V_141 ;
V_141 = F_7 ( V_81 + V_142 ) ;
...
V_32 -> V_146 = V_153 | V_179 ;
}
} else if ( V_230 & V_236 ) {
F_53 ( V_81 , V_173 ) ;
F_8 ( 0 , V_81 + V_177 ) ;
F_53 ( V_81 , V_124 ) ;
F_8 ( V_237 , V_81 + V_195 ) ;
if ( V_32 -> V_27 . V_157 == V_178 ) {
F_71 ( V_32 , V_81 ) ;
V_32 -> V_146 = V_181 ;
} else {
if ( F_76 ( V_32 , V_81 ) ) {
...
static T_9 F_89 ( int V_24 , void * V_239 )
{
struct V_29 * V_30 = V_239 ;
struct V_31 * V_32 ;
T_5 V_183 , V_230 ;
int V_81 ;
V_32 = F_17 ( V_30 ) ;
...
V_230 = F_7 ( V_81 + V_240 ) & V_32 -> V_146 ;
F_8 ( 0 , V_81 + V_140 ) ;
if ( V_230 ) {
if ( V_32 -> V_27 . V_144 > 115200 )
F_87 ( V_32 , V_81 , V_230 ) ;
else
F_86 ( V_32 , V_230 ) ;
}
...
V_141 = F_7 ( V_81 + V_142 ) ;
F_53 ( V_81 , V_121 ) ;
if ( ( F_7 ( V_81 + V_241 ) & 0x3f ) != 0 ) {
V_203 = TRUE ;
}
F_8 ( V_141 , V_81 + V_142 ) ;
} else
V_203 = ( V_32 -> V_56 . V_66 != V_67 ) ;
F_64 ( & V_32 -> V_37 , V_156 ) ;
return V_203 ;
}
...
V_141 = F_7 ( V_81 + V_142 ) ;
F_53 ( V_81 , V_124 ) ;
F_8 ( V_244 | V_139 , V_81 + V_140 ) ;
F_8 ( V_141 , V_81 + V_142 ) ;
F_98 ( V_30 ) ;
sprintf ( V_242 , L_54 , V_32 -> V_27 . V_21 ) ;
V_32 -> V_245 = F_99 ( V_30 , & V_32 -> V_43 , V_242 ) ;
return 0 ;
}
...
static int F_104 ( struct V_29 * V_30 , struct V_246 * V_247 , int V_248 )
{
struct V_249 * V_24 = (struct V_249 * ) V_247 ;
struct V_31 * V_32 ;
unsigned long V_156 ;
int V_3 = 0 ;
F_35 (dev != NULL, return -1;) ;
V_32 = F_17 ( V_30 ) ;
F_35 (self != NULL, return -1;) ;
F_5 ( 2 , L_55 , V_16 , V_30 -> V_15 , V_248 ) ;
switch ( V_248 ) {
case V_250 :
if ( ! F_105 ( V_251 ) ) {
V_3 = - V_252 ;
...
static int F_107 ( struct V_258 * V_30 , T_10 V_66 )
{
...
static int F_113 ( struct V_258 * V_30 )
{
struct V_31 * V_32 = F_108 ( V_30 ) ;
unsigned long V_156 ;
if ( ! V_32 -> V_27 . V_88 )
