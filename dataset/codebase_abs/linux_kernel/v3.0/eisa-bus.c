...
V_6 -> V_50 [ V_7 ] . V_65 = V_67 ;
}
if ( F_30 ( V_4 -> V_50 , & V_6 -> V_50 [ V_7 ] ) )
goto V_68;
}
return 0 ;
V_68:
...
static void T_1 F_32 ( struct V_5 * V_6 )
{
int V_7 ;
for ( V_7 = 0 ; V_7 < V_49 ; V_7 ++ )
...
V_75:
for ( V_69 = 0 , V_7 = 1 ; V_7 <= V_4 -> V_78 ; V_7 ++ ) {
V_6 = F_36 ( sizeof( * V_6 ) , V_71 ) ;
if ( ! V_6 ) {
F_34 ( V_72 L_13 , V_7 ) ;
continue;
...
F_34 ( V_70 L_20 , V_69 , V_69 == 1 ? L_21 : L_22 ) ;
return 0 ;
}
int T_1 F_38 ( struct V_3 * V_4 )
{
int V_79 ;
V_4 -> V_80 . V_16 = V_80 . V_16 ;
V_4 -> V_80 . V_63 = V_4 -> V_50 -> V_63 ;
V_4 -> V_80 . V_64 = V_4 -> V_50 -> V_64 ;
V_4 -> V_80 . V_65 = V_67 ;
V_79 = F_30 ( & V_80 , & V_4 -> V_80 ) ;
if ( V_79 )
return V_79 ;
V_4 -> V_9 = V_81 ++ ;
V_79 = F_33 ( V_4 ) ;
