...
goto V_99;
V_96 = F_48 ( V_95 , args -> V_45 + args -> V_40 ) ;
args -> V_4 = V_96 - args -> V_45 ;
F_17 ( args ) ;
if ( ! F_18 ( args ) )
goto V_99;
V_37 = args -> V_4 ;
ASSERT ( args -> V_45 + V_37 <= V_95 ) ;
V_96 = args -> V_45 + V_37 ;
...
goto V_114;
do {
error = F_8 ( * V_105 , V_107 , V_108 , & V_52 ) ;
if ( error )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
F_11 ( args , * V_107 , * V_108 , V_109 , V_110 ) ;
if ( ! V_111 ) {
if ( * V_109 >= args -> V_45 + V_106 )
goto V_114;
} else {
if ( * V_109 <= args -> V_45 - V_106 )
goto V_114;
...
if ( * V_110 >= args -> V_21 ) {
args -> V_4 = F_15 ( * V_110 , args -> V_40 ) ;
F_17 ( args ) ;
V_113 = F_14 ( args -> V_45 , args -> V_4 ,
args -> V_20 , * V_109 ,
* V_110 , & V_112 ) ;
if ( V_113 < V_106 )
goto V_115;
...
if ( ! V_111 )
error = F_54 ( * V_105 , 0 , & V_52 ) ;
else
error = F_55 ( * V_105 , 0 , & V_52 ) ;
if ( error )
goto V_98;
} while ( V_52 );
V_114:
...
break;
#endif
if ( V_128 || args -> V_20 > 1 ) {
V_46 -> V_139 [ 0 ] = 1 ;
do {
if ( ( error = F_8 ( V_46 , & V_125 ,
& V_128 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
if ( V_128 >= args -> V_21 )
...
ASSERT ( V_128 >= args -> V_21 ) ;
if ( ! V_52 )
break;
}
V_52 = V_46 -> V_139 [ 0 ] ;
for ( V_124 = 1 , V_137 = 0 , V_135 = 0 ;
! error && V_124 && ( V_137 < args -> V_40 || V_135 > 0 ) ;
error = F_54 ( V_46 , 0 , & V_124 ) ) {
if ( ( error = F_8 ( V_46 , & V_125 , & V_128 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
F_11 ( args , V_125 , V_128 ,
& V_126 , & V_129 ) ;
if ( V_129 < args -> V_21 )
continue;
args -> V_4 = F_15 ( V_129 , args -> V_40 ) ;
F_17 ( args ) ;
ASSERT ( args -> V_4 >= args -> V_21 ) ;
if ( args -> V_4 < V_137 )
continue;
V_127 = F_14 ( args -> V_45 , args -> V_4 ,
args -> V_20 , V_126 , V_129 , & V_130 ) ;
if ( V_130 != V_35 &&
( args -> V_4 > V_137 || V_127 < V_135 ) ) {
V_135 = V_127 ;
V_138 = V_130 ;
V_137 = args -> V_4 ;
V_136 = V_46 -> V_139 [ 0 ] ;
...
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
ASSERT ( V_125 + V_128 <= F_10 ( F_19 ( args -> V_43 ) -> V_80 ) ) ;
args -> V_4 = V_137 ;
if ( ! F_18 ( args ) ) {
F_49 ( V_46 , V_102 ) ;
F_61 ( args ) ;
...
args -> V_45 = V_138 ;
ASSERT ( V_138 >= V_125 ) ;
ASSERT ( V_138 + V_137 <= V_125 + V_128 ) ;
V_117 = F_46 ( args -> V_65 , args -> V_66 ,
args -> V_43 , args -> V_67 , V_97 ) ;
if ( ( error = F_20 ( V_46 , V_117 , V_125 ,
V_128 , V_138 , V_137 , V_57 ) ) )
goto V_98;
F_49 ( V_46 , V_102 ) ;
F_49 ( V_117 , V_102 ) ;
F_62 ( args ) ;
...
V_117 = F_46 ( args -> V_65 , args -> V_66 , args -> V_43 ,
args -> V_67 , V_97 ) ;
if ( ( error = F_4 ( V_117 , args -> V_45 , args -> V_40 , & V_52 ) ) )
goto V_98;
if ( ! V_52 ) {
V_116 = V_117 ;
V_117 = NULL ;
}
else if ( ( error = F_63 ( V_117 , & V_116 ) ) )
goto V_98;
if ( ( error = F_54 ( V_116 , 0 , & V_52 ) ) )
goto V_98;
if ( ! V_52 ) {
F_49 ( V_116 , V_102 ) ;
V_116 = NULL ;
...
do {
if ( V_117 ) {
if ( ( error = F_8 ( V_117 , & V_125 , & V_128 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
F_11 ( args , V_125 , V_128 ,
& V_126 , & V_129 ) ;
...
if ( V_116 ) {
if ( ( error = F_8 ( V_116 , & V_118 , & V_121 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
F_11 ( args , V_118 , V_121 ,
& V_119 , & V_122 ) ;
if ( V_122 >= args -> V_21 )
break;
if ( ( error = F_54 ( V_116 , 0 , & V_52 ) ) )
...
ASSERT ( V_122 >= args -> V_21 ) ;
args -> V_4 = F_15 ( V_122 , args -> V_40 ) ;
F_17 ( args ) ;
V_120 = F_14 ( args -> V_45 , args -> V_4 ,
args -> V_20 , V_119 , V_122 , & V_123 ) ;
error = F_53 ( args ,
& V_116 , & V_117 ,
V_120 , & V_125 , & V_128 ,
& V_126 , & V_129 ,
...
if ( V_117 == NULL && V_116 == NULL ) {
if ( ! V_131 ++ ) {
F_64 ( args ) ;
F_65 ( args -> V_65 , V_140 ) ;
goto V_134;
}
F_66 ( args ) ;
args -> V_45 = V_35 ;
...
V_126 , V_129 , & V_130 ) ;
ASSERT ( V_130 >= V_125 ) ;
ASSERT ( V_130 + V_37 <= V_126 + V_129 ) ;
ASSERT ( V_130 + V_37 <= F_10 ( F_19 ( args -> V_43 ) -> V_80 ) ) ;
args -> V_45 = V_130 ;
if ( ( error = F_20 ( V_46 , V_117 , V_125 , V_128 ,
V_130 , V_37 , V_58 ) ) )
goto V_98;
if ( V_124 )
F_67 ( args ) ;
...
F_47 ( V_37 == 0 ||
( V_37 <= V_49 && V_50 + V_37 <= V_48 + V_49 ) , V_98 ) ;
if ( V_37 < args -> V_40 ) {
T_1 V_141 ;
T_2 V_142 ;
T_1 V_143 ;
...
T_2 V_49 ;
int V_52 ;
if ( ( error = F_55 ( V_146 , 0 , & V_52 ) ) )
goto V_98;
if ( V_52 ) {
if ( ( error = F_8 ( V_146 , & V_48 , & V_49 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
}
else if ( args -> V_21 == 1 && args -> V_20 == 1 && ! args -> V_87 &&
( F_10 ( F_19 ( args -> V_43 ) -> V_149 )
> args -> V_42 ) ) {
...
T_10 * V_76 ;
V_65 = V_66 -> V_155 ;
V_47 = F_46 ( V_65 , V_66 , V_43 , V_67 , V_97 ) ;
V_46 = NULL ;
if ( ( error = F_4 ( V_47 , V_3 , V_4 , & V_151 ) ) )
goto V_98;
if ( V_151 ) {
if ( ( error = F_8 ( V_47 , & V_125 , & V_128 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
if ( V_125 + V_128 < V_3 )
V_151 = 0 ;
else {
F_47 ( V_125 + V_128 <= V_3 , V_98 ) ;
}
}
if ( ( error = F_54 ( V_47 , 0 , & V_152 ) ) )
goto V_98;
if ( V_152 ) {
if ( ( error = F_8 ( V_47 , & V_118 , & V_121 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
if ( V_3 + V_4 < V_118 )
V_152 = 0 ;
else {
F_47 ( V_118 >= V_3 + V_4 , V_98 ) ;
}
}
V_46 = F_46 ( V_65 , V_66 , V_43 , V_67 , V_100 ) ;
if ( V_151 && V_152 ) {
if ( ( error = F_1 ( V_46 , V_125 , V_128 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
if ( ( error = F_24 ( V_46 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
if ( ( error = F_1 ( V_46 , V_118 , V_121 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 1 , V_98 ) ;
if ( ( error = F_24 ( V_46 , & V_52 ) ) )
goto V_98;
...
T_1 V_156 ;
T_2 V_157 ;
if ( ( error = F_8 ( V_47 , & V_156 , & V_157 ,
& V_52 ) ) )
goto V_98;
F_47 (
V_52 == 1 && V_156 == V_125 && V_157 == V_128 ,
V_98 ) ;
}
#endif
V_153 = V_125 ;
V_154 = V_4 + V_128 + V_121 ;
if ( ( error = F_5 ( V_47 , V_153 , V_154 ) ) )
goto V_98;
}
else if ( V_151 ) {
if ( ( error = F_1 ( V_46 , V_125 , V_128 , & V_52 ) ) )
...
F_49 ( V_47 , V_102 ) ;
V_47 = NULL ;
if ( ( error = F_1 ( V_46 , V_153 , V_154 , & V_52 ) ) )
goto V_98;
F_47 ( V_52 == 0 , V_98 ) ;
if ( ( error = F_25 ( V_46 , & V_52 ) ) )
goto V_98;
...
F_44 ( V_158 ) ;
F_45 ( V_159 , V_4 ) ;
F_86 ( V_65 , V_67 , V_3 , V_4 , V_87 , V_151 , V_152 ) ;
return 0 ;
V_98:
...
int V_163 ;
int V_164 ;
V_162 = ( V_65 -> V_165 . V_166 + 1 ) / 2 ;
V_163 = V_65 -> V_167 [ 0 ] ;
V_164 = V_65 -> V_167 [ 1 ] ;
V_161 = ( V_162 + V_163 - 1 ) / V_163 ;
for ( V_160 = 1 ; V_161 > 1 ; V_160 ++ )
V_161 = ( V_161 + V_164 - 1 ) / V_164 ;
V_65 -> V_168 = V_160 ;
}
T_2
F_88 (
...
{
T_2 V_170 , V_171 = 0 ;
V_170 = F_89 ( V_76 , V_65 ) ;
if ( V_170 > V_76 -> V_172 )
V_171 = V_170 - V_76 -> V_172 ;
if ( V_76 -> V_173 > V_171 )
return V_76 -> V_173 - V_171 ;
return V_76 -> V_172 > 0 || V_76 -> V_173 > 0 ;
}
STATIC int
F_90 (
T_3 * args ,
...
if ( ! ( V_51 & V_179 ) ) {
V_170 = F_89 ( V_76 , V_65 ) ;
V_175 = F_88 ( V_65 , V_76 ) ;
if ( ( args -> V_21 + args -> V_20 + args -> V_181 - 1 ) >
V_175 ||
( ( int ) ( V_76 -> V_79 + V_76 -> V_172 -
V_170 - args -> V_182 ) < ( int ) args -> V_42 ) ) {
if ( V_43 )
F_92 ( V_66 , V_43 ) ;
args -> V_43 = NULL ;
return 0 ;
...
V_41 = F_19 ( V_43 ) ;
V_170 = F_93 ( V_41 , V_65 ) ;
if ( ! ( V_51 & V_179 ) ) {
V_171 = V_170 > F_10 ( V_41 -> V_149 ) ?
( V_170 - F_10 ( V_41 -> V_149 ) ) : 0 ;
V_175 = F_10 ( V_41 -> V_183 ) ;
V_175 = ( V_175 > V_171 ) ? ( V_175 - V_171 ) :
( F_10 ( V_41 -> V_149 ) > 0 || V_175 > 0 ) ;
if ( ( args -> V_21 + args -> V_20 + args -> V_181 - 1 ) >
V_175 ||
( ( int ) ( F_10 ( V_41 -> V_44 ) +
F_10 ( V_41 -> V_149 ) - V_170 - args -> V_182 ) <
( int ) args -> V_42 ) ) {
F_92 ( V_66 , V_43 ) ;
args -> V_43 = NULL ;
return 0 ;
...
V_176 . V_65 = V_65 ;
V_176 . V_43 = V_43 ;
V_176 . V_67 = args -> V_67 ;
V_176 . V_38 = V_176 . V_42 = V_176 . V_88 = V_176 . V_150 =
V_176 . V_181 = 0 ;
V_176 . V_20 = V_176 . V_21 = V_176 . V_39 = V_176 . V_87 = 1 ;
V_176 . type = V_84 ;
V_176 . V_76 = V_76 ;
if ( ( error = F_26 ( V_65 , V_66 , V_176 . V_67 , & V_174 ) ) )
return error ;
while ( F_10 ( V_41 -> V_149 ) < V_170 ) {
V_176 . V_45 = 0 ;
V_176 . V_40 = V_170 - F_10 ( V_41 -> V_149 ) ;
if ( ( error = F_38 ( & V_176 ) ) ) {
F_92 ( V_66 , V_174 ) ;
return error ;
}
...
for ( V_3 = V_176 . V_45 ; V_3 < V_176 . V_45 + V_176 . V_4 ; V_3 ++ ) {
...
F_10 ( V_41 -> V_188 ) , & V_174 ) ) )
return error ;
V_186 = F_95 ( V_174 ) ;
V_3 = F_10 ( V_186 -> V_189 [ F_10 ( V_41 -> V_190 ) ] ) ;
F_34 ( & V_41 -> V_190 , 1 ) ;
F_92 ( V_66 , V_174 ) ;
if ( F_10 ( V_41 -> V_190 ) == F_96 ( V_65 ) )
V_41 -> V_190 = 0 ;
V_76 = F_84 ( V_65 , F_10 ( V_41 -> V_188 ) ) ;
F_34 ( & V_41 -> V_149 , - 1 ) ;
F_97 ( V_66 , - 1 ) ;
V_76 -> V_172 -- ;
F_85 ( V_76 ) ;
...
F_99 ( V_66 -> V_155 , F_19 ( V_69 ) , V_196 , V_205 ) ;
F_100 ( V_196 , V_199 , V_206 , & V_197 , & V_198 ) ;
F_101 ( V_66 , V_69 , ( T_11 ) V_197 , ( T_11 ) V_198 ) ;
}
int
F_102 (
T_6 * V_65 ,
...
V_41 = F_19 ( V_43 ) ;
V_65 = V_66 -> V_155 ;
if ( ! V_174 && ( error = F_26 ( V_65 , V_66 ,
F_10 ( V_41 -> V_188 ) , & V_174 ) ) )
return error ;
V_186 = F_95 ( V_174 ) ;
F_34 ( & V_41 -> V_204 , 1 ) ;
if ( F_10 ( V_41 -> V_204 ) == F_96 ( V_65 ) )
V_41 -> V_204 = 0 ;
V_76 = F_84 ( V_65 , F_10 ( V_41 -> V_188 ) ) ;
F_34 ( & V_41 -> V_149 , 1 ) ;
F_97 ( V_66 , 1 ) ;
...
F_85 ( V_76 ) ;
F_37 ( V_66 , V_43 , V_187 ) ;
ASSERT ( F_10 ( V_41 -> V_149 ) <= F_96 ( V_65 ) ) ;
V_207 = & V_186 -> V_189 [ F_10 ( V_41 -> V_204 ) ] ;
* V_207 = F_6 ( V_3 ) ;
F_37 ( V_66 , V_43 , V_187 ) ;
F_101 ( V_66 , V_174 ,
( int ) ( ( V_209 ) V_207 - ( V_209 ) V_186 ) ,
( int ) ( ( V_209 ) V_207 - ( V_209 ) V_186 +
sizeof( T_1 ) - 1 ) ) ;
return 0 ;
}
...
V_41 = F_19 ( * V_68 ) ;
V_210 =
F_10 ( V_41 -> V_200 ) == V_211 &&
F_105 ( F_10 ( V_41 -> V_201 ) ) &&
F_10 ( V_41 -> V_44 ) <= F_10 ( V_41 -> V_80 ) &&
F_10 ( V_41 -> V_190 ) < F_96 ( V_65 ) &&
F_10 ( V_41 -> V_204 ) < F_96 ( V_65 ) &&
F_10 ( V_41 -> V_149 ) <= F_96 ( V_65 ) &&
F_10 ( V_41 -> V_188 ) == V_67 ;
if ( F_106 ( & V_65 -> V_165 ) )
V_210 = V_210 && F_10 ( V_41 -> V_193 ) <=
F_10 ( V_41 -> V_80 ) ;
if ( F_36 ( F_107 ( ! V_210 , V_65 , V_212 ,
V_213 ) ) ) {
F_108 ( L_1 ,
V_214 , V_65 , V_41 ) ;
F_92 ( V_66 , * V_68 ) ;
...
V_76 -> V_194 = F_10 ( V_41 -> V_193 ) ;
V_76 -> V_172 = F_10 ( V_41 -> V_149 ) ;
V_76 -> V_173 = F_10 ( V_41 -> V_183 ) ;
V_76 -> V_218 [ V_219 ] =
F_10 ( V_41 -> V_203 [ V_219 ] ) ;
V_76 -> V_218 [ V_220 ] =
F_10 ( V_41 -> V_203 [ V_220 ] ) ;
F_110 ( & V_76 -> V_221 ) ;
V_76 -> V_222 = 0 ;
V_76 -> V_223 = V_224 ;
V_76 -> V_177 = 1 ;
...
ASSERT ( V_76 -> V_194 == F_10 ( V_41 -> V_193 ) ) ;
ASSERT ( V_76 -> V_172 == F_10 ( V_41 -> V_149 ) ) ;
ASSERT ( V_76 -> V_173 == F_10 ( V_41 -> V_183 ) ) ;
...
args -> V_45 = V_35 ;
V_225 = V_65 -> V_165 . V_166 ;
if ( args -> V_40 > V_225 )
args -> V_40 = V_225 ;
if ( args -> V_20 == 0 )
args -> V_20 = 1 ;
ASSERT ( F_113 ( V_65 , args -> V_232 ) < V_65 -> V_165 . V_233 ) ;
ASSERT ( F_114 ( V_65 , args -> V_232 ) < V_225 ) ;
ASSERT ( args -> V_21 <= args -> V_40 ) ;
ASSERT ( args -> V_21 <= V_225 ) ;
ASSERT ( args -> V_38 < args -> V_39 ) ;
if ( F_113 ( V_65 , args -> V_232 ) >= V_65 -> V_165 . V_233 ||
...
args . V_66 = V_66 ;
args . V_65 = V_66 -> V_155 ;
args . V_67 = F_113 ( args . V_65 , V_3 ) ;
if ( args . V_67 >= args . V_65 -> V_165 . V_233 )
return V_81 ;
args . V_45 = F_114 ( args . V_65 , V_3 ) ;
if ( args . V_45 >= args . V_65 -> V_165 . V_166 )
return V_81 ;
args . V_76 = F_84 ( args . V_65 , args . V_67 ) ;
ASSERT ( args . V_76 ) ;
error = F_90 ( & args , V_179 ) ;
if ( error )
goto V_98;
if ( args . V_45 + V_4 >
F_10 ( F_19 ( args . V_43 ) -> V_80 ) ) {
...
V_112 = F_125 ( sizeof( struct V_244 ) , V_249 ) ;
if ( ! V_112 ) {
F_126 ( V_66 -> V_155 , V_67 , V_3 , V_4 ) ;
F_127 ( V_66 ) ;
return;
}
V_112 -> V_67 = V_67 ;
...
F_128 ( & V_112 -> V_251 ) ;
V_112 -> V_51 = V_51 ;
F_129 ( V_66 -> V_155 , V_67 , V_3 , V_4 ) ;
V_76 = F_84 ( V_66 -> V_155 , V_112 -> V_67 ) ;
F_130 ( & V_76 -> V_221 ) ;
V_247 = & V_76 -> V_223 . V_246 ;
while ( * V_247 ) {
V_248 = * V_247 ;
V_245 = F_131 ( V_248 , struct V_244 , V_246 ) ;
if ( V_112 -> V_3 < V_245 -> V_3 ) {
V_247 = & ( * V_247 ) -> V_252 ;
ASSERT ( V_112 -> V_3 + V_112 -> V_250 <= V_245 -> V_3 ) ;
} else if ( V_112 -> V_3 > V_245 -> V_3 ) {
V_247 = & ( * V_247 ) -> V_253 ;
...
F_132 ( & V_112 -> V_246 , V_248 , V_247 ) ;
F_133 ( & V_112 -> V_246 , & V_76 -> V_223 ) ;
F_134 ( & V_112 -> V_251 , & V_66 -> V_254 ) ;
F_135 ( & V_76 -> V_221 ) ;
F_85 ( V_76 ) ;
}
int
