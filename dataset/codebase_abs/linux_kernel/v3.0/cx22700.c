...
V_28 -> V_46 > V_48 )
return - V_26 ;
if ( V_28 -> V_49 < V_50 || V_28 -> V_49 > V_51 )
return - V_26 ;
if ( V_28 -> V_49 == V_52 )
...
static const T_3 V_30 [ 5 ] = { V_32 , V_53 , V_54 ,
V_55 , V_33 } ;
T_1 V_21 ;
F_2 ( L_1 , V_14 ) ;
...
F_1 ( V_2 , 0x00 , 0x00 ) ;
F_10 ( 10 ) ;
for ( V_63 = 0 ; V_63 < sizeof( V_64 ) ; V_63 += 2 )
F_1 ( V_2 , V_64 [ V_63 ] , V_64 [ V_63 + 1 ] ) ;
F_1 ( V_2 , 0x00 , 0x01 ) ;
return 0 ;
}
static int F_11 ( struct V_60 * V_61 , T_4 * V_65 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
T_5 V_66 = ( F_5 ( V_2 , 0x0d ) << 9 )
| ( F_5 ( V_2 , 0x0e ) << 1 ) ;
...
static int F_12 ( struct V_60 * V_61 , T_6 * V_73 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
...
static int F_13 ( struct V_60 * V_61 , T_5 * V_74 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
T_5 V_66 = ( F_5 ( V_2 , 0x0d ) << 9 )
| ( F_5 ( V_2 , 0x0e ) << 1 ) ;
...
static int F_14 ( struct V_60 * V_61 , T_5 * V_75 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
T_5 V_66 = ( F_5 ( V_2 , 0x0d ) << 9 )
| ( F_5 ( V_2 , 0x0e ) << 1 ) ;
...
static int F_15 ( struct V_60 * V_61 , T_6 * V_76 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
* V_76 = F_5 ( V_2 , 0x0f ) ;
F_1 ( V_2 , 0x0f , 0x00 ) ;
...
static int F_16 ( struct V_60 * V_61 , struct V_77 * V_28 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
F_1 ( V_2 , 0x00 , 0x02 ) ;
F_1 ( V_2 , 0x00 , 0x00 ) ;
if ( V_61 -> V_78 . V_79 . V_80 ) {
V_61 -> V_78 . V_79 . V_80 ( V_61 , V_28 ) ;
if ( V_61 -> V_78 . V_81 ) V_61 -> V_78 . V_81 ( V_61 , 0 ) ;
}
F_6 ( V_2 , V_28 -> V_20 ) ;
F_7 ( V_2 , & V_28 -> V_82 . V_83 ) ;
F_1 ( V_2 , 0x37 , 0x01 ) ;
F_1 ( V_2 , 0x00 , 0x01 ) ;
return 0 ;
}
static int F_17 ( struct V_60 * V_61 , struct V_77 * V_28 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
T_1 V_84 = F_5 ( V_2 , 0x09 ) ;
V_28 -> V_20 = V_84 & 0x1 ? V_24 : V_25 ;
return F_8 ( V_2 , & V_28 -> V_82 . V_83 ) ;
}
static int F_18 ( struct V_60 * V_61 , int V_85 )
{
struct V_1 * V_2 = V_61 -> V_62 ;
if ( V_85 ) {
...
static int F_19 ( struct V_60 * V_61 , struct V_86 * V_87 )
{
V_87 -> V_88 = 150 ;
V_87 -> V_89 = 166667 ;
V_87 -> V_90 = 166667 * 2 ;
...
struct V_60 * F_22 ( const struct V_91 * V_10 ,
struct V_92 * V_15 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_23 ( sizeof( struct V_1 ) , V_93 ) ;
if ( V_2 == NULL ) goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_15 = V_15 ;
if ( F_5 ( V_2 , 0x07 ) < 0 ) goto error;
memcpy ( & V_2 -> V_94 . V_78 , & V_95 , sizeof( struct V_96 ) ) ;
V_2 -> V_94 . V_62 = V_2 ;
return & V_2 -> V_94 ;
error:
F_21 ( V_2 ) ;
