...
type = - 1 ;
if ( F_28 ( ( V_214 = F_7 ( V_210 ) ) & V_235 , 20 ) == 0 ) {
F_29 ( L_1 , V_37 , V_214 ) ;
if ( ( V_214 & V_223 ) == ( V_236 | V_237 ) ) {
F_29 ( L_2 ) ;
type = V_58 ;
} else if ( ( V_214 & ( V_238 | V_236 ) ) == V_238 ) {
F_29 ( L_3 ) ;
type = V_67 ;
...
V_1 -> V_20 = V_19 -> V_23 ;
F_32 ( V_6 ,
V_6 -> V_9 -> V_32 . V_240 , V_21 ) ;
}
static enum V_241
F_33 ( struct V_5 * V_6 , bool V_242 )
{
struct V_25 V_7 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
int type ;
V_7 = V_243 [ 0 ] ;
F_34 ( & V_7 , V_244 ) ;
if ( V_1 -> V_4 . V_4 . V_34 && V_1 -> V_4 . V_4 . V_34 -> V_245 ) {
type = F_23 ( V_1 , V_6 ) ;
} else if ( V_242 ) {
struct V_246 V_247 ;
if ( F_35 ( & V_1 -> V_4 , V_6 ,
...
struct V_1 * V_1 = F_3 ( V_6 ) ;
const struct V_19 * V_19 = F_9 ( V_1 ) ;
if ( V_19 -> V_83 < 480 && V_252 -> V_253 == 480 )
V_252 -> type |= V_254 ;
else if ( V_19 -> V_83 > 480 ) {
if ( V_19 -> V_121 == true && V_19 -> V_83 < 720 ) {
if ( V_252 -> V_253 == 720 )
V_252 -> type |= V_254 ;
} else if ( V_252 -> V_253 == 1080 )
V_252 -> type |= V_254 ;
}
}
static int
...
int V_51 , V_255 = 0 ;
T_2 V_247 ;
for ( V_51 = 0 ; V_51 < F_39 ( V_256 ) ;
V_51 ++ ) {
const struct V_257 * V_258 = & V_256 [ V_51 ] ;
unsigned int V_259 = V_258 -> V_260 ;
unsigned int V_261 = V_258 -> V_262 ;
if ( V_19 -> V_263 && V_258 -> V_260 > V_19 -> V_263 )
continue;
if ( V_258 -> V_260 > 1024 && ( ! V_19 -> V_121
&& ! V_19 -> V_239 ) )
continue;
V_252 = F_40 ( V_6 -> V_9 ) ;
if ( ! V_252 )
continue;
strncpy ( V_252 -> V_23 , V_258 -> V_23 , V_264 ) ;
V_252 -> V_265 = V_259 ;
V_252 -> V_266 = V_259 + 1 ;
V_252 -> V_71 = V_259 + 64 ;
if ( V_252 -> V_71 <= V_252 -> V_266 )
V_252 -> V_71 = V_252 -> V_266 + 1 ;
V_252 -> V_73 = V_259 + 96 ;
V_252 -> V_253 = V_261 ;
V_252 -> V_267 = V_261 + 1 ;
V_252 -> V_268 = V_261 + 32 ;
if ( V_252 -> V_268 <= V_252 -> V_267 )
V_252 -> V_268 = V_252 -> V_267 + 1 ;
V_252 -> V_269 = V_261 + 33 ;
V_247 = ( T_2 ) V_19 -> V_26 * V_252 -> V_269 ;
V_247 *= V_252 -> V_73 ;
V_247 = F_41 ( V_247 , 1000000 ) ;
V_252 -> clock = ( int ) V_247 ;
V_252 -> type = V_270 ;
F_37 ( V_6 , V_252 ) ;
F_42 ( V_6 , V_252 ) ;
V_255 ++ ;
...
static int
F_47 ( struct V_5 * V_6 , struct V_271 * V_272 ,
T_3 V_273 )
{
...
int V_274 = 0 ;
bool V_275 = false ;
V_274 = F_32 ( V_6 , V_272 , V_273 ) ;
if ( V_274 < 0 )
goto V_276;
if ( V_272 == V_9 -> V_32 . V_277 &&
V_1 -> V_198 [ V_199 ] != V_273 ) {
V_1 -> V_198 [ V_199 ] = V_273 ;
V_275 = true ;
} else if ( V_272 == V_9 -> V_32 . V_278 &&
V_1 -> V_198 [ V_201 ] != V_273 ) {
V_1 -> V_198 [ V_201 ] = V_273 ;
V_275 = true ;
} else if ( V_272 == V_9 -> V_32 . V_279 &&
V_1 -> V_198 [ V_200 ] != V_273 ) {
V_1 -> V_198 [ V_200 ] = V_273 ;
V_275 = true ;
} else if ( V_272 == V_9 -> V_32 . V_280 &&
V_1 -> V_198 [ V_202 ] != V_273 ) {
V_1 -> V_198 [ V_202 ] = V_273 ;
V_275 = true ;
} else if ( V_272 == V_9 -> V_32 . V_240 ) {
if ( V_273 >= F_39 ( V_22 ) ) {
V_274 = - V_281 ;
goto V_276;
}
if ( ! strcmp ( V_1 -> V_20 , V_22 [ V_273 ] . V_23 ) )
goto V_276;
V_1 -> V_20 = V_22 [ V_273 ] . V_23 ;
V_275 = true ;
} else {
V_274 = - V_281 ;
goto V_276;
...
if ( V_275 && V_34 )
F_48 ( V_34 , & V_34 -> V_7 , V_34 -> V_282 ,
V_34 -> V_283 , V_34 -> V_284 ) ;
V_276:
return V_274 ;
}
...
return 1 ;
V_274 = 0 ;
for ( V_21 = 0 ; V_21 < V_11 -> V_287 ; V_21 ++ ) {
V_286 = V_11 -> V_288 + V_21 ;
...
struct V_293 * V_293 ;
struct V_294 * V_294 ;
T_1 V_295 , V_296 , V_215 ;
char * V_297 [ F_39 ( V_22 ) ] ;
int V_21 , V_298 = 0 ;
if ( ( F_7 ( V_14 ) & V_299 ) == V_300 )
return;
if ( ! F_49 ( V_9 ) ) {
F_29 ( L_6 ) ;
return;
...
( V_296 & V_227 ) != 0 )
return;
V_1 = F_51 ( sizeof( struct V_1 ) , V_302 ) ;
if ( ! V_1 ) {
return;
}
V_294 = F_51 ( sizeof( struct V_294 ) , V_302 ) ;
if ( ! V_294 ) {
F_46 ( V_1 ) ;
return;
}
...
F_52 ( V_9 , V_6 , & V_304 ,
V_67 ) ;
F_53 ( V_9 , & V_293 -> V_4 , & V_305 ,
V_306 ) ;
F_54 ( V_294 , V_293 ) ;
V_293 -> type = V_307 ;
V_293 -> V_308 = ( 1 << 0 ) | ( 1 << 1 ) ;
V_293 -> V_309 = ( 1 << V_310 ) ;
V_293 -> V_4 . V_311 = ( ( 1 << 0 ) | ( 1 << 1 ) ) ;
V_293 -> V_4 . V_312 = ( 1 << V_307 ) ;
V_1 -> type = V_57 ;
V_1 -> V_198 [ V_199 ] = 54 ;
V_1 -> V_198 [ V_200 ] = 36 ;
V_1 -> V_198 [ V_201 ] = 46 ;
V_1 -> V_198 [ V_202 ] = 37 ;
V_1 -> V_20 = V_22 [ V_298 ] . V_23 ;
F_55 ( & V_293 -> V_4 , & V_313 ) ;
F_56 ( V_6 , & V_314 ) ;
V_6 -> V_315 = false ;
V_6 -> V_316 = false ;
for ( V_21 = 0 ; V_21 < F_39 ( V_22 ) ; V_21 ++ )
V_297 [ V_21 ] = ( char * ) V_22 [ V_21 ] . V_23 ;
F_57 ( V_9 ,
F_39 ( V_22 ) ,
V_297 ) ;
F_58 ( V_6 , V_9 -> V_32 . V_240 ,
V_298 ) ;
F_58 ( V_6 ,
V_9 -> V_32 . V_277 ,
V_1 -> V_198 [ V_199 ] ) ;
