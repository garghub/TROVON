...
static void T_1 F_3 ( struct V_5 * V_6 )
{
unsigned char V_7 ;
if ( ! F_1 () )
return;
...
static void T_1 F_7 ( struct V_5 * V_6 )
{
int V_14 ;
if ( ! F_1 () )
return;
for ( V_14 = 0 ; V_14 < 4 ; V_14 ++ ) {
T_2 V_15 = V_16 [ V_14 * 2 ] | ( V_16 [ V_14 * 2 + 1 ] << 4 ) ;
...
static void T_1 F_12 ( struct V_5 * V_6 )
{
unsigned char V_31 ;
unsigned int V_32 ;
if ( ! F_1 () )
...
static void T_1 F_17 ( struct V_5 * V_6 )
{
int V_14 ;
T_2 * V_36 ;
...
static void T_1 F_24 ( struct V_5 * V_6 )
{
T_4 V_47 ;
if ( ! F_2 ( V_48 ) )
return;
...
static void T_1 F_25 ( struct V_5 * V_6 )
{
unsigned char V_31 ;
if ( ! F_2 ( V_48 ) )
return;
...
static void T_1 F_26 ( struct V_5 * V_6 )
{
unsigned char V_31 ;
if ( ! F_2 ( V_48 ) )
return;
...
static void T_1 F_27 ( struct V_5 * V_6 )
{
