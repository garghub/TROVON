...
static int F_22 ( struct V_4 * V_5 , int V_60 )
{
struct V_6 * V_7 = V_5 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
struct V_21 * V_22 = V_9 -> V_22 ;
...
{
struct V_6 * V_7 = V_5 -> V_7 ;
return F_37 ( V_5 -> V_82 -> V_83 -> V_84 , V_81 ,
V_7 -> V_85 ,
V_7 -> V_45 ,
V_7 -> V_26 ) ;
}
static int F_38 ( struct V_86 * V_82 ,
int V_36 )
{
...
V_89 -> V_10 = NULL ;
V_89 -> V_93 = F_39 ( V_82 -> V_83 -> V_84 , V_90 ,
& V_89 -> V_94 , V_78 ) ;
if ( ! V_89 -> V_93 )
return - V_79 ;
V_89 -> V_32 = V_90 ;
...
static void F_40 ( struct V_86 * V_82 )
{
struct V_4 * V_5 ;
struct V_88 * V_89 ;
int V_36 ;
...
if ( ! V_89 -> V_93 )
continue;
F_41 ( V_82 -> V_83 -> V_84 , V_89 -> V_32 ,
V_89 -> V_93 , V_89 -> V_94 ) ;
V_89 -> V_93 = NULL ;
}
}
static int F_42 ( struct V_95 * V_83 , struct V_96 * V_97 ,
struct V_86 * V_82 )
{
int V_61 = 0 ;
if ( ! V_83 -> V_84 -> V_98 )
...
static T_5 int F_44 ( struct V_105 * V_106 )
{
return F_45 ( & V_106 -> V_84 ,
& V_107 ) ;
}
static int T_6 F_46 ( struct V_105 * V_106 )
{
F_47 ( & V_106 -> V_84 ) ;
return 0 ;
}
