...
static int T_1 F_4 ( void * V_73 , unsigned int V_63 )
{
return - 1 ;
}
static int T_1 F_5 ( struct V_1 * * V_74 , void * V_10 , int V_63 ,
int (* V_9)( void * , unsigned int ) )
{
struct V_1 * V_2 ;
...
STATIC int T_1 F_7 ( unsigned char * V_73 , int V_63 ,
int (* V_9)( void * , unsigned int ) ,
int (* F_8)( void * , unsigned int ) ,
unsigned char * V_62 ,
int * V_64 ,
...
STATIC int T_1 F_10 ( unsigned char * V_73 , int V_63 ,
int (* V_9)( void * , unsigned int ) ,
int (* F_8)( void * , unsigned int ) ,
unsigned char * V_62 ,
int * V_64 ,
