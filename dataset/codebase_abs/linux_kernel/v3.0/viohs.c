...
static int F_35 ( struct V_1 * V_2 , struct V_73 * V_18 )
{
F_9 ( V_25 , L_23 ) ;
V_18 -> V_11 . V_13 = V_83 ;
F_9 ( V_25 , L_24 ) ;
...
int F_39 ( struct V_1 * V_2 , void * V_18 )
{
...
int F_41 ( struct V_1 * V_2 , struct V_10 * V_102 )
{
V_20 V_12 ;
if ( V_102 -> type == V_21 &&
V_102 -> V_13 == V_22 &&
...
V_8 = F_43 ( V_2 -> V_52 -> V_53 , & V_107 , V_106 ) ;
if ( F_44 ( V_8 ) )
return F_45 ( V_8 ) ;
V_2 -> V_8 = V_8 ;
return 0 ;
...
unsigned long V_111 ;
int V_5 , V_112 ;
F_49 ( & V_2 -> V_113 , V_111 ) ;
V_112 = F_50 ( V_2 -> V_8 ) ;
V_5 = 0 ;
if ( V_112 == V_114 ) {
V_5 = F_51 ( V_2 -> V_8 , V_2 -> V_115 ) ;
if ( V_5 )
F_18 ( V_116 L_28
L_29 ,
V_2 -> V_115 , V_2 -> V_52 -> V_53 , V_5 ) ;
}
if ( ! V_5 ) {
V_5 = F_52 ( V_2 -> V_8 ) ;
if ( V_5 )
...
V_117 = F_53 ( V_117 ) ;
F_54 ( & V_2 -> V_120 , V_117 ) ;
}
F_55 ( & V_2 -> V_113 , V_111 ) ;
}
static void F_56 ( unsigned long V_121 )
{
struct V_1 * V_2 = (struct V_1 * ) V_121 ;
F_48 ( V_2 ) ;
}
int F_57 ( struct V_1 * V_2 , struct V_122 * V_52 ,
...
V_2 -> V_78 = V_123 ;
V_2 -> V_75 = V_75 ;
F_59 ( & V_2 -> V_120 , F_56 , ( unsigned long ) V_2 ) ;
return 0 ;
}
