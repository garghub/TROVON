...
for ( V_6 = 0 ; V_6 < V_5 -> V_14 . V_20 ; V_6 ++ ) {
if ( V_5 -> V_14 . V_35 == V_5 -> V_14 . V_19 [ V_6 ] ) {
F_3 ( L_34 , V_5 -> V_14 . V_19 [ V_6 ] ) ;
V_69 = 1 ;
} else
F_3 ( L_35 , V_5 -> V_14 . V_19 [ V_6 ] ) ;
}
F_3 ( L_36 ) ;
if ( ! V_69 )
F_3 ( L_34 , V_5 -> V_14 . V_35 ) ;
if ( ! V_5 -> V_29 -> V_28 . V_38 )
F_3 ( L_37 ) ;
F_3 ( L_38 ) ;
F_31 ( & V_5 -> V_73 , & V_74 ) ;
...
static int T_3 F_36 ( char * V_75 , int V_76 )
{
int V_6 ;
...
static int T_3 F_40 ( char * V_75 )
{
return F_36 ( V_75 , 1 ) ;
}
static int T_3 F_41 ( char * V_75 )
{
return F_36 ( V_75 , 0 ) ;
}
static int T_3 F_42 ( char * V_75 )
{
V_64 = 0 ;
return 1 ;
}
static int T_3 F_43 ( char * V_75 )
{
V_64 = 1 ;
return 1 ;
}
