...
F_14 ( V_86 , 0 , 0 , L_1 , V_81 ) ;
V_87 = F_51 ( V_31 ) ;
F_52 ( 1 ) ;
F_39 ( V_31 ) ;
F_40 ( V_50 ) ;
while ( ( V_46 = F_41 ( V_86 ) ) ) {
int V_49 = strlen ( V_81 ) ;
switch ( V_46 ) {
case 10 :
case 27 :
case F_43 ( V_89 ) :
...
const char * line = F_17 ( V_41 , V_42 ) ;
int V_49 = F_18 ( line ) ;
V_98 = F_24 ( V_98 , V_49 + 2 ) ;
}
V_101 = F_59 ( V_47 + 10 , V_98 + 10 ) ;
( void ) F_13 ( V_101 , V_66 [ V_11 ] ) ;
F_19 ( V_101 , V_41 ) ;
V_100 = F_21 ( V_47 + 4 , V_64 - 2 ) ;
V_99 = F_21 ( V_98 + 2 , V_65 - 2 ) ;
V_96 = F_24 ( V_100 - 4 , 0 ) ;
V_97 = F_24 ( V_99 - 2 , 0 ) ;
V_38 = ( V_64 - V_100 ) / 2 ;
V_37 = ( V_65 - V_99 ) / 2 ;
V_31 = F_25 ( V_100 , V_99 , V_38 , V_37 ) ;
F_26 ( V_31 , TRUE ) ;
...
V_87 = F_51 ( V_31 ) ;
do {
F_60 ( V_101 , V_31 , V_95 , V_94 , 2 , 2 , V_96 ,
V_97 , 0 ) ;
F_11 ( V_31 ,
V_96 + 2 ,
0 ,
