...
{
T_4 V_17 ;
int V_71 , V_72 , V_13 = ( ( V_2 >> 25 ) & 0x1f ) ;
int V_14 = ( V_8 -> V_9 & V_19 ) != 0 ;
F_34 ( V_73 , 1 , 0 , V_8 , 0 ) ;
if ( V_2 & 0x2000 ) {
F_7 ( 0 , 0 , V_13 , V_14 ) ;
...
for ( V_71 = 0 , V_72 = 0 ; V_72 < 16 ; V_72 ++ ) {
V_71 += V_74 [ V_17 & 0xf ] ;
V_17 >>= 4 ;
}
if ( V_13 < 16 ) {
...
struct V_26 T_1 * V_27 ;
V_27 = (struct V_26 T_1 * ) ( ( unsigned long ) ( ( V_28 ) V_8 -> V_18 [ V_22 ] ) ) ;
F_39 ( V_71 , & V_27 -> V_24 [ V_13 - 16 ] ) ;
} else {
struct V_20 T_1 * V_21 ;
V_21 = (struct V_20 T_1 * ) ( V_8 -> V_18 [ V_22 ] + V_23 ) ;
F_39 ( V_71 , & V_21 -> V_24 [ V_13 - 16 ] ) ;
}
}
F_23 ( V_8 ) ;
return 1 ;
}
int F_40 ( V_28 V_2 , struct V_7 * V_8 )
{
unsigned long V_59 = F_14 ( V_8 , V_2 , 0 ) ;
int V_75 = ( ( V_2 >> 25 ) & 0x1e ) | ( ( V_2 >> 20 ) & 0x20 ) ;
struct V_76 * V_77 = V_78 ;
int V_33 = F_5 ( V_2 , V_8 ) ;
int V_79 = ( V_75 < 32 ) ? V_80 : V_81 ;
F_34 ( V_73 , 1 , 0 , V_8 , 0 ) ;
F_41 () ;
F_27 () -> V_82 [ 0 ] &= ~ 0x1c000 ;
if ( V_75 & 3 ) {
...
T_4 V_83 = 0 , V_84 = 0 ;
if ( F_27 () -> V_85 [ 0 ] & V_79 ) {
V_83 = * ( T_4 * ) & V_77 -> V_8 [ V_75 ] ;
V_84 = * ( T_4 * ) & V_77 -> V_8 [ V_75 + 2 ] ;
}
if ( V_33 < 0x80 ) {
F_43 ( V_8 ) ;
return 1 ;
...
if ( F_39 ( V_83 >> 32 , ( V_28 T_1 * ) V_59 ) ||
F_47 ( ( V_28 ) V_83 , ( V_28 T_1 * ) ( V_59 + 4 ) ) ||
F_47 ( V_84 >> 32 , ( V_28 T_1 * ) ( V_59 + 8 ) ) ||
F_47 ( ( V_28 ) V_84 , ( V_28 T_1 * ) ( V_59 + 12 ) ) ) {
if ( V_87 == V_88 )
F_45 ( V_8 , V_59 , 0 ) ;
else
F_46 ( V_8 , 0 , V_59 ) ;
...
for ( V_72 = 0 ; V_72 < V_31 ; V_72 ++ )
V_89 [ V_72 ] = 0 ;
V_61 = F_12 ( V_89 [ 0 ] , ( V_28 T_1 * ) V_59 ) ;
if ( ! V_61 ) {
for ( V_72 = 1 ; V_72 < V_31 ; V_72 ++ )
V_61 |= F_49 ( V_89 [ V_72 ] , ( V_28 T_1 * ) ( V_59 + 4 * V_72 ) ) ;
}
if ( V_61 && ! ( V_33 & 0x2 ) ) {
if ( V_87 == V_88 )
F_45 ( V_8 , V_59 , 0 ) ;
...
T_4 V_3 ;
switch ( V_31 ) {
case 1 : V_89 [ 0 ] = F_50 ( V_89 + 0 ) ; break;
default: * ( T_4 * ) ( V_89 + 0 ) = F_51 ( ( T_4 * ) ( V_89 + 0 ) ) ;
break;
case 4 : V_3 = F_51 ( ( T_4 * ) ( V_89 + 0 ) ) ;
* ( T_4 * ) ( V_89 + 0 ) = F_51 ( ( T_4 * ) ( V_89 + 2 ) ) ;
* ( T_4 * ) ( V_89 + 2 ) = V_3 ;
break;
}
}
...
if ( ! ( F_27 () -> V_85 [ 0 ] & V_79 ) ) {
if ( V_75 < 32 )
memset ( V_77 -> V_8 , 0 , 32 * sizeof( V_28 ) ) ;
else
memset ( V_77 -> V_8 + 32 , 0 , 32 * sizeof( V_28 ) ) ;
}
memcpy ( V_77 -> V_8 + V_75 , V_89 , V_31 * 4 ) ;
F_27 () -> V_85 [ 0 ] |= V_79 ;
}
F_23 ( V_8 ) ;
return 1 ;
}
void F_52 ( V_28 V_2 , struct V_7 * V_8 )
{
...
F_39 ( 0 , ( int T_1 * ) V_16 ) ;
if ( ( V_2 & 0x780000 ) == 0x180000 )
F_39 ( 0 , ( ( int T_1 * ) V_16 ) + 1 ) ;
} else {
F_39 ( 0 , ( unsigned long T_1 * ) V_16 ) ;
if ( ( V_2 & 0x780000 ) == 0x180000 )
F_39 ( 0 , ( unsigned long T_1 * ) V_16 + 1 ) ;
}
F_23 ( V_8 ) ;
}
void F_53 ( struct V_7 * V_8 , unsigned long V_93 , unsigned long V_94 )
{
unsigned long V_95 = V_8 -> V_38 ;
...
if ( V_9 & V_19 )
F_4 ( L_17 , V_8 ) ;
F_34 ( V_62 , 1 , 0 , V_8 , V_93 ) ;
if ( F_11 ( V_25 ) )
V_95 = ( V_28 ) V_95 ;
if ( F_12 ( V_2 , ( V_28 T_1 * ) V_95 ) != - V_96 ) {
int V_33 = F_5 ( V_2 , V_8 ) ;
V_28 V_83 , V_84 ;
int V_61 ;
if ( ( V_33 > V_69 ) ||
...
goto V_97;
V_83 = V_84 = 0 ;
V_61 = F_12 ( V_83 , ( V_28 T_1 * ) V_93 ) ;
if ( ! V_61 )
V_61 = F_12 ( V_84 , ( V_28 T_1 * ) ( V_93 + 4 ) ) ;
if ( V_61 ) {
if ( ! ( V_33 & 0x2 ) )
goto V_97;
V_83 = V_84 = 0 ;
...
F_41 () ;
V_75 = ( ( V_2 >> 25 ) & 0x1e ) | ( ( V_2 >> 20 ) & 0x20 ) ;
V_17 = ( ( ( T_4 ) V_83 ) << 32 ) | V_84 ;
if ( V_33 & 0x8 )
V_17 = F_44 ( & V_17 ) ;
V_79 = ( V_75 < 32 ) ? V_80 : V_81 ;
if ( ! ( F_27 () -> V_85 [ 0 ] & V_91 ) ) {
F_27 () -> V_85 [ 0 ] = V_91 ;
F_27 () -> V_92 [ 0 ] = 0 ;
}
...
void F_54 ( struct V_7 * V_8 , unsigned long V_93 , unsigned long V_94 )
{
unsigned long V_95 = V_8 -> V_38 ;
unsigned long V_9 = V_8 -> V_9 ;
V_28 V_2 ;
...
F_41 () ;
if ( F_27 () -> V_85 [ 0 ] & V_79 )
V_17 = * ( T_4 * ) & V_77 -> V_8 [ V_75 ] ;
switch ( V_33 ) {
case V_10 :
case V_86 : break;
case V_66 :
case V_67 :
V_17 = F_44 ( & V_17 ) ; break;
default: goto V_97;
}
if ( F_39 ( V_17 >> 32 , ( V_28 T_1 * ) V_93 ) ||
F_47 ( ( V_28 ) V_17 , ( V_28 T_1 * ) ( V_93 + 4 ) ) )
goto V_97;
} else {
V_97:
if ( V_87 == V_88 )
