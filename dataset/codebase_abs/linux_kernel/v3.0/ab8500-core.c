...
int T_5 F_32 ( struct V_3 * V_3 )
{
struct V_50 * V_51 = F_33 ( V_3 -> V_2 ) ;
int V_10 ;
int V_21 ;
T_1 V_14 ;
if ( V_51 )
...
if ( V_10 )
return V_10 ;
V_10 = F_37 ( V_3 -> V_32 , NULL , F_19 ,
V_60 | V_61 ,
L_11 , V_3 ) ;
if ( V_10 )
goto V_62;
}
V_10 = F_38 ( V_3 -> V_2 , 0 , V_63 ,
F_39 ( V_63 ) , NULL ,
V_3 -> V_33 ) ;
if ( V_10 )
goto V_64;
V_10 = F_40 ( & V_3 -> V_2 -> V_65 , & V_66 ) ;
if ( V_10 )
F_6 ( V_3 -> V_2 , L_12 ) ;
return V_10 ;
V_64:
...
int T_6 F_42 ( struct V_3 * V_3 )
{
F_43 ( & V_3 -> V_2 -> V_65 , & V_66 ) ;
F_44 ( V_3 -> V_2 ) ;
if ( V_3 -> V_33 ) {
F_41 ( V_3 -> V_32 , V_3 ) ;
F_29 ( V_3 ) ;
