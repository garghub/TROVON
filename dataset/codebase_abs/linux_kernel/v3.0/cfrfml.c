...
int V_11 ;
struct V_5 * V_12 =
F_7 ( sizeof( struct V_5 ) , V_13 ) ;
if ( ! V_12 ) {
F_8 ( L_1 ) ;
return NULL ;
}
F_9 ( & V_12 -> V_14 , V_8 , V_9 , false ) ;
V_12 -> V_14 . V_15 = F_1 ;
...
static struct V_25 * F_11 ( struct V_5 * V_6 , char * V_26 ,
struct V_25 * V_27 , int * V_28 )
{
struct V_25 * V_29 ;
* V_28 = - V_30 ;
if ( F_12 ( V_27 , V_26 , 6 ) < 0 )
return NULL ;
if ( memcmp ( V_26 , V_6 -> V_26 , 6 ) != 0 )
return NULL ;
V_29 = F_13 ( V_6 -> V_7 , V_27 ,
V_6 -> V_31 + V_20 ) ;
* V_28 = - V_32 ;
if ( V_29 == NULL )
return NULL ;
...
F_15 ( & V_6 -> V_22 ) ;
V_28 = - V_30 ;
if ( F_12 ( V_27 , & V_11 , 1 ) < 0 )
goto V_36;
V_34 = V_11 & V_37 ;
if ( V_34 ) {
if ( V_6 -> V_7 == NULL ) {
if ( F_16 ( V_27 , V_6 -> V_26 , 6 ) < 0 )
goto V_36;
V_6 -> V_31 = F_17 ( V_6 -> V_26 + 4 ) ;
if ( F_18 ( V_27 ) )
goto V_36;
V_6 -> V_7 = V_27 ;
V_27 = NULL ;
} else {
V_29 = F_11 ( V_6 , V_26 , V_27 , & V_28 ) ;
if ( V_29 == NULL )
goto V_36;
if ( F_18 ( V_29 ) )
goto V_36;
...
goto V_36;
V_28 = 0 ;
if ( F_19 ( V_27 ) > V_6 -> V_21 + V_20 )
V_28 = F_16 ( V_27 , V_44 , 6 ) ;
if ( V_28 < 0 )
goto V_36;
while ( F_19 ( V_46 ) > V_6 -> V_21 + V_20 ) {
V_43 = 1 ;
V_28 = - V_30 ;
if ( F_25 ( V_46 , & V_43 , 1 ) < 0 )
goto V_36;
V_45 = F_26 ( V_46 , V_6 -> V_21 ) ;
if ( V_45 == NULL )
goto V_36;
V_28 = F_22 ( V_6 , V_46 ) ;
if ( V_28 != 0 )
