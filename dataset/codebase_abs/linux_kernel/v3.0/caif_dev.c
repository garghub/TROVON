...
static int F_23 ( struct V_24 * V_25 , struct V_14 * V_15 ,
...
F_25 () ;
V_16 = F_17 ( V_15 ) ;
if ( ! V_16 || ! V_16 -> V_20 . V_31 || ! V_16 -> V_20 . V_31 -> F_23 ||
! F_26 ( V_16 -> V_18 ) ) {
F_27 () ;
F_28 ( V_25 ) ;
return V_32 ;
...
F_7 ( V_16 ) ;
F_27 () ;
V_23 = V_16 -> V_20 . V_31 -> F_23 ( V_16 -> V_20 . V_31 , V_22 ) ;
if ( V_23 == - V_33 )
F_29 ( V_22 ) ;
F_5 ( V_16 ) ;
return 0 ;
}
static void F_30 ( struct V_14 * V_15 , int V_34 )
{
struct V_9 * V_16 ;
F_25 () ;
V_16 = F_17 ( V_15 ) ;
...
static int F_31 ( struct V_39 * V_40 , unsigned long V_41 ,
void * V_42 )
{
