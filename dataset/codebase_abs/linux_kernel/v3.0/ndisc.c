...
struct V_93 * F_34 ( struct V_2 * V_3 ,
...
F_39 ( V_105 , F_40 ( V_3 ) ) ;
F_41 ( V_102 , V_105 , V_3 , V_95 , V_94 , V_112 , V_107 ) ;
V_105 -> V_113 = V_105 -> V_114 ;
F_42 ( V_105 , V_107 ) ;
V_106 = (struct V_96 * ) F_43 ( V_105 ) ;
memcpy ( V_106 , V_97 , sizeof( * V_106 ) ) ;
V_5 = F_43 ( V_105 ) + sizeof( struct V_96 ) ;
if ( V_98 ) {
F_44 ( (struct V_41 * ) V_5 , V_98 ) ;
V_5 += sizeof( * V_98 ) ;
}
if ( V_99 )
F_4 ( V_5 , V_99 , V_3 -> V_81 ,
V_3 -> V_4 , V_3 -> type ) ;
V_106 -> V_115 = F_45 ( V_95 , V_94 , V_107 ,
V_112 ,
F_46 ( V_106 ,
V_107 , 0 ) ) ;
return V_105 ;
}
void F_47 ( struct V_93 * V_105 ,
struct V_2 * V_3 ,
struct V_59 * V_60 ,
const struct V_41 * V_94 ,
const struct V_41 * V_95 ,
...
T_1 type ;
type = V_97 -> V_121 ;
F_48 ( V_102 , & V_117 , type , V_95 , V_94 , V_3 -> V_58 ) ;
V_119 = F_49 ( V_3 , V_60 , V_94 ) ;
if ( ! V_119 ) {
F_50 ( V_105 ) ;
return;
}
V_119 = F_51 ( V_100 , V_119 , F_52 ( & V_117 ) , NULL , 0 ) ;
if ( F_53 ( V_119 ) ) {
F_50 ( V_105 ) ;
return;
}
F_54 ( V_105 , V_119 ) ;
V_120 = F_23 ( V_119 -> V_3 ) ;
F_55 ( V_100 , V_120 , V_122 , V_105 -> V_107 ) ;
V_108 = F_56 ( V_123 , V_124 , V_105 , NULL , V_119 -> V_3 ,
V_125 ) ;
if ( ! V_108 ) {
F_57 ( V_100 , V_120 , type ) ;
F_58 ( V_100 , V_120 , V_126 ) ;
}
if ( F_59 ( V_120 != NULL ) )
F_27 ( V_120 ) ;
}
...
{
struct V_93 * V_105 ;
V_105 = F_34 ( V_3 , V_94 , V_95 , V_97 , V_98 , V_99 ) ;
if ( ! V_105 )
return;
F_47 ( V_105 , V_3 , V_60 , V_94 , V_95 , V_97 ) ;
}
static void F_61 ( struct V_2 * V_3 , struct V_59 * V_60 ,
const struct V_41 * V_94 ,
...
V_134 = F_62 ( F_35 ( V_3 ) , V_127 , V_3 , 1 ) ;
if ( V_134 ) {
V_135 = V_127 ;
if ( V_134 -> V_78 & V_137 )
V_130 = 0 ;
...
if ( F_64 ( F_35 ( V_3 ) , V_3 , V_94 ,
F_65 ( F_35 ( V_3 ) -> V_103 . V_104 ) -> V_140 ,
& V_132 ) )
return;
V_135 = & V_132 ;
}
...
F_30 ( & V_144 -> V_42 , & V_145 ) ;
F_61 ( V_3 , NULL , & V_145 , & V_144 -> V_42 ,
! ! V_120 -> V_138 . V_147 ,
false , true ,
true ) ;
}
...
void F_70 ( struct V_2 * V_3 , struct V_59 * V_60 ,
...
F_60 ( V_3 , V_60 , V_94 , V_95 ,
& V_97 , V_148 ,
! F_72 ( V_95 ) ? V_22 : 0 ) ;
}
void F_73 ( struct V_2 * V_3 , const struct V_41 * V_95 ,
const struct V_41 * V_94 )
{
struct V_96 V_97 = {
. V_121 = V_152 ,
...
#ifdef F_74
if ( V_153 ) {
struct V_133 * V_134 = F_62 ( F_35 ( V_3 ) , V_95 ,
V_3 , 1 ) ;
if ( V_134 ) {
if ( V_134 -> V_78 & V_137 ) {
V_153 = 0 ;
...
#endif
F_60 ( V_3 , NULL , V_94 , V_95 ,
& V_97 , NULL ,
V_153 ? V_22 : 0 ) ;
}
static void F_75 ( struct V_59 * V_60 , struct V_93 * V_105 )
{
F_76 ( V_105 ) ;
F_50 ( V_105 ) ;
}
static void F_77 ( struct V_59 * V_60 , struct V_93 * V_105 )
{
struct V_41 * V_95 = NULL ;
struct V_41 V_145 ;
struct V_2 * V_3 = V_60 -> V_3 ;
struct V_41 * V_98 = (struct V_41 * ) & V_60 -> V_61 ;
int V_154 = F_78 ( & V_60 -> V_154 ) ;
if ( V_105 && F_79 ( F_35 ( V_3 ) , & F_80 ( V_105 ) -> V_95 , V_3 , 1 ) )
V_95 = & F_80 ( V_105 ) -> V_95 ;
if ( ( V_154 -= V_60 -> V_65 -> V_155 ) < 0 ) {
if ( ! ( V_60 -> V_71 & V_87 ) ) {
F_81 ( V_156 L_4 ,
V_28 , V_98 ) ;
}
F_70 ( V_3 , V_60 , V_98 , V_98 , V_95 ) ;
...
F_30 ( V_98 , & V_145 ) ;
F_70 ( V_3 , NULL , V_98 , & V_145 , V_95 ) ;
}
}
static int F_84 ( const void * V_53 ,
struct V_2 * V_3 )
{
struct V_89 * V_90 ;
int V_158 = - 1 ;
F_67 ( & V_159 . V_146 ) ;
V_90 = F_85 ( & V_159 , F_35 ( V_3 ) , V_53 , V_3 ) ;
if ( V_90 )
V_158 = ! ! ( V_90 -> V_78 & V_160 ) ;
F_69 ( & V_159 . V_146 ) ;
return V_158 ;
}
static void F_86 ( struct V_93 * V_105 )
{
struct V_161 * V_162 = (struct V_161 * ) F_43 ( V_105 ) ;
const struct V_41 * V_95 = & F_80 ( V_105 ) -> V_95 ;
const struct V_41 * V_94 = & F_80 ( V_105 ) -> V_94 ;
T_1 * V_38 = NULL ;
T_2 V_163 = V_105 -> V_114 - ( V_105 -> V_113 +
F_87 ( struct V_161 , V_5 ) ) ;
struct V_17 V_19 ;
...
if ( V_164 &&
! ( V_94 -> V_167 [ 0 ] == F_88 ( 0xff020000 ) &&
V_94 -> V_167 [ 1 ] == F_88 ( 0x00000000 ) &&
V_94 -> V_167 [ 2 ] == F_88 ( 0x00000001 ) &&
V_94 -> V_168 [ 12 ] == 0xff ) ) {
F_9 ( V_27
L_6 ) ;
return;
...
V_165 = F_21 ( V_94 ) ;
V_134 = F_62 ( F_35 ( V_3 ) , & V_162 -> V_98 , V_3 , 1 ) ;
if ( V_134 ) {
...
if ( F_91 ( V_100 , V_3 , & V_162 -> V_98 ) ||
( V_120 -> V_138 . V_147 &&
( V_100 -> V_103 . V_172 -> V_173 || V_120 -> V_138 . V_173 ) &&
( V_166 = F_84 ( & V_162 -> V_98 , V_3 ) ) >= 0 ) ) {
if ( ! ( F_92 ( V_105 ) -> V_78 & V_174 ) &&
V_105 -> V_175 != V_176 &&
V_165 != 0 &&
V_120 -> V_67 -> V_177 != 0 ) {
struct V_93 * V_90 = F_93 ( V_105 , V_178 ) ;
if ( V_90 )
F_94 ( & V_159 , V_120 -> V_67 , V_90 ) ;
goto V_171;
}
} else
goto V_171;
...
if ( V_164 ) {
F_61 ( V_3 , NULL , & V_179 , & V_162 -> V_98 ,
...
F_95 ( & V_159 , V_181 ) ;
V_60 = F_96 ( & V_159 , V_95 , V_3 ,
! V_165 || V_38 || ! V_3 -> V_4 ) ;
if ( V_60 )
F_97 ( V_60 , V_38 , V_182 ,
V_183 |
V_184 ) ;
if ( V_60 || ! V_3 -> V_70 ) {
F_61 ( V_3 , V_60 , V_95 , & V_162 -> V_98 ,
V_166 ,
...
static void F_99 ( struct V_93 * V_105 )
{
struct V_161 * V_162 = (struct V_161 * ) F_43 ( V_105 ) ;
const struct V_41 * V_95 = & F_80 ( V_105 ) -> V_95 ;
const struct V_41 * V_94 = & F_80 ( V_105 ) -> V_94 ;
...
V_60 = F_100 ( & V_159 , & V_162 -> V_98 , V_3 ) ;
if ( V_60 ) {
T_1 V_189 = V_60 -> V_78 ;
struct V_100 * V_100 = F_35 ( V_3 ) ;
if ( V_60 -> V_71 & V_190 )
...
F_101 ( & V_159 , V_100 , & V_162 -> V_98 , V_3 , 0 ) ) {
goto V_171;
}
F_97 ( V_60 , V_38 ,
...
static void F_104 ( struct V_93 * V_105 )
{
struct V_196 * V_196 = (struct V_196 * ) F_43 ( V_105 ) ;
...
V_60 = F_96 ( & V_159 , V_95 , V_105 -> V_3 , 1 ) ;
if ( V_60 ) {
F_97 ( V_60 , V_38 , V_182 ,
V_183 |
V_184 |
...
static void F_106 ( struct V_93 * V_197 , struct V_11 * V_5 )
{
struct V_96 * V_97 = (struct V_96 * ) F_43 ( V_197 ) ;
struct V_93 * V_105 ;
struct V_198 * V_199 ;
struct V_200 * V_201 ;
struct V_100 * V_100 = F_35 ( V_197 -> V_3 ) ;
int V_108 ;
int V_202 = F_107 ( sizeof( struct V_200 )
+ ( V_5 -> V_15 << 3 ) ) ;
T_4 V_203 = V_202 + F_108 ( sizeof( struct V_41 ) ) ;
V_105 = F_109 ( V_203 , V_178 ) ;
if ( V_105 == NULL ) {
V_108 = - V_204 ;
goto V_205;
}
V_199 = F_110 ( V_105 , 0 , 0 , V_206 , V_202 , 0 ) ;
if ( V_199 == NULL ) {
goto V_207;
}
V_201 = F_111 ( V_199 ) ;
...
F_112 ( V_105 , V_215 , sizeof( struct V_41 ) ,
& F_80 ( V_197 ) -> V_95 ) ;
F_113 ( V_105 , V_199 ) ;
F_114 ( V_105 , V_100 , 0 , V_216 , NULL , V_178 ) ;
return;
V_207:
F_115 ( V_105 ) ;
V_108 = - V_217 ;
V_205:
F_116 ( V_100 , V_216 , V_108 ) ;
}
static inline int F_117 ( struct V_62 * V_63 )
{
if ( V_63 -> V_138 . V_147 && V_63 -> V_138 . F_117 < 2 )
return 0 ;
return V_63 -> V_138 . F_117 ;
}
static void F_118 ( struct V_93 * V_105 )
{
struct V_218 * V_218 = (struct V_218 * ) F_43 ( V_105 ) ;
...
if ( ! ( F_119 ( & F_80 ( V_105 ) -> V_95 ) & V_222 ) ) {
F_9 ( V_27
L_18 ) ;
return;
}
...
V_221 = V_240 ;
#endif
V_195 = F_102 ( & F_80 ( V_105 ) -> V_95 , V_105 -> V_3 ) ;
if ( V_195 )
V_60 = V_195 -> V_241 ;
if ( V_195 && V_219 == 0 ) {
F_123 ( V_60 ) ;
...
F_124 ( V_156
L_23 ) ;
V_195 = F_125 ( & F_80 ( V_105 ) -> V_95 , V_105 -> V_3 , V_221 ) ;
if ( V_195 == NULL ) {
F_38 ( V_111
L_24 ,
V_28 ) ;
...
V_195 -> V_242 = ( V_195 -> V_242 & ~ V_243 ) | F_127 ( V_221 ) ;
}
if ( V_195 )
V_195 -> V_244 = V_245 + ( V_246 * V_219 ) ;
if ( V_218 -> V_185 . V_247 ) {
V_63 -> V_138 . V_248 = V_218 -> V_185 . V_247 ;
if ( V_195 )
F_128 ( & V_195 -> V_119 , V_249 ,
V_218 -> V_185 . V_247 ) ;
}
V_235:
if ( V_63 -> V_67 ) {
unsigned long V_250 = F_129 ( V_218 -> V_251 ) ;
if ( V_250 && V_250 / 1000 < V_252 / V_246 ) {
V_250 = ( V_250 * V_246 ) / 1000 ;
if ( V_250 < V_246 / 10 )
V_250 = V_246 / 10 ;
V_63 -> V_67 -> V_253 = V_250 ;
V_63 -> V_254 = V_245 ;
F_130 ( V_255 , V_63 ) ;
}
V_250 = F_129 ( V_218 -> V_256 ) ;
if ( V_250 && V_250 / 1000 < V_252 / ( 3 * V_246 ) ) {
V_250 = ( V_250 * V_246 ) / 1000 ;
if ( V_250 < V_246 / 10 )
V_250 = V_246 / 10 ;
if ( V_250 != V_63 -> V_67 -> V_257 ) {
V_63 -> V_67 -> V_257 = V_250 ;
V_63 -> V_67 -> V_258 = 3 * V_250 ;
V_63 -> V_67 -> V_256 = F_131 ( V_250 ) ;
V_63 -> V_254 = V_245 ;
F_130 ( V_255 , V_63 ) ;
}
}
...
V_225:
if ( ! V_60 )
V_60 = F_96 ( & V_159 , & F_80 ( V_105 ) -> V_95 ,
V_105 -> V_3 , 1 ) ;
if ( V_60 ) {
T_1 * V_38 = NULL ;
if ( V_19 . V_169 ) {
...
V_60 = F_96 ( & V_159 , V_98 , V_105 -> V_3 , 1 ) ;
if ( V_60 ) {
F_138 ( V_271 , & F_80 ( V_105 ) -> V_94 ,
& F_80 ( V_105 ) -> V_95 , V_60 , V_38 ,
V_272 ) ;
F_98 ( V_60 ) ;
}
F_27 ( V_63 ) ;
...
if ( F_71 ( V_3 , & V_276 , V_151 ) ) {
F_9 ( V_27
L_36 ,
V_3 -> V_188 ) ;
return;
}
if ( ! F_137 ( & F_80 ( V_105 ) -> V_94 , V_98 ) &&
F_119 ( V_98 ) != ( V_273 | V_222 ) ) {
F_9 ( V_27
L_33 ) ;
return;
}
F_48 ( V_102 , & V_117 , V_281 ,
& V_276 , & F_80 ( V_105 ) -> V_95 , V_3 -> V_58 ) ;
...
F_39 ( V_275 , F_40 ( V_3 ) ) ;
F_41 ( V_102 , V_275 , V_3 , & V_276 , & F_80 ( V_105 ) -> V_95 ,
V_112 , V_107 ) ;
...
* ( V_5 ++ ) = ( V_278 >> 3 ) ;
V_5 += 6 ;
memcpy ( V_5 , F_80 ( V_105 ) , V_278 - 8 ) ;
V_185 -> V_115 = F_45 ( & V_276 , & F_80 ( V_105 ) -> V_95 ,
V_107 , V_112 ,
F_46 ( V_185 , V_107 , 0 ) ) ;
F_54 ( V_275 , V_119 ) ;
V_120 = F_23 ( V_119 -> V_3 ) ;
F_55 ( V_100 , V_120 , V_122 , V_105 -> V_107 ) ;
V_108 = F_56 ( V_123 , V_124 , V_275 , NULL , V_119 -> V_3 ,
V_125 ) ;
if ( ! V_108 ) {
F_57 ( V_100 , V_120 , V_281 ) ;
F_58 ( V_100 , V_120 , V_126 ) ;
}
if ( F_59 ( V_120 != NULL ) )
F_27 ( V_120 ) ;
...
return 0 ;
V_162 = (struct V_161 * ) F_43 ( V_105 ) ;
F_149 ( V_105 , V_105 -> V_6 - F_43 ( V_105 ) ) ;
if ( F_80 ( V_105 ) -> V_248 != 255 ) {
F_9 ( V_27
L_39 ,
F_80 ( V_105 ) -> V_248 ) ;
return 0 ;
...
memset ( F_92 ( V_105 ) , 0 , sizeof( struct V_285 ) ) ;
...
V_158 = - 1 ;
if ( V_305 && V_158 == 0 && V_3 && ( V_120 = F_23 ( V_3 ) ) != NULL ) {
if ( V_296 -> V_6 == & V_120 -> V_67 -> V_257 )
V_120 -> V_67 -> V_256 = F_131 ( V_120 -> V_67 -> V_257 ) ;
V_120 -> V_254 = V_245 ;
F_130 ( V_255 , V_120 ) ;
F_27 ( V_120 ) ;
}
