...
static struct V_243 * F_97 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
F_61 ( V_84 ) ;
V_84 -> V_156 . V_193 += F_7 ( V_2 , V_233 ) ;
...
static void F_98 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
unsigned long V_5 ;
if ( V_84 -> V_5 & V_244 ) {
...
static T_6 F_101 ( int V_130 , void * V_256 )
{
...
static void F_105 ( struct V_83 * V_84 )
{
F_106 ( V_84 -> V_130 ) ;
F_101 ( 0 , V_84 ) ;
F_107 ( V_84 -> V_130 ) ;
}
static int F_108 ( struct V_83 * V_84 , void * V_267 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
struct V_268 * V_36 = V_267 ;
if ( V_2 -> V_255 <= 1 && F_109 ( V_84 ) )
return - V_269 ;
if ( ! F_83 ( V_36 -> V_270 ) )
return - V_213 ;
...
static int F_110 ( struct V_83 * V_84 , struct V_271 * V_272 , int V_273 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
if ( ! F_109 ( V_84 ) || ! V_2 -> V_80 )
return - V_274 ;
return F_111 ( V_2 -> V_80 , V_272 , V_273 ) ;
}
static int
F_112 ( struct V_83 * V_84 , struct V_275 * V_273 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
V_273 -> V_276 = 1 ;
V_273 -> V_277 = 1 ;
return F_113 ( V_2 -> V_80 , V_273 ) ;
}
static int
F_114 ( struct V_83 * V_84 , struct V_275 * V_273 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
return F_115 ( V_2 -> V_80 , V_273 ) ;
}
static void F_116 ( struct V_83 * V_84 ,
struct V_278 * V_279 )
{
F_117 ( V_279 -> V_280 , V_281 , sizeof( V_279 -> V_280 ) ) ;
F_117 ( V_279 -> V_282 , V_283 , sizeof( V_279 -> V_282 ) ) ;
F_117 ( V_279 -> V_284 , F_53 ( V_84 -> V_84 . V_150 ) ,
sizeof( V_279 -> V_284 ) ) ;
}
static int F_118 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
return F_119 ( V_2 -> V_80 ) ;
}
static T_1 F_120 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
return V_2 -> V_285 ;
}
static void F_121 ( struct V_83 * V_84 , T_1 V_286 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
V_2 -> V_285 = V_286 ;
}
...
static void
F_123 ( struct V_83 * V_84 , struct V_290 * V_291 ,
void * V_15 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
struct V_79 * V_80 = V_2 -> V_80 ;
...
static int F_125 ( struct V_1 * V_2 , T_1 V_293 )
{
int V_179 = 100 ;
T_1 V_294 ;
...
int V_21 ;
F_124 ( V_2 ) ;
V_241 = F_130 ( V_302 -> V_241 , V_300 ) ;
for ( V_21 = 0 ; V_21 < V_241 ; V_21 ++ ) {
int V_123 = F_126 ( V_2 , V_21 , V_303 ) ;
if ( V_123 < 0 ) {
V_302 -> V_241 = 0 ;
return V_123 ;
}
...
F_124 ( V_2 ) ;
F_125 ( V_2 , V_304 ) ;
V_123 = F_127 ( V_2 , V_302 -> V_26 , * V_9 ) ;
F_125 ( V_2 , V_305 ) ;
V_302 -> V_241 = 1 ;
return V_123 ;
}
static void T_5 F_132 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
...
static int T_5 F_133 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_42 ( V_84 ) ;
unsigned int V_306 ;
F_34 ( V_2 , V_125 , L_81 ) ;
...
F_135 ( V_84 ) ;
V_84 -> V_5 |= V_309 ;
F_136 ( V_84 , & V_2 -> V_183 , F_64 , V_310 ) ;
V_84 -> V_311 = & V_312 ;
V_84 -> V_313 = & V_314 ;
return 0 ;
}
static int T_7 F_137 ( struct V_136 * V_137 )
{
struct V_83 * V_84 ;
struct V_1 * V_2 ;
struct V_315 * V_316 ;
...
F_140 ( V_137 , NULL ) ;
F_141 ( V_84 ) ;
F_142 ( V_84 -> V_130 , V_84 ) ;
V_316 = F_143 ( V_137 , V_317 ,
L_96 ) ;
if ( ! V_316 )
V_316 = F_144 ( V_137 , V_317 , 0 ) ;
F_145 ( V_316 -> V_318 , F_146 ( V_316 ) ) ;
F_147 ( V_2 -> V_7 ) ;
F_148 ( V_84 ) ;
return 0 ;
}
static int T_5 F_149 ( struct V_136 * V_137 )
{
struct V_83 * V_84 ;
struct V_1 * V_2 ;
...
V_322 = F_146 ( V_316 ) ;
V_321 = F_144 ( V_137 , V_326 , 0 ) ;
if ( ! V_321 ) {
F_151 ( L_100 ) ;
V_324 = - V_124 ;
goto V_325;
}
if ( ! F_152 ( V_316 -> V_318 , V_322 , V_281 ) ) {
V_324 = - V_269 ;
goto V_325;
}
V_84 = F_153 ( sizeof( struct V_1 ) ) ;
if ( ! V_84 ) {
F_151 ( L_101 ) ;
V_324 = - V_140 ;
goto V_327;
}
F_154 ( V_84 , & V_137 -> V_84 ) ;
V_2 = F_42 ( V_84 ) ;
V_84 -> V_130 = V_321 -> V_318 ;
V_323 = V_321 -> V_5 & V_328 ;
V_2 -> V_7 = F_155 ( V_316 -> V_318 , V_322 ) ;
...
static int F_160 ( struct V_341 * V_84 )
{
struct V_83 * V_342 = F_161 ( V_84 ) ;
...
static int F_162 ( struct V_341 * V_84 )
{
struct V_83 * V_342 = F_161 ( V_84 ) ;
struct V_1 * V_2 = F_42 ( V_342 ) ;
