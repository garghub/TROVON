...
V_10 -> V_19 = ( unsigned short ) V_56 ;
}
else {
unsigned long V_19 = F_19 () ;
if ( ! V_19 ) {
F_18 ( L_13 ) ;
return 0 ;
}
...
switch( V_31 -> V_50 ) {
case V_55 :
memcpy ( V_10 -> V_60 , V_61 , 6 ) ;
break;
case V_54 :
V_31 -> V_46 ( V_10 -> V_60 , V_62 , 6 ) ;
break;
case V_51 :
V_8 = V_33 -> V_48 ;
for( V_8 = 0 ; V_8 < 6 ; ++ V_8 )
...
for( V_8 = 0 ; V_8 < 6 ; V_8 ++ )
V_42 -> V_64 . V_66 [ V_8 ] = V_10 -> V_60 [ V_8 ^ 1 ] ;
...
memcpy ( V_10 -> V_60 , V_189 -> V_191 , V_10 -> V_192 ) ;
for( V_8 = 0 ; V_8 < 6 ; V_8 ++ )
V_42 -> V_64 . V_66 [ V_8 ] = V_10 -> V_60 [ V_8 ^ 1 ] ;
V_31 -> V_46 ( V_62 , V_10 -> V_60 , 6 ) ;
* V_52 = V_53 ;
return 0 ;
}
