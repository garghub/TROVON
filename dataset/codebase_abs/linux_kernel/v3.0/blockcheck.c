...
T_1 V_36 , V_37 ;
F_21 ( V_20 ) ;
V_42 . V_39 = F_32 ( V_35 -> V_39 ) ;
V_42 . V_40 = F_33 ( V_35 -> V_40 ) ;
memset ( V_35 , 0 , sizeof( struct V_34 ) ) ;
V_36 = F_28 ( ~ 0 , V_6 , V_9 ) ;
if ( V_36 == V_42 . V_39 )
goto V_27;
...
F_24 ( V_43 ,
L_8 ,
( unsigned int ) V_42 . V_39 , ( unsigned int ) V_36 ) ;
V_37 = F_5 ( V_6 , V_9 ) ;
F_11 ( V_6 , V_9 , V_37 ^ V_42 . V_40 ) ;
V_36 = F_28 ( ~ 0 , V_6 , V_9 ) ;
if ( V_36 == V_42 . V_39 ) {
F_26 ( V_20 ) ;
goto V_27;
...
V_25 = - V_44 ;
V_27:
V_35 -> V_39 = F_29 ( V_42 . V_39 ) ;
V_35 -> V_40 = F_30 ( V_42 . V_40 ) ;
return V_25 ;
}
void F_34 ( struct V_45 * * V_46 , int V_8 ,
struct V_34 * V_35 )
{
int V_1 ;
T_1 V_36 , V_37 ;
...
V_36 = F_28 ( V_36 , V_46 [ V_1 ] -> V_47 , V_46 [ V_1 ] -> V_48 ) ;
V_37 = ( V_41 ) F_2 ( V_37 , V_46 [ V_1 ] -> V_47 ,
V_46 [ V_1 ] -> V_48 * 8 ,
V_46 [ V_1 ] -> V_48 * 8 * V_1 ) ;
}
F_3 ( V_37 > V_38 ) ;
...
int F_35 ( struct V_45 * * V_46 , int V_8 ,
struct V_34 * V_35 ,
struct V_19 * V_20 )
{
int V_1 , V_25 = 0 ;
...
F_6 ( V_46 [ V_1 ] -> V_47 , V_46 [ V_1 ] -> V_48 * 8 ,
V_46 [ V_1 ] -> V_48 * 8 * V_1 , V_10 ) ;
}
for ( V_1 = 0 , V_36 = ~ 0 ; V_1 < V_8 ; V_1 ++ )
V_36 = F_28 ( V_36 , V_46 [ V_1 ] -> V_47 , V_46 [ V_1 ] -> V_48 ) ;
if ( V_36 == V_42 . V_39 ) {
...
void F_36 ( struct V_49 * V_50 , void * V_6 ,
struct V_34 * V_35 )
{
if ( F_37 ( F_38 ( V_50 ) ) )
F_27 ( V_6 , V_50 -> V_51 , V_35 ) ;
}
int F_39 ( struct V_49 * V_50 , void * V_6 ,
struct V_34 * V_35 )
{
int V_25 = 0 ;
struct V_52 * V_53 = F_38 ( V_50 ) ;
if ( F_37 ( V_53 ) )
V_25 = F_31 ( V_6 , V_50 -> V_51 , V_35 ,
& V_53 -> V_54 ) ;
return V_25 ;
}
void F_40 ( struct V_49 * V_50 ,
struct V_45 * * V_46 , int V_8 ,
struct V_34 * V_35 )
{
if ( F_37 ( F_38 ( V_50 ) ) )
F_34 ( V_46 , V_8 , V_35 ) ;
