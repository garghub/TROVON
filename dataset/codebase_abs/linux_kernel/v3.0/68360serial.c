...
int F_135 ( struct V_282 * V_285 , char * V_367 )
{
struct V_137 * V_278 ;
V_280 V_289 , V_305 , V_368 , V_11 , V_306 ;
T_3 V_207 ;
T_4 * V_33 ;
volatile T_6 * V_28 ;
volatile struct V_15 * V_308 ;
...
volatile struct V_103 * V_104 ;
volatile struct V_105 * V_310 ;
for ( V_368 = 0 ; V_368 < ( sizeof( V_162 ) / sizeof( int ) ) ; V_368 ++ )
if ( V_369 == V_162 [ V_368 ] )
break;
V_319 = V_368 ;
V_278 = V_138 + V_139 ;
V_28 = V_20 ;
