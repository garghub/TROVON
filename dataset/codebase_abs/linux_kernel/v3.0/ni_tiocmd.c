...
V_60 |= V_44 ;
V_36 -> V_41 &= V_60 ;
if ( ! V_36 -> V_41 || V_59 != V_36 -> V_41 )
V_58 ++ ;
V_59 = V_36 -> V_52 ;
V_36 -> V_52 &= V_61 | V_44 | V_46 ;
if ( ! V_36 -> V_52 || V_59 != V_36 -> V_52 )
V_58 ++ ;
V_59 = V_36 -> V_54 ;
V_60 = V_42 | V_44 | V_46 ;
V_36 -> V_54 &= V_60 ;
if ( ! V_36 -> V_54 || V_59 != V_36 -> V_54 )
V_58 ++ ;
V_59 = V_36 -> V_62 ;
V_36 -> V_62 &= V_63 ;
if ( ! V_36 -> V_62 || V_59 != V_36 -> V_62 )
V_58 ++ ;
V_59 = V_36 -> V_64 ;
V_36 -> V_64 &= V_65 ;
if ( ! V_36 -> V_64 || V_59 != V_36 -> V_64 )
V_58 ++ ;
if ( V_58 )
return 1 ;
if ( V_36 -> V_41 != V_42 &&
V_36 -> V_41 != V_43 &&
V_36 -> V_41 != V_44 && V_36 -> V_41 != V_46 )
V_58 ++ ;
if ( V_36 -> V_52 != V_61 &&
V_36 -> V_52 != V_44 &&
V_36 -> V_52 != V_46 )
V_58 ++ ;
if ( V_36 -> V_54 != V_46 &&
V_36 -> V_54 != V_44 && V_36 -> V_54 != V_42 )
V_58 ++ ;
if ( V_36 -> V_64 != V_65 )
V_58 ++ ;
if ( V_36 -> V_54 != V_42 && V_36 -> V_52 != V_61 )
V_58 ++ ;
if ( V_58 )
return 2 ;
if ( V_36 -> V_41 != V_44 ) {
...
void F_29 ( struct V_1 * V_2 , int * V_69 ,
int * V_70 , int * V_71 ,
int * V_72 )
{
const unsigned short V_73 = F_30 ( V_2 ,
F_31
( V_2 ->
V_10 ) ) ;
const unsigned short V_74 = F_30 ( V_2 ,
F_32
( V_2 ->
V_10 ) ) ;
unsigned V_75 = 0 ;
