...
static void F_17 ( const struct V_4 * V_5 , struct V_24 * V_25 )
{
struct V_16 * V_17 ;
if ( V_5 -> V_6 )
F_18 ( V_25 , V_5 -> V_6 ) ;
...
if ( F_19 ( V_5 ) ) {
F_20 () ;
V_17 = F_21 ( V_5 -> V_19 . V_20 ) ;
if ( V_17 )
F_22 ( V_25 , L_2 , V_17 -> V_22 , V_17 -> V_26 ) ;
else
F_18 ( V_25 , L_3 ) ;
F_23 () ;
}
}
static long F_24 ( const struct V_4 * V_5 ,
...
struct V_4 * F_27 ( const char * V_6 , T_3 V_34 , T_4 V_35 ,
...
V_37 ) ;
if ( ! F_29 ( V_5 ) ) {
V_14 = F_30 ( V_5 , NULL , 0 , V_38 , NULL ) ;
if ( V_14 < 0 ) {
F_15 ( V_5 ) ;
V_5 = F_31 ( V_14 ) ;
}
...
goto V_63;
V_68:
if ( F_38 ( V_62 , & V_5 -> V_37 ) )
goto V_69;
V_47 = F_21 ( V_5 -> V_19 . V_20 ) ;
if ( ! V_47 )
goto V_69;
...
struct V_4 * F_44 ( const char * V_75 , bool V_76 )
{
struct V_4 * V_5 ;
int V_2 ;
if ( ! V_75 )
...
static int F_50 ( struct V_4 * V_80 , struct V_4 * V_81 )
{
struct {
struct V_16 * V_47 ;
int V_48 ;
...
V_57 = 0 ;
V_68:
if ( F_38 ( V_62 , & V_82 -> V_37 ) )
goto V_69;
V_47 = F_21 ( V_82 -> V_19 . V_20 ) ;
if ( ! V_47 )
goto V_69;
V_48 = 0 ;
V_70:
...
{
struct V_16 * V_17 =
F_52 ( V_88 , struct V_16 , V_88 ) ;
if ( V_17 -> V_89 != V_90 )
F_15 ( V_17 -> V_23 [ V_17 -> V_89 ] ) ;
F_16 ( V_17 ) ;
}
int F_53 ( struct V_4 * V_5 , const struct V_44 * type ,
...
* V_91 = 0 ;
F_56 ( L_4 , V_5 -> V_33 , V_4 -> V_33 , V_92 ) ;
V_17 = F_57 ( V_5 -> V_19 . V_20 ,
F_58 ( & V_5 -> V_94 ) ) ;
F_40 ( & V_4 -> V_21 ) ;
if ( V_92 ) {
F_59 ( L_5 ,
...
void F_63 ( struct V_4 * V_5 , struct V_44 * type ,
unsigned long V_95 )
...
F_35 ( V_5 ) ;
F_35 ( V_4 ) ;
V_14 = F_53 ( V_5 , V_4 -> type , V_4 -> V_6 , & V_95 ) ;
if ( V_14 == 0 ) {
V_14 = F_54 ( V_5 , V_4 ) ;
if ( V_14 == 0 )
F_55 ( V_5 , V_4 , & V_95 ) ;
F_63 ( V_5 , V_4 -> type , V_95 ) ;
}
return V_14 ;
}
...
struct V_16 * V_17 ;
int V_18 ;
V_17 = F_52 ( V_88 , struct V_16 , V_88 ) ;
for ( V_18 = V_17 -> V_22 - 1 ; V_18 >= 0 ; V_18 -- )
F_15 ( V_17 -> V_23 [ V_18 ] ) ;
F_16 ( V_17 ) ;
}
...
F_69 ( V_5 , 0 ) ;
if ( V_17 ) {
F_60 ( V_5 -> V_19 . V_20 , NULL ) ;
F_61 ( & V_17 -> V_88 , F_70 ) ;
}
}
static bool F_73 ( struct V_4 * V_4 , T_8 V_102 )
{
return F_38 ( V_103 , & V_4 -> V_37 ) ||
( V_4 -> V_64 > 0 && V_4 -> V_64 <= V_102 ) ;
}
void F_74 ( struct V_4 * V_5 , T_8 V_102 )
{
struct V_16 * V_17 , * V_104 ;
struct V_4 * V_4 ;
int V_18 , V_105 , V_106 ;
F_56 ( L_7 , F_75 ( V_5 ) , V_5 -> V_6 ) ;
F_66 ( & V_5 -> V_94 ) ;
V_17 = F_25 ( V_5 ) ;
if ( ! V_17 )
goto V_107;
V_105 = 0 ;
for ( V_18 = V_17 -> V_22 - 1 ; V_18 >= 0 ; V_18 -- )
if ( ! F_73 ( V_17 -> V_23 [ V_18 ] , V_102 ) )
V_105 ++ ;
if ( V_105 == V_17 -> V_22 )
goto V_108;
V_106 = F_76 ( V_105 , 4 ) ;
V_104 = F_68 ( sizeof( struct V_16 ) + V_106 * sizeof( struct V_4 * ) ,
V_98 ) ;
if ( ! V_104 )
goto V_99;
V_104 -> V_26 = V_106 ;
