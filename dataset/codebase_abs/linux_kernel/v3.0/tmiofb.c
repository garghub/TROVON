...
V_156 = F_52 ( V_1 , & F_1 , V_176 ,
F_53 ( & V_15 -> V_15 ) , V_4 ) ;
if ( V_156 )
goto V_177;
F_54 ( V_15 , V_4 ) ;
V_156 = F_55 ( & V_4 -> V_133 , V_4 , V_178 ,
...
static void T_9 F_71 ( char * V_269 )
{
char * V_270 ;
if ( ! V_269 || ! * V_269 )
return;
while ( ( V_270 = F_72 ( & V_269 , L_10 ) ) != NULL ) {
if ( ! * V_270 )
continue;
}
}
