...
V_21 -> V_15 = V_19 -> V_15 ;
F_28 ( V_19 ) ;
if ( ( V_22 = F_29 ( V_18 , V_39 , V_21 , & V_24 ) ) < 0 ) {
goto V_40;
}
F_30 ( V_18 , & V_19 -> V_41 ) ;
* V_20 = V_21 ;
...
static int T_2
F_31 ( struct V_1 * V_19 , const struct V_42 * V_43 )
{
static int V_41 ;
struct V_17 * V_18 ;
T_3 * V_21 ;
...
V_22 = F_32 ( V_48 [ V_41 ] , V_49 [ V_41 ] , V_50 , 0 , & V_18 ) ;
if ( V_22 < 0 )
return V_22 ;
...
F_6 ( V_19 , V_51 [ V_41 ] ) ;
strcpy ( V_18 -> V_52 , V_32 ) ;
sprintf ( V_18 -> V_53 , L_9 , V_32 ) ;
sprintf ( V_18 -> V_54 , L_10 ,
V_18 -> V_53 , V_21 -> V_30 , V_21 -> V_15 ) ;
if ( ( V_22 = F_34 ( V_21 , V_55 , V_56 ) ) < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
#ifndef F_35
if ( ( V_22 = F_34 ( V_21 , V_57 , 1 ) ) < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
if ( ( V_22 = F_34 ( V_21 , V_58 , V_59 ) ) < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
#endif
#ifndef F_36
if ( ( V_22 = F_34 ( V_21 , V_60 , V_61 ) ) < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
#endif
...
V_21 -> V_64 = V_19 -> V_65 ;
#ifdef F_41
if ( ( V_21 -> V_64 ) != 0xfe && ( V_21 -> V_64 ) != 0xfa ) {
F_3 ( V_66
L_11 ,
V_21 -> V_64 ) ;
F_3 ( V_66
