...
V_63 = F_32 ( V_103 + V_96 -> V_24 ,
V_104 + V_96 -> V_24 ) ;
if ( V_63 ) {
F_22 ( & V_96 -> V_60 , L_6 ) ;
return V_63 ;
}
V_63 = F_33 ( V_105 + V_96 -> V_24 ,
V_106 + V_96 -> V_24 ) ;
if ( V_63 ) {
F_22 ( & V_96 -> V_60 , L_7 ) ;
return V_63 ;
}
V_2 = F_34 ( sizeof( struct V_1 ) , V_107 ) ;
if ( ! V_2 ) {
F_22 ( & V_96 -> V_60 , L_8 ) ;
V_63 = - V_108 ;
goto exit;
...
F_35 ( & V_96 -> V_60 , V_2 ) ;
snprintf ( V_97 , sizeof( V_97 ) , V_25 L_9 , V_96 -> V_24 ) ;
V_2 -> V_75 = F_36 ( V_97 , NULL ) ;
if ( F_37 ( V_2 -> V_75 ) ) {
F_22 ( & V_96 -> V_60 , L_10 ) ;
V_63 = F_38 ( V_2 -> V_75 ) ;
goto V_109;
}
V_99 = F_39 ( V_96 , V_110 , 0 ) ;
if ( ! V_99 ) {
F_22 ( & V_96 -> V_60 , L_11 ) ;
V_63 = - V_111 ;
goto V_112;
}
V_101 = F_39 ( V_96 , V_113 , 0 ) ;
if ( ! V_101 ) {
F_22 ( & V_96 -> V_60 , L_12 ) ;
V_63 = - V_111 ;
goto V_112;
}
V_100 = F_40 ( V_99 -> V_114 , F_41 ( V_99 ) ,
V_25 ) ;
if ( ! V_100 ) {
F_22 ( & V_96 -> V_60 , L_13 ) ;
V_63 = - V_115 ;
...
V_2 -> V_5 = F_42 ( V_99 -> V_114 , F_41 ( V_99 ) ) ;
if ( ! V_2 -> V_5 ) {
F_22 ( & V_96 -> V_60 , L_14 ) ;
V_63 = - V_108 ;
goto V_116;
}
V_2 -> V_93 . V_117 = V_99 -> V_114 + V_118 ;
V_2 -> V_93 . V_119 = 4 ;
V_2 -> V_93 . V_120 = 32 ;
V_2 -> V_93 . V_121 = V_101 -> V_114 ;
V_2 -> V_94 . V_117 = V_99 -> V_114 + V_122 ;
V_2 -> V_94 . V_119 = 4 ;
V_2 -> V_94 . V_120 = 32 ;
V_2 -> V_94 . V_121 = V_101 -> V_114 ;
V_2 -> V_36 = V_123 ;
V_63 = F_43 ( & V_96 -> V_60 , & V_102 [ V_96 -> V_24 ] ) ;
if ( V_63 ) {
F_22 ( & V_96 -> V_60 , L_15 , V_63 ) ;
V_63 = - V_108 ;
goto V_124;
}
F_11 ( V_2 , V_96 -> V_24 ) ;
...
F_13 ( V_2 ) ;
F_44 ( V_2 -> V_5 ) ;
V_125 = F_39 ( V_96 , V_110 , 0 ) ;
F_45 ( V_125 -> V_114 , F_41 ( V_125 ) ) ;
F_46 ( V_2 -> V_75 ) ;
F_47 ( V_2 ) ;
return 0 ;
}
