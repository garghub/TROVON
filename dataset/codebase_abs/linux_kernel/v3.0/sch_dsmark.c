...
static struct V_44 * F_34 ( struct V_5 * V_6 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
struct V_44 * V_45 ;
T_2 V_3 ;
...
switch ( V_45 -> V_47 ) {
case F_22 ( V_48 ) :
F_36 ( F_25 ( V_45 ) , V_2 -> V_27 [ V_3 ] ,
V_2 -> V_33 [ V_3 ] ) ;
break;
case F_22 ( V_53 ) :
F_37 ( F_27 ( V_45 ) , V_2 -> V_27 [ V_3 ] ,
V_2 -> V_33 [ V_3 ] ) ;
break;
default:
...
static struct V_44 * F_40 ( struct V_5 * V_6 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
F_4 ( L_11 , V_6 , V_2 ) ;
...
static int F_42 ( struct V_5 * V_6 , struct V_19 * V_21 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
struct V_19 * V_23 [ V_24 + 1 ] ;
int V_25 = - V_26 ;
...
static int F_52 ( struct V_5 * V_6 , unsigned long V_18 ,
...
if ( ! F_1 ( V_2 , V_18 ) )
return - V_26 ;
V_80 -> V_82 = F_53 ( F_28 ( V_6 -> V_12 ) , V_18 - 1 ) ;
V_80 -> V_83 = V_2 -> V_14 -> V_12 ;
V_81 = F_54 ( V_45 , V_22 ) ;
if ( V_81 == NULL )
goto V_84;
F_55 ( V_45 , V_31 , V_2 -> V_27 [ V_18 - 1 ] ) ;
F_55 ( V_45 , V_32 , V_2 -> V_33 [ V_18 - 1 ] ) ;
return F_56 ( V_45 , V_81 ) ;
V_84:
F_57 ( V_45 , V_81 ) ;
return - V_85 ;
}
static int F_58 ( struct V_5 * V_6 , struct V_44 * V_45 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
struct V_19 * V_81 = NULL ;
V_81 = F_54 ( V_45 , V_22 ) ;
if ( V_81 == NULL )
goto V_84;
F_59 ( V_45 , V_74 , V_2 -> V_4 ) ;
if ( V_2 -> V_65 != V_66 )
F_59 ( V_45 , V_75 , V_2 -> V_65 ) ;
if ( V_2 -> V_46 )
F_60 ( V_45 , V_78 ) ;
return F_56 ( V_45 , V_81 ) ;
V_84:
