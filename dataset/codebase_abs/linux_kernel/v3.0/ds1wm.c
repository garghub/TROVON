...
( ( V_67 & 0x10 ) >> 2 ) |
( ( V_67 & 0x40 ) >> 3 ) ;
V_62 |= ( unsigned long long ) V_69 << ( V_44 * 4 ) ;
V_63 |= ( unsigned long long ) V_70 << ( V_44 * 4 ) ;
}
if ( V_1 -> V_42 ) {
F_10 ( & V_1 -> V_34 -> V_35 ,
L_14 , V_65 ) ;
...
static int F_24 ( struct V_71 * V_34 )
{
struct V_1 * V_1 ;
struct V_47 * V_48 ;
struct V_72 * V_73 ;
...
if ( ! V_34 )
return - V_75 ;
V_1 = F_25 ( sizeof( * V_1 ) , V_76 ) ;
if ( ! V_1 )
return - V_77 ;
F_26 ( V_34 , V_1 ) ;
V_73 = F_27 ( V_34 , V_78 , 0 ) ;
if ( ! V_73 ) {
V_74 = - V_79 ;
goto V_80;
}
V_1 -> V_4 = F_28 ( V_73 -> V_81 , F_29 ( V_73 ) ) ;
if ( ! V_1 -> V_4 ) {
V_74 = - V_77 ;
goto V_80;
}
...
V_73 = F_27 ( V_34 , V_83 , 0 ) ;
if ( ! V_73 ) {
V_74 = - V_79 ;
goto V_82;
}
V_1 -> V_84 = V_73 -> V_81 ;
V_1 -> V_13 = ( V_48 -> V_85 ? V_86 : 0 ) ;
V_1 -> V_36 = V_48 -> V_36 ;
if ( V_73 -> V_87 & V_88 )
F_31 ( V_1 -> V_84 , V_89 ) ;
if ( V_73 -> V_87 & V_90 )
F_31 ( V_1 -> V_84 , V_91 ) ;
V_74 = F_32 ( V_1 -> V_84 , F_5 ,
V_92 | V_93 , L_23 , V_1 ) ;
if ( V_74 )
goto V_82;
F_17 ( V_1 ) ;
...
static int F_37 ( struct V_71 * V_34 , T_6 V_96 )
{
struct V_1 * V_1 = F_38 ( V_34 ) ;
F_18 ( V_1 ) ;
return 0 ;
}
static int F_39 ( struct V_71 * V_34 )
{
struct V_1 * V_1 = F_38 ( V_34 ) ;
F_17 ( V_1 ) ;
return 0 ;
}
static int F_40 ( struct V_71 * V_34 )
{
struct V_1 * V_1 = F_38 ( V_34 ) ;
F_41 ( & V_94 ) ;
F_18 ( V_1 ) ;
