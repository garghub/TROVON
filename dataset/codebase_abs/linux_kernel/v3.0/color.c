...
if ( V_28 && * V_31 )
V_34 += snprintf ( V_29 , V_30 , L_25 , V_31 ) ;
V_34 += vsnprintf ( V_29 + V_34 , V_30 - V_34 , V_32 , args ) ;
if ( V_28 && * V_31 )
V_34 += snprintf ( V_29 + V_34 , V_30 - V_34 , L_25 , V_17 ) ;
if ( V_33 )
V_34 += snprintf ( V_29 + V_34 , V_30 - V_34 , L_25 , V_33 ) ;
return V_34 ;
}
static int F_14 ( T_3 * V_35 , const char * V_31 , const char * V_32 ,
...
int F_15 ( char * V_29 , T_1 V_30 , const char * V_31 ,
const char * V_32 , T_2 args )
{
return F_13 ( V_29 , V_30 , V_31 , V_32 , args , NULL ) ;
}
int F_16 ( T_3 * V_35 , const char * V_31 , const char * V_32 , T_2 args )
{
return F_14 ( V_35 , V_31 , V_32 , args , NULL ) ;
}
...
int V_34 ;
va_start ( args , V_32 ) ;
V_34 = F_15 ( V_29 , V_30 , V_31 , V_32 , args ) ;
va_end ( args ) ;
return V_34 ;
}
int F_18 ( T_3 * V_35 , const char * V_31 , const char * V_32 , ... )
{
T_2 args ;
int V_34 ;
va_start ( args , V_32 ) ;
V_34 = F_16 ( V_35 , V_31 , V_32 , args ) ;
va_end ( args ) ;
return V_34 ;
}
int F_19 ( T_3 * V_35 , const char * V_31 , const char * V_32 , ... )
{
T_2 args ;
int V_34 ;
va_start ( args , V_32 ) ;
V_34 = F_14 ( V_35 , V_31 , V_32 , args , L_26 ) ;
va_end ( args ) ;
return V_34 ;
}
int F_20 ( T_3 * V_35 , const char * V_31 ,
...
int F_22 ( T_3 * V_35 , const char * V_32 , double V_39 )
{
int V_34 ;
const char * V_31 ;
V_31 = F_21 ( V_39 ) ;
V_34 = F_18 ( V_35 , V_31 , V_32 , V_39 ) ;
return V_34 ;
}
int F_23 ( char * V_29 , T_1 V_30 , const char * V_32 , double V_39 )
{
const char * V_31 = F_21 ( V_39 ) ;
return F_17 ( V_29 , V_30 , V_31 , V_32 , V_39 ) ;
}
