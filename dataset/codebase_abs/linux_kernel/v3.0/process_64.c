...
static unsigned long F_54 ( unsigned long V_59 , unsigned long V_60 )
{
unsigned long V_52 , V_61 , V_62 ;
if ( ! ( F_25 ( V_20 ) ) ) {
V_59 += V_21 ;
V_60 += V_21 ;
F_55 ( V_52 , & ( ( (struct V_16 T_1 * ) V_60 ) -> V_15 [ 6 ] ) ) ;
V_52 += V_21 ;
} else
F_55 ( V_52 , & ( ( (struct V_8 T_1 * ) V_60 ) -> V_15 [ 6 ] ) ) ;
V_59 &= ~ 15UL ;
V_61 = V_52 - V_60 ;
V_62 = ( V_59 - V_61 ) ;
if ( F_56 ( ( void T_1 * ) V_62 , ( void T_1 * ) V_60 , V_61 ) )
V_62 = 0 ;
else if ( F_25 ( V_20 ) ) {
if ( F_57 ( ( ( V_63 ) V_59 ) ,
& ( ( (struct V_8 T_1 * ) V_62 ) -> V_15 [ 6 ] ) ) )
V_62 = 0 ;
} else {
if ( F_57 ( ( ( V_64 ) V_59 - V_21 ) ,
& ( ( (struct V_16 T_1 * ) V_62 ) -> V_15 [ 6 ] ) ) )
V_62 = 0 ;
else
V_62 = V_62 - V_21 ;
}
...
static inline void F_58 ( int V_65 , int V_66 ,
struct V_27 * V_53 )
{
int V_67 ;
for ( V_67 = V_65 ; V_67 < V_66 ; V_67 ++ ) {
V_53 -> V_68 [ V_67 ] = V_53 -> V_68 [ V_67 + 1 ] ;
memcpy ( & V_53 -> V_16 [ V_67 ] , & V_53 -> V_16 [ V_67 + 1 ] ,
sizeof( struct V_16 ) ) ;
}
}
void F_59 ( void )
...
F_60 () ;
if ( ( V_69 = F_61 () ) != 0 ) {
int V_70 = sizeof( struct V_16 ) ;
int V_71 = 0 ;
if ( F_25 ( V_20 ) )
V_70 = sizeof( struct V_8 ) ;
else
V_71 = V_21 ;
V_69 -= 1 ;
do {
unsigned long V_51 = ( V_53 -> V_68 [ V_69 ] + V_71 ) ;
struct V_16 * V_72 = & V_53 -> V_16 [ V_69 ] ;
if ( ! F_62 ( ( char T_1 * ) V_51 , V_72 , V_70 ) ) {
F_58 ( V_69 , F_61 () - 1 , V_53 ) ;
F_52 ( F_61 () - 1 ) ;
}
} while ( V_69 -- );
}
...
T_5 long F_69 ( unsigned long V_83 ,
unsigned long V_84 ,
struct V_6 * V_7 ,
unsigned long V_85 )
{
int T_1 * V_86 , * V_87 ;
unsigned long V_88 = V_7 -> V_12 [ V_89 ] ;
long V_49 ;
#ifdef F_70
if ( F_25 ( V_20 ) ) {
V_86 = F_19 ( V_7 -> V_12 [ V_90 ] ) ;
V_87 = F_19 ( V_7 -> V_12 [ V_91 ] ) ;
} else
#endif
{
V_86 = ( int T_1 * ) V_7 -> V_12 [ V_90 ] ;
V_87 = ( int T_1 * ) V_7 -> V_12 [ V_91 ] ;
}
V_49 = F_71 ( V_83 , V_84 ,
V_7 , V_85 ,
V_86 , V_87 ) ;
if ( ( unsigned long ) V_49 >= - V_92 )
V_7 -> V_12 [ V_89 ] = V_88 ;
return V_49 ;
}
int F_72 ( unsigned long V_83 , unsigned long V_51 ,
unsigned long V_93 ,
struct V_46 * V_94 , struct V_6 * V_7 )
{
struct V_27 * V_53 = F_47 ( V_94 ) ;
struct V_95 * V_96 ;
unsigned long V_97 ;
char * V_98 ;
int V_99 ;
V_99 = ( V_7 -> V_18 & V_19 ) ? 1 : 0 ;
V_96 = ( (struct V_95 * ) V_7 ) - 1 ;
V_97 = ( ( V_100 + V_101 ) +
( V_99 ? V_100 : 0 ) ) ;
V_98 = ( F_73 ( V_94 ) +
( V_102 - V_97 ) ) ;
memcpy ( V_98 , V_96 , V_97 ) ;
V_53 -> V_38 = ( V_53 -> V_38 & ~ ( ( 0xffUL << V_103 ) |
( 0xffUL << V_104 ) ) ) |
( ( ( V_7 -> V_18 + 1 ) & V_105 ) << V_103 ) ;
V_53 -> V_106 = 1 ;
V_53 -> V_50 = ( ( unsigned long ) V_98 ) - V_21 ;
V_53 -> V_39 = (struct V_6 * ) ( V_98 +
sizeof( struct V_95 ) ) ;
V_53 -> V_57 [ 0 ] = 0 ;
if ( V_99 ) {
struct V_95 * V_107 = (struct V_95 * )
( V_98 + ( V_100 + V_101 ) ) ;
V_107 -> V_52 = NULL ;
V_53 -> V_39 -> V_12 [ V_26 ] =
( ( unsigned long ) V_107 ) - V_21 ;
V_53 -> V_38 |= ( ( long ) V_108 << V_104 ) ;
V_53 -> V_39 -> V_12 [ V_109 ] = ( unsigned long ) V_53 ;
V_53 -> V_39 -> V_12 [ V_110 ] = ( unsigned long ) V_53 -> V_41 ;
} else {
if ( V_53 -> V_38 & V_111 ) {
...
V_53 -> V_38 |= ( ( long ) V_58 << V_104 ) ;
if ( V_51 != V_7 -> V_12 [ V_26 ] ) {
unsigned long V_59 ;
V_59 = F_54 ( V_51 , V_7 -> V_12 [ V_26 ] ) ;
if ( ! V_59 )
return - V_112 ;
V_53 -> V_39 -> V_12 [ V_26 ] = V_59 ;
}
if ( V_53 -> V_54 )
V_53 -> V_54 [ 0 ] ++ ;
}
V_53 -> V_39 -> V_12 [ V_113 ] = V_25 -> V_43 ;
V_53 -> V_39 -> V_12 [ V_89 ] = 1 ;
V_7 -> V_12 [ V_89 ] = 0 ;
if ( V_83 & V_114 )
V_53 -> V_39 -> V_12 [ V_115 ] = V_7 -> V_12 [ V_116 ] ;
return 0 ;
}
T_6 V_99 ( int (* F_74)( void * ) , void * V_117 , unsigned long V_38 )
{
long V_118 ;
...
{
unsigned long V_142 , V_52 , V_71 = 0 ;
struct V_27 * V_28 ;
struct V_16 * V_9 ;
