...
V_488 -> V_500 = V_501 ;
V_488 -> V_500 . V_51 =
V_502 | V_364 | V_356 | V_355 | V_373 ;
V_488 -> V_500 . V_503 = 9600 ;
V_488 -> V_500 . V_504 = 9600 ;
V_488 -> V_11 = V_505 ;
F_209 ( V_488 , & V_15 ) ;
...
{
if ( V_380 ) {
F_74 ( V_1 , V_506 , ( unsigned char ) ( F_73 ( V_1 , V_506 ) | ( V_346 + V_279 ) ) ) ;
V_1 -> V_345 [ 0 ] -> V_507 |= ( V_279 << ( V_1 -> V_250 * 2 ) ) ;
F_213 ( V_1 ) ;
F_74 ( V_1 , V_508 , 0x40 ) ;
F_74 ( V_1 , V_509 , 0x40 ) ;
} else {
...
V_510 >>= 1 ;
F_74 ( V_1 , V_509 ,
( unsigned char ) ( ( F_73 ( V_1 , V_509 ) & 0xf0 ) | V_511 ) ) ;
F_74 ( V_1 , V_508 ,
( unsigned char ) ( ( F_73 ( V_1 , V_508 ) & 0xf0 ) | V_511 ) ) ;
F_74 ( V_1 , V_513 , ( unsigned char ) V_510 ) ;
}
else {
F_74 ( V_1 , V_509 , 0 ) ;
F_74 ( V_1 , V_508 , 0 ) ;
...
V_1 -> V_516 = 0 ;
F_124 ( V_1 , V_309 + V_517 ,
V_1 -> V_435 [ 0 ] . V_441 ) ;
F_124 ( V_1 , V_309 + V_518 ,
V_1 -> V_435 [ V_1 -> V_433 - 1 ] . V_441 ) ;
F_124 ( V_1 , V_309 + V_519 , V_428 ) ;
...
F_74 ( V_1 , V_290 + V_292 , 0 ) ;
F_74 ( V_1 , V_290 + V_293 , V_294 ) ;
F_124 ( V_1 , V_290 + V_517 ,
V_1 -> V_437 [ 0 ] . V_441 ) ;
F_124 ( V_1 , V_290 + V_518 ,
V_1 -> V_437 [ V_1 -> V_524 ] . V_441 ) ;
V_1 -> V_259 &= ~ V_302 ;
V_1 -> V_259 |= V_295 ;
F_74 ( V_1 , V_321 , V_1 -> V_259 ) ;
F_74 ( V_1 , V_258 , ( unsigned char ) ( V_302 + V_295 ) ) ;
...
return;
while( V_1 -> V_70 && ( F_73 ( V_1 , V_526 ) & V_346 ) ) {
if ( ( V_1 -> V_70 > 1 ) && ! V_1 -> V_75 ) {
V_525 [ 0 ] = V_1 -> V_63 [ V_1 -> V_84 ++ ] ;
if ( V_1 -> V_84 >= V_1 -> V_67 )
V_1 -> V_84 -= V_1 -> V_67 ;
V_525 [ 1 ] = V_1 -> V_63 [ V_1 -> V_84 ++ ] ;
if ( V_1 -> V_84 >= V_1 -> V_67 )
V_1 -> V_84 -= V_1 -> V_67 ;
F_124 ( V_1 , V_282 , * ( ( T_7 * ) V_525 ) ) ;
V_1 -> V_70 -= 2 ;
V_1 -> V_105 . V_113 += 2 ;
} else {
if ( V_1 -> V_75 ) {
...
F_74 ( V_1 , V_303 , V_1 -> V_300 ) ;
F_74 ( V_1 , V_321 , V_1 -> V_259 ) ;
F_74 ( V_1 , V_527 , V_1 -> V_266 ) ;
F_74 ( V_1 , V_296 , V_528 ) ;
}
}
...
F_74 ( V_1 , V_530 , V_146 ) ;
V_146 = 0x00 ;
if ( V_1 -> V_64 . V_211 )
V_146 |= ( V_346 + V_279 ) ;
F_74 ( V_1 , V_506 , V_146 ) ;
V_146 = V_351 ;
F_74 ( V_1 , V_508 , V_146 ) ;
V_146 = V_351 ;
F_74 ( V_1 , V_509 , V_146 ) ;
V_1 -> V_345 [ 0 ] -> V_507 |= ( V_279 << ( V_1 -> V_250 * 2 ) ) ;
F_213 ( V_1 ) ;
F_158 ( V_1 ) ;
F_74 ( V_1 , V_531 , 0x00 ) ;
...
if ( V_1 -> V_64 . V_11 & V_539 ) {
V_535 = 16 ;
V_146 |= V_149 ;
} else if ( V_1 -> V_64 . V_11 & V_540 ) {
V_535 = 8 ;
} else {
V_535 = 32 ;
V_146 |= V_349 ;
...
F_74 ( V_1 , V_509 , V_146 ) ;
if ( V_1 -> V_64 . V_11 & V_196 )
F_214 ( V_1 , V_1 -> V_64 . V_210 * V_535 ) ;
else
F_214 ( V_1 , V_1 -> V_64 . V_210 ) ;
if ( V_1 -> V_64 . V_11 & V_201 )
V_1 -> V_345 [ 0 ] -> V_507 |= ( V_279 << ( V_1 -> V_250 * 2 ) ) ;
...
V_1 -> V_345 [ 0 ] -> V_507 &= ~ ( V_279 << ( V_1 -> V_250 * 2 ) ) ;
F_213 ( V_1 ) ;
F_74 ( V_1 , V_531 , V_541 ) ;
F_74 ( V_1 , V_312 , V_523 ) ;
F_74 ( V_1 , V_532 , ( unsigned char ) ( V_522 - 1 ) ) ;
F_74 ( V_1 , V_290 + V_542 , 0x14 ) ;
F_74 ( V_1 , V_309 + V_542 , 0x14 ) ;
F_74 ( V_1 , V_309 + V_543 ,
( unsigned char ) ( V_1 -> V_440 >> 16 ) ) ;
F_74 ( V_1 , V_290 + V_543 ,
( unsigned char ) ( V_1 -> V_440 >> 16 ) ) ;
V_1 -> V_300 |= V_533 + V_534 ;
F_74 ( V_1 , V_303 , V_1 -> V_300 ) ;
V_146 = 0x10 ;
...
case V_544 : V_146 = 0xaa ; break;
case V_545 : V_146 = 0x00 ; break;
case V_546 : V_146 = 0xff ; break;
case V_547 : V_146 = 0xaa ; break;
case V_548 : V_146 = 0x00 ; break;
case V_549 : V_146 = 0xff ; break;
}
F_74 ( V_1 , V_550 , V_146 ) ;
}
static void F_62 ( T_1 * V_1 )
{
T_7 V_257 = F_73 ( V_1 , V_551 ) ;
T_7 V_552 = F_215 ( V_1 ) ;
T_7 V_553 ;
V_1 -> V_54 &= V_56 + V_55 ;
if ( ! ( V_257 & V_149 ) )
...
if ( ! ( V_257 & V_347 ) )
V_1 -> V_54 |= V_129 ;
V_553 = V_346 << ( V_1 -> V_250 * 2 ) ;
if ( ! ( V_552 & V_553 ) )
V_1 -> V_54 |= V_130 ;
V_553 = V_279 << ( V_1 -> V_250 * 2 ) ;
if ( ! ( V_552 & V_553 ) )
V_1 -> V_54 |= V_128 ;
}
...
static void F_217 ( T_1 * V_1 , unsigned int V_555 , unsigned int V_556 )
{
bool V_557 = false ;
while( ! V_557 ) {
V_1 -> V_434 [ V_555 ] . V_257 = 0xff ;
if ( V_555 == V_556 ) {
V_557 = true ;
F_124 ( V_1 , V_309 + V_518 , V_1 -> V_435 [ V_555 ] . V_441 ) ;
}
V_555 ++ ;
if ( V_555 == V_1 -> V_433 )
V_555 = 0 ;
...
for ( ; ; ) {
V_563 = & V_1 -> V_434 [ V_559 ] ;
V_564 = & V_1 -> V_435 [ V_559 ] ;
if ( V_563 -> V_257 == 0xff )
goto V_566;
if ( V_560 == 0 && V_1 -> V_64 . V_567 != 0xff )
V_562 = V_564 -> V_447 [ 0 ] ;
V_560 += V_563 -> V_443 ;
if ( V_563 -> V_257 )
break;
...
V_257 &= ~ V_347 ;
if ( V_560 == 0 ||
( V_562 != 0xff && V_562 != V_1 -> V_64 . V_567 ) ) {
F_217 ( V_1 , V_558 , V_559 ) ;
goto V_565;
}
if ( V_560 < 2 )
V_257 |= V_351 ;
...
#if V_305
{
V_1 -> V_217 -> V_176 . V_569 ++ ;
V_1 -> V_217 -> V_176 . V_570 ++ ;
}
#endif
}
if ( V_29 >= V_244 )
F_4 ( L_160 ,
__FILE__ , __LINE__ , V_1 -> V_26 , V_257 , V_560 ) ;
if ( V_29 >= V_571 )
F_218 ( V_1 , V_1 -> V_435 [ V_558 ] . V_447 ,
F_33 ( int , V_560 , V_428 ) , 0 ) ;
if ( V_560 ) {
if ( V_560 > V_1 -> V_67 )
V_1 -> V_105 . V_136 ++ ;
else {
int V_572 = V_560 ;
int V_20 = V_558 ;
unsigned char * V_573 = V_1 -> V_450 ;
V_1 -> V_574 = V_560 ;
V_1 -> V_105 . V_132 ++ ;
while( V_572 ) {
int V_575 = F_34 ( V_572 , V_428 ) ;
memcpy ( V_573 ,
...
T_10 * V_564 ;
if ( V_29 >= V_571 )
F_218 ( V_1 , V_60 , F_33 ( int , V_12 , V_428 ) , 1 ) ;
for( V_339 = 0 ; ; )
{
V_572 = F_33 (unsigned short,count,SCABUFSIZE) ;
V_563 = & V_1 -> V_436 [ V_339 ] ;
V_564 = & V_1 -> V_437 [ V_339 ] ;
F_219 ( V_1 , V_564 -> V_447 , V_60 , V_572 ) ;
V_563 -> V_443 = V_572 ;
V_563 -> V_257 = 0 ;
V_60 += V_572 ;
V_12 -= V_572 ;
...
{
static unsigned char V_577 [] = { 0x00 , 0xff , 0xaa , 0x55 , 0x69 , 0x96 } ;
static unsigned int V_12 = F_221 ( V_577 ) ;
unsigned int V_339 ;
bool V_181 = true ;
unsigned long V_11 ;
F_11 ( & V_1 -> V_46 , V_11 ) ;
...
V_1 -> V_25 = V_578 ;
for ( V_339 = 0 ; V_339 < V_12 ; V_339 ++ ) {
F_74 ( V_1 , V_513 , V_577 [ V_339 ] ) ;
F_74 ( V_1 , V_550 , V_577 [ ( V_339 + 1 ) % V_12 ] ) ;
F_74 ( V_1 , V_579 , V_577 [ ( V_339 + 2 ) % V_12 ] ) ;
F_74 ( V_1 , V_580 , V_577 [ ( V_339 + 3 ) % V_12 ] ) ;
if ( ( F_73 ( V_1 , V_513 ) != V_577 [ V_339 ] ) ||
( F_73 ( V_1 , V_550 ) != V_577 [ ( V_339 + 1 ) % V_12 ] ) ||
( F_73 ( V_1 , V_579 ) != V_577 [ ( V_339 + 2 ) % V_12 ] ) ||
( F_73 ( V_1 , V_580 ) != V_577 [ ( V_339 + 3 ) % V_12 ] ) )
{
V_181 = false ;
break;
}
...
F_74 ( V_1 , ( unsigned char ) ( V_249 + V_582 ) , 0 ) ;
F_124 ( V_1 , ( unsigned char ) ( V_249 + V_583 ) , 1 ) ;
...
{
int V_339 ;
volatile T_13 * V_595 = ( T_13 * ) ( V_1 -> V_462 + 0x50 ) ;
T_13 V_596 ;
V_1 -> V_485 |= V_597 ;
* V_595 = V_1 -> V_485 ;
...
F_213 ( V_1 ) ;
{
volatile T_13 * V_598 = ( T_13 * ) ( V_1 -> V_462 + 0x2c ) ;
V_599 &= ~ ( V_348 + V_349 + V_149 ) ;
switch( V_600 )
{
case 16 :
V_599 |= V_348 + V_349 + V_149 ;
...
bool V_181 = false ;
unsigned long V_11 ;
struct V_8 * V_601 = V_1 -> V_28 . V_9 ;
T_13 V_602 = V_1 -> V_64 . V_210 ;
...
{
static unsigned long V_577 [] = { 0x0 , 0x55555555 , 0xaaaaaaaa ,
0x66666666 , 0x99999999 , 0xffffffff , 0x12345678 } ;
unsigned long V_12 = F_221 ( V_577 ) ;
unsigned long V_339 ;
unsigned long V_604 = V_427 /sizeof( unsigned long ) ;
unsigned long * V_605 = ( unsigned long * ) V_1 -> V_439 ;
for ( V_339 = 0 ; V_339 < V_12 ; V_339 ++ ) {
* V_605 = V_577 [ V_339 ] ;
if ( * V_605 != V_577 [ V_339 ] )
return false ;
}
for ( V_339 = 0 ; V_339 < V_604 ; V_339 ++ ) {
* V_605 = V_339 * 4 ;
V_605 ++ ;
}
V_605 = ( unsigned long * ) V_1 -> V_439 ;
for ( V_339 = 0 ; V_339 < V_604 ; V_339 ++ ) {
if ( * V_605 != V_339 * 4 )
return false ;
V_605 ++ ;
...
static void F_219 ( T_1 * V_1 , char * V_606 , const char * V_607 , unsigned short V_12 )
{
unsigned short V_608 = V_12 / V_609 ;
unsigned short V_339 ;
for ( V_339 = 0 ; V_339 < V_608 ; V_339 ++ )
{
memcpy ( V_606 , V_607 , V_609 ) ;
F_215 ( V_1 ) ;
V_606 += V_609 ;
V_607 += V_609 ;
}
memcpy ( V_606 , V_607 , V_12 % V_609 ) ;
}
...
static void V_483 ( unsigned long V_611 )
{
T_1 * V_1 = ( T_1 * ) V_611 ;
unsigned long V_11 ;
if ( V_29 >= V_30 )
...
static void V_484 ( unsigned long V_611 )
{
T_7 V_257 = 0 ;
T_1 * V_1 = ( T_1 * ) V_611 ;
unsigned long V_11 ;
...
static unsigned char F_73 ( T_1 * V_1 , unsigned char V_615 )
{
F_227 () ;
return * V_616 ;
}
static void F_74 ( T_1 * V_1 , unsigned char V_615 , unsigned char V_617 )
{
F_227 () ;
* V_616 = V_617 ;
}
static T_7 F_135 ( T_1 * V_1 , unsigned char V_615 )
{
F_227 () ;
return * ( ( T_7 * ) V_616 ) ;
}
static void F_124 ( T_1 * V_1 , unsigned char V_615 , T_7 V_617 )
{
F_227 () ;
* ( ( T_7 * ) V_616 ) = V_617 ;
}
...
{
unsigned char * V_616 = ( unsigned char * ) V_1 -> V_465 ;
return * V_616 ;
}
static void F_213 ( T_1 * V_1 )
{
unsigned char * V_616 = ( unsigned char * ) V_1 -> V_465 ;
* V_616 = V_1 -> V_345 [ 0 ] -> V_507 ;
}
static int T_15 F_228 ( struct V_472 * V_151 ,
const struct V_618 * V_619 )
{
if ( F_229 ( V_151 ) ) {
F_4 ( L_174 , V_151 ) ;
return - V_68 ;
