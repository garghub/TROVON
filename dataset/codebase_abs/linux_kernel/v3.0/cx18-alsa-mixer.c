...
F_7 ( V_17 ) ;
V_23 = F_8 ( V_19 -> V_26 , V_27 , V_28 , & V_22 ) ;
F_9 ( V_17 ) ;
if ( ! V_23 )
...
V_22 . V_9 = F_1 ( V_15 -> V_9 . integer . V_9 [ 0 ] ) ;
V_23 = F_8 ( V_19 -> V_26 , V_27 , V_29 , & V_22 ) ;
if ( ! V_23 )
V_23 = 1 ;
}
F_9 ( V_17 ) ;
...
int T_1 F_11 ( struct V_16 * V_17 )
{
struct V_30 * V_20 = V_17 -> V_20 ;
struct V_31 * V_32 = V_17 -> V_32 ;
int V_23 ;
F_12 ( V_32 -> V_33 , L_1 , sizeof( V_32 -> V_33 ) ) ;
V_23 = F_13 ( V_32 , F_14 ( V_34 , V_17 ) ) ;
if ( V_23 ) {
F_15 ( L_2 ,
V_35 , V_34 . V_36 , V_23 ) ;
}
