...
F_24 ( & V_1 -> V_31 ) ;
V_1 -> V_31 . V_45 = F_21 ;
V_1 -> V_31 . V_42 = ( unsigned long ) V_8 -> V_12 -> V_10 -> V_13 ;
V_1 -> V_31 . V_43 = 1 + V_44 ;
F_22 ( & V_1 -> V_31 ) ;
}
V_1 -> V_30 ++ ;
...
{
int V_48 , V_49 ;
unsigned char V_50 [ 4 ] , V_51 [ 4 ] ;
T_5 * V_52 ;
T_1 * V_1 ;
V_52 = & V_10 -> V_14 ;
V_1 = & V_52 -> V_1 ;
for ( V_49 = 0 ; V_49 < 30000 && ! F_4 ( V_1 ) ; V_49 ++ ) ;
if ( ! F_4 ( V_1 ) ) {
F_30 ( L_1 ) ;
return - 1 ;
}
V_52 -> V_53 = 1 ;
F_7 ( V_54 , V_1 -> V_55 ) ;
for ( V_48 = 0 , V_49 = 50000 ; V_49 > 0 && ! V_48 ; V_49 -- ) {
if ( F_3 ( V_1 ) ) {
if ( F_5 ( V_1 ) == V_56 ) {
V_48 = 1 ;
break;
...
if ( F_31 ( V_52 , V_57 , V_50 , V_51 ) ) {
F_30 ( L_3 ) ;
}
if ( F_31 ( V_52 , V_58 , V_50 , V_51 ) ) {
F_30 ( L_4 ) ;
return 0 ;
}
F_27 ( V_10 ) ;
if ( F_31 ( V_52 , V_59 , V_50 , V_51 ) ) {
F_30 ( L_5 ) ;
F_28 ( V_10 ) ;
}
return 0 ;
