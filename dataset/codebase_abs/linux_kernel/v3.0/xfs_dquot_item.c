...
V_30 = F_22 ( V_22 -> V_26 -> V_33 , V_7 -> V_9 . V_34 ,
V_22 -> V_26 -> V_35 -> V_36 , V_37 ) ;
F_16 ( V_22 ) ;
if ( ! V_30 )
return;
if ( F_23 ( V_30 ) )
...
struct V_21 * V_22 )
{
struct V_1 * V_43 = & V_22 -> V_44 ;
F_32 ( V_22 -> V_26 , & V_43 -> V_4 , V_45 ,
& V_46 ) ;
V_43 -> V_14 = V_22 ;
V_43 -> V_9 . V_47 = V_45 ;
V_43 -> V_9 . V_48 = F_33 ( V_22 -> V_15 . V_49 ) ;
V_43 -> V_9 . V_34 = V_22 -> V_50 ;
V_43 -> V_9 . V_51 = 1 ;
V_43 -> V_9 . V_52 = ( V_53 ) V_22 -> V_54 ;
}
static inline struct V_55 * F_34 ( struct V_2 * V_3 )
{
...
{
struct V_55 * V_78 ;
V_78 = F_49 ( sizeof( struct V_55 ) , V_79 ) ;
F_32 ( V_75 , & V_78 -> V_56 , V_61 , V_76 ?
& V_80 : & V_81 ) ;
V_78 -> V_56 . V_82 = V_75 ;
V_78 -> V_59 . V_60 = V_61 ;
V_78 -> V_59 . V_83 = V_77 ;
