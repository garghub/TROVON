...
static int T_7 F_36 ( int V_1 , unsigned short * V_71 )
{
int V_60 = 0 , V_2 ;
unsigned short V_72 ;
unsigned char V_73 ;
F_1 ( V_1 ) ;
V_2 = V_74 ? V_74 : F_4 ( V_1 , 0x20 ) ;
if ( ! ( V_2 == 0x7c || V_2 == 0x7d || V_2 == 0x7f ) ) {
V_60 = - V_75 ;
goto exit;
}
V_73 = V_2 == 0x7c ? 2 : V_2 == 0x7d ? 4 : 6 ;
F_6 ( V_1 , 0x07 , 0x0a ) ;
if ( ( F_4 ( V_1 , 0x30 ) & 0x01 ) == 0 )
F_24 (KERN_INFO PFX L_6 ) ;
V_72 = ( F_4 ( V_1 , 0x60 ) << 8 ) |
F_4 ( V_1 , 0x61 ) ;
if ( ! V_72 ) {
F_24 (KERN_ERR PFX L_7 ) ;
V_60 = - V_75 ;
goto exit;
}
* V_71 = V_72 ;
F_24 (KERN_INFO PFX L_8 ,
dev_id, base_addr) ;
exit:
F_3 ( V_1 ) ;
return V_60 ;
...
{
int V_60 , V_23 , V_76 = 0 ;
unsigned short V_71 = 0 ;
for ( V_23 = 0 ; ! V_76 && V_77 [ V_23 ] ; V_23 ++ )
if ( F_36 ( V_77 [ V_23 ] , & V_71 ) == 0 )
V_76 ++ ;
if ( ! V_76 )
return - V_75 ;
V_6 . V_7 = V_71 ;
