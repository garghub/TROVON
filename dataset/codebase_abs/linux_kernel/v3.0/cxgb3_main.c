...
static void F_234 ( struct V_1 * V_2 , struct V_525 * V_526 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
V_16 -> V_527 = V_526 ;
if ( V_15 -> V_97 . V_130 > 0 )
F_235 ( V_15 , 1 << V_16 -> V_26 , V_526 != NULL ) ;
else {
unsigned int V_58 , V_528 = 0 ;
F_35 (adapter, i)
V_528 |= F_37 ( V_15 , V_58 ) -> V_527 != NULL ;
F_235 ( V_15 , 1 , V_528 ) ;
}
F_233 ( V_15 , V_16 ) ;
}
...
static void F_237 ( struct V_15 * V_15 )
{
int V_58 ;
F_35 (adapter, i) {
...
static void F_238 ( struct V_15 * V_15 )
{
int V_58 ;
F_35 (adapter, i) {
struct V_1 * V_2 = V_15 -> V_28 [ V_58 ] ;
...
{
struct V_15 * V_15 = F_245 ( V_535 , struct V_15 ,
V_229 . V_535 ) ;
...
static void F_253 ( struct V_534 * V_535 )
{
struct V_15 * V_15 = F_245 ( V_535 , struct V_15 ,
V_553 ) ;
int V_58 ;
...
F_7 ( V_15 , V_557 ,
V_15 -> V_554 ) ;
F_256 ( V_224 , & V_15 -> V_553 ) ;
}
F_164 ( & V_15 -> V_223 ) ;
}
void F_257 ( struct V_15 * V_15 , int V_26 )
{
...
static int F_258 ( struct V_15 * V_15 , int V_537 , int V_222 )
{
int V_58 , V_138 = 0 ;
if ( F_80 ( V_15 ) &&
...
static int F_262 ( struct V_15 * V_15 )
{
if ( F_263 ( V_15 -> V_53 ) ) {
F_101 ( & V_15 -> V_53 -> V_2 ,
L_42 ) ;
...
static void F_268 ( struct V_15 * V_15 )
{
int V_58 ;
F_35 (adapter, i) {
struct V_1 * V_123 = V_15 -> V_28 [ V_58 ] ;
...
static void F_269 ( struct V_534 * V_535 )
{
struct V_15 * V_15 = F_245 ( V_535 , struct V_15 ,
V_560 ) ;
int V_67 = 0 ;
...
if ( ! V_67 )
F_268 ( V_15 ) ;
F_270 ( V_15 , L_45 , V_67 ? L_31 : L_32 ) ;
F_74 () ;
}
...
F_162 ( & V_15 -> V_223 ) ;
F_123 ( V_15 ) ;
F_256 ( V_224 , & V_15 -> V_560 ) ;
F_164 ( & V_15 -> V_223 ) ;
}
F_270 ( V_15 , L_46 ) ;
if ( ! F_272 ( V_15 , 0xa0 , 4 , V_561 ) )
F_270 ( V_15 , L_47 ,
V_561 [ 0 ] , V_561 [ 1 ] ,
V_561 [ 2 ] , V_561 [ 3 ] ) ;
}
static T_10 F_273 ( struct V_562 * V_53 ,
T_11 V_27 )
{
struct V_15 * V_15 = F_274 ( V_53 ) ;
if ( V_27 == V_563 )
return V_564 ;
F_258 ( V_15 , 0 , 0 ) ;
return V_565 ;
...
static void F_276 ( struct V_562 * V_53 )
{
struct V_15 * V_15 = F_274 ( V_53 ) ;
F_270 ( V_15 , L_48 ,
F_12 ( V_15 , V_567 ) ) ;
...
static void F_277 ( struct V_15 * V_25 )
{
int V_58 , V_59 = 0 ;
int V_568 = F_278 () ;
...
static int T_12 F_279 ( struct V_15 * V_25 )
{
...
while ( ( V_67 = F_280 ( V_25 -> V_53 , V_572 , V_573 ) ) > 0 )
V_573 = V_67 ;
if ( V_67 < 0 )
F_30 ( V_25 -> V_53 ) ;
...
static void T_12 F_281 ( struct V_15 * V_25 ,
...
F_3 ( V_3
L_62 ,
V_25 -> V_4 , F_282 ( & V_25 -> V_496 ) >> 20 ,
F_282 ( & V_25 -> V_500 ) >> 20 ,
F_282 ( & V_25 -> V_498 ) >> 20 ,
V_25 -> V_97 . V_160 . V_583 ) ;
}
}
static void T_12 F_283 ( struct V_1 * V_2 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
memcpy ( V_16 -> V_49 . V_50 , V_2 -> V_47 , V_166 ) ;
V_16 -> V_49 . V_50 [ 3 ] |= 0x80 ;
}
static int T_12 F_284 ( struct V_562 * V_53 ,
...
V_67 = F_286 ( V_53 , V_296 ) ;
if ( V_67 ) {
F_108 ( & V_53 -> V_2 , L_66 ) ;
goto V_591;
}
if ( ! F_287 ( V_53 , F_288 ( 64 ) ) ) {
V_587 = 1 ;
V_67 = F_289 ( V_53 , F_288 ( 64 ) ) ;
if ( V_67 ) {
F_101 ( & V_53 -> V_2 , L_67
L_68 ) ;
goto V_592;
}
} else if ( ( V_67 = F_287 ( V_53 , F_288 ( 32 ) ) ) != 0 ) {
F_101 ( & V_53 -> V_2 , L_69 ) ;
goto V_592;
}
F_264 ( V_53 ) ;
...
V_588 = F_290 ( V_53 , 0 ) ;
V_589 = F_291 ( V_53 , 0 ) ;
V_576 = F_292 ( V_585 -> V_593 ) ;
V_15 = F_293 ( sizeof( * V_15 ) , V_85 ) ;
if ( ! V_15 ) {
V_67 = - V_103 ;
goto V_592;
}
...
F_296 ( & V_15 -> V_252 ) ;
F_297 ( & V_15 -> V_597 ) ;
F_298 ( & V_15 -> V_553 , F_253 ) ;
F_298 ( & V_15 -> V_560 , F_269 ) ;
F_298 ( & V_15 -> F_246 , F_246 ) ;
F_298 ( & V_15 -> F_247 , F_247 ) ;
F_298 ( & V_15 -> F_248 , F_248 ) ;
F_299 ( & V_15 -> V_229 , F_244 ) ;
for ( V_58 = 0 ; V_58 < V_576 -> V_598 + V_576 -> V_599 ; ++ V_58 ) {
struct V_1 * V_123 ;
V_123 = F_300 ( sizeof( struct V_6 ) , V_107 ) ;
if ( ! V_123 ) {
V_67 = - V_103 ;
goto V_600;
}
F_301 ( V_123 , & V_53 -> V_2 ) ;
...
F_303 ( V_53 , V_15 ) ;
if ( F_304 ( V_15 , V_576 , 1 ) < 0 ) {
V_67 = - V_614 ;
goto V_600;
}
F_35 (adapter, i) {
V_67 = F_305 ( V_15 -> V_28 [ V_58 ] ) ;
if ( V_67 )
F_306 ( & V_53 -> V_2 ,
L_72 ,
V_15 -> V_28 [ V_58 ] -> V_4 ) ;
...
F_35 (adapter, i)
F_283 ( V_15 -> V_28 [ V_58 ] ) ;
F_308 ( V_15 ) ;
if ( F_80 ( V_15 ) ) {
F_307 ( V_233 , & V_15 -> V_581 ) ;
F_309 ( V_15 ) ;
}
if ( V_615 > 1 && F_279 ( V_15 ) == 0 )
V_15 -> V_51 |= V_52 ;
else if ( V_615 > 0 && F_310 ( V_53 ) == 0 )
V_15 -> V_51 |= V_54 ;
F_277 ( V_15 ) ;
...
static void T_14 F_314 ( struct V_562 * V_53 )
{
struct V_15 * V_15 = F_274 ( V_53 ) ;
if ( V_15 ) {
int V_58 ;
