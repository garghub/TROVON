...
T_1 * V_28 ;
int V_29 ;
F_15 ( V_10 -> V_30 , V_1 -> V_31 , V_1 -> V_32 ,
0x21 ) ;
F_16 ( V_10 -> V_30 , V_10 -> V_24 ) ;
V_28 = V_1 -> V_7 ;
V_28 [ 0 ] = 0x01 ;
V_28 [ 1 ] = 0x01 ;
F_1 ( V_1 , 2 ) ;
...
V_28 [ 5 ] = 0x30 ;
V_28 [ 6 ] = 0x02 ;
V_28 [ 7 ] = V_10 -> V_11 [ GAMMA ] . V_13 * 0x40 ;
V_28 [ 8 ] = 0x01 ;
V_28 [ 9 ] = 0x52 ;
V_28 [ 10 ] = 0x18 ;
F_1 ( V_1 , 11 ) ;
...
V_28 [ 0 ] = 0x5e ;
V_28 [ 1 ] = 0 ;
V_28 [ 2 ] = V_10 -> V_11 [ V_14 ] . V_13 << 3 ;
V_28 [ 3 ] = ( ( V_10 -> V_11 [ V_14 ] . V_13 >> 2 ) & 0xf8 ) | 0x04 ;
V_28 [ 4 ] = V_10 -> V_11 [ V_12 ] . V_13 ;
V_28 [ 5 ] = 0x00 ;
F_1 ( V_1 , 6 ) ;
V_28 [ 0 ] = 0x67 ;
V_28 [ 1 ] = V_10 -> V_11 [ V_15 ] . V_13 * 4 + 3 ;
V_28 [ 2 ] = 0x14 ;
F_1 ( V_1 , 3 ) ;
V_28 [ 0 ] = 0x69 ;
V_28 [ 1 ] = 0x2f ;
...
V_28 [ 1 ] = 0x07 ;
F_1 ( V_1 , 2 ) ;
for ( V_29 = 0 ; V_29 < sizeof F_17 ; V_29 ++ )
F_5 ( V_1 , V_29 + 1 , F_17 [ V_29 ] ) ;
V_28 [ 0 ] = 0x00 ;
V_28 [ 1 ] = 0x4d ;
F_1 ( V_1 , 2 ) ;
V_1 -> V_27 = 0 ;
...
const struct V_18 * V_19 )
{
return F_28 ( V_48 , V_19 , & V_49 , sizeof( struct V_10 ) ,
V_50 ) ;
}
