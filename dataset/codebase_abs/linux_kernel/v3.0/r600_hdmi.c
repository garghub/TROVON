...
V_64 -> V_12 = V_106 -> V_108 ?
V_99 : V_97 ;
if ( F_28 ( V_9 ) )
V_64 -> V_109 = V_106 -> V_108 ?
V_110 : V_111 ;
...
V_11 = V_64 -> V_12 ;
if ( F_28 ( V_9 ) && ! F_15 ( V_9 ) ) {
F_13 ( V_64 -> V_109 + 0x4 , 0x1 , ~ 0x1 ) ;
} else if ( V_9 -> V_100 >= V_104 && ! F_27 ( V_9 ) ) {
switch ( V_64 -> V_112 ) {
case V_113 :
F_13 ( V_114 , 0x4 , ~ 0x4 ) ;
F_5 ( V_11 + V_115 , 0x101 ) ;
break;
case V_116 :
F_13 ( V_117 , 0x4 , ~ 0x4 ) ;
F_5 ( V_11 + V_115 , 0x105 ) ;
break;
default:
F_26 ( V_9 -> V_7 , L_9 ) ;
break;
...
&& V_9 -> V_100 != V_102
&& V_9 -> V_100 != V_103 ) {
V_9 -> V_118 . V_120 [ V_11 == V_97 ? 0 : 1 ] = true ;
F_31 ( V_9 ) ;
F_32 ( V_5 ) ;
} else {
F_33 ( V_5 ) ;
...
F_2 ( L_12 ,
V_11 , V_64 -> V_112 ) ;
V_9 -> V_118 . V_120 [ V_11 == V_97 ? 0 : 1 ] = false ;
F_31 ( V_9 ) ;
F_32 ( V_5 ) ;
if ( F_28 ( V_9 ) && ! F_15 ( V_9 ) ) {
F_13 ( V_64 -> V_109 + 0x4 , 0 , ~ 0x1 ) ;
} else if ( V_9 -> V_100 >= V_104 && ! F_27 ( V_9 ) ) {
switch ( V_64 -> V_112 ) {
case V_113 :
F_13 ( V_114 , 0 , ~ 0x4 ) ;
