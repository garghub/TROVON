...
static void T_3 F_17 ( unsigned long V_54 , unsigned long V_55 ,
void * V_56 )
{
...
static int T_3 F_20 ( char * V_59 )
{
if ( V_59 )
F_21 ( V_60 , V_59 , sizeof ( V_60 ) ) ;
return 1 ;
}
static int T_3 F_22 ( char * V_59 )
{
char * V_25 ;
int V_61 = 0 ;
...
static void T_3
F_24 ( struct V_65 * V_16 , unsigned int V_66 )
{
struct V_67 * V_68 ;
F_25 ( ( V_69
L_2
...
static int T_3
F_40 ( struct V_113 * V_135 , int V_42 , int V_43 )
{
struct V_112 * V_28 ;
int V_61 = 0 ;
...
static void T_3
F_42 ( unsigned long V_54 , unsigned long V_55 , void * V_56 )
{
unsigned long V_57 = ( unsigned long ) V_56 ;
while ( V_55 ) {
V_55 -- ;
...
static struct V_137 * T_3
F_43 ( unsigned long V_151 )
{
struct V_137 * V_29 ;
V_58 V_118 ;
struct V_120 * V_146 , * V_134 ;
...
static struct V_137 T_3 * F_46 ( unsigned long V_151 )
{
struct V_137 * V_29 ;
unsigned long V_118 ;
...
static int T_3 F_48 ( int V_156 , struct V_1 * V_2 ,
unsigned long V_151 )
{
struct V_113 * V_157 ;
...
F_49 ( unsigned long V_151 , unsigned long V_89 , struct V_165 * V_96 )
{
struct V_1 * V_2 ;
int V_160 ;
V_58 V_166 ;
...
static void T_3 F_55 ( struct V_1 * V_2 , char * V_175 )
{
if ( strcmp ( V_175 , V_60 ) == 0 )
V_176 = V_2 ;
}
static int T_3 F_56 ( struct V_177 * V_178 )
{
char V_179 [ 21 ] ;
struct V_1 * V_2 = NULL ;
...
static int T_3 F_58 ( struct V_165 * V_96 ,
...
static void T_4 F_65 ( struct V_165 * V_96 )
{
F_66 () ;
}
