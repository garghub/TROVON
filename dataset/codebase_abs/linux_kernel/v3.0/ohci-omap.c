...
F_19 ( V_29 ) ;
V_25 -> V_31 -> V_32 = V_33 ;
F_20 ( V_34 , & V_25 -> V_35 -> V_36 . V_37 [ V_26 ] ) ;
V_30 = F_15 ( V_38 ) ;
V_30 &= ~ V_39 ;
F_13 ( V_30 , V_38 ) ;
F_21 ( V_29 ) ;
...
{
struct V_24 * V_25 = F_23 ( V_41 ) ;
struct V_42 * V_43 = V_41 -> V_27 . V_44 -> V_45 ;
int V_46 = ( V_43 -> V_47 != 0 ) ;
int V_48 ;
F_24 ( V_41 -> V_27 . V_44 , L_1 ) ;
if ( V_43 -> V_47 ) {
F_17 ( V_25 ) -> V_27 . V_28 = V_43 -> V_47 ;
F_17 ( V_25 ) -> V_49 = 8 ;
}
V_46 = V_46
|| F_25 () || F_26 () ;
...
V_25 -> V_31 = F_30 () ;
if ( V_25 -> V_31 ) {
int V_50 = F_31 ( V_25 -> V_31 ,
& F_17 ( V_25 ) -> V_27 ) ;
F_24 ( V_41 -> V_27 . V_44 , L_2 ,
V_25 -> V_31 -> V_51 , V_50 ) ;
if ( V_50 ) {
if ( V_25 -> V_31 )
F_32 ( V_25 -> V_31 -> V_52 ) ;
...
F_40 ( V_25 , V_54 , & V_25 -> V_35 -> V_36 . V_59 ) ;
V_25 -> V_29 &= ~ V_60 ;
} else if ( F_41 () ) {
F_17 ( V_25 ) -> V_49 = 0 ;
}
...
V_41 = F_50 ( V_62 , & V_64 -> V_52 , F_51 ( & V_64 -> V_52 ) ) ;
if ( ! V_41 ) {
V_65 = - V_72 ;
goto V_73;
}
V_41 -> V_74 = V_64 -> V_69 [ 0 ] . V_75 ;
V_41 -> V_76 = V_64 -> V_69 [ 0 ] . V_77 - V_64 -> V_69 [ 0 ] . V_75 + 1 ;
if ( ! F_52 ( V_41 -> V_74 , V_41 -> V_76 , V_78 ) ) {
F_24 ( & V_64 -> V_52 , L_11 ) ;
V_65 = - V_79 ;
goto V_80;
}
V_41 -> V_35 = F_53 ( V_41 -> V_74 , V_41 -> V_76 ) ;
if ( ! V_41 -> V_35 ) {
F_33 ( & V_64 -> V_52 , L_12 ) ;
V_65 = - V_72 ;
goto V_81;
...
static inline void
F_60 ( struct V_40 * V_41 , struct V_63 * V_64 )
{
struct V_24 * V_25 = F_23 ( V_41 ) ;
F_61 ( V_41 ) ;
if ( V_25 -> V_31 ) {
( void ) F_31 ( V_25 -> V_31 , 0 ) ;
F_32 ( V_25 -> V_31 -> V_52 ) ;
}
if ( F_11 () )
F_62 ( 9 ) ;
...
if ( ! V_83 )
return 0 ;
V_43 = V_41 -> V_27 . V_44 -> V_45 ;
if ( V_43 -> V_47 || V_43 -> V_87 ) {
V_25 -> V_88 = V_89 ;
F_20 ( V_89 , & V_25 -> V_35 -> V_90 ) ;
}
if ( ( V_48 = F_64 ( V_25 ) ) < 0 ) {
F_33 ( V_41 -> V_27 . V_44 , L_13 ) ;
F_43 ( V_41 ) ;
return V_48 ;
}
return 0 ;
...
{
return F_44 ( & V_91 , V_52 ) ;
}
static int F_66 ( struct V_63 * V_52 )
{
struct V_40 * V_41 = F_67 ( V_52 ) ;
F_60 ( V_41 , V_52 ) ;
F_68 ( V_52 , NULL ) ;
return 0 ;
}
static int F_69 ( struct V_63 * V_52 , T_2 V_92 )
{
struct V_24 * V_25 = F_23 ( F_67 ( V_52 ) ) ;
if ( F_70 ( V_93 , V_25 -> V_94 ) )
F_71 ( 5 ) ;
V_25 -> V_94 = V_93 ;
F_2 ( 0 ) ;
F_17 ( V_25 ) -> V_32 = V_95 ;
