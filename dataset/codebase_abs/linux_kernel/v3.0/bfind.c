...
F_7 ( V_4 -> V_6 ) ;
F_8 ( V_4 -> V_10 ) ;
F_3 ( V_12 , L_2 , V_4 -> V_2 -> V_13 , F_4 ( 0 ) ) ;
F_9 ( & V_4 -> V_2 -> V_14 ) ;
V_4 -> V_2 = NULL ;
}
...
int F_20 ( struct V_3 * V_4 , void * V_20 , int V_47 )
{
int V_23 ;
V_23 = F_14 ( V_4 ) ;
if ( V_23 )
...
int F_21 ( struct V_3 * V_4 , int V_48 )
{
struct V_1 * V_2 ;
struct V_15 * V_6 ;
int V_49 , V_23 = 0 ;
...
while ( V_48 >= V_6 -> V_24 - V_4 -> V_30 ) {
V_48 -= V_6 -> V_24 - V_4 -> V_30 ;
V_4 -> V_30 = 0 ;
V_49 = V_6 -> V_52 ;
if ( ! V_49 ) {
V_23 = - V_25 ;
