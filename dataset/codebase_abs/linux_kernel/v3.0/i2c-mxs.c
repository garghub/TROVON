...
V_2 -> V_40 = 0 ;
F_21 ( & V_2 -> V_34 ) ;
F_3 ( V_50 , V_2 -> V_3 + V_59 ) ;
return V_60 ;
}
static int T_4 F_22 ( struct V_61 * V_62 )
{
struct V_63 * V_35 = & V_62 -> V_35 ;
struct V_1 * V_2 ;
struct V_28 * V_29 ;
struct V_64 * V_65 ;
T_5 V_66 ;
int V_44 , V_67 ;
V_2 = F_23 ( V_35 , sizeof( struct V_1 ) , V_68 ) ;
if ( ! V_2 )
return - V_69 ;
V_65 = F_24 ( V_62 , V_70 , 0 ) ;
if ( ! V_65 )
return - V_71 ;
V_66 = F_25 ( V_65 ) ;
if ( ! F_26 ( V_35 , V_65 -> V_72 , V_66 , V_65 -> V_73 ) )
return - V_74 ;
V_2 -> V_3 = F_27 ( V_35 , V_65 -> V_72 , V_66 ) ;
if ( ! V_2 -> V_3 )
return - V_74 ;
V_67 = F_28 ( V_62 , 0 ) ;
if ( V_67 < 0 )
return V_67 ;
V_44 = F_29 ( V_35 , V_67 , F_20 , 0 , F_30 ( V_35 ) , V_2 ) ;
if ( V_44 )
return V_44 ;
V_2 -> V_35 = V_35 ;
F_31 ( V_62 , V_2 ) ;
F_1 ( V_2 ) ;
V_29 = & V_2 -> V_75 ;
F_32 ( V_29 -> V_73 , L_4 , sizeof( V_29 -> V_73 ) ) ;
V_29 -> V_76 = V_77 ;
V_29 -> V_78 = & V_79 ;
V_29 -> V_35 . V_80 = V_35 ;
V_29 -> V_81 = V_62 -> V_82 ;
...
static int T_6 F_36 ( struct V_61 * V_62 )
{
...
F_3 ( V_39 ,
V_2 -> V_3 + V_85 ) ;
F_3 ( V_83 , V_2 -> V_3 + V_84 ) ;
F_31 ( V_62 , NULL ) ;
return 0 ;
}
static int T_7 F_39 ( void )
{
return F_40 ( & V_86 , F_22 ) ;
}
