...
if ( V_13 ) {
F_7 ( 4 , L_13
L_14 , ( unsigned long long ) V_41 -> V_58 ) ;
F_4 ( & V_1 -> V_20 ) ;
F_47 ( & V_13 -> F_1 ) ;
F_6 ( & V_1 -> V_20 ) ;
F_17 ( V_15 , V_13 ) ;
...
V_65 = 0 ;
V_66 = 0 ;
V_64 = V_1 -> V_5 == V_1 -> V_35 [ 0 ] ?
V_1 -> V_35 [ 1 ] : V_1 -> V_35 [ 0 ] ;
for ( V_34 = 0 ; V_34 < V_64 -> V_7 ; V_34 ++ ) {
V_11 = & V_64 -> V_19 [ V_34 ] ;
while ( ! F_20 ( V_11 ) ) {
V_13 = (struct V_12 * )
V_11 -> V_24 ;
...
if ( ! V_63 )
return;
V_69 = ( T_6 * ) & F_43 ( V_63 ) -> V_70 [ 0 ] ;
V_69 -> V_71 = F_55 ( V_72 ) ;
V_69 -> V_73 = F_55 ( V_74 ) ;
V_69 -> V_75 = F_55 ( V_61 -> V_53 ) ;
F_56 ( V_63 , L_16 ) ;
F_57 ( V_63 , V_61 , V_76 ) ;
V_65 = sizeof( V_77 ) ;
* V_67 = V_63 ;
...
if ( F_58 ( V_1 , V_78 ) ) {
* ( ( V_79 * ) ( & F_43 ( V_63 ) -> V_70 [ V_65 ] ) ) =
F_59 ( V_13 -> V_8 ) ;
V_65 += 8 ;
} else {
* ( ( V_80 * ) ( & F_43 ( V_63 ) -> V_70 [ V_65 ] ) ) =
F_55 ( V_13 -> V_8 ) ;
V_65 += 4 ;
}
* V_68 = V_65 ;
...
{
V_77 * V_69 ;
struct V_39 * V_41 = F_43 ( V_63 ) ;
if ( F_53 ( V_1 ) ) {
F_35 ( V_41 ) ;
return;
}
V_69 = ( V_77 * ) F_43 ( V_63 ) -> V_70 ;
V_69 -> V_81 = F_55 ( V_65 ) ;
F_60 ( V_41 ) ;
F_28 ( V_41 , L_17 ) ;
F_61 ( V_41 ) ;
