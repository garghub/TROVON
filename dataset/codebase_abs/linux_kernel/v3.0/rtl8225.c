...
{
struct V_5 * V_6 = V_2 -> V_6 ;
int V_66 = F_30 ( V_65 -> V_27 -> V_67 ) ;
if ( V_6 -> V_68 -> V_69 == F_21 )
F_13 ( V_2 , V_66 ) ;
else if ( V_6 -> V_68 -> V_69 == F_26 )
F_24 ( V_2 , V_66 ) ;
else
F_25 ( V_2 , V_66 ) ;
F_10 ( V_2 , 0x7 , V_70 [ V_66 - 1 ] ) ;
F_17 ( 10 ) ;
}
const struct V_71 * F_31 ( struct V_1 * V_2 )
{
T_2 V_72 , V_73 ;
struct V_5 * V_6 = V_2 -> V_6 ;
if ( ! V_6 -> V_74 ) {
