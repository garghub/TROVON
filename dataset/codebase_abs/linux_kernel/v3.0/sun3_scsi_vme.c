...
F_21 ( V_69 , V_70 ) ;
F_23 ( V_72 ) ;
for( V_66 = V_73 + V_74 ; F_24 ( V_73 , V_66 ) ; )
F_25 () ;
F_13 ( L_12 ) ;
}
static const char * F_26 ( struct V_9 * V_75 ) {
return L_13 ;
}
static T_1 V_50 ( int V_7 , void * V_76 )
{
...
static unsigned long F_30 ( void * V_85 , unsigned long V_86 , int V_87 )
{
void * V_88 ;
if( V_81 != NULL )
F_31 ( V_81 ) ;
V_88 = ( void * ) F_32 ( ( unsigned long ) V_85 , V_86 ) ;
V_81 = V_88 ;
V_89 = V_86 ;
#ifdef F_27
F_13 ( L_18 , V_88 , V_86 ) ;
...
static inline unsigned long F_33 ( struct V_9 * V_10 )
{
return V_92 ;
}
static inline unsigned long F_34 ( unsigned long V_93 ,
struct V_94 * V_95 ,
int V_87 )
{
...
static int F_35 ( unsigned long V_86 , char * V_85 )
{
unsigned short V_40 ;
V_40 = V_37 -> V_40 ;
#ifdef F_27
