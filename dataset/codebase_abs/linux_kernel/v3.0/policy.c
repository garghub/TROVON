...
{
struct V_37 * V_57 = F_30 ( V_33 , struct V_37 ,
V_20 . V_10 ) ;
F_57 ( V_57 ) ;
}
...
static int F_69 ( struct V_37 * V_38 , int V_58 ,
const char * * V_59 )
{
if ( V_38 ) {
if ( V_38 -> V_29 & V_32 ) {
...
static int F_71 ( int V_62 , T_3 V_63 , const char * V_6 , const char * V_59 ,
int error )
{
struct V_64 V_65 ;
F_72 ( & V_65 , V_66 ) ;
...
V_65 . V_67 . V_6 = V_6 ;
V_65 . V_67 . V_59 = V_59 ;
V_65 . V_67 . error = error ;
return F_73 ( V_68 , F_74 () , V_63 ,
& V_65 , NULL ) ;
}
bool F_75 ( int V_62 )
{
if ( V_69 ) {
F_71 ( V_62 , V_7 , NULL , L_14 , - V_70 ) ;
return 0 ;
}
if ( ! F_76 ( V_71 ) ) {
F_71 ( V_62 , V_7 , NULL , L_15 , - V_70 ) ;
return 0 ;
}
return 1 ;
}
T_4 F_77 ( void * V_72 , T_5 V_73 , bool V_58 )
{
struct V_3 * V_4 ;
struct V_37 * V_74 = NULL , * V_75 = NULL ;
struct V_37 * V_76 = NULL ;
struct V_16 * V_22 = NULL ;
const char * V_77 , * V_6 = NULL , * V_59 = NULL ;
int V_62 = V_78 ;
T_4 error ;
V_75 = F_78 ( V_72 , V_73 , & V_77 ) ;
if ( F_79 ( V_75 ) ) {
error = F_80 ( V_75 ) ;
V_75 = NULL ;
goto V_48;
...
V_6 = V_75 -> V_20 . V_1 ;
F_37 ( & V_22 -> V_25 ) ;
V_4 = F_66 ( V_22 , V_75 -> V_20 . V_1 ) ;
if ( ! V_4 ) {
V_59 = L_17 ;
error = - V_79 ;
goto V_80;
}
V_74 = F_63 ( & V_4 -> V_9 , V_75 -> V_20 . V_6 ) ;
F_41 ( V_74 ) ;
if ( V_75 -> rename ) {
V_76 = F_67 ( & V_22 -> V_20 ,
V_75 -> rename ) ;
...
error = F_69 ( V_74 , V_58 , & V_59 ) ;
if ( error )
goto V_80;
error = F_69 ( V_76 , V_58 , & V_59 ) ;
if ( error )
goto V_80;
V_80:
if ( ! V_74 && ! V_76 )
V_62 = V_81 ;
error = F_71 ( V_62 , V_82 , V_6 , V_59 , error ) ;
if ( ! error ) {
if ( V_76 )
F_44 ( V_76 , V_75 ) ;
if ( V_74 ) {
...
return V_73 ;
V_48:
error = F_71 ( V_62 , V_7 , V_6 , V_59 , error ) ;
goto V_35;
}
T_4 F_81 ( char * V_83 , T_5 V_73 )
{
struct V_16 * V_34 , * V_22 = NULL ;
struct V_37 * V_38 = NULL ;
const char * V_6 = V_83 , * V_59 = NULL ;
T_4 error = 0 ;
if ( * V_83 == 0 ) {
V_59 = L_19 ;
error = - V_79 ;
...
( void ) F_71 ( V_85 , V_7 , V_6 , V_59 , error ) ;
F_27 ( V_22 ) ;
F_28 ( V_38 ) ;
return V_73 ;
V_84:
