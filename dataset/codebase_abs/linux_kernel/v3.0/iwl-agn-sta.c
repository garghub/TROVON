...
int F_8 ( struct V_2 * V_3 , struct V_34 * V_35 ,
...
memcpy ( & V_87 , & V_3 -> V_42 [ V_4 ] . V_95 , sizeof( struct V_86 ) ) ;
F_11 ( & V_3 -> V_41 , V_39 ) ;
...
switch ( V_73 -> V_84 ) {
case V_116 :
V_38 = F_26 ( V_3 , V_35 , V_73 , V_4 ) ;
break;
case V_117 :
V_38 = F_27 ( V_3 , V_35 , V_73 , V_4 ) ;
break;
case V_118 :
case V_119 :
V_38 = F_22 ( V_3 , V_35 , V_73 , V_4 ) ;
break;
default:
F_3 ( V_3 ,
L_15 , V_120 ,
...
T_1 V_4 ;
F_10 ( & V_3 -> V_41 , V_39 ) ;
V_4 = F_37 ( V_3 , V_35 , V_121 , false , NULL ) ;
if ( V_4 == V_40 ) {
F_3 ( V_3 , L_17 ) ;
F_11 ( & V_3 -> V_41 , V_39 ) ;
return - V_78 ;
...
static void F_47 ( struct V_2 * V_3 , int V_4 )
{
unsigned long V_39 ;
F_10 ( & V_3 -> V_41 , V_39 ) ;
V_3 -> V_42 [ V_4 ] . V_95 . V_135 &= ~ V_136 ;
V_3 -> V_42 [ V_4 ] . V_95 . V_129 = V_136 ;
V_3 -> V_42 [ V_4 ] . V_95 . V_95 . V_98 = 0 ;
V_3 -> V_42 [ V_4 ] . V_95 . V_137 = 0 ;
V_3 -> V_42 [ V_4 ] . V_95 . V_100 = V_101 ;
F_25 ( V_3 , & V_3 -> V_42 [ V_4 ] . V_95 , V_110 ) ;
F_11 ( & V_3 -> V_41 , V_39 ) ;
}
void F_48 ( struct V_2 * V_3 , int V_4 , int V_138 )
{
unsigned long V_39 ;
F_10 ( & V_3 -> V_41 , V_39 ) ;
V_3 -> V_42 [ V_4 ] . V_95 . V_135 |= V_136 ;
...
V_139 ;
V_3 -> V_42 [ V_4 ] . V_95 . V_137 = F_7 ( V_138 ) ;
V_3 -> V_42 [ V_4 ] . V_95 . V_100 = V_101 ;
F_25 ( V_3 , & V_3 -> V_42 [ V_4 ] . V_95 , V_110 ) ;
F_11 ( & V_3 -> V_41 , V_39 ) ;
}
void F_49 ( struct V_140 * V_141 ,
struct V_142 * V_143 ,
enum V_144 V_57 ,
struct V_105 * V_95 )
{
struct V_2 * V_3 = V_141 -> V_3 ;
struct V_145 * V_146 = ( void * ) V_95 -> V_147 ;
int V_4 ;
switch ( V_57 ) {
case V_148 :
F_50 ( ! V_146 -> V_149 ) ;
V_146 -> V_150 = true ;
if ( F_51 ( & V_146 -> V_151 ) > 0 )
F_52 ( V_141 , V_95 , true ) ;
break;
case V_152 :
F_50 ( ! V_146 -> V_149 ) ;
if ( ! V_146 -> V_150 )
