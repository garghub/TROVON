...
{
int V_15 ;
struct V_16 * V_30 = NULL ;
if ( V_29 != NULL ) {
V_15 = 0 ;
while ( ( V_15 < V_19 ) && ( V_30 == NULL ) ) {
...
struct V_31 * F_10 ( enum V_28 V_18 )
{
struct V_31 * V_32 = NULL ;
struct V_31 * V_30 ;
V_30 = V_33 ;
while ( ( V_30 -> V_18 != - 1 ) && ( V_32 == NULL ) ) {
if ( V_30 -> V_18 == V_18 )
V_32 = V_30 ;
else
V_30 ++ ;
...
char * F_16 ( char * V_81 , char * V_82 )
{
int V_36 = 0 ;
while ( * V_81 && * V_81 <= V_77 )
V_81 ++ ;
while ( * V_81 >= '0' && * V_81 <= '9' ) {
V_36 *= 10 ;
V_36 += ( * V_81 ) - '0' ;
...
char * F_17 ( char * V_72 )
{
static const char V_84 [] = L_12 ;
static const char V_85 [] = L_13 ;
static const char V_86 [] = L_14 ;
char * V_80 = V_72 , * V_87 , * V_88 , V_89 ;
int V_90 ;
while ( ( V_80 = strchr ( V_80 , '\\' ) ) ) {
V_87 = V_80 + 1 ;
V_88 = strchr ( V_84 , * V_87 ) ;
if ( V_88 ) {
* V_80 ++ = V_85 [ V_88 - V_84 ] ;
V_87 ++ ;
} else if ( * V_87 >= '0' && * V_87 <= '7' ) {
V_90 = ( * V_87 ++ ) & 7 ;
while ( V_90 < 256 && * V_87 >= '0' && * V_87 <= '7' ) {
V_90 <<= 3 ;
V_90 = ( * V_87 ++ ) & 7 ;
}
* V_80 ++ = V_90 ;
} else if ( * V_87 == 'x' &&
strchr ( V_86 , V_87 [ 1 ] ) && strchr ( V_86 , V_87 [ 2 ] ) ) {
V_87 ++ ;
V_89 = * V_87 ++ ;
if ( V_89 > '9' )
V_89 = ( V_89 - '7' ) & 0x0f ;
