...
if ( V_41 > V_93 )
V_41 = V_93 ;
if ( V_41 > 0 && F_68 ( V_72 , V_6 -> V_14 , V_41 ) )
V_41 = - V_98 ;
F_49 ( V_6 ) ;
return V_41 ;
}
static T_4 F_69 ( struct V_87 * V_87 , const char T_5 * V_72 ,
T_6 V_93 , T_7 * V_94 )
{
int V_41 ;
struct V_77 * V_24 = V_87 -> V_92 ;
...
F_20 ( void )
{
if ( F_73 ( V_110 , L_14 , & V_111 ) ) {
F_2 ( V_67 L_15 , V_110 ) ;
return;
}
V_112 = F_74 ( V_113 , L_14 ) ;
if ( F_75 ( V_112 ) )
return;
F_76 ( V_112 , NULL , F_77 ( V_110 , 0 ) , NULL , L_14 ) ;
F_78 ( & V_109 ) ;
F_79 ( & V_114 , F_72 ) ;
}
