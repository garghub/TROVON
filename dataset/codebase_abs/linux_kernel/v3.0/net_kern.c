...
static void F_40 ( char * V_68 , unsigned char * V_69 , char * V_33 )
{
char * V_70 ;
int V_71 ;
if ( V_68 == NULL )
...
static void F_46 ( struct V_74 * V_12 )
{
struct V_75 * V_74 = F_47 ( V_12 ) ;
...
static void F_50 ( int V_77 , void * V_78 , char * V_79 ,
struct V_80 * V_80 )
{
struct V_75 * V_74 ;
struct V_11 * V_12 ;
...
V_74 -> V_88 . V_89 = V_77 ;
V_74 -> V_88 . V_33 = V_62 ;
V_74 -> V_88 . V_12 . V_90 = F_46 ;
F_56 ( & V_74 -> V_88 . V_12 , V_74 ) ;
if ( F_57 ( & V_74 -> V_88 ) )
goto V_91;
F_58 ( V_12 , & V_74 -> V_88 . V_12 ) ;
V_74 -> V_12 = V_12 ;
...
static struct V_75 * F_66 ( int V_77 )
{
struct V_75 * V_74 ;
struct V_108 * V_109 ;
F_17 ( & V_106 ) ;
F_67 (ele, &devices) {
V_74 = F_68 ( V_109 , struct V_75 , V_47 ) ;
if ( V_74 -> V_85 == V_77 )
goto V_8;
}
V_74 = NULL ;
...
static int F_69 ( char * V_68 , int * V_110 , char * * V_111 ,
char * * V_112 )
{
char * V_70 ;
int V_77 , V_5 = - V_113 ;
V_77 = F_41 ( V_68 , & V_70 , 0 ) ;
if ( V_70 == V_68 ) {
* V_112 = L_23 ;
return V_5 ;
}
...
static int F_70 ( struct V_80 * V_80 , char * V_114 , int V_77 ,
...
F_25 ( & V_3 -> V_47 , & V_123 ) ;
F_21 ( & V_122 ) ;
F_75 (ele, next, &eth_cmd_line) {
V_114 = F_68 ( V_109 , struct V_120 , V_47 ) ;
V_121 = F_70 ( V_3 , V_114 -> V_78 , V_114 -> V_85 , & V_78 ,
& V_79 ) ;
if ( ! V_121 )
continue;
else if ( V_78 != NULL ) {
F_50 ( V_114 -> V_85 , V_78 , V_79 , V_3 ) ;
F_48 ( V_78 ) ;
}
F_29 ( & V_114 -> V_47 ) ;
}
}
static int F_76 ( char * V_68 , int V_85 )
{
struct V_108 * V_109 ;
struct V_80 * V_80 ;
void * V_78 ;
...
F_17 ( & V_122 ) ;
F_67 (ele, &transports) {
V_80 = F_68 ( V_109 , struct V_80 , V_47 ) ;
if ( ! F_70 ( V_80 , V_68 , V_85 , & V_78 , & V_79 ) )
continue;
if ( V_78 != NULL ) {
F_50 ( V_85 , V_78 , V_79 , V_80 ) ;
F_48 ( V_78 ) ;
}
V_124 = 1 ;
break;
...
static int T_2 F_77 ( char * V_68 )
{
struct V_120 * V_3 ;
char * error ;
int V_77 , V_5 ;
V_5 = F_69 ( V_68 , & V_77 , & V_68 , & error ) ;
if ( V_5 ) {
F_18 ( V_32 L_26 ,
V_68 , error ) ;
return 1 ;
...
static int F_80 ( char * V_68 , char * * V_112 )
{
int V_77 , V_5 ;
V_5 = F_69 ( V_68 , & V_77 , & V_68 , V_112 ) ;
if ( V_5 )
return V_5 ;
V_68 = F_81 ( V_68 , V_83 ) ;
if ( V_68 == NULL ) {
...
static int F_82 ( char * * V_68 , int * V_126 , int * V_127 )
{
char * V_70 ;
int V_77 ;
V_77 = F_41 ( * V_68 , & V_70 , 0 ) ;
...
static int F_83 ( int V_77 , char * * V_112 )
{
struct V_75 * V_74 ;
struct V_11 * V_12 ;
struct V_13 * V_14 ;
...
static int F_85 ( struct V_130 * V_131 , unsigned long V_132 ,
void * V_133 )
{
struct V_134 * V_135 = V_133 ;
struct V_11 * V_12 = V_135 -> V_136 -> V_12 ;
struct V_13 * V_14 ;
void (* F_86)( unsigned char * , unsigned char * , void * );
...
F_17 ( & V_46 ) ;
F_67 (ele, &opened) {
V_14 = F_68 ( V_109 , struct V_13 , V_47 ) ;
V_146 = V_14 -> V_12 -> V_149 ;
if ( V_146 == NULL )
continue;
V_147 = V_146 -> V_150 ;
while ( V_147 != NULL ) {
F_85 ( NULL , V_141 , V_147 ) ;
V_147 = V_147 -> V_151 ;
}
}
F_21 ( & V_46 ) ;
...
void F_92 ( void * V_153 , void (* F_93)( unsigned char * , unsigned char * ,
void * ) ,
void * V_154 )
{
...
(* F_93)( V_155 , V_156 , V_154 ) ;
V_147 = V_147 -> V_151 ;
}
}
int F_94 ( void * V_153 , void * V_157 )
{
struct V_11 * V_12 = V_153 ;
struct V_145 * V_146 = V_12 -> V_149 ;
struct V_134 * V_147 ;
...
{
void * V_160 ;
V_160 = ( void * ) F_96 ( V_83 , 0 ) ;
if ( V_160 ) * V_159 = V_161 ;
else * V_159 = 0 ;
return V_160 ;
}
void F_97 ( void * V_162 )
{
F_98 ( ( unsigned long ) V_162 , 0 ) ;
}
int F_99 ( char * V_68 , char * type , char * * V_163 , char * * V_116 ,
char * * V_164 )
{
char * V_165 ;
V_165 = F_100 ( V_68 , V_163 , V_116 , V_164 , NULL ) ;
if ( V_165 != NULL ) {
F_18 ( V_32 L_29
L_30 , V_165 ) ;
return 1 ;
...
unsigned short F_101 ( struct V_2 * V_16 )
{
return F_102 ( V_16 , V_16 -> V_12 ) ;
}
