...
{
F_113 ( V_8 -> V_33 . V_70 , V_71 ) ;
V_8 -> V_33 . V_70 [ 0 ] &= ~ 0x01 ;
V_8 -> V_33 . V_70 [ 0 ] |= 0x02 ;
}
...
V_8 -> V_87 . V_340 = F_30 ;
#ifdef F_130
V_8 -> V_116 = F_131 ( V_341 , 0 ) ;
#else
V_8 -> V_116 = F_131 ( V_341 ) ;
#endif
F_132 ( & V_8 -> V_319 , ( void * ) F_116 ) ;
F_133 ( & V_8 -> V_214 , ( void * ) F_75 ) ;
F_133 ( & V_8 -> V_220 , ( void * ) F_80 ) ;
F_132 ( & V_8 -> V_113 , ( void * ) F_41 ) ;
F_132 ( & V_8 -> V_204 , ( void * ) F_122 ) ;
F_133 ( & V_8 -> V_342 , ( void * ) V_343 ) ;
F_134 ( & V_8 -> V_221 , 1 ) ;
F_134 ( & V_8 -> V_99 , 1 ) ;
F_135 ( & V_8 -> V_60 ) ;
F_135 ( & V_8 -> V_92 ) ;
...
( unsigned long ) V_8 ) ;
V_8 -> V_344 = F_137 ( sizeof( V_345 ) , V_243 ) ;
}
...
static int F_140 ( struct V_7 * V_8 , int V_347 )
{
F_9 ( L_27 , V_347 ? L_28 : L_29 ) ;
V_8 -> V_348 = V_347 ;
return 0 ;
}
void F_141 ( struct V_7 * V_8 , char * V_167 , int V_147 )
{
F_140 ( V_8 , 1 ) ;
F_119 ( V_8 ) ;
}
static int F_142 ( struct V_7 * V_8 , int V_349 , int V_350 )
{
int V_43 = 0 ;
switch ( V_349 ) {
case V_351 :
...
F_141 ( V_8 , V_8 -> V_167 , V_8 -> V_147 ) ;
return 0 ;
}
static int F_144 ( struct V_7 * V_8 , int V_347 )
{
struct V_361 V_362 = {
. V_45 = V_363 ,
} ;
...
static int F_145 ( struct V_7 * V_8 , T_1 V_153 , T_2 V_347 )
{
int V_43 = 0 ;
unsigned long V_45 ;
switch ( V_153 ) {
case V_367 :
V_43 = F_140 ( V_8 , V_347 ) ;
break;
case V_368 :
V_8 -> V_369 = V_347 ;
break;
...
if ( V_355 -> V_392 [ 0 ] == 0xff && V_355 -> V_392 [ 1 ] == 0xff &&
V_355 -> V_392 [ 2 ] == 0xff && V_355 -> V_392 [ 3 ] == 0xff &&
V_355 -> V_392 [ 4 ] == 0xff && V_355 -> V_392 [ 5 ] == 0xff ) {
...
struct V_144 * V_399 ;
F_147 ( V_8 , V_145 ) ;
V_399 = F_137 ( sizeof( * V_399 ) , V_360 ) ;
if ( V_399 == NULL ) {
V_43 = - V_244 ;
goto V_395;
}
...
switch ( V_355 -> V_421 ) {
case V_422 :
V_43 = F_145 ( V_8 , V_355 -> V_357 . V_423 . V_153 ,
V_355 -> V_357 . V_423 . V_347 ) ;
break;
case V_424 :
V_43 = F_143 ( V_8 , V_355 , V_417 -> V_418 ) ;
break;
case V_425 :
V_43 = F_146 ( V_8 , V_355 , V_417 -> V_418 ) ;
break;
case V_426 :
V_43 = F_142 ( V_8 , V_355 -> V_357 . V_427 . V_349 ,
