...
static void T_3 F_32 ( struct V_55 * V_56 )
{
struct V_57 * V_58 ;
struct V_17 * V_18 ;
struct V_33 * V_34 ;
V_58 = F_33 ( V_56 ) ;
if ( V_58 ) {
V_18 = F_34 ( V_58 , struct V_17 , V_58 ) ;
V_34 = V_18 -> V_34 ;
F_15 ( & V_35 ) ;
F_35 ( V_58 ) ;
F_36 ( & V_58 -> V_59 ) ;
...
static int T_4 F_39 ( struct V_55 * V_56 ,
...
struct V_33 * V_34 ;
int V_25 = 0 ;
V_34 = F_40 ( sizeof( * V_34 ) , V_71 ) ;
if ( V_34 == NULL )
return - V_10 ;
V_18 = F_40 ( sizeof( * V_18 ) , V_71 ) ;
if ( V_18 == NULL ) {
V_25 = - V_10 ;
goto V_48;
}
...
{
struct V_17 * V_18 = F_34 ( V_58 , struct V_17 , V_58 ) ;
int V_126 ;
F_15 ( & V_35 ) ;
...
T_5 V_132 , V_133 , V_134 , V_135 , V_136 , V_137 ;
T_5 V_138 , V_139 , V_140 , V_141 , V_142 , V_143 ;
T_5 V_144 ;
int clock ;
...
static int F_69 ( T_7 V_188 , T_7 V_66 , T_7 V_65 , T_7 V_63 ,
T_7 V_67 , struct V_57 * V_58 )
{
T_5 V_116 ;
if ( V_188 >= 16 )
return - V_42 ;
...
{
struct V_17 * V_18 = F_34 ( V_58 , struct V_17 , V_58 ) ;
unsigned long V_12 = V_190 -> V_191 - V_190 -> V_192 ;
unsigned long V_40 = V_190 -> V_193 << V_15 ;
int V_126 ;
if ( V_190 -> V_193 > ( ~ 0UL >> V_15 ) )
return - V_42 ;
if ( V_40 + V_12 > V_18 -> V_32 )
return - V_42 ;
V_126 = F_19 ( V_18 , V_40 ) ;
if ( V_126 )
return - V_42 ;
V_40 += V_18 -> V_29 ;
F_72 ( V_190 -> V_194 ) |= V_195 ;
F_72 ( V_190 -> V_194 ) &= ~ V_196 ;
V_190 -> V_197 |= V_198 | V_199 ;
if ( F_73 ( V_190 , V_190 -> V_192 , V_40 >> V_15 ,
V_12 , V_190 -> V_194 ) )
return - V_200 ;
return 0 ;
}
...
static int F_75 ( struct V_57 * V_58 , struct V_201 * V_202 )
{
return - V_42 ;
}
...
while ( V_210 != & V_180 ) {
F_84 ( V_210 ) ;
V_208 = F_85 ( V_210 , struct V_17 , V_97 ) ;
if ( ! F_49 ( & V_208 -> V_58 . V_61 , V_208 ) ) {
F_60 ( V_208 ) ;
F_86 ( V_210 , & V_179 ) ;
} else {
F_17 ( & V_35 ) ;
V_211 = V_208 -> V_58 . V_61 . V_215 ;
V_208 -> V_58 . V_61 . V_62 = 16 ;
F_38 ( & V_208 -> V_58 . V_61 ) ;
if ( F_43 ( & V_208 -> V_58 . V_61 ,
& V_208 -> V_58 ,
V_102 , NULL , 0 , NULL , 16 ) ) {
V_208 -> V_58 . V_61 . V_215 |=
V_216 | V_217 ;
F_87 ( & V_208 -> V_58 , & V_208 -> V_58 . V_61 ) ;
} else {
F_7 (KERN_ERR MODULE_NAME
L_38 ) ;
}
V_208 -> V_58 . V_61 . V_215 = V_211 ;
F_15 ( & V_35 ) ;
}
F_66 ( V_208 ) ;
V_210 = V_180 . V_214 ;
...
void F_88 ( struct V_206 * V_207 )
{
struct V_17 * V_208 , * V_214 ;
F_15 ( & V_35 ) ;
if ( V_118 != V_207 ) {
F_17 ( & V_35 ) ;
return;
