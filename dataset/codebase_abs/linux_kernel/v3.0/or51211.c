...
{
struct V_1 * V_2 = V_16 -> V_19 ;
if ( V_2 -> V_34 != V_33 -> V_35 ) {
if ( V_16 -> V_36 . V_37 . V_38 ) {
V_16 -> V_36 . V_37 . V_38 ( V_16 , V_33 ) ;
if ( V_16 -> V_36 . V_39 ) V_16 -> V_36 . V_39 ( V_16 , 0 ) ;
}
F_8 ( V_16 , 0 ) ;
V_2 -> V_34 = V_33 -> V_35 ;
}
...
static int F_10 ( struct V_15 * V_16 , T_2 * V_40 )
{
struct V_1 * V_2 = V_16 -> V_19 ;
unsigned char V_29 [ 2 ] ;
unsigned char V_41 [] = { 0x04 , 0x00 , 0x03 , 0x00 } ;
* V_40 = 0 ;
if ( F_1 ( V_2 , V_2 -> V_24 -> V_26 , V_41 , 3 ) ) {
F_3 ( V_12 L_18 ) ;
return - 1 ;
}
F_7 ( 3 ) ;
...
static T_3 F_11 ( T_3 V_47 , T_3 V_48 )
{
if ( V_47 == 0 )
return 0 ;
V_47 = 2 * F_12 ( V_47 ) ;
...
static int F_13 ( struct V_15 * V_16 , T_4 * V_49 )
{
struct V_1 * V_2 = V_16 -> V_19 ;
T_1 V_29 [ 2 ] ;
T_1 V_41 [ 3 ] ;
...
V_2 -> V_49 = F_11 ( V_29 [ 0 ] , 89599047 ) ;
* V_49 = ( V_2 -> V_49 ) >> 16 ;
F_6 ( L_23 , V_50 , V_29 [ 0 ] ,
V_2 -> V_49 >> 24 , ( ( ( V_2 -> V_49 >> 8 ) & 0xffff ) * 100 ) >> 16 ) ;
return 0 ;
}
static int F_14 ( struct V_15 * V_16 , T_4 * V_51 )
{
struct V_1 * V_2 = (struct V_1 * ) V_16 -> V_19 ;
T_4 V_49 ;
int V_52 ;
V_52 = V_16 -> V_36 . V_53 ( V_16 , & V_49 ) ;
if ( V_52 != 0 )
return V_52 ;
if ( V_2 -> V_49 >= 8960 * 0x10000 )
* V_51 = 0xffff ;
else
* V_51 = V_2 -> V_49 / 8960 ;
return 0 ;
}
static int F_15 ( struct V_15 * V_16 , T_3 * V_54 )
{
* V_54 = - V_55 ;
return 0 ;
}
static int F_16 ( struct V_15 * V_16 , T_3 * V_56 )
{
* V_56 = - V_55 ;
return 0 ;
}
...
{
struct V_1 * V_2 = V_16 -> V_19 ;
const struct V_57 * V_24 = V_2 -> V_24 ;
const struct V_17 * V_18 ;
...
struct V_15 * F_23 ( const struct V_57 * V_24 ,
struct V_69 * V_11 )
{
struct V_1 * V_2 = NULL ;
...
V_2 -> V_59 = 0 ;
V_2 -> V_34 = 0 ;
memcpy ( & V_2 -> V_71 . V_36 , & V_72 , sizeof( struct V_73 ) ) ;
V_2 -> V_71 . V_19 = V_2 ;
return & V_2 -> V_71 ;
}
