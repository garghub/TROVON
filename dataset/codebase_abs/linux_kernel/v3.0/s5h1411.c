...
{
struct V_1 * V_2 = V_19 -> V_20 ;
F_6 ( L_14 , V_14 , V_46 -> V_47 ) ;
F_5 ( V_19 ) ;
V_2 -> V_48 = V_46 -> V_47 ;
F_11 ( V_19 , V_46 -> V_49 . V_50 . V_51 ) ;
if ( V_19 -> V_52 . V_53 . V_54 ) {
if ( V_19 -> V_52 . V_55 )
V_19 -> V_52 . V_55 ( V_19 , 1 ) ;
V_19 -> V_52 . V_53 . V_54 ( V_19 , V_46 ) ;
if ( V_19 -> V_52 . V_55 )
...
V_2 -> V_36 = V_37 ;
V_2 -> V_35 = 1 ;
if ( V_2 -> V_38 -> V_58 == V_59 )
F_10 ( V_19 , 1 ) ;
else
F_10 ( V_19 , 0 ) ;
F_9 ( V_19 , V_2 -> V_38 -> V_32 ) ;
F_7 ( V_19 , V_2 -> V_38 -> V_39 ) ;
F_13 ( V_19 , V_2 -> V_38 -> V_60 ) ;
F_8 ( V_19 , V_2 -> V_38 -> V_61 ) ;
F_5 ( V_19 ) ;
F_12 ( V_19 , 0 ) ;
return 0 ;
}
static int F_20 ( struct V_18 * V_19 , T_4 * V_62 )
{
struct V_1 * V_2 = V_19 -> V_20 ;
T_2 V_4 ;
T_5 V_63 = 0 ;
...
switch ( V_2 -> V_38 -> V_69 ) {
case V_70 :
if ( * V_62 & V_66 )
* V_62 |= V_67 | V_68 ;
break;
case V_71 :
if ( V_19 -> V_52 . V_53 . V_72 ) {
if ( V_19 -> V_52 . V_55 )
V_19 -> V_52 . V_55 ( V_19 , 1 ) ;
V_19 -> V_52 . V_53 . V_72 ( V_19 , & V_63 ) ;
if ( V_19 -> V_52 . V_55 )
V_19 -> V_52 . V_55 ( V_19 , 0 ) ;
}
if ( V_63 )
...
static int F_21 ( struct V_18 * V_19 , T_2 * V_73 , T_2 V_74 )
{
int V_56 , V_6 = - V_31 ;
F_6 ( L_4 , V_14 ) ;
for ( V_56 = 0 ; V_56 < F_19 ( V_75 ) ; V_56 ++ ) {
if ( V_74 < V_75 [ V_56 ] . V_26 ) {
* V_73 = V_75 [ V_56 ] . V_5 ;
V_6 = 0 ;
break;
}
...
static int F_22 ( struct V_18 * V_19 , T_2 * V_73 , T_2 V_74 )
{
int V_56 , V_6 = - V_31 ;
F_6 ( L_4 , V_14 ) ;
for ( V_56 = 0 ; V_56 < F_19 ( V_76 ) ; V_56 ++ ) {
if ( V_74 < V_76 [ V_56 ] . V_26 ) {
* V_73 = V_76 [ V_56 ] . V_5 ;
V_6 = 0 ;
break;
}
...
static int F_23 ( struct V_18 * V_19 , T_2 * V_73 , T_2 V_74 )
{
int V_56 , V_6 = - V_31 ;
F_6 ( L_4 , V_14 ) ;
for ( V_56 = 0 ; V_56 < F_19 ( V_77 ) ; V_56 ++ ) {
if ( V_74 > V_77 [ V_56 ] . V_26 ) {
* V_73 = V_77 [ V_56 ] . V_5 ;
V_6 = 0 ;
break;
}
...
static int F_24 ( struct V_18 * V_19 , T_2 * V_73 )
{
struct V_1 * V_2 = V_19 -> V_20 ;
T_2 V_4 ;
F_6 ( L_4 , V_14 ) ;
...
return F_22 ( V_19 , V_73 , V_4 ) ;
case V_41 :
V_4 = F_4 ( V_2 , V_21 , 0xf1 ) ;
return F_21 ( V_19 , V_73 , V_4 ) ;
case V_37 :
V_4 = F_4 ( V_2 , V_21 ,
0xf2 ) & 0x3ff ;
return F_23 ( V_19 , V_73 , V_4 ) ;
default:
break;
}
return - V_31 ;
