...
F_75 ( V_16 ) ;
F_76 ( V_2 -> V_53 ) ;
V_97 = F_77 ( V_147 , V_163 , V_2 , & V_156 ) ;
if ( V_97 < 0 )
goto V_159;
F_78 ( V_147 , & V_16 -> V_164 ) ;
* V_154 = V_2 ;
return 0 ;
V_159:
F_56 ( V_2 ) ;
...
V_166 = F_80 ( V_167 , V_16 ) ;
if ( V_166 && V_166 -> V_168 > 0 )
return V_166 -> V_168 ;
for ( V_10 = 0 ; V_10 < F_81 ( V_169 ) ; ++ V_10 )
if ( V_169 [ V_10 ] . V_170 == V_16 -> V_171 &&
V_169 [ V_10 ] . V_172 == V_16 -> V_173 ) {
F_82 ( V_174 L_15 ,
V_16 -> V_101 , V_16 -> V_171 , V_16 -> V_173 ) ;
return - V_99 ;
}
F_16 ( V_174 L_16 ,
V_16 -> V_101 , V_16 -> V_171 , V_16 -> V_173 ) ;
...
V_97 = F_84 ( V_184 [ V_164 ] , V_185 [ V_164 ] , V_186 , 0 , & V_147 ) ;
if ( V_97 < 0 )
return V_97 ;
V_97 = F_68 ( V_147 , V_16 , & V_2 ) ;
if ( V_97 < 0 )
goto V_103;
memcpy ( & V_2 -> V_78 , & V_187 [ V_179 ] , sizeof( V_2 -> V_78 ) ) ;
if ( ! V_2 -> V_78 . V_188 ) {
if ( V_189 [ V_164 ] > 0 )
V_2 -> V_78 . V_79 = V_189 [ V_164 ] ;
V_2 -> V_64 |= V_2 -> V_78 . V_190 ;
V_97 = F_63 ( V_2 , V_102 , L_20 ) ;
if ( V_97 < 0 )
goto V_103;
}
if ( ! V_2 -> V_78 . V_191 ) {
V_97 = F_63 ( V_2 , V_192 , L_21 ) ;
if ( V_97 < 0 )
goto V_103;
...
F_16 ( V_174 L_22
L_23 , V_164 , V_179 ,
V_2 -> V_78 . V_191 ? L_24 : L_25 ,
V_2 -> V_78 . V_188 ? L_24 : L_25 , V_2 -> V_78 . V_79 ) ;
strcpy ( V_147 -> V_196 , L_26 ) ;
sprintf ( V_147 -> V_197 , L_27 , V_16 -> V_101 ) ;
sprintf ( V_147 -> V_198 , L_28 ,
V_147 -> V_197 , ( unsigned long long ) F_87 ( V_16 , 0 ) ,
V_2 -> V_53 ) ;
strcpy ( V_147 -> V_199 , L_26 ) ;
V_97 = F_88 ( V_147 ) ;
if ( V_97 < 0 )
goto V_103;
F_89 ( V_16 , V_147 ) ;
