...
V_62 += V_59 ;
F_32 ( V_43 , F_18 ( V_43 , V_40 ) ,
F_18 ( V_43 , V_40 ) + V_59 ) ;
}
}
}
static void T_5 F_33 ( T_2 V_43 )
{
...
T_7 V_69 , V_70 ;
F_35 ( V_43 , & V_69 , & V_70 ) ;
V_71 [ V_43 ] = F_36 ( V_67 << V_48 ) ;
F_37 ( V_43 ) -> V_72 = & V_73 [ V_43 ] ;
F_37 ( V_43 ) -> V_74 = V_69 ;
F_37 ( V_43 ) -> V_75 = V_70 - V_69 ;
F_38 ( F_39 ( V_43 ) -> V_76 ) ;
V_67 += F_40 ( sizeof( struct V_77 ) +
sizeof( struct F_39 ) ) ;
V_68 = F_41 ( F_37 ( V_43 ) , V_67 ,
V_69 , V_70 ) ;
F_42 ( V_43 , V_70 ) ;
F_43 ( F_37 ( V_43 ) , V_66 << V_48 ,
( ( V_67 - V_66 ) << V_48 ) + V_68 ,
V_78 ) ;
F_44 ( V_43 ) ;
}
