...
V_2 -> V_153 = V_100 | V_102 | V_97 ;
if ( V_146 -> V_154 != - 1 )
V_2 -> V_30 = V_146 -> V_154 ;
V_2 -> V_155 = F_47 ;
V_2 -> V_156 = F_60 ;
V_2 -> V_157 = F_50 ;
V_2 -> V_113 = V_148 -> V_158 ;
F_71 ( & V_146 -> V_35 , V_2 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_2 = V_2 ;
V_151 = F_72 ( V_146 , V_159 , 0 ) ;
if ( V_151 == NULL ) {
V_123 = - V_160 ;
goto V_161;
}
if ( ! F_73 ( V_151 -> V_162 , ( V_151 -> V_163 - V_151 -> V_162 ) + 1 ,
F_74 ( & V_146 -> V_35 ) ) ) {
V_123 = - V_164 ;
goto V_161;
}
V_151 -> V_162 += V_148 -> V_165 ;
V_151 -> V_163 += V_148 -> V_165 ;
V_6 -> V_59 = V_151 -> V_162 ;
V_6 -> V_7 = F_75 ( V_151 -> V_162 , V_151 -> V_163 - V_151 -> V_162 + 1 ) ;
if ( ! V_6 -> V_7 ) {
F_39 ( & V_146 -> V_35 , L_29 ) ;
V_123 = - V_111 ;
goto V_166;
}
V_6 -> V_35 = & V_146 -> V_35 ;
...
F_77 ( & V_6 -> V_116 ) ;
F_78 ( & V_6 -> V_117 ) ;
F_78 ( & V_29 [ V_2 -> V_30 - 1 ] . V_11 ) ;
V_6 -> V_55 = F_79 ( V_2 -> V_113 ,
sizeof( struct V_42 ) ,
V_110 ) ;
if ( V_6 -> V_55 == NULL )
goto V_166;
...
char V_167 [ 14 ] ;
struct V_150 * V_168 ;
sprintf ( V_167 , L_30 , V_152 ) ;
V_168 = F_80 ( V_146 , V_169 ,
V_167 ) ;
if ( ! V_168 ) {
...
V_6 -> V_55 [ V_152 ] . V_75 = V_168 -> V_162 ;
sprintf ( V_167 , L_32 , V_152 ) ;
V_168 = F_80 ( V_146 , V_169 ,
V_167 ) ;
if ( ! V_168 ) {
...
V_6 -> V_55 [ V_152 ] . V_69 = V_168 -> V_162 ;
}
F_81 ( & V_146 -> V_35 ) ;
if ( V_123 || F_66 ( V_6 ) < 0 )
goto V_170;
...
F_52 ( V_6 -> V_55 ) ;
V_166:
F_84 ( V_151 -> V_162 , ( V_151 -> V_163 - V_151 -> V_162 ) + 1 ) ;
F_85 ( V_6 -> V_7 ) ;
V_161:
return V_123 ;
}
static int T_5 F_86 ( struct V_145 * V_146 )
{
struct V_1 * V_2 ;
struct V_5 * V_6 ;
struct V_42 * V_55 ;
...
static int F_88 ( struct V_144 * V_35 )
{
