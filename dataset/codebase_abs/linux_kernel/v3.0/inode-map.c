...
F_26 ( V_80 ) ;
V_80 = true ;
V_17 = F_48 ( V_3 , V_76 , V_12 ) ;
if ( V_17 )
goto V_29;
goto V_27;
}
F_49 ( V_77 ) -> V_85 = 0 ;
V_17 = F_50 ( V_76 , V_3 , V_77 ) ;
F_11 ( V_17 ) ;
if ( F_51 ( V_77 ) > 0 ) {
V_17 = F_52 ( V_3 , V_76 , V_12 , V_77 ) ;
if ( V_17 )
goto V_86;
}
F_18 ( & V_3 -> V_36 ) ;
...
F_19 ( & V_3 -> V_36 ) ;
F_18 ( & V_7 -> V_68 ) ;
V_79 = sizeof( struct V_52 ) * V_7 -> V_67 ;
V_79 = F_38 ( V_79 , V_66 ) ;
V_79 += V_7 -> V_65 * V_66 ;
F_19 ( & V_7 -> V_68 ) ;
V_79 += 8 * V_66 ;
...
V_29:
if ( V_17 == 0 )
V_17 = F_57 ( V_3 , V_76 , V_12 ) ;
F_21 ( V_12 ) ;
return V_17 ;
}
static int F_58 ( struct V_2 * V_3 , T_1 * V_23 )
{
struct V_11 * V_12 ;
int V_17 ;
struct V_13 * V_87 ;
...
V_88 . type = - 1 ;
V_88 . V_25 = ( T_1 ) - 1 ;
V_17 = F_5 ( NULL , V_3 , & V_88 , V_12 , 0 , 0 ) ;
if ( V_17 < 0 )
goto error;
F_26 ( V_17 == 0 ) ;
if ( V_12 -> V_31 [ 0 ] > 0 ) {
...
int V_17 ;
F_4 ( & V_3 -> V_90 ) ;
if ( F_60 ( V_3 -> V_34 < V_24 ) ) {
V_17 = F_58 ( V_3 ,
& V_3 -> V_34 ) ;
if ( V_17 )
goto V_29;
}
if ( F_60 ( V_3 -> V_34 >= V_43 ) ) {
V_17 = - V_46 ;
goto V_29;
}
* V_23 = ++ V_3 -> V_34 ;
