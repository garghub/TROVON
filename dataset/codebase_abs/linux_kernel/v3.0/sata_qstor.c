...
{
static int V_131 ;
unsigned int V_132 = ( unsigned int ) V_130 -> V_133 ;
const struct V_134 * V_135 [] = { & V_136 [ V_132 ] , NULL } ;
struct V_1 * V_2 ;
int V_125 , V_10 ;
if ( ! V_131 ++ )
F_59 ( V_137 , & V_122 -> V_104 , L_10 V_138 L_11 ) ;
V_2 = F_61 ( & V_122 -> V_104 , V_135 , V_139 ) ;
if ( ! V_2 )
return - V_106 ;
V_125 = F_62 ( V_122 ) ;
if ( V_125 )
return V_125 ;
if ( ( F_63 ( V_122 , V_4 ) & V_140 ) == 0 )
return - V_141 ;
V_125 = F_64 ( V_122 , 1 << V_4 , V_142 ) ;
if ( V_125 )
return V_125 ;
V_2 -> V_3 = F_65 ( V_122 ) ;
...
for ( V_10 = 0 ; V_10 < V_2 -> V_83 ; ++ V_10 ) {
struct V_7 * V_8 = V_2 -> V_80 [ V_10 ] ;
unsigned int V_143 = V_10 * 0x4000 ;
void T_1 * V_9 = V_2 -> V_3 [ V_4 ] + V_143 ;
F_48 ( & V_8 -> V_29 , V_9 ) ;
F_66 ( V_8 , V_4 , - 1 , L_12 ) ;
F_66 ( V_8 , V_4 , V_143 , L_13 ) ;
}
F_53 ( V_2 , V_132 ) ;
F_67 ( V_122 ) ;
return F_68 ( V_2 , V_122 -> V_84 , F_44 , V_144 ,
& V_145 ) ;
}
