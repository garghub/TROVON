...
if ( V_9 -> V_16 + V_9 -> V_18 > V_11 -> V_9 . V_5 ||
V_9 -> V_17 + V_9 -> V_19 > V_11 -> V_9 . V_20 )
return - V_22 ;
}
...
static int T_7 F_20 ( struct V_58 * V_59 )
{
struct V_10 * V_11 ;
int V_60 = - V_24 ;
if ( ! ( V_61 = F_1 ( V_23 ) ) )
return V_60 ;
memset ( V_61 , 0 , V_23 ) ;
V_11 = F_21 ( sizeof( T_5 ) * 256 , & V_59 -> V_59 ) ;
if ( ! V_11 )
goto V_62;
V_11 -> V_63 = ( char V_64 * ) V_61 ;
V_11 -> V_65 = & V_66 ;
V_60 = F_22 ( & V_11 -> V_9 , V_11 , NULL ,
NULL , 0 , NULL , 8 ) ;
if ( ! V_60 || ( V_60 == 4 ) )
V_11 -> V_9 = V_67 ;
V_68 . V_50 = ( unsigned long ) V_61 ;
V_68 . V_49 = V_23 ;
V_11 -> V_31 = V_68 ;
V_11 -> V_39 = V_11 -> V_69 ;
V_11 -> V_69 = NULL ;
V_11 -> V_70 = V_71 ;
V_60 = F_23 ( & V_11 -> V_72 , 256 , 0 ) ;
if ( V_60 < 0 )
goto V_73;
V_60 = F_24 ( V_11 ) ;
if ( V_60 < 0 )
