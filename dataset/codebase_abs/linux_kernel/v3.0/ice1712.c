...
F_6 ( ( ( V_2 -> V_226 . V_8 [ V_238 ] & V_371 ) == 0 ?
V_68 : 0 ) |
( ( V_2 -> V_226 . V_8 [ V_238 ] & V_326 ) ?
V_77 | V_82 | V_84 : 0 ) ,
F_12 ( V_2 , V_346 ) ) ;
F_6 ( 0x00 , F_3 ( V_2 , V_71 ) ) ;
V_46 = F_195 ( V_148 , V_372 , V_2 , & V_51 ) ;
if ( V_46 < 0 ) {
F_174 ( V_2 ) ;
return V_46 ;
}
...
V_46 = F_198 ( V_192 [ V_289 ] , V_198 [ V_289 ] , V_380 , 0 , & V_148 ) ;
if ( V_46 < 0 )
return V_46 ;
strcpy ( V_148 -> V_381 , L_70 ) ;
strcpy ( V_148 -> V_382 , L_72 ) ;
...
strcpy ( V_148 -> V_382 , V_300 -> V_154 ) ;
if ( V_300 -> V_381 )
strcpy ( V_148 -> V_381 , V_300 -> V_381 ) ;
if ( V_300 -> V_383 ) {
V_46 = V_300 -> V_383 ( V_2 ) ;
if ( V_46 < 0 ) {
F_199 ( V_148 ) ;
return V_46 ;
}
...
L_73 , V_300 -> V_392 , V_148 -> V_97 ) ;
if ( V_2 -> V_226 . V_8 [ V_238 ] & V_371 ) {
V_46 = F_200 ( V_148 , 1 , V_388 ,
F_12 ( V_2 , V_393 ) ,
( V_300 -> V_394 | V_391 ) ,
...
V_148 -> V_382 , V_2 -> V_344 , V_2 -> V_60 ) ;
V_46 = F_201 ( V_148 ) ;
if ( V_46 < 0 ) {
F_199 ( V_148 ) ;
return V_46 ;
