...
if ( ! V_14 -> V_17 ) {
V_14 -> V_17 = 1 ;
F_16 ( V_29 , V_30 , V_37 / 8 , V_21 , V_22 ) ;
V_21 &= V_38 ;
...
F_16 ( V_29 , V_30 , V_37 / 8 , V_21 , V_22 ) ;
V_21 &= V_38 ;
F_17 ( V_33 , V_34 , V_35 , V_36 , V_21 , V_22 ) ;
V_29 += ( V_37 / sizeof( T_1 ) ) ;
}
V_14 -> V_15 [ 0 ] = V_33 ;
V_14 -> V_15 [ 1 ] = V_34 ;
}
static T_1 F_18 ( unsigned char V_27 [] , unsigned int V_28 ,
...
F_16 ( V_29 , V_30 , V_37 / 8 , V_33 , V_34 ) ;
V_33 &= V_38 ;
F_13 ( V_33 , V_34 , V_35 , V_36 ) ;
V_29 += ( V_37 / sizeof( T_1 ) ) ;
V_32 -- ;
} else if ( V_40 ) {
F_19 ( V_29 , V_30 , 2 * ( ( V_40 + 15 ) / 16 ) , V_33 , V_34 ) ;
V_33 &= V_38 ;
F_13 ( V_33 , V_34 , V_35 , V_36 ) ;
V_29 += ( V_37 / sizeof( T_1 ) ) ;
goto V_41;
...
if ( V_40 ) {
F_19 ( V_29 , V_30 , 2 * ( ( V_40 + 15 ) / 16 ) , V_21 , V_22 ) ;
V_21 &= V_38 ;
F_17 ( V_33 , V_34 , V_35 , V_36 , V_21 , V_22 ) ;
}
V_41:
...
static T_1 F_20 ( unsigned char V_27 [] , unsigned int V_28 ,
unsigned char V_43 [ 16 ] , T_1 * V_39 ,
struct V_44 * V_14 )
{
T_1 * V_45 , * V_46 ;
T_1 V_7 , V_47 ;
...
V_7 = F_22 ( V_46 + V_32 ) ;
V_47 = F_18 ( V_27 , V_28 , ( T_1 * ) 0 , & V_14 -> V_48 ) ;
return F_23 ( V_7 + V_47 ) ;
}
static int F_24 ( unsigned char V_52 [] , struct V_44 * V_14 )
{
T_1 V_53 [ 2 ] = { 0 } , V_54 [ 2 ] ;
unsigned V_32 ;
int V_55 = 0 ;
V_55 = F_25 ( V_14 -> V_51 , V_52 , V_56 ) ;
if ( V_55 )
return V_55 ;
...
V_14 -> V_48 . V_31 [ V_32 ] = F_22 ( V_54 ) ;
V_14 -> V_48 . V_31 [ V_32 + 1 ] = F_22 ( V_54 + 1 ) ;
...
F_21 ( V_14 -> V_51 ,
( unsigned char * ) V_54 , ( unsigned char * ) V_53 ) ;
V_14 -> V_48 . V_42 [ V_32 ] = F_22 ( V_54 ) ;
V_14 -> V_48 . V_42 [ V_32 + 1 ] = F_22 ( V_54 + 1 ) ;
( ( unsigned char * ) V_53 ) [ 15 ] += 1 ;
...
{
struct V_44 * V_14 = F_27 ( V_59 ) ;
if ( V_61 != V_56 ) {
F_28 ( V_59 , V_62 ) ;
return - V_63 ;
}
return F_24 ( ( T_3 * ) V_60 , V_14 ) ;
}
static int F_29 ( struct V_64 * V_65 )
{
return 0 ;
}
static int F_30 ( struct V_64 * V_65 , const T_3 * V_7 ,
unsigned int V_20 )
{
struct V_58 * V_59 = V_65 -> V_66 ;
struct V_44 * V_14 = F_27 ( V_59 ) ;
F_15 ( V_7 , V_20 , & V_14 -> V_48 ) ;
return 0 ;
}
static int F_31 ( struct V_64 * V_65 , T_3 * V_54 )
{
struct V_58 * V_59 = V_65 -> V_66 ;
struct V_44 * V_14 = F_27 ( V_59 ) ;
T_4 V_67 ;
T_3 V_68 [ 16 ] = {} ;
V_67 = F_20 ( NULL , 0 , V_68 , NULL , V_14 ) ;
memcpy ( V_54 , & V_67 , sizeof( T_4 ) ) ;
memset ( & V_67 , 0 , sizeof( T_4 ) ) ;
memset ( & V_14 -> V_48 , 0 , sizeof( struct V_13 ) ) ;
return 0 ;
}
static int F_32 ( struct V_69 * V_66 )
{
struct V_70 * V_71 ;
struct V_72 * V_73 = ( void * ) V_66 -> V_74 ;
struct V_75 * V_76 = F_33 ( V_73 ) ;
struct V_44 * V_14 = F_34 ( V_66 ) ;
V_71 = F_35 ( V_76 ) ;
if ( F_36 ( V_71 ) )
return F_37 ( V_71 ) ;
V_14 -> V_51 = V_71 ;
...
static void F_38 ( struct V_69 * V_66 )
{
struct V_44 * V_14 = F_34 ( V_66 ) ;
F_39 ( V_14 -> V_51 ) ;
}
static int F_40 ( struct V_77 * V_78 , struct V_79 * * V_80 )
{
struct V_81 * V_73 ;
struct V_82 * V_83 ;
int V_55 ;
...
if ( F_36 ( V_73 ) )
goto V_87;
V_55 = F_44 ( F_45 ( V_73 ) , V_83 ,
F_46 ( V_73 ) ,
V_86 ) ;
if ( V_55 )
goto V_88;
V_73 -> V_83 . V_89 . V_90 = V_83 -> V_90 ;
V_73 -> V_83 . V_89 . V_91 = V_83 -> V_91 ;
V_73 -> V_83 . V_89 . V_92 = V_83 -> V_92 ;
V_73 -> V_83 . V_93 = sizeof( T_4 ) ;
V_73 -> V_83 . V_89 . V_94 = sizeof( struct V_44 ) ;
V_73 -> V_83 . V_89 . V_95 = F_32 ;
V_73 -> V_83 . V_89 . V_96 = F_38 ;
V_73 -> V_83 . V_97 = F_29 ;
V_73 -> V_83 . V_98 = F_30 ;
V_73 -> V_83 . V_99 = F_31 ;
V_73 -> V_83 . V_100 = F_26 ;
V_55 = F_47 ( V_78 , V_73 ) ;
if ( V_55 ) {
V_88:
F_48 ( F_46 ( V_73 ) ) ;
