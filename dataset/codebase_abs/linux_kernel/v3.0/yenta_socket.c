...
if ( V_232 -> V_183 >= V_228 -> V_183 )
return;
if ( ! V_232 -> V_181 )
return;
V_231 = V_232 -> V_181 -> V_183 ;
F_84 (tmp, &bridge_to_fix->parent->children) {
struct V_227 * V_233 = F_85 ( V_230 ) ;
if ( V_233 -> V_220 > V_232 -> V_183
&& V_233 -> V_220 <= V_231 )
V_231 = V_233 -> V_220 - 1 ;
}
if ( V_228 -> V_183 > V_231 )
F_59 ( V_205 , & V_228 -> V_7 ,
L_16
L_17 , V_231 ) ;
if ( V_232 -> V_183 < V_231 ) {
unsigned char V_234 =
V_165 ( V_228 -> V_183 , V_231 ) ;
...
static int T_8 F_86 ( struct V_13 * V_7 , const struct V_238 * V_239 )
{
struct V_1 * V_2 ;
int V_240 ;
if ( ! V_7 -> V_183 ) {
...
V_2 = F_87 ( sizeof( struct V_1 ) , V_243 ) ;
if ( ! V_2 )
return - V_244 ;
V_2 -> V_2 . V_245 = & V_246 ;
V_2 -> V_2 . V_247 = & V_248 ;
...
static int F_97 ( struct V_8 * V_7 )
{
...
static int F_99 ( struct V_8 * V_7 )
{
struct V_13 * V_270 = F_25 ( V_7 ) ;
struct V_1 * V_2 = F_26 ( V_270 ) ;
int V_240 ;
