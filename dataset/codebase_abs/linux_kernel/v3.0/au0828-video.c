...
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
V_208 -> V_178 . V_179 . V_79 = V_2 -> V_79 ;
V_208 -> V_178 . V_179 . V_106 = V_2 -> V_106 ;
V_208 -> V_178 . V_179 . V_180 = V_181 ;
V_208 -> V_178 . V_179 . V_78 = V_2 -> V_78 ;
V_208 -> V_178 . V_179 . V_182 = V_2 -> V_155 ;
V_208 -> V_178 . V_179 . V_183 = V_184 ;
V_208 -> V_178 . V_179 . V_112 = V_161 ;
return 0 ;
}
...
V_26 = F_85 ( V_2 , V_212 , V_208 ) ;
V_211:
F_59 ( & V_2 -> V_135 ) ;
return V_26 ;
}
static int F_94 ( struct V_144 * V_144 , void * V_187 , T_6 * V_213 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
F_76 ( & V_2 -> V_165 , 0 , V_166 , V_214 , * V_213 ) ;
return 0 ;
}
...
if ( V_217 >= V_226 )
return - V_116 ;
if ( F_96 ( V_217 ) . type == 0 )
return - V_116 ;
V_216 -> V_209 = V_217 ;
strcpy ( V_216 -> V_196 , V_218 [ F_96 ( V_217 ) . type ] ) ;
if ( ( F_96 ( V_217 ) . type == V_223 ) ||
( F_96 ( V_217 ) . type == V_222 ) )
V_216 -> type |= V_227 ;
else
V_216 -> type |= V_228 ;
V_216 -> V_229 = V_2 -> V_131 -> V_230 ;
return 0 ;
}
...
static int F_98 ( struct V_144 * V_144 , void * V_187 , unsigned int V_209 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
int V_27 ;
...
if ( V_209 >= V_226 )
return - V_116 ;
if ( F_96 ( V_209 ) . type == 0 )
return - V_116 ;
V_2 -> V_231 = V_209 ;
switch ( F_96 ( V_209 ) . type ) {
case V_221 :
V_2 -> V_232 = V_221 ;
break;
case V_220 :
...
F_76 ( & V_2 -> V_165 , 0 , V_233 , V_234 ,
F_96 ( V_209 ) . V_235 , 0 , 0 ) ;
for ( V_27 = 0 ; V_27 < V_226 ; V_27 ++ ) {
int V_236 = 0 ;
if ( F_96 ( V_27 ) . V_237 == NULL )
continue;
if ( V_27 == V_209 )
V_236 = 1 ;
else
...
F_76 ( & V_2 -> V_165 , 0 , V_238 , V_234 ,
F_96 ( V_209 ) . V_239 , 0 , 0 ) ;
return 0 ;
}
static int F_99 ( struct V_144 * V_144 , void * V_187 , struct V_240 * V_241 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
unsigned int V_209 = V_241 -> V_209 ;
if ( V_241 -> V_209 > 1 )
return - V_116 ;
V_209 = V_2 -> V_242 ;
if ( V_209 == 0 )
strcpy ( V_241 -> V_196 , L_62 ) ;
else
strcpy ( V_241 -> V_196 , L_67 ) ;
V_241 -> V_243 = V_244 ;
V_241 -> V_209 = V_209 ;
return 0 ;
}
static int F_100 ( struct V_144 * V_144 , void * V_187 , struct V_240 * V_241 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
if ( V_241 -> V_209 != V_2 -> V_242 )
return - V_116 ;
return 0 ;
}
...
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
F_76 ( & V_2 -> V_165 , 0 , V_166 , V_247 , V_246 ) ;
return 0 ;
}
...
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
F_76 ( & V_2 -> V_165 , 0 , V_166 , V_248 , V_246 ) ;
return 0 ;
}
static int F_103 ( struct V_144 * V_144 , void * V_187 , struct V_249 * V_250 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
if ( V_250 -> V_209 != 0 )
return - V_116 ;
strcpy ( V_250 -> V_196 , L_68 ) ;
F_76 ( & V_2 -> V_165 , 0 , V_251 , V_252 , V_250 ) ;
return 0 ;
}
...
return - V_116 ;
V_250 -> type = V_253 ;
F_76 ( & V_2 -> V_165 , 0 , V_251 , V_254 , V_250 ) ;
F_51 ( 1 , L_69 , V_250 -> signal ,
V_250 -> V_255 ) ;
return 0 ;
}
...
if ( V_257 -> type != V_253 )
return - V_116 ;
V_2 -> V_259 = V_257 -> V_258 ;
F_76 ( & V_2 -> V_165 , 0 , V_251 , V_260 , V_257 ) ;
F_53 ( V_2 ) ;
return 0 ;
}
...
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
V_177 -> V_178 . V_261 . V_262 = V_2 -> V_86 ;
V_177 -> V_178 . V_261 . V_263 = V_264 ;
V_177 -> V_178 . V_261 . V_56 = 0 ;
V_177 -> V_178 . V_261 . V_25 = 0 ;
V_177 -> V_178 . V_261 . V_265 = 6750000 * 4 / 2 ;
V_177 -> V_178 . V_261 . V_102 [ 0 ] = V_2 -> V_87 ;
V_177 -> V_178 . V_261 . V_102 [ 1 ] = V_2 -> V_87 ;
V_177 -> V_178 . V_261 . V_266 [ 0 ] = 21 ;
V_177 -> V_178 . V_261 . V_266 [ 1 ] = 284 ;
return 0 ;
}
...
V_268 -> V_269 = V_270 ;
V_268 -> V_271 = 0 ;
if ( F_109 ( & V_268 -> V_272 ) ) {
V_268 -> V_269 = V_273 ;
return 0 ;
}
F_76 ( & V_2 -> V_165 , 0 , V_166 , V_274 , V_268 ) ;
...
V_276 -> V_277 . V_278 = 0 ;
V_276 -> V_277 . V_279 = 0 ;
V_276 -> V_277 . V_79 = V_2 -> V_79 ;
V_276 -> V_277 . V_106 = V_2 -> V_106 ;
V_276 -> V_280 = V_276 -> V_277 ;
V_276 -> V_281 . V_282 = 54 ;
V_276 -> V_281 . V_283 = 59 ;
return 0 ;
}
...
if ( type == V_137 ) {
F_50 ( V_2 ) ;
F_76 ( & V_2 -> V_165 , 0 , V_233 , V_285 , 1 ) ;
}
if ( V_104 -> type == V_137 ) {
...
V_2 -> V_93 = 0 ;
F_74 ( & V_2 -> V_94 ) ;
F_76 ( & V_2 -> V_165 , 0 , V_233 , V_285 , 0 ) ;
V_26 = F_55 ( V_2 ) ;
if ( V_26 != 0 )
return V_26 ;
for ( V_27 = 0 ; V_27 < V_226 ; V_27 ++ ) {
...
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
switch ( V_287 -> V_272 . type ) {
case V_288 :
F_76 ( & V_2 -> V_165 , 0 , V_166 , V_289 , V_287 ) ;
return 0 ;
default:
return - V_116 ;
}
...
switch ( V_287 -> V_272 . type ) {
case V_288 :
F_76 ( & V_2 -> V_165 , 0 , V_166 , V_290 , V_287 ) ;
return 0 ;
default:
return - V_116 ;
}
...
return V_26 ;
if ( V_104 -> type == V_137 )
V_26 = F_119 ( & V_104 -> V_159 , V_292 ) ;
else if ( V_104 -> type == V_139 )
V_26 = F_119 ( & V_104 -> V_162 , V_292 ) ;
return V_26 ;
}
...
return V_26 ;
if ( V_104 -> type == V_137 )
V_26 = F_121 ( & V_104 -> V_159 , V_294 ) ;
else if ( V_104 -> type == V_139 )
V_26 = F_121 ( & V_104 -> V_162 , V_294 ) ;
return V_26 ;
}
static int F_122 ( struct V_144 * V_144 , void * V_187 , struct V_293 * V_294 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
int V_26 ;
...
return V_26 ;
if ( V_104 -> type == V_137 )
V_26 = F_123 ( & V_104 -> V_159 , V_294 ) ;
else if ( V_104 -> type == V_139 )
V_26 = F_123 ( & V_104 -> V_162 , V_294 ) ;
return V_26 ;
}
static int F_124 ( struct V_144 * V_144 , void * V_187 , struct V_293 * V_294 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
int V_26 ;
...
if ( V_104 -> type == V_137 )
V_26 = F_125 ( & V_104 -> V_159 , V_294 , V_144 -> V_169 & V_170 ) ;
else if ( V_104 -> type == V_139 )
V_26 = F_125 ( & V_104 -> V_162 , V_294 , V_144 -> V_169 & V_170 ) ;
return V_26 ;
}
...
F_51 ( 1 , L_73 ) ;
V_297 = F_71 ( V_2 -> V_40 ,
V_296 -> V_302 -> V_303 . V_304 , 5 ) ;
if ( V_297 != 0 ) {
F_4 ( V_16 L_74 ) ;
return V_297 ;
}
V_299 = V_296 -> V_302 ;
for ( V_27 = 0 ; V_27 < V_299 -> V_303 . V_305 ; V_27 ++ ) {
V_301 = & V_299 -> V_301 [ V_27 ] . V_303 ;
if ( ( ( V_301 -> V_306 & V_307 )
== V_308 ) &&
( ( V_301 -> V_309 & V_310 )
== V_311 ) ) {
T_7 V_217 = F_127 ( V_301 -> V_312 ) ;
V_2 -> V_44 = ( V_217 & 0x07ff ) *
( ( ( V_217 & 0x1800 ) >> 11 ) + 1 ) ;
V_2 -> V_52 = V_301 -> V_306 ;
}
}
if ( ! ( V_2 -> V_52 ) ) {
F_4 ( V_16 L_75 ) ;
...
F_129 ( & V_2 -> V_135 ) ;
F_130 ( & V_2 -> V_24 . V_84 ) ;
F_130 ( & V_2 -> V_24 . V_313 ) ;
F_130 ( & V_2 -> V_88 . V_84 ) ;
F_130 ( & V_2 -> V_88 . V_313 ) ;
V_2 -> V_94 . V_314 = F_66 ;
...
* V_2 -> V_131 = V_315 ;
V_2 -> V_131 -> V_316 = & V_2 -> V_40 -> V_2 ;
strcpy ( V_2 -> V_131 -> V_196 , L_78 ) ;
* V_2 -> V_132 = V_315 ;
V_2 -> V_132 -> V_316 = & V_2 -> V_40 -> V_2 ;
strcpy ( V_2 -> V_132 -> V_196 , L_79 ) ;
F_133 ( V_2 -> V_131 , V_2 ) ;
V_297 = F_134 ( V_2 -> V_131 , V_148 , - 1 ) ;
if ( V_297 != 0 ) {
F_51 ( 1 , L_80 ,
V_297 ) ;
F_135 ( V_2 -> V_131 ) ;
