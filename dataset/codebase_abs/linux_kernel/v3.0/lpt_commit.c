...
void * V_57 = V_15 -> V_58 ;
F_8 ( L_13 , V_23 ) ;
V_39 = F_64 ( V_15 -> V_103 , V_23 , V_57 , 0 , V_15 -> V_32 ) ;
if ( V_39 ) {
F_14 ( L_14 , V_23 , V_39 ) ;
return V_39 ;
}
...
static struct V_2 * F_75 ( struct V_14 * V_15 , int * V_109 )
{
struct V_2 * V_3 ;
int V_64 , V_4 , V_110 ;
V_3 = V_15 -> V_18 ;
...
struct V_2 * V_3 , int * V_109 )
{
struct V_2 * V_12 ;
int V_13 , V_64 , V_4 , V_110 ;
V_12 = V_3 -> V_12 ;
if ( ! V_12 )
return NULL ;
if ( V_3 -> V_13 == V_6 - 1 ) {
...
for ( V_64 = * V_109 + 1 ; V_64 < V_15 -> V_67 ; V_64 ++ ) {
V_110 = 0 ;
for ( V_4 = 0 ; V_4 < V_6 ; V_4 ++ ) {
if ( V_3 -> V_8 [ V_4 ] . V_3 ) {
V_110 = 1 ;
...
void F_77 ( struct V_14 * V_15 , int V_111 )
{
struct V_2 * V_3 ;
int V_4 , V_109 ;
F_71 ( V_15 ) ;
...
int V_109 ;
V_3 = F_75 ( V_15 , & V_109 ) ;
for (; V_3 ; V_3 = F_76 ( V_15 , V_3 , & V_109 ) ) {
struct V_83 * V_84 ;
F_81 () ;
if ( V_3 -> V_12 ) {
V_84 = & V_3 -> V_12 -> V_8 [ V_3 -> V_13 ] ;
...
if ( ! ( V_118 & V_119 ) )
return 0 ;
V_57 = V_117 = F_88 ( V_15 -> V_32 , V_120 , V_121 ) ;
if ( ! V_57 ) {
F_14 ( L_17 ) ;
return 0 ;
}
...
while ( 1 ) {
if ( ! F_61 ( V_15 , V_117 , V_35 ) ) {
int V_4 , V_92 ;
V_92 = F_58 ( V_15 , V_117 , V_35 ) ;
if ( V_92 ) {
V_117 += V_92 ;
V_35 -= V_92 ;
V_24 += V_92 ;
...
V_86 = F_59 ( V_15 , V_117 , & V_82 ) ;
V_98 = F_57 ( V_15 , V_86 ) ;
V_116 = F_86 ( V_15 , V_86 , V_23 , V_15 -> V_32 - V_35 ) ;
if ( V_116 == 1 )
V_24 += V_98 ;
V_117 += V_98 ;
V_35 -= V_98 ;
...
int F_12 ( struct V_14 * V_15 , int V_122 , int V_35 )
{
struct V_123 * V_124 = V_15 -> V_125 ;
long long V_126 , V_68 ;
int V_39 = 0 ;
if ( ! ( V_118 & V_119 ) )
return 0 ;
switch ( V_122 ) {
...
V_124 -> V_128 = 0 ;
V_124 -> V_129 = 0 ;
if ( V_15 -> V_22 > V_15 -> V_130 ) {
F_15 ( L_27 ,
V_15 -> V_22 , V_15 -> V_130 ) ;
V_39 = - V_91 ;
}
if ( V_15 -> V_21 > V_15 -> V_131 ) {
F_15 ( L_28 ,
V_15 -> V_21 , V_15 -> V_131 ) ;
V_39 = - V_91 ;
}
return V_39 ;
case 1 :
...
V_126 = V_15 -> V_32 ;
V_126 *= V_124 -> V_128 ;
V_126 += V_35 - V_15 -> V_41 ;
if ( V_124 -> V_126 != V_126 ) {
F_15 ( L_29 ,
V_124 -> V_126 , V_126 ) ;
V_39 = - V_91 ;
}
if ( V_124 -> V_126 > V_15 -> V_68 ) {
F_15 ( L_30 ,
V_124 -> V_126 , V_15 -> V_68 ) ;
V_39 = - V_91 ;
}
if ( V_124 -> V_127 && V_124 -> V_126 != V_124 -> V_127 ) {
F_15 ( L_31 ,
V_124 -> V_126 , V_124 -> V_127 ) ;
V_39 = - V_91 ;
}
if ( V_124 -> V_127 && V_124 -> V_132 != V_35 ) {
F_15 ( L_32 ,
V_124 -> V_132 , V_35 ) ;
V_39 = - V_91 ;
}
V_68 = ( long long ) V_15 -> V_130 * V_15 -> V_50 ;
V_68 += ( long long ) V_15 -> V_131 * V_15 -> V_49 ;
V_68 += V_15 -> V_46 ;
if ( V_15 -> V_42 )
V_68 += V_15 -> V_43 ;
if ( V_124 -> V_126 - V_124 -> V_129 > V_68 ) {
F_15 ( L_33 ,
V_124 -> V_126 , V_124 -> V_129 , V_68 ) ;
V_39 = - V_91 ;
}
if ( V_39 ) {
F_16 ( V_15 ) ;
...
F_92 ( V_133 L_41 ,
V_23 , V_34 ) ;
V_39 = F_93 ( V_15 , V_117 , & V_3 ) ;
for ( V_4 = 0 ; V_4 < V_6 ; V_4 ++ ) {
F_92 ( V_136 L_42 , V_3 . V_8 [ V_4 ] . V_23 ,
V_3 . V_8 [ V_4 ] . V_34 ) ;
if ( V_4 != V_6 - 1 )
F_92 ( V_136 L_43 ) ;
}
...
F_50 (lprops, &c->empty_list, list)
V_15 -> V_59 [ F_94 () % V_15 -> V_75 ] = V_70 -> V_23 ;
F_50 (lprops, &c->freeable_list, list)
V_15 -> V_59 [ F_94 () % V_15 -> V_75 ] = V_70 -> V_23 ;
F_50 (lprops, &c->frdi_idx_list, list)
V_15 -> V_59 [ F_94 () % V_15 -> V_75 ] = V_70 -> V_23 ;
V_72 = & V_15 -> V_76 [ V_77 - 1 ] ;
for ( V_4 = 0 ; V_4 < V_72 -> V_17 ; V_4 ++ )
V_15 -> V_59 [ F_94 () % V_15 -> V_75 ] = V_72 -> V_78 [ V_4 ] -> V_23 ;
V_72 = & V_15 -> V_76 [ V_79 - 1 ] ;
for ( V_4 = 0 ; V_4 < V_72 -> V_17 ; V_4 ++ )
V_15 -> V_59 [ F_94 () % V_15 -> V_75 ] = V_72 -> V_78 [ V_4 ] -> V_23 ;
V_72 = & V_15 -> V_76 [ V_80 - 1 ] ;
