...
{
if ( V_160 && V_160 -> V_161 )
F_50 ( V_160 -> V_161 ) ;
}
void F_55 ( struct V_159 * V_160 )
{
struct V_154 * V_155 = & V_160 -> V_161 -> V_156 ;
F_51 ( & V_155 -> V_157 ) ;
V_155 -> V_158 ++ ;
F_56 ( V_155 -> V_158 != 0 ) ;
F_53 ( & V_155 -> V_157 ) ;
...
static T_1
F_57 ( unsigned int V_132 , struct V_133 * * V_35 )
{
switch ( V_132 ) {
case V_137 :
case V_138 :
...
static T_1 F_58 ( T_2 V_31 , int V_131 ,
struct V_1 * V_2 ,
struct V_8 * V_162 , void * V_3 ,
struct V_8 * V_163 , void * V_4 ,
struct V_164 * V_165 )
{
...
V_166 = V_163 -> V_170 - V_163 -> V_6 ;
if ( V_166 > 0 && V_166 < V_171 ) {
V_26 = V_35 -> V_172 ( V_2 , V_162 , V_3 ) ;
if ( F_15 ( V_26 == 0 ) )
V_26 = V_35 -> F_58 ( V_3 , V_4 , V_165 ) ;
} else
V_26 = F_2 ( V_14 ) ;
V_168:
V_120 = F_45 ( V_163 , V_132 , V_26 ) ;
if ( F_9 ( V_120 ) )
return V_120 ;
if ( V_35 -> V_173 != NULL && V_26 == 0 )
V_26 = V_35 -> V_173 ( V_2 , V_163 , V_4 ) ;
...
unsigned int V_34 = 0 ;
F_18 ( L_12 , V_30 ) ;
F_60 ( & V_162 , & V_2 -> V_176 , V_2 -> V_176 . V_177 [ 0 ] . V_178 ) ;
V_6 = ( T_1 * ) ( ( char * ) V_2 -> V_179 . V_177 [ 0 ] . V_178 + V_2 -> V_179 . V_177 [ 0 ] . V_180 ) ;
F_61 ( & V_163 , & V_2 -> V_179 , V_6 ) ;
V_26 = F_17 ( & V_162 , & V_174 ) ;
if ( V_26 == F_62 ( V_14 ) )
return V_181 ;
if ( V_174 . V_31 == 0 ) {
V_165 . V_160 = F_63 ( V_174 . V_32 ) ;
if ( ! V_165 . V_160 || ! F_64 ( V_165 . V_160 , V_2 ) )
return V_182 ;
}
V_175 . V_27 = V_174 . V_27 ;
V_175 . V_28 = V_174 . V_28 ;
if ( F_44 ( & V_163 , & V_175 ) != 0 )
return V_183 ;
while ( V_26 == 0 && V_34 != V_174 . V_34 ) {
V_26 = F_58 ( V_174 . V_31 , V_34 , V_2 ,
& V_162 , V_3 , & V_163 , V_4 , & V_165 ) ;
V_34 ++ ;
}
