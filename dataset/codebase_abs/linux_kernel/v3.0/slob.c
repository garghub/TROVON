...
int V_22 = F_46 ( V_41 , V_42 ) ;
unsigned int * V_40 = ( unsigned int * ) ( V_38 - V_22 ) ;
return F_32 ( * V_40 ) * V_48 ;
} else
return V_3 -> V_2 . V_47 ;
}
struct V_49 * F_57 ( const char * V_50 , T_4 V_9 ,
T_4 V_22 , unsigned long V_29 , void (* F_58)( void * ) )
{
struct V_49 * V_51 ;
V_51 = F_34 ( sizeof( struct V_49 ) ,
V_52 , V_41 , - 1 ) ;
if ( V_51 ) {
V_51 -> V_50 = V_50 ;
V_51 -> V_9 = V_9 ;
if ( V_29 & V_53 ) {
V_51 -> V_9 += sizeof( struct V_54 ) ;
}
V_51 -> V_29 = V_29 ;
V_51 -> F_58 = F_58 ;
V_51 -> V_22 = ( V_29 & V_55 ) ? V_56 : 0 ;
if ( V_51 -> V_22 < V_42 )
V_51 -> V_22 = V_42 ;
if ( V_51 -> V_22 < V_22 )
V_51 -> V_22 = V_22 ;
...
F_59 ( L_1 , V_50 ) ;
F_51 ( V_51 , sizeof( struct V_49 ) , 1 , V_52 ) ;
return V_51 ;
}
void F_60 ( struct V_49 * V_51 )
{
F_54 ( V_51 ) ;
if ( V_51 -> V_29 & V_53 )
F_61 () ;
F_43 ( V_51 , sizeof( struct V_49 ) ) ;
}
void * F_62 ( struct V_49 * V_51 , T_3 V_29 , int V_17 )
{
void * V_18 ;
if ( V_51 -> V_9 < V_37 ) {
V_18 = F_34 ( V_51 -> V_9 , V_29 , V_51 -> V_22 , V_17 ) ;
F_63 ( V_45 , V_18 , V_51 -> V_9 ,
F_32 ( V_51 -> V_9 ) * V_48 ,
V_29 , V_17 ) ;
} else {
V_18 = F_24 ( V_29 , F_49 ( V_51 -> V_9 ) , V_17 ) ;
F_63 ( V_45 , V_18 , V_51 -> V_9 ,
V_37 << F_49 ( V_51 -> V_9 ) ,
V_29 , V_17 ) ;
}
if ( V_51 -> F_58 )
V_51 -> F_58 ( V_18 ) ;
F_64 ( V_18 , V_51 -> V_9 , 1 , V_51 -> V_29 , V_29 ) ;
return V_18 ;
}
...
{
struct V_54 * V_54 = (struct V_54 * ) V_59 ;
void * V_18 = ( void * ) V_54 - ( V_54 -> V_9 - sizeof( struct V_54 ) ) ;
F_65 ( V_18 , V_54 -> V_9 ) ;
}
void F_67 ( struct V_49 * V_51 , void * V_18 )
{
F_68 ( V_18 , V_51 -> V_29 ) ;
if ( F_42 ( V_51 -> V_29 & V_53 ) ) {
struct V_54 * V_54 ;
V_54 = V_18 + ( V_51 -> V_9 - sizeof( struct V_54 ) ) ;
V_54 -> V_9 = V_51 -> V_9 ;
F_69 ( & V_54 -> V_59 , F_66 ) ;
} else {
F_65 ( V_18 , V_51 -> V_9 ) ;
...
unsigned int F_71 ( struct V_49 * V_51 )
{
return V_51 -> V_9 ;
}
int F_72 ( struct V_49 * V_60 )
{
return 0 ;
}
int F_73 ( void )
