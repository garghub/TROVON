...
static struct V_1 * F_116 ( struct V_1 * V_2 , unsigned long V_124 , int * * V_125 )
{
int V_126 = F_117 ( V_2 ) ;
if ( F_88 ( V_2 ) )
return F_118 ( F_119 ( F_17 ( V_2 ) ) ,
V_126 ) ;
else
return F_120 ( V_126 , V_127 , 0 ) ;
}
static int F_121 ( struct V_1 * V_2 , unsigned long V_29 , int V_68 )
{
int V_32 ;
if ( V_68 & V_119 )
return 1 ;
...
static int F_126 ( struct V_1 * V_1 , int V_68 )
{
int V_32 ;
unsigned long V_29 = F_30 ( V_1 ) ;
struct V_1 * V_95 = F_17 ( V_1 ) ;
F_79 ( V_128 ) ;
V_32 = F_121 ( V_1 , V_29 , V_68 ) ;
if ( V_32 < 0 )
return V_32 ;
if ( V_32 == 0 )
goto V_129;
...
F_127 ( & V_95 -> V_130 , & V_128 ) ;
V_32 = F_128 ( & V_128 , F_116 , V_131 , 0 ,
true ) ;
if ( V_32 ) {
...
int F_129 ( struct V_1 * V_1 , int V_68 )
{
int V_32 ;
unsigned long V_29 = F_30 ( V_1 ) ;
if ( F_88 ( V_1 ) )
return F_126 ( V_1 , V_68 ) ;
V_32 = F_121 ( V_1 , V_29 , V_68 ) ;
if ( V_32 < 0 )
return V_32 ;
if ( V_32 == 0 )
...
F_130 ( V_1 , V_134 +
F_131 ( V_1 ) ) ;
F_127 ( & V_1 -> V_130 , & V_128 ) ;
V_32 = F_132 ( & V_128 , F_116 , V_131 ,
0 , true ) ;
if ( V_32 ) {
F_133 ( & V_128 ) ;
F_29 ( L_39 ,
