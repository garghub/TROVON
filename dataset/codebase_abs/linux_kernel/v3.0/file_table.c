...
F_81 ( V_67 ) ;
F_82 (sb, file) {
struct V_46 * V_46 = V_3 -> V_34 . V_36 -> V_37 ;
if ( V_46 -> V_68 == 0 )
goto V_69;
if ( F_83 ( V_46 -> V_42 ) && ( V_3 -> V_39 & V_41 ) )
goto V_69;
} V_70 ;
F_84 ( V_67 ) ;
return 1 ;
...
void T_6 F_90 ( unsigned long V_72 )
{
unsigned long V_73 ;
V_8 = F_91 ( L_2 , sizeof( struct V_3 ) , 0 ,
V_74 | V_75 , NULL ) ;
V_73 = ( V_72 * ( V_76 / 1024 ) ) / 10 ;
V_10 . V_11 = F_92 (unsigned long, n, NR_FILE) ;
F_93 () ;
F_94 ( V_67 ) ;
F_95 ( & V_9 , 0 ) ;
}
