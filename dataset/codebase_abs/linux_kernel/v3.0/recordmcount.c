...
case V_64 : V_52 = '_' ; break;
case V_65 : V_38 = V_66 ; V_52 = '_' ; break;
case V_67 : V_38 = V_68 ; V_52 = '_' ; break;
case V_69 : V_52 = '_' ; break;
case V_70 : V_38 = V_71 ; break;
case V_72 : V_38 = V_73 ; V_52 = '_' ; break;
case V_74 :
V_56 = F_12 ;
V_20 = V_75 ;
V_38 = V_76 ;
...
break;
case V_79 :
if ( V_39 ( V_37 -> V_80 ) != sizeof( T_7 )
|| V_39 ( V_37 -> V_81 ) != sizeof( V_82 ) ) {
fprintf ( V_15 ,
L_18 , V_21 ) ;
F_6 () ;
}
if ( V_39 ( V_37 -> V_53 ) == V_69 ) {
V_38 = V_83 ;
V_58 = - 4 ;
}
if ( V_39 ( V_37 -> V_53 ) == V_64 ) {
V_38 = V_84 ;
V_85 = V_86 ;
}
F_28 ( V_37 , V_21 , V_38 ) ;
break;
case V_87 : {
T_8 * const V_88 = ( T_8 * ) V_37 ;
if ( V_39 ( V_88 -> V_80 ) != sizeof( T_8 )
|| V_39 ( V_88 -> V_81 ) != sizeof( V_89 ) ) {
fprintf ( V_15 ,
L_18 , V_21 ) ;
F_6 () ;
}
if ( V_39 ( V_88 -> V_53 ) == V_69 ) {
V_38 = V_90 ;
V_77 = - 8 ;
}
if ( V_39 ( V_88 -> V_53 ) == V_64 ) {
V_38 = V_91 ;
V_92 = F_25 ;
V_93 = F_26 ;
V_94 = V_95 ;
...
{
const char V_98 [] = L_19 ;
int V_99 = sizeof( V_98 ) - 1 ;
int V_100 = 0 ;
int V_101 ;
int V_102 ;
while ( ( V_101 = F_30 ( V_96 , V_97 , L_20 ) ) >= 0 ) {
switch ( V_101 ) {
case 'w' :
V_103 = 1 ;
break;
...
for ( V_102 = V_104 ; V_102 < V_96 ; V_102 ++ ) {
char * V_105 = V_97 [ V_102 ] ;
int const V_106 = setjmp ( V_107 ) ;
int V_108 ;
V_108 = strlen ( V_105 ) ;
if ( V_108 >= V_99 &&
strcmp ( V_105 + ( V_108 - V_99 ) , V_98 ) == 0 )
continue;
switch ( V_106 ) {
default:
fprintf ( V_15 , L_22 , V_105 ) ;
exit ( 1 ) ;
break;
case V_109 :
V_5 = - 1 ;
