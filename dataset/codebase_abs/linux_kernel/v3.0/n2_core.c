...
struct V_244 * V_245 )
{
const T_2 * V_248 , * V_251 ;
int V_283 , V_284 ;
int V_153 ;
V_248 = F_141 ( V_273 , V_274 , L_25 , & V_283 ) ;
if ( ! V_248 )
return - V_107 ;
V_251 = F_141 ( V_273 , V_274 , L_26 , & V_284 ) ;
if ( ! V_251 )
return - V_107 ;
if ( V_283 != V_284 )
return - V_121 ;
V_245 -> V_249 = V_283 / sizeof( T_2 ) ;
V_245 -> V_250 = F_84 ( ( sizeof( struct V_285 ) *
V_245 -> V_249 ) ,
V_201 ) ;
if ( ! V_245 -> V_250 )
return - V_185 ;
for ( V_153 = 0 ; V_153 < V_245 -> V_249 ; V_153 ++ ) {
struct V_285 * V_286 = & V_245 -> V_250 [ V_153 ] ;
V_286 -> V_248 = V_248 [ V_153 ] ;
V_286 -> V_251 = V_251 [ V_153 ] ;
}
return 0 ;
}
static int T_5 F_150 ( struct V_272 * V_273 ,
struct V_242 * V_243 ,
struct V_244 * V_245 ,
const char * V_287 )
{
...
T_2 V_274 ;
V_288 = F_114 ( V_243 -> V_243 . V_252 , L_27 , NULL ) ;
if ( ! V_288 )
return - V_107 ;
...
continue;
V_289 = F_141 ( V_273 , V_274 , L_30 , NULL ) ;
...
if ( ! V_109 )
goto V_296;
V_297 = F_84 ( sizeof( struct V_1 * ) * V_271 ,
V_201 ) ;
if ( ! V_297 )
goto V_298;
V_78 = 0 ;
...
static struct V_299 * T_5 F_157 ( void )
{
...
{
if ( V_300 -> V_302 . V_250 ) {
F_90 ( V_300 -> V_302 . V_250 ) ;
V_300 -> V_302 . V_250 = NULL ;
}
F_90 ( V_300 ) ;
}
...
static int T_5 F_160 ( struct V_242 * V_243 )
{
struct V_272 * V_273 ;
const char * V_279 ;
struct V_299 * V_300 ;
...
V_78 = F_150 ( V_273 , V_243 , & V_300 -> V_302 , L_37 ) ;
if ( V_78 ) {
...
V_78 = F_147 ( V_273 , V_243 , & V_300 -> V_302 , & V_300 -> V_301 ,
L_39 , V_263 , F_3 ,
V_109 ) ;
F_162 ( V_273 ) ;
if ( V_78 ) {
...
static int T_6 F_164 ( struct V_242 * V_243 )
{
struct V_299 * V_300 = F_165 ( & V_243 -> V_243 ) ;
F_112 () ;
F_135 ( & V_300 -> V_301 ) ;
F_156 () ;
F_158 ( V_300 ) ;
...
static struct V_308 * T_5 F_166 ( void )
{
...
static void F_167 ( struct V_308 * V_309 )
{
if ( V_309 -> V_311 . V_250 ) {
F_90 ( V_309 -> V_311 . V_250 ) ;
V_309 -> V_311 . V_250 = NULL ;
}
F_90 ( V_309 ) ;
}
static int T_5 F_168 ( struct V_242 * V_243 )
{
struct V_272 * V_273 ;
const char * V_279 ;
struct V_308 * V_309 ;
...
V_78 = F_150 ( V_273 , V_243 , & V_309 -> V_311 , L_44 ) ;
if ( V_78 ) {
F_142 ( & V_243 -> V_243 , L_38 ,
V_279 ) ;
F_162 ( V_273 ) ;
...
V_78 = F_147 ( V_273 , V_243 , & V_309 -> V_311 , & V_309 -> V_310 ,
L_45 , V_5 , F_10 ,
V_297 ) ;
F_162 ( V_273 ) ;
if ( V_78 ) {
...
static int T_6 F_169 ( struct V_242 * V_243 )
{
struct V_308 * V_309 = F_165 ( & V_243 -> V_243 ) ;
F_135 ( & V_309 -> V_310 ) ;
F_156 () ;
F_167 ( V_309 ) ;
return 0 ;
