...
static int
F_68 ( struct V_63 * V_30 , struct V_79 * V_80 )
{
struct V_1 * V_4 = V_30 -> V_31 ;
F_60 ( V_4 ) ;
if ( F_69 ( V_101 , & V_4 -> V_59 ) )
return 0 ;
V_4 -> V_37 = V_80 ;
V_4 -> V_89 = 0 ;
F_60 ( V_4 ) ;
...
int V_105 = 0 ;
if ( F_69 ( V_106 , & V_4 -> V_59 ) )
return 0 ;
F_70 ( & V_4 -> V_19 ) ;
for (; ; ) {
if ( F_71 ( V_58 , & V_4 -> V_59 ) )
V_105 = 0 ;
...
static inline int
F_73 ( struct V_1 * V_4 , const unsigned char * V_39 , int V_40 )
{
int V_83 , V_84 ;
...
{
struct V_79 * V_80 ;
int V_84 , V_83 , V_116 , V_117 , V_118 , V_119 ;
unsigned char * V_120 ;
if ( ~ V_4 -> V_67 & V_69 ) {
V_118 = 0 ;
for ( V_83 = 0 ; V_83 < V_40 ; ++ V_83 ) {
...
if ( V_56 && V_56 [ V_83 ] != 0 )
continue;
V_118 |= ( V_84 & 0x80 ) ? V_121 : V_122 ;
V_84 = ( ( V_84 >> 4 ) ^ V_84 ) & 0xf ;
V_118 |= ( 0x6996 & ( 1 << V_84 ) ) ? V_123 : V_124 ;
}
V_4 -> V_67 |= V_118 ;
}
while ( V_40 > 0 ) {
...
V_117 = F_73 ( V_4 , V_39 , V_40 ) ;
V_119 = 0 ;
if ( V_56 && ( V_4 -> V_109 & V_110 ) == 0 ) {
for ( V_116 = 0 ; V_116 < V_117 ; ++ V_116 )
if ( ( V_119 = V_56 [ V_116 ] ) != 0 )
break;
}
if ( V_119 != 0 ) {
V_4 -> V_109 |= V_110 ;
} else if ( V_117 > 0 && ( V_4 -> V_109 & V_110 ) == 0 ) {
V_80 = V_4 -> V_36 ;
if ( ! V_80 ) {
V_80 = F_81 ( V_4 -> V_17 + V_125 + 2 ) ;
if ( ! V_80 )
goto V_126;
V_4 -> V_36 = V_80 ;
}
if ( V_80 -> V_90 == 0 ) {
if ( V_39 [ 0 ] != V_113 )
F_79 ( V_80 , 2 + ( V_39 [ 0 ] & 1 ) ) ;
}
if ( V_117 > F_82 ( V_80 ) ) {
V_4 -> V_109 |= V_110 ;
} else {
V_120 = F_83 ( V_80 , V_117 ) ;
memcpy ( V_120 , V_39 , V_117 ) ;
if ( V_4 -> V_109 & V_111 ) {
V_120 [ 0 ] ^= V_127 ;
V_4 -> V_109 &= ~ V_111 ;
}
...
break;
V_84 = V_39 [ V_117 ] ;
if ( V_56 != NULL && V_56 [ V_117 ] != 0 ) {
V_4 -> V_109 |= V_110 ;
} else if ( V_84 == V_96 ) {
F_74 ( V_4 ) ;
} else if ( V_84 == V_108 ) {
V_4 -> V_109 |= V_111 ;
} else if ( F_84 ( V_4 -> V_3 ) ) {
if ( V_84 == F_85 ( V_4 -> V_3 ) )
F_86 ( V_4 -> V_3 ) ;
else if ( V_84 == F_87 ( V_4 -> V_3 ) )
F_88 ( V_4 -> V_3 ) ;
}
++ V_117 ;
V_39 += V_117 ;
...
if ( V_90 < V_129 )
return;
if ( V_130 == ( V_128 ? V_131 : V_132 ) ) {
V_82 = V_97 ;
for ( V_83 = 1 ; V_83 < V_129 ; ++ V_83 )
...
V_87 += 4 ;
V_129 -= 4 ;
while ( V_129 >= 2 && V_129 >= V_87 [ 1 ] && V_87 [ 1 ] >= 2 ) {
switch ( V_87 [ 0 ] ) {
case V_133 :
V_44 = F_63 ( V_87 + 2 ) ;
if ( V_128 )
