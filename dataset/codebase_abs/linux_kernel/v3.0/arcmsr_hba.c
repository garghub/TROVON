...
( T_7 ) V_320 -> V_249 [ 8 ] ;
V_242 = F_136 ( V_320 ) ;
V_44 = F_137 ( F_138 ( V_242 ) , V_326 ) + V_242 -> V_327 ;
if ( F_139 ( V_320 ) > 1 ) {
V_323 = V_328 ;
goto V_329;
}
...
memcpy ( V_322 -> V_334 , V_331 , V_304 ) ;
V_322 -> V_335 . V_336 = V_304 ;
if( V_10 -> V_148 == V_337 ) {
V_322 -> V_335 . V_338 = V_339 ;
} else{
V_322 -> V_335 . V_338 = V_340 ;
}
F_20 ( V_331 ) ;
}
break;
...
V_343 = V_331 ;
V_342 = V_322 -> V_335 . V_336 ;
memcpy ( V_343 , V_322 -> V_334 , V_342 ) ;
V_302 = V_10 -> V_302 ;
V_301 = V_10 -> V_301 ;
if ( V_302 != V_301 ) {
struct V_172 * V_173 =
...
V_329:
V_242 = F_136 ( V_320 ) ;
F_141 ( V_44 - V_242 -> V_327 , V_326 ) ;
return V_323 ;
}
static struct V_67 * F_142 ( struct V_9 * V_10 )
{
struct V_358 * V_359 = & V_10 -> V_95 ;
struct V_67 * V_164 = NULL ;
unsigned long V_167 ;
F_81 ( & V_10 -> V_135 , V_167 ) ;
if ( ! F_143 ( V_359 ) ) {
V_164 = F_144 ( V_359 -> V_360 , struct V_67 , V_94 ) ;
F_145 ( & V_164 -> V_94 ) ;
} else{
F_82 ( & V_10 -> V_135 , V_167 ) ;
return 0 ;
...
case V_361 : {
unsigned char V_362 [ 36 ] ;
char * V_44 ;
struct V_241 * V_242 ;
if ( V_320 -> V_189 -> V_105 ) {
V_320 -> V_175 = ( V_363 << 16 ) ;
V_320 -> V_171 ( V_320 ) ;
return;
}
V_362 [ 0 ] = V_364 ;
...
V_362 [ 2 ] = 0 ;
V_362 [ 4 ] = 31 ;
strncpy ( & V_362 [ 8 ] , L_16 , 8 ) ;
strncpy ( & V_362 [ 16 ] , L_17 , 16 ) ;
strncpy ( & V_362 [ 32 ] , L_18 , 4 ) ;
V_242 = F_136 ( V_320 ) ;
V_44 = F_137 ( F_138 ( V_242 ) , V_326 ) + V_242 -> V_327 ;
memcpy ( V_44 , V_362 , sizeof( V_362 ) ) ;
V_242 = F_136 ( V_320 ) ;
F_141 ( V_44 - V_242 -> V_327 , V_326 ) ;
V_320 -> V_171 ( V_320 ) ;
}
...
T_5 V_368 = V_320 -> V_249 [ 0 ] ;
V_320 -> V_171 = F_148 ;
V_320 -> V_369 = NULL ;
V_320 -> V_175 = 0 ;
if ( ( V_368 == V_370 ) || ( V_368 == V_371 ) ) {
...
void * V_65 ;
T_6 V_66 ;
char * V_374 = V_10 -> V_375 ;
char * V_376 = V_10 -> V_377 ;
char * V_378 = V_10 -> V_100 ;
char T_1 * V_379 ;
char T_1 * V_380 ;
char T_1 * V_381 ;
int V_382 ;
...
V_10 -> V_18 = V_47 ;
V_47 -> V_55 = ( T_7 T_1 * ) ( ( unsigned long ) V_10 -> V_25 + V_383 ) ;
V_47 -> V_384 = ( T_7 T_1 * ) ( ( unsigned long ) V_10 -> V_25 + V_385 ) ;
V_47 -> V_51 = ( T_7 T_1 * ) ( ( unsigned long ) V_10 -> V_25 + V_386 ) ;
V_47 -> V_186 = ( T_7 T_1 * ) ( ( unsigned long ) V_10 -> V_25 + V_387 ) ;
V_47 -> V_289 = ( T_7 T_1 * ) ( ( unsigned long ) V_10 -> V_26 + V_388 ) ;
V_47 -> V_287 = ( T_7 T_1 * ) ( ( unsigned long ) V_10 -> V_26 + V_389 ) ;
V_47 -> V_102 = ( T_7 T_1 * ) ( ( unsigned long ) V_10 -> V_26 + V_390 ) ;
V_379 = ( char T_1 * ) ( & V_47 -> V_102 [ 15 ] ) ;
V_380 = ( char T_1 * ) ( & V_47 -> V_102 [ 17 ] ) ;
V_381 = ( char T_1 * ) ( & V_47 -> V_102 [ 21 ] ) ;
F_13 ( V_391 , V_47 -> V_55 ) ;
if ( ! F_25 ( V_10 ) ) {
...
V_10 -> V_392 = F_12 ( & V_47 -> V_102 [ 2 ] ) ;
V_10 -> V_393 = F_12 ( & V_47 -> V_102 [ 3 ] ) ;
V_10 -> V_394 = F_12 ( & V_47 -> V_102 [ 4 ] ) ;
V_10 -> V_395 = F_12 ( & V_47 -> V_102 [ 5 ] ) ;
V_10 -> V_81 = F_12 ( & V_47 -> V_102 [ 25 ] ) ;
return true ;
}
static bool F_150 ( struct V_9 * V_56 )
{
T_7 V_224 , V_396 , V_397 = 0 ;
struct V_57 * V_47 = V_56 -> V_27 ;
char * V_374 = V_56 -> V_375 ;
char * V_376 = V_56 -> V_377 ;
char * V_379 = ( char * ) ( & V_47 -> V_111 [ 15 ] ) ;
char * V_380 = ( char * ) ( & V_47 -> V_111 [ 17 ] ) ;
int V_382 ;
V_224 = F_12 ( & V_47 -> V_187 ) ;
F_13 ( V_224 | V_188 , & V_47 -> V_187 ) ;
do {
V_397 = F_12 ( & V_47 -> V_398 ) ;
} while ( ( V_397 & V_399 ) == 0 );
F_13 ( V_400 , & V_47 -> V_61 ) ;
F_13 ( V_63 , & V_47 -> V_64 ) ;
for ( V_396 = 0 ; V_396 < 2000 ; V_396 ++ ) {
...
V_56 -> V_377 ,
V_56 -> V_375 ) ;
V_56 -> V_392 = F_12 ( & V_47 -> V_111 [ 1 ] ) ;
V_56 -> V_393 = F_12 ( & V_47 -> V_111 [ 2 ] ) ;
V_56 -> V_394 = F_12 ( & V_47 -> V_111 [ 3 ] ) ;
V_56 -> V_395 = F_12 ( & V_47 -> V_111 [ 4 ] ) ;
...
struct V_67 * V_164 ;
struct V_204 * V_91 ;
T_7 V_203 , V_49 , V_402 = 0 , V_221 = 0 ;
int V_403 ;
bool error ;
V_404:
V_221 ++ ;
...
V_164 = F_38 ( V_91 , struct V_67 , V_91 ) ;
V_402 = ( V_164 == V_401 ) ? 1 : 0 ;
if ( ( V_164 -> V_10 != V_10 ) || ( V_164 -> V_169 != V_199 ) ) {
if ( ( V_164 -> V_169 == V_200 ) || ( V_164 == V_401 ) ) {
F_9 ( V_22 L_22
L_23
, V_10 -> V_23 -> V_24
, V_164 -> V_166 -> V_189 -> V_113
, V_164 -> V_166 -> V_189 -> V_105
, V_164 ) ;
V_164 -> V_166 -> V_175 = V_202 << 16 ;
F_79 ( V_164 ) ;
continue;
...
static int F_155 ( struct V_9 * V_10 , struct V_67 * V_401 )
{
struct V_57 * V_47 = (struct V_57 * ) V_10 -> V_27 ;
T_7 V_203 , V_216 ;
struct V_204 * V_91 ;
...
switch ( V_10 -> V_11 ) {
case V_12 : {
V_403 = F_153 ( V_10 , V_401 ) ;
}
break;
case V_14 : {
V_403 = F_154 ( V_10 , V_401 ) ;
}
break;
case V_13 : {
V_403 = F_155 ( V_10 , V_401 ) ;
}
}
return V_403 ;
}
