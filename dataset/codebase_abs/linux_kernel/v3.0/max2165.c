...
V_38 = V_2 -> V_33 ;
F_5 ( V_2 , V_40 , 0xF0 , V_38 << 4 ) ;
return 0 ;
}
int F_9 ( T_2 V_41 , T_2 V_42 , T_2 * V_43 , T_2 * V_44 )
{
T_2 V_45 ;
T_2 V_46 , V_47 = 0 ;
int V_26 ;
...
T_2 V_51 ;
T_2 V_43 , V_44 ;
F_9 ( V_48 / 1000 , V_2 -> V_12 -> V_52 * 1000 ,
& V_43 , & V_44 ) ;
V_44 >>= 12 ;
F_1 ( V_2 , V_53 , V_43 ) ;
F_5 ( V_2 , V_54 , 0x0F , V_44 >> 16 ) ;
F_1 ( V_2 , V_55 , V_44 >> 8 ) ;
F_1 ( V_2 , V_56 , V_44 ) ;
V_50 = ( V_48 < 725000000 ) ?
V_2 -> V_29 : V_2 -> V_30 ;
...
int V_5 ;
F_2 ( L_16 , V_15 , V_74 -> V_76 ) ;
if ( V_72 -> V_77 . V_78 . type == V_79 ) {
return - V_80 ;
} else if ( V_72 -> V_77 . V_78 . type == V_81 ) {
F_2 ( L_17 , V_15 ) ;
switch ( V_74 -> V_82 . V_83 . V_84 ) {
case V_85 :
return - V_80 ;
case V_86 :
case V_39 :
V_2 -> V_76 = V_74 -> V_76 ;
V_2 -> V_84 = V_74 -> V_82 . V_83 . V_84 ;
break;
default:
F_13 ( V_87 L_18 ) ;
return - V_80 ;
...
F_2 ( L_20 , V_15 , V_2 -> V_76 ) ;
if ( V_72 -> V_77 . V_88 )
V_72 -> V_77 . V_88 ( V_72 , 1 ) ;
F_8 ( V_2 , V_2 -> V_84 ) ;
V_5 = F_10 ( V_2 , V_2 -> V_76 ) ;
F_14 ( 50 ) ;
F_11 ( V_2 ) ;
if ( V_72 -> V_77 . V_88 )
V_72 -> V_77 . V_88 ( V_72 , 0 ) ;
if ( V_5 != 0 )
return - V_89 ;
return 0 ;
}
...
V_16 ? F_23 ( V_16 ) : - 1 ,
V_99 ? V_99 -> V_13 : - 1 ) ;
V_2 = F_24 ( sizeof( struct V_1 ) , V_100 ) ;
if ( V_2 == NULL )
return NULL ;
memcpy ( & V_72 -> V_77 . V_101 , & V_102 ,
sizeof( struct V_103 ) ) ;
V_2 -> V_12 = V_99 ;
V_2 -> V_16 = V_16 ;
V_72 -> V_75 = V_2 ;
