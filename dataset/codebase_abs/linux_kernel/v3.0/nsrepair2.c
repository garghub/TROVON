...
V_46 = ( * V_54 ) -> V_45 . V_46 ;
V_56 = V_46 [ 1 ] ;
if ( ( T_3 ) V_56 -> integer . V_59 > V_57 ) {
F_8 ( ( V_30 , V_2 -> V_31 ,
V_2 -> V_32 ,
L_8 ,
V_21 - 1 , V_21 ) ) ;
}
V_57 = ( T_3 ) V_56 -> integer . V_59 ;
V_54 ++ ;
}
return ( V_28 ) ;
}
...
for ( V_21 = 0 ; V_21 < V_55 ; V_21 ++ ) {
if ( ( * V_54 ) -> V_23 . type != V_44 ) {
return ( V_33 ) ;
}
if ( ( * V_54 ) -> V_45 . V_47 < V_60 ) {
return ( V_65 ) ;
}
V_46 = ( * V_54 ) -> V_45 . V_46 ;
V_56 = V_46 [ V_61 ] ;
if ( V_56 -> V_23 . type != V_66 ) {
return ( V_33 ) ;
}
if ( ( ( V_62 == V_17 ) &&
( V_56 -> integer . V_59 < V_57 ) ) ||
( ( V_62 == V_53 ) &&
( V_56 -> integer . V_59 > V_57 ) ) ) {
F_20 ( V_16 -> V_45 . V_46 ,
V_55 , V_61 ,
...
for ( V_71 = ( V_47 - 1 ) ; V_71 >= V_21 ; V_71 -- ) {
V_68 = V_46 [ V_71 - 1 ] -> V_45 . V_46 [ V_67 ] ;
V_69 = V_46 [ V_71 ] -> V_45 . V_46 [ V_67 ] ;
if ( ( ( V_62 == V_17 ) &&
( V_68 -> integer . V_59 >
V_69 -> integer . V_59 ) )
|| ( ( V_62 == V_53 )
