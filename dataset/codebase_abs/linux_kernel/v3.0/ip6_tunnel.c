...
int V_51 = - 1 ;
int V_156 ;
if ( ( V_16 = F_4 ( V_15 ) ) != NULL )
F_95 ( V_16 ) ;
else {
V_16 = F_96 ( V_26 , NULL , V_152 ) ;
if ( V_16 -> error )
goto V_157;
V_16 = F_97 ( V_26 , V_16 , F_98 ( V_152 ) , NULL , 0 ) ;
if ( F_54 ( V_16 ) ) {
V_51 = F_99 ( V_16 ) ;
V_16 = NULL ;
goto V_157;
...
F_48 ( V_58 ) ;
F_56 ( V_58 , F_107 ( V_16 ) ) ;
V_58 -> V_163 = V_58 -> V_139 ;
V_97 = V_152 -> V_164 ;
if ( V_105 >= 0 ) {
F_90 ( & V_81 , V_105 ) ;
...
F_50 ( V_58 ) ;
V_61 = F_65 ( V_58 ) ;
* ( T_6 * ) V_61 = V_152 -> V_165 | F_61 ( 0x60000000 ) ;
V_127 = F_110 ( 0 , V_127 ) ;
F_111 ( V_61 , ~ V_128 , V_127 ) ;
V_61 -> V_166 = V_15 -> V_35 . V_166 ;
V_61 -> V_62 = V_97 ;
F_112 ( & V_61 -> V_95 , & V_152 -> V_95 ) ;
F_112 ( & V_61 -> V_94 , & V_152 -> V_94 ) ;
F_113 ( V_58 ) ;
V_156 = V_58 -> V_92 ;
V_51 = F_114 ( V_58 ) ;
if ( F_115 ( V_51 ) == 0 ) {
...
{
struct V_14 * V_15 = F_27 ( V_3 ) ;
const struct V_110 * V_170 = F_51 ( V_58 ) ;
int V_105 = - 1 ;
struct V_151 V_152 ;
T_3 V_127 ;
T_5 V_99 ;
...
memcpy ( & V_152 , & V_15 -> V_172 . V_173 . V_174 , sizeof ( V_152 ) ) ;
V_152 . V_164 = V_115 ;
V_127 = F_118 ( V_170 ) ;
if ( ( V_15 -> V_35 . V_38 & V_175 ) )
V_152 . V_165 |= F_61 ( ( T_5 ) V_170 -> V_120 << V_176 )
& V_177 ;
...
V_127 = F_68 ( V_61 ) ;
if ( ( V_15 -> V_35 . V_38 & V_175 ) )
V_152 . V_165 |= ( * ( T_6 * ) V_61 & V_177 ) ;
if ( ( V_15 -> V_35 . V_38 & V_178 ) )
V_152 . V_165 |= ( * ( T_6 * ) V_61 & V_179 ) ;
V_51 = F_94 ( V_58 , V_3 , V_127 , & V_152 , V_105 , & V_99 ) ;
if ( V_51 != 0 ) {
if ( V_51 == - V_160 )
...
switch ( V_58 -> V_134 ) {
case F_84 ( V_143 ) :
V_130 = F_117 ( V_58 , V_3 ) ;
break;
case F_84 ( V_144 ) :
V_130 = F_119 ( V_58 , V_3 ) ;
break;
default:
goto V_180;
}
...
{
struct V_41 * V_42 = & V_15 -> V_35 ;
int V_183 = F_123 ( & V_42 -> V_36 ) ;
int V_184 = F_123 ( & V_42 -> V_37 ) ;
V_42 -> V_38 &= ~ ( V_150 | V_131 ) ;
if ( V_183 & ( V_185 | V_186 ) &&
V_184 & ( V_185 | V_186 ) &&
! ( ( V_183 | V_184 ) & V_187 ) &&
( ! ( ( V_183 | V_184 ) & V_188 ) || V_42 -> V_133 ) ) {
if ( V_183 & V_185 )
V_42 -> V_38 |= V_150 ;
if ( V_184 & V_185 )
V_42 -> V_38 |= V_131 ;
...
struct V_41 * V_42 = & V_15 -> V_35 ;
struct V_151 * V_152 = & V_15 -> V_172 . V_173 . V_174 ;
memcpy ( V_3 -> V_189 , & V_42 -> V_36 , sizeof( struct V_27 ) ) ;
memcpy ( V_3 -> V_190 , & V_42 -> V_37 , sizeof( struct V_27 ) ) ;
F_112 ( & V_152 -> V_95 , & V_42 -> V_36 ) ;
F_112 ( & V_152 -> V_94 , & V_42 -> V_37 ) ;
V_152 -> V_191 = V_42 -> V_133 ;
V_152 -> V_165 = 0 ;
if ( ! ( V_42 -> V_38 & V_175 ) )
V_152 -> V_165 |= V_177 & V_42 -> V_192 ;
if ( ! ( V_42 -> V_38 & V_178 ) )
V_152 -> V_165 |= V_179 & V_42 -> V_192 ;
F_122 ( V_15 ) ;
if ( V_42 -> V_38 & V_150 && V_42 -> V_38 & V_131 )
V_3 -> V_38 |= V_193 ;
else
V_3 -> V_38 &= ~ V_193 ;
V_3 -> V_194 = V_42 -> V_133 ;
if ( V_42 -> V_38 & V_150 ) {
int V_195 = ( F_123 ( & V_42 -> V_37 ) &
( V_186 | V_188 ) ) ;
...
{
F_112 ( & V_15 -> V_35 . V_36 , & V_42 -> V_36 ) ;
F_112 ( & V_15 -> V_35 . V_37 , & V_42 -> V_37 ) ;
V_15 -> V_35 . V_38 = V_42 -> V_38 ;
V_15 -> V_35 . V_166 = V_42 -> V_166 ;
V_15 -> V_35 . V_105 = V_42 -> V_105 ;
V_15 -> V_35 . V_192 = V_42 -> V_192 ;
...
static int
F_126 ( struct V_2 * V_3 , struct V_197 * V_198 , int V_199 )
{
int V_51 = 0 ;
struct V_41 V_42 ;
...
case V_200 :
if ( V_3 == V_33 -> V_56 ) {
if ( F_127 ( & V_42 , V_198 -> V_201 . V_202 , sizeof ( V_42 ) ) ) {
V_51 = - V_203 ;
break;
}
...
if ( F_128 ( V_198 -> V_201 . V_202 , & V_42 , sizeof ( V_42 ) ) ) {
V_51 = - V_203 ;
}
break;
case V_204 :
...
V_42 . V_97 != 0 )
break;
V_15 = F_31 ( V_26 , & V_42 , V_199 == V_204 ) ;
if ( V_3 != V_33 -> V_56 && V_199 == V_205 ) {
if ( V_15 != NULL ) {
if ( V_15 -> V_3 != V_3 ) {
V_51 = - V_209 ;
break;
...
if ( V_15 ) {
V_51 = 0 ;
if ( F_128 ( V_198 -> V_201 . V_202 , & V_15 -> V_35 , sizeof ( V_42 ) ) )
V_51 = - V_203 ;
} else
V_51 = ( V_199 == V_204 ? - V_210 : - V_93 ) ;
break;
case V_211 :
V_51 = - V_206 ;
if ( ! F_129 ( V_207 ) )
...
static int
F_133 ( struct V_2 * V_3 , int V_212 )
{
if ( V_212 < V_107 ) {
return - V_208 ;
}
...
V_3 -> V_215 = F_20 ;
V_3 -> type = V_216 ;
V_3 -> V_196 = V_217 + sizeof ( struct V_60 ) ;
V_3 -> V_99 = V_218 - sizeof ( struct V_60 ) ;
V_15 = F_27 ( V_3 ) ;
if ( ! ( V_15 -> V_35 . V_38 & V_171 ) )
V_3 -> V_99 -= 8 ;
V_3 -> V_38 |= V_219 ;
V_3 -> V_220 = sizeof( struct V_27 ) ;
V_3 -> V_221 |= V_222 ;
V_3 -> V_223 &= ~ V_224 ;
}
static inline int
...
struct V_14 * V_15 ;
F_138 ( V_226 ) ;
for ( V_43 = 0 ; V_43 < V_227 ; V_43 ++ ) {
V_15 = F_18 ( V_33 -> V_228 [ V_43 ] ) ;
while ( V_15 != NULL ) {
F_139 ( V_15 -> V_3 , & V_226 ) ;
V_15 = F_18 ( V_15 -> V_47 ) ;
}
}
...
if ( V_51 < 0 )
goto V_232;
V_51 = F_148 ( & V_233 , V_234 ) ;
if ( V_51 < 0 ) {
F_42 ( V_235 L_16 ) ;
goto V_236;
}
V_51 = F_148 ( & V_237 , V_238 ) ;
if ( V_51 < 0 ) {
F_42 ( V_235 L_17 ) ;
goto V_239;
}
...
{
if ( F_149 ( & V_233 , V_234 ) )
F_42 ( V_240 L_18 ) ;
if ( F_149 ( & V_237 , V_238 ) )
F_42 ( V_240 L_19 ) ;
F_150 ( & V_231 ) ;
}
