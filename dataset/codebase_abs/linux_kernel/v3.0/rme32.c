...
static int T_5 F_80 ( struct V_1 * V_1 )
{
...
V_1 -> V_93 = V_34 -> V_93 ;
F_88 ( V_34 , 8 , & V_1 -> V_156 ) ;
if ( ( V_60 = F_89 ( V_1 -> V_115 , L_4 , 0 , 1 , 1 , & V_1 -> V_149 ) ) < 0 ) {
return V_60 ;
}
V_1 -> V_149 -> V_146 = V_1 ;
V_1 -> V_149 -> V_157 = F_78 ;
strcpy ( V_1 -> V_149 -> V_158 , L_4 ) ;
if ( V_1 -> V_64 ) {
F_90 ( V_1 -> V_149 , V_159 ,
& V_160 ) ;
F_90 ( V_1 -> V_149 , V_144 ,
& V_161 ) ;
F_91 ( V_1 -> V_149 , V_162 ,
F_92 ( V_163 ) ,
0 , V_164 ) ;
V_1 -> V_149 -> V_165 = V_166 ;
} else {
F_90 ( V_1 -> V_149 , V_159 ,
& V_167 ) ;
F_90 ( V_1 -> V_149 , V_144 ,
& V_168 ) ;
V_1 -> V_149 -> V_165 = V_169 ;
}
if ( ( V_34 -> V_35 == V_170 ) ||
( V_34 -> V_35 == V_36 ) ) {
V_1 -> V_150 = NULL ;
...
V_1 -> V_150 -> V_146 = V_1 ;
V_1 -> V_150 -> V_157 = F_79 ;
strcpy ( V_1 -> V_150 -> V_158 , L_5 ) ;
if ( V_1 -> V_64 ) {
F_90 ( V_1 -> V_150 , V_159 ,
& V_171 ) ;
F_90 ( V_1 -> V_150 , V_144 ,
& V_172 ) ;
F_91 ( V_1 -> V_150 , V_162 ,
F_92 ( V_163 ) ,
0 , V_164 ) ;
V_1 -> V_150 -> V_165 = V_166 ;
} else {
F_90 ( V_1 -> V_150 , V_159 ,
& V_173 ) ;
F_90 ( V_1 -> V_150 , V_144 ,
& V_174 ) ;
V_1 -> V_150 -> V_165 = V_169 ;
}
}
V_1 -> V_76 = 0 ;
V_1 -> V_74 = 0 ;
...
static void
F_95 ( struct V_175 * V_176 , struct V_177 * V_178 )
{
int V_24 ;
struct V_1 * V_1 = (struct V_1 * ) V_176 -> V_146 ;
V_1 -> V_25 = F_2 ( V_1 -> V_2 + V_18 ) ;
F_96 ( V_178 , V_1 -> V_115 -> V_179 ) ;
F_96 ( V_178 , L_6 , V_1 -> V_115 -> V_180 + 1 ) ;
F_96 ( V_178 , L_7 ) ;
if ( V_1 -> V_64 )
F_96 ( V_178 , L_8 ) ;
else
...
static void T_5 F_94 ( struct V_1 * V_1 )
{
struct V_175 * V_176 ;
if ( ! F_97 ( V_1 -> V_115 , L_36 , & V_176 ) )
F_98 ( V_176 , V_1 , F_95 ) ;
}
static int
...
struct V_184 * V_185 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
F_25 ( & V_1 -> V_71 ) ;
V_185 -> V_186 . integer . V_186 [ 0 ] =
V_1 -> V_16 & V_91 ? 0 : 1 ;
F_27 ( & V_1 -> V_71 ) ;
return 0 ;
}
...
unsigned int V_187 ;
int V_188 ;
V_187 = V_185 -> V_186 . integer . V_186 [ 0 ] ? 0 : V_91 ;
F_25 ( & V_1 -> V_71 ) ;
V_187 = ( V_1 -> V_16 & ~ V_91 ) | V_187 ;
V_188 = V_187 != V_1 -> V_16 ;
if ( V_185 -> V_186 . integer . V_186 [ 0 ] )
V_187 &= ~ V_92 ;
else
V_187 |= V_92 ;
V_1 -> V_16 = V_187 ;
F_11 ( V_187 , V_1 -> V_2 + V_18 ) ;
F_27 ( & V_1 -> V_71 ) ;
return V_188 ;
}
static int
F_102 ( struct V_182 * V_183 ,
struct V_189 * V_190 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
static char * V_191 [ 4 ] = { L_37 , L_38 , L_39 , L_40 } ;
V_190 -> type = V_192 ;
V_190 -> V_9 = 1 ;
switch ( V_1 -> V_34 -> V_35 ) {
case V_170 :
case V_193 :
V_190 -> V_186 . V_194 . V_195 = 3 ;
break;
case V_36 :
V_190 -> V_186 . V_194 . V_195 = 4 ;
break;
default:
F_103 () ;
break;
}
if ( V_190 -> V_186 . V_194 . V_196 >
V_190 -> V_186 . V_194 . V_195 - 1 ) {
V_190 -> V_186 . V_194 . V_196 =
V_190 -> V_186 . V_194 . V_195 - 1 ;
}
strcpy ( V_190 -> V_186 . V_194 . V_158 ,
V_191 [ V_190 -> V_186 . V_194 . V_196 ] ) ;
return 0 ;
}
static int
F_104 ( struct V_182 * V_183 ,
struct V_184 * V_185 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
unsigned int V_195 = 3 ;
F_25 ( & V_1 -> V_71 ) ;
V_185 -> V_186 . V_194 . V_196 [ 0 ] = F_19 ( V_1 ) ;
switch ( V_1 -> V_34 -> V_35 ) {
case V_170 :
case V_193 :
V_195 = 3 ;
...
if ( V_185 -> V_186 . V_194 . V_196 [ 0 ] >= V_195 ) {
V_185 -> V_186 . V_194 . V_196 [ 0 ] = V_195 - 1 ;
}
F_27 ( & V_1 -> V_71 ) ;
return 0 ;
}
static int
F_105 ( struct V_182 * V_183 ,
struct V_184 * V_185 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
unsigned int V_187 ;
...
V_187 = V_185 -> V_186 . V_194 . V_196 [ 0 ] % V_195 ;
F_25 ( & V_1 -> V_71 ) ;
V_188 = V_187 != ( unsigned int ) F_19 ( V_1 ) ;
F_18 ( V_1 , V_187 ) ;
F_27 ( & V_1 -> V_71 ) ;
return V_188 ;
}
static int
F_106 ( struct V_182 * V_183 ,
struct V_189 * V_190 )
{
static char * V_191 [ 4 ] = { L_41 ,
L_42 ,
L_43 ,
L_44 } ;
V_190 -> type = V_192 ;
V_190 -> V_9 = 1 ;
V_190 -> V_186 . V_194 . V_195 = 4 ;
if ( V_190 -> V_186 . V_194 . V_196 > 3 ) {
V_190 -> V_186 . V_194 . V_196 = 3 ;
}
strcpy ( V_190 -> V_186 . V_194 . V_158 ,
V_191 [ V_190 -> V_186 . V_194 . V_196 ] ) ;
return 0 ;
...
static int
F_107 ( struct V_182 * V_183 ,
struct V_184 * V_185 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
F_25 ( & V_1 -> V_71 ) ;
V_185 -> V_186 . V_194 . V_196 [ 0 ] = F_17 ( V_1 ) ;
F_27 ( & V_1 -> V_71 ) ;
return 0 ;
}
static int
F_108 ( struct V_182 * V_183 ,
struct V_184 * V_185 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
unsigned int V_187 ;
int V_188 ;
V_187 = V_185 -> V_186 . V_194 . V_196 [ 0 ] % 3 ;
F_25 ( & V_1 -> V_71 ) ;
V_188 = V_187 != ( unsigned int ) F_17 ( V_1 ) ;
F_16 ( V_1 , V_187 ) ;
F_27 ( & V_1 -> V_71 ) ;
return V_188 ;
}
static T_6 F_109 ( struct V_197 * V_198 )
{
T_6 V_187 = 0 ;
V_187 |= ( V_198 -> V_199 [ 0 ] & V_200 ) ? V_78 : 0 ;
if ( V_187 & V_78 )
V_187 |= ( V_198 -> V_199 [ 0 ] & V_201 ) ? V_79 : 0 ;
else
V_187 |= ( V_198 -> V_199 [ 0 ] & V_202 ) ? V_79 : 0 ;
return V_187 ;
}
static void F_110 ( struct V_197 * V_198 , T_6 V_187 )
{
V_198 -> V_199 [ 0 ] = ( ( V_187 & V_78 ) ? V_200 : 0 ) ;
if ( V_187 & V_78 )
V_198 -> V_199 [ 0 ] |= ( V_187 & V_79 ) ? V_201 : 0 ;
else
V_198 -> V_199 [ 0 ] |= ( V_187 & V_79 ) ? V_202 : 0 ;
}
static int F_111 ( struct V_182 * V_183 ,
struct V_189 * V_190 )
{
V_190 -> type = V_203 ;
V_190 -> V_9 = 1 ;
...
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
F_110 ( & V_185 -> V_186 . V_204 ,
V_1 -> V_110 ) ;
return 0 ;
}
static int F_113 ( struct V_182 * V_183 ,
struct V_184 * V_185 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
int V_188 ;
T_6 V_187 ;
V_187 = F_109 ( & V_185 -> V_186 . V_204 ) ;
F_25 ( & V_1 -> V_71 ) ;
V_188 = V_187 != V_1 -> V_110 ;
V_1 -> V_110 = V_187 ;
F_27 ( & V_1 -> V_71 ) ;
return V_188 ;
}
static int F_114 ( struct V_182 * V_183 ,
struct V_189 * V_190 )
{
V_190 -> type = V_203 ;
V_190 -> V_9 = 1 ;
...
static int F_115 ( struct V_182 * V_183 ,
struct V_184 *
V_185 )
{
struct V_1 * V_1 = F_100 ( V_183 ) ;
...
static int F_117 ( struct V_182 * V_183 ,
struct V_189 * V_190 )
{
V_190 -> type = V_203 ;
V_190 -> V_9 = 1 ;
...
V_185 )
{
V_185 -> V_186 . V_204 . V_199 [ 0 ] = V_183 -> V_205 ;
return 0 ;
}
static int F_93 ( struct V_206 * V_115 , struct V_1 * V_1 )
{
int V_207 , V_60 ;
struct V_182 * V_208 ;
for ( V_207 = 0 ; V_207 < ( int ) F_119 ( V_209 ) ; V_207 ++ ) {
if ( ( V_60 = F_120 ( V_115 , V_208 = F_121 ( & V_209 [ V_207 ] , V_1 ) ) ) < 0 )
return V_60 ;
if ( V_207 == 1 )
V_1 -> V_111 = V_208 ;
}
...
static void F_122 ( struct V_206 * V_115 )
{
F_73 ( V_115 -> V_146 ) ;
}
static int T_5
F_123 ( struct V_151 * V_34 , const struct V_210 * V_211 )
{
static int V_212 ;
struct V_1 * V_1 ;
struct V_206 * V_115 ;
...
V_60 = F_124 ( V_217 [ V_212 ] , V_118 [ V_212 ] , V_218 ,
...
strcpy ( V_115 -> V_220 , L_45 ) ;
switch ( V_1 -> V_34 -> V_35 ) {
case V_170 :
strcpy ( V_115 -> V_221 , L_46 ) ;
break;
case V_193 :
strcpy ( V_115 -> V_221 , L_47 ) ;
break;
case V_36 :
strcpy ( V_115 -> V_221 , L_48 ) ;
break;
}
sprintf ( V_115 -> V_179 , L_49 ,
V_115 -> V_221 , V_1 -> V_156 , V_1 -> V_68 , V_1 -> V_93 ) ;
...
static void T_7 F_129 ( struct V_151 * V_34 )
{
F_126 ( F_130 ( V_34 ) ) ;
F_128 ( V_34 , NULL ) ;
}
