...
int F_26 ( struct V_6 * V_7 , T_2 V_26 , T_2 V_44 )
{
int V_45 = 0 ;
...
V_47 = F_22 ( & V_11 -> V_18 ) ;
if ( V_47 )
V_46 = F_16 ( V_47 , struct V_2 , V_18 ) ;
if ( V_47 && F_23 ( V_46 , V_11 ) ) {
V_11 -> V_26 = V_46 -> V_26 ;
V_11 -> V_44 += V_46 -> V_44 ;
V_11 -> V_49 += V_46 -> V_49 ;
V_11 -> V_39 = V_46 -> V_39 ;
V_46 -> V_13 = 0 ;
F_30 ( & V_46 -> V_18 , & V_7 -> V_8 ) ;
F_10 ( V_46 ) ;
}
}
V_47 = F_21 ( & V_11 -> V_18 ) ;
...
struct V_18 * V_47 ;
struct V_2 * V_50 ;
V_50 = F_28 ( V_7 , V_11 -> V_26 , V_11 -> V_44 ) ;
if ( V_50 ) {
F_10 ( V_50 ) ;
V_45 = - V_51 ;
goto V_48;
}
V_47 = F_15 ( & V_7 -> V_8 , V_11 -> V_26 , & V_11 -> V_18 ) ;
if ( V_47 ) {
V_45 = - V_51 ;
goto V_48;
}
...
static T_2 F_34 ( T_2 V_26 , T_2 V_44 )
{
if ( V_26 + V_44 < V_26 )
return ( T_2 ) - 1 ;
return V_26 + V_44 ;
...
T_2 V_52 = F_34 ( V_26 , V_44 ) ;
V_18 = F_20 ( & V_7 -> V_8 , V_26 , & V_32 , & V_35 ) ;
if ( ! V_18 && V_32 ) {
V_11 = F_16 ( V_32 , struct V_2 , V_18 ) ;
if ( V_52 > V_11 -> V_26 && V_26 < F_17 ( V_11 ) )
goto V_53;
}
if ( ! V_18 && V_35 ) {
V_11 = F_16 ( V_35 , struct V_2 , V_18 ) ;
if ( V_52 > V_11 -> V_26 && V_26 < F_17 ( V_11 ) )
goto V_53;
}
if ( ! V_18 ) {
