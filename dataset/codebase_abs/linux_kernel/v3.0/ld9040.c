...
V_2 = F_27 ( sizeof( struct V_1 ) , V_67 ) ;
if ( ! V_2 )
return - V_68 ;
V_12 -> V_69 = 9 ;
V_15 = F_28 ( V_12 ) ;
...
V_2 -> V_12 = V_12 ;
V_2 -> V_24 = & V_12 -> V_24 ;
V_2 -> V_44 = V_12 -> V_24 . V_71 ;
if ( ! V_2 -> V_44 ) {
F_9 ( & V_12 -> V_24 , L_4 ) ;
goto V_70;
}
V_47 = F_29 ( L_14 , & V_12 -> V_24 , V_2 , & V_72 ) ;
if ( F_30 ( V_47 ) ) {
V_15 = F_31 ( V_47 ) ;
goto V_70;
}
...
static int T_2 F_36 ( struct V_66 * V_12 )
{
struct V_1 * V_2 = F_37 ( & V_12 -> V_24 ) ;
F_18 ( V_2 , V_56 ) ;
F_38 ( V_2 -> V_47 ) ;
F_35 ( V_2 ) ;
return 0 ;
}
static int F_39 ( struct V_66 * V_12 , T_3 V_75 )
{
int V_15 = 0 ;
struct V_1 * V_2 = F_37 ( & V_12 -> V_24 ) ;
F_40 ( & V_12 -> V_24 , L_17 , V_2 -> V_53 ) ;
V_15 = F_18 ( V_2 , V_56 ) ;
return V_15 ;
}
static int F_41 ( struct V_66 * V_12 )
{
int V_15 = 0 ;
struct V_1 * V_2 = F_37 ( & V_12 -> V_24 ) ;
V_2 -> V_53 = V_56 ;
...
static void F_42 ( struct V_66 * V_12 )
{
struct V_1 * V_2 = F_37 ( & V_12 -> V_24 ) ;
F_18 ( V_2 , V_56 ) ;
}
