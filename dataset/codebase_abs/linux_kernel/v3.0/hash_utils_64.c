...
void F_32 ( unsigned long V_87 , unsigned long V_88 )
{
F_8 ( F_2 ( V_87 , V_88 , F_33 ( V_87 ) ,
F_34 ( V_89 ) , V_74 ,
V_90 ) ) ;
}
...
#ifdef F_47
F_3 ( L_26 , V_117 ) ;
if ( V_117 != 0 && V_117 >= V_103
&& V_117 < ( V_103 + V_42 ) ) {
unsigned long V_118 = V_117 + 16 * V_119 ;
if ( V_103 != V_117 )
F_8 ( F_2 ( V_103 , V_117 ,
F_33 ( V_103 ) , V_12 ,
V_74 ,
...
F_48 ( V_114 ) ;
if ( V_120 ) {
V_120 = ( unsigned long ) F_45 ( V_120 ) ;
...
void T_1 F_49 ( void )
{
F_50 () -> V_122 = F_33 ( ( V_123 ) & V_124 ) ;
F_50 () -> V_125 = ( V_123 ) & V_124 ;
F_40 () ;
if ( F_22 ( V_126 ) )
F_51 () ;
else if ( ! F_41 ( V_127 ) )
...
unsigned int F_54 ( unsigned int V_128 , T_4 V_129 , int V_130 )
{
struct V_131 * V_131 ;
if ( ! F_55 ( F_56 ( V_129 ) ) )
return V_128 ;
V_131 = F_57 ( V_129 ) ;
if ( ! F_58 ( V_132 , & V_131 -> V_133 ) && ! F_59 ( V_131 ) ) {
if ( V_130 == 0x400 ) {
F_60 ( V_131 ) ;
F_61 ( V_132 , & V_131 -> V_133 ) ;
} else
V_128 |= V_4 ;
}
return V_128 ;
}
unsigned int F_62 ( unsigned long V_134 )
{
unsigned long V_135 , V_136 ;
if ( V_134 < V_137 ) {
V_136 = F_50 () -> V_138 . V_139 ;
V_135 = F_63 ( V_134 ) ;
} else {
V_136 = F_50 () -> V_138 . V_140 ;
V_135 = F_64 ( V_134 ) ;
}
...
void F_65 ( struct V_142 * V_143 , unsigned long V_134 )
{
if ( F_66 ( V_143 , V_134 ) == V_54 )
return;
F_67 ( V_143 , V_134 , 1 , V_54 ) ;
#ifdef F_68
F_69 ( V_143 ) ;
#endif
if ( F_62 ( V_134 ) != V_54 ) {
F_50 () -> V_138 = V_143 -> V_138 ;
F_70 () ;
}
}
static int F_71 ( struct V_142 * V_143 , unsigned long V_144 )
{
...
static inline int F_71 ( struct V_142 * V_143 , unsigned long V_144 )
{
return 0 ;
}
void F_72 ( unsigned long V_144 , unsigned long V_157 ,
...
int F_75 ( unsigned long V_144 , unsigned long V_157 , unsigned long V_130 )
{
T_5 * V_160 ;
unsigned long V_23 ;
struct V_142 * V_143 ;
...
V_13 = F_66 ( V_143 , V_144 ) ;
V_14 = F_78 ( V_144 ) ;
V_23 = F_79 ( V_143 -> V_138 . V_170 , V_144 , V_14 ) ;
break;
case V_171 :
V_143 = & V_172 ;
V_23 = F_4 ( V_144 , V_90 ) ;
...
F_76 ( L_33 , V_143 , V_143 -> V_174 , V_23 ) ;
V_160 = V_143 -> V_174 ;
if ( V_160 == NULL )
return 1 ;
V_164 = F_80 ( F_81 () ) ;
if ( V_165 && F_82 ( F_83 ( V_143 ) , V_164 ) )
V_166 = 1 ;
#ifndef F_23
if ( V_13 != V_54 )
V_144 &= ~ ( ( 1ul << V_20 [ V_13 ] . V_18 ) - 1 ) ;
#endif
V_161 = F_84 ( V_160 , V_144 , & V_162 ) ;
if ( V_161 == NULL || ! F_85 ( * V_161 ) ) {
F_76 ( L_34 ) ;
return 1 ;
}
V_157 |= V_175 ;
...
#ifdef F_27
if ( V_162 )
return F_87 ( V_144 , V_157 , V_23 , V_161 , V_130 , V_166 ,
V_14 , V_162 , V_13 ) ;
#endif
#ifndef F_23
F_76 ( L_36 , F_86 ( * V_161 ) ) ;
#else
F_76 ( L_37 , F_86 ( * V_161 ) ,
F_86 ( * ( V_161 + V_176 ) ) ) ;
#endif
#ifdef F_23
if ( ( F_86 ( * V_161 ) & V_177 ) && V_13 == V_55 ) {
F_65 ( V_143 , V_144 ) ;
V_13 = V_54 ;
}
if ( V_80 && V_13 == V_55 &&
...
#ifdef F_37
if ( V_13 == V_55 )
V_70 = F_89 ( V_144 , V_157 , V_23 , V_161 , V_130 , V_166 , V_14 ) ;
else
#endif
{
int V_147 = F_71 ( V_143 , V_144 ) ;
if ( V_157 & V_147 )
V_70 = - 2 ;
else
V_70 = F_90 ( V_144 , V_157 , V_23 , V_161 , V_130 ,
V_166 , V_14 , V_147 ) ;
}
if ( V_70 == - 1 )
F_72 ( V_144 , V_157 , V_23 , V_130 , V_14 , V_13 ,
F_86 ( * V_161 ) ) ;
#ifndef F_23
F_76 ( L_41 , F_86 ( * V_161 ) ) ;
#else
F_76 ( L_42 , F_86 ( * V_161 ) ,
F_86 ( * ( V_161 + V_176 ) ) ) ;
#endif
F_76 ( L_43 , V_70 ) ;
return V_70 ;
}
void F_91 ( struct V_142 * V_143 , unsigned long V_144 ,
...
F_8 ( F_77 ( V_144 ) != V_169 ) ;
#ifdef F_92
if ( F_93 ( F_66 ( V_143 , V_144 ) != V_143 -> V_138 . V_141 ) )
return;
#endif
F_76 ( L_44
...
if ( V_160 == NULL )
return;
V_161 = F_94 ( V_160 , V_144 ) ;
if ( ! V_161 )
return;
#ifdef F_23
if ( F_86 ( * V_161 ) & ( V_177 | V_178 ) )
return;
#endif
V_14 = F_78 ( V_144 ) ;
V_23 = F_79 ( V_143 -> V_138 . V_170 , V_144 , V_14 ) ;
F_95 ( V_133 ) ;
if ( F_82 ( F_83 ( V_143 ) , F_80 ( F_81 () ) ) )
V_166 = 1 ;
#ifdef F_37
...
#endif
V_70 = F_90 ( V_144 , V_157 , V_23 , V_161 , V_130 , V_166 , V_14 ,
F_71 ( V_143 , V_144 ) ) ;
if ( V_70 == - 1 )
F_72 ( V_144 , V_157 , V_23 , V_130 , V_14 ,
V_143 -> V_138 . V_141 , F_86 ( * V_161 ) ) ;
F_96 ( V_133 ) ;
}
void F_97 ( unsigned long V_24 , T_6 V_129 , int V_13 , int V_14 ,
int V_166 )
{
unsigned long V_21 , V_135 , V_18 , V_181 , V_182 ;
F_76 ( L_46 , V_24 ) ;
F_98 (pte, psize, va, index, shift) {
V_21 = F_7 ( V_24 , V_18 , V_14 ) ;
V_181 = F_99 ( V_129 , V_135 ) ;
if ( V_181 & V_183 )
V_21 = ~ V_21 ;
V_182 = ( V_21 & V_26 ) * V_27 ;
V_182 += V_181 & V_184 ;
F_76 ( L_47 , V_135 , V_182 , V_181 ) ;
V_28 . V_185 ( V_182 , V_24 , V_13 , V_14 , V_166 ) ;
} F_100 () ;
}
void F_101 ( unsigned long V_186 , int V_166 )
{
if ( V_28 . F_101 )
V_28 . F_101 ( V_186 , V_166 ) ;
else {
int V_187 ;
struct V_188 * V_189 =
& F_102 ( V_188 ) ;
for ( V_187 = 0 ; V_187 < V_186 ; V_187 ++ )
F_97 ( V_189 -> V_15 [ V_187 ] , V_189 -> V_129 [ V_187 ] ,
V_189 -> V_13 , V_189 -> V_14 , V_166 ) ;
}
}
void F_103 ( struct V_190 * V_191 , unsigned long V_192 , int V_70 )
{
if ( F_104 ( V_191 ) ) {
#ifdef F_105
if ( V_70 == - 2 )
F_106 ( V_193 , V_191 , V_194 , V_192 ) ;
else
#endif
F_106 ( V_195 , V_191 , V_196 , V_192 ) ;
} else
F_107 ( V_191 , V_192 , V_195 ) ;
}
static void F_108 ( unsigned long V_15 , unsigned long V_197 )
{
unsigned long V_21 , V_22 ;
...
static void F_111 ( unsigned long V_15 , unsigned long V_197 )
{
...
void F_112 ( struct V_131 * V_131 , int V_200 , int V_201 )
{
unsigned long V_133 , V_15 , V_197 ;
int V_187 ;
F_95 ( V_133 ) ;
for ( V_187 = 0 ; V_187 < V_200 ; V_187 ++ , V_131 ++ ) {
V_15 = ( unsigned long ) F_113 ( V_131 ) ;
...
void F_114 ( T_7 V_202 ,
T_7 V_203 )
{
F_8 ( V_202 != 0 ) ;
V_116 = F_115 ( V_123 , V_203 , 0x40000000 ) ;
F_48 ( V_116 ) ;
}
