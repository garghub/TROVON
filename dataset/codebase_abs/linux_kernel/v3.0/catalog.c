...
int V_50 ;
int V_51 ;
F_11 ( V_52 , L_1 , V_46 -> V_6 , V_15 , V_16 -> V_53 ) ;
if ( V_20 -> V_54 >= V_55 )
return - V_56 ;
V_2 = V_20 -> V_38 ;
F_12 ( F_8 ( V_2 ) -> V_57 , & V_48 ) ;
...
if ( V_72 )
goto V_78;
type = F_25 ( V_48 . V_79 , V_48 . V_80 ) ;
if ( type == V_28 ) {
struct V_42 V_29 ;
F_26 ( V_48 . V_79 , & V_29 , V_48 . V_80 , sizeof( V_29 ) ) ;
...
struct V_82 * V_83 =
F_29 ( V_77 , struct V_82 , V_84 ) ;
if ( V_48 . V_85 -> V_86 ( V_48 . V_58 , ( void * ) & V_83 -> V_3 ) < 0 )
V_83 -> V_29 -> V_87 -- ;
}
V_72 = F_17 ( & V_48 ) ;
if ( V_72 )
...
int F_30 ( T_2 V_15 , struct V_16 * V_88 , struct V_5 * V_89 ,
struct V_16 * V_90 , struct V_5 * V_91 )
{
struct V_1 * V_2 ;
struct V_47 V_92 , V_93 ;
union T_3 V_49 ;
int V_50 , type ;
int V_51 ;
F_11 ( V_52 , L_5 , V_15 , V_88 -> V_61 , V_89 -> V_6 ,
V_90 -> V_61 , V_91 -> V_6 ) ;
V_2 = V_88 -> V_38 ;
F_12 ( F_8 ( V_2 ) -> V_57 , & V_92 ) ;
V_93 = V_92 ;
F_1 ( V_2 , V_92 . V_58 , V_88 -> V_61 , V_89 ) ;
V_51 = F_13 ( & V_92 ) ;
if ( V_51 )
goto V_78;
if ( V_92 . V_94 > sizeof( V_49 ) || V_92 . V_94 < 0 ) {
V_51 = - V_74 ;
goto V_78;
}
F_26 ( V_92 . V_79 , & V_49 , V_92 . V_80 ,
V_92 . V_94 ) ;
F_1 ( V_2 , V_93 . V_58 , V_90 -> V_61 , V_91 ) ;
V_51 = F_13 ( & V_93 ) ;
if ( V_51 != - V_62 ) {
if ( ! V_51 )
V_51 = - V_63 ;
...
V_51 = F_14 ( & V_93 , & V_49 , V_92 . V_94 ) ;
if ( V_51 )
goto V_78;
V_90 -> V_54 ++ ;
V_90 -> V_66 = V_90 -> V_67 = V_68 ;
F_15 ( V_90 ) ;
F_1 ( V_2 , V_92 . V_58 , V_88 -> V_61 , V_89 ) ;
V_51 = F_13 ( & V_92 ) ;
if ( V_51 )
