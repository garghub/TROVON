...
V_53 , V_82 -> V_86 ) ;
F_2 ( L_11 ,
V_97 , V_53 -> V_64 - V_82 -> V_86 , V_95 ) ;
if ( F_38 ( V_95 >= 0 ) ) {
V_82 -> V_86 += V_95 ;
V_82 -> V_98 += V_95 ;
if ( F_38 ( V_82 -> V_86 >= V_82 -> V_85 ) ) {
V_82 -> V_86 = 0 ;
return 0 ;
}
V_95 = - V_88 ;
...
V_8 = F_181 ( args -> V_299 , sizeof( * V_297 ) , V_296 ) ;
if ( V_8 == NULL ) {
F_2 ( L_87
L_88 ) ;
return F_141 ( - V_300 ) ;
}
V_297 = F_27 ( V_8 , struct V_75 , V_8 ) ;
memcpy ( & V_8 -> V_9 , args -> V_301 , args -> V_38 ) ;
V_8 -> V_38 = args -> V_38 ;
if ( args -> V_219 )
memcpy ( & V_297 -> V_219 , args -> V_219 , args -> V_38 ) ;
else {
int V_57 ;
V_57 = F_178 ( args -> V_301 -> V_16 ,
(struct V_6 * ) & V_297 -> V_219 ) ;
if ( V_57 != 0 )
return F_141 ( V_57 ) ;
}
return V_8 ;
...
{
struct V_10 * V_15 = (struct V_10 * ) args -> V_301 ;
struct V_75 * V_76 ;
struct V_7 * V_8 ;
struct V_7 * V_83 ;
V_8 = F_180 ( args , V_302 ) ;
if ( F_149 ( V_8 ) )
return V_8 ;
V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
V_8 -> V_303 = 0 ;
V_8 -> V_304 = sizeof( V_92 ) / sizeof( T_1 ) ;
V_8 -> V_305 = V_306 ;
V_8 -> V_307 = V_308 ;
V_8 -> V_122 = V_196 ;
V_8 -> V_309 = V_310 ;
...
{
struct V_6 * V_9 = args -> V_301 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
struct V_7 * V_83 ;
V_8 = F_180 ( args , V_316 ) ;
if ( F_149 ( V_8 ) )
return V_8 ;
V_76 = F_27 ( V_8 , struct V_75 , V_8 ) ;
V_8 -> V_303 = V_240 ;
V_8 -> V_304 = 0 ;
V_8 -> V_305 = ( 1U << 16 ) - ( V_317 << 3 ) ;
V_8 -> V_307 = V_308 ;
V_8 -> V_122 = V_318 ;
V_8 -> V_309 = V_310 ;
V_8 -> V_66 = & V_319 ;
...
switch ( V_9 -> V_16 ) {
case V_22 :
if ( ( (struct V_11 * ) V_9 ) -> V_321 != F_186 ( 0 ) )
F_130 ( V_8 ) ;
F_183 ( & V_76 -> V_126 ,
F_148 ) ;
F_15 ( V_8 , L_92 , V_322 ) ;
break;
case V_25 :
if ( ( (struct V_12 * ) V_9 ) -> V_323 != F_186 ( 0 ) )
F_130 ( V_8 ) ;
F_183 ( & V_76 -> V_126 ,
F_148 ) ;
F_15 ( V_8 , L_92 , V_324 ) ;
...
V_8 -> V_19 [ V_32 ] ) ;
F_189 ( V_8 ) ;
args -> V_284 -> V_330 = V_8 ;
V_8 -> V_284 = args -> V_284 ;
V_329 = F_27 ( args -> V_284 , struct V_282 , V_285 ) ;
V_76 -> V_37 = V_329 -> V_332 ;
V_76 -> V_79 = V_329 -> V_333 ;
F_146 ( V_8 ) ;
if ( F_184 ( V_127 ) )
return V_8 ;
F_190 ( V_8 ) ;
...
static int F_198 ( const char * V_340 ,
...
if ( ! V_340 )
return - V_259 ;
V_83 = F_199 ( V_340 , 0 , & V_345 ) ;
if ( V_83 == - V_259 || V_345 < V_343 || V_345 > V_344 )
return - V_259 ;
* ( ( unsigned int * ) V_342 -> V_179 ) = V_345 ;
return 0 ;
}
static int F_200 ( const char * V_340 , const struct V_341 * V_342 )
{
return F_198 ( V_340 , V_342 ,
V_346 ,
V_347 ) ;
}
static int F_201 ( const char * V_340 ,
const struct V_341 * V_342 )
{
return F_198 ( V_340 , V_342 ,
V_348 ,
