...
int T_2 F_15 ( struct F_15 * V_17 , void * V_18 , unsigned long V_19 )
{
int V_14 ;
unsigned long V_12 ;
F_9 ( & V_13 , V_12 ) ;
...
int T_2 F_49 ( unsigned long * V_131 )
{
int V_14 ;
unsigned long V_12 ;
...
int V_14 ;
unsigned long V_12 ;
static struct V_167 T_3 V_168 ( ( F_59 ( 8 ) ) ) ;
F_9 ( & V_13 , V_12 ) ;
V_14 = F_6 ( V_161 , V_169 , F_7 ( V_10 ) ,
V_163 , V_164 , V_165 , F_7 ( & T_3 ) ) ;
if( ! V_14 ) {
* V_39 = V_10 [ 0 ] ;
memcpy ( V_166 , & T_3 , * V_39 ) ;
}
F_10 ( & V_13 , V_12 ) ;
return V_14 ;
}
int F_60 ( struct V_170 * V_171 , void * V_40 )
{
int V_14 ;
unsigned long V_12 ;
F_9 ( & V_13 , V_12 ) ;
...
switch( V_183 ) {
case 1 : * ( V_185 * ) V_166 = ( V_185 ) V_10 [ 0 ] ;
case 2 : * ( V_186 * ) V_166 = ( V_186 ) V_10 [ 0 ] ;
case 4 : * ( V_3 * ) V_166 = ( V_3 ) V_10 [ 0 ] ;
}
F_10 ( & V_13 , V_12 ) ;
return V_14 ;
}
