...
if ( ! F_25 ( V_33 -> V_42 , V_33 -> V_77 + 1 - V_33 -> V_42 ,
V_10 ) ) {
V_60 = - V_75 ;
goto V_76;
}
...
V_3 -> V_4 , V_3 -> V_17 ) ;
V_2 -> V_11 . V_78 = V_79 ;
V_2 -> V_11 . V_57 . V_80 = & V_55 -> V_57 ;
V_2 -> V_11 . V_81 = & V_82 ;
V_2 -> V_11 . V_83 = & V_84 ;
V_2 -> V_11 . V_85 = V_86 | V_87
| V_88 ;
V_2 -> V_11 . V_89 = V_45 ;
V_2 -> V_11 . V_33 [ 0 ] . V_90 = V_33 ;
V_60 = F_27 ( & V_2 -> V_11 ) ;
if ( V_60 < 0 )
goto V_91;
return 0 ;
V_91:
F_28 ( V_33 -> V_42 , V_33 -> V_77 + 1 - V_33 -> V_42 ) ;
V_76:
if ( V_2 -> V_11 . V_43 )
F_29 ( ( void V_92 * ) V_2 -> V_11 . V_43 ) ;
if ( V_3 -> V_17 ) {
F_30 ( V_3 -> V_17 , V_2 ) ;
V_71:
F_31 ( V_3 -> V_17 ) ;
...
struct V_59 * V_33 = V_2 -> V_11 . V_33 [ 0 ] . V_90 ;
F_35 ( & V_2 -> V_11 ) ;
F_28 ( V_33 -> V_42 , V_33 -> V_77 + 1 - V_33 -> V_42 ) ;
F_29 ( ( void V_92 * ) V_2 -> V_11 . V_43 ) ;
if ( V_3 -> V_17 ) {
...
static int F_36 ( struct V_54 * V_55 , T_6 V_93 )
{
struct V_1 * V_2 = F_34 ( V_55 ) ;
struct V_56 * V_3 = V_2 -> V_3 ;
if ( F_37 ( & V_55 -> V_57 ) ) {
