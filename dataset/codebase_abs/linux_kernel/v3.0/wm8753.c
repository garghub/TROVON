...
static int T_4 F_51 ( struct V_138 * V_139 )
{
struct V_7 * V_8 ;
int V_105 ;
V_8 = F_52 ( sizeof( struct V_7 ) , V_140 ) ;
if ( V_8 == NULL )
return - V_141 ;
V_8 -> V_127 = V_142 ;
F_53 ( V_139 , V_8 ) ;
V_105 = F_54 ( & V_139 -> V_128 ,
& V_143 , V_144 , F_11 ( V_144 ) ) ;
if ( V_105 < 0 )
F_55 ( V_8 ) ;
return V_105 ;
}
static int T_5 F_56 ( struct V_138 * V_139 )
{
F_57 ( & V_139 -> V_128 ) ;
F_55 ( F_58 ( V_139 ) ) ;
return 0 ;
}
static T_4 int F_59 ( struct V_145 * V_146 ,
...
F_60 ( V_146 , V_8 ) ;
V_8 -> V_127 = V_149 ;
V_105 = F_54 ( & V_146 -> V_128 ,
& V_143 , V_144 , F_11 ( V_144 ) ) ;
if ( V_105 < 0 )
F_55 ( V_8 ) ;
return V_105 ;
}
static T_5 int F_61 ( struct V_145 * V_150 )
{
F_57 ( & V_150 -> V_128 ) ;
F_55 ( F_62 ( V_150 ) ) ;
return 0 ;
