...
if ( ( V_107 = F_97 ( V_108 , V_214 , V_2 , & V_141 ) ) < 0 ) {
F_78 ( V_2 ) ;
return V_107 ;
}
F_58 ( V_2 ) ;
...
if ( ( V_206 = F_3 ( V_2 , V_224 ) ) != ( V_225 | V_226 ) ) {
F_7 ( V_19 L_17 , V_206 ) ;
return - V_222 ;
}
if ( ( V_206 = F_3 ( V_2 , V_227 ) ) != ( V_228 | V_229 ) ) {
F_7 ( V_19 L_18 , V_206 ) ;
return - V_222 ;
}
F_1 ( V_2 , V_201 , V_230 | V_231 |
V_232 | V_233 |
V_234 | V_235 ) ;
F_1 ( V_2 , V_200 , 0 ) ;
F_1 ( V_2 , V_236 , 0 ) ;
...
F_1 ( V_2 , V_200 , V_242 ) ;
F_99 ( 50 ) ;
F_1 ( V_2 , V_200 , V_243 | V_242 ) ;
V_215 = V_244 + V_245 ;
do {
if ( F_3 ( V_2 , V_200 ) & V_246 )
goto V_247;
F_101 ( 1 ) ;
} while ( F_102 ( V_215 , V_244 ) );
F_7 ( V_19 L_19 ) ;
return - V_222 ;
V_247:
F_1 ( V_2 , V_13 , V_16 ) ;
...
V_215 = V_244 + V_245 ;
do {
if ( ( F_3 ( V_2 , V_251 ) & ( F_103 ( 3 ) | F_103 ( 4 ) ) ) == ( F_103 ( 3 ) | F_103 ( 4 ) ) )
goto V_30;
F_101 ( 1 ) ;
} while ( F_102 ( V_215 , V_244 ) );
if ( -- V_216 > 0 )
...
return - V_222 ;
V_30:
F_1 ( V_2 , V_252 , F_104 ( 3 ) | F_104 ( 4 ) ) ;
for ( V_206 = 0 ; V_206 < 4 ; V_206 ++ ) {
struct V_34 * V_35 = & V_2 -> V_35 [ V_206 ] ;
V_35 -> V_80 = V_253 + ( V_206 * 0x10 ) ;
V_35 -> V_254 = V_255 + ( V_206 * 0x10 ) ;
V_35 -> V_82 = V_256 + ( V_206 * 0x10 ) ;
V_35 -> V_99 = V_257 + ( V_206 * 0x10 ) ;
V_35 -> V_46 = V_258 + ( V_206 * 8 ) ;
V_35 -> V_55 = V_259 + ( V_206 * 8 ) ;
V_35 -> V_260 = V_261 + ( V_206 * 4 ) ;
V_35 -> V_52 = V_53 + ( V_206 * 4 ) ;
V_35 -> V_96 = V_262 + ( V_206 * 4 ) ;
...
static int F_107 ( struct V_272 * V_32 )
{
struct V_1 * V_2 = V_32 -> V_273 -> V_9 ;
F_29 ( & V_2 -> V_37 ) ;
V_2 -> V_270 |= V_274 ;
V_2 -> V_275 = V_32 ;
if ( ! ( V_2 -> V_276 & V_277 ) ) {
...
static int F_108 ( struct V_272 * V_32 )
{
struct V_1 * V_2 = V_32 -> V_273 -> V_9 ;
F_29 ( & V_2 -> V_37 ) ;
...
static int F_109 ( struct V_272 * V_32 )
{
struct V_1 * V_2 = V_32 -> V_273 -> V_9 ;
F_29 ( & V_2 -> V_37 ) ;
V_2 -> V_276 |= V_277 ;
...
static int F_110 ( struct V_272 * V_32 )
{
struct V_1 * V_2 = V_32 -> V_273 -> V_9 ;
F_29 ( & V_2 -> V_37 ) ;
...
static void F_111 ( struct V_272 * V_32 , int V_283 )
{
unsigned long V_284 ;
struct V_1 * V_2 = V_32 -> V_273 -> V_9 ;
F_112 ( & V_2 -> V_37 , V_284 ) ;
if ( V_283 ) {
...
F_113 ( & V_2 -> V_37 , V_284 ) ;
}
static void F_114 ( struct V_272 * V_32 , int V_283 )
{
unsigned long V_284 ;
struct V_1 * V_2 = V_32 -> V_273 -> V_9 ;
unsigned char V_285 ;
...
if ( V_290 )
* V_290 = NULL ;
if ( ( V_107 = F_117 ( V_2 -> V_108 , L_4 , V_103 , 1 , 1 , & V_273 ) ) < 0 )
return V_107 ;
strcpy ( V_273 -> V_114 , L_4 ) ;
F_118 ( V_273 , V_291 , & V_292 ) ;
F_118 ( V_273 , V_293 , & V_294 ) ;
...
static T_7 V_212 ( int V_198 , void * V_298 )
{
struct V_1 * V_2 = V_298 ;
unsigned int V_299 , V_35 , V_4 ;
struct V_34 * V_300 ;
if ( V_2 == NULL )
return V_301 ;
V_299 = F_3 ( V_2 , V_302 ) ;
...
if ( V_299 & ( F_105 ( 0 ) | F_105 ( 1 ) | F_105 ( 2 ) | F_105 ( 3 ) ) ) {
...
V_300 -> V_75 ++ ;
if ( ( V_4 & V_303 ) && ! ( V_300 -> V_75 & 1 ) ) {
V_300 -> V_75 -- ;
V_2 -> V_152 ++ ;
F_12 ( & V_2 -> V_37 ) ;
continue;
}
if ( ( V_4 & V_304 ) && ( V_300 -> V_75 & 1 ) ) {
V_300 -> V_75 -- ;
V_2 -> V_153 ++ ;
F_12 ( & V_2 -> V_37 ) ;
continue;
...
if ( ( V_2 -> V_270 & V_278 ) == 0 )
continue;
F_120 ( V_2 -> V_275 , & V_162 , 1 ) ;
}
while ( ( F_3 ( V_2 , V_286 ) & V_287 ) == 0 ) {
if ( ( V_2 -> V_270 & V_282 ) == 0 )
break;
if ( F_115 ( V_2 -> V_281 , & V_162 , 1 ) != 1 ) {
V_2 -> V_270 &= ~ V_282 ;
F_1 ( V_2 , V_269 , V_2 -> V_270 ) ;
break;
}
...
static void F_121 ( struct V_308 * V_309 , unsigned short V_33 ,
unsigned char V_4 )
{
unsigned long V_284 ;
...
V_310 = V_2 -> V_5 + V_313 ;
F_112 ( & V_309 -> V_37 , V_284 ) ;
F_2 ( ( unsigned int ) V_33 , V_310 ) ;
F_6 ( 10 ) ;
F_2 ( ( unsigned int ) V_4 , V_310 + 4 ) ;
F_6 ( 30 ) ;
F_113 ( & V_309 -> V_37 , V_284 ) ;
}
...
V_107 = F_123 ( V_320 [ V_190 ] , V_321 [ V_190 ] , V_322 , 0 , & V_108 ) ;
if ( V_107 < 0 )
return V_107 ;
...
if ( ( V_107 = F_125 ( V_108 , V_323 , & V_309 ) ) < 0 ) {
F_124 ( V_108 ) ;
return V_107 ;
}
V_309 -> V_9 = V_2 ;
V_309 -> V_324 = F_121 ;
F_126 ( V_309 ) ;
if ( ( V_107 = F_127 ( V_309 , 0 , 1 , NULL ) ) < 0 ) {
F_124 ( V_108 ) ;
return V_107 ;
}
F_67 ( V_2 ) ;
strcpy ( V_108 -> V_325 , L_4 ) ;
strcpy ( V_108 -> V_326 , L_23 ) ;
sprintf ( V_108 -> V_327 , L_24 ,
V_108 -> V_326 ,
V_2 -> V_210 ,
V_2 -> V_198 ) ;
...
static int F_132 ( struct V_204 * V_116 , T_10 V_328 )
{
...
F_1 ( V_2 , V_200 , V_329 ) ;
F_1 ( V_2 , V_265 , V_333 ) ;
for ( V_330 = 0 ; V_330 < F_136 ( V_334 ) ; V_330 ++ )
if ( V_334 [ V_330 ] )
