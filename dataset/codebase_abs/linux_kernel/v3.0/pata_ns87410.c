...
F_9 ( V_24 , & V_7 -> V_9 , L_1 , V_15 -> V_23 ) ;
return;
}
V_20 . V_25 = F_10 ( V_20 . V_25 , 2 , 16 ) - 2 ;
V_20 . V_26 = F_10 ( V_20 . V_26 , 1 , 4 ) - 1 ;
V_20 . V_27 = F_10 ( V_20 . V_27 , 1 , 12 ) - 1 ;
V_17 = ( V_20 . V_26 << 6 ) | ( V_22 [ V_20 . V_27 ] << 3 ) | V_21 [ V_20 . V_25 ] ;
F_11 ( V_7 , V_16 , V_17 ) ;
...
struct V_14 * V_15 = V_30 -> V_9 ;
if ( V_15 -> V_23 && V_15 != V_5 -> V_28 )
F_5 ( V_5 , V_15 ) ;
return F_13 ( V_30 ) ;
}
static int F_14 ( struct V_6 * V_9 , const struct V_31 * V_32 )
{
...
const struct V_33 * V_41 [] = { & V_34 , NULL } ;
return F_15 ( V_9 , V_41 , & V_42 , NULL , 0 ) ;
}
