...
F_12 ( V_2 , F_16 ( 10 , 0 ) ,
F_2 ( V_54 ) , V_54 ) ;
if ( ( V_42 -> V_55 == 0x4325 ) && ( V_42 -> V_56 == 0 ) ) {
F_12 ( V_2 , F_16 ( 13 , 0 ) ,
F_2 ( V_57 ) , V_57 ) ;
F_12 ( V_2 , F_15 ( 14 , 0 ) ,
F_2 ( V_58 ) , V_58 ) ;
...
V_62 |= V_26 . V_65 << 4 ;
V_62 |= V_26 . V_66 ;
F_11 ( V_2 , F_16 ( 10 , 0xC0 + V_11 ) , V_62 ) ;
V_62 = V_26 . V_67 << 20 ;
F_11 ( V_2 , F_16 ( 10 , 0x140 + V_11 ) , V_62 ) ;
}
...
F_11 ( V_2 , F_16 ( 7 , 0xC0 + V_11 ) , V_62 ) ;
V_62 = V_26 . V_67 << 20 ;
V_62 |= V_26 . V_66 << 28 ;
F_11 ( V_2 , F_16 ( 7 , 0x140 + V_11 ) , V_62 ) ;
}
...
void F_21 ( struct V_1 * V_2 , int V_11 , int V_69 ,
struct V_61 * V_70 )
{
int V_5 ;
for ( V_5 = V_11 ; V_5 < V_69 ; V_5 ++ )
F_20 ( V_2 , V_5 , V_70 [ V_5 ] ) ;
}
