...
return;
do {
register unsigned int V_1 = V_12 -> V_15 -> V_16 [ 0 ] -> V_17 ;
...
{
T_2 * V_12 = ( T_2 * ) ( V_22 -> V_69 ) ;
F_27 ( & ( V_12 -> V_20 ) ) ;
return 0 ;
}
static int F_28 ( struct V_68 * V_22 )
{
F_29 ( V_46 , & ( V_22 -> V_47 ) ) ;
return 0 ;
}
static int F_30 ( struct V_68 * V_22 )
{
if ( ! F_31 ( V_46 , & ( V_22 -> V_47 ) ) )
return 0 ;
F_26 ( V_22 ) ;
return 0 ;
}
...
memcpy ( F_33 ( V_19 , 1 ) , & F_18 ( V_19 ) -> V_35 , 1 ) ;
F_34 ( & ( V_12 -> V_20 ) , V_19 ) ;
F_35 ( & ( V_12 -> V_63 ) , V_47 ) ;
F_9 ( V_12 ) ;
F_36 ( & ( V_12 -> V_63 ) , V_47 ) ;
...
static void F_37 ( struct V_68 * V_22 )
{
}
static int F_38 ( struct V_68 * V_22 , unsigned int V_75 , unsigned long V_76 )
{
return - V_77 ;
}
static int F_39 ( T_2 * V_12 , const unsigned char * V_78 ,
int V_79 )
{
char * V_80 = ( char * ) V_78 ;
char V_81 [ 9 ] ;
unsigned int V_1 , V_25 , V_2 , V_82 , V_83 ;
int V_84 , V_85 = 0 ;
V_1 = V_12 -> V_15 -> V_16 [ 0 ] -> V_17 ;
...
memcpy ( V_81 , V_80 + 2 , 2 ) ;
V_25 = F_41 ( V_81 , NULL , 16 ) ;
memset ( V_81 , 0 , sizeof( V_81 ) ) ;
memcpy ( V_81 , V_80 + 4 , 8 ) ;
V_2 = F_41 ( V_81 , NULL , 16 ) ;
memset ( V_81 , 0 , sizeof( V_81 ) ) ;
memcpy ( V_81 , V_80 + ( V_25 * 2 ) + 2 , 2 ) ;
V_82 = F_41 ( V_81 , NULL , 16 ) ;
memset ( V_81 , 0 , sizeof( V_81 ) ) ;
for ( V_83 = 0 , V_84 = 0 ; V_84 < V_25 ; V_84 ++ ) {
memcpy ( V_81 , V_80 + ( V_84 * 2 ) + 2 , 2 ) ;
V_83 += F_42 ( V_81 , NULL , 16 ) ;
}
if ( ( ( V_83 + V_82 ) & 0xff ) != 0xff ) {
F_10 ( L_11 ) ;
V_85 = - V_87 ;
goto error;
}
...
F_1 ( V_1 , V_2 ) ;
memset ( V_81 , 0 , sizeof( V_81 ) ) ;
for ( V_84 = 0 ; V_84 < ( V_25 - 4 ) / 2 ; V_84 ++ ) {
memcpy ( V_81 , V_80 + ( V_84 * 4 ) + 12 , 4 ) ;
V_83 = F_41 ( V_81 , NULL , 16 ) ;
F_3 ( V_1 , V_83 ) ;
}
}
V_80 += ( V_25 * 2 ) + 6 ;
...
V_22 -> V_96 = F_38 ;
V_22 -> V_97 = V_98 ;
V_85 = F_48 ( & V_78 , L_13 , & V_12 -> V_15 -> V_34 ) ;
if ( V_85 < 0 ) {
F_10 ( L_14 ) ;
goto error;
}
V_85 = F_39 ( V_12 , V_78 -> V_21 , V_78 -> V_25 ) ;
F_49 ( V_78 ) ;
if ( V_85 < 0 ) {
F_10 ( L_15 ) ;
goto error;
...
{
T_2 * V_12 = V_100 -> V_102 ;
F_59 ( V_100 ) ;
F_60 ( V_12 ) ;
}
static int F_61 ( struct V_99 * V_15 , void * V_107 )
{
int * V_108 = V_107 ;
if ( V_108 == 0 )
V_15 -> V_109 = 16 ;
if ( ( V_15 -> V_16 [ 0 ] -> V_110 != 8 ) || ( V_15 -> V_16 [ 0 ] -> V_17 == 0 ) )
return - V_111 ;
V_15 -> V_16 [ 0 ] -> V_110 = 8 ;
V_15 -> V_16 [ 0 ] -> V_47 &= ~ V_112 ;
V_15 -> V_16 [ 0 ] -> V_47 |= V_113 ;
return F_62 ( V_15 ) ;
}
static int F_63 ( struct V_99 * V_15 ,
void * V_107 )
{
static unsigned int V_114 [ 5 ] = { 0x3f8 , 0x2f8 , 0x3e8 , 0x2e8 , 0x0 } ;
int V_115 ;
if ( V_15 -> V_109 > 3 )
return - V_70 ;
V_15 -> V_16 [ 0 ] -> V_47 &= ~ V_112 ;
...
V_15 -> V_16 [ 0 ] -> V_17 = V_114 [ V_115 ] ;
V_15 -> V_109 = V_114 [ V_115 ] ? 16 : 3 ;
if ( ! F_62 ( V_15 ) )
return 0 ;
}
return - V_70 ;
...
if ( ! F_64 ( V_100 , F_61 , ( void * ) V_108 ) )
goto V_116;
if ( ! F_64 ( V_100 , F_63 , NULL ) )
goto V_116;
F_10 ( L_18 ) ;
goto V_117;
V_116:
V_84 = F_65 ( V_100 , & F_22 ) ;
if ( V_84 != 0 )
goto V_117;
V_84 = F_66 ( V_100 ) ;
if ( V_84 != 0 )
