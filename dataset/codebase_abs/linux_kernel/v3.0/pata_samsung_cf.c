...
static void F_39 ( void * V_1 , bool V_101 )
{
T_3 V_41 = F_2 ( V_1 + V_102 ) ;
V_41 = V_101 ? ( V_41 | 1 ) : ( V_41 & ~ 1 ) ;
F_3 ( V_41 , V_1 + V_102 ) ;
}
static T_6 F_40 ( int V_103 , void * V_104 )
{
struct V_39 * V_24 = V_104 ;
struct V_9 * V_10 = V_24 -> V_25 ;
T_3 V_3 ;
V_3 = F_2 ( V_10 -> V_29 + V_105 ) ;
F_3 ( V_3 , V_10 -> V_29 + V_105 ) ;
return F_41 ( V_103 , V_104 ) ;
}
...
F_39 ( V_10 -> V_29 , true ) ;
F_43 ( 100 ) ;
F_3 ( 0x1f , V_10 -> V_29 + V_105 ) ;
F_3 ( 0x1b , V_10 -> V_29 + V_111 ) ;
break;
case V_112 :
F_4 ( V_10 -> V_110 ) ;
case V_113 :
...
F_39 ( V_10 -> V_29 , true ) ;
F_43 ( 100 ) ;
F_3 ( 0x3f , V_10 -> V_29 + V_105 ) ;
F_3 ( 0x3f , V_10 -> V_29 + V_111 ) ;
break;
default:
F_44 () ;
}
...
{
struct V_106 * V_107 = V_115 -> V_78 . V_116 ;
struct V_70 * V_78 = & V_115 -> V_78 ;
struct V_9 * V_10 ;
struct V_117 * V_118 ;
struct V_20 * V_21 ;
struct V_39 * V_24 ;
enum V_119 V_108 ;
int V_120 ;
V_108 = F_46 ( V_115 ) -> V_121 ;
V_10 = F_47 ( V_78 , sizeof( * V_10 ) , V_122 ) ;
if ( ! V_10 ) {
F_27 ( V_78 , L_3 ) ;
return - V_123 ;
}
V_10 -> V_103 = F_48 ( V_115 , 0 ) ;
V_118 = F_49 ( V_115 , V_124 , 0 ) ;
if ( V_118 == NULL ) {
F_27 ( V_78 , L_4 ) ;
return - V_125 ;
}
if ( ! F_50 ( V_78 , V_118 -> V_126 ,
F_51 ( V_118 ) , V_127 ) ) {
F_27 ( V_78 , L_5 ) ;
return - V_38 ;
}
V_10 -> V_29 = F_52 ( V_78 , V_118 -> V_126 , F_51 ( V_118 ) ) ;
if ( ! V_10 -> V_29 ) {
F_27 ( V_78 , L_6 ) ;
return - V_123 ;
}
V_10 -> V_31 = F_53 ( & V_115 -> V_78 , L_7 ) ;
if ( F_54 ( V_10 -> V_31 ) ) {
F_27 ( V_78 , L_8 ) ;
V_120 = F_55 ( V_10 -> V_31 ) ;
V_10 -> V_31 = NULL ;
return V_120 ;
}
F_56 ( V_10 -> V_31 ) ;
...
V_21 -> V_46 . V_136 = V_10 -> V_29 + V_137 ;
V_21 -> V_46 . V_83 = V_10 -> V_29 + V_138 ;
V_21 -> V_46 . V_72 = V_10 -> V_29 + V_139 ;
V_21 -> V_46 . V_55 = V_10 -> V_29 + V_139 ;
V_21 -> V_46 . V_57 = V_10 -> V_29 + V_140 ;
V_21 -> V_46 . V_59 = V_10 -> V_29 + V_141 ;
V_21 -> V_46 . V_61 = V_10 -> V_29 + V_142 ;
V_21 -> V_46 . V_63 = V_10 -> V_29 + V_143 ;
V_21 -> V_46 . V_71 = V_10 -> V_29 + V_144 ;
V_21 -> V_46 . V_76 = V_10 -> V_29 + V_145 ;
V_21 -> V_46 . V_75 = V_10 -> V_29 + V_145 ;
V_21 -> V_46 . V_77 = V_10 -> V_29 + V_146 ;
V_21 -> V_46 . V_52 = V_10 -> V_29 + V_146 ;
F_58 ( V_21 , L_11 ,
( unsigned long long ) V_118 -> V_126 ) ;
V_24 -> V_25 = V_10 ;
if ( V_107 && V_107 -> V_147 )
V_107 -> V_147 () ;
F_42 ( V_10 , V_107 ) ;
F_59 ( V_115 , V_24 ) ;
return F_60 ( V_24 , V_10 -> V_103 ,
V_10 -> V_103 ? F_40 : NULL ,
0 , & V_148 ) ;
V_128:
F_61 ( V_10 -> V_31 ) ;
F_62 ( V_10 -> V_31 ) ;
...
static int T_8 F_63 ( struct V_114 * V_115 )
{
struct V_39 * V_24 = F_64 ( V_115 ) ;
struct V_9 * V_10 = V_24 -> V_25 ;
F_65 ( V_24 ) ;
F_61 ( V_10 -> V_31 ) ;
F_62 ( V_10 -> V_31 ) ;
...
{
struct V_114 * V_115 = F_67 ( V_78 ) ;
struct V_39 * V_24 = F_64 ( V_115 ) ;
return F_68 ( V_24 , V_149 ) ;
}
