...
static int F_28 ( struct V_2 * V_3 , struct V_11 * V_38 )
{
int V_47 = F_29 ( V_38 ) -> V_48 ;
...
if ( ! V_6 || ! V_6 -> V_34 )
continue;
if ( F_27 ( V_6 -> V_35 ) >= V_64 )
continue;
if ( F_27 ( V_6 -> V_34 ) < V_42 )
continue;
if ( F_27 ( V_6 -> V_46 ) < V_51 )
continue;
V_45 = V_44 ;
V_64 = F_27 ( V_6 -> V_35 ) ;
}
...
V_56 = V_42 - V_49 / 4 ;
V_57 = V_51 - F_31 ( V_3 ) / 4 ;
V_54 = F_31 ( V_3 ) / F_32 ( V_52 , ( T_2 ) V_67 ) ;
if ( V_54 * V_68 > V_49 )
V_54 = V_49 / V_68 ;
if ( V_54 > 255 )
V_54 = 255 ;
...
if ( ! V_6 || ! V_6 -> V_34 )
continue;
if ( F_27 ( V_6 -> V_35 ) >= V_55 )
continue;
if ( F_27 ( V_6 -> V_34 ) < V_56 )
continue;
if ( F_27 ( V_6 -> V_46 ) < V_57 )
continue;
return V_44 ;
}
V_65:
...
struct V_11 * F_34 ( T_1 * V_10 , struct V_11 * V_69 ,
...
V_15 -> V_33 , F_12 ( V_3 ) , V_14 ) ;
if ( V_14 < F_12 ( V_3 ) ) {
F_13 ( V_15 , L_10 ) ;
V_24 = F_14 ( V_10 , V_15 ) ;
if ( V_24 )
goto V_81;
if ( ! F_39 ( F_16 ( V_22 , V_44 ) ,
V_14 , V_15 -> V_33 ) ) {
F_13 ( V_15 ,
L_12 ) ;
V_24 = F_22 ( V_10 ,
...
if ( V_24 )
goto V_105;
V_24 = F_52 ( V_10 , V_11 , V_69 ) ;
if ( V_24 )
goto V_114;
V_24 = F_53 ( V_10 , V_11 , V_69 , V_70 ) ;
if ( V_24 )
goto V_114;
V_24 = F_54 ( V_10 , V_11 ) ;
if ( V_24 ) {
...
struct V_11 * F_59 ( struct V_2 * V_3 , unsigned long V_14 )
{
...
if ( ! F_61 ( V_17 , V_15 -> V_33 ) )
goto V_119;
V_11 = F_62 ( V_3 , V_14 ) ;
if ( F_63 ( V_11 ) )
goto V_120;
if ( V_11 -> V_26 && ! F_64 ( V_11 ) )
goto V_119;
if ( F_65 ( V_11 ) > V_117 )
goto V_119;
F_23 ( V_15 ) ;
...
unsigned long F_68 ( struct V_2 * V_3 )
{
unsigned long V_123 ;
struct V_5 * V_18 ;
int V_58 ;
...
if ( ! V_18 )
continue;
V_123 += F_27 ( V_18 -> V_34 ) ;
F_23 ( V_15 ) ;
V_15 = F_1 ( V_3 , V_58 ) ;
if ( ! V_15 )
continue;
V_125 = F_70 ( V_15 , F_12 ( V_3 ) / 8 ) ;
F_8 ( L_26 ,
V_58 , F_27 ( V_18 -> V_34 ) , V_125 ) ;
V_124 += V_125 ;
}
F_23 ( V_15 ) ;
F_8 ( L_27 ,
...
unsigned long F_72 ( struct V_2 * V_3 )
{
