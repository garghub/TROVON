...
{
struct V_1 * V_2 = V_16 -> V_29 . V_2 ;
struct V_12 * V_13 = V_2 -> V_14 ;
unsigned int V_21 = F_1 ( V_2 , V_16 -> V_4 ) ;
int V_32 ;
if ( V_13 -> V_17 . V_22 -> V_23 ) {
V_32 = F_12 ( V_16 -> V_31 ,
V_16 -> V_29 . V_30 >> V_28 ,
...
{
F_4 ( V_16 -> V_26 -> V_27 >> V_28 ,
V_16 -> V_29 . V_30 >> V_28 ) ;
if ( V_16 -> V_24 ) {
F_14 ( V_16 -> V_24 , V_16 -> V_25 ) ;
V_16 -> V_24 = NULL ;
}
}
