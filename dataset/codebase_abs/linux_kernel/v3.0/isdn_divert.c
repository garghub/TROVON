...
unsigned long V_2 ;
if ( ! ( V_70 = F_9 ( sizeof( struct V_69 ) ,
V_72 ) ) )
return ( - V_44 ) ;
V_70 -> V_73 = * V_68 ;
F_2 ( & V_5 , V_2 ) ;
...
if ( ! V_78 ) continue;
if ( ( strcmp ( V_76 -> V_73 . V_85 , L_7 ) ) || ( V_63 -> V_21 . V_22 . V_23 [ 0 ] ) )
{ V_39 = V_76 -> V_73 . V_85 ;
...
if ( ! V_4 -> V_6 . V_15 )
{ strcpy ( V_63 -> V_21 . V_22 . V_25 , L_8 ) ;
...
V_4 = V_28 ;
while ( V_4 )
{ if ( ( V_63 -> V_48 == V_4 -> V_9 . V_48 ) && ( V_63 -> V_1 == V_4 -> V_9 . V_1 ) )
{ switch ( V_63 -> V_10 )
{ case V_109 :
