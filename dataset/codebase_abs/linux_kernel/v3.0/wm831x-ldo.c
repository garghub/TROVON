...
int V_50 = V_44 -> V_50 % F_22 ( V_48 -> V_4 ) ;
struct V_3 * V_4 ;
struct V_51 * V_52 ;
int V_21 , V_9 ;
F_23 ( & V_44 -> V_45 , L_1 , V_50 + 1 ) ;
if ( V_48 == NULL || V_48 -> V_4 [ V_50 ] == NULL )
return - V_53 ;
V_4 = F_24 ( sizeof( struct V_3 ) , V_54 ) ;
if ( V_4 == NULL ) {
F_25 ( & V_44 -> V_45 , L_2 ) ;
return - V_55 ;
}
V_4 -> V_5 = V_5 ;
V_52 = F_26 ( V_44 , V_56 , 0 ) ;
if ( V_52 == NULL ) {
F_25 ( & V_44 -> V_45 , L_3 ) ;
V_21 = - V_17 ;
goto V_57;
...
V_4 -> V_23 = V_52 -> V_58 ;
snprintf ( V_4 -> V_59 , sizeof( V_4 -> V_59 ) , L_4 , V_50 + 1 ) ;
V_4 -> V_60 . V_59 = V_4 -> V_59 ;
V_4 -> V_60 . V_50 = V_50 ;
V_4 -> V_60 . type = V_61 ;
V_4 -> V_60 . V_62 = V_16 + 1 ;
V_4 -> V_60 . V_63 = & V_64 ;
V_4 -> V_60 . V_65 = V_66 ;
V_4 -> V_11 = F_27 ( & V_4 -> V_60 , & V_44 -> V_45 ,
V_48 -> V_4 [ V_50 ] , V_4 ) ;
if ( F_28 ( V_4 -> V_11 ) ) {
V_21 = F_29 ( V_4 -> V_11 ) ;
F_25 ( V_5 -> V_45 , L_5 ,
...
static T_3 int F_35 ( struct V_43 * V_44 )
{
struct V_3 * V_4 = F_36 ( V_44 ) ;
F_32 ( V_44 , NULL ) ;
F_37 ( F_30 ( V_44 , L_6 ) , V_4 ) ;
F_33 ( V_4 -> V_11 ) ;
F_34 ( V_4 ) ;
return 0 ;
}
...
if ( V_14 <= V_70 )
return 1600000 + ( ( V_14 - V_69 )
* 100000 ) ;
return - V_17 ;
}
static int F_39 ( struct V_1 * V_2 , int V_7 ,
int V_18 , int V_19 ,
unsigned * V_14 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
int V_7 = V_4 -> V_23 + V_26 ;
unsigned int V_14 ;
return F_39 ( V_2 , V_7 , V_25 , V_25 , & V_14 ) ;
}
...
static T_2 int F_46 ( struct V_43 * V_44 )
{
struct V_5 * V_5 = F_21 ( V_44 -> V_45 . V_46 ) ;
struct V_47 * V_48 = V_5 -> V_45 -> V_49 ;
int V_50 = V_44 -> V_50 % F_22 ( V_48 -> V_4 ) ;
...
static T_3 int F_47 ( struct V_43 * V_44 )
{
struct V_3 * V_4 = F_36 ( V_44 ) ;
F_37 ( F_30 ( V_44 , L_6 ) , V_4 ) ;
F_33 ( V_4 -> V_11 ) ;
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_7 = V_4 -> V_23 + V_76 ;
return F_49 ( V_2 , V_7 , V_18 , V_19 ,
V_14 ) ;
}
...
unsigned V_14 ;
return F_49 ( V_2 , V_7 , V_25 , V_25 , & V_14 ) ;
}
...
static T_2 int F_54 ( struct V_43 * V_44 )
{
struct V_5 * V_5 = F_21 ( V_44 -> V_45 . V_46 ) ;
struct V_47 * V_48 = V_5 -> V_45 -> V_49 ;
int V_50 = V_44 -> V_50 % F_22 ( V_48 -> V_4 ) ;
...
static T_3 int F_55 ( struct V_43 * V_44 )
{
struct V_3 * V_4 = F_36 ( V_44 ) ;
F_33 ( V_4 -> V_11 ) ;
F_34 ( V_4 ) ;
