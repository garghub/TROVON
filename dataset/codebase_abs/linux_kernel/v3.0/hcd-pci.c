...
F_26 ( V_16 ) ;
V_29 = F_27 ( V_4 , V_16 -> V_35 , V_51 | V_52 ) ;
if ( V_29 != 0 )
goto V_53;
F_8 ( V_16 , V_4 ) ;
if ( F_28 ( V_16 ) )
...
if ( ! V_4 )
return;
if ( F_41 ( V_54 , & V_4 -> V_38 ) &&
V_4 -> V_28 -> V_55 ) {
V_4 -> V_28 -> V_55 ( V_4 ) ;
F_33 ( V_16 ) ;
}
}
static void F_42 ( struct V_1 * V_1 , int V_56 )
{
if ( F_43 ( V_57 ) ) {
struct V_58 * V_59 ;
V_59 = F_44 ( V_1 ) ;
...
static inline void F_42 ( struct V_1 * V_1 , int V_56 )
{}
static int F_46 ( struct V_61 * V_16 )
{
...
static int F_50 ( struct V_61 * V_16 , bool V_63 )
{
struct V_1 * V_1 = F_47 ( V_16 ) ;
struct V_3 * V_4 = F_4 ( V_1 ) ;
int V_29 ;
...
F_52 ( V_4 -> V_62 ) )
return - V_43 ;
V_29 = V_4 -> V_28 -> V_64 ( V_4 , V_63 ) ;
F_53 ( V_4 -> V_28 -> V_64 , V_29 ) ;
if ( ( V_29 == 0 && V_63 && F_52 ( V_4 ) ) ||
( V_29 == 0 && V_63 && V_4 -> V_62 &&
F_52 ( V_4 -> V_62 ) ) ) {
if ( V_4 -> V_28 -> V_65 )
V_4 -> V_28 -> V_65 ( V_4 , false ) ;
V_29 = - V_43 ;
}
if ( V_29 )
return V_29 ;
...
static int F_55 ( struct V_61 * V_16 , int V_67 )
{
struct V_1 * V_1 = F_47 ( V_16 ) ;
struct V_3 * V_4 = F_4 ( V_1 ) ;
int V_29 ;
...
F_56 ( V_68 , & V_4 -> V_38 ) ;
if ( V_4 -> V_62 )
F_56 ( V_68 , & V_4 -> V_62 -> V_38 ) ;
if ( V_4 -> V_28 -> V_65 && ! F_51 ( V_4 ) ) {
if ( V_67 != V_69 )
F_13 ( V_1 , V_4 ) ;
V_29 = V_4 -> V_28 -> V_65 ( V_4 ,
V_67 == V_70 ) ;
if ( V_29 ) {
F_17 ( V_16 , L_11 , V_29 ) ;
if ( V_4 -> V_62 )
...
static int F_58 ( struct V_61 * V_16 )
{
return F_50 ( V_16 , F_59 ( V_16 ) ) ;
}
static int F_60 ( struct V_61 * V_16 )
{
struct V_1 * V_1 = F_47 ( V_16 ) ;
struct V_3 * V_4 = F_4 ( V_1 ) ;
int V_29 ;
...
static int F_65 ( struct V_61 * V_16 )
{
struct V_1 * V_1 = F_47 ( V_16 ) ;
F_42 ( V_1 , 1 ) ;
F_66 ( V_1 ) ;
...
static int F_67 ( struct V_61 * V_16 )
{
return F_55 ( V_16 , V_72 ) ;
}
static int F_68 ( struct V_61 * V_16 )
{
return F_55 ( V_16 , V_70 ) ;
}
static int F_69 ( struct V_61 * V_16 )
{
int V_29 ;
V_29 = F_50 ( V_16 , true ) ;
if ( V_29 == 0 )
...
static int F_70 ( struct V_61 * V_16 )
{
int V_29 ;
F_42 ( F_47 ( V_16 ) , 1 ) ;
V_29 = F_55 ( V_16 , V_69 ) ;
