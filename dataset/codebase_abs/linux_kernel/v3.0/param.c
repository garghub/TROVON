...
if ( V_79 > V_28 ) {
unsigned int V_80 = V_81 [ V_28 ] ;
F_1 ( & V_80 , & V_3 , V_5 ) ;
if ( V_27 -> V_82 . type == V_83 )
F_7 ( V_27 ,
V_80 ) ;
} else {
if ( V_27 -> V_82 . type == V_83 )
