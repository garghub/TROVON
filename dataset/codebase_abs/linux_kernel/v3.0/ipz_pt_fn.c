...
V_7 V_14 = ( V_7 ) F_6 ( V_2 -> V_15 [ V_13 ] ) ;
...
V_2 -> V_10 = 1 ;
V_2 -> V_39 = NULL ;
V_2 -> V_15 = F_28 ( V_17 * sizeof( void * ) , V_21 ) ;
if ( ! V_2 -> V_15 ) {
...
int F_33 ( struct V_26 * V_27 , struct V_1 * V_2 )
{
int V_13 , V_49 ;
if ( ! V_2 || ! V_2 -> V_15 ) {
F_34 ( L_8 ) ;
...
V_49 = V_2 -> V_6 / V_2 -> V_5 ;
for ( V_13 = 0 ; V_13 < V_49 ; V_13 += V_23 )
