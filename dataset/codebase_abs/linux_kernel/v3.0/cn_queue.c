...
struct V_5 * V_6 ,
void (* F_2)( struct V_7 * , struct V_8 * ) )
{
struct V_1 * V_9 ;
...
int F_11 ( struct V_5 * V_14 , struct V_5 * V_15 )
{
return ( ( V_14 -> V_16 == V_15 -> V_16 ) && ( V_14 -> V_17 == V_15 -> V_17 ) ) ;
}
...
if ( F_11 ( & V_18 -> V_6 . V_6 , V_6 ) ) {
V_19 = 1 ;
break;
}
}
if ( ! V_19 )
F_15 ( & V_9 -> V_22 , & V_3 -> V_23 ) ;
F_16 ( & V_3 -> V_21 ) ;
if ( V_19 ) {
F_7 ( V_9 ) ;
return - V_24 ;
...
struct V_2 * F_20 ( const char * V_4 , struct V_28 * V_29 )
{
struct V_2 * V_3 ;
