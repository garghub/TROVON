...
static inline int F_18 ( struct V_9 * V_12 )
{
return V_12 -> V_28 & V_29 ;
}
static struct V_9 *
F_19 ( struct V_13 * V_14 , const struct V_30 * V_31 )
{
struct V_9 * V_12 ;
struct V_10 * V_11 ;
struct V_32 V_33 ;
F_20 ( V_14 -> V_1 , F_21 ( V_31 ) , & V_33 ) ;
F_14 ( 6 , L_5 ) ;
V_11 = (struct V_10 * ) V_14 -> V_27 ;
V_12 = F_4 ( V_14 -> V_1 , V_11 , & V_33 . V_34 ) ;
if ( ! V_12
|| ! ( V_12 -> V_28 & V_35 )
|| F_22 ( & V_12 -> V_36 ) <= 0
|| F_18 ( V_12 ) ) {
...
F_24 ( 6 , L_7 ,
F_25 ( V_14 -> V_1 , & V_33 . V_34 ) ,
F_25 ( V_14 -> V_1 , & V_12 -> V_3 ) ,
F_26 ( V_12 -> V_37 ) ) ;
return V_12 ;
}
