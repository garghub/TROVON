...
{
struct V_43 * V_44 = V_42 -> V_19 . V_45 ;
struct V_46 * V_47 ;
struct V_2 * V_3 ;
struct V_22 * V_23 ;
...
int V_38 ;
int V_49 ;
V_3 = F_30 ( sizeof( * V_3 ) , V_50 ) ;
if ( ! V_3 )
return - V_51 ;
F_31 ( & V_3 -> V_37 ) ;
V_49 = - V_30 ;
V_47 = F_32 ( V_42 , V_52 , 0 ) ;
if ( V_47 )
V_3 -> V_53 = V_47 -> V_54 ;
V_47 = F_32 ( V_42 , V_55 , 0 ) ;
if ( ! V_47 )
goto V_56;
V_3 -> V_5 = F_33 ( V_47 -> V_54 , F_34 ( V_47 ) ) ;
if ( ! V_3 -> V_5 )
goto V_56;
F_6 ( L_13 , ( V_57 ) V_47 -> V_54 , V_3 -> V_5 ) ;
if ( ( V_44 -> V_58 != 16 ) && ( V_44 -> V_58 != 32 ) )
goto V_56;
V_3 -> V_6 = F_35 ( V_44 -> V_58 - 1 ) - 3 ;
F_6 ( L_14 , V_3 -> V_6 ) ;
if ( ( V_44 -> V_59 != 8 ) && ( V_44 -> V_59 != 16 ) )
goto V_56;
V_3 -> V_21 = F_35 ( V_44 -> V_59 - 1 ) ;
F_6 ( L_15 , V_3 -> V_21 ) ;
V_3 -> V_36 = ( 1 << V_44 -> V_59 ) - 1 ;
F_36 ( V_42 , V_3 ) ;
V_3 -> V_39 = V_44 -> V_60 ;
V_3 -> V_23 = F_30 ( sizeof( struct V_25 ) * V_3 -> V_39 , V_50 ) ;
if ( ! V_3 -> V_23 ) {
V_49 = - V_51 ;
goto V_56;
}
...
V_3 -> V_23 [ V_38 ] . V_35 = V_44 -> V_23 [ V_38 ] . V_61 ;
V_3 -> V_23 [ V_38 ] . V_29 = V_44 -> V_23 [ V_38 ] . V_62 ;
...
if ( V_44 -> V_74 )
V_3 -> V_7 = 0 ;
V_48 = V_3 -> V_13 + V_3 -> V_72 ;
for ( V_12 = V_3 -> V_13 ; V_12 < V_48 ; V_12 ++ ) {
F_38 ( V_12 , & V_75 ,
V_76 ) ;
F_39 ( V_12 , V_3 ) ;
F_40 ( V_12 , V_77 | V_78 ) ;
