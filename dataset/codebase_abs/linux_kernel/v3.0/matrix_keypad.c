...
V_25 = F_53 ( V_2 -> V_9 ) ;
V_13 = F_54 ( sizeof( struct V_12 ) , V_57 ) ;
...
V_19 -> V_60 = V_44 -> V_60 ;
V_19 -> V_32 . V_61 = V_62 ;
V_19 -> V_38 . V_63 = & V_44 -> V_38 ;
V_19 -> V_64 [ 0 ] = F_58 ( V_65 ) ;
if ( ! V_2 -> V_66 )
V_19 -> V_64 [ 0 ] |= F_58 ( V_67 ) ;
V_19 -> V_68 = F_29 ;
V_19 -> V_69 = F_32 ;
V_19 -> V_70 = V_28 ;
V_19 -> V_71 = sizeof( * V_28 ) ;
V_19 -> V_72 = V_2 -> V_16 << V_25 ;
F_59 ( V_55 , V_25 ,
V_19 -> V_70 , V_19 -> V_73 ) ;
F_60 ( V_19 , V_26 , V_27 ) ;
F_61 ( V_19 , V_13 ) ;
