...
static void * F_132 ( struct V_184 * V_185 , T_11 * V_186 )
{
struct V_3 * V_4 ;
int type ;
T_11 V_187 = * V_186 ;
...
static void * F_135 ( struct V_184 * V_185 , void * V_190 , T_11 * V_186 )
{
...
static void F_136 ( struct V_184 * V_185 , void * V_190 )
{
F_137 ( & V_188 ) ;
}
static int F_138 ( struct V_184 * V_185 , void * V_190 )
{
struct V_3 * V_4 = V_190 ;
struct V_172 * V_172 ;
int V_191 ;
...
V_172 = V_4 -> V_159 ;
V_191 = F_140 ( V_185 , & V_172 -> V_192 , L_4 ) ;
F_141 ( V_185 , L_5 ,
V_191 < 40 ? 40 - V_191 : 1 , L_6 ,
F_126 ( V_172 -> V_192 . V_193 -> V_194 -> V_162 ) ?
L_7 : L_8 ,
V_4 -> V_40 << ( V_17 - 10 ) ,
V_4 -> V_41 << ( V_17 - 10 ) ,
V_4 -> V_64 ) ;
...
struct V_174 * V_175 ;
int V_8 ;
V_175 = F_123 ( sizeof( struct V_174 ) , V_20 ) ;
if ( ! V_175 )
return - V_108 ;
V_172 -> V_176 = V_175 ;
V_8 = F_143 ( V_172 , & V_195 ) ;
if ( V_8 ) {
F_121 ( V_175 ) ;
return V_8 ;
}
V_175 -> V_196 . V_197 = V_175 ;
V_175 -> V_178 = F_104 ( & V_179 ) ;
return V_8 ;
}
static int T_12 F_144 ( void )
{
F_145 ( L_9 , 0 , NULL , & V_198 ) ;
return 0 ;
}
...
V_66 -> V_205 = F_156 ( V_66 -> V_19 ) ;
error = F_157 ( V_66 -> V_19 , V_115 ) ;
if ( error < 0 )
return error ;
V_66 -> V_36 |= V_87 ;
} else if ( F_158 ( V_150 -> V_162 ) ) {
V_66 -> V_19 = V_150 -> V_206 -> V_207 ;
F_133 ( & V_150 -> V_208 ) ;
if ( F_159 ( V_150 ) )
return - V_209 ;
} else
...
unsigned long V_211 ;
unsigned long V_212 ;
if ( memcmp ( L_10 , V_210 -> V_213 . V_213 , 10 ) ) {
F_31 ( V_74 L_11 ) ;
return 0 ;
}
if ( F_161 ( V_210 -> V_214 . V_215 ) == 1 ) {
F_162 ( & V_210 -> V_214 . V_215 ) ;
F_162 ( & V_210 -> V_214 . V_216 ) ;
F_162 ( & V_210 -> V_214 . V_217 ) ;
for ( V_128 = 0 ; V_128 < V_210 -> V_214 . V_217 ; V_128 ++ )
F_162 ( & V_210 -> V_214 . V_218 [ V_128 ] ) ;
}
if ( V_210 -> V_214 . V_215 != 1 ) {
F_31 ( V_219
L_12 ,
V_210 -> V_214 . V_215 ) ;
return 0 ;
...
V_211 = F_30 ( F_163 (
F_64 ( F_3 ( 0 , ~ 0UL ) ) ) ) + 1 ;
if ( V_211 > V_210 -> V_214 . V_216 ) {
V_211 = V_210 -> V_214 . V_216 + 1 ;
if ( ( unsigned int ) V_211 == 0 )
V_211 = V_220 ;
}
V_66 -> V_51 = V_211 - 1 ;
if ( ! V_211 )
return 0 ;
V_212 = F_127 ( V_150 ) >> V_17 ;
if ( V_212 && V_211 > V_212 ) {
F_31 ( V_219
L_13 ) ;
return 0 ;
}
if ( V_210 -> V_214 . V_217 && F_158 ( V_150 -> V_162 ) )
return 0 ;
if ( V_210 -> V_214 . V_217 > V_221 )
return 0 ;
return V_211 ;
}
static int F_164 ( struct V_3 * V_66 ,
union V_210 * V_210 ,
unsigned char * V_52 ,
unsigned long V_211 ,
T_2 * V_149 )
...
V_222 = V_211 - 1 ;
for ( V_128 = 0 ; V_128 < V_210 -> V_214 . V_217 ; V_128 ++ ) {
unsigned int V_223 = V_210 -> V_214 . V_218 [ V_128 ] ;
if ( V_223 == 0 || V_223 > V_210 -> V_214 . V_216 )
return - V_169 ;
if ( V_223 < V_211 ) {
V_52 [ V_223 ] = V_129 ;
V_222 -- ;
...
V_10 -> V_226 = V_60 + V_225 ;
V_10 -> V_227 = V_171 + V_225 ;
F_19 ( & V_48 ) ;
}
static int F_166 ( T_1 V_6 , unsigned char V_30 )
{
struct V_3 * V_66 ;
unsigned long V_5 , type ;
unsigned char V_79 ;
...
{
int V_15 = 0 ;
while ( ! V_15 && F_166 ( V_6 , 1 ) == - V_108 )
V_15 = F_169 ( V_6 , V_232 ) ;
return V_15 ;
}
int F_170 ( T_1 V_6 )
{
return F_166 ( V_6 , V_2 ) ;
}
int F_171 ( T_1 V_6 , unsigned long * V_5 )
{
struct V_3 * V_4 ;
int V_233 = V_234 ;
T_3 V_235 , V_236 ;
...
if ( V_113 > V_4 -> V_46 )
V_113 = V_4 -> V_46 ;
for ( V_236 = V_235 ; ++ V_236 < V_113 ; V_18 ++ ) {
if ( ! V_4 -> V_52 [ V_236 ] )
break;
if ( F_1 ( V_4 -> V_52 [ V_236 ] ) == V_129 )
break;
}
for ( V_236 = V_235 ; -- V_236 >= V_237 ; V_18 ++ ) {
if ( ! V_4 -> V_52 [ V_236 ] )
break;
if ( F_1 ( V_4 -> V_52 [ V_236 ] ) == V_129 )
break;
...
if ( ! ( V_79 & V_82 ) )
goto V_67;
V_245 = F_175 ( V_239 , V_246 ) + V_5 ;
V_79 = * V_245 ;
F_176 ( V_245 , V_246 ) ;
if ( ( V_79 & ~ V_82 ) != V_247 )
goto V_67;
}
F_124 ( & V_7 -> V_243 , & V_65 -> V_243 ) ;
V_7 = NULL ;
V_67:
F_19 ( & V_48 ) ;
V_241:
...
V_5 &= ~ V_242 ;
V_7 = F_14 ( V_65 -> V_243 . V_28 , struct V_7 , V_243 ) ;
V_245 = F_175 ( V_7 , V_246 ) + V_5 ;
if ( V_79 == V_83 )
goto V_248;
if ( V_79 == ( V_83 | V_82 ) ) {
while ( * V_245 == ( V_247 | V_82 ) ) {
F_176 ( V_245 , V_246 ) ;
V_7 = F_14 ( V_7 -> V_243 . V_28 , struct V_7 , V_243 ) ;
F_116 ( V_7 == V_65 ) ;
V_245 = F_175 ( V_7 , V_246 ) + V_5 ;
}
if ( * V_245 == V_247 ) {
...
* V_245 += 1 ;
F_176 ( V_245 , V_246 ) ;
V_7 = F_14 ( V_7 -> V_243 . V_127 , struct V_7 , V_243 ) ;
while ( V_7 != V_65 ) {
V_245 = F_175 ( V_7 , V_246 ) + V_5 ;
* V_245 = V_82 ;
F_176 ( V_245 , V_246 ) ;
...
V_65 = F_173 ( V_4 -> V_52 + V_5 ) ;
if ( F_40 ( V_65 ) ) {
struct V_24 * V_249 , * V_28 ;
F_114 (this, next, &head->lru) {
struct V_7 * V_7 ;
V_7 = F_14 ( V_249 , struct V_7 , V_243 ) ;
F_120 ( V_249 ) ;
F_177 ( V_7 ) ;
}
}
