...
V_200 = V_284 [ V_210 ] + V_138 ;
snprintf ( V_283 , sizeof( V_283 ) , L_69 ,
V_285 [ V_210 ] ? V_285 [ V_210 ] : V_256 , V_138 ) ;
V_12 = F_96 ( V_200 , V_283 , V_286 , 0 , & V_191 ) ;
if ( V_12 < 0 ) {
F_5 ( V_36 L_70 , V_138 ) ;
F_74 ( V_7 ) ;
return V_12 ;
}
strcpy ( V_191 -> V_287 , V_288 ) ;
sprintf ( V_191 -> V_276 , L_71 , V_7 -> V_276 , V_138 ) ;
...
V_255 = F_98 ( sizeof( struct V_289 ) ) ;
