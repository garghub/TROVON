...
static int
F_19 ( struct V_1 * V_2 , T_1 V_22 , T_1 V_32 , T_1 V_33 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
T_1 V_20 = V_33 << 4 ;
T_1 V_34 = F_20 ( V_5 , V_20 + 0 ) ;
T_1 V_35 = F_20 ( V_5 , V_20 + 4 ) ;
T_1 V_36 = F_20 ( V_5 , V_20 + 8 ) ;
T_1 V_29 = ( V_36 & 0xfffff000 ) | ( V_34 >> 20 ) ;
T_1 V_37 = V_35 + 1 ;
if ( ! ( V_34 & 0x00002000 ) )
return - V_38 ;
if ( V_32 == 0x0190 ) {
F_6 ( V_5 , 0x00b300 , 0x00030000 , ( V_34 & 0x00030000 ) ) ;
F_8 ( V_5 , 0x00b334 , V_29 ) ;
F_8 ( V_5 , 0x00b324 , V_37 ) ;
} else
if ( V_32 == 0x01a0 ) {
F_6 ( V_5 , 0x00b300 , 0x000c0000 , ( V_34 & 0x00030000 ) << 2 ) ;
F_8 ( V_5 , 0x00b360 , V_29 ) ;
F_8 ( V_5 , 0x00b364 , V_37 ) ;
} else {
if ( V_34 & 0x000c0000 )
return - V_38 ;
F_8 ( V_5 , 0x00b370 , V_29 ) ;
F_8 ( V_5 , 0x00b374 , V_37 ) ;
}
return 0 ;
}
static int
...
unsigned long V_11 ;
int V_26 ;
F_5 ( & V_7 -> V_39 . V_40 , V_11 ) ;
for ( V_26 = 0 ; V_26 < V_7 -> V_3 . V_41 . V_39 ; V_26 ++ ) {
if ( ! V_7 -> V_39 . V_42 [ V_26 ] )
continue;
V_10 = V_7 -> V_39 . V_42 [ V_26 ] -> V_19 [ V_43 ] ;
if ( V_10 && V_10 -> V_17 == V_20 )
break;
}
F_9 ( & V_7 -> V_39 . V_40 , V_11 ) ;
return V_26 ;
}
static void
...
{
struct V_6 * V_7 = V_5 -> V_8 ;
struct V_44 * V_45 = & V_7 -> V_45 . V_46 [ V_26 ] ;
F_8 ( V_5 , 0x00b008 + ( V_26 * 0x10 ) , V_45 -> V_47 ) ;
F_8 ( V_5 , 0x00b004 + ( V_26 * 0x10 ) , V_45 -> V_48 ) ;
F_8 ( V_5 , 0x00b000 + ( V_26 * 0x10 ) , V_45 -> V_49 ) ;
}
static void
F_23 ( struct V_4 * V_5 )
{
T_1 V_20 = ( F_7 ( V_5 , 0x00b318 ) & 0x000fffff ) << 4 ;
T_1 V_50 = F_21 ( V_5 , V_20 ) ;
T_1 V_51 = F_7 ( V_5 , 0x00b100 ) ;
T_1 type = F_7 ( V_5 , 0x00b230 ) ;
T_1 V_32 = F_7 ( V_5 , 0x00b234 ) ;
T_1 V_33 = F_7 ( V_5 , 0x00b238 ) ;
T_1 V_52 = V_51 ;
if ( V_51 & 0x01000000 ) {
...
if ( type == 0x00000010 ) {
if ( ! F_24 ( V_5 , V_50 , 0x3174 , V_32 , V_33 ) )
V_52 &= ~ 0x01000000 ;
}
}
F_8 ( V_5 , 0x00b100 , V_51 ) ;
F_8 ( V_5 , 0x00b230 , 0x00000001 ) ;
if ( V_52 && F_25 () ) {
F_26 ( V_5 , L_3 ,
V_50 , V_20 , V_51 , type , V_32 , V_33 ) ;
}
}
static void
F_27 ( struct V_4 * V_5 )
...
V_25 -> V_29 . V_30 = F_22 ;
F_34 ( V_5 , 0 , F_27 ) ;
F_35 ( V_5 , V_53 , & V_25 -> V_29 ) ;
F_36 ( V_5 , 0x3174 , V_53 ) ;
