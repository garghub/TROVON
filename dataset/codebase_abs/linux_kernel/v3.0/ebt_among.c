...
static int F_3 ( const struct V_15 * V_16 , T_1 * V_17 )
{
if ( F_4 ( V_16 ) -> V_18 == F_5 ( V_19 ) ) {
const struct V_20 * V_21 ;
struct V_20 V_22 ;
V_21 = F_6 ( V_16 , 0 , sizeof( V_22 ) , & V_22 ) ;
if ( V_21 == NULL )
return - 1 ;
* V_17 = V_21 -> V_23 ;
} else if ( F_4 ( V_16 ) -> V_18 == F_5 ( V_24 ) ) {
const struct V_25 * V_26 ;
struct V_25 V_27 ;
const T_1 * V_28 ;
T_1 V_29 ;
V_26 = F_6 ( V_16 , 0 , sizeof( V_27 ) , & V_27 ) ;
if ( V_26 == NULL ||
V_26 -> V_30 != sizeof( T_1 ) ||
V_26 -> V_31 != V_32 )
return - 1 ;
V_28 = F_6 ( V_16 , sizeof( struct V_25 ) +
2 * V_32 + sizeof( T_1 ) ,
sizeof( T_1 ) , & V_29 ) ;
if ( V_28 == NULL )
return - 1 ;
...
static int F_7 ( const struct V_15 * V_16 , T_1 * V_17 )
{
if ( F_4 ( V_16 ) -> V_18 == F_5 ( V_19 ) ) {
const struct V_20 * V_21 ;
struct V_20 V_22 ;
...
static bool
F_8 ( const struct V_15 * V_16 , struct V_34 * V_35 )
{
