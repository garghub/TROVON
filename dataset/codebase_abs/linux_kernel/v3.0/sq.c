...
static int T_4 F_33 ( struct V_60 * V_61 )
{
unsigned int V_62 = V_61 -> V_63 ;
struct V_45 * V_46 ;
int error ;
V_64 [ V_62 ] = F_34 ( sizeof( struct V_45 ) , V_35 ) ;
if ( F_15 ( ! V_64 [ V_62 ] ) )
return - V_19 ;
V_46 = V_64 [ V_62 ] ;
error = F_35 ( V_46 , & V_65 , & V_61 -> V_46 ,
L_10 , L_11 ) ;
if ( ! error )
F_36 ( V_46 , V_66 ) ;
return error ;
}
static int T_5 F_37 ( struct V_60 * V_61 )
{
unsigned int V_62 = V_61 -> V_63 ;
struct V_45 * V_46 = V_64 [ V_62 ] ;
F_38 ( V_46 ) ;
return 0 ;
}
static int T_6 F_39 ( void )
{
unsigned int V_67 = 0x04000000 >> V_37 ;
unsigned int V_15 = ( V_67 + ( V_68 - 1 ) ) / V_68 ;
int V_29 = - V_19 ;
F_25 ( V_69 L_12 ) ;
V_34 = F_40 ( L_13 ,
