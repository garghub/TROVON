...
{
struct V_46 * V_47 = V_2 -> V_47 ;
struct V_67 * V_68 = V_47 -> V_69 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_70 = F_23 ( V_2 -> V_9 ) -> V_71 ;
struct V_72 * V_49 = & V_68 -> V_73 . V_74 [ V_70 ] ;
struct V_7 * V_75 = & V_2 -> V_9 -> V_8 ;
struct V_7 * V_76 =
& F_3 ( V_2 ) -> V_77 . V_8 ;
int V_17 , V_78 , V_79 , V_80 , V_81 ;
if ( V_76 -> V_82 & V_83 )
V_17 = 100 ;
else
V_17 = V_4 -> V_17 ;
V_78 = ( V_76 -> V_21 - V_75 -> V_21 ) / 2 ;
V_79 = ( V_76 -> V_22 - V_75 -> V_22 ) / 2 ;
V_78 = F_19 ( 0 , F_24 ( V_78 , V_76 -> V_21 / 20 ) ,
V_78 , V_17 ) ;
V_79 = F_19 ( 0 , F_24 ( V_79 , V_76 -> V_22 / 20 ) ,
V_79 , V_17 ) ;
V_80 = V_75 -> V_21 * 0x800 /
( V_76 -> V_21 - 2 * V_78 ) ;
V_81 = V_75 -> V_22 * 0x800 /
( V_76 -> V_22 - 2 * V_79 ) & ~ 3 ;
V_49 -> V_84 [ V_85 ] = V_78 ;
V_49 -> V_84 [ V_86 ] = V_76 -> V_21 - V_78 - 1 ;
V_49 -> V_87 [ V_85 ] = V_79 ;
V_49 -> V_87 [ V_86 ] = V_76 -> V_22 - V_79 - 1 ;
V_49 -> V_88 = V_89 |
F_25 ( V_81 , 0 , V_90 ) |
V_91 |
F_25 ( V_80 , 0 , V_92 ) ;
