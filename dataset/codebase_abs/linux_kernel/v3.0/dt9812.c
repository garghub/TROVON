...
V_32 [ 2 ] . V_16 = V_65 ;
V_32 [ 2 ] . V_50 = 0xff ;
V_32 [ 2 ] . V_51 = V_69 | V_70 ;
V_38 = F_14 ( V_36 -> V_41 , 3 , V_32 ) ;
if ( V_38 )
goto exit;
V_38 = F_12 ( V_36 -> V_41 , 3 , V_42 , V_68 ) ;
if ( V_38 )
goto exit;
if ( ( V_68 [ 0 ] & ( V_71 | V_70 ) ) ==
V_71 ) {
...
case V_49 :
* V_24 = ( ( V_68 [ 1 ] << 8 ) | V_68 [ 2 ] ) + 0x800 ;
break;
case V_72 :
* V_24 = ( V_68 [ 1 ] << 8 ) | V_68 [ 2 ] ;
break;
}
}
exit:
...
V_4 -> V_104 = F_32 ( V_4 -> V_104 ) ;
V_4 -> V_105 = F_32 ( V_4 -> V_105 ) ;
V_4 -> V_48 = F_32 ( V_4 -> V_48 ) ;
V_4 -> V_106 = F_35 ( V_4 -> V_106 ) ;
switch ( V_4 -> V_48 ) {
case V_49 :
V_4 -> V_73 [ 0 ] = 0x0800 ;
V_4 -> V_73 [ 1 ] = 0x800 ;
...
struct V_115 * V_116 ;
V_4 -> V_133 = L_13 ;
if ( F_47 ( V_4 , sizeof( struct V_134 ) ) < 0 )
return - V_85 ;
V_4 -> V_135 = F_40 ;
V_114 -> V_106 = V_132 -> V_136 [ 0 ] ;
if ( F_48 ( V_4 , 4 ) < 0 )
return - V_85 ;
V_116 = V_4 -> V_117 + 0 ;
V_116 -> type = V_137 ;
...
static int F_50 ( struct V_113 * V_4 )
{
return 0 ;
}
...
int V_38 , V_25 ;
for ( V_25 = 0 ; V_25 < V_110 ; V_25 ++ ) {
F_52 ( & V_111 [ V_25 ] . V_40 , 1 ) ;
V_111 [ V_25 ] . V_106 = 0 ;
V_111 [ V_25 ] . V_41 = NULL ;
V_111 [ V_25 ] . V_149 = NULL ;
}
V_111 [ 12 ] . V_106 = 0x0 ;
V_38 = F_53 ( & V_150 ) ;
if ( V_38 ) {
F_49 (KERN_ERR KBUILD_MODNAME
L_15 , result) ;
return V_38 ;
}
V_38 = F_54 ( & V_151 ) ;
