...
V_175 &= ~ V_178 ;
F_11 ( V_26 , V_83 , V_175 ) ;
for( V_45 = 0 ; V_45 < 4 ; V_45 ++ ) V_185 [ V_45 ] = 0 ;
F_75 (ha, dev) {
V_184 = V_180 -> V_18 ;
if( ! ( * V_184 & 1 ) )
continue;
V_171 = F_76 ( 6 , V_184 ) ;
V_171 >>= 26 ;
V_185 [ V_171 >> 4 ] |= 1 << ( V_171 & 0xf ) ;
}
F_11 ( V_26 , V_78 , V_185 [ 0 ] ) ;
F_11 ( V_26 , V_77 , V_185 [ 1 ] ) ;
F_11 ( V_26 , V_76 , V_185 [ 2 ] ) ;
F_11 ( V_26 , V_75 , V_185 [ 3 ] ) ;
}
}
...
if ( V_13 & V_187 ) V_26 -> V_143 . V_153 ++ ;
if ( V_13 & V_188 ) V_26 -> V_143 . V_189 ++ ;
if ( V_13 & V_190 ) V_26 -> V_143 . V_152 ++ ;
if ( V_13 & V_191 ) V_26 -> V_143 . V_192 ++ ;
if ( V_13 & V_193 ) V_26 -> V_143 . V_194 ++ ;
if ( V_13 & V_195 ) V_26 -> V_143 . V_196 ++ ;
if ( V_13 & V_197 ) V_26 -> V_143 . V_198 ++ ;
if ( V_13 & V_199 ) V_26 -> V_143 . V_200 ++ ;
return V_158 ;
}
...
unsigned short V_28 ;
unsigned short V_39 ;
F_11 ( V_26 , V_201 , V_202 | V_203 ) ;
F_23 ( V_204 ) ;
V_28 = F_12 ( V_26 , V_201 ) ;
F_23 ( V_204 ) ;
V_39 = ( V_28 >> V_205 ) & 1 ;
F_11 ( V_26 , V_201 , V_202 ) ;
F_23 ( V_204 ) ;
return V_39 ;
}
static void
...
V_28 = ( V_39 << V_206 ) ;
F_11 ( V_26 , V_201 , V_28 | V_202 ) ;
F_23 ( V_204 ) ;
F_11 ( V_26 , V_201 , V_28 | V_202 | V_203 ) ;
F_23 ( V_204 ) ;
F_11 ( V_26 , V_201 , V_28 | V_202 ) ;
F_23 ( V_204 ) ;
}
...
F_81 ( struct V_25 * V_26 , unsigned int V_18 , unsigned int V_207 )
{
unsigned short V_28 , V_39 ;
int V_45 ;
for ( V_45 = 0 ; V_45 < V_207 ; V_45 ++ ) {
V_39 = V_18 >> ( V_207 - V_45 - 1 ) ;
F_79 ( V_26 , V_39 & 1 ) ;
}
V_28 = 0 ;
...
{
unsigned short V_28 , V_208 ;
F_80 ( V_26 ) ;
V_28 = F_81 ( V_26 , 3 , V_209 ) ;
V_208 = ( ( V_28 >> 8 ) & 0x0ff ) | ( ( V_28 << 8 ) & 0xff00 ) ;
return 0 ;
}
static void
F_83 ( struct V_25 * V_26 , unsigned char * V_210 )
{
int V_45 ;
unsigned short V_28 ;
for ( V_45 = 0 ; V_45 < 6 ; V_45 ++ )
{
F_80 ( V_26 ) ;
V_28 = F_81 ( V_26 , V_45 + V_211 / 2 , V_209 ) ;
V_210 [ 2 * V_45 ] = F_84 ( V_28 & 0x0ff ) ;
V_210 [ 2 * V_45 + 1 ] = F_84 ( ( V_28 >> 8 ) & 0x0ff ) ;
}
}
...
static int T_7 F_85 ( struct V_97 * V_37 , const struct V_212 * V_213 )
{
...
F_99 ( V_31 -> V_231 ) ;
F_100 ( & V_31 -> V_103 ) ;
V_216 = F_101 ( V_26 -> V_104 , F_77 , 0 , L_26 , V_26 ) ;
if ( V_216 ) {
F_26 ( V_218 L_27 , V_26 -> V_104 ) ;
goto V_233;
}
V_216 = F_101 ( V_31 -> V_105 , F_60 , 0 , L_28 , V_26 ) ;
if ( V_216 ) {
F_26 ( V_218 L_27 , V_31 -> V_105 ) ;
goto V_234;
}
V_216 = F_101 ( V_31 -> V_106 , F_54 , 0 , L_29 , V_26 ) ;
if ( V_216 ) {
F_26 ( V_218 L_27 , V_31 -> V_106 ) ;
goto V_235;
}
F_33 ( V_26 -> V_104 ) ;
F_16 ( V_36 , F_17 ( V_31 -> V_37 ) , 0 , 0 ) ;
...
F_26 ( V_237 L_31 ,
V_26 -> V_238 , ( V_50 ? L_32 : L_33 ) , V_26 -> V_79 ) ;
F_42 ( ( L_34 , V_26 -> V_29 ) ) ;
F_26 ( L_3 ) ;
return 0 ;
V_236:
