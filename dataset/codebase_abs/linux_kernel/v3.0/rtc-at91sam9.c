...
F_23 ( & V_47 -> V_2 , 1 ) ;
F_24 ( V_47 , V_6 ) ;
V_6 -> V_55 = ( void V_56 V_57 * ) ( V_58 - V_59 ) ;
V_6 -> V_55 += V_49 -> V_60 ;
V_20 = F_4 ( V_6 , V_21 ) ;
if ( ( V_20 & V_61 ) != V_62 ) {
V_20 = V_26 | ( V_62 & V_61 ) ;
...
V_20 &= ~ ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 ) ;
V_6 -> V_43 = F_25 ( V_47 -> V_63 , & V_47 -> V_2 ,
& V_64 , V_65 ) ;
if ( F_26 ( V_6 -> V_43 ) ) {
V_50 = F_27 ( V_6 -> V_43 ) ;
goto V_66;
...
V_50 = F_28 ( V_67 , F_16 ,
V_68 | V_69 ,
F_29 ( & V_6 -> V_43 -> V_2 ) , V_6 ) ;
if ( V_50 ) {
F_6 ( & V_47 -> V_2 , L_11 , V_67 ) ;
F_30 ( V_6 -> V_43 ) ;
goto V_66;
}
if ( F_3 ( V_6 ) == 0 )
...
struct V_5 * V_6 = F_34 ( V_47 ) ;
T_1 V_20 = F_4 ( V_6 , V_21 ) ;
V_6 -> V_70 = V_20 & ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 & ~ V_6 -> V_70 ) ;
}
...
static int T_3 F_42 ( struct V_1 * V_2 , void * V_72 )
{
struct V_46 * V_47 = F_43 ( V_2 ) ;
int V_50 ;
if ( strcmp ( L_13 , V_47 -> V_63 ) != 0
|| V_47 -> V_73 != V_74 )
goto V_66;
if ( V_2 -> V_75 ) {
F_6 ( V_2 , L_14 ) ;
