...
static struct V_91 * F_55 ( struct V_21 * V_22 , T_1 V_66 , struct V_71 * V_72 , const struct V_92 * V_93 )
{
struct V_12 * V_9 = V_22 -> V_57 ;
struct V_67 * V_68 ;
struct V_94 V_95 = {
...
static int F_58 ( struct V_21 * V_22 , T_1 V_66 , struct V_71 * V_72 , const struct V_92 * V_93 )
{
struct V_91 * V_103 ;
V_103 = F_55 ( V_22 , V_66 , V_72 , V_93 ) ;
if ( F_59 ( V_103 ) )
return F_60 ( V_103 ) ;
F_61 ( V_103 ) ;
return 0 ;
}
int F_62 ( struct V_21 * V_22 , T_1 V_66 , const struct V_92 * V_93 )
{
struct V_71 V_72 = {
. V_73 = & V_22 -> V_27 ,
. V_74 = & V_22 -> V_56 ,
} ;
return F_58 ( V_22 , V_66 , & V_72 , V_93 ) ;
}
...
static int F_64 ( struct V_64 * V_65 , struct V_21 * V_22 , T_1 V_66 , const struct V_92 * V_93 )
{
struct V_71 V_72 = {
. V_73 = & V_22 -> V_27 ,
. V_74 = & V_22 -> V_56 ,
...
{
int V_49 ;
V_49 = F_50 ( F_66 ( V_24 -> V_31 ) , V_22 , V_105 ) ;
if ( V_49 < 0 )
goto V_106;
...
break;
default:
V_49 = F_67 ( V_22 -> V_56 . V_49 ) ;
}
V_106:
F_41 ( V_22 ) ;
return V_49 ;
}
static void F_68 ( struct V_23 * V_18 , struct V_23 * V_24 )
{
F_16 ( & V_24 -> V_40 . V_41 . V_17 -> V_9 -> V_10 ) ;
V_18 -> V_40 . V_41 . V_110 = V_24 -> V_40 . V_41 . V_110 ;
V_18 -> V_40 . V_41 . V_17 = F_3 ( V_24 -> V_40 . V_41 . V_17 ) ;
F_69 ( & V_18 -> V_40 . V_41 . V_11 , & V_24 -> V_40 . V_41 . V_17 -> V_9 -> V_111 ) ;
...
{
struct V_64 * V_65 = F_66 ( V_24 -> V_31 ) ;
struct V_12 * V_9 = V_22 -> V_57 ;
struct V_69 * V_70 = & V_22 -> V_56 ;
...
if ( ! V_22 -> V_27 . V_52 )
goto V_125;
if ( F_79 ( V_9 , V_22 -> V_27 . V_52 , V_24 ) == 0 )
goto V_126;
}
if ( V_70 -> V_49 == V_107 ) {
F_80 ( & V_9 -> V_127 ) ;
...
V_24 -> V_45 = V_45 ;
V_24 -> V_114 = V_114 ;
F_64 ( V_65 , V_22 , V_130 , & V_131 ) ;
return V_49 ;
}
int
F_83 ( struct V_12 * V_9 , struct V_23 * V_24 )
{
...
F_21 ( V_22 , V_24 ) ;
V_22 -> V_27 . V_77 = 1 ;
V_49 = F_50 ( F_66 ( V_24 -> V_31 ) , V_22 , V_123 ) ;
if ( V_49 >= 0 && V_22 -> V_56 . V_49 == V_107 )
return 0 ;
F_39 ( V_89 L_13
L_14 , V_24 -> V_109 ,
V_49 , F_84 ( V_22 -> V_56 . V_49 ) ) ;
return - V_79 ;
}
static int
...
static int F_79 ( struct V_12 * V_9 , int V_52 , struct V_23 * V_24 )
{
struct V_21 * V_22 ;
int V_49 ;
F_35 ( L_17
