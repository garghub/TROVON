...
V_136 = ( V_134 -> V_141 - V_134 -> V_142 ) + 1 ;
V_4 -> V_143 = F_50 ( V_134 -> V_142 , V_136 , V_132 -> V_144 ) ;
if ( V_4 -> V_143 == NULL ) {
F_44 ( & V_132 -> V_24 , L_17 ) ;
V_135 = - V_137 ;
goto V_145;
}
V_4 -> V_7 = F_51 ( V_134 -> V_142 , V_136 ) ;
if ( V_4 -> V_7 == NULL ) {
...
F_2 ( 0 , V_4 -> V_7 + V_80 ) ;
strcpy ( V_124 -> V_10 . V_148 , V_149 ) ;
V_124 -> V_10 . type = V_150 ;
V_124 -> V_10 . V_151 = 0 ;
V_124 -> V_10 . V_152 = 0 ;
V_124 -> V_10 . V_153 = 0 ;
V_124 -> V_10 . V_154 = 0 ;
V_124 -> V_10 . V_155 = V_156 ;
V_124 -> V_13 . V_157 = 0 ;
V_124 -> V_13 . V_158 = V_159 ;
V_124 -> V_13 . V_160 = 0 ;
V_124 -> V_13 . V_161 = V_162 ;
V_124 -> V_163 = & V_164 ;
V_124 -> V_165 = V_166 ;
V_124 -> V_91 = & V_4 -> V_167 ;
V_135 = F_52 ( V_109 , F_33 , V_168 ,
V_132 -> V_144 , V_124 ) ;
if ( V_135 ) {
...
static int F_69 ( struct V_131 * V_24 , T_7 V_179 )
{
...
static int F_70 ( struct V_131 * V_24 )
{
struct V_1 * V_124 = F_36 ( V_24 ) ;
struct V_3 * V_4 = V_124 -> V_5 ;
F_7 ( V_175 L_27 ) ;
