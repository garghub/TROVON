...
static int F_13 ( struct V_23 * V_24 , T_5 * V_36 )
{
unsigned int V_14 ;
T_3 V_37 , V_38 ;
T_5 V_39 = 0 ;
if ( V_24 == NULL || V_24 -> V_24 >= V_40 || V_36 == NULL )
return - V_41 ;
V_14 = V_24 -> V_24 ;
V_37 = F_5 ( V_14 , V_42 ) ;
if ( F_5 ( V_14 , V_43 ) & V_44 ) {
if ( V_37 & V_45 )
V_39 |= V_46 ;
} else {
if ( ! ( V_37 & V_47 ) )
V_39 |= V_48 ;
else if ( ( V_37 & ( V_47 | V_49 ) ) == V_47 )
V_39 |= V_50 ;
}
if ( ( V_37 & V_51 ) == V_51 )
V_39 |= V_52 ;
...
static inline T_3 F_14 ( T_6 V_65 )
{
switch ( V_65 ) {
case 33 :
return V_66 ;
...
static int F_15 ( struct V_23 * V_24 , T_7 * V_68 )
{
T_4 * V_25 ;
unsigned int V_14 ;
T_3 V_69 , V_70 , V_71 , V_72 ;
if ( V_24 == NULL || V_24 -> V_24 >= V_40 ||
( V_68 -> V_73 != V_68 -> V_65 && V_68 -> V_73 != 0 ) ||
( V_68 -> V_65 != 50 && V_68 -> V_65 != 33 && V_68 -> V_65 != 0 ) )
return - V_41 ;
V_14 = V_24 -> V_24 ;
V_25 = & V_33 [ V_14 ] ;
F_16 ( & V_25 -> V_74 ) ;
...
static int F_18 ( struct V_23 * V_24 , struct V_93 * V_94 )
{
unsigned int V_14 ;
T_3 V_95 , V_96 ;
T_6 V_97 ;
...
F_10 ( V_14 , F_20 ( V_97 ) + V_102 , V_94 -> V_99 ) ;
F_10 ( V_14 , F_20 ( V_97 ) + V_103 , V_94 -> V_100 ) ;
V_95 = 0 ;
if ( V_94 -> V_104 > 0 )
V_95 |= F_21 ( V_97 ) ;
if ( V_94 -> V_78 & V_105 )
...
static int F_25 ( struct V_23 * V_24 , struct V_110 * V_111 )
{
unsigned int V_14 ;
...
if ( V_111 -> V_78 & V_105 )
V_99 |= V_121 ;
F_10 ( V_14 , F_27 ( V_97 ) + V_102 , V_99 ) ;
...
F_10 ( V_14 , F_27 ( V_97 ) + V_103 , V_100 ) ;
V_112 = ( V_111 -> V_118 >> 12 ) & 0x3fff ;
if ( V_111 -> V_78 & V_124 )
V_112 |= V_125 ;
if ( V_111 -> V_78 & V_126 )
V_112 |= V_127 ;
F_10 ( V_14 , F_27 ( V_97 ) + V_128 , V_112 ) ;
if ( V_111 -> V_78 & V_109 ) {
V_96 |= F_26 ( V_97 ) ;
F_9 ( V_14 , V_101 , V_96 ) ;
}
...
static inline unsigned int F_28 ( int V_14 )
{
...
if ( ( V_130 & V_91 ) && ( V_37 & V_55 ) )
V_129 |= V_56 ;
if ( ( V_130 & V_92 ) && ( ( V_37 & V_51 ) == V_51 ) )
V_129 |= V_52 ;
return V_129 ;
}
static T_8 F_29 ( int V_131 , void * V_132 )
{
T_4 * V_25 ;
unsigned int V_129 ;
T_8 V_133 = V_134 ;
...
static inline void F_31 ( int V_14 )
{
unsigned int V_131 ;
V_131 = F_5 ( V_14 , V_43 ) ;
V_131 &= 0x0f ;
...
static int T_9 F_36 ( char * V_153 )
{
