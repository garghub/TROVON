...
F_2 ( L_89 ) ;
if ( F_9 ( V_2 ) ) {
V_2 [ V_31 ] . V_59 = V_2 [ V_31 - 1 ] . V_59 + V_2 [ V_31 - 1 ] . V_7 ;
V_2 [ V_31 ] . V_9 = V_15 ? V_65 : V_66 ;
V_2 [ V_31 ] . V_7 = 0 ;
}
...
T_4 F_24 ( T_9 * V_68 , const T_3 V_11 , T_4 V_12 ,
T_10 * V_69 , const bool V_70 )
{
T_4 V_71 , V_72 , V_73 , V_74 ;
T_1 * V_1 ;
struct V_3 * V_4 ;
T_2 * V_2 ;
int V_8 ;
F_6 ( ! V_68 ) ;
F_2 ( L_102
L_103 , V_68 -> V_75 , ( unsigned long long ) V_11 ,
( unsigned long long ) V_12 ,
V_70 ? L_104 : L_105 ) ;
V_1 = V_68 -> V_1 ;
V_4 = V_1 -> V_5 ;
...
V_71 = F_24 ( V_68 , V_11 , V_73 , V_69 , true ) ;
if ( V_71 < 0 ) {
F_16 ( V_1 -> V_53 , L_122
L_123
L_124 , ( int ) V_71 ) ;
