...
struct V_5 * V_6 ;
int error ;
error = F_19 ( V_36 [ V_3 ] , V_37 [ V_3 ] , V_38 ,
...
struct V_44 * V_45 ;
int error ;
V_45 = F_26 ( V_41 , V_43 -> V_46 [ 0 ] . V_37 , NULL ) ;
if ( V_45 == NULL )
return - V_47 ;
error = F_27 ( V_45 ) ;
if ( error < 0 ) {
...
V_19 [ V_3 ] = F_29 ( V_45 , 0 ) ;
V_17 [ V_3 ] = F_30 ( V_45 , 0 ) ;
V_14 [ V_3 ] = F_31 ( V_45 , 0 ) ;
return F_7 ( V_6 , V_8 , V_19 [ V_3 ] , V_21 [ V_3 ] , V_14 [ V_3 ] ,
V_22 [ V_3 ] , V_17 [ V_3 ] , V_23 ) ;
}
static int T_1 F_32 ( struct V_40 * V_41 ,
const struct V_42 * V_43 )
{
struct V_5 * V_6 ;
...
if ( V_2 == V_50 )
return - V_47 ;
error = F_19 ( V_36 [ V_2 ] , V_37 [ V_2 ] , V_38 ,
sizeof( struct V_7 ) , & V_6 ) ;
if ( error < 0 )
return error ;
V_8 = V_6 -> V_9 ;
error = F_25 ( V_6 , V_2 , V_41 , V_43 ) ;
if ( error < 0 ) {
F_22 ( V_6 ) ;
return error ;
}
F_20 ( V_6 , & V_41 -> V_6 -> V_2 ) ;
error = F_9 ( V_6 , V_2 ) ;
if ( error < 0 )
return error ;
F_33 ( V_41 , V_6 ) ;
...
static void T_2 F_34 ( struct V_40 * V_41 )
{
F_22 ( F_35 ( V_41 ) ) ;
F_33 ( V_41 , NULL ) ;
V_49 = 0 ;
