...
static void F_64 ( struct V_58 * V_16 ,
struct V_134 * V_135 )
{
struct V_56 * V_57 = V_135 -> V_136 -> V_104 [ 0 ] ;
unsigned long V_43 ;
if ( V_57 -> V_111 )
switch ( V_135 -> V_108 ) {
case V_137 :
break;
case V_138 :
V_57 -> V_111 ( V_57 , - V_139 , NULL ) ;
break;
case V_140 :
V_57 -> V_111 ( V_57 , - V_141 , NULL ) ;
break;
default:
V_57 -> V_111 ( V_57 , - V_142 , NULL ) ;
break;
}
F_19 ( & V_61 , V_43 ) ;
F_48 ( & V_62 , V_57 -> V_55 ) ;
...
static void F_65 ( struct V_58 * V_143 ,
struct V_144 * V_145 )
{
struct V_56 * V_57 ;
struct V_59 * V_60 ;
V_60 = ( void * ) ( unsigned long ) V_145 -> V_146 -> V_147 ;
V_57 = V_60 -> V_104 [ 0 ] ;
if ( V_57 -> V_111 ) {
if ( V_145 -> V_146 -> V_108 == V_137 )
V_57 -> V_111 ( V_57 ,
V_145 -> V_148 . V_90 -> V_91 . V_108 ?
- V_128 : 0 ,
(struct V_89 * ) V_145 -> V_148 . V_90 ) ;
else
V_57 -> V_111 ( V_57 , - V_142 , NULL ) ;
}
F_66 ( V_145 ) ;
}
static void F_67 ( struct V_63 * V_17 )
{
struct V_44 * V_45 ;
int V_149 , V_150 , V_151 ;
if ( F_68 ( V_17 -> V_152 ) != V_153 )
return;
if ( V_17 -> V_152 == V_154 )
V_149 = V_150 = 0 ;
else {
...
V_45 = F_69 ( sizeof *V_45 +
( V_150 - V_149 + 1 ) * sizeof ( struct V_8 ) ,
V_20 ) ;
if ( ! V_45 )
return;
V_45 -> V_48 = V_149 ;
V_45 -> V_156 = V_150 ;
for ( V_151 = 0 ; V_151 <= V_150 - V_149 ; ++ V_151 ) {
F_70 ( & V_45 -> V_9 [ V_151 ] . V_32 ) ;
if ( F_18 ( V_17 , V_151 + 1 ) != V_49 )
continue;
V_45 -> V_9 [ V_151 ] . V_3 = NULL ;
V_45 -> V_9 [ V_151 ] . V_18 = V_151 + V_149 ;
V_45 -> V_9 [ V_151 ] . V_16 =
F_71 ( V_17 , V_151 + V_149 , V_157 ,
NULL , 0 , F_64 ,
F_65 , V_45 ) ;
if ( F_12 ( V_45 -> V_9 [ V_151 ] . V_16 ) )
goto V_158;
F_72 ( & V_45 -> V_9 [ V_151 ] . V_10 , F_5 ) ;
}
F_73 ( V_17 , & V_64 , V_45 ) ;
F_74 ( & V_45 -> V_46 , V_17 , F_16 ) ;
if ( F_75 ( & V_45 -> V_46 ) )
goto V_158;
for ( V_151 = 0 ; V_151 <= V_150 - V_149 ; ++ V_151 )
if ( F_18 ( V_17 , V_151 + 1 ) == V_49 )
F_5 ( & V_45 -> V_9 [ V_151 ] . V_10 ) ;
return;
V_158:
while ( -- V_151 >= 0 )
if ( F_18 ( V_17 , V_151 + 1 ) == V_49 )
F_76 ( V_45 -> V_9 [ V_151 ] . V_16 ) ;
F_4 ( V_45 ) ;
return;
}
static void F_77 ( struct V_63 * V_17 )
{
struct V_44 * V_45 = F_32 ( V_17 , & V_64 ) ;
int V_151 ;
if ( ! V_45 )
...
F_78 ( & V_45 -> V_46 ) ;
F_79 ( V_50 ) ;
for ( V_151 = 0 ; V_151 <= V_45 -> V_156 - V_45 -> V_48 ; ++ V_151 ) {
if ( F_18 ( V_17 , V_151 + 1 ) == V_49 ) {
F_76 ( V_45 -> V_9 [ V_151 ] . V_16 ) ;
if ( V_45 -> V_9 [ V_151 ] . V_3 )
F_14 ( & V_45 -> V_9 [ V_151 ] . V_3 -> V_4 , F_1 ) ;
}
}
F_4 ( V_45 ) ;
}
