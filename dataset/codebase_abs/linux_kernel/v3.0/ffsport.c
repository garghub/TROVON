...
if ( F_10 ( V_20 , ( void V_24 * ) V_22 . V_31 ,
V_25 . V_26 ) ) {
F_7 ( V_15 L_6
L_5 ) ;
F_16 ( V_20 ) ;
...
static int F_21 ( struct V_37 * V_38 , struct V_39 * V_40 )
{
T_2 V_41 , V_3 ;
T_1 V_42 , V_43 ;
T_1 V_44 , V_45 ;
...
if ( V_40 -> V_50 != V_52 )
return - V_18 ;
if ( F_22 ( V_40 ) + F_23 ( V_40 ) > F_24 ( V_38 -> V_53 ) ) {
F_7 ( V_15 L_7
L_8
L_9 ,
( int ) F_22 ( V_40 ) ,
...
return 0 ;
default:
F_7 ( V_58 L_11 , F_25 ( V_40 ) ) ;
return - V_18 ;
}
}
static int F_26 ( void * V_19 )
{
...
static int F_37 ( struct V_71 * V_72 , T_4 V_73 )
{
F_5 ( V_74 , L_1 ,
__FILE__ , __LINE__ , V_13 ) ;
return 0 ;
}
static int F_38 ( struct V_75 * V_76 , T_4 V_73 )
{
int V_77 ;
F_5 ( V_74 , L_1 ,
__FILE__ , __LINE__ , V_13 ) ;
...
static int F_39 ( struct V_71 * V_72 , struct V_78 * V_79 )
{
V_79 -> V_80 = 4 ;
V_79 -> V_81 = 16 ;
V_79 -> V_82 = F_24 ( V_72 -> V_83 ) / ( 4 * 16 ) ;
F_5 ( V_12 ,
L_12 ,
V_79 -> V_80 , V_79 -> V_81 , V_79 -> V_82 ) ;
return 0 ;
}
int F_40 ( struct V_71 * V_72 , T_4 V_73 ,
...
int F_48 ( struct V_71 * V_72 , T_4 V_73 ,
unsigned int V_84 , unsigned long V_19 )
{
int V_77 ;
F_12 ( & V_96 ) ;
V_77 = F_40 ( V_72 , V_73 , V_84 , V_19 ) ;
F_14 ( & V_96 ) ;
return V_77 ;
}
static int F_49 ( struct V_37 * V_97 , int V_98 )
{
int V_33 ;
T_1 V_99 ;
F_5 ( V_85 , L_1 ,
...
V_97 -> V_61 = F_51 ( F_35 , & V_97 -> V_101 ) ;
if ( V_97 -> V_61 == NULL ) {
F_7 ( V_15
L_27
L_28 ) ;
...
F_52 ( V_97 -> V_61 , 512 ) ;
F_53 ( V_97 -> V_61 , V_51 ) ;
V_97 -> V_70 = F_54 ( F_26 , V_97 , L_29 ) ;
if ( F_55 ( V_97 -> V_70 ) ) {
F_56 ( V_97 -> V_61 ) ;
F_57 ( V_103 , V_104 ) ;
return F_58 ( V_97 -> V_70 ) ;
}
V_97 -> V_53 = F_59 ( V_105 ) ;
if ( ! V_97 -> V_53 ) {
F_7 ( V_15
L_30 ) ;
goto V_102;
...
static void F_62 ( void * V_112 , T_5 V_113 )
{
int V_114 ;
if ( V_23 != F_63 ( & V_25 ) ) {
F_7 ( V_15 L_33
...
if ( F_49 ( & V_120 [ V_114 ] , V_114 ) == - V_28 )
goto V_121;
F_5 ( V_12 ,
L_42 ,
V_103 ) ;
