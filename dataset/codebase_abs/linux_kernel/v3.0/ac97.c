...
static T_3 int F_27 ( struct V_65 * V_66 )
{
struct V_67 * V_68 , * V_69 , * V_70 , * V_71 , * V_72 ;
struct V_73 * V_74 ;
int V_75 ;
V_74 = V_66 -> V_76 . V_77 ;
if ( ! V_74 || ! V_74 -> V_78 ) {
...
V_69 = F_29 ( V_66 , V_80 , 0 ) ;
if ( ! V_69 ) {
F_28 ( & V_66 -> V_76 , L_8 ) ;
return - V_81 ;
}
V_70 = F_29 ( V_66 , V_80 , 1 ) ;
if ( ! V_70 ) {
F_28 ( & V_66 -> V_76 , L_9 ) ;
return - V_81 ;
}
V_71 = F_29 ( V_66 , V_80 , 2 ) ;
if ( ! V_71 ) {
F_28 ( & V_66 -> V_76 , L_10 ) ;
return - V_81 ;
}
V_68 = F_29 ( V_66 , V_82 , 0 ) ;
if ( ! V_68 ) {
F_28 ( & V_66 -> V_76 , L_11 ) ;
return - V_81 ;
}
V_72 = F_29 ( V_66 , V_83 , 0 ) ;
if ( ! V_72 ) {
F_28 ( & V_66 -> V_76 , L_12 ) ;
return - V_81 ;
}
...
V_45 . V_59 = V_69 -> V_84 ;
V_45 . V_86 = V_68 -> V_84 + V_87 ;
V_46 . V_59 = V_70 -> V_84 ;
V_46 . V_86 = V_68 -> V_84 + V_87 ;
V_62 . V_59 = V_71 -> V_84 ;
V_62 . V_86 = V_68 -> V_84 + V_88 ;
F_32 ( & V_5 . V_9 ) ;
F_33 ( & V_5 . V_19 ) ;
V_5 . V_6 = F_34 ( V_68 -> V_84 , F_31 ( V_68 ) ) ;
if ( V_5 . V_6 == NULL ) {
F_28 ( & V_66 -> V_76 , L_15 ) ;
V_75 = - V_81 ;
goto V_89;
}
V_5 . V_90 = F_35 ( & V_66 -> V_76 , L_13 ) ;
if ( F_36 ( V_5 . V_90 ) ) {
F_28 ( & V_66 -> V_76 , L_16 ) ;
V_75 = - V_61 ;
goto V_91;
...
V_75 = F_38 ( V_72 -> V_84 , F_18 ,
V_93 , L_18 , NULL ) ;
if ( V_75 < 0 ) {
F_28 ( & V_66 -> V_76 , L_19 ) ;
goto V_94;
}
V_75 = F_39 ( & V_66 -> V_76 , V_95 ,
F_40 ( V_95 ) ) ;
if ( V_75 )
goto V_96;
return 0 ;
...
F_44 ( V_5 . V_6 ) ;
V_89:
F_45 ( V_68 -> V_84 , F_31 ( V_68 ) ) ;
return V_75 ;
}
static T_4 int F_46 ( struct V_65 * V_66 )
{
struct V_67 * V_68 , * V_72 ;
F_47 ( & V_66 -> V_76 , F_40 ( V_95 ) ) ;
V_72 = F_29 ( V_66 , V_83 , 0 ) ;
if ( V_72 )
F_41 ( V_72 -> V_84 , NULL ) ;
F_42 ( V_5 . V_90 ) ;
