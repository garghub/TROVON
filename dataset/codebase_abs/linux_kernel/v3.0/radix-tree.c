...
static unsigned int
F_43 ( struct V_7 * V_38 , void * * * V_58 , unsigned long V_34 ,
...
if ( V_65 > V_64 )
break;
V_66 = F_43 ( V_8 , ( void * * * ) V_58 + V_16 , V_65 ,
V_59 - V_16 , & V_60 ) ;
V_61 = 0 ;
...
static inline void F_49 ( struct V_3 * V_4 )
{
while ( V_4 -> V_32 > 0 ) {
struct V_7 * V_68 = V_4 -> V_35 ;
void * V_69 ;
F_18 ( ! F_19 ( V_68 ) ) ;
V_68 = F_2 ( V_68 ) ;
if ( V_68 -> V_29 != 1 )
...
void * F_50 ( struct V_3 * V_4 , unsigned long V_34 )
{
struct V_44 V_45 [ V_46 + 1 ] , * V_47 = V_45 ;
struct V_7 * V_38 = NULL ;
struct V_7 * V_68 ;
...
int F_51 ( struct V_3 * V_4 , unsigned int V_9 )
{
return F_13 ( V_4 , V_9 ) ;
}
static void
...
static T_2 unsigned long F_53 ( unsigned int V_32 )
{
unsigned int V_70 = V_32 * V_40 ;
int V_39 = V_71 - V_70 ;
if ( V_39 < 0 )
return ~ 0UL ;
if ( V_39 >= V_72 )
