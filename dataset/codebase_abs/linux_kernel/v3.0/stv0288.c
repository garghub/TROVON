...
if ( V_2 -> V_10 -> V_68 )
V_2 -> V_10 -> V_68 ( V_18 , 0 ) ;
V_59 -> V_69 = V_61 -> V_69 ;
V_59 -> V_70 . V_71 . V_72 = V_61 -> V_72 ;
if ( V_18 -> V_73 . V_74 . V_75 ) {
V_18 -> V_73 . V_74 . V_75 ( V_18 , V_59 ) ;
if ( V_18 -> V_73 . V_76 )
V_18 -> V_73 . V_76 ( V_18 , 0 ) ;
}
F_22 ( 10 ) ;
F_6 ( V_18 , V_61 -> V_72 ) ;
F_1 ( V_2 , 0x15 , 0xc5 ) ;
...
static int F_23 ( struct V_17 * V_18 , int V_80 )
{
struct V_1 * V_2 = V_18 -> V_19 ;
if ( V_80 )
F_1 ( V_2 , 0x01 , 0xb5 ) ;
...
struct V_17 * F_26 ( const struct V_81 * V_10 ,
struct V_82 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_83 ;
V_2 = F_27 ( sizeof( struct V_1 ) , V_84 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_14 = V_14 ;
