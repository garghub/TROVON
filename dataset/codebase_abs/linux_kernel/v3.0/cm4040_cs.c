...
if ( V_22 == V_81 )
return - V_44 ;
V_5 = F_44 ( sizeof( struct V_4 ) , V_98 ) ;
if ( V_5 == NULL )
return - V_99 ;
V_5 -> V_26 = V_66 ;
V_5 -> V_13 = 0 ;
...
F_48 ( V_100 , NULL , F_49 ( V_101 , V_22 ) , NULL , L_42 , V_22 ) ;
return 0 ;
}
...
V_83 [ V_91 ] = NULL ;
F_47 ( V_5 ) ;
F_51 ( V_100 , F_49 ( V_101 , V_91 ) ) ;
return;
}
static int T_6 F_52 ( void )
{
int V_23 ;
V_100 = F_53 ( V_102 , L_43 ) ;
if ( F_54 ( V_100 ) )
return F_55 ( V_100 ) ;
V_101 = F_56 ( 0 , V_97 , & V_103 ) ;
if ( V_101 < 0 ) {
