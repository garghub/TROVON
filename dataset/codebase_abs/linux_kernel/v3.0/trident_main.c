...
static int T_2 F_127 ( struct V_8 * V_9 , int V_253 )
{
struct V_254 V_255 ;
...
int T_2 F_141 ( struct V_8 * V_286 )
{
struct V_285 * V_297 ;
...
int T_2 F_141 ( struct V_8 * V_286 ) { return - V_303 ; }
static inline void F_150 ( struct V_8 * V_286 ) { }
...
static void T_2 F_160 ( struct V_8 * V_9 )
{
struct V_319 * V_320 ;
...
static int T_2 F_165 ( struct V_8 * V_9 )
{
int V_290 ;
...
int T_2 F_176 ( struct V_241 * V_148 ,
struct V_340 * V_215 ,
int V_347 ,
int V_253 ,
int V_348 ,
...
if ( ( V_98 = F_187 ( V_148 , V_365 , V_9 , & V_259 ) ) < 0 ) {
F_164 ( V_9 ) ;
return V_98 ;
}
...
static T_3 V_361 ( int V_357 , void * V_367 )
{
struct V_8 * V_9 = V_367 ;
unsigned int V_368 , V_369 , V_177 , V_53 , V_43 , V_41 ;
int V_85 ;
struct V_57 * V_42 ;
V_368 = F_5 ( F_4 ( V_9 , V_345 ) ) ;
...
struct V_57 * F_45 ( struct V_8 * V_9 , int type , int V_380 , int V_360 )
{
struct V_57 * V_381 ;
unsigned long V_7 ;
int V_48 ;
...
if ( V_42 -> V_55 )
F_17 ( V_9 , V_42 -> V_67 ) ;
V_42 -> V_382 = V_42 -> V_201 = V_42 -> V_55 = V_42 -> V_385 = 0 ;
...
static void F_196 ( struct V_8 * V_9 , unsigned short V_387 , unsigned short V_388 )
{
...
int F_197 ( struct V_340 * V_215 , T_4 V_389 )
{
struct V_241 * V_148 = F_198 ( V_215 ) ;
...
F_181 ( V_215 ) ;
F_202 ( V_215 ) ;
F_203 ( V_215 , F_204 ( V_215 , V_389 ) ) ;
return 0 ;
}
int F_205 ( struct V_340 * V_215 )
{
struct V_241 * V_148 = F_198 ( V_215 ) ;
struct V_8 * V_9 = V_148 -> V_10 ;
F_203 ( V_215 , V_391 ) ;
