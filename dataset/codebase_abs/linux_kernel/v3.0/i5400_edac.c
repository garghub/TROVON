...
F_39 ( L_21 ,
F_40 ( V_14 -> V_65 ) ,
V_14 -> V_65 -> V_66 , V_14 -> V_65 -> V_67 ) ;
F_39 ( L_22 ,
F_40 ( V_14 -> V_17 ) ,
V_14 -> V_17 -> V_66 , V_14 -> V_17 -> V_67 ) ;
F_39 ( L_23 ,
F_40 ( V_14 -> V_57 ) ,
V_14 -> V_57 -> V_66 , V_14 -> V_57 -> V_67 ) ;
V_14 -> V_56 = F_36 ( V_61 ,
V_68 , NULL ) ;
if ( ! V_14 -> V_56 ) {
F_37 ( V_63 ,
...
F_47 ( V_79 ) ? L_34 : L_35 ) ;
F_45 ( L_36 , F_48 ( V_79 ) ) ;
F_45 ( L_37 , F_49 ( V_79 ) ? L_38 : L_39 ) ;
F_45 ( L_40 , V_86 [ F_50 ( V_79 ) ] ) ;
F_45 ( L_41 , V_87 [ F_51 ( V_79 ) ] ) ;
}
...
V_80 = snprintf ( V_94 , V_96 , L_46 , V_78 ) ;
V_94 += V_80 ;
V_96 -= V_80 ;
for ( V_39 = 0 ; V_39 < V_14 -> V_69 ; V_39 ++ ) {
V_89 = & V_14 -> V_100 [ V_78 ] [ V_39 ] ;
F_52 ( V_14 , V_78 , V_39 , V_89 ) ;
V_80 = snprintf ( V_94 , V_96 , L_47 , V_89 -> V_92 ) ;
V_94 += V_80 ;
V_96 -= V_80 ;
}
F_45 ( L_45 , V_95 ) ;
...
V_94 = V_95 ;
V_96 = V_97 ;
V_80 = snprintf ( V_94 , V_96 , L_48 ) ;
V_94 += V_80 ;
V_96 -= V_80 ;
for ( V_39 = 0 ; V_39 < V_14 -> V_69 ; V_39 ++ ) {
V_80 = snprintf ( V_94 , V_96 , L_49 , V_39 ) ;
V_94 += V_80 ;
V_96 -= V_80 ;
}
F_45 ( L_45 , V_95 ) ;
...
int V_103 , V_104 ;
V_14 = V_12 -> V_16 ;
F_17 ( V_14 -> V_65 , V_105 ,
( T_1 * ) & V_14 -> V_106 ) ;
F_17 ( V_14 -> V_65 , V_105 + sizeof( T_1 ) ,
( ( T_1 * ) & V_14 -> V_106 ) + sizeof( T_1 ) ) ;
V_99 = V_14 -> V_99 ;
V_69 = V_14 -> V_69 ;
F_45 ( L_50 ,
( long unsigned int ) V_14 -> V_106 , V_14 -> V_69 , V_14 -> V_99 ) ;
F_18 ( V_14 -> V_17 , V_107 , & V_14 -> V_108 ) ;
V_14 -> V_108 >>= 12 ;
F_45 ( L_51 , V_14 -> V_108 ,
V_14 -> V_108 ) ;
