...
static inline void F_43 ( struct V_82 * V_59 ,
T_4 V_83 , T_4 V_84 , T_5 V_85 )
{
V_59 -> V_56 = NULL ;
V_59 -> V_86 = V_85 ;
V_59 -> V_87 = V_83 ;
...
F_43 ( & V_13 -> V_59 , V_83 , V_84 , V_85 ) ;
return V_13 ;
}
static inline int F_45 ( struct V_5 * V_13 , T_5 V_85 )
{
struct V_1 * V_14 = V_13 -> V_18 ;
struct V_89 * V_90 = & V_14 -> V_20 -> V_30 ;
int V_91 ;
V_91 = V_90 -> V_92 . V_93 / 8 ;
V_91 *= V_90 -> V_92 . V_94 ;
V_91 >>= V_13 -> V_60 . V_95 ;
if ( V_91 > 16 )
V_91 = 16 ;
while ( V_91 > 1 ) {
if ( ! ( V_85 % ( V_91 << V_13 -> V_60 . V_95 ) ) )
break;
V_91 -- ;
}
return V_91 ;
...
static struct V_6 *
F_46 ( struct V_2 * V_4 , T_4 V_83 ,
T_4 V_84 , T_5 V_85 , unsigned long V_15 )
{
struct V_5 * V_13 ;
struct V_1 * V_14 = F_1 ( V_4 ) ;
...
struct V_89 * V_90 ;
int V_96 ;
if ( F_47 ( ! V_14 || ! V_85 || ! V_77 ) )
return NULL ;
if ( V_77 -> V_80 != V_97 )
return NULL ;
V_90 = & V_14 -> V_20 -> V_30 ;
V_13 = F_44 ( V_14 , V_83 , V_84 , V_85 ) ;
if ( ! V_13 )
return NULL ;
V_13 -> V_60 . V_98 = 1 ;
V_13 -> V_60 . V_99 = 1 ;
V_96 = V_90 -> V_92 . V_93 / 8 ;
while ( V_96 > 1 ) {
if ( ! ( V_85 % V_96 ) )
break;
V_96 /= 2 ;
...
V_13 -> V_60 . V_95 = 0 ;
while ( V_96 != ( 1 << V_13 -> V_60 . V_95 ) )
V_13 -> V_60 . V_95 ++ ;
V_13 -> V_60 . V_100 = F_45 ( V_13 , V_85 ) ;
V_13 -> V_8 . V_15 = V_15 ;
return & V_13 -> V_8 ;
}
static struct V_6 *
...
struct V_127 * V_128 ;
int V_74 , V_23 , V_116 ;
V_124 = V_120 -> V_31 . V_129 ;
if ( ! V_124 || ! V_124 -> V_130 ) {
F_12 ( & V_120 -> V_31 , L_5 ) ;
return - V_131 ;
}
V_12 = F_55 ( V_124 -> V_130 * sizeof( * V_14 )
+ sizeof( * V_12 ) , V_132 ) ;
if ( ! V_12 ) {
F_12 ( & V_120 -> V_31 , L_6 ) ;
return - V_133 ;
...
V_90 = & V_12 -> V_30 ;
V_90 -> V_31 = & V_120 -> V_31 ;
V_90 -> V_134 = NULL ;
V_90 -> V_135 = V_124 -> V_136 ;
V_128 = & V_120 -> V_128 ;
F_56 ( V_128 -> V_137 , F_57 ( V_128 ) , L_7 ) ;
V_90 -> V_138 = F_58 ( V_128 -> V_137 , F_57 ( V_128 ) ) ;
if ( ! V_90 -> V_138 ) {
V_23 = - V_48 ;
goto V_139;
}
...
F_35 ( & V_12 -> V_22 ) ;
F_62 ( & V_12 -> V_21 ) ;
if ( ! F_36 ( V_12 , V_132 , V_142 ) )
F_63 ( & V_120 -> V_31 , L_8 ) ;
V_126 = & V_12 -> V_143 ;
F_35 ( & V_126 -> V_144 ) ;
for ( V_74 = 0 ; V_74 < V_124 -> V_130 ; V_74 ++ ) {
struct V_76 * V_77 = & V_124 -> V_77 [ V_74 ] ;
V_14 = & V_12 -> V_145 [ V_74 ] ;
switch ( V_77 -> V_80 ) {
case V_97 :
F_64 ( V_146 , V_126 -> V_147 ) ;
break;
case V_111 :
case V_113 :
F_64 ( V_148 , V_126 -> V_147 ) ;
break;
default:
F_12 ( & V_120 -> V_31 , L_9 ) ;
continue;
...
V_14 -> V_26 = NULL ;
V_14 -> V_4 . V_78 = V_77 ;
V_14 -> V_4 . V_149 = V_126 ;
V_14 -> V_4 . V_150 = V_74 ;
V_14 -> V_20 = V_12 ;
V_126 -> V_151 ++ ;
F_33 ( & V_14 -> V_4 . V_152 , & V_126 -> V_144 ) ;
}
...
L_12 ,
V_90 -> V_92 . V_94 ,
V_90 -> V_92 . V_93 / 8 , V_90 -> V_92 . V_162 ,
V_90 -> V_92 . V_163 , V_90 -> V_92 . V_164 ) ;
return 0 ;
V_160:
F_68 ( V_90 ) ;
V_141:
...
F_70 ( V_90 -> V_138 ) ;
V_139:
F_71 ( V_128 -> V_137 , F_57 ( V_128 ) ) ;
F_72 ( V_12 ) ;
return V_23 ;
}
static int T_8 F_73 ( struct V_119 * V_120 )
{
struct V_11 * V_12 = F_74 ( V_120 ) ;
