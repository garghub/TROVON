...
#ifdef F_96
if ( F_94 ( V_156 , & F_18 , V_175 , V_23 -> V_9 , V_23 ) )
{
...
memcpy ( & V_178 , ( V_68 * ) ( V_59 -> V_69 . V_70 . V_179 ) , 4 ) ;
V_25 -> V_180 = F_99 ( V_178 ) ;
break;
case V_72 :
memcpy ( V_23 -> V_67 , ( V_73 * ) ( V_59 -> V_69 . V_74 . V_71 ) , 6 ) ;
memcpy ( & V_178 , ( V_73 * ) ( V_59 -> V_69 . V_74 . V_179 ) , 4 ) ;
V_25 -> V_180 = F_99 ( V_178 ) ;
break;
default:
V_25 -> V_180 = 0 ;
...
V_27 * V_25 ;
struct V_7 * V_23 ;
int V_107 , V_191 , V_192 ;
for ( V_107 = 0 , V_59 = V_62 ; V_107 < V_193 ; V_107 ++ , V_59 ++ )
{
if ( V_59 -> V_23 )
{
V_25 = ( V_27 * ) ( F_17 ( V_59 -> V_23 ) ) ;
for ( V_191 = 0 ; V_191 < V_25 -> V_91 ; V_191 ++ )
for ( V_192 = 0 ; V_192 < V_194 ; V_192 ++ )
if ( ( V_23 = V_25 -> V_89 [ V_191 ] . V_195 [ V_192 ] -> V_3 ) )
{
F_73 ( V_23 , 0 ) ;
}
}
