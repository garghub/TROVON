...
static void F_19 ( T_8 V_19 , int V_20 )
{
struct V_1 V_1 ;
memset ( & V_1 , 0 , sizeof ( V_1 ) ) ;
V_1 . V_16 = 0x9610 ;
...
static void T_7 F_27 ( struct V_55 * V_56 )
{
if ( V_32 & V_35 ) {
T_6 V_57 = F_18 ( V_54 ) ;
if ( V_57 & 1 ) {
...
static int T_7 F_43 ( struct V_80 * V_75 ,
struct V_23 * V_81 )
{
switch ( V_81 -> type ) {
case V_28 :
...
static int T_7 F_50 ( struct V_98 * V_75 )
{
int V_12 ;
F_15 () ;
V_73 = F_17 () ;
...
static int T_9 F_51 ( struct V_98 * V_75 )
{
F_29 () ;
F_52 ( V_62 ) ;
F_48 ( V_62 -> V_63 ) ;
