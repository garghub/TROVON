...
goto V_55;
V_31 = - V_58 ;
V_8 = F_22 ( sizeof( * V_8 ) , V_59 ) ;
if ( ! V_8 )
goto V_55;
V_8 -> V_17 =
F_23 ( V_2 -> V_60 -> V_61 -> V_62 , V_63 ,
& V_8 -> V_18 , V_59 ) ;
if ( ! V_8 -> V_17 )
goto V_64;
V_8 -> V_33 = - 1 ;
...
{
struct V_5 * V_6 = V_2 -> V_6 ;
return F_28 ( V_2 -> V_60 -> V_61 -> V_62 , V_66 ,
V_6 -> V_67 ,
V_6 -> V_19 ,
V_6 -> V_16 ) ;
}
int F_29 ( struct V_68 * V_60 , int V_21 )
{
...
V_71 -> V_9 = NULL ;
V_71 -> V_75 = F_23 ( V_60 -> V_61 -> V_62 , V_72 ,
& V_71 -> V_76 , V_59 ) ;
if ( ! V_71 -> V_75 )
return - V_58 ;
V_71 -> V_77 = V_72 ;
