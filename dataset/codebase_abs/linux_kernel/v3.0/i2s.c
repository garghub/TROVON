...
T_4 int F_62 ( struct V_146 * V_32 )
{
...
V_151 = V_32 -> V_33 . V_161 ;
if ( V_151 == NULL ) {
F_22 ( & V_32 -> V_33 , L_15 ) ;
return - V_68 ;
}
V_155 = F_65 ( V_32 , V_162 , 0 ) ;
if ( ! V_155 ) {
F_22 ( & V_32 -> V_33 , L_16 ) ;
return - V_142 ;
}
V_147 = V_155 -> V_163 ;
V_155 = F_65 ( V_32 , V_162 , 1 ) ;
if ( ! V_155 ) {
F_22 ( & V_32 -> V_33 , L_17 ) ;
return - V_142 ;
}
V_148 = V_155 -> V_163 ;
V_155 = F_65 ( V_32 , V_162 , 2 ) ;
if ( V_155 )
V_149 = V_155 -> V_163 ;
else
V_149 = 0 ;
V_155 = F_65 ( V_32 , V_164 , 0 ) ;
if ( ! V_155 ) {
F_22 ( & V_32 -> V_33 , L_18 ) ;
return - V_142 ;
}
if ( ! F_66 ( V_155 -> V_163 , F_67 ( V_155 ) ,
L_19 ) ) {
F_22 ( & V_32 -> V_33 , L_20 ) ;
return - V_165 ;
}
V_156 = V_155 -> V_163 ;
V_153 = & V_151 -> type . V_2 ;
V_62 = V_153 -> V_62 ;
V_3 = F_68 ( V_32 , false ) ;
if ( ! V_3 ) {
F_22 ( & V_32 -> V_33 , L_21 ) ;
...
V_3 -> V_109 . V_168 = V_156 + V_169 ;
V_3 -> V_110 . V_168 = V_156 + V_170 ;
V_3 -> V_109 . V_171 =
(struct V_172 * ) & V_3 -> V_109 ;
V_3 -> V_110 . V_171 =
(struct V_172 * ) & V_3 -> V_110 ;
V_3 -> V_109 . V_173 = V_147 ;
V_3 -> V_110 . V_173 = V_148 ;
V_3 -> V_67 = V_153 -> V_67 ;
V_3 -> V_109 . V_174 = 4 ;
V_3 -> V_110 . V_174 = 4 ;
V_3 -> V_141 = V_156 ;
...
V_12 -> V_109 . V_168 = V_156 + V_180 ;
V_12 -> V_109 . V_171 =
(struct V_172 * ) & V_12 -> V_109 ;
V_12 -> V_109 . V_173 = V_149 ? : - 1 ;
V_12 -> V_67 = V_153 -> V_67 ;
V_12 -> V_109 . V_174 = 4 ;
V_12 -> V_141 = V_156 ;
V_12 -> V_62 = V_62 ;
V_12 -> V_3 = V_3 ;
...
if ( V_151 -> V_181 && V_151 -> V_181 ( V_32 ) ) {
F_22 ( & V_32 -> V_33 , L_23 ) ;
V_157 = - V_68 ;
goto V_182;
}
F_64 ( & V_3 -> V_32 -> V_33 , & V_3 -> V_160 ) ;
return 0 ;
V_182:
F_69 ( V_12 ) ;
V_179:
F_69 ( V_3 ) ;
V_167:
F_70 ( V_156 , F_67 ( V_155 ) ) ;
return V_157 ;
}
static T_5 int F_71 ( struct V_146 * V_32 )
{
struct V_1 * V_2 , * V_11 ;
V_2 = F_63 ( & V_32 -> V_33 ) ;
