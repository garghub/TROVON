...
void T_2 F_48 ( char * V_94 , int * V_95 )
{
if ( V_95 [ 0 ] < 1 ) {
F_14 ( L_26 ) ;
return;
...
F_55 ( V_108 ) ;
V_102 = V_109 + V_110 ;
while ( F_57 ( V_109 , V_102 ) )
F_58 () ;
F_14 ( L_29 ) ;
}
const char * F_59 ( struct V_51 * V_49 )
{
static const char string [] = L_30 ;
return string ;
}
unsigned long F_60 ( struct V_51 * V_52 , void * V_111 ,
...
static long F_64 ( struct V_51 * V_52 )
{
return V_24 ;
}
static int F_65 ( T_3 * V_97 )
{
...
static unsigned long F_66 ( unsigned long V_130 ,
T_3 * V_97 , int V_131 )
{
...
V_133 = ( V_82 && ! F_61 ( F_37 ( V_97 -> V_134 . V_135 ) ) ) ?
V_83 : 255 * 512 ;
if ( V_132 > V_133 )
V_132 = V_133 ;
if ( V_132 != V_130 )
