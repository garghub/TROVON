...
V_2 -> V_45 = V_45 ;
V_2 -> V_41 = V_52 . V_61 ;
V_2 -> V_62 = F_19 ( V_52 . V_63 - V_52 . V_61 ) ;
V_2 -> V_64 = F_20 ( V_2 -> V_41 , V_2 -> V_62 ) ;
V_2 -> V_65 = F_19 ( V_36 . V_63 - V_36 . V_61 ) ;
V_57 = F_21 ( V_2 -> V_65 , 0 , V_66 , V_67 ) ;
if ( V_57 == NULL )
return - V_59 ;
V_2 -> V_68 = ( void V_69 * ) ( V_57 -> V_70 ) ;
V_2 -> V_4 = F_20 ( 0xfc103000 , 0x1000 ) ;
F_22 ( V_46 , V_2 ) ;
if ( ! V_2 -> V_64 || ! V_2 -> V_68 || ! V_2 -> V_4 ||
( F_23 ( V_36 . V_61 , V_2 -> V_68 , V_2 -> V_65 ,
V_71 | V_72 ) == NULL ) ) {
F_24 ( V_46 , L_2 ) ;
V_53 = - V_59 ;
goto V_73;
}
V_2 -> V_74 = ( unsigned long ) V_2 -> V_68 - V_75 ;
V_2 -> V_76 . V_61 = ( unsigned long ) V_2 -> V_64 ;
V_2 -> V_76 . V_63 = ( unsigned long ) V_2 -> V_64 + ( V_52 . V_63 - V_52 . V_61 ) ;
V_2 -> V_76 . V_27 = V_77 ;
V_2 -> V_16 = F_25 ( V_49 , 0 ) ;
V_53 = F_26 ( V_2 -> V_16 , F_7 , V_78 ,
V_32 , V_2 ) ;
if ( V_53 < 0 ) {
F_24 ( V_46 , L_3 ) ;
goto V_73;
...
V_54 = F_27 ( V_49 , L_4 , NULL ) ;
if ( ! V_54 )
goto V_73;
V_2 -> V_5 = * V_54 ;
V_54 = F_27 ( V_49 , L_5 , NULL ) ;
if ( ! V_54 )
goto V_73;
V_2 -> V_79 = * V_54 ;
V_54 = F_27 ( V_49 , L_6 , NULL ) ;
if ( ! V_54 )
goto V_73;
V_2 -> V_30 = * V_54 ;
V_54 = F_27 ( V_49 , L_7 , NULL ) ;
if ( ! V_54 )
goto V_73;
V_2 -> V_31 = * V_54 ;
V_2 -> V_10 . V_80 = V_2 -> V_74 ;
if ( ! F_28 ( V_2 -> V_41 , V_2 -> V_62 , V_32 ) ) {
V_53 = - V_81 ;
F_24 ( V_46 , L_8 ) ;
goto V_73;
}
if ( ! F_29 ( V_2 -> V_74 , V_2 -> V_65 , V_32 ) ) {
V_53 = - V_81 ;
F_24 ( V_46 , L_9 ) ;
goto V_82;
}
...
return 0 ;
V_95:
F_32 ( V_2 -> V_74 , V_2 -> V_65 ) ;
V_82:
F_33 ( V_2 -> V_41 , V_2 -> V_62 ) ;
V_73:
if ( V_2 -> V_16 != V_60 )
F_34 ( V_2 -> V_16 , V_2 ) ;
if ( V_2 -> V_68 )
F_35 ( V_2 -> V_68 , V_2 -> V_65 ) ;
if ( V_2 -> V_64 )
F_36 ( V_2 -> V_64 ) ;
if ( V_2 -> V_4 )
F_36 ( V_2 -> V_4 ) ;
