...
void F_38 ( struct V_1 * V_2 , int V_19 )
{
V_2 -> V_37 . V_69 = ! V_19 ;
}
void F_39 ( struct V_1 * V_2 , T_1 V_70 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_7 ;
if ( F_40 ( V_2 -> V_37 . V_32 == V_70 ) )
return;
V_2 -> V_37 . V_32 = V_70 ;
for ( V_7 = 0 ; V_7 < F_4 ( V_4 -> V_45 ) ; V_7 ++ ) {
struct V_43 * V_44 = & V_4 -> V_45 [ V_7 ] ;
...
return 0 ;
V_71 = F_20 ( V_6 ) ;
if ( ! F_42 ( V_2 -> V_59 , V_71 >> V_58 ) )
return 0 ;
return 1 ;
}
int F_43 ( struct V_1 * V_2 , T_7 V_72 , T_7 V_73 , T_7 V_74 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 ;
unsigned int V_34 ;
...
case V_78 :
V_6 -> V_12 = F_46 ( V_2 ) ;
V_6 -> V_10 = F_44 ( V_2 , V_73 ) ;
break;
case V_79 :
V_6 -> V_13 = F_44 ( V_2 , V_73 ) ;
break;
case V_80 :
V_6 -> V_14 = F_44 ( V_2 , V_73 ) ;
break;
default:
return V_77 ;
}
...
int F_49 ( struct V_1 * V_2 , T_7 V_84 , T_7 V_72 , T_7 V_85 , T_7 V_86 )
{
T_1 V_87 ;
int V_34 ;
...
if ( V_72 )
V_87 += F_44 ( V_2 , V_72 ) ;
V_34 = F_14 ( V_2 , V_87 , V_32 , V_33 ) ;
if ( V_86 ) {
T_1 V_88 = F_51 ( V_2 ) ;
if ( V_34 < 0 )
F_52 ( V_2 , V_88 & ~ 0x20000000 ) ;
else
F_52 ( V_2 , V_88 | 0x20000000 ) ;
}
F_53 ( V_2 , V_84 , V_34 ) ;
