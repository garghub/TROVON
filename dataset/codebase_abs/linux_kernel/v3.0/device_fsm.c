...
case 0 :
F_43 ( V_4 , V_87 ) ;
if ( V_4 -> V_9 -> V_30 . V_110 ) {
memset ( & V_4 -> V_9 -> V_88 , 0 , sizeof( struct V_88 ) ) ;
V_4 -> V_9 -> V_88 . V_42 . V_24 . V_11 = 1 ;
V_4 -> V_9 -> V_88 . V_42 . V_24 . V_111 = V_112 ;
V_4 -> V_9 -> V_88 . V_42 . V_24 . V_113 = V_114 ;
V_4 -> V_9 -> V_88 . V_42 . V_24 . V_115 =
V_116 ;
V_4 -> V_9 -> V_30 . V_110 = 0 ;
if ( V_4 -> V_117 )
V_4 -> V_117 ( V_4 , V_4 -> V_9 -> V_118 ,
& V_4 -> V_9 -> V_88 ) ;
memset ( & V_4 -> V_9 -> V_88 , 0 , sizeof( struct V_88 ) ) ;
}
F_52 ( V_4 ) ;
...
static void
F_63 ( struct V_3 * V_4 , enum V_96 V_96 )
{
struct V_6 * V_7 ;
if ( V_4 -> V_9 -> V_29 == V_124 ) {
V_4 -> V_9 -> V_30 . V_109 = 1 ;
return;
}
V_7 = F_3 ( V_4 -> V_12 . V_13 ) ;
if ( F_20 ( V_7 ) ) {
...
if ( F_21 ( & V_7 -> V_5 . V_42 ) != 0 ||
( F_64 ( & V_7 -> V_5 . V_42 ) & V_116 ) ||
( F_64 ( & V_4 -> V_9 -> V_88 . V_42 ) & V_116 ) ) {
V_4 -> V_9 -> V_30 . V_109 = 1 ;
return;
}
V_4 -> V_9 -> V_29 = V_121 ;
...
static void
F_66 ( struct V_3 * V_4 , enum V_96 V_96 )
{
struct V_88 * V_88 ;
int V_125 ;
V_88 = (struct V_88 * ) & V_126 . V_88 ;
V_125 = ! F_22 ( & V_88 -> V_42 ) ;
if ( ! F_67 ( & V_88 -> V_42 ) ) {
if ( V_125 && ( V_88 -> V_42 . V_24 . V_127 & V_128 ) &&
! V_88 -> V_129 . V_130 . V_131 . V_132 ) {
if ( F_68 ( V_4 , V_88 ) != 0 )
goto V_133;
...
V_133:
if ( V_4 -> V_117 )
V_4 -> V_117 ( V_4 , 0 , V_88 ) ;
if ( V_4 -> V_9 -> V_30 . V_109 )
F_63 ( V_4 , 0 ) ;
return;
}
F_69 ( V_4 , V_88 ) ;
if ( V_125 && V_4 -> V_9 -> V_30 . V_134 ) {
if ( F_68 ( V_4 , V_88 ) == 0 ) {
V_4 -> V_9 -> V_29 = V_124 ;
}
return;
}
if ( F_70 ( V_4 ) && V_4 -> V_9 -> V_30 . V_109 )
F_63 ( V_4 , 0 ) ;
}
static void
F_71 ( struct V_3 * V_4 , enum V_96 V_96 )
{
int V_38 ;
F_14 ( V_4 , 0 ) ;
V_4 -> V_9 -> V_46 = 255 ;
...
if ( F_75 ( & V_88 -> V_42 ) &
( V_139 | V_140 ) ) {
V_4 -> V_9 -> V_30 . V_134 = 0 ;
memset ( & V_4 -> V_9 -> V_88 , 0 , sizeof( struct V_88 ) ) ;
F_69 ( V_4 , V_88 ) ;
goto V_141;
}
F_76 ( V_4 , V_88 ) ;
if ( V_4 -> V_9 -> V_30 . V_134 ) {
F_68 ( V_4 , V_88 ) ;
return;
}
V_141:
...
static void
F_77 ( struct V_3 * V_4 , enum V_96 V_96 )
{
F_14 ( V_4 , 0 ) ;
F_63 ( V_4 , 0 ) ;
if ( V_4 -> V_117 )
...
static void
F_78 ( struct V_3 * V_4 , enum V_96 V_96 )
{
int V_38 ;
V_38 = F_19 ( V_4 ) ;
if ( V_38 == - V_47 ) {
...
static void
F_81 ( struct V_3 * V_4 , enum V_96 V_96 )
{
struct V_6 * V_7 ;
V_7 = F_3 ( V_4 -> V_12 . V_13 ) ;
...
static void
F_86 ( struct V_3 * V_4 , enum V_96 V_96 )
{
F_87 ( V_4 ) ;
V_4 -> V_9 -> V_29 = V_87 ;
F_12 ( V_4 , V_96 ) ;
...
static void
F_90 ( struct V_3 * V_4 , enum V_96 V_96 )
{
F_14 ( V_4 , 0 ) ;
V_4 -> V_9 -> V_29 = V_63 ;
F_35 ( & V_4 -> V_9 -> V_69 ) ;
...
static void
F_91 ( struct V_3 * V_4 , enum V_96 V_96 )
{
int V_38 ;
V_38 = F_19 ( V_4 ) ;
if ( V_38 == - V_47 ) {
