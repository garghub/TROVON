...
#ifdef F_20
V_8 -> V_9 . V_83 = V_84 ;
V_8 -> V_9 . V_85 = F_28 ( V_84 ) ;
V_8 -> V_9 . V_86 = F_1 ;
V_8 -> V_9 . V_87 = L_8 ;
V_8 -> V_9 . type = V_88 ;
V_8 -> V_9 . V_89 = 0 ;
V_13 = F_29 ( & V_21 -> V_29 , & V_8 -> V_9 ) ;
if ( V_13 ) {
F_6 ( V_21 , L_9 ,
V_13 ) ;
goto V_90;
...
V_8 -> V_18 . V_83 = V_91 ;
V_8 -> V_18 . V_85 = F_28 ( V_91 ) ;
V_8 -> V_18 . V_86 = F_3 ;
V_8 -> V_18 . V_87 = L_10 ;
V_8 -> V_18 . type = V_92 ;
V_8 -> V_18 . V_89 = 0 ;
V_13 = F_29 ( & V_21 -> V_29 , & V_8 -> V_18 ) ;
if ( V_13 ) {
F_6 ( V_21 ,
L_11 , V_13 ) ;
F_30 ( & V_8 -> V_9 ) ;
...
V_41 = F_12 ( V_21 -> V_51 . V_52 , struct V_40 , V_53 ) ;
V_43 = V_41 -> V_43 ;
V_43 -> V_93 [ 0 ] |= F_31 ( V_94 ) | F_31 ( V_95 ) | F_31 ( V_96 ) ;
F_32 ( V_68 , V_43 -> V_97 ) ;
F_32 ( V_55 , V_43 -> V_98 ) ;
F_32 ( V_62 , V_43 -> V_98 ) ;
F_32 ( V_63 , V_43 -> V_98 ) ;
...
F_32 ( V_56 , V_43 -> V_98 ) ;
F_32 ( V_57 , V_43 -> V_98 ) ;
F_33 ( V_43 , V_66 , 0 , 16704 , 4 , 0 ) ;
F_33 ( V_43 , V_67 , 0 , 12064 , 4 , 0 ) ;
F_33 ( V_43 , V_65 , 0 , 511 , 0 , 0 ) ;
F_33 ( V_43 , V_61 , 0 , 32 , 0 , 0 ) ;
return 0 ;
V_80:
F_34 ( V_8 ) ;
return V_13 ;
