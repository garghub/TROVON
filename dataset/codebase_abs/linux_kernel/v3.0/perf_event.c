...
switch ( V_102 -> type ) {
case V_120 :
if ( V_102 -> V_24 >= V_12 -> V_121 )
return - V_81 ;
V_2 = V_12 -> V_122 ( V_102 -> V_24 ) ;
break;
case V_123 :
V_2 = F_52 ( V_102 -> V_24 ) ;
if ( F_62 ( V_2 ) )
...
static void F_64 ( struct V_57 * V_57 )
{
struct V_18 * V_127 = & F_27 ( V_18 ) ;
F_37 ( V_57 ) ;
V_127 -> V_114 |= V_115 ;
}
...
static int F_66 ( struct V_57 * V_57 )
{
struct V_18 * V_19 = & F_27 ( V_18 ) ;
int V_100 ;
if ( ! V_12 )
...
static int T_5 F_70 ( struct V_129 * V_130 ,
unsigned long V_131 , void * V_132 )
{
struct V_133 * args = V_132 ;
struct V_134 V_135 ;
struct V_18 * V_19 ;
struct V_136 * V_137 ;
int V_45 ;
...
if ( V_5 & ( 1ULL << 31 ) )
continue;
V_135 . V_40 = V_31 -> V_52 . V_43 ;
if ( ! F_21 ( V_31 , V_21 , V_10 ) )
continue;
if ( F_72 ( V_31 , 1 , & V_135 , V_137 ) )
F_34 ( V_31 , 0 ) ;
}
return V_140 ;
}
...
F_75 ( L_11 , V_141 ) ;
F_76 ( & V_57 , L_12 , V_124 ) ;
F_77 ( & V_145 ) ;
return 0 ;
}
void F_78 ( struct V_146 * V_147 ,
struct V_136 * V_137 )
{
...
#endif
F_80 () ;
F_81 ( V_147 , V_137 -> V_151 ) ;
V_148 = V_137 -> V_152 [ V_153 ] ;
V_149 = V_148 + V_154 ;
do {
struct V_155 * V_156 ;
struct V_136 * V_137 ;
...
if ( ! F_82 ( F_83 () , V_149 ) )
break;
V_156 = (struct V_155 * ) V_149 ;
V_137 = (struct V_136 * ) ( V_156 + 1 ) ;
if ( F_84 ( F_83 () , V_137 ) ) {
if ( F_85 ( V_137 ) )
break;
V_157 = V_137 -> V_151 ;
V_149 = V_137 -> V_152 [ V_153 ] + V_154 ;
} else {
V_157 = V_156 -> V_158 ;
V_149 = ( unsigned long ) V_156 -> V_149 + V_154 ;
}
F_81 ( V_147 , V_157 ) ;
#ifdef F_79
if ( ( V_157 + 8UL ) == ( unsigned long ) & V_159 ) {
int V_160 = V_161 -> V_162 ;
if ( V_161 -> V_163 && V_160 >= V_150 ) {
V_157 = V_161 -> V_163 [ V_160 - V_150 ] . V_42 ;
F_81 ( V_147 , V_157 ) ;
V_150 ++ ;
}
}
#endif
} while ( V_147 -> V_164 < V_165 );
}
...
unsigned long V_166 ;
F_81 ( V_147 , V_137 -> V_151 ) ;
V_166 = V_137 -> V_152 [ V_153 ] + V_154 ;
do {
struct V_155 * V_167 , V_156 ;
unsigned long V_157 ;
V_167 = (struct V_155 * ) V_166 ;
if ( F_87 ( & V_156 , V_167 , sizeof( V_156 ) ) )
break;
V_157 = V_156 . V_158 ;
V_166 = ( unsigned long ) V_156 . V_149 + V_154 ;
F_81 ( V_147 , V_157 ) ;
} while ( V_147 -> V_164 < V_165 );
}
...
unsigned long V_166 ;
F_81 ( V_147 , V_137 -> V_151 ) ;
V_166 = V_137 -> V_152 [ V_153 ] & 0xffffffffUL ;
do {
struct V_168 * V_167 , V_156 ;
unsigned long V_157 ;
V_167 = (struct V_168 * ) V_166 ;
if ( F_87 ( & V_156 , V_167 , sizeof( V_156 ) ) )
break;
V_157 = V_156 . V_158 ;
V_166 = ( unsigned long ) V_156 . V_149 ;
F_81 ( V_147 , V_157 ) ;
} while ( V_147 -> V_164 < V_165 );
}
void
F_89 ( struct V_146 * V_147 , struct V_136 * V_137 )
{
F_90 () ;
if ( F_91 ( V_169 ) )
F_88 ( V_147 , V_137 ) ;
