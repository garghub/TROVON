...
static int F_9 ( struct V_29 * V_30 , struct V_31 * V_32 )
{
struct V_1 * V_2 ;
int V_33 = 0 ;
int V_34 = 0 ;
...
F_5 ( V_2 , V_43 , 2 ) ;
V_35 = V_32 -> V_50 / 1000 ;
V_2 -> V_51 = ( V_30 -> V_48 . V_52 . type == V_53 ) ? V_32 -> V_54 . V_55 . V_51 : 0 ;
V_37 = V_35 + V_44 * 1000 ;
V_37 = ( V_37 / 250 ) * 250 ;
V_38 = V_37 - V_35 - V_56 ;
V_38 = ( ( V_38 + 25 ) / 50 ) * 50 ;
V_2 -> V_50 = ( V_37 - V_38 - V_56 ) * 1000 ,
#ifdef F_10
V_40 = F_7 ( V_37 , V_38 , V_56 ) ;
V_37 += V_40 ;
V_38 += V_40 ;
#endif
V_40 = V_37 / ( V_57 / 64 ) ;
...
return;
if ( F_5 ( V_2 , V_61 , sizeof( V_61 ) ) )
return;
F_4 ( V_2 , V_62 , ( V_2 -> V_8 -> V_63 << 6 ) | 0x30 ) ;
do {
V_43 |= ( 1 << 6 ) ;
F_4 ( V_2 , V_64 , V_43 ) ;
F_11 ( 20 ) ;
...
V_34 = 0 ;
while ( V_34 ++ < 10 && F_1 ( V_2 , V_65 , & V_43 ) == 0 && ( V_43 & ( 1 << 6 ) ) == 0 )
F_11 ( 20 ) ;
if ( V_34 <= 10 ) {
F_1 ( V_2 , V_66 , & V_2 -> V_67 ) ;
F_8 ( L_10 , ( int ) V_2 -> V_67 ) ;
} else
F_8 ( L_11 ) ;
}
...
struct V_29 * F_19 ( struct V_29 * V_30 , struct V_68 * V_14 , struct V_69 * V_8 , T_3 V_44 )
{
struct V_1 * V_2 = NULL ;
T_1 V_70 = 0 ;
V_2 = F_20 ( sizeof( struct V_1 ) , V_71 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_8 = V_8 ;
V_2 -> V_14 = V_14 ;
...
F_3 ( V_74 L_12 , V_44 ) ;
memcpy ( & V_30 -> V_48 . V_75 , & V_76 , sizeof( struct V_77 ) ) ;
V_30 -> V_45 = V_2 ;
F_12 ( V_2 ) ;
if ( V_30 -> V_48 . V_49 )
V_30 -> V_48 . V_49 ( V_30 , 0 ) ;
