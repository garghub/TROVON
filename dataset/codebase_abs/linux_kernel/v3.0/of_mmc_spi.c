...
for ( V_24 = 0 ; V_24 < F_18 ( V_7 -> V_11 ) ; V_24 ++ ) {
enum V_32 V_33 ;
V_7 -> V_11 [ V_24 ] = F_19 ( V_20 , V_24 , & V_33 ) ;
if ( ! F_20 ( V_7 -> V_11 [ V_24 ] ) )
continue;
V_25 = F_21 ( V_7 -> V_11 [ V_24 ] , F_10 ( V_3 ) ) ;
if ( V_25 < 0 ) {
V_7 -> V_11 [ V_24 ] = - V_26 ;
continue;
}
...
if ( F_20 ( V_7 -> V_11 [ V_12 ] ) )
V_7 -> V_5 . V_35 = F_5 ;
if ( F_20 ( V_7 -> V_11 [ V_13 ] ) )
V_7 -> V_5 . V_36 = F_6 ;
V_7 -> V_15 = F_22 ( V_20 , 0 ) ;
if ( V_7 -> V_15 != V_37 ) {
V_7 -> V_5 . V_38 = F_7 ;
V_7 -> V_5 . exit = F_11 ;
} else {
