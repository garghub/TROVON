...
F_61 ( V_173 . V_174 , V_4 ) ;
F_62 ( & V_173 , V_30 -> V_112 ) ;
V_30 -> V_175 = & V_173 ;
V_172 = & V_173 ;
}
#endif
...
static T_10 F_63 ( struct V_176 * V_177 , void * V_8 )
{
struct V_137 * V_138 ;
T_10 V_178 ;
struct V_179 V_5 ;
V_138 = V_8 ;
V_178 = F_64 ( V_177 , & V_5 ) ;
if ( F_65 ( V_178 ) ) {
V_138 -> V_139 = V_5 . V_180 ;
V_138 -> V_159 = F_66 ( V_5 . V_180 , V_5 . V_181 ) ;
if ( F_53 ( V_138 ) ) {
F_67 ( V_138 -> V_159 ) ;
return V_182 ;
}
} else if ( V_177 -> type == V_183 ) {
struct V_184 * V_185 ;
V_185 = & V_177 -> V_8 . V_186 ;
if ( ! V_185 )
return V_187 ;
V_138 -> V_139 = V_185 -> V_188 ;
V_138 -> V_159 = F_66 ( V_185 -> V_188 ,
V_189 ) ;
if ( F_53 ( V_138 ) ) {
F_67 ( V_138 -> V_159 ) ;
return V_182 ;
}
} else if ( V_177 -> type == V_190 ) {
struct V_191 * V_192 ;
int V_58 , V_7 ;
V_192 = & V_177 -> V_8 . V_193 ;
for ( V_58 = 0 ; V_58 < V_192 -> V_194 ; V_58 ++ ) {
V_7 = F_17 ( NULL , V_192 -> V_195 [ V_58 ] ,
V_192 -> V_196 , V_192 -> V_197 ) ;
if ( V_7 < 0 )
return V_198 ;
...
static int F_68 ( struct V_200 * V_201 )
{
T_10 V_202 ;
struct V_137 V_8 ;
memset ( & V_8 , 0 , sizeof( V_8 ) ) ;
V_202 =
F_69 ( V_201 -> V_203 , V_204 ,
F_63 , & V_8 ) ;
if ( F_70 ( V_202 ) )
return - V_164 ;
...
static int F_71 ( struct V_200 * V_201 , int type )
{
return - V_61 ;
}
