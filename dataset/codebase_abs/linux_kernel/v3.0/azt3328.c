...
F_128 ( V_15 -> V_268 ) ;
F_134 ( V_15 ) ;
V_133 = F_148 ( V_86 , V_346 , V_15 , & V_77 ) ;
if ( V_133 < 0 )
goto V_339;
V_133 = F_35 ( V_15 ) ;
if ( V_133 < 0 )
...
static int T_4
F_152 ( struct V_331 * V_85 , const struct V_347 * V_348 )
{
static int V_255 ;
struct V_129 * V_86 ;
struct V_14 * V_15 ;
...
V_133 = F_153 ( V_354 [ V_255 ] , V_355 [ V_255 ] , V_356 , 0 , & V_86 ) ;
if ( V_133 < 0 )
return V_133 ;
strcpy ( V_86 -> V_357 , L_62 ) ;
strcpy ( V_86 -> V_299 , L_80 ) ;
V_133 = F_137 ( V_86 , V_85 , V_348 -> V_358 , & V_15 ) ;
if ( V_133 < 0 )
goto V_339;
V_86 -> V_61 = V_15 ;
V_133 = F_154 (
V_86 , 0 ,
V_359 , V_15 -> V_327 , V_360 ,
V_85 -> V_268 , 0 , & V_15 -> V_283
) ;
if ( V_133 < 0 ) {
F_60 ( V_87 L_81 ,
V_15 -> V_327
...
V_133 = F_156 ( V_350 , 1 , 2 ) ;
if ( V_133 < 0 )
goto V_339;
V_133 = F_157 ( V_350 , 0 , 1 , NULL ) ;
if ( V_133 < 0 )
goto V_339;
}
V_350 -> V_61 = V_15 ;
sprintf ( V_86 -> V_362 , L_83 ,
...
static inline void
F_164 ( unsigned long V_364 , unsigned V_11 , T_3 * V_365 )
{
unsigned V_1 ;
...
F_171 ( V_15 -> V_59 ) ;
#else
F_166 ( V_15 -> V_366 , V_15 -> V_18 ,
F_50 ( V_15 -> V_366 ) ) ;
F_7 ( ( ( T_2 * ) V_15 -> V_366 ) [ 1 ] , V_15 -> V_18 + 2 ) ;
#endif
}
static int
F_172 ( struct V_331 * V_85 , T_8 V_367 )
{
...
V_368 = ( T_2 * ) V_15 -> V_370 ;
V_368 [ V_191 / 2 ] = V_15 -> V_190 ;
F_164 ( V_15 -> V_17 ,
...
F_147 ( V_85 ) ;
F_166 ( V_15 -> V_371 , V_15 -> V_17 ,
F_50 ( V_15 -> V_371 ) ) ;
F_166 ( V_15 -> V_372 , V_15 -> V_327 ,
F_50 ( V_15 -> V_372 ) ) ;
F_166 ( V_15 -> V_373 , V_15 -> V_328 ,
F_50 ( V_15 -> V_373 ) ) ;
F_170 ( V_15 ) ;
F_166 ( V_15 -> V_370 , V_15 -> V_16 ,
F_50 ( V_15 -> V_370 ) ) ;
F_173 ( V_86 , V_376 ) ;
return 0 ;
}
