...
int V_141 ;
int V_142 = 0 ;
for ( V_141 = 0 ; V_141 < F_31 ( V_143 ) ; V_141 ++ )
V_142 += sprintf ( V_133 + V_142 , L_8 , V_143 [ V_141 ] ) ;
sprintf ( V_133 + V_142 - 1 , L_9 ) ;
return V_142 ;
}
...
{
struct V_1 * V_2 = F_36 ( V_52 ) ;
return sprintf ( V_133 , L_10 , V_2 -> V_144 ) ;
}
static int F_46 ( struct V_1 * V_2 , int V_145 )
{
int V_141 ;
for ( V_141 = 0 ; V_141 < F_31 ( V_143 ) ; V_141 ++ )
if ( V_145 >= V_143 [ V_141 ] )
break;
if ( V_141 == F_31 ( V_143 ) )
return - V_140 ;
V_2 -> V_111 = V_146 [ V_141 ] ;
V_2 -> V_144 = V_143 [ V_141 ] ;
if ( F_13 ( & V_2 -> V_6 -> V_52 ) )
return 0 ;
...
static int T_8 F_68 ( struct V_5 * V_6 ,
...
static int T_9 F_81 ( struct V_5 * V_6 )
{
...
{
struct V_5 * V_6 = F_87 ( V_52 , struct V_5 , V_52 ) ;
struct V_1 * V_2 = F_82 ( V_6 ) ;
F_33 ( V_2 ) ;
return 0 ;
}
