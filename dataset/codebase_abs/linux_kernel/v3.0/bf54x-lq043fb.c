...
V_150 = F_69 ( V_40 , & V_95 -> V_85 , NULL , & V_151 ) ;
V_150 -> V_97 . V_152 = 255 , F_27 ( V_153 L_19 ) ;
#endif
return 0 ;
V_145:
F_70 ( V_46 -> V_90 , V_46 ) ;
...
static int F_80 ( struct V_94 * V_95 , T_7 V_154 )
{
struct V_45 * V_98 = F_77 ( V_95 ) ;
F_16 ( F_37 () & ~ V_51 ) ;
F_40 ( V_24 ) ;
