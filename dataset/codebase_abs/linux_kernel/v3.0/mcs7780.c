...
V_2 -> V_67 . V_68 = FALSE ;
V_2 -> V_67 . V_69 = V_70 ;
F_34 ( V_2 -> V_64 , V_2 -> V_7 ,
F_35 ( V_2 -> V_7 , V_2 -> V_71 ) ,
V_2 -> V_72 , 4096 , V_73 , V_2 ) ;
V_2 -> V_64 -> V_74 = 0 ;
return F_36 ( V_2 -> V_64 , V_66 ) ;
}
...
{
struct V_1 * V_2 = F_39 ( V_84 , struct V_1 , V_84 ) ;
...
static int F_42 ( struct V_85 * V_52 , struct V_92 * V_93 , int V_94 )
{
int V_11 = 0 ;
switch ( V_94 ) {
default:
...
static int F_43 ( struct V_85 * V_52 )
{
int V_11 = 0 ;
struct V_1 * V_2 = F_44 ( V_52 ) ;
F_45 ( V_52 ) ;
F_46 ( V_2 -> V_67 . V_45 ) ;
F_47 ( V_2 -> V_64 ) ;
F_48 ( V_2 -> V_64 ) ;
...
F_53 ( & V_2 -> V_104 ) ;
sprintf ( V_97 , L_10 , V_2 -> V_7 -> V_105 ) ;
V_2 -> V_96 = F_54 ( V_52 , & V_2 -> V_106 , V_97 ) ;
if ( ! V_2 -> V_96 ) {
F_13 ( L_11 ) ;
goto V_107;
}
...
V_11 = F_36 ( V_109 , V_114 ) ;
}
static void F_58 ( struct V_109 * V_109 )
{
struct V_1 * V_2 = V_109 -> V_111 ;
...
static T_4 F_60 ( struct V_44 * V_45 ,
struct V_85 * V_115 )
{
unsigned long V_116 ;
struct V_1 * V_2 ;
...
F_45 ( V_115 ) ;
V_2 = F_44 ( V_115 ) ;
F_61 ( & V_2 -> V_117 , V_116 ) ;
V_2 -> V_33 = F_62 ( V_45 ) ;
if ( F_63 ( V_2 -> V_33 == V_2 -> V_32 ) )
V_2 -> V_33 = 0 ;
if( V_2 -> V_32 < 576000 ) {
...
F_34 ( V_2 -> V_65 , V_2 -> V_7 ,
F_52 ( V_2 -> V_7 , V_2 -> V_82 ) ,
V_2 -> V_118 , V_47 , F_58 , V_2 ) ;
if ( ( V_11 = F_36 ( V_2 -> V_65 , V_114 ) ) ) {
F_13 ( L_12 , V_11 ) ;
switch ( V_11 ) {
case - V_119 :
case - V_120 :
...
F_64 ( V_45 ) ;
F_65 ( & V_2 -> V_117 , V_116 ) ;
return V_124 ;
}
static int F_66 ( struct V_125 * V_126 ,
const struct V_127 * V_128 )
{
struct V_5 * V_129 = F_67 ( V_126 ) ;
struct V_85 * V_115 = NULL ;
struct V_1 * V_2 ;
int V_11 = - V_99 ;
V_115 = F_68 ( sizeof( * V_2 ) ) ;
if ( ! V_115 )
goto V_98;
F_69 ( 1 , L_13 , V_129 -> V_105 ) ;
F_70 ( V_115 , & V_126 -> V_6 ) ;
V_11 = F_71 ( V_129 ) ;
if ( V_11 != 0 ) {
F_13 ( L_14 ) ;
goto V_107;
...
F_72 ( & V_2 -> V_117 ) ;
F_73 ( & V_2 -> V_106 ) ;
V_2 -> V_106 . V_130 . V_131 &=
V_132 | V_133 | V_134 | V_135 | V_136 | V_137
| V_138 | V_139 | ( V_140 << 8 ) ;
V_2 -> V_106 . V_141 . V_131 &= V_142 ;
F_74 ( & V_2 -> V_106 ) ;
F_75 ( & V_2 -> V_84 , F_38 ) ;
V_115 -> V_143 = & V_144 ;
if ( ! V_126 -> V_145 )
goto V_107;
V_11 = F_37 ( V_2 , V_126 -> V_145 -> V_146 ,
...
static void F_79 ( struct V_125 * V_126 )
{
struct V_1 * V_2 = F_80 ( V_126 ) ;
if ( ! V_2 )
return;
F_81 ( & V_2 -> V_84 ) ;
F_82 ( V_2 -> V_52 ) ;
