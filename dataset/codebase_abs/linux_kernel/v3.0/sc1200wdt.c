...
V_13 = V_21 ;
F_10 () ;
F_15 (KERN_INFO PFX L_1 , timeout) ;
...
static T_2 F_23 ( struct V_18 * V_18 , const char T_1 * V_2 ,
T_3 V_48 , T_4 * V_49 )
{
if ( V_48 ) {
if ( ! V_50 ) {
...
V_68 = F_27 ( V_66 , 0 ) ;
V_69 = F_28 ( V_66 , 0 ) ;
if ( ! F_29 ( V_68 , V_69 , V_70 ) ) {
F_15 (KERN_ERR PFX L_5 , io) ;
return - V_20 ;
}
F_15 ( V_71 L_6 ,
V_68 , V_69 ) ;
