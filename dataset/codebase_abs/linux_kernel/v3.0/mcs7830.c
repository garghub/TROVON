...
F_58 ( V_109 , V_109 -> V_96 - 1 ) ;
V_22 = V_109 -> V_5 [ V_109 -> V_96 ] ;
if ( V_22 != V_110 ) {
F_14 ( & V_2 -> V_8 -> V_2 , L_12 , V_22 ) ;
V_2 -> V_71 -> V_111 . V_112 ++ ;
if ( V_22 & ( V_113
| V_114
| V_115 ) )
V_2 -> V_71 -> V_111 . V_116 ++ ;
if ( V_22 & V_117 )
V_2 -> V_71 -> V_111 . V_118 ++ ;
if ( V_22 & V_119 )
V_2 -> V_71 -> V_111 . V_120 ++ ;
}
return V_109 -> V_96 > 0 ;
}
static int F_59 ( struct V_97 * V_121 )
{
struct V_1 * V_2 = F_60 ( V_121 ) ;
F_48 ( V_2 ) ;
F_61 ( V_121 ) ;
return 0 ;
}
