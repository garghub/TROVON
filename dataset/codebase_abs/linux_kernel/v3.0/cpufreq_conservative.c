...
static int
F_10 ( struct V_12 * V_13 , unsigned long V_14 ,
void * V_15 )
{
struct V_16 * V_17 = V_15 ;
struct V_18 * V_19 = & F_11 ( V_20 ,
V_17 -> V_1 ) ;
struct V_21 * V_22 ;
if ( ! V_19 -> V_23 )
return 0 ;
...
static T_3 F_12 ( struct V_29 * V_30 ,
struct V_31 * V_32 , char * V_33 )
{
return sprintf ( V_33 , L_1 , V_34 ) ;
}
static T_3 F_13 ( struct V_29 * V_35 ,
struct V_31 * V_36 ,
...
static T_3 F_14 ( struct V_29 * V_35 , struct V_31 * V_36 ,
const char * V_33 , T_4 V_37 )
{
unsigned int V_38 ;
int V_39 ;
...
static T_3 F_19 ( struct V_29 * V_35 , struct V_31 * V_36 ,
const char * V_33 , T_4 V_37 )
{
unsigned int V_38 ;
int V_39 ;
...
{
struct V_18 * V_49 =
F_26 ( V_66 , struct V_18 , V_66 . V_66 ) ;
unsigned int V_1 = V_49 -> V_1 ;
int V_67 = F_27 ( V_42 . V_44 ) ;
V_67 -= V_68 % V_67 ;
F_28 ( & V_49 -> V_69 ) ;
F_20 ( V_49 ) ;
F_29 ( V_1 , & V_49 -> V_66 , V_67 ) ;
F_30 ( & V_49 -> V_69 ) ;
}
static inline void F_31 ( struct V_18 * V_49 )
{
int V_67 = F_27 ( V_42 . V_44 ) ;
V_67 -= V_68 % V_67 ;
V_49 -> V_23 = 1 ;
F_32 ( & V_49 -> V_66 , F_25 ) ;
F_29 ( V_49 -> V_1 , & V_49 -> V_66 , V_67 ) ;
}
static inline void F_33 ( struct V_18 * V_49 )
{
V_49 -> V_23 = 0 ;
F_34 ( & V_49 -> V_66 ) ;
}
