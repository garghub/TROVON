...
F_7 ( V_12 -> V_13 [ V_9 ] ) ) ;
switch ( V_17 ) {
case 1 : V_12 -> V_13 [ V_9 ] = 0 ; break;
case 2 : V_12 -> V_13 [ V_9 ] = 1 ; break;
case 4 : V_12 -> V_13 [ V_9 ] = 2 ; break;
case 8 : V_12 -> V_13 [ V_9 ] = 3 ; break;
default:
F_18 ( & V_16 -> V_5 , L_2
L_3 , V_17 ) ;
F_15 ( & V_12 -> V_18 ) ;
...
static T_2 F_20 ( struct V_4 * V_5 , struct V_6 * V_7 , char * V_8 )
{
struct V_11 * V_12 = F_6 ( V_5 ) ;
...
if ( ( V_38 = F_32 ( & V_16 -> V_5 . V_41 , & V_42 ) ) )
goto V_43;
