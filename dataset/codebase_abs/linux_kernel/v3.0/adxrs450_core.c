...
{
int V_11 , V_48 = 0 ;
struct V_9 * V_10 = F_26 ( sizeof *V_10 , V_49 ) ;
if ( ! V_10 ) {
V_11 = - V_50 ;
goto V_26;
}
F_27 ( V_47 , V_10 ) ;
V_10 -> V_20 = F_26 ( sizeof( * V_10 -> V_20 ) * V_51 , V_49 ) ;
if ( V_10 -> V_20 == NULL ) {
V_11 = - V_50 ;
goto V_52;
}
V_10 -> V_15 = F_26 ( sizeof( * V_10 -> V_15 ) * V_53 , V_49 ) ;
if ( V_10 -> V_15 == NULL ) {
V_11 = - V_50 ;
goto V_54;
}
...
V_10 -> V_8 -> V_2 . V_56 = & V_47 -> V_2 ;
V_10 -> V_8 -> V_57 = & V_58 ;
V_10 -> V_8 -> V_59 = ( void * ) ( V_10 ) ;
V_10 -> V_8 -> V_60 = V_61 ;
V_11 = F_30 ( V_10 -> V_8 ) ;
if ( V_11 )
goto V_62;
