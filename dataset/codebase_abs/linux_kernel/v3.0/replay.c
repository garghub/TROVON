...
int V_7 ;
F_6 ( L_4 , V_21 -> V_10 ,
V_21 -> V_32 , V_21 -> V_33 , V_21 -> V_34 , V_21 -> V_35 , F_19 ( & V_21 -> V_31 ) ) ;
V_2 -> V_36 = V_21 -> V_35 ;
...
return 0 ;
V_7 = F_54 ( V_2 -> V_73 , V_70 -> V_10 , ( char * ) & V_71 ,
V_70 -> V_12 , 4 ) ;
if ( V_7 )
return 0 ;
...
{
int V_74 = F_52 ( V_2 , V_4 -> V_9 ) ;
int V_7 = 0 , V_51 = 0 , V_10 = V_4 -> V_9 -> V_10 , V_32 = V_4 -> V_9 -> V_12 ;
struct V_75 * V_76 ;
struct V_77 * V_78 ;
F_6 ( L_10 ,
V_10 , V_4 -> V_9 -> V_17 , V_32 , V_74 ) ;
if ( V_2 -> V_41 && V_74 )
V_76 = F_56 ( V_2 , V_10 , V_32 , V_2 -> V_79 , V_4 -> V_9 -> V_17 ) ;
else
V_76 = F_57 ( V_2 , V_10 , V_32 , V_2 -> V_79 , 0 ) ;
if ( F_4 ( V_76 ) )
return F_5 ( V_76 ) ;
...
if ( V_78 -> V_35 > V_2 -> V_82 )
V_2 -> V_82 = V_78 -> V_35 ;
switch ( V_78 -> type ) {
case V_83 :
{
struct V_84 * V_27 = V_78 -> V_85 ;
T_2 V_28 = F_50 ( V_27 -> V_86 ) ;
if ( F_48 ( V_27 -> V_87 ) == 0 )
V_34 = 1 ;
V_7 = F_38 ( V_2 , V_10 , V_78 -> V_32 , V_78 -> V_33 ,
& V_78 -> V_31 , V_78 -> V_35 , V_34 ,
& V_51 , 0 , V_28 ) ;
break;
}
case V_88 :
{
struct V_89 * V_90 = V_78 -> V_85 ;
T_2 V_28 = F_48 ( V_90 -> V_86 ) +
F_58 ( V_2 , & V_78 -> V_31 ) *
V_29 ;
V_7 = F_38 ( V_2 , V_10 , V_78 -> V_32 , V_78 -> V_33 ,
& V_78 -> V_31 , V_78 -> V_35 , V_34 ,
...
case V_92 :
{
struct V_57 * V_58 = V_78 -> V_85 ;
V_7 = F_45 ( V_2 , V_58 ) ;
if ( V_7 )
goto V_81;
V_7 = F_43 ( V_2 , V_10 , V_78 -> V_32 , V_78 -> V_33 ,
& V_78 -> V_31 , V_58 -> V_50 ,
F_47 ( V_58 -> V_55 ) , V_78 -> V_35 ,
! F_50 ( V_58 -> V_39 ) , & V_51 ) ;
break;
}
case V_93 :
{
struct V_94 * V_95 = V_78 -> V_85 ;
T_2 V_30 = F_50 ( V_95 -> V_30 ) ;
T_2 V_28 = F_50 ( V_95 -> V_28 ) ;
union V_24 V_31 ;
if ( V_30 < 0 || V_30 > V_2 -> V_96 ||
V_28 < 0 || V_28 > V_2 -> V_96 ||
V_30 <= V_28 ) {
F_51 ( L_12 ) ;
goto V_81;
}
F_59 ( V_2 , & V_31 , F_48 ( V_95 -> V_39 ) ) ;
V_7 = F_38 ( V_2 , V_10 , V_78 -> V_32 , V_78 -> V_33 ,
& V_31 , V_78 -> V_35 , 1 , & V_51 ,
V_30 , V_28 ) ;
break;
}
default:
F_51 ( L_13 ,
V_78 -> type , V_10 , V_78 -> V_32 ) ;
V_7 = - V_65 ;
goto V_81;
}
if ( V_7 )
...
F_31 ( F_60 ( V_2 , V_10 ) ) ;
F_31 ( V_76 -> V_97 - V_32 >= V_51 ) ;
F_31 ( V_76 -> V_97 % V_2 -> V_98 == 0 ) ;
V_4 -> V_8 = V_76 -> V_97 - V_32 - V_51 ;
V_4 -> free = V_2 -> V_13 - V_76 -> V_97 ;
F_6 ( L_14 , V_10 , V_4 -> V_8 , V_4 -> free ) ;
V_11:
F_61 ( V_76 ) ;
return V_7 ;
V_81:
F_51 ( L_15 , V_10 , V_78 -> V_32 ) ;
F_62 ( V_2 , V_78 -> V_85 ) ;
F_61 ( V_76 ) ;
return - V_65 ;
}
...
static int F_68 ( struct V_1 * V_2 , const struct V_100 * V_101 )
{
struct V_67 * V_9 ;
int V_10 = F_48 ( V_101 -> V_10 ) ;
unsigned int V_32 = F_48 ( V_101 -> V_32 ) ;
unsigned int V_17 = F_48 ( V_101 -> V_17 ) ;
if ( V_17 >= V_2 -> V_102 || V_10 >= V_2 -> V_103 ||
V_10 < V_2 -> V_104 || V_32 > V_2 -> V_13 ||
V_32 & ( V_2 -> V_98 - 1 ) )
return - V_65 ;
V_9 = F_60 ( V_2 , V_10 ) ;
if ( V_9 ) {
...
static int F_69 ( struct V_1 * V_2 , int V_10 , int V_32 , void * V_79 )
{
int V_7 ;
struct V_75 * V_76 ;
struct V_77 * V_78 ;
const struct V_105 * V_85 ;
F_6 ( L_18 , V_10 , V_32 ) ;
V_76 = F_57 ( V_2 , V_10 , V_32 , V_79 , V_2 -> V_41 ) ;
if ( F_4 ( V_76 ) ) {
if ( F_5 ( V_76 ) != - V_106 || ! V_2 -> V_41 )
return F_5 ( V_76 ) ;
V_76 = F_70 ( V_2 , V_10 , V_32 , V_79 ) ;
if ( F_4 ( V_76 ) )
return F_5 ( V_76 ) ;
}
if ( V_76 -> V_107 == 0 ) {
...
V_85 = V_76 -> V_108 ;
V_78 = F_30 ( V_76 -> V_109 . V_70 , struct V_77 , V_47 ) ;
if ( V_2 -> V_110 == 0 ) {
if ( V_78 -> type != V_111 ) {
F_71 ( L_19 ,
V_10 , V_32 ) ;
...
if ( F_50 ( V_85 -> V_112 ) != V_2 -> V_112 ) {
F_71 ( L_20
L_21 ,
V_10 , V_32 ,
( unsigned long long ) F_50 ( V_85 -> V_112 ) ,
V_2 -> V_112 ) ;
goto V_81;
}
V_2 -> V_110 = F_50 ( V_85 -> V_59 . V_35 ) ;
F_6 ( L_22 , V_2 -> V_110 ) ;
}
if ( V_78 -> V_35 < V_2 -> V_110 ) {
V_7 = 1 ;
goto V_11;
}
if ( V_78 -> V_32 != 0 ) {
...
switch ( V_78 -> type ) {
case V_113 : {
const struct V_100 * V_101 = V_78 -> V_85 ;
V_7 = F_68 ( V_2 , V_101 ) ;
if ( V_7 == 1 )
break;
if ( V_7 )
goto V_81;
V_7 = F_66 ( V_2 , F_48 ( V_101 -> V_10 ) ,
F_48 ( V_101 -> V_32 ) ,
F_48 ( V_101 -> V_17 ) ,
V_78 -> V_35 ) ;
if ( V_7 )
...
if ( V_76 -> V_97 || V_2 -> V_114 >= V_2 -> V_13 ) {
V_2 -> V_115 = V_10 ;
V_2 -> V_114 = V_76 -> V_97 ;
}
V_7 = ! V_76 -> V_97 ;
...
int V_7 , free ;
F_2 ( V_2 ) ;
V_6 = F_3 ( V_2 , V_2 -> V_116 ) ;
if ( F_4 ( V_6 ) ) {
V_7 = F_5 ( V_6 ) ;
goto V_11;
}
free = V_6 -> free ;
V_6 = F_9 ( V_2 , V_6 , V_117 , V_117 ,
V_6 -> V_14 | V_15 , 0 ) ;
if ( F_4 ( V_6 ) ) {
V_7 = F_5 ( V_6 ) ;
goto V_11;
...
{
int V_7 , V_118 , V_10 , V_32 , free ;
F_74 ( V_40 > 5 ) ;
free = F_72 ( V_2 ) ;
if ( free < 0 )
return free ;
if ( V_2 -> V_119 != V_2 -> V_13 - free ) {
F_51 ( L_27 , V_2 -> V_116 ,
V_2 -> V_119 ) ;
return - V_65 ;
}
F_6 ( L_28 ) ;
V_2 -> V_120 = 1 ;
V_10 = V_2 -> V_121 = V_2 -> V_115 ;
V_32 = V_2 -> V_114 ;
for ( V_118 = 0 ; V_118 < V_2 -> V_122 ; V_118 ++ , V_10 ++ ) {
if ( V_10 >= V_123 + V_2 -> V_122 ) {
V_10 = V_123 ;
V_32 = 0 ;
}
V_7 = F_69 ( V_2 , V_10 , V_32 , V_2 -> V_79 ) ;
if ( V_7 == 1 )
break;
if ( V_7 )
goto V_11;
...
if ( V_7 )
goto V_11;
V_2 -> V_124 . V_125 = F_75 ( & V_2 -> V_126 ) ;
V_2 -> V_124 . V_125 *= V_2 -> V_127 ;
F_31 ( V_2 -> V_128 <= V_2 -> V_129 || V_2 -> V_41 ) ;
F_6 ( L_29
L_30 , V_2 -> V_115 , V_2 -> V_114 , V_2 -> V_82 ,
