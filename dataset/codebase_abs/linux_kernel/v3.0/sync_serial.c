...
static unsigned int F_32 ( struct V_112 * V_112 , T_2 * V_150 )
{
int V_113 = F_16 ( V_112 -> V_151 -> V_152 -> V_114 ) ;
unsigned int V_153 = 0 ;
struct V_44 * V_45 ;
F_33 (static unsigned int prev_mask = 0 ) ;
V_45 = & V_1 [ V_113 ] ;
F_34 ( V_112 , & V_45 -> V_67 , V_150 ) ;
F_34 ( V_112 , & V_45 -> V_68 , V_150 ) ;
if ( V_45 -> V_51 < V_154 )
V_153 |= V_155 | V_156 ;
...
if ( V_160 > 5 )
return - V_167 ;
if ( V_160 == V_168 || V_160 == V_169 )
* V_148 = 1 << V_45 -> V_146 ;
else if ( ! V_45 -> V_22 )
* V_145 = 1 << V_45 -> V_146 ;
F_39 ( V_45 -> V_69 , V_70 , V_73 , V_160 ) ;
break;
case V_170 :
if ( V_160 & V_171 )
F_7 ( V_45 -> V_69 , V_70 ,
...
V_45 = & V_1 [ V_113 ] ;
F_47 ( F_4 ( V_46 L_33 ,
V_45 -> V_48 , V_213 , V_45 -> V_51 , V_154 ) ) ;
F_36 ( V_162 ) ;
if ( V_213 > V_154 - V_45 -> V_51 )
V_213 = V_154 - V_45 -> V_51 ;
...
* V_45 -> V_236 = F_9 ( V_237 , V_159 , V_109 ) ;
F_61 ( F_4 ( V_46 L_40 ,
...
* V_45 -> V_243 = F_9 ( V_237 , V_159 , V_109 ) ;
}
...
V_45 -> V_52 = V_45 -> V_53 ;
if ( V_45 -> V_51 ) {
int V_216 = V_45 -> V_53 + V_154 - V_45 -> V_52 ;
if ( V_216 > V_45 -> V_51 )
V_216 = V_45 -> V_51 ;
F_61 ( F_4 ( V_46
L_42 , V_250 , V_216 ) ) ;
...
V_45 -> V_56 += 2 ;
break;
case F_9 ( V_70 , V_89 , V_187 ) :
* ( unsigned int * ) V_45 -> V_56 = * V_45 -> V_262 ;
V_45 -> V_56 += 3 ;
break;
case F_9 ( V_70 , V_89 , V_189 ) :
* ( unsigned int * ) V_45 -> V_56 = * V_45 -> V_262 ;
V_45 -> V_56 += 4 ;
break;
}
