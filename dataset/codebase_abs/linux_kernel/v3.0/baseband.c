...
bool F_7 ( unsigned long V_41 , unsigned char V_42 , unsigned char * V_43 )
{
unsigned short V_44 ;
unsigned char V_45 ;
F_8 ( V_41 + V_46 , V_42 ) ;
...
bool F_13 ( unsigned long V_41 , unsigned char V_42 , unsigned char V_54 )
{
unsigned short V_44 ;
unsigned char V_45 ;
F_8 ( V_41 + V_46 , V_42 ) ;
...
bool F_15 ( unsigned long V_41 , unsigned char V_42 , unsigned char V_56 )
{
unsigned char V_57 ;
F_7 ( V_41 , V_42 , & V_57 ) ;
return ( V_57 & V_56 ) == 0 ;
...
V_58 &= F_13 ( V_41 , V_65 [ V_59 ] [ 0 ] , V_65 [ V_59 ] [ 1 ] ) ;
}
} else {
for ( V_59 = 0 ; V_59 < V_66 ; V_59 ++ ) {
V_58 &= F_13 ( V_41 , V_67 [ V_59 ] [ 0 ] , V_67 [ V_59 ] [ 1 ] ) ;
}
for ( V_59 = 0 ; V_59 < V_68 ; V_59 ++ ) {
V_58 &= F_13 ( V_41 , V_69 [ V_59 ] [ 0 ] , V_69 [ V_59 ] [ 1 ] ) ;
}
F_17 ( V_41 + V_70 , 0x23 ) ;
F_9 ( V_41 , V_71 , V_72 ) ;
}
...
V_58 &= F_13 ( V_41 , V_78 [ V_59 ] [ 0 ] , V_78 [ V_59 ] [ 1 ] ) ;
}
for ( V_59 = 0 ; V_59 < V_79 ; V_59 ++ ) {
V_58 &= F_13 ( V_41 , V_80 [ V_59 ] [ 0 ] , V_80 [ V_59 ] [ 1 ] ) ;
}
V_1 -> V_73 [ 0 ] = 0x1C ;
V_1 -> V_73 [ 1 ] = 0x10 ;
V_1 -> V_73 [ 2 ] = 0x0 ;
...
V_58 &= F_13 ( V_41 , V_83 [ V_59 ] [ 0 ] , V_83 [ V_59 ] [ 1 ] ) ;
}
for ( V_59 = 0 ; V_59 < V_79 ; V_59 ++ ) {
V_58 &= F_13 ( V_41 , V_80 [ V_59 ] [ 0 ] , V_80 [ V_59 ] [ 1 ] ) ;
}
...
V_58 &= F_13 ( V_41 , 0xd7 , 0x06 ) ;
V_58 &= F_13 ( V_41 , 0x90 , 0x20 ) ;
V_58 &= F_13 ( V_41 , 0x97 , 0xeb ) ;
V_58 &= F_13 ( V_41 , 0xa6 , 0x00 ) ;
V_58 &= F_13 ( V_41 , 0xa8 , 0x30 ) ;
V_58 &= F_13 ( V_41 , 0xb0 , 0x58 ) ;
for ( V_59 = 0 ; V_59 < V_79 ; V_59 ++ ) {
V_58 &= F_13 ( V_41 , V_80 [ V_59 ] [ 0 ] , V_80 [ V_59 ] [ 1 ] ) ;
}
V_1 -> V_73 [ 0 ] = 0x14 ;
...
void F_19 ( unsigned long V_41 , unsigned char * V_88 )
{
int V_59 ;
unsigned char V_89 = 1 ;
for ( V_59 = 0 ; V_59 < V_90 ; V_59 ++ ) {
F_7 ( V_41 , ( unsigned char ) ( V_59 * V_89 ) , V_88 ) ;
V_88 += V_89 ;
}
}
void F_20 ( T_1 V_1 )
...
unsigned char V_54 ;
unsigned long V_41 = V_1 -> V_4 ;
F_7 ( V_41 , 0xC9 , & V_1 -> V_91 ) ;
F_13 ( V_41 , 0xC9 , 0 ) ;
F_7 ( V_41 , 0x4D , & V_1 -> V_92 ) ;
F_13 ( V_41 , 0x4D , 0x90 ) ;
F_7 ( V_41 , 0x88 , & V_1 -> V_93 ) ;
if ( V_1 -> V_94 <= V_32 ) {
F_7 ( V_41 , 0x21 , & V_54 ) ;
F_13 ( V_41 , 0x21 , ( unsigned char ) ( V_54 | 0x01 ) ) ;
F_13 ( V_41 , 0x9A , 0 ) ;
F_13 ( V_41 , 0x88 , 0x02 ) ;
}
else {
F_7 ( V_41 , 0x9A , & V_54 ) ;
F_13 ( V_41 , 0x9A , ( unsigned char ) ( V_54 | 0x01 ) ) ;
F_13 ( V_41 , 0x21 , 0 ) ;
F_13 ( V_41 , 0x88 , 0x03 ) ;
}
F_13 ( V_41 , 0x0E , 0 ) ;
F_7 ( V_1 -> V_4 , 0x09 , & V_1 -> V_95 ) ;
F_13 ( V_1 -> V_4 , 0x09 , ( unsigned char ) ( V_1 -> V_95 & 0xDE ) ) ;
}
void F_21 ( T_1 V_1 )
{
unsigned char V_54 ;
unsigned long V_41 = V_1 -> V_4 ;
F_13 ( V_41 , 0xC9 , V_1 -> V_91 ) ;
F_13 ( V_41 , 0x88 , V_1 -> V_93 ) ;
F_13 ( V_41 , 0x09 , V_1 -> V_95 ) ;
F_13 ( V_41 , 0x4D , V_1 -> V_92 ) ;
if ( V_1 -> V_94 <= V_32 ) {
F_7 ( V_41 , 0x21 , & V_54 ) ;
F_13 ( V_41 , 0x21 , ( unsigned char ) ( V_54 & 0xFE ) ) ;
}
else {
F_7 ( V_41 , 0x9A , & V_54 ) ;
F_13 ( V_41 , 0x9A , ( unsigned char ) ( V_54 & 0xFE ) ) ;
}
F_7 ( V_41 , 0x0E , & V_54 ) ;
F_13 ( V_41 , 0x0E , ( unsigned char ) ( V_54 | 0x80 ) ) ;
}
void
F_22 ( T_1 V_1 )
{
...
F_7 ( V_1 -> V_4 , 0x0A , & V_96 ) ;
if ( V_1 -> V_98 ) {
V_96 &= 0xDF ;
} else {
V_96 |= 0x20 ;
}
F_7 ( V_1 -> V_4 , 0xE7 , & V_97 ) ;
if ( V_97 == V_1 -> V_73 [ 0 ] ) {
V_96 |= 0x20 ;
}
F_13 ( V_1 -> V_4 , 0x0A , V_96 ) ;
}
void F_23 ( T_1 V_1 , unsigned char V_54 )
{
unsigned char V_96 = 0 ;
F_13 ( V_1 -> V_4 , 0xE7 , V_54 ) ;
F_7 ( V_1 -> V_4 , 0x0A , & V_96 ) ;
if ( V_54 == V_1 -> V_73 [ 0 ] ) {
V_96 |= 0x20 ;
} else if ( V_1 -> V_98 ) {
...
void
F_4 ( unsigned long V_41 , unsigned char V_100 )
{
unsigned char V_101 ;
#ifdef F_2
#endif
...
void
F_28 ( unsigned long V_41 , unsigned char V_61 )
{
F_13 ( V_41 , 0x0C , 0x00 ) ;
F_13 ( V_41 , 0x0D , 0x01 ) ;
}
...
void
F_31 ( T_1 V_1 , unsigned char V_121 , unsigned char V_122 )
{
...
V_1 -> V_126 = F_29 ( V_1 ) ;
F_12 ( V_52 , V_53 L_4 , ( int ) V_1 -> V_126 ) ;
if ( V_1 -> V_127 == 0 )
return;
F_12 ( V_52 , V_53 L_5 ,
...
F_32 ( & V_1 -> V_128 ) ;
F_32 ( & V_1 -> V_129 ) ;
V_1 -> V_130 . V_131 = F_33 ( V_1 -> V_127 * V_132 ) ;
F_34 ( & V_1 -> V_130 ) ;
} else {
V_1 -> V_128 . V_131 = F_33 ( V_1 -> V_133 * V_132 ) ;
F_34 ( & V_1 -> V_128 ) ;
}
F_30 ( V_1 ) ;
}
...
F_1 ( V_1 ) ;
V_1 -> V_128 . V_131 = F_33 ( V_1 -> V_133 * V_132 ) ;
V_1 -> V_129 . V_131 = F_33 ( V_1 -> V_136 * V_132 ) ;
F_34 ( & V_1 -> V_128 ) ;
F_34 ( & V_1 -> V_129 ) ;
}
V_1 -> V_124 = 0 ;
...
F_12 ( V_52 , V_53 L_8 ) ;
F_36 ( & V_1 -> V_138 ) ;
F_12 ( V_52 , V_53 L_9 , ( int ) V_1 -> V_126 , ( int ) V_1 -> V_135 , ( int ) V_1 -> V_107 ) ;
#ifdef F_2
#endif
F_1 ( V_1 ) ;
V_1 -> V_124 = 0 ;
