...
V_26 -> V_39 - V_26 -> V_38 + 1 ) ) ;
V_30 = V_41 | V_51 ;
F_3 ( & V_23 -> V_52 , F_18 ( V_28 , V_29 , V_30 ) ) ;
V_24 &= 0xfffc0000 ;
...
F_14 ( L_9 , V_75 -> V_78 ) ;
F_21 ( V_79 ) ;
if ( F_22 ( V_75 , 0 , & V_77 ) != 0 ) {
F_17 ( V_48 L_10 , V_75 -> V_78 ) ;
return - V_80 ;
}
V_76 = F_23 ( V_75 , L_11 , & V_5 ) ;
...
V_8 -> V_86 = & V_87 ;
V_23 = F_25 ( V_77 . V_38 , V_77 . V_39 - V_77 . V_38 + 1 ) ;
if ( ! V_23 )
return - V_83 ;
F_26 ( V_8 , V_75 , 1 ) ;
