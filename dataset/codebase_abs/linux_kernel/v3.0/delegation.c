...
{
struct V_45 * V_49 = F_38 ( V_2 -> V_7 ) -> V_45 ;
F_5 ( V_63 , & V_2 -> V_6 ) ;
F_5 ( V_65 , & V_49 -> V_66 ) ;
}
void F_56 ( struct V_67 * V_68 )
{
struct V_43 * V_44 = F_57 ( V_68 ) ;
struct V_45 * V_49 = V_44 -> V_45 ;
struct V_1 * V_2 ;
if ( V_49 == NULL )
return;
...
const T_2 * V_25 )
{
struct V_45 * V_49 = F_38 ( V_7 ) -> V_45 ;
struct V_1 * V_2 ;
F_7 () ;
V_2 = F_8 ( F_9 ( V_7 ) -> V_2 ) ;
if ( ! V_49 -> V_69 -> V_70 ( V_2 , V_25 ) ) {
F_10 () ;
return - V_71 ;
}
F_55 ( V_2 ) ;
...
int F_77 ( T_2 * V_75 , struct V_7 * V_7 )
{
struct V_26 * V_27 = F_9 ( V_7 ) ;
struct V_1 * V_2 ;
int V_8 = 0 ;
...
V_2 = F_8 ( V_27 -> V_2 ) ;
if ( V_2 != NULL ) {
memcpy ( V_75 -> V_32 , V_2 -> V_25 . V_32 , sizeof( V_75 -> V_32 ) ) ;
V_8 = 1 ;
}
F_10 () ;
return V_8 ;
