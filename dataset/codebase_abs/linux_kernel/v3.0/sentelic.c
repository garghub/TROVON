...
{
unsigned long V_52 , V_30 ;
char * V_53 ;
T_1 V_54 ;
V_52 = F_23 ( V_50 , & V_53 , 16 ) ;
if ( V_53 == V_50 || * V_53 != ' ' || V_52 > 0xff )
return - V_55 ;
if ( F_24 ( V_53 + 1 , 16 , & V_30 ) || V_30 > 0xff )
return - V_55 ;
if ( F_12 ( V_2 , true ) )
return - V_25 ;
...
unsigned long V_52 ;
int V_30 ;
if ( F_24 ( V_50 , 16 , & V_52 ) || V_52 > 0xff )
return - V_55 ;
...
{
unsigned long V_30 ;
if ( F_24 ( V_50 , 16 , & V_30 ) || V_30 > 0xff )
return - V_55 ;
if ( F_14 ( V_2 , V_30 ) )
return - V_25 ;
return V_51 ;
...
static T_1 F_32 ( struct V_2 * V_2 , void * V_49 ,
const char * V_50 , T_2 V_51 )
{
unsigned long V_30 ;
if ( F_24 ( V_50 , 10 , & V_30 ) || V_30 > 1 )
...
static T_1 F_34 ( struct V_2 * V_2 , void * V_49 ,
const char * V_50 , T_2 V_51 )
{
struct V_35 * V_36 = V_2 -> V_37 ;
T_2 V_60 ;
for ( V_60 = 0 ; V_60 < V_51 ; V_60 ++ ) {
switch ( V_50 [ V_60 ] ) {
case 'C' :
V_36 -> V_58 |= V_59 ;
break;
...
void * V_49 , char * V_50 )
{
return sprintf ( V_50 , L_11 , V_61 ) ;
}
static void F_36 ( unsigned char V_62 [] )
{
...
V_65 = F_37 ( V_66 ) ;
F_38 ( V_67 L_12 ,
V_65 , V_62 [ 0 ] , V_62 [ 1 ] , V_62 [ 2 ] , V_62 [ 3 ] ) ;
if ( V_65 - V_64 > 1000 ) {
F_38 ( V_67 L_13 , V_63 ) ;
V_63 = 0 ;
V_64 = V_65 ;
...
static T_3 F_39 ( struct V_2 * V_2 )
{
struct V_68 * V_17 = V_2 -> V_17 ;
struct V_35 * V_69 = V_2 -> V_37 ;
unsigned char * V_62 = V_2 -> V_62 ;
unsigned char V_70 = 0 , V_71 = 0 , V_72 = 0 ;
int V_73 , V_74 ;
if ( V_2 -> V_75 < 4 )
return V_76 ;
switch ( V_2 -> V_62 [ 0 ] >> V_77 ) {
case V_78 :
F_40 ( & V_2 -> V_4 . V_16 -> V_17 ,
L_14 ) ;
break;
case V_79 :
if ( ( V_69 -> V_58 & V_59 ) != V_59 )
V_62 [ 0 ] &= ~ F_41 ( 0 ) ;
case V_80 :
if ( V_62 [ 3 ] != 0 ) {
if ( V_62 [ 3 ] & F_41 ( 0 ) )
...
F_42 ( V_17 , V_81 ,
( int ) ( V_62 [ 3 ] & 8 ) - ( int ) ( V_62 [ 3 ] & 7 ) ) ;
F_42 ( V_17 , V_82 , V_71 - V_72 ) ;
F_43 ( V_17 , V_83 , V_71 ) ;
F_43 ( V_17 , V_84 , V_72 ) ;
F_43 ( V_17 , V_85 , V_62 [ 0 ] & 1 ) ;
F_43 ( V_17 , V_86 , ( V_62 [ 0 ] >> 2 ) & 1 ) ;
F_43 ( V_17 , V_87 , ( V_62 [ 0 ] >> 1 ) & 1 ) ;
V_73 = V_62 [ 1 ] ? ( int ) V_62 [ 1 ] - ( int ) ( ( V_62 [ 0 ] << 4 ) & 0x100 ) : 0 ;
V_74 = V_62 [ 2 ] ? ( int ) ( ( V_62 [ 0 ] << 3 ) & 0x100 ) - ( int ) V_62 [ 2 ] : 0 ;
F_42 ( V_17 , V_88 , V_73 ) ;
F_42 ( V_17 , V_89 , V_74 ) ;
break;
}
...
int F_46 ( struct V_2 * V_2 , bool V_95 )
{
int V_96 ;
...
F_38 ( V_105
L_21 ,
V_104 >> 4 , V_104 & 0x0F , V_26 , V_61 , V_29 & 7 ) ;
V_2 -> V_37 = V_103 = F_53 ( sizeof( struct V_35 ) , V_106 ) ;
if ( ! V_103 )
return - V_107 ;
V_103 -> V_104 = V_104 ;
V_103 -> V_26 = V_26 ;
V_103 -> V_29 = V_29 ;
V_103 -> V_58 |= V_59 ;
F_54 ( V_86 , V_2 -> V_17 -> V_108 ) ;
F_54 ( V_83 , V_2 -> V_17 -> V_108 ) ;
F_54 ( V_84 , V_2 -> V_17 -> V_108 ) ;
F_54 ( V_81 , V_2 -> V_17 -> V_109 ) ;
F_54 ( V_82 , V_2 -> V_17 -> V_109 ) ;
V_2 -> V_110 = F_39 ;
V_2 -> V_111 = F_48 ;
V_2 -> V_112 = F_51 ;
V_2 -> V_113 = F_47 ;
...
if ( error )
goto V_115;
error = F_55 ( & V_2 -> V_4 . V_16 -> V_17 . V_101 ,
& V_102 ) ;
if ( error ) {
F_19 ( & V_2 -> V_4 . V_16 -> V_17 ,
L_22 , error ) ;
