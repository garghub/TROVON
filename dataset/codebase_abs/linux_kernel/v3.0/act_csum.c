...
struct V_4 * V_5 , struct V_102 * V_103 )
{
struct V_14 * V_15 = V_5 -> V_30 ;
int V_28 ;
T_2 V_29 ;
...
struct V_122 V_123 ;
F_50 ( V_33 , V_20 , sizeof( V_116 ) , & V_116 ) ;
V_123 . V_124 = F_51 ( V_106 - V_15 -> V_104 . V_124 ) ;
V_123 . V_105 = F_51 ( V_106 - V_15 -> V_104 . V_105 ) ;
V_123 . V_125 = F_51 ( V_15 -> V_104 . V_125 ) ;
F_50 ( V_33 , V_126 , sizeof( V_123 ) , & V_123 ) ;
return V_33 -> V_66 ;
V_127:
F_52 ( V_33 , V_115 ) ;
return - 1 ;
