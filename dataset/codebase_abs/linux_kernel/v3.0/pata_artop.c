...
const struct V_42 * V_61 [] = { NULL , NULL } ;
int V_36 ;
if ( ! V_41 ++ )
F_19 ( V_62 , & V_7 -> V_9 ,
L_1 V_63 L_2 ) ;
...
unsigned long V_65 = F_21 ( V_7 , 4 ) ;
T_1 V_66 ;
V_61 [ 0 ] = & V_57 ;
if ( F_22 ( V_65 ) & 0x10 )
V_61 [ 0 ] = & V_59 ;
F_7 ( V_7 , 0x49 , & V_66 ) ;
F_11 ( V_7 , 0x49 , V_66 & ~ 0x30 ) ;
F_7 ( V_7 , V_67 , & V_66 ) ;
if ( V_66 <= 0x80 )
F_11 ( V_7 , V_67 , 0x90 ) ;
F_7 ( V_7 , 0x4a , & V_66 ) ;
F_11 ( V_7 , 0x4a , ( V_66 & ~ 0x01 ) | 0x80 ) ;
}
F_23 ( V_61 [ 0 ] == NULL ) ;
return F_24 ( V_7 , V_61 , & V_68 , NULL , 0 ) ;
}
