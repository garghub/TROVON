...
int V_23 ;
T_1 V_40 ;
if ( ( V_30 < V_26 -> V_28 . V_48 . V_49 )
|| ( V_30 > V_26 -> V_28 . V_48 . V_50 ) )
return - V_51 ;
V_33 = ( 27 * V_47 -> V_52 . V_53 . V_54 ) / 32 ;
V_33 /= 1000 ;
V_33 += 3000 ;
if ( V_30 < 950000 )
return - V_51 ;
...
V_55 [ 1 ] [ 0 ] |= 0x01 ;
F_5 ( L_9 , V_15 ) ;
for ( V_23 = 0 ; V_23 < F_18 ( V_55 ) ; V_23 ++ ) {
V_21 = F_6 ( V_2 , V_55 [ V_23 ] , 2 ) ;
if ( V_21 < 0 )
return V_21 ;
}
return 0 ;
...
V_2 = F_21 ( sizeof( struct V_1 ) , V_58 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_7 = V_7 ;
V_2 -> V_13 = V_13 ;
...
V_26 -> V_28 . V_29 ( V_26 , 0 ) ;
V_26 -> V_27 = V_2 ;
memcpy ( & V_26 -> V_28 . V_59 , & V_60 ,
sizeof( struct V_61 ) ) ;
F_3 ( V_62 L_16 ,
V_15 , V_26 -> V_28 . V_59 . V_48 . V_63 , V_7 -> V_8 ) ;
return V_26 ;
error:
F_8 ( V_2 ) ;
return NULL ;
