...
struct V_6 * F_20 ( struct V_1 * V_30 )
{
struct V_6 * V_7 , * V_31 = NULL ;
struct V_8 * V_9 ;
F_21 ( & V_12 ) ;
F_3 (entry, &x25_route_list) {
V_7 = F_4 ( V_9 , struct V_6 , V_13 ) ;
if ( ! memcmp ( & V_7 -> V_2 , V_30 , V_7 -> V_3 ) ) {
if ( ! V_31 )
V_31 = V_7 ;
else if ( V_7 -> V_3 > V_31 -> V_3 )
V_31 = V_7 ;
}
}
if ( V_31 )
...
int F_24 ( unsigned int V_32 , void T_1 * V_33 )
{
struct V_34 V_7 ;
struct V_4 * V_5 ;
int V_10 = - V_11 ;
