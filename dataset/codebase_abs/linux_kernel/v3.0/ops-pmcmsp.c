...
{
T_2 V_6 = 0 ;
if ( F_8 ( V_54 , V_38 , V_39 ,
V_12 , & V_6 ) ) {
* V_53 = 0xFFFFFFFF ;
return - 1 ;
}
* V_53 = ( V_6 >> ( ( V_12 & 3 ) << 3 ) ) & 0x0ff ;
return V_52 ;
}
static int
...
{
if ( V_56 == 1 ) {
if ( F_17 ( V_38 , V_39 , V_12 , V_53 ) ) {
return - 1 ;
}
} else if ( V_56 == 2 ) {
if ( F_18 ( V_38 , V_39 , V_12 , V_53 ) ) {
return - 1 ;
}
} else if ( V_56 == 4 ) {
if ( F_19 ( V_38 , V_39 , V_12 , V_53 ) ) {
return - 1 ;
}
} else {
* V_53 = 0xFFFFFFFF ;
...
if ( F_21 ( V_38 , V_39 ,
V_12 , ( T_5 ) ( 0xFFFF & V_53 ) ) ) {
return - 1 ;
}
} else if ( V_56 == 4 ) {
if ( F_22 ( V_38 , V_39 , V_12 , V_53 ) ) {
return - 1 ;
}
} else {
return - 1 ;
