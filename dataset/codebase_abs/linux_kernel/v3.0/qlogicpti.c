...
V_168 -> V_188 |= V_201 ;
V_168 -> V_202 = 30 ;
memcpy ( V_168 -> V_203 , V_179 -> V_196 , V_179 -> V_187 ) ;
}
static inline int F_44 ( struct V_178 * V_179 , struct V_167 * V_168 ,
struct V_1 * V_2 , T_8 V_204 , T_8 V_205 )
{
struct V_206 * V_207 ;
...
int V_212 ;
V_209 = F_46 ( V_179 ) ;
V_212 = F_47 ( & V_2 -> V_114 -> V_115 , V_209 ,
F_48 ( V_179 ) ,
V_179 -> V_213 ) ;
V_207 = V_168 -> V_206 ;
V_168 -> V_214 = V_212 ;
...
V_211 = 4 ;
F_49 (sg, s, n, i) {
V_207 [ V_37 ] . V_215 = F_50 ( V_210 ) ;
V_207 [ V_37 ] . V_216 = F_51 ( V_210 ) ;
}
V_212 -= 4 ;
V_209 = V_210 ;
while ( V_212 > 0 ) {
struct V_217 * V_218 ;
++ V_168 -> V_171 . V_172 ;
V_218 = (struct V_217 * ) & V_2 -> V_165 [ V_204 ] ;
V_204 = F_52 ( V_204 ) ;
if ( V_204 == V_205 )
return - 1 ;
V_218 -> V_171 . V_173 = V_219 ;
V_218 -> V_171 . V_172 = 0 ;
V_218 -> V_171 . V_220 = 0 ;
V_218 -> V_171 . V_64 = 0 ;
V_218 -> V_221 = 0 ;
...
V_168 -> V_206 [ 0 ] . V_215 = 0 ;
V_168 -> V_206 [ 0 ] . V_216 = 0 ;
V_168 -> V_214 = 1 ;
}
V_168 -> V_222 = V_204 ;
V_2 -> V_223 [ V_204 ] = V_179 ;
V_2 -> V_190 [ V_179 -> V_182 -> V_183 ] ++ ;
F_2 ( V_204 , V_2 -> V_5 + V_30 ) ;
V_2 -> V_89 = V_204 ;
return V_204 ;
}
static inline void F_53 ( struct V_60 * V_61 , T_8 V_204 , T_8 V_205 )
{
int V_224 = V_95 - F_54 ( V_204 , V_205 ) - 64 ;
V_61 -> V_225 = V_61 -> V_226 + V_224 ;
V_61 -> V_227 = F_55 ( V_224 ) ;
}
static int F_56 ( struct V_228 * V_229 )
{
struct V_1 * V_2 = F_57 ( V_229 -> V_61 ) ;
int V_230 = V_229 -> V_183 ;
T_3 V_17 [ 6 ] ;
if ( V_229 -> V_231 ) {
V_2 -> V_53 [ V_230 ] . V_54 |= 0x10 ;
} else {
V_2 -> V_53 [ V_230 ] . V_58 = 0 ;
V_2 -> V_53 [ V_230 ] . V_57 = 0 ;
}
if ( V_229 -> V_232 )
V_2 -> V_53 [ V_230 ] . V_54 |= 0x20 ;
V_17 [ 0 ] = V_102 ;
V_17 [ 1 ] = ( V_230 << 8 ) ;
V_17 [ 2 ] = ( V_2 -> V_53 [ V_230 ] . V_54 << 8 ) ;
if ( V_2 -> V_53 [ V_230 ] . V_54 & 0x10 ) {
V_17 [ 3 ] = ( V_2 -> V_53 [ V_230 ] . V_58 << 8 ) |
V_2 -> V_53 [ V_230 ] . V_57 ;
} else {
V_17 [ 3 ] = 0 ;
}
...
V_179 -> V_233 = F_59 ;
V_204 = V_2 -> V_89 ;
V_168 = (struct V_167 * ) & V_2 -> V_165 [ V_204 ] ;
V_205 = F_6 ( V_2 -> V_5 + V_30 ) ;
V_204 = F_52 ( V_204 ) ;
if ( V_204 == V_205 )
goto V_234;
if ( V_2 -> V_104 ) {
...
if ( ( V_204 = F_44 ( V_179 , V_168 , V_2 , V_204 , V_205 ) ) == - 1 )
goto V_234;
F_53 ( V_61 , V_204 , V_205 ) ;
return 0 ;
V_234:
F_9 ( V_27 L_41 ,
V_2 -> V_28 ) ;
...
{
struct V_178 * V_179 , * V_237 = NULL ;
struct V_238 * V_239 ;
T_8 V_204 , V_205 ;
if ( ! ( F_6 ( V_2 -> V_5 + V_240 ) & V_241 ) )
return NULL ;
V_204 = F_6 ( V_2 -> V_5 + V_29 ) ;
...
while ( V_205 != V_204 ) {
T_8 V_248 ;
V_239 = (struct V_238 * ) & V_2 -> V_163 [ V_205 ] ;
V_205 = F_61 ( V_205 ) ;
V_248 = V_239 -> V_222 ;
V_179 = V_2 -> V_223 [ V_248 ] ;
V_2 -> V_223 [ V_248 ] = NULL ;
if ( V_239 -> V_249 == V_250 ||
V_239 -> V_249 == V_251 ||
( V_239 -> V_252 & V_253 ) )
V_2 -> V_104 = 1 ;
if ( V_239 -> V_254 & V_255 )
memcpy ( V_179 -> V_256 , V_239 -> V_257 ,
V_258 ) ;
if ( V_239 -> V_171 . V_173 == V_259 )
V_179 -> V_235 =
F_62 ( V_239 , V_2 -> V_28 ) ;
else
V_179 -> V_235 = V_260 << 16 ;
if ( F_45 ( V_179 ) )
F_63 ( & V_2 -> V_114 -> V_115 ,
F_46 ( V_179 ) , F_48 ( V_179 ) ,
V_179 -> V_213 ) ;
V_2 -> V_190 [ V_179 -> V_182 -> V_183 ] -- ;
F_2 ( V_205 , V_2 -> V_5 + V_29 ) ;
V_179 -> V_261 = ( unsigned char * ) V_237 ;
V_237 = V_179 ;
}
V_2 -> V_90 = V_205 ;
return V_237 ;
}
static T_9 V_151 ( int V_148 , void * V_262 )
{
...
do {
struct V_178 * V_145 ;
V_145 = (struct V_178 * ) V_263 -> V_261 ;
V_263 -> V_233 ( V_263 ) ;
V_263 = V_145 ;
} while ( V_263 != NULL );
}
...
static int V_275 ;
const char * V_276 ;
V_272 = F_67 ( V_277 , & V_114 -> V_115 ) ;
if ( ! V_272 )
return - V_118 ;
V_274 = V_272 -> V_120 ;
if ( V_114 -> V_149 . V_150 [ 0 ] == 0 )
return - V_278 ;
V_61 = F_68 ( V_274 , sizeof( struct V_1 ) ) ;
if ( ! V_61 )
return - V_279 ;
V_2 = F_57 ( V_61 ) ;
V_61 -> V_280 = V_52 ;
...
V_2 -> V_114 = V_114 ;
V_2 -> V_28 = V_275 ;
strcpy ( V_2 -> V_281 , V_114 -> V_115 . V_156 -> V_282 ) ;
V_2 -> V_135 = strcmp ( V_2 -> V_281 , L_46 ) ;
if ( F_26 ( V_2 ) < 0 )
goto V_283;
if ( F_29 ( V_2 ) < 0 )
goto V_284;
...
F_33 ( V_2 ) ;
F_34 ( V_2 ) ;
memset ( V_2 -> V_223 , 0 , sizeof( V_2 -> V_223 ) ) ;
if ( F_36 ( V_2 ) < 0 )
goto V_285;
if ( F_15 ( V_2 ) )
goto V_286;
