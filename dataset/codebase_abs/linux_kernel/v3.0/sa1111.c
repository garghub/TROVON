...
static void F_38 ( struct V_78 * V_79 )
{
struct V_80 * V_74 = F_39 ( V_79 ) ;
F_40 ( & V_74 -> V_81 ) ;
F_41 ( V_74 ) ;
}
static int
F_42 ( struct V_7 * V_8 , struct V_82 * V_83 ,
struct V_84 * V_85 )
{
struct V_80 * V_74 ;
int V_86 ;
V_74 = F_43 ( sizeof( struct V_80 ) , V_87 ) ;
if ( ! V_74 ) {
V_86 = - V_88 ;
goto V_89;
}
F_44 ( & V_74 -> V_74 , L_4 , V_85 -> V_90 ) ;
V_74 -> V_91 = V_85 -> V_91 ;
V_74 -> V_74 . V_83 = V_8 -> V_74 ;
V_74 -> V_74 . V_92 = & V_93 ;
V_74 -> V_74 . V_94 = F_38 ;
V_74 -> V_74 . V_77 = V_8 -> V_74 -> V_77 ;
V_74 -> V_81 . V_95 = V_8 -> V_43 + V_85 -> V_90 ;
V_74 -> V_81 . V_96 = V_74 -> V_81 . V_95 + 511 ;
V_74 -> V_81 . V_97 = F_45 ( & V_74 -> V_74 ) ;
V_74 -> V_81 . V_26 = V_98 ;
V_74 -> V_9 = V_8 -> V_10 + V_85 -> V_90 ;
V_74 -> V_99 = V_85 -> V_99 ;
memmove ( V_74 -> V_1 , V_85 -> V_1 , sizeof( V_74 -> V_1 ) ) ;
V_86 = F_46 ( V_83 , & V_74 -> V_81 ) ;
if ( V_86 ) {
F_14 ( L_5 ,
V_74 -> V_81 . V_97 ) ;
F_44 ( & V_74 -> V_74 , NULL ) ;
...
static int T_2
F_52 ( struct V_78 * V_100 , struct V_82 * V_101 , int V_1 )
{
struct V_7 * V_8 ;
unsigned long V_102 ;
unsigned int V_103 ;
int V_6 , V_86 = - V_104 ;
V_8 = F_43 ( sizeof( struct V_7 ) , V_87 ) ;
if ( ! V_8 )
return - V_88 ;
V_8 -> V_57 = F_53 ( V_100 , L_8 ) ;
if ( F_54 ( V_8 -> V_57 ) ) {
V_86 = F_55 ( V_8 -> V_57 ) ;
goto V_105;
}
...
V_8 -> V_43 = V_101 -> V_95 ;
V_8 -> V_1 = V_1 ;
V_8 -> V_10 = F_58 ( V_101 -> V_95 , V_106 * 2 ) ;
if ( ! V_8 -> V_10 ) {
V_86 = - V_88 ;
goto V_107;
}
V_102 = F_3 ( V_8 -> V_10 + V_108 ) ;
if ( ( V_102 & V_109 ) != V_110 ) {
F_14 ( V_111 L_9 , V_102 ) ;
V_86 = - V_104 ;
goto V_112;
}
F_14 ( V_113 L_10
L_11 ,
( V_102 & V_114 ) >> 4 , ( V_102 & V_115 ) ) ;
F_31 ( V_8 ) ;
#ifdef F_59
{
unsigned int V_116 ;
...
F_60 ( V_117 , V_118 ) ,
F_60 ( V_117 , V_119 ) ) ;
V_116 = F_3 ( V_8 -> V_10 + V_64 ) ;
F_4 ( V_116 | V_120 , V_8 -> V_10 + V_64 ) ;
F_61 () ;
}
#endif
if ( V_8 -> V_1 != V_121 )
...
V_103 &= ~ ( 1 << 1 ) ;
for ( V_6 = 0 ; V_6 < F_65 ( V_123 ) ; V_6 ++ )
if ( V_103 & ( 1 << V_6 ) )
F_42 ( V_8 , V_101 , & V_123 [ V_6 ] ) ;
return 0 ;
V_112:
F_66 ( V_8 -> V_10 ) ;
V_107:
...
static int F_68 ( struct V_78 * V_74 , void * V_124 )
{
F_51 ( V_74 ) ;
return 0 ;
}
...
F_30 ( V_8 -> V_1 , NULL ) ;
F_29 ( V_8 -> V_1 , NULL ) ;
F_72 ( V_8 -> V_43 + V_11 , 512 ) ;
}
F_66 ( V_8 -> V_10 ) ;
F_67 ( V_8 -> V_57 ) ;
F_41 ( V_8 ) ;
}
int F_73 ( struct V_78 * V_74 , T_3 V_125 , T_4 V_126 )
{
return ( ( F_62 () || F_74 () ) &&
( V_125 >= 0xc8000000 || ( V_125 + V_126 ) >= 0xc8000000 ) ) ;
}
...
unsigned int V_116 ;
void T_1 * V_10 ;
V_130 = F_77 ( sizeof( struct V_129 ) , V_87 ) ;
if ( ! V_130 )
return - V_88 ;
V_8 -> V_131 = V_130 ;
F_32 ( & V_8 -> V_56 , V_26 ) ;
...
V_116 = F_3 ( V_8 -> V_10 + V_58 ) ;
F_4 ( V_116 | V_150 , V_8 -> V_10 + V_58 ) ;
...
static int T_2 F_80 ( struct V_127 * V_151 )
{
struct V_82 * V_101 ;
int V_1 ;
V_101 = F_81 ( V_151 , V_98 , 0 ) ;
if ( ! V_101 )
return - V_30 ;
V_1 = F_82 ( V_151 , 0 ) ;
if ( V_1 < 0 )
return - V_152 ;
return F_52 ( & V_151 -> V_74 , V_101 , V_1 ) ;
}
...
static inline struct V_7 * F_85 ( struct V_80 * V_153 )
{
return (struct V_7 * ) F_86 ( V_153 -> V_74 . V_83 ) ;
}
...
unsigned int F_88 ( struct V_80 * V_153 )
{
struct V_7 * V_8 = F_85 ( V_153 ) ;
return F_87 ( V_8 ) ;
}
void F_89 ( struct V_80 * V_153 , int V_158 )
{
struct V_7 * V_8 = F_85 ( V_153 ) ;
unsigned long V_26 ;
unsigned int V_116 ;
...
F_4 ( V_116 , V_8 -> V_10 + V_58 ) ;
F_35 ( & V_8 -> V_56 , V_26 ) ;
}
int F_90 ( struct V_80 * V_153 , int V_161 )
{
struct V_7 * V_8 = F_85 ( V_153 ) ;
unsigned int div ;
if ( V_153 -> V_91 != V_162 )
...
void F_94 ( struct V_80 * V_153 , unsigned int V_163 , unsigned int V_174 )
{
struct V_7 * V_8 = F_85 ( V_153 ) ;
unsigned long V_26 ;
unsigned int V_116 ;
...
void F_95 ( struct V_80 * V_153 , unsigned int V_163 , unsigned int V_174 )
{
struct V_7 * V_8 = F_85 ( V_153 ) ;
unsigned long V_26 ;
unsigned int V_116 ;
...
F_32 ( & V_8 -> V_56 , V_26 ) ;
V_116 = F_3 ( V_8 -> V_10 + V_64 ) ;
F_4 ( V_116 | V_153 -> V_99 , V_8 -> V_10 + V_64 ) ;
F_35 ( & V_8 -> V_56 , V_26 ) ;
}
void F_97 ( struct V_80 * V_153 )
{
struct V_7 * V_8 = F_85 ( V_153 ) ;
unsigned long V_26 ;
unsigned int V_116 ;
...
static int F_98 ( struct V_78 * V_79 , struct V_181 * V_182 )
{
struct V_80 * V_74 = F_39 ( V_79 ) ;
struct V_183 * V_184 = F_99 ( V_182 ) ;
return V_74 -> V_91 == V_184 -> V_91 ;
}
static int F_100 ( struct V_78 * V_74 , T_5 V_128 )
{
struct V_80 * V_153 = F_39 ( V_74 ) ;
struct V_183 * V_184 = F_99 ( V_74 -> V_185 ) ;
int V_86 = 0 ;
if ( V_184 && V_184 -> V_186 )
V_86 = V_184 -> V_186 ( V_153 , V_128 ) ;
return V_86 ;
}
...
int V_86 = 0 ;
if ( V_184 -> remove )
V_86 = V_184 -> remove ( V_153 ) ;
return V_86 ;
}
int F_104 ( struct V_183 * V_185 )
{
V_185 -> V_184 . V_92 = & V_93 ;
