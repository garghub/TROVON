...
V_45 = V_92 -> V_93 [ 0 ] ;
F_37 ( L_9 , V_4 -> V_94 ) ;
V_90 = F_38 ( V_4 , sizeof( struct V_95 ) ) ;
if ( V_90 < 0 )
return V_90 ;
V_4 -> V_96 = V_26 -> V_97 ;
F_37 ( L_10 ,
V_45 , V_45 + V_98 ,
V_45 + V_99 , V_45 + V_99 + V_100 ) ;
if ( ! F_39 ( V_45 , V_98 , V_1 . V_101 ) ) {
F_37 ( L_11 ) ;
return - V_102 ;
}
if ( ! F_39 ( V_45 + V_99 , V_100 ,
V_1 . V_101 ) ) {
F_40 ( V_45 , V_98 ) ;
F_37 ( L_11 ) ;
return - V_102 ;
...
V_6 = V_4 -> V_104 + 2 ;
V_6 -> type = V_123 ;
V_6 -> V_106 = V_124 | V_107 ;
V_6 -> V_109 = 4 ;
V_6 -> V_112 = 1 ;
V_6 -> V_113 = & V_121 ;
V_6 -> V_122 = F_23 ;
V_6 = V_4 -> V_104 + 3 ;
F_43 ( V_4 , V_6 , NULL , V_4 -> V_45 + V_99 ) ;
F_11 ( V_125 , V_4 -> V_45 + V_126 ) ;
F_11 ( V_32 -> V_67 , V_4 -> V_45 + V_65 ) ;
if ( V_4 -> V_41 )
...
F_37 ( L_17 , V_4 -> V_94 ) ;
if ( V_4 -> V_104 )
F_45 ( V_4 , V_4 -> V_104 + 3 ) ;
if ( V_4 -> V_41 )
F_46 ( V_4 -> V_41 , V_4 ) ;
if ( V_4 -> V_45 ) {
F_40 ( V_4 -> V_45 , V_98 ) ;
F_40 ( V_4 -> V_45 + V_99 , V_100 ) ;
}
return 0 ;
}
