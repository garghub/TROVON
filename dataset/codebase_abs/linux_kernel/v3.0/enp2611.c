...
struct V_3 * V_4 )
{
return F_19 ( V_4 -> V_15 , & V_16 , V_4 ) ;
}
static int T_1 F_20 ( struct V_17 * V_18 , T_3 V_19 , T_3 V_20 )
{
int V_21 ;
if ( V_18 -> V_8 -> V_10 == 0 && F_21 ( V_18 -> V_9 ) == 0 ) {
V_21 = V_22 ;
} else if ( V_18 -> V_8 -> V_10 == 0 && F_21 ( V_18 -> V_9 ) == 1 ) {
V_21 = V_23 ;
} else if ( V_18 -> V_8 -> V_10 == 0 && F_21 ( V_18 -> V_9 ) == 4 ) {
V_21 = - 1 ;
} else if ( V_18 -> V_8 -> V_10 == 1 && F_21 ( V_18 -> V_9 ) == 0 ) {
V_21 = V_22 ;
} else if ( V_18 -> V_8 -> V_10 == 1 && F_21 ( V_18 -> V_9 ) == 1 ) {
V_21 = V_23 ;
} else {
F_22 ( V_24 L_2
L_3 , V_18 -> V_8 -> V_10 ,
F_21 ( V_18 -> V_9 ) , F_23 ( V_18 -> V_9 ) ) ;
V_21 = - 1 ;
}
return V_21 ;
}
