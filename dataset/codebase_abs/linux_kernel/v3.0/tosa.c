...
static void F_26 ( char V_10 , const char * V_37 )
{
T_2 V_38 = F_27 ( V_39 ) ;
if( ( V_38 & 0xffff0000 ) == 0x7ff00000 )
F_28 ( ( V_38 & 0xffff ) | 0x7ee00000 , V_39 ) ;
F_24 () ;
}
...
F_42 ( 2 , & V_56 ) ;
F_43 ( V_57 , F_44 ( V_57 ) ) ;
F_45 ( L_10 , V_58 . V_59 , L_11 , NULL ) ;
F_46 ( V_60 , F_44 ( V_60 ) ) ;
}
static void T_3 F_47 ( struct V_61 * V_62 ,
struct V_63 * V_64 , char * * V_65 , struct V_66 * V_67 )
{
F_48 () ;
V_67 -> V_68 = 1 ;
V_67 -> V_69 [ 0 ] . V_70 = 0xa0000000 ;
V_67 -> V_69 [ 0 ] . V_71 = ( 64 * 1024 * 1024 ) ;
}
