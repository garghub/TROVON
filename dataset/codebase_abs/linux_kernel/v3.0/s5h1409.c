...
static int F_10 ( struct V_20 * V_21 , int V_38 )
{
struct V_1 * V_2 = V_21 -> V_22 ;
F_6 ( L_6 , V_16 , V_38 ) ;
if ( V_38 )
...
static int F_11 ( struct V_20 * V_21 , int V_38 )
{
struct V_1 * V_2 = V_21 -> V_22 ;
F_6 ( L_6 , V_16 , V_38 ) ;
if ( V_38 )
...
static int F_12 ( struct V_20 * V_21 , int V_38 )
{
struct V_1 * V_2 = V_21 -> V_22 ;
F_6 ( L_6 , V_16 , V_38 ) ;
return F_1 ( V_2 , 0xf2 , V_38 ) ;
}
...
{
struct V_1 * V_2 = V_21 -> V_22 ;
F_6 ( L_16 , V_16 , V_47 -> V_48 ) ;
F_5 ( V_21 ) ;
V_2 -> V_49 = V_47 -> V_48 ;
F_9 ( V_21 , V_47 -> V_50 . V_51 . V_52 ) ;
if ( V_21 -> V_53 . V_54 . V_55 ) {
if ( V_21 -> V_53 . V_56 )
V_21 -> V_53 . V_56 ( V_21 , 1 ) ;
V_21 -> V_53 . V_54 . V_55 ( V_21 , V_47 ) ;
if ( V_21 -> V_53 . V_56 )
...
static int F_22 ( struct V_20 * V_21 , T_4 * V_72 )
{
struct V_1 * V_2 = V_21 -> V_22 ;
T_2 V_3 ;
T_5 V_73 = 0 ;
...
if ( V_3 & 0x8000 )
* V_72 |= V_75 | V_76 ;
switch ( V_2 -> V_10 -> V_77 ) {
case V_78 :
if ( * V_72 & V_74 )
* V_72 |= V_79 | V_80 ;
break;
case V_81 :
if ( V_21 -> V_53 . V_54 . V_82 ) {
if ( V_21 -> V_53 . V_56 )
V_21 -> V_53 . V_56 ( V_21 , 1 ) ;
V_21 -> V_53 . V_54 . V_82 ( V_21 , & V_73 ) ;
if ( V_21 -> V_53 . V_56 )
V_21 -> V_53 . V_56 ( V_21 , 0 ) ;
}
if ( V_73 )
...
static int F_23 ( struct V_20 * V_21 , T_2 * V_83 , T_2 V_84 )
{
int V_65 , V_5 = - V_36 ;
F_6 ( L_4 , V_16 ) ;
for ( V_65 = 0 ; V_65 < F_21 ( V_85 ) ; V_65 ++ ) {
if ( V_84 < V_85 [ V_65 ] . V_60 ) {
* V_83 = V_85 [ V_65 ] . V_4 ;
V_5 = 0 ;
break;
}
...
static int F_24 ( struct V_20 * V_21 , T_2 * V_83 , T_2 V_84 )
{
int V_65 , V_5 = - V_36 ;
F_6 ( L_4 , V_16 ) ;
for ( V_65 = 0 ; V_65 < F_21 ( V_86 ) ; V_65 ++ ) {
if ( V_84 < V_86 [ V_65 ] . V_60 ) {
* V_83 = V_86 [ V_65 ] . V_4 ;
V_5 = 0 ;
break;
}
...
static int F_25 ( struct V_20 * V_21 , T_2 * V_83 , T_2 V_84 )
{
int V_65 , V_5 = - V_36 ;
F_6 ( L_4 , V_16 ) ;
for ( V_65 = 0 ; V_65 < F_21 ( V_87 ) ; V_65 ++ ) {
if ( V_84 > V_87 [ V_65 ] . V_60 ) {
* V_83 = V_87 [ V_65 ] . V_4 ;
V_5 = 0 ;
break;
}
...
static int F_26 ( struct V_20 * V_21 , T_2 * V_83 )
{
struct V_1 * V_2 = V_21 -> V_22 ;
T_2 V_3 ;
F_6 ( L_4 , V_16 ) ;
...
return F_24 ( V_21 , V_83 , V_3 ) ;
case V_33 :
V_3 = F_4 ( V_2 , 0xf0 ) & 0xff ;
return F_23 ( V_21 , V_83 , V_3 ) ;
case V_30 :
V_3 = F_4 ( V_2 , 0xf1 ) & 0x3ff ;
return F_25 ( V_21 , V_83 , V_3 ) ;
default:
break;
}
return - V_36 ;
...
T_2 * V_88 )
{
return F_26 ( V_21 , V_88 ) ;
}
static int F_28 ( struct V_20 * V_21 , T_5 * V_89 )
{
struct V_1 * V_2 = V_21 -> V_22 ;
* V_89 = F_4 ( V_2 , 0xb5 ) ;
return 0 ;
}
static int F_29 ( struct V_20 * V_21 , T_5 * V_90 )
{
return F_28 ( V_21 , V_90 ) ;
}
...
struct V_20 * F_34 ( const struct V_94 * V_10 ,
struct V_95 * V_14 )
{
struct V_1 * V_2 = NULL ;
T_2 V_3 ;
V_2 = F_35 ( sizeof( struct V_1 ) , V_96 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_14 = V_14 ;
