...
static int F_149 ( struct V_1 * V_1 , int V_21 )
{
int V_24 ;
...
F_111 ( V_78 ) ;
V_24 = F_150 ( V_78 , & V_142 ) ;
F_114 ( V_78 ) ;
if ( ! V_24 ) {
F_18 ( L_38 , V_20 ) ;
return - V_88 ;
}
V_24 = F_151 ( & V_142 , F_143 , NULL , V_143 ,
V_144 , V_145 ) ;
if ( V_24 ) {
F_18 ( L_39 ,
V_20 , V_24 , V_1 -> V_21 ) ;
...
static int F_154 ( struct V_1 * V_1 , int V_21 )
{
int V_24 ;
unsigned long V_20 = F_30 ( V_1 ) ;
F_107 ( V_1 ) ;
