...
{
struct V_67 * V_68 = V_2 -> V_14 . V_69 ;
struct V_27 * V_28 = F_9 ( & V_2 -> V_14 ) ;
struct V_24 * V_48 ;
int V_70 ;
V_70 = F_39 ( V_68 , L_5 , 0 ) ;
if ( ! F_23 ( V_70 ) ) {
F_40 ( & V_2 -> V_14 , L_6 ) ;
return V_70 ;
}
...
V_28 = F_47 ( & V_2 -> V_14 , sizeof( * V_28 ) , V_73 ) ;
if ( V_28 == NULL )
return - V_74 ;
F_48 ( & V_2 -> V_14 , V_28 ) ;
V_28 -> V_2 = V_2 ;
...
return V_10 ;
V_28 -> V_38 = V_75 ;
memcpy ( V_28 -> gamma , V_76 , sizeof( V_28 -> gamma ) ) ;
