...
static struct V_27 * F_27 ( struct V_28 * V_15 )
{
struct V_27 * V_29 , * V_30 ;
V_30 = F_28 ( V_15 -> V_31 , V_32 , 0 ) ;
if ( ! V_30 )
return NULL ;
V_29 = F_29 ( V_30 ) ;
F_30 ( V_30 ) ;
...
int V_20 ;
F_30 ( V_29 ) ;
V_12 = F_33 ( V_15 , sizeof( * V_9 -> V_12 ) , V_36 ) ;
if ( ! V_12 )
return - V_37 ;
V_20 = F_34 ( V_33 , V_12 , 0 ) ;
if ( V_20 < 0 ) {
F_35 ( V_15 , V_12 ) ;
return V_20 ;
}
...
int F_36 ( struct V_39 * V_15 , struct V_2 * V_4 )
{
int V_20 ;
V_20 = F_37 ( V_15 , V_40 ) ;
if ( V_20 < 0 )
...
struct V_2 * F_42 ( struct V_28 * V_15 )
{
struct V_1 * V_9 ;
int V_20 ;
V_9 = F_33 ( V_15 , sizeof( * V_9 ) , V_36 ) ;
if ( ! V_9 )
return F_43 ( - V_37 ) ;
V_9 -> V_15 = V_15 ;
V_20 = F_31 ( V_9 ) ;
...
if ( V_9 -> V_34 ) {
V_9 -> V_10 = F_44 ( V_9 -> V_34 ) ;
if ( ! V_9 -> V_10 )
return F_43 ( - V_45 ) ;
}
return & V_9 -> V_4 ;
}
int F_45 ( struct V_2 * V_4 )
{
struct V_1 * V_9 = F_1 ( V_4 ) ;
F_24 ( & V_9 -> V_4 ) ;
if ( V_9 -> V_10 )
