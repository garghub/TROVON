...
static int F_210 ( struct V_3 * V_4 , struct V_315 * V_316 )
{
struct V_84 * V_84 = F_173 ( V_4 -> V_214 ) ;
int V_205 , V_308 , V_317 = 0 ;
int V_318 = V_316 -> args [ 0 ] ;
int V_319 = V_316 -> args [ 1 ] ;
struct V_10 * V_11 ;
V_205 = ( (struct V_320 * ) F_176 ( V_316 -> V_213 ) ) -> V_321 ;
for ( V_308 = 0 ; V_308 < V_310 ; V_308 ++ ) {
struct V_110 * V_120 ;
V_11 = V_204 [ V_308 ] ;
if ( ! V_11 )
continue;
if ( V_308 < V_318 || ( V_205 && V_11 -> V_205 != V_205 ) )
continue;
if ( F_192 ( V_4 , V_11 , F_211 ( V_316 -> V_4 ) . V_322 ,
V_316 -> V_213 -> V_323 , V_324 ,
V_325 ) < 0 )
break;
V_317 = 0 ;
V_120 = F_212 ( & V_11 -> V_6 , V_33 ) ;
F_213 (p, &tbl->parms_list, list) {
if ( ! F_67 ( F_146 ( V_120 ) , V_84 ) )
continue;
if ( V_317 < V_319 )
goto V_25;
if ( F_203 ( V_4 , V_11 , V_120 ,
F_211 ( V_316 -> V_4 ) . V_322 ,
V_316 -> V_213 -> V_323 ,
V_324 ,
V_325 ) < 0 )
goto V_62;
...
static int F_214 ( struct V_3 * V_4 , struct V_1 * V_2 ,
...
if ( V_2 -> V_23 & V_39 ) {
char V_331 [ V_332 ] ;
F_215 ( V_331 , V_2 , V_2 -> V_34 ) ;
if ( F_196 ( V_4 , V_228 , V_2 -> V_34 -> V_166 , V_331 ) < 0 ) {
F_79 ( & V_2 -> V_17 ) ;
goto V_260;
}
}
V_327 . V_333 = F_216 ( V_44 - V_2 -> V_57 ) ;
V_327 . V_334 = F_216 ( V_44 - V_2 -> V_96 ) ;
V_327 . V_335 = F_216 ( V_44 - V_2 -> V_56 ) ;
V_327 . V_336 = F_14 ( & V_2 -> V_22 ) - 1 ;
F_79 ( & V_2 -> V_17 ) ;
if ( F_187 ( V_4 , V_337 , F_14 ( & V_2 -> V_136 ) ) ||
F_196 ( V_4 , V_338 , sizeof( V_327 ) , & V_327 ) )
goto V_260;
F_201 ( V_4 , V_213 ) ;
return 0 ;
V_260:
...
static int F_217 ( struct V_3 * V_4 , struct V_101 * V_229 ,
T_2 V_262 , T_2 V_179 , int type , unsigned int V_160 ,
struct V_10 * V_11 )
{
struct V_212 * V_213 ;
...
static bool F_219 ( struct V_35 * V_34 , int V_342 )
{
struct V_35 * V_343 ;
if ( ! V_342 )
return false ;
V_343 = F_220 ( V_34 ) ;
if ( ! V_343 || V_343 -> V_190 != V_342 )
return true ;
return false ;
}
static bool F_221 ( struct V_35 * V_34 , int V_344 )
{
if ( V_344 && V_34 -> V_190 != V_344 )
return true ;
return false ;
}
...
{
struct V_84 * V_84 = F_173 ( V_4 -> V_214 ) ;
const struct V_212 * V_213 = V_316 -> V_213 ;
struct V_217 * V_226 [ V_227 + 1 ] ;
struct V_1 * V_19 ;
int V_89 , V_109 , V_345 = V_316 -> args [ 1 ] ;
int V_346 , V_347 = V_346 = V_316 -> args [ 2 ] ;
struct V_14 * V_15 ;
int V_348 = 0 , V_344 = 0 ;
unsigned int V_160 = V_325 ;
int V_162 ;
V_162 = F_181 ( V_213 , sizeof( struct V_215 ) , V_226 , V_227 , NULL ) ;
if ( ! V_162 ) {
if ( V_226 [ V_349 ] )
V_344 = F_207 ( V_226 [ V_349 ] ) ;
if ( V_226 [ V_350 ] )
V_348 = F_207 ( V_226 [ V_350 ] ) ;
if ( V_344 || V_348 )
V_160 |= V_351 ;
}
F_61 () ;
V_15 = F_66 ( V_11 -> V_15 ) ;
for ( V_109 = V_345 ; V_109 < ( 1 << V_15 -> V_18 ) ; V_109 ++ ) {
if ( V_109 > V_345 )
V_347 = 0 ;
for ( V_19 = F_66 ( V_15 -> V_21 [ V_109 ] ) , V_346 = 0 ;
V_19 != NULL ;
V_19 = F_66 ( V_19 -> V_25 ) ) {
if ( ! F_67 ( F_68 ( V_19 -> V_34 ) , V_84 ) )
continue;
if ( F_221 ( V_19 -> V_34 , V_344 ) )
continue;
if ( F_219 ( V_19 -> V_34 , V_348 ) )
continue;
if ( V_346 < V_347 )
goto V_25;
if ( F_214 ( V_4 , V_19 , F_211 ( V_316 -> V_4 ) . V_322 ,
V_316 -> V_213 -> V_323 ,
V_341 ,
V_160 ) < 0 ) {
V_89 = - 1 ;
...
struct V_101 * V_19 ;
struct V_84 * V_84 = F_173 ( V_4 -> V_214 ) ;
int V_89 , V_109 , V_345 = V_316 -> args [ 3 ] ;
int V_346 , V_347 = V_346 = V_316 -> args [ 4 ] ;
F_78 ( & V_11 -> V_17 ) ;
for ( V_109 = V_345 ; V_109 <= V_100 ; V_109 ++ ) {
if ( V_109 > V_345 )
V_347 = 0 ;
for ( V_19 = V_11 -> V_103 [ V_109 ] , V_346 = 0 ; V_19 ; V_19 = V_19 -> V_25 ) {
if ( F_75 ( V_19 ) != V_84 )
continue;
if ( V_346 < V_347 )
goto V_25;
if ( F_217 ( V_4 , V_19 , F_211 ( V_316 -> V_4 ) . V_322 ,
V_316 -> V_213 -> V_323 ,
V_341 ,
V_325 , V_11 ) < 0 ) {
F_79 ( & V_11 -> V_17 ) ;
...
static int F_224 ( struct V_3 * V_4 , struct V_315 * V_316 )
{
struct V_10 * V_11 ;
int V_352 , V_205 , V_353 ;
int V_354 = 0 ;
int V_162 ;
V_205 = ( (struct V_320 * ) F_176 ( V_316 -> V_213 ) ) -> V_321 ;
if ( F_174 ( V_316 -> V_213 ) >= sizeof( struct V_215 ) &&
( (struct V_215 * ) F_176 ( V_316 -> V_213 ) ) -> V_224 == V_225 )
V_354 = 1 ;
V_353 = V_316 -> args [ 0 ] ;
for ( V_352 = 0 ; V_352 < V_310 ; V_352 ++ ) {
V_11 = V_204 [ V_352 ] ;
if ( ! V_11 )
continue;
if ( V_352 < V_353 || ( V_205 && V_11 -> V_205 != V_205 ) )
continue;
if ( V_352 > V_353 )
memset ( & V_316 -> args [ 1 ] , 0 , sizeof( V_316 -> args ) -
sizeof( V_316 -> args [ 0 ] ) ) ;
if ( V_354 )
V_162 = F_223 ( V_11 , V_4 , V_316 ) ;
else
V_162 = F_222 ( V_11 , V_4 , V_316 ) ;
if ( V_162 < 0 )
break;
}
V_316 -> args [ 0 ] = V_352 ;
...
void F_225 ( struct V_10 * V_11 , void (* V_316)( struct V_1 * , void * ) , void * V_355 )
{
int V_356 ;
struct V_14 * V_15 ;
F_61 () ;
V_15 = F_66 ( V_11 -> V_15 ) ;
F_226 ( & V_11 -> V_17 ) ;
for ( V_356 = 0 ; V_356 < ( 1 << V_15 -> V_18 ) ; V_356 ++ ) {
struct V_1 * V_19 ;
for ( V_19 = F_66 ( V_15 -> V_21 [ V_356 ] ) ;
V_19 != NULL ;
V_19 = F_66 ( V_19 -> V_25 ) )
V_316 ( V_19 , V_355 ) ;
}
...
const void * V_358 , struct V_3 * V_4 )
{
int V_162 = - V_223 ;
...
goto V_62;
F_61 () ;
V_2 = F_62 ( V_11 , V_358 , V_34 ) ;
if ( ! V_2 )
V_2 = F_69 ( V_11 , V_358 , V_34 , false ) ;
V_162 = F_184 ( V_2 ) ;
if ( F_183 ( V_2 ) ) {
F_64 () ;
goto V_181;
...
static struct V_1 * F_231 ( struct V_360 * V_179 )
{
struct V_361 * V_123 = V_179 -> V_362 ;
struct V_84 * V_84 = F_232 ( V_179 ) ;
struct V_14 * V_15 = V_123 -> V_15 ;
struct V_1 * V_19 = NULL ;
int V_363 = V_123 -> V_363 ;
V_123 -> V_160 &= ~ V_364 ;
for ( V_363 = 0 ; V_363 < ( 1 << V_15 -> V_18 ) ; V_363 ++ ) {
V_19 = F_66 ( V_15 -> V_21 [ V_363 ] ) ;
while ( V_19 ) {
if ( ! F_67 ( F_68 ( V_19 -> V_34 ) , V_84 ) )
goto V_25;
if ( V_123 -> V_365 ) {
T_7 V_366 = 0 ;
void * V_367 ;
V_367 = V_123 -> V_365 ( V_123 , V_19 , & V_366 ) ;
if ( ! V_367 )
goto V_25;
}
if ( ! ( V_123 -> V_160 & V_368 ) )
break;
if ( V_19 -> V_23 & ~ V_40 )
break;
V_25:
...
static struct V_1 * F_233 ( struct V_360 * V_179 ,
struct V_1 * V_19 ,
T_7 * V_369 )
{
struct V_361 * V_123 = V_179 -> V_362 ;
...
struct V_14 * V_15 = V_123 -> V_15 ;
if ( V_123 -> V_365 ) {
void * V_367 = V_123 -> V_365 ( V_123 , V_19 , V_369 ) ;
if ( V_367 )
return V_19 ;
}
V_19 = F_66 ( V_19 -> V_25 ) ;
...
if ( V_19 )
break;
if ( ++ V_123 -> V_363 >= ( 1 << V_15 -> V_18 ) )
break;
V_19 = F_66 ( V_15 -> V_21 [ V_123 -> V_363 ] ) ;
}
if ( V_19 && V_369 )
-- ( * V_369 ) ;
return V_19 ;
}
static struct V_1 * F_234 ( struct V_360 * V_179 , T_7 * V_369 )
{
struct V_1 * V_19 = F_231 ( V_179 ) ;
if ( V_19 ) {
-- ( * V_369 ) ;
while ( * V_369 ) {
V_19 = F_233 ( V_179 , V_19 , V_369 ) ;
if ( ! V_19 )
break;
}
}
return * V_369 ? NULL : V_19 ;
}
static struct V_101 * F_235 ( struct V_360 * V_179 )
{
struct V_361 * V_123 = V_179 -> V_362 ;
struct V_84 * V_84 = F_232 ( V_179 ) ;
...
int V_363 = V_123 -> V_363 ;
V_123 -> V_160 |= V_364 ;
for ( V_363 = 0 ; V_363 <= V_100 ; V_363 ++ ) {
V_229 = V_11 -> V_103 [ V_363 ] ;
...
static struct V_101 * F_236 ( struct V_360 * V_179 ,
struct V_101 * V_229 ,
T_7 * V_369 )
{
struct V_361 * V_123 = V_179 -> V_362 ;
...
while ( ! V_229 ) {
if ( ++ V_123 -> V_363 > V_100 )
break;
V_229 = V_11 -> V_103 [ V_123 -> V_363 ] ;
while ( V_229 && ! F_67 ( F_75 ( V_229 ) , V_84 ) )
V_229 = V_229 -> V_25 ;
if ( V_229 )
break;
...
static struct V_101 * F_237 ( struct V_360 * V_179 , T_7 * V_369 )
{
struct V_101 * V_229 = F_235 ( V_179 ) ;
if ( V_229 ) {
-- ( * V_369 ) ;
while ( * V_369 ) {
V_229 = F_236 ( V_179 , V_229 , V_369 ) ;
if ( ! V_229 )
break;
}
}
return * V_369 ? NULL : V_229 ;
}
static void * F_238 ( struct V_360 * V_179 , T_7 * V_369 )
{
struct V_361 * V_123 = V_179 -> V_362 ;
void * V_89 ;
T_7 V_370 = * V_369 ;
V_89 = F_234 ( V_179 , & V_370 ) ;
if ( ! V_89 && ! ( V_123 -> V_160 & V_371 ) )
V_89 = F_237 ( V_179 , & V_370 ) ;
return V_89 ;
}
void * F_239 ( struct V_360 * V_179 , T_7 * V_369 , struct V_10 * V_11 , unsigned int V_372 )
__acquires( T_8 )
{
struct V_361 * V_123 = V_179 -> V_362 ;
V_123 -> V_11 = V_11 ;
V_123 -> V_363 = 0 ;
V_123 -> V_160 = ( V_372 & ~ V_364 ) ;
F_61 () ;
V_123 -> V_15 = F_66 ( V_11 -> V_15 ) ;
return * V_369 ? F_238 ( V_179 , V_369 ) : V_373 ;
}
void * F_240 ( struct V_360 * V_179 , void * V_367 , T_7 * V_369 )
{
struct V_361 * V_123 ;
void * V_89 ;
if ( V_367 == V_373 ) {
...
V_123 = V_179 -> V_362 ;
if ( ! ( V_123 -> V_160 & V_364 ) ) {
V_89 = F_233 ( V_179 , V_367 , NULL ) ;
if ( V_89 )
goto V_62;
if ( ! ( V_123 -> V_160 & V_371 ) )
V_89 = F_235 ( V_179 ) ;
} else {
F_200 ( V_123 -> V_160 & V_371 ) ;
V_89 = F_236 ( V_179 , V_367 , NULL ) ;
}
V_62:
++ ( * V_369 ) ;
return V_89 ;
}
void F_241 ( struct V_360 * V_179 , void * V_367 )
__releases( T_8 )
{
F_64 () ;
}
static void * F_242 ( struct V_360 * V_179 , T_7 * V_369 )
{
struct V_10 * V_11 = V_179 -> V_362 ;
int V_287 ;
if ( * V_369 == 0 )
return V_373 ;
for ( V_287 = * V_369 - 1 ; V_287 < V_374 ; ++ V_287 ) {
if ( ! F_243 ( V_287 ) )
continue;
* V_369 = V_287 + 1 ;
...
static void * F_244 ( struct V_360 * V_179 , void * V_367 , T_7 * V_369 )
{
struct V_10 * V_11 = V_179 -> V_362 ;
int V_287 ;
for ( V_287 = * V_369 ; V_287 < V_374 ; ++ V_287 ) {
if ( ! F_243 ( V_287 ) )
continue;
* V_369 = V_287 + 1 ;
return F_198 ( V_11 -> V_198 , V_287 ) ;
...
static void F_245 ( struct V_360 * V_179 , void * V_367 )
{
}
static int F_246 ( struct V_360 * V_179 , void * V_367 )
{
struct V_10 * V_11 = V_179 -> V_362 ;
struct V_199 * V_290 = V_367 ;
if ( V_367 == V_373 ) {
F_247 ( V_179 , L_19 ) ;
return 0 ;
}
...
static int F_248 ( struct V_375 * V_375 , struct V_376 * V_376 )
{
int V_66 = F_249 ( V_376 , & V_377 ) ;
if ( ! V_66 ) {
struct V_360 * V_378 = V_376 -> V_379 ;
V_378 -> V_362 = F_250 ( V_375 ) ;
}
return V_66 ;
}
...
if ( V_4 == NULL )
goto V_305;
V_162 = F_214 ( V_4 , V_19 , 0 , 0 , type , V_160 ) ;
if ( V_162 < 0 ) {
F_163 ( V_162 == - V_261 ) ;
F_2 ( V_4 ) ;
goto V_305;
}
F_255 ( V_4 , V_84 , 0 , V_380 , NULL , V_54 ) ;
return;
V_305:
if ( V_162 < 0 )
F_256 ( V_84 , V_380 , V_162 ) ;
}
void F_257 ( struct V_1 * V_19 )
{
F_4 ( V_19 , V_381 , V_382 ) ;
}
static int F_258 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 , T_3 * V_387 , T_7 * V_388 )
{
int V_65 , V_66 ;
struct V_383 V_389 = * V_384 ;
V_389 . V_390 = & V_391 ;
V_389 . V_392 = & V_393 ;
V_389 . V_394 = & V_65 ;
V_65 = * ( int * ) V_384 -> V_394 / F_188 ( V_243 ) ;
V_66 = F_259 ( & V_389 , V_385 , V_386 , V_387 , V_388 ) ;
if ( V_385 && ! V_66 )
* ( int * ) V_384 -> V_394 = V_65 * F_188 ( V_243 ) ;
return V_66 ;
}
...
struct V_110 * V_395 =
F_260 ( V_34 , V_205 ) ;
if ( V_395 && ! F_266 ( V_195 , V_395 -> V_396 ) )
V_395 -> V_394 [ V_195 ] = V_120 -> V_394 [ V_195 ] ;
}
F_120 () ;
}
static void F_267 ( struct V_383 * V_384 , int V_385 )
{
struct V_35 * V_34 = V_384 -> V_390 ;
struct V_110 * V_120 = V_384 -> V_392 ;
struct V_84 * V_84 = F_146 ( V_120 ) ;
int V_195 = ( int * ) V_384 -> V_394 - V_120 -> V_394 ;
if ( ! V_385 )
return;
F_268 ( V_195 , V_120 -> V_396 ) ;
if ( ! V_34 )
F_263 ( V_84 , V_120 , V_195 ) ;
}
static int F_269 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 ,
T_3 * V_387 , T_7 * V_388 )
{
struct V_383 V_389 = * V_384 ;
...
int F_270 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 , T_3 * V_387 , T_7 * V_388 )
{
int V_66 = F_271 ( V_384 , V_385 , V_386 , V_387 , V_388 ) ;
F_267 ( V_384 , V_385 ) ;
return V_66 ;
}
int F_272 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 ,
T_3 * V_387 , T_7 * V_388 )
{
int V_66 = F_273 ( V_384 , V_385 , V_386 , V_387 , V_388 ) ;
F_267 ( V_384 , V_385 ) ;
return V_66 ;
}
static int F_274 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 ,
T_3 * V_387 , T_7 * V_388 )
{
int V_66 = F_275 ( V_384 , V_385 , V_386 , V_387 , V_388 ) ;
F_267 ( V_384 , V_385 ) ;
return V_66 ;
}
int F_276 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 ,
T_3 * V_387 , T_7 * V_388 )
{
int V_66 = F_277 ( V_384 , V_385 , V_386 , V_387 , V_388 ) ;
F_267 ( V_384 , V_385 ) ;
return V_66 ;
}
static int F_278 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 ,
T_3 * V_387 , T_7 * V_388 )
{
int V_66 = F_258 ( V_384 , V_385 , V_386 , V_387 , V_388 ) ;
F_267 ( V_384 , V_385 ) ;
return V_66 ;
}
static int F_279 ( struct V_383 * V_384 , int V_385 ,
void T_9 * V_386 ,
T_3 * V_387 , T_7 * V_388 )
{
struct V_110 * V_120 = V_384 -> V_392 ;
int V_66 ;
if ( strcmp ( V_384 -> V_398 , L_22 ) == 0 )
V_66 = F_272 ( V_384 , V_385 , V_386 , V_387 , V_388 ) ;
else if ( strcmp ( V_384 -> V_398 , L_23 ) == 0 )
V_66 = F_276 ( V_384 , V_385 , V_386 , V_387 , V_388 ) ;
else
V_66 = - 1 ;
if ( V_385 && V_66 == 0 ) {
V_120 -> V_121 =
...
struct V_400 * V_352 ;
const char * V_401 ;
char V_402 [ sizeof( L_24 ) + V_403 + V_403 ] ;
char * V_404 ;
V_352 = F_148 ( & V_405 , sizeof( * V_352 ) , V_105 ) ;
if ( ! V_352 )
goto V_162;
for ( V_13 = 0 ; V_13 < V_406 ; V_13 ++ ) {
V_352 -> V_407 [ V_13 ] . V_394 += ( long ) V_120 ;
V_352 -> V_407 [ V_13 ] . V_390 = V_34 ;
V_352 -> V_407 [ V_13 ] . V_392 = V_120 ;
}
if ( V_34 ) {
V_401 = V_34 -> V_408 ;
memset ( & V_352 -> V_407 [ V_406 ] , 0 ,
sizeof( V_352 -> V_407 [ V_406 ] ) ) ;
} else {
struct V_10 * V_11 = V_120 -> V_11 ;
V_401 = L_25 ;
V_352 -> V_407 [ V_406 ] . V_394 = & V_11 -> V_269 ;
V_352 -> V_407 [ V_409 ] . V_394 = & V_11 -> V_122 ;
V_352 -> V_407 [ V_410 ] . V_394 = & V_11 -> V_47 ;
V_352 -> V_407 [ V_411 ] . V_394 = & V_11 -> V_46 ;
}
if ( V_399 ) {
V_352 -> V_407 [ V_412 ] . T_10 = V_399 ;
V_352 -> V_407 [ V_413 ] . T_10 = V_399 ;
V_352 -> V_407 [ V_414 ] . T_10 = V_399 ;
V_352 -> V_407 [ V_415 ] . T_10 = V_399 ;
} else {
V_352 -> V_407 [ V_413 ] . T_10 =
F_279 ;
V_352 -> V_407 [ V_415 ] . T_10 =
F_279 ;
}
if ( F_146 ( V_120 ) -> V_416 != & V_417 )
V_352 -> V_407 [ 0 ] . V_398 = NULL ;
switch ( F_264 ( V_120 ) ) {
case V_206 :
V_404 = L_26 ;
break;
...
snprintf ( V_402 , sizeof( V_402 ) , L_28 ,
V_404 , V_401 ) ;
V_352 -> V_418 =
F_282 ( F_146 ( V_120 ) , V_402 , V_352 -> V_407 ) ;
if ( ! V_352 -> V_418 )
goto free;
V_120 -> V_193 = V_352 ;
return 0 ;
...
{
if ( V_120 -> V_193 ) {
struct V_400 * V_352 = V_120 -> V_193 ;
V_120 -> V_193 = NULL ;
F_284 ( V_352 -> V_418 ) ;
F_54 ( V_352 ) ;
}
...
{
F_286 ( V_419 , V_341 , F_180 , NULL , NULL ) ;
F_286 ( V_419 , V_8 , F_172 , NULL , NULL ) ;
F_286 ( V_419 , V_381 , NULL , F_224 , NULL ) ;
F_286 ( V_419 , V_420 , NULL , F_210 ,
NULL ) ;
F_286 ( V_419 , V_421 , F_204 , NULL , NULL ) ;
return 0 ;
}
