...
struct V_188 * V_189 ;
struct V_190 V_12 = V_191 ;
int V_79 , V_36 ;
V_189 = & V_187 -> V_192 [ V_187 -> V_193 - 1 ] ;
V_79 = F_24 ( V_78 ) ;
if ( V_79 == V_46 ||
V_79 == V_44 ) {
...
if ( V_187 -> V_195 && F_103 ( V_78 , V_187 -> V_85 . V_25 ) )
return V_166 ;
else
return V_167 ;
error:
...
static int F_119 ( T_1 * V_88 , struct V_84 * V_85 )
{
struct V_186 * V_187 =
...
T_1 V_78 ;
int V_36 ;
if ( V_187 -> V_193 == V_187 -> V_196 ) {
F_28 ( L_67 , V_187 -> V_196 ) ;
return - V_45 ;
}
V_189 = & V_187 -> V_192 [ V_187 -> V_193 ++ ] ;
...
{
struct V_186 V_187 = {
. V_85 = { . V_117 = V_117 , . V_109 = F_119 } ,
. V_8 = V_2 -> V_8 ,
. V_196 = V_42 . V_185 } ;
int V_36 ;
* V_192 = F_11 ( sizeof( struct V_188 ) * V_187 . V_196 ) ;
if ( * V_192 == NULL )
return - V_51 ;
V_187 . V_192 = * V_192 ;
V_187 . V_193 = 0 ;
...
if ( V_36 < 0 ) {
while ( V_187 . V_193 -- ) {
F_12 ( & V_187 . V_192 [ V_187 . V_193 ] . V_118 . V_99 ) ;
F_122 ( V_187 . V_192 [ V_187 . V_193 ] . V_163 ) ;
}
F_12 ( V_192 ) ;
return V_36 ;
}
return ( V_36 < 0 ) ? V_36 : V_187 . V_193 ;
}
...
V_201 = F_127 ( V_2 -> V_8 , V_169 , & V_198 ) ;
if ( strcmp ( V_201 , L_74 ) == 0 ) {
V_199 = F_128 ( V_156 , V_198 ) ;
if ( ! V_199 )
return - V_10 ;
V_158 = F_129 ( V_199 , & V_200 ) ;
if ( ! V_158 )
return - V_10 ;
* V_21 = V_158 -> V_202 ;
}
...
T_2 V_207 = 0 , V_208 = 0 ;
const char * V_119 = NULL , * V_209 = NULL , * V_210 = NULL , * V_31 ;
int V_211 = 0 , V_121 = 0 , V_36 = 0 ;
bool V_212 = false ;
V_213:
if ( ! F_131 ( V_2 -> V_2 , ( T_2 ) V_25 , & V_204 ) ) {
if ( ! V_212 && F_124 ( V_2 , & V_208 ) == 0 ) {
V_25 += V_208 ;
V_212 = true ;
goto V_213;
}
...
F_132 ( & V_204 , V_25 , & V_119 , & V_121 ) ;
if ( F_56 ( & V_204 , ( T_2 ) V_25 , & V_205 ) ) {
V_209 = V_210 = F_26 ( & V_205 ) ;
if ( ! V_209 ||
F_23 ( & V_205 , & V_208 ) != 0 ||
F_64 ( & V_205 , & V_211 ) != 0 ) {
V_121 = 0 ;
...
V_119 = F_62 ( & V_205 ) ;
if ( V_25 == ( unsigned long ) V_208 ) {
V_121 = V_211 ;
goto V_214;
}
while ( F_133 ( & V_205 , ( T_2 ) V_25 ,
& V_206 ) ) {
if ( F_23 ( & V_206 , & V_207 ) == 0 &&
V_207 == V_25 ) {
V_121 = F_134 ( & V_206 ) ;
V_119 = F_135 ( & V_206 ) ;
break;
...
V_214:
if ( V_121 )
V_203 -> line = V_121 - V_211 ;
else if ( V_210 ) {
V_203 -> V_23 = V_25 - ( unsigned long ) V_208 ;
V_209 = V_210 ;
}
if ( V_209 ) {
V_203 -> V_93 = F_29 ( V_209 ) ;
if ( V_203 -> V_93 == NULL ) {
V_36 = - V_51 ;
goto V_182;
}
...
V_182:
if ( V_36 == 0 && ( V_119 || V_209 ) )
V_36 = 1 ;
return V_36 ;
}
static int F_136 ( const char * V_215 , unsigned int V_121 ,
struct V_216 * V_217 )
{
if ( ! V_217 -> V_3 ) {
V_217 -> V_3 = F_29 ( V_215 ) ;
if ( V_217 -> V_3 == NULL )
return - V_51 ;
}
return F_74 ( V_217 -> V_218 , V_121 ) ;
}
static int F_137 ( const char * V_119 , int V_121 ,
T_2 V_25 V_219 ,
void * V_111 )
{
struct V_220 * V_221 = V_111 ;
int V_222 ;
if ( ( F_68 ( V_119 , V_221 -> V_119 ) != 0 ) ||
( V_221 -> V_223 > V_121 || V_221 -> V_224 < V_121 ) )
return 0 ;
V_222 = F_136 ( V_119 , V_121 , V_221 -> V_217 ) ;
if ( V_222 < 0 && V_222 != - V_225 )
return V_222 ;
return 0 ;
}
static int F_138 ( T_1 * V_27 , struct V_220 * V_221 )
{
int V_36 ;
V_36 = F_70 ( V_27 ? : & V_221 -> V_90 , F_137 , V_221 ) ;
if ( V_36 >= 0 )
if ( ! F_78 ( V_221 -> V_217 -> V_218 ) )
V_36 = V_221 -> V_47 = 1 ;
else
V_36 = 0 ;
else {
F_12 ( & V_221 -> V_217 -> V_3 ) ;
}
return V_36 ;
}
static int F_139 ( T_1 * V_135 , void * V_111 )
{
int V_36 = F_138 ( V_135 , V_111 ) ;
return V_36 < 0 ? V_36 : 0 ;
}
static int F_140 ( T_1 * V_27 , void * V_111 )
{
struct V_138 * V_139 = V_111 ;
struct V_220 * V_221 = V_139 -> V_111 ;
struct V_216 * V_217 = V_221 -> V_217 ;
if ( V_217 -> V_114 && F_68 ( V_217 -> V_114 , F_62 ( V_27 ) ) )
return V_140 ;
if ( F_55 ( V_27 ) &&
F_63 ( V_27 , V_217 -> V_93 ) ) {
V_221 -> V_119 = F_62 ( V_27 ) ;
F_64 ( V_27 , & V_217 -> V_23 ) ;
F_13 ( L_76 , V_221 -> V_119 , V_217 -> V_23 ) ;
V_221 -> V_223 = V_217 -> V_23 + V_217 -> V_226 ;
if ( V_221 -> V_223 < 0 )
V_221 -> V_223 = V_120 ;
V_221 -> V_224 = V_217 -> V_23 + V_217 -> V_182 ;
if ( V_221 -> V_224 < 0 )
V_221 -> V_224 = V_120 ;
F_13 ( L_77 , V_221 -> V_223 , V_221 -> V_224 ) ;
V_217 -> V_226 = V_221 -> V_223 ;
V_217 -> V_182 = V_221 -> V_224 ;
if ( ! F_83 ( V_27 ) )
V_139 -> V_141 = F_84 ( V_27 ,
F_139 , V_221 ) ;
else
V_139 -> V_141 = F_138 ( V_27 , V_221 ) ;
return V_143 ;
}
return V_140 ;
}
...
{
struct V_138 V_139 = { . V_111 = ( void * ) V_221 , . V_141 = 0 } ;
F_87 ( & V_221 -> V_90 , F_140 , & V_139 , 0 ) ;
return V_139 . V_141 ;
}
int F_142 ( struct V_1 * V_2 , struct V_216 * V_217 )
{
struct V_220 V_221 = { . V_217 = V_217 , . V_47 = 0 } ;
int V_36 = 0 ;
T_14 V_150 = 0 , V_151 ;
T_5 V_152 ;
T_1 * V_153 ;
...
if ( V_217 -> V_93 ) {
struct V_146 V_154 = {
. V_93 = V_217 -> V_93 , . V_114 = V_217 -> V_114 ,
. V_90 = & V_221 . V_90 , . V_27 = & V_221 . V_27 , . V_47 = 0 } ;
struct V_138 V_227 = {
. V_111 = ( void * ) & V_221 , . V_141 = 0 } ;
F_92 ( V_2 -> V_2 , F_88 ,
& V_154 , 0 ) ;
if ( V_154 . V_47 ) {
F_140 ( & V_221 . V_27 , & V_227 ) ;
if ( V_221 . V_47 )
goto V_47;
}
}
while ( ! V_221 . V_47 && V_36 >= 0 ) {
if ( F_93 ( V_2 -> V_2 , V_150 , & V_151 , & V_152 ,
NULL , NULL , NULL ) != 0 )
break;
V_153 = F_89 ( V_2 -> V_2 , V_150 + V_152 , & V_221 . V_90 ) ;
if ( ! V_153 )
continue;
if ( V_217 -> V_114 )
V_221 . V_119 = F_94 ( & V_221 . V_90 , V_217 -> V_114 ) ;
else
V_221 . V_119 = 0 ;
if ( ! V_217 -> V_114 || V_221 . V_119 ) {
if ( V_217 -> V_93 )
V_36 = F_141 ( & V_221 ) ;
else {
V_221 . V_223 = V_217 -> V_226 ;
V_221 . V_224 = V_217 -> V_182 ;
V_36 = F_138 ( NULL , & V_221 ) ;
}
}
V_150 = V_151 ;
}
V_47:
if ( V_221 . V_47 ) {
V_133 = F_79 ( & V_221 . V_90 ) ;
if ( V_133 ) {
V_217 -> V_133 = F_29 ( V_133 ) ;
if ( ! V_217 -> V_133 )
V_36 = - V_51 ;
}
}
F_13 ( L_78 , V_217 -> V_3 ) ;
return ( V_36 < 0 ) ? V_36 : V_221 . V_47 ;
}
int F_80 ( const char * V_228 , const char * V_133 ,
char * * V_229 )
{
const char * V_230 = V_231 . V_232 ;
if ( ! V_230 ) {
if ( V_228 [ 0 ] != '/' && V_133 )
V_230 = V_133 ;
else {
if ( F_143 ( V_228 , V_233 ) == 0 ) {
* V_229 = F_29 ( V_228 ) ;
return * V_229 ? 0 : - V_51 ;
} else
return - V_130 ;
...
* V_229 = malloc ( ( strlen ( V_230 ) + strlen ( V_228 ) + 2 ) ) ;
if ( ! * V_229 )
return - V_51 ;
for (; ; ) {
sprintf ( * V_229 , L_79 , V_230 , V_228 ) ;
if ( F_143 ( * V_229 , V_233 ) == 0 )
return 0 ;
if ( ! V_231 . V_232 ) {
F_12 ( V_229 ) ;
return - V_130 ;
