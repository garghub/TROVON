...
static T_1 F_132 ( T_1 V_262 , T_11 V_263 )
{
T_2 V_264 = ( T_2 ) V_262 * ( 1000000 + V_263 ) ;
F_133 ( V_264 , 1000000 ) ;
return V_264 ;
}
static int F_134 ( struct V_1 * V_2 , T_1 V_265 , bool V_266 )
{
T_2 V_267 ;
if ( ! V_266 ) {
V_2 -> V_5 . V_268 = V_269 ;
...
V_267 = F_136 ( 1ULL << V_274 ,
V_265 , V_271 ) ;
if ( V_267 == 0 || V_267 >= V_275 ) {
F_137 ( 1 , L_4 ,
V_265 ) ;
return - 1 ;
}
...
static int F_138 ( struct V_1 * V_2 , T_1 V_265 )
{
T_1 V_276 , V_277 ;
int V_278 = 0 ;
if ( V_265 == 0 ) {
...
F_130 ( V_265 * 1000LL , V_279 ,
& V_2 -> V_5 . V_280 ,
& V_2 -> V_5 . V_281 ) ;
V_2 -> V_5 . V_282 = V_265 ;
V_276 = F_132 ( V_271 , - V_283 ) ;
V_277 = F_132 ( V_271 , V_283 ) ;
if ( V_265 < V_276 || V_265 > V_277 ) {
F_131 ( L_5 , V_265 , V_276 , V_277 ) ;
V_278 = 1 ;
}
return F_134 ( V_2 , V_265 , V_278 ) ;
}
static T_2 F_139 ( struct V_1 * V_2 , T_12 V_284 )
{
T_2 V_285 = F_140 ( V_284 - V_2 -> V_5 . V_286 ,
V_2 -> V_5 . V_281 ,
V_2 -> V_5 . V_280 ) ;
V_285 += V_2 -> V_5 . V_287 ;
return V_285 ;
...
V_288 = ( V_290 -> V_292 + 1 ==
F_142 ( & V_2 -> V_138 -> V_293 ) ) ;
if ( V_290 -> V_294 ||
( V_291 -> clock . V_232 == V_295 && V_288 ) )
F_30 ( V_296 , V_2 ) ;
F_143 ( V_2 -> V_297 , V_290 -> V_292 ,
F_142 ( & V_2 -> V_138 -> V_293 ) ,
V_290 -> V_294 , V_291 -> clock . V_232 ) ;
#endif
}
static void F_144 ( struct V_1 * V_2 , T_12 V_94 )
{
T_2 V_298 = V_73 -> V_299 ( V_2 ) ;
V_2 -> V_5 . V_300 += V_94 - V_298 ;
}
static inline T_2 F_145 ( T_2 V_267 , T_2 V_285 )
{
return F_146 ( V_285 , V_267 , V_274 ) ;
}
T_2 F_147 ( struct V_1 * V_2 , T_2 V_285 )
{
T_2 V_301 = V_285 ;
T_2 V_267 = V_2 -> V_5 . V_268 ;
if ( V_267 != V_269 )
V_301 = F_145 ( V_267 , V_285 ) ;
return V_301 ;
}
static T_2 F_148 ( struct V_1 * V_2 , T_2 V_302 )
{
T_2 V_285 ;
V_285 = F_147 ( V_2 , F_149 () ) ;
return V_302 - V_285 ;
}
T_2 F_150 ( struct V_1 * V_2 , T_2 V_303 )
{
return V_73 -> V_304 ( V_2 , F_147 ( V_2 , V_303 ) ) ;
}
void F_151 ( struct V_1 * V_2 , struct V_32 * V_21 )
{
...
struct V_225 * V_291 = & V_225 ;
* V_328 = F_162 () ;
V_264 = ( * V_328 - V_291 -> clock . V_234 ) & V_291 -> clock . V_28 ;
return V_264 * V_291 -> clock . V_235 ;
}
...
static int F_179 ( struct V_1 * V_264 )
{
unsigned long V_307 , V_340 ;
struct V_341 * V_2 = & V_264 -> V_5 ;
struct V_289 * V_290 = & V_264 -> V_138 -> V_5 ;
T_12 V_284 ;
T_2 V_342 , V_303 ;
struct V_343 V_344 ;
T_14 V_345 ;
...
V_342 = F_150 ( V_264 , V_303 ) ;
if ( V_2 -> V_272 ) {
T_2 V_285 = F_139 ( V_264 , V_284 ) ;
if ( V_285 > V_342 ) {
F_160 ( V_264 , V_285 - V_342 ) ;
V_342 = V_285 ;
}
}
F_182 ( V_307 ) ;
...
return 0 ;
if ( V_270 )
V_340 = F_147 ( V_264 , V_340 ) ;
if ( F_168 ( V_2 -> V_348 != V_340 ) ) {
F_130 ( V_279 , V_340 * 1000LL ,
& V_2 -> V_349 . V_350 ,
& V_2 -> V_349 . V_351 ) ;
V_2 -> V_348 = V_340 ;
}
V_2 -> V_349 . V_342 = V_342 ;
V_2 -> V_349 . V_352 = V_284 + V_264 -> V_138 -> V_5 . V_246 ;
V_2 -> V_323 = V_342 ;
if ( F_168 ( F_183 ( V_264 -> V_138 , & V_2 -> V_353 ,
& V_344 , sizeof( V_344 ) ) ) )
return 0 ;
F_184 ( F_185 ( struct V_343 , V_241 ) != 0 ) ;
V_2 -> V_349 . V_241 = V_344 . V_241 + 1 ;
F_186 ( V_264 -> V_138 , & V_2 -> V_353 ,
& V_2 -> V_349 ,
...
static void F_192 ( struct V_1 * V_264 )
{
struct V_138 * V_138 = V_264 -> V_138 ;
F_30 ( V_338 , V_264 ) ;
...
return;
if ( F_168 ( F_183 ( V_2 -> V_138 , & V_2 -> V_5 . V_394 . V_396 ,
& V_2 -> V_5 . V_394 . V_397 , sizeof( struct V_398 ) ) ) )
return;
if ( V_2 -> V_5 . V_394 . V_397 . V_241 & 1 )
V_2 -> V_5 . V_394 . V_397 . V_241 += 1 ;
V_2 -> V_5 . V_394 . V_397 . V_241 += 1 ;
F_186 ( V_2 -> V_138 , & V_2 -> V_5 . V_394 . V_396 ,
& V_2 -> V_5 . V_394 . V_397 , sizeof( struct V_398 ) ) ;
F_187 () ;
...
int F_208 ( struct V_1 * V_2 , struct V_32 * V_33 )
{
bool V_403 = false ;
T_1 V_21 = V_33 -> V_146 ;
T_2 V_38 = V_33 -> V_38 ;
...
bool V_430 = ( V_21 == V_428 ) ;
if ( V_290 -> V_335 != V_430 )
F_213 ( V_296 ,
& V_2 -> V_339 ) ;
V_290 -> V_335 = V_430 ;
}
...
if ( V_38 & V_434 )
return 1 ;
if ( F_204 ( V_2 -> V_138 , & V_2 -> V_5 . V_394 . V_396 ,
V_38 & V_435 ,
sizeof( struct V_398 ) ) )
return 1 ;
...
case V_452 :
case V_453 ... V_454 :
return F_218 ( V_2 , V_21 , V_38 ,
V_33 -> V_40 ) ;
case V_455 :
F_209 ( V_2 , L_15 , V_21 , V_38 ) ;
break;
case V_456 :
if ( ! F_219 ( V_2 ) )
return 1 ;
V_2 -> V_5 . V_457 . V_458 = V_38 ;
break;
case V_459 :
if ( ! F_219 ( V_2 ) )
return 1 ;
V_2 -> V_5 . V_457 . V_460 = V_38 ;
break;
default:
...
{
return V_73 -> V_462 ( V_2 , V_21 ) ;
}
static int F_220 ( struct V_1 * V_2 , T_1 V_21 , T_2 * V_463 )
{
T_2 V_38 ;
T_2 V_366 = V_2 -> V_5 . V_366 ;
unsigned V_367 = V_366 & 0xff ;
...
int F_221 ( struct V_1 * V_2 , struct V_32 * V_33 )
{
switch ( V_33 -> V_146 ) {
case V_467 :
case V_468 :
...
break;
case V_421 :
V_33 -> V_38 = V_2 -> V_5 . V_422 ;
break;
case V_423 :
if ( ! V_33 -> V_40 )
return 1 ;
V_33 -> V_38 = V_2 -> V_5 . V_424 ;
break;
case V_480 :
V_33 -> V_38 = 1000ULL ;
...
if ( ! F_219 ( V_2 ) )
return 1 ;
V_33 -> V_38 = V_2 -> V_5 . V_457 . V_458 ;
break;
case V_459 :
if ( ! F_219 ( V_2 ) )
return 1 ;
V_33 -> V_38 = V_2 -> V_5 . V_457 . V_460 ;
break;
default:
if ( F_216 ( V_2 , V_33 -> V_146 ) )
return F_222 ( V_2 , V_33 -> V_146 , & V_33 -> V_38 ) ;
if ( ! V_461 ) {
F_209 ( V_2 , L_17 , V_33 -> V_146 ) ;
return 1 ;
} else {
F_209 ( V_2 , L_18 , V_33 -> V_146 ) ;
V_33 -> V_38 = 0 ;
}
break;
}
...
static int F_227 ( struct V_1 * V_2 , struct V_482 * V_19 ,
struct V_483 * V_484 ,
int (* F_228)( struct V_1 * V_2 ,
unsigned V_146 , T_2 * V_38 ) )
{
int V_3 , V_485 ;
V_485 = F_229 ( & V_2 -> V_138 -> V_486 ) ;
for ( V_3 = 0 ; V_3 < V_19 -> V_487 ; ++ V_3 )
if ( F_228 ( V_2 , V_484 [ V_3 ] . V_146 , & V_484 [ V_3 ] . V_38 ) )
break;
F_230 ( & V_2 -> V_138 -> V_486 , V_485 ) ;
return V_3 ;
}
static int F_231 ( struct V_1 * V_2 , struct V_482 T_15 * V_488 ,
int (* F_228)( struct V_1 * V_2 ,
unsigned V_146 , T_2 * V_38 ) ,
int V_489 )
{
...
unsigned V_491 ;
V_120 = - V_101 ;
if ( F_232 ( & V_19 , V_488 , sizeof V_19 ) )
goto V_113;
V_120 = - V_386 ;
if ( V_19 . V_487 >= V_492 )
goto V_113;
...
V_120 = V_490 = F_227 ( V_2 , & V_19 , V_484 , F_228 ) ;
if ( V_120 < 0 )
goto V_388;
V_120 = - V_101 ;
if ( V_489 && F_233 ( V_488 -> V_484 , V_484 , V_491 ) )
goto V_388;
V_120 = V_490 ;
V_388:
F_202 ( V_484 ) ;
...
int F_234 ( struct V_138 * V_138 , long V_493 )
{
int V_120 ;
switch ( V_493 ) {
case V_494 :
...
unsigned V_490 ;
V_120 = - V_101 ;
if ( F_232 ( & V_564 , V_563 , sizeof V_564 ) )
goto V_113;
V_490 = V_564 . V_487 ;
V_564 . V_487 = V_565 + V_566 ;
if ( F_233 ( V_563 , & V_564 , sizeof V_564 ) )
goto V_113;
V_120 = - V_386 ;
if ( V_490 < V_564 . V_487 )
goto V_113;
V_120 = - V_101 ;
if ( F_233 ( V_563 -> V_567 , & V_568 ,
V_565 * sizeof( T_1 ) ) )
goto V_113;
if ( F_233 ( V_563 -> V_567 + V_565 ,
& V_569 ,
V_566 * sizeof( T_1 ) ) )
goto V_113;
V_120 = 0 ;
...
struct V_572 V_574 ;
V_120 = - V_101 ;
if ( F_232 ( & V_574 , V_573 , sizeof V_574 ) )
goto V_113;
...
goto V_113;
V_120 = - V_101 ;
if ( F_233 ( V_573 , & V_574 , sizeof V_574 ) )
goto V_113;
V_120 = 0 ;
break;
}
...
V_576 = V_577 ;
V_120 = - V_101 ;
if ( F_233 ( V_560 , & V_576 , sizeof V_576 ) )
goto V_113;
V_120 = 0 ;
break;
}
...
if ( V_607 -> V_605 >= V_367 || ! ( V_607 -> V_460 & V_609 ) )
return - V_578 ;
if ( ( V_607 -> V_460 & V_610 ) && ( V_366 & V_371 ) &&
V_2 -> V_5 . V_372 != ~ ( T_2 ) 0 )
return 0 ;
V_608 += 4 * V_607 -> V_605 ;
if ( ( V_607 -> V_460 & V_610 ) && V_608 [ 0 ] != ~ ( T_2 ) 0 )
return 0 ;
if ( V_607 -> V_460 & V_610 ) {
...
return - V_578 ;
if ( V_617 -> V_68 . V_618 &&
( V_617 -> V_68 . V_16 > 31 || V_617 -> V_68 . V_16 == V_51 ) )
return - V_578 ;
F_270 ( V_2 ) ;
...
F_213 ( V_645 , & V_2 -> V_5 . V_593 -> V_646 ) ;
else
...
if ( V_648 -> V_307 )
return - V_578 ;
if ( V_648 -> V_186 & ~ 0xffffffffull )
return - V_578 ;
if ( V_648 -> V_187 & ~ 0xffffffffull )
return - V_578 ;
...
goto V_113;
V_120 = - V_101 ;
if ( F_233 ( V_560 , V_681 . V_679 , sizeof( struct V_588 ) ) )
goto V_113;
V_120 = 0 ;
break;
}
...
struct V_594 V_595 ;
V_120 = - V_101 ;
if ( F_232 ( & V_595 , V_560 , sizeof V_595 ) )
goto V_113;
...
case V_692 :
V_120 = F_231 ( V_2 , V_560 , F_113 , 1 ) ;
break;
case V_693 :
V_120 = F_231 ( V_2 , V_560 , F_115 , 0 ) ;
break;
case V_694 : {
struct V_601 V_602 ;
V_120 = - V_101 ;
if ( F_232 ( & V_602 , V_560 , sizeof V_602 ) )
goto V_113;
V_120 = F_266 ( V_2 , & V_602 ) ;
if ( V_120 )
goto V_113;
V_120 = - V_101 ;
if ( F_233 ( V_560 , & V_602 , sizeof V_602 ) )
goto V_113;
V_120 = 0 ;
break;
} ;
...
goto V_113;
V_120 = - V_101 ;
if ( F_232 ( & V_697 , V_560 , sizeof V_697 ) )
goto V_113;
...
T_2 V_366 ;
V_120 = - V_101 ;
if ( F_232 ( & V_366 , V_560 , sizeof V_366 ) )
goto V_113;
...
struct V_606 V_607 ;
V_120 = - V_101 ;
if ( F_232 ( & V_607 , V_560 , sizeof V_607 ) )
goto V_113;
...
F_269 ( V_2 , & V_617 ) ;
V_120 = - V_101 ;
if ( F_233 ( V_560 , & V_617 , sizeof( struct V_616 ) ) )
break;
V_120 = 0 ;
break;
}
...
struct V_616 V_617 ;
V_120 = - V_101 ;
if ( F_232 ( & V_617 , V_560 , sizeof( struct V_616 ) ) )
break;
...
V_120 = - V_101 ;
if ( F_233 ( V_560 , V_681 . V_651 , sizeof( struct V_666 ) ) )
break;
V_120 = 0 ;
break;
}
...
struct V_676 V_677 ;
V_120 = - V_101 ;
if ( F_232 ( & V_677 , V_560 , sizeof( V_677 ) ) )
goto V_113;
...
T_2 V_718 ;
V_120 = - V_101 ;
if ( F_232 ( & V_718 , V_560 , sizeof V_718 ) )
goto V_113;
...
goto V_786;
V_120 = - V_101 ;
if ( F_233 ( V_560 , V_726 , sizeof *V_726 ) )
goto V_786;
V_120 = 0 ;
V_786:
F_202 ( V_726 ) ;
...
case V_789 : {
V_120 = - V_101 ;
if ( F_232 ( & V_681 . V_737 , V_560 , sizeof( struct V_736 ) ) )
goto V_113;
V_120 = - V_597 ;
if ( ! V_138 -> V_5 . V_740 )
goto V_113;
...
goto V_113;
V_120 = - V_101 ;
if ( F_233 ( V_560 , & V_681 . V_737 , sizeof( struct V_736 ) ) )
goto V_113;
V_120 = 0 ;
break;
}
case V_790 : {
V_120 = - V_101 ;
if ( F_232 ( & V_681 . V_737 , V_560 , sizeof V_681 . V_737 ) )
goto V_113;
V_120 = - V_597 ;
if ( ! V_138 -> V_5 . V_740 )
goto V_113;
...
goto V_113;
V_120 = - V_101 ;
if ( F_233 ( V_560 , & V_681 . V_768 , sizeof( V_681 . V_768 ) ) )
goto V_113;
V_120 = 0 ;
break;
}
case V_792 : {
V_120 = - V_101 ;
if ( F_232 ( & V_681 . V_768 , V_560 , sizeof( V_681 . V_768 ) ) )
goto V_113;
V_120 = - V_597 ;
if ( ! V_138 -> V_5 . V_740 )
goto V_113;
...
struct V_751 V_752 ;
V_120 = - V_101 ;
if ( F_232 ( & V_752 , V_560 , sizeof( V_752 ) ) )
goto V_113;
...
case V_797 : {
V_120 = - V_101 ;
if ( F_232 ( & V_138 -> V_5 . F_197 , V_560 ,
sizeof( struct V_798 ) ) )
goto V_113;
V_120 = - V_578 ;
...
T_12 V_318 ;
V_120 = - V_101 ;
if ( F_232 ( & V_801 , V_560 , sizeof( V_801 ) ) )
goto V_113;
V_120 = - V_578 ;
if ( V_801 . V_307 )
goto V_113;
...
V_120 = - V_101 ;
if ( F_233 ( V_560 , & V_801 , sizeof( V_801 ) ) )
goto V_113;
V_120 = 0 ;
break;
}
...
V_490 = F_338 ( V_95 , 8 ) ;
if ( ! ( F_89 ( V_2 ) &&
! F_339 ( V_2 , & V_2 -> V_5 . V_593 -> V_811 , V_614 , V_490 , V_264 ) )
&& F_340 ( V_2 , V_812 , V_614 , V_490 , V_264 ) )
break;
V_810 += V_490 ;
V_614 += V_490 ;
V_95 -= V_490 ;
...
static int F_341 ( struct V_1 * V_2 , T_6 V_614 , int V_95 , void * V_264 )
{
int V_810 = 0 ;
int V_490 ;
do {
...
V_614 , V_490 , V_264 ) )
&& F_343 ( V_2 , V_812 , V_614 , V_490 , V_264 ) )
break;
F_344 ( V_813 , V_490 , V_614 , * ( T_2 * ) V_264 ) ;
V_810 += V_490 ;
V_614 += V_490 ;
V_95 -= V_490 ;
V_264 += V_490 ;
...
static void F_424 ( struct V_828 * V_829 , T_2 V_424 )
{
struct V_1 * V_2 = F_354 ( V_829 ) ;
V_2 -> V_5 . V_424 = V_424 ;
}
...
T_1 V_911 , T_2 * V_463 )
{
return F_103 ( F_354 ( V_829 ) , V_911 , V_463 ) ;
}
...
F_461 ( V_2 -> V_297 , V_2 -> V_5 . V_424 , false ) ;
...
static int F_480 ( struct V_997 * V_998 , unsigned long V_195 ,
void * V_38 )
{
struct V_994 * V_995 = V_38 ;
struct V_138 * V_138 ;
...
static int F_482 ( struct V_997 * V_1003 ,
...
static unsigned long F_493 ( void )
{
...
static void F_499 ( struct V_357 * V_358 )
{
struct V_138 * V_138 ;
struct V_1 * V_2 ;
int V_3 ;
...
static int F_500 ( struct V_997 * V_998 , unsigned long V_1024 ,
void * V_1025 )
{
struct V_225 * V_291 = & V_225 ;
...
static void F_519 ( struct V_138 * V_138 , unsigned long V_307 , int V_1043 )
{
...
F_525 ( V_16 , V_1053 , V_1054 , V_1055 , V_1056 ) ;
V_1057 = F_526 ( V_2 ) ;
if ( ! V_1057 ) {
V_16 &= 0xFFFFFFFF ;
V_1053 &= 0xFFFFFFFF ;
...
static int F_527 ( struct V_828 * V_829 )
{
struct V_1 * V_2 = F_354 ( V_829 ) ;
char V_1065 [ 3 ] ;
...
static int F_531 ( struct V_1 * V_2 , bool V_1074 )
{
int V_120 ;
if ( V_2 -> V_5 . V_68 . V_69 ) {
F_532 ( V_2 -> V_5 . V_68 . V_16 ,
V_2 -> V_5 . V_68 . V_71 ,
V_2 -> V_5 . V_68 . V_62 ) ;
...
V_902 = 1 ;
V_2 -> V_5 . V_626 += F_535 ( & V_2 -> V_5 . V_85 , 0 ) ;
V_2 -> V_5 . V_626 = F_338 ( V_2 -> V_5 . V_626 , V_902 ) ;
F_30 ( V_67 , V_2 ) ;
}
static T_1 F_536 ( struct V_814 * V_816 )
{
T_1 V_307 = 0 ;
...
static void F_537 ( struct V_1 * V_2 , char * V_1082 , int V_490 )
{
struct V_814 V_816 ;
int V_94 ;
F_346 ( V_2 , & V_816 , V_490 ) ;
F_538 ( T_1 , V_1082 , 0x7fa8 + V_490 * 4 , V_816 . V_896 ) ;
if ( V_490 < 3 )
V_94 = 0x7f84 + V_490 * 12 ;
else
V_94 = 0x7f2c + ( V_490 - 3 ) * 12 ;
F_538 ( T_1 , V_1082 , V_94 + 8 , V_816 . V_229 ) ;
F_538 ( T_1 , V_1082 , V_94 + 4 , V_816 . V_902 ) ;
F_538 ( T_1 , V_1082 , V_94 , F_536 ( & V_816 ) ) ;
}
static void F_539 ( struct V_1 * V_2 , char * V_1082 , int V_490 )
{
struct V_814 V_816 ;
int V_94 ;
V_867 V_307 ;
...
V_307 = F_536 ( & V_816 ) >> 8 ;
F_538 ( V_867 , V_1082 , V_94 , V_816 . V_896 ) ;
F_538 ( V_867 , V_1082 , V_94 + 2 , V_307 ) ;
F_538 ( T_1 , V_1082 , V_94 + 4 , V_816 . V_902 ) ;
F_538 ( T_2 , V_1082 , V_94 + 8 , V_816 . V_229 ) ;
}
static void F_540 ( struct V_1 * V_2 , char * V_1082 )
{
struct V_890 V_891 ;
struct V_814 V_816 ;
unsigned long V_195 ;
int V_3 ;
F_538 ( T_1 , V_1082 , 0x7ffc , F_61 ( V_2 ) ) ;
F_538 ( T_1 , V_1082 , 0x7ff8 , F_59 ( V_2 ) ) ;
F_538 ( T_1 , V_1082 , 0x7ff4 , F_443 ( V_2 ) ) ;
F_538 ( T_1 , V_1082 , 0x7ff0 , F_444 ( V_2 ) ) ;
for ( V_3 = 0 ; V_3 < 8 ; V_3 ++ )
F_538 ( T_1 , V_1082 , 0x7fd0 + V_3 * 4 , F_102 ( V_2 , V_3 ) ) ;
F_100 ( V_2 , 6 , & V_195 ) ;
F_538 ( T_1 , V_1082 , 0x7fcc , ( T_1 ) V_195 ) ;
F_100 ( V_2 , 7 , & V_195 ) ;
F_538 ( T_1 , V_1082 , 0x7fc8 , ( T_1 ) V_195 ) ;
F_346 ( V_2 , & V_816 , V_1083 ) ;
F_538 ( T_1 , V_1082 , 0x7fc4 , V_816 . V_896 ) ;
F_538 ( T_1 , V_1082 , 0x7f64 , V_816 . V_229 ) ;
F_538 ( T_1 , V_1082 , 0x7f60 , V_816 . V_902 ) ;
F_538 ( T_1 , V_1082 , 0x7f5c , F_536 ( & V_816 ) ) ;
F_346 ( V_2 , & V_816 , V_1084 ) ;
F_538 ( T_1 , V_1082 , 0x7fc0 , V_816 . V_896 ) ;
F_538 ( T_1 , V_1082 , 0x7f80 , V_816 . V_229 ) ;
F_538 ( T_1 , V_1082 , 0x7f7c , V_816 . V_902 ) ;
F_538 ( T_1 , V_1082 , 0x7f78 , F_536 ( & V_816 ) ) ;
V_73 -> V_892 ( V_2 , & V_891 ) ;
F_538 ( T_1 , V_1082 , 0x7f74 , V_891 . V_80 ) ;
F_538 ( T_1 , V_1082 , 0x7f70 , V_891 . V_491 ) ;
V_73 -> V_893 ( V_2 , & V_891 ) ;
F_538 ( T_1 , V_1082 , 0x7f58 , V_891 . V_80 ) ;
F_538 ( T_1 , V_1082 , 0x7f54 , V_891 . V_491 ) ;
for ( V_3 = 0 ; V_3 < 6 ; V_3 ++ )
F_537 ( V_2 , V_1082 , V_3 ) ;
F_538 ( T_1 , V_1082 , 0x7f14 , F_78 ( V_2 ) ) ;
F_538 ( T_1 , V_1082 , 0x7efc , 0x00020000 ) ;
F_538 ( T_1 , V_1082 , 0x7ef8 , V_2 -> V_5 . V_424 ) ;
}
...
F_538 ( T_2 , V_1082 , 0x7ff8 - V_3 * 8 , F_102 ( V_2 , V_3 ) ) ;
F_538 ( T_2 , V_1082 , 0x7f78 , F_444 ( V_2 ) ) ;
F_538 ( T_1 , V_1082 , 0x7f70 , F_443 ( V_2 ) ) ;
F_100 ( V_2 , 6 , & V_195 ) ;
F_538 ( T_2 , V_1082 , 0x7f68 , V_195 ) ;
F_100 ( V_2 , 7 , & V_195 ) ;
F_538 ( T_2 , V_1082 , 0x7f60 , V_195 ) ;
F_538 ( T_2 , V_1082 , 0x7f58 , F_61 ( V_2 ) ) ;
F_538 ( T_2 , V_1082 , 0x7f50 , F_59 ( V_2 ) ) ;
F_538 ( T_2 , V_1082 , 0x7f48 , F_78 ( V_2 ) ) ;
F_538 ( T_1 , V_1082 , 0x7f00 , V_2 -> V_5 . V_424 ) ;
F_538 ( T_1 , V_1082 , 0x7efc , 0x00020064 ) ;
F_538 ( T_2 , V_1082 , 0x7ed0 , V_2 -> V_5 . V_131 ) ;
F_346 ( V_2 , & V_816 , V_1083 ) ;
F_538 ( V_867 , V_1082 , 0x7e90 , V_816 . V_896 ) ;
F_538 ( V_867 , V_1082 , 0x7e92 , F_536 ( & V_816 ) >> 8 ) ;
F_538 ( T_1 , V_1082 , 0x7e94 , V_816 . V_902 ) ;
F_538 ( T_2 , V_1082 , 0x7e98 , V_816 . V_229 ) ;
V_73 -> V_893 ( V_2 , & V_891 ) ;
F_538 ( T_1 , V_1082 , 0x7e84 , V_891 . V_491 ) ;
F_538 ( T_2 , V_1082 , 0x7e88 , V_891 . V_80 ) ;
F_346 ( V_2 , & V_816 , V_1084 ) ;
F_538 ( V_867 , V_1082 , 0x7e70 , V_816 . V_896 ) ;
F_538 ( V_867 , V_1082 , 0x7e72 , F_536 ( & V_816 ) >> 8 ) ;
F_538 ( T_1 , V_1082 , 0x7e74 , V_816 . V_902 ) ;
F_538 ( T_2 , V_1082 , 0x7e78 , V_816 . V_229 ) ;
V_73 -> V_892 ( V_2 , & V_891 ) ;
F_538 ( T_1 , V_1082 , 0x7e64 , V_891 . V_491 ) ;
F_538 ( T_2 , V_1082 , 0x7e68 , V_891 . V_80 ) ;
for ( V_3 = 0 ; V_3 < 6 ; V_3 ++ )
F_539 ( V_2 , V_1082 , V_3 ) ;
#else
F_542 ( 1 ) ;
#endif
}
...
F_461 ( V_2 -> V_297 , V_2 -> V_5 . V_424 , true ) ;
V_2 -> V_5 . V_634 |= V_644 ;
memset ( V_1082 , 0 , 512 ) ;
if ( F_544 ( V_2 ) )
F_541 ( V_2 , V_1082 ) ;
...
F_540 ( V_2 , V_1082 ) ;
F_201 ( V_2 , V_2 -> V_5 . V_424 + 0xfe00 , V_1082 , sizeof( V_1082 ) ) ;
if ( V_73 -> V_628 ( V_2 ) )
V_2 -> V_5 . V_634 |= V_635 ;
else
V_73 -> V_643 ( V_2 , true ) ;
...
F_98 ( V_2 , 7 , V_198 ) ;
V_1085 . V_896 = ( V_2 -> V_5 . V_424 >> 4 ) & 0xffff ;
V_1085 . V_229 = V_2 -> V_5 . V_424 ;
V_1086 . V_896 = 0 ;
V_1086 . V_229 = 0 ;
...
{
T_2 V_1097 [ 4 ] ;
if ( ! F_547 ( V_2 -> V_5 . V_593 ) )
return;
F_548 ( V_2 -> V_5 . V_1098 , 256 ) ;
if ( V_765 ( V_2 -> V_138 ) )
F_549 ( V_2 , V_2 -> V_5 . V_1098 ) ;
else {
if ( V_2 -> V_5 . V_590 )
V_73 -> V_591 ( V_2 ) ;
F_550 ( V_2 , V_2 -> V_5 . V_1098 ) ;
}
F_551 ( ( V_175 * ) V_1097 , V_2 -> V_5 . V_1098 ,
F_552 ( V_2 ) -> V_1099 , 256 ) ;
...
if ( ! V_73 -> V_1102 )
return;
V_385 = F_555 ( V_2 -> V_138 , V_833 >> V_106 ) ;
if ( F_379 ( V_385 ) )
return;
V_73 -> V_1102 ( V_2 , F_556 ( V_385 ) ) ;
F_557 ( V_385 ) ;
}
void F_558 ( struct V_138 * V_138 ,
unsigned long V_80 )
{
if ( V_80 == F_559 ( V_138 , V_833 >> V_106 ) )
F_175 ( V_138 , V_1103 ) ;
}
...
if ( F_561 ( V_67 , V_2 ) || V_1074 ) {
F_568 ( V_2 ) ;
if ( V_2 -> V_5 . V_1040 == V_1132 ) {
V_120 = 1 ;
goto V_113;
}
if ( F_531 ( V_2 , V_1074 ) != 0 )
V_1104 = true ;
else {
if ( V_2 -> V_5 . V_626 )
V_73 -> V_1133 ( V_2 ) ;
...
F_431 ( V_2 ) ;
V_2 -> V_330 = V_1137 ;
F_230 ( & V_2 -> V_138 -> V_486 , V_2 -> V_1138 ) ;
F_571 () ;
F_332 () ;
...
F_333 () ;
F_434 () ;
V_2 -> V_1138 = F_229 ( & V_2 -> V_138 -> V_486 ) ;
V_120 = 1 ;
goto V_1135;
}
F_71 ( V_2 ) ;
...
F_578 ( 0 , 7 ) ;
F_578 ( V_2 -> V_5 . V_181 [ 0 ] , 0 ) ;
F_578 ( V_2 -> V_5 . V_181 [ 1 ] , 1 ) ;
F_578 ( V_2 -> V_5 . V_181 [ 2 ] , 2 ) ;
F_578 ( V_2 -> V_5 . V_181 [ 3 ] , 3 ) ;
F_578 ( V_2 -> V_5 . V_186 , 6 ) ;
V_2 -> V_5 . V_183 &= ~ V_184 ;
}
V_73 -> V_840 ( V_2 ) ;
...
unsigned long V_1066 = F_444 ( V_2 ) ;
F_583 ( V_1146 , ( void * ) V_1066 ) ;
}
if ( F_168 ( V_2 -> V_5 . V_273 ) )
F_30 ( V_338 , V_2 ) ;
if ( V_2 -> V_5 . V_1147 )
F_584 ( V_2 ) ;
...
static inline int F_585 ( struct V_138 * V_138 , struct V_1 * V_2 )
{
if ( ! F_586 ( V_2 ) &&
( ! V_73 -> V_1149 || V_73 -> V_1149 ( V_2 ) == 0 ) ) {
F_230 ( & V_138 -> V_486 , V_2 -> V_1138 ) ;
F_587 ( V_2 ) ;
V_2 -> V_1138 = F_229 ( & V_138 -> V_486 ) ;
if ( V_73 -> V_1150 )
V_73 -> V_1150 ( V_2 ) ;
if ( ! F_561 ( V_1151 , V_2 ) )
return 1 ;
...
static inline bool F_588 ( struct V_1 * V_2 )
{
...
static inline int F_594 ( struct V_1 * V_2 )
{
int V_120 ;
V_2 -> V_1138 = F_229 ( & V_2 -> V_138 -> V_486 ) ;
V_120 = F_595 ( V_2 , V_975 ) ;
F_230 ( & V_2 -> V_138 -> V_486 , V_2 -> V_1138 ) ;
if ( V_120 != V_942 )
return 0 ;
return 1 ;
...
int F_596 ( struct V_1 * V_2 , struct V_962 * V_962 )
{
struct V_1160 * V_1160 = & V_399 -> V_1161 . V_1160 ;
int V_120 ;
T_18 V_1162 ;
F_597 ( V_1160 ) ;
if ( V_2 -> V_1163 )
F_598 ( V_1164 , & V_2 -> V_1165 , & V_1162 ) ;
...
int (* F_599)( struct V_1 * ) = V_2 -> V_5 . V_987 ;
V_2 -> V_5 . V_987 = NULL ;
V_120 = F_599 ( V_2 ) ;
if ( V_120 <= 0 )
goto V_113;
...
F_529 ( V_2 ) ;
if ( V_2 -> V_1163 )
F_598 ( V_1164 , & V_1162 , NULL ) ;
return V_120 ;
}
int F_600 ( struct V_1 * V_2 , struct V_1168 * V_592 )
{
if ( V_2 -> V_5 . V_992 ) {
F_601 ( & V_2 -> V_5 . V_922 ) ;
V_2 -> V_5 . V_992 = false ;
...
int F_602 ( struct V_1 * V_2 , struct V_1168 * V_592 )
{
V_2 -> V_5 . V_936 = true ;
V_2 -> V_5 . V_992 = false ;
...
void F_603 ( struct V_1 * V_2 , int * V_182 , int * V_907 )
{
struct V_814 V_1085 ;
...
F_213 ( V_1209 , & V_2 -> V_5 . V_593 -> V_646 ) ;
} else
V_2 -> V_5 . V_1040 = V_1040 -> V_1040 ;
F_30 ( V_67 , V_2 ) ;
return 0 ;
}
int F_607 ( struct V_1 * V_2 , V_867 V_1210 , int V_1211 ,
int V_1212 , bool V_71 , T_1 V_62 )
{
struct V_828 * V_829 = & V_2 -> V_5 . V_922 ;
int V_108 ;
F_442 ( V_2 ) ;
V_108 = F_608 ( V_829 , V_1210 , V_1211 , V_1212 ,
V_71 , V_62 ) ;
if ( V_108 )
return V_941 ;
F_448 ( V_2 , V_829 -> V_925 ) ;
...
int F_614 ( struct V_1 * V_2 , struct V_1230 * V_1160 )
{
struct V_670 * V_669 =
& V_2 -> V_5 . V_652 . V_653 . V_669 ;
...
struct V_1 * F_626 ( struct V_138 * V_138 ,
unsigned int V_1250 )
{
struct V_1 * V_2 ;
if ( F_154 () && F_142 ( & V_138 -> V_293 ) != 0 )
F_387 ( V_869
L_28
L_29 ) ;
...
void F_629 ( struct V_1 * V_2 , bool V_1253 )
{
V_2 -> V_5 . V_634 = 0 ;
...
void F_635 ( struct V_1 * V_2 , T_14 V_41 )
{
struct V_814 V_1085 ;
F_346 ( V_2 , & V_1085 , V_1090 ) ;
V_1085 . V_896 = V_41 << 8 ;
...
if ( ! F_261 ( V_138 ) || F_641 ( V_2 ) )
V_2 -> V_5 . V_1040 = V_1154 ;
else
V_2 -> V_5 . V_1040 = V_1166 ;
V_385 = F_644 ( V_683 | V_1271 ) ;
if ( ! V_385 ) {
V_120 = - V_387 ;
goto V_1272;
}
V_2 -> V_5 . V_875 = F_645 ( V_385 ) ;
F_138 ( V_2 , V_1010 ) ;
V_120 = F_646 ( V_2 ) ;
if ( V_120 < 0 )
goto V_1273;
...
F_648 ( & V_1275 ) ;
V_2 -> V_5 . V_374 = F_291 ( V_438 * sizeof( T_2 ) * 4 ,
V_683 ) ;
if ( ! V_2 -> V_5 . V_374 ) {
V_120 = - V_387 ;
goto V_1276;
...
F_654 ( V_2 ) ;
V_1273:
F_655 ( ( unsigned long ) V_2 -> V_5 . V_875 ) ;
V_1272:
return V_120 ;
}
...
void F_660 ( struct V_1 * V_2 , int V_23 )
{
V_73 -> V_1282 ( V_2 , V_23 ) ;
}
int F_661 ( struct V_138 * V_138 , unsigned long type )
{
if ( type )
return - V_578 ;
F_662 ( & V_138 -> V_5 . V_1283 ) ;
F_663 ( & V_138 -> V_5 . V_1284 ) ;
F_663 ( & V_138 -> V_5 . V_1285 ) ;
F_663 ( & V_138 -> V_5 . V_1286 ) ;
F_172 ( & V_138 -> V_5 . V_1287 , 0 ) ;
F_213 ( V_760 , & V_138 -> V_5 . V_1288 ) ;
F_213 ( V_1289 ,
& V_138 -> V_5 . V_1288 ) ;
F_664 ( & V_138 -> V_5 . V_311 ) ;
F_665 ( & V_138 -> V_5 . V_1290 ) ;
F_666 ( & V_138 -> V_5 . V_325 ) ;
F_171 ( V_138 ) ;
F_667 ( & V_138 -> V_5 . V_361 , F_189 ) ;
F_667 ( & V_138 -> V_5 . V_363 , F_194 ) ;
F_668 ( V_138 ) ;
F_669 ( V_138 ) ;
if ( V_73 -> V_1291 )
return V_73 -> V_1291 ( V_138 ) ;
return 0 ;
}
...
static void F_671 ( struct V_138 * V_138 )
{
unsigned int V_3 ;
struct V_1 * V_2 ;
F_177 (i, vcpu, kvm) {
...
F_624 ( V_2 ) ;
F_300 ( & V_138 -> V_735 ) ;
for ( V_3 = 0 ; V_3 < F_142 ( & V_138 -> V_293 ) ; V_3 ++ )
V_138 -> V_1292 [ V_3 ] = NULL ;
F_172 ( & V_138 -> V_293 , 0 ) ;
F_302 ( & V_138 -> V_735 ) ;
}
void F_672 ( struct V_138 * V_138 )
{
F_673 ( & V_138 -> V_5 . V_363 ) ;
F_673 ( & V_138 -> V_5 . V_361 ) ;
F_674 ( V_138 ) ;
F_675 ( V_138 ) ;
}
int F_676 ( struct V_138 * V_138 , int V_1250 , T_6 V_389 , T_1 V_491 )
{
int V_3 , V_120 ;
unsigned long V_1293 ;
struct V_1294 * V_1295 = V_1294 ( V_138 ) ;
struct V_1296 * V_10 , V_862 ;
if ( F_28 ( V_1250 >= V_1297 ) )
return - V_578 ;
V_10 = F_677 ( V_1295 , V_1250 ) ;
if ( V_491 ) {
if ( V_10 -> V_1298 )
return - V_599 ;
V_1293 = F_678 ( NULL , 0 , V_491 , V_1299 | V_1300 ,
V_1301 | V_1302 , 0 ) ;
if ( F_199 ( ( void * ) V_1293 ) )
return F_200 ( ( void * ) V_1293 ) ;
} else {
if ( ! V_10 -> V_1298 )
return 0 ;
V_1293 = 0 ;
...
V_862 = * V_10 ;
for ( V_3 = 0 ; V_3 < V_1303 ; V_3 ++ ) {
struct V_1304 V_1305 ;
V_1305 . V_10 = V_1250 | ( V_3 << 16 ) ;
V_1305 . V_307 = 0 ;
V_1305 . V_1306 = V_389 ;
V_1305 . V_1307 = V_1293 ;
V_1305 . V_1308 = V_491 ;
V_120 = F_679 ( V_138 , & V_1305 ) ;
if ( V_120 < 0 )
return V_120 ;
}
if ( ! V_491 ) {
V_120 = F_680 ( V_862 . V_1307 , V_862 . V_1298 * V_107 ) ;
F_28 ( V_120 < 0 ) ;
}
return 0 ;
}
int F_681 ( struct V_138 * V_138 , int V_1250 , T_6 V_389 , T_1 V_491 )
{
int V_120 ;
F_300 ( & V_138 -> V_722 ) ;
V_120 = F_676 ( V_138 , V_1250 , V_389 , V_491 ) ;
F_302 ( & V_138 -> V_722 ) ;
return V_120 ;
}
void F_682 ( struct V_138 * V_138 )
{
if ( V_399 -> V_1309 == V_138 -> V_1309 ) {
F_681 ( V_138 , V_1310 , 0 , 0 ) ;
F_681 ( V_138 , V_1311 , 0 , 0 ) ;
F_681 ( V_138 , V_1312 , 0 , 0 ) ;
}
if ( V_73 -> V_1313 )
V_73 -> V_1313 ( V_138 ) ;
F_683 ( V_138 ) ;
F_202 ( V_138 -> V_5 . V_777 ) ;
F_202 ( V_138 -> V_5 . V_1314 ) ;
F_671 ( V_138 ) ;
F_202 ( F_684 ( V_138 -> V_5 . V_1315 , 1 ) ) ;
F_685 ( V_138 ) ;
}
void F_686 ( struct V_138 * V_138 , struct V_1296 * free ,
struct V_1296 * V_1316 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < V_1317 ; ++ V_3 ) {
if ( ! V_1316 || free -> V_5 . V_1318 [ V_3 ] != V_1316 -> V_5 . V_1318 [ V_3 ] ) {
F_687 ( free -> V_5 . V_1318 [ V_3 ] ) ;
free -> V_5 . V_1318 [ V_3 ] = NULL ;
}
if ( V_3 == 0 )
continue;
if ( ! V_1316 || free -> V_5 . V_1319 [ V_3 - 1 ] !=
V_1316 -> V_5 . V_1319 [ V_3 - 1 ] ) {
F_687 ( free -> V_5 . V_1319 [ V_3 - 1 ] ) ;
free -> V_5 . V_1319 [ V_3 - 1 ] = NULL ;
}
}
F_688 ( free , V_1316 ) ;
}
int F_689 ( struct V_138 * V_138 , struct V_1296 * V_10 ,
unsigned long V_1298 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < V_1317 ; ++ V_3 ) {
struct V_1320 * V_1321 ;
unsigned long V_1322 ;
int V_1323 ;
int V_761 = V_3 + 1 ;
V_1323 = F_690 ( V_10 -> V_1324 + V_1298 - 1 ,
V_10 -> V_1324 , V_761 ) + 1 ;
V_10 -> V_5 . V_1318 [ V_3 ] =
F_691 ( V_1323 * sizeof( * V_10 -> V_5 . V_1318 [ V_3 ] ) ) ;
if ( ! V_10 -> V_5 . V_1318 [ V_3 ] )
goto V_388;
if ( V_3 == 0 )
continue;
V_1321 = F_691 ( V_1323 * sizeof( * V_1321 ) ) ;
if ( ! V_1321 )
goto V_388;
V_10 -> V_5 . V_1319 [ V_3 - 1 ] = V_1321 ;
if ( V_10 -> V_1324 & ( F_692 ( V_761 ) - 1 ) )
V_1321 [ 0 ] . V_1325 = 1 ;
if ( ( V_10 -> V_1324 + V_1298 ) & ( F_692 ( V_761 ) - 1 ) )
V_1321 [ V_1323 - 1 ] . V_1325 = 1 ;
V_1322 = V_10 -> V_1307 >> V_106 ;
if ( ( V_10 -> V_1324 ^ V_1322 ) & ( F_692 ( V_761 ) - 1 ) ||
! F_693 () ) {
unsigned long V_805 ;
for ( V_805 = 0 ; V_805 < V_1323 ; ++ V_805 )
V_1321 [ V_805 ] . V_1325 = 1 ;
}
}
if ( F_694 ( V_10 , V_1298 ) )
goto V_388;
return 0 ;
V_388:
for ( V_3 = 0 ; V_3 < V_1317 ; ++ V_3 ) {
F_687 ( V_10 -> V_5 . V_1318 [ V_3 ] ) ;
V_10 -> V_5 . V_1318 [ V_3 ] = NULL ;
if ( V_3 == 0 )
continue;
F_687 ( V_10 -> V_5 . V_1319 [ V_3 - 1 ] ) ;
V_10 -> V_5 . V_1319 [ V_3 - 1 ] = NULL ;
}
return - V_387 ;
}
void F_695 ( struct V_138 * V_138 , struct V_1294 * V_1295 )
{
F_696 ( V_138 , V_1295 ) ;
}
int F_697 ( struct V_138 * V_138 ,
struct V_1296 * V_1326 ,
const struct V_1304 * V_1327 ,
enum V_1328 V_1329 )
{
return 0 ;
}
static void F_698 ( struct V_138 * V_138 ,
struct V_1296 * V_863 )
{
if ( V_863 -> V_307 & V_1330 ) {
F_699 ( V_138 , V_863 ) ;
return;
}
if ( V_863 -> V_307 & V_1331 ) {
if ( V_73 -> V_1332 )
V_73 -> V_1332 ( V_138 , V_863 ) ;
else
F_699 ( V_138 , V_863 ) ;
} else {
if ( V_73 -> V_1333 )
V_73 -> V_1333 ( V_138 , V_863 ) ;
}
}
void F_700 ( struct V_138 * V_138 ,
const struct V_1304 * V_1327 ,
const struct V_1296 * V_862 ,
const struct V_1296 * V_863 ,
enum V_1328 V_1329 )
{
int V_1334 = 0 ;
if ( ! V_138 -> V_5 . V_723 )
...
F_702 ( V_138 , V_863 ) ;
if ( V_1329 != V_1335 )
F_698 ( V_138 , (struct V_1296 * ) V_863 ) ;
}
void F_703 ( struct V_138 * V_138 )
{
F_704 ( V_138 ) ;
}
void F_705 ( struct V_138 * V_138 ,
struct V_1296 * V_10 )
{
F_704 ( V_138 ) ;
}
static inline bool F_706 ( struct V_1 * V_2 )
{
if ( ! F_707 ( & V_2 -> V_1336 . V_1337 ) )
return true ;
if ( F_708 ( V_2 ) )
return true ;
if ( V_2 -> V_5 . V_1152 . V_1153 )
return true ;
if ( F_142 ( & V_2 -> V_5 . V_85 ) )
return true ;
...
return F_588 ( V_2 ) || F_706 ( V_2 ) ;
}
int F_710 ( struct V_1 * V_2 )
{
return F_711 ( V_2 ) == V_1137 ;
}
...
bool F_712 ( struct V_1 * V_2 , unsigned long V_1338 )
{
return F_466 ( V_2 ) == V_1338 ;
}
...
{
if ( V_2 -> V_178 & V_964 &&
F_712 ( V_2 , V_2 -> V_5 . V_968 ) )
V_961 |= V_963 ;
V_73 -> V_1339 ( V_2 , V_961 ) ;
}
...
void F_713 ( struct V_1 * V_2 , struct V_1340 * V_358 )
{
int V_120 ;
...
return;
if ( ! V_2 -> V_5 . V_84 . V_953 &&
V_358 -> V_5 . V_104 != V_2 -> V_5 . V_84 . V_1342 ( V_2 ) )
return;
V_2 -> V_5 . V_84 . V_1343 ( V_2 , V_358 -> V_821 , 0 , true ) ;
}
static inline T_1 F_714 ( T_5 V_102 )
{
return F_715 ( V_102 & 0xffffffff , F_716 ( V_4 ) ) ;
}
static inline T_1 F_717 ( T_1 V_1344 )
{
return ( V_1344 + 1 ) & ( F_2 ( V_4 ) - 1 ) ;
}
static void F_718 ( struct V_1 * V_2 , T_5 V_102 )
{
T_1 V_1344 = F_714 ( V_102 ) ;
while ( V_2 -> V_5 . V_6 . V_7 [ V_1344 ] != ~ 0 )
V_1344 = F_717 ( V_1344 ) ;
V_2 -> V_5 . V_6 . V_7 [ V_1344 ] = V_102 ;
}
static T_1 F_719 ( struct V_1 * V_2 , T_5 V_102 )
{
int V_3 ;
T_1 V_1344 = F_714 ( V_102 ) ;
for ( V_3 = 0 ; V_3 < F_2 ( V_4 ) &&
( V_2 -> V_5 . V_6 . V_7 [ V_1344 ] != V_102 &&
V_2 -> V_5 . V_6 . V_7 [ V_1344 ] != ~ 0 ) ; V_3 ++ )
V_1344 = F_717 ( V_1344 ) ;
return V_1344 ;
}
bool F_720 ( struct V_1 * V_2 , T_5 V_102 )
{
return V_2 -> V_5 . V_6 . V_7 [ F_719 ( V_2 , V_102 ) ] == V_102 ;
}
static void F_721 ( struct V_1 * V_2 , T_5 V_102 )
{
T_1 V_3 , V_805 , V_1345 ;
V_3 = V_805 = F_719 ( V_2 , V_102 ) ;
while ( true ) {
V_2 -> V_5 . V_6 . V_7 [ V_3 ] = ~ 0 ;
do {
V_805 = F_717 ( V_805 ) ;
...
return;
V_1345 = F_714 ( V_2 -> V_5 . V_6 . V_7 [ V_805 ] ) ;
} while ( ( V_3 <= V_805 ) ? ( V_3 < V_1345 && V_1345 <= V_805 ) : ( V_3 < V_1345 || V_1345 <= V_805 ) );
V_2 -> V_5 . V_6 . V_7 [ V_3 ] = V_2 -> V_5 . V_6 . V_7 [ V_805 ] ;
V_3 = V_805 ;
}
}
static int F_722 ( struct V_1 * V_2 , T_1 V_195 )
{
...
{
struct V_75 V_76 ;
F_724 ( V_358 -> V_5 . V_1346 , V_358 -> V_821 ) ;
F_718 ( V_2 , V_358 -> V_5 . V_102 ) ;
if ( ! ( V_2 -> V_5 . V_6 . V_390 & V_391 ) ||
( V_2 -> V_5 . V_6 . V_392 &&
V_73 -> V_88 ( V_2 ) == 0 ) )
F_30 ( V_1113 , V_2 ) ;
else if ( ! F_722 ( V_2 , V_1347 ) ) {
V_76 . V_41 = V_42 ;
V_76 . V_923 = true ;
V_76 . V_62 = 0 ;
V_76 . V_81 = false ;
V_76 . V_80 = V_358 -> V_5 . V_1346 ;
F_36 ( V_2 , & V_76 ) ;
}
}
void F_725 ( struct V_1 * V_2 ,
struct V_1340 * V_358 )
{
struct V_75 V_76 ;
F_726 ( V_358 -> V_5 . V_1346 , V_358 -> V_821 ) ;
if ( V_358 -> V_1341 )
V_358 -> V_5 . V_1346 = ~ 0 ;
else
F_721 ( V_2 , V_358 -> V_5 . V_102 ) ;
if ( ( V_2 -> V_5 . V_6 . V_390 & V_391 ) &&
! F_722 ( V_2 , V_1348 ) ) {
V_76 . V_41 = V_42 ;
V_76 . V_923 = true ;
...
void F_728 ( struct V_138 * V_138 )
{
F_41 ( & V_138 -> V_5 . V_1349 ) ;
}
void F_729 ( struct V_138 * V_138 )
{
F_730 ( & V_138 -> V_5 . V_1349 ) ;
}
bool F_731 ( struct V_138 * V_138 )
{
return F_142 ( & V_138 -> V_5 . V_1349 ) ;
}
void F_732 ( struct V_138 * V_138 )
{
F_41 ( & V_138 -> V_5 . V_1287 ) ;
}
void F_733 ( struct V_138 * V_138 )
{
F_730 ( & V_138 -> V_5 . V_1287 ) ;
}
bool F_66 ( struct V_138 * V_138 )
{
return F_142 ( & V_138 -> V_5 . V_1287 ) ;
}
bool F_734 ( void )
{
return V_73 -> V_1350 != NULL ;
}
int F_735 ( struct V_1351 * V_1352 ,
struct V_1353 * V_1354 )
{
struct V_1355 * V_1356 =
F_4 ( V_1352 , struct V_1355 , V_1357 ) ;
V_1356 -> V_1358 = V_1354 ;
return V_73 -> V_1350 ( V_1356 -> V_138 ,
V_1354 -> V_595 , V_1356 -> V_1359 , 1 ) ;
}
void F_736 ( struct V_1351 * V_1352 ,
struct V_1353 * V_1354 )
{
int V_108 ;
struct V_1355 * V_1356 =
F_4 ( V_1352 , struct V_1355 , V_1357 ) ;
F_28 ( V_1356 -> V_1358 != V_1354 ) ;
V_1356 -> V_1358 = NULL ;
V_108 = V_73 -> V_1350 ( V_1356 -> V_138 , V_1354 -> V_595 , V_1356 -> V_1359 , 0 ) ;
if ( V_108 )
F_10 ( V_1360 L_30
L_31 , V_1356 -> V_1357 . V_1346 , V_108 ) ;
}
int F_737 ( struct V_138 * V_138 , unsigned int V_1361 ,
T_7 V_1362 , bool V_1363 )
{
if ( ! V_73 -> V_1350 )
return - V_578 ;
return V_73 -> V_1350 ( V_138 , V_1361 , V_1362 , V_1363 ) ;
}
bool F_738 ( void )
{
return V_1364 ;
