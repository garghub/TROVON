...
struct V_80 * V_81 )
{
F_24 ( V_81 -> V_82 , V_83 , sizeof( V_81 -> V_82 ) ) ;
F_24 ( V_81 -> V_84 , V_85 , sizeof( V_81 -> V_84 ) ) ;
F_24 ( V_81 -> V_86 , L_5 , sizeof( V_81 -> V_86 ) ) ;
F_24 ( V_81 -> V_87 , L_6 , sizeof( V_81 -> V_87 ) ) ;
}
static void F_25 ( struct V_1 * V_2 , struct V_88 * V_89 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
if ( V_8 && V_8 -> V_90 )
...
static int F_27 ( struct V_1 * V_2 , struct V_88 * V_89 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
...
return - V_52 ;
else if ( V_89 -> V_94 & V_93 && ! F_26 () )
return - V_52 ;
V_6 -> V_95 = V_89 -> V_94 ;
F_28 ( & V_2 -> V_96 , V_6 -> V_95 ) ;
return 0 ;
}
