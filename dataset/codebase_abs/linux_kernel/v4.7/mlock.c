...
static T_6 int F_80 ( unsigned long V_35 , T_5 V_66 , T_3 V_67 )
{
unsigned long V_73 ;
unsigned long V_74 ;
int error = - V_21 ;
...
for ( V_33 = V_56 -> V_51 -> V_85 ; V_33 ; V_33 = V_48 -> V_72 ) {
T_3 V_49 ;
V_49 = V_33 -> V_41 & V_42 ;
V_49 |= V_79 ;
...
int F_87 ( T_5 V_86 , struct V_87 * V_88 )
{
unsigned long V_74 , V_73 ;
int V_89 = 0 ;
V_73 = ( V_86 + V_40 - 1 ) >> V_59 ;
V_74 = F_2 ( V_1 ) ;
if ( V_74 == V_90 )
V_89 = 1 ;
V_74 >>= V_59 ;
...
void F_91 ( T_5 V_86 , struct V_87 * V_88 )
{
F_88 ( & V_91 ) ;
V_88 -> V_92 -= ( V_86 + V_40 - 1 ) >> V_59 ;
F_90 ( & V_91 ) ;
F_92 ( V_88 ) ;
}
