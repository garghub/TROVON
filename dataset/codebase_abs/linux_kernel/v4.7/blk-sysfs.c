...
static T_1
F_53 ( struct V_47 * V_48 , struct V_49 * V_50 , char * V_2 )
{
struct V_51 * V_52 = F_54 ( V_50 ) ;
struct V_8 * V_9 =
F_55 ( V_48 , struct V_8 , V_48 ) ;
T_1 V_53 ;
if ( ! V_52 -> V_54 )
return - V_55 ;
F_56 ( & V_9 -> V_56 ) ;
...
static T_1
F_59 ( struct V_47 * V_48 , struct V_49 * V_50 ,
...
static void F_60 ( struct V_60 * V_60 )
{
struct V_8 * V_9 = F_55 ( V_60 , struct V_8 ,
V_60 ) ;
F_61 ( V_61 , V_9 ) ;
}
...
int F_75 ( struct V_69 * V_70 )
{
int V_12 ;
struct V_71 * V_72 = F_76 ( V_70 ) ;
...
if ( V_12 )
return V_12 ;
V_12 = F_83 ( & V_9 -> V_48 , F_84 ( & V_72 -> V_48 ) , L_8 , L_9 ) ;
if ( V_12 < 0 ) {
F_85 ( V_72 ) ;
return V_12 ;
}
