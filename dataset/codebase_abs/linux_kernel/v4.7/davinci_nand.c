...
V_5 -> V_4 . V_43 . V_139 = V_91 -> V_101 ;
break;
default:
return - V_66 ;
}
if ( V_91 -> V_101 == 4 ) {
int V_140 = V_3 -> V_141 / 512 ;
if ( ! V_140 || V_3 -> V_85 < 16 ) {
F_57 ( & V_88 -> V_89 , L_19 ) ;
V_111 = - V_66 ;
goto V_130;
}
if ( V_140 == 1 ) {
F_62 ( V_3 , & V_142 ) ;
} else if ( V_140 == 4 || V_140 == 8 ) {
F_62 ( V_3 , & V_143 ) ;
V_5 -> V_4 . V_43 . V_29 = V_144 ;
} else {
V_111 = - V_145 ;
goto V_130;
}
