...
V_11 [ 2 ] = 0x7f ;
for ( V_61 = 0 ; V_61 < sizeof( V_11 ) ; V_61 ++ ) {
V_7 = F_2 ( V_54 + V_61 ) ;
if ( F_22 ( V_4 , V_7 , V_11 [ V_61 ] ) < 0 ) {
F_6 ( V_15 , L_10 ) ;
return - V_16 ;
}
}
...
static int F_25 ( struct V_47 * V_15 , struct V_62 * V_63 )
{
int V_64 , V_39 , V_40 ;
V_64 = F_17 ( F_19 ( V_15 ) , & V_39 , & V_40 ) ;
if ( V_64 == 0 ) {
F_26 ( V_63 , L_12 ,
V_39 / 1000 , V_39 % 1000 ) ;
F_26 ( V_63 , L_13 , V_40 ) ;
...
struct V_65 * V_66 , char * V_11 )
{
int V_64 , V_40 ;
V_64 = F_17 ( F_19 ( V_15 ) , NULL , & V_40 ) ;
if ( V_64 )
return V_64 ;
...
int V_7 , V_61 , V_69 = 0 ;
if ( V_1 -> type == V_70 ) {
if ( V_1 -> V_18 [ V_59 ] & V_71 )
return V_69 ;
V_1 -> V_18 [ V_59 ] |= V_71 ;
} else {
if ( ! ( V_1 -> V_18 [ V_59 ] & V_72 ) )
return V_69 ;
V_1 -> V_18 [ V_59 ] &= ~ V_72 ;
}
V_7 = F_2 ( V_49 ) ;
V_11 [ 0 ] = V_1 -> V_18 [ V_49 ] ;
V_11 [ 1 ] = V_1 -> V_18 [ V_59 ] ;
switch ( V_1 -> type ) {
case V_73 :
case V_74 :
V_11 [ 1 ] |= V_75 ;
...
for ( V_61 = 0 ; V_61 < sizeof( V_11 ) ; V_61 ++ ) {
V_7 = F_2 ( V_49 + V_61 ) ;
V_69 = F_22 ( V_1 -> V_4 , V_7 , V_11 [ V_61 ] ) ;
if ( F_34 ( V_69 < 0 ) )
return V_69 ;
}
V_1 -> V_18 [ V_49 ] = V_11 [ 0 ] ;
V_1 -> V_18 [ V_59 ] = V_11 [ 1 ] ;
return 0 ;
}
