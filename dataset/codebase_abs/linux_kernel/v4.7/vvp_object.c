...
V_76 -> V_15 = V_50 -> V_51 ;
V_76 -> V_17 = 0 ;
F_32 ( & V_76 -> V_77 , sizeof( struct V_78 ) ) ;
return 0 ;
}
static int F_33 ( const struct V_8 * V_9 , struct V_12 * V_2 ,
const struct V_79 * V_50 )
{
struct V_80 * V_81 = F_34 ( V_2 -> V_82 ) ;
...
static void F_38 ( const struct V_8 * V_9 , struct V_12 * V_2 )
{
struct V_14 * V_76 = F_6 ( V_2 ) ;
F_39 ( V_2 ) ;
F_40 ( V_2 -> V_91 ) ;
...
struct V_14 * F_42 ( struct V_3 * V_3 )
{
struct V_4 * V_5 = F_3 ( V_3 ) ;
struct V_1 * V_2 = V_5 -> V_7 ;
struct V_12 * V_95 ;
V_95 = F_43 ( V_2 -> V_68 . V_91 , & V_96 ) ;
F_44 ( V_95 ) ;
return F_6 ( V_95 ) ;
}
struct V_12 * F_45 ( const struct V_8 * V_9 ,
...
V_101 = & V_76 -> V_102 ;
F_47 ( V_101 ) ;
V_101 -> V_103 = F_48 ( sizeof( struct V_104 ) ) ;
F_49 ( V_2 , & V_101 -> V_105 , V_81 ) ;
F_50 ( & V_101 -> V_105 , V_2 ) ;
