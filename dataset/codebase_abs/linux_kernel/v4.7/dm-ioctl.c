...
unsigned V_205 ;
V_205 = F_137 () ;
V_195 = F_138 ( V_194 -> V_54 , V_201 | V_206 | V_207 , V_208 ) ;
F_139 ( V_205 ) ;
if ( V_195 )
* V_190 |= V_193 ;
}
...
static int F_142 ( T_7 V_209 , struct V_40 T_6 * V_185 )
{
int V_88 = 0 ;
int V_165 ;
int V_190 ;
...
V_88 = - V_186 ;
V_66:
F_134 ( V_41 , V_211 , V_190 ) ;
return V_88 ;
}
static long F_146 ( struct V_216 * V_216 , T_7 V_209 , T_8 V_217 )
{
return ( long ) F_142 ( V_209 , (struct V_40 T_6 * ) V_217 ) ;
}
static long F_147 ( struct V_216 * V_216 , T_7 V_209 , T_8 V_217 )
{
return ( long ) F_146 ( V_216 , V_209 , ( T_8 ) F_148 ( V_217 ) ) ;
}
int T_9 F_149 ( void )
{
int V_88 ;
