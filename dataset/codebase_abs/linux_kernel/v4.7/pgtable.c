...
if ( V_54 )
F_63 ( V_45 -> V_50 , V_53 , V_46 ) ;
return V_54 ;
}
int F_70 ( struct V_44 * V_45 ,
...
unsigned long V_3 , T_1 * V_46 )
{
return F_67 ( V_45 , V_3 , V_46 ) ;
}
int F_73 ( struct V_44 * V_45 ,
unsigned long V_3 , T_4 * V_51 )
{
int V_56 ;
F_66 ( V_3 & ~ V_52 ) ;
V_56 = F_70 ( V_45 , V_3 , V_51 ) ;
if ( V_56 )
F_74 ( V_45 , V_3 , V_3 + V_57 ) ;
return V_56 ;
}
void T_3 F_75 ( unsigned long V_58 )
{
#ifdef F_76
F_77 ( V_59 > 0 ) ;
V_60 = F_78 ( - V_58 , 1 << V_61 ) - V_62 ;
F_79 ( V_63 L_3 ,
- V_58 , V_60 + V_62 ) ;
#endif
}
void F_80 ( enum V_64 V_65 , T_1 V_6 )
{
unsigned long V_3 = F_81 ( V_65 ) ;
if ( V_65 >= V_66 ) {
F_82 () ;
return;
}
...
void F_84 ( enum V_64 V_65 , T_7 V_67 ,
T_8 V_68 )
{
F_80 ( V_65 , F_85 ( V_67 >> V_14 , V_68 ) ) ;
}
int F_86 ( T_5 * V_16 , T_7 V_53 , T_8 V_69 )
{
T_9 V_70 , V_71 ;
V_70 = F_87 ( V_53 , V_53 + V_72 , & V_71 ) ;
if ( ( V_70 != V_73 ) && ( ! V_71 ) &&
( V_70 != V_74 ) )
return 0 ;
V_69 = F_88 ( V_69 ) ;
...
int F_92 ( T_4 * V_13 , T_7 V_53 , T_8 V_69 )
{
T_9 V_70 , V_71 ;
V_70 = F_87 ( V_53 , V_53 + V_77 , & V_71 ) ;
if ( ( V_70 != V_73 ) && ( ! V_71 ) &&
( V_70 != V_74 ) ) {
F_93 ( L_4 ,
V_78 , V_53 , V_53 + V_77 ) ;
