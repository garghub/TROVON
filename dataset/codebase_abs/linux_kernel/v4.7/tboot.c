...
static int F_42 ( struct V_84 * V_85 , unsigned long V_86 ,
void * V_87 )
{
switch ( V_86 ) {
case V_88 :
...
static T_12 F_45 ( struct V_92 * V_92 , char T_13 * V_93 , T_14 V_94 , T_15 * V_95 )
{
void T_16 * V_96 ;
T_11 V_97 [ 16 ] ;
T_7 V_98 ;
void * V_99 ;
int V_100 = - V_101 ;
V_96 = F_46 ( V_102 , V_103 ) ;
if ( ! V_96 )
return V_100 ;
F_47 ( V_97 , V_96 , sizeof( V_97 ) ) ;
if ( memcmp ( & V_104 , V_97 , sizeof( V_97 ) ) )
goto V_105;
V_98 = F_48 ( V_96 + V_106 ) ;
if ( * V_95 >= V_98 ) {
V_100 = 0 ;
goto V_105;
}
if ( * V_95 + V_94 > V_98 )
V_94 = V_98 - * V_95 ;
V_99 = F_49 ( V_94 , V_107 ) ;
if ( ! V_99 ) {
V_100 = - V_108 ;
goto V_105;
}
F_47 ( V_99 , V_96 + V_109 + * V_95 , V_94 ) ;
if ( F_50 ( V_93 , V_99 , V_94 ) )
goto V_110;
* V_95 += V_94 ;
V_100 = V_94 ;
V_110:
...
struct V_115 * F_60 ( struct V_115 * V_116 )
{
void * V_117 , * V_118 , * V_119 ;
if ( ! F_32 () )
return V_116 ;
V_119 = F_61 ( V_120 , V_121 *
V_24 ) ;
if ( ! V_119 )
return NULL ;
V_117 = F_61 ( * ( V_122 * ) ( V_119 + V_123 ) ,
* ( V_122 * ) ( V_119 + V_124 ) ) ;
F_52 ( V_119 ) ;
if ( ! V_117 )
return NULL ;
