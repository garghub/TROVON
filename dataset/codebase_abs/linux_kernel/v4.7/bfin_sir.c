...
#else
if ( F_68 ( V_28 -> V_20 , F_38 , 0 , L_6 , V_47 ) ) {
F_62 ( & V_47 -> V_47 , L_7 ) ;
return - V_88 ;
}
if ( F_68 ( V_28 -> V_20 + 1 , F_41 , 0 , L_8 , V_47 ) ) {
F_62 ( & V_47 -> V_47 , L_9 ) ;
F_69 ( V_28 -> V_20 , V_47 ) ;
return - V_88 ;
}
...
static int F_82 ( struct V_101 * V_102 , struct V_46 * V_47 )
{
struct V_48 * V_49 = F_29 ( V_47 ) ;
int V_32 = F_83 ( V_102 ) ;
F_84 ( V_47 ) ;
...
V_49 -> V_55 . V_56 = F_86 ( V_102 , V_49 -> V_55 . V_57 , V_49 -> V_55 . V_103 ) ;
F_87 ( & V_49 -> V_98 ) ;
F_88 ( V_102 ) ;
return 0 ;
}
static int F_89 ( struct V_46 * V_47 , struct V_104 * V_104 , int V_105 )
{
...
static struct V_116 * F_92 ( struct V_46 * V_47 )
{
struct V_48 * V_49 = F_29 ( V_47 ) ;
return & V_49 -> V_58 ;
}
...
V_49 -> V_32 = 9600 ;
F_94 ( & V_49 -> V_67 ) ;
V_117 = F_60 ( V_28 , V_47 ) ;
if ( V_117 )
goto V_118;
F_16 ( V_28 , 9600 ) ;
V_49 -> V_119 = F_95 ( V_47 , & V_49 -> V_120 , V_121 ) ;
if ( ! V_49 -> V_119 ) {
V_117 = - V_122 ;
goto V_123;
}
...
static int F_100 ( T_4 * V_125 , int V_126 )
{
V_125 -> V_61 = F_101 ( V_126 , V_127 ) ;
if ( ! V_125 -> V_61 )
return - V_122 ;
V_125 -> V_103 = V_126 ;
V_125 -> V_128 = FALSE ;
V_125 -> V_52 = V_53 ;
V_125 -> V_57 = V_125 -> V_61 ;
return 0 ;
}
...
struct V_6 * V_50 ;
int V_117 ;
if ( V_9 -> V_130 >= 0 && V_9 -> V_130 < F_103 ( V_131 ) && \
V_131 [ V_9 -> V_130 ] [ 3 ] == V_9 -> V_130 ) {
V_117 = F_104 ( V_131 [ V_9 -> V_130 ] , V_121 ) ;
if ( V_117 )
return V_117 ;
} else {
F_105 ( & V_9 -> V_47 , L_11 ) ;
...
V_117 = - V_122 ;
V_50 = F_101 ( sizeof( * V_50 ) , V_127 ) ;
if ( ! V_50 )
goto V_133;
F_3 ( V_50 , V_9 ) ;
V_47 = F_106 ( sizeof( * V_49 ) ) ;
if ( ! V_47 )
goto V_134;
V_49 = F_29 ( V_47 ) ;
V_49 -> V_47 = & V_9 -> V_47 ;
V_49 -> V_50 = V_50 ;
V_50 -> V_47 = V_47 ;
V_117 = F_100 ( & V_49 -> V_51 , V_135 ) ;
if ( V_117 )
goto V_136;
V_117 = F_100 ( & V_49 -> V_55 , V_137 ) ;
if ( V_117 )
goto V_138;
V_47 -> V_139 = & V_140 ;
V_47 -> V_20 = V_50 -> V_20 ;
...
V_49 -> V_120 . V_147 . V_148 &= V_129 ;
V_49 -> V_120 . V_149 . V_148 = 1 ;
F_108 ( & V_49 -> V_120 ) ;
V_117 = F_109 ( V_47 ) ;
if ( V_117 ) {
F_110 ( V_49 -> V_55 . V_61 ) ;
V_138:
F_110 ( V_49 -> V_51 . V_61 ) ;
V_136:
F_111 ( V_47 ) ;
V_134:
F_110 ( V_50 ) ;
V_133:
F_112 ( V_131 [ V_9 -> V_130 ] ) ;
} else
F_113 ( V_9 , V_50 ) ;
return V_117 ;
}
