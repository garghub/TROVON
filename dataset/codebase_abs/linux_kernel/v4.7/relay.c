...
static T_6 F_95 ( struct V_26 * V_27 ,
char T_9 * V_149 ,
T_2 V_138 ,
T_7 * V_147 )
{
...
static void F_96 ( struct V_3 * V_150 , int V_67 )
{
V_150 -> V_67 += V_67 ;
if ( V_150 -> V_67 >= V_150 -> V_6 -> V_95 ) {
F_73 ( V_150 -> V_6 , V_150 -> V_51 , 1 ) ;
...
{
struct V_3 * V_150 ;
V_150 = (struct V_3 * ) F_98 ( V_4 -> V_12 ) ;
F_96 ( V_150 , V_4 -> V_154 ) ;
}
static void F_99 ( struct V_155 * V_156 , unsigned int V_38 )
{
}
static T_6 F_100 ( struct V_26 * V_157 ,
T_7 * V_147 ,
struct V_151 * V_152 ,
T_2 V_158 ,
unsigned int V_107 ,
...
T_2 V_140 = ( T_2 ) F_101 ( V_165 , V_29 ) ;
...
static T_6 F_106 ( struct V_26 * V_157 ,
T_7 * V_147 ,
struct V_151 * V_152 ,
T_2 V_158 ,
unsigned int V_107 )
...
V_180 = 0 ;
while ( V_158 && ! V_180 ) {
V_143 = F_100 ( V_157 , V_147 , V_152 , V_158 , V_107 , & V_159 ) ;
if ( V_143 < 0 )
break;
else if ( ! V_143 ) {
if ( V_107 & V_181 )
