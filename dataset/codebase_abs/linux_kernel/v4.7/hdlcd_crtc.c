...
if ( ! V_79 -> V_12 -> V_13 )
return;
F_27 ( V_79 -> V_12 -> V_13 -> V_7 , & V_87 , & V_88 ) ;
V_81 = V_79 -> V_12 -> V_81 >> 16 ;
V_82 = V_79 -> V_12 -> V_82 >> 16 ;
V_89 = V_79 -> V_12 -> V_83 ;
V_90 = V_79 -> V_12 -> V_84 ;
V_86 = F_28 ( V_79 -> V_12 -> V_13 , 0 ) ;
...
static struct V_78 * F_32 ( struct V_102 * V_103 )
{
struct V_3 * V_4 = V_103 -> V_97 ;
struct V_78 * V_79 = NULL ;
T_2 V_104 [ F_6 ( V_14 ) ] , V_10 ;
int V_105 ;
V_79 = F_33 ( V_103 -> V_76 , sizeof( * V_79 ) , V_106 ) ;
if ( ! V_79 )
return F_34 ( - V_107 ) ;
for ( V_10 = 0 ; V_10 < F_6 ( V_14 ) ; V_10 ++ )
V_104 [ V_10 ] = V_14 [ V_10 ] . V_15 ;
V_105 = F_35 ( V_103 , V_79 , 0xff , & V_108 ,
V_104 , F_6 ( V_104 ) ,
V_109 , NULL ) ;
if ( V_105 ) {
F_36 ( V_103 -> V_76 , V_79 ) ;
return F_34 ( V_105 ) ;
}
F_37 ( V_79 , & V_110 ) ;
V_4 -> V_79 = V_79 ;
...
if ( F_39 ( V_11 ) )
return F_40 ( V_11 ) ;
V_105 = F_41 ( V_103 , & V_4 -> V_2 , V_11 , NULL ,
& V_111 , NULL ) ;
if ( V_105 ) {
F_29 ( V_11 ) ;
F_36 ( V_103 -> V_76 , V_11 ) ;
return V_105 ;
}
F_42 ( & V_4 -> V_2 , & V_112 ) ;
return 0 ;
