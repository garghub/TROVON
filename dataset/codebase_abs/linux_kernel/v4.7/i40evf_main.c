...
static int F_66 ( struct V_28 * V_29 , void * V_125 )
{
struct V_7 * V_8 = F_15 ( V_29 ) ;
struct V_1 * V_2 = & V_8 -> V_2 ;
struct V_121 * V_107 ;
...
F_71 (f, ftmp, &adapter->mac_filter_list, list) {
F_70 (mca, netdev)
...
static int
F_86 ( struct V_7 * V_8 , int V_163 )
{
int V_87 , V_164 ;
V_164 = V_165 ;
V_87 = F_87 ( V_8 -> V_12 , V_8 -> V_33 ,
V_164 , V_163 ) ;
if ( V_87 < 0 ) {
...
{
int V_39 ;
V_8 -> V_75 = F_90 ( V_8 -> V_82 ,
sizeof( struct V_63 ) , V_16 ) ;
if ( ! V_8 -> V_75 )
goto V_167;
V_8 -> V_65 = F_90 ( V_8 -> V_82 ,
sizeof( struct V_63 ) , V_16 ) ;
if ( ! V_8 -> V_65 )
goto V_167;
for ( V_39 = 0 ; V_39 < V_8 -> V_82 ; V_39 ++ ) {
...
V_174 = V_8 -> V_82 ;
V_173 = F_92 ( int , V_174 , ( int ) ( F_93 () * 2 ) ) + V_88 ;
V_173 = F_92 ( int , V_173 , ( int ) V_8 -> V_175 -> V_176 ) ;
V_8 -> V_33 = F_90 ( V_173 ,
...
V_181 = F_97 ( V_2 , V_8 -> V_67 . V_183 , V_180 ) ;
if ( V_181 ) {
F_43 ( & V_8 -> V_12 -> V_13 , L_12 ,
F_98 ( V_2 , V_181 ) ,
F_99 ( V_2 , V_2 -> V_184 . V_185 ) ) ;
return V_181 ;
}
V_181 = F_100 ( V_2 , V_8 -> V_67 . V_183 , false ,
V_8 -> V_186 , V_8 -> V_187 ) ;
if ( V_181 ) {
...
F_17 ( V_2 , F_102 ( V_39 ) , V_188 [ V_39 ] ) ;
V_188 = ( T_3 * ) V_8 -> V_186 ;
...
V_8 -> V_194 = V_196 ;
F_17 ( V_2 , F_110 ( 0 ) , ( T_3 ) V_8 -> V_194 ) ;
F_17 ( V_2 , F_110 ( 1 ) , ( T_3 ) ( V_8 -> V_194 >> 32 ) ) ;
}
F_108 ( V_8 ) ;
F_111 ( ( void * ) V_8 -> V_180 , V_8 -> V_189 ) ;
V_181 = F_105 ( V_8 ) ;
return V_181 ;
}
...
struct V_54 * V_55 ;
V_197 = V_8 -> V_40 - V_88 ;
V_8 -> V_62 = F_90 ( V_197 , sizeof( * V_55 ) ,
V_16 ) ;
if ( ! V_8 -> V_62 )
return - V_120 ;
...
static void F_120 ( unsigned long V_48 )
{
...
F_142 ( & V_8 -> V_155 , V_156 + ( V_225 * 2 ) ) ;
F_13 ( & V_8 -> V_52 ) ;
}
static void F_144 ( struct V_205 * V_206 )
{
struct V_7 * V_8 = F_122 ( V_206 ,
struct V_7 ,
V_27 ) ;
...
F_71 (f, ftmp, &adapter->mac_filter_list,
list) {
F_154 ( & V_107 -> V_112 ) ;
F_9 ( V_107 ) ;
}
F_71 (fv, fvtmp, &adapter->vlan_filter_list,
list) {
F_154 ( & V_230 -> V_112 ) ;
F_9 ( V_230 ) ;
}
...
do {
V_181 = F_161 ( V_2 , & V_235 , & V_239 ) ;
if ( V_181 || ! V_237 -> V_244 )
break;
F_162 ( V_8 , V_237 -> V_244 ,
...
static struct V_260 * F_168 ( struct V_28 * V_29 )
{
struct V_7 * V_8 = F_15 ( V_29 ) ;
return & V_8 -> V_261 ;
}
static int F_169 ( struct V_28 * V_29 , int V_262 )
{
struct V_7 * V_8 = F_15 ( V_29 ) ;
...
static T_10 F_170 ( struct V_28 * V_29 ,
T_10 V_269 )
{
struct V_7 * V_8 = F_15 ( V_29 ) ;
V_269 &= ~ V_270 ;
...
static void F_174 ( struct V_205 * V_206 )
{
struct V_7 * V_8 = F_122 ( V_206 ,
struct V_7 ,
V_213 . V_206 ) ;
...
F_180 ( & V_8 -> V_155 ) ;
V_8 -> V_155 . V_344 = & F_120 ;
V_8 -> V_155 . V_48 = ( unsigned long ) V_8 ;
F_142 ( & V_8 -> V_155 , V_156 + 1 ) ;
V_8 -> V_82 = F_92 ( int ,
V_8 -> V_166 -> V_345 ,
( int ) ( F_93 () ) ) ;
V_8 -> V_169 = V_346 ;
...
F_145 ( V_2 ) ;
V_8 -> V_93 = V_212 ;
F_123 ( & V_8 -> V_213 , V_225 * 5 ) ;
return;
}
F_123 ( & V_8 -> V_213 , V_225 ) ;
}
static void F_182 ( struct V_318 * V_12 )
{
struct V_28 * V_29 = F_183 ( V_12 ) ;
struct V_7 * V_8 = F_15 ( V_29 ) ;
F_184 ( V_29 ) ;
if ( F_150 ( V_29 ) )
F_159 ( V_29 ) ;
...
static int F_188 ( struct V_318 * V_12 , const struct V_357 * V_358 )
{
struct V_28 * V_29 ;
struct V_7 * V_8 = NULL ;
struct V_1 * V_2 = NULL ;
...
if ( V_87 )
return V_87 ;
V_87 = F_190 ( & V_12 -> V_13 , F_191 ( 64 ) ) ;
if ( V_87 ) {
V_87 = F_190 ( & V_12 -> V_13 , F_191 ( 32 ) ) ;
if ( V_87 ) {
F_43 ( & V_12 -> V_13 ,
L_52 , V_87 ) ;
goto V_359;
...
F_193 ( V_12 ) ;
F_149 ( V_12 ) ;
V_29 = F_194 ( sizeof( struct V_7 ) , V_362 ) ;
if ( ! V_29 ) {
V_87 = - V_120 ;
goto V_363;
}
F_195 ( V_29 , & V_12 -> V_13 ) ;
F_196 ( V_12 , V_29 ) ;
V_8 = F_15 ( V_29 ) ;
V_8 -> V_29 = V_29 ;
V_8 -> V_12 = V_12 ;
...
F_200 ( V_12 , V_371 , & V_2 -> V_372 ) ;
V_2 -> V_373 = V_12 -> V_374 ;
V_2 -> V_375 = V_12 -> V_376 ;
V_2 -> V_377 . V_370 = F_201 ( V_12 -> V_378 ) ;
V_2 -> V_377 . V_379 = F_202 ( V_12 -> V_378 ) ;
F_203 ( & V_2 -> V_184 . V_380 ) ;
F_203 ( & V_2 -> V_184 . V_381 ) ;
F_55 ( & V_8 -> V_123 ) ;
F_55 ( & V_8 -> V_113 ) ;
F_204 ( & V_8 -> V_27 , F_144 ) ;
F_204 ( & V_8 -> V_52 , F_160 ) ;
F_204 ( & V_8 -> V_204 , F_121 ) ;
F_205 ( & V_8 -> V_213 , F_174 ) ;
F_123 ( & V_8 -> V_213 ,
F_143 ( 5 * ( V_12 -> V_378 & 0x07 ) ) ) ;
return 0 ;
V_366:
F_206 ( V_29 ) ;
V_363:
...
static int F_208 ( struct V_318 * V_12 , T_11 V_93 )
{
struct V_28 * V_29 = F_183 ( V_12 ) ;
struct V_7 * V_8 = F_15 ( V_29 ) ;
int V_382 = 0 ;
...
static int F_211 ( struct V_318 * V_12 )
{
struct V_7 * V_8 = F_183 ( V_12 ) ;
struct V_28 * V_29 = V_8 -> V_29 ;
T_3 V_87 ;
F_212 ( V_12 , V_383 ) ;
F_213 ( V_12 ) ;
...
static void F_216 ( struct V_318 * V_12 )
{
struct V_28 * V_29 = F_183 ( V_12 ) ;
struct V_7 * V_8 = F_15 ( V_29 ) ;
struct V_121 * V_107 , * V_135 ;
...
F_145 ( V_2 ) ;
F_222 ( & V_2 -> V_184 . V_381 ) ;
F_222 ( & V_2 -> V_184 . V_380 ) ;
F_223 ( V_2 -> V_102 ) ;
F_207 ( V_12 ) ;
F_152 ( V_8 ) ;
F_153 ( V_8 ) ;
...
F_71 (f, ftmp, &adapter->vlan_filter_list, list) {
F_154 ( & V_107 -> V_112 ) ;
F_9 ( V_107 ) ;
}
F_206 ( V_29 ) ;
