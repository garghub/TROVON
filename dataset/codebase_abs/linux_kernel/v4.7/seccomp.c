...
if ( F_62 ( V_123 == V_124 ) )
return 0 ;
else if ( F_62 ( V_123 == V_125 ) )
return - 1 ;
else
return F_63 ( V_123 ) ;
}
static T_2 F_64 ( int V_116 , struct V_1 * V_2 )
{
T_2 V_126 , V_127 ;
int V_128 ;
F_65 () ;
...
static long F_79 ( unsigned int V_96 ,
const char T_4 * V_12 )
{
...
F_78 ( & V_5 -> V_64 -> V_65 ) ;
if ( V_96 & V_100 )
F_83 ( & V_5 -> signal -> V_72 ) ;
V_139:
F_47 ( V_137 ) ;
return V_53 ;
}
static inline long F_79 ( unsigned int V_96 ,
const char T_4 * V_12 )
{
return - V_22 ;
}
static long F_84 ( unsigned int V_140 , unsigned int V_96 ,
const char T_4 * V_141 )
{
switch ( V_140 ) {
case V_142 :
if ( V_96 != 0 || V_141 != NULL )
return - V_22 ;
return F_74 () ;
case V_143 :
return F_79 ( V_96 , V_141 ) ;
default:
return - V_22 ;
}
}
long F_85 ( unsigned long V_63 , char T_4 * V_12 )
{
unsigned int V_140 ;
char T_4 * V_141 ;
switch ( V_63 ) {
...
return F_84 ( V_140 , 0 , V_141 ) ;
}
long F_86 ( struct V_3 * V_4 , unsigned long V_144 ,
void T_4 * V_128 )
{
struct V_55 * V_12 ;
struct V_145 * V_78 ;
...
if ( F_11 ( V_146 != 1 || ! V_12 ) ) {
V_53 = - V_147 ;
goto V_95;
}
V_78 = V_12 -> V_61 -> V_148 ;
if ( ! V_78 ) {
V_53 = - V_149 ;
goto V_95;
}
...
F_25 ( V_4 ) ;
F_78 ( & V_4 -> V_64 -> V_65 ) ;
if ( F_88 ( V_128 , V_78 -> V_12 , F_89 ( V_78 ) ) )
V_53 = - V_92 ;
F_26 ( V_4 ) ;
return V_53 ;
V_95:
