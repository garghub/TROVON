...
if ( V_77 )
F_46 ( & V_6 -> V_11 -> V_81 , NULL , L_18 ) ;
return V_82 ;
}
static void F_47 ( struct V_83 * V_84 )
{
struct V_5 * V_6 = F_48 ( V_84 , struct V_5 ,
V_60 . V_84 ) ;
F_42 ( 0 , V_6 ) ;
}
...
static int F_51 ( struct V_85 * V_86 , struct V_91 * V_92 )
{
if ( ! V_86 )
return - V_66 ;
V_86 -> V_92 = V_92 ;
...
{
struct V_95 * V_96 = F_53 ( & V_94 -> V_11 ) ;
struct V_5 * V_6 ;
struct V_59 * V_59 ;
int V_22 , V_80 ;
struct V_85 * V_86 ;
struct V_97 * V_98 = V_94 -> V_11 . V_99 ;
struct V_100 * V_100 ;
V_6 = F_54 ( & V_94 -> V_11 , sizeof( * V_6 ) , V_101 ) ;
if ( ! V_6 )
return - V_102 ;
if ( V_98 )
F_55 ( V_98 , L_19 ,
...
V_86 = F_54 ( & V_94 -> V_11 , sizeof( * V_86 ) , V_101 ) ;
if ( ! V_86 )
return - V_102 ;
V_6 -> V_11 = & V_94 -> V_11 ;
V_6 -> V_77 = F_56 ( V_94 , 0 ) ;
V_6 -> V_25 = false ;
V_6 -> V_23 = V_24 ;
