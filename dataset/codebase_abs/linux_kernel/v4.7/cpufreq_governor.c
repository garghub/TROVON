...
unsigned long V_49 , unsigned long F_3 )
{
...
static struct V_6 * F_37 ( struct V_25 * V_26 ,
struct V_41 * V_42 )
{
struct V_6 * V_7 ;
int V_14 ;
...
V_7 -> V_5 = V_5 ;
V_26 -> V_27 = V_7 ;
F_46 ( & V_5 -> V_2 , & V_7 -> V_68 ) ;
goto V_69;
}
V_5 = F_47 ( sizeof( * V_5 ) , V_70 ) ;
if ( ! V_5 ) {
V_9 = - V_65 ;
goto F_41;
}
F_48 ( & V_5 -> V_2 , & V_7 -> V_68 ) ;
V_9 = V_42 -> V_71 ( V_5 , ! V_26 -> V_72 -> V_73 ) ;
if ( V_9 )
goto F_41;
V_63 = V_26 -> V_74 . V_75 / 1000 ;
if ( V_63 == 0 )
V_63 = 1 ;
...
V_26 -> V_27 = V_7 ;
V_42 -> V_78 . V_79 = & V_80 ;
V_9 = F_49 ( & V_5 -> V_2 . V_81 , & V_42 -> V_78 ,
F_50 ( V_26 ) ,
L_2 , V_42 -> V_42 . V_82 ) ;
if ( ! V_9 )
goto V_69;
...
unsigned int V_4 ;
F_5 ( & V_66 ) ;
V_4 = F_54 ( & V_5 -> V_2 , & V_7 -> V_68 ) ;
V_26 -> V_27 = NULL ;
if ( ! V_4 ) {
if ( ! F_45 () )
V_42 -> V_67 = NULL ;
V_42 -> exit ( V_5 , V_26 -> V_72 -> V_73 == 1 ) ;
F_52 ( V_5 ) ;
}
F_41 ( V_7 , V_42 ) ;
F_7 ( & V_66 ) ;
...
struct V_6 * V_7 = V_26 -> V_27 ;
F_5 ( & V_7 -> V_13 ) ;
if ( V_26 -> F_3 < V_26 -> V_83 )
F_59 ( V_26 , V_26 -> F_3 , V_85 ) ;
else if ( V_26 -> V_86 > V_26 -> V_83 )
F_59 ( V_26 , V_26 -> V_86 , V_87 ) ;
F_6 ( V_7 , 0 ) ;
F_7 ( & V_7 -> V_13 ) ;
return 0 ;
}
int F_60 ( struct V_25 * V_26 , unsigned int V_88 )
{
if ( V_88 == V_89 ) {
return F_43 ( V_26 ) ;
} else if ( V_26 -> V_27 ) {
