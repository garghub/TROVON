...
if ( ! V_8 -> V_12 ) {
V_8 -> V_12 = F_61 ( V_8 -> V_78 , V_8 -> V_124 -> V_111 ,
F_55 ( V_8 -> V_124 ) ) ;
if ( ! V_8 -> V_12 ) {
F_47 ( V_8 -> V_78 , L_8 ) ;
return - V_127 ;
...
if ( ! V_8 -> V_113 ) {
V_8 -> V_113 = F_61 ( V_8 -> V_78 , V_8 -> V_110 ,
V_8 -> V_108 ) ;
if ( ! V_8 -> V_113 ) {
F_47 ( V_8 -> V_78 , L_9 ) ;
return - V_127 ;
...
if ( ! V_8 -> V_129 ) {
V_8 -> V_129 = F_61 ( V_8 -> V_78 , V_8 -> V_112 ,
V_8 -> V_109 ) ;
if ( ! V_8 -> V_129 ) {
F_47 ( V_8 -> V_78 , L_8 ) ;
return - V_127 ;
...
V_33 = F_62 ( V_98 , L_10 , & V_8 -> V_130 ) ;
if ( V_33 )
V_8 -> V_130 = 0 ;
if ( F_63 ( F_36 ) ) {
if ( ! V_8 -> V_10 -> V_131 ) {
V_8 -> V_38 = F_64 ( V_8 -> V_78 -> V_99 ,
V_55 , & V_132 ,
& V_133 ) ;
if ( ! V_8 -> V_38 ) {
F_47 ( V_8 -> V_78 , L_11 ) ;
...
if ( F_63 ( F_36 ) ) {
V_73 = F_66 ( V_8 -> V_78 , V_8 -> V_136 ,
& V_137 , V_8 , & V_44 ,
& V_133 ) ;
V_133 . V_78 = V_8 -> V_78 ;
} else
V_73 = F_67 ( V_8 -> V_78 , V_8 -> V_136 , & V_137 ,
V_8 , & V_44 ) ;
if ( ! V_73 )
return - V_127 ;
if ( V_8 -> V_10 -> V_138 )
...
F_70 ( V_73 ) ;
F_71 ( V_73 ) ;
F_72 (child, &bus->children, node)
F_73 ( V_102 ) ;
F_74 ( V_73 ) ;
return 0 ;
}
static int F_75 ( struct V_7 * V_8 , struct V_101 * V_73 ,
...
V_142 = F_76 ( V_73 -> V_146 ) | F_77 ( F_78 ( V_141 ) ) |
F_79 ( F_80 ( V_141 ) ) ;
...
static int F_81 ( struct V_7 * V_8 , struct V_101 * V_73 ,
T_2 V_141 , int V_14 , int V_2 , T_2 V_3 )
{
int V_33 , type ;
T_2 V_142 , V_143 ;
...
static int F_83 ( struct V_101 * V_73 , T_2 V_141 , int V_14 ,
int V_2 , T_2 * V_3 )
{
struct V_7 * V_8 = V_73 -> V_74 ;
if ( F_82 ( V_8 , V_73 , F_78 ( V_141 ) ) == 0 ) {
* V_3 = 0xffffffff ;
return V_154 ;
}
if ( V_73 -> V_146 == V_8 -> V_136 )
return F_11 ( V_8 , V_14 , V_2 , V_3 ) ;
return F_75 ( V_8 , V_73 , V_141 , V_14 , V_2 , V_3 ) ;
}
static int F_84 ( struct V_101 * V_73 , T_2 V_141 ,
...
return F_81 ( V_8 , V_73 , V_141 , V_14 , V_2 , V_3 ) ;
}
