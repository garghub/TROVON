...
static void F_13 ( struct V_3 * V_4 , T_1 V_16 )
{
if ( V_4 -> V_17 != V_16 ) {
V_4 -> V_17 = V_16 ;
F_14 ( V_16 , V_4 -> V_8 + V_18 ) ;
}
}
static void F_15 ( struct V_3 * V_4 , T_1 V_19 )
{
if ( V_4 -> V_20 != V_19 ) {
V_4 -> V_20 = V_19 ;
F_14 ( V_19 , V_4 -> V_8 + V_21 ) ;
}
}
static void F_16 ( struct V_3 * V_4 , T_1 V_22 )
{
V_22 |= V_4 -> V_23 & V_24 ;
if ( V_4 -> V_23 != V_22 ) {
V_4 -> V_23 = V_22 ;
F_14 ( V_22 , V_4 -> V_8 + V_25 ) ;
}
}
static void F_17 ( struct V_3 * V_4 , unsigned int V_26 )
{
...
V_5 |= V_61 ;
F_25 ( & V_4 -> V_62 , V_12 -> V_63 , V_12 -> V_64 , V_5 ) ;
}
...
static void F_36 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
struct V_80 * V_81 ;
enum V_82 V_83 ;
if ( V_12 -> V_5 & V_59 ) {
...
F_37 ( V_81 -> V_71 -> V_72 , V_12 -> V_63 , V_12 -> V_64 , V_83 ) ;
}
static void F_38 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
T_1 V_86 ;
int V_87 ;
for ( V_87 = 0 ; ; V_87 ++ ) {
...
static int F_39 ( struct V_3 * V_4 , struct V_11 * V_12 ,
struct V_80 * * V_80 ,
struct V_90 * * V_91 )
{
struct V_27 * V_28 = V_4 -> V_28 ;
...
return - V_14 ;
V_71 = V_81 -> V_71 ;
V_108 = F_40 ( V_71 -> V_72 , V_12 -> V_63 , V_12 -> V_64 , V_107 ) ;
if ( V_108 == 0 )
return - V_14 ;
if ( V_4 -> V_28 -> V_74 )
V_5 |= V_115 ;
F_41 ( V_81 , & V_93 ) ;
V_106 = F_42 ( V_81 , V_12 -> V_63 , V_108 ,
V_93 . V_110 , V_5 ) ;
if ( ! V_106 )
goto V_116;
* V_80 = V_81 ;
...
return 0 ;
V_116:
F_37 ( V_71 -> V_72 , V_12 -> V_63 , V_12 -> V_64 , V_107 ) ;
return - V_117 ;
}
...
return F_39 ( V_4 , V_12 , & V_119 -> V_80 , & V_119 -> V_91 ) ;
}
static int F_45 ( struct V_3 * V_4 , unsigned int V_22 )
{
int V_120 ;
struct V_11 * V_12 = V_4 -> V_12 ;
V_120 = F_43 ( V_4 , V_4 -> V_12 ) ;
if ( V_120 )
return V_120 ;
F_46 ( F_9 ( V_4 -> V_2 ) ,
L_8 ,
...
static void F_50 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
struct V_118 * V_123 = & V_4 -> V_69 ;
F_51 ( V_12 -> V_79 && V_12 -> V_79 != V_123 -> V_70 ) ;
F_51 ( ! V_12 -> V_79 && ( V_123 -> V_91 || V_123 -> V_80 ) ) ;
V_4 -> V_78 = V_123 -> V_91 ;
V_4 -> V_77 = V_123 -> V_80 ;
V_123 -> V_91 = NULL ;
V_123 -> V_80 = NULL ;
...
static inline void F_36 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
}
...
static inline int F_45 ( struct V_3 * V_4 , unsigned int V_22 )
{
return - V_126 ;
}
static void F_54 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
struct V_27 * V_28 = V_4 -> V_28 ;
...
V_130 = F_57 ( V_12 -> V_13 ) - 1 ;
F_20 ( 1 << V_130 != V_12 -> V_13 ) ;
if ( V_28 -> V_138 )
...
static void
F_61 ( struct V_3 * V_4 , struct V_11 * V_12 ,
unsigned int V_86 )
{
if ( ! V_12 )
return;
...
V_12 -> V_132 = F_63 ( V_168 , V_12 -> V_13 ) ;
}
if ( V_86 & V_173 )
...
static int F_65 ( struct V_3 * V_4 , T_1 V_86 , int V_167 )
{
return V_167 - ( F_4 ( V_4 -> V_8 + V_192 ) << 2 ) ;
}
...
static int F_67 ( struct V_3 * V_4 , char * V_196 , unsigned int V_167 )
{
void T_2 * V_8 = V_4 -> V_8 ;
char * V_197 = V_196 ;
...
static int F_70 ( struct V_3 * V_4 , char * V_196 , unsigned int V_167 , T_1 V_86 )
{
struct V_27 * V_28 = V_4 -> V_28 ;
void T_2 * V_8 = V_4 -> V_8 ;
char * V_197 = V_196 ;
...
V_208 = 0 ;
if ( V_86 & V_211 )
V_208 = F_67 ( V_4 , V_196 , V_167 ) ;
if ( V_86 & V_212 )
V_208 = F_70 ( V_4 , V_196 , V_167 , V_86 ) ;
V_62 -> V_213 = V_208 ;
V_4 -> V_131 -= V_208 ;
V_167 -= V_208 ;
if ( V_167 )
...
F_14 ( V_86 , V_4 -> V_8 + V_215 ) ;
F_55 ( F_9 ( V_4 -> V_2 ) , L_14 , V_86 ) ;
if ( V_4 -> V_28 -> V_216 ) {
F_61 ( V_4 , V_4 -> V_12 , V_86 ) ;
...
unsigned long V_5 ;
F_51 ( V_4 -> V_49 != NULL ) ;
V_49 -> V_51 -> error = F_6 ( V_4 , V_49 -> V_12 ) ;
if ( V_49 -> V_51 -> error ) {
F_21 ( V_2 , V_49 ) ;
return;
}
...
V_120 = F_88 ( V_4 -> V_16 , V_38 -> clock ) ;
if ( V_120 < 0 )
F_8 ( F_9 ( V_4 -> V_2 ) ,
L_17 , V_120 ) ;
else
V_4 -> V_31 = F_89 ( V_4 -> V_16 ) ;
}
...
V_4 -> V_16 = F_103 ( & V_72 -> V_72 , NULL ) ;
if ( F_84 ( V_4 -> V_16 ) ) {
V_120 = F_104 ( V_4 -> V_16 ) ;
goto V_263;
}
V_120 = F_105 ( V_4 -> V_16 ) ;
if ( V_120 )
goto V_263;
if ( V_28 -> V_265 )
V_4 -> V_200 = F_66 ;
...
V_120 = F_88 ( V_4 -> V_16 , V_28 -> V_266 ) ;
if ( V_120 < 0 )
goto V_267;
V_4 -> V_31 = F_89 ( V_4 -> V_16 ) ;
F_55 ( F_9 ( V_2 ) , L_30 ,
...
V_2 -> V_270 = F_107 ( V_4 -> V_16 , 100000 ) ;
else
V_2 -> V_270 = F_18 ( V_4 -> V_31 , 512 ) ;
if ( V_2 -> V_266 )
V_2 -> V_266 = V_28 -> V_30 ?
F_71 ( V_28 -> V_266 , V_2 -> V_266 ) :
...
V_120 = F_114 ( V_2 , V_218 -> V_294 ) ;
if ( V_120 )
goto V_267;
}
}
}
V_120 = F_115 ( & V_72 -> V_72 , V_72 -> V_205 [ 0 ] , F_78 , V_295 ,
V_296 L_35 , V_4 ) ;
if ( V_120 )
goto V_267;
if ( ! V_72 -> V_205 [ 1 ] )
...
F_3 ( & V_4 -> V_7 , V_5 ) ;
if ( V_4 -> V_28 -> V_298 ) {
F_14 ( V_4 -> V_17 , V_4 -> V_8 + V_18 ) ;
F_14 ( V_4 -> V_23 , V_4 -> V_8 + V_25 ) ;
F_14 ( V_4 -> V_20 , V_4 -> V_8 + V_21 ) ;
}
F_14 ( V_297 , V_4 -> V_8 + V_55 ) ;
F_10 ( V_4 ) ;
F_5 ( & V_4 -> V_7 , V_5 ) ;
