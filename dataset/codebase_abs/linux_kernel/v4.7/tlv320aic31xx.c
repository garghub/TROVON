...
F_13 ( V_32 , V_95 , V_87 ,
V_80 [ V_73 ] . V_84 ) ;
F_25 ( V_32 , V_96 , V_80 [ V_73 ] . V_83 >> 8 ) ;
F_25 ( V_32 , V_97 , V_80 [ V_73 ] . V_83 & 0xff ) ;
F_13 ( V_32 , V_98 , V_87 ,
V_80 [ V_73 ] . V_99 ? V_80 [ V_73 ] . V_99 : 1 ) ;
F_13 ( V_32 , V_100 , V_87 ,
V_80 [ V_73 ] . V_101 ? V_80 [ V_73 ] . V_101 : 1 ) ;
F_25 ( V_32 , V_102 , V_80 [ V_73 ] . V_103 ) ;
F_13 ( V_32 , V_104 ,
V_87 , V_71 ) ;
V_16 -> V_105 = V_73 ;
F_11 ( V_32 -> V_2 ,
...
static int F_26 ( struct V_106 * V_107 ,
struct V_65 * V_66 ,
struct V_108 * V_109 )
{
...
V_116 ,
V_110 ) ;
return F_21 ( V_32 , V_66 ) ;
}
static int F_28 ( struct V_108 * V_117 , int V_118 )
{
...
static int F_31 ( struct V_108 * V_117 ,
...
static int F_32 ( struct V_152 * V_153 ,
unsigned long V_30 , void * V_110 )
{
struct V_154 * V_155 =
F_33 ( V_153 , struct V_154 , V_153 ) ;
struct V_15 * V_16 = V_155 -> V_16 ;
if ( V_30 & V_156 ) {
if ( F_34 ( V_16 -> V_52 . V_157 ) )
F_35 ( V_16 -> V_52 . V_157 , 0 ) ;
F_36 ( V_16 -> V_24 ) ;
...
struct V_15 * V_16 = F_9 ( V_32 ) ;
int V_23 = 0 ;
V_23 = F_41 ( F_16 ( V_16 -> V_161 ) ,
V_16 -> V_161 ) ;
if ( V_23 )
return V_23 ;
if ( F_34 ( V_16 -> V_52 . V_157 ) ) {
F_35 ( V_16 -> V_52 . V_157 , 1 ) ;
F_42 ( 100 ) ;
}
...
V_16 -> V_155 [ V_73 ] . V_153 . V_168 =
F_32 ;
V_16 -> V_155 [ V_73 ] . V_16 = V_16 ;
V_23 = F_51 ( V_16 -> V_161 [ V_73 ] . V_169 ,
...
int V_73 ;
for ( V_73 = 0 ; V_73 < F_16 ( V_16 -> V_161 ) ; V_73 ++ )
F_53 ( V_16 -> V_161 [ V_73 ] . V_169 ,
& V_16 -> V_155 [ V_73 ] . V_153 ) ;
return 0 ;
}
static void F_54 ( struct V_15 * V_16 )
{
struct V_170 * V_171 = V_16 -> V_2 -> V_172 ;
unsigned int V_173 = V_174 ;
int V_23 ;
F_55 ( V_171 , L_24 , & V_173 ) ;
switch ( V_173 ) {
case V_174 :
case V_175 :
case V_176 :
V_16 -> V_52 . V_53 = V_173 ;
break;
default:
F_6 ( V_16 -> V_2 ,
L_25 ,
...
for ( V_73 = 0 ; V_73 < F_16 ( V_16 -> V_161 ) ; V_73 ++ )
V_16 -> V_161 [ V_73 ] . V_178 = V_179 [ V_73 ] ;
V_23 = F_61 ( V_16 -> V_2 ,
F_16 ( V_16 -> V_161 ) ,
V_16 -> V_161 ) ;
if ( V_23 != 0 )
...
static int F_62 ( struct V_180 * V_181 ,
const struct V_182 * V_183 )
{
struct V_15 * V_16 ;
int V_23 ;
const struct V_184 * V_184 ;
F_11 ( & V_181 -> V_2 , L_30 , V_25 ,
V_183 -> V_46 , ( int ) V_183 -> V_185 ) ;
V_184 = & V_186 ;
V_16 = F_63 ( & V_181 -> V_2 , sizeof( * V_16 ) , V_187 ) ;
if ( V_16 == NULL )
return - V_188 ;
V_16 -> V_24 = F_64 ( V_181 , V_184 ) ;
if ( F_65 ( V_16 -> V_24 ) ) {
V_23 = F_66 ( V_16 -> V_24 ) ;
F_6 ( & V_181 -> V_2 , L_31 ,
V_23 ) ;
...
V_16 -> V_2 = & V_181 -> V_2 ;
V_16 -> V_52 . V_56 = V_183 -> V_185 ;
V_23 = F_57 ( V_16 ) ;
if ( V_23 )
return V_23 ;
return F_67 ( & V_181 -> V_2 , & V_189 ,
V_190 ,
F_16 ( V_190 ) ) ;
}
static int F_68 ( struct V_180 * V_181 )
{
F_69 ( & V_181 -> V_2 ) ;
return 0 ;
}
