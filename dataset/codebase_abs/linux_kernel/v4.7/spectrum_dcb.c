...
F_34 ( V_59 , V_8 -> V_22 ) ;
F_35 ( V_59 , V_36 -> V_61 ) ;
return F_10 ( V_8 -> V_23 -> V_24 , F_11 ( V_62 ) ,
V_59 ) ;
}
...
struct V_8 * V_8 = F_4 ( V_2 ) ;
int V_31 ;
if ( ( V_8 -> V_63 . V_64 || V_8 -> V_63 . V_65 ) &&
V_36 -> V_61 ) {
F_6 ( V_2 , L_11 ) ;
return - V_18 ;
}
...
V_66:
F_19 ( V_8 , V_2 -> V_35 ,
V_8 -> V_9 . V_7 -> V_19 , false ,
V_8 -> V_9 . V_36 ) ;
return V_31 ;
}
static int F_37 ( struct V_8 * V_8 )
{
V_8 -> V_9 . V_7 = F_38 ( sizeof( * V_8 -> V_9 . V_7 ) ,
V_68 ) ;
if ( ! V_8 -> V_9 . V_7 )
return - V_69 ;
V_8 -> V_9 . V_7 -> V_44 = V_13 ;
...
static int F_41 ( struct V_8 * V_8 )
{
int V_11 ;
V_8 -> V_9 . V_46 = F_42 ( sizeof( * V_8 -> V_9 . V_46 ) ,
V_68 ) ;
if ( ! V_8 -> V_9 . V_46 )
return - V_69 ;
for ( V_11 = 0 ; V_11 < V_13 ; V_11 ++ )
...
static void F_43 ( struct V_8 * V_8 )
{
F_40 ( V_8 -> V_9 . V_46 ) ;
}
static int F_44 ( struct V_8 * V_8 )
{
V_8 -> V_9 . V_36 = F_38 ( sizeof( * V_8 -> V_9 . V_36 ) ,
V_68 ) ;
if ( ! V_8 -> V_9 . V_36 )
return - V_69 ;
V_8 -> V_9 . V_36 -> V_67 = V_13 ;
