...
void F_101 ( struct V_1 * V_1 , void * V_35 )
{
memcpy ( V_1 -> V_35 , V_35 , sizeof( V_1 -> V_35 ) ) ;
V_1 -> V_34 = 1 ;
}
bool F_102 ( const struct V_1 * V_1 , T_6 * V_35 )
{
...
struct V_1 * V_157 ;
F_108 (pos, head, node) {
if ( V_155 && ! V_157 -> V_158 && ! F_109 ( V_157 ) )
continue;
if ( V_157 -> V_34 ) {
V_156 = true ;
continue;
}
if ( F_110 ( V_157 -> V_30 , V_157 -> V_35 ,
sizeof( V_157 -> V_35 ) ) > 0 ) {
V_156 = true ;
V_157 -> V_34 = true ;
}
...
void F_112 ( struct V_159 * V_159 , struct V_1 * V_1 )
{
F_113 ( & V_159 -> V_100 ) ;
F_111 ( V_159 , V_1 ) ;
F_114 ( & V_159 -> V_100 ) ;
...
struct V_1 * F_116 ( struct V_159 * V_159 , const char * V_58 , bool V_160 )
{
struct V_1 * V_1 ;
F_117 ( & V_159 -> V_100 ) ;
V_1 = F_115 ( V_159 , V_58 , V_160 ) ;
F_114 ( & V_159 -> V_100 ) ;
return V_1 ;
}
...
{
struct V_1 * V_1 = F_115 ( V_159 , V_58 , false ) ;
return V_1 ? V_1 : F_118 ( V_159 , V_58 ) ;
}
struct V_1 * F_120 ( struct V_159 * V_159 , const char * V_58 )
{
struct V_1 * V_1 ;
F_113 ( & V_159 -> V_100 ) ;
V_1 = F_97 ( F_119 ( V_159 , V_58 ) ) ;
F_114 ( & V_159 -> V_100 ) ;
return V_1 ;
}
T_1 F_121 ( struct V_153 * V_154 , T_8 * V_161 ,
bool (F_122)( struct V_1 * V_1 , int V_162 ) , int V_162 )
{
struct V_1 * V_157 ;
T_1 V_27 = 0 ;
F_108 (pos, head, node) {
if ( F_122 && F_122 ( V_157 , V_162 ) )
continue;
V_27 += F_123 ( V_157 , V_161 ) ;
V_27 += fprintf ( V_161 , L_25 , V_157 -> V_30 ) ;
}
return V_27 ;
}
T_1 F_124 ( struct V_153 * V_154 , T_8 * V_161 )
{
struct V_1 * V_157 ;
T_1 V_27 = 0 ;
F_108 (pos, head, node) {
int V_41 ;
for ( V_41 = 0 ; V_41 < V_137 ; ++ V_41 )
V_27 += F_125 ( V_157 , V_41 , V_161 ) ;
}
return V_27 ;
}
T_1 F_123 ( struct V_1 * V_1 , T_8 * V_161 )
{
char V_163 [ V_26 ] ;
F_8 ( V_1 -> V_35 , sizeof( V_1 -> V_35 ) , V_163 ) ;
return fprintf ( V_161 , L_3 , V_163 ) ;
}
T_1 F_125 ( struct V_1 * V_1 , enum V_134 type , T_8 * V_161 )
{
struct V_98 * V_164 ;
...
V_27 += F_126 ( V_157 , V_161 ) ;
}
return V_27 ;
}
enum V_123 F_127 ( struct V_1 * V_1 , struct V_72 * V_72 )
{
int V_66 ;
...
int F_129 ( struct V_1 * V_1 , char * V_168 , T_1 V_169 )
{
