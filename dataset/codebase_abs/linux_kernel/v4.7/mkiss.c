...
V_22 -> V_87 = & V_88 ;
V_22 -> V_89 = & V_90 ;
memcpy ( V_22 -> V_91 , & V_92 , V_48 ) ;
memcpy ( V_22 -> V_46 , & V_93 , V_48 ) ;
V_22 -> V_37 = V_94 | V_95 ;
}
static struct V_14 * F_48 ( struct V_96 * V_65 )
{
struct V_14 * V_15 ;
F_49 ( & V_97 ) ;
V_15 = V_65 -> V_98 ;
...
static int F_55 ( struct V_96 * V_65 )
{
struct V_42 * V_22 ;
struct V_14 * V_15 ;
int V_101 ;
...
return - V_104 ;
V_22 = F_57 ( sizeof( struct V_14 ) , L_16 , V_105 ,
F_47 ) ;
if ( ! V_22 ) {
V_101 = - V_81 ;
goto V_106;
...
static void F_63 ( struct V_96 * V_65 )
{
struct V_14 * V_15 ;
F_64 ( & V_97 ) ;
V_15 = V_65 -> V_98 ;
...
static int F_68 ( struct V_96 * V_65 , struct V_111 * V_111 ,
unsigned int V_60 , unsigned long V_112 )
{
...
switch ( V_60 ) {
case V_115 :
V_101 = F_69 ( ( void V_116 * ) V_112 , V_15 -> V_22 -> V_29 ,
strlen ( V_15 -> V_22 -> V_29 ) + 1 ) ? - V_117 : 0 ;
break;
case V_118 :
V_101 = F_70 ( 4 , ( int V_116 * ) V_112 ) ;
break;
case V_119 :
if ( F_71 ( V_113 , ( int V_116 * ) V_112 ) ) {
V_101 = - V_117 ;
break;
}
V_15 -> V_120 = V_113 ;
...
static long F_73 ( struct V_96 * V_65 , struct V_111 * V_111 ,
unsigned int V_60 , unsigned long V_112 )
{
switch ( V_60 ) {
case V_115 :
...
case V_119 :
case V_123 :
return F_68 ( V_65 , V_111 , V_60 ,
( unsigned long ) F_74 ( V_112 ) ) ;
}
return - V_124 ;
}
static void F_75 ( struct V_96 * V_65 , const unsigned char * V_1 ,
char * V_125 , int V_18 )
{
struct V_14 * V_15 = F_48 ( V_65 ) ;
if ( ! V_15 )
...
static void F_78 ( struct V_96 * V_65 )
{
struct V_14 * V_15 = F_48 ( V_65 ) ;
int V_59 ;
if ( ! V_15 )
