...
static int F_73 ( struct V_46 * V_47 )
{
struct V_48 * V_49 ;
struct V_14 * V_15 ;
...
F_18 ( V_26 , F_36 ( F_33 ( V_47 ) ) ,
V_59 ) ;
F_37 ( V_47 , V_60 , F_71 ( V_47 ) ) ;
return - 1 ;
}
static int T_3 F_76 ( struct V_26 * V_26 )
{
struct V_107 * V_108 ;
struct V_109 * V_101 ;
V_108 = V_110 ;
if ( ! F_77 ( V_26 , & V_111 ) ) {
V_108 = F_78 ( V_108 , sizeof( V_110 ) , V_112 ) ;
if ( ! V_108 )
goto V_113;
...
static void T_4 F_81 ( struct V_26 * V_26 )
{
struct V_107 * V_108 ;
V_108 = V_26 -> V_43 . V_123 . V_124 -> V_126 ;
F_82 ( V_26 -> V_43 . V_123 . V_124 ) ;
if ( ! F_77 ( V_26 , & V_111 ) )
F_80 ( V_108 ) ;
}
static int F_83 ( void )
{
V_127 = F_79 ( & V_111 , L_3 ,
V_128 ) ;
...
static int F_76 ( struct V_26 * V_26 )
{
return 0 ;
}
static void F_81 ( struct V_26 * V_26 )
{
}
static int F_83 ( void )
{
...
static void T_4 F_88 ( struct V_26 * V_26 )
{
F_81 ( V_26 ) ;
F_89 ( & V_26 -> V_43 . V_28 , & V_8 ) ;
}
int T_5 F_90 ( void )
{
int V_106 ;
V_106 = F_91 ( & V_132 , V_133 ) ;
if ( V_106 )
goto V_34;
V_106 = F_83 () ;
if ( V_106 )
