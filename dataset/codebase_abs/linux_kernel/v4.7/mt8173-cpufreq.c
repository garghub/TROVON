...
{
struct V_1 * V_3 = V_22 -> V_29 ;
struct V_41 * V_42 = F_24 ( V_3 -> V_31 -> V_43 ) ;
T_1 V_44 = 0 ;
if ( F_21 ( ! V_42 ) )
return;
if ( F_25 ( V_42 , L_8 , NULL ) ) {
F_26 ( V_42 , V_45 , & V_44 ) ;
V_3 -> V_46 = F_27 ( V_42 ,
V_22 -> V_47 ,
V_44 ,
...
{
struct V_30 * V_31 ;
struct V_6 * V_7 = F_31 ( - V_48 ) ;
struct V_6 * V_8 = F_31 ( - V_48 ) ;
struct V_26 * V_27 = F_31 ( - V_48 ) ;
struct V_26 * V_40 = F_31 ( - V_48 ) ;
struct V_32 * V_33 ;
unsigned long V_49 ;
int V_14 ;
V_31 = F_32 ( V_2 ) ;
...
return 0 ;
V_61:
F_54 (info, tmp, &dvfs_info_list, list_head) {
F_41 ( V_3 ) ;
F_55 ( & V_3 -> V_62 ) ;
}
return V_14 ;
