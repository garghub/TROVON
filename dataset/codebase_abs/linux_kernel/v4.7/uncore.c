...
return - V_127 ;
if ( V_28 -> V_130 < 0 )
V_28 -> V_130 = V_173 -> V_182 ;
else
F_73 ( V_28 -> V_130 != V_173 -> V_182 ) ;
F_24 ( & V_31 -> V_183 ) ;
V_31 -> V_82 = V_5 ;
V_31 -> V_83 = V_157 ;
V_31 -> V_172 = V_173 ;
...
T_4 V_79 ;
int V_114 ;
V_79 = V_161 * sizeof( struct V_186 ) ;
...
for ( V_13 = 0 ; V_13 < type -> V_153 ; V_13 ++ , V_28 ++ ) {
V_31 = V_28 -> V_30 [ V_157 ] ;
if ( V_31 && F_112 ( & V_31 -> V_183 ) == 0 )
F_94 ( V_31 ) ;
}
}
}
static void F_118 ( int V_29 , bool V_193 )
{
struct V_77 * type , * * V_159 = V_160 ;
struct V_27 * V_28 ;
struct V_26 * V_31 ;
int V_13 , V_157 , V_194 = 1 ;
if ( V_193 ) {
V_194 = F_119 ( F_120 ( V_29 ) ) ;
}
V_157 = F_17 ( V_29 ) ;
for (; * V_159 ; V_159 ++ ) {
type = * V_159 ;
...
if ( ! V_31 )
continue;
if ( F_121 ( V_194 , & V_31 -> V_183 ) == V_194 )
F_108 ( V_31 ) ;
}
}
}
static int F_122 ( int V_29 )
{
struct V_77 * type , * * V_159 = V_160 ;
struct V_27 * V_28 ;
struct V_26 * V_31 ;
...
static void F_124 ( struct V_77 * type , int V_195 ,
int V_196 )
{
struct V_27 * V_28 = type -> V_156 ;
struct V_26 * V_31 ;
int V_13 , V_157 ;
V_157 = F_17 ( V_195 < 0 ? V_196 : V_195 ) ;
for ( V_13 = 0 ; V_13 < type -> V_153 ; V_13 ++ , V_28 ++ ) {
V_31 = V_28 -> V_30 [ V_157 ] ;
if ( ! V_31 )
continue;
...
F_73 ( V_31 -> V_29 != V_195 ) ;
V_31 -> V_29 = - 1 ;
if ( V_196 < 0 )
continue;
F_50 ( V_31 ) ;
F_125 ( & V_28 -> V_28 , V_195 , V_196 ) ;
V_31 -> V_29 = V_196 ;
}
}
static void F_126 ( struct V_77 * * V_197 ,
int V_195 , int V_196 )
{
for (; * V_197 ; V_197 ++ )
F_124 ( * V_197 , V_195 , V_196 ) ;
}
...
if ( ! F_128 ( V_29 , & V_144 ) )
return;
V_198 = F_129 ( F_120 ( V_29 ) , V_29 ) ;
if ( V_198 < V_199 )
F_130 ( V_198 , & V_144 ) ;
else
V_198 = - 1 ;
F_126 ( V_160 , V_29 , V_198 ) ;
F_126 ( V_179 , V_29 , V_198 ) ;
}
static void F_131 ( int V_29 )
{
int V_198 ;
V_198 = F_132 ( & V_144 , F_120 ( V_29 ) ) ;
if ( V_198 < V_199 )
return;
F_130 ( V_29 , & V_144 ) ;
F_126 ( V_160 , - 1 , V_29 ) ;
...
static int F_133 ( struct V_200 * V_201 ,
unsigned long V_202 , void * V_203 )
{
unsigned int V_29 = ( long ) V_203 ;
switch ( V_202 & ~ V_204 ) {
case V_205 :
return F_134 ( F_122 ( V_29 ) ) ;
case V_206 :
F_118 ( V_29 , false ) ;
case V_207 :
F_131 ( V_29 ) ;
...
static int T_3 F_135 ( struct V_77 * type )
{
int V_13 , V_114 ;
for ( V_13 = 0 ; V_13 < type -> V_153 ; V_13 ++ ) {
...
static void T_3 F_138 ( void * V_158 )
{
F_118 ( F_42 () , true ) ;
}
static int T_3 F_139 ( bool V_212 )
{
unsigned int V_29 ;
F_140 (cpu) {
unsigned int V_157 = F_17 ( V_29 ) ;
int V_114 ;
if ( F_141 ( V_157 , V_213 ) )
continue;
if ( V_212 ) {
V_114 = F_122 ( V_29 ) ;
if ( V_114 )
...
{
const struct V_215 * V_175 ;
struct V_216 * V_217 ;
int V_218 = 0 , V_219 = 0 , V_114 ;
V_175 = F_145 ( V_220 ) ;
if ( ! V_175 )
return - V_121 ;
if ( F_146 ( V_221 ) )
return - V_121 ;
V_161 = F_147 () ;
V_217 = (struct V_216 * ) V_175 -> V_176 ;
if ( V_217 -> V_222 ) {
V_218 = V_217 -> V_222 () ;
if ( ! V_218 )
V_218 = F_113 () ;
