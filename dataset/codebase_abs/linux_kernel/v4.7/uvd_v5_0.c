...
F_24 ( V_2 , F_23 ( V_98 , 0 ) ) ;
F_24 ( V_2 , F_33 ( V_92 ) & 0xff ) ;
F_24 ( V_2 , F_23 ( V_99 , 0 ) ) ;
F_24 ( V_2 , 0 ) ;
F_24 ( V_2 , F_23 ( V_97 , 0 ) ) ;
F_24 ( V_2 , 0 ) ;
F_24 ( V_2 , F_23 ( V_98 , 0 ) ) ;
...
F_24 ( V_2 , 0xDEADBEEF ) ;
F_25 ( V_2 ) ;
for ( V_49 = 0 ; V_49 < V_4 -> V_101 ; V_49 ++ ) {
V_15 = F_2 ( V_96 ) ;
if ( V_15 == 0xDEADBEEF )
break;
F_43 ( 1 ) ;
...
struct V_103 * V_104 ,
unsigned V_105 , bool V_106 )
{
F_24 ( V_2 , F_23 ( V_107 , 0 ) ) ;
F_24 ( V_2 , F_32 ( V_104 -> V_26 ) ) ;
F_24 ( V_2 , F_23 ( V_108 , 0 ) ) ;
F_24 ( V_2 , F_33 ( V_104 -> V_26 ) ) ;
F_24 ( V_2 , F_23 ( V_109 , 0 ) ) ;
F_24 ( V_2 , V_104 -> V_110 ) ;
}
...
V_9 = F_47 ( V_2 , 1 , true , & V_111 ) ;
if ( V_9 ) {
F_22 ( L_11 , V_9 ) ;
goto error;
}
V_9 = F_48 ( V_111 , false ) ;
if ( V_9 ) {
F_22 ( L_12 , V_9 ) ;
goto error;
}
...
{
struct V_3 * V_4 = (struct V_3 * ) V_8 ;
bool V_166 = ( V_118 == V_167 ) ? true : false ;
static int V_168 = - 1 ;
if ( ! ( V_4 -> V_169 & V_170 ) )
return 0 ;
if ( V_168 == V_118 )
...
{
V_4 -> V_10 . V_2 . V_176 = & V_177 ;
}
static void F_8 ( struct V_3 * V_4 )
{
V_4 -> V_10 . V_11 . V_178 = 1 ;
V_4 -> V_10 . V_11 . V_176 = & V_179 ;
}
