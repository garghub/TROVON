...
static void F_23 ( struct V_1 * V_1 , T_1 V_2 , const char * V_14 , T_1 V_29 )
{
char * V_21 = F_5 ( V_1 ) ;
...
T_1 F_25 ( const void * V_30 , T_1 V_3 , struct V_4 * V_5 )
{
const char * V_14 = V_30 ;
F_26 (i, bytes, v,
...
return 0 ;
F_33 ( V_5 , V_32 , V_25 ,
( V_36 |= ( ! V_36 ? 0 : ( unsigned long ) V_25 . V_17 ) |
( V_32 != V_25 . V_18 ? V_32 : 0 ) , 0 ) ,
( V_36 |= ( ! V_36 ? 0 : ( unsigned long ) V_25 . V_37 ) |
( V_32 != V_25 . V_34 ? V_32 : 0 ) ) ,
( V_36 |= ( ! V_36 ? 0 : ( unsigned long ) V_25 . V_17 ) |
( V_32 != V_25 . V_18 ? V_32 : 0 ) )
) ;
return V_36 ;
}
T_3 F_41 ( struct V_4 * V_5 ,
struct V_1 * * V_38 , T_1 V_39 , unsigned V_40 ,
T_1 * V_41 )
{
if ( V_39 > V_5 -> V_15 )
V_39 = V_5 -> V_15 ;
...
static struct V_1 * * F_42 ( T_1 V_42 )
{
struct V_1 * * V_31 = F_43 ( V_42 * sizeof( struct V_1 * ) , V_43 ) ;
if ( ! V_31 )
V_31 = F_44 ( V_42 * sizeof( struct V_1 * ) ) ;
return V_31 ;
}
T_3 F_45 ( struct V_4 * V_5 ,
struct V_1 * * * V_38 , T_1 V_39 ,
T_1 * V_41 )
{
struct V_1 * * V_31 ;
if ( V_39 > V_5 -> V_15 )
...
T_1 F_46 ( void * V_30 , T_1 V_3 , T_4 * V_44 ,
struct V_4 * V_5 )
{
char * V_21 = V_30 ;
T_4 V_45 , V_46 ;
...
T_1 F_47 ( const void * V_30 , T_1 V_3 , T_4 * V_44 ,
struct V_4 * V_5 )
{
const char * V_14 = V_30 ;
T_4 V_45 , V_46 ;
...
int F_48 ( const struct V_4 * V_5 , int V_40 )
{
T_1 V_32 = V_5 -> V_15 ;
int V_48 = 0 ;
if ( ! V_32 )
...
const void * F_49 ( struct V_4 * V_49 , struct V_4 * V_50 , T_5 V_51 )
{
* V_49 = * V_50 ;
if ( V_49 -> type & V_22 )
return V_49 -> V_33 = F_50 ( V_49 -> V_33 ,
V_49 -> V_20 * sizeof( struct V_35 ) ,
V_51 ) ;
else
return V_49 -> V_11 = F_50 ( V_49 -> V_11 ,
V_49 -> V_20 * sizeof( struct V_10 ) ,
V_51 ) ;
}
int F_51 ( int type , const struct V_10 T_2 * V_52 ,
unsigned V_20 , unsigned V_53 ,
struct V_10 * * V_11 , struct V_4 * V_5 )
{
T_3 V_42 ;
struct V_10 * V_31 ;
V_42 = F_52 ( type , V_52 , V_20 , V_53 ,
* V_11 , & V_31 ) ;
if ( V_42 < 0 ) {
if ( V_31 != * V_11 )
F_53 ( V_31 ) ;
...
F_19 ( V_5 , type , V_31 , V_20 , V_42 ) ;
* V_11 = V_31 == * V_11 ? NULL : V_31 ;
return 0 ;
}
int F_54 ( int type , const struct V_54 T_2 * V_52 ,
unsigned V_20 , unsigned V_53 ,
struct V_10 * * V_11 , struct V_4 * V_5 )
{
T_3 V_42 ;
struct V_10 * V_31 ;
V_42 = F_55 ( type , V_52 , V_20 , V_53 ,
* V_11 , & V_31 ) ;
if ( V_42 < 0 ) {
if ( V_31 != * V_11 )
F_53 ( V_31 ) ;
...
int F_56 ( int V_55 , void T_2 * V_12 , T_1 V_29 ,
struct V_10 * V_11 , struct V_4 * V_5 )
{
if ( V_29 > V_56 )
V_29 = V_56 ;
if ( F_2 ( ! F_57 ( ! V_55 , V_12 , V_29 ) ) )
return - V_57 ;
V_11 -> V_17 = V_12 ;
V_11 -> V_18 = V_29 ;
F_19 ( V_5 , V_55 , V_11 , 1 , V_29 ) ;
return 0 ;
}
