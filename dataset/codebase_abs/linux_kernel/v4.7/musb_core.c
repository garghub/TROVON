...
static int
F_80 ( struct V_1 * V_1 , struct V_30 * V_31 ,
...
F_89 ( L_37 , V_165 , V_158 ) ;
V_157:
V_27 = F_80 ( V_1 , V_31 , & V_166 , 0 ) ;
...
V_27 = F_80 ( V_1 , V_31 + V_167 , V_134 ++ , V_27 ) ;
if ( V_27 < 0 ) {
F_89 ( L_39 ,
V_165 , V_167 ) ;
return V_27 ;
...
V_167 ++ ;
V_1 -> V_171 = F_82 ( V_167 , V_1 -> V_171 ) ;
}
F_89 ( L_40 ,
V_165 ,
...
static int F_92 ( T_4 V_172 , struct V_1 * V_1 )
{
T_3 V_6 ;
char * type ;
...
V_1 -> V_191 = F_96 ( V_26 ) ;
snprintf ( V_174 , 32 , L_55 , F_97 ( V_1 -> V_191 ) ,
F_98 ( V_1 -> V_191 ) ,
...
F_30 ( V_1 -> V_35 , L_64 ,
F_67 ( V_1 ) ? L_12 : L_13 ,
V_1 -> V_67 , V_1 -> V_209 , V_1 -> V_210 ) ;
if ( V_1 -> V_67 )
V_208 |= F_52 ( V_1 , V_1 -> V_67 , V_68 ) ;
if ( V_1 -> V_209 & 1 ) {
if ( F_67 ( V_1 ) )
V_208 |= F_102 ( V_1 ) ;
else
...
void F_110 ( struct V_1 * V_1 , T_3 V_25 , T_3 V_211 )
{
if ( ! V_25 ) {
if ( ! F_111 ( V_1 ) ) {
if ( F_67 ( V_1 ) )
...
static T_6
F_113 ( struct V_2 * V_3 , struct V_215 * V_216 , char * V_217 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_48 ;
int V_12 = - V_170 ;
F_45 ( & V_1 -> V_49 , V_48 ) ;
V_12 = sprintf ( V_217 , L_65 , F_47 ( V_1 -> V_50 -> V_51 -> V_52 ) ) ;
F_49 ( & V_1 -> V_49 , V_48 ) ;
return V_12 ;
}
static T_6
F_114 ( struct V_2 * V_3 , struct V_215 * V_216 ,
...
F_45 ( & V_1 -> V_49 , V_48 ) ;
if ( F_115 ( V_217 , L_12 ) )
V_176 = F_116 ( V_1 , V_218 ) ;
else if ( F_115 ( V_217 , L_13 ) )
V_176 = F_116 ( V_1 , V_219 ) ;
else if ( F_115 ( V_217 , L_66 ) )
V_176 = F_116 ( V_1 , V_220 ) ;
else
V_176 = - V_170 ;
F_49 ( & V_1 -> V_49 , V_48 ) ;
...
static T_6
F_117 ( struct V_2 * V_3 , struct V_215 * V_216 ,
const char * V_217 , T_7 V_154 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_48 ;
unsigned long V_24 ;
if ( sscanf ( V_217 , L_67 , & V_24 ) < 1 ) {
F_66 ( V_3 , L_68 ) ;
return - V_170 ;
}
F_45 ( & V_1 -> V_49 , V_48 ) ;
V_1 -> V_99 = V_24 ? F_118 ( int , V_24 , V_100 ) : 0 ;
...
static T_6
F_119 ( struct V_2 * V_3 , struct V_215 * V_216 , char * V_217 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_48 ;
unsigned long V_24 ;
...
F_49 ( & V_1 -> V_49 , V_48 ) ;
return sprintf ( V_217 , L_69 ,
V_221 ? L_70 : L_71 , V_24 ) ;
}
static T_6
F_121 ( struct V_2 * V_3 , struct V_215 * V_216 ,
const char * V_217 , T_7 V_154 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned short V_222 ;
if ( sscanf ( V_217 , L_72 , & V_222 ) != 1
|| ( V_222 != 1 ) ) {
F_66 ( V_3 , L_73 ) ;
return - V_170 ;
}
...
static void F_123 ( struct V_223 * V_29 )
{
struct V_1 * V_1 = F_124 ( V_29 , struct V_1 , V_119 ) ;
if ( V_1 -> V_50 -> V_51 -> V_52 != V_1 -> V_224 ) {
V_1 -> V_224 = V_1 -> V_50 -> V_51 -> V_52 ;
F_125 ( & V_1 -> V_35 -> V_225 , NULL , L_74 ) ;
}
}
...
static struct V_1 * F_128 ( struct V_2 * V_3 ,
...
int V_25 ;
int V_12 ;
V_1 = F_129 ( V_3 , sizeof( * V_1 ) , V_228 ) ;
if ( ! V_1 )
return NULL ;
F_130 ( & V_1 -> V_229 ) ;
F_130 ( & V_1 -> V_230 ) ;
...
static void F_140 ( struct V_223 * V_239 )
{
struct V_1 * V_1 ;
unsigned long V_48 ;
V_1 = F_124 ( V_239 , struct V_1 , V_240 . V_239 ) ;
F_45 ( & V_1 -> V_49 , V_48 ) ;
if ( V_1 -> V_65 & V_241 )
F_141 ( V_1 , false ) ;
F_49 ( & V_1 -> V_49 , V_48 ) ;
...
static int
F_142 ( struct V_2 * V_3 , int V_234 , void T_2 * V_242 )
{
int V_176 ;
struct V_1 * V_1 ;
struct V_243 * V_244 = F_143 ( V_3 ) ;
if ( ! V_244 ) {
F_30 ( V_3 , L_75 ) ;
V_176 = - V_214 ;
goto V_245;
}
V_1 = F_128 ( V_3 , V_244 -> V_126 , V_242 ) ;
if ( ! V_1 ) {
V_176 = - V_246 ;
goto V_245;
}
...
F_6 = V_1 -> V_250 -> V_261 ;
if ( V_1 -> V_250 -> V_262 )
F_73 = V_1 -> V_250 -> V_262 ;
if ( V_1 -> V_250 -> V_263 )
F_43 = V_1 -> V_250 -> V_263 ;
if ( V_1 -> V_250 -> V_264 )
...
V_268 ( V_1 , V_1 -> V_43 ) ;
if ( F_151 ( V_1 -> V_276 ) ) {
V_176 = F_152 ( V_1 -> V_276 ) ;
goto V_277;
}
}
F_79 ( V_1 ) ;
F_75 ( V_1 ) ;
F_153 ( & V_1 -> V_119 , F_123 ) ;
F_154 ( & V_1 -> V_240 , F_140 ) ;
F_154 ( & V_1 -> V_278 , V_279 ) ;
V_176 = F_92 ( V_244 -> V_126 -> V_280
? V_189
: V_281 , V_1 ) ;
if ( V_176 < 0 )
goto V_282;
F_155 ( & V_1 -> V_103 , F_44 , ( unsigned long ) V_1 ) ;
if ( F_156 ( V_234 , V_1 -> V_255 , 0 , F_157 ( V_3 ) , V_1 ) ) {
F_66 ( V_3 , L_77 , V_234 ) ;
V_176 = - V_214 ;
goto V_282;
}
...
if ( V_244 -> V_283 ) {
T_3 V_284 = F_160 ( V_1 -> V_43 ) ;
V_284 |= V_285 ;
F_161 ( V_1 -> V_43 , V_284 ) ;
}
...
if ( V_176 < 0 )
goto V_289;
V_176 = F_166 ( & V_1 -> V_35 -> V_225 , & V_237 ) ;
if ( V_176 )
goto V_290;
F_167 ( V_1 -> V_35 ) ;
F_168 ( V_1 -> V_35 ) ;
...
static int F_178 ( struct V_291 * V_292 )
{
struct V_2 * V_3 = & V_292 -> V_3 ;
int V_293 = F_179 ( V_292 , L_80 ) ;
struct V_294 * V_295 ;
void T_2 * V_296 ;
if ( V_293 <= 0 )
return - V_214 ;
V_295 = F_180 ( V_292 , V_297 , 0 ) ;
V_296 = F_181 ( V_3 , V_295 ) ;
if ( F_151 ( V_296 ) )
return F_152 ( V_296 ) ;
return F_142 ( V_3 , V_293 , V_296 ) ;
}
...
V_1 -> V_300 . V_284 = F_160 ( V_1 -> V_43 ) ;
...
F_161 ( V_1 -> V_43 , V_1 -> V_300 . V_284 ) ;
V_11 = F_5 ( V_298 , V_14 ) ;
V_11 &= V_15 | V_332 ;
