...
V_4 = F_22 ( & V_12 -> V_2 , sizeof( * V_4 ) , V_20 ) ;
if ( V_4 == NULL )
return - V_21 ;
F_23 ( & V_4 -> V_22 . V_23 ) ;
V_4 -> V_2 = & V_12 -> V_2 ;
V_4 -> V_24 = F_24 ( V_25 , V_4 -> V_2 ) -> V_26 ;
V_10 = F_25 ( & V_27 , & V_12 -> V_2 ) ;
if ( ! V_10 )
return - V_21 ;
F_26 ( V_10 , F_27 ( & V_12 -> V_2 ) ) ;
V_4 -> V_10 = V_10 ;
V_10 -> V_5 = V_4 ;
F_28 ( V_12 , V_4 ) ;
V_17 = F_29 ( V_12 , V_28 , 0 ) ;
V_4 -> V_29 = F_30 ( & V_12 -> V_2 , V_17 ) ;
if ( F_31 ( V_4 -> V_29 ) ) {
V_18 = F_32 ( V_4 -> V_29 ) ;
goto error;
}
V_18 = F_33 ( V_10 , ( 1 << V_4 -> V_24 -> V_30 ) - 1 ) ;
if ( V_18 < 0 ) {
F_21 ( & V_12 -> V_2 , L_2 ) ;
goto error;
}
