...
int
F_123 ( struct V_1 * V_2 , const struct V_173 * V_174 , int V_103 ,
...
struct V_156 * F_124 ( struct V_193 * V_194 )
{
struct V_156 * V_165 ;
...
V_28 = F_131 ( V_219 , V_215 , V_216 , 0 ) ;
if ( V_28 < 0 ) {
F_45 ( L_24 , V_28 ) ;
goto V_225;
}
V_28 = F_132 ( V_219 , V_208 , & V_217 ) ;
if ( V_28 < 0 ) {
F_45 ( L_25 , V_28 ) ;
goto V_225;
}
...
V_3 = F_136 ( V_40 -> V_229 ) ;
F_80 () ;
F_137 ( V_215 , 0 ) ;
V_28 = F_128 ( V_3 , V_215 , V_216 , V_208 , V_217 ) ;
F_138 ( V_3 ) ;
if ( V_28 != 0 )
...
static inline void
F_163 ( struct V_195 * V_208 , void * V_275 , T_4 V_200 )
{
...
if ( V_277 == NULL )
return;
V_165 -> V_190 = F_166 ( V_165 , V_277 , V_194 , V_278 ,
V_165 -> V_175 . V_177 ) ;
}
static void
...
F_69 ( memcmp ( & V_194 -> V_279 , & V_194 -> V_326 ,
...
static void F_206 ( const struct V_1 * V_2 ,
const struct V_156 * V_165 )
{
const char * V_370 = L_87 ;
if ( F_97 ( V_165 ) )
V_370 = F_207 ( V_165 -> V_161 ) ;
F_20 ( V_21 L_88 ,
