...
if ( V_65 )
return V_65 ;
V_23 = (struct V_22 * ) V_39 -> V_114 ;
if ( V_23 )
F_85 ( V_23 ) ;
}
return 0 ;
}
static int F_86 ( struct V_80 * V_80 , struct V_1 * V_2 ,
const struct V_40 * V_41 ,
struct V_38 * V_39 )
{
int V_65 ;
...
static bool F_88 ( const struct V_26 * V_27 )
{
T_4 V_165 ;
...
int F_89 ( struct V_80 * V_80 , struct V_38 * V_39 ,
struct V_1 * V_2 ,
const struct V_40 * V_41 )
{
int V_167 ;
...
static int F_90 ( struct V_40 * V_41 , const char * V_169 ,
const struct V_1 * V_2 , bool log )
{
struct V_68 * V_69 ;
struct V_70 * V_71 ;
V_69 = F_91 ( V_169 , V_41 -> V_117 ,
V_2 -> V_93 . V_67 ) ;
if ( ! V_69 ) {
F_92 ( log , L_6 , V_169 ) ;
return - V_163 ;
}
V_71 = F_93 ( V_41 -> V_23 , V_69 , V_170 ) ;
if ( ! V_71 ) {
F_94 ( V_69 -> V_171 ) ;
return - V_172 ;
}
...
static int F_96 ( const struct V_173 * V_174 ,
...
if ( F_99 ( V_175 ) != V_180 [ type ] [ V_179 ] ) {
F_92 ( log ,
L_8 ,
type , F_99 ( V_175 ) ,
V_180 [ type ] [ V_179 ] ) ;
...
break;
case V_184 :
F_100 ( & V_41 -> V_121 . V_194 , V_175 ,
sizeof( V_41 -> V_121 . V_194 ) ) ;
V_41 -> V_121 . V_136 |= V_137 ;
break;
case V_187 :
V_177 = true ;
F_100 ( & V_41 -> V_121 . V_195 , V_175 ,
sizeof( V_41 -> V_121 . V_195 ) ) ;
V_41 -> V_121 . V_136 |= V_137 ;
break;
case V_188 :
V_41 -> V_121 . V_196 . V_197 = F_29 ( F_101 ( V_175 ) ) ;
V_41 -> V_121 . V_136 |= V_198 ;
break;
case V_189 :
V_178 = true ;
V_41 -> V_121 . V_199 . V_197 = F_29 ( F_101 ( V_175 ) ) ;
V_41 -> V_121 . V_136 |= V_198 ;
break;
case V_190 :
...
static int F_102 ( const struct V_173 * V_174 , struct V_40 * V_41 ,
...
if ( F_99 ( V_175 ) < V_205 || F_99 ( V_175 ) > V_203 ) {
F_92 ( log ,
L_15 ,
type , F_99 ( V_175 ) , V_203 ) ;
return - V_163 ;
}
switch ( type ) {
case V_207 :
...
#ifdef V_55
case V_208 :
V_41 -> V_36 . V_37 = F_101 ( V_175 ) ;
break;
#endif
#ifdef V_24
case V_209 : {
struct V_210 * V_25 = F_103 ( V_175 ) ;
if ( ! V_25 -> V_61 ) {
F_92 ( log , L_16 ) ;
return - V_163 ;
}
...
bool F_105 ( struct V_80 * V_80 , enum V_215 V_174 )
{
if ( V_174 == V_53 )
return true ;
if ( F_5 ( V_55 ) &&
...
if ( F_5 ( V_58 ) &&
V_174 == V_59 ) {
struct V_216 * V_216 = F_106 ( V_80 , V_217 ) ;
return V_216 -> V_218 ;
}
return false ;
}
int F_107 ( struct V_80 * V_80 , const struct V_173 * V_174 ,
const struct V_1 * V_2 ,
...
V_221 . V_117 = V_117 ;
F_108 ( & V_221 . V_36 , V_222 ,
V_223 , 0 ) ;
V_65 = F_102 ( V_174 , & V_221 , & V_69 , log ) ;
if ( V_65 )
return V_65 ;
V_221 . V_23 = F_109 ( V_80 , & V_221 . V_36 , V_170 ) ;
if ( ! V_221 . V_23 ) {
F_92 ( log , L_22 ) ;
return - V_172 ;
}
F_110 ( V_224 , & V_221 . V_23 -> V_47 ) ;
F_81 ( & V_221 . V_23 -> V_115 ) ;
if ( V_69 ) {
V_65 = F_90 ( & V_221 , V_69 , V_2 , log ) ;
if ( V_65 )
goto V_225;
}
V_65 = F_111 ( V_220 , V_226 , & V_221 ,
sizeof( V_221 ) , log ) ;
if ( V_65 )
goto V_225;
return 0 ;
...
static bool F_113 ( const struct V_40 * V_41 ,
struct V_38 * V_39 )
{
struct V_173 * V_227 ;
V_227 = F_114 ( V_39 , V_214 ) ;
if ( ! V_227 )
return false ;
if ( V_41 -> V_151 & V_156 ) {
if ( F_115 ( V_39 , V_182 ) )
...
int F_119 ( const struct V_40 * V_221 ,
struct V_38 * V_39 )
{
struct V_173 * V_227 ;
V_227 = F_114 ( V_39 , V_226 ) ;
if ( ! V_227 )
return - V_54 ;
if ( V_221 -> V_154 && F_115 ( V_39 , V_207 ) )
return - V_54 ;
if ( F_5 ( V_55 ) &&
...
#ifdef F_104
if ( V_221 -> V_151 && ! F_113 ( V_221 , V_39 ) )
return - V_54 ;
#endif
F_118 ( V_39 , V_227 ) ;
return 0 ;
}
void F_121 ( const struct V_173 * V_175 )
{
struct V_40 * V_221 = F_103 ( V_175 ) ;
F_112 ( V_221 ) ;
}
static void F_112 ( struct V_40 * V_221 )
{
if ( V_221 -> V_69 )
F_94 ( V_221 -> V_69 -> V_171 ) ;
if ( V_221 -> V_23 )
F_122 ( V_221 -> V_23 ) ;
}
void F_123 ( struct V_80 * V_80 )
{
unsigned int V_230 = sizeof( struct V_26 ) * V_231 ;
struct V_216 * V_216 = F_106 ( V_80 , V_217 ) ;
if ( F_124 ( V_80 , V_230 - 1 ) ) {
V_216 -> V_218 = false ;
F_92 ( true , L_23 ) ;
} else {
V_216 -> V_218 = true ;
