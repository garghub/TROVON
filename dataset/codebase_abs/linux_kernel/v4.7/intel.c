...
static unsigned int F_63 ( struct V_3 * V_4 , unsigned int V_92 )
{
if ( ( V_4 -> V_8 == 6 ) && ( V_4 -> V_9 == 11 ) && ( V_92 == 0 ) )
V_92 = 256 ;
if ( ( V_4 -> V_8 == 5 ) && ( V_4 -> V_9 == 9 ) )
V_92 = 16 ;
return V_92 ;
}
static void F_64 ( const unsigned char V_93 )
{
unsigned char V_94 ;
if ( V_93 == 0 )
return;
for ( V_94 = 0 ; V_95 [ V_94 ] . V_96 != V_93 && \
V_95 [ V_94 ] . V_96 != 0 ; V_94 ++ )
;
if ( V_95 [ V_94 ] . V_97 == 0 )
return;
switch ( V_95 [ V_94 ] . V_97 ) {
case V_98 :
if ( V_99 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_99 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
if ( V_102 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_102 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
break;
case V_103 :
if ( V_99 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_99 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
if ( V_102 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_102 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
if ( V_104 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_104 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
if ( V_105 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_105 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
if ( V_106 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_106 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
if ( V_107 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_107 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
break;
case V_108 :
if ( V_99 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_99 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
...
break;
case V_119 :
if ( V_120 [ V_100 ] < V_95 [ V_94 ] . V_101 )
V_120 [ V_100 ] = V_95 [ V_94 ] . V_101 ;
break;
}
}
...
unsigned char * V_93 = ( unsigned char * ) V_124 ;
if ( V_4 -> V_12 < 2 )
return;
V_123 = F_8 ( 2 ) & 0xFF ;
for ( V_121 = 0 ; V_121 < V_123 ; V_121 ++ ) {
F_21 ( 2 , & V_124 [ 0 ] , & V_124 [ 1 ] , & V_124 [ 2 ] , & V_124 [ 3 ] ) ;
for ( V_122 = 0 ; V_122 < 3 ; V_122 ++ )
if ( V_124 [ V_122 ] & ( 1 << 31 ) )
V_124 [ V_122 ] = 0 ;
for ( V_122 = 1 ; V_122 < 16 ; V_122 ++ )
F_64 ( V_93 [ V_122 ] ) ;
}
}
