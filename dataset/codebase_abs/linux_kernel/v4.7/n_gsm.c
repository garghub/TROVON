...
static int F_163 ( struct V_226 * V_90 , int V_246 )
{
struct V_229 * V_233 = F_144 ( V_90 ) ;
if ( ( V_246 < 8 ) || ( V_246 > V_233 -> V_8 -> V_48 -> V_78 ) )
return - V_200 ;
V_90 -> V_78 = V_246 ;
return 0 ;
}
static void F_164 ( struct V_226 * V_90 )
{
...
static int F_165 ( struct V_7 * V_8 , struct V_263 * V_264 )
{
char * V_265 ;
int V_266 = 0 ;
struct V_226 * V_90 ;
...
if ( V_8 -> V_76 > 2 )
return - V_182 ;
if ( V_264 -> V_242 != F_161 ( V_243 ) )
return - V_269 ;
if ( V_264 -> V_76 != 3 && V_264 -> V_76 != 4 )
return - V_269 ;
F_8 ( L_34 ) ;
V_265 = L_35 ;
if ( V_264 -> V_270 [ 0 ] != '\0' )
V_265 = V_264 -> V_270 ;
V_90 = F_167 ( sizeof( struct V_229 ) , V_265 ,
V_271 , F_164 ) ;
if ( ! V_90 ) {
F_168 ( L_36 ) ;
return - V_80 ;
...
V_233 -> V_8 = V_8 ;
F_110 ( & V_233 -> V_184 ) ;
strncpy ( V_264 -> V_270 , V_90 -> V_272 , V_273 ) ;
V_8 -> V_231 = V_8 -> V_76 ;
V_8 -> V_232 = V_8 -> V_25 ;
V_8 -> V_76 = V_264 -> V_76 ;
V_8 -> V_25 = F_157 ;
...
static int F_171 ( struct V_107 * V_104 )
{
struct V_7 * V_8 = F_77 ( V_104 , struct V_7 , V_104 ) ;
if ( V_8 -> V_142 != V_144 )
return 0 ;
...
static void F_172 ( struct V_107 * V_104 , int V_275 )
{
struct V_7 * V_8 = F_77 ( V_104 , struct V_7 , V_104 ) ;
...
static int F_173 ( struct V_276 * V_277 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
...
V_192 = F_174 ( & V_8 -> V_104 , V_277 , V_95 ) ;
if ( V_192 ) {
if ( V_280 )
F_84 ( V_8 ) ;
F_89 ( & V_48 -> V_148 ) ;
...
static int F_175 ( struct V_94 * V_95 , struct V_202 * V_287 )
{
...
F_176 ( V_104 , 1 ) ;
F_65 ( V_8 ) ;
return F_177 ( V_104 , V_95 , V_287 ) ;
}
static void F_178 ( struct V_94 * V_95 , struct V_202 * V_287 )
{
struct V_7 * V_8 = V_95 -> V_286 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_89 ( & V_8 -> V_148 ) ;
V_48 = V_8 -> V_48 ;
if ( F_179 ( & V_8 -> V_104 , V_95 , V_287 ) == 0 )
return;
F_49 ( V_8 ) ;
if ( F_180 ( & V_8 -> V_104 ) && F_181 ( V_95 ) )
F_182 ( & V_8 -> V_104 ) ;
F_183 ( & V_8 -> V_104 , V_95 ) ;
F_91 ( & V_8 -> V_104 , NULL ) ;
return;
}
...
static int F_186 ( struct V_94 * V_95 , const unsigned char * V_114 ,
int V_4 )
{
int V_288 ;
struct V_7 * V_8 = V_95 -> V_286 ;
if ( V_8 -> V_142 == V_143 )
return - V_200 ;
V_288 = F_187 ( V_8 -> V_77 , V_114 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_288 ;
}
...
static void F_191 ( struct V_94 * V_95 , int V_290 )
{
}
...
switch ( V_93 ) {
case V_293 :
if ( F_137 ( & V_264 , ( void T_4 * ) V_221 , sizeof( V_264 ) ) )
return - V_224 ;
V_264 . V_270 [ V_273 - 1 ] = '\0' ;
F_87 ( & V_8 -> V_148 ) ;
V_278 = F_165 ( V_8 , & V_264 ) ;
F_89 ( & V_8 -> V_148 ) ;
if ( F_136 ( ( void T_4 * ) V_221 , & V_264 , sizeof( V_264 ) ) )
return - V_224 ;
return V_278 ;
case V_294 :
if ( ! F_166 ( V_267 ) )
...
static void F_195 ( struct V_94 * V_95 , struct V_296 * V_297 )
{
struct V_7 * V_8 = V_95 -> V_286 ;
if ( V_8 -> V_142 == V_143 )
return;
F_196 ( & V_95 -> V_298 , V_297 ) ;
}
...
static int F_200 ( struct V_94 * V_95 , int V_142 )
{
struct V_7 * V_8 = V_95 -> V_286 ;
int V_299 = 0 ;
if ( V_8 -> V_142 == V_143 )
