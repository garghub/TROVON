...
struct V_11 * V_12 ;
int V_82 , V_13 ;
if ( ! ( V_83 & V_9 ) || ! F_21 ( V_5 -> V_84 )
|| ! V_5 -> V_56 -> V_85 )
return;
V_82 = F_2 ( V_5 , V_86 , V_32 ) ;
V_12 = F_22 ( V_5 ) ;
if ( V_12 ) {
V_12 -> V_38 &= ~ ( V_9 | V_40 |
V_87 | V_88 |
...
if ( ! V_82 )
V_13 = V_5 -> V_56 -> V_85 ( V_10 , V_23 ) ;
return;
}
static int F_23 ( struct V_10 * V_10 , const char * V_90 ,
const void * V_46 , T_3 V_91 )
{
...
static void F_25 ( struct V_5 * V_5 , int V_94 )
{
struct V_11 * V_12 ;
if ( ! ( V_83 & V_9 ) || ! F_21 ( V_5 -> V_84 ) )
return;
...
int F_26 ( struct V_10 * V_10 , const char * V_90 ,
const void * V_46 , T_3 V_91 )
{
const struct V_45 * V_96 = V_46 ;
int V_97 ;
V_97 = F_23 ( V_10 , V_90 , V_46 ,
V_91 ) ;
if ( V_97 == 1 ) {
bool V_94 ;
if ( ! V_91 || ( V_96 -> type >= V_98 ) )
return - V_76 ;
V_94 = ( V_96 -> type == V_51 ) ;
if ( ! V_94 && ( V_2 & V_99 ) )
return - V_93 ;
...
int F_27 ( struct V_10 * V_10 , const char * V_90 )
{
int V_97 ;
V_97 = F_23 ( V_10 , V_90 , NULL , 0 ) ;
if ( V_97 == 1 ) {
F_25 ( F_12 ( V_10 ) , 0 ) ;
V_97 = 0 ;
}
