...
V_2 -> V_81 |= V_71 |
V_72 ;
if ( V_131 -> V_152 & ( V_154 | V_155 | V_156 ) )
V_2 -> V_81 |= V_74 ;
V_2 -> V_86 = 0 ;
if ( V_131 -> V_152 & V_154 )
V_2 -> V_86 |= V_74 ;
...
V_173 -> V_178 &= V_182 | V_179 ;
memset ( V_173 -> V_183 , 0 , sizeof( V_173 -> V_183 ) ) ;
V_2 -> V_173 = * V_173 ;
return 0 ;
}
...
struct V_4 * V_5 = F_2 ( V_2 -> V_6 ) ;
F_4 ( V_2 , V_189 , 0 ) ;
V_5 -> V_16 -> V_184 ( V_2 , 0 ) ;
}
static const char * F_61 ( struct V_1 * V_2 )
{
struct V_4 * V_5 = F_2 ( V_2 -> V_6 ) ;
return ( V_2 -> type == V_190 ) ? V_5 -> V_16 -> V_17 : NULL ;
}
static int F_62 ( struct V_1 * V_2 )
{
return 0 ;
}
static void F_63 ( struct V_1 * V_2 , int V_178 )
{
if ( V_178 & V_191 )
V_2 -> type = V_190 ;
}
static int F_64 ( struct V_1 * V_2 , struct V_192 * V_5 )
{
if ( ( V_5 -> type != V_193 ) && ( V_5 -> type != V_190 ) )
return - V_194 ;
...
struct V_4 * V_5 = F_2 ( V_6 ) ;
int V_195 ;
for ( V_195 = 0 ; V_195 < V_5 -> V_109 . V_110 ; V_195 ++ ) {
F_67 ( & V_5 -> V_109 , & V_5 -> V_100 [ V_195 ] . V_2 ) ;
V_5 -> V_16 -> V_184 ( & V_5 -> V_100 [ V_195 ] . V_2 , 0 ) ;
}
return 0 ;
}
static int T_3 F_68 ( struct V_11 * V_6 )
{
struct V_4 * V_5 = F_2 ( V_6 ) ;
int V_195 ;
for ( V_195 = 0 ; V_195 < V_5 -> V_109 . V_110 ; V_195 ++ ) {
V_5 -> V_16 -> V_184 ( & V_5 -> V_100 [ V_195 ] . V_2 , 1 ) ;
F_69 ( & V_5 -> V_109 , & V_5 -> V_100 [ V_195 ] . V_2 ) ;
}
return 0 ;
}
static int F_70 ( struct V_196 * V_197 , unsigned V_198 )
{
unsigned int V_7 ;
struct V_4 * V_5 = F_71 ( V_197 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
V_7 = F_1 ( V_2 , V_40 ) ;
return ! ! ( ( V_7 >> 4 ) & ( 1 << ( V_198 % 4 ) ) ) ;
}
static void F_72 ( struct V_196 * V_197 , unsigned V_198 , int V_199 )
{
struct V_4 * V_5 = F_71 ( V_197 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
F_6 ( V_2 , V_40 , 1 << ( V_198 % 4 ) ,
V_199 ? 1 << ( V_198 % 4 ) : 0 ) ;
}
...
struct V_4 * V_5 = F_71 ( V_197 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
F_6 ( V_2 , V_200 , 1 << ( V_198 % 4 ) , 0 ) ;
return 0 ;
}
static int F_74 ( struct V_196 * V_197 ,
unsigned V_198 , int V_199 )
{
struct V_4 * V_5 = F_71 ( V_197 ) ;
struct V_1 * V_2 = & V_5 -> V_100 [ V_198 / 4 ] . V_2 ;
F_6 ( V_2 , V_40 , 1 << ( V_198 % 4 ) ,
V_199 ? 1 << ( V_198 % 4 ) : 0 ) ;
F_6 ( V_2 , V_200 , 1 << ( V_198 % 4 ) ,
1 << ( V_198 % 4 ) ) ;
return 0 ;
}
static int F_75 ( struct V_11 * V_6 , struct V_201 * V_16 ,
struct V_8 * V_8 , int V_107 , unsigned long V_178 )
{
int V_195 , V_12 , V_202 , V_203 , V_54 , V_47 ;
struct V_46 * V_204 , * V_205 ;
struct V_4 * V_5 ;
bool V_55 = false ;
if ( F_76 ( V_8 ) )
return F_77 ( V_8 ) ;
V_5 = F_78 ( V_6 , sizeof( * V_5 ) +
sizeof( struct V_115 ) * V_16 -> V_110 , V_206 ) ;
if ( ! V_5 ) {
F_9 ( V_6 , L_4 ) ;
return - V_207 ;
}
...
if ( V_12 )
goto V_209;
for ( V_195 = 0 ; V_195 < V_16 -> V_110 ; V_195 ++ ) {
unsigned int V_211 = V_195 << 5 ;
F_5 ( V_5 -> V_8 , V_123 + V_211 ,
V_212 ) ;
F_5 ( V_5 -> V_8 , V_123 + V_211 , 0 ) ;
do {
F_3 ( V_5 -> V_8 ,
V_41 + V_211 , & V_12 ) ;
} while ( V_12 != 0x01 );
F_7 ( V_5 -> V_8 , V_28 + V_211 ,
V_213 ,
V_213 ) ;
}
V_47 = F_22 ( V_5 , V_54 , V_55 ) ;
F_83 ( V_6 , L_8 , V_47 ) ;
V_5 -> V_109 . V_214 = V_215 ;
V_5 -> V_109 . V_216 = L_9 ;
V_5 -> V_109 . V_217 = V_218 ;
V_5 -> V_109 . V_219 = V_220 ;
...
#ifdef F_85
V_5 -> V_221 . V_214 = V_215 ;
V_5 -> V_221 . V_222 = V_6 ;
V_5 -> V_221 . V_223 = V_216 ( V_6 ) ;
V_5 -> V_221 . V_224 = F_73 ;
V_5 -> V_221 . V_225 = F_70 ;
V_5 -> V_221 . V_226 = F_74 ;
V_5 -> V_221 . V_227 = F_72 ;
V_5 -> V_221 . V_228 = - 1 ;
V_5 -> V_221 . V_229 = V_16 -> V_110 * 4 ;
V_5 -> V_221 . V_230 = 1 ;
V_12 = F_86 ( & V_5 -> V_221 , V_5 ) ;
if ( V_12 )
goto V_231;
#endif
F_87 ( & V_5 -> V_106 ) ;
for ( V_195 = 0 ; V_195 < V_16 -> V_110 ; V_195 ++ ) {
V_5 -> V_100 [ V_195 ] . V_2 . line = V_195 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_6 = V_6 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_107 = V_107 ;
V_5 -> V_100 [ V_195 ] . V_2 . type = V_190 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_68 = V_232 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_178 = V_233 | V_234 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_235 = V_236 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_9 = V_195 * 0x20 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_237 = ( void V_238 * ) ~ 0 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_47 = V_47 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_239 = F_56 ;
V_5 -> V_100 [ V_195 ] . V_2 . V_240 = & V_241 ;
F_4 ( & V_5 -> V_100 [ V_195 ] . V_2 , V_189 , 0 ) ;
F_1 ( & V_5 -> V_100 [ V_195 ] . V_2 , V_33 ) ;
F_6 ( & V_5 -> V_100 [ V_195 ] . V_2 , V_28 ,
V_242 ,
V_242 ) ;
F_88 ( & V_5 -> V_100 [ V_195 ] . V_117 , F_43 ) ;
F_88 ( & V_5 -> V_100 [ V_195 ] . V_122 , F_50 ) ;
F_89 ( & V_5 -> V_109 , & V_5 -> V_100 [ V_195 ] . V_2 ) ;
V_16 -> V_184 ( & V_5 -> V_100 [ V_195 ] . V_2 , 0 ) ;
}
V_12 = F_90 ( V_6 , V_107 , NULL , F_40 ,
V_243 | V_178 , V_216 ( V_6 ) , V_5 ) ;
if ( ! V_12 )
return 0 ;
F_9 ( V_6 , L_11 , V_107 ) ;
F_91 ( & V_5 -> V_106 ) ;
...
static int F_95 ( struct V_11 * V_6 )
{
struct V_4 * V_5 = F_2 ( V_6 ) ;
int V_195 ;
#ifdef F_85
...
#endif
for ( V_195 = 0 ; V_195 < V_5 -> V_109 . V_110 ; V_195 ++ ) {
F_96 ( & V_5 -> V_100 [ V_195 ] . V_117 ) ;
F_96 ( & V_5 -> V_100 [ V_195 ] . V_122 ) ;
F_97 ( & V_5 -> V_109 , & V_5 -> V_100 [ V_195 ] . V_2 ) ;
V_5 -> V_16 -> V_184 ( & V_5 -> V_100 [ V_195 ] . V_2 , 0 ) ;
}
F_91 ( & V_5 -> V_106 ) ;
F_93 ( & V_5 -> V_109 ) ;
...
static int F_98 ( struct V_244 * V_245 )
{
struct V_201 * V_16 ;
...
int V_12 ;
V_245 -> V_246 = 8 ;
V_245 -> V_45 = V_245 -> V_45 ? : V_247 ;
V_245 -> V_248 = V_245 -> V_248 ? : 26000000 ;
V_12 = F_99 ( V_245 ) ;
if ( V_12 )
return V_12 ;
if ( V_245 -> V_6 . V_249 ) {
const struct V_250 * V_251 =
F_100 ( V_252 , & V_245 -> V_6 ) ;
V_16 = (struct V_201 * ) V_251 -> V_253 ;
} else {
const struct V_254 * V_255 = F_101 ( V_245 ) ;
V_16 = (struct V_201 * ) V_255 -> V_256 ;
V_178 = V_257 ;
}
V_258 . V_259 = V_16 -> V_110 * 0x20 - 1 ;
V_8 = F_102 ( V_245 , & V_258 ) ;
return F_75 ( & V_245 -> V_6 , V_16 , V_8 , V_245 -> V_107 , V_178 ) ;
}
static int F_103 ( struct V_244 * V_245 )
{
return F_95 ( & V_245 -> V_6 ) ;
}
