...
static struct V_18 *
F_17 ( struct V_63 * V_64 , T_4 V_65 )
{
struct V_18 * V_19 ;
...
static struct V_13 *
F_19 ( struct V_18 * V_19 , T_4 V_65 )
{
unsigned int V_3 ;
...
int V_95 ;
struct V_116 V_117 ;
F_58 ( & V_117 , V_118 , V_119 ) ;
V_95 = F_59 ( V_110 , V_10 , V_113 , V_114 , & V_117 , V_115 ) ;
if ( V_95 < 0 )
return V_95 ;
V_95 = - V_96 ;
if ( V_113 [ V_120 ] ) {
T_4 V_65 = F_60 ( V_113 [ V_120 ] ) ;
struct V_18 * V_47 = NULL , * V_121 ;
if ( F_23 ( V_65 ) )
goto V_122;
if ( V_65 ) {
