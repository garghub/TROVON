...
if ( V_97 && V_97 -> V_92 )
V_97 -> V_92 ( V_9 , V_54 ) ;
F_64 (plane, crtc->dev, plane_mask) {
struct V_3 * V_77 =
F_36 ( V_52 , V_6 ) ;
...
if ( V_20 != 0 )
return V_20 ;
F_85 ( V_121 -> V_39 , & V_125 , & V_126 ) ;
F_73 ( V_124 , V_121 -> V_76 ) ;
V_124 -> V_107 = 0 ;
V_124 -> V_108 = 0 ;
V_124 -> V_109 = V_125 ;
V_124 -> V_110 = V_126 ;
...
if ( V_124 -> V_127 & ( F_86 ( V_128 ) | F_86 ( V_129 ) ) ) {
...
struct V_1 * F_88 ( struct V_44 * V_45 )
{
struct V_130 V_131 ;
struct V_1 * V_2 ;
int V_133 ;
...
{
F_3 ( V_15 -> V_146 [ 1 ] ) ;
return F_111 ( V_15 -> V_45 , V_15 -> V_146 [ 0 ] ) ;
}
void F_112 ( struct V_33 * V_9 )
{
if ( V_9 -> V_2 )
F_113 ( V_9 -> V_2 ) ;
F_114 ( V_9 -> V_2 ) ;
V_9 -> V_2 = F_115 ( sizeof( * V_9 -> V_2 ) , V_147 ) ;
if ( V_9 -> V_2 )
V_9 -> V_2 -> V_9 = V_9 ;
}
void F_116 ( struct V_33 * V_9 ,
struct V_7 * V_2 )
{
...
struct V_7 *
F_118 ( struct V_33 * V_9 )
{
struct V_7 * V_2 ;
if ( F_3 ( ! V_9 -> V_2 ) )
return NULL ;
V_2 = F_119 ( sizeof( * V_2 ) , V_147 ) ;
if ( V_2 )
F_116 ( V_9 , V_2 ) ;
return V_2 ;
}
void F_113 ( struct V_7 * V_2 )
{
F_120 ( V_2 -> V_148 ) ;
F_120 ( V_2 -> V_149 ) ;
F_120 ( V_2 -> V_150 ) ;
...
F_123 ( V_6 -> V_2 ) ;
F_114 ( V_6 -> V_2 ) ;
V_6 -> V_2 = F_115 ( sizeof( * V_6 -> V_2 ) , V_147 ) ;
if ( V_6 -> V_2 ) {
V_6 -> V_2 -> V_6 = V_6 ;
V_6 -> V_2 -> V_127 = F_86 ( V_153 ) ;
}
}
...
void F_138 ( struct V_33 * V_9 ,
T_3 * V_154 , T_3 * V_155 , T_3 * V_156 ,
T_1 V_157 , T_1 V_158 )
{
...
V_162 = (struct V_161 * ) V_160 -> V_163 ;
for ( V_19 = 0 ; V_19 < V_158 ; V_19 ++ ) {
V_162 [ V_19 ] . V_154 = V_154 [ V_19 ] ;
V_162 [ V_19 ] . V_155 = V_155 [ V_19 ] ;
V_162 [ V_19 ] . V_156 = V_156 [ V_19 ] ;
}
V_2 -> V_114 = V_9 -> V_45 -> V_61 . V_114 ;
V_115:
V_8 = F_83 ( V_2 , V_9 ) ;
