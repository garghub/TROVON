...
switch ( V_62 -> V_77 ) {
case V_65 :
V_93 = F_35 ( 0 , V_91 -> V_95 * V_96 ) ;
V_2 -> V_97 = V_98 + V_99 ;
goto V_100;
case V_101 :
case V_80 :
V_93 = F_35 ( 0 , V_91 -> V_102 * V_96 ) ;
V_2 -> V_97 = V_98 + V_99 ;
goto V_100;
default:
break;
...
case V_80 :
if ( ! V_92 ) {
V_93 = F_35 ( 0 , ( V_91 -> V_103 + V_91 -> V_104 ) *
V_96 ) ;
goto V_100;
}
break;
...
static int
F_39 ( struct V_1 * V_2 , unsigned int V_82 )
{
unsigned long V_13 ;
...
V_126 = V_69 [ 1 ] ;
if ( ! F_50 ( V_126 ) ) {
F_51 ( & V_2 -> V_66 -> V_15 , L_4 ) ;
V_126 = V_128 ;
}
V_127 = V_69 [ 2 + V_126 ] ;
V_125 = F_52 ( V_128 ) ;
if ( ! V_125 ) {
F_51 ( & V_2 -> V_66 -> V_15 , L_5 ) ;
F_20 ( V_62 ) ;
return;
}
memcpy ( F_53 ( V_125 , V_126 ) , V_69 + 2 , V_126 ) ;
F_54 ( V_2 -> V_63 , V_125 , V_127 ) ;
F_20 ( V_62 ) ;
}
static void
F_55 ( void * V_60 )
...
F_61 ( & V_82 -> V_132 , & V_82 -> V_72 ) ;
F_62 ( & V_82 -> V_88 , V_137 , V_107 ) ;
V_82 -> V_88 . V_138 = F_32 ;
}
static T_3 F_63 ( int V_134 , void * V_4 )
{
struct V_1 * V_2 = V_4 ;
struct V_61 * V_62 ;
int V_13 ;
F_64 ( V_134 ) ;
V_62 = F_65 ( sizeof( * V_62 ) , V_139 ) ;
if ( ! V_62 ) {
F_58 ( V_134 ) ;
return V_140 ;
}
...
static int
F_70 ( struct V_144 * V_63 , struct V_124 * V_125 )
{
...
static int
F_72 ( struct V_144 * V_63 , T_1 * V_147 )
{
F_73 ( ! V_147 ) ;
* V_147 = 0xbe ;
return 0 ;
...
static void
F_75 ( struct V_144 * V_63 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
T_1 V_149 [ 2 ] ;
F_39 ( V_2 , V_67 ) ;
F_76 ( V_2 -> V_66 -> V_134 ) ;
F_77 ( V_149 , F_78 ( V_149 ) ) ;
F_11 ( V_2 , V_150 , V_149 [ 0 ] ) ;
F_11 ( V_2 , V_151 , V_149 [ 1 ] ) ;
F_1 ( V_2 ) ;
}
static int
F_79 ( struct V_1 * V_2 , T_1 V_152 , T_1 V_153 )
{
return F_11 ( V_2 , V_154 , V_153 ) ;
}
static inline int
F_80 ( struct V_1 * V_2 , int V_155 )
{
unsigned int V_156 ;
int V_13 ;
...
V_2 -> V_63 -> V_158 -> V_159 . V_162 = F_78 ( V_161 ) ;
V_2 -> V_63 -> V_158 -> V_163 = V_161 [ V_156 ] ;
break;
case - 100 :
V_2 -> V_63 -> V_158 -> V_159 . V_160 = V_164 ;
V_2 -> V_63 -> V_158 -> V_159 . V_162 = F_78 ( V_164 ) ;
...
static int
F_82 ( struct V_1 * V_2 , T_1 V_152 , T_1 V_153 )
{
int V_13 ;
if ( V_153 == 0 )
...
static int
F_83 ( struct V_144 * V_63 , T_1 V_152 , T_1 V_153 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
int V_13 ;
...
static int
F_84 ( struct V_144 * V_63 ,
struct V_174 * V_175 ,
unsigned long V_176 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
if ( V_176 & V_177 ) {
T_4 V_8 = F_85 ( V_175 -> V_178 ) ;
F_51 ( & V_2 -> V_66 -> V_15 ,
L_8 ) ;
F_6 ( V_2 , V_37 , V_8 ) ;
F_6 ( V_2 , V_38 , V_8 >> 8 ) ;
...
static int
F_88 ( struct V_144 * V_63 , T_5 V_188 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
return V_2 -> V_4 -> V_194 ( V_2 , V_188 ) ;
}
static int
F_89 ( struct V_144 * V_63 , bool V_195 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
return F_11 ( V_2 , V_196 , V_195 ) ;
}
static int
F_90 ( struct V_144 * V_63 ,
...
static int
F_91 ( struct V_144 * V_63 , T_5 V_188 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
T_6 V_183 ;
...
static int
F_92 ( struct V_144 * V_63 , T_1 V_207 , T_1 V_208 ,
T_1 V_209 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
int V_13 ;
...
static int
F_93 ( struct V_144 * V_63 , T_7 V_209 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
return F_11 ( V_2 , V_213 , V_209 ) ;
}
static int
F_94 ( struct V_144 * V_63 , const bool V_195 )
{
struct V_1 * V_2 = V_63 -> V_145 ;
int V_13 ;
if ( V_195 ) {
...
static int F_95 ( struct V_1 * V_2 , T_1 V_216 )
{
...
static int
F_97 ( struct V_234 * V_66 , int * V_235 , int * V_3 ,
T_1 * V_216 )
{
struct V_236 * V_237 = V_66 -> V_15 . V_238 ;
int V_9 ;
if ( ! F_46 ( V_239 ) || ! V_66 -> V_15 . V_240 ) {
if ( ! V_237 )
return - V_241 ;
* V_235 = V_237 -> V_235 ;
* V_3 = V_237 -> V_3 ;
...
* V_235 = F_98 ( V_66 -> V_15 . V_240 , L_13 , 0 ) ;
* V_3 = F_98 ( V_66 -> V_15 . V_240 , L_14 , 0 ) ;
V_9 = F_99 ( V_66 -> V_15 . V_240 , L_15 , V_216 ) ;
if ( V_9 < 0 && V_9 != - V_192 )
return V_9 ;
return 0 ;
}
...
V_253 |
V_254 ;
V_2 -> V_63 -> V_158 -> V_159 . V_255 = F_101 ( V_200 ) |
F_101 ( V_201 ) | F_101 ( V_202 ) ;
V_2 -> V_63 -> V_158 -> V_159 . V_256 = F_101 ( V_204 ) |
F_101 ( V_205 ) ;
V_2 -> V_63 -> V_158 -> V_159 . V_160 = V_257 ;
V_2 -> V_63 -> V_158 -> V_159 . V_162 = F_78 ( V_257 ) ;
...
V_245 = L_18 ;
V_2 -> V_4 = & V_260 ;
V_2 -> V_63 -> V_158 -> V_159 . V_261 [ 0 ] = 0x7FFF800 ;
V_2 -> V_63 -> V_158 -> V_262 = 11 ;
V_2 -> V_63 -> V_158 -> V_167 = 16 ;
V_2 -> V_63 -> V_158 -> V_159 . V_190 = V_263 ;
V_2 -> V_63 -> V_158 -> V_159 . V_189 = F_78 ( V_263 ) ;
break;
case 7 :
V_245 = L_19 ;
V_2 -> V_4 = & V_264 ;
V_2 -> V_63 -> V_246 |= V_265 ;
V_2 -> V_63 -> V_158 -> V_159 . V_261 [ 0 ] = 0x00007FF ;
V_2 -> V_63 -> V_158 -> V_159 . V_261 [ 2 ] = 0x00007FF ;
V_2 -> V_63 -> V_158 -> V_262 = 5 ;
V_2 -> V_63 -> V_158 -> V_167 = 25 ;
V_2 -> V_63 -> V_158 -> V_159 . V_266 = V_267 ;
V_2 -> V_63 -> V_158 -> V_159 . V_190 = V_268 ;
V_2 -> V_63 -> V_158 -> V_159 . V_189 = F_78 ( V_268 ) ;
V_2 -> V_63 -> V_158 -> V_159 . V_160 = V_164 ;
V_2 -> V_63 -> V_158 -> V_159 . V_162 = F_78 ( V_164 ) ;
break;
case 11 :
...
V_2 -> V_4 = & V_269 ;
V_2 -> V_63 -> V_158 -> V_159 . V_261 [ 0 ] = 0x7FFF800 ;
V_2 -> V_63 -> V_158 -> V_262 = 13 ;
V_2 -> V_63 -> V_158 -> V_167 = 16 ;
V_2 -> V_63 -> V_158 -> V_159 . V_190 = V_270 ;
V_2 -> V_63 -> V_158 -> V_159 . V_189 = F_78 ( V_270 ) ;
break;
default:
V_245 = L_21 ;
V_13 = - V_258 ;
...
V_2 -> V_63 -> V_158 -> V_271 = V_2 -> V_63 -> V_158 -> V_159 . V_190 [ 0 ] ;
V_259:
F_102 ( & V_2 -> V_66 -> V_15 , L_22 , V_245 , V_243 ) ;
return V_13 ;
}
static int F_103 ( struct V_272 * V_273 , void * V_274 )
{
struct V_1 * V_2 = V_273 -> V_275 ;
F_104 ( V_273 , L_23 , V_2 -> V_113 . V_115 ) ;
F_104 ( V_273 , L_24 ,
V_2 -> V_113 . V_117 ) ;
F_104 ( V_273 , L_25 ,
V_2 -> V_113 . V_130 ) ;
F_104 ( V_273 , L_26 ,
V_2 -> V_113 . V_119 ) ;
F_104 ( V_273 , L_27 , V_2 -> V_113 . V_121 ) ;
F_104 ( V_273 , L_28 , V_2 -> V_113 . V_123 ) ;
return 0 ;
}
static int F_105 ( struct V_276 * V_276 , struct V_273 * V_273 )
{
return F_106 ( V_273 , F_103 , V_276 -> V_277 ) ;
}
static int F_107 ( struct V_1 * V_2 )
{
char V_278 [ V_279 + 1 ] = L_29 ;
struct V_280 * V_281 ;
strncat ( V_278 , F_108 ( & V_2 -> V_66 -> V_15 ) , V_279 ) ;
V_282 = F_109 ( V_278 , NULL ) ;
if ( ! V_282 )
return - V_283 ;
V_281 = F_110 ( L_30 , V_284 ,
V_282 , V_2 ,
& V_285 ) ;
if ( ! V_281 )
return - V_283 ;
...
static int F_107 ( struct V_1 * V_2 ) { return 0 ; }
static void F_111 ( void ) { }
static int F_113 ( struct V_234 * V_66 )
{
struct V_144 * V_63 ;
struct V_1 * V_2 ;
unsigned int V_286 ;
...
V_13 = F_97 ( V_66 , & V_235 , & V_3 , & V_216 ) ;
if ( V_13 < 0 ) {
F_25 ( & V_66 -> V_15 , L_32 , V_13 ) ;
return V_13 ;
}
if ( F_2 ( V_235 ) ) {
V_13 = F_114 ( & V_66 -> V_15 , V_235 ,
V_287 , L_33 ) ;
if ( V_13 )
return V_13 ;
}
if ( F_2 ( V_3 ) ) {
V_13 = F_114 ( & V_66 -> V_15 , V_3 ,
V_288 , L_34 ) ;
if ( V_13 )
return V_13 ;
}
...
V_2 -> V_66 = V_66 ;
V_2 -> V_3 = V_3 ;
V_63 -> V_290 = & V_66 -> V_15 ;
F_116 ( & V_63 -> V_158 -> V_291 ) ;
V_2 -> V_10 = F_117 ( V_66 , & V_292 ) ;
if ( F_118 ( V_2 -> V_10 ) ) {
V_13 = F_119 ( V_2 -> V_10 ) ;
F_25 ( & V_66 -> V_15 , L_35 ,
V_13 ) ;
...
if ( V_13 )
goto V_293;
V_217 = F_96 ( V_66 -> V_134 ) ;
if ( ! V_217 )
V_217 = V_294 ;
V_13 = F_122 ( & V_66 -> V_15 , V_66 -> V_134 , F_63 ,
V_295 | V_217 , F_108 ( & V_66 -> V_15 ) , V_2 ) ;
if ( V_13 )
goto V_293;
F_76 ( V_66 -> V_134 ) ;
F_1 ( V_2 ) ;
