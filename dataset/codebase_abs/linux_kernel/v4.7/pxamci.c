...
F_12 ( V_2 ) ;
F_14 ( 0 , V_2 -> V_19 + V_198 ) ;
F_14 ( 64 , V_2 -> V_19 + V_199 ) ;
F_14 ( V_2 -> V_29 , V_2 -> V_19 + V_30 ) ;
...
F_75 ( V_160 , V_4 ) ;
if ( ! V_160 -> V_73 . V_163 ) {
V_172 = F_64 ( V_160 , V_201 , 0 ) ;
V_173 = F_64 ( V_160 , V_201 , 1 ) ;
if ( ! V_172 || ! V_173 ) {
V_13 = - V_202 ;
goto V_180;
}
V_175 . V_203 = V_204 ;
V_175 . V_205 = V_172 -> V_57 ;
V_176 . V_203 = V_204 ;
V_176 . V_205 = V_173 -> V_57 ;
}
F_76 ( V_26 ) ;
F_77 ( V_206 , V_26 ) ;
V_2 -> V_67 =
...
if ( V_2 -> V_6 && V_2 -> V_6 -> V_212 )
V_2 -> V_6 -> V_212 ( & V_160 -> V_73 , F_56 , V_4 ) ;
