...
static void F_72 ( struct V_4 * V_5 , unsigned V_16 , int V_100 )
{
struct V_1 * V_6 ;
unsigned long V_60 ;
V_6 = F_3 ( V_5 ) ;
...
static void T_4 F_73 ( struct V_1 * V_6 )
{
static bool V_101 ;
T_2 V_102 ;
if ( V_101 || V_6 -> V_12 -> V_103 == V_104 )
return;
V_102 = F_74 ( V_6 -> V_10 + V_6 -> V_12 -> V_103 ) ;
F_75 ( L_1 ,
...
static int F_77 ( struct V_1 * V_6 , struct V_106 * V_107 )
{
static int V_7 ;
int V_108 = 0 ;
int V_109 ;
...
V_7 += V_6 -> V_68 ;
#ifdef F_81
V_108 = F_82 ( - 1 , 0 , V_6 -> V_68 , 0 ) ;
if ( V_108 < 0 ) {
F_80 ( V_6 -> V_5 . V_75 , L_5 ) ;
return - V_118 ;
}
#endif
if ( V_6 -> V_105 ) {
...
F_85 ( & V_6 -> V_5 , V_107 , V_6 -> V_74 , NULL ) ;
V_109 = F_86 ( V_6 -> V_5 . V_75 , V_6 -> V_74 ,
F_46 ,
0 , F_87 ( V_6 -> V_5 . V_75 ) , V_6 ) ;
if ( V_109 )
F_84 ( & V_6 -> V_5 ) ;
return V_109 ;
}
...
struct V_106 * V_107 ;
int V_109 ;
V_127 = F_89 ( F_90 ( V_132 ) , V_91 ) ;
V_129 = V_127 ? V_127 -> V_89 : F_91 ( V_91 ) ;
if ( ! V_129 )
return - V_51 ;
V_6 = F_92 ( V_91 , sizeof( struct V_1 ) , V_133 ) ;
if ( ! V_6 ) {
F_80 ( V_91 , L_7 ) ;
return - V_134 ;
}
V_107 = F_92 ( V_91 , sizeof( * V_107 ) , V_133 ) ;
if ( ! V_107 )
return - V_134 ;
V_107 -> V_135 = F_51 ,
V_107 -> V_136 = F_53 ,
...
V_107 -> V_140 = F_54 ,
V_107 -> V_141 = F_55 ,
V_107 -> V_142 = F_87 ( & V_93 -> V_91 ) ;
V_107 -> V_60 = V_143 ;
V_6 -> V_74 = F_93 ( V_93 , 0 ) ;
if ( V_6 -> V_74 <= 0 ) {
if ( ! V_6 -> V_74 )
V_6 -> V_74 = - V_144 ;
if ( V_6 -> V_74 != - V_145 )
...
V_6 -> V_5 . V_146 = V_147 ;
V_6 -> V_31 = V_129 -> V_31 ;
V_6 -> V_96 = V_129 -> V_148 ;
V_6 -> V_68 = V_129 -> V_149 ;
V_6 -> V_105 = V_129 -> V_105 ;
V_6 -> V_42 = V_129 -> V_42 ;
V_6 -> V_12 = V_129 -> V_12 ;
#ifdef F_94
V_6 -> V_5 . V_125 = F_95 ( V_124 ) ;
#endif
if ( V_124 ) {
if ( ! F_96 ( V_124 , L_9 ) )
V_6 -> V_150 = true ;
} else {
V_6 -> V_150 = V_129 -> V_150 ;
if ( V_6 -> V_150 )
V_6 -> V_151 =
V_129 -> V_151 ;
}
...
F_97 ( & V_6 -> V_62 ) ;
F_97 ( & V_6 -> V_84 ) ;
V_131 = F_98 ( V_93 , V_152 , 0 ) ;
V_6 -> V_10 = F_99 ( V_91 , V_131 ) ;
if ( F_100 ( V_6 -> V_10 ) ) {
return F_101 ( V_6 -> V_10 ) ;
}
if ( V_6 -> V_31 ) {
V_6 -> V_27 = F_102 ( V_91 , L_10 ) ;
if ( F_100 ( V_6 -> V_27 ) ) {
F_80 ( V_91 ,
L_11 ) ;
V_6 -> V_31 = false ;
...
static int F_112 ( struct V_90 * V_91 )
{
struct V_92 * V_93 = F_60 ( V_91 ) ;
struct V_1 * V_6 = F_61 ( V_93 ) ;
T_2 V_154 = 0 , V_155 = 0 ;
...
T_2 V_156 , V_157 ;
F_31 ( & V_6 -> V_62 , V_60 ) ;
V_156 = V_6 -> V_14 . V_34 & V_6 -> V_14 . V_44 ;
if ( V_156 )
F_7 ( V_156 | V_6 -> V_14 . V_40 ,
V_6 -> V_10 + V_6 -> V_12 -> V_40 ) ;
V_157 = V_6 -> V_14 . V_36 & V_6 -> V_14 . V_44 ;
if ( V_157 )
F_7 ( V_157 | V_6 -> V_14 . V_38 ,
...
V_6 -> V_161 = F_5 ( V_6 -> V_10 +
V_6 -> V_12 -> V_22 ) ;
V_154 = V_6 -> V_14 . V_40 ;
V_155 = V_6 -> V_14 . V_38 ;
V_154 &= ~ V_6 -> V_47 ;
V_155 &= ~ V_6 -> V_47 ;
F_7 ( V_154 , V_6 -> V_10 + V_6 -> V_12 -> V_40 ) ;
F_7 ( V_155 , V_6 -> V_10 + V_6 -> V_12 -> V_38 ) ;
V_6 -> V_162 = true ;
V_158:
if ( V_6 -> V_151 )
V_6 -> V_163 =
...
static int F_113 ( struct V_90 * V_91 )
{
struct V_92 * V_93 = F_60 ( V_91 ) ;
struct V_1 * V_6 = F_61 ( V_93 ) ;
T_2 V_11 = 0 , V_164 , V_165 , V_166 ;
unsigned long V_60 ;
int V_167 ;
F_31 ( & V_6 -> V_62 , V_60 ) ;
if ( V_6 -> V_150 && ! V_6 -> V_168 ) {
F_114 ( V_6 ) ;
if ( V_6 -> V_151 )
V_6 -> V_163 =
V_6 -> V_151 ( V_91 ) ;
...
V_11 ^= V_6 -> V_161 ;
V_11 &= V_6 -> V_47 ;
V_165 = V_11 & V_6 -> V_14 . V_40 ;
V_165 &= V_6 -> V_161 ;
V_166 = V_11 & V_6 -> V_14 . V_38 ;
V_166 &= ~ ( V_6 -> V_161 ) ;
...
if ( V_164 ) {
T_2 V_169 , V_170 ;
V_169 = F_5 ( V_6 -> V_10 + V_6 -> V_12 -> V_34 ) ;
V_170 = F_5 ( V_6 -> V_10 + V_6 -> V_12 -> V_36 ) ;
if ( ! V_6 -> V_12 -> V_171 ) {
F_7 ( V_169 | V_164 , V_6 -> V_10 +
V_6 -> V_12 -> V_34 ) ;
F_7 ( V_170 | V_164 , V_6 -> V_10 +
V_6 -> V_12 -> V_36 ) ;
}
if ( V_6 -> V_12 -> V_171 ) {
F_7 ( V_169 | V_11 , V_6 -> V_10 +
V_6 -> V_12 -> V_34 ) ;
F_7 ( V_170 | V_11 , V_6 -> V_10 +
V_6 -> V_12 -> V_36 ) ;
}
F_7 ( V_169 , V_6 -> V_10 + V_6 -> V_12 -> V_34 ) ;
F_7 ( V_170 , V_6 -> V_10 + V_6 -> V_12 -> V_36 ) ;
}
V_6 -> V_162 = false ;
F_32 ( & V_6 -> V_62 , V_60 ) ;
return 0 ;
}
void F_116 ( int V_172 )
{
struct V_1 * V_6 ;
F_117 (bank, &omap_gpio_list, node) {
if ( ! F_25 ( V_6 ) || ! V_6 -> V_150 )
continue;
V_6 -> V_159 = V_172 ;
F_118 ( V_6 -> V_5 . V_75 ) ;
}
...
static void F_114 ( struct V_1 * V_173 )
{
struct V_174 * V_12 = V_173 -> V_12 ;
void T_1 * V_10 = V_173 -> V_10 ;
V_173 -> V_14 . V_55 = F_5 ( V_10 + V_12 -> V_55 ) ;
V_173 -> V_14 . V_15 = F_5 ( V_10 + V_12 -> V_13 ) ;
V_173 -> V_14 . V_44 = F_5 ( V_10 + V_12 -> V_43 ) ;
V_173 -> V_14 . V_34 = F_5 ( V_10 + V_12 -> V_34 ) ;
V_173 -> V_14 . V_36 = F_5 ( V_10 + V_12 -> V_36 ) ;
V_173 -> V_14 . V_38 = F_5 ( V_10 + V_12 -> V_38 ) ;
V_173 -> V_14 . V_40 = F_5 ( V_10 + V_12 -> V_40 ) ;
V_173 -> V_14 . V_72 = F_5 ( V_10 + V_12 -> V_69 ) ;
V_173 -> V_14 . V_175 = F_5 ( V_10 + V_12 -> V_175 ) ;
if ( V_12 -> V_18 && V_173 -> V_12 -> V_20 )
V_173 -> V_14 . V_19 = F_5 ( V_10 + V_12 -> V_18 ) ;
else
V_173 -> V_14 . V_19 = F_5 ( V_10 + V_12 -> V_19 ) ;
V_173 -> V_168 = true ;
}
static void F_115 ( struct V_1 * V_6 )
{
F_7 ( V_6 -> V_14 . V_44 ,
...
F_7 ( V_6 -> V_14 . V_175 ,
V_6 -> V_10 + V_6 -> V_12 -> V_175 ) ;
}
static inline void F_114 ( struct V_1 * V_173 ) {}
