...
F_135 ( V_4 ) ;
if ( V_17 -> V_33 -> V_177 ) {
V_150 = V_17 -> V_33 -> V_177 ( V_17 -> V_4 ) ;
if ( V_150 )
goto V_178;
}
V_150 = F_57 ( V_17 ) ;
...
goto V_178;
if ( F_65 ( V_17 -> V_88 ) ) {
char * V_181 = F_138 ( V_3 , 16 , V_182 ) ;
if ( ! V_181 ) {
V_150 = - V_152 ;
goto V_183;
}
snprintf ( V_181 , 16 , L_7 , F_133 ( V_4 ) ) ;
V_17 -> V_184 = F_139 ( V_17 -> V_88 ) ;
if ( F_140 ( V_17 -> V_184 , F_105 ,
V_185 |
V_186 ,
V_181 , V_17 -> V_4 ) < 0 )
V_17 -> V_88 = - V_71 ;
...
static int F_148 ( struct V_148 * V_3 )
{
struct V_2 * V_4 = F_145 ( V_3 ) ;
struct V_16 * V_17 = F_15 ( V_4 ) ;
if ( F_106 ( V_4 ) ) {
...
static int F_150 ( struct V_148 * V_3 )
{
struct V_2 * V_4 = F_145 ( V_3 ) ;
struct V_16 * V_17 = F_15 ( V_4 ) ;
if ( F_106 ( V_4 ) ) {
