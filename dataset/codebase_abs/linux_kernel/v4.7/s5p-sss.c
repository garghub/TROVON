...
struct V_12 * V_116 ;
struct V_117 * V_5 = & V_3 -> V_5 ;
struct V_118 * V_119 ;
struct V_1 * V_120 ;
if ( V_110 )
return - V_121 ;
V_116 = F_73 ( V_5 , sizeof( * V_116 ) , V_122 ) ;
if ( ! V_116 )
return - V_41 ;
V_119 = F_74 ( V_3 , V_123 , 0 ) ;
V_116 -> V_124 = F_75 ( & V_3 -> V_5 , V_119 ) ;
if ( F_76 ( V_116 -> V_124 ) )
return F_77 ( V_116 -> V_124 ) ;
V_120 = F_1 ( V_3 ) ;
V_116 -> V_125 = F_78 ( V_5 , L_5 ) ;
if ( F_76 ( V_116 -> V_125 ) ) {
F_64 ( V_5 , L_6 ) ;
return - V_126 ;
}
V_27 = F_79 ( V_116 -> V_125 ) ;
if ( V_27 < 0 ) {
F_64 ( V_5 , L_7 , V_27 ) ;
return V_27 ;
}
F_80 ( & V_116 -> V_52 ) ;
V_116 -> V_62 = V_116 -> V_124 + V_120 -> V_127 ;
V_116 -> V_128 = F_81 ( V_3 , 0 ) ;
if ( V_116 -> V_128 < 0 ) {
V_27 = V_116 -> V_128 ;
F_82 ( V_5 , L_8 ) ;
goto V_129;
}
V_27 = F_83 ( V_5 , V_116 -> V_128 , F_38 ,
V_130 , V_3 -> V_131 , V_3 ) ;
if ( V_27 < 0 ) {
F_82 ( V_5 , L_8 ) ;
goto V_129;
...
F_84 ( V_3 , V_116 ) ;
V_110 = V_116 ;
F_85 ( & V_116 -> V_45 , F_53 , ( unsigned long ) V_116 ) ;
F_86 ( & V_116 -> V_102 , V_132 ) ;
for ( V_113 = 0 ; V_113 < F_87 ( V_133 ) ; V_113 ++ ) {
V_27 = F_88 ( & V_133 [ V_113 ] ) ;
if ( V_27 )
goto V_134;
}
F_89 ( V_5 , L_9 ) ;
return 0 ;
V_134:
F_64 ( V_5 , L_10 , V_133 [ V_113 ] . V_135 , V_27 ) ;
