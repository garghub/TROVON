...
if ( ! F_45 ( V_5 -> V_2 . V_4 ) )
return - V_50 ;
if ( F_49 ( V_7 , V_51 , V_30 , sizeof( * V_30 ) ) )
return - V_39 ;
...
static unsigned long F_63 ( T_6 V_60 )
{
unsigned long V_61 = F_64 ( V_60 ) ;
return F_65 ( V_61 ) ;
}
static unsigned long F_66 ( T_6 V_60 )
{
unsigned long V_62 = F_64 ( V_63 ) ;
unsigned long V_61 = F_64 ( V_60 ) ;
V_62 += V_61 - F_65 ( V_61 ) ;
return V_62 ;
}
static struct V_64 * F_67 ( struct V_5 * V_5 ,
...
V_38 += V_34 ;
V_73 = F_35 ( & V_36 -> V_37 ) ;
V_69 = ( V_73 - V_34 - V_40 - V_63 ) / V_51 ;
if ( V_5 -> V_15 == V_17 ) {
unsigned long V_79 ;
V_79 = F_75 ( 64 * V_69 , V_41 ) ;
V_31 = F_75 ( V_38 + V_63 + V_79 + V_71 ,
V_5 -> V_25 ) - V_38 ;
...
V_30 -> V_34 = F_76 ( V_34 ) ;
V_30 -> V_40 = F_76 ( V_40 ) ;
V_30 -> V_25 = F_76 ( V_5 -> V_25 ) ;
V_47 = F_51 ( (struct V_54 * ) V_30 ) ;
V_30 -> V_47 = F_52 ( V_47 ) ;
return F_78 ( V_7 , V_51 , V_30 , sizeof( * V_30 ) ) ;
}
struct V_64 * F_79 ( struct V_5 * V_5 ,
struct V_65 * V_37 , struct V_64 * V_66 )
{
int V_19 ;
if ( ! V_5 -> V_10 || ! V_5 -> V_7 )
