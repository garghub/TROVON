...
struct V_66 * V_65 ;
V_65 = F_18 ( sizeof( struct V_66 ) , V_67 ) ;
if ( V_65 ) {
V_65 -> V_68 = V_69 ;
V_65 -> V_70 = V_71 ;
}
...
static int F_20 ( struct V_37 * V_38 , int V_56 )
{
struct V_57 * V_58 = V_38 -> V_59 ;
V_58 -> V_63 -- ;
...
static int F_24 ( struct V_75 * V_2 ,
struct V_76 * V_77 ,
unsigned V_78 , unsigned V_79 ,
struct V_80 * V_81 ,
unsigned V_82 )
{
struct V_1 * V_60 = F_25 ( V_2 ) ;
int V_13 ;
int V_14 = 0 ;
F_26 ( V_2 -> V_8 ) ;
if ( ! V_60 -> V_24 )
...
V_14 = F_27 ( V_60 -> V_25 -> V_9 . V_84 -> V_85 ,
V_86 ) ;
if ( V_14 )
goto V_83;
}
...
static void F_30 ( struct V_75 * V_2 )
{
struct V_1 * V_60 = F_25 ( V_2 ) ;
if ( V_60 -> V_25 )
F_31 ( & V_60 -> V_25 -> V_9 ) ;
...
V_38 -> V_59 = V_58 ;
V_14 = F_33 ( V_8 , & V_58 -> V_60 , & V_91 , V_25 ) ;
if ( V_14 )
goto V_105;
V_2 = & V_58 -> V_60 . V_9 ;
V_58 -> V_95 . V_2 = V_2 ;
...
V_38 -> V_73 = & V_110 ;
F_44 ( V_38 , V_2 -> V_31 [ 0 ] , V_2 -> V_111 ) ;
F_45 ( V_38 , & V_58 -> V_95 , V_97 -> V_112 , V_97 -> V_113 ) ;
F_46 ( L_7 ,
V_2 -> V_5 , V_2 -> V_6 ,
V_58 -> V_60 . V_25 -> V_26 ) ;
return V_14 ;
...
struct V_57 * V_58 ;
int V_14 ;
V_58 = F_53 ( sizeof( struct V_57 ) , V_67 ) ;
if ( ! V_58 )
return - V_27 ;
V_11 -> V_116 = V_58 ;
F_54 ( V_8 , & V_58 -> V_95 , & V_117 ) ;
V_14 = F_55 ( V_8 , & V_58 -> V_95 ,
1 , 1 ) ;
if ( V_14 )
goto free;
V_14 = F_56 ( & V_58 -> V_95 ) ;
...
V_60 = F_53 ( sizeof( * V_60 ) , V_67 ) ;
if ( V_60 == NULL )
return F_64 ( - V_27 ) ;
V_14 = F_33 ( V_8 , V_60 , V_91 , F_65 ( V_25 ) ) ;
if ( V_14 ) {
F_22 ( V_60 ) ;
return F_64 ( - V_28 ) ;
}
