...
static struct V_416 * F_89 ( struct V_401
* V_402 )
{
struct V_1 * V_2 = F_79 ( V_402 , struct V_1 ,
V_402 ) ;
...
static void F_90 ( struct V_401 * V_402 )
{
F_91 ( V_402 ) ;
F_92 ( V_402 ) ;
}
static void F_93 ( struct V_401 * V_402 )
{
struct V_1 * V_2 = F_79 ( V_402 , struct V_1 ,
V_402 ) ;
F_21 ( & V_2 -> V_399 ) ;
...
static T_4 F_94 ( int V_418 , void * V_419 )
{
...
static int F_97 ( struct V_436 * V_437 , struct V_1 * V_2 )
{
struct V_416 * V_417 = V_2 -> V_417 ;
struct V_395 * V_396 ;
int V_212 ;
V_396 = F_98 ( V_437 -> V_29 , sizeof( * V_396 ) , V_438 ) ;
if ( ! V_396 ) {
F_99 ( L_15 ) ;
return - V_439 ;
}
...
F_101 ( & V_2 -> V_402 ,
& V_444 ) ;
if ( F_102 ( V_437 , V_445 ) )
F_103 ( V_437 , & V_2 -> V_402 ,
& V_446 ,
V_447 ) ;
else
F_103 ( V_437 , & V_2 -> V_402 ,
& V_448 ,
V_447 ) ;
F_104 ( & V_2 -> V_402 , V_417 ) ;
return 0 ;
}
int F_105 ( struct V_449 * V_29 , struct V_449 * V_450 ,
...
int V_212 ;
T_3 V_3 = 1 ;
V_2 = F_98 ( V_29 , sizeof( * V_2 ) , V_438 ) ;
if ( ! V_2 )
return - V_439 ;
V_2 -> V_402 . V_461 = 1 ;
V_2 -> V_178 = V_178 ;
...
V_458 = F_109 ( V_454 , L_19 , 0 ) ;
if ( V_458 ) {
V_2 -> V_407 = F_110 ( V_458 ) ;
F_111 ( V_458 ) ;
if ( ! V_2 -> V_407 ) {
F_17 ( V_2 -> V_29 , L_20 ) ;
return - V_462 ;
...
V_2 -> V_5 = F_112 ( V_29 , V_452 ) ;
if ( F_113 ( V_2 -> V_5 ) )
return F_114 ( V_2 -> V_5 ) ;
V_2 -> V_463 = F_115 ( V_2 -> V_29 , L_22 ) ;
if ( F_113 ( V_2 -> V_463 ) ) {
V_212 = F_114 ( V_2 -> V_463 ) ;
F_55 ( V_2 -> V_29 , L_23 , V_212 ) ;
return V_212 ;
}
V_212 = F_116 ( V_2 -> V_463 ) ;
if ( V_212 ) {
F_55 ( V_2 -> V_29 , L_24 , V_212 ) ;
return V_212 ;
}
V_2 -> V_464 = F_115 ( V_2 -> V_29 , L_25 ) ;
if ( F_113 ( V_2 -> V_464 ) ) {
V_212 = F_114 ( V_2 -> V_464 ) ;
F_55 ( V_2 -> V_29 , L_26 , V_212 ) ;
goto V_465;
}
V_212 = F_116 ( V_2 -> V_464 ) ;
if ( V_212 ) {
...
V_457 . V_483 = F_120 ( 32 ) ;
V_2 -> V_460 = F_121 ( & V_457 ) ;
}
F_122 ( V_29 , V_2 ) ;
return 0 ;
V_471:
...
void F_124 ( struct V_449 * V_29 , struct V_449 * V_450 , void * V_8 )
{
struct V_1 * V_2 = F_125 ( V_29 ) ;
if ( V_2 -> V_460 && ! F_113 ( V_2 -> V_460 ) )
F_126 ( V_2 -> V_460 ) ;
F_9 ( V_2 , ~ 0 , V_379 ) ;
