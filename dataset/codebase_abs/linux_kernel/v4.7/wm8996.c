...
int V_38 = V_36 -> V_38 . V_39 . V_40 [ 0 ] ;
if ( V_3 < 0 )
return V_3 ;
if ( V_38 >= V_7 -> V_23 )
return - V_32 ;
...
static void F_52 ( struct V_417 * V_418 , unsigned V_419 , int V_38 )
{
struct V_4 * V_5 = F_53 ( V_418 ) ;
F_54 ( V_5 -> V_294 , V_259 + V_419 ,
V_420 , ! ! V_38 << V_421 ) ;
}
...
return F_54 ( V_5 -> V_294 , V_259 + V_419 ,
V_340 | V_423 |
V_420 , V_65 ) ;
}
...
unsigned int V_88 ;
int V_48 ;
V_48 = F_57 ( V_5 -> V_294 , V_259 + V_419 , & V_88 ) ;
if ( V_48 < 0 )
return V_48 ;
return ( V_88 & V_420 ) != 0 ;
}
...
V_5 -> V_417 = V_425 ;
V_5 -> V_417 . V_426 = 5 ;
V_5 -> V_417 . V_427 = V_5 -> V_29 ;
if ( V_5 -> V_7 . V_428 )
V_5 -> V_417 . V_8 = V_5 -> V_7 . V_428 ;
else
V_5 -> V_417 . V_8 = - 1 ;
V_48 = F_60 ( & V_5 -> V_417 , V_5 ) ;
if ( V_48 != 0 )
...
V_5 -> V_292 [ V_12 ] . V_493 = V_494 [ V_12 ] ;
V_48 = F_93 ( & V_57 -> V_29 , F_5 ( V_5 -> V_292 ) ,
V_5 -> V_292 ) ;
if ( V_48 != 0 ) {
...
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_292 ) ; V_12 ++ ) {
V_48 = F_94 ( V_5 -> V_292 [ V_12 ] . V_501 ,
& V_5 -> V_496 [ V_12 ] ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 ,
L_55 ,
...
V_5 -> V_294 = F_95 ( V_57 , & V_502 ) ;
if ( F_96 ( V_5 -> V_294 ) ) {
V_48 = F_97 ( V_5 -> V_294 ) ;
F_24 ( & V_57 -> V_29 , L_56 , V_48 ) ;
goto V_503;
}
V_48 = F_57 ( V_5 -> V_294 , V_89 , & V_88 ) ;
if ( V_48 < 0 ) {
...
V_48 = F_57 ( V_5 -> V_294 , V_128 , & V_88 ) ;
if ( V_48 < 0 ) {
F_24 ( & V_57 -> V_29 , L_59 ,
V_48 ) ;
goto V_504;
...
F_54 ( V_5 -> V_294 , V_97 ,
V_516 , V_516 ) ;
F_54 ( V_5 -> V_294 , V_101 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_294 , V_102 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_294 , V_103 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_294 , V_104 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_294 , V_105 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_294 , V_106 ,
V_517 , V_517 ) ;
F_54 ( V_5 -> V_294 , V_107 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_294 , V_108 ,
V_518 , V_518 ) ;
F_54 ( V_5 -> V_294 , V_183 ,
V_519 , V_519 ) ;
F_54 ( V_5 -> V_294 , V_184 ,
V_519 , V_519 ) ;
F_54 ( V_5 -> V_294 , V_213 ,
V_520 , V_520 ) ;
F_54 ( V_5 -> V_294 , V_214 ,
V_520 , V_520 ) ;
F_54 ( V_5 -> V_294 , V_185 ,
V_521 , V_521 ) ;
F_54 ( V_5 -> V_294 , V_186 ,
V_521 , V_521 ) ;
F_54 ( V_5 -> V_294 , V_215 ,
V_522 , V_522 ) ;
F_54 ( V_5 -> V_294 , V_216 ,
V_522 , V_522 ) ;
F_54 ( V_5 -> V_294 ,
V_160 ,
V_523 |
...
V_561 ,
1 << V_548 | 1 ) ;
V_48 = F_57 ( V_5 -> V_294 , V_259 , & V_88 ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 , L_62 , V_48 ) ;
goto V_504;
}
if ( V_88 & V_340 )
F_54 ( V_5 -> V_294 , V_148 ,
V_562 ,
V_562 ) ;
V_48 = F_57 ( V_5 -> V_294 , V_260 , & V_88 ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 , L_63 , V_48 ) ;
goto V_504;
}
if ( V_88 & V_341 )
F_54 ( V_5 -> V_294 , V_171 ,
V_563 ,
V_563 ) ;
F_59 ( V_5 ) ;
