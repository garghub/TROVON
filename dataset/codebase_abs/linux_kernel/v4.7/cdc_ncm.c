...
F_71 ( V_13 -> V_62 , V_11 ) ;
if ( V_13 -> V_84 ) {
V_141 = F_72 ( V_11 , V_13 -> V_84 -> V_164 ) ;
if ( V_141 ) {
F_11 ( & V_30 -> V_11 , L_27 ) ;
goto V_163;
}
...
static void F_81 ( struct V_181 * V_182 , T_5 V_183 , T_5 V_184 , T_5 V_24 )
{
T_5 V_185 = F_82 ( V_182 -> V_47 , V_183 ) - V_182 -> V_47 + V_184 ;
if ( V_182 -> V_47 + V_185 > V_24 )
V_185 = V_24 - V_182 -> V_47 ;
if ( V_185 && F_83 ( V_182 ) >= V_185 )
memset ( F_84 ( V_182 , V_185 ) , 0 , V_185 ) ;
}
static struct V_105 * F_85 ( struct V_12 * V_13 , struct V_181 * V_182 , T_6 V_186 , T_5 V_187 )
{
...
if ( ! ( V_13 -> V_54 & V_55 ) )
F_81 ( V_182 , V_13 -> V_100 , 0 , V_13 -> V_44 ) ;
...
if ( ! ( V_13 -> V_54 & V_55 ) )
V_188 = (struct V_105 * ) memset ( F_84 ( V_182 , V_13 -> V_33 ) , 0 , V_13 -> V_33 ) ;
else
V_188 = V_13 -> V_57 ;
V_188 -> V_192 = V_186 ;
...
struct V_181 *
F_86 ( struct V_10 * V_11 , struct V_181 * V_182 , T_6 V_186 )
{
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
struct V_34 * V_189 ;
struct V_105 * V_188 ;
...
V_200 = 0 ;
if ( V_182 != NULL ) {
F_87 ( V_182 , V_13 -> V_135 ) ;
F_87 ( V_186 , V_13 -> V_201 ) ;
} else {
V_199 = 1 ;
}
V_195 = V_13 -> V_73 ;
if ( ! V_195 ) {
V_195 = F_88 ( V_13 -> V_44 , V_202 ) ;
if ( V_195 == NULL ) {
if ( V_182 != NULL ) {
F_39 ( V_182 ) ;
V_11 -> V_60 -> V_8 . V_203 ++ ;
...
V_189 = (struct V_34 * ) memset ( F_84 ( V_195 , sizeof( struct V_34 ) ) , 0 , sizeof( struct V_34 ) ) ;
...
V_188 = F_85 ( V_13 , V_195 , V_186 , V_182 -> V_47 + V_13 -> V_98 + V_13 -> V_96 ) ;
F_81 ( V_195 , V_13 -> V_98 , V_13 -> V_96 , V_13 -> V_44 ) ;
...
memcpy ( F_84 ( V_195 , V_182 -> V_47 ) , V_182 -> V_9 , V_182 -> V_47 ) ;
...
F_81 ( V_195 , V_13 -> V_100 , 0 , V_13 -> V_44 ) ;
V_189 -> V_191 = F_51 ( V_195 -> V_47 ) ;
memcpy ( F_84 ( V_195 , V_13 -> V_33 ) , V_13 -> V_57 , V_13 -> V_33 ) ;
V_188 = memset ( V_13 -> V_57 , 0 , V_13 -> V_33 ) ;
}
if ( ! ( V_11 -> V_219 -> V_220 & V_221 ) &&
V_195 -> V_47 > V_13 -> V_42 )
memset ( F_84 ( V_195 , V_13 -> V_44 - V_195 -> V_47 ) , 0 ,
...
{
if ( ! ( F_75 ( & V_13 -> V_144 ) || F_91 ( & V_13 -> V_152 ) ) )
F_92 ( & V_13 -> V_144 ,
F_93 ( 0 , V_13 -> V_45 ) ,
V_146 ) ;
}
...
struct V_181 *
F_96 ( struct V_10 * V_11 , struct V_181 * V_182 , T_8 V_220 )
{
struct V_181 * V_195 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
if ( V_13 == NULL )
goto error;
F_24 ( & V_13 -> V_52 ) ;
V_195 = F_86 ( V_11 , V_182 , F_33 ( V_232 ) ) ;
F_25 ( & V_13 -> V_52 ) ;
return V_195 ;
error:
if ( V_182 != NULL )
...
int F_97 ( struct V_12 * V_13 , struct V_181 * V_233 )
{
...
sizeof( struct V_105 ) ) ) {
F_98 ( V_11 , V_234 , V_11 -> V_60 , L_31 ) ;
goto error;
}
V_189 = (struct V_34 * ) V_233 -> V_9 ;
if ( V_189 -> V_192 != F_33 ( V_205 ) ) {
F_98 ( V_11 , V_234 , V_11 -> V_60 ,
L_32 ,
F_8 ( V_189 -> V_192 ) ) ;
goto error;
}
...
F_98 ( V_11 , V_234 , V_11 -> V_60 , L_37 , V_49 ) ;
V_49 = - V_48 ;
}
error:
return V_49 ;
}
int F_100 ( struct V_10 * V_11 , struct V_181 * V_233 )
{
struct V_181 * V_182 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
int V_47 ;
...
int V_240 = 50 ;
V_18 V_241 = 0 ;
V_190 = F_97 ( V_13 , V_233 ) ;
if ( V_190 < 0 )
goto error;
V_242:
V_237 = F_99 ( V_233 , V_190 ) ;
if ( V_237 < 0 )
goto error;
V_188 = (struct V_105 * ) ( V_233 -> V_9 + V_190 ) ;
...
V_182 = F_101 ( V_11 -> V_60 , V_47 ) ;
if ( ! V_182 )
goto error;
memcpy ( F_84 ( V_182 , V_47 ) , V_233 -> V_9 + V_239 , V_47 ) ;
F_102 ( V_11 , V_182 ) ;
V_241 += V_47 ;
}
}
...
static void F_105 ( struct V_10 * V_11 , struct V_252 * V_252 )
{
struct V_12 * V_13 ;
struct V_253 * V_254 ;
...
F_107 ( V_11 , ! ! V_254 -> V_260 , 0 ) ;
break;
case V_261 :
if ( V_252 -> V_255 < ( sizeof( * V_254 ) +
sizeof( struct V_246 ) ) )
F_108 ( V_256 , & V_11 -> V_220 ) ;
else
F_103 ( V_11 ,
