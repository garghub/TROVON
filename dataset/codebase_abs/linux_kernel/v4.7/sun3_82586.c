...
static int F_60 ( struct V_164 * V_165 , struct V_1 * V_2 )
{
int V_93 , V_13 ;
#ifndef F_39
int V_193 ;
...
F_62 ( V_165 , ( void * ) V_11 -> V_124 [ V_11 -> V_133 ] , V_165 -> V_93 ) ;
#if ( V_118 == 1 )
# ifdef F_39
#ifdef F_58
if( V_11 -> V_25 -> V_107 & V_191 )
...
#endif
V_11 -> V_126 [ 0 ] -> V_8 = F_34 ( V_198 | V_93 ) ;
for( V_13 = 0 ; V_13 < 16 ; V_13 ++ )
{
V_11 -> V_122 [ 0 ] -> V_77 = 0 ;
F_40 () ;
if( ( V_11 -> V_25 -> V_107 & V_199 ) == V_200 )
V_11 -> V_25 -> V_98 = V_201 ;
else
{
...
# else
V_193 = ( V_11 -> V_135 + 1 ) & 0x1 ;
V_11 -> V_126 [ 0 ] -> V_8 = F_34 ( V_198 | V_93 ) ;
V_11 -> V_122 [ 0 ] -> V_81 = V_11 -> V_119 [ V_193 ] -> V_81
= F_19 ( ( V_11 -> V_119 [ V_193 ] ) ) ;
V_11 -> V_122 [ 0 ] -> V_77 = V_11 -> V_119 [ V_193 ] -> V_77 = 0 ;
V_11 -> V_119 [ V_11 -> V_135 ] -> V_81 = F_19 ( ( V_11 -> V_122 [ 0 ] ) ) ;
V_11 -> V_135 = V_193 ;
F_63 ( V_165 ) ;
# endif
#else
V_11 -> V_126 [ V_11 -> V_133 ] -> V_8 = F_34 ( V_198 | V_93 ) ;
if( ( V_193 = V_11 -> V_133 + 1 ) == V_118 )
V_193 = 0 ;
V_11 -> V_122 [ V_11 -> V_133 ] -> V_77 = 0 ;
V_11 -> V_119 [ V_193 ] -> V_81 = F_19 ( ( V_11 -> V_119 [ V_193 ] ) ) ;
V_11 -> V_119 [ V_193 ] -> V_77 = 0 ;
...
static struct V_202 * F_66 ( struct V_1 * V_2 )
{
struct V_9 * V_11 = F_18 ( V_2 ) ;
unsigned short V_203 , V_204 , V_205 , V_206 ;
V_203 = F_34 ( V_11 -> V_25 -> V_207 ) ;
V_11 -> V_25 -> V_207 = 0 ;
V_204 = F_34 ( V_11 -> V_25 -> V_208 ) ;
V_11 -> V_25 -> V_208 = 0 ;
V_205 = F_34 ( V_11 -> V_25 -> V_209 ) ;
V_11 -> V_25 -> V_209 = 0 ;
V_206 = F_34 ( V_11 -> V_25 -> V_210 ) ;
V_11 -> V_25 -> V_210 = 0 ;
V_2 -> V_172 . V_211 += V_203 ;
V_2 -> V_172 . V_212 += V_206 ;
V_2 -> V_172 . V_213 += V_204 ;
V_2 -> V_172 . V_174 += V_205 ;
return & V_2 -> V_172 ;
}
