...
static void
F_50 ( struct V_4 * V_5 , int V_134 )
{
struct V_27 * V_28 = F_12 ( V_5 ) ;
if ( F_51 ( 0 , & V_28 -> V_135 ) == 0 ) {
if ( V_134 ) {
F_52 ( & V_28 -> V_136 , 0 ) ;
} else {
F_52 ( & V_28 -> V_136 , 1 ) ;
...
static int
F_53 ( struct V_4 * V_5 , struct V_88 * V_77 )
{
struct V_27 * V_28 = F_12 ( V_5 ) ;
V_77 -> V_137 = F_54 ( V_77 , V_5 ) ;
F_2 ( ( V_8 V_9 L_49
L_50 ,
F_3 ( V_5 ) , V_77 -> V_80 ) ) ;
V_5 -> V_91 . V_138 += V_77 -> V_80 ;
V_5 -> V_91 . V_139 ++ ;
V_77 -> V_5 = V_5 ;
F_55 ( V_77 ) ;
F_2 ( ( V_9 L_51 ,
F_33 ( & V_28 -> V_35 ) ) ) ;
if ( F_33 ( & V_28 -> V_35 ) < V_28 -> V_140 )
F_50 ( V_5 , 1 ) ;
F_2 ( ( V_8 V_9 L_52
L_53 ,
F_33 ( & V_28 -> V_35 ) , V_28 -> V_141 ) ) ;
return 0 ;
}
static int
...
F_59 ( V_52 -> V_78 , V_28 -> V_63 [ V_90 ] . V_79 ,
V_28 -> V_63 [ V_90 ] . V_80 , V_81 ) ;
F_60 ( V_142 , F_61 ( V_77 , V_80 ) , V_80 ) ;
F_62 ( V_52 -> V_78 , V_28 -> V_63 [ V_90 ] . V_79 ,
V_28 -> V_63 [ V_90 ] . V_80 , V_81 ) ;
goto V_57;
}
F_61 ( V_77 , V_80 ) ;
...
V_101 )
return F_64 ( V_5 , V_19 ) ;
V_80 = F_21 ( V_19 -> V_149 ) ;
if ( V_80 == 0 ) {
...
V_90 = F_21 ( V_19 -> V_144 [ 0 ] ) ;
V_97 = V_19 -> V_20 ;
V_77 = V_28 -> V_63 [ V_90 ] . V_77 ;
V_145 = F_21 ( V_19 -> V_150 ) ;
F_2 ( ( V_8 V_9 L_64 ,
F_3 ( V_5 ) ,
V_145 , V_80 ) ) ;
if ( V_97 > 1 ) {
...
for ( V_32 = 0 ; V_32 < V_97 ; V_32 ++ ) {
V_90 = F_21 ( V_19 -> V_144 [ V_32 ] ) ;
V_142 = V_28 -> V_63 [ V_90 ] . V_77 ;
V_148 = V_28 -> V_63 [ V_90 ] . V_80 ;
if ( V_151 < V_148 )
V_148 = V_151 ;
F_59 ( V_52 -> V_78 ,
V_28 -> V_63 [ V_90 ] . V_79 ,
V_28 -> V_63 [ V_90 ] . V_80 ,
V_81 ) ;
F_60 ( V_142 , F_61 ( V_77 , V_148 ) , V_148 ) ;
F_62 ( V_52 -> V_78 ,
V_28 -> V_63 [ V_90 ] . V_79 ,
V_28 -> V_63 [ V_90 ] . V_80 ,
V_81 ) ;
...
struct V_88 * V_77 ;
T_12 V_79 ;
T_3 V_155 , V_156 , V_97 , V_157 ;
T_3 V_80 = ( V_5 -> V_87 + V_5 -> V_158 + 4 ) ;
unsigned long V_33 ;
int V_32 ;
V_155 = F_33 ( & V_28 -> V_35 ) ;
V_156 = ( V_28 -> V_38 - V_155 ) ;
F_2 ( ( V_8 V_9 L_76 ,
F_3 ( V_5 ) ,
V_94 , V_156 , V_155 ) ) ;
V_157 = ( V_52 -> V_159 - V_160 ) /
( V_161 + sizeof( T_11 ) ) ;
while ( V_156 ) {
V_2 = F_29 ( V_65 , V_52 ) ;
if ( V_2 == NULL ) {
...
V_154 = ( T_14 * ) V_2 ;
V_32 = F_42 ( V_2 -> V_13 . V_162 . V_163 . V_164 . V_165 . V_166 ) ;
V_52 -> V_167 [ V_32 ] = 0 ;
V_97 = V_156 ;
if ( V_97 > V_157 )
V_97 = V_157 ;
...
V_154 -> V_68 = 0 ;
V_154 -> V_21 = 0 ;
V_154 -> V_70 = V_28 -> V_71 ;
V_107 = ( T_10 * ) V_154 -> V_114 ;
V_108 = NULL ;
for ( V_32 = 0 ; V_32 < V_97 ; V_32 ++ ) {
int V_90 ;
F_16 ( & V_28 -> V_36 , V_33 ) ;
...
V_57:
F_2 ( ( V_8 V_9 L_81 ,
V_94 , V_156 , F_33 ( & V_28 -> V_35 ) ) ) ;
F_2 ( ( V_8 V_9 L_82 ,
V_94 , V_28 -> V_74 , V_28 -> V_141 ) ) ;
F_69 ( 0 , & V_28 -> V_135 ) ;
}
static void
F_70 ( struct V_169 * V_170 )
{
F_18 ( F_71 ( V_170 , struct V_27 ,
V_136 . V_170 ) ) ;
}
static struct V_4 *
F_72 ( T_1 * V_52 , int V_71 )
{
struct V_4 * V_5 ;
struct V_27 * V_28 ;
T_8 V_171 [ V_172 ] , * V_173 ;
V_5 = F_73 ( sizeof( struct V_27 ) ) ;
if ( ! V_5 )
return NULL ;
V_5 -> V_87 = V_174 ;
V_28 = F_12 ( V_5 ) ;
...
V_28 -> V_135 = 0 ;
F_13 ( ( V_8 V_9 L_83 ,
__LINE__ , V_5 -> V_87 + V_5 -> V_158 + 4 ) ) ;
F_15 ( & V_28 -> V_35 , 0 ) ;
V_28 -> V_74 = 0 ;
V_28 -> V_141 = 0 ;
V_28 -> V_38 = V_38 ;
if ( V_52 -> V_175 [ 0 ] . V_176 < V_38 )
V_28 -> V_38 = V_52 -> V_175 [ 0 ] . V_176 ;
F_13 ( ( V_8 V_9 L_84 ,
__LINE__ ,
V_52 -> V_175 [ 0 ] . V_176 ,
V_38 ,
V_28 -> V_38 ) ) ;
V_28 -> V_140 = V_28 -> V_38 * 2 / 3 ;
F_75 ( & V_28 -> V_95 ) ;
F_75 ( & V_28 -> V_36 ) ;
V_173 = ( T_8 * ) & V_52 -> V_177 . V_178 ;
V_171 [ 0 ] = V_173 [ 5 ] ;
V_171 [ 1 ] = V_173 [ 4 ] ;
V_171 [ 2 ] = V_173 [ 3 ] ;
V_171 [ 3 ] = V_173 [ 2 ] ;
...
V_171 [ 5 ] = V_173 [ 0 ] ;
V_5 -> V_179 = V_172 ;
memcpy ( V_5 -> V_180 , V_171 , V_172 ) ;
memset ( V_5 -> V_181 , 0xff , V_172 ) ;
V_28 -> V_55 = ( V_182 <= V_183 ) ?
V_182 : V_183 ;
V_5 -> V_184 = & V_185 ;
V_5 -> V_186 = V_187 ;
F_13 ( ( V_8 V_9 L_85
...
static int
F_78 ( struct V_188 * V_189 , const struct V_190 * V_191 )
{
T_1 * V_1 = F_79 ( V_189 ) ;
struct V_4 * V_5 ;
int V_32 ;
...
F_54 ( struct V_88 * V_77 , struct V_4 * V_5 )
{
struct V_203 * V_204 = (struct V_203 * ) V_77 -> V_113 ;
struct V_205 * V_205 ;
F_44 ( V_77 ) ;
F_45 ( V_77 , sizeof( struct V_203 ) ) ;
if ( V_204 -> V_206 == F_91 ( 0xffff ) ) {
T_3 * V_207 = ( T_3 * ) V_204 ;
F_92 ( V_207 + 0 ) ;
F_92 ( V_207 + 1 ) ;
F_92 ( V_207 + 2 ) ;
...
if ( * V_204 -> V_208 & 1 ) {
if ( ! memcmp ( V_204 -> V_208 , V_5 -> V_181 , V_172 ) ) {
V_77 -> V_209 = V_210 ;
} else {
V_77 -> V_209 = V_211 ;
}
} else {
if ( memcmp ( V_204 -> V_208 , V_5 -> V_180 , V_172 ) ) {
V_77 -> V_209 = V_212 ;
} else {
V_77 -> V_209 = V_213 ;
}
}
V_205 = (struct V_205 * ) V_77 -> V_113 ;
if ( V_205 -> V_214 == V_215 &&
( V_205 -> V_216 == F_91 ( V_217 ) ||
V_205 -> V_216 == F_91 ( V_218 ) ) ) {
F_45 ( V_77 , sizeof( struct V_205 ) ) ;
return V_205 -> V_216 ;
}
return F_91 ( V_219 ) ;
}
