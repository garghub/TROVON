...
static T_1
F_51 ( struct V_56 * V_57 , struct V_58 * V_14 ,
char * V_2 ) {
struct V_28 * V_29 = F_29 ( V_57 ) ;
T_5 V_63 ;
unsigned long long V_84 ;
V_63 = F_50 ( V_29 -> V_1 , L_12 , NULL , & V_84 ) ;
if ( F_36 ( V_63 ) )
return - V_83 ;
return sprintf ( V_2 , L_11 , V_84 ) ;
}
static T_1 F_52 ( struct V_56 * V_57 , struct V_58 * V_14 ,
char * V_2 ) {
struct V_28 * V_29 = F_29 ( V_57 ) ;
T_5 V_63 ;
unsigned long long V_85 ;
V_63 = F_50 ( V_29 -> V_1 , L_13 , NULL , & V_85 ) ;
if ( F_36 ( V_63 ) )
return - V_83 ;
return sprintf ( V_2 , L_11 , V_85 ) ;
}
int F_53 ( struct V_28 * V_57 )
{
struct V_3 V_78 = { V_5 , NULL } ;
T_5 V_63 ;
int V_6 = 0 ;
if ( V_57 -> V_1 ) {
V_6 = F_54 ( & V_57 -> V_57 , & V_86 ) ;
if ( V_6 )
goto V_87;
}
if ( ! F_11 ( & V_57 -> V_53 . V_54 ) ) {
V_6 = F_54 ( & V_57 -> V_57 , & V_88 ) ;
if ( V_6 )
goto V_87;
V_6 = F_54 ( & V_57 -> V_57 , & V_89 ) ;
if ( V_6 )
goto V_87;
}
if ( F_55 ( V_57 -> V_1 , L_14 ) ) {
V_63 = F_56 ( V_57 -> V_1 , L_14 ,
NULL , & V_78 ) ;
if ( F_36 ( V_63 ) )
V_78 . V_8 = NULL ;
V_57 -> V_53 . V_76 = V_78 . V_8 ;
V_6 = F_54 ( & V_57 -> V_57 , & V_90 ) ;
if ( V_6 )
goto V_87;
}
if ( V_57 -> V_53 . type . V_75 )
V_6 = F_54 ( & V_57 -> V_57 , & V_91 ) ;
if ( V_57 -> V_53 . V_74 )
V_6 = F_54 ( & V_57 -> V_57 , & V_92 ) ;
if ( F_55 ( V_57 -> V_1 , L_10 ) ) {
V_6 = F_54 ( & V_57 -> V_57 , & V_93 ) ;
if ( V_6 )
goto V_87;
}
if ( F_55 ( V_57 -> V_1 , L_12 ) ) {
V_6 = F_54 ( & V_57 -> V_57 , & V_94 ) ;
if ( V_6 )
goto V_87;
}
if ( F_55 ( V_57 -> V_1 , L_13 ) ) {
V_6 = F_54 ( & V_57 -> V_57 , & V_95 ) ;
if ( V_6 )
goto V_87;
}
if ( F_55 ( V_57 -> V_1 , L_15 ) ) {
V_6 = F_54 ( & V_57 -> V_57 , & V_96 ) ;
if ( V_6 )
return V_6 ;
}
if ( V_57 -> V_68 . V_97 ) {
V_6 = F_54 ( & V_57 -> V_57 , & V_98 ) ;
if ( V_6 )
return V_6 ;
if ( V_57 -> V_60 . V_68 . V_99 )
V_6 = F_54 ( & V_57 -> V_57 ,
& V_100 ) ;
}
