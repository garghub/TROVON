...
F_67 ( V_138 , V_2 ) ;
V_18 = F_9 ( V_2 ) ;
V_145 = F_68 ( & V_138 -> V_2 , sizeof( * V_18 -> V_147 ) ,
& V_18 -> V_148 , V_149 ) ;
if ( ! V_145 ) {
F_21 ( V_117 L_10 ) ;
V_65 = - V_49 ;
...
V_18 -> V_147 = V_145 ;
V_18 -> V_44 = V_18 -> V_147 -> V_151 ;
V_18 -> V_39 = V_18 -> V_147 -> V_152 ;
F_69 ( & V_18 -> V_33 ) ;
F_63 ( V_2 , V_18 -> V_44 , V_43 ) ;
F_62 ( V_2 , V_18 -> V_39 , V_38 ) ;
memcpy ( V_2 -> V_28 , V_140 -> V_153 , V_154 ) ;
#ifdef F_70
V_57 = V_18 ;
V_155 = V_2 ;
#endif
V_18 -> V_14 = (struct V_13 * ) & V_142 -> V_156 [ 0 ] ;
V_18 -> V_9 = & V_142 -> V_157 ;
V_18 -> V_128 = V_116 ;
V_18 -> V_20 = V_134 ;
V_18 -> V_9 -> V_158 = 0x161 ;
V_18 -> V_9 -> V_159 = V_160 | V_161 |
V_162 | V_163 | 0x026 ;
V_18 -> V_9 -> V_158 = 0x161 ;
V_18 -> V_9 -> V_159 = V_160 | V_161 |
V_162 | V_163 | 0x026 ;
F_4 ( V_18 -> V_9 ) ;
V_18 -> V_66 = ! ( V_18 -> V_14 -> V_26 . V_164 . V_165 [ 0 ] & 0xff ) ;
if ( V_18 -> V_66 )
V_18 -> V_69 = V_97 | V_166 |
V_167 | V_168 |
V_169 ;
V_2 -> V_170 = & V_171 ;
V_2 -> V_172 = ( 200 * V_173 ) / 1000 ;
V_2 -> V_113 = V_113 ;
if ( F_71 ( V_2 ) ) {
F_21 ( V_117 L_11
L_12 ) ;
...
F_21 ( V_176 L_13 , V_2 -> V_128 , V_116 , V_2 -> V_28 ) ;
return 0 ;
V_175:
...
static int T_3 F_74 ( struct V_137 * V_138 )
{
