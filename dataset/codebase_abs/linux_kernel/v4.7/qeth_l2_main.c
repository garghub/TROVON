...
case V_202 :
V_7 -> V_2 = F_144 ( 0 , L_51 , V_262 ,
V_263 ) ;
break;
case V_14 :
V_7 -> V_2 = F_144 ( 0 , L_52 , V_262 ,
V_263 ) ;
V_7 -> V_2 -> V_32 |= V_264 ;
break;
default:
...
V_7 -> V_13 . V_276 = 1 ;
F_92 ( V_7 ) ;
F_146 ( V_7 -> V_2 , & V_7 -> V_198 -> V_2 ) ;
F_147 ( V_7 -> V_2 , & V_7 -> V_170 , F_78 , V_277 ) ;
F_148 ( V_7 -> V_2 ) ;
...
static int F_153 ( struct V_256 * V_198 , int V_141 )
{
struct V_6 * V_7 = F_133 ( & V_198 -> V_2 ) ;
int V_11 = 0 ;
enum V_278 V_279 ;
...
static int F_172 ( struct V_256 * V_198 )
{
return F_153 ( V_198 , 0 ) ;
}
...
V_290 = F_168 ( F_170 ( V_7 ) ) ;
V_291 = F_168 ( F_14 ( V_7 ) ) ;
if ( ! V_11 )
...
static void F_185 ( struct V_256 * V_198 )
{
struct V_6 * V_7 = F_133 ( & V_198 -> V_2 ) ;
F_59 ( V_7 , 0 , 1 ) ;
...
static int F_186 ( struct V_256 * V_198 )
{
struct V_6 * V_7 = F_133 ( & V_198 -> V_2 ) ;
if ( V_7 -> V_2 )
F_187 ( V_7 -> V_2 ) ;
...
static int F_188 ( struct V_256 * V_198 )
{
struct V_6 * V_7 = F_133 ( & V_198 -> V_2 ) ;
int V_11 = 0 ;
if ( V_198 -> V_138 == V_294 )
...
F_17 ( V_7 , 5 , L_69 ) ;
F_139 ( V_7 -> V_260 ,
F_194 ( & V_7 -> V_144 . V_300 , 0 , 1 ) == 0 ) ;
F_195 ( V_7 , V_101 , V_117 ) ;
F_17 ( V_7 , 6 , L_70 ) ;
F_196 ( F_197 ( V_7 -> V_144 . V_187 ) , V_32 ) ;
V_11 = F_198 ( V_7 -> V_144 . V_187 , & V_7 -> V_144 . V_301 ,
( V_302 ) V_117 , 0 , 0 ) ;
F_199 ( F_197 ( V_7 -> V_144 . V_187 ) , V_32 ) ;
if ( V_11 ) {
F_19 ( 2 , L_71
L_72 , V_11 ) ;
F_7 ( V_7 , 2 , L_73 , V_11 ) ;
F_200 ( V_117 -> V_303 , V_117 ) ;
F_201 ( & V_7 -> V_144 . V_300 , 0 ) ;
F_202 ( & V_7 -> V_260 ) ;
}
return V_11 ;
}
...
T_6 V_305 , V_306 ;
F_17 ( V_7 , 4 , L_74 ) ;
F_204 ( V_7 , V_117 , V_307 ) ;
V_305 = ( T_6 ) ( V_119 + V_304 ) ;
V_306 = ( T_6 ) V_304 ;
memcpy ( F_205 ( V_117 -> V_74 ) , & V_305 , 2 ) ;
memcpy ( F_206 ( V_117 -> V_74 ) , & V_306 , 2 ) ;
memcpy ( F_207 ( V_117 -> V_74 ) , & V_306 , 2 ) ;
memcpy ( F_208 ( V_117 -> V_74 ) , & V_306 , 2 ) ;
return F_193 ( V_7 , V_305 , V_117 ) ;
}
int F_209 ( struct V_1 * V_2 , void * V_74 , int V_304 )
{
struct V_116 * V_117 ;
struct V_6 * V_7 ;
int V_11 ;
...
if ( ! F_2 ( V_7 ) )
return - V_12 ;
V_117 = F_210 ( & V_7 -> V_144 ) ;
memcpy ( V_117 -> V_74 + V_119 , V_74 , V_304 ) ;
V_11 = F_203 ( V_7 , V_117 , V_304 ) ;
return V_11 ;
}
...
V_316 [ V_67 ] = NULL ;
F_215 ( & V_7 -> V_198 -> V_2 . V_288 , V_289 , V_316 ) ;
}
static void F_216 ( struct V_330 * V_331 )
{
struct V_332 * V_74 =
...
F_154 ( & V_74 -> V_7 -> V_281 ) ;
V_74 -> V_7 -> V_88 . V_210 . V_209 = V_335 -> V_209 ;
F_167 ( & V_74 -> V_7 -> V_281 ) ;
...
L_94 ) ;
F_215 ( & V_74 -> V_7 -> V_198 -> V_2 . V_288 ,
V_289 , V_316 ) ;
F_29 ( V_74 ) ;
}
...
F_217 ( & V_74 -> V_333 , F_216 ) ;
V_74 -> V_7 = V_7 ;
memcpy ( & V_74 -> V_336 , V_336 ,
sizeof( struct V_343 ) + V_345 ) ;
F_218 ( V_348 , & V_74 -> V_333 ) ;
}
static void F_219 ( struct V_330 * V_331 )
{
struct V_349 * V_74 =
...
if ( V_11 < 0 )
return V_11 ;
return F_220 ( V_7 , & V_358 , V_360 ) ;
}
static int F_227 ( struct V_6 * V_7 , int V_388 , T_6 V_389 )
{
int V_11 ;
if ( V_388 == 0 )
switch ( V_389 ) {
...
V_310 |= V_319 ;
F_214 ( V_7 , V_317 , V_310 ,
(struct V_311 * ) & V_394 -> V_396 ,
(struct V_313 * ) & V_394 -> V_314 ) ;
}
int F_229 ( struct V_6 * V_7 , int V_397 )
{
int V_11 ;
T_6 V_389 ;
struct V_398 * V_399 ;
...
F_230 ( V_399 , & V_401 ) ;
if ( V_397 ) {
F_214 ( V_7 , V_329 , 0 , NULL , NULL ) ;
V_11 = F_231 ( V_401 , 1 , & V_389 ,
F_228 , V_7 ) ;
} else
V_11 = F_231 ( V_401 , 0 , & V_389 , NULL , NULL ) ;
return F_227 ( V_7 , V_11 , V_389 ) ;
}
