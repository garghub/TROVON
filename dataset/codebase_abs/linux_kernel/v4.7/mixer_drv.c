...
struct V_33 * V_20 ;
int V_11 ;
V_20 = F_25 ( V_32 , V_34 , L_8 ) ;
if ( V_20 == NULL ) {
F_26 ( V_2 , L_9 ) ;
V_11 = - V_35 ;
goto V_36;
}
V_2 -> V_20 . V_37 = F_27 ( V_20 -> V_38 , F_28 ( V_20 ) ) ;
if ( V_2 -> V_20 . V_37 == NULL ) {
F_26 ( V_2 , L_10 ) ;
V_11 = - V_35 ;
goto V_36;
}
V_20 = F_25 ( V_32 , V_34 , L_11 ) ;
if ( V_20 == NULL ) {
F_26 ( V_2 , L_9 ) ;
V_11 = - V_35 ;
goto V_39;
}
V_2 -> V_20 . V_40 = F_27 ( V_20 -> V_38 , F_28 ( V_20 ) ) ;
if ( V_2 -> V_20 . V_40 == NULL ) {
F_26 ( V_2 , L_10 ) ;
V_11 = - V_35 ;
goto V_39;
}
V_20 = F_25 ( V_32 , V_41 , L_12 ) ;
if ( V_20 == NULL ) {
F_26 ( V_2 , L_13 ) ;
V_11 = - V_35 ;
goto V_42;
}
V_11 = F_29 ( V_20 -> V_38 , V_43 , 0 , L_14 , V_2 ) ;
if ( V_11 ) {
F_26 ( V_2 , L_15 ) ;
goto V_42;
}
...
F_31 ( V_20 ) ;
V_20 -> V_45 = F_39 ( V_30 , L_16 ) ;
if ( F_36 ( V_20 -> V_45 ) ) {
F_26 ( V_2 , L_17 ) ;
goto V_36;
}
V_20 -> V_47 = F_39 ( V_30 , L_11 ) ;
if ( F_36 ( V_20 -> V_47 ) ) {
F_26 ( V_2 , L_18 ) ;
goto V_36;
}
V_20 -> V_22 = F_39 ( V_30 , L_19 ) ;
if ( F_36 ( V_20 -> V_22 ) ) {
F_26 ( V_2 , L_20 ) ;
goto V_36;
}
V_20 -> V_24 = F_39 ( V_30 , L_21 ) ;
if ( F_36 ( V_20 -> V_24 ) ) {
F_26 ( V_2 , L_22 ) ;
goto V_36;
}
V_20 -> V_23 = F_39 ( V_30 , L_23 ) ;
if ( F_36 ( V_20 -> V_23 ) ) {
F_26 ( V_2 , L_24 ) ;
goto V_36;
}
...
{
int V_51 ;
for ( V_51 = 0 ; V_51 < F_44 ( V_2 -> V_52 ) ; ++ V_51 )
if ( V_2 -> V_52 [ V_51 ] )
F_45 ( V_2 -> V_52 [ V_51 ] ) ;
}
...
struct V_53 * V_54 )
{
V_2 -> V_52 [ 0 ] = F_47 ( V_2 , 0 ) ;
V_2 -> V_52 [ 1 ] = F_47 ( V_2 , 1 ) ;
V_2 -> V_52 [ 2 ] = F_48 ( V_2 , 0 ) ;
...
static int F_49 ( struct V_48 * V_30 )
{
...
static int F_55 ( struct V_48 * V_30 )
{
struct V_1 * V_2 = F_50 ( V_30 ) ;
struct V_19 * V_20 = & V_2 -> V_20 ;
F_8 ( V_2 , L_34 ) ;
...
L_42 ;
F_69 ( L_43 , V_66 ) ;
for ( V_51 = 0 ; V_51 < F_44 ( V_63 ) ; ++ V_51 )
F_70 ( V_63 [ V_51 ] . V_68 ) ;
V_11 = F_71 ( & V_69 ) ;
if ( V_11 != 0 ) {
F_72 ( L_44 ) ;
