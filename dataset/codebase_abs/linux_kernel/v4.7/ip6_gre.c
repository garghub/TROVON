...
F_52 ( V_58 , V_109 ) ;
return F_53 ( V_58 , V_7 , V_105 , V_107 , V_84 , V_108 ,
V_114 ) ;
}
static inline int F_54 ( struct V_57 * V_58 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
const struct V_115 * V_116 = F_55 ( V_58 ) ;
int V_84 = - 1 ;
struct V_106 V_107 ;
T_8 V_105 ;
T_6 V_78 ;
...
if ( V_62 > 0 ) {
struct V_76 * V_77 ;
V_77 = (struct V_76 * ) & F_59 ( V_58 ) [ V_62 ] ;
if ( V_77 -> V_84 == 0 ) {
F_44 ( V_58 , V_82 ,
V_83 , V_62 + 2 ) ;
return - 1 ;
...
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_137 * V_138 = & V_17 -> V_7 -> V_138 ;
int V_139 ;
...
static void F_25 ( struct V_5 * V_17 , int V_145 )
{
...
int V_146 ;
if ( V_7 -> type != V_24 ) {
memcpy ( V_7 -> V_147 , & V_36 -> V_29 , sizeof( struct V_1 ) ) ;
memcpy ( V_7 -> V_148 , & V_36 -> V_30 , sizeof( struct V_1 ) ) ;
}
V_107 -> V_74 = V_36 -> V_29 ;
V_107 -> V_73 = V_36 -> V_30 ;
V_107 -> V_149 = V_36 -> V_13 ;
V_107 -> V_123 = 0 ;
V_107 -> V_136 = V_150 ;
if ( ! ( V_36 -> V_32 & V_122 ) )
...
V_7 -> V_32 &= ~ V_156 ;
V_17 -> V_112 = F_67 ( V_17 -> V_28 . V_52 ) ;
V_17 -> V_157 = V_17 -> V_158 + V_17 -> V_112 ;
V_146 = V_17 -> V_157 + sizeof( struct V_64 ) ;
if ( V_36 -> V_32 & V_153 ) {
int V_159 = ( F_68 ( & V_36 -> V_30 ) &
( V_160 | V_161 ) ) ;
struct V_162 * V_163 = F_69 ( V_17 -> V_12 ,
& V_36 -> V_30 , & V_36 -> V_29 ,
V_36 -> V_13 , V_159 ) ;
if ( ! V_163 )
return;
...
V_146 ;
if ( V_145 ) {
V_7 -> V_78 = V_163 -> V_164 . V_7 -> V_78 - V_146 ;
if ( ! ( V_17 -> V_28 . V_32 & V_118 ) )
V_7 -> V_78 -= 8 ;
if ( V_7 -> type == V_24 )
V_7 -> V_78 -= V_166 ;
...
const struct V_35 * V_36 , int V_145 )
{
...
V_36 -> V_168 = F_73 ( V_120 -> V_168 ) ;
V_36 -> V_52 = F_73 ( V_120 -> V_52 ) ;
memcpy ( V_36 -> V_45 , V_120 -> V_45 , sizeof( V_120 -> V_45 ) ) ;
}
static void F_74 ( struct V_169 * V_120 ,
const struct V_35 * V_36 )
{
V_120 -> V_94 = V_150 ;
...
V_120 -> V_168 = F_75 ( V_36 -> V_168 ) ;
V_120 -> V_52 = F_75 ( V_36 -> V_52 ) ;
...
case V_174 :
if ( V_7 == V_20 -> V_34 ) {
if ( F_77 ( & V_36 , V_171 -> V_175 . V_176 , sizeof( V_36 ) ) ) {
V_117 = - V_177 ;
break;
}
F_72 ( & V_173 , & V_36 ) ;
...
F_74 ( & V_36 , & V_17 -> V_28 ) ;
if ( F_78 ( V_171 -> V_175 . V_176 , & V_36 , sizeof( V_36 ) ) )
V_117 = - V_177 ;
break;
case V_178 :
case V_179 :
V_117 = - V_180 ;
if ( ! F_79 ( V_12 -> V_181 , V_182 ) )
goto V_183;
V_117 = - V_177 ;
if ( F_77 ( & V_36 , V_171 -> V_175 . V_176 , sizeof( V_36 ) ) )
goto V_183;
...
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_64 * V_65 = (struct V_64 * ) F_84 ( V_58 , V_17 -> V_157 ) ;
T_3 * V_36 = ( T_3 * ) ( V_65 + 1 ) ;
F_85 ( V_65 , 0 ,
F_86 ( F_5 ( V_7 ) , V_58 ,
...
V_7 -> V_191 = F_92 ( struct V_197 ) ;
if ( ! V_7 -> V_191 )
return - V_198 ;
V_139 = F_93 ( & V_93 -> V_56 , V_199 ) ;
if ( V_139 ) {
F_89 ( V_7 -> V_191 ) ;
V_7 -> V_191 = NULL ;
return V_139 ;
}
V_93 -> V_112 = F_67 ( V_93 -> V_28 . V_52 ) ;
V_93 -> V_157 = V_93 -> V_112 + V_93 -> V_158 ;
V_146 = V_93 -> V_157 + sizeof( struct V_64 ) ;
V_7 -> V_165 = V_200 + V_146 ;
V_7 -> V_78 = V_201 - V_146 ;
if ( V_7 -> type == V_24 )
V_7 -> V_78 -= V_166 ;
...
return V_139 ;
V_93 = F_12 ( V_7 ) ;
memcpy ( V_7 -> V_147 , & V_93 -> V_28 . V_29 , sizeof( struct V_1 ) ) ;
memcpy ( V_7 -> V_148 , & V_93 -> V_28 . V_30 , sizeof( struct V_1 ) ) ;
...
static void F_96 ( struct V_12 * V_12 , struct V_203 * V_204 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
...
static int T_10 F_100 ( struct V_12 * V_12 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
int V_117 ;
...
static void T_11 F_102 ( struct V_12 * V_12 )
{
F_103 ( V_212 ) ;
F_104 () ;
F_96 ( V_12 , & V_212 ) ;
...
static int F_107 ( struct V_213 * V_214 [] , struct V_213 * V_66 [] )
{
T_3 V_32 ;
if ( ! V_66 )
return 0 ;
V_32 = 0 ;
if ( V_66 [ V_215 ] )
V_32 |= F_108 ( V_66 [ V_215 ] ) ;
if ( V_66 [ V_216 ] )
V_32 |= F_108 ( V_66 [ V_216 ] ) ;
if ( V_32 & ( V_72 | V_71 ) )
return - V_184 ;
return 0 ;
}
static int F_109 ( struct V_213 * V_214 [] , struct V_213 * V_66 [] )
{
struct V_1 V_73 ;
if ( V_214 [ V_217 ] ) {
if ( F_110 ( V_214 [ V_217 ] ) != V_218 )
return - V_184 ;
if ( ! F_111 ( F_112 ( V_214 [ V_217 ] ) ) )
return - V_219 ;
}
if ( ! V_66 )
goto V_220;
if ( V_66 [ V_221 ] ) {
V_73 = F_113 ( V_66 [ V_221 ] ) ;
if ( F_14 ( & V_73 ) )
return - V_184 ;
}
V_220:
return F_107 ( V_214 , V_66 ) ;
}
static void F_114 ( struct V_213 * V_66 [] ,
struct V_35 * V_28 )
{
...
F_108 ( V_66 [ V_216 ] ) ) ;
if ( V_66 [ V_223 ] )
V_28 -> V_31 = F_116 ( V_66 [ V_223 ] ) ;
if ( V_66 [ V_224 ] )
V_28 -> V_113 = F_116 ( V_66 [ V_224 ] ) ;
if ( V_66 [ V_225 ] )
V_28 -> V_29 = F_113 ( V_66 [ V_225 ] ) ;
if ( V_66 [ V_221 ] )
V_28 -> V_30 = F_113 ( V_66 [ V_221 ] ) ;
if ( V_66 [ V_226 ] )
V_28 -> V_167 = F_117 ( V_66 [ V_226 ] ) ;
if ( V_66 [ V_227 ] )
V_28 -> V_84 = F_117 ( V_66 [ V_227 ] ) ;
if ( V_66 [ V_228 ] )
V_28 -> V_151 = F_115 ( V_66 [ V_228 ] ) ;
if ( V_66 [ V_229 ] )
V_28 -> V_32 = F_115 ( V_66 [ V_229 ] ) ;
}
...
static bool F_121 ( struct V_213 * V_66 [] ,
struct V_234 * V_235 )
{
bool V_139 = false ;
...
if ( V_66 [ V_236 ] ) {
V_139 = true ;
V_235 -> type = F_122 ( V_66 [ V_236 ] ) ;
}
if ( V_66 [ V_237 ] ) {
V_139 = true ;
V_235 -> V_32 = F_122 ( V_66 [ V_237 ] ) ;
}
if ( V_66 [ V_238 ] ) {
V_139 = true ;
V_235 -> V_239 = F_108 ( V_66 [ V_238 ] ) ;
}
if ( V_66 [ V_240 ] ) {
V_139 = true ;
V_235 -> V_241 = F_108 ( V_66 [ V_240 ] ) ;
}
return V_139 ;
}
static int F_123 ( struct V_12 * V_242 , struct V_6 * V_7 ,
...
V_44 = F_12 ( V_7 ) ;
if ( F_121 ( V_66 , & V_235 ) ) {
int V_117 = F_124 ( V_44 , & V_235 ) ;
if ( V_117 < 0 )
return V_117 ;
}
F_114 ( V_66 , & V_44 -> V_28 ) ;
...
static int F_126 ( struct V_6 * V_7 , struct V_213 * V_214 [] ,
struct V_213 * V_66 [] )
{
...
F_19 ( V_20 , V_17 ) ;
F_71 ( V_17 , & V_36 , ! V_214 [ V_243 ] ) ;
F_16 ( V_20 , V_17 ) ;
return 0 ;
}
static void F_127 ( struct V_6 * V_7 , struct V_203 * V_204 )
{
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
if ( V_7 != V_20 -> V_34 )
...
static T_12 F_128 ( const struct V_6 * V_7 )
{
return
F_129 ( 4 ) +
F_129 ( 2 ) +
...
static int F_130 ( struct V_57 * V_58 , const struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_131 ( V_58 , V_222 , V_36 -> V_13 ) ||
F_132 ( V_58 , V_215 ,
F_75 ( V_36 -> V_168 ) ) ||
F_132 ( V_58 , V_216 ,
F_75 ( V_36 -> V_52 ) ) ||
F_133 ( V_58 , V_223 , V_36 -> V_31 ) ||
F_133 ( V_58 , V_224 , V_36 -> V_113 ) ||
F_134 ( V_58 , V_225 , & V_36 -> V_29 ) ||
F_134 ( V_58 , V_221 , & V_36 -> V_30 ) ||
F_135 ( V_58 , V_226 , V_36 -> V_167 ) ||
F_135 ( V_58 , V_227 , V_36 -> V_84 ) ||
F_133 ( V_58 , V_228 , V_36 -> V_151 ) ||
F_131 ( V_58 , V_229 , V_36 -> V_32 ) )
goto V_249;
if ( F_136 ( V_58 , V_236 ,
V_17 -> V_246 . type ) ||
F_132 ( V_58 , V_238 ,
