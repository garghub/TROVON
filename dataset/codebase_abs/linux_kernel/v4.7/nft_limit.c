...
if ( V_46 < 0 )
return V_46 ;
V_40 -> V_3 = F_11 ( V_40 -> V_2 . V_18 , V_40 -> V_2 . V_17 ) ;
return 0 ;
}
static int F_19 ( struct V_26 * V_27 , const struct V_33 * V_34 )
{
const struct V_39 * V_40 = F_17 ( V_34 ) ;
return F_10 ( V_27 , & V_40 -> V_2 , V_47 ) ;
}
static void F_20 ( const struct V_33 * V_34 ,
struct V_35 * V_36 ,
const struct V_37 * V_38 )
{
struct V_1 * V_40 = F_17 ( V_34 ) ;
T_1 V_3 = F_11 ( V_40 -> V_18 * V_38 -> V_27 -> V_48 , V_40 -> V_17 ) ;
if ( F_1 ( V_40 , V_3 ) )
V_36 -> V_41 . V_42 = V_43 ;
}
