...
T_5 F_51 ( struct V_99 * V_99 , unsigned long V_76 ,
unsigned long V_96 , T_5 V_100 )
{
return V_100 ;
}
static inline int F_52 ( unsigned long V_76 , unsigned long V_96 )
{
return 1 ;
}
static inline int F_52 ( unsigned long V_76 , unsigned long V_96 )
...
int F_54 ( struct V_99 * V_99 , unsigned long V_76 ,
unsigned long V_96 , T_5 * V_100 )
{
enum V_6 V_104 = V_13 ;
if ( ! F_52 ( V_76 , V_96 ) )
...
{
unsigned long V_109 ;
if ( V_108 > F_58 ( V_110 - 1 ) )
return 0 ;
if ( ! F_59 ( V_108 >> V_71 ) )
return 0 ;
V_109 = ( F_58 ( V_110 - 1 ) <= V_108 + V_96 ) ?
F_58 ( V_110 ) - V_108 :
V_96 ;
if ( F_60 ( ( unsigned long ) F_61 ( V_108 ) , V_109 , V_104 ) < 0 ) {
F_3 ( L_21 ,
V_91 -> V_92 , V_91 -> V_93 ,
F_37 ( V_104 ) ,
...
static int F_62 ( T_2 V_94 , unsigned long V_96 , T_5 * V_100 ,
int V_111 )
{
int V_112 = 0 ;
int V_69 ;
enum V_6 V_113 = F_63 ( * V_100 ) ;
...
static void F_66 ( T_2 V_94 , unsigned long V_96 )
{
int V_112 ;
V_112 = F_26 ( V_94 , V_94 + V_96 ) ;
if ( V_112 == 0 )
...
if ( F_68 ( V_115 , V_115 -> V_119 , 0 , & V_116 , & V_94 ) ) {
F_29 ( 1 ) ;
return - V_78 ;
}
V_120 = F_55 ( V_116 ) ;
return F_62 ( V_94 , V_117 , & V_120 , 1 ) ;
}
return 0 ;
}
int F_69 ( struct V_114 * V_115 , T_5 * V_116 ,
unsigned long V_76 , unsigned long V_123 , unsigned long V_96 )
{
T_4 V_94 = ( T_4 ) V_76 << V_71 ;
enum V_6 V_104 ;
if ( V_123 == V_115 -> V_119 && V_96 == ( V_115 -> V_118 - V_115 -> V_119 ) ) {
int V_69 ;
V_69 = F_62 ( V_94 , V_96 , V_116 , 0 ) ;
if ( ! V_69 )
V_115 -> V_121 |= V_122 ;
return V_69 ;
}
...
* V_116 = F_55 ( ( F_56 ( * V_116 ) & ( ~ V_107 ) ) |
F_57 ( V_104 ) ) ;
return 0 ;
}
int F_70 ( struct V_114 * V_115 , T_5 * V_116 ,
T_6 V_76 )
{
enum V_6 V_104 ;
if ( ! F_6 () )
return 0 ;
V_104 = F_44 ( F_71 ( V_76 ) ) ;
* V_116 = F_55 ( ( F_56 ( * V_116 ) & ( ~ V_107 ) ) |
F_57 ( V_104 ) ) ;
return 0 ;
}
void F_72 ( struct V_114 * V_115 , unsigned long V_76 ,
unsigned long V_96 )
{
T_4 V_94 ;
unsigned long V_116 ;
...
void F_73 ( struct V_114 * V_115 )
{
V_115 -> V_121 &= ~ V_122 ;
}
T_5 F_74 ( T_5 V_116 )
{
return F_55 ( F_56 ( V_116 ) |
F_57 ( V_15 ) ) ;
}
T_5 F_75 ( T_5 V_116 )
{
...
static struct V_19 * F_76 ( T_7 V_124 )
{
struct V_19 * V_125 ;
int V_69 ;
...
static void * F_78 ( struct V_126 * V_127 , T_7 * V_124 )
{
if ( * V_124 == 0 ) {
++ * V_124 ;
F_79 ( V_127 , L_24 ) ;
...
static void * F_80 ( struct V_126 * V_127 , void * V_128 , T_7 * V_124 )
{
++ * V_124 ;
return F_76 ( * V_124 ) ;
}
static void F_81 ( struct V_126 * V_127 , void * V_128 )
{
}
static int F_82 ( struct V_126 * V_127 , void * V_128 )
{
struct V_19 * V_125 = (struct V_19 * ) V_128 ;
F_83 ( V_127 , L_25 , F_37 ( V_125 -> type ) ,
V_125 -> V_55 , V_125 -> V_56 ) ;
F_38 ( V_125 ) ;
return 0 ;
}
static int F_84 ( struct V_129 * V_129 , struct V_99 * V_99 )
{
return F_85 ( V_99 , & V_130 ) ;
}
