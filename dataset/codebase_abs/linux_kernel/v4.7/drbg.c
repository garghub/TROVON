...
V_61 = V_63 ;
V_58 . V_7 = & V_61 ;
V_17 = F_21 ( V_12 , V_12 -> V_53 , & V_26 ) ;
if ( V_17 )
return V_17 ;
F_20 ( V_12 , V_12 -> V_53 ) ;
V_17 = F_21 ( V_12 , V_12 -> V_52 , & V_60 ) ;
if ( V_17 )
return V_17 ;
if ( ! V_44 )
return V_17 ;
...
static inline void F_23 ( unsigned char * V_65 , T_4 V_66 ,
...
static int F_26 ( struct V_11 * V_12 , struct V_15 * V_44 ,
int V_48 )
{
int V_17 = 0 ;
...
F_13 ( V_44 , & V_64 ) ;
V_17 = F_24 ( V_12 , V_12 -> V_52 , F_11 ( V_12 ) , & V_64 ) ;
if ( V_17 )
goto V_13;
V_61 = V_62 ;
F_5 ( & V_76 , & V_61 , 1 ) ;
...
F_12 ( & V_77 . V_46 , & V_78 ) ;
V_17 = F_24 ( V_12 , V_12 -> V_53 , F_11 ( V_12 ) , & V_78 ) ;
V_13:
...
F_12 ( & V_77 . V_46 , & V_64 ) ;
F_13 ( V_55 , & V_64 ) ;
V_17 = F_21 ( V_12 , V_12 -> V_49 , & V_64 ) ;
if ( V_17 )
goto V_13;
F_23 ( V_12 -> V_52 , F_11 ( V_12 ) ,
V_12 -> V_49 , F_6 ( V_12 ) ) ;
V_13:
memset ( V_12 -> V_49 , 0 , F_6 ( V_12 ) ) ;
return V_17 ;
...
F_23 ( V_12 -> V_52 , F_11 ( V_12 ) ,
V_12 -> V_53 , F_11 ( V_12 ) ) ;
V_83 . V_82 = F_30 ( V_12 -> V_85 ) ;
F_23 ( V_12 -> V_52 , F_11 ( V_12 ) , V_83 . V_81 , 8 ) ;
V_13:
memset ( V_12 -> V_49 , 0 , F_6 ( V_12 ) ) ;
return V_23 ;
}
static inline int F_31 ( struct V_11 * V_12 , struct V_15 * V_44 ,
int V_48 )
{
...
struct V_18 V_20 ;
F_10 ( V_26 ) ;
struct V_11 * V_12 = F_33 ( V_90 , struct V_11 ,
V_91 ) ;
unsigned int V_92 = F_1 ( V_12 -> V_93 -> V_1 ) ;
unsigned char V_94 [ 32 ] ;
F_34 ( ! V_92 ) ;
F_34 ( V_92 > sizeof( V_94 ) ) ;
F_35 ( V_94 , V_92 ) ;
F_5 ( & V_20 , V_94 , V_92 ) ;
F_12 ( & V_20 . V_46 , & V_26 ) ;
F_36 ( & V_12 -> V_95 ) ;
...
static int F_41 ( struct V_11 * V_12 , struct V_18 * V_98 ,
bool V_48 )
{
int V_17 ;
...
static inline int F_47 ( struct V_11 * V_12 )
{
int V_17 = - V_100 ;
...
V_12 -> V_52 = F_51 ( F_11 ( V_12 ) , V_111 ) ;
if ( ! V_12 -> V_52 )
goto V_110;
V_12 -> V_53 = F_51 ( F_11 ( V_12 ) , V_111 ) ;
if ( ! V_12 -> V_53 )
goto V_110;
...
V_115 = ( ( V_54 - V_23 ) / F_54 ( V_12 ) ) ;
V_116 = V_115 ? F_54 ( V_12 ) : ( V_54 - V_23 ) ;
F_36 ( & V_12 -> V_95 ) ;
V_110 = F_53 ( V_12 , V_7 + V_23 , V_116 , V_55 ) ;
F_39 ( & V_12 -> V_95 ) ;
if ( 0 > V_110 )
return V_110 ;
V_23 += V_116 ;
...
{
struct V_11 * V_12 = F_33 ( V_118 , struct V_11 ,
V_119 ) ;
F_57 ( & V_12 -> V_91 ) ;
}
...
V_12 -> V_119 . V_122 = F_56 ;
V_110 = F_60 ( & V_12 -> V_119 ) ;
switch ( V_110 ) {
case 0 :
break;
case - V_123 :
...
V_12 -> V_96 = F_61 ( L_21 , 0 , 0 ) ;
V_12 -> V_97 = 50 ;
return V_110 ;
}
static int F_62 ( struct V_11 * V_12 , struct V_18 * V_98 ,
...
struct V_134 * V_134 ;
struct V_135 * V_133 ;
V_133 = F_72 ( V_12 -> V_93 -> V_136 , 0 , 0 ) ;
if ( F_63 ( V_133 ) ) {
F_65 ( L_27 ,
V_12 -> V_93 -> V_136 ) ;
return F_64 ( V_133 ) ;
}
F_34 ( F_6 ( V_12 ) != F_73 ( V_133 ) ) ;
V_134 = F_52 ( sizeof( struct V_137 ) + F_74 ( V_133 ) ,
V_111 ) ;
if ( ! V_134 ) {
F_75 ( V_133 ) ;
return - V_100 ;
...
{
struct V_134 * V_134 = (struct V_134 * ) V_12 -> V_139 ;
F_77 ( V_134 -> V_138 . V_133 , V_14 , F_11 ( V_12 ) ) ;
}
static int F_21 ( struct V_11 * V_12 , unsigned char * V_72 ,
...
F_78 ( & V_134 -> V_138 ) ;
F_7 (input, in, list)
F_79 ( & V_134 -> V_138 , V_74 -> V_7 , V_74 -> V_23 ) ;
return F_80 ( & V_134 -> V_138 , V_72 ) ;
}
static int F_81 ( struct V_11 * V_12 )
{
int V_17 = 0 ;
struct V_140 * V_133 ;
V_133 = F_82 ( V_12 -> V_93 -> V_136 , 0 , 0 ) ;
if ( F_63 ( V_133 ) ) {
F_65 ( L_28 ,
V_12 -> V_93 -> V_136 ) ;
return F_64 ( V_133 ) ;
}
F_34 ( F_6 ( V_12 ) != F_83 ( V_133 ) ) ;
V_12 -> V_139 = V_133 ;
return V_17 ;
}
...
struct V_140 * V_133 =
(struct V_140 * ) V_12 -> V_139 ;
F_86 ( V_133 , V_14 , ( F_14 ( V_12 ) ) ) ;
F_34 ( V_16 -> V_23 < F_6 ( V_12 ) ) ;
F_87 ( V_133 , V_72 , V_16 -> V_7 ) ;
return 0 ;
}
static inline void F_88 ( const char * V_141 ,
int * V_124 , bool * V_113 )
{
int V_39 = 0 ;
T_4 V_142 = 0 ;
...
for ( V_39 = 0 ; F_89 ( V_125 ) > V_39 ; V_39 ++ ) {
...
static int F_90 ( struct V_144 * V_133 )
{
struct V_11 * V_12 = F_91 ( V_133 ) ;
F_92 ( & V_12 -> V_95 ) ;
return 0 ;
}
static void F_93 ( struct V_144 * V_133 )
{
F_66 ( F_91 ( V_133 ) ) ;
}
...
return F_55 ( V_12 , V_65 , V_146 , V_55 ) ;
}
static int F_95 ( struct V_132 * V_133 ,
const T_6 * V_44 , unsigned int V_145 )
{
struct V_11 * V_12 = F_70 ( V_133 ) ;
struct V_144 * V_147 = F_96 ( V_133 ) ;
bool V_113 = false ;
struct V_18 string ;
struct V_18 * V_148 = NULL ;
int V_124 = 0 ;
F_88 ( F_97 ( V_147 ) , & V_124 ,
& V_113 ) ;
if ( 0 < V_145 ) {
F_5 ( & string , V_44 , V_145 ) ;
V_148 = & string ;
}
return F_62 ( V_12 , V_148 , V_124 , V_113 ) ;
}
static inline int T_7 F_98 ( void )
{
int V_23 = 0 ;
#define F_99 16
unsigned char V_7 [ F_99 ] ;
...
return 0 ;
#ifdef F_50
F_88 ( L_31 , & V_124 , & V_113 ) ;
#elif V_152 F_49
F_88 ( L_32 , & V_124 , & V_113 ) ;
#else
F_88 ( L_33 , & V_124 , & V_113 ) ;
#endif
V_12 = F_52 ( sizeof( struct V_11 ) , V_111 ) ;
if ( ! V_12 )
return - V_100 ;
F_92 ( & V_12 -> V_95 ) ;
V_17 = F_62 ( V_12 , NULL , V_124 , V_113 ) ;
if ( V_17 ) {
V_149 = V_17 ;
goto V_153;
}
...
V_23 = F_53 ( V_12 , V_7 , F_99 , & V_55 ) ;
F_34 ( 0 < V_23 ) ;
V_23 = F_53 ( V_12 , V_7 , ( V_151 + 1 ) , NULL ) ;
F_34 ( 0 < V_23 ) ;
F_66 ( V_12 ) ;
V_17 = F_62 ( V_12 , & V_55 , V_124 , V_113 ) ;
F_34 ( 0 == V_17 ) ;
V_149 = 0 ;
F_43 ( L_34
L_35 ) ;
...
static inline void T_7 F_100 ( struct V_154 * V_155 ,
...
V_155 -> V_158 . V_162 = F_90 ;
V_155 -> V_158 . V_163 = F_93 ;
V_155 -> V_114 = F_94 ;
V_155 -> V_44 = F_95 ;
V_155 -> V_164 = F_69 ;
V_155 -> V_165 = 0 ;
...
if ( V_17 )
return V_17 ;
if ( F_89 ( V_125 ) * 2 > F_89 ( V_167 ) ) {
F_65 ( L_37
L_38 ,
F_89 ( V_125 ) * 2 , F_89 ( V_167 ) ) ;
return V_17 ;
}
for ( V_166 = 0 ; F_89 ( V_125 ) > V_166 ; V_166 ++ , V_39 ++ )
F_100 ( & V_167 [ V_39 ] , & V_125 [ V_166 ] , 1 ) ;
for ( V_166 = 0 ; F_89 ( V_125 ) > V_166 ; V_166 ++ , V_39 ++ )
F_100 ( & V_167 [ V_39 ] , & V_125 [ V_166 ] , 0 ) ;
return F_102 ( V_167 , ( F_89 ( V_125 ) * 2 ) ) ;
}
static void T_8 F_103 ( void )
{
F_104 ( V_167 , ( F_89 ( V_125 ) * 2 ) ) ;
}
