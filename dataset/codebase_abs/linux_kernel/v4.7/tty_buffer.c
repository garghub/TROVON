...
int F_41 ( struct V_33 * V_34 , unsigned char * V_17 ,
char * V_48 , int V_49 )
{
if ( V_34 -> V_35 -> V_50 )
...
static int
V_52 ( struct V_33 * V_34 , struct V_16 * V_8 , int V_49 )
{
unsigned char * V_17 = F_35 ( V_8 , V_8 -> V_10 ) ;
char * V_48 = NULL ;
if ( ~ V_8 -> V_21 & V_40 )
V_48 = F_36 ( V_8 , V_8 -> V_10 ) ;
return F_41 ( V_34 , V_17 , V_48 , V_49 ) ;
}
...
int F_52 ( struct V_1 * V_2 , int V_57 )
{
if ( V_57 < V_27 )
return - V_58 ;
V_2 -> V_4 . V_14 = V_57 ;
