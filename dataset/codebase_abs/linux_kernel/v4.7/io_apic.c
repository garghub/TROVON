...
if ( ! V_217 )
V_217 = V_252 ;
V_249 -> V_15 = F_183 ( V_211 -> V_253 , V_248 , V_211 -> V_254 ,
( void * ) ( long ) V_8 ) ;
if ( ! V_249 -> V_15 )
return - V_62 ;
...
unsigned int F_195 ( unsigned int V_261 )
{
return V_125 ? V_255 : V_262 ;
}
static int F_196 ( int V_8 , int V_263 )
{
union V_153 V_154 ;
...
static T_7 F_198 ( int V_33 , T_7 V_266 )
{
if ( ( V_195 . V_196 == V_197 ) &&
! F_136 ( V_198 [ V_199 ] ) )
return F_196 ( V_33 , V_266 ) ;
else
return V_266 ;
}
static T_7 F_198 ( int V_33 , T_7 V_266 )
...
V_268 = F_202 ( V_267 , 256 ) ;
V_154 . V_162 . V_164 = V_268 ;
F_32 ( & V_54 , V_53 ) ;
F_28 ( V_33 , 0 , V_154 . V_161 ) ;
V_154 . V_161 = F_30 ( V_33 , 0 ) ;
F_33 ( & V_54 , V_53 ) ;
F_187 ( V_154 . V_162 . V_164 != V_268 ) ;
return V_268 ;
}
...
static struct V_275 * T_2 F_213 ( void )
{
unsigned long V_276 ;
struct V_275 * V_277 ;
char * V_278 ;
...
V_290:
#endif
V_286 = ( unsigned long ) F_216 ( V_291 ) ;
V_286 = F_217 ( V_286 ) ;
}
F_218 ( V_33 , V_286 ) ;
F_14 ( V_23 , L_102 ,
F_219 ( V_33 ) + ( V_286 & ~ V_292 ) ,
V_286 ) ;
V_33 ++ ;
V_288 -> V_293 = V_286 ;
...
int F_225 ( int V_266 , T_1 V_299 , T_1 V_11 ,
struct V_250 * V_211 )
{
bool V_300 = ! ! V_125 ;
struct V_6 * V_9 ;
...
F_218 ( V_287 + V_33 , V_299 ) ;
if ( F_223 ( V_33 ) ) {
F_226 ( V_287 + V_33 ) ;
return - V_306 ;
}
V_2 [ V_33 ] . V_3 . V_4 = F_198 ( V_33 , V_266 ) ;
V_2 [ V_33 ] . V_3 . V_307 = F_203 ( V_33 ) ;
V_167 = F_194 ( V_33 ) ;
V_10 = V_11 + V_167 - 1 ;
F_22 (ioapic) {
V_9 = F_3 ( V_8 ) ;
...
static void F_232 ( struct V_210 * V_211 , struct V_58 * V_46 ,
struct V_36 * V_52 )
{
memset ( V_52 , 0 , sizeof( * V_52 ) ) ;
...
int F_233 ( struct V_14 * V_121 , unsigned int V_310 ,
...
V_218 = F_235 ( V_121 , V_310 , V_311 , V_102 ) ;
if ( V_218 < 0 ) {
F_20 ( V_46 ) ;
return V_218 ;
}
...
void F_237 ( struct V_14 * V_121 , unsigned int V_310 ,
unsigned int V_311 )
{
struct V_72 * V_72 ;
struct V_58 * V_46 ;
