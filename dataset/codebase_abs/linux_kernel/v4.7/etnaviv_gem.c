...
struct V_13 * * V_133 ;
T_6 V_134 ;
V_133 = F_99 ( V_20 , sizeof( struct V_13 * ) ) ;
if ( ! V_133 )
return F_16 ( - V_50 ) ;
V_132 = 0 ;
...
{
struct V_141 * V_142 = F_106 ( V_140 , F_107 ( * V_142 ) , V_142 ) ;
struct V_1 * V_2 = V_142 -> V_2 ;
struct V_13 * * V_133 ;
V_133 = F_98 ( V_2 , V_142 -> V_129 , V_142 -> V_131 ) ;
F_43 ( & V_2 -> V_17 ) ;
if ( F_7 ( V_133 ) ) {
...
F_115 ( & V_142 -> V_142 , F_105 ) ;
F_116 ( V_2 -> V_5 . V_4 , & V_142 -> V_142 ) ;
return - V_45 ;
}
