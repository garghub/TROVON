...
if ( F_28 ( V_34 , V_89 , sizeof( V_85 ) , & V_85 , V_90 ) )
goto V_86;
return V_34 -> V_91 ;
V_86:
F_29 ( V_34 , V_77 ) ;
...
static int F_30 ( struct V_1 * V_1 , struct V_33 * V_34 ,
struct V_92 * V_93 , int type ,
struct V_5 * V_6 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_31 ( V_10 , V_34 , V_93 , type , V_6 ) ;
}
static int F_32 ( struct V_1 * V_1 , struct V_5 * V_6 , T_2 V_23 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_33 ( V_10 , V_6 , V_23 ) ;
}
static T_3 int F_34 ( struct V_1 * V_1 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_35 ( V_10 , & V_94 , V_95 ) ;
}
static void T_4 F_36 ( struct V_1 * V_1 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
F_37 ( V_10 ) ;
}
