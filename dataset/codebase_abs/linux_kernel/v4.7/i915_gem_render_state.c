...
if ( V_11 )
return V_11 ;
V_22 = F_10 ( V_10 -> V_15 , 0 ) ;
V_23 = F_11 ( V_22 ) ;
while ( V_20 < V_12 -> V_13 ) {
T_1 V_24 = V_12 -> V_25 [ V_20 ] ;
if ( V_20 * 4 == V_12 -> V_26 [ V_21 ] ) {
T_2 V_27 = V_24 + V_10 -> V_18 ;
V_24 = F_12 ( V_27 ) ;
if ( V_10 -> V_4 >= 8 ) {
if ( V_20 + 1 >= V_12 -> V_13 ||
V_12 -> V_25 [ V_20 + 1 ] != 0 ) {
...
while ( V_20 % V_29 )
F_14 ( V_23 , V_20 , V_30 ) ;
V_10 -> V_31 = V_20 * sizeof( T_1 ) ;
F_14 ( V_23 , V_20 , V_32 ) ;
V_10 -> V_33 = ( V_20 * sizeof( T_1 ) ) - V_10 -> V_31 ;
V_10 -> V_33 = F_15 ( V_10 -> V_33 , 8 ) ;
F_16 ( V_22 ) ;
...
{
int V_11 ;
if ( F_22 ( V_35 -> V_36 != V_37 ) )
return - V_38 ;
V_11 = F_2 ( V_10 , V_35 -> V_3 ) ;
if ( V_11 )
return V_11 ;
if ( V_10 -> V_12 == NULL )
return 0 ;
...
struct V_9 V_10 ;
int V_11 ;
V_11 = F_21 ( V_40 -> V_35 , & V_10 ) ;
if ( V_11 )
return V_11 ;
if ( V_10 . V_12 == NULL )
return 0 ;
V_11 = V_40 -> V_35 -> V_41 ( V_40 , V_10 . V_18 ,
V_10 . V_12 -> V_13 * 4 ,
V_42 ) ;
if ( V_11 )
goto V_43;
if ( V_10 . V_33 > 8 ) {
V_11 = V_40 -> V_35 -> V_41 ( V_40 ,
( V_10 . V_18 +
V_10 . V_31 ) ,
V_10 . V_33 ,
V_42 ) ;
