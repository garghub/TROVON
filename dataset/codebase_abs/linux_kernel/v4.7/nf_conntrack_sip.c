...
for ( V_175 = 0 ; V_175 < F_62 ( V_177 [ V_119 ] ) ; V_175 ++ ) {
if ( V_177 [ V_119 ] [ V_175 ] . V_178 == NULL )
continue;
F_83 ( & V_177 [ V_119 ] [ V_175 ] ) ;
}
}
}
static int T_4 F_84 ( void )
{
int V_119 , V_175 , V_15 ;
if ( V_176 == 0 )
V_179 [ V_176 ++ ] = V_30 ;
for ( V_119 = 0 ; V_119 < V_176 ; V_119 ++ ) {
memset ( & V_177 [ V_119 ] , 0 , sizeof( V_177 [ V_119 ] ) ) ;
V_177 [ V_119 ] [ 0 ] . V_66 . V_104 . V_106 = V_16 ;
V_177 [ V_119 ] [ 0 ] . V_66 . V_67 . V_69 = V_47 ;
V_177 [ V_119 ] [ 0 ] . V_58 = F_81 ;
V_177 [ V_119 ] [ 1 ] . V_66 . V_104 . V_106 = V_16 ;
V_177 [ V_119 ] [ 1 ] . V_66 . V_67 . V_69 = V_46 ;
V_177 [ V_119 ] [ 1 ] . V_58 = F_76 ;
V_177 [ V_119 ] [ 2 ] . V_66 . V_104 . V_106 = V_19 ;
V_177 [ V_119 ] [ 2 ] . V_66 . V_67 . V_69 = V_47 ;
V_177 [ V_119 ] [ 2 ] . V_58 = F_81 ;
V_177 [ V_119 ] [ 3 ] . V_66 . V_104 . V_106 = V_19 ;
V_177 [ V_119 ] [ 3 ] . V_66 . V_67 . V_69 = V_46 ;
V_177 [ V_119 ] [ 3 ] . V_58 = F_76 ;
for ( V_175 = 0 ; V_175 < F_62 ( V_177 [ V_119 ] ) ; V_175 ++ ) {
V_177 [ V_119 ] [ V_175 ] . V_180 = sizeof( struct V_134 ) ;
V_177 [ V_119 ] [ V_175 ] . V_66 . V_104 . V_70 . V_71 . V_27 = F_17 ( V_179 [ V_119 ] ) ;
V_177 [ V_119 ] [ V_175 ] . V_181 = V_182 ;
V_177 [ V_119 ] [ V_175 ] . V_183 = V_184 ;
V_177 [ V_119 ] [ V_175 ] . V_178 = V_185 ;
if ( V_179 [ V_119 ] == V_30 )
sprintf ( V_177 [ V_119 ] [ V_175 ] . V_37 , L_24 ) ;
else
sprintf ( V_177 [ V_119 ] [ V_175 ] . V_37 , L_25 , V_119 ) ;
F_13 ( L_26 , V_119 , V_179 [ V_119 ] ) ;
V_15 = F_85 ( & V_177 [ V_119 ] [ V_175 ] ) ;
if ( V_15 ) {
F_86 ( L_27 ,
V_177 [ V_119 ] [ V_175 ] . V_66 . V_104 . V_106 , V_179 [ V_119 ] ) ;
V_176 = V_119 ;
F_82 () ;
return V_15 ;
}
