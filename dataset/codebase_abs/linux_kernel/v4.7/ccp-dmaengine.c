...
{
struct V_10 * V_11 ;
V_11 = F_35 ( V_18 -> V_2 -> V_15 , V_41 ) ;
if ( ! V_11 )
return NULL ;
memset ( V_11 , 0 , sizeof( * V_11 ) ) ;
F_37 ( & V_11 -> V_24 , & V_18 -> V_16 ) ;
V_11 -> V_24 . V_19 = V_19 ;
V_11 -> V_24 . V_42 = F_31 ;
V_11 -> V_2 = V_18 -> V_2 ;
F_38 ( & V_11 -> V_14 ) ;
...
static struct V_10 * F_39 ( struct V_16 * V_16 ,
struct V_44 * V_45 ,
unsigned int V_46 ,
struct V_44 * V_47 ,
unsigned int V_48 ,
...
V_50 -> V_64 = V_65 ;
V_50 -> V_66 = V_67 ;
V_50 -> V_68 = F_43 ( V_47 ) + V_51 ;
V_50 -> V_69 = F_43 ( V_45 ) + V_53 ;
V_50 -> V_52 = V_55 ;
V_50 -> V_70 = 1 ;
V_28 -> V_35 = F_29 ;
V_28 -> V_25 = V_11 ;
...
F_43 ( & V_47 ) = V_72 ;
F_40 ( & V_47 ) = V_55 ;
V_11 = F_39 ( V_16 , & V_45 , 1 , & V_47 , 1 , V_19 ) ;
if ( ! V_11 )
return NULL ;
return & V_11 -> V_24 ;
}
static struct V_31 * F_46 (
...
V_11 = F_39 ( V_16 , V_45 , V_46 , V_47 , V_48 ,
V_19 ) ;
if ( ! V_11 )
return NULL ;
return & V_11 -> V_24 ;
...
static void F_48 ( struct V_16 * V_16 )
{
struct V_17 * V_18 = F_7 ( V_16 , struct V_17 ,
V_16 ) ;
struct V_10 * V_11 ;
...
static enum V_73 F_49 ( struct V_16 * V_16 ,
T_1 V_27 ,
struct V_74 * V_75 )
{
struct V_17 * V_18 = F_7 ( V_16 , struct V_17 ,
...
V_26 = F_50 ( V_16 , V_27 , V_75 ) ;
if ( V_26 == V_34 ) {
F_9 ( & V_18 -> V_22 , V_19 ) ;
F_51 (desc, &chan->complete, entry) {
...
static int F_52 ( struct V_16 * V_16 )
{
struct V_17 * V_18 = F_7 ( V_16 , struct V_17 ,
V_16 ) ;
V_18 -> V_32 = V_39 ;
...
unsigned int V_81 ;
int V_26 ;
V_2 -> V_17 = F_56 ( V_2 -> V_20 , V_2 -> V_82 ,
sizeof( * ( V_2 -> V_17 ) ) ,
V_83 ) ;
if ( ! V_2 -> V_17 )
return - V_84 ;
V_79 = F_57 ( V_2 -> V_20 , V_83 ,
L_15 ,
V_2 -> V_85 ) ;
if ( ! V_79 )
return - V_84 ;
...
V_78 -> V_20 = V_2 -> V_20 ;
V_78 -> V_88 = F_59 ( F_60 ( V_2 -> V_20 ) ) ;
V_78 -> V_89 = F_59 ( F_60 ( V_2 -> V_20 ) ) ;
V_78 -> V_90 = V_91 ;
V_78 -> V_92 = V_93 ;
F_61 ( V_94 , V_78 -> V_95 ) ;
F_61 ( V_96 , V_78 -> V_95 ) ;
