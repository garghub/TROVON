...
V_54 = V_66 -> V_160 ;
if ( V_54 -> V_176 & V_177 ) {
V_161 = F_114 ( sizeof( struct V_53 ) ,
V_178 ) ;
if ( V_161 == NULL ) {
if ( F_109 ( & V_66 -> V_62 ) )
F_110 ( & V_66 -> V_62 , & V_62 ) ;
...
struct V_179 * V_130 = & V_66 -> V_130 [ V_66 -> V_174 ] ;
V_161 = F_114 ( sizeof( struct V_53 ) ,
V_178 ) ;
if( V_161 == NULL ) {
if( F_109 ( & V_66 -> V_62 ) )
...
static int F_116 ( struct V_147 * V_148 , struct V_180 * V_181 )
{
...
static int F_117 ( struct V_147 * V_148 , T_7 V_97 ,
...
if( V_54 -> V_153 == - 1 )
return 0 ;
V_3 = F_120 ( V_54 -> V_165 [ 1 ] , & V_54 -> V_154 ,
...
V_202 = 0 ;
do {
V_1 = F_1 ( V_202 , ( unsigned char * ) & V_54 -> V_157 ) ;
V_23 = V_202 ;
while( ( V_23 < V_201 ) &&
...
V_78 = & V_54 -> V_169 [ V_202 * V_54 -> V_95 ] ;
if( V_54 -> V_158 == V_159 ) {
V_3 = 0 ;
do {
V_78 = & V_78 [ V_3 ] ;
...
V_3 = F_120 ( V_54 -> V_165 [ V_1 ] , V_78 , V_80 , V_5 ) ;
if( V_3 != V_80 ) {
F_18 ( L_72
L_70 , - V_3 , V_54 -> V_165 [ V_1 ] ) ;
V_54 -> error = 1 ;
