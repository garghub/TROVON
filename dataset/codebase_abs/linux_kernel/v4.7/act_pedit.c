...
if ( F_32 ( V_41 , V_82 , sizeof( V_72 ) , & V_72 , V_83 ) )
goto V_79;
F_13 ( V_70 ) ;
return V_41 -> V_60 ;
V_79:
...
static int F_34 ( struct V_1 * V_1 , struct V_40 * V_41 ,
struct V_84 * V_85 , int type ,
struct V_5 * V_6 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_35 ( V_10 , V_41 , V_85 , type , V_6 ) ;
}
static int F_36 ( struct V_1 * V_1 , struct V_5 * V_6 , T_1 V_27 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_37 ( V_10 , V_6 , V_27 ) ;
}
static T_2 int F_38 ( struct V_1 * V_1 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
return F_39 ( V_10 , & V_86 , V_87 ) ;
}
static void T_3 F_40 ( struct V_1 * V_1 )
{
struct V_9 * V_10 = F_2 ( V_1 , V_11 ) ;
F_41 ( V_10 ) ;
}
