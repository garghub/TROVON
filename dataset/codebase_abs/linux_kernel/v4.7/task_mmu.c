...
static inline T_9 F_158 ( V_114 V_199 , V_114 V_79 )
{
return ( T_9 ) { . V_200 = ( V_199 & V_201 ) | V_79 } ;
}
static int F_159 ( unsigned long V_119 , T_9 * V_200 ,
struct V_202 * V_203 )
{
V_203 -> V_185 [ V_203 -> V_56 ++ ] = * V_200 ;
...
unsigned long V_206 ;
if ( V_46 )
V_206 = F_161 ( V_84 , V_46 -> V_53 ) ;
else
V_206 = V_84 ;
for (; V_119 < V_206 ; V_119 += V_35 ) {
V_69 = F_159 ( V_119 , & V_200 , V_203 ) ;
if ( V_69 )
goto V_181;
}
if ( ! V_46 )
...
static T_9 F_162 ( struct V_202 * V_203 ,
struct V_45 * V_46 , unsigned long V_119 , V_27 V_123 )
{
V_114 V_199 = 0 , V_79 = 0 ;
struct V_103 * V_103 = NULL ;
if ( F_76 ( V_123 ) ) {
if ( V_203 -> V_208 )
V_199 = F_163 ( V_123 ) ;
...
T_9 V_200 = F_158 ( V_199 , V_79 ) ;
V_69 = F_159 ( V_119 , & V_200 , V_203 ) ;
if ( V_69 )
break;
if ( V_203 -> V_208 && ( V_79 & V_209 ) )
V_199 ++ ;
}
F_100 ( V_133 ) ;
return V_69 ;
...
return 0 ;
#endif
V_215 = V_123 = F_102 ( V_121 -> V_4 , V_177 , V_119 , & V_133 ) ;
for (; V_119 < V_84 ; V_123 ++ , V_119 += V_35 ) {
T_9 V_200 ;
V_200 = F_162 ( V_203 , V_46 , V_119 , * V_123 ) ;
V_69 = F_159 ( V_119 , & V_200 , V_203 ) ;
if ( V_69 )
break;
}
...
static int F_173 ( V_27 * V_217 , unsigned long V_166 ,
unsigned long V_119 , unsigned long V_84 ,
struct V_120 * V_121 )
{
struct V_202 * V_203 = V_121 -> V_52 ;
...
if ( ! V_49 )
goto V_198;
V_203 . V_208 = F_177 ( V_11 , & V_226 , V_227 ) ;
V_203 . V_204 = ( V_228 >> V_24 ) ;
V_203 . V_185 = F_178 ( V_203 . V_204 * V_225 , V_229 ) ;
V_223 = - V_67 ;
if ( ! V_203 . V_185 )
goto V_198;
V_218 . V_170 = F_168 ;
...
unsigned long V_84 ;
V_203 . V_56 = 0 ;
V_84 = ( V_221 + V_228 ) & V_231 ;
if ( V_84 < V_221 || V_84 > V_222 )
V_84 = V_222 ;
F_26 ( & V_4 -> V_44 ) ;
V_223 = F_155 ( V_221 , V_84 , & V_218 ) ;
F_18 ( & V_4 -> V_44 ) ;
V_221 = V_84 ;
V_204 = F_161 ( V_49 , V_225 * V_203 . V_56 ) ;
if ( F_179 ( V_184 , V_203 . V_185 , V_204 ) ) {
V_223 = - V_190 ;
goto V_232;
}
V_224 += V_204 ;
...
static void F_183 ( struct V_103 * V_103 , struct V_233 * V_234 , int F_93 ,
unsigned long V_235 )
{
int V_49 = F_72 ( V_103 ) ;
V_234 -> V_236 += V_235 ;
...
return 0 ;
#endif
V_215 = V_123 = F_102 ( V_121 -> V_4 , V_129 , V_119 , & V_133 ) ;
do {
struct V_103 * V_103 = F_189 ( * V_123 , V_46 , V_119 ) ;
if ( ! V_103 )
continue;
F_183 ( V_103 , V_234 , F_93 ( * V_123 ) , 1 ) ;
...
return 0 ;
V_234 = V_121 -> V_52 ;
F_183 ( V_103 , V_234 , F_93 ( V_245 ) , 1 ) ;
return 0 ;
}
static int F_195 ( V_27 * V_123 , unsigned long V_166 ,
unsigned long V_119 , unsigned long V_84 , struct V_120 * V_121 )
...
V_251 = F_197 ( V_46 , V_46 -> V_53 ) ;
if ( V_251 ) {
F_198 ( V_185 , sizeof( V_185 ) , V_251 ) ;
F_199 ( V_251 ) ;
} else {
F_198 ( V_185 , sizeof( V_185 ) , V_248 -> V_43 ) ;
}
...
goto V_181;
if ( V_234 -> V_10 )
F_6 ( V_2 , L_79 , V_234 -> V_10 ) ;
if ( V_234 -> V_106 )
F_6 ( V_2 , L_80 , V_234 -> V_106 ) ;
if ( V_234 -> V_236 != V_234 -> V_10 && V_234 -> V_236 != V_234 -> V_106 )
F_6 ( V_2 , L_81 , V_234 -> V_236 ) ;
if ( V_234 -> V_240 > 1 )
F_6 ( V_2 , L_82 , V_234 -> V_240 ) ;
if ( V_234 -> V_237 )
F_6 ( V_2 , L_83 , V_234 -> V_237 ) ;
if ( V_234 -> V_238 < V_234 -> V_236 && ! F_200 ( V_46 ) )
F_6 ( V_2 , L_84 , V_234 -> V_238 ) ;
if ( V_234 -> V_239 )
F_6 ( V_2 , L_85 , V_234 -> V_239 ) ;
F_201 (nid, N_MEMORY)
if ( V_234 -> V_241 [ V_242 ] )
F_6 ( V_2 , L_86 , V_242 , V_234 -> V_241 [ V_242 ] ) ;
