...
static struct V_1 * F_70 ( unsigned int V_145 )
{
struct V_1 * V_2 ;
if ( V_145 >= V_146 )
return NULL ;
...
static unsigned int F_86 ( struct V_1 * V_2 , struct V_55 * V_56 )
{
...
static int F_129 ( struct V_55 * V_56 , unsigned int V_207 ,
unsigned long V_208 )
{
struct V_1 * V_2 = V_56 -> V_186 ;
int V_84 ;
...
static int F_132 ( struct V_55 * V_56 , int V_218 )
{
struct V_1 * V_2 = V_56 -> V_186 ;
long V_219 ;
F_5 ( V_2 , L_20 , V_218 ) ;
...
V_219 = F_133 ( V_2 -> V_142 ,
! F_64 ( V_129 , & V_2 -> V_130 ) ,
10 ) ;
if ( V_219 == 0 || V_219 == - V_220 ) {
...
static int F_135 ( struct V_55 * V_56 )
{
struct V_1 * V_2 = V_56 -> V_186 ;
unsigned int V_222 ;
F_2 ( & V_2 -> V_6 ) ;
V_222 = ( V_2 -> V_79 & V_57 ) | ( V_2 -> V_58 & ~ V_57 ) ;
F_4 ( & V_2 -> V_6 ) ;
F_5 ( V_2 , L_30 , V_222 ) ;
return V_222 ;
}
...
{
struct V_1 * V_2 = V_56 -> V_186 ;
F_5 ( V_2 , L_31 , V_223 , V_224 ) ;
F_2 ( & V_2 -> V_6 ) ;
V_2 -> V_79 &= ~ ( V_224 & V_57 & 0xffff ) ;
V_2 -> V_79 |= V_223 & V_57 & 0xffff ;
F_36 ( V_2 ) ;
F_4 ( & V_2 -> V_6 ) ;
return 0 ;
}
static int F_137 ( struct V_55 * V_56 ,
struct V_225 * V_60 )
{
struct V_1 * V_2 = V_56 -> V_186 ;
struct V_11 V_11 ;
...
V_60 -> V_228 = V_2 -> V_60 . V_228 ;
V_60 -> V_94 = V_2 -> V_60 . V_94 ;
V_60 -> V_229 = V_2 -> V_60 . V_103 ;
return 0 ;
}
...
V_2 -> V_60 . V_103 , V_2 -> V_60 . V_228 , V_2 -> V_60 . V_94 ) ;
}
static void F_139 ( struct V_9 * V_10 , struct V_1 * V_2 )
{
struct V_11 V_11 ;
memcpy ( & V_11 , & V_2 -> V_11 , sizeof( V_11 ) ) ;
if ( V_2 -> V_2 . V_158 )
...
if ( V_2 -> V_2 . V_158 ) {
F_140 ( V_10 , L_37 ) ;
(* V_2 -> V_226 -> V_230 )( V_10 , V_2 -> V_227 ) ;
}
F_8 ( V_10 , & V_2 -> V_11 ) ;
}
static void F_141 ( struct V_9 * V_10 , struct V_42 * V_43 )
{
int V_46 = V_43 -> V_46 ;
F_20 () ;
F_9 ( V_10 , L_38 , F_142 ( & V_43 -> V_231 -> V_232 ) ) ;
F_9 ( V_10 , L_39 , V_43 -> V_50 , V_46 ) ;
F_9 ( V_10 , L_40 , V_43 -> V_51 ,
V_43 -> V_181 , ( unsigned long long ) V_43 -> V_233 ) ;
F_9 ( V_10 , L_41 , ( unsigned long long ) V_43 -> V_234 ) ;
F_9 ( V_10 , L_42 , ( unsigned long long ) V_43 -> V_87 ) ;
F_143 ( V_10 , '\n' ) ;
}
static int F_144 ( struct V_9 * V_10 , void * V_235 )
{
struct V_1 * V_2 ;
int V_152 ;
F_140 ( V_10 , L_43 ) ;
...
static int F_145 ( struct V_9 * V_10 , void * V_235 )
{
struct V_150 * V_49 = V_10 -> V_236 ;
struct V_1 * V_2 ;
int V_152 ;
...
static int F_146 ( struct V_9 * V_10 , void * V_235 )
{
struct V_150 * V_49 = V_10 -> V_236 ;
struct V_42 * V_43 ;
F_37 () ;
F_9 ( V_10 , L_46 ,
F_142 ( V_49 -> V_35 -> V_232 ) ,
( unsigned long long ) V_49 -> V_35 -> V_233 ) ;
F_147 (peer, &serial->peer_list, list)
F_141 ( V_10 , V_43 ) ;
F_39 () ;
return 0 ;
}
static int F_148 ( struct V_237 * V_237 , struct V_184 * V_185 )
{
return F_149 ( V_185 , F_144 , NULL ) ;
}
static int F_150 ( struct V_237 * V_237 , struct V_184 * V_185 )
{
return F_149 ( V_185 , F_145 , V_237 -> V_238 ) ;
}
static int F_151 ( struct V_237 * V_237 , struct V_184 * V_185 )
{
return F_149 ( V_185 , F_146 , V_237 -> V_238 ) ;
}
static inline int F_152 ( T_4 V_239 )
{
static const struct V_240 V_241 ;
switch ( F_153 ( V_239 ) ) {
case V_242 :
return sizeof( V_241 . V_243 ) + sizeof( V_241 . V_244 ) ;
case V_245 :
return sizeof( V_241 . V_243 ) + sizeof( V_241 . V_246 ) ;
case V_247 :
case V_248 :
case V_245 | V_249 :
case V_248 | V_249 :
return sizeof( V_241 . V_243 ) ;
default:
return - 1 ;
}
}
static inline void F_154 ( struct V_250 * V_251 ,
struct V_1 * V_2 )
{
T_5 V_87 = V_2 -> V_119 . V_120 ;
T_5 V_138 = V_2 -> V_119 . V_120 + 4 ;
T_1 V_252 = V_2 -> V_119 . V_122 - 4 ;
V_251 -> V_253 = F_155 ( V_87 >> 32 ) ;
V_251 -> V_254 = F_155 ( V_87 ) ;
V_251 -> V_255 = F_155 ( V_138 >> 32 ) ;
V_251 -> V_256 = F_155 ( V_138 ) ;
V_251 -> V_252 = F_155 ( V_252 ) ;
}
static inline void F_156 ( struct V_240 * V_241 ,
struct V_1 * V_2 )
{
V_241 -> V_243 . V_239 = F_157 ( V_242 ) ;
V_241 -> V_243 . V_37 = F_157 ( F_152 ( V_241 -> V_243 . V_239 ) ) ;
F_154 ( & V_241 -> V_244 , V_2 ) ;
}
static inline void F_158 ( struct V_240 * V_241 ,
struct V_1 * V_2 )
{
V_241 -> V_243 . V_239 = F_157 ( V_245 ) ;
V_241 -> V_243 . V_37 = F_157 ( F_152 ( V_241 -> V_243 . V_239 ) ) ;
F_154 ( & V_241 -> V_246 , V_2 ) ;
}
static inline void F_159 ( struct V_240 * V_241 )
{
V_241 -> V_243 . V_239 = F_157 ( V_245 | V_249 ) ;
V_241 -> V_243 . V_37 = F_157 ( F_152 ( V_241 -> V_243 . V_239 ) ) ;
}
static inline void F_160 ( struct V_240 * V_241 )
{
V_241 -> V_243 . V_239 = F_157 ( V_247 ) ;
V_241 -> V_243 . V_37 = F_157 ( F_152 ( V_241 -> V_243 . V_239 ) ) ;
}
static inline void F_161 ( struct V_240 * V_241 )
{
V_241 -> V_243 . V_239 = F_157 ( V_248 | V_249 ) ;
V_241 -> V_243 . V_37 = F_157 ( F_152 ( V_241 -> V_243 . V_239 ) ) ;
}
static inline void F_162 ( struct V_240 * V_241 )
{
V_241 -> V_243 . V_239 = F_157 ( V_248 ) ;
V_241 -> V_243 . V_37 = F_157 ( F_152 ( V_241 -> V_243 . V_239 ) ) ;
}
...
V_43 -> V_87 = F_164 ( V_251 -> V_253 , V_251 -> V_254 ) ;
V_43 -> V_138 = F_164 ( V_251 -> V_255 , V_251 -> V_256 ) ;
V_43 -> V_252 = F_165 ( V_251 -> V_252 ) ;
F_166 ( V_43 , V_257 ) ;
F_2 ( & V_2 -> V_6 ) ;
V_2 -> V_181 = F_11 ( V_43 -> V_181 , V_43 -> V_252 ) ;
F_167 ( & V_2 -> V_7 , V_2 -> V_181 ) ;
F_4 ( & V_43 -> V_2 -> V_6 ) ;
if ( V_2 -> V_2 . V_158 && V_2 -> V_226 -> V_258 )
(* V_2 -> V_226 -> V_258 )( V_259 , V_2 -> V_227 ) ;
F_168 ( & V_43 -> V_231 , L_47 ,
( unsigned long long ) V_43 -> V_233 , F_142 ( V_2 -> V_232 ) ) ;
}
static inline int F_169 ( struct V_42 * V_43 ,
struct V_240 * V_241 )
{
int V_46 ;
int V_23 , V_260 = 5 ;
...
V_46 = V_43 -> V_46 ;
F_20 () ;
V_23 = F_170 ( V_43 -> V_49 -> V_35 ,
V_121 ,
V_43 -> V_50 ,
V_46 , V_43 -> V_51 ,
V_43 -> V_234 ,
V_241 , F_153 ( V_241 -> V_243 . V_37 ) ) ;
if ( V_23 == V_28 || V_23 == V_24 ||
V_23 == V_261 ) {
F_5 ( & V_43 -> V_231 , L_48 , V_23 ) ;
continue;
} else {
break;
}
...
static struct V_1 * F_171 ( struct V_42 * V_43 ,
int V_145 )
{
struct V_1 * V_2 ;
...
static struct V_1 * F_174 ( struct V_42 * V_43 )
{
struct V_1 * * V_155 = V_43 -> V_49 -> V_155 ;
int V_152 ;
F_77 () ;
for ( V_152 = 0 ; V_152 < V_263 ; ++ V_152 ) {
F_2 ( & V_155 [ V_152 ] -> V_6 ) ;
if ( ! V_155 [ V_152 ] -> V_43 ) {
F_173 ( V_155 [ V_152 ] -> V_43 , V_43 ) ;
F_4 ( & V_155 [ V_152 ] -> V_6 ) ;
return V_155 [ V_152 ] ;
}
F_4 ( & V_155 [ V_152 ] -> V_6 ) ;
...
static void F_175 ( struct V_1 * V_2 , bool V_264 )
{
if ( V_264 )
F_27 ( V_2 , 0 ) ;
F_2 ( & V_2 -> V_6 ) ;
V_2 -> V_181 = F_176 ( V_265 ) ;
F_167 ( & V_2 -> V_7 , V_2 -> V_181 ) ;
F_177 ( V_2 -> V_43 , NULL ) ;
F_4 ( & V_2 -> V_6 ) ;
if ( V_2 -> V_2 . V_158 && V_2 -> V_226 -> V_258 )
(* V_2 -> V_226 -> V_258 )( V_266 , V_2 -> V_227 ) ;
}
static void F_178 ( unsigned long V_99 )
{
...
struct V_240 * V_241 ;
int V_84 , V_23 ;
V_241 = F_181 ( sizeof( * V_241 ) , V_183 ) ;
if ( ! V_241 )
return - V_48 ;
V_2 = F_174 ( V_43 ) ;
if ( ! V_2 ) {
F_182 ( & V_43 -> V_231 , L_49 ) ;
V_84 = - V_151 ;
goto V_268;
}
F_2 ( & V_43 -> V_6 ) ;
...
V_43 -> V_2 = V_2 ;
F_166 ( V_43 , V_267 ) ;
F_156 ( V_241 , V_43 -> V_2 ) ;
F_183 ( & V_43 -> V_271 , F_178 , ( unsigned long ) V_43 ) ;
F_184 ( & V_43 -> V_271 , V_75 + V_272 ) ;
F_4 ( & V_43 -> V_6 ) ;
V_23 = F_169 ( V_43 , V_241 ) ;
F_2 ( & V_43 -> V_6 ) ;
if ( V_43 -> V_218 == V_267 && V_23 != V_39 ) {
if ( V_23 == V_123 )
V_84 = - V_132 ;
else
V_84 = - V_108 ;
...
static void F_186 ( struct V_187 * V_188 ,
struct V_1 * V_2 )
{
struct V_55 * V_56 ;
F_71 ( & V_2 -> V_2 . V_210 ) ;
...
F_73 ( & V_2 -> V_2 . V_210 ) ;
if ( V_188 == V_274 )
F_187 ( V_188 , F_188 ( V_2 ) ) ;
else
F_187 ( V_188 , V_2 -> V_145 ) ;
}
static struct V_150 * F_189 ( struct V_34 * V_35 )
{
struct V_150 * V_49 ;
F_190 (serial, &fwserial_list, list) {
if ( V_35 == V_49 -> V_35 )
return V_49 ;
}
return NULL ;
}
static struct V_150 * F_191 ( struct V_34 * V_35 )
{
struct V_150 * V_49 ;
F_147 (serial, &fwserial_list, list) {
if ( V_35 == V_49 -> V_35 )
return V_49 ;
}
return NULL ;
...
if ( ! V_49 ) {
F_182 ( V_35 , L_50 ,
( unsigned long long ) V_35 -> V_233 ) ;
return NULL ;
}
F_147 (peer, &serial->peer_list, list) {
int V_276 = V_43 -> V_46 ;
F_20 () ;
if ( V_46 == V_276 && V_275 == V_43 -> V_50 )
return V_43 ;
}
return NULL ;
}
...
F_20 () ;
F_5 ( V_35 , L_51 ,
V_276 , V_43 -> V_50 , ( unsigned long long ) V_43 -> V_233 ) ;
}
}
static void F_193 ( struct V_89 * V_90 )
{
struct V_42 * V_43 = F_194 ( F_48 ( V_90 ) , V_277 ) ;
int V_84 ;
V_84 = F_180 ( V_43 ) ;
if ( V_84 == - V_132 && ++ V_43 -> V_278 < V_279 )
F_25 ( & V_43 -> V_277 , V_280 ) ;
}
static void F_195 ( struct V_89 * V_90 )
{
struct V_42 * V_43 = F_194 ( V_90 , V_90 ) ;
V_43 -> V_281 ( V_90 ) ;
}
static int F_196 ( struct V_150 * V_49 , struct V_282 * V_231 )
{
struct V_232 * V_283 = & V_231 -> V_232 ;
struct V_21 * V_284 = F_197 ( V_231 ) ;
struct V_42 * V_43 ;
struct V_285 V_286 ;
int V_287 , V_288 ;
int V_46 ;
V_43 = F_198 ( sizeof( * V_43 ) , V_183 ) ;
if ( ! V_43 )
return - V_48 ;
F_166 ( V_43 , V_269 ) ;
F_199 ( V_283 , V_43 ) ;
V_43 -> V_231 = V_231 ;
V_43 -> V_233 = ( T_5 ) V_284 -> V_289 [ 3 ] << 32 | V_284 -> V_289 [ 4 ] ;
V_43 -> V_51 = V_284 -> V_290 ;
V_43 -> V_181 = F_11 ( F_10 ( V_284 ) ,
F_176 ( V_43 -> V_51 ) ) ;
V_46 = V_284 -> V_46 ;
F_20 () ;
V_43 -> V_50 = V_284 -> V_50 ;
F_200 () ;
V_43 -> V_46 = V_46 ;
F_201 ( & V_286 , V_231 -> V_291 ) ;
while ( F_202 ( & V_286 , & V_287 , & V_288 ) ) {
if ( V_287 == ( V_292 | V_293 ) ) {
V_43 -> V_234 = V_294 + 4 * V_288 ;
break;
}
}
if ( V_43 -> V_234 == 0ULL ) {
...
V_43 -> V_2 = NULL ;
F_15 ( & V_43 -> V_271 ) ;
F_204 ( & V_43 -> V_90 , F_195 ) ;
F_205 ( & V_43 -> V_277 , F_193 ) ;
V_43 -> V_49 = V_49 ;
F_206 ( & V_43 -> V_296 , & V_49 -> V_297 ) ;
F_168 ( & V_43 -> V_231 , L_52 ,
( unsigned long long ) V_43 -> V_233 ) ;
if ( V_284 -> V_298 ) {
V_49 -> V_299 = V_43 ;
if ( V_300 ) {
struct V_1 * V_2 ;
V_2 = F_171 ( V_43 , V_263 ) ;
if ( ! F_207 ( V_2 ) ) {
struct V_250 V_251 ;
F_2 ( & V_43 -> V_6 ) ;
V_43 -> V_2 = V_2 ;
...
static void F_208 ( struct V_42 * V_43 )
{
struct V_1 * V_2 ;
F_2 ( & V_43 -> V_6 ) ;
F_166 ( V_43 , V_302 ) ;
...
F_209 ( & V_43 -> V_90 ) ;
F_2 ( & V_43 -> V_6 ) ;
if ( V_43 == V_43 -> V_49 -> V_299 )
V_43 -> V_49 -> V_299 = NULL ;
F_185 ( & V_43 -> V_271 ) ;
V_2 = V_43 -> V_2 ;
V_43 -> V_2 = NULL ;
F_210 ( & V_43 -> V_296 ) ;
F_168 ( & V_43 -> V_231 , L_53 ,
( unsigned long long ) V_43 -> V_233 ) ;
F_4 ( & V_43 -> V_6 ) ;
if ( V_2 )
F_175 ( V_2 , true ) ;
...
static int F_211 ( struct V_282 * V_231 )
{
struct V_21 * V_284 = F_197 ( V_231 ) ;
struct V_34 * V_35 = V_284 -> V_35 ;
struct V_150 * V_49 ;
struct V_1 * V_2 ;
struct V_232 * V_303 ;
int V_152 , V_14 ;
int V_84 ;
V_49 = F_198 ( sizeof( * V_49 ) , V_183 ) ;
if ( ! V_49 )
return - V_48 ;
F_212 ( & V_49 -> V_149 ) ;
V_49 -> V_35 = V_35 ;
...
V_2 -> V_119 . V_122 = V_308 + 4 ;
V_2 -> V_119 . V_309 = F_54 ;
V_2 -> V_119 . V_117 = V_2 ;
V_84 = F_218 ( & V_2 -> V_119 ,
& V_310 ) ;
if ( V_84 ) {
F_81 ( V_2 ) ;
goto V_304;
...
for ( V_14 = 0 ; V_14 < V_263 ; ++ V_14 ) {
V_303 = F_219 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_311 ,
...
V_49 -> V_155 [ V_14 ] -> V_232 = V_303 ;
}
if ( V_300 ) {
struct V_232 * V_313 ;
V_313 = F_219 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_274 ,
F_188 ( V_49 -> V_155 [ V_14 ] ) ,
V_35 -> V_232 ) ;
if ( F_207 ( V_313 ) ) {
V_84 = F_220 ( V_313 ) ;
F_182 ( & V_231 , L_56 ,
...
V_49 -> V_155 [ V_14 ] -> V_232 = V_313 ;
V_49 -> V_155 [ V_14 ] -> V_71 = true ;
}
if ( ! F_221 ( V_314 ) ) {
V_49 -> V_315 = F_222 ( F_142 ( & V_231 -> V_232 ) ,
V_314 ) ;
if ( ! F_221 ( V_49 -> V_315 ) ) {
F_223 ( L_57 , 0444 , V_49 -> V_315 ,
V_49 , & V_316 ) ;
F_223 ( L_58 , 0444 , V_49 -> V_315 ,
V_49 , & V_317 ) ;
}
}
F_206 ( & V_49 -> V_296 , & V_318 ) ;
F_224 ( & V_231 , L_59 ,
F_142 ( V_35 -> V_232 ) , ( unsigned long long ) V_35 -> V_233 ) ;
V_84 = F_196 ( V_49 , V_231 ) ;
if ( ! V_84 )
return 0 ;
F_182 ( & V_231 , L_60 , V_84 ) ;
F_225 ( V_49 -> V_315 ) ;
F_210 ( & V_49 -> V_296 ) ;
if ( V_300 )
F_187 ( V_274 ,
...
F_187 ( V_311 , V_49 -> V_155 [ V_14 ] -> V_145 ) ;
...
static int F_226 ( struct V_282 * V_231 ,
const struct V_319 * V_275 )
{
struct V_150 * V_49 ;
int V_84 ;
F_71 ( & V_320 ) ;
V_49 = F_189 ( F_197 ( V_231 ) -> V_35 ) ;
if ( ! V_49 )
V_84 = F_211 ( V_231 ) ;
else
V_84 = F_196 ( V_49 , V_231 ) ;
...
static void F_227 ( struct V_282 * V_231 )
{
struct V_42 * V_43 = F_228 ( & V_231 -> V_232 ) ;
...
F_225 ( V_49 -> V_315 ) ;
for ( V_152 = 0 ; V_152 < V_263 ; ++ V_152 )
F_186 ( V_311 , V_49 -> V_155 [ V_152 ] ) ;
if ( V_300 )
F_186 ( V_274 , V_49 -> V_155 [ V_152 ] ) ;
F_83 ( & V_49 -> V_149 , F_75 ) ;
}
F_73 ( & V_320 ) ;
}
static void F_230 ( struct V_282 * V_231 )
{
struct V_21 * V_284 = F_197 ( V_231 ) ;
struct V_42 * V_43 = F_228 ( & V_231 -> V_232 ) ;
int V_46 ;
...
{
struct V_42 * V_43 = F_194 ( V_90 , V_90 ) ;
struct V_250 * V_244 = & V_43 -> V_321 . V_244 ;
struct V_1 * V_2 ;
struct V_240 * V_241 ;
int V_23 ;
V_241 = F_181 ( sizeof( * V_241 ) , V_183 ) ;
...
case V_269 :
if ( ! V_2 ) {
F_182 ( & V_43 -> V_231 , L_61 ) ;
F_159 ( V_241 ) ;
} else {
V_43 -> V_2 = V_2 ;
F_158 ( V_241 , V_43 -> V_2 ) ;
F_166 ( V_43 , V_322 ) ;
V_2 = NULL ;
}
break;
case V_267 :
if ( V_43 -> V_49 -> V_35 -> V_233 > V_43 -> V_233 )
goto V_323;
F_185 ( & V_43 -> V_271 ) ;
F_158 ( V_241 , V_43 -> V_2 ) ;
F_166 ( V_43 , V_322 ) ;
...
bool V_264 = false ;
int V_23 ;
if ( V_45 != V_326 . V_120 || V_37 < sizeof( V_241 -> V_243 ) )
return V_25 ;
if ( V_37 != F_153 ( V_241 -> V_243 . V_37 ) ||
V_37 != F_152 ( V_241 -> V_243 . V_239 ) )
return V_26 ;
F_2 ( & V_43 -> V_6 ) ;
if ( V_43 -> V_218 == V_302 ) {
F_182 ( & V_43 -> V_231 , L_64 ) ;
F_4 ( & V_43 -> V_6 ) ;
return V_25 ;
}
V_23 = V_39 ;
F_5 ( & V_43 -> V_231 , L_65 , V_241 -> V_243 . V_239 ) ;
switch ( F_153 ( V_241 -> V_243 . V_239 ) & V_327 ) {
case V_242 :
if ( F_234 ( & V_43 -> V_90 ) ) {
F_182 ( & V_43 -> V_231 , L_66 ) ;
V_23 = V_123 ;
} else {
V_43 -> V_321 . V_244 = V_241 -> V_244 ;
V_43 -> V_281 = F_231 ;
F_235 ( V_328 , & V_43 -> V_90 ) ;
}
break;
case V_245 :
if ( V_43 -> V_218 != V_267 ) {
V_23 = V_123 ;
} else if ( F_153 ( V_241 -> V_243 . V_239 ) & V_249 ) {
F_224 ( & V_43 -> V_231 , L_67 ) ;
V_2 = F_179 ( V_43 ) ;
} else {
struct V_1 * V_196 = V_43 -> V_2 ;
F_163 ( V_43 , & V_241 -> V_246 ) ;
F_4 ( & V_43 -> V_6 ) ;
F_40 ( V_196 ) ;
F_2 ( & V_43 -> V_6 ) ;
}
...
if ( F_153 ( V_241 -> V_243 . V_239 ) & V_249 )
F_224 ( & V_43 -> V_231 , L_69 ) ;
V_2 = F_179 ( V_43 ) ;
V_264 = true ;
}
break;
default:
F_182 ( & V_43 -> V_231 , L_70 ,
F_153 ( V_241 -> V_243 . V_239 ) ) ;
V_23 = V_26 ;
}
F_4 ( & V_43 -> V_6 ) ;
if ( V_2 )
...
switch ( V_44 ) {
case V_121 :
V_23 = F_233 ( V_43 , V_241 , V_45 , V_37 ) ;
break;
default:
V_23 = V_124 ;
}
...
{
int V_84 , V_329 = ! ! ( V_300 ) ;
V_314 = F_222 ( V_330 , NULL ) ;
if ( V_263 + V_329 > V_331 )
V_263 = V_331 - V_329 ;
V_154 = V_263 + V_329 ;
V_311 = F_238 ( V_146 , V_332
| V_333 ) ;
if ( F_207 ( V_311 ) ) {
V_84 = F_220 ( V_311 ) ;
goto V_334;
...
V_326 . V_122 = sizeof( struct V_240 ) ;
V_326 . V_309 = F_236 ;
V_84 = F_218 ( & V_326 ,
& V_353 ) ;
if ( V_84 ) {
