...
F_7 ( & V_8 -> V_35 , V_29 ) ;
for ( V_18 = 0 ; V_18 < V_6 -> V_36 ; V_18 += 4 )
F_8 ( * ( V_6 -> V_37 + V_18 / 4 ) , V_8 -> V_38 + V_39 + V_18 ) ;
if ( V_2 -> V_30 ) {
for ( V_18 = 0 ; V_18 < 4 && V_18 < V_9 / 4 ; V_18 ++ ) {
V_17 = * ( T_1 * ) ( V_2 -> V_30 + V_18 * 4 ) ;
F_8 ( V_17 , V_8 -> V_38 + V_40 + V_18 * 4 ) ;
}
}
...
if ( V_2 -> V_30 ) {
for ( V_18 = 0 ; V_18 < 4 && V_18 < V_9 / 4 ; V_18 ++ ) {
V_17 = F_14 ( V_8 -> V_38 + V_40 + V_18 * 4 ) ;
* ( T_1 * ) ( V_2 -> V_30 + V_18 * 4 ) = V_17 ;
}
}
V_46:
F_18 ( & V_25 ) ;
