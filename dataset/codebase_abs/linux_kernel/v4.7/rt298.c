...
static int F_32 ( struct V_83 * V_88 ,
struct V_89 * V_90 , int V_91 )
{
struct V_53 * V_54 = F_24 ( V_88 -> V_64 ) ;
switch ( V_91 ) {
...
int V_86 , unsigned int V_122 , int V_123 )
{
struct V_53 * V_54 = V_109 -> V_54 ;
struct V_55 * V_56 = F_7 ( V_54 ) ;
F_38 ( V_54 -> V_2 , L_10 , V_124 , V_122 ) ;
if ( V_87 == V_86 ) {
F_28 ( V_54 ,
V_125 , 0x0100 , 0x0 ) ;
F_28 ( V_54 ,
...
static int F_41 ( struct V_108 * V_109 , unsigned int V_128 )
{
struct V_53 * V_54 = V_109 -> V_54 ;
F_38 ( V_54 -> V_2 , L_13 , V_124 , V_128 ) ;
if ( 50 == V_128 )
F_28 ( V_54 ,
V_112 , 0x1000 , 0x1000 ) ;
else
...
static T_1 F_44 ( int V_135 , void * V_136 )
{
struct V_55 * V_56 = V_136 ;
bool V_61 = false ;
bool V_62 = false ;
int V_137 , V_78 = 0 ;
V_137 = F_9 ( V_56 , & V_61 , & V_62 ) ;
F_12 ( V_56 -> V_70 , V_138 , 0x1 , 0x1 ) ;
if ( V_137 == 0 ) {
if ( V_61 == true )
V_78 |= V_79 ;
if ( V_62 == true )
...
static int F_57 ( struct V_141 * V_139 ,
const struct V_142 * V_143 )
{
struct V_144 * V_68 = F_58 ( & V_139 -> V_2 ) ;
struct V_55 * V_56 ;
struct V_1 * V_2 = & V_139 -> V_2 ;
const struct V_145 * V_146 ;
int V_57 , V_137 ;
V_56 = F_59 ( & V_139 -> V_2 , sizeof( * V_56 ) ,
V_147 ) ;
if ( NULL == V_56 )
return - V_148 ;
V_56 -> V_70 = F_60 ( & V_139 -> V_2 , NULL , V_139 , & V_149 ) ;
if ( F_61 ( V_56 -> V_70 ) ) {
V_137 = F_62 ( V_56 -> V_70 ) ;
F_35 ( & V_139 -> V_2 , L_14 ,
V_137 ) ;
return V_137 ;
}
...
V_56 -> V_59 = F_63 ( & V_139 -> V_2 , V_152 ,
sizeof( V_152 ) , V_147 ) ;
if ( ! V_56 -> V_59 )
return - V_148 ;
V_56 -> V_153 = V_58 ;
...
V_56 -> V_59 [ V_57 ] . V_60 ) ;
for ( V_57 = 0 ; V_57 < F_65 ( V_154 ) ; V_57 ++ )
F_15 ( V_56 -> V_70 , V_154 [ V_57 ] . V_3 ,
V_154 [ V_57 ] . V_60 ) ;
if ( V_68 )
V_56 -> V_68 = * V_68 ;
V_146 = F_66 ( V_2 -> V_155 -> V_156 , V_2 ) ;
if ( V_146 && V_146 -> V_157 ) {
V_56 -> V_68 = * (struct V_144 * )
V_146 -> V_157 ;
}
if ( F_67 ( V_158 ) ) {
V_56 -> V_68 . V_69 = true ;
V_56 -> V_68 . V_159 = false ;
}
F_12 ( V_56 -> V_70 , 0x04 , 0x80 , 0x80 ) ;
F_12 ( V_56 -> V_70 , 0x1b , 0x860 , 0x860 ) ;
F_12 ( V_56 -> V_70 , 0x08 , 0x20 , 0x20 ) ;
F_15 ( V_56 -> V_70 , V_13 , V_134 ) ;
for ( V_57 = 0 ; V_57 < V_160 ; V_57 ++ )
F_15 ( V_56 -> V_70 ,
F_5 ( V_161 [ V_57 ] ) ,
V_162 ) ;
if ( ! V_56 -> V_68 . V_69 ) {
F_15 ( V_56 -> V_70 , V_74 , 0x0000 ) ;
F_15 ( V_56 -> V_70 , V_163 , 0x0816 ) ;
F_12 ( V_56 -> V_70 ,
V_73 , 0xf000 , 0xb000 ) ;
} else {
F_12 ( V_56 -> V_70 ,
...
F_31 ( 10 ) ;
F_15 ( V_56 -> V_70 , V_164 , 0x0000 ) ;
F_12 ( V_56 -> V_70 ,
V_165 , 0x0082 , 0x0082 ) ;
F_15 ( V_56 -> V_70 , V_166 , 0x81 ) ;
F_15 ( V_56 -> V_70 , V_167 , 0x82 ) ;
F_15 ( V_56 -> V_70 , V_168 , 0x84 ) ;
F_12 ( V_56 -> V_70 , V_169 , 0x2 , 0x2 ) ;
V_56 -> V_71 = - 1 ;
if ( V_56 -> V_139 -> V_135 ) {
V_137 = F_68 ( V_56 -> V_139 -> V_135 , NULL , F_44 ,
V_170 | V_171 , L_16 , V_56 ) ;
if ( V_137 != 0 ) {
F_35 ( & V_139 -> V_2 ,
L_17 , V_137 ) ;
return V_137 ;
...
V_137 = F_69 ( & V_139 -> V_2 , & V_172 ,
V_173 , F_65 ( V_173 ) ) ;
return V_137 ;
}
static int F_70 ( struct V_141 * V_139 )
{
struct V_55 * V_56 = F_71 ( V_139 ) ;
if ( V_139 -> V_135 )
F_72 ( V_139 -> V_135 , V_56 ) ;
F_73 ( & V_139 -> V_2 ) ;
return 0 ;
}
