...
{
struct V_18 * V_19 = F_23 ( V_84 ) ;
unsigned long V_75 ;
F_17 ( & V_19 -> V_55 , V_75 ) ;
F_4 ( V_19 , V_19 -> V_86 [ V_85 ] ,
V_21 ? V_66 : V_68 ) ;
F_18 ( & V_19 -> V_55 , V_75 ) ;
if ( V_19 -> V_26 )
F_19 ( & V_19 -> V_48 ) ;
...
static int F_25 ( struct V_49 * V_37 ,
struct V_18 * V_19 ,
struct V_87 * V_88 )
{
int V_74 ;
int V_63 = 0 ;
int V_89 = 0 ;
for ( V_63 = 0 ; V_63 < V_90 ; V_63 ++ )
if ( V_88 -> V_91 . V_91 [ V_63 ] . V_92 && V_88 -> V_91 . V_91 [ V_63 ] . V_75 ) {
V_19 -> V_93 [ V_89 ] = V_88 -> V_91 . V_91 [ V_63 ] . V_92 ;
V_19 -> V_86 [ V_89 ] = V_63 ;
V_89 ++ ;
}
if ( ! V_89 )
return 0 ;
V_19 -> V_94 . V_95 = L_3 ;
V_19 -> V_94 . V_96 = V_19 -> V_93 ;
V_19 -> V_94 . V_97 = V_89 ;
V_19 -> V_94 . V_98 = V_88 -> V_99 ;
V_19 -> V_94 . V_100 = V_101 ;
V_19 -> V_94 . V_102 = F_24 ;
V_19 -> V_94 . V_51 = F_22 ;
V_19 -> V_94 . V_103 = & V_37 -> V_38 ;
#ifdef F_26
V_19 -> V_94 . V_104 = F_27 ( V_37 -> V_38 . V_104 ) ;
#endif
V_74 = F_28 ( & V_19 -> V_94 , V_19 ) ;
if ( V_74 ) {
V_19 -> V_94 . V_97 = 0 ;
return V_74 ;
}
if ( V_88 -> V_105 )
V_88 -> V_105 ( V_19 -> V_94 . V_98 , V_19 -> V_94 . V_97 ) ;
return 0 ;
}
...
static struct V_87 *
F_31 ( struct V_49 * V_37 )
{
struct V_106 * V_107 = V_37 -> V_38 . V_104 , * V_108 ;
struct V_87 * V_88 ;
struct V_109 * V_110 ;
int V_111 ;
V_111 = F_32 ( V_107 ) ;
if ( ! V_111 || V_111 > V_90 )
return F_33 ( - V_112 ) ;
V_110 = F_34 ( & V_37 -> V_38 ,
sizeof( struct V_109 ) * V_90 , V_113 ) ;
if ( ! V_110 )
return F_33 ( - V_114 ) ;
F_35 (np, child) {
struct V_109 V_20 ;
...
int V_115 ;
V_20 . V_92 =
F_36 ( V_108 , L_4 , NULL ) ? : V_108 -> V_92 ;
V_20 . V_116 =
F_36 ( V_108 , L_5 , NULL ) ;
V_20 . V_75 = 0 ;
if ( F_37 ( V_108 , L_6 , L_7 ) >= 0 )
V_20 . V_75 |= V_117 ;
V_115 = F_38 ( V_108 , L_8 , & V_27 ) ;
if ( V_115 != 0 || V_27 < 0 || V_27 >= V_90 )
continue;
V_110 [ V_27 ] = V_20 ;
}
V_88 = F_34 ( & V_37 -> V_38 ,
sizeof( struct V_87 ) , V_113 ) ;
if ( ! V_88 )
return F_33 ( - V_114 ) ;
V_88 -> V_91 . V_91 = V_110 ;
V_88 -> V_91 . V_118 = V_90 ;
#ifdef F_39
V_88 -> V_99 = - 1 ;
#endif
return V_88 ;
...
static int F_40 ( struct V_49 * V_37 ,
...
int V_74 ;
int V_63 = 0 ;
V_122 = F_41 ( V_37 -> V_38 . V_103 ) ;
V_88 = F_42 ( & V_37 -> V_38 ) ;
if ( ! F_43 ( V_122 , V_123 ) )
return - V_124 ;
if ( ! V_88 || V_88 -> V_91 . V_118 != V_90 ) {
V_88 = F_31 ( V_37 ) ;
if ( F_44 ( V_88 ) ) {
F_45 ( & V_37 -> V_38 , L_9 ,
V_90 ) ;
...
V_19 = F_34 ( & V_37 -> V_38 , sizeof( * V_19 ) , V_113 ) ;
if ( ! V_19 )
return - V_114 ;
V_19 -> V_37 = V_37 ;
F_47 ( & V_19 -> V_48 , F_9 ) ;
...
F_49 ( V_37 , V_19 ) ;
for ( V_63 = 0 ; V_63 < V_90 ; V_63 ++ ) {
struct V_56 * V_125 = V_19 -> V_91 + V_63 ;
V_125 -> V_57 = V_19 ;
V_125 -> V_65 = V_63 ;
if ( V_88 -> V_91 . V_91 [ V_63 ] . V_92 && ! V_88 -> V_91 . V_91 [ V_63 ] . V_75 ) {
V_125 -> V_62 . V_92 = V_88 -> V_91 . V_91 [ V_63 ] . V_92 ;
V_125 -> V_62 . V_116
= V_88 -> V_91 . V_91 [ V_63 ] . V_116 ;
...
exit:
while ( V_63 -- ) {
if ( V_19 -> V_91 [ V_63 ] . V_62 . V_92 )
F_51 ( & V_19 -> V_91 [ V_63 ] . V_62 ) ;
}
return V_74 ;
}
static int F_52 ( struct V_49 * V_37 )
{
int V_63 ;
struct V_18 * V_19 = F_53 ( V_37 ) ;
struct V_56 * V_110 = V_19 -> V_91 ;
for ( V_63 = 0 ; V_63 < V_90 ; V_63 ++ ) {
if ( V_110 [ V_63 ] . V_62 . V_92 )
F_51 ( & V_110 [ V_63 ] . V_62 ) ;
}
F_29 ( V_19 ) ;
F_54 ( & V_19 -> V_48 ) ;
return 0 ;
