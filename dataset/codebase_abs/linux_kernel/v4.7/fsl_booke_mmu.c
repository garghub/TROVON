...
#ifdef F_21
F_22 () -> V_62 . V_63 = V_58 ;
F_22 () -> V_62 . V_64 = F_17 ( V_54 ) & V_65 ;
F_22 () -> V_62 . V_66 = V_58 ;
#endif
return V_59 ;
}
unsigned long F_23 ( unsigned long V_47 , int V_56 , bool V_57 )
{
unsigned long V_11 = V_67 ;
T_1 V_8 = V_68 ;
return F_18 ( V_8 , V_11 , V_47 , V_56 , V_57 ) ;
}
unsigned long T_2 F_24 ( unsigned long V_69 )
{
...
unsigned long V_47 ;
int V_58 ;
V_47 = F_28 ( ( T_1 ) V_70 , ( T_1 ) V_71 ) ;
V_58 = F_29 () ;
V_70 = F_23 ( V_47 , V_72 , false ) ;
F_30 ( V_58 , 0 , 0 , 1 ) ;
F_31 ( L_1 ) ;
for ( V_58 = 0 ; V_58 < V_7 - 1 ; V_58 ++ )
F_32 ( L_2 , F_1 ( V_58 ) >> 20 ) ;
F_32 ( L_3 , F_1 ( V_7 - 1 ) >> 20 ,
...
{
T_1 V_3 = V_73 + V_74 ;
F_33 ( F_35 ( V_43 , V_3 , 0x04000000 ) ) ;
}
T_3 void T_2 F_36 ( V_43 V_75 , T_1 V_4 )
{
