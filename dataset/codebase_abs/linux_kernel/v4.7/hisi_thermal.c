...
static int F_19 ( struct V_38 * V_32 ,
struct V_4 * V_5 ,
struct V_6 * V_7 ,
int V_39 )
{
...
bool V_46 )
{
struct V_47 * V_31 = V_7 -> V_31 ;
V_31 -> V_48 -> V_49 ( V_31 ,
V_46 ? V_50 : V_51 ) ;
}
static int F_27 ( struct V_38 * V_32 )
{
struct V_4 * V_5 ;
struct V_52 * V_53 ;
int V_27 ;
int V_40 ;
V_5 = F_28 ( & V_32 -> V_33 , sizeof( * V_5 ) , V_54 ) ;
if ( ! V_5 )
return - V_55 ;
F_29 ( & V_5 -> V_9 ) ;
V_5 -> V_32 = V_32 ;
V_53 = F_30 ( V_32 , V_56 , 0 ) ;
V_5 -> V_10 = F_31 ( & V_32 -> V_33 , V_53 ) ;
if ( F_21 ( V_5 -> V_10 ) ) {
F_23 ( & V_32 -> V_33 , L_4 ) ;
...
if ( V_5 -> V_35 < 0 )
return V_5 -> V_35 ;
V_40 = F_33 ( & V_32 -> V_33 , V_5 -> V_35 ,
F_14 ,
F_16 ,
0 , L_5 , V_5 ) ;
if ( V_40 < 0 ) {
F_23 ( & V_32 -> V_33 , L_6 , V_40 ) ;
return V_40 ;
}
F_34 ( V_32 , V_5 ) ;
V_5 -> V_57 = F_35 ( & V_32 -> V_33 , L_7 ) ;
if ( F_21 ( V_5 -> V_57 ) ) {
V_40 = F_22 ( V_5 -> V_57 ) ;
if ( V_40 != - V_58 )
F_23 ( & V_32 -> V_33 ,
...
static int F_41 ( struct V_60 * V_33 )
{
...
static int F_43 ( struct V_60 * V_33 )
{
struct V_4 * V_5 = F_42 ( V_33 ) ;
F_36 ( V_5 -> V_57 ) ;
V_5 -> V_34 = true ;
