...
V_8 -> V_341 = true ;
V_340 -> V_164 = V_5 -> V_115 -> V_343 ;
V_340 -> V_165 = V_5 -> V_115 -> V_344 ;
V_34 = F_41 ( V_5 , V_340 ) ;
F_46 ( V_340 ) ;
memset ( & V_5 -> V_308 , 0 , sizeof( V_5 -> V_308 ) ) ;
if ( V_34 ) {
F_70 ( V_5 -> V_8 -> V_345 , L_54 , V_34 ) ;
return V_34 ;
}
return 0 ;
}
...
V_357 = ( F_28 ( V_347 -> V_299 )
== V_362 ) ;
if ( V_357 )
V_349 = & V_347 -> V_296 . V_363 . V_364 ;
else
V_349 = & V_347 -> V_296 . V_364 ;
if ( V_349 -> V_365 > V_366 ) {
F_19 ( V_8 , ERROR ,
L_58 ,
V_349 -> V_365 ) ;
V_34 = - 1 ;
...
F_27 ( V_5 ) ;
V_212 = F_28 ( V_349 -> V_368 ) ;
F_19 ( V_8 , V_49 ,
L_59 ,
V_212 ) ;
V_352 = F_28 ( V_347 -> V_300 ) ;
F_19 ( V_8 , V_49 ,
L_60 ,
V_349 -> V_365 ) ;
V_311 = V_349 -> V_369 ;
...
& V_354 ) ;
#ifdef F_74
if ( V_5 -> V_80 . V_81 -> V_370 )
V_361 = V_5 -> V_80 . V_81 -> V_370 -> V_361 ;
#endif
if ( V_361 ) {
V_8 -> V_371 =
F_44 ( sizeof( struct V_358 ) +
sizeof( struct V_358 * ) *
V_349 -> V_365 , V_372 ) ;
if ( V_8 -> V_371 )
V_8 -> V_371 -> V_373 = V_349 -> V_365 ;
}
for ( V_304 = 0 ; V_304 < V_349 -> V_365 && V_212 ; V_304 ++ ) {
if ( V_351 )
memcpy ( & V_312 , & V_351 -> V_374 [ V_304 * V_375 ] ,
sizeof( V_312 ) ) ;
if ( V_354 ) {
V_356 = & V_354 -> V_376 [ V_304 ] ;
V_87 = & V_356 -> V_87 ;
} else {
V_87 = NULL ;
}
if ( V_354 && V_8 -> V_371 ) {
V_8 -> V_371 -> V_377 [ V_304 ] =
F_44 ( sizeof( * V_359 ) +
sizeof( T_2 ) , V_372 ) ;
V_359 = V_8 -> V_371 -> V_377 [ V_304 ] ;
if ( V_359 ) {
...
void * V_378 )
{
struct V_379 * V_134 = & V_292 -> V_296 . V_134 ;
struct V_104 * V_293 = V_378 ;
memcpy ( V_134 -> V_298 , V_293 -> V_113 , V_293 -> V_114 ) ;
V_292 -> V_299 = F_21 ( V_135 ) ;
V_292 -> V_300 = F_21 ( ( V_91 ) ( sizeof( V_134 -> V_380 )
+ V_293 -> V_114 + V_301 ) ) ;
return 0 ;
}
...
struct V_381 * V_382 =
& V_292 -> V_296 . V_383 ;
struct V_102 * V_103 = V_378 ;
T_1 * V_111 = V_382 -> V_186 ;
T_1 V_149 ;
...
struct V_121 * V_390 ;
struct V_68 * V_391 ;
V_292 -> V_299 = F_21 ( V_392 ) ;
V_292 -> V_300 = F_21 ( sizeof( * V_382 ) + V_301 ) ;
V_382 -> V_393 = F_21 ( V_103 -> V_393 ) ;
V_382 -> V_394 = V_103 -> V_394 ;
V_382 -> V_395 = V_103 -> V_395 ;
V_382 -> V_396 =
F_77 ( V_103 -> V_396 ) ;
V_382 -> V_397 =
F_77 ( V_103 -> V_397 ) ;
...
F_21 ( V_400 ) ;
V_385 -> V_117 . V_119 =
F_21 ( sizeof( V_385 -> V_399 ) ) ;
V_385 -> V_399 =
F_21 ( V_103 -> V_399 ) ;
V_111 += sizeof( V_385 -> V_117 ) +
F_28 ( V_385 -> V_117 . V_119 ) ;
}
if ( V_103 -> V_401 ) {
V_387 =
(struct V_386 * ) V_111 ;
...
F_21 ( V_402 ) ;
V_387 -> V_117 . V_119 =
F_21 ( sizeof( V_387 -> V_401 ) ) ;
V_387 -> V_401 =
F_21 ( V_103 -> V_401 ) ;
V_111 += sizeof( V_387 -> V_117 ) +
F_28 ( V_387 -> V_117 . V_119 ) ;
}
...
V_390 = (struct V_121 * ) V_111 ;
if ( V_103 -> V_88 [ 0 ] . V_98 ) {
F_78 ( V_5 -> V_8 -> V_345 , L_61 ) ;
V_390 -> V_117 . type = F_21 ( V_129 ) ;
for ( V_77 = 0 ;
V_77 < V_403 &&
V_103 -> V_88 [ V_77 ] . V_98 ;
V_77 ++ ) {
V_391 = V_390 -> V_131 + V_77 ;
F_29 ( & V_390 -> V_117 . V_119 ,
sizeof( V_390 -> V_131 ) ) ;
V_391 -> V_98 =
V_103 -> V_88 [ V_77 ] . V_98 ;
V_391 -> V_87 =
...
V_391 -> V_182 = F_21 ( V_152 ) ;
V_391 -> V_90 = F_21 ( V_152 ) ;
}
} else {
F_78 ( V_5 -> V_8 -> V_345 ,
L_62 ) ;
...
F_21 ( V_405 ) ;
V_389 -> V_117 . V_119 =
F_21 ( sizeof( V_389 -> V_404 ) ) ;
V_389 -> V_404 =
F_21 ( V_103 -> V_404 ) ;
V_111 += sizeof( V_389 -> V_117 ) +
F_28 ( V_389 -> V_117 . V_119 ) ;
}
F_37 ( V_5 , V_406 , & V_111 ) ;
F_29 ( & V_292 -> V_300 , V_111 - V_382 -> V_186 ) ;
return 0 ;
}
...
struct V_102 * V_407 ;
if ( ! V_5 -> V_408 ) {
F_78 ( V_5 -> V_8 -> V_345 , L_63 ) ;
return 0 ;
}
V_407 = F_44 ( sizeof( * V_407 ) , V_282 ) ;
if ( ! V_407 )
return - V_283 ;
V_407 -> V_395 = V_409 ;
V_407 -> V_393 = V_410 ;
...
struct V_414 * V_415 ;
struct V_416 V_417 ;
V_415 = ( void * ) ( ( T_1 * ) V_412 +
sizeof( struct V_138 ) ) ;
V_413 = F_28 ( V_412 -> V_117 . V_119 ) /
sizeof( struct V_416 ) ;
for ( V_78 = 0 ; V_78 < V_413 ; V_78 ++ ) {
V_417 . V_150 = V_415 -> V_150 ;
V_417 . V_418 = V_415 -> V_418 ;
V_417 . V_85 = V_415 -> V_85 ;
V_417 . V_419 = V_415 -> V_419 ;
V_417 . V_420 = F_28 ( V_415 -> V_420 ) ;
V_417 . V_421 =
F_28 ( V_415 -> V_421 ) ;
V_417 . V_422 =
F_28 ( V_415 -> V_422 ) ;
...
V_417 . V_421 ,
V_417 . V_422 ) ;
memcpy ( & V_8 -> V_417 [ V_8 -> V_334 ++ ] , & V_417 ,
sizeof( struct V_416 ) ) ;
V_415 ++ ;
}
}
...
struct V_138 * V_186 ;
struct V_411 * V_412 ;
V_91 V_424 , type , V_119 ;
struct V_291 * V_425 ;
struct V_270 * V_271 ;
unsigned long V_426 , V_427 ;
bool V_428 = false ;
F_19 ( V_8 , V_49 , L_65 ) ;
V_423 = & V_347 -> V_296 . V_134 ;
V_186 = ( void * ) V_423 -> V_298 ;
V_424 = F_28 ( V_347 -> V_300 ) - ( sizeof( * V_423 ) + V_301
- 1 ) ;
while ( V_424 >= sizeof( struct V_138 ) ) {
type = F_28 ( V_186 -> type ) ;
V_119 = F_28 ( V_186 -> V_119 ) ;
if ( V_424 < ( sizeof( struct V_138 ) + V_119 ) ) {
F_19 ( V_8 , ERROR ,
L_66 ) ;
break;
}
...
V_424 -= V_119 + sizeof( struct V_138 ) ;
V_186 = ( void * ) ( ( T_1 * ) V_186 + V_119 +
sizeof( struct V_138 ) ) ;
}
F_42 ( & V_8 -> V_430 , V_426 ) ;
F_42 ( & V_8 -> V_286 , V_427 ) ;
if ( F_47 ( & V_8 -> V_287 ) ) {
V_428 = true ;
F_82 (cmd_node, &adapter->cmd_pending_q, list) {
V_425 = ( void * ) V_271 -> V_431 -> V_36 ;
if ( F_28 ( V_425 -> V_299 ) ==
V_135 ) {
F_19 ( V_8 , V_49 ,
L_67 ) ;
...
F_43 ( & V_8 -> V_286 , V_427 ) ;
F_43 ( & V_8 -> V_430 , V_426 ) ;
if ( V_428 )
F_67 ( V_5 ) ;
return 0 ;
}
...
T_4 V_312 = 0 ;
T_3 V_316 = 0 ;
struct V_438 * V_439 = V_432 ;
T_1 V_440 = V_439 -> V_440 ;
T_1 * V_364 = V_432 + sizeof( struct V_438 ) ;
V_91 V_352 = F_28 ( V_439 -> V_441 ) ;
if ( V_440 > V_366 ) {
F_19 ( V_8 , ERROR ,
L_68 ,
V_440 ) ;
...
L_69 ,
V_352 , V_440 ) ;
F_84 ( V_8 , V_442 , L_70 , V_432 ,
V_352 +
sizeof( struct V_438 ) ) ;
V_186 = (struct V_185 * ) V_364 ;
for ( V_304 = 0 ; V_304 < V_440 && V_212 ; V_304 ++ ) {
...
V_212 -= sizeof( V_91 ) ;
if ( V_437 ) {
V_316 = ( T_3 ) ( V_445 ) ( F_28 ( V_437 -> V_316 ) ) ;
V_316 *= 100 ;
F_19 ( V_8 , V_49 ,
L_45 , V_316 ) ;
V_312 = F_62 ( V_437 -> V_446 ) ;
V_87 = & V_437 -> V_87 ;
} else {
V_87 = NULL ;
}
...
int F_85 ( struct V_291 * V_292 )
{
struct V_448 * V_449 =
& V_292 -> V_296 . V_450 ;
V_292 -> V_299 = F_21 ( V_362 ) ;
V_292 -> V_300 = F_21 ( sizeof( struct V_448 )
+ V_301 ) ;
V_449 -> V_451 = 1 ;
return 0 ;
}
...
unsigned long V_85 ;
V_271 -> V_336 = true ;
V_271 -> V_452 = & V_8 -> V_453 ;
F_42 ( & V_8 -> V_286 , V_85 ) ;
F_87 ( & V_271 -> V_288 , & V_8 -> V_287 ) ;
F_43 ( & V_8 -> V_286 , V_85 ) ;
}
...
if ( ! ( * V_457 ) )
return 0 ;
for ( V_339 = 0 ; V_339 < V_461 ; V_339 ++ ) {
if ( V_5 -> V_462 [ V_339 ] . V_463 & V_456 ) {
V_460 =
(struct V_459 * )
* V_457 ;
V_460 -> V_117 . type =
F_21 ( V_464 ) ;
V_460 -> V_117 . V_119 =
F_21 ( ( ( ( V_91 ) V_5 -> V_462 [ V_339 ] . V_21 [ 1 ] )
& 0x00FF ) + 2 ) ;
memcpy ( V_460 -> V_21 , V_5 -> V_462 [ V_339 ] . V_21 ,
F_28 ( V_460 -> V_117 . V_119 ) ) ;
* V_457 += F_28 ( V_460 -> V_117 . V_119 ) +
sizeof( struct V_138 ) ;
V_458 += F_28 ( V_460 -> V_117 . V_119 ) +
sizeof( struct V_138 ) ;
}
}
return V_458 ;
...
return;
if ( ! V_5 -> V_466 ||
V_5 -> V_467 != V_465 -> V_217 ) {
V_5 -> V_467 = V_465 -> V_217 ;
F_46 ( V_5 -> V_466 ) ;
V_5 -> V_466 = F_92 ( V_465 -> V_217 ,
V_372 ) ;
if ( ! V_5 -> V_466 )
return;
}
memcpy ( V_5 -> V_466 , V_465 -> V_216 ,
V_465 -> V_217 ) ;
F_19 ( V_5 -> V_8 , V_49 ,
L_75 ,
V_5 -> V_467 ) ;
V_465 -> V_216 = V_5 -> V_466 ;
if ( V_465 -> V_9 )
V_465 -> V_9 =
(struct V_23 * )
( V_465 -> V_216 +
V_465 -> V_239 ) ;
if ( V_465 -> V_12 )
V_465 -> V_12 = (struct V_20 * )
( V_465 -> V_216 +
V_465 -> V_243 ) ;
if ( V_465 -> V_63 )
V_465 -> V_63 = (struct V_178 * )
( V_465 -> V_216 +
V_465 -> V_245 ) ;
if ( V_465 -> V_247 )
V_465 -> V_247 = (struct V_248 * )
( V_465 -> V_216 +
V_465 -> V_249 ) ;
if ( V_465 -> V_252 )
V_465 -> V_252 = ( void * ) ( V_465 -> V_216 +
V_465 -> V_253 ) ;
if ( V_465 -> V_255 )
V_465 -> V_255 = ( void * ) ( V_465 -> V_216 +
V_465 -> V_256 ) ;
if ( V_465 -> V_258 )
V_465 -> V_258 =
( V_465 -> V_216 + V_465 -> V_259 ) ;
if ( V_465 -> V_261 )
V_465 -> V_261 = V_465 -> V_216 +
V_465 -> V_262 ;
if ( V_465 -> V_264 )
V_465 -> V_264 = ( void * ) ( V_465 -> V_216 +
V_465 -> V_265 ) ;
}
void
F_93 ( struct V_4 * V_5 )
