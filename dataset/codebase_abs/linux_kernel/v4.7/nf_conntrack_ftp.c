...
{
int V_13 , V_97 ;
for ( V_13 = 0 ; V_13 < V_98 ; V_13 ++ ) {
for ( V_97 = 0 ; V_97 < 2 ; V_97 ++ ) {
if ( V_94 [ V_13 ] [ V_97 ] . V_99 == NULL )
continue;
F_5 ( L_25 ,
V_94 [ V_13 ] [ V_97 ] . V_80 . V_1 . V_27 , V_100 [ V_13 ] ) ;
F_39 ( & V_94 [ V_13 ] [ V_97 ] ) ;
}
}
F_40 ( V_73 ) ;
...
{
int V_13 , V_97 = - 1 , V_7 = 0 ;
V_73 = F_42 ( 65536 , V_101 ) ;
if ( ! V_73 )
return - V_102 ;
if ( V_98 == 0 )
V_100 [ V_98 ++ ] = V_103 ;
for ( V_13 = 0 ; V_13 < V_98 ; V_13 ++ ) {
V_94 [ V_13 ] [ 0 ] . V_80 . V_1 . V_27 = V_28 ;
V_94 [ V_13 ] [ 1 ] . V_80 . V_1 . V_27 = V_29 ;
for ( V_97 = 0 ; V_97 < 2 ; V_97 ++ ) {
V_94 [ V_13 ] [ V_97 ] . V_104 = sizeof( struct V_37 ) ;
V_94 [ V_13 ] [ V_97 ] . V_80 . V_1 . V_21 . V_22 . V_23 = F_8 ( V_100 [ V_13 ] ) ;
V_94 [ V_13 ] [ V_97 ] . V_80 . V_4 . V_105 = V_87 ;
V_94 [ V_13 ] [ V_97 ] . V_106 = & V_107 ;
V_94 [ V_13 ] [ V_97 ] . V_99 = V_108 ;
V_94 [ V_13 ] [ V_97 ] . F_19 = F_19 ;
V_94 [ V_13 ] [ V_97 ] . V_109 = F_37 ;
if ( V_100 [ V_13 ] == V_103 )
sprintf ( V_94 [ V_13 ] [ V_97 ] . V_110 , L_26 ) ;
else
sprintf ( V_94 [ V_13 ] [ V_97 ] . V_110 , L_27 , V_100 [ V_13 ] ) ;
F_5 ( L_28 ,
V_94 [ V_13 ] [ V_97 ] . V_80 . V_1 . V_27 , V_100 [ V_13 ] ) ;
V_7 = F_43 ( & V_94 [ V_13 ] [ V_97 ] ) ;
if ( V_7 ) {
F_44 ( L_29 ,
V_94 [ V_13 ] [ V_97 ] . V_80 . V_1 . V_27 , V_100 [ V_13 ] ) ;
V_98 = V_13 ;
