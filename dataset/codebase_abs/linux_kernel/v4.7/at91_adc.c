...
V_25 = V_185 ;
V_25 |= F_82 ( V_9 -> V_160 -> V_186 )
& V_187 ;
V_25 |= F_83 ( V_9 -> V_64 ) & V_188 ;
V_25 |= V_189 ;
V_25 |= V_190 ;
V_25 |= 0x03 << 8 ;
F_23 ( V_9 , V_191 , V_25 ) ;
...
V_196 -> V_40 . V_123 = & V_142 -> V_40 ;
V_196 -> V_200 = F_77 ;
V_196 -> V_201 = F_79 ;
F_86 ( V_202 , V_196 -> V_203 ) ;
F_86 ( V_204 , V_196 -> V_203 ) ;
F_86 ( V_48 , V_196 -> V_205 ) ;
if ( V_9 -> V_160 -> V_161 ) {
F_87 ( V_196 , V_45 , 0 , ( 1 << V_39 ) - 1 ,
0 , 0 ) ;
F_87 ( V_196 , V_46 , 0 , ( 1 << V_39 ) - 1 ,
0 , 0 ) ;
F_87 ( V_196 , V_47 , 0 , 0xffffff , 0 , 0 ) ;
} else {
if ( V_9 -> V_82 != V_83 ) {
F_16 ( & V_142 -> V_40 ,
L_40 ) ;
...
F_87 ( V_196 , V_45 , 0 , ( 1 << V_69 ) - 1 ,
0 , 0 ) ;
F_87 ( V_196 , V_46 , 0 , ( 1 << V_69 ) - 1 ,
0 , 0 ) ;
}
V_9 -> V_44 = V_196 ;
F_88 ( V_196 , V_9 ) ;
...
struct V_211 * V_36 ;
T_2 V_25 ;
V_6 = F_94 ( & V_142 -> V_40 , sizeof( struct V_8 ) ) ;
if ( ! V_6 )
return - V_89 ;
V_9 = F_2 ( V_6 ) ;
if ( V_142 -> V_40 . V_145 )
...
if ( V_122 ) {
F_16 ( & V_142 -> V_40 , L_41 ) ;
return - V_112 ;
}
F_95 ( V_142 , V_6 ) ;
V_6 -> V_40 . V_123 = & V_142 -> V_40 ;
V_6 -> V_109 = F_96 ( & V_142 -> V_40 ) ;
V_6 -> V_212 = V_213 ;
V_6 -> V_214 = & V_215 ;
V_9 -> V_1 = F_97 ( V_142 , 0 ) ;
if ( V_9 -> V_1 < 0 ) {
F_16 ( & V_142 -> V_40 , L_42 ) ;
return - V_150 ;
}
V_36 = F_98 ( V_142 , V_216 , 0 ) ;
V_9 -> V_217 = F_99 ( & V_142 -> V_40 , V_36 ) ;
if ( F_100 ( V_9 -> V_217 ) ) {
return F_101 ( V_9 -> V_217 ) ;
}
F_23 ( V_9 , V_135 , V_218 ) ;
F_23 ( V_9 , V_58 , 0xFFFFFFFF ) ;
if ( V_9 -> V_160 -> V_161 )
V_122 = F_102 ( V_9 -> V_1 , F_27 , 0 ,
V_142 -> V_40 . V_219 -> V_109 , V_6 ) ;
else
V_122 = F_102 ( V_9 -> V_1 , F_21 , 0 ,
V_142 -> V_40 . V_219 -> V_109 , V_6 ) ;
if ( V_122 ) {
F_16 ( & V_142 -> V_40 , L_43 ) ;
return V_122 ;
}
V_9 -> V_220 = F_103 ( & V_142 -> V_40 , L_44 ) ;
if ( F_100 ( V_9 -> V_220 ) ) {
F_16 ( & V_142 -> V_40 , L_45 ) ;
V_122 = F_101 ( V_9 -> V_220 ) ;
goto V_221;
}
V_122 = F_104 ( V_9 -> V_220 ) ;
if ( V_122 ) {
F_16 ( & V_142 -> V_40 ,
L_46 ) ;
goto V_221;
}
V_9 -> V_209 = F_103 ( & V_142 -> V_40 , L_47 ) ;
if ( F_100 ( V_9 -> V_209 ) ) {
F_16 ( & V_142 -> V_40 , L_48 ) ;
V_122 = F_101 ( V_9 -> V_209 ) ;
goto V_222;
}
V_122 = F_104 ( V_9 -> V_209 ) ;
if ( V_122 ) {
F_16 ( & V_142 -> V_40 ,
L_49 ) ;
goto V_222;
}
V_208 = F_105 ( V_9 -> V_220 ) ;
V_209 = F_105 ( V_9 -> V_209 ) ;
V_153 = V_209 / 1000 ;
F_17 ( & V_142 -> V_40 , L_50 ,
V_208 , V_209 ) ;
V_207 = ( V_208 / ( 2 * V_209 ) ) - 1 ;
if ( ! V_9 -> V_152 ) {
F_16 ( & V_142 -> V_40 , L_51 ) ;
V_122 = - V_112 ;
goto V_223;
}
V_156 = (* V_9 -> V_160 -> V_224 )( V_9 -> V_152 , V_153 ) ;
if ( V_9 -> V_167 > 0 )
V_210 = F_65 ( ( V_9 -> V_167 * V_153 / 1000 )
- 1 , 1 ) ;
else
V_210 = 0 ;
V_25 = F_106 ( V_207 ) & V_9 -> V_51 -> V_225 ;
V_25 |= F_107 ( V_156 ) & V_9 -> V_51 -> V_226 ;
if ( V_9 -> V_151 )
V_25 |= V_227 ;
if ( V_9 -> V_166 )
V_25 |= V_228 ;
V_25 |= F_108 ( V_210 ) & V_229 ;
F_23 ( V_9 , V_56 , V_25 ) ;
V_122 = F_28 ( V_6 ) ;
if ( V_122 < 0 ) {
...
static int F_114 ( struct V_141 * V_142 )
{
struct V_5 * V_6 = F_115 ( V_142 ) ;
struct V_8 * V_9 = F_2 ( V_6 ) ;
F_116 ( V_6 ) ;
if ( ! V_9 -> V_82 ) {
F_47 ( V_6 ) ;
