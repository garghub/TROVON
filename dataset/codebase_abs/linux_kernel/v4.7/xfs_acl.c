...
STATIC int
F_24 ( struct V_36 * V_36 , int type , struct V_1 * V_8 )
{
struct V_37 * V_38 = F_16 ( V_36 ) ;
unsigned char * V_39 ;
int error ;
...
V_51 . V_52 = V_53 | V_54 ;
V_51 . V_55 = V_50 ;
V_51 . V_56 = F_30 ( V_36 -> V_57 ) ;
error = F_31 ( F_16 ( V_36 ) , & V_51 , V_58 ) ;
}
return error ;
}
int
...
goto V_59;
error = - V_60 ;
if ( V_8 -> V_34 > F_22 ( F_33 ( V_36 -> V_57 ) ) )
return error ;
if ( type == V_40 ) {
T_1 V_50 = V_36 -> V_48 ;
error = F_34 ( V_8 , & V_50 ) ;
