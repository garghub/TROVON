...
static void F_158 ( struct V_539 * V_540 )
{
V_534 * V_541 ;
V_534 V_542 ;
V_541 = V_540 -> V_543 . V_544 -> V_545 ;
F_159 ( V_541 , 0 , 0 ) ;
F_159 ( V_541 , 8 , 0 ) ;
F_159 ( V_541 , 16 , 0 ) ;
V_542 = F_160 ( V_546 , V_547 ) |
F_160 ( 0 , V_548 ) |
F_160 ( V_540 -> V_543 . V_549 , V_550 ) ;
F_159 ( V_541 , 24 , V_542 ) ;
}
static void F_161 ( struct V_171 * V_172 )
{
struct V_325 * V_173 ;
struct V_551 * V_552 ;
V_173 = F_162 ( V_172 -> V_415 . V_553 ) ;
if ( ! V_173 ) {
F_16 ( L_57 ) ;
return;
}
...
if ( V_172 -> V_555 . V_106 ) {
if ( V_172 -> V_556 )
V_552 -> V_557 . V_558 ( V_172 -> V_556 ) ;
F_163 ( V_173 -> V_332 . V_559 , & V_172 -> V_555 ) ;
}
}
if ( V_172 -> V_19 ) {
...
struct V_57 * V_58 ;
struct V_325 * V_173 ;
struct V_539 * V_540 = & V_172 -> V_533 ;
T_2 V_560 ;
T_1 V_561 ;
T_1 V_562 ;
int V_563 = 0 ;
...
F_26 ( & V_172 -> V_277 , V_85 ) ;
if ( V_566 && ! V_172 -> V_577 ) {
F_166 ( V_173 , V_172 ) ;
if ( V_540 -> V_569 ) {
V_568 . V_553 = V_172 -> V_415 . V_553 ;
V_568 . V_29 = ( V_540 -> V_578 == V_579 ) ?
V_580 : V_581 ;
V_568 . V_582 . V_540 = & V_172 -> V_415 ;
V_172 -> V_415 . V_76 ( & V_568 , V_172 -> V_415 . V_583 ) ;
}
}
if ( V_58 && V_58 -> V_76 ) {
if ( V_564 ) {
...
static void V_538 ( struct V_584 * V_537 )
{
struct V_536 * V_585 = F_57 ( V_537 , struct V_536 , V_537 ) ;
struct V_171 * V_172 = V_585 -> V_172 ;
F_22 ( V_585 ) ;
F_164 ( V_172 ) ;
F_126 ( & V_172 -> V_415 ) ;
}
int F_167 ( struct V_57 * V_58 , struct V_586 * V_587 )
{
struct V_588 * V_415 ;
struct V_171 * V_172 ;
struct V_325 * V_173 ;
...
V_415 = F_168 ( V_58 -> V_553 , V_587 -> V_597 ) ;
if ( ! V_415 )
return - V_267 ;
V_172 = F_169 ( V_415 ) ;
V_173 = V_172 -> V_173 ;
...
V_19 -> V_172 = V_172 ;
V_594 = V_587 -> V_63 + V_599 + V_107 ;
V_69 = F_170 ( V_2 -> V_559 , & V_172 -> V_555 , V_594 , 1 ) ;
if ( V_69 )
return - V_237 ;
V_19 -> V_64 . V_65 = V_587 -> V_63 ;
V_595 . V_161 = V_172 -> V_555 . V_106 ;
V_595 . V_65 = F_44 ( V_19 , & V_595 , V_208 ) ;
memcpy ( V_595 . V_161 + V_595 . V_65 , V_587 -> V_61 ,
V_587 -> V_63 ) ;
if ( ( V_19 -> V_55 &&
! F_118 ( V_19 -> V_42 [ 0 ] , V_19 -> V_43 [ 0 ] ) ) ||
( ! V_19 -> V_55 &&
...
V_522 = V_172 -> V_522 ;
V_596 = ( V_600 ) V_172 -> V_555 . V_106 ;
V_592 = F_171 ( & V_522 -> V_601 ,
V_172 -> V_555 . V_602 ,
V_594 ,
V_603 ,
& V_596 ) ;
if ( F_103 ( V_592 ) ) {
F_163 ( V_2 -> V_559 , & V_172 -> V_555 ) ;
return - V_237 ;
}
V_592 -> V_604 = & V_522 -> V_601 ;
V_592 -> V_553 = V_522 -> V_601 . V_553 ;
V_172 -> V_556 = V_592 ;
if ( V_172 -> V_605 )
V_172 -> V_533 . V_543 . V_544 = F_172 ( V_172 -> V_605 ) ;
if ( F_27 ( V_19 ) )
V_2 -> V_531 -> V_606 (
& V_172 -> V_533 ,
V_172 -> V_555 . V_106 ,
( V_595 . V_65 + V_587 -> V_63 ) ,
V_592 -> V_607 ) ;
else
V_2 -> V_531 -> V_606 (
& V_172 -> V_533 ,
V_172 -> V_555 . V_106 ,
( V_595 . V_65 + V_587 -> V_63 + V_107 ) ,
V_592 -> V_607 ) ;
} else {
if ( V_172 -> V_605 )
V_172 -> V_533 . V_543 . V_544 = F_172 ( V_172 -> V_605 ) ;
...
V_172 -> V_554 = 0 ;
V_19 -> V_528 = V_595 . V_65 + V_587 -> V_63 ;
F_154 ( V_172 , V_19 ) ;
V_58 -> V_458 ( V_58 ) ;
F_155 ( & V_172 -> V_415 ) ;
...
V_590 . V_608 = V_573 ;
V_19 -> V_372 = false ;
F_174 ( & V_172 -> V_415 , & V_590 , V_609 , NULL ) ;
if ( V_19 -> V_368 ) {
V_19 -> V_368 -> V_64 . V_65 = V_587 -> V_63 ;
...
int F_175 ( struct V_57 * V_58 , const void * V_64 , T_1 V_610 )
{
struct V_325 * V_173 ;
struct V_18 * V_19 ;
struct V_18 * V_364 ;
...
V_364 = V_19 -> V_368 ;
V_19 -> V_58 = V_58 ;
V_19 -> V_64 . V_65 = V_610 ;
V_173 = F_162 ( V_58 -> V_553 ) ;
if ( ! V_173 )
return - V_267 ;
V_19 -> V_164 -> V_611 ++ ;
if ( V_610 + sizeof( struct V_214 ) > V_246 )
return - V_267 ;
if ( V_364 ) {
memcpy ( & V_364 -> V_62 , V_64 , V_610 ) ;
V_364 -> V_64 . V_65 = V_610 ;
}
return F_141 ( V_19 , V_64 , V_610 ) ;
}
int F_176 ( struct V_57 * V_58 , struct V_586 * V_587 )
{
struct V_588 * V_415 ;
struct V_171 * V_172 ;
struct V_325 * V_173 ;
...
V_69 = F_97 ( V_173 , V_54 . V_38 , V_613 ) ;
if ( V_69 ) {
F_73 ( V_173 ,
& V_54 ,
V_414 ,
...
if ( ! V_19 )
goto V_359;
F_5 ( V_19 , ( T_2 ) V_587 -> V_66 , ( T_2 ) V_587 -> V_67 ) ;
if ( V_19 -> V_227 == V_229 &&
! V_19 -> V_25 )
V_19 -> V_25 = 1 ;
V_19 -> V_413 = V_413 ;
...
int F_177 ( struct V_57 * V_58 , int V_436 )
{
struct V_325 * V_173 ;
struct V_313 * V_614 ;
struct V_53 V_54 ;
...
V_54 . V_436 = V_436 ;
V_54 . V_58 = V_58 ;
V_614 = F_139 ( & V_173 -> V_164 , V_173 , & V_54 ) ;
if ( ! V_614 ) {
F_16 ( L_67 ) ;
return - V_237 ;
}
...
return 0 ;
error:
F_100 ( & V_173 -> V_164 , ( void * ) V_614 , false ) ;
return - V_267 ;
}
int F_178 ( struct V_57 * V_58 )
{
struct V_325 * V_173 ;
V_173 = F_162 ( V_58 -> V_553 ) ;
if ( V_58 -> V_71 )
...
static void F_179 ( struct V_77 * V_29 )
{
struct V_171 * V_172 ;
struct V_325 * V_173 ;
struct V_18 * V_19 ;
...
F_154 ( V_172 , V_19 ) ;
V_619 = ( V_19 -> V_227 == V_229 ) ;
if ( V_172 -> V_605 )
V_172 -> V_533 . V_543 . V_544 = F_172 ( V_172 -> V_605 ) ;
V_2 -> V_531 -> V_621 ( & V_172 -> V_533 , V_619 ) ;
if ( V_172 -> V_605 )
F_173 ( V_172 -> V_605 ) ;
...
static void F_180 ( struct V_77 * V_29 )
{
...
static void F_181 ( struct V_584 * V_537 )
{
...
F_156 ( & V_29 -> V_622 , F_181 ) ;
F_157 ( V_29 -> V_19 -> V_164 -> V_468 , & V_29 -> V_622 ) ;
}
