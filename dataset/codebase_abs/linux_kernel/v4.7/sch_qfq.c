...
if ( V_56 ) {
V_11 -> V_16 . V_168 ++ ;
return F_115 ( V_86 , V_3 ) ;
}
}
V_56 = F_116 ( V_86 , V_11 -> V_13 ) ;
if ( F_88 ( V_56 != V_113 ) ) {
F_10 ( L_12 , V_56 ) ;
if ( F_117 ( V_56 ) ) {
V_11 -> V_16 . V_168 ++ ;
...
static void F_119 ( struct V_5 * V_6 , struct V_125 * V_38 ,
struct V_25 * V_26 )
{
...
F_95 ( V_38 -> V_22 , & V_6 -> V_132 [ V_140 ] ) ;
if ( F_120 ( V_38 -> V_22 , & V_6 -> V_132 [ V_133 ] ) &&
...
static void F_121 ( struct V_2 * V_3 , unsigned long V_52 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_1 * V_11 = (struct V_1 * ) V_52 ;
if ( V_11 -> V_13 -> V_6 . V_14 == 0 )
...
static unsigned int F_122 ( struct V_5 * V_6 ,
struct V_171 * V_147 )
{
struct V_25 * V_26 ;
struct V_1 * V_11 ;
...
static unsigned int F_124 ( struct V_2 * V_3 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_125 * V_38 ;
...
V_12 = F_122 ( V_6 , & V_38 -> V_152 [ V_173 ] ) ;
if ( V_12 > 0 ) {
V_3 -> V_6 . V_14 -- ;
return V_12 ;
}
