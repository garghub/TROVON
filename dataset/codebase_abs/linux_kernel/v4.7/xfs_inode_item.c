...
struct V_1 * V_5 ;
ASSERT ( V_9 -> V_119 == NULL ) ;
V_5 = V_9 -> V_119 = F_38 ( V_148 , V_149 ) ;
V_5 -> V_10 = V_9 ;
F_39 ( V_147 , & V_5 -> V_4 , V_123 ,
& V_150 ) ;
}
void
F_40 (
...
V_153 -> V_162 = V_3 -> V_162 ;
V_3 -> V_162 = V_153 ;
V_5 = F_1 ( V_153 ) ;
if ( V_5 -> V_163 && V_153 -> V_120 == V_5 -> V_164 )
V_159 ++ ;
V_153 = V_154 ;
}
V_5 = F_1 ( V_3 ) ;
if ( V_5 -> V_163 && V_3 -> V_120 == V_5 -> V_164 )
V_159 ++ ;
if ( V_159 ) {
struct V_2 * V_165 [ V_159 ] ;
int V_166 = 0 ;
F_43 ( & V_157 -> V_167 ) ;
for ( V_153 = V_3 ; V_153 ; V_153 = V_153 -> V_162 ) {
V_5 = F_1 ( V_153 ) ;
if ( V_5 -> V_163 &&
V_153 -> V_120 == V_5 -> V_164 ) {
V_165 [ V_166 ++ ] = V_153 ;
}
ASSERT ( V_166 <= V_159 ) ;
}
F_44 ( V_157 , V_165 , V_166 ,
V_168 ) ;
}
for ( V_153 = V_3 ; V_153 ; V_153 = V_154 ) {
V_154 = V_153 -> V_162 ;
V_153 -> V_162 = NULL ;
V_5 = F_1 ( V_153 ) ;
V_5 -> V_163 = 0 ;
...
T_7 * V_176 )
{
if ( V_175 -> V_177 == sizeof( V_178 ) ) {
V_178 * V_179 = V_175 -> V_180 ;
V_176 -> V_122 = V_179 -> V_122 ;
V_176 -> V_50 = V_179 -> V_50 ;
V_176 -> V_132 = V_179 -> V_132 ;
V_176 -> V_65 = V_179 -> V_65 ;
V_176 -> V_49 = V_179 -> V_49 ;
V_176 -> V_124 = V_179 -> V_124 ;
memcpy ( V_176 -> V_57 . V_61 . V_181 ,
V_179 -> V_57 . V_61 . V_181 ,
sizeof( V_182 ) ) ;
V_176 -> V_125 = V_179 -> V_125 ;
V_176 -> V_128 = V_179 -> V_128 ;
V_176 -> V_130 = V_179 -> V_130 ;
return 0 ;
} else if ( V_175 -> V_177 == sizeof( V_183 ) ) {
V_183 * V_184 = V_175 -> V_180 ;
V_176 -> V_122 = V_184 -> V_122 ;
V_176 -> V_50 = V_184 -> V_50 ;
V_176 -> V_132 = V_184 -> V_132 ;
V_176 -> V_65 = V_184 -> V_65 ;
V_176 -> V_49 = V_184 -> V_49 ;
V_176 -> V_124 = V_184 -> V_124 ;
memcpy ( V_176 -> V_57 . V_61 . V_181 ,
V_184 -> V_57 . V_61 . V_181 ,
sizeof( V_182 ) ) ;
V_176 -> V_125 = V_184 -> V_125 ;
V_176 -> V_128 = V_184 -> V_128 ;
V_176 -> V_130 = V_184 -> V_130 ;
return 0 ;
}
return - V_185 ;
}
