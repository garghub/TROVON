...
bool F_195 ( int V_193 , T_14 V_194 )
{
struct V_1 * V_7 ;
int V_195 ;
unsigned long V_11 ;
...
{
return * V_197 = F_199 ( * V_197 , V_110 -> V_40 ) ;
}
int F_200 ( void )
{
if ( V_110 -> V_198 == V_199 )
V_110 -> V_198 =
F_201 ( & V_110 -> V_40 ) ;
return F_198 ( & V_110 -> V_198 ) ;
}
int F_202 ( void )
{
if ( V_110 -> V_200 == V_199 )
V_110 -> V_200 =
F_201 ( & V_110 -> V_40 ) ;
return F_198 ( & V_110 -> V_200 ) ;
}
int F_203 ( const struct V_4 * V_201 ,
const struct V_4 * V_202 )
{
return F_24 ( V_201 -> V_40 , V_202 -> V_40 ) ;
}
void F_204 ( void )
{
struct V_55 * V_203 ;
F_42 () ;
V_203 = F_3 ( V_110 ) -> V_3 . V_55 ;
F_205 ( L_9 , V_110 -> V_204 ) ;
F_173 ( V_203 ) ;
F_174 ( L_10 ,
F_155 ( & V_110 -> V_40 ) ) ;
F_49 () ;
...
int F_207 ( struct V_167 * V_205 , struct V_206 * V_207 ,
...
int V_96 ;
V_96 = - V_126 ;
V_95 = F_58 ( V_209 , V_42 ) ;
if ( ! V_95 )
goto V_49;
V_96 = - V_210 ;
V_3 = F_208 ( V_36 , V_6 ) ;
V_37 = F_209 ( V_3 -> V_55 , V_95 , V_209 ,
V_110 -> V_211 -> V_212 ) ;
F_83 ( V_3 ) ;
if ( ! V_37 )
goto V_213;
...
void F_212 ( struct V_167 * V_205 , struct V_4 * V_5 )
{
F_153 ( V_205 , L_11 ,
F_155 ( & V_5 -> V_40 ) ) ;
F_153 ( V_205 , L_12 ,
