...
if ( V_2 -> V_17 )
F_1 ( V_2 , V_4 , V_41 , V_42 ) ;
else
F_1 ( V_2 , V_4 , V_43 , V_44 ) ;
}
struct V_1 * F_12 ( struct V_45 * V_46 , bool V_17 )
{
struct V_1 * V_2 ;
int V_47 ;
V_2 = F_13 ( V_46 -> V_48 , sizeof( * V_2 ) , V_49 ) ;
if ( V_2 == NULL )
return F_14 ( - V_50 ) ;
V_2 -> V_17 = V_17 ;
V_2 -> V_30 . V_51 = & V_52 ;
...
V_2 -> V_30 . type = V_54 ;
V_47 = F_15 ( V_46 , & V_2 -> V_30 , V_17 ? L_1 : L_2 , 2 ,
& V_55 ) ;
if ( V_47 < 0 )
return F_14 ( V_47 ) ;
return V_2 ;
