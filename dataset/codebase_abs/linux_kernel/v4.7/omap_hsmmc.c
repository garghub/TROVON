...
V_7 = F_95 ( V_169 , & V_223 ) ;
if ( V_7 )
return V_7 ;
V_7 = F_90 ( V_4 , V_129 , NULL , V_169 ) ;
if ( V_7 )
return V_7 ;
V_225 = F_96 ( V_169 , V_129 -> V_170 , V_129 -> V_171 ,
...
static void F_107 ( struct V_6 * V_5 , struct V_263 * V_264 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
if ( F_16 ( V_4 ) -> V_265 )
F_16 ( V_4 ) -> V_265 ( V_264 ) ;
}
static void F_108 ( struct V_6 * V_5 , int V_266 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
T_1 V_48 , V_86 ;
unsigned long V_50 ;
...
return - V_31 ;
V_7 = F_110 ( V_4 -> V_2 , V_4 -> V_269 ) ;
if ( V_7 ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_59 ) ;
goto V_182;
}
if ( V_4 -> V_36 -> V_102 & V_270 ) {
struct V_271 * V_272 = F_111 ( V_4 -> V_2 ) ;
if ( ! V_272 ) {
V_7 = - V_31 ;
goto V_273;
}
if ( F_22 ( F_112 ( V_272 , V_274 ) ) ) {
F_84 ( V_4 -> V_2 , L_60 ) ;
F_113 ( V_272 ) ;
V_7 = - V_220 ;
goto V_273;
}
if ( F_22 ( F_112 ( V_272 , V_275 ) ) ) {
F_84 ( V_4 -> V_2 , L_61 ) ;
F_113 ( V_272 ) ;
V_7 = - V_220 ;
goto V_273;
...
V_276 = F_33 ( V_4 -> V_43 , V_84 ) & ~ V_277 ;
F_32 ( V_4 -> V_43 , V_84 , V_276 | V_98 ) ;
V_276 = F_33 ( V_4 -> V_43 , V_82 ) ;
F_32 ( V_4 -> V_43 , V_82 , V_276 | V_99 ) ;
F_79 ( V_4 ) ;
}
static int F_116 ( struct V_263 * V_264 ,
...
static int F_117 ( struct V_280 * V_281 , void * V_129 )
{
struct V_6 * V_5 = V_281 -> V_282 ;
struct V_3 * V_4 = F_6 ( V_5 ) ;
F_118 ( V_281 , L_63 , V_5 -> V_283 ) ;
F_118 ( V_281 , L_64 ,
...
static int F_123 ( struct V_285 * V_285 , struct V_286 * V_286 )
{
return F_124 ( V_286 , F_117 , V_285 -> V_287 ) ;
}
static void F_125 ( struct V_6 * V_5 )
{
if ( V_5 -> V_288 )
F_126 ( L_79 , V_289 , V_5 -> V_288 ,
V_5 , & V_290 ) ;
}
static void F_125 ( struct V_6 * V_5 )
{
...
{
struct V_35 * V_36 , * V_291 ;
struct V_292 * V_293 = V_2 -> V_32 ;
V_36 = F_128 ( V_2 , sizeof( * V_36 ) , V_294 ) ;
if ( ! V_36 )
return F_129 ( - V_295 ) ;
V_291 = F_130 ( V_2 ) ;
if ( V_291 && V_291 -> V_127 )
V_36 -> V_127 = V_291 -> V_127 ;
if ( F_131 ( V_293 , L_80 , NULL ) )
V_36 -> V_102 |= V_103 ;
V_36 -> V_40 = - V_220 ;
V_36 -> V_37 = - V_220 ;
V_36 -> V_42 = - V_220 ;
if ( F_131 ( V_293 , L_81 , NULL ) ) {
V_36 -> V_296 = true ;
V_36 -> V_34 = true ;
}
if ( F_131 ( V_293 , L_82 , NULL ) )
V_36 -> V_77 |= V_180 ;
if ( F_131 ( V_293 , L_83 , NULL ) )
V_36 -> V_77 |= V_78 ;
return V_36 ;
}
...
static int F_132 ( struct V_297 * V_298 )
{
struct V_35 * V_36 = V_298 -> V_2 . V_299 ;
struct V_6 * V_5 ;
struct V_3 * V_4 = NULL ;
struct V_300 * V_174 ;
int V_7 , V_117 ;
const struct V_301 * V_302 ;
const struct V_303 * V_129 ;
void T_6 * V_43 ;
V_302 = F_133 ( F_134 ( V_304 ) , & V_298 -> V_2 ) ;
if ( V_302 ) {
V_36 = F_127 ( & V_298 -> V_2 ) ;
if ( F_22 ( V_36 ) )
return F_23 ( V_36 ) ;
if ( V_302 -> V_129 ) {
V_129 = V_302 -> V_129 ;
V_36 -> V_305 = V_129 -> V_305 ;
...
V_174 = F_135 ( V_298 , V_307 , 0 ) ;
V_117 = F_136 ( V_298 , 0 ) ;
if ( V_174 == NULL || V_117 < 0 )
return - V_306 ;
V_43 = F_137 ( & V_298 -> V_2 , V_174 ) ;
if ( F_22 ( V_43 ) )
return F_23 ( V_43 ) ;
V_5 = F_138 ( sizeof( struct V_3 ) , & V_298 -> V_2 ) ;
if ( ! V_5 ) {
V_7 = - V_295 ;
goto V_182;
}
...
V_4 -> V_159 = - 1 ;
V_4 -> V_117 = V_117 ;
V_4 -> V_230 = V_174 -> V_309 + V_36 -> V_305 ;
V_4 -> V_43 = V_43 + V_36 -> V_305 ;
V_4 -> V_104 = V_105 ;
V_4 -> V_218 . V_219 = 1 ;
V_4 -> V_23 = 0 ;
V_4 -> V_14 = 0 ;
...
F_140 ( V_298 , V_4 ) ;
if ( V_298 -> V_2 . V_32 )
V_4 -> V_269 = F_141 ( V_298 -> V_2 . V_32 , 1 ) ;
V_5 -> V_311 = & V_312 ;
V_5 -> V_313 = V_314 ;
if ( V_36 -> V_315 > 0 )
V_5 -> V_316 = V_36 -> V_315 ;
else if ( V_5 -> V_316 == 0 )
V_5 -> V_316 = V_317 ;
F_142 ( & V_4 -> V_57 ) ;
V_4 -> V_65 = F_143 ( & V_298 -> V_2 , L_85 ) ;
if ( F_22 ( V_4 -> V_65 ) ) {
V_7 = F_23 ( V_4 -> V_65 ) ;
V_4 -> V_65 = NULL ;
goto V_308;
}
if ( V_4 -> V_36 -> V_102 & V_318 ) {
F_84 ( & V_298 -> V_2 , L_86 ) ;
V_312 . V_319 = F_116 ;
}
F_144 ( & V_298 -> V_2 , true ) ;
F_145 ( V_4 -> V_2 ) ;
F_119 ( V_4 -> V_2 ) ;
F_146 ( V_4 -> V_2 , V_320 ) ;
F_147 ( V_4 -> V_2 ) ;
F_50 ( V_4 ) ;
V_4 -> V_209 = F_143 ( & V_298 -> V_2 , L_87 ) ;
if ( F_22 ( V_4 -> V_209 ) ) {
V_4 -> V_209 = NULL ;
...
V_5 -> V_322 = 512 ;
V_5 -> V_323 = 0xFFFF ;
V_5 -> V_324 = V_5 -> V_322 * V_5 -> V_323 ;
V_5 -> V_325 = V_5 -> V_324 ;
V_5 -> V_111 |= V_326 | V_327 |
V_328 | V_329 ;
...
if ( F_16 ( V_4 ) -> V_296 )
V_5 -> V_111 |= V_332 ;
V_5 -> V_333 |= F_16 ( V_4 ) -> V_333 ;
F_115 ( V_4 ) ;
V_4 -> V_157 = F_148 ( & V_298 -> V_2 , L_89 ) ;
if ( F_22 ( V_4 -> V_157 ) ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_90 ) ;
V_7 = F_23 ( V_4 -> V_157 ) ;
goto V_334;
}
V_4 -> V_156 = F_148 ( & V_298 -> V_2 , L_91 ) ;
if ( F_22 ( V_4 -> V_156 ) ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_92 ) ;
V_7 = F_23 ( V_4 -> V_156 ) ;
goto V_334;
}
V_7 = F_149 ( & V_298 -> V_2 , V_4 -> V_117 , F_77 , 0 ,
F_59 ( V_5 ) , V_4 ) ;
if ( V_7 ) {
...
F_32 ( V_4 -> V_43 , V_60 , 0 ) ;
F_32 ( V_4 -> V_43 , V_63 , 0 ) ;
if ( ! ( F_33 ( V_4 -> V_43 , V_284 ) & F_165 ( 1 ) ) ) {
F_24 ( V_2 , L_95 ) ;
F_32 ( V_4 -> V_43 , V_58 , V_59 ) ;
