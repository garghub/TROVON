...
F_54 = (struct V_66 * ) F_158 ( V_24 ) ;
V_284 = F_26 ( V_283 -> V_286 ) ;
V_285 = V_283 -> V_287 ;
if ( V_284 == V_288 && V_285 == V_289 && V_290 )
F_19 ( L_34 ,
F_54 -> V_107 , F_54 -> V_102 ) ;
V_24 -> V_99 = F_159 ( V_281 ) -> V_7 ;
F_160 ( V_24 ) ;
}
static int F_161 ( struct V_291 * V_196 , bool V_292 )
{
struct V_158 * V_159 = F_162 ( V_196 ) ;
...
V_32 = F_163 ( V_196 ) ;
if ( V_32 ) {
F_164 ( V_196 -> V_295 , V_294 , sizeof( V_294 ) ) ;
...
static void F_173 ( struct V_36 * V_37 , struct V_2 * V_3 )
{
...
static int F_175 ( struct V_291 * V_196 )
{
struct V_158 * V_159 = F_162 ( V_196 ) ;
struct V_2 * V_293 = F_102 ( V_159 ) ;
...
F_174 ( & V_138 -> V_22 ) ;
F_23 ( & V_293 -> V_244 ) ;
F_173 ( V_35 -> V_37 , V_34 -> V_3 ) ;
F_176 ( V_34 -> V_3 ) ;
F_177 ( V_35 ) ;
F_178 ( V_239 , & V_34 -> V_308 ) ;
return 0 ;
}
static int F_179 ( struct V_291 * V_196 , bool V_309 )
{
...
static int F_181 ( struct V_4 * V_35 )
{
struct V_1 * V_7 = V_35 -> V_7 ;
...
if ( ! V_313 )
return - V_64 ;
V_35 -> V_279 . V_316 = F_153 ;
V_35 -> V_279 . type = F_53 ( V_317 ) ;
V_35 -> V_279 . V_99 = V_7 ;
F_186 ( & V_35 -> V_279 ) ;
V_35 -> V_125 . V_316 = F_63 ;
V_35 -> V_125 . type = F_187 ( V_98 ) ;
V_35 -> V_125 . V_99 = V_7 ;
F_186 ( & V_35 -> V_125 ) ;
return 0 ;
}
...
static void F_192 ( struct V_320 * V_320 )
{
struct V_10 * V_11 ;
struct V_4 * V_35 ;
struct V_12 * V_13 ;
...
V_11 = F_132 ( V_13 ) ;
V_7 = V_35 -> V_7 ;
if ( F_193 ( V_321 , & V_35 -> V_322 ) )
F_194 ( V_13 ) ;
F_195 ( V_11 ) ;
F_196 ( V_7 ) ;
F_197 ( V_323 ) ;
}
static inline void F_198 ( struct V_4 * V_35 )
{
F_199 ( & V_35 -> V_320 ) ;
}
static inline void F_177 ( struct V_4 * V_35 )
{
F_200 ( & V_35 -> V_320 , F_192 ) ;
}
...
static struct V_36 * F_204 ( struct V_325 * V_326 )
{
struct V_36 * V_37 ;
struct V_327 * V_328 ;
int V_32 ;
V_37 = F_205 ( sizeof( * V_37 ) , V_329 ) ;
if ( ! V_37 ) {
...
struct V_4 * F_211 ( struct V_36 * V_37 ,
struct V_1 * V_7 ,
enum V_352 V_353 )
{
struct V_10 * V_11 ;
...
static struct V_2 * F_166 ( struct V_4 * V_35 ,
...
struct V_5 * V_34 ;
struct V_158 * V_159 ;
struct V_291 * V_196 = F_216 ( V_359 ) ;
struct V_302 * V_303 ;
struct V_36 * V_37 = V_35 -> V_37 ;
int V_32 = 0 ;
V_303 = F_205 ( sizeof( struct V_302 ) , V_329 ) ;
if ( ! V_303 ) {
F_34 ( V_13 -> V_16 , L_51 ) ;
return NULL ;
}
...
if ( ! V_360 )
V_3 = F_217 ( & V_361 , sizeof( * V_34 ) ) ;
else
V_3 = F_218 ( V_196 , sizeof( * V_34 ) ) ;
if ( ! V_3 ) {
...
static void F_224 ( struct V_4 * V_35 )
{
F_225 ( & V_35 -> V_125 ) ;
F_225 ( & V_35 -> V_279 ) ;
F_226 () ;
}
static void F_227 ( struct V_4 * V_35 )
{
struct V_12 * V_13 = F_32 ( V_35 ) ;
...
static int F_234 ( struct V_1 * V_7 )
{
...
static void F_237 ( struct V_36 * V_37 )
{
F_238 ( V_37 ) ;
F_239 ( V_37 ) ;
}
static int F_240 ( struct V_36 * V_37 )
{
if ( F_241 ( V_37 ) )
goto V_373;
if ( F_242 ( V_37 ) )
...
static int F_208 ( struct V_36 * V_37 )
{
struct V_325 * V_326 ;
struct V_374 * V_375 ;
if ( ! V_37 -> V_326 ) {
...
break;
default:
F_243 ( V_394 L_67 , V_375 -> V_187 ) ;
break;
}
F_244 ( V_37 -> V_376 ) ;
return 0 ;
}
static void F_203 ( struct V_36 * V_37 )
{
if ( V_37 -> V_376 ) {
V_37 -> V_202 [ 0 ] = '\0' ;
F_245 ( V_37 -> V_376 ) ;
...
static void F_233 ( struct V_4 * V_35 )
{
struct V_12 * V_13 = F_32 ( V_35 ) ;
struct V_2 * V_3 ;
struct V_2 * V_196 ;
...
static void F_254 ( struct V_36 * V_37 )
{
if ( F_193 ( V_296 , & V_37 -> V_85 ) ) {
if ( F_255 ( V_37 ) == 0 ) {
F_256 ( & V_37 -> V_407 ) ;
...
static void F_249 ( struct V_4 * V_35 )
{
struct V_12 * V_13 = F_32 ( V_35 ) ;
struct V_2 * V_3 ;
int V_411 = 0 ;
...
static void F_260 ( struct V_325 * V_99 )
{
struct V_36 * V_37 ;
int V_32 = 0 ;
F_19 ( L_1 , V_41 ) ;
...
static T_6 F_263 ( struct V_2 * V_3 ,
struct V_421 * V_422 )
{
struct V_423 V_424 ;
T_6 V_40 , V_425 = 0 ;
...
if ( F_264 ( V_422 -> V_211 [ 0 ] ) == 0 &&
F_264 ( V_422 -> V_212 [ 0 ] ) == 0 ) {
F_34 ( V_3 , L_86 ) ;
goto V_428;
}
V_424 . V_429 = V_430 ;
...
V_424 . V_367 = F_264 ( V_422 -> V_211 [ V_40 ] ) ;
V_424 . V_295 = F_264 ( V_422 -> V_212 [ V_40 ] ) ;
F_265 ( V_424 . V_433 , sizeof( V_424 . V_433 ) ,
L_87 ,
V_425 , V_424 . V_295 , V_424 . V_367 ) ;
if ( F_266 ( V_3 -> V_188 , 0 , & V_424 ) )
V_425 ++ ;
else
F_34 ( V_3 , L_88 ) ;
}
...
if ( ! V_37 -> V_326 -> V_434 )
goto V_428;
V_422 = F_205 ( sizeof( struct V_421 ) , V_329 ) ;
if ( ! V_422 )
goto V_428;
...
static int F_268 ( struct V_1 * V_7 )
{
struct V_4 * V_35 ;
struct V_12 * V_13 ;
int V_32 = 0 ;
...
static int F_269 ( struct V_10 * V_226 )
{
...
static int F_270 ( struct V_1 * V_7 ,
enum V_352 V_353 ,
enum V_437 V_438 )
{
struct V_10 * V_226 ;
...
static int F_276 ( struct V_1 * V_7 , enum V_352 V_353 )
{
return F_270 ( V_7 , V_353 , V_454 ) ;
}
static int F_277 ( struct V_1 * V_7 )
{
return F_270 ( V_7 , V_441 ,
V_455 ) ;
}
static struct V_36 * F_278 ( struct V_325 * V_326 )
{
struct V_36 * V_37 ;
...
static struct V_4 * F_235 ( struct V_1
* V_7 )
{
struct V_4 * V_35 ;
F_131 (interface, &if_list, list) {
...
static void F_279 ( struct V_325 * V_99 )
{
struct V_36 * V_37 ;
struct V_4 * V_35 , * V_153 ;
F_19 ( L_103 ) ;
...
struct V_149 * V_150 ;
struct V_458 * V_130 ;
V_150 = & F_284 ( V_459 , V_457 ) ;
V_130 = F_285 ( F_93 ,
( void * ) V_150 , F_286 ( V_457 ) ,
L_106 , V_457 ) ;
if ( F_287 ( ! F_288 ( V_130 ) ) ) {
F_289 ( V_130 , V_457 ) ;
V_150 -> V_460 = V_130 ;
F_71 ( V_130 ) ;
}
...
static int F_292 ( struct V_461 * V_462 ,
unsigned long V_463 , void * V_464 )
{
unsigned V_457 = ( unsigned long ) V_464 ;
switch ( V_463 ) {
case V_465 :
case V_466 :
...
static int F_293 ( struct V_470 * V_471 )
{
if ( ! V_472 )
return 0 ;
F_294 ( V_471 , V_472 ) ;
...
static T_9
F_311 ( struct V_187 * V_99 , struct V_482 * V_483 ,
char * V_294 )
{
...
struct V_5 * V_34 = F_2 ( V_3 ) ;
struct V_4 * V_35 = V_34 -> V_6 ;
sprintf ( V_294 , L_116 , V_35 -> V_450 ) ;
return strlen ( V_294 ) ;
}
static T_9
F_313 ( struct V_187 * V_99 ,
struct V_482 * V_483 , const char * V_294 , T_10 V_426 )
{
struct V_158 * V_159 = F_312 ( V_99 ) ;
struct V_2 * V_3 = F_102 ( V_159 ) ;
struct V_5 * V_34 = F_2 ( V_3 ) ;
struct V_4 * V_35 = V_34 -> V_6 ;
int V_484 , V_485 ;
V_484 = F_314 ( V_294 , 10 , & V_485 ) ;
if ( V_484 )
return V_484 ;
if ( V_485 > 255 )
return - V_486 ;
V_35 -> V_450 = ( T_1 ) V_485 ;
return strlen ( V_294 ) ;
}
