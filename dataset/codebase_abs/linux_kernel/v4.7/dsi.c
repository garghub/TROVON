...
static enum V_459 F_255 ( int V_181 )
{
switch ( F_256 () ) {
case V_572 :
case V_573 :
...
if ( V_155 )
return V_155 ;
V_155 = F_264 ( V_460 , V_6 ) ;
if ( V_155 )
return V_155 ;
V_155 = F_265 ( V_6 , V_587 ) ;
if ( V_155 ) {
F_44 ( L_165 ,
V_6 -> V_45 ) ;
F_266 ( V_460 , V_6 ) ;
...
static int F_273 ( struct V_2 * V_157 )
{
...
if ( ! V_600 )
return 0 ;
V_598 = F_275 ( V_600 , L_168 , & V_344 ) ;
if ( V_598 == NULL ) {
F_276 ( & V_157 -> V_4 , L_169 ) ;
V_155 = - V_153 ;
goto V_333;
}
...
V_451 > V_16 -> V_274 * 2 ) {
F_276 ( & V_157 -> V_4 , L_170 ) ;
V_155 = - V_153 ;
goto V_333;
}
V_155 = F_277 ( V_600 , L_168 , V_599 , V_451 ) ;
if ( V_155 ) {
F_276 ( & V_157 -> V_4 , L_171 ) ;
goto V_333;
}
V_450 . V_451 = V_451 ;
...
static int F_281 ( struct V_608 * V_4 , struct V_608 * V_609 , void * V_26 )
{
...
struct V_611 * V_613 ;
struct V_611 V_614 ;
V_16 = F_282 ( & V_3 -> V_4 , sizeof( * V_16 ) , V_615 ) ;
if ( ! V_16 )
return - V_616 ;
V_16 -> V_157 = V_3 ;
F_283 ( & V_3 -> V_4 , V_16 ) ;
...
V_16 -> V_141 . V_26 = 0 ;
#endif
V_613 = F_290 ( V_3 , V_617 , L_177 ) ;
if ( ! V_613 ) {
V_613 = F_291 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_178 ) ;
return - V_153 ;
}
...
V_612 = V_613 ;
V_16 -> V_19 = F_292 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_293 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_179 ) ;
return - V_616 ;
}
V_613 = F_290 ( V_3 , V_617 , L_180 ) ;
if ( ! V_613 ) {
V_613 = F_291 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_178 ) ;
...
V_16 -> V_21 = F_292 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_293 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_181 ) ;
return - V_616 ;
}
V_613 = F_290 ( V_3 , V_617 , L_182 ) ;
if ( ! V_613 ) {
V_613 = F_291 ( V_3 , V_617 , 0 ) ;
if ( ! V_613 ) {
F_44 ( L_178 ) ;
...
V_16 -> V_23 = F_292 ( & V_3 -> V_4 , V_613 -> T_9 ,
F_293 ( V_613 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_183 ) ;
return - V_616 ;
}
V_16 -> V_133 = F_294 ( V_16 -> V_157 , 0 ) ;
if ( V_16 -> V_133 < 0 ) {
F_44 ( L_184 ) ;
return - V_202 ;
}
V_155 = F_295 ( & V_3 -> V_4 , V_16 -> V_133 , F_48 ,
V_623 , F_296 ( & V_3 -> V_4 ) , V_16 -> V_157 ) ;
if ( V_155 < 0 ) {
F_44 ( L_185 ) ;
return V_155 ;
}
...
V_625 = F_297 ( V_628 , V_3 -> V_4 . V_596 ) ;
if ( ! V_625 ) {
F_44 ( L_186 ) ;
return - V_202 ;
}
...
V_155 = F_300 ( V_3 -> V_4 . V_596 , NULL , NULL ,
& V_3 -> V_4 ) ;
if ( V_155 )
F_44 ( L_189 , V_155 ) ;
}
...
static void F_303 ( struct V_608 * V_4 , struct V_608 * V_609 , void * V_26 )
{
struct V_2 * V_3 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
F_304 ( & V_3 -> V_4 ) ;
...
static int F_306 ( struct V_2 * V_157 )
{
return F_307 ( & V_157 -> V_4 , & V_632 ) ;
}
static int F_308 ( struct V_2 * V_157 )
{
F_309 ( & V_157 -> V_4 , & V_632 ) ;
return 0 ;
}
static int F_310 ( struct V_608 * V_4 )
{
...
static int F_314 ( struct V_608 * V_4 )
{
struct V_2 * V_157 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_157 ) ;
int V_155 ;
