...
V_66 -> V_140 = V_142 . V_140 * V_123 / 100 ;
...
{
struct V_1 * V_2 = V_198 + V_15 -> V_138 ;
struct V_65 * V_66 = & V_2 -> V_53 ;
int V_86 ;
V_66 -> V_130 ++ ;
V_66 -> V_15 = V_15 ;
...
static struct V_237 * F_127 ( struct V_234 * V_131 , int * V_138 )
{
* V_138 = 0 ;
return V_209 ;
}
