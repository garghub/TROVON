...
F_32 ( & V_2 -> V_14 , L_33 , V_35 , V_104 ) ;
return F_13 ( V_2 , V_111 , V_104 ) ;
}
static void F_39 ( struct V_1 * V_112 , int V_113 )
{
if ( V_113 )
F_38 ( V_112 , V_108 | V_105 , 0 ) ;
else
F_38 ( V_112 , 0 , V_108 | V_105 ) ;
}
...
| ( ( V_104 & V_119 ) ? V_120 : 0 )
| ( ( V_104 & V_121 ) ? V_122 : 0 ) ;
F_32 ( & V_2 -> V_14 , L_34 , V_35 , V_104 ) ;
return V_11 ;
}
static void F_41 ( struct V_31 * V_32 , int V_123 )
{
struct V_1 * V_2 = V_32 -> V_45 ;
T_4 V_124 ;
if ( V_123 == 0 )
