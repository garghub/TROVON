...
if ( F_100 ( V_5 ) == F_101 () )
F_102 ( F_66 ( V_5 ) ) ;
F_103 ( V_26 -> V_83 . V_86 . V_87 ,
F_104 ( V_26 -> V_83 . V_86 . V_87 , V_82 ) ) ;
V_26 -> V_83 . V_88 += V_82 ;
F_105 ( V_26 , V_82 ) ;
V_26 -> V_83 . V_84 = F_99 ( V_5 ) ;
F_106 ( V_26 , V_82 ) ;
F_107 ( V_5 , V_82 ) ;
V_3 -> V_13 -= V_82 ;
V_85:
if ( F_97 ( V_3 ) || V_3 -> V_59 ) {
V_3 -> V_57 = 1 ;
F_108 ( V_5 , V_26 , 0 ) ;
...
static void F_111 ( struct V_6 * V_6 , T_1 V_45 )
{
struct V_5 * V_5 = F_3 ( V_6 ) ;
if ( V_6 -> V_25 . V_26 == 0 ||
F_65 ( V_45 , V_6 -> V_25 . V_26 ) ) {
V_6 -> V_25 . V_26 = V_45 ;
F_112 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_45 , 1 ) ;
}
}
static void F_113 ( struct V_6 * V_6 , T_1 V_45 )
{
struct V_5 * V_5 = F_3 ( V_6 ) ;
if ( ! V_6 -> V_36 ) {
V_6 -> V_25 . V_26 = 0 ;
V_6 -> V_25 . V_27 = 0 ;
F_112 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , 0 , 0 ) ;
} else {
struct V_8 * V_40 = V_6 -> V_9 ;
struct V_2 * V_39 ;
V_39 = F_34 ( V_40 , struct V_2 , V_8 ) ;
V_6 -> V_25 . V_26 = V_39 -> V_45 ;
F_112 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_39 -> V_45 , 1 ) ;
}
}
static inline void F_111 ( struct V_6 * V_6 , T_1 V_45 ) {}
static inline void F_113 ( struct V_6 * V_6 , T_1 V_45 ) {}
static inline
void F_114 ( struct V_2 * V_3 , struct V_6 * V_6 )
{
...
static inline
void F_117 ( struct V_2 * V_3 , struct V_6 * V_6 )
{
int V_94 = F_1 ( V_3 ) -> V_94 ;
F_64 ( ! F_115 ( V_94 ) ) ;
F_64 ( ! V_6 -> V_36 ) ;
...
{
struct V_1 * V_97 = F_123 ( V_7 ) ;
struct V_2 * V_56 = & V_7 -> V_4 ;
if ( V_97 && V_7 -> V_4 . V_75 && F_115 ( V_97 -> V_98 ) ) {
V_56 = & V_97 -> V_4 ;
} else if ( ! F_115 ( V_7 -> V_98 ) ) {
F_33 ( ! V_7 -> V_4 . V_75 || V_95 != V_76 ) ;
return;
}
if ( V_7 -> V_4 . V_57 && ! ( V_95 & V_76 ) )
return;
F_121 ( & V_7 -> V_4 , V_56 , V_95 ) ;
if ( ! F_124 ( V_5 , V_7 ) && F_30 ( V_7 ) > 1 )
F_32 ( V_5 , V_7 ) ;
}
static void F_108 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_95 )
{
F_122 ( & V_7 -> V_4 ) ;
F_38 ( V_5 , V_7 ) ;
}
static void F_125 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_95 )
{
F_98 ( V_5 ) ;
F_108 ( V_5 , V_7 , V_95 ) ;
}
...
static int
F_128 ( struct V_1 * V_7 , int V_34 , int V_99 , int V_95 )
{
struct V_1 * V_26 ;
struct V_5 * V_5 ;
if ( V_99 != V_100 )
...
{
if ( F_30 ( V_5 -> V_26 ) == 1 ||
F_134 ( & V_5 -> V_31 -> V_93 , V_5 -> V_26 , NULL ) == - 1 )
return;
if ( F_30 ( V_7 ) != 1 &&
F_134 ( & V_5 -> V_31 -> V_93 , V_7 , NULL ) != - 1 )
return;
F_61 ( V_5 ) ;
}
...
struct V_1 *
F_139 ( struct V_5 * V_5 , struct V_1 * V_47 , struct V_103 V_77 )
{
struct V_2 * V_3 ;
struct V_1 * V_7 ;
struct V_6 * V_6 ;
...
static void F_143 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_108 )
{
F_98 ( V_5 ) ;
if ( F_141 ( V_5 ) && V_108 && V_7 -> V_4 . V_13 > 0 &&
F_8 ( V_7 , & V_5 -> V_4 ) )
F_136 ( V_5 , V_7 ) ;
}
...
static int F_131 ( struct V_1 * V_109 )
{
struct V_110 * V_111 ;
struct V_112 * V_113 = F_155 ( V_114 ) ;
int V_115 = F_101 () ;
int V_116 , V_34 = F_147 ( V_109 ) ;
if ( F_89 ( ! V_113 ) )
return - 1 ;
if ( F_30 ( V_109 ) == 1 )
return - 1 ;
V_116 = F_134 ( & F_5 ( V_109 ) -> V_31 -> V_93 ,
V_109 , V_113 ) ;
if ( V_116 == - 1 )
return - 1 ;
if ( F_153 ( V_34 , V_113 ) )
return V_34 ;
if ( ! F_153 ( V_115 , V_113 ) )
V_115 = - 1 ;
F_129 () ;
F_156 (cpu, sd) {
if ( V_111 -> V_95 & V_117 ) {
if ( V_115 != - 1 &&
F_153 ( V_115 , F_157 ( V_111 ) ) ) {
F_132 () ;
return V_115 ;
}
if ( V_116 < V_55 &&
F_153 ( V_116 , F_157 ( V_111 ) ) ) {
F_132 () ;
return V_116 ;
}
}
...
static struct V_1 * F_158 ( struct V_5 * V_5 )
{
struct V_1 * V_7 ;
if ( ! F_42 ( V_5 ) )
return NULL ;
...
struct V_1 * V_109 ;
V_109 = F_158 ( V_5 ) ;
if ( F_147 ( V_120 ) == V_5 -> V_34 && V_109 == V_120 ) {
goto V_101;
}
if ( ! V_109 )
goto V_101;
...
static void F_162 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
if ( ! F_152 ( V_5 , V_7 ) &&
! F_135 ( V_5 -> V_26 ) &&
F_30 ( V_7 ) > 1 &&
...
V_5 = F_5 ( V_7 ) ;
V_131 = V_5 -> V_31 ;
if ( ! F_164 ( V_131 -> V_132 , V_129 ) ) {
struct V_17 * V_133 ;
V_133 = F_146 ( F_100 ( V_5 ) ) ;
F_12 ( & V_133 -> V_18 ) ;
F_165 ( V_133 , V_7 -> V_4 . V_17 ) ;
F_16 ( & V_133 -> V_18 ) ;
}
F_166 ( V_7 , V_129 ) ;
}
...
if ( V_5 -> V_4 . V_36 > 0 )
F_112 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_5 -> V_4 . V_25 . V_26 , 1 ) ;
}
...
void F_178 ( struct V_137 * V_138 , int V_34 )
{
F_179 ( V_138 , V_34 , & F_56 ( V_34 ) -> V_4 ) ;
}
