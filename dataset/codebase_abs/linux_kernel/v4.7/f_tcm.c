...
static void F_89 ( struct V_231 * V_232 )
{
}
...
static const char * F_93 ( const char * V_233 )
{
const char * V_234 ;
unsigned int V_115 ;
...
static int F_94 ( struct V_231 * V_236 , const char * V_233 )
{
if ( ! F_93 ( V_233 ) )
return - V_57 ;
return 0 ;
}
static struct V_226 * F_95 (
struct V_237 * V_238 ,
struct V_239 * V_240 ,
const char * V_233 )
{
...
return F_70 ( - V_57 ) ;
if ( F_96 ( V_233 + 5 , 0 , & V_242 ) || V_242 > V_245 )
return F_70 ( - V_57 ) ;
V_6 = - V_220 ;
F_97 ( & V_246 ) ;
...
F_101 ( & V_93 -> V_259 ) ;
F_102 ( & V_93 -> V_94 , 0 ) ;
V_93 -> V_215 = F_103 ( L_22 , 0 , 1 ) ;
if ( ! V_93 -> V_215 )
goto V_260;
V_93 -> V_228 = V_228 ;
V_93 -> V_230 = V_242 ;
V_6 = F_104 ( V_238 , & V_93 -> V_188 , V_261 ) ;
if ( V_6 < 0 )
goto V_262;
...
static void F_109 ( struct V_226 * V_188 )
{
struct V_181 * V_93 = F_2 ( V_188 ,
struct V_181 , V_188 ) ;
unsigned V_104 ;
...
if ( ! V_266 )
return F_70 ( - V_57 ) ;
V_228 = F_100 ( sizeof( struct V_227 ) , V_39 ) ;
if ( ! ( V_228 ) )
return F_70 ( - V_51 ) ;
V_228 -> V_268 = V_267 ;
...
static void F_113 ( struct V_237 * V_238 )
{
struct V_227 * V_228 = F_2 ( V_238 ,
struct V_227 , V_241 ) ;
F_28 ( V_228 ) ;
}
static T_5 F_114 ( struct V_269 * V_270 , char * V_271 )
{
return sprintf ( V_271 , L_24 ) ;
}
static T_5 F_115 ( struct V_269 * V_270 , char * V_271 )
{
struct V_226 * V_188 = F_116 ( V_270 ) ;
struct V_181 * V_93 = F_2 ( V_188 , struct V_181 , V_188 ) ;
return snprintf ( V_271 , V_272 , L_25 , V_93 -> V_273 ) ;
}
static T_5 F_117 ( struct V_269 * V_270 ,
...
static T_5 F_121 ( struct V_269 * V_270 , char * V_271 )
{
struct V_226 * V_188 = F_116 ( V_270 ) ;
struct V_181 * V_93 = F_2 ( V_188 , struct V_181 , V_188 ) ;
struct V_179 * V_180 ;
...
static int F_122 ( struct V_226 * V_188 ,
...
static int F_123 ( struct V_181 * V_93 , char * V_233 )
{
struct V_179 * V_180 ;
int V_6 = 0 ;
F_97 ( & V_93 -> V_259 ) ;
...
static T_5 F_130 ( struct V_269 * V_270 ,
const char * V_271 , T_6 V_274 )
{
struct V_226 * V_188 = F_116 ( V_270 ) ;
struct V_181 * V_93 = F_2 ( V_188 , struct V_181 , V_188 ) ;
...
V_6 = F_123 ( V_93 , & V_283 [ 0 ] ) ;
if ( V_6 < 0 )
return V_6 ;
return V_274 ;
}
static int F_132 ( struct V_226 * V_188 , struct V_285 * V_214 )
{
struct V_181 * V_93 = F_2 ( V_188 , struct V_181 , V_188 ) ;
F_133 ( & V_93 -> V_94 ) ;
F_134 () ;
...
static void F_135 ( struct V_226 * V_188 ,
struct V_285 * V_285 )
{
struct V_181 * V_93 = F_2 ( V_188 , struct V_181 , V_188 ) ;
F_136 ( & V_93 -> V_94 ) ;
...
static int F_139 ( struct V_286 * V_287 , struct V_2 * V_3 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
struct V_288 * V_289 ;
...
F_105 ( & V_244 -> V_251 ) ;
V_289 = F_140 ( V_287 -> V_72 , V_292 ,
F_141 ( V_293 ) ) ;
if ( F_72 ( V_289 ) )
return F_127 ( V_289 ) ;
V_294 . V_295 = V_289 [ V_296 ] . V_297 ;
V_298 . V_295 = V_289 [ V_299 ] . V_297 ;
V_290 = F_142 ( V_287 , V_3 ) ;
if ( V_290 < 0 )
return V_290 ;
V_294 . V_300 = V_290 ;
V_298 . V_300 = V_290 ;
V_5 -> V_290 = V_290 ;
V_14 = F_143 ( V_46 , & V_301 ,
& V_302 ) ;
if ( ! V_14 )
goto V_303;
V_5 -> V_29 = V_14 ;
V_14 = F_143 ( V_46 , & V_304 ,
& V_305 ) ;
if ( ! V_14 )
goto V_303;
V_5 -> V_9 = V_14 ;
V_14 = F_143 ( V_46 , & V_306 ,
& V_307 ) ;
if ( ! V_14 )
goto V_303;
V_5 -> V_101 = V_14 ;
V_14 = F_143 ( V_46 , & V_308 ,
& V_309 ) ;
if ( ! V_14 )
goto V_303;
V_5 -> V_103 = V_14 ;
...
static void F_145 ( struct V_177 * V_322 )
{
...
static int F_147 ( struct V_2 * V_3 , unsigned V_327 , unsigned V_324 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
...
static inline struct V_243 * F_151 ( struct V_269 * V_270 )
{
return F_2 ( F_152 ( V_270 ) , struct V_243 ,
V_249 . V_240 ) ;
}
static void F_153 ( struct V_269 * V_270 )
{
struct V_243 * V_244 = F_151 ( V_270 ) ;
F_154 ( & V_244 -> V_249 ) ;
}
static void F_155 ( struct V_330 * V_3 )
{
struct V_243 * V_244 ;
unsigned V_104 ;
...
static int F_156 ( struct V_330 * V_3 )
{
...
static int F_159 ( struct V_330 * V_3 , const char * V_233 )
{
struct V_243 * V_244 = F_2 ( V_3 , struct V_243 , V_249 ) ;
F_124 ( L_32 , V_233 ) ;
F_97 ( & V_244 -> V_251 ) ;
...
static struct V_330 * F_160 ( void )
{
struct V_243 * V_244 ;
int V_104 ;
V_244 = F_100 ( sizeof( * V_244 ) , V_39 ) ;
if ( ! V_244 )
return F_70 ( - V_51 ) ;
F_97 ( & V_246 ) ;
for ( V_104 = 0 ; V_104 < V_247 ; ++ V_104 )
...
F_105 ( & V_246 ) ;
F_101 ( & V_244 -> V_251 ) ;
V_244 -> V_249 . V_333 = F_159 ;
V_244 -> V_249 . V_334 = F_155 ;
V_244 -> F_156 = F_156 ;
V_244 -> F_157 = F_157 ;
F_161 ( & V_244 -> V_249 . V_240 , L_33 ,
& V_335 ) ;
return & V_244 -> V_249 ;
}
...
static void F_163 ( struct V_286 * V_287 , struct V_2 * V_3 )
{
F_164 ( V_3 ) ;
}
static struct V_2 * F_165 ( struct V_330 * V_263 )
{
struct V_1 * V_5 ;
unsigned V_104 ;
F_97 ( & V_246 ) ;
