...
static int F_41 ( struct V_1 * V_2 , int V_27 )
{
if ( ! V_27 ) {
F_30 ( 0 ) ;
F_20 ( 0 ) ;
...
static void F_42 ( unsigned char V_28 , unsigned short V_29 )
{
switch ( V_28 ) {
case V_30 :
F_12 ( F_9 ( 1 ) , 0 ) ;
...
{
F_66 ( 0x30003000 , 0x1000 ) ;
F_66 ( 0x30081000 , 0x1000 ) ;
}
