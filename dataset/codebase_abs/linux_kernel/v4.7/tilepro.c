...
static int F_144 ( struct V_56 * V_39 , int V_255 )
{
F_74 ( L_39 ) ;
if ( ( V_255 < 68 ) || ( V_255 > 1500 ) )
return - V_256 ;
V_39 -> V_257 = V_255 ;
return 0 ;
}
static int F_145 ( struct V_56 * V_39 , void * V_258 )
{
struct V_259 * V_260 = V_258 ;
if ( ! F_146 ( V_260 -> V_261 ) )
return - V_262 ;
memcpy ( V_39 -> V_97 , V_260 -> V_261 , V_39 -> V_263 ) ;
return 0 ;
}
static int F_147 ( struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
char V_264 [ 32 ] ;
int V_3 ;
T_18 V_265 = { . V_79 = V_266 } ;
int V_115 ;
strcpy ( V_264 , V_39 -> V_137 ) ;
V_3 = strlen ( V_264 ) ;
V_264 [ V_3 ] = V_264 [ V_3 - 1 ] ;
V_264 [ V_3 - 1 ] = '/' ;
V_3 ++ ;
strcpy ( V_264 + V_3 , V_41 ? L_40 : L_41 ) ;
V_59 -> V_118 = F_148 ( ( V_119 ) V_264 , 0 ) ;
F_74 ( L_42 ,
V_264 , V_59 -> V_118 , & V_59 -> V_118 ) ;
if ( V_59 -> V_118 < 0 ) {
if ( V_59 -> V_118 == V_267 )
F_79 ( V_145 L_43 ,
V_264 ) ;
...
V_265 . V_238 . V_268 = V_269 ;
V_265 . V_238 . V_260 = V_270 ;
V_115 = F_63 ( V_59 -> V_118 , 0 ,
( V_119 ) V_39 -> V_97 , V_39 -> V_263 ,
V_265 . V_79 ) ;
F_74 ( L_45 , V_115 ) ;
if ( V_115 <= 0 ) {
F_79 ( V_145 L_46 ,
...
static void F_151 ( struct V_56 * V_39 )
{
T_19 V_271 = 0 ;
F_152 ( V_39 ) ;
V_39 -> V_272 = & V_273 ;
...
static struct V_56 * F_153 ( const char * V_137 )
{
int V_115 ;
struct V_56 * V_39 ;
struct V_58 * V_59 ;
V_39 = F_154 ( sizeof( * V_59 ) , V_137 , V_284 ,
F_151 ) ;
if ( ! V_39 ) {
F_64 ( L_47 , V_137 ) ;
return NULL ;
...
V_59 -> V_39 = V_39 ;
F_155 ( & V_59 -> V_165 , F_100 ) ;
F_156 ( & V_59 -> V_63 ) ;
V_59 -> V_123 = F_157 ( V_285 | V_286 , V_124 ) ;
if ( ! V_59 -> V_123 ) {
F_158 ( V_39 ) ;
return NULL ;
}
V_59 -> V_49 = F_159 ( V_59 -> V_123 ) ;
V_115 = F_160 ( V_39 ) ;
if ( V_115 ) {
F_64 ( L_48 , V_39 -> V_137 , V_115 ) ;
F_161 ( V_59 -> V_123 , V_124 ) ;
F_158 ( V_39 ) ;
return NULL ;
}
V_115 = F_147 ( V_39 ) ;
...
{
int V_2 ;
for ( V_2 = 0 ; V_2 < V_287 ; V_2 ++ ) {
if ( V_288 [ V_2 ] ) {
struct V_56 * V_39 = V_288 [ V_2 ] ;
struct V_58 * V_59 = F_30 ( V_39 ) ;
F_162 ( V_39 ) ;
...
static int T_20 F_165 ( char * V_289 )
{
int V_290 = F_166 ( V_289 , & V_132 ) ;
if ( V_290 != 0 ) {
F_71 ( L_50 , V_289 ) ;
} else {
F_167 ( & V_132 , & V_132 ,
