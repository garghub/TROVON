...
if ( F_47 ( V_64 -> V_22 . V_50 , L_18 ) )
V_16 -> V_37 = F_48 ( V_16 -> V_22 , V_47 -> V_19 , V_26 ) ;
else
V_16 -> V_37 = F_49 ( V_16 -> V_22 , V_47 -> V_19 , V_26 ) ;
if ( ! V_16 -> V_37 )
return - V_29 ;
