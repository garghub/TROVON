...
static int F_15 ( struct V_49 * V_32 ,
struct V_16 * * V_50 )
{
struct V_16 * V_17 ;
struct V_51 * V_27 ;
...
if ( ! V_27 )
return - V_29 ;
V_17 = F_17 ( V_32 , sizeof( * V_17 ) , V_55 ) ;
if ( ! V_17 )
return - V_56 ;
V_17 -> V_32 = V_32 ;
V_17 -> V_27 = V_27 ;
...
if ( V_14 )
return V_14 ;
V_19 = F_19 ( V_27 -> V_28 , L_5 , NULL , & V_52 ) ;
if ( F_9 ( V_19 ) ) {
V_15 = F_1 () ;
if ( V_15 > 0 )
V_54 = & V_59 ;
}
V_17 -> V_48 = F_20 ( V_27 , V_54 ) ;
if ( F_21 ( V_17 -> V_48 ) ) {
V_14 = F_22 ( V_17 -> V_48 ) ;
goto V_60;
} else
V_14 = 0 ;
V_14 = F_23 ( V_27 -> V_28 , V_61 ,
F_13 ,
( void * ) V_17 ) ;
if ( V_14 )
goto V_62;
...
static T_4 F_32 ( int V_68 , void * V_69 )
{
struct V_16 * V_17 ;
struct V_70 * V_64 = V_69 ;
V_17 = F_33 ( V_64 ) ;
F_34 ( V_17 -> V_71 ) ;
return V_72 ;
}
static int F_35 ( struct V_70 * V_64 ,
...
V_17 -> V_71 = F_39 (
V_76 , 2 , 0 ) ;
if ( V_17 -> V_71 && V_64 -> V_68 ) {
V_14 = F_40 ( V_64 ) ;
if ( ! V_14 ) {
V_14 = F_41 ( V_64 -> V_68 , NULL ,
F_32 ,
V_77 , L_9 ,
V_64 ) ;
if ( V_14 ) {
...
static void F_44 ( struct V_70 * V_64 )
{
struct V_16 * V_17 = F_33 ( V_64 ) ;
if ( V_17 -> V_71 ) {
F_42 ( V_17 -> V_71 ) ;
if ( V_64 -> V_68 ) {
F_45 ( V_64 -> V_68 , V_64 ) ;
