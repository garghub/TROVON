...
F_5 ( V_10 , 0x61c10c + V_18 , 0x001f4000 , V_19 ) ;
return 0 ;
}
int
F_7 ( struct V_1 * V_2 ,
...
if ( ! V_28 )
return - V_40 ;
V_29 [ 0 ] = F_11 ( V_10 , 0x61c118 + V_18 ) & ~ ( 0x000000ff << V_27 ) ;
V_29 [ 1 ] = F_11 ( V_10 , 0x61c120 + V_18 ) & ~ ( 0x000000ff << V_27 ) ;
V_29 [ 2 ] = F_11 ( V_10 , 0x61c130 + V_18 ) ;
if ( ( V_29 [ 2 ] & 0x0000ff00 ) < ( V_36 . V_41 << 8 ) || V_21 == 0 )
V_29 [ 2 ] = ( V_29 [ 2 ] & ~ 0x0000ff00 ) | ( V_36 . V_41 << 8 ) ;
F_12 ( V_10 , 0x61c118 + V_18 , V_29 [ 0 ] | ( V_36 . V_42 << V_27 ) ) ;
F_12 ( V_10 , 0x61c120 + V_18 , V_29 [ 1 ] | ( V_36 . V_23 << V_27 ) ) ;
F_12 ( V_10 , 0x61c130 + V_18 , V_29 [ 2 ] ) ;
V_29 [ 3 ] = F_11 ( V_10 , 0x61c13c + V_18 ) & ~ ( 0x000000ff << V_27 ) ;
F_12 ( V_10 , 0x61c13c + V_18 , V_29 [ 3 ] | ( V_36 . V_24 << V_27 ) ) ;
return 0 ;
}
int
