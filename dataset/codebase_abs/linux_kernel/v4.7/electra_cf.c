...
F_23 ( V_46 , V_2 ) ;
if ( ! V_2 -> V_63 || ! V_2 -> V_68 || ! V_2 -> V_4 ||
( F_24 ( V_36 . V_61 , V_2 -> V_68 , V_2 -> V_64 ,
F_25 ( F_26 ( F_27 ( 0 ) ) ) ) == NULL ) ) {
F_28 ( V_46 , L_2 ) ;
V_53 = - V_59 ;
goto V_67;
}
V_2 -> V_71 = ( unsigned long ) V_2 -> V_68 - V_72 ;
V_2 -> V_73 . V_61 = ( unsigned long ) V_2 -> V_63 ;
V_2 -> V_73 . V_74 = ( unsigned long ) V_2 -> V_63 + ( V_52 . V_74 - V_52 . V_61 ) ;
V_2 -> V_73 . V_27 = V_75 ;
V_2 -> V_16 = F_29 ( V_49 , 0 ) ;
V_53 = F_30 ( V_2 -> V_16 , F_7 , V_76 ,
V_32 , V_2 ) ;
if ( V_53 < 0 ) {
F_28 ( V_46 , L_3 ) ;
goto V_67;
...
goto V_67;
V_2 -> V_31 = * V_54 ;
V_2 -> V_10 . V_78 = V_2 -> V_71 ;
if ( ! F_32 ( V_2 -> V_41 , V_2 -> V_62 , V_32 ) ) {
V_53 = - V_79 ;
F_28 ( V_46 , L_8 ) ;
goto V_67;
}
if ( ! F_33 ( V_2 -> V_71 , V_2 -> V_64 , V_32 ) ) {
V_53 = - V_79 ;
F_28 ( V_46 , L_9 ) ;
goto V_80;
}
V_2 -> V_10 . V_81 = V_82 ;
V_2 -> V_10 . V_47 . V_83 = & V_45 -> V_47 ;
V_2 -> V_10 . V_84 = & V_85 ;
V_2 -> V_10 . V_86 = & V_87 ;
V_2 -> V_10 . V_88 = V_89 | V_90 |
V_91 ;
V_2 -> V_10 . V_92 = 0x800 ;
V_53 = F_34 ( & V_2 -> V_10 ) ;
if ( V_53 < 0 ) {
...
return 0 ;
V_93:
F_36 ( V_2 -> V_71 , V_2 -> V_64 ) ;
V_80:
F_37 ( V_2 -> V_41 , V_2 -> V_62 ) ;
V_67:
if ( V_2 -> V_16 != V_60 )
F_38 ( V_2 -> V_16 , V_2 ) ;
if ( V_2 -> V_68 )
F_39 ( V_2 -> V_68 , V_2 -> V_64 ) ;
if ( V_2 -> V_63 )
F_40 ( V_2 -> V_63 ) ;
if ( V_2 -> V_4 )
F_40 ( V_2 -> V_4 ) ;
