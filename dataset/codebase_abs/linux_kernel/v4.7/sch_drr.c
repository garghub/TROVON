...
goto V_87;
while ( 1 ) {
V_11 = F_65 ( & V_6 -> V_86 , struct V_1 , V_47 ) ;
V_49 = V_11 -> V_13 -> V_88 -> V_89 ( V_11 -> V_13 ) ;
if ( V_49 == NULL ) {
F_66 ( V_90 , V_11 -> V_13 ) ;
goto V_87;
}
...
V_11 -> V_64 += V_11 -> V_25 ;
F_72 ( & V_11 -> V_47 , & V_6 -> V_86 ) ;
}
V_87:
return NULL ;
}
static unsigned int F_73 ( struct V_2 * V_3 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_1 * V_11 ;
unsigned int V_12 ;
F_74 (cl, &q->active, alist) {
if ( V_11 -> V_13 -> V_88 -> V_91 ) {
V_12 = V_11 -> V_13 -> V_88 -> V_91 ( V_11 -> V_13 ) ;
if ( V_12 > 0 ) {
V_3 -> V_16 . V_15 -= V_12 ;
V_3 -> V_6 . V_14 -- ;
if ( V_11 -> V_13 -> V_6 . V_14 == 0 )
...
static int F_75 ( struct V_2 * V_3 , struct V_18 * V_21 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
int V_26 ;
V_26 = F_76 ( & V_6 -> V_9 ) ;
