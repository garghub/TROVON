...
{
struct V_20 * V_40 ;
struct V_20 * V_55 = NULL ;
struct V_29 * V_30 ;
V_30 = & V_5 -> V_8 ;
F_37 (flde, head, fce_list) {
...
struct V_20
* F_38 ( struct V_1 * V_5 , struct V_26 * V_44 )
{
struct V_20 * V_55 = NULL ;
F_39 ( & V_5 -> V_11 ) ;
V_55 = F_36 ( V_5 , V_44 ) ;
...
const T_2 V_56 , struct V_26 * V_44 )
{
struct V_20 * V_40 ;
...
V_5 -> V_15 . V_18 ++ ;
F_37 (flde, head, fce_list) {
if ( V_40 -> V_32 . V_34 > V_56 ) {
if ( V_43 )
* V_44 = V_43 -> V_32 ;
break;
}
V_43 = V_40 ;
if ( F_42 ( & V_40 -> V_32 , V_56 ) ) {
* V_44 = V_40 -> V_32 ;
V_5 -> V_15 . V_19 ++ ;
F_40 ( & V_5 -> V_11 ) ;
return 0 ;
