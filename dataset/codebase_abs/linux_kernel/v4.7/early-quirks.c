...
static void T_1 F_49 ( int V_80 , int V_2 , int V_3 )
{
void T_6 * V_81 ;
T_4 V_82 ;
T_7 V_83 ;
...
if ( ! F_50 ( V_84 , L_19 ) )
return;
V_82 = F_21 ( V_80 , V_2 , V_3 , V_85 + V_86 ) ;
if ( ( V_82 & V_87 ) != V_88 ) {
V_82 &= ~ V_87 ;
F_51 ( V_80 , V_2 , V_3 , V_85 + V_86 , V_82 ) ;
F_52 ( 10 ) ;
V_82 = F_21 ( V_80 , V_2 , V_3 , V_85 + V_86 ) ;
if ( ( V_82 & V_87 ) != V_88 ) {
F_53 ( L_20 ) ;
...
V_83 = F_2 ( V_80 , V_2 , V_3 , V_89 ) ;
V_83 |= ( T_7 ) F_2 ( V_80 , V_2 , V_3 , V_90 ) << 32 ;
V_83 &= V_91 ;
V_81 = F_54 ( V_83 , V_92 ) ;
if ( ! V_81 ) {
F_53 ( L_21 ) ;
...
F_48 ( L_22 ) ;
for ( V_65 = 0 ; F_55 ( V_93 ) && V_65 < 30 ; V_65 ++ )
F_56 ( 10 ) ;
F_57 ( V_94 , V_95 ) ;
F_55 ( V_94 ) ;
F_56 ( 1 ) ;
...
static int T_1 F_59 ( int V_1 , int V_2 , int V_3 )
{
T_4 V_96 ;
T_4 V_97 ;
T_4 V_21 ;
...
T_3 V_98 ;
int V_65 ;
V_96 = F_21 ( V_1 , V_2 , V_3 , V_99 ) ;
if ( V_96 == 0xffff )
return - 1 ;
V_97 = F_21 ( V_1 , V_2 , V_3 , V_100 ) ;
V_21 = F_21 ( V_1 , V_2 , V_3 , V_22 ) ;
for ( V_65 = 0 ; V_101 [ V_65 ] . V_102 != NULL ; V_65 ++ ) {
if ( ( ( V_101 [ V_65 ] . V_97 == V_103 ) ||
( V_101 [ V_65 ] . V_97 == V_97 ) ) &&
( ( V_101 [ V_65 ] . V_21 == V_103 ) ||
( V_101 [ V_65 ] . V_21 == V_21 ) ) &&
( ! ( ( V_101 [ V_65 ] . V_96 ^ V_96 ) &
V_101 [ V_65 ] . V_104 ) ) ) {
if ( ( V_101 [ V_65 ] . V_105 &
V_106 ) != V_106 )
V_101 [ V_65 ] . V_102 ( V_1 , V_2 , V_3 ) ;
V_101 [ V_65 ] . V_105 |= V_107 ;
}
}
type = F_13 ( V_1 , V_2 , V_3 ,
V_108 ) ;
if ( ( type & 0x7f ) == V_109 ) {
V_98 = F_13 ( V_1 , V_2 , V_3 , V_110 ) ;
if ( V_98 > V_1 )
F_60 ( V_98 ) ;
}
if ( ! ( type & 0x80 ) )
...
static void T_1 F_60 ( int V_80 )
{
int V_2 , V_3 ;
for ( V_2 = 0 ; V_2 < 32 ; V_2 ++ )
for ( V_3 = 0 ; V_3 < 8 ; V_3 ++ ) {
if ( F_59 ( V_80 , V_2 , V_3 ) )
break;
}
}
void T_1 F_61 ( void )
