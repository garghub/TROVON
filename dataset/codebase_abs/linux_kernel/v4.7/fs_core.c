...
F_9 ( & V_50 -> V_2 , V_158 ) ;
F_96 (g, ft)
if ( F_28 ( V_157 -> V_18 . V_27 ,
V_27 ,
V_157 -> V_18 . V_34 ,
V_34 ) ) {
V_54 = F_99 ( V_157 , V_59 ,
V_67 , V_76 , V_105 ) ;
if ( ! F_84 ( V_54 ) || F_105 ( V_54 ) != - V_118 )
goto V_159;
}
V_157 = F_95 ( V_50 , V_27 , V_34 ) ;
if ( F_84 ( V_157 ) ) {
V_54 = ( void * ) V_157 ;
goto V_159;
}
...
{
return ( ( V_50 -> type == V_160 ) &&
( F_74 ( F_33 ( & V_50 -> V_2 ) , V_161 ) ) ) ;
}
struct V_53 *
...
V_54 = F_104 ( V_50 , V_27 , V_34 ,
V_59 , V_67 , V_76 , V_105 ) ;
if ( V_63 == V_64 ) {
if ( ! F_108 ( V_54 ) &&
( F_73 ( & V_54 -> V_66 ) ) ) {
F_12 ( & V_66 -> V_6 ) ;
...
enum V_165 type )
{
struct V_45 * V_166 = V_48 -> V_167 . V_166 ;
int V_16 ;
struct V_13 * V_13 ;
struct V_14 * V_15 ;
if ( ! V_166 )
...
case V_172 :
if ( V_48 -> V_167 . V_173 )
return & V_48 -> V_167 . V_173 -> V_15 ;
else
return NULL ;
case V_174 :
if ( V_48 -> V_167 . V_175 )
return & V_48 -> V_167 . V_175 -> V_15 ;
else
return NULL ;
case V_176 :
if ( V_48 -> V_167 . V_177 )
return & V_48 -> V_167 . V_177 -> V_15 ;
else
return NULL ;
default:
return NULL ;
}
V_13 = F_22 ( & V_166 -> V_15 , V_16 ) ;
if ( ! V_13 )
return NULL ;
...
struct V_13 * V_13 ;
int V_22 ;
for ( V_22 = 0 ; V_22 < V_180 -> V_181 ; V_22 ++ ) {
V_13 = F_120 ( V_15 , V_16 ++ , V_180 -> V_117 ) ;
if ( F_84 ( V_13 ) )
return F_105 ( V_13 ) ;
}
return 0 ;
}
static bool F_124 ( struct V_47 * V_48 , struct V_182 * V_183 )
{
int V_22 ;
for ( V_22 = 0 ; V_22 < V_183 -> V_184 ; V_22 ++ ) {
if ( ! F_125 ( V_48 , V_183 -> V_183 [ V_22 ] ) )
return false ;
}
return true ;
}
static int F_126 ( struct V_47 * V_48 ,
struct V_179 * V_185 ,
struct V_1 * V_186 ,
struct V_179 * V_187 ,
int V_16 )
...
int V_51 ;
if ( V_185 -> type == V_178 ) {
if ( ( V_185 -> V_191 > V_188 ) ||
! F_124 ( V_48 , & V_185 -> V_183 ) )
return 0 ;
F_35 ( V_189 , V_186 ) ;
if ( V_185 -> V_181 )
return F_123 ( V_189 , V_16 , V_185 ) ;
V_13 = F_120 ( V_189 , V_16 , V_185 -> V_117 ) ;
if ( F_84 ( V_13 ) )
return F_105 ( V_13 ) ;
V_190 = & V_13 -> V_2 ;
} else if ( V_185 -> type == V_46 ) {
F_35 ( V_13 , V_186 ) ;
V_189 = F_122 ( V_13 ) ;
if ( F_84 ( V_189 ) )
return F_105 ( V_189 ) ;
...
V_16 = 0 ;
for ( V_22 = 0 ; V_22 < V_185 -> V_192 ; V_22 ++ ) {
V_51 = F_126 ( V_48 , & V_185 -> V_5 [ V_22 ] ,
V_190 , V_185 , V_16 ) ;
if ( V_51 )
return V_51 ;
if ( V_185 -> V_5 [ V_22 ] . type == V_178 &&
V_185 -> V_5 [ V_22 ] . V_181 ) {
V_16 += V_185 -> V_5 [ V_22 ] . V_181 ;
}
}
return 0 ;
}
static int F_127 ( struct V_47 * V_48 ,
struct V_179 * V_185 ,
struct V_1 * V_186 )
{
int V_22 ;
...
static struct V_45 * F_128 ( struct V_47 * V_48 ,
enum V_90
V_91 )
{
struct V_45 * V_166 ;
struct V_14 * V_15 ;
V_166 = F_38 ( sizeof( * V_166 ) ) ;
if ( ! V_166 )
return NULL ;
V_166 -> V_48 = V_48 ;
V_166 -> V_91 = V_91 ;
...
static int F_129 ( struct V_14 * V_15 , int V_193 )
{
struct V_13 * V_16 ;
F_23 (prio, ns) {
F_130 ( V_16 , V_193 ) ;
...
static void F_130 ( struct V_13 * V_16 , int V_193 )
{
struct V_14 * V_15 ;
int V_194 = V_193 ;
V_16 -> V_119 = V_193 ;
F_131 (ns, prio)
V_194 = F_129 ( V_15 , V_193 ) ;
if ( ! V_16 -> V_117 )
V_16 -> V_117 = V_194 - V_16 -> V_119 ;
F_30 ( V_16 -> V_117 < V_194 - V_16 -> V_119 ) ;
}
static void F_132 ( struct V_45 * V_166 )
{
struct V_14 * V_15 = & V_166 -> V_15 ;
struct V_13 * V_16 ;
int V_119 = 0 ;
F_23 (prio, ns) {
F_130 ( V_16 , V_119 ) ;
...
static int F_133 ( struct V_47
* V_48 )
{
struct V_14 * V_15 = NULL ;
struct V_49 * V_50 ;
V_15 = F_118 ( V_48 , V_171 ) ;
if ( ! V_15 )
return - V_106 ;
V_50 = F_81 ( V_15 , V_195 , V_196 , V_197 ) ;
if ( F_84 ( V_50 ) ) {
F_134 ( V_48 , L_14 ) ;
return F_105 ( V_50 ) ;
}
...
{
V_48 -> V_167 . V_166 = F_128 ( V_48 , V_160 ) ;
if ( F_108 ( V_48 -> V_167 . V_166 ) )
goto V_198;
if ( F_127 ( V_48 , & V_199 , & V_48 -> V_167 . V_166 -> V_15 . V_2 ) )
goto V_198;
F_132 ( V_48 -> V_167 . V_166 ) ;
if ( F_133 ( V_48 ) )
goto V_198;
return 0 ;
V_198:
...
static void F_137 ( struct V_47 * V_48 ,
struct V_45 * V_166 )
{
struct V_1 * V_16 ;
if ( ! V_166 )
return;
if ( ! F_73 ( & V_166 -> V_15 . V_2 . V_5 ) ) {
V_16 = F_115 ( & V_166 -> V_15 . V_2 . V_5 ,
struct V_1 ,
V_4 ) ;
if ( F_20 ( V_16 ) )
F_63 ( V_48 ,
...
if ( F_20 ( & V_166 -> V_15 . V_2 ) )
F_63 ( V_48 ,
L_16 ) ;
V_166 = NULL ;
}
static void F_138 ( struct V_13 * V_16 )
{
struct V_49 * V_97 ;
struct V_49 * V_200 ;
F_139 (iter, tmp, prio)
...
static void F_140 ( struct V_47 * V_48 )
{
struct V_45 * V_166 = V_48 -> V_167 . V_166 ;
struct V_13 * V_17 ;
if ( ! F_141 ( V_48 , V_201 ) )
...
struct V_1 * V_2 ;
struct V_14 * V_202 ;
F_142 (node, iter_prio) {
if ( V_2 -> type == V_92 )
continue;
F_35 ( V_202 , V_2 ) ;
while ( ! F_73 ( & V_202 -> V_2 . V_5 ) ) {
struct V_13 * V_203 ;
struct V_1 * V_204 =
F_115 ( & V_202 -> V_2 . V_5 ,
struct V_1 ,
...
while ( ! F_73 ( & V_166 -> V_15 . V_2 . V_5 ) ) {
struct V_13 * V_205 ;
struct V_1 * V_206 =
F_115 ( & V_166 -> V_15 . V_2 . V_5 ,
struct V_1 ,
V_4 ) ;
F_35 ( V_205 , V_206 ) ;
if ( F_20 ( V_206 ) ) {
...
V_48 -> V_167 . V_166 = NULL ;
}
void F_136 ( struct V_47 * V_48 )
{
if ( F_141 ( V_48 , V_207 ) != V_208 )
return;
F_140 ( V_48 ) ;
F_137 ( V_48 , V_48 -> V_167 . V_173 ) ;
F_137 ( V_48 , V_48 -> V_167 . V_175 ) ;
F_137 ( V_48 , V_48 -> V_167 . V_177 ) ;
F_143 ( V_48 ) ;
}
static int F_144 ( struct V_47 * V_48 )
{
struct V_13 * V_16 ;
V_48 -> V_167 . V_173 = F_128 ( V_48 , V_209 ) ;
if ( ! V_48 -> V_167 . V_173 )
return - V_78 ;
V_16 = F_120 ( & V_48 -> V_167 . V_173 -> V_15 , 0 , 1 ) ;
if ( F_84 ( V_16 ) ) {
F_137 ( V_48 , V_48 -> V_167 . V_173 ) ;
return F_105 ( V_16 ) ;
} else {
...
{
struct V_13 * V_16 ;
V_48 -> V_167 . V_175 = F_128 ( V_48 , V_210 ) ;
if ( ! V_48 -> V_167 . V_175 )
return - V_78 ;
V_16 = F_120 ( & V_48 -> V_167 . V_175 -> V_15 , 0 , F_146 ( V_48 ) ) ;
if ( F_84 ( V_16 ) )
return F_105 ( V_16 ) ;
else
return 0 ;
...
{
struct V_13 * V_16 ;
V_48 -> V_167 . V_177 = F_128 ( V_48 , V_211 ) ;
if ( ! V_48 -> V_167 . V_177 )
return - V_78 ;
V_16 = F_120 ( & V_48 -> V_167 . V_177 -> V_15 , 0 , F_146 ( V_48 ) ) ;
if ( F_84 ( V_16 ) )
return F_105 ( V_16 ) ;
else
return 0 ;
}
int F_148 ( struct V_47 * V_48 )
{
int V_51 = 0 ;
if ( F_141 ( V_48 , V_207 ) != V_208 )
return 0 ;
