...
V_153 -> V_450 = F_4 ( V_153 -> V_40 * sizeof( struct V_451 ) , V_362 ) ;
if ( ! V_153 -> V_450 ) {
...
{
struct V_341 * V_452 ;
V_452 = F_4 ( sizeof( * V_452 ) , V_362 | V_453 ) ;
if( ! V_452 ) {
F_9 (KERN_ERR DEV_LABEL L_102 ) ;
goto V_454;
}
V_153 -> V_450 [ V_32 ] . V_452 = V_452 ;
V_153 -> V_450 [ V_32 ] . V_287 = F_71 ( & V_153 -> V_312 -> V_10 ,
V_452 ,
sizeof( * V_452 ) ,
V_406 ) ;
}
V_153 -> V_19 = F_4 ( V_153 -> V_40 *
sizeof( struct V_5 ) , V_362 ) ;
if ( ! V_153 -> V_19 ) {
F_9 (KERN_ERR DEV_LABEL L_101 ) ;
goto V_455;
}
V_32 = V_456 * V_153 -> V_114 ;
F_16 ( V_32 >> 16 , V_153 -> V_15 + V_457 ) ;
F_16 ( V_32 , V_153 -> V_15 + V_272 ) ;
F_16 ( V_32 , V_153 -> V_15 + V_458 ) ;
...
V_32 = V_459 * V_153 -> V_114 ;
F_16 ( V_32 , V_153 -> V_15 + V_460 ) ;
F_16 ( V_32 + 2 * V_153 -> V_40 * sizeof( T_3 ) ,
V_153 -> V_15 + V_461 ) ;
F_16 ( V_32 , V_153 -> V_15 + V_462 ) ;
F_16 ( V_32 , V_153 -> V_15 + V_463 ) ;
V_153 -> V_28 . V_464 = F_61 ( V_153 -> V_15 + V_460 ) & 0xffff ;
V_153 -> V_28 . V_465 = F_61 ( V_153 -> V_15 + V_461 ) & 0xffff ;
V_153 -> V_28 . V_466 = F_61 ( V_153 -> V_15 + V_463 ) & 0xffff ;
V_153 -> V_28 . V_30 = F_61 ( V_153 -> V_15 + V_272 ) & 0xffff ;
V_153 -> V_28 . V_29 = F_61 ( V_153 -> V_15 + V_273 ) & 0xffff ;
V_153 -> V_28 . V_39 = F_61 ( V_153 -> V_15 + V_458 ) & 0xffff ;
V_438 = F_61 ( V_153 -> V_15 + V_460 ) ;
...
F_16 ( V_440 , V_153 -> V_15 + V_469 + 1 ) ;
V_440 = ( V_147 * V_153 -> V_114 + V_153 -> V_71 * 6 - 2 ) >> 1 ;
F_16 ( V_440 , V_153 -> V_15 + V_469 ) ;
F_47 (printk(L_107,
...
F_16 ( V_357 | ( ( V_32 >> 8 ) & 0xfff8 ) , V_153 -> V_15 + V_471 ) ;
V_32 = V_445 * V_153 -> V_114 ;
F_16 ( ( V_32 >> 8 ) & 0xfffe , V_153 -> V_15 + V_472 ) ;
V_32 = V_473 * V_153 -> V_114 ;
F_16 ( ( V_32 & 0xffff ) >> 11 , V_153 -> V_15 + V_474 ) ;
V_32 = V_475 * V_153 -> V_114 ;
F_16 ( ( V_32 >> 7 ) & 0xffff , V_153 -> V_15 + V_476 ) ;
memset ( ( V_99 ) ( V_153 -> V_18 + V_473 * V_153 -> V_114 ) ,
0 , V_153 -> V_71 * 8 ) ;
V_32 = V_446 * V_153 -> V_114 ;
F_16 ( ( V_32 >> 11 ) & 0xffff , V_153 -> V_15 + V_477 ) ;
V_32 = V_478 * V_153 -> V_114 ;
F_16 ( ( V_32 >> 7 ) & 0xffff , V_153 -> V_15 + V_479 ) ;
V_32 = V_446 * V_153 -> V_114 ;
memset ( ( V_99 ) ( V_153 -> V_18 + V_32 ) , 0 , V_153 -> V_71 * 4 ) ;
V_408 = (struct V_48 * ) V_153 -> V_50 ;
V_409 = (struct V_51 * ) V_153 -> V_53 ;
V_153 -> V_58 = F_4 ( sizeof( long ) * V_153 -> V_71 , V_362 ) ;
if ( ! V_153 -> V_58 ) {
F_9 ( L_109 ) ;
goto V_480;
}
...
memset ( ( V_99 ) V_408 , 0 , sizeof( * V_408 ) ) ;
memset ( ( V_99 ) V_409 , 0 , sizeof( * V_409 ) ) ;
V_153 -> V_58 [ V_32 ] = F_4 ( sizeof( struct V_481 ) ,
V_362 ) ;
if ( ! V_153 -> V_58 [ V_32 ] )
goto V_482;
V_153 -> V_58 [ V_32 ] -> V_67 = 0 ;
V_153 -> V_58 [ V_32 ] -> V_68 = 0 ;
V_153 -> V_58 [ V_32 ] -> V_60 = V_483 ;
V_408 ++ ;
V_409 ++ ;
}
if ( V_153 -> V_187 & V_189 ) {
F_16 ( V_484 , V_153 -> V_15 + V_485 ) ;
F_16 ( ( V_150 | ( 0x23 << 2 ) ) , V_153 -> V_15 + V_152 ) ;
}
else {
F_16 ( F_18 ( V_153 -> V_82 ) , V_153 -> V_15 + V_485 ) ;
F_16 ( ( V_150 | V_151 | ( 0x23 << 2 ) ) , V_153 -> V_15 + V_152 ) ;
}
F_16 ( 0 , V_153 -> V_15 + V_486 ) ;
F_16 ( 0 , V_153 -> V_15 + V_487 ) ;
F_16 ( 0xaa00 , V_153 -> V_15 + V_488 ) ;
V_153 -> V_401 = 0 ;
F_96 ( & V_153 -> V_402 ) ;
F_96 ( & V_153 -> V_489 ) ;
F_83 ( & V_153 -> V_405 ) ;
F_1 ( & V_153 -> V_27 ) ;
F_16 ( V_490 , V_153 -> V_15 + V_491 ) ;
F_83 ( & V_153 -> V_157 ) ;
F_16 ( V_492 , V_153 -> V_15 + V_493 ) ;
...
V_454:
while ( -- V_32 >= 0 ) {
struct V_451 * V_275 = V_153 -> V_450 + V_32 ;
F_74 ( & V_153 -> V_312 -> V_10 , V_275 -> V_287 ,
sizeof( * V_275 -> V_452 ) , V_406 ) ;
F_41 ( V_275 -> V_452 ) ;
}
F_41 ( V_153 -> V_450 ) ;
V_398:
...
static int F_99 ( struct V_274 * V_10 )
{
T_2 * V_153 ;
int V_32 ;
T_8 V_506 ;
...
V_153 -> V_195 + V_508 ) ) ) ;
V_507 = F_102 ( F_103 ( F_7 ( V_153 -> V_195 + V_509 ) ) ) ;
...
static int F_104 ( struct V_274 * V_10 )
{
T_2 * V_153 ;
int V_32 , error = 1 ;
...
static int F_107 ( struct V_274 * V_10 )
{
T_2 * V_153 ;
unsigned long V_515 ;
void T_13 * V_516 ;
...
V_153 = F_31 ( V_10 ) ;
V_515 = F_108 ( V_153 -> V_312 , 0 ) ;
V_153 -> V_495 = V_153 -> V_312 -> V_495 ;
error = F_109 ( V_153 -> V_312 , V_522 , & V_517 ) ;
if ( error ) {
...
V_153 -> V_523 = F_110 ( V_153 -> V_312 , 0 ) ;
...
F_116 ( & V_554 , V_38 + V_416 / 4 ) ;
return;
}
static void F_117 ( struct V_274 * V_10 , unsigned char V_555 ,
unsigned long V_166 )
{
F_50 ( V_555 , F_31 ( V_10 ) -> V_196 + V_166 ) ;
}
static unsigned char F_118 ( struct V_274 * V_10 , unsigned long V_166 )
{
return F_7 ( F_31 ( V_10 ) -> V_196 + V_166 ) ;
}
static void F_119 ( T_2 * V_153 )
{
int V_32 ;
F_41 ( V_153 -> V_19 ) ;
for ( V_32 = 0 ; V_32 < V_153 -> V_71 ; V_32 ++ )
...
static int F_121 ( struct V_274 * V_10 )
{
T_2 * V_153 ;
int error ;
unsigned char V_196 ;
...
F_10 (printk(L_127);)
V_153 = F_31 ( V_10 ) ;
if ( F_122 ( V_153 -> V_495 , & F_97 , V_556 , V_525 , V_10 ) ) {
F_9 (KERN_ERR DEV_LABEL L_128 ,
dev->number, iadev->irq) ;
error = - V_557 ;
goto V_363;
}
if ( ( error = F_123 ( V_153 -> V_312 ,
V_522 ,
V_558 | V_559 ) ) )
{
...
F_127 ( V_158 , & V_42 -> V_159 ) ;
F_83 ( & V_580 ) ;
F_83 ( & V_581 ) ;
if ( V_42 -> V_54 . V_55 . V_56 != V_350 ) {
V_153 -> V_401 ++ ;
F_128 ( & V_153 -> V_489 , & V_578 , V_583 ) ;
F_129 ( F_130 ( 500 ) ) ;
F_131 ( & V_153 -> V_489 , & V_578 ) ;
F_87 ( & V_153 -> V_400 , V_159 ) ;
...
V_582 = 1 ;
F_88 ( & V_153 -> V_400 , V_159 ) ;
F_132 ( V_153 -> V_402 , ( V_13 -> V_22 <= 0 ) , V_582 ) ;
F_87 ( & V_153 -> V_400 , V_159 ) ;
V_153 -> V_401 -- ;
V_153 -> V_58 [ V_42 -> V_59 ] -> V_67 = 0 ;
V_153 -> V_58 [ V_42 -> V_59 ] -> V_68 = 0 ;
V_153 -> V_58 [ V_42 -> V_59 ] -> V_60 = V_483 ;
if ( V_42 -> V_54 . V_55 . V_56 == V_57 ) {
if ( V_42 -> V_54 . V_55 . V_426 > 0 )
V_153 -> V_122 -= V_42 -> V_54 . V_55 . V_426 ;
}
...
static int F_135 ( struct V_41 * V_42 , struct V_591 * V_54 , int V_159 )
{
F_10 (printk(L_144);)
return 0 ;
}
static int F_136 ( struct V_274 * V_10 , unsigned int V_592 , void T_15 * V_547 )
{
T_16 V_593 ;
T_2 * V_153 ;
int V_32 , V_594 ;
...
if ( F_137 ( & V_593 , V_547 , sizeof V_593 ) ) return - V_598 ;
V_594 = V_593 . V_63 ;
...
switch ( V_593 . V_600 ) {
case V_601 :
if ( ! F_138 ( V_602 ) ) return - V_603 ;
if ( F_139 ( V_593 . V_604 , V_153 , sizeof( T_2 ) ) )
return - V_598 ;
V_593 . V_63 = 0 ;
break;
case V_605 :
...
if( F_140 ( ( T_4 ) ( F_7 ( V_153 -> V_15 + V_32 ) & 0xffff ) , V_595 ) ) return - V_598 ;
V_593 . V_63 = 0 ;
V_593 . V_165 = 0x80 ;
break;
case V_606 :
...
V_595 = ( T_4 T_15 * ) V_593 . V_604 ;
for( V_32 = 0 ; V_32 < 0x80 ; V_32 += 2 , V_595 ++ )
if( F_140 ( ( T_4 ) ( F_7 ( V_153 -> V_280 + V_32 ) & 0xffff ) , V_595 ) ) return - V_598 ;
V_593 . V_63 = 0 ;
V_593 . V_165 = 0x80 ;
break;
case V_607 :
...
if ( F_139 ( V_593 . V_604 , V_608 , sizeof( T_17 ) ) ) {
F_41 ( V_608 ) ;
return - V_598 ;
}
F_41 ( V_608 ) ;
...
{
V_593 . V_63 = 0 ;
F_9 ( L_147 , ( long ) F_141 ( & V_153 -> V_157 ) ) ;
...
{
struct V_612 * V_301 ;
V_301 = & F_142 ( V_613 [ V_594 ] ) -> V_614 ;
F_9 ( L_149 , F_143 ( & V_301 -> V_615 ) ) ;
F_9 ( L_150 , F_143 ( & V_301 -> V_616 ) ) ;
F_9 ( L_151 , F_143 ( & V_301 -> V_617 ) ) ;
F_9 ( L_152 , F_143 ( & V_301 -> V_618 ) ) ;
F_9 ( L_153 , F_143 ( & V_301 -> V_619 ) ) ;
F_9 ( L_154 , F_143 ( & V_301 -> V_620 ) ) ;
F_9 ( L_155 , F_143 ( & V_301 -> V_621 ) ) ;
F_9 ( L_156 , F_143 ( & V_301 -> V_622 ) ) ;
F_9 ( L_157 , F_143 ( & V_301 -> V_623 ) ) ;
}
V_593 . V_63 = 0 ;
break;
case 0x9 :
...
static int F_144 ( struct V_41 * V_42 , int V_626 , int V_627 ,
...
F_16 ( V_153 -> V_28 . V_39 , V_153 -> V_15 + V_458 ) ;
* ( T_4 * ) ( V_153 -> V_18 + V_153 -> V_28 . V_466 ) = V_275 ;
V_153 -> V_28 . V_466 += 2 ;
if ( V_153 -> V_28 . V_466 > V_153 -> V_28 . V_465 )
V_153 -> V_28 . V_466 = V_153 -> V_28 . V_464 ;
V_631 = V_34 -> V_165 + sizeof( struct V_341 ) ;
V_631 = ( ( V_631 + 47 ) / 48 ) * 48 ;
F_146 (printk(L_166, total_len, total_len - skb->len);)
V_342 = V_153 -> V_450 [ V_275 - 1 ] . V_452 ;
F_146 (printk(L_167,
...
static int F_148 ( struct V_41 * V_42 , struct V_33 * V_34 )
{
T_2 * V_153 ;
unsigned long V_159 ;
V_153 = F_31 ( V_42 -> V_10 ) ;
...
static int F_149 ( struct V_274 * V_10 , T_20 * V_642 , char * V_643 )
{
...
V_153 -> V_330 , V_153 -> V_494 ,
V_153 -> V_537 , V_153 -> V_544 ,
V_153 -> V_542 , V_153 -> V_540 ) ;
}
return 0 ;
}
static int F_150 ( struct V_648 * V_649 , const struct V_650 * V_651 )
{
struct V_274 * V_10 ;
T_2 * V_153 ;
int V_410 ;
...
V_10 = F_152 ( V_525 , & V_649 -> V_10 , & V_654 , - 1 , NULL ) ;
if ( ! V_10 ) {
V_410 = - V_8 ;
goto V_655;
}
...
static void F_156 ( struct V_648 * V_649 )
{
struct V_274 * V_10 = F_157 ( V_649 ) ;
T_2 * V_153 = F_31 ( V_10 ) ;
F_117 ( V_10 , F_118 ( V_10 , V_659 ) & ~ ( V_660 ) ,
V_659 ) ;
F_15 ( 1 ) ;
