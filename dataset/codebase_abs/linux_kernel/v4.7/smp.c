...
V_178 = F_125 ( V_137 . V_86 , V_137 . V_165 ) + 1 ;
V_178 = F_126 ( V_2 , V_178 ) ;
V_178 = V_137 . V_179 * V_178 ? : V_156 ;
V_177 = V_175 ? : V_156 ;
V_177 = F_126 ( V_177 , V_178 ) ;
for ( V_20 = 0 ; V_20 < V_177 && V_20 < V_156 ; V_20 ++ )
F_127 ( V_20 , true ) ;
}
void T_1 F_128 ( unsigned int V_180 )
{
if ( F_129 ( V_181 , F_65 ) )
F_85 ( L_6 ) ;
if ( F_129 ( V_182 , F_65 ) )
...
V_8 -> V_159 = V_161 ;
V_8 -> V_10 = F_37 () ;
V_8 -> V_29 = (struct V_29 * ) ( unsigned long ) F_131 () ;
V_38 . V_52 = V_53 [ 0 ] ;
F_88 ( 0 , V_162 ) ;
F_95 ( 0 , true ) ;
F_111 ( 0 , true ) ;
...
static T_10 F_135 ( struct V_184 * V_185 ,
...
static T_10 F_138 ( struct V_184 * V_185 ,
struct V_186 * V_187 ,
...
static T_10 F_143 ( struct V_184 * V_185 ,
struct V_186 * V_187 , char * V_188 )
{
return sprintf ( V_188 , L_8 , V_21 [ V_185 -> V_191 ] . V_10 ) ;
}
static int F_144 ( struct V_195 * V_196 , unsigned long V_197 ,
void * V_198 )
{
unsigned int V_20 = ( unsigned int ) ( long ) V_198 ;
struct V_184 * V_1 = & F_145 ( V_199 , V_20 ) -> V_185 ;
int V_200 = 0 ;
switch ( V_197 & ~ V_201 ) {
case V_202 :
V_200 = F_146 ( & V_1 -> V_203 , & V_204 ) ;
break;
case V_205 :
F_147 ( & V_1 -> V_203 , & V_204 ) ;
break;
}
return F_148 ( V_200 ) ;
}
...
if ( ! V_206 )
return - V_46 ;
F_145 ( V_199 , V_20 ) = V_206 ;
V_1 = & V_206 -> V_185 ;
V_206 -> V_207 = 1 ;
V_173 = F_149 ( V_206 , V_20 ) ;
if ( V_173 )
goto V_35;
V_173 = F_146 ( & V_1 -> V_203 , & V_208 ) ;
if ( V_173 )
goto V_209;
if ( F_115 ( V_20 ) ) {
V_173 = F_146 ( & V_1 -> V_203 , & V_204 ) ;
if ( V_173 )
goto V_210;
}
V_173 = F_150 ( V_206 ) ;
...
static T_10 T_12 F_155 ( struct V_184 * V_185 ,
struct V_186 * V_187 ,
const char * V_188 ,
T_11 V_189 )
{
