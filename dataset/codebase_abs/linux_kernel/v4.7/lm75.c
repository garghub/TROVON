...
F_29 ( V_5 -> V_63 ) ;
F_14 ( V_15 , V_61 , V_5 -> V_62 ) ;
return 0 ;
}
static int F_30 ( struct V_14 * V_67 ,
struct V_68 * V_69 )
{
...
if ( F_31 ( V_67 , V_71 + 1 ) != V_72
|| F_31 ( V_67 , V_71 + 2 ) != V_73
|| F_31 ( V_67 , V_71 + 3 ) != V_74 )
return - V_76 ;
if ( V_75 && F_31 ( V_67 , V_71 + 7 )
!= V_77 )
return - V_76 ;
}
F_32 ( V_69 -> type , V_75 ? L_5 : L_6 , V_78 ) ;
return 0 ;
}
static int F_33 ( struct V_6 * V_3 )
{
int V_24 ;
struct V_14 * V_15 = F_34 ( V_3 ) ;
V_24 = F_21 ( V_15 , V_61 ) ;
if ( V_24 < 0 ) {
...
static int F_35 ( struct V_6 * V_3 )
{
int V_24 ;
struct V_14 * V_15 = F_34 ( V_3 ) ;
V_24 = F_21 ( V_15 , V_61 ) ;
...
{
if ( V_79 == V_61 )
return F_31 ( V_15 , V_79 ) ;
else
return F_36 ( V_15 , V_79 ) ;
}
static int F_14 ( struct V_14 * V_15 , T_2 V_79 , T_5 V_80 )
{
if ( V_79 == V_61 )
return F_37 ( V_15 , V_79 , V_80 ) ;
else
...
struct V_4 * V_81 = V_5 ;
F_11 ( & V_5 -> V_18 ) ;
if ( F_39 ( V_82 , V_5 -> V_83 + V_5 -> V_39 )
|| ! V_5 -> V_84 ) {
int V_71 ;
F_22 ( & V_15 -> V_3 , L_7 ) ;
for ( V_71 = 0 ; V_71 < F_40 ( V_5 -> V_1 ) ; V_71 ++ ) {
int V_24 ;
