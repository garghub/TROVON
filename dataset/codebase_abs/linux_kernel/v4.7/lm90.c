...
static inline int F_19 ( T_4 V_83 )
{
return V_83 * 1000 ;
}
static inline int F_20 ( T_2 V_83 )
{
return V_83 * 1000 ;
}
static inline int F_21 ( T_5 V_83 )
{
return V_83 / 32 * 125 ;
}
static inline int F_22 ( T_3 V_83 )
{
return V_83 / 32 * 125 ;
}
static T_4 F_23 ( long V_83 )
{
if ( V_83 <= - 128000 )
return - 128 ;
if ( V_83 >= 127000 )
...
static inline int F_27 ( struct V_18 * V_19 , T_2 V_83 )
{
if ( V_19 -> V_6 & V_84 )
return ( V_83 - 64 ) * 1000 ;
else
...
static inline int F_28 ( struct V_18 * V_19 , T_3 V_83 )
{
if ( V_19 -> V_6 & V_84 )
...
static T_2 F_29 ( struct V_18 * V_19 , long V_83 )
{
if ( V_19 -> V_6 & V_84 ) {
if ( V_83 <= - 64000 )
return 0 ;
...
static T_3 F_30 ( struct V_18 * V_19 , long V_83 )
{
if ( V_19 -> V_6 & V_84 ) {
if ( V_83 <= - 64000 )
return 0 ;
...
static T_6 F_31 ( struct V_32 * V_12 , struct V_85 * V_86 ,
char * V_87 )
{
struct V_88 * V_89 = F_32 ( V_86 ) ;
struct V_18 * V_19 = F_12 ( V_12 ) ;
int V_90 ;
if ( V_19 -> V_22 == V_91 || V_19 -> V_22 == V_92 )
V_90 = F_27 ( V_19 , V_19 -> V_41 [ V_89 -> V_93 ] ) ;
else if ( V_19 -> V_22 == V_94 )
V_90 = F_20 ( V_19 -> V_41 [ V_89 -> V_93 ] ) ;
else
V_90 = F_19 ( V_19 -> V_41 [ V_89 -> V_93 ] ) ;
if ( V_19 -> V_22 == V_95 && V_89 -> V_93 == 3 )
V_90 += 16000 ;
return sprintf ( V_87 , L_4 , V_90 ) ;
}
static T_6 F_33 ( struct V_32 * V_12 , struct V_85 * V_86 ,
...
F_14 ( & V_19 -> V_34 ) ;
if ( V_19 -> V_22 == V_91 || V_19 -> V_22 == V_92 )
V_19 -> V_41 [ V_104 ] = F_29 ( V_19 , V_83 ) ;
else if ( V_19 -> V_22 == V_94 )
V_19 -> V_41 [ V_104 ] = F_24 ( V_83 ) ;
else
V_19 -> V_41 [ V_104 ] = F_23 ( V_83 ) ;
...
static T_6 F_35 ( struct V_32 * V_12 , struct V_85 * V_86 ,
char * V_87 )
{
struct V_105 * V_89 = F_36 ( V_86 ) ;
struct V_18 * V_19 = F_12 ( V_12 ) ;
int V_90 ;
if ( V_19 -> V_22 == V_91 || V_19 -> V_22 == V_92 )
V_90 = F_28 ( V_19 , V_19 -> V_53 [ V_89 -> V_93 ] ) ;
else if ( V_19 -> V_22 == V_94 )
V_90 = F_22 ( V_19 -> V_53 [ V_89 -> V_93 ] ) ;
else
V_90 = F_21 ( V_19 -> V_53 [ V_89 -> V_93 ] ) ;
if ( V_19 -> V_22 == V_95 && V_89 -> V_93 <= 2 )
V_90 += 16000 ;
return sprintf ( V_87 , L_4 , V_90 ) ;
}
static T_6 F_37 ( struct V_32 * V_12 , struct V_85 * V_86 ,
const char * V_87 , T_7 V_96 )
{
struct {
T_2 V_106 ;
...
F_14 ( & V_19 -> V_34 ) ;
if ( V_19 -> V_22 == V_91 || V_19 -> V_22 == V_92 )
V_19 -> V_53 [ V_93 ] = F_30 ( V_19 , V_83 ) ;
else if ( V_19 -> V_22 == V_94 )
V_19 -> V_53 [ V_93 ] = F_24 ( V_83 ) << 8 ;
else if ( V_19 -> V_6 & V_60 )
V_19 -> V_53 [ V_93 ] = F_25 ( V_83 ) ;
else
V_19 -> V_53 [ V_93 ] = F_23 ( V_83 ) << 8 ;
...
static T_6 F_38 ( struct V_32 * V_12 ,
struct V_85 * V_86 ,
char * V_87 )
{
struct V_88 * V_89 = F_32 ( V_86 ) ;
...
if ( V_19 -> V_22 == V_95 && V_89 -> V_93 == 3 )
V_90 += 16000 ;
return sprintf ( V_87 , L_4 , V_90 - F_19 ( V_19 -> V_50 ) ) ;
}
static T_6 F_39 ( struct V_32 * V_12 , struct V_85 * V_114 ,
const char * V_87 , T_7 V_96 )
{
struct V_18 * V_19 = F_13 ( V_12 ) ;
struct V_1 * V_2 = V_19 -> V_2 ;
...
F_14 ( & V_19 -> V_34 ) ;
if ( V_19 -> V_22 == V_91 || V_19 -> V_22 == V_92 )
V_90 = F_27 ( V_19 , V_19 -> V_41 [ V_46 ] ) ;
else if ( V_19 -> V_22 == V_94 )
V_90 = F_20 ( V_19 -> V_41 [ V_46 ] ) ;
else
V_90 = F_19 ( V_19 -> V_41 [ V_46 ] ) ;
V_19 -> V_50 = F_26 ( V_90 - V_83 ) ;
F_9 ( V_2 , V_115 ,
V_19 -> V_50 ) ;
F_18 ( & V_19 -> V_34 ) ;
return V_96 ;
...
static T_6 F_41 ( struct V_32 * V_12 , struct V_85
* V_86 , char * V_87 )
{
struct V_88 * V_89 = F_32 ( V_86 ) ;
struct V_18 * V_19 = F_12 ( V_12 ) ;
...
static T_6 F_42 ( struct V_32 * V_12 ,
...
unsigned long V_83 ;
int V_11 ;
V_11 = F_44 ( V_87 , 10 , & V_83 ) ;
if ( V_11 )
return V_11 ;
F_14 ( & V_19 -> V_34 ) ;
F_10 ( V_2 , V_19 , F_45 ( V_83 , 0 , 100000 ) ) ;
F_18 ( & V_19 -> V_34 ) ;
return V_96 ;
}
static T_6 F_46 ( struct V_32 * V_12 , struct V_85 * V_114 ,
char * V_87 )
{
struct V_1 * V_2 = F_47 ( V_12 ) ;
...
static bool F_55 ( struct V_1 * V_2 , T_3 * V_144 )
{
struct V_18 * V_19 = F_56 ( V_2 ) ;
T_2 V_145 , V_146 = 0 ;
F_3 ( V_2 , V_74 , & V_145 ) ;
if ( V_19 -> V_22 == V_23 )
F_3 ( V_2 , V_80 , & V_146 ) ;
* V_144 = V_145 | ( V_146 << 8 ) ;
if ( ( V_145 & 0x7f ) == 0 && ( V_146 & 0xfe ) == 0 )
return false ;
if ( ( V_145 & ( V_147 | V_148 | V_149 ) ) ||
( V_146 & V_150 ) )
F_6 ( & V_2 -> V_12 ,
L_29 , 1 ) ;
if ( ( V_145 & ( V_151 | V_152 | V_153 ) ) ||
( V_146 & V_154 ) )
F_6 ( & V_2 -> V_12 ,
L_29 , 2 ) ;
if ( V_145 & V_155 )
...
static T_8 F_57 ( int V_161 , void * V_162 )
{
...
struct V_120 * V_4 = F_59 ( V_12 -> V_167 ) ;
struct V_18 * V_19 ;
struct V_168 * V_168 ;
int V_169 = 0 ;
int V_11 ;
V_168 = F_60 ( V_12 , L_31 ) ;
if ( F_61 ( V_168 ) )
return F_62 ( V_168 ) ;
V_11 = F_63 ( V_168 ) ;
if ( V_11 < 0 ) {
...
V_19 = F_65 ( V_12 , sizeof( struct V_18 ) , V_170 ) ;
if ( ! V_19 )
return - V_171 ;
V_19 -> V_2 = V_2 ;
F_66 ( V_2 , V_19 ) ;
F_67 ( & V_19 -> V_34 ) ;
V_19 -> V_168 = V_168 ;
V_19 -> V_22 = V_166 -> V_172 ;
if ( V_19 -> V_22 == V_173 ) {
if ( ! F_50 ( V_4 , V_134 ) )
V_2 -> V_6 &= ~ V_7 ;
}
V_19 -> V_82 = V_174 [ V_19 -> V_22 ] . V_82 ;
V_19 -> V_6 = V_174 [ V_19 -> V_22 ] . V_6 ;
V_19 -> V_51 = V_174 [ V_19 -> V_22 ] . V_51 ;
V_19 -> V_30 = V_174 [ V_19 -> V_22 ] . V_30 ;
F_54 ( V_2 , V_19 ) ;
V_19 -> V_169 [ V_169 ++ ] = & V_175 ;
if ( V_19 -> V_6 & V_65 )
V_19 -> V_169 [ V_169 ++ ] = & V_176 ;
if ( V_19 -> V_6 & V_69 )
V_19 -> V_169 [ V_169 ++ ] = & V_177 ;
if ( V_19 -> V_6 & V_178 )
V_19 -> V_169 [ V_169 ++ ] = & V_179 ;
if ( V_19 -> V_6 & V_180 )
V_19 -> V_169 [ V_169 ++ ] = & V_181 ;
if ( V_2 -> V_6 & V_7 ) {
V_11 = F_68 ( V_12 , & V_182 ) ;
if ( V_11 )
goto V_183;
}
V_19 -> V_184 = F_69 ( V_12 , V_2 -> V_122 ,
V_19 , V_19 -> V_169 ) ;
if ( F_61 ( V_19 -> V_184 ) ) {
V_11 = F_62 ( V_19 -> V_184 ) ;
goto V_185;
}
if ( V_2 -> V_161 ) {
F_17 ( V_12 , L_33 , V_2 -> V_161 ) ;
V_11 = F_70 ( V_12 , V_2 -> V_161 ,
NULL , F_57 ,
V_186 | V_187 ,
L_6 , V_2 ) ;
if ( V_11 < 0 ) {
F_64 ( V_12 , L_34 , V_2 -> V_161 ) ;
goto V_188;
}
}
return 0 ;
...
static void F_75 ( struct V_1 * V_2 , unsigned int V_189 )
{
T_3 V_39 ;
if ( F_55 ( V_2 , & V_39 ) ) {
struct V_18 * V_19 = F_56 ( V_2 ) ;
