...
if ( ! V_7 -> V_8 )
return V_9 ;
return V_7 -> V_8 -> V_10 ( V_2 , V_3 , V_4 , V_5 ) ;
}
...
if ( V_31 & F_21 ( V_30 ) ) {
F_14 ( V_2 , F_20 ( V_29 ) , F_21 ( V_30 ) ) ;
V_2 -> V_7 . V_25 . V_38 ++ ;
return 0 ;
}
return V_9 ;
}
static T_1 F_22 ( struct V_1 * V_2 , T_3 V_22 )
{
T_2 V_39 ;
F_14 ( V_2 , F_23 ( V_22 ) , V_40 ) ;
V_39 = F_12 ( V_2 , F_23 ( V_22 ) ) ;
if ( V_39 & V_40 )
return 0 ;
return V_9 ;
}
static T_1 F_24 ( struct V_1 * V_2 , T_2 * V_3 , T_3 V_4 ,
T_3 V_22 )
{
T_1 V_18 ;
T_3 V_41 ;
...
F_25 ( V_2 , F_26 ( V_22 ) , V_41 , V_3 [ V_41 ] ) ;
F_14 ( V_2 , F_23 ( V_22 ) , V_42 ) ;
V_2 -> V_7 . V_25 . V_43 ++ ;
return 0 ;
}
static T_1 F_27 ( struct V_1 * V_2 , T_2 * V_3 , T_3 V_4 ,
T_3 V_22 )
{
T_1 V_18 ;
T_3 V_41 ;
...
return V_18 ;
for ( V_41 = 0 ; V_41 < V_4 ; V_41 ++ )
V_3 [ V_41 ] = F_28 ( V_2 , F_26 ( V_22 ) , V_41 ) ;
F_14 ( V_2 , F_23 ( V_22 ) , V_44 ) ;
V_2 -> V_7 . V_25 . V_45 ++ ;
return 0 ;
}
