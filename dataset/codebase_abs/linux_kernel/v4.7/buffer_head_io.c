...
int F_28 ( struct V_5 * V_6 , T_1 V_16 , int V_17 ,
struct V_3 * V_18 [] , int V_27 ,
int (* F_29)( struct V_28 * V_22 ,
struct V_3 * V_4 ) )
{
int V_19 = 0 ;
int V_20 , V_29 = 0 ;
struct V_3 * V_4 ;
struct V_28 * V_22 = F_30 ( V_6 ) ;
F_31 ( V_6 , ( unsigned long long ) V_16 , V_17 , V_27 ) ;
F_3 ( ! V_6 ) ;
F_3 ( ( V_27 & V_30 ) &&
( V_27 & V_31 ) ) ;
if ( V_18 == NULL ) {
...
V_4 = V_18 [ V_20 ] ;
V_29 = ( V_27 & V_31 ) ;
if ( ! V_29 && ! F_32 ( V_6 , V_4 ) ) {
F_33 (
( unsigned long long ) V_4 -> V_8 ,
( unsigned long long ) F_34 ( V_6 ) ) ;
V_29 = 1 ;
}
F_35 ( ( unsigned long long ) V_4 -> V_8 ,
