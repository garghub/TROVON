...
case V_98 : {
unsigned int V_106 ;
if ( ! V_5 -> V_6 -> V_107 || ! V_5 -> V_6 -> V_107 -> V_108 )
return - V_105 ;
F_26 ( & V_5 -> V_63 , V_62 ) ;
V_106 = V_5 -> V_6 -> V_107 -> V_108 ( V_5 , V_92 ) ;
F_29 ( & V_5 -> V_63 , V_62 ) ;
if ( V_106 != V_94 )
return - V_47 ;
* V_104 = 0 ;
...
case V_102 : {
int V_43 ;
if ( ! V_5 -> V_6 -> V_107 || ! V_5 -> V_6 -> V_107 -> V_109 )
return - V_105 ;
F_26 ( & V_5 -> V_63 , V_62 ) ;
V_43 = V_5 -> V_6 -> V_107 -> V_109 ( V_5 , V_92 ) ;
F_29 ( & V_5 -> V_63 , V_62 ) ;
if ( V_43 < 0 )
return V_43 ;
* V_104 = V_43 ;
...
static int F_43 ( struct V_1 * V_2 , unsigned V_92 ,
...
case V_98 :
case V_95 :
if ( ! V_5 -> V_6 -> V_107 || ! V_5 -> V_6 -> V_107 -> V_110 )
return - V_105 ;
F_26 ( & V_5 -> V_63 , V_62 ) ;
V_5 -> V_6 -> V_107 -> V_110 ( V_5 , V_92 , V_94 ) ;
F_29 ( & V_5 -> V_63 , V_62 ) ;
break;
case V_100 : {
unsigned int V_111 =
...
F_44 ( V_22 [ V_54 ] ) ;
int V_43 ;
if ( ! V_5 -> V_6 -> V_107 || ! V_5 -> V_6 -> V_107 -> V_112 )
return - V_105 ;
F_26 ( & V_5 -> V_63 , V_62 ) ;
V_43 = V_5 -> V_6 -> V_107 -> V_112 ( V_5 , V_92 , V_111 ) ;
F_29 ( & V_5 -> V_63 , V_62 ) ;
if ( V_43 )
return V_43 ;
break;
...
static int F_45 ( struct V_1 * V_2 , unsigned V_41 ,
unsigned long * V_22 ,
unsigned V_23 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_43 ( V_2 , V_11 [ V_54 ] , V_22 , V_23 ) ;
return 0 ;
}
static int F_46 ( struct V_59 * V_5 , struct V_3 * V_4 )
{
unsigned int V_54 ;
V_4 -> V_11 = F_47 ( V_5 -> V_33 ,
sizeof( * V_4 -> V_11 ) * V_5 -> V_6 -> V_13 ,
V_25 ) ;
if ( F_48 ( ! V_4 -> V_11 ) )
return - V_26 ;
V_4 -> V_22 = F_47 ( V_5 -> V_33 ,
...
struct V_113 * V_42 = & V_4 -> V_11 [ V_54 ] ;
V_42 -> V_114 = V_6 -> V_42 != ( T_2 ) - 1 ? V_6 -> V_42 : V_54 ;
V_42 -> V_10 = V_6 -> V_10 ;
V_65 -> type = V_66 ;
}
return 0 ;
}
int F_49 ( struct V_59 * V_5 )
{
struct V_3 * V_4 ;
int V_43 ;
V_4 = F_47 ( V_5 -> V_33 , sizeof( * V_4 ) , V_25 ) ;
if ( F_48 ( ! V_4 ) )
return - V_26 ;
V_4 -> V_5 = V_5 ;
V_43 = F_46 ( V_5 , V_4 ) ;
...
return V_43 ;
V_4 -> V_115 . V_10 = V_17 ;
V_4 -> V_115 . V_116 = V_117 ;
V_4 -> V_115 . V_118 = & V_119 ;
V_4 -> V_115 . V_120 = & V_121 ;
V_4 -> V_115 . V_122 = & V_123 ;
V_4 -> V_115 . V_11 = V_4 -> V_11 ;
V_4 -> V_115 . V_124 = V_5 -> V_6 -> V_13 ;
V_4 -> V_125 = F_50 ( V_5 -> V_33 , & V_4 -> V_115 , V_4 ) ;
if ( F_51 ( V_4 -> V_125 ) )
return F_52 ( V_4 -> V_125 ) ;
return 0 ;
}
