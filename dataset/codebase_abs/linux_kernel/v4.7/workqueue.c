...
static int F_321 ( struct V_283 * V_284 ,
unsigned long V_285 ,
void * V_286 )
{
int V_56 = ( unsigned long ) V_286 ;
struct V_13 * V_14 ;
struct V_22 * V_23 ;
int V_279 ;
switch ( V_285 & ~ V_287 ) {
...
static int F_322 ( struct V_283 * V_284 ,
unsigned long V_285 ,
void * V_286 )
{
int V_56 = ( unsigned long ) V_286 ;
...
static void F_323 ( struct V_2 * V_4 )
{
struct V_296 * V_297 = F_168 ( V_4 , struct V_296 , V_4 ) ;
V_297 -> V_15 = V_297 -> V_200 ( V_297 -> V_298 ) ;
}
long F_324 ( int V_56 , long (* V_200)( void * ) , void * V_298 )
{
struct V_296 V_297 = { . V_200 = V_200 , . V_298 = V_298 } ;
F_170 ( & V_297 . V_4 , F_323 ) ;
F_208 ( V_56 , & V_297 . V_4 ) ;
F_189 ( & V_297 . V_4 ) ;
F_16 ( & V_297 . V_4 ) ;
return V_297 . V_15 ;
}
...
static struct V_22 * F_332 ( struct V_302 * V_303 )
{
struct V_304 * V_305 = F_168 ( V_303 , struct V_304 , V_303 ) ;
return V_305 -> V_23 ;
}
static T_10 F_333 ( struct V_302 * V_303 , struct V_306 * V_307 ,
char * V_308 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
return F_334 ( V_308 , V_309 , L_40 , ( bool ) ! ( V_23 -> V_33 & V_70 ) ) ;
}
static T_10 F_335 ( struct V_302 * V_303 ,
struct V_306 * V_307 , char * V_308 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
return F_334 ( V_308 , V_309 , L_40 , V_23 -> V_189 ) ;
}
static T_10 F_336 ( struct V_302 * V_303 ,
struct V_306 * V_307 , const char * V_308 ,
T_7 V_310 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
int V_311 ;
if ( sscanf ( V_308 , L_41 , & V_311 ) != 1 || V_311 <= 0 )
return - V_240 ;
F_290 ( V_23 , V_311 ) ;
return V_310 ;
}
static T_10 F_337 ( struct V_302 * V_303 ,
struct V_306 * V_307 , char * V_308 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
const char * V_312 = L_5 ;
int V_24 , V_313 = 0 ;
F_293 () ;
F_244 (node) {
V_313 += F_334 ( V_308 + V_313 , V_309 - V_313 ,
L_42 , V_312 , V_24 ,
F_22 ( V_23 , V_24 ) -> V_14 -> V_20 ) ;
V_312 = L_43 ;
}
V_313 += F_334 ( V_308 + V_313 , V_309 - V_313 , L_18 ) ;
F_295 () ;
return V_313 ;
}
static T_10 F_338 ( struct V_302 * V_303 , struct V_306 * V_307 ,
char * V_308 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
int V_313 ;
F_134 ( & V_23 -> V_179 ) ;
V_313 = F_334 ( V_308 , V_309 , L_40 , V_23 -> V_217 -> V_134 ) ;
F_136 ( & V_23 -> V_179 ) ;
return V_313 ;
}
static struct V_203 * F_339 ( struct V_22 * V_23 )
{
struct V_203 * V_125 ;
F_20 ( & V_16 ) ;
V_125 = F_215 ( V_19 ) ;
...
static T_10 F_340 ( struct V_302 * V_303 , struct V_306 * V_307 ,
const char * V_308 , T_7 V_310 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
struct V_203 * V_125 ;
int V_15 = - V_199 ;
...
if ( ! V_125 )
goto V_181;
if ( sscanf ( V_308 , L_41 , & V_125 -> V_134 ) == 1 &&
V_125 -> V_134 >= V_314 && V_125 -> V_134 <= V_315 )
V_15 = F_272 ( V_23 , V_125 ) ;
else
V_15 = - V_240 ;
V_181:
...
static T_10 F_341 ( struct V_302 * V_303 ,
struct V_306 * V_307 , char * V_308 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
int V_313 ;
F_134 ( & V_23 -> V_179 ) ;
V_313 = F_334 ( V_308 , V_309 , L_44 ,
F_342 ( V_23 -> V_217 -> V_126 ) ) ;
F_136 ( & V_23 -> V_179 ) ;
return V_313 ;
}
static T_10 F_343 ( struct V_302 * V_303 ,
struct V_306 * V_307 ,
const char * V_308 , T_7 V_310 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
...
static T_10 F_345 ( struct V_302 * V_303 , struct V_306 * V_307 ,
char * V_308 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
int V_313 ;
F_134 ( & V_23 -> V_179 ) ;
V_313 = F_334 ( V_308 , V_309 , L_40 ,
! V_23 -> V_217 -> V_208 ) ;
F_136 ( & V_23 -> V_179 ) ;
return V_313 ;
}
static T_10 F_346 ( struct V_302 * V_303 , struct V_306 * V_307 ,
const char * V_308 , T_7 V_310 )
{
struct V_22 * V_23 = F_332 ( V_303 ) ;
struct V_203 * V_125 ;
int V_316 , V_15 = - V_199 ;
F_270 () ;
V_125 = F_339 ( V_23 ) ;
if ( ! V_125 )
goto V_181;
V_15 = - V_240 ;
if ( sscanf ( V_308 , L_41 , & V_316 ) == 1 ) {
V_125 -> V_208 = ! V_316 ;
V_15 = F_272 ( V_23 , V_125 ) ;
}
V_181:
...
static T_10 F_347 ( struct V_302 * V_303 ,
struct V_306 * V_307 , char * V_308 )
{
int V_313 ;
F_134 ( & V_16 ) ;
...
static T_10 F_348 ( struct V_302 * V_303 ,
struct V_306 * V_307 , const char * V_308 , T_7 V_310 )
{
T_9 V_126 ;
int V_15 ;
if ( ! F_331 ( & V_126 , V_19 ) )
return - V_199 ;
V_15 = F_344 ( V_308 , V_126 ) ;
if ( ! V_15 )
V_15 = F_330 ( V_126 ) ;
F_214 ( V_126 ) ;
return V_15 ? V_15 : V_310 ;
}
static int T_11 F_349 ( void )
{
int V_317 ;
V_317 = F_350 ( & V_318 , NULL ) ;
if ( V_317 )
return V_317 ;
return F_351 ( V_318 . V_319 , & V_320 ) ;
}
static void F_352 ( struct V_302 * V_303 )
{
struct V_304 * V_305 = F_168 ( V_303 , struct V_304 , V_303 ) ;
F_146 ( V_305 ) ;
}
...
if ( F_116 ( V_23 -> V_33 & V_241 ) )
return - V_240 ;
V_23 -> V_305 = V_305 = F_216 ( sizeof( * V_305 ) , V_19 ) ;
if ( ! V_305 )
return - V_199 ;
V_305 -> V_23 = V_23 ;
V_305 -> V_303 . V_321 = & V_318 ;
V_305 -> V_303 . V_322 = F_352 ;
F_353 ( & V_305 -> V_303 , L_15 , V_23 -> V_107 ) ;
F_354 ( & V_305 -> V_303 , true ) ;
V_15 = F_355 ( & V_305 -> V_303 ) ;
if ( V_15 ) {
F_146 ( V_305 ) ;
V_23 -> V_305 = NULL ;
return V_15 ;
...
if ( V_23 -> V_33 & V_70 ) {
struct V_306 * V_307 ;
for ( V_307 = V_323 ; V_307 -> V_307 . V_107 ; V_307 ++ ) {
V_15 = F_351 ( & V_305 -> V_303 , V_307 ) ;
if ( V_15 ) {
F_356 ( & V_305 -> V_303 ) ;
V_23 -> V_305 = NULL ;
return V_15 ;
...
F_354 ( & V_305 -> V_303 , false ) ;
F_357 ( & V_305 -> V_303 . V_324 , V_325 ) ;
return 0 ;
}
static void F_287 ( struct V_22 * V_23 )
{
struct V_304 * V_305 = V_23 -> V_305 ;
if ( ! V_23 -> V_305 )
return;
V_23 -> V_305 = NULL ;
F_356 ( & V_305 -> V_303 ) ;
...
V_326 = V_73 ;
F_276 (cpu)
F_277 ( V_327 , V_56 ) = V_73 ;
}
static void F_359 ( unsigned long V_32 )
{
unsigned long V_328 = F_360 ( V_329 ) * V_330 ;
bool V_331 = false ;
struct V_13 * V_14 ;
int V_279 ;
if ( ! V_328 )
...
F_361 () ;
F_313 (pool, pi) {
unsigned long V_332 , V_333 , V_334 ;
if ( F_51 ( & V_14 -> V_44 ) )
continue;
V_332 = F_360 ( V_14 -> V_72 ) ;
V_333 = F_360 ( V_326 ) ;
if ( F_362 ( V_332 , V_333 ) )
V_334 = V_332 ;
else
V_334 = V_333 ;
if ( V_14 -> V_56 >= 0 ) {
...
F_360 ( F_277 ( V_327 ,
V_14 -> V_56 ) ) ;
if ( F_362 ( V_335 , V_334 ) )
V_334 = V_335 ;
}
if ( F_362 ( V_73 , V_334 + V_328 ) ) {
V_331 = true ;
F_363 ( L_45 ) ;
F_303 ( V_14 ) ;
F_302 ( L_46 ,
F_314 ( V_73 - V_332 ) / 1000 ) ;
}
}
F_364 () ;
if ( V_331 )
...
static void F_366 ( unsigned long V_328 )
{
V_329 = 0 ;
F_200 ( & V_336 ) ;
if ( V_328 ) {
V_329 = V_328 ;
F_358 () ;
F_128 ( & V_336 , V_73 + V_328 * V_330 ) ;
}
}
static int F_367 ( const char * V_311 ,
const struct V_337 * V_338 )
{
unsigned long V_328 ;
int V_15 ;
V_15 = F_368 ( V_311 , 0 , & V_328 ) ;
if ( V_15 )
return V_15 ;
if ( V_339 )
F_366 ( V_328 ) ;
...
V_245 = F_215 ( V_19 ) ;
F_254 ( ! V_245 ) ;
V_340 = F_216 ( V_238 * sizeof( V_340 [ 0 ] ) , V_19 ) ;
F_254 ( ! V_340 ) ;
F_244 (node)
F_254 ( ! F_372 ( & V_340 [ V_24 ] , V_19 ,
F_373 ( V_24 ) ? V_24 : V_25 ) ) ;
F_276 (cpu) {
V_24 = F_113 ( V_56 ) ;
if ( F_116 ( V_24 == V_25 ) ) {
F_104 ( L_48 , V_56 ) ;
...
{
int V_342 [ V_343 ] = { 0 , V_344 } ;
int V_267 , V_56 ;
F_116 ( F_376 ( struct V_21 ) < F_376 (long long) ) ;
F_254 ( ! F_217 ( & V_96 , V_19 ) ) ;
F_218 ( V_96 , V_205 ) ;
V_222 = F_377 ( V_21 , V_345 ) ;
F_378 ( F_321 , V_346 ) ;
F_379 ( F_322 , V_347 ) ;
F_370 () ;
F_276 (cpu) {
...
F_254 ( F_227 ( V_14 ) ) ;
V_14 -> V_56 = V_56 ;
F_218 ( V_14 -> V_125 -> V_126 , F_380 ( V_56 ) ) ;
V_14 -> V_125 -> V_134 = V_342 [ V_267 ++ ] ;
...
for ( V_267 = 0 ; V_267 < V_343 ; V_267 ++ ) {
struct V_203 * V_125 ;
F_254 ( ! ( V_125 = F_215 ( V_19 ) ) ) ;
V_125 -> V_134 = V_342 [ V_267 ] ;
V_252 [ V_267 ] = V_125 ;
F_254 ( ! ( V_125 = F_215 ( V_19 ) ) ) ;
V_125 -> V_134 = V_342 [ V_267 ] ;
V_125 -> V_208 = true ;
...
V_339 = F_381 ( L_49 , 0 , 0 ) ;
V_295 = F_381 ( L_50 , V_248 , 0 ) ;
V_348 = F_381 ( L_51 , 0 , 0 ) ;
V_349 = F_381 ( L_52 , V_70 ,
V_254 ) ;
V_350 = F_381 ( L_53 ,
V_227 , 0 ) ;
V_351 = F_381 ( L_54 ,
