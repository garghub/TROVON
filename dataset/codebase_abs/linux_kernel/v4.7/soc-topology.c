...
V_51 -> V_20 = V_208 -> V_217 ;
V_51 -> V_218 = V_208 -> V_209 ;
V_51 -> V_219 = L_43 ;
V_51 -> V_220 = L_44 ;
V_51 -> V_221 = 1 ;
V_51 -> V_222 = V_208 -> V_211 ;
V_51 -> V_223 = V_208 -> V_213 ;
V_36 = F_16 ( V_2 , V_51 ) ;
if ( V_36 < 0 ) {
...
if ( V_2 -> V_40 != V_227 )
return 0 ;
V_226 = (struct V_225 * ) V_2 -> V_8 ;
if ( V_226 -> V_11 != sizeof( * V_226 ) ) {
F_2 ( V_2 -> V_12 , L_50 ) ;
return - V_13 ;
}
V_2 -> V_8 += sizeof( struct V_225 ) ;
if ( V_2 -> V_37 && V_2 -> V_30 && V_2 -> V_30 -> V_226 )
return V_2 -> V_30 -> V_226 ( V_2 -> V_37 , V_226 ) ;
F_2 ( V_2 -> V_12 , L_51 ) ;
return 0 ;
}
...
F_39 ( V_2 -> V_12 ,
L_57 ,
V_28 -> V_165 , V_28 -> type , V_28 -> V_232 ,
V_28 -> V_39 , V_2 -> V_40 ) ;
return 1 ;
}
...
struct V_244 * V_30 , const struct V_245 * V_9 , V_154 V_20 )
{
struct V_1 V_2 ;
...
return;
F_29 ( V_43 -> V_174 -> V_246 , & V_43 -> V_67 , V_83 ) ;
}
