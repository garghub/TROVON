...
strncpy ( V_17 -> V_52 , L_7 , sizeof( V_17 -> V_52 ) ) ;
if ( F_20 ( V_30 , L_8 , & V_3 ) == 0 ||
F_20 ( V_30 , L_9 , & V_3 ) == 0 ) {
V_17 -> V_18 = V_3 ;
} else {
F_16 ( V_30 , L_10 ) ;
...
if ( F_20 ( V_30 , L_11 , & V_3 ) == 0 ||
F_20 ( V_30 , L_12 , & V_3 ) == 0 ) {
V_17 -> V_35 = ( V_54 ) V_3 ;
} else {
F_16 ( V_30 , L_13 ) ;
return - V_53 ;
}
if ( F_20 ( V_30 , L_14 , & V_3 ) == 0 ) {
V_17 -> V_21 = ( V_54 ) V_3 ;
} else {
if ( F_20 ( V_30 , L_15 , & V_3 ) ) {
F_16 ( V_30 ,
L_16 ) ;
return - V_53 ;
}
...
? V_17 . V_18
: ( V_17 . V_18 / 1024 ) ,
( V_17 . V_18 < 1024 ) ? L_21 : L_22 ,
V_6 -> V_17 . V_52 ,
( V_17 . V_21 & V_58 ) ? L_23 : L_24 ,
V_6 -> V_17 . V_35 ) ;
return 0 ;
}
