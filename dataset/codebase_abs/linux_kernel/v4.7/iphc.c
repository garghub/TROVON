...
V_87 . V_12 [ 11 ] = 0xFF ;
V_87 . V_12 [ 12 ] = 0xFE ;
memcpy ( & V_87 . V_12 [ 14 ] , & V_2 -> V_12 [ 14 ] , 2 ) ;
F_20 ( & V_87 , & V_20 -> V_27 , V_20 -> V_26 ) ;
if ( F_14 ( & V_87 , V_2 ) ) {
F_44 ( V_85 , & V_2 -> V_12 [ 14 ] , 2 ) ;
V_88 = V_38 ;
goto V_89;
}
memset ( & V_87 , 0 , sizeof( V_87 ) ) ;
memcpy ( & V_87 . V_12 [ 8 ] , & V_2 -> V_12 [ 8 ] , 8 ) ;
F_20 ( & V_87 , & V_20 -> V_27 , V_20 -> V_26 ) ;
if ( F_14 ( & V_87 , V_2 ) ) {
F_44 ( V_85 , & V_2 -> V_12 [ 8 ] , 8 ) ;
V_88 = V_36 ;
goto V_89;
}
F_45 ( 1 , L_19 ) ;
...
if ( F_54 ( V_2 ) ) {
F_17 ( L_25 ) ;
F_44 ( V_85 , & V_2 -> V_12 [ 15 ] , 1 ) ;
V_53 = V_40 ;
} else if ( F_55 ( V_2 ) ) {
F_17 ( L_26 ) ;
F_44 ( V_85 , & V_2 -> V_12 [ 1 ] , 1 ) ;
F_44 ( V_85 , & V_2 -> V_12 [ 13 ] , 3 ) ;
V_53 = V_38 ;
} else if ( F_56 ( V_2 ) ) {
F_17 ( L_27 ) ;
F_44 ( V_85 , & V_2 -> V_12 [ 1 ] , 1 ) ;
F_44 ( V_85 , & V_2 -> V_12 [ 11 ] , 5 ) ;
V_53 = V_36 ;
} else {
F_17 ( L_28 ) ;
F_44 ( V_85 , V_2 -> V_12 , 16 ) ;
V_53 = V_34 ;
}
return V_53 ;
}
...
V_61 = V_102 ;
V_62 = 0 ;
F_18 ( V_65 , L_32 , V_59 , V_7 ) ;
F_18 ( V_65 , L_33 , V_58 , V_7 ) ;
F_28 ( V_65 , L_34 ,
V_31 -> V_66 , V_31 -> V_67 ) ;
V_98 = F_60 ( & V_46 -> V_58 ) ;
F_29 ( & F_7 ( V_17 ) -> V_20 . V_78 ) ;
...
if ( V_61 & V_71 ) {
V_19 = F_63 ( V_31 , V_46 , & V_85 ) ;
if ( V_19 < 0 )
return V_19 ;
}
V_92 [ 0 ] = V_61 ;
V_92 [ 1 ] = V_62 ;
F_64 ( V_31 , sizeof( struct V_45 ) ) ;
F_65 ( V_31 ) ;
