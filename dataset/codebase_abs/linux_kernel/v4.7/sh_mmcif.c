...
switch ( V_208 -> V_210 ) {
case V_211 :
if ( ! F_69 ( V_196 -> V_212 . V_213 ) )
F_70 ( V_196 , V_196 -> V_212 . V_213 , V_208 -> V_214 ) ;
if ( ! V_2 -> V_215 ) {
F_71 ( V_2 -> V_65 ) ;
F_72 ( V_10 ) ;
F_36 ( V_2 ) ;
...
case V_216 :
if ( ! F_69 ( V_196 -> V_212 . V_213 ) )
F_70 ( V_196 , V_196 -> V_212 . V_213 , 0 ) ;
if ( V_2 -> V_215 ) {
F_30 ( V_2 , 0 ) ;
F_29 ( V_2 ) ;
F_73 ( V_10 ) ;
...
static T_5 F_82 ( int V_225 , void * V_226 )
{
...
static T_5 F_87 ( int V_225 , void * V_226 )
{
struct V_1 * V_2 = V_226 ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
T_1 V_103 , V_41 ;
...
static void F_88 ( struct V_238 * V_239 )
{
struct V_240 * V_241 = F_89 ( V_239 ) ;
struct V_1 * V_2 = F_90 ( V_241 , struct V_1 , V_190 ) ;
struct V_7 * V_8 = V_2 -> V_8 ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
unsigned long V_127 ;
if ( V_2 -> V_242 )
...
F_17 ( F_93 ( V_196 ) , L_35 ) ;
}
static int F_94 ( struct V_246 * V_247 )
{
int V_23 = 0 , V_225 [ 2 ] ;
struct V_195 * V_196 ;
struct V_1 * V_2 ;
...
void T_6 * V_3 ;
const char * V_248 ;
V_225 [ 0 ] = F_95 ( V_247 , 0 ) ;
V_225 [ 1 ] = F_95 ( V_247 , 1 ) ;
if ( V_225 [ 0 ] < 0 ) {
F_41 ( V_10 , L_36 ) ;
return - V_249 ;
}
...
if ( F_69 ( V_3 ) )
return F_97 ( V_3 ) ;
V_196 = F_98 ( sizeof( struct V_1 ) , V_10 ) ;
if ( ! V_196 )
return - V_250 ;
V_23 = F_99 ( V_196 ) ;
if ( V_23 < 0 )
...
if ( V_23 < 0 )
goto V_265;
F_105 ( & V_2 -> V_190 , F_88 ) ;
F_36 ( V_2 ) ;
F_38 ( V_2 -> V_5 , V_115 , V_266 ) ;
V_248 = V_225 [ 1 ] < 0 ? F_9 ( V_10 ) : L_38 ;
V_23 = F_106 ( V_10 , V_225 [ 0 ] , F_87 ,
F_82 , 0 , V_248 , V_2 ) ;
if ( V_23 ) {
...
static int F_115 ( struct V_246 * V_247 )
{
struct V_1 * V_2 = F_116 ( V_247 ) ;
V_2 -> V_242 = true ;
F_71 ( V_2 -> V_65 ) ;
F_72 ( & V_247 -> V_10 ) ;
F_117 ( & V_247 -> V_10 ) ;
