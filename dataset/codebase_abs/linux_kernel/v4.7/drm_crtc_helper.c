...
{
struct V_1 * V_2 ;
struct V_19 * * V_58 , * V_59 ;
struct V_14 * * V_60 , * V_61 , * V_15 ;
bool V_62 = false ;
bool V_63 = false ;
struct V_3 * V_4 ;
...
F_35 ( ! V_57 -> V_20 ) ;
F_35 ( ! V_57 -> V_20 -> V_23 ) ;
F_35 ( ! V_57 -> V_35 && V_57 -> V_32 ) ;
F_35 ( V_57 -> V_32 && V_57 -> V_69 == 0 ) ;
V_29 = V_57 -> V_20 -> V_23 ;
if ( ! V_57 -> V_35 )
V_57 -> V_32 = NULL ;
if ( V_57 -> V_32 ) {
...
V_2 = V_57 -> V_20 -> V_2 ;
F_17 ( V_2 ) ;
V_58 = F_36 ( V_2 -> V_12 . V_70 *
sizeof( struct V_19 * ) , V_71 ) ;
if ( ! V_58 )
return - V_72 ;
V_60 = F_36 ( V_2 -> V_12 . V_73 *
...
V_63 = true ;
if ( ! F_38 ( V_57 -> V_35 , & V_57 -> V_20 -> V_35 ) ) {
F_26 ( L_10 ) ;
F_39 ( & V_57 -> V_20 -> V_35 ) ;
F_39 ( V_57 -> V_35 ) ;
V_62 = true ;
...
F_26 ( L_20 , V_57 -> V_75 [ V_68 ] -> V_50 . V_51 ,
V_57 -> V_75 [ V_68 ] -> V_52 ) ;
V_57 -> V_75 [ V_68 ] -> V_82 -> V_26 ( V_57 -> V_75 [ V_68 ] , V_79 ) ;
}
}
F_16 ( V_2 ) ;
} else if ( V_63 ) {
...
static void F_44 ( struct V_14 * V_15 , int V_35 )
{
...
int F_46 ( struct V_3 * V_4 , int V_35 )
{
...
int F_50 ( struct V_19 * V_20 , struct V_34 * V_35 ,
...
int F_56 ( struct V_19 * V_20 , int V_36 , int V_37 ,
struct V_38 * V_39 )
{
struct V_105 * V_106 ;
