...
if ( V_237 ) {
V_236 = ( V_237 [ 1 ] & V_243 ) &&
F_141 ( V_244 , & V_99 -> V_194 ) ;
V_235 = ( V_237 [ 1 ] & V_245 ) &&
F_141 ( V_246 , & V_99 -> V_194 ) ;
}
if ( ! ( V_236 || V_235 ) )
V_2 -> V_42 -> V_247 ( V_2 , V_232 , L_74 ) ;
if ( V_2 -> V_81 & V_248 )
V_2 -> V_42 -> V_249 ( V_2 , V_99 , V_232 ) ;
V_2 -> V_42 -> V_250 ( V_2 , V_99 , V_232 ) ;
F_23 ( V_2 ) ;
}
if ( F_157 ( & V_232 -> V_239 ) & V_251 ) {
V_2 = F_153 ( V_56 ) ;
V_2 -> V_42 -> V_252 ( V_2 , V_232 -> V_253 . V_254 . V_255 ) ;
F_23 ( V_2 ) ;
}
if ( ! V_99 )
return;
...
V_233 = NULL ;
V_228 = 0 ;
if ( F_157 ( & V_232 -> V_239 ) == ( V_240 | V_241 ) &&
F_158 ( & V_232 -> V_239 ) == 0 ) {
V_99 -> V_203 = V_258 ;
V_99 -> V_151 = V_234 ;
...
if ( V_2 -> V_42 -> V_247 )
V_2 -> V_42 -> V_247 ( V_2 , V_232 , L_79 ) ;
V_2 -> V_42 -> V_250 ( V_2 , NULL , V_232 ) ;
F_23 ( V_2 ) ;
V_68:
return V_264 ;
}
...
if ( V_237 && V_237 [ 1 ] & V_243 &&
F_141 ( V_244 , & V_99 -> V_194 ) )
continue;
if ( F_158 ( & V_99 -> V_232 . V_239 ) == 0x40 &&
...
char * V_237 = NULL ;
if ( F_285 ( & V_232 -> V_239 ) && ( V_232 -> V_239 . V_393 . V_394 == 0x01 ) ) {
if ( V_232 -> V_239 . V_393 . V_395 )
V_392 = F_286 ( (struct V_395 * ) ( unsigned long )
V_232 -> V_239 . V_393 . V_395 ) ;
...
} else if ( V_232 -> V_253 . V_400 . V_401 . V_402 ) {
V_237 = V_232 -> V_403 ;
}
return V_237 ;
}
