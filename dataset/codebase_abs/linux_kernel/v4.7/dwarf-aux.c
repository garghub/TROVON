...
V_41 = L_12 ;
return F_71 ( V_100 , L_13 , V_41 , F_18 ( & type ) ) ;
}
V_7 = F_69 ( & type , V_100 ) ;
return V_7 ? V_7 : F_72 ( V_100 , V_41 ) ;
}
...
if ( V_7 < 0 ) {
F_39 ( L_14 ) ;
V_7 = F_70 ( V_100 , L_15 , 14 ) ;
}
return V_7 < 0 ? V_7 : F_71 ( V_100 , L_16 , F_18 ( V_24 ) ) ;
}
...
V_112 -= V_113 ;
if ( V_114 ) {
V_7 = F_71 ( V_100 , L_17 V_116 L_18 V_116 ,
V_20 , V_111 , V_112 ) ;
V_114 = false ;
} else {
V_7 = F_71 ( V_100 , L_19 V_116 L_18 V_116 ,
V_111 , V_112 ) ;
}
if ( V_7 < 0 )
goto V_115;
...
return - V_88 ;
while ( ( V_109 = F_78 ( & V_8 , V_109 , & V_110 ,
