...
static bool F_71 ( struct V_146 * V_147 , void * V_107 )
{
struct V_148 * V_149 = V_107 ;
if ( ! V_149 )
return false ;
if ( V_149 -> V_150 == V_147 -> V_151 -> V_67 ) {
V_147 -> V_152 = V_149 ;
return true ;
}
return false ;
...
struct V_88 * T_2
F_72 ( unsigned int V_89 , struct V_153 * V_115 )
{
struct V_88 * V_90 ;
struct V_148 * V_154 ;
T_1 V_155 ;
...
if ( V_89 != 0 || ! V_115 )
return NULL ;
if ( ! V_115 -> V_157 [ 0 ] . V_158 && ! V_115 -> V_157 [ 1 ] . V_158 )
return NULL ;
V_90 = F_46 ( L_7 , V_89 ) ;
if ( ! V_90 )
goto V_159;
...
F_48 ( V_160 ) ) )
goto V_159;
V_154 = F_73 ( sizeof( * V_154 ) , V_161 ) ;
if ( ! V_154 )
goto V_159;
V_154 -> V_150 = & V_80 . V_67 ;
V_154 -> V_162 = 0 ;
V_154 -> V_163 = 1 ;
V_154 -> V_164 = 1 ;
V_154 -> V_165 = 0 ;
...
V_155 |= 1 << 11 ;
V_155 |= 1 << 12 ;
if ( F_75 ( V_115 -> V_157 [ 0 ] . V_169 ) )
F_66 ( V_115 -> V_157 [ 0 ] . V_169 , 0 ) ;
if ( F_75 ( V_115 -> V_157 [ 0 ] . V_170 ) )
F_66 ( V_115 -> V_157 [ 0 ] . V_170 , 0 ) ;
break;
case 0 :
break;
default:
...
F_49 ( V_95 , V_155 , V_96 , 0 ) ;
V_156 = 0 ;
switch ( V_115 -> V_157 [ 1 ] . V_158 ) {
case 4 :
V_156 |= 1 << 8 ;
V_156 |= 1 << 9 ;
V_156 |= 1 << 10 ;
...
V_156 |= 1 << 6 ;
V_156 |= 1 << 7 ;
F_49 ( V_99 , V_156 , V_103 , 0 ) ;
if ( F_75 ( V_115 -> V_157 [ 1 ] . V_169 ) )
F_66 ( V_115 -> V_157 [ 1 ] . V_169 , 0 ) ;
if ( F_75 ( V_115 -> V_157 [ 1 ] . V_170 ) )
F_66 ( V_115 -> V_157 [ 1 ] . V_170 , 0 ) ;
break;
case 0 :
break;
default:
...
goto V_168;
V_115 -> V_157 [ 1 ] . V_158 = 0 ;
break;
}
V_171 . V_67 = & V_90 -> V_67 ;
F_50 ( V_90 ) ;
return V_90 ;
V_168:
F_76 ( V_154 ) ;
...
struct V_88 * T_2
F_77 ( unsigned int V_89 , struct V_172 * V_115 ,
...
V_177 = F_78 ( V_115 -> V_184 ,
sizeof( struct V_176 ) , V_161 ) ;
if ( ! V_177 )
return NULL ;
V_180 = sizeof( struct V_178 ) * V_177 -> V_185 ;
V_179 = F_78 ( V_177 -> V_179 , V_180 , V_161 ) ;
if ( ! V_179 )
goto V_186;
V_177 -> V_179 = V_179 ;
switch ( V_89 ) {
...
if ( V_91 == 0ULL )
V_91 = V_188 | V_189 ;
V_181 = V_91 & 0xfff80000 ;
F_49 ( V_126 , V_181 , V_96 , 0 ) ;
V_182 = V_91 & 0x0003ffff ;
F_49 ( V_128 , V_182 , V_96 , 0 ) ;
V_183 = ( V_91 >> 32 ) & 0x0007ffff ;
F_49 ( V_190 , V_183 , V_103 , 0 ) ;
F_79 ( & V_191 , & V_70 ) ;
F_80 ( & V_191 , F_81 ( & V_70 ) ) ;
break;
default:
goto V_192;
}
if ( V_174 ) {
V_90 -> V_112 [ 2 ] . V_113 = V_173 ;
V_90 -> V_112 [ 2 ] . V_193 = V_173 + V_174 - 1 ;
V_90 -> V_112 [ 2 ] . V_45 = V_194 ;
}
V_175 = V_90 -> V_67 . V_116 ;
memcpy ( V_175 , V_115 , sizeof( struct V_172 ) ) ;
V_175 -> V_184 = V_177 ;
V_90 -> V_32 = L_8 ;
F_44 ( V_90 ) ;
return V_90 ;
...
struct V_88 * T_2
F_84 ( unsigned int V_89 , struct V_207 * V_115 )
{
struct {
struct V_207 V_107 ;
struct V_208 V_209 [ 7 ] ;
} V_210 ;
struct V_88 * V_90 ;
if ( V_89 != 0 )
return NULL ;
...
goto V_196;
if ( V_115 ) {
V_210 . V_107 . V_212 = V_115 -> V_212 ;
V_210 . V_107 . V_213 = V_115 -> V_213 ;
} else {
V_210 . V_107 . V_212 = - V_22 ;
V_210 . V_107 . V_213 = - V_22 ;
}
V_115 = & V_210 . V_107 ;
V_115 -> V_214 = F_48 ( V_215 ) ;
memcpy ( V_115 -> V_209 , V_215 , sizeof( V_215 ) ) ;
if ( F_74 ( V_90 , V_115 , sizeof( V_210 ) ) )
goto V_196;
if ( F_75 ( V_115 -> V_212 ) )
F_66 ( V_115 -> V_212 , 0 ) ;
V_216 . V_67 = & V_90 -> V_67 ;
V_217 . V_67 = & V_90 -> V_67 ;
F_50 ( V_90 ) ;
return V_90 ;
V_196:
F_51 ( V_90 ) ;
...
{
static unsigned int V_220 [ 4 ] T_4 = {
( 1 << 25 ) ,
( 1 << 26 ) ,
( 1 << 27 ) ,
( 1 << 28 ) ,
...
V_91 |= ( 1 << 23 ) ;
V_91 |= ( 1 << 24 ) ;
F_49 ( V_190 , V_91 , V_96 , 0 ) ;
T_6 = true ;
}
F_49 ( V_99 , V_221 , V_96 , V_227 ) ;
V_90 -> V_112 [ 1 ] . V_113 = V_228 + V_219 ;
V_90 -> V_112 [ 1 ] . V_193 = V_90 -> V_112 [ 1 ] . V_113 ;
return 0 ;
}
struct V_88 * T_2
F_86 ( unsigned int V_89 , unsigned int V_219 ,
struct V_229 * V_115 )
{
struct V_88 * V_90 ;
V_90 = F_46 ( L_11 , V_89 ) ;
...
sizeof( struct V_229 ) ) )
goto V_159;
if ( F_85 ( V_90 , V_115 -> V_218 , V_219 ) )
goto V_159;
F_50 ( V_90 ) ;
return V_90 ;
V_159:
...
struct V_88 * T_2
F_87 ( unsigned int V_89 , unsigned int V_219 ,
struct V_230 * V_115 )
{
struct V_88 * V_90 ;
V_90 = F_46 ( L_12 , V_89 ) ;
...
struct V_88 * T_2
F_88 ( unsigned int V_89 , struct V_233 * V_115 )
{
struct V_88 * V_90 ;
if ( V_89 != 0 || ! V_115 )
return NULL ;
...
struct V_88 * T_2
F_89 ( unsigned int V_89 , struct V_240 * V_115 ,
unsigned int V_45 )
{
struct V_88 * V_90 ;
struct V_148 * V_241 ;
...
if ( ! V_115 ) {
V_115 = & V_243 ;
memset ( V_115 , 0 , sizeof( struct V_240 ) ) ;
V_115 -> V_231 = - V_246 ;
}
V_241 = & V_115 -> V_241 ;
V_242 = & V_115 -> V_242 ;
if ( V_45 & V_247 ) {
V_241 -> V_150 = & V_80 . V_67 ;
V_241 -> V_162 = 3 ;
V_241 -> V_164 = 0 ;
V_241 -> V_165 = 1 ;
}
if ( V_45 & V_248 ) {
V_242 -> V_150 = & V_80 . V_67 ;
V_242 -> V_163 = 4 ;
V_242 -> V_164 = 0 ;
V_242 -> V_165 = 1 ;
}
...
struct V_88 * T_2
F_90 ( unsigned int V_89 , struct V_250 * V_115 )
{
struct V_88 * V_90 ;
struct V_148 * V_251 ;
T_1 V_91 ;
...
V_91 |= ( 1 << 21 ) | ( 1 << 23 ) ;
F_49 ( V_99 , V_91 , V_96 , 0 ) ;
V_253 . V_67 = & V_90 -> V_67 ;
V_254 . V_67 = & V_90 -> V_67 ;
F_50 ( V_90 ) ;
return V_90 ;
V_245:
F_51 ( V_90 ) ;
...
void T_2 F_91 ( void )
{
T_1 V_255 = 0 , V_256 = 0 , V_257 = 0 , V_258 = 0 ;
int V_259 ;
if ( F_9 ( V_260 ) & F_7 ( V_71 ) ) {
V_44 = & V_70 ;
V_261 . V_9 = & V_70 ;
} else {
V_44 = & V_42 ;
...
F_39 ( & V_265 ) ;
F_39 ( & V_266 ) ;
#if F_92 ( V_267 ) || F_92 ( V_268 )
F_39 ( & V_191 ) ;
#endif
F_39 ( & V_254 ) ;
for ( V_259 = 0 ; V_259 < F_48 ( V_269 ) ; V_259 ++ ) {
struct V_1 * V_1 = V_269 [ V_259 ] ;
F_93 ( V_1 ) ;
if ( V_1 -> V_39 == 0 )
continue;
if ( V_1 -> V_135 == & F_20 )
...
if ( ! V_271 )
goto V_159;
if ( F_97 ( V_271 , 0x24000000 , 0x8000 , - 1 ) )
goto V_272;
V_273 = V_271 ;
return 0 ;
V_272:
