...
break;
V_3 = F_10 ( V_12 ,
V_20 [ V_18 ] . V_25 + 4 , V_20 [ V_18 ] . V_24 - 4 ) ;
} else {
V_3 = F_10 ( V_12 ,
V_20 [ V_18 ] . V_25 , V_20 [ V_18 ] . V_24 ) ;
}
if ( V_3 ) {
F_4 ( V_8 , L_4 ,
V_27 ) ;
...
int V_3 = 0 ;
char V_38 [ 20 ] ;
struct V_39 * V_40 = (struct V_39 * ) V_16 -> V_21 [ 0 ] . V_25 ;
...
struct V_19 V_20 ;
V_20 . V_25 = V_40 ;
V_20 . V_24 = F_20 ( V_40 -> V_53 ) + 4 ;
return F_18 ( & V_20 , 1 , V_2 ,
V_37 ) ;
}
...
V_111 = (struct V_110 * )
( V_67 -> V_74 . V_36 + V_71 ) ;
V_111 -> V_125 = F_17 ( 0x00000101 ) ;
V_111 -> V_126 = 0 ;
V_111 -> time = V_123 ;
F_49 ( & V_111 -> V_127 , sizeof( V_111 -> V_127 ) ) ;
V_111 -> V_128 = 0 ;
...
struct V_134 * V_135 ;
unsigned char V_136 [ V_71 ] ;
F_49 ( V_136 , V_71 ) ;
V_130 = F_51 ( L_32 , 0 , V_137 ) ;
if ( F_3 ( V_130 ) ) {
V_3 = F_5 ( V_130 ) ;
F_4 ( V_8 , L_33 ) ;
return V_3 ;
}
V_3 = F_52 ( V_130 , V_67 -> V_74 . V_36 ,
V_71 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_34 ,
V_27 ) ;
...
V_135 = F_53 ( V_130 , V_10 ) ;
if ( ! V_135 ) {
V_3 = - V_11 ;
F_4 ( V_8 , L_35 ) ;
goto V_138;
}
F_54 ( & V_132 , V_136 , V_71 ) ;
F_54 ( & V_133 , V_67 -> V_118 -> V_139 , V_140 ) ;
F_55 ( V_135 , 0 , NULL , NULL ) ;
F_56 ( V_135 , & V_132 , & V_133 , V_140 , NULL ) ;
V_3 = F_57 ( V_135 ) ;
F_58 ( V_135 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_36 , V_3 ) ;
...
memcpy ( V_67 -> V_74 . V_36 , V_136 , V_71 ) ;
V_67 -> V_74 . V_31 = V_71 ;
V_138:
F_59 ( V_130 ) ;
return V_3 ;
