...
goto V_45;
F_14 ( V_35 ) ;
if ( V_27 [ V_32 ] . V_5 != V_46 )
V_35 -> V_5 = V_27 [ V_32 ] . V_5 ;
else
V_35 -> V_5 = F_15 ( V_35 , V_47 ) ;
if ( V_35 -> V_5 == 255 )
V_35 -> V_5 = V_48 ;
if ( V_35 -> V_5 != V_48 )
if ( F_16 ( V_35 -> V_5 , V_49 , 0 ,
L_7 , V_35 ) ) {
F_5 ( L_8 ,
V_35 -> V_50 , V_35 -> V_5 ) ;
V_35 -> V_5 = V_48 ;
...
static int F_18 ( struct V_51 * V_52 , struct V_53 * V_54 ,
T_2 V_55 , int * V_56 )
{
int V_57 = V_55 ;
V_56 [ 0 ] = 64 ;
...
static inline int F_19 ( struct V_34 * V_35 ,
unsigned char * V_58 , int V_59 )
{
register unsigned char * V_60 = V_58 ;
register unsigned short V_61 = ( unsigned short ) ( V_35 -> V_4 +
V_62 ) ;
register int V_24 = V_59 ;
int V_63 = 0 ;
while ( ! ( F_4 ( V_35 -> V_4 + V_64 ) & V_65 ) )
++ V_63 ;
F_20 ( V_61 , V_60 , V_24 ) ;
if ( F_4 ( V_35 -> V_4 + V_10 ) & V_66 ) {
F_2 ( V_67 , V_35 -> V_4 + V_10 ) ;
F_5 ( L_12 ,
V_35 -> V_50 ) ;
return - 1 ;
}
...
static inline int F_21 ( struct V_34 * V_35 ,
unsigned char * V_68 , int V_59 )
{
register unsigned char * V_69 = V_68 ;
register unsigned short V_61 = ( V_35 -> V_4 + V_62 ) ;
register int V_24 = V_59 ;
int V_63 = 0 ;
while ( ! ( ( F_4 ( V_35 -> V_4 + V_64 ) ) & V_65 ) )
++ V_63 ;
...
static int F_23 ( struct V_34 * V_70 )
{
if ( V_70 -> V_5 != V_48 )
F_24 ( V_70 -> V_5 , V_70 ) ;
F_25 ( V_70 ) ;
