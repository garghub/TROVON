...
if ( V_41 ) {
V_72 V_168 = ( ( 1U << V_41 ) - 1 ) ;
V_7 [ V_160 ] &= ~ ( V_168 << V_162 ) ;
V_7 [ V_160 ] |= V_24 << V_162 ;
}
}
...
static int F_49 ( T_2 * V_171 , T_2 V_24 , unsigned V_41 )
{
while ( V_41 -- ) {
if ( * V_171 ++ == V_24 )
return 0 ;
...
if ( ! F_53 ( & V_62 -> V_186 ) )
F_54 ( V_62 , V_23 , V_24 ) ;
if ( V_185 && V_185 -> V_187 && F_51 ( V_62 , V_23 ) ) {
...
for ( V_41 = 0 ; V_41 < V_95 ; V_41 ++ ) {
if ( V_196 & V_18 -> V_46 ) {
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_41 ] , V_24 [ V_41 ] , V_183 ) ;
continue;
}
...
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_18 -> V_24 [ V_41 ] - V_193 ] , 0 , V_183 ) ;
if ( V_24 [ V_41 ] >= V_193 && V_24 [ V_41 ] <= V_194
&& V_24 [ V_41 ] - V_193 < V_18 -> V_63
&& V_18 -> V_23 [ V_24 [ V_41 ] - V_193 ] . V_62
&& F_49 ( V_18 -> V_24 , V_24 [ V_41 ] , V_95 ) )
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_24 [ V_41 ] - V_193 ] , 1 , V_183 ) ;
}
...
if ( V_199 == V_204 )
F_64 ( V_62 , V_7 -> type , V_156 , V_104 , 0 ) ;
V_203:
F_8 ( V_156 ) ;
}
...
F_56 ( V_62 , V_7 -> V_18 [ V_159 ] , V_206 , V_183 ) ;
V_185 = V_62 -> V_173 ;
if ( V_185 && V_185 -> V_7 )
V_185 -> V_7 ( V_62 , V_7 ) ;
}
...
int F_64 ( struct V_2 * V_62 , int type , V_72 * V_71 , int V_12 , int V_183 )
{
struct V_5 * V_6 ;
struct V_184 * V_185 ;
struct V_1 * V_7 ;
...
if ( V_185 && V_185 -> V_214 && F_50 ( V_62 , V_7 ) ) {
V_104 = V_185 -> V_214 ( V_62 , V_7 , V_71 , V_12 ) ;
if ( V_104 < 0 )
goto V_213;
}
V_104 = F_65 ( V_62 , type , V_71 , V_12 , V_183 ) ;
V_213:
F_70 ( & V_62 -> V_211 ) ;
return V_104 ;
}
static bool F_71 ( struct V_2 * V_215 ,
...
const struct V_216 * F_72 ( struct V_2 * V_215 ,
const struct V_216 * V_4 )
{
for (; V_4 -> V_217 ; V_4 ++ )
if ( F_71 ( V_215 , V_4 ) )
...
static bool F_73 ( struct V_2 * V_215 )
{
return ! ! F_72 ( V_215 , V_220 ) ;
}
static T_5
F_74 ( struct V_221 * V_222 , struct V_223 * V_224 ,
struct V_225 * V_226 ,
char * V_156 , T_6 V_227 , T_7 V_95 )
{
struct V_3 * V_103 = F_75 ( V_224 ) ;
...
static T_5
F_76 ( struct V_3 * V_103 , struct V_228 * V_226 ,
char * V_156 )
{
struct V_2 * V_215 = F_28 ( V_103 ) ;
return sprintf ( V_156 , L_38 , V_215 -> V_229 & 0xff ) ;
}
int F_77 ( struct V_2 * V_215 , unsigned int V_230 )
{
...
void F_83 ( struct V_2 * V_215 )
{
F_84 ( & V_215 -> V_103 , & V_252 ) ;
if ( V_215 -> V_189 & V_190 )
F_85 ( V_215 ) ;
if ( V_215 -> V_189 & V_191 )
V_215 -> V_255 ( V_215 ) ;
...
static T_5 F_87 ( struct V_256 * V_257 , const char * V_156 ,
T_7 V_95 )
{
struct V_184 * V_185 = F_88 ( V_257 ) ;
struct V_258 * V_259 ;
...
static const struct V_216 * F_95 ( struct V_2 * V_215 ,
struct V_184 * V_185 )
{
struct V_258 * V_259 ;
F_89 ( & V_185 -> V_261 ) ;
F_96 (dynid, &hdrv->dyn_list, list) {
if ( F_71 ( V_215 , & V_259 -> V_4 ) ) {
F_90 ( & V_185 -> V_261 ) ;
return & V_259 -> V_4 ;
}
}
F_90 ( & V_185 -> V_261 ) ;
return F_72 ( V_215 , V_185 -> V_263 ) ;
}
static int F_97 ( struct V_3 * V_103 , struct V_256 * V_257 )
{
struct V_184 * V_185 = F_88 ( V_257 ) ;
struct V_2 * V_215 = F_28 ( V_103 ) ;
return F_95 ( V_215 , V_185 ) != NULL ;
}
static int F_98 ( struct V_3 * V_103 )
{
struct V_184 * V_185 = F_88 ( V_103 -> V_173 ) ;
struct V_2 * V_215 = F_28 ( V_103 ) ;
const struct V_216 * V_4 ;
int V_104 = 0 ;
if ( F_99 ( & V_215 -> V_264 ) )
...
static T_5 F_103 ( struct V_3 * V_103 , struct V_228 * V_159 ,
char * V_156 )
{
struct V_2 * V_215 = F_104 ( V_103 , struct V_2 , V_103 ) ;
return F_105 ( V_156 , V_270 , L_60 ,
V_215 -> V_217 , V_215 -> V_130 , V_215 -> V_136 , V_215 -> V_138 ) ;
}
static int F_106 ( struct V_3 * V_103 , struct V_271 * V_272 )
{
struct V_2 * V_215 = F_28 ( V_103 ) ;
if ( F_107 ( V_272 , L_61 ,
V_215 -> V_217 , V_215 -> V_136 , V_215 -> V_138 ) )
return - V_36 ;
if ( F_107 ( V_272 , L_62 , V_215 -> V_188 ) )
return - V_36 ;
if ( F_107 ( V_272 , L_63 , V_215 -> V_254 ) )
return - V_36 ;
if ( F_107 ( V_272 , L_64 , V_215 -> V_273 ) )
return - V_36 ;
if ( F_107 ( V_272 , L_65 ,
V_215 -> V_217 , V_215 -> V_130 , V_215 -> V_136 , V_215 -> V_138 ) )
return - V_36 ;
...
F_72 ( V_215 , V_300 ) )
return true ;
return ! ! F_72 ( V_215 , V_301 ) ;
}
int F_109 ( struct V_2 * V_215 )
{
static T_8 V_4 = F_110 ( 0 ) ;
int V_104 ;
if ( F_48 ( V_215 -> V_116 & V_302 ) )
return - V_212 ;
if ( F_108 ( V_215 ) )
return - V_210 ;
...
F_111 ( & V_215 -> V_103 , L_70 , V_215 -> V_217 ,
V_215 -> V_136 , V_215 -> V_138 , F_112 ( & V_4 ) ) ;
F_113 ( V_215 , F_20 ( & V_215 -> V_103 ) ) ;
V_104 = F_114 ( & V_215 -> V_103 ) ;
if ( ! V_104 )
V_215 -> V_116 |= V_302 ;
else
F_115 ( V_215 ) ;
...
static void F_123 ( struct V_2 * V_215 )
{
...
void F_125 ( struct V_2 * V_215 )
{
F_123 ( V_215 ) ;
F_126 ( & V_215 -> V_103 ) ;
}
int F_127 ( struct V_184 * V_185 , struct V_310 * V_311 ,
const char * V_312 )
{
int V_104 ;
...
F_26 ( & V_185 -> V_262 ) ;
F_121 ( & V_185 -> V_261 ) ;
V_104 = F_128 ( & V_185 -> V_173 ) ;
if ( V_104 )
return V_104 ;
V_104 = F_129 ( & V_185 -> V_173 , & V_313 ) ;
if ( V_104 )
F_130 ( & V_185 -> V_173 ) ;
return V_104 ;
}
void F_131 ( struct V_184 * V_185 )
{
F_132 ( & V_185 -> V_173 , & V_313 ) ;
F_130 ( & V_185 -> V_173 ) ;
F_92 ( V_185 ) ;
}
...
for ( V_48 = 0 ; V_48 < F_134 ( V_316 ) ; V_48 ++ )
