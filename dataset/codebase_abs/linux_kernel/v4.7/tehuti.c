...
if ( F_33 ( V_196 -> V_223 != V_270 ) )
V_264 = 0 ;
if ( F_137 ( V_196 ) -> V_271 ) {
V_268 = F_137 ( V_196 ) -> V_271 ;
V_265 = 1 ;
F_30 ( L_52 , V_196 , V_196 -> V_207 ,
V_268 ) ;
}
if ( F_148 ( V_196 ) ) {
V_266 = F_149 ( V_196 ) & F_150 ( 12 ) ;
V_267 = 1 ;
}
V_236 -> V_272 = F_115 ( V_196 -> V_207 ) ;
V_236 -> V_273 = F_115 ( V_268 ) ;
V_236 -> V_274 =
F_104 ( F_151
( V_244 [ V_238 ] . V_248 , V_264 , V_267 ,
V_265 , V_266 ) ) ;
F_30 ( L_53 ) ;
F_30 ( L_54 , V_236 -> V_274 ) ;
F_30 ( L_55 , V_236 -> V_273 , V_236 -> V_272 ) ;
...
#endif
V_17 -> V_170 . V_277 ++ ;
V_17 -> V_170 . V_278 += V_196 -> V_207 ;
if ( V_20 -> V_259 < V_279 ) {
F_30 ( L_56 ,
V_280 , V_17 -> V_79 , V_20 -> V_259 ) ;
F_23 ( V_17 ) ;
}
...
( V_20 -> V_259 >= V_279 ) ) ) {
F_30 ( L_57 ,
V_280 , V_20 -> V_17 -> V_79 , V_20 -> V_259 ) ;
F_26 ( V_20 -> V_17 ) ;
}
F_158 ( & V_20 -> V_269 ) ;
}
...
V_321 -> V_338 =
( ( F_188 ( V_100 ) * V_337 ) / sizeof( struct V_190 ) ) ;
return 0 ;
}
static void
...
{
struct V_19 * V_20 = F_32 ( V_319 ) ;
F_190 ( V_340 -> V_341 , V_280 , sizeof( V_340 -> V_341 ) ) ;
F_190 ( V_340 -> V_342 , V_343 , sizeof( V_340 -> V_342 ) ) ;
F_190 ( V_340 -> V_344 , L_70 , sizeof( V_340 -> V_344 ) ) ;
F_190 ( V_340 -> V_345 , F_191 ( V_20 -> V_2 ) ,
sizeof( V_340 -> V_345 ) ) ;
}
static int
F_192 ( struct V_16 * V_319 , struct V_346 * V_347 )
{
V_37 V_100 ;
V_37 V_103 ;
struct V_19 * V_20 = F_32 ( V_319 ) ;
V_100 = V_20 -> V_100 ;
V_103 = V_20 -> V_103 ;
V_347 -> V_348 = F_193 ( V_100 ) * V_349 ;
V_347 -> V_350 =
( ( F_188 ( V_100 ) * V_337 ) / sizeof( struct V_190 ) ) ;
V_347 -> V_351 = F_193 ( V_103 ) * V_349 ;
V_347 -> V_352 =
( ( F_188 ( V_103 ) * V_337 ) / V_284 ) ;
return 0 ;
}
static int
F_194 ( struct V_16 * V_319 , struct V_346 * V_347 )
{
V_37 V_100 ;
V_37 V_103 ;
struct V_19 * V_20 = F_32 ( V_319 ) ;
...
int V_355 ;
int V_356 ;
V_353 = V_347 -> V_348 / V_349 ;
V_354 = V_347 -> V_351 / V_349 ;
V_355 = V_347 -> V_350 ;
V_356 = V_347 -> V_352 ;
V_355 =
( ( ( V_355 * sizeof( struct V_190 ) ) + V_337 - 1 )
/ V_337 ) ;
V_356 =
( ( ( V_356 * V_284 ) + V_337 - 1 )
/ V_337 ) ;
if ( ( V_353 > 0x7FFF ) || ( V_354 > 0x7FFF ) ||
( V_355 > 0xF ) || ( V_356 > 0xF ) )
return - V_127 ;
V_100 = F_178 ( V_353 , F_195 ( V_20 -> V_100 ) ,
F_196 ( V_20 -> V_100 ) , V_355 ) ;
V_103 = F_178 ( V_354 , F_195 ( V_20 -> V_103 ) , 0 ,
V_356 ) ;
V_20 -> V_100 = V_100 ;
V_20 -> V_103 = V_103 ;
...
static inline int F_197 ( int V_357 )
{
return ( V_29 * ( 1 << V_357 ) ) / sizeof( struct V_190 ) ;
}
static inline int F_198 ( int V_358 )
{
return ( V_29 * ( 1 << V_358 ) ) / V_284 ;
}
static void
F_199 ( struct V_16 * V_319 , struct V_359 * V_360 )
{
struct V_19 * V_20 = F_32 ( V_319 ) ;
V_360 -> V_361 = F_197 ( 3 ) ;
V_360 -> V_362 = F_198 ( 3 ) ;
V_360 -> V_363 = F_197 ( V_20 -> V_185 ) ;
V_360 -> V_364 = F_198 ( V_20 -> V_250 ) ;
}
static int
F_200 ( struct V_16 * V_319 , struct V_359 * V_360 )
{
struct V_19 * V_20 = F_32 ( V_319 ) ;
int V_357 = 0 ;
int V_358 = 0 ;
for (; V_357 < 4 ; V_357 ++ ) {
if ( F_197 ( V_357 ) >= V_360 -> V_363 )
break;
}
if ( V_357 == 4 )
V_357 = 3 ;
for (; V_358 < 4 ; V_358 ++ ) {
if ( F_198 ( V_358 ) >= V_360 -> V_364 )
break;
}
if ( V_358 == 4 )
V_358 = 3 ;
...
static void F_201 ( struct V_16 * V_319 , V_37 V_365 , T_6 * V_74 )
{
switch ( V_365 ) {
case V_366 :
memcpy ( V_74 , * V_367 , sizeof( V_367 ) ) ;
break;
}
}
static int F_202 ( struct V_16 * V_319 , int V_365 )
{
struct V_19 * V_20 = F_32 ( V_319 ) ;
switch ( V_365 ) {
case V_366 :
...
return ( V_20 -> V_316 ) ? F_203 ( V_367 ) : 0 ;
}
return - V_127 ;
}
static void F_204 ( struct V_16 * V_319 ,
struct V_368 * V_170 , T_7 * V_74 )
{
struct V_19 * V_20 = F_32 ( V_319 ) ;
if ( V_20 -> V_316 ) {
F_88 ( V_20 ) ;
...
{
static const struct V_369 V_370 = {
. V_371 = F_186 ,
. V_372 = F_189 ,
. V_373 = V_374 ,
. V_375 = F_192 ,
