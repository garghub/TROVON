...
const struct V_29 * T_5 V_32 = NULL ;
struct V_1 * V_1 ;
struct V_33 * V_34 ;
int V_35 ;
...
static int F_48 ( struct V_58 * V_58 )
{
struct V_15 * V_16 = F_30 ( V_58 ) ;
struct V_1 * V_2 = F_26 ( V_16 ) ;
int V_35 ;
F_41 ( V_2 , L_11 ) ;
if ( F_38 ( V_71 , & V_2 -> V_21 ) ) {
V_35 = F_37 ( V_2 ) ;
if ( V_35 < 0 )
return V_35 ;
}
...
static void F_54 ( struct V_58 * V_58 )
{
struct V_15 * V_16 = F_30 ( V_58 ) ;
struct V_1 * V_2 = F_26 ( V_16 ) ;
F_41 ( V_2 , L_14 ) ;
