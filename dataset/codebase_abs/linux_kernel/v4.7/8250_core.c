...
struct V_12 * V_13 = & V_72 [ V_4 ] ;
if ( V_13 -> V_15 . type != V_148 && V_13 -> V_15 . V_108 == & V_108 -> V_108 )
...
return & V_72 [ V_4 ] ;
V_4 = V_15 -> line ;
if ( V_4 < V_89 && V_72 [ V_4 ] . V_15 . type == V_148 &&
V_72 [ V_4 ] . V_15 . V_69 == 0 )
return & V_72 [ V_4 ] ;
for ( V_4 = 0 ; V_4 < V_89 ; V_4 ++ )
if ( V_72 [ V_4 ] . V_15 . type == V_148 &&
V_72 [ V_4 ] . V_15 . V_69 == 0 )
return & V_72 [ V_4 ] ;
for ( V_4 = 0 ; V_4 < V_89 ; V_4 ++ )
if ( V_72 [ V_4 ] . V_15 . type == V_148 )
...
if ( V_13 -> V_15 . V_161 )
V_143 -> V_15 . V_161 = V_13 -> V_15 . V_161 ;
if ( V_13 -> V_15 . V_147 )
V_143 -> V_15 . V_147 = V_13 -> V_15 . V_147 ;
if ( V_13 -> V_15 . V_144 )
V_143 -> V_15 . V_144 = V_13 -> V_15 . V_144 ;
if ( V_13 -> V_162 )
V_143 -> V_162 = V_13 -> V_162 ;
if ( V_13 -> V_163 )
V_143 -> V_163 = V_13 -> V_163 ;
...
F_90 ( & V_138 , & V_143 -> V_15 ) ;
if ( V_165 ) {
V_143 -> V_15 . V_28 &= ~ V_151 ;
if ( V_110 )
V_143 -> V_15 . V_28 |= V_111 ;
V_143 -> V_15 . type = V_148 ;
V_143 -> V_15 . V_108 = & V_165 -> V_108 ;
V_143 -> V_73 = 0 ;
...
{
#undef V_174
#define V_174 "8250_core."
F_111 ( V_96 , & V_175 , & V_96 , 0644 ) ;
F_111 ( V_89 , & V_175 , & V_89 , 0644 ) ;
F_111 ( V_110 , & V_175 , & V_110 , 0644 ) ;
#ifdef F_112
F_113 ( V_174 , V_80 ,
& V_176 , . V_177 = & V_178 ,
0444 , - 1 , 0 ) ;
