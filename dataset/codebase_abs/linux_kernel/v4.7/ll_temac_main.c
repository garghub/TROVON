...
F_21 ( & V_27 -> V_25 , L_11 ) ;
if ( V_2 -> V_175 ) {
V_2 -> V_109 = F_77 ( V_2 -> V_27 , V_2 -> V_175 ,
F_50 , 0 , 0 ) ;
if ( ! V_2 -> V_109 ) {
F_48 ( V_2 -> V_25 , L_12 ) ;
return - V_176 ;
...
if ( ! V_2 -> V_109 )
return - V_185 ;
return F_88 ( V_2 -> V_109 , V_183 , V_184 ) ;
}
...
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
return F_92 ( V_2 -> V_109 , V_184 ) ;
}
static int F_93 ( struct V_26 * V_27 , struct V_190 * V_184 )
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
return F_94 ( V_2 -> V_109 , V_184 ) ;
}
static int F_95 ( struct V_26 * V_27 )
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
return F_96 ( V_2 -> V_109 ) ;
}
...
T_6 * V_71 ;
int V_191 , V_174 = 0 ;
V_27 = F_98 ( sizeof( * V_2 ) ) ;
if ( ! V_27 )
return - V_64 ;
F_99 ( V_19 , V_27 ) ;
F_100 ( V_27 , & V_19 -> V_25 ) ;
V_27 -> V_78 &= ~ V_192 ;
V_27 -> V_193 = V_194 ;
V_27 -> V_195 = & V_196 ;
V_27 -> V_197 = & V_198 ;
...
F_101 ( & V_2 -> V_157 ) ;
F_102 ( & V_2 -> V_65 ) ;
V_2 -> V_4 = F_103 ( V_19 -> V_25 . V_200 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_48 ( & V_19 -> V_25 , L_18 ) ;
V_174 = - V_64 ;
goto V_201;
...
V_2 -> V_159 = 0 ;
V_71 = ( T_6 * ) F_104 ( V_19 -> V_25 . V_200 , L_19 , NULL ) ;
if ( V_71 && F_105 ( * V_71 ) ) {
V_2 -> V_159 |= V_202 ;
V_27 -> V_193 |= V_203 ;
}
V_71 = ( T_6 * ) F_104 ( V_19 -> V_25 . V_200 , L_20 , NULL ) ;
if ( V_71 && F_105 ( * V_71 ) )
V_2 -> V_159 |= V_160 ;
V_21 = F_106 ( V_19 -> V_25 . V_200 , L_21 , 0 ) ;
if ( ! V_21 ) {
F_48 ( & V_19 -> V_25 , L_22 ) ;
V_174 = - V_176 ;
goto V_204;
...
V_2 -> V_180 = F_108 ( V_21 , 0 ) ;
V_2 -> V_177 = F_108 ( V_21 , 1 ) ;
F_107 ( V_21 ) ;
...
V_73 = F_104 ( V_19 -> V_25 . V_200 , L_26 , & V_191 ) ;
if ( ( ! V_73 ) || ( V_191 != 6 ) ) {
F_48 ( & V_19 -> V_25 , L_27 ) ;
V_174 = - V_176 ;
goto V_205;
...
F_36 ( V_27 , ( void * ) V_73 ) ;
V_174 = F_109 ( V_2 , V_19 -> V_25 . V_200 ) ;
if ( V_174 )
F_110 ( & V_19 -> V_25 , L_28 ) ;
V_2 -> V_175 = F_106 ( V_19 -> V_25 . V_200 , L_29 , 0 ) ;
if ( V_2 -> V_175 )
F_21 ( V_2 -> V_25 , L_30 , V_21 -> V_206 , V_21 ) ;
V_174 = F_111 ( & V_2 -> V_25 -> V_207 , & V_208 ) ;
if ( V_174 ) {
F_48 ( V_2 -> V_25 , L_31 ) ;
goto V_205;
}
V_174 = F_112 ( V_2 -> V_27 ) ;
if ( V_174 ) {
