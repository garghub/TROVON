...
{
int V_19 = 0 ;
struct V_198 * V_199 = V_16 -> V_69 ;
T_1 V_200 = F_34 ( V_199 -> V_200 ) ;
switch ( V_200 ) {
case V_201 :
V_19 = F_53 ( V_2 , V_16 ) ;
break;
...
{
struct V_203 V_14 = { 0 } ;
struct V_204 * V_144 = V_2 -> V_145 ;
F_6 ( V_2 , & V_14 , V_205 , - 1 , - 1 ) ;
V_14 . V_24 = F_7 ( 0xffff ) ;
F_20 ( & V_2 -> V_64 ) ;
if ( F_21 ( V_2 , & V_14 , sizeof( V_14 ) , V_26 ) )
goto V_206;
if ( ! F_55 ( V_144 -> V_207 , V_2 -> V_16 . V_30 ) )
memcpy ( V_2 -> V_16 . V_30 , V_144 -> V_207 , V_31 ) ;
if ( F_54 ( V_2 -> V_16 . V_30 ) )
memcpy ( V_2 -> V_6 -> V_208 , V_2 -> V_16 . V_30 , V_31 ) ;
V_206:
F_22 ( & V_2 -> V_64 ) ;
}
...
if ( ! F_63 ( V_2 ) )
return 0 ;
if ( V_2 -> V_210 < 0x10202 ) {
if ( F_54 ( V_2 -> V_16 . V_30 ) )
V_19 = - V_211 ;
goto V_212;
}
F_6 ( V_2 , & V_14 , V_213 , - 1 , - 1 ) ;
V_14 . V_44 = F_8 ( V_214 ) ;
memcpy ( V_14 . V_46 , V_29 , V_31 ) ;
V_19 = F_9 ( V_2 , & V_14 , sizeof( V_14 ) , V_26 ) ;
V_212:
