...
int V_170 = - 1 ;
F_15 ( & V_171 ) ;
for ( V_169 = 0 ; V_169 < sizeof( V_172 ) * 8 ; V_169 ++ ) {
if ( ( V_172 & ( 1 << V_169 ) ) == 0 ) {
V_172 |= ( 1 << V_169 ) ;
V_21 -> V_164 = V_169 ;
F_35 ( & V_21 -> V_173 ) ;
F_50 ( & V_21 -> V_174 , & V_175 ) ;
V_170 = 0 ;
break;
}
}
...
struct V_4 * V_21 , unsigned int V_181 )
{
int V_182 ;
unsigned int V_169 ;
struct V_1 * V_51 ;
struct V_1 * V_176 ;
for ( V_169 = 0 ; V_169 < V_181 ; V_169 ++ ) {
...
V_51 -> V_164 = V_169 ;
V_51 -> V_21 = V_21 ;
V_51 -> V_3 . V_185 = V_180 ;
V_51 -> V_3 . V_186 = F_67 ;
V_51 -> V_3 . V_11 = V_21 -> V_11 ;
V_51 -> V_3 . V_187 = & V_188 ;
F_75 ( & V_51 -> V_3 , L_56 , V_180 -> V_22 , V_21 -> V_164 ,
V_51 -> V_164 ) ;
V_182 = F_76 ( & V_51 -> V_3 ) ;
if ( V_182 )
goto V_189;
if ( V_51 -> V_3 . V_185 ) {
F_50 ( & V_51 -> V_177 , & V_180 -> V_173 ) ;
F_50 ( & V_51 -> V_178 , & V_21 -> V_173 ) ;
} else
F_72 ( & V_51 -> V_3 ) ;
}
return 0 ;
...
static int F_78 ( struct V_179 * V_180 , unsigned int V_181 )
{
struct V_4 * V_21 ;
int V_182 = 0 ;
F_15 ( & V_171 ) ;
F_79 (bridge, &vme_bus_list, bus_list) {
V_182 = F_73 ( V_180 , V_21 , V_181 ) ;
if ( V_182 )
break;
}
F_16 ( & V_171 ) ;
...
int F_80 ( struct V_179 * V_180 , unsigned int V_181 )
{
int V_182 ;
V_180 -> V_190 . V_22 = V_180 -> V_22 ;
V_180 -> V_190 . V_187 = & V_188 ;
F_35 ( & V_180 -> V_173 ) ;
V_182 = F_81 ( & V_180 -> V_190 ) ;
if ( V_182 )
return V_182 ;
V_182 = F_78 ( V_180 , V_181 ) ;
if ( V_182 )
F_82 ( & V_180 -> V_190 ) ;
return V_182 ;
}
void F_83 ( struct V_179 * V_180 )
{
struct V_1 * V_3 , * V_191 ;
F_15 ( & V_171 ) ;
...
static int F_84 ( struct V_2 * V_3 , struct V_192 * V_180 )
{
struct V_179 * V_193 ;
V_193 = F_2 ( V_180 , struct V_179 , V_190 ) ;
if ( V_3 -> V_185 == V_193 ) {
struct V_1 * V_51 = F_1 ( V_3 ) ;
if ( V_193 -> V_194 && V_193 -> V_194 ( V_51 ) )
return 1 ;
V_3 -> V_185 = NULL ;
}
return 0 ;
...
struct V_1 * V_51 = F_1 ( V_3 ) ;
V_190 = V_3 -> V_185 ;
if ( V_190 -> remove != NULL )
V_27 = V_190 -> remove ( V_51 ) ;
return V_27 ;
}
