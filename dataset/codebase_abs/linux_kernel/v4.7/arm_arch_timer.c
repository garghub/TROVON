...
switch ( V_39 ) {
case V_40 :
V_106 = F_66 ( V_107 , F_9 ,
L_15 , V_98 ) ;
break;
case V_43 :
case V_44 :
V_106 = F_66 ( V_107 , F_10 ,
L_15 , V_98 ) ;
if ( ! V_106 && V_38 [ V_44 ] ) {
V_107 = V_38 [ V_44 ] ;
V_106 = F_66 ( V_107 , F_10 ,
...
T_8 V_115 ;
struct V_8 * V_116 ;
V_116 = F_73 ( sizeof( * V_116 ) , V_117 ) ;
if ( ! V_116 )
return - V_108 ;
V_116 -> V_11 = V_11 ;
V_116 -> V_18 . V_25 = V_25 ;
F_23 ( V_72 , & V_116 -> V_18 ) ;
if ( V_48 )
V_115 = F_12 ;
else
V_115 = F_11 ;
V_114 = F_74 ( V_25 , V_115 , V_118 , L_2 , & V_116 -> V_18 ) ;
if ( V_114 ) {
F_68 ( L_17 ) ;
F_75 ( V_116 ) ;
}
...
static bool T_7
F_76 ( int type , const struct V_119 * V_120 )
{
struct V_68 * V_121 ;
bool V_122 = false ;
V_121 = F_77 ( NULL , V_120 ) ;
if ( V_121 && F_78 ( V_121 ) && ! ( V_123 & type ) )
V_122 = true ;
F_79 ( V_121 ) ;
return V_122 ;
}
...
V_123 |= V_32 ;
for ( V_129 = V_43 ; V_129 < V_130 ; V_129 ++ )
V_38 [ V_129 ] = F_86 ( V_69 , V_129 ) ;
F_40 ( NULL , V_69 ) ;
V_33 = ! F_87 ( V_69 , L_20 ) ;
if ( F_39 ( V_131 ) &&
F_87 ( V_69 , L_21 ) )
...
V_135 = F_6 ( V_134 + V_136 ) ;
F_90 (np, frame) {
int V_137 ;
T_2 V_138 ;
if ( F_41 ( V_132 , L_23 , & V_137 ) ) {
F_68 ( L_24 ) ;
F_79 ( V_132 ) ;
goto V_109;
}
...
V_142 | V_143 | V_144 ;
F_3 ( V_138 , V_134 + F_91 ( V_137 ) ) ;
V_138 = F_6 ( V_134 + F_91 ( V_137 ) ) ;
if ( ( V_135 & F_92 ( V_137 ) ) &&
! ( ~ V_138 & ( V_142 | V_144 ) ) ) {
F_79 ( V_133 ) ;
V_133 = V_132 ;
...
static int T_7 F_95 ( T_2 V_145 , T_2 V_146 )
{
int V_147 , V_148 ;
if ( ! V_145 )
return 0 ;
V_147 = ( V_146 & V_149 ) ? V_150
: V_151 ;
V_148 = ( V_146 & V_152 ) ? V_153
: V_154 ;
return F_96 ( NULL , V_145 , V_147 , V_148 ) ;
}
static int T_7 F_97 ( struct V_155 * V_156 )
{
struct V_157 * V_158 ;
if ( V_123 & V_32 ) {
F_43 ( L_27 ) ;
...
V_158 = F_98 ( V_156 , struct V_157 , V_160 ) ;
V_123 |= V_32 ;
V_38 [ V_43 ] =
F_95 ( V_158 -> V_161 ,
V_158 -> V_162 ) ;
