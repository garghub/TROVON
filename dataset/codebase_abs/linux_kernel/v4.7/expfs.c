...
goto V_57;
error = - V_58 ;
if ( ! V_49 -> V_61 -> V_62 && ! V_49 -> V_61 -> V_63 )
goto V_64;
V_53 . V_45 = 0 ;
while ( 1 ) {
int V_65 = V_53 . V_45 ;
...
V_39 = 2 ;
V_66 -> V_70 . V_41 = V_16 -> V_30 ;
V_66 -> V_70 . V_71 = V_16 -> V_72 ;
if ( V_21 ) {
V_66 -> V_70 . V_73 = V_21 -> V_30 ;
...
if ( ! V_8 || ! V_8 -> V_84 )
return F_15 ( - V_34 ) ;
V_13 = V_8 -> V_84 ( V_2 -> V_27 , V_66 , V_81 , V_82 ) ;
if ( ! V_13 )
V_13 = F_15 ( - V_34 ) ;
if ( F_18 ( V_13 ) )
return V_13 ;
