...
static int F_93 ( struct V_71 * V_79 ,
...
{
struct V_13 * V_14 = F_99 ( V_93 ) ;
F_95 ( V_14 ) ;
}
static T_2 F_100 ( struct V_13 * V_14 ,
...
static T_2 F_102 ( struct V_13 * V_14 ,
struct V_94 * V_95 ,
...
if ( ! F_44 ( & V_102 , V_57 ) )
return - V_58 ;
V_103 = F_103 ( V_96 , V_101 , F_101 ( V_102 ) ,
V_105 ) ;
if ( V_103 < 0 )
goto V_30;
V_104 = ! strcmp ( V_95 -> V_98 , L_1 ) ?
V_69 : V_68 ;
V_103 = F_83 ( V_14 , V_104 , V_102 ) ;
if ( ! V_103 )
V_103 = V_101 ;
V_30:
F_46 ( V_102 ) ;
...
static T_2 F_104 ( struct V_92 * V_93 ,
struct V_94 * V_95 , char * V_96 )
{
struct V_13 * V_14 ;
struct V_106 * V_107 ;
...
static T_2 F_106 ( struct V_92 * V_93 , struct V_94 * V_95 ,
const char * V_96 , T_3 V_101 )
{
struct V_13 * V_14 ;
struct V_106 * V_107 ;
...
struct V_13 * F_107 ( struct V_111 * V_36 )
{
return F_108 ( V_36 , V_112 , V_112 ) ;
}
struct V_13 * F_108 ( struct V_111 * V_36 ,
const struct V_6 * V_55 ,
const struct V_6 * V_56 )
{
struct V_13 * V_14 ;
...
F_70 () ;
F_109 ( & V_14 -> V_70 ) ;
F_110 ( & V_14 -> V_93 , & V_115 ) ;
F_111 ( & V_14 -> V_18 ) ;
#ifdef F_96
V_14 -> V_82 . V_116 = F_93 ;
V_14 -> V_82 . V_117 = 0 ;
F_112 ( & V_14 -> V_82 ) ;
#endif
return V_14 ;
