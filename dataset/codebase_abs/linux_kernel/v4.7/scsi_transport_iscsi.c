...
static void F_96 ( struct V_407 * V_408 )
{
struct V_382 * V_390 =
F_25 ( V_408 , struct V_382 , V_409 ) ;
...
int F_98 ( struct V_411 * V_412 )
{
struct V_382 * V_390 =
F_99 ( F_100 ( V_412 -> V_1 ) ) ;
unsigned long V_385 ;
int V_337 = 0 ;
F_75 ( & V_390 -> V_391 , V_385 ) ;
...
static void F_102 ( struct V_407 * V_408 )
{
struct V_382 * V_390 =
F_25 ( V_408 , struct V_382 ,
V_414 . V_408 ) ;
unsigned long V_385 ;
F_103 ( V_415 , V_390 ,
L_18 ,
...
F_85 ( V_390 , L_19 ) ;
F_104 ( & V_390 -> V_2 , V_417 ) ;
F_85 ( V_390 , L_20 ) ;
}
static void F_105 ( struct V_407 * V_408 )
{
struct V_382 * V_390 =
F_25 ( V_408 , struct V_382 ,
V_418 ) ;
...
V_390 -> V_181 = V_392 ;
F_77 ( & V_390 -> V_391 , V_385 ) ;
F_104 ( & V_390 -> V_2 , V_419 ) ;
if ( V_189 -> V_355 -> V_420 ) {
if ( F_107 ( V_189 , & V_390 -> V_409 ) )
F_108 ( & V_366 -> V_378 ) ;
}
F_85 ( V_390 , L_22 ) ;
}
...
{
F_110 ( V_421 , & V_390 -> V_418 ) ;
F_111 ( V_421 ) ;
}
static void F_112 ( struct V_407 * V_408 )
{
struct V_382 * V_390 =
F_25 ( V_408 , struct V_382 ,
V_422 ) ;
...
{
F_110 ( V_421 , & V_390 -> V_422 ) ;
}
static void F_116 ( struct V_407 * V_408 )
{
struct V_382 * V_390 =
F_25 ( V_408 , struct V_382 ,
V_424 ) ;
...
V_390 -> V_429 = false ;
V_390 -> V_181 = V_395 ;
F_121 ( & V_390 -> V_414 , F_102 ) ;
F_122 ( & V_390 -> V_430 ) ;
F_123 ( & V_390 -> V_418 , F_105 ) ;
F_123 ( & V_390 -> V_422 , F_112 ) ;
F_123 ( & V_390 -> V_424 , F_116 ) ;
F_123 ( & V_390 -> V_409 , F_96 ) ;
F_124 ( & V_390 -> V_391 ) ;
F_125 ( V_189 ) ;
...
int V_11 = 0 ;
int V_15 ;
V_390 -> V_384 = F_128 ( 1 , & V_431 ) ;
if ( V_332 == V_401 ) {
V_11 = F_129 ( & V_426 , 0 , 0 , V_19 ) ;
if ( V_11 < 0 ) {
F_103 ( V_18 , V_390 ,
L_28 ) ;
return V_11 ;
...
static int
F_149 ( struct V_443 * V_444 , T_5 V_445 , T_7 V_446 )
{
return F_150 ( V_447 , V_444 , 0 , V_445 , V_446 ) ;
}
int F_151 ( struct V_380 * V_381 , struct V_448 * V_449 ,
char * V_12 , T_5 V_450 )
{
struct V_451 * V_452 ;
struct V_443 * V_444 ;
...
char * V_455 ;
struct V_3 * V_4 ;
int V_456 = F_152 ( sizeof( * V_454 ) + sizeof( struct V_448 ) +
V_450 ) ;
V_4 = F_148 ( V_381 -> V_34 ) ;
if ( ! V_4 )
return - V_457 ;
V_444 = F_153 ( V_456 , V_458 ) ;
if ( ! V_444 ) {
F_154 ( V_381 , V_459 ) ;
...
V_452 = F_156 ( V_444 , 0 , 0 , 0 , ( V_456 - sizeof( * V_452 ) ) , 0 ) ;
V_454 = F_157 ( V_452 ) ;
memset ( V_454 , 0 , sizeof( * V_454 ) ) ;
V_454 -> V_460 = F_5 ( V_381 -> V_34 ) ;
V_454 -> type = V_461 ;
V_454 -> V_462 . V_463 . V_387 = V_381 -> V_387 ;
V_454 -> V_462 . V_463 . V_384 = F_72 ( V_381 ) ;
V_455 = ( char * ) V_454 + sizeof( * V_454 ) ;
memcpy ( V_455 , V_449 , sizeof( struct V_448 ) ) ;
memcpy ( V_455 + sizeof( struct V_448 ) , V_12 , V_450 ) ;
return F_149 ( V_444 , V_464 , V_458 ) ;
}
...
struct V_443 * V_444 ;
struct V_453 * V_454 ;
int V_456 = F_152 ( sizeof( * V_454 ) + V_450 ) ;
V_444 = F_153 ( V_456 , V_458 ) ;
if ( ! V_444 ) {
F_13 ( V_18 L_46 ) ;
return - V_372 ;
...
memset ( V_454 , 0 , sizeof( * V_454 ) ) ;
V_454 -> type = type ;
V_454 -> V_460 = F_5 ( V_34 ) ;
switch ( type ) {
case V_465 :
V_454 -> V_462 . V_466 . V_194 = V_189 -> V_194 ;
break;
case V_467 :
V_454 -> V_462 . V_468 . V_194 = V_189 -> V_194 ;
break;
}
memcpy ( ( char * ) V_454 + sizeof( * V_454 ) , V_12 , V_450 ) ;
return F_149 ( V_444 , V_469 , V_458 ) ;
}
void F_154 ( struct V_380 * V_381 , enum V_470 error )
{
struct V_451 * V_452 ;
struct V_443 * V_444 ;
struct V_453 * V_454 ;
struct V_3 * V_4 ;
int V_456 = F_152 ( sizeof( * V_454 ) ) ;
V_4 = F_148 ( V_381 -> V_34 ) ;
if ( ! V_4 )
return;
V_444 = F_153 ( V_456 , V_458 ) ;
...
V_454 -> V_460 = F_5 ( V_381 -> V_34 ) ;
V_454 -> type = V_471 ;
V_454 -> V_462 . V_472 . error = error ;
V_454 -> V_462 . V_472 . V_387 = V_381 -> V_387 ;
V_454 -> V_462 . V_472 . V_384 = F_72 ( V_381 ) ;
F_149 ( V_444 , V_464 , V_458 ) ;
F_155 ( V_415 , V_381 , L_49 ,
error ) ;
}
...
V_454 -> V_460 = F_5 ( V_381 -> V_34 ) ;
V_454 -> type = V_474 ;
V_454 -> V_462 . V_475 . V_181 = V_181 ;
V_454 -> V_462 . V_475 . V_387 = V_381 -> V_387 ;
V_454 -> V_462 . V_475 . V_384 = F_72 ( V_381 ) ;
F_149 ( V_444 , V_464 , V_458 ) ;
F_155 ( V_415 , V_381 , L_51 ,
V_181 ) ;
}
void F_160 ( T_5 V_194 , struct V_8 * V_34 ,
enum V_476 V_477 , T_5 V_450 ,
T_9 * V_12 )
{
struct V_451 * V_452 ;
struct V_443 * V_444 ;
...
V_454 -> V_460 = F_5 ( V_34 ) ;
V_454 -> type = V_479 ;
V_454 -> V_462 . V_480 . V_194 = V_194 ;
V_454 -> V_462 . V_480 . V_477 = V_477 ;
V_454 -> V_462 . V_480 . V_450 = V_450 ;
if ( V_450 )
memcpy ( ( char * ) V_454 + sizeof( * V_454 ) , V_12 , V_450 ) ;
F_149 ( V_444 , V_464 , V_478 ) ;
}
void F_161 ( T_5 V_194 , struct V_8 * V_34 ,
T_5 V_481 , T_5 V_482 , T_5 V_450 ,
T_9 * V_12 )
{
struct V_451 * V_452 ;
struct V_443 * V_444 ;
...
V_454 -> V_460 = F_5 ( V_34 ) ;
V_454 -> type = V_483 ;
V_454 -> V_462 . V_484 . V_194 = V_194 ;
V_454 -> V_462 . V_484 . V_481 = V_481 ;
V_454 -> V_462 . V_484 . V_482 = V_482 ;
V_454 -> V_462 . V_484 . V_450 = V_450 ;
memcpy ( ( char * ) V_454 + sizeof( * V_454 ) , V_12 , V_450 ) ;
F_149 ( V_444 , V_464 , V_478 ) ;
}
static int
F_162 ( T_5 V_445 , int V_485 , int type , int V_486 , int V_487 ,
void * V_488 , int V_489 )
{
struct V_443 * V_444 ;
struct V_451 * V_452 ;
int V_456 = F_152 ( V_489 ) ;
int V_385 = V_487 ? V_490 : 0 ;
int V_33 = V_486 ? V_491 : type ;
V_444 = F_153 ( V_456 , V_458 ) ;
if ( ! V_444 ) {
F_13 ( V_18 L_54 ) ;
return - V_372 ;
}
V_452 = F_156 ( V_444 , 0 , 0 , V_33 , ( V_456 - sizeof( * V_452 ) ) , 0 ) ;
V_452 -> V_492 = V_385 ;
memcpy ( F_157 ( V_452 ) , V_488 , V_489 ) ;
return F_149 ( V_444 , V_445 , V_458 ) ;
}
static int
F_163 ( struct V_8 * V_34 , struct V_451 * V_452 )
{
struct V_453 * V_454 = F_157 ( V_452 ) ;
struct V_493 * V_494 ;
struct V_443 * V_495 ;
struct V_380 * V_381 ;
struct V_451 * V_496 ;
...
if ( ! V_4 )
return - V_457 ;
V_381 = F_78 ( V_454 -> V_500 . V_501 . V_384 , V_454 -> V_500 . V_501 . V_387 ) ;
if ( ! V_381 )
return - V_502 ;
do {
int V_503 ;
V_495 = F_153 ( V_456 , V_458 ) ;
if ( ! V_495 ) {
F_155 ( V_18 , V_381 , L_55
L_56 ) ;
return - V_372 ;
}
V_496 = F_156 ( V_495 , 0 , 0 , 0 ,
( V_456 - sizeof( * V_496 ) ) , 0 ) ;
V_497 = F_157 ( V_496 ) ;
memset ( V_497 , 0 , sizeof( * V_497 ) ) ;
V_497 -> V_460 = F_5 ( V_381 -> V_34 ) ;
V_497 -> type = V_452 -> V_504 ;
V_497 -> V_500 . V_501 . V_387 =
V_454 -> V_500 . V_501 . V_387 ;
V_497 -> V_500 . V_501 . V_384 =
V_454 -> V_500 . V_501 . V_384 ;
V_494 = (struct V_493 * )
( ( char * ) V_497 + sizeof( * V_497 ) ) ;
memset ( V_494 , 0 , sizeof( * V_494 ) ) ;
V_34 -> V_501 ( V_381 , V_494 ) ;
V_503 = F_152 ( sizeof( struct V_453 ) +
sizeof( struct V_493 ) +
sizeof( struct V_498 ) *
V_494 -> V_505 ) ;
V_503 -= sizeof( * V_496 ) ;
V_503 = F_164 ( V_503 ) ;
F_165 ( V_495 , F_166 ( V_503 ) ) ;
V_496 -> V_506 = V_503 ;
V_15 = F_149 ( V_495 , V_464 ,
V_458 ) ;
} while ( V_15 < 0 && V_15 != - V_507 );
return V_15 ;
}
...
struct V_443 * V_444 ;
struct V_451 * V_452 ;
int V_510 , V_456 = F_152 ( sizeof( * V_454 ) ) ;
V_4 = F_148 ( V_390 -> V_34 ) ;
if ( ! V_4 )
return - V_457 ;
V_189 = F_83 ( V_390 ) ;
V_444 = F_153 ( V_456 , V_19 ) ;
if ( ! V_444 ) {
F_103 ( V_18 , V_390 ,
L_57
L_58 , V_509 ) ;
...
V_452 = F_156 ( V_444 , 0 , 0 , 0 , ( V_456 - sizeof( * V_452 ) ) , 0 ) ;
V_454 = F_157 ( V_452 ) ;
V_454 -> V_460 = F_5 ( V_390 -> V_34 ) ;
V_454 -> type = V_509 ;
switch ( V_509 ) {
case V_435 :
V_454 -> V_462 . V_511 . V_194 = V_189 -> V_194 ;
V_454 -> V_462 . V_511 . V_384 = V_390 -> V_384 ;
break;
case V_434 :
V_454 -> V_462 . V_512 . V_194 = V_189 -> V_194 ;
V_454 -> V_462 . V_512 . V_384 = V_390 -> V_384 ;
break;
case V_427 :
V_454 -> V_462 . V_513 . V_194 = V_189 -> V_194 ;
V_454 -> V_462 . V_513 . V_384 = V_390 -> V_384 ;
break;
default:
...
struct V_382 * V_390 ;
struct V_188 * V_189 ;
V_390 = V_34 -> V_517 ( V_10 , V_515 , V_516 ,
V_514 ) ;
if ( ! V_390 )
return - V_372 ;
V_390 -> V_428 = V_482 ;
...
static int
F_169 ( struct V_8 * V_34 , struct V_453 * V_454 )
{
struct V_380 * V_381 ;
struct V_382 * V_390 ;
V_390 = F_74 ( V_454 -> V_500 . V_518 . V_384 ) ;
if ( ! V_390 ) {
F_13 ( V_18 L_64 ,
V_454 -> V_500 . V_518 . V_384 ) ;
return - V_457 ;
}
V_381 = V_34 -> V_519 ( V_390 , V_454 -> V_500 . V_518 . V_387 ) ;
if ( ! V_381 ) {
F_103 ( V_18 , V_390 ,
L_65 ) ;
return - V_372 ;
}
V_454 -> V_462 . V_520 . V_384 = V_390 -> V_384 ;
V_454 -> V_462 . V_520 . V_387 = V_381 -> V_387 ;
F_137 ( V_381 , L_66 ) ;
return 0 ;
}
static int
F_170 ( struct V_8 * V_34 , struct V_453 * V_454 )
{
struct V_380 * V_381 ;
V_381 = F_78 ( V_454 -> V_500 . V_521 . V_384 , V_454 -> V_500 . V_521 . V_387 ) ;
if ( ! V_381 )
return - V_457 ;
F_137 ( V_381 , L_67 ) ;
if ( V_34 -> V_522 )
...
static int
F_171 ( struct V_8 * V_34 , struct V_453 * V_454 )
{
char * V_12 = ( char * ) V_454 + sizeof( * V_454 ) ;
struct V_380 * V_381 ;
struct V_382 * V_390 ;
int V_15 = 0 , V_183 = 0 ;
V_390 = F_74 ( V_454 -> V_500 . V_523 . V_384 ) ;
V_381 = F_78 ( V_454 -> V_500 . V_523 . V_384 , V_454 -> V_500 . V_523 . V_387 ) ;
if ( ! V_381 || ! V_390 )
return - V_457 ;
switch ( V_454 -> V_500 . V_523 . V_35 ) {
case V_524 :
...
break;
default:
V_15 = V_34 -> V_523 ( V_381 , V_454 -> V_500 . V_523 . V_35 ,
V_12 , V_454 -> V_500 . V_523 . V_456 ) ;
}
return V_15 ;
}
static int F_172 ( struct V_8 * V_34 ,
struct V_453 * V_454 , int V_525 )
{
struct V_9 * V_10 ;
struct V_526 * V_527 ;
...
return - V_457 ;
if ( V_525 == V_530 ) {
V_189 = F_173 ( V_454 -> V_500 . V_531 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_69
L_70 ,
V_454 -> V_500 . V_531 . V_194 ) ;
return - V_532 ;
}
V_528 = V_454 -> V_500 . V_531 . V_528 ;
} else
V_528 = V_454 -> V_500 . V_529 . V_528 ;
V_527 = (struct V_526 * ) ( ( char * ) V_454 + sizeof( * V_454 ) ) ;
V_10 = V_34 -> V_529 ( V_189 , V_527 , V_528 ) ;
if ( F_174 ( V_10 ) ) {
V_15 = F_175 ( V_10 ) ;
goto V_533;
}
V_454 -> V_462 . V_534 . V_26 = V_10 -> V_11 ;
V_533:
if ( V_189 )
F_84 ( V_189 ) ;
return V_15 ;
...
case V_530 :
case V_537 :
V_510 = F_172 ( V_34 , V_454 , V_525 ) ;
break;
case V_538 :
if ( ! V_34 -> V_539 )
return - V_457 ;
V_10 = F_21 ( V_454 -> V_500 . V_539 . V_535 ) ;
if ( ! V_10 )
return - V_457 ;
V_454 -> V_462 . V_540 = V_34 -> V_539 ( V_10 ,
V_454 -> V_500 . V_539 . V_541 ) ;
break;
case V_542 :
V_510 = F_176 ( V_34 ,
V_454 -> V_500 . V_536 . V_535 ) ;
break;
}
return V_510 ;
}
...
if ( ! V_34 -> V_543 )
return - V_457 ;
V_189 = F_173 ( V_454 -> V_500 . V_543 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_71 ,
V_454 -> V_500 . V_543 . V_194 ) ;
return - V_532 ;
}
V_527 = (struct V_526 * ) ( ( char * ) V_454 + sizeof( * V_454 ) ) ;
V_15 = V_34 -> V_543 ( V_189 , V_454 -> V_500 . V_543 . type ,
V_454 -> V_500 . V_543 . V_544 , V_527 ) ;
F_84 ( V_189 ) ;
return V_15 ;
}
static int
...
if ( ! V_34 -> V_545 )
return - V_546 ;
V_189 = F_173 ( V_454 -> V_500 . V_545 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_72 ,
V_454 -> V_500 . V_545 . V_194 ) ;
return - V_532 ;
}
V_15 = V_34 -> V_545 ( V_189 , V_454 -> V_500 . V_545 . V_35 ,
V_12 , V_454 -> V_500 . V_545 . V_456 ) ;
F_84 ( V_189 ) ;
return V_15 ;
}
static int
F_180 ( struct V_8 * V_34 , struct V_453 * V_454 )
{
struct V_188 * V_189 ;
struct V_547 * V_548 ;
int V_15 ;
if ( ! V_34 -> V_549 )
return - V_546 ;
V_189 = F_173 ( V_454 -> V_500 . V_549 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_73 ,
V_454 -> V_500 . V_549 . V_194 ) ;
return - V_532 ;
}
V_548 = (struct V_547 * ) ( ( char * ) V_454 + sizeof( * V_454 ) ) ;
V_15 = V_34 -> V_549 ( V_189 , V_548 ) ;
F_84 ( V_189 ) ;
return V_15 ;
}
static int
F_181 ( struct V_8 * V_34 ,
struct V_453 * V_454 , T_5 V_456 )
{
char * V_12 = ( char * ) V_454 + sizeof( * V_454 ) ;
struct V_188 * V_189 ;
int V_15 ;
if ( ! V_34 -> V_550 )
return - V_546 ;
V_189 = F_173 ( V_454 -> V_500 . V_551 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_74 ,
V_454 -> V_500 . V_551 . V_194 ) ;
return - V_532 ;
}
V_15 = V_34 -> V_550 ( V_189 , V_12 , V_456 ) ;
F_84 ( V_189 ) ;
return V_15 ;
}
static int
F_182 ( struct V_8 * V_34 , struct V_453 * V_454 )
{
struct V_188 * V_189 ;
struct V_526 * V_527 ;
int V_15 ;
if ( ! V_34 -> V_552 )
return - V_546 ;
V_189 = F_173 ( V_454 -> V_500 . V_553 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_75 ,
V_454 -> V_500 . V_553 . V_194 ) ;
return - V_532 ;
}
V_527 = (struct V_526 * ) ( ( char * ) V_454 + sizeof( * V_454 ) ) ;
V_15 = V_34 -> V_552 ( V_189 , V_454 -> V_500 . V_553 . V_190 ,
V_454 -> V_500 . V_553 . V_103 ,
V_454 -> V_500 . V_553 . V_554 ,
V_454 -> V_500 . V_553 . V_482 ,
V_527 ) ;
F_84 ( V_189 ) ;
return V_15 ;
}
static int
F_183 ( struct V_8 * V_34 , struct V_451 * V_452 )
{
struct V_453 * V_454 = F_157 ( V_452 ) ;
struct V_188 * V_189 = NULL ;
struct V_555 * V_556 ;
...
if ( ! V_4 )
return - V_457 ;
V_560 = ( V_454 -> V_500 . V_561 . V_562 * sizeof( * V_556 ) ) ;
V_456 = F_152 ( sizeof( * V_454 ) + V_560 ) ;
V_189 = F_173 ( V_454 -> V_500 . V_561 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_76 ,
V_563 , V_454 -> V_500 . V_561 . V_194 ) ;
return - V_532 ;
}
do {
int V_503 ;
V_557 = F_153 ( V_456 , V_19 ) ;
if ( ! V_557 ) {
F_13 ( V_18 L_77 ) ;
V_15 = - V_372 ;
goto V_564;
}
V_558 = F_156 ( V_557 , 0 , 0 , 0 ,
( V_456 - sizeof( * V_558 ) ) , 0 ) ;
V_559 = F_157 ( V_558 ) ;
memset ( V_559 , 0 , sizeof( * V_559 ) ) ;
V_559 -> V_460 = F_5 ( V_34 ) ;
V_559 -> type = V_452 -> V_504 ;
V_559 -> V_500 . V_561 . V_194 = V_454 -> V_500 . V_561 . V_194 ;
V_559 -> V_500 . V_561 . V_565 = V_454 -> V_500 . V_561 . V_565 ;
V_559 -> V_500 . V_561 . V_562 = V_454 -> V_500 . V_561 . V_562 ;
V_7 = ( char * ) V_559 + sizeof( * V_559 ) ;
memset ( V_7 , 0 , V_560 ) ;
V_15 = V_34 -> V_561 ( V_189 , V_454 -> V_500 . V_561 . V_565 ,
& V_559 -> V_500 . V_561 . V_562 , V_7 ) ;
V_503 = F_152 ( sizeof( * V_454 ) + V_560 ) ;
F_165 ( V_557 , F_166 ( V_503 ) ) ;
V_558 -> V_506 = V_503 ;
V_15 = F_149 ( V_557 , V_464 ,
V_19 ) ;
} while ( V_15 < 0 && V_15 != - V_507 );
V_564:
F_84 ( V_189 ) ;
...
if ( ! V_189 ) {
F_53 ( L_78 ,
V_563 , V_454 -> V_500 . V_549 . V_194 ) ;
return - V_532 ;
}
V_15 = V_34 -> V_566 ( V_189 , V_12 , V_456 ) ;
F_84 ( V_189 ) ;
return V_15 ;
}
...
if ( ! V_34 -> V_567 )
return - V_546 ;
V_189 = F_173 ( V_454 -> V_500 . V_567 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_78 ,
V_563 , V_454 -> V_500 . V_567 . V_194 ) ;
return - V_532 ;
}
V_15 = V_34 -> V_567 ( V_189 , V_454 -> V_500 . V_567 . V_565 ) ;
F_84 ( V_189 ) ;
return V_15 ;
}
char * F_186 ( int V_568 )
{
int V_32 ;
char * V_181 = L_79 ;
for ( V_32 = 0 ; V_32 < F_28 ( V_569 ) ; V_32 ++ ) {
if ( V_569 [ V_32 ] . V_183 & V_568 ) {
V_181 = V_569 [ V_32 ] . V_184 ;
break;
}
}
return V_181 ;
...
V_189 = F_173 ( V_454 -> V_500 . V_572 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
V_563 , V_454 -> V_500 . V_572 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_339 = V_454 -> V_500 . V_572 . V_574 ;
V_199 = F_45 ( V_189 , V_339 ) ;
if ( ! V_199 ) {
F_53 ( L_80 ,
V_563 , V_339 , V_454 -> V_500 . V_572 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_2 = F_49 ( V_199 ) ;
...
V_271 = F_37 ( V_2 ) ;
V_15 = V_34 -> V_570 ( V_199 , V_271 , V_12 , V_456 ) ;
F_12 ( V_2 ) ;
V_575:
F_12 ( & V_199 -> V_2 ) ;
V_573:
...
V_189 = F_173 ( V_454 -> V_500 . V_576 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
V_563 , V_454 -> V_500 . V_576 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_331 = V_34 -> V_576 ( V_189 , V_12 , V_456 ) ;
if ( V_331 >= 0 )
V_454 -> V_462 . V_578 . V_574 = V_331 ;
else
V_15 = - V_579 ;
V_573:
F_84 ( V_189 ) ;
...
V_189 = F_173 ( V_454 -> V_500 . V_580 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
V_563 , V_454 -> V_500 . V_580 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_339 = V_454 -> V_500 . V_580 . V_574 ;
V_199 = F_45 ( V_189 , V_339 ) ;
if ( ! V_199 ) {
F_53 ( L_80 ,
V_563 , V_339 , V_454 -> V_500 . V_580 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_15 = V_34 -> V_580 ( V_199 ) ;
F_12 ( & V_199 -> V_2 ) ;
V_573:
F_84 ( V_189 ) ;
V_581:
...
V_189 = F_173 ( V_454 -> V_500 . V_582 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
V_563 , V_454 -> V_500 . V_582 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_339 = V_454 -> V_500 . V_582 . V_574 ;
V_199 = F_45 ( V_189 , V_339 ) ;
if ( ! V_199 ) {
F_53 ( L_80 ,
V_563 , V_339 , V_454 -> V_500 . V_582 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_2 = F_49 ( V_199 ) ;
...
V_189 = F_173 ( V_454 -> V_500 . V_584 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
V_563 , V_454 -> V_500 . V_584 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_339 = V_454 -> V_500 . V_584 . V_574 ;
V_199 = F_45 ( V_189 , V_339 ) ;
if ( ! V_199 ) {
F_53 ( L_80 ,
V_563 , V_339 , V_454 -> V_500 . V_584 . V_194 ) ;
V_15 = - V_532 ;
goto V_573;
}
V_2 = F_49 ( V_199 ) ;
...
V_189 = F_173 ( V_454 -> V_500 . V_586 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
V_563 , V_454 -> V_500 . V_584 . V_194 ) ;
V_15 = - V_532 ;
...
V_390 = F_74 ( V_454 -> V_500 . V_586 . V_384 ) ;
if ( ! V_390 ) {
F_53 ( L_81 ,
V_563 , V_454 -> V_500 . V_586 . V_384 ) ;
V_15 = - V_457 ;
goto V_573;
}
V_15 = V_34 -> V_586 ( V_390 ) ;
V_573:
F_84 ( V_189 ) ;
V_587:
return V_15 ;
...
static int
F_193 ( struct V_8 * V_34 , struct V_451 * V_452 )
{
struct V_453 * V_454 = F_157 ( V_452 ) ;
struct V_188 * V_189 = NULL ;
struct V_3 * V_4 ;
...
if ( ! V_4 )
return - V_457 ;
V_591 = sizeof( struct V_593 ) ;
V_456 = F_152 ( sizeof( * V_454 ) + V_591 ) ;
V_189 = F_173 ( V_454 -> V_500 . V_592 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_82 ,
V_563 , V_454 -> V_500 . V_592 . V_194 ) ;
return - V_532 ;
}
do {
int V_503 ;
V_588 = F_153 ( V_456 , V_19 ) ;
if ( ! V_588 ) {
F_53 ( L_83 ) ;
V_15 = - V_372 ;
goto V_594;
}
V_589 = F_156 ( V_588 , 0 , 0 , 0 ,
( V_456 - sizeof( * V_589 ) ) , 0 ) ;
V_590 = F_157 ( V_589 ) ;
memset ( V_590 , 0 , sizeof( * V_590 ) ) ;
V_590 -> V_460 = F_5 ( V_34 ) ;
V_590 -> type = V_452 -> V_504 ;
V_590 -> V_500 . V_592 . V_194 =
V_454 -> V_500 . V_592 . V_194 ;
V_7 = ( char * ) V_590 + sizeof( * V_590 ) ;
memset ( V_7 , 0 , V_591 ) ;
V_15 = V_34 -> V_592 ( V_189 , V_7 , V_591 ) ;
if ( V_15 ) {
F_167 ( V_588 ) ;
goto V_594;
}
V_503 = F_152 ( sizeof( * V_454 ) + V_591 ) ;
F_165 ( V_588 , F_166 ( V_503 ) ) ;
V_589 -> V_506 = V_503 ;
V_15 = F_149 ( V_588 , V_464 ,
V_19 ) ;
} while ( V_15 < 0 && V_15 != - V_507 );
V_594:
F_84 ( V_189 ) ;
...
static int
F_194 ( struct V_443 * V_444 , struct V_451 * V_452 , T_5 * V_445 )
{
int V_15 = 0 ;
struct V_453 * V_454 = F_157 ( V_452 ) ;
...
if ( V_452 -> V_504 == V_595 )
* V_445 = V_469 ;
else
* V_445 = V_464 ;
V_4 = F_148 ( F_195 ( V_454 -> V_460 ) ) ;
if ( ! V_4 )
return - V_457 ;
V_34 = V_4 -> V_8 ;
if ( ! F_196 ( V_34 -> V_596 ) )
...
switch ( V_452 -> V_504 ) {
case V_597 :
V_15 = F_168 ( V_4 , V_10 , V_454 ,
F_197 ( V_444 ) . V_598 ,
V_454 -> V_500 . V_599 . V_514 ,
V_454 -> V_500 . V_599 . V_515 ,
V_454 -> V_500 . V_599 . V_516 ) ;
break;
case V_600 :
V_10 = F_21 ( V_454 -> V_500 . V_601 . V_535 ) ;
if ( ! V_10 ) {
V_15 = - V_457 ;
break;
}
V_15 = F_168 ( V_4 , V_10 , V_454 ,
F_197 ( V_444 ) . V_598 ,
V_454 -> V_500 . V_601 . V_514 ,
V_454 -> V_500 . V_601 . V_515 ,
V_454 -> V_500 . V_601 . V_516 ) ;
break;
case V_602 :
V_390 = F_74 ( V_454 -> V_500 . V_511 . V_384 ) ;
if ( V_390 )
V_34 -> V_603 ( V_390 ) ;
else
V_15 = - V_457 ;
...
break;
case V_605 :
V_15 = F_169 ( V_34 , V_454 ) ;
break;
case V_606 :
V_15 = F_170 ( V_34 , V_454 ) ;
break;
case V_607 :
V_390 = F_74 ( V_454 -> V_500 . V_608 . V_384 ) ;
V_381 = F_78 ( V_454 -> V_500 . V_608 . V_384 , V_454 -> V_500 . V_608 . V_387 ) ;
if ( V_381 && V_381 -> V_10 )
...
V_454 -> V_462 . V_540 = V_34 -> V_609 ( V_390 , V_381 ,
V_454 -> V_500 . V_608 . V_610 ,
V_454 -> V_500 . V_608 . V_611 ) ;
if ( V_454 -> V_462 . V_540 || ! V_34 -> V_529 )
break;
V_10 = F_21 ( V_454 -> V_500 . V_608 . V_610 ) ;
if ( V_10 ) {
V_10 -> V_381 = V_381 ;
F_92 ( & V_381 -> V_436 ) ;
V_381 -> V_10 = V_10 ;
...
break;
case V_612 :
V_15 = F_171 ( V_34 , V_454 ) ;
break;
case V_613 :
V_381 = F_78 ( V_454 -> V_500 . V_614 . V_384 , V_454 -> V_500 . V_614 . V_387 ) ;
if ( V_381 )
V_454 -> V_462 . V_540 = V_34 -> V_614 ( V_381 ) ;
else
V_15 = - V_457 ;
break;
case V_615 :
V_381 = F_78 ( V_454 -> V_500 . V_616 . V_384 , V_454 -> V_500 . V_616 . V_387 ) ;
if ( V_381 )
V_34 -> V_616 ( V_381 , V_454 -> V_500 . V_616 . V_617 ) ;
else
V_15 = - V_457 ;
break;
case V_618 :
V_381 = F_78 ( V_454 -> V_500 . V_619 . V_384 , V_454 -> V_500 . V_619 . V_387 ) ;
if ( V_381 )
V_454 -> V_462 . V_540 = V_34 -> V_619 ( V_381 ,
(struct V_448 * ) ( ( char * ) V_454 + sizeof( * V_454 ) ) ,
( char * ) V_454 + sizeof( * V_454 ) + V_454 -> V_500 . V_619 . V_620 ,
V_454 -> V_500 . V_619 . V_450 ) ;
else
V_15 = - V_457 ;
break;
case V_621 :
V_15 = F_163 ( V_34 , V_452 ) ;
break;
case V_537 :
case V_538 :
case V_542 :
case V_530 :
V_15 = F_177 ( V_34 , V_454 , V_452 -> V_504 ) ;
break;
case V_622 :
V_15 = F_178 ( V_34 , V_454 ) ;
break;
case V_623 :
V_15 = F_179 ( V_34 , V_454 ) ;
break;
case V_595 :
V_15 = F_180 ( V_34 , V_454 ) ;
break;
case V_624 :
V_15 = F_181 ( V_34 , V_454 ,
F_198 ( V_452 , sizeof( * V_454 ) ) ) ;
break;
case V_625 :
V_15 = F_182 ( V_34 , V_454 ) ;
break;
case V_626 :
V_15 = F_183 ( V_34 , V_452 ) ;
break;
case V_627 :
V_15 = F_185 ( V_34 , V_454 ) ;
break;
case V_628 :
V_15 = F_187 ( V_34 , V_454 ,
F_198 ( V_452 ,
sizeof( * V_454 ) ) ) ;
break;
case V_629 :
V_15 = F_188 ( V_34 , V_454 ,
F_198 ( V_452 , sizeof( * V_454 ) ) ) ;
break;
case V_630 :
V_15 = F_189 ( V_34 , V_454 ) ;
break;
case V_631 :
V_15 = F_190 ( V_34 , V_454 ) ;
break;
case V_632 :
V_15 = F_191 ( V_34 , V_454 ) ;
break;
case V_633 :
V_15 = F_192 ( V_34 , V_454 ) ;
break;
case V_634 :
V_15 = F_184 ( V_34 , V_454 ,
F_198 ( V_452 , sizeof( * V_454 ) ) ) ;
break;
case V_635 :
V_15 = F_193 ( V_34 , V_452 ) ;
break;
default:
V_15 = - V_546 ;
break;
...
static void
F_200 ( struct V_443 * V_444 )
{
F_92 ( & V_636 ) ;
while ( V_444 -> V_456 >= V_637 ) {
int V_15 ;
T_5 V_638 ;
struct V_451 * V_452 ;
struct V_453 * V_454 ;
T_5 V_445 ;
V_452 = F_201 ( V_444 ) ;
if ( V_452 -> V_506 < sizeof( * V_452 ) ||
V_444 -> V_456 < V_452 -> V_506 ) {
break;
}
V_454 = F_157 ( V_452 ) ;
V_638 = F_166 ( V_452 -> V_506 ) ;
if ( V_638 > V_444 -> V_456 )
V_638 = V_444 -> V_456 ;
V_15 = F_194 ( V_444 , V_452 , & V_445 ) ;
if ( V_15 ) {
V_454 -> type = V_639 ;
V_454 -> V_640 = V_15 ;
}
do {
if ( V_454 -> type == V_621 && ! V_15 )
break;
if ( V_454 -> type == V_626 && ! V_15 )
break;
V_15 = F_162 ( V_445 , V_452 -> V_641 ,
V_452 -> V_504 , 0 , 0 , V_454 , sizeof( * V_454 ) ) ;
} while ( V_15 < 0 && V_15 != - V_507 && V_15 != - V_359 );
F_202 ( V_444 , V_638 ) ;
}
F_94 ( & V_636 ) ;
}
...
V_35 = V_697 ;
else if ( V_6 == & V_698 . V_6 )
V_35 = V_699 ;
else if ( V_6 == & V_700 . V_6 )
V_35 = V_701 ;
else {
F_26 ( 1 , L_86 ) ;
return 0 ;
}
return V_33 -> V_178 ( V_702 , V_35 ) ;
}
static T_1
...
{
struct V_382 * V_390 = F_73 ( V_2 -> V_29 ) ;
return sprintf ( V_7 , L_88 , V_390 -> V_428 ) ;
}
static T_1
...
V_35 = V_796 ;
else if ( V_6 == & V_797 . V_6 )
V_35 = V_798 ;
else if ( V_6 == & V_799 . V_6 )
V_35 = V_800 ;
else {
F_26 ( 1 , L_90 ) ;
return 0 ;
}
return V_4 -> V_8 -> V_178 ( V_801 , V_35 ) ;
}
...
char * V_802 = L_79 ;
struct V_365 * V_366 = V_189 -> V_377 ;
T_5 V_803 = V_366 -> V_803 ;
for ( V_32 = 0 ; V_32 < F_28 ( V_804 ) ; V_32 ++ ) {
if ( V_804 [ V_32 ] . V_183 & V_803 ) {
V_802 = V_804 [ V_32 ] . V_184 ;
break;
}
}
return V_802 ;
...
for ( V_32 = 0 ; V_32 < F_28 ( V_805 ) ; V_32 ++ ) {
if ( V_805 [ V_32 ] . V_183 & V_180 ) {
V_181 = V_805 [ V_32 ] . V_184 ;
break;
}
}
return V_181 ;
}
static int F_214 ( struct V_806 * V_807 ,
struct V_1 * V_2 )
{
struct V_382 * V_390 ;
struct V_188 * V_189 ;
...
if ( V_4 -> V_808 . V_809 . V_20 != & V_810 . V_20 )
return 0 ;
return & V_4 -> V_808 . V_809 == V_807 ;
}
static int F_215 ( struct V_806 * V_807 ,
struct V_1 * V_2 )
{
struct V_382 * V_390 ;
struct V_380 * V_381 ;
...
return 0 ;
V_4 = F_58 ( V_189 -> V_347 ) ;
if ( V_4 -> V_811 . V_809 . V_20 != & V_812 . V_20 )
return 0 ;
return & V_4 -> V_811 . V_809 == V_807 ;
}
static int F_216 ( struct V_806 * V_807 ,
struct V_1 * V_2 )
{
struct V_188 * V_189 ;
struct V_3 * V_4 ;
...
V_189 = F_67 ( V_2 ) ;
if ( ! V_189 -> V_347 ||
V_189 -> V_347 -> V_813 . V_809 . V_20 != & V_814 . V_20 )
return 0 ;
V_4 = F_58 ( V_189 -> V_347 ) ;
return & V_4 -> V_33 . V_813 . V_809 == V_807 ;
}
struct V_815 *
F_218 ( struct V_8 * V_441 )
{
struct V_3 * V_4 ;
unsigned long V_385 ;
int V_15 ;
...
V_4 -> V_33 . V_818 = 1 ;
V_4 -> V_2 . V_20 = & V_819 ;
F_15 ( & V_4 -> V_2 , L_91 , V_441 -> V_184 ) ;
V_15 = F_16 ( & V_4 -> V_2 ) ;
if ( V_15 )
goto V_820;
V_15 = F_17 ( & V_4 -> V_2 . V_22 , & V_821 ) ;
if ( V_15 )
goto V_24;
V_4 -> V_33 . V_813 . V_809 . V_20 = & V_814 . V_20 ;
V_4 -> V_33 . V_813 . V_809 . V_822 = F_216 ;
V_4 -> V_33 . V_813 . V_809 . V_823 = & V_824 ;
V_4 -> V_33 . V_825 = sizeof( struct V_365 ) ;
F_219 ( & V_4 -> V_33 . V_813 ) ;
V_4 -> V_811 . V_809 . V_20 = & V_812 . V_20 ;
V_4 -> V_811 . V_809 . V_822 = F_215 ;
V_4 -> V_811 . V_809 . V_823 = & V_826 ;
F_219 ( & V_4 -> V_811 ) ;
V_4 -> V_808 . V_809 . V_20 = & V_810 . V_20 ;
V_4 -> V_808 . V_809 . V_822 = F_214 ;
V_4 -> V_808 . V_809 . V_823 = & V_827 ;
F_219 ( & V_4 -> V_808 ) ;
F_75 ( & V_442 , V_385 ) ;
F_132 ( & V_4 -> V_816 , & V_828 ) ;
F_77 ( & V_442 , V_385 ) ;
F_13 ( V_829 L_92 , V_441 -> V_184 ) ;
return & V_4 -> V_33 ;
V_24:
F_18 ( & V_4 -> V_2 ) ;
return NULL ;
...
F_221 ( & V_4 -> V_811 ) ;
F_221 ( & V_4 -> V_808 ) ;
F_221 ( & V_4 -> V_33 . V_813 ) ;
F_20 ( & V_4 -> V_2 . V_22 , & V_821 ) ;
F_18 ( & V_4 -> V_2 ) ;
F_94 ( & V_636 ) ;
return 0 ;
}
