...
if ( V_285 == NULL )
goto V_287;
if ( ! F_132 ( V_84 -> V_143 . V_284 . V_276 , L_111 , V_285 ) )
V_122 = F_132 ( V_84 -> V_143 . V_284 . V_277 , L_111 , V_285 ) ;
free ( V_285 ) ;
V_158:
return V_122 ;
V_287:
...
if ( V_122 ) {
fprintf ( V_84 -> V_109 , L_119 , V_122 ) ;
goto V_314;
}
...
char V_304 [ V_305 ] ;
V_297:
F_164 ( V_124 , V_304 , sizeof( V_304 ) , L_112 , L_113 ) ;
goto V_319;
V_293:
F_164 ( V_124 , V_304 , sizeof( V_304 ) , L_1 , L_124 ) ;
goto V_319;
V_310:
...
V_319:
fprintf ( V_84 -> V_109 , L_125 , V_304 ) ;
goto V_298;
V_308:
fprintf ( V_84 -> V_109 ,
L_126 ,
...
V_294:
fprintf ( V_84 -> V_109 , L_127 ) ;
goto V_298;
V_307:
fprintf ( V_84 -> V_109 , L_128 , V_124 , strerror ( V_124 ) ) ;
goto V_298;
}
...
if ( V_68 == NULL )
return 0 ;
V_42 += fprintf ( V_58 , L_122 ) ;
V_42 += fprintf ( V_58 , L_136 ) ;
V_42 += fprintf ( V_58 , L_137 ) ;
V_42 += fprintf ( V_58 , L_138 ) ;
...
V_42 += fprintf ( V_58 , L_139 , V_130 -> V_20 ) ;
V_42 += fprintf ( V_58 , L_140 V_110 L_141 ,
T_2 , V_350 -> V_354 , V_351 , V_352 ) ;
V_42 += fprintf ( V_58 , L_142 , V_67 , V_353 ) ;
}
}
F_181 ( V_68 ) ;
V_42 += fprintf ( V_58 , L_143 ) ;
return V_42 ;
}
...
V_42 += fprintf ( V_58 , L_144 , F_52 ( V_69 ) , V_69 -> V_81 ) ;
V_42 += fprintf ( V_58 , L_145 , V_65 -> V_71 ) ;
V_42 += fprintf ( V_58 , L_146 , V_355 ) ;
if ( V_65 -> V_243 )
V_42 += fprintf ( V_58 , L_147 , V_65 -> V_243 ) ;
if ( V_65 -> V_244 )
V_42 += fprintf ( V_58 , L_148 , V_65 -> V_244 ) ;
if ( V_84 -> V_296 )
V_42 += fprintf ( V_58 , L_149 , V_65 -> V_210 ) ;
else if ( fputc ( '\n' , V_58 ) != V_356 )
++ V_42 ;
...
char V_364 [ V_76 ] ;
F_16 ( V_364 , sizeof( V_364 ) , L_151 , V_90 ) ;
F_191 ( V_364 ) ;
rename ( V_90 , V_364 ) ;
}
V_84 -> V_109 = fopen ( V_90 , L_152 ) ;
...
F_195 ( 0 , L_158 , & V_84 . V_121 , L_158 ,
L_159 ,
V_377 ) ,
F_196 ( 0 , L_73 , & V_84 . V_103 ,
L_160 ) ,
F_196 ( 0 , L_161 , & V_84 . V_318 , L_162 ) ,
F_197 ( 'e' , L_163 , & V_375 , L_163 , L_164 ) ,
F_197 ( 'o' , L_165 , & V_374 , L_166 , L_167 ) ,
F_197 ( 'i' , L_168 , & V_324 , L_166 , L_169 ) ,
F_197 ( 'p' , L_74 , & V_84 . V_125 . V_126 . V_173 , L_74 ,
L_170 ) ,
F_197 ( 't' , L_171 , & V_84 . V_125 . V_126 . V_81 , L_171 ,
L_172 ) ,
F_195 ( 0 , L_173 , & V_84 , L_174 ,
L_175 , F_186 ) ,
F_196 ( 'a' , L_176 , & V_84 . V_125 . V_126 . V_378 ,
L_177 ) ,
F_197 ( 'C' , L_178 , & V_84 . V_125 . V_126 . V_379 , L_178 ,
L_179 ) ,
F_196 ( 0 , L_180 , & V_84 . V_125 . V_380 ,
L_181 ) ,
F_195 ( 'm' , L_182 , & V_84 . V_125 . V_309 , L_183 ,
L_184 ,
V_381 ) ,
F_197 ( 'u' , L_185 , & V_84 . V_125 . V_126 . V_382 , L_186 ,
L_187 ) ,
F_195 ( 0 , L_188 , & V_84 , L_189 ,
L_190 ,
F_185 ) ,
F_196 ( 0 , L_112 , & V_84 . V_296 , L_191 ) ,
F_198 ( 'v' , L_192 , & V_164 , L_193 ) ,
F_196 ( 'T' , L_194 , & V_84 . V_252 ,
L_195 ) ,
F_196 ( 's' , L_196 , & V_84 . V_176 ,
L_197 ) ,
F_196 ( 'S' , L_198 , & V_84 . V_189 ,
L_199 ) ,
F_199 ( 'F' , L_200 , & V_84 . V_267 , L_201 ,
L_202 , F_192 , L_83 ) ,
F_196 ( 0 , L_2 , & V_84 . V_228 , L_203 ) ,
F_196 ( 'f' , L_204 , & V_84 . V_326 , L_205 ) ,
F_195 ( 0 , L_206 , & V_84 . V_125 ,
L_207 , V_383 ,
& V_384 ) ,
F_196 ( 0 , L_208 , & V_84 . V_282 ,
L_209 ) ,
F_200 ( 0 , L_210 , & V_84 . V_177 ,
L_211
L_212 ) ,
F_200 ( 0 , L_213 , & V_84 . V_183 ,
L_214
L_215
L_216 F_201 ( V_385 ) ) ,
F_200 ( 0 , L_217 , & V_84 . V_125 . V_128 ,
L_218 ) ,
F_202 ()
} ;
...
F_209 ( & V_84 . V_125 , & V_280 , L_220 , false ) ;
#endif
if ( V_280 . V_281 ) {
if ( ! V_387 && F_210 () == 0 )
...
V_84 . V_190 = F_74 ( V_84 . V_142 , L_224 ) ;
if ( V_375 != NULL ) {
