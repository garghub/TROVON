...
if ( ! V_30 -> V_36 )
return - V_37 ;
V_12 = F_12 ( V_30 , sizeof( * V_12 ) , V_38 ) ;
if ( ! V_12 )
return - V_39 ;
V_35 = F_13 ( V_30 ) ;
V_33 = F_14 ( V_35 , V_40 , 1 ) ;
if ( ! V_33 ) {
F_15 ( V_30 , L_1 ) ;
return - V_37 ;
}
V_12 -> V_15 = F_16 ( V_30 , V_33 -> V_21 , 0x10000 ) ;
if ( ! V_12 -> V_15 )
return - V_39 ;
V_31 = V_33 -> V_21 + 0xf00000 ;
V_12 -> V_17 [ 0 ] = ( T_1 ) V_31 | 2 ;
V_12 -> V_17 [ 1 ] = ( T_1 ) ( V_33 -> V_22 - V_31 ) & ~ 3u ;
V_12 -> V_17 [ 2 ] = ( T_1 ) ( V_31 >> 32 ) ;
V_9 -> V_13 = V_12 ;
return 0 ;
}
static int F_17 ( struct V_34 * V_35 )
{
return F_18 ( V_35 , & V_41 ) ;
}
