...
V_8 -> V_207 . V_91 = L_71 ;
V_43 = F_80 ( V_29 , V_199 , V_200 ) ;
if ( ! V_43 ) {
V_10 = - V_152 ;
goto V_202;
}
for ( V_45 = 0 ; V_45 < V_196 ; ++ V_45 ) {
V_44 = F_81 ( sizeof( struct V_27 ) , V_200 ) ;
if ( ! V_44 ) {
V_10 = - V_152 ;
goto V_209;
}
...
F_2 ( & V_12 ) ;
V_18 = F_85 ( & V_20 , V_13 , 0 , 256 , V_200 ) ;
F_3 ( & V_12 ) ;
if ( V_18 < 0 )
return V_18 ;
V_8 -> V_5 = F_86 ( 1 << V_19 ) ;
...
F_88 ( V_8 -> V_157 , F_65 ) ;
F_89 ( V_8 -> V_157 , V_226 ) ;
F_90 ( V_8 -> V_157 , V_232 ) ;
F_91 ( V_8 -> V_157 , V_233 ) ;
F_92 ( V_8 -> V_157 ,
V_232 * V_8 -> V_59 ) ;
V_8 -> V_5 -> V_234 = V_234 ;
...
struct V_7 * V_8 ;
int V_10 = 0 ;
V_8 = F_81 ( sizeof( struct V_7 ) , V_200 ) ;
if ( ! V_8 )
return - V_152 ;
F_99 ( V_13 , V_8 ) ;
V_8 -> V_13 = V_13 ;
...
if ( V_10 )
goto V_241;
V_10 = F_101 ( & V_13 -> V_42 . V_242 , & V_8 -> V_207 ) ;
if ( V_10 )
goto V_241;
V_10 = F_84 ( V_13 ) ;
if ( ! V_10 ) {
...
F_102 ( & V_13 -> V_42 . V_242 , & V_8 -> V_207 ) ;
V_241:
F_99 ( V_13 , NULL ) ;
F_96 ( V_8 ) ;
F_7 ( V_8 ) ;
...
static int F_106 ( struct V_99 * V_13 , T_6 V_246 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
unsigned char V_45 ;
F_2 ( & V_156 -> V_249 ) ;
V_247 = F_81 ( sizeof( struct V_7 ) , V_200 ) ;
if ( ! V_247 ) {
V_10 = - V_152 ;
goto V_250;
}
