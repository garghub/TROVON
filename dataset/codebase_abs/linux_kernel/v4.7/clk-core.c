...
V_21 = F_20 ( V_4 -> V_5 , V_20 , V_20 & V_22 ,
1 , V_23 ) ;
if ( V_21 )
return V_21 ;
return ( F_11 ( V_4 ) == div ) ? 0 : - V_26 ;
}
struct V_27 * F_21 ( const struct V_28 * V_29 ,
struct V_30 * V_24 )
{
struct V_3 * V_31 ;
struct V_27 * V_27 ;
V_31 = F_22 ( V_24 -> V_32 , sizeof( * V_31 ) , V_33 ) ;
if ( ! V_31 )
return F_23 ( - V_34 ) ;
V_31 -> V_2 . V_35 = & V_29 -> V_36 ;
V_31 -> V_24 = V_24 ;
V_31 -> V_5 = V_29 -> V_5 + V_24 -> V_37 ;
V_27 = F_24 ( V_24 -> V_32 , & V_31 -> V_2 ) ;
if ( F_25 ( V_27 ) ) {
F_26 ( V_24 -> V_32 , L_1 , V_38 ) ;
F_27 ( V_24 -> V_32 , V_31 ) ;
}
return V_27 ;
}
...
if ( ! V_40 -> V_46 )
return V_20 ;
for ( V_43 = 0 ; V_43 < F_34 ( V_2 ) ; V_43 ++ )
if ( V_40 -> V_46 [ V_43 ] == V_20 )
return V_43 ;
return - V_47 ;
}
static unsigned long F_35 ( unsigned long V_8 ,
T_1 V_48 , T_1 V_49 )
{
T_3 V_50 ;
if ( V_49 ) {
...
V_49 = ( V_20 >> V_58 ) & V_59 ;
return F_35 ( V_8 , V_48 , V_49 ) ;
}
static long F_39 ( struct V_1 * V_2 , unsigned long V_7 ,
unsigned long * V_8 )
{
T_1 V_49 , V_48 ;
F_37 ( V_7 , * V_8 , & V_48 , & V_49 ) ;
return F_35 ( * V_8 , V_48 , V_49 ) ;
}
...
static int F_46 ( struct V_1 * V_2 , T_2 V_70 )
{
struct V_39 * V_40 = F_29 ( V_2 ) ;
unsigned long V_19 ;
T_1 V_20 ;
...
V_21 = F_20 ( V_40 -> V_5 , V_20 , ! ( V_20 & V_73 ) ,
1 , V_23 ) ;
...
struct V_39 * V_40 ;
struct V_27 * V_27 ;
V_40 = F_22 ( V_24 -> V_32 , sizeof( * V_40 ) , V_33 ) ;
if ( ! V_40 )
return F_23 ( - V_34 ) ;
V_40 -> V_24 = V_24 ;
...
struct V_79 * V_101 ;
struct V_27 * V_27 ;
V_101 = F_22 ( V_24 -> V_32 , sizeof( * V_101 ) , V_33 ) ;
if ( ! V_101 )
return F_23 ( - V_34 ) ;
V_101 -> V_24 = V_24 ;
...
struct V_104 * V_105 ;
struct V_27 * V_27 ;
V_105 = F_22 ( V_24 -> V_32 , sizeof( * V_105 ) , V_33 ) ;
if ( ! V_105 )
return F_23 ( - V_34 ) ;
V_105 -> V_24 = V_24 ;
...
V_27 = F_24 ( V_24 -> V_32 , & V_105 -> V_2 ) ;
if ( F_25 ( V_27 ) )
F_26 ( V_24 -> V_32 , L_12 , V_38 ) ;
return V_27 ;
}
...
{
struct V_124 * V_125 ;
V_125 = F_22 ( V_24 -> V_32 , sizeof( * V_125 ) , V_33 ) ;
if ( ! V_125 )
return F_23 ( - V_34 ) ;
V_125 -> V_24 = V_24 ;
...
return F_24 ( V_24 -> V_32 , & V_125 -> V_2 ) ;
}
