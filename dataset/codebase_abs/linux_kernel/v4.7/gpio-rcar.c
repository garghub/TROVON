...
{
return F_27 ( V_47 -> V_4 + V_41 ) ;
}
static void F_28 ( struct V_10 * V_47 , unsigned V_41 )
{
F_29 ( V_47 -> V_4 + V_41 ) ;
F_25 ( V_47 , V_41 , false ) ;
}
static int F_30 ( struct V_10 * V_47 , unsigned V_41 )
{
F_25 ( V_47 , V_41 , false ) ;
return 0 ;
}
static int F_31 ( struct V_10 * V_47 , unsigned V_41 )
{
T_1 V_6 = F_6 ( V_41 ) ;
...
static void F_32 ( struct V_10 * V_47 , unsigned V_41 , int V_5 )
{
struct V_1 * V_2 = F_9 ( V_47 ) ;
unsigned long V_18 ;
F_13 ( & V_2 -> V_19 , V_18 ) ;
...
static void F_33 ( struct V_10 * V_47 , unsigned long * V_53 ,
unsigned long * V_54 )
{
struct V_1 * V_2 = F_9 ( V_47 ) ;
unsigned long V_18 ;
T_1 V_55 , V_56 ;
V_56 = V_53 [ 0 ] & F_34 ( V_47 -> V_57 - 1 , 0 ) ;
if ( ! V_56 )
return;
F_13 ( & V_2 -> V_19 , V_18 ) ;
V_55 = F_1 ( V_2 , V_51 ) ;
...
static int F_35 ( struct V_10 * V_47 , unsigned V_41 ,
int V_5 )
{
F_32 ( V_47 , V_41 , V_5 ) ;
F_25 ( V_47 , V_41 , true ) ;
...
static int F_36 ( struct V_1 * V_2 , unsigned int * V_58 )
{
...
static int F_40 ( struct V_72 * V_26 )
{
struct V_1 * V_2 ;
...
const char * V_77 = F_41 ( V_27 ) ;
unsigned int V_58 ;
int V_67 ;
V_2 = F_42 ( V_27 , sizeof( * V_2 ) , V_78 ) ;
if ( ! V_2 )
return - V_79 ;
V_2 -> V_26 = V_26 ;
F_43 ( & V_2 -> V_19 ) ;
...
F_49 ( V_27 ) ;
F_50 ( V_27 ) ;
V_74 = F_51 ( V_26 , V_81 , 0 ) ;
V_38 = F_51 ( V_26 , V_82 , 0 ) ;
if ( ! V_74 || ! V_38 ) {
F_47 ( V_27 , L_6 ) ;
V_67 = - V_34 ;
goto V_80;
}
V_2 -> V_4 = F_52 ( V_27 , V_74 -> V_83 , F_53 ( V_74 ) ) ;
if ( ! V_2 -> V_4 ) {
F_47 ( V_27 , L_7 ) ;
V_67 = - V_84 ;
goto V_80;
...
V_75 -> V_97 = F_15 ;
V_75 -> V_98 = F_17 ;
V_75 -> V_18 = V_99 | V_100 ;
V_67 = F_54 ( V_10 , V_2 ) ;
if ( V_67 ) {
F_47 ( V_27 , L_8 ) ;
goto V_80;
}
V_67 = F_55 ( V_10 , V_75 , 0 , V_101 ,
V_102 ) ;
if ( V_67 ) {
F_47 ( V_27 , L_9 ) ;
goto V_103;
