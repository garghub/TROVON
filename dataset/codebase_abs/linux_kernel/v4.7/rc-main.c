...
for ( V_31 = 0 ; V_31 < F_65 ( V_104 ) ; V_31 ++ ) {
...
static int F_66 ( T_1 * V_107 , const char * V_89 )
{
const char * V_94 ;
unsigned V_108 = 0 ;
bool V_109 , V_110 ;
T_1 V_111 ;
int V_31 ;
while ( ( V_94 = F_67 ( ( char * * ) & V_89 , L_23 ) ) != NULL ) {
if ( ! * V_94 )
break;
if ( * V_94 == '+' ) {
V_109 = true ;
...
struct V_90 * V_91 = F_62 ( V_88 ) ;
T_1 * V_118 ;
int (* F_71)( struct V_25 * V_26 , T_1 * V_10 );
struct V_119 * V_120 ;
int (* F_72)( struct V_25 * V_26 , struct V_119 * V_120 );
T_1 V_121 , V_122 ;
T_7 V_6 ;
if ( ! V_26 )
return - V_48 ;
...
static void F_76 ( struct V_80 * V_80 )
{
struct V_25 * V_26 = F_61 ( V_80 ) ;
F_19 ( V_26 ) ;
}
static int F_77 ( struct V_80 * V_80 , struct V_133 * V_134 )
{
struct V_25 * V_26 = F_61 ( V_80 ) ;
if ( V_26 -> V_5 . V_2 )
F_78 ( L_36 , V_26 -> V_5 . V_2 ) ;
if ( V_26 -> V_135 )
F_78 ( L_37 , V_26 -> V_135 ) ;
return 0 ;
}
struct V_25 * F_79 ( void )
{
struct V_25 * V_26 ;
V_26 = F_80 ( sizeof( * V_26 ) , V_15 ) ;
if ( ! V_26 )
return NULL ;
V_26 -> V_35 = F_81 () ;
if ( ! V_26 -> V_35 ) {
...
V_26 -> V_35 -> V_136 = F_32 ;
V_26 -> V_35 -> V_137 = F_25 ;
F_82 ( V_26 -> V_35 , V_26 ) ;
F_83 ( & V_26 -> V_5 . V_46 ) ;
F_83 ( & V_26 -> V_61 ) ;
F_84 ( & V_26 -> V_46 ) ;
F_85 ( & V_26 -> V_69 , F_39 , ( unsigned long ) V_26 ) ;
...
return - V_48 ;
F_93 ( V_147 , V_26 -> V_35 -> V_148 ) ;
F_93 ( V_149 , V_26 -> V_35 -> V_148 ) ;
F_93 ( V_64 , V_26 -> V_35 -> V_148 ) ;
F_93 ( V_65 , V_26 -> V_35 -> V_150 ) ;
if ( V_26 -> V_78 )
V_26 -> V_35 -> V_78 = F_51 ;
if ( V_26 -> V_79 )
V_26 -> V_35 -> V_79 = F_53 ;
V_144 = F_94 ( & V_151 , 0 , V_152 , V_15 ) ;
if ( V_144 < 0 )
return V_144 ;
V_26 -> V_144 = V_144 ;
F_95 ( & V_26 -> V_26 , L_38 , V_26 -> V_144 ) ;
F_96 ( & V_26 -> V_26 , V_26 ) ;
F_97 ( & V_26 -> V_95 , 0 ) ;
...
V_26 -> V_35 -> V_166 [ V_167 ] = 500 ;
V_26 -> V_35 -> V_166 [ V_168 ] = 125 ;
V_6 = F_99 ( V_26 -> V_35 ) ;
if ( V_6 )
goto V_169;
V_143 = F_100 ( & V_26 -> V_26 . V_170 , V_15 ) ;
F_101 ( & V_26 -> V_26 , L_39 ,
