...
static int F_51 ( struct V_124 * V_125 , struct V_1 * V_11 )
{
int V_34 ;
V_34 = F_52 ( V_125 , & V_11 -> V_7 , & V_126 ,
V_127 ) ;
if ( V_34 ) {
F_36 ( L_8 ) ;
return V_34 ;
...
static int F_57 ( struct V_124 * V_125 , struct V_1 * V_11 )
{
int V_34 ;
V_34 = F_58 ( V_125 , & V_11 -> V_4 , & V_132 ,
V_133 , NULL ) ;
if ( V_34 ) {
F_36 ( L_10 ) ;
return V_34 ;
...
F_59 ( & V_11 -> V_4 , & V_134 ) ;
V_11 -> V_4 . V_135 = 1 ;
V_34 = F_49 ( V_11 -> V_122 , & V_11 -> V_4 ) ;
if ( V_34 ) {
V_34 = F_51 ( V_125 , V_11 ) ;
if ( V_34 )
goto V_136;
}
return 0 ;
...
static void F_62 ( struct V_137 * V_138 )
{
struct V_1 * V_11 = F_2 ( V_138 , struct V_1 , V_139 ) ;
F_32 ( V_11 ) ;
}
...
static int F_66 ( struct V_32 * V_33 , struct V_32 * V_141 , void * V_14 )
{
int V_34 ;
struct V_124 * V_125 = V_14 ;
struct V_1 * V_11 = F_67 ( V_33 ) ;
V_34 = F_68 ( V_125 , & V_11 -> V_139 ) ;
if ( V_34 < 0 ) {
F_15 ( V_33 , L_11 ,
...
F_70 ( & V_11 -> V_10 ) ;
V_144:
F_71 ( V_125 , & V_11 -> V_139 ) ;
return V_34 ;
}
static void F_72 ( struct V_32 * V_33 , struct V_32 * V_141 ,
void * V_14 )
{
struct V_124 * V_125 = V_14 ;
struct V_1 * V_11 = F_67 ( V_33 ) ;
...
int V_152 ;
int V_34 ;
V_11 = F_74 ( V_33 , sizeof( * V_11 ) , V_153 ) ;
if ( ! V_11 )
return - V_154 ;
V_11 -> V_10 . V_155 = & V_156 ;
V_11 -> V_10 . V_33 = V_33 ;
V_150 = F_75 ( V_33 -> V_142 , NULL ) ;
if ( V_150 ) {
V_149 = F_76 ( V_150 ) ;
if ( ! V_149 ) {
F_15 ( V_33 , L_14 ) ;
...
V_11 -> V_122 = F_77 ( V_149 ) ;
V_11 -> V_104 = F_78 ( V_149 ) ;
F_79 ( V_149 ) ;
...
V_11 -> V_41 = F_81 ( V_33 , L_16 ) ;
if ( F_82 ( V_11 -> V_41 ) ) {
V_34 = F_83 ( V_11 -> V_41 ) ;
F_15 ( V_33 , L_17 , V_34 ) ;
return V_34 ;
}
V_11 -> V_43 = F_81 ( V_33 , L_18 ) ;
if ( F_82 ( V_11 -> V_43 ) ) {
V_34 = F_83 ( V_11 -> V_43 ) ;
F_15 ( V_33 , L_19 , V_34 ) ;
return V_34 ;
}
V_11 -> V_38 = F_81 ( V_33 , L_20 ) ;
if ( F_82 ( V_11 -> V_38 ) ) {
V_34 = F_83 ( V_11 -> V_38 ) ;
F_15 ( V_33 , L_21 , V_34 ) ;
return V_34 ;
}
V_16 = F_84 ( V_147 , V_159 , 0 ) ;
V_11 -> V_16 = F_85 ( V_33 , V_16 ) ;
if ( F_82 ( V_11 -> V_16 ) ) {
V_34 = F_83 ( V_11 -> V_16 ) ;
F_15 ( V_33 , L_22 , V_34 ) ;
return V_34 ;
}
V_11 -> V_40 = F_86 ( V_33 , L_23 ) ;
if ( F_82 ( V_11 -> V_40 ) ) {
V_34 = F_83 ( V_11 -> V_40 ) ;
F_15 ( V_33 , L_24 , V_34 ) ;
return V_34 ;
}
V_152 = F_87 ( V_33 -> V_142 , V_160 ) ;
if ( V_152 < 0 ) {
F_15 ( V_33 , L_25 , V_152 ) ;
return V_152 ;
}
V_34 = F_88 ( V_33 , V_33 -> V_142 , & V_11 -> V_139 , V_152 ,
& V_161 ) ;
if ( V_34 ) {
F_15 ( V_33 , L_26 , V_34 ) ;
return V_34 ;
...
F_89 ( V_147 , V_11 ) ;
return F_90 ( & V_147 -> V_33 , & V_162 ) ;
}
static int F_91 ( struct V_146 * V_147 )
{
struct V_1 * V_11 = F_92 ( V_147 ) ;
F_37 ( V_11 ) ;
F_93 ( & V_147 -> V_33 , & V_162 ) ;
return 0 ;
}
