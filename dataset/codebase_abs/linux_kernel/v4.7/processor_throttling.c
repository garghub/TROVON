...
if ( ! V_8 -> V_40 . V_19 )
return - V_58 ;
F_30 ( V_8 -> V_19 . V_99 , 6 , L_33 ) ;
V_8 -> V_19 . V_50 = 0 ;
V_97 = V_8 -> V_19 . V_47 - 1 ;
V_97 <<= V_8 -> V_19 . V_100 ;
F_31 () ;
V_96 = F_32 ( V_8 -> V_19 . V_99 ) ;
if ( V_96 & 0x10 ) {
V_98 = V_96 & V_97 ;
V_98 >>= V_8 -> V_19 . V_100 ;
if ( V_98 )
...
static int F_34 ( T_4 * V_96 )
{
T_4 V_103 , V_104 ;
T_4 V_105 = 0 ;
int V_106 = - 1 ;
if ( ( F_35 ( V_107 . V_108 ) != V_109 ) ||
! F_36 ( V_110 ) ) {
F_13 (KERN_ERR PREFIX
L_35 ) ;
} else {
...
else if ( ( V_8 -> V_19 . V_100 + V_8 -> V_19 . V_123 ) > 4 ) {
...
V_129 . V_36 = V_50 ;
V_129 . V_126 = V_126 ;
V_106 = F_57 ( V_8 -> V_93 , F_54 , & V_129 ) ;
} else {
