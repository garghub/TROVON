...
static int F_70 ( struct V_27 * V_28 , int V_5 , int V_22 )
{
struct V_1 * V_2 = & V_28 -> V_2 [ V_5 ] ;
struct V_33 * V_36 ;
int V_30 ;
V_36 = F_71 ( V_28 -> V_21 , sizeof( * V_36 ) , V_146 ) ;
if ( V_36 == NULL )
return - V_63 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_7 = V_28 -> V_7 ;
if ( V_22 ) {
V_30 = F_72 ( V_28 -> V_21 , V_22 , F_10 ,
V_147 , L_10 , V_2 ) ;
if ( V_30 ) {
F_31 ( V_28 -> V_21 , L_11 ) ;
return V_30 ;
...
F_74 ( & V_36 -> V_25 , F_63 , ( unsigned long ) V_36 ) ;
F_32 ( & V_36 -> V_45 ) ;
F_32 ( & V_36 -> V_47 ) ;
F_47 ( & V_36 -> V_36 . V_148 , & V_28 -> V_37 . V_149 ) ;
return 0 ;
}
static struct V_61 * F_75 ( struct V_150 * V_151 ,
struct V_152 * V_153 )
{
struct V_27 * V_154 = V_153 -> V_155 ;
struct V_61 * V_36 ;
V_36 = F_76 ( & V_154 -> V_37 ) ;
if ( ! V_36 )
return NULL ;
F_25 ( V_36 ) -> V_10 = V_151 -> args [ 0 ] ;
return V_36 ;
}
static int F_77 ( struct V_144 * V_145 )
{
struct V_27 * V_28 ;
const struct V_156 * V_157 ;
struct V_158 * V_159 = F_78 ( & V_145 -> V_21 ) ;
struct V_160 * V_161 ;
...
V_117 | V_119 |
V_121 ;
V_28 = F_71 ( & V_145 -> V_21 , sizeof( * V_28 ) , V_146 ) ;
if ( ! V_28 )
return - V_63 ;
V_28 -> V_21 = & V_145 -> V_21 ;
F_73 ( & V_28 -> V_40 ) ;
V_161 = F_79 ( V_145 , V_163 , 0 ) ;
V_28 -> V_7 = F_80 ( V_28 -> V_21 , V_161 ) ;
if ( F_81 ( V_28 -> V_7 ) )
return F_82 ( V_28 -> V_7 ) ;
V_157 = F_83 ( V_164 , V_28 -> V_21 ) ;
if ( V_157 )
F_84 ( V_28 -> V_21 -> V_165 , L_12 ,
& V_32 ) ;
...
if ( F_85 ( V_145 , V_29 ) > 0 )
V_31 ++ ;
}
V_28 -> V_2 = F_86 ( V_28 -> V_21 , V_32 , sizeof( * V_28 -> V_2 ) ,
V_146 ) ;
if ( V_28 -> V_2 == NULL )
return - V_63 ;
...
if ( V_31 != V_32 ) {
V_22 = F_85 ( V_145 , 0 ) ;
V_30 = F_72 ( V_28 -> V_21 , V_22 , F_12 ,
V_147 , L_10 , V_28 ) ;
if ( V_30 )
return V_30 ;
}
for ( V_29 = 0 ; V_29 < V_32 ; V_29 ++ ) {
V_22 = ( V_31 != V_32 ) ? 0 : F_85 ( V_145 , V_29 ) ;
V_30 = F_70 ( V_28 , V_29 , V_22 ) ;
if ( V_30 )
return V_30 ;
}
F_87 ( V_166 , V_28 -> V_37 . V_167 ) ;
F_87 ( V_168 , V_28 -> V_37 . V_167 ) ;
F_87 ( V_169 , V_28 -> V_37 . V_167 ) ;
F_87 ( V_170 , V_28 -> V_37 . V_167 ) ;
...
if ( V_28 -> V_21 -> V_187 )
F_88 ( V_28 -> V_21 , V_28 -> V_21 -> V_187 ) ;
else
F_88 ( V_28 -> V_21 , F_89 ( 64 ) ) ;
V_30 = F_90 ( & V_28 -> V_37 ) ;
if ( V_30 ) {
...
F_92 ( V_145 , V_28 ) ;
F_93 ( V_28 -> V_37 . V_21 , L_15 , V_32 ) ;
return 0 ;
}
bool F_94 ( struct V_61 * V_36 , void * V_188 )
{
