...
V_2 -> V_117 = F_113 ( V_127 , V_129 [ 0 ] ) ;
V_2 -> V_132 = F_113 ( V_127 , V_129 [ 1 ] ) ;
return 0 ;
}
...
const char * V_136 ;
V_16 = F_115 ( V_6 , sizeof( * V_16 ) , V_137 ) ;
if ( ! V_16 )
return - V_138 ;
if ( F_116 ( V_135 , L_19 , & V_2 -> V_4 ) ||
V_2 -> V_4 == V_139 ) {
F_4 ( V_6 , L_20 ) ;
return - V_31 ;
}
if ( V_2 -> V_4 >= V_5 )
V_16 -> V_17 = 1 ;
if ( F_116 ( V_135 , L_21 , & V_16 -> V_131 ) ) {
F_4 ( V_6 , L_22 ) ;
return - V_31 ;
}
if ( F_117 ( V_135 , L_23 , & V_136 ) ) {
F_4 ( V_6 , L_24 ) ;
return - V_31 ;
}
...
V_2 -> V_143 = & V_145 ;
V_2 -> V_32 = F_119 ( V_123 -> V_6 . V_126 , 0 ) ;
if ( F_120 ( V_2 -> V_32 ) )
V_10 = F_121 ( V_2 -> V_32 ) ;
if ( V_2 -> V_117 ) {
V_10 = F_105 ( V_2 -> V_117 , 1 ) ;
