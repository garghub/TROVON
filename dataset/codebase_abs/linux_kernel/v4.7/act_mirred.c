...
if ( F_41 ( V_50 , V_87 , sizeof( V_81 ) , & V_81 , V_88 ) )
goto V_82;
return V_50 -> V_89 ;
V_82:
F_42 ( V_50 , V_73 ) ;
...
static int F_43 ( struct V_11 * V_11 , struct V_49 * V_50 ,
struct V_90 * V_91 , int type ,
struct V_1 * V_2 )
{
struct V_16 * V_17 = F_9 ( V_11 , V_18 ) ;
return F_44 ( V_17 , V_50 , V_91 , type , V_2 ) ;
}
