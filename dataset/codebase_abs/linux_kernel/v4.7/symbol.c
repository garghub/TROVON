...
V_2 -> V_13 &= V_13 | ~ V_46 ;
V_44 = V_2 -> V_3 [ V_47 ] . V_30 ;
if ( V_44 && V_44 -> V_18 != V_22 )
return V_44 ;
V_44 = F_29 ( V_2 ) ;
if ( V_44 == NULL )
V_2 -> V_29 . V_27 = V_22 ;
...
if ( F_8 ( V_2 ) && V_2 -> V_18 == V_19 ) {
V_5 = F_10 ( V_2 ) ;
V_49 . V_27 = ( F_26 ( V_5 ) -> V_29 . V_30 == V_2 ) ? V_19 : V_22 ;
} else {
if ( V_2 -> V_18 != V_22 ) {
V_2 -> V_13 |= V_56 ;
if ( F_32 ( V_2 ) ) {
V_49 . V_27 = F_33 ( V_2 -> V_3 [ V_47 ] . V_27 ,
V_2 -> V_18 ) ;
goto V_57;
}
}
...
struct V_7 * V_45 ;
V_45 = F_35 ( V_2 -> V_43 . V_7 ,
V_2 -> V_42 . V_7 ) ;
fprintf ( V_58 , L_11 ) ;
F_36 ( V_45 , V_58 ) ;
fprintf ( V_58 , L_12 ,
V_2 -> V_55 ) ;
F_36 ( V_2 -> V_42 . V_7 , V_58 ) ;
fprintf ( V_58 , L_13 ) ;
F_37 ( V_45 ) ;
}
V_49 . V_27 = F_28 ( V_49 . V_27 , V_2 -> V_43 . V_27 ) ;
}
if ( V_49 . V_27 == V_41 && F_7 ( V_2 ) == V_20 )
V_49 . V_27 = V_19 ;
break;
case V_12 :
case V_24 :
...
V_2 -> V_13 |= V_56 ;
if ( F_32 ( V_2 ) ) {
V_49 . V_30 = V_2 -> V_3 [ V_47 ] . V_30 ;
break;
}
}
V_5 = F_14 ( V_2 ) ;
if ( V_5 ) {
struct V_1 * V_59 = F_26 ( V_5 ) ;
if ( V_59 ) {
V_2 -> V_13 |= V_56 ;
F_19 ( V_59 ) ;
V_49 . V_30 = V_59 -> V_29 . V_30 ;
}
}
break;
default:
...
V_2 -> V_29 = V_49 ;
if ( F_34 ( V_2 ) && V_49 . V_27 == V_19 )
V_2 -> V_29 . V_30 = F_31 ( V_2 ) ;
F_20 ( V_2 ) ;
if ( memcmp ( & V_50 , & V_2 -> V_29 , sizeof( V_50 ) ) ) {
F_22 ( V_2 ) ;
if ( V_60 == V_2 ) {
F_23 () ;
V_21 = V_60 -> V_29 . V_27 ;
...
struct V_1 * V_61 = F_26 ( F_10 ( V_2 ) ) ;
struct V_4 * V_5 ;
struct V_7 * V_45 ;
V_61 -> V_3 [ V_47 ] . V_30 = V_2 ;
V_61 -> V_13 |= V_46 ;
V_5 = F_10 ( V_61 ) ;
for ( V_45 = V_5 -> V_7 ; V_45 ; V_45 = V_45 -> V_33 . V_7 ) {
if ( V_45 -> V_34 . V_2 -> V_18 != V_22 )
V_45 -> V_34 . V_2 -> V_13 |= V_46 ;
}
}
V_2 -> V_3 [ V_47 ] . V_27 = V_30 ;
if ( V_50 != V_30 )
F_39 () ;
return true ;
}
...
bool F_47 ( struct V_1 * V_2 , const char * V_49 )
{
const char * V_50 ;
char * V_30 ;
int V_63 ;
...
V_50 = V_2 -> V_3 [ V_47 ] . V_30 ;
V_63 = strlen ( V_49 ) + 1 ;
if ( V_2 -> type == V_24 && ( V_49 [ 0 ] != '0' || ( V_49 [ 1 ] != 'x' && V_49 [ 1 ] != 'X' ) ) ) {
V_63 += 2 ;
V_2 -> V_3 [ V_47 ] . V_30 = V_30 = xmalloc ( V_63 ) ;
* V_30 ++ = '0' ;
* V_30 ++ = 'x' ;
} else if ( ! V_50 || strcmp ( V_50 , V_49 ) )
V_2 -> V_3 [ V_47 ] . V_30 = V_30 = xmalloc ( V_63 ) ;
else
return true ;
strcpy ( V_30 , V_49 ) ;
...
if ( V_59 != NULL ) {
F_19 ( V_59 ) ;
V_32 = ( const char * ) V_59 -> V_29 . V_30 ;
}
}
}
V_30 = F_28 ( V_30 , V_2 -> V_43 . V_27 ) ;
if ( V_30 == V_41 )
if ( ! F_8 ( V_2 ) && V_60 -> V_29 . V_27 == V_22 )
V_30 = V_19 ;
...
case V_41 :
F_19 ( V_60 ) ;
return ( V_60 -> V_29 . V_27 == V_22 ) ? L_14 : L_15 ;
case V_19 :
return L_16 ;
}
break;
...
struct V_1 * F_4 ( const char * V_55 , int V_13 )
{
struct V_1 * V_1 ;
char * V_66 ;
int V_65 ;
...
struct V_1 * F_52 ( const char * V_55 )
{
struct V_1 * V_1 = NULL ;
int V_65 = 0 ;
if ( ! V_55 )
...
int V_86 , V_87 ;
V_86 = ( V_84 -> V_88 - V_84 -> V_89 ) == strlen ( V_84 -> V_2 -> V_55 ) ;
V_87 = ( V_85 -> V_88 - V_85 -> V_89 ) == strlen ( V_85 -> V_2 -> V_55 ) ;
if ( V_86 && ! V_87 )
return - 1 ;
if ( ! V_86 && V_87 )
return 1 ;
return strcmp ( V_84 -> V_2 -> V_55 , V_85 -> V_2 -> V_55 ) ;
}
...
return NULL ;
F_24 (i, sym) {
if ( V_2 -> V_13 & V_8 || ! V_2 -> V_55 )
continue;
if ( regexec ( & V_94 , V_2 -> V_55 , 1 , V_95 , 0 ) )
continue;
if ( V_93 >= V_63 ) {
void * V_98 ;
V_63 += 16 ;
...
if ( V_103 -> V_2 == V_106 )
fprintf ( V_58 , L_23 ,
V_5 -> V_109 -> V_55 , V_5 -> V_110 ) ;
fprintf ( V_58 , L_24 ) ;
fprintf ( V_58 , L_25 ) ;
if ( V_103 -> V_7 ) {
fprintf ( V_58 , L_26 ,
V_5 -> V_109 -> V_55 , V_5 -> V_110 ,
V_2 -> V_55 ? V_2 -> V_55 : L_27 ,
F_60 ( V_5 -> type ) ,
V_107 -> V_55 ? V_107 -> V_55 : L_27 ) ;
} else if ( V_103 -> V_5 ) {
fprintf ( V_58 , L_28 ,
V_5 -> V_109 -> V_55 , V_5 -> V_110 ,
V_2 -> V_55 ? V_2 -> V_55 : L_27 ,
...
static struct V_1 * F_61 ( struct V_7 * V_45 )
{
struct V_1 * V_2 ;
if ( ! V_45 )
return NULL ;
...
case V_111 :
case V_112 :
V_2 = F_61 ( V_45 -> V_33 . V_7 ) ;
if ( V_2 )
return V_2 ;
return F_61 ( V_45 -> V_34 . V_7 ) ;
case V_113 :
return F_61 ( V_45 -> V_33 . V_7 ) ;
case V_114 :
case V_115 :
case V_116 :
case V_117 :
case V_118 :
case V_119 :
V_2 = F_62 ( V_45 -> V_33 . V_2 ) ;
if ( V_2 )
return V_2 ;
return F_62 ( V_45 -> V_34 . V_2 ) ;
case V_120 :
return F_62 ( V_45 -> V_33 . V_2 ) ;
default:
break;
}
printf ( L_32 , V_45 -> type ) ;
return NULL ;
}
...
struct V_102 V_103 ;
F_57 ( & V_103 , V_2 ) ;
V_82 = F_61 ( V_2 -> V_43 . V_7 ) ;
if ( V_82 )
goto V_121;
for ( V_5 = V_2 -> V_5 ; V_5 ; V_5 = V_5 -> V_36 ) {
if ( V_5 -> type == V_122 || V_5 -> type == V_123 )
continue;
V_103 . V_5 = V_5 ;
...
static struct V_1 * F_64 ( struct V_1 * V_124 )
{
struct V_1 * V_2 , * V_82 ;
struct V_4 * V_5 ;
struct V_7 * V_45 ;
...
V_2 -> V_13 |= ( V_125 | V_126 ) ;
V_124 -> V_13 |= ( V_125 | V_126 ) ;
V_82 = F_63 ( V_124 ) ;
V_124 -> V_13 &= ~ V_125 ;
if ( V_82 )
goto V_121;
...
struct V_4 * F_2 ( enum V_127 type , struct V_1 * V_2 )
{
struct V_4 * V_5 ;
struct V_4 * * V_128 ;
...
V_5 -> V_110 = F_65 () ;
if ( V_2 ) {
for ( V_128 = & V_2 -> V_5 ; * V_128 ; V_128 = & ( * V_128 ) -> V_36 )
;
* V_128 = V_5 ;
}
return V_5 ;
...
{
if ( V_5 -> V_7 && ( V_5 -> V_7 -> type == V_120 ||
V_5 -> V_7 -> type == V_130 ) )
return V_5 -> V_7 -> V_33 . V_2 ;
return NULL ;
}
const char * F_60 ( enum V_127 type )
{
switch ( type ) {
case V_131 :
return L_33 ;
...
static void F_66 ( const char * V_138 )
{
struct V_1 * V_2 , * V_82 ;
struct V_4 * V_5 ;
char * V_76 ;
...
F_13 (sym, prop, P_ENV) {
V_82 = F_26 ( V_5 ) ;
if ( strcmp ( V_82 -> V_55 , V_138 ) )
F_67 ( V_139 , L_42 ,
V_82 -> V_55 ) ;
return;
}
V_5 = F_2 ( V_132 , V_2 ) ;
V_5 -> V_7 = F_3 ( F_4 ( V_138 , V_8 ) ) ;
V_140 = F_68 ( V_130 , V_140 ) ;
V_140 -> V_34 . V_2 = V_2 ;
V_76 = getenv ( V_138 ) ;
if ( V_76 )
F_1 ( V_2 , V_76 ) ;
else
F_67 ( V_139 , L_43 , V_138 ) ;
}
