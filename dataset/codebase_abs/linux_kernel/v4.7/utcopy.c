...
struct V_43 V_44 ;
F_2 ( V_61 ) ;
V_4 = F_11 ( union V_3 , V_15 ) ;
V_44 . V_13 = F_4 ( sizeof( union V_3 ) ) ;
V_44 . V_54 = V_15 +
F_4 ( sizeof( union V_3 ) ) ;
V_44 . V_45 = 0 ;
V_44 . V_62 = 1 ;
V_4 -> type = V_2 -> V_10 . type ;
...
if ( V_80 -> string . V_12 ) {
V_81 -> string . V_12 =
F_25 ( ( T_3 ) V_80 -> string .
V_13 + 1 ) ;
if ( ! V_81 -> string . V_12 ) {
return ( V_68 ) ;
}
memcpy ( V_81 -> string . V_12 ,
V_80 -> string . V_12 ,
