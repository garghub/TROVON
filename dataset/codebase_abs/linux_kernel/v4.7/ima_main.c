...
void F_31 ( struct V_60 * V_60 )
{
struct V_15 * V_16 ;
struct V_20 * V_20 = V_60 -> V_77 ;
int V_47 ;
V_47 = F_32 ( V_20 , V_78 , V_53 ) ;
if ( ! V_47 )
return;
V_16 = F_18 ( V_20 ) ;
if ( V_16 )
...
int F_33 ( struct V_14 * V_14 , enum V_79 V_80 )
{
if ( ! V_14 && V_80 == V_81 ) {
#ifndef F_34
if ( ( V_68 & V_82 ) &&
...
int F_35 ( struct V_14 * V_14 , void * V_38 , T_3 V_39 ,
enum V_79 V_80 )
{
enum V_41 V_42 ;
if ( ! V_14 && V_80 == V_83 ) {
