...
struct V_19 * V_19 , struct V_27 * V_27 ,
const char * V_3 , void * V_4 , T_2 V_28 )
{
const char * V_29 = F_19 ( V_26 , V_3 ) ;
return F_10 ( V_19 , V_29 , V_4 , V_28 ) ;
}
static int F_20 ( const struct V_25 * V_26 ,
struct V_19 * V_19 , struct V_27 * V_27 ,
const char * V_3 , const void * V_20 ,
T_2 V_28 , int V_22 )
{
const char * V_29 = F_19 ( V_26 , V_3 ) ;
return F_12 ( V_19 , V_29 , V_20 , V_28 , V_22 ) ;
}
