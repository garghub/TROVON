...
if ( F_29 ( V_2 -> V_63 ) != - V_65 )
return F_29 ( V_2 -> V_63 ) ;
V_2 -> V_41 = 2500 ;
}
if ( V_59 ) {
V_2 -> V_18 = V_59 -> V_18 ;
...
V_2 -> V_42 = V_59 -> V_42 ;
if ( ! V_2 -> V_18 ) {
for ( V_17 = 0 ; V_17 < F_30 ( V_2 -> V_23 ) ; ++ V_17 ) {
V_2 -> V_23 [ V_17 ] . V_24 = V_59 -> V_66 [ V_17 ] ;
V_2 -> V_23 [ V_17 ] . V_67 = V_68 ;
V_2 -> V_23 [ V_17 ] . V_69 = V_70 [ V_17 ] ;
}
V_12 = F_31 ( V_2 -> V_23 ,
F_30 ( V_2 -> V_23 ) ) ;
if ( V_12 )
...
F_32 ( V_3 , V_7 ) ;
V_2 -> V_3 = V_3 ;
V_7 -> V_60 . V_72 = & V_3 -> V_60 ;
V_7 -> V_73 = F_33 ( V_3 ) -> V_73 ;
V_7 -> V_74 = V_75 ;
V_7 -> V_76 = & V_77 ;
F_21 ( V_7 ) ;
...
V_2 -> V_78 [ 2 ] . V_80 = 1 ;
F_34 ( & V_2 -> V_29 ) ;
F_35 ( & V_2 -> V_78 [ 0 ] , & V_2 -> V_29 ) ;
F_35 ( & V_2 -> V_78 [ 1 ] , & V_2 -> V_29 ) ;
F_35 ( & V_2 -> V_78 [ 2 ] , & V_2 -> V_29 ) ;
V_12 = F_36 ( V_7 , & V_83 ,
& F_7 , & V_84 ) ;
if ( V_12 )
goto V_85;
...
V_85:
if ( ! V_2 -> V_18 )
F_39 ( V_2 -> V_23 , F_30 ( V_2 -> V_23 ) ) ;
V_64:
if ( ! F_40 ( V_2 -> V_63 ) )
F_41 ( V_2 -> V_63 ) ;
return V_12 ;
}
static int F_42 ( struct V_57 * V_3 )
{
struct V_6 * V_7 = F_43 ( V_3 ) ;
struct V_1 * V_2 = F_5 ( V_7 ) ;
F_44 ( V_7 ) ;
F_38 ( V_7 ) ;
if ( ! V_2 -> V_18 )
