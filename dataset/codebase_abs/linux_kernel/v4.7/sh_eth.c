...
if ( ! V_6 -> V_256 )
return - V_275 ;
F_101 ( & V_6 -> V_248 , V_274 ) ;
V_54 = F_102 ( V_6 -> V_256 , V_273 ) ;
F_103 ( & V_6 -> V_248 , V_274 ) ;
return V_54 ;
}
...
static T_6 F_106 ( struct V_1 * V_2 , T_1 * V_278 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_37 * V_38 = V_6 -> V_38 ;
T_1 * V_279 ;
...
static void F_114 ( struct V_1 * V_2 , struct V_334 * V_335 ,
void * V_278 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_335 -> V_336 = V_337 ;
F_115 ( & V_6 -> V_338 -> V_119 ) ;
F_106 ( V_2 , V_278 ) ;
...
static int F_121 ( struct V_1 * V_245 , int V_340 )
{
switch ( V_340 ) {
case V_341 :
return V_342 ;
...
static void F_123 ( struct V_1 * V_2 , T_1 V_345 , T_10 * V_3 )
{
switch ( V_345 ) {
case V_341 :
memcpy ( V_3 , * V_346 ,
...
static int F_140 ( struct V_73 * V_74 , struct V_1 * V_2 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_105 * V_108 ;
T_4 V_113 ;
...
V_108 = & V_6 -> V_104 [ V_179 ] ;
if ( ! V_6 -> V_38 -> V_141 )
F_68 ( F_143 ( V_74 -> V_3 , 4 ) , V_74 -> V_121 + 2 ) ;
...
static void
F_144 ( struct V_1 * V_2 , unsigned long * V_372 , int T_7 )
{
...
if ( ! V_6 -> V_365 )
return & V_2 -> V_182 ;
F_144 ( V_2 , & V_2 -> V_182 . V_375 , V_291 ) ;
F_144 ( V_2 , & V_2 -> V_182 . V_376 , V_292 ) ;
F_144 ( V_2 , & V_2 -> V_182 . V_219 , V_293 ) ;
if ( F_8 ( V_6 ) ) {
F_144 ( V_2 , & V_2 -> V_182 . V_219 ,
V_299 ) ;
F_144 ( V_2 , & V_2 -> V_182 . V_219 ,
V_300 ) ;
} else {
...
static int F_148 ( struct V_1 * V_2 , struct V_377 * V_378 , int V_379 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_255 * V_256 = V_6 -> V_256 ;
if ( ! F_126 ( V_2 ) )
...
if ( ! V_256 )
return - V_275 ;
return F_149 ( V_256 , V_378 , V_379 ) ;
}
static void * F_150 ( struct V_5 * V_6 ,
int V_179 )
{
return F_151 ( V_6 , V_327 ) + ( V_179 / 8 * 4 ) ;
}
static T_1 F_152 ( int V_179 )
{
return 0x0f << ( 28 - ( ( V_179 % 8 ) * 4 ) ) ;
}
static T_1 F_153 ( struct V_5 * V_6 , int V_179 )
{
...
int V_54 ;
T_10 V_390 [ V_81 ] ;
F_14 ( V_6 , F_157 ( V_6 , V_326 ) &
~ ( 1 << ( 31 - V_179 ) ) , V_326 ) ;
memset ( V_390 , 0 , sizeof( V_390 ) ) ;
V_54 = F_159 ( V_2 , V_8 + V_179 * 8 , V_390 ) ;
if ( V_54 < 0 )
return V_54 ;
return 0 ;
}
...
if ( V_36 < 0 )
return - V_133 ;
V_54 = F_159 ( V_2 , V_8 + V_36 * 8 , V_10 ) ;
if ( V_54 < 0 )
return V_54 ;
F_14 ( V_6 , F_157 ( V_6 , V_326 ) |
( 1 << ( 31 - V_36 ) ) , V_326 ) ;
...
struct V_399 * V_400 ;
F_171 (ha, ndev) {
if ( V_393 && F_169 ( V_400 -> V_10 ) )
continue;
if ( F_165 ( V_2 , V_400 -> V_10 ) < 0 ) {
if ( ! V_393 ) {
F_168 ( V_2 ) ;
V_392 &= ~ V_395 ;
V_393 = 1 ;
...
static int F_190 ( struct V_412 * V_338 )
{
struct V_431 * V_432 ;
struct V_410 * V_411 = F_191 ( & V_338 -> V_119 ) ;
const struct V_433 * V_271 = F_192 ( V_338 ) ;
struct V_5 * V_6 ;
struct V_1 * V_2 ;
int V_54 , V_434 ;
V_432 = F_193 ( V_338 , V_435 , 0 ) ;
...
goto V_437;
V_2 -> V_244 = V_54 ;
F_197 ( V_2 , & V_338 -> V_119 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_100 = V_438 ;
V_6 -> V_98 = V_439 ;
V_6 -> V_10 = F_198 ( & V_338 -> V_119 , V_432 ) ;
if ( F_95 ( V_6 -> V_10 ) ) {
V_54 = F_96 ( V_6 -> V_10 ) ;
goto V_437;
}
V_2 -> V_440 = V_432 -> V_441 ;
F_199 ( & V_6 -> V_248 ) ;
V_6 -> V_338 = V_338 ;
if ( V_338 -> V_119 . V_264 )
V_411 = F_186 ( & V_338 -> V_119 ) ;
if ( ! V_411 ) {
F_200 ( & V_338 -> V_119 , L_23 ) ;
V_54 = - V_357 ;
goto V_437;
}
...
if ( V_271 )
V_6 -> V_38 = (struct V_37 * ) V_271 -> V_442 ;
else
V_6 -> V_38 = (struct V_37 * ) F_201 ( & V_338 -> V_119 ) ;
V_6 -> V_8 = F_185 ( V_6 -> V_38 -> V_420 ) ;
if ( ! V_6 -> V_8 ) {
F_200 ( & V_338 -> V_119 , L_24 ,
V_6 -> V_38 -> V_420 ) ;
V_54 = - V_357 ;
goto V_437;
}
...
if ( V_6 -> V_38 -> V_303 ) {
struct V_431 * V_451 ;
V_451 = F_193 ( V_338 , V_435 , 1 ) ;
V_6 -> V_333 = F_198 ( & V_338 -> V_119 , V_451 ) ;
if ( F_95 ( V_6 -> V_333 ) ) {
V_54 = F_96 ( V_6 -> V_333 ) ;
goto V_437;
}
...
goto V_456;
F_207 ( V_2 , L_27 ,
( T_1 ) V_2 -> V_440 , V_2 -> V_77 , V_2 -> V_244 ) ;
F_208 ( & V_338 -> V_119 ) ;
F_209 ( V_338 , V_2 ) ;
return V_54 ;
V_456:
...
static int F_213 ( struct V_412 * V_338 )
{
struct V_1 * V_2 = F_214 ( V_338 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_215 ( V_2 ) ;
F_210 ( & V_6 -> V_252 ) ;
F_177 ( V_6 ) ;
