...
if ( ! V_52 && V_165 . V_202 ) {
V_99 = F_119 ( V_1 , V_165 . V_202 , V_146 ) ;
if ( V_99 < 0 )
goto V_107;
}
F_120 ( V_7 , F_121 ( V_146 ) ) ;
V_167 = F_122 ( V_1 , V_146 , V_7 ) ;
if ( F_123 ( V_167 ) ) {
V_99 = F_124 ( V_167 ) ;
V_167 = NULL ;
if ( V_99 == - V_218 )
...
if ( ! V_170 ) {
V_73 = F_128 ( V_7 , V_146 , F_102 , V_161 , V_163 ,
...
V_185:
V_127 -> V_129 += V_163 ;
V_99 = F_131 ( V_7 , V_146 , F_102 , V_161 , V_163 ,
sizeof( struct V_79 ) , & V_165 , & V_167 ,
...
int F_135 ( struct V_6 * V_7 , struct V_233 * V_233 , int V_132 ,
T_8 V_234 , int V_231 )
{
struct V_48 * V_62 = F_32 ( V_7 ) ;
struct V_126 * V_127 = F_7 ( V_7 ) ;
...
V_235 = F_136 ( V_7 , & V_62 -> V_156 . V_157 . V_158 . V_159 ,
V_233 , V_132 , V_234 , V_231 ) ;
if ( V_235 == - V_177 ) {
F_105 ( V_7 ) ;
return F_137 ( V_7 -> V_230 , V_233 , V_132 ,
V_234 , V_231 ) ;
}
if ( V_235 < 0 ) {
F_76 ( V_7 ) ;
...
V_18 = V_73 ? V_73 -> V_129 : 0 ;
F_30 ( & V_239 -> V_19 ) ;
if ( ! F_132 ( & V_238 ) ) {
bool V_244 = F_146 ( V_7 ) ;
F_147 ( & V_238 ) ;
F_148 ( V_7 ) ;
F_149 ( V_7 , V_244 ) ;
}
...
int F_150 ( struct V_6 * V_7 , int V_245 , unsigned long V_246 )
{
switch ( V_245 ) {
case V_247 :
{
int V_248 = F_151 ( V_7 ) ;
return F_152 ( V_248 , ( int V_249 * ) V_246 ) ;
}
case V_250 :
{
unsigned int V_248 = F_138 ( V_7 ) ;
return F_152 ( V_248 , ( int V_249 * ) V_246 ) ;
}
default:
return - V_251 ;
...
void F_177 ( struct V_6 * V_7 , T_10 V_273 )
{
if ( F_173 ( V_7 ) ) {
struct V_23 * V_24 = V_7 -> V_25 -> V_26 . V_23 ;
...
static int F_179 ( struct V_6 * V_7 , struct V_72 * V_73 )
{
int V_276 ;
if ( F_32 ( V_7 ) -> V_64 ) {
F_180 ( V_7 , V_73 ) ;
...
int F_189 ( struct V_6 * V_7 , struct V_72 * V_73 )
{
struct V_126 * V_127 = F_7 ( V_7 ) ;
int V_276 ;
int V_147 = F_93 ( V_7 ) ;
if ( ! F_190 ( V_7 , V_280 , V_73 ) )
goto V_281;
F_191 ( V_73 ) ;
if ( F_192 ( & V_279 ) && V_127 -> V_282 ) {
int (* F_193)( struct V_6 * V_7 , struct V_72 * V_73 );
F_193 = F_194 ( V_127 -> F_193 ) ;
if ( F_193 ) {
int V_235 ;
if ( F_141 ( V_73 ) )
goto V_283;
V_235 = F_193 ( V_7 , V_73 ) ;
if ( V_235 <= 0 ) {
F_142 ( F_6 ( V_7 ) ,
V_265 ,
V_147 ) ;
...
if ( V_287 ( V_7 , V_73 ) )
goto V_281;
if ( F_58 ( V_73 -> V_129 < sizeof( struct V_79 ) ) )
goto V_281;
F_195 ( V_73 ) ;
if ( F_196 ( V_7 , V_7 -> V_288 ) ) {
F_142 ( F_6 ( V_7 ) , V_278 ,
V_147 ) ;
goto V_281;
}
...
F_198 ( V_7 ) ;
if ( ! F_199 ( V_7 ) )
V_276 = F_179 ( V_7 , V_73 ) ;
else if ( F_200 ( V_7 , V_73 , V_7 -> V_288 ) ) {
F_201 ( V_7 ) ;
goto V_281;
}
F_201 ( V_7 ) ;
return V_276 ;
V_283:
F_142 ( F_6 ( V_7 ) , V_241 , V_147 ) ;
V_281:
F_142 ( F_6 ( V_7 ) , V_242 , V_147 ) ;
F_143 ( & V_7 -> V_243 ) ;
F_184 ( V_73 ) ;
return - 1 ;
}
static void F_202 ( struct V_6 * V_7 , struct V_289 * V_131 )
{
struct V_289 * V_290 ;
F_203 ( V_131 ) ;
V_290 = F_204 ( & V_7 -> V_291 , V_131 ) ;
F_205 ( V_290 ) ;
}
static int F_206 ( struct V_1 * V_1 , struct V_72 * V_73 ,
struct V_79 * V_95 ,
T_4 V_52 , T_4 V_58 ,
struct V_23 * V_24 ,
int V_292 )
...
unsigned int V_132 = F_83 ( F_207 ( * V_7 ) , V_295 ) ;
...
V_23 . V_33 ;
V_81 = F_41 ( V_1 , V_58 , V_59 ) & V_23 . V_33 ;
V_299:
V_4 = & V_23 . V_81 [ V_81 ] ;
V_132 = F_83 ( F_207 ( * V_7 ) , V_300 . V_301 ) ;
}
F_208 (sk, node, &hslot->head, offset) {
...
static inline int F_211 ( struct V_72 * V_73 , struct V_79 * V_95 ,
int V_292 )
{
int V_99 ;
F_157 ( V_73 ) -> V_263 = 0 ;
F_157 ( V_73 ) -> V_286 = V_73 -> V_129 ;
if ( V_292 == V_304 ) {
V_99 = F_212 ( V_73 , V_95 ) ;
if ( V_99 )
return V_99 ;
}
return ( V_54 int ) F_213 ( V_73 , V_292 , V_95 -> V_137 ,
V_305 ) ;
}
int F_214 ( struct V_72 * V_73 , struct V_23 * V_24 ,
int V_292 )
{
struct V_6 * V_7 ;
struct V_79 * V_95 ;
unsigned short V_163 ;
struct V_166 * V_167 = F_215 ( V_73 ) ;
T_4 V_52 , V_58 ;
struct V_1 * V_1 = F_62 ( V_73 -> V_87 ) ;
if ( ! F_216 ( V_73 , sizeof( struct V_79 ) ) )
goto V_281;
V_95 = F_79 ( V_73 ) ;
...
goto V_306;
if ( V_292 == V_138 ) {
if ( V_163 < sizeof( * V_95 ) || F_217 ( V_73 , V_163 ) )
goto V_306;
V_95 = F_79 ( V_73 ) ;
}
if ( F_211 ( V_73 , V_95 , V_292 ) )
goto V_283;
V_7 = F_218 ( V_73 ) ;
if ( V_7 ) {
struct V_289 * V_131 = F_219 ( V_73 ) ;
int V_235 ;
if ( F_58 ( V_7 -> V_291 != V_131 ) )
F_202 ( V_7 , V_131 ) ;
V_235 = F_189 ( V_7 , V_73 ) ;
F_220 ( V_7 ) ;
if ( V_235 > 0 )
return - V_235 ;
return 0 ;
...
return F_206 ( V_1 , V_73 , V_95 ,
V_52 , V_58 , V_24 , V_292 ) ;
V_7 = F_60 ( V_73 , V_95 -> V_101 , V_95 -> V_100 , V_24 ) ;
if ( V_7 ) {
int V_235 ;
if ( F_221 ( V_7 ) && V_95 -> V_137 && ! F_93 ( V_7 ) )
F_222 ( V_73 , V_138 , V_95 -> V_137 ,
V_305 ) ;
V_235 = F_189 ( V_7 , V_73 ) ;
if ( V_235 > 0 )
return - V_235 ;
...
if ( ! F_190 ( NULL , V_280 , V_73 ) )
goto V_281;
F_191 ( V_73 ) ;
if ( F_141 ( V_73 ) )
goto V_283;
F_142 ( V_1 , V_308 , V_292 == V_304 ) ;
F_223 ( V_73 , V_110 , V_309 , 0 ) ;
F_184 ( V_73 ) ;
return 0 ;
V_306:
F_130 ( L_5 ,
...
V_163 ) ;
F_142 ( V_1 , V_241 , V_292 == V_304 ) ;
V_281:
F_142 ( V_1 , V_242 , V_292 == V_304 ) ;
F_184 ( V_73 ) ;
return 0 ;
}
...
F_226 ( V_310 , V_92 , V_90 ) ;
const T_11 V_311 = F_227 ( V_91 , V_59 ) ;
struct V_6 * V_7 ;
F_52 (sk, &hslot2->head) {
if ( F_228 ( V_7 , V_1 , V_310 , V_92 ,
V_90 , V_311 , V_60 ) )
return V_7 ;
break;
}
...
int V_60 = V_73 -> V_87 -> V_102 ;
int V_312 ;
if ( ! F_216 ( V_73 , F_80 ( V_73 ) + sizeof( struct V_79 ) ) )
return;
V_86 = F_61 ( V_73 ) ;
V_95 = F_79 ( V_73 ) ;
if ( V_73 -> V_313 == V_314 ||
V_73 -> V_313 == V_315 ) {
struct V_316 * V_317 = F_230 ( V_73 -> V_87 ) ;
if ( ! V_317 )
return;
if ( V_73 -> V_313 == V_315 ) {
V_312 = F_231 ( V_317 , V_86 -> V_58 , V_86 -> V_52 ,
V_86 -> V_318 ) ;
if ( ! V_312 )
return;
}
V_7 = F_224 ( V_1 , V_95 -> V_100 , V_86 -> V_58 ,
V_95 -> V_101 , V_86 -> V_52 , V_60 ) ;
} else if ( V_73 -> V_313 == V_319 ) {
V_7 = F_225 ( V_1 , V_95 -> V_100 , V_86 -> V_58 ,
V_95 -> V_101 , V_86 -> V_52 , V_60 ) ;
}
if ( ! V_7 || ! F_232 ( & V_7 -> V_88 , 2 ) )
return;
V_73 -> V_7 = V_7 ;
V_73 -> V_320 = V_321 ;
V_131 = F_233 ( V_7 -> V_291 ) ;
if ( V_131 )
V_131 = F_234 ( V_131 , 0 ) ;
if ( V_131 ) {
...
int F_237 ( struct V_72 * V_73 )
{
return F_214 ( V_73 , & V_23 , V_138 ) ;
}
...
if ( V_206 < sizeof( int ) )
return - V_184 ;
if ( F_242 ( V_327 , ( int V_249 * ) V_326 ) )
return - V_329 ;
V_328 = V_327 ? 1 : 0 ;
switch ( V_325 ) {
case V_330 :
...
return F_240 ( V_7 , V_324 , V_325 , V_326 , V_206 ,
F_99 ) ;
return F_244 ( V_7 , V_324 , V_325 , V_326 , V_206 ) ;
}
...
struct V_126 * V_127 = F_7 ( V_7 ) ;
int V_327 , V_129 ;
if ( F_242 ( V_129 , V_206 ) )
return - V_329 ;
V_129 = F_248 (unsigned int, len, sizeof(int)) ;
if ( V_129 < 0 )
return - V_184 ;
switch ( V_325 ) {
case V_330 :
...
if ( F_152 ( V_129 , V_206 ) )
return - V_329 ;
if ( F_249 ( V_326 , & V_327 , V_129 ) )
return - V_329 ;
return 0 ;
}
...
{
if ( V_324 == V_347 || V_324 == V_348 )
return F_247 ( V_7 , V_324 , V_325 , V_326 , V_206 ) ;
return F_251 ( V_7 , V_324 , V_325 , V_326 , V_206 ) ;
}
...
{
unsigned int V_33 = F_255 ( V_349 , V_6 , V_351 ) ;
struct V_6 * V_7 = V_6 -> V_7 ;
F_256 ( V_7 ) ;
if ( ( V_33 & V_352 ) && ! ( V_349 -> V_353 & V_354 ) &&
! ( V_7 -> V_355 & V_356 ) && ! F_138 ( V_7 ) )
V_33 &= ~ ( V_357 | V_352 ) ;
return V_33 ;
}
...
struct V_361 * V_373 ;
int V_99 ;
V_99 = F_268 ( V_370 , V_349 , & V_372 -> V_374 ,
sizeof( struct V_361 ) ) ;
if ( V_99 < 0 )
return V_99 ;
...
void T_16 F_292 ( struct V_23 * V_393 , const char * V_380 )
{
unsigned int V_394 ;
V_393 -> V_78 = F_293 ( V_380 ,
2 * sizeof( struct V_3 ) ,
V_391 ,
21 ,
0 ,
...
F_294 ( & V_393 -> V_78 [ V_394 ] . V_43 ) ;
V_393 -> V_78 [ V_394 ] . V_36 = 0 ;
F_295 ( & V_393 -> V_78 [ V_394 ] . V_19 ) ;
}
for ( V_394 = 0 ; V_394 <= V_393 -> V_33 ; V_394 ++ ) {
F_294 ( & V_393 -> V_81 [ V_394 ] . V_43 ) ;
V_393 -> V_81 [ V_394 ] . V_36 = 0 ;
F_295 ( & V_393 -> V_81 [ V_394 ] . V_19 ) ;
}
}
T_3 F_296 ( void )
{
