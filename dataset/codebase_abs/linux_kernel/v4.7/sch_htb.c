...
struct V_5 * V_6 = F_2 ( V_4 ) ;
int V_35 ;
for ( V_35 = V_124 - 1 ; V_35 >= 0 ; V_35 -- ) {
struct V_125 * V_37 ;
F_72 (p, q->drops + prio) {
struct V_1 * V_14 = F_73 ( V_37 , struct V_1 ,
V_63 . V_79 . V_81 ) ;
unsigned int V_126 ;
if ( V_14 -> V_63 . V_79 . V_6 -> V_127 -> V_128 &&
( V_126 = V_14 -> V_63 . V_79 . V_6 -> V_127 -> V_128 ( V_14 -> V_63 . V_79 . V_6 ) ) ) {
V_4 -> V_88 . V_129 -= V_126 ;
V_4 -> V_6 . V_80 -- ;
if ( ! V_14 -> V_63 . V_79 . V_6 -> V_6 . V_80 )
F_34 ( V_6 , V_14 ) ;
return V_126 ;
...
struct V_1 * V_14 ;
unsigned int V_105 ;
for ( V_105 = 0 ; V_105 < V_6 -> V_9 . V_130 ; V_105 ++ ) {
...
for ( V_105 = 0 ; V_105 < V_124 ; V_105 ++ )
F_77 ( V_6 -> V_82 + V_105 ) ;
}
static void F_80 ( struct V_131 * V_123 )
{
struct V_5 * V_6 = F_4 ( V_123 , struct V_5 , V_123 ) ;
struct V_3 * V_4 = V_6 -> V_122 . V_132 ;
F_81 () ;
F_82 ( F_83 ( V_4 ) ) ;
F_84 () ;
}
static int F_85 ( struct V_3 * V_4 , struct V_133 * V_134 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_133 * V_135 [ V_136 + 1 ] ;
struct V_137 * V_138 ;
int V_139 ;
int V_105 ;
if ( ! V_134 )
return - V_140 ;
V_139 = F_86 ( V_135 , V_136 , V_134 , V_141 ) ;
if ( V_139 < 0 )
return V_139 ;
if ( ! V_135 [ V_142 ] )
return - V_140 ;
V_138 = F_87 ( V_135 [ V_142 ] ) ;
if ( V_138 -> V_143 != V_144 >> 16 )
return - V_140 ;
V_139 = F_88 ( & V_6 -> V_9 ) ;
if ( V_139 < 0 )
return V_139 ;
...
F_91 ( & V_6 -> V_85 ) ;
if ( V_135 [ V_145 ] )
V_6 -> V_86 = F_92 ( V_135 [ V_145 ] ) ;
else
V_6 -> V_86 = F_93 ( V_4 ) -> V_146 ;
if ( ( V_6 -> V_147 = V_138 -> V_147 ) < 1 )
V_6 -> V_147 = 1 ;
V_6 -> V_32 = V_138 -> V_32 ;
return 0 ;
}
...
V_138 . V_87 = V_6 -> V_87 ;
V_138 . V_143 = V_144 ;
V_138 . V_147 = V_6 -> V_147 ;
V_138 . V_32 = V_6 -> V_32 ;
V_138 . V_149 = 0 ;
V_148 = F_95 ( V_12 , V_150 ) ;
if ( V_148 == NULL )
goto V_151;
if ( F_96 ( V_12 , V_142 , sizeof( V_138 ) , & V_138 ) ||
F_97 ( V_12 , V_145 , V_6 -> V_86 ) )
goto V_151;
return F_98 ( V_12 , V_148 ) ;
V_151:
F_99 ( V_12 , V_148 ) ;
return - 1 ;
}
static int F_100 ( struct V_3 * V_4 , unsigned long V_152 ,
...
V_154 -> V_159 = V_14 -> V_63 . V_79 . V_6 -> V_2 ;
V_148 = F_95 ( V_12 , V_150 ) ;
if ( V_148 == NULL )
goto V_151;
memset ( & V_134 , 0 , sizeof( V_134 ) ) ;
F_101 ( & V_134 . V_90 , & V_14 -> V_90 ) ;
V_134 . V_72 = F_102 ( V_14 -> V_72 ) ;
F_101 ( & V_134 . ceil , & V_14 -> ceil ) ;
V_134 . V_71 = F_102 ( V_14 -> V_71 ) ;
V_134 . V_115 = V_14 -> V_115 ;
V_134 . V_35 = V_14 -> V_35 ;
V_134 . V_22 = V_14 -> V_22 ;
if ( F_96 ( V_12 , V_160 , sizeof( V_134 ) , & V_134 ) )
goto V_151;
if ( ( V_14 -> V_90 . V_161 >= ( 1ULL << 32 ) ) &&
F_103 ( V_12 , V_162 , V_14 -> V_90 . V_161 ,
V_163 ) )
goto V_151;
if ( ( V_14 -> ceil . V_161 >= ( 1ULL << 32 ) ) &&
F_103 ( V_12 , V_164 , V_14 -> ceil . V_161 ,
V_163 ) )
goto V_151;
return F_98 ( V_12 , V_148 ) ;
V_151:
...
static int
F_104 ( struct V_3 * V_4 , unsigned long V_152 , struct V_165 * V_166 )
{
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
T_3 V_80 = 0 ;
if ( ! V_14 -> V_22 && V_14 -> V_63 . V_79 . V_6 )
V_80 = V_14 -> V_63 . V_79 . V_6 -> V_6 . V_80 ;
V_14 -> V_94 . V_77 = F_105 ( T_2 , F_102 ( V_14 -> V_77 ) ,
V_167 , V_168 ) ;
V_14 -> V_94 . V_76 = F_105 ( T_2 , F_102 ( V_14 -> V_76 ) ,
V_167 , V_168 ) ;
if ( F_106 ( V_166 , NULL , & V_14 -> V_97 ) < 0 ||
F_107 ( V_166 , NULL , & V_14 -> V_169 ) < 0 ||
F_108 ( V_166 , NULL , & V_14 -> V_88 , V_80 ) < 0 )
return - 1 ;
return F_109 ( V_166 , & V_14 -> V_94 , sizeof( V_14 -> V_94 ) ) ;
}
static int F_110 ( struct V_3 * V_4 , unsigned long V_152 , struct V_3 * V_170 ,
struct V_3 * * V_171 )
{
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
if ( V_14 -> V_22 )
return - V_140 ;
if ( V_170 == NULL &&
( V_170 = F_111 ( V_4 -> V_172 , & V_173 ,
V_14 -> V_10 . V_31 ) ) == NULL )
return - V_174 ;
* V_171 = F_112 ( V_4 , V_170 , & V_14 -> V_63 . V_79 . V_6 ) ;
return 0 ;
}
static struct V_3 * F_113 ( struct V_3 * V_4 , unsigned long V_152 )
{
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
return ! V_14 -> V_22 ? V_14 -> V_63 . V_79 . V_6 : NULL ;
}
static void F_114 ( struct V_3 * V_4 , unsigned long V_152 )
{
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
...
static void F_118 ( struct V_3 * V_4 , struct V_1 * V_14 )
{
if ( ! V_14 -> V_22 ) {
F_22 ( ! V_14 -> V_63 . V_79 . V_6 ) ;
F_119 ( V_14 -> V_63 . V_79 . V_6 ) ;
}
F_120 ( & V_14 -> V_97 , & V_14 -> V_169 ) ;
F_121 ( & V_14 -> V_23 ) ;
F_122 ( V_14 ) ;
}
...
static int F_127 ( struct V_3 * V_4 , unsigned long V_152 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
...
unsigned int V_129 = V_14 -> V_63 . V_79 . V_6 -> V_88 . V_129 ;
F_76 ( V_14 -> V_63 . V_79 . V_6 ) ;
F_129 ( V_14 -> V_63 . V_79 . V_6 , V_80 , V_129 ) ;
}
...
if ( V_180 )
F_117 ( V_6 , V_14 , V_177 ) ;
F_57 ( -- V_14 -> V_175 == 0 ) ;
F_131 ( V_4 ) ;
return 0 ;
}
static void F_132 ( struct V_3 * V_4 , unsigned long V_152 )
{
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
if ( -- V_14 -> V_175 == 0 )
F_118 ( V_4 , V_14 ) ;
}
static int F_133 ( struct V_3 * V_4 , T_1 V_31 ,
T_1 V_183 , struct V_133 * * V_184 ,
unsigned long * V_152 )
{
int V_139 = - V_140 ;
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) * V_152 , * V_38 ;
struct V_133 * V_134 = V_184 [ V_150 ] ;
struct V_133 * V_135 [ V_136 + 1 ] ;
struct V_155 * V_185 ;
T_4 V_186 , V_187 ;
if ( ! V_134 )
...
if ( V_135 [ V_160 ] == NULL )
goto V_188;
V_38 = V_183 == V_157 ? NULL : F_1 ( V_183 , V_4 ) ;
V_185 = F_87 ( V_135 [ V_160 ] ) ;
if ( ! V_185 -> V_90 . V_90 || ! V_185 -> ceil . V_90 )
goto V_188;
if ( V_185 -> V_90 . V_189 == V_190 )
F_134 ( F_135 ( & V_185 -> V_90 , V_135 [ V_191 ] ) ) ;
if ( V_185 -> ceil . V_189 == V_190 )
F_134 ( F_135 ( & V_185 -> ceil , V_135 [ V_192 ] ) ) ;
if ( ! V_14 ) {
struct V_3 * V_177 ;
int V_35 ;
struct {
...
. V_193 = {
. V_196 = F_136 ( sizeof( V_195 . V_134 ) ) ,
. V_197 = V_198 ,
} ,
. V_134 = {
. V_199 = 2 ,
...
V_139 = - V_174 ;
V_14 = F_138 ( sizeof( * V_14 ) , V_201 ) ;
if ( ! V_14 )
goto V_188;
if ( V_202 || V_184 [ V_198 ] ) {
V_139 = F_139 ( & V_14 -> V_97 , NULL ,
& V_14 -> V_169 ,
F_140 ( V_4 ) ,
...
F_24 ( & V_14 -> V_40 [ V_35 ] ) ;
V_177 = F_111 ( V_4 -> V_172 ,
& V_173 , V_31 ) ;
F_128 ( V_4 ) ;
if ( V_38 && ! V_38 -> V_22 ) {
unsigned int V_80 = V_38 -> V_63 . V_79 . V_6 -> V_6 . V_80 ;
unsigned int V_129 = V_38 -> V_63 . V_79 . V_6 -> V_88 . V_129 ;
F_76 ( V_38 -> V_63 . V_79 . V_6 ) ;
F_129 ( V_38 -> V_63 . V_79 . V_6 , V_80 , V_129 ) ;
F_119 ( V_38 -> V_63 . V_79 . V_6 ) ;
if ( V_38 -> V_60 )
F_34 ( V_6 , V_38 ) ;
if ( V_38 -> V_61 != V_67 ) {
...
V_14 -> V_10 . V_31 = V_31 ;
V_14 -> V_38 = V_38 ;
V_14 -> V_77 = F_141 ( V_185 -> V_72 ) ;
V_14 -> V_76 = F_141 ( V_185 -> V_71 ) ;
V_14 -> V_91 = 60ULL * V_120 ;
V_14 -> V_93 = F_67 () ;
V_14 -> V_61 = V_67 ;
F_142 ( & V_6 -> V_9 , & V_14 -> V_10 ) ;
if ( V_38 )
V_38 -> V_176 ++ ;
} else {
if ( V_184 [ V_198 ] ) {
T_5 * V_203 = F_140 ( V_4 ) ;
V_139 = F_143 ( & V_14 -> V_97 , NULL ,
& V_14 -> V_169 ,
V_203 ,
V_184 [ V_198 ] ) ;
if ( V_139 )
...
V_186 = V_135 [ V_162 ] ? F_144 ( V_135 [ V_162 ] ) : 0 ;
V_187 = V_135 [ V_164 ] ? F_144 ( V_135 [ V_164 ] ) : 0 ;
F_145 ( & V_14 -> V_90 , & V_185 -> V_90 , V_186 ) ;
F_145 ( & V_14 -> ceil , & V_185 -> ceil , V_187 ) ;
if ( ! V_14 -> V_22 ) {
T_4 V_115 = V_14 -> V_90 . V_161 ;
F_146 ( V_115 , V_6 -> V_147 ) ;
V_14 -> V_115 = F_49 ( T_4 , V_115 , V_168 ) ;
...
if ( ( V_14 -> V_35 = V_185 -> V_35 ) >= V_124 )
V_14 -> V_35 = V_124 - 1 ;
}
V_14 -> V_72 = F_141 ( V_185 -> V_72 ) ;
V_14 -> V_71 = F_141 ( V_185 -> V_71 ) ;
F_131 ( V_4 ) ;
F_147 ( V_4 , & V_6 -> V_9 ) ;
...
static struct V_17 T_6 * * F_148 ( struct V_3 * V_4 ,
unsigned long V_152 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
struct V_17 T_6 * * V_204 = V_14 ? & V_14 -> V_23 : & V_6 -> V_23 ;
return V_204 ;
}
static unsigned long F_149 ( struct V_3 * V_4 , unsigned long V_38 ,
T_1 V_31 )
{
struct V_1 * V_14 = F_1 ( V_31 , V_4 ) ;
if ( V_14 )
...
static void F_150 ( struct V_3 * V_4 , unsigned long V_152 )
{
struct V_1 * V_14 = (struct V_1 * ) V_152 ;
if ( V_14 )
V_14 -> V_181 -- ;
}
static void F_151 ( struct V_3 * V_4 , struct V_205 * V_152 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 ;
unsigned int V_105 ;
...
for ( V_105 = 0 ; V_105 < V_6 -> V_9 . V_130 ; V_105 ++ ) {
F_75 (cl, &q->clhash.hash[i], common.hnode) {
if ( V_152 -> V_207 < V_152 -> V_208 ) {
V_152 -> V_207 ++ ;
continue;
}
if ( V_152 -> V_209 ( V_4 , ( unsigned long ) V_14 , V_152 ) < 0 ) {
V_152 -> V_206 = 1 ;
return;
}
V_152 -> V_207 ++ ;
