...
{
struct V_1 * V_2 = F_272 ( V_5 ) ;
struct V_592 * V_416 = V_2 -> V_4 -> V_416 ;
if ( V_416 -> V_593 ) {
return V_416 -> V_593 ( V_5 , V_46 ) ;
} else {
F_83 ( & V_5 -> V_30 , L_111 ) ;
return V_588 ;
}
...
struct V_21 * V_30 , unsigned long V_601 )
{
struct V_602 * V_603 ;
V_603 = F_370 ( V_30 ) ;
if ( ! V_603 )
...
void F_125 ( struct V_21 * V_22 , unsigned long V_601 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
struct V_21 * V_30 ;
T_3 V_51 ;
F_369 ( V_2 , V_22 , V_601 ) ;
F_375 () ;
F_376 (vid, adapter->vlans, VLAN_N_VID) {
V_30 = F_377 ( V_22 , F_378 ( V_608 ) , V_51 ) ;
if ( ! V_30 )
continue;
F_369 ( V_2 , V_30 , V_601 ) ;
}
F_379 () ;
}
static int F_380 ( struct V_609 * V_610 ,
unsigned long V_601 , void * V_611 )
{
struct V_1 * V_2 ;
struct V_21 * V_30 = F_381 ( V_611 ) ;
V_612:
if ( V_30 == NULL )
goto V_516;
if ( V_30 -> V_397 & V_613 ) {
...
static int
F_384 ( struct V_609 * V_610 ,
unsigned long V_601 , void * V_611 )
{
struct V_1 * V_2 ;
struct V_21 * V_30 ;
struct V_615 * V_604 = (struct V_615 * ) V_611 ;
V_30 = V_604 -> V_616 ? V_604 -> V_616 -> V_30 : NULL ;
V_612:
if ( V_30 == NULL )
goto V_516;
if ( V_30 -> V_397 & V_613 ) {
...
switch ( V_601 ) {
case V_362 :
F_372 ( V_2 , V_604 -> V_605 , V_606 ) ;
break;
case V_266 :
F_372 ( V_2 , V_604 -> V_605 , V_607 ) ;
break;
default:
break;
}
...
void F_125 ( struct V_21 * V_30 , unsigned long V_601 )
{ }
static int T_16 F_385 ( void )
{
int V_26 ;
F_386 ( V_483 L_120 , V_617 ) ;
#ifdef F_387
F_388 ( & V_618 ) ;
F_389 ( & V_619 ) ;
#endif
