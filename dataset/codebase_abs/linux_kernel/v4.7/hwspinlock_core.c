...
static int F_26 ( struct V_1 * V_2 , int V_29 )
{
struct V_1 * V_36 ;
int V_5 ;
F_27 ( & V_37 ) ;
V_5 = F_28 ( & V_38 , V_29 , V_2 ) ;
if ( V_5 ) {
if ( V_5 == - V_39 )
F_29 ( L_3 , V_29 ) ;
goto V_33;
}
V_36 = F_30 ( & V_38 , V_29 , V_40 ) ;
F_15 ( V_36 != V_2 ) ;
V_33:
F_31 ( & V_37 ) ;
return 0 ;
}
static struct V_1 * F_32 ( unsigned int V_29 )
{
struct V_1 * V_2 = NULL ;
int V_5 ;
F_27 ( & V_37 ) ;
V_5 = F_33 ( & V_38 , V_29 , V_40 ) ;
if ( V_5 == 0 ) {
F_29 ( L_4 , V_29 ) ;
goto V_33;
}
...
int F_35 ( struct V_41 * V_10 , struct V_42 * V_31 ,
...
int F_37 ( struct V_41 * V_10 )
{
struct V_1 * V_2 , * V_36 ;
int V_44 ;
for ( V_44 = 0 ; V_44 < V_10 -> V_34 ; V_44 ++ ) {
V_2 = & V_10 -> V_7 [ V_44 ] ;
V_36 = F_32 ( V_10 -> V_35 + V_44 ) ;
if ( ! V_36 )
return - V_9 ;
F_15 ( V_36 != V_2 ) ;
}
...
struct V_1 * F_47 ( void )
{
struct V_1 * V_2 ;
int V_5 ;
F_27 ( & V_37 ) ;
V_5 = F_48 ( & V_38 , ( void * * ) & V_2 ,
0 , 1 , V_40 ) ;
if ( V_5 == 0 ) {
F_49 ( L_10 ) ;
V_2 = NULL ;
...
struct V_1 * F_50 ( unsigned int V_29 )
{
struct V_1 * V_2 ;
int V_5 ;
F_27 ( & V_37 ) ;
