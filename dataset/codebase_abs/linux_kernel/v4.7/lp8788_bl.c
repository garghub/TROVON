...
V_53 = V_9 -> V_53 ;
V_42 = F_17 ( V_53 , V_7 -> V_22 -> V_29 , V_7 ,
& V_58 , & V_43 ) ;
if ( F_8 ( V_42 ) )
return F_18 ( V_42 ) ;
V_7 -> V_42 = V_42 ;
...
static T_2 F_21 ( struct V_36 * V_29 ,
struct V_59 * V_60 , char * V_61 )
{
struct V_6 * V_7 = F_22 ( V_29 ) ;
enum V_1 V_2 = V_7 -> V_2 ;
char * V_62 ;
if ( F_1 ( V_2 ) )
V_62 = L_3 ;
...
V_62 = L_5 ;
return F_23 ( V_61 , V_63 , L_6 , V_62 ) ;
}
static int F_24 ( struct V_64 * V_65 )
{
struct V_66 * V_22 = F_22 ( V_65 -> V_29 . V_67 ) ;
struct V_6 * V_7 ;
int V_13 ;
V_7 = F_25 ( V_22 -> V_29 , sizeof( struct V_6 ) , V_68 ) ;
if ( ! V_7 )
return - V_69 ;
V_7 -> V_22 = V_22 ;
if ( V_22 -> V_9 )
...
{
struct V_6 * V_7 = F_30 ( V_65 ) ;
struct V_41 * V_42 = V_7 -> V_42 ;
V_42 -> V_43 . V_46 = 0 ;
F_28 ( V_42 ) ;
F_31 ( & V_65 -> V_29 . V_72 , & V_73 ) ;
F_19 ( V_7 ) ;
return 0 ;
}
