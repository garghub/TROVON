...
V_127 -> V_136 = V_137 ;
V_127 -> V_138 = 0 ;
V_124 = F_17 ( V_17 + V_139 ) ;
if ( V_124 & ( 1 << 13 ) )
V_127 -> V_138 |= V_140 ;
if ( V_124 & ( 1 << 12 ) )
V_127 -> V_138 |= V_141 ;
if ( V_124 & ( 1 << 9 ) ) {
V_127 -> V_138 |= V_142 | V_143 |
V_144 ;
F_16 ( 4 ) ;
V_124 = F_17 ( V_17 + V_145 ) ;
if ( V_124 & V_146 )
V_127 -> V_136 = V_147 ;
}
F_84 ( V_127 , V_148 ) ;
...
static int
F_85 ( struct V_15 * V_16 , struct V_126 * V_127 )
{
T_6 V_124 ;
int V_17 = V_16 -> V_22 ;
if ( V_127 -> V_149 != V_148 )
return - V_150 ;
if ( ( V_127 -> V_136 != V_137 ) && ( V_127 -> V_136 != V_147 ) )
return - V_150 ;
if ( ( V_127 -> V_129 != V_130 ) && ( V_127 -> V_129 != V_134 ) )
return - V_150 ;
F_16 ( 0 ) ;
V_124 = F_17 ( V_17 + V_128 ) ;
switch ( V_127 -> V_131 ) {
...
F_18 ( V_124 , V_17 + V_128 ) ;
if ( V_16 -> V_19 == 3 ) {
V_124 = F_17 ( V_17 + V_128 ) ;
if ( V_124 & ( 3 << 14 ) ) {
F_18 ( V_151 , V_17 + V_51 ) ;
F_86 ( 800 ) ;
} else
return - V_152 ;
}
F_16 ( 4 ) ;
V_124 = F_17 ( V_17 + V_145 ) ;
if ( V_127 -> V_136 == V_147 )
V_124 |= V_146 ;
else
V_124 &= ~ V_146 ;
F_18 ( V_124 , V_17 + V_145 ) ;
F_16 ( 1 ) ;
return 0 ;
}
static void F_87 ( struct V_15 * V_16 , struct V_153 * V_154 )
{
F_88 ( V_154 -> V_155 , V_156 , sizeof( V_154 -> V_155 ) ) ;
F_88 ( V_154 -> V_47 , V_157 , sizeof( V_154 -> V_47 ) ) ;
}
static int F_89 ( struct V_15 * V_16 , struct V_126 * V_127 )
{
struct V_8 * V_9 = F_6 ( V_16 ) ;
int V_158 ;
F_90 ( & V_9 -> V_40 ) ;
V_158 = F_83 ( V_16 , V_127 ) ;
F_91 ( & V_9 -> V_40 ) ;
return V_158 ;
}
static int F_92 ( struct V_15 * V_16 , struct V_126 * V_127 )
{
struct V_8 * V_9 = F_6 ( V_16 ) ;
int V_158 ;
F_90 ( & V_9 -> V_40 ) ;
V_158 = F_85 ( V_16 , V_127 ) ;
F_91 ( & V_9 -> V_40 ) ;
return V_158 ;
}
...
static void F_95 ( struct V_15 * V_16 , T_7 V_159 )
{
V_14 = V_159 ;
}
static void
...
F_16 ( 4 ) ;
F_18 ( F_17 ( V_17 + V_125 ) & ~ V_163 , V_17 + V_125 ) ;
}
F_18 ( V_164 | 0x0000 , V_17 + V_51 ) ;
F_65 ( V_16 ) ;
}
static void
...
F_16 ( 0 ) ;
V_165 = ( F_31 ( V_17 , 0x14 ) & 0x400f ) |
( F_31 ( V_17 , 0x0d ) & 0xBff0 ) ;
F_16 ( 4 ) ;
V_166 = F_17 ( V_17 + V_145 ) ;
V_166 = ( V_166 | V_146 ) ;
F_42 ( L_28 , V_16 -> V_46 ) ;
...
F_18 ( V_166 , V_17 + V_145 ) ;
F_96 ( L_32 , V_16 -> V_19 , V_165 ) ;
if ( V_14 > 3 )
F_8 ( L_33 , V_16 -> V_46 , V_166 ) ;
F_18 ( F_17 ( V_17 + V_125 ) | V_163 , V_17 + V_125 ) ;
}
F_18 ( V_100 , V_17 + V_51 ) ;
F_16 ( 6 ) ;
...
V_17 + V_51 ) ;
F_18 ( V_164 | V_81 | V_84 | V_88 | V_82 | V_83 ,
V_17 + V_51 ) ;
F_60 ( V_16 ) ;
}
static int
