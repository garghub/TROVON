...
struct V_107 * V_108 ;
F_70 ( & V_109 [ V_20 ] . V_110 ) ;
F_71 ( & V_109 [ V_20 ] . V_111 ) ;
F_34 ( & V_109 [ V_20 ] . V_112 , 0 ) ;
F_72 ( & V_109 [ V_20 ] . V_113 ) ;
V_108 = V_114 [ V_20 ] -> F_73 () ;
if ( F_74 ( V_108 ) ) {
F_75 ( V_115
L_3 ) ;
} else {
...
V_109 [ V_20 ] . V_116 = 1 ;
F_76 ( V_108 , & V_109 [ V_20 ] . V_110 ) ;
}
}
}
static struct V_107 * F_77 ( int type )
{
struct V_107 * V_108 ;
int V_117 = F_78 () ;
int V_118 = type - 1 ;
...
F_84 ( V_120 ) ;
F_82 ( V_111 ) ;
F_85 ( V_113 , & V_120 , V_121 ) ;
if ( F_83 ( V_112 ) > V_117 && ! * V_116 )
F_86 () ;
F_87 ( V_113 , & V_120 ) ;
goto V_119;
}
...
static void F_92 ( int type , struct V_107 * V_108 )
{
int V_118 = type - 1 ;
struct V_107 * V_110 = & V_109 [ V_118 ] . V_110 ;
T_8 * V_111 = & V_109 [ V_118 ] . V_111 ;
...
int V_20 ;
for ( V_20 = 0 ; V_20 < V_106 ; V_20 ++ ) {
while ( ! F_80 ( & V_109 [ V_20 ] . V_110 ) ) {
V_108 = V_109 [ V_20 ] . V_110 . V_86 ;
F_81 ( V_108 ) ;
V_114 [ V_20 ] -> F_92 ( V_108 ) ;
F_88 ( & V_109 [ V_20 ] . V_112 ) ;
}
}
}
int F_96 ( int type , struct V_79 * V_48 ,
...
int V_18 ;
V_108 = F_77 ( type ) ;
V_18 = V_114 [ type - 1 ] -> F_97 ( V_108 , V_48 ,
V_43 , V_54 , V_55 ,
V_125 , V_126 ,
V_127 , V_128 ,
V_129 ) ;
...
int V_18 ;
V_108 = F_77 ( type ) ;
V_18 = V_114 [ type - 1 ] -> F_98 ( V_108 , V_130 ,
V_17 ,
V_50 , V_131 , V_132 ) ;
F_92 ( type , V_108 ) ;
return V_18 ;
}
int F_99 ( int type , unsigned char * V_133 , struct V_19 * V_134 ,
unsigned long V_135 , T_6 V_132 , T_6 V_136 )
{
struct V_107 * V_108 ;
int V_18 ;
V_108 = F_77 ( type ) ;
V_18 = V_114 [ type - 1 ] -> F_100 ( V_108 , V_133 ,
V_134 , V_135 ,
V_132 , V_136 ) ;
F_92 ( type , V_108 ) ;
return V_18 ;
...
int F_102 ( char * V_137 , unsigned long V_138 ,
...
V_141 = V_138 ;
while ( V_142 > 0 ) {
V_143 = F_103 ( V_29 - * V_139 ,
V_29 - V_140 ) ;
V_143 = F_103 ( V_143 , V_142 ) ;
V_21 = F_8 ( V_144 ) ;
...
void F_104 ( struct V_49 * V_50 , int V_131 ,
unsigned long V_63 ,
unsigned long V_139 )
{
while ( V_63 < V_131 ) {
