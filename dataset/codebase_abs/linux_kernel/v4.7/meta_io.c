...
void F_49 ( struct V_4 * V_5 , int V_81 )
{
...
void F_60 ( struct V_94 * V_95 , T_1 V_96 , T_2 V_97 )
{
struct V_24 * V_25 = F_61 ( & V_95 -> V_98 ) ;
struct V_4 * V_5 ;
while ( V_97 ) {
V_5 = F_19 ( V_95 -> V_99 , V_96 , V_100 ) ;
if ( V_5 ) {
F_7 ( V_5 ) ;
F_62 ( V_25 ) ;
F_49 ( V_5 , V_88 ) ;
...
int F_64 ( struct V_94 * V_95 , int V_101 , T_1 V_58 ,
struct V_4 * * V_69 )
{
struct V_24 * V_25 = F_61 ( & V_95 -> V_98 ) ;
struct V_18 * V_19 = V_95 -> V_99 ;
struct V_4 * V_5 ;
int V_102 = 0 ;
...
if ( V_58 == V_95 -> V_106 )
V_68 = V_95 -> V_107 ;
V_102 = F_41 ( V_19 , V_58 , V_73 , V_68 , & V_5 ) ;
if ( V_102 == 0 && F_65 ( V_25 , V_5 , V_103 ) ) {
F_45 ( V_5 ) ;
V_102 = - V_72 ;
}
* V_69 = V_5 ;
...
struct V_4 * F_66 ( struct V_18 * V_19 , T_1 V_108 , T_2 V_109 )
{
struct V_24 * V_25 = V_19 -> V_26 . V_27 ;
struct V_4 * V_110 , * V_5 ;
T_2 V_111 = F_67 ( V_25 , V_112 ) >>
V_25 -> V_33 . V_34 ;
F_2 ( ! V_109 ) ;
if ( V_111 < 1 )
V_111 = 1 ;
if ( V_109 > V_111 )
V_109 = V_111 ;
V_110 = F_19 ( V_19 , V_108 , V_44 ) ;
if ( F_44 ( V_110 ) )
goto V_113;
if ( ! F_68 ( V_110 ) )
F_69 ( V_75 | V_9 , 1 , & V_110 ) ;
V_108 ++ ;
V_109 -- ;
while ( V_109 ) {
V_5 = F_19 ( V_19 , V_108 , V_44 ) ;
if ( ! F_44 ( V_5 ) && ! F_68 ( V_5 ) )
F_69 ( V_114 | V_9 , 1 , & V_5 ) ;
F_45 ( V_5 ) ;
V_108 ++ ;
V_109 -- ;
if ( ! F_68 ( V_110 ) && F_44 ( V_110 ) )
goto V_113;
}
F_46 ( V_110 ) ;
V_113:
