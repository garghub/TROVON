...
do {
V_212 = F_18 () ;
} while ( F_80 ( V_212 , V_210 ) < 0 );
} else {
F_81 ( & V_154 , V_12 ) ;
do {
F_82 ( V_218 ) ;
F_83 ( & V_154 . V_215 , V_217 ) ;
if ( F_84 ( V_154 . V_219 ) )
F_85 () ;
F_86 ( & V_154 . V_215 ) ;
} while ( V_154 . V_219 && V_22 -> V_92 && ! F_87 ( V_12 ) );
F_88 ( V_220 ) ;
V_212 = F_18 () ;
}
V_22 -> V_94 += F_78 ( F_89 ( V_212 , V_211 ) ) ;
V_156:
V_22 -> V_221 = F_90 ( V_210 , V_22 -> V_29 ) ;
F_91 ( & V_154 . V_215 ) ;
}
static inline void F_92 ( struct V_21 * V_22 )
{
V_22 -> V_196 = F_93 ( V_22 -> V_50 ) ;
V_22 -> V_196 += V_22 -> V_59 * sizeof( V_222 ) ;
V_22 -> V_196 += F_94 ( V_22 ) ;
V_22 -> V_196 += F_95 ( V_22 ) ;
}
static inline int F_96 ( const struct V_21 * V_22 , int V_223 )
{
...
static void F_99 ( struct V_21 * V_22 , int V_223 )
{
struct V_227 * V_228 = V_22 -> V_224 [ V_223 ] . V_228 ;
struct V_10 * V_11 = F_4 ( F_64 ( V_22 -> V_50 ) , V_15 ) ;
if ( ! V_228 ) {
if ( V_22 -> V_86 ) {
V_228 = F_100 ( V_11 -> V_183 , F_28 ( V_22 -> V_86 ) , V_229 ) ;
} else {
V_228 = F_101 ( V_11 -> V_183 , V_230 ,
( V_231 * ) & V_22 -> V_105 ,
( V_231 * ) & V_22 -> V_104 ,
V_229 ,
V_22 -> V_232 ,
...
static int F_111 ( struct V_243 * V_244 , struct V_21 * V_22 )
{
...
struct V_205 * V_262 ;
int V_155 ;
V_259 = V_228 -> V_234 . V_235 - F_120 ( V_244 ) ;
if ( V_259 > 0 ) {
V_155 = F_121 ( V_244 , V_259 , 0 , V_263 ) ;
if ( V_155 < 0 ) {
F_48 ( L_253 ,
V_155 ) ;
goto V_184;
...
F_122 ( V_244 , V_264 ) ;
V_155 = F_111 ( V_244 , V_22 ) ;
if ( V_155 ) {
F_48 ( L_254 , V_155 ) ;
goto V_184;
}
V_261 = (struct V_260 * ) F_123 ( V_244 , V_264 ) ;
memcpy ( V_261 , V_22 -> V_149 , 2 * V_265 ) ;
V_261 -> V_266 = V_258 ;
V_262 = F_124 ( V_244 ) ;
V_262 -> V_267 = F_125 ( V_244 -> V_120 - V_264 ) ;
F_126 ( V_262 ) ;
}
}
return 1 ;
...
static void F_128 ( V_240 * V_268 , struct V_21 * V_22 )
{
unsigned int V_60 ;
for ( V_60 = 0 ; V_60 < V_22 -> V_59 ; V_60 ++ )
...
static inline T_10 F_129 ( unsigned int V_269 , unsigned int V_270 ,
unsigned int V_271 )
{
return F_125 ( V_269 | ( V_270 << 12 ) | ( V_271 << 13 ) ) ;
}
static void F_130 ( struct V_21 * V_22 , struct V_243 * V_244 ,
int V_272 )
{
struct V_273 V_274 ;
struct V_195 * V_275 ;
V_275 = (struct V_195 * ) F_131 ( V_244 , sizeof( * V_275 ) ) ;
V_272 -= sizeof( * V_275 ) ;
if ( V_22 -> V_28 <= 0 ) {
memset ( F_131 ( V_244 , V_272 ) , 0 , V_272 ) ;
} else {
int V_276 = V_22 -> V_28 ;
int V_60 , V_120 ;
int V_277 ;
...
if ( V_120 > 0 ) {
memset ( F_131 ( V_244 , V_120 ) , 0 , V_120 ) ;
V_272 = V_276 * V_279 ;
}
V_60 = 0 ;
...
V_71 = V_22 -> V_71 ;
V_22 -> V_141 = F_134 ( V_71 , V_280 | V_281 , 0 ) ;
if ( ! V_22 -> V_141 )
break;
}
F_135 ( V_22 -> V_141 ) ;
F_136 ( V_244 , V_60 , V_22 -> V_141 ) ;
F_137 ( V_244 ) -> V_276 [ V_60 ] . V_282 = 0 ;
if ( V_60 == ( V_276 - 1 ) )
F_138 ( & F_137 ( V_244 ) -> V_276 [ V_60 ] ,
( V_272 < V_279 ? V_272 : V_279 ) ) ;
else
F_138 ( & F_137 ( V_244 ) -> V_276 [ V_60 ] , V_277 ) ;
V_272 -= F_139 ( & F_137 ( V_244 ) -> V_276 [ V_60 ] ) ;
V_244 -> V_120 += F_139 ( & F_137 ( V_244 ) -> V_276 [ V_60 ] ) ;
V_244 -> V_283 += F_139 ( & F_137 ( V_244 ) -> V_276 [ V_60 ] ) ;
V_60 ++ ;
F_137 ( V_244 ) -> V_284 = V_60 ;
}
}
...
static struct V_243 * F_141 ( struct V_168 * V_169 ,
struct V_21 * V_22 ,
unsigned int V_289 )
{
...
V_244 = F_142 ( V_291 + V_290 , V_292 , 0 , V_71 ) ;
if ( F_84 ( V_244 ) ) {
F_143 ( V_244 , V_291 ) ;
V_244 -> V_169 = V_169 ;
}
} else {
V_244 = F_144 ( V_169 , V_290 , V_292 ) ;
}
if ( F_84 ( V_244 ) )
F_143 ( V_244 , F_93 ( V_169 ) ) ;
return V_244 ;
}
static struct V_243 * F_145 ( struct V_168 * V_50 ,
struct V_21 * V_22 )
{
struct V_243 * V_244 = NULL ;
T_11 * V_261 ;
...
F_146 ( V_244 -> V_9 ) ;
F_143 ( V_244 , V_272 ) ;
V_261 = ( T_11 * ) F_123 ( V_244 , 14 ) ;
V_268 = ( V_240 * ) F_131 ( V_244 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_128 ( V_268 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_298 = ( T_10 * ) F_131 ( V_244 , sizeof( T_10 ) ) ;
* V_298 = F_129 ( V_22 -> V_65 ,
V_22 -> V_67 ,
V_22 -> V_66 ) ;
V_299 = ( T_10 * ) F_131 ( V_244 , sizeof( T_10 ) ) ;
* V_299 = F_125 ( V_302 ) ;
}
V_296 = ( T_10 * ) F_131 ( V_244 , sizeof( T_10 ) ) ;
* V_296 = F_129 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_297 = ( T_10 * ) F_131 ( V_244 , sizeof( T_10 ) ) ;
* V_297 = F_125 ( V_295 ) ;
}
F_147 ( V_244 ) ;
F_148 ( V_244 , V_244 -> V_120 ) ;
V_262 = (struct V_205 * ) F_131 ( V_244 , sizeof( struct V_205 ) ) ;
F_149 ( V_244 , V_244 -> V_120 ) ;
V_293 = (struct V_194 * ) F_131 ( V_244 , sizeof( struct V_194 ) ) ;
F_150 ( V_244 , V_300 ) ;
...
V_293 -> V_305 = F_125 ( V_22 -> V_107 ) ;
V_293 -> V_306 = F_125 ( V_22 -> V_106 ) ;
V_293 -> V_120 = F_125 ( V_272 + 8 ) ;
V_293 -> V_307 = 0 ;
V_262 -> V_308 = 5 ;
V_262 -> V_4 = 4 ;
V_262 -> V_309 = 32 ;
...
V_262 -> V_269 = F_125 ( V_22 -> V_313 ) ;
V_22 -> V_313 ++ ;
V_262 -> V_314 = 0 ;
V_294 = 20 + 8 + V_272 ;
V_262 -> V_267 = F_125 ( V_294 ) ;
F_126 ( V_262 ) ;
V_244 -> V_258 = V_258 ;
V_244 -> V_169 = V_50 ;
V_244 -> V_315 = V_316 ;
F_130 ( V_22 , V_244 , V_272 ) ;
if ( ! ( V_22 -> V_37 & V_79 ) ) {
V_244 -> V_317 = V_318 ;
} else if ( V_50 -> V_319 & ( V_320 | V_321 ) ) {
V_244 -> V_317 = V_322 ;
V_244 -> V_323 = 0 ;
F_151 ( V_244 , V_262 -> V_311 , V_262 -> V_312 ) ;
} else {
T_13 V_323 = F_152 ( V_244 , F_153 ( V_244 ) , V_272 + 8 , 0 ) ;
V_293 -> V_307 = F_154 ( V_262 -> V_311 , V_262 -> V_312 ,
V_272 + 8 , V_310 , V_323 ) ;
if ( V_293 -> V_307 == 0 )
V_293 -> V_307 = V_324 ;
}
#ifdef F_17
if ( ! F_119 ( V_22 , V_244 , V_258 ) )
return NULL ;
#endif
return V_244 ;
}
static struct V_243 * F_155 ( struct V_168 * V_50 ,
struct V_21 * V_22 )
{
struct V_243 * V_244 = NULL ;
T_11 * V_261 ;
...
F_147 ( V_244 ) ;
F_148 ( V_244 , V_244 -> V_120 ) ;
V_262 = (struct V_193 * ) F_131 ( V_244 , sizeof( struct V_193 ) ) ;
F_149 ( V_244 , V_244 -> V_120 ) ;
V_293 = (struct V_194 * ) F_131 ( V_244 , sizeof( struct V_194 ) ) ;
F_150 ( V_244 , V_300 ) ;
V_244 -> V_304 = V_22 -> V_36 ;
...
V_244 -> V_317 = V_322 ;
V_244 -> V_331 = F_157 ( V_244 ) - V_244 -> V_332 ;
V_244 -> V_333 = F_158 ( struct V_194 , V_307 ) ;
V_293 -> V_307 = ~ F_159 ( & V_262 -> V_311 , & V_262 -> V_312 , V_325 , V_310 , 0 ) ;
} else {
T_13 V_323 = F_152 ( V_244 , F_153 ( V_244 ) , V_325 , 0 ) ;
V_293 -> V_307 = F_159 ( & V_262 -> V_311 , & V_262 -> V_312 , V_325 , V_310 , V_323 ) ;
if ( V_293 -> V_307 == 0 )
V_293 -> V_307 = V_324 ;
}
return V_244 ;
}
static struct V_243 * F_160 ( struct V_168 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
...
static void F_161 ( struct V_153 * V_154 )
{
struct V_21 * V_22 ;
int V_335 = 0 ;
F_162 () ;
...
static int F_163 ( const struct V_153 * V_154 )
{
const struct V_21 * V_22 ;
F_44 () ;
F_45 (pkt_dev, &t->if_list, list)
...
static int F_164 ( struct V_153 * V_154 )
{
while ( F_163 ( V_154 ) ) {
F_165 ( 100 ) ;
if ( F_87 ( V_12 ) )
...
static void F_167 ( struct V_21 * V_22 , int V_284 )
{
T_14 V_339 , V_340 , V_341 ;
char * V_342 = V_22 -> V_110 ;
T_5 V_343 = F_89 ( V_22 -> V_93 ,
V_22 -> V_98 ) ;
T_5 V_25 = F_168 ( V_22 -> V_94 ) ;
V_342 += sprintf ( V_342 , L_259 ,
( unsigned long long ) F_20 ( V_343 ) ,
( unsigned long long ) F_20 ( F_89 ( V_343 , V_25 ) ) ,
( unsigned long long ) F_20 ( V_25 ) ,
( unsigned long long ) V_22 -> V_96 ,
V_22 -> V_134 , V_284 ) ;
V_341 = F_169 ( V_22 -> V_96 * V_136 ,
F_78 ( V_343 ) ) ;
...
{
int V_284 = V_22 -> V_244 ? F_137 ( V_22 -> V_244 ) -> V_284 : - 1 ;
if ( ! V_22 -> V_92 ) {
F_30 ( L_261 ,
V_22 -> V_31 ) ;
return - V_18 ;
...
static struct V_21 * F_171 ( struct V_153 * V_154 )
{
...
if ( V_344 == NULL )
V_344 = V_22 ;
else if ( F_80 ( V_22 -> V_221 , V_344 -> V_221 ) < 0 )
V_344 = V_22 ;
}
F_46 () ;
return V_344 ;
...
static void F_173 ( struct V_153 * V_154 )
{
struct V_345 * V_346 , * V_119 ;
struct V_21 * V_347 ;
F_162 () ;
F_174 (q, n, &t->if_list) {
V_347 = F_175 ( V_346 , struct V_21 , V_348 ) ;
if ( ! V_347 -> V_163 )
continue;
F_127 ( V_347 -> V_244 ) ;
V_347 -> V_244 = NULL ;
...
static void F_178 ( struct V_153 * V_154 )
{
F_179 ( V_154 -> V_349 -> V_350 , V_154 -> V_183 -> V_171 ) ;
}
static void F_180 ( struct V_21 * V_22 )
{
T_5 V_351 = F_18 () ;
F_85 () ;
V_22 -> V_94 += F_78 ( F_89 ( F_18 () , V_351 ) ) ;
}
static void F_181 ( struct V_21 * V_22 )
{
T_5 V_351 = F_18 () ;
while ( F_182 ( & ( V_22 -> V_244 -> V_352 ) ) != 1 ) {
if ( F_87 ( V_12 ) )
break;
if ( F_183 () )
F_180 ( V_22 ) ;
...
if ( F_132 ( V_22 -> V_29 == V_135 ) ) {
V_22 -> V_221 = F_90 ( F_18 () , V_355 ) ;
return;
}
if ( ! V_22 -> V_244 || ( V_22 -> V_143 &&
++ V_22 -> V_356 >= V_22 -> V_30 ) ) {
F_127 ( V_22 -> V_244 ) ;
V_22 -> V_244 = F_160 ( V_50 , V_22 ) ;
if ( V_22 -> V_244 == NULL ) {
F_48 ( L_262 ) ;
F_85 () ;
V_22 -> V_356 -- ;
...
F_75 ( V_22 , V_22 -> V_221 ) ;
if ( V_22 -> V_72 == V_73 ) {
V_244 = V_22 -> V_244 ;
V_244 -> V_258 = F_188 ( V_244 , V_244 -> V_169 ) ;
F_189 ( V_70 , & V_244 -> V_352 ) ;
F_190 () ;
do {
V_155 = F_191 ( V_244 ) ;
if ( V_155 == V_358 )
...
V_22 -> V_96 ++ ;
V_22 -> V_99 ++ ;
if ( F_182 ( & V_244 -> V_352 ) != V_70 ) {
F_192 ( V_70 - 1 , & V_244 -> V_352 ) ;
break;
}
#ifdef F_193
V_244 -> V_359 = 0 ;
...
V_354 = F_194 ( V_50 , V_22 -> V_244 ) ;
F_190 () ;
F_195 ( V_50 , V_354 , F_103 () ) ;
if ( F_132 ( F_196 ( V_354 ) ) ) {
V_155 = V_360 ;
V_22 -> V_143 = 0 ;
goto V_361;
}
F_189 ( V_70 , & V_22 -> V_244 -> V_352 ) ;
V_362:
V_155 = F_197 ( V_22 -> V_244 , V_50 , V_354 , -- V_70 > 0 ) ;
switch ( V_155 ) {
case V_363 :
V_22 -> V_143 = 1 ;
V_22 -> V_96 ++ ;
...
V_22 -> V_97 ++ ;
case V_360 :
F_198 ( & ( V_22 -> V_244 -> V_352 ) ) ;
V_22 -> V_143 = 0 ;
}
if ( F_132 ( V_70 ) )
F_192 ( V_70 , & V_22 -> V_244 -> V_352 ) ;
V_361:
F_199 ( V_50 , V_354 ) ;
V_156:
F_200 () ;
...
F_203 ( & V_154 -> V_370 ) ;
F_204 ( & V_154 -> V_371 ) ;
F_32 ( L_264 , V_369 , F_205 ( V_12 ) ) ;
F_206 () ;
while ( ! F_207 () ) {
V_22 = F_171 ( V_154 ) ;
if ( F_132 ( ! V_22 && V_154 -> V_158 == 0 ) ) {
...
static int F_210 ( struct V_153 * V_154 ,
struct V_21 * V_22 )
{
int V_373 = 0 ;
F_211 ( V_154 ) ;
...
struct V_21 * V_22 ;
int V_184 ;
int V_71 = F_214 ( V_154 -> V_369 ) ;
V_22 = F_55 ( V_154 -> V_183 , V_160 , V_162 ) ;
if ( V_22 ) {
F_48 ( L_270 ) ;
return - V_375 ;
}
V_22 = F_215 ( sizeof( struct V_21 ) , V_280 , V_71 ) ;
if ( ! V_22 )
return - V_377 ;
strcpy ( V_22 -> V_31 , V_160 ) ;
V_22 -> V_224 = F_216 ( V_150 * sizeof( struct V_378 ) ,
V_71 ) ;
if ( V_22 -> V_224 == NULL ) {
F_217 ( V_22 ) ;
return - V_377 ;
...
static int T_15 F_220 ( int V_369 , struct V_10 * V_11 )
{
struct V_153 * V_154 ;
struct V_391 * V_392 ;
struct V_393 * V_342 ;
V_154 = F_215 ( sizeof( struct V_153 ) , V_280 ,
F_214 ( V_369 ) ) ;
if ( ! V_154 ) {
F_48 ( L_272 ) ;
return - V_377 ;
...
F_229 ( V_342 , V_369 ) ;
V_154 -> V_349 = V_342 ;
V_392 = F_61 ( V_154 -> V_349 -> V_350 , 0600 , V_11 -> V_171 ,
& V_396 , V_154 ) ;
if ( ! V_392 ) {
F_48 ( L_271 ,
V_383 , V_154 -> V_349 -> V_350 ) ;
F_230 ( V_342 ) ;
F_227 ( & V_154 -> V_394 ) ;
F_217 ( V_154 ) ;
return - V_18 ;
...
static void F_234 ( struct V_153 * V_154 ,
struct V_21 * V_22 )
{
struct V_345 * V_346 , * V_119 ;
struct V_21 * V_342 ;
F_211 ( V_154 ) ;
F_174 (q, n, &t->if_list) {
V_342 = F_175 ( V_346 , struct V_21 , V_348 ) ;
if ( V_342 == V_22 )
F_235 ( & V_342 -> V_348 ) ;
}
F_213 ( V_154 ) ;
}
static int F_176 ( struct V_153 * V_154 ,
struct V_21 * V_22 )
{
F_32 ( L_275 , V_22 ) ;
if ( V_22 -> V_92 ) {
...
static int T_15 F_237 ( struct V_183 * V_183 )
{
...
F_222 ( & V_11 -> V_395 ) ;
V_11 -> V_177 = false ;
V_11 -> V_171 = F_238 ( V_383 , V_11 -> V_183 -> V_398 ) ;
if ( ! V_11 -> V_171 ) {
F_30 ( L_277 , V_383 ) ;
return - V_185 ;
}
V_392 = F_239 ( V_399 , 0600 , V_11 -> V_171 , & V_400 ) ;
if ( V_392 == NULL ) {
F_48 ( L_278 , V_399 ) ;
V_155 = - V_18 ;
goto remove;
...
return 0 ;
V_401:
F_179 ( V_399 , V_11 -> V_171 ) ;
remove:
F_179 ( V_383 , V_11 -> V_183 -> V_398 ) ;
return V_155 ;
}
static void T_16 F_242 ( struct V_183 * V_183 )
{
struct V_10 * V_11 = F_4 ( V_183 , V_15 ) ;
struct V_153 * V_154 ;
struct V_345 * V_346 , * V_119 ;
...
V_11 -> V_177 = true ;
F_49 ( & V_157 ) ;
F_244 ( & V_11 -> V_395 , & V_348 ) ;
F_51 ( & V_157 ) ;
F_174 (q, n, &list) {
V_154 = F_175 ( V_346 , struct V_153 , V_394 ) ;
F_227 ( & V_154 -> V_394 ) ;
F_230 ( V_154 -> V_349 ) ;
F_245 ( V_154 -> V_349 ) ;
F_217 ( V_154 ) ;
