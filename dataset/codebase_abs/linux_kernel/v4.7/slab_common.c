...
static void F_110 ( struct V_97 * V_98 )
{
#ifdef F_111
F_112 ( V_98 , L_10 ) ;
#else
...
void * F_114 ( struct V_97 * V_98 , T_4 * V_99 )
{
F_27 ( & V_32 ) ;
return F_115 ( & V_49 , * V_99 ) ;
}
void * F_116 ( struct V_97 * V_98 , void * V_13 , T_4 * V_99 )
{
return F_117 ( V_13 , & V_49 , V_99 ) ;
}
void F_118 ( struct V_97 * V_98 , void * V_13 )
{
F_28 ( & V_32 ) ;
}
static void
F_119 ( struct V_3 * V_4 , struct V_100 * V_101 )
{
struct V_3 * V_69 ;
struct V_100 V_102 ;
if ( ! V_18 ( V_4 ) )
...
static void F_122 ( struct V_3 * V_4 , struct V_97 * V_98 )
{
struct V_100 V_102 ;
memset ( & V_102 , 0 , sizeof( V_102 ) ) ;
F_121 ( V_4 , & V_102 ) ;
...
static int F_125 ( struct V_97 * V_98 , void * V_13 )
{
struct V_3 * V_4 = F_126 ( V_13 , struct V_3 , V_19 ) ;
if ( V_13 == V_49 . V_113 )
F_110 ( V_98 ) ;
if ( V_18 ( V_4 ) )
F_122 ( V_4 , V_98 ) ;
...
int F_127 ( struct V_97 * V_98 , void * V_13 )
{
struct V_3 * V_4 = F_126 ( V_13 , struct V_3 , V_19 ) ;
struct V_21 * V_22 = F_128 ( F_129 ( V_98 ) ) ;
if ( V_13 == V_49 . V_113 )
F_110 ( V_98 ) ;
if ( ! V_18 ( V_4 ) && V_4 -> V_17 . V_22 == V_22 )
F_122 ( V_4 , V_98 ) ;
...
static int F_130 ( struct V_114 * V_114 , struct V_115 * V_115 )
{
return F_131 ( V_115 , & V_116 ) ;
}
static int T_1 F_132 ( void )
{
F_133 ( L_20 , V_117 , NULL ,
& V_118 ) ;
return 0 ;
}
static T_5 void * F_134 ( const void * V_13 , T_2 V_119 ,
T_3 V_15 )
{
void * V_36 ;
T_2 V_120 = 0 ;
...
V_120 = F_135 ( V_13 ) ;
if ( V_120 >= V_119 ) {
F_136 ( ( void * ) V_13 , V_119 , V_15 ) ;
return ( void * ) V_13 ;
}
V_36 = F_137 ( V_119 , V_15 ) ;
if ( V_36 && V_13 )
memcpy ( V_36 , V_13 , V_120 ) ;
return V_36 ;
}
void * F_138 ( const void * V_13 , T_2 V_119 , T_3 V_15 )
{
if ( F_85 ( ! V_119 ) )
return V_80 ;
return F_134 ( V_13 , V_119 , V_15 ) ;
}
void * F_139 ( const void * V_13 , T_2 V_119 , T_3 V_15 )
{
void * V_36 ;
if ( F_85 ( ! V_119 ) ) {
F_11 ( V_13 ) ;
...
V_36 = F_134 ( V_13 , V_119 , V_15 ) ;
if ( V_36 && V_13 != V_36 )
F_11 ( V_13 ) ;
return V_36 ;
}
void F_140 ( const void * V_13 )
{
T_2 V_120 ;
