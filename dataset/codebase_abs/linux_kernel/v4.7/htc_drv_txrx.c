...
V_220 -> V_223 |= V_226 ;
if ( V_222 -> V_224 & V_227 )
V_220 -> V_223 |= V_228 ;
}
static void F_104 ( struct V_219 * V_220 ,
struct V_221 * V_222 )
{
V_220 -> V_229 = F_105 ( V_222 -> V_229 ) ;
V_220 -> V_230 = V_222 -> V_230 ;
V_220 -> V_231 = V_222 -> V_231 ;
V_220 -> V_232 = V_222 -> V_232 ;
V_220 -> V_233 = V_222 -> V_233 ;
V_220 -> V_234 = V_222 -> V_234 ;
V_220 -> V_235 = V_222 -> V_235 ;
V_220 -> V_236 = V_222 -> V_236 ;
memcpy ( V_220 -> V_237 , V_222 -> V_237 ,
sizeof( V_220 -> V_237 ) ) ;
memcpy ( V_220 -> V_238 , V_222 -> V_238 ,
sizeof( V_220 -> V_238 ) ) ;
V_220 -> V_239 = V_222 -> V_239 ;
V_220 -> V_240 = V_222 -> V_240 ;
...
{
struct V_69 * V_70 ;
struct V_246 * V_15 = V_8 -> V_15 ;
struct V_40 * V_41 = V_243 -> V_41 ;
struct V_28 * V_29 = F_16 ( V_8 -> V_30 ) ;
...
if ( F_105 ( V_222 -> V_229 ) -
( V_41 -> V_99 - V_248 ) != 0 ) {
F_17 ( V_29 ,
L_10 ,
V_222 -> V_229 , V_41 -> V_99 ) ;
goto V_249;
}
memset ( V_245 , 0 , sizeof( struct V_244 ) ) ;
F_104 ( & V_220 , V_222 ) ;
F_107 ( V_8 , & V_220 ) ;
V_245 -> V_250 = F_108 ( V_222 -> V_251 ) ;
F_20 ( V_41 , V_248 ) ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( V_220 . V_230 & V_252 ) {
if ( F_109 ( & V_8 -> V_253 , V_70 ,
& V_220 , V_245 -> V_250 ) ) {
}
goto V_249;
}
if ( ! F_110 ( V_29 , V_70 , V_245 , & V_220 ,
& V_247 , V_8 -> V_198 ) )
goto V_249;
F_111 ( V_29 , V_41 , & V_220 ,
V_245 , V_247 ) ;
if ( F_112 ( V_29 , V_15 , & V_220 , V_245 ) )
goto V_249;
V_220 . V_254 = F_113 ( V_29 , V_70 ) ;
F_114 ( V_29 , V_15 , & V_220 , V_245 ) ;
V_245 -> V_159 = V_30 -> V_255 -> V_158 -> V_159 ;
V_245 -> V_256 = V_30 -> V_255 -> V_158 -> V_257 ;
V_245 -> V_258 = V_220 . V_235 ;
V_245 -> V_223 |= V_259 ;
return true ;
V_249:
return false ;
...
{
struct V_7 * V_8 = (struct V_7 * ) V_46 ;
struct V_242 * V_243 = NULL , * V_260 = NULL ;
struct V_244 V_245 ;
struct V_40 * V_41 ;
unsigned long V_13 ;
struct V_69 * V_70 ;
...
if ( ! V_243 -> V_41 )
goto V_264;
if ( ! F_106 ( V_8 , V_243 , & V_245 ) ) {
F_49 ( V_243 -> V_41 ) ;
goto V_264;
}
memcpy ( F_117 ( V_243 -> V_41 ) , & V_245 ,
sizeof( struct V_244 ) ) ;
V_41 = V_243 -> V_41 ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( F_118 ( V_70 -> V_72 ) && V_8 -> V_265 )
F_119 ( V_8 -> V_15 , & V_8 -> V_266 ) ;
F_68 ( & V_8 -> V_261 . V_262 , V_13 ) ;
F_120 ( V_8 -> V_15 , V_41 ) ;
F_65 ( & V_8 -> V_261 . V_262 , V_13 ) ;
V_264:
V_243 -> V_263 = false ;
V_243 -> V_41 = NULL ;
F_121 ( & V_243 -> V_170 , & V_8 -> V_261 . V_243 ) ;
V_243 = NULL ;
F_68 ( & V_8 -> V_261 . V_262 , V_13 ) ;
} while ( 1 );
}
...
{
int V_178 = 0 ;
F_125 ( & V_8 -> V_261 . V_243 ) ;
F_126 ( & V_8 -> V_261 . V_262 ) ;
for ( V_178 = 0 ; V_178 < V_271 ; V_178 ++ ) {
struct V_242 * V_243 =
F_70 ( sizeof( struct V_242 ) , V_272 ) ;
if ( V_243 == NULL )
goto V_268;
F_72 ( & V_243 -> V_170 , & V_8 -> V_261 . V_243 ) ;
}
return 0 ;
V_268:
F_123 ( V_8 ) ;
