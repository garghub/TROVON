...
void F_22 ( struct V_33 * V_34 , struct V_24 * V_25 )
{
F_19 ( & V_34 -> V_58 ) ;
if ( F_23 ( ! V_25 ) )
return;
...
static void F_24 ( void * V_61 , T_1 * V_62 ,
struct V_63 * V_64 )
{
unsigned long * V_65 = V_61 ;
struct V_66 * V_67 = F_25 ( V_64 ) ;
if ( ! V_67 -> V_68 )
return;
if ( V_64 -> type == V_69 ||
V_64 -> type == V_70 )
F_26 ( V_67 -> V_68 -> V_31 , V_65 ) ;
}
int F_27 ( struct V_33 * V_34 )
{
