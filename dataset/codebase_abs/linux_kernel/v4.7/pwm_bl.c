...
if ( V_31 -> V_14 ) {
unsigned int V_56 ;
for ( V_56 = 0 ; V_56 <= V_31 -> V_42 ; V_56 ++ )
if ( V_31 -> V_14 [ V_56 ] > V_2 -> V_15 )
V_2 -> V_15 = V_31 -> V_14 [ V_56 ] ;
V_2 -> V_14 = V_31 -> V_14 ;
} else
V_2 -> V_15 = V_31 -> V_42 ;
V_2 -> V_24 = V_31 -> V_24 ;
...
if ( V_33 && V_33 -> V_59 && ! F_31 ( V_2 -> V_6 ) )
V_51 = V_61 ;
V_2 -> V_9 = F_32 ( & V_48 -> V_7 , NULL ) ;
if ( F_22 ( V_2 -> V_9 ) && F_23 ( V_2 -> V_9 ) != - V_62 && ! V_33 ) {
F_3 ( & V_48 -> V_7 , L_8 ) ;
V_2 -> V_63 = true ;
V_2 -> V_9 = F_33 ( V_31 -> V_64 , L_9 ) ;
}
if ( F_22 ( V_2 -> V_9 ) ) {
V_39 = F_23 ( V_2 -> V_9 ) ;
if ( V_39 != - V_62 )
