...
struct V_204 * V_205 ;
if ( V_200 -> V_210 -> type != V_211 ||
! ( V_209 & V_212 ) )
return NULL ;
V_24 = F_108 ( & V_72 -> V_213 ) ;
if ( F_6 ( V_24 != 0 ) )
return F_109 ( - V_214 ) ;
if ( V_200 -> V_215 ) {
F_110 ( & V_72 -> V_213 ) ;
...
F_110 ( & V_72 -> V_213 ) ;
V_205 = V_204 ( V_200 -> V_218 ) ;
V_24 = F_111 ( & V_205 -> V_153 , true ) ;
if ( F_6 ( V_24 != 0 ) )
V_205 = F_109 ( V_24 ) ;
return V_205 ;
}
static long F_112 ( struct V_219 * V_220 , unsigned int V_221 ,
unsigned long V_222 ,
long (* F_113)( struct V_219 * , unsigned int ,
unsigned long ) )
{
struct V_199 * V_200 = V_220 -> V_223 ;
struct V_81 * V_72 = V_200 -> V_210 -> V_72 ;
unsigned int V_224 = F_114 ( V_221 ) ;
struct V_204 * V_205 ;
unsigned int V_209 ;
long V_24 ;
if ( ( V_224 >= V_225 ) && ( V_224 < V_226 )
&& ( V_224 < V_225 + V_72 -> V_227 -> V_228 ) ) {
const struct V_229 * V_230 =
& V_231 [ V_224 - V_225 ] ;
if ( V_224 == V_225 + V_232 ) {
V_24 = ( long ) F_115 ( V_230 -> V_209 , V_200 ) ;
if ( F_6 ( V_24 != 0 ) )
return V_24 ;
if ( F_6 ( ( V_221 & ( V_233 | V_234 ) ) != V_233 ) )
goto V_235;
return ( long ) F_116 ( V_72 , V_222 , V_200 ,
F_117 ( V_221 ) ) ;
}
if ( F_6 ( V_230 -> V_221 != V_221 ) )
goto V_235;
V_209 = V_230 -> V_209 ;
} else if ( ! F_118 ( V_224 , & V_209 ) )
return - V_80 ;
...
static long F_121 ( struct V_219 * V_220 , unsigned int V_221 ,
unsigned long V_222 )
{
return F_112 ( V_220 , V_221 , V_222 , & V_236 ) ;
}
static long F_122 ( struct V_219 * V_220 , unsigned int V_221 ,
unsigned long V_222 )
{
return F_112 ( V_220 , V_221 , V_222 , & V_237 ) ;
}
static void F_123 ( struct V_81 * V_72 )
{
}
...
static int F_124 ( struct V_81 * V_72 ,
struct V_238 * V_218 )
{
struct V_204 * V_205 ;
...
struct V_238 * V_218 )
{
struct V_204 * V_205 = V_204 ( V_218 ) ;
V_218 -> V_208 = NULL ;
F_91 ( V_205 ) ;
}
...
struct V_204 * V_205 = V_204 ( V_200 -> V_218 ) ;
int V_24 = 0 ;
if ( V_240 ) {
F_8 ( V_240 != & V_23 -> V_152 ) ;
V_24 = F_127 ( & V_240 -> V_153 , false , V_202 -> V_206 ) ;
if ( F_6 ( V_24 != 0 ) )
return V_24 ;
...
struct V_204 * V_205 = V_204 ( V_200 -> V_218 ) ;
int V_24 ;
V_202 -> V_203 = F_130 ( V_200 -> V_218 ) ;
V_24 = F_127 ( & V_205 -> V_153 , false , V_202 -> V_206 ) ;
F_131 ( V_23 ) ;
if ( F_6 ( ( V_24 != 0 ) ) ) {
F_15 ( L_65 ) ;
F_103 ( & V_202 -> V_203 ) ;
...
static void F_137 ( struct V_245 * V_89 )
{
struct V_81 * V_72 = F_138 ( V_89 ) ;
F_139 ( V_89 ) ;
F_140 ( V_72 ) ;
}
static int V_193 ( struct V_246 * V_247 , unsigned long V_248 ,
void * V_249 )
{
struct V_22 * V_23 =
F_141 ( V_247 , struct V_22 , V_191 ) ;
switch ( V_248 ) {
case V_250 :
if ( V_23 -> V_117 )
F_97 ( V_23 ) ;
...
static int F_147 ( struct V_245 * V_89 , T_4 V_38 )
{
struct V_81 * V_72 = F_138 ( V_89 ) ;
struct V_22 * V_23 = F_93 ( V_72 ) ;
if ( V_23 -> V_254 )
...
static int F_150 ( struct V_245 * V_89 )
{
F_149 ( V_89 , V_257 ) ;
F_151 ( V_89 ) ;
return F_152 ( V_89 ) ;
}
static int F_153 ( struct V_258 * V_259 )
{
struct V_245 * V_89 = F_154 ( V_259 ) ;
struct V_260 V_30 ;
V_30 . V_261 = 0 ;
return F_147 ( V_89 , V_30 ) ;
}
static int F_155 ( struct V_258 * V_259 )
{
struct V_245 * V_89 = F_154 ( V_259 ) ;
return F_150 ( V_89 ) ;
}
static int F_156 ( struct V_258 * V_259 )
{
struct V_245 * V_89 = F_154 ( V_259 ) ;
struct V_81 * V_72 = F_138 ( V_89 ) ;
struct V_22 * V_23 = F_93 ( V_72 ) ;
...
static int F_159 ( struct V_258 * V_259 )
{
struct V_245 * V_89 = F_154 ( V_259 ) ;
struct V_81 * V_72 = F_138 ( V_89 ) ;
struct V_22 * V_23 = F_93 ( V_72 ) ;
...
static int F_160 ( struct V_245 * V_89 , const struct V_264 * V_265 )
{
return F_161 ( V_89 , V_265 , & V_227 ) ;
}
