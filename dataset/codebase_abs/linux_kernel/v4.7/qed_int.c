...
struct V_199 * V_200 ,
T_1 V_266 , bool V_298 , V_73 V_299 )
{
T_1 V_300 = 0 , V_103 = 0 , V_301 = 0 , V_302 = 0 , V_11 = 0 ;
T_1 V_303 = V_97 + V_266 ;
T_1 V_304 = V_305 ;
F_46 ( V_11 , V_306 , V_298 ? 1 : 0 ) ;
F_46 ( V_11 , V_307 , 0 ) ;
F_46 ( V_11 , V_308 , V_309 ) ;
F_46 ( V_300 , V_310 , V_303 ) ;
F_46 ( V_300 , V_311 , V_299 ) ;
F_46 ( V_300 , V_312 , V_313 ) ;
F_4 ( V_2 , V_200 , V_314 , V_11 ) ;
F_28 () ;
F_4 ( V_2 , V_200 , V_315 , V_300 ) ;
F_12 () ;
V_301 = 1 << ( V_266 % 32 ) ;
V_302 = V_266 / 32 * sizeof( T_1 ) ;
V_302 += V_316 ;
do {
...
struct V_199 * V_200 ,
T_1 V_266 , V_73 V_317 , bool V_318 )
{
int V_192 , V_119 ;
if ( V_318 )
F_71 ( V_2 , V_200 , V_266 , 1 , V_317 ) ;
F_71 ( V_2 , V_200 , V_266 , 0 , V_317 ) ;
...
T_1 V_321 = V_2 -> V_268 . V_269 -> V_321 ;
T_1 V_266 = 0 , V_103 = 0 ;
...
L_66 ,
V_271 , V_271 + V_321 - 1 ) ;
for ( V_266 = V_271 ; V_266 < V_271 + V_321 ; V_266 ++ )
F_73 ( V_2 , V_200 , V_266 ,
V_2 -> V_268 . V_299 ,
V_318 ) ;
if ( ! V_320 )
return;
...
sizeof( T_1 ) * V_266 ) ;
struct V_326 * V_101 ;
V_101 = & V_2 -> V_268 . V_269 -> V_327 . V_328 [ V_266 ] ;
if ( ! F_6 ( V_103 , V_329 ) &&
F_6 ( V_103 , V_330 ) )
goto V_27;
V_101 -> V_331 = V_332 ;
...
struct V_326 * V_342 ;
V_73 V_343 = 0xFF ;
V_2 -> V_268 . V_269 = F_77 ( sizeof( * V_269 ) , V_211 ) ;
if ( ! V_2 -> V_268 . V_269 )
return - V_212 ;
...
for ( V_266 = 0 ; V_266 < F_78 ( V_2 -> V_6 ) ;
V_266 ++ ) {
V_342 = & V_269 -> V_327 . V_328 [ V_266 ] ;
V_103 = F_75 ( V_2 , V_200 , V_266 ) ;
if ( ! F_6 ( V_103 , V_329 ) &&
F_6 ( V_103 , V_330 ) )
break;
if ( V_342 -> V_335 ) {
...
V_342 -> V_331 |= V_351 ;
V_2 -> V_268 . V_269 -> V_352 ++ ;
V_341 = V_266 ;
}
}
}
V_269 -> V_353 = V_269 -> V_352 ;
F_15 (
V_2 ,
V_89 ,
L_72 ,
...
{
V_2 -> V_362 = F_43 ( sizeof( * V_2 -> V_362 ) , V_211 ) ;
if ( ! V_2 -> V_362 )
return - V_212 ;
return 0 ;
}
...
struct V_364 * V_365 )
{
struct V_338 * V_366 = V_2 -> V_268 . V_269 ;
if ( ! V_366 || ! V_365 )
return;
V_365 -> V_367 = V_366 -> V_321 ;
V_365 -> V_368 = V_366 -> V_353 ;
V_365 -> V_369 = V_366 -> V_352 ;
}
V_73 F_90 ( struct V_1 * V_2 , V_73 V_266 )
{
struct V_338 * V_370 = V_2 -> V_268 . V_269 ;
if ( ( V_266 >= V_370 -> V_271 ) &&
( V_266 < V_370 -> V_271 + V_370 -> V_321 ) ) {
return V_266 - V_370 -> V_271 ;
} else if ( ( V_266 >= V_370 -> V_344 ) &&
( V_266 < V_370 -> V_344 + V_370 -> V_353 ) ) {
return V_266 - V_370 -> V_344 + V_370 -> V_321 ;
} else {
F_19 ( V_2 , L_77 , V_266 ) ;
return 0 ;
}
