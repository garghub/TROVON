...
F_17 ( V_1 ) ;
if ( F_45 ( V_62 , & V_63 , sizeof( struct V_61 ) ) )
V_30 = - V_71 ;
F_14 ( & V_15 -> V_46 ) ;
V_5 = F_2 ( V_1 ) ;
V_5 -> V_6 = V_7 ;
...
int F_47 ( struct V_40 * V_41 , struct V_8 * V_9 ,
...
V_1 = F_39 ( V_41 , V_9 , V_15 , V_72 ) ;
if ( V_1 ) {
struct V_4 * V_5 = F_2 ( V_1 ) ;
V_30 = F_41 ( V_15 , V_1 , V_73 ) ;
F_14 ( & V_15 -> V_46 ) ;
V_5 -> V_6 = V_7 ;
V_5 -> V_47 &= ~ ( V_51 | V_50 ) ;
F_46 ( & V_5 -> V_52 ) ;
...
{
int V_3 = 0 ;
if ( V_74 && F_50 ( V_3 , V_74 ) )
return - V_71 ;
return F_47 ( V_41 , V_9 , V_15 , V_3 ) ;
}
