...
F_87 ( V_49 , V_190 , & V_191 ) ;
F_52 (evlist, counter) {
V_192:
if ( F_88 ( V_41 , V_2 -> V_49 -> V_193 ,
V_2 -> V_49 -> V_194 ) < 0 ) {
...
if ( F_92 ( V_49 , V_190 -> V_197 , false ) < 0 ) {
F_91 ( L_72 ,
...
static int F_94 ( struct V_191 * V_198 )
{
if ( ! V_136 . V_12 ) {
if ( V_198 -> V_50 ) {
F_91 ( L_73 ) ;
...
V_2 -> V_49 -> V_194 , false , V_190 -> V_205 ) ;
if ( V_136 . V_206 ) {
V_88 = F_102 ( & V_207 ) ;
if ( V_88 < 0 )
goto V_208;
...
{
struct V_191 * V_198 = V_219 -> V_222 ;
V_198 -> V_50 = ! V_220 ;
V_198 -> V_223 = V_224 ;
if ( V_220 ) {
V_155 . V_221 = false ;
...
static int F_115 ( const char * V_226 , const char * V_222 , void * T_7 V_7 )
{
if ( ! strcmp ( V_226 , L_78 ) )
V_226 = L_79 ;
if ( ! strcmp ( V_226 , L_80 ) ) {
V_155 . V_166 = F_116 ( V_226 , V_222 ) ;
return 0 ;
}
return 0 ;
}
...
int F_118 ( int V_227 , const char * * V_228 , const char * T_8 V_7 )
{
char V_216 [ V_217 ] ;
struct V_1 V_2 = {
. V_86 = 5 ,
...
const struct V_218 V_236 [] = {
F_119 ( 'e' , L_81 , & V_2 . V_49 , L_81 ,
L_82 ,
V_237 ) ,
F_120 ( 'c' , L_83 , & V_190 -> V_231 , L_84 ) ,
F_121 ( 'p' , L_85 , & V_69 -> V_149 , L_85 ,
L_86 ) ,
F_121 ( 't' , L_87 , & V_69 -> V_238 , L_87 ,
L_88 ) ,
F_122 ( 'a' , L_89 , & V_69 -> V_239 ,
L_90 ) ,
F_121 ( 'C' , L_91 , & V_69 -> V_240 , L_91 ,
L_92 ) ,
F_121 ( 'k' , L_93 , & V_155 . V_163 ,
L_94 , L_95 ) ,
F_122 ( 0 , L_96 , & V_155 . V_241 ,
L_97 ) ,
F_122 ( 'K' , L_98 , & V_2 . V_67 ,
L_99 ) ,
F_119 ( 'm' , L_100 , & V_190 -> V_197 , L_101 ,
L_102 ,
V_242 ) ,
...
L_110 ) ,
F_122 ( 0 , L_111 , & V_190 -> V_243 ,
L_112 ) ,
F_122 ( 'i' , L_113 , & V_190 -> V_244 ,
L_114 ) ,
F_121 ( 0 , L_115 , & V_2 . V_245 , L_116 ,
L_117 ) ,
F_122 ( 'z' , L_118 , & V_2 . V_51 , L_119 ) ,
F_124 ( 'F' , L_120 , & V_190 -> V_230 , L_121 ) ,
F_123 ( 'E' , L_122 , & V_2 . V_3 ,
L_123 ) ,
F_122 ( 'U' , L_124 , & V_2 . V_66 ,
L_125 ) ,
F_122 ( 0 , L_126 , & V_2 . V_246 , L_127 ) ,
F_122 ( 0 , L_128 , & V_2 . V_247 , L_129 ) ,
F_125 ( 'v' , L_130 , & V_195 ,
L_131 ) ,
F_121 ( 's' , L_132 , & V_248 , L_133 ,
L_134
L_135 ) ,
F_121 ( 0 , L_136 , & V_249 , L_137 ,
L_138 ) ,
F_122 ( 'n' , L_139 , & V_155 . V_250 ,
L_140 ) ,
F_126 ( 'g' , NULL , & V_191 ,
NULL , L_141 ,
& F_111 ) ,
...
return - V_44 ;
F_131 ( F_115 , & V_2 ) ;
V_227 = F_132 ( V_227 , V_228 , V_236 , V_267 , 0 ) ;
if ( V_227 )
F_133 ( V_267 , V_236 ) ;
if ( ! V_2 . V_49 -> V_85 &&
F_134 ( V_2 . V_49 ) < 0 ) {
...
if ( V_249 ) {
F_6 ( L_201 ) ;
F_135 ( V_267 , V_236 , L_136 , 0 ) ;
F_135 ( NULL , V_236 , L_197 , 0 ) ;
goto V_269;
}
}
V_271 = V_272 ;
...
if ( F_137 ( V_2 . V_49 ) < 0 ) {
if ( V_248 )
F_135 ( V_267 , V_236 , L_202 , 1 ) ;
if ( V_249 )
F_135 ( V_248 ? NULL : V_267 ,
V_236 , L_136 , 0 ) ;
goto V_269;
}
V_268 = F_138 ( V_69 ) ;
