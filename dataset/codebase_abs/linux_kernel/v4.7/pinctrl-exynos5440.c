...
V_110 -> V_121 = V_60 ;
V_111 = F_38 ( & V_86 -> V_17 , sizeof( char ) * V_122 *
V_106 -> V_89 , V_28 ) ;
if ( ! V_111 )
return - V_29 ;
for ( V_60 = 0 ; V_60 < V_106 -> V_89 ; V_60 ++ ) {
snprintf ( V_111 , 6 , L_8 , V_60 ) ;
V_110 = V_109 + V_60 ;
V_110 -> V_8 = V_111 ;
V_111 += V_122 ;
}
...
if ( V_103 )
return V_103 ;
V_107 = F_45 ( & V_86 -> V_17 , V_106 , V_4 ) ;
if ( F_46 ( V_107 ) ) {
F_8 ( & V_86 -> V_17 , L_9 ) ;
return F_47 ( V_107 ) ;
}
