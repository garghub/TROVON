...
struct V_1 * F_15 ( struct V_21 * V_22 ,
...
struct V_1 * V_2 ;
int V_10 ;
V_5 = F_16 ( sizeof( * V_5 ) , V_28 ) ;
if ( ! V_5 )
return F_17 ( - V_29 ) ;
V_27 . V_23 = V_23 ;
V_27 . V_30 = & V_31 ;
V_27 . V_6 = V_6 | V_32 ;
V_27 . V_33 = V_24 ? & V_24 : NULL ;
V_27 . V_34 = V_24 ? 1 : 0 ;
V_5 -> V_12 = V_12 ;
V_5 -> V_14 = V_14 ;
V_5 -> V_20 = V_20 ;
...
struct V_35 * F_20 ( struct V_21 * V_22 ,
const char * V_23 , const char * V_24 , unsigned long V_6 ,
void T_3 * V_12 , T_4 V_14 , T_4 V_20 , T_4 V_16 , T_4 V_19 ,
T_4 V_25 , T_5 * V_11 )
{
struct V_1 * V_2 ;
V_2 = F_15 ( V_22 , V_23 , V_24 , V_6 ,
V_12 , V_14 , V_20 , V_16 , V_19 , V_25 ,
V_11 ) ;
if ( F_21 ( V_2 ) )
return F_22 ( V_2 ) ;
return V_2 -> V_35 ;
