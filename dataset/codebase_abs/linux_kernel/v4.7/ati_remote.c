...
V_30 -> V_118 = V_18 -> V_119 ;
F_51 ( V_18 -> V_4 , & V_30 -> V_120 ) ;
...
int V_121 , V_122 ;
F_54 ( & V_18 -> V_37 ) ;
V_121 = F_55 ( V_4 , V_18 -> V_123 -> V_124 ) ;
V_122 = F_56 ( V_4 , V_121 , F_57 ( V_121 ) ) ;
V_122 = ( V_122 > V_90 ) ? V_90 : V_122 ;
F_58 ( V_18 -> V_23 , V_4 , V_121 , V_18 -> V_57 ,
V_122 , F_39 , V_18 ,
V_18 -> V_123 -> V_125 ) ;
V_18 -> V_23 -> V_126 = V_18 -> V_91 ;
V_18 -> V_23 -> V_127 |= V_128 ;
V_121 = F_59 ( V_4 , V_18 -> V_129 -> V_124 ) ;
V_122 = F_56 ( V_4 , V_121 , F_57 ( V_121 ) ) ;
V_122 = ( V_122 > V_90 ) ? V_90 : V_122 ;
F_58 ( V_18 -> V_40 , V_4 , V_121 , V_18 -> V_92 ,
V_122 , F_18 , V_18 ,
V_18 -> V_129 -> V_125 ) ;
V_18 -> V_40 -> V_126 = V_18 -> V_93 ;
V_18 -> V_40 -> V_127 |= V_128 ;
if ( ( F_22 ( V_18 , 0x8004 , V_130 ) ) ||
( F_22 ( V_18 , 0x8007 , V_131 ) ) ) {
F_9 ( & V_18 -> V_2 -> V_14 ,
L_21 ) ;
return - V_26 ;
}
...
const struct V_132 * V_109 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_133 * V_134 = V_2 -> V_135 ;
struct V_136 * V_123 , * V_129 ;
struct V_137 * type = (struct V_137 * ) V_109 -> V_138 ;
struct V_18 * V_18 ;
struct V_27 * V_27 ;
struct V_29 * V_29 ;
int V_19 = - V_139 ;
if ( V_134 -> V_8 . V_140 != 2 ) {
V_19 ( L_22 , V_25 ) ;
return - V_141 ;
}
V_123 = & V_134 -> V_142 [ 0 ] . V_8 ;
V_129 = & V_134 -> V_142 [ 1 ] . V_8 ;
if ( ! F_61 ( V_123 ) ) {
V_19 ( L_23 , V_25 ) ;
return - V_141 ;
}
if ( F_62 ( V_123 -> V_143 ) == 0 ) {
V_19 ( L_24 , V_25 ) ;
return - V_141 ;
}
...
V_18 -> V_30 = V_29 ;
V_18 -> V_2 = V_2 ;
F_65 ( V_4 , V_18 -> V_119 , sizeof( V_18 -> V_119 ) ) ;
F_66 ( V_18 -> V_108 , V_18 -> V_119 ,
sizeof( V_18 -> V_108 ) ) ;
F_67 ( V_18 -> V_119 , L_25 , sizeof( V_18 -> V_119 ) ) ;
F_67 ( V_18 -> V_108 , L_26 , sizeof( V_18 -> V_108 ) ) ;
snprintf ( V_18 -> V_117 , sizeof( V_18 -> V_117 ) , L_27 ,
V_4 -> V_5 ? : L_28 ,
V_4 -> V_5 && V_4 -> V_6 ? L_29 : L_28 ,
V_4 -> V_6 ? : L_28 ) ;
if ( ! strlen ( V_18 -> V_117 ) )
snprintf ( V_18 -> V_117 , sizeof( V_18 -> V_117 ) ,
V_146 L_30 ,
F_62 ( V_18 -> V_4 -> V_147 . V_148 ) ,
F_62 ( V_18 -> V_4 -> V_147 . V_149 ) ) ;
snprintf ( V_18 -> V_106 , sizeof( V_18 -> V_106 ) ,
L_31 , V_18 -> V_117 ) ;
V_29 -> V_150 = V_151 ;
if ( type ) {
if ( type -> V_152 )
V_29 -> V_150 = type -> V_152 ;
else if ( type -> V_153 )
V_29 -> V_150 = type -> V_153 ( V_2 ) ;
}
F_52 ( V_18 ) ;
F_68 ( & V_18 -> V_20 ) ;
V_19 = F_53 ( V_18 ) ;
...
if ( V_19 )
goto V_154;
V_18 -> V_30 -> V_27 -> V_155 [ V_156 ] = V_77 ;
if ( V_157 ) {
V_27 = F_70 () ;
if ( ! V_27 ) {
V_19 = - V_139 ;
