...
V_13 = V_12 -> V_15 . V_16 -> V_136 ( V_12 , V_2 -> V_18 , V_133 ) ;
if ( V_13 )
goto V_53;
while ( V_134 < V_131 ) {
...
V_13 = V_134 ;
V_137:
V_12 -> V_15 . V_16 -> V_136 ( V_12 , V_2 -> V_18 , 1 ) ;
V_53:
V_12 -> V_15 . V_16 -> V_65 ( V_12 ) ;
V_51:
F_31 ( & V_2 -> V_61 ) ;
...
{
struct V_140 * V_141 = V_48 -> V_49 . V_142 ;
struct V_1 * V_2 = F_36 ( V_48 ) ;
struct V_11 * V_12 ;
int V_143 ;
V_143 = F_73 ( V_141 , L_31 , 0 ) ;
if ( ! F_19 ( V_143 ) ) {
F_22 ( & V_48 -> V_49 , L_32 ) ;
return V_143 ;
}
V_2 -> V_83 = V_143 ;
V_143 = F_73 ( V_141 , L_33 , 0 ) ;
if ( F_19 ( V_143 ) || V_143 == - V_144 ) {
V_2 -> V_46 = V_143 ;
} else {
F_22 ( & V_48 -> V_49 , L_34 ) ;
return V_143 ;
...
struct V_145 V_56 ;
struct V_1 * V_2 ;
struct V_54 * V_146 = NULL ;
struct V_73 * V_49 = & V_48 -> V_49 ;
struct V_11 * V_66 ;
int V_13 ;
F_29 ( V_49 , L_36 ) ;
V_2 = F_78 ( V_49 , sizeof( * V_2 ) , V_147 ) ;
if ( ! V_2 )
return - V_135 ;
F_79 ( V_48 , V_2 ) ;
V_2 -> V_48 = V_48 ;
...
F_43 ( V_2 ) ;
if ( V_2 -> V_162 ) {
memset ( & V_56 , 0 , sizeof( struct V_145 ) ) ;
V_56 . V_163 = 255 ;
V_56 . type = V_164 ;
V_146 = F_87 ( F_88 ( V_49 ) ,
V_49 , V_2 , & V_165 , & V_56 ) ;
if ( F_75 ( V_146 ) ) {
V_13 = F_76 ( V_146 ) ;
goto V_166;
...
V_2 -> V_146 = V_146 ;
V_146 -> V_56 . V_57 = V_58 ;
V_146 -> V_56 . V_59 = V_58 ;
V_146 -> V_56 . V_60 = 255 ;
F_27 ( V_146 ) ;
}
V_13 = F_89 ( & V_49 -> V_167 , & V_168 ) ;
if ( V_13 ) {
F_22 ( V_49 , L_47 ) ;
goto V_169;
}
...
F_55 ( V_66 ) ;
F_52 ( V_66 ) ;
F_94 ( & V_48 -> V_49 . V_167 , & V_168 ) ;
V_146 = V_2 -> V_146 ;
if ( V_146 != NULL ) {
V_146 -> V_56 . V_59 = V_170 ;
F_27 ( V_146 ) ;
F_90 ( V_146 ) ;
}
F_95 ( V_2 -> V_12 ) ;
