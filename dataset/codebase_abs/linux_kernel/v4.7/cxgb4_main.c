...
if ( V_54 < 0 )
return V_54 ;
V_54 = F_425 ( V_13 , V_13 -> V_27 , V_13 -> V_27 , V_760 , & V_35 ) ;
if ( V_54 < 0 ) {
F_11 ( V_13 -> V_30 , L_64 ,
V_54 ) ;
return V_54 ;
...
if ( V_54 == V_13 -> V_27 )
V_13 -> V_68 |= V_169 ;
F_426 ( V_13 , & V_13 -> V_223 . V_546 ) ;
F_427 ( V_13 , & V_13 -> V_223 . V_761 ) ;
F_428 ( V_13 , & V_13 -> V_223 . V_762 ) ;
F_429 ( V_13 , & V_13 -> V_223 . V_763 ) ;
V_54 = F_430 ( V_13 ) ;
if ( V_54 )
V_35 = V_764 ;
if ( ( V_13 -> V_68 & V_169 ) && V_35 != V_765 ) {
struct V_756 * V_756 ;
struct V_766 * V_767 ;
const struct V_717 * V_768 ;
const T_3 * V_769 = NULL ;
unsigned int V_770 = 0 ;
...
V_767 = F_125 ( sizeof( * V_767 ) ) ;
V_54 = F_414 ( & V_768 , V_756 -> V_771 ,
V_13 -> V_30 ) ;
if ( V_54 < 0 ) {
F_11 ( V_13 -> V_30 ,
L_66 ,
...
V_54 = F_431 ( V_13 , V_756 , V_769 , V_770 , V_767 ,
V_35 , & V_725 ) ;
F_410 ( V_768 ) ;
F_127 ( V_767 ) ;
if ( V_54 < 0 )
...
V_54 = F_432 ( V_13 , & V_13 -> V_223 . V_532 ) ;
if ( V_54 < 0 )
goto V_739;
V_165 =
F_7 ( V_747 ) |
...
if ( V_54 < 0 )
goto V_739;
V_13 -> V_223 . V_224 = F_433 ( V_758 ) ;
V_13 -> V_223 . V_773 = V_758 ;
if ( V_35 == V_765 ) {
...
V_13 -> V_16 . V_118 = F_437 ( V_13 -> V_16 . V_216 ,
sizeof( * V_13 -> V_16 . V_118 ) , V_195 ) ;
if ( ! V_13 -> V_16 . V_118 ) {
V_54 = - V_61 ;
goto V_739;
}
V_13 -> V_16 . V_203 = F_437 ( V_13 -> V_16 . V_204 ,
sizeof( * V_13 -> V_16 . V_203 ) , V_195 ) ;
if ( ! V_13 -> V_16 . V_203 ) {
V_54 = - V_61 ;
goto V_739;
}
V_13 -> V_16 . V_215 = F_437 ( F_221 ( V_13 -> V_16 . V_216 ) ,
sizeof( long ) , V_195 ) ;
if ( ! V_13 -> V_16 . V_215 ) {
V_54 = - V_61 ;
goto V_739;
}
V_13 -> V_16 . V_217 = F_437 ( F_221 ( V_13 -> V_16 . V_216 ) ,
sizeof( long ) , V_195 ) ;
if ( ! V_13 -> V_16 . V_217 ) {
V_54 = - V_61 ;
goto V_739;
...
#ifdef F_194
V_13 -> V_16 . V_785 = F_437 ( F_221 ( V_13 -> V_16 . V_216 ) ,
sizeof( long ) , V_195 ) ;
if ( ! V_13 -> V_16 . V_785 ) {
V_54 = - V_61 ;
goto V_739;
...
V_13 -> V_68 |= V_555 ;
V_13 -> V_91 . V_792 = V_268 [ 0 ] ;
V_13 -> V_91 . V_793 = V_268 [ 1 ] ;
}
V_223 [ 0 ] = F_436 ( V_794 ) ;
V_268 [ 0 ] = 1 ;
...
V_13 -> V_91 . V_370 = F_438 ( V_13 -> V_91 . V_365 / 2 , V_803 ) ;
V_13 -> V_91 . V_346 = V_268 [ 1 ] ;
V_13 -> V_91 . V_344 = V_268 [ 2 ] - V_268 [ 1 ] + 1 ;
if ( V_13 -> V_68 & V_555 && ! F_439 ( V_13 ) ) {
V_13 -> V_91 . V_348 = V_13 -> V_91 . V_92 +
F_440 ( V_13 -> V_91 . V_93 , 3 ) ;
V_13 -> V_91 . V_94 = V_13 -> V_91 . V_93 -
F_440 ( V_13 -> V_91 . V_93 , 3 ) ;
V_13 -> V_91 . V_93 = V_13 -> V_91 . V_348 -
V_13 -> V_91 . V_92 ;
}
V_13 -> V_449 . V_804 . V_450 = V_268 [ 3 ] ;
V_13 -> V_449 . V_804 . V_214 = V_268 [ 4 ] - V_268 [ 3 ] + 1 ;
...
V_13 -> V_449 . V_813 . V_450 = V_268 [ 2 ] ;
V_13 -> V_449 . V_813 . V_214 = V_268 [ 3 ] - V_268 [ 2 ] + 1 ;
V_13 -> V_449 . V_814 . V_450 = V_268 [ 4 ] ;
V_13 -> V_449 . V_814 . V_214 = V_268 [ 5 ] - V_268 [ 4 ] + 1 ;
V_223 [ 0 ] = F_436 ( V_815 ) ;
V_223 [ 1 ] = F_436 ( V_816 ) ;
V_223 [ 2 ] = F_436 ( V_817 ) ;
V_223 [ 3 ] = F_436 ( V_818 ) ;
...
if ( V_54 < 0 )
goto V_739;
V_13 -> V_449 . V_821 . V_450 = V_268 [ 0 ] ;
V_13 -> V_449 . V_821 . V_214 = V_268 [ 1 ] - V_268 [ 0 ] + 1 ;
V_13 -> V_449 . V_822 . V_450 = V_268 [ 2 ] ;
V_13 -> V_449 . V_822 . V_214 = V_268 [ 3 ] - V_268 [ 2 ] + 1 ;
...
if ( V_54 < 0 )
goto V_739;
V_13 -> V_449 . V_828 . V_450 = V_268 [ 0 ] ;
V_13 -> V_449 . V_828 . V_214 = V_268 [ 1 ] - V_268 [ 0 ] + 1 ;
}
#undef F_436
#undef F_435
F_441 ( V_13 , V_13 -> V_223 . V_398 , NULL ) ;
if ( V_35 != V_765 ) {
int V_19 ;
...
F_442 ( V_13 , V_13 -> V_223 . V_398 , V_13 -> V_223 . V_829 ,
V_13 -> V_223 . V_830 ) ;
}
F_443 ( V_13 ) ;
V_13 -> V_68 |= V_831 ;
...
#ifdef F_194
F_34 ( V_13 -> V_16 . V_785 ) ;
#endif
if ( V_54 != - V_832 && V_54 != - V_833 )
F_445 ( V_13 , V_13 -> V_27 ) ;
return V_54 ;
}
static T_15 F_446 ( struct V_417 * V_162 ,
T_16 V_35 )
{
int V_19 ;
struct V_12 * V_13 = F_249 ( V_162 ) ;
...
V_59: return V_35 == V_836 ?
V_837 : V_838 ;
}
static T_15 F_451 ( struct V_417 * V_162 )
{
int V_19 , V_54 ;
struct V_680 V_681 ;
struct V_12 * V_13 = F_249 ( V_162 ) ;
...
F_453 ( V_162 ) ;
F_456 ( V_162 ) ;
if ( F_457 ( V_13 -> V_544 ) < 0 )
return V_837 ;
if ( F_425 ( V_13 , V_13 -> V_27 , V_13 -> V_28 , V_840 , NULL ) < 0 )
return V_837 ;
V_13 -> V_68 |= V_831 ;
if ( F_380 ( V_13 , & V_681 ) )
return V_837 ;
...
V_54 = F_458 ( V_13 , V_13 -> V_27 , V_6 -> V_76 , V_13 -> V_28 , 0 , 1 ,
NULL , NULL ) ;
if ( V_54 < 0 )
return V_837 ;
V_6 -> V_51 = V_54 ;
...
static void F_459 ( struct V_417 * V_162 )
{
int V_19 ;
struct V_12 * V_13 = F_249 ( V_162 ) ;
if ( ! V_13 )
...
static inline bool F_461 ( const struct V_841 * V_842 )
{
return ( V_842 -> V_843 & V_844 ) != 0 ||
( V_842 -> V_843 & V_845 ) != 0 ;
}
static inline void F_462 ( struct V_12 * V_13 , struct V_104 * V_25 ,
unsigned int V_323 , unsigned int V_324 ,
unsigned int V_214 , unsigned int V_846 )
{
V_25 -> V_13 = V_13 ;
...
static void F_463 ( struct V_12 * V_13 )
{
struct V_16 * V_4 = & V_13 -> V_16 ;
int V_19 , V_848 = 0 , V_849 = 0 ;
#ifndef F_13
int V_850 = 0 ;
#endif
int V_851 ;
F_82 (adap, i)
V_848 += F_461 ( & F_97 ( V_13 , V_19 ) -> V_7 ) ;
#ifdef F_13
if ( V_13 -> V_223 . V_224 * 8 > V_852 ) {
F_11 ( V_13 -> V_30 , L_82 ,
V_852 , V_13 -> V_223 . V_224 * 8 ) ;
F_464 ( 1 ) ;
}
F_82 (adap, i) {
...
#else
if ( V_848 )
V_850 = ( V_852 - ( V_13 -> V_223 . V_224 - V_848 ) ) / V_848 ;
if ( V_850 > F_465 () )
V_850 = F_465 () ;
F_82 (adap, i) {
struct V_5 * V_11 = F_97 ( V_13 , V_19 ) ;
V_11 -> V_18 = V_849 ;
V_11 -> V_20 = F_461 ( & V_11 -> V_7 ) ? V_850 : 1 ;
V_849 += V_11 -> V_20 ;
}
#endif
V_4 -> V_853 = V_849 ;
...
if ( F_390 ( V_13 ) ) {
if ( V_848 ) {
V_19 = F_466 ( int , F_20 ( V_4 -> V_187 ) ,
F_467 () ) ;
V_4 -> V_222 = F_468 ( V_19 , V_13 -> V_223 . V_224 ) ;
} else
V_4 -> V_222 = V_13 -> V_223 . V_224 ;
V_4 -> V_228 = V_13 -> V_223 . V_224 ;
V_4 -> V_230 = F_466 ( int , V_855 , F_467 () ) ;
V_4 -> V_230 = ( V_4 -> V_230 / V_13 -> V_223 . V_224 ) *
V_13 -> V_223 . V_224 ;
V_4 -> V_230 = F_469 ( int , V_4 -> V_230 , V_13 -> V_223 . V_224 ) ;
if ( ! F_122 ( V_13 -> V_223 . V_233 ) )
V_4 -> V_226 = V_4 -> V_222 ;
}
for ( V_19 = 0 ; V_19 < F_20 ( V_4 -> V_185 ) ; V_19 ++ ) {
struct V_193 * V_856 = & V_4 -> V_185 [ V_19 ] ;
F_462 ( V_13 , & V_856 -> V_151 , 5 , 10 , 1024 , 64 ) ;
V_856 -> V_213 . V_214 = 72 ;
}
...
struct V_149 * V_856 = & V_4 -> V_187 [ V_19 ] ;
F_462 ( V_13 , & V_856 -> V_151 , 5 , 1 , 1024 , 64 ) ;
V_856 -> V_151 . V_146 = V_517 ;
V_856 -> V_213 . V_214 = 72 ;
}
if ( ! F_122 ( V_13 -> V_223 . V_233 ) ) {
for ( V_19 = 0 ; V_19 < F_20 ( V_4 -> V_188 ) ; V_19 ++ ) {
struct V_149 * V_856 = & V_4 -> V_188 [ V_19 ] ;
F_462 ( V_13 , & V_856 -> V_151 , 5 , 1 , 1024 , 64 ) ;
V_856 -> V_151 . V_146 = V_518 ;
V_856 -> V_213 . V_214 = 72 ;
}
}
for ( V_19 = 0 ; V_19 < F_20 ( V_4 -> V_189 ) ; V_19 ++ ) {
struct V_149 * V_856 = & V_4 -> V_189 [ V_19 ] ;
F_462 ( V_13 , & V_856 -> V_151 , 5 , 1 , 511 , 64 ) ;
V_856 -> V_151 . V_146 = V_489 ;
V_856 -> V_213 . V_214 = 72 ;
}
V_851 = 64 + V_13 -> V_449 . V_822 . V_214 + V_13 -> V_91 . V_93 ;
if ( V_851 > V_857 ) {
F_299 ( V_13 , L_83 ) ;
V_851 = V_857 ;
}
for ( V_19 = 0 ; V_19 < F_20 ( V_4 -> V_190 ) ; V_19 ++ ) {
struct V_149 * V_856 = & V_4 -> V_190 [ V_19 ] ;
F_462 ( V_13 , & V_856 -> V_151 , 5 , 1 , V_851 , 64 ) ;
V_856 -> V_151 . V_146 = V_489 ;
}
F_462 ( V_13 , & V_4 -> V_184 , 0 , 1 , 1024 , 64 ) ;
F_462 ( V_13 , & V_4 -> V_218 , 0 , 1 , 2 * V_691 , 64 ) ;
}
static void F_470 ( struct V_12 * V_13 , int V_173 )
{
int V_19 ;
struct V_5 * V_11 ;
while ( V_173 < V_13 -> V_16 . V_853 )
F_82 (adap, i) {
V_11 = F_97 ( V_13 , V_19 ) ;
if ( V_11 -> V_20 > 1 ) {
V_11 -> V_20 -- ;
V_13 -> V_16 . V_853 -- ;
if ( V_13 -> V_16 . V_853 <= V_173 )
break;
}
}
V_173 = 0 ;
...
{
int V_858 = 0 ;
int V_19 , V_859 , V_860 , V_861 ;
struct V_16 * V_4 = & V_13 -> V_16 ;
unsigned int V_520 = V_13 -> V_223 . V_224 ;
struct V_862 * V_863 ;
V_863 = F_93 ( sizeof( * V_863 ) * ( V_691 + 1 ) ,
V_195 ) ;
if ( ! V_863 )
return - V_61 ;
for ( V_19 = 0 ; V_19 < V_691 + 1 ; ++ V_19 )
V_863 [ V_19 ] . V_49 = V_19 ;
V_859 = V_4 -> V_854 + V_864 ;
if ( F_390 ( V_13 ) ) {
V_859 += V_4 -> V_228 + V_4 -> V_230 + V_4 -> V_222 +
V_4 -> V_226 ;
if ( F_122 ( V_13 -> V_223 . V_233 ) )
V_858 = 3 * V_520 ;
else
...
#ifdef F_13
V_860 = 8 * V_13 -> V_223 . V_224 + V_864 + V_858 ;
#else
V_860 = V_13 -> V_223 . V_224 + V_864 + V_858 ;
#endif
V_861 = F_472 ( V_13 -> V_162 , V_863 , V_860 , V_859 ) ;
if ( V_861 < 0 ) {
...
V_19 = V_861 - V_864 - V_4 -> V_854 -
V_4 -> V_228 - V_4 -> V_230 - V_4 -> V_226 ;
V_4 -> V_222 = ( V_19 / V_520 ) * V_520 ;
}
for ( V_19 = 0 ; V_19 < V_861 ; ++ V_19 )
V_13 -> V_174 [ V_19 ] . V_46 = V_863 [ V_19 ] . V_865 ;
F_409 ( V_13 -> V_30 , L_86
L_87 ,
V_861 , V_4 -> V_854 , V_4 -> V_222 , V_4 -> V_228 ,
V_4 -> V_230 ) ;
F_34 ( V_863 ) ;
return 0 ;
}
...
unsigned int V_19 ;
int V_22 ;
V_22 = F_474 ( V_13 , V_13 -> V_27 ) ;
if ( V_22 )
return V_22 ;
F_82 (adap, i) {
struct V_5 * V_11 = F_97 ( V_13 , V_19 ) ;
V_11 -> V_192 = F_437 ( V_11 -> V_194 , sizeof( T_6 ) , V_195 ) ;
if ( ! V_11 -> V_192 )
return - V_61 ;
}
return 0 ;
}
static int F_475 ( struct V_12 * V_13 ,
enum V_866 * V_8 ,
enum V_867 * V_868 )
{
T_1 V_869 , V_870 ;
...
* V_8 = V_873 ;
* V_868 = V_874 ;
V_871 = F_477 ( V_13 -> V_162 , V_875 ,
& V_869 ) ;
V_872 = F_477 ( V_13 -> V_162 , V_876 ,
& V_870 ) ;
if ( ! V_872 && V_870 ) {
if ( V_870 & V_877 )
* V_8 = V_878 ;
...
if ( * V_8 == V_873 || * V_868 == V_874 )
return V_871 ? V_871 : V_872 ? V_872 : - V_65 ;
return 0 ;
}
static void F_478 ( struct V_12 * V_13 )
{
enum V_867 V_868 , V_886 ;
enum V_866 V_8 , V_887 ;
#define F_479 ( V_8 ) \
(speed == PCIE_SPEED_8_0GT ? "8.0GT/s" : \
speed == PCIE_SPEED_5_0GT ? "5.0GT/s" : \
speed == PCIE_SPEED_2_5GT ? "2.5GT/s" : \
"Unknown")
if ( F_475 ( V_13 , & V_887 , & V_886 ) ) {
F_310 ( V_13 -> V_30 ,
L_88 ) ;
return;
}
if ( F_480 ( V_13 -> V_162 , & V_8 , & V_868 ) ||
V_8 == V_873 || V_868 == V_874 ) {
F_310 ( V_13 -> V_30 ,
L_89 ) ;
return;
}
F_409 ( V_13 -> V_30 , L_90 ,
F_479 ( V_8 ) , F_479 ( V_887 ) ) ;
F_409 ( V_13 -> V_30 , L_91 ,
V_868 , V_886 ) ;
if ( V_8 < V_887 || V_868 < V_886 )
F_409 ( V_13 -> V_30 ,
L_92
L_93 ) ;
}
static void F_481 ( struct V_12 * V_12 )
{
F_409 ( V_12 -> V_30 , L_94 ,
V_12 -> V_223 . V_532 . V_888 ,
F_482 ( V_12 -> V_223 . V_233 ) ) ;
F_409 ( V_12 -> V_30 , L_95 ,
V_12 -> V_223 . V_532 . V_889 , V_12 -> V_223 . V_532 . V_890 ) ;
if ( ! V_12 -> V_223 . V_546 )
F_310 ( V_12 -> V_30 , L_96 ) ;
else
F_409 ( V_12 -> V_30 , L_97 ,
F_483 ( V_12 -> V_223 . V_546 ) ,
F_484 ( V_12 -> V_223 . V_546 ) ,
F_485 ( V_12 -> V_223 . V_546 ) ,
F_486 ( V_12 -> V_223 . V_546 ) ) ;
if ( ! V_12 -> V_223 . V_761 )
F_409 ( V_12 -> V_30 , L_98 ) ;
else
F_409 ( V_12 -> V_30 , L_99 ,
F_483 ( V_12 -> V_223 . V_761 ) ,
F_484 ( V_12 -> V_223 . V_761 ) ,
F_485 ( V_12 -> V_223 . V_761 ) ,
F_486 ( V_12 -> V_223 . V_761 ) ) ;
if ( ! V_12 -> V_223 . V_762 )
F_310 ( V_12 -> V_30 , L_100 ) ;
else
F_409 ( V_12 -> V_30 ,
L_101 ,
F_483 ( V_12 -> V_223 . V_762 ) ,
F_484 ( V_12 -> V_223 . V_762 ) ,
F_485 ( V_12 -> V_223 . V_762 ) ,
...
F_409 ( V_12 -> V_30 ,
L_103 ,
F_483 ( V_12 -> V_223 . V_763 ) ,
F_484 ( V_12 -> V_223 . V_763 ) ,
F_485 ( V_12 -> V_223 . V_763 ) ,
...
static void F_487 ( const struct V_1 * V_2 )
{
char V_752 [ 80 ] ;
char * V_891 = V_752 ;
const char * V_892 = L_106 ;
const struct V_5 * V_11 = F_4 ( V_2 ) ;
const struct V_12 * V_13 = V_11 -> V_12 ;
if ( V_13 -> V_223 . V_893 . V_8 == V_894 )
V_892 = L_111 ;
else if ( V_13 -> V_223 . V_893 . V_8 == V_895 )
V_892 = L_112 ;
else if ( V_13 -> V_223 . V_893 . V_8 == V_896 )
V_892 = L_113 ;
if ( V_11 -> V_7 . V_843 & V_897 )
V_891 += sprintf ( V_891 , L_114 ) ;
if ( V_11 -> V_7 . V_843 & V_898 )
V_891 += sprintf ( V_891 , L_115 ) ;
if ( V_11 -> V_7 . V_843 & V_844 )
V_891 += sprintf ( V_891 , L_116 ) ;
if ( V_11 -> V_7 . V_843 & V_845 )
V_891 += sprintf ( V_891 , L_117 ) ;
if ( V_891 != V_752 )
-- V_891 ;
sprintf ( V_891 , L_118 , F_488 ( V_11 -> V_899 ) ) ;
F_3 ( V_2 , L_119 ,
V_2 -> V_9 , V_13 -> V_223 . V_532 . V_888 , V_13 -> V_9 , V_752 ) ;
}
static void F_489 ( struct V_417 * V_2 )
{
F_490 ( V_2 , V_900 , V_901 ) ;
}
static void F_491 ( struct V_12 * V_12 )
{
unsigned int V_19 ;
F_127 ( V_12 -> V_86 ) ;
...
if ( V_11 -> V_51 != 0 )
F_492 ( V_12 , V_12 -> V_27 , V_12 -> V_28 ,
0 , V_11 -> V_51 ) ;
F_34 ( F_97 ( V_12 , V_19 ) -> V_192 ) ;
F_493 ( V_12 -> V_39 [ V_19 ] ) ;
}
if ( V_12 -> V_68 & V_831 )
F_445 ( V_12 , V_12 -> V_28 ) ;
}
static int F_494 ( struct V_417 * V_162 , T_1 V_902 )
{
T_6 V_903 ;
F_495 ( V_162 , V_904 , & V_903 ) ;
switch ( V_903 >> 12 ) {
case V_740 :
return F_496 ( V_740 , V_902 ) ;
case V_372 :
return F_496 ( V_372 , V_902 ) ;
case V_743 :
return F_496 ( V_743 , V_902 ) ;
default:
F_11 ( & V_162 -> V_2 , L_55 ,
V_903 ) ;
}
...
static int F_497 ( struct V_417 * V_162 , const struct V_905 * V_906 )
{
int V_907 , V_19 , V_22 , V_908 , V_909 , V_910 ;
struct V_5 * V_11 ;
bool V_911 = false ;
...
T_1 V_912 , V_902 ;
enum V_409 V_233 ;
F_498 ( V_913 L_120 , V_914 , V_915 ) ;
V_22 = F_499 ( V_162 , V_916 ) ;
if ( V_22 ) {
F_409 ( & V_162 -> V_2 , L_121 ) ;
return V_22 ;
}
V_22 = F_454 ( V_162 ) ;
if ( V_22 ) {
...
if ( V_22 < 0 )
goto V_919;
V_912 = F_501 ( V_544 + V_920 ) ;
V_902 = F_502 ( F_501 ( V_544 + V_921 ) ) ;
V_233 = F_494 ( V_162 , V_902 ) ;
V_907 = F_224 ( V_233 ) <= V_372 ?
F_503 ( V_912 ) : F_504 ( V_912 ) ;
if ( V_907 != V_906 -> V_922 ) {
F_505 ( V_544 ) ;
F_450 ( V_162 ) ;
F_453 ( V_162 ) ;
goto V_923;
}
if ( ! F_506 ( V_162 , F_507 ( 64 ) ) ) {
V_911 = true ;
V_22 = F_508 ( V_162 , F_507 ( 64 ) ) ;
if ( V_22 ) {
F_11 ( & V_162 -> V_2 , L_124
L_125 ) ;
goto V_919;
}
} else {
V_22 = F_506 ( V_162 , F_507 ( 32 ) ) ;
if ( V_22 ) {
F_11 ( & V_162 -> V_2 , L_126 ) ;
goto V_919;
}
}
F_509 ( V_162 ) ;
...
V_12 -> V_361 = F_510 ( L_127 ) ;
if ( ! V_12 -> V_361 ) {
V_22 = - V_61 ;
goto V_924;
}
V_12 -> V_925 = F_27 ( sizeof( * V_12 -> V_925 ) +
( sizeof( struct V_926 ) *
V_927 ) ,
V_195 ) ;
if ( ! V_12 -> V_925 ) {
...
V_12 -> V_925 -> V_214 = V_927 ;
V_12 -> V_68 |= V_835 ;
V_12 -> V_544 = V_544 ;
V_12 -> V_162 = V_162 ;
V_12 -> V_30 = & V_162 -> V_2 ;
V_12 -> V_9 = F_511 ( V_162 ) ;
V_12 -> V_27 = V_907 ;
V_12 -> V_28 = V_907 ;
V_12 -> V_928 = V_929 ;
...
F_222 ( & V_12 -> V_357 ) ;
F_222 ( & V_12 -> V_430 ) ;
F_512 ( & V_12 -> V_362 , F_215 ) ;
F_512 ( & V_12 -> V_490 , F_296 ) ;
F_512 ( & V_12 -> V_497 , F_301 ) ;
V_22 = F_513 ( V_12 ) ;
if ( V_22 )
goto V_924;
...
V_12 -> V_503 = F_515 ( F_516 ( V_162 , 2 ) ,
F_517 ( V_162 , 2 ) ) ;
if ( ! V_12 -> V_503 ) {
F_11 ( & V_162 -> V_2 , L_129 ) ;
V_22 = - V_61 ;
goto V_924;
}
}
...
V_22 = F_423 ( V_12 ) ;
#ifdef F_194
F_114 ( V_12 -> V_16 . V_785 , V_12 -> V_16 . V_216 ) ;
#endif
F_372 ( V_12 ) ;
if ( V_22 )
goto V_934;
if ( ! F_122 ( V_12 -> V_223 . V_233 ) )
F_79 ( V_12 , V_935 , F_518 ( 7 ) |
( F_271 ( V_12 -> V_223 . V_233 ) ? F_519 ( 0 ) :
F_520 ( 0 ) ) ) ;
F_82 (adapter, i) {
struct V_1 * V_52 ;
V_52 = F_521 ( sizeof( struct V_5 ) ,
V_852 ) ;
if ( ! V_52 ) {
V_22 = - V_61 ;
goto V_936;
}
F_522 ( V_52 , & V_162 -> V_2 ) ;
V_12 -> V_39 [ V_19 ] = V_52 ;
V_11 = F_4 ( V_52 ) ;
V_11 -> V_12 = V_12 ;
V_11 -> V_74 = - 1 ;
...
V_52 -> V_937 = V_938 | V_939 |
V_940 | V_941 |
V_942 | V_943 |
V_944 | V_73 ;
if ( V_911 )
V_52 -> V_937 |= V_945 ;
V_52 -> V_72 |= V_52 -> V_937 ;
V_52 -> V_946 = V_52 -> V_72 & V_947 ;
V_52 -> V_474 |= V_948 ;
V_52 -> V_949 = & V_950 ;
#ifdef F_13
V_52 -> V_951 = & V_952 ;
...
F_524 ( V_162 , V_12 ) ;
if ( V_12 -> V_68 & V_831 ) {
V_22 = F_525 ( V_12 , V_907 , V_907 , 0 ) ;
if ( V_22 )
goto V_936;
} else if ( V_12 -> V_223 . V_224 == 1 ) {
T_3 V_953 [ V_954 ] ;
T_3 * V_955 = V_12 -> V_223 . V_532 . V_955 ;
V_22 = F_526 ( V_12 , & V_12 -> V_223 . V_532 ) ;
if ( ! V_22 ) {
for ( V_19 = 0 ; V_19 < V_954 ; V_19 ++ )
V_953 [ V_19 ] = ( F_527 ( V_955 [ 2 * V_19 + 0 ] ) * 16 +
F_527 ( V_955 [ 2 * V_19 + 1 ] ) ) ;
F_528 ( V_12 , 0 , V_953 ) ;
}
}
F_463 ( V_12 ) ;
V_12 -> V_86 = F_529 ( V_12 -> V_781 , V_12 -> V_782 ) ;
if ( ! V_12 -> V_86 ) {
F_310 ( & V_162 -> V_2 , L_130 ) ;
V_12 -> V_223 . V_805 = 0 ;
}
#if F_326 ( V_591 )
if ( ( F_224 ( V_12 -> V_223 . V_233 ) <= V_372 ) &&
( ! ( F_77 ( V_12 , V_956 ) & V_957 ) ) ) {
F_310 ( & V_162 -> V_2 ,
L_131 ) ;
V_12 -> V_223 . V_805 = 0 ;
} else {
V_12 -> V_958 = F_530 ( V_12 -> V_788 ,
V_12 -> V_789 ) ;
if ( ! V_12 -> V_958 ) {
F_310 ( & V_162 -> V_2 ,
L_132 ) ;
...
F_310 ( & V_162 -> V_2 , L_133
L_134 ) ;
V_12 -> V_223 . V_805 = 0 ;
}
if ( F_390 ( V_12 ) ) {
if ( F_77 ( V_12 , V_956 ) & V_959 ) {
T_1 V_366 , V_960 ;
if ( V_233 <= V_372 ) {
V_960 = V_961 ;
V_366 = F_77 ( V_12 , V_960 ) ;
...
if ( V_963 > 1 && F_471 ( V_12 ) == 0 )
V_12 -> V_68 |= V_161 ;
else if ( V_963 > 0 && F_531 ( V_162 ) == 0 )
V_12 -> V_68 |= V_163 ;
F_478 ( V_12 ) ;
V_22 = F_473 ( V_12 ) ;
if ( V_22 )
...
F_82 (adapter, i) {
V_11 = F_97 ( V_12 , V_19 ) ;
F_532 ( V_12 -> V_39 [ V_19 ] , V_11 -> V_20 ) ;
F_533 ( V_12 -> V_39 [ V_19 ] , V_11 -> V_20 ) ;
V_22 = F_534 ( V_12 -> V_39 [ V_19 ] ) ;
if ( V_22 )
break;
V_12 -> V_81 [ V_11 -> V_76 ] = V_19 ;
F_487 ( V_12 -> V_39 [ V_19 ] ) ;
}
if ( V_19 == 0 ) {
F_11 ( & V_162 -> V_2 , L_135 ) ;
goto V_936;
}
if ( V_22 ) {
F_310 ( & V_162 -> V_2 , L_136 , V_19 ) ;
V_22 = 0 ;
}
if ( V_964 ) {
V_12 -> V_329 = F_535 ( F_511 ( V_162 ) ,
V_964 ) ;
F_192 ( V_12 ) ;
}
V_162 -> V_965 = 1 ;
...
V_923:
#ifdef F_536
if ( V_907 < F_20 ( V_966 ) && V_966 [ V_907 ] > 0 )
if ( F_537 ( V_162 , V_966 [ V_907 ] ) == 0 )
F_409 ( & V_162 -> V_2 ,
L_137 ,
V_966 [ V_907 ] ) ;
#endif
...
static void F_541 ( struct V_417 * V_162 )
{
...
F_104 ( V_12 ) ;
F_82 (adapter, i)
if ( V_12 -> V_39 [ V_19 ] -> V_967 == V_968 )
F_543 ( V_12 -> V_39 [ V_19 ] ) ;
F_544 ( V_12 -> V_329 ) ;
if ( V_12 -> V_91 . V_96 ) {
...
static int T_18 F_547 ( void )
{
int V_54 ;
V_964 = F_535 ( V_916 , NULL ) ;
if ( ! V_964 )
F_548 ( L_138 ) ;
V_54 = F_549 ( & V_477 ) ;
if ( V_54 < 0 )
