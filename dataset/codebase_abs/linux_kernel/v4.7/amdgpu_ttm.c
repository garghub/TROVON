...
static void F_98 ( struct V_61 * V_75 )
{
struct V_1 * V_6 = F_1 ( V_75 -> V_3 ) ;
unsigned V_166 , V_192 ;
for ( V_166 = 0 ; V_166 < V_193 ; ++ V_166 ) {
struct V_194 * V_195 = & V_6 -> V_5 . V_196 [ V_166 ] ;
for ( V_192 = 0 ; V_192 < V_197 ; ++ V_192 )
if ( & V_75 -> V_195 == V_195 -> V_195 [ V_192 ] )
V_195 -> V_195 [ V_192 ] = V_75 -> V_195 . V_198 ;
if ( & V_75 -> V_199 == V_195 -> V_200 )
V_195 -> V_200 = V_75 -> V_199 . V_198 ;
}
}
static struct V_194 * F_99 ( struct V_61 * V_75 )
{
struct V_1 * V_6 = F_1 ( V_75 -> V_3 ) ;
unsigned V_196 = F_100 ( F_101 ( V_75 -> V_100 ) ,
V_193 - 1 ) ;
return & V_6 -> V_5 . V_196 [ V_196 ] ;
}
static struct V_201 * F_102 ( struct V_61 * V_75 )
{
struct V_194 * V_195 = F_99 ( V_75 ) ;
struct V_201 * V_202 = V_195 -> V_195 [ V_75 -> V_76 . V_77 ] ;
V_195 -> V_195 [ V_75 -> V_76 . V_77 ] = & V_75 -> V_195 ;
return V_202 ;
}
static struct V_201 * F_103 ( struct V_61 * V_75 )
{
struct V_194 * V_195 = F_99 ( V_75 ) ;
struct V_201 * V_202 = V_195 -> V_200 ;
V_195 -> V_200 = & V_75 -> V_199 ;
return V_202 ;
}
int F_104 ( struct V_1 * V_6 )
{
unsigned V_166 , V_192 ;
int V_15 ;
V_15 = F_7 ( V_6 ) ;
...
V_15 = F_105 ( & V_6 -> V_5 . V_3 ,
V_6 -> V_5 . V_24 . V_8 . V_9 ,
& V_203 ,
V_6 -> V_118 -> V_204 -> V_205 ,
V_206 ,
V_6 -> V_207 ) ;
if ( V_15 ) {
F_9 ( L_11 , V_15 ) ;
...
struct V_194 * V_195 = & V_6 -> V_5 . V_196 [ V_166 ] ;
for ( V_192 = 0 ; V_192 < V_197 ; ++ V_192 )
V_195 -> V_195 [ V_192 ] = & V_6 -> V_5 . V_3 . V_38 [ V_192 ] . V_195 ;
V_195 -> V_200 = & V_6 -> V_5 . V_3 . V_208 -> V_200 ;
}
V_6 -> V_5 . V_209 = true ;
V_15 = F_106 ( & V_6 -> V_5 . V_3 , V_52 ,
V_6 -> V_49 . V_210 >> V_97 ) ;
if ( V_15 ) {
F_9 ( L_12 ) ;
return V_15 ;
}
F_107 ( V_6 , V_6 -> V_49 . V_116 ) ;
V_15 = F_108 ( V_6 , 256 * 1024 , V_98 , true ,
V_211 ,
V_212 ,
NULL , NULL , & V_6 -> V_213 ) ;
if ( V_15 ) {
...
V_15 = F_109 ( V_6 -> V_213 , false ) ;
if ( V_15 )
return V_15 ;
V_15 = F_110 ( V_6 -> V_213 , V_211 , NULL ) ;
F_111 ( V_6 -> V_213 ) ;
if ( V_15 ) {
F_112 ( & V_6 -> V_213 ) ;
return V_15 ;
...
F_113 ( L_13 ,
( unsigned ) ( V_6 -> V_49 . V_210 / ( 1024 * 1024 ) ) ) ;
V_15 = F_106 ( & V_6 -> V_5 . V_3 , V_45 ,
V_6 -> V_49 . V_214 >> V_97 ) ;
if ( V_15 ) {
F_9 ( L_14 ) ;
return V_15 ;
...
F_113 ( L_15 ,
( unsigned ) ( V_6 -> V_49 . V_214 / ( 1024 * 1024 ) ) ) ;
V_6 -> V_215 . V_76 . V_216 = V_6 -> V_215 . V_76 . V_216 << V_217 ;
V_6 -> V_215 . V_76 . V_218 = V_6 -> V_215 . V_76 . V_218 << V_217 ;
V_6 -> V_215 . V_76 . V_219 = V_6 -> V_215 . V_76 . V_219 << V_217 ;
V_6 -> V_215 . V_220 . V_216 = V_6 -> V_215 . V_220 . V_216 << V_221 ;
V_6 -> V_215 . V_220 . V_218 = V_6 -> V_215 . V_220 . V_218 << V_221 ;
V_6 -> V_215 . V_220 . V_219 = V_6 -> V_215 . V_220 . V_219 << V_221 ;
V_6 -> V_215 . V_222 . V_216 = V_6 -> V_215 . V_222 . V_216 << V_223 ;
V_6 -> V_215 . V_222 . V_218 = V_6 -> V_215 . V_222 . V_218 << V_223 ;
V_6 -> V_215 . V_222 . V_219 = V_6 -> V_215 . V_222 . V_219 << V_223 ;
V_15 = F_106 ( & V_6 -> V_5 . V_3 , V_57 ,
V_6 -> V_215 . V_76 . V_216 >> V_97 ) ;
if ( V_15 ) {
F_9 ( L_16 ) ;
return V_15 ;
}
V_15 = F_106 ( & V_6 -> V_5 . V_3 , V_58 ,
V_6 -> V_215 . V_220 . V_216 >> V_97 ) ;
if ( V_15 ) {
F_9 ( L_17 ) ;
return V_15 ;
}
V_15 = F_106 ( & V_6 -> V_5 . V_3 , V_59 ,
V_6 -> V_215 . V_222 . V_216 >> V_97 ) ;
if ( V_15 ) {
F_9 ( L_18 ) ;
return V_15 ;
}
...
F_118 ( & V_6 -> V_5 . V_3 , V_52 ) ;
F_118 ( & V_6 -> V_5 . V_3 , V_45 ) ;
F_118 ( & V_6 -> V_5 . V_3 , V_57 ) ;
F_118 ( & V_6 -> V_5 . V_3 , V_58 ) ;
F_118 ( & V_6 -> V_5 . V_3 , V_59 ) ;
F_119 ( & V_6 -> V_5 . V_3 ) ;
F_120 ( V_6 ) ;
F_12 ( V_6 ) ;
V_6 -> V_5 . V_209 = false ;
...
void F_107 ( struct V_1 * V_6 , V_109 V_20 )
{
struct V_37 * V_38 ;
if ( ! V_6 -> V_5 . V_209 )
return;
...
int F_121 ( struct V_81 * V_82 , struct V_133 * V_134 )
{
struct V_224 * V_225 ;
struct V_1 * V_6 ;
if ( F_31 ( V_134 -> V_226 < V_206 ) )
return - V_60 ;
V_225 = V_82 -> V_227 ;
V_6 = V_225 -> V_228 -> V_156 -> V_229 ;
if ( V_6 == NULL )
return - V_60 ;
return F_122 ( V_82 , V_134 , & V_6 -> V_5 . V_3 ) ;
}
...
unsigned V_166 ;
int V_15 ;
V_236 = V_6 -> V_5 . V_108 -> V_239 ;
V_237 = F_123 ( V_232 , V_236 ) ;
V_238 = V_237 * V_6 -> V_5 . V_108 -> V_240 ;
while ( V_238 & 0x7 )
V_238 ++ ;
V_15 = F_124 ( V_6 , V_238 * 4 , & V_235 ) ;
if ( V_15 )
return V_15 ;
if ( V_101 ) {
V_15 = F_125 ( V_6 , & V_235 -> V_241 , V_101 ,
V_242 ) ;
if ( V_15 ) {
F_9 ( L_21 , V_15 ) ;
goto V_243;
...
for ( V_166 = 0 ; V_166 < V_237 ; V_166 ++ ) {
T_1 V_244 = F_100 ( V_232 , V_236 ) ;
F_126 ( V_6 , & V_235 -> V_245 [ 0 ] , V_230 ,
V_231 , V_244 ) ;
V_230 += V_244 ;
V_231 += V_244 ;
V_232 -= V_244 ;
}
F_127 ( V_12 , & V_235 -> V_245 [ 0 ] ) ;
F_128 ( V_235 -> V_245 [ 0 ] . V_246 > V_238 ) ;
V_15 = F_129 ( V_235 , V_12 , & V_6 -> V_5 . V_34 ,
V_242 , V_95 ) ;
if ( V_15 )
goto V_243;
return 0 ;
...
static int F_131 ( struct V_247 * V_248 , void * V_249 )
{
struct V_250 * V_251 = (struct V_250 * ) V_248 -> V_252 ;
unsigned V_253 = * ( int * ) V_251 -> V_254 -> V_249 ;
struct V_255 * V_156 = V_251 -> V_228 -> V_156 ;
struct V_1 * V_6 = V_156 -> V_229 ;
struct V_256 * V_176 = (struct V_256 * ) V_6 -> V_5 . V_3 . V_38 [ V_253 ] . V_257 ;
int V_258 ;
struct V_27 * V_208 = V_6 -> V_5 . V_3 . V_208 ;
F_48 ( & V_208 -> V_259 ) ;
V_258 = F_132 ( V_248 , V_176 ) ;
F_50 ( & V_208 -> V_259 ) ;
if ( V_253 == V_52 )
F_133 ( V_248 , L_22 ,
V_6 -> V_5 . V_3 . V_38 [ V_253 ] . V_20 ,
( V_109 ) F_134 ( & V_6 -> V_260 ) >> 20 ,
( V_109 ) F_134 ( & V_6 -> V_261 ) >> 20 ) ;
return V_258 ;
}
static T_3 F_135 ( struct V_81 * V_262 , char T_4 * V_263 ,
T_5 V_20 , T_6 * V_264 )
{
struct V_1 * V_6 = V_262 -> V_265 -> V_266 ;
T_3 V_267 = 0 ;
int V_15 ;
if ( V_20 & 0x3 || * V_264 & 0x3 )
return - V_60 ;
while ( V_20 ) {
unsigned long V_36 ;
T_1 V_268 ;
if ( * V_264 >= V_6 -> V_49 . V_269 )
return V_267 ;
F_136 ( & V_6 -> V_270 , V_36 ) ;
F_137 ( V_271 , ( ( T_1 ) * V_264 ) | 0x80000000 ) ;
F_137 ( V_272 , * V_264 >> 31 ) ;
V_268 = F_138 ( V_273 ) ;
F_139 ( & V_6 -> V_270 , V_36 ) ;
V_15 = F_140 ( V_268 , ( T_1 * ) V_263 ) ;
if ( V_15 )
return V_15 ;
V_267 += 4 ;
V_263 += 4 ;
...
static T_3 F_141 ( struct V_81 * V_262 , char T_4 * V_263 ,
T_5 V_20 , T_6 * V_264 )
{
struct V_1 * V_6 = V_262 -> V_265 -> V_266 ;
T_3 V_267 = 0 ;
int V_15 ;
while ( V_20 ) {
T_6 V_138 = * V_264 / V_98 ;
unsigned V_274 = * V_264 & ~ V_275 ;
T_5 V_276 = F_142 ( T_5 , V_20 , V_98 - V_274 ) ;
struct V_122 * V_122 ;
void * V_277 ;
if ( V_138 >= V_6 -> V_162 . V_278 )
return V_267 ;
V_122 = V_6 -> V_162 . V_123 [ V_138 ] ;
if ( V_122 ) {
V_277 = F_143 ( V_122 ) ;
V_277 += V_274 ;
V_15 = F_144 ( V_263 , V_277 , V_276 ) ;
F_145 ( V_6 -> V_162 . V_123 [ V_138 ] ) ;
} else
V_15 = F_146 ( V_263 , V_276 ) ;
if ( V_15 )
return - V_175 ;
V_267 += V_276 ;
V_263 += V_276 ;
...
static int F_114 ( struct V_1 * V_6 )
{
#if F_147 ( V_279 )
unsigned V_280 ;
struct V_281 * V_228 = V_6 -> V_118 -> V_282 ;
struct V_283 * V_284 , * V_285 = V_228 -> V_286 ;
V_284 = F_148 ( L_23 , V_287 | V_288 , V_285 ,
V_6 , & V_289 ) ;
if ( F_149 ( V_284 ) )
return F_150 ( V_284 ) ;
F_151 ( V_284 -> V_290 , V_6 -> V_49 . V_269 ) ;
V_6 -> V_5 . V_291 = V_284 ;
#ifdef F_152
V_284 = F_148 ( L_24 , V_287 | V_288 , V_285 ,
V_6 , & V_292 ) ;
if ( F_149 ( V_284 ) )
return F_150 ( V_284 ) ;
F_151 ( V_284 -> V_290 , V_6 -> V_49 . V_214 ) ;
V_6 -> V_5 . V_125 = V_284 ;
#endif
V_280 = F_153 ( V_293 ) ;
#ifdef F_78
