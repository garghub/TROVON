...
{
struct V_51 * V_52 ;
struct V_49 * V_70 = NULL ;
struct V_20 V_71 ;
struct V_23 * V_65 ;
unsigned int V_60 = V_56 -> V_58 -> V_59 -> V_60 ;
unsigned int V_66 = sizeof( V_71 ) ;
...
V_71 . V_76 = V_77 ;
V_71 . V_63 = V_78 ;
V_71 . V_22 = F_51 ( F_52 ( & V_52 -> V_79 ) ) ;
V_71 . V_80 = 0 ;
V_71 . V_35 = 0 ;
V_71 . V_39 = F_51 ( V_8 -> V_36 ) ;
F_53 ( V_71 . V_81 , V_70 -> V_59 -> V_82 ) ;
F_53 ( V_71 . V_57 , V_10 -> V_81 ) ;
while ( V_8 -> V_36 > V_72 ) {
V_65 = F_43 ( V_8 , & V_71 , V_60 ) ;
if ( ! V_65 )
goto V_48;
F_38 ( V_52 , V_83 ) ;
F_39 ( V_52 , V_84 ,
