...
static int F_17 ( struct V_41 * V_42 , struct V_43 * V_44 ,
T_3 V_45 , int * V_46 )
{
int V_47 = V_45 ;
V_46 [ 0 ] = 64 ;
...
static inline int F_18 ( struct V_16 * V_17 ,
unsigned char * V_48 , int V_49 )
{
unsigned char * V_50 = V_48 ;
int V_3 ;
struct V_27 * V_29 = F_19 ( V_17 ) ;
V_3 = 0 ;
if ( V_17 -> V_8 == V_36 )
F_13 ( V_32 , V_51 ) ;
else
...
while ( V_49 > 0 ) {
F_20 ( 2 ) ;
while ( F_21 ( V_32 ) & V_54 )
++ V_3 ;
F_20 ( 3 ) ;
F_22 ( V_50 , V_29 -> V_19 + V_55 , 128 ) ;
V_50 += 128 ;
V_49 -= 128 ;
F_20 ( 7 ) ;
}
F_20 ( 4 ) ;
while ( ! ( F_21 ( V_32 ) & V_56 ) )
++ V_3 ;
F_20 ( 0 ) ;
return ( 0 ) ;
}
static inline int F_23 ( struct V_16 * V_17 ,
unsigned char * V_57 , int V_49 )
{
int V_3 ;
struct V_27 * V_29 = F_19 ( V_17 ) ;
if ( V_17 -> V_8 == V_36 )
...
{
int V_62 = V_61 -> V_62 ;
if ( V_62 > 32 * 1024 && V_61 -> V_63 . V_64 &&
! ( V_61 -> V_63 . V_64 % V_62 ) )
V_62 = 32 * 1024 ;
return V_62 ;
}
