...
struct V_1 * V_2 = V_31 -> V_32 ;
unsigned int V_35 ;
F_74 ( V_2 -> V_37 -> V_38 , V_101 , 0xffffffff ) ;
F_3 ( V_2 -> V_37 -> V_38 , V_40 , & V_35 ) ;
}
...
{
struct V_1 * V_2 = V_31 -> V_32 ;
F_74 ( V_2 -> V_37 -> V_38 , V_101 , V_42 ) ;
}
static int F_78 ( struct V_86 * V_87 )
{
struct V_30 * V_103 ;
int V_69 ;
V_103 = F_79 ( & V_104 , & V_87 -> V_31 ) ;
if ( ! V_103 )
return - V_71 ;
V_69 = F_40 ( V_103 ) ;
if ( V_69 )
...
static int F_86 ( struct V_108 * V_31 )
{
struct V_30 * V_109 = F_46 ( V_31 ) ;
struct V_110 * V_43 ;
if ( F_87 ( V_31 ) )
return 0 ;
F_88 ( V_109 ) ;
F_89 (crtc, &drm_dev->mode_config.crtc_list, head)
F_90 ( V_43 ) ;
F_91 ( V_109 ) ;
return 0 ;
}
static int F_92 ( struct V_108 * V_31 )
{
struct V_30 * V_109 = F_46 ( V_31 ) ;
struct V_110 * V_43 ;
if ( F_87 ( V_31 ) )
