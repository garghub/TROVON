...
static int F_264 ( struct V_556 * V_121 , int V_321 )
{
struct V_27 * V_28 = F_256 ( & V_121 -> V_122 ) ;
int V_4 = 0 ;
enum V_561 V_562 ;
...
V_4 = F_92 ( V_28 ) ;
if ( V_4 ) {
F_267 ( V_136 , 2 , L_174 , V_4 ) ;
goto V_565;
}
V_4 = F_49 ( V_28 ) ;
if ( V_4 )
F_267 ( V_136 , 2 , L_175 , V_4 ) ;
V_4 = F_52 ( V_28 ) ;
if ( V_4 )
F_267 ( V_136 , 2 , L_176 , V_4 ) ;
}
F_240 ( V_28 -> V_122 ) ;
V_4 = F_272 ( V_28 ) ;
if ( V_4 ) {
F_267 ( V_136 , 2 , L_177 , V_4 ) ;
V_4 = - V_403 ;
goto V_565;
}
V_28 -> V_323 = V_327 ;
...
static int F_283 ( struct V_556 * V_121 )
{
return F_264 ( V_121 , 0 ) ;
}
static int F_284 ( struct V_556 * V_558 ,
int V_321 )
{
struct V_27 * V_28 = F_256 ( & V_558 -> V_122 ) ;
...
if ( V_28 -> V_122 && F_285 ( V_28 -> V_122 ) )
F_253 ( V_28 -> V_122 ) ;
V_562 = V_28 -> V_323 ;
...
F_162 () ;
F_286 ( V_575 , V_28 -> V_122 ) ;
F_164 () ;
}
V_4 = F_278 ( F_279 ( V_28 ) ) ;
V_572 = F_278 ( F_280 ( V_28 ) ) ;
V_573 = F_278 ( F_281 ( V_28 ) ) ;
if ( ! V_4 )
...
{
return F_284 ( V_558 , 0 ) ;
}
static int F_287 ( void * V_576 )
{
struct V_27 * V_28 ;
int V_4 = 0 ;
...
static void F_294 ( struct V_556 * V_121 )
{
struct V_27 * V_28 = F_256 ( & V_121 -> V_122 ) ;
F_160 ( V_28 , 0 , 1 ) ;
...
static int F_295 ( struct V_556 * V_121 )
{
struct V_27 * V_28 = F_256 ( & V_121 -> V_122 ) ;
if ( V_28 -> V_122 )
F_296 ( V_28 -> V_122 ) ;
...
static int F_297 ( struct V_556 * V_121 )
{
struct V_27 * V_28 = F_256 ( & V_121 -> V_122 ) ;
int V_4 = 0 ;
if ( V_121 -> V_323 == V_577 )
...
static int F_299 ( struct V_27 * V_28 ,
struct V_80 * V_81 )
{
return 1 ;
}
static int F_300 ( struct V_578 * V_579 ,
...
static int F_302 ( struct V_578 * V_579 ,
unsigned long V_580 , void * V_576 )
{
