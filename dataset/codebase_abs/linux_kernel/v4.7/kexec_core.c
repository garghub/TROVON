...
void __weak F_69 ( unsigned long V_96 ,
unsigned long V_27 )
{
unsigned long V_50 ;
...
V_26 = F_72 ( V_26 , V_104 ) ;
V_27 = F_72 ( V_26 + V_97 , V_104 ) ;
F_69 ( V_27 , V_25 . V_27 ) ;
...
static T_5 * F_75 ( T_5 * V_80 , char * V_109 , unsigned type , void * V_111 ,
T_3 V_112 )
{
struct V_113 V_114 ;
...
void F_77 ( struct V_87 * V_88 , int V_118 )
{
struct V_119 V_120 ;
T_5 * V_80 ;
if ( ( V_118 < 0 ) || ( V_118 >= V_121 ) )
return;
V_80 = ( T_5 * ) F_78 ( V_122 , V_118 ) ;
if ( ! V_80 )
return;
memset ( & V_120 , 0 , sizeof( V_120 ) ) ;
V_120 . V_123 = V_124 -> V_4 ;
F_79 ( & V_120 . V_125 , V_88 ) ;
V_80 = F_75 ( V_80 , V_126 , V_127 ,
& V_120 , sizeof( V_120 ) ) ;
F_76 ( V_80 ) ;
}
...
T_3 V_57 , V_128 ;
V_57 = sizeof( V_129 ) ;
V_128 = F_48 ( F_81 ( sizeof( V_129 ) ) , V_63 ) ;
F_82 ( V_57 > V_63 ) ;
V_122 = F_83 ( V_57 , V_128 ) ;
if ( ! V_122 ) {
F_84 ( L_2 ) ;
return - V_61 ;
}
...
static int T_6 F_85 ( char * V_130 ,
...
static int T_6 F_87 ( char * V_130 ,
unsigned long long * V_132 ,
unsigned long long * V_133 )
{
char * V_134 = V_130 ;
* V_132 = F_86 ( V_130 , & V_134 ) ;
if ( V_130 == V_134 ) {
F_84 ( L_10 ) ;
return - V_19 ;
}
if ( * V_134 == '@' )
* V_133 = F_86 ( V_134 + 1 , & V_134 ) ;
...
static T_6 char * F_89 ( char * V_130 ,
const char * V_109 ,
const char * V_137 )
{
...
static int T_6 F_90 ( char * V_130 ,
unsigned long long V_131 ,
unsigned long long * V_132 ,
unsigned long long * V_133 ,
const char * V_109 ,
...
* V_132 = 0 ;
* V_133 = 0 ;
V_138 = F_89 ( V_130 , V_109 , V_137 ) ;
if ( ! V_138 )
return - V_19 ;
V_138 += strlen ( V_109 ) ;
if ( V_137 )
return F_88 ( V_138 , V_132 ,
V_137 ) ;
V_142 = strchr ( V_138 , ':' ) ;
V_143 = strchr ( V_138 , ' ' ) ;
if ( V_142 && ( ! V_143 || V_142 < V_143 ) )
return F_85 ( V_138 , V_131 ,
V_132 , V_133 ) ;
return F_87 ( V_138 , V_132 , V_133 ) ;
}
int T_6 F_92 ( char * V_130 ,
unsigned long long V_131 ,
unsigned long long * V_132 ,
unsigned long long * V_133 )
{
return F_90 ( V_130 , V_131 , V_132 , V_133 ,
L_12 , NULL ) ;
}
...
void F_96 ( const char * V_150 , ... )
{
T_7 args ;
char V_80 [ 0x50 ] ;
T_3 V_151 ;
va_start ( args , V_150 ) ;
V_151 = F_98 ( V_80 , sizeof( V_80 ) , V_150 , args ) ;
va_end ( args ) ;
V_151 = F_48 ( V_151 , V_152 - V_147 ) ;
memcpy ( & V_149 [ V_147 ] , V_80 , V_151 ) ;
V_147 += V_151 ;
}
void __weak F_99 ( void )
{}
unsigned long __weak F_100 ( void )
{
return F_101 ( ( unsigned long ) ( char * ) & V_146 ) ;
}
static int T_6 F_102 ( void )
{
F_103 ( V_153 . V_109 . V_154 ) ;
F_104 ( V_63 ) ;
F_105 ( V_153 ) ;
F_105 ( V_155 ) ;
#ifdef F_106
...
F_111 ( V_43 , V_45 ) ;
F_111 ( V_43 , V_183 ) ;
F_111 ( V_184 , va_start ) ;
F_111 ( V_184 , V_44 ) ;
F_109 ( V_165 . V_166 , V_185 ) ;
F_114 () ;
F_109 ( V_166 . V_182 , V_186 ) ;
F_115 ( V_187 ) ;
F_115 ( V_188 ) ;
F_115 ( V_189 ) ;
F_115 ( V_190 ) ;
...
void __weak F_144 ( void )
{}
void __weak F_145 ( void )
{}
