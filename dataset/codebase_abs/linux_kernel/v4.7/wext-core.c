...
int V_140 = 0 ;
struct V_130 V_141 ;
struct V_52 * V_142 = ( void * ) & V_131 -> V_74 . V_63 ;
memcpy ( & V_141 , V_131 , sizeof( struct V_130 ) ) ;
V_141 . V_74 . V_63 . V_78 = F_57 ( V_142 -> V_78 ) ;
V_141 . V_74 . V_63 . V_64 = V_142 -> V_64 ;
V_141 . V_74 . V_63 . V_77 = V_142 -> V_77 ;
V_140 = V_19 -> V_137 -> V_138 ( V_19 , ( void * ) & V_141 , V_35 ) ;
V_142 -> V_78 = F_58 ( V_141 . V_74 . V_63 . V_78 ) ;
V_142 -> V_64 = V_141 . V_74 . V_63 . V_64 ;
V_142 -> V_77 = V_141 . V_74 . V_63 . V_77 ;
return V_140 ;
} else
#endif
...
static int F_59 ( unsigned int V_35 )
{
if ( ( F_46 ( V_35 ) || V_35 == V_143 ||
V_35 == V_144 ) &&
! F_60 ( V_145 ) )
return - V_146 ;
return 0 ;
}
static int F_61 ( struct V_3 * V_3 , struct V_128 * V_129 ,
...
if ( V_140 )
return V_140 ;
F_62 ( V_3 , V_129 -> V_132 ) ;
F_16 () ;
V_140 = F_54 ( V_3 , V_129 , V_35 , V_89 , V_99 , V_102 ) ;
F_17 () ;
return V_140 ;
}
...
V_40 = & ( V_58 [ F_27 ( V_35 ) ] ) ;
if ( V_40 -> V_61 != V_62 ) {
V_140 = V_105 ( V_19 , V_89 , & ( V_131 -> V_74 ) , NULL ) ;
if ( ( V_40 -> V_77 & V_125 ) &&
( ( V_140 == 0 ) || ( V_140 == - V_126 ) ) )
F_24 ( V_19 , V_35 , & ( V_131 -> V_74 ) , NULL ) ;
} else {
V_140 = F_45 ( & V_131 -> V_74 . V_63 , V_35 , V_40 ,
V_105 , V_19 , V_89 ) ;
}
if ( V_140 == - V_126 )
V_140 = F_52 ( V_19 ) ;
...
int F_64 ( struct V_3 * V_3 , struct V_128 * V_129 , unsigned int V_35 ,
void T_6 * V_147 )
{
struct V_88 V_89 = { . V_35 = V_35 , . V_77 = 0 } ;
int V_140 ;
V_140 = F_61 ( V_3 , V_129 , V_35 , & V_89 ,
F_63 ,
V_148 ) ;
if ( V_140 >= 0 &&
F_49 ( V_35 ) &&
F_50 ( V_147 , V_129 , sizeof( struct V_130 ) ) )
return - V_115 ;
return V_140 ;
}
...
V_40 = V_58 + F_27 ( V_35 ) ;
if ( V_40 -> V_61 != V_62 )
return F_63 ( V_19 , V_131 , V_35 , V_89 , V_105 ) ;
V_142 = (struct V_52 * ) & V_131 -> V_74 . V_63 ;
V_104 . V_78 = F_57 ( V_142 -> V_78 ) ;
V_104 . V_64 = V_142 -> V_64 ;
V_104 . V_77 = V_142 -> V_77 ;
V_12 = F_45 ( & V_104 , V_35 , V_40 , V_105 , V_19 , V_89 ) ;
V_142 -> V_78 = F_58 ( V_104 . V_78 ) ;
...
unsigned long V_147 )
{
void T_6 * V_149 = ( void T_6 * ) V_147 ;
struct V_88 V_89 ;
struct V_130 V_131 ;
char * V_150 ;
int V_140 ;
if ( F_47 ( & V_131 , V_149 , sizeof( struct V_130 ) ) )
return - V_115 ;
V_131 . V_132 [ V_151 - 1 ] = 0 ;
V_150 = strchr ( V_131 . V_132 , ':' ) ;
if ( V_150 )
* V_150 = 0 ;
V_89 . V_35 = V_35 ;
V_89 . V_77 = V_139 ;
V_140 = F_61 ( V_3 , (struct V_128 * ) & V_131 , V_35 , & V_89 ,
F_65 ,
V_152 ) ;
if ( V_140 >= 0 &&
F_49 ( V_35 ) &&
F_50 ( V_149 , & V_131 , sizeof( struct V_130 ) ) )
return - V_115 ;
return V_140 ;
}
