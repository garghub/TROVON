...
static int F_45 ( struct V_1 * V_1 , struct V_2 * V_3 , struct V_4 * V_5 )
{
struct V_27 * V_28 = F_28 ( V_5 -> V_23 ) ;
F_43 ( V_5 ) ;
...
T_4 F_46 ( struct V_4 * * V_78 )
{
struct V_27 * V_28 ;
struct V_4 * V_5 = * V_78 ;
const unsigned char * V_58 = F_27 ( V_5 ) -> V_59 ;
T_5 * V_79 ;
if ( F_47 ( V_5 -> V_80 == V_81 ) )
return V_82 ;
if ( ! F_48 ( F_27 ( V_5 ) -> V_69 ) )
goto V_66;
V_5 = F_49 ( V_5 , V_83 ) ;
if ( ! V_5 )
return V_84 ;
...
case V_70 :
if ( F_52 ( V_28 -> V_10 -> V_23 -> V_93 , V_58 ) )
V_5 -> V_80 = V_94 ;
F_13 ( V_24 , V_95 ,
