...
static int
F_114 ( struct V_61 * V_52 , struct V_237 * V_238 )
{
struct V_1 * V_2 = F_41 ( V_52 ) ;
V_238 -> V_239 = V_240 ;
V_238 -> V_241 = V_242
...
| V_244 ;
F_115 ( V_238 , V_150 ) ;
V_238 -> V_148 = V_2 -> V_113 ? V_151 : V_245 ;
V_238 -> V_246 = V_247 ;
V_238 -> V_146 = V_149 ;
return 0 ;
}
static int
F_116 ( struct V_61 * V_52 , struct V_237 * V_238 )
{
return F_54 ( V_52 , V_238 -> V_146 ,
F_117 ( V_238 ) , V_238 -> V_148 ) ;
}
...
static int F_121 ( struct V_249 * V_16 )
{
struct V_61 * V_52 ;
struct V_1 * V_2 ;
const void * V_250 ;
...
V_250 = F_129 ( V_16 -> V_52 . V_257 ) ;
if ( V_250 )
F_130 ( V_52 -> V_65 , V_250 ) ;
else
F_131 ( V_52 ) ;
F_40 ( V_52 ) ;
...
static int F_136 ( struct V_249 * V_16 )
{
