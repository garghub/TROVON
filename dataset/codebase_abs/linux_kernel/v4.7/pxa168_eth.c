...
if ( V_182 )
return V_182 ;
V_181 . V_186 = V_2 -> V_184 ;
V_181 . V_176 = V_2 -> V_187 ;
V_181 . V_178 = V_2 -> V_188 ;
V_181 . V_189 = V_190 ;
V_181 . V_191 = V_192 ;
if ( V_181 . V_176 != 0 )
V_181 . V_191 = V_193 ;
...
goto V_205;
V_202 = V_2 -> V_25 ;
for ( V_42 = 0 ; V_42 < V_203 ; V_42 ++ ) {
V_202 [ V_42 ] . V_206 = V_2 -> V_102 +
( ( V_42 + 1 ) % V_203 ) * sizeof( struct V_16 ) ;
}
V_2 -> V_100 = 0 ;
V_2 -> V_24 = 0 ;
V_2 -> V_204 = V_203 * sizeof( struct V_16 ) ;
return 0 ;
V_205:
F_74 ( V_2 -> V_29 ) ;
return - V_74 ;
...
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_207 ;
for ( V_207 = 0 ; V_2 -> V_19 && V_207 < V_2 -> V_20 ; V_207 ++ ) {
if ( V_2 -> V_29 [ V_207 ] ) {
F_76 ( V_2 -> V_29 [ V_207 ] ) ;
V_2 -> V_19 -- ;
}
...
V_2 -> V_19 ) ;
if ( V_2 -> V_25 )
F_77 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_204 ,
V_2 -> V_25 , V_2 -> V_102 ) ;
F_74 ( V_2 -> V_29 ) ;
}
...
goto V_205;
V_208 = V_2 -> V_118 ;
for ( V_42 = 0 ; V_42 < V_209 ; V_42 ++ ) {
V_208 [ V_42 ] . V_206 = V_2 -> V_98 +
( ( V_42 + 1 ) % V_209 ) * sizeof( struct V_99 ) ;
}
V_2 -> V_96 = 0 ;
V_2 -> V_117 = 0 ;
V_2 -> V_210 = V_209 * sizeof( struct V_99 ) ;
return 0 ;
V_205:
F_74 ( V_2 -> V_122 ) ;
return - V_74 ;
...
if ( V_2 -> V_118 )
F_77 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_210 ,
V_2 -> V_118 , V_2 -> V_98 ) ;
F_74 ( V_2 -> V_122 ) ;
}
...
if ( V_182 )
return V_182 ;
V_182 = F_81 ( V_11 -> V_149 , F_58 , 0 , V_11 -> V_211 , V_11 ) ;
if ( V_182 ) {
F_82 ( & V_11 -> V_11 , L_8 ) ;
return - V_212 ;
}
...
int V_217 ;
V_217 = V_2 -> V_96 ;
V_2 -> V_96 = ( V_217 + 1 ) % V_2 -> V_120 ;
F_80 ( V_2 -> V_96 == V_2 -> V_117 ) ;
V_2 -> V_116 ++ ;
return V_217 ;
}
static int F_91 ( struct V_218 * V_39 , int V_130 )
{
struct V_1 * V_2 =
...
V_110 -> V_121 = V_220 ;
V_110 -> V_26 = F_13 ( NULL , V_15 -> V_5 , V_220 , V_126 ) ;
F_96 ( V_15 ) ;
F_14 () ;
V_110 -> V_30 = V_31 | V_222 | V_223 |
V_224 | V_225 | V_226 ;
F_97 () ;
F_3 ( V_2 , V_8 , V_227 | V_108 ) ;
V_124 -> V_228 += V_220 ;
V_124 -> V_229 ++ ;
F_98 ( V_11 ) ;
...
{
int V_42 = 0 ;
for ( V_42 = 0 ; F_1 ( V_2 , V_231 ) & V_232 ; V_42 ++ ) {
if ( V_42 == V_233 )
return - V_234 ;
F_101 ( 10 ) ;
}
...
static int F_102 ( struct V_235 * V_236 , int V_184 , int V_237 )
{
struct V_1 * V_2 = V_236 -> V_238 ;
int V_42 = 0 ;
int V_78 ;
if ( F_100 ( V_2 ) ) {
F_103 ( V_2 -> V_11 , L_10 ) ;
...
F_3 ( V_2 , V_231 , ( V_184 << 16 ) | ( V_237 << 21 ) | V_239 ) ;
for ( V_42 = 0 ; ! ( ( V_78 = F_1 ( V_2 , V_231 ) ) & V_240 ) ; V_42 ++ ) {
if ( V_42 == V_233 ) {
F_103 ( V_2 -> V_11 ,
L_11 ) ;
return - V_241 ;
...
static int F_104 ( struct V_235 * V_236 , int V_184 , int V_237 ,
T_5 V_242 )
{
struct V_1 * V_2 = V_236 -> V_238 ;
if ( F_100 ( V_2 ) ) {
...
F_3 ( V_2 , V_231 , ( V_184 << 16 ) | ( V_237 << 21 ) |
V_243 | ( V_242 & 0xffff ) ) ;
if ( F_100 ( V_2 ) ) {
F_7 ( V_2 -> V_11 , L_10 ) ;
return - V_234 ;
...
static int F_105 ( struct V_13 * V_11 , struct V_244 * V_245 ,
int V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
if ( V_2 -> V_95 != NULL )
return F_106 ( V_2 -> V_95 , V_245 , V_181 ) ;
return - V_246 ;
}
...
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_182 ;
V_182 = F_107 ( V_2 -> V_95 ) ;
if ( V_182 == 0 )
V_182 = F_108 ( V_2 -> V_95 , V_181 ) ;
return V_182 ;
}
static int F_70 ( struct V_13 * V_11 , struct V_180 * V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
return F_109 ( V_2 -> V_95 , V_181 ) ;
}
static void F_110 ( struct V_13 * V_11 ,
struct V_247 * V_248 )
{
F_111 ( V_248 -> V_249 , V_250 , sizeof( V_248 -> V_249 ) ) ;
F_111 ( V_248 -> V_251 , V_252 , sizeof( V_248 -> V_251 ) ) ;
F_111 ( V_248 -> V_253 , L_12 , sizeof( V_248 -> V_253 ) ) ;
F_111 ( V_248 -> V_254 , L_12 , sizeof( V_248 -> V_254 ) ) ;
}
...
int V_182 ;
F_113 ( V_262 L_13 ) ;
V_259 = F_114 ( & V_256 -> V_11 , NULL ) ;
if ( F_66 ( V_259 ) ) {
F_82 ( & V_256 -> V_11 , L_14 ) ;
return - V_241 ;
}
F_115 ( V_259 ) ;
...
V_2 -> V_11 = V_11 ;
V_2 -> V_259 = V_259 ;
V_258 = F_118 ( V_256 , V_264 , 0 ) ;
V_2 -> V_4 = F_119 ( & V_256 -> V_11 , V_258 ) ;
if ( F_66 ( V_2 -> V_4 ) ) {
V_182 = - V_74 ;
goto V_265;
}
V_258 = F_118 ( V_256 , V_266 , 0 ) ;
F_80 ( ! V_258 ) ;
V_11 -> V_149 = V_258 -> V_55 ;
V_11 -> V_267 = & V_268 ;
V_11 -> V_269 = 2 * V_38 ;
V_11 -> V_270 = 0 ;
V_11 -> V_271 = & V_272 ;
...
if ( V_256 -> V_11 . V_273 )
V_41 = F_121 ( V_256 -> V_11 . V_273 ) ;
if ( V_41 && F_33 ( V_41 ) ) {
F_122 ( V_11 -> V_83 , V_41 ) ;
} else {
F_31 ( V_11 , V_11 -> V_83 ) ;
if ( ! F_33 ( V_11 -> V_83 ) ) {
F_123 ( & V_256 -> V_11 , L_15 ) ;
F_124 ( V_11 ) ;
}
}
V_2 -> V_20 = V_274 ;
V_2 -> V_120 = V_275 ;
V_2 -> V_276 = F_125 ( & V_256 -> V_11 ) ;
if ( V_2 -> V_276 ) {
if ( V_2 -> V_276 -> V_277 )
V_2 -> V_20 = V_2 -> V_276 -> V_277 ;
if ( V_2 -> V_276 -> V_278 )
V_2 -> V_120 = V_2 -> V_276 -> V_278 ;
V_2 -> V_279 = V_2 -> V_276 -> V_280 ;
V_2 -> V_184 = V_2 -> V_276 -> V_184 ;
V_2 -> V_187 = V_2 -> V_276 -> V_176 ;
V_2 -> V_188 = V_2 -> V_276 -> V_178 ;
V_2 -> V_185 = V_2 -> V_276 -> V_281 ;
if ( V_2 -> V_276 -> V_282 )
V_2 -> V_276 -> V_282 () ;
} else if ( V_256 -> V_11 . V_273 ) {
F_126 ( V_256 -> V_11 . V_273 , L_16 ,
& V_2 -> V_279 ) ;
V_261 = F_127 ( V_256 -> V_11 . V_273 , L_17 , 0 ) ;
if ( ! V_261 ) {
F_82 ( & V_256 -> V_11 , L_18 ) ;
V_182 = - V_216 ;
goto V_265;
}
F_126 ( V_261 , L_19 , & V_2 -> V_184 ) ;
V_2 -> V_185 = F_128 ( V_256 -> V_11 . V_273 ) ;
}
F_80 ( V_2 -> V_279 > 2 ) ;
F_129 ( V_11 , & V_2 -> V_39 , F_91 , V_2 -> V_20 ) ;
memset ( & V_2 -> V_35 , 0 , sizeof( struct V_283 ) ) ;
F_130 ( & V_2 -> V_35 ) ;
V_2 -> V_35 . V_284 = F_16 ;
...
V_2 -> V_183 -> V_238 = V_2 ;
V_2 -> V_183 -> V_211 = L_20 ;
V_2 -> V_183 -> V_285 = F_102 ;
V_2 -> V_183 -> V_286 = F_104 ;
snprintf ( V_2 -> V_183 -> V_287 , V_288 , L_21 ,
V_256 -> V_211 , V_256 -> V_287 ) ;
V_2 -> V_183 -> V_70 = & V_256 -> V_11 ;
V_2 -> V_183 -> V_289 = 0xffffffff ;
V_182 = F_132 ( V_2 -> V_183 ) ;
if ( V_182 )
goto V_290;
F_133 ( V_11 , & V_256 -> V_11 ) ;
F_71 ( V_2 ) ;
V_182 = F_134 ( V_11 ) ;
if ( V_182 )
goto V_291;
...
static int F_139 ( struct V_255 * V_256 )
{
struct V_13 * V_11 = F_140 ( V_256 ) ;
struct V_1 * V_2 = F_9 ( V_11 ) ;
if ( V_2 -> V_61 ) {
...
static void F_144 ( struct V_255 * V_256 )
{
struct V_13 * V_11 = F_140 ( V_256 ) ;
F_38 ( V_11 ) ;
}
...
static int F_146 ( struct V_255 * V_256 , T_6 V_293 )
{
return - V_292 ;
}
