...
struct V_27 * V_48 ;
struct V_28 * V_29 = V_8 -> V_23 ;
V_48 = V_29 -> V_36 [ V_29 -> V_22 [ V_47 ] . V_23 ] ;
return F_31 ( V_8 -> V_27 , V_48 ) ;
}
static void F_32 ( struct V_7 * V_8 )
{
struct V_28 * V_49 = V_8 -> V_23 ;
struct V_2 * V_5 = F_10 ( V_8 -> V_1 , NULL ) ;
if ( F_33 ( V_5 , L_9 , NULL ) ) {
V_49 -> V_46 = F_34 ( V_5 ,
V_8 -> V_50 ) ;
if ( F_20 ( V_49 -> V_46 ) && F_35 ( V_49 -> V_46 ) != - V_51 ) {
F_21 ( L_10 ,
V_8 -> V_1 , F_35 ( V_49 -> V_46 ) ) ;
V_49 -> V_46 = NULL ;
}
}
F_7 ( V_5 ) ;
