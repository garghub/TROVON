...
static bool F_24 ( unsigned long V_22 ,
struct V_2 V_38 ,
int V_15 ,
unsigned long * V_44 )
{
...
while ( V_22 < V_58 ) {
V_52 . V_59 = V_22 ;
if ( ! F_24 ( V_22 , V_38 , 1 , & V_22 ) )
continue;
V_60:
if ( V_22 >= V_58 )
V_22 = V_58 ;
else if ( F_24 ( V_22 , V_38 , 1 , & V_50 ) ) {
V_22 = V_50 ;
goto V_60;
}
V_52 . V_61 = V_22 ;
...
static unsigned long F_28 ( struct V_20 * V_21 ,
unsigned long V_14 ,
struct V_2 V_38 ,
int V_30 )
{
...
while ( V_22 > V_66 ) {
V_52 . V_61 = V_22 ;
if ( ! F_24 ( V_22 - 1 , V_38 , 0 , & V_22 ) )
continue;
V_67:
if ( V_22 < V_66 )
V_22 = V_66 ;
else if ( F_24 ( V_22 - 1 , V_38 , 0 , & V_63 ) ) {
V_22 = V_63 ;
goto V_67;
}
V_52 . V_59 = V_22 ;
...
return F_25 ( V_21 , V_14 , V_38 , V_30 ) ;
}
static unsigned long F_29 ( struct V_20 * V_21 , unsigned long V_14 ,
struct V_2 V_3 , int V_30 ,
int V_68 )
{
if ( V_68 )
return F_28 ( V_21 , V_14 , V_3 , V_30 ) ;
else
return F_25 ( V_21 , V_14 , V_3 , V_30 ) ;
}
unsigned long F_30 ( unsigned long V_22 , unsigned long V_14 ,
...
V_74 = F_29 ( V_21 , V_14 , V_69 , V_30 , V_68 ) ;
if ( V_74 != - V_62 ) {
F_20 ( L_10 , V_74 ) ;
return V_74 ;
}
...
F_20 ( L_13 ) ;
if ( V_22 ) {
V_22 = F_29 ( V_21 , V_14 , V_69 , V_30 , V_68 ) ;
if ( V_22 != - V_62 ) {
F_20 ( L_10 , V_22 ) ;
return V_22 ;
}
}
V_22 = F_29 ( V_21 , V_14 , V_70 , V_30 , V_68 ) ;
#ifdef F_35
if ( V_22 == - V_62 && V_30 == V_76 ) {
F_36 ( V_70 , V_71 ) ;
V_22 = F_29 ( V_21 , V_14 , V_70 , V_30 ,
V_68 ) ;
}
#endif
if ( V_22 == - V_62 )
...
unsigned long V_40 )
{
return F_30 ( V_22 , V_14 , V_40 ,
V_41 -> V_21 -> V_35 . V_84 , 0 ) ;
}
unsigned long F_40 ( struct V_81 * V_82 ,
const unsigned long V_85 ,
const unsigned long V_14 ,
const unsigned long V_83 ,
const unsigned long V_40 )
{
return F_30 ( V_85 , V_14 , V_40 ,
V_41 -> V_21 -> V_35 . V_84 , 1 ) ;
}
unsigned int F_41 ( struct V_20 * V_21 , unsigned long V_22 )
{
unsigned char * V_31 ;
int V_32 , V_33 ;
if ( F_33 () ) {
...
void F_42 ( struct V_20 * V_21 , unsigned int V_30 )
{
int V_32 , V_33 ;
unsigned char * V_31 ;
