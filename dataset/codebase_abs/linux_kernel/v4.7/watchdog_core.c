...
V_31 ) ;
int V_15 ;
V_15 = V_2 -> V_26 -> V_32 ( V_2 , V_30 , V_22 ) ;
if ( V_15 )
return V_28 ;
return V_29 ;
}
...
return - V_17 ;
if ( ! V_2 -> V_26 -> V_36 || ( ! V_2 -> V_26 -> V_27 && ! V_2 -> V_37 ) )
return - V_17 ;
F_7 ( V_2 ) ;
if ( V_2 -> V_38 ) {
V_15 = F_18 ( V_2 -> V_38 -> V_18 , L_3 ) ;
if ( V_15 >= 0 )
V_34 = F_19 ( & V_39 , V_15 ,
V_15 + 1 , V_40 ) ;
}
if ( V_34 < 0 )
V_34 = F_19 ( & V_39 , 0 , V_41 , V_40 ) ;
if ( V_34 < 0 )
return V_34 ;
V_2 -> V_34 = V_34 ;
V_15 = F_20 ( V_2 ) ;
