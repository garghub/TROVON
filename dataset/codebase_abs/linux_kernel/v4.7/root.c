...
static int F_41 ( struct V_44 * V_45 , struct V_22 * V_22 , struct V_46 * V_47
)
{
F_42 ( F_43 ( V_22 ) , V_47 ) ;
V_47 -> V_48 = V_49 . V_48 + F_44 () ;
return 0 ;
}
static struct V_22 * F_45 ( struct V_50 * V_51 , struct V_22 * V_22 , unsigned int V_21 )
{
if ( ! F_46 ( V_51 , V_22 , V_21 ) )
return NULL ;
return F_47 ( V_51 , V_22 , V_21 ) ;
}
static int F_48 ( struct V_52 * V_52 , struct V_53 * V_54 )
{
if ( V_54 -> V_55 < V_56 ) {
int error = F_49 ( V_52 , V_54 ) ;
if ( F_50 ( error <= 0 ) )
return error ;
V_54 -> V_55 = V_56 ;
}
return F_51 ( V_52 , V_54 ) ;
}
