...
V_2 -> V_16 = F_80 ( & V_136 -> V_42 , & V_2 -> V_150 ,
V_2 ) ;
if ( F_77 ( V_2 -> V_16 ) ) {
...
{
struct V_1 * V_2 = F_83 ( V_136 ) ;
F_68 ( & V_2 -> V_89 ) ;
return 0 ;
}
static int F_84 ( struct V_152 * V_42 )
{
struct V_135 * V_136 = F_85 ( V_42 ) ;
struct V_1 * V_2 = F_83 ( V_136 ) ;
int V_41 ;
...
static int F_86 ( struct V_152 * V_42 )
{
struct V_135 * V_136 = F_85 ( V_42 ) ;
struct V_1 * V_2 = F_83 ( V_136 ) ;
int V_41 ;
