...
static int
F_10 ( struct V_16 * V_17 , struct V_18 * V_19 ,
int V_20 , bool V_21 )
{
struct V_1 * V_2 = & V_17 -> V_22 ;
F_11 ( V_2 -> V_23 , V_19 , F_12 ( V_21 ) ) ;
V_19 -> V_24 = V_2 -> V_15 -> V_25 ;
V_19 -> V_26 = V_19 -> V_27 ;
return 1 ;
}
static void
F_13 ( struct V_16 * V_17 , struct V_28 * V_29 )
{
struct V_30 * V_31 = V_17 -> V_22 . V_23 ;
unsigned int V_32 ;
for ( V_32 = 0 ; V_29 -> V_33 ; -- V_29 -> V_33 )
F_14 ( V_31 , & V_29 -> V_34 [ V_32 ++ ] ) ;
}
static void
F_15 ( struct V_16 * V_17 , struct V_28 * V_29 ,
bool V_35 )
{
F_13 ( V_17 , V_29 ) ;
}
