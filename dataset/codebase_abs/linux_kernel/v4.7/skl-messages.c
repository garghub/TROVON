...
F_53 ( V_176 , L_6 , V_177 , 8 , 4 ,
* V_174 , V_165 , false ) ;
return 0 ;
}
static int F_54 ( struct V_178 * V_179 ,
struct V_180 V_53 , int V_181 )
{
int V_51 ;
for ( V_51 = 0 ; V_51 < V_181 ; V_51 ++ ) {
if ( V_179 [ V_51 ] . V_53 . V_175 == V_53 . V_175 &&
V_179 [ V_51 ] . V_53 . V_182 == V_53 . V_182 )
return V_51 ;
}
return - V_35 ;
}
static int F_55 ( struct V_178 * V_179 ,
struct V_72 * V_183 , int V_181 )
{
int V_51 ;
struct V_180 V_53 = V_183 -> V_53 ;
for ( V_51 = 0 ; V_51 < V_181 ; V_51 ++ ) {
if ( V_179 [ V_51 ] . V_184 ) {
if ( ! V_179 [ V_51 ] . V_185 &&
V_179 [ V_51 ] . V_186 == V_187 ) {
V_179 [ V_51 ] . V_185 = true ;
V_179 [ V_51 ] . V_53 . V_175 = V_53 . V_175 ;
V_179 [ V_51 ] . V_53 . V_182 = V_53 . V_182 ;
V_179 [ V_51 ] . V_188 = V_183 ;
return V_51 ;
}
} else {
if ( V_179 [ V_51 ] . V_53 . V_175 == V_53 . V_175 &&
...
static void F_56 ( struct V_178 * V_179 , int V_189 )
{
if ( V_179 [ V_189 ] . V_184 ) {
V_179 [ V_189 ] . V_185 = false ;
V_179 [ V_189 ] . V_53 . V_175 = 0 ;
V_179 [ V_189 ] . V_53 . V_182 = 0 ;
}
V_179 [ V_189 ] . V_186 = V_187 ;
V_179 [ V_189 ] . V_188 = NULL ;
}
static void F_57 ( struct V_178 * V_179 , int V_181 ,
struct V_72 * V_190 )
{
int V_51 ;
bool V_191 = false ;
for ( V_51 = 0 ; V_51 < V_181 ; V_51 ++ ) {
if ( V_179 [ V_51 ] . V_186 == V_187 )
continue;
V_191 = true ;
break;
}
...
int V_40 ;
struct V_194 V_21 ;
F_30 ( V_16 -> V_2 , L_7 , V_195 ,
V_73 -> V_53 . V_175 , V_73 -> V_53 . V_182 ) ;
if ( V_73 -> V_109 -> V_196 != V_197 ) {
F_28 ( V_16 -> V_2 , L_8 ,
V_73 -> V_109 -> V_196 , V_73 -> V_109 -> V_198 ) ;
return - V_60 ;
}
V_40 = F_52 ( V_16 , V_73 ,
& V_173 , & V_174 ) ;
...
V_21 . V_182 = V_73 -> V_53 . V_182 ;
V_21 . V_199 = V_73 -> V_109 -> V_198 ;
V_21 . V_26 = V_173 ;
V_21 . V_200 = V_73 -> V_200 ;
...
* V_202 , struct V_72 * V_203 )
{
F_30 ( V_16 -> V_2 , L_11 ,
V_195 , V_202 -> V_53 . V_175 , V_202 -> V_53 . V_182 ) ;
F_30 ( V_16 -> V_2 , L_12 , V_195 ,
V_203 -> V_53 . V_175 , V_203 -> V_53 . V_182 ) ;
F_30 ( V_16 -> V_2 , L_13 ,
V_202 -> V_192 , V_203 -> V_192 ) ;
}
...
int V_40 ;
struct V_206 V_21 ;
struct V_180 V_207 = V_204 -> V_53 ;
struct V_180 V_208 = V_205 -> V_53 ;
int V_209 = V_205 -> V_210 ;
int V_211 = V_204 -> V_212 ;
int V_213 , V_214 , V_215 , V_216 ;
F_60 ( V_16 , V_204 , V_205 ) ;
V_213 = F_54 ( V_204 -> V_217 , V_208 , V_211 ) ;
if ( V_213 < 0 )
return 0 ;
V_21 . V_218 = V_213 ;
V_214 = F_54 ( V_205 -> V_219 , V_207 , V_209 ) ;
if ( V_214 < 0 )
return 0 ;
V_21 . V_220 = V_214 ;
V_215 = V_204 -> V_217 [ V_213 ] . V_186 ;
V_216 = V_205 -> V_219 [ V_214 ] . V_186 ;
if ( V_215 != V_221 ||
V_216 != V_221 )
return 0 ;
V_21 . V_175 = V_204 -> V_53 . V_175 ;
V_21 . V_182 = V_204 -> V_53 . V_182 ;
V_21 . V_222 = V_205 -> V_53 . V_175 ;
V_21 . V_223 = V_205 -> V_53 . V_182 ;
V_21 . V_224 = false ;
V_40 = F_62 ( & V_16 -> V_27 , & V_21 ) ;
if ( ! V_40 ) {
F_56 ( V_204 -> V_217 , V_213 ) ;
F_56 ( V_205 -> V_219 , V_214 ) ;
F_57 ( V_204 -> V_217 , V_211 , V_204 ) ;
}
return V_40 ;
}
...
int V_213 , V_214 ;
F_60 ( V_16 , V_204 , V_205 ) ;
if ( V_204 -> V_192 < V_201 ||
V_205 -> V_192 < V_201 )
return 0 ;
V_213 = F_55 ( V_204 -> V_217 , V_205 , V_211 ) ;
if ( V_213 < 0 )
return - V_35 ;
V_21 . V_218 = V_213 ;
V_214 = F_55 ( V_205 -> V_219 , V_204 , V_209 ) ;
if ( V_214 < 0 ) {
F_56 ( V_204 -> V_217 , V_213 ) ;
return - V_35 ;
}
...
if ( ! V_40 ) {
V_204 -> V_192 = V_225 ;
V_204 -> V_217 [ V_213 ] . V_186 = V_221 ;
V_205 -> V_219 [ V_214 ] . V_186 = V_221 ;
} else {
F_56 ( V_204 -> V_217 , V_213 ) ;
F_56 ( V_205 -> V_219 , V_214 ) ;
}
...
static int F_64 ( struct V_15 * V_16 , struct V_226 * V_109 ,
enum V_227 V_196 )
{
F_30 ( V_16 -> V_2 , L_15 , V_195 , V_196 ) ;
return F_65 ( & V_16 -> V_27 , V_109 -> V_198 , V_196 ) ;
}
int F_66 ( struct V_15 * V_16 , struct V_226 * V_109 )
{
int V_40 ;
F_30 ( V_16 -> V_2 , L_16 , V_195 , V_109 -> V_198 ) ;
V_40 = F_67 ( & V_16 -> V_27 , V_109 -> V_228 ,
V_109 -> V_229 , V_109 -> V_198 ) ;
if ( V_40 < 0 ) {
F_28 ( V_16 -> V_2 , L_17 ) ;
return V_40 ;
}
...
int F_68 ( struct V_15 * V_16 , struct V_226 * V_109 )
{
int V_40 ;
F_30 ( V_16 -> V_2 , L_18 , V_195 , V_109 -> V_198 ) ;
if ( V_109 -> V_196 > V_230 ) {
V_40 = F_64 ( V_16 , V_109 , V_231 ) ;
if ( V_40 < 0 ) {
F_28 ( V_16 -> V_2 , L_19 ) ;
return V_40 ;
}
...
return 0 ;
V_40 = F_69 ( & V_16 -> V_27 , V_109 -> V_198 ) ;
if ( V_40 < 0 )
F_28 ( V_16 -> V_2 , L_20 ) ;
V_109 -> V_196 = V_233 ;
}
...
int F_70 ( struct V_15 * V_16 , struct V_226 * V_109 )
{
int V_40 ;
F_30 ( V_16 -> V_2 , L_18 , V_195 , V_109 -> V_198 ) ;
if ( V_109 -> V_196 < V_197 )
...
int F_71 ( struct V_15 * V_16 , struct V_226 * V_109 )
{
int V_40 ;
F_30 ( V_16 -> V_2 , L_23 , V_195 , V_109 -> V_198 ) ;
if ( V_109 -> V_196 < V_232 )
return 0 ;
V_40 = F_64 ( V_16 , V_109 , V_231 ) ;
if ( V_40 < 0 ) {
F_30 ( V_16 -> V_2 , L_24 ) ;
...
int F_72 ( struct V_15 * V_16 , V_28 * V_66 , int V_5 ,
V_28 V_235 , struct V_72 * V_190 )
{
struct V_20 V_21 ;
V_21 . V_175 = V_190 -> V_53 . V_175 ;
V_21 . V_182 = V_190 -> V_53 . V_182 ;
V_21 . V_26 = V_5 ;
V_21 . V_24 = V_235 ;
...
V_21 . V_26 = V_5 ;
V_21 . V_24 = V_235 ;
return F_74 ( & V_16 -> V_27 , & V_21 , V_66 ) ;
}
