...
break;
F_68 ( V_114 L_4
L_5 , V_48 -> V_7 , V_48 -> V_51 , V_48 -> V_34 ,
V_48 -> V_54 ) ;
for ( V_112 = 0 ; V_112 < V_48 -> V_59 ; ++ V_112 ) {
F_68 ( V_116 L_6 ,
V_48 -> V_57 [ V_112 ] -> V_115 ) ;
}
if ( V_55 -> V_89 == V_48 )
F_68 ( V_116 L_7 ,
V_55 -> V_90 - V_48 -> V_7 ) ;
...
F_68 ( V_116 L_6 ,
V_4 -> V_77 [ V_11 ] -> V_57 [ V_112 ] -> V_115 ) ;
}
}
F_68 ( V_116 L_8 ) ;
...
struct V_27 * F_69 ( struct V_61 * V_62 ,
...
if ( ! F_62 ( & V_2 -> V_102 ) )
F_27 ( V_2 ) ;
F_75 ( V_28 -> V_36 , F_62 ( & V_28 -> V_34 ) == 0 ,
5 * V_121 ) ;
F_67 ( V_28 -> V_62 -> V_2 ,
