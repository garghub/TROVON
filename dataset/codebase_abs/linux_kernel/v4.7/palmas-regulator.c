...
static int F_30 ( struct V_156 * V_11 ,
struct V_157 * V_158 ,
struct V_69 * V_70 ,
struct V_16 * V_17 )
{
...
T_1 V_160 ;
int V_161 , V_37 ;
V_159 = F_31 ( V_158 , L_12 ) ;
if ( ! V_159 ) {
F_32 ( V_11 , L_13 ) ;
return 0 ;
}
V_37 = F_33 ( V_11 , V_159 , V_17 -> V_114 ,
V_17 -> V_76 ) ;
F_34 ( V_159 ) ;
if ( V_37 < 0 ) {
F_13 ( V_11 , L_14 , V_37 ) ;
...
for ( V_161 = 0 ; V_161 < V_17 -> V_76 ; V_161 ++ ) {
static struct F_33 * V_162 ;
struct V_43 * V_163 ;
struct V_157 * V_164 ;
V_162 = & V_17 -> V_114 [ V_161 ] ;
V_164 = V_162 -> V_113 ;
if ( ! V_162 -> V_109 || ! V_164 )
continue;
V_163 = F_35 ( V_11 , sizeof( * V_163 ) , V_165 ) ;
if ( ! V_163 )
return - V_166 ;
V_70 -> V_110 [ V_161 ] = V_162 -> V_109 ;
V_70 -> V_44 [ V_161 ] = V_163 ;
V_163 -> V_52 = F_36 ( V_164 , L_15 ) ;
V_37 = F_37 ( V_164 , L_16 , & V_160 ) ;
if ( V_37 != - V_31 ) {
int V_167 ;
V_167 = V_168 ;
if ( ! V_37 ) {
...
V_37 = F_37 ( V_164 , L_18 , & V_160 ) ;
if ( ! V_37 )
V_163 -> V_50 = V_160 ;
V_37 = F_36 ( V_164 , L_19 ) ;
if ( V_37 )
V_163 -> V_58 = V_142 ;
if ( V_161 == V_66 )
V_70 -> V_96 = F_36 (
...
V_70 -> V_97 = F_36 ( V_158 , L_21 ) ;
return 0 ;
}
static int F_40 ( struct V_171 * V_172 )
{
struct V_1 * V_1 = F_41 ( V_172 -> V_11 . V_173 ) ;
struct V_69 * V_70 = F_42 ( & V_172 -> V_11 ) ;
struct V_157 * V_158 = V_172 -> V_11 . V_113 ;
struct V_16 * V_174 ;
struct V_72 V_73 = { } ;
struct V_14 * V_15 ;
const char * V_71 ;
const struct V_175 * V_162 ;
int V_37 = 0 ;
unsigned int V_2 ;
V_162 = F_43 ( F_44 ( V_176 ) , & V_172 -> V_11 ) ;
if ( ! V_162 )
return - V_177 ;
V_174 = (struct V_16 * ) V_162 -> V_178 ;
V_70 = F_35 ( & V_172 -> V_11 , sizeof( * V_70 ) , V_165 ) ;
if ( ! V_70 )
return - V_166 ;
V_15 = F_35 ( & V_172 -> V_11 , sizeof( * V_15 ) , V_165 ) ;
if ( ! V_15 )
return - V_166 ;
if ( F_45 ( V_158 , L_22 ) ) {
V_179 [ V_180 ] . V_22 =
...
V_15 -> V_11 = & V_172 -> V_11 ;
V_15 -> V_1 = V_1 ;
V_1 -> V_15 = V_15 ;
F_46 ( V_172 , V_15 ) ;
V_15 -> V_1 -> V_18 = V_174 ;
V_37 = F_30 ( & V_172 -> V_11 , V_158 , V_70 , V_174 ) ;
if ( V_37 )
return V_37 ;
V_37 = F_1 ( V_1 , V_183 , & V_2 ) ;
if ( V_37 )
return V_37 ;
if ( V_2 & V_184 )
V_15 -> V_126 = 1 ;
...
V_73 . V_11 = & V_172 -> V_11 ;
V_73 . V_174 = V_15 ;
V_71 = V_172 -> V_77 ;
V_37 = V_174 -> V_186 ( V_15 , V_174 , V_70 , V_71 ,
V_73 ) ;
if ( V_37 )
return V_37 ;
V_37 = V_174 -> V_187 ( V_15 , V_174 , V_70 , V_71 ,
V_73 ) ;
return V_37 ;
}
