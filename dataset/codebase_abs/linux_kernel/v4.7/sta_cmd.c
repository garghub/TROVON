...
struct V_387 * V_369 )
{
struct V_388 * V_389 = & V_4 -> V_11 . V_389 ;
V_292 V_390 ;
V_4 -> V_6 = F_2 ( V_391 ) ;
V_4 -> V_8 = F_2 ( sizeof( * V_389 ) + V_10 ) ;
V_389 -> V_13 = F_2 ( V_5 ) ;
if ( V_5 == V_28 ) {
memcpy ( V_389 -> V_392 , V_369 -> V_392 , V_393 ) ;
memcpy ( V_389 -> V_394 , V_369 -> V_394 , V_395 ) ;
V_390 = F_48 ( ( V_396 * ) V_369 -> V_397 ) ;
V_389 -> V_398 = F_15 ( ( T_2 ) V_390 ) ;
V_389 -> V_399 =
F_15 ( ( T_2 ) ( ( V_292 ) V_390 >> 32 ) ) ;
}
return 0 ;
}
static int
...
struct V_400 * V_401 =
& V_4 -> V_11 . V_401 ;
struct V_402 * V_403 = V_79 ;
struct V_404 * V_228 ;
T_1 V_405 , V_406 , V_60 ;
struct V_407 * V_408 ;
V_4 -> V_6 = F_2 ( V_409 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
V_401 -> V_13 = F_2 ( V_5 ) ;
V_401 -> V_410 = F_2 ( V_403 -> V_410 ) ;
V_408 = V_401 -> V_408 ;
for ( V_405 = 0 ; V_405 < V_403 -> V_410 ; V_405 ++ ) {
V_408 -> V_231 . type = F_2 ( V_411 ) ;
V_408 -> V_412 =
F_2 ( V_403 -> V_408 [ V_405 ] . V_412 ) ;
V_408 -> V_413 = V_403 -> V_408 [ V_405 ] . V_413 ;
V_408 -> V_414 = V_403 -> V_408 [ V_405 ] . V_414 ;
V_60 = 0 ;
V_228 = V_408 -> V_11 ;
for ( V_406 = 0 ; V_406 < V_403 -> V_408 [ V_405 ] . V_414 ; V_406 ++ ) {
V_228 -> V_415 = V_403 -> V_408 [ V_405 ] . V_11 [ V_406 ] . V_415 ;
V_228 -> V_416 =
V_403 -> V_408 [ V_405 ] . V_11 [ V_406 ] . V_416 ;
V_228 -> V_264 =
F_2 ( V_403 -> V_408 [ V_405 ] . V_11 [ V_406 ] . V_264 ) ;
memcpy ( V_228 -> V_417 ,
V_403 -> V_408 [ V_405 ] . V_11 [ V_406 ] . V_417 ,
V_228 -> V_416 ) ;
V_60 += sizeof( struct V_404 ) ;
V_228 ++ ;
}
V_408 -> V_231 . V_168 = F_2 ( V_60 + sizeof( T_1 ) +
sizeof( V_58 ) + sizeof( V_58 ) ) ;
F_6 ( & V_4 -> V_8 , F_7 ( V_408 -> V_231 . V_168 ) +
sizeof( struct V_61 ) ) ;
V_408 = ( void * ) ( ( V_58 * ) V_408 -> V_11 + V_60 ) ;
}
...
T_1 V_5 , void * V_79 )
{
struct V_418 * V_419 = & V_4 -> V_11 . V_419 ;
struct V_420 * V_421 ;
struct V_422 * V_423 ;
T_1 V_168 ;
V_4 -> V_6 = F_2 ( V_424 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
V_419 -> V_425 = F_2 ( V_5 ) ;
F_6 ( & V_4 -> V_8 , sizeof( V_419 -> V_425 ) ) ;
switch ( V_5 ) {
case V_426 :
V_423 = V_79 ;
V_168 = sizeof( * V_423 ) ;
memcpy ( V_419 -> V_427 , V_423 , V_168 ) ;
break;
case V_428 :
V_421 = V_79 ;
V_168 = sizeof( * V_421 ) ;
memcpy ( V_419 -> V_427 , V_421 , V_168 ) ;
break;
case V_429 :
V_168 = sizeof( struct V_430 ) ;
memcpy ( V_419 -> V_427 , V_79 , V_168 ) ;
break;
case V_431 :
V_168 = sizeof( struct V_432 ) ;
memcpy ( V_419 -> V_427 , V_79 , V_168 ) ;
break;
default:
F_4 ( V_2 -> V_29 , ERROR ,
...
void * V_79 )
{
struct V_434 * V_435 = & V_4 -> V_11 . V_435 ;
struct V_436 * V_437 = V_79 ;
struct V_438 * V_439 ;
struct V_440 * V_441 ;
struct V_442 * V_443 ;
struct V_444 * V_445 ;
...
V_58 * V_315 , V_454 ;
T_1 V_455 = 0 ;
struct V_456 * V_11 = V_2 -> V_457 ;
V_4 -> V_6 = F_2 ( V_458 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
F_6 ( & V_4 -> V_8 , sizeof( struct V_434 ) ) ;
V_435 -> V_459 = 0 ;
memcpy ( V_435 -> V_460 , V_437 -> V_460 , V_126 ) ;
V_439 = F_52 ( V_2 , V_437 -> V_460 ) ;
V_315 = ( V_58 * ) V_435 + sizeof( struct V_434 ) ;
switch ( V_437 -> V_425 ) {
case V_461 :
V_435 -> V_425 = F_2 ( V_462 ) ;
break;
case V_463 :
V_435 -> V_425 = F_2 ( V_464 ) ;
break;
case V_465 :
V_435 -> V_425 = F_2 ( V_466 ) ;
if ( ! V_11 ) {
F_4 ( V_2 -> V_29 , ERROR ,
L_32 ,
V_437 -> V_460 ) ;
...
* ( V_43 * ) V_315 = F_2 ( V_11 -> V_468 ) ;
V_455 += sizeof( V_11 -> V_468 ) ;
V_454 = V_11 -> V_469 | ( V_11 -> V_470 << 5 ) ;
V_445 = (struct V_444 * ) ( V_315 +
V_455 ) ;
V_445 -> V_231 . type = F_2 ( V_471 ) ;
V_445 -> V_231 . V_168 = F_2 ( sizeof( V_454 ) ) ;
V_445 -> V_454 = V_454 ;
V_455 += sizeof( struct V_444 ) ;
if ( V_11 -> V_472 ) {
V_443 = (struct V_442 * ) ( V_315 +
V_455 ) ;
V_443 -> V_231 . type =
F_2 ( V_473 ) ;
V_443 -> V_231 . V_168 =
F_2 ( sizeof( struct V_474 ) ) ;
memcpy ( & V_443 -> V_475 , V_11 -> V_472 ,
sizeof( struct V_474 ) ) ;
V_455 += sizeof( struct V_442 ) ;
}
if ( V_11 -> V_476 && V_11 -> V_477 ) {
V_441 = (struct V_440 * ) ( V_315 +
V_455 ) ;
V_441 -> V_231 . type =
F_2 ( V_478 ) ;
V_441 -> V_231 . V_168 =
F_2 ( V_11 -> V_477 ) ;
memcpy ( V_441 -> V_479 , V_11 -> V_476 ,
V_11 -> V_477 ) ;
V_455 += sizeof( struct V_440 ) +
V_11 -> V_477 ;
}
if ( V_11 -> V_480 && V_11 -> V_481 ) {
V_447 = (struct V_446 * ) ( V_315 +
V_455 ) ;
V_447 -> V_231 . type =
F_2 ( V_482 ) ;
V_447 -> V_231 . V_168 = F_2 ( V_11 -> V_481 ) ;
memcpy ( V_447 -> V_480 , V_11 -> V_480 ,
V_11 -> V_481 ) ;
V_455 += sizeof( struct V_446 ) +
V_11 -> V_481 ;
}
if ( V_11 -> V_483 ) {
V_449 = (struct V_448 * ) ( V_315 +
V_455 ) ;
V_449 -> V_231 . type =
F_2 ( V_484 ) ;
V_449 -> V_231 . V_168 =
F_2 ( sizeof( struct V_485 ) ) ;
memcpy ( & V_449 -> V_486 , V_11 -> V_483 ,
sizeof( struct V_485 ) ) ;
V_455 += sizeof( struct V_448 ) ;
}
if ( V_11 -> V_451 ) {
V_451 = (struct V_450 * ) ( V_315 + V_455 ) ;
V_451 -> V_231 . type = F_2 ( V_487 ) ;
V_451 -> V_231 . V_168 = F_2 ( sizeof( V_11 -> V_451 ) ) ;
V_451 -> V_451 = F_2 ( V_11 -> V_451 ) ;
V_455 += sizeof( struct V_450 ) ;
}
V_453 = ( void * ) ( V_315 + V_455 ) ;
V_453 -> V_231 . type = F_2 ( V_488 ) ;
V_453 -> V_231 . V_168 = F_2 ( sizeof( V_453 -> V_44 ) ) ;
V_453 -> V_44 = F_2 ( V_489 ) ;
V_455 += sizeof( struct V_452 ) ;
break;
default:
...
V_4 -> V_6 = F_2 ( V_492 ) ;
V_4 -> V_8 =
F_2 ( sizeof( struct V_490 ) +
V_10 ) ;
V_403 -> V_13 = V_5 ;
if ( V_5 == V_28 )
V_403 -> V_246 = * ( V_58 * ) V_79 ;
return 0 ;
}
...
{
V_4 -> V_6 = F_2 ( V_493 ) ;
V_4 -> V_8 = F_2 ( sizeof( struct V_494 ) +
V_10 ) ;
return 0 ;
}
int F_55 ( struct V_1 * V_2 , T_4 V_495 ,
T_1 V_5 , T_2 V_31 ,
void * V_79 , void * V_496 )
{
struct V_3 * V_497 = V_496 ;
int V_223 = 0 ;
switch ( V_495 ) {
case V_498 :
V_223 = F_56 ( V_2 , V_497 ) ;
break;
case V_368 :
V_223 = F_43 ( V_2 , V_497 , V_79 ) ;
break;
case V_30 :
V_223 = F_3 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_121 :
V_223 = F_16 ( V_2 , V_497 ,
V_5 ) ;
break;
case V_132 :
V_223 = F_17 ( V_497 , V_5 ,
V_79 ) ;
break;
case V_56 :
V_223 = F_9 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_77 :
V_223 = F_11 ( V_497 , V_5 ,
V_79 ) ;
break;
case V_81 :
V_223 = F_12 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_88 :
V_223 = F_13 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_499 :
V_223 = F_57 ( V_2 , V_497 , V_5 ,
( T_4 ) V_31 , V_79 ) ;
break;
case V_108 :
V_223 = F_14 ( V_2 , V_497 , V_5 ,
(struct V_101 * ) V_79 ) ;
break;
case V_500 :
V_223 = F_58 ( V_497 , V_79 ) ;
break;
case V_501 :
V_223 = F_59 ( V_2 , V_497 ,
V_79 ) ;
break;
case V_502 :
V_223 = F_60 ( V_497 ) ;
break;
case V_503 :
V_223 = F_61 ( V_2 , V_497 , V_79 ) ;
break;
case V_139 :
V_223 = F_18 ( V_2 , V_497 ,
V_79 ) ;
break;
case V_504 :
V_223 = F_62 ( V_2 , V_497 ,
V_79 ) ;
break;
case V_45 :
V_223 = F_8 ( V_497 ) ;
...
break;
case V_7 :
V_223 = F_1 ( V_2 , V_497 , V_5 ) ;
break;
case V_37 :
V_223 = F_5 ( V_2 , V_497 , V_5 ,
V_31 , V_79 ) ;
break;
case V_506 :
V_497 -> V_6 =
...
case V_509 :
V_497 -> V_6 = F_2 ( V_495 ) ;
V_497 -> V_11 . V_510 . V_511 =
( V_58 ) ( * ( ( T_2 * ) V_79 ) ) ;
memcpy ( & V_497 -> V_11 , V_79 ,
sizeof( struct V_512 ) ) ;
V_497 -> V_8 =
F_2 ( sizeof( struct V_512 ) +
V_10 ) ;
V_223 = 0 ;
break;
case V_513 :
V_497 -> V_6 = F_2 ( V_495 ) ;
V_497 -> V_11 . V_514 . V_13 = F_2 ( V_5 ) ;
V_497 -> V_11 . V_514 . V_515 = F_15 ( * ( T_2 * ) V_79 ) ;
V_497 -> V_8 =
...
sizeof( struct V_518 ) ) ;
V_497 -> V_8 =
F_2 ( sizeof( struct V_518 ) +
V_10 ) ;
break;
case V_519 :
V_223 = F_64 ( V_2 , V_497 , V_5 , V_79 ) ;
break;
case V_520 :
V_497 -> V_6 = F_2 ( V_495 ) ;
V_497 -> V_11 . V_521 . V_13 = F_2 ( V_5 ) ;
V_497 -> V_11 . V_521 . V_78 = F_2 ( * ( T_1 * ) V_79 ) ;
V_497 -> V_8 =
F_2 ( sizeof( struct V_522 ) +
V_10 ) ;
break;
case V_523 :
if ( V_2 -> V_29 -> V_524 == V_525 )
V_2 -> V_29 -> V_524 = V_526 ;
V_497 -> V_6 = F_2 ( V_495 ) ;
V_497 -> V_8 = F_2 ( V_10 ) ;
break;
case V_527 :
V_2 -> V_29 -> V_524 = V_525 ;
V_497 -> V_6 = F_2 ( V_495 ) ;
V_497 -> V_8 = F_2 ( V_10 ) ;
break;
case V_528 :
V_223 = F_65 ( V_497 , V_79 ) ;
break;
case V_529 :
V_223 = F_66 ( V_497 , V_79 ) ;
break;
case V_530 :
V_223 = F_67 ( V_2 , V_497 , V_79 ) ;
break;
case V_187 :
V_223 = F_27 ( V_2 , V_497 ,
V_5 , V_31 ,
V_79 ) ;
break;
case V_241 :
V_223 = F_28 ( V_2 , V_497 ,
V_5 ) ;
break;
case V_531 :
V_223 = F_68 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_532 :
V_223 = F_69 ( V_497 , V_5 ,
V_79 ) ;
break;
case V_533 :
V_223 = F_70 ( V_2 , V_497 , V_5 , V_79 ) ;
break;
case V_534 :
F_4 ( V_2 -> V_29 , V_36 ,
L_34 ) ;
...
break;
case V_250 :
V_223 = F_29 ( V_497 , V_5 ,
V_79 ) ;
break;
case V_536 :
V_223 = F_71 ( V_2 , V_497 , V_79 ) ;
break;
case V_257 :
V_223 = F_30 ( V_497 , V_5 , V_79 ) ;
break;
case V_261 :
case V_265 :
case V_268 :
...
case V_274 :
case V_276 :
V_223 = F_31 ( V_497 , V_5 , V_79 ) ;
break;
case V_537 :
V_497 -> V_6 = F_2 ( V_495 ) ;
if ( V_2 -> V_210 == V_211 )
V_497 -> V_11 . V_210 . V_538 =
V_539 ;
else if ( V_2 -> V_210 == V_540 ||
V_2 -> V_210 == V_541 )
V_497 -> V_11 . V_210 . V_538 =
V_542 ;
else if ( V_2 -> V_210 == V_543 ||
V_2 -> V_210 == V_544 )
V_497 -> V_11 . V_210 . V_538 = V_545 ;
V_497 -> V_8 = F_2 ( sizeof( struct
V_546 ) + V_10 ) ;
V_223 = 0 ;
break;
case V_288 :
V_223 = F_33 ( V_2 , V_497 , V_5 ) ;
break;
case V_316 :
V_223 = F_34 ( V_2 , V_497 , V_79 ) ;
break;
case V_352 :
V_223 = F_36 ( V_2 , V_497 , V_79 ) ;
break;
case V_409 :
V_223 = F_49 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_458 :
V_223 = F_51 ( V_2 , V_497 , V_79 ) ;
break;
case V_424 :
V_223 = F_50 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_547 :
V_223 = F_72 ( V_2 , V_497 ,
V_79 ) ;
break;
case V_492 :
V_223 = F_53 ( V_497 , V_5 ,
V_79 ) ;
break;
case V_493 :
V_223 = F_54 ( V_2 , V_497 ) ;
break;
case V_377 :
V_223 = F_45 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_383 :
V_223 = F_46 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
case V_391 :
V_223 = F_47 ( V_2 , V_497 , V_5 ,
V_79 ) ;
break;
default:
F_4 ( V_2 -> V_29 , ERROR ,
...
int F_73 ( struct V_1 * V_2 , V_58 V_548 , bool V_549 )
{
struct V_103 * V_29 = V_2 -> V_29 ;
int V_223 ;
T_1 V_246 = true ;
...
V_223 = F_42 ( V_2 , V_523 ,
V_28 , 0 , NULL , true ) ;
if ( V_223 )
return - 1 ;
if ( V_2 -> V_29 -> V_559 == V_561 &&
V_29 -> V_562 -> V_563 ) {
V_29 -> V_370 = V_29 -> V_562 -> V_563 ;
if ( F_74 ( V_29 -> V_370 ,
L_36 ,
& V_369 ) == 0 ) {
F_75 ( L_37 , V_369 ) ;
V_29 -> V_105 . V_119 = V_369 ;
}
...
V_223 = F_42 ( V_2 , V_531 ,
V_28 , 0 ,
& V_2 -> V_29 -> V_567 , true ) ;
if ( V_223 )
return - 1 ;
if ( V_2 -> V_568 != V_569 ) {
V_2 -> V_29 -> V_570 = V_571 ;
V_223 = F_42 ( V_2 ,
V_499 ,
V_572 , V_573 , NULL ,
true ) ;
...
return - 1 ;
if ( ! V_579 &&
V_548 && V_2 -> V_29 -> V_559 != V_580 &&
V_2 -> V_568 != V_569 ) {
V_553 . V_553 = V_581 ;
V_553 . V_582 = V_583 ;
V_223 = F_42 ( V_2 , V_499 ,
V_572 , V_584 ,
& V_553 , true ) ;
if ( V_223 )
return - 1 ;
...
V_557 . V_587 = V_588 ;
V_223 = F_42 ( V_2 , V_533 ,
V_28 , 0 , & V_557 , true ) ;
if ( V_549 ) {
V_2 -> V_29 -> V_589 = V_533 ;
V_223 = - V_590 ;
}
return V_223 ;
}
