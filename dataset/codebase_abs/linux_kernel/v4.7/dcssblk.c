...
void T_6 * * V_112 , T_7 * V_113 , long V_114 )
{
struct V_3 * V_4 ;
...
if ( ! V_4 )
return - V_77 ;
V_116 = V_4 -> V_20 - V_4 -> V_23 ;
V_115 = V_111 * 512 ;
* V_112 = ( void T_6 * ) ( V_4 -> V_23 + V_115 ) ;
* V_113 = F_74 ( F_75 ( V_4 -> V_23 + V_115 ) , V_117 ) ;
return V_116 - V_115 ;
}
static void
F_76 ( void )
{
int V_26 , V_24 , V_25 , V_118 ;
char V_41 [ V_119 + 1 ] ;
struct V_3 * V_4 ;
for ( V_24 = 0 ; ( V_24 < V_119 ) && ( V_120 [ V_24 ] != '\0' ) ;
V_24 ++ ) {
for ( V_25 = V_24 ; ( V_25 < V_119 ) &&
( V_120 [ V_25 ] != ',' ) &&
( V_120 [ V_25 ] != '\0' ) &&
( V_120 [ V_25 ] != '(' ) ; V_25 ++ )
{
V_41 [ V_25 - V_24 ] = V_120 [ V_25 ] ;
}
V_41 [ V_25 - V_24 ] = '\0' ;
V_26 = F_43 ( V_57 , NULL , V_41 , V_25 - V_24 ) ;
if ( ( V_26 >= 0 ) && ( V_120 [ V_25 ] == '(' ) ) {
for ( V_118 = 0 ; ( V_41 [ V_118 ] != ':' ) && ( V_41 [ V_118 ] != '\0' ) ; V_118 ++ )
V_41 [ V_118 ] = toupper ( V_41 [ V_118 ] ) ;
V_41 [ V_118 ] = '\0' ;
if ( ! strncmp ( & V_120 [ V_25 ] , L_30 , 7 ) ) {
F_17 ( & V_36 ) ;
V_4 = F_9 ( V_41 ) ;
F_18 ( & V_36 ) ;
if ( V_4 )
...
V_26 = F_92 ( V_57 , & V_127 ) ;
if ( V_26 )
goto V_128;
V_26 = F_92 ( V_57 , & V_129 ) ;
if ( V_26 )
goto V_128;
V_26 = F_93 ( 0 , V_124 ) ;
if ( V_26 < 0 )
