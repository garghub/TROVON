...
int F_72 ( struct V_1 * V_2 , struct V_36 * V_37 ,
struct V_79 * V_80 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_28 * V_29 = V_7 -> V_30 ;
...
F_36 ( V_2 ) ;
F_76 ( & V_37 -> V_78 , & V_2 -> V_77 ) ;
F_77 ( V_37 ) ;
F_54 ( V_2 ) ;
for ( V_13 = 0 ; V_13 < V_37 -> V_70 ; V_13 ++ ) {
struct V_71 * V_72 = V_37 -> V_73 [ V_13 ] . V_74 ;
T_1 V_81 ;
F_26 ( F_78 ( V_72 ) && ( V_72 -> V_2 != V_2 ) ) ;
F_79 ( & V_72 -> V_75 ) ;
F_80 ( & V_72 -> V_75 ,
V_37 -> V_2 -> V_76 , & V_81 ) ;
if ( V_37 -> V_73 [ V_13 ] . V_62 & V_82 )
F_81 ( & V_72 -> V_75 , V_2 , true , V_37 -> V_38 ) ;
else if ( V_37 -> V_73 [ V_13 ] . V_62 & V_83 )
F_81 ( & V_72 -> V_75 , V_2 , false , V_37 -> V_38 ) ;
}
...
static T_3 F_82 ( int V_85 , void * V_27 )
{
struct V_1 * V_2 = V_27 ;
return V_2 -> V_39 -> V_85 ( V_2 ) ;
}
int F_83 ( struct V_6 * V_86 , struct V_87 * V_88 ,
...
( unsigned long ) V_2 ) ;
F_88 ( & V_2 -> V_63 ) ;
F_89 ( F_14 ( V_97 ) != F_14 ( V_2 -> V_14 ) ) ;
V_2 -> V_98 = F_90 ( V_88 , V_90 , V_19 ) ;
if ( F_74 ( V_2 -> V_98 ) ) {
V_8 = F_75 ( V_2 -> V_98 ) ;
goto V_95;
}
V_2 -> V_85 = F_91 ( V_88 , V_91 ) ;
if ( V_2 -> V_85 < 0 ) {
V_8 = V_2 -> V_85 ;
F_10 ( V_86 -> V_7 , L_13 , V_8 ) ;
goto V_95;
}
V_8 = F_92 ( & V_88 -> V_7 , V_2 -> V_85 , F_82 ,
V_99 , V_2 -> V_19 , V_2 ) ;
if ( V_8 ) {
...
V_2 -> V_14 [ V_13 ] = F_93 ( & V_88 -> V_7 , V_97 [ V_13 ] ) ;
F_3 ( L_15 , V_97 [ V_13 ] , V_2 -> V_14 [ V_13 ] ) ;
if ( F_74 ( V_2 -> V_14 [ V_13 ] ) )
V_2 -> V_14 [ V_13 ] = NULL ;
}
V_2 -> V_17 = F_93 ( & V_88 -> V_7 , L_16 ) ;
F_3 ( L_17 , V_2 -> V_17 ) ;
if ( F_74 ( V_2 -> V_17 ) )
V_2 -> V_17 = NULL ;
V_2 -> V_9 = F_94 ( & V_88 -> V_7 , L_18 ) ;
F_3 ( L_19 , V_2 -> V_9 ) ;
if ( F_74 ( V_2 -> V_9 ) )
V_2 -> V_9 = NULL ;
V_2 -> V_10 = F_94 ( & V_88 -> V_7 , L_20 ) ;
F_3 ( L_21 , V_2 -> V_10 ) ;
if ( F_74 ( V_2 -> V_10 ) )
V_2 -> V_10 = NULL ;
V_94 = F_95 ( & V_100 ) ;
if ( V_94 ) {
F_96 ( V_86 -> V_7 , L_22 , V_19 ) ;
V_2 -> V_101 = F_97 ( & V_88 -> V_7 , V_94 ) ;
if ( F_74 ( V_2 -> V_101 ) ) {
V_8 = F_75 ( V_2 -> V_101 ) ;
...
F_96 ( V_86 -> V_7 , L_24 , V_19 ) ;
}
V_2 -> V_76 = F_99 ( V_86 , V_2 -> V_101 ) ;
F_31 ( & V_86 -> V_21 ) ;
V_2 -> V_102 = F_100 ( V_2 , V_92 ) ;
F_33 ( & V_86 -> V_21 ) ;
if ( F_74 ( V_2 -> V_102 ) ) {
V_8 = F_75 ( V_2 -> V_102 ) ;
V_2 -> V_102 = NULL ;
