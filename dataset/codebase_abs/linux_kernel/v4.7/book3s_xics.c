...
int F_77 ( struct V_146 * V_147 , struct V_60 * V_48 ,
T_1 V_157 )
{
struct V_1 * V_2 = V_147 -> V_95 ;
int V_158 = - V_159 ;
...
int F_81 ( struct V_31 * V_31 , unsigned V_170 , unsigned V_171 )
{
return V_171 ;
}
