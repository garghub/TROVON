...
static int F_533 ( struct V_359 * V_111 , struct V_1985 * V_637 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( F_23 ( V_5 , V_266 ) ) {
struct V_211 * V_212 ;
...
F_535 ( V_637 , V_5 -> V_324 . V_325 ) ;
V_637 -> V_371 = V_5 -> V_324 . V_328 ;
V_637 -> V_1999 = V_5 -> V_324 . V_364 ;
if ( ! ( V_5 -> V_178 & V_354 ) ) {
if ( V_5 -> V_178 & V_818 )
V_637 -> V_2000 = V_2001 ;
else
...
static int F_536 ( struct V_359 * V_111 , struct V_1985 * V_637 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
T_1 V_367 = F_537 ( V_637 ) ;
if ( F_23 ( V_5 , V_266 ) ) {
struct V_211 * V_212 ;
if ( ! ( V_5 -> V_178 & V_386 ) )
return - V_85 ;
...
static void F_539 ( struct V_359 * V_111 , struct V_2010 * V_982 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
F_540 ( V_982 -> V_2011 , V_2012 , sizeof( V_982 -> V_2011 ) ) ;
F_540 ( V_982 -> V_1969 , V_2013 , sizeof( V_982 -> V_1969 ) ) ;
F_540 ( V_982 -> V_2014 , V_5 -> V_2015 , sizeof( V_982 -> V_2014 ) ) ;
F_540 ( V_982 -> V_2016 , F_541 ( V_5 -> V_12 ) , sizeof( V_982 -> V_2016 ) ) ;
}
static void F_542 ( struct V_359 * V_111 , struct V_2017 * V_2018 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
V_2018 -> V_2020 = V_2019 ;
memset ( & V_2018 -> V_2021 , 0 , sizeof( V_2018 -> V_2021 ) ) ;
}
static int F_544 ( struct V_359 * V_111 , struct V_2017 * V_2018 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
struct V_538 * V_2022 = & V_5 -> V_12 -> V_111 ;
if ( V_2018 -> V_2020 & ~ V_2019 )
return - V_64 ;
if ( ( V_2018 -> V_2020 & V_2019 ) &&
! ( F_23 ( V_5 , V_712 ) && F_543 ( V_2022 ) ) )
return - V_64 ;
F_545 ( V_2022 , V_2018 -> V_2020 & V_2019 ) ;
if ( F_44 ( V_2022 ) )
F_84 ( V_5 , V_112 ) ;
else
F_86 ( V_5 , V_112 ) ;
...
static void F_547 ( struct V_359 * V_111 , T_1 V_2024 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
V_5 -> V_2023 = V_2024 ;
}
...
if ( ! ( V_5 -> V_178 & V_386 ) )
return - V_85 ;
V_2025 = F_123 ( F_74 ( V_5 -> V_213 , V_5 -> V_160 ) ) ;
} else {
T_1 V_769 ;
F_70 ( & V_5 -> V_209 ) ;
V_2025 = - V_64 ;
...
static void F_549 ( struct V_359 * V_111 , struct V_2026 * V_2027 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
V_2027 -> V_2028 = V_5 -> V_1133 ;
if ( F_23 ( V_5 , V_1340 ) )
V_2027 -> V_2029 = V_5 -> V_1138 ;
else
V_2027 -> V_2029 = 0 ;
V_2027 -> V_2030 = V_1091 - 1 ;
V_2027 -> V_1338 = V_5 -> V_1338 ;
if ( F_23 ( V_5 , V_1340 ) )
V_2027 -> V_1342 = V_5 -> V_1342 ;
else
V_2027 -> V_1342 = 0 ;
V_2027 -> V_1083 = V_5 -> V_123 [ 0 ] . V_1083 ;
}
static int F_550 ( struct V_359 * V_111 , struct V_2026 * V_2027 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_42 , V_125 = 0 , V_75 = 0 ;
if ( ( V_2027 -> V_1338 > V_5 -> V_1133 ) ||
( V_2027 -> V_1342 > V_5 -> V_1138 ) ||
( V_2027 -> V_1083 > V_1091 - 1 ) ||
( V_2027 -> V_1083 <= V_1315 ) ||
( F_23 ( V_5 , V_1288 ) &&
( V_2027 -> V_1083 <= ( V_1315 * 3 ) ) ) )
return - V_64 ;
if ( F_146 ( V_111 ) ) {
F_124 ( V_5 ) ;
F_343 ( V_5 ) ;
...
F_243 ( V_5 , V_125 ) ;
V_5 -> V_1338 = V_2027 -> V_1338 ;
if ( F_23 ( V_5 , V_2031 ) &&
V_5 -> V_1338 > 63 )
V_5 -> V_1338 = 63 ;
if ( F_23 ( V_5 , V_1340 ) )
V_5 -> V_1342 = V_2027 -> V_1342 ;
for ( V_42 = 0 ; V_42 < V_5 -> V_122 ; V_42 ++ )
V_5 -> V_123 [ V_42 ] . V_1083 = V_2027 -> V_1083 ;
if ( F_146 ( V_111 ) ) {
F_435 ( V_5 , V_110 , 1 ) ;
...
static void F_551 ( struct V_359 * V_111 , struct V_2032 * V_2033 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
V_2033 -> V_347 = ! ! F_23 ( V_5 , V_353 ) ;
if ( V_5 -> V_324 . V_337 & V_332 )
V_2033 -> V_2034 = 1 ;
else
V_2033 -> V_2034 = 0 ;
...
static int F_552 ( struct V_359 * V_111 , struct V_2032 * V_2033 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_75 = 0 ;
if ( V_5 -> V_324 . V_347 == V_352 )
...
static int F_553 ( struct V_359 * V_111 , int V_2037 )
{
switch ( V_2037 ) {
case V_2038 :
return V_2039 ;
...
static int F_554 ( struct V_359 * V_111 , struct V_2042 * V_982 ,
T_1 * T_19 V_2043 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! F_23 ( V_5 , V_1056 ) )
...
static int F_557 ( struct V_359 * V_111 , T_1 * V_2046 , T_4 * V_2047 , T_4 * V_2048 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_42 ;
if ( V_2048 )
...
return 0 ;
for ( V_42 = 0 ; V_42 < V_1528 ; V_42 ++ )
V_2046 [ V_42 ] = V_5 -> V_1529 [ V_42 ] ;
return 0 ;
}
static int F_558 ( struct V_359 * V_111 , const T_1 * V_2046 , const T_4 * V_2047 ,
const T_4 V_2048 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
T_20 V_42 ;
if ( V_2047 ||
( V_2048 != V_2050 && V_2048 != V_2049 ) )
return - V_1032 ;
if ( ! V_2046 )
return 0 ;
for ( V_42 = 0 ; V_42 < V_1528 ; V_42 ++ )
V_5 -> V_1529 [ V_42 ] = V_2046 [ V_42 ] ;
...
struct V_2051 * V_2052 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
T_1 V_2053 = F_508 () ;
V_2052 -> V_2054 = V_5 -> V_1893 ;
V_2052 -> V_2055 = V_5 -> V_1895 ;
if ( F_146 ( V_111 ) ) {
V_2052 -> V_2056 = V_5 -> V_1214 ;
V_2052 -> V_2057 = V_5 -> V_1348 ;
} else {
if ( V_5 -> V_1892 )
V_2052 -> V_2056 = V_5 -> V_1892 ;
else
V_2052 -> V_2056 = F_322 ( V_2053 , V_5 -> V_1893 ) ;
if ( V_5 -> V_1891 )
V_2052 -> V_2057 = V_5 -> V_1891 ;
else
V_2052 -> V_2057 = F_322 ( V_2053 , V_5 -> V_1895 ) ;
}
}
...
if ( ! F_23 ( V_5 , V_1056 ) )
return - V_1032 ;
if ( V_2052 -> V_2056 > V_5 -> V_1893 ||
V_2052 -> V_2057 > V_5 -> V_1895 )
return - V_64 ;
V_5 -> V_1892 = V_2052 -> V_2056 ;
V_5 -> V_1891 = V_2052 -> V_2057 ;
if ( ! F_146 ( V_111 ) )
return 0 ;
F_519 ( V_5 ) ;
F_141 ( V_5 ) ;
...
static void F_561 ( struct V_359 * V_111 , T_1 V_2058 , T_4 * V_621 )
{
switch ( V_2058 ) {
case V_2040 :
memcpy ( V_621 , & V_2059 , sizeof( V_2059 ) ) ;
break;
case V_2038 :
...
struct V_2069 * V_1909 , T_6 * V_2070 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( V_5 -> V_1351 )
F_437 ( V_5 , (struct V_1908 * ) V_2070 ) ;
else
memset ( V_2070 , 0 , sizeof( struct V_1908 ) ) ;
}
static T_5 * F_565 ( struct V_4 * V_5 , T_1 * V_2071 )
{
int V_42 ;
T_5 * V_621 ;
T_1 V_590 = 0 , V_74 = 0 ;
...
T_4 * V_2080 ;
T_16 V_2081 ;
unsigned int V_2082 = 0 ;
V_2080 = ( T_4 * ) & V_621 [ 0 ] ;
for ( V_42 = 0 ; V_2082 < V_74 && V_42 < 3 ; V_42 ++ , V_2082 += V_2081 , V_2080 += V_2081 ) {
V_2081 = F_566 ( V_5 -> V_12 , V_2082 ,
V_74 - V_2082 , V_2080 ) ;
if ( V_2081 == - V_2083 || V_2081 == - V_1982 )
V_2081 = 0 ;
else if ( V_2081 < 0 )
goto error;
}
...
if ( V_1978 == V_1979 )
V_629 = V_2085 ;
else if ( ( V_1978 & V_2086 ) == V_2087 ) {
if ( ( V_1978 & V_2088 ) ==
V_2089 ) {
switch ( V_1978 & V_2090 ) {
case V_2091 :
V_629 = V_2092 ;
break;
case V_2093 :
...
if ( ( V_1978 & V_2086 ) ==
V_2087 ) {
T_4 * V_2106 = ( T_4 * ) V_621 , V_2107 = 0 ;
if ( ( V_1978 & V_2090 ) ==
V_2093 ) {
for ( V_42 = 0 ; V_42 < V_2108 ; V_42 ++ )
V_2107 += V_2106 [ V_42 ] ;
for ( V_42 = V_2108 + 4 ; V_42 < V_629 ; V_42 ++ )
V_2107 += V_2106 [ V_42 ] ;
} else {
...
T_4 V_72 [ V_2109 ] ;
T_4 V_2110 [ V_2109 ] ;
T_4 * V_2106 = ( T_4 * ) V_621 ;
for ( V_42 = 0 , V_622 = 0 , V_1510 = 0 ; V_42 < V_2105 ; V_42 ++ ) {
if ( ( V_42 == 0 ) || ( V_42 == 8 ) ) {
int V_2111 ;
T_4 V_2112 ;
for ( V_2111 = 0 , V_2112 = 0x80 ; V_2111 < 7 ; V_2111 ++ , V_2112 >>= 1 )
V_2110 [ V_1510 ++ ] = V_2106 [ V_42 ] & V_2112 ;
V_42 ++ ;
} else if ( V_42 == 16 ) {
int V_2111 ;
T_4 V_2112 ;
...
V_72 [ V_622 ++ ] = V_2106 [ V_42 ] ;
}
V_75 = - V_210 ;
for ( V_42 = 0 ; V_42 < V_2109 ; V_42 ++ ) {
T_4 V_2113 = F_568 ( V_72 [ V_42 ] ) ;
...
V_75 = - V_210 ;
V_2084 = F_452 ( ( unsigned char * ) V_621 , 0x10 ) ;
if ( V_2084 != F_569 ( V_621 [ 0x10 / 4 ] ) )
goto V_497;
V_2084 = F_452 ( ( unsigned char * ) & V_621 [ 0x74 / 4 ] , 0x88 ) ;
if ( V_2084 != F_569 ( V_621 [ 0xfc / 4 ] ) )
goto V_497;
F_177 ( V_621 ) ;
V_621 = F_565 ( V_5 , & V_74 ) ;
if ( ! V_621 )
return - V_267 ;
V_42 = F_570 ( ( T_4 * ) V_621 , 0 , V_74 , V_2114 ) ;
if ( V_42 > 0 ) {
V_622 = F_571 ( & ( ( T_4 * ) V_621 ) [ V_42 ] ) ;
if ( V_622 < 0 )
goto V_497;
if ( V_42 + V_2115 + V_622 > V_74 )
goto V_497;
V_42 += V_2115 ;
...
T_1 V_590 , V_2122 , V_2123 , V_7 , V_2124 , V_2125 ;
static struct {
T_3 V_590 ;
T_3 V_10 ;
#define F_576 0x1
...
for ( V_42 = 0 ; V_2126 [ V_42 ] . V_590 != 0xffff ; V_42 ++ ) {
if ( V_2120 && ( V_2126 [ V_42 ] . V_10 & F_577 ) )
continue;
if ( ! V_2120 && ( V_2126 [ V_42 ] . V_10 & F_576 ) )
continue;
if ( F_23 ( V_5 , V_1643 ) &&
( V_2126 [ V_42 ] . V_10 & F_578 ) )
continue;
if ( V_2121 && ( V_2126 [ V_42 ] . V_10 & F_579 ) )
continue;
V_590 = ( T_1 ) V_2126 [ V_42 ] . V_590 ;
...
int V_42 ;
T_1 V_622 ;
for ( V_42 = 0 ; V_42 < F_582 ( V_2131 ) ; V_42 ++ ) {
for ( V_622 = 0 ; V_622 < V_74 ; V_622 += 4 ) {
T_1 V_7 ;
F_29 ( V_5 , V_590 + V_622 , V_2131 [ V_42 ] ) ;
...
V_2139 = V_2133 ;
for ( V_42 = 0 ; V_2139 [ V_42 ] . V_590 != 0xffffffff ; V_42 ++ ) {
V_75 = F_581 ( V_5 , V_2139 [ V_42 ] . V_590 , V_2139 [ V_42 ] . V_74 ) ;
if ( V_75 )
break;
}
return V_75 ;
}
static int F_584 ( struct V_4 * V_5 , T_1 V_2140 , bool V_2141 )
{
T_1 V_2142 , V_2143 , V_2144 , V_1124 ;
T_1 V_1261 = 0 , V_1239 = 0 , V_1160 , V_126 , V_2145 , V_7 ;
T_1 V_1152 ;
struct V_1102 * V_1103 ;
T_4 * V_2146 , * V_2147 ;
T_9 V_1129 ;
...
V_75 = - V_210 ;
V_2149 = V_2140 ;
V_1103 = F_305 ( V_5 -> V_111 , V_2149 ) ;
if ( ! V_1103 )
return - V_267 ;
V_2146 = F_308 ( V_1103 , V_2149 ) ;
memcpy ( V_2146 , V_5 -> V_111 -> V_689 , V_1526 ) ;
memset ( V_2146 + V_1526 , 0x0 , 8 ) ;
F_46 ( V_1624 , V_2149 + V_1176 ) ;
if ( V_2141 ) {
struct V_1277 * V_1278 = (struct V_1277 * ) & V_2146 [ V_1194 ] ;
T_1 V_1286 = V_2152 + V_2153 +
V_2154 ;
memcpy ( V_2146 + V_1526 * 2 , V_2155 ,
sizeof( V_2155 ) ) ;
V_1239 = V_2156 ;
V_7 = V_2149 - V_1526 * 2 - sizeof( V_2155 ) ;
V_2148 = F_585 ( V_7 , V_2156 ) ;
...
F_23 ( V_5 , V_1294 ) ||
F_23 ( V_5 , V_1295 ) ) {
struct V_1279 * V_2157 ;
V_7 = V_1194 + V_2152 ;
V_2157 = (struct V_1279 * ) & V_2146 [ V_7 ] ;
V_2157 -> V_1289 = 0 ;
} else
V_1261 |= V_1296 ;
if ( F_23 ( V_5 , V_1295 ) ) {
...
V_1129 = F_294 ( V_5 -> V_12 , V_1103 -> V_72 , V_2149 , V_1111 ) ;
...
V_2151 -> V_126 ) ;
F_24 ( 10 ) ;
V_2142 = V_2151 -> V_134 -> V_145 [ 0 ] . V_1080 ;
V_1152 = F_265 ( V_131 ) ;
if ( F_365 ( V_131 , & V_7 , & V_1152 , V_1129 , V_2149 ,
...
V_2143 = V_2151 -> V_134 -> V_145 [ 0 ] . V_1080 ;
if ( ( V_2144 == V_131 -> V_1082 ) &&
...
V_7 = V_2145 ;
while ( V_2143 != V_2142 ) {
V_1128 = & V_2151 -> V_1158 [ V_2142 ++ ] ;
V_1160 = V_1128 -> V_1163 & V_1164 ;
V_1124 = V_1128 -> V_1163 & V_1165 ;
if ( ( V_1128 -> V_1167 & V_1168 ) != 0 &&
( V_1128 -> V_1167 != V_2158 ) )
goto V_497;
V_2150 = ( ( V_1128 -> V_1173 & V_1174 ) >> V_1175 )
- V_1176 ;
if ( ! V_2141 ) {
if ( V_2150 != V_2149 )
goto V_497;
if ( V_2140 <= V_1332 - V_1176 ) {
if ( V_1124 != V_1132 )
goto V_497;
} else {
if ( V_1124 != V_1137 )
...
if ( V_1124 == V_1132 ) {
V_2147 = V_1123 -> V_1135 [ V_1160 ] . V_72 ;
V_1129 = F_272 ( & V_1123 -> V_1135 [ V_1160 ] ,
V_1110 ) ;
} else if ( V_1124 == V_1137 ) {
V_2147 = V_1123 -> V_1141 [ V_1160 ] . V_72 ;
V_1129 = F_272 ( & V_1123 -> V_1141 [ V_1160 ] ,
V_1110 ) ;
} else
goto V_497;
F_306 ( V_5 -> V_12 , V_1129 , V_2150 ,
V_1120 ) ;
V_2147 += F_291 ( V_5 ) ;
...
static int F_587 ( struct V_4 * V_5 , T_6 * V_72 , bool V_2159 )
{
int V_75 = - V_210 ;
T_1 V_2160 ;
T_1 V_2161 = 9000 ;
if ( V_5 -> V_1252 )
V_2161 = V_5 -> V_1252 - V_1194 ;
V_2160 = V_5 -> V_178 & V_333 ;
V_5 -> V_178 &= ~ V_333 ;
if ( ! F_146 ( V_5 -> V_111 ) ) {
V_72 [ V_2162 ] = V_2163 ;
V_72 [ V_2164 ] = V_2163 ;
...
! F_23 ( V_5 , V_152 ) ) {
F_395 ( V_5 , true ) ;
if ( F_584 ( V_5 , V_2166 , false ) )
V_72 [ V_2162 ] |= V_2167 ;
if ( F_23 ( V_5 , V_1340 ) &&
F_584 ( V_5 , V_2161 + V_1194 , false ) )
V_72 [ V_2162 ] |= V_2168 ;
F_395 ( V_5 , false ) ;
}
if ( ! ( V_5 -> V_178 & V_562 ) &&
...
static void F_588 ( struct V_359 * V_111 , struct V_2170 * V_2171 ,
T_6 * V_72 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
...
if ( F_199 ( V_5 ) ) {
V_2171 -> V_10 |= V_2174 ;
memset ( V_72 , 1 , sizeof( T_6 ) * V_2039 ) ;
return;
}
F_42 ( V_5 , V_96 ) ;
}
memset ( V_72 , 0 , sizeof( T_6 ) * V_2039 ) ;
if ( F_567 ( V_5 ) != 0 ) {
V_2171 -> V_10 |= V_2174 ;
V_72 [ V_2175 ] = 1 ;
}
...
static int F_589 ( struct V_359 * V_111 , struct V_2182 * V_2183 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
struct V_2184 V_2185 ;
if ( ! F_23 ( V_5 , V_987 ) )
return - V_1032 ;
if ( F_590 ( & V_2185 , V_2183 -> V_2186 , sizeof( V_2185 ) ) )
return - V_2187 ;
if ( V_2185 . V_10 )
return - V_64 ;
if ( V_2185 . V_2188 != V_995 &&
V_2185 . V_2188 != V_994 )
return - V_2189 ;
...
F_86 ( V_5 , V_1309 ) ;
return F_591 ( V_2183 -> V_2186 , & V_2185 , sizeof( V_2185 ) ) ?
- V_2187 : 0 ;
}
static int F_592 ( struct V_359 * V_111 , struct V_2182 * V_2183 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
struct V_2184 V_2185 ;
if ( ! F_23 ( V_5 , V_987 ) )
...
static int F_594 ( struct V_359 * V_111 , struct V_2182 * V_2183 , int V_637 )
{
struct V_2208 * V_72 = F_595 ( V_2183 ) ;
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_75 ;
if ( F_23 ( V_5 , V_266 ) ) {
struct V_211 * V_212 ;
...
return - V_85 ;
V_212 = F_74 ( V_5 -> V_213 , V_5 -> V_160 ) ;
return F_596 ( V_212 , V_2183 , V_637 ) ;
}
switch ( V_637 ) {
case V_2209 :
...
return V_75 ;
case V_2216 :
return F_589 ( V_111 , V_2183 ) ;
case V_2217 :
return F_592 ( V_111 , V_2183 ) ;
default:
break;
}
return - V_1032 ;
...
static int F_599 ( struct V_359 * V_111 , struct V_446 * V_2232 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! ( V_5 -> V_178 & V_333 ) ) {
...
if ( V_2232 -> V_458 != V_5 -> V_447 . V_458 ) {
F_144 ( V_5 -> V_111 ,
L_79 ) ;
return - V_64 ;
}
if ( V_2232 -> V_462 > V_2233 ) {
F_144 ( V_5 -> V_111 ,
L_80 ,
V_2233 ) ;
return - V_64 ;
...
static int F_600 ( struct V_359 * V_111 , struct V_446 * V_2232 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
if ( ! ( V_5 -> V_178 & V_333 ) ) {
F_144 ( V_5 -> V_111 ,
...
static int F_605 ( struct V_359 * V_111 , int V_2234 )
{
struct V_4 * V_5 = F_111 ( V_111 ) ;
int V_75 ;
bool V_1533 = false ;
if ( V_2234 < V_2235 || V_2234 > F_468 ( V_5 ) )
return - V_64 ;
if ( ! F_146 ( V_111 ) ) {
F_603 ( V_111 , V_5 , V_2234 ) ;
return 0 ;
}
F_124 ( V_5 ) ;
F_343 ( V_5 ) ;
...
{
T_1 V_2236 , V_7 , V_1978 ;
V_5 -> V_1970 = V_2237 ;
if ( F_170 ( V_5 , 0 , & V_1978 ) != 0 )
return;
if ( ( V_1978 != V_1979 ) &&
( ( V_1978 & V_2086 ) != V_2087 ) &&
( ( V_1978 & V_2103 ) != V_2104 ) )
return;
V_2236 = 0x10 ;
while ( V_2236 < V_5 -> V_1970 ) {
if ( F_170 ( V_5 , V_2236 , & V_7 ) != 0 )
return;
if ( V_7 == V_1978 )
break;
V_2236 <<= 1 ;
...
static void F_610 ( struct V_4 * V_5 , T_1 V_2259 )
{
...
if ( V_2239 == V_2276 ||
V_2239 == V_2279 )
V_5 -> V_1970 = ( V_2275 ? 0x3e200 :
V_2238 ) ;
else if ( V_2239 == V_2277 )
V_5 -> V_1970 = ( V_2275 ? 0x1f200 :
V_2280 ) ;
else
V_5 -> V_1970 = ( V_2275 ? 0x1f200 :
V_2281 ) ;
...
static struct V_2372 * F_620 ( struct V_4 * V_5 )
{
int V_42 ;
for ( V_42 = 0 ; V_42 < F_582 ( V_2373 ) ; V_42 ++ ) {
...
T_1 V_2071 ;
int V_622 , V_42 = 0 ;
V_2465 = ( T_4 * ) F_565 ( V_5 , & V_2071 ) ;
if ( ! V_2465 )
goto V_2468;
V_42 = F_570 ( V_2465 , 0 , V_2071 , V_2114 ) ;
if ( V_42 < 0 )
goto V_2469;
V_2467 = F_571 ( & V_2465 [ V_42 ] ) ;
V_2466 = V_42 + V_2115 + V_2467 ;
V_42 += V_2115 ;
if ( V_2466 > V_2071 )
goto V_2469;
V_622 = F_572 ( V_2465 , V_42 , V_2467 ,
V_2470 ) ;
if ( V_622 > 0 ) {
V_74 = F_630 ( & V_2465 [ V_622 ] ) ;
V_622 += V_2117 ;
if ( V_622 + V_74 > V_2466 || V_74 != 4 ||
memcmp ( & V_2465 [ V_622 ] , L_82 , 4 ) )
goto V_2471;
V_622 = F_572 ( V_2465 , V_42 , V_2467 ,
V_2472 ) ;
if ( V_622 < 0 )
...
V_74 = F_630 ( & V_2465 [ V_622 ] ) ;
V_622 += V_2117 ;
if ( V_622 + V_74 > V_2466 )
goto V_2471;
if ( V_74 >= sizeof( V_5 -> V_2015 ) )
V_74 = sizeof( V_5 -> V_2015 ) - 1 ;
memset ( V_5 -> V_2015 , 0 , sizeof( V_5 -> V_2015 ) ) ;
snprintf ( V_5 -> V_2015 , sizeof( V_5 -> V_2015 ) , L_83 , V_74 ,
& V_2465 [ V_622 ] ) ;
}
V_2471:
V_42 = F_572 ( V_2465 , V_42 , V_2467 ,
V_2473 ) ;
if ( V_42 < 0 )
goto V_2469;
V_74 = F_630 ( & V_2465 [ V_42 ] ) ;
V_42 += V_2117 ;
if ( V_74 > V_2474 ||
( V_74 + V_42 ) > V_2071 )
goto V_2469;
...
V_2495 = strlen ( V_5 -> V_2015 ) ;
if ( V_2496 ) {
if ( V_2497 - V_2495 < 16 ||
F_170 ( V_5 , V_590 + 8 , & V_2494 ) )
return;
V_590 = V_590 + V_2494 - V_1023 ;
for ( V_42 = 0 ; V_42 < 16 ; V_42 += 4 ) {
T_5 V_619 ;
if ( F_171 ( V_5 , V_590 + V_42 , & V_619 ) )
return;
memcpy ( V_5 -> V_2015 + V_2495 + V_42 , & V_619 , sizeof( V_619 ) ) ;
}
} else {
T_1 V_2498 , V_2499 ;
if ( F_170 ( V_5 , V_2500 , & V_2494 ) )
return;
V_2498 = ( V_2494 & V_2501 ) >>
V_2502 ;
V_2499 = V_2494 & V_2503 ;
snprintf ( & V_5 -> V_2015 [ V_2495 ] , V_2497 - V_2495 ,
L_102 , V_2498 , V_2499 ) ;
}
}
...
if ( F_170 ( V_5 , V_2504 , & V_7 ) )
return;
V_2498 = ( V_7 & V_2505 ) >>
V_2506 ;
V_2499 = ( V_7 & V_2507 ) >>
V_2508 ;
snprintf ( & V_5 -> V_2015 [ 0 ] , 32 , L_103 , V_2498 , V_2499 ) ;
}
static void F_634 ( struct V_4 * V_5 , T_1 V_7 )
{
T_1 V_590 , V_2498 , V_2499 , V_2509 ;
strncat ( V_5 -> V_2015 , L_104 , V_2497 - strlen ( V_5 -> V_2015 ) - 1 ) ;
...
return;
V_590 = strlen ( V_5 -> V_2015 ) ;
snprintf ( & V_5 -> V_2015 [ V_590 ] , V_2497 - V_590 ,
L_105 , V_2498 , V_2499 ) ;
if ( V_2509 > 0 ) {
V_590 = strlen ( V_5 -> V_2015 ) ;
if ( V_590 < V_2497 - 1 )
V_5 -> V_2015 [ V_590 ] = 'a' + V_2509 - 1 ;
}
}
...
return;
V_590 += sizeof( V_619 ) ;
if ( V_2521 > V_2497 - sizeof( V_619 ) ) {
memcpy ( & V_5 -> V_2015 [ V_2521 ] , & V_619 , V_2497 - V_2521 ) ;
break;
}
memcpy ( & V_5 -> V_2015 [ V_2521 ] , & V_619 , sizeof( V_619 ) ) ;
V_2521 += sizeof( V_619 ) ;
}
}
...
if ( F_23 ( V_5 , V_79 ) )
V_2525 = L_106 ;
else if ( V_5 -> V_12 -> V_538 == V_2527 )
V_2525 = L_107 ;
else
V_2525 = L_108 ;
V_2521 = strlen ( V_5 -> V_2015 ) ;
snprintf ( & V_5 -> V_2015 [ V_2521 ] , V_2497 - V_2521 , L_109 ,
V_2525 ,
( V_69 & V_2528 ) >> V_2529 ,
( V_69 & V_2530 ) >> V_2531 ,
( V_69 & V_2532 ) >> V_2533 ,
...
if ( F_30 ( V_5 ) != V_762 )
return;
if ( ! F_623 ( V_5 , V_2535 , & V_7 ) &&
! F_623 ( V_5 , V_2535 + 4 , & V_2432 ) &&
F_639 ( V_7 ) ) {
...
V_2521 = strlen ( V_5 -> V_2015 ) ;
snprintf ( & V_5 -> V_2015 [ V_2521 ] , V_2497 - V_2521 , L_110 , V_2389 ) ;
}
}
...
{
struct V_1786 * V_2541 ;
unsigned int V_2542 , V_2543 = V_5 -> V_12 -> V_273 & ~ 7 ;
for ( V_2542 = 0 ; V_2542 < 8 ; V_2542 ++ ) {
V_2541 = F_643 ( V_5 -> V_12 -> V_271 , V_2543 | V_2542 ) ;
...
static void F_645 ( struct V_4 * V_5 , T_1 V_2544 )
{
...
static int F_647 ( struct V_4 * V_5 , const struct V_2561 * V_2562 )
{
T_1 V_2544 ;
T_1 V_2568 , V_2563 ;
T_1 V_7 ;
...
struct V_1786 * V_2583 = NULL ;
while ( V_2582 -> V_2573 != 0 ) {
V_2583 = F_648 ( V_2582 -> V_2573 , V_2582 -> V_538 ,
V_2583 ) ;
if ( ! V_2583 ) {
V_2582 ++ ;
continue;
...
F_23 ( V_5 , 5780_CLASS ) ) {
V_5 -> V_1392 = F_650 ( V_5 -> V_12 , V_2602 ) ;
if ( ! V_5 -> V_1392 ) {
F_117 ( & V_5 -> V_12 -> V_111 ,
L_111 ) ;
return - V_210 ;
...
F_30 ( V_5 ) == V_408 ||
F_30 ( V_5 ) == V_45 ) {
if ( V_5 -> V_12 -> V_538 != V_2626 &&
V_5 -> V_12 -> V_538 != V_2627 )
V_5 -> V_178 |= V_512 ;
if ( V_5 -> V_12 -> V_538 == V_2628 )
V_5 -> V_178 |= V_513 ;
} else
V_5 -> V_178 |= V_511 ;
}
...
struct V_359 * V_111 = V_5 -> V_111 ;
struct V_1786 * V_12 = V_5 -> V_12 ;
struct V_2653 * V_2022 = F_657 ( V_12 ) ;
const unsigned char * V_184 ;
int V_74 ;
V_184 = F_658 ( V_2022 , L_113 , & V_74 ) ;
...
{
struct V_359 * V_111 = V_5 -> V_111 ;
memcpy ( V_111 -> V_689 , V_2654 -> V_2655 , V_1526 ) ;
return 0 ;
}
...
if ( ( V_2656 >> 16 ) == 0x484b ) {
V_111 -> V_689 [ 0 ] = ( V_2656 >> 8 ) & 0xff ;
V_111 -> V_689 [ 1 ] = ( V_2656 >> 0 ) & 0xff ;
F_32 ( V_5 , V_2662 , & V_2657 ) ;
V_111 -> V_689 [ 2 ] = ( V_2657 >> 24 ) & 0xff ;
V_111 -> V_689 [ 3 ] = ( V_2657 >> 16 ) & 0xff ;
V_111 -> V_689 [ 4 ] = ( V_2657 >> 8 ) & 0xff ;
V_111 -> V_689 [ 5 ] = ( V_2657 >> 0 ) & 0xff ;
V_2659 = F_439 ( & V_111 -> V_689 [ 0 ] ) ;
}
if ( ! V_2659 ) {
if ( ! F_23 ( V_5 , V_676 ) &&
! F_171 ( V_5 , V_2658 + 0 , & V_2656 ) &&
! F_171 ( V_5 , V_2658 + 4 , & V_2657 ) ) {
memcpy ( & V_111 -> V_689 [ 0 ] , ( ( char * ) & V_2656 ) + 2 , 2 ) ;
memcpy ( & V_111 -> V_689 [ 2 ] , ( char * ) & V_2657 , sizeof( V_2657 ) ) ;
}
else {
V_2656 = F_33 ( V_684 ) ;
V_2657 = F_33 ( V_685 ) ;
V_111 -> V_689 [ 5 ] = V_2657 & 0xff ;
V_111 -> V_689 [ 4 ] = ( V_2657 >> 8 ) & 0xff ;
V_111 -> V_689 [ 3 ] = ( V_2657 >> 16 ) & 0xff ;
V_111 -> V_689 [ 2 ] = ( V_2657 >> 24 ) & 0xff ;
V_111 -> V_689 [ 1 ] = V_2656 & 0xff ;
V_111 -> V_689 [ 0 ] = ( V_2656 >> 8 ) & 0xff ;
}
}
...
! F_23 ( V_5 , V_1074 ) )
goto V_497;
#if F_362 ( V_2666 ) || F_362 ( V_2667 ) || F_362 ( V_2668 )
V_2665 = V_2669 ;
#else
#if F_362 ( V_2670 ) || F_362 ( V_2671 )
V_2665 = V_2672 ;
#else
V_2665 = 0 ;
#endif
...
static int F_664 ( struct V_4 * V_5 , T_1 * V_621 , T_9 V_2696 ,
int V_629 , bool V_2697 )
{
...
F_46 ( V_1059 , 0 ) ;
F_46 ( V_1069 , 0 ) ;
V_2699 . V_1143 = ( ( T_6 ) V_2696 ) >> 32 ;
V_2699 . V_1144 = V_2696 & 0xffffffff ;
...
T_1 * V_621 , V_2707 ;
int V_56 = 0 ;
V_621 = F_410 ( & V_5 -> V_12 -> V_111 , V_2708 ,
& V_2696 , V_627 ) ;
if ( ! V_621 ) {
V_56 = - V_267 ;
goto V_2709;
...
V_1441 [ V_42 ] = V_42 ;
V_56 = F_664 ( V_5 , V_621 , V_2696 , V_2708 , true ) ;
if ( V_56 ) {
F_117 ( & V_5 -> V_12 -> V_111 ,
L_114 ,
V_652 , V_56 ) ;
...
V_56 = F_664 ( V_5 , V_621 , V_2696 , V_2708 , false ) ;
if ( V_56 ) {
...
V_497:
F_408 ( & V_5 -> V_12 -> V_111 , V_2708 , V_621 , V_2696 ) ;
V_2709:
return V_56 ;
}
...
case V_2742 : return L_119 ;
case V_396 : return L_120 ;
case V_560 : return L_121 ;
case V_2743 : return L_122 ;
case V_2744 : return L_123 ;
case V_2745 : return L_124 ;
case V_2746 : return L_125 ;
case V_2747 : return L_126 ;
case V_2748 : return L_127 ;
case V_2749 : return L_128 ;
case V_2750 : return L_129 ;
case V_2751 : return L_130 ;
case V_2752 : return L_131 ;
case V_2753 : return L_132 ;
case V_2754 : return L_133 ;
case V_2755 : return L_134 ;
case V_2756 : return L_135 ;
case V_2757 : return L_136 ;
case V_2758 : return L_137 ;
case V_2759 : return L_138 ;
case V_2760 : return L_139 ;
case V_2761 : return L_140 ;
case V_2762 : return L_141 ;
case V_936 : return L_142 ;
case 0 : return L_143 ;
default: return L_144 ;
}
}
static char * F_668 ( struct V_4 * V_5 , char * V_2763 )
{
if ( F_23 ( V_5 , V_1074 ) ) {
strcpy ( V_2763 , L_145 ) ;
return V_2763 ;
...
T_6 V_2782 , V_2783 ;
T_15 V_1184 = 0 ;
F_671 ( V_2784 L_155 , V_1969 ) ;
V_75 = F_672 ( V_12 ) ;
if ( V_75 ) {
F_117 ( & V_12 -> V_111 , L_156 ) ;
return V_75 ;
}
V_75 = F_673 ( V_12 , V_2012 ) ;
if ( V_75 ) {
...
if ( V_5 -> V_12 -> V_538 == V_539 ||
V_5 -> V_12 -> V_538 == V_2800 ||
V_5 -> V_12 -> V_538 == V_540 ||
V_5 -> V_12 -> V_538 == V_2801 ||
V_5 -> V_12 -> V_538 == V_2476 ||
V_5 -> V_12 -> V_538 == V_2477 ||
V_5 -> V_12 -> V_538 == V_2478 ||
V_5 -> V_12 -> V_538 == V_2548 ||
V_5 -> V_12 -> V_538 == V_2549 ||
...
if ( F_23 ( V_5 , V_1643 ) )
V_2783 = V_2782 = F_363 ( 32 ) ;
else if ( F_23 ( V_5 , 40BIT_DMA_BUG ) ) {
V_2783 = V_2782 = F_363 ( 40 ) ;
#ifdef V_1240
V_2782 = F_363 ( 64 ) ;
#endif
} else
V_2783 = V_2782 = F_363 ( 64 ) ;
if ( V_2782 > F_363 ( 32 ) ) {
V_75 = F_686 ( V_12 , V_2782 ) ;
if ( ! V_75 ) {
V_1184 |= V_2813 ;
V_75 = F_687 ( V_12 ,
V_2783 ) ;
...
F_98 ( V_111 , L_174 ,
V_5 -> V_1575 ,
V_12 -> V_2782 == F_363 ( 32 ) ? 32 :
( ( T_6 ) V_12 -> V_2782 ) == F_363 ( 40 ) ? 40 : 64 ) ;
F_691 ( V_12 ) ;
return 0 ;
V_2812:
if ( V_5 -> V_9 ) {
...
T_22 V_843 )
{
struct V_359 * V_2832 = F_154 ( V_12 ) ;
struct V_4 * V_5 = F_111 ( V_2832 ) ;
T_21 V_75 = V_2833 ;
F_98 ( V_2832 , L_175 ) ;
F_492 () ;
if ( V_843 == V_2834 )
V_5 -> V_1906 = true ;
if ( ! V_2832 || ! F_146 ( V_2832 ) )
goto V_186;
F_124 ( V_5 ) ;
F_343 ( V_5 ) ;
F_487 ( V_5 ) ;
...
V_623 = V_2837 ;
V_186:
if ( V_623 != V_2837 && V_2832 && F_146 ( V_2832 ) ) {
F_337 ( V_5 ) ;
F_490 ( V_2832 ) ;
}
F_493 () ;
