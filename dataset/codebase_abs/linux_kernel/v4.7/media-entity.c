...
struct V_65 * F_56 ( struct V_65 * V_50 )
{
if ( V_50 == NULL )
return NULL ;
if ( V_50 -> V_67 . V_38 -> V_39 &&
! F_57 ( V_50 -> V_67 . V_38 -> V_39 -> V_95 -> V_96 ) )
return NULL ;
return V_50 ;
}
void F_58 ( struct V_65 * V_50 )
{
if ( V_50 == NULL )
return;
if ( V_50 -> V_67 . V_38 -> V_39 )
F_59 ( V_50 -> V_67 . V_38 -> V_39 -> V_95 -> V_96 ) ;
}
static struct V_41 * F_60 ( struct V_97 * V_98 )
{
struct V_41 * V_42 ;
V_42 = F_61 ( sizeof( * V_42 ) , V_31 ) ;
if ( V_42 == NULL )
return NULL ;
F_22 ( & V_42 -> V_58 , V_98 ) ;
return V_42 ;
}
static void F_62 ( struct V_65 * V_50 ,
struct V_41 * V_42 )
{
struct V_41 * V_99 , * V_100 ;
struct V_65 * V_101 ;
if ( V_42 -> V_70 -> V_50 == V_50 )
V_101 = V_42 -> V_71 -> V_50 ;
else
V_101 = V_42 -> V_70 -> V_50 ;
...
int
F_64 ( struct V_65 * V_70 , T_2 V_105 ,
struct V_65 * V_71 , T_2 V_106 , T_3 V_47 )
{
struct V_41 * V_42 ;
struct V_41 * V_107 ;
F_20 ( V_70 == NULL || V_71 == NULL ) ;
F_20 ( V_105 >= V_70 -> V_66 ) ;
F_20 ( V_106 >= V_71 -> V_66 ) ;
V_42 = F_60 ( & V_70 -> V_61 ) ;
if ( V_42 == NULL )
return - V_32 ;
V_42 -> V_70 = & V_70 -> V_60 [ V_105 ] ;
V_42 -> V_71 = & V_71 -> V_60 [ V_106 ] ;
V_42 -> V_47 = V_47 & ~ V_108 ;
F_19 ( V_70 -> V_67 . V_38 , V_4 ,
& V_42 -> V_67 ) ;
V_107 = F_60 ( & V_71 -> V_61 ) ;
if ( V_107 == NULL ) {
F_62 ( V_70 , V_42 ) ;
return - V_32 ;
}
V_107 -> V_70 = & V_70 -> V_60 [ V_105 ] ;
V_107 -> V_71 = & V_71 -> V_60 [ V_106 ] ;
V_107 -> V_47 = V_47 ;
V_107 -> V_109 = true ;
...
int F_65 ( const struct V_56 * V_38 ,
const T_3 V_110 ,
struct V_65 * V_70 ,
const T_2 V_105 ,
const T_3 V_111 ,
...
void F_67 ( struct V_65 * V_50 )
{
struct V_41 * V_42 , * V_100 ;
F_63 (link, tmp, &entity->links, list)
F_62 ( V_50 , V_42 ) ;
V_50 -> V_104 = 0 ;
V_50 -> V_103 = 0 ;
}
void F_68 ( struct V_65 * V_50 )
{
struct V_56 * V_38 = V_50 -> V_67 . V_38 ;
if ( V_38 == NULL )
return;
...
static int F_69 ( struct V_41 * V_42 , T_3 V_47 )
{
int V_82 ;
V_82 = F_70 ( V_42 -> V_70 -> V_50 , V_115 ,
V_42 -> V_70 , V_42 -> V_71 , V_47 ) ;
if ( V_82 < 0 && V_82 != - V_93 )
return V_82 ;
V_82 = F_70 ( V_42 -> V_71 -> V_50 , V_115 ,
V_42 -> V_71 , V_42 -> V_70 , V_47 ) ;
if ( V_82 < 0 && V_82 != - V_93 ) {
F_70 ( V_42 -> V_70 -> V_50 , V_115 ,
V_42 -> V_70 , V_42 -> V_71 , V_42 -> V_47 ) ;
return V_82 ;
}
V_42 -> V_47 = V_47 ;
V_42 -> V_102 -> V_47 = V_42 -> V_47 ;
return 0 ;
}
int F_71 ( struct V_41 * V_42 , T_3 V_47 )
{
const T_3 V_116 = V_78 ;
struct V_56 * V_38 ;
struct V_65 * V_70 , * V_71 ;
int V_82 = - V_89 ;
if ( V_42 == NULL )
return - V_117 ;
if ( ( V_42 -> V_47 & ~ V_116 ) != ( V_47 & ~ V_116 ) )
return - V_117 ;
if ( V_42 -> V_47 & V_114 )
return V_42 -> V_47 == V_47 ? 0 : - V_117 ;
if ( V_42 -> V_47 == V_47 )
return 0 ;
V_70 = V_42 -> V_70 -> V_50 ;
V_71 = V_42 -> V_71 -> V_50 ;
...
V_82 = F_69 ( V_42 , V_47 ) ;
if ( V_38 -> V_119 )
V_38 -> V_119 ( V_42 , V_47 , V_121 ) ;
return V_82 ;
}
int F_72 ( struct V_41 * V_42 , T_3 V_47 )
{
int V_82 ;
F_26 ( & V_42 -> V_67 . V_38 -> V_69 ) ;
V_82 = F_71 ( V_42 , V_47 ) ;
F_27 ( & V_42 -> V_67 . V_38 -> V_69 ) ;
return V_82 ;
}
struct V_41 *
F_73 ( struct V_45 * V_70 , struct V_45 * V_71 )
{
struct V_41 * V_42 ;
...
struct V_45 * F_74 ( struct V_45 * V_46 )
{
struct V_41 * V_42 ;
...
static void F_75 ( struct V_56 * V_38 ,
struct V_6 * V_7 ,
T_3 F_1 ,
T_3 F_2 , T_3 V_47 )
{
...
struct V_52 * F_77 ( struct V_56 * V_38 ,
T_3 type , T_3 V_47 ,
T_3 V_54 , T_3 V_55 )
{
struct V_52 * V_53 ;
V_53 = F_61 ( sizeof( * V_53 ) , V_31 ) ;
if ( ! V_53 )
return NULL ;
V_53 -> V_54 = V_54 ;
V_53 -> V_55 = V_55 ;
F_75 ( V_38 , & V_53 -> V_7 , V_5 ,
type , V_47 ) ;
return V_53 ;
}
...
struct V_41 * F_80 ( struct V_65 * V_50 ,
struct V_6 * V_7 ,
T_3 V_47 )
{
struct V_41 * V_42 ;
