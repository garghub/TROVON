...
static int T_2 F_99 ( struct V_4 * type , T_3 V_38 )
{
...
bool T_5 F_100 ( T_3 V_38 )
{
return F_99 ( & V_5 . V_7 , V_38 ) != - 1 ;
}
bool T_2 F_101 ( T_3 V_38 )
{
return F_99 ( & V_5 . V_6 , V_38 ) != - 1 ;
}
int T_2 F_102 ( T_3 V_38 )
{
int V_15 = F_99 ( & V_5 . V_6 , V_38 ) ;
if ( V_15 == - 1 )
return false ;
return ! F_63 ( & V_5 . V_6 . V_17 [ V_15 ] ) ;
}
int T_2 F_103 ( unsigned long V_110 ,
unsigned long * V_104 , unsigned long * V_105 )
{
struct V_4 * type = & V_5 . V_6 ;
int V_109 = F_99 ( type , F_95 ( V_110 ) ) ;
if ( V_109 == - 1 )
return - 1 ;
...
int T_2 F_104 ( T_3 V_8 , T_3 V_9 )
{
int V_58 = F_99 ( & V_5 . V_6 , V_8 ) ;
T_3 V_19 = V_8 + F_3 ( V_8 , & V_9 ) ;
if ( V_58 == - 1 )
return 0 ;
...
bool T_2 F_105 ( T_3 V_8 , T_3 V_9 )
{
F_3 ( V_8 , & V_9 ) ;
return F_6 ( & V_5 . V_7 , V_8 , V_9 ) ;
}
void T_2 F_106 ( T_3 V_20 )
{
...
static void T_2 F_109 ( struct V_4 * type , char * V_113 )
{
unsigned long long V_8 , V_9 ;
unsigned long V_22 ;
int V_58 ;
struct V_40 * V_59 ;
F_110 ( L_16 , V_113 , type -> V_16 ) ;
F_43 (type, rgn) {
char V_114 [ 32 ] = L_17 ;
V_8 = V_59 -> V_8 ;
V_9 = V_59 -> V_9 ;
...
static int T_5 F_113 ( char * V_115 )
{
if ( V_115 && strstr ( V_115 , L_22 ) )
V_116 = 1 ;
return 0 ;
}
static int F_114 ( struct V_117 * V_81 , void * V_118 )
{
...
static int F_116 ( struct V_120 * V_120 , struct V_121 * V_121 )
{
return F_117 ( V_121 , F_114 , V_120 -> V_122 ) ;
}
static int T_5 F_118 ( void )
{
struct V_123 * V_124 = F_119 ( L_26 , NULL ) ;
if ( ! V_124 )
return - V_125 ;
F_120 ( L_1 , V_126 , V_124 , & V_5 . V_6 , & V_127 ) ;
F_120 ( L_2 , V_126 , V_124 , & V_5 . V_7 , & V_127 ) ;
#ifdef F_121
F_120 ( L_27 , V_126 , V_124 , & V_5 . V_128 , & V_127 ) ;
#endif
return 0 ;
}
