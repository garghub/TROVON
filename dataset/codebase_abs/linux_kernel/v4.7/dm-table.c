...
T_1 V_50 , T_1 V_51 , void * V_52 )
{
unsigned long V_152 = ( unsigned long ) V_52 ;
struct V_53 * V_54 = F_29 ( V_46 -> V_47 ) ;
return V_54 && ( V_54 -> V_153 & V_152 ) ;
}
static bool F_113 ( struct V_6 * V_7 , unsigned long V_152 )
{
struct V_21 * V_49 ;
unsigned V_42 = 0 ;
while ( V_42 < F_55 ( V_7 ) ) {
...
return true ;
if ( V_49 -> type -> V_96 &&
V_49 -> type -> V_96 ( V_49 , F_112 , ( void * ) V_152 ) )
return true ;
}
return false ;
}
...
{
struct V_53 * V_54 = F_29 ( V_46 -> V_47 ) ;
return V_54 && ! F_120 ( V_157 , & V_54 -> V_153 ) ;
}
...
V_49 = F_56 ( V_7 , V_42 ++ ) ;
if ( ! V_49 -> type -> V_96 ||
! V_49 -> type -> V_96 ( V_49 , V_158 , NULL ) )
return false ;
}
return true ;
}
...
F_129 ( V_163 , V_54 ) ;
if ( F_113 ( V_7 , ( 1UL << V_164 ) ) ) {
V_161 = true ;
if ( F_113 ( V_7 , ( 1UL << V_165 ) ) )
V_162 = true ;
}
F_130 ( V_54 , V_161 , V_162 ) ;
if ( ! F_114 ( V_7 ) )
V_54 -> V_56 . V_166 = 0 ;
if ( F_121 ( V_7 , F_115 ) )
F_129 ( V_167 , V_54 ) ;
...
static void F_133 ( struct V_6 * V_7 , enum V_170 V_27 )
{
int V_42 = V_7 -> V_28 ;
...
void F_138 ( struct V_6 * V_7 , struct V_179 * V_180 )
{
F_42 ( & V_180 -> V_39 , & V_7 -> V_33 ) ;
}
int F_139 ( struct V_6 * V_7 , int V_181 )
{
struct V_37 * V_38 ;
struct V_34 * V_32 = F_74 ( V_7 ) ;
struct V_179 * V_180 ;
...
F_147 ( V_184 -> V_186 , V_185 ) ;
F_148 ( V_184 ) ;
F_149 ( V_184 -> V_186 , V_185 ) ;
}
}
}
