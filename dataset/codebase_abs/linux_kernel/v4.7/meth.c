...
static int F_51 ( struct V_1 * V_2 , struct V_152 * V_153 , int V_154 )
{
switch( V_154 ) {
case V_155 :
case V_156 :
...
if ( V_2 -> V_19 & V_61 ) {
V_10 -> V_34 |= V_62 ;
V_10 -> V_159 = 0xffffffffffffffffUL ;
} else if ( ( F_53 ( V_2 ) > V_160 ) ||
( V_2 -> V_19 & V_161 ) ) {
V_10 -> V_34 |= V_162 ;
V_10 -> V_159 = 0xffffffffffffffffUL ;
} else {
...
V_10 -> V_34 |= V_59 ;
F_54 (ha, dev)
F_55 ( ( F_56 ( V_165 , V_164 -> V_166 ) >> 26 ) ,
( volatile unsigned long * ) & V_10 -> V_159 ) ;
}
V_6 -> V_7 . V_34 = V_10 -> V_34 ;
V_6 -> V_7 . V_159 = V_10 -> V_159 ;
F_8 ( & V_10 -> V_20 , V_19 ) ;
F_40 ( V_2 ) ;
}
...
struct V_9 * V_10 ;
int V_169 ;
V_2 = F_58 ( sizeof( struct V_9 ) ) ;
if ( ! V_2 )
return - V_39 ;
V_2 -> V_170 = & V_171 ;
V_2 -> V_172 = V_173 ;
V_2 -> V_68 = V_174 ;
V_2 -> V_175 = ( unsigned long ) & V_6 -> V_7 ;
memcpy ( V_2 -> V_5 , V_176 , V_165 ) ;
V_10 = F_10 ( V_2 ) ;
F_59 ( & V_10 -> V_20 ) ;
F_60 ( V_2 , & V_168 -> V_2 ) ;
V_169 = F_61 ( V_2 ) ;
...
static int T_5 F_63 ( struct V_167 * V_168 )
{
struct V_1 * V_2 = F_64 ( V_168 ) ;
F_65 ( V_2 ) ;
F_62 ( V_2 ) ;
return 0 ;
}
