...
V_93 = F_29 ( V_89 , 0 ) ;
F_30 ( V_89 , L_3 , & V_91 ) ;
V_86 = F_31 ( V_85 , V_91 , V_93 , 0 , V_78 ) ;
if ( ! F_32 ( V_86 ) )
F_33 ( V_89 , V_94 , V_86 ) ;
return V_86 ;
}
static int F_34 ( struct V_95 * V_96 ,
...
V_40 = F_37 ( V_85 , sizeof( * V_40 ) , V_104 ) ;
if ( ! V_40 )
return - V_105 ;
V_40 -> V_48 = V_48 ;
V_40 -> V_79 = V_79 ;
F_38 ( V_96 , V_40 ) ;
V_84 = F_39 ( V_96 , V_48 -> V_106 ) ;
if ( F_32 ( V_84 ) )
return F_40 ( V_84 ) ;
return F_41 ( V_85 ,
& V_107 , & V_108 , 1 ) ;
}
static int F_42 ( struct V_95 * V_109 )
{
F_43 ( & V_109 -> V_85 ) ;
return 0 ;
}
