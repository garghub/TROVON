...
if ( V_74 -> V_179 ) {
if ( V_74 -> V_180 ) {
F_113 ( V_74 -> V_180 , V_74 ) ;
F_114 ( V_74 -> V_180 ) ;
V_74 -> V_180 = 0 ;
}
F_113 ( V_74 -> V_179 , V_74 ) ;
F_114 ( V_74 -> V_179 ) ;
V_74 -> V_179 = 0 ;
}
if ( V_74 -> V_181 ) {
F_115 ( ( unsigned long ) V_74 -> V_181 -> V_182 ) ;
F_10 ( V_74 -> V_181 -> V_183 ) ;
F_10 ( V_74 -> V_181 ) ;
}
if ( V_74 -> V_146 )
F_90 ( V_74 ) ;
...
static int F_117 ( struct V_145 * V_74 , int V_53 )
{
T_10 V_191 ;
int V_192 , V_193 ;
struct V_184 * V_181 = V_74 -> V_181 ;
int V_194 = ( V_53 + 1 ) % V_189 ;
if ( V_181 -> V_183 [ V_194 ] == V_187 )
return - V_195 ;
V_191 = F_105 ( V_74 -> V_146 + V_196 ) ;
if ( V_191 & V_197 ) {
V_192 = F_105 ( V_74 -> V_146 + V_198 ) ;
if ( ( V_192 >> V_199 ) == V_53 ) {
F_71 ( L_41
L_42 ,
( unsigned long long ) V_181 -> V_182 [ V_53 ] . V_200 ,
( unsigned long long ) V_181 -> V_182 [ V_53 ] . V_201 ) ;
memcpy ( & V_181 -> V_182 [ V_53 ] , & V_181 -> V_182 [ V_194 ] ,
sizeof( struct V_202 ) ) ;
F_118 ( V_74 , & V_181 -> V_182 [ V_53 ] ,
sizeof( struct V_202 ) ) ;
F_119 ( V_197 , V_74 -> V_146 + V_196 ) ;
return - V_52 ;
}
}
if ( V_191 & V_203 ) {
...
V_192 |= 1 ;
V_193 = F_105 ( V_74 -> V_146 + V_204 ) ;
V_193 = ( ( V_193 >> V_199 ) - 1 + V_189 ) % V_189 ;
F_119 ( V_203 , V_74 -> V_146 + V_196 ) ;
do {
...
if ( V_191 & V_206 )
F_119 ( V_206 , V_74 -> V_146 + V_196 ) ;
return 0 ;
}
int F_120 ( struct V_202 * V_182 , struct V_145 * V_74 )
{
int V_207 ;
struct V_184 * V_181 = V_74 -> V_181 ;
...
V_210:
V_207 = 0 ;
F_121 ( & V_181 -> V_211 , V_73 ) ;
while ( V_181 -> V_190 < 3 ) {
F_122 ( & V_181 -> V_211 , V_73 ) ;
F_123 () ;
F_121 ( & V_181 -> V_211 , V_73 ) ;
}
V_53 = V_181 -> V_212 ;
V_194 = ( V_53 + 1 ) % V_189 ;
V_181 -> V_183 [ V_53 ] = V_181 -> V_183 [ V_194 ] = V_205 ;
V_208 [ V_53 ] = * V_182 ;
V_209 . V_200 = F_124 ( V_186 ) |
V_213 | V_214 ;
V_209 . V_201 = F_125 ( & V_181 -> V_183 [ V_194 ] ) ;
V_208 [ V_194 ] = V_209 ;
F_118 ( V_74 , & V_208 [ V_53 ] , sizeof( struct V_202 ) ) ;
F_118 ( V_74 , & V_208 [ V_194 ] , sizeof( struct V_202 ) ) ;
V_181 -> V_212 = ( V_181 -> V_212 + 2 ) % V_189 ;
V_181 -> V_190 -= 2 ;
F_119 ( V_181 -> V_212 << V_199 , V_74 -> V_146 + V_204 ) ;
while ( V_181 -> V_183 [ V_194 ] != V_186 ) {
V_207 = F_117 ( V_74 , V_53 ) ;
if ( V_207 )
break;
F_126 ( & V_181 -> V_211 ) ;
F_123 () ;
...
void F_129 ( struct V_145 * V_74 , T_2 V_216 , T_2 V_217 , T_5 V_218 ,
T_7 type )
{
struct V_202 V_182 ;
...
void F_134 ( struct V_145 * V_74 , T_2 V_216 , T_7 V_129 ,
...
void F_144 ( struct V_145 * V_74 , T_2 V_217 , T_2 V_225 ,
...
if ( ! ( V_160 & V_173 ) )
goto V_7;
while ( ( F_105 ( V_74 -> V_146 + V_204 ) !=
F_105 ( V_74 -> V_146 + V_198 ) ) &&
( V_232 > ( F_149 () - V_231 ) ) )
F_123 () ;
V_74 -> V_169 &= ~ V_174 ;
F_119 ( V_74 -> V_169 , V_74 -> V_146 + V_233 ) ;
F_151 ( V_74 , V_167 , F_105 ,
! ( V_160 & V_173 ) , V_160 ) ;
V_7:
F_122 ( & V_74 -> V_175 , V_73 ) ;
}
static void F_152 ( struct V_145 * V_74 )
{
T_10 V_160 ;
unsigned long V_73 ;
struct V_184 * V_181 = V_74 -> V_181 ;
...
V_181 -> V_190 = V_189 ;
F_121 ( & V_74 -> V_175 , V_73 ) ;
F_119 ( 0 , V_74 -> V_146 + V_204 ) ;
F_153 ( V_74 -> V_146 + V_234 , F_125 ( V_181 -> V_182 ) ) ;
V_74 -> V_169 |= V_174 ;
F_119 ( V_74 -> V_169 , V_74 -> V_146 + V_233 ) ;
F_151 ( V_74 , V_167 , F_105 , ( V_160 & V_173 ) , V_160 ) ;
F_122 ( & V_74 -> V_175 , V_73 ) ;
}
int F_154 ( struct V_145 * V_74 )
{
struct V_184 * V_181 ;
struct V_235 * V_236 ;
if ( ! F_150 ( V_74 -> V_133 ) )
...
if ( V_74 -> V_181 )
return 0 ;
V_74 -> V_181 = F_155 ( sizeof( * V_181 ) , V_238 ) ;
if ( ! V_74 -> V_181 )
return - V_39 ;
V_181 = V_74 -> V_181 ;
V_236 = F_156 ( V_74 -> V_86 , V_238 | V_239 , 0 ) ;
if ( ! V_236 ) {
F_10 ( V_181 ) ;
V_74 -> V_181 = NULL ;
return - V_39 ;
...
static inline int F_160 ( struct V_145 * V_74 , int V_179 )
{
if ( V_74 -> V_179 == V_179 )
return V_247 ;
else if ( V_74 -> V_180 == V_179 )
return V_248 ;
else
F_161 () ;
}
void F_162 ( struct V_249 * V_62 )
{
struct V_145 * V_74 = F_163 ( V_62 ) ;
int V_146 = F_160 ( V_74 , V_62 -> V_179 ) ;
unsigned long V_250 ;
F_121 ( & V_74 -> V_175 , V_250 ) ;
F_119 ( 0 , V_74 -> V_146 + V_146 ) ;
F_105 ( V_74 -> V_146 + V_146 ) ;
F_122 ( & V_74 -> V_175 , V_250 ) ;
}
void F_164 ( struct V_249 * V_62 )
{
struct V_145 * V_74 = F_163 ( V_62 ) ;
int V_146 = F_160 ( V_74 , V_62 -> V_179 ) ;
unsigned long V_250 ;
F_121 ( & V_74 -> V_175 , V_250 ) ;
F_119 ( V_251 , V_74 -> V_146 + V_146 ) ;
F_105 ( V_74 -> V_146 + V_146 ) ;
F_122 ( & V_74 -> V_175 , V_250 ) ;
}
void F_165 ( int V_179 , struct V_252 * V_253 )
{
struct V_145 * V_74 = F_166 ( V_179 ) ;
int V_146 = F_160 ( V_74 , V_179 ) ;
unsigned long V_250 ;
F_121 ( & V_74 -> V_175 , V_250 ) ;
F_119 ( V_253 -> V_62 , V_74 -> V_146 + V_146 + 4 ) ;
F_119 ( V_253 -> V_254 , V_74 -> V_146 + V_146 + 8 ) ;
F_119 ( V_253 -> V_255 , V_74 -> V_146 + V_146 + 12 ) ;
F_122 ( & V_74 -> V_175 , V_250 ) ;
}
...
unsigned long V_250 ;
F_121 ( & V_74 -> V_175 , V_250 ) ;
V_253 -> V_62 = F_105 ( V_74 -> V_146 + V_146 + 4 ) ;
V_253 -> V_254 = F_105 ( V_74 -> V_146 + V_146 + 8 ) ;
V_253 -> V_255 = F_105 ( V_74 -> V_146 + V_146 + 12 ) ;
F_122 ( & V_74 -> V_175 , V_250 ) ;
}
static int F_168 ( struct V_145 * V_74 , int type ,
...
V_261 = ! F_171 ( & V_262 ) ;
F_121 ( & V_74 -> V_175 , V_250 ) ;
V_260 = F_105 ( V_74 -> V_146 + V_196 ) ;
if ( V_260 && ! V_261 )
F_71 ( L_48 , V_260 ) ;
if ( ! ( V_260 & V_265 ) )
goto V_266;
V_259 = F_172 ( V_260 ) ;
V_146 = F_173 ( V_74 -> V_132 ) ;
while ( 1 ) {
T_5 V_240 ;
T_2 V_256 ;
T_7 V_267 ;
...
V_259 * V_268 + 8 ) ;
V_256 = F_176 ( V_62 ) ;
V_267 = F_83 ( V_74 -> V_146 + V_146 +
V_259 * V_268 ) ;
V_267 = F_177 ( V_267 ) ;
}
F_119 ( V_269 , V_74 -> V_146 + V_146 +
V_259 * V_268 + 12 ) ;
F_122 ( & V_74 -> V_175 , V_250 ) ;
if ( ! V_261 )
F_168 ( V_74 , type , V_240 ,
V_256 , V_267 ) ;
V_259 ++ ;
if ( V_259 >= F_178 ( V_74 -> V_132 ) )
V_259 = 0 ;
F_121 ( & V_74 -> V_175 , V_250 ) ;
}
F_119 ( V_270 | V_265 , V_74 -> V_146 + V_196 ) ;
V_266:
F_122 ( & V_74 -> V_175 , V_250 ) ;
return V_271 ;
}
int F_179 ( struct V_145 * V_74 )
{
int V_179 , V_54 ;
if ( V_74 -> V_179 )
return 0 ;
V_179 = F_180 ( V_74 -> V_156 , V_74 -> V_86 , V_74 ) ;
if ( V_179 > 0 ) {
V_74 -> V_179 = V_179 ;
} else {
F_71 ( L_49 ) ;
...
V_54 = F_181 ( V_179 , F_169 , V_272 , V_74 -> V_152 , V_74 ) ;
if ( V_54 )
F_71 ( L_50 ) ;
return V_54 ;
}
...
F_169 ( V_74 -> V_179 , V_74 ) ;
V_260 = F_105 ( V_74 -> V_146 + V_196 ) ;
F_119 ( V_260 , V_74 -> V_146 + V_196 ) ;
}
return 0 ;
}
int F_184 ( struct V_145 * V_74 )
{
if ( ! F_150 ( V_74 -> V_133 ) )
return - V_237 ;
if ( ! V_74 -> V_181 )
...
V_282 . V_71 [ V_283 [ V_276 ] ] = V_71 ;
V_6 = (struct V_70 * ) V_281 -> V_288 . V_289 ;
V_54 = F_55 ( V_6 , V_281 -> V_288 . V_17 , & V_282 ) ;
F_195 ( V_281 ) ;
return V_54 ;
}
...
if ( ! V_55 )
return - V_118 ;
V_54 = F_197 ( V_55 , true ) ;
if ( V_54 == 0 )
V_54 = F_198 ( V_55 , true ) ;
return V_54 ;
}
static int F_199 ( struct V_70 * V_58 , void * V_71 )
{
int V_21 , V_54 ;
struct V_22 * V_26 ;
struct V_1 * V_55 ;
...
return - V_153 ;
V_54 = F_197 ( V_55 , false ) ;
if ( V_54 == 0 )
V_54 = F_198 ( V_55 , false ) ;
return V_54 ;
}
static int F_200 ( struct V_70 * V_58 , void * V_71 )
{
struct V_1 * V_55 ;
V_55 = F_38 ( (struct V_56 * ) V_58 ) ;
if ( V_55 ) {
...
V_54 = F_193 ( V_275 , V_286 ,
& F_48 , NULL ) ;
if ( V_54 )
goto V_290;
V_54 = F_193 ( V_275 , V_285 ,
& V_117 , NULL ) ;
if ( V_54 )
goto V_291;
V_54 = F_193 ( V_275 , V_284 ,
