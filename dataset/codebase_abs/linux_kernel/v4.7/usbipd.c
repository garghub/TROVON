...
while ( ! V_98 ) {
int V_115 ;
V_115 = F_61 ( V_100 , V_67 , & V_102 , & V_103 ) ;
if ( V_115 < 0 ) {
F_4 ( L_46 , strerror ( V_75 ) ) ;
V_98 = 1 ;
} else if ( V_115 ) {
for ( V_10 = 0 ; V_10 < V_67 ; V_10 ++ ) {
if ( V_100 [ V_10 ] . V_116 & V_111 ) {
F_4 ( L_47 ,
V_10 , V_65 [ V_10 ] ) ;
F_34 ( V_65 [ V_10 ] ) ;
}
...
V_34 = & V_130 ;
for (; ; ) {
V_128 = F_63 ( V_117 , V_118 , L_60 , V_120 , NULL ) ;
if ( V_128 == - 1 )
break;
switch ( V_128 ) {
case '4' :
...
switch ( V_127 ) {
case V_124 :
V_12 = F_53 ( V_93 , V_94 , V_95 ) ;
F_51 () ;
break;
case V_126 :
printf ( V_42 L_61 , V_105 ) ;
V_12 = 0 ;
break;
case V_125 :
F_1 () ;
