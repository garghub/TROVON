...
if ( V_61 > V_64 )
V_61 = V_64 ;
V_4 -> V_65 = F_28 ( V_14 , NULL ) ;
if ( F_29 ( V_4 -> V_65 ) ) {
F_10 ( V_14 , L_13 ) ;
return F_30 ( V_4 -> V_65 ) ;
}
V_20 = F_31 ( V_4 -> V_65 ) ;
if ( V_20 )
return V_20 ;
...
{
struct V_56 * V_14 = & V_68 -> V_14 ;
struct V_3 * V_4 ;
struct V_69 * V_70 ;
int V_1 ;
int V_20 ;
V_4 = F_34 ( V_14 , sizeof( * V_4 ) , V_71 ) ;
if ( ! V_4 )
return - V_72 ;
V_70 = F_35 ( V_68 , V_73 , 0 ) ;
V_4 -> V_15 = F_36 ( V_14 , V_70 ) ;
if ( F_29 ( V_4 -> V_15 ) )
...
V_4 -> V_8 . V_74 = V_75 ;
V_4 -> V_8 . V_76 = & V_77 ;
V_4 -> V_8 . V_14 . V_78 = V_14 ;
V_4 -> V_8 . V_14 . V_59 = V_14 -> V_59 ;
F_39 ( V_4 -> V_8 . V_79 , L_16 , sizeof( V_4 -> V_8 . V_79 ) ) ;
V_4 -> V_8 . V_80 = & V_81 ;
F_40 ( & V_4 -> V_8 , V_4 ) ;
F_41 ( V_68 , V_4 ) ;
V_20 = F_26 ( V_14 , V_4 ) ;
if ( V_20 )
goto V_82;
V_20 = F_42 ( V_14 , V_1 , F_1 , 0 , V_68 -> V_79 ,
V_4 ) ;
if ( V_20 ) {
F_10 ( V_14 , L_17 , V_1 ) ;
goto V_82;
