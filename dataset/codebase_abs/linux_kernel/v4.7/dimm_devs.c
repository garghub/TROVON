...
F_24 ( ! F_25 ( V_2 -> V_5 ) ) ;
F_15 ( V_51 -> V_73 ) ;
F_63 ( & V_2 -> V_75 , V_51 -> V_66 , F_61 ( V_51 ) ) ;
}
struct V_50 * F_64 ( struct V_1 * V_2 ,
struct V_76 * V_77 , T_4 V_66 ,
T_4 V_78 )
{
char * V_73 = F_65 ( V_77 , sizeof( * V_77 ) , V_27 ) ;
struct V_50 * V_51 ;
if ( ! V_73 )
return NULL ;
F_24 ( ! F_25 ( V_2 -> V_5 ) ) ;
V_51 = F_66 ( & V_2 -> V_75 , V_66 , V_78 , V_73 , 0 ) ;
if ( ! V_51 )
F_15 ( V_73 ) ;
return V_51 ;
}
...
static int F_68 ( struct V_40 * V_5 , void * V_80 )
{
int * V_81 = V_80 ;
if ( F_19 ( V_5 ) )
( * V_81 ) ++ ;
...
int F_69 ( struct V_14 * V_14 , int V_82 )
{
int V_81 = 0 ;
F_70 () ;
F_71 ( & V_14 -> V_5 , & V_81 , F_68 ) ;
