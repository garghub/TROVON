...
return F_18 ( V_62 ) ;
if ( V_62 -> V_94 -> V_95 )
V_6 = V_62 -> V_94 -> V_95 ( V_62 ) ;
else
V_6 = - V_96 ;
F_45 ( V_62 ) ;
if ( V_6 < 0 )
return V_6 ;
return sprintf ( V_81 , L_31 , V_6 ) ;
}
static T_2
...
static T_2
F_76 ( struct V_62 * V_71 , struct V_79 * V_80 ,
char * V_81 )
{
struct V_68 * V_62 ;
T_2 V_23 ;
...
if ( V_62 -> V_94 && V_62 -> V_94 -> V_107 &&
! V_62 -> V_94 -> V_107 ( V_62 , & V_106 ) ) {
if ( V_106 . type == V_108 ||
V_106 . type == V_109 ) {
F_45 ( V_62 ) ;
...
static T_2 F_78 ( struct V_62 * V_71 ,
struct V_79 * V_80 , char * V_81 )
{
struct V_68 * V_62 ;
struct V_105 V_106 ;
...
V_110 = L_42 ;
if ( F_15 ( V_62 ) )
return snprintf ( V_81 , V_41 , L_32 , V_110 ) ;
if ( V_62 -> V_94 && V_62 -> V_94 -> V_107 &&
! V_62 -> V_94 -> V_107 ( V_62 , & V_106 ) )
V_110 = V_106 . V_110 ;
F_45 ( V_62 ) ;
...
V_111 [ 0 ] = 0 ;
if ( F_15 ( V_62 ) )
return snprintf ( V_81 , V_41 , L_32 , V_111 ) ;
if ( V_62 -> V_94 && V_62 -> V_94 -> V_107 &&
! V_62 -> V_94 -> V_107 ( V_62 , & V_106 ) ) {
switch ( V_106 . type ) {
case V_114 :
snprintf ( V_113 , sizeof( V_113 ) , L_43 ,
V_106 . V_115 ) ;
break;
case V_108 :
snprintf ( V_113 , sizeof( V_113 ) , L_43 ,
...
break;
case V_109 :
snprintf ( V_113 , sizeof( V_113 ) , L_44 ) ;
break;
default:
snprintf ( V_113 , sizeof( V_113 ) , L_43 ,
V_106 . V_115 ) ;
...
if ( strlen ( V_106 . V_117 ) > 0 )
snprintf ( V_111 , sizeof( V_111 ) ,
L_45 ,
V_106 . V_110 , V_106 . V_118 , V_106 . V_20 , V_113 ,
V_106 . V_117 ) ;
else
snprintf ( V_111 , sizeof( V_111 ) ,
L_46 ,
...
static T_2
F_80 ( struct V_62 * V_71 , struct V_79 * V_80 , char * V_81 )
{
struct V_45 * V_46 ;
int V_119 ;
V_46 = F_25 ( F_34 ( V_71 ) ) ;
if ( ! F_15 ( V_46 ) && V_46 -> V_62 )
V_119 = F_81 ( V_46 -> V_62 ) ;
else
V_119 = 0 ;
return snprintf ( V_81 , V_41 , V_119 ? L_29 : L_30 ) ;
}
static T_2
F_82 ( struct V_62 * V_71 , struct V_79 * V_80 ,
const char * V_81 , T_3 V_6 )
{
struct V_45 * V_46 ;
int V_11 , V_24 ;
...
static T_2
F_85 ( struct V_62 * V_71 , struct V_79 * V_80 , char * V_81 )
{
struct V_68 * V_62 ;
int V_23 ;
V_62 = F_54 ( F_59 ( V_71 ) ) ;
...
static T_2
F_86 ( struct V_62 * V_71 , struct V_79 * V_80 ,
const char * V_81 , T_3 V_6 )
{
struct V_68 * V_62 ;
unsigned long V_11 ;
...
static T_2
F_87 ( struct V_62 * V_71 , struct V_79 * V_80 , char * V_81 )
{
struct V_68 * V_62 ;
int V_23 ;
V_62 = F_54 ( F_59 ( V_71 ) ) ;
...
if ( F_15 ( V_62 ) )
return - V_65 ;
V_23 = snprintf ( V_81 , V_41 , L_47 , V_62 -> V_124 ) ;
F_45 ( V_62 ) ;
return V_23 ;
}
static T_2
F_90 ( struct V_62 * V_71 , struct V_79 * V_80 ,
const char * V_81 , T_3 V_6 )
{
struct V_68 * V_62 ;
struct V_125 * V_126 ;
...
V_126 = V_62 -> V_85 -> V_125 ;
if ( ! V_126 ) {
F_45 ( V_62 ) ;
return - V_65 ;
}
F_40 ( & V_62 -> V_85 -> V_129 , V_72 ) ;
if ( ! V_11 )
F_91 ( V_126 , NULL ) ;
else
F_91 ( V_126 , V_130 ) ;
V_62 -> V_124 = V_11 ;
F_92 ( V_126 , V_62 -> V_124 * V_128 ) ;
F_43 ( & V_62 -> V_85 -> V_129 , V_72 ) ;
F_45 ( V_62 ) ;
return V_6 ;
}
...
static T_2 F_94 ( struct V_62 * V_71 ,
struct V_79 * V_80 ,
const char * V_81 , T_3 V_6 )
{
struct V_45 * V_46 ;
...
if ( F_62 ( V_132 , & V_62 -> V_72 ) )
V_24 = snprintf ( V_81 , V_41 , L_52 ) ;
else if ( F_62 ( V_133 , & V_62 -> V_72 ) )
...
static T_2 F_97 ( struct V_62 * V_71 ,
struct V_79 * V_80 ,
const char * V_81 , T_3 V_6 )
{
struct V_68 * V_62 ;
...
static T_2 F_99 ( struct V_62 * V_71 ,
struct V_79 * V_80 , char * V_81 )
{
struct V_68 * V_62 ;
T_4 V_134 , V_135 , V_136 , V_137 , V_138 ;
V_62 = F_54 ( F_59 ( V_71 ) ) ;
if ( F_15 ( V_62 ) )
return sprintf ( V_81 , L_30 ) ;
V_134 = V_62 -> V_139 . V_134 ;
V_135 = V_62 -> V_139 . V_140 ;
V_136 = V_62 -> V_139 . V_136 ;
V_137 = V_62 -> V_139 . V_137 ;
V_138 = V_62 -> V_139 . V_138 ;
F_45 ( V_62 ) ;
return sprintf ( V_81 , L_55 , V_134 , V_135 ,
V_136 , V_137 , V_138 ) ;
}
int
F_100 ( struct V_69 * V_70 , int V_141 )
{
struct V_45 * V_46 ;
V_46 = F_25 ( F_34 ( & V_70 -> V_71 ) ) ;
if ( F_15 ( V_46 ) )
return F_18 ( V_46 ) ;
return ( ( V_46 -> V_22 & V_141 ) != 0 ) ;
}
int
F_101 ( struct V_69 * V_70 , int V_141 , int V_142 )
{
struct V_45 * V_46 ;
V_46 = F_25 ( F_34 ( & V_70 -> V_71 ) ) ;
if ( F_15 ( V_46 ) )
...
{
return F_103 ( & V_70 -> V_71 . V_143 , & V_144 ) ;
}
void
F_104 ( struct V_69 * V_70 )
{
F_105 ( & V_70 -> V_71 . V_143 , & V_144 ) ;
}
int
F_106 ( void )
{
