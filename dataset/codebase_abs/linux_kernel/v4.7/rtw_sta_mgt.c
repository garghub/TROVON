...
V_2 -> V_112 = 0 ;
V_2 -> V_113 = 0 ;
V_26 -> V_38 &= ~ F_34 ( V_2 -> V_114 ) ;
V_26 -> V_39 &= ~ F_34 ( V_2 -> V_114 ) ;
...
struct V_25 * V_26 = & V_73 -> V_48 ;
V_3 V_118 [ V_67 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
return F_37 ( V_26 , V_118 ) ;
}
V_3 F_40 ( struct V_83 * V_73 , V_3 * V_122 )
{
V_3 V_119 = true ;
#ifdef F_7
struct V_52 * V_54 , * V_53 ;
