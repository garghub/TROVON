...
F_62 ( & V_134 -> V_2 , L_28 ,
V_153 , V_154 ) ;
F_60 ( V_22 -> V_97 , false ) ;
if ( V_22 -> V_136 . V_141 )
F_63 ( V_22 -> V_97 , V_166 ,
V_167 , 1 ) ;
if ( V_22 -> V_136 . V_143 )
F_63 ( V_22 -> V_97 , V_166 ,
V_168 , 1 ) ;
...
V_170 , 1 ) ;
if ( V_22 -> V_136 . V_145 )
F_63 ( V_22 -> V_97 , V_171 ,
V_172 ,
V_22 -> V_136 . V_145 ) ;
if ( V_22 -> V_136 . V_146 )
F_63 ( V_22 -> V_97 , V_173 ,
V_174 ,
V_22 -> V_136 . V_146 ) ;
if ( V_22 -> V_136 . V_149 )
F_63 ( V_22 -> V_97 , V_175 ,
V_176 ,
V_22 -> V_136 . V_149 ) ;
if ( V_22 -> V_136 . V_148 )
F_63 ( V_22 -> V_97 , V_175 ,
...
static int F_65 ( struct V_134 * V_181 )
{
struct V_21 * V_22 = F_66 ( V_181 ) ;
F_67 ( & V_181 -> V_2 ) ;
F_18 ( F_4 ( V_22 -> V_98 ) ,
V_22 -> V_98 ) ;
return 0 ;
