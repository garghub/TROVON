...
V_146 = V_46 ;
V_154 = F_64 ( F_65 ( ( F_66 ( V_158 -> V_175 ) ) ) ) ;
V_156 = V_158 -> V_172 & V_176 ;
}
F_67 ( & V_76 -> V_77 -> V_169 ) ;
if ( ! V_151 )
goto V_177;
} else {
V_6 = V_153 [ 0 ] ;
...
F_81 ( V_152 ) ;
V_106 [ 0 ] |= F_82 ( V_113 ) ;
F_83 ( V_1 , V_106 , V_107 ) ;
V_93 |= F_45 ( V_106 [ 1 ] ) & ( V_54 | V_55 ) ;
} else {
F_84 ( V_1 , V_5 , V_152 , V_107 , 0 ) ;
}
V_106 [ 1 ] = F_82 ( V_93 ) ;
F_85 () ;
F_86 ( V_106 , V_144 [ 0 ] ) ;
...
F_87 ( V_6 ) ;
V_177:
F_88 ( V_36 , V_144 , V_50 ) ;
if ( V_6 ) {
F_89 ( V_153 [ 0 ] ) ;
}
return V_50 ;
V_182:
F_86 ( V_106 , F_45 ( V_106 [ 0 ] ) ) ;
F_44 () ;
goto V_177;
}
...
T_6 V_149 , V_194 ;
V_192 = F_95 ( V_188 , V_38 -> V_195 ) ;
V_193 = F_96 ( V_189 , V_38 -> V_195 +
( V_38 -> V_41 << V_12 ) ) ;
if ( V_192 >= V_193 )
continue;
V_149 = F_97 ( V_192 , V_38 ) ;
V_194 = F_97 ( V_193 + V_168 - 1 , V_38 ) ;
for (; V_149 < V_194 ; ++ V_149 ) {
T_6 V_196 = V_149 - V_38 -> V_165 ;
V_50 = F_94 ( V_1 , & V_38 -> V_10 . V_152 [ V_196 ] , V_149 ) ;
V_191 |= V_50 ;
}
}
return V_191 ;
}
static int F_98 ( struct V_1 * V_1 , unsigned long V_150 ,
int (* F_94)( struct V_1 * V_1 , unsigned long * V_190 ,
unsigned long V_149 ) )
{
return F_93 ( V_1 , V_150 , V_150 + 1 , F_94 ) ;
}
static int F_99 ( struct V_1 * V_1 , unsigned long * V_190 ,
unsigned long V_149 )
{
...
int F_103 ( struct V_1 * V_1 , unsigned long V_150 )
{
F_98 ( V_1 , V_150 , F_99 ) ;
return 0 ;
}
int F_104 ( struct V_1 * V_1 , unsigned long V_188 , unsigned long V_189 )
{
F_93 ( V_1 , V_188 , V_189 , F_99 ) ;
return 0 ;
}
...
if ( * V_190 & V_199 )
F_99 ( V_1 , V_190 , V_149 ) ;
++ V_190 ;
++ V_149 ;
}
}
static int F_106 ( struct V_1 * V_1 , unsigned long * V_190 ,
unsigned long V_149 )
{
struct V_4 * V_5 = V_1 -> V_10 . V_23 ;
...
int F_108 ( struct V_1 * V_1 , unsigned long V_188 , unsigned long V_189 )
{
return F_93 ( V_1 , V_188 , V_189 , F_106 ) ;
}
static int F_109 ( struct V_1 * V_1 , unsigned long * V_190 ,
unsigned long V_149 )
{
struct V_4 * V_5 = V_1 -> V_10 . V_23 ;
unsigned long V_204 , V_40 , V_198 ;
...
int F_110 ( struct V_1 * V_1 , unsigned long V_150 )
{
return F_98 ( V_1 , V_150 , F_109 ) ;
}
void F_111 ( struct V_1 * V_1 , unsigned long V_150 , T_5 V_179 )
{
F_98 ( V_1 , V_150 , F_99 ) ;
}
...
static int F_112 ( struct V_1 * V_1 , unsigned long * V_190 )
{
struct V_4 * V_5 = V_1 -> V_10 . V_23 ;
unsigned long V_204 , V_40 , V_198 ;
unsigned long V_203 ;
...
if ( ! F_55 ( V_106 , V_115 ) ) {
F_81 ( V_190 ) ;
while ( V_106 [ 0 ] & F_82 ( V_115 ) )
F_56 () ;
goto V_205;
}
if ( ! ( V_106 [ 0 ] & F_82 ( V_112 ) ) ) {
F_86 ( V_106 , F_45 ( V_106 [ 0 ] ) ) ;
continue;
}
V_106 [ 0 ] |= F_82 ( V_113 ) ;
...
V_215 -> V_217 = false ;
if ( V_216 )
F_114 ( V_149 - V_38 -> V_165 , V_216 ) ;
}
long F_115 ( struct V_1 * V_1 , struct V_37 * V_38 ,
unsigned long * V_216 )
{
...
F_113 ( & V_36 -> V_10 . V_215 , V_38 , V_216 ) ;
F_113 ( & V_36 -> V_10 . V_220 , V_38 , V_216 ) ;
F_118 ( & V_36 -> V_10 . V_219 ) ;
}
F_44 () ;
return 0 ;
}
void * F_119 ( struct V_1 * V_1 , unsigned long V_135 ,
unsigned long * V_221 )
{
struct V_37 * V_38 ;
...
if ( V_221 )
* V_221 = V_168 - V_222 ;
return F_120 ( V_6 ) + V_222 ;
V_26:
F_92 ( & V_1 -> V_187 , V_186 ) ;
return NULL ;
}
void F_121 ( struct V_1 * V_1 , void * V_223 , unsigned long V_135 ,
bool V_217 )
{
...
static int F_122 ( struct V_4 * V_224 , T_4 * V_225 )
{
unsigned long V_226 ;
...
static long F_123 ( unsigned long V_71 , T_4 * V_225 ,
...
static T_7 F_124 ( struct V_233 * V_233 , char T_8 * V_234 ,
...
V_241 . V_248 < 0xffff &&
V_242 + V_247 < V_235 &&
F_123 ( V_71 , V_225 , V_144 , V_224 , 1 , V_229 ) ) {
++ V_241 . V_248 ;
if ( F_126 ( V_144 [ 0 ] , V_244 ) ||
F_126 ( V_144 [ 1 ] , V_244 + 1 ) )
return - V_166 ;
V_242 += V_247 ;
V_244 += 2 ;
++ V_40 ;
...
while ( V_40 < V_1 -> V_10 . V_20 &&
V_241 . V_249 < 0xffff &&
F_123 ( V_71 , V_225 , V_144 , V_224 , 0 , V_229 ) ) {
++ V_241 . V_249 ;
++ V_40 ;
V_225 += 2 ;
++ V_224 ;
...
if ( F_127 ( V_245 , & V_241 , sizeof( V_241 ) ) )
return - V_166 ;
V_243 = V_242 ;
...
static T_7 F_128 ( struct V_233 * V_233 , const char T_8 * V_234 ,
T_9 V_235 , T_10 * V_236 )
{
struct V_237 * V_238 = V_233 -> V_239 ;
struct V_1 * V_1 = V_238 -> V_1 ;
...
V_26 = - V_166 ;
if ( F_129 ( & V_241 , V_234 , sizeof( V_241 ) ) )
break;
V_26 = 0 ;
...
if ( ! V_251 && F_132 ( V_92 ) ) {
unsigned long V_46 = F_133 ( V_92 , V_93 ) ;
unsigned long V_256 = F_134 ( V_46 ) ;
unsigned long V_257 ;
V_1 -> V_10 . V_111 = V_256 | V_89 |
( V_52 << V_258 ) ;
V_257 = V_256 << ( V_259 - 4 ) ;
F_135 ( V_1 , V_257 , V_260 ) ;
V_251 = 1 ;
}
++ V_40 ;
V_225 += 2 ;
...
static int F_137 ( struct V_261 * V_261 , struct V_233 * V_262 )
{
struct V_237 * V_238 = V_262 -> V_239 ;
V_262 -> V_239 = NULL ;
if ( ! ( V_238 -> V_71 & V_263 ) )
F_138 ( & V_238 -> V_1 -> V_10 . V_264 ) ;
F_139 ( V_238 -> V_1 ) ;
F_140 ( V_238 ) ;
return 0 ;
}
int F_141 ( struct V_1 * V_1 , struct V_265 * V_266 )
{
int V_50 ;
struct V_237 * V_238 ;
int V_267 ;
...
V_50 = F_144 ( L_7 , & V_271 , V_238 , V_267 | V_272 ) ;
if ( V_50 < 0 ) {
F_139 ( V_1 ) ;
return V_50 ;
}
if ( V_267 == V_270 ) {
F_13 ( & V_1 -> V_273 ) ;
F_145 ( & V_1 -> V_10 . V_264 ) ;
F_146 ( & V_1 -> V_187 ) ;
F_18 ( & V_1 -> V_273 ) ;
}
return V_50 ;
}
static int F_147 ( struct V_261 * V_261 , struct V_233 * V_233 )
{
struct V_1 * V_1 = V_261 -> V_274 ;
struct V_275 * V_276 ;
V_276 = F_142 ( sizeof( * V_276 ) , V_13 ) ;
if ( ! V_276 )
return - V_17 ;
F_143 ( V_1 ) ;
V_276 -> V_1 = V_1 ;
F_148 ( & V_276 -> V_277 ) ;
V_233 -> V_239 = V_276 ;
return F_149 ( V_261 , V_233 ) ;
}
static int F_150 ( struct V_261 * V_261 , struct V_233 * V_233 )
{
...
static T_7 F_151 ( struct V_233 * V_233 , char T_8 * V_234 ,
...
if ( V_203 > V_278 )
V_203 = V_278 ;
V_93 = F_153 ( V_234 , V_276 -> V_234 + V_276 -> V_281 , V_203 ) ;
V_203 -= V_93 ;
V_276 -> V_280 -= V_203 ;
V_276 -> V_281 += V_203 ;
V_234 += V_203 ;
...
if ( ! ( V_92 & ( V_112 | V_113 ) ) )
continue;
V_203 = F_154 ( V_276 -> V_234 , sizeof( V_276 -> V_234 ) ,
L_8 ,
V_40 , V_92 , V_279 , V_105 ) ;
V_276 -> V_280 = V_203 ;
if ( V_203 > V_278 )
V_203 = V_278 ;
V_93 = F_153 ( V_234 , V_276 -> V_234 , V_203 ) ;
V_203 -= V_93 ;
V_276 -> V_280 -= V_203 ;
V_276 -> V_281 = V_203 ;
V_234 += V_203 ;
...
T_7 F_155 ( struct V_233 * V_233 , const char T_8 * V_234 ,
T_9 V_278 , T_10 * V_236 )
{
return - V_283 ;
}
...
{
V_1 -> V_10 . V_284 = F_157 ( L_9 , 0400 ,
V_1 -> V_10 . V_285 , V_1 ,
& V_286 ) ;
}
void F_158 ( struct V_35 * V_36 )
{
