...
V_181 = F_106 () ;
if ( F_65 ( V_181 ) ) {
V_8 = F_26 ( V_177 , sizeof( V_177 ) ,
L_20 ,
V_181 ) ;
V_180 += F_15 ( 0 , 2 , V_56 | V_131 , 0 ,
NULL , 0 , V_177 , V_8 ) ;
}
V_8 = F_107 ( V_34 , sizeof( V_177 ) , V_175 , args ) ;
if ( V_8 && V_34 [ V_8 - 1 ] == '\n' ) {
V_8 -- ;
V_178 |= V_131 ;
}
if ( V_28 == 0 ) {
int V_188 = F_108 ( V_34 ) ;
if ( V_188 ) {
const char * V_189 = F_109 ( V_34 ) ;
switch ( V_188 ) {
case '0' ... '7' :
if ( V_29 == V_144 )
V_29 = V_188 - '0' ;
...
T_10 int F_114 ( const char * V_175 , T_11 args )
{
...
int V_191 ;
va_start ( args , V_175 ) ;
V_191 = F_100 ( V_28 , V_29 , V_33 , V_174 , V_175 , args ) ;
va_end ( args ) ;
return V_191 ;
}
int F_115 ( const char * V_175 , T_11 args )
{
int V_191 ;
#ifdef F_116
if ( F_65 ( V_192 ) ) {
V_191 = F_117 ( V_193 , V_175 , args ) ;
return V_191 ;
}
#endif
V_191 = F_100 ( 0 , V_144 , NULL , 0 , V_175 , args ) ;
return V_191 ;
}
T_10 T_12 int F_118 ( const char * V_175 , ... )
{
T_11 args ;
int V_191 ;
va_start ( args , V_175 ) ;
V_191 = F_119 ( V_175 , args ) ;
va_end ( args ) ;
return V_191 ;
}
...
T_10 T_12 void F_120 ( const char * V_175 , ... )
{
T_11 V_194 ;
char V_50 [ 512 ] ;
int V_134 ;
if ( ! V_195 )
return;
va_start ( V_194 , V_175 ) ;
V_134 = F_107 ( V_50 , sizeof( V_50 ) , V_175 , V_194 ) ;
va_end ( V_194 ) ;
V_195 -> V_162 ( V_195 , V_50 , V_134 ) ;
}
static int F_121 ( char * V_196 , int V_9 , char * V_197 ,
char * V_198 )
{
struct V_199 * V_49 ;
int V_58 ;
for ( V_58 = 0 , V_49 = V_199 ;
V_58 < V_200 && V_49 -> V_196 [ 0 ] ;
V_58 ++ , V_49 ++ ) {
if ( strcmp ( V_49 -> V_196 , V_196 ) == 0 && V_49 -> V_201 == V_9 ) {
if ( ! V_198 )
V_202 = V_58 ;
return 0 ;
}
...
if ( ! V_198 )
V_202 = V_58 ;
F_122 ( V_49 -> V_196 , V_196 , sizeof( V_49 -> V_196 ) ) ;
V_49 -> V_197 = V_197 ;
F_123 ( V_49 , V_198 ) ;
V_49 -> V_201 = V_9 ;
return 0 ;
}
static int T_9 F_124 ( char * V_105 )
{
char V_50 [ sizeof( V_199 [ 0 ] . V_196 ) + 4 ] ;
char * V_204 , * V_197 , * V_198 = NULL ;
int V_9 ;
if ( F_125 ( & V_105 , & V_198 ) )
return 1 ;
...
* ( V_197 ++ ) = 0 ;
#ifdef F_126
if ( ! strcmp ( V_105 , L_22 ) )
strcpy ( V_50 , L_23 ) ;
if ( ! strcmp ( V_105 , L_24 ) )
strcpy ( V_50 , L_25 ) ;
#endif
for ( V_204 = V_50 ; * V_204 ; V_204 ++ )
if ( isdigit ( * V_204 ) || * V_204 == ',' )
break;
V_9 = F_33 ( V_204 , NULL , 10 ) ;
* V_204 = 0 ;
F_121 ( V_50 , V_9 , V_197 , V_198 ) ;
V_205 = 1 ;
return 1 ;
}
int F_127 ( char * V_196 , int V_9 , char * V_197 )
{
return F_121 ( V_196 , V_9 , V_197 , NULL ) ;
}
static int T_9 F_128 ( char * V_105 )
{
V_206 = false ;
return 1 ;
}
...
{
return F_88 ( F_142 () ) || F_140 () ;
}
static void F_143 ( char * V_34 , T_5 V_22 )
{
unsigned long V_31 ;
T_5 V_10 ;
F_67 ( & V_79 , V_31 ) ;
...
void F_153 ( struct V_157 * V_157 )
{
F_130 () ;
V_157 -> V_31 |= V_161 ;
F_113 () ;
}
static int T_9 F_154 ( char * V_105 )
{
V_231 = 1 ;
F_61 ( L_28 ) ;
return 0 ;
}
void F_155 ( struct V_157 * V_232 )
{
int V_58 ;
unsigned long V_31 ;
struct V_157 * V_233 = NULL ;
struct V_199 * V_49 ;
if ( V_159 )
F_87 (bcon)
if ( F_156 ( V_233 == V_232 ,
L_29 ,
V_233 -> V_196 , V_233 -> V_201 ) )
return;
if ( V_159 && V_232 -> V_31 & V_234 ) {
F_87 (bcon) {
if ( ! ( V_233 -> V_31 & V_234 ) ) {
F_61 ( L_30 ,
V_232 -> V_196 , V_232 -> V_201 ) ;
return;
}
}
}
if ( V_159 && V_159 -> V_31 & V_234 )
V_233 = V_159 ;
if ( V_235 < 0 || V_233 || ! V_159 )
V_235 = V_202 ;
if ( V_235 < 0 ) {
if ( V_232 -> V_201 < 0 )
V_232 -> V_201 = 0 ;
...
V_58 ++ , V_49 ++ ) {
if ( ! V_232 -> V_238 ||
V_232 -> V_238 ( V_232 , V_49 -> V_196 , V_49 -> V_201 , V_49 -> V_197 ) != 0 ) {
F_157 ( sizeof( V_49 -> V_196 ) != sizeof( V_232 -> V_196 ) ) ;
if ( strcmp ( V_49 -> V_196 , V_232 -> V_196 ) != 0 )
continue;
if ( V_232 -> V_201 >= 0 &&
V_232 -> V_201 != V_49 -> V_201 )
continue;
if ( V_232 -> V_201 < 0 )
V_232 -> V_201 = V_49 -> V_201 ;
if ( F_158 ( V_232 , V_49 ) )
return;
if ( V_232 -> V_236 &&
V_232 -> V_236 ( V_232 , V_49 -> V_197 ) != 0 )
break;
}
V_232 -> V_31 |= V_161 ;
if ( V_58 == V_202 ) {
...
if ( ! ( V_232 -> V_31 & V_161 ) )
return;
if ( V_233 && ( ( V_232 -> V_31 & ( V_237 | V_234 ) ) == V_237 ) )
V_232 -> V_31 &= ~ V_239 ;
F_130 () ;
if ( ( V_232 -> V_31 & V_237 ) || V_159 == NULL ) {
V_232 -> V_132 = V_159 ;
V_159 = V_232 ;
if ( V_232 -> V_132 )
V_232 -> V_132 -> V_31 &= ~ V_237 ;
} else {
V_232 -> V_132 = V_159 -> V_132 ;
V_159 -> V_132 = V_232 ;
}
if ( V_232 -> V_31 & V_164 )
if ( ! V_171 ++ )
...
F_159 () ;
F_61 ( L_32 ,
( V_232 -> V_31 & V_234 ) ? L_33 : L_34 ,
V_232 -> V_196 , V_232 -> V_201 ) ;
if ( V_233 &&
( ( V_232 -> V_31 & ( V_237 | V_234 ) ) == V_237 ) &&
! V_231 ) {
F_87 (bcon)
if ( V_233 -> V_31 & V_234 )
F_160 ( V_233 ) ;
...
int F_160 ( struct V_157 * V_157 )
{
struct V_157 * V_240 , * V_241 ;
int V_242 ;
F_61 ( L_35 ,
( V_157 -> V_31 & V_234 ) ? L_33 : L_34 ,
V_157 -> V_196 , V_157 -> V_201 ) ;
V_242 = F_161 ( V_157 ) ;
if ( V_242 )
return V_242 ;
V_242 = 1 ;
...
for ( V_240 = V_159 -> V_132 , V_241 = V_159 ;
V_240 ; V_241 = V_240 , V_240 = V_241 -> V_132 ) {
if ( V_240 == V_157 ) {
V_241 -> V_132 = V_240 -> V_132 ;
V_242 = 0 ;
break;
}
}
}
if ( ! V_242 && ( V_157 -> V_31 & V_164 ) )
V_171 -- ;
if ( V_159 != NULL && V_157 -> V_31 & V_237 )
V_159 -> V_31 |= V_237 ;
V_157 -> V_31 &= ~ V_161 ;
F_113 () ;
F_159 () ;
...
struct V_157 * V_158 ;
F_87 (con) {
if ( ! V_231 && V_158 -> V_31 & V_234 ) {
if ( F_163 ( V_158 , sizeof( * V_158 ) ) )
F_160 ( V_158 ) ;
}
}
F_164 ( F_134 , 0 ) ;
...
static void F_165 ( struct V_243 * V_243 )
{
int V_244 = F_166 ( V_245 , 0 ) ;
if ( V_244 & V_246 ) {
if ( F_112 () )
F_113 () ;
}
...
int F_174 ( const char * V_175 , ... )
{
T_11 args ;
int V_191 ;
F_168 () ;
va_start ( args , V_175 ) ;
V_191 = F_100 ( 0 , V_185 , NULL , 0 , V_175 , args ) ;
va_end ( args ) ;
F_175 ( V_245 , V_246 ) ;
F_171 ( F_172 ( & V_248 ) ) ;
F_173 () ;
...
int F_176 ( const char * V_249 )
{
return F_177 ( & V_250 , V_249 ) ;
}
bool F_178 ( unsigned long * V_251 ,
unsigned int V_252 )
{
unsigned long V_253 = V_123 - * V_251 ;
if ( * V_251 && V_253 <= F_74 ( V_252 ) )
return false ;
* V_251 = V_123 ;
return true ;
}
int F_179 ( struct V_254 * V_255 )
{
unsigned long V_31 ;
int V_100 = - V_256 ;
if ( ! V_255 -> V_257 )
...
if ( ! V_255 -> V_259 ) {
V_255 -> V_259 = 1 ;
F_181 ( & V_255 -> V_260 , & V_261 ) ;
V_100 = 0 ;
}
F_182 ( & V_258 , V_31 ) ;
return V_100 ;
}
int F_183 ( struct V_254 * V_255 )
{
unsigned long V_31 ;
int V_100 = - V_66 ;
F_180 ( & V_258 , V_31 ) ;
...
bool F_190 ( struct V_254 * V_255 , bool V_127 ,
...
goto V_83;
V_7 = F_8 ( V_255 -> V_269 ) ;
V_271 = F_80 ( V_7 , 0 , V_127 , line , V_22 ) ;
...
bool F_191 ( struct V_254 * V_255 , bool V_127 ,
char * line , T_5 V_22 , T_5 * V_10 )
{
unsigned long V_31 ;
bool V_64 ;
F_67 ( & V_79 , V_31 ) ;
V_64 = F_190 ( V_255 , V_127 , line , V_22 , V_10 ) ;
F_68 ( & V_79 , V_31 ) ;
return V_64 ;
}
bool F_192 ( struct V_254 * V_255 , bool V_127 ,
...
V_9 = V_255 -> V_269 ;
V_86 = 0 ;
while ( V_51 < V_255 -> V_141 ) {
struct V_6 * V_7 = F_8 ( V_9 ) ;
V_271 += F_80 ( V_7 , V_86 , true , NULL , 0 ) ;
V_9 = F_9 ( V_9 ) ;
V_51 ++ ;
V_86 = V_7 -> V_31 ;
}
...
V_9 = V_255 -> V_269 ;
V_86 = 0 ;
while ( V_271 > V_22 && V_51 < V_255 -> V_141 ) {
struct V_6 * V_7 = F_8 ( V_9 ) ;
V_271 -= F_80 ( V_7 , V_86 , true , NULL , 0 ) ;
V_9 = F_9 ( V_9 ) ;
V_51 ++ ;
...
while ( V_51 < V_255 -> V_141 ) {
struct V_6 * V_7 = F_8 ( V_9 ) ;
V_271 += F_80 ( V_7 , V_86 , V_127 , V_50 + V_271 , V_22 - V_271 ) ;
V_9 = F_9 ( V_9 ) ;
V_51 ++ ;
V_86 = V_7 -> V_31 ;
}
...
void T_9 F_195 ( const char * V_175 , ... )
{
T_11 args ;
va_start ( args , V_175 ) ;
...
void F_196 ( const char * V_273 )
{
F_118 ( L_36 ,
V_273 , F_142 () , V_44 -> V_274 , V_44 -> V_45 ,
F_197 () , F_198 () -> V_275 ,
( int ) strcspn ( F_198 () -> V_276 , L_37 ) ,
F_198 () -> V_276 ) ;
if ( V_272 [ 0 ] != '\0' )
F_118 ( L_38 ,
V_273 , V_272 ) ;
