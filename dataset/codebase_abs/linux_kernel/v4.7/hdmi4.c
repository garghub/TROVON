...
if ( V_27 -> V_39 )
V_33 *= 2 ;
F_23 ( & V_2 . V_40 , V_33 , & V_32 ) ;
V_1 = F_24 ( & V_2 . V_40 . V_40 ) ;
if ( V_1 ) {
F_15 ( L_6 ) ;
goto V_41;
}
V_1 = F_25 ( & V_2 . V_40 . V_40 , & V_32 ) ;
if ( V_1 ) {
F_15 ( L_7 ) ;
goto V_42;
}
V_1 = F_26 ( & V_2 . V_43 , V_32 . V_44 ,
V_32 . V_45 [ 0 ] ) ;
if ( V_1 ) {
F_2 ( L_8 ) ;
goto V_46;
...
if ( V_1 )
goto V_47;
F_27 ( & V_2 . V_48 , & V_2 . V_9 , & V_2 . V_34 ) ;
F_28 ( 0 ) ;
F_29 ( V_29 , V_27 ) ;
V_1 = F_30 ( V_29 ) ;
if ( V_1 )
...
static int F_49 ( T_3 * V_56 , int V_57 )
{
int V_1 ;
F_40 ( & V_2 . V_53 ) ;
V_1 = F_1 () ;
F_50 ( V_1 ) ;
V_1 = F_51 ( & V_2 . V_48 , V_56 , V_57 ) ;
F_5 () ;
F_42 ( & V_2 . V_53 ) ;
return V_1 ;
}
...
{
F_53 ( & V_59 -> V_9 , true ) ;
F_54 ( & V_59 -> V_48 , & V_59 -> V_9 ) ;
}
static void F_55 ( struct V_58 * V_59 )
{
F_56 ( & V_59 -> V_48 , & V_59 -> V_9 ) ;
F_53 ( & V_59 -> V_9 , false ) ;
}
...
if ( V_2 . V_66 ) {
V_1 = F_58 ( & V_2 . V_48 , & V_2 . V_9 , & V_2 . V_67 ,
V_2 . V_34 . V_35 . V_38 ) ;
if ( V_1 ) {
F_15 ( L_12 , V_1 ) ;
...
{
struct V_58 * V_59 = F_83 ( V_4 ) ;
int V_99 = 0 ;
F_40 ( & V_59 -> V_53 ) ;
if ( ! F_84 ( & V_59 -> V_34 ) || ! V_59 -> V_71 ) {
V_99 = - V_100 ;
goto V_60;
}
V_59 -> V_68 = F_82 ;
...
V_99 = F_58 ( & V_59 -> V_48 , & V_59 -> V_9 , V_102 ,
V_59 -> V_34 . V_35 . V_38 ) ;
if ( ! V_99 ) {
V_59 -> V_66 = true ;
V_59 -> V_67 = * V_102 ;
...
if ( V_1 )
return V_1 ;
V_1 = F_100 ( V_3 , & V_2 . V_43 ) ;
if ( V_1 )
goto V_97;
V_1 = F_101 ( V_3 , & V_2 . V_48 ) ;
if ( V_1 )
goto V_97;
V_6 = F_102 ( V_3 , 0 ) ;
if ( V_6 < 0 ) {
