...
F_46 ( V_2 , V_260 -> V_119 == V_262 ? V_171 : V_170 ) ;
F_40 ( V_2 , V_260 -> V_178 == V_263 ? 10 : 100 ) ;
}
return 0 ;
}
...
struct V_264 * V_265 )
{
F_96 ( V_265 -> V_266 , L_17 , sizeof( V_265 -> V_266 ) ) ;
F_96 ( V_265 -> V_267 , L_18 , sizeof( V_265 -> V_267 ) ) ;
F_96 ( V_265 -> V_268 , L_19 , sizeof( V_265 -> V_268 ) ) ;
F_96 ( V_265 -> V_269 , L_19 , sizeof( V_265 -> V_269 ) ) ;
}
...
static int
F_98 ( struct V_1 * V_2 , struct V_270 * V_271 )
{
struct V_3 * V_4 = F_5 ( V_2 ) ;
F_14 ( & V_4 -> V_25 ) ;
switch( V_271 -> V_272 ) {
...
static void
F_73 ( struct V_283 * V_284 )
{
unsigned long V_285 = * V_140 ;
V_284 -> V_286 += F_55 ( V_140 , V_287 , V_285 ) ;
V_284 -> V_288 += F_55 ( V_140 , V_289 , V_285 ) ;
V_284 -> V_290 += F_55 ( V_140 , V_291 , V_285 ) ;
V_284 -> V_292 += F_55 ( V_140 , V_293 , V_285 ) ;
}
static void
F_85 ( struct V_283 * V_284 )
{
unsigned long V_285 = * V_141 ;
V_284 -> V_294 +=
F_55 ( V_141 , V_295 , V_285 ) +
F_55 ( V_141 , V_296 , V_285 ) ;
}
static struct V_283 *
F_99 ( struct V_1 * V_2 )
{
struct V_3 * V_297 = F_5 ( V_2 ) ;
unsigned long V_86 ;
F_58 ( & V_297 -> V_25 , V_86 ) ;
F_73 ( & V_2 -> V_210 ) ;
F_85 ( & V_2 -> V_210 ) ;
F_63 ( & V_297 -> V_25 , V_86 ) ;
return & V_2 -> V_210 ;
}
static void
...
struct V_3 * V_297 = F_5 ( V_2 ) ;
int V_298 = F_101 ( V_2 ) ;
unsigned long int V_299 ;
unsigned long int V_300 ;
F_14 ( & V_297 -> V_25 ) ;
if ( V_2 -> V_86 & V_301 ) {
V_299 = 0xfffffffful ;
V_300 = 0xfffffffful ;
F_22 ( V_112 , V_113 , V_302 , V_117 ) ;
* V_113 = V_112 ;
} else if ( V_2 -> V_86 & V_303 ) {
V_299 = 0xfffffffful ;
V_300 = 0xfffffffful ;
F_22 ( V_112 , V_113 , V_302 , V_304 ) ;
* V_113 = V_112 ;
} else if ( V_298 == 0 ) {
V_299 = 0x00000000ul ;
V_300 = 0x00000000ul ;
...
V_48 -> V_33 . V_34 = V_309 | V_41 | V_310 ;
V_48 -> V_33 . V_37 = F_8 ( V_37 ) ;
V_49 -> V_33 . V_34 &= ~ V_41 ;
V_49 = V_48 ;
* V_311 = F_17 ( V_311 , V_144 , V_221 ) ;
}
static void
V_60 ( unsigned long V_312 )
{
struct V_1 * V_2 = (struct V_1 * ) V_312 ;
struct V_3 * V_4 = F_5 ( V_2 ) ;
F_14 ( & V_4 -> V_26 ) ;
if ( V_229 && F_74 ( V_55 , V_76 ) ) {
F_37 ( V_167 ) ;
...
{
#if F_47 ( V_314 )
int V_315 = ( V_219 == V_167 ) ;
#elif F_47 ( V_316 )
int V_315 = ( V_219 == V_230 ) ;
#else
...
unsigned int V_324 ;
if ( sscanf ( V_321 + 3 * V_5 , L_22 , & V_324 ) != 1 ) {
F_2 ( V_209 L_23 ) ;
return 0 ;
}
V_322 . V_81 [ V_5 ] = ( char ) V_324 ;
}
V_50 = V_322 ;
return 1 ;
}
