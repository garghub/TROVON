...
char V_66 [ 16 ] ;
V_63 = F_23 ( & V_60 -> V_17 , sizeof( * V_63 ) , V_67 ) ;
if ( ! V_63 )
return - V_68 ;
for ( V_62 = 0 ; V_62 < F_15 ( V_64 ) ; V_62 ++ ) {
if ( F_24 ( V_64 [ V_62 ] . V_69 ) ) {
F_25 ( & V_60 -> V_17 ,
L_7 , V_64 [ V_62 ] . V_69 ) ;
V_3 = V_64 [ V_62 ] . V_65 ;
V_63 -> V_40 = & V_64 [ V_62 ] ;
...
V_3 -> V_17 = & V_60 -> V_17 ;
sprintf ( V_66 , L_8 , V_63 -> V_40 -> V_69 ) ;
for ( V_62 = 0 ; V_62 < F_15 ( V_70 ) ; V_62 ++ )
if ( ! strcmp ( V_3 -> V_71 [ V_62 ] . V_66 , L_9 ) )
V_3 -> V_71 [ V_62 ] . V_66 = F_26 ( V_66 , V_72 ) ;
F_27 ( V_3 , V_63 ) ;
V_61 = F_28 ( & V_60 -> V_17 , V_3 ) ;
if ( V_61 ) {
F_4 ( & V_60 -> V_17 ,
L_10 , V_61 ) ;
return V_61 ;
