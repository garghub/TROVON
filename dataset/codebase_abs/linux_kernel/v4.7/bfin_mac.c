...
static int F_171 ( struct V_16 * V_170 , struct V_171 * V_172 , int V_104 )
{
struct V_61 * V_62 = F_22 ( V_170 ) ;
if ( ! F_77 ( V_170 ) )
return - V_88 ;
...
default:
if ( V_62 -> V_64 )
return F_172 ( V_62 -> V_64 , V_172 , V_104 ) ;
else
return - V_126 ;
}
}
...
static int F_174 ( struct V_16 * V_17 )
{
struct V_61 * V_62 = F_22 ( V_17 ) ;
int V_56 ;
F_28 ( L_15 , V_17 -> V_270 , V_181 ) ;
...
F_182 ( V_17 ) ;
F_183 ( V_62 -> V_64 ) ;
F_184 ( V_62 -> V_64 , V_285 , V_286 ) ;
F_173 ( V_17 ) ;
F_1 () ;
return 0 ;
}
static int F_185 ( struct V_287 * V_288 )
{
struct V_16 * V_229 ;
struct V_61 * V_62 ;
struct V_287 * V_289 ;
struct V_290 * V_291 ;
int V_120 ;
V_229 = F_186 ( sizeof( struct V_61 ) ) ;
if ( ! V_229 )
return - V_47 ;
F_187 ( V_229 , & V_288 -> V_17 ) ;
F_188 ( V_288 , V_229 ) ;
V_62 = F_22 ( V_229 ) ;
V_62 -> V_229 = V_229 ;
* ( V_155 * ) ( & ( V_229 -> V_162 [ 0 ] ) ) = F_189 ( F_190 () ) ;
* ( V_157 * ) ( & ( V_229 -> V_162 [ 4 ] ) ) = F_191 ( ( V_57 ) F_192 () ) ;
F_74 ( 0x12345678 ) ;
if ( F_190 () != 0x12345678 ) {
F_193 ( & V_288 -> V_17 , L_19 ) ;
V_120 = - V_86 ;
goto V_292;
}
if ( ! F_175 ( V_229 -> V_162 ) ) {
if ( F_194 ( V_229 -> V_162 ) ||
! F_175 ( V_229 -> V_162 ) ) {
F_26 ( V_229 , L_20 ) ;
F_195 ( V_229 ) ;
}
...
F_71 ( V_229 -> V_162 ) ;
if ( ! F_196 ( & V_288 -> V_17 ) ) {
F_193 ( & V_288 -> V_17 , L_21 ) ;
V_120 = - V_86 ;
goto V_292;
}
V_289 = F_196 ( & V_288 -> V_17 ) ;
V_62 -> V_52 = F_197 ( V_289 ) ;
if ( ! V_62 -> V_52 ) {
F_193 ( & V_288 -> V_17 , L_22 ) ;
V_120 = - V_86 ;
goto V_292;
}
V_62 -> V_52 -> V_293 = V_229 ;
V_291 = F_196 ( & V_289 -> V_17 ) ;
V_120 = F_30 ( V_229 , V_291 -> V_79 ) ;
if ( V_120 ) {
F_193 ( & V_288 -> V_17 , L_23 ) ;
goto V_294;
}
V_62 -> V_151 = V_295 | V_291 -> V_151 ;
V_62 -> V_152 = V_295 | V_291 -> V_152 ;
V_229 -> V_296 = & V_297 ;
V_229 -> V_298 = & V_299 ;
F_198 ( & V_62 -> V_230 ) ;
V_62 -> V_230 . V_44 = ( unsigned long ) V_62 ;
V_62 -> V_230 . V_300 = F_134 ;
V_62 -> V_65 = 0 ;
F_199 ( V_229 , & V_62 -> V_253 , F_145 , V_15 ) ;
F_123 ( & V_62 -> V_67 ) ;
V_120 = F_55 ( V_259 , F_149 ,
0 , L_24 , V_229 ) ;
if ( V_120 ) {
F_193 ( & V_288 -> V_17 , L_25 ) ;
V_120 = - V_161 ;
goto V_301;
}
V_120 = F_200 ( V_229 ) ;
if ( V_120 ) {
F_193 ( & V_288 -> V_17 , L_26 ) ;
goto V_302;
}
F_102 ( V_229 ) ;
V_120 = F_120 ( V_229 , & V_288 -> V_17 ) ;
if ( V_120 ) {
F_193 ( & V_288 -> V_17 , L_27 ) ;
goto V_303;
}
F_169 ( V_229 , L_28 , V_304 , V_112 ) ;
return 0 ;
V_303:
V_302:
F_56 ( V_259 , V_229 ) ;
...
static int F_205 ( struct V_287 * V_288 )
{
struct V_16 * V_229 = F_197 ( V_288 ) ;
struct V_61 * V_62 = F_22 ( V_229 ) ;
F_124 ( V_62 ) ;
V_62 -> V_52 -> V_293 = NULL ;
F_206 ( V_229 ) ;
F_201 ( & V_62 -> V_253 ) ;
F_56 ( V_259 , V_229 ) ;
F_204 ( V_229 ) ;
...
static int F_207 ( struct V_287 * V_288 , T_7 V_305 )
{
struct V_16 * V_306 = F_197 ( V_288 ) ;
struct V_61 * V_62 = F_22 ( V_306 ) ;
if ( V_62 -> V_119 ) {
...
static int F_210 ( struct V_287 * V_288 )
{
struct V_16 * V_306 = F_197 ( V_288 ) ;
struct V_61 * V_62 = F_22 ( V_306 ) ;
if ( V_62 -> V_119 ) {
...
static int F_212 ( struct V_287 * V_288 )
{
struct V_52 * V_308 ;
struct V_290 * V_309 ;
const unsigned short * V_310 ;
int V_120 , V_5 ;
V_309 = F_196 ( & V_288 -> V_17 ) ;
if ( ! V_309 ) {
F_193 ( & V_288 -> V_17 , L_29 ) ;
return - V_88 ;
}
V_310 = V_309 -> V_311 ;
V_120 = F_213 ( V_310 , V_110 ) ;
if ( V_120 ) {
F_193 ( & V_288 -> V_17 , L_30 ) ;
return V_120 ;
}
V_120 = - V_47 ;
V_308 = F_214 () ;
...
V_308 -> V_313 = F_14 ;
V_308 -> V_314 = F_19 ;
V_308 -> V_315 = & V_288 -> V_17 ;
V_308 -> V_270 = L_31 ;
V_308 -> V_316 = V_309 -> V_316 ;
snprintf ( V_308 -> V_317 , V_318 , L_32 ,
V_288 -> V_270 , V_288 -> V_317 ) ;
V_120 = F_215 ( V_309 -> V_319 , 0 , V_143 ) ;
if ( V_120 != V_309 -> V_319 )
F_193 ( & V_288 -> V_17 , L_33 ,
V_309 -> V_319 ) ;
for ( V_5 = 0 ; V_5 < V_120 ; ++ V_5 ) {
unsigned short V_320 = V_309 -> V_321 [ V_5 ] . V_160 ;
if ( V_320 < V_143 )
V_308 -> V_100 [ V_320 ] = V_309 -> V_321 [ V_5 ] . V_100 ;
else
F_193 ( & V_288 -> V_17 ,
L_34 ,
V_320 , V_5 ) ;
...
static int F_218 ( struct V_287 * V_288 )
{
struct V_52 * V_308 = F_197 ( V_288 ) ;
struct V_290 * V_309 =
F_196 ( & V_288 -> V_17 ) ;
F_202 ( V_308 ) ;
F_203 ( V_308 ) ;
...
{
return F_220 ( V_323 , F_221 ( V_323 ) ) ;
}
static void T_9 F_222 ( void )
{
F_223 ( V_323 , F_221 ( V_323 ) ) ;
}
