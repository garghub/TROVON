...
V_149 = F_81 ( V_141 , 0 , sizeof( V_148 ) , & V_148 ) ;
if ( V_149 == NULL )
return;
F_30 ( & V_11 -> V_95 ) ;
V_145 = F_82 ( V_11 , * V_149 ) ;
...
T_4 V_73 , V_159 ;
char * V_160 ;
V_160 = ( ( char * ) & V_83 -> V_161 ) + V_83 -> V_162 ;
V_73 = sizeof( V_83 -> V_161 ) - V_83 -> V_162 ;
V_159 = V_144 ( V_143 , V_160 , V_73 ) ;
V_83 -> V_162 += V_159 ;
if ( V_159 != V_73 )
return;
V_83 -> V_163 = F_12 ( V_83 -> V_161 ) ;
if ( V_83 -> V_163 & V_100 )
V_83 -> V_164 |= V_165 ;
else
V_83 -> V_164 &= ~ V_165 ;
...
T_4 V_73 , V_159 ;
char * V_160 ;
V_73 = sizeof( V_83 -> V_171 ) - V_83 -> V_162 ;
F_2 ( L_25 , V_73 ) ;
V_160 = ( ( char * ) & V_83 -> V_171 ) + V_83 -> V_162 ;
V_159 = V_144 ( V_143 , V_160 , V_73 ) ;
V_83 -> V_162 += V_159 ;
if ( V_159 != V_73 )
return;
...
T_1 V_59 ;
char * V_160 ;
V_59 = V_83 -> V_162 - sizeof( V_83 -> V_171 ) ;
V_73 = sizeof( V_83 -> V_174 ) - V_59 ;
F_2 ( L_29 , V_73 ) ;
V_160 = ( ( char * ) & V_83 -> V_174 ) + V_59 ;
V_159 = V_144 ( V_143 , V_160 , V_73 ) ;
V_83 -> V_162 += V_159 ;
if ( V_159 != V_73 )
return;
V_83 -> V_164 &= ~ V_172 ;
switch ( F_12 ( V_83 -> V_174 ) ) {
case V_175 :
V_83 -> V_164 |= V_176 ;
V_83 -> V_164 |= V_168 ;
V_83 -> V_164 |= V_173 ;
...
V_178 = & V_89 -> V_152 ;
if ( V_83 -> V_164 & V_176 ) {
memcpy ( V_178 -> V_77 [ 0 ] . V_52 + V_83 -> V_170 ,
& V_83 -> V_174 ,
sizeof( V_83 -> V_174 ) ) ;
V_83 -> V_170 += sizeof( V_83 -> V_174 ) ;
V_83 -> V_164 &= ~ V_176 ;
}
V_73 = V_143 -> V_3 ;
if ( V_73 > V_83 -> V_163 - V_83 -> V_162 ) {
struct V_142 V_180 ;
V_73 = V_83 -> V_163 - V_83 -> V_162 ;
memcpy ( & V_180 , V_143 , sizeof( V_180 ) ) ;
V_180 . V_3 = V_73 ;
V_179 = F_79 ( V_178 , V_83 -> V_170 ,
& V_180 , V_144 ) ;
V_143 -> V_3 -= V_179 ;
V_143 -> V_59 += V_179 ;
} else
...
F_2 ( L_34 ,
F_12 ( V_83 -> V_171 ) , V_179 ) ;
F_2 ( L_35
L_36 , V_11 , V_83 -> V_170 ,
V_83 -> V_162 , V_83 -> V_163 ) ;
if ( V_83 -> V_170 == V_89 -> V_152 . V_153 )
V_83 -> V_164 &= ~ V_168 ;
else if ( V_83 -> V_162 == V_83 -> V_163 ) {
if ( V_83 -> V_164 & V_165 )
V_83 -> V_164 &= ~ V_168 ;
}
}
...
F_28 ( V_11 , struct V_82 , V_11 ) ;
struct V_88 * V_89 ;
F_2 ( L_37 , F_12 ( V_83 -> V_171 ) ) ;
F_30 ( & V_11 -> V_95 ) ;
V_89 = F_82 ( V_11 , V_83 -> V_171 ) ;
if ( ! V_89 ) {
F_2 ( L_38 ,
F_12 ( V_83 -> V_171 ) ) ;
F_33 ( & V_11 -> V_95 ) ;
...
F_2 ( L_40 , F_12 ( V_89 -> V_182 ) ) ;
F_102 ( V_11 , V_143 , V_89 ) ;
if ( ! ( V_83 -> V_164 & V_168 ) )
F_107 ( V_89 , V_83 -> V_170 ) ;
F_33 ( & V_11 -> V_95 ) ;
return 0 ;
}
...
struct V_82 * V_83 =
F_28 ( V_11 , struct V_82 , V_11 ) ;
return ( V_83 -> V_164 & V_173 ) ?
F_103 ( V_11 , V_143 ) :
F_104 ( V_11 , V_143 ) ;
}
static int F_109 ( struct V_183 * V_184 , struct V_185 * V_185 )
{
int V_90 ;
V_90 = F_110 ( V_184 , L_41 , V_185 , V_186 , 0 ,
V_187 ) ;
if ( V_90 < 0 )
return V_90 ;
return 0 ;
}
static T_4 F_111 ( struct V_6 * V_11 )
{
return V_188 ;
}
static inline int F_108 ( struct V_6 * V_11 ,
...
static inline void F_113 ( struct V_82 * V_83 , struct V_142 * V_143 )
{
T_4 V_73 ;
V_73 = V_83 -> V_163 - V_83 -> V_162 ;
if ( V_73 > V_143 -> V_3 )
...
static int F_114 ( T_6 * V_189 , struct V_140 * V_141 , unsigned int V_59 , T_4 V_73 )
{
...
static void F_116 ( struct V_82 * V_83 )
{
struct V_6 * V_11 = & V_83 -> V_11 ;
struct V_7 * V_8 ;
T_6 V_189 = {
...
V_78:
F_68 ( & V_83 -> V_135 ) ;
F_120 ( V_11 , V_193 , V_192 ) ;
}
static void F_121 ( struct V_154 * V_155 )
{
struct V_82 * V_83 =
F_28 ( V_155 , struct V_82 , V_138 ) ;
F_116 ( V_83 ) ;
...
return;
F_132 () ;
V_208 = F_133 ( V_8 -> V_210 ) ;
if ( ! V_208 || F_130 ( V_211 , & V_208 -> V_61 ) == 0 )
goto V_78;
F_134 ( V_11 ) ;
V_78:
F_135 () ;
...
static void F_138 ( struct V_6 * V_11 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
struct V_7 * V_8 = V_83 -> V_86 ;
if ( V_83 -> V_212 ) {
...
static void F_139 ( struct V_6 * V_11 , T_4 V_217 , T_4 V_212 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
V_83 -> V_217 = 0 ;
if ( V_217 )
...
static void F_140 ( struct V_6 * V_11 , struct V_80 * V_81 )
{
F_91 ( V_11 , V_81 , - V_220 ) ;
}
static unsigned short F_141 ( void )
{
unsigned short V_221 = V_222 - V_223 ;
unsigned short rand = ( unsigned short ) F_142 () % V_221 ;
return rand + V_223 ;
}
static void F_143 ( struct V_39 * V_7 )
{
int V_224 = 1 ;
F_144 ( V_7 , V_225 , V_226 ,
( char * ) & V_224 , sizeof( V_224 ) ) ;
}
static unsigned short F_145 ( struct V_39 * V_7 )
{
struct V_227 V_4 ;
int V_153 ;
unsigned short V_228 = 0 ;
if ( F_146 ( V_7 , (struct V_10 * ) & V_4 , & V_153 ) < 0 )
goto V_78;
switch ( V_4 . V_229 ) {
case V_28 :
V_228 = F_147 ( ( (struct V_15 * ) & V_4 ) -> V_230 ) ;
break;
case V_25 :
V_228 = F_147 ( ( (struct V_14 * ) & V_4 ) -> V_231 ) ;
}
V_78:
return V_228 ;
}
static void F_148 ( struct V_6 * V_11 , unsigned short V_228 )
{
F_2 ( L_48 , V_11 , V_228 ) ;
F_149 ( F_4 ( V_11 ) , V_228 ) ;
F_17 ( V_11 ) ;
}
static void F_150 ( struct V_82 * V_83 , struct V_39 * V_7 )
{
if ( V_83 -> V_232 == 0 )
V_83 -> V_232 = F_145 ( V_7 ) ;
}
static unsigned short F_151 ( struct V_82 * V_83 )
{
...
static unsigned short F_152 ( struct V_82 * V_83 , unsigned short V_228 )
{
if ( V_83 -> V_232 != 0 )
V_83 -> V_232 = 0 ;
if ( ! V_83 -> V_11 . V_233 )
...
static int F_153 ( struct V_82 * V_83 , struct V_39 * V_7 )
{
struct V_227 V_234 ;
int V_64 , V_235 = 0 ;
unsigned short V_228 = F_151 ( V_83 ) ;
unsigned short V_236 ;
if ( V_228 == 0 )
return 0 ;
memcpy ( & V_234 , & V_83 -> V_237 , V_83 -> V_11 . V_40 ) ;
do {
F_149 ( (struct V_10 * ) & V_234 , V_228 ) ;
V_64 = F_154 ( V_7 , (struct V_10 * ) & V_234 ,
V_83 -> V_11 . V_40 ) ;
if ( V_64 == 0 ) {
V_83 -> V_232 = V_228 ;
break;
...
static void F_155 ( struct V_80 * V_81 )
{
F_156 ( V_81 -> V_238 ) ;
}
static void F_157 ( struct V_6 * V_11 , unsigned short V_228 )
{
}
...
static inline void F_162 ( int V_241 , struct V_39 * V_7 )
{
if ( F_163 ( ! F_164 ( V_7 -> V_8 ) ) )
return;
switch ( V_241 ) {
case V_20 :
F_158 ( V_7 ) ;
...
static void F_165 ( struct V_154 * V_155 )
{
}
...
struct V_39 * V_7 ;
int V_64 ;
V_64 = F_167 ( V_11 -> V_243 , V_241 , type , V_33 , & V_7 , 1 ) ;
if ( V_64 < 0 ) {
F_2 ( L_59 ,
V_33 , - V_64 ) ;
goto V_78;
...
return F_171 ( V_7 , F_4 ( V_11 ) , V_11 -> V_40 , 0 ) ;
}
static int F_172 ( struct V_82 * V_83 )
{
struct V_6 * V_11 = & V_83 -> V_11 ;
struct V_39 * V_7 ;
int V_102 = - V_251 ;
V_102 = F_167 ( V_11 -> V_243 , V_20 ,
V_252 , 0 , & V_7 , 1 ) ;
if ( V_102 < 0 ) {
F_2 ( L_60
L_61 , - V_102 ) ;
...
F_2 ( L_62 ,
V_11 , V_11 -> V_22 [ V_23 ] ) ;
V_102 = F_169 ( V_11 , V_7 ) ;
F_173 ( V_11 , V_7 , V_102 ) ;
switch ( V_102 ) {
case 0 :
F_2 ( L_63 ,
V_11 , V_11 -> V_22 [ V_23 ] ) ;
...
static void F_180 ( struct V_6 * V_11 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 ,
V_11 ) ;
if ( ! V_83 -> V_86 )
...
static int
F_182 ( struct V_6 * V_11 )
{
struct V_82 * V_255 = F_28 ( V_11 , struct V_82 , V_11 ) ;
if ( F_183 ( & V_11 -> V_133 ) != 1 )
return 0 ;
if ( F_184 ( & V_11 -> V_119 , V_256 , V_257 ) )
return - V_258 ;
if ( V_255 -> V_86 )
F_181 ( V_255 -> V_86 ) ;
F_46 ( V_11 , NULL ) ;
...
static void F_187 ( struct V_6 * V_11 , struct V_39 * V_7 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
if ( ! V_83 -> V_86 ) {
struct V_7 * V_8 = V_7 -> V_8 ;
...
static void F_188 ( struct V_154 * V_155 )
{
struct V_82 * V_83 =
...
static void F_191 ( struct V_6 * V_11 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
struct V_39 * V_7 = V_83 -> V_7 ;
if ( V_7 == NULL )
...
static int F_193 ( struct V_6 * V_11 , struct V_39 * V_7 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
int V_90 = - V_96 ;
if ( ! V_83 -> V_86 ) {
...
unsigned int V_269 ;
F_144 ( V_7 , V_225 , V_270 ,
( char * ) & V_268 , sizeof( V_268 ) ) ;
F_144 ( V_7 , V_271 , V_272 ,
( char * ) & V_262 , sizeof( V_262 ) ) ;
F_144 ( V_7 , V_271 , V_273 ,
( char * ) & V_262 , sizeof( V_262 ) ) ;
F_144 ( V_7 , V_271 , V_274 ,
( char * ) & V_266 , sizeof( V_266 ) ) ;
V_269 = F_194 ( V_11 -> V_263 -> V_264 ) *
( V_11 -> V_263 -> V_267 + 1 ) ;
F_144 ( V_7 , V_271 , V_275 ,
...
V_90 = F_171 ( V_7 , F_4 ( V_11 ) , V_11 -> V_40 , V_279 ) ;
switch ( V_90 ) {
case 0 :
F_150 ( V_83 , V_7 ) ;
case - V_280 :
...
static void F_197 ( struct V_154 * V_155 )
{
struct V_82 * V_83 =
F_28 ( V_155 , struct V_82 , V_137 . V_155 ) ;
struct V_39 * V_7 = V_83 -> V_7 ;
...
static void F_199 ( struct V_6 * V_11 , struct V_80 * V_81 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
F_163 ( ! F_200 ( V_11 , V_81 , V_83 ) ) ;
if ( V_83 -> V_7 != NULL ) {
F_2 ( L_71
L_72 ,
...
static void F_204 ( struct V_6 * V_11 , struct V_285 * V_286 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
F_203 ( V_286 , L_76
L_77 ,
...
static void F_205 ( struct V_6 * V_11 , struct V_285 * V_286 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
long V_287 = 0 ;
if ( F_31 ( V_11 ) )
...
static void * F_206 ( struct V_80 * V_81 , T_4 V_60 )
{
struct V_58 * V_58 ;
struct V_299 * V_4 ;
F_163 ( V_60 > V_188 - sizeof( struct V_299 ) ) ;
if ( V_60 > V_188 - sizeof( struct V_299 ) )
return NULL ;
V_58 = F_207 ( V_24 ) ;
if ( ! V_58 )
return NULL ;
...
static void F_209 ( void * V_300 )
{
struct V_299 * V_4 ;
if ( ! V_300 )
return;
V_4 = F_28 ( V_300 , struct V_299 , V_191 ) ;
F_210 ( ( unsigned long ) V_4 ) ;
}
static int F_211 ( struct V_88 * V_89 )
{
int V_73 ;
...
V_73 = F_212 ( V_7 , V_301 ,
F_213 ( V_301 -> V_77 [ 0 ] . V_52 ) , V_302 ,
...
static int F_214 ( struct V_80 * V_81 )
{
struct V_88 * V_89 = V_81 -> V_84 ;
struct V_305 * V_11 ;
int V_73 ;
F_2 ( L_80 , F_12 ( V_89 -> V_182 ) ) ;
V_11 = V_89 -> V_85 -> V_306 ;
if ( ! F_215 ( & V_11 -> V_307 ) ) {
F_216 ( & V_11 -> V_308 , V_81 , NULL ) ;
if ( ! F_215 ( & V_11 -> V_307 ) )
return - V_91 ;
F_217 ( & V_11 -> V_308 , V_81 ) ;
}
if ( F_218 ( V_309 , & V_11 -> V_310 ) )
V_73 = - V_96 ;
else
V_73 = F_211 ( V_89 ) ;
F_68 ( & V_11 -> V_307 ) ;
...
static void F_219 ( struct V_6 * V_11 )
{
}
static void F_220 ( struct V_6 * V_11 )
{
F_2 ( L_81 , V_11 ) ;
F_72 ( V_11 ) ;
F_77 ( V_139 ) ;
}
static int F_221 ( const int V_241 , struct V_10 * V_16 )
{
static const struct V_14 sin = {
. V_311 = V_25 ,
. V_26 . V_27 = F_222 ( V_312 ) ,
} ;
...
static struct V_6 * F_223 ( struct V_316 * args ,
unsigned int V_317 ,
unsigned int V_318 )
{
struct V_6 * V_11 ;
...
V_11 = F_224 ( args -> V_185 , sizeof( * V_319 ) , V_317 ,
V_318 ) ;
if ( V_11 == NULL ) {
F_2 ( L_84
L_85 ) ;
...
static struct V_6 * F_226 ( struct V_316 * args )
{
struct V_13 * V_18 = (struct V_13 * ) args -> V_322 ;
struct V_82 * V_83 ;
struct V_6 * V_11 ;
struct V_6 * V_90 ;
V_11 = F_223 ( args , V_323 ,
V_324 ) ;
if ( F_189 ( V_11 ) )
return V_11 ;
V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
...
V_11 -> V_70 = & V_341 ;
V_11 -> V_263 = & V_342 ;
F_227 ( & V_83 -> V_138 , F_93 ) ;
F_228 ( & V_83 -> V_137 , F_188 ) ;
switch ( V_12 -> V_19 ) {
case V_25 :
if ( ( (struct V_14 * ) V_12 ) -> V_231 != F_231 ( 0 ) )
F_156 ( V_11 ) ;
F_16 ( V_11 , L_89 , V_343 ) ;
break;
case V_28 :
if ( ( (struct V_15 * ) V_12 ) -> V_230 != F_231 ( 0 ) )
F_156 ( V_11 ) ;
...
static struct V_6 * F_232 ( struct V_316 * args )
{
struct V_10 * V_12 = args -> V_322 ;
struct V_6 * V_11 ;
struct V_82 * V_83 ;
...
V_11 -> V_70 = & V_347 ;
V_11 -> V_263 = & V_348 ;
F_227 ( & V_83 -> V_138 , F_121 ) ;
F_228 ( & V_83 -> V_137 , F_197 ) ;
switch ( V_12 -> V_19 ) {
case V_25 :
if ( ( (struct V_14 * ) V_12 ) -> V_231 != F_231 ( 0 ) )
F_156 ( V_11 ) ;
...
static struct V_6 * F_233 ( struct V_316 * args )
{
struct V_10 * V_12 = args -> V_322 ;
struct V_6 * V_11 ;
struct V_82 * V_83 ;
...
static int F_243 ( const char * V_366 ,
...
if ( ! V_366 )
return - V_259 ;
V_90 = F_244 ( V_366 , 0 , & V_371 ) ;
if ( V_90 == - V_259 || V_371 < V_369 || V_371 > V_370 )
return - V_259 ;
* ( ( unsigned int * ) V_368 -> V_190 ) = V_371 ;
return 0 ;
}
static int F_245 ( const char * V_366 , const struct V_367 * V_368 )
{
return F_243 ( V_366 , V_368 ,
V_372 ,
V_373 ) ;
}
static int F_246 ( const char * V_366 ,
const struct V_367 * V_368 )
{
return F_243 ( V_366 , V_368 ,
V_374 ,
...
static int F_247 ( const char * V_366 ,
const struct V_367 * V_368 )
{
return F_243 ( V_366 , V_368 ,
V_374 ,
