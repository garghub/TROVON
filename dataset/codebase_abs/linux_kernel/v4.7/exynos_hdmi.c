...
static struct V_2 * F_38 ( struct V_5 * V_7 )
{
struct V_1 * V_8 = F_3 ( V_7 ) ;
return & V_8 -> V_4 ;
}
...
static void F_50 ( struct V_1 * V_8 , T_1 V_107 )
{
T_1 V_108 , V_109 ;
...
F_7 ( V_8 , V_133 , V_16 ) ;
F_7 ( V_8 , V_134 , F_52 ( 5 )
| F_53 ( 6 ) ) ;
F_7 ( V_8 , V_135 , F_54 ( 1 )
| F_55 ( 4 ) ) ;
F_7 ( V_8 , V_136 , F_56 ( 1 )
| F_55 ( 2 ) ) ;
F_7 ( V_8 , V_137 , F_57 ( 0 ) ) ;
F_7 ( V_8 , V_138 , V_139
| V_140 ) ;
F_7 ( V_8 , V_141 , V_142
| F_58 ( V_117 )
...
static void F_62 ( struct V_1 * V_8 , bool V_161 )
{
if ( V_8 -> V_41 )
return;
...
static void F_63 ( struct V_1 * V_8 , bool V_35 )
{
...
static void F_72 ( struct V_1 * V_8 , bool V_266 )
{
...
static void F_77 ( struct V_1 * V_8 , bool V_273 )
{
if ( ! V_8 -> V_274 )
return;
F_78 ( V_8 -> V_274 , V_275 ,
V_276 , V_273 ? ~ 0 : 0 ) ;
}
...
return;
F_80 ( V_8 -> V_29 ) ;
if ( F_81 ( F_82 ( V_278 ) , V_8 -> V_279 ) )
F_23 ( L_21 ) ;
F_78 ( V_8 -> V_280 , V_281 ,
V_282 , 1 ) ;
F_77 ( V_8 , true ) ;
...
static void F_89 ( struct V_292 * V_293 )
{
struct V_1 * V_8 ;
...
static T_3 F_91 ( int V_294 , void * V_295 )
{
struct V_1 * V_8 = V_295 ;
F_92 ( V_296 , & V_8 -> V_291 ,
F_93 ( V_297 ) ) ;
return V_298 ;
}
...
struct V_34 * V_34 = F_95 ( V_29 , V_300 -> V_30 [ V_25 ] ) ;
if ( F_96 ( V_34 ) ) {
int V_24 = F_97 ( V_34 ) ;
F_15 ( V_29 , L_22 ,
...
if ( ! V_28 )
return 0 ;
V_301 = F_99 ( V_29 , sizeof( * V_301 ) * V_28 , V_303 ) ;
if ( ! V_301 )
return - V_304 ;
V_8 -> V_27 = V_301 ;
V_8 -> V_33 = V_301 + V_12 -> V_27 . V_28 ;
V_24 = F_94 ( V_8 , & V_12 -> V_27 , V_8 -> V_27 ) ;
if ( V_24 )
return V_24 ;
return F_94 ( V_8 , & V_12 -> V_33 , V_8 -> V_33 ) ;
}
static void F_100 ( struct V_305 * V_34 , bool V_266 )
{
...
int V_25 , V_24 ;
F_23 ( L_23 ) ;
V_8 -> V_75 = F_102 ( V_29 , L_24 , V_307 ) ;
if ( F_96 ( V_8 -> V_75 ) ) {
F_41 ( L_25 ) ;
return F_97 ( V_8 -> V_75 ) ;
}
V_8 -> V_294 = F_103 ( V_8 -> V_75 ) ;
if ( V_8 -> V_294 < 0 ) {
F_41 ( L_26 ) ;
return V_8 -> V_294 ;
}
...
if ( V_24 )
return V_24 ;
for ( V_25 = 0 ; V_25 < F_82 ( V_278 ) ; ++ V_25 ) {
V_8 -> V_279 [ V_25 ] . V_278 = V_278 [ V_25 ] ;
V_8 -> V_279 [ V_25 ] . V_308 = NULL ;
}
V_24 = F_104 ( V_29 , F_82 ( V_278 ) , V_8 -> V_279 ) ;
if ( V_24 ) {
if ( V_24 != - V_309 )
F_41 ( L_27 ) ;
return V_24 ;
}
V_8 -> V_310 = F_105 ( V_29 , L_28 ) ;
if ( F_97 ( V_8 -> V_310 ) == - V_80 )
return 0 ;
if ( F_96 ( V_8 -> V_310 ) )
return F_97 ( V_8 -> V_310 ) ;
V_24 = F_106 ( V_8 -> V_310 ) ;
if ( V_24 )
F_41 ( L_29 ) ;
return V_24 ;
}
static int F_107 ( struct V_32 * V_29 , struct V_32 * V_311 , void * V_30 )
{
struct V_104 * V_99 = V_30 ;
struct V_1 * V_8 = F_108 ( V_29 ) ;
...
if ( V_312 < 0 )
return V_312 ;
V_8 -> V_306 . V_266 = F_100 ;
F_110 ( V_99 , V_312 ) -> V_314 = & V_8 -> V_306 ;
V_4 -> V_315 = 1 << V_312 ;
F_23 ( L_30 , V_4 -> V_315 ) ;
F_111 ( V_99 , V_4 , & V_316 ,
V_317 , NULL ) ;
F_112 ( V_4 , & V_318 ) ;
V_24 = F_39 ( V_4 ) ;
if ( V_24 ) {
...
static void F_114 ( struct V_32 * V_29 , struct V_32 * V_311 , void * V_30 )
{
}
static struct V_319 * F_115 ( struct V_32 * V_29 )
{
const char * V_320 = L_32 ;
struct V_319 * V_321 ;
V_321 = F_116 ( NULL , NULL , V_320 ) ;
if ( V_321 )
return F_117 ( V_321 ) ;
return NULL ;
}
static struct V_319 * F_118 ( struct V_32 * V_29 )
{
const char * V_320 = L_33 ;
return F_116 ( NULL , NULL , V_320 ) ;
}
...
struct V_326 * V_327 ;
int V_24 ;
V_8 = F_99 ( V_29 , sizeof( struct V_1 ) , V_303 ) ;
if ( ! V_8 )
return - V_304 ;
V_8 -> V_12 = F_120 ( V_29 ) ;
F_121 ( V_323 , V_8 ) ;
...
V_327 = F_122 ( V_323 , V_328 , 0 ) ;
V_8 -> V_13 = F_123 ( V_29 , V_327 ) ;
if ( F_96 ( V_8 -> V_13 ) ) {
V_24 = F_97 ( V_8 -> V_13 ) ;
return V_24 ;
}
