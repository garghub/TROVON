...
F_20 (cur, &dm_device.ha_region_list) {
V_28 = F_21 ( V_41 , struct V_27 , V_44 ) ;
if ( V_20 < V_28 -> V_20 || V_20 >= V_28 -> V_49 )
continue;
...
V_138 . V_144 . V_144 = V_66 -> V_141 ;
switch ( V_138 . V_144 . V_144 ) {
case V_145 :
V_66 -> V_141 = V_146 ;
V_138 . V_147 = 0 ;
break;
...
static void F_58 ( void * V_150 )
{
struct V_151 * V_83 = V_150 ;
T_3 V_152 ;
T_4 V_153 ;
struct V_154 * V_155 ;
struct V_156 * V_157 ;
...
F_60 ( V_83 -> V_84 , V_163 ,
V_115 , & V_152 , & V_153 ) ;
if ( V_152 > 0 ) {
V_155 = (struct V_154 * ) V_163 ;
V_157 = & V_155 -> V_67 ;
switch ( V_157 -> type ) {
case V_164 :
F_56 ( V_66 ,
...
if ( V_66 -> V_80 == V_167 )
F_61 ( L_8 ) ;
V_159 = (struct V_158 * ) V_163 ;
V_66 -> V_80 = V_167 ;
V_8 . V_121 . V_110 = V_159 -> V_110 ;
F_62 ( & V_8 . V_121 . V_168 ) ;
break;
case V_169 :
V_66 -> V_80 = V_170 ;
F_51 ( V_66 ,
...
F_61 ( L_9 ) ;
V_66 -> V_80 = V_172 ;
V_161 = (struct V_160 * ) V_163 ;
if ( V_161 -> V_67 . V_21 == sizeof( struct V_160 ) ) {
V_66 -> V_57 = false ;
V_162 = & V_161 -> V_173 ;
V_66 -> V_69 . V_70 = * V_162 ;
V_66 -> V_69 . V_74 . V_174 = 0 ;
} else {
V_66 -> V_57 = true ;
V_162 = & V_161 -> V_173 ;
V_56 = & V_162 [ 1 ] ;
...
break;
case V_175 :
F_34 ( V_66 , (struct V_86 * ) V_155 ) ;
break;
default:
F_63 ( L_10 , V_157 -> type ) ;
}
}
}
static int F_64 ( struct V_151 * V_83 ,
...
if ( ! V_125 )
return - V_182 ;
V_29 = F_66 ( V_83 -> V_84 , V_183 , V_183 , NULL , 0 ,
F_58 , V_83 ) ;
if ( V_29 )
goto V_184;
V_8 . V_83 = V_83 ;
...
F_28 ( & V_8 . V_48 ) ;
F_67 ( & V_8 . V_9 ) ;
F_68 ( & V_8 . V_121 . V_168 , F_48 ) ;
F_68 ( & V_8 . V_69 . V_168 , F_30 ) ;
V_8 . V_57 = false ;
V_8 . V_186 =
F_69 ( F_52 , & V_8 , L_11 ) ;
if ( F_70 ( V_8 . V_186 ) ) {
...
V_180 . V_67 . type = V_192 ;
V_180 . V_67 . V_21 = sizeof( struct V_179 ) ;
V_180 . V_67 . V_82 = F_32 ( & V_82 ) ;
V_180 . V_193 . V_194 . V_195 = 1 ;
V_180 . V_193 . V_194 . V_181 = 1 ;
V_180 . V_193 . V_194 . V_196 = 7 ;
V_180 . V_197 = 0 ;
V_180 . V_198 = - 1 ;
V_29 = F_33 ( V_83 -> V_84 , & V_180 ,
sizeof( struct V_179 ) ,
( unsigned long ) NULL ,
V_85 , 0 ) ;
if ( V_29 )
...
static int F_79 ( struct V_151 * V_83 )
{
struct V_65 * V_66 = F_59 ( V_83 ) ;
struct V_40 * V_41 , * V_199 ;
struct V_27 * V_28 ;
if ( V_66 -> V_107 != 0 )
F_61 ( L_12 , V_66 -> V_107 ) ;
F_80 ( & V_66 -> V_121 . V_168 ) ;
F_80 ( & V_66 -> V_69 . V_168 ) ;
F_77 ( V_83 -> V_84 ) ;
F_76 ( V_66 -> V_186 ) ;
F_78 ( V_125 ) ;
#ifdef F_31
