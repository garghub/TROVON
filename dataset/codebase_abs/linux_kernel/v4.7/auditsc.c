...
F_135 ( V_205 ) ;
F_70 ( V_205 , L_55 ,
V_356 , V_60 , V_358 ? F_136 ( V_358 ) : L_56 ,
V_355 , V_202 , ! V_47 ) ;
F_137 ( V_358 ) ;
F_75 ( V_205 ) ;
}
...
goto V_277;
if ( F_131 ( V_60 ) )
V_202 = ( unsigned int ) F_141 ( & V_361 ) ;
V_360 -> V_202 = V_202 ;
V_360 -> V_60 = V_60 ;
V_277:
...
void F_142 ( int V_241 , T_1 V_21 , struct V_259 * V_242 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
if ( V_242 )
...
void F_143 ( T_9 V_249 , T_6 V_250 , unsigned int V_251 ,
...
void F_144 ( T_9 V_249 , const struct V_362 * V_363 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
if ( V_363 )
V_175 -> V_256 . V_257 = V_363 -> V_257 ;
else
V_175 -> V_256 . V_257 = 0 ;
V_175 -> V_256 . V_249 = V_249 ;
V_175 -> type = V_255 ;
}
void F_145 ( T_9 V_249 , struct V_259 * V_261 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
...
{
struct V_1 * V_175 = V_93 -> V_1 ;
V_175 -> V_147 . V_43 = V_365 -> V_43 ;
V_175 -> V_147 . V_49 = V_365 -> V_49 ;
V_175 -> V_147 . V_21 = V_365 -> V_21 ;
V_175 -> V_147 . V_233 = 0 ;
F_147 ( V_365 , & V_175 -> V_147 . V_145 ) ;
V_175 -> type = V_146 ;
}
void F_148 ( unsigned long V_235 , T_8 V_43 , T_10 V_49 , T_1 V_21 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
...
void F_149 ( struct V_366 * V_367 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
V_175 -> type = V_224 ;
V_175 -> V_227 . V_228 = V_367 -> V_228 ;
}
int F_150 ( int V_231 , unsigned long * args )
{
struct V_1 * V_175 = V_93 -> V_1 ;
if ( V_231 <= 0 || V_231 > V_368 || ! args )
return - V_369 ;
V_175 -> type = V_230 ;
...
void F_151 ( int V_370 , int V_371 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
V_175 -> V_288 [ 0 ] = V_370 ;
V_175 -> V_288 [ 1 ] = V_371 ;
}
int F_152 ( int V_186 , void * V_372 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
if ( ! V_175 -> V_200 ) {
void * V_31 = F_86 ( sizeof( struct V_373 ) , V_37 ) ;
if ( ! V_31 )
return - V_199 ;
V_175 -> V_200 = V_31 ;
}
V_175 -> V_290 = V_186 ;
memcpy ( V_175 -> V_200 , V_372 , V_186 ) ;
return 0 ;
}
void F_153 ( struct V_50 * V_348 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
V_175 -> V_294 = F_28 ( V_348 ) ;
V_175 -> V_295 = F_139 ( V_348 ) ;
V_175 -> V_296 = F_133 ( V_348 ) ;
V_175 -> V_297 = F_140 ( V_348 ) ;
F_38 ( V_348 , & V_175 -> V_298 ) ;
memcpy ( V_175 -> V_299 , V_348 -> V_203 , V_374 ) ;
}
int F_154 ( int V_375 , struct V_50 * V_348 )
{
struct V_292 * V_376 ;
struct V_50 * V_51 = V_93 ;
struct V_1 * V_2 = V_51 -> V_1 ;
T_2 V_43 = F_155 () , V_377 = F_133 ( V_348 ) ;
if ( V_171 && V_348 -> V_172 == V_171 ) {
if ( V_375 == V_378 || V_375 == V_379 || V_375 == V_380 || V_375 == V_381 ) {
V_382 = F_28 ( V_51 ) ;
if ( F_131 ( V_51 -> V_60 ) )
V_383 = V_51 -> V_60 ;
else
...
if ( ! V_2 -> V_294 ) {
V_2 -> V_294 = F_157 ( V_348 ) ;
V_2 -> V_295 = F_139 ( V_348 ) ;
V_2 -> V_296 = V_377 ;
V_2 -> V_297 = F_140 ( V_348 ) ;
F_38 ( V_348 , & V_2 -> V_298 ) ;
memcpy ( V_2 -> V_299 , V_348 -> V_203 , V_374 ) ;
return 0 ;
}
V_376 = ( void * ) V_2 -> V_194 ;
if ( ! V_376 || V_376 -> V_293 == V_386 ) {
V_376 = F_12 ( sizeof( * V_376 ) , V_157 ) ;
if ( ! V_376 )
return - V_199 ;
V_376 -> V_315 . type = V_206 ;
V_376 -> V_315 . V_36 = V_2 -> V_194 ;
V_2 -> V_194 = ( void * ) V_376 ;
}
F_103 ( V_376 -> V_293 >= V_386 ) ;
V_376 -> V_294 [ V_376 -> V_293 ] = F_157 ( V_348 ) ;
V_376 -> V_295 [ V_376 -> V_293 ] = F_139 ( V_348 ) ;
V_376 -> V_296 [ V_376 -> V_293 ] = V_377 ;
V_376 -> V_297 [ V_376 -> V_293 ] = F_140 ( V_348 ) ;
F_38 ( V_348 , & V_376 -> V_298 [ V_376 -> V_293 ] ) ;
memcpy ( V_376 -> V_299 [ V_376 -> V_293 ] , V_348 -> V_203 , V_374 ) ;
V_376 -> V_293 ++ ;
return 0 ;
}
int F_158 ( struct V_366 * V_367 ,
const struct V_52 * V_387 , const struct V_52 * V_388 )
{
struct V_281 * V_389 ;
struct V_1 * V_175 = V_93 -> V_1 ;
struct V_390 V_391 ;
V_389 = F_86 ( sizeof( * V_389 ) , V_37 ) ;
if ( ! V_389 )
return - V_199 ;
V_389 -> V_315 . type = V_280 ;
V_389 -> V_315 . V_36 = V_175 -> V_193 ;
V_175 -> V_193 = ( void * ) V_389 ;
F_159 ( V_367 -> V_341 -> V_342 . V_190 , & V_391 ) ;
V_389 -> V_284 . V_266 = V_391 . V_266 ;
V_389 -> V_284 . V_265 = V_391 . V_265 ;
V_389 -> V_284 . V_285 = ! ! ( V_391 . V_392 & V_393 ) ;
V_389 -> V_283 = ( V_391 . V_392 & V_394 ) >> V_395 ;
V_389 -> V_286 . V_266 = V_388 -> V_396 ;
V_389 -> V_286 . V_265 = V_388 -> V_397 ;
V_389 -> V_286 . V_267 = V_388 -> V_398 ;
V_389 -> V_287 . V_266 = V_387 -> V_396 ;
V_389 -> V_287 . V_265 = V_387 -> V_397 ;
V_389 -> V_287 . V_267 = V_387 -> V_398 ;
return 0 ;
}
void F_160 ( const struct V_52 * V_387 , const struct V_52 * V_388 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
V_175 -> V_263 . V_97 = F_28 ( V_93 ) ;
V_175 -> V_263 . V_264 . V_267 = V_387 -> V_398 ;
V_175 -> V_263 . V_264 . V_265 = V_387 -> V_398 ;
V_175 -> V_263 . V_264 . V_266 = V_387 -> V_396 ;
V_175 -> type = V_262 ;
}
void F_161 ( int V_270 , int V_271 )
{
struct V_1 * V_175 = V_93 -> V_1 ;
...
V_202 ) ;
F_135 ( V_205 ) ;
F_70 ( V_205 , L_58 , F_28 ( V_93 ) ) ;
F_74 ( V_205 , F_164 ( V_203 , V_93 ) ) ;
F_165 ( V_205 , V_93 -> V_225 ) ;
}
void F_166 ( long V_399 )
{
struct V_204 * V_205 ;
if ( ! V_307 )
return;
if ( V_399 == V_400 )
return;
V_205 = F_69 ( NULL , V_37 , V_401 ) ;
if ( F_2 ( ! V_205 ) )
return;
F_162 ( V_205 ) ;
F_70 ( V_205 , L_59 , V_399 ) ;
F_75 ( V_205 ) ;
}
void F_167 ( unsigned long V_402 , long V_399 , int V_403 )
{
struct V_204 * V_205 ;
V_205 = F_69 ( NULL , V_37 , V_404 ) ;
if ( F_2 ( ! V_205 ) )
return;
F_162 ( V_205 ) ;
F_70 ( V_205 , L_60 ,
V_399 , F_104 () , V_402 ,
F_168 () , F_169 ( V_93 ) , V_403 ) ;
F_75 ( V_205 ) ;
}
struct V_169 * F_170 ( void )
{
