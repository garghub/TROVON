...
if ( ! ( V_46 & 0x01 ) )
continue;
V_111 = F_24 ( V_81 , V_7 -> V_14 ) ;
while ( ( V_50 = F_52 ( & V_7 -> V_46 ) ) ) {
struct V_4 * V_5 ;
V_5 = F_53 ( V_50 , struct V_4 , V_50 ) ;
if ( V_111 . V_15 < F_123 ( V_5 ) )
break;
F_117 ( V_9 , V_7 , V_5 , & V_111 ) ;
}
}
}
void F_124 ( struct V_112 * V_113 )
{
struct V_17 * V_9 = F_15 ( & V_20 ) ;
...
static enum V_108 F_131 ( struct V_4 * V_5 )
{
struct V_127 * V_128 =
...
void F_133 ( struct V_127 * V_131 , struct V_129 * V_130 )
{
V_131 -> V_5 . V_36 = F_131 ;
V_131 -> V_130 = V_130 ;
}
static int T_7 F_134 ( struct V_127 * V_128 , enum V_41 V_42 )
{
F_133 ( V_128 , V_75 ) ;
do {
F_135 ( V_132 ) ;
F_136 ( & V_128 -> V_5 , V_42 ) ;
if ( F_3 ( V_128 -> V_130 ) )
F_137 () ;
F_28 ( & V_128 -> V_5 ) ;
V_42 = V_104 ;
} while ( V_128 -> V_130 && ! F_138 ( V_75 ) );
F_139 ( V_133 ) ;
return V_128 -> V_130 == NULL ;
}
static int F_140 ( struct V_4 * V_5 , struct V_134 T_8 * V_135 )
{
struct V_134 V_136 ;
T_2 V_102 ;
V_102 = F_109 ( V_5 ) ;
...
return 0 ;
V_136 = F_141 ( V_102 ) ;
if ( F_142 ( V_135 , & V_136 , sizeof( * V_135 ) ) )
return - V_137 ;
return 1 ;
}
long T_7 F_143 ( struct V_138 * V_89 )
{
struct V_127 V_128 ;
...
V_104 ) ;
F_144 ( & V_128 . V_5 , V_89 -> V_139 . V_12 ) ;
if ( F_134 ( & V_128 , V_104 ) )
goto V_140;
V_135 = V_89 -> V_139 . V_135 ;
if ( V_135 ) {
V_100 = F_140 ( & V_128 . V_5 , V_135 ) ;
if ( V_100 <= 0 )
goto V_140;
}
V_100 = - V_141 ;
...
long F_145 ( struct V_134 * V_142 , struct V_134 T_8 * V_135 ,
...
T_4 V_143 ;
V_143 = V_75 -> V_144 ;
if ( F_146 ( V_75 ) || F_147 ( V_75 ) )
V_143 = 0 ;
F_40 ( & V_128 . V_5 , V_43 , V_42 ) ;
F_101 ( & V_128 . V_5 , F_148 ( * V_142 ) , V_143 ) ;
if ( F_134 ( & V_128 , V_42 ) )
goto V_140;
if ( V_42 == V_104 ) {
V_100 = - V_145 ;
...
static void F_149 ( int V_65 )
{
struct V_17 * V_9 = & F_12 ( V_20 , V_65 ) ;
int V_146 ;
for ( V_146 = 0 ; V_146 < V_147 ; V_146 ++ ) {
V_9 -> V_26 [ V_146 ] . V_9 = V_9 ;
F_150 ( & V_9 -> V_26 [ V_146 ] . V_46 ) ;
}
V_9 -> V_65 = V_65 ;
F_66 ( V_9 ) ;
}
static void F_151 ( struct V_3 * V_148 ,
struct V_3 * V_11 )
{
struct V_4 * V_5 ;
struct V_48 * V_50 ;
...
V_11 = F_15 ( & V_20 ) ;
F_19 ( & V_11 -> V_10 ) ;
F_156 ( & V_148 -> V_10 , V_150 ) ;
for ( V_146 = 0 ; V_146 < V_147 ; V_146 ++ ) {
F_151 ( & V_148 -> V_26 [ V_146 ] ,
& V_11 -> V_26 [ V_146 ] ) ;
}
F_18 ( & V_148 -> V_10 ) ;
F_18 ( & V_11 -> V_10 ) ;
...
static int F_158 ( struct V_151 * V_152 ,
unsigned long V_153 , void * V_154 )
{
int V_149 = ( long ) V_154 ;
switch ( V_153 ) {
case V_155 :
case V_156 :
F_149 ( V_149 ) ;
...
void T_5 F_160 ( void )
{
F_158 ( & V_160 , ( unsigned long ) V_155 ,
( void * ) ( long ) F_161 () ) ;
F_162 ( & V_160 ) ;
}
int T_7
F_163 ( T_2 * V_12 , T_4 V_84 ,
...
F_43 ( & V_128 . V_5 ) ;
F_139 ( V_133 ) ;
return ! V_128 . V_130 ? 0 : - V_161 ;
}
int T_7 F_165 ( T_2 * V_12 , T_4 V_84 ,
const enum V_41 V_42 )
{
return F_163 ( V_12 , V_84 , V_42 ,
V_105 ) ;
}
int T_7 F_166 ( T_2 * V_12 ,
const enum V_41 V_42 )
{
return F_165 ( V_12 , 0 , V_42 ) ;
}
