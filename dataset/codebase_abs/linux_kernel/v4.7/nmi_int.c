...
static int F_71 ( const char * V_95 , struct V_96 * V_97 )
{
if ( ! strcmp ( V_95 , L_14 ) ) {
V_98 = V_99 ;
F_70 ( V_94 L_15 ) ;
} else if ( ! strcmp ( V_95 , L_16 ) ) {
V_98 = V_100 ;
F_70 ( V_94 L_17 ) ;
} else {
V_98 = 0 ;
...
static int T_4 F_72 ( char * * V_87 )
{
T_5 V_88 = V_89 . V_90 ;
struct V_1 * V_101 = & V_102 ;
if ( V_98 == V_100 && F_73 ( V_103 ) )
return 0 ;
switch ( V_88 ) {
case 0 ... 2 :
* V_87 = L_18 ;
...
int T_4 F_74 ( struct V_53 * V_54 )
{
T_5 V_105 = V_89 . V_106 ;
T_5 V_107 = V_89 . V_108 ;
char * V_87 = NULL ;
int V_109 = 0 ;
if ( ! F_73 ( V_110 ) )
return - V_111 ;
