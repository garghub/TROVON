...
F_89 ( & V_2 -> V_120 , & V_8 -> V_22 ) ;
F_2 ( V_8 , V_10 ) ;
F_90 ( V_39 , V_4 ) ;
return 0 ;
}
static void F_91 ( struct V_3 * V_4 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_24 ( V_4 ) ;
struct V_51 * V_52 , * V_123 ;
F_92 (addr, next, &ipvlan->addrs, anode) {
F_35 ( V_52 ) ;
F_93 ( & V_52 -> V_124 ) ;
F_13 ( V_52 , V_31 ) ;
}
...
static int F_106 ( struct V_1 * V_2 , struct V_154 * V_155 )
{
struct V_51 * V_52 ;
if ( F_107 ( V_2 -> V_8 , V_155 , true ) ) {
F_108 ( V_2 , V_156 , V_2 -> V_4 ,
L_3 ,
V_155 , V_2 -> V_4 -> V_157 ) ;
return - V_18 ;
}
V_52 = F_7 ( sizeof( struct V_51 ) , V_158 ) ;
if ( ! V_52 )
return - V_21 ;
V_52 -> V_159 = V_2 ;
memcpy ( & V_52 -> V_160 , V_155 , sizeof( struct V_154 ) ) ;
V_52 -> V_161 = V_162 ;
F_109 ( & V_52 -> V_124 , & V_2 -> V_117 ) ;
if ( F_110 ( V_2 -> V_4 ) )
F_29 ( V_2 , V_52 ) ;
return 0 ;
}
static void F_111 ( struct V_1 * V_2 , struct V_154 * V_155 )
{
struct V_51 * V_52 ;
V_52 = F_112 ( V_2 , V_155 , true ) ;
if ( ! V_52 )
return;
F_35 ( V_52 ) ;
F_93 ( & V_52 -> V_124 ) ;
...
switch ( V_141 ) {
case V_166 :
if ( F_106 ( V_2 , & V_164 -> V_52 ) )
return V_153 ;
break;
case V_167 :
F_111 ( V_2 , & V_164 -> V_52 ) ;
break;
}
return V_168 ;
}
static int F_115 ( struct V_1 * V_2 , struct V_169 * V_170 )
{
struct V_51 * V_52 ;
if ( F_107 ( V_2 -> V_8 , V_170 , false ) ) {
F_108 ( V_2 , V_156 , V_2 -> V_4 ,
L_4 ,
V_170 , V_2 -> V_4 -> V_157 ) ;
return - V_18 ;
...
return - V_21 ;
V_52 -> V_159 = V_2 ;
memcpy ( & V_52 -> V_171 , V_170 , sizeof( struct V_169 ) ) ;
V_52 -> V_161 = V_172 ;
F_109 ( & V_52 -> V_124 , & V_2 -> V_117 ) ;
if ( F_110 ( V_2 -> V_4 ) )
F_29 ( V_2 , V_52 ) ;
...
static void F_116 ( struct V_1 * V_2 , struct V_169 * V_170 )
{
struct V_51 * V_52 ;
V_52 = F_112 ( V_2 , V_170 , false ) ;
if ( ! V_52 )
return;
F_35 ( V_52 ) ;
F_93 ( & V_52 -> V_124 ) ;
...
static int F_117 ( struct V_139 * V_140 ,
unsigned long V_141 , void * V_142 )
{
