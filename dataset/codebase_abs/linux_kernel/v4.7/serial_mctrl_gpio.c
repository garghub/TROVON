...
if ( V_30 & V_40 )
F_15 ( V_28 , V_3 & V_40 ) ;
F_16 ( & V_28 -> V_33 -> V_28 . V_41 ) ;
}
F_17 ( & V_28 -> V_31 , V_21 ) ;
return V_42 ;
}
struct V_1 * F_18 ( struct V_27 * V_28 , unsigned int V_17 )
{
struct V_1 * V_2 ;
enum V_4 V_5 ;
...
V_2 -> V_25 [ V_5 ] = V_43 ;
F_21 ( V_2 -> V_25 [ V_5 ] , V_44 ) ;
V_43 = F_22 ( V_28 -> V_16 , V_2 -> V_25 [ V_5 ] ,
F_12 ,
V_45 , F_23 ( V_28 -> V_16 ) ,
V_2 ) ;
if ( V_43 ) {
...
void F_24 ( struct V_15 * V_16 , struct V_1 * V_2 )
{
enum V_4 V_5 ;
for ( V_5 = 0 ; V_5 < V_8 ; V_5 ++ ) {
if ( V_2 -> V_25 [ V_5 ] )
F_25 ( V_2 -> V_28 -> V_16 , V_2 -> V_25 [ V_5 ] , V_2 ) ;
if ( V_2 -> V_11 [ V_5 ] )
F_26 ( V_16 , V_2 -> V_11 [ V_5 ] ) ;
}
F_27 ( V_16 , V_2 ) ;
}
