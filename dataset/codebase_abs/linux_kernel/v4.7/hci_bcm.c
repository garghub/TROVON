...
static int F_79 ( struct V_71 * V_72 , void * V_28 )
{
...
{
struct V_88 * V_30 = V_20 -> V_30 ;
F_81 ( V_89 ) ;
const struct V_90 * V_91 ;
int V_92 ;
V_20 -> V_93 = F_82 ( & V_30 -> V_20 ) ;
V_92 = F_83 ( F_84 ( & V_30 -> V_20 ) ,
V_94 ) ;
if ( V_92 )
return V_92 ;
...
if ( ( ! V_20 -> V_26 && ! V_20 -> V_25 ) || ! V_20 -> V_93 ) {
F_90 ( & V_30 -> V_20 , L_25 ) ;
return - V_98 ;
}
V_92 = F_91 ( F_84 ( & V_20 -> V_30 -> V_20 ) ,
& V_89 , F_79 , V_20 ) ;
if ( V_92 < 0 )
return V_92 ;
F_92 ( & V_89 ) ;
...
static int F_95 ( struct V_88 * V_30 )
{
struct V_16 * V_20 ;
int V_92 ;
...
return V_92 ;
F_97 ( V_30 , V_20 ) ;
F_89 ( & V_30 -> V_20 , L_27 , V_20 -> V_93 ) ;
F_22 ( & V_34 ) ;
F_98 ( & V_20 -> V_21 , & V_103 ) ;
F_29 ( & V_34 ) ;
F_13 ( V_20 , false ) ;
return 0 ;
}
static int F_99 ( struct V_88 * V_30 )
{
