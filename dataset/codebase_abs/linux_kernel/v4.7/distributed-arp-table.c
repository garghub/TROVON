...
if ( V_10 ) {
if ( F_93 ( V_2 , V_10 -> V_49 , V_44 ) ) {
V_84 = true ;
goto V_53;
}
V_146 = F_94 ( V_147 , V_134 , V_61 ,
V_2 -> V_148 , V_62 , V_131 ,
V_10 -> V_49 , V_131 ) ;
if ( ! V_146 )
goto V_53;
if ( V_44 & V_144 ) {
V_146 = F_95 ( V_146 , F_81 ( V_149 ) ,
V_44 & V_150 ) ;
if ( ! V_146 )
goto V_53;
}
F_96 ( V_146 ) ;
V_146 -> V_151 = F_97 ( V_146 ,
V_2 -> V_148 ) ;
V_2 -> V_152 . V_153 ++ ;
...
V_157 = F_100 ( V_2 , V_146 ,
V_71 ,
NULL , V_44 ) ;
else
V_157 = F_101 ( V_2 , V_146 , NULL , V_44 ) ;
if ( V_157 != V_158 ) {
F_53 ( V_2 , V_159 ) ;
V_84 = true ;
}
...
F_30 ( V_2 , V_61 , V_131 , V_44 ) ;
F_30 ( V_2 , V_62 , V_132 , V_44 ) ;
V_160 = ! F_93 ( V_2 , V_132 , V_44 ) ;
V_160 |= F_93 ( V_2 , V_131 , V_44 ) ;
V_53:
if ( V_160 )
F_51 ( V_35 ) ;
return V_160 ;
