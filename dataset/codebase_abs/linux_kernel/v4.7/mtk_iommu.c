...
static int F_71 ( struct V_109 * V_137 )
{
struct V_6 * V_7 ;
struct V_48 * V_24 = & V_137 -> V_24 ;
struct V_138 * V_139 ;
struct V_140 * V_141 = NULL ;
void * V_142 ;
int V_143 , V_144 , V_21 ;
V_7 = F_72 ( V_24 , sizeof( * V_7 ) , V_87 ) ;
if ( ! V_7 )
return - V_113 ;
V_7 -> V_24 = V_24 ;
V_142 = F_72 ( V_24 , V_145 * 2 , V_87 ) ;
if ( ! V_142 )
return - V_113 ;
V_7 -> V_132 = F_73 ( F_74 ( V_142 ) , V_145 ) ;
V_7 -> V_78 = ! ! ( V_146 > ( 0xffffffffUL >> V_147 ) ) ;
V_139 = F_75 ( V_137 , V_148 , 0 ) ;
V_7 -> V_10 = F_76 ( V_24 , V_139 ) ;
if ( F_44 ( V_7 -> V_10 ) )
return F_45 ( V_7 -> V_10 ) ;
V_7 -> V_25 = F_77 ( V_137 , 0 ) ;
if ( V_7 -> V_25 < 0 )
return V_7 -> V_25 ;
V_7 -> V_115 = F_78 ( V_24 , L_14 ) ;
if ( F_44 ( V_7 -> V_115 ) )
return F_45 ( V_7 -> V_115 ) ;
V_144 = F_79 ( V_24 -> V_136 ,
L_15 , NULL ) ;
if ( V_144 < 0 )
return V_144 ;
V_7 -> V_61 . V_144 = V_144 ;
for ( V_143 = 0 ; V_143 < V_144 ; V_143 ++ ) {
struct V_149 * V_150 ;
struct V_109 * V_151 ;
V_150 = F_80 ( V_24 -> V_136 , L_15 , V_143 ) ;
if ( ! V_150 )
return - V_82 ;
if ( ! F_81 ( V_150 ) )
continue;
...
V_7 -> V_61 . V_62 [ V_143 ] . V_24 = & V_151 -> V_24 ;
F_83 ( V_24 , & V_141 , F_66 , V_150 ) ;
}
F_84 ( V_137 , V_7 ) ;
V_21 = F_59 ( V_7 ) ;
if ( V_21 )
...
if ( ! F_85 ( & V_152 ) )
F_86 ( & V_152 , & V_72 ) ;
return F_87 ( V_24 , & V_155 , V_141 ) ;
}
static int F_88 ( struct V_109 * V_137 )
{
struct V_6 * V_7 = F_89 ( V_137 ) ;
if ( F_85 ( & V_152 ) )
F_86 ( & V_152 , NULL ) ;
F_90 ( V_7 -> V_27 -> V_80 ) ;
F_65 ( V_7 -> V_115 ) ;
F_91 ( & V_137 -> V_24 , V_7 -> V_25 , V_7 ) ;
F_92 ( & V_137 -> V_24 , & V_155 ) ;
return 0 ;
}
static int T_6 F_93 ( struct V_48 * V_24 )
{
struct V_6 * V_7 = F_35 ( V_24 ) ;
struct V_156 * V_157 = & V_7 -> V_157 ;
void T_7 * V_10 = V_7 -> V_10 ;
V_157 -> V_158 = F_11 ( V_10 +
V_135 ) ;
V_157 -> V_159 = F_11 ( V_10 + V_134 ) ;
V_157 -> V_160 = F_11 ( V_10 + V_117 ) ;
V_157 -> V_161 = F_11 ( V_10 + V_45 ) ;
V_157 -> V_162 = F_11 ( V_10 + V_131 ) ;
return 0 ;
}
...
F_4 ( V_157 -> V_158 ,
V_10 + V_135 ) ;
F_4 ( V_157 -> V_159 , V_10 + V_134 ) ;
F_4 ( V_157 -> V_160 , V_10 + V_117 ) ;
F_4 ( V_157 -> V_161 , V_10 + V_45 ) ;
F_4 ( V_157 -> V_162 , V_10 + V_131 ) ;
F_4 ( F_62 ( V_7 -> V_132 , V_7 -> V_78 ) ,
V_10 + V_133 ) ;
return 0 ;
}
static int F_95 ( struct V_149 * V_112 )
{
int V_21 ;
struct V_109 * V_137 ;
V_137 = F_82 ( V_112 , NULL , V_152 . V_153 ) ;
if ( ! V_137 )
return - V_113 ;
V_21 = F_96 ( & V_163 ) ;
if ( V_21 ) {
