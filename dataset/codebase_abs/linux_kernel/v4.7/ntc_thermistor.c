...
if ( ! V_33 )
return - V_19 ;
V_63 = V_60 ? V_60 -> V_33 : F_35 ( V_12 ) ;
V_33 -> V_16 = & V_12 -> V_16 ;
V_33 -> V_2 = V_2 ;
F_36 ( V_33 -> V_56 , V_63 -> V_56 , sizeof( V_33 -> V_56 ) ) ;
switch ( V_63 -> V_64 ) {
case V_65 :
V_33 -> V_45 = V_66 ;
V_33 -> V_46 = F_37 ( V_66 ) ;
...
F_38 ( V_12 , V_33 ) ;
V_8 = F_39 ( & V_33 -> V_16 -> V_75 , & V_76 ) ;
if ( V_8 ) {
F_33 ( V_33 -> V_16 , L_14 ) ;
return V_8 ;
}
V_33 -> V_77 = F_40 ( V_33 -> V_16 ) ;
if ( F_9 ( V_33 -> V_77 ) ) {
F_33 ( V_33 -> V_16 , L_15 ) ;
V_8 = F_31 ( V_33 -> V_77 ) ;
goto V_78;
...
F_41 ( & V_12 -> V_16 , L_16 ,
V_63 -> V_56 ) ;
V_58 = F_42 ( V_33 -> V_16 , 0 , V_33 -> V_16 ,
& V_79 ) ;
if ( F_9 ( V_58 ) )
F_43 ( & V_12 -> V_16 , L_17 ) ;
return 0 ;
V_78:
F_44 ( & V_33 -> V_16 -> V_75 , & V_76 ) ;
F_14 ( V_2 ) ;
return V_8 ;
}
