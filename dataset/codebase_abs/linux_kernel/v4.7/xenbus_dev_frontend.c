...
F_25 (trans, &u->transactions, list)
if ( V_58 -> V_60 . V_61 == V_7 -> V_7 . V_24 . V_62 )
break;
if ( & V_58 -> V_21 == & V_7 -> V_63 )
return - V_64 ;
}
V_56 = F_26 ( & V_7 -> V_7 . V_24 ) ;
if ( F_27 ( V_56 ) ) {
if ( V_54 == V_59 )
F_10 ( V_58 ) ;
V_55 = F_28 ( V_56 ) ;
...
if ( V_54 == V_59 ) {
if ( V_7 -> V_7 . V_24 . type == V_65 )
F_10 ( V_58 ) ;
else {
V_58 -> V_60 . V_61 = F_29 ( V_56 , NULL , 0 ) ;
F_30 ( & V_58 -> V_21 , & V_7 -> V_63 ) ;
}
} else if ( V_7 -> V_7 . V_24 . type == V_66 ) {
F_9 ( & V_58 -> V_21 ) ;
F_10 ( V_58 ) ;
}
F_2 ( & V_7 -> V_13 ) ;
...
static int F_31 ( unsigned V_54 , struct V_6 * V_7 )
{
struct V_34 * V_35 , * V_67 ;
char * V_38 , * V_37 ;
int V_68 , V_55 ;
F_20 ( V_50 ) ;
V_38 = V_7 -> V_7 . V_69 + sizeof( V_7 -> V_7 . V_24 ) ;
...
F_30 ( & V_35 -> V_21 , & V_7 -> V_73 ) ;
} else {
F_33 (watch, tmp_watch, &u->watches, list) {
...
if ( V_4 == 0 )
goto V_26;
if ( V_4 > sizeof( V_7 -> V_7 . V_69 ) - V_7 -> V_4 ) {
V_7 -> V_4 = 0 ;
V_55 = - V_31 ;
goto V_26;
}
V_12 = F_36 ( V_7 -> V_7 . V_69 + V_7 -> V_4 , V_3 , V_4 ) ;
if ( V_12 != 0 ) {
V_55 = - V_25 ;
goto V_26;
}
...
goto V_26;
if ( ( sizeof( V_7 -> V_7 . V_24 ) + V_7 -> V_7 . V_24 . V_4 ) > sizeof( V_7 -> V_7 . V_69 ) ) {
V_55 = - V_77 ;
V_7 -> V_4 = 0 ;
goto V_26;
}
...
static int F_37 ( struct V_79 * V_79 , struct V_1 * V_2 )
{
struct V_6 * V_7 ;
if ( V_80 == 0 )
return - V_81 ;
...
static int F_42 ( struct V_79 * V_79 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
struct V_57 * V_58 , * V_82 ;
struct V_34 * V_35 , * V_67 ;
struct V_9 * V_10 , * V_83 ;
F_33 (trans, tmp, &u->transactions, list) {
F_43 ( V_58 -> V_60 , 1 ) ;
F_9 ( & V_58 -> V_21 ) ;
F_10 ( V_58 ) ;
}
...
F_33 (rb, tmp_rb, &u->read_buffers, list) {
F_9 ( & V_10 -> V_21 ) ;
F_10 ( V_10 ) ;
}
F_10 ( V_7 ) ;
...
static unsigned int F_44 ( struct V_1 * V_1 , T_6 * V_84 )
{
struct V_6 * V_7 = V_1 -> V_8 ;
F_45 ( V_1 , & V_7 -> V_19 , V_84 ) ;
if ( ! F_3 ( & V_7 -> V_15 ) )
return V_85 | V_86 ;
return 0 ;
}
