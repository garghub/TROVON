...
static void F_16 ( struct V_51 * V_51 )
{
char * V_60 = V_51 -> V_61 ;
int V_62 ;
int V_31 ;
V_62 = 0 ;
for ( V_31 = 0 ; V_60 [ V_31 ] ; V_31 ++ ) {
if ( ! isspace ( V_60 [ V_31 ] ) )
V_60 [ V_62 ++ ] = V_60 [ V_31 ] ;
}
V_60 [ V_62 ] = '\0' ;
}
int F_17 ( struct V_51 * V_51 )
{
struct V_1 * V_18 = (struct V_1 * ) V_51 -> V_18 ;
struct V_54 * V_55 = F_15 ( & V_51 -> V_56 ) ;
struct V_2 * V_3 = V_55 -> V_3 ;
F_11 ( V_3 , L_10 ,
V_18 -> V_63 . V_64 , V_18 -> V_63 . V_65 ,
V_18 -> V_63 . V_66 ) ;
snprintf ( V_51 -> V_61 , sizeof( V_51 -> V_61 ) , L_11 ,
V_51 -> V_67 , V_18 -> V_63 . V_64 , V_18 -> V_63 . V_65 ,
V_18 -> V_63 . V_66 , L_12 ) ;
F_16 ( V_51 ) ;
return 0 ;
}
