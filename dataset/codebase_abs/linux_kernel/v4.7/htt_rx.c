...
if ( F_4 ( ! V_165 ) )
return NULL ;
if ( F_75 ( F_76 ( V_165 -> V_174 , & V_167 ) ) )
return NULL ;
return V_167 . V_175 ;
}
static struct V_161 *
...
V_121 -> V_148 |= V_187 ;
F_83 ( V_3 , V_121 , V_88 ) ;
F_82 ( V_3 , V_121 , V_88 , V_173 ) ;
F_69 ( V_3 , V_121 , V_88 ) ;
}
if ( V_194 )
F_84 ( V_3 , V_121 , V_88 ) ;
}
static char * F_87 ( struct V_197 * V_198 , char * V_199 , T_3 V_19 )
{
T_4 * V_200 ;
int V_201 ;
if ( ! F_88 ( V_198 -> V_202 ) )
...
V_9 -> V_16 ,
F_92 ( V_198 ) ,
F_87 ( V_198 , V_201 , sizeof( V_201 ) ) ,
F_93 ( F_94 ( V_198 ) ) ?
L_15 : L_16 ,
( F_56 ( V_198 -> V_207 ) & V_208 ) >> 4 ,
V_121 -> V_148 == 0 ? L_17 : L_11 ,
...
F_105 ( ( (struct V_197 * ) V_225 ) -> V_202 ) ) {
V_198 = (struct V_197 * ) ( V_56 -> V_36 + 2 ) ;
F_48 ( V_56 , 2 ) ;
} else {
V_198 = (struct V_197 * ) ( V_56 -> V_36 ) ;
}
V_218 = F_98 ( V_3 , V_198 ) ;
F_106 ( V_226 , F_94 ( V_198 ) ) ;
F_106 ( V_228 , F_92 ( V_198 ) ) ;
F_18 ( V_56 , V_218 ) ;
V_198 = (struct V_197 * ) V_225 ;
V_218 = F_99 ( V_198 -> V_202 ) ;
memcpy ( F_107 ( V_56 , V_218 ) , V_198 , V_218 ) ;
V_198 = (struct V_197 * ) V_56 -> V_36 ;
F_106 ( F_94 ( V_198 ) , V_226 ) ;
F_106 ( F_92 ( V_198 ) , V_228 ) ;
}
...
T_4 V_226 [ V_227 ] ;
T_4 V_228 [ V_227 ] ;
V_232 = F_108 ( V_3 , V_56 , V_216 ) ;
if ( F_4 ( ! V_232 ) )
return;
V_237 = (struct V_236 * ) V_56 -> V_36 ;
F_106 ( V_226 , V_237 -> V_238 ) ;
F_106 ( V_228 , V_237 -> V_239 ) ;
F_18 ( V_56 , sizeof( struct V_236 ) ) ;
memcpy ( F_107 ( V_56 , sizeof( struct V_240 ) ) , V_232 ,
sizeof( struct V_240 ) ) ;
V_198 = (struct V_197 * ) V_225 ;
V_218 = F_99 ( V_198 -> V_202 ) ;
memcpy ( F_107 ( V_56 , V_218 ) , V_198 , V_218 ) ;
...
switch ( V_242 ) {
case V_244 :
F_102 ( V_3 , V_56 , V_121 , V_216 ,
V_217 ) ;
break;
case V_245 :
F_104 ( V_3 , V_56 , V_121 , V_225 ) ;
break;
case V_246 :
F_109 ( V_3 , V_56 , V_121 , V_225 , V_216 ) ;
break;
case V_247 :
F_110 ( V_3 , V_56 , V_121 , V_225 ) ;
break;
}
}
...
F_117 (amsdu, msdu) {
F_113 ( V_56 ) ;
F_111 ( V_3 , V_56 , V_121 , V_225 , V_216 ,
V_217 ) ;
if ( ! V_217 )
continue;
if ( V_269 )
...
static int F_121 ( struct V_60 * V_61 )
{
...
if ( ( V_279 > 0 ) &&
( F_122 ( V_192 , 0 , V_279 , V_281 ) < 0 ) ) {
F_123 ( V_61 , V_192 ) ;
return - 1 ;
}
while ( ( V_9 = F_120 ( V_61 ) ) ) {
F_124 ( V_9 , F_48 ( V_192 , V_9 -> V_16 ) ,
V_9 -> V_16 ) ;
F_10 ( V_9 ) ;
}
F_123 ( V_61 , V_192 ) ;
...
F_85 ( V_3 , & V_61 , & V_205 , 0xffff ) ;
F_125 ( V_3 , & V_61 , V_26 > 0 ) ;
F_128 ( V_3 , & V_61 , & V_205 ) ;
F_114 ( V_3 , & V_61 , & V_205 ) ;
F_119 ( V_3 , & V_61 , & V_205 ) ;
return 0 ;
}
...
static void F_140 ( struct V_2 * V_3 , struct V_293 * V_294 )
{
...
F_141 ( V_165 -> V_174 , V_163 -> V_316 , V_201 ) ;
F_33 ( & V_3 -> V_169 ) ;
}
static void F_142 ( struct V_2 * V_3 , struct V_293 * V_294 )
{
...
L_36 ,
V_163 -> V_316 , V_201 ) ;
F_143 ( V_165 -> V_174 , V_163 -> V_316 , V_201 ) ;
F_33 ( & V_3 -> V_169 ) ;
}
static int F_144 ( struct V_60 * V_84 ,
struct V_60 * V_61 )
{
struct V_1 * V_56 ;
struct V_24 * V_88 ;
...
V_121 -> V_148 |= V_187 ;
F_146 ( V_121 , V_56 ) ;
F_82 ( V_3 , V_121 , NULL , V_287 -> V_173 ) ;
F_90 ( V_3 , V_121 , V_56 ) ;
}
}
...
while ( ! F_53 ( & V_84 ) ) {
F_130 ( & V_61 ) ;
V_26 = F_144 ( & V_84 , & V_61 ) ;
switch ( V_26 ) {
case 0 :
F_85 ( V_3 , & V_61 , V_121 , V_173 ) ;
F_128 ( V_3 , & V_61 , V_121 ) ;
F_114 ( V_3 , & V_61 , V_121 ) ;
F_119 ( V_3 , & V_61 , V_121 ) ;
break;
case - V_320 :
default:
F_43 ( V_3 , L_41 , V_26 ) ;
...
static inline enum V_369 F_168 ( T_1 V_370 )
{
enum V_369 V_144 ;
switch ( V_370 ) {
case V_371 :
...
void F_169 ( struct V_2 * V_3 , struct V_1 * V_9 )
{
bool V_387 ;
V_387 = F_170 ( V_3 , V_9 ) ;
if ( V_387 )
...
bool F_170 ( struct V_2 * V_3 , struct V_1 * V_9 )
{
struct V_7 * V_8 = & V_3 -> V_8 ;
struct V_293 * V_294 = (struct V_293 * ) V_9 -> V_36 ;
enum V_388 type ;
...
F_66 ( V_3 , V_285 , L_63 ,
V_294 -> V_198 . V_389 ) ;
if ( V_294 -> V_198 . V_389 >= V_3 -> V_8 . V_390 ) {
F_66 ( V_3 , V_285 , L_64 ,
V_294 -> V_198 . V_389 , V_3 -> V_8 . V_390 ) ;
return true ;
}
type = V_3 -> V_8 . V_391 [ V_294 -> V_198 . V_389 ] ;
switch ( type ) {
case V_392 : {
V_8 -> V_393 = V_294 -> V_394 . V_395 ;
V_8 -> V_396 = V_294 -> V_394 . V_397 ;
F_171 ( & V_8 -> V_398 ) ;
break;
}
case V_399 :
F_131 ( V_8 , & V_294 -> V_400 ) ;
break;
case V_401 : {
struct V_402 V_83 = {
. V_173 = V_294 -> V_403 . V_173 ,
. V_168 = F_56 ( V_294 -> V_403 . V_168 ) ,
} ;
memcpy ( V_83 . V_316 , V_294 -> V_403 . V_316 , sizeof( V_83 . V_316 ) ) ;
F_172 ( V_8 , & V_83 ) ;
break;
}
case V_404 : {
struct V_405 V_83 = {
. V_168 = F_56 ( V_294 -> V_406 . V_168 ) ,
} ;
F_173 ( V_8 , & V_83 ) ;
break;
}
case V_407 : {
struct V_295 V_296 = {} ;
int V_121 = F_15 ( V_294 -> V_408 . V_121 ) ;
V_296 . V_299 = F_15 ( V_294 -> V_408 . V_409 ) ;
switch ( V_121 ) {
case V_410 :
V_296 . V_121 = V_303 ;
break;
...
case V_414 : {
struct V_2 * V_3 = V_8 -> V_3 ;
struct V_415 * V_83 = & V_294 -> V_416 ;
F_66 ( V_3 , V_285 ,
L_65 ,
F_56 ( V_83 -> V_168 ) ,
! ! ( V_83 -> V_38 & V_417 ) ,
F_50 ( V_83 -> V_38 , V_418 ) ) ;
F_171 ( & V_3 -> V_419 ) ;
break;
}
case V_420 : {
...
case V_426 : {
struct V_427 * V_198 =
(struct V_427 * ) V_294 -> V_428 . V_429 ;
F_176 ( V_3 , V_294 -> V_428 . V_429 ,
sizeof( * V_198 ) +
F_56 ( V_198 -> V_19 ) ) ;
break;
}
...
break;
case V_433 : {
T_1 V_434 = F_15 ( V_294 -> V_435 . V_434 ) ;
T_1 V_138 = F_15 ( V_294 -> V_435 . V_138 ) ;
V_3 -> V_183 =
F_178 ( V_3 -> V_177 -> V_436 , V_138 ) ;
F_66 ( V_3 , V_285 ,
L_68 ,
V_138 , F_179 ( V_434 ) ) ;
break;
...
break;
case V_438 : {
struct V_1 * V_339 = F_180 ( V_9 , V_281 ) ;
if ( ! V_339 ) {
F_43 ( V_3 , L_69 ) ;
break;
}
F_177 ( & V_8 -> V_54 , V_339 ) ;
F_134 ( & V_8 -> V_51 ) ;
break;
}
case V_439 :
...
struct V_1 * V_9 )
{
F_176 ( V_3 , V_9 -> V_36 , V_9 -> V_16 ) ;
F_10 ( V_9 ) ;
}
static void V_103 ( unsigned long V_442 )
{
struct V_7 * V_8 = (struct V_7 * ) V_442 ;
struct V_2 * V_3 = V_8 -> V_3 ;
struct V_295 V_296 = {} ;
struct V_60 V_443 ;
struct V_60 V_444 ;
...
F_145 ( & V_8 -> V_53 , & V_443 ) ;
F_183 ( & V_8 -> V_53 . V_41 , V_38 ) ;
F_182 ( & V_8 -> V_54 . V_41 , V_38 ) ;
F_145 ( & V_8 -> V_54 , & V_444 ) ;
F_183 ( & V_8 -> V_54 . V_41 , V_38 ) ;
while ( F_184 ( & V_8 -> V_310 , & V_296 ) )
F_139 ( V_8 , & V_296 ) ;
while ( ( V_9 = F_120 ( & V_444 ) ) ) {
F_153 ( V_3 , V_9 ) ;
F_10 ( V_9 ) ;
}
F_167 ( V_3 ) ;
V_445 = F_185 ( & V_8 -> V_102 ) ;
while ( V_445 ) {
if ( F_129 ( V_8 ) )
break;
V_445 -- ;
