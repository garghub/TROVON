...
F_6 ( V_8 , V_6 -> V_10 + V_11 ) ;
if ( V_5 == 0 ) {
V_64 = F_34 ( V_3 , 1 , NULL ) ;
if ( V_64 )
goto V_83;
V_4 -> V_84 ( V_3 , 0 ) ;
V_4 -> V_85 ( V_3 , V_86 , - 1 , - 1 ) ;
V_4 -> V_85 ( V_3 , V_87 , 0x00 , - 1 ) ;
* V_73 = V_4 -> V_88 ( V_3 ) ;
* V_74 = V_4 -> V_88 ( V_3 ) ;
} else {
V_4 -> V_84 ( V_3 , V_5 ) ;
...
F_35 ( & V_60 -> V_66 , L_7 , V_5 , V_72 ) ;
return 0 ;
V_83:
F_35 ( & V_60 -> V_66 , L_8 , V_72 ) ;
V_8 &= ~ ( F_33 ( V_72 - 1 ) ) ;
F_6 ( V_8 , V_6 -> V_10 + V_11 ) ;
F_32 ( V_75 , V_93 ) ;
F_26 ( V_6 -> V_80 [ V_72 - 1 ] ,
V_6 -> V_15 [ V_72 - 1 ] ) ;
V_81:
F_36 ( V_75 ) ;
V_79:
...
struct V_7 * V_4 ;
struct V_2 * V_3 ;
struct V_94 * V_95 = F_38 ( & V_60 -> V_66 ) ;
T_5 V_5 , V_96 ;
T_3 V_73 = 0 , V_74 = 0 ;
V_6 = F_39 ( sizeof( * V_6 ) , V_97 ) ;
if ( ! V_6 )
return - V_98 ;
V_64 = F_19 ( V_60 , L_9 , & V_6 -> V_99 , & V_6 -> V_10 ) ;
if ( V_64 )
goto V_100;
V_6 -> V_27 = F_40 ( & V_60 -> V_66 , L_10 , V_101 ) ;
if ( F_41 ( V_6 -> V_27 ) ) {
V_64 = F_42 ( V_6 -> V_27 ) ;
F_21 ( & V_60 -> V_66 , L_11 ,
V_64 ) ;
...
V_4 = & V_6 -> V_4 ;
V_3 = F_29 ( V_4 ) ;
V_3 -> V_66 . V_103 = & V_60 -> V_66 ;
V_3 -> V_61 = L_12 ;
V_4 -> V_104 . V_105 = F_13 ;
V_4 -> V_104 . V_106 = F_14 ;
V_4 -> V_104 . V_107 = F_17 ;
V_4 -> V_104 . V_28 = V_108 ;
V_4 -> V_104 . V_91 = 512 ;
V_4 -> V_104 . V_109 = 9 ;
V_4 -> V_104 . V_110 = 4 ;
V_4 -> V_104 . V_111 = V_112 ;
V_4 -> V_113 = 50 ;
V_4 -> V_114 = F_7 ;
V_4 -> V_84 = F_4 ;
if ( V_6 -> V_27 )
...
unsigned char V_72 ;
V_72 = V_95 ? V_95 -> V_13 [ V_96 ] : V_96 ^ 1 ;
if ( V_72 == 0 )
break;
if ( V_72 > V_116 ) {
F_31 ( & V_60 -> V_66 ,
...
if ( V_95 && V_95 -> V_117 ) {
V_95 -> V_117 ( V_60 , V_3 , & V_95 -> V_118 ,
& V_95 -> V_119 ) ;
}
V_64 = F_44 ( V_3 ) ;
if ( V_64 ) {
...
V_64 = F_45 ( V_3 , NULL , NULL ,
V_95 ? V_95 -> V_118 : NULL ,
V_95 ? V_95 -> V_119 : 0 ) ;
if ( V_64 ) {
F_21 ( & V_60 -> V_66 , L_16 ) ;
goto V_121;
