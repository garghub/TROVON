...
for ( V_21 = 0 ; V_21 < V_45 -> V_98 ; V_21 ++ ) {
struct V_55 * V_25 = V_45 -> V_99 [ V_21 ] ;
if ( ! V_25 -> V_22 )
continue;
#ifdef F_67
F_22 ( 1 , L_20 , V_21 ) ;
if ( V_100 >= 1 ) {
int V_101 ;
for ( V_101 = 0 ; V_101 < V_45 -> V_66 ; V_101 ++ )
F_68 ( V_102 L_15 ,
V_86 [ V_45 -> V_67 [ V_101 ] . type ] ,
V_25 -> V_103 [ V_101 ] ) ;
F_68 ( V_102 L_21 ) ;
}
#endif
...
{
struct V_106 * V_48 = V_45 -> V_48 ;
const char * V_91 = V_45 -> V_48 -> V_91 ;
