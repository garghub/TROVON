...
static void F_90 ( struct V_147 * * V_303 ,
struct V_147 * V_304 ,
int * V_305 ,
int * V_306 )
{
...
static
struct V_147 * F_91 ( struct V_20 * V_21 )
{
struct V_147 * V_192 ;
struct V_147 * V_307 ;
int V_306 , V_305 ;
...
if ( V_311 ) {
F_6 ( L_97 , V_24 ) ;
V_310 -> V_126 = F_93 ( V_313 ) ;
} else {
F_6 ( L_98 , V_24 ) ;
V_310 -> V_126 = F_93 ( V_314 ) ;
}
} else {
F_6 ( L_99 , V_24 ) ;
V_310 -> V_126 = F_93 ( V_315 ) ;
}
V_17 = F_21 ( V_21 , V_9 ,
V_310 , sizeof( * V_310 ) ) ;
if ( ! V_17 )
...
static const char * F_94 ( enum V_317 V_318 )
{
switch ( V_318 ) {
case V_319 :
return L_100 ;
...
V_144 -> V_126 = F_93 ( V_126 ) ;
V_144 -> V_275 = F_93 ( V_21 -> V_275 ) ;
#ifdef F_20
F_6 ( L_108 , V_24 ,
F_94 ( V_144 -> V_126 ) ,
( V_144 -> V_275 == V_276 ) ?
...
V_329 -> V_331 = F_93 ( V_332 ) ;
V_329 -> V_333 = F_93 ( V_334 ) ;
V_329 -> V_335 = F_93 ( V_327 -> V_207 ) ;
switch ( V_21 -> V_223 ) {
case V_224 :
V_329 -> V_223 = F_93 ( V_224 ) ;
break;
case V_239 :
V_329 -> V_223 = F_93 ( V_239 ) ;
break;
}
#ifdef F_20
F_55 ( V_21 ) ;
...
F_30 ( V_21 , NULL ) ;
V_21 -> V_45 = V_339 ;
F_102 ( F_32 ( F_10 ( V_21 ) ) ) ;
if ( V_212 )
F_29 ( & V_21 -> V_44 ) ;
}
static const char * F_103 ( enum V_345 V_341 )
{
...
void F_107 ( struct V_41 * V_42 , T_1 V_31 )
{
struct V_20 * V_21 = F_26 ( F_40 ( V_42 ) ) ;
if ( V_31 & V_357 ) {
F_6 ( L_138 , V_24 ) ;
...
if ( V_31 & V_358 ) {
F_6 ( L_139 , V_24 ) ;
F_108 ( V_21 -> V_359 , & V_21 -> V_353 , 0 ) ;
}
}
static struct V_41 * F_109 ( struct V_18 * V_19 )
{
struct V_41 * V_42 ;
struct V_351 * V_352 ;
struct V_20 * V_21 ;
unsigned int V_73 ;
F_6 ( L_77 , V_24 ) ;
V_42 = F_110 ( sizeof( struct V_351 ) +
sizeof( struct V_20 ) ) ;
...
if ( ! V_21 -> V_361 )
goto V_363;
V_21 -> V_40 = F_111 ( L_143 ) ;
if ( ! V_21 -> V_40 )
goto V_364;
V_21 -> V_359 = F_111 ( L_144 ) ;
if ( ! V_21 -> V_359 )
goto V_365;
F_112 ( & V_21 -> V_300 ) ;
F_112 ( & V_21 -> V_302 ) ;
for ( V_73 = 0 ; V_73 < V_362 ; V_73 ++ )
F_113 ( & V_21 -> V_361 [ V_73 ] . V_299 ,
& V_21 -> V_300 ) ;
F_13 ( & V_21 -> V_30 ) ;
F_114 ( & V_21 -> V_353 , F_104 ) ;
F_114 ( & V_21 -> V_355 , F_105 ) ;
F_115 ( & V_21 -> V_195 ) ;
F_115 ( & V_21 -> V_44 ) ;
F_13 ( & V_21 -> V_291 ) ;
F_17 ( & V_21 -> V_291 ) ;
...
V_367:
V_43 = F_106 ( & V_21 -> V_355 , 0 ) ;
F_6 ( L_150 , V_24 , V_43 ) ;
return V_43 ;
}
static int F_121 ( struct V_41 * V_42 )
{
struct V_18 * V_19 = F_122 ( V_42 ) ;
F_6 ( L_151 , V_24 , V_42 ) ;
F_123 ( V_19 ) ;
F_63 ( V_42 ) ;
F_124 ( V_42 ) ;
...
struct V_16 * V_17 ;
if ( V_21 -> V_197 == V_198 )
F_97 ( & V_21 -> V_291 , V_340 ) ;
V_17 = F_21 ( V_21 , V_4 , NULL , 0 ) ;
F_80 ( V_17 ) ;
F_30 ( V_21 , NULL ) ;
}
static int F_127 ( struct V_41 * V_42 )
{
struct V_351 * V_352 = F_40 ( V_42 ) ;
struct V_20 * V_21 = F_26 ( V_352 ) ;
struct V_18 * V_19 = F_122 ( V_42 ) ;
...
if ( ! V_42 )
return - V_292 ;
F_133 ( V_42 , & V_19 -> V_56 -> V_380 ) ;
F_131 ( V_42 ) ;
V_43 = F_134 ( V_42 , V_19 ) ;
if ( V_43 )
goto V_381;
