...
{
struct V_1 * V_1 = V_30 -> V_21 ;
V_1 -> V_110 . V_178 . V_30 = NULL ;
}
static int F_97 ( struct V_1 * V_1 ,
struct V_179 * V_180 )
{
while ( V_180 -> V_181 != ( unsigned short ) V_182 ) {
if ( V_1 -> V_27 -> V_183 == V_180 -> V_181 &&
V_1 -> V_27 -> V_28 == V_180 -> V_184 &&
V_1 -> V_185 == V_180 -> V_185 )
return 1 ;
V_180 ++ ;
}
return 0 ;
...
if ( ( V_141 = V_189 ( V_6 , 0 , & V_193 , NULL , & V_190 ) ) < 0 )
return V_141 ;
...
V_30 . V_27 = V_1 -> V_27 ;
V_30 . V_198 = V_199 ;
if ( ( V_141 = F_99 ( V_190 , & V_30 , & V_1 -> V_110 . V_178 . V_30 ) ) < 0 )
return V_141 ;
if ( V_186 > 0 ||
( ! V_186 && F_97 ( V_1 , V_200 ) ) ) {
struct V_155 * V_201 ;
int V_10 , V_202 = 0 ;
V_1 -> V_131 = V_1 -> V_130 =
V_203 ;
F_8 ( V_1 -> V_131 , F_3 ( V_1 , V_168 ) ) ;
if ( V_1 -> V_110 . V_178 . V_30 -> V_204 & V_205 )
V_202 ++ ;
for ( V_10 = 0 ; V_10 < F_100 ( V_206 ) ; V_10 ++ ) {
V_201 = F_101 ( & V_206 [ V_10 ] , V_1 ) ;
if ( ! V_201 )
return - V_207 ;
V_201 -> V_208 . V_209 = V_202 ;
V_141 = F_102 ( V_6 , V_201 ) ;
if ( V_141 < 0 )
return V_141 ;
}
}
if ( V_1 -> V_110 . V_178 . V_30 -> V_204 & V_210 ) {
V_1 -> V_173 &= ~ ( V_174 | V_176 ) ;
V_1 -> V_173 |= V_175 ;
V_141 = F_102 ( V_6 , F_101 ( & V_211 , V_1 ) ) ;
if ( V_141 < 0 )
return V_141 ;
}
if ( V_187 > 0 ||
F_103 ( V_1 -> V_27 , V_212 ) ) {
V_141 = F_102 ( V_6 , F_101 ( & V_213 ,
V_1 ) ) ;
if ( V_141 < 0 )
return V_141 ;
}
...
{
struct V_1 * V_1 = F_84 ( V_156 ) ;
int V_214 = V_156 -> V_215 ;
F_44 ( & V_1 -> V_68 ) ;
V_162 -> V_163 . integer . V_163 [ 0 ] = V_1 -> V_76 & V_214 ? 1 : 0 ;
F_51 ( & V_1 -> V_68 ) ;
return 0 ;
}
...
unsigned int V_216 ;
int V_166 ;
V_216 = V_162 -> V_163 . integer . V_163 [ 0 ] ? V_214 : 0 ;
F_44 ( & V_1 -> V_68 ) ;
V_166 = ( V_1 -> V_76 & V_214 ) != V_216 ;
V_1 -> V_76 &= ~ V_214 ;
V_1 -> V_76 |= V_216 ;
F_8 ( V_1 -> V_76 , F_3 ( V_1 , V_39 ) ) ;
F_51 ( & V_1 -> V_68 ) ;
...
unsigned int V_217 ;
int V_141 ;
F_12 ( F_13 ( V_218 , 0x02 ) , F_3 ( V_1 , 1370_CODEC ) ) ;
F_108 ( F_3 ( V_1 , 1370_CODEC ) ) ;
F_109 ( 100 ) ;
F_12 ( F_13 ( V_218 , 0x03 ) , F_3 ( V_1 , 1370_CODEC ) ) ;
F_108 ( F_3 ( V_1 , 1370_CODEC ) ) ;
F_109 ( 100 ) ;
...
V_141 = F_102 ( V_6 , F_101 ( & V_220 [ V_217 ] , V_1 ) ) ;
if ( V_141 < 0 )
return V_141 ;
}
return 0 ;
...
F_117 ( V_224 , L_15 ) ;
F_118 ( V_224 , L_16 , F_119 ( V_1 -> V_27 ) ) ;
F_120 ( V_224 , & V_1 -> V_27 -> V_7 ) ;
V_224 -> V_228 = V_225 ;
V_1 -> V_76 |= V_229 ;
#ifdef F_45
V_1 -> V_76 &= ~ V_230 ;
V_1 -> V_76 |= F_121 ( ( V_225 - 0x200 ) / 8 ) ;
#endif
F_8 ( V_1 -> V_76 , F_3 ( V_1 , V_39 ) ) ;
F_122 ( V_1 -> V_223 ) ;
return 0 ;
...
static inline int F_112 ( struct V_1 * V_1 , long V_231 ) { return - V_226 ; }
static inline void F_123 ( struct V_1 * V_1 ) { }
static void F_125 ( struct V_232 * V_233 ,
struct V_234 * V_235 )
{
struct V_1 * V_1 = V_233 -> V_21 ;
F_126 ( V_235 , L_17 V_142 L_18 ) ;
F_126 ( V_235 , L_19 ,
V_1 -> V_76 & V_229 ? L_20 : L_21 ) ;
#ifdef F_48
F_126 ( V_235 , L_22 ,
V_1 -> V_76 & V_236 ? L_20 : L_21 ) ;
F_126 ( V_235 , L_23 ,
...
{
struct V_232 * V_233 ;
if ( ! F_129 ( V_1 -> V_6 , L_25 , & V_233 ) )
F_130 ( V_233 , V_1 , F_125 ) ;
}
...
static int F_139 ( struct V_244 * V_28 )
{
struct V_1 * V_1 = V_28 -> V_245 ;
return F_131 ( V_1 ) ;
}
...
F_8 ( V_1 -> V_76 | V_250 , F_3 ( V_1 , V_39 ) ) ;
F_2 ( F_3 ( V_1 , V_39 ) ) ;
F_109 ( 20 ) ;
F_8 ( V_1 -> V_76 , F_3 ( V_1 , V_39 ) ) ;
F_1 ( V_1 ) ;
F_8 ( V_12 , F_3 ( V_1 , 1371_SMPRATE ) ) ;
for ( V_217 = 0 ; V_217 < 0x80 ; V_217 ++ )
F_9 ( V_1 , V_217 , 0 ) ;
...
#endif
F_141 ( V_1 -> V_253 = 0x00 , F_3 ( V_1 , V_254 ) ) ;
F_141 ( 0x00 , F_3 ( V_1 , V_255 ) ) ;
F_8 ( V_1 -> V_173 , F_3 ( V_1 , V_25 ) ) ;
F_132 ( V_1 -> V_238 ) ;
}
static int F_142 ( struct V_28 * V_7 )
{
struct V_188 * V_6 = F_143 ( V_7 ) ;
struct V_1 * V_1 = V_6 -> V_21 ;
F_144 ( V_6 , V_256 ) ;
F_145 ( V_1 -> V_150 ) ;
F_145 ( V_1 -> V_154 ) ;
#ifdef F_45
F_146 ( V_1 -> V_110 . V_178 . V_30 ) ;
#else
F_12 ( F_13 ( V_218 , 0x02 ) , F_3 ( V_1 , 1370_CODEC ) ) ;
F_108 ( F_3 ( V_1 , 1370_CODEC ) ) ;
F_109 ( 100 ) ;
...
static int F_151 ( struct V_188 * V_6 ,
struct V_258 * V_27 ,
struct V_1 * * V_259 )
{
struct V_1 * V_1 ;
int V_141 ;
static struct V_260 V_193 = {
. V_261 = F_139 ,
} ;
* V_259 = NULL ;
if ( ( V_141 = F_152 ( V_27 ) ) < 0 )
return V_141 ;
V_1 = F_153 ( sizeof( * V_1 ) , V_262 ) ;
if ( V_1 == NULL ) {
F_137 ( V_27 ) ;
return - V_207 ;
}
...
V_1 -> V_231 = F_157 ( V_27 , 0 ) ;
if ( F_158 ( V_27 -> V_238 , V_263 , V_264 ,
V_265 , V_1 ) ) {
F_5 ( V_6 -> V_7 , L_27 , V_27 -> V_238 ) ;
F_131 ( V_1 ) ;
return - V_227 ;
}
V_1 -> V_238 = V_27 -> V_238 ;
#ifdef F_48
...
#endif
F_160 ( V_27 ) ;
V_1 -> V_185 = V_27 -> V_266 ;
#ifdef F_48
#if 0
ensoniq->ctrl = ES_1370_CDC_EN | ES_1370_SERR_DISABLE |
ES_1370_PCLKDIVO(ES_1370_SRTODIV(8000));
#else
V_1 -> V_76 = V_267 | F_56 ( F_57 ( 8000 ) ) ;
#endif
V_1 -> V_69 = 0 ;
#else
V_1 -> V_76 = 0 ;
...
#endif
F_140 ( V_1 ) ;
if ( ( V_141 = F_161 ( V_6 , V_270 , V_1 , & V_193 ) ) < 0 ) {
F_131 ( V_1 ) ;
return V_141 ;
}
F_128 ( V_1 ) ;
...
{
struct V_271 * V_272 = V_1 -> V_272 ;
unsigned char V_165 , V_214 , V_273 ;
if ( V_272 == NULL )
return;
F_33 ( & V_1 -> V_68 ) ;
V_214 = V_1 -> V_274 & V_275 ? V_276 : 0 ;
while ( V_214 ) {
V_165 = F_163 ( F_3 ( V_1 , V_277 ) ) ;
if ( ( V_165 & V_214 ) == 0 )
break;
V_273 = F_163 ( F_3 ( V_1 , V_278 ) ) ;
F_164 ( V_1 -> V_279 , & V_273 , 1 ) ;
}
F_34 ( & V_1 -> V_68 ) ;
F_33 ( & V_1 -> V_68 ) ;
V_214 = V_1 -> V_274 & V_280 ? V_281 : 0 ;
while ( V_214 ) {
V_165 = F_163 ( F_3 ( V_1 , V_277 ) ) ;
if ( ( V_165 & V_214 ) == 0 )
break;
if ( F_165 ( V_1 -> V_282 , & V_273 , 1 ) != 1 ) {
V_1 -> V_253 &= ~ V_283 ;
F_141 ( V_1 -> V_253 , F_3 ( V_1 , V_254 ) ) ;
V_214 &= ~ V_281 ;
} else {
F_141 ( V_273 , F_3 ( V_1 , V_278 ) ) ;
}
}
F_34 ( & V_1 -> V_68 ) ;
}
static int F_166 ( struct V_284 * V_56 )
{
struct V_1 * V_1 = V_56 -> V_272 -> V_21 ;
F_44 ( & V_1 -> V_68 ) ;
V_1 -> V_274 |= V_275 ;
V_1 -> V_279 = V_56 ;
if ( ! ( V_1 -> V_274 & V_280 ) ) {
F_141 ( F_167 ( 3 ) , F_3 ( V_1 , V_254 ) ) ;
F_141 ( V_1 -> V_253 = 0 , F_3 ( V_1 , V_254 ) ) ;
F_8 ( V_1 -> V_76 |= V_285 , F_3 ( V_1 , V_39 ) ) ;
}
F_51 ( & V_1 -> V_68 ) ;
return 0 ;
}
static int F_168 ( struct V_284 * V_56 )
{
struct V_1 * V_1 = V_56 -> V_272 -> V_21 ;
F_44 ( & V_1 -> V_68 ) ;
if ( ! ( V_1 -> V_274 & V_280 ) ) {
...
F_141 ( V_1 -> V_253 &= ~ V_286 , F_3 ( V_1 , V_254 ) ) ;
}
V_1 -> V_279 = NULL ;
V_1 -> V_274 &= ~ V_275 ;
F_51 ( & V_1 -> V_68 ) ;
...
static int F_169 ( struct V_284 * V_56 )
{
struct V_1 * V_1 = V_56 -> V_272 -> V_21 ;
F_44 ( & V_1 -> V_68 ) ;
V_1 -> V_274 |= V_280 ;
...
static int F_170 ( struct V_284 * V_56 )
{
struct V_1 * V_1 = V_56 -> V_272 -> V_21 ;
F_44 ( & V_1 -> V_68 ) ;
if ( ! ( V_1 -> V_274 & V_275 ) ) {
...
F_141 ( V_1 -> V_253 &= ~ V_283 , F_3 ( V_1 , V_254 ) ) ;
}
V_1 -> V_282 = NULL ;
V_1 -> V_274 &= ~ V_280 ;
F_51 ( & V_1 -> V_68 ) ;
...
static void F_171 ( struct V_284 * V_56 , int V_287 )
{
unsigned long V_288 ;
struct V_1 * V_1 = V_56 -> V_272 -> V_21 ;
int V_217 ;
F_172 ( & V_1 -> V_68 , V_288 ) ;
if ( V_287 ) {
if ( ( V_1 -> V_253 & V_286 ) == 0 ) {
for ( V_217 = 0 ; V_217 < 32 ; V_217 ++ )
F_163 ( F_3 ( V_1 , V_278 ) ) ;
V_1 -> V_253 |= V_286 ;
F_141 ( V_1 -> V_253 , F_3 ( V_1 , V_254 ) ) ;
}
...
F_173 ( & V_1 -> V_68 , V_288 ) ;
}
static void F_174 ( struct V_284 * V_56 , int V_287 )
{
unsigned long V_288 ;
struct V_1 * V_1 = V_56 -> V_272 -> V_21 ;
unsigned char V_273 ;
F_172 ( & V_1 -> V_68 , V_288 ) ;
if ( V_287 ) {
if ( F_175 ( V_1 -> V_253 ) == 0 ) {
V_1 -> V_253 |= F_176 ( 1 ) ;
while ( F_175 ( V_1 -> V_253 ) == 1 &&
( F_163 ( F_3 ( V_1 , V_277 ) ) & V_281 ) ) {
if ( F_165 ( V_56 , & V_273 , 1 ) != 1 ) {
V_1 -> V_253 &= ~ V_283 ;
} else {
F_141 ( V_273 , F_3 ( V_1 , V_278 ) ) ;
}
...
struct V_271 * V_272 ;
int V_141 ;
if ( ( V_141 = F_178 ( V_1 -> V_6 , L_29 , V_28 , 1 , 1 , & V_272 ) ) < 0 )
return V_141 ;
strcpy ( V_272 -> V_149 , V_142 ) ;
F_179 ( V_272 , V_289 , & V_290 ) ;
F_179 ( V_272 , V_291 , & V_292 ) ;
V_272 -> V_148 |= V_293 | V_294 |
V_295 ;
V_272 -> V_21 = V_1 ;
V_1 -> V_272 = V_272 ;
return 0 ;
}
static T_3 V_263 ( int V_238 , void * V_296 )
{
struct V_1 * V_1 = V_296 ;
...
if ( V_165 & V_302 )
F_162 ( V_1 ) ;
if ( ( V_165 & V_300 ) && V_1 -> V_64 )
F_180 ( V_1 -> V_64 ) ;
if ( ( V_165 & V_301 ) && V_1 -> V_66 )
F_180 ( V_1 -> V_66 ) ;
if ( ( V_165 & V_299 ) && V_1 -> V_62 )
F_180 ( V_1 -> V_62 ) ;
return V_303 ;
}
static int F_181 ( struct V_258 * V_27 ,
...
V_141 = F_182 ( & V_27 -> V_7 , V_209 [ V_7 ] , V_208 [ V_7 ] , V_311 ,
0 , & V_6 ) ;
if ( V_141 < 0 )
return V_141 ;
...
#endif
#ifdef F_45
if ( ( V_141 = F_98 ( V_1 , V_129 [ V_7 ] , V_312 [ V_7 ] ) ) < 0 ) {
F_183 ( V_6 ) ;
return V_141 ;
}
#endif
...
F_112 ( V_1 , V_7 ) ;
strcpy ( V_6 -> V_313 , V_314 ) ;
strcpy ( V_6 -> V_315 , L_26 ) ;
sprintf ( V_6 -> V_316 , L_30 ,
V_6 -> V_315 ,
V_6 -> V_313 ,
V_1 -> V_231 ,
V_1 -> V_238 ) ;
...
static void F_186 ( struct V_258 * V_27 )
{
F_183 ( F_187 ( V_27 ) ) ;
}
