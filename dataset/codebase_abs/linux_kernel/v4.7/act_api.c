...
V_31 = F_80 ( V_27 , V_124 ,
& V_4 -> V_67 , & V_119 , V_125 ) ;
if ( V_31 < 0 )
goto V_100;
...
static int
F_85 ( struct V_26 * V_27 , struct V_85 * V_86 , T_1 V_128 , T_1 V_129 ,
T_2 V_130 , int V_131 , int V_17 , int V_97 )
{
struct V_132 * V_133 ;
struct V_134 * V_135 ;
unsigned char * V_98 = F_63 ( V_27 ) ;
struct V_36 * V_37 ;
V_135 = F_86 ( V_27 , V_128 , V_129 , V_131 , sizeof( * V_133 ) , V_130 ) ;
if ( ! V_135 )
goto V_136;
V_133 = F_87 ( V_135 ) ;
V_133 -> V_137 = V_138 ;
V_133 -> V_139 = 0 ;
V_133 -> V_140 = 0 ;
V_37 = F_15 ( V_27 , V_141 ) ;
if ( V_37 == NULL )
goto V_136;
if ( F_65 ( V_27 , V_86 , V_17 , V_97 ) < 0 )
goto V_136;
F_18 ( V_27 , V_37 ) ;
V_135 -> V_142 = F_63 ( V_27 ) - V_98 ;
return V_27 -> V_143 ;
V_136:
F_17 ( V_27 , V_98 ) ;
return - 1 ;
...
static int
F_88 ( struct V_101 * V_101 , T_1 V_128 , struct V_134 * V_45 ,
struct V_85 * V_86 , int V_131 )
{
struct V_26 * V_27 ;
V_27 = F_89 ( V_144 , V_61 ) ;
if ( ! V_27 )
return - V_145 ;
if ( F_85 ( V_27 , V_86 , V_128 , V_45 -> V_146 , 0 , V_131 , 0 , 0 ) <= 0 ) {
F_90 ( V_27 ) ;
return - V_46 ;
}
return F_91 ( V_27 , V_101 , V_128 ) ;
}
...
V_31 = - V_46 ;
if ( V_108 [ V_147 ] == NULL ||
F_95 ( V_108 [ V_147 ] ) < sizeof( V_32 ) )
goto V_110;
V_32 = F_96 ( V_108 [ V_147 ] ) ;
V_31 = - V_62 ;
V_11 = F_92 ( 0 ) ;
if ( V_11 == NULL )
goto V_110;
...
if ( V_11 . V_23 == NULL )
goto V_110;
V_135 = F_86 ( V_27 , V_128 , V_45 -> V_146 , V_53 , sizeof( * V_133 ) , 0 ) ;
if ( ! V_135 )
goto V_149;
V_133 = F_87 ( V_135 ) ;
V_133 -> V_137 = V_138 ;
...
if ( V_37 == NULL )
goto V_149;
V_31 = V_11 . V_23 -> V_78 ( V_101 , V_27 , & V_148 , V_53 , & V_11 ) ;
if ( V_31 < 0 )
goto V_149;
if ( V_31 == 0 )
goto V_150;
...
V_135 -> V_151 |= V_152 ;
F_23 ( V_11 . V_23 -> V_49 ) ;
V_31 = F_99 ( V_27 , V_101 , V_128 , V_153 ,
V_45 -> V_151 & V_154 ) ;
if ( V_31 > 0 )
return 0 ;
return V_31 ;
...
static int
F_100 ( struct V_101 * V_101 , struct V_134 * V_45 , struct V_85 * V_86 ,
T_1 V_128 )
{
int V_19 ;
struct V_26 * V_27 ;
...
if ( ! V_27 )
return - V_145 ;
if ( F_85 ( V_27 , V_86 , V_128 , V_45 -> V_146 , 0 , V_53 ,
0 , 1 ) <= 0 ) {
F_90 ( V_27 ) ;
return - V_46 ;
}
...
V_19 = F_99 ( V_27 , V_101 , V_128 , V_153 ,
V_45 -> V_151 & V_154 ) ;
if ( V_19 > 0 )
return 0 ;
return V_19 ;
...
static int
F_101 ( struct V_101 * V_101 , struct V_36 * V_102 , struct V_134 * V_45 ,
T_1 V_128 , int V_131 )
{
int V_33 , V_19 ;
struct V_36 * V_108 [ V_43 + 1 ] ;
...
if ( V_19 < 0 )
return V_19 ;
if ( V_131 == V_53 && V_45 -> V_151 & V_152 ) {
if ( V_108 [ 1 ] != NULL )
return F_98 ( V_101 , V_108 [ 1 ] , V_45 , V_128 ) ;
else
return - V_46 ;
}
for ( V_33 = 1 ; V_33 <= V_43 && V_108 [ V_33 ] ; V_33 ++ ) {
V_74 = F_94 ( V_101 , V_108 [ V_33 ] , V_45 , V_128 ) ;
if ( F_77 ( V_74 ) ) {
V_19 = F_78 ( V_74 ) ;
goto V_31;
}
...
if ( V_131 == V_54 )
V_19 = F_88 ( V_101 , V_128 , V_45 , & V_86 , V_131 ) ;
else {
V_19 = F_100 ( V_101 , V_45 , & V_86 , V_128 ) ;
if ( V_19 )
goto V_31;
return V_19 ;
}
...
static int
F_103 ( struct V_101 * V_101 , struct V_134 * V_45 , struct V_85 * V_86 ,
T_1 V_128 )
{
struct V_26 * V_27 ;
int V_31 = 0 ;
...
if ( ! V_27 )
return - V_145 ;
if ( F_85 ( V_27 , V_86 , V_128 , V_45 -> V_146 , V_45 -> V_151 ,
V_155 , 0 , 0 ) <= 0 ) {
F_90 ( V_27 ) ;
return - V_46 ;
}
...
static int
F_104 ( struct V_101 * V_101 , struct V_36 * V_102 , struct V_134 * V_45 ,
T_1 V_128 , int V_104 )
{
int V_19 = 0 ;
F_102 ( V_86 ) ;
...
if ( V_19 )
goto V_42;
V_19 = F_103 ( V_101 , V_45 , & V_86 , V_128 ) ;
F_97 ( & V_86 ) ;
V_42:
return V_19 ;
}
static int F_105 ( struct V_26 * V_27 , struct V_134 * V_45 )
{
struct V_101 * V_101 = F_106 ( V_27 -> V_156 ) ;
struct V_36 * V_157 [ V_109 + 1 ] ;
T_1 V_128 = V_27 ? F_107 ( V_27 ) . V_128 : 0 ;
int V_19 = 0 , V_104 = 0 ;
if ( ( V_45 -> V_158 != V_54 ) && ! F_108 ( V_27 , V_159 ) )
return - V_21 ;
V_19 = F_109 ( V_45 , sizeof( struct V_132 ) , V_157 , V_109 , NULL ) ;
if ( V_19 < 0 )
return V_19 ;
if ( V_157 [ V_141 ] == NULL ) {
F_110 ( L_5 ) ;
...
V_104 = 1 ;
V_161:
V_19 = F_104 ( V_101 , V_157 [ V_141 ] , V_45 , V_128 , V_104 ) ;
if ( V_19 == - V_112 )
goto V_161;
break;
case V_53 :
V_19 = F_101 ( V_101 , V_157 [ V_141 ] , V_45 ,
V_128 , V_53 ) ;
break;
case V_54 :
V_19 = F_101 ( V_101 , V_157 [ V_141 ] , V_45 ,
...
static struct V_36 *
F_112 ( const struct V_134 * V_45 )
{
struct V_36 * V_162 , * V_163 [ V_109 + 1 ] ;
struct V_36 * V_108 [ V_43 + 1 ] ;
struct V_36 * V_102 [ V_164 + 1 ] ;
struct V_36 * V_48 ;
if ( F_109 ( V_45 , sizeof( struct V_132 ) , V_102 , V_164 , NULL ) < 0 )
return NULL ;
V_162 = V_102 [ V_141 ] ;
if ( V_162 == NULL )
return NULL ;
if ( F_113 ( V_108 , V_43 , F_114 ( V_162 ) ,
F_115 ( F_95 ( V_162 ) ) , NULL ) < 0 )
return NULL ;
if ( V_108 [ 1 ] == NULL )
return NULL ;
if ( F_113 ( V_163 , V_109 , F_114 ( V_108 [ 1 ] ) ,
F_95 ( V_108 [ 1 ] ) , NULL ) < 0 )
return NULL ;
V_48 = V_163 [ V_111 ] ;
return V_48 ;
...
struct V_10 V_11 ;
int V_19 = 0 ;
struct V_132 * V_133 = (struct V_132 * ) F_87 ( V_29 -> V_135 ) ;
struct V_36 * V_48 = F_112 ( V_29 -> V_135 ) ;
if ( V_48 == NULL ) {
F_117 ( L_6 ) ;
return 0 ;
}
...
memset ( & V_11 , 0 , sizeof( struct V_10 ) ) ;
V_11 . V_23 = V_105 ;
V_135 = F_86 ( V_27 , F_107 ( V_29 -> V_27 ) . V_128 , V_29 -> V_135 -> V_146 ,
V_29 -> V_135 -> V_158 , sizeof( * V_133 ) , 0 ) ;
if ( ! V_135 )
goto V_149;
V_133 = F_87 ( V_135 ) ;
V_133 -> V_137 = V_138 ;
...
{
F_119 ( V_166 , V_155 , F_105 , NULL , NULL ) ;
F_119 ( V_166 , V_53 , F_105 , NULL , NULL ) ;
F_119 ( V_166 , V_54 , F_105 , F_116 ,
NULL ) ;
return 0 ;
}
