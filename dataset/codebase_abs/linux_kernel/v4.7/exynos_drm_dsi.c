...
static int F_122 ( const struct V_254 * V_255 ,
const char * V_256 , T_1 * V_257 )
{
int V_213 = F_123 ( V_255 , V_256 , V_257 ) ;
if ( V_213 < 0 )
F_124 ( L_25 , V_255 -> V_258 ,
V_256 ) ;
return V_213 ;
}
...
struct V_254 * V_260 ;
int V_213 ;
V_213 = F_122 ( V_259 , L_26 ,
& V_5 -> V_42 ) ;
if ( V_213 < 0 )
return V_213 ;
V_260 = F_126 ( V_259 , V_261 , 0 ) ;
if ( ! V_260 ) {
F_10 ( V_13 , L_27 ) ;
return - V_120 ;
}
V_213 = F_122 ( V_260 , L_28 ,
& V_5 -> V_56 ) ;
if ( V_213 < 0 )
goto V_262;
V_213 = F_122 ( V_260 , L_29 ,
& V_5 -> V_58 ) ;
if ( V_213 < 0 )
goto V_262;
F_127 ( V_260 ) ;
V_260 = F_128 ( V_259 , NULL ) ;
if ( ! V_260 ) {
V_213 = - V_120 ;
goto V_262;
}
V_5 -> V_263 = F_129 ( V_260 ) ;
if ( ! V_5 -> V_263 ) {
V_213 = - V_120 ;
goto V_262;
}
...
static int F_130 ( struct V_155 * V_13 , struct V_155 * V_264 ,
void * V_265 )
{
struct V_2 * V_4 = F_131 ( V_13 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
...
return V_213 ;
V_4 -> V_271 = 1 << V_213 ;
F_133 ( L_30 , V_4 -> V_271 ) ;
F_134 ( V_267 , V_4 , & V_272 ,
V_273 , NULL ) ;
F_135 ( V_4 , & V_274 ) ;
V_213 = F_115 ( V_4 ) ;
if ( V_213 ) {
...
V_269 = F_137 ( V_5 -> V_263 ) ;
if ( V_269 ) {
V_4 -> V_269 = V_269 ;
F_138 ( V_267 , V_269 ) ;
}
return F_139 ( & V_5 -> V_275 ) ;
}
static void F_140 ( struct V_155 * V_13 , struct V_155 * V_264 ,
void * V_265 )
{
struct V_2 * V_4 = F_131 ( V_13 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
...
static int F_142 ( struct V_276 * V_277 )
{
struct V_155 * V_13 = & V_277 -> V_13 ;
struct V_278 * V_279 ;
struct V_1 * V_5 ;
int V_213 , V_280 ;
V_5 = F_143 ( V_13 , sizeof( * V_5 ) , V_281 ) ;
if ( ! V_5 )
return - V_282 ;
V_5 -> V_210 = - V_219 ;
F_67 ( & V_5 -> V_12 ) ;
...
V_213 = F_147 ( V_13 , F_21 ( V_5 -> V_285 ) ,
V_5 -> V_285 ) ;
if ( V_213 ) {
F_148 ( V_13 , L_34 , V_213 ) ;
return - V_287 ;
}
V_5 -> V_288 = F_143 ( V_13 ,
sizeof( * V_5 -> V_288 ) * V_5 -> V_10 -> V_289 ,
V_281 ) ;
if ( ! V_5 -> V_288 )
return - V_282 ;
for ( V_280 = 0 ; V_280 < V_5 -> V_10 -> V_289 ; V_280 ++ ) {
V_5 -> V_288 [ V_280 ] = F_149 ( V_13 , V_290 [ V_280 ] ) ;
if ( F_150 ( V_5 -> V_288 [ V_280 ] ) ) {
...
F_148 ( V_13 , L_36 ,
V_290 [ V_280 ] ) ;
return F_151 ( V_5 -> V_288 [ V_280 ] ) ;
}
}
V_279 = F_152 ( V_277 , V_292 , 0 ) ;
V_5 -> V_9 = F_153 ( V_13 , V_279 ) ;
if ( F_150 ( V_5 -> V_9 ) ) {
F_10 ( V_13 , L_37 ) ;
return F_151 ( V_5 -> V_9 ) ;
}
V_5 -> V_293 = F_154 ( V_13 , L_38 ) ;
if ( F_150 ( V_5 -> V_293 ) ) {
F_148 ( V_13 , L_39 ) ;
return F_151 ( V_5 -> V_293 ) ;
}
V_5 -> V_193 = F_155 ( V_277 , 0 ) ;
if ( V_5 -> V_193 < 0 ) {
F_10 ( V_13 , L_40 ) ;
return V_5 -> V_193 ;
}
F_84 ( V_5 -> V_193 , V_217 ) ;
V_213 = F_156 ( V_13 , V_5 -> V_193 , NULL ,
F_69 , V_294 ,
F_157 ( V_13 ) , V_5 ) ;
if ( V_213 ) {
F_10 ( V_13 , L_41 ) ;
...
F_158 ( V_277 , & V_5 -> V_4 ) ;
F_159 ( V_13 ) ;
return F_160 ( V_13 , & V_295 ) ;
}
static int F_161 ( struct V_276 * V_277 )
{
F_162 ( & V_277 -> V_13 ) ;
F_163 ( & V_277 -> V_13 , & V_295 ) ;
return 0 ;
}
...
F_166 ( V_5 -> V_288 [ V_280 ] ) ;
V_213 = F_167 ( F_21 ( V_5 -> V_285 ) , V_5 -> V_285 ) ;
if ( V_213 < 0 )
F_10 ( V_5 -> V_13 , L_42 , V_213 ) ;
return 0 ;
}
static int T_7 F_168 ( struct V_155 * V_13 )
{
struct V_2 * V_4 = F_131 ( V_13 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
const struct V_23 * V_10 = V_5 -> V_10 ;
int V_213 , V_280 ;
V_213 = F_169 ( F_21 ( V_5 -> V_285 ) , V_5 -> V_285 ) ;
if ( V_213 < 0 ) {
F_10 ( V_5 -> V_13 , L_43 , V_213 ) ;
return V_213 ;
}
for ( V_280 = 0 ; V_280 < V_10 -> V_289 ; V_280 ++ ) {
V_213 = F_170 ( V_5 -> V_288 [ V_280 ] ) ;
if ( V_213 < 0 )
goto V_296;
}
V_213 = F_171 ( V_5 -> V_293 ) ;
if ( V_213 < 0 ) {
...
while ( -- V_280 > - 1 )
F_166 ( V_5 -> V_288 [ V_280 ] ) ;
F_167 ( F_21 ( V_5 -> V_285 ) , V_5 -> V_285 ) ;
return V_213 ;
}
