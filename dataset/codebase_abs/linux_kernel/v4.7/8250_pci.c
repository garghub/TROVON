...
static inline int F_125 ( T_1 V_256 , T_1 V_243 )
{
return V_256 == V_257 || V_256 == V_243 ;
}
static struct V_258 * F_126 ( struct V_2 * V_3 )
{
struct V_258 * V_259 ;
for ( V_259 = V_260 ; ; V_259 ++ )
if ( F_125 ( V_259 -> V_4 , V_3 -> V_4 ) &&
F_125 ( V_259 -> V_5 , V_3 -> V_5 ) &&
F_125 ( V_259 -> V_261 , V_3 -> V_6 ) &&
F_125 ( V_259 -> V_262 , V_3 -> V_7 ) )
break;
return V_259 ;
}
...
static int
F_128 ( struct V_2 * V_3 , struct V_25 * V_26 )
{
...
struct V_8 *
F_130 ( struct V_2 * V_3 , const struct V_25 * V_26 )
{
struct V_10 V_275 ;
struct V_8 * V_9 ;
struct V_258 * V_259 ;
...
V_275 . V_11 . V_232 = F_127 ( V_3 , V_26 ) ;
...
static int
F_141 ( struct V_2 * V_3 , const struct V_264 * V_285 )
{
struct V_258 * V_259 ;
struct V_8 * V_9 ;
const struct V_25 * V_26 ;
