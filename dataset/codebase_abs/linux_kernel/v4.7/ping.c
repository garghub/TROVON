...
V_31 . V_65 = V_26 . V_66 ;
F_14 ( V_2 , F_15 ( & V_31 ) ) ;
if ( ! V_31 . V_67 && F_16 ( & V_31 . V_28 ) )
V_31 . V_67 = V_24 -> V_68 ;
else if ( ! V_31 . V_67 )
V_31 . V_67 = V_24 -> V_69 ;
V_33 = F_17 ( V_2 , & V_31 , V_28 ) ;
if ( F_18 ( V_33 ) )
return F_19 ( V_33 ) ;
...
V_31 . V_67 = V_24 -> V_69 ;
V_37 . V_71 . type = V_26 . V_64 ;
V_37 . V_71 . V_10 = V_26 . V_66 ;
V_37 . V_71 . V_72 = 0 ;
V_37 . V_71 . V_73 . V_74 . V_75 = V_22 -> V_76 ;
V_37 . V_71 . V_73 . V_74 . V_77 = V_26 . V_78 ;
V_37 . V_4 = V_4 ;
V_37 . V_79 = 0 ;
V_37 . V_80 = V_43 ;
V_41 . V_81 = F_20 ( V_24 , & V_31 , V_33 ) ;
V_41 . V_82 = V_24 -> V_82 ;
V_41 . V_83 = V_24 -> V_83 ;
V_41 . V_84 = NULL ;
F_21 ( V_2 ) ;
V_11 = F_22 ( V_2 , V_85 , & V_37 , V_5 ,
0 , & V_41 , & V_31 , V_35 ,
V_86 , & V_39 ) ;
if ( V_11 ) {
F_23 ( F_24 ( V_2 ) , V_35 -> V_87 ,
V_88 ) ;
F_25 ( V_2 ) ;
} else {
V_11 = F_26 ( V_2 , & V_31 ,
(struct V_25 * ) & V_37 . V_71 ,
V_5 ) ;
}
F_27 ( V_2 ) ;
if ( V_11 )
...
struct V_21 * V_22 = F_7 ( V_92 ) ;
T_6 V_98 = F_32 ( V_22 -> V_76 ) ;
T_6 V_99 = F_32 ( V_22 -> V_100 ) ;
