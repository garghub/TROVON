...
V_27 = F_14 ( V_25 -> V_19 , L_19 , NULL , & V_44 ) ;
if ( F_33 ( V_27 ) )
F_34 ( V_25 -> V_31 , V_44 ) ;
return 0 ;
}
...
struct V_36 * V_2 ;
int V_17 = 0 ;
V_25 = F_36 ( sizeof( struct V_24 ) , V_62 ) ;
if ( ! V_25 )
return - V_63 ;
if ( ! F_37 ( & V_25 -> V_56 . V_64 , V_62 ) ) {
V_17 = - V_63 ;
goto V_65;
}
V_25 -> V_19 = V_36 -> V_19 ;
strcpy ( F_38 ( V_36 ) , V_66 ) ;
strcpy ( F_39 ( V_36 ) , V_67 ) ;
V_36 -> V_68 = V_25 ;
V_17 = F_21 ( V_36 ) ;
if ( V_17 )
return 0 ;
...
#endif
F_41 ( V_25 -> V_31 >= V_70 ) ;
if ( F_42 ( V_71 , V_25 -> V_31 ) != NULL &&
F_42 ( V_71 , V_25 -> V_31 ) != V_36 ) {
F_43 ( & V_36 -> V_2 ,
L_20 ,
V_25 -> V_31 ) ;
goto V_72;
...
static int F_61 ( struct V_35 * V_2 ,
const struct V_61 * V_31 )
{
return 1 ;
}
