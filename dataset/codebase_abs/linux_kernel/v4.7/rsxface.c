...
( memcmp ( V_38 -> V_31 , V_33 -> V_31 -> V_26 , V_42 ) ) ) {
return ( V_12 ) ;
}
V_3 = V_33 -> V_3 ;
V_6 = F_22 ( V_3 , V_18 -> V_16 ) ;
if ( F_6 ( V_6 ) ) {
return ( V_6 ) ;
}
memcpy ( V_3 -> V_15 , V_18 , V_18 -> V_16 ) ;
V_3 -> V_16 = V_18 -> V_16 ;
V_33 -> V_6 = V_12 ;
return ( V_45 ) ;
}
...
V_47 =
F_24 ( struct V_17 , V_3 -> V_15 , V_3 -> V_16 ) ;
while ( V_18 < V_47 ) {
if ( V_18 -> type > V_48 ) {
V_6 = V_49 ;
break;
...
V_3 . V_16 = V_55 ;
V_6 = F_27 ( V_1 , V_29 , & V_3 ) ;
if ( F_6 ( V_6 ) ) {
F_3 ( V_6 ) ;
}
V_6 = F_23 ( & V_3 , V_46 , V_36 ) ;
F_28 ( V_3 . V_15 ) ;
F_3 ( V_6 ) ;
}
