...
for ( V_15 = 0 ; V_15 < V_107 ; ++ V_15 ) {
V_24 = F_48 ( & V_29 -> V_99 . V_103 [ V_15 ] , V_7 ) ;
if ( V_24 )
goto V_112;
}
V_24 = F_49 ( V_7 ,
...
static struct V_12 * F_55 ( struct V_114 * V_10 )
{
...
{
struct V_9 * V_9 = F_3 ( V_116 -> V_10 . V_11 ) ;
struct V_73 * V_74 ;
int V_15 , V_24 ;
V_74 = F_57 ( & V_116 -> V_10 , sizeof( struct V_73 ) ,
V_117 ) ;
if ( V_74 == NULL )
return - V_118 ;
F_58 ( V_116 , V_74 ) ;
...
V_74 -> V_99 . V_119 = 8 ;
for ( V_15 = 0 ; V_15 < V_107 ; V_15 ++ ) {
V_74 -> V_99 . V_103 [ V_15 ] . V_120 = L_14 ;
V_74 -> V_99 . V_103 [ V_15 ] . V_121 = V_15 + 1 ;
V_74 -> V_99 . V_103 [ V_15 ] . type = V_122 ;
V_74 -> V_99 . V_103 [ V_15 ] . V_10 = V_9 -> V_10 ;
V_74 -> V_99 . V_103 [ V_15 ] . V_12 = V_9 -> V_12 ;
V_74 -> V_99 . V_103 [ V_15 ] . V_123 = V_124
+ ( 0x100 * V_15 ) ;
V_74 -> V_99 . V_103 [ V_15 ] . V_125 = V_126 [ V_15 ] ;
V_74 -> V_99 . V_103 [ V_15 ] . V_127
= F_4 ( V_128 ) ;
V_24 = F_59 ( & V_74 -> V_99 . V_103 [ V_15 ] ) ;
if ( V_24 != 0 )
return V_24 ;
}
for ( V_15 = 0 ; V_15 < F_4 ( V_74 -> V_89 ) ; V_15 ++ )
V_74 -> V_89 [ V_15 ] . V_129 = 3 ;
F_60 ( V_9 , 1 , V_130 - 1 ,
V_131 , V_132 ,
& V_74 -> V_89 [ 0 ] ) ;
F_60 ( V_9 , 2 , V_133 - 1 ,
...
F_24 ( V_9 -> V_12 , V_138 ,
V_139 , 0x12 ) ;
for ( V_15 = 0 ; V_15 < F_4 ( V_140 ) ; V_15 ++ )
F_61 ( & V_74 -> V_99 , V_15 ) ;
for ( V_15 = 0 ; V_15 < F_4 ( V_141 ) ; V_15 ++ )
F_24 ( V_9 -> V_12 , V_141 [ V_15 ] ,
V_142 , V_142 ) ;
F_62 ( & V_116 -> V_10 ) ;
F_63 ( & V_116 -> V_10 ) ;
V_24 = F_64 ( & V_116 -> V_10 , & V_143 ) ;
if ( V_24 < 0 ) {
F_8 ( & V_116 -> V_10 , L_15 , V_24 ) ;
return V_24 ;
}
V_24 = F_65 ( & V_116 -> V_10 , & V_144 ,
V_140 , F_4 ( V_140 ) ) ;
if ( V_24 < 0 ) {
F_8 ( & V_116 -> V_10 , L_16 , V_24 ) ;
F_66 ( & V_116 -> V_10 ) ;
}
return V_24 ;
}
...
{
struct V_73 * V_74 = F_68 ( V_116 ) ;
int V_15 ;
F_66 ( & V_116 -> V_10 ) ;
F_69 ( & V_116 -> V_10 ) ;
F_70 ( & V_116 -> V_10 ) ;
for ( V_15 = 0 ; V_15 < V_107 ; V_15 ++ )
F_71 ( & V_74 -> V_99 . V_103 [ V_15 ] ) ;
return 0 ;
}
