...
+ V_70 -> V_73 . V_169 + F_60 ( & V_42 -> V_118 ) ;
if ( V_145 > V_27 -> V_78 )
V_27 -> V_78 = V_145 ;
...
if ( V_27 -> type != V_74 ) {
memcpy ( V_27 -> V_173 , & V_7 -> V_24 . V_25 , 4 ) ;
memcpy ( V_27 -> V_174 , & V_7 -> V_24 . V_26 , 4 ) ;
}
F_10 ( V_14 , V_18 ) ;
...
int F_92 ( struct V_37 * V_27 , struct V_6 * V_7 , int V_175 )
{
int V_41 = 0 ;
struct V_12 * V_18 = F_8 ( V_27 ) ;
struct V_38 * V_38 = V_18 -> V_38 ;
struct V_13 * V_14 = F_93 ( V_38 , V_18 -> V_176 ) ;
F_33 ( ! V_14 -> V_32 ) ;
switch ( V_175 ) {
case V_177 :
if ( V_27 == V_14 -> V_32 ) {
...
int F_97 ( struct V_37 * V_27 , int V_191 , bool V_192 )
{
struct V_12 * V_42 = F_8 ( V_27 ) ;
int V_68 = V_42 -> V_64 + sizeof( struct V_63 ) ;
int V_193 = 0xFFF8 - V_27 -> V_77 - V_68 ;
if ( V_191 < 68 )
return - V_188 ;
if ( V_191 > V_193 ) {
if ( V_192 )
...
int F_98 ( struct V_37 * V_27 , int V_191 )
{
return F_97 ( V_27 , V_191 , true ) ;
}
...
void F_103 ( struct V_37 * V_27 , struct V_194 * V_21 )
{
struct V_12 * V_42 = F_8 ( V_27 ) ;
struct V_13 * V_14 ;
V_14 = F_93 ( V_42 -> V_38 , V_42 -> V_176 ) ;
if ( V_14 -> V_32 != V_27 ) {
F_13 ( V_14 , F_8 ( V_27 ) ) ;
F_104 ( V_27 , V_21 ) ;
}
...
int F_107 ( struct V_38 * V_38 , int V_176 ,
struct V_39 * V_40 , char * V_195 )
{
struct V_13 * V_14 = F_93 ( V_38 , V_176 ) ;
struct V_6 V_23 ;
unsigned int V_196 ;
for ( V_196 = 0 ; V_196 < V_197 ; V_196 ++ )
F_108 ( & V_14 -> V_22 [ V_196 ] ) ;
if ( ! V_40 ) {
V_14 -> V_32 = NULL ;
return 0 ;
}
...
if ( V_195 )
F_17 ( V_23 . V_43 , V_195 , V_44 ) ;
F_109 () ;
V_14 -> V_32 = F_16 ( V_38 , V_40 , & V_23 ) ;
if ( ! F_28 ( V_14 -> V_32 ) ) {
V_14 -> V_32 -> V_198 |= V_199 ;
...
static void F_111 ( struct V_13 * V_14 , struct V_194 * V_21 ,
struct V_39 * V_40 )
{
struct V_38 * V_38 = F_48 ( V_14 -> V_32 ) ;
struct V_37 * V_27 , * V_200 ;
int V_33 ;
F_112 (net, dev, aux)
if ( V_27 -> V_39 == V_40 )
F_104 ( V_27 , V_21 ) ;
...
struct V_12 * V_18 ;
struct V_201 * V_202 ;
struct V_20 * V_203 = & V_14 -> V_22 [ V_33 ] ;
...
F_115 ( V_204 ) ;
F_109 () ;
F_111 ( V_14 , & V_204 , V_40 ) ;
F_116 ( & V_204 ) ;
F_110 () ;
}
int F_117 ( struct V_37 * V_27 , struct V_205 * V_206 [] ,
struct V_6 * V_7 )
{
struct V_12 * V_79 ;
...
int F_120 ( struct V_37 * V_27 , struct V_205 * V_206 [] ,
struct V_6 * V_7 )
{
struct V_12 * V_18 ;
struct V_12 * V_42 = F_8 ( V_27 ) ;
struct V_38 * V_38 = V_42 -> V_38 ;
struct V_13 * V_14 = F_93 ( V_38 , V_42 -> V_176 ) ;
if ( V_27 == V_14 -> V_32 )
return - V_188 ;
...
F_90 ( V_14 , V_18 , V_27 , V_7 , ! V_206 [ V_209 ] ) ;
return 0 ;
}
...
struct V_38 * V_38 = V_42 -> V_38 ;
struct V_13 * V_14 ;
V_14 = F_93 ( V_38 , V_42 -> V_176 ) ;
if ( V_14 -> V_32 != V_27 )
F_13 ( V_14 , F_8 ( V_27 ) ) ;
F_30 ( & V_42 -> V_76 ) ;
}
void F_127 ( struct V_37 * V_27 , int V_214 )
{
struct V_12 * V_42 = F_8 ( V_27 ) ;
V_42 -> V_176 = V_214 ;
}
