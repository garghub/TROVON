...
{
F_74 ( & V_23 -> V_145 . V_146 -> V_83 , L_50 ) ;
return 0 ;
}
...
struct V_25 * V_26 = F_12 ( V_23 ) ;
unsigned long V_12 ;
F_76 ( & V_23 -> V_145 . V_146 -> V_83 , L_51 , V_147 ) ;
F_5 ( & V_26 -> V_14 , V_12 ) ;
V_23 -> V_32 = V_33 ;
F_6 ( & V_26 -> V_14 , V_12 ) ;
return 0 ;
...
V_23 = F_79 ( & V_155 , & V_152 -> V_83 , F_80 ( & V_152 -> V_83 ) ) ;
if ( ! V_23 ) {
F_18 ( L_53 ) ;
return - V_122 ;
}
...
static int F_86 ( struct V_151 * V_152 , T_4 V_32 )
{
struct V_22 * V_23 ;
int V_9 = 0 ;
int V_157 = 0 ;
...
{
struct V_22 * V_23 ;
F_76 ( & V_152 -> V_83 , L_51 , V_147 ) ;
V_23 = F_84 ( V_152 ) ;
F_89 ( V_159 , & V_23 -> V_12 ) ;
F_7 ( V_23 ) ;
return 0 ;
}
static void F_90 ( struct V_95 * V_83 )
{
}
