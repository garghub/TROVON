...
V_346 = log -> V_348 + ( ( V_349 ) V_171 - 2 ) ;
if ( V_346 >= log -> V_273 )
V_346 -= log -> V_273 ;
V_142 = F_144 ( log , V_346 ) ;
if ( V_142 -> V_350 == 0 )
return 0 ;
F_143 ( V_341 , L_42 ,
V_142 -> V_351 , V_142 -> V_350 ,
V_142 -> V_352 , V_142 -> V_353 ) ;
for ( V_160 = 0 ; V_160 < V_354 / 8 ; V_160 ++ ) {
T_4 V_355 = V_142 -> V_178 [ V_160 ] ;
T_5 V_356 = ( T_5 ) ( V_355 >> 32 ) ;
T_5 V_357 = ( T_5 ) V_355 ;
F_143 ( V_341 , L_43 , V_356 , V_357 ) ;
}
F_145 ( V_341 , L_44 ) ;
return 0 ;
}
static inline void * F_146 ( struct V_340 * V_341 , T_7 V_358 )
{
struct V_1 * V_1 = V_341 -> V_342 ;
struct V_343 * log = V_1 -> V_344 ;
return ( ( V_358 <= log -> V_273 ) ? ( void * ) ( V_349 ) ( V_358 + 1 ) : NULL ) ;
}
static void * F_147 ( struct V_340 * V_341 , T_7 * V_358 )
{
return * V_358 ? F_146 ( V_341 , * V_358 ) : V_347 ;
}
static void * F_148 ( struct V_340 * V_341 , void * V_171 , T_7 * V_358 )
{
++ * V_358 ;
return F_146 ( V_341 , * V_358 ) ;
}
static void F_149 ( struct V_340 * V_341 , void * V_171 )
{
}
static int F_150 ( struct V_359 * V_359 , struct V_360 * V_360 )
{
int V_361 = F_151 ( V_360 , & V_362 ) ;
if ( ! V_361 ) {
struct V_340 * V_341 = V_360 -> V_363 ;
V_341 -> V_342 = V_359 -> V_364 ;
}
return V_361 ;
}
static int F_152 ( struct V_340 * V_341 , void * V_171 )
{
struct V_1 * V_1 = V_341 -> V_342 ;
int V_365 = F_153 ( V_1 -> V_36 . V_366 , V_367 ) ;
int V_32 , V_368 = ( V_349 ) V_171 - 1 ;
if ( V_368 )
F_154 ( V_341 , '\n' ) ;
#define F_155 ( T_8 , V_7 , V_171 ) \
do {\
...
#define F_156 ( V_7 , V_171 ) S3("s", s, v)
#define F_157 ( V_7 , V_171 ) S3("u", s, txq[qs].v)
#define F_158 ( V_7 , V_171 ) S3("u", s, rxq[qs].v)
if ( V_368 < V_365 ) {
const struct V_84 * V_37 = & V_1 -> V_36 . V_42 [ V_368 * V_367 ] ;
const struct V_73 * V_74 = & V_1 -> V_36 . V_86 [ V_368 * V_367 ] ;
int V_369 = F_159 ( V_367 , V_1 -> V_36 . V_366 - V_367 * V_368 ) ;
F_156 ( L_45 , L_46 ) ;
F_156 ( L_47 ,
...
: - 1 ) ) ;
F_157 ( L_51 , V_78 . V_79 ) ;
F_157 ( L_52 , V_78 . V_273 ) ;
F_157 ( L_53 , V_78 . V_370 ) ;
F_157 ( L_54 , V_78 . V_2 ) ;
F_157 ( L_55 , V_78 . V_371 ) ;
F_158 ( L_56 , V_43 . V_79 ) ;
F_158 ( L_57 , V_43 . V_273 ) ;
F_158 ( L_58 , V_43 . V_372 ) ;
F_155 ( L_59 , L_60 , F_93 ( V_1 , & V_37 [ V_32 ] . V_43 ) ) ;
F_155 ( L_59 , L_61 ,
V_1 -> V_36 . V_168 [ V_37 [ V_32 ] . V_43 . V_167 ] ) ;
F_158 ( L_62 , V_43 . V_371 ) ;
F_158 ( L_63 , V_43 . V_373 ) ;
F_158 ( L_64 , V_87 . V_79 ) ;
F_158 ( L_65 , V_87 . V_273 - V_274 ) ;
F_158 ( L_66 , V_87 . V_374 ) ;
F_158 ( L_67 , V_87 . V_2 ) ;
F_158 ( L_68 , V_87 . V_371 ) ;
return 0 ;
}
V_368 -= V_365 ;
if ( V_368 == 0 ) {
const struct V_45 * V_375 = & V_1 -> V_36 . V_41 ;
F_143 ( V_341 , L_69 , L_45 , L_70 ) ;
F_143 ( V_341 , L_71 , L_56 , V_375 -> V_79 ) ;
F_143 ( V_341 , L_71 , L_60 ,
F_93 ( V_1 , V_375 ) ) ;
F_143 ( V_341 , L_71 , L_61 ,
V_1 -> V_36 . V_168 [ V_375 -> V_167 ] ) ;
F_143 ( V_341 , L_71 , L_72 , V_375 -> V_371 ) ;
F_143 ( V_341 , L_71 , L_63 , V_375 -> V_373 ) ;
} else if ( V_368 == 1 ) {
const struct V_45 * V_53 = & V_1 -> V_36 . V_53 ;
F_143 ( V_341 , L_69 , L_45 , L_73 ) ;
F_143 ( V_341 , L_71 , L_56 , V_53 -> V_79 ) ;
F_143 ( V_341 , L_71 , L_60 ,
F_93 ( V_1 , V_53 ) ) ;
F_143 ( V_341 , L_71 , L_61 ,
V_1 -> V_36 . V_168 [ V_53 -> V_167 ] ) ;
F_143 ( V_341 , L_71 , L_72 , V_53 -> V_371 ) ;
F_143 ( V_341 , L_71 , L_63 , V_53 -> V_373 ) ;
}
#undef F_158
#undef F_157
#undef F_156
...
{
return F_153 ( V_1 -> V_36 . V_366 , V_367 ) + 1 +
( ( V_1 -> V_51 & V_52 ) != 0 ) ;
}
static void * F_161 ( struct V_340 * V_341 , T_7 * V_358 )
{
int V_376 = F_160 ( V_341 -> V_342 ) ;
return * V_358 < V_376 ? ( void * ) ( ( V_349 ) * V_358 + 1 ) : NULL ;
}
static void F_162 ( struct V_340 * V_341 , void * V_171 )
{
}
static void * F_163 ( struct V_340 * V_341 , void * V_171 , T_7 * V_358 )
{
int V_376 = F_160 ( V_341 -> V_342 ) ;
++ * V_358 ;
return * V_358 < V_376 ? ( void * ) ( ( V_349 ) * V_358 + 1 ) : NULL ;
}
static int F_164 ( struct V_359 * V_359 , struct V_360 * V_360 )
{
int V_361 = F_151 ( V_360 , & V_377 ) ;
if ( ! V_361 ) {
struct V_340 * V_341 = V_360 -> V_363 ;
V_341 -> V_342 = V_359 -> V_364 ;
}
...
#define F_156 ( V_7 , V_171 ) S3("s", s, v)
#define F_166 ( T_9 , V_7 , V_171 ) S3(fmt, s, txq[qs].v)
#define F_157 ( V_7 , V_171 ) T3("lu", s, v)
#define F_167 ( T_9 , V_7 , V_171 ) S3(fmt, s, rxq[qs].v)
#define F_158 ( V_7 , V_171 ) R3("lu", s, v)
if ( V_368 < V_365 ) {
const struct V_84 * V_37 = & V_1 -> V_36 . V_42 [ V_368 * V_367 ] ;
const struct V_73 * V_74 = & V_1 -> V_36 . V_86 [ V_368 * V_367 ] ;
int V_369 = F_159 ( V_367 , V_1 -> V_36 . V_366 - V_367 * V_368 ) ;
...
? V_37 [ V_32 ] . V_43 . V_144 -> V_19
: L_48 ) ) ;
F_167 ( L_59 , L_74 , V_43 . V_378 ) ;
F_158 ( L_75 , V_90 . V_379 ) ;
F_158 ( L_76 , V_90 . V_306 ) ;
F_158 ( L_77 , V_90 . V_307 ) ;
F_158 ( L_78 , V_90 . V_310 ) ;
F_158 ( L_79 , V_90 . V_309 ) ;
F_158 ( L_80 , V_90 . V_380 ) ;
F_157 ( L_81 , V_302 ) ;
F_157 ( L_82 , V_304 ) ;
F_157 ( L_83 , V_308 ) ;
F_157 ( L_84 , V_78 . V_381 ) ;
F_157 ( L_85 , V_78 . V_80 ) ;
F_157 ( L_86 , V_382 ) ;
F_158 ( L_87 , V_87 . V_383 ) ;
F_158 ( L_88 , V_87 . V_384 ) ;
F_158 ( L_89 , V_87 . V_385 ) ;
return 0 ;
}
V_368 -= V_365 ;
if ( V_368 == 0 ) {
const struct V_45 * V_375 = & V_1 -> V_36 . V_41 ;
F_143 ( V_341 , L_90 , L_45 , L_70 ) ;
F_143 ( V_341 , L_91 , L_74 ,
V_375 -> V_378 ) ;
F_143 ( V_341 , L_91 , L_62 , V_375 -> V_371 ) ;
F_143 ( V_341 , L_91 , L_63 , V_375 -> V_373 ) ;
} else if ( V_368 == 1 ) {
const struct V_45 * V_53 = & V_1 -> V_36 . V_53 ;
F_143 ( V_341 , L_90 , L_45 , L_73 ) ;
F_143 ( V_341 , L_91 , L_74 ,
V_53 -> V_378 ) ;
F_143 ( V_341 , L_91 , L_62 , V_53 -> V_371 ) ;
F_143 ( V_341 , L_91 , L_63 , V_53 -> V_373 ) ;
}
#undef F_158
#undef F_157
#undef F_156
...
static int F_168 ( const struct V_1 * V_1 )
{
return F_153 ( V_1 -> V_36 . V_366 , V_367 ) + 1 +
( ( V_1 -> V_51 & V_52 ) != 0 ) ;
}
static void * F_169 ( struct V_340 * V_341 , T_7 * V_358 )
{
int V_376 = F_168 ( V_341 -> V_342 ) ;
return * V_358 < V_376 ? ( void * ) ( ( V_349 ) * V_358 + 1 ) : NULL ;
}
static void F_170 ( struct V_340 * V_341 , void * V_171 )
{
}
static void * F_171 ( struct V_340 * V_341 , void * V_171 , T_7 * V_358 )
{
int V_376 = F_168 ( V_341 -> V_342 ) ;
( * V_358 ) ++ ;
return * V_358 < V_376 ? ( void * ) ( ( V_349 ) * V_358 + 1 ) : NULL ;
}
static int F_172 ( struct V_359 * V_359 , struct V_360 * V_360 )
{
int V_361 = F_151 ( V_360 , & V_386 ) ;
if ( V_361 == 0 ) {
struct V_340 * V_341 = V_360 -> V_363 ;
V_341 -> V_342 = V_359 -> V_364 ;
}
...
static int F_173 ( struct V_340 * V_341 , void * V_171 )
{
struct V_1 * V_1 = V_341 -> V_342 ;
struct V_387 * V_388 = & V_1 -> V_96 . V_388 ;
#define F_156 ( V_30 , T_9 , T_10 ) \
seq_printf(seq, "%-60s " fmt "\n", \
desc " (" #var "):", vfres->var)
F_156 ( L_92 , L_93 , V_389 ) ;
F_156 ( L_94 , L_93 , V_390 ) ;
F_156 ( L_95 , L_93 , V_391 ) ;
F_156 ( L_96 , L_93 , V_392 ) ;
F_156 ( L_97 , L_93 , V_393 ) ;
F_156 ( L_98 , L_93 , V_394 ) ;
F_156 ( L_99 , L_100 , V_395 ) ;
F_156 ( L_101 , L_93 , V_396 ) ;
F_156 ( L_102 , L_100 , V_397 ) ;
F_156 ( L_103 , L_100 , V_398 ) ;
#undef F_156
return 0 ;
}
static int F_174 ( struct V_359 * V_359 , struct V_360 * V_360 )
{
return F_175 ( V_360 , F_173 , V_359 -> V_364 ) ;
}
static int F_176 ( struct V_340 * V_341 , void * V_171 )
{
if ( V_171 == V_347 ) {
F_145 ( V_341 , L_104 ) ;
} else {
struct V_1 * V_1 = V_341 -> V_342 ;
int V_2 = ( V_349 ) V_171 - 2 ;
struct V_4 * V_5 = V_1 -> V_6 [ V_2 ] ;
struct V_9 * V_10 = F_4 ( V_5 ) ;
F_143 ( V_341 , L_105 ,
...
static inline void * F_177 ( struct V_1 * V_1 , T_7 V_358 )
{
return V_358 <= V_1 -> V_96 . V_399
? ( void * ) ( V_349 ) ( V_358 + 1 )
: NULL ;
}
static void * F_178 ( struct V_340 * V_341 , T_7 * V_358 )
{
return * V_358
? F_177 ( V_341 -> V_342 , * V_358 )
: V_347 ;
}
static void * F_179 ( struct V_340 * V_341 , void * V_171 , T_7 * V_358 )
{
( * V_358 ) ++ ;
return F_177 ( V_341 -> V_342 , * V_358 ) ;
}
static void F_180 ( struct V_340 * V_341 , void * V_171 )
{
}
static int F_181 ( struct V_359 * V_359 , struct V_360 * V_360 )
{
int V_361 = F_151 ( V_360 , & V_400 ) ;
if ( V_361 == 0 ) {
struct V_340 * V_341 = V_360 -> V_363 ;
V_341 -> V_342 = V_359 -> V_364 ;
}
...
{
int V_160 ;
F_56 ( F_183 ( V_1 -> V_401 ) ) ;
for ( V_160 = 0 ; V_160 < F_10 ( V_402 ) ; V_160 ++ )
( void ) F_184 ( V_402 [ V_160 ] . V_19 ,
V_402 [ V_160 ] . V_97 ,
V_1 -> V_401 ,
( void * ) V_1 ,
V_402 [ V_160 ] . V_403 ) ;
...
{
struct V_387 * V_388 = & V_1 -> V_96 . V_388 ;
unsigned int V_366 , V_404 ;
V_1 -> V_96 . V_399 = V_388 -> V_389 ;
if ( V_1 -> V_96 . V_399 > V_405 ) {
F_187 ( V_1 -> V_18 , L_106
L_107 , V_405 ,
V_1 -> V_96 . V_399 ) ;
V_1 -> V_96 . V_399 = V_405 ;
}
V_404 = F_188 ( V_1 -> V_96 . V_388 . V_395 ) ;
if ( V_404 < V_1 -> V_96 . V_399 ) {
F_187 ( V_1 -> V_18 , L_108
L_109
L_110 , V_404 , V_1 -> V_96 . V_399 ,
V_1 -> V_96 . V_388 . V_395 ) ;
V_1 -> V_96 . V_399 = V_404 ;
}
V_366 = V_388 -> V_392 - 1 - ( V_33 == V_406 ) ;
if ( V_388 -> V_391 != V_366 )
V_366 = F_159 ( V_388 -> V_391 , V_366 ) ;
if ( V_388 -> V_390 < V_366 * 2 )
V_366 = V_388 -> V_390 / 2 ;
if ( V_366 > V_407 )
V_366 = V_407 ;
V_1 -> V_36 . V_408 = V_366 ;
if ( V_1 -> V_36 . V_408 < V_1 -> V_96 . V_399 ) {
F_187 ( V_1 -> V_18 , L_111
L_112 ,
V_1 -> V_36 . V_408 , V_1 -> V_96 . V_399 ) ;
V_1 -> V_96 . V_399 = V_1 -> V_36 . V_408 ;
}
}
static int F_189 ( struct V_1 * V_1 )
{
struct V_409 * V_409 = & V_1 -> V_96 . V_36 ;
struct V_36 * V_7 = & V_1 -> V_36 ;
int V_38 ;
T_5 V_410 , V_295 = 0 ;
V_38 = F_190 ( V_1 ) ;
...
F_97 ( V_412 ) ;
V_295 = 1 ;
( void ) F_99 ( V_1 , 1 , & V_410 , & V_295 ) ;
V_7 -> V_164 [ 0 ] = F_196 ( V_1 ,
F_197 ( V_409 -> V_413 ) ) ;
V_7 -> V_164 [ 1 ] = F_196 ( V_1 ,
F_198 ( V_409 -> V_413 ) ) ;
V_7 -> V_164 [ 2 ] = F_196 ( V_1 ,
F_197 ( V_409 -> V_414 ) ) ;
V_7 -> V_164 [ 3 ] = F_196 ( V_1 ,
F_198 ( V_409 -> V_414 ) ) ;
V_7 -> V_164 [ 4 ] = F_196 ( V_1 ,
F_197 ( V_409 -> V_415 ) ) ;
V_7 -> V_164 [ 5 ] = F_196 ( V_1 ,
F_198 ( V_409 -> V_415 ) ) ;
V_7 -> V_168 [ 0 ] = F_199 ( V_409 -> V_416 ) ;
V_7 -> V_168 [ 1 ] = F_200 ( V_409 -> V_416 ) ;
V_7 -> V_168 [ 2 ] = F_201 ( V_409 -> V_416 ) ;
V_7 -> V_168 [ 3 ] = F_202 ( V_409 -> V_416 ) ;
V_38 = F_203 ( V_1 ) ;
if ( V_38 ) {
F_35 ( V_1 -> V_18 , L_123
L_124 , V_38 ) ;
...
if ( V_1 -> V_96 . V_388 . V_395 == 0 ) {
F_35 ( V_1 -> V_18 , L_125
L_126 ) ;
return - V_155 ;
}
if ( V_1 -> V_96 . V_388 . V_389 == 0 ) {
F_35 ( V_1 -> V_18 , L_127
L_126 ) ;
return - V_155 ;
}
...
static inline void F_204 ( struct V_45 * V_43 , T_2 V_161 ,
T_2 V_417 , unsigned int V_273 ,
unsigned int V_418 )
{
V_43 -> V_49 = ( F_100 ( V_161 ) |
( V_417 < V_419 ?
V_286 : 0 ) ) ;
V_43 -> V_167 = ( V_417 < V_419
? V_417
: 0 ) ;
V_43 -> V_372 = V_418 ;
V_43 -> V_273 = V_273 ;
...
{
struct V_36 * V_7 = & V_1 -> V_36 ;
int V_420 , V_421 , V_422 , V_2 , V_32 ;
T_11 V_418 ;
F_56 ( ( V_1 -> V_51 & ( V_106 | V_52 ) ) == 0 ) ;
V_421 = 0 ;
F_16 (adapter, pidx)
V_421 += F_206 ( & F_51 ( V_1 , V_2 ) -> V_11 ) ;
if ( V_421 == 0 )
V_420 = 0 ;
else {
int V_423 = ( V_1 -> V_96 . V_399 - V_421 ) ;
V_420 = ( V_1 -> V_36 . V_408 - V_423 ) / V_421 ;
if ( V_420 > F_207 () )
V_420 = F_207 () ;
}
V_422 = 0 ;
...
struct V_9 * V_10 = F_51 ( V_1 , V_2 ) ;
V_10 -> V_85 = V_422 ;
V_10 -> V_35 = F_206 ( & V_10 -> V_11 ) ? V_420 : 1 ;
V_422 += V_10 -> V_35 ;
}
V_7 -> V_366 = V_422 ;
V_418 = 64 ;
for ( V_32 = 0 ; V_32 < V_7 -> V_408 ; V_32 ++ ) {
struct V_84 * V_37 = & V_7 -> V_42 [ V_32 ] ;
struct V_73 * V_74 = & V_7 -> V_86 [ V_32 ] ;
F_204 ( & V_37 -> V_43 , 0 , 0 , 1024 , V_418 ) ;
V_37 -> V_87 . V_273 = 72 ;
V_74 -> V_78 . V_273 = 1024 ;
}
F_204 ( & V_7 -> V_41 , V_174 , 0 , 512 , V_418 ) ;
F_204 ( & V_7 -> V_53 , V_174 , 0 , V_424 + 1 ,
V_418 ) ;
}
static void F_208 ( struct V_1 * V_1 , int V_369 )
{
int V_160 ;
struct V_9 * V_10 ;
F_56 ( V_369 < V_1 -> V_96 . V_399 ) ;
while ( V_369 < V_1 -> V_36 . V_366 )
F_16 (adapter, i) {
V_10 = F_51 ( V_1 , V_160 ) ;
if ( V_10 -> V_35 > 1 ) {
V_10 -> V_35 -- ;
V_1 -> V_36 . V_366 -- ;
if ( V_1 -> V_36 . V_366 <= V_369 )
break;
}
}
V_369 = 0 ;
...
{
int V_160 , V_425 , V_426 , V_35 ;
struct V_427 V_376 [ V_424 ] ;
struct V_36 * V_7 = & V_1 -> V_36 ;
for ( V_160 = 0 ; V_160 < V_424 ; ++ V_160 )
V_376 [ V_160 ] . V_142 = V_160 ;
V_425 = V_7 -> V_408 + V_428 ;
V_426 = V_1 -> V_96 . V_399 + V_428 ;
V_425 = F_210 ( V_1 -> V_107 , V_376 , V_426 , V_425 ) ;
if ( V_425 < 0 )
return V_425 ;
V_35 = V_425 - V_428 ;
if ( V_35 < V_7 -> V_408 ) {
F_187 ( V_1 -> V_18 , L_128
L_129 , V_35 ) ;
V_7 -> V_408 = V_35 ;
if ( V_35 < V_7 -> V_366 )
F_208 ( V_1 , V_35 ) ;
}
for ( V_160 = 0 ; V_160 < V_425 ; ++ V_160 )
V_1 -> V_29 [ V_160 ] . V_39 = V_376 [ V_160 ] . V_429 ;
return 0 ;
}
static int F_211 ( struct V_430 * V_107 ,
...
struct V_9 * V_10 ;
struct V_4 * V_144 ;
F_212 ( L_130 , V_434 , V_255 ) ;
V_38 = F_213 ( V_107 ) ;
if ( V_38 ) {
F_35 ( & V_107 -> V_5 , L_131 ) ;
return V_38 ;
}
V_38 = F_214 ( V_107 , V_253 ) ;
if ( V_38 ) {
F_35 ( & V_107 -> V_5 , L_132 ) ;
goto V_435;
}
V_38 = F_215 ( V_107 , F_216 ( 64 ) ) ;
if ( V_38 == 0 ) {
V_38 = F_217 ( V_107 , F_216 ( 64 ) ) ;
if ( V_38 ) {
...
V_1 -> V_107 = V_107 ;
V_1 -> V_18 = & V_107 -> V_5 ;
V_1 -> V_344 = F_78 ( sizeof( * V_1 -> V_344 ) +
( sizeof( struct V_345 ) *
V_438 ) ,
V_437 ) ;
if ( ! V_1 -> V_344 ) {
...
V_1 -> V_344 -> V_273 = V_438 ;
F_220 ( & V_1 -> V_116 ) ;
V_1 -> V_321 = F_221 ( V_107 , 0 ) ;
if ( ! V_1 -> V_321 ) {
...
V_144 -> V_445 = V_446 | V_447 |
V_448 | V_449 |
V_182 | V_450 ;
V_144 -> V_451 = V_446 | V_447 |
V_448 | V_449 |
V_452 ;
V_144 -> V_181 = V_144 -> V_445 |
V_183 ;
if ( V_433 )
V_144 -> V_181 |= V_452 ;
V_144 -> V_453 |= V_454 ;
...
if ( V_144 == NULL )
continue;
F_233 ( V_144 , V_10 -> V_35 ) ;
F_234 ( V_144 , V_10 -> V_35 ) ;
V_38 = F_235 ( V_144 ) ;
if ( V_38 ) {
F_187 ( & V_107 -> V_5 , L_144
L_145 , V_144 -> V_19 ) ;
continue;
}
F_63 ( V_2 , & V_1 -> V_460 ) ;
...
F_9 ( V_1 -> V_18 , L_149 ,
V_1 -> V_6 [ V_2 ] -> V_19 ,
( V_1 -> V_51 & V_106 ) ? L_150 :
( V_1 -> V_51 & V_52 ) ? L_151 : L_152 ) ;
}
return 0 ;
V_461:
if ( V_1 -> V_51 & V_106 ) {
...
static void F_246 ( struct V_430 * V_107 )
{
struct V_1 * V_1 = F_247 ( V_107 ) ;
if ( V_1 ) {
int V_2 ;
F_16 (adapter, pidx)
if ( F_239 ( V_2 , & V_1 -> V_460 ) )
...
static void F_250 ( struct V_430 * V_107 )
{
struct V_1 * V_1 ;
int V_2 ;
V_1 = F_247 ( V_107 ) ;
...
{
int V_23 ;
if ( V_33 != V_459 && V_33 != V_406 ) {
F_252 ( L_153 ,
V_33 , V_459 , V_406 ) ;
return - V_155 ;
}
V_462 = F_236 ( V_253 , NULL ) ;
if ( F_183 ( V_462 ) )
F_252 ( L_154 ) ;
V_23 = F_253 ( & V_463 ) ;
if ( V_23 < 0 && ! F_183 ( V_462 ) )
F_254 ( V_462 ) ;
return V_23 ;
}
static void T_13 F_255 ( void )
{
F_256 ( & V_463 ) ;
F_254 ( V_462 ) ;
}
