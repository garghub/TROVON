...
F_41 ( F_60 ( V_53 -> V_56 ) ,
V_59 , V_53 -> V_112 . V_66 ,
V_53 -> V_112 . V_67 , V_113 ,
V_114 , V_115 ) ;
if ( V_102 || ! F_30 ( V_53 ) )
F_31 ( V_104 , V_53 ) ;
V_5 = NULL ;
...
struct V_87 * V_89 ;
if ( V_59 ) {
V_89 = F_46 ( V_59 , V_53 -> V_112 . V_88 ) ;
if ( ! V_89 )
V_89 = F_62 ( V_116 ) ;
} else {
V_89 = F_62 ( V_116 ) ;
...
struct V_39 * V_107 , struct V_103 * V_103 )
{
struct V_58 * V_59 = F_52 ( V_53 , V_101 ) ;
...
return V_107 -> V_111 ;
case 4 :
return F_64 ( V_107 , V_103 ) ;
default:
F_65 () ;
}
}
static bool F_66 ( T_4 V_118 , T_4 V_119 ,
T_4 V_120 , T_4 V_121 )
{
T_4 V_122 = F_33 ( V_118 , V_119 ) ;
T_4 V_123 = F_33 ( V_120 , V_121 ) ;
return ( V_122 == V_63 || V_122 > V_120 ) &&
( V_123 == V_63 || V_123 > V_118 ) ;
}
int F_67 ( struct V_74 * V_75 ,
struct V_12 * V_124 , int * V_125 ,
const struct V_126 * V_127 )
{
struct V_64 * V_65 , * V_128 ;
T_3 * V_27 ;
F_39 (err, n, &flo->error_list, list) {
if ( ! F_66 ( V_65 -> V_66 , V_65 -> V_67 ,
V_127 -> V_66 , V_127 -> V_67 ) )
continue;
V_27 = F_68 ( V_124 ,
28 + V_129 + V_84 ) ;
if ( F_16 ( ! V_27 ) )
...
struct V_54 * V_55 ;
T_2 V_131 ;
for ( V_131 = 0 ; V_131 < F_73 ( V_53 ) ; V_131 ++ ) {
V_59 = F_52 ( V_53 , V_131 ) ;
if ( V_59 && V_59 -> V_2 ) {
V_55 = & V_59 -> V_2 -> V_3 ;
if ( ! F_56 ( V_55 ) )
return true ;
