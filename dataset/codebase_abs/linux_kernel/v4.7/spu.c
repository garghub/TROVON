...
static int T_2 F_30 ( struct V_2 * V_2 , void * V_48 )
{
int V_12 ;
F_2 ( L_12 , V_20 , __LINE__ , V_2 -> V_47 ) ;
...
static int T_2 F_33 ( int (* F_34)( void * V_48 ) )
{
int V_12 ;
unsigned int V_56 ;
unsigned int V_57 ;
...
break;
if ( V_59 == V_60 ) {
V_12 = F_34 ( ( void * ) ( unsigned long ) V_43 ) ;
if ( V_12 )
break;
}
}
...
T_1 V_68 ;
V_68 = F_42 ( V_2 , V_66 ) ;
F_43 ( V_2 , V_66 , V_68 & V_67 ) ;
}
static void F_44 ( struct V_2 * V_2 , int V_66 , T_1 V_67 )
{
T_1 V_68 ;
V_68 = F_42 ( V_2 , V_66 ) ;
F_43 ( V_2 , V_66 , V_68 | V_67 ) ;
}
static void F_45 ( struct V_2 * V_2 , int V_66 , T_1 V_67 )
{
...
static void F_48 ( struct V_2 * V_2 , int V_66 , T_1 V_70 )
{
F_49 ( V_1 ( V_2 ) -> V_4 , V_66 ,
V_70 , 0 ) ;
}
static T_1 F_50 ( struct V_2 * V_2 , int V_66 )
{
T_1 V_70 ;
F_51 ( V_1 ( V_2 ) -> V_4 , V_66 , & V_70 ) ;
return V_70 ;
}
static void F_52 ( struct V_2 * V_2 , int V_71 )
{
}
static T_1 F_53 ( struct V_2 * V_2 )
{
return F_32 ( & V_1 ( V_2 ) -> V_8 -> V_72 ) ;
}
static void F_54 ( struct V_2 * V_2 , T_1 V_73 )
{
}
static T_1 F_55 ( struct V_2 * V_2 )
{
return F_32 ( & V_1 ( V_2 ) -> V_8 -> V_74 ) ;
}
static void F_56 ( struct V_2 * V_2 )
{
}
static void F_57 ( struct V_2 * V_2 , T_1 V_52 )
{
static const T_1 V_75 = ~ ( V_76
| V_77 ) ;
F_27 ( ( V_52 & V_75 ) != ( V_1 ( V_2 ) -> V_51 . V_52 & V_75 ) ) ;
...
static void F_61 ( struct V_2 * V_2 , T_1 V_80 )
{
...
static void F_66 ( struct V_2 * V_2 , T_1 V_82 )
{
}
