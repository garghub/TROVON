...
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return sprintf ( V_122 , L_38 , V_20 -> V_135 ) ;
}
...
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return sprintf ( V_122 , L_42 , F_64 ( V_20 , V_142 ) ) ;
}
...
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return sprintf ( V_122 , L_42 , F_64 ( V_20 , V_145 ) ) ;
}
static T_3 F_73 ( struct V_35 * V_38 , struct V_117 * V_118 ,
const char * V_122 , T_4 V_11 )
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return F_61 ( V_20 , V_122 , V_11 , V_144 ) ;
}
...
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return sprintf ( V_122 , L_42 , F_64 ( V_20 , V_147 ) ) ;
}
static T_3 F_76 ( struct V_35 * V_38 , struct V_117 * V_118 ,
const char * V_122 , T_4 V_11 )
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return F_61 ( V_20 , V_122 , V_11 , V_146 ) ;
}
...
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return sprintf ( V_122 , L_42 , V_20 -> V_152 ) ;
}
...
{
struct V_19 * V_20 = F_13 ( V_38 ) ;
return sprintf ( V_122 , L_42 , V_20 -> V_154 ) ;
}
...
if ( ! V_49 )
return sprintf ( V_122 , L_42 , 10 * V_160 + V_161 ) ;
return V_49 ;
}
...
V_156 = F_99 ( V_20 , & V_20 -> V_168 , L_50 ,
- 1 , V_180 ,
& V_181 ) ;
if ( V_156 )
goto exit;
...
V_20 -> V_94 == V_182 )
V_156 = F_99 ( V_20 , & V_20 -> V_177 , L_51 ,
V_142 , V_183 ,
& V_184 ) ;
if ( V_156 )
goto exit;
...
V_156 = F_99 ( V_20 , & V_20 -> V_175 , L_53 ,
V_147 , V_186 ,
& V_184 ) ;
if ( V_156 )
goto exit;
if ( ! F_4 ( V_20 -> V_1 , V_144 , NULL ) )
V_156 = F_99 ( V_20 , & V_20 -> V_187 , L_54 ,
V_145 , V_188 ,
& V_184 ) ;
if ( V_156 )
goto exit;
...
if( ! V_20 -> V_50 )
return - V_17 ;
V_16 = F_104 ( V_20 , & V_20 -> V_177 , L_55 ,
V_192 , V_183 ) ;
if( V_16 )
goto exit;
V_16 = F_104 ( V_20 , & V_20 -> V_176 , L_56 ,
V_193 , V_185 ) ;
if( V_16 )
goto exit;
V_16 = F_104 ( V_20 , & V_20 -> V_175 , L_57 ,
V_194 , V_186 ) ;
exit:
if ( V_16 )
F_98 ( V_20 ) ;
...
if ( F_31 ( V_10 ) )
F_6 ( L_62 ) ;
if ( F_1 ( V_20 -> V_1 , L_63 , 0 , & V_157 ) ) {
F_54 ( L_64 ) ;
return - V_17 ;
}
V_10 =
F_10 ( V_20 -> V_1 , L_65 , NULL , & V_234 ) ;
if ( F_31 ( V_10 ) )
F_6 ( L_66 ) ;
else if ( V_234 )
F_137 ( L_67 ,
( V_125 ) V_234 ) ;
if ( F_3 ( V_20 -> V_1 , L_68 , V_236 ) )
F_54 ( L_69 , V_236 ) ;
if ( V_157 . V_12 ) {
V_233 = V_157 . V_12 ;
switch ( V_233 -> type ) {
