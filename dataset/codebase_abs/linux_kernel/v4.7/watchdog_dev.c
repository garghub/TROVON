...
static int F_57 ( struct V_1 * V_2 , T_6 V_101 )
{
struct V_7 * V_8 ;
int V_21 ;
V_8 = F_58 ( sizeof( struct V_7 ) , V_102 ) ;
if ( ! V_8 )
return - V_103 ;
F_59 ( & V_8 -> V_97 ) ;
F_60 ( & V_8 -> V_26 ) ;
...
V_21 = F_65 ( & V_8 -> V_92 , V_101 , 1 ) ;
if ( V_21 ) {
F_63 ( L_10 ,
V_2 -> V_31 , F_66 ( V_108 ) , V_2 -> V_31 ) ;
if ( V_2 -> V_31 == 0 ) {
F_67 ( & V_104 ) ;
V_90 = NULL ;
F_56 ( & V_8 -> V_97 , F_51 ) ;
...
T_6 V_101 ;
int V_109 ;
V_101 = F_74 ( F_66 ( V_108 ) , V_2 -> V_31 ) ;
V_109 = F_57 ( V_2 , V_101 ) ;
if ( V_109 )
return V_109 ;
