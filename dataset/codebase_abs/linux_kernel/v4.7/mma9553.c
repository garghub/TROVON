...
static const char * F_48 ( struct V_143 * V_40 )
{
const struct V_144 * V_145 ;
V_145 = F_49 ( V_40 -> V_146 -> V_147 , V_40 ) ;
if ( ! V_145 )
return NULL ;
return F_50 ( V_40 ) ;
}
static int F_51 ( struct V_148 * V_38 ,
const struct V_149 * V_145 )
{
struct V_17 * V_18 ;
struct V_79 * V_80 ;
const char * V_150 = NULL ;
int V_34 ;
V_80 = F_52 ( & V_38 -> V_40 , sizeof( * V_18 ) ) ;
if ( ! V_80 )
return - V_151 ;
V_18 = F_30 ( V_80 ) ;
F_53 ( V_38 , V_80 ) ;
...
if ( V_145 )
V_150 = V_145 -> V_150 ;
else if ( F_54 ( & V_38 -> V_40 ) )
V_150 = F_48 ( & V_38 -> V_40 ) ;
else
return - V_152 ;
F_55 ( & V_18 -> V_78 ) ;
F_5 ( V_18 ) ;
...
if ( V_34 < 0 )
return V_34 ;
V_80 -> V_40 . V_153 = & V_38 -> V_40 ;
V_80 -> V_154 = V_155 ;
V_80 -> V_156 = F_15 ( V_155 ) ;
V_80 -> V_150 = V_150 ;
V_80 -> V_157 = V_158 ;
V_80 -> V_23 = & V_159 ;
if ( V_38 -> V_132 > 0 ) {
V_34 = F_56 ( & V_38 -> V_40 , V_38 -> V_132 ,
F_43 ,
F_45 ,
V_160 ,
V_161 , V_80 ) ;
...
F_62 ( & V_80 -> V_40 , L_8 , V_150 ) ;
return 0 ;
V_162:
F_24 ( V_38 , false ) ;
return V_34 ;
}
static int F_63 ( struct V_148 * V_38 )
{
struct V_79 * V_80 = F_64 ( V_38 ) ;
struct V_17 * V_18 = F_30 ( V_80 ) ;
F_65 ( V_80 ) ;
F_66 ( & V_38 -> V_40 ) ;
F_67 ( & V_38 -> V_40 ) ;
...
static int F_69 ( struct V_143 * V_40 )
{
struct V_79 * V_80 = F_64 ( F_70 ( V_40 ) ) ;
struct V_17 * V_18 = F_30 ( V_80 ) ;
int V_34 ;
F_26 ( & V_18 -> V_78 ) ;
...
F_28 ( & V_18 -> V_78 ) ;
if ( V_34 < 0 ) {
F_10 ( & V_18 -> V_38 -> V_40 , L_9 ) ;
return - V_164 ;
}
return 0 ;
}
static int F_71 ( struct V_143 * V_40 )
{
struct V_79 * V_80 = F_64 ( F_70 ( V_40 ) ) ;
struct V_17 * V_18 = F_30 ( V_80 ) ;
int V_34 ;
...
static int F_72 ( struct V_143 * V_40 )
{
struct V_79 * V_80 = F_64 ( F_70 ( V_40 ) ) ;
struct V_17 * V_18 = F_30 ( V_80 ) ;
int V_34 ;
...
static int F_73 ( struct V_143 * V_40 )
{
struct V_79 * V_80 = F_64 ( F_70 ( V_40 ) ) ;
struct V_17 * V_18 = F_30 ( V_80 ) ;
int V_34 ;
