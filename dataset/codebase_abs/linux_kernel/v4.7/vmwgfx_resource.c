...
long V_100 ;
if ( V_98 )
return F_66 ( V_3 -> V_101 , true ) ? 0 : - V_102 ;
V_100 = F_67 ( V_3 -> V_101 , true , true , V_103 ) ;
if ( ! V_100 )
return - V_102 ;
else if ( V_100 < 0 )
return V_100 ;
...
int F_72 ( struct V_104 * V_105 , void * V_106 ,
struct V_107 * V_108 )
{
struct V_109 * V_110 =
(struct V_109 * ) V_106 ;
struct V_1 * V_111 ;
struct V_5 * V_79 ;
struct V_40 * V_41 = F_73 ( V_108 ) -> V_41 ;
struct V_45 * V_112 ;
int V_33 ;
...
int F_74 ( struct V_104 * V_105 , void * V_106 ,
struct V_107 * V_108 )
{
struct V_11 * V_12 = F_75 ( V_105 ) ;
union V_119 * V_110 =
(union V_119 * ) V_106 ;
...
T_1 V_42 ;
int V_33 ;
V_33 = F_76 ( & V_12 -> V_124 , true ) ;
if ( F_36 ( V_33 != 0 ) )
return V_33 ;
V_33 = F_58 ( V_12 , F_73 ( V_108 ) -> V_41 ,
V_121 -> V_54 , false , & V_42 , & V_111 ,
NULL ) ;
if ( F_36 ( V_33 != 0 ) )
goto V_125;
V_123 -> V_42 = V_42 ;
V_123 -> V_126 = F_77 ( & V_111 -> V_4 . V_127 ) ;
V_123 -> V_128 = V_42 ;
V_123 -> V_129 = 0 ;
F_15 ( & V_111 ) ;
V_125:
...
int F_79 ( struct V_104 * V_105 , void * V_106 ,
struct V_107 * V_108 )
{
struct V_130 * V_110 =
(struct V_130 * ) V_106 ;
return F_71 ( F_73 ( V_108 ) -> V_41 ,
V_110 -> V_42 ,
V_131 ) ;
}
...
F_71 ( V_41 , V_136 -> V_4 . V_91 . V_92 , V_131 ) ;
V_132:
F_21 ( & V_9 ) ;
return V_33 ;
}
int F_94 ( struct V_104 * V_105 , void * V_106 ,
struct V_107 * V_108 )
{
struct V_11 * V_12 = F_75 ( V_105 ) ;
struct V_140 * V_136 ;
...
V_136 -> V_4 . V_41 = NULL ;
V_33 = F_86 ( V_12 , & V_136 -> V_136 , F_88 ) ;
if ( F_36 ( V_33 != 0 ) )
goto V_144;
V_83 = F_2 ( V_9 ) ;
V_33 = F_97 ( V_41 , & V_136 -> V_4 , false , V_145 ,
& F_92 , NULL ) ;
if ( F_36 ( V_33 != 0 ) ) {
F_21 ( & V_83 ) ;
goto V_146;
...
if ( V_33 != 0 )
return - V_46 ;
* V_154 = F_77 ( & V_52 -> V_4 . V_127 ) ;
F_15 ( & V_52 ) ;
return 0 ;
}
int F_101 ( struct V_107 * V_108 ,
struct V_104 * V_105 ,
T_1 V_42 )
{
return F_71 ( F_73 ( V_108 ) -> V_41 ,
...
if ( V_9 -> V_21 ) {
F_106 ( & V_9 -> V_21 -> V_4 . V_101 -> V_166 . V_4 ) ;
F_11 ( & V_9 -> V_22 ) ;
F_15 ( & V_9 -> V_21 ) ;
}
if ( V_164 ) {
V_9 -> V_21 = F_107 ( V_164 ) ;
F_106 ( & V_164 -> V_4 . V_101 -> V_166 . V_4 ) ;
F_104 ( & V_9 -> V_22 , & V_164 -> V_74 ) ;
} else {
V_9 -> V_21 = NULL ;
}
}
...
V_25 -> V_26 = false ;
F_104 ( & V_25 -> V_172 , & V_171 ) ;
V_33 = F_109 ( NULL , & V_171 , V_70 , NULL ) ;
if ( F_36 ( V_33 != 0 ) )
goto V_173;
...
static int F_114 ( struct V_8 * V_9 , bool V_70 )
{
struct V_24 V_25 ;
const struct V_37 * V_15 = V_9 -> V_15 ;
int V_33 ;
...
V_177 = F_2
( F_116 ( V_178 , struct V_8 ,
V_20 ) ) ;
F_11 ( & V_177 -> V_20 ) ;
F_9 ( & V_12 -> V_17 ) ;
V_33 = F_114 ( V_177 , true ) ;
if ( F_36 ( V_33 != 0 ) ) {
F_7 ( & V_12 -> V_17 ) ;
F_104 ( & V_177 -> V_20 , V_178 ) ;
F_9 ( & V_12 -> V_17 ) ;
if ( V_33 == - V_117 ||
++ V_179 > V_181 ) {
F_21 ( & V_177 ) ;
...
if ( V_183 == NULL ) {
F_118 ( NULL , V_12 , & V_183 , NULL ) ;
F_119 ( V_3 -> V_101 , & V_183 -> V_4 ) ;
F_120 ( & V_183 -> V_4 ) ;
} else
F_119 ( V_3 -> V_101 , & V_183 -> V_4 ) ;
}
...
( void ) F_123 ( V_3 , false , false ) ;
}
}
int F_124 ( struct V_1 * V_189 )
{
struct V_8 * V_190 ;
struct V_11 * V_12 ;
struct {
...
V_190 = V_189 -> V_190 ;
V_12 = V_190 -> V_12 ;
V_193 = F_125 ( V_12 , sizeof( * V_193 ) , V_190 -> V_18 ) ;
if ( F_36 ( V_193 == NULL ) ) {
F_60 ( L_16
L_17 ) ;
return - V_84 ;
...
( void ) F_124 ( V_189 ) ;
F_19 ( & V_12 -> V_29 ) ;
( void ) F_118 ( NULL , V_12 , & V_183 , NULL ) ;
F_117 ( V_3 , V_183 ) ;
if ( V_183 != NULL )
F_128 ( & V_183 ) ;
( void ) F_123 ( V_3 , false , false ) ;
...
bool F_129 ( const struct V_8 * V_9 )
{
...
int F_132 ( struct V_8 * V_9 , bool V_70 )
{
struct V_11 * V_12 = V_9 -> V_12 ;
int V_33 ;
F_133 ( & V_12 -> V_124 , V_70 ) ;
F_17 ( & V_12 -> V_199 ) ;
V_33 = F_112 ( V_9 , V_70 , false ) ;
if ( V_33 )
goto V_173;
if ( V_9 -> V_168 == 0 ) {
...
struct V_11 * V_12 = V_9 -> V_12 ;
int V_33 ;
F_76 ( & V_12 -> V_124 , false ) ;
F_17 ( & V_12 -> V_199 ) ;
V_33 = F_112 ( V_9 , false , true ) ;
F_85 ( V_33 ) ;
F_85 ( V_9 -> V_168 == 0 ) ;
