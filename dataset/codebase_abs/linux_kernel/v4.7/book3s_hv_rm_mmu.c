...
long F_44 ( struct V_14 * V_89 , unsigned long V_8 ,
long V_21 , unsigned long V_50 , unsigned long V_44 )
{
return F_21 ( V_89 -> V_7 , V_8 , V_21 , V_50 , V_44 ,
V_89 -> V_10 . V_51 , true , & V_89 -> V_10 . V_90 [ 4 ] ) ;
}
static inline int F_45 ( unsigned int * V_91 )
{
...
static void F_46 ( struct V_7 * V_7 , unsigned long * V_96 ,
long V_97 , int V_9 , bool V_98 )
{
long V_25 ;
if ( V_9 ) {
while ( ! F_45 ( & V_7 -> V_10 . V_99 ) )
F_38 () ;
if ( V_98 )
asm volatile("ptesync" : : : "memory");
...
long F_47 ( struct V_7 * V_7 , unsigned long V_8 ,
...
if ( V_102 & V_68 ) {
V_57 [ 0 ] &= ~ F_42 ( V_68 ) ;
V_104 = F_48 ( V_102 , F_36 ( V_57 [ 1 ] ) , V_21 ) ;
F_46 ( V_7 , & V_104 , 1 , F_6 ( V_7 , V_8 ) , true ) ;
...
F_49 ( V_57 , 0 ) ;
if ( V_102 & V_67 )
V_102 = ( V_102 & ~ V_67 ) | V_68 ;
V_101 [ 0 ] = V_102 ;
V_101 [ 1 ] = V_103 ;
return V_88 ;
}
long F_50 ( struct V_14 * V_89 , unsigned long V_8 ,
unsigned long V_21 , unsigned long V_100 )
{
return F_47 ( V_89 -> V_7 , V_8 , V_21 , V_100 ,
& V_89 -> V_10 . V_90 [ 4 ] ) ;
}
long F_51 ( struct V_14 * V_89 )
{
...
long F_52 ( struct V_14 * V_89 , unsigned long V_8 ,
unsigned long V_21 , unsigned long V_100 ,
unsigned long V_120 )
{
struct V_7 * V_7 = V_89 -> V_7 ;
...
V_103 = F_32 ( V_103 ) ;
if ( V_103 != V_76 ) {
V_104 = F_48 ( V_102 , V_103 , V_21 ) ;
V_57 [ 0 ] = F_42 ( ( V_102 & ~ V_68 ) |
V_67 ) ;
F_46 ( V_7 , & V_104 , 1 , F_6 ( V_7 , V_8 ) ,
true ) ;
V_57 [ 1 ] = F_42 ( V_103 ) ;
}
}
F_49 ( V_57 , V_102 & ~ V_66 ) ;
asm volatile("ptesync" : : : "memory");
return V_88 ;
}
...
long F_56 ( struct V_14 * V_89 , unsigned long V_8 ,
unsigned long V_21 )
{
struct V_7 * V_7 = V_89 -> V_7 ;
T_3 * V_57 ;
...
void F_57 ( struct V_7 * V_7 , T_3 * V_130 ,
unsigned long V_21 )
{
unsigned long V_104 ;
V_130 [ 0 ] &= ~ F_42 ( V_68 ) ;
V_104 = F_48 ( F_36 ( V_130 [ 0 ] ) , F_36 ( V_130 [ 1 ] ) ,
V_21 ) ;
F_46 ( V_7 , & V_104 , 1 , 1 , true ) ;
}
void F_55 ( struct V_7 * V_7 , T_3 * V_130 ,
unsigned long V_21 )
{
unsigned long V_104 ;
unsigned char V_131 ;
V_104 = F_48 ( F_36 ( V_130 [ 0 ] ) , F_36 ( V_130 [ 1 ] ) ,
V_21 ) ;
V_131 = ( F_36 ( V_130 [ 1 ] ) & ~ V_46 ) >> 8 ;
* ( ( char * ) V_130 + 14 ) = V_131 ;
F_46 ( V_7 , & V_104 , 1 , 1 , false ) ;
}
long F_58 ( struct V_7 * V_7 , T_5 V_132 , unsigned long V_133 ,
unsigned long V_134 )
{
unsigned int V_25 ;
unsigned int V_135 ;
...
V_102 = F_36 ( V_57 [ V_25 ] ) & ~ V_66 ;
if ( ! ( V_102 & V_134 ) || ( V_102 & V_121 ) != V_139 )
continue;
while ( ! F_37 ( & V_57 [ V_25 ] , V_66 ) )
F_38 () ;
V_102 = F_36 ( V_57 [ V_25 ] ) & ~ V_66 ;
V_103 = F_36 ( V_57 [ V_25 + 1 ] ) ;
if ( ( V_102 & V_134 ) && ( V_102 & V_121 ) == V_139 &&
F_59 ( V_102 , V_103 ) == ( 1ul << V_135 ) )
return ( V_138 << 3 ) + ( V_25 >> 1 ) ;
F_39 ( & V_57 [ V_25 ] , V_102 ) ;
}
if ( V_139 & V_142 )
break;
V_139 |= V_142 ;
...
long F_60 ( struct V_14 * V_89 , unsigned long V_2 ,
...
if ( V_151 & V_156 )
V_134 |= V_67 ;
V_153 = F_58 ( V_7 , V_2 , V_133 , V_134 ) ;
if ( V_153 < 0 ) {
if ( V_151 & V_156 )
return V_151 ;
return 0 ;
...
unsigned int V_167 = F_63 ( V_126 , V_89 -> V_10 . V_168 ) ;
if ( V_151 & V_164 )
V_167 >>= 1 ;
if ( V_167 & 1 )
return V_151 | V_169 ;
