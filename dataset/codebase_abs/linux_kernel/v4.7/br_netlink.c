...
#if F_112 ( V_227 )
if ( V_167 [ V_228 ] ) {
V_29 V_203 = F_66 ( V_167 [ V_228 ] ) ;
V_23 -> V_229 = V_203 ? true : false ;
}
if ( V_167 [ V_230 ] ) {
V_29 V_203 = F_66 ( V_167 [ V_230 ] ) ;
V_23 -> V_231 = V_203 ? true : false ;
}
if ( V_167 [ V_232 ] ) {
V_29 V_203 = F_66 ( V_167 [ V_232 ] ) ;
V_23 -> V_233 = V_203 ? true : false ;
}
#endif
return 0 ;
}
...
{
struct V_22 * V_23 = F_12 ( V_175 ) ;
T_1 V_234 = F_115 ( V_23 -> V_234 ) ;
T_1 V_235 = F_115 ( V_23 -> V_235 ) ;
T_1 V_236 = F_115 ( V_23 -> V_237 ) ;
T_1 V_238 = F_115 ( V_23 -> V_238 ) ;
T_1 V_149 = V_23 -> V_149 ;
T_2 V_42 = ( V_23 -> V_239 . V_240 [ 0 ] << 8 ) | V_23 -> V_239 . V_240 [ 1 ] ;
V_29 V_241 = F_116 ( V_23 ) ;
V_30 V_242 ;
V_242 = F_25 ( & V_23 -> V_243 ) ;
if ( F_26 ( V_35 , V_244 , V_242 , V_245 ) )
return - V_76 ;
V_242 = F_25 ( & V_23 -> V_246 ) ;
if ( F_26 ( V_35 , V_247 , V_242 , V_245 ) )
return - V_76 ;
V_242 = F_25 ( & V_23 -> V_248 ) ;
if ( F_26 ( V_35 , V_249 , V_242 ,
V_245 ) )
return - V_76 ;
V_242 = F_25 ( & V_23 -> V_250 ) ;
if ( F_26 ( V_35 , V_251 , V_242 , V_245 ) )
return - V_76 ;
if ( F_23 ( V_35 , V_177 , V_234 ) ||
F_23 ( V_35 , V_178 , V_235 ) ||
F_23 ( V_35 , V_179 , V_236 ) ||
F_23 ( V_35 , V_180 , V_238 ) ||
F_23 ( V_35 , V_181 , V_149 ) ||
F_22 ( V_35 , V_182 , V_42 ) ||
F_21 ( V_35 , V_183 , V_241 ) ||
F_22 ( V_35 , V_190 , V_23 -> V_193 ) ||
F_24 ( V_35 , V_252 , sizeof( struct V_28 ) ,
& V_23 -> V_239 ) ||
F_24 ( V_35 , V_253 , sizeof( struct V_28 ) ,
& V_23 -> V_61 ) ||
F_22 ( V_35 , V_254 , V_23 -> V_255 ) ||
F_23 ( V_35 , V_256 , V_23 -> V_257 ) ||
F_21 ( V_35 , V_258 , V_23 -> V_259 ) ||
F_21 ( V_35 , V_260 ,
V_23 -> V_261 ) ||
...
F_22 ( V_35 , V_186 , V_23 -> V_262 ) ||
F_21 ( V_35 , V_188 , V_23 -> V_263 ) )
return - V_76 ;
#endif
#ifdef F_17
if ( F_21 ( V_35 , V_199 , V_23 -> V_85 ) ||
F_21 ( V_35 , V_200 , ! V_23 -> V_264 ) ||
F_21 ( V_35 , V_202 ,
V_23 -> V_204 ) ||
F_21 ( V_35 , V_205 , V_23 -> V_265 ) ||
F_23 ( V_35 , V_207 ,
V_23 -> V_208 ) ||
...
V_23 -> V_214 ) )
return - V_76 ;
V_242 = F_115 ( V_23 -> V_216 ) ;
if ( F_26 ( V_35 , V_215 , V_242 ,
V_245 ) )
return - V_76 ;
V_242 = F_115 ( V_23 -> V_218 ) ;
if ( F_26 ( V_35 , V_217 , V_242 ,
V_245 ) )
return - V_76 ;
V_242 = F_115 ( V_23 -> V_220 ) ;
if ( F_26 ( V_35 , V_219 , V_242 ,
V_245 ) )
return - V_76 ;
V_242 = F_115 ( V_23 -> V_222 ) ;
if ( F_26 ( V_35 , V_221 , V_242 ,
V_245 ) )
return - V_76 ;
V_242 = F_115 ( V_23 -> V_224 ) ;
if ( F_26 ( V_35 , V_223 , V_242 ,
V_245 ) )
return - V_76 ;
V_242 = F_115 ( V_23 -> V_226 ) ;
if ( F_26 ( V_35 , V_225 , V_242 ,
V_245 ) )
return - V_76 ;
#endif
#if F_112 ( V_227 )
...
V_266 ++ ;
return V_266 * F_14 ( sizeof( struct V_267 ) ) +
F_14 ( 0 ) ;
}
static int F_121 ( struct V_34 * V_35 , const struct V_18 * V_19 ,
int * V_268 )
{
struct V_22 * V_23 = F_12 ( V_19 ) ;
struct V_1 * V_2 ;
...
V_271 . V_13 = V_5 -> V_13 ;
F_122 ( V_5 , & V_273 ) ;
V_271 . V_274 = V_273 . V_274 ;
V_271 . V_275 = V_273 . V_275 ;
V_271 . V_276 = V_273 . V_276 ;
V_271 . V_277 = V_273 . V_277 ;
if ( F_24 ( V_35 , V_278 , sizeof( V_271 ) , & V_271 ) )
goto V_91;
}
F_39 ( V_35 , V_123 ) ;
* V_268 = 0 ;
