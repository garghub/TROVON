...
int V_82 ;
F_29 ( & V_81 -> V_40 ) ;
V_82 = ( V_81 -> V_27 == NULL ) || ! F_6 ( & V_81 -> V_22 ) ;
F_37 ( & V_81 -> V_40 ) ;
return V_82 ;
}
...
V_28 = F_105 ( V_79 -> V_26 ) ;
if ( V_28 < 0 )
return V_28 ;
V_79 -> V_26 -> V_59 = V_20 ;
V_28 = F_105 ( V_79 -> V_46 ) ;
if ( V_28 < 0 )
goto V_128;
V_79 -> V_46 -> V_59 = V_20 ;
F_56 ( & V_20 -> V_40 , V_86 ) ;
