...
F_33 ( & V_32 -> V_85 ) ;
F_34 ( & V_32 -> V_86 ) ;
for ( V_77 = 0 ; V_77 < V_32 -> V_87 ; V_77 ++ ) {
if ( V_32 -> V_88 [ V_77 ] ) {
F_35 ( V_32 -> V_88 [ V_77 ] ) ;
V_32 -> V_88 [ V_77 ] = NULL ;
}
...
for ( V_77 = 0 ; V_77 < V_7 ; V_77 ++ )
F_22 ( V_32 -> V_70 , V_32 , V_32 -> V_88 [ V_77 ] ) ;
return 0 ;
}
static int
...
{
struct V_134 V_135 ;
int V_77 = 0 , V_136 , V_137 ;
int V_138 = 0 ;
int V_139 = 0 ;
V_135 = V_56 -> V_57 . V_140 ;
switch ( V_135 . V_141 ) {
case 0 :
V_32 -> V_142 ++ ;
break;
...
for ( V_77 = 0 ; V_77 < V_32 -> V_87 ; V_77 ++ ) {
if ( V_32 -> V_88 [ V_77 ] != V_135 . V_88 [ V_136 ] )
continue;
if ( ( V_2 ) && V_32 -> V_88 [ V_77 ] == V_2 ) {
V_32 -> V_146 ++ ;
V_138 = 1 ;
V_32 -> V_147 ++ ;
}
...
F_17 ( & V_32 -> V_47 , V_45 ) ;
F_64 ( & V_32 -> V_36 ) ;
V_2 -> V_26 = V_56 -> V_57 . V_140 . V_158 ;
V_32 -> V_124 . V_159 ++ ;
...
V_155 = F_65 ( V_2 ) - V_2 -> V_17 ;
if ( V_56 -> V_57 . V_140 . V_88 [ 0 ] != V_2 ) {
if ( F_62 ( V_56 , V_32 , V_2 , V_34 ) < 0 )
F_38 ( & V_32 -> V_34 -> V_41 , L_14 ) ;
return V_157 ;
}
if ( V_56 -> V_57 . V_140 . V_141 > 1 ) {
for ( V_136 = 1 , V_152 = NULL ;
V_136 < V_56 -> V_57 . V_140 . V_141 ; V_136 ++ ) {
V_153 = (struct V_1 * ) V_56 -> V_57 . V_140 . V_88 [ V_136 ] ;
V_153 -> V_25 = NULL ;
if ( ! V_152 )
F_2 ( V_2 ) -> V_22 = V_153 ;
else
...
static int F_92 ( struct V_206 * V_85 , int V_199 )
{
struct V_31 * V_32 = F_42 ( V_85 ,
struct V_31 ,
V_85 ) ;
int V_157 = 0 ;
F_84 ( V_32 ) ;
F_87 ( V_32 -> V_56 , V_32 , & V_157 , V_199 ) ;
if ( V_157 < V_199 )
F_93 ( V_85 ) ;
return V_157 ;
}
static void
F_94 ( unsigned long V_207 )
{
...
V_34 -> V_213 = V_214 ;
V_209 = F_101 ( struct V_215 ,
V_216 . V_217 ) ;
V_46 = F_102 ( V_41 , V_209 , V_34 -> V_175 ,
V_214 ) ;
if ( V_46 < 0 ) {
F_38 ( & V_41 -> V_48 ,
L_58 ,
...
V_209 = F_101 ( struct V_215 ,
V_216 . V_223 ) ;
V_46 = F_102 ( V_41 , V_209 , & V_34 -> V_223 , 4 ) ;
if ( V_46 ) {
F_38 ( & V_41 -> V_48 ,
L_61 ,
V_49 , V_46 ) ;
...
F_110 ( V_34 , & V_32 -> V_85 , F_92 , 64 ) ;
F_111 ( & V_32 -> V_35 , F_94 ,
( unsigned long ) V_32 ) ;
F_97 ( & V_32 -> V_35 , F_30 ( 2 ) ) ;
V_209 = F_101 ( struct V_215 ,
V_224 . V_210 ) ;
V_46 = F_102 ( V_41 , V_209 , & V_210 , 8 ) ;
if ( V_46 ) {
F_38 ( & V_41 -> V_48 ,
L_62 ,
V_49 , V_46 ) ;
...
F_110 ( V_34 , & V_32 -> V_85 , F_92 , V_228 ) ;
F_113 ( V_41 ) ;
V_46 = F_114 ( V_34 ) ;
if ( V_46 ) {
F_38 ( & V_41 -> V_48 ,
...
unsigned long V_45 ;
if ( ! V_32 ) {
F_38 ( & V_41 -> V_48 , L_67 , V_49 ) ;
return;
}
F_17 ( & V_32 -> V_47 , V_45 ) ;
if ( V_32 -> V_51 ) {
F_19 ( & V_32 -> V_47 , V_45 ) ;
F_38 ( & V_41 -> V_48 , L_68 , V_49 ) ;
return;
}
V_32 -> V_51 = true ;
F_19 ( & V_32 -> V_47 , V_45 ) ;
...
struct V_232 * V_233 ;
int V_46 = - V_89 ;
V_230 = F_115 ( L_72 , NULL ) ;
if ( ! V_230 )
return V_46 ;
V_233 = F_129 ( L_73 , V_234 , V_230 , NULL ,
& V_235 ) ;
if ( ! V_233 )
goto V_236;
V_233 = F_129 ( L_74 , V_237 , V_230 ,
NULL , & V_238 ) ;
if ( ! V_233 )
goto V_236;
V_46 = F_130 ( & V_239 ) ;
