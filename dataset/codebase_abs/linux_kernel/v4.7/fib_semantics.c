...
static bool F_132 ( const struct V_5 * V_6 )
{
int V_112 = V_117 ;
if ( V_6 -> V_49 == V_173 ) {
struct V_110 * V_111 ;
F_133 () ;
V_111 = F_134 ( V_6 -> V_26 , V_6 -> V_48 ) ;
if ( V_111 )
V_112 = V_111 -> V_116 ;
F_135 () ;
}
...
void F_136 ( struct V_168 * V_169 , int V_8 )
{
...
void F_137 ( struct V_125 * V_125 , struct V_168 * V_169 ,
struct V_181 * V_182 , int V_293 )
{
#ifdef F_27
