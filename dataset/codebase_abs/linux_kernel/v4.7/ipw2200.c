...
static int F_520 ( struct V_477 * V_1383 ,
const struct V_1384 * V_1385 )
{
int V_557 = 0 ;
struct V_165 * V_167 ;
void T_14 * V_137 ;
...
F_523 ( V_1383 ) ;
V_557 = F_524 ( V_1383 , F_525 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_526 ( V_1383 , F_525 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_515 ) ;
goto V_1389;
}
F_527 ( V_1383 , V_23 ) ;
V_557 = F_528 ( V_1383 , V_1324 ) ;
if ( V_557 )
goto V_1389;
F_529 ( V_1383 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_530 ( V_1383 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_531 ( V_1383 , 0 ) ;
V_23 -> V_1390 = V_415 ;
V_137 = F_532 ( V_1383 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1387 ;
goto V_1391;
}
...
F_412 ( V_23 , 1 ) ;
V_557 = F_533 ( V_1383 -> V_1332 , F_485 , V_1393 , V_1324 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_519 , V_1383 -> V_1332 ) ;
goto V_1392;
}
F_516 ( V_167 , & V_1383 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1394 = F_474 ;
V_23 -> V_163 -> V_896 = F_501 ;
V_23 -> V_163 -> V_1395 = F_471 ;
#ifdef F_292
V_23 -> V_163 -> V_1396 = F_364 ;
V_23 -> V_163 -> V_1397 = F_369 ;
V_23 -> V_163 -> V_1398 = F_368 ;
V_23 -> V_163 -> V_1399 = F_370 ;
#endif
V_23 -> V_163 -> V_642 = - 20 ;
V_23 -> V_163 -> V_643 = - 85 ;
V_167 -> V_1381 = & V_1400 ;
V_23 -> V_1401 . V_1402 = & V_23 -> V_163 -> V_1402 ;
V_167 -> V_1401 = & V_23 -> V_1401 ;
V_167 -> V_1403 = & V_1404 ;
V_167 -> V_1405 = & V_1406 ;
V_557 = F_534 ( & V_1383 -> V_166 . V_1407 , & V_1408 ) ;
if ( V_557 ) {
F_46 ( L_520 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1409;
...
V_1410:
F_536 ( & V_1383 -> V_166 . V_1407 , & V_1408 ) ;
V_1409:
F_537 ( V_1383 -> V_1332 , V_23 ) ;
V_1392:
F_538 ( V_23 -> V_22 ) ;
V_1391:
F_539 ( V_1383 ) ;
...
static void F_541 ( struct V_477 * V_1383 )
{
struct V_17 * V_23 = F_542 ( V_1383 ) ;
...
static int F_545 ( struct V_477 * V_1383 , T_15 V_665 )
{
struct V_17 * V_23 = F_542 ( V_1383 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_547 ( V_1383 ) ;
F_540 ( V_1383 ) ;
F_548 ( V_1383 , F_549 ( V_1383 , V_665 ) ) ;
V_23 -> V_1412 = F_550 () ;
return 0 ;
}
static int F_551 ( struct V_477 * V_1383 )
{
struct V_17 * V_23 = F_542 ( V_1383 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_530 ( V_1383 , 0x40 , V_21 & 0xffff00ff ) ;
F_553 ( V_166 ) ;
V_23 -> V_1354 = F_550 () - V_23 -> V_1412 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_554 ( struct V_477 * V_1383 )
{
struct V_17 * V_23 = F_542 ( V_1383 ) ;
F_162 ( V_23 ) ;
F_540 ( V_1383 ) ;
...
V_432 = F_557 ( & V_1414 . V_1323 , & V_1415 ) ;
if ( V_432 ) {
F_46 ( L_531 ) ;
F_558 ( & V_1414 ) ;
return V_432 ;
