...
{
struct V_10 * V_11 = F_2 ( V_8 -> V_11 ) ;
struct V_51 * V_46 = V_11 -> V_9 . V_46 ;
struct V_52 * V_53 ;
struct V_54 * V_55 ;
...
F_22 ( & V_6 , & V_44 ) ;
V_53 = F_14 ( V_11 -> V_9 . V_16 ) ;
V_55 = F_23 ( V_53 ) ;
F_1 ( V_2 , true , V_55 -> V_56 , & V_6 ) ;
}
...
int F_25 ( struct V_57 * V_58 , struct V_1 * V_2 ,
unsigned long V_59 , enum V_60 type ,
unsigned int V_61 )
{
int V_62 ;
V_62 = F_26 ( V_58 , & V_2 -> V_9 , V_59 ,
& V_63 , V_64 ,
F_27 ( V_64 ) , type , NULL ) ;
if ( V_62 ) {
F_28 ( L_2 ) ;
