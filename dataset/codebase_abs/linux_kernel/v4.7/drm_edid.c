...
static int F_152 ( T_1 * V_344 , int V_8 , int V_345 )
{
int V_2 ;
T_1 V_5 = 0 ;
struct V_346 * V_347 ;
V_347 = (struct V_346 * ) & V_344 [ V_345 ] ;
F_14 ( L_41 ,
V_347 -> V_348 , V_347 -> V_349 , V_347 -> V_350 , V_347 -> V_351 ) ;
if ( V_347 -> V_349 + 5 > V_8 - V_345 )
return - V_352 ;
for ( V_2 = V_345 ; V_2 <= V_347 -> V_349 + 5 ; V_2 ++ ) {
V_5 += V_344 [ V_2 ] ;
}
if ( V_5 ) {
F_8 ( L_42 , V_5 ) ;
...
unsigned V_354 = ( V_206 -> V_355 [ 0 ] | V_206 -> V_355 [ 1 ] << 8 ) + 1 ;
...
bool V_358 = ( V_206 -> V_176 [ 1 ] >> 7 ) & 0x1 ;
bool V_359 = ( V_206 -> V_179 [ 1 ] >> 7 ) & 0x1 ;
V_75 = F_66 ( V_52 ) ;
if ( ! V_75 )
return NULL ;
V_75 -> clock = V_158 * 10 ;
...
V_75 -> V_78 = V_75 -> V_79 + V_354 ;
V_75 -> V_76 = V_75 -> V_77 + V_141 ;
V_75 -> V_81 = V_138 ;
V_75 -> V_80 = V_75 -> V_81 + V_179 ;
V_75 -> V_130 = V_75 -> V_80 + V_356 ;
V_75 -> V_131 = V_75 -> V_81 + V_143 ;
V_75 -> V_35 = 0 ;
V_75 -> V_35 |= V_358 ? V_162 : V_163 ;
V_75 -> V_35 |= V_359 ? V_164 : V_165 ;
V_75 -> type = V_175 ;
if ( V_206 -> V_35 & 0x80 )
V_75 -> type |= V_73 ;
V_75 -> V_74 = F_38 ( V_75 ) ;
...
struct V_353 * V_206 = & V_362 -> V_206 [ V_2 ] ;
...
if ( ! V_344 )
return 0 ;
V_29 = F_152 ( V_344 , V_8 , V_345 ) ;
if ( V_29 )
return 0 ;
V_345 += sizeof( struct V_346 ) ;
while ( V_9 = (struct V_360 * ) & V_344 [ V_345 ] ,
V_345 + sizeof( struct V_360 ) <= V_8 &&
V_345 + sizeof( struct V_360 ) + V_9 -> V_365 <= V_8 &&
V_9 -> V_365 > 0 ) {
V_345 += V_9 -> V_365 + sizeof( struct V_360 ) ;
switch ( V_9 -> V_366 ) {
case V_367 :
V_364 += F_154 ( V_41 , V_9 ) ;
break;
}
}
return V_364 ;
...
if ( ! F_11 ( V_12 ) ) {
F_19 ( V_41 -> V_52 -> V_52 , L_43 ,
V_41 -> V_39 ) ;
return 0 ;
}
V_61 = F_30 ( V_12 ) ;
V_364 += F_93 ( V_41 , V_12 , V_61 ) ;
V_364 += F_90 ( V_41 , V_12 ) ;
V_364 += F_87 ( V_41 , V_12 ) ;
V_364 += F_85 ( V_41 , V_12 ) ;
V_364 += F_128 ( V_41 , V_12 ) ;
V_364 += F_110 ( V_41 , V_12 ) ;
V_364 += F_155 ( V_41 , V_12 ) ;
if ( V_12 -> V_104 & V_105 )
V_364 += F_82 ( V_41 , V_12 ) ;
if ( V_61 & ( V_70 | V_71 ) )
F_33 ( V_41 , V_61 ) ;
F_151 ( V_12 , & V_41 -> V_368 , V_41 ) ;
if ( V_61 & V_369 )
V_41 -> V_368 . V_321 = 8 ;
if ( V_61 & V_370 )
V_41 -> V_368 . V_321 = 12 ;
...
if ( V_75 -> V_35 & V_376 )
V_374 -> V_377 = 1 ;
V_374 -> V_231 = F_101 ( V_75 ) ;
V_374 -> V_378 = V_379 ;
if ( V_75 -> V_232 == V_380 ||
V_75 -> V_232 == V_381 )
V_374 -> V_378 = V_75 -> V_232 ;
else if ( V_374 -> V_231 > 0 )
V_374 -> V_378 = F_105 (
V_374 -> V_231 ) ;
V_374 -> V_382 = V_383 ;
V_374 -> V_384 = V_385 ;
...
T_1 V_409 , V_410 ;
struct V_411 * V_412 ;
V_125 = V_406 -> V_413 [ 0 ] | V_406 -> V_413 [ 1 ] << 8 ;
V_126 = V_406 -> V_413 [ 2 ] | V_406 -> V_413 [ 3 ] << 8 ;
...
V_41 -> V_418 = V_125 + 1 ;
V_41 -> V_419 = V_126 + 1 ;
F_14 ( L_44 , V_406 -> V_416 ) ;
F_14 ( L_45 , V_125 + 1 , V_126 + 1 ) ;
F_14 ( L_46 ,
V_410 + 1 , V_409 + 1 , V_408 , V_407 ) ;
F_14 ( L_47 , V_406 -> V_420 [ 0 ] , V_406 -> V_420 [ 1 ] , V_406 -> V_420 [ 2 ] ) ;
V_412 = F_165 ( V_41 -> V_52 , V_406 -> V_420 ) ;
if ( ! V_412 ) {
V_412 = F_166 ( V_41 -> V_52 , V_406 -> V_420 ) ;
}
if ( ! V_412 )
return - V_299 ;
if ( V_41 -> V_421 != V_412 ) {
if ( V_41 -> V_421 ) {
F_167 ( V_41 -> V_52 , V_41 -> V_421 ) ;
}
V_41 -> V_421 = V_412 ;
} else
F_167 ( V_41 -> V_52 , V_412 ) ;
return 0 ;
}
...
V_29 = F_168 ( V_41 , V_344 , V_6 , true ) ;
if ( V_29 < 0 )
goto V_424;
if ( ! V_41 -> V_415 )
goto V_424;
