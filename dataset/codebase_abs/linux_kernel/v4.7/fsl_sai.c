...
int V_1 , V_53 , V_160 ;
int V_161 ;
V_4 = F_49 ( & V_7 -> V_6 , sizeof( * V_4 ) , V_162 ) ;
if ( ! V_4 )
return - V_163 ;
V_4 -> V_7 = V_7 ;
if ( F_50 ( V_7 -> V_6 . V_154 , L_19 ) ||
F_50 ( V_7 -> V_6 . V_154 , L_20 ) )
V_4 -> V_164 = true ;
V_4 -> V_58 = F_51 ( V_153 , L_21 ) ;
V_157 = F_52 ( V_7 , V_165 , 0 ) ;
V_158 = F_53 ( & V_7 -> V_6 , V_157 ) ;
if ( F_54 ( V_158 ) )
return F_55 ( V_158 ) ;
...
for ( V_160 = 1 ; V_160 < V_89 ; V_160 ++ ) {
sprintf ( V_159 , L_26 , V_160 ) ;
V_4 -> V_90 [ V_160 ] = F_57 ( & V_7 -> V_6 , V_159 ) ;
if ( F_54 ( V_4 -> V_90 [ V_160 ] ) ) {
F_12 ( & V_7 -> V_6 , L_27 ,
V_160 + 1 , F_55 ( V_4 -> V_90 [ V_160 ] ) ) ;
V_4 -> V_90 [ V_160 ] = NULL ;
}
}
V_1 = F_58 ( V_7 , 0 ) ;
if ( V_1 < 0 ) {
F_12 ( & V_7 -> V_6 , L_28 , V_7 -> V_167 ) ;
return V_1 ;
}
V_53 = F_59 ( & V_7 -> V_6 , V_1 , F_1 , 0 , V_153 -> V_167 , V_4 ) ;
if ( V_53 ) {
F_12 ( & V_7 -> V_6 , L_29 , V_1 ) ;
return V_53 ;
}
V_4 -> V_92 [ V_94 ] = true ;
V_4 -> V_92 [ V_93 ] = false ;
...
V_168 . V_170 = 1 ;
V_168 . V_171 = 1 ;
if ( F_60 ( V_153 , L_30 , NULL ) &&
F_60 ( V_153 , L_31 , NULL ) ) {
F_12 ( & V_7 -> V_6 , L_32 ) ;
return - V_50 ;
}
if ( F_60 ( V_153 , L_30 , NULL ) ) {
...
V_161 = F_62 ( V_153 , L_23 ) ;
if ( V_161 < 0 )
return V_161 ;
F_9 ( V_155 , V_172 , F_63 ( V_161 ) ,
F_63 ( V_161 ) ) ;
}
V_4 -> V_143 . V_173 = V_157 -> V_174 + V_148 ;
V_4 -> V_142 . V_173 = V_157 -> V_174 + V_150 ;
V_4 -> V_143 . V_175 = V_141 ;
V_4 -> V_142 . V_175 = V_139 ;
F_64 ( V_7 , V_4 ) ;
V_53 = F_65 ( & V_7 -> V_6 , & V_176 ,
& V_168 , 1 ) ;
if ( V_53 )
return V_53 ;
if ( V_4 -> V_164 )
return F_66 ( V_7 , V_177 ) ;
else
return F_67 ( & V_7 -> V_6 , NULL , 0 ) ;
}
