...
return 0 ;
V_7 -> V_81 = V_78 ;
V_2 -> V_44 . V_25 . V_82 ( V_2 , V_83 , V_7 -> V_67 , false ) ;
F_40 ( V_9 , V_7 ) ;
return 0 ;
}
int F_47 ( struct V_75 * V_76 , int V_15 ,
int T_7 V_84 , int V_85 )
{
struct V_8 * V_9 = F_42 ( V_76 ) ;
struct V_16 * V_17 = V_9 -> V_17 ;
struct V_1 * V_2 = & V_9 -> V_2 ;
if ( ! V_17 || V_15 >= V_17 -> V_23 )
return - V_77 ;
if ( V_85 && ( ( V_85 < V_86 ) || V_85 > V_87 ) )
return - V_77 ;
V_17 -> V_7 [ V_15 ] . V_85 = V_85 ;
V_2 -> V_24 . V_25 . V_88 ( V_2 , V_15 , V_85 ) ;
return 0 ;
}
int F_48 ( struct V_75 * V_76 ,
int V_15 , struct V_89 * V_90 )
{
struct V_8 * V_9 = F_42 ( V_76 ) ;
struct V_16 * V_17 = V_9 -> V_17 ;
struct V_6 * V_7 ;
