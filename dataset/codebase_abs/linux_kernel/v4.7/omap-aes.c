...
static int F_56 ( struct V_43 * V_44 , int V_82 )
{
int V_86 = 0 ;
if ( ! F_57 ( V_82 , V_87 ) )
return - V_77 ;
...
void * V_88 , * V_89 ;
int V_90 , V_82 ;
V_82 = F_60 ( V_2 -> V_82 , V_87 ) ;
V_90 = F_61 ( V_82 ) ;
V_88 = ( void * ) F_62 ( V_91 , V_90 ) ;
V_89 = ( void * ) F_62 ( V_91 , V_90 ) ;
if ( ! V_88 || ! V_89 ) {
F_63 ( L_12 ) ;
return - 1 ;
}
...
F_64 ( & V_2 -> V_93 , 1 ) ;
F_65 ( & V_2 -> V_93 , V_88 , V_82 ) ;
V_2 -> V_52 = & V_2 -> V_93 ;
F_64 ( & V_2 -> V_94 , 1 ) ;
F_65 ( & V_2 -> V_94 , V_89 , V_82 ) ;
V_2 -> V_53 = & V_2 -> V_94 ;
return 0 ;
}
...
{
if ( V_19 )
return F_67 ( V_2 -> V_85 , V_19 ) ;
return 0 ;
}
static int F_68 ( struct V_95 * V_85 ,
struct V_84 * V_19 )
{
...
V_2 -> V_52 = V_19 -> V_100 ;
V_2 -> V_53 = V_19 -> V_101 ;
if ( F_56 ( V_2 -> V_52 , V_2 -> V_82 ) ||
F_56 ( V_2 -> V_53 , V_2 -> V_82 ) ) {
if ( F_59 ( V_2 ) )
F_63 ( L_13 ) ;
V_2 -> V_102 = 1 ;
} else {
...
V_86 = F_60 ( V_2 -> V_82 , V_87 ) ;
V_2 -> V_54 = F_70 ( V_2 -> V_52 , V_86 ) ;
V_2 -> V_55 = F_70 ( V_2 -> V_53 , V_86 ) ;
F_71 ( V_2 -> V_54 < 0 || V_2 -> V_55 < 0 ) ;
V_97 = F_72 ( V_19 ) ;
V_14 = F_69 ( F_48 ( V_19 ) ) ;
V_97 -> V_103 &= V_104 ;
...
static int F_73 ( struct V_95 * V_85 ,
struct V_84 * V_19 )
{
struct V_34 * V_14 = F_69 (
F_48 ( V_19 ) ) ;
...
V_86 = F_60 ( V_2 -> V_99 , V_87 ) ;
V_90 = F_61 ( V_86 ) ;
F_76 ( ( unsigned long ) V_88 , V_90 ) ;
F_76 ( ( unsigned long ) V_89 , V_90 ) ;
}
F_52 ( V_2 , 0 ) ;
F_49 ( L_15 ) ;
}
static int F_77 ( struct V_84 * V_19 , unsigned long V_103 )
{
struct V_34 * V_14 = F_69 (
F_48 ( V_19 ) ) ;
struct V_96 * V_97 = F_72 ( V_19 ) ;
struct V_1 * V_2 ;
F_49 ( L_16 , V_19 -> V_46 ,
! ! ( V_103 & V_24 ) ,
! ! ( V_103 & V_17 ) ) ;
...
static int F_78 ( struct V_105 * V_51 , const T_2 * V_16 ,
unsigned int V_15 )
{
struct V_34 * V_14 = F_69 ( V_51 ) ;
...
static int F_83 ( struct V_84 * V_19 )
{
return F_77 ( V_19 , V_24 | V_18 ) ;
}
static int F_84 ( struct V_84 * V_19 )
{
...
static T_3 F_89 ( int V_112 , void * V_113 )
{
struct V_1 * V_2 = V_113 ;
T_1 V_114 , V_13 ;
T_1 * V_100 , * V_101 ;
V_114 = F_1 ( V_2 , F_90 ( V_2 ) ) ;
if ( V_114 & V_115 ) {
F_3 ( V_2 , F_39 ( V_2 ) , 0x0 ) ;
F_71 ( ! V_2 -> V_52 ) ;
F_71 ( F_91 ( V_116 ) > V_2 -> V_52 -> V_27 ) ;
V_100 = F_75 ( V_2 -> V_52 ) + F_91 ( V_116 ) ;
for ( V_13 = 0 ; V_13 < V_117 ; V_13 ++ ) {
F_3 ( V_2 , F_41 ( V_2 , V_13 ) , * V_100 ) ;
F_34 ( & V_2 -> V_62 , 4 ) ;
if ( V_2 -> V_52 -> V_27 == F_91 ( V_116 ) ) {
V_2 -> V_52 = F_58 ( V_2 -> V_52 ) ;
if ( V_2 -> V_52 ) {
F_33 ( & V_2 -> V_62 ,
V_2 -> V_52 ) ;
V_100 = F_75 ( V_2 -> V_52 ) +
...
V_114 &= ~ V_115 ;
F_3 ( V_2 , F_90 ( V_2 ) , V_114 ) ;
F_3 ( V_2 , F_39 ( V_2 ) , 0x4 ) ;
} else if ( V_114 & V_118 ) {
F_3 ( V_2 , F_39 ( V_2 ) , 0x0 ) ;
F_71 ( ! V_2 -> V_53 ) ;
F_71 ( F_91 ( V_47 ) > V_2 -> V_53 -> V_27 ) ;
V_101 = F_75 ( V_2 -> V_53 ) + F_91 ( V_47 ) ;
for ( V_13 = 0 ; V_13 < V_117 ; V_13 ++ ) {
* V_101 = F_1 ( V_2 , F_41 ( V_2 , V_13 ) ) ;
F_34 ( & V_2 -> V_63 , 4 ) ;
if ( V_2 -> V_53 -> V_27 == F_91 ( V_47 ) ) {
V_2 -> V_53 = F_58 ( V_2 -> V_53 ) ;
if ( V_2 -> V_53 ) {
F_33 ( & V_2 -> V_63 ,
V_2 -> V_53 ) ;
V_101 = F_75 ( V_2 -> V_53 ) +
...
V_2 -> V_82 -= F_92 ( V_119 , V_87 , V_2 -> V_82 ) ;
V_114 &= ~ V_118 ;
F_3 ( V_2 , F_90 ( V_2 ) , V_114 ) ;
if ( ! V_2 -> V_82 )
F_24 ( & V_2 -> V_38 ) ;
...
int V_11 = 0 ;
V_128 = F_94 ( F_95 ( V_129 ) , V_39 ) ;
if ( ! V_128 ) {
F_28 ( V_39 , L_19 ) ;
V_11 = - V_77 ;
goto V_11;
}
V_11 = F_96 ( V_125 , 0 , V_123 ) ;
if ( V_11 < 0 ) {
F_28 ( V_39 , L_20 ) ;
V_11 = - V_77 ;
goto V_11;
...
static int F_99 ( struct V_130 * V_131 )
{
struct V_121 * V_39 = & V_131 -> V_39 ;
struct V_1 * V_2 ;
struct V_135 * V_136 ;
...
T_1 V_139 ;
V_2 = F_100 ( V_39 , sizeof( struct V_1 ) , V_140 ) ;
if ( V_2 == NULL ) {
F_28 ( V_39 , L_22 ) ;
goto V_141;
}
V_2 -> V_39 = V_39 ;
F_101 ( V_131 , V_2 ) ;
V_11 = ( V_39 -> V_126 ) ? F_93 ( V_2 , V_39 , & V_123 ) :
F_97 ( V_2 , V_131 , & V_123 ) ;
if ( V_11 )
goto V_142;
V_2 -> V_4 = F_102 ( V_39 , & V_123 ) ;
if ( F_27 ( V_2 -> V_4 ) ) {
V_11 = F_29 ( V_2 -> V_4 ) ;
goto V_142;
}
...
F_18 ( V_2 ) ;
V_139 = F_1 ( V_2 , F_104 ( V_2 ) ) ;
F_88 ( V_39 ) ;
F_105 ( V_39 , L_23 ,
( V_139 & V_2 -> V_28 -> V_143 ) >> V_2 -> V_28 -> V_144 ,
( V_139 & V_2 -> V_28 -> V_145 ) >> V_2 -> V_28 -> V_146 ) ;
F_106 ( & V_2 -> V_38 , F_74 , ( unsigned long ) V_2 ) ;
V_11 = F_25 ( V_2 ) ;
if ( V_11 == - V_147 ) {
goto V_148;
} else if ( V_11 && F_90 ( V_2 ) && F_39 ( V_2 ) ) {
V_2 -> V_41 = 1 ;
V_112 = F_107 ( V_131 , 0 ) ;
if ( V_112 < 0 ) {
F_28 ( V_39 , L_24 ) ;
...
F_110 ( & V_2 -> V_149 ) ;
F_111 ( & V_36 ) ;
F_112 ( & V_2 -> V_149 , & V_150 ) ;
F_113 ( & V_36 ) ;
for ( V_13 = 0 ; V_13 < V_2 -> V_28 -> V_151 ; V_13 ++ ) {
for ( V_138 = 0 ; V_138 < V_2 -> V_28 -> V_152 [ V_13 ] . V_153 ; V_138 ++ ) {
V_136 = & V_2 -> V_28 -> V_152 [ V_13 ] . V_154 [ V_138 ] ;
F_49 ( L_26 , V_136 -> V_155 ) ;
F_110 ( & V_136 -> V_156 ) ;
V_11 = F_114 ( V_136 ) ;
if ( V_11 )
goto V_157;
V_2 -> V_28 -> V_152 [ V_13 ] . V_158 ++ ;
}
}
V_2 -> V_85 = F_115 ( V_39 , 1 ) ;
if ( ! V_2 -> V_85 )
goto V_157;
V_2 -> V_85 -> V_159 = F_68 ;
V_2 -> V_85 -> V_160 = F_73 ;
...
for ( V_138 = V_2 -> V_28 -> V_152 [ V_13 ] . V_158 - 1 ; V_138 >= 0 ; V_138 -- )
F_118 (
& V_2 -> V_28 -> V_152 [ V_13 ] . V_154 [ V_138 ] ) ;
F_31 ( V_2 ) ;
V_148:
F_119 ( & V_2 -> V_38 ) ;
F_120 ( V_39 ) ;
...
static int F_121 ( struct V_130 * V_131 )
{
struct V_1 * V_2 = F_122 ( V_131 ) ;
int V_13 , V_138 ;
if ( ! V_2 )
return - V_98 ;
F_111 ( & V_36 ) ;
...
static int F_125 ( struct V_121 * V_39 )
{
F_86 ( V_39 ) ;
return 0 ;
}
