...
static void F_3 ( struct V_1 T_2 * V_2 ,
void T_2 * V_8 )
{
}
...
snprintf ( V_48 , sizeof( V_48 ) , L_10 , V_5 -> V_53 ) ;
F_15 ( V_48 , 0600 ,
V_38 -> V_51 , V_5 ,
& V_54 ) ;
}
