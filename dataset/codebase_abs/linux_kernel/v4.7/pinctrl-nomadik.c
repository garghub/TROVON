...
break;
F_23 ( V_45 -> V_80 ) ;
F_4 ( V_45 -> V_34 & V_45 -> V_105 ,
V_45 -> V_7 + V_38 ) ;
F_4 ( V_45 -> V_35 & V_45 -> V_105 ,
V_45 -> V_7 + V_39 ) ;
F_25 ( V_45 -> V_80 ) ;
}
}
...
break;
F_23 ( V_45 -> V_80 ) ;
F_4 ( V_45 -> V_34 , V_45 -> V_7 + V_38 ) ;
F_4 ( V_45 -> V_35 , V_45 -> V_7 + V_39 ) ;
F_25 ( V_45 -> V_80 ) ;
}
}
void F_70 ( int V_134 , T_1 * V_22 )
{
if ( V_134 < V_77 ) {
struct V_1 * V_45 = V_78 [ V_134 ] ;
if ( ! V_45 )
return;
* V_22 = V_45 -> V_22 ;
}
...
F_20 ( & V_138 -> V_67 , L_34 ) ;
return F_74 ( - V_102 ) ;
}
V_2 = V_78 [ V_142 ] ;
if ( V_2 )
return V_2 ;
V_2 = F_76 ( & V_138 -> V_67 , sizeof( * V_2 ) , V_145 ) ;
if ( ! V_2 )
return F_74 ( - V_146 ) ;
V_2 -> V_118 = V_142 ;
V_45 = & V_2 -> V_45 ;
V_45 -> V_46 = V_142 * V_147 ;
V_45 -> V_133 = V_147 ;
V_45 -> V_124 = F_77 ( & V_139 -> V_67 ) ;
V_45 -> V_53 = & V_139 -> V_67 ;
V_141 = F_78 ( V_139 , V_148 , 0 ) ;
V_46 = F_79 ( & V_138 -> V_67 , V_141 ) ;
if ( F_80 ( V_46 ) )
return V_46 ;
V_2 -> V_7 = V_46 ;
V_80 = F_81 ( & V_139 -> V_67 , NULL ) ;
if ( F_80 ( V_80 ) )
return ( void * ) V_80 ;
F_82 ( V_80 ) ;
V_2 -> V_80 = V_80 ;
F_83 ( V_2 -> V_118 >= F_84 ( V_78 ) ) ;
V_78 [ V_142 ] = V_2 ;
return V_2 ;
}
static int F_85 ( struct V_137 * V_67 )
{
struct V_135 * V_136 = V_67 -> V_67 . V_149 ;
struct V_1 * V_2 ;
struct V_84 * V_45 ;
struct V_114 * V_150 ;
int V_151 ;
...
V_150 -> V_174 = F_44 ;
V_150 -> V_101 = V_175 ;
V_150 -> V_143 = F_90 ( V_145 , L_37 ,
V_67 -> V_142 ,
V_45 -> V_46 ,
V_45 -> V_46 + V_45 -> V_133 - 1 ) ;
F_23 ( V_2 -> V_80 ) ;
V_2 -> V_27 = F_91 ( V_2 -> V_7 + V_29 ) ;
F_25 ( V_2 -> V_80 ) ;
V_45 -> V_149 = V_136 ;
V_153 = F_92 ( V_45 , V_2 ) ;
if ( V_153 )
...
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
return V_58 -> V_68 -> V_179 [ V_178 ] . V_143 ;
}
static int F_100 ( struct V_81 * V_82 , unsigned V_178 ,
...
static struct V_84 * F_102 ( unsigned V_71 )
{
struct V_1 * V_183 = F_101 ( V_71 ) ;
if ( V_183 )
return & V_183 -> V_45 ;
return NULL ;
}
...
static int F_104 ( struct V_185 * * V_186 , unsigned * V_187 ,
...
static int F_105 ( struct V_185 * * V_186 ,
unsigned * V_187 ,
unsigned * V_188 , const char * V_189 ,
...
if ( * V_188 == * V_187 )
return - V_191 ;
V_197 = F_106 ( V_195 , V_196 * sizeof( * V_197 ) ,
V_145 ) ;
if ( ! V_197 )
return - V_146 ;
...
static int F_107 ( int V_200 , int V_31 , unsigned long * V_201 )
{
int V_153 = 0 ;
...
static const char * F_108 ( struct V_81 * V_82 , const char * V_205 )
{
int V_60 , V_206 ;
struct V_57 * V_58 = F_27 ( V_82 ) ;
...
return V_58 -> V_68 -> V_180 [ V_60 ] . V_143 ;
return NULL ;
}
...
int V_60 , V_31 , V_153 ;
for ( V_60 = 0 ; V_60 < F_84 ( V_202 ) ; V_60 ++ ) {
V_153 = F_75 ( V_136 ,
V_202 [ V_60 ] . V_210 , & V_31 ) ;
if ( V_153 != - V_102 ) {
if ( F_107 ( V_60 , V_31 , & V_209 ) == 0 ) {
* V_195 |= V_209 ;
V_208 = 1 ;
}
}
...
struct V_210 * V_211 ;
struct V_135 * V_212 ;
V_153 = F_111 ( V_136 , L_42 , & V_190 ) ;
if ( V_153 >= 0 ) {
const char * V_189 ;
V_153 = F_112 ( V_136 , L_43 ) ;
if ( V_153 < 0 )
goto exit;
V_153 = F_113 ( V_82 , V_186 ,
V_187 ,
V_188 , V_153 ) ;
if ( V_153 < 0 )
goto exit;
F_114 (np, L_43 , prop, group) {
V_153 = F_104 ( V_186 , V_187 , V_188 ,
V_189 , V_190 ) ;
if ( V_153 < 0 )
goto exit;
}
}
V_208 = F_109 ( V_136 , & V_195 ) ;
V_212 = F_115 ( V_136 , L_44 , 0 ) ;
if ( V_212 )
V_208 |= F_109 ( V_212 , & V_195 ) ;
if ( V_208 ) {
const char * V_213 ;
const char * V_71 ;
V_153 = F_112 ( V_136 , L_45 ) ;
if ( V_153 < 0 )
goto exit;
V_153 = F_113 ( V_82 , V_186 ,
V_187 ,
...
V_213 = F_108 ( V_82 , V_71 ) ;
V_153 = F_105 ( V_186 , V_187 ,
V_188 ,
V_213 , & V_195 , 1 ) ;
if ( V_153 < 0 )
goto exit;
...
* V_188 = 0 ;
F_117 (np_config, np) {
V_153 = F_110 ( V_82 , V_136 , V_186 ,
& V_187 , V_188 ) ;
if ( V_153 < 0 ) {
F_118 ( V_82 , * V_186 , * V_188 ) ;
return V_153 ;
}
}
return 0 ;
...
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
return V_58 -> V_68 -> V_215 [ V_190 ] . V_143 ;
}
...
static int F_122 ( struct V_81 * V_82 , unsigned V_190 ,
unsigned V_189 )
{
struct V_57 * V_58 = F_27 ( V_82 ) ;
...
if ( V_218 -> V_219 < 0 )
return - V_102 ;
F_17 ( V_58 -> V_67 , L_46 , V_218 -> V_143 , V_218 -> V_182 ) ;
V_33 = ( ( V_218 -> V_219 & V_83 ) == V_83 ) ;
if ( V_33 ) {
F_34 ( & V_103 , V_101 ) ;
memset ( V_14 , 0xff , sizeof( V_14 ) ) ;
for ( V_60 = 0 ; V_60 < V_218 -> V_182 ; V_60 ++ )
V_14 [ V_218 -> V_180 [ V_60 ] / V_147 ] &= ~ F_3 ( V_218 -> V_180 [ V_60 ] ) ;
F_22 ( V_14 ) ;
}
for ( V_60 = 0 ; V_60 < V_218 -> V_182 ; V_60 ++ ) {
struct V_1 * V_2 ;
unsigned V_37 ;
V_2 = F_101 ( V_218 -> V_180 [ V_60 ] ) ;
if ( ! V_2 ) {
F_20 ( V_58 -> V_67 ,
L_47 ,
V_218 -> V_180 [ V_60 ] , V_218 -> V_143 , V_60 ) ;
goto V_220;
}
F_17 ( V_58 -> V_67 , L_48 , V_218 -> V_180 [ V_60 ] , V_218 -> V_219 ) ;
F_23 ( V_2 -> V_80 ) ;
V_37 = V_218 -> V_180 [ V_60 ] % V_147 ;
F_13 ( V_2 , V_37 ) ;
F_12 ( V_2 , V_37 ,
...
V_230 = F_133 ( V_209 ) ;
if ( V_230 ) {
int V_231 = F_134 ( V_209 ) ;
int V_232 = F_135 ( V_209 ) ;
int V_233 = F_136 ( V_209 ) ;
V_229 = true ;
if ( V_231 )
V_18 = V_231 - 1 ;
if ( V_232 )
...
static int F_137 ( struct V_234 * V_67 )
{
struct V_57 * V_58 ;
V_58 = F_138 ( V_67 ) ;
if ( ! V_58 )
return - V_102 ;
return F_139 ( V_58 -> V_235 ) ;
}
static int F_140 ( struct V_234 * V_67 )
{
struct V_57 * V_58 ;
V_58 = F_138 ( V_67 ) ;
if ( ! V_58 )
return - V_102 ;
return F_141 ( V_58 -> V_235 ) ;
}
static int F_142 ( struct V_137 * V_138 )
{
const struct V_236 * V_237 ;
struct V_135 * V_136 = V_138 -> V_67 . V_149 ;
struct V_135 * V_238 ;
struct V_57 * V_58 ;
unsigned int V_239 = 0 ;
int V_60 ;
V_58 = F_76 ( & V_138 -> V_67 , sizeof( * V_58 ) , V_145 ) ;
if ( ! V_58 )
return - V_146 ;
V_237 = F_143 ( V_240 , & V_138 -> V_67 ) ;
if ( ! V_237 )
return - V_144 ;
...
struct V_135 * V_244 ;
struct V_1 * V_2 ;
V_244 = F_115 ( V_136 , L_70 , V_60 ) ;
if ( V_244 ) {
F_97 ( & V_138 -> V_67 ,
L_71 ,
V_60 , V_244 -> V_143 ) ;
V_2 = F_71 ( V_244 , V_138 ) ;
if ( F_80 ( V_2 ) )
F_20 ( & V_138 -> V_67 ,
L_72
L_73 ) ;
...
V_238 = F_115 ( V_136 , L_74 , 0 ) ;
if ( V_238 )
V_58 -> V_65 = F_148 ( V_238 , 0 ) ;
if ( ! V_58 -> V_65 ) {
if ( V_239 == V_241 ) {
F_97 ( & V_138 -> V_67 ,
L_75
...
F_20 ( & V_138 -> V_67 , L_77 ) ;
return - V_102 ;
}
}
V_245 . V_180 = V_58 -> V_68 -> V_180 ;
V_245 . V_182 = V_58 -> V_68 -> V_182 ;
V_58 -> V_67 = & V_138 -> V_67 ;
V_58 -> V_235 = F_149 ( & V_138 -> V_67 , & V_245 , V_58 ) ;
if ( F_80 ( V_58 -> V_235 ) ) {
F_20 ( & V_138 -> V_67 , L_78 ) ;
return F_86 ( V_58 -> V_235 ) ;
}
F_93 ( V_138 , V_58 ) ;
F_97 ( & V_138 -> V_67 , L_79 ) ;
return 0 ;
}
