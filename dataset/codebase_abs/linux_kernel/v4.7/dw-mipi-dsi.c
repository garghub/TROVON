...
static enum V_217
F_90 ( struct V_15 * V_17 , bool V_218 )
{
return V_219 ;
}
static void F_91 ( struct V_15 * V_17 )
{
F_92 ( V_17 ) ;
F_93 ( V_17 ) ;
}
...
int V_32 ;
V_19 -> V_222 = F_95 ( V_221 ,
V_35 -> V_97 ) ;
if ( V_19 -> V_222 == 0 )
return - V_223 ;
F_96 ( & V_7 -> V_19 ,
& V_224 ) ;
V_32 = F_97 ( V_221 , & V_7 -> V_19 , & V_225 ,
V_226 , NULL ) ;
if ( V_32 ) {
F_19 ( V_35 , L_19 ) ;
return V_32 ;
...
V_7 -> V_199 = F_102 ( V_230 , L_20 ) ;
if ( F_103 ( V_7 -> V_199 ) ) {
F_19 ( V_7 -> V_35 , L_21 ) ;
return F_104 ( V_7 -> V_199 ) ;
}
return 0 ;
}
static enum V_213 F_105 (
struct V_15 * V_17 ,
struct V_133 * V_10 )
{
if ( V_10 -> V_158 > 0x7ff )
...
static int F_106 ( struct V_89 * V_35 , struct V_89 * V_233 ,
void * V_234 )
{
const struct V_235 * V_236 =
F_107 ( V_237 , V_35 ) ;
const struct V_238 * V_90 = V_236 -> V_234 ;
struct V_239 * V_240 = F_108 ( V_35 ) ;
struct V_220 * V_221 = V_234 ;
struct V_6 * V_7 ;
struct V_241 * V_242 ;
int V_32 ;
V_7 = F_109 ( V_35 , sizeof( * V_7 ) , V_243 ) ;
if ( ! V_7 )
return - V_244 ;
V_7 -> V_35 = V_35 ;
V_7 -> V_90 = V_90 ;
...
if ( V_32 )
return V_32 ;
V_242 = F_110 ( V_240 , V_245 , 0 ) ;
if ( ! V_242 )
return - V_246 ;
V_7 -> V_22 = F_111 ( V_35 , V_242 ) ;
if ( F_103 ( V_7 -> V_22 ) )
return F_104 ( V_7 -> V_22 ) ;
V_7 -> V_86 = F_112 ( V_35 , L_22 ) ;
if ( F_103 ( V_7 -> V_86 ) ) {
V_32 = F_104 ( V_7 -> V_86 ) ;
F_19 ( V_35 , L_23 , V_32 ) ;
return V_32 ;
}
V_7 -> V_194 = F_112 ( V_35 , L_24 ) ;
if ( F_103 ( V_7 -> V_194 ) ) {
V_32 = F_104 ( V_7 -> V_194 ) ;
F_19 ( V_35 , L_25 , V_32 ) ;
return V_32 ;
}
V_32 = F_72 ( V_7 -> V_86 ) ;
...
V_7 -> V_14 . V_35 = V_35 ;
return F_114 ( & V_7 -> V_14 ) ;
V_247:
F_74 ( V_7 -> V_86 ) ;
return V_32 ;
}
static void F_115 ( struct V_89 * V_35 , struct V_89 * V_233 ,
void * V_234 )
{
struct V_6 * V_7 = F_116 ( V_35 ) ;
F_117 ( & V_7 -> V_14 ) ;
F_74 ( V_7 -> V_86 ) ;
}
static int F_118 ( struct V_239 * V_240 )
{
return F_119 ( & V_240 -> V_35 , & V_250 ) ;
}
static int F_120 ( struct V_239 * V_240 )
{
F_121 ( & V_240 -> V_35 , & V_250 ) ;
return 0 ;
}
