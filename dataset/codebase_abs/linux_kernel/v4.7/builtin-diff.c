...
V_78 = F_37 ( V_76 ) ;
while ( V_78 != NULL ) {
struct V_24 * V_25 = F_38 ( V_78 , struct V_24 , V_82 ) ;
V_78 = F_39 ( & V_25 -> V_82 ) ;
if ( ! F_40 ( V_25 ) ) {
F_41 ( & V_25 -> V_82 , V_76 ) ;
F_42 ( V_25 ) ;
...
static void F_43 ( struct V_28 * V_28 )
{
struct V_75 * V_76 ;
struct V_77 * V_78 ;
if ( F_36 ( V_28 , V_79 ) )
...
struct V_67 * V_74 ;
int V_19 ;
V_25 = F_38 ( V_78 , struct V_24 , V_82 ) ;
V_78 = F_39 ( & V_25 -> V_82 ) ;
F_44 (i, d) {
V_29 = F_31 ( V_25 , V_74 ) ;
if ( ! V_29 )
...
static T_6 F_45 ( double V_83 , double V_84 )
{
if ( V_83 > V_84 )
return - 1 ;
else if ( V_83 < V_84 )
...
if ( ! V_92 || ! V_91 )
return V_92 ? - 1 : 1 ;
return F_46 ( V_92 , V_91 , V_87 ) ;
}
static T_6
F_48 ( struct V_24 * V_85 , struct V_24 * V_86 ,
int V_87 , int V_88 )
{
struct V_24 * V_91 , * V_92 ;
V_92 = F_31 ( V_85 , & V_93 [ V_88 ] ) ;
...
return F_47 ( V_86 , V_85 , V_20 , V_74 -> V_73 ) ;
}
static T_6
...
{
struct V_67 * V_74 = F_29 ( V_69 ) ;
return F_47 ( V_86 , V_85 , V_49 , V_74 -> V_73 ) ;
}
static T_6
...
{
struct V_67 * V_74 = F_29 ( V_69 ) ;
return F_47 ( V_86 , V_85 , V_11 , V_74 -> V_73 ) ;
}
static T_6
F_54 ( struct V_68 * V_69 V_14 ,
struct V_24 * V_85 , struct V_24 * V_86 )
{
return F_48 ( V_86 , V_85 , V_20 ,
V_95 ) ;
}
static T_6
...
static void F_67 ( struct V_67 * V_74 )
{
int V_107 ;
...
int V_4 = - V_5 , V_19 ;
F_61 (i, d) {
V_74 -> V_100 = F_70 ( & V_74 -> V_97 , false , & T_5 ) ;
if ( ! V_74 -> V_100 ) {
...
return F_79 ( V_111 -> V_18 , V_111 -> V_40 ,
F_80 ( V_39 ) ,
V_113 , V_39 ) ;
default:
F_16 ( 1 ) ;
...
struct V_110 * V_111 , struct V_24 * V_25 )
{
return F_77 ( V_69 , V_111 , V_25 , V_20 ) ;
}
static int F_82 ( struct V_68 * V_69 ,
struct V_110 * V_111 , struct V_24 * V_25 )
{
return F_77 ( V_69 , V_111 , V_25 , V_49 ) ;
}
static int F_83 ( struct V_68 * V_69 ,
struct V_110 * V_111 , struct V_24 * V_25 )
{
return F_77 ( V_69 , V_111 , V_25 , V_11 ) ;
}
static void
...
static int F_87 ( struct V_68 * V_127 , struct V_110 * V_111 ,
struct V_24 * V_25 )
{
struct V_70 * V_71 =
F_30 ( V_127 , struct V_70 , V_69 ) ;
char V_18 [ V_128 ] = L_27 ;
F_86 ( V_25 , V_71 , V_18 , V_128 ) ;
if ( V_45 . V_115 )
...
static int F_88 ( struct V_68 * V_69 , struct V_110 * V_111 ,
...
static void F_90 ( struct V_67 * V_74 , struct V_70 * V_71 )
{
#define F_91 100
char V_129 [ F_91 ] ;
char V_18 [ F_91 ] ;
...
F_16 ( ! V_61 ) ;
if ( V_105 > 2 )
F_12 ( V_18 , F_91 , L_40 , V_61 , V_74 -> V_73 ) ;
#define F_92 (data__files_cnt > 2 ? buf : header)
V_71 -> V_114 = V_130 ;
V_130 = ( int ) strlen ( F_92 ) ;
if ( V_71 -> V_114 < V_130 )
V_71 -> V_114 = V_130 ;
F_12 ( V_129 , F_91 , L_29 ,
V_71 -> V_114 , F_92 ) ;
V_71 -> V_61 = F_93 ( V_129 ) ;
#undef F_91
#undef F_92
}
static void F_94 ( struct V_67 * V_74 , int V_73 )
{
...
int V_19 ;
F_61 (i, d) {
F_94 ( V_74 , V_19 ? V_138 [ V_10 ] :
V_126 ) ;
if ( V_139 && V_19 )
F_94 ( V_74 , V_124 ) ;
if ( V_140 )
F_94 ( V_74 , V_19 ? V_125 :
V_119 ) ;
}
if ( ! V_95 )
return 0 ;
V_69 = F_98 ( sizeof( * V_69 ) ) ;
if ( V_69 == NULL ) {
F_3 ( L_41 ) ;
return - 1 ;
}
...
static int F_99 ( int V_141 , const char * * V_142 )
{
struct V_67 * V_74 ;
...
int F_100 ( int V_141 , const char * * V_142 , const char * T_7 V_14 )
{
int V_4 = F_101 () ;
if ( V_4 < 0 )
return V_4 ;
V_141 = F_102 ( V_141 , V_142 , V_150 , V_151 , 0 ) ;
if ( F_103 ( NULL ) < 0 )
return - 1 ;
if ( F_99 ( V_141 , V_142 ) < 0 )
return - 1 ;
if ( F_97 () < 0 )
return - 1 ;
V_152 = V_153 ;
