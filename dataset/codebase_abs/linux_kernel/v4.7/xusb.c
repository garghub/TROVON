...
if ( ! V_14 || ! F_26 ( V_14 ) )
goto V_66;
V_41 = F_66 ( V_18 -> V_3 , sizeof( * V_41 ) , V_34 ) ;
if ( ! V_41 ) {
V_26 = - V_35 ;
goto V_66;
}
...
static int F_67 ( struct V_68 * V_42 )
{
...
if ( ! V_14 || ! F_26 ( V_14 ) )
goto V_66;
V_42 = F_66 ( V_18 -> V_3 , sizeof( * V_42 ) , V_34 ) ;
if ( ! V_42 ) {
V_26 = - V_35 ;
goto V_66;
}
...
static int F_69 ( struct V_69 * V_43 )
{
return 0 ;
}
...
if ( ! V_14 || ! F_26 ( V_14 ) )
goto V_66;
V_43 = F_66 ( V_18 -> V_3 , sizeof( * V_43 ) , V_34 ) ;
if ( ! V_43 ) {
V_26 = - V_35 ;
goto V_66;
}
...
static int F_71 ( struct V_61 * V_70 )
{
struct V_55 * V_56 = & V_70 -> V_63 ;
struct V_16 * V_14 = V_56 -> V_3 . V_13 ;
T_1 V_47 ;
int V_26 ;
V_26 = F_72 ( V_14 , L_18 , & V_47 ) ;
if ( V_26 < 0 ) {
...
if ( ! V_14 || ! F_26 ( V_14 ) )
goto V_66;
V_70 = F_66 ( V_18 -> V_3 , sizeof( * V_70 ) , V_34 ) ;
if ( ! V_70 ) {
V_26 = - V_35 ;
goto V_66;
}
...
F_19 ( & V_18 -> V_52 ) ;
F_83 ( & V_18 -> V_45 ) ;
V_80 = F_84 ( V_76 , V_83 , 0 ) ;
V_18 -> V_84 = F_85 ( & V_76 -> V_3 , V_80 ) ;
if ( F_28 ( V_18 -> V_84 ) ) {
V_26 = F_29 ( V_18 -> V_84 ) ;
goto remove;
}
V_18 -> V_85 = F_86 ( & V_76 -> V_3 , NULL ) ;
if ( F_28 ( V_18 -> V_85 ) ) {
V_26 = F_29 ( V_18 -> V_85 ) ;
goto remove;
}
...
struct V_17 * F_91 ( struct V_2 * V_3 )
{
struct V_17 * V_18 ;
struct V_75 * V_76 ;
struct V_16 * V_14 ;
V_14 = F_92 ( V_3 -> V_13 , L_25 , 0 ) ;
if ( ! V_14 )
return F_3 ( - V_9 ) ;
V_76 = F_93 ( V_14 ) ;
if ( ! V_76 ) {
