...
static int F_190 ( struct V_328 * V_329 , struct V_6 * V_7 )
{
struct V_5 * V_4 = F_3 ( V_7 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
V_2 -> V_9 = V_10 ;
V_2 -> V_24 =
F_192 ( F_121 , V_2 , L_83 ) ;
if ( F_172 ( V_2 -> V_24 ) ) {
int V_332 = F_173 ( V_2 -> V_24 ) ;
V_2 -> V_24 = NULL ;
V_2 -> V_9 = V_262 ;
return V_332 ;
}
...
V_4 -> V_249 = V_249 ;
V_51 = F_194 ( V_329 , V_7 ) ;
if ( V_51 < 0 )
goto V_324;
V_293 . V_337 = V_51 ;
V_4 -> V_69 = V_51 ;
V_19 = F_195 ( V_249 , & V_338 ) ;
if ( ! V_19 )
goto V_339;
V_4 -> V_21 = V_19 ;
...
V_343 . V_342 =
V_340 . V_342 ;
V_331 = F_196 ( unsigned , V_103 / 1024 , 15 ) ;
V_344 . V_342 =
V_338 . V_342 ;
V_345 . V_346 = V_331 ;
V_347 . V_342 =
...
static void F_198 ( struct V_328 * V_329 , struct V_6 * V_7 )
{
struct V_5 * V_4 = F_3 ( V_7 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
F_8 ( V_4 , L_86 ) ;
...
static inline struct V_353 * F_201 ( struct V_354 * V_355 )
{
return F_4 ( F_202 ( V_355 ) , struct V_353 , V_356 ) ;
}
static inline struct V_333 * F_203 ( struct V_354 * V_355 )
{
return F_4 ( F_202 ( V_355 ) , struct V_333 ,
V_357 . V_356 ) ;
}
static void F_204 ( struct V_354 * V_355 )
{
struct V_353 * V_358 ;
V_358 = F_201 ( V_355 ) ;
F_159 ( V_358 ) ;
...
{
struct V_353 * V_334 = F_201 ( V_355 ) ;
struct V_333 * V_333 = F_203 ( V_334 -> V_356 . V_360 . V_361 ) ;
...
static T_4 F_207 ( struct V_354 * V_355 , char * V_359 )
{
return F_129 ( F_201 ( V_355 ) -> V_197 , V_359 ) ;
}
...
char * V_359 )
{
return F_210 ( F_201 ( V_355 ) -> V_197 , V_359 ) ;
}
static T_4 F_211 ( struct V_354 * V_355 ,
const char * V_359 , T_5 V_159 )
{
return F_212 ( F_201 ( V_355 ) -> V_197 , V_359 , V_159 ) ;
}
static T_4 F_213 ( struct V_354 * V_355 , char * V_359 )
{
return F_214 ( F_201 ( V_355 ) -> V_197 , V_359 ) ;
}
static T_4 F_215 ( struct V_354 * V_355 ,
const char * V_359 , T_5 V_159 )
{
struct V_353 * V_334 = F_201 ( V_355 ) ;
struct V_333 * V_333 = F_203 ( V_334 -> V_356 . V_360 . V_361 ) ;
return F_216 ( V_334 -> V_197 , & V_333 -> V_2 -> V_169 , V_359 ,
V_159 ) ;
}
static T_4 F_217 ( struct V_354 * V_355 , char * V_359 )
{
return F_131 ( F_201 ( V_355 ) -> V_197 , V_359 ) ;
}
static T_4 F_218 ( struct V_354 * V_355 ,
const char * V_359 , T_5 V_159 )
{
return F_138 ( F_201 ( V_355 ) -> V_197 , V_359 , V_159 ) ;
}
static struct V_362 * F_219 ( struct V_362 * V_356 ,
const char * V_20 )
{
struct V_353 * V_334 ;
struct V_333 * V_333 ;
...
V_364 ++ ;
V_332 = F_220 ( V_364 , 0 , & V_365 ) ;
if ( V_332 )
return F_151 ( V_332 ) ;
V_333 = F_203 ( & V_356 -> V_360 ) ;
if ( V_365 >= V_366 )
return F_151 ( - V_367 ) ;
F_221 ( & V_333 -> V_28 ) ;
...
V_334 -> V_371 = V_365 ;
F_222 ( & V_333 -> V_28 ) ;
F_223 ( & V_334 -> V_356 , V_20 , & V_372 ) ;
return & V_334 -> V_356 ;
V_369:
F_222 ( & V_333 -> V_28 ) ;
return F_151 ( V_332 ) ;
}
static void F_224 ( struct V_362 * V_356 , struct V_354 * V_355 )
{
struct V_353 * V_358 ;
struct V_333 * V_333 ;
V_358 = F_201 ( V_355 ) ;
...
static void F_227 ( struct V_354 * V_355 )
{
struct V_333 * V_334 = F_203 ( V_355 ) ;
F_228 ( & V_334 -> V_357 ) ;
}
static T_4 F_229 ( struct V_354 * V_355 , char * V_359 )
{
struct V_333 * V_334 = F_203 ( V_355 ) ;
int V_373 ;
F_221 ( & V_334 -> V_28 ) ;
...
static T_4 F_230 ( struct V_354 * V_355 , const char * V_359 ,
T_5 V_159 )
{
struct V_333 * V_334 = F_203 ( V_355 ) ;
int V_332 ;
...
static T_4 F_233 ( struct V_354 * V_355 ,
const char * V_359 , T_5 V_159 )
{
struct V_333 * V_334 = F_203 ( V_355 ) ;
int V_332 ;
...
static void F_234 ( struct V_376 * V_335 )
{
struct V_333 * V_334 ;
V_334 = F_191 ( V_335 ) ;
F_144 ( V_334 -> V_2 ) ;
...
static struct V_376 * F_235 ( void )
{
struct V_333 * V_334 ;
struct V_306 V_363 ;
int V_33 ;
...
V_334 -> V_383 . V_371 = 0 ;
F_223 ( & V_334 -> V_357 . V_356 , L_73 , & V_384 ) ;
F_223 ( & V_334 -> V_383 . V_356 , L_91 , & V_372 ) ;
F_237 ( & V_334 -> V_383 . V_356 , & V_334 -> V_357 . V_356 ) ;
return & V_334 -> V_357 ;
V_382:
F_169 ( V_334 -> V_2 ) ;
V_378:
...
{
struct V_333 * V_334 = F_191 ( V_335 ) ;
