...
V_20 = F_28 ( V_3 -> V_8 , * V_28 , V_37 , V_39 ) ;
if ( V_20 <= 0 ) {
V_20 = V_33 ? V_33 : V_20 ;
goto V_36;
}
if ( F_29 ( V_19 + V_33 , V_37 , V_20 ) ) {
V_20 = V_33 ?
V_33 : - V_35 ;
goto V_36;
}
...
static T_1 F_32 ( struct V_25 * V_25 , const char T_3 * V_19 ,
T_4 V_31 , T_2 * V_28 )
{
T_4 V_32 , V_33 = 0 ;
struct V_1 * V_3 = V_25 -> V_27 ;
...
V_20 = F_34 ( V_3 -> V_8 , * V_28 , V_37 , V_39 ) ;
if ( V_20 <= 0 ) {
V_20 = V_33 ? V_33 : V_20 ;
goto V_36;
}
...
if ( F_47 ( V_3 ) )
return F_48 ( V_3 ) ;
V_3 -> V_16 = F_49 ( V_47 , V_8 -> V_16 ,
F_44 ( V_48 , V_3 -> V_2 ) , NULL ,
L_3 , V_3 -> V_2 ) ;
if ( F_47 ( V_3 -> V_16 ) ) {
V_20 = F_48 ( V_3 -> V_16 ) ;
V_3 -> V_16 = NULL ;
