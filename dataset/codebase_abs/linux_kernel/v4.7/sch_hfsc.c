...
unsigned int V_97 = V_2 -> V_85 -> V_98 . V_97 ;
F_50 ( V_2 -> V_85 ) ;
F_51 ( V_2 -> V_85 , V_62 , V_97 ) ;
}
static void
F_52 ( struct V_1 * V_2 )
{
...
static inline struct V_1 *
F_54 ( T_2 V_99 , struct V_91 * V_92 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_100 * V_101 ;
V_101 = F_56 ( & V_14 -> V_102 , V_99 ) ;
if ( V_101 == NULL )
return NULL ;
return F_57 ( V_101 , struct V_1 , V_103 ) ;
}
static void
F_58 ( struct V_1 * V_2 , struct V_42 * V_104 ,
T_1 V_15 )
{
F_28 ( V_104 , & V_2 -> V_59 ) ;
...
static void
F_59 ( struct V_1 * V_2 , struct V_42 * V_105 )
{
F_28 ( V_105 , & V_2 -> V_75 ) ;
...
static void
F_60 ( struct V_1 * V_2 , struct V_42 * V_106 ,
T_1 V_15 )
{
F_28 ( V_106 , & V_2 -> V_81 ) ;
...
static int
F_61 ( struct V_91 * V_92 , T_2 V_99 , T_2 V_107 ,
struct V_108 * * V_109 , unsigned long * V_110 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_1 * V_2 = (struct V_1 * ) * V_110 ;
struct V_1 * V_7 = NULL ;
struct V_108 * V_111 = V_109 [ V_112 ] ;
struct V_108 * V_113 [ V_114 + 1 ] ;
struct V_42 * V_104 = NULL , * V_105 = NULL , * V_106 = NULL ;
T_1 V_15 ;
int V_115 ;
if ( V_111 == NULL )
return - V_116 ;
V_115 = F_62 ( V_113 , V_114 , V_111 , V_117 ) ;
if ( V_115 < 0 )
return V_115 ;
if ( V_113 [ V_118 ] ) {
V_104 = F_63 ( V_113 [ V_118 ] ) ;
if ( V_104 -> V_47 == 0 && V_104 -> V_51 == 0 )
V_104 = NULL ;
}
if ( V_113 [ V_119 ] ) {
V_105 = F_63 ( V_113 [ V_119 ] ) ;
if ( V_105 -> V_47 == 0 && V_105 -> V_51 == 0 )
V_105 = NULL ;
}
if ( V_113 [ V_120 ] ) {
V_106 = F_63 ( V_113 [ V_120 ] ) ;
if ( V_106 -> V_47 == 0 && V_106 -> V_51 == 0 )
V_106 = NULL ;
}
if ( V_2 != NULL ) {
if ( V_107 ) {
if ( V_2 -> V_18 &&
V_2 -> V_18 -> V_103 . V_99 != V_107 )
return - V_116 ;
if ( V_2 -> V_18 == NULL && V_107 != V_121 )
return - V_116 ;
}
V_15 = F_34 () ;
if ( V_109 [ V_122 ] ) {
T_3 * V_123 = F_64 ( V_92 ) ;
V_115 = F_65 ( & V_2 -> V_124 , NULL ,
& V_2 -> V_125 ,
V_123 ,
V_109 [ V_122 ] ) ;
if ( V_115 )
...
if ( V_99 == 0 || F_68 ( V_99 ^ V_92 -> V_129 ) != 0 )
return - V_116 ;
if ( F_54 ( V_99 , V_92 ) )
return - V_126 ;
if ( V_104 == NULL && V_105 == NULL )
return - V_116 ;
V_2 = F_69 ( sizeof( struct V_1 ) , V_130 ) ;
if ( V_2 == NULL )
return - V_131 ;
if ( V_109 [ V_122 ] ) {
V_115 = F_70 ( & V_2 -> V_124 , NULL , & V_2 -> V_125 ,
F_64 ( V_92 ) ,
V_109 [ V_122 ] ) ;
if ( V_115 ) {
F_71 ( V_2 ) ;
...
V_2 -> V_26 = V_137 ;
F_66 ( V_92 ) ;
F_74 ( & V_14 -> V_102 , & V_2 -> V_103 ) ;
F_43 ( & V_2 -> V_138 , & V_7 -> V_136 ) ;
if ( V_7 -> V_24 == 0 )
F_49 ( V_92 , V_7 ) ;
F_52 ( V_7 ) ;
V_2 -> V_73 = V_7 -> V_71 ;
F_67 ( V_92 ) ;
F_75 ( V_92 , & V_14 -> V_102 ) ;
* V_110 = ( unsigned long ) V_2 ;
return 0 ;
}
static void
...
F_77 ( & V_2 -> V_139 ) ;
F_78 ( V_2 -> V_85 ) ;
F_79 ( & V_2 -> V_124 , & V_2 -> V_125 ) ;
if ( V_2 != & V_14 -> V_127 )
F_71 ( V_2 ) ;
}
static int
F_80 ( struct V_91 * V_92 , unsigned long V_110 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
if ( V_2 -> V_24 > 0 || V_2 -> V_140 > 0 || V_2 == & V_14 -> V_127 )
return - V_141 ;
F_66 ( V_92 ) ;
F_45 ( & V_2 -> V_138 ) ;
F_52 ( V_2 -> V_18 ) ;
F_49 ( V_92 , V_2 ) ;
F_81 ( & V_14 -> V_102 , & V_2 -> V_103 ) ;
F_82 ( -- V_2 -> V_132 == 0 ) ;
F_67 ( V_92 ) ;
return 0 ;
}
static struct V_1 *
F_83 ( struct V_93 * V_94 , struct V_91 * V_92 , int * V_142 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_1 * V_143 , * V_2 ;
struct V_144 V_145 ;
struct V_146 * V_147 ;
int V_148 ;
if ( F_68 ( V_94 -> V_149 ^ V_92 -> V_129 ) == 0 &&
( V_2 = F_54 ( V_94 -> V_149 , V_92 ) ) != NULL )
if ( V_2 -> V_24 == 0 )
return V_2 ;
* V_142 = V_150 | V_151 ;
V_143 = & V_14 -> V_127 ;
V_147 = F_84 ( V_14 -> V_127 . V_139 ) ;
while ( V_147 && ( V_148 = F_85 ( V_94 , V_147 , & V_145 , false ) ) >= 0 ) {
#ifdef F_86
switch ( V_148 ) {
case V_152 :
case V_153 :
...
#endif
V_2 = (struct V_1 * ) V_145 . V_156 ;
if ( ! V_2 ) {
V_2 = F_54 ( V_145 . V_99 , V_92 ) ;
if ( ! V_2 )
break;
...
if ( V_2 -> V_24 == 0 )
return V_2 ;
V_147 = F_84 ( V_2 -> V_139 ) ;
V_143 = V_2 ;
}
V_2 = F_54 ( F_87 ( F_68 ( V_92 -> V_129 ) , V_14 -> V_157 ) , V_92 ) ;
if ( V_2 == NULL || V_2 -> V_24 > 0 )
return NULL ;
return V_2 ;
}
static int
F_88 ( struct V_91 * V_92 , unsigned long V_110 , struct V_91 * V_158 ,
struct V_91 * * V_159 )
{
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
if ( V_2 -> V_24 > 0 )
return - V_116 ;
if ( V_158 == NULL ) {
V_158 = F_72 ( V_92 -> V_133 , & V_134 ,
V_2 -> V_103 . V_99 ) ;
if ( V_158 == NULL )
V_158 = & V_135 ;
}
* V_159 = F_89 ( V_92 , V_158 , & V_2 -> V_85 ) ;
return 0 ;
}
static struct V_91 *
F_90 ( struct V_91 * V_92 , unsigned long V_110 )
{
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
if ( V_2 -> V_24 == 0 )
return V_2 -> V_85 ;
...
static void
F_91 ( struct V_91 * V_92 , unsigned long V_110 )
{
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
if ( V_2 -> V_85 -> V_14 . V_86 == 0 ) {
F_41 ( V_2 , 0 , 0 ) ;
...
F_92 ( struct V_91 * V_92 , T_2 V_99 )
{
struct V_1 * V_2 = F_54 ( V_99 , V_92 ) ;
if ( V_2 != NULL )
V_2 -> V_132 ++ ;
return ( unsigned long ) V_2 ;
}
static void
F_93 ( struct V_91 * V_92 , unsigned long V_110 )
{
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
if ( -- V_2 -> V_132 == 0 )
F_76 ( V_92 , V_2 ) ;
...
static unsigned long
F_94 ( struct V_91 * V_92 , unsigned long V_7 , T_2 V_99 )
{
...
static void
F_95 ( struct V_91 * V_92 , unsigned long V_110 )
{
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
V_2 -> V_140 -- ;
}
static struct V_146 T_4 * *
F_96 ( struct V_91 * V_92 , unsigned long V_110 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
if ( V_2 == NULL )
...
static int
F_97 ( struct V_93 * V_94 , int V_160 , struct V_44 * V_43 )
{
struct V_42 V_161 ;
V_161 . V_47 = F_26 ( V_43 -> V_46 ) ;
V_161 . V_39 = F_27 ( V_43 -> V_40 ) ;
V_161 . V_51 = F_26 ( V_43 -> V_50 ) ;
if ( F_98 ( V_94 , V_160 , sizeof( V_161 ) , & V_161 ) )
goto V_162;
return V_94 -> V_62 ;
V_162:
return - 1 ;
...
static int
F_99 ( struct V_93 * V_94 , struct V_1 * V_2 )
{
if ( ( V_2 -> V_78 & V_88 ) &&
( F_97 ( V_94 , V_118 , & V_2 -> V_59 ) < 0 ) )
goto V_162;
if ( ( V_2 -> V_78 & V_87 ) &&
( F_97 ( V_94 , V_119 , & V_2 -> V_75 ) < 0 ) )
goto V_162;
if ( ( V_2 -> V_78 & V_79 ) &&
( F_97 ( V_94 , V_120 , & V_2 -> V_81 ) < 0 ) )
goto V_162;
return V_94 -> V_62 ;
V_162:
return - 1 ;
...
static int
F_100 ( struct V_91 * V_92 , unsigned long V_110 , struct V_93 * V_94 ,
struct V_163 * V_164 )
{
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
struct V_108 * V_165 ;
V_164 -> V_166 = V_2 -> V_18 ? V_2 -> V_18 -> V_103 . V_99 :
V_121 ;
V_164 -> V_167 = V_2 -> V_103 . V_99 ;
if ( V_2 -> V_24 == 0 )
V_164 -> V_168 = V_2 -> V_85 -> V_129 ;
V_165 = F_101 ( V_94 , V_112 ) ;
if ( V_165 == NULL )
goto V_162;
if ( F_99 ( V_94 , V_2 ) < 0 )
goto V_162;
return F_102 ( V_94 , V_165 ) ;
V_162:
F_103 ( V_94 , V_165 ) ;
return - V_169 ;
}
static int
F_104 ( struct V_91 * V_92 , unsigned long V_110 ,
struct V_170 * V_39 )
{
struct V_1 * V_2 = (struct V_1 * ) V_110 ;
struct V_171 V_172 ;
V_2 -> V_98 . V_97 = V_2 -> V_85 -> V_98 . V_97 ;
V_172 . V_24 = V_2 -> V_24 ;
V_172 . V_173 = V_2 -> V_68 ;
V_172 . V_174 = V_2 -> V_76 ;
V_172 . V_175 = V_2 -> V_60 ;
if ( F_105 ( V_39 , NULL , & V_2 -> V_124 ) < 0 ||
F_106 ( V_39 , & V_2 -> V_124 , & V_2 -> V_125 ) < 0 ||
F_107 ( V_39 , NULL , & V_2 -> V_98 , V_2 -> V_85 -> V_14 . V_86 ) < 0 )
return - 1 ;
return F_108 ( V_39 , & V_172 , sizeof( V_172 ) ) ;
}
static void
F_109 ( struct V_91 * V_92 , struct V_176 * V_110 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_1 * V_2 ;
unsigned int V_177 ;
if ( V_110 -> V_178 )
return;
for ( V_177 = 0 ; V_177 < V_14 -> V_102 . V_179 ; V_177 ++ ) {
F_110 (cl, &q->clhash.hash[i],
cl_common.hnode) {
if ( V_110 -> V_180 < V_110 -> V_181 ) {
V_110 -> V_180 ++ ;
continue;
}
if ( V_110 -> V_182 ( V_92 , ( unsigned long ) V_2 , V_110 ) < 0 ) {
V_110 -> V_178 = 1 ;
return;
}
V_110 -> V_180 ++ ;
...
if ( V_2 )
V_183 = V_2 -> V_10 ;
if ( V_14 -> V_127 . V_23 != 0 ) {
if ( V_183 == 0 || V_183 > V_14 -> V_127 . V_23 )
V_183 = V_14 -> V_127 . V_23 ;
}
F_112 ( V_183 == 0 ) ;
F_113 ( & V_14 -> V_184 , V_183 ) ;
}
static int
F_114 ( struct V_91 * V_92 , struct V_108 * V_111 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_185 * V_186 ;
int V_115 ;
if ( V_111 == NULL || F_115 ( V_111 ) < sizeof( * V_186 ) )
return - V_116 ;
V_186 = F_63 ( V_111 ) ;
V_14 -> V_157 = V_186 -> V_157 ;
V_115 = F_116 ( & V_14 -> V_102 ) ;
if ( V_115 < 0 )
return V_115 ;
V_14 -> V_6 = V_137 ;
F_73 ( & V_14 -> V_90 ) ;
V_14 -> V_127 . V_103 . V_99 = V_92 -> V_129 ;
V_14 -> V_127 . V_132 = 1 ;
V_14 -> V_127 . V_5 = V_14 ;
V_14 -> V_127 . V_85 = F_72 ( V_92 -> V_133 , & V_134 ,
V_92 -> V_129 ) ;
if ( V_14 -> V_127 . V_85 == NULL )
V_14 -> V_127 . V_85 = & V_135 ;
F_73 ( & V_14 -> V_127 . V_136 ) ;
V_14 -> V_127 . V_19 = V_137 ;
V_14 -> V_127 . V_26 = V_137 ;
F_74 ( & V_14 -> V_102 , & V_14 -> V_127 . V_103 ) ;
F_75 ( V_92 , & V_14 -> V_102 ) ;
F_117 ( & V_14 -> V_184 , V_92 ) ;
return 0 ;
}
static int
F_118 ( struct V_91 * V_92 , struct V_108 * V_111 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
struct V_185 * V_186 ;
if ( V_111 == NULL || F_115 ( V_111 ) < sizeof( * V_186 ) )
...
unsigned int V_177 ;
for ( V_177 = 0 ; V_177 < V_14 -> V_102 . V_179 ; V_177 ++ ) {
F_110 (cl, &q->clhash.hash[i], cl_common.hnode)
F_119 ( V_2 ) ;
}
V_14 -> V_6 = V_137 ;
F_73 ( & V_14 -> V_90 ) ;
...
static int
F_125 ( struct V_91 * V_92 , struct V_93 * V_94 )
{
struct V_13 * V_14 = F_55 ( V_92 ) ;
unsigned char * V_189 = F_126 ( V_94 ) ;
struct V_185 V_186 ;
V_186 . V_157 = V_14 -> V_157 ;
if ( F_98 ( V_94 , V_112 , sizeof( V_186 ) , & V_186 ) )
goto V_162;
return V_94 -> V_62 ;
V_162:
F_127 ( V_94 , V_189 ) ;
...
static int
F_128 ( struct V_93 * V_94 , struct V_91 * V_92 )
{
struct V_1 * V_2 ;
int V_190 ( V_115 ) ;
V_2 = F_83 ( V_94 , V_92 , & V_115 ) ;
if ( V_2 == NULL ) {
if ( V_115 & V_151 )
F_129 ( V_92 ) ;
F_130 ( V_94 ) ;
...
V_115 = F_131 ( V_94 , V_2 -> V_85 ) ;
if ( F_132 ( V_115 != V_150 ) ) {
if ( F_133 ( V_115 ) ) {
V_2 -> V_98 . V_191 ++ ;
F_129 ( V_92 ) ;
}
