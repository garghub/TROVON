...
struct V_50 * F_176 ( struct V_58 * V_53 ,
...
V_154 . V_279 = NULL ;
V_319 = V_82 -> V_211 ;
V_329 = F_228 ( V_37 , V_82 -> V_211 ) ;
if ( V_329 )
V_82 -> V_211 = V_329 ;
V_82 -> V_212 = V_330 ;
V_82 -> V_210 = V_86 & V_331 ;
V_82 -> V_311 = ( ( V_86 & V_332 ) ?
V_237 : V_97 ) ;
F_59 () ;
if ( V_82 -> V_79 ) {
V_51 = F_223 ( - V_188 ) ;
...
( F_84 ( V_82 -> V_57 ) ||
F_85 ( V_82 -> V_57 ) ) ) {
V_320 = F_229 ( V_37 , V_82 -> V_79 , false ) ;
if ( ! V_320 )
goto V_183;
...
if ( ! ( V_82 -> V_312 & V_334 ) ) {
if ( ! F_229 ( V_37 , V_82 -> V_79 , false ) )
goto V_183;
}
}
if ( V_82 -> V_211 ) {
V_320 = F_230 ( V_37 , V_82 -> V_211 ) ;
V_51 = F_223 ( - V_335 ) ;
if ( ! V_320 )
goto V_183;
if ( ! ( V_320 -> V_220 & V_336 ) || ! F_82 ( V_320 ) ) {
V_51 = F_223 ( - V_186 ) ;
goto V_183;
}
if ( F_182 ( V_82 -> V_57 ) ||
...
V_82 -> V_57 = V_82 -> V_79 ;
if ( ! V_82 -> V_57 )
V_82 -> V_57 = V_82 -> V_79 = F_232 ( V_339 ) ;
V_320 = V_37 -> V_230 ;
V_82 -> V_211 = V_330 ;
V_154 . type = V_315 ;
V_220 |= V_254 ;
...
if ( V_154 . type == V_315 ) {
if ( ! V_82 -> V_79 ) {
if ( V_154 . V_232 -> V_340 )
V_82 -> V_79 = V_154 . V_232 -> V_340 ;
else
V_82 -> V_79 = V_82 -> V_57 ;
}
V_320 = V_37 -> V_230 ;
...
static struct V_1 * F_235 ( struct V_1 * V_2 , T_1 V_206 )
{
return NULL ;
}
...
static void F_238 ( struct V_1 * V_2 , struct V_83 * V_84 ,
struct V_55 * V_56 )
{
}
...
struct V_1 * F_240 ( struct V_37 * V_37 , struct V_1 * V_341 )
{
struct V_50 * V_342 = (struct V_50 * ) V_341 ;
struct V_50 * V_60 ;
V_60 = F_177 ( & V_343 , NULL , 1 , V_344 , 0 ) ;
if ( V_60 ) {
struct V_1 * V_202 = & V_60 -> V_2 ;
V_202 -> V_345 = 1 ;
V_202 -> V_255 = V_346 ;
V_202 -> V_252 = V_347 ;
V_202 -> V_53 = V_342 -> V_2 . V_53 ;
if ( V_202 -> V_53 )
F_169 ( V_202 -> V_53 ) ;
V_60 -> V_249 = V_342 -> V_249 ;
V_60 -> V_250 = V_342 -> V_250 ;
V_60 -> V_119 = V_342 -> V_119 ;
V_60 -> V_52 = F_34 ( V_37 ) ;
V_60 -> V_124 = V_342 -> V_124 ;
V_60 -> V_248 = V_342 -> V_248 ;
V_60 -> V_62 = V_342 -> V_62 ;
V_60 -> V_126 = V_342 -> V_126 ;
F_178 ( & V_60 -> V_228 ) ;
F_241 ( V_202 ) ;
}
F_136 ( V_341 ) ;
...
struct V_50 * F_134 ( struct V_37 * V_37 , struct V_81 * V_348 ,
const struct V_83 * V_84 )
{
struct V_50 * V_60 = F_126 ( V_37 , V_348 ) ;
if ( F_92 ( V_60 ) )
return V_60 ;
if ( V_348 -> V_322 )
V_60 = (struct V_50 * ) F_242 ( V_37 , & V_60 -> V_2 ,
F_243 ( V_348 ) ,
V_84 , 0 ) ;
return V_60 ;
}
static int F_244 ( struct V_37 * V_37 , T_6 V_2 , T_6 V_28 , T_1 V_349 ,
struct V_81 * V_82 , struct V_55 * V_56 , T_1 V_350 ,
...
T_1 error ;
T_1 V_357 [ V_358 ] ;
V_356 = F_245 ( V_56 , V_350 , V_5 , V_351 , sizeof( * V_354 ) , V_220 ) ;
if ( ! V_356 )
return - V_359 ;
V_354 = F_246 ( V_356 ) ;
V_354 -> V_360 = V_361 ;
V_354 -> V_362 = 32 ;
V_354 -> V_363 = 0 ;
V_354 -> V_364 = V_82 -> V_210 ;
V_354 -> V_365 = V_349 ;
if ( F_247 ( V_56 , V_366 , V_349 ) )
goto V_367;
V_354 -> V_368 = V_60 -> V_248 ;
V_354 -> V_369 = V_97 ;
V_354 -> V_370 = V_371 ;
V_354 -> V_372 = ( V_60 -> V_124 & ~ 0xFFFF ) | V_373 ;
if ( V_60 -> V_124 & V_374 )
V_354 -> V_372 |= V_375 ;
if ( F_204 ( V_56 ) -> V_220 & V_276 )
V_354 -> V_372 |= V_376 ;
if ( F_248 ( V_56 , V_377 , V_2 ) )
goto V_367;
if ( V_28 ) {
V_354 -> V_363 = 32 ;
if ( F_248 ( V_56 , V_378 , V_28 ) )
goto V_367;
}
if ( V_60 -> V_2 . V_53 &&
F_247 ( V_56 , V_379 , V_60 -> V_2 . V_53 -> V_98 ) )
goto V_367;
#ifdef F_28
if ( V_60 -> V_2 . V_214 &&
F_247 ( V_56 , V_380 , V_60 -> V_2 . V_214 ) )
goto V_367;
#endif
if ( ! F_159 ( V_60 ) &&
V_82 -> V_79 != V_28 ) {
if ( F_248 ( V_56 , V_381 , V_82 -> V_79 ) )
goto V_367;
}
if ( V_60 -> V_126 &&
F_248 ( V_56 , V_382 , V_60 -> V_62 ) )
goto V_367;
...
memcpy ( V_357 , F_249 ( & V_60 -> V_2 ) , sizeof( V_357 ) ) ;
if ( V_60 -> V_119 && V_121 )
V_357 [ V_197 - 1 ] = V_60 -> V_119 ;
if ( F_250 ( V_56 , V_357 ) < 0 )
goto V_367;
if ( V_82 -> V_200 &&
F_247 ( V_56 , V_383 , V_82 -> V_200 ) )
goto V_367;
...
#endif
if ( F_247 ( V_56 , V_385 , V_56 -> V_53 -> V_98 ) )
goto V_367;
}
if ( F_253 ( V_56 , & V_60 -> V_2 , 0 , V_121 , error ) < 0 )
goto V_367;
F_254 ( V_56 , V_356 ) ;
return 0 ;
V_367:
...
static int F_256 ( struct V_55 * V_386 , struct V_355 * V_356 )
{
struct V_37 * V_37 = F_128 ( V_386 -> V_84 ) ;
struct V_353 * V_387 ;
...
struct V_55 * V_56 ;
T_1 V_349 = V_392 ;
V_259 = F_257 ( V_356 , sizeof( * V_387 ) , V_389 , V_390 , V_393 ) ;
if ( V_259 < 0 )
goto V_394;
V_387 = F_246 ( V_356 ) ;
V_56 = F_258 ( V_395 , V_31 ) ;
if ( ! V_56 ) {
V_259 = - V_267 ;
goto V_394;
}
...
F_261 ( V_56 , V_396 + sizeof( struct V_75 ) ) ;
V_28 = V_389 [ V_378 ] ? F_262 ( V_389 [ V_378 ] ) : 0 ;
V_2 = V_389 [ V_377 ] ? F_262 ( V_389 [ V_377 ] ) : 0 ;
V_391 = V_389 [ V_385 ] ? F_263 ( V_389 [ V_385 ] ) : 0 ;
V_88 = V_389 [ V_383 ] ? F_263 ( V_389 [ V_383 ] ) : 0 ;
memset ( & V_82 , 0 , sizeof( V_82 ) ) ;
V_82 . V_57 = V_2 ;
V_82 . V_79 = V_28 ;
V_82 . V_210 = V_387 -> V_364 ;
V_82 . V_211 = V_389 [ V_379 ] ? F_263 ( V_389 [ V_379 ] ) : 0 ;
V_82 . V_200 = V_88 ;
if ( F_233 ( V_37 , V_82 . V_211 ) )
V_82 . V_312 = V_397 | V_398 ;
if ( V_391 ) {
struct V_58 * V_53 ;
V_53 = F_264 ( V_37 , V_391 ) ;
if ( ! V_53 ) {
V_259 = - V_335 ;
goto V_399;
}
...
V_56 -> V_88 = V_88 ;
F_265 () ;
V_259 = F_266 ( V_56 , V_2 , V_28 , V_387 -> V_364 , V_53 ) ;
F_267 () ;
V_60 = F_105 ( V_56 ) ;
if ( V_259 == 0 && V_60 -> V_2 . error )
V_259 = - V_60 -> V_2 . error ;
} else {
V_60 = F_268 ( V_37 , & V_82 ) ;
V_259 = 0 ;
if ( F_92 ( V_60 ) )
V_259 = F_269 ( V_60 ) ;
}
...
V_349 = V_60 -> V_251 ;
V_259 = F_244 ( V_37 , V_2 , V_28 , V_349 , & V_82 , V_56 ,
F_270 ( V_386 ) . V_350 , V_356 -> V_401 ,
V_402 , 0 , 0 ) ;
if ( V_259 < 0 )
goto V_399;
V_259 = F_271 ( V_56 , V_37 , F_270 ( V_386 ) . V_350 ) ;
V_394:
return V_259 ;
V_399:
F_119 ( V_56 ) ;
...
void F_272 ( struct V_151 * V_152 )
{
F_36 ( F_35 ( V_152 -> V_53 ) ) ;
}
static int F_273 ( struct V_403 * V_404 , int V_405 ,
void T_14 * V_406 ,
...
static T_3 int F_275 ( struct V_37 * V_37 )
{
struct V_403 * V_410 ;
V_410 = V_411 ;
if ( ! F_276 ( V_37 , & V_412 ) ) {
V_410 = F_277 ( V_410 , sizeof( V_411 ) , V_31 ) ;
if ( ! V_410 )
goto V_413;
if ( V_37 -> V_414 != & V_415 )
V_410 [ 0 ] . V_416 = NULL ;
...
V_410 [ 0 ] . V_409 = V_37 ;
V_37 -> V_173 . V_417 = F_278 ( V_37 , L_19 , V_410 ) ;
if ( ! V_37 -> V_173 . V_417 )
goto V_418;
return 0 ;
V_418:
...
static T_4 void F_279 ( struct V_37 * V_37 )
{
struct V_403 * V_410 ;
V_410 = V_37 -> V_173 . V_417 -> V_419 ;
F_280 ( V_37 -> V_173 . V_417 ) ;
F_281 ( V_410 == V_411 ) ;
F_23 ( V_410 ) ;
}
static T_3 int F_282 ( struct V_37 * V_37 )
{
F_283 ( & V_37 -> V_173 . V_52 , 0 ) ;
F_283 ( & V_37 -> V_139 , 0 ) ;
F_284 ( & V_37 -> V_173 . V_420 ,
sizeof( V_37 -> V_173 . V_420 ) ) ;
return 0 ;
}
static int T_3 F_285 ( struct V_37 * V_37 )
{
struct V_421 * V_422 = F_286 ( sizeof( * V_422 ) , V_31 ) ;
if ( ! V_422 )
return - V_32 ;
F_287 ( V_422 ) ;
V_37 -> V_173 . V_174 = V_422 ;
return 0 ;
}
static void T_4 F_288 ( struct V_37 * V_37 )
{
struct V_421 * V_422 = V_37 -> V_173 . V_174 ;
...
int V_423 = 0 ;
int V_12 ;
V_71 = F_286 ( V_69 * sizeof( * V_71 ) , V_31 ) ;
if ( ! V_71 )
F_291 ( L_20 ) ;
F_292 ( V_71 , V_69 * sizeof( * V_71 ) ) ;
...
#ifdef F_28
V_27 = F_294 ( 256 * sizeof( struct V_27 ) , F_295 ( struct V_27 ) ) ;
if ( ! V_27 )
F_291 ( L_22 ) ;
#endif
V_16 . V_424 =
F_296 ( L_23 , sizeof( struct V_50 ) , 0 ,
V_425 | V_426 , NULL ) ;
...
F_303 () ;
#endif
F_304 ( V_430 , V_431 , F_256 , NULL , NULL ) ;
#ifdef F_305
F_32 ( & V_432 ) ;
#endif
F_32 ( & V_433 ) ;
