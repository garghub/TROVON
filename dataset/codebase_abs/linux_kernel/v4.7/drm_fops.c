...
F_30 ( & V_2 -> V_89 ) ;
if ( V_77 -> V_96 )
F_59 ( & V_77 -> V_26 -> V_97 , V_77 -> V_96 ) ;
F_32 ( & V_2 -> V_89 ) ;
if ( V_2 -> V_4 -> V_98 )
V_2 -> V_4 -> V_98 ( V_2 , V_77 ) ;
F_4 ( L_7 ,
F_19 ( V_42 ) ,
( long ) F_60 ( V_77 -> V_11 -> V_99 -> V_100 ) ,
V_2 -> V_14 ) ;
if ( V_77 -> V_11 -> V_26 )
F_42 ( V_2 , V_9 ) ;
if ( F_2 ( V_2 , V_101 ) )
...
F_30 ( & V_2 -> V_89 ) ;
if ( V_26 -> V_78 . V_79 ) {
if ( V_2 -> V_90 . V_78 == V_26 -> V_78 . V_79 )
V_2 -> V_90 . V_78 = NULL ;
V_26 -> V_78 . V_79 = NULL ;
V_26 -> V_78 . V_77 = NULL ;
F_65 ( & V_26 -> V_78 . V_102 ) ;
}
F_32 ( & V_2 -> V_89 ) ;
if ( V_77 -> V_11 -> V_26 == V_77 -> V_26 ) {
if ( V_2 -> V_4 -> V_103 )
V_2 -> V_4 -> V_103 ( V_2 , V_77 , true ) ;
F_18 ( & V_77 -> V_11 -> V_26 ) ;
}
}
if ( V_77 -> V_26 )
...
T_1 F_70 ( struct V_8 * V_9 , char T_2 * V_104 ,
T_3 V_105 , T_4 * V_106 )
{
struct V_21 * V_77 = V_9 -> V_45 ;
struct V_1 * V_2 = V_77 -> V_11 -> V_2 ;
T_1 V_3 ;
if ( ! F_71 ( V_107 , V_104 , V_105 ) )
return - V_108 ;
V_3 = F_72 ( & V_77 -> V_58 ) ;
if ( V_3 )
return V_3 ;
...
unsigned V_110 = V_81 -> V_109 -> V_110 ;
if ( V_110 > V_105 - V_3 ) {
V_113:
F_73 ( & V_2 -> V_84 ) ;
V_77 -> V_57 -= V_110 ;
...
if ( F_77 ( V_104 + V_3 , V_81 -> V_109 , V_110 ) ) {
if ( V_3 == 0 )
V_3 = - V_108 ;
goto V_113;
}
...
struct V_120 * V_81 )
{
if ( V_77 -> V_57 < V_81 -> V_110 )
return - V_27 ;
V_77 -> V_57 -= V_81 -> V_110 ;
V_119 -> V_109 = V_81 ;
F_33 ( & V_119 -> V_85 , & V_77 -> V_54 ) ;
V_119 -> V_77 = V_77 ;
V_119 -> V_87 = ( void ( * ) ( struct V_80 * ) ) F_41 ;
return 0 ;
}
...
F_47 ( & V_2 -> V_84 , V_83 ) ;
if ( V_119 -> V_77 ) {
V_119 -> V_77 -> V_57 += V_119 -> V_109 -> V_110 ;
F_49 ( & V_119 -> V_85 ) ;
}
F_50 ( & V_2 -> V_84 , V_83 ) ;
V_119 -> V_87 ( V_119 ) ;
