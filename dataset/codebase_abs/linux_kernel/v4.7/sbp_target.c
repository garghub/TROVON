...
static void F_143 ( struct V_205 * V_206 )
{
return;
}
...
return 0 ;
V_208 = F_151 ( & V_53 -> V_17 -> V_22 ) ;
V_209 = F_154 ( V_212 ) + 4 + V_208 ;
if ( V_53 -> V_213 != - 1 )
V_209 ++ ;
V_94 = F_155 ( ( V_209 + 4 ) , sizeof( T_3 ) , V_39 ) ;
if ( ! V_94 )
return - V_40 ;
V_94 [ V_153 ++ ] = V_209 << 16 ;
if ( V_53 -> V_213 != - 1 )
...
static T_7 F_158 ( const char * V_226 , T_1 * V_227 )
{
const char * V_228 ;
char V_229 , V_230 ;
int V_231 = 0 , V_34 ;
...
static T_7 F_160 ( char * V_235 , T_4 V_236 , T_1 V_227 )
{
return snprintf ( V_235 , V_236 , L_1 , V_227 ) ;
}
static int F_161 ( struct V_205 * V_237 , const char * V_226 )
{
T_1 V_1 = 0 ;
if ( F_158 ( V_226 , & V_1 ) < 0 )
return - V_238 ;
return 0 ;
}
static int F_162 (
...
return F_18 ( - V_238 ) ;
if ( F_165 ( V_226 + 5 , 10 , & V_243 ) || V_243 > V_244 )
return F_18 ( - V_238 ) ;
if ( V_53 -> V_17 ) {
F_17 ( L_60 ) ;
return F_18 ( - V_245 ) ;
...
V_4 = F_166 ( V_227 , & V_17 -> V_22 , V_247 ) ;
if ( V_4 < 0 )
goto V_248;
return & V_17 -> V_22 ;
V_248:
...
V_53 -> V_1 = V_1 ;
F_160 ( V_53 -> V_203 , V_232 , V_1 ) ;
return & V_53 -> V_242 ;
}
static void F_170 ( struct V_239 * V_227 )
{
struct V_52 * V_53 =
F_70 ( V_227 , struct V_52 , V_242 ) ;
F_25 ( V_53 ) ;
}
static T_7 F_171 ( struct V_251 * V_252 , char * V_253 )
{
return sprintf ( V_253 , L_63 , V_254 ) ;
}
static T_7 F_172 ( struct V_251 * V_252 , char * V_253 )
{
struct V_35 * V_22 = F_173 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
if ( V_53 -> V_213 == - 1 )
...
static T_7 F_174 ( struct V_251 * V_252 ,
...
static T_7 F_175 ( struct V_251 * V_252 , char * V_253 )
{
struct V_35 * V_22 = F_173 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
...
static T_7 F_177 ( struct V_251 * V_252 ,
char * V_253 )
{
struct V_35 * V_22 = F_178 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
struct V_52 * V_53 = V_17 -> V_53 ;
...
static T_7 F_180 ( struct V_251 * V_252 ,
char * V_253 )
{
struct V_35 * V_22 = F_178 ( V_252 ) ;
struct V_16 * V_17 = F_70 ( V_22 , struct V_16 , V_22 ) ;
