...
V_267 = 2 ;
if ( V_9 -> V_109 == V_123 ) {
V_189 = F_126 ( V_189 , V_9 -> V_269 ) ;
V_191 = F_126 ( V_191 , V_9 -> V_270 ) ;
}
...
if ( V_2 -> V_271 ) {
F_130 ( & V_2 -> V_271 -> V_272 ) ;
F_129 ( V_52 , V_2 -> V_271 ) ;
}
V_2 -> V_271 = V_249 ;
for ( V_78 = 0 ; V_273 [ V_78 ] . type != 0 ; V_78 ++ ) {
V_265 = & V_273 [ V_78 ] ;
...
int V_78 ;
V_227 V_283 = 0 ;
struct V_284 * V_95 = & V_52 -> V_95 ;
struct V_121 V_285 = { 0 } ;
if ( ! V_195 -> V_286 ) {
struct V_121 V_287 = { 0 , 0 , 800 , 600 } ;
F_114 ( V_9 , 1 , & V_287 ) ;
return 0 ;
}
V_282 = V_195 -> V_286 * sizeof( struct V_121 ) ;
V_232 = F_135 ( V_195 -> V_286 , sizeof( struct V_121 ) ,
V_140 ) ;
if ( F_10 ( ! V_232 ) )
return - V_20 ;
V_281 = ( void T_9 * ) ( unsigned long ) V_195 -> V_232 ;
V_31 = F_136 ( V_232 , V_281 , V_282 ) ;
if ( F_10 ( V_31 != 0 ) ) {
F_11 ( L_27 ) ;
V_31 = - V_288 ;
goto V_289;
}
for ( V_78 = 0 ; V_78 < V_195 -> V_286 ; ++ V_78 ) {
...
if ( V_232 [ V_78 ] . V_37 + V_232 [ V_78 ] . V_91 > V_285 . V_91 )
V_285 . V_91 = V_232 [ V_78 ] . V_37 + V_232 [ V_78 ] . V_91 ;
if ( V_232 [ V_78 ] . V_38 + V_232 [ V_78 ] . V_92 > V_285 . V_92 )
V_285 . V_92 = V_232 [ V_78 ] . V_38 + V_232 [ V_78 ] . V_92 ;
V_283 += ( V_227 ) V_232 [ V_78 ] . V_91 * ( V_227 ) V_232 [ V_78 ] . V_92 ;
}
if ( V_9 -> V_109 == V_123 ) {
V_227 V_290 = V_285 . V_91 * V_285 . V_92 * 4 ;
V_227 V_291 = V_283 * 4 ;
if ( V_290 > V_9 -> V_228 ) {
F_11 ( L_29 ) ;
V_31 = - V_19 ;
...
if ( V_6 -> V_218 -> V_300 != & V_98 -> V_34 )
continue;
V_296 [ V_298 ++ ] = F_24 ( V_6 ) ;
}
for ( V_299 = 0 ; V_299 < V_298 ; V_299 ++ ) {
struct V_1 * V_235 = V_296 [ V_299 ] ;
T_5 V_301 = V_235 -> V_6 . V_37 ;
T_5 V_302 = V_235 -> V_6 . V_38 ;
T_5 V_303 = V_235 -> V_6 . V_249 . V_257 ;
T_5 V_304 = V_235 -> V_6 . V_249 . V_261 ;
const struct V_104 * V_305 = V_105 ;
const struct V_121 * V_306 = V_122 ;
V_295 -> V_235 = V_235 ;
if ( V_295 -> V_307 > 0 ) {
V_295 -> V_15 = F_9 ( V_9 ,
V_295 -> V_307 ) ;
...
memset ( V_295 -> V_15 , 0 , V_295 -> V_307 ) ;
}
V_295 -> V_308 = 0 ;
for ( V_78 = 0 ; V_78 < V_106 ; V_78 ++ , V_305 += V_151 ,
V_306 += V_151 ) {
T_5 V_309 ;
T_5 V_310 ;
if ( V_105 ) {
V_295 -> V_311 = ( T_5 ) V_305 -> V_112 ;
V_295 -> V_312 = ( T_5 ) V_305 -> y1 ;
V_295 -> V_313 = ( T_5 ) V_305 -> V_113 + V_292 -
V_301 ;
V_295 -> V_314 = ( T_5 ) V_305 -> V_114 + V_293 -
V_302 ;
} else {
V_295 -> V_311 = V_306 -> V_37 ;
V_295 -> V_312 = V_306 -> V_38 ;
V_295 -> V_313 = V_295 -> V_311 + V_306 -> V_91 +
V_292 - V_301 ;
V_295 -> V_314 = V_295 -> V_312 + V_306 -> V_92 +
V_293 - V_302 ;
}
V_295 -> V_315 = V_295 -> V_311 + V_292 - V_301 ;
V_295 -> V_316 = V_295 -> V_312 + V_293 - V_302 ;
if ( V_295 -> V_315 >= V_303 ||
V_295 -> V_316 >= V_304 ||
V_295 -> V_313 <= 0 || V_295 -> V_314 <= 0 )
continue;
V_295 -> V_313 = F_138 ( T_5 , V_295 -> V_313 ,
V_303 ) ;
V_295 -> V_314 = F_138 ( T_5 , V_295 -> V_314 ,
V_304 ) ;
V_309 = F_138 ( T_5 , V_295 -> V_315 , 0 ) ;
V_310 = F_138 ( T_5 , V_295 -> V_316 , 0 ) ;
V_295 -> V_315 -= V_309 ;
V_295 -> V_316 -= V_310 ;
V_295 -> V_311 -= V_309 ;
V_295 -> V_312 -= V_310 ;
...
T_3 V_49 ;
int V_31 ;
V_31 = F_143 ( V_48 , V_9 , & V_323 ,
V_48 ? & V_49 : NULL ) ;
if ( V_152 )
F_144 ( & V_152 -> V_34 , V_323 ) ;
if ( V_48 )
F_145 ( V_9 , F_27 ( V_48 ) ,
V_31 , V_120 , V_323 ,
V_49 ) ;
...
V_74 = & V_15 -> V_329 . V_74 ;
V_15 -> V_73 . V_22 = V_331 ;
V_15 -> V_73 . V_82 = sizeof( V_15 -> V_329 ) ;
V_15 -> V_329 . V_10 . V_180 = V_153 -> V_22 ;
V_15 -> V_329 . V_10 . V_80 = 0 ;
V_15 -> V_329 . V_10 . V_81 = 0 ;
...
{
F_37 ( & V_9 -> V_336 ) ;
F_160 ( ! V_9 -> V_338 && V_9 -> V_339 ) ;
if ( ! V_2 -> V_337 && V_2 -> V_279 ) {
V_9 -> V_339 = V_118 ;
V_2 -> V_337 = true ;
V_9 -> V_338 ++ ;
}
