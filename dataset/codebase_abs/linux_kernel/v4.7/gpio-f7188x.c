...
static int F_16 ( struct V_10 * V_11 , unsigned V_12 )
{
int V_13 ;
struct V_14 * V_15 = F_13 ( V_11 ) ;
struct V_16 * V_17 = V_15 -> V_18 -> V_17 ;
...
return V_13 ;
F_9 ( V_17 -> V_20 , V_21 ) ;
V_24 = F_1 ( V_17 -> V_20 , F_17 ( V_15 -> V_22 ) ) ;
if ( V_23 )
V_24 |= F_15 ( V_12 ) ;
else
V_24 &= ~ F_15 ( V_12 ) ;
F_5 ( V_17 -> V_20 , F_17 ( V_15 -> V_22 ) , V_24 ) ;
V_19 = F_1 ( V_17 -> V_20 , F_14 ( V_15 -> V_22 ) ) ;
V_19 |= F_15 ( V_12 ) ;
F_5 ( V_17 -> V_20 , F_14 ( V_15 -> V_22 ) , V_19 ) ;
F_10 ( V_17 -> V_20 ) ;
...
static void F_20 ( struct V_10 * V_11 , unsigned V_12 , int V_23 )
{
int V_13 ;
struct V_14 * V_15 = F_13 ( V_11 ) ;
struct V_16 * V_17 = V_15 -> V_18 -> V_17 ;
...
return V_13 ;
F_9 ( V_17 -> V_20 , V_21 ) ;
V_18 = F_1 ( V_17 -> V_20 , F_22 ( V_15 -> V_22 ) ) ;
if ( V_26 == V_27 )
V_18 &= ~ F_15 ( V_12 ) ;
else
V_18 |= F_15 ( V_12 ) ;
F_5 ( V_17 -> V_20 , F_22 ( V_15 -> V_22 ) , V_18 ) ;
F_10 ( V_17 -> V_20 ) ;
return 0 ;
}
...
int V_13 ;
int V_32 ;
struct V_16 * V_17 = F_24 ( & V_31 -> V_33 ) ;
struct V_34 * V_18 ;
V_18 = F_25 ( & V_31 -> V_33 , sizeof( * V_18 ) , V_35 ) ;
if ( ! V_18 )
return - V_36 ;
switch ( V_17 -> type ) {
case V_37 :
...
V_15 -> V_18 = V_18 ;
V_13 = F_28 ( & V_31 -> V_33 , & V_15 -> V_11 , V_15 ) ;
if ( V_13 ) {
F_29 ( & V_31 -> V_33 ,
L_2 ,
V_32 , V_13 ) ;
