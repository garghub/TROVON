...
F_24 ( V_13 , V_19 -> V_34 ) ;
F_24 ( V_13 , V_19 -> V_55 ) ;
V_51 = F_25 ( V_12 , 0x404154 , 0xffffffff , 0x00000000 ) ;
V_19 -> V_56 ( V_2 ) ;
V_19 -> V_57 ( V_2 ) ;
V_19 -> V_28 ( V_2 ) ;
V_19 -> V_58 ( V_13 ) ;
...
F_19 ( V_13 ) ;
F_26 ( V_13 , V_19 -> V_59 ) ;
F_4 ( V_12 , 0x404154 , V_51 ) ;
F_27 ( V_13 , V_19 -> V_60 ) ;
F_23 ( V_12 -> V_52 , 1 ) ;
}
int
F_28 ( struct V_27 * V_13 )
{
const struct V_18 * V_19 = V_13 -> V_20 -> V_19 ;
struct V_61 * V_16 = & V_13 -> V_14 . V_15 . V_16 ;
struct V_11 * V_12 = V_16 -> V_12 ;
struct V_62 * V_63 ;
struct V_1 V_2 ;
int V_64 , V_42 ;
T_3 V_9 ;
V_64 = F_29 ( V_12 , V_65 , 0x80000 + V_13 -> V_3 ,
0x1000 , true , & V_63 ) ;
if ( V_64 ) {
F_30 ( V_16 , L_1 , V_64 ) ;
return V_64 ;
...
V_9 = F_31 ( V_63 ) ;
F_32 ( V_63 ) ;
F_33 ( V_63 , 0x0200 , F_20 ( V_9 + 0x1000 ) ) ;
F_33 ( V_63 , 0x0204 , F_21 ( V_9 + 0x1000 ) ) ;
F_33 ( V_63 , 0x0208 , 0xffffffff ) ;
F_33 ( V_63 , 0x020c , 0x000000ff ) ;
F_33 ( V_63 , 0x1000 , 0x00000000 ) ;
F_33 ( V_63 , 0x1004 , 0x00000001 | ( V_9 + 0x2000 ) >> 8 ) ;
for ( V_42 = 0 ; V_42 < F_34 ( V_63 ) / 4096 ; V_42 ++ ) {
T_3 V_9 = ( ( F_31 ( V_63 ) + ( V_42 * 4096 ) ) >> 8 ) | 1 ;
F_33 ( V_63 , 0x2000 + ( V_42 * 8 ) , F_20 ( V_9 ) ) ;
F_33 ( V_63 , 0x2004 + ( V_42 * 8 ) , F_21 ( V_9 ) ) ;
}
F_33 ( V_63 , 0x0210 , 0x00080004 ) ;
F_33 ( V_63 , 0x0214 , 0x00000000 ) ;
F_35 ( V_63 ) ;
...
V_19 -> main( V_13 , & V_2 ) ;
F_25 ( V_12 , 0x409b04 , 0x80000000 , 0x00000000 ) ;
...
V_13 -> V_6 = F_37 ( V_13 -> V_3 , V_71 ) ;
if ( V_13 -> V_6 ) {
F_32 ( V_63 ) ;
for ( V_42 = 0 ; V_42 < V_13 -> V_3 ; V_42 += 4 )
V_13 -> V_6 [ V_42 / 4 ] = F_38 ( V_63 , 0x80000 + V_42 ) ;
F_35 ( V_63 ) ;
V_64 = 0 ;
} else {
V_64 = - V_72 ;
