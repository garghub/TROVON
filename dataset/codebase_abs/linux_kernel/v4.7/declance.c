...
* F_9 ( V_27 , V_129 [ 3 ] , V_4 -> type ) = 0 ;
F_50 (ha, dev) {
V_144 = F_51 ( V_146 , V_143 -> V_147 ) ;
V_144 = V_144 >> 26 ;
* F_9 ( V_27 , V_129 [ V_144 >> 4 ] , V_4 -> type ) |= 1 << ( V_144 & 0xf ) ;
}
}
...
F_54 ( & V_4 -> V_137 , V_148 + 4 * V_149 / 100 ) ;
F_27 ( V_26 ) ;
return;
}
F_8 ( V_26 ) ;
