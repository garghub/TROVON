...
struct V_44 * V_230 ;
int V_161 = - V_205 ;
V_22 = ( unsigned long ) V_207 -> V_231 ;
if ( V_22 == V_232 )
return - V_107 ;
V_227 = ( V_22 == V_233 ) ? 1 : V_234 ;
if ( V_22 == V_235 ) {
V_217 = F_115 ( V_200 , 1 ) ;
V_216 = F_115 ( V_200 , 0 ) ;
if ( ! V_217 || ! V_216 )
...
if ( ! V_214 ) {
if ( V_48 -> V_237 -> V_238 &&
V_48 -> V_237 -> V_238 -> V_215 &&
V_48 -> V_237 -> V_238 -> V_213 ) {
F_14 ( & V_48 -> V_16 ,
L_24 ) ;
V_214 = V_48 -> V_237 -> V_238 -> V_215 ;
V_212 = V_48 -> V_237 -> V_238 -> V_213 ;
} else {
F_25 ( & V_48 -> V_16 ,
L_25 ) ;
return - V_148 ;
...
V_209 = (struct V_208 * ) V_212 ;
break;
case V_242 :
if ( V_228 < sizeof( struct V_210 ) )
goto V_239;
V_211 = (struct V_210 * ) V_212 ;
break;
case V_243 :
break;
case V_244 :
...
V_217 = F_115 ( V_200 , ( V_226 = V_225 ) ) ;
V_216 = V_48 ;
} else {
if ( V_48 -> V_237 -> V_19 . V_247 != 3 ) {
F_14 ( & V_48 -> V_16 , L_33 ) ;
return - V_107 ;
} else {
F_116 ( & V_48 -> V_16 , L_34 ) ;
V_229 = 1 ;
V_216 = V_217 = V_48 ;
goto V_248;
}
...
V_216 = F_115 ( V_200 , V_209 -> V_249 ) ;
V_217 = F_115 ( V_200 , ( V_226 = V_209 -> V_250 ) ) ;
}
if ( ! V_216 || ! V_217 ) {
F_14 ( & V_48 -> V_16 , L_35 ) ;
return - V_107 ;
...
F_14 ( & V_48 -> V_16 , L_36 ) ;
if ( V_216 == V_217 ) {
F_116 ( & V_48 -> V_16 , L_37 ) ;
V_229 = 1 ;
V_22 |= V_251 ;
if ( V_217 -> V_237 -> V_19 . V_247 != 3 ) {
F_25 ( & V_48 -> V_16 , L_38 ) ;
return - V_148 ;
}
V_248:
...
struct V_218 * V_252 ;
V_252 = & V_217 -> V_237 -> V_238 [ V_26 ] . V_19 ;
if ( F_117 ( V_252 ) )
V_219 = V_252 ;
else if ( F_118 ( V_252 ) )
V_221 = V_252 ;
...
V_236:
if ( V_217 -> V_237 -> V_19 . V_254
!= V_255 ) {
if ( V_216 -> V_237 -> V_19 . V_254
== V_255 ) {
F_14 ( & V_48 -> V_16 ,
L_39 ) ;
F_120 ( V_216 , V_217 ) ;
...
if ( ! V_229 && V_48 != V_216 )
return - V_107 ;
if ( ! V_229 && F_121 ( V_217 ) ) {
F_14 ( & V_48 -> V_16 , L_40 ) ;
return - V_256 ;
}
if ( V_217 -> V_237 -> V_19 . V_247 < 2 ||
V_216 -> V_237 -> V_19 . V_247 == 0 )
return - V_148 ;
V_219 = & V_216 -> V_237 -> V_238 [ 0 ] . V_19 ;
V_220 = & V_217 -> V_237 -> V_238 [ 0 ] . V_19 ;
V_221 = & V_217 -> V_237 -> V_238 [ 1 ] . V_19 ;
if ( ! F_122 ( V_220 ) ) {
F_14 ( & V_48 -> V_16 ,
L_41 ) ;
F_120 ( V_220 , V_221 ) ;
...
V_253:
F_14 ( & V_48 -> V_16 , L_42 ) ;
V_1 = F_123 ( sizeof( struct V_1 ) , V_9 ) ;
if ( V_1 == NULL )
goto V_257;
V_2 = F_6 ( V_1 ) ;
if ( V_2 < 0 ) {
...
V_1 -> V_201 = V_201 ;
V_1 -> V_94 = V_227 ;
F_125 ( & V_1 -> V_101 , F_50 ) ;
F_126 ( & V_1 -> V_85 ) ;
F_127 ( & V_1 -> V_34 ) ;
F_127 ( & V_1 -> V_69 ) ;
F_128 ( & V_1 -> V_5 ) ;
V_1 -> V_258 = F_129 ( V_200 , V_220 -> V_259 ) ;
V_1 -> V_260 = F_130 ( V_220 ) ;
if ( V_1 -> V_260 )
V_1 -> V_261 = V_220 -> V_261 ;
F_131 ( & V_1 -> V_7 ) ;
V_1 -> V_7 . V_262 = & V_263 ;
F_132 ( & V_1 -> V_124 ) ;
V_1 -> V_22 = V_22 ;
V_12 = F_113 ( V_200 , V_222 , V_9 , & V_1 -> V_264 ) ;
if ( ! V_12 )
goto V_265;
V_1 -> V_266 = V_12 ;
if ( F_112 ( V_1 ) < 0 )
...
for ( V_26 = 0 ; V_26 < V_31 ; V_26 ++ ) {
struct V_28 * V_272 = & ( V_1 -> V_29 [ V_26 ] ) ;
V_272 -> V_37 = F_133 ( 0 , V_9 ) ;
if ( V_272 -> V_37 == NULL )
goto V_273;
if ( F_130 ( V_221 ) )
F_134 ( V_272 -> V_37 , V_200 ,
F_137 ( V_200 , V_221 -> V_259 ) ,
NULL , V_1 -> V_127 , F_48 , V_272 , V_221 -> V_261 ) ;
else
F_135 ( V_272 -> V_37 , V_200 ,
F_138 ( V_200 , V_221 -> V_259 ) ,
NULL , V_1 -> V_127 , F_48 , V_272 ) ;
V_272 -> V_37 -> V_270 |= V_271 ;
if ( V_22 & V_274 )
V_272 -> V_37 -> V_270 |= V_275 ;
V_272 -> V_98 = V_1 ;
}
F_139 ( V_48 , V_1 ) ;
V_26 = F_140 ( & V_48 -> V_16 , & V_276 ) ;
if ( V_26 < 0 )
goto V_273;
if ( V_211 ) {
V_1 -> V_50 = F_141 ( V_211 -> V_277 - 4 , V_9 ) ;
if ( ! V_1 -> V_50 )
goto V_278;
V_1 -> V_51 = V_211 -> V_277 - 4 ;
memcpy ( V_1 -> V_50 , ( T_4 * ) & V_211 -> V_279 ,
V_211 -> V_277 - 4 ) ;
V_1 -> V_52 = V_211 -> V_280 ;
V_26 = F_140 ( & V_48 -> V_16 , & V_281 ) ;
if ( V_26 < 0 ) {
F_67 ( V_1 -> V_50 ) ;
V_1 -> V_50 = NULL ;
V_1 -> V_51 = 0 ;
...
V_26 = F_140 ( & V_48 -> V_16 ,
& V_282 ) ;
if ( V_26 < 0 ) {
F_142 ( & V_48 -> V_16 , & V_281 ) ;
F_67 ( V_1 -> V_50 ) ;
V_1 -> V_50 = NULL ;
V_1 -> V_51 = 0 ;
goto V_278;
...
F_143 ( V_200 , V_219 -> V_259 ) ,
V_1 -> V_266 , V_222 , F_31 , V_1 ,
V_219 -> V_261 ? V_219 -> V_261 : 16 ) ;
V_1 -> V_121 -> V_270 |= V_271 ;
V_1 -> V_121 -> V_39 = V_1 -> V_264 ;
F_144 ( & V_48 -> V_16 , L_44 , V_2 ) ;
V_1 -> line . V_152 = F_104 ( 9600 ) ;
V_1 -> line . V_192 = 8 ;
F_107 ( V_1 , & V_1 -> line ) ;
F_145 ( & V_283 , V_217 , V_1 ) ;
F_139 ( V_217 , V_1 ) ;
F_146 ( V_216 ) ;
V_230 = F_147 ( & V_1 -> V_7 , V_284 , V_2 ,
& V_216 -> V_16 ) ;
if ( F_148 ( V_230 ) ) {
V_161 = F_149 ( V_230 ) ;
goto V_285;
...
if ( V_22 & V_286 ) {
F_150 ( V_200 , F_129 ( V_200 , V_220 -> V_259 ) ) ;
F_150 ( V_200 , F_138 ( V_200 , V_221 -> V_259 ) ) ;
}
return 0 ;
V_285:
if ( V_1 -> V_50 ) {
...
F_142 ( & V_1 -> V_15 -> V_16 , & V_276 ) ;
V_273:
F_139 ( V_48 , NULL ) ;
for ( V_26 = 0 ; V_26 < V_31 ; V_26 ++ )
F_151 ( V_1 -> V_29 [ V_26 ] . V_37 ) ;
V_269:
for ( V_26 = 0 ; V_26 < V_227 ; V_26 ++ )
F_151 ( V_1 -> V_93 [ V_26 ] ) ;
F_111 ( V_1 ) ;
...
F_108 ( V_1 ) ;
V_267:
F_110 ( V_200 , V_222 , V_1 -> V_266 , V_1 -> V_264 ) ;
V_265:
F_8 ( V_1 ) ;
F_67 ( V_1 ) ;
V_257:
...
F_151 ( V_1 -> V_93 [ V_26 ] ) ;
F_108 ( V_1 ) ;
F_110 ( V_200 , V_1 -> V_222 , V_1 -> V_266 , V_1 -> V_264 ) ;
F_111 ( V_1 ) ;
if ( ! V_1 -> V_229 )
F_159 ( & V_283 , V_48 == V_1 -> V_15 ?
V_1 -> V_43 : V_1 -> V_15 ) ;
F_55 ( & V_1 -> V_7 ) ;
}
static int F_160 ( struct V_47 * V_48 , T_5 V_287 )
{
struct V_1 * V_1 = F_28 ( V_48 ) ;
int V_288 ;
F_61 ( & V_1 -> V_34 ) ;
...
static int F_164 ( struct V_47 * V_48 )
{
struct V_1 * V_1 = F_28 ( V_48 ) ;
if ( F_163 ( & V_1 -> V_7 ) )
F_34 ( & V_1 -> V_7 , false ) ;
...
V_284 -> type = V_294 ,
V_284 -> V_295 = V_296 ,
V_284 -> V_33 = V_297 | V_298 ;
V_284 -> V_299 = V_300 ;
V_284 -> V_299 . V_184 = V_301 | V_195 | V_302 |
V_303 | V_196 ;
F_167 ( V_284 , & V_304 ) ;
V_14 = F_168 ( V_284 ) ;
if ( V_14 ) {
...
F_172 (KERN_INFO KBUILD_MODNAME L_47 DRIVER_DESC L_48 ) ;
return 0 ;
}
