...
V_65 = F_38 ( & V_19 -> V_70 , struct V_15 , V_69 ) ;
V_17 = & V_65 -> V_18 ;
if ( V_17 -> V_204 && ( V_17 -> V_116 & V_205 ) )
V_17 -> V_204 ( V_17 -> V_206 ) ;
}
static void F_85 ( unsigned long V_207 )
{
struct V_6 * V_19 = (struct V_6 * ) V_207 ;
struct V_15 * V_65 ;
T_2 V_208 ;
...
static T_8 F_91 ( int V_213 , void * V_214 )
{
struct V_1 * V_2 = (struct V_1 * ) V_214 ;
struct V_6 * V_19 ;
T_2 V_215 , V_21 , V_216 ;
T_2 V_217 , V_218 ;
int V_119 , V_120 = V_219 ;
do {
V_215 = F_17 ( V_2 , V_220 ) ;
V_21 = F_17 ( V_2 , V_221 ) ;
V_216 = V_21 & V_215 ;
F_20 ( V_2 -> V_14 . V_11 ,
L_51 ,
V_35 , V_21 , V_215 , V_216 ) ;
if ( ! V_216 )
break;
for ( V_119 = 0 ; V_119 < V_2 -> V_14 . V_222 ; V_119 ++ ) {
if ( ! ( ( 1 << V_119 ) & V_216 ) )
continue;
V_19 = & V_2 -> V_9 [ V_119 ] ;
V_217 = F_14 ( V_19 , V_223 ) ;
V_218 = F_14 ( V_19 , V_199 ) ;
V_19 -> V_21 = V_218 & V_217 ;
F_20 ( V_2 -> V_14 . V_11 ,
L_52 ,
V_35 , V_119 , V_217 , V_218 ) ;
F_20 ( F_4 ( & V_19 -> V_9 ) ,
L_2 ,
V_35 ,
F_14 ( V_19 , V_46 ) ,
...
static void F_93 ( struct V_7 * V_9 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
...
F_16 ( V_2 , V_230 , V_19 -> V_30 ) ;
F_97 ( V_22 , & V_19 -> V_21 ) ;
F_30 ( & V_19 -> V_68 , V_116 ) ;
return 0 ;
}
static int F_98 ( struct V_7 * V_9 )
{
struct V_15 * V_65 , * V_187 ;
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_1 * V_2 = F_5 ( V_19 -> V_9 . V_10 ) ;
...
static void F_102 ( struct V_7 * V_9 )
{
struct V_6 * V_19 = F_2 ( V_9 ) ;
struct V_1 * V_2 = F_5 ( V_9 -> V_10 ) ;
struct V_15 * V_65 , * V_187 ;
...
F_39 ( & V_65 -> V_80 ) ;
F_103 ( V_2 -> V_72 , V_65 , V_65 -> V_18 . V_37 ) ;
}
return;
}
static int F_104 ( struct V_10 * V_11 )
{
struct V_234 * V_235 = F_105 ( V_11 ) ;
struct V_1 * V_2 = F_106 ( V_235 ) ;
struct V_7 * V_9 , * V_236 ;
...
F_81 (chan, _chan, &atxdmac->dma.channels, device_node) {
struct V_6 * V_19 = F_2 ( V_9 ) ;
V_19 -> V_238 = F_14 ( V_19 , V_46 ) ;
if ( F_7 ( V_19 ) ) {
if ( ! F_9 ( V_19 ) )
F_95 ( V_9 ) ;
V_19 -> V_239 = F_14 ( V_19 , V_223 ) ;
V_19 -> V_240 = F_14 ( V_19 , V_39 ) ;
V_19 -> V_241 = F_14 ( V_19 , V_51 ) ;
}
}
V_2 -> V_242 = F_17 ( V_2 , V_220 ) ;
F_15 ( V_2 ) ;
F_108 ( V_2 -> V_243 ) ;
return 0 ;
}
...
F_16 ( V_2 , V_62 , V_2 -> V_242 ) ;
F_16 ( V_2 , V_63 , V_2 -> V_244 ) ;
F_81 (chan, _chan, &atxdmac->dma.channels, device_node) {
V_19 = F_2 ( V_9 ) ;
F_23 ( V_19 , V_46 , V_19 -> V_238 ) ;
if ( F_7 ( V_19 ) ) {
if ( F_9 ( V_19 ) )
F_96 ( V_9 ) ;
F_23 ( V_19 , V_39 , V_19 -> V_240 ) ;
F_23 ( V_19 , V_51 , V_19 -> V_241 ) ;
F_23 ( V_19 , V_59 , V_19 -> V_239 ) ;
F_24 () ;
F_16 ( V_2 , V_63 , V_19 -> V_30 ) ;
}
}
...
static int F_111 ( struct V_234 * V_235 )
{
struct V_245 * V_246 ;
struct V_1 * V_2 ;
int V_213 , V_152 , V_247 , V_119 , V_120 ;
void T_1 * V_248 ;
T_2 V_34 ;
V_246 = F_112 ( V_235 , V_249 , 0 ) ;
if ( ! V_246 )
return - V_25 ;
V_213 = F_113 ( V_235 , 0 ) ;
if ( V_213 < 0 )
return V_213 ;
V_248 = F_114 ( & V_235 -> V_11 , V_246 ) ;
if ( F_115 ( V_248 ) )
return F_116 ( V_248 ) ;
V_34 = F_117 ( V_248 + V_250 ) ;
V_247 = F_118 ( V_34 ) ;
if ( V_247 > V_251 ) {
F_44 ( & V_235 -> V_11 , L_59 ,
V_247 ) ;
return - V_25 ;
}
V_152 = sizeof( * V_2 ) ;
V_152 += V_247 * sizeof( struct V_6 ) ;
V_2 = F_119 ( & V_235 -> V_11 , V_152 , V_252 ) ;
if ( ! V_2 ) {
F_44 ( & V_235 -> V_11 , L_60 ) ;
return - V_253 ;
}
V_2 -> V_4 = V_248 ;
V_2 -> V_213 = V_213 ;
V_2 -> V_243 = F_120 ( & V_235 -> V_11 , L_61 ) ;
if ( F_115 ( V_2 -> V_243 ) ) {
F_44 ( & V_235 -> V_11 , L_62 ) ;
return F_116 ( V_2 -> V_243 ) ;
}
V_120 = F_121 ( V_2 -> V_213 , F_91 , 0 , L_63 , V_2 ) ;
if ( V_120 ) {
F_44 ( & V_235 -> V_11 , L_64 ) ;
return V_120 ;
}
V_120 = F_110 ( V_2 -> V_243 ) ;
if ( V_120 ) {
F_44 ( & V_235 -> V_11 , L_65 ) ;
goto V_254;
}
V_2 -> V_72 =
F_122 ( F_123 ( & V_235 -> V_11 ) , & V_235 -> V_11 ,
sizeof( struct V_15 ) , 4 , 0 ) ;
if ( ! V_2 -> V_72 ) {
F_44 ( & V_235 -> V_11 , L_66 ) ;
V_120 = - V_253 ;
goto V_255;
}
F_124 ( V_256 , V_2 -> V_14 . V_257 ) ;
F_124 ( V_258 , V_2 -> V_14 . V_257 ) ;
F_124 ( V_259 , V_2 -> V_14 . V_257 ) ;
F_124 ( V_260 , V_2 -> V_14 . V_257 ) ;
F_124 ( V_261 , V_2 -> V_14 . V_257 ) ;
F_124 ( V_262 , V_2 -> V_14 . V_257 ) ;
F_124 ( V_263 , V_2 -> V_14 . V_257 ) ;
V_2 -> V_14 . V_11 = & V_235 -> V_11 ;
V_2 -> V_14 . V_264 = F_99 ;
V_2 -> V_14 . V_265 = F_102 ;
V_2 -> V_14 . V_266 = F_77 ;
V_2 -> V_14 . V_267 = F_93 ;
V_2 -> V_14 . V_268 = F_65 ;
V_2 -> V_14 . V_269 = F_72 ;
...
V_2 -> V_14 . V_280 = V_279 ;
V_2 -> V_14 . V_281 = F_125 ( V_94 ) | F_125 ( V_104 ) ;
...
F_28 ( & V_19 -> V_9 . V_285 ,
& V_2 -> V_14 . V_284 ) ;
V_19 -> V_286 = F_1 ( V_2 , V_119 ) ;
V_19 -> V_30 = 1 << V_119 ;
F_126 ( & V_19 -> V_68 ) ;
F_33 ( & V_19 -> V_70 ) ;
F_33 ( & V_19 -> V_78 ) ;
F_127 ( & V_19 -> V_224 , F_85 ,
( unsigned long ) V_19 ) ;
while ( F_14 ( V_19 , V_199 ) )
F_18 () ;
}
F_128 ( V_235 , V_2 ) ;
V_120 = F_129 ( & V_2 -> V_14 ) ;
if ( V_120 ) {
F_44 ( & V_235 -> V_11 , L_67 ) ;
goto V_255;
}
V_120 = F_130 ( V_235 -> V_11 . V_287 ,
F_43 , V_2 ) ;
if ( V_120 ) {
F_44 ( & V_235 -> V_11 , L_68 ) ;
goto V_288;
}
F_131 ( & V_235 -> V_11 , L_69 ,
V_247 , V_2 -> V_4 ) ;
return 0 ;
V_288:
F_132 ( & V_2 -> V_14 ) ;
...
F_108 ( V_2 -> V_243 ) ;
V_254:
F_133 ( V_2 -> V_213 , V_2 -> V_14 . V_11 ) ;
return V_120 ;
}
static int F_134 ( struct V_234 * V_235 )
{
struct V_1 * V_2 = (struct V_1 * ) F_106 ( V_235 ) ;
int V_119 ;
F_15 ( V_2 ) ;
F_135 ( V_235 -> V_11 . V_287 ) ;
F_132 ( & V_2 -> V_14 ) ;
F_108 ( V_2 -> V_243 ) ;
F_133 ( V_2 -> V_213 , V_2 -> V_14 . V_11 ) ;
for ( V_119 = 0 ; V_119 < V_2 -> V_14 . V_222 ; V_119 ++ ) {
