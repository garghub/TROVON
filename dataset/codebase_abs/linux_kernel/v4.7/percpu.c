...
T_2 V_207 ;
struct V_17 * * V_208 ;
int V_126 , V_33 , V_78 , V_197 ;
snprintf ( V_205 , sizeof( V_205 ) , L_21 , V_30 >> 10 ) ;
V_123 = F_124 ( V_144 , 0 , V_30 , NULL ) ;
if ( F_129 ( V_123 ) )
return F_130 ( V_123 ) ;
F_46 ( V_123 -> V_121 != 1 ) ;
F_46 ( V_123 -> V_127 [ 0 ] . V_122 != F_108 () ) ;
V_206 = V_123 -> V_143 >> V_25 ;
...
V_204 . V_59 = V_210 ;
V_204 . V_9 = F_108 () * V_123 -> V_143 ;
F_134 ( & V_204 , V_30 ) ;
for ( V_126 = 0 ; V_126 < F_108 () ; V_126 ++ ) {
unsigned long V_211 =
( unsigned long ) V_204 . V_3 + V_126 * V_123 -> V_143 ;
for ( V_33 = 0 ; V_33 < V_206 ; V_33 ++ )
V_202 ( V_211 + ( V_33 << V_25 ) ) ;
V_197 = F_135 ( V_211 , & V_208 [ V_126 * V_206 ] ,
V_206 ) ;
if ( V_197 < 0 )
F_136 ( L_23 , V_197 ) ;
memcpy ( ( void * ) V_211 , V_200 , V_123 -> V_109 ) ;
}
F_72 ( L_24 ,
V_206 , V_205 , V_204 . V_3 , V_123 -> V_109 ,
V_123 -> V_144 , V_123 -> V_145 ) ;
V_197 = F_113 ( V_123 , V_204 . V_3 ) ;
goto V_212;
V_209:
while ( -- V_78 >= 0 )
...
if ( V_197 < 0 )
F_136 ( L_25 ) ;
V_214 = ( unsigned long ) V_113 - ( unsigned long ) V_111 ;
F_67 (cpu)
