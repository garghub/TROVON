...
static int F_22 ( struct V_12 * V_13 , enum V_37 * V_85 )
{
struct V_1 * V_2 = V_13 -> V_14 ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
int V_8 ;
...
static int F_23 ( struct V_12 * V_13 , T_5 * V_91 )
{
struct V_15 * V_16 = & V_13 -> V_17 ;
...
static int F_27 ( struct V_12 * V_13 , T_5 * V_27 )
{
struct V_15 * V_16 = & V_13 -> V_17 ;
...
static int F_35 ( struct V_12 * V_13 , T_3 V_109 , T_5 V_110 , int V_108 )
{
struct V_1 * V_2 = V_13 -> V_14 ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
int V_8 ;
...
static int F_38 ( struct V_112 * V_113 , T_4 V_114 )
{
struct V_1 * V_2 = F_39 ( V_113 ) ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
int V_8 ;
F_14 ( & V_2 -> V_7 , L_8 ) ;
...
static struct V_12 * F_40 ( struct V_1 * V_2 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
F_14 ( & V_2 -> V_7 , L_8 ) ;
return & V_7 -> V_13 ;
}
static struct V_115 * F_41 ( struct V_1 * V_2 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
F_14 ( & V_2 -> V_7 , L_8 ) ;
return V_7 -> V_113 -> V_9 [ 0 ] ;
}
static int F_42 ( void * V_116 , const void * V_117 ,
...
V_8 = F_43 ( V_2 -> V_9 , V_122 , 2 ) ;
if ( V_8 != 2 ) {
F_44 ( & V_2 -> V_7 , L_14 , V_8 ) ;
if ( V_8 >= 0 )
V_8 = - V_126 ;
return V_8 ;
}
...
static int F_45 ( void * V_116 , const void * V_127 , T_1 V_128 )
{
struct V_1 * V_2 = V_116 ;
int V_8 ;
...
V_8 = F_43 ( V_2 -> V_9 , V_122 , 1 ) ;
if ( V_8 != 1 ) {
F_44 ( & V_2 -> V_7 , L_15 , V_8 ) ;
if ( V_8 >= 0 )
V_8 = - V_126 ;
return V_8 ;
}
...
static int F_46 ( void * V_116 , const void * V_3 ,
...
V_7 -> V_36 = true ;
F_50 ( & V_7 -> V_35 , F_28 ) ;
V_7 -> V_10 = F_51 ( & V_2 -> V_7 , & V_135 , V_2 ,
& V_149 ) ;
if ( F_52 ( V_7 -> V_10 ) ) {
V_8 = F_53 ( V_7 -> V_10 ) ;
goto V_157;
...
if ( V_8 )
goto V_158;
V_7 -> V_113 = F_54 ( V_2 -> V_9 , & V_2 -> V_7 , 1 , 0 , 0 ,
F_38 , NULL ) ;
if ( ! V_7 -> V_113 ) {
V_8 = - V_156 ;
goto V_158;
