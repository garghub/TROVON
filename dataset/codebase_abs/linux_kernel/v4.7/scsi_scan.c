...
static void F_42 ( struct V_74 * V_28 )
{
...
int F_44 ( const struct V_74 * V_28 )
{
return V_28 -> type == & V_80 ;
}
static struct V_21 * F_45 ( struct V_74 * V_29 ,
int V_46 , T_2 V_45 )
{
...
static void F_47 ( struct V_82 * V_82 )
{
struct V_21 * V_22
= F_48 ( V_82 , struct V_21 , V_83 ) ;
if ( V_22 -> V_76 != V_84 ) {
F_49 ( & V_22 -> V_28 ) ;
F_50 ( & V_22 -> V_28 ) ;
}
...
static struct V_21 * F_53 ( struct V_74 * V_29 ,
int V_46 , T_2 V_45 )
{
struct V_27 * V_5 = F_19 ( V_29 ) ;
...
F_55 ( & V_22 -> V_83 ) ;
V_28 -> V_29 = F_25 ( V_29 ) ;
F_56 ( V_28 , L_4 , V_5 -> V_90 , V_46 , V_45 ) ;
V_28 -> V_91 = & V_92 ;
V_28 -> type = & V_80 ;
V_22 -> V_45 = V_45 ;
V_22 -> V_46 = V_46 ;
...
V_13 -> V_194 = 1 ;
F_77 ( & V_13 -> V_58 ) ;
if ( V_13 -> V_42 -> V_67 -> V_195 ) {
V_26 = V_13 -> V_42 -> V_67 -> V_195 ( V_13 ) ;
if ( V_26 ) {
if ( V_26 != - V_70 ) {
F_16 ( V_89 , V_13 ,
L_21 ) ;
...
if ( V_13 -> V_95 >= V_151 )
F_78 ( V_13 ) ;
V_13 -> V_196 = V_13 -> V_197 ;
if ( ! V_135 && F_79 ( V_13 ) != 0 )
return V_138 ;
return V_198 ;
}
static unsigned char * F_80 ( unsigned char * V_199 , unsigned char * V_200 ,
unsigned V_201 , unsigned V_202 )
{
unsigned V_203 = 0 , V_204 ;
for ( V_204 = 0 ; V_204 + V_201 < V_202 && V_204 + V_201 < V_200 [ 4 ] + 5 ; V_204 ++ ) {
if ( V_200 [ V_204 + V_201 ] > ' ' ) {
V_199 [ V_204 ] = V_200 [ V_204 + V_201 ] ;
V_203 = V_204 + 1 ;
} else {
V_199 [ V_204 ] = ' ' ;
}
...
struct V_12 * V_13 ;
unsigned char * V_14 ;
int V_108 , V_209 = V_138 , V_107 = 256 ;
struct V_27 * V_5 = F_19 ( V_22 -> V_28 . V_29 ) ;
V_13 = F_82 ( V_22 , V_23 ) ;
if ( V_13 ) {
if ( V_208 != V_210 || ! F_83 ( V_13 ) ) {
F_63 ( 3 , F_16 ( V_10 , V_13 ,
L_22 ,
F_84 ( & V_13 -> V_58 ) ) ) ;
if ( V_206 )
...
V_209 = F_69 ( V_13 , V_14 , & V_108 , V_5 -> V_218 ) ;
if ( V_209 == V_198 ) {
if ( V_108 & V_219 ) {
V_13 -> V_149 = 0 ;
F_15 ( V_13 , V_14 ) ;
...
if ( V_108 & V_226 )
V_220 = F_67 ( 5U , V_220 ) ;
if ( V_95 < V_151 && ! ( V_108 & V_227 ) )
V_220 = F_67 ( 8U , V_220 ) ;
if ( ! ( V_108 & V_228 ) )
V_220 = F_67 ( 256U , V_220 ) ;
for ( V_23 = 1 ; V_23 < V_220 ; ++ V_23 )
if ( ( F_81 ( V_22 , V_23 , NULL , NULL , V_208 ,
NULL ) != V_198 ) &&
! V_221 )
return;
}
...
V_230 = ( 511 + 1 ) * sizeof( struct V_233 ) ;
V_99:
V_235 = F_3 ( V_230 , V_4 |
( V_13 -> V_42 -> V_211 ? V_212 : 0 ) ) ;
if ( ! V_235 ) {
F_9 ( V_72 , V_73 ) ;
goto V_37;
}
...
if ( F_91 ( V_235 -> V_233 ) +
sizeof( struct V_233 ) > V_230 ) {
V_230 = F_91 ( V_235 -> V_233 ) +
sizeof( struct V_233 ) ;
F_14 ( V_235 ) ;
goto V_99;
}
V_230 = F_91 ( V_235 -> V_233 ) ;
V_231 = ( V_230 / sizeof( struct V_233 ) ) ;
F_63 ( 3 , F_16 ( V_10 , V_13 ,
L_35 ) ) ;
for ( V_234 = & V_235 [ 1 ] ; V_234 <= & V_235 [ V_231 ] ; V_234 ++ ) {
V_23 = F_92 ( V_234 ) ;
if ( V_23 > V_13 -> V_42 -> V_223 ) {
F_16 ( V_144 , V_13 ,
L_36
L_37 , V_23 ) ;
} else {
...
{
struct V_12 * V_13 = F_94 ( - V_241 ) ;
struct V_74 * V_29 = & V_5 -> V_242 ;
struct V_21 * V_22 ;
if ( strncmp ( V_243 , L_41 , 4 ) == 0 )
return F_94 ( - V_241 ) ;
V_22 = F_53 ( V_29 , V_46 , V_45 ) ;
if ( ! V_22 )
return F_94 ( - V_244 ) ;
F_95 ( V_22 ) ;
F_96 ( & V_5 -> V_245 ) ;
...
{
struct V_12 * V_13 =
F_93 ( V_42 , V_46 , V_246 , V_23 , NULL ) ;
if ( F_103 ( V_13 ) )
return F_104 ( V_13 ) ;
F_85 ( V_13 ) ;
return 0 ;
...
F_107 ( V_28 ) ;
F_78 ( V_13 ) ;
if ( V_13 -> V_247 && V_13 -> V_247 -> V_208 )
V_13 -> V_247 -> V_208 ( V_13 ) ;
if ( V_28 -> V_248 && F_108 ( V_28 -> V_248 -> V_249 ) ) {
struct V_250 * V_251 = F_109 ( V_28 -> V_248 ) ;
if ( V_251 -> V_208 )
V_251 -> V_208 ( V_28 ) ;
F_110 ( V_28 -> V_248 -> V_249 ) ;
}
F_111 ( V_28 ) ;
}
static void F_112 ( struct V_74 * V_29 , unsigned int V_46 ,
unsigned int V_45 , T_1 V_23 , enum V_207 V_208 )
{
struct V_27 * V_5 = F_19 ( V_29 ) ;
int V_108 = 0 ;
int V_209 ;
...
F_95 ( V_22 ) ;
if ( V_23 != V_253 ) {
F_81 ( V_22 , V_23 , NULL , NULL , V_208 , NULL ) ;
goto V_254;
}
V_209 = F_81 ( V_22 , 0 , & V_108 , NULL , V_208 , NULL ) ;
if ( V_209 == V_198 || V_209 == V_216 ) {
if ( F_89 ( V_22 , V_108 , V_208 ) != 0 )
F_87 ( V_22 , V_108 ,
V_22 -> V_95 , V_208 ) ;
}
V_254:
...
return;
if ( V_208 != V_255 &&
strncmp ( V_243 , L_42 , 6 ) == 0 )
return;
F_96 ( & V_5 -> V_245 ) ;
if ( ! V_5 -> V_218 )
F_1 () ;
if ( F_97 ( V_5 ) && F_98 ( V_5 ) == 0 ) {
F_112 ( V_29 , V_46 , V_45 , V_23 , V_208 ) ;
F_99 ( V_5 ) ;
}
F_100 ( & V_5 -> V_245 ) ;
}
static void F_114 ( struct V_27 * V_5 , unsigned int V_46 ,
unsigned int V_45 , T_1 V_23 ,
enum V_207 V_208 )
{
T_2 V_256 ;
if ( V_45 == V_253 )
for ( V_45 = 0 ; V_45 < V_5 -> V_257 ; ++ V_45 ) {
if ( V_5 -> V_258 )
V_256 = V_5 -> V_257 - V_45 - 1 ;
else
V_256 = V_45 ;
F_112 ( & V_5 -> V_242 , V_46 ,
V_256 , V_23 , V_208 ) ;
}
else
F_112 ( & V_5 -> V_242 , V_46 ,
...
L_43 ,
V_73 , V_46 , V_45 , V_23 ) ) ;
if ( ( ( V_46 != V_253 ) && ( V_46 > V_5 -> V_259 ) ) ||
( ( V_45 != V_253 ) && ( V_45 >= V_5 -> V_257 ) ) ||
( ( V_23 != V_253 ) && ( V_23 >= V_5 -> V_223 ) ) )
return - V_260 ;
F_96 ( & V_5 -> V_245 ) ;
if ( ! V_5 -> V_218 )
F_1 () ;
if ( F_97 ( V_5 ) && F_98 ( V_5 ) == 0 ) {
if ( V_46 == V_253 )
for ( V_46 = 0 ; V_46 <= V_5 -> V_259 ;
V_46 ++ )
F_114 ( V_5 , V_46 , V_45 , V_23 ,
V_208 ) ;
else
F_114 ( V_5 , V_46 , V_45 , V_23 , V_208 ) ;
F_99 ( V_5 ) ;
}
F_100 ( & V_5 -> V_245 ) ;
return 0 ;
...
struct V_1 * V_2 ;
unsigned long V_75 ;
if ( strncmp ( V_243 , L_44 , 4 ) == 0 )
return NULL ;
if ( V_5 -> V_218 ) {
F_68 ( V_263 , V_5 , L_45 , V_73 ) ;
return NULL ;
}
V_2 = F_3 ( sizeof( * V_2 ) , V_4 ) ;
if ( ! V_2 )
...
if ( V_5 -> V_67 -> V_268 )
V_5 -> V_67 -> V_268 ( V_5 ) ;
while ( ! V_5 -> V_67 -> V_265 ( V_5 , V_267 - V_266 ) )
F_4 ( 10 ) ;
} else {
F_115 ( V_5 , V_253 , V_253 ,
V_253 , 0 ) ;
}
}
static void F_124 ( void * V_269 , T_3 V_270 )
{
...
if ( ! F_97 ( V_5 ) )
goto V_37;
V_22 = F_53 ( & V_5 -> V_242 , 0 , V_5 -> V_252 ) ;
if ( ! V_22 )
goto V_37;
V_13 = F_18 ( V_22 , 0 , NULL ) ;
if ( V_13 )
...
{
F_37 ( V_13 -> V_45 != V_13 -> V_42 -> V_252 ) ;
F_35 ( V_13 ) ;
}
