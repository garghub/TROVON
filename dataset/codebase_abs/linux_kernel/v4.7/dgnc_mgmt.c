...
long F_6 ( struct V_2 * V_2 , unsigned int V_10 , unsigned long V_11 )
{
unsigned long V_3 ;
...
V_15 . V_16 = V_17 ;
sprintf ( V_15 . V_18 , L_1 , V_19 ) ;
F_4 ( & V_5 , V_3 ) ;
if ( F_7 ( V_12 , & V_15 , sizeof( V_15 ) ) )
return - V_20 ;
break;
}
case V_21 :
...
T_2 V_49 = 0 ;
T_2 V_50 = 0 ;
if ( F_8 ( & V_47 , V_12 , sizeof( V_47 ) ) )
return - V_20 ;
V_49 = V_47 . V_49 ;
V_50 = V_47 . V_50 ;
if ( V_49 >= V_17 )
return - V_25 ;
if ( V_50 >= V_27 [ V_49 ] -> V_42 )
return - V_25 ;
