...
T_1 V_133 = 0 ;
T_4 V_134 = 0 ;
struct V_124 * V_125 = V_97 -> V_125 ;
enum V_135 V_136 = V_97 -> V_136 ;
T_1 V_137 = V_97 -> V_137 ;
T_1 * V_138 = & V_97 -> V_138 ;
T_4 V_139 = V_97 -> V_139 ;
for ( V_134 = 0 ; V_134 < V_140 ; V_134 ++ ) {
if ( V_55 == V_9 -> V_60 [ V_134 ] )
break;
}
F_16 ( & V_2 -> V_52 ) ;
F_21 ( V_74 , L_11 , V_63 , V_136 ) ;
if ( V_138 != NULL )
V_133 = * V_138 ;
switch ( V_136 ) {
case V_141 :
...
break;
case V_145 :
V_2 -> V_146 [ V_134 ] . V_147 = V_133 ;
F_38 ( V_55 , V_125 -> V_148 , V_137 ) ;
V_42 = 0 ;
break;
case V_149 :
case V_150 :
...
if ( V_188 & 0xfff ) {
for ( V_134 = 0 ; V_134 < F_4 ( V_19 ) ; V_134 ++ ) {
if ( V_188 & F_55 ( V_134 ) ) {
V_2 -> V_192 = V_19 [ V_134 ] . V_70 ;
V_189 = true ;
break;
}
}
...
for ( V_134 = 0 ; V_134 < F_4 ( V_194 ) ; V_134 ++ ) {
if ( ( V_188 >> 12 ) & F_55 ( V_134 ) ) {
V_2 -> V_192 = V_194 [ V_134 ] ;
V_189 = true ;
break;
}
}
