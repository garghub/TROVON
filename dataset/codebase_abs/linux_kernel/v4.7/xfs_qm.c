...
F_111 ( V_29 , V_170 ) ;
#ifdef F_112
V_169 = F_113 ( V_2 , V_126 ) ;
F_114 ( V_169 , sizeof( V_171 ) ) ;
...
F_115 ( V_2 , V_174 , V_56 + V_169 , type , V_175 ,
L_4 ) ;
V_174 -> V_36 = type ;
V_174 -> V_176 = 0 ;
V_174 -> V_177 = 0 ;
...
error = 0 ;
while ( V_182 -- ) {
error = F_119 ( V_2 , NULL , V_2 -> V_184 ,
F_120 ( V_2 , V_181 ) ,
...
return 0 ;
V_189 = F_122 ( V_196 * sizeof( * V_189 ) , V_117 ) ;
V_191 = 0 ;
V_192 = F_123 ( V_2 , V_2 -> V_197 -> V_198 ) ;
do {
T_2 V_199 ;
V_190 = V_196 ;
V_199 = F_124 ( V_187 ) ;
error = F_125 ( V_187 , V_191 , V_192 - V_191 ,
V_189 , & V_190 , 0 ) ;
F_49 ( V_187 , V_199 ) ;
if ( error )
break;
...
F_128 ( V_4 ) ;
F_129 ( & V_4 -> V_20 . V_177 , 1 ) ;
V_4 -> V_210 ++ ;
if ( V_206 ) {
F_129 ( & V_4 -> V_20 . V_176 , V_206 ) ;
V_4 -> V_211 += V_206 ;
}
if ( V_207 ) {
F_129 ( & V_4 -> V_20 . V_178 , V_207 ) ;
V_4 -> V_212 += V_207 ;
}
if ( V_4 -> V_20 . V_21 ) {
F_130 ( V_2 , V_4 ) ;
...
int error ;
ASSERT ( F_134 ( V_55 ) ) ;
V_216 = F_135 ( V_55 , V_218 ) ;
if ( ! ( V_216 -> V_219 & V_220 ) ) {
if ( ( error = F_136 ( NULL , V_55 , V_218 ) ) )
return error ;
}
V_207 = 0 ;
V_217 = V_216 -> V_221 / ( T_2 ) sizeof( V_222 ) ;
for ( V_215 = 0 ; V_215 < V_217 ; V_215 ++ )
V_207 += F_137 ( F_138 ( V_216 , V_215 ) ) ;
* V_214 = ( T_16 ) V_207 ;
return 0 ;
}
STATIC int
...
ASSERT ( V_55 -> V_229 == 0 ) ;
if ( F_134 ( V_55 ) ) {
error = F_133 ( V_55 , & V_207 ) ;
if ( error )
goto V_230;
}
V_206 = ( T_16 ) V_55 -> V_66 . V_195 - V_207 ;
if ( F_43 ( V_2 ) ) {
error = F_127 ( V_55 , V_55 -> V_66 . V_67 ,
V_43 , V_206 , V_207 ) ;
if ( error )
goto V_230;
}
if ( F_44 ( V_2 ) ) {
error = F_127 ( V_55 , V_55 -> V_66 . V_71 ,
V_45 , V_206 , V_207 ) ;
if ( error )
goto V_230;
}
if ( F_45 ( V_2 ) ) {
error = F_127 ( V_55 , F_46 ( V_55 ) ,
V_47 , V_206 , V_207 ) ;
if ( error )
goto V_230;
}
...
T_3 * V_2 )
{
int V_69 , V_234 , error , V_235 ;
T_11 V_236 ;
T_20 V_237 ;
T_2 V_41 ;
F_142 ( V_183 ) ;
struct V_62 * V_238 = V_2 -> V_8 -> V_52 ;
struct V_62 * V_239 = V_2 -> V_8 -> V_53 ;
struct V_62 * V_240 = V_2 -> V_8 -> V_54 ;
V_234 = V_241 ;
V_237 = 1 ;
V_236 = 0 ;
V_41 = 0 ;
ASSERT ( V_238 || V_239 || V_240 ) ;
ASSERT ( F_38 ( V_2 ) ) ;
F_143 ( V_2 , L_5 ) ;
if ( V_238 ) {
error = F_121 ( V_2 , V_238 , V_42 ,
& V_183 ) ;
if ( error )
goto V_242;
V_41 |= V_243 ;
...
if ( F_43 ( V_2 ) ) {
error = F_1 ( V_2 , V_43 , F_140 ,
& V_183 ) ;
}
if ( F_44 ( V_2 ) ) {
V_235 = F_1 ( V_2 , V_45 , F_140 ,
& V_183 ) ;
if ( ! error )
error = V_235 ;
}
if ( F_45 ( V_2 ) ) {
V_235 = F_1 ( V_2 , V_47 , F_140 ,
& V_183 ) ;
if ( ! error )
error = V_235 ;
}
...
V_249:
F_65 ( & V_2 -> V_163 ) ;
V_247 = V_2 -> V_63 . V_129 ;
V_2 -> V_63 . V_129 = V_2 -> V_128 & V_250 ;
F_60 ( & V_2 -> V_163 ) ;
if ( V_247 != ( V_2 -> V_128 & V_250 ) ) {
if ( F_148 ( V_2 , false ) ) {
ASSERT ( ! ( F_38 ( V_2 ) ) ) ;
F_108 ( V_2 , L_10 ,
V_30 ) ;
...
V_261 = V_59 ;
F_48 ( V_55 , V_261 ) ;
if ( ( V_41 & V_262 ) && F_150 ( V_55 ) )
V_253 = V_55 -> V_66 . V_71 ;
if ( F_40 ( V_2 , V_55 ) ) {
...
ASSERT ( V_55 -> V_65 ) ;
V_258 = F_151 ( V_55 -> V_65 ) ;
}
}
if ( ( V_41 & V_44 ) && F_44 ( V_2 ) ) {
if ( V_55 -> V_66 . V_71 != V_253 ) {
F_49 ( V_55 , V_261 ) ;
...
ASSERT ( V_55 -> V_70 ) ;
V_259 = F_151 ( V_55 -> V_70 ) ;
}
}
if ( ( V_41 & V_46 ) && F_45 ( V_2 ) ) {
if ( F_46 ( V_55 ) != V_254 ) {
F_49 ( V_55 , V_261 ) ;
error = F_35 ( V_2 , NULL , ( T_5 ) V_254 ,
V_47 ,
V_68 |
V_61 ,
& V_260 ) ;
...
ASSERT ( V_266 ) ;
ASSERT ( V_266 != V_265 ) ;
F_154 ( V_154 , V_266 , V_267 , - ( V_55 -> V_66 . V_195 ) ) ;
F_154 ( V_154 , V_266 , V_270 , - 1 ) ;
F_154 ( V_154 , V_265 , V_267 , V_55 -> V_66 . V_195 ) ;
F_154 ( V_154 , V_265 , V_270 , 1 ) ;
* V_264 = F_151 ( V_265 ) ;
return V_266 ;
}
int
...
int error ;
ASSERT ( F_33 ( V_55 , V_59 | V_263 ) ) ;
ASSERT ( F_38 ( V_2 ) ) ;
V_275 = V_55 -> V_229 ;
V_276 = F_134 ( V_55 ) ?
V_284 : V_285 ;
if ( F_43 ( V_2 ) && V_272 &&
V_55 -> V_66 . V_67 != F_7 ( V_272 -> V_20 . V_21 ) ) {
V_281 = V_272 ;
if ( V_275 ) {
ASSERT ( V_55 -> V_65 ) ;
V_278 = V_55 -> V_65 ;
...
if ( F_44 ( V_55 -> V_60 ) && V_273 &&
V_55 -> V_66 . V_71 != F_7 ( V_273 -> V_20 . V_21 ) ) {
V_282 = V_273 ;
if ( V_275 ) {
ASSERT ( V_55 -> V_70 ) ;
V_279 = V_55 -> V_70 ;
...
if ( F_45 ( V_55 -> V_60 ) && V_274 &&
F_46 ( V_55 ) != F_7 ( V_274 -> V_20 . V_21 ) ) {
V_277 = V_286 ;
V_283 = V_274 ;
if ( V_275 ) {
ASSERT ( V_55 -> V_72 ) ;
...
return error ;
if ( V_275 ) {
ASSERT ( V_281 || V_282 || V_283 ) ;
ASSERT ( V_278 || V_279 || V_280 ) ;
error = F_156 ( NULL , V_55 -> V_60 ,
V_281 , V_282 , V_283 ,
( T_16 ) V_275 , 0 ,
V_41 | V_276 | V_277 ) ;
if ( error )
return error ;
F_156 ( NULL , V_55 -> V_60 ,
V_278 , V_279 , V_280 ,
- ( ( T_16 ) V_275 ) , 0 , V_276 ) ;
}
return 0 ;
...
struct V_62 * * V_287 )
{
struct V_1 * V_2 = V_287 [ 0 ] -> V_60 ;
int V_18 ;
if ( ! F_38 ( V_2 ) || ! F_39 ( V_2 ) )
return 0 ;
for ( V_18 = 0 ; ( V_18 < 4 && V_287 [ V_18 ] ) ; V_18 ++ ) {
struct V_62 * V_55 = V_287 [ V_18 ] ;
int error ;
if ( V_18 == 0 || V_55 != V_287 [ V_18 - 1 ] ) {
if ( F_40 ( V_2 , V_55 ) ) {
error = F_47 ( V_55 , 0 ) ;
if ( error )
return error ;
...
ASSERT ( V_55 -> V_66 . V_67 == F_7 ( V_272 -> V_20 . V_21 ) ) ;
V_55 -> V_65 = F_151 ( V_272 ) ;
F_154 ( V_154 , V_272 , V_270 , 1 ) ;
}
if ( V_273 && F_44 ( V_2 ) ) {
ASSERT ( V_55 -> V_70 == NULL ) ;
ASSERT ( V_55 -> V_66 . V_71 == F_7 ( V_273 -> V_20 . V_21 ) ) ;
V_55 -> V_70 = F_151 ( V_273 ) ;
F_154 ( V_154 , V_273 , V_270 , 1 ) ;
}
if ( V_274 && F_45 ( V_2 ) ) {
ASSERT ( V_55 -> V_72 == NULL ) ;
ASSERT ( F_46 ( V_55 ) == F_7 ( V_274 -> V_20 . V_21 ) ) ;
V_55 -> V_72 = F_151 ( V_274 ) ;
F_154 ( V_154 , V_274 , V_270 , 1 ) ;
}
}
