...
if ( F_46 ( V_31 ) )
F_47 ( V_8 , V_15 - V_28 , V_14 ) ;
F_48 ( V_8 -> V_20 , V_32 , V_33 ) ;
...
if ( V_2 -> V_49 >= V_50 - 3 )
return - V_51 ;
V_48 = F_50 ( V_8 , V_14 , V_14 + V_39 ,
V_52 , & V_42 ) ;
if ( V_48 )
return V_48 ;
V_43 = V_8 -> V_53 + ( ( V_14 - V_8 -> V_54 ) >> V_55 ) ;
V_16 = F_51 ( & V_8 , V_18 , V_40 , V_43 ,
& V_19 ) ;
if ( ! V_16 )
return - V_51 ;
...
V_46 = V_2 -> V_46 ;
F_54 ( V_2 , V_8 -> V_42 , V_40 >> V_55 ) ;
if ( F_52 ( V_8 -> V_42 & V_60 ) )
F_55 ( V_8 ) ;
if ( F_56 ( V_2 , V_14 , V_39 ) < 0 ) {
F_57 ( V_45 >> V_55 ) ;
V_45 = 0 ;
}
V_2 -> V_46 = V_46 ;
...
V_70 = F_62 ( V_71 ) ;
V_41 += V_40 - V_39 ;
if ( V_41 > V_70 && ! F_63 ( V_72 ) )
return F_60 ( - V_73 ) ;
}
if ( ! F_64 ( V_2 , V_8 -> V_42 ,
( V_40 - V_39 ) >> V_55 ) )
return F_60 ( - V_51 ) ;
if ( V_8 -> V_42 & V_58 ) {
...
static unsigned long F_66 ( unsigned long V_3 , unsigned long V_39 ,
...
goto V_77;
V_75 = F_56 ( V_2 , V_18 , V_40 ) ;
if ( V_75 )
goto V_77;
if ( V_39 >= V_40 ) {
V_75 = F_56 ( V_2 , V_3 + V_40 , V_39 - V_40 ) ;
if ( V_75 && V_39 != V_40 )
goto V_77;
V_39 = V_40 ;
}
V_8 = F_58 ( V_3 , V_39 , V_40 , & V_74 ) ;
if ( F_68 ( V_8 ) ) {
V_75 = F_69 ( V_8 ) ;
goto V_77;
}
...
if ( V_8 -> V_42 & V_80 )
V_76 |= V_81 ;
V_75 = F_70 ( V_8 -> V_9 , V_18 , V_40 , V_8 -> V_53 +
( ( V_3 - V_8 -> V_54 ) >> V_55 ) ,
V_76 ) ;
if ( F_67 ( V_75 ) )
goto V_82;
V_75 = F_49 ( V_8 , V_3 , V_39 , V_40 , V_18 , V_41 ) ;
if ( ! ( F_67 ( V_75 ) ) )
goto V_77;
V_82:
F_57 ( V_74 ) ;
...
static int F_71 ( struct V_7 * V_8 , unsigned long V_83 )
{
...
return 0 ;
if ( F_70 ( NULL , V_8 -> V_54 , V_84 - V_8 -> V_54 ,
0 , V_79 ) & ~ V_85 )
return 0 ;
return 1 ;
}
