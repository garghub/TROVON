...
struct V_16 * V_17 = F_23 ( V_28 ) ;
struct V_1 * V_5 = F_24 ( V_17 ) ;
return sprintf ( V_64 , L_3 , ! ! ( V_5 -> V_10 & V_67 ) ) ;
}
...
struct V_16 * V_17 = F_23 ( V_28 ) ;
struct V_1 * V_5 = F_24 ( V_17 ) ;
return sprintf ( V_64 , L_3 , ! ! ( V_5 -> V_68 & V_69 ) ) ;
}
...
if ( V_21 )
return V_21 ;
switch ( ( V_73 ) V_71 -> V_74 ) {
case V_75 :
if ( V_72 )
V_5 -> V_68 |= V_69 ;
else
V_5 -> V_68 &= ~ V_69 ;
F_5 ( & V_5 -> V_3 , V_75 , 1 , V_5 -> V_68 ) ;
break;
case V_12 :
if ( V_72 )
V_5 -> V_10 |= V_67 ;
...
static unsigned int F_35 ( bool V_76 )
{
return V_76 ? 2815 * 2 : 2815 ;
}
...
{
struct V_1 * V_5 = F_24 ( V_17 ) ;
bool V_76 = ! ! ( V_5 -> V_6 & V_52 ) ;
switch ( V_80 ) {
case V_81 :
return F_37 ( V_17 , V_78 , V_72 ) ;
case V_82 :
switch ( V_78 -> type ) {
case V_83 :
F_38 ( & V_17 -> V_84 ) ;
* V_72 = V_5 -> V_55 [ F_19 ( V_5 -> V_6 ) ] [ 0 ] ;
* V_79 = V_5 -> V_55 [ F_19 ( V_5 -> V_6 ) ] [ 1 ] ;
F_39 ( & V_17 -> V_84 ) ;
return V_85 ;
case V_86 :
* V_72 = 0 ;
* V_79 = 1000000000 / F_35 ( V_76 ) ;
return V_85 ;
default:
return - V_37 ;
}
...
static int F_42 ( struct V_91 * V_18 )
{
const struct V_14 * V_15 = F_43 ( & V_18 -> V_28 ) ;
struct V_1 * V_5 ;
struct V_16 * V_17 ;
int V_21 , V_92 = 0 ;
if ( ! V_15 ) {
...
V_17 = F_44 ( & V_18 -> V_28 , sizeof( * V_5 ) ) ;
if ( ! V_17 )
return - V_95 ;
V_5 = F_24 ( V_17 ) ;
V_5 -> V_96 = F_45 ( & V_18 -> V_28 , L_8 ) ;
if ( ! F_46 ( V_5 -> V_96 ) ) {
V_21 = F_47 ( V_5 -> V_96 ) ;
if ( V_21 )
return V_21 ;
...
F_16 ( & V_18 -> V_28 , L_9 ) ;
F_49 ( V_18 , V_17 ) ;
V_5 -> V_27 = F_50 ( V_18 ) -> V_98 ;
V_17 -> V_28 . V_99 = & V_18 -> V_28 ;
V_17 -> V_100 = F_50 ( V_18 ) -> V_100 ;
V_17 -> V_101 = V_102 ;
switch ( V_5 -> V_27 ) {
case V_103 :
V_17 -> V_58 = V_104 ;
V_17 -> V_105 = F_10 ( V_104 ) ;
break;
default:
V_17 -> V_58 = V_106 ;
V_17 -> V_105 = F_10 ( V_106 ) ;
break;
}
if ( V_5 -> V_27 == V_44 )
V_17 -> V_107 = & V_108 ;
...
static int F_56 ( struct V_91 * V_18 )
{
