...
int V_41 ;
T_2 V_54 ;
V_47 = F_30 ( V_45 , V_55 , 0 ) ;
if ( ! V_47 )
return - V_56 ;
V_13 = F_31 ( & V_45 -> V_57 , sizeof( * V_13 ) , V_58 ) ;
if ( ! V_13 )
return - V_59 ;
V_50 = F_32 ( & V_45 -> V_57 , V_47 ) ;
if ( F_33 ( V_50 ) )
return F_34 ( V_50 ) ;
V_52 = F_35 ( V_45 , 0 ) ;
if ( V_52 < 0 )
return V_52 ;
V_49 = F_36 ( V_60 , & V_45 -> V_57 ) ;
if ( ! V_49 ) {
F_37 ( & V_45 -> V_57 , L_1 ) ;
return - V_56 ;
}
...
V_11 = & V_13 -> V_39 ;
V_11 -> V_86 = V_87 ;
V_11 -> V_88 = F_39 ( & V_45 -> V_57 ) ;
V_11 -> V_89 = 0 ;
V_11 -> V_90 = & V_45 -> V_57 ;
V_11 -> V_41 = V_41 ;
V_11 -> V_91 = V_45 -> V_57 . V_91 ;
V_11 -> V_92 = F_24 ;
V_11 -> V_93 = F_26 ;
V_11 -> V_94 = F_28 ;
V_11 -> V_95 = F_27 ;
F_40 ( & V_13 -> V_15 ) ;
if ( V_54 == V_78 )
V_51 = F_41 ( - 1 , 0 , V_11 -> V_41 , 0 ) ;
else
V_51 = F_41 ( - 1 , V_96 , V_11 -> V_41 , 0 ) ;
if ( V_51 < 0 ) {
F_37 ( & V_45 -> V_57 , L_3 ) ;
return V_51 ;
}
