...
void F_56 ( struct V_73 * V_46 , T_2 * V_62 ,
void * V_69 )
{
struct V_18 * V_19 ;
int V_3 ;
...
{
unsigned int V_3 , V_74 ;
for ( V_3 = 0 , V_74 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
struct V_5 * V_6 = & V_2 -> V_7 [ V_3 ] ;
V_74 += F_60 ( & V_6 -> V_9 , V_6 -> V_10 ) ;
}
return V_2 -> V_10 - V_74 ;
}
static void F_61 ( struct V_1 * V_2 ,
unsigned int V_10 )
{
unsigned int V_75 = 1U << V_2 -> V_38 ;
unsigned int V_76 = V_10 ;
if ( V_10 ) {
int V_3 ;
for ( V_3 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
V_2 -> V_7 [ V_3 ] . V_10 = F_62 ( V_76 , V_75 ) ;
V_76 -= V_2 -> V_7 [ V_3 ] . V_10 ;
}
}
V_2 -> V_56 = V_77 ;
...
V_80 = F_65 ( V_10 , V_75 ) / V_75 ;
V_2 -> V_7 = F_66 ( V_80 * sizeof( struct V_5 ) ,
V_81 , V_78 ) ;
if ( ! V_2 -> V_7 )
return - V_82 ;
V_2 -> V_4 = V_80 ;
}
V_2 -> V_26 = F_67 ( V_15 * sizeof( * V_2 -> V_26 ) , V_81 ) ;
if ( ! V_2 -> V_26 ) {
F_68 ( V_2 -> V_7 ) ;
V_2 -> V_7 = NULL ;
return - V_82 ;
...
V_12 -> V_59 = V_59 ;
if ( F_63 ( & V_12 -> V_13 , V_10 , V_78 , false ) )
goto V_83;
if ( F_63 ( & V_12 -> V_28 , V_12 -> V_51 , V_78 , true ) )
goto V_83;
return V_12 ;
V_83:
F_71 ( & V_12 -> V_13 ) ;
...
struct V_11 * F_73 ( unsigned int V_84 ,
unsigned int V_85 ,
int V_78 , int V_59 )
{
struct V_11 * V_12 ;
...
V_12 = F_66 ( sizeof( * V_12 ) , V_81 , V_78 ) ;
if ( ! V_12 )
return NULL ;
if ( ! F_75 ( & V_12 -> V_87 , V_81 ) ) {
F_68 ( V_12 ) ;
return NULL ;
}
V_12 -> V_58 = V_84 ;
V_12 -> V_51 = V_85 ;
return F_72 ( V_12 , V_78 , V_59 ) ;
}
...
int F_80 ( struct V_11 * V_12 , unsigned int V_88 )
{
V_88 -= V_12 -> V_51 ;
if ( V_88 > V_12 -> V_58 )
return - V_89 ;
...
T_4 F_81 ( struct V_64 * V_65 )
{
struct V_73 * V_46 = V_65 -> V_46 ;
struct V_18 * V_19 ;
int V_90 = 0 ;
if ( V_46 -> V_47 ) {
V_19 = V_46 -> V_47 -> V_48 ( V_46 , V_65 -> V_91 -> V_49 ) ;
V_90 = V_19 -> V_92 ;
}
return ( V_90 << V_93 ) |
( V_65 -> V_35 & V_94 ) ;
}
T_5 F_82 ( struct V_11 * V_12 , char * V_95 )
{
char * V_96 = V_95 ;
unsigned int free , V_97 ;
if ( ! V_12 )
return 0 ;
V_95 += sprintf ( V_95 , L_2
L_3 ,
V_12 -> V_58 , V_12 -> V_51 ,
V_12 -> V_13 . V_38 ) ;
free = F_59 ( & V_12 -> V_13 ) ;
V_97 = F_59 ( & V_12 -> V_28 ) ;
V_95 += sprintf ( V_95 , L_4 , free , V_97 ) ;
V_95 += sprintf ( V_95 , L_5 , F_6 ( & V_12 -> V_22 ) ) ;
return V_95 - V_96 ;
}
