...
V_98 -> V_102 [ V_99 ] = V_33 -> V_36 ;
V_98 -> V_103 [ V_99 ] = V_33 -> V_34 ;
F_66 ( & V_33 -> V_57 , & V_98 -> V_104 ) ;
V_28 = 0 ;
V_26 -> V_74 += 1 ;
V_26 -> V_51 -= 1 ;
}
...
{
struct V_100 * V_101 = & V_98 -> V_101 ;
struct V_105 * V_106 = V_101 -> V_107 -> V_106 ;
struct V_25 * V_26 ;
enum V_40 type ;
unsigned V_24 ;
T_4 V_38 ;
...
return 0 ;
type = F_23 ( V_101 -> V_110 , V_101 -> V_111 ) ;
if ( V_101 -> V_110 & V_45 )
V_38 = V_112 | V_113 ;
else
V_38 = V_114 ;
if ( V_101 -> V_110 & V_115 )
V_38 |= V_116 ;
V_26 = F_53 ( V_35 , type ) ;
if ( ! V_26 ) {
...
F_30 ( & V_98 -> V_104 ) ;
for ( V_24 = 0 ; V_24 < V_101 -> V_117 ; ++ V_24 ) {
V_81 = F_64 ( V_26 , V_98 , V_24 ) ;
if ( V_81 != 0 ) {
F_69 ( V_98 , V_35 ) ;
return - V_83 ;
}
V_81 = F_70 ( V_106 , V_101 -> V_21 [ V_24 ] ,
false , false ) ;
if ( F_71 ( V_81 != 0 ) ) {
F_69 ( V_98 , V_35 ) ;
return - V_83 ;
...
if ( ! V_26 )
return;
V_121 = ( F_53 ( V_26 -> V_35 ,
F_23 ( V_101 -> V_110 , V_47 ) ) == V_26 ) ;
...
F_74 ( struct V_122 * V_123 , struct V_124 * V_125 )
{
static unsigned V_126 ;
unsigned V_127 = 0 ;
unsigned V_128 ;
unsigned V_129 = V_125 -> V_130 ;
struct V_70 * V_39 ;
...
continue;
V_58 = V_129 ;
V_129 = F_29 ( V_39 -> V_26 , V_58 , true ) ;
V_131 += V_58 - V_129 ;
F_57 ( L_20 ,
...
static unsigned long
F_77 ( struct V_122 * V_123 , struct V_124 * V_125 )
{
struct V_70 * V_39 ;
...
static void F_78 ( struct V_3 * V_133 )
{
V_133 -> V_134 . V_135 = F_77 ;
V_133 -> V_134 . V_136 = & F_74 ;
V_133 -> V_134 . V_137 = 1 ;
F_79 ( & V_133 -> V_134 ) ;
}
static void F_80 ( struct V_3 * V_133 )
{
F_81 ( & V_133 -> V_134 ) ;
}
int F_82 ( struct V_105 * V_107 , unsigned V_138 )
{
int V_81 = - V_83 ;
F_39 ( V_71 ) ;
F_83 ( L_21 ) ;
...
F_85 ( & V_71 -> V_66 ) ;
F_30 ( & V_71 -> V_72 ) ;
V_71 -> V_13 . V_14 = V_138 ;
V_71 -> V_13 . V_16 = V_140 ;
V_71 -> V_13 . V_19 = V_18 ;
V_81 = F_86 ( & V_71 -> V_2 , & V_141 ,
& V_107 -> V_2 , L_22 ) ;
if ( F_71 ( V_81 != 0 ) ) {
F_87 ( & V_71 -> V_2 ) ;
goto V_139;
...
int F_91 ( struct V_142 * V_4 , void * V_143 )
{
struct V_70 * V_39 ;
struct V_25 * V_26 = NULL ;
char * V_144 [] = { L_25 , L_26 , L_27 , L_28 , L_29 ,
L_30 , L_31 , L_32 } ;
if ( ! V_71 ) {
F_92 ( V_4 , L_33 ) ;
return 0 ;
...
F_92 ( V_4 , L_34 ,
V_144 [ 0 ] , V_144 [ 1 ] , V_144 [ 2 ] , V_144 [ 3 ] , V_144 [ 4 ] , V_144 [ 5 ] ) ;
F_37 ( & V_71 -> V_66 ) ;
F_62 (p, &_manager->pools, pools) {
