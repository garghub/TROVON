...
int F_57 ( struct V_34 * V_21 , int * V_64 )
{
int V_6 ;
F_2 ( & V_21 -> V_2 -> V_73 ) ;
if ( V_21 -> V_2 -> V_43 == NULL ) {
...
V_6 = F_50 ( V_21 , V_64 , V_65 , V_86 ) ;
V_74:
F_5 ( & V_21 -> V_2 -> V_73 ) ;
return V_6 ;
}
int F_59 ( struct V_34 * V_21 , enum V_93 * type )
{
int V_6 = 0 ;
F_2 ( & V_21 -> V_2 -> V_73 ) ;
if ( V_21 -> V_2 -> V_43 == NULL ) {
...
static int F_60 ( struct V_34 * V_21 , int V_64 , int V_65 ,
enum V_66 V_43 )
{
return V_21 -> V_2 -> V_43 -> V_94 ( V_21 -> V_2 ,
V_21 -> V_35 , V_64 , V_65 , V_43 ) ;
}
int F_61 ( struct V_34 * V_21 , int V_64 )
{
int V_6 ;
F_2 ( & V_21 -> V_2 -> V_73 ) ;
if ( V_21 -> V_2 -> V_43 == NULL ) {
