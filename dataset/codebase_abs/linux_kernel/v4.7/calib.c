...
V_16 [ V_5 ] = V_12 -> V_38 ;
} else if ( V_16 [ V_5 ] < V_12 -> V_82 ) {
F_9 ( V_25 , V_39 ,
L_11 ,
V_5 , V_16 [ V_5 ] , V_12 -> V_82 ) ;
V_16 [ V_5 ] = V_12 -> V_15 ;
}
}
}
...
F_11 ( V_72 , & V_63 -> V_41 ) ;
F_6 ( V_9 , V_63 , V_23 ) ;
V_11 -> V_86 = V_27 [ 0 ] . V_37 ;
V_9 -> V_17 = F_5 ( V_9 , V_11 , V_11 -> V_86 ) ;
return true ;
}
