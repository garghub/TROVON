...
. V_136 = V_137 ,
. V_138 = V_131 -> V_139 ,
. V_140 = (struct V_78 * ) & V_107 -> V_104 ,
. V_141 = V_107 -> V_142 ,
. V_143 = V_131 -> V_144 ,
} ;
F_87 ( V_131 -> V_145 , & V_135 ,
V_146 , NULL ) ;
} else
...
V_133 = F_92 ( V_131 , V_126 -> V_130 -> V_149 ) ;
if ( V_133 )
goto V_150;
F_89 () ;
V_32 -> V_4 = V_131 ;
...
void F_93 ( struct V_125 * V_126 , struct V_72 * V_32 ,
struct V_151 * V_152 , unsigned int V_127 ,
unsigned int V_128 , T_4 V_153 ,
T_4 V_148 , T_3 V_129 )
{
if ( F_94 ( V_121 , & V_32 -> V_120 ) == 0 ) {
int V_154 = 0 ;
if ( V_153 == 3 ) {
V_154 = F_84 ( V_126 , V_32 , V_127 ,
V_128 , V_129 ) ;
} else if ( V_153 == 4 ) {
V_154 = F_90 ( V_126 , V_32 , V_127 ,
V_128 , V_148 ,
V_129 ) ;
} else {
F_58 ( L_14 , V_74 ,
...
struct V_98 *
F_96 ( struct V_138 * V_138 , struct V_156 * V_157 , T_1 V_112 )
{
...
goto V_117;
V_161 = F_99 ( V_115 ++ ) ;
V_115 = F_97 ( V_157 , V_161 ) ;
if ( F_98 ( ! V_115 ) )
goto V_117;
V_163 = F_100 ( V_161 + 1 , V_112 ) ;
if ( F_98 ( ! V_163 ) )
goto V_117;
V_163 [ V_161 ] = '\0' ;
memcpy ( V_163 , V_115 , V_161 ) ;
V_115 = F_97 ( V_157 , 4 ) ;
if ( F_98 ( ! V_115 ) )
goto V_168;
V_162 = F_99 ( V_115 ) ;
V_115 = F_97 ( V_157 , V_162 ) ;
if ( F_98 ( ! V_115 ) )
goto V_168;
if ( V_162 > V_169 + V_170 + 8 ) {
F_58 ( L_16 , V_74 ,
V_162 ) ;
goto V_168;
}
V_158 = F_100 ( V_162 + 1 , V_112 ) ;
if ( ! V_158 ) {
F_58 ( L_17 , V_74 ) ;
goto V_168;
}
V_158 [ V_162 ] = '\0' ;
memcpy ( V_158 , V_115 , V_162 ) ;
V_159 = strrchr ( V_158 , '.' ) ;
if ( ! V_159 ) {
F_58 ( L_18 ,
V_74 ) ;
...
goto V_171;
F_70 ( & V_107 -> V_108 ) ;
if ( ! F_101 ( V_138 , V_158 , V_159 - V_158 , (struct V_78 * ) & V_107 -> V_104 ,
sizeof( V_107 -> V_104 ) ) ) {
F_58 ( L_21 , V_74 , V_158 ) ;
goto V_172;
}
V_159 ++ ;
sscanf ( V_159 , L_22 , & V_43 [ 0 ] , & V_43 [ 1 ] ) ;
V_160 = F_102 ( ( V_43 [ 0 ] << 8 ) | ( V_43 [ 1 ] ) ) ;
switch ( V_107 -> V_104 . V_173 ) {
case V_87 :
( (struct V_81 * ) & V_107 -> V_104 ) -> V_90 = V_160 ;
V_107 -> V_142 = sizeof( struct V_81 ) ;
V_164 = L_23 ;
V_165 = 3 ;
break;
case V_91 :
( (struct V_83 * ) & V_107 -> V_104 ) -> V_95 = V_160 ;
V_107 -> V_142 = sizeof( struct V_83 ) ;
V_164 = L_24 ;
V_165 = 4 ;
V_166 = L_25 ;
V_167 = L_26 ;
...
default:
F_58 ( L_27 ,
V_74 , V_107 -> V_104 . V_173 ) ;
goto V_172;
}
if ( V_161 != V_165 || strncmp ( V_163 , V_164 , V_161 ) ) {
F_58 ( L_28 ,
V_74 , V_163 , V_164 ) ;
goto V_172;
}
V_114 = strlen ( V_166 ) + strlen ( V_158 ) + strlen ( V_167 ) + 7 ;
V_107 -> V_109 = F_68 ( V_114 , V_112 ) ;
if ( V_107 -> V_109 )
snprintf ( V_107 -> V_109 , V_114 , L_29 , V_166 ,
V_158 , V_167 , F_103 ( V_160 ) ) ;
...
F_30 ( & V_26 -> V_46 -> V_47 ) ;
V_56 = V_26 -> V_32 -> V_56 ;
V_62 = & V_56 [ V_174 ] . V_37 ;
if ( F_26 ( V_62 ) ) {
if ( ! F_105 ( V_23 ) ) {
F_29 ( & V_26 -> V_46 -> V_47 ) ;
V_26 -> V_21 -> V_175 ( V_26 , V_24 ) ;
return;
}
F_42 ( V_56 [ V_174 ] . V_38 != NULL ) ;
V_56 [ V_174 ] . V_38 = F_25 ( V_23 ) ;
}
F_106 ( V_29 , & V_24 -> V_30 ) ;
V_26 -> V_32 -> V_33 ++ ;
F_107 ( V_24 , V_62 , V_26 ) ;
F_29 ( & V_26 -> V_46 -> V_47 ) ;
F_108 ( V_24 -> V_176 , V_26 ) ;
}
int
F_109 ( struct V_46 * V_46 , bool V_177 )
{
if ( V_177 )
return 0 ;
return F_110 ( V_46 , true ) ;
}
