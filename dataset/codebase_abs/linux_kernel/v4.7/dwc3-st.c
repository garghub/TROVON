...
{
struct V_4 * V_5 = F_34 ( V_34 ) ;
F_35 ( & V_34 -> V_22 ) ;
F_31 ( V_5 -> V_51 ) ;
F_31 ( V_5 -> V_52 ) ;
return 0 ;
}
static int F_36 ( struct V_37 * V_22 )
{
struct V_4 * V_5 = F_37 ( V_22 ) ;
F_31 ( V_5 -> V_51 ) ;
F_31 ( V_5 -> V_52 ) ;
F_38 ( V_22 ) ;
return 0 ;
}
static int F_39 ( struct V_37 * V_22 )
{
struct V_4 * V_5 = F_37 ( V_22 ) ;
int V_43 ;
F_40 ( V_22 ) ;
