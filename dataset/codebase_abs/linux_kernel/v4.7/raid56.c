...
{
F_108 ( & V_24 -> V_148 , V_149 ,
V_150 , NULL , NULL ) ;
F_109 ( V_24 -> V_47 -> V_151 ,
& V_24 -> V_148 ) ;
}
...
static int F_115 ( void * V_157 , struct V_81 * V_158 , struct V_81 * V_159 )
{
struct V_23 * V_160 = F_116 ( V_158 , struct V_23 ,
V_51 ) ;
struct V_23 * V_161 = F_116 ( V_159 , struct V_23 ,
V_51 ) ;
...
static void F_117 ( struct V_164 * V_165 )
{
struct V_23 * V_7 ;
struct V_23 * V_65 = NULL ;
F_118 ( NULL , & V_165 -> V_166 , F_115 ) ;
...
static void F_119 ( struct V_167 * V_148 )
{
struct V_164 * V_165 ;
V_165 = F_116 ( V_148 , struct V_164 , V_148 ) ;
F_117 ( V_165 ) ;
}
static void F_120 ( struct V_168 * V_169 , bool V_170 )
{
struct V_164 * V_165 ;
V_165 = F_116 ( V_169 , struct V_164 , V_169 ) ;
if ( V_170 ) {
F_108 ( & V_165 -> V_148 , V_149 ,
F_119 , NULL , NULL ) ;
F_109 ( V_165 -> V_2 -> V_151 ,
& V_165 -> V_148 ) ;
return;
}
F_117 ( V_165 ) ;
...
int V_86 ;
int V_11 ;
V_135 = F_128 ( V_24 -> V_73 , sizeof( void * ) , V_107 ) ;
if ( ! V_135 ) {
V_86 = - V_17 ;
goto V_171;
}
...
{
struct V_23 * V_24 ;
V_24 = F_116 ( V_148 , struct V_23 , V_148 ) ;
F_110 ( V_24 ) ;
}
...
V_188 = 1 ;
F_136 ( V_185 , V_24 -> V_110 , V_24 -> V_72 ) ;
}
F_60 ( V_32 , & V_24 -> V_33 ) ;
if ( ! V_184 )
goto V_189;
...
if ( V_24 -> V_108 >= 0 || V_24 -> V_109 >= 0 ) {
int V_192 = 0 , V_193 = - 1 ;
if ( F_142 ( V_24 , V_24 -> V_108 ) )
V_192 ++ ;
else if ( F_144 ( V_24 -> V_108 ) )
V_193 = V_24 -> V_108 ;
...
static void F_147 ( struct V_167 * V_148 )
{
struct V_23 * V_24 ;
V_24 = F_116 ( V_148 , struct V_23 , V_148 ) ;
F_146 ( V_24 ) ;
...
static void F_150 ( struct V_167 * V_148 )
{
struct V_23 * V_24 ;
V_24 = F_116 ( V_148 , struct V_23 , V_148 ) ;
F_96 ( V_24 ) ;
...
F_108 ( & V_24 -> V_148 , V_149 ,
F_150 , NULL , NULL ) ;
F_109 ( V_24 -> V_47 -> V_151 , & V_24 -> V_148 ) ;
}
