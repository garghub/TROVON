...
{
return ( V_2 -> V_77 -> V_93 == F_32 ) ;
}
int F_65 ( struct V_1 * V_16 , struct V_1 * V_94 [ 2 ] ,
unsigned char V_95 , T_2 V_96 )
{
struct V_18 * V_19 ;
struct V_8 * V_14 ;
int V_97 ;
...
F_66 ( & V_19 -> V_99 ) ;
F_66 ( & V_19 -> V_100 ) ;
F_48 ( V_16 -> V_57 , V_94 [ 0 ] -> V_57 ) ;
V_97 = F_67 ( & V_19 -> V_100 , V_16 -> V_57 ,
V_94 [ 1 ] -> V_57 ) ;
if ( V_97 < 0 )
return V_97 ;
F_68 ( & V_19 -> V_62 ) ;
...
F_69 ( & V_19 -> V_74 , V_103 , ( unsigned long ) V_19 ) ;
F_48 ( V_19 -> V_56 , V_104 ) ;
V_19 -> V_56 [ V_105 - 1 ] = V_95 ;
V_19 -> V_70 = V_96 ;
F_14 ( V_16 ) ;
V_97 = F_70 ( V_19 , V_16 , V_15 ) ;
if ( V_97 )
return V_97 ;
V_97 = F_71 ( V_16 ) ;
if ( V_97 )
goto V_106;
V_97 = F_70 ( V_19 , V_94 [ 0 ] , V_32 ) ;
if ( V_97 )
goto V_106;
V_97 = F_70 ( V_19 , V_94 [ 1 ] , V_33 ) ;
if ( V_97 )
goto V_106;
F_72 ( & V_19 -> V_74 , V_23 + F_17 ( V_107 ) ) ;
return 0 ;
V_106:
F_11 (hsr, port)
F_55 ( V_14 ) ;
