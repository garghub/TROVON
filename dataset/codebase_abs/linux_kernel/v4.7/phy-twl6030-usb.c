...
{
struct V_1 * V_2 = F_23 ( V_52 , struct V_1 ,
V_53 . V_52 ) ;
F_16 ( V_2 -> V_54 , V_2 ) ;
F_21 ( V_2 -> V_55 , V_2 ) ;
}
...
static void F_26 ( struct V_51 * V_4 )
{
...
static int F_27 ( struct V_8 * V_9 , bool V_62 )
{
struct V_1 * V_2 = F_7 ( V_9 ) ;
V_2 -> V_60 = V_62 ;
F_28 ( & V_2 -> V_59 ) ;
...
struct V_1 * V_2 ;
int V_36 , V_65 ;
struct V_66 * V_67 = V_64 -> V_7 . V_68 ;
struct V_21 * V_7 = & V_64 -> V_7 ;
struct V_69 * V_70 = F_30 ( V_7 ) ;
V_2 = F_31 ( V_7 , sizeof( * V_2 ) , V_71 ) ;
if ( ! V_2 )
return - V_72 ;
V_2 -> V_7 = & V_64 -> V_7 ;
V_2 -> V_55 = F_32 ( V_64 , 0 ) ;
V_2 -> V_54 = F_32 ( V_64 , 1 ) ;
V_2 -> V_28 = V_37 ;
V_2 -> V_9 . V_73 = F_27 ;
V_2 -> V_9 . V_74 = F_6 ;
V_6 = F_33 ( & V_2 -> V_9 ) ;
...
F_36 ( V_64 , V_2 ) ;
if ( F_37 ( & V_64 -> V_7 , & V_78 ) )
F_38 ( & V_64 -> V_7 , L_15 ) ;
F_39 ( & V_2 -> V_59 , F_26 ) ;
F_40 ( & V_2 -> V_53 , F_22 ) ;
V_36 = F_41 ( V_2 -> V_55 , NULL , F_21 ,
V_79 | V_80 | V_81 ,
L_16 , V_2 ) ;
if ( V_36 < 0 ) {
F_3 ( & V_64 -> V_7 , L_17 ,
