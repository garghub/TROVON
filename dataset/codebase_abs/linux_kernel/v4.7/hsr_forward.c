...
{
struct V_56 * V_77 ;
V_77 = F_34 ( V_2 , V_71 ) -> V_57 ;
if ( F_35 ( V_2 , F_13 ( V_4 ) -> V_11 ) ) {
V_26 -> V_75 = true ;
V_4 -> V_62 = V_78 ;
} else {
V_26 -> V_75 = false ;
...
V_26 -> V_59 = F_37 ( & V_40 -> V_2 -> V_81 , V_4 ,
V_26 -> V_76 ) ;
if ( V_26 -> V_59 == NULL )
return - 1 ;
V_5 = (struct V_5 * ) F_4 ( V_4 ) ;
V_26 -> V_36 = false ;
if ( V_5 -> V_13 == F_6 ( V_82 ) ) {
V_26 -> V_36 = true ;
F_21 ( 1 , L_2 ) ;
}
...
V_26 -> V_41 = V_4 ;
V_26 -> V_42 = NULL ;
F_39 ( & V_40 -> V_2 -> V_83 , V_80 ) ;
V_26 -> V_50 = V_40 -> V_2 -> V_50 ;
V_40 -> V_2 -> V_50 ++ ;
F_40 ( & V_40 -> V_2 -> V_83 , V_80 ) ;
}
V_26 -> V_70 = V_40 ;
F_33 ( V_40 -> V_2 , V_4 , V_26 ) ;
return 0 ;
}
void F_41 ( struct V_3 * V_4 , struct V_39 * V_40 )
{
struct V_25 V_26 ;
if ( F_4 ( V_4 ) != V_4 -> V_84 ) {
F_21 ( 1 , L_3 ,
__FILE__ , __LINE__ , V_40 -> V_57 -> V_85 ) ;
goto V_86;
}
if ( F_36 ( & V_26 , V_4 , V_40 ) < 0 )
goto V_86;
F_42 ( V_26 . V_59 , V_40 , V_26 . V_50 ) ;
F_29 ( & V_26 ) ;
if ( V_26 . V_42 != NULL )
F_43 ( V_26 . V_42 ) ;
if ( V_26 . V_41 != NULL )
