...
{
struct V_547 * V_505 = F_97 ( & V_514 -> V_2 ) ;
struct V_211 * V_212 ;
int V_218 ;
unsigned int V_271 ;
...
V_212 -> V_534 = F_100 ( & V_514 -> V_2 ,
L_31 , V_552 ) ;
if ( F_101 ( V_212 -> V_534 ) ) {
V_218 = F_102 ( V_212 -> V_534 ) ;
...
V_212 -> V_230 = F_104 ( & V_514 -> V_2 , NULL , V_514 , & V_554 ) ;
