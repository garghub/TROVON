...
int T_5 F_62 ( const struct V_105 * V_66 , T_2 V_106 , T_2 V_107 )
{
struct V_9 * V_10 = V_66 -> V_23 ;
if ( V_10 && V_10 -> V_90 )
return V_10 -> V_90 ( V_66 , V_106 , V_107 ) ;
return - 1 ;
}
int F_63 ( struct V_105 * V_66 )
{
return 0 ;
}
