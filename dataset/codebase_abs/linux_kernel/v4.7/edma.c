...
if ( ! V_5 )
continue;
F_48 ( V_2 -> V_44 , L_37 , V_9 , V_5 ) ;
V_179 = V_5 ;
for ( V_8 = F_102 ( & V_179 , 32 , 0 ) ; V_8 < 32 ;
V_8 = F_102 ( & V_179 , 32 , V_8 + 1 ) ) {
int V_180 = ( V_9 << 5 ) + V_8 ;
F_9 ( V_2 , V_55 , V_9 , F_31 ( V_8 ) ) ;
F_17 ( V_2 , V_56 , V_9 ,
F_31 ( V_8 ) ) ;
F_99 ( & V_2 -> V_172 [ V_180 ] ) ;
}
}
V_5 = F_1 ( V_2 , V_175 ) ;
if ( V_5 ) {
F_48 ( V_2 -> V_44 , L_38 , V_5 ) ;
F_3 ( V_2 , V_181 , V_5 ) ;
F_16 ( V_2 , V_182 , V_5 ) ;
}
V_5 = F_1 ( V_2 , V_176 ) ;
if ( V_5 ) {
F_45 ( V_2 -> V_44 , L_39 , V_5 ) ;
F_3 ( V_2 , V_62 , V_5 ) ;
}
if ( ! F_100 ( V_2 ) )
break;
...
F_48 ( V_44 , L_48 , V_233 ) ;
F_48 ( V_44 , L_49 , V_2 -> V_236 ) ;
F_48 ( V_44 , L_50 , V_2 -> V_34 ) ;
F_48 ( V_44 , L_51 , V_2 -> V_237 ) ;
F_48 ( V_44 , L_52 , V_2 -> V_32 ) ;
F_48 ( V_44 , L_53 , V_2 -> V_67 ) ;
F_48 ( V_44 , L_54 , V_2 -> V_24 ? L_55 : L_56 ) ;
if ( V_231 -> V_239 )
return 0 ;
...
V_254 = F_140 ( V_44 -> V_249 , L_58 , & V_240 ) ;
if ( V_254 ) {
...
V_254 = F_140 ( V_44 -> V_249 , L_59 ,
& V_240 ) ;
if ( V_254 ) {
const char V_241 [] = L_59 ;
T_2 ( * V_256 ) [ 2 ] ;
F_131 ( * V_257 ) [ 2 ] ;
...
V_163 = F_158 ( V_269 , L_66 ) ;
if ( V_163 < 0 && V_86 )
V_163 = F_159 ( V_86 , 0 ) ;
if ( V_163 >= 0 ) {
V_273 = F_160 ( V_44 , V_227 , L_67 ,
F_161 ( V_44 ) ) ;
V_141 = F_162 ( V_44 , V_163 , F_97 , 0 , V_273 ,
V_2 ) ;
if ( V_141 ) {
F_80 ( V_44 , L_68 , V_163 , V_141 ) ;
return V_141 ;
}
}
V_163 = F_158 ( V_269 , L_69 ) ;
if ( V_163 < 0 && V_86 )
V_163 = F_159 ( V_86 , 2 ) ;
if ( V_163 >= 0 ) {
V_273 = F_160 ( V_44 , V_227 , L_70 ,
F_161 ( V_44 ) ) ;
V_141 = F_162 ( V_44 , V_163 , F_101 , 0 , V_273 ,
V_2 ) ;
if ( V_141 ) {
F_80 ( V_44 , L_71 , V_163 , V_141 ) ;
return V_141 ;
}
}
