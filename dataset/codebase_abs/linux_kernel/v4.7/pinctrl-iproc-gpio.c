...
V_76 -> V_86 = V_14 -> V_79 ;
V_76 -> V_87 = & V_88 ;
V_3 -> V_89 = F_52 ( V_3 -> V_41 , V_76 , V_3 ) ;
if ( F_53 ( V_3 -> V_89 ) ) {
F_26 ( V_3 -> V_41 , L_11 ) ;
...
T_1 V_95 ;
int V_96 , V_67 ;
V_3 = F_56 ( V_41 , sizeof( * V_3 ) , V_80 ) ;
if ( ! V_3 )
return - V_81 ;
V_3 -> V_41 = V_41 ;
F_57 ( V_91 , V_3 ) ;
V_94 = F_58 ( V_91 , V_97 , 0 ) ;
V_3 -> V_10 = F_59 ( V_41 , V_94 ) ;
if ( F_53 ( V_3 -> V_10 ) ) {
F_26 ( V_41 , L_12 ) ;
return F_54 ( V_3 -> V_10 ) ;
}
V_94 = F_58 ( V_91 , V_97 , 1 ) ;
if ( V_94 ) {
V_3 -> V_59 = F_59 ( V_41 , V_94 ) ;
if ( F_53 ( V_3 -> V_59 ) ) {
F_26 ( V_41 , L_12 ) ;
return F_54 ( V_3 -> V_59 ) ;
}
}
if ( F_60 ( V_41 -> V_98 , L_13 , & V_95 ) ) {
F_26 ( & V_91 -> V_41 , L_14 ) ;
return - V_99 ;
}
F_61 ( & V_3 -> V_31 ) ;
...
V_96 = F_64 ( V_91 , 0 ) ;
if ( V_96 ) {
V_67 = F_65 ( V_14 , & V_107 , 0 ,
V_108 , V_109 ) ;
if ( V_67 ) {
F_26 ( V_41 , L_18 ) ;
goto V_106;
}
F_66 ( V_14 , & V_107 , V_96 ,
F_9 ) ;
}
return 0 ;
V_106:
