...
if ( ! V_114 )
return - V_34 ;
V_6 = (struct V_113 * ) F_13 ( V_10 | V_35 ) ;
if ( ! V_6 )
return - V_11 ;
V_6 -> V_36 . V_37 = sizeof( * V_6 ) ;
V_9 = F_3 ( V_5 , V_6 ) ;
...
int F_58 ( struct V_115 V_116 )
{
return F_57 ( V_117 | V_116 . V_52 << 8 ) ;
}
int F_59 ( struct V_115 V_116 )
{
return F_57 ( V_118 | V_116 . V_52 << 8 ) ;
}
int F_60 ( struct V_119 * V_22 )
{
struct V_120 * V_6 ;
int V_9 ;
if ( ! V_121 )
return - V_34 ;
V_6 = (struct V_120 * ) F_13 ( V_10 | V_35 ) ;
if ( ! V_6 )
return - V_11 ;
V_6 -> V_36 . V_37 = sizeof( * V_6 ) ;
V_9 = F_3 ( V_122 , V_6 ) ;
...
memcpy ( V_22 -> V_123 , V_6 -> V_123 , V_124 ) ;
memcpy ( V_22 -> V_27 , V_6 -> V_27 , V_124 ) ;
memcpy ( V_22 -> V_25 , V_6 -> V_25 , V_124 ) ;
V_18:
F_14 ( ( unsigned long ) V_6 ) ;
return V_9 ;
}
