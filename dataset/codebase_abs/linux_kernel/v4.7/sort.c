...
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
if ( ! V_53 )
V_53 = F_110 ( F_111 ( V_76 ) , V_144 -> V_146 -> V_147 ) ;
return F_54 ( V_145 -> V_135 , V_145 -> V_2 , L_3 , V_53 , V_53 , V_3 -> V_47 ) ;
}
static int F_112 ( struct V_142 * V_3 ,
struct V_148 * V_145 V_150 ,
struct V_75 * V_76 )
{
struct V_143 * V_144 ;
T_1 V_53 = V_3 -> V_149 ;
...
static int F_113 ( struct V_142 * V_3 , struct V_148 * V_145 ,
struct V_11 * V_16 )
{
struct V_143 * V_144 ;
T_1 V_53 = V_3 -> V_149 ;
...
static T_3 F_115 ( struct V_142 * V_3 ,
struct V_11 * V_152 , struct V_11 * V_153 )
{
struct V_143 * V_144 ;
T_3 (* F_116)( struct V_11 * , struct V_11 * );
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
F_116 = V_144 -> V_146 -> V_155 ? : V_144 -> V_146 -> V_154 ;
return F_116 ( V_152 , V_153 ) ;
}
static T_3 F_117 ( struct V_142 * V_3 ,
struct V_11 * V_152 , struct V_11 * V_153 )
{
struct V_143 * V_144 ;
T_3 (* F_118)( struct V_11 * , struct V_11 * );
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
F_118 = V_144 -> V_146 -> V_156 ? : V_144 -> V_146 -> V_154 ;
return F_118 ( V_152 , V_153 ) ;
}
bool F_106 ( struct V_142 * V_157 )
{
return V_157 -> V_158 == F_109 ;
}
static bool F_119 ( struct V_142 * V_152 , struct V_142 * V_153 )
{
struct V_143 * V_159 ;
struct V_143 * V_160 ;
...
static void F_120 ( struct V_142 * V_3 )
{
struct V_143 * V_144 ;
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
free ( V_144 ) ;
...
static struct V_143 *
F_121 ( struct V_161 * V_162 , int V_48 )
{
struct V_143 * V_144 ;
...
V_144 -> V_145 . V_17 = F_112 ;
V_144 -> V_145 . V_163 = F_113 ;
V_144 -> V_145 . V_165 = NULL ;
V_144 -> V_145 . V_166 = F_114 ;
V_144 -> V_145 . V_167 = F_115 ;
V_144 -> V_145 . V_168 = F_117 ;
V_144 -> V_145 . V_169 = F_119 ;
V_144 -> V_145 . free = F_120 ;
F_123 ( & V_144 -> V_145 . V_170 ) ;
F_123 ( & V_144 -> V_145 . V_171 ) ;
...
static void F_124 ( struct V_142 * V_3 )
{
free ( V_3 ) ;
}
static struct V_142 * F_125 ( struct V_173 * V_174 ,
int V_48 )
{
struct V_142 * V_3 ;
V_3 = F_126 ( V_174 -> V_3 , sizeof( * V_3 ) ) ;
if ( V_3 ) {
F_123 ( & V_3 -> V_170 ) ;
F_123 ( & V_3 -> V_171 ) ;
V_3 -> free = F_124 ;
...
int F_127 ( struct V_11 * V_16 , int type , const void * V_19 )
{
struct V_142 * V_3 ;
struct V_143 * V_144 ;
int V_43 = - 1 ;
int V_10 ;
F_128 (he->hpp_list, fmt) {
if ( ! F_106 ( V_3 ) )
continue;
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
...
static int F_129 ( struct V_161 * V_162 ,
struct V_176 * V_170 ,
int V_48 )
{
struct V_143 * V_144 = F_121 ( V_162 , V_48 ) ;
if ( V_144 == NULL )
return - 1 ;
F_130 ( V_170 , & V_144 -> V_145 ) ;
return 0 ;
}
static int F_131 ( struct V_161 * V_162 ,
struct V_176 * V_170 )
{
struct V_143 * V_144 = F_121 ( V_162 , 0 ) ;
if ( V_144 == NULL )
return - 1 ;
F_132 ( V_170 , & V_144 -> V_145 ) ;
return 0 ;
}
static int F_133 ( struct V_177 * V_178 )
{
if ( ! V_178 -> V_145 . V_53 ) {
...
static void F_134 ( struct V_177 * V_178 ,
struct V_11 * V_16 )
{
char * V_130 , * V_184 ;
...
static int F_135 ( struct V_142 * V_3 , struct V_148 * V_145 ,
struct V_75 * V_76 V_150 )
{
struct V_177 * V_178 ;
T_1 V_53 = V_3 -> V_149 ;
...
static int F_136 ( struct V_142 * V_3 ,
struct V_148 * V_145 V_150 ,
struct V_75 * V_76 V_150 )
{
struct V_177 * V_178 ;
...
bool F_137 ( struct V_142 * V_3 , struct V_46 * V_46 )
{
struct V_177 * V_178 ;
V_178 = F_107 ( V_3 , struct V_177 , V_145 ) ;
return F_48 ( V_46 ) == V_178 -> V_76 ;
}
static int F_138 ( struct V_142 * V_3 , struct V_148 * V_145 ,
struct V_11 * V_16 )
{
struct V_177 * V_178 ;
T_1 V_53 = V_3 -> V_149 ;
...
V_187:
F_49 ( & V_74 ) ;
F_140 ( & V_74 , V_16 -> V_80 , V_178 -> V_181 ) ;
V_130 = V_74 . V_84 ;
}
...
static T_3 F_141 ( struct V_142 * V_3 ,
struct V_11 * V_152 , struct V_11 * V_153 )
{
struct V_177 * V_178 ;
struct V_185 * V_181 ;
...
bool F_143 ( struct V_142 * V_3 )
{
return V_3 -> V_166 == F_141 ;
}
static bool F_144 ( struct V_142 * V_152 , struct V_142 * V_153 )
{
struct V_177 * V_191 ;
struct V_177 * V_192 ;
if ( ! F_143 ( V_152 ) || ! F_143 ( V_153 ) )
return false ;
V_191 = F_107 ( V_152 , struct V_177 , V_145 ) ;
V_192 = F_107 ( V_153 , struct V_177 , V_145 ) ;
return V_191 -> V_181 == V_192 -> V_181 ;
}
static void F_145 ( struct V_142 * V_3 )
{
struct V_177 * V_178 ;
V_178 = F_107 ( V_3 , struct V_177 , V_145 ) ;
free ( V_178 ) ;
...
static struct V_177 *
F_146 ( struct V_75 * V_76 , struct V_185 * V_181 ,
int V_48 )
{
struct V_177 * V_178 ;
...
V_178 -> V_145 . V_158 = F_135 ;
V_178 -> V_145 . V_17 = F_136 ;
V_178 -> V_145 . V_163 = F_138 ;
V_178 -> V_145 . V_165 = NULL ;
V_178 -> V_145 . V_166 = F_141 ;
V_178 -> V_145 . V_167 = F_141 ;
V_178 -> V_145 . V_168 = F_141 ;
V_178 -> V_145 . V_169 = F_144 ;
V_178 -> V_145 . free = F_145 ;
F_123 ( & V_178 -> V_145 . V_170 ) ;
F_123 ( & V_178 -> V_145 . V_171 ) ;
...
struct V_142 * F_148 ( struct V_142 * V_3 )
{
struct V_142 * V_193 = NULL ;
if ( F_106 ( V_3 ) ) {
struct V_143 * V_144 , * V_194 ;
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
V_194 = F_126 ( V_144 , sizeof( * V_144 ) ) ;
if ( V_194 )
V_193 = & V_194 -> V_145 ;
} else if ( F_143 ( V_3 ) ) {
struct V_177 * V_178 , * V_195 ;
V_178 = F_107 ( V_3 , struct V_177 , V_145 ) ;
V_195 = F_126 ( V_178 , sizeof( * V_178 ) ) ;
if ( V_195 )
V_193 = & V_195 -> V_145 ;
} else {
V_193 = F_126 ( V_3 , sizeof( * V_3 ) ) ;
}
F_123 ( & V_193 -> V_170 ) ;
F_123 ( & V_193 -> V_171 ) ;
return V_193 ;
}
static int F_149 ( char * V_130 , char * * V_196 , char * * V_181 , char * * V_197 )
{
...
static struct V_75 * F_150 ( struct V_201 * V_202 , char * V_198 )
{
...
static int F_156 ( struct V_75 * V_76 , bool V_82 , int V_48 )
{
int V_43 ;
struct V_185 * V_181 ;
V_181 = V_76 -> V_83 -> V_157 . V_207 ;
while ( V_181 ) {
V_43 = F_154 ( V_76 , V_181 , V_82 , V_48 ) ;
if ( V_43 < 0 )
return V_43 ;
V_181 = V_181 -> V_208 ;
}
...
static int F_157 ( struct V_201 * V_202 , bool V_82 ,
int V_48 )
{
int V_43 ;
struct V_75 * V_76 ;
...
if ( V_76 -> V_85 . type != V_86 )
continue;
V_43 = F_156 ( V_76 , V_82 , V_48 ) ;
if ( V_43 < 0 )
return V_43 ;
}
return 0 ;
}
static int F_158 ( struct V_201 * V_202 ,
...
static int F_160 ( struct V_201 * V_202 , const char * V_210 ,
int V_48 )
{
...
if ( V_130 == NULL )
return - V_206 ;
if ( F_149 ( V_130 , & V_198 , & V_199 , & V_200 ) < 0 ) {
V_43 = - V_212 ;
goto V_98;
}
if ( V_200 ) {
...
V_43 = F_157 ( V_202 , V_82 , V_48 ) ;
goto V_98;
}
if ( V_198 == NULL ) {
V_43 = F_158 ( V_202 , V_199 , V_82 , V_48 ) ;
goto V_98;
}
V_76 = F_150 ( V_202 , V_198 ) ;
if ( V_76 == NULL ) {
F_147 ( L_33 , V_198 ) ;
V_43 = - V_211 ;
goto V_98;
...
static int F_163 ( struct V_173 * V_174 ,
struct V_176 * V_170 ,
int V_48 )
{
struct V_142 * V_3 ;
...
if ( V_162 -> V_213 )
return 0 ;
if ( F_131 ( V_162 , V_170 ) < 0 )
return - 1 ;
V_162 -> V_213 = 1 ;
return 0 ;
}
static int F_165 ( struct V_176 * V_170 ,
struct V_173 * V_174 )
{
struct V_142 * V_3 ;
if ( V_174 -> V_213 )
...
int F_166 ( unsigned V_215 )
{
F_167 ( V_215 >= V_216 ) ;
return F_165 ( & V_176 , & V_217 [ V_215 ] ) ;
}
static int F_168 ( struct V_176 * V_170 , const char * V_210 ,
struct V_201 * V_202 ,
int V_48 )
{
unsigned int V_131 ;
for ( V_131 = 0 ; V_131 < F_169 ( V_218 ) ; V_131 ++ ) {
...
return F_162 ( V_162 , V_170 , V_48 ) ;
}
for ( V_131 = 0 ; V_131 < F_169 ( V_217 ) ; V_131 ++ ) {
struct V_173 * V_174 = & V_217 [ V_131 ] ;
if ( strncasecmp ( V_210 , V_174 -> V_47 , strlen ( V_210 ) ) )
continue;
return F_163 ( V_174 , V_170 , V_48 ) ;
}
for ( V_131 = 0 ; V_131 < F_169 ( V_232 ) ; V_131 ++ ) {
...
V_170 -> V_44 = 1 ;
F_162 ( V_162 , V_170 , V_48 ) ;
return 0 ;
}
for ( V_131 = 0 ; V_131 < F_169 ( V_236 ) ; V_131 ++ ) {
struct V_161 * V_162 = & V_236 [ V_131 ] ;
if ( strncasecmp ( V_210 , V_162 -> V_47 , strlen ( V_210 ) ) )
continue;
if ( V_226 != V_237 )
return - V_212 ;
if ( V_162 -> V_163 == & V_238 )
V_170 -> V_44 = 1 ;
F_162 ( V_162 , V_170 , V_48 ) ;
return 0 ;
}
if ( ! F_160 ( V_202 , V_210 , V_48 ) )
return 0 ;
return - V_209 ;
}
static int F_170 ( struct V_176 * V_170 , char * V_130 ,
struct V_201 * V_202 )
{
char * V_239 , * V_210 ;
int V_43 = 0 ;
...
if ( * V_210 ) {
V_43 = F_168 ( V_170 , V_210 , V_202 , V_48 ) ;
if ( V_43 == - V_212 ) {
error ( L_39 , V_210 ) ;
break;
} else if ( V_43 == - V_209 ) {
...
static const char * F_171 ( struct V_201 * V_202 )
{
const char * V_242 [] = {
V_243 ,
V_244 ,
...
static int F_172 ( struct V_201 * V_202 )
{
char * V_252 ;
if ( ! V_253 || F_173 ( V_253 ) )
return 0 ;
if ( V_253 [ 1 ] == '\0' ) {
error ( L_41 ) ;
return - V_212 ;
...
static char * F_175 ( const char * V_254 , char * V_130 )
{
char * V_4 ;
if ( ! V_130 || strstr ( V_130 , V_254 ) )
return V_130 ;
if ( F_174 ( & V_4 , L_42 , V_254 , V_130 ) < 0 )
return NULL ;
free ( V_130 ) ;
return V_4 ;
}
static char * F_176 ( char * V_255 )
{
if ( V_226 == V_227 )
return V_255 ;
V_255 = F_175 ( L_44 , V_255 ) ;
if ( V_6 . V_256 )
V_255 = F_175 ( L_45 , V_255 ) ;
return V_255 ;
}
static int F_177 ( struct V_201 * V_202 )
{
char * V_130 ;
const char * V_257 ;
int V_43 = 0 ;
...
V_43 = F_170 ( & V_176 , V_130 , V_202 ) ;
free ( V_130 ) ;
return V_43 ;
}
void F_178 ( int V_259 , bool V_172 )
{
struct V_142 * V_3 ;
struct V_143 * V_144 ;
F_128 (&perf_hpp_list, fmt) {
if ( ! F_106 ( V_3 ) )
continue;
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
if ( V_144 -> V_146 -> V_147 == V_259 ) {
V_3 -> V_172 = V_172 ;
break;
}
}
}
static bool F_179 ( struct V_260 * V_170 , const char * V_261 , T_6 * V_262 )
{
if ( V_170 && F_180 ( V_170 ) == 1 ) {
if ( V_262 != NULL )
fprintf ( V_262 , L_48 , V_261 ,
F_181 ( V_170 , 0 ) -> V_263 ) ;
return true ;
}
return false ;
}
static bool F_182 ( int V_259 , T_6 * V_264 )
{
switch ( V_259 ) {
case V_265 :
return F_179 ( V_6 . V_266 , L_49 , V_264 ) ;
case V_267 :
return F_179 ( V_6 . V_268 , L_50 , V_264 ) ;
case V_269 :
return F_179 ( V_6 . V_270 , L_51 , V_264 ) ;
default:
break;
}
if ( V_226 != V_233 )
...
switch ( V_259 ) {
case V_271 :
return F_179 ( V_6 . V_272 , L_52 , V_264 ) ;
case V_273 :
return F_179 ( V_6 . V_274 , L_53 , V_264 ) ;
case V_275 :
return F_179 ( V_6 . V_276 , L_54 , V_264 ) ;
case V_277 :
return F_179 ( V_6 . V_278 , L_55 , V_264 ) ;
default:
break;
}
return false ;
}
void F_183 ( T_6 * V_264 )
{
struct V_142 * V_3 ;
struct V_143 * V_144 ;
F_128 (&perf_hpp_list, fmt) {
...
continue;
V_144 = F_107 ( V_3 , struct V_143 , V_145 ) ;
V_3 -> V_172 = F_182 ( V_144 -> V_146 -> V_147 , V_264 ) ;
}
F_128 (&perf_hpp_list, fmt) {
if ( ! F_106 ( V_3 ) )
continue;
...
static int F_184 ( struct V_176 * V_170 , char * V_210 )
{
unsigned int V_131 ;
for ( V_131 = 0 ; V_131 < F_169 ( V_218 ) ; V_131 ++ ) {
struct V_161 * V_162 = & V_218 [ V_131 ] ;
if ( strncasecmp ( V_210 , V_162 -> V_47 , strlen ( V_210 ) ) )
continue;
return F_164 ( V_170 , V_162 ) ;
}
for ( V_131 = 0 ; V_131 < F_169 ( V_217 ) ; V_131 ++ ) {
struct V_173 * V_174 = & V_217 [ V_131 ] ;
if ( strncasecmp ( V_210 , V_174 -> V_47 , strlen ( V_210 ) ) )
continue;
return F_165 ( V_170 , V_174 ) ;
}
for ( V_131 = 0 ; V_131 < F_169 ( V_232 ) ; V_131 ++ ) {
struct V_161 * V_162 = & V_232 [ V_131 ] ;
if ( strncasecmp ( V_210 , V_162 -> V_47 , strlen ( V_210 ) ) )
...
static int F_185 ( struct V_176 * V_170 , char * V_130 )
{
char * V_239 , * V_210 ;
int V_43 = 0 ;
for ( V_210 = strtok_r ( V_130 , L_56 , & V_239 ) ;
V_210 ; V_210 = strtok_r ( NULL , L_56 , & V_239 ) ) {
V_43 = F_184 ( V_170 , V_210 ) ;
if ( V_43 == - V_212 ) {
error ( L_57 , V_210 ) ;
break;
} else if ( V_43 == - V_209 ) {
...
V_43 = F_185 ( & V_176 , V_280 ) ;
V_98:
free ( V_130 ) ;
return V_43 ;
}
int F_188 ( struct V_201 * V_202 )
{
int V_223 ;
V_223 = F_177 ( V_202 ) ;
if ( V_223 < 0 )
return V_223 ;
if ( V_221 != V_281 ) {
V_223 = F_168 ( & V_176 , L_61 , V_202 , - 1 ) ;
if ( V_223 < 0 )
return V_223 ;
}
F_186 () ;
