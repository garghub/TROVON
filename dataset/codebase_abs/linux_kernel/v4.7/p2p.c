...
T_4 V_233 ;
T_2 V_7 ;
if ( V_183 -> V_227 < sizeof( * V_229 ) ) {
F_5 ( V_234 , L_64 ) ;
return 0 ;
}
V_169 . V_73 = F_65 ( V_229 -> V_69 ) ;
V_107 -> V_153 . V_218 ( & V_169 ) ;
F_5 ( V_65 , L_65 , V_41 -> V_53 -> V_235 ) ;
V_233 = ( V_236 & V_237 ) >> 4 ;
if ( ( V_41 -> V_53 -> V_235 & F_66 ( V_233 ) ) == 0 )
return 0 ;
F_4 ( false , V_1 , V_226 ) ;
V_7 = V_238 ;
if ( F_1 ( V_1 , V_226 ) ) {
...
V_231 = F_24 ( F_23 ( struct V_230 , V_241 ) +
V_226 , V_99 ) ;
if ( ! V_231 ) {
F_10 ( L_68 ) ;
return - V_100 ;
}
memcpy ( V_231 -> V_242 , V_41 -> V_55 , V_46 ) ;
F_68 ( V_41 , V_243 , V_231 -> V_110 ,
V_46 ) ;
memcpy ( V_231 -> V_244 , V_183 -> V_239 , V_46 ) ;
V_231 -> V_245 = F_15 ( V_236 ) ;
memcpy ( & V_231 -> V_241 , V_1 , V_226 ) ;
V_226 += F_23 ( struct V_230 , V_241 ) ;
...
V_53 = V_48 -> V_51 [ V_76 ] . V_53 ;
V_133 = F_16 ( V_53 -> V_41 , L_72 , V_256 ,
sizeof( * V_256 ) ) ;
if ( V_133 ) {
F_10 ( L_73 ) ;
goto exit;
}
V_48 -> V_222 = F_59 ( V_256 -> V_166 ) ;
V_48 -> V_258 = V_259 ;
...
F_76 ( V_107 ) ;
memcpy ( V_160 -> V_216 , V_265 -> V_242 , V_46 ) ;
if ( V_263 . V_267 == 0 )
F_67 ( V_41 , 0 ) ;
if ( V_48 -> V_240 != V_238 ) {
...
if ( V_278 && V_263 . V_266 && ! V_48 -> V_225 &&
...
F_5 ( V_65 , L_87 , V_53 -> V_235 ) ;
V_233 = ( V_290 & V_237 ) >> 4 ;
if ( ( V_53 -> V_235 & F_66 ( V_233 ) ) == 0 )
return 0 ;
V_231 = ( T_2 * ) ( V_229 + 1 ) ;
...
V_46 ) == 0 ) {
V_291 = F_24 ( V_292 , V_99 ) ;
if ( V_291 != NULL ) {
* ( V_293 * ) V_291 = F_25 ( V_292 ) ;
if ( F_68 ( V_41 , V_294 ,
V_291 , V_292 ) == 0 ) {
V_210 = (struct V_209 * ) ( V_291 + 4 ) ;
...
F_82 ( V_107 , V_53 ) ;
V_133 = F_9 ( V_53 -> V_41 , L_91 , & V_299 ,
sizeof( V_299 ) ) ;
if ( V_133 ) {
F_10 ( L_92 , V_133 ) ;
F_82 ( V_107 , NULL ) ;
...
V_133 = F_7 ( V_53 -> V_41 , V_302 ,
V_303 ) ;
return V_133 ;
}
static int F_84 ( struct V_47 * V_48 ,
struct V_40 * V_41 , T_2 V_304 [ V_46 ] ,
enum V_296 V_146 )
{
struct V_298 V_299 ;
int V_133 ;
T_4 V_69 ;
F_80 ( V_48 , & V_69 ) ;
memcpy ( V_299 . V_239 , V_304 , V_46 ) ;
V_299 . type = F_15 ( ( T_4 ) V_146 ) ;
V_299 . V_73 = F_15 ( V_69 ) ;
V_133 = F_9 ( V_41 , L_94 , & V_299 ,
sizeof( V_299 ) ) ;
if ( V_133 )
return V_133 ;
return V_133 ;
...
struct V_134 * V_305 = F_87 ( V_107 ) ;
struct V_40 * V_41 = F_75 ( V_305 ) ;
...
struct V_40 * V_41 = F_75 ( V_305 ) ;
T_2 * V_239 = V_53 -> V_139 . V_140 -> V_49 ;
return F_9 ( V_41 , L_96 , V_239 , V_46 ) ;
}
...
return F_90 ( - V_308 ) ;
V_306 = F_91 ( V_48 -> V_107 , V_309 ,
false ) ;
if ( F_92 ( V_306 ) ) {
F_10 ( L_97 ) ;
return (struct V_177 * ) V_306 ;
}
V_50 = V_48 -> V_51 [ V_52 ] . V_53 -> V_41 ;
F_11 ( V_48 , V_239 ) ;
F_6 ( V_50 , V_48 -> V_49 ) ;
F_82 ( V_48 -> V_107 , V_306 ) ;
F_93 ( V_50 , true ) ;
...
V_307 = V_306 -> V_41 ;
V_48 -> V_51 [ V_76 ] . V_53 = V_306 ;
memcpy ( V_307 -> V_55 , V_48 -> V_49 , V_46 ) ;
memcpy ( & V_306 -> V_139 . V_312 , V_48 -> V_49 , sizeof( V_48 -> V_49 ) ) ;
V_133 = F_94 ( V_50 , L_99 , & V_289 ) ;
if ( V_133 < 0 ) {
F_10 ( L_100 ) ;
goto V_310;
}
F_95 ( V_307 -> V_289 != V_289 ) ;
F_96 ( & V_48 -> V_254 ) ;
...
struct V_177 * F_99 ( struct V_159 * V_159 , const char * V_313 ,
unsigned char V_314 ,
...
V_77 , 0 , 0 ) ;
F_76 ( V_107 ) ;
F_36 ( V_332 , & V_53 -> V_206 ) ;
F_112 ( & V_107 -> V_331 ) ;
}
}
T_3 F_114 ( struct V_132 * V_107 , bool V_333 )
{
struct V_47 * V_48 ;
struct V_40 * V_50 ;
T_3 V_133 = 0 ;
...
V_48 = & V_107 -> V_48 ;
V_48 -> V_107 = V_107 ;
V_50 = F_115 ( V_107 -> V_335 , 0 ) ;
V_48 -> V_51 [ V_52 ] . V_53 = V_50 -> V_53 ;
if ( V_333 ) {
V_334 = F_89 ( V_48 , NULL , NULL ) ;
if ( F_92 ( V_334 ) ) {
F_10 ( L_107 ) ;
V_133 = F_116 ( V_334 ) ;
}
