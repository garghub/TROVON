...
V_2 -> V_227 = V_2 -> V_154 ;
if ( V_13 [ V_182 ] . V_195 & V_228 )
F_98 ( V_40 , 0 , 2 , 0 , NULL ) ;
V_2 -> V_229 = V_230 ;
F_99 ( V_168 , V_2 ) ;
error = F_100 ( V_2 , & V_168 -> V_11 ) ;
if ( error )
goto V_214;
F_101 ( V_2 ) ;
F_102 ( V_168 ) ;
...
F_104 ( V_40 ) ;
if ( V_40 -> V_231 )
F_105 ( V_40 -> V_168 , V_40 -> V_232 , V_40 -> V_231 ,
V_40 -> V_233 ) ;
F_10 ( V_40 -> V_234 ) ;
F_106 ( V_40 , 0 ) ;
F_10 ( V_40 -> V_85 ) ;
...
static void F_109 ( struct V_10 * V_40 )
{
int V_160 ;
F_67 ( V_40 ) ;
if ( V_40 -> V_168 -> V_63 == V_169 ||
...
{
int V_160 , V_235 ;
int V_236 = V_11 -> V_115 ;
const char * V_15 = V_11 -> V_15 ;
unsigned long V_237 ;
while ( ! ( ( V_237 = F_111 ( V_11 , V_238 . V_239 ) ) & V_240 )
|| V_237 == 0xffffffff )
F_112 ( 20 ) ;
F_67 ( V_11 ) ;
F_113 ( V_11 ) ;
...
if ( V_11 -> V_241 )
F_115 ( V_11 , V_242 ) ;
if ( ! V_11 -> V_211 && V_11 -> V_241 && V_11 -> V_173 > 1 ) {
for ( V_160 = 0 ; V_160 < V_11 -> V_173 ; V_160 ++ ) {
V_11 -> V_176 [ V_160 ] . V_243 = V_160 ;
V_11 -> V_176 [ V_160 ] . V_11 = V_11 ;
if ( F_116 ( V_11 -> V_174 [ V_160 ] . V_175 ,
V_11 -> V_244 . V_245 ,
0 , L_33 , & ( V_11 -> V_176 [ V_160 ] ) ) ) {
F_25 ( V_72 L_34 ,
V_15 , V_236 , V_160 ) ;
for ( V_235 = 0 ; V_235 < V_160 ; V_235 ++ )
F_71 ( V_11 -> V_174 [ V_235 ] . V_175 ,
& ( V_11 -> V_176 [ V_235 ] ) ) ;
F_73 ( V_11 -> V_168 ) ;
goto V_246;
}
...
V_11 -> V_176 [ 0 ] . V_243 = 0 ;
V_11 -> V_176 [ 0 ] . V_11 = V_11 ;
if ( F_116 ( V_11 -> V_168 -> V_177 , V_11 -> V_244 . V_245 ,
V_247 , L_33 ,
& ( V_11 -> V_176 [ 0 ] ) ) < 0 ) {
if ( V_11 -> V_142 )
F_72 ( V_11 -> V_168 ) ;
...
F_117 ( V_11 ) ;
if ( ! V_11 -> V_211 ) {
V_11 -> V_209 -> V_248 = F_26 ( V_11 -> V_173 ) ;
F_118 ( V_11 ) ;
}
return 0 ;
V_246:
...
static int F_119 ( struct V_180 * V_168 , T_6 V_249 )
{
struct V_1 * V_2 = F_120 ( V_168 ) ;
...
F_103 ( V_168 ) ;
F_108 ( V_168 ) ;
F_122 ( V_168 , F_123 ( V_168 , V_249 ) ) ;
return 0 ;
}
static int F_124 ( struct V_180 * V_168 )
{
struct V_1 * V_2 = F_120 ( V_168 ) ;
struct V_10 * V_40 = (struct V_10 * ) V_2 -> V_12 ;
int V_5 ;
...
static void F_128 ( struct V_180 * V_11 )
{
struct V_1 * V_2 = F_120 ( V_11 ) ;
F_121 ( V_2 ) ;
F_63 ( (struct V_10 * ) V_2 -> V_12 ) ;
}
static void F_129 ( struct V_180 * V_168 )
{
struct V_1 * V_2 = F_120 ( V_168 ) ;
struct V_10 * V_40 = (struct V_10 * ) V_2 -> V_12 ;
F_130 ( V_2 ) ;
...
static void F_134 ( struct V_10 * V_40 )
{
int V_160 ;
struct V_3 * V_4 ;
...
static T_7 F_136 ( struct V_180 * V_168 ,
enum V_258 error )
{
struct V_1 * V_2 = F_120 ( V_168 ) ;
struct V_10 * V_40 = F_137 ( V_2 ) ;
F_138 ( & V_168 -> V_11 , L_37 , error ) ;
switch ( error ) {
case V_259 :
return V_260 ;
case V_261 :
...
{
F_138 ( & V_168 -> V_11 , L_38 ) ;
return V_262 ;
}
static T_7 F_141 ( struct V_180 * V_168 )
{
F_138 ( & V_168 -> V_11 , L_39 ) ;
F_126 ( V_168 ) ;
if ( F_79 ( V_168 ) ) {
F_142 ( & V_168 -> V_11 ,
L_40 ) ;
...
F_83 ( V_168 ) ;
if ( F_143 ( V_168 ) ) {
F_138 ( & V_168 -> V_11 , L_41 ) ;
goto V_251;
}
return V_265 ;
V_251:
F_138 ( & V_168 -> V_11 , L_42 ) ;
return V_264 ;
}
static void F_144 ( struct V_180 * V_168 )
{
struct V_1 * V_2 = F_120 ( V_168 ) ;
struct V_18 * V_19 = NULL ;
struct V_10 * V_40 = (struct V_10 * ) F_137 ( V_2 ) ;
F_145 ( V_168 ) ;
if ( F_106 ( V_40 , V_40 -> V_207 ) ) {
F_138 ( & V_168 -> V_11 , L_43 ) ;
V_40 -> V_266 = V_267 ;
if ( F_106 ( V_40 , V_208 ) ) {
F_142 ( & V_168 -> V_11 ,
L_44 ) ;
