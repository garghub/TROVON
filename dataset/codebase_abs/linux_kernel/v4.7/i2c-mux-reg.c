...
V_40 = V_2 -> V_4 . V_44 ? ( V_2 -> V_4 . V_44 + V_28 ) : 0 ;
V_38 = V_2 -> V_4 . V_45 ? V_2 -> V_4 . V_45 [ V_28 ] : 0 ;
V_39 = F_38 ( V_11 , V_40 , V_2 -> V_4 . V_27 [ V_28 ] , V_38 ) ;
if ( V_39 ) {
F_15 ( & V_16 -> V_19 , L_12 , V_28 ) ;
goto V_46;
}
}
F_39 ( & V_16 -> V_19 , L_13 ,
V_2 -> V_4 . V_32 , V_11 -> V_31 -> V_47 ) ;
return 0 ;
V_46:
F_40 ( V_11 ) ;
return V_39 ;
