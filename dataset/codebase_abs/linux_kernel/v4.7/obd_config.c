...
V_201 = F_101 () ;
F_102 ( V_202 ) ;
V_16 = ( V_183 -> V_199 -> V_200 ) ( & V_185 , V_188 ,
V_191 , NULL ) ;
F_102 ( V_201 ) ;
}
break;
...
int F_103 ( const struct V_203 * V_204 ,
struct V_205 * V_206 ,
...
if ( V_20 -> V_223 == F_104 ( V_224 ) ) {
F_105 ( V_20 ) ;
V_222 = 1 ;
}
V_16 = F_106 ( V_213 , V_211 ) ;
if ( V_16 )
goto V_28;
if ( V_20 -> V_144 == V_156 ) {
...
if ( V_210 && ! V_210 -> V_235 &&
V_20 -> V_144 == V_240 ) {
F_112 ( & V_218 , 2 , V_218 . V_241 [ 1 ] ,
V_218 . V_242 [ 1 ] ) ;
F_112 ( & V_218 , 1 , V_218 . V_241 [ 0 ] ,
V_218 . V_242 [ 0 ] ) ;
F_111 ( & V_218 , 0 ,
V_210 -> V_243 ) ;
}
V_216 = F_113 ( V_20 -> V_144 , & V_218 ) ;
...
V_216 -> V_147 =
F_114 ( F_115 ( V_20 -> V_245 , 0 ) , V_246 ) ;
F_93 ( L_80 ,
V_20 -> V_245 , V_246 ,
F_88 ( V_216 -> V_147 ) ) ;
} else {
...
F_117 ( NULL , V_206 , V_208 , V_182 ) ;
}
return V_16 ;
}
int F_118 ( const struct V_203 * V_204 , struct V_249 * V_250 ,
...
int V_16 ;
F_8 ( V_11 , L_83 , V_24 ) ;
V_16 = F_119 ( V_204 , V_250 , & V_254 , NULL , V_24 , V_256 ) ;
if ( V_16 )
return V_16 ;
V_16 = F_120 ( V_204 , V_254 , V_257 , NULL ) ;
if ( V_16 )
goto V_258;
if ( V_251 ) {
...
V_253 . V_262 = 0 ;
V_16 = F_121 ( V_204 , V_254 , V_255 , V_251 , & V_253 ) ;
F_8 ( V_91 , L_84 , V_24 ,
...
static int F_123 ( struct V_207 * V_208 , char * V_1 ,
int V_263 )
{
...
if ( V_20 -> V_147 ) {
char V_264 [ V_265 ] ;
F_124 ( V_20 -> V_147 , V_264 , sizeof( V_264 ) ) ;
...
V_4 += snprintf ( V_4 , V_141 - V_4 , L_91 ) ;
V_16 = V_4 - V_1 ;
return V_16 ;
}
int F_117 ( const struct V_203 * V_204 ,
struct V_205 * V_206 ,
struct V_207 * V_208 , void * V_182 )
{
char * V_266 ;
...
F_123 ( V_208 , V_266 , 256 ) ;
F_125 ( V_267 , L_92 , V_266 ) ;
} else {
F_125 ( V_267 , L_93 , V_208 -> V_214 ) ;
V_16 = - V_9 ;
}
F_74 ( V_266 ) ;
return V_16 ;
}
int F_126 ( struct V_21 * V_22 )
{
char V_268 [ 3 ] = L_94 ;
struct V_19 * V_20 ;
struct V_217 V_218 ;
...
F_8 ( V_91 , L_98 ,
V_22 -> V_31 , V_268 ) ;
F_127 ( & V_218 , V_22 -> V_31 ) ;
F_111 ( & V_218 , 1 , V_268 ) ;
V_20 = F_113 ( V_171 , & V_218 ) ;
if ( ! V_20 )
return - V_70 ;
V_16 = F_87 ( V_20 ) ;
if ( V_16 ) {
...
V_16 = F_87 ( V_20 ) ;
if ( V_16 )
F_16 ( L_100 , V_16 , V_22 -> V_31 ) ;
V_28:
F_116 ( V_20 ) ;
return V_16 ;
}
static unsigned
F_128 ( struct V_270 * V_271 , const void * V_2 , unsigned V_272 )
{
return F_129 ( ( (struct V_48 * ) V_2 ) -> V_25 ,
sizeof( ( (struct V_48 * ) V_2 ) -> V_25 ) , V_272 ) ;
}
static void *
F_130 ( struct V_273 * V_274 )
{
struct V_55 * exp ;
exp = F_131 ( V_274 , struct V_55 , V_275 ) ;
return & exp -> V_276 ;
}
static int
F_132 ( const void * V_2 , struct V_273 * V_274 )
{
struct V_55 * exp ;
F_40 ( V_2 ) ;
exp = F_131 ( V_274 , struct V_55 , V_275 ) ;
return F_133 ( V_2 , & exp -> V_276 ) &&
! exp -> V_277 ;
}
static void *
F_134 ( struct V_273 * V_274 )
{
return F_131 ( V_274 , struct V_55 , V_275 ) ;
}
static void
F_135 ( struct V_270 * V_271 , struct V_273 * V_274 )
{
struct V_55 * exp ;
exp = F_131 ( V_274 , struct V_55 , V_275 ) ;
F_136 ( exp ) ;
...
static void
F_137 ( struct V_270 * V_271 , struct V_273 * V_274 )
{
struct V_55 * exp ;
exp = F_131 ( V_274 , struct V_55 , V_275 ) ;
F_44 ( exp ) ;
