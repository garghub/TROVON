...
V_51 = F_37 ( V_21 * sizeof( * V_51 ) , V_65 ) ;
if ( ! V_51 ) {
F_4 ( L_45 , V_9 ,
V_21 ) ;
F_26 ( V_57 ) ;
...
static int
F_38 ( const char * * V_54 , struct V_17 * V_18 ,
struct V_67 * V_30 )
{
...
static void F_42 ( struct V_14 * V_70 ,
struct V_67 * V_30 )
{
F_41 ( & V_70 -> V_18 , V_30 ) ;
}
static int
F_43 ( struct V_14 * V_70 , struct V_67 * V_30 )
{
V_30 -> V_71 = V_72 ;
return F_38 ( V_70 -> V_54 , & V_70 -> V_18 , V_30 ) ;
}
static void F_44 ( struct V_12 * V_13 )
{
switch ( V_13 -> type ) {
case V_20 :
F_42 ( V_13 -> V_16 . V_70 , & V_13 -> V_30 ) ;
break;
default:
break;
}
...
struct V_74 * F_49 ( struct V_12 * V_13 )
{
struct V_67 * V_30 = & V_13 -> V_30 ;
struct V_74 * V_74 = NULL ;
switch ( V_13 -> type ) {
case V_20 :
if ( F_43 ( V_13 -> V_16 . V_70 , V_30 ) )
return NULL ;
break;
default:
F_4 ( L_48 , V_9 ,
...
V_2 -> V_82 = F_61 ( V_86 . V_90 , V_2 -> V_6 ) ;
if ( ! V_2 -> V_82 ) {
F_4 ( L_55 , V_9 ,
V_83 -> V_10 ) ;
goto V_88;
...
continue;
V_2 -> V_79 . V_81 [ V_60 ] = F_49 ( & V_2 -> V_91 [ V_60 ] ) ;
}
V_68 = F_63 ( V_83 , V_92 , & V_2 -> V_79 ) ;
if ( V_68 ) {
F_4 ( L_56 , V_9 ,
V_83 -> V_10 , V_68 ) ;
goto V_88;
