...
V_13 = F_118 ( V_254 , L_85 , & V_20 ) ;
if ( V_13 ) {
F_102 ( & V_29 -> V_30 , L_86 ) ;
V_20 = 8 ;
}
switch ( V_20 ) {
default:
...
V_256 -> V_229 = F_100 ( V_232 , L_88 , V_75 ) ;
V_256 ++ ;
}
...
V_20 = F_8 ( V_19 -> V_21 ) ;
if ( V_20 & ( V_306 | V_307 ) ) {
F_102 ( & V_29 -> V_30 , L_93 , V_75 ) ;
V_19 -> V_79 = true ;
}
}
F_31 ( & V_29 -> V_30 , L_94 ,
V_75 , F_7 ( V_19 ) ? L_95 : L_96 ) ;
}
...
F_136 ( V_29 , V_24 ) ;
F_109 ( V_24 ) ;
F_102 ( & V_24 -> V_29 -> V_30 , L_101 ,
F_137 ( V_29 ) , V_24 -> V_8 -> V_28 ? L_102 : L_10 , F_138 ( V_29 ) ,
