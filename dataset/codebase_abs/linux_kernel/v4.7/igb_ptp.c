...
V_185 . V_32 = F_48 ( V_185 . V_32 , V_187 ) ;
...
{
T_6 * V_186 = ( T_6 * ) V_199 ;
F_8 ( V_198 -> V_13 , F_51 ( V_201 ) ,
F_52 ( V_186 [ 1 ] ) ) ;
}
void F_53 ( struct V_197 * V_198 ,
struct V_200 * V_201 )
{
...
struct V_281 * V_282 = & V_13 -> V_283 [ V_149 ] ;
snprintf ( V_282 -> V_265 , sizeof( V_282 -> V_265 ) , L_5 , V_149 ) ;
V_282 -> V_122 = V_149 ;
V_282 -> V_155 = V_156 ;
}
snprintf ( V_13 -> V_38 . V_265 , 16 , L_4 , V_207 -> V_266 ) ;
V_13 -> V_38 . V_267 = V_268 ;
V_13 -> V_38 . V_269 = 62499999 ;
V_13 -> V_38 . V_270 = V_284 ;
V_13 -> V_38 . V_285 = V_286 ;
V_13 -> V_38 . V_287 = V_58 ;
V_13 -> V_38 . V_271 = 1 ;
V_13 -> V_38 . V_288 = V_13 -> V_283 ;
V_13 -> V_38 . V_272 = F_16 ;
V_13 -> V_38 . V_273 = F_19 ;
V_13 -> V_38 . V_173 = F_24 ;
V_13 -> V_38 . V_274 = F_28 ;
V_13 -> V_38 . V_275 = F_32 ;
V_13 -> V_38 . V_289 = F_35 ;
F_7 ( V_128 , 0x0 ) ;
break;
default:
V_13 -> V_119 = NULL ;
...
V_13 -> V_119 = F_76 ( & V_13 -> V_38 ,
& V_13 -> V_168 -> V_169 ) ;
if ( F_77 ( V_13 -> V_119 ) ) {
V_13 -> V_119 = NULL ;
F_78 ( & V_13 -> V_168 -> V_169 , L_6 ) ;
} else {
F_79 ( & V_13 -> V_168 -> V_169 , L_7 ,
V_13 -> V_207 -> V_265 ) ;
V_13 -> V_23 |= V_293 ;
}
}
