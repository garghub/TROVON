...
if ( * V_26 + V_25 > V_2 -> V_29 )
V_25 = V_2 -> V_29 - * V_26 ;
if ( V_2 -> V_14 == V_17 ) {
if ( V_27 == ( char * ) ( V_2 -> V_30 + V_2 -> V_29 ) )
V_27 = V_2 -> V_30 ;
else if ( V_27 > ( char * ) ( V_2 -> V_30 + V_2 -> V_29 ) )
V_27 -= V_2 -> V_29 ;
if ( ( V_27 + V_25 ) > ( char * ) ( V_2 -> V_30 + V_2 -> V_29 ) )
V_25 = ( char * ) ( V_2 -> V_30 + V_2 -> V_29 ) - V_27 ;
}
...
V_2 -> V_29 = F_5 ( V_2 -> V_3 + V_64 ) * 4 ;
}
F_39 ( & V_46 -> V_6 ) ;
V_54 = F_34 ( V_6 , sizeof( * V_54 ) , V_59 ) ;
if ( ! V_54 ) {
V_13 = - V_60 ;
goto V_65;
}
