...
{
return F_156 ( V_57 , V_193 , V_194 , V_21 ) ;
}
static struct V_4 *
F_157 ( struct V_97 * V_57 , struct V_192 * V_193 , int V_194 , T_8 V_195 )
{
...
V_57 -> V_167 ) ;
if ( ! ( V_5 = F_24 ( sizeof( * V_5 ) , V_195 ) ) )
goto V_196;
F_158 ( & V_5 -> V_7 , V_193 , V_57 , & V_197 ) ;
V_5 -> V_7 . V_9 = 1UL << V_8 ;
V_5 -> V_198 = V_87 -> V_159 ;
V_5 -> V_95 = NULL ;
if ( V_193 -> V_199 )
V_5 -> V_95 = V_193 -> V_200 ;
F_66 ( & V_87 -> V_92 ) ;
return & V_5 -> V_7 ;
V_196:
F_29 ( L_27 , V_46 , V_35 ) ;
...
memcpy ( string , V_201 -> V_20 , V_201 -> V_15 ) ;
string [ V_201 -> V_15 ] = '\0' ;
V_101:
F_22 () ;
return string ;
...
static int
F_161 ( struct V_4 * V_202 )
{
struct V_6 * V_6 = F_7 ( V_202 , struct V_6 , V_7 ) ;
struct V_1 * V_2 ;
unsigned long V_30 = V_32 + ( V_203 * V_38 ) ;
int V_34 = 0 ;
F_20 () ;
V_2 = F_21 ( V_6 -> V_10 ) ;
...
static int
F_163 ( struct V_192 * V_193 , struct V_4 * V_202 , int V_194 )
{
struct V_6 * V_6 = F_7 ( V_202 , struct V_6 , V_7 ) ;
struct V_1 * V_2 ;
int V_34 ;
if ( F_8 ( V_8 , & V_202 -> V_9 ) )
goto V_101;
F_20 () ;
V_2 = F_21 ( V_6 -> V_10 ) ;
...
F_22 () ;
if ( ! F_8 ( V_11 , & V_202 -> V_9 ) )
return 0 ;
V_101:
if ( V_193 -> V_200 != NULL ) {
if ( V_6 -> V_95 == NULL )
return 0 ;
V_34 = strcmp ( V_193 -> V_200 , V_6 -> V_95 ) == 0 ;
goto V_204;
}
if ( V_6 -> V_95 != NULL )
return 0 ;
V_34 = F_45 ( V_202 -> V_94 , V_193 -> V_62 ) ;
V_204:
if ( V_34 == 0 )
return V_34 ;
if ( F_8 ( V_205 , & V_193 -> V_206 ) &&
( F_161 ( V_202 ) != 0 ) ) {
F_164 ( V_205 , & V_193 -> V_206 ) ;
F_10 ( V_207 , & V_193 -> V_206 ) ;
}
return V_34 ;
}
static T_9 *
F_165 ( struct V_73 * V_74 , T_9 * V_12 )
{
struct V_208 * V_209 = V_74 -> V_75 ;
struct V_4 * V_5 = V_209 -> V_76 ;
...
V_210 = V_12 ++ ;
F_33 ( & V_2 -> V_26 ) ;
V_209 -> V_218 = V_2 -> V_25 ++ ;
F_34 ( & V_2 -> V_26 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_219 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_2 -> V_23 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_209 -> V_218 ) ;
* V_12 ++ = F_166 ( ( T_2 ) V_6 -> V_198 ) ;
V_12 = F_167 ( V_12 , & V_2 -> V_42 ) ;
* V_210 = F_166 ( ( V_12 - ( V_210 + 1 ) ) << 2 ) ;
V_214 . V_220 = F_168 ( V_209 -> V_221 ,
V_209 -> V_222 . V_189 [ 0 ] . V_220 ) ;
V_214 . V_223 = ( V_224 * ) V_12 - ( V_224 * ) V_214 . V_220 ;
F_169 ( & V_214 , & V_216 ) ;
* V_12 ++ = F_166 ( V_217 ) ;
V_212 . V_20 = ( V_224 * ) ( V_12 + 1 ) ;
V_211 = F_170 ( V_2 -> V_43 , & V_216 , & V_212 ) ;
if ( V_211 == V_225 ) {
F_12 ( V_11 , & V_5 -> V_9 ) ;
} else if ( V_211 != 0 ) {
F_87 ( L_29 , V_211 ) ;
...
V_12 = F_171 ( V_12 , NULL , V_212 . V_15 ) ;
F_3 ( V_2 ) ;
return V_12 ;
V_226:
F_3 ( V_2 ) ;
...
{
struct V_4 * V_227 = V_74 -> V_75 -> V_76 ;
struct V_6 * V_6 = F_7 ( V_227 ,
struct V_6 ,
V_7 ) ;
struct V_97 * V_57 = V_227 -> V_96 ;
struct V_192 V_193 = {
. V_62 = V_227 -> V_94 ,
. V_200 = V_6 -> V_95 ,
. V_199 = ( V_6 -> V_95 != NULL ? 1 : 0 ) ,
} ;
struct V_4 * V_174 ;
V_174 = F_155 ( V_57 , & V_193 , V_228 ) ;
if ( F_17 ( V_174 ) )
return F_30 ( V_174 ) ;
...
V_229 = V_6 -> V_71 ;
V_230 = V_229 + V_231 * V_38 ;
if ( F_174 ( V_31 , V_229 , V_230 ) )
return 1 ;
}
return 0 ;
}
...
static T_9 *
F_177 ( struct V_73 * V_74 , T_9 * V_12 )
{
struct V_4 * V_5 = V_74 -> V_75 -> V_76 ;
struct V_1 * V_2 = F_19 ( V_5 ) ;
T_9 V_232 ;
...
F_29 ( L_28 , V_74 -> V_98 , V_46 ) ;
V_233 = F_178 ( * V_12 ++ ) ;
if ( ( V_15 = F_178 ( * V_12 ++ ) ) > V_234 )
goto V_235;
if ( V_233 != V_217 )
goto V_235;
V_232 = F_166 ( V_74 -> V_75 -> V_218 ) ;
V_214 . V_220 = & V_232 ;
V_214 . V_223 = sizeof( V_232 ) ;
F_169 ( & V_214 , & V_216 ) ;
V_212 . V_20 = ( V_224 * ) V_12 ;
V_212 . V_15 = V_15 ;
V_34 = F_15 ( - V_41 ) ;
V_211 = F_179 ( V_2 -> V_43 , & V_216 , & V_212 ) ;
if ( V_211 == V_225 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_211 ) {
F_29 ( L_30 ,
V_74 -> V_98 , V_46 , V_211 ) ;
goto V_235;
}
V_5 -> V_96 -> V_236 = F_180 ( V_15 ) + 2 ;
F_3 ( V_2 ) ;
F_29 ( L_31 ,
V_74 -> V_98 , V_46 ) ;
...
static void F_181 ( T_10 V_237 , struct V_208 * V_238 ,
T_9 * V_12 , void * V_239 )
{
struct V_240 V_241 ;
F_182 ( & V_241 , & V_238 -> V_222 , V_12 ) ;
V_237 ( V_238 , & V_241 , V_239 ) ;
}
static inline int
F_183 ( struct V_4 * V_5 , struct V_1 * V_2 ,
T_10 V_237 , struct V_208 * V_238 ,
T_9 * V_12 , void * V_239 )
{
struct V_215 * V_242 = & V_238 -> V_222 ;
struct V_215 V_243 ;
T_9 * V_244 = NULL ;
struct V_18 V_212 ;
T_2 V_245 ;
...
int V_246 = - V_122 ;
V_244 = V_12 ++ ;
V_245 = ( V_224 * ) V_12 - ( V_224 * ) V_242 -> V_189 [ 0 ] . V_220 ;
* V_12 ++ = F_166 ( V_238 -> V_218 ) ;
F_181 ( V_237 , V_238 , V_12 , V_239 ) ;
if ( F_184 ( V_242 , & V_243 ,
V_245 , V_242 -> V_15 - V_245 ) )
return V_246 ;
* V_244 = F_166 ( V_243 . V_15 ) ;
if ( V_242 -> V_247 || V_242 -> V_248 [ 0 ] . V_223 )
V_214 = V_242 -> V_248 ;
else
V_214 = V_242 -> V_189 ;
V_12 = V_214 -> V_220 + V_214 -> V_223 ;
V_212 . V_20 = ( V_224 * ) ( V_12 + 1 ) ;
V_211 = F_170 ( V_2 -> V_43 , & V_243 , & V_212 ) ;
V_246 = - V_122 ;
if ( V_211 == V_225 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
else if ( V_211 )
return V_246 ;
V_16 = F_171 ( V_12 , NULL , V_212 . V_15 ) ;
V_245 = ( V_224 * ) V_16 - ( V_224 * ) V_12 ;
V_214 -> V_223 += V_245 ;
V_242 -> V_15 += V_245 ;
return 0 ;
}
static void
F_185 ( struct V_208 * V_238 )
{
int V_249 ;
for ( V_249 = 0 ; V_249 < V_238 -> V_250 ; V_249 ++ )
F_186 ( V_238 -> V_251 [ V_249 ] ) ;
F_42 ( V_238 -> V_251 ) ;
}
static int
F_187 ( struct V_208 * V_238 )
{
struct V_215 * V_242 = & V_238 -> V_222 ;
int V_252 , V_253 , V_249 ;
if ( V_242 -> V_247 == 0 ) {
V_238 -> V_250 = 0 ;
return 0 ;
}
V_252 = V_242 -> V_254 >> V_255 ;
V_253 = ( V_242 -> V_254 + V_242 -> V_247 - 1 ) >> V_255 ;
V_238 -> V_250 = V_253 - V_252 + 1 + 1 ;
V_238 -> V_251
= F_83 ( V_238 -> V_250 * sizeof( struct V_256 * ) ,
V_21 ) ;
if ( ! V_238 -> V_251 )
goto V_101;
for ( V_249 = 0 ; V_249 < V_238 -> V_250 ; V_249 ++ ) {
V_238 -> V_251 [ V_249 ] = F_188 ( V_21 ) ;
if ( V_238 -> V_251 [ V_249 ] == NULL )
goto V_257;
}
V_238 -> V_258 = F_185 ;
return 0 ;
...
return V_246 ;
V_252 = V_242 -> V_254 >> V_255 ;
V_260 = V_242 -> V_263 + V_252 ;
V_242 -> V_263 = V_238 -> V_251 ;
V_242 -> V_254 -= V_252 << V_255 ;
if ( V_242 -> V_247 || V_242 -> V_248 [ 0 ] . V_223 ) {
V_262 = F_190 ( V_238 -> V_251 [ V_238 -> V_250 - 1 ] ) ;
memcpy ( V_262 , V_242 -> V_248 [ 0 ] . V_220 , V_242 -> V_248 [ 0 ] . V_223 ) ;
V_242 -> V_248 [ 0 ] . V_220 = V_262 ;
}
V_211 = F_191 ( V_2 -> V_43 , V_245 , V_242 , V_260 ) ;
F_38 ( V_242 -> V_15 > V_242 -> V_83 ) ;
V_246 = - V_122 ;
if ( V_211 == V_225 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
else if ( V_211 )
return V_246 ;
* V_259 = F_166 ( V_242 -> V_15 - V_245 ) ;
if ( V_242 -> V_247 || V_242 -> V_248 [ 0 ] . V_223 )
V_214 = V_242 -> V_248 ;
else
V_214 = V_242 -> V_189 ;
V_12 = V_214 -> V_220 + V_214 -> V_223 ;
V_261 = 3 - ( ( V_242 -> V_15 - V_245 - 1 ) & 3 ) ;
memset ( V_12 , 0 , V_261 ) ;
V_214 -> V_223 += V_261 ;
V_242 -> V_15 += V_261 ;
return 0 ;
...
T_10 V_237 , void * V_238 , T_9 * V_12 , void * V_239 )
{
struct V_4 * V_5 = V_74 -> V_75 -> V_76 ;
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 ,
V_7 ) ;
...
break;
case V_265 :
V_246 = F_183 ( V_5 , V_2 , V_237 , V_238 , V_12 , V_239 ) ;
break;
case V_266 :
V_246 = F_189 ( V_5 , V_2 , V_237 , V_238 , V_12 , V_239 ) ;
break;
}
V_101:
F_3 ( V_2 ) ;
F_29 ( L_33 , V_74 -> V_98 , V_46 , V_246 ) ;
return V_246 ;
}
static inline int
F_193 ( struct V_4 * V_5 , struct V_1 * V_2 ,
struct V_208 * V_238 , T_9 * * V_12 )
{
struct V_215 * V_267 = & V_238 -> V_268 ;
struct V_215 V_243 ;
struct V_18 V_212 ;
T_2 V_269 , V_270 ;
T_2 V_244 ;
...
if ( V_244 & 3 )
return V_246 ;
V_269 = ( V_224 * ) ( * V_12 ) - ( V_224 * ) V_267 -> V_189 [ 0 ] . V_220 ;
V_270 = V_244 + V_269 ;
if ( V_270 > V_267 -> V_15 )
return V_246 ;
if ( F_178 ( * ( * V_12 ) ++ ) != V_238 -> V_218 )
return V_246 ;
if ( F_184 ( V_267 , & V_243 , V_269 ,
V_270 - V_269 ) )
return V_246 ;
if ( F_194 ( V_267 , & V_212 , V_270 ) )
return V_246 ;
V_211 = F_179 ( V_2 -> V_43 , & V_243 , & V_212 ) ;
if ( V_211 == V_225 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_211 != V_271 )
return V_246 ;
...
int V_246 = - V_122 ;
V_259 = F_178 ( * ( * V_12 ) ++ ) ;
V_245 = ( V_224 * ) ( * V_12 ) - ( V_224 * ) V_267 -> V_189 [ 0 ] . V_220 ;
if ( V_245 + V_259 > V_267 -> V_15 )
return V_246 ;
V_267 -> V_15 = V_245 + V_259 ;
V_211 = F_196 ( V_2 -> V_43 , V_245 , V_267 ) ;
if ( V_211 == V_225 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_211 != V_271 )
return V_246 ;
...
static int
F_197 ( T_11 V_272 , struct V_208 * V_238 ,
T_9 * V_12 , void * V_239 )
{
struct V_240 V_241 ;
F_198 ( & V_241 , & V_238 -> V_268 , V_12 ) ;
return V_272 ( V_238 , & V_241 , V_239 ) ;
}
static int
F_199 ( struct V_73 * V_74 ,
T_11 V_272 , void * V_238 , T_9 * V_12 , void * V_239 )
{
struct V_4 * V_5 = V_74 -> V_75 -> V_76 ;
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 ,
V_7 ) ;
struct V_1 * V_2 = F_19 ( V_5 ) ;
T_9 * V_273 = V_12 ;
struct V_213 * V_189 = ( (struct V_208 * ) V_238 ) -> V_268 . V_189 ;
int V_274 = V_189 -> V_223 ;
int V_246 = - V_122 ;
if ( V_2 -> V_23 != V_24 )
goto V_275;
switch ( V_6 -> V_198 ) {
...
break;
case V_265 :
V_246 = F_193 ( V_5 , V_2 , V_238 , & V_12 ) ;
if ( V_246 )
goto V_101;
break;
case V_266 :
V_246 = F_195 ( V_5 , V_2 , V_238 , & V_12 ) ;
if ( V_246 )
goto V_101;
break;
}
V_5 -> V_96 -> V_163 = V_5 -> V_96 -> V_236 + ( V_12 - V_273 )
+ ( V_274 - V_189 -> V_223 ) ;
V_275:
V_246 = F_197 ( V_272 , V_238 , V_12 , V_239 ) ;
V_101:
F_3 ( V_2 ) ;
F_29 ( L_33 ,
V_74 -> V_98 , V_46 , V_246 ) ;
return V_246 ;
}
static T_12 int F_200 ( struct V_47 * V_47 )
{
return F_201 ( V_47 ) ;
}
static T_13 void F_202 ( struct V_47 * V_47 )
{
F_203 ( V_47 ) ;
}
static int T_14 F_204 ( void )
{
int V_35 = 0 ;
V_35 = F_205 ( & V_166 ) ;
if ( V_35 )
