...
static inline unsigned long F_41 ( struct V_1 * V_2 ,
...
if ( F_51 ( V_35 ) )
continue;
V_16 += F_41 ( V_2 , V_35 , V_4 , V_27 , V_11 ,
V_12 , V_5 ) ;
...
unsigned long F_54 ( struct V_1 * V_2 , unsigned long V_36 ,
unsigned long V_10 , T_4 V_11 ,
int V_12 , int V_5 )
{
unsigned long V_16 ;
if ( F_55 ( V_2 ) )
V_16 = F_56 ( V_2 , V_36 , V_10 , V_11 ) ;
else
V_16 = F_45 ( V_2 , V_36 , V_10 , V_11 , V_12 , V_5 ) ;
return V_16 ;
}
int
F_57 ( struct V_1 * V_2 , struct V_1 * * V_37 ,
...
* V_37 = F_60 ( V_14 , * V_37 , V_36 , V_10 , V_38 ,
V_2 -> V_52 , V_2 -> V_53 , V_43 , F_61 ( V_2 ) ,
V_2 -> V_54 ) ;
if ( * V_37 ) {
V_2 = * V_37 ;
goto V_55;
...
* V_37 = V_2 ;
if ( V_36 != V_2 -> V_51 ) {
error = F_62 ( V_14 , V_2 , V_36 , 1 ) ;
if ( error )
goto V_56;
}
if ( V_10 != V_2 -> V_57 ) {
error = F_62 ( V_14 , V_2 , V_10 , 0 ) ;
if ( error )
goto V_56;
}
V_55:
...
V_12 = F_63 ( V_2 ) ;
F_64 ( V_2 ) ;
F_54 ( V_2 , V_36 , V_10 , V_2 -> V_58 ,
V_12 , 0 ) ;
if ( ( V_39 & ( V_44 | V_48 | V_59 ) ) == V_59 &&
( V_38 & V_44 ) ) {
F_65 ( V_2 , V_36 , V_10 , NULL ) ;
}
F_66 ( V_14 , V_39 , - V_40 ) ;
F_66 ( V_14 , V_38 , V_40 ) ;
F_67 ( V_2 ) ;
