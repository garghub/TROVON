...
! ( V_16 -> V_103 & V_224 ) )
V_209 -> string = F_61 ( V_16 , V_209 -> V_20 . V_225 ) ;
F_104 ( V_16 ) ;
F_140 ( V_16 ) ;
for ( V_61 = 0 ; V_61 < V_212 ; ++ V_61 ) {
...
static void F_143 ( struct V_205 * V_226 )
{
struct V_227 * V_228 =
F_122 ( V_226 , struct V_227 , V_226 ) ;
struct V_22 * V_116 = V_228 -> V_116 ;
F_144 ( V_116 ) ;
F_28 ( & V_229 ) ;
F_145 ( & V_228 -> V_230 ) ;
F_30 ( & V_229 ) ;
if ( V_228 -> V_173 >= - 1 )
F_127 ( V_116 , V_228 -> V_173 ) ;
F_125 ( V_116 ) ;
F_112 ( V_116 ) ;
F_20 ( V_228 ) ;
}
...
V_228 -> V_116 = V_116 ;
V_228 -> V_173 = V_173 ;
F_135 ( & V_228 -> V_226 , F_143 ) ;
F_28 ( & V_229 ) ;
F_148 ( & V_228 -> V_230 , & V_231 ) ;
F_30 ( & V_229 ) ;
F_139 ( V_116 ) ;
F_149 ( & V_228 -> V_226 ) ;
return 0 ;
