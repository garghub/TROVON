...
struct V_30 * V_31 ;
int V_32 ;
V_28 = F_26 ( V_18 -> V_18 , sizeof( * V_28 ) , V_33 ) ;
if ( ! V_28 )
return - V_34 ;
V_28 -> V_12 = V_12 ;
F_27 ( & V_28 -> V_5 ,
& V_35 ) ;
V_32 = F_28 ( V_18 , & V_28 -> V_5 ,
& V_36 ,
V_37 , NULL ) ;
if ( V_32 )
return V_32 ;
