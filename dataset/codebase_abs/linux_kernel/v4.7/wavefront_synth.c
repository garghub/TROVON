...
F_11 ( V_92 , L_47 ,
V_89 -> V_93 ) ;
if ( V_89 -> V_93 >= F_25 ( V_9 -> V_74 ) )
return - V_94 ;
V_9 -> V_74 [ V_89 -> V_93 ] |= V_61 ;
V_91 = V_90 ;
V_91 = F_16 ( V_89 -> V_93 , V_90 , 2 ) ;
F_18 ( ( unsigned char * ) & V_89 -> V_95 . V_70 , V_91 , V_68 ) ;
if ( F_14 ( V_9 , V_96 , NULL , V_90 ) ) {
F_15 ( L_48 ) ;
return - V_97 ;
}
return ( 0 ) ;
...
static int
F_26 ( T_1 * V_9 , T_4 * V_89 )
{
unsigned char V_90 [ V_79 + 1 ] ;
int V_2 ;
F_11 ( V_92 , L_49 ,
V_89 -> V_93 ) ;
if ( V_89 -> V_93 >= F_25 ( V_9 -> V_84 ) )
return - V_94 ;
V_9 -> V_84 [ V_89 -> V_93 ] = V_77 ;
for ( V_2 = 0 ; V_2 < V_85 ; V_2 ++ ) {
if ( V_89 -> V_95 . V_98 . V_86 [ V_2 ] . V_87 ) {
V_9 -> V_74 [ V_89 -> V_95 . V_98 . V_86 [ V_2 ] . V_88 ] |=
V_77 ;
}
}
V_90 [ 0 ] = V_89 -> V_93 ;
F_18 ( ( unsigned char * ) & V_89 -> V_95 . V_98 , & V_90 [ 1 ] , V_79 ) ;
if ( F_14 ( V_9 , V_99 , NULL , V_90 ) ) {
F_15 ( L_48 ) ;
return - V_97 ;
}
return ( 0 ) ;
...
T_5 T_6 * V_105 = NULL ;
unsigned int V_2 ;
const unsigned int V_106 = 4096 / 2 ;
unsigned int V_107 ;
unsigned int V_108 ;
int V_109 ;
int V_110 ;
...
F_11 ( V_92 , L_51
L_52 ,
V_89 -> V_116 ? L_53 : L_54 ,
V_89 -> V_93 , V_89 -> V_117 ,
V_89 -> V_116 ,
( unsigned long ) V_89 -> V_101 ) ;
if ( V_89 -> V_93 == V_118 ) {
int V_50 ;
if ( ( V_50 = F_29 ( V_9 ) ) < 0 ) {
return - V_119 ;
...
V_114 = F_30 ( & V_89 -> V_95 . V_123 ) ;
if ( V_114 > 0 && V_89 -> V_95 . V_123 . V_124 != V_125 ) {
F_15 ( L_60
L_61 ) ;
return - V_94 ;
}
...
F_11 ( V_92 , L_62
L_63 ,
F_30 ( & V_89 -> V_95 . V_123 ) ,
V_115 , V_114 ) ;
F_31 ( & V_89 -> V_95 . V_123 , 0 ) ;
V_104 = V_89 -> V_116 / 2 ;
V_113 = & V_111 [ 0 ] ;
V_113 = F_16 ( V_89 -> V_93 , V_113 , 2 ) ;
if ( V_89 -> V_116 ) {
V_113 = F_16 ( V_104 , V_113 , 4 ) ;
}
V_113 = F_16 ( * ( ( T_7 * ) & V_89 -> V_95 . V_123 . V_126 ) ,
V_113 , 4 ) ;
V_113 = F_16 ( * ( ( T_7 * ) & V_89 -> V_95 . V_123 . V_127 ) ,
V_113 , 4 ) ;
V_113 = F_16 ( * ( ( T_7 * ) & V_89 -> V_95 . V_123 . V_128 ) ,
V_113 , 4 ) ;
V_113 = F_16 ( * ( ( T_7 * ) & V_89 -> V_95 . V_123 . V_129 ) ,
V_113 , 4 ) ;
V_113 = F_16 ( V_89 -> V_95 . V_123 . V_130 , V_113 , 3 ) ;
V_113 = F_16 ( * ( & V_89 -> V_95 . V_123 . V_130 + 1 ) ,
V_113 , 2 ) ;
if ( F_14 ( V_9 ,
V_89 -> V_116 ?
V_131 : V_132 ,
...
V_101 += V_115 ;
for ( V_107 = 0 , V_110 = 0 ;
V_107 < V_104 ; V_107 += V_106 , V_110 ++ ) {
if ( ( V_104 - V_107 ) > V_106 ) {
V_108 = V_106 ;
} else {
V_108 = F_32 ( V_104 - V_107 , 8 ) ;
}
...
if ( V_2 < V_108 - 1 ) {
F_35 ( V_103 , V_9 -> V_135 ) ;
} else {
F_35 ( V_103 , V_9 -> V_136 ) ;
}
}
if ( ( V_109 = F_10 ( V_9 ) ) != V_137 ) {
if ( V_109 == - 1 ) {
F_15 ( L_67
L_68 ) ;
return - V_97 ;
...
L_71 ,
V_89 -> V_93 ,
V_89 -> V_95 . V_140 . V_141 ) ;
F_16 ( V_89 -> V_93 , & V_138 [ 0 ] , 2 ) ;
F_16 ( V_89 -> V_95 . V_140 . V_141 , & V_138 [ 2 ] , 2 ) ;
F_16 ( * ( ( unsigned int * ) & V_89 -> V_95 . V_140 . V_126 ) ,
& V_138 [ 4 ] , 4 ) ;
F_16 ( * ( ( unsigned int * ) & V_89 -> V_95 . V_140 . V_127 ) ,
& V_138 [ 8 ] , 4 ) ;
F_16 ( * ( ( unsigned int * ) & V_89 -> V_95 . V_140 . V_128 ) ,
& V_138 [ 12 ] , 4 ) ;
F_16 ( * ( ( unsigned int * ) & V_89 -> V_95 . V_140 . V_129 ) ,
& V_138 [ 16 ] , 4 ) ;
F_16 ( V_89 -> V_95 . V_140 . V_130 , & V_138 [ 20 ] , 3 ) ;
F_16 ( * ( & V_89 -> V_95 . V_140 . V_130 + 1 ) , & V_138 [ 23 ] , 2 ) ;
...
static int
F_37 ( T_1 * V_9 , T_4 * V_89 )
{
int V_2 ;
int V_143 ;
unsigned char * V_144 ;
V_144 = F_38 ( V_145 , V_146 ) ;
if ( ! V_144 )
return - V_119 ;
F_16 ( V_89 -> V_93 , & V_144 [ 0 ] , 2 ) ;
V_143 = ( 1 << ( V_89 -> V_95 . V_147 . V_148 & 7 ) ) ;
V_144 [ 2 ] = ( unsigned char ) V_89 -> V_95 . V_147 . V_148 ;
F_11 ( V_92 , L_73 ,
V_89 -> V_93 ,
V_89 -> V_95 . V_147 . V_148 ,
V_143 ) ;
for ( V_2 = 0 ; V_2 < V_143 ; V_2 ++ ) {
F_11 ( V_92 | V_20 , L_74 ,
V_2 , V_89 -> V_95 . V_147 . V_149 [ V_2 ] ) ;
F_16 ( V_89 -> V_95 . V_147 . V_149 [ V_2 ] ,
& V_144 [ 3 + ( V_2 * 2 ) ] , 2 ) ;
}
if ( F_14 ( V_9 , V_28 ,
...
static int
F_41 ( T_1 * V_9 , T_4 * V_89 )
{
unsigned char V_154 [ V_155 ] ;
T_8 * V_156 = & V_89 -> V_95 . V_152 ;
int V_2 ;
F_11 ( V_92 , L_81
L_82 ,
...
static int
F_42 ( T_1 * V_9 , const char T_6 * V_159 )
{
T_4 * V_89 ;
int V_40 ;
V_89 = F_38 ( sizeof( * V_89 ) , V_146 ) ;
if ( ! V_89 )
return - V_119 ;
if ( F_43 ( V_89 , V_159 , sizeof( T_4 ) -
sizeof( V_160 ) ) ) {
F_15 ( L_85 ) ;
V_40 = - V_161 ;
goto V_162;
...
switch ( V_89 -> V_117 ) {
case V_64 :
if ( F_43 ( & V_89 -> V_95 . V_123 , V_89 -> V_163 ,
sizeof ( V_164 ) ) ) {
V_40 = - V_161 ;
break;
}
V_40 = F_28 ( V_9 , V_89 , V_89 -> V_101 , 0 ) ;
break;
case V_65 :
if ( F_43 ( & V_89 -> V_95 . V_123 , V_89 -> V_163 ,
sizeof ( V_165 ) ) ) {
...
break;
case V_66 :
if ( F_43 ( & V_89 -> V_95 . V_140 , V_89 -> V_163 ,
sizeof ( V_166 ) ) ) {
V_40 = - V_161 ;
break;
}
...
break;
case V_167 :
if ( F_43 ( & V_89 -> V_95 . V_152 , V_89 -> V_163 ,
sizeof ( T_8 ) ) ) {
V_40 = - V_161 ;
break;
}
...
break;
case V_168 :
if ( F_43 ( & V_89 -> V_95 . V_70 , V_89 -> V_163 ,
sizeof ( T_2 ) ) ) {
V_40 = - V_161 ;
break;
}
...
break;
case V_169 :
if ( F_43 ( & V_89 -> V_95 . V_98 , V_89 -> V_163 ,
sizeof ( T_3 ) ) ) {
V_40 = - V_161 ;
break;
}
...
T_9 * V_170 ;
V_170 = V_90 ;
* ( ( T_7 * ) & V_123 . V_126 ) = F_17 ( V_170 , 4 ) ; V_170 += 4 ;
* ( ( T_7 * ) & V_123 . V_127 ) = F_17 ( V_170 , 4 ) ; V_170 += 4 ;
* ( ( T_7 * ) & V_123 . V_128 ) = F_17 ( V_170 , 4 ) ; V_170 += 4 ;
* ( ( T_7 * ) & V_123 . V_129 ) = F_17 ( V_170 , 4 ) ; V_170 += 4 ;
* ( ( T_7 * ) & V_123 . V_130 ) = F_17 ( V_170 , 3 ) ; V_170 += 3 ;
V_123 . V_124 = * V_170 & 0x3 ;
V_123 . V_171 = * V_170 & 0x8 ;
V_123 . V_172 = * V_170 & 0x10 ;
V_123 . V_173 = * V_170 & 0x40 ;
memcpy ( V_90 , ( unsigned char * ) & V_123 , sizeof ( V_164 ) ) ;
}
static int
F_45 ( T_10 * V_174 ,
T_11 * V_175 )
...
int
F_48 ( struct V_193 * V_194 , struct V_195 * V_195 )
{
if ( ! F_49 ( V_194 -> V_196 -> V_197 ) )
return - V_161 ;
V_195 -> V_198 = V_194 ;
return 0 ;
}
int
F_50 ( struct V_193 * V_194 , struct V_195 * V_195 )
{
F_51 ( V_194 -> V_196 -> V_197 ) ;
return 0 ;
}
int
F_52 ( struct V_193 * V_194 , struct V_195 * V_195 ,
...
break;
case V_204 :
V_175 = F_54 ( V_201 , sizeof( * V_175 ) ) ;
if ( F_55 ( V_175 ) )
return F_56 ( V_175 ) ;
if ( F_45 ( V_174 , V_175 ) < 0 )
V_40 = - V_97 ;
else if ( F_57 ( V_201 , V_175 , sizeof ( * V_175 ) ) )
V_40 = - V_161 ;
else
V_40 = 0 ;
F_39 ( V_175 ) ;
...
F_64 ( & V_215 , V_12 ) ;
F_65 ( & V_9 -> V_207 ) ;
F_66 ( & V_9 -> V_210 , & V_215 ) ;
V_9 -> V_208 = 0 ;
F_13 ( V_153 , V_213 ) ;
F_67 ( & V_9 -> V_207 ) ;
while ( ! V_9 -> V_208 && F_68 ( V_216 , V_214 ) ) {
F_69 ( 1 ) ;
F_70 () ;
}
}
...
int V_212 ;
int V_217 [ 2 ] ;
V_212 = F_62 ( V_9 -> V_211 ) ;
F_13 ( 0x0 , V_9 -> V_179 ) ;
F_13 ( 0x80 | 0x40 | V_212 , V_9 -> V_19 ) ;
F_63 ( V_9 , 0x80 | 0x40 | 0x10 | 0x1 ,
V_9 -> V_179 ,
( V_218 * V_16 ) / 100 ) ;
if ( ! V_9 -> V_208 ) {
F_15 ( L_102 ) ;
...
static int
F_72 ( T_1 * V_9 , char * V_222 )
{
const unsigned char * V_90 ;
int V_223 , V_40 ;
int V_224 = 0 ;
const struct V_225 * V_225 ;
V_40 = F_73 ( & V_225 , V_222 , V_9 -> V_196 -> V_9 ) ;
if ( V_40 < 0 ) {
...
if ( ( V_9 -> V_122 = F_27 ( V_9 ) ) < 0 ) {
goto V_219;
}
F_15 ( L_121 , V_9 -> V_122 / 1024 ) ;
if ( F_12 ( V_9 , 0xf0 ) ||
F_12 ( V_9 , 1 ) ||
( F_10 ( V_9 ) < 0 ) ) {
V_9 -> V_187 = 0 ;
