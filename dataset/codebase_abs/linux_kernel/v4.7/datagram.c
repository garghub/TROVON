...
V_94 = F_41 ( V_87 ) ;
if ( sin && F_56 ( V_94 ) ) {
const unsigned char * V_139 = F_42 ( V_87 ) ;
sin -> V_59 = V_64 ;
sin -> V_65 = 0 ;
sin -> V_77 = V_94 -> V_88 ;
if ( V_87 -> V_97 == F_40 ( V_98 ) ) {
const struct V_111 * V_140 = F_65 ( (struct V_1 * ) ( V_139 + V_94 -> V_110 ) ,
struct V_111 , V_14 ) ;
sin -> V_67 = V_140 -> V_14 ;
if ( V_11 -> V_39 )
sin -> V_65 = F_66 ( V_140 ) ;
...
F_72 ( V_129 , V_143 , V_144 , sizeof( V_134 ) , & V_134 ) ;
V_129 -> V_137 |= V_145 ;
V_38 = V_135 ;
F_73 ( V_87 ) ;
V_42:
...
int F_74 ( struct V_6 * V_7 , struct V_128 * V_129 , int V_130 ,
int * V_54 )
{
struct V_10 * V_11 = F_5 ( V_7 ) ;
struct V_86 * V_87 ;
...
F_72 ( V_129 , V_143 , V_147 , sizeof( V_117 ) , & V_117 ) ;
V_38 = V_135 ;
V_146:
F_46 ( V_87 ) ;
V_42:
...
if ( V_151 . V_28 >= 0 )
F_72 ( V_129 , V_143 , V_153 ,
sizeof( V_151 ) , & V_151 ) ;
}
}
void F_69 ( struct V_6 * V_7 , struct V_128 * V_129 ,
struct V_86 * V_87 )
{
struct V_10 * V_11 = F_5 ( V_7 ) ;
struct V_154 * V_35 = F_58 ( V_87 ) ;
unsigned char * V_139 = F_42 ( V_87 ) ;
if ( V_11 -> V_118 . V_119 . V_155 ) {
int V_156 = F_51 ( V_87 ) -> V_157 ;
F_72 ( V_129 , V_143 , V_158 , sizeof( V_156 ) , & V_156 ) ;
}
if ( V_11 -> V_118 . V_119 . V_159 ) {
int V_160 = F_75 ( F_51 ( V_87 ) ) ;
F_72 ( V_129 , V_143 , V_161 , sizeof( V_160 ) , & V_160 ) ;
}
if ( V_11 -> V_118 . V_119 . V_162 ) {
T_1 V_163 = F_66 ( (struct V_111 * ) V_139 ) ;
if ( V_163 )
F_72 ( V_129 , V_143 , V_164 , sizeof( V_163 ) , & V_163 ) ;
}
if ( V_11 -> V_118 . V_119 . V_165 && ( V_35 -> V_166 & V_167 ) ) {
T_4 * V_168 = V_139 + sizeof( struct V_111 ) ;
F_72 ( V_129 , V_143 , V_169 , ( V_168 [ 1 ] + 1 ) << 3 , V_168 ) ;
}
if ( V_35 -> V_170 &&
...
unsigned int V_130 ;
T_4 * V_168 = V_139 + V_173 ;
switch ( V_174 ) {
case V_175 :
V_174 = V_168 [ 0 ] ;
V_130 = ( V_168 [ 1 ] + 1 ) << 3 ;
if ( V_11 -> V_118 . V_119 . V_171 )
F_72 ( V_129 , V_143 , V_176 , V_130 , V_168 ) ;
break;
case V_177 :
V_174 = V_168 [ 0 ] ;
V_130 = ( V_168 [ 1 ] + 1 ) << 3 ;
if ( V_11 -> V_118 . V_119 . V_172 )
F_72 ( V_129 , V_143 , V_178 , V_130 , V_168 ) ;
break;
case V_179 :
V_174 = V_168 [ 0 ] ;
V_130 = ( V_168 [ 1 ] + 2 ) << 2 ;
...
V_151 . V_152 = F_51 ( V_87 ) -> V_14 ;
F_72 ( V_129 , V_143 , V_181 , sizeof( V_151 ) , & V_151 ) ;
}
if ( V_11 -> V_118 . V_119 . V_182 ) {
int V_156 = F_51 ( V_87 ) -> V_157 ;
F_72 ( V_129 , V_143 , V_183 , sizeof( V_156 ) , & V_156 ) ;
}
if ( V_11 -> V_118 . V_119 . V_184 && ( V_35 -> V_166 & V_167 ) ) {
T_4 * V_168 = V_139 + sizeof( struct V_111 ) ;
F_72 ( V_129 , V_143 , V_185 , ( V_168 [ 1 ] + 1 ) << 3 , V_168 ) ;
}
if ( V_11 -> V_118 . V_119 . V_186 && V_35 -> V_187 ) {
T_4 * V_168 = V_139 + V_35 -> V_187 ;
F_72 ( V_129 , V_143 , V_188 , ( V_168 [ 1 ] + 1 ) << 3 , V_168 ) ;
}
if ( V_11 -> V_118 . V_119 . V_189 && V_35 -> V_172 ) {
struct V_190 * V_191 = (struct V_190 * ) ( V_139 + V_35 -> V_172 ) ;
F_72 ( V_129 , V_143 , V_192 , ( V_191 -> V_193 + 1 ) << 3 , V_191 ) ;
}
if ( V_11 -> V_118 . V_119 . V_186 && V_35 -> V_194 ) {
T_4 * V_168 = V_139 + V_35 -> V_194 ;
F_72 ( V_129 , V_143 , V_188 , ( V_168 [ 1 ] + 1 ) << 3 , V_168 ) ;
}
if ( V_11 -> V_118 . V_119 . V_195 ) {
struct V_55 V_85 ;
T_2 * V_196 = ( T_2 * ) F_76 ( V_87 ) ;
if ( F_77 ( V_87 ) + 4 <= V_87 -> V_130 ) {
V_85 . V_59 = V_64 ;
...
F_67 ( & F_51 ( V_87 ) -> V_14 ,
V_35 -> V_125 ) ;
F_72 ( V_129 , V_143 , V_197 , sizeof( V_85 ) , & V_85 ) ;
}
}
}
void F_78 ( struct V_6 * V_7 , struct V_128 * V_129 ,
struct V_86 * V_87 )
{
F_68 ( V_7 , V_129 , V_87 ) ;
F_69 ( V_7 , V_129 , V_87 ) ;
}
int F_79 ( struct V_198 * V_198 , struct V_6 * V_7 ,
struct V_128 * V_129 , struct V_4 * V_5 ,
struct V_199 * V_200 , struct V_201 * V_202 )
{
struct V_150 * V_151 ;
struct V_203 * V_204 ;
struct V_190 * V_191 ;
struct V_205 * V_206 ;
struct V_34 * V_35 = V_200 -> V_35 ;
int V_130 ;
int V_38 = 0 ;
F_80 (cmsg, msg) {
int V_57 ;
...
V_38 = F_82 ( V_7 , V_129 , V_204 , V_202 ) ;
if ( V_38 )
return V_38 ;
continue;
}
if ( V_204 -> V_208 != V_143 )
continue;
switch ( V_204 -> V_210 ) {
case V_153 :
case V_181 :
{
struct V_211 * V_124 = NULL ;
if ( V_204 -> V_212 < F_83 ( sizeof( struct V_150 ) ) ) {
V_38 = - V_41 ;
goto V_207;
}
V_151 = (struct V_150 * ) F_84 ( V_204 ) ;
if ( V_151 -> V_28 ) {
if ( V_5 -> V_17 &&
V_151 -> V_28 != V_5 -> V_17 )
return - V_41 ;
...
V_57 = F_85 ( & V_151 -> V_152 ) ;
F_11 () ;
if ( V_5 -> V_17 ) {
V_124 = F_86 ( V_198 , V_5 -> V_17 ) ;
if ( ! V_124 ) {
F_14 () ;
return - V_213 ;
}
...
if ( V_57 != V_68 ) {
int V_215 = F_87 ( V_57 ) <= V_216 ;
if ( ! ( F_4 ( V_7 ) -> V_217 || F_4 ( V_7 ) -> V_218 ) &&
! F_88 ( V_198 , & V_151 -> V_152 ,
V_215 ? V_124 : NULL , 0 ) &&
! F_89 ( V_198 , V_124 ,
& V_151 -> V_152 ) )
V_38 = - V_41 ;
...
case V_164 :
if ( V_204 -> V_212 < F_83 ( 4 ) ) {
V_38 = - V_41 ;
goto V_207;
}
if ( V_5 -> V_25 & V_66 ) {
if ( ( V_5 -> V_25 ^ * ( T_1 * ) F_84 ( V_204 ) ) & ~ V_66 ) {
V_38 = - V_41 ;
goto V_207;
}
}
V_5 -> V_25 = V_66 & * ( T_1 * ) F_84 ( V_204 ) ;
break;
case V_185 :
case V_169 :
if ( V_35 -> V_219 || V_204 -> V_212 < F_83 ( sizeof( struct V_205 ) ) ) {
V_38 = - V_41 ;
goto V_207;
}
V_206 = (struct V_205 * ) F_84 ( V_204 ) ;
V_130 = ( ( V_206 -> V_193 + 1 ) << 3 ) ;
if ( V_204 -> V_212 < F_83 ( V_130 ) ) {
V_38 = - V_41 ;
goto V_207;
}
if ( ! F_90 ( V_198 -> V_220 , V_221 ) ) {
V_38 = - V_222 ;
goto V_207;
}
V_35 -> V_223 += V_130 ;
...
break;
case V_188 :
if ( V_204 -> V_212 < F_83 ( sizeof( struct V_205 ) ) ) {
V_38 = - V_41 ;
goto V_207;
}
V_206 = (struct V_205 * ) F_84 ( V_204 ) ;
...
case V_192 :
case V_178 :
if ( V_204 -> V_212 < F_83 ( sizeof( struct V_190 ) ) ) {
V_38 = - V_41 ;
goto V_207;
}
V_191 = (struct V_190 * ) F_84 ( V_204 ) ;
switch ( V_191 -> type ) {
#if F_91 ( V_228 )
case V_229 :
if ( V_191 -> V_193 != 2 ||
...
if ( ( V_191 -> V_193 >> 1 ) != V_191 -> V_230 ) {
V_38 = - V_41 ;
goto V_207;
}
V_35 -> V_223 += V_130 ;
V_35 -> V_172 = V_191 ;
if ( V_204 -> V_210 == V_192 && V_35 -> V_224 ) {
int V_231 = ( ( V_35 -> V_224 -> V_193 + 1 ) << 3 ) ;
V_35 -> V_223 += V_231 ;
V_35 -> V_227 = V_35 -> V_224 ;
V_35 -> V_224 = NULL ;
V_35 -> V_225 -= V_231 ;
}
break;
case V_183 :
case V_158 :
if ( V_204 -> V_212 != F_83 ( sizeof( int ) ) ) {
V_38 = - V_41 ;
goto V_207;
}
V_200 -> V_232 = * ( int * ) F_84 ( V_204 ) ;
if ( V_200 -> V_232 < - 1 || V_200 -> V_232 > 0xff ) {
V_38 = - V_41 ;
goto V_207;
}
break;
...
if ( V_204 -> V_212 != F_83 ( sizeof( int ) ) )
goto V_207;
V_233 = * ( int * ) F_84 ( V_204 ) ;
if ( V_233 < - 1 || V_233 > 0xff )
goto V_207;
V_38 = 0 ;
V_200 -> V_160 = V_233 ;
break;
...
void F_93 ( struct V_237 * V_238 , struct V_6 * V_239 ,
T_5 V_240 , T_5 V_241 , int V_242 )
{
const struct V_1 * V_243 , * V_244 ;
V_243 = & V_239 -> V_15 ;
V_244 = & V_239 -> V_43 ;
F_94 ( V_238 ,
L_2
L_3 ,
V_242 ,
V_244 -> V_3 [ 0 ] , V_244 -> V_3 [ 1 ] ,
V_244 -> V_3 [ 2 ] , V_244 -> V_3 [ 3 ] , V_240 ,
V_243 -> V_3 [ 0 ] , V_243 -> V_3 [ 1 ] ,
V_243 -> V_3 [ 2 ] , V_243 -> V_3 [ 3 ] , V_241 ,
V_239 -> V_82 ,
F_95 ( V_239 ) ,
F_96 ( V_239 ) ,
0 , 0L , 0 ,
F_97 ( F_98 ( V_238 ) , F_99 ( V_239 ) ) ,
0 ,
F_100 ( V_239 ) ,
F_101 ( & V_239 -> V_245 ) , V_239 ,
F_101 ( & V_239 -> V_246 ) ) ;
}
