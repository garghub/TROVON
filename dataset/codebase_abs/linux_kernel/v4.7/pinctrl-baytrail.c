...
static int F_92 ( struct V_158 * V_42 )
{
struct V_2 * V_3 = F_93 ( V_42 ) ;
F_94 ( & V_42 -> V_43 ) ;
F_78 ( & V_3 -> V_107 ) ;
F_88 ( V_3 -> V_59 ) ;
return 0 ;
...
static int F_99 ( struct V_171 * V_43 )
{
return 0 ;
}
static int F_100 ( struct V_171 * V_43 )
{
return 0 ;
}
