...
static struct V_36 *
F_43 ( struct V_47 * V_59 ,
const T_1 * V_63 )
{
struct V_22 * V_23 = F_44 ( V_59 -> V_64 ) ;
...
if ( V_23 -> V_45 -> V_66 )
V_23 -> V_45 -> V_66 ( V_37 ) ;
F_47 ( & V_37 -> V_16 , & V_59 -> V_67 ) ;
V_14:
F_15 ( & V_59 -> V_39 ) ;
return V_37 ;
}
static struct V_36 *
F_48 ( struct V_47 * V_59 ,
const T_1 * V_63 )
{
struct V_36 * V_37 = NULL ;
V_37 = F_45 ( V_59 , V_63 ) ;
if ( V_37 )
return V_37 ;
return F_43 ( V_59 , V_63 ) ;
}
struct V_36 *
F_45 ( const struct V_47 * V_59 ,
const T_1 * V_63 )
{
...
int F_53 ( struct V_73 * V_74 , void * V_75 )
{
struct V_76 * V_71 = (struct V_76 * ) V_74 -> V_77 ;
struct V_22 * V_23 = F_44 ( V_71 ) ;
struct V_47 * V_78 ;
V_78 = F_54 ( V_74 ) ;
if ( ! V_78 )
return 0 ;
...
if ( V_49 -> V_34 != V_35 )
F_27 ( V_49 -> V_34 ) ;
V_50 = F_58 ( V_49 -> V_50 , true ) ;
if ( V_50 )
F_34 ( V_50 ) ;
F_17 ( V_49 , V_21 ) ;
}
void F_59 ( struct V_48 * V_49 )
{
F_19 ( & V_49 -> V_12 , F_57 ) ;
}
...
F_70 ( & V_23 -> V_27 ) ;
V_23 -> V_24 = NULL ;
for ( V_92 = 0 ; V_92 < V_88 -> V_93 ; V_92 ++ ) {
V_90 = & V_88 -> V_94 [ V_92 ] ;
V_91 = & V_88 -> V_95 [ V_92 ] ;
F_10 ( V_91 ) ;
...
F_50 ( & V_8 -> V_110 [ V_92 ] . V_90 ) ;
F_51 ( & V_8 -> V_110 [ V_92 ] . V_111 ) ;
V_8 -> V_110 [ V_92 ] . V_93 = 0 ;
}
return V_8 ;
V_108:
F_63 ( V_8 ) ;
...
static void V_28 ( struct V_126 * V_127 )
{
struct V_128 * V_128 ;
struct V_22 * V_23 ;
V_128 = F_90 ( V_127 ) ;
V_23 = F_2 ( V_128 , struct V_22 , V_27 ) ;
F_86 ( V_23 ) ;
F_24 ( V_29 ,
& V_23 -> V_27 ,
F_25 ( V_30 ) ) ;
...
V_23 -> V_45 -> V_129 ( V_23 , V_74 ,
V_35 ) ;
return 0 ;
}
int F_93 ( struct V_73 * V_74 , void * V_75 )
{
struct V_76 * V_71 = (struct V_76 * ) V_74 -> V_77 ;
struct V_47 * V_59 ;
struct V_22 * V_23 ;
...
V_23 -> V_45 -> V_129 ( V_23 , V_74 , V_59 ) ;
V_14:
if ( V_59 )
F_27 ( V_59 ) ;
return 0 ;
...
if ( V_133 -> V_112 == V_114 )
continue;
if ( V_59 == V_133 )
continue;
if ( V_59 -> V_64 != V_133 -> V_64 )
continue;
if ( V_133 -> V_135 > V_59 -> V_135 )
V_133 -> V_135 -- ;
}
F_8 () ;
V_59 -> V_135 = - 1 ;
