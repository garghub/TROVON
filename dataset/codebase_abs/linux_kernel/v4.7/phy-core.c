...
static struct V_4 * F_43 ( struct V_19 * V_37 , int V_38 )
{
int V_23 ;
struct V_5 * V_5 ;
struct V_4 * V_4 = NULL ;
struct V_39 args ;
V_23 = F_44 ( V_37 , L_5 , L_6 ,
V_38 , & args ) ;
if ( V_23 )
return F_19 ( - V_18 ) ;
F_10 ( & V_14 ) ;
V_5 = F_20 ( args . V_37 ) ;
if ( F_45 ( V_5 ) || ! F_46 ( V_5 -> V_40 ) ) {
V_4 = F_19 ( - V_22 ) ;
goto V_41;
}
if ( ! F_47 ( args . V_37 ) ) {
...
struct V_4 * F_51 ( struct V_19 * V_37 , const char * V_7 )
{
struct V_4 * V_4 = NULL ;
int V_38 = 0 ;
if ( V_7 )
V_38 = F_52 ( V_37 , L_8 , V_7 ) ;
V_4 = F_43 ( V_37 , V_38 ) ;
if ( F_45 ( V_4 ) )
return V_4 ;
if ( ! F_46 ( V_4 -> V_28 -> V_40 ) )
return F_19 ( - V_22 ) ;
F_53 ( & V_4 -> V_2 ) ;
return V_4 ;
}
...
if ( ! V_4 )
return;
V_44 = F_56 ( V_2 , F_1 , F_7 , V_4 ) ;
F_57 ( V_2 , V_44 , L_9 ) ;
}
struct V_4 * F_58 ( struct V_1 * V_2 , struct V_39
* args )
{
struct V_4 * V_4 ;
struct V_45 V_46 ;
F_59 ( & V_46 , V_47 , NULL , NULL ) ;
while ( ( V_2 = F_60 ( & V_46 ) ) ) {
V_4 = F_61 ( V_2 ) ;
if ( args -> V_37 != V_4 -> V_2 . V_21 )
continue;
F_62 ( & V_46 ) ;
return V_4 ;
}
...
if ( V_2 -> V_21 ) {
V_38 = F_52 ( V_2 -> V_21 , L_8 ,
string ) ;
V_4 = F_43 ( V_2 -> V_21 , V_38 ) ;
} else {
V_4 = F_17 ( V_2 , string ) ;
}
if ( F_45 ( V_4 ) )
...
{
struct V_4 * * V_48 , * V_4 ;
V_48 = F_68 ( F_1 , sizeof( * V_48 ) , V_12 ) ;
if ( ! V_48 )
return F_19 ( - V_13 ) ;
V_4 = F_63 ( V_2 , string ) ;
if ( ! F_45 ( V_4 ) ) {
...
struct V_4 * F_72 ( struct V_1 * V_2 , struct V_19 * V_37 ,
const char * V_7 )
{
struct V_4 * * V_48 , * V_4 ;
V_48 = F_68 ( F_1 , sizeof( * V_48 ) , V_12 ) ;
...
struct V_4 * F_73 ( struct V_1 * V_2 , struct V_19 * V_37 ,
int V_38 )
{
struct V_4 * * V_48 , * V_4 ;
V_48 = F_68 ( F_1 , sizeof( * V_48 ) , V_12 ) ;
...
V_4 -> V_50 = V_50 ;
V_4 -> V_28 = V_28 ;
V_23 = F_79 ( & V_4 -> V_2 , L_12 , F_18 ( V_2 ) , V_50 ) ;
if ( V_23 )
goto V_55;
...
{
struct V_4 * * V_48 , * V_4 ;
V_48 = F_68 ( F_5 , sizeof( * V_48 ) , V_12 ) ;
if ( ! V_48 )
return F_19 ( - V_13 ) ;
