...
V_16 -> V_4 . V_35 = V_35 ;
V_16 -> V_4 . V_34 = V_34 ;
V_16 -> V_51 . V_34 = V_16 -> V_4 . V_34 ;
V_16 -> V_51 . V_52 = F_16 ;
V_16 -> V_51 . V_53 = & V_16 -> V_4 ;
V_16 -> V_51 . V_17 = V_17 ;
V_16 -> V_51 . V_54 = V_55 | V_56 |
V_57 ;
V_16 -> V_22 = F_15 ;
V_37 = F_33 ( V_17 , & V_16 -> V_51 ) ;
if ( V_37 ) {
F_34 ( L_7 ) ;
F_35 ( V_16 ) ;
V_16 = NULL ;
...
void F_42 ( struct V_5 * V_58 )
{
T_1 V_13 = F_4 ( & V_58 -> V_9 , V_14 ) ;
V_13 &= ~ V_26 ;
F_6 ( & V_58 -> V_9 , V_13 , V_14 ) ;
F_6 ( & V_58 -> V_9 , ~ 0 , V_28 ) ;
V_13 &= ~ V_27 ;
V_13 |= ( V_26 | V_15 ) ;
F_6 ( & V_58 -> V_9 , V_13 , V_14 ) ;
...
unsigned long V_30 )
{
struct V_5 * V_58 = F_29 ( sizeof( * V_58 ) , V_36 ) ;
if ( ! V_58 )
return NULL ;
V_58 -> V_9 . V_11 = V_11 ;
V_58 -> V_9 . V_30 = V_30 ;
...
V_58 -> V_7 . V_35 = V_35 ;
V_58 -> V_7 . V_61 = F_44 ;
V_58 -> V_7 . V_62 = F_47 ( 32 ) ;
V_58 -> V_7 . V_54 = V_63 ;
V_58 -> V_7 . V_64 = F_45 ;
return V_58 ;
}
void F_48 ( struct V_5 * V_58 )
{
F_49 ( & V_58 -> V_7 , V_58 -> V_9 . V_30 ) ;
}
T_4 F_43 ( struct V_5 * V_58 )
{
return ( T_4 ) ~ F_4 ( & V_58 -> V_9 , V_60 ) ;
}
