...
F_34 ( V_30 , V_21 ,
L_28 ) ;
} else if ( V_66 -> V_72 == 0x2a && V_66 -> V_73 == 0x06 ) {
V_68 = V_78 ;
F_34 ( V_30 , V_21 ,
L_29 ) ;
...
if ( F_44 ( & V_66 ) )
return V_82 ;
if ( V_21 -> V_83 && V_21 -> V_83 -> V_84 ) {
int V_85 ;
V_85 = V_21 -> V_83 -> V_84 ( V_21 , & V_66 ) ;
if ( V_85 != V_86 )
return V_85 ;
}
...
if ( V_18 -> V_22 -> V_99 ) {
int V_201 , V_23 = V_82 ;
for ( V_201 = 0 ; V_23 == V_82 && V_201 < 2 ; V_201 ++ )
...
int F_138 ( const T_2 * V_92 , int V_271 ,
T_3 * V_272 )
{
int V_273 ;
const T_2 * V_274 ;
...
case 0x72 :
case 0x73 :
V_274 = F_139 ( V_92 , V_271 ,
0 ) ;
if ( V_274 && ( 0xa == V_274 [ 1 ] ) ) {
V_275 = 0 ;
