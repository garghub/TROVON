...
const struct V_63 * V_64 , unsigned V_66 )
{
struct V_47 * V_48 = F_23 ( V_6 ) -> V_14 ;
...
struct V_87 * V_88 = & F_31 ( V_8 ) -> V_89 ;
F_32 ( V_3 -> V_90 == 0 ,
V_91 L_5 ,
F_33 ( F_34 ( & V_6 -> V_5 ) ) , V_3 -> V_90 , V_6 , V_3 ) ;
F_35 ( & V_3 -> V_14 -> V_53 , V_88 ) ;
F_36 ( F_37 ( V_3 ) -> V_92 -> V_93 , V_88 ,
F_29 , V_3 ) ;
return 0 ;
}
...
{
struct V_96 * V_97 = F_42 ( V_6 -> V_4 . V_5 . V_98 ) ;
int V_99 = V_97 -> V_100 ;
unsigned long V_101 = F_39 () ;
unsigned long V_102 ;
if ( F_43 ( V_103 ) )
return 1 ;
if ( ! V_6 -> V_95 )
