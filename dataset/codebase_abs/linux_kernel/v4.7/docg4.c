...
F_62 ( & V_15 -> V_185 -> V_187 ) ;
F_63 ( & V_15 -> V_185 -> V_188 ) ;
V_15 -> V_189 = F_40 ;
V_15 -> V_126 = F_17 ;
V_15 -> V_190 = F_19 ;
V_15 -> V_191 = F_31 ;
...
V_15 -> V_120 . V_196 = F_43 ;
V_15 -> V_120 . V_197 = F_49 ;
V_15 -> V_120 . V_198 = F_45 ;
V_15 -> V_120 . V_199 = F_51 ;
if ( V_46 ) {
V_15 -> V_182 |= V_200 ;
V_15 -> V_201 = F_56 ;
}
...
static int T_5 F_66 ( struct V_152 * V_153 )
{
struct V_1 * V_2 ;
struct V_14 * V_15 ;
void T_1 * V_23 ;
...
int V_12 , V_69 ;
struct V_209 * V_210 ;
struct V_211 * V_24 = & V_153 -> V_24 ;
V_210 = F_67 ( V_153 , V_212 , 0 ) ;
if ( V_210 == NULL ) {
F_16 ( V_24 , L_36 ) ;
return - V_208 ;
}
V_23 = F_68 ( V_210 -> V_213 , F_69 ( V_210 ) ) ;
if ( ! V_23 ) {
F_16 ( V_24 , L_37 , V_210 ) ;
return - V_68 ;
}
...
F_71 ( V_15 , V_20 ) ;
V_2 -> V_24 . V_215 = & V_153 -> V_24 ;
V_20 -> V_23 = V_23 ;
V_20 -> V_24 = V_24 ;
F_60 ( V_2 ) ;
V_20 -> V_52 = F_72 ( V_216 , V_181 , V_217 ) ;
if ( V_20 -> V_52 == NULL ) {
V_69 = - V_218 ;
goto V_219;
}
...
if ( V_69 )
goto V_219;
V_69 = F_75 ( V_2 , V_220 , NULL , NULL , 0 ) ;
if ( V_69 )
goto V_219;
V_20 -> V_2 = V_2 ;
return 0 ;
...
static int T_9 F_79 ( struct V_152 * V_153 )
{
struct V_19 * V_20 = F_58 ( V_153 ) ;
F_76 ( V_20 -> V_2 ) ;
F_77 ( V_20 -> V_52 ) ;
