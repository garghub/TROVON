...
V_216 = F_110 ( V_2 -> V_181 , F_111 ( V_2 -> V_217 ) ) ;
if ( V_216 ) {
F_21 ( V_2 -> V_22 , L_13 ) ;
return V_216 ;
}
...
struct V_214 * V_215 )
{
struct V_218 * V_219 = V_215 -> V_22 . V_220 ;
int V_180 ;
if ( ! V_219 )
return 1 ;
V_180 = F_113 ( V_219 , L_15 ) ;
if ( V_180 < 0 ) {
F_21 ( & V_215 -> V_22 , L_16 , V_180 ) ;
return V_180 ;
}
V_2 -> V_13 . line = V_180 ;
if ( F_114 ( V_219 , L_17 , NULL ) ||
F_114 ( V_219 , L_18 , NULL ) )
F_115 ( V_158 , & V_2 -> V_6 ) ;
return 0 ;
}
static int F_116 ( struct V_1 * V_2 , struct V_221 * V_22 )
{
enum V_222 V_44 ;
struct V_223 * V_224 ;
V_2 -> V_89 = F_117 ( V_22 , 0 ) ;
if ( F_108 ( V_2 -> V_89 ) )
return F_109 ( V_2 -> V_89 ) ;
if ( ! F_118 () || ! F_74 () ) {
...
for ( V_44 = 0 ; V_44 < V_225 ; V_44 ++ ) {
V_224 = F_120 ( V_2 -> V_89 , V_44 ) ;
if ( V_224 && ( F_121 ( V_224 ) == V_226 ) )
V_2 -> V_102 [ V_44 ] = F_122 ( V_224 ) ;
else
V_2 -> V_102 [ V_44 ] = - V_37 ;
}
return 0 ;
...
enum V_222 V_44 ;
int V_216 = 0 ;
for ( V_44 = 0 ; ( V_44 < V_225 ) && ! V_216 ; V_44 ++ ) {
if ( V_168 [ V_44 ] < 0 )
continue;
F_126 ( V_168 [ V_44 ] , V_227 ) ;
V_216 = F_127 ( V_168 [ V_44 ] , F_82 ,
V_228 , F_43 ( V_2 -> V_22 ) , V_2 ) ;
if ( V_216 )
F_21 ( V_2 -> V_22 , L_20 ,
V_229 , V_168 [ V_44 ] ) ;
}
while ( V_216 && ( -- V_44 >= 0 ) )
if ( V_168 [ V_44 ] >= 0 )
F_124 ( V_168 [ V_44 ] , V_2 ) ;
return V_216 ;
}
static int F_128 ( struct V_214 * V_215 )
{
const struct V_230 * V_231 =
F_129 ( V_232 , & V_215 -> V_22 ) ;
struct V_1 * V_2 ;
T_2 V_233 ;
int V_180 , V_168 ;
struct V_234 * V_235 ;
V_2 = F_130 ( & V_215 -> V_22 , sizeof( * V_2 ) , V_122 ) ;
if ( ! V_2 )
return - V_236 ;
V_2 -> V_13 . V_22 = & V_215 -> V_22 ;
V_2 -> V_22 = & V_215 -> V_22 ;
V_180 = F_112 ( V_2 , V_215 ) ;
if ( V_180 > 0 )
V_2 -> V_13 . line = V_215 -> V_237 < 0 ? 0 : V_215 -> V_237 ;
else if ( V_180 < 0 )
return V_180 ;
if ( V_231 ) {
V_215 -> V_238 = V_231 -> V_239 ;
V_2 -> V_3 = V_215 -> V_238 -> V_240 ;
}
V_180 = F_106 ( V_2 , V_215 ) ;
if ( V_180 )
return V_180 ;
V_235 = F_131 ( V_215 , V_241 , 0 ) ;
if ( ! V_235 )
return - V_242 ;
V_2 -> V_13 . V_243 = V_235 -> V_244 ;
V_2 -> V_13 . V_14 = F_132 ( V_235 -> V_244 , F_133 ( V_235 ) ) ;
V_2 -> V_13 . V_245 = & V_246 ;
V_2 -> V_13 . V_247 = V_248 ;
V_2 -> V_13 . V_124 = V_184 ;
V_2 -> V_13 . V_159 = F_111 ( V_2 -> V_181 ) ;
V_2 -> V_13 . type = V_82 ;
F_105 ( V_2 ) ;
V_2 -> V_91 = 0 ;
V_168 = F_134 ( V_215 , 0 ) ;
...
V_180 = F_135 ( & V_215 -> V_22 , V_168 , F_82 , 0 ,
F_43 ( & V_215 -> V_22 ) , V_2 ) ;
if ( V_180 )
return V_180 ;
F_136 ( V_215 , V_2 ) ;
V_180 = F_116 ( V_2 , & V_215 -> V_22 ) ;
if ( V_180 ) {
...
F_83 ( V_2 ) ;
V_180 = F_137 ( & V_249 , & V_2 -> V_13 ) ;
if ( V_180 )
goto V_250;
if ( F_2 ( V_2 ) ) {
F_138 ( & V_215 -> V_22 , L_22 ) ;
} else {
V_233 = F_5 ( V_2 , V_251 ) ;
F_138 ( & V_215 -> V_22 , L_23 ,
( V_233 >> 24 ) & 0xff ,
( V_233 >> 16 ) & 0xff , V_233 & 0xffff ) ;
}
return 0 ;
V_250:
F_123 ( V_2 ) ;
V_200 [ V_215 -> V_237 ] = NULL ;
return V_180 ;
}
static int F_139 ( struct V_214 * V_215 )
{
struct V_1 * V_2 = F_140 ( V_215 ) ;
F_141 ( & V_249 , & V_2 -> V_13 ) ;
V_200 [ V_215 -> V_237 ] = NULL ;
F_123 ( V_2 ) ;
return 0 ;
}
