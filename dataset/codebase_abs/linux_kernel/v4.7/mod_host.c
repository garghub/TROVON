...
static int F_88 ( struct V_9 * V_83 , struct V_14 * V_11 ,
int V_84 )
{
if ( V_84 ) {
struct V_1 * V_6 = F_66 ( V_11 ) ;
...
struct V_9 * V_10 = F_3 ( V_8 ) ;
struct V_39 * V_18 = V_4 -> V_18 ;
struct V_25 * V_89 = NULL ;
int V_90 = F_20 ( V_4 -> V_21 ) ;
int V_34 ;
F_32 ( V_10 , L_24 , V_37 , V_90 ? L_3 : L_4 ) ;
if ( ! F_10 ( V_3 ) ) {
V_34 = - V_61 ;
F_5 ( V_10 , L_25 ) ;
goto V_91;
...
{
struct V_7 * V_8 = F_2 ( V_3 ) ;
struct V_120 * V_19 = (struct V_120 * ) V_59 ;
struct V_9 * V_10 = F_3 ( V_8 ) ;
int V_94 = 1 ;
switch ( V_95 ) {
case V_121 :
...
V_19 -> V_131 =
F_108 ( V_132 | V_133 ) ;
V_19 -> V_134 . V_135 . V_136 [ 0 ] = ( V_94 << 1 ) ;
V_19 -> V_134 . V_135 . V_136 [ 1 ] = ~ 0 ;
F_32 ( V_10 , L_37 , V_37 ) ;
break;
}
return 0 ;
...
V_45 -> V_157 = 1 ;
V_3 = F_71 ( V_45 ) ;
F_133 ( V_8 , & V_3 -> V_12 , V_158 ) ;
V_3 -> V_12 . V_159 = L_46 ;
V_3 -> V_12 . V_160 = F_122 ;
V_3 -> V_12 . V_161 = F_129 ;
F_134 ( V_3 ) ;
F_135 (udev, hpriv, i) {
V_26 -> V_47 = NULL ;
F_40 ( & V_26 -> V_42 ) ;
