...
F_29 () ;
F_35 ( L_7 ) ;
V_52 . V_53 . V_54 = F_36 () -> V_54 ;
V_52 . V_53 . V_55 = 0 ;
V_52 . V_53 . V_56 = V_57 ;
V_52 . V_53 . V_50 = F_36 () -> V_50 ;
memcpy ( & V_58 , F_15 () , sizeof( struct V_59 ) ) ;
V_58 . V_60 = 0xedeaddeadeeeeeeeUL ;
V_47 = (struct V_59 * ) F_37 ( & V_58 , 0 ) -
V_58 . V_61 ;
F_38 ( & V_58 ) ;
F_39 ( & V_52 , V_2 -> V_62 , V_2 ,
F_40 ( V_2 -> V_63 ) ,
V_17 . V_18 ) ;
}
...
if ( ! V_14 )
return - V_64 ;
F_43 ( V_14 , F_44 ( V_14 , V_65 . V_66 , NULL ) ) ;
F_43 ( V_14 , F_44 ( V_14 , V_67 . V_66 , NULL ) ) ;
V_68 = F_45 ( F_2 ( V_20 ) ) ;
F_46 ( V_14 , & V_65 ) ;
V_69 = F_45 ( V_21 ) ;
F_46 ( V_14 , & V_67 ) ;
