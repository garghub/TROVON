...
if ( V_152 && F_128 ( V_152 ) ) {
F_129 ( V_152 ) ;
return - 1 ;
}
F_20 ( L_71 ) ;
V_100 = F_130 ( & V_31 -> V_40 , V_32 -> V_119 ) ;
if ( V_100 >= V_32 -> V_119 ) {
F_131 ( & V_31 -> V_40 , V_32 -> V_120 ,
V_32 -> V_119 ) ;
F_132 ( & V_31 -> V_40 ) ;
} else {
F_41 ( & V_31 -> V_36 -> V_88 -> V_15 ,
...
sprintf ( V_286 , L_74 , F_1 ( V_3 ) -> V_70 -> V_12 ) ;
} else
sprintf ( V_286 , L_75 , V_287 ,
F_2 ( V_3 ) -> V_155 ) ;
F_134 ( & V_3 -> V_68 -> V_15 , L_76 ,
V_285 , V_286 ) ;
}
...
{
F_137 ( V_295 , V_31 -> V_155 ) ;
}
static void F_138 ( struct V_6 * V_31 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_31 -> V_34 ; V_43 ++ ) {
F_139 ( V_31 -> V_35 [ V_43 ] ) ;
F_140 ( V_31 -> V_277 [ V_43 ] ) ;
}
F_139 ( V_31 -> V_281 ) ;
F_140 ( V_31 -> V_183 ) ;
F_140 ( V_31 -> V_259 ) ;
...
static int F_142 ( struct V_6 * V_31 , int V_296 ,
int V_297 , int V_298 )
{
struct V_14 * V_15 ;
int V_155 ;
...
if ( V_155 < 0 )
goto exit;
V_31 -> V_36 -> V_15 = F_144 ( & V_31 -> V_40 ,
V_295 , V_155 , & V_31 -> V_36 -> V_68 -> V_15 ,
V_31 -> V_36 , V_299 ) ;
V_15 = V_31 -> V_36 -> V_15 ;
V_31 -> V_155 = V_155 ;
V_31 -> V_170 = V_171 ;
...
V_31 -> V_277 [ V_43 ] = F_147 ( V_31 -> V_156 ,
V_174 ) ;
if ( ! V_31 -> V_277 [ V_43 ] )
goto exit;
}
V_31 -> V_281 = F_146 ( 0 , V_174 ) ;
if ( ! V_31 -> V_281 ) {
F_8 ( V_15 , L_78 ) ;
goto exit;
}
...
V_31 -> V_181 = 0 ;
V_31 -> V_180 = V_298 ;
V_31 -> V_259 = F_147 ( V_31 -> V_180 , V_174 ) ;
if ( ! V_31 -> V_259 )
goto exit;
V_31 -> V_183 = F_147 ( V_31 -> V_180 , V_174 ) ;
if ( ! V_31 -> V_183 )
goto exit;
return 0 ;
exit:
...
static struct V_2 * F_148 ( struct V_199 * V_300 ,
int V_19 )
{
struct V_2 * V_3 ;
V_3 = F_147 ( sizeof( * V_3 ) , V_93 ) ;
if ( ! V_3 )
return NULL ;
V_3 -> V_19 = V_19 ;
V_3 -> V_88 = F_149 ( V_300 ) ;
V_3 -> V_68 = V_300 ;
F_150 ( & V_3 -> V_175 ) ;
F_151 ( & V_3 -> V_172 ) ;
F_152 ( & V_3 -> V_301 , V_301 ) ;
F_152 ( & V_3 -> V_302 , V_302 ) ;
return V_3 ;
}
static int F_153 ( struct V_2 * V_3 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_303 ; V_43 ++ ) {
if ( V_304 [ V_43 ] == V_3 ) {
V_304 [ V_43 ] = NULL ;
break;
}
...
F_155 ( V_1 -> V_70 ) ;
for ( V_43 = 0 ; V_43 < V_288 ; V_43 ++ ) {
F_139 ( V_1 -> V_289 [ V_43 ] ) ;
F_140 ( V_1 -> V_290 [ V_43 ] ) ;
V_1 -> V_290 [ V_43 ] = NULL ;
}
F_139 ( V_1 -> V_87 ) ;
F_140 ( V_1 -> V_85 ) ;
...
static int F_159 ( void * V_84 , bool V_318 )
{
struct V_2 * V_3 = V_84 ;
int V_319 = ! V_318 ;
int V_320 ;
...
V_320 = F_113 ( V_3 -> V_88 , F_114 ( V_3 -> V_88 , 0 ) ,
V_319 ? 0x82 : 0x81 , 0x40 , 0 , 0 , NULL , 0 ,
V_252 ) ;
F_85 ( & V_3 -> V_172 ) ;
return V_320 ;
}
...
static struct V_2 * F_164 ( struct V_199 * V_68 ,
int V_19 )
{
int V_38 , V_43 ;
struct V_69 * V_70 ;
...
if ( ! V_3 )
return NULL ;
V_70 = F_165 ( sizeof( struct V_1 ) , L_83 , V_325 ,
F_157 ) ;
if ( ! V_70 ) {
F_8 ( & V_68 -> V_15 , L_84 ) ;
goto exit;
...
V_1 -> V_70 = V_70 ;
V_1 -> V_36 = V_3 ;
V_1 -> V_122 = F_166 ( V_68 , V_326 ,
V_270 ) ;
if ( ! V_1 -> V_122 ) {
F_8 ( & V_68 -> V_15 , L_85 ) ;
goto exit;
}
V_1 -> V_89 = F_166 ( V_68 , V_326 ,
V_274 ) ;
if ( ! V_1 -> V_89 ) {
F_8 ( & V_68 -> V_15 , L_86 ) ;
goto exit;
}
F_167 ( V_70 , & V_68 -> V_15 ) ;
F_168 ( V_70 , & V_327 ) ;
V_38 = F_169 ( V_70 ) ;
if ( V_38 ) {
F_8 ( & V_68 -> V_15 , L_87 ) ;
...
for ( V_43 = 0 ; V_43 < V_288 ; V_43 ++ ) {
V_1 -> V_289 [ V_43 ] = F_146 ( 0 , V_174 ) ;
if ( ! V_1 -> V_289 [ V_43 ] ) {
F_8 ( & V_68 -> V_15 , L_88 ) ;
goto exit;
}
V_1 -> V_290 [ V_43 ] = F_147 ( V_125 ,
V_174 ) ;
if ( ! V_1 -> V_290 [ V_43 ] )
goto exit;
}
V_1 -> V_87 = F_146 ( 0 , V_174 ) ;
if ( ! V_1 -> V_87 ) {
F_8 ( & V_68 -> V_15 , L_89 ) ;
goto exit;
}
V_1 -> V_85 = F_147 ( V_86 , V_174 ) ;
if ( ! V_1 -> V_85 )
goto exit;
F_158 ( V_3 ) ;
F_133 ( V_3 ) ;
...
static void F_170 ( struct V_6 * V_31 )
{
struct V_187 * V_188 ;
if ( ! V_31 )
return;
...
if ( ( V_40 & V_20 ) == V_29 ) {
V_296 = 2 ;
V_31 -> V_188 = F_147 ( sizeof( struct V_187 ) ,
V_174 ) ;
if ( V_31 -> V_188 ) {
V_188 = V_31 -> V_188 ;
V_188 -> V_32 = F_146 ( 0 , V_174 ) ;
if ( V_188 -> V_32 ) {
F_151 ( & V_188 -> V_172 ) ;
F_174 ( & V_188 -> V_227 ) ;
V_188 -> V_190 = F_166 (
...
V_296 = 1 ;
if ( F_142 ( V_31 , V_296 , V_330 ,
V_331 ) )
goto exit;
V_31 -> V_122 = F_166 ( V_68 , V_326 ,
V_270 ) ;
if ( ! V_31 -> V_122 ) {
F_8 ( & V_68 -> V_15 , L_90 ) ;
goto V_332;
...
static
struct V_2 * F_175 ( struct V_199 * V_68 ,
int V_40 ,
struct V_41 * V_37 )
{
struct V_2 * V_3 ;
...
static void F_172 ( struct V_41 * V_37 )
{
F_139 ( V_37 -> V_294 ) ;
F_140 ( V_37 -> V_334 ) ;
F_85 ( & V_37 -> V_292 ) ;
...
static
struct V_41 * F_176 ( struct V_199 * V_68 )
{
struct V_41 * V_37 = F_147 ( sizeof( * V_37 ) , V_174 ) ;
if ( ! V_37 )
return NULL ;
V_37 -> V_335 = F_166 ( V_68 , V_329 ,
V_270 ) ;
if ( ! V_37 -> V_335 ) {
F_8 ( & V_68 -> V_15 , L_91 ) ;
goto exit;
}
V_37 -> V_294 = F_146 ( 0 , V_174 ) ;
if ( ! V_37 -> V_294 ) {
F_8 ( & V_68 -> V_15 , L_92 ) ;
goto exit;
}
V_37 -> V_334 =
F_147 ( F_55 ( V_37 -> V_335 -> V_123 ) ,
V_174 ) ;
if ( ! V_37 -> V_334 )
goto exit;
F_151 ( & V_37 -> V_292 ) ;
...
static int F_177 ( struct V_199 * V_68 )
{
struct V_189 * V_336 = F_149 ( V_68 ) ;
T_5 * V_337 = F_178 ( 17 , V_174 ) ;
T_2 V_200 = V_68 -> V_201 -> V_202 . V_203 ;
T_8 V_38 ;
if ( ! V_337 )
return - V_338 ;
if ( F_113 ( V_336 , F_114 ( V_336 , 0 ) ,
0x86 , 0xC0 , 0 , 0 , V_337 , 17 ,
V_252 ) != 0x11 ) {
F_140 ( V_337 ) ;
return - V_339 ;
}
...
static int F_179 ( struct V_199 * V_68 ,
...
struct V_2 * V_3 = NULL ;
struct V_41 * V_42 ;
struct V_2 * V_346 = NULL ;
if ( V_68 -> V_201 -> V_202 . V_347 != 0xFF ) {
F_8 ( & V_68 -> V_15 , L_93 ) ;
return - V_54 ;
}
V_200 = V_68 -> V_201 -> V_202 . V_203 ;
if ( V_344 -> V_348 )
V_19 = ( ( T_2 * ) ( V_344 -> V_348 ) ) [ V_200 ] ;
else
V_19 = F_177 ( V_68 ) ;
if ( V_68 -> V_349 > 1 )
F_180 ( F_149 ( V_68 ) , V_200 , 1 ) ;
V_68 -> V_350 = 1 ;
switch ( V_19 & V_351 ) {
case V_166 :
if ( ( V_19 & V_20 ) == V_30 ) {
...
static void F_184 ( struct V_199 * V_68 )
{
F_183 ( V_68 ) ;
F_182 ( V_68 , NULL ) ;
}
static void V_301 ( struct V_353 * V_84 )
{
struct V_2 * V_3 =
F_185 ( V_84 , struct V_2 , V_301 ) ;
F_77 ( V_3 -> V_68 ) ;
}
static void V_302 ( struct V_353 * V_84 )
{
struct V_2 * V_3 =
F_185 ( V_84 , struct V_2 , V_302 ) ;
F_83 ( V_3 -> V_68 ) ;
}
static int F_36 ( struct V_2 * V_3 )
{
if ( V_3 -> V_88 -> V_354 == V_355 ) {
if ( ! V_3 -> V_356 ) {
V_3 -> V_356 = 1 ;
F_186 ( & V_3 -> V_301 ) ;
}
}
if ( V_3 -> V_88 -> V_354 != V_357 )
return - V_61 ;
F_57 ( V_3 -> V_88 ) ;
return 0 ;
}
...
static int F_187 ( struct V_199 * V_358 , T_9 V_359 )
{
int V_43 , V_38 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
if ( V_45 [ V_43 ] && ( V_45 [ V_43 ] -> V_68 == V_358 ) ) {
V_38 = F_81 ( V_45 [ V_43 ] ) ;
if ( V_38 )
goto V_182;
}
...
for ( V_43 = 0 ; V_43 < V_303 ; V_43 ++ ) {
if ( V_304 [ V_43 ] &&
( V_304 [ V_43 ] -> V_68 == V_358 ) ) {
V_38 = F_29 ( V_304 [ V_43 ] ) ;
if ( V_38 )
goto V_182;
}
}
...
static int F_188 ( struct V_199 * V_358 )
{
int V_43 , V_38 = 0 ;
struct V_1 * V_1 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
...
static void V_185 ( struct V_361 * V_175 )
{
struct V_2 * V_3 = F_185 ( V_175 , struct V_2 , V_175 ) ;
F_171 ( V_3 ) ;
}
...
( V_45 [ V_43 ] -> V_68 == V_68 ) ) {
V_31 = F_2 ( V_45 [ V_43 ] ) ;
F_189 ( & V_31 -> V_40 , false ) ;
F_76 ( & V_31 -> V_36 -> V_172 ) ;
V_31 -> V_36 -> V_178 = 1 ;
F_85 ( & V_31 -> V_36 -> V_172 ) ;
F_190 ( & V_45 [ V_43 ] -> V_302 ) ;
F_190 ( & V_45 [ V_43 ] -> V_301 ) ;
F_136 ( V_31 ) ;
...
for ( V_43 = 0 ; V_43 < V_303 ; V_43 ++ ) {
if ( V_304 [ V_43 ] &&
( V_304 [ V_43 ] -> V_68 == V_68 ) ) {
struct V_322 * V_362 = F_1 ( V_304 [ V_43 ] ) -> V_322 ;
F_27 ( F_1 ( V_304 [ V_43 ] ) -> V_70 ) ;
F_29 ( V_304 [ V_43 ] ) ;
F_190 ( & V_304 [ V_43 ] -> V_302 ) ;
F_190 ( & V_304 [ V_43 ] -> V_301 ) ;
if ( V_362 ) {
F_191 ( V_362 ) ;
F_163 ( V_362 ) ;
}
...
static struct V_363 * F_166 ( struct V_199 * V_300 ,
int type , int V_364 )
{
int V_43 ;
struct V_365 * V_358 = V_300 -> V_201 ;
struct V_363 * V_190 ;
for ( V_43 = 0 ; V_43 < V_358 -> V_202 . V_366 ; V_43 ++ ) {
V_190 = & V_358 -> V_367 [ V_43 ] . V_202 ;
if ( ( ( V_190 -> V_90 & V_368 ) == V_364 ) &&
( F_192 ( V_190 ) == type ) )
return V_190 ;
}
return NULL ;
}
static int F_181 ( struct V_199 * V_300 , unsigned char * V_369 )
{
int V_43 ;
struct V_365 * V_358 = V_300 -> V_201 ;
if ( V_358 -> V_370 == 3 ) {
...
for ( V_43 = 0 ; V_43 < V_358 -> V_202 . V_366 ; V_43 ++ ) {
if ( V_358 -> V_367 [ V_43 ] . V_370 == 3 ) {
* V_369 = V_358 -> V_367 [ V_43 ] . V_371 [ 2 ] ;
return 0 ;
}
}
return - 1 ;
...
struct V_189 * V_88 , T_7 V_372 )
{
int V_38 ;
F_97 ( V_42 -> V_294 , V_88 ,
F_98 ( V_88 ,
V_42 -> V_335 -> V_90 & 0x7F ) ,
V_42 -> V_334 ,
1 ,
F_121 , V_42 ,
V_42 -> V_335 -> V_194 ) ;
V_38 = F_40 ( V_42 -> V_294 , V_372 ) ;
if ( V_38 )
