...
V_261 = F_2 ( V_1 , V_177 ) ;
if ( V_263 & V_264 ) {
F_6 ( V_1 , 0xffff & ~ V_264 ,
V_149 ) ;
F_82 ( V_1 ) ;
V_1 -> V_265 = F_2 ( V_1 , V_149 )
& V_266 ;
V_1 -> V_267 = V_268 ;
F_111 ( & V_1 -> V_269 ,
V_270 + F_112 ( 50 ) ) ;
...
if ( V_254 & V_232 )
F_104 ( V_1 ) ;
if ( ( V_254 & V_271 ) && ( V_255 & V_10 )
&& ( V_256 & V_259 ) )
F_93 ( V_1 , V_256 , V_259 ) ;
if ( ( V_254 & V_272 ) && ( V_255 & V_8 )
&& ( V_258 & V_261 ) )
F_94 ( V_1 , V_258 , V_261 ) ;
if ( V_254 & V_238 )
F_106 ( V_1 ) ;
}
F_6 ( V_1 , V_262 , V_95 ) ;
...
unsigned long V_274 ;
T_1 V_6 ;
F_114 ( & V_1 -> V_14 , V_274 ) ;
V_6 = F_2 ( V_1 , V_13 ) ;
if ( V_1 -> V_267 > 0 ) {
V_6 = F_2 ( V_1 , V_149 ) & V_266 ;
if ( V_6 == V_1 -> V_265 ) {
V_1 -> V_267 -- ;
if ( V_1 -> V_267 == 0 ) {
if ( V_6 == V_266 )
...
F_115 ( & V_1 -> V_14 , V_274 ) ;
}
static int F_116 ( struct V_275 * V_276 ,
const struct V_90 * V_91 )
{
struct V_57 * V_21 ;
V_21 = F_117 ( V_276 , struct V_57 , V_21 ) ;
return F_49 ( V_21 , V_91 ) ;
}
static int F_118 ( struct V_275 * V_276 )
{
struct V_57 * V_21 ;
struct V_117 * V_118 ;
unsigned long V_274 ;
...
V_118 = F_83 ( V_21 ) ;
F_114 ( & V_21 -> V_1 -> V_14 , V_274 ) ;
F_60 ( V_21 , V_118 , - V_277 ) ;
F_115 ( & V_21 -> V_1 -> V_14 , V_274 ) ;
}
F_55 ( V_21 -> V_1 , V_21 -> V_4 ) ;
return F_51 ( V_21 ) ;
}
static struct V_278 * F_119 ( struct V_275 * V_276 ,
T_5 V_279 )
{
struct V_117 * V_118 ;
V_118 = F_120 ( sizeof( struct V_117 ) , V_279 ) ;
if ( ! V_118 )
return NULL ;
F_14 ( & V_118 -> V_22 ) ;
return & V_118 -> V_118 ;
}
static void F_121 ( struct V_275 * V_276 , struct V_278 * V_280 )
{
struct V_117 * V_118 ;
V_118 = F_117 ( V_280 , struct V_117 , V_118 ) ;
F_122 ( V_118 ) ;
}
static int F_98 ( struct V_275 * V_276 , struct V_278 * V_280 ,
T_5 V_279 )
{
struct V_57 * V_21 ;
struct V_117 * V_118 ;
...
static int F_124 ( struct V_275 * V_276 , struct V_278 * V_280 )
{
struct V_57 * V_21 ;
struct V_117 * V_118 ;
unsigned long V_274 ;
...
static int F_125 ( struct V_275 * V_276 , int V_283 )
{
struct V_57 * V_21 ;
struct V_117 * V_118 ;
unsigned long V_274 ;
...
static int F_126 ( struct V_275 * V_276 )
{
struct V_57 * V_21 ;
unsigned long V_274 ;
V_21 = F_117 ( V_276 , struct V_57 , V_21 ) ;
...
static void F_128 ( struct V_275 * V_276 )
{
struct V_57 * V_21 ;
unsigned long V_274 ;
V_21 = F_117 ( V_276 , struct V_57 , V_21 ) ;
...
static int F_129 ( struct V_286 * V_15 ,
struct V_287 * V_18 )
{
...
F_13 ( V_1 ) ;
F_5 ( V_1 , V_20 , V_7 ) ;
if ( F_2 ( V_1 , V_149 ) & V_266 ) {
F_82 ( V_1 ) ;
V_1 -> V_265 = F_2 ( V_1 ,
V_149 ) & V_266 ;
V_1 -> V_267 = V_268 ;
F_111 ( & V_1 -> V_269 , V_270 + F_112 ( 50 ) ) ;
}
return 0 ;
}
static int F_131 ( struct V_286 * V_15 )
{
struct V_1 * V_1 = F_130 ( V_15 ) ;
unsigned long V_274 ;
F_114 ( & V_1 -> V_14 , V_274 ) ;
...
static int F_132 ( struct V_286 * V_289 )
{
struct V_1 * V_1 = F_130 ( V_289 ) ;
return F_2 ( V_1 , V_290 ) & 0x03FF ;
}
static int F_133 ( struct V_286 * V_15 , int V_291 )
{
struct V_1 * V_1 = F_130 ( V_15 ) ;
unsigned long V_274 ;
F_114 ( & V_1 -> V_14 , V_274 ) ;
...
static int F_134 ( struct V_286 * V_15 , int V_292 )
{
struct V_1 * V_1 = F_130 ( V_15 ) ;
V_15 -> V_293 = ( V_292 != 0 ) ;
if ( V_292 )
...
static int F_135 ( struct V_295 * V_296 )
{
struct V_1 * V_1 = F_136 ( V_296 ) ;
F_137 ( & V_1 -> V_15 ) ;
F_138 ( & V_1 -> V_269 ) ;
...
static void F_140 ( struct V_275 * V_21 , struct V_278 * V_298 )
{
}
...
{
struct V_299 * V_300 ;
V_300 = F_142 ( V_296 , V_301 , L_20 ) ;
V_1 -> V_302 = F_143 ( & V_296 -> V_303 , V_300 ) ;
return F_144 ( V_1 -> V_302 ) ;
}
static int F_145 ( struct V_295 * V_296 )
{
struct V_304 * V_303 = & V_296 -> V_303 ;
char V_305 [ 8 ] ;
struct V_299 * V_300 , * V_306 ;
int V_252 ;
void T_6 * V_5 = NULL ;
struct V_1 * V_1 = NULL ;
int V_31 = 0 ;
int V_54 ;
unsigned long V_307 ;
V_300 = F_146 ( V_296 , V_301 , 0 ) ;
V_5 = F_143 ( & V_296 -> V_303 , V_300 ) ;
if ( F_147 ( V_5 ) )
return F_148 ( V_5 ) ;
V_306 = F_146 ( V_296 , V_308 , 0 ) ;
V_252 = V_306 -> V_309 ;
V_307 = V_306 -> V_274 & V_310 ;
if ( V_252 < 0 ) {
F_17 ( V_303 , L_21 ) ;
return - V_107 ;
}
V_1 = F_149 ( V_303 , sizeof( struct V_1 ) , V_212 ) ;
if ( V_1 == NULL )
return - V_81 ;
F_150 ( & V_1 -> V_14 ) ;
F_151 ( V_296 , V_1 ) ;
V_1 -> V_46 = F_152 ( V_303 ) ;
V_1 -> V_157 = V_307 == V_311 ;
V_1 -> V_15 . V_312 = & V_313 ;
V_1 -> V_15 . V_288 = V_228 ;
V_1 -> V_15 . V_314 = V_315 ;
F_153 ( & V_1 -> V_269 ) ;
V_1 -> V_269 . V_316 = F_113 ;
V_1 -> V_269 . V_317 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
if ( V_1 -> V_46 -> V_47 ) {
snprintf ( V_305 , sizeof( V_305 ) , L_22 , V_296 -> V_318 ) ;
V_1 -> V_297 = F_154 ( V_303 , V_305 ) ;
if ( F_147 ( V_1 -> V_297 ) ) {
F_17 ( V_303 , L_23 , V_305 ) ;
return F_148 ( V_1 -> V_297 ) ;
}
F_155 ( V_1 -> V_297 ) ;
}
if ( V_1 -> V_46 -> V_319 ) {
V_31 = F_141 ( V_1 , V_296 ) ;
if ( V_31 < 0 )
goto V_320;
}
F_12 ( V_1 ) ;
V_31 = F_156 ( V_303 , V_252 , F_110 , V_321 ,
V_315 , V_1 ) ;
if ( V_31 < 0 ) {
F_17 ( V_303 , L_24 , V_31 ) ;
goto V_320;
}
F_14 ( & V_1 -> V_15 . V_322 ) ;
V_1 -> V_15 . V_211 = & V_1 -> V_21 [ 0 ] . V_21 ;
F_14 ( & V_1 -> V_15 . V_211 -> V_322 ) ;
for ( V_54 = 0 ; V_54 < V_27 ; V_54 ++ ) {
struct V_57 * V_21 = & V_1 -> V_21 [ V_54 ] ;
if ( V_54 != 0 ) {
F_14 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_322 ) ;
F_123 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_322 ,
& V_1 -> V_15 . V_322 ) ;
}
V_21 -> V_1 = V_1 ;
F_14 ( & V_21 -> V_22 ) ;
V_21 -> V_21 . V_314 = V_323 [ V_54 ] ;
V_21 -> V_21 . V_312 = & V_324 ;
F_157 ( & V_21 -> V_21 , 512 ) ;
if ( V_54 == 0 ) {
V_21 -> V_21 . V_325 . V_326 = true ;
} else {
V_21 -> V_21 . V_325 . V_327 = true ;
V_21 -> V_21 . V_325 . V_328 = true ;
V_21 -> V_21 . V_325 . V_329 = true ;
}
V_21 -> V_21 . V_325 . V_68 = true ;
V_21 -> V_21 . V_325 . V_330 = true ;
}
...
V_1 -> V_210 -> V_331 = F_140 ;
V_31 = F_158 ( V_303 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_332;
F_159 ( V_303 , L_25 , V_333 ) ;
return 0 ;
V_332:
F_121 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_210 ) ;
V_320:
