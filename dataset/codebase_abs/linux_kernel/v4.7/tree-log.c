...
int V_327 = 0 ;
F_170 ( & V_322 ) ;
F_253 ( & F_116 ( V_84 ) -> V_328 ) ;
F_254 ( & V_324 -> V_329 ) ;
V_326 = V_4 -> V_10 -> V_330 ;
F_255 (em, n, &tree->modified_extents, list) {
F_168 ( & V_290 -> V_24 ) ;
if ( ++ V_327 > 32768 ) {
F_168 ( & V_324 -> V_331 ) ;
V_7 = - V_332 ;
...
F_256 ( NULL , & V_322 , F_234 ) ;
F_257 ( V_84 , V_291 , V_36 , V_226 ) ;
V_7 = F_238 ( V_84 ) ;
if ( V_7 )
V_6 -> V_317 = V_7 ;
V_333:
...
F_141 ( ! F_71 ( & V_322 ) ) ;
F_260 ( & V_324 -> V_329 ) ;
F_261 ( & F_116 ( V_84 ) -> V_328 ) ;
F_31 ( V_41 ) ;
return V_7 ;
}
static int F_262 ( struct V_3 * log , struct V_84 * V_84 ,
...
V_7 = F_233 ( V_2 , log , V_143 , V_338 , 0 , 0 ,
V_339 , 0 , V_339 , 0 , 0 , 0 ) ;
return V_7 ;
}
static int F_266 ( struct V_28 * V_29 ,
const int V_42 ,
...
if ( V_44 -> type == V_133 ) {
struct V_116 * V_345 ;
V_345 = (struct V_116 * ) ( V_118 + V_135 ) ;
V_196 = V_44 -> V_82 ;
V_344 = F_92 ( V_29 , V_345 ) ;
V_120 = ( unsigned long ) ( V_345 + 1 ) ;
V_180 = sizeof( * V_345 ) + V_344 ;
} else {
struct V_130 * V_131 ;
V_131 = (struct V_130 * ) ( V_118 +
V_135 ) ;
V_196 = F_100 ( V_29 , V_131 ) ;
V_344 = F_99 ( V_29 , V_131 ) ;
V_120 = ( unsigned long ) & V_131 -> V_109 ;
V_180 = sizeof( * V_131 ) + V_344 ;
}
if ( V_344 > V_110 ) {
char * V_346 ;
V_346 = F_267 ( V_109 , V_344 , V_62 ) ;
if ( ! V_346 ) {
V_7 = - V_63 ;
goto V_12;
}
...
bool V_348 = false ;
T_1 V_143 = F_61 ( V_84 ) ;
struct V_323 * V_349 = & F_116 ( V_84 ) -> V_325 ;
T_1 V_249 = 0 ;
bool V_350 = true ;
V_41 = F_90 () ;
if ( ! V_41 )
...
V_245 . V_82 = ( T_1 ) - 1 ;
if ( F_39 ( V_84 -> V_148 ) ||
F_116 ( V_84 ) -> V_250 > V_4 -> V_10 -> V_330 )
V_7 = F_269 ( V_2 , V_84 ) ;
else
V_7 = F_270 ( V_84 ) ;
if ( V_7 ) {
...
V_240 = V_41 -> V_59 [ 0 ] ;
if ( V_337 && V_347 + V_337 == V_41 -> V_60 [ 0 ] ) {
V_337 ++ ;
goto V_356;
} else if ( ! V_337 ) {
V_347 = V_41 -> V_60 [ 0 ] ;
...
F_31 ( V_41 ) ;
F_31 ( V_236 ) ;
V_228 = F_263 ( V_2 , V_4 , V_84 , V_41 , V_236 ) ;
if ( V_228 )
goto V_232;
if ( V_245 . type >= V_193 && ! V_348 ) {
F_31 ( V_41 ) ;
F_31 ( V_236 ) ;
V_228 = F_264 ( V_2 , V_4 , V_84 , V_41 ) ;
if ( V_228 )
goto V_232;
}
V_355:
...
struct V_287 * V_290 , * V_321 ;
F_254 ( & V_349 -> V_329 ) ;
F_255 (em, n, &em_tree->modified_extents,
list) {
const T_1 V_357 = V_290 -> V_295 + V_290 -> V_296 - 1 ;
if ( V_290 -> V_295 >= V_36 && V_357 <= V_226 )
F_168 ( & V_290 -> V_24 ) ;
}
F_260 ( & V_349 -> V_329 ) ;
}
if ( V_264 == V_354 && F_39 ( V_84 -> V_148 ) ) {
...
F_273 ( & F_116 ( V_84 ) -> V_329 ) ;
F_116 ( V_84 ) -> V_231 = V_2 -> V_79 ;
F_116 ( V_84 ) -> V_225 = F_116 ( V_84 ) -> V_358 ;
F_274 ( & F_116 ( V_84 ) -> V_329 ) ;
V_232:
if ( F_275 ( V_228 ) )
F_276 ( & V_291 ) ;
else
...
bool V_7 = false ;
F_2 ( & F_116 ( V_84 ) -> V_8 ) ;
if ( F_116 ( V_84 ) -> V_359 > V_10 -> V_330 ) {
F_182 ( V_10 , V_2 ) ;
V_7 = true ;
}
F_7 ( & F_116 ( V_84 ) -> V_8 ) ;
...
static T_2 int F_279 ( struct V_1 * V_2 ,
struct V_84 * V_84 ,
struct V_360 * V_196 ,
struct V_361 * V_362 ,
T_1 V_363 )
{
int V_7 = 0 ;
struct V_360 * V_364 = NULL ;
struct V_84 * V_365 = V_84 ;
if ( F_46 ( V_84 -> V_148 ) &&
F_116 ( V_84 ) -> V_250 <= V_363 &&
F_116 ( V_84 ) -> V_359 <= V_363 )
goto V_12;
if ( ! F_39 ( V_84 -> V_148 ) ) {
if ( ! V_196 || F_280 ( V_196 ) || V_362 != V_196 -> V_366 )
goto V_12;
V_84 = F_281 ( V_196 ) ;
}
while ( 1 ) {
...
if ( ! V_41 )
return - V_63 ;
V_370 = F_32 ( sizeof( * V_370 ) , V_62 ) ;
if ( ! V_370 ) {
F_94 ( V_41 ) ;
return - V_63 ;
}
V_370 -> V_143 = F_61 ( V_367 ) ;
F_10 ( & V_370 -> V_24 , & V_368 ) ;
while ( ! F_71 ( & V_368 ) ) {
struct V_28 * V_94 ;
struct V_43 V_239 ;
int V_170 ;
int V_174 ;
V_370 = F_286 ( & V_368 , struct V_369 ,
V_24 ) ;
if ( V_7 )
goto V_371;
V_239 . V_54 = V_370 -> V_143 ;
V_239 . type = V_159 ;
V_239 . V_82 = 0 ;
V_132:
F_31 ( V_41 ) ;
...
if ( V_164 . type == V_243 )
continue;
V_372 = F_287 ( V_4 -> V_10 -> V_362 , & V_164 ,
V_4 , NULL ) ;
if ( F_87 ( V_372 ) ) {
V_7 = F_134 ( V_372 ) ;
goto V_371;
}
if ( F_288 ( V_372 , V_2 -> V_79 ) ) {
F_78 ( V_372 ) ;
continue;
}
V_6 -> V_244 = false ;
if ( type == V_163 || type == V_375 )
V_374 = V_354 ;
F_31 ( V_41 ) ;
V_7 = F_268 ( V_2 , V_4 , V_372 ,
V_374 , 0 , V_376 , V_6 ) ;
if ( ! V_7 &&
F_278 ( V_2 , V_372 ) )
V_7 = 1 ;
...
goto V_371;
if ( V_6 -> V_244 ) {
V_373 = F_32 ( sizeof( * V_373 ) ,
V_62 ) ;
if ( ! V_373 ) {
V_7 = - V_63 ;
goto V_371;
}
V_373 -> V_143 = V_164 . V_54 ;
F_10 ( & V_373 -> V_24 , & V_368 ) ;
}
break;
}
if ( V_174 == V_170 ) {
...
V_377 . V_54 = V_44 . V_82 ;
V_135 = V_45 ;
}
V_378 = F_287 ( V_4 -> V_10 -> V_362 , & V_377 ,
V_4 , NULL ) ;
if ( F_87 ( V_378 ) )
continue;
if ( V_6 )
V_6 -> V_244 = false ;
V_7 = F_268 ( V_2 , V_4 , V_378 ,
V_354 , 0 , V_376 , V_6 ) ;
if ( ! V_7 &&
F_278 ( V_2 , V_378 ) )
V_7 = 1 ;
...
struct V_5 * V_6 )
{
int V_264 = V_379 ? V_278 : V_354 ;
struct V_361 * V_362 ;
struct V_360 * V_364 = NULL ;
int V_7 = 0 ;
T_1 V_363 = V_4 -> V_10 -> V_330 ;
bool V_380 = false ;
struct V_84 * V_365 = V_84 ;
V_362 = V_84 -> V_381 ;
if ( F_174 ( V_4 , V_382 ) ) {
...
V_7 = F_279 ( V_2 , V_84 , V_196 ,
V_362 , V_363 ) ;
if ( V_7 )
goto V_383;
if ( F_288 ( V_84 , V_2 -> V_79 ) ) {
V_7 = V_385 ;
goto V_383;
}
V_7 = F_1 ( V_2 , V_4 , V_6 ) ;
if ( V_7 )
goto V_383;
V_7 = F_268 ( V_2 , V_4 , V_84 , V_264 , V_36 , V_226 , V_6 ) ;
if ( V_7 )
goto V_386;
if ( F_46 ( V_84 -> V_148 ) &&
F_116 ( V_84 ) -> V_250 <= V_363 &&
...
V_380 = true ;
if ( F_116 ( V_84 ) -> V_359 > V_363 ) {
V_7 = F_289 ( V_2 , V_365 , V_6 ) ;
if ( V_7 )
goto V_386;
}
while ( 1 ) {
...
if ( V_4 != F_116 ( V_84 ) -> V_4 )
break;
if ( F_116 ( V_84 ) -> V_250 > V_363 ) {
V_7 = F_268 ( V_2 , V_4 , V_84 ,
V_278 ,
0 , V_376 , V_6 ) ;
if ( V_7 )
goto V_386;
...
struct V_3 * V_4 , struct V_360 * V_360 ,
const T_6 V_36 ,
const T_6 V_226 ,
struct V_5 * V_6 )
{
struct V_360 * V_196 = F_283 ( V_360 ) ;
int V_7 ;
V_7 = F_290 ( V_2 , V_4 , F_281 ( V_360 ) , V_196 ,
V_36 , V_226 , 0 , V_6 ) ;
F_284 ( V_196 ) ;
return V_7 ;
}
int F_293 ( struct V_3 * V_19 )
{
int V_7 ;
struct V_40 * V_41 ;
struct V_1 * V_2 ;
...
V_387 . V_54 = V_152 . V_82 ;
V_387 . type = V_243 ;
V_387 . V_82 = ( T_1 ) - 1 ;
V_31 . V_187 = F_297 ( V_10 , & V_387 ) ;
if ( F_87 ( V_31 . V_187 ) ) {
...
struct V_84 * V_84 , struct V_84 * V_392 ,
struct V_360 * V_196 )
{
struct V_3 * V_4 = F_116 ( V_84 ) -> V_4 ;
if ( F_46 ( V_84 -> V_148 ) )
...
if ( F_116 ( V_84 ) -> V_231 <=
V_4 -> V_10 -> V_330 &&
( ! V_392 || F_116 ( V_392 ) -> V_231 <=
V_4 -> V_10 -> V_330 ) )
return 0 ;
return F_290 ( V_2 , V_4 , V_84 , V_196 , 0 ,
V_376 , 1 , NULL ) ;
}
