...
for ( V_8 = 0 , V_37 = 0 ; V_8 < V_14 ; ++ V_8 )
if ( V_31 [ V_8 ] )
V_31 [ V_37 ++ ] = F_38 ( V_31 [ V_8 ] ) ;
if ( V_37 ) {
F_37 ( & V_4 -> V_10 . V_41 ) ;
V_38 = F_39 ( V_31 , V_37 , false ,
V_42 ) ;
