...
static T_4 F_77 ( struct V_169 * V_170 ,
struct V_155 * V_156 )
{
int V_212 , V_4 ;
struct V_18 * V_19 = F_43 ( V_156 ) ;
...
static struct V_217 * F_82 ( struct V_155 * V_156 )
{
struct V_18 * V_19 = F_43 ( V_156 ) ;
struct V_217 * V_218 = & V_19 -> V_218 ;
T_5 V_13 ;
memset ( V_218 , 0 , sizeof( * V_218 ) ) ;
V_218 -> V_72 = F_83 ( V_156 ) ;
if ( ! F_20 ( V_19 , V_219 ,
& V_13 , sizeof( V_13 ) ) )
...
static int F_89 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
F_90 ( V_235 -> V_157 , L_23 , sizeof( V_235 -> V_157 ) ) ;
return 0 ;
}
static int F_91 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_43 ( V_156 ) ;
...
F_93 ( V_19 -> V_111 , V_240 ) ;
V_235 -> V_237 . V_241 = 1 ;
return 0 ;
}
static int F_94 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
int V_4 = - V_239 ;
if ( V_235 -> V_242 == V_89 ||
...
static int F_98 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_43 ( V_156 ) ;
int V_4 = - V_239 ;
...
static int F_100 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_43 ( V_156 ) ;
...
static int F_107 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_43 ( V_156 ) ;
if ( V_235 -> V_15 . V_248 > sizeof( V_19 -> V_276 ) )
return - V_277 ;
F_90 ( V_19 -> V_276 , V_236 , V_235 -> V_15 . V_248 ) ;
return 0 ;
}
...
if ( V_4 )
goto V_42;
V_299 = F_115 ( T_2 , V_298 , V_235 -> V_301 . V_248 ) ;
V_299 = F_115 ( T_1 , V_299 , 100 ) ;
...
static int F_117 ( struct V_205 * V_207 )
{
struct V_155 * V_156 ;
struct V_18 * V_19 ;
...
V_207 -> V_314 = V_315 ;
V_207 -> V_316 = 1 ;
V_156 = F_118 ( sizeof( struct V_18 ) ) ;
if ( ! V_156 )
goto V_317;
V_156 -> V_318 = & V_319 ;
V_156 -> V_320 = 5 * V_321 ;
...
F_90 ( V_19 -> V_276 , L_28 , sizeof( V_19 -> V_276 ) ) ;
F_125 ( & V_19 -> V_60 ) ;
F_126 ( & V_19 -> V_63 ) ;
F_127 ( V_156 ) ;
return 0 ;
...
static void F_86 ( struct V_205 * V_206 )
{
F_128 ( V_206 ) ;
}
