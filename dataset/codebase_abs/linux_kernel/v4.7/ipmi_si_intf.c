...
int V_169 ;
for ( V_169 = 0 ; ; V_169 ++ ) {
if ( ! V_318 [ V_169 ] . V_319 )
break;
#ifdef F_212
if ( F_213 ( V_318 [ V_169 ] . V_319 ) )
continue;
#endif
V_143 = F_118 () ;
if ( ! V_143 )
return;
V_143 -> V_141 = V_320 ;
V_143 -> V_83 = V_318 [ V_169 ] . type ;
V_143 -> V_191 = F_90 ;
V_143 -> V_70 . V_150 = V_318 [ V_169 ] . V_319 ;
V_143 -> V_70 . V_189 = V_204 ;
V_143 -> V_70 . V_149 = NULL ;
V_143 -> V_70 . V_151 = V_192 ;
V_143 -> V_70 . V_156 = V_192 ;
...
V_134 -> V_155 = V_134 -> V_26 -> V_328 ( V_134 -> V_28 ,
& V_134 -> V_70 ) ;
V_19 = V_134 -> V_191 ( V_134 ) ;
if ( V_19 ) {
F_115 (KERN_ERR PFX L_120 ) ;
goto V_323;
}
if ( V_134 -> V_26 -> V_329 ( V_134 -> V_28 ) ) {
if ( V_134 -> V_141 )
F_115 (KERN_INFO PFX L_121 ) ;
V_19 = - V_157 ;
goto V_323;
}
V_19 = F_180 ( V_134 ) ;
...
F_34 ( & V_134 -> V_99 , 0 ) ;
V_134 -> V_104 = false ;
for ( V_169 = 0 ; V_169 < V_330 ; V_169 ++ )
F_34 ( & V_134 -> V_331 [ V_169 ] , 0 ) ;
V_134 -> V_51 = true ;
F_34 ( & V_134 -> V_120 , 0 ) ;
V_134 -> V_111 = V_332 ;
V_332 ++ ;
...
V_134 -> V_79 -> V_333 = & V_334 . V_333 ;
V_19 = F_218 ( V_134 -> V_248 ) ;
if ( V_19 ) {
F_115 (KERN_ERR PFX
L_126
L_127 ,
...
V_134 -> V_193 ) ;
if ( V_19 ) {
F_147 ( V_134 -> V_79 , L_128 ,
V_19 ) ;
goto V_336;
}
V_19 = F_220 ( V_134 -> V_11 , L_129 ,
& V_337 ,
V_134 ) ;
if ( V_19 ) {
F_147 ( V_134 -> V_79 , L_130 , V_19 ) ;
goto V_336;
}
V_19 = F_220 ( V_134 -> V_11 , L_131 ,
& V_338 ,
V_134 ) ;
if ( V_19 ) {
F_147 ( V_134 -> V_79 , L_130 , V_19 ) ;
...
static void F_126 ( struct V_9 * V_355 )
{
int V_19 = 0 ;
if ( ! V_355 )
return;
...
if ( V_355 -> V_79 )
F_163 ( V_355 -> V_79 , NULL ) ;
F_235 ( & V_355 -> V_324 ) ;
if ( V_355 -> V_146 )
V_355 -> V_146 ( V_355 ) ;
F_208 ( V_355 ) ;
while ( V_355 -> V_13 || ( V_355 -> V_41 != V_52 ) ) {
F_56 ( V_355 ) ;
F_178 ( 1 ) ;
}
F_20 ( V_355 , false ) ;
