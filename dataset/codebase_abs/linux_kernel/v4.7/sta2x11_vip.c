...
V_87 -> V_94 . V_95 . V_36 = V_87 -> V_94 . V_95 . V_15 * 2 * V_87 -> V_94 . V_95 . V_97 ;
...
F_21 ( & V_6 -> V_23 ) ;
F_60 ( & V_6 -> V_22 ) ;
V_6 -> V_37 = F_61 ( & V_6 -> V_59 -> V_125 ) ;
if ( F_62 ( V_6 -> V_37 ) ) {
F_24 ( & V_6 -> V_42 , L_10 ) ;
return F_63 ( V_6 -> V_37 ) ;
}
return 0 ;
}
...
static int F_69 ( struct V_140 * V_125 , int V_141 , int V_142 ,
const char * V_81 )
{
int V_83 ;
if ( V_141 == - 1 )
return 0 ;
V_83 = F_70 ( V_141 , V_81 ) ;
if ( V_83 ) {
F_71 ( V_125 , L_11 , V_141 , V_81 ) ;
return V_83 ;
}
V_83 = F_72 ( V_141 , V_142 ) ;
if ( V_83 ) {
F_71 ( V_125 , L_12 ,
V_141 , V_81 ) ;
F_73 ( V_141 ) ;
...
V_83 = F_74 ( V_141 , false ) ;
if ( V_83 ) {
F_71 ( V_125 , L_13 , V_141 , V_81 ) ;
F_73 ( V_141 ) ;
return V_83 ;
}
return 0 ;
}
static void F_75 ( struct V_140 * V_125 , int V_141 , const char * V_81 )
{
if ( V_141 != - 1 ) {
F_76 ( V_125 , L_14 , V_141 , V_81 ) ;
F_77 ( V_141 ) ;
F_73 ( V_141 ) ;
}
}
static int F_78 ( struct V_143 * V_59 ,
const struct V_144 * V_145 )
{
int V_83 ;
struct V_5 * V_6 ;
struct V_146 * V_147 ;
if ( F_79 ( & V_59 -> V_125 , F_58 ( 26 ) ) ) {
F_71 ( & V_59 -> V_125 , L_15 ) ;
return - V_43 ;
}
V_83 = F_80 ( V_59 ) ;
if ( V_83 )
return V_83 ;
V_147 = F_81 ( & V_59 -> V_125 ) ;
if ( ! V_147 ) {
F_82 ( & V_59 -> V_125 , L_16 ) ;
V_83 = - V_43 ;
goto V_148;
}
V_83 = F_69 ( & V_59 -> V_125 , V_147 -> V_149 , 0 ,
V_147 -> V_150 ) ;
if ( V_83 )
goto V_148;
if ( V_147 -> V_151 >= 0 ) {
V_83 = F_69 ( & V_59 -> V_125 , V_147 -> V_151 , 0 ,
V_147 -> V_152 ) ;
if ( V_83 ) {
F_75 ( & V_59 -> V_125 , V_147 -> V_149 ,
V_147 -> V_150 ) ;
goto V_148;
}
}
if ( V_147 -> V_149 != - 1 ) {
F_83 ( 5000 , 25000 ) ;
V_83 = F_72 ( V_147 -> V_149 , 1 ) ;
}
if ( V_147 -> V_151 != - 1 ) {
F_83 ( 5000 , 25000 ) ;
V_83 = F_72 ( V_147 -> V_151 , 1 ) ;
}
F_83 ( 5000 , 25000 ) ;
...
if ( V_83 )
goto V_157;
V_83 = F_85 ( & V_59 -> V_125 , & V_6 -> V_42 ) ;
if ( V_83 )
goto V_157;
F_76 ( & V_59 -> V_125 , L_17 ,
( unsigned long ) F_86 ( V_59 , 0 ) ,
( unsigned long ) F_87 ( V_59 , 0 ) , V_59 -> V_112 ) ;
F_88 ( V_59 ) ;
V_83 = F_89 ( V_59 , V_56 ) ;
if ( V_83 )
goto V_158;
V_6 -> V_9 = F_90 ( V_59 , 0 , 0x100 ) ;
if ( ! V_6 -> V_9 ) {
V_83 = - V_154 ;
goto V_159;
}
...
goto V_160;
F_60 ( & V_6 -> V_16 ) ;
V_83 = F_92 ( V_59 -> V_112 ,
( V_161 ) F_51 ,
V_162 , V_56 , V_6 ) ;
if ( V_83 ) {
F_71 ( & V_59 -> V_125 , L_18 ) ;
V_83 = - V_163 ;
goto V_164;
}
V_6 -> V_165 = V_166 ;
V_6 -> V_165 . V_42 = & V_6 -> V_42 ;
V_6 -> V_165 . V_167 = & V_6 -> V_28 ;
F_93 ( & V_6 -> V_165 , V_6 ) ;
V_83 = F_94 ( & V_6 -> V_165 , V_168 , - 1 ) ;
if ( V_83 )
goto V_169;
V_6 -> V_170 = F_95 ( V_6 -> V_147 -> V_171 ) ;
if ( ! V_6 -> V_170 ) {
V_83 = - V_163 ;
F_71 ( & V_59 -> V_125 , L_19 ) ;
goto V_172;
}
V_6 -> V_68 = F_96 ( & V_6 -> V_42 , V_6 -> V_170 ,
L_20 , V_6 -> V_147 -> V_173 ,
NULL ) ;
if ( ! V_6 -> V_68 ) {
V_83 = - V_163 ;
F_71 ( & V_59 -> V_125 , L_21 ) ;
goto V_172;
}
F_97 ( V_6 -> V_170 ) ;
F_39 ( V_6 -> V_68 , V_174 , V_175 , 0 ) ;
F_54 ( V_6 ) ;
F_82 ( & V_59 -> V_125 , L_22 ) ;
return 0 ;
V_172:
F_93 ( & V_6 -> V_165 , NULL ) ;
V_169:
...
F_105 ( V_6 ) ;
V_155:
F_75 ( & V_59 -> V_125 , V_147 -> V_151 , V_147 -> V_152 ) ;
F_75 ( & V_59 -> V_125 , V_147 -> V_149 , V_147 -> V_150 ) ;
V_148:
return V_83 ;
}
static void F_106 ( struct V_143 * V_59 )
{
struct V_176 * V_42 = F_107 ( V_59 ) ;
struct V_5 * V_6 =
...
F_103 ( V_59 ) ;
F_104 ( & V_6 -> V_42 ) ;
F_75 ( & V_59 -> V_125 , V_6 -> V_147 -> V_149 ,
V_6 -> V_147 -> V_150 ) ;
F_75 ( & V_59 -> V_125 , V_6 -> V_147 -> V_151 ,
V_6 -> V_147 -> V_152 ) ;
F_105 ( V_6 ) ;
}
static int F_108 ( struct V_143 * V_59 , T_4 V_177 )
{
struct V_176 * V_42 = F_107 ( V_59 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
...
V_6 -> V_178 [ V_180 ] = F_5 ( V_6 , V_46 ) ;
F_3 ( V_6 , V_46 , 0 ) ;
for ( V_82 = 1 ; V_82 < V_180 ; V_82 ++ )
V_6 -> V_178 [ V_82 ] = F_5 ( V_6 , 4 * V_82 ) ;
for ( V_82 = 0 ; V_82 < V_181 ; V_82 ++ )
V_6 -> V_178 [ V_180 + V_182 + V_82 ] =
F_5 ( V_6 , V_183 [ V_82 ] ) ;
F_110 ( & V_6 -> V_16 , V_91 ) ;
F_111 ( V_59 ) ;
if ( F_112 ( V_59 , F_113 ( V_59 , V_177 ) ) ) {
V_6 -> V_184 = 1 ;
}
F_52 ( L_23 ) ;
return 0 ;
}
static int F_114 ( struct V_143 * V_59 )
{
struct V_176 * V_42 = F_107 ( V_59 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
...
F_109 ( & V_6 -> V_16 , V_91 ) ;
for ( V_82 = 1 ; V_82 < V_180 ; V_82 ++ )
F_3 ( V_6 , 4 * V_82 , V_6 -> V_178 [ V_82 ] ) ;
for ( V_82 = 0 ; V_82 < V_181 ; V_82 ++ )
F_3 ( V_6 , V_183 [ V_82 ] ,
V_6 -> V_178 [ V_180 + V_182 + V_82 ] ) ;
F_3 ( V_6 , V_17 , V_6 -> V_178 [ 0 ] ) ;
F_3 ( V_6 , V_46 , V_6 -> V_178 [ V_180 ] ) ;
F_110 ( & V_6 -> V_16 , V_91 ) ;
return 0 ;
}
