...
char V_147 [ V_148 ] ;
V_39 -> V_52 &= ~ V_124 ;
strncpy ( V_147 , V_42 -> V_147 , V_148 ) ;
F_75 ( V_42 ) ;
F_73 ( V_42 ) ;
F_45 ( V_39 -> V_122 ) ;
V_39 -> V_139 = NULL ;
if ( V_39 -> V_11 -> V_149 )
V_39 -> V_11 -> V_149 ( V_39 ) ;
F_76 ( & V_115 -> V_39 , L_24 , V_147 ) ;
}
F_68 ( V_115 , NULL ) ;
}
...
{
struct V_117 * V_118 = F_63 ( V_115 ) ;
const T_6 V_152 = F_71 ( V_118 -> V_140 . V_153 ) ;
const struct V_10 * V_10 = NULL ;
int V_76 , V_43 = - V_89 ;
V_118 = F_63 ( V_115 ) ;
for ( V_76 = 0 ; V_76 < F_78 ( V_154 ) ; V_76 ++ )
if ( V_154 [ V_76 ] -> V_155 == V_152 ) {
V_10 = V_154 [ V_76 ] ;
break;
}
if ( ! V_10 ) {
F_79 ( L_25 ,
V_4 , V_118 -> V_140 . V_153 ) ;
return - V_61 ;
}
if ( V_10 -> V_156 ) {
V_43 = V_10 -> V_156 ( V_115 ) ;
if ( V_43 )
return V_43 ;
}
for ( V_76 = 0 ; V_76 < V_10 -> V_157 ; V_76 ++ ) {
...
static int F_82 ( struct V_159 * V_160 , void * V_161 )
{
struct V_114 * V_115 = F_83 ( V_160 ) ;
struct V_38 * V_39 ;
for ( V_39 = F_67 ( V_115 ) ; V_39 ; V_39 = V_39 -> V_136 ) {
struct V_41 * V_42 = V_39 -> V_42 ;
if ( F_16 ( V_42 ) )
if ( V_39 -> V_11 -> V_162 )
V_39 -> V_11 -> V_162 ( V_39 ) ;
}
return 0 ;
}
...
{
int V_43 ;
V_43 = F_85 ( & V_158 . V_163 . V_164 , NULL ,
NULL , F_82 ) ;
if ( V_43 )
F_79 ( L_27 ,
V_4 , V_43 ) ;
