...
V_14 -> V_15 -> V_195 = 1 ;
V_14 -> V_15 -> V_196 &= ~ V_197 ;
V_14 -> V_15 -> V_196 |= V_198 |
V_199 |
V_200 ;
V_14 -> V_15 -> V_196 |= V_201 ;
V_14 -> V_202 = 4 ;
V_14 -> V_203 = 1 ;
V_14 -> V_204 = sizeof( struct V_205 ) ;
V_14 -> V_206 = sizeof( struct V_207 ) ;
V_14 -> V_208 = sizeof( struct V_209 ) +
sizeof( struct V_210 ) + 4 ;
if ( V_4 -> V_12 -> V_211 . V_212 & V_213 )
V_14 -> V_15 -> V_214 [ V_215 ] =
& V_2 -> V_216 [ V_215 ] ;
if ( V_4 -> V_12 -> V_211 . V_212 & V_217 )
V_14 -> V_15 -> V_214 [ V_218 ] =
& V_2 -> V_216 [ V_218 ] ;
F_85 ( V_12 ) ;
V_174 = F_86 ( V_4 ) ;
if ( V_174 ) {
V_14 -> V_15 -> V_219 = V_174 -> V_220 ;
V_14 -> V_15 -> V_221 = V_174 -> V_222 ;
}
F_87 ( V_14 , V_2 -> V_223 ) ;
}
...
if ( V_28 )
return - V_108 ;
V_4 -> V_227 = F_90 ( V_225 . V_228 ) ;
V_4 -> V_229 = F_90 ( V_225 . V_230 ) ;
...
if ( error != 0 )
goto V_237;
error = F_92 ( & V_2 -> V_238 , V_4 -> V_14 -> V_15 ,
F_28 ) ;
if ( error )
goto V_239;
V_57 = & V_2 -> V_238 ;
...
goto V_246;
if ( ! F_99 ( V_57 ) ) {
error = F_100 ( V_14 -> V_15 , V_57 -> V_247 ) ;
if ( error )
goto V_248;
}
...
V_4 -> V_47 ,
V_4 -> V_49 ) ;
F_102 ( V_4 -> V_12 , V_235 , sizeof( V_235 ) ) ;
F_103 ( V_14 -> V_15 , L_25 , V_235 ) ;
F_104 ( V_4 ) ;
F_105 ( V_4 ) ;
return 0 ;
V_248:
...
int F_106 ( struct V_250 * V_251 , struct V_252 * V_10 ,
T_1 V_26 , char * V_123 , T_2 V_27 )
{
struct V_13 * V_14 ;
struct V_3 * V_4 ;
int V_28 ;
V_14 = F_107 ( sizeof( struct V_3 ) , & V_253 ) ;
if ( ! V_14 )
return - V_125 ;
V_4 = V_14 -> V_4 ;
V_4 -> V_14 = V_14 ;
...
void F_112 ( struct V_250 * V_251 , bool V_256 )
{
if ( V_251 -> V_254 ) {
if ( V_256 )
...
F_13 ( V_251 -> V_254 ) ;
F_110 ( V_251 -> V_254 ) ;
F_111 ( V_251 -> V_254 -> V_14 ) ;
}
}
void F_113 ( struct V_250 * V_251 )
{
F_114 ( V_251 -> V_254 , V_258 ) ;
}
int F_115 ( struct V_250 * V_251 )
{
