...
do {
memset ( V_49 , 0 , sizeof( * V_49 ) ) ;
V_50 = V_46 -> V_118 -> V_119 ( V_108 , V_49 ) ;
if ( V_50 )
break;
V_116 ++ ;
F_20 ( V_46 , V_120 ,
L_4 ,
V_121 , V_49 -> V_122 , V_49 -> V_112 , V_49 -> V_123 ) ;
if ( V_49 -> V_112 ) {
F_21 ( & V_2 -> V_38 , V_115 ) ;
V_87 = V_2 -> V_36 [ V_49 -> V_123 ] ;
if ( ! V_87 ) {
F_22 ( & V_2 -> V_38 , V_115 ) ;
F_9 ( L_5 , V_49 -> V_123 ) ;
continue;
...
F_22 ( & V_2 -> V_38 , V_115 ) ;
V_112 = & V_87 -> V_101 ;
F_21 ( & V_87 -> V_125 , V_115 ) ;
V_87 -> V_126 = V_49 -> V_127 ;
V_87 -> V_128 = V_49 -> V_129 ;
V_87 -> V_130 = V_49 -> V_122 ;
F_22 ( & V_87 -> V_125 , V_115 ) ;
V_114 = & V_87 -> V_114 ;
V_114 -> V_131 = true ;
} else {
if ( V_49 -> V_122 != V_132 )
...
V_114 -> V_131 = false ;
default:
if ( ! V_49 -> V_182 && V_114 -> V_131 ) {
V_114 -> V_183 = V_49 -> V_184 ;
V_114 -> V_185 = false ;
V_114 -> V_186 = false ;
...
V_196 -> V_202 = V_258 ;
V_196 -> V_204 = 1 ;
V_196 -> V_197 . V_198 . V_257 . V_112 = V_112 ;
...
struct V_111 * V_112 = & V_87 -> V_101 ;
memset ( V_281 , 0 , sizeof( * V_281 ) ) ;
V_49 . V_182 = true ;
V_49 . V_286 = true ;
if ( V_112 -> V_102 ) {
F_47 ( V_281 , & V_281 -> V_287 ,
& V_281 -> V_288 , V_112 -> V_289 ) ;
F_47 ( V_281 , & V_281 -> V_290 ,
& V_281 -> V_291 , V_112 -> V_289 ) ;
}
