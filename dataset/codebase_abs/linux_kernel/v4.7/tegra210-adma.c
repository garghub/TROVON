...
V_2 = F_77 ( & V_110 -> V_19 , sizeof( * V_2 ) + V_112 -> V_118 *
sizeof( struct V_6 ) , V_119 ) ;
if ( ! V_2 )
return - V_120 ;
V_2 -> V_19 = & V_110 -> V_19 ;
V_2 -> V_118 = V_112 -> V_118 ;
F_78 ( V_110 , V_2 ) ;
V_114 = F_79 ( V_110 , V_121 , 0 ) ;
...
if ( V_24 )
return V_24 ;
V_115 = F_84 ( & V_110 -> V_19 , L_13 ) ;
if ( F_81 ( V_115 ) ) {
F_17 ( & V_110 -> V_19 , L_14 ) ;
V_24 = F_82 ( V_115 ) ;
goto V_122;
}
V_24 = F_85 ( & V_110 -> V_19 , V_115 ) ;
if ( V_24 ) {
F_86 ( V_115 ) ;
goto V_122;
}
...
if ( V_24 )
goto V_124;
F_88 ( & V_2 -> V_107 . V_125 ) ;
for ( V_116 = 0 ; V_116 < V_2 -> V_118 ; V_116 ++ ) {
struct V_6 * V_7 = & V_2 -> V_125 [ V_116 ] ;
V_7 -> V_8 = V_2 -> V_5 + F_89 ( V_116 ) ;
V_7 -> V_72 = F_90 ( V_110 -> V_19 . V_126 , V_116 ) ;
if ( V_7 -> V_72 < 0 ) {
V_24 = V_7 -> V_72 ;
goto V_127;
}
F_91 ( & V_7 -> V_11 , & V_2 -> V_107 ) ;
V_7 -> V_11 . V_128 = F_11 ;
V_7 -> V_2 = V_2 ;
}
F_92 ( V_129 , V_2 -> V_107 . V_130 ) ;
F_92 ( V_131 , V_2 -> V_107 . V_130 ) ;
F_92 ( V_132 , V_2 -> V_107 . V_130 ) ;
...
V_2 -> V_107 . V_140 = F_93 ( V_141 ) ;
V_2 -> V_107 . V_142 = F_93 ( V_141 ) ;
V_2 -> V_107 . V_143 = F_93 ( V_37 ) | F_93 ( V_34 ) ;
...
V_24 = F_95 ( V_110 -> V_19 . V_126 ,
F_68 , V_2 ) ;
if ( V_24 < 0 ) {
F_17 ( & V_110 -> V_19 , L_16 , V_24 ) ;
goto V_146;
}
F_67 ( & V_110 -> V_19 ) ;
F_96 ( & V_110 -> V_19 , L_17 ,
V_2 -> V_118 ) ;
return 0 ;
V_146:
F_97 ( & V_2 -> V_107 ) ;
...
static int F_102 ( struct V_109 * V_110 )
{
struct V_1 * V_2 = F_103 ( V_110 ) ;
int V_116 ;
F_97 ( & V_2 -> V_107 ) ;
for ( V_116 = 0 ; V_116 < V_2 -> V_118 ; ++ V_116 )
F_98 ( V_2 -> V_125 [ V_116 ] . V_72 ) ;
