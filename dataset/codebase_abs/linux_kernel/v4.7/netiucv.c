...
static struct V_159 * F_97 ( struct V_1 * V_2 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return & V_4 -> V_78 ;
}
static int F_98 ( struct V_1 * V_2 , int V_160 )
{
F_37 ( V_83 , 3 , V_84 ) ;
if ( V_160 < 576 || V_160 > V_161 ) {
F_37 ( V_57 , 2 , L_38 ) ;
return - V_54 ;
}
V_2 -> V_162 = V_160 ;
...
static T_5 F_99 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static int F_100 ( const char * V_14 , T_6 V_165 , char * V_166 ,
char * V_15 )
{
const char * V_9 ;
int V_167 ;
...
for ( V_167 = 0 , V_9 = V_14 ; V_167 < 8 && * V_9 && * V_9 != '.' ; V_167 ++ , V_9 ++ ) {
if ( isalnum ( * V_9 ) || * V_9 == '$' ) {
V_166 [ V_167 ] = toupper ( * V_9 ) ;
continue;
}
if ( * V_9 == '\n' )
break;
...
if ( * V_9 == '.' ) {
V_9 ++ ;
for ( V_167 = 0 ; V_167 < 16 && * V_9 ; V_167 ++ , V_9 ++ ) {
if ( * V_9 == '\n' )
break;
V_15 [ V_167 ] = toupper ( * V_9 ) ;
}
while ( V_167 > 0 && V_167 < 16 )
V_15 [ V_167 ++ ] = ' ' ;
} else
memcpy ( V_15 , V_168 , 16 ) ;
V_15 [ 16 ] = '\0' ;
F_101 ( V_15 , 16 ) ;
return 0 ;
}
static T_5 F_102 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
...
struct V_10 * V_169 ;
F_37 ( V_83 , 3 , V_84 ) ;
V_53 = F_100 ( V_14 , V_165 , V_166 , V_15 ) ;
if ( V_53 )
return V_53 ;
if ( memcmp ( V_166 , V_4 -> V_11 -> V_17 , 9 ) &&
( V_152 -> V_119 & ( V_170 | V_171 ) ) ) {
F_37 ( V_57 , 2 , L_42 ) ;
return - V_172 ;
}
F_22 ( & V_55 ) ;
F_23 (cp, &iucv_connection_list, list) {
if ( ! strncmp ( V_166 , V_169 -> V_17 , 9 ) &&
! strncmp ( V_15 , V_169 -> V_15 , 17 ) && V_169 -> V_66 != V_152 ) {
F_25 ( & V_55 ) ;
F_24 ( V_57 , 2 , L_43
L_44 , F_9 ( V_169 ) ) ;
return - V_173 ;
...
F_25 ( & V_55 ) ;
memcpy ( V_4 -> V_11 -> V_17 , V_166 , 9 ) ;
memcpy ( V_4 -> V_11 -> V_15 , V_15 , 17 ) ;
return V_165 ;
}
static T_5 F_103 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_104 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
struct V_1 * V_152 = V_4 -> V_11 -> V_66 ;
...
if ( V_165 >= 39 )
return - V_54 ;
V_175 = F_105 ( V_14 , & V_174 , 0 ) ;
if ( V_174 && ( ! isspace ( * V_174 ) ) ) {
F_24 ( V_57 , 2 , L_46 ,
* V_174 ) ;
return - V_54 ;
}
...
if ( ( V_152 -> V_119 & V_171 ) &&
( V_175 < ( V_152 -> V_162 + V_69 + 2 ) ) ) {
F_24 ( V_57 , 2 ,
L_48 ,
V_175 ) ;
return - V_54 ;
}
if ( V_175 < ( 576 + V_69 + V_69 ) ) {
F_24 ( V_57 , 2 ,
L_48 ,
V_175 ) ;
return - V_54 ;
...
V_4 -> V_11 -> V_86 = V_175 ;
if ( ! ( V_152 -> V_119 & V_171 ) )
V_152 -> V_162 = V_175 - V_69 - V_69 ;
return V_165 ;
}
static T_5 F_106 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_111 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_112 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_113 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_114 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_115 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_116 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_117 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_118 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_119 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_49 , V_4 -> V_11 -> V_97 . V_177 ) ;
}
static T_5 F_120 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
V_4 -> V_11 -> V_97 . V_177 = 0 ;
return V_165 ;
}
static T_5 F_121 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_122 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
static T_5 F_123 ( struct V_151 * V_2 , struct V_163 * V_164 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static T_5 F_124 ( struct V_151 * V_2 , struct V_163 * V_164 ,
const char * V_14 , T_6 V_165 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 4 , V_84 ) ;
...
F_37 ( V_83 , 3 , V_84 ) ;
if ( V_2 ) {
F_127 ( V_2 , L_50 , V_152 -> V_6 ) ;
V_2 -> V_179 = & V_180 ;
V_2 -> V_181 = V_182 ;
V_2 -> V_183 = V_184 ;
V_2 -> V_185 = ( void ( * ) ( struct V_151 * ) ) F_67 ;
V_2 -> V_186 = & V_187 ;
} else
return - V_33 ;
V_178 = F_128 ( V_2 ) ;
...
F_50 ( V_11 -> V_46 , V_198 ) ;
if ( V_15 )
memcpy ( V_11 -> V_15 , V_15 , 17 ) ;
if ( V_166 ) {
memcpy ( V_11 -> V_17 , V_166 , 9 ) ;
F_50 ( V_11 -> V_46 , V_133 ) ;
}
F_138 ( & V_55 ) ;
F_139 ( & V_11 -> V_199 , & V_200 ) ;
F_140 ( & V_55 ) ;
return V_11 ;
V_197:
F_141 ( V_11 -> V_103 ) ;
...
V_2 -> type = V_205 ;
V_2 -> V_121 = V_118 ;
V_2 -> V_119 = V_206 | V_207 ;
V_2 -> V_208 = & V_209 ;
}
static struct V_1 * F_148 ( char * V_166 , char * V_15 )
{
struct V_3 * V_67 ;
struct V_1 * V_2 ;
...
if ( ! V_67 -> V_46 )
goto V_211;
V_67 -> V_11 = F_133 ( V_2 , V_166 , V_15 ) ;
if ( ! V_67 -> V_11 ) {
F_37 ( V_57 , 2 , L_54 ) ;
goto V_218;
}
...
if ( V_165 >= V_224 )
V_165 = V_224 - 1 ;
for ( V_167 = 0 , V_9 = V_14 ; V_167 < V_165 && * V_9 ; V_167 ++ , V_9 ++ ) {
if ( * V_9 == '\n' || * V_9 == ' ' )
break;
V_6 [ V_167 ] = * V_9 ;
}
...
V_4 = F_2 ( V_152 ) ;
V_2 = V_4 -> V_2 ;
if ( strncmp ( V_6 , V_152 -> V_6 , V_165 ) )
continue;
F_25 ( & V_55 ) ;
if ( V_152 -> V_119 & ( V_170 | V_171 ) ) {
F_65 ( V_2 , L_60
L_61 ,
V_4 -> V_11 -> V_17 ) ;
F_37 ( V_45 , 2 , L_62 ) ;
...
V_225 = F_126 ( sizeof( struct V_151 ) , V_127 ) ;
if ( ! V_225 ) {
V_53 = - V_33 ;
goto V_229;
}
...
V_225 -> V_179 = & V_180 ;
V_225 -> V_181 = V_182 ;
V_225 -> V_185 = ( void ( * ) ( struct V_151 * ) ) F_67 ;
V_225 -> V_186 = & V_187 ;
V_53 = F_128 ( V_225 ) ;
if ( V_53 ) {
F_129 ( V_225 ) ;
