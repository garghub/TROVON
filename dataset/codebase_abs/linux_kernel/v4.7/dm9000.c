...
if ( F_119 ( V_3 -> V_211 ) == V_222 )
F_101 ( V_4 -> V_3 , L_30 ) ;
F_6 ( V_4 , V_145 , 0 ) ;
F_29 ( 1 ) ;
F_90 ( V_3 ) ;
if ( F_120 ( V_3 -> V_211 , F_111 , V_223 ,
V_3 -> V_61 , V_3 ) )
return - V_224 ;
F_89 ( V_4 ) ;
V_4 -> V_225 = 0 ;
...
static struct V_226 * F_127 ( struct V_227 * V_3 )
{
struct V_226 * V_228 ;
struct V_229 * V_230 = V_3 -> V_231 ;
const void * V_232 ;
if ( ! F_128 ( V_233 ) || ! V_230 )
return F_129 ( - V_234 ) ;
V_228 = F_130 ( V_3 , sizeof( * V_228 ) , V_235 ) ;
if ( ! V_228 )
return F_129 ( - V_236 ) ;
if ( F_131 ( V_230 , L_32 , NULL ) )
V_228 -> V_20 |= V_69 ;
if ( F_131 ( V_230 , L_33 , NULL ) )
V_228 -> V_20 |= V_52 ;
V_232 = F_132 ( V_230 ) ;
if ( V_232 )
memcpy ( V_228 -> V_128 , V_232 , sizeof( V_228 -> V_128 ) ) ;
return V_228 ;
}
static int
F_133 ( struct V_110 * V_111 )
{
struct V_226 * V_228 = F_134 ( & V_111 -> V_3 ) ;
struct V_1 * V_4 ;
struct V_2 * V_96 ;
struct V_227 * V_3 = & V_111 -> V_3 ;
...
struct V_242 * V_243 ;
bool V_244 = false ;
V_243 = F_135 ( V_3 , L_34 ) ;
if ( F_136 ( V_243 ) ) {
if ( F_137 ( V_243 ) == - V_245 )
return - V_245 ;
F_8 ( V_3 , L_35 ) ;
} else {
V_22 = F_138 ( V_243 ) ;
...
V_240 = F_139 ( V_3 -> V_231 , L_38 , 0 ,
& V_20 ) ;
if ( F_140 ( V_240 ) ) {
V_22 = F_141 ( V_3 , V_240 , V_20 ,
L_39 ) ;
if ( V_22 ) {
F_10 ( V_3 , L_40 ,
V_240 , V_22 ) ;
...
F_146 ( & V_4 -> V_23 ) ;
F_147 ( & V_4 -> V_39 , F_71 ) ;
V_4 -> V_247 = F_148 ( V_111 , V_248 , 0 ) ;
V_4 -> V_249 = F_148 ( V_111 , V_248 , 1 ) ;
if ( ! V_4 -> V_247 || ! V_4 -> V_249 ) {
F_10 ( V_4 -> V_3 , L_42 ,
V_4 -> V_247 , V_4 -> V_249 ) ;
V_22 = - V_75 ;
goto V_250;
...
V_238 = F_151 ( V_4 -> V_247 ) ;
V_4 -> V_113 = F_152 ( V_4 -> V_247 -> V_251 , V_238 ,
V_111 -> V_61 ) ;
if ( V_4 -> V_113 == NULL ) {
F_10 ( V_4 -> V_3 , L_47 ) ;
V_22 = - V_252 ;
...
V_4 -> V_6 = F_153 ( V_4 -> V_247 -> V_251 , V_238 ) ;
if ( V_4 -> V_6 == NULL ) {
F_10 ( V_4 -> V_3 , L_48 ) ;
V_22 = - V_45 ;
goto V_250;
}
V_238 = F_151 ( V_4 -> V_249 ) ;
V_4 -> V_112 = F_152 ( V_4 -> V_249 -> V_251 , V_238 ,
V_111 -> V_61 ) ;
if ( V_4 -> V_112 == NULL ) {
F_10 ( V_4 -> V_3 , L_49 ) ;
V_22 = - V_252 ;
...
V_4 -> V_7 = F_153 ( V_4 -> V_249 -> V_251 , V_238 ) ;
if ( V_4 -> V_7 == NULL ) {
F_10 ( V_4 -> V_3 , L_50 ) ;
V_22 = - V_45 ;
goto V_250;
}
V_96 -> V_253 = ( unsigned long ) V_4 -> V_6 ;
F_38 ( V_4 , V_238 ) ;
if ( V_228 != NULL ) {
if ( V_228 -> V_20 & V_254 )
F_38 ( V_4 , 1 ) ;
...
V_239 = F_3 ( V_4 , V_257 ) ;
V_239 |= ( T_3 ) F_3 ( V_4 , V_258 ) << 8 ;
V_239 |= ( T_3 ) F_3 ( V_4 , V_259 ) << 16 ;
V_239 |= ( T_3 ) F_3 ( V_4 , V_260 ) << 24 ;
if ( V_239 == V_261 )
break;
F_10 ( V_4 -> V_3 , L_51 , V_239 ) ;
}
if ( V_239 != V_261 ) {
F_10 ( V_4 -> V_3 , L_52 , V_239 ) ;
V_22 = - V_246 ;
goto V_250;
}
V_239 = F_3 ( V_4 , V_262 ) ;
F_8 ( V_4 -> V_3 , L_53 , V_239 ) ;
switch ( V_239 ) {
case V_263 :
V_4 -> type = V_115 ;
break;
...
if ( ! F_156 ( V_96 -> V_128 ) && V_228 != NULL ) {
V_237 = L_56 ;
memcpy ( V_96 -> V_128 , V_228 -> V_128 , V_278 ) ;
}
if ( ! F_156 ( V_96 -> V_128 ) ) {
V_237 = L_57 ;
