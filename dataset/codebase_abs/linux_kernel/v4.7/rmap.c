...
static void F_158 ( struct V_41 * V_41 )
{
F_155 ( V_41 ) ;
if ( F_18 ( F_87 ( V_41 ) ) ) {
F_159 ( F_146 ( V_41 ) ) ;
...
void F_168 ( struct V_41 * V_41 , bool V_113 )
{
if ( ! F_74 ( V_41 ) ) {
F_135 ( V_113 && ! F_87 ( V_41 ) , V_41 ) ;
F_158 ( V_41 ) ;
return;
}
if ( V_113 )
...
F_174 ( V_41 ) ;
F_175 ( V_18 ) ;
if ( F_176 ( V_41 ) && ! ( V_60 & V_135 ) ) {
if ( F_87 ( V_41 ) ) {
F_177 ( 1 << F_178 ( V_41 ) , V_18 ) ;
} else {
F_179 ( V_18 , F_180 ( V_41 ) ) ;
}
...
T_9 V_108 ;
T_6 V_137 ;
V_108 = F_184 ( V_41 , F_121 ( V_125 ) ) ;
V_137 = F_181 ( V_108 ) ;
if ( F_185 ( V_125 ) )
V_137 = F_186 ( V_137 ) ;
F_126 ( V_18 , V_63 , V_76 , V_137 ) ;
} else if ( F_74 ( V_41 ) ) {
T_9 V_108 = { . V_138 = F_187 (page) } ;
T_6 V_137 ;
F_135 ( ! F_188 ( V_41 ) , V_41 ) ;
if ( ! F_189 ( V_41 ) && ( V_60 & V_139 ) ) {
F_179 ( V_18 , V_140 ) ;
V_127 -> V_141 ++ ;
goto V_142;
}
...
F_179 ( V_18 , F_193 ( V_41 ) ) ;
V_142:
F_168 ( V_41 , F_87 ( V_41 ) ) ;
F_194 ( V_41 ) ;
V_133:
F_97 ( V_76 , V_77 ) ;
...
static bool F_196 ( struct V_12 * V_13 , void * V_85 )
{
return F_195 ( V_13 ) ;
}
static int F_197 ( struct V_41 * V_41 )
{
return ! F_171 ( V_41 ) ;
}
int F_198 ( struct V_41 * V_41 , enum V_59 V_60 )
{
int V_100 ;
struct V_126 V_127 = {
. V_60 = V_60 ,
...
V_103 . V_106 = F_196 ;
if ( V_60 & V_152 )
V_100 = F_199 ( V_41 , & V_103 ) ;
else
V_100 = F_117 ( V_41 , & V_103 ) ;
if ( V_100 != V_132 && ! F_171 ( V_41 ) ) {
V_100 = V_96 ;
if ( V_127 . V_141 && ! F_189 ( V_41 ) )
V_100 = V_153 ;
}
return V_100 ;
}
...
F_135 ( ! F_131 ( V_41 ) || F_202 ( V_41 ) , V_41 ) ;
V_100 = F_117 ( V_41 , & V_103 ) ;
return V_100 ;
}
...
static struct V_1 * F_203 ( struct V_41 * V_41 ,
struct V_102 * V_103 )
{
struct V_1 * V_1 ;
if ( V_103 -> V_105 )
...
static int F_204 ( struct V_41 * V_41 , struct V_102 * V_103 ,
bool V_154 )
{
struct V_1 * V_1 ;
T_10 V_155 ;
...
V_1 = F_203 ( V_41 , V_103 ) ;
}
if ( ! V_1 )
return V_100 ;
V_155 = F_142 ( V_41 ) ;
F_205 (avc, &anon_vma->rb_root, pgoff, pgoff) {
struct V_12 * V_13 = V_14 -> V_13 ;
unsigned long V_63 = F_206 ( V_41 , V_13 ) ;
F_207 () ;
...
if ( ! V_154 )
F_209 ( V_43 ) ;
F_210 (vma, &mapping->i_mmap, pgoff, pgoff) {
unsigned long V_63 = F_206 ( V_41 , V_13 ) ;
F_207 () ;
if ( V_103 -> V_106 && V_103 -> V_106 ( V_13 , V_103 -> V_85 ) )
continue;
...
{
if ( F_18 ( F_115 ( V_41 ) ) )
return F_212 ( V_41 , V_103 ) ;
else if ( F_74 ( V_41 ) )
return F_204 ( V_41 , V_103 , false ) ;
else
return F_208 ( V_41 , V_103 , false ) ;
}
int F_199 ( struct V_41 * V_41 , struct V_102 * V_103 )
{
F_135 ( F_115 ( V_41 ) , V_41 ) ;
if ( F_74 ( V_41 ) )
return F_204 ( V_41 , V_103 , true ) ;
else
return F_208 ( V_41 , V_103 , true ) ;
}
static void F_213 ( struct V_41 * V_41 ,
struct V_12 * V_13 , unsigned long V_63 , int V_111 )
{
struct V_1 * V_1 = V_13 -> V_1 ;
F_130 ( ! V_1 ) ;
...
if ( V_115 )
F_213 ( V_41 , V_13 , V_63 , 0 ) ;
}
void F_215 ( struct V_41 * V_41 ,
struct V_12 * V_13 , unsigned long V_63 )
{
F_130 ( V_63 < V_13 -> V_68 || V_63 >= V_13 -> V_69 ) ;
F_3 ( F_146 ( V_41 ) , 0 ) ;
F_213 ( V_41 , V_13 , V_63 , 1 ) ;
}
