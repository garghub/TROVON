...
enum V_20 V_21 = F_6 ( V_2 ) ;
struct V_22 * V_23 ;
T_2 V_110 , V_111 = 0 , V_28 = 0 ;
enum V_112 V_113 = V_4 -> V_4 . V_53 ;
V_23 = V_19 -> V_24 . V_25 -> V_26 [ V_21 ] ;
V_110 = F_44 ( V_2 , V_108 , V_21 , & V_111 ) ;
F_40 ( & V_4 -> V_7 -> V_11 ) ;
...
goto V_32;
V_4 -> V_7 -> V_117 = true ;
if ( V_4 -> V_4 . V_39 [ V_21 ] != V_110 )
V_28 |= V_118 ;
V_4 -> V_4 . V_39 [ V_21 ] = V_110 ;
if ( F_45 ( V_2 , V_23 ,
V_108 -> V_119 , V_4 ) )
V_28 |= V_120 ;
F_46 ( V_2 , V_23 ,
V_108 -> V_121 , V_4 ) ;
if ( V_113 != V_4 -> V_4 . V_53 )
V_28 |= V_120 ;
if ( V_108 -> V_122 &&
! ( V_108 -> V_122 -> V_123 &
V_124 ) ) {
...
F_52 ( V_4 -> V_4 . V_99 , V_125 ) ;
F_10 () ;
V_99 = F_53 ( V_125 , V_126 + 1 ) ;
F_54 ( V_125 ) ;
if ( V_99 > V_126 )
return - V_128 ;
return V_99 ;
...
static struct V_3 *
F_60 ( struct V_1 * V_2 ,
T_4 * V_44 , struct V_107 * V_108 ) __acquires( T_5 )
{
struct V_3 * V_4 = NULL ;
F_8 () ;
V_4 = F_61 ( V_2 , V_44 ) ;
if ( V_4 ) {
F_43 ( V_2 , V_4 , V_108 , false ) ;
} else {
F_10 () ;
V_4 = F_58 ( V_2 , V_44 , V_108 ) ;
if ( ! V_4 ) {
F_8 () ;
return NULL ;
}
F_43 ( V_2 , V_4 , V_108 , true ) ;
if ( F_62 ( V_4 ) )
return NULL ;
}
return V_4 ;
...
if ( V_177 != V_97 &&
( ! V_108 -> V_187 || ! V_108 -> V_145 ) ) {
F_11 ( V_2 , L_19 ) ;
return;
}
V_15 = F_89 ( F_90 ( V_108 -> V_184 ) ) ;
if ( V_177 == V_98 ||
( V_177 == V_97 && V_75 == 8 ) )
V_14 = F_89 ( F_91 ( V_108 -> V_184 ) ) ;
F_8 () ;
V_4 = F_61 ( V_2 , V_71 -> V_92 ) ;
if ( V_177 == V_101 &&
! F_1 ( V_2 , V_4 ) ) {
F_11 ( V_2 , L_20 ,
V_71 -> V_92 ) ;
...
V_165 = F_85 ( V_2 , V_4 , V_108 , V_177 , V_14 , V_15 ) ;
if ( V_165 == V_172 ) {
F_10 () ;
V_4 = F_60 ( V_2 , V_71 -> V_92 , V_108 ) ;
if ( ! V_4 ) {
F_11 ( V_2 , L_21 ) ;
goto V_188;
}
...
if ( ! V_4 -> V_7 -> V_15 )
V_4 -> V_7 -> V_15 = V_15 ;
V_4 -> V_7 -> V_99 = F_89 ( F_92 ( V_71 ) ) ;
}
V_28 |= F_84 ( V_2 , V_4 , V_165 ) ;
V_188:
F_10 () ;
if ( V_28 )
F_67 ( V_2 , V_28 ) ;
...
F_95 ( V_193 , V_189 - V_192 , true , & V_108 ) ;
F_88 ( V_2 , V_71 , & V_108 ) ;
}
