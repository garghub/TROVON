...
F_3 ( V_13 ) ;
if ( V_53 -> V_185 -> V_114 >= V_186 ) {
V_91 = V_53 -> V_185 -> V_513 . V_514 . V_515 ;
V_13 -> V_430 = V_516 ;
} else {
V_91 = V_53 -> V_185 -> V_513 . V_517 . V_515 ;
V_13 -> V_430 = V_518 ;
}
F_103 ( F_104 ( V_516 ) != V_429 ) ;
F_103 ( F_104 ( V_518 ) != V_429 ) ;
switch ( V_91 & 0xf ) {
case 0 :
V_13 -> V_76 = 1 ;
break;
...
struct V_148 * V_527 , * V_528 , * V_529 ;
T_1 V_530 , V_531 , V_147 , V_532 ;
T_2 * V_89 = V_53 -> V_89 . V_90 ;
T_1 V_105 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_528 -> V_182 ) & 0xff ;
V_53 -> V_105 += V_147 + 3 ;
break;
default:
F_64 ( L_130 , V_105 , V_530 ) ;
return - V_68 ;
}
if ( ( V_534 + ( V_147 * 4 ) ) > F_23 ( V_528 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_131 ,
V_534 , F_23 ( V_528 -> V_198 ) ) ;
return - V_68 ;
}
break;
case V_537 :
...
if ( ( V_533 + ( V_147 * 4 ) ) > F_23 ( V_527 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_133 ,
V_533 + ( V_147 * 4 ) , F_23 ( V_527 -> V_198 ) ) ;
return - V_68 ;
}
if ( ( V_534 + ( V_147 * 4 ) ) > F_23 ( V_528 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_134 ,
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_527 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_528 -> V_182 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_527 -> V_182 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
case 0x08 :
...
V_533 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_527 -> V_182 >> 8 ) ;
...
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_527 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_527 -> V_182 ) & 0xff ;
V_534 = F_43 ( V_53 , V_105 + 1 ) ;
V_534 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_182 >> 8 ) ;
}
...
V_534 = F_43 ( V_53 , V_105 + 1 ) ;
V_534 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_533 + V_147 ) > F_23 ( V_527 -> V_198 ) ) {
F_7 ( V_53 -> V_66 , L_137 ,
V_533 + V_147 , F_23 ( V_527 -> V_198 ) ) ;
return - V_68 ;
}
...
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_527 -> V_182 & 0xffffffff ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_528 -> V_182 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_527 -> V_182 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_527 -> V_182 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_527 -> V_182 ) & 0xff ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_528 -> V_182 & 0xffffffff ) ;
V_89 [ V_105 + 5 ] += F_91 ( V_528 -> V_182 ) & 0xff ;
V_53 -> V_105 += 9 ;
break;
case 0x44 :
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_529 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( T_1 ) ( V_527 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 4 ] += F_91 ( V_528 -> V_182 ) & 0xff ;
V_89 [ V_105 + 5 ] += F_91 ( V_529 -> V_182 ) & 0xff ;
V_89 [ V_105 + 6 ] += F_91 ( V_527 -> V_182 ) & 0xff ;
V_53 -> V_105 += 7 ;
break;
case 0x48 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_182 >> 8 ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_529 -> V_182 >> 8 ) ;
V_89 [ V_105 + 8 ] += ( T_1 ) ( V_527 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 9 ] += F_91 ( V_527 -> V_182 ) & 0xff ;
V_53 -> V_105 += 10 ;
break;
case 0x49 :
if ( V_53 -> V_114 < V_186 ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_527 -> V_182 >> 8 ) ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_528 -> V_182 >> 8 ) ;
V_53 -> V_105 += 13 ;
break;
case 0x4f :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_182 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( F_91 ( V_528 -> V_182 ) << 16 ) & 0x00ff0000 ;
V_53 -> V_105 += 4 ;
break;
case V_539 :
V_53 -> V_105 += 1 ;
...
static int F_113 ( struct V_614 * V_185 ,
...
int F_114 ( struct V_614 * V_185 , struct V_624 * V_89 )
{
int V_625 = 0 ;
T_1 V_105 = 0 ;
struct V_143 V_144 ;
...
V_625 = F_113 ( V_185 , V_89 -> V_90 , & V_144 ) ;
V_105 += V_144 . V_147 + 2 ;
break;
default:
F_87 ( V_185 -> V_66 , L_127 , V_144 . type ) ;
V_625 = - V_68 ;
break;
}
if ( V_625 )
...
int F_118 ( struct V_614 * V_185 , struct V_624 * V_89 )
{
T_1 V_105 = 0 ;
T_1 V_530 , V_531 , V_147 , V_532 ;
do {
...
break;
default:
F_64 ( L_130 , V_105 , V_89 -> V_90 [ V_105 ] ) ;
return - V_68 ;
}
break;
case V_537 :
...
break;
default:
F_64 ( L_154 , V_105 , V_89 -> V_90 [ V_105 ] ) ;
return - V_68 ;
}
break;
case V_538 :
