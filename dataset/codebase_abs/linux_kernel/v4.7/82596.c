...
if ( ! V_100 ) {
F_35 ( V_58 , 2 ) ;
memcpy ( F_34 ( V_58 , V_99 ) , V_32 -> V_63 , V_99 ) ;
}
...
if ( F_44 ( V_2 -> V_50 , V_138 , 0 , L_41 , V_2 ) ) {
...
static T_3 F_49 ( struct V_59 * V_58 , struct V_1 * V_2 )
{
struct V_15 * V_16 = V_2 -> V_28 ;
struct V_121 * V_121 ;
struct V_145 * V_146 ;
...
#ifdef F_19
F_52 ( F_21 ( ( void * ) ( V_2 -> V_178 ) ) , 4096 ) ;
F_20 ( F_21 ( ( void * ) ( V_2 -> V_178 ) ) , 4096 ) ;
F_58 ( ( void * ) ( V_2 -> V_178 ) , 4096 , V_188 ) ;
#endif
V_16 -> V_23 . V_25 = 0 ;
V_16 -> V_23 . V_27 = V_42 ;
V_16 -> V_23 . V_30 = V_42 ;
...
F_76 ( V_218 ) ;
#ifdef F_19
F_58 ( ( void * ) ( V_218 -> V_178 ) , 4096 ,
V_190 ) ;
#endif
F_61 ( ( T_1 ) ( V_218 -> V_178 ) ) ;
F_62 ( V_218 ) ;
}
