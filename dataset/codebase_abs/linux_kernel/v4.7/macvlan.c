...
static struct V_149 * F_122 ( struct V_5 * V_6 ,
struct V_149 * V_150 )
{
struct V_8 * V_10 = F_71 ( V_6 ) ;
if ( V_10 -> V_95 ) {
...
do {
V_155 = F_125 ( & V_118 -> V_96 ) ;
V_151 = V_118 -> V_151 ;
V_152 = V_118 -> V_152 ;
V_153 = V_118 -> V_153 ;
V_97 = V_118 -> V_97 ;
V_98 = V_118 -> V_98 ;
} while ( F_126 ( & V_118 -> V_96 , V_155 ) );
V_150 -> V_151 += V_151 ;
V_150 -> V_152 += V_152 ;
V_150 -> V_156 += V_153 ;
V_150 -> V_97 += V_97 ;
...
struct V_8 * V_10 = F_71 ( V_6 ) ;
struct V_5 * V_88 = V_10 -> V_88 ;
F_130 ( V_88 , V_157 , V_158 ) ;
return 0 ;
}
static int F_131 ( struct V_159 * V_160 , struct V_161 * V_162 [] ,
struct V_5 * V_6 ,
...
static int F_135 ( struct V_159 * V_160 , struct V_161 * V_162 [] ,
struct V_5 * V_6 ,
const unsigned char * V_1 , T_6 V_158 )
{
struct V_8 * V_10 = F_71 ( V_6 ) ;
...
struct V_165 * V_166 )
{
F_138 ( V_166 -> V_167 , L_1 , sizeof( V_166 -> V_167 ) ) ;
F_138 ( V_166 -> V_168 , L_2 , sizeof( V_166 -> V_168 ) ) ;
}
static int F_139 ( struct V_5 * V_6 ,
struct V_169 * V_170 )
{
const struct V_8 * V_10 = F_71 ( V_6 ) ;
return F_140 ( V_10 -> V_88 , V_170 ) ;
}
...
T_7 V_172 ;
V_104 |= V_173 ;
V_104 &= ( V_10 -> V_174 | ~ V_140 ) ;
V_172 = V_104 ;
V_171 &= ( V_104 | ~ V_143 ) ;
V_104 = F_142 ( V_171 , V_104 , V_172 ) ;
V_104 |= V_141 ;
V_104 &= ~ V_175 ;
return V_104 ;
}
...
static int F_144 ( struct V_5 * V_6 , struct V_176 * V_177 )
{
struct V_8 * V_10 = F_71 ( V_6 ) ;
...
unsigned int V_43 ;
int V_44 ;
if ( V_6 -> type != V_191 || V_6 -> V_72 & V_192 )
return - V_129 ;
if ( F_156 ( V_6 ) )
return - V_110 ;
...
static int F_165 ( struct V_161 * V_162 [] , struct V_161 * V_86 [] )
{
if ( V_162 [ V_194 ] ) {
if ( F_166 ( V_162 [ V_194 ] ) != V_25 )
return - V_129 ;
if ( ! F_98 ( F_167 ( V_162 [ V_194 ] ) ) )
return - V_121 ;
}
if ( V_86 && V_86 [ V_195 ] &&
F_168 ( V_86 [ V_195 ] ) & ~ V_102 )
return - V_129 ;
if ( V_86 && V_86 [ V_196 ] ) {
...
if ( V_86 && V_86 [ V_203 ] ) {
if ( F_166 ( V_86 [ V_203 ] ) != V_25 )
return - V_129 ;
if ( ! F_98 ( F_167 ( V_86 [ V_203 ] ) ) )
return - V_121 ;
}
if ( V_86 && V_86 [ V_204 ] )
return - V_129 ;
...
char * V_1 = NULL ;
int V_71 , V_205 , V_53 ;
struct V_161 * V_206 , * V_207 ;
struct V_13 * V_14 ;
if ( V_86 [ V_203 ] )
V_1 = F_167 ( V_86 [ V_203 ] ) ;
if ( V_41 == V_199 ) {
if ( ! V_1 )
return - V_129 ;
...
if ( ! V_86 || ! V_86 [ V_208 ] )
return 0 ;
V_207 = F_167 ( V_86 [ V_208 ] ) ;
V_53 = F_166 ( V_86 [ V_208 ] ) ;
F_171 (nla, head, len, rem) {
if ( F_172 ( V_206 ) != V_203 ||
F_166 ( V_206 ) != V_25 )
continue;
V_1 = F_167 ( V_206 ) ;
V_71 = F_13 ( V_10 , V_1 ) ;
...
int F_173 ( struct V_209 * V_210 , struct V_5 * V_6 ,
...
if ( ! V_162 [ V_212 ] )
return - V_129 ;
V_88 = F_174 ( V_210 , F_169 ( V_162 [ V_212 ] ) ) ;
if ( V_88 == NULL )
return - V_213 ;
if ( F_175 ( V_88 ) )
V_88 = F_176 ( V_88 ) ;
...
V_10 -> V_41 = V_64 ;
if ( V_86 && V_86 [ V_196 ] )
V_10 -> V_41 = F_169 ( V_86 [ V_196 ] ) ;
if ( V_86 && V_86 [ V_195 ] )
V_10 -> V_72 = F_168 ( V_86 [ V_195 ] ) ;
if ( V_10 -> V_41 == V_65 ) {
if ( V_9 -> V_148 )
return - V_129 ;
V_9 -> V_82 = true ;
...
if ( V_10 -> V_41 != V_197 )
return - V_129 ;
V_211 = F_169 ( V_86 [ V_198 ] ) ;
V_44 = F_170 ( V_10 , V_211 , V_86 ) ;
if ( V_44 )
return V_44 ;
}
V_44 = F_181 ( V_6 ) ;
...
static int F_187 ( struct V_209 * V_210 , struct V_5 * V_6 ,
struct V_161 * V_162 [] , struct V_161 * V_86 [] )
{
return F_173 ( V_210 , V_6 , V_162 , V_86 ) ;
}
void F_188 ( struct V_5 * V_6 , struct V_217 * V_207 )
{
struct V_8 * V_10 = F_71 ( V_6 ) ;
if ( V_10 -> V_41 == V_197 )
F_57 ( V_10 -> V_9 , V_10 ) ;
...
if ( V_14 -> V_10 != V_10 )
continue;
if ( F_197 ( V_27 , V_203 , V_25 , V_14 -> V_1 ) )
return 1 ;
}
return 0 ;
}
...
int V_43 ;
struct V_161 * V_222 ;
if ( F_199 ( V_27 , V_196 , V_10 -> V_41 ) )
goto V_223;
if ( F_200 ( V_27 , V_195 , V_10 -> V_72 ) )
goto V_223;
if ( F_199 ( V_27 , V_204 , V_10 -> V_21 ) )
goto V_223;
if ( V_10 -> V_21 > 0 ) {
V_222 = F_201 ( V_27 , V_208 ) ;
if ( V_222 == NULL )
goto V_223;
for ( V_43 = 0 ; V_43 < V_48 ; V_43 ++ ) {
...
static struct V_209 * F_205 ( const struct V_5 * V_6 )
{
