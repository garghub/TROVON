...
unsigned int V_39 = 1300 ;
unsigned int V_40 = 400 ;
unsigned int V_41 = 200 ;
V_24 = F_11 ( & V_2 -> V_25 , V_2 -> V_25 . V_22 ,
V_29 ) ;
V_40 = F_14 ( V_40 , ( V_24 -> V_30 + 1 ) / 2 * V_24 -> V_31 - 4 ) ;
F_1 ( V_2 , V_4 , V_42 ,
( V_39 << V_43 ) |
( V_41 << V_44 ) ) ;
F_1 ( V_2 , V_4 , V_45 ,
...
struct V_1 * F_15 ( struct V_50 * V_51 )
{
struct V_1 * V_2 ;
int V_52 ;
V_2 = F_16 ( V_51 -> V_53 , sizeof( * V_2 ) , V_54 ) ;
if ( V_2 == NULL )
return F_17 ( - V_55 ) ;
V_2 -> V_25 . V_56 = & V_57 ;
V_2 -> V_25 . type = V_58 ;
V_52 = F_18 ( V_51 , & V_2 -> V_25 , L_1 , 2 , & V_59 ) ;
if ( V_52 < 0 )
return F_17 ( V_52 ) ;
return V_2 ;
}
