...
goto V_36;
if ( F_12 ( V_2 , 0 , V_37 . V_38 , false ) )
goto V_36;
return F_13 ( V_34 , V_2 , & V_37 , NULL , V_39 ) ;
}
return - 1 ;
V_36:
F_14 ( V_2 ) ;
...
static int
F_22 ( struct V_40 * V_5 , struct V_49 * V_50 , int V_51 )
{
int V_14 = 0 ;
struct V_52 V_53 ;
if ( F_23 ( & V_53 , V_50 -> V_54 . V_55 , sizeof( V_53 ) ) )
return - V_56 ;
...
V_14 = F_24 ( V_5 , & V_53 , V_51 ) ;
if ( V_14 )
return V_14 ;
if ( F_25 ( V_50 -> V_54 . V_55 , & V_53 , sizeof( V_53 ) ) )
return - V_56 ;
return 0 ;
}
static void F_26 ( struct V_40 * V_5 )
{
V_5 -> V_68 = & V_69 ;
V_5 -> type = V_70 ;
V_5 -> V_71 = V_72 ;
...
return;
if ( V_11 [ V_84 ] )
V_24 -> V_25 = F_32 ( V_11 [ V_84 ] ) ;
if ( V_11 [ V_85 ] )
V_24 -> V_10 . V_20 = F_33 ( V_11 [ V_85 ] ) ;
if ( V_11 [ V_86 ] )
V_24 -> V_10 . V_19 = F_33 ( V_11 [ V_86 ] ) ;
if ( V_11 [ V_87 ] ) {
V_24 -> V_10 . V_28 = F_34 ( V_11 [ V_87 ] ) ;
if ( V_24 -> V_10 . V_28 )
V_24 -> V_10 . V_61 = F_18 ( V_62 ) ;
}
if ( V_11 [ V_88 ] )
V_24 -> V_10 . V_89 = F_34 ( V_11 [ V_88 ] ) ;
if ( ! V_11 [ V_90 ] || F_34 ( V_11 [ V_90 ] ) )
V_24 -> V_10 . V_61 = F_18 ( V_62 ) ;
}
static bool F_35 ( struct V_83 * V_11 [] ,
struct V_91 * V_92 )
{
bool V_93 = false ;
...
if ( V_11 [ V_94 ] ) {
V_93 = true ;
V_92 -> type = F_36 ( V_11 [ V_94 ] ) ;
}
if ( V_11 [ V_95 ] ) {
V_93 = true ;
V_92 -> V_71 = F_36 ( V_11 [ V_95 ] ) ;
}
if ( V_11 [ V_96 ] ) {
V_93 = true ;
V_92 -> V_97 = F_37 ( V_11 [ V_96 ] ) ;
}
if ( V_11 [ V_98 ] ) {
V_93 = true ;
V_92 -> V_99 = F_37 ( V_11 [ V_98 ] ) ;
}
return V_93 ;
}
static int F_38 ( struct V_4 * V_100 , struct V_40 * V_5 ,
...
int V_14 = F_39 ( V_13 , & V_92 ) ;
if ( V_14 < 0 )
return V_14 ;
}
F_31 ( V_11 , & V_53 ) ;
return F_40 ( V_5 , V_101 , & V_53 ) ;
}
static int F_41 ( struct V_40 * V_5 , struct V_83 * V_101 [] ,
struct V_83 * V_11 [] )
{
struct V_52 V_53 ;
struct V_91 V_92 ;
...
if ( F_46 ( V_2 , V_84 , V_103 -> V_25 ) ||
F_47 ( V_2 , V_85 , V_103 -> V_10 . V_20 ) ||
F_47 ( V_2 , V_86 , V_103 -> V_10 . V_19 ) ||
F_48 ( V_2 , V_87 , V_103 -> V_10 . V_28 ) ||
F_48 ( V_2 , V_88 , V_103 -> V_10 . V_89 ) ||
F_48 ( V_2 , V_90 ,
...
static int T_4 F_51 ( struct V_4 * V_4 )
{
return F_52 ( V_4 , V_8 , & V_107 , L_1 ) ;
}
static void T_5 F_53 ( struct V_4 * V_4 )
{
struct V_6 * V_7 = F_3 ( V_4 , V_8 ) ;
F_54 ( V_7 , & V_107 ) ;
}
