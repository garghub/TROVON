...
static T_6 F_107 ( struct V_126 * V_127 ,
struct V_128 * V_129 , int V_73 )
{
struct V_1 * V_2 = F_108 ( V_127 , struct V_1 , V_127 ) ;
if ( V_129 == & V_130 . V_42 ) {
if ( F_11 ( V_2 ) )
return 0 ;
return V_129 -> V_124 ;
...
if ( ! V_4 )
return NULL ;
V_142 = F_113 ( 2 , sizeof( struct V_1 * ) , V_51 ) ;
if ( ! V_142 ) {
F_3 ( V_4 ) ;
return NULL ;
}
...
static bool F_114 ( struct V_11 * V_11 , T_1 * V_8 ,
T_7 V_145 , T_8 V_46 )
{
...
bool V_148 = false ;
int V_149 ;
F_115 (l, nd_label, nd_mapping->labels) {
T_7 V_150 = F_116 ( V_147 -> V_150 ) ;
T_8 V_151 = F_117 ( V_147 -> V_151 ) ;
T_8 V_152 = F_117 ( V_147 -> V_152 ) ;
if ( V_150 != V_145 )
continue;
...
static int F_118 ( struct V_11 * V_11 , T_1 * V_153 )
{
...
V_157 = F_116 ( V_154 -> V_100 ) ;
V_158 = V_157 + F_116 ( V_154 -> V_159 ) ;
...
if ( V_145 == 0 )
return - V_49 ;
F_115 (l, nd_label, nd_region->mapping[0].labels) {
T_7 V_150 = F_116 ( V_147 -> V_150 ) ;
if ( V_150 != V_145 )
continue;
for ( V_67 = 0 ; V_11 -> V_77 ; V_67 ++ )
if ( ! F_114 ( V_11 , V_147 -> V_8 ,
V_145 , V_67 ) )
break;
if ( V_67 < V_11 -> V_77 ) {
V_48 = - V_54 ;
...
V_48 = F_118 ( V_11 , V_153 ) ;
if ( V_48 )
goto V_161;
for ( V_67 = 0 ; V_67 < V_11 -> V_77 ; V_67 ++ ) {
struct V_57 * V_57 = & V_11 -> V_58 [ V_67 ] ;
struct V_146 * V_162 = V_57 -> V_121 [ 0 ] ;
V_63 += F_116 ( V_162 -> V_159 ) ;
if ( F_117 ( V_162 -> V_151 ) != 0 )
continue;
F_119 ( V_6 -> V_7 || V_6 -> V_8 ) ;
...
struct V_64 * F_123 ( struct V_11 * V_11 ,
...
V_2 = & V_10 -> V_56 . V_2 ;
V_2 -> type = & V_17 ;
V_10 -> V_13 = F_126 ( & V_11 -> V_14 , 0 , 0 , V_51 ) ;
if ( V_10 -> V_13 < 0 ) {
F_3 ( V_10 ) ;
return NULL ;
}
F_127 ( V_2 , L_53 , V_11 -> V_13 , V_10 -> V_13 ) ;
V_2 -> V_12 = & V_11 -> V_2 ;
V_2 -> V_164 = V_165 ;
...
{
F_119 ( ! F_25 ( & V_11 -> V_2 ) ) ;
V_11 -> V_166 = F_132 ( V_11 ) ;
if ( ! V_11 -> V_166 )
F_129 ( & V_11 -> V_2 , L_55 ) ;
}
void F_133 ( struct V_11 * V_11 )
{
F_119 ( ! F_25 ( & V_11 -> V_2 ) ) ;
V_11 -> V_167 = F_134 ( V_11 ) ;
if ( ! V_11 -> V_167 )
F_129 ( & V_11 -> V_2 , L_56 ) ;
}
void F_135 ( struct V_11 * V_11 )
{
F_119 ( ! F_25 ( & V_11 -> V_2 ) ) ;
V_11 -> V_168 = F_136 ( V_11 ) ;
if ( ! V_11 -> V_168 )
F_129 ( & V_11 -> V_2 , L_57 ) ;
}
static struct V_1 * * F_137 ( struct V_11 * V_11 )
{
struct V_57 * V_57 = & V_11 -> V_58 [ 0 ] ;
struct V_146 * V_147 ;
...
V_24 ) == 0 ) {
V_15 = F_123 ( V_11 , V_60 , V_10 ,
F_116 ( V_147 -> V_100 ) ) ;
if ( ! V_15 )
goto V_161;
F_60 ( V_11 , V_60 , V_15 , L_58 ,
F_101 ( & V_10 -> V_56 . V_2 ) ) ;
break;
}
}
if ( V_67 < V_66 )
continue;
V_169 = F_113 ( V_66 + 2 , sizeof( V_2 ) , V_51 ) ;
if ( ! V_169 )
goto V_161;
memcpy ( V_169 , V_142 , sizeof( V_2 ) * V_66 ) ;
F_3 ( V_142 ) ;
V_142 = V_169 ;
V_10 = F_40 ( sizeof( * V_10 ) , V_51 ) ;
if ( ! V_10 )
...
V_2 -> type = & V_17 ;
V_2 -> V_12 = & V_11 -> V_2 ;
F_127 ( V_2 , L_53 , V_11 -> V_13 , V_66 ) ;
V_142 [ V_66 ++ ] = V_2 ;
V_10 -> V_13 = - 1 ;
V_10 -> V_68 = F_116 ( V_147 -> V_68 ) ;
...
F_141 ( V_60 ) ;
V_66 = F_142 ( V_60 ) ;
F_56 ( V_60 -> V_2 , L_61 , V_72 , V_66 ) ;
if ( ! V_66 )
continue;
V_57 -> V_121 = F_113 ( V_66 + 1 , sizeof( void * ) ,
V_51 ) ;
if ( ! V_57 -> V_121 )
return - V_52 ;
for ( V_105 = 0 ; V_105 < V_66 ; V_105 ++ ) {
struct V_146 * V_172 ;
V_172 = F_143 ( V_60 , V_105 ) ;
V_57 -> V_121 [ V_105 ] = V_172 ;
}
}
return 0 ;
}
int F_144 ( struct V_11 * V_11 , int * V_161 )
{
