...
static int F_50 ( struct V_150 * V_151 )
{
struct V_1 * V_2 =
F_51 ( V_151 , struct V_1 , V_2 ) ;
...
static void F_52 ( struct V_150 * V_151 , int V_152 )
{
struct V_1 * V_2 =
F_51 ( V_151 , struct V_1 , V_2 ) ;
int V_4 = F_20 ( V_2 ) ;
...
static int F_55 ( struct V_150 * V_151 , struct V_126 * V_127 )
{
struct V_1 * V_2 =
F_51 ( V_151 , struct V_1 , V_2 ) ;
int V_4 ;
F_56 ( V_153 , & V_127 -> V_154 ) ;
F_57 ( & V_2 -> V_8 ) ;
V_4 = F_20 ( V_2 ) ;
if ( V_4 )
return V_4 ;
...
static int F_66 ( struct V_163 * V_164 , struct V_126 * V_127 )
{
int V_165 = V_127 -> V_3 ;
struct V_1 * V_2 = F_7 ( V_165 ) ;
int V_4 = F_67 ( V_164 , V_127 ) ;
if ( V_4 == 0 )
V_127 -> V_166 = V_2 ;
else
F_9 ( V_2 ) ;
...
static int F_69 ( struct V_126 * V_127 , struct V_167 * V_168 )
{
struct V_1 * V_2 = V_127 -> V_166 ;
return F_70 ( & V_2 -> V_2 , V_127 , V_168 ) ;
}
static void F_71 ( struct V_126 * V_127 , struct V_167 * V_168 )
{
struct V_1 * V_2 = V_127 -> V_166 ;
F_72 ( & V_2 -> V_2 , V_127 , V_168 ) ;
}
...
static int F_75 ( struct V_126 * V_127 , const unsigned char * V_169 ,
int V_125 )
{
struct V_1 * V_2 = V_127 -> V_166 ;
int V_4 ;
if ( ! V_2 -> V_16 )
return - V_18 ;
V_4 = F_76 ( & V_2 -> V_8 , V_169 , V_125 , & V_2 -> V_7 ) ;
if ( ! ( V_2 -> V_94 & V_105 ) ) {
int V_170 = F_20 ( V_2 ) ;
if ( ! V_170 ) {
F_33 ( V_2 ) ;
...
static void F_79 ( struct V_126 * V_127 , char V_107 )
{
struct V_1 * V_2 = V_127 -> V_166 ;
V_2 -> V_130 = V_107 ;
...
static int F_87 ( struct V_126 * V_127 , int V_174 )
{
struct V_1 * V_2 = V_127 -> V_166 ;
int V_175 ;
V_175 = F_20 ( V_2 ) ;
...
static int F_90 ( struct V_176 * V_177 , void * V_178 )
{
int V_179 ;
F_91 ( V_177 , L_1 ,
L_2 , L_2 , L_2 ) ;
...
static int F_94 ( struct V_181 * V_181 , struct V_167 * V_167 )
{
return F_95 ( V_167 , F_90 , NULL ) ;
}
...
struct V_1 * V_2 ;
int V_4 ;
V_2 = F_97 ( sizeof( struct V_1 ) , V_10 ) ;
if ( ! V_2 )
return - V_11 ;
if ( V_16 -> V_184 == V_185 ) {
F_98 ( L_13 ,
...
F_100 ( L_15 ,
F_99 ( V_16 ) , V_189 -> V_194 [ 2 ] , V_189 -> V_194 [ 3 ] ) ;
