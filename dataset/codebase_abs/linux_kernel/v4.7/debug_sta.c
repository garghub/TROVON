...
exit:
V_17 = F_7 ( V_2 , V_3 , V_4 , V_16 , V_14 ) ;
F_8 ( V_16 ) ;
return V_17 ;
}
...
return;
F_11 () ;
V_21 = F_12 ( V_9 -> V_51 , V_40 -> V_52 , NULL ) ;
if ( ! V_21 )
goto exit;
...
void F_22 ( struct V_78 * V_51 ,
struct V_79 * V_80 ,
struct V_49 * V_21 ,
struct V_81 * V_82 )
{
struct V_5 * V_6 = (struct V_5 * ) V_21 -> V_53 ;
F_23 ( L_39 , V_83 , V_82 , V_6 , & V_84 ) ;
F_23 ( L_40 , V_83 , V_82 , V_6 , & V_85 ) ;
}
