...
{
struct V_18 * V_19 ;
struct V_101 * V_102 = F_83 ( V_51 ) ;
struct V_55 * V_55 = F_84 ( V_51 -> V_103 ) ;
struct V_1 * V_2 = F_32 ( V_55 , V_56 ) ;
struct V_20 * V_21 = F_85 ( & V_102 -> V_104 ) ;
if ( ! F_86 ( V_21 ) ) {
return 0 ;
}
F_61 () ;
V_19 = F_22 ( V_21 , V_51 -> V_103 -> V_22 , V_2 ) ;
if ( V_19 )
F_87 ( V_51 , & V_19 -> V_23 . V_28 ) ;
F_62 () ;
return 0 ;
}
int F_88 ( void )
