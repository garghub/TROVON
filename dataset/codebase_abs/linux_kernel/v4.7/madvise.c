...
if ( F_52 ( V_68 ) || F_53 ( V_68 ) ) {
V_68 = F_54 ( V_12 , V_65 , V_53 ,
V_67 -> V_71 ) ;
V_68 = F_55 ( V_68 ) ;
V_68 = F_56 ( V_68 ) ;
F_57 ( V_12 , V_65 , V_53 , V_68 ) ;
if ( F_58 ( V_55 ) )
F_59 ( V_55 ) ;
F_60 ( V_67 , V_53 , V_65 ) ;
}
...
if ( ! F_69 ( V_7 ) )
return - V_26 ;
V_9 = F_70 ( V_7 -> V_37 , V_75 ) ;
if ( V_9 >= V_7 -> V_43 )
return - V_26 ;
V_10 = F_71 ( V_7 -> V_43 , V_76 ) ;
if ( V_10 <= V_7 -> V_37 )
return - V_26 ;
F_21 () ;
F_72 ( & V_67 , V_12 , V_9 , V_10 ) ;
F_73 ( V_12 ) ;
F_74 ( V_12 , V_9 , V_10 ) ;
F_65 ( & V_67 , V_7 , V_9 , V_10 ) ;
F_75 ( V_12 , V_9 , V_10 ) ;
F_76 ( & V_67 , V_9 , V_10 ) ;
return 0 ;
}
...
static int F_86 ( int V_89 , unsigned long V_9 , unsigned long V_10 )
{
struct V_55 * V_90 ;
if ( ! F_87 ( V_91 ) )
return - V_92 ;
...
static long
F_96 ( struct V_6 * V_7 , struct V_6 * * V_8 ,
unsigned long V_9 , unsigned long V_10 , int V_1 )
{
switch ( V_1 ) {
case V_2 :
return F_80 ( V_7 , V_8 , V_9 , V_10 ) ;
case V_3 :
