...
V_3 -> V_68 = V_53 -> V_68 ;
V_3 -> V_69 = ( void * ) V_142 -> V_160 ;
V_3 -> V_70 = V_3 -> V_69 + V_142 -> V_101 ;
V_3 -> V_71 = V_142 -> V_161 ;
...
if ( V_3 -> V_164 ) {
V_3 -> V_118 = V_165 ;
V_152 = F_70 ( V_3 , V_149 ) ;
if ( V_152 ) {
V_141 -> V_115 = V_152 ;
F_41 ( V_3 ) ;
return;
}
V_146 = V_53 -> V_146 | V_147 | V_3 -> V_166 ;
...
V_3 -> V_164 ? L_11 : L_12 ) ;
if ( F_2 ( V_3 ) ) {
if ( ( F_7 ( V_3 , V_167 ) & 0xff )
!= V_53 -> V_168 )
F_25 ( V_3 , V_167 ,
V_53 -> V_168 ) ;
if ( ( F_7 ( V_3 , V_169 ) & 0xffff )
!= V_53 -> V_170 )
F_25 ( V_3 , V_169 ,
V_53 -> V_170 ) ;
}
if ( F_3 ( V_3 ) &&
( F_7 ( V_3 , V_171 ) != V_53 -> V_139 ) )
F_25 ( V_3 , V_171 , V_53 -> V_139 ) ;
...
static int F_74 ( struct V_172 * V_49 ,
struct V_74 * V_75 )
{
...
static int F_77 ( struct V_172 * V_49 )
{
struct V_2 * V_3 = F_75 ( V_49 ) ;
F_25 ( V_3 , V_96 ,
F_7 ( V_3 , V_96 ) & ~ V_27 ) ;
...
static int F_78 ( struct V_174 * V_46 , struct V_52 * V_53 ,
struct V_175 * V_176 )
{
int V_152 = 0 ;
if ( V_53 == NULL || V_176 == NULL )
return 0 ;
if ( F_26 ( V_53 -> V_59 ) )
F_79 ( V_53 -> V_59 ) ;
if ( V_176 -> V_57 ) {
V_53 -> V_57 = V_176 -> V_57 ;
return 0 ;
}
if ( F_26 ( V_176 -> V_59 ) ) {
V_152 = F_80 ( V_176 -> V_59 , L_13 ) ;
if ( V_152 ) {
F_52 ( & V_46 -> V_98 , L_14 ,
V_176 -> V_59 ) ;
return V_152 ;
}
V_53 -> V_59 = V_176 -> V_59 ;
V_53 -> V_60 = V_46 -> V_177 & V_178 ;
V_152 = F_81 ( V_53 -> V_59 ,
! V_53 -> V_60 ) ;
}
return V_152 ;
}
static int F_82 ( struct V_174 * V_46 )
{
...
V_53 -> V_168 = F_86 ( V_181 ) ;
V_53 -> V_170 = F_87 ( V_179 )
| F_88 ( V_180 ) ;
if ( V_53 -> V_39 ) {
if ( F_68 ( V_53 , V_46 ,
V_46 -> V_162 ,
...
V_53 -> V_109 = F_34 ;
V_53 -> V_110 = F_33 ;
} else if ( V_46 -> V_162 <= 16 ) {
V_53 -> V_68 = 2 ;
V_53 -> V_109 = F_36 ;
V_53 -> V_110 = F_35 ;
} else if ( V_46 -> V_162 <= 32 ) {
V_53 -> V_68 = 4 ;
V_53 -> V_109 = F_38 ;
V_53 -> V_110 = F_37 ;
}
...
if ( V_3 -> V_5 == V_55 )
return 0 ;
return F_78 ( V_46 , V_53 , V_176 ) ;
}
static void F_93 ( struct V_174 * V_46 )
{
...
static int F_109 ( struct V_172 * V_49 , unsigned V_43 )
{
struct V_2 * V_3 = F_75 ( V_49 ) ;
...
V_49 -> V_246 = F_109 ;
V_49 -> V_247 = true ;
V_49 -> V_248 = V_249 | V_250 ;
V_3 -> V_5 = V_137 -> type ;
V_3 -> V_34 = V_137 -> V_228 ;
V_3 -> V_251 = V_137 -> V_226 + V_65 ;
if ( F_51 ( V_3 ) ) {
switch ( V_3 -> V_5 ) {
case V_11 :
V_49 -> V_252 = F_116 ( 4 , 32 ) ;
break;
default:
V_49 -> V_252 = F_116 ( 4 , 16 ) ;
break;
}
V_3 -> V_93 = V_103 | V_253 ;
V_3 -> V_166 = 0 ;
V_3 -> V_94 = V_67 ;
V_3 -> V_104 = V_254 | V_105 | V_67 ;
} else {
V_49 -> V_252 = F_116 ( 4 , 32 ) ;
V_3 -> V_93 = V_103 | V_253 | V_117 ;
V_3 -> V_166 = V_255 ;
V_3 -> V_94 = V_67 | V_108 ;
V_3 -> V_104 = V_108 | V_254 | V_105 | V_67 ;
}
V_115 = F_117 ( V_137 -> V_113 , F_56 , V_256 , F_118 ( V_98 ) ,
V_3 ) ;
if ( V_115 < 0 ) {
