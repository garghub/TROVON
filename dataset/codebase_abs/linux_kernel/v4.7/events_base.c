...
int F_108 ( unsigned int V_24 , unsigned int V_13 , bool V_113 )
{
struct V_114 V_115 ;
int V_5 , V_6 , V_14 ;
F_93 ( & V_67 ) ;
...
static void F_109 ( unsigned int V_6 )
{
F_93 ( & V_67 ) ;
F_91 ( V_6 ) ;
F_96 ( & V_67 ) ;
}
int F_110 ( unsigned int V_5 ,
T_4 V_118 ,
unsigned long V_119 ,
...
if ( V_6 < 0 )
return V_6 ;
V_122 = F_111 ( V_6 , V_118 , V_119 , V_120 , V_121 ) ;
if ( V_122 != 0 ) {
F_109 ( V_6 ) ;
return V_122 ;
}
...
int F_113 ( unsigned int V_24 , unsigned int V_13 ,
T_4 V_118 ,
unsigned long V_119 , const char * V_120 , void * V_121 )
{
int V_6 , V_122 ;
V_6 = F_108 ( V_24 , V_13 , V_119 & V_123 ) ;
if ( V_6 < 0 )
return V_6 ;
V_122 = F_111 ( V_6 , V_118 , V_119 , V_120 , V_121 ) ;
if ( V_122 != 0 ) {
...
void F_115 ( unsigned int V_6 , void * V_121 )
{
struct V_10 * V_11 = F_10 ( V_6 ) ;
if ( F_61 ( ! V_11 ) )
return;
...
int F_117 ( unsigned V_6 , unsigned V_127 )
{
struct V_128 V_129 ;
V_129 . V_41 = F_21 ( V_6 ) ;
V_129 . V_127 = V_127 ;
...
void F_121 ( unsigned int V_13 , enum V_19 V_69 )
{
int V_6 ;
#ifdef F_122
if ( F_22 ( V_69 == V_132 ) ) {
int V_53 = F_123 ( V_133 , V_13 , NULL ) ;
if ( V_53 < 0 )
F_124 ( V_134 L_12 , V_13 , V_53 ) ;
return;
}
#endif
...
{
struct V_135 * V_135 = F_126 ( V_136 ) ;
int V_13 = F_127 () ;
unsigned V_137 ;
do {
V_135 -> V_138 = 0 ;
...
void F_133 ( struct V_140 * V_141 )
{
struct V_140 * V_142 = F_134 ( V_141 ) ;
F_135 () ;
#ifdef F_122
F_136 () ;
F_137 ( V_143 ) ;
...
F_124 ( V_157 L_14 , V_6 , V_153 . V_27 ) ;
F_81 ( V_6 ) ;
}
}
