...
V_17 -> V_44 = V_45 ;
V_25 = V_12 -> V_46 ;
for ( V_11 = V_12 ; V_11 ; V_11 = V_11 -> V_47 ) {
F_8 ( V_25 == V_11 -> V_46 ) ;
...
F_73 ( & V_144 ) ;
if ( F_74 ( ( void V_147 * ) V_139 , & V_144 , sizeof( V_144 ) ) )
V_79 = - V_148 ;
break;
}
default:
...
static enum V_149 F_75 ( struct V_19 * V_103 , struct V_3 * V_3 ,
unsigned int V_138 , unsigned long V_139 ,
...
V_2 = V_157 ;
V_152 = F_76 ( V_161 , V_2 -> V_102 ) ;
if ( F_77 ( ( long ) F_78 ( V_152 ) , ( long V_147 * ) V_139 ) ) {
V_79 = - V_148 ;
goto V_96;
}
V_105 = F_79 ( V_152 , V_3 -> V_117 , NULL ) ;
if ( F_40 ( V_105 ) ) {
V_79 = F_41 ( V_105 ) ;
goto V_96;
}
...
F_27 ( V_168 , L_10 ,
V_161 , V_159 ) ;
V_153 = F_86 ( F_75 , 2 , V_165 ) ;
if ( ! V_153 )
goto V_169;
V_160 = F_87 ( V_159 , sizeof( * V_160 ) , V_170 ) ;
if ( ! V_160 )
goto V_169;
V_127 = F_87 ( V_159 , sizeof( * V_127 ) , V_170 ) ;
if ( ! V_127 )
goto V_171;
...
struct V_136 * V_137 = V_127 [ V_158 ] ;
V_2 -> V_126 = F_90 ( V_170 ) ;
if ( ! V_2 -> V_126 )
goto V_173;
F_89 ( & V_2 -> V_135 ) ;
F_91 ( & V_2 -> V_100 , 0 ) ;
...
V_137 -> V_175 = V_158 ;
V_137 -> V_176 = & V_177 ;
sprintf ( V_137 -> V_178 , L_6 , V_158 ) ;
V_137 -> V_134 = V_2 ;
V_137 -> V_179 = V_2 -> V_126 ;
}
for ( V_158 = 0 ; V_158 < V_159 ; V_158 ++ )
F_94 ( V_127 [ V_158 ] ) ;
return 0 ;
