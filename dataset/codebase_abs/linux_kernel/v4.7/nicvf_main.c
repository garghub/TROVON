...
{
union V_23 V_24 = {} ;
V_24 . V_321 . V_25 = V_322 ;
V_24 . V_321 . V_34 = V_2 -> V_34 ;
V_24 . V_321 . V_105 = ( V_143 & V_323 ) != 0 ;
return F_10 ( V_2 , & V_24 ) ;
}
...
{
struct V_1 * V_2 = F_46 ( V_33 ) ;
T_8 V_324 = V_143 ^ V_33 -> V_143 ;
if ( V_324 & V_325 )
F_157 ( V_2 , V_143 ) ;
if ( ( V_324 & V_323 ) && F_143 ( V_33 ) )
return F_154 ( V_2 , V_143 ) ;
return 0 ;
}
static int F_158 ( struct V_326 * V_224 , const struct V_327 * V_328 )
{
struct V_329 * V_200 = & V_224 -> V_200 ;
struct V_80 * V_33 ;
struct V_1 * V_2 ;
int V_119 , V_330 ;
V_119 = F_159 ( V_224 ) ;
...
V_119 = F_161 ( V_224 , V_331 ) ;
if ( V_119 ) {
F_160 ( V_200 , L_32 , V_119 ) ;
goto V_332;
}
V_119 = F_162 ( V_224 , F_163 ( 48 ) ) ;
if ( V_119 ) {
F_160 ( V_200 , L_33 ) ;
goto V_333;
}
V_119 = F_164 ( V_224 , F_163 ( 48 ) ) ;
if ( V_119 ) {
F_160 ( V_200 , L_34 ) ;
goto V_333;
}
V_330 = V_6 ;
if ( V_224 -> V_334 ) {
V_330 = F_165 ( F_166 () , V_6 ) ;
V_330 = F_28 ( V_330 ,
( V_335 + 1 ) * V_6 ) ;
}
V_33 = F_167 ( sizeof( struct V_1 ) , V_330 , V_330 ) ;
if ( ! V_33 ) {
V_119 = - V_246 ;
goto V_333;
}
F_168 ( V_224 , V_33 ) ;
F_169 ( V_33 , & V_224 -> V_200 ) ;
V_2 = F_46 ( V_33 ) ;
V_2 -> V_33 = V_33 ;
V_2 -> V_224 = V_224 ;
V_2 -> V_78 = V_2 ;
V_2 -> V_336 = V_330 ;
V_2 -> V_20 = F_170 ( V_224 , V_337 , 0 ) ;
if ( ! V_2 -> V_20 ) {
F_160 ( V_200 , L_35 ) ;
V_119 = - V_246 ;
goto V_338;
...
if ( V_119 )
goto V_339;
V_33 -> V_160 = ( V_161 | V_340 | V_341 |
V_342 | V_171 |
V_325 ) ;
V_33 -> V_160 |= V_144 ;
V_33 -> V_143 |= V_33 -> V_160 ;
V_33 -> V_160 |= V_323 ;
V_33 -> V_343 = V_341 | V_340 | V_342 ;
V_33 -> V_344 = & V_345 ;
V_33 -> V_346 = V_347 ;
F_173 ( & V_2 -> V_318 , F_152 ) ;
V_119 = F_174 ( V_33 ) ;
if ( V_119 ) {
F_160 ( V_200 , L_36 ) ;
goto V_339;
...
static void F_179 ( struct V_326 * V_224 )
{
struct V_80 * V_33 = F_180 ( V_224 ) ;
struct V_1 * V_2 ;
struct V_80 * V_350 ;
if ( ! V_33 )
return;
...
static void F_182 ( struct V_326 * V_224 )
{
F_179 ( V_224 ) ;
}
static int T_9 F_183 ( void )
{
F_184 ( L_37 , V_331 , V_353 ) ;
return F_185 ( & V_354 ) ;
}
