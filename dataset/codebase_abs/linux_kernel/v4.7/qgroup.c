...
F_87 ( & V_8 -> V_102 ) ;
V_3 = V_8 -> V_155 ;
V_46 = F_123 ( V_8 , V_137 , V_108 , V_142 , V_3 ,
V_156 ) ;
if ( V_46 < 0 )
goto V_52;
V_46 = F_123 ( V_8 , V_151 , V_108 , V_142 , V_3 ,
V_157 ) ;
if ( V_46 < 0 )
goto V_52;
F_125 ( V_8 , V_142 , V_147 , V_148 ,
V_110 , V_3 ) ;
V_8 -> V_155 += F_130 ( V_147 , V_148 ) + 1 ;
V_52:
F_88 ( & V_8 -> V_102 ) ;
V_153:
F_52 ( V_108 ) ;
...
if ( V_163 ) {
V_165 = ( T_1 * ) ( V_163 + 1 ) ;
for ( V_164 = 0 ; V_164 < V_163 -> V_170 ; ++ V_164 , ++ V_165 ) {
if ( * V_165 == 0 )
continue;
V_46 = F_55 ( V_82 , V_40 ,
V_54 , * V_165 ) ;
...
for ( V_164 = 0 ; V_164 < V_163 -> V_171 ; ++ V_164 , V_165 += 2 ) {
struct V_1 * V_83 ;
struct V_1 * V_84 ;
if ( ! V_165 [ 0 ] || ! V_165 [ 1 ] )
continue;
...
for ( V_164 = 0 ; V_164 < V_163 -> V_172 ; ++ V_164 , V_165 += 2 ) {
struct V_1 * V_83 ;
struct V_1 * V_84 ;
if ( ! V_165 [ 0 ] || ! V_165 [ 1 ] )
continue;
...
static int F_141 ( struct V_39 * V_90 , T_1 V_110 )
{
struct V_39 * V_40 ;
struct V_1 * V_13 ;
...
static inline void F_144 ( struct V_39 * V_90 , T_1 V_110 )
{
return F_143 ( V_90 -> V_8 , V_90 -> V_54 ,
V_110 ) ;
}
void F_145 ( struct V_81 * V_82 )
{
...
static int
F_147 ( struct V_7 * V_8 , struct V_41 * V_42 ,
struct V_81 * V_82 )
{
struct V_36 V_185 ;
struct V_43 * V_186 = NULL ;
struct V_107 * V_141 = NULL ;
struct V_187 V_188 = F_148 ( V_188 ) ;
T_1 V_110 ;
int V_45 ;
int V_46 ;
F_84 ( & V_8 -> V_154 ) ;
...
{
struct V_7 * V_8 = F_158 ( V_194 , struct V_7 ,
V_161 ) ;
struct V_41 * V_42 ;
...
goto V_52;
V_119 = 0 ;
while ( ! V_119 && ! F_159 ( V_8 ) ) {
V_82 = F_160 ( V_8 -> V_195 , 0 ) ;
if ( F_36 ( V_82 ) ) {
V_119 = F_37 ( V_82 ) ;
break;
}
...
V_119 = F_147 ( V_8 , V_42 , V_82 ) ;
}
if ( V_119 > 0 )
F_161 ( V_82 , V_8 -> V_195 ) ;
else
F_162 ( V_82 , V_8 -> V_195 ) ;
}
V_52:
F_51 ( V_42 ) ;
F_84 ( & V_8 -> V_154 ) ;
...
if ( V_46 )
return V_46 ;
V_82 = F_167 ( V_8 -> V_195 ) ;
if ( F_36 ( V_82 ) ) {
V_8 -> V_53 &= ~ V_80 ;
return F_37 ( V_82 ) ;
}
V_46 = F_161 ( V_82 , V_8 -> V_195 ) ;
if ( V_46 ) {
V_8 -> V_53 &= ~ V_80 ;
return V_46 ;
}
...
int F_170 ( struct V_204 * V_204 , T_1 V_205 , T_1 V_206 )
{
struct V_39 * V_90 = F_171 ( V_204 ) -> V_90 ;
struct V_207 V_208 ;
struct V_113 * V_114 ;
struct V_115 V_116 ;
int V_46 ;
if ( ! V_90 -> V_8 -> V_49 || ! F_142 ( V_90 -> V_54 ) ||
V_206 == 0 )
return 0 ;
V_208 . V_209 = 0 ;
V_208 . V_210 = F_26 ( V_51 ) ;
V_46 = F_172 ( & F_171 ( V_204 ) -> V_211 , V_205 ,
V_205 + V_206 - 1 , V_212 , & V_208 ) ;
F_173 ( V_204 , V_205 , V_206 ,
V_208 . V_209 ,
V_213 ) ;
if ( V_46 < 0 )
goto V_158;
V_46 = F_141 ( V_90 , V_208 . V_209 ) ;
if ( V_46 < 0 )
goto V_158;
F_52 ( V_208 . V_210 ) ;
return V_46 ;
...
F_174 ( & F_171 ( V_204 ) -> V_211 , V_114 -> V_146 ,
V_114 -> V_118 , V_212 , 0 , 0 , NULL ,
V_51 ) ;
F_52 ( V_208 . V_210 ) ;
return V_46 ;
}
static int F_175 ( struct V_204 * V_204 , T_1 V_205 , T_1 V_206 ,
int free )
{
struct V_207 V_208 ;
int V_214 = V_215 ;
...
if ( ! V_208 . V_210 )
return - V_20 ;
V_46 = F_176 ( & F_171 ( V_204 ) -> V_211 , V_205 ,
V_205 + V_206 - 1 , V_212 , & V_208 ) ;
if ( V_46 < 0 )
goto V_52;
if ( free ) {
F_144 ( F_171 ( V_204 ) -> V_90 , V_208 . V_209 ) ;
V_214 = V_216 ;
}
F_177 ( V_204 , V_205 , V_206 ,
V_208 . V_209 , V_214 ) ;
V_52:
F_52 ( V_208 . V_210 ) ;
return V_46 ;
}
int F_178 ( struct V_204 * V_204 , T_1 V_205 , T_1 V_206 )
{
return F_175 ( V_204 , V_205 , V_206 , 1 ) ;
}
int F_179 ( struct V_204 * V_204 , T_1 V_205 , T_1 V_206 )
{
return F_175 ( V_204 , V_205 , V_206 , 0 ) ;
}
int F_180 ( struct V_39 * V_90 , int V_110 )
{
int V_46 ;
if ( ! V_90 -> V_8 -> V_49 || ! F_142 ( V_90 -> V_54 ) ||
V_110 == 0 )
return 0 ;
F_128 ( V_110 != F_181 ( V_110 , V_90 -> V_176 ) ) ;
V_46 = F_141 ( V_90 , V_110 ) ;
if ( V_46 < 0 )
return V_46 ;
F_182 ( V_110 , & V_90 -> V_217 ) ;
return V_46 ;
}
void F_183 ( struct V_39 * V_90 )
{
int V_117 ;
if ( ! V_90 -> V_8 -> V_49 || ! F_142 ( V_90 -> V_54 ) )
return;
V_117 = F_184 ( & V_90 -> V_217 , 0 ) ;
if ( V_117 == 0 )
return;
F_144 ( V_90 , V_117 ) ;
}
void F_185 ( struct V_39 * V_90 , int V_110 )
{
if ( ! V_90 -> V_8 -> V_49 || ! F_142 ( V_90 -> V_54 ) )
return;
F_128 ( V_110 != F_181 ( V_110 , V_90 -> V_176 ) ) ;
F_101 ( F_186 ( & V_90 -> V_217 ) < V_110 ) ;
F_187 ( V_110 , & V_90 -> V_217 ) ;
F_144 ( V_90 , V_110 ) ;
}
void F_188 ( struct V_204 * V_204 )
{
struct V_207 V_208 ;
struct V_113 * V_114 ;
struct V_115 V_218 ;
...
return;
V_46 = F_176 ( & F_171 ( V_204 ) -> V_211 , 0 , ( T_1 ) - 1 ,
V_212 , & V_208 ) ;
F_101 ( V_46 < 0 ) ;
if ( F_101 ( V_208 . V_209 ) ) {
F_104 ( & V_218 ) ;
while ( ( V_114 = F_105 ( V_208 . V_210 , & V_218 ) ) ) {
F_49 ( F_171 ( V_204 ) -> V_90 -> V_8 ,
L_19 ,
