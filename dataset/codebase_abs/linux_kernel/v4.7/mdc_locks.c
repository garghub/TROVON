...
F_81 ( V_69 -> V_100 . V_101 . V_211 , V_2 ) ;
if ( V_40 < 0 ) {
F_85 ( ( V_40 == - V_215 || V_40 == - V_216 ) ? V_217 : V_57 ,
L_10 ,
V_69 -> V_218 , V_40 ) ;
F_28 ( V_53 , V_40 ) ;
F_82 ( V_53 ) ;
...
F_86 ( V_147 -> V_159 ) ;
if ( V_2 -> V_88 & V_89 &&
( int ) V_147 -> V_159 == - V_219 ) {
F_28 ( V_53 , V_40 ) ;
F_82 ( V_53 ) ;
V_191 ++ ;
F_87 ( V_220 , L_11 V_221 L_12 V_221 L_13 ,
V_69 -> V_218 , V_191 , V_2 -> V_88 ,
...
if ( V_40 )
return V_40 ;
V_58 = F_62 ( & V_223 -> V_95 , & V_169 ) ;
F_9 ( V_58 ) ;
if ( F_36 ( & V_65 -> V_77 ) &&
V_2 -> V_74 & V_227 &&
V_2 -> V_88 != V_168 ) {
if ( ( ! F_91 ( & V_65 -> V_77 , & V_58 -> V_228 ) ) &&
( ! F_91 ( & V_65 -> V_229 , & V_58 -> V_228 ) ) ) {
F_87 ( V_230 , L_15 V_221 L_16 V_221 L_17 V_221
L_13 , F_88 ( & V_65 -> V_77 ) ,
F_88 ( & V_65 -> V_77 ) , F_88 ( & V_58 -> V_228 ) ) ;
return - V_231 ;
}
}
V_40 = F_4 ( V_11 , V_2 ) ;
...
T_2 V_36 = V_18 -> V_29 ;
F_70 ( V_18 , L_18 ) ;
F_11 ( F_94 ( & V_58 -> V_228 ,
& V_18 -> V_22 -> V_236 ) ,
L_19 V_237 L_20 V_221 L_13 ,
F_95 ( V_18 -> V_22 ) , F_88 ( & V_58 -> V_228 ) ) ;
F_13 ( V_18 ) ;
memcpy ( & V_224 , V_14 , sizeof( * V_14 ) ) ;
if ( F_17 ( NULL , V_238 , NULL ,
V_195 , & V_36 , V_214 ,
& V_224 , 0 ) ) {
F_96 ( V_14 ,
V_2 -> V_4 . V_5 . V_160 ) ;
memcpy ( V_14 , & V_224 , sizeof( V_224 ) ) ;
...
int V_40 = 0 ;
F_9 ( V_2 ) ;
F_87 ( V_247 , L_22 V_221 L_23 V_221
L_24 , V_65 -> V_98 ,
