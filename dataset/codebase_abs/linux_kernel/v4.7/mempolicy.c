...
struct V_57 * V_58 , unsigned long V_186 )
{
unsigned V_187 = F_6 ( V_4 -> V_18 . V_16 ) ;
unsigned V_188 ;
int V_189 ;
int V_72 ;
if ( ! V_187 )
return F_2 () ;
V_188 = ( unsigned int ) V_186 % V_187 ;
...
struct V_57 * V_58 , unsigned long V_64 , int V_190 )
{
if ( V_58 ) {
unsigned long V_191 ;
F_129 ( V_190 < V_119 ) ;
V_191 = V_58 -> V_108 >> ( V_190 - V_119 ) ;
V_191 += ( V_64 - V_58 -> V_91 ) >> V_190 ;
return F_162 ( V_4 , V_58 , V_191 ) ;
} else
return F_156 ( V_4 ) ;
}
...
V_195 = F_155 ( F_164 ( * V_193 , V_58 , V_64 ,
F_166 ( F_67 ( V_58 ) ) ) , V_192 ) ;
} else {
...
static struct V_68 * F_170 ( T_7 V_178 , unsigned V_196 ,
unsigned V_72 )
{
struct V_179 * V_195 ;
struct V_68 * V_68 ;
V_195 = F_155 ( V_72 , V_178 ) ;
V_68 = F_171 ( V_178 , V_196 , V_195 ) ;
if ( V_68 && F_172 ( V_68 ) == F_173 ( & V_195 -> V_197 [ 0 ] ) )
F_110 ( V_68 , V_198 ) ;
return V_68 ;
}
struct V_68 *
F_174 ( T_7 V_178 , int V_196 , struct V_57 * V_58 ,
...
if ( V_4 -> V_8 == V_126 ) {
unsigned V_72 ;
V_72 = F_164 ( V_4 , V_58 , V_64 , V_119 + V_196 ) ;
F_107 ( V_4 ) ;
V_68 = F_170 ( V_178 , V_196 , V_72 ) ;
goto V_124;
}
if ( F_151 ( F_176 ( V_202 ) && V_199 ) ) {
int V_203 = V_5 ;
if ( V_4 -> V_8 == V_27 &&
! ( V_4 -> V_10 & V_19 ) )
V_203 = V_4 -> V_18 . V_20 ;
...
F_107 ( V_4 ) ;
V_68 = F_177 ( V_178 , V_196 , V_195 , V_77 ) ;
V_124:
if ( F_151 ( ! V_68 && F_178 ( V_200 ) ) )
goto V_201;
return V_68 ;
}
struct V_68 * F_179 ( T_7 V_178 , unsigned V_196 )
{
struct V_1 * V_4 = & V_9 ;
struct V_68 * V_68 ;
unsigned int V_200 ;
...
V_200 = F_175 () ;
if ( V_4 -> V_8 == V_126 )
V_68 = F_170 ( V_178 , V_196 , F_156 ( V_4 ) ) ;
else
V_68 = F_177 ( V_178 , V_196 ,
F_154 ( V_178 , V_4 , F_2 () ) ,
F_150 ( V_178 , V_4 ) ) ;
if ( F_151 ( ! V_68 && F_178 ( V_200 ) ) )
goto V_201;
...
int F_180 ( struct V_57 * V_204 , struct V_57 * V_205 )
{
...
struct V_1 * F_181 ( struct V_1 * V_107 )
{
...
bool F_183 ( struct V_1 * V_207 , struct V_1 * V_208 )
{
if ( ! V_207 || ! V_208 )
return false ;
...
static struct V_209 *
F_184 ( struct V_210 * V_211 , unsigned long V_88 , unsigned long V_65 )
{
struct V_212 * V_186 = V_211 -> V_213 . V_212 ;
while ( V_186 ) {
struct V_209 * V_3 = F_185 ( V_186 , struct V_209 , V_180 ) ;
if ( V_88 >= V_3 -> V_65 )
V_186 = V_186 -> V_214 ;
...
struct V_212 * V_94 = F_186 ( V_186 ) ;
if ( ! V_94 )
break;
V_30 = F_185 ( V_94 , struct V_209 , V_180 ) ;
if ( V_30 -> V_65 <= V_88 )
break;
V_186 = V_94 ;
}
return F_185 ( V_186 , struct V_209 , V_180 ) ;
}
static void F_187 ( struct V_210 * V_211 , struct V_209 * V_54 )
{
struct V_212 * * V_3 = & V_211 -> V_213 . V_212 ;
struct V_212 * V_216 = NULL ;
struct V_209 * V_180 ;
while ( * V_3 ) {
V_216 = * V_3 ;
V_180 = F_185 ( V_216 , struct V_209 , V_180 ) ;
...
F_188 ( & V_54 -> V_180 , V_216 , V_3 ) ;
F_189 ( & V_54 -> V_180 , & V_211 -> V_213 ) ;
F_18 ( L_4 , V_54 -> V_88 , V_54 -> V_65 ,
V_54 -> V_34 ? V_54 -> V_34 -> V_8 : 0 ) ;
}
struct V_1 *
F_190 ( struct V_210 * V_211 , unsigned long V_217 )
{
struct V_1 * V_4 = NULL ;
struct V_209 * V_218 ;
if ( ! V_211 -> V_213 . V_212 )
return NULL ;
F_191 ( & V_211 -> V_219 ) ;
V_218 = F_184 ( V_211 , V_217 , V_217 + 1 ) ;
if ( V_218 ) {
F_145 ( V_218 -> V_34 ) ;
V_4 = V_218 -> V_34 ;
}
...
static void F_193 ( struct V_209 * V_186 )
{
F_84 ( V_186 -> V_34 ) ;
F_25 ( V_220 , V_186 ) ;
}
int F_194 ( struct V_68 * V_68 , struct V_57 * V_58 , unsigned long V_64 )
{
struct V_1 * V_4 ;
struct V_182 * V_183 ;
int V_221 = F_58 ( V_68 ) ;
...
if ( V_4 -> V_10 & V_226 ) {
V_224 = V_223 ;
if ( ! F_197 ( V_47 , V_68 , V_221 , V_222 ) )
goto V_124;
}
if ( V_221 != V_224 )
V_12 = V_224 ;
...
static void F_198 ( struct V_210 * V_211 , struct V_209 * V_186 )
{
F_18 ( L_5 , V_186 -> V_88 , V_186 -> V_65 ) ;
F_199 ( & V_186 -> V_180 , & V_211 -> V_213 ) ;
F_193 ( V_186 ) ;
}
static void F_200 ( struct V_209 * V_5 , unsigned long V_88 ,
...
static struct V_209 * F_201 ( unsigned long V_88 , unsigned long V_65 ,
struct V_1 * V_4 )
{
struct V_209 * V_186 ;
struct V_1 * V_227 ;
V_186 = F_21 ( V_220 , V_39 ) ;
if ( ! V_186 )
return NULL ;
V_227 = F_81 ( V_4 ) ;
if ( F_82 ( V_227 ) ) {
...
V_227 -> V_10 |= V_228 ;
F_200 ( V_186 , V_88 , V_65 , V_227 ) ;
return V_186 ;
}
static int F_202 ( struct V_210 * V_211 , unsigned long V_88 ,
unsigned long V_65 , struct V_209 * V_54 )
{
struct V_209 * V_186 ;
struct V_209 * V_229 = NULL ;
struct V_1 * F_17 = NULL ;
int V_12 = 0 ;
V_230:
F_203 ( & V_211 -> V_219 ) ;
V_186 = F_184 ( V_211 , V_88 , V_65 ) ;
while ( V_186 && V_186 -> V_88 < V_65 ) {
struct V_212 * V_114 = F_204 ( & V_186 -> V_180 ) ;
if ( V_186 -> V_88 >= V_88 ) {
if ( V_186 -> V_65 <= V_65 )
F_198 ( V_211 , V_186 ) ;
else
...
* F_17 = * V_186 -> V_34 ;
F_22 ( & F_17 -> V_41 , 1 ) ;
F_200 ( V_229 , V_65 , V_186 -> V_65 , F_17 ) ;
V_186 -> V_65 = V_88 ;
F_187 ( V_211 , V_229 ) ;
V_229 = NULL ;
F_17 = NULL ;
...
if ( ! V_114 )
break;
V_186 = F_185 ( V_114 , struct V_209 , V_180 ) ;
}
if ( V_54 )
F_187 ( V_211 , V_54 ) ;
F_205 ( & V_211 -> V_219 ) ;
...
void F_206 ( struct V_210 * V_211 , struct V_1 * V_193 )
{
int V_12 ;
V_211 -> V_213 = V_232 ;
F_207 ( & V_211 -> V_219 ) ;
...
int F_208 ( struct V_210 * V_238 ,
struct V_57 * V_58 , struct V_1 * V_239 )
{
int V_106 ;
struct V_209 * V_54 = NULL ;
unsigned long V_240 = F_209 ( V_58 ) ;
F_18 ( L_6 ,
V_58 -> V_108 ,
...
if ( V_239 ) {
V_54 = F_201 ( V_58 -> V_108 , V_58 -> V_108 + V_240 , V_239 ) ;
if ( ! V_54 )
return - V_40 ;
}
V_106 = F_202 ( V_238 , V_58 -> V_108 , V_58 -> V_108 + V_240 , V_54 ) ;
if ( V_106 && V_54 )
F_193 ( V_54 ) ;
return V_106 ;
}
void F_210 ( struct V_210 * V_3 )
{
struct V_209 * V_186 ;
struct V_212 * V_114 ;
if ( ! V_3 -> V_213 . V_212 )
return;
F_203 ( & V_3 -> V_219 ) ;
V_114 = F_211 ( & V_3 -> V_213 ) ;
while ( V_114 ) {
V_186 = F_185 ( V_114 , struct V_209 , V_180 ) ;
V_114 = F_204 ( & V_186 -> V_180 ) ;
F_198 ( V_3 , V_186 ) ;
}
F_205 ( & V_3 -> V_219 ) ;
}
static void T_8 F_212 ( void )
{
bool V_241 = false ;
if ( F_176 ( V_242 ) )
V_241 = true ;
...
static int T_8 F_216 ( char * V_244 )
{
int V_12 = 0 ;
if ( ! V_244 )
goto V_124;
if ( ! strcmp ( V_244 , L_10 ) ) {
V_243 = 1 ;
V_12 = 1 ;
} else if ( ! strcmp ( V_244 , L_11 ) ) {
V_243 = - 1 ;
V_12 = 1 ;
}
V_124:
...
static inline void T_8 F_212 ( void )
{
}
void T_8 F_218 ( void )
{
...
F_99 ( F_156 ) ;
F_222 (nid, N_MEMORY) {
unsigned long V_248 = F_223 ( V_72 ) ;
if ( V_245 < V_248 ) {
V_245 = V_248 ;
V_246 = V_72 ;
}
...
int F_226 ( char * V_244 , struct V_1 * * V_193 )
{
...
void F_229 ( char * V_254 , int V_255 , struct V_1 * V_4 )
{
char * V_3 = V_254 ;
T_1 V_16 = V_256 ;
...
default:
F_134 ( 1 ) ;
snprintf ( V_3 , V_255 , L_18 ) ;
return;
}
V_3 += snprintf ( V_3 , V_255 , L_19 , V_252 [ V_8 ] ) ;
if ( V_10 & V_11 ) {
V_3 += snprintf ( V_3 , V_254 + V_255 - V_3 , L_20 ) ;
if ( V_10 & V_36 )
V_3 += snprintf ( V_3 , V_254 + V_255 - V_3 , L_16 ) ;
else if ( V_10 & V_28 )
V_3 += snprintf ( V_3 , V_254 + V_255 - V_3 , L_17 ) ;
}
if ( ! F_9 ( V_16 ) )
V_3 += F_230 ( V_3 , V_254 + V_255 - V_3 , L_21 ,
F_231 ( & V_16 ) ) ;
}
