...
V_113 = F_100 ( & V_228 -> V_30 , L_37 ) ;
if ( F_101 ( V_113 ) )
return F_102 ( V_113 ) ;
V_2 = F_103 ( & V_228 -> V_30 , sizeof( * V_2 ) + F_104 ( V_230 ) ,
V_233 ) ;
if ( ! V_2 )
return - V_183 ;
V_2 -> V_113 = V_113 ;
V_2 -> V_214 = V_228 -> V_30 . V_234 ;
if ( V_2 -> V_214 ) {
V_2 -> V_108 = V_2 -> V_214 -> V_97 ;
V_2 -> V_118 = V_2 -> V_214 -> V_235 * 1000 ;
}
switch ( V_2 -> V_118 ) {
case 6000000 :
case 8000000 :
...
V_2 -> V_118 = 0 ;
case 0 :
F_105 ( & V_228 -> V_30 , L_41 ) ;
}
F_91 ( & V_2 -> V_67 ) ;
F_106 ( & V_2 -> V_98 ) ;
V_230 = F_107 ( V_228 , V_236 , 0 ) ;
V_6 = F_108 ( & V_228 -> V_30 , V_230 ) ;
if ( F_101 ( V_6 ) )
return F_102 ( V_6 ) ;
V_2 -> V_99 = V_99 ;
V_2 -> V_6 = V_6 ;
F_60 ( V_2 , true ) ;
V_231 = F_109 ( V_237 , V_238 ,
F_53 , ( void * ) V_2 , & V_2 -> V_52 ) ;
if ( V_231 < 0 ) {
F_81 ( & V_228 -> V_30 , L_42 ) ;
return - V_239 ;
}
F_8 ( & V_228 -> V_30 , L_43 , V_2 -> V_52 ) ;
F_110 ( V_2 -> V_52 , V_240 ,
V_241 , V_230 -> V_242 + V_243 ,
0 , 0 ) ;
F_111 ( V_2 -> V_52 , V_244 ) ;
F_112 ( V_2 -> V_52 , V_2 -> V_52 ) ;
V_231 = F_113 ( & V_228 -> V_30 , V_2 -> V_99 , F_56 , 0 , V_238 ,
V_2 ) ;
if ( V_231 ) {
F_81 ( & V_228 -> V_30 , L_44 ) ;
goto V_245;
}
V_2 -> V_90 . V_246 = V_238 ;
V_2 -> V_90 . V_247 = & V_248 ;
V_2 -> V_90 . V_18 = V_2 ;
V_2 -> V_90 . V_249 . V_30 = & V_228 -> V_30 ;
V_2 -> V_90 . V_250 = V_228 -> V_251 ;
V_231 = F_114 ( & V_2 -> V_90 ) ;
if ( V_231 )
return V_231 ;
F_105 ( & V_228 -> V_30 , L_45 ) ;
return 0 ;
V_245:
F_115 ( V_2 -> V_52 ) ;
exit:
