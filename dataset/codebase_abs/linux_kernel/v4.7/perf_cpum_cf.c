...
int V_20 ;
do {
V_60 = F_39 ( & V_6 -> V_47 . V_62 ) ;
V_20 = F_40 ( V_6 -> V_47 . V_15 , & V_61 ) ;
if ( V_20 ) {
if ( V_20 != 3 )
break;
V_61 = 0 ;
}
} while ( F_41 ( & V_6 -> V_47 . V_62 , V_60 , V_61 ) != V_60 );
return V_20 ;
}
...
static void F_51 ( struct V_27 * V_27 , unsigned int V_70 )
{
struct V_18 * V_19 = F_12 ( & V_18 ) ;
F_46 ( V_19 -> V_70 ) ;
V_19 -> V_70 = V_70 ;
