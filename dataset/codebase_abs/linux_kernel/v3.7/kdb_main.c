...
static int F_88 ( int V_25 , const char * V_26 [] )
{
if ( F_89 ( & V_223 ) )
return 0 ;
F_90 ( & V_223 , 1 ) ;
...
static int F_91 ( const char * V_20 , const struct V_226 * V_227 )
{
if ( ! F_92 ( & V_223 , - 1 , 0 ) )
return - V_228 ;
V_224 . V_225 ( 1 ) ;
...
{
int V_10 , V_229 , V_230 = 1 ;
char V_206 , V_231 = '?' ;
F_16 ( L_124 , F_50 () ) ;
F_16 ( L_125 ) ;
for ( V_229 = - 1 , V_10 = 0 ; V_10 < V_232 ; V_10 ++ ) {
if ( ! F_94 ( V_10 ) ) {
V_206 = 'F' ;
} else {
V_206 = ' ' ;
...
static int F_96 ( int V_25 , const char * * V_26 )
{
unsigned long V_233 ;
int V_21 ;
if ( V_25 == 0 ) {
...
if ( V_25 != 1 )
return V_29 ;
V_21 = F_12 ( V_26 [ 1 ] , & V_233 ) ;
if ( V_21 )
return V_21 ;
if ( ( V_233 > V_232 ) || ! F_94 ( V_233 ) )
return V_191 ;
V_234 = V_233 ;
return V_145 ;
}
...
{
int V_235 = 0 , V_236 = 0 ;
unsigned long V_237 = F_98 ( L_130 ) ,
V_238 = F_98 ( L_131 ) ;
unsigned long V_2 ;
const struct V_1 * V_3 , * V_239 ;
F_99 (cpu) {
V_3 = F_1 ( V_2 ) ;
if ( F_100 ( V_3 , V_237 ) )
++ V_235 ;
...
void F_103 ( const struct V_1 * V_3 )
{
int V_2 ;
unsigned long V_240 ;
if ( ! V_3 || F_104 ( & V_240 , ( char * ) V_3 , sizeof( unsigned long ) ) )
return;
V_2 = F_48 ( V_3 ) ;
F_16 ( L_138 ,
( void * ) V_3 , V_3 -> V_122 , V_3 -> V_241 -> V_122 ,
F_46 ( V_3 ) , F_48 ( V_3 ) ,
F_95 ( V_3 ) ,
( void * ) ( & V_3 -> V_242 ) ,
V_3 == F_1 ( F_50 () ) ? '*' : ' ' ,
...
unsigned long V_244 , V_2 ;
if ( V_25 == 0 )
F_97 () ;
F_16 ( L_142 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_143 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_144 ) ;
V_244 = F_98 ( V_25 ? V_26 [ 1 ] : NULL ) ;
F_99 (cpu) {
if ( F_31 ( V_88 ) )
return 0 ;
V_3 = F_1 ( V_2 ) ;
...
if ( V_21 )
return V_24 ;
V_3 = F_107 ( ( V_245 ) V_20 , & V_246 ) ;
if ( ! V_3 ) {
F_16 ( L_146 , ( V_245 ) V_20 ) ;
return 0 ;
}
}
F_45 ( V_3 ) ;
...
static int F_108 ( int V_25 , const char * * V_26 )
{
int V_21 = 0 ;
unsigned long V_41 ;
long V_39 = 0 ;
...
if ( F_31 ( V_88 ) )
goto V_250;
sprintf ( V_221 , L_108 V_125 L_29 , V_61 , V_247 ) ;
V_21 = F_29 ( V_221 ) ;
if ( V_21 )
goto V_250;
V_41 = V_247 + V_248 ;
if ( F_63 ( & V_247 , V_41 , sizeof( V_247 ) ) )
goto V_250;
}
V_250:
F_26 ( V_61 ) ;
...
F_34 (kt, i) {
if ( V_251 -> V_92 )
F_16 ( L_149 , V_251 -> V_92 ,
V_251 -> V_252 , V_251 -> V_253 ) ;
if ( F_31 ( V_88 ) )
return 0 ;
}
return 0 ;
...
if ( V_25 )
return V_29 ;
F_16 ( L_158 , V_283 . V_40 . V_284 ) ;
F_16 ( L_159 , V_283 . V_40 . V_285 ) ;
F_16 ( L_160 , V_283 . V_40 . V_286 ) ;
F_16 ( L_161 , V_283 . V_40 . V_287 ) ;
F_16 ( L_162 , V_283 . V_40 . V_288 ) ;
F_16 ( L_163 , V_283 . V_40 . V_289 ) ;
F_16 ( L_164 , F_118 ( V_290 ) ) ;
V_282 = F_119 () ;
F_113 ( & V_282 , & V_267 ) ;
F_16 ( L_165
L_166 ,
...
V_20 . V_277 %= ( 24 * 60 * 60 ) ;
F_16 ( L_168 , V_293 , V_293 == 1 ? L_1 : L_169 ) ;
}
F_16 ( L_170 , V_20 . V_277 / ( 60 * 60 ) , ( V_20 . V_277 / 60 ) % 60 ) ;
...
char V_160 [ 64 ] ;
int V_2 , V_21 , V_38 = 1 ;
unsigned long V_41 , V_297 , V_20 , V_163 = 0 , V_298 = ~ 0UL ;
if ( V_25 < 1 || V_25 > 3 )
return V_29 ;
...
T_4 * V_227 ;
F_34 (kp, i) {
if ( V_227 -> V_92 && ( strcmp ( V_227 -> V_92 , V_103 ) == 0 ) ) {
F_16 ( L_190
L_191 , V_103 , V_300 , V_67 ) ;
return 1 ;
}
}
F_34 (kp, i) {
...
if ( V_305 ) {
memcpy ( V_302 , V_305 ,
( V_94 - V_303 ) * sizeof( * V_302 ) ) ;
F_26 ( V_305 ) ;
}
memset ( V_302 + V_94 , 0 ,
V_304 * sizeof( * V_302 ) ) ;
V_305 = V_302 ;
V_227 = V_305 + V_94 - V_303 ;
V_94 += V_304 ;
}
V_227 -> V_92 = V_103 ;
V_227 -> V_96 = V_300 ;
...
short V_301 )
{
return F_127 ( V_103 , V_300 , V_66 , V_67 , V_301 ,
V_99 ) ;
}
int F_128 ( char * V_103 )
{
int V_10 ;
T_4 * V_227 ;
F_34 (kp, i) {
...
F_34 (kp, i)
V_227 -> V_92 = NULL ;
F_127 ( L_74 , F_66 , L_194 ,
L_195 , 1 ,
V_100 ) ;
F_127 ( L_73 , F_66 , L_196 ,
L_197 , 0 , V_100 ) ;
F_127 ( L_76 , F_66 , L_198 ,
L_199 , 0 , V_100 ) ;
F_127 ( L_75 , F_66 , L_194 ,
L_200 , 0 , V_100 ) ;
F_127 ( L_201 , F_68 , L_202 ,
L_203 , 0 , V_100 ) ;
F_127 ( L_204 , F_70 , L_205 ,
L_206 , 1 , V_99 ) ;
F_127 ( L_207 , F_71 , L_1 ,
L_208 , 0 , V_99 ) ;
F_127 ( L_209 , F_73 , L_210 ,
L_211 , 0 , V_99 ) ;
F_127 ( L_212 , F_77 , L_194 ,
L_213 , 0 , V_99 ) ;
F_127 ( L_214 , V_307 , L_205 ,
L_215 , 1 , V_99 ) ;
F_127 ( L_216 , V_307 , L_217 ,
L_218 , 0 , V_99 ) ;
F_127 ( L_219 , V_307 , L_220 ,
L_221 , 0 , V_99 ) ;
F_127 ( L_222 , V_307 , L_1 ,
L_223 , 0 , V_99 ) ;
F_127 ( L_224 , V_307 , L_194 ,
L_225 , 0 ,
V_99 ) ;
F_127 ( L_226 , F_108 , L_227 ,
L_228 , 0 , V_99 ) ;
F_127 ( L_229 , F_82 , L_1 ,
L_230 , 0 , V_99 ) ;
F_127 ( L_113 , F_15 , L_1 ,
L_231 , 0 , V_99 ) ;
F_127 ( L_232 , F_110 , L_1 ,
L_233 , 1 , V_99 ) ;
F_127 ( L_234 , F_110 , L_1 ,
L_233 , 0 , V_99 ) ;
F_127 ( L_235 , F_96 , L_236 ,
L_237 , 0 , V_99 ) ;
F_127 ( L_238 , F_109 , L_1 ,
L_239 , 0 , V_99 ) ;
F_127 ( L_240 , F_105 , L_241 ,
L_242 , 0 , V_99 ) ;
F_127 ( L_243 , F_106 , L_244 ,
L_245 , 0 , V_99 ) ;
F_127 ( L_246 , F_40 , L_1 ,
L_247 , 0 , V_99 ) ;
#if F_52 ( V_308 )
F_127 ( L_248 , F_78 , L_1 ,
L_249 , 0 , V_99 ) ;
#endif
#if F_52 ( V_309 )
F_127 ( L_250 , F_75 , L_251 ,
L_252 , 0 , V_99 ) ;
#endif
#if F_52 ( V_310 )
F_127 ( L_253 , F_84 , L_254 ,
L_255 , 0 , V_99 ) ;
#endif
if ( V_224 . V_225 ) {
F_127 ( L_256 , F_88 , L_1 ,
L_257 , 0 , V_99 ) ;
}
F_127 ( L_258 , F_27 , L_259 ,
L_260 , 0 , V_99 ) ;
F_127 ( L_261 , F_111 , L_262 ,
L_263 , 0 , V_99 ) ;
F_127 ( L_264 , F_117 , L_1 ,
L_265 , 4 , V_99 ) ;
F_127 ( L_266 , F_123 , L_267 ,
L_268 , 3 , V_99 ) ;
F_127 ( L_269 , F_126 , L_1 ,
L_270 , 0 , V_99 ) ;
}
