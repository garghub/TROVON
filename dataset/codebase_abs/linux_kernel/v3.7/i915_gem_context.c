...
struct V_11 * V_12 ;
int V_6 , V_17 ;
V_12 = F_15 ( sizeof( struct V_21 ) , V_22 ) ;
if ( V_12 == NULL )
return F_16 ( - V_23 ) ;
...
if ( V_38 == NULL )
return - V_70 ;
V_55 = F_40 ( V_38 -> V_39 , V_69 ) ;
if ( V_55 == NULL )
return - V_71 ;
}
return F_27 ( V_55 ) ;
}
int F_55 ( struct V_1 * V_2 , void * V_36 ,
struct V_37 * V_38 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_72 * args = V_36 ;
struct V_21 * V_15 = V_38 -> V_39 ;
struct V_11 * V_12 ;
int V_6 ;
...
int F_57 ( struct V_1 * V_2 , void * V_36 ,
struct V_37 * V_38 )
{
struct V_78 * args = V_36 ;
struct V_21 * V_15 = V_38 -> V_39 ;
struct V_11 * V_12 ;
int V_6 ;
if ( ! ( V_2 -> V_73 -> V_74 & V_75 ) )
