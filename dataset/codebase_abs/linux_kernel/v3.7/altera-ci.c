...
int F_9 ( struct V_23 * V_24 , int V_25 ,
...
int F_15 ( struct V_23 * V_24 , int V_25 , T_1 V_18 )
{
...
int F_17 ( struct V_23 * V_24 , int V_25 )
{
struct V_27 * V_28 = V_24 -> V_29 ;
struct V_7 * V_17 = V_28 -> V_5 ;
...
int F_22 ( struct V_23 * V_24 , int V_25 )
{
return 0 ;
}
int F_23 ( struct V_23 * V_24 , int V_25 )
{
struct V_27 * V_28 = V_24 -> V_29 ;
struct V_7 * V_17 = V_28 -> V_5 ;
int V_44 ;
...
int F_28 ( struct V_23 * V_24 , int V_25 ,
int V_51 )
{
struct V_27 * V_28 = V_24 -> V_29 ;
if ( 0 != V_25 )
...
int F_36 ( struct V_66 * V_67 , int V_68 )
{
F_35 ( V_67 -> V_12 , V_68 , V_67 , 1 ) ;
return 0 ;
}
int F_37 ( struct V_66 * V_67 , int V_68 )
{
...
int F_39 ( struct V_66 * V_67 )
{
return F_37 ( V_67 , 1 ) ;
}
int F_40 ( struct V_66 * V_67 )
{
return F_36 ( V_67 , 2 ) ;
}
int F_41 ( struct V_66 * V_67 )
{
return F_37 ( V_67 , 2 ) ;
}
int F_42 ( struct V_69 * V_70 , int V_71 )
{
struct V_53 * V_11 = NULL ;
