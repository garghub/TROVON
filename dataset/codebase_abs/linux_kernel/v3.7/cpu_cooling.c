...
unsigned long * V_46 )
{
int V_14 = - V_32 , V_15 = 0 ;
struct V_23 * V_24 ;
struct V_28 * V_29 ;
unsigned int V_10 ;
struct V_18 * V_19 ;
F_4 ( & V_7 ) ;
F_21 (cpufreq_device, &cooling_cpufreq_list, node) {
if ( V_24 && V_24 -> V_47 == V_45 )
break;
}
if ( V_24 == NULL )
goto V_48;
...
{
struct V_44 * V_47 ;
struct V_23 * V_50 = NULL ;
unsigned int V_51 = 0 , V_52 = 0 , V_43 = 0 ;
char V_53 [ V_54 ] ;
int V_14 = 0 , V_15 ;
struct V_11 V_12 ;
F_21 (cpufreq_dev, &cooling_cpufreq_list, node)
V_51 ++ ;
F_15 (i, clip_cpus) {
if ( ! F_10 ( & V_12 , V_15 ) )
continue;
...
if ( V_51 == 0 )
F_28 ( & V_7 ) ;
V_14 = F_1 ( & V_57 , & V_50 -> V_2 ) ;
if ( V_14 ) {
F_29 ( V_50 ) ;
return F_25 ( - V_32 ) ;
}
sprintf ( V_53 , L_1 , V_50 -> V_2 ) ;
V_47 = F_30 ( V_53 , V_50 ,
& V_58 ) ;
if ( ! V_47 ) {
F_7 ( & V_57 , V_50 -> V_2 ) ;
