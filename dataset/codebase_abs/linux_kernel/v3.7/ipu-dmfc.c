...
int F_16 ( struct V_1 * V_2 , int V_41 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_1 V_42 ;
V_42 = F_10 ( V_4 -> V_26 + V_43 ) ;
if ( ( V_2 -> V_9 * 64 * 4 ) / V_41 > V_2 -> V_15 -> V_44 )
V_42 |= 1 << V_2 -> V_15 -> V_45 ;
else
V_42 &= ~ ( 1 << V_2 -> V_15 -> V_45 ) ;
F_11 ( V_42 , V_4 -> V_26 + V_43 ) ;
return 0 ;
}
struct V_1 * F_17 ( struct V_46 * V_7 , int V_16 )
{
struct V_3 * V_4 = V_7 -> V_47 ;
int V_34 ;
for ( V_34 = 0 ; V_34 < V_35 ; V_34 ++ )
if ( V_48 [ V_34 ] . V_16 == V_16 )
...
int F_20 ( struct V_46 * V_7 , struct V_50 * V_14 , unsigned long V_26 ,
struct V_51 * V_52 )
{
struct V_3 * V_4 ;
int V_34 ;
V_4 = F_21 ( V_14 , sizeof( * V_4 ) , V_53 ) ;
if ( ! V_4 )
return - V_54 ;
V_4 -> V_26 = F_22 ( V_14 , V_26 , V_55 ) ;
if ( ! V_4 -> V_26 )
return - V_54 ;
V_4 -> V_14 = V_14 ;
V_4 -> V_7 = V_7 ;
...
V_4 -> V_36 [ V_34 ] . V_15 = & V_48 [ V_34 ] ;
}
F_11 ( 0x0 , V_4 -> V_26 + V_56 ) ;
F_11 ( 0x0 , V_4 -> V_26 + V_57 ) ;
V_4 -> V_31 = F_24 ( V_52 ) / 8 ;
F_8 ( V_14 , L_4 ,
V_4 -> V_31 / 1000000 ) ;
F_11 ( 0x202020f6 , V_4 -> V_26 + V_58 ) ;
F_11 ( 0x2020f6f6 , V_4 -> V_26 + V_59 ) ;
F_11 ( 0x00000003 , V_4 -> V_26 + V_43 ) ;
return 0 ;
}
void F_25 ( struct V_46 * V_7 )
{
}
