...
static T_3 F_22 ( struct V_36 * V_53 , T_4 V_54 ,
unsigned short V_55 , char V_56 ,
T_2 V_57 , int V_58 , union V_59 * V_60 )
{
...
static T_5 F_24 ( struct V_36 * V_83 )
{
return V_84 | V_85 |
V_86 | V_87 |
V_88 ;
}
static int T_1 F_25 ( struct V_1 * V_13 ,
unsigned short V_40 ,
struct V_36 * * V_89 )
{
struct V_36 * V_53 ;
...
static int T_1 F_30 ( struct V_1 * V_13 ,
const struct V_3 * V_4 )
{
int V_90 ;
if ( ( V_13 -> V_7 == V_101 &&
...
if ( V_90 > 0 ) {
F_25 ( V_13 , V_90 , & V_106 ) ;
}
}
return 0 ;
}
static void T_6 F_31 ( struct V_36 * V_53 )
{
struct V_38 * V_39 = F_19 ( V_53 ) ;
if ( V_39 -> V_40 ) {
F_32 ( V_53 ) ;
...
static void T_6 F_33 ( struct V_1 * V_13 )
{
if ( V_105 ) {
F_31 ( V_105 ) ;
V_105 = NULL ;
