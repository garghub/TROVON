...
int F_67 ( struct V_63 * V_3 , const char * V_89 , T_6 V_20 )
{
F_35 ( & V_3 -> V_90 ) ;
F_4 ( & V_3 -> V_13 ) ;
F_36 ( & V_3 -> V_91 ) ;
...
return - V_75 ;
if ( V_20 != V_96 ) {
struct V_97 * V_97 = F_69 ( V_3 , V_20 ) ;
char V_98 [ 64 ] ;
if ( V_97 == NULL )
return - V_75 ;
snprintf ( V_98 , sizeof( V_98 ) , L_22 , V_20 ) ;
F_70 ( V_97 , V_98 ) ;
}
return 0 ;
}
static void F_71 ( struct V_17 * V_3 )
{
struct V_8 * V_65 , * V_66 ;
F_41 (pos, n, self, node) {
F_42 ( & V_65 -> V_67 ) ;
F_72 ( V_65 ) ;
}
}
void F_73 ( struct V_63 * V_3 )
{
F_43 ( & V_3 -> V_90 ) ;
F_71 ( & V_3 -> V_91 ) ;
F_71 ( & V_3 -> V_92 ) ;
...
void F_74 ( struct V_63 * V_3 )
{
F_73 ( V_3 ) ;
free ( V_3 ) ;
}
struct V_63 * F_75 ( struct V_30 * V_3 , T_6 V_20 ,
const char * V_89 )
{
struct V_13 * * V_85 = & V_3 -> V_13 ;
struct V_13 * V_78 = NULL ;
struct V_63 * V_65 , * V_63 = malloc ( sizeof( * V_63 ) ) ;
if ( ! V_63 )
return NULL ;
if ( F_67 ( V_63 , V_89 , V_20 ) != 0 ) {
free ( V_63 ) ;
return NULL ;
}
while ( * V_85 != NULL ) {
V_78 = * V_85 ;
V_65 = F_14 ( V_78 , struct V_63 , V_13 ) ;
if ( V_20 < V_65 -> V_20 )
V_85 = & ( * V_85 ) -> V_87 ;
else
V_85 = & ( * V_85 ) -> V_88 ;
}
F_63 ( & V_63 -> V_13 , V_78 , V_85 ) ;
F_64 ( & V_63 -> V_13 , V_3 ) ;
return V_63 ;
}
struct V_63 * F_76 ( struct V_30 * V_3 , T_6 V_20 )
{
struct V_13 * * V_85 = & V_3 -> V_13 ;
struct V_13 * V_78 = NULL ;
struct V_63 * V_63 ;
struct V_63 * V_99 = NULL ;
while ( * V_85 != NULL ) {
V_78 = * V_85 ;
V_63 = F_14 ( V_78 , struct V_63 , V_13 ) ;
if ( V_20 < V_63 -> V_20 )
V_85 = & ( * V_85 ) -> V_87 ;
else if ( V_20 > V_63 -> V_20 )
V_85 = & ( * V_85 ) -> V_88 ;
else
return V_63 ;
if ( ! V_63 -> V_20 )
...
struct V_63 * F_77 ( struct V_30 * V_3 , T_6 V_20 )
{
char V_100 [ V_22 ] ;
const char * V_89 = L_23 ;
struct V_63 * V_63 = F_76 ( V_3 , V_20 ) ;
if ( V_63 && ( V_63 -> V_20 == V_20 ) )
goto V_101;
if ( ( V_20 != V_96 ) &&
( V_20 != V_102 ) &&
( V_52 . V_103 ) ) {
sprintf ( V_100 , L_24 , V_52 . V_103 , V_20 ) ;
if ( F_78 ( V_100 , V_104 ) ) {
static struct V_105 * V_106 ;
if ( ! V_106 )
V_106 = F_79 ( true , NULL ) ;
if ( ! F_80 ( V_106 , V_100 ) ) {
F_81 ( L_25 , V_100 ) ;
F_82 ( V_106 , V_100 ) ;
}
...
V_63 = F_75 ( V_3 , V_20 , V_89 ) ;
V_101:
return V_63 ;
}
void F_83 ( struct V_30 * V_3 , T_7 V_107 , void * V_108 )
{
struct V_13 * V_32 ;
for ( V_32 = F_13 ( V_3 ) ; V_32 ; V_32 = F_38 ( V_32 ) ) {
struct V_63 * V_65 = F_14 ( V_32 , struct V_63 , V_13 ) ;
V_107 ( V_65 , V_108 ) ;
}
}
char * F_84 ( struct V_63 * V_3 , char * V_109 , T_4 V_110 )
{
if ( F_85 ( V_3 ) )
snprintf ( V_109 , V_110 , L_26 , L_27 ) ;
else if ( F_86 ( V_3 ) )
snprintf ( V_109 , V_110 , L_26 , L_28 ) ;
else
snprintf ( V_109 , V_110 , L_29 , L_28 , V_3 -> V_20 ) ;
return V_109 ;
}
void F_87 ( struct V_30 * V_111 , T_8 V_112 )
{
struct V_13 * V_67 ;
struct V_63 * V_63 ;
for ( V_67 = F_13 ( V_111 ) ; V_67 ; V_67 = F_38 ( V_67 ) ) {
V_63 = F_14 ( V_67 , struct V_63 , V_13 ) ;
V_63 -> V_112 = V_112 ;
}
return;
}
