...
switch ( V_55 ) {
case V_89 :
if ( V_10 -> V_73 . V_90 == 0 || V_56 == V_10 -> V_73 . V_90 )
V_51 = V_83 ;
break;
case V_91 :
#define F_22 1460
#define F_23 1448
if ( V_56 == V_10 -> V_73 . V_90 * V_58 ||
V_56 == V_10 -> V_73 . V_90 * F_22 ||
V_56 == V_10 -> V_73 . V_90 * F_23 )
V_51 = V_83 ;
break;
case V_92 :
if ( V_56 == V_10 -> V_73 . V_90 * ( V_58 + 40 ) ||
V_56 == V_10 -> V_73 . V_90 * ( F_22 + 40 ) ||
V_56 == V_10 -> V_73 . V_90 * ( F_23 + 40 ) )
V_51 = V_83 ;
break;
case V_93 :
if ( ( V_56 % V_10 -> V_73 . V_90 ) == 0 )
V_51 = V_83 ;
break;
}
}
...
V_53 ++ ;
if ( V_30 -> V_34 & V_68 )
F_24 ( V_46 -> V_94 , V_46 -> V_95 , V_4 ,
V_46 -> V_96 , V_46 -> V_97 , NULL ,
L_1 ,
V_10 -> V_69 , V_10 -> V_98 , V_10 -> V_99 ,
& V_33 -> V_43 , F_19 ( V_49 -> V_100 ) ,
& V_33 -> V_101 , F_19 ( V_49 -> V_102 ) ,
V_10 -> V_36 - V_33 -> V_36 ) ;
if ( ( V_30 -> V_34 & V_68 ) &&
V_30 -> V_103 == V_104 )
break;
...
F_24 ( V_46 -> V_94 , V_46 -> V_95 , V_4 , V_46 -> V_96 , V_46 -> V_97 , NULL ,
L_2 ,
& V_33 -> V_43 , F_19 ( V_49 -> V_100 ) ,
& V_33 -> V_101 , F_19 ( V_49 -> V_102 ) ) ;
if ( V_53 )
...
int V_14 = - V_16 ;
int V_105 ;
for ( V_105 = 0 ; V_105 < F_27 ( V_25 ) ; ++ V_105 )
F_28 ( & V_25 [ V_105 ] ) ;
V_14 = F_29 ( & V_106 ) ;
if ( V_14 < 0 ) {
F_30 ( L_3 , V_14 ) ;
