...
V_5 = F_31 ( V_217 -> V_231 , V_82 ) ;
if ( V_5 == NULL ) {
F_4 ( L_23 ) ;
goto V_228;
}
memcpy ( V_5 , V_217 -> V_232 , V_217 -> V_231 ) ;
memset ( V_8 , 0 , sizeof( struct V_7 ) ) ;
V_8 -> V_65 = F_21 ( V_66 ) ;
V_8 -> V_17 = V_217 -> V_231 ;
V_8 -> V_67 = 0x00 ;
V_8 -> V_69 [ 0 ] = 0xEF ;
V_12 = F_2 ( V_3 , V_70 , V_5 , 0 ) ;
V_37 -> V_218 = V_213 ;
...
if ( V_37 -> V_195 . V_39 && V_37 -> V_195 . V_40 ) {
F_76 ( V_238 L_29 , V_37 -> V_195 . V_39 ) ;
F_76 ( V_238 L_30 , V_37 -> V_195 . V_40 ) ;
F_76 ( V_238 L_31 , V_37 -> V_195 . V_196 ) ;
F_76 ( V_238 L_32 , V_37 -> V_195 . V_260 ) ;
F_76 ( V_238 L_33 , V_37 -> V_195 . V_44 ) ;
if ( V_37 -> V_195 . V_196 ) {
V_256 = ( V_5 [ 6 ] << 8 ) | V_5 [ 7 ] ;
...
F_4 ( L_29 , V_37 -> V_38 . V_39 ) ;
F_4 ( L_30 , V_37 -> V_38 . V_40 ) ;
F_4 ( L_40 , V_37 -> V_38 . V_51 ) ;
F_4 ( L_41 , V_37 -> V_38 . V_50 ) ;
F_4 ( L_42 , V_37 -> V_38 . V_262 ) ;
F_4 ( L_43 , V_37 -> V_38 . V_44 ) ;
} else {
F_4 ( L_44 , V_5 [ 0 ] ) ;
return V_21 ;
}
...
static int F_87 ( struct V_275 * V_286 )
{
T_1 V_287 = 0 ;
struct V_2 * V_3 = F_88 ( V_286 ) ;
struct V_36 * V_37 = (struct V_36 * ) ( V_3 -> V_1 ) ;
F_89 ( & V_3 -> V_288 ) ;
F_4 ( L_48 , V_289 ) ;
if ( V_3 -> V_290 )
...
F_90 ( & V_3 -> V_288 ) ;
V_37 -> V_292 = true ;
V_37 -> V_38 = * (struct V_261 * ) & V_287 ;
V_37 -> V_195 = * (struct V_259 * ) & V_287 ;
V_37 -> V_293 = * (struct V_294 * ) & V_287 ;
return 0 ;
}
static int F_91 ( struct V_275 * V_286 )
{
T_1 V_287 = 0 ;
struct V_2 * V_3 = F_88 ( V_286 ) ;
struct V_36 * V_37 = (struct V_36 * ) ( V_3 -> V_1 ) ;
