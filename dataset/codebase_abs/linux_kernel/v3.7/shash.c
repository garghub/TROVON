...
int F_87 ( struct V_6 * V_92 , int V_93 )
{
int V_94 , V_95 ;
...
return 0 ;
V_12:
for ( -- V_94 ; V_94 >= 0 ; -- V_94 )
F_85 ( & V_92 [ V_94 ] ) ;
return V_95 ;
}
int F_88 ( struct V_6 * V_92 , int V_93 )
{
int V_94 , V_95 ;
for ( V_94 = V_93 - 1 ; V_94 >= 0 ; -- V_94 ) {
V_95 = F_85 ( & V_92 [ V_94 ] ) ;
if ( V_95 )
F_89 ( L_6 ,
V_92 [ V_94 ] . V_38 . V_96 ,
V_92 [ V_94 ] . V_38 . V_97 , V_95 ) ;
}
return 0 ;
}
int F_90 ( struct V_98 * V_99 ,
struct V_100 * V_101 )
{
int V_12 ;
V_12 = F_82 ( & V_101 -> V_53 ) ;
if ( V_12 )
return V_12 ;
return F_91 ( V_99 , F_92 ( V_101 ) ) ;
}
void F_93 ( struct V_102 * V_101 )
{
F_94 ( F_95 ( V_101 ) ) ;
F_96 ( V_100 ( V_101 ) ) ;
}
int F_97 ( struct V_103 * V_104 ,
struct V_6 * V_53 ,
struct V_102 * V_101 )
{
return F_98 ( & V_104 -> V_38 , & V_53 -> V_38 , V_101 ,
& V_56 ) ;
}
struct V_6 * F_99 ( struct V_105 * V_106 , T_2 type , T_2 V_17 )
{
struct V_50 * V_53 ;
V_53 = F_100 ( V_106 , & V_56 , type , V_17 ) ;
