...
int V_22 ;
const char * V_40 ;
V_7 = F_30 ( & V_35 -> V_13 , sizeof( * V_7 ) , V_41 ) ;
if ( ! V_7 )
return - V_42 ;
V_39 = F_31 ( V_37 , L_3 , & V_7 -> V_43 ) ;
if ( V_39 )
V_7 -> V_9 = F_32 ( V_39 , V_7 -> V_43 , V_41 ) ;
V_22 = F_33 ( V_37 , L_4 , & V_40 ) ;
if ( ! V_22 ) {
if ( ! strcmp ( V_40 , L_5 ) )
V_7 -> V_21 = V_44 ;
else if ( ! strcmp ( V_40 , L_6 ) )
V_7 -> V_21 = V_45 ;
}
V_7 -> V_13 = & V_35 -> V_13 ;
V_22 = F_21 ( V_7 ) ;
if ( V_22 )
return V_22 ;
V_22 = F_34 ( V_7 -> V_30 , V_37 ) ;
F_35 ( V_35 , V_7 ) ;
return 0 ;
}
static int T_3 F_36 ( struct V_34 * V_35 )
{
struct V_6 * V_7 = F_37 ( V_35 ) ;
