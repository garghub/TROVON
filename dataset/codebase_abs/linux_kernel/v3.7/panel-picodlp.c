...
F_13 ( 1000 ) ;
F_26 ( V_3 , & V_3 -> V_110 . V_111 ) ;
F_27 ( V_3 , V_3 -> V_112 . V_113 . V_114 ) ;
V_21 = F_28 ( V_3 ) ;
if ( V_21 ) {
F_8 ( & V_3 -> V_23 , L_6 ) ;
goto V_115;
}
V_21 = F_14 ( V_105 -> V_116 ) ;
if ( V_21 )
goto V_25;
V_3 -> V_117 = V_118 ;
return V_21 ;
...
T_3 * V_129 , T_3 * V_130 )
{
* V_129 = V_3 -> V_110 . V_111 . V_131 ;
* V_130 = V_3 -> V_110 . V_111 . V_132 ;
}
