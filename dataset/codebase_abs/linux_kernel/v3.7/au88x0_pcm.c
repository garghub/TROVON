...
static int T_4 F_63 ( T_1 * V_46 , int V_97 , int V_98 )
{
struct V_99 * V_21 ;
struct V_3 * V_4 ;
int V_88 ;
...
0x10000 , 0x10000 ) ;
if ( F_8 ( V_21 ) == V_26 ) {
for ( V_88 = 0 ; V_88 < F_68 ( V_111 ) ; V_88 ++ ) {
V_4 = F_69 ( & V_111 [ V_88 ] , V_46 ) ;
if ( ! V_4 )
return - V_112 ;
if ( ( V_17 = F_70 ( V_46 -> V_2 , V_4 ) ) < 0 )
return V_17 ;
}
}
if ( F_8 ( V_21 ) == V_33 ) {
