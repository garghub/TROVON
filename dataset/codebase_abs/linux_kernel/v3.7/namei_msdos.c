...
break;
case 0 :
V_16 = F_11 ( V_44 , V_19 . V_27 , V_19 . V_47 ) ;
F_5 ( V_19 . V_30 ) ;
break;
default:
V_16 = F_12 ( V_24 ) ;
...
static int F_22 ( struct V_16 * V_17 , struct V_31 * V_31 , T_2 V_64 ,
bool V_65 )
{
struct V_43 * V_44 = V_17 -> V_22 ;
...
V_16 -> V_63 = V_16 -> V_67 = V_16 -> V_62 = V_52 ;
F_25 ( V_31 , V_16 ) ;
V_41:
F_13 ( & F_3 ( V_44 ) -> V_45 ) ;
if ( ! V_24 )
...
static int F_33 ( struct V_16 * V_17 , struct V_31 * V_31 , T_2 V_64 )
{
struct V_43 * V_44 = V_17 -> V_22 ;
struct V_18 V_19 ;
struct V_16 * V_16 ;
...
static int F_39 ( struct V_16 * V_70 , unsigned char * V_71 ,
struct V_31 * V_72 ,
struct V_16 * V_73 , unsigned char * V_74 ,
struct V_31 * V_75 , int V_49 )
{
struct V_76 * V_77 ;
struct V_53 * V_78 ;
struct V_16 * V_79 , * V_80 ;
struct V_18 V_81 , V_19 ;
struct V_51 V_52 ;
T_3 V_82 ;
int V_24 , V_83 , V_48 , V_84 , V_85 = 0 ;
V_81 . V_30 = V_19 . V_30 = V_77 = NULL ;
V_79 = V_72 -> V_68 ;
V_80 = V_75 -> V_68 ;
V_24 = F_4 ( V_70 , V_71 , & V_81 ) ;
if ( V_24 ) {
V_24 = - V_86 ;
goto V_41;
}
...
V_84 = ( V_48 && V_70 != V_73 ) ;
if ( V_84 ) {
if ( F_41 ( V_79 , & V_77 , & V_78 ) ) {
V_24 = - V_86 ;
goto V_41;
}
}
V_83 = F_42 ( V_79 ) -> V_88 ;
V_24 = F_4 ( V_73 , V_74 , & V_19 ) ;
if ( ! V_24 ) {
if ( ! V_80 ) {
if ( V_19 . V_27 != V_81 . V_27 ) {
V_24 = - V_10 ;
goto V_41;
}
if ( V_49 )
...
V_24 = F_15 ( V_73 , V_74 , V_48 , V_49 , 0 ,
& V_52 , & V_19 ) ;
if ( V_24 )
goto V_41;
V_82 = V_19 . V_47 ;
...
static int F_47 ( struct V_16 * V_70 , struct V_31 * V_72 ,
struct V_16 * V_73 , struct V_31 * V_75 )
{
struct V_43 * V_44 = V_70 -> V_22 ;
unsigned char V_95 [ V_15 ] , V_96 [ V_15 ] ;
int V_24 , V_49 ;
F_10 ( & F_3 ( V_44 ) -> V_45 ) ;
V_24 = F_1 ( V_72 -> V_46 . V_1 ,
V_72 -> V_46 . V_2 , V_95 ,
& F_3 ( V_70 -> V_22 ) -> V_25 ) ;
if ( V_24 )
goto V_41;
V_24 = F_1 ( V_75 -> V_46 . V_1 ,
V_75 -> V_46 . V_2 , V_96 ,
& F_3 ( V_73 -> V_22 ) -> V_25 ) ;
if ( V_24 )
goto V_41;
V_49 =
( V_75 -> V_46 . V_1 [ 0 ] == '.' ) && ( V_96 [ 0 ] != '.' ) ;
V_24 = F_39 ( V_70 , V_95 , V_72 ,
V_73 , V_96 , V_75 , V_49 ) ;
V_41:
F_13 ( & F_3 ( V_44 ) -> V_45 ) ;
if ( ! V_24 )
V_24 = F_26 ( V_44 , V_70 , V_73 ) ;
return V_24 ;
}
