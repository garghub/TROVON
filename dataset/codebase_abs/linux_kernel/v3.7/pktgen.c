...
return - V_19 ;
V_11 [ V_114 ] = 0 ;
F_39 ( V_11 , - 1 , V_22 -> V_42 . V_139 , - 1 , NULL ) ;
...
return - V_19 ;
V_11 [ V_114 ] = 0 ;
F_39 ( V_11 , - 1 , V_22 -> V_43 . V_139 , - 1 , NULL ) ;
...
return - V_19 ;
V_11 [ V_114 ] = 0 ;
F_39 ( V_11 , - 1 , V_22 -> V_44 . V_139 , - 1 , NULL ) ;
...
return - V_19 ;
V_11 [ V_114 ] = 0 ;
F_39 ( V_11 , - 1 , V_22 -> V_39 . V_139 , - 1 , NULL ) ;
...
struct V_183 * V_184 ;
if ( V_22 -> V_26 == 0 ) {
V_22 -> V_26 = 14 + sizeof( struct V_185 )
+ sizeof( struct V_186 )
+ sizeof( struct V_187 )
+ V_22 -> V_188 ;
}
for ( V_60 = 0 ; V_60 < V_189 ; V_60 ++ )
...
if ( ! V_182 ) {
F_71 () ;
V_184 = F_72 ( V_22 -> V_50 ) ;
if ( V_184 ) {
struct V_190 * V_191 ;
F_73 ( & V_184 -> V_192 ) ;
F_46 (ifp, &idev->addr_list, if_list) {
if ( ( V_191 -> V_193 & V_194 ) &&
! ( V_191 -> V_37 & V_195 ) ) {
V_22 -> V_96 = V_191 -> V_196 ;
V_14 = 0 ;
break;
}
}
...
if ( V_22 -> V_26 == 0 ) {
V_22 -> V_26 = 14 + sizeof( struct V_197 )
+ sizeof( struct V_186 )
+ sizeof( struct V_187 )
+ V_22 -> V_188 ;
}
...
static void F_77 ( struct V_21 * V_22 , T_1 V_202 )
{
T_1 V_203 , V_204 ;
T_8 V_205 ;
struct V_206 V_148 ;
F_78 ( & V_148 . V_207 , V_208 , V_209 ) ;
F_79 ( & V_148 . V_207 , V_202 ) ;
V_205 = F_80 ( F_81 ( & V_148 . V_207 ) ) ;
if ( V_205 <= 0 ) {
V_22 -> V_210 = F_82 ( V_202 , V_22 -> V_29 ) ;
return;
}
V_203 = F_1 () ;
if ( V_205 < 100000 ) {
do {
V_204 = F_1 () ;
} while ( F_4 ( V_204 , V_202 ) );
} else {
F_83 ( & V_148 , V_211 ) ;
do {
F_84 ( V_212 ) ;
F_85 ( & V_148 . V_207 , V_209 ) ;
if ( ! F_86 ( & V_148 . V_207 ) )
V_148 . V_213 = NULL ;
if ( F_87 ( V_148 . V_213 ) )
F_88 () ;
F_89 ( & V_148 . V_207 ) ;
} while ( V_148 . V_213 && V_22 -> V_86 && ! F_90 ( V_211 ) );
F_91 ( V_214 ) ;
V_204 = F_1 () ;
}
V_22 -> V_88 += F_80 ( F_92 ( V_204 , V_203 ) ) ;
V_22 -> V_210 = F_82 ( V_202 , V_22 -> V_29 ) ;
}
static inline void F_93 ( struct V_21 * V_22 )
{
V_22 -> V_188 = 0 ;
V_22 -> V_188 += V_22 -> V_59 * sizeof( V_215 ) ;
V_22 -> V_188 += F_94 ( V_22 ) ;
V_22 -> V_188 += F_95 ( V_22 ) ;
}
static inline int F_96 ( const struct V_21 * V_22 , int V_216 )
{
return ! ! ( V_22 -> V_217 [ V_216 ] . V_37 & V_218 ) ;
}
static inline int F_97 ( struct V_21 * V_22 )
{
int V_216 = V_22 -> V_219 ;
if ( V_22 -> V_37 & V_79 ) {
if ( V_22 -> V_217 [ V_216 ] . V_12 >= V_22 -> V_33 ) {
V_22 -> V_217 [ V_216 ] . V_12 = 0 ;
V_22 -> V_217 [ V_216 ] . V_37 = 0 ;
V_22 -> V_219 += 1 ;
if ( V_22 -> V_219 >= V_22 -> V_32 )
V_22 -> V_219 = 0 ;
}
} else {
V_216 = F_98 () % V_22 -> V_32 ;
V_22 -> V_219 = V_216 ;
if ( V_22 -> V_217 [ V_216 ] . V_12 > V_22 -> V_33 ) {
V_22 -> V_217 [ V_216 ] . V_12 = 0 ;
V_22 -> V_217 [ V_216 ] . V_37 = 0 ;
...
static void F_99 ( struct V_21 * V_22 , int V_216 )
{
struct V_220 * V_221 = V_22 -> V_217 [ V_216 ] . V_221 ;
if ( ! V_221 ) {
V_221 = F_100 ( & V_170 , V_222 ,
( V_223 * ) & V_22 -> V_99 ,
( V_223 * ) & V_22 -> V_98 ,
V_224 ,
V_22 -> V_225 ,
V_22 -> V_226 , 0 ) ;
if ( V_221 ) {
V_22 -> V_217 [ V_216 ] . V_221 = V_221 ;
F_93 ( V_22 ) ;
V_22 -> V_188 += V_221 -> V_227 . V_228 ;
}
}
}
...
V_115 = V_22 -> V_49 [ 5 ] + ( V_231 & 0xFF ) ;
V_22 -> V_142 [ 11 ] = V_115 ;
V_115 = ( V_22 -> V_49 [ 4 ] + ( ( V_231 >> 8 ) & 0xFF ) + ( V_115 >> 8 ) ) ;
V_22 -> V_142 [ 10 ] = V_115 ;
V_115 = ( V_22 -> V_49 [ 3 ] + ( ( V_231 >> 16 ) & 0xFF ) + ( V_115 >> 8 ) ) ;
V_22 -> V_142 [ 9 ] = V_115 ;
V_115 = ( V_22 -> V_49 [ 2 ] + ( ( V_231 >> 24 ) & 0xFF ) + ( V_115 >> 8 ) ) ;
V_22 -> V_142 [ 8 ] = V_115 ;
...
V_115 = V_22 -> V_52 [ 5 ] + ( V_231 & 0xFF ) ;
V_22 -> V_142 [ 5 ] = V_115 ;
V_115 = ( V_22 -> V_52 [ 4 ] + ( ( V_231 >> 8 ) & 0xFF ) + ( V_115 >> 8 ) ) ;
V_22 -> V_142 [ 4 ] = V_115 ;
V_115 = ( V_22 -> V_52 [ 3 ] + ( ( V_231 >> 16 ) & 0xFF ) + ( V_115 >> 8 ) ) ;
V_22 -> V_142 [ 3 ] = V_115 ;
V_115 = ( V_22 -> V_52 [ 2 ] + ( ( V_231 >> 24 ) & 0xFF ) + ( V_115 >> 8 ) ) ;
V_22 -> V_142 [ 2 ] = V_115 ;
...
if ( ! ( V_22 -> V_37 & V_38 ) ) {
V_229 = F_20 ( V_22 -> V_140 ) ;
V_230 = F_20 ( V_22 -> V_141 ) ;
if ( V_229 < V_230 ) {
T_7 V_148 ;
if ( V_22 -> V_37 & V_71 )
V_148 = F_98 () % ( V_230 - V_229 ) + V_229 ;
else {
...
if ( V_22 -> V_32 && F_96 ( V_22 , V_216 ) ) {
V_22 -> V_99 = V_22 -> V_217 [ V_216 ] . V_99 ;
} else {
V_229 = F_20 ( V_22 -> V_137 ) ;
V_230 = F_20 ( V_22 -> V_138 ) ;
if ( V_229 < V_230 ) {
T_7 V_148 ;
V_233 V_234 ;
if ( V_22 -> V_37 & V_72 ) {
...
if ( V_22 -> V_32 ) {
V_22 -> V_217 [ V_216 ] . V_37 |= V_218 ;
V_22 -> V_217 [ V_216 ] . V_99 =
V_22 -> V_99 ;
#ifdef F_21
if ( V_22 -> V_37 & V_80 )
F_99 ( V_22 , V_216 ) ;
...
V_22 -> V_97 . V_235 [ V_60 ] =
( ( ( V_232 V_233 ) F_98 () |
V_22 -> V_43 . V_235 [ V_60 ] ) &
V_22 -> V_44 . V_235 [ V_60 ] ) ;
}
}
}
if ( V_22 -> V_26 < V_22 -> V_27 ) {
...
F_101 ( V_22 ) ;
V_22 -> V_217 [ V_216 ] . V_12 ++ ;
}
static int F_109 ( struct V_236 * V_237 , struct V_21 * V_22 )
{
struct V_220 * V_221 = V_22 -> V_217 [ V_22 -> V_219 ] . V_221 ;
int V_14 = 0 ;
if ( ! V_221 )
return 0 ;
...
return 0 ;
F_110 ( & V_221 -> V_192 ) ;
V_14 = V_221 -> V_240 -> V_241 ( V_221 , V_237 ) ;
if ( V_14 )
goto error;
V_14 = V_221 -> type -> V_241 ( V_221 , V_237 ) ;
if ( V_14 )
goto error;
V_221 -> V_242 . V_243 += V_237 -> V_114 ;
V_221 -> V_242 . V_244 ++ ;
error:
F_111 ( & V_221 -> V_192 ) ;
return V_14 ;
...
struct V_220 * V_221 = V_22 -> V_217 [ V_60 ] . V_221 ;
if ( V_221 ) {
F_113 ( V_221 ) ;
V_22 -> V_217 [ V_60 ] . V_221 = NULL ;
}
}
}
}
...
if ( V_246 > 0 ) {
V_149 = F_116 ( V_237 , V_246 , 0 , V_248 ) ;
if ( V_149 < 0 ) {
F_49 ( L_229 ,
V_149 ) ;
goto V_14;
...
F_117 ( V_237 , V_249 ) ;
V_149 = F_109 ( V_237 , V_22 ) ;
if ( V_149 ) {
F_49 ( L_230 , V_149 ) ;
goto V_14;
}
V_247 = ( T_11 * ) F_118 ( V_237 , V_249 ) ;
memcpy ( V_247 , V_22 -> V_142 , 12 ) ;
...
static void F_120 ( V_233 * V_251 , struct V_21 * V_22 )
{
unsigned int V_60 ;
for ( V_60 = 0 ; V_60 < V_22 -> V_59 ; V_60 ++ )
* V_251 ++ = V_22 -> V_61 [ V_60 ] & ~ V_116 ;
V_251 -- ;
* V_251 |= V_116 ;
}
...
static void F_123 ( struct V_21 * V_22 , struct V_236 * V_237 ,
int V_255 )
{
struct V_256 V_257 ;
struct V_187 * V_258 ;
V_258 = (struct V_187 * ) F_124 ( V_237 , sizeof( * V_258 ) ) ;
V_255 -= sizeof( * V_258 ) ;
if ( V_22 -> V_28 <= 0 ) {
...
if ( V_259 > V_261 )
V_259 = V_261 ;
V_114 = V_255 - V_259 * V_262 ;
if ( V_114 > 0 ) {
memset ( F_124 ( V_237 , V_114 ) , 0 , V_114 ) ;
V_255 = V_259 * V_262 ;
}
V_60 = 0 ;
...
V_70 = V_22 -> V_70 ;
V_22 -> V_135 = F_127 ( V_70 , V_263 | V_264 , 0 ) ;
if ( ! V_22 -> V_135 )
break;
}
F_128 ( V_22 -> V_135 ) ;
F_129 ( V_237 , V_60 , V_22 -> V_135 ) ;
F_130 ( V_237 ) -> V_259 [ V_60 ] . V_265 = 0 ;
if ( V_60 == ( V_259 - 1 ) )
F_131 ( & F_130 ( V_237 ) -> V_259 [ V_60 ] ,
( V_255 < V_262 ? V_255 : V_262 ) ) ;
else
F_131 ( & F_130 ( V_237 ) -> V_259 [ V_60 ] , V_260 ) ;
V_255 -= F_132 ( & F_130 ( V_237 ) -> V_259 [ V_60 ] ) ;
V_237 -> V_114 += F_132 ( & F_130 ( V_237 ) -> V_259 [ V_60 ] ) ;
V_237 -> V_266 += F_132 ( & F_130 ( V_237 ) -> V_259 [ V_60 ] ) ;
V_60 ++ ;
F_130 ( V_237 ) -> V_267 = V_60 ;
}
}
V_258 -> V_268 = F_31 ( V_269 ) ;
V_258 -> V_93 = F_31 ( V_22 -> V_93 ) ;
F_133 ( & V_257 ) ;
V_258 -> V_270 = F_31 ( V_257 . V_270 ) ;
V_258 -> V_271 = F_31 ( V_257 . V_271 ) ;
}
static struct V_236 * F_134 ( struct V_161 * V_50 ,
struct V_21 * V_22 )
{
...
V_70 = F_126 () ;
V_237 = F_135 ( V_284 + V_22 -> V_129 + 64
+ V_255 + V_22 -> V_188 , V_285 , 0 , V_70 ) ;
if ( F_87 ( V_237 ) ) {
F_136 ( V_237 , V_284 ) ;
V_237 -> V_162 = V_50 ;
}
...
V_251 = ( V_233 * ) F_124 ( V_237 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_120 ( V_251 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_278 = ( T_10 * ) F_124 ( V_237 , sizeof( T_10 ) ) ;
* V_278 = F_121 ( V_22 -> V_65 ,
V_22 -> V_67 ,
V_22 -> V_66 ) ;
V_279 = ( T_10 * ) F_124 ( V_237 , sizeof( T_10 ) ) ;
* V_279 = F_122 ( V_282 ) ;
}
V_276 = ( T_10 * ) F_124 ( V_237 , sizeof( T_10 ) ) ;
* V_276 = F_121 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_277 = ( T_10 * ) F_124 ( V_237 , sizeof( T_10 ) ) ;
* V_277 = F_122 ( V_275 ) ;
}
V_237 -> V_286 = V_237 -> V_287 ;
V_237 -> V_288 = V_237 -> V_286 + sizeof( struct V_197 ) ;
F_124 ( V_237 , sizeof( struct V_197 ) + sizeof( struct V_186 ) ) ;
F_139 ( V_237 , V_280 ) ;
V_237 -> V_289 = V_22 -> V_36 ;
V_274 = F_140 ( V_237 ) ;
V_272 = F_141 ( V_237 ) ;
memcpy ( V_247 , V_22 -> V_142 , 12 ) ;
* ( T_10 * ) & V_247 [ 12 ] = V_245 ;
V_255 = V_22 -> V_129 - 14 - 20 - 8 -
V_22 -> V_188 ;
if ( V_255 < 0 || V_255 < sizeof( struct V_187 ) )
V_255 = sizeof( struct V_187 ) ;
V_272 -> V_290 = F_122 ( V_22 -> V_101 ) ;
V_272 -> V_291 = F_122 ( V_22 -> V_100 ) ;
V_272 -> V_114 = F_122 ( V_255 + 8 ) ;
V_272 -> V_292 = 0 ;
V_274 -> V_293 = 5 ;
V_274 -> V_9 = 4 ;
V_274 -> V_294 = 32 ;
V_274 -> V_68 = V_22 -> V_68 ;
V_274 -> V_245 = V_295 ;
V_274 -> V_296 = V_22 -> V_98 ;
V_274 -> V_297 = V_22 -> V_99 ;
V_274 -> V_252 = F_122 ( V_22 -> V_298 ) ;
V_22 -> V_298 ++ ;
V_274 -> V_299 = 0 ;
V_273 = 20 + 8 + V_255 ;
V_274 -> V_300 = F_122 ( V_273 ) ;
V_274 -> V_292 = 0 ;
V_274 -> V_292 = F_142 ( ( void * ) V_274 , V_274 -> V_293 ) ;
V_237 -> V_245 = V_245 ;
V_237 -> V_301 = ( V_237 -> V_286 - V_249 -
V_22 -> V_188 ) ;
V_237 -> V_162 = V_50 ;
V_237 -> V_302 = V_303 ;
F_123 ( V_22 , V_237 , V_255 ) ;
#ifdef F_21
if ( ! F_114 ( V_22 , V_237 , V_245 ) )
return NULL ;
#endif
return V_237 ;
}
static struct V_236 * F_143 ( struct V_161 * V_50 ,
struct V_21 * V_22 )
{
struct V_236 * V_237 = NULL ;
T_11 * V_247 ;
...
V_237 -> V_286 = V_237 -> V_287 ;
V_237 -> V_288 = V_237 -> V_286 + sizeof( struct V_185 ) ;
F_124 ( V_237 , sizeof( struct V_185 ) + sizeof( struct V_186 ) ) ;
F_139 ( V_237 , V_280 ) ;
V_237 -> V_289 = V_22 -> V_36 ;
V_274 = F_144 ( V_237 ) ;
V_272 = F_141 ( V_237 ) ;
...
* ( T_10 * ) & V_247 [ 12 ] = V_245 ;
V_255 = V_22 -> V_129 - 14 -
sizeof( struct V_185 ) - sizeof( struct V_186 ) -
V_22 -> V_188 ;
if ( V_255 < 0 || V_255 < sizeof( struct V_187 ) ) {
V_255 = sizeof( struct V_187 ) ;
F_145 ( L_232 , V_255 ) ;
...
V_272 -> V_290 = F_122 ( V_22 -> V_101 ) ;
V_272 -> V_291 = F_122 ( V_22 -> V_100 ) ;
V_272 -> V_114 = F_122 ( V_255 + sizeof( struct V_186 ) ) ;
V_272 -> V_292 = 0 ;
* ( V_233 * ) V_274 = F_31 ( 0x60000000 ) ;
if ( V_22 -> V_69 ) {
* ( V_233 * ) V_274 |= F_31 ( 0x60000000 | ( V_22 -> V_69 << 20 ) ) ;
}
V_274 -> V_305 = 32 ;
V_274 -> V_306 = F_122 ( sizeof( struct V_186 ) + V_255 ) ;
V_274 -> V_307 = V_295 ;
V_274 -> V_297 = V_22 -> V_97 ;
V_274 -> V_296 = V_22 -> V_96 ;
V_237 -> V_301 = ( V_237 -> V_286 - V_249 -
V_22 -> V_188 ) ;
V_237 -> V_245 = V_245 ;
V_237 -> V_162 = V_50 ;
...
static struct V_236 * F_146 ( struct V_161 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
return F_143 ( V_50 , V_22 ) ;
else
return F_134 ( V_50 , V_22 ) ;
}
...
static int F_149 ( const struct V_147 * V_148 )
{
const struct V_21 * V_22 ;
F_46 (pkt_dev, &t->if_list, list)
if ( V_22 -> V_86 )
...
static void F_153 ( struct V_21 * V_22 , int V_267 )
{
T_12 V_313 , V_314 , V_315 ;
char * V_316 = V_22 -> V_104 ;
T_1 V_317 = F_92 ( V_22 -> V_87 ,
V_22 -> V_92 ) ;
T_1 V_25 = F_154 ( V_22 -> V_88 ) ;
V_316 += sprintf ( V_316 , L_235 ,
( unsigned long long ) F_23 ( V_317 ) ,
( unsigned long long ) F_23 ( F_92 ( V_317 , V_25 ) ) ,
( unsigned long long ) F_23 ( V_25 ) ,
( unsigned long long ) V_22 -> V_90 ,
V_22 -> V_129 , V_267 ) ;
V_315 = F_155 ( V_22 -> V_90 * V_131 ,
F_80 ( V_317 ) ) ;
V_313 = V_315 * 8 * V_22 -> V_129 ;
V_314 = V_313 ;
F_22 ( V_314 , 1000000 ) ;
...
{
int V_267 = V_22 -> V_237 ? F_130 ( V_22 -> V_237 ) -> V_267 : - 1 ;
if ( ! V_22 -> V_86 ) {
F_13 ( L_237 ,
V_22 -> V_31 ) ;
return - V_125 ;
...
static struct V_21 * F_157 ( struct V_147 * V_148 )
{
struct V_21 * V_22 , * V_318 = NULL ;
F_45 ( V_148 ) ;
F_46 (pkt_dev, &t->if_list, list) {
if ( ! V_22 -> V_86 )
continue;
if ( V_318 == NULL )
V_318 = V_22 ;
else if ( F_4 ( V_22 -> V_210 , V_318 -> V_210 ) )
V_318 = V_22 ;
}
F_47 ( V_148 ) ;
return V_318 ;
...
{
struct V_319 * V_320 , * V_113 ;
struct V_21 * V_321 ;
F_148 () ;
F_45 ( V_148 ) ;
F_160 (q, n, &t->if_list) {
V_321 = F_161 ( V_320 , struct V_21 , V_322 ) ;
if ( ! V_321 -> V_156 )
continue;
F_119 ( V_321 -> V_237 ) ;
V_321 -> V_237 = NULL ;
...
static void F_163 ( struct V_147 * V_148 )
{
struct V_319 * V_320 , * V_113 ;
struct V_21 * V_321 ;
F_148 () ;
...
{
F_60 ( V_148 -> V_323 -> V_324 , V_164 ) ;
}
static void F_165 ( struct V_21 * V_22 )
{
T_1 V_325 = F_1 () ;
F_88 () ;
V_22 -> V_88 += F_80 ( F_92 ( F_1 () , V_325 ) ) ;
}
static void F_166 ( struct V_21 * V_22 )
{
T_1 V_325 = F_1 () ;
while ( F_167 ( & ( V_22 -> V_237 -> V_326 ) ) != 1 ) {
if ( F_90 ( V_211 ) )
break;
if ( F_168 () )
F_165 ( V_22 ) ;
...
T_13 (* F_171)( struct V_236 * , struct V_161 * )
= V_50 -> V_327 -> V_328 ;
struct V_329 * V_330 ;
V_250 V_280 ;
int V_149 ;
if ( F_125 ( ! F_69 ( V_50 ) || ! F_172 ( V_50 ) ) ) {
F_156 ( V_22 ) ;
return;
}
if ( F_125 ( V_22 -> V_29 == V_130 ) ) {
V_22 -> V_210 = F_82 ( F_1 () , V_331 ) ;
return;
}
if ( ! V_22 -> V_237 || ( V_22 -> V_332 &&
++ V_22 -> V_333 >= V_22 -> V_30 ) ) {
F_119 ( V_22 -> V_237 ) ;
V_22 -> V_237 = F_146 ( V_50 , V_22 ) ;
if ( V_22 -> V_237 == NULL ) {
F_49 ( L_238 ) ;
F_88 () ;
V_22 -> V_333 -- ;
...
V_22 -> V_334 = V_22 -> V_237 -> V_114 ;
V_22 -> V_335 ++ ;
V_22 -> V_333 = 0 ;
}
if ( V_22 -> V_29 && V_22 -> V_332 )
F_77 ( V_22 , V_22 -> V_210 ) ;
V_280 = F_173 ( V_22 -> V_237 ) ;
V_330 = F_174 ( V_50 , V_280 ) ;
F_175 ( V_330 ) ;
if ( F_125 ( F_176 ( V_330 ) ) ) {
V_149 = V_336 ;
V_22 -> V_332 = 0 ;
goto V_337;
}
F_177 ( & ( V_22 -> V_237 -> V_326 ) ) ;
V_149 = (* F_171)( V_22 -> V_237 , V_50 ) ;
switch ( V_149 ) {
case V_338 :
F_178 ( V_330 ) ;
V_22 -> V_332 = 1 ;
...
{
F_182 ( V_344 ) ;
struct V_147 * V_148 = V_343 ;
struct V_21 * V_22 = NULL ;
int V_345 = V_148 -> V_345 ;
F_44 ( F_102 () != V_345 ) ;
F_183 ( & V_148 -> V_346 ) ;
F_184 ( & V_148 -> V_347 ) ;
F_34 ( L_240 , V_345 , F_185 ( V_211 ) ) ;
F_84 ( V_212 ) ;
F_186 () ;
while ( ! F_187 () ) {
V_22 = F_157 ( V_148 ) ;
if ( F_125 ( ! V_22 && V_148 -> V_151 == 0 ) ) {
if ( V_171 )
break;
F_188 ( V_148 -> V_346 ,
V_148 -> V_151 != 0 ,
...
if ( V_148 -> V_151 & V_310 ) {
F_158 ( V_148 ) ;
V_148 -> V_151 &= ~ ( V_310 ) ;
}
if ( V_148 -> V_151 & V_312 ) {
F_147 ( V_148 ) ;
V_148 -> V_151 &= ~ ( V_312 ) ;
}
...
F_34 ( L_241 , V_148 -> V_323 -> V_324 ) ;
F_158 ( V_148 ) ;
F_34 ( L_242 , V_148 -> V_323 -> V_324 ) ;
F_163 ( V_148 ) ;
F_34 ( L_243 , V_148 -> V_323 -> V_324 ) ;
F_164 ( V_148 ) ;
while ( ! F_187 () ) {
F_84 ( V_212 ) ;
F_88 () ;
...
{
struct V_21 * V_316 , * V_22 = NULL ;
T_4 V_114 = strlen ( V_153 ) ;
F_45 ( V_148 ) ;
F_46 (p, &t->if_list, list)
if ( strncmp ( V_316 -> V_31 , V_153 , V_114 ) == 0 ) {
if ( V_316 -> V_31 [ V_114 ] ) {
if ( V_154 || V_316 -> V_31 [ V_114 ] != '@' )
continue;
}
V_22 = V_316 ;
break;
...
static int F_190 ( struct V_147 * V_148 ,
struct V_21 * V_22 )
{
int V_349 = 0 ;
F_45 ( V_148 ) ;
...
struct V_21 * V_22 ;
int V_14 ;
int V_70 = F_192 ( V_148 -> V_345 ) ;
V_22 = F_56 ( V_153 , V_155 ) ;
if ( V_22 ) {
F_49 ( L_246 ) ;
return - V_351 ;
}
V_22 = F_193 ( sizeof( struct V_21 ) , V_263 , V_70 ) ;
if ( ! V_22 )
return - V_353 ;
strcpy ( V_22 -> V_31 , V_153 ) ;
V_22 -> V_217 = F_194 ( V_144 * sizeof( struct V_354 ) ,
V_70 ) ;
if ( V_22 -> V_217 == NULL ) {
F_195 ( V_22 ) ;
return - V_353 ;
...
static int T_14 F_197 ( int V_345 )
{
struct V_147 * V_148 ;
struct V_362 * V_363 ;
struct V_364 * V_316 ;
V_148 = F_193 ( sizeof( struct V_147 ) , V_263 ,
F_192 ( V_345 ) ) ;
if ( ! V_148 ) {
F_49 ( L_248 ) ;
return - V_353 ;
...
F_206 ( V_316 , V_345 ) ;
V_148 -> V_323 = V_316 ;
V_363 = F_61 ( V_148 -> V_323 -> V_324 , 0600 , V_164 ,
& V_367 , V_148 ) ;
if ( ! V_363 ) {
F_49 ( L_247 ,
V_359 , V_148 -> V_323 -> V_324 ) ;
F_207 ( V_316 ) ;
F_204 ( & V_148 -> V_365 ) ;
F_195 ( V_148 ) ;
return - V_125 ;
...
static void F_210 ( struct V_147 * V_148 ,
struct V_21 * V_22 )
{
struct V_319 * V_320 , * V_113 ;
struct V_21 * V_316 ;
F_160 (q, n, &t->if_list) {
V_316 = F_161 ( V_320 , struct V_21 , V_322 ) ;
if ( V_316 == V_22 )
F_204 ( & V_316 -> V_322 ) ;
}
}
...
static int T_14 F_211 ( void )
{
int V_345 ;
struct V_362 * V_363 ;
int V_149 = 0 ;
F_35 ( L_253 , V_9 ) ;
V_164 = F_212 ( V_359 , V_170 . V_368 ) ;
if ( ! V_164 )
return - V_177 ;
V_363 = F_213 ( V_369 , 0600 , V_164 , & V_370 ) ;
if ( V_363 == NULL ) {
F_49 ( L_254 , V_369 ) ;
V_149 = - V_125 ;
goto V_371;
...
F_52 ( & V_150 ) ;
F_160 (q, n, &list) {
V_148 = F_161 ( V_320 , struct V_147 , V_365 ) ;
F_204 ( & V_148 -> V_365 ) ;
F_207 ( V_148 -> V_323 ) ;
F_195 ( V_148 ) ;
}
