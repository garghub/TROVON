...
F_38 ( V_1 , V_77 , V_1 -> V_311 ) ;
} else {
F_38 ( V_1 , V_77 , V_200 -> V_312 ) ;
}
V_1 -> V_77 = V_77 ;
if ( V_65 == V_138 ) {
V_174 -> V_13 = 0 ;
...
V_1 -> V_329 = FALSE ;
if ( F_39 ( V_196 -> V_318 -> V_325 . V_53 ) != 0 ) {
if ( V_1 -> V_275 == V_276 ) {
V_204 = 4 ;
V_60 = 4 ;
V_174 -> V_239 |= V_243 ;
...
( V_1 -> V_333 == TRUE ) ) {
V_331 = V_1 -> V_158 ;
if ( F_40 ( & ( V_1 -> V_334 ) , V_331 , V_335 , & V_26 ) == FALSE ) {
if( F_40 ( & ( V_1 -> V_334 ) , V_331 , V_336 , & V_26 ) == TRUE ) {
F_2 ( V_5 , V_6 L_8 ) ;
break;
}
} else {
...
V_331 = V_1 -> V_337 ;
if( F_40 ( & ( V_1 -> V_334 ) , V_331 , V_336 , & V_26 ) == FALSE ) {
V_26 = NULL ;
...
void
F_44 ( T_1 V_1 , struct V_349 * V_350 ) {
T_26 V_200 = & ( V_1 -> V_201 ) ;
T_3 V_65 ;
T_4 V_211 ;
void * V_141 ;
...
if ( V_1 -> V_266 ) {
if ( F_46 ( V_1 , ( T_4 ) ( V_318 -> V_319 . V_54 ) , & V_197 ) )
V_351 = TRUE ;
}
V_177 = TRUE ;
V_174 -> V_13 |= V_234 ;
...
if ( F_47 ( V_318 -> V_325 . V_53 ) == V_356 ) {
...
int F_48 ( T_1 V_1 , unsigned int V_112 , struct V_349 * V_350 )
{
T_26 V_200 = & ( V_1 -> V_201 ) ;
...
F_49 ( & ( V_200 -> V_267 [ 0 ] . V_380 ) , V_350 ) ;
V_200 -> V_267 [ 0 ] . V_381 ++ ;
...
if ( F_46 ( V_1 , ( T_4 ) ( V_350 -> V_355 ) , & V_197 ) ) {
if ( V_200 -> V_267 [ V_197 ] . V_379 ) {
F_49 ( & V_200 -> V_267 [ V_197 ] . V_380 , V_350 ) ;
...
F_2 ( V_5 , V_390 L_26 ) ;
if( F_40 ( & ( V_1 -> V_334 ) , V_331 , V_335 , & V_26 ) == TRUE )
break;
}
V_331 = V_1 -> V_337 ;
if( F_40 ( & ( V_1 -> V_334 ) , V_331 , V_336 , & V_26 ) == FALSE ) {
...
if( F_46 ( V_1 , & ( V_1 -> V_392 . V_157 [ 0 ] ) , & V_197 ) ) {
V_1 -> V_77 = V_200 -> V_267 [ V_197 ] . V_386 ;
if ( V_200 -> V_267 [ V_197 ] . V_387 ) {
V_1 -> V_71 = V_1 -> V_388 ;
}
