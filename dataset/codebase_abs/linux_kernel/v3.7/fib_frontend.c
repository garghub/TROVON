...
int V_157 , V_167 ;
struct V_168 * V_169 ;
V_157 = F_62 ( V_165 , sizeof( * V_169 ) , V_170 , V_171 ) ;
if ( V_157 < 0 )
goto V_172;
memset ( V_103 , 0 , sizeof( * V_103 ) ) ;
V_169 = F_63 ( V_165 ) ;
...
V_103 -> V_105 . V_183 = F_64 ( V_44 ) . V_183 ;
...
switch ( V_98 ( V_166 ) ) {
case V_185 :
V_103 -> V_115 = F_66 ( V_166 ) ;
break;
case V_186 :
V_103 -> V_134 = F_67 ( V_166 ) ;
break;
case V_187 :
V_103 -> V_142 = F_66 ( V_166 ) ;
break;
case V_188 :
V_103 -> V_122 = F_67 ( V_166 ) ;
break;
case V_189 :
V_103 -> V_139 = F_66 ( V_166 ) ;
break;
case V_190 :
V_103 -> V_154 = F_46 ( V_166 ) ;
V_103 -> V_155 = V_99 ( V_166 ) ;
break;
case V_191 :
V_103 -> V_192 = F_46 ( V_166 ) ;
V_103 -> V_193 = V_99 ( V_166 ) ;
break;
case V_194 :
V_103 -> V_195 = F_67 ( V_166 ) ;
break;
case V_196 :
V_103 -> V_161 = F_67 ( V_166 ) ;
break;
}
}
return 0 ;
...
static int F_68 ( struct V_43 * V_44 , struct V_164 * V_165 , void * V_156 )
{
struct V_1 * V_1 = F_69 ( V_44 -> V_197 ) ;
struct V_102 V_103 ;
struct V_2 * V_15 ;
int V_157 ;
V_157 = F_61 ( V_1 , V_44 , V_165 , & V_103 ) ;
if ( V_157 < 0 )
goto V_172;
V_15 = F_6 ( V_1 , V_103 . V_161 ) ;
if ( V_15 == NULL ) {
...
static int F_70 ( struct V_43 * V_44 , struct V_164 * V_165 , void * V_156 )
{
struct V_1 * V_1 = F_69 ( V_44 -> V_197 ) ;
struct V_102 V_103 ;
struct V_2 * V_15 ;
...
static int F_71 ( struct V_43 * V_44 , struct V_198 * V_199 )
{
struct V_1 * V_1 = F_69 ( V_44 -> V_197 ) ;
...
struct V_24 * V_25 ;
int V_203 = 0 ;
if ( F_72 ( V_199 -> V_165 ) >= sizeof( struct V_168 ) &&
( (struct V_168 * ) F_63 ( V_199 -> V_165 ) ) -> V_181 & V_204 )
return F_73 ( V_44 , V_199 ) ;
V_200 = V_199 -> args [ 0 ] ;
V_202 = V_199 -> args [ 1 ] ;
...
static void F_75 ( int V_100 , int type , T_3 V_66 , int V_207 , struct V_135 * V_136 )
{
...
V_212 = F_77 ( V_46 , V_214 , V_112 ) ;
if ( V_212 == NULL ) {
F_78 ( L_1 , V_218 ) ;
return;
}
}
F_75 ( V_211 , V_76 , V_30 , 32 , V_212 ) ;
if ( ! ( V_29 -> V_219 & V_220 ) )
return;
if ( V_136 -> V_221 && V_136 -> V_221 != F_79 ( 0xFFFFFFFF ) )
F_75 ( V_211 , V_37 , V_136 -> V_221 , 32 , V_212 ) ;
if ( ! F_15 ( V_214 ) && ! ( V_136 -> V_216 & V_217 ) &&
( V_214 != V_30 || V_136 -> V_222 < 32 ) ) {
F_75 ( V_211 ,
V_29 -> V_219 & V_223 ? V_76 : V_39 ,
V_214 , V_136 -> V_222 , V_212 ) ;
if ( V_136 -> V_222 < 31 ) {
F_75 ( V_211 , V_37 , V_214 , 32 , V_212 ) ;
F_75 ( V_211 , V_37 , V_214 | ~ V_112 ,
32 , V_212 ) ;
}
}
}
void F_80 ( struct V_135 * V_136 , struct V_135 * V_224 )
{
struct V_45 * V_46 = V_136 -> V_208 ;
struct V_28 * V_29 = V_46 -> V_29 ;
struct V_135 * V_225 ;
...
int V_232 = 0 ;
if ( V_136 -> V_216 & V_217 ) {
V_212 = F_77 ( V_46 , V_228 , V_136 -> V_213 ) ;
if ( V_212 == NULL ) {
F_78 ( L_1 , V_218 ) ;
return;
}
...
for ( V_225 = V_46 -> V_74 ; V_225 ; V_225 = V_225 -> V_137 ) {
if ( V_225 == V_136 ) {
V_231 = 0 ;
continue;
}
if ( V_224 && V_225 -> V_213 == V_224 -> V_213 &&
F_85 ( V_225 -> V_215 , V_224 ) )
continue;
if ( V_225 -> V_216 & V_217 ) {
if ( V_225 -> V_213 == V_212 -> V_213 &&
F_85 ( V_225 -> V_215 , V_212 ) )
V_226 = V_212 ;
else {
if ( ! V_232 )
continue;
...
if ( ! ( V_229 & F_82 ) )
F_75 ( V_233 , V_37 , V_136 -> V_221 , 32 , V_212 ) ;
if ( V_230 && V_136 -> V_222 < 31 ) {
if ( ! ( V_229 & F_84 ) )
F_75 ( V_233 , V_37 , V_227 , 32 , V_212 ) ;
if ( ! ( V_229 & F_83 ) )
F_75 ( V_233 , V_37 , V_228 , 32 , V_212 ) ;
}
if ( ! ( V_229 & F_81 ) ) {
F_75 ( V_233 , V_76 , V_136 -> V_140 , 32 , V_212 ) ;
if ( V_231 &&
...
static void F_87 ( struct V_236 * V_237 , struct V_2 * V_15 )
{
struct V_34 V_35 ;
struct V_31 V_32 = {
. V_62 = V_237 -> V_238 ,
...
V_1 = F_69 ( V_44 -> V_197 ) ;
V_165 = F_91 ( V_44 ) ;
if ( V_44 -> V_95 < F_92 ( 0 ) || V_44 -> V_95 < V_165 -> F_72 ||
V_165 -> F_72 < F_93 ( sizeof( * V_237 ) ) )
return;
V_44 = F_94 ( V_44 , V_147 ) ;
if ( V_44 == NULL )
return;
V_165 = F_91 ( V_44 ) ;
V_237 = (struct V_236 * ) F_95 ( V_165 ) ;
V_15 = F_6 ( V_1 , V_237 -> V_245 ) ;
F_87 ( V_237 , V_15 ) ;
V_183 = F_64 ( V_44 ) . V_183 ;
F_64 ( V_44 ) . V_183 = 0 ;
F_64 ( V_44 ) . V_246 = 0 ;
F_96 ( V_1 -> V_10 . V_247 , V_44 , V_183 , V_248 ) ;
}
...
{
F_100 ( V_1 -> V_10 . V_247 ) ;
V_1 -> V_10 . V_247 = NULL ;
}
static void F_101 ( struct V_28 * V_29 , int V_253 )
{
if ( F_102 ( V_29 , V_253 ) )
F_10 ( F_26 ( V_29 ) ) ;
F_13 ( F_26 ( V_29 ) ) ;
...
{
struct V_135 * V_136 = (struct V_135 * ) V_257 ;
...
F_105 ( V_29 ) ;
#endif
F_106 ( & V_1 -> V_10 . V_259 ) ;
F_13 ( F_26 ( V_29 ) ) ;
break;
case V_260 :
F_80 ( V_136 , NULL ) ;
F_106 ( & V_1 -> V_10 . V_259 ) ;
if ( V_136 -> V_208 -> V_74 == NULL ) {
F_101 ( V_29 , 1 ) ;
} else {
F_13 ( F_26 ( V_29 ) ) ;
}
...
static int F_107 ( struct V_254 * V_255 , unsigned long V_256 , void * V_257 )
{
struct V_28 * V_29 = V_257 ;
struct V_45 * V_46 ;
struct V_1 * V_1 = F_26 ( V_29 ) ;
if ( V_256 == V_262 ) {
F_101 ( V_29 , 2 ) ;
...
{
int V_157 ;
T_6 V_265 = sizeof( struct V_24 ) * V_21 ;
V_265 = F_112 ( T_6 , V_265 , V_266 ) ;
V_1 -> V_10 . V_11 = F_54 ( V_265 , V_147 ) ;
...
struct V_2 * V_15 ;
struct V_24 * V_25 ;
struct V_22 * V_23 , * V_268 ;
V_25 = & V_1 -> V_10 . V_11 [ V_267 ] ;
...
void T_8 F_124 ( void )
{
F_125 ( V_271 , V_211 , F_70 , NULL , NULL ) ;
F_125 ( V_271 , V_233 , F_68 , NULL , NULL ) ;
