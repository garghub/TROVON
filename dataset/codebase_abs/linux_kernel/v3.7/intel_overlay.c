...
F_61 ( & V_5 -> V_116 . V_117 ) ;
F_61 ( & V_5 -> V_115 ) ;
V_19 = F_50 ( V_3 ) ;
F_62 ( & V_5 -> V_115 ) ;
F_62 ( & V_5 -> V_116 . V_117 ) ;
return V_19 ;
}
V_62 = F_63 ( sizeof( struct V_61 ) , V_192 ) ;
if ( ! V_62 )
return - V_120 ;
V_189 = F_64 ( V_5 , V_187 -> V_193 ,
V_194 ) ;
if ( ! V_189 ) {
V_19 = - V_195 ;
goto V_196;
}
V_42 = F_65 ( F_66 ( V_189 ) ) ;
V_109 = F_67 ( F_68 ( V_5 , V_186 ,
V_187 -> V_197 ) ) ;
if ( & V_109 -> V_40 == NULL ) {
V_19 = - V_195 ;
goto V_196;
...
static bool F_73 ( T_3 V_209 , T_3 V_210 )
{
int V_211 ;
...
static int F_75 ( struct V_213 * V_214 )
{
if ( ! F_73 ( 0 , V_214 -> V_215 ) ||
! F_73 ( V_214 -> V_215 , V_214 -> V_209 ) ||
! F_73 ( V_214 -> V_209 , V_214 -> V_210 ) ||
! F_73 ( V_214 -> V_210 , V_214 -> V_216 ) ||
! F_73 ( V_214 -> V_216 , V_214 -> V_217 ) ||
! F_73 ( V_214 -> V_217 , V_214 -> V_212 ) ||
! F_73 ( V_214 -> V_212 , 0x00ffffff ) )
return - V_50 ;
if ( ! F_74 ( V_214 -> V_212 ) )
return - V_50 ;
return 0 ;
}
int F_76 ( struct V_15 * V_5 , void * V_184 ,
struct V_185 * V_186 )
{
...
if ( V_19 )
goto V_199;
F_77 ( V_219 , V_214 -> V_215 ) ;
F_77 ( V_220 , V_214 -> V_209 ) ;
F_77 ( V_221 , V_214 -> V_210 ) ;
F_77 ( V_222 , V_214 -> V_216 ) ;
F_77 ( V_223 , V_214 -> V_217 ) ;
F_77 ( V_224 , V_214 -> V_212 ) ;
}
}
V_19 = 0 ;
V_199:
...
if ( ! F_79 ( V_5 ) )
return;
V_3 = F_80 ( sizeof( struct V_2 ) , V_192 ) ;
if ( ! V_3 )
return;
F_61 ( & V_5 -> V_115 ) ;
if ( F_13 ( V_4 -> V_3 ) )
...
V_19 = F_83 ( V_8 , V_227 , true , false ) ;
if ( V_19 ) {
F_69 ( L_5 ) ;
goto V_229;
}
...
void F_87 ( struct V_15 * V_5 )
{
T_2 * V_4 = V_5 -> V_6 ;
if ( ! V_4 -> V_3 )
return;
F_8 ( V_4 -> V_3 -> V_23 ) ;
F_71 ( & V_4 -> V_3 -> V_8 -> V_40 ) ;
F_70 ( V_4 -> V_3 ) ;
}
static struct V_1 T_1 *
F_88 ( struct V_2 * V_3 )
...
if ( ! V_7 )
goto V_237;
F_93 ( & error -> V_7 , V_7 , sizeof( struct V_1 ) ) ;
F_90 ( V_3 , V_7 ) ;
return error ;
V_237:
F_70 ( error ) ;
...
void
F_94 ( struct V_238 * V_239 , struct V_232 * error )
{
F_95 ( V_239 , L_8 ,
error -> V_234 , error -> V_235 ) ;
F_95 ( V_239 , L_9 ,
error -> V_40 ) ;
#define F_96 ( T_4 ) seq_printf(m, " " #x ": 0x%08x\n", error->regs.x)
F_96 ( V_135 ) ;
F_96 ( V_240 ) ;
F_96 ( V_141 ) ;
F_96 ( V_142 ) ;
