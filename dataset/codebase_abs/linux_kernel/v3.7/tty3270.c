...
static int F_85 ( struct V_122 * V_123 , struct V_115 * V_116 )
{
struct V_85 * V_12 ;
struct V_1 * V_2 ;
int V_118 , V_52 ;
...
F_78 ( & V_2 -> V_73 , V_116 ) ;
V_2 -> V_11 = V_24 ;
return F_86 ( & V_2 -> V_73 , V_123 , V_116 ) ;
}
...
V_2 -> V_72 -> V_130 [ F_89 ( V_131 ) ] = F_39 ;
V_2 -> V_72 -> V_130 [ F_89 ( V_132 ) ] = F_42 ;
V_2 -> V_72 -> V_130 [ F_89 ( V_133 ) ] = F_41 ;
V_2 -> V_72 -> V_130 [ F_89 ( V_134 ) ] = F_36 ;
F_90 ( V_2 -> V_72 , V_2 -> V_12 . V_30 ) ;
F_91 ( & V_2 -> V_12 ) ;
V_52 = F_86 ( & V_2 -> V_73 , V_123 , V_116 ) ;
if ( V_52 ) {
F_45 ( & V_2 -> V_12 ) ;
return V_52 ;
}
...
static void
F_92 ( struct V_115 * V_116 , struct V_135 * V_136 )
{
...
static void F_95 ( struct V_1 * V_2 , char V_138 )
{
struct V_110 * line ;
struct V_112 * V_139 ;
...
V_148 = F_101 ( int , line -> V_18 - V_2 -> V_141 , V_2 -> V_12 . V_13 - V_2 -> V_141 - V_40 ) ;
while ( V_148 -- )
...
V_2 -> V_141 += V_40 ;
V_2 -> V_141 = F_101 ( int , V_2 -> V_141 , V_2 -> V_12 . V_13 - 1 ) ;
}
static void
F_104 ( struct V_1 * V_2 , int V_149 )
{
struct V_110 * line ;
struct V_112 * V_139 ;
int V_118 ;
...
static inline int
F_107 ( struct V_1 * V_2 , int V_164 )
{
return ( V_2 -> V_160 [ V_164 ] > 0 ) ? V_2 -> V_160 [ V_164 ] : 1 ;
}
static void
F_108 ( struct V_1 * V_2 , int V_141 , int V_140 )
{
int V_165 = F_109 ( 0 , V_141 ) ;
int V_166 = F_109 ( 0 , V_140 ) ;
V_2 -> V_141 = F_101 ( int , V_2 -> V_12 . V_13 - 1 , V_165 ) ;
V_140 = F_101 ( int , V_2 -> V_12 . V_16 - 3 , V_166 ) ;
if ( V_140 != V_2 -> V_140 ) {
F_96 ( V_2 , V_2 -> V_140 ) ;
V_2 -> V_140 = V_140 ;
}
...
static void
F_110 ( struct V_1 * V_2 , char V_138 )
{
...
case 'H' :
case 'f' :
F_108 ( V_2 , F_107 ( V_2 , 1 ) - 1 ,
F_107 ( V_2 , 0 ) - 1 ) ;
break;
case 'd' :
F_108 ( V_2 , V_2 -> V_141 , F_107 ( V_2 , 0 ) - 1 ) ;
break;
case 'A' :
case 'F' :
F_108 ( V_2 , V_2 -> V_141 , V_2 -> V_140 - F_107 ( V_2 , 0 ) ) ;
break;
case 'B' :
case 'e' :
case 'E' :
...
case 'C' :
case 'a' :
F_108 ( V_2 , V_2 -> V_141 + F_107 ( V_2 , 0 ) , V_2 -> V_140 ) ;
break;
case 'D' :
F_108 ( V_2 , V_2 -> V_141 - F_107 ( V_2 , 0 ) , V_2 -> V_140 ) ;
break;
case 'G' :
case '`' :
F_108 ( V_2 , F_107 ( V_2 , 0 ) , V_2 -> V_140 ) ;
break;
case 'X' :
F_103 ( V_2 , F_107 ( V_2 , 0 ) ) ;
break;
case 'J' :
F_105 ( V_2 , V_2 -> V_160 [ 0 ] ) ;
break;
case 'K' :
F_104 ( V_2 , V_2 -> V_160 [ 0 ] ) ;
break;
case 'P' :
F_102 ( V_2 , F_107 ( V_2 , 0 ) ) ;
break;
case '@' :
F_100 ( V_2 , F_107 ( V_2 , 0 ) ) ;
break;
case 's' :
V_2 -> V_172 = V_2 -> V_141 ;
V_2 -> V_173 = V_2 -> V_140 ;
...
static void
F_112 ( struct V_1 * V_2 , struct V_115 * V_116 ,
...
return 0 ;
if ( V_2 -> V_183 > 0 ) {
F_112 ( V_2 , V_116 , V_2 -> V_184 , V_2 -> V_183 ) ;
V_2 -> V_183 = 0 ;
}
F_112 ( V_2 , V_116 , V_178 , V_7 ) ;
return V_7 ;
}
static int F_115 ( struct V_115 * V_116 , unsigned char V_138 )
{
struct V_1 * V_2 ;
V_2 = V_116 -> V_117 ;
...
static void
F_119 ( struct V_115 * V_116 , struct V_186 * V_187 )
{
struct V_1 * V_2 ;
int V_188 ;
V_2 = V_116 -> V_117 ;
...
static void
F_125 ( struct V_115 * V_116 , int V_189 )
{
}
static int F_126 ( struct V_115 * V_116 , unsigned int V_88 ,
unsigned long V_190 )
{
struct V_1 * V_2 ;
V_2 = V_116 -> V_117 ;
...
return - V_94 ;
return F_127 ( V_2 -> V_72 , V_88 , V_190 ) ;
}
static long F_128 ( struct V_115 * V_116 ,
...
if ( V_116 -> V_191 & ( 1 << V_192 ) )
return - V_94 ;
return F_127 ( V_2 -> V_72 , V_88 , ( unsigned long ) F_129 ( V_190 ) ) ;
}
