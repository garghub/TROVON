...
if ( V_7 )
goto V_22;
F_2 ( V_24 , V_21 -> V_23 + V_25 ) ;
F_2 ( V_26 ,
V_21 -> V_23 + V_27 ) ;
F_2 ( V_28 , V_21 -> V_23 + V_27 ) ;
F_2 ( V_29 , V_21 -> V_23 + V_27 ) ;
F_13 ( V_14 ) ;
return 0 ;
V_22:
return V_7 ;
...
{
struct V_19 * V_21 = & V_14 -> V_19 ;
struct V_30 * V_31 = & V_14 -> V_30 ;
T_2 V_32 ;
int V_17 ;
F_7 ( L_2 ) ;
for ( V_17 = 0 ; V_17 <= V_33 / 0x10 + 1 ; V_17 ++ ) {
V_32 = F_4 ( V_21 -> V_23 + V_17 * 0x10 ) ;
F_7 ( L_3 , V_17 * 0x10 , V_32 ) ;
}
F_7 ( L_4 ) ;
F_7 ( L_5 , V_31 -> V_34 ) ;
F_7 ( L_6 , V_31 -> V_35 ) ;
...
if ( F_17 ( V_14 ) ) {
V_2 = V_140 << V_127 ;
V_32 = F_4 ( V_21 -> V_23 + V_33 ) ;
} else if ( F_51 ( V_14 ) || F_34 ( V_14 ) ) {
V_2 = F_52 ( 1 << V_127 ) ;
V_32 = F_4 ( V_21 -> V_23 + V_141 ) ;
} else
F_7 ( L_19 ) ;
return V_32 & V_2 ;
}
