...
static int T_4 F_77 ( struct V_117 * V_118 )
{
...
F_3 ( V_2 , V_134 + V_69 * 4 , 0 ) ;
V_29 = F_1 ( V_2 , V_31 + V_69 * 4 ) ;
F_29 (offset, &events, 32 )
F_3 ( V_2 , V_31 + V_69 * 4 , F_9 ( V_18 ) ) ;
V_2 -> V_24 [ V_69 ] = F_89 ( V_73 , V_69 ) ;
V_2 -> V_47 [ V_69 ] . V_2 = V_2 ;
V_2 -> V_47 [ V_69 ] . V_28 = V_69 ;
F_90 ( & V_2 -> V_50 [ V_69 ] ) ;
V_132 = strlen ( F_91 ( V_2 -> V_11 ) ) + 16 ;
V_85 = F_79 ( V_2 -> V_11 , V_132 , V_81 ) ;
if ( ! V_85 )
return - V_82 ;
snprintf ( V_85 , V_132 , L_20 , F_91 ( V_2 -> V_11 ) , V_69 ) ;
V_96 = F_92 ( V_11 , V_2 -> V_24 [ V_69 ] ,
F_28 , V_135 ,
V_85 , & V_2 -> V_47 [ V_69 ] ) ;
if ( V_96 ) {
...
V_2 -> V_136 = F_94 ( & V_137 , V_11 , V_2 ) ;
if ( ! V_2 -> V_136 ) {
F_95 ( & V_2 -> V_16 ) ;
return - V_52 ;
}
V_2 -> V_138 = V_139 ;
V_2 -> V_138 . V_4 = V_2 -> V_16 . V_4 ;
V_2 -> V_138 . V_140 = & V_2 -> V_16 ;
F_96 ( V_2 -> V_136 , & V_2 -> V_138 ) ;
return 0 ;
}
static int T_5 F_97 ( struct V_117 * V_118 )
{
struct V_1 * V_2 = F_98 ( V_118 ) ;
F_99 ( V_2 -> V_136 ) ;
F_95 ( & V_2 -> V_16 ) ;
return 0 ;
}
