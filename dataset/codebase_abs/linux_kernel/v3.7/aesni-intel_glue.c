...
static void F_48 ( void * V_13 , V_4 * V_37 , unsigned int V_27 )
{
F_30 ( V_13 , V_37 , V_37 , V_27 ) ;
}
static int F_49 ( struct V_10 * V_3 , const V_4 * V_38 ,
unsigned int V_39 )
{
...
if ( V_16 )
return V_16 ;
return F_50 ( & V_13 -> V_42 , V_38 + V_39 - V_33 ) ;
}
static void F_51 ( struct V_10 * V_3 )
{
struct V_40 * V_13 = F_3 ( V_3 ) ;
F_52 ( & V_13 -> V_42 ) ;
}
static int F_53 ( struct V_24 * V_25 , struct V_26 * V_22 ,
...
V_25 -> V_14 &= ~ V_30 ;
F_11 () ;
V_51 = F_54 ( V_25 , V_22 , V_23 , V_27 , & V_45 ) ;
F_13 () ;
return V_51 ;
}
static int F_55 ( struct V_24 * V_25 , struct V_26 * V_22 ,
struct V_26 * V_23 , unsigned int V_27 )
{
struct V_40 * V_13 = F_24 ( V_25 -> V_3 ) ;
T_2 V_43 [ 8 ] ;
...
static int F_56 ( struct V_10 * V_3 , const V_4 * V_38 ,
unsigned int V_39 )
{
...
static void F_57 ( void * V_13 , V_4 * V_55 , const V_4 * V_56 )
{
F_17 ( V_13 , V_55 , V_56 ) ;
}
static int F_58 ( struct V_24 * V_25 , struct V_26 * V_22 ,
struct V_26 * V_23 , unsigned int V_27 )
{
...
V_25 -> V_14 &= ~ V_30 ;
F_11 () ;
V_51 = F_59 ( V_25 , V_22 , V_23 , V_27 , & V_45 ) ;
F_13 () ;
return V_51 ;
}
static int F_60 ( struct V_24 * V_25 , struct V_26 * V_22 ,
struct V_26 * V_23 , unsigned int V_27 )
{
struct V_52 * V_13 = F_24 ( V_25 -> V_3 ) ;
T_2 V_43 [ 8 ] ;
...
static int F_61 ( struct V_10 * V_3 )
{
struct V_60 * V_61 ;
...
static void F_67 ( struct V_10 * V_3 )
{
struct V_1 * V_13 =
(struct V_1 * )
F_2 ( ( V_4 * ) F_3 ( V_3 ) , V_5 ) ;
...
static void
F_69 ( struct V_68 * V_45 , int V_16 )
{
...
static int
F_71 ( V_4 * V_74 , const V_4 * V_38 , unsigned int V_12 )
{
struct V_75 * V_76 ;
struct V_77 * V_45 ;
int V_51 = - V_21 ;
...
if ( ! V_45 )
goto V_80;
V_79 = F_76 ( sizeof( * V_79 ) , V_82 ) ;
if ( ! V_79 )
goto V_83;
memset ( V_79 -> V_34 , 0 , sizeof( V_79 -> V_34 ) ) ;
memset ( V_74 , 0 , V_84 ) ;
F_77 ( & V_79 -> V_70 . V_73 ) ;
F_78 ( & V_79 -> V_85 , V_74 , V_84 ) ;
F_79 ( V_45 , V_76 ) ;
F_80 ( V_45 , V_30 |
V_86 ,
F_69 ,
...
static int F_87 ( struct V_2 * V_88 , const V_4 * V_38 ,
unsigned int V_12 )
{
int V_51 = 0 ;
struct V_10 * V_3 = F_4 ( V_88 ) ;
struct V_1 * V_13 = F_1 ( V_88 ) ;
struct V_2 * V_62 = F_65 ( V_13 -> V_61 ) ;
struct V_1 * V_63 =
F_1 ( V_62 ) ;
V_4 * V_89 , * V_90 = NULL ;
if ( V_12 < 4 ) {
...
V_51 = F_71 ( V_13 -> V_74 , V_38 , V_12 ) ;
memcpy ( V_63 , V_13 , sizeof( * V_13 ) ) ;
exit:
F_84 ( V_90 ) ;
return V_51 ;
}
static int F_89 ( struct V_2 * V_88 ,
unsigned int V_94 )
{
struct V_1 * V_13 = F_1 ( V_88 ) ;
struct V_2 * V_62 = F_65 ( V_13 -> V_61 ) ;
...
static int F_91 ( struct V_66 * V_45 )
{
int V_51 ;
struct V_2 * V_3 = F_92 ( V_45 ) ;
struct V_1 * V_13 = F_1 ( V_3 ) ;
if ( ! F_9 () ) {
struct V_66 * V_95 =
(struct V_66 * ) F_93 ( V_45 ) ;
memcpy ( V_95 , V_45 , sizeof( * V_45 ) ) ;
F_94 ( V_95 , & V_13 -> V_61 -> V_67 ) ;
return F_95 ( V_95 ) ;
} else {
struct V_2 * V_62 = F_65 ( V_13 -> V_61 ) ;
F_11 () ;
...
static int F_96 ( struct V_66 * V_45 )
{
int V_51 ;
struct V_2 * V_3 = F_92 ( V_45 ) ;
struct V_1 * V_13 = F_1 ( V_3 ) ;
...
static int F_98 ( struct V_66 * V_45 )
{
V_4 V_98 = 0 ;
V_4 * V_23 , * V_22 , * V_99 ;
T_3 V_100 = F_99 ( 1 ) ;
...
struct V_103 V_106 ;
unsigned int V_107 ;
if ( F_101 ( V_45 -> V_108 != 8 && V_45 -> V_108 != 12 ) )
return - V_21 ;
...
* ( ( T_3 * ) ( V_34 + 12 ) ) = V_100 ;
if ( ( F_102 ( V_45 -> V_23 ) ) && ( F_102 ( V_45 -> V_99 ) ) ) {
V_98 = 1 ;
F_103 ( & V_104 , V_45 -> V_23 ) ;
F_103 ( & V_105 , V_45 -> V_99 ) ;
V_23 = F_104 ( & V_104 ) ;
V_99 = F_104 ( & V_105 ) ;
V_22 = V_23 ;
if ( F_101 ( V_45 -> V_23 != V_45 -> V_22 ) ) {
F_103 ( & V_106 , V_45 -> V_22 ) ;
V_22 = F_104 ( & V_106 ) ;
}
} else {
V_23 = F_76 ( V_45 -> V_109 + V_101 + V_45 -> V_108 ,
V_110 ) ;
if ( F_101 ( ! V_23 ) )
return - V_81 ;
V_99 = ( V_23 + V_45 -> V_109 + V_101 ) ;
F_105 ( V_23 , V_45 -> V_23 , 0 , V_45 -> V_109 , 0 ) ;
F_105 ( V_99 , V_45 -> V_99 , 0 ,
V_45 -> V_108 , 0 ) ;
V_22 = V_23 ;
}
F_106 ( F_5 , V_22 , V_23 , ( unsigned long ) V_45 -> V_109 , V_34 ,
...
F_105 ( V_22 , V_45 -> V_22 , 0 ,
V_45 -> V_109 + V_101 , 1 ) ;
F_84 ( V_23 ) ;
}
return 0 ;
}
static int F_109 ( struct V_66 * V_45 )
{
V_4 V_98 = 0 ;
V_4 * V_23 , * V_22 , * V_99 ;
...
V_23 = F_76 ( V_45 -> V_109 + V_45 -> V_108 , V_110 ) ;
if ( ! V_23 )
return - V_81 ;
V_99 = ( V_23 + V_45 -> V_109 + V_101 ) ;
F_105 ( V_23 , V_45 -> V_23 , 0 , V_45 -> V_109 , 0 ) ;
...
F_110 ( F_5 , V_22 , V_23 , V_111 , V_34 ,
...
F_105 ( V_22 , V_45 -> V_22 , 0 , V_45 -> V_109 , 1 ) ;
F_84 ( V_23 ) ;
}
return V_112 ;
}
...
if ( V_16 )
return V_16 ;
return F_114 ( V_118 , F_115 ( V_118 ) ) ;
}
static void T_5 F_116 ( void )
{
F_117 ( V_118 , F_115 ( V_118 ) ) ;
F_118 () ;
}
