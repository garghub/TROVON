...
static T_4
F_33 ( struct V_38 * V_34 ,
struct V_91 * V_92 , char * V_4 )
{
...
return - V_83 ;
return F_11 ( F_16 ( V_34 ) , V_30 ) ? - V_23 : V_93 ;
}
static int
F_37 ( struct V_1 * V_2 , const struct V_94 * V_95 )
{
int V_96 = 0 ;
struct V_97 * V_98 ;
if ( ! F_38 ( V_2 -> V_14 , V_99 ) )
return - V_20 ;
if ( F_5 ( V_2 ) < 0 )
return - V_20 ;
F_39 ( & V_2 -> V_34 ,
L_30 V_100 L_31 ) ;
if ( V_2 -> V_84 > 0 ) {
V_96 = F_40 ( V_2 -> V_84 , NULL ,
F_29 ,
V_101 ,
V_102 . V_103 . V_104 , V_2 ) ;
if ( ! V_96 ) {
F_41 ( & V_2 -> V_34 , 1 ) ;
F_42 ( V_2 -> V_84 ) ;
} else {
...
F_47 ( & V_2 -> V_34 , L_34
L_35 ) ;
V_96 = F_48 ( & V_2 -> V_34 . V_109 , & V_110 ) ;
if ( V_96 )
goto V_108;
return 0 ;
V_108:
...
F_51 ( struct V_1 * V_2 )
{
struct V_97 * V_98 = F_52 ( V_2 ) ;
F_53 ( & V_2 -> V_34 . V_109 , & V_110 ) ;
F_49 ( V_98 ) ;
if ( V_2 -> V_84 )
F_50 ( V_2 -> V_84 , V_2 ) ;
return 0 ;
