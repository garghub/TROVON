...
int error ;
error = F_111 ( V_2 , V_155 -> V_172 ) ;
if ( error )
return error ;
F_112 ( V_2 , V_155 -> V_172 ) ;
}
F_113 ( V_2 , V_155 ) ;
F_114 ( V_2 ) ;
return 0 ;
}
static void * F_115 ( struct V_4 * V_4 , struct V_186 * V_187 )
{
char * V_19 = F_11 () ;
if ( V_19 ) {
char * V_188 = F_10 ( V_4 ) ;
...
static void F_117 ( struct V_4 * V_4 , struct V_186 * V_187 , void * V_190 )
{
char * V_17 = F_118 ( V_187 ) ;
if ( ! F_7 ( V_17 ) )
F_8 ( V_17 ) ;
}
static int F_119 ( struct V_27 * V_28 , void * V_191 , int V_192 )
{
struct V_2 * V_193 ;
...
static struct V_4 * F_122 ( struct V_206 * type ,
int V_88 , const char * V_207 ,
void * V_208 )
{
return F_123 ( type , V_88 , V_208 , F_119 ) ;
}
