...
V_117 = F_101 ( V_17 , V_112 . V_138 ) ;
break;
case V_130 :
V_117 = - V_79 ;
if ( F_89 ( sin -> V_135 . V_136 ) < 0 )
break;
if ( ! V_7 ) {
V_117 = - V_80 ;
V_7 = F_22 () ;
...
static int F_106 ( struct V_12 * V_17 , char T_4 * V_142 , int V_143 )
{
struct V_29 * V_39 = F_66 ( V_17 ) ;
struct V_6 * V_7 ;
struct V_111 V_112 ;
...
V_7 -> V_9 ;
if ( F_105 ( V_142 , & V_112 , sizeof( struct V_111 ) ) ) {
V_134 = - V_118 ;
break;
}
...
T_2 F_107 ( const struct V_12 * V_17 , T_2 V_144 , int V_145 )
{
T_2 V_2 = 0 ;
struct V_29 * V_39 ;
...
static T_2 F_110 ( struct V_29 * V_39 , T_2 V_144 ,
T_2 V_25 , int V_145 )
{
int V_149 = 0 ;
T_2 V_2 = 0 ;
...
if ( ! V_149 ) {
V_149 = ( ! V_25 || F_54 ( V_25 , V_7 ) ) &&
( ! V_144 || F_54 ( V_144 , V_7 ) ) ;
if ( V_149 && V_2 ) {
if ( V_25 || ! V_144 )
break;
if ( F_54 ( V_2 , V_7 ) )
...
T_2 V_144 , T_2 V_25 , int V_145 )
{
T_2 V_2 = 0 ;
struct V_12 * V_17 ;
struct V_1 * V_1 ;
if ( V_145 != V_148 )
return F_110 ( V_39 , V_144 , V_25 , V_145 ) ;
V_1 = F_14 ( V_39 -> V_17 ) ;
F_11 () ;
F_109 (net, dev) {
V_39 = F_108 ( V_17 ) ;
if ( V_39 ) {
V_2 = F_110 ( V_39 , V_144 , V_25 , V_145 ) ;
if ( V_2 )
break;
}
}
...
int F_115 ( struct V_150 * V_151 )
{
return F_116 ( & V_72 , V_151 ) ;
}
...
static bool F_118 ( unsigned int V_156 )
{
return V_156 >= 68 ;
}
...
static int F_121 ( struct V_150 * V_160 , unsigned long V_161 ,
void * V_162 )
{
...
T_1 V_58 , T_1 V_177 , int V_161 , unsigned int V_49 )
{
struct V_92 * V_93 ;
struct V_56 * V_57 ;
V_57 = F_133 ( V_86 , V_58 , V_177 , V_161 , sizeof( * V_93 ) , V_49 ) ;
if ( V_57 == NULL )
return - V_178 ;
V_93 = F_76 ( V_57 ) ;
V_93 -> V_179 = V_126 ;
...
static int F_138 ( struct V_85 * V_86 , struct V_182 * V_183 )
{
struct V_1 * V_1 = F_74 ( V_86 -> V_88 ) ;
int V_184 , V_185 ;
int V_186 , V_187 ;
...
static void F_58 ( int V_161 , struct V_6 * V_7 , struct V_56 * V_57 ,
T_1 V_58 )
{
struct V_85 * V_86 ;
T_1 V_177 = V_57 ? V_57 -> V_194 : 0 ;
int V_94 = - V_80 ;
struct V_1 * V_1 ;
...
if ( V_86 == NULL )
goto V_96;
V_94 = F_132 ( V_86 , V_7 , V_58 , V_177 , V_161 , 0 ) ;
if ( V_94 < 0 ) {
F_31 ( V_94 == - V_178 ) ;
F_140 ( V_86 ) ;
goto V_96;
}
F_141 ( V_86 , V_1 , V_58 , V_196 , V_57 , V_31 ) ;
return;
V_96:
if ( V_94 < 0 )
F_142 ( V_1 , V_196 , V_94 ) ;
}
...
if ( ! V_39 )
return - V_200 ;
V_198 = F_145 ( V_86 , V_201 , V_197 * 4 ) ;
if ( V_198 == NULL )
return - V_178 ;
for ( V_199 = 0 ; V_199 < V_197 ; V_199 ++ )
( ( T_1 * ) F_146 ( V_198 ) ) [ V_199 ] = V_39 -> V_41 . V_202 [ V_199 ] ;
return 0 ;
}
...
if ( V_17 && ! F_66 ( V_17 ) )
return - V_205 ;
V_94 = F_148 ( V_90 , V_203 , V_198 , V_206 ) ;
if ( V_94 < 0 )
return V_94 ;
if ( V_90 [ V_201 ] ) {
F_149 (a, tb[IFLA_INET_CONF], rem) {
int V_207 = F_150 ( V_52 ) ;
if ( F_151 ( V_52 ) < 4 )
return - V_79 ;
...
static int F_152 ( struct V_12 * V_17 , const struct V_89 * V_198 )
{
struct V_29 * V_39 = F_66 ( V_17 ) ;
struct V_89 * V_52 , * V_90 [ V_203 + 1 ] ;
int V_204 ;
if ( ! V_39 )
return - V_205 ;
if ( F_148 ( V_90 , V_203 , V_198 , NULL ) < 0 )
F_153 () ;
if ( V_90 [ V_201 ] ) {
F_149 (a, tb[IFLA_INET_CONF], rem)
...
static void F_156 ( struct V_1 * V_1 , int V_199 )
{
struct V_12 * V_17 ;
F_11 () ;
F_109 (net, dev) {
struct V_29 * V_39 ;
V_39 = F_108 ( V_17 ) ;
if ( V_39 && ! F_157 ( V_199 , V_39 -> V_41 . V_208 ) )
...
{
struct V_12 * V_17 ;
int V_209 = F_159 ( V_1 , V_48 ) ;
F_159 ( V_1 , V_210 ) = ! V_209 ;
F_160 ( V_1 , V_48 ) = V_209 ;
F_161 (net, dev) {
struct V_29 * V_39 ;
if ( V_209 )
F_40 ( V_17 ) ;
...
static int F_166 ( T_6 * V_211 , int V_212 ,
void T_4 * V_213 ,
T_5 * V_214 , T_7 * V_215 )
{
...
static int F_169 ( T_6 * V_211 , int V_212 ,
void T_4 * V_213 ,
T_5 * V_214 , T_7 * V_215 )
{
int * V_223 = V_211 -> V_202 ;
...
static int F_170 ( struct V_1 * V_1 , char * V_225 ,
struct V_218 * V_226 )
{
int V_199 ;
struct V_227 * V_228 ;
char V_229 [ sizeof( L_6 ) + V_107 ] ;
V_228 = F_171 ( & V_230 , sizeof( * V_228 ) , V_31 ) ;
if ( ! V_228 )
goto V_40;
for ( V_199 = 0 ; V_199 < F_172 ( V_228 -> V_231 ) - 1 ; V_199 ++ ) {
...
V_228 -> V_232 = F_173 ( V_1 , V_229 , V_228 -> V_231 ) ;
if ( ! V_228 -> V_232 )
goto free;
V_226 -> V_44 = V_228 ;
return 0 ;
...
static void F_20 ( struct V_29 * V_30 )
{
F_176 ( V_30 -> V_17 , V_30 -> V_45 , L_8 , NULL ) ;
F_170 ( F_14 ( V_30 -> V_17 ) , V_30 -> V_17 -> V_37 ,
& V_30 -> V_41 ) ;
}
static void F_21 ( struct V_29 * V_30 )
{
...
V_234 = & V_239 ;
if ( ! F_13 ( V_1 , & V_240 ) ) {
V_233 = F_171 ( V_233 , sizeof( V_218 ) , V_31 ) ;
if ( V_233 == NULL )
goto V_241;
V_234 = F_171 ( V_234 , sizeof( V_239 ) , V_31 ) ;
if ( V_234 == NULL )
goto V_242;
#ifdef F_179
V_235 = F_171 ( V_235 , sizeof( V_236 ) , V_31 ) ;
if ( V_235 == NULL )
goto V_243;
...
#ifdef F_179
V_94 = F_170 ( V_1 , L_9 , V_233 ) ;
if ( V_94 < 0 )
goto V_245;
V_94 = F_170 ( V_1 , L_10 , V_234 ) ;
if ( V_94 < 0 )
goto V_246;
V_94 = - V_164 ;
V_238 = F_173 ( V_1 , L_11 , V_235 ) ;
if ( V_238 == NULL )
goto V_247;
...
{
int V_199 ;
for ( V_199 = 0 ; V_199 < V_250 ; V_199 ++ )
F_182 ( & V_11 [ V_199 ] ) ;
F_183 ( & V_251 ) ;
F_184 ( V_252 , F_106 ) ;
F_185 ( & V_253 ) ;
F_186 ( & V_254 ) ;
F_187 ( V_252 , V_75 , F_86 , NULL , NULL ) ;
F_187 ( V_252 , V_71 , F_73 , NULL , NULL ) ;
F_187 ( V_252 , V_255 , NULL , F_138 , NULL ) ;
}
