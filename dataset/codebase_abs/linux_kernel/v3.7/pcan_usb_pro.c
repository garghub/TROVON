...
if ( ! V_108 )
return - V_113 ;
V_106 -> V_114 = F_13 ( V_104 -> V_13 ) ;
V_106 -> V_115 = V_104 -> V_14 & 0x0f ;
if ( V_104 -> V_116 & V_117 )
V_106 -> V_114 |= V_118 ;
if ( V_104 -> V_116 & V_119 )
V_106 -> V_114 |= V_120 ;
else
memcpy ( V_106 -> V_121 , V_104 -> V_121 , V_106 -> V_115 ) ;
F_39 ( & V_102 -> V_122 , F_13 ( V_104 -> V_123 ) , & V_110 ) ;
V_112 = F_40 ( V_108 ) ;
V_112 -> V_124 = F_41 ( V_110 ) ;
F_42 ( V_108 ) ;
V_42 -> V_125 . V_126 ++ ;
V_42 -> V_125 . V_127 += V_106 -> V_115 ;
return 0 ;
}
static int F_43 ( struct V_101 * V_102 ,
struct V_128 * V_129 )
{
const V_21 V_130 = F_13 ( V_129 -> V_131 ) ;
const unsigned int V_75 = ( V_129 -> V_55 >> 4 ) & 0x0f ;
struct V_32 * V_33 = V_102 -> V_33 [ V_75 ] ;
struct V_105 * V_42 = V_33 -> V_42 ;
struct V_106 * V_106 ;
...
struct V_109 V_110 ;
struct V_111 * V_112 ;
if ( V_33 -> V_86 . V_37 == V_136 )
return 0 ;
if ( ! V_130 ) {
V_33 -> V_86 . V_37 = V_134 ;
return 0 ;
}
if ( V_130 & ( V_137 |
V_138 ) ) {
...
V_21 V_142 = ( F_13 ( V_129 -> V_143 ) & 0x00ff0000 ) >> 16 ;
V_21 V_144 = ( F_13 ( V_129 -> V_143 ) & 0xff000000 ) >> 24 ;
if ( V_142 > 127 )
V_135 |= V_145 ;
else if ( V_142 > 96 )
V_135 |= V_146 ;
...
if ( V_33 -> V_86 . V_37 == V_133 )
return 0 ;
V_108 = F_44 ( V_42 , & V_106 ) ;
if ( ! V_108 )
return - V_113 ;
switch ( V_133 ) {
case V_136 :
...
V_106 -> V_114 |= V_152 ;
V_106 -> V_121 [ 1 ] |= V_135 ;
V_33 -> V_86 . V_153 . V_154 ++ ;
break;
case V_149 :
V_106 -> V_114 |= V_152 ;
V_106 -> V_121 [ 1 ] |= V_135 ;
V_33 -> V_86 . V_153 . V_155 ++ ;
break;
case V_134 :
break;
default:
...
V_33 -> V_86 . V_37 = V_133 ;
F_39 ( & V_102 -> V_122 , F_13 ( V_129 -> V_123 ) , & V_110 ) ;
V_112 = F_40 ( V_108 ) ;
V_112 -> V_124 = F_41 ( V_110 ) ;
F_42 ( V_108 ) ;
V_42 -> V_125 . V_126 ++ ;
...
static int F_48 ( struct V_32 * V_33 , struct V_94 * V_94 )
{
...
V_27 V_12 ;
int V_36 = 0 ;
V_10 = F_1 ( & V_165 , V_94 -> V_167 ,
V_94 -> V_35 ) ;
if ( ! V_10 ) {
F_10 ( V_42 , L_11 , V_94 -> V_35 ) ;
return - V_168 ;
}
V_166 = V_94 -> V_167 + V_94 -> V_35 ;
V_12 = F_49 ( * V_165 . V_6 . V_169 ) ;
for (; V_12 > 0 ; V_12 -- ) {
union V_47 * V_11 = (union V_47 * ) V_10 ;
V_27 V_170 = V_52 [ V_11 -> V_53 ] ;
if ( ! V_170 ) {
F_10 ( V_42 ,
L_12 ) ;
V_36 = - V_171 ;
...
case V_174 :
case V_175 :
V_36 = F_37 ( V_102 , & V_11 -> V_176 ) ;
if ( V_36 < 0 )
goto V_177;
break;
case V_178 :
V_36 = F_43 ( V_102 , & V_11 -> V_179 ) ;
if ( V_36 < 0 )
goto V_177;
break;
case V_180 :
F_46 ( V_102 , & V_11 -> V_181 ) ;
break;
default:
F_10 ( V_42 ,
L_14 ,
...
if ( V_36 )
F_14 ( L_15 ,
V_94 -> V_167 , V_94 -> V_35 ) ;
return V_36 ;
}
static int F_50 ( struct V_32 * V_33 ,
struct V_107 * V_108 , T_1 * V_182 , T_3 * V_183 )
{
struct V_106 * V_184 = (struct V_106 * ) V_108 -> V_121 ;
T_1 V_53 , V_14 , V_116 ;
struct V_1 V_165 ;
F_2 ( & V_165 , V_182 , * V_183 ) ;
if ( ( V_184 -> V_114 & V_120 ) || ( V_184 -> V_115 == 0 ) )
V_53 = V_20 ;
else if ( V_184 -> V_115 <= 4 )
V_53 = V_19 ;
else
V_53 = V_18 ;
V_14 = ( V_33 -> V_75 << 4 ) | ( V_184 -> V_115 & 0x0f ) ;
V_116 = 0 ;
if ( V_184 -> V_114 & V_118 )
V_116 |= 0x02 ;
if ( V_184 -> V_114 & V_120 )
V_116 |= 0x01 ;
F_3 ( & V_165 , V_53 , 0 , V_116 , V_14 , V_184 -> V_114 ,
V_184 -> V_121 ) ;
* V_183 = V_165 . V_9 ;
return 0 ;
}
...
int V_36 ;
V_36 = F_24 ( V_33 ,
V_33 -> V_86 . V_87 & V_185 ) ;
if ( V_36 )
return V_36 ;
V_36 = F_25 ( V_33 , 1 ) ;
if ( V_36 )
return V_36 ;
if ( V_74 -> V_102 -> V_186 == 0 ) {
F_52 ( & V_74 -> V_102 -> V_122 , & V_187 ) ;
V_36 = F_20 ( V_33 , 1 ) ;
}
V_74 -> V_102 -> V_186 ++ ;
return V_36 ;
...
struct V_191 V_192 ;
int V_36 ;
V_102 = F_55 ( sizeof( struct V_101 ) ,
V_193 ) ;
if ( ! V_102 )
return - V_113 ;
V_102 -> V_163 = 5 ;
V_36 = F_15 ( V_33 , V_194 ,
V_195 ,
& V_190 , sizeof( V_190 ) ) ;
if ( V_36 ) {
F_56 ( V_102 ) ;
F_57 ( V_33 -> V_42 -> V_33 . V_196 ,
L_16 ,
V_187 . V_197 , V_36 ) ;
return V_36 ;
}
...
F_58 ( V_33 -> V_42 -> V_33 . V_196 ,
L_18 ,
V_187 . V_197 ,
V_192 . V_199 , V_192 . V_200 , V_192 . V_201 ,
V_187 . V_202 ) ;
F_35 ( V_33 , 1 ) ;
} else {
V_102 = F_36 ( V_33 -> V_188 ) ;
}
V_74 -> V_102 = V_102 ;
...
{
if ( ! V_33 -> V_188 && ! V_33 -> V_204 )
F_56 ( F_36 ( V_33 ) ) ;
}
static int F_61 ( struct V_205 * V_206 )
{
struct V_207 * V_208 ;
int V_15 ;
V_208 = V_206 -> V_209 ;
for ( V_15 = 0 ; V_15 < V_208 -> V_210 . V_211 ; V_15 ++ ) {
struct V_212 * V_213 = & V_208 -> V_214 [ V_15 ] . V_210 ;
switch ( V_213 -> V_215 ) {
case V_40 :
case V_50 :
case V_216 :
