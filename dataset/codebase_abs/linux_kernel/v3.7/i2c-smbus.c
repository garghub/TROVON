...
int V_32 ;
V_12 = F_16 ( & V_18 -> V_2 , sizeof( struct V_17 ) ,
V_33 ) ;
if ( ! V_12 )
return - V_34 ;
V_12 -> V_22 = V_29 -> V_22 ;
...
static int F_21 ( struct V_4 * V_18 )
{
struct V_17 * V_12 = F_22 ( V_18 ) ;
F_23 ( & V_12 -> V_12 ) ;
return 0 ;
}
struct V_4 * F_24 ( struct V_31 * V_21 ,
struct V_28 * V_29 )
{
struct V_35 V_36 = {
F_25 ( L_6 , 0x0c ) ,
...
return F_26 ( V_21 , & V_36 ) ;
}
int F_27 ( struct V_4 * V_18 )
{
struct V_17 * V_12 = F_22 ( V_18 ) ;
