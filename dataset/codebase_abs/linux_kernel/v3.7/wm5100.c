...
static T_3 int F_71 ( struct V_166 * V_167 ,
const struct V_274 * V_98 )
{
struct V_275 * V_18 = F_72 ( & V_167 -> V_10 ) ;
struct V_4 * V_5 ;
unsigned int V_38 ;
int V_57 , V_8 , V_276 ;
V_5 = F_73 ( & V_167 -> V_10 , sizeof( struct V_4 ) ,
V_277 ) ;
if ( V_5 == NULL )
return - V_278 ;
V_5 -> V_10 = & V_167 -> V_10 ;
V_5 -> V_20 = F_74 ( V_167 , & V_279 ) ;
if ( F_75 ( V_5 -> V_20 ) ) {
V_57 = F_76 ( V_5 -> V_20 ) ;
F_4 ( & V_167 -> V_10 , L_79 ,
V_57 ) ;
...
F_81 ( & V_167 -> V_10 , L_89 , V_5 -> V_289 + 'A' ) ;
V_57 = F_10 ( V_5 ) ;
if ( V_57 < 0 ) {
F_4 ( & V_167 -> V_10 , L_90 ) ;
goto V_287;
...
V_57 = F_83 ( V_167 -> V_197 , NULL ,
F_53 , V_276 ,
L_92 , V_5 ) ;
else
V_57 = F_83 ( V_167 -> V_197 , NULL , F_51 ,
V_276 , L_92 ,
V_5 ) ;
if ( V_57 != 0 ) {
F_4 ( & V_167 -> V_10 , L_93 ,
...
static T_4 int F_90 ( struct V_166 * V_167 )
{
struct V_4 * V_5 = F_60 ( V_167 ) ;
F_91 ( & V_167 -> V_10 ) ;
if ( V_167 -> V_197 )
...
static int F_92 ( struct V_312 * V_10 )
{
...
static int F_96 ( struct V_312 * V_10 )
{
struct V_4 * V_5 = F_93 ( V_10 ) ;
int V_57 ;
V_57 = F_80 ( F_3 ( V_5 -> V_281 ) ,
