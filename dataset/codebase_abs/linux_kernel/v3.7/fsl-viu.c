...
int F_48 ( struct V_69 * V_69 , void * V_70 , const struct V_110 * V_111 )
{
struct V_44 * V_45 = V_70 ;
struct V_7 * V_8 = V_45 -> V_8 ;
...
static T_4 F_89 ( struct V_69 * V_69 , char T_5 * V_39 , T_6 V_42 ,
T_7 * V_201 )
{
...
static unsigned int F_91 ( struct V_69 * V_69 , struct V_202 * V_203 )
{
struct V_44 * V_45 = V_69 -> V_191 ;
...
static int F_99 ( struct V_69 * V_69 , struct V_208 * V_209 )
{
struct V_44 * V_45 = V_69 -> V_191 ;
struct V_7 * V_8 = V_45 -> V_8 ;
int V_94 ;
...
static int T_8 F_101 ( struct V_212 * V_213 )
{
struct V_7 * V_7 ;
struct V_182 * V_135 ;
struct V_214 V_215 ;
...
struct V_217 * V_218 ;
int V_94 , V_219 ;
V_94 = F_102 ( V_213 -> V_8 . V_220 , 0 , & V_215 ) ;
if ( V_94 ) {
F_103 ( & V_213 -> V_8 , L_47 ) ;
return - V_221 ;
}
V_219 = F_104 ( V_213 -> V_8 . V_220 , 0 ) ;
if ( V_219 == V_222 ) {
F_103 ( & V_213 -> V_8 , L_48 ) ;
return - V_58 ;
}
if ( ! F_105 ( & V_213 -> V_8 , V_215 . V_223 ,
sizeof( struct V_9 ) , V_224 ) ) {
F_103 ( & V_213 -> V_8 , L_49 ) ;
V_94 = - V_185 ;
goto V_106;
}
V_216 = F_106 ( & V_213 -> V_8 , V_215 . V_223 , sizeof( struct V_9 ) ) ;
if ( ! V_216 ) {
F_103 ( & V_213 -> V_8 , L_50 ) ;
V_94 = - V_190 ;
goto V_106;
}
V_7 = F_107 ( & V_213 -> V_8 , sizeof( struct V_7 ) , V_225 ) ;
if ( ! V_7 ) {
F_103 ( & V_213 -> V_8 , L_51 ) ;
V_94 = - V_190 ;
goto V_106;
}
V_7 -> V_10 = V_216 ;
...
V_94 = F_109 ( V_7 -> V_8 , & V_7 -> V_226 ) ;
if ( V_94 < 0 ) {
F_103 ( & V_213 -> V_8 , L_54 , V_94 ) ;
goto V_106;
}
V_218 = F_110 ( 0 ) ;
V_7 -> V_227 = F_111 ( & V_7 -> V_226 , V_218 ,
L_55 , V_228 , NULL ) ;
...
F_115 ( V_7 -> V_135 , V_7 ) ;
F_92 ( & V_7 -> V_187 ) ;
V_94 = F_116 ( V_7 -> V_135 , V_232 , - 1 ) ;
if ( V_94 < 0 ) {
F_117 ( V_7 -> V_135 ) ;
goto V_230;
}
V_7 -> V_233 = F_118 ( & V_213 -> V_8 , L_56 ) ;
if ( F_119 ( V_7 -> V_233 ) ) {
F_103 ( & V_213 -> V_8 , L_57 ) ;
V_94 = - V_221 ;
goto V_234;
} else {
F_120 ( V_7 -> V_233 ) ;
...
F_98 ( V_7 -> V_10 ) ;
if ( F_121 ( V_7 -> V_168 , F_80 , 0 , L_20 , ( void * ) V_7 ) ) {
F_103 ( & V_213 -> V_8 , L_58 ) ;
V_94 = - V_221 ;
goto V_235;
}
F_86 ( & V_7 -> V_187 ) ;
F_122 ( & V_213 -> V_8 , L_59 ) ;
return V_94 ;
V_235:
F_123 ( V_7 -> V_233 ) ;
F_124 ( V_7 -> V_233 ) ;
...
static int T_10 F_129 ( struct V_212 * V_213 )
{
struct V_236 * V_226 = F_130 ( & V_213 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_226 , struct V_7 , V_226 ) ;
struct V_237 * V_238 = F_9 ( V_226 -> V_239 . V_25 ,
struct V_237 , V_240 ) ;
struct V_241 * V_242 = F_131 ( V_238 ) ;
F_132 ( V_8 -> V_168 , ( void * ) V_8 ) ;
F_128 ( V_8 -> V_168 ) ;
F_123 ( V_8 -> V_233 ) ;
F_124 ( V_8 -> V_233 ) ;
F_125 ( V_8 -> V_135 ) ;
...
static int F_133 ( struct V_212 * V_213 , T_11 V_28 )
{
struct V_236 * V_226 = F_130 ( & V_213 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_226 , struct V_7 , V_226 ) ;
F_123 ( V_8 -> V_233 ) ;
...
static int F_134 ( struct V_212 * V_213 )
{
struct V_236 * V_226 = F_130 ( & V_213 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_226 , struct V_7 , V_226 ) ;
F_120 ( V_8 -> V_233 ) ;
