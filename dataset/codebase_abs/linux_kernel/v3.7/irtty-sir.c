...
static int F_26 ( struct V_6 * V_5 , struct V_45 * V_45 , unsigned int V_46 , unsigned long V_47 )
{
...
switch ( V_46 ) {
case V_52 :
V_51 = F_27 ( V_2 , ( V_53 ) V_47 ) ;
break;
case V_54 :
F_2 (dev->netdev != NULL, return -1;) ;
memset ( & V_50 , 0 , sizeof( V_50 ) ) ;
strncpy ( V_50 . V_49 , V_2 -> V_55 -> V_49 , sizeof( V_50 . V_49 ) - 1 ) ;
if ( F_28 ( ( void V_56 * ) V_47 , & V_50 , sizeof( V_50 ) ) )
V_51 = - V_57 ;
break;
default:
V_51 = F_29 ( V_5 , V_45 , V_46 , V_47 ) ;
break;
}
return V_51 ;
}
static int F_30 ( struct V_6 * V_5 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 ;
int V_58 = 0 ;
...
F_31 ( V_5 ) ;
V_61 . V_62 = V_62 ;
V_2 = F_32 ( & V_61 , V_5 -> V_49 ) ;
if ( ! V_2 ) {
V_58 = - V_63 ;
goto V_60;
}
V_4 = F_33 ( sizeof( * V_4 ) , V_64 ) ;
if ( ! V_4 ) {
V_58 = - V_65 ;
goto V_66;
}
...
static void F_35 ( struct V_6 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_35 ;
F_2 (priv != NULL, return;) ;
F_2 (priv->magic == IRTTY_MAGIC, return;) ;
