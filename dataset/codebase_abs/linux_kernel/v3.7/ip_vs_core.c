...
struct V_81 * V_41 ;
struct V_39 * V_40 ;
unsigned int V_108 , V_185 , V_124 , V_141 ;
bool V_186 ;
* V_146 = 1 ;
if ( F_77 ( F_59 ( V_15 ) ) ) {
if ( F_56 ( V_15 , F_55 ( V_110 ) ) )
...
V_108 += V_150 -> V_124 * 4 ;
F_19 ( V_132 , V_150 , & V_127 ) ;
V_13 = V_41 -> V_87 ( V_132 , V_15 , & V_127 , V_108 , V_186 ? 0 : 1 ) ;
if ( ! V_13 )
return V_102 ;
V_141 = V_91 ;
if ( ! F_72 ( V_15 ) && F_52 ( V_15 , V_124 ) ) {
...
if ( V_186 ) {
T_6 V_188 = V_148 -> V_189 . V_190 ;
if ( V_148 -> type == V_106 &&
V_148 -> V_191 == V_192 ) {
struct V_16 * V_17 = V_13 -> V_17 ;
T_7 V_193 = F_24 ( V_148 -> V_189 . V_194 . V_193 ) ;
F_102 ( V_15 , V_124 + sizeof( V_147 ) ) ;
V_185 -= V_124 + sizeof( V_147 ) ;
F_103 ( V_15 ) ;
F_27 ( 12 , L_37 ,
& F_59 ( V_15 ) -> V_67 , & F_59 ( V_15 ) -> V_69 , V_193 ) ;
F_104 () ;
F_105 ( V_15 , F_45 ( V_15 -> V_85 ) ,
V_193 , 0 , 0 , 0 , 0 ) ;
F_106 () ;
if ( ! ( V_150 -> V_154 & F_81 ( V_195 ) ) )
goto V_196;
if ( V_17 ) {
F_107 ( & V_17 -> V_197 ) ;
if ( V_17 -> V_198 )
V_193 = F_108 ( V_17 -> V_198 ) ;
F_109 ( & V_17 -> V_197 ) ;
}
if ( V_193 > 68 + sizeof( struct V_122 ) )
V_193 -= sizeof( struct V_122 ) ;
V_188 = F_18 ( V_193 ) ;
}
F_102 ( V_15 , V_185 ) ;
F_103 ( V_15 ) ;
F_27 ( 12 , L_38 ,
& F_59 ( V_15 ) -> V_67 , & F_59 ( V_15 ) -> V_69 ,
V_148 -> type , V_148 -> V_191 , F_110 ( V_188 ) ) ;
F_48 ( V_15 , V_148 -> type , V_148 -> V_191 , V_188 ) ;
F_11 ( V_13 , V_15 ) ;
V_196:
F_111 ( V_15 ) ;
V_141 = V_151 ;
...
V_108 += 2 * sizeof( V_143 ) ;
V_141 = F_112 ( V_15 , V_13 , V_41 , V_108 , V_110 ) ;
V_142:
F_35 ( V_13 ) ;
return V_141 ;
}
static int
F_113 ( struct V_14 * V_15 , int * V_146 , unsigned int V_110 )
{
struct V_36 * V_36 = NULL ;
struct V_133 * V_58 ;
struct V_134 V_147 , * V_148 ;
...
V_6 == V_150 -> V_135 )
V_108 += 2 * sizeof( V_143 ) ;
V_141 = F_114 ( V_15 , V_13 , V_41 , V_108 , V_110 ) ;
F_35 ( V_13 ) ;
return V_141 ;
}
static unsigned int
F_115 ( unsigned int V_110 , struct V_14 * V_15 , int V_51 )
{
struct V_36 * V_36 ;
struct V_57 V_58 ;
struct V_81 * V_41 ;
...
if ( V_15 -> V_144 )
return V_102 ;
if ( F_80 ( ( V_15 -> V_200 != V_201 &&
V_110 != V_175 ) ||
! F_46 ( V_15 ) ) ) {
F_19 ( V_51 , F_20 ( V_15 ) , & V_58 ) ;
F_22 ( 12 , L_41
L_42 ,
V_15 -> V_200 , V_58 . V_43 ,
...
if ( F_80 ( V_58 . V_43 == V_8 ) ) {
int V_146 ;
int V_141 = F_113 ( V_15 , & V_146 , V_110 ) ;
if ( V_146 )
return V_141 ;
F_19 ( V_51 , F_20 ( V_15 ) , & V_58 ) ;
}
...
if ( F_80 ( ! V_13 ) ) {
int V_202 ;
if ( ! V_41 -> V_203 ( V_51 , V_15 , V_40 , & V_202 , & V_13 ) )
return V_202 ;
}
if ( F_80 ( ! V_13 ) ) {
F_34 ( 12 , V_51 , V_41 , V_15 , 0 ,
...
V_199 = F_119 ( 1 , & V_13 -> V_101 ) ;
if ( V_19 -> V_204 & V_205 )
F_120 ( V_36 , V_13 , V_199 ) ;
F_30 ( V_13 ) ;
return V_95 ;
}
static unsigned int
F_121 ( unsigned int V_110 , struct V_14 * V_15 ,
const struct V_183 * V_184 ,
const struct V_183 * V_142 ,
int (* F_95)( struct V_14 * ) )
{
return F_115 ( V_110 , V_15 , V_132 ) ;
}
static unsigned int
F_122 ( unsigned int V_110 , struct V_14 * V_15 ,
const struct V_183 * V_184 , const struct V_183 * V_142 ,
int (* F_95)( struct V_14 * ) )
{
unsigned int V_141 ;
F_97 () ;
V_141 = F_115 ( V_110 , V_15 , V_132 ) ;
F_98 () ;
return V_141 ;
}
static unsigned int
...
if ( ! F_6 ( V_36 ) -> V_182 )
return V_102 ;
return F_113 ( V_15 , & V_206 , V_110 ) ;
}
static int T_8 F_127 ( struct V_36 * V_36 )
{
struct V_18 * V_19 ;
V_19 = F_128 ( V_36 , V_207 ) ;
if ( V_19 == NULL )
return - V_208 ;
V_19 -> V_182 = 0 ;
V_19 -> V_36 = V_36 ;
...
static void T_9 F_141 ( struct V_36 * V_36 )
{
F_142 ( V_36 ) ;
F_136 ( V_36 ) ;
F_137 ( V_36 ) ;
