...
static int F_19 ( struct V_32 * V_33 , struct V_47 * V_17 )
{
struct V_40 V_48 ;
unsigned long error ;
unsigned long V_49 ;
...
if ( ( F_20 ( V_48 ) != V_53 && F_20 ( V_48 ) != V_54 &&
F_20 ( V_48 ) != V_55 && F_20 ( V_48 ) != V_56 ) ||
F_21 ( V_48 ) || F_22 ( V_48 ) ||
F_23 ( V_33 -> V_3 -> V_57 . V_58 -> V_59 ) < V_48 . V_60 + V_48 . V_61 + F_24 ( V_48 ) + F_25 ( V_48 ) ) {
return - V_62 ;
}
...
( V_11 -> V_41 -> V_71 = F_31 ( V_48 ) ) ;
V_11 -> V_41 -> V_72 = V_48 . V_61 +
( V_11 -> V_41 -> V_73 = F_32 ( V_48 ) ) ;
V_11 -> V_41 -> V_74 = V_48 . V_67 +
( V_11 -> V_41 -> V_75 = F_33 ( V_48 ) ) ;
V_11 -> V_41 -> V_76 = V_11 -> V_41 -> V_77 ;
V_11 -> V_41 -> V_78 = 0 ;
V_51 = F_34 ( V_33 , V_79 , V_80 ) ;
if ( V_51 < 0 ) {
F_35 ( V_81 , V_11 , 0 ) ;
return V_51 ;
}
...
F_37 ( V_82 , V_82 + V_48 . V_60 + V_48 . V_61 ) ;
} else {
...
T_4 V_84 = V_49 ;
F_14 ( F_31 ( V_48 ) , V_48 . V_60 + V_48 . V_61 ) ;
V_33 -> V_3 -> V_63 -> V_86 ( V_33 -> V_3 ,
( char T_2 * ) F_31 ( V_48 ) ,
V_48 . V_60 + V_48 . V_61 , & V_84 ) ;
F_37 ( ( unsigned long ) F_31 ( V_48 ) ,
( unsigned long ) F_31 ( V_48 ) +
V_48 . V_60 + V_48 . V_61 ) ;
goto V_91;
}
error = F_40 ( V_33 -> V_3 , F_31 ( V_48 ) , V_48 . V_60 ,
V_92 | V_93 ,
V_94 | V_95 | V_96 | V_97 ,
V_49 ) ;
if ( error != F_31 ( V_48 ) ) {
...
error = F_40 ( V_33 -> V_3 , F_32 ( V_48 ) , V_48 . V_61 ,
V_92 | V_98 | V_93 ,
V_94 | V_95 | V_96 | V_97 ,
V_49 + V_48 . V_60 ) ;
if ( error != F_32 ( V_48 ) ) {
...
#endif
F_42 ( V_17 , V_48 . V_103 , V_11 -> V_41 -> V_100 ) ;
return 0 ;
}
...
V_51 = - V_62 ;
error = F_44 ( V_3 , 0 , ( char * ) & V_48 , sizeof( V_48 ) ) ;
if ( error != sizeof( V_48 ) )
goto V_108;
if ( ( F_20 ( V_48 ) != V_53 && F_20 ( V_48 ) != V_55 ) || F_21 ( V_48 ) ||
F_22 ( V_48 ) || ( ( V_48 . V_103 & 0xfff ) && F_20 ( V_48 ) == V_53 ) ||
F_23 ( V_104 ) < V_48 . V_60 + V_48 . V_61 + F_24 ( V_48 ) + F_25 ( V_48 ) ) {
goto V_108;
}
...
V_48 . V_60 + V_48 . V_61 , & V_84 ) ;
F_37 ( ( unsigned long ) V_106 ,
( unsigned long ) V_106 + V_48 . V_60 + V_48 . V_61 ) ;
V_51 = 0 ;
goto V_108;
}
error = F_40 ( V_3 , V_106 , V_48 . V_60 + V_48 . V_61 ,
V_92 | V_98 | V_93 ,
V_94 | V_95 | V_96 ,
F_25 ( V_48 ) ) ;
V_51 = error ;
