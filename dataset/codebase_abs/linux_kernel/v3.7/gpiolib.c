...
int F_54 ( unsigned V_8 , bool V_78 )
{
unsigned long V_11 ;
struct V_1 * V_4 ;
int V_33 = - V_24 ;
...
F_17 ( & V_25 , V_11 ) ;
if ( V_4 -> V_7 -> V_85 && V_4 -> V_7 -> V_85 [ V_8 - V_4 -> V_7 -> V_9 ] )
V_79 = V_4 -> V_7 -> V_85 [ V_8 - V_4 -> V_7 -> V_9 ] ;
if ( V_33 == 0 ) {
struct V_28 * V_29 ;
V_29 = F_58 ( & V_80 , V_4 -> V_7 -> V_29 , F_59 ( 0 , 0 ) ,
V_4 , V_79 ? V_79 : L_19 , V_8 ) ;
if ( ! F_60 ( V_29 ) ) {
V_33 = F_61 ( & V_29 -> V_58 ,
& V_86 ) ;
if ( ! V_33 && V_78 )
...
static int F_65 ( struct V_28 * V_29 , void * V_89 )
{
return F_19 ( V_29 ) == V_89 ;
}
...
if ( F_11 ( V_35 , & V_4 -> V_11 ) ) {
struct V_28 * V_90 ;
V_90 = F_67 ( & V_80 , NULL , V_4 , F_65 ) ;
if ( V_90 != NULL ) {
V_33 = F_68 ( & V_29 -> V_58 , & V_90 -> V_58 ,
V_69 ) ;
} else {
V_33 = - V_60 ;
}
...
return 0 ;
F_20 ( & V_34 ) ;
V_29 = F_58 ( & V_80 , V_7 -> V_29 , F_59 ( 0 , 0 ) , V_7 ,
L_21 , V_7 -> V_9 ) ;
if ( ! F_60 ( V_29 ) ) {
V_33 = F_61 ( & V_29 -> V_58 ,
& V_92 ) ;
...
int F_87 ( const struct V_8 * V_106 , T_3 V_107 )
{
int V_16 , V_27 ;
for ( V_16 = 0 ; V_16 < V_107 ; V_16 ++ , V_106 ++ ) {
V_27 = F_86 ( V_106 -> V_8 , V_106 -> V_11 , V_106 -> V_3 ) ;
if ( V_27 )
goto V_108;
}
return 0 ;
...
void F_88 ( const struct V_8 * V_106 , T_3 V_107 )
{
while ( V_107 -- )
F_55 ( ( V_106 ++ ) -> V_8 ) ;
}
...
return F_25 ( V_8 ) ;
if ( ! V_38 && F_11 ( V_98 , & V_4 -> V_11 ) )
return F_25 ( V_8 ) ;
F_15 ( & V_25 , V_11 ) ;
if ( ! F_12 ( V_8 ) )
goto V_94;
V_7 = V_4 -> V_7 ;
if ( ! V_7 || ! V_7 -> V_111 || ! V_7 -> V_84 )
goto V_94;
V_8 -= V_7 -> V_9 ;
if ( V_8 >= V_7 -> V_15 )
goto V_94;
...
int F_92 ( unsigned V_8 , unsigned V_112 )
{
unsigned long V_11 ;
struct V_6 * V_7 ;
struct V_1 * V_4 = & V_1 [ V_8 ] ;
...
F_17 ( & V_25 , V_11 ) ;
F_85 ( V_7 -> V_96 ) ;
return V_7 -> V_113 ( V_7 , V_8 , V_112 ) ;
V_94:
F_17 ( & V_25 , V_11 ) ;
if ( V_33 )
F_13 ( L_29 ,
...
V_7 = F_9 ( V_8 ) ;
F_84 ( V_7 -> V_96 ) ;
V_38 = V_7 -> V_109 ? V_7 -> V_109 ( V_7 , V_8 - V_7 -> V_9 ) : 0 ;
F_91 ( V_8 , 1 , V_38 ) ;
return V_38 ;
}
...
int V_27 = 0 ;
if ( V_38 ) {
V_27 = V_7 -> V_83 ( V_7 , V_8 - V_7 -> V_9 ) ;
if ( ! V_27 )
F_8 ( V_36 , & V_1 [ V_8 ] . V_11 ) ;
} else {
V_27 = V_7 -> V_84 ( V_7 , V_8 - V_7 -> V_9 , 0 ) ;
if ( ! V_27 )
...
int V_27 = 0 ;
if ( V_38 ) {
V_27 = V_7 -> V_84 ( V_7 , V_8 - V_7 -> V_9 , 1 ) ;
if ( ! V_27 )
F_16 ( V_36 , & V_1 [ V_8 ] . V_11 ) ;
} else {
V_27 = V_7 -> V_83 ( V_7 , V_8 - V_7 -> V_9 ) ;
...
F_84 ( V_7 -> V_96 ) ;
F_91 ( V_8 , 0 , V_38 ) ;
if ( F_11 ( V_97 , & V_1 [ V_8 ] . V_11 ) )
F_94 ( V_8 , V_7 , V_38 ) ;
else if ( F_11 ( V_98 , & V_1 [ V_8 ] . V_11 ) )
F_95 ( V_8 , V_7 , V_38 ) ;
else
V_7 -> V_111 ( V_7 , V_8 - V_7 -> V_9 , V_38 ) ;
}
...
struct V_6 * V_7 ;
V_7 = F_9 ( V_8 ) ;
return V_7 -> V_114 ? V_7 -> V_114 ( V_7 , V_8 - V_7 -> V_9 ) : - V_115 ;
}
...
static void F_99 ( struct V_116 * V_117 , struct V_6 * V_7 )
{
unsigned V_16 ;
unsigned V_8 = V_7 -> V_9 ;
struct V_1 * V_118 = & V_1 [ V_8 ] ;
int V_119 ;
for ( V_16 = 0 ; V_16 < V_7 -> V_15 ; V_16 ++ , V_8 ++ , V_118 ++ ) {
if ( ! F_11 ( V_10 , & V_118 -> V_11 ) )
continue;
V_119 = F_11 ( V_36 , & V_118 -> V_11 ) ;
F_100 ( V_117 , L_32 ,
V_8 , V_118 -> V_3 ,
V_119 ? L_7 : L_33 ,
V_7 -> V_109
? ( V_7 -> V_109 ( V_7 , V_16 ) ? L_34 : L_35 )
: L_36 ) ;
F_100 ( V_117 , L_37 ) ;
}
}
static void * F_101 ( struct V_116 * V_117 , T_5 * V_120 )
{
struct V_6 * V_7 = NULL ;
unsigned int V_8 ;
void * V_23 = NULL ;
...
static void * F_102 ( struct V_116 * V_117 , void * V_123 , T_5 * V_120 )
{
...
static void F_103 ( struct V_116 * V_117 , void * V_123 )
{
}
static int F_104 ( struct V_116 * V_117 , void * V_123 )
{
struct V_6 * V_7 = V_123 ;
struct V_28 * V_29 ;
F_100 ( V_117 , L_38 , ( char * ) V_117 -> V_122 ,
V_7 -> V_9 , V_7 -> V_9 + V_7 -> V_15 - 1 ) ;
V_29 = V_7 -> V_29 ;
if ( V_29 )
F_100 ( V_117 , L_39 , V_29 -> V_124 ? V_29 -> V_124 -> V_69 : L_40 ,
F_105 ( V_29 ) ) ;
if ( V_7 -> V_3 )
F_100 ( V_117 , L_41 , V_7 -> V_3 ) ;
if ( V_7 -> V_96 )
F_100 ( V_117 , L_42 ) ;
F_100 ( V_117 , L_43 ) ;
if ( V_7 -> V_125 )
...
static int F_106 ( struct V_126 * V_126 , struct V_127 * V_127 )
{
return F_107 ( V_127 , & V_128 ) ;
}
static int T_1 F_108 ( void )
{
( void ) F_109 ( L_44 , V_129 | V_130 ,
NULL , NULL , & V_131 ) ;
return 0 ;
}
