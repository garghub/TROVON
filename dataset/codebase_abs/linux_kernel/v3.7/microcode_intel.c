...
enum V_51 V_72 ;
sprintf ( V_70 , L_12 ,
V_5 -> V_9 , V_5 -> V_8 , V_5 -> V_73 ) ;
if ( F_28 ( & V_71 , V_70 , V_68 ) ) {
F_25 ( L_13 , V_70 ) ;
return V_64 ;
}
V_72 = F_21 ( V_41 , ( void * ) V_71 -> V_52 ,
V_71 -> V_53 , & F_26 ) ;
F_29 ( V_71 ) ;
return V_72 ;
}
...
static enum V_51
F_32 ( int V_41 , const void T_3 * V_74 , T_1 V_53 )
{
return F_21 ( V_41 , ( void * ) V_74 , V_53 , & F_30 ) ;
}
...
struct V_75 * T_4 F_34 ( void )
{
struct V_4 * V_5 = & F_2 ( 0 ) ;
if ( V_5 -> V_76 != V_77 || V_5 -> V_9 < 6 ||
F_35 ( V_5 , V_78 ) ) {
F_12 ( L_14 , V_5 -> V_9 ) ;
return NULL ;
}
