...
static int F_73 ( char * V_50 , int V_94 , T_4 * V_95 ,
const void * * V_96 )
{
int V_58 ;
T_4 V_97 = * V_95 ;
const char * V_61 = * V_96 ;
while ( isspace ( * V_61 ) && V_97 ) {
V_61 ++ ;
V_97 -- ;
}
if ( ! V_97 )
...
int F_74 ( struct V_82 * V_33 , T_4 V_97 , const void * V_98 )
{
char V_50 [ 128 ] ;
struct V_1 * V_2 ;
int V_99 ;
V_99 = V_93 ;
V_2 = NULL ;
while ( F_73 ( V_50 , sizeof( V_50 ) - 1 , & V_97 , & V_98 ) ) {
if ( ! * V_50 || * V_50 == '#' || * V_50 == '\n' )
continue;
if ( * V_50 == '[' )
V_99 = F_72 ( V_50 , V_33 ) ;
else if ( V_91 [ V_99 ] . V_100 &&
( V_2 || ! V_91 [ V_99 ] . V_101 ) )
V_91 [ V_99 ] . V_100 ( V_50 , V_33 , & V_2 ) ;
}
return 0 ;
}
