...
static int T_7 F_48 ( struct V_94 * V_95 )
{
...
int V_105 , V_74 ;
struct V_106 V_107 ;
V_105 = ( F_49 ( V_108 ) >> 4 ) & 0xF ;
if ( ( V_105 != 2 ) && ( V_105 != 3 ) ) {
F_41 ( V_34 , L_10 , V_105 ) ;
return - V_109 ;
}
V_8 = F_50 ( V_34 , sizeof( * V_8 ) , V_110 ) ;
if ( ! V_8 ) {
F_41 ( V_34 , L_11 ) ;
return - V_45 ;
}
...
V_8 -> V_25 = F_51 ( V_43 , 0 ) ;
if ( V_8 -> V_25 == V_111 ) {
F_41 ( V_34 , L_13 ) ;
return - V_46 ;
}
V_104 = F_52 ( V_43 , 0 , & V_99 ) ;
if ( V_104 ) {
F_41 ( V_34 , L_14 ) ;
return V_104 ;
}
V_102 = F_53 ( V_43 , L_15 , & V_74 ) ;
...
V_100 = V_99 . V_112 ;
V_101 = F_54 ( & V_99 ) ;
if ( ! F_55 ( V_34 , V_100 , V_101 , V_113 ) ) {
F_41 ( V_34 , L_17 ) ;
return - V_89 ;
}
V_8 -> V_9 = F_56 ( V_34 , V_100 , V_101 ) ;
if ( ! V_8 -> V_9 ) {
F_41 ( V_34 , L_18 ) ;
return - V_45 ;
}
...
F_64 ( & V_8 -> V_29 ) ;
V_104 = F_65 ( V_34 , V_8 -> V_25 , & F_14 , 0 , V_113 ,
V_2 ) ;
if ( V_104 ) {
F_41 ( V_34 , L_26 ) ;
goto error;
}
if ( F_66 ( V_2 , F_67 ( V_102 ) ) ) {
F_41 ( V_34 , L_27 ) ;
...
F_69 ( V_34 , V_2 ) ;
V_104 = F_70 ( V_2 , NULL , & V_107 , NULL , 0 ) ;
if ( V_104 ) {
F_41 ( V_34 , L_29 ) ;
F_68 ( V_34 , V_8 -> V_25 , V_2 ) ;
goto error;
...
static int T_9 F_71 ( struct V_94 * V_95 )
{
struct V_92 * V_34 = & V_95 -> V_34 ;
struct V_1 * V_2 = F_72 ( V_34 ) ;
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_7 * V_8 = V_5 -> V_6 ;
F_73 ( V_2 ) ;
F_68 ( V_34 , V_8 -> V_25 , V_2 ) ;
