...
if ( ( V_54 -> V_68 == V_67 ) && ( V_54 -> V_77 < 1 ) ) {
V_54 -> V_77 = 1 ;
error ++ ;
}
if ( ( V_54 -> V_68 == V_69 ) && ( V_54 -> V_77 != 0 ) ) {
V_54 -> V_77 = 0 ;
error ++ ;
}
if ( error )
...
V_57 = F_19 ( V_54 -> V_82 [ 0 ] ) ;
if ( V_54 -> V_76 > 1 ) {
for ( V_58 = 0 ; V_58 < V_54 -> V_76 ; V_58 ++ ) {
if ( F_20 ( V_54 -> V_82 [ V_58 ] ) != V_58 ) {
F_21 ( V_15 ,
L_1
L_2 ) ;
error ++ ;
}
if ( F_18 ( V_54 -> V_82 [ V_58 ] ) != V_56 ) {
F_21 ( V_15 ,
L_3 ) ;
error ++ ;
}
if ( F_19 ( V_54 -> V_82 [ V_58 ] ) != V_57 ) {
F_21 ( V_15 ,
L_4 ) ;
error ++ ;
}
...
F_2 ( F_20 ( V_83 -> V_82 [ 0 ] ) ,
V_15 -> V_20 + V_86 ) ;
F_10 ( V_15 , false ) ;
}
F_2 ( F_18 ( V_83 -> V_82 [ 0 ] ) & V_87 ,
V_15 -> V_20 + V_88 ) ;
switch ( V_83 -> V_68 ) {
case V_67 :
V_17 -> V_89 =
...
static T_1 F_24 ( int V_85 , void * V_103 )
{
...
{
unsigned int V_130 = F_20 ( V_129 -> V_131 ) ;
unsigned int V_56 = F_18 ( V_129 -> V_131 ) ;
unsigned int V_99 = V_51 -> V_99 ;
unsigned int V_100 = ( V_99 + 1 ) >> 1 ;
unsigned int V_101 = ( V_99 == 0xffff ) ? 0 : 4 ;
unsigned int V_106 ;
...
return - V_138 ;
V_137:
V_95 [ V_58 ] = F_31 ( V_15 -> V_20 + V_124 ) ;
...
F_33 ( V_51 -> V_145 , V_15 -> V_20 + V_142 ) ;
}
V_95 [ 1 ] = V_51 -> V_145 ;
return V_129 -> V_133 ;
}
...
struct V_50 * V_51 ;
int V_148 ;
F_39 ( V_15 , & V_147 -> V_15 ) ;
V_15 -> V_149 = V_15 -> V_150 -> V_151 ;
V_148 = F_40 ( V_15 , sizeof( * V_17 ) ) ;
if ( V_148 )
return V_148 ;
V_17 = V_15 -> V_18 ;
V_148 = F_41 ( V_147 , V_15 -> V_149 ) ;
if ( V_148 )
return V_148 ;
V_17 -> V_52 = F_42 ( V_147 , 1 ) ;
V_15 -> V_20 = F_42 ( V_147 , 2 ) ;
F_37 ( V_15 ) ;
if ( V_147 -> V_85 > 0 ) {
V_148 = F_43 ( V_15 -> V_85 , F_24 ,
V_152 , V_15 -> V_149 , V_15 ) ;
if ( V_148 )
return V_148 ;
V_15 -> V_85 = V_147 -> V_85 ;
}
V_148 = F_44 ( V_15 , 4 ) ;
if ( V_148 )
return V_148 ;
...
V_51 -> V_161 = & V_173 ;
V_51 -> V_174 = F_36 ;
F_45 ( V_15 -> V_176 , L_10 , V_15 -> V_149 ) ;
return 0 ;
}
static void F_46 ( struct V_14 * V_15 )
{
struct V_146 * V_147 = F_47 ( V_15 ) ;
if ( V_15 -> V_20 )
F_37 ( V_15 ) ;
if ( V_15 -> V_85 != 0 )
F_48 ( V_15 -> V_85 , V_15 ) ;
...
static int T_2 F_50 ( struct V_146 * V_15 ,
const struct V_177 * V_178 )
{
return F_51 ( V_15 , & V_179 ) ;
}
static void T_3 F_52 ( struct V_146 * V_15 )
{
F_53 ( V_15 ) ;
}
