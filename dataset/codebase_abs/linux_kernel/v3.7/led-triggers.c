...
return;
F_27 ( & V_12 -> V_23 ) ;
F_28 (entry, &trig->led_cdevs) {
struct V_7 * V_8 ;
V_8 = F_29 ( V_41 , struct V_7 , V_24 ) ;
F_17 ( V_8 , V_39 ) ;
}
F_30 ( & V_12 -> V_23 ) ;
}
...
int V_45 )
{
F_31 ( V_12 , V_42 , V_43 , 1 , V_45 ) ;
}
void F_36 ( const char * V_15 , struct V_11 * * V_46 )
{
struct V_11 * V_12 ;
int V_47 ;
V_12 = F_37 ( sizeof( struct V_11 ) , V_22 ) ;
if ( V_12 ) {
V_12 -> V_15 = V_15 ;
V_47 = F_22 ( V_12 ) ;
if ( V_47 < 0 ) {
