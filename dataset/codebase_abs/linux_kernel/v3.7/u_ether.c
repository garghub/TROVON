...
int F_66 ( struct V_1 * V_128 , T_5 V_129 [ V_130 ] ,
const char * V_131 )
{
struct V_11 * V_12 ;
struct V_8 * V_9 ;
...
F_72 ( & V_128 -> V_12 ,
L_18 , L_19 ) ;
if ( F_62 ( V_133 , V_12 -> V_134 ) )
F_72 ( & V_128 -> V_12 ,
L_18 , L_20 ) ;
if ( V_129 )
memcpy ( V_129 , V_12 -> V_134 , V_130 ) ;
V_9 -> V_135 = & V_136 ;
F_73 ( V_9 , & V_137 ) ;
V_12 -> V_2 = V_128 ;
F_74 ( V_9 , & V_128 -> V_12 ) ;
...
V_14 = F_76 ( V_9 ) ;
if ( V_14 < 0 ) {
F_77 ( & V_128 -> V_12 , L_21 , V_14 ) ;
F_78 ( V_9 ) ;
} else {
F_79 ( V_12 , L_22 , V_9 -> V_126 ) ;
F_79 ( V_12 , L_23 , V_12 -> V_134 ) ;
V_132 = V_12 ;
F_80 ( V_9 ) ;
}
return V_14 ;
...
struct V_8 * F_84 ( struct V_91 * V_92 )
{
struct V_11 * V_12 = V_132 ;
int V_139 = 0 ;
if ( ! V_12 )
return F_85 ( - V_140 ) ;
V_92 -> V_94 -> V_65 = V_12 ;
