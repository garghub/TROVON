...
struct V_1 * F_11 ( struct V_12 * V_3 , T_1 V_2 )
{
...
while ( * V_14 != NULL ) {
V_16 = * V_14 ;
V_17 = F_12 ( V_16 , struct V_1 , V_13 ) ;
if ( V_17 -> V_2 == V_2 ) {
V_3 -> V_18 = V_17 ;
return V_17 ;
}
...
V_17 = F_1 ( V_2 ) ;
if ( V_17 != NULL ) {
F_13 ( & V_17 -> V_13 , V_16 , V_14 ) ;
F_14 ( & V_17 -> V_13 , & V_3 -> V_15 ) ;
V_3 -> V_18 = V_17 ;
}
return V_17 ;
}
void F_15 ( struct V_1 * V_3 , struct V_21 * V_21 )
{
F_16 ( & V_3 -> V_4 , V_21 , V_11 , V_22 ) ;
F_17 ( & V_3 -> V_4 , V_21 ) ;
}
int F_18 ( struct V_1 * V_3 , struct V_1 * V_16 )
{
int V_23 ;
if ( V_16 -> V_8 ) {
if ( V_3 -> V_5 )
...
if ( F_19 ( & V_3 -> V_4 , & V_16 -> V_4 , V_23 ) < 0 )
return - V_7 ;
return 0 ;
}
T_2 F_20 ( struct V_12 * V_12 , T_3 * V_10 )
{
T_2 V_25 = 0 ;
struct V_13 * V_26 ;
for ( V_26 = F_21 ( & V_12 -> V_15 ) ; V_26 ; V_26 = F_22 ( V_26 ) ) {
struct V_1 * V_27 = F_12 ( V_26 , struct V_1 , V_13 ) ;
V_25 += F_9 ( V_27 , V_10 ) ;
}
return V_25 ;
}
