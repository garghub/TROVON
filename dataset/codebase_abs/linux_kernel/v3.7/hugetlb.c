...
static int T_4 F_189 ( char * V_201 )
{
V_189 = F_190 ( V_201 , & V_201 ) ;
return 1 ;
}
static unsigned int F_191 ( unsigned int * V_204 )
{
int V_183 ;
...
V_10 = F_193 ( V_207 , V_208 , V_209 , V_210 , V_211 ) ;
if ( V_10 )
goto V_155;
if ( V_208 ) {
F_158 ( T_2 , V_109 ,
...
void T_8 * V_209 , T_6 * V_210 , T_9 * V_211 )
{
return F_192 ( false , V_207 , V_208 ,
V_209 , V_210 , V_211 ) ;
}
int F_195 ( struct V_206 * V_207 , int V_208 ,
void T_8 * V_209 , T_6 * V_210 , T_9 * V_211 )
{
return F_192 ( true , V_207 , V_208 ,
V_209 , V_210 , V_211 ) ;
}
int F_196 ( struct V_206 * V_207 , int V_208 ,
void T_8 * V_209 ,
T_6 * V_210 , T_9 * V_211 )
{
F_197 ( V_207 , V_208 , V_209 , V_210 , V_211 ) ;
if ( V_214 )
V_83 = V_215 ;
else
V_83 = V_216 ;
...
int F_198 ( struct V_206 * V_207 , int V_208 ,
void T_8 * V_209 ,
T_6 * V_210 , T_9 * V_211 )
{
struct V_36 * V_37 = & V_194 ;
...
static int F_209 ( struct V_14 * V_15 , struct V_221 * V_222 )
{
F_177 () ;
return 0 ;
}
...
if ( V_223 ) {
V_224 =
F_211 ( F_212 ( F_213 ( V_60 , V_15 -> V_225 ) ) ) ;
} else {
V_224 = F_214 ( F_213 ( V_60 , V_15 -> V_225 ) ) ;
}
V_224 = F_215 ( V_224 ) ;
V_224 = F_216 ( V_224 ) ;
V_224 = F_217 ( V_224 , V_15 , V_60 , V_223 ) ;
return V_224 ;
}
...
{
T_10 V_224 ;
V_224 = F_211 ( F_212 ( F_219 ( V_226 ) ) ) ;
if ( F_220 ( V_15 , V_38 , V_226 , V_224 , 1 ) )
F_221 ( V_15 , V_38 , V_226 ) ;
}
int F_222 ( struct V_227 * V_61 , struct V_227 * V_62 ,
struct V_14 * V_15 )
{
...
V_228 = F_223 ( V_62 , V_130 ) ;
if ( ! V_228 )
continue;
V_229 = F_224 ( V_61 , V_130 , V_232 ) ;
if ( ! V_229 )
goto V_235;
if ( V_229 == V_228 )
continue;
F_8 ( & V_61 -> V_236 ) ;
F_225 ( & V_62 -> V_236 , V_237 ) ;
if ( ! F_226 ( F_219 ( V_228 ) ) ) {
if ( V_231 )
F_227 ( V_62 , V_130 , V_228 ) ;
V_224 = F_219 ( V_228 ) ;
V_230 = F_228 ( V_224 ) ;
F_229 ( V_230 ) ;
F_230 ( V_230 ) ;
F_231 ( V_61 , V_130 , V_229 , V_224 ) ;
}
F_2 ( & V_62 -> V_236 ) ;
F_2 ( & V_61 -> V_236 ) ;
}
...
static int F_232 ( T_10 V_238 )
{
T_11 V_239 ;
if ( F_226 ( V_238 ) || F_233 ( V_238 ) )
return 0 ;
V_239 = F_234 ( V_238 ) ;
if ( F_235 ( V_239 ) && F_236 ( V_239 ) )
return 1 ;
else
return 0 ;
}
static int F_237 ( T_10 V_238 )
{
T_11 V_239 ;
if ( F_226 ( V_238 ) || F_233 ( V_238 ) )
return 0 ;
V_239 = F_234 ( V_238 ) ;
if ( F_235 ( V_239 ) && F_238 ( V_239 ) )
return 1 ;
else
return 0 ;
}
void F_239 ( struct V_240 * V_241 , struct V_14 * V_15 ,
...
struct V_36 * V_37 = F_32 ( V_15 ) ;
unsigned long V_232 = F_80 ( V_37 ) ;
const unsigned long V_246 = V_219 ;
const unsigned long V_247 = V_32 ;
F_141 ( ! F_34 ( V_15 ) ) ;
F_9 ( V_219 & ~ F_240 ( V_37 ) ) ;
F_9 ( V_32 & ~ F_240 ( V_37 ) ) ;
F_241 ( V_241 , V_15 ) ;
F_242 ( V_244 , V_246 , V_247 ) ;
V_248:
F_8 ( & V_244 -> V_236 ) ;
for ( V_38 = V_219 ; V_38 < V_32 ; V_38 += V_232 ) {
V_226 = F_223 ( V_244 , V_38 ) ;
if ( ! V_226 )
continue;
if ( F_243 ( V_244 , & V_38 , V_226 ) )
continue;
V_238 = F_219 ( V_226 ) ;
if ( F_226 ( V_238 ) )
continue;
...
V_238 = F_244 ( V_244 , V_38 , V_226 ) ;
F_245 ( V_241 , V_226 , V_38 ) ;
if ( F_246 ( V_238 ) )
F_247 ( V_60 ) ;
F_248 ( V_60 ) ;
V_243 = ! F_249 ( V_241 , V_60 ) ;
if ( V_243 )
break;
if ( V_242 )
break;
...
F_251 ( V_244 , V_246 , V_247 ) ;
F_252 ( V_241 , V_15 ) ;
}
void F_253 ( struct V_240 * V_241 ,
struct V_14 * V_15 , unsigned long V_219 ,
unsigned long V_32 , struct V_60 * V_242 )
{
F_239 ( V_241 , V_15 , V_219 , V_32 , V_242 ) ;
V_15 -> V_51 &= ~ V_52 ;
}
void F_254 ( struct V_14 * V_15 , unsigned long V_219 ,
unsigned long V_32 , struct V_60 * V_242 )
{
struct V_227 * V_244 ;
struct V_240 V_241 ;
...
F_255 ( & V_241 , V_244 , 0 ) ;
F_239 ( & V_241 , V_15 , V_219 , V_32 , V_242 ) ;
F_256 ( & V_241 , V_219 , V_32 ) ;
}
static int F_257 ( struct V_227 * V_244 , struct V_14 * V_15 ,
...
V_251 = ( ( V_38 - V_15 -> V_39 ) >> V_43 ) +
V_15 -> V_40 ;
V_97 = V_15 -> V_16 -> V_17 -> V_18 -> V_135 ;
F_258 ( & V_97 -> V_252 ) ;
F_259 (iter_vma, &mapping->i_mmap, pgoff, pgoff) {
if ( V_250 == V_15 )
continue;
if ( ! F_46 ( V_250 , V_59 ) )
F_254 ( V_250 , V_38 ,
...
static int F_261 ( struct V_227 * V_244 , struct V_14 * V_15 ,
...
if ( V_256 ) {
if ( F_262 ( V_254 ) )
F_263 ( V_254 , V_15 , V_38 ) ;
F_218 ( V_15 , V_38 , V_226 ) ;
return 0 ;
}
if ( ! ( V_15 -> V_51 & V_52 ) &&
F_46 ( V_15 , V_59 ) &&
...
F_264 ( V_254 ) ;
F_2 ( & V_244 -> V_236 ) ;
V_255 = F_123 ( V_15 , V_38 , V_257 ) ;
if ( F_265 ( V_255 ) ) {
long V_84 = F_266 ( V_255 ) ;
F_267 ( V_254 ) ;
if ( V_257 ) {
F_9 ( F_226 ( V_238 ) ) ;
if ( F_257 ( V_244 , V_15 , V_254 , V_38 ) ) {
F_9 ( F_226 ( V_238 ) ) ;
F_8 ( & V_244 -> V_236 ) ;
V_226 = F_223 ( V_244 , V_38 & F_240 ( V_37 ) ) ;
if ( F_268 ( F_269 ( F_219 ( V_226 ) , V_238 ) ) )
goto V_258;
return 0 ;
}
F_270 ( 1 ) ;
...
F_272 ( V_255 , V_254 , V_38 , V_15 ,
F_52 ( V_37 ) ) ;
F_273 ( V_255 ) ;
V_246 = V_38 & F_240 ( V_37 ) ;
V_247 = V_246 + F_80 ( V_37 ) ;
F_242 ( V_244 , V_246 , V_247 ) ;
F_8 ( & V_244 -> V_236 ) ;
V_226 = F_223 ( V_244 , V_38 & F_240 ( V_37 ) ) ;
if ( F_268 ( F_269 ( F_219 ( V_226 ) , V_238 ) ) ) {
F_274 ( V_15 , V_38 , V_226 ) ;
F_231 ( V_244 , V_38 , V_226 ,
F_210 ( V_15 , V_255 , 1 ) ) ;
F_248 ( V_254 ) ;
F_275 ( V_255 , V_15 , V_38 ) ;
V_255 = V_254 ;
}
F_2 ( & V_244 -> V_236 ) ;
F_251 ( V_244 , V_246 , V_247 ) ;
...
static struct V_60 * F_276 ( struct V_36 * V_37 ,
struct V_14 * V_15 , unsigned long V_38 )
{
struct V_131 * V_97 ;
T_1 V_134 ;
...
return F_277 ( V_97 , V_134 ) ;
}
static bool F_278 ( struct V_36 * V_37 ,
struct V_14 * V_15 , unsigned long V_38 )
{
struct V_131 * V_97 ;
T_1 V_134 ;
...
V_97 = V_15 -> V_16 -> V_132 ;
V_134 = F_28 ( V_37 , V_15 , V_38 ) ;
V_60 = F_279 ( V_97 , V_134 ) ;
if ( V_60 )
F_91 ( V_60 ) ;
return V_60 != NULL ;
}
static int F_280 ( struct V_227 * V_244 , struct V_14 * V_15 ,
...
V_134 = F_28 ( V_37 , V_15 , V_38 ) ;
V_126:
V_60 = F_277 ( V_97 , V_134 ) ;
if ( ! V_60 ) {
V_96 = F_281 ( V_97 -> V_133 ) >> F_29 ( V_37 ) ;
if ( V_134 >= V_96 )
goto V_155;
...
F_282 ( V_60 , V_38 , F_52 ( V_37 ) ) ;
F_273 ( V_60 ) ;
if ( V_15 -> V_51 & V_52 ) {
int V_84 ;
struct V_12 * V_12 = V_97 -> V_133 ;
V_84 = F_283 ( V_60 , V_97 , V_134 , V_7 ) ;
if ( V_84 ) {
F_91 ( V_60 ) ;
if ( V_84 == - V_264 )
goto V_126;
...
goto V_270;
V_10 = 0 ;
if ( ! F_226 ( F_219 ( V_226 ) ) )
goto V_270;
if ( V_261 )
F_275 ( V_60 , V_15 , V_38 ) ;
else
F_230 ( V_60 ) ;
V_262 = F_210 ( V_15 , V_60 , ( ( V_15 -> V_51 & V_271 )
&& ( V_15 -> V_51 & V_233 ) ) ) ;
F_231 ( V_244 , V_38 , V_226 , V_262 ) ;
if ( ( V_55 & V_269 ) && ! ( V_15 -> V_51 & V_233 ) ) {
V_10 = F_261 ( V_244 , V_15 , V_38 , V_226 , V_262 , V_60 ) ;
}
F_2 ( & V_244 -> V_236 ) ;
F_288 ( V_60 ) ;
V_155:
...
int F_289 ( struct V_227 * V_244 , struct V_14 * V_15 ,
...
V_224 = F_219 ( V_226 ) ;
if ( F_57 ( F_232 ( V_224 ) ) ) {
F_291 ( V_244 , ( V_273 * ) V_226 , V_38 ) ;
return 0 ;
} else if ( F_57 ( F_237 ( V_224 ) ) )
return V_274 |
F_287 ( F_87 ( V_37 ) ) ;
}
V_226 = F_224 ( V_244 , V_38 , F_80 ( V_37 ) ) ;
if ( ! V_226 )
return V_259 ;
F_258 ( & V_272 ) ;
V_224 = F_219 ( V_226 ) ;
if ( F_226 ( V_224 ) ) {
V_10 = F_280 ( V_244 , V_15 , V_38 , V_226 , V_55 ) ;
goto V_275;
}
V_10 = 0 ;
if ( ( V_55 & V_269 ) && ! F_292 ( V_224 ) ) {
if ( F_121 ( V_37 , V_15 , V_38 ) < 0 ) {
V_10 = V_259 ;
goto V_275;
}
...
F_285 ( V_60 ) ;
F_8 ( & V_244 -> V_236 ) ;
if ( F_57 ( ! F_269 ( V_224 , F_219 ( V_226 ) ) ) )
goto V_276;
if ( V_55 & V_269 ) {
if ( ! F_292 ( V_224 ) ) {
V_10 = F_261 ( V_244 , V_15 , V_38 , V_226 , V_224 ,
V_253 ) ;
goto V_276;
}
V_224 = F_212 ( V_224 ) ;
...
V_224 = F_215 ( V_224 ) ;
if ( F_220 ( V_15 , V_38 , V_226 , V_224 ,
V_55 & V_269 ) )
F_221 ( V_15 , V_38 , V_226 ) ;
V_276:
F_2 ( & V_244 -> V_236 ) ;
...
struct V_60 *
F_293 ( struct V_227 * V_244 , unsigned long V_38 ,
T_12 * V_277 , int V_208 )
{
F_177 () ;
return NULL ;
}
int F_294 ( struct V_227 * V_244 , struct V_14 * V_15 ,
...
int V_284 ;
struct V_60 * V_60 ;
V_238 = F_223 ( V_244 , V_282 & F_240 ( V_37 ) ) ;
V_284 = ! V_238 || F_226 ( F_219 ( V_238 ) ) ;
if ( V_284 && ( V_55 & V_285 ) &&
! F_278 ( V_37 , V_15 , V_282 ) ) {
V_283 = 0 ;
break;
}
if ( V_284 ||
( ( V_55 & V_286 ) && ! F_292 ( F_219 ( V_238 ) ) ) ) {
int V_10 ;
F_2 ( & V_244 -> V_236 ) ;
V_10 = F_289 ( V_244 , V_15 , V_282 ,
( V_55 & V_286 ) ? V_269 : 0 ) ;
F_8 ( & V_244 -> V_236 ) ;
if ( ! ( V_10 & V_287 ) )
continue;
...
V_281 = ( V_282 & ~ F_240 ( V_37 ) ) >> V_43 ;
V_60 = F_228 ( F_219 ( V_238 ) ) ;
V_288:
if ( V_278 ) {
V_278 [ V_63 ] = F_295 ( V_60 , V_281 ) ;
F_229 ( V_278 [ V_63 ] ) ;
}
if ( V_279 )
V_279 [ V_63 ] = V_15 ;
...
struct V_36 * V_37 = F_32 ( V_15 ) ;
F_9 ( V_38 >= V_32 ) ;
F_297 ( V_15 , V_38 , V_32 ) ;
F_258 ( & V_15 -> V_16 -> V_132 -> V_252 ) ;
F_8 ( & V_244 -> V_236 ) ;
...
if ( ! F_226 ( F_219 ( V_226 ) ) ) {
V_238 = F_244 ( V_244 , V_38 , V_226 ) ;
V_238 = F_216 ( F_298 ( V_238 , V_290 ) ) ;
F_231 ( V_244 , V_38 , V_226 , V_238 ) ;
}
}
F_2 ( & V_244 -> V_236 ) ;
F_299 ( V_15 , V_219 , V_32 ) ;
F_260 ( & V_15 -> V_16 -> V_132 -> V_252 ) ;
}
int F_300 ( struct V_12 * V_12 ,
long V_28 , long V_27 ,
struct V_14 * V_15 ,
T_14 V_51 )
{
long V_10 , V_30 ;
struct V_36 * V_37 = F_301 ( V_12 ) ;
...
void F_302 ( struct V_12 * V_12 , long V_292 , long V_293 )
{
struct V_36 * V_37 = F_301 ( V_12 ) ;
long V_30 = F_22 ( & V_12 -> V_135 -> V_136 , V_292 ) ;
struct V_1 * V_2 = F_12 ( V_12 ) ;
F_8 ( & V_12 -> V_265 ) ;
V_12 -> V_266 -= ( F_284 ( V_37 ) * V_293 ) ;
F_2 ( & V_12 -> V_265 ) ;
F_11 ( V_2 , ( V_30 - V_293 ) ) ;
F_203 ( V_37 , - ( V_30 - V_293 ) ) ;
}
static int F_303 ( struct V_60 * V_294 )
{
struct V_60 * V_60 ;
struct V_60 * V_122 ;
