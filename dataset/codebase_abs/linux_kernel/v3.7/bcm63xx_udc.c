...
static int T_4 F_139 ( struct V_297 * V_298 )
{
...
if ( ! V_11 -> V_13 || ! V_11 -> V_15 ) {
F_34 ( V_117 , L_50 ) ;
return - V_304 ;
}
F_143 ( & V_11 -> V_190 ) ;
F_144 ( & V_11 -> V_201 , F_104 ) ;
F_145 ( & V_11 -> V_4 . V_117 , L_51 ) ;
...
F_146 ( V_117 ) , V_11 ) < 0 ) {
F_34 ( V_117 , L_53 , V_262 ) ;
goto V_310;
}
for ( V_35 = 0 ; V_35 < V_38 ; V_35 ++ ) {
V_262 = F_147 ( V_298 , V_35 + 1 ) ;
if ( V_262 < 0 ) {
F_34 ( V_117 , L_54 , V_35 + 1 ) ;
goto V_310;
}
...
V_125 = F_149 ( & V_11 -> V_4 . V_117 ) ;
if ( V_125 )
goto V_310;
F_132 ( V_11 ) ;
V_125 = F_150 ( V_117 , & V_11 -> V_4 ) ;
if ( ! V_125 )
return 0 ;
F_137 ( V_11 ) ;
F_151 ( & V_11 -> V_4 . V_117 ) ;
V_310:
F_55 ( V_11 ) ;
return V_125 ;
}
static int T_5 F_152 ( struct V_297 * V_298 )
{
struct V_1 * V_11 = F_153 ( V_298 ) ;
F_137 ( V_11 ) ;
F_154 ( & V_11 -> V_4 ) ;
F_151 ( & V_11 -> V_4 . V_117 ) ;
F_67 ( V_11 -> V_188 ) ;
