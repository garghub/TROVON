...
{
struct V_31 * V_32 ;
F_119 ( & V_8 -> V_100 , sizeof( * V_32 ) , 32 ) ;
V_32 = F_120 ( & V_8 -> V_100 ) ;
if ( ! V_32 )
return - V_37 ;
* V_32 = V_222 [ type ] ;
...
static void F_174 ( struct V_5 * V_6 , unsigned int V_113 )
{
switch ( V_113 >> 26 ) {
case V_374 :
F_172 ( V_6 ) ;
...
V_8 -> V_21 [ V_8 -> V_20 ++ ] =
V_392 ;
V_6 -> V_136 . V_160 = F_174 ;
V_6 -> V_136 . V_161 = F_173 ;
}
break;
case V_393 :
V_8 -> V_24 = 3 ;
