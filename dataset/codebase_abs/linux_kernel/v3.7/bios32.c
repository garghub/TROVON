...
static T_5 T_3 F_23 ( struct V_5 * V_6 , T_5 * V_62 )
{
...
static int F_25 ( const struct V_5 * V_6 , T_5 V_66 , T_5 V_62 )
{
struct V_63 * V_64 = V_6 -> V_65 ;
int V_70 = - 1 ;
if ( V_64 -> V_71 )
...
static int T_6 F_26 ( int V_72 , struct V_63 * V_64 )
{
int V_73 ;
struct V_74 * V_75 ;
if ( F_27 ( & V_64 -> V_76 ) ) {
...
static void T_6 F_32 ( struct V_88 * V_89 , struct V_12 * V_90 )
{
...
void T_6 F_40 ( struct V_88 * V_89 )
{
struct V_63 * V_64 ;
F_41 ( V_90 ) ;
F_42 ( V_100 ) ;
...
T_7 F_51 ( void * V_105 , const struct V_18 * V_79 ,
T_7 V_106 , T_7 V_107 )
{
T_7 V_20 = V_79 -> V_20 ;
...
void T_6 F_56 ( unsigned long V_130 )
{
struct V_131 V_132 = {
. V_133 = V_134 ,
. type = V_135 ,
