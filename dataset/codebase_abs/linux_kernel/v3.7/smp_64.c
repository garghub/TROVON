...
void F_102 ( struct V_151 * V_152 , unsigned long V_115 , unsigned long * V_177 )
{
T_5 V_140 = F_94 ( V_152 -> V_164 ) ;
int V_45 = F_85 () ;
...
F_61 ( & V_178 ,
V_140 , V_115 , ( unsigned long ) V_177 ,
F_76 ( V_152 ) ) ;
F_103 ( V_140 , V_115 , V_177 ) ;
F_86 () ;
}
void F_104 ( unsigned long V_179 , unsigned long V_180 )
{
V_179 &= V_181 ;
V_180 = F_105 ( V_180 ) ;
if ( V_179 != V_180 ) {
...
void T_6 F_114 ( int V_146 , struct V_147 * V_148 )
{
F_67 ( 1 << V_146 ) ;
F_20 () ;
...
int F_116 ( unsigned int V_188 )
{
return - V_189 ;
}
void T_7 F_117 ( unsigned int V_190 )
{
}
void T_8 F_118 ( void )
{
...
if ( F_5 ( V_3 ) . V_193 ==
F_5 ( V_191 ) . V_193 )
F_123 ( V_191 , & V_192 [ V_3 ] ) ;
}
}
F_121 (i) {
unsigned int V_191 ;
F_122 ( & F_124 ( V_194 , V_3 ) ) ;
if ( F_5 ( V_3 ) . V_195 == - 1 ) {
F_123 ( V_3 , & F_124 ( V_194 , V_3 ) ) ;
continue;
}
F_121 (j) {
if ( F_5 ( V_3 ) . V_195 ==
F_5 ( V_191 ) . V_195 )
F_123 ( V_191 , & F_124 ( V_194 , V_3 ) ) ;
}
}
}
int T_1 F_125 ( unsigned int V_45 , struct V_76 * V_196 )
{
int V_84 = F_40 ( V_45 , V_196 ) ;
if ( ! V_84 ) {
F_123 ( V_45 , & V_16 ) ;
while ( ! F_59 ( V_45 ) )
F_126 () ;
...
F_130 ( V_45 , & V_192 [ V_3 ] ) ;
F_122 ( & V_192 [ V_45 ] ) ;
F_58 (i, &per_cpu(cpu_sibling_map, cpu))
F_130 ( V_45 , & F_124 ( V_194 , V_3 ) ) ;
F_122 ( & F_124 ( V_194 , V_45 ) ) ;
V_205 = & F_5 ( V_45 ) ;
V_205 -> V_193 = 0 ;
V_205 -> V_195 = - 1 ;
F_134 () ;
...
void T_7 F_143 ( unsigned int V_190 )
{
F_144 () ;
}
void F_145 ( int V_45 )
...
void T_6 F_146 ( int V_146 , struct V_147 * V_148 )
{
F_67 ( 1 << V_146 ) ;
F_147 () ;
}
...
static void * T_7 F_149 ( unsigned int V_45 , T_10 V_208 ,
T_10 V_209 )
{
const unsigned long V_210 = F_39 ( V_211 ) ;
#ifdef F_150
int V_212 = F_151 ( V_45 ) ;
void * V_213 ;
if ( ! F_152 ( V_212 ) || ! F_153 ( V_212 ) ) {
V_213 = F_154 ( V_208 , V_209 , V_210 ) ;
F_155 ( L_33 ,
V_45 , V_212 ) ;
F_156 ( L_34 ,
V_45 , V_208 , F_39 ( V_213 ) ) ;
} else {
V_213 = F_157 ( F_153 ( V_212 ) ,
V_208 , V_209 , V_210 ) ;
F_156 ( L_35
L_36 , V_45 , V_208 , V_212 , F_39 ( V_213 ) ) ;
}
return V_213 ;
#else
return F_154 ( V_208 , V_209 , V_210 ) ;
#endif
}
static void T_7 F_158 ( void * V_213 , T_10 V_208 )
{
F_159 ( F_39 ( V_213 ) , V_208 ) ;
}
static int T_7 F_160 ( unsigned int V_214 , unsigned int V_215 )
{
if ( F_151 ( V_214 ) == F_151 ( V_215 ) )
return V_216 ;
else
return V_217 ;
}
static void T_7 F_161 ( unsigned long V_218 )
{
T_11 * V_154 = F_162 ( V_218 ) ;
T_12 * V_219 ;
T_13 * V_220 ;
V_219 = F_163 ( V_154 , V_218 ) ;
if ( F_164 ( * V_219 ) ) {
T_13 * V_221 ;
V_221 = F_154 ( V_222 , V_222 , V_222 ) ;
F_165 ( & V_12 , V_219 , V_221 ) ;
}
V_220 = F_166 ( V_219 , V_218 ) ;
if ( ! F_167 ( * V_220 ) ) {
T_14 * V_221 ;
V_221 = F_154 ( V_222 , V_222 , V_222 ) ;
F_168 ( & V_12 , V_220 , V_221 ) ;
}
}
void T_7 F_169 ( void )
{
...
if ( V_223 < 0 )
F_24 ( L_39 , V_223 ) ;
V_32 = ( unsigned long ) V_229 - ( unsigned long ) V_230 ;
F_173 (cpu)
F_8 ( V_45 ) = V_32 + V_231 [ V_45 ] ;
V_6 = F_8 ( F_23 () ) ;
F_174 () ;
if ( V_7 == V_8 )
F_175 ( V_232 ) ;
