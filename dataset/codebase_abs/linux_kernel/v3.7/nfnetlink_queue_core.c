...
switch ( V_185 -> V_188 ) {
case V_189 :
return F_97 ( F_86 ( V_185 -> V_82 ) ,
& V_190 ) ;
case V_191 :
return F_98 ( F_86 ( V_185 -> V_82 ) ,
& V_190 ) ;
}
}
F_73 () ;
...
V_197 = F_45 ( V_168 [ V_195 ] ) ;
F_70 ( V_32 , V_197 -> V_22 ,
F_82 ( V_197 -> V_21 ) ) ;
}
if ( V_168 [ V_198 ] ) {
T_4 * V_19 ;
...
V_76 = F_82 ( F_91 ( V_168 [ V_199 ] ) ) ;
V_200 = F_82 ( F_91 ( V_168 [ V_201 ] ) ) ;
if ( V_76 >= V_202 ) {
V_186 = - V_203 ;
goto V_142;
}
...
static struct V_6 * F_99 ( struct V_204 * V_205 )
{
struct V_206 * V_207 = V_205 -> V_208 ;
if ( ! V_207 )
return NULL ;
for ( V_207 -> V_209 = 0 ; V_207 -> V_209 < V_2 ; V_207 -> V_209 ++ ) {
if ( ! F_100 ( & V_9 [ V_207 -> V_209 ] ) )
return V_9 [ V_207 -> V_209 ] . V_210 ;
}
return NULL ;
}
static struct V_6 * F_101 ( struct V_204 * V_205 , struct V_6 * V_11 )
{
struct V_206 * V_207 = V_205 -> V_208 ;
V_11 = V_11 -> V_41 ;
while ( ! V_11 ) {
if ( ++ V_207 -> V_209 >= V_2 )
return NULL ;
V_11 = V_9 [ V_207 -> V_209 ] . V_210 ;
}
return V_11 ;
}
static struct V_6 * F_102 ( struct V_204 * V_205 , T_9 V_7 )
{
struct V_6 * V_5 ;
V_5 = F_99 ( V_205 ) ;
if ( V_5 )
while ( V_7 && ( V_5 = F_101 ( V_205 , V_5 ) ) )
V_7 -- ;
return V_7 ? NULL : V_5 ;
}
static void * F_103 ( struct V_204 * V_205 , T_9 * V_7 )
__acquires( V_13 )
{
F_5 ( & V_13 ) ;
return F_102 ( V_205 , * V_7 ) ;
}
static void * F_104 ( struct V_204 * V_211 , void * V_212 , T_9 * V_7 )
{
( * V_7 ) ++ ;
return F_101 ( V_211 , V_212 ) ;
}
static void F_105 ( struct V_204 * V_211 , void * V_212 )
__releases( V_13 )
{
F_11 ( & V_13 ) ;
}
static int F_106 ( struct V_204 * V_211 , void * V_212 )
{
const struct V_3 * V_8 = V_212 ;
return F_107 ( V_211 , L_6 ,
V_8 -> V_1 ,
V_8 -> V_18 , V_8 -> V_36 ,
V_8 -> V_22 , V_8 -> V_21 ,
V_8 -> V_137 , V_8 -> V_141 ,
...
static int F_108 ( struct V_213 * V_213 , struct V_214 * V_214 )
{
return F_109 ( V_214 , & V_215 ,
sizeof( struct V_206 ) ) ;
}
