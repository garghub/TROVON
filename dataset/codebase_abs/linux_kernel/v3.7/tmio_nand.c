...
{
struct V_72 * V_40 = V_31 -> V_31 . V_73 ;
struct V_74 * V_19 = F_30 ( V_31 ,
V_75 , 0 ) ;
struct V_74 * V_60 = F_30 ( V_31 ,
V_75 , 1 ) ;
int V_26 = F_31 ( V_31 , 0 ) ;
struct V_5 * V_6 ;
struct V_1 * V_2 ;
struct V_7 * V_7 ;
int V_76 ;
...
V_2 -> V_9 = V_7 ;
V_2 -> V_80 = L_7 ;
V_6 -> V_60 = F_34 ( V_60 -> V_81 , F_35 ( V_60 ) ) ;
if ( ! V_6 -> V_60 ) {
V_76 = - V_82 ;
goto V_83;
}
V_6 -> V_62 = V_19 -> V_81 & 0xfffff ;
V_6 -> V_19 = F_34 ( V_19 -> V_81 , F_35 ( V_19 ) ) ;
if ( ! V_6 -> V_19 ) {
V_76 = - V_82 ;
goto V_84;
}
...
V_7 -> V_99 = 15 ;
V_76 = F_36 ( V_26 , & F_6 ,
V_100 , F_37 ( & V_31 -> V_31 ) , V_6 ) ;
if ( V_76 ) {
F_38 ( & V_31 -> V_31 , L_8 , V_76 ) ;
goto V_101;
}
V_6 -> V_26 = V_26 ;
V_7 -> V_102 = F_11 ;
...
V_76 = F_40 ( V_2 , NULL , NULL ,
V_40 ? V_40 -> V_105 : NULL ,
V_40 ? V_40 -> V_106 : 0 ) ;
if ( ! V_76 )
return V_76 ;
F_41 ( V_2 ) ;
...
static int F_45 ( struct V_55 * V_31 )
{
struct V_5 * V_6 = F_46 ( V_31 ) ;
F_41 ( & V_6 -> V_2 ) ;
if ( V_6 -> V_26 )
F_42 ( V_6 -> V_26 , V_6 ) ;
F_28 ( V_31 , V_6 ) ;
...
static int F_47 ( struct V_55 * V_31 , T_4 V_35 )
{
const struct V_56 * V_57 = F_25 ( V_31 ) ;
if ( V_57 -> V_107 )
V_57 -> V_107 ( V_31 ) ;
...
static int F_48 ( struct V_55 * V_31 )
{
const struct V_56 * V_57 = F_25 ( V_31 ) ;
F_24 ( V_31 , F_46 ( V_31 ) ) ;
if ( V_57 -> V_108 )
