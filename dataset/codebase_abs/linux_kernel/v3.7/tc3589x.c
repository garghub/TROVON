...
static int T_4 F_30 ( struct V_1 * V_1 )
{
int V_3 = 0 ;
unsigned int V_47 = V_1 -> V_48 -> V_49 ;
if ( V_47 & V_50 ) {
V_3 = F_31 ( V_1 -> V_5 , - 1 , V_51 ,
F_32 ( V_51 ) , NULL ,
V_1 -> V_32 , V_1 -> V_20 ) ;
if ( V_3 ) {
F_3 ( V_1 -> V_5 , L_8 ) ;
...
static int T_4 F_35 ( struct V_57 * V_4 ,
...
if ( ! V_48 ) {
if ( V_30 ) {
V_48 = F_36 ( & V_4 -> V_5 , sizeof( * V_48 ) , V_62 ) ;
if ( ! V_48 )
return - V_63 ;
V_3 = F_33 ( V_30 , V_48 ) ;
if ( V_3 )
...
if ( ! F_37 ( V_4 -> V_64 , V_65
| V_66 ) )
return - V_67 ;
V_1 = F_38 ( sizeof( struct V_1 ) , V_62 ) ;
if ( ! V_1 )
return - V_63 ;
F_39 ( & V_1 -> V_11 ) ;
V_1 -> V_5 = & V_4 -> V_5 ;
...
if ( V_3 )
goto V_70;
V_3 = F_41 ( V_1 -> V_4 -> V_13 , NULL , F_13 ,
V_71 | V_72 ,
L_15 , V_1 ) ;
if ( V_3 ) {
...
return 0 ;
V_73:
F_42 ( V_1 -> V_4 -> V_13 , V_1 ) ;
V_70:
F_43 ( V_1 ) ;
return V_3 ;
}
static int T_5 F_44 ( struct V_57 * V_74 )
{
struct V_1 * V_1 = F_45 ( V_74 ) ;
F_46 ( V_1 -> V_5 ) ;
F_42 ( V_1 -> V_4 -> V_13 , V_1 ) ;
F_43 ( V_1 ) ;
return 0 ;
}
static int F_47 ( struct V_75 * V_5 )
{
struct V_1 * V_1 = F_48 ( V_5 ) ;
struct V_57 * V_74 = V_1 -> V_4 ;
int V_3 = 0 ;
if ( ! F_49 ( & V_74 -> V_5 ) )
V_3 = F_4 ( V_1 , V_76 ,
V_77 ) ;
...
static int F_50 ( struct V_75 * V_5 )
{
struct V_1 * V_1 = F_48 ( V_5 ) ;
struct V_57 * V_74 = V_1 -> V_4 ;
int V_3 = 0 ;
