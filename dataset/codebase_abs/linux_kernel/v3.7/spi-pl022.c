...
static T_4 F_66 ( int V_166 , void * V_167 )
{
...
static int T_2
F_99 ( struct V_302 * V_27 , const struct V_303 * V_304 )
{
...
for ( V_87 = 0 ; V_87 < V_307 ; V_87 ++ ) {
int V_322 = F_107 ( V_247 , L_80 , V_87 ) ;
if ( V_322 == - V_323 ) {
V_184 = - V_323 ;
goto V_324;
}
V_2 -> V_196 [ V_87 ] = V_322 ;
if ( F_4 ( V_322 ) ) {
if ( F_108 ( V_28 , V_322 , L_81 ) )
F_62 ( & V_27 -> V_28 ,
L_82 ,
V_322 ) ;
else if ( F_109 ( V_322 , 1 ) )
F_62 ( & V_27 -> V_28 ,
L_83 ,
V_322 ) ;
}
...
V_17 -> V_325 = V_279 | V_283 | V_326 | V_289 ;
if ( V_2 -> V_34 -> V_35 )
V_17 -> V_325 |= V_268 ;
F_15 ( & V_27 -> V_28 , L_84 , V_17 -> V_316 ) ;
V_184 = F_110 ( V_27 , NULL ) ;
if ( V_184 )
goto V_327;
V_2 -> V_105 = V_27 -> V_328 . V_329 ;
V_2 -> V_23 = F_111 ( V_28 , V_27 -> V_328 . V_329 ,
F_112 ( & V_27 -> V_328 ) ) ;
if ( V_2 -> V_23 == NULL ) {
V_184 = - V_155 ;
goto V_330;
