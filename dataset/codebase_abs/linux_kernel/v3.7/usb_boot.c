...
#endif
if ( V_24 . V_34 > V_35 ) {
F_6 ( V_10 L_6 , V_24 . V_34 ) ;
V_8 = - V_36 ;
goto V_33;
}
for ( V_3 = 0 ; V_3 < V_24 . V_34 ; V_3 ++ ) {
if ( V_24 . V_37 [ V_3 ] > V_24 . V_7 ) {
F_6 ( V_10 L_7
L_8
L_9 ,
V_3 , V_24 . V_37 [ V_3 ] , V_24 . V_7 ) ;
V_8 = - V_36 ;
goto V_33;
}
V_13 = V_24 . V_37 [ V_3 ] ;
...
#endif
if ( ( V_25 . V_38 & 0xffff ) != V_22 )
continue;
V_13 = V_24 . V_37 [ V_3 ] + V_25 . V_39 ;
if ( V_12 -> V_18 < V_25 . V_40 + V_13 ) {
F_6 ( V_10 L_11 ) ;
goto V_33;
}
...
goto V_33;
F_6 ( V_42 L_12 ) ;
V_13 = V_24 . V_37 [ V_3 ] + V_25 . V_43 ;
if ( V_12 -> V_18 < V_25 . V_44 + V_13 ) {
F_6 ( V_10 L_13 ) ;
goto V_33;
}
V_8 = F_9 ( V_5 , V_12 , V_13 , V_25 . V_44 ,
V_45 ) ;
if ( V_8 < 0 )
goto V_33;
F_6 ( V_42 L_14 ) ;
...
static int F_17 ( struct V_4 * V_5 , int V_46 )
{
int V_47 ;
int V_8 = - 1 ;
if ( V_46 ) {
...
V_8 = F_7 ( V_5 , & V_47 , sizeof( V_47 ) ) ;
if ( V_8 < 0 )
goto V_33;
V_33:
return V_8 ;
}
static int F_18 ( struct V_4 * V_5 , const char * V_26 ,
char * V_48 )
{
char * V_49 = NULL ;
T_2 V_13 = 0 ;
...
V_49 = F_14 ( V_52 + V_51 , V_30 ) ;
if ( V_49 == NULL ) {
F_6 ( V_10 L_4 ) ;
return - V_31 ;
}
strcpy ( V_49 + V_51 , V_48 ) ;
V_8 = F_3 ( V_5 , V_49 , strlen ( V_48 ) + V_51 ) ;
if ( V_8 < 0 )
goto V_33;
V_14 = V_12 -> V_18 ;
if ( V_14 <= 0 ) {
...
V_7 = V_14 ;
memcpy ( V_49 + V_51 , V_12 -> V_6 + V_13 , V_7 ) ;
V_8 = F_3 ( V_5 , V_49 , V_7 + V_51 ) ;
if ( V_8 < 0 )
goto V_33;
V_14 -= V_52 ;
V_13 += V_52 ;
V_8 = F_17 ( V_5 , ( ( V_7 + V_51 ) % 512 == 0 ) ) ;
if ( V_8 < 0 )
goto V_33;
}
V_8 = F_17 ( V_5 , 1 ) ;
...
const char * V_55 = V_27 V_56 ;
V_8 = F_18 ( V_5 , V_53 , V_57 ) ;
if ( V_8 < 0 )
return V_8 ;
F_6 ( V_42 L_16 ) ;
V_8 = F_18 ( V_5 , V_55 , V_58 ) ;
if ( V_8 < 0 )
return V_8 ;
F_6 ( V_42 L_17 ) ;
V_8 = F_20 ( V_5 ) ;
