...
V_118 = F_112 ( strlen ( V_115 -> V_28 ) + 1 , ( V_204 ) V_202 ) ;
memcpy ( V_201 , V_115 -> V_28 , V_118 ) ;
F_10 ( V_109 , L_21 ,
V_129 -> V_135 . V_56 , V_115 -> V_28 , V_202 , V_201 ) ;
V_167:
F_57 ( V_115 ) ;
F_58 ( V_115 ) ;
return V_118 ;
}
static void * F_113 ( struct V_129 * V_129 , struct V_205 * V_206 )
{
int V_142 = 0 ;
char * V_207 = F_114 () ;
...
V_142 = F_111 ( V_129 , V_207 , V_208 ) ;
if ( V_142 < 0 ) {
F_115 ( V_207 ) ;
V_207 = F_34 ( V_142 ) ;
} else
V_207 [ F_112 ( V_142 , V_208 - 1 ) ] = 0 ;
}
F_116 ( V_206 , V_207 ) ;
return NULL ;
}
void
F_117 ( struct V_129 * V_129 , struct V_205 * V_206 , void * V_209 )
{
char * V_210 = F_118 ( V_206 ) ;
F_10 ( V_109 , L_23 ,
V_129 -> V_135 . V_56 , F_55 ( V_210 ) ? L_24 : V_210 ) ;
if ( ! F_55 ( V_210 ) )
F_115 ( V_210 ) ;
}
static int F_119 ( struct V_63 * V_128 , struct V_129 * V_129 ,
...
static int
F_120 ( struct V_63 * V_128 , struct V_129 * V_129 , const char * V_211 )
{
F_10 ( V_109 , L_26 ,
V_128 -> V_119 , V_129 -> V_135 . V_56 , V_211 ) ;
return F_119 ( V_128 , V_129 , V_21 , V_211 ) ;
}
static int
F_121 ( struct V_129 * V_160 , struct V_63 * V_128 ,
struct V_129 * V_129 )
{
int V_118 ;
char * V_56 ;
...
V_118 = F_119 ( V_128 , V_129 , V_138 , V_56 ) ;
F_115 ( V_56 ) ;
if ( ! V_118 ) {
F_123 ( V_164 , V_160 -> V_133 ) ;
F_68 ( V_128 ) ;
}
V_212:
F_41 ( V_164 ) ;
...
static int
F_124 ( struct V_63 * V_128 , struct V_129 * V_129 , T_2 V_3 , T_3 V_19 )
{
struct V_1 * V_2 = F_43 ( V_128 ) ;
int V_118 ;
char * V_56 ;
...
return - V_112 ;
if ( F_6 ( V_3 ) )
sprintf ( V_56 , L_29 , F_125 ( V_19 ) , F_126 ( V_19 ) ) ;
else if ( F_7 ( V_3 ) )
sprintf ( V_56 , L_30 , F_125 ( V_19 ) , F_126 ( V_19 ) ) ;
else if ( F_5 ( V_3 ) )
* V_56 = 0 ;
else if ( F_4 ( V_3 ) )
* V_56 = 0 ;
...
V_136 = F_1 ( V_2 , V_3 ) ;
V_118 = F_119 ( V_128 , V_129 , V_136 , V_56 ) ;
F_115 ( V_56 ) ;
return V_118 ;
}
int F_123 ( struct V_122 * V_123 , struct V_63 * V_63 )
{
int V_114 ;
T_3 V_19 ;
T_7 V_213 ;
