...
F_66 (bvec, bio, i) {
V_92 = ( unsigned long )
F_67 ( V_90 -> V_100 ) + V_90 -> V_101 ;
V_93 = V_4 -> V_23 + ( V_91 << 12 ) + V_94 ;
if ( F_68 ( ( V_92 & 4095 ) != 0 ) || ( V_90 -> V_102 & 4095 ) != 0 )
goto V_96;
if ( F_64 ( V_88 ) == V_103 ) {
...
static int
F_71 ( struct V_79 * V_80 , T_4 V_104 ,
...
V_26 = F_89 ( V_55 , & V_120 ) ;
if ( V_26 )
goto V_121;
V_26 = F_89 ( V_55 , & V_122 ) ;
if ( V_26 )
goto V_121;
V_26 = F_90 ( 0 , V_117 ) ;
if ( V_26 < 0 )
