...
static int T_5 F_54 ( struct V_1 * V_4 ,
struct V_83 * V_84 )
{
int V_13 ;
...
static int T_5 F_56 ( struct V_87 * V_88 )
{
struct V_20 * V_20 ;
struct V_83 * V_84 ;
struct V_1 * V_4 ;
...
if ( V_88 -> V_5 < 0 || V_88 -> V_5 >= V_91 ) {
F_12 ( & V_88 -> V_14 , L_12 , V_88 -> V_5 ) ;
return - V_56 ;
}
V_4 = F_57 ( & V_88 -> V_14 , sizeof( * V_4 ) , V_92 ) ;
if ( ! V_4 )
return - V_93 ;
V_4 -> V_20 = V_20 ;
V_4 -> V_3 . V_94 = V_84 -> V_94 ;
V_4 -> V_3 . V_95 = V_84 -> V_95 ;
V_4 -> V_3 . V_96 = F_17 ;
V_4 -> V_3 . V_97 = F_19 ;
V_4 -> V_3 . V_98 = F_29 ;
V_4 -> V_3 . V_99 = V_100 ;
...
F_60 ( V_88 , V_4 ) ;
V_13 = F_61 ( V_88 -> V_14 . V_89 , & V_4 -> V_3 ) ;
if ( V_13 ) {
F_12 ( & V_88 -> V_14 , L_13 , V_88 -> V_5 ) ;
return V_13 ;
}
V_4 -> V_25 . V_14 = V_4 -> V_3 . V_14 ;
V_13 = F_62 ( & V_4 -> V_3 . V_14 -> V_76 ,
& V_101 ) ;
if ( V_13 < 0 ) {
F_12 ( & V_88 -> V_14 , L_14 ) ;
goto V_102;
...
return 0 ;
V_103:
F_64 ( & V_4 -> V_3 . V_14 -> V_76 , & V_101 ) ;
V_102:
F_65 ( & V_4 -> V_3 ) ;
F_66 ( & V_4 -> V_23 ) ;
return V_13 ;
}
static int T_6 F_67 ( struct V_87 * V_88 )
{
struct V_1 * V_4 = F_68 ( V_88 ) ;
F_8 ( & V_88 -> V_14 , L_10 , V_15 ) ;
F_69 ( & V_4 -> V_25 ) ;
F_64 ( & V_4 -> V_3 . V_14 -> V_76 , & V_101 ) ;
F_65 ( & V_4 -> V_3 ) ;
