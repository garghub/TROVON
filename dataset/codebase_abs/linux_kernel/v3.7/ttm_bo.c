...
static int F_58 ( struct V_6 * V_7 , bool V_115 )
{
struct V_33 * V_34 = V_7 -> V_34 ;
struct V_20 * V_116 = NULL ;
int V_24 = 0 ;
F_28 ( & V_34 -> V_64 ) ;
if ( F_11 ( & V_7 -> V_45 ) )
goto V_117;
...
F_21 ( & V_116 -> V_38 ) ;
for (; ; ) {
struct V_20 * V_118 = NULL ;
if ( V_116 -> V_45 . V_119 != & V_7 -> V_45 ) {
V_118 = F_59 ( & V_116 -> V_45 ,
struct V_20 , V_45 ) ;
F_21 ( & V_118 -> V_38 ) ;
}
F_27 ( & V_34 -> V_64 ) ;
V_24 = F_57 ( V_116 , false , ! V_115 ,
! V_115 ) ;
F_60 ( & V_116 -> V_38 , F_9 ) ;
V_116 = V_118 ;
if ( V_24 || ! V_116 )
...
{
struct V_6 * V_7 =
F_6 ( V_122 , struct V_6 , V_111 . V_122 ) ;
if ( F_58 ( V_7 , false ) ) {
F_56 ( & V_7 -> V_111 ,
( ( V_112 / 100 ) < 1 ) ? 1 : V_112 / 100 ) ;
}
...
if ( F_35 ( V_21 -> V_123 != NULL ) ) {
F_63 ( & V_21 -> V_124 , & V_7 -> V_125 ) ;
F_64 ( V_21 -> V_123 ) ;
V_21 -> V_123 = NULL ;
}
F_65 ( & V_7 -> V_126 ) ;
...
void F_68 ( struct V_20 * * V_127 )
{
struct V_20 * V_21 = * V_127 ;
struct V_6 * V_7 = V_21 -> V_7 ;
* V_127 = NULL ;
F_67 ( & V_7 -> V_126 ) ;
F_60 ( & V_21 -> V_37 , F_62 ) ;
...
void F_71 ( struct V_6 * V_7 , int V_128 )
{
if ( V_128 )
F_56 ( & V_7 -> V_111 ,
( ( V_112 / 100 ) < 1 ) ? 1 : V_112 / 100 ) ;
...
V_129 = V_21 -> V_25 ;
V_129 . V_43 = NULL ;
V_129 . V_131 . V_132 = false ;
V_129 . V_131 . V_133 = 0 ;
V_23 . V_134 = 0 ;
V_23 . V_135 = 0 ;
V_23 . V_27 = 0 ;
V_23 . V_136 = 0 ;
V_7 -> V_75 -> V_137 ( V_21 , & V_23 ) ;
V_24 = F_73 ( V_21 , & V_23 , & V_129 , V_49 ,
V_85 , V_86 ) ;
if ( V_24 ) {
if ( V_24 != - V_130 ) {
F_3 ( L_14 ,
...
V_24 = F_41 ( V_21 , & V_129 , true , V_49 ,
V_85 , V_86 ) ;
if ( V_24 ) {
if ( V_24 != - V_130 )
F_3 ( L_15 ) ;
...
int V_24 ;
do {
V_24 = (* V_9 -> V_17 -> V_139 )( V_9 , V_21 , V_23 , V_25 ) ;
if ( F_25 ( V_24 != 0 ) )
return V_24 ;
if ( V_25 -> V_43 )
break;
...
T_1 V_140 )
{
T_1 V_141 = V_140 & V_91 ;
T_1 V_142 = V_140 & ~ V_91 ;
if ( ( V_103 & V_141 ) != 0 )
V_142 |= ( V_103 & V_141 ) ;
else if ( ( V_9 -> V_15 & V_141 ) != 0 )
V_142 |= V_9 -> V_15 ;
...
{
T_1 V_147 = F_8 ( V_2 ) ;
if ( ( V_147 & V_140 & V_148 ) == 0 )
return false ;
if ( ( V_140 & V_9 -> V_14 ) == 0 )
return false ;
V_147 |= ( V_140 & V_9 -> V_14 ) ;
* V_146 = V_147 ;
return true ;
}
...
if ( ! V_150 )
continue;
V_147 = F_76 ( V_9 , V_21 -> V_25 . V_23 ,
V_147 ) ;
F_78 ( & V_147 , V_23 -> V_23 [ V_3 ] ,
~ V_152 ) ;
if ( V_2 == V_16 )
break;
...
if ( ! V_149 )
return - V_5 ;
for ( V_3 = 0 ; V_3 < V_23 -> V_136 ; ++ V_3 ) {
V_24 = F_1 ( V_23 -> V_153 [ V_3 ] ,
& V_2 ) ;
if ( V_24 )
return V_24 ;
V_9 = & V_7 -> V_9 [ V_2 ] ;
...
V_25 . V_154 = V_21 -> V_25 . V_154 ;
V_25 . V_131 . V_132 = false ;
V_25 . V_131 . V_133 = 0 ;
...
{
int V_3 ;
if ( V_25 -> V_43 && V_23 -> V_135 != 0 &&
( V_25 -> V_102 < V_23 -> V_134 ||
V_25 -> V_102 + V_25 -> V_26 > V_23 -> V_135 ) )
return - 1 ;
for ( V_3 = 0 ; V_3 < V_23 -> V_27 ; V_3 ++ ) {
...
int V_24 ;
F_10 ( ! F_7 ( & V_21 -> V_51 ) ) ;
if ( V_23 -> V_135 || V_23 -> V_134 )
if ( V_23 -> V_134 > V_23 -> V_135 ||
( V_23 -> V_135 - V_23 -> V_134 ) < V_21 -> V_26 )
return - V_5 ;
...
struct V_22 * V_23 )
{
F_10 ( ( V_23 -> V_134 || V_23 -> V_135 ) &&
( V_21 -> V_25 . V_26 > ( V_23 -> V_135 - V_23 -> V_134 ) ) ) ;
return 0 ;
}
...
int V_24 = 0 ;
unsigned long V_26 ;
struct V_160 * V_48 = V_7 -> V_34 -> V_48 ;
...
V_21 -> V_25 . V_43 = NULL ;
V_21 -> V_25 . V_154 = V_154 ;
V_21 -> V_25 . V_131 . V_132 = false ;
V_21 -> V_25 . V_131 . V_133 = 0 ;
V_21 -> V_156 = V_156 & V_161 ;
V_21 -> V_163 = 0 ;
V_21 -> V_25 . V_23 = ( V_164 | V_143 ) ;
V_21 -> V_59 = false ;
V_21 -> V_158 = V_158 ;
V_21 -> V_39 = V_39 ;
V_21 -> V_82 = V_82 ;
...
unsigned V_166 )
{
unsigned V_167 = ( F_92 ( V_165 ) ) >> V_77 ;
T_3 V_13 = 0 ;
V_13 += F_93 ( V_166 ) ;
V_13 += F_92 ( V_167 * sizeof( void * ) ) ;
V_13 += F_93 ( sizeof( struct V_168 ) ) ;
return V_13 ;
}
...
V_13 += F_93 ( V_166 ) ;
V_13 += F_92 ( V_167 * sizeof( void * ) ) ;
V_13 += F_92 ( V_167 * sizeof( V_169 ) ) ;
V_13 += F_93 ( sizeof( struct V_170 ) ) ;
return V_13 ;
}
...
T_3 V_39 ;
int V_24 ;
V_21 = F_96 ( sizeof( * V_21 ) , V_171 ) ;
if ( F_25 ( V_21 == NULL ) )
return - V_79 ;
V_39 = F_91 ( V_7 , V_13 , sizeof( struct V_20 ) ) ;
V_24 = F_84 ( V_7 , V_21 , V_13 , type , V_23 , V_154 ,
V_156 , V_49 ,
V_158 , V_39 , NULL , NULL ) ;
if ( F_35 ( V_24 == 0 ) )
* V_127 = V_21 ;
return V_24 ;
}
static int F_97 ( struct V_6 * V_7 ,
unsigned V_2 , bool V_172 )
{
struct V_8 * V_9 = & V_7 -> V_9 [ V_2 ] ;
struct V_33 * V_34 = V_7 -> V_34 ;
int V_24 ;
...
F_101 ( & V_9 -> V_178 ) ;
F_88 ( & V_9 -> V_162 ) ;
V_24 = V_7 -> V_75 -> V_179 ( V_7 , type , V_9 ) ;
if ( V_24 )
return V_24 ;
V_9 -> V_7 = V_7 ;
V_24 = 0 ;
if ( type != V_16 ) {
V_24 = (* V_9 -> V_17 -> V_180 )( V_9 , V_175 ) ;
if ( V_24 )
return V_24 ;
}
V_9 -> V_10 = true ;
...
struct V_33 * V_34 =
F_6 ( V_29 , struct V_33 , V_29 ) ;
F_103 ( V_34 -> V_48 , & V_34 -> V_181 ) ;
F_104 ( V_34 -> V_78 ) ;
F_14 ( V_34 ) ;
}
void F_105 ( struct V_182 * V_183 )
{
struct V_33 * V_34 = V_183 -> V_184 ;
F_106 ( & V_34 -> V_29 ) ;
F_107 ( & V_34 -> V_29 ) ;
}
int F_108 ( struct V_182 * V_183 )
{
struct V_185 * V_186 =
...
F_101 ( & V_34 -> V_187 ) ;
F_109 ( & V_34 -> V_64 ) ;
V_34 -> V_48 = V_186 -> V_48 ;
V_34 -> V_78 = F_110 ( V_188 | V_189 ) ;
...
F_88 ( & V_34 -> V_54 ) ;
F_88 ( & V_34 -> V_191 ) ;
F_111 ( & V_34 -> V_181 , V_192 ) ;
V_24 = F_112 ( V_34 -> V_48 , & V_34 -> V_181 ) ;
if ( F_25 ( V_24 != 0 ) ) {
F_3 ( L_23 ) ;
goto V_193;
}
...
goto V_197;
V_7 -> V_125 = V_198 ;
V_24 = F_124 ( & V_7 -> V_195 , V_196 , 0x10000000 ) ;
if ( F_25 ( V_24 != 0 ) )
goto V_199;
...
{
struct V_6 * V_7 = V_21 -> V_7 ;
T_5 V_101 = ( T_5 ) V_21 -> V_203 ;
T_5 V_204 = ( ( T_5 ) V_21 -> V_25 . V_26 ) << V_77 ;
if ( ! V_7 -> V_201 )
return;
F_126 ( V_7 -> V_201 , V_101 , V_204 , 1 ) ;
F_66 ( V_21 ) ;
}
...
{
struct V_6 * V_7 = V_21 -> V_7 ;
struct V_205 * * V_206 = & V_7 -> V_125 . V_205 ;
struct V_205 * V_207 = NULL ;
struct V_20 * V_208 ;
unsigned long V_101 = V_21 -> V_123 -> V_102 ;
unsigned long V_209 ;
while ( * V_206 ) {
V_207 = * V_206 ;
V_208 = F_129 ( V_207 , struct V_20 , V_124 ) ;
V_209 = V_208 -> V_123 -> V_102 ;
if ( V_101 < V_209 )
V_206 = & V_207 -> V_210 ;
else if ( V_101 > V_209 )
V_206 = & V_207 -> V_211 ;
...
F_130 ( & V_21 -> V_124 , V_207 , V_206 ) ;
F_131 ( & V_21 -> V_124 , & V_7 -> V_125 ) ;
}
...
int V_24 ;
V_212:
V_24 = F_132 ( & V_7 -> V_195 ) ;
if ( F_25 ( V_24 != 0 ) )
return V_24 ;
F_67 ( & V_7 -> V_126 ) ;
V_21 -> V_123 = F_133 ( & V_7 -> V_195 ,
V_21 -> V_25 . V_26 , 0 , 0 ) ;
if ( F_25 ( V_21 -> V_123 == NULL ) ) {
V_24 = - V_79 ;
goto V_117;
}
V_21 -> V_123 = F_134 ( V_21 -> V_123 ,
V_21 -> V_25 . V_26 , 0 ) ;
if ( F_25 ( V_21 -> V_123 == NULL ) ) {
F_65 ( & V_7 -> V_126 ) ;
goto V_212;
...
F_128 ( V_21 ) ;
F_65 ( & V_7 -> V_126 ) ;
V_21 -> V_203 = ( ( T_4 ) V_21 -> V_123 -> V_102 ) << V_77 ;
return 0 ;
V_117:
F_65 ( & V_7 -> V_126 ) ;
return V_24 ;
...
bool V_213 , bool V_49 , bool V_56 )
{
...
return 0 ;
while ( V_21 -> V_42 ) {
if ( V_75 -> V_214 ( V_21 -> V_42 , V_21 -> V_105 ) ) {
void * V_215 = V_21 -> V_42 ;
V_21 -> V_42 = NULL ;
F_135 ( V_216 , & V_21 -> V_163 ) ;
F_27 ( & V_7 -> V_106 ) ;
V_75 -> V_110 ( & V_215 ) ;
F_28 ( & V_7 -> V_106 ) ;
continue;
...
static int V_192 ( struct V_218 * V_181 )
{
struct V_33 * V_34 =
F_6 ( V_181 , struct V_33 , V_181 ) ;
struct V_20 * V_21 ;
int V_24 = - V_63 ;
int V_55 ;
T_1 V_219 = ( V_143 | V_164 ) ;
F_28 ( & V_34 -> V_64 ) ;
while ( V_24 == - V_63 ) {
...
if ( F_25 ( V_24 != 0 ) )
goto V_120;
if ( ( V_21 -> V_25 . V_23 & V_219 ) != V_219 ) {
struct V_83 V_129 ;
V_129 = V_21 -> V_25 ;
V_129 . V_43 = NULL ;
V_129 . V_23 = V_164 | V_143 ;
V_129 . V_2 = V_16 ;
V_24 = F_41 ( V_21 , & V_129 , true ,
false , false , false ) ;
if ( F_25 ( V_24 != 0 ) )
goto V_120;
}
F_127 ( V_21 ) ;
if ( V_21 -> V_7 -> V_75 -> V_220 )
V_21 -> V_7 -> V_75 -> V_220 ( V_21 ) ;
V_24 = F_139 ( V_21 -> V_46 , V_21 -> V_158 ) ;
V_120:
F_37 ( & V_21 -> V_51 , 0 ) ;
F_29 ( & V_21 -> V_50 ) ;
F_60 ( & V_21 -> V_38 , F_9 ) ;
