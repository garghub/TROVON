...
F_35 ( V_40 -> V_67 , ( T_1 * ) V_8 ) ;
F_36 ( V_40 -> V_68 ) ;
V_2 -> V_30 = false ;
F_17 ( V_2 -> V_21 -> V_31 ) ;
return V_69 ;
}
static T_2 F_37 ( int V_31 , void * V_70 )
{
struct V_1 * V_2 = V_70 ;
F_38 ( & V_2 -> V_29 ) ;
F_19 ( V_31 ) ;
...
int F_41 ( struct V_39 * V_40 , struct V_71 * V_68 )
{
struct V_1 * V_2 = F_23 ( V_40 ) ;
if ( V_2 -> V_68 != V_68 )
return - V_20 ;
...
V_2 -> V_68 -> V_80 . V_81 = & V_2 -> V_21 -> V_80 ;
V_2 -> V_68 -> V_82 = V_2 ;
V_17 = F_46 ( V_2 -> V_68 ) ;
if ( V_17 )
goto V_83;
...
struct V_86 * V_21 , const struct V_87 * V_18 )
{
V_2 -> V_21 = V_21 ;
V_2 -> V_18 = V_18 ;
F_56 ( V_40 , V_2 ) ;
