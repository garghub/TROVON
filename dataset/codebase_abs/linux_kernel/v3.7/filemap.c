...
if ( ! F_153 ( V_1 , V_154 -> V_165 , V_159 -> V_42 ) ) {
F_21 ( V_1 ) ;
return V_20 | V_168 ;
}
if ( F_100 ( V_1 -> V_3 != V_3 ) ) {
...
struct V_99 * V_99 = V_154 -> V_160 -> V_172 . V_173 -> V_174 ;
int V_20 = V_170 ;
F_156 ( V_99 -> V_175 ) ;
F_157 ( V_154 -> V_160 ) ;
F_106 ( V_1 ) ;
if ( V_1 -> V_3 != V_99 -> V_176 ) {
F_81 ( V_1 ) ;
V_20 = V_177 ;
goto V_58;
}
...
{
if ( ( V_154 -> V_181 & V_182 ) && ( V_154 -> V_181 & V_183 ) )
return - V_140 ;
...
if ( F_56 ( ! V_195 ) ) {
if ( F_100 ( * V_144 >= V_99 -> V_175 -> V_204 ) ) {
if ( * V_106 || * V_144 > V_99 -> V_175 -> V_204 ) {
return - V_201 ;
}
}
if ( F_100 ( * V_144 + * V_106 > V_99 -> V_175 -> V_204 ) )
* V_106 = V_99 -> V_175 -> V_204 - * V_144 ;
} else {
#ifdef F_185
T_1 V_109 ;
if ( F_186 ( F_187 ( V_99 ) ) )
