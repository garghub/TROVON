...
static T_2 F_102 ( struct V_2 * V_3 )
{
struct V_223 V_7 ;
struct V_224 * V_225 ;
struct V_1 * V_4 ;
...
V_225 -> V_110 = V_236 ;
V_225 -> V_112 = V_237 ;
F_19 ( V_3 , V_238 , & V_7 , sizeof V_7 ) ;
if ( V_225 -> V_110 == V_115 &&
V_225 -> V_112 == V_239 ) {
struct V_240 * V_241 ;
V_241 = V_227 ;
V_228 = V_241 -> V_228 ;
...
F_103 ( V_4 , L_23 ,
V_225 -> V_110 , V_225 -> V_112 ) ;
F_99 ( V_3 -> V_4 , V_76 , V_227 , V_226 ) ;
exit:
return V_228 ;
}
static int T_4 F_104 ( struct V_242 * V_243 ,
const struct V_244 * V_32 )
{
struct V_2 * V_3 ;
struct V_183 * V_184 ;
struct V_1 * V_4 ;
...
if ( F_105 ( V_243 ) )
return error ;
if ( F_106 ( V_243 , F_107 ( 64 ) ) == 0 &&
F_108 ( V_243 , F_107 ( 64 ) ) == 0 ) {
F_67 ( V_187 L_24 ) ;
} else if ( F_106 ( V_243 , F_107 ( 32 ) ) == 0 &&
F_108 ( V_243 , F_107 ( 32 ) ) == 0 ) {
F_67 ( V_187 L_25 ) ;
} else {
F_67 ( V_162 L_26 ) ;
goto V_246;
...
V_82 ;
V_193 . V_194 =
F_44 ( V_193 . V_247 , V_248 ) ;
V_184 = F_109 ( & V_193 , sizeof( struct V_2 ) ) ;
if ( ! V_184 ) {
F_67 ( V_162 L_27 ) ;
goto V_246;
}
...
V_184 -> V_251 = 1 ;
V_184 -> V_252 = 16 ;
V_3 -> V_192 = V_243 -> V_253 ;
if ( F_111 ( V_243 , L_28 ) ) {
F_67 ( V_162 L_29 ) ;
goto V_254;
}
for ( V_27 = 0 ; V_27 < V_255 ; V_27 ++ ) {
if ( ( F_112 ( V_243 , V_27 ) & V_256 ) )
continue;
if ( F_113 ( V_243 , V_27 ) < V_257 )
continue;
break;
}
if ( V_27 == V_255 ) {
...
V_3 -> V_17 = F_114 ( V_243 , V_27 , V_257 ) ;
if ( ! V_3 -> V_17 ) {
F_67 ( V_162
L_31 ,
V_27 , V_257 ) ;
...
V_184 -> V_250 = F_102 ( V_3 ) ;
V_4 = F_1 ( V_3 ) ;
F_117 ( V_4 , L_33 , V_184 -> V_250 ) ;
F_46 ( V_3 ) ;
V_3 -> V_10 = F_118 ( V_3 -> V_11 ,
...
F_67 ( V_187 L_36 ) ;
V_3 -> V_214 = 1 ;
} else if ( ! V_261 && F_120 ( V_243 ) == 0 ) {
F_67 ( V_187 L_37 ) ;
V_3 -> V_213 = 1 ;
V_3 -> V_210 = V_243 -> V_210 ;
} else {
F_67 ( V_187 L_38 ) ;
V_3 -> V_210 = V_243 -> V_210 ;
V_58 = V_262 ;
}
error = F_121 ( V_3 -> V_210 , F_82 , V_58 ,
L_28 , V_3 ) ;
if ( error ) {
F_67 ( V_162
L_39 , error ) ;
...
error = F_122 ( V_184 , & V_243 -> V_4 ) ;
if ( error ) {
F_67 ( V_162
L_40 , error ) ;
goto V_259;
}
F_117 ( & V_243 -> V_4 , L_41 ,
...
static void F_126 ( struct V_242 * V_4 )
{
struct V_183 * V_184 = F_127 ( V_4 ) ;
struct V_2 * V_3 = F_57 ( V_184 ) ;
F_125 ( V_3 ) ;
}
static void F_128 ( struct V_242 * V_243 )
{
struct V_183 * V_184 = F_127 ( V_243 ) ;
struct V_2 * V_3 = F_57 ( V_184 ) ;
F_129 ( V_184 ) ;
F_125 ( V_3 ) ;
F_94 ( V_3 ) ;
