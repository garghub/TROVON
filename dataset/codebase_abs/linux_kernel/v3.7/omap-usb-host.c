...
( F_22 ( V_9 -> V_54 [ 0 ] ) ) )
V_2 |= V_82 ;
else if ( F_45 ( V_9 -> V_54 [ 0 ] ) )
V_2 |= V_83 ;
if ( F_30 ( V_9 -> V_54 [ 1 ] ) ||
( F_22 ( V_9 -> V_54 [ 1 ] ) ) )
V_2 |= V_84 ;
else if ( F_45 ( V_9 -> V_54 [ 1 ] ) )
V_2 |= V_85 ;
}
...
if ( V_9 -> V_24 -> V_59 ) {
if ( F_36 ( V_9 -> V_24 -> V_60 [ 0 ] ) )
F_49 ( V_9 -> V_24 -> V_60 [ 0 ] ) ;
if ( F_36 ( V_9 -> V_24 -> V_60 [ 1 ] ) )
F_49 ( V_9 -> V_24 -> V_60 [ 1 ] ) ;
}
}
static int T_5 F_50 ( struct V_4 * V_20 )
{
struct V_11 * V_12 = & V_20 -> V_12 ;
...
F_53 ( V_12 ) ;
for ( V_87 = 0 ; V_87 < V_90 ; V_87 ++ )
if ( F_43 ( V_87 ) || F_30 ( V_87 ) ||
F_45 ( V_87 ) ) {
V_22 -> V_53 = F_54 ( V_12 , L_26 ) ;
if ( F_28 ( V_22 -> V_53 ) ) {
V_14 = F_55 ( V_22 -> V_53 ) ;
F_56 ( V_12 , L_27 ,
V_14 ) ;
...
V_22 -> V_57 = F_54 ( V_12 , L_28 ) ;
if ( F_28 ( V_22 -> V_57 ) ) {
V_14 = F_55 ( V_22 -> V_57 ) ;
F_11 ( V_12 , L_29 , V_14 ) ;
goto V_15;
}
V_22 -> V_91 = F_54 ( V_12 , L_30 ) ;
if ( F_28 ( V_22 -> V_91 ) ) {
V_14 = F_55 ( V_22 -> V_91 ) ;
F_11 ( V_12 , L_31 , V_14 ) ;
goto V_92;
}
V_22 -> V_58 = F_54 ( V_12 , L_32 ) ;
if ( F_28 ( V_22 -> V_58 ) ) {
V_14 = F_55 ( V_22 -> V_58 ) ;
F_11 ( V_12 , L_33 , V_14 ) ;
goto V_93;
}
V_22 -> V_94 = F_54 ( V_12 , L_34 ) ;
if ( F_28 ( V_22 -> V_94 ) ) {
V_14 = F_55 ( V_22 -> V_94 ) ;
F_11 ( V_12 , L_35 , V_14 ) ;
goto V_95;
}
V_22 -> V_55 = F_54 ( V_12 , L_36 ) ;
if ( F_28 ( V_22 -> V_55 ) ) {
V_14 = F_55 ( V_22 -> V_55 ) ;
F_11 ( V_12 , L_37 , V_14 ) ;
goto V_96;
}
V_22 -> V_56 = F_54 ( V_12 , L_38 ) ;
if ( F_28 ( V_22 -> V_56 ) ) {
V_14 = F_55 ( V_22 -> V_56 ) ;
F_11 ( V_12 , L_39 , V_14 ) ;
goto V_97;
}
V_22 -> V_98 = F_54 ( V_12 , L_40 ) ;
if ( F_28 ( V_22 -> V_98 ) ) {
V_14 = F_55 ( V_22 -> V_98 ) ;
F_11 ( V_12 , L_41 , V_14 ) ;
goto V_99;
...
V_22 -> V_63 = F_58 ( V_7 -> V_101 , F_59 ( V_7 ) ) ;
if ( ! V_22 -> V_63 ) {
F_11 ( V_12 , L_48 ) ;
V_14 = - V_35 ;
goto V_100;
...
static int T_6 F_65 ( struct V_4 * V_20 )
{
