...
struct V_150 * V_151 = V_122 -> V_53 -> V_57 ;
...
int V_281 )
{
struct V_150 * V_151 = V_280 -> V_53 -> V_57 ;
char V_176 [ V_177 ] ;
int V_178 ;
memset ( V_176 , 0 , V_177 ) ;
V_178 = F_1 ( V_2 , & V_176 [ 0 ] ,
...
F_30 () ;
F_5 ( & V_33 -> V_45 ) ;
V_309 = V_53 -> V_57 -> V_311 (
V_53 , V_280 , V_2 , & V_310 ) ;
