...
V_55 ++ ;
if ( F_92 ( ( V_145 -> V_45 + V_145 -> V_46 ) > V_31 ) ) {
F_44 ( V_2 -> V_29 , L_5 ,
...
static struct V_12 * F_93 ( struct V_6 * V_7 ,
struct V_49 * V_50 ,
T_1 V_24 )
{
struct V_12 * V_12 ;
V_12 = F_94 ( V_151 | V_152 ) ;
if ( ! V_12 )
return NULL ;
F_10 ( V_12 , V_7 , V_24 ) ;
V_7 -> V_11 [ V_24 ] = V_12 ;
...
static struct V_69 * F_95 ( struct V_6 * V_7 ,
struct V_1 * V_2 ,
struct V_49 * V_50 ,
struct V_144 * V_145 ,
struct V_69 * V_153 )
...
struct V_69 * * V_159 )
{
struct V_69 * V_153 = * V_159 ;
T_1 V_24 = * ( ( T_1 * ) V_50 -> V_90 ) ;
struct V_78 * V_78 = V_7 -> V_78 ;
struct V_1 * V_2 = V_78 [ V_24 ] . V_2 ;
struct V_144 * V_145 ;
struct V_154 * V_155 = F_27 ( V_50 ) ;
int V_54 = V_155 -> V_54 ;
int V_3 , V_160 , V_156 ;
...
static void F_98 ( struct V_6 * V_7 , struct V_49 * V_50 )
{
struct V_154 * V_155 = F_27 ( V_50 ) ;
int V_54 = V_155 -> V_54 ;
int V_3 ;
...
F_99 ( V_50 , V_3 , V_12 , V_145 -> V_45 , V_145 -> V_46 ) ;
...
F_44 ( V_2 -> V_29 , L_9 , V_33 -> V_82 . V_33 . type ) ;
return - V_169 ;
}
...
static int F_103 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
struct V_175 * V_176 ;
unsigned char * V_177 ;
int V_160 = - V_178 ;
int V_179 = 0 ;
if ( V_50 -> V_119 != V_120 && F_104 ( V_50 ) ) {
V_2 -> V_180 ++ ;
V_50 -> V_119 = V_120 ;
V_179 = 1 ;
}
...
switch ( V_176 -> V_181 ) {
case V_185 :
V_50 -> V_186 = F_106 ( struct V_187 , V_188 ) ;
if ( V_179 ) {
struct V_187 * V_189 = (struct V_187 * ) V_177 ;
V_189 -> V_188 = ~ F_107 ( V_176 -> V_190 , V_176 -> V_191 ,
V_50 -> V_89 - V_176 -> V_183 * 4 ,
V_185 , 0 ) ;
}
break;
case V_192 :
V_50 -> V_186 = F_106 ( struct V_193 , V_188 ) ;
if ( V_179 ) {
struct V_193 * V_194 = (struct V_193 * ) V_177 ;
V_194 -> V_188 = ~ F_107 ( V_176 -> V_190 , V_176 -> V_191 ,
V_50 -> V_89 - V_176 -> V_183 * 4 ,
V_192 , 0 ) ;
}
break;
...
static bool F_110 ( struct V_1 * V_2 , unsigned V_46 )
{
unsigned long V_195 = V_196 ;
unsigned long V_197 =
V_2 -> V_198 . V_199 +
F_111 ( V_2 -> V_200 / 1000 ) ;
if ( F_66 ( & V_2 -> V_198 ) )
return true ;
if ( F_112 ( V_195 , V_197 ) ) {
...
static unsigned F_114 ( struct V_6 * V_7 )
{
...
V_107 = F_91 ( V_2 , & V_204 , V_205 , V_149 ) ;
if ( F_92 ( V_107 < 0 ) ) {
F_89 ( V_2 , & V_204 , V_10 - V_107 ) ;
continue;
}
V_10 += V_107 ;
if ( F_92 ( V_204 . V_46 < V_207 ) ) {
F_44 ( V_2 -> V_29 ,
L_11 , V_204 . V_46 ) ;
F_89 ( V_2 , & V_204 , V_10 ) ;
continue;
}
if ( F_92 ( ( V_204 . V_45 + V_204 . V_46 ) > V_31 ) ) {
F_44 ( V_2 -> V_29 ,
L_12 ,
...
V_157 = F_15 ( V_7 -> V_26 ) ;
V_24 = V_7 -> V_158 [ V_157 ] ;
V_163 = ( V_204 . V_46 > V_208 &&
V_107 < V_35 ) ?
V_208 : V_204 . V_46 ;
V_50 = F_116 ( V_163 + V_209 + V_210 ,
V_211 | V_212 ) ;
if ( F_92 ( V_50 == NULL ) ) {
F_44 ( V_2 -> V_29 ,
L_13 ) ;
...
F_117 ( V_50 , V_209 + V_210 ) ;
if ( V_165 [ V_129 - 1 ] . type ) {
struct V_124 * V_33 ;
V_33 = & V_165 [ V_129 - 1 ] ;
if ( F_102 ( V_2 , V_50 , V_33 ) ) {
F_118 ( V_50 ) ;
F_89 ( V_2 , & V_204 , V_10 ) ;
continue;
}
...
struct V_49 * V_50 ;
while ( ( V_50 = F_54 ( & V_7 -> V_214 ) ) != NULL ) {
struct V_144 * V_145 ;
struct V_1 * V_2 ;
T_1 V_24 ;
unsigned V_163 ;
...
if ( V_145 -> V_76 & V_215 )
V_50 -> V_119 = V_120 ;
else if ( V_145 -> V_76 & V_216 )
V_50 -> V_119 = V_123 ;
F_98 ( V_7 , V_50 ) ;
if ( F_26 ( V_50 ) < V_208 && F_121 ( V_50 ) ) {
int V_217 = F_122 ( int , V_50 -> V_89 , V_208 ) ;
F_123 ( V_50 , V_217 - F_26 ( V_50 ) ) ;
}
V_50 -> V_29 = V_2 -> V_29 ;
V_50 -> V_181 = F_124 ( V_50 , V_50 -> V_29 ) ;
if ( F_103 ( V_2 , V_50 ) ) {
F_44 ( V_2 -> V_29 ,
L_15 ) ;
F_118 ( V_50 ) ;
...
V_2 -> V_29 -> V_116 . V_218 += V_50 -> V_89 ;
V_2 -> V_29 -> V_116 . V_219 ++ ;
F_125 ( V_2 , V_50 ) ;
}
}
...
if ( V_220 == 0 )
return;
F_53 ( V_7 -> V_202 , V_220 ) ;
F_120 ( V_7 ) ;
}
static void F_97 ( struct V_6 * V_7 , T_1 V_24 )
{
struct V_1 * V_2 ;
struct V_78 * V_78 ;
T_3 V_157 ;
...
V_103 -> V_76 = V_76 ;
V_103 -> V_66 = V_66 ;
V_103 -> V_94 = ( V_224 ) V_46 ;
if ( V_221 < 0 )
V_103 -> V_94 = ( V_224 ) V_221 ;
V_2 -> V_39 . V_42 = ++ V_3 ;
return V_103 ;
}
...
static inline int F_129 ( struct V_6 * V_7 )
{
...
struct V_230 * V_231 ;
int V_160 = - V_232 ;
V_160 = F_138 ( F_136 ( V_2 ) ,
V_225 , & V_227 ) ;
if ( V_160 )
goto V_160;
V_229 = (struct V_228 * ) V_227 ;
F_139 ( & V_2 -> V_138 , V_229 , V_31 ) ;
V_160 = F_138 ( F_136 ( V_2 ) ,
V_226 , & V_227 ) ;
if ( V_160 )
goto V_160;
V_231 = (struct V_230 * ) V_227 ;
F_139 ( & V_2 -> V_39 , V_231 , V_31 ) ;
V_2 -> V_37 = 0 ;
return 0 ;
V_160:
F_134 ( V_2 ) ;
...
return - V_234 ;
V_9 = F_142 () ;
V_6 = F_143 ( sizeof( struct V_6 ) * V_9 ) ;
if ( ! V_6 )
return - V_232 ;
...
V_7 -> V_158 [ V_3 ] = V_3 ;
F_145 ( & V_7 -> V_27 ) ;
V_7 -> V_235 = F_146 ( F_130 ,
( void * ) V_7 ,
L_16 , V_14 ) ;
if ( F_147 ( V_7 -> V_235 ) ) {
F_148 ( V_236 L_17 ) ;
F_149 ( & V_7 -> V_131 ) ;
V_233 = F_150 ( V_7 -> V_235 ) ;
goto V_237;
}
F_151 ( V_7 -> V_235 , V_14 ) ;
F_152 ( & V_7 -> V_134 ) ;
F_153 ( & V_7 -> V_133 ) ;
F_154 ( & V_7 -> V_8 , 0 ) ;
F_155 ( V_7 -> V_235 ) ;
