...
static unsigned int F_47 ( struct V_46 * V_46 , struct V_77 * V_78 )
{
struct V_47 * V_48 = F_29 ( V_46 ) ;
struct V_1 * V_2 = V_46 -> V_57 ;
struct V_79 * V_14 = NULL ;
struct V_11 * V_12 ;
unsigned int V_72 = F_48 ( V_46 , V_78 ) ;
F_7 ( L_26 , V_46 , V_78 ) ;
if ( V_48 -> V_58 == V_59 ) {
if ( V_2 -> V_5 -> V_60 -> V_61 & V_75 )
return V_72 | V_80 | V_81 ;
if( 0 == V_2 -> V_76 . V_82 )
return V_72 | F_49 ( V_46 , & V_2 -> V_76 , V_78 ) ;
V_12 = & V_2 -> V_76 ;
} else {
F_2 ( L_27 ) ;
V_12 = & V_2 -> V_74 ;
...
static unsigned int F_51 ( struct V_46 * V_46 , struct V_77 * V_78 )
{
struct V_47 * V_48 = F_29 ( V_46 ) ;
unsigned int V_72 ;
F_52 ( V_48 -> V_50 ) ;
...
V_5 -> V_60 = V_102 ;
V_7 -> V_126 . V_127 = F_63 ( V_5 -> V_110 , V_128 , & V_7 -> V_126 . V_39 ) ;
...
memset ( V_7 -> V_126 . V_127 , 0x0 , V_128 ) ;
V_66 . V_129 ( V_5 , V_7 ) ;
if ( V_5 -> V_60 -> V_61 & V_62 )
V_63 . V_129 ( V_5 , V_7 ) ;
V_107 = & V_7 -> V_130 . V_107 ;
V_107 -> V_131 = V_7 -> V_132 -> V_133 ;
V_107 -> V_134 = V_7 -> V_132 -> V_135 ;
V_107 -> V_136 = V_137 ;
V_107 -> V_138 = 2 * V_107 -> V_131 ;
...
V_160 -> V_167 = 0 ;
F_70 ( V_168 , & V_160 -> V_44 ) ;
for ( V_161 = 0 ; V_161 < V_5 -> V_60 -> V_169 ; V_161 ++ )
V_160 -> V_167 |= V_5 -> V_60 -> V_170 [ V_161 ] . V_171 ;
F_71 ( V_160 -> V_159 , V_159 , sizeof( V_160 -> V_159 ) ) ;
F_72 ( V_160 , V_5 ) ;
V_109 = F_73 ( V_160 , type , - 1 ) ;
if ( V_109 < 0 ) {
F_62 ( L_38 ) ;
V_165 ( V_160 ) ;
return V_109 ;
...
int F_75 ( struct V_47 * * V_158 , struct V_4 * V_5 )
{
F_7 ( L_36 , V_5 ) ;
F_76 ( * V_158 ) ;
* V_158 = NULL ;
