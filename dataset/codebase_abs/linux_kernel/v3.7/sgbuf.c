...
unsigned int V_35 , unsigned int V_21 )
{
struct V_3 * V_36 = V_2 -> V_5 ;
unsigned int V_37 , V_38 , V_39 ;
V_37 = V_35 >> V_18 ;
V_38 = ( V_35 + V_21 - 1 ) >> V_18 ;
V_39 = V_36 -> V_13 [ V_37 ] . V_14 >> V_18 ;
for (; ; ) {
V_37 ++ ;
if ( V_37 > V_38 )
break;
V_39 ++ ;
if ( ( V_36 -> V_13 [ V_37 ] . V_14 >> V_18 ) != V_39 )
return ( V_37 << V_18 ) - V_35 ;
}
return V_21 ;
}
