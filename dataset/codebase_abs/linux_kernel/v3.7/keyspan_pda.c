...
case - V_26 :
case - V_27 :
F_9 ( & V_19 -> V_14 -> V_14 , L_2 , V_18 , V_24 ) ;
return;
default:
F_9 ( & V_19 -> V_14 -> V_14 , L_3 , V_18 , V_24 ) ;
goto exit;
}
switch ( V_21 [ 0 ] ) {
case 0 :
...
break;
case 1 :
F_9 ( & V_7 -> V_14 , L_4 , V_21 [ 1 ] , V_21 [ 2 ] ) ;
switch ( V_21 [ 1 ] ) {
case 1 :
break;
case 2 :
...
2000 ) ;
if ( V_35 < 0 ) {
F_9 ( & V_7 -> V_14 , L_13 , V_18 ) ;
goto error;
}
if ( V_35 == 0 ) {
F_9 ( & V_7 -> V_14 , L_14 , V_18 ) ;
V_35 = - V_61 ;
goto error;
}
V_4 = F_11 ( V_7 ) ;
...
int V_67 ;
const char * V_68 ;
V_67 = F_50 ( V_12 -> V_14 , 1 ) ;
if ( 0 ) { ; }
#ifdef F_51
else if ( F_52 ( V_12 -> V_14 -> V_69 . V_70 ) == V_71 )
V_68 = L_16 ;
#endif
#ifdef F_53
else if ( ( F_52 ( V_12 -> V_14 -> V_69 . V_70 ) == V_72 ) ||
( F_52 ( V_12 -> V_14 -> V_69 . V_70 ) == V_73 ) )
V_68 = L_17 ;
#endif
else {
