...
V_45 = F_22 ( sizeof( struct V_1 ) , V_57 ) ;
if ( ! V_45 ) {
V_53 = - V_58 ;
goto V_56;
}
...
V_45 -> V_63 = 200 ;
V_45 -> V_11 = 200 ;
V_45 -> V_2 . V_64 = V_50 -> V_65 ;
V_45 -> V_2 . V_66 = & V_67 ;
V_45 -> V_2 . V_36 = V_45 ;
V_45 -> V_2 . V_68 . V_69 = & V_50 -> V_68 ;
F_23 ( V_45 -> V_2 . V_70 , L_22 , sizeof( V_45 -> V_2 . V_70 ) ) ;
F_18 ( V_45 ) ;
V_53 = F_24 ( & V_45 -> V_2 ) ;
if ( V_53 == 0 ) {
F_25 ( V_50 , V_45 ) ;
...
static int
F_30 ( struct V_49 * V_50 , T_4 V_71 )
{
struct V_1 * V_45 = F_28 ( V_50 ) ;
F_31 ( & V_50 -> V_68 , L_20 ) ;
F_19 ( V_45 ) ;
