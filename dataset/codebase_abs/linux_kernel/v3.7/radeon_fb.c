...
{
F_42 ( & V_2 -> V_84 . V_15 -> V_56 ) ;
}
static int F_43 ( struct V_85 * V_37 , struct V_14 * V_15 )
{
struct V_41 * V_42 ;
struct V_86 * V_54 = & V_15 -> V_54 ;
if ( V_15 -> V_56 . V_57 ) {
V_42 = V_15 -> V_56 . V_57 ;
F_44 ( V_42 ) ;
if ( V_42 -> V_81 . V_87 )
...
int V_89 = 32 ;
int V_13 ;
if ( F_49 ( V_2 ) || V_2 -> V_66 . V_90 <= ( 32 * 1024 * 1024 ) )
V_89 = 8 ;
V_15 = F_50 ( sizeof( struct V_14 ) , V_91 ) ;
if ( ! V_15 )
return - V_32 ;
V_15 -> V_2 = V_2 ;
V_2 -> V_84 . V_15 = V_15 ;
V_15 -> V_56 . V_92 = & V_93 ;
V_13 = F_51 ( V_2 -> V_53 , & V_15 -> V_56 ,
V_2 -> V_94 ,
V_95 ) ;
if ( V_13 ) {
F_39 ( V_15 ) ;
...
if ( ! V_2 -> V_84 . V_15 )
return;
F_43 ( V_2 -> V_53 , V_2 -> V_84 . V_15 ) ;
F_39 ( V_2 -> V_84 . V_15 ) ;
V_2 -> V_84 . V_15 = NULL ;
}
void F_55 ( struct V_1 * V_2 , int V_96 )
{
F_56 ( V_2 -> V_84 . V_15 -> V_56 . V_57 , V_96 ) ;
}
int F_57 ( struct V_1 * V_2 )
{
struct V_11 * V_97 ;
int V_22 = 0 ;
V_97 = F_4 ( V_2 -> V_84 . V_15 -> V_54 . V_88 ) ;
V_22 += F_29 ( V_97 ) ;
return V_22 ;
}
bool F_58 ( struct V_1 * V_2 , struct V_11 * V_97 )
{
if ( V_97 == F_4 ( V_2 -> V_84 . V_15 -> V_54 . V_88 ) )
return true ;
return false ;
}
