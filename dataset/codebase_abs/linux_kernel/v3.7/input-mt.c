...
static int F_20 ( int * V_63 , int V_64 , int * V_65 , int V_66 )
{
...
static void F_21 ( int * V_69 , int V_70 , int V_71 , int V_72 )
{
int V_11 , V_73 , V_74 ;
for ( V_73 = 0 ; V_73 < V_72 ; V_73 ++ ) {
for ( V_11 = 0 ; V_11 < V_70 ; V_11 ++ )
F_20 ( V_69 + V_11 , V_70 , V_69 + V_11 + V_72 , V_70 <= V_71 ) ;
V_74 = 0 ;
for ( V_11 = 0 ; V_11 < V_72 ; V_11 += V_70 )
V_74 += F_20 ( V_69 + V_11 , 1 , V_69 + V_11 + V_70 , V_71 <= V_70 ) ;
if ( ! V_74 )
break;
}
}
...
int F_25 ( struct V_1 * V_2 , int * V_13 ,
const struct V_75 * V_76 , int V_77 )
{
struct V_9 * V_10 = V_2 -> V_10 ;
int V_72 ;
...
if ( V_77 < 1 )
return 0 ;
V_72 = F_22 ( V_10 , V_76 , V_77 ) ;
F_21 ( V_10 -> V_41 , V_77 , V_72 / V_77 , V_72 ) ;
F_24 ( V_10 , V_13 , V_77 ) ;
return 0 ;
}
int F_26 ( struct V_1 * V_2 , int V_81 )
{
struct V_9 * V_10 = V_2 -> V_10 ;
struct V_45 * V_61 ;
if ( ! V_10 )
