...
static void F_215 ( T_1 * V_1 , int V_381 )
{
if ( V_381 ) {
...
if ( V_1 -> V_65 . V_211 )
F_217 ( V_1 , V_1 -> V_65 . V_211 ) ;
else
F_217 ( V_1 , 3686400 ) ;
}
static void F_217 ( T_1 * V_1 , T_13 V_82 )
{
T_13 V_509 ;
unsigned char V_510 ;
T_13 V_511 = 0 ;
...
F_76 ( V_1 , V_508 , V_147 ) ;
if ( V_1 -> V_65 . V_11 & V_197 )
F_217 ( V_1 , V_1 -> V_65 . V_211 * V_534 ) ;
else
F_217 ( V_1 , V_1 -> V_65 . V_211 ) ;
if ( V_1 -> V_65 . V_11 & V_202 )
V_1 -> V_345 [ 0 ] -> V_506 |= ( V_280 << ( V_1 -> V_251 * 2 ) ) ;
...
{
F_220 ( V_1 , 0 , V_1 -> V_434 - 1 ) ;
}
static void F_220 ( T_1 * V_1 , unsigned int V_554 , unsigned int V_555 )
{
bool V_556 = false ;
while( ! V_556 ) {
...
if ( V_31 >= V_570 )
F_221 ( V_1 , V_1 -> V_436 [ V_557 ] . V_448 ,
...
T_10 * V_563 ;
if ( V_31 >= V_570 )
F_221 ( V_1 , V_61 , F_35 (unsigned int, count, SCABUFSIZE) , 1 ) ;
for( V_339 = 0 ; ; )
{
V_571 = F_35 (unsigned int, count, SCABUFSIZE) ;
V_562 = & V_1 -> V_437 [ V_339 ] ;
V_563 = & V_1 -> V_438 [ V_339 ] ;
F_222 ( V_1 , V_563 -> V_448 , V_61 , V_571 ) ;
V_562 -> V_444 = V_571 ;
V_562 -> V_258 = 0 ;
V_61 += V_571 ;
V_12 -= V_571 ;
...
static unsigned int V_12 = F_224 ( V_576 ) ;
unsigned int V_339 ;
bool V_182 = true ;
unsigned long V_11 ;
F_13 ( & V_1 -> V_47 , V_11 ) ;
...
V_1 -> V_27 . V_9 = NULL ;
V_1 -> V_24 = V_602 ;
for ( V_12 = 0 ; V_12 < F_229 ; ++ V_12 )
V_61 [ V_12 ] = ( unsigned char ) V_12 ;
memset ( V_1 -> V_451 , 0 , F_229 ) ;
F_13 ( & V_1 -> V_47 , V_11 ) ;
F_149 ( V_1 ) ;
F_215 ( V_1 , 1 ) ;
F_151 ( V_1 ) ;
...
F_14 ( & V_1 -> V_47 , V_11 ) ;
V_1 -> V_345 [ 0 ] -> V_344 = 0 ;
if ( F_223 ( V_1 -> V_345 [ 0 ] ) &&
F_223 ( V_1 -> V_345 [ 1 ] ) ) {
V_1 -> V_345 [ 0 ] -> V_344 = 2 ;
if ( F_223 ( V_1 -> V_345 [ 2 ] ) &&
F_223 ( V_1 -> V_345 [ 3 ] ) )
V_1 -> V_345 [ 0 ] -> V_344 += 2 ;
}
else {
...
if ( ! F_228 ( V_1 -> V_345 [ 0 ] ) ||
! F_228 ( V_1 -> V_345 [ 1 ] ) ||
( V_1 -> V_344 == 4 && ! F_228 ( V_1 -> V_345 [ 2 ] ) ) ||
( V_1 -> V_344 == 4 && ! F_228 ( V_1 -> V_345 [ 3 ] ) ) ) {
F_4 ( L_164 ,
__FILE__ , __LINE__ , V_1 -> V_25 ) ;
return - V_21 ;
}
...
unsigned long V_12 = F_224 ( V_576 ) ;
unsigned long V_339 ;
...
static void F_222 ( T_1 * V_1 , char * V_605 , const char * V_606 , unsigned short V_12 )
{
...
static void F_221 ( T_1 * V_1 , const char * V_10 , int V_12 , int V_237 )
{
int V_339 ;
int V_609 ;
if ( V_237 )
...
static unsigned char F_218 ( T_1 * V_1 )
{
...
static int T_15 F_231 ( struct V_473 * V_152 ,
...
static void T_16 F_233 ( struct V_473 * V_152 )
{
}
