...
int F_16 ( struct V_18 * V_19 , unsigned V_20 )
{
return F_17 ( V_19 -> V_21 + V_20 ) ;
}
void F_18 ( struct V_18 * V_19 , unsigned V_20 )
{
F_19 ( V_19 -> V_21 + V_20 ) ;
}
...
static int T_3 F_50 ( struct V_56 * V_57 )
{
struct V_1 * V_2 ;
...
V_2 -> V_54 = F_67 ( - 1 , 0 , V_66 , - 1 ) ;
if ( V_2 -> V_54 < 0 ) {
F_53 ( & V_57 -> V_62 , L_8 ) ;
F_61 ( V_2 -> V_19 . V_74 ) ;
return - V_73 ;
}
V_31 = F_68 ( L_9 , 2 , V_2 -> V_54 ,
V_2 -> V_3 , V_83 ) ;
if ( ! V_31 ) {
F_53 ( & V_57 -> V_62 , L_10 ) ;
F_61 ( V_2 -> V_19 . V_74 ) ;
...
V_38 -> V_90 = V_91 ;
V_38 -> V_19 . V_88 = V_2 -> V_19 . V_74 ;
F_69 ( V_31 , F_70 ( V_66 ) , 0 ,
V_92 , V_93 | V_94 ) ;
V_2 -> V_27 = F_71 ( V_61 , V_2 -> V_19 . V_53 ,
V_2 -> V_54 , 0 ,
& V_95 ,
V_2 ) ;
if ( ! V_2 -> V_27 ) {
