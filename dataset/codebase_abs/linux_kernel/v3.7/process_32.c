...
T_4 F_45 ( int (* F_46)( void * ) , void * V_73 , unsigned long V_74 )
{
long V_75 ;
...
unsigned long F_47 ( struct V_21 * V_76 )
{
unsigned long V_16 , V_24 , V_77 = 0 ;
