...
static int T_6 F_82 ( struct V_182 * V_183 )
{
...
int V_60 = - V_191 ;
int V_202 ;
V_201 = F_83 ( sizeof( * V_201 ) , V_203 ) ;
if ( ! V_201 ) {
F_84 ( & V_183 -> V_198 , L_44 ) ;
goto V_204;
}
V_202 = F_85 ( & V_183 -> V_198 , V_203 ) ;
if ( V_202 < 0 ) {
F_84 ( & V_183 -> V_198 , L_45 ) ;
V_60 = - V_191 ;
goto V_205;
}
V_1 = F_86 ( L_46 , V_202 ) ;
...
V_1 -> V_207 = V_202 ;
V_1 -> V_198 . V_208 = & V_183 -> V_198 ;
V_1 -> V_198 . V_209 = & V_210 ;
V_1 -> V_198 . V_211 = V_210 ;
V_201 -> V_198 = & V_183 -> V_198 ;
V_201 -> V_1 = V_1 ;
V_197 -> V_212 = & V_213 ;
F_87 ( V_183 , V_201 ) ;
V_60 = F_88 ( V_1 , V_183 -> V_184 ,
V_183 -> V_214 ) ;
if ( V_60 ) {
F_84 ( & V_183 -> V_198 , L_48 ) ;
goto V_215;
}
V_60 = F_89 ( V_1 , V_197 , sizeof( * V_197 ) ) ;
if ( V_60 ) {
...
F_91 ( V_1 ) ;
V_206:
F_92 ( & V_183 -> V_198 , V_202 ) ;
V_205:
F_93 ( V_201 ) ;
V_204:
return V_60 ;
}
static int T_7 F_94 ( struct V_182 * V_183 )
{
struct V_200 * V_201 = F_95 ( V_183 ) ;
F_92 ( & V_183 -> V_198 , V_201 -> V_1 -> V_207 ) ;
F_96 ( V_201 -> V_1 ) ;
F_91 ( V_201 -> V_1 ) ;
F_93 ( V_201 ) ;
return 0 ;
