...
static struct V_42 * F_23 ( struct V_62 * V_45 )
{
struct V_42 * V_63 ;
V_63 = F_24 ( V_45 , sizeof( * V_63 ) , V_64 ) ;
if ( ! V_63 )
return NULL ;
V_63 -> V_65 = F_25 ( V_45 -> V_66 ,
L_1 ) ;
F_26 ( V_45 -> V_66 , L_2 ,
& V_63 -> V_60 ) ;
F_26 ( V_45 -> V_66 , L_3 ,
...
static int T_2 F_27 ( struct V_69 * V_70 )
{
struct V_42 * V_43 = V_70 -> V_45 . V_46 ;
struct V_71 * V_72 = V_70 -> V_45 . V_66 ;
int V_4 , V_73 ;
if ( F_28 () ) {
F_29 ( & V_70 -> V_45 , L_6 ) ;
goto V_74;
}
V_73 = F_30 ( - 1 , 0 , V_26 , 0 ) ;
if ( V_73 < 0 ) {
F_29 ( & V_70 -> V_45 , L_7 ) ;
return V_73 ;
}
F_31 ( V_72 , V_26 , V_73 , 0 ,
& V_75 , NULL ) ;
V_4 = F_32 ( & V_70 -> V_45 , V_3 , V_73 ) ;
if ( V_4 < 0 )
return V_4 ;
V_51 = V_73 ;
V_74:
...
V_4 = F_20 ( V_43 -> V_67 , V_43 -> V_68 ) ;
if ( V_4 )
F_33 ( & V_70 -> V_45 , L_9 ,
V_43 -> V_67 , V_43 -> V_68 , V_4 ) ;
V_4 = F_22 ( V_43 -> V_60 , V_43 -> V_47 ) ;
if ( V_4 )
F_33 ( & V_70 -> V_45 , L_10 ,
V_43 -> V_60 , V_43 -> V_47 , V_4 ) ;
if ( V_43 -> V_65 )
V_76 . V_77 += 2 ;
V_4 = F_34 ( & V_76 ) ;
if ( V_4 < 0 ) {
F_29 ( & V_70 -> V_45 , L_11 , V_4 ) ;
V_76 . V_77 = 0 ;
F_35 ( V_70 ) ;
goto V_79;
}
...
if ( V_43 && V_43 -> V_81 ) {
int V_10 ;
V_10 = V_43 -> V_81 ( & V_70 -> V_45 ,
V_80 , V_26 ) ;
if ( V_10 )
F_33 ( & V_70 -> V_45 , L_12 , V_10 ) ;
}
V_79:
return V_4 ;
}
...
int V_10 ;
if ( V_43 && V_43 -> V_82 ) {
V_10 = V_43 -> V_82 ( & V_70 -> V_45 ,
V_80 , V_26 ) ;
if ( V_10 ) {
F_33 ( & V_70 -> V_45 , L_13 , V_10 ) ;
return V_10 ;
}
}
V_10 = F_36 ( & V_76 ) ;
