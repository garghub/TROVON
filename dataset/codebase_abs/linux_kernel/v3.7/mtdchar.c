...
V_206 = F_77 ( V_202 ) ;
V_74 = V_208 -> V_210 ;
V_51 = F_81 ( ( V_74 & ~ V_211 ) + V_208 -> V_13 ) ;
V_74 &= V_211 ;
V_209 = F_76 ( V_202 ) ;
...
return - V_14 ;
V_202 -> V_212 |= V_213 | V_214 | V_215 ;
#ifdef F_82
if ( V_1 -> V_216 & V_217 || V_206 >= F_83 ( V_218 ) )
V_202 -> V_219 = F_82 ( V_202 -> V_219 ) ;
#endif
...
return - V_200 ;
#else
return V_202 -> V_212 & V_221 ? 0 : - V_200 ;
#endif
}
static struct V_222 * F_85 ( struct V_223 * V_224 ,
int V_42 , const char * V_225 , void * V_105 )
{
return F_86 ( V_224 , L_6 , & V_226 , NULL , V_227 ) ;
}
static int T_11 F_87 ( void )
{
int V_18 ;
V_18 = F_88 ( V_228 , 0 , 1 << V_229 ,
L_7 , & V_230 ) ;
if ( V_18 < 0 ) {
F_89 ( L_8
L_9 , V_228 ) ;
