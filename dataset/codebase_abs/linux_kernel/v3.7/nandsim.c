...
V_247 = (struct V_1 * ) ( V_34 + 1 ) ;
V_34 -> V_35 = ( void * ) V_247 ;
V_34 -> V_250 = F_90 ;
V_34 -> V_245 = F_86 ;
V_34 -> V_251 = F_91 ;
V_34 -> V_252 = F_93 ;
...
if ( V_263 != 0xFF || V_264 != 0xFF )
V_247 -> V_19 . V_231 = 4 ;
else
V_247 -> V_19 . V_231 = 2 ;
V_247 -> V_163 . V_167 = F_85 ( V_247 ) ;
V_247 -> V_168 = V_145 ;
V_247 -> V_42 |= V_59 ;
V_247 -> V_237 [ 0 ] = V_265 ;
V_247 -> V_237 [ 1 ] = V_75 ;
...
V_270 = V_207 -> V_47 / 512 ;
V_271 = ( V_269 * 13 + 7 ) / 8 ;
if ( ( V_207 -> V_49 < 64 ) || ! V_270 ) {
F_5 ( L_160 ) ;
V_248 = - V_14 ;
goto error;
}
if ( ( V_271 * V_270 + 2 ) > V_207 -> V_49 ) {
F_5 ( L_161 , V_269 ) ;
V_248 = - V_14 ;
goto error;
}
V_34 -> V_255 . V_256 = V_272 ;
V_34 -> V_255 . V_45 = 512 ;
V_34 -> V_255 . V_273 = V_271 ;
F_44 ( L_162 , V_269 , V_34 -> V_255 . V_45 ) ;
}
V_248 = F_98 ( V_207 ) ;
if ( V_248 ) {
F_5 ( L_163 ) ;
...
if ( V_274 ) {
T_1 V_275 = ( T_1 ) V_207 -> V_51 << V_274 ;
if ( V_275 >> V_274 != V_207 -> V_51 ) {
F_5 ( L_164 ) ;
V_248 = - V_14 ;
goto V_276;
}
V_207 -> V_45 = V_275 ;
V_34 -> V_277 = V_275 ;
V_34 -> V_278 = F_21 ( V_207 -> V_51 ) + V_274 - 1 ;
V_34 -> V_279 = ( V_34 -> V_277 >> V_34 -> V_55 ) - 1 ;
}
if ( ( V_248 = F_42 ( V_207 ) ) != 0 )
goto V_276;
if ( ( V_248 = F_18 ( V_207 ) ) != 0 )
goto V_276;
if ( ( V_248 = F_99 ( V_207 ) ) != 0 )
goto V_276;
if ( ( V_248 = F_26 ( V_247 , V_207 ) ) != 0 )
goto V_276;
V_248 = F_100 ( V_207 , & V_247 -> V_68 [ 0 ] ,
V_247 -> V_73 ) ;
if ( V_248 != 0 )
goto V_276;
return 0 ;
...
F_25 ( V_247 ) ;
F_101 ( V_207 ) ;
for ( V_5 = 0 ; V_5 < F_22 ( V_247 -> V_68 ) ; ++ V_5 )
F_13 ( V_247 -> V_68 [ V_5 ] . V_71 ) ;
error:
F_13 ( V_207 ) ;
F_38 () ;
return V_248 ;
