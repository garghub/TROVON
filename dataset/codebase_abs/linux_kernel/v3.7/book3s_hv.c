...
{
V_242 -> V_255 |= V_256 | V_257 ;
V_242 -> V_258 = & V_259 ;
return 0 ;
}
static int F_118 ( struct V_260 * V_260 , struct V_254 * V_261 )
{
struct V_245 * V_246 = V_261 -> V_248 ;
F_119 ( V_246 ) ;
return 0 ;
}
long F_120 ( struct V_41 * V_41 , struct V_262 * V_47 )
{
struct V_245 * V_246 ;
long V_263 ;
V_246 = F_121 () ;
if ( ! V_246 )
return - V_162 ;
V_263 = F_122 ( L_17 , & V_264 , V_246 , V_265 ) ;
if ( V_263 < 0 )
F_119 ( V_246 ) ;
V_47 -> V_239 = V_246 -> V_251 << V_266 ;
return V_263 ;
}
static void F_123 ( struct V_267 * * V_268 ,
int V_269 )
{
struct V_270 * V_271 = & V_272 [ V_269 ] ;
if ( ! V_271 -> V_273 )
return;
( * V_268 ) -> V_274 = V_271 -> V_273 ;
( * V_268 ) -> V_275 = V_271 -> V_276 ;
( * V_268 ) -> V_277 [ 0 ] . V_274 = V_271 -> V_273 ;
( * V_268 ) -> V_277 [ 0 ] . V_278 = V_271 -> V_279 ;
( * V_268 ) ++ ;
}
int F_124 ( struct V_41 * V_41 , struct V_280 * V_281 )
{
struct V_267 * V_268 ;
V_281 -> V_58 = V_282 ;
if ( F_125 ( V_283 ) )
...
int F_126 ( struct V_41 * V_41 , struct V_290 * log )
{
struct V_291 * V_292 ;
int V_19 ;
unsigned long V_293 ;
...
if ( log -> V_295 >= V_296 )
goto V_161;
V_292 = F_127 ( V_41 -> V_297 , log -> V_295 ) ;
V_19 = - V_298 ;
if ( ! V_292 -> V_299 )
goto V_161;
V_293 = F_128 ( V_292 ) ;
memset ( V_292 -> V_299 , 0 , V_293 ) ;
V_19 = F_129 ( V_41 , V_292 ) ;
if ( V_19 )
goto V_161;
V_19 = - V_300 ;
if ( F_130 ( log -> V_299 , V_292 -> V_299 , V_293 ) )
goto V_161;
V_19 = 0 ;
V_161:
F_13 ( & V_41 -> V_294 ) ;
...
static unsigned long F_131 ( unsigned long V_301 )
{
...
unsigned long V_251 ;
unsigned long * V_307 ;
V_307 = V_41 -> V_6 . V_308 [ V_306 -> V_295 ] ;
if ( ! V_41 -> V_6 . V_309 && ! V_307 ) {
V_251 = V_306 -> V_310 >> V_266 ;
V_307 = F_133 ( V_251 * sizeof( unsigned long ) ) ;
if ( ! V_307 )
return - V_162 ;
V_41 -> V_6 . V_308 [ V_306 -> V_295 ] = V_307 ;
V_41 -> V_6 . V_311 [ V_306 -> V_295 ] = V_251 ;
}
return 0 ;
}
static void F_134 ( struct V_41 * V_41 , int V_312 )
{
unsigned long * V_313 ;
unsigned long V_146 , V_251 , V_314 ;
struct V_249 * V_249 ;
V_313 = V_41 -> V_6 . V_308 [ V_312 ] ;
V_251 = V_41 -> V_6 . V_311 [ V_312 ] ;
if ( V_313 ) {
F_19 ( & V_41 -> V_6 . V_315 ) ;
for ( V_146 = 0 ; V_146 < V_251 ; V_146 ++ ) {
if ( ! ( V_313 [ V_146 ] & V_316 ) )
continue;
V_314 = V_313 [ V_146 ] >> V_266 ;
V_249 = F_115 ( V_314 ) ;
F_135 ( V_249 ) ;
F_136 ( V_249 ) ;
}
V_41 -> V_6 . V_308 [ V_312 ] = NULL ;
F_20 ( & V_41 -> V_6 . V_315 ) ;
F_137 ( V_313 ) ;
}
}
...
struct V_291 * V_292 ;
struct V_241 * V_242 ;
unsigned long V_42 , V_302 ;
unsigned long V_301 , V_318 ;
unsigned long V_239 ;
unsigned long V_319 ;
unsigned long * V_313 ;
...
V_292 = F_140 ( V_41 , 0 ) ;
V_64 = - V_151 ;
if ( ! V_292 || ( V_292 -> V_58 & V_321 ) )
goto V_161;
V_317 = V_292 -> V_322 ;
F_141 ( & V_226 -> V_237 -> V_323 ) ;
V_242 = F_142 ( V_226 -> V_237 , V_317 ) ;
if ( ! V_242 || V_242 -> V_324 > V_317 || ( V_242 -> V_255 & V_325 ) )
goto V_326;
V_301 = F_143 ( V_242 ) ;
V_318 = F_144 ( V_301 ) ;
if ( V_242 -> V_247 && V_242 -> V_247 -> V_327 == & V_264 &&
V_317 == V_242 -> V_324 )
V_246 = V_242 -> V_247 -> V_248 ;
F_145 ( & V_226 -> V_237 -> V_323 ) ;
if ( ! V_246 ) {
V_64 = - V_328 ;
if ( F_45 ( V_329 ) ) {
F_8 ( L_19 ) ;
...
V_64 = - V_151 ;
if ( ! ( V_301 == 0x1000 || V_301 == 0x10000 ||
V_301 == 0x1000000 ) )
goto V_161;
V_302 = F_131 ( V_301 ) ;
V_41 -> V_6 . V_330 = V_302 | V_331 |
( V_332 << V_333 ) ;
V_42 = V_41 -> V_6 . V_42 & ~ V_334 ;
V_42 |= V_302 << ( V_335 - 4 ) ;
V_41 -> V_6 . V_42 = V_42 ;
F_146 ( V_2 , V_292 , V_318 ) ;
} else {
V_239 = V_246 -> V_251 ;
if ( V_239 > V_292 -> V_251 )
V_239 = V_292 -> V_251 ;
V_239 <<= V_266 ;
V_319 = F_113 ( V_239 ) ;
V_64 = - V_151 ;
...
V_42 |= ( ( V_319 >> 2 ) << V_338 ) |
( ( V_319 & 3 ) << V_339 ) ;
V_42 |= ( ( V_246 -> V_253 >> ( 26 - V_266 ) ) & 0xffff )
<< V_340 ;
} else {
V_42 &= ~ ( V_341 | V_342 ) ;
V_42 |= V_319 << V_343 ;
V_41 -> V_6 . V_344 = V_41 -> V_6 . V_337 -> V_253 << V_266 ;
}
V_41 -> V_6 . V_42 = V_42 ;
F_147 ( L_21 ,
V_246 -> V_253 << V_266 , V_239 , V_42 ) ;
V_251 = V_246 -> V_251 ;
V_318 = F_144 ( V_251 ) ;
V_313 = V_41 -> V_6 . V_308 [ V_292 -> V_45 ] ;
F_19 ( & V_41 -> V_6 . V_315 ) ;
for ( V_130 = 0 ; V_130 < V_251 ; ++ V_130 )
V_313 [ V_130 ] = ( ( V_246 -> V_253 + V_130 ) << V_266 ) + V_318 ;
F_20 ( & V_41 -> V_6 . V_315 ) ;
}
F_25 () ;
V_41 -> V_6 . V_234 = 1 ;
...
{
unsigned long V_42 , V_345 ;
V_345 = F_149 () ;
if ( V_345 < 0 )
return - V_162 ;
V_41 -> V_6 . V_345 = V_345 ;
F_54 ( & V_41 -> V_6 . V_346 ) ;
V_41 -> V_6 . V_337 = NULL ;
V_41 -> V_6 . V_347 = F_49 ( V_348 ) ;
if ( F_45 ( V_329 ) ) {
V_41 -> V_6 . V_349 = 0 ;
V_41 -> V_6 . V_350 = V_42 = F_49 ( V_351 ) ;
V_42 &= ~ ( ( 3 << V_352 ) | ( 0xful << V_353 ) ) ;
V_42 |= ( ( V_345 >> 4 ) << V_352 ) |
( ( V_345 & 0xf ) << V_353 ) ;
} else {
V_41 -> V_6 . V_349 = F_49 ( V_354 ) ;
V_41 -> V_6 . V_350 = V_42 = F_49 ( V_355 ) ;
V_42 &= V_356 | V_357 ;
V_42 |= ( 4UL << V_358 ) | V_359 |
V_341 | V_360 ;
V_41 -> V_6 . V_330 = V_331 |
( V_332 << V_333 ) ;
}
V_41 -> V_6 . V_42 = V_42 ;
V_41 -> V_6 . V_309 = ! ! F_45 ( V_240 ) ;
F_50 ( & V_41 -> V_6 . V_315 ) ;
return 0 ;
}
...
unsigned long V_130 ;
if ( ! V_41 -> V_6 . V_309 )
for ( V_130 = 0 ; V_130 < V_361 ; V_130 ++ )
F_134 ( V_41 , V_130 ) ;
if ( V_41 -> V_6 . V_337 ) {
F_119 ( V_41 -> V_6 . V_337 ) ;
V_41 -> V_6 . V_337 = NULL ;
}
F_151 ( V_41 ) ;
F_152 ( ! F_153 ( & V_41 -> V_6 . V_346 ) ) ;
}
void F_154 ( struct V_1 * V_2 , T_3 V_362 , T_3 V_363 )
{
}
int F_155 ( struct V_115 * V_116 , struct V_1 * V_2 ,
unsigned int V_364 , int * V_365 )
{
return V_366 ;
}
int F_156 ( struct V_1 * V_2 , int V_367 , T_3 V_368 )
{
return V_366 ;
}
int F_157 ( struct V_1 * V_2 , int V_367 , T_3 * V_368 )
{
return V_366 ;
}
...
{
int V_19 ;
V_19 = F_159 ( NULL , sizeof( struct V_1 ) , 0 , V_369 ) ;
if ( V_19 )
return V_19 ;
V_19 = F_160 () ;
return V_19 ;
