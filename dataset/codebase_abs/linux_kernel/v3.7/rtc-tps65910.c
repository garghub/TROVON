...
static int T_4 F_17 ( struct V_43 * V_44 )
{
struct V_4 * V_4 = NULL ;
...
F_23 ( & V_44 -> V_2 , 1 ) ;
V_35 -> V_32 = F_24 ( V_44 -> V_48 , & V_44 -> V_2 ,
& V_49 , V_50 ) ;
if ( F_25 ( V_35 -> V_32 ) ) {
V_15 = F_26 ( V_35 -> V_32 ) ;
F_6 ( & V_44 -> V_2 , L_12 , V_15 ) ;
return V_15 ;
}
F_27 ( V_44 , V_35 ) ;
return 0 ;
}
static int T_5 F_28 ( struct V_43 * V_44 )
{
struct V_34 * V_35 = F_29 ( V_44 ) ;
F_1 ( & V_44 -> V_2 , 0 ) ;
F_30 ( V_35 -> V_32 ) ;
return 0 ;
}
