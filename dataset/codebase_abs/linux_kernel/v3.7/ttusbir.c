...
for ( V_49 = 0 ; V_49 < V_45 -> V_57 ; V_49 ++ ) {
V_47 = & V_41 -> V_50 [ V_29 ] . V_58 [ V_49 ] . V_47 ;
if ( F_23 ( V_47 ) &&
F_24 ( V_47 ) &&
V_47 -> V_59 == 0x10 )
V_56 = V_49 ;
...
V_5 -> V_12 = F_28 ( V_41 ) ;
V_5 -> V_36 = V_36 ;
V_10 = F_29 ( V_5 -> V_12 , 0 , V_50 ) ;
if ( V_10 )
goto V_53;
for ( V_29 = 0 ; V_29 < V_60 ; V_29 ++ ) {
struct V_19 * V_19 = F_30 ( 8 , V_51 ) ;
void * V_61 ;
if ( ! V_19 ) {
V_10 = - V_52 ;
goto V_53;
...
V_19 -> V_17 = V_5 -> V_12 ;
V_19 -> V_20 = V_5 ;
V_19 -> V_62 = F_31 ( V_5 -> V_12 , V_5 -> V_56 ) ;
V_19 -> V_63 = 1 ;
V_61 = F_32 ( V_5 -> V_12 , 128 , V_51 ,
& V_19 -> V_64 ) ;
if ( ! V_61 ) {
F_33 ( V_19 ) ;
V_10 = - V_52 ;
...
V_19 -> V_71 [ V_49 ] . V_72 = V_49 * 16 ;
V_19 -> V_71 [ V_49 ] . V_73 = 16 ;
}
V_5 -> V_19 [ V_29 ] = V_19 ;
}
V_5 -> V_15 = F_30 ( 0 , V_51 ) ;
if ( ! V_5 -> V_15 ) {
V_10 = - V_52 ;
goto V_53;
}
...
V_5 -> V_14 [ 2 ] = 0x05 ;
V_5 -> V_14 [ 3 ] = 0x01 ;
F_34 ( V_5 -> V_15 , V_5 -> V_12 , F_35 ( V_5 -> V_12 ,
V_5 -> V_55 ) , V_5 -> V_14 , sizeof( V_5 -> V_14 ) ,
F_10 , V_5 ) ;
V_5 -> V_6 . V_74 = L_5 ;
V_5 -> V_6 . V_75 = F_9 ;
V_5 -> V_6 . V_76 = F_1 ;
...
F_36 ( & V_5 -> V_13 , 0 ) ;
V_10 = F_37 ( & V_41 -> V_17 , & V_5 -> V_6 ) ;
if ( V_10 )
goto V_53;
F_38 ( V_5 -> V_12 , V_5 -> V_77 , sizeof( V_5 -> V_77 ) ) ;
V_36 -> V_78 = V_79 ;
V_36 -> V_80 = V_5 -> V_77 ;
F_39 ( V_5 -> V_12 , & V_36 -> V_81 ) ;
V_36 -> V_17 . V_82 = & V_41 -> V_17 ;
V_36 -> V_83 = V_84 ;
V_36 -> V_85 = V_86 ;
V_36 -> V_87 = V_5 ;
V_36 -> V_88 = V_89 ;
...
V_53:
if ( V_5 ) {
for ( V_29 = 0 ; V_29 < V_60 && V_5 -> V_19 [ V_29 ] ; V_29 ++ ) {
struct V_19 * V_19 = V_5 -> V_19 [ V_29 ] ;
F_45 ( V_19 ) ;
F_46 ( V_5 -> V_12 , 128 , V_19 -> V_38 ,
V_19 -> V_64 ) ;
F_33 ( V_19 ) ;
}
F_45 ( V_5 -> V_15 ) ;
...
static void T_3 F_49 ( struct V_40 * V_41 )
{
struct V_4 * V_5 = F_50 ( V_41 ) ;
struct V_96 * V_12 = V_5 -> V_12 ;
int V_29 ;
V_5 -> V_12 = NULL ;
F_43 ( V_5 -> V_36 ) ;
F_44 ( & V_5 -> V_6 ) ;
for ( V_29 = 0 ; V_29 < V_60 ; V_29 ++ ) {
F_45 ( V_5 -> V_19 [ V_29 ] ) ;
F_46 ( V_12 , 128 , V_5 -> V_19 [ V_29 ] -> V_38 ,
V_5 -> V_19 [ V_29 ] -> V_64 ) ;
F_33 ( V_5 -> V_19 [ V_29 ] ) ;
}
F_45 ( V_5 -> V_15 ) ;
...
static int F_51 ( struct V_40 * V_41 , T_4 V_97 )
{
struct V_4 * V_5 = F_50 ( V_41 ) ;
int V_29 ;
for ( V_29 = 0 ; V_29 < V_60 ; V_29 ++ )
