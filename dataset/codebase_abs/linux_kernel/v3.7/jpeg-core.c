...
if ( V_23 -> V_8 == NULL ) {
F_155 ( & V_234 -> V_209 , L_6 ) ;
return - V_237 ;
}
V_23 -> V_222 = V_29 = F_156 ( V_234 , 0 ) ;
if ( V_29 < 0 ) {
F_155 ( & V_234 -> V_209 , L_7 ) ;
return V_29 ;
}
V_29 = F_157 ( & V_234 -> V_209 , V_23 -> V_222 , F_132 , 0 ,
F_158 ( & V_234 -> V_209 ) , V_23 ) ;
if ( V_29 ) {
F_155 ( & V_234 -> V_209 , L_8 , V_23 -> V_222 ) ;
return V_29 ;
}
V_23 -> V_238 = F_159 ( & V_234 -> V_209 , L_9 ) ;
if ( F_29 ( V_23 -> V_238 ) ) {
F_155 ( & V_234 -> V_209 , L_10 ) ;
V_29 = F_30 ( V_23 -> V_238 ) ;
return V_29 ;
}
F_160 ( & V_234 -> V_209 , L_11 , V_23 -> V_238 ) ;
F_161 ( V_23 -> V_238 ) ;
V_29 = F_162 ( & V_234 -> V_209 , & V_23 -> V_143 ) ;
if ( V_29 ) {
F_155 ( & V_234 -> V_209 , L_12 ) ;
goto V_239;
}
V_23 -> V_42 = F_163 ( & V_240 ) ;
if ( F_29 ( V_23 -> V_42 ) ) {
...
V_23 -> V_35 -> V_244 = & V_245 ;
V_23 -> V_35 -> V_246 = & V_247 ;
V_23 -> V_35 -> V_248 = - 1 ;
V_23 -> V_35 -> V_249 = V_250 ;
V_23 -> V_35 -> V_32 = & V_23 -> V_32 ;
V_23 -> V_35 -> V_143 = & V_23 -> V_143 ;
V_23 -> V_35 -> V_251 = V_252 ;
V_29 = F_166 ( V_23 -> V_35 , V_253 , - 1 ) ;
if ( V_29 ) {
F_60 ( & V_23 -> V_143 , L_16 ) ;
goto V_254;
}
...
F_48 ( V_23 -> V_255 -> V_98 , V_81 ,
sizeof( V_23 -> V_255 -> V_98 ) ) ;
V_23 -> V_255 -> V_244 = & V_245 ;
V_23 -> V_255 -> V_246 = & V_247 ;
V_23 -> V_255 -> V_248 = - 1 ;
V_23 -> V_255 -> V_249 = V_250 ;
V_23 -> V_255 -> V_32 = & V_23 -> V_32 ;
V_23 -> V_255 -> V_143 = & V_23 -> V_143 ;
V_29 = F_166 ( V_23 -> V_255 , V_253 , - 1 ) ;
if ( V_29 ) {
F_60 ( & V_23 -> V_143 , L_16 ) ;
goto V_257;
}
F_167 ( V_23 -> V_255 , V_23 ) ;
F_168 ( & V_23 -> V_143 ,
L_18 ,
V_23 -> V_255 -> V_93 ) ;
F_169 ( V_234 , V_23 ) ;
F_170 ( & V_234 -> V_209 ) ;
F_168 ( & V_23 -> V_143 , L_19 ) ;
return 0 ;
V_257:
V_250 ( V_23 -> V_255 ) ;
V_256:
...
static int F_180 ( struct V_258 * V_209 )
{
return 0 ;
}
static int F_181 ( struct V_258 * V_209 )
{
