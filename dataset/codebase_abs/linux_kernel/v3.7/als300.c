...
struct V_6 * V_7 = F_31 ( V_62 ) ;
struct V_63 * V_31 = V_62 -> V_31 ;
unsigned short V_77 = F_42 ( V_62 ) ;
unsigned short V_78 = F_43 ( V_62 ) ;
F_7 () ;
F_44 ( & V_7 -> V_79 ) ;
...
static int T_7 F_60 ( struct V_110 * V_60 ,
...
V_112 = F_15 ;
if ( F_70 ( V_18 -> V_17 , V_112 , V_117 ,
V_118 , V_7 ) ) {
F_71 ( V_115 L_12 , V_18 -> V_17 ) ;
F_9 ( V_7 ) ;
return - V_119 ;
}
V_7 -> V_17 = V_18 -> V_17 ;
