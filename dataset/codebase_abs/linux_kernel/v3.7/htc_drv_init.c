...
F_73 ( V_202 ) |
F_73 ( V_203 ) ;
V_12 -> V_13 -> V_189 &= ~ V_204 ;
V_12 -> V_13 -> V_189 |= V_205 |
V_206 ;
V_12 -> V_207 = 4 ;
V_12 -> V_208 = 5000 ;
V_12 -> V_209 = 1 ;
...
V_12 -> V_214 = sizeof( struct V_215 ) +
sizeof( struct V_216 ) + 4 ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
V_12 -> V_13 -> V_217 [ V_128 ] =
& V_2 -> V_127 [ V_128 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
V_12 -> V_13 -> V_217 [ V_137 ] =
& V_2 -> V_127 [ V_137 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_218 ) {
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_128 ] . V_219 ) ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_137 ] . V_219 ) ;
}
F_74 ( V_12 , V_55 -> V_220 ) ;
}
...
if ( V_26 )
return - V_125 ;
V_2 -> V_224 = F_77 ( V_222 . V_225 ) ;
V_2 -> V_226 = F_77 ( V_222 . V_227 ) ;
snprintf ( V_12 -> V_13 -> V_228 , V_229 , L_16 ,
V_2 -> V_224 ,
V_2 -> V_226 ) ;
F_22 ( V_2 -> V_8 , L_17 ,
V_2 -> V_224 ,
...
if ( error != 0 )
goto V_235;
error = F_79 ( & V_55 -> V_236 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_237;
V_57 = & V_55 -> V_236 ;
...
goto V_244;
if ( ! F_85 ( V_57 ) ) {
error = F_86 ( V_12 -> V_13 , V_57 -> V_245 ) ;
if ( error )
goto V_246;
}
error = F_87 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_88 ( V_2 -> V_10 , V_233 , sizeof( V_233 ) ) ;
F_89 ( V_12 -> V_13 , L_21 , V_233 ) ;
F_90 ( V_2 ) ;
F_91 ( V_2 ) ;
return 0 ;
V_246:
...
int F_92 ( struct V_247 * V_248 , struct V_249 * V_8 ,
T_1 V_24 , char * V_144 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_93 ( sizeof( struct V_1 ) , & V_250 ) ;
if ( ! V_12 )
return - V_148 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_98 ( struct V_247 * V_248 , bool V_253 )
{
if ( V_248 -> V_251 ) {
if ( V_253 )
V_248 -> V_251 -> V_10 -> V_151 |= V_254 ;
F_9 ( V_248 -> V_251 ) ;
F_96 ( V_248 -> V_251 ) ;
F_97 ( V_248 -> V_251 -> V_12 ) ;
}
}
void F_99 ( struct V_247 * V_248 )
{
F_100 ( V_248 -> V_251 , V_255 ) ;
}
int F_101 ( struct V_247 * V_248 )
{
struct V_1 * V_2 = V_248 -> V_251 ;
int V_26 ;
V_26 = F_1 ( V_2 ) ;
if ( V_26 )
return V_26 ;
