...
static int F_117 ( struct V_55 * V_2 , int V_267 , int V_268 , char V_256 * V_269 , unsigned int V_270 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_184 ;
F_57 ( V_3 ) ;
V_184 = F_118 ( V_2 , V_267 , V_268 , V_269 , V_270 , 0 ) ;
F_58 ( V_3 ) ;
return V_184 ;
}
static int F_118 ( struct V_55 * V_2 , int V_267 , int V_268 , char V_256 * V_269 , unsigned int V_270 , int V_194 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
long V_181 ;
...
return - V_171 ;
if ( V_270 != sizeof( struct V_217 ) )
return - V_171 ;
if ( F_4 ( V_273 . V_218 . V_219 ) > 16 )
return - V_171 ;
memcpy ( & V_5 -> V_241 , & V_273 . V_218 , V_270 ) ;
break;
case V_276 :
if ( V_2 -> V_72 != V_190 &&
V_5 -> V_96 == V_97 )
...
if ( F_4 ( V_273 . V_218 . V_219 ) > 16 )
return - V_171 ;
memcpy ( & V_5 -> V_242 , & V_273 . V_218 , V_270 ) ;
break;
case V_277 :
if ( V_2 -> V_72 == V_190 )
return - V_195 ;
if ( V_5 -> V_72 != V_73 )
return - V_171 ;
if ( V_270 != sizeof( struct V_210 ) )
return - V_171 ;
if ( ( V_273 . V_211 . V_101 > V_278 ) ||
( V_273 . V_211 . V_215 > V_278 ) ||
( V_273 . V_211 . V_213 > V_278 ) )
return - V_171 ;
memcpy ( & V_5 -> V_100 , & V_273 . V_211 , V_270 ) ;
break;
case V_279 :
if ( V_2 -> V_72 == V_190 )
return - V_195 ;
...
if ( V_270 != sizeof( int ) )
return - V_171 ;
if ( ( V_273 . V_271 != V_97 ) && ( V_273 . V_271 != V_280 ) )
return - V_171 ;
V_5 -> V_96 = ( unsigned char ) V_273 . V_271 ;
break;
case V_281 :
if ( V_5 -> V_72 != V_142 )
return - V_171 ;
...
default:
#ifdef F_120
return F_121 ( V_3 , V_57 , V_268 , V_269 , V_270 ) ;
#endif
case V_283 :
case V_284 :
case V_285 :
...
return - V_171 ;
if ( V_273 . V_272 > V_104 )
V_273 . V_272 = V_104 ;
if ( V_273 . V_272 == 0 )
return - V_171 ;
V_5 -> V_103 = V_273 . V_272 ;
if ( V_5 -> V_105 > V_273 . V_272 )
V_5 -> V_105 = V_273 . V_272 ;
break;
case V_288 :
if ( V_270 != sizeof( int ) )
return - V_171 ;
...
if ( V_273 . V_230 & 0xfc )
return - V_171 ;
V_5 -> V_91 = V_273 . V_230 ;
break;
}
return 0 ;
}
static int F_122 ( struct V_55 * V_2 , int V_267 , int V_268 , char V_256 * V_269 , int V_256 * V_270 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_184 ;
F_57 ( V_3 ) ;
V_184 = F_123 ( V_2 , V_267 , V_268 , V_269 , V_270 , 0 ) ;
F_58 ( V_3 ) ;
return V_184 ;
}
static int F_123 ( struct V_55 * V_2 , int V_267 , int V_268 , char V_256 * V_269 , int V_256 * V_270 , int V_194 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
struct V_292 V_293 ;
...
void * V_295 = NULL ;
unsigned int V_253 ;
if( F_124 ( V_294 , V_270 ) )
return - V_274 ;
switch ( V_268 ) {
case V_275 :
if ( V_294 > sizeof( struct V_217 ) )
V_294 = sizeof( struct V_217 ) ;
V_295 = & V_5 -> V_236 ;
break;
case V_276 :
if ( V_294 > sizeof( struct V_217 ) )
...
break;
case V_277 :
if ( V_294 > sizeof( struct V_210 ) )
V_294 = sizeof( struct V_210 ) ;
V_295 = & V_5 -> V_100 ;
break;
case V_279 :
...
if ( F_124 ( V_31 , V_270 ) )
return - V_274 ;
V_303 = F_125 ( V_3 , V_57 , V_268 , V_269 , & V_31 ) ;
if ( V_303 >= 0 )
V_303 = F_112 ( V_31 , V_270 ) ;
return V_303 ;
}
#endif
case V_284 :
...
if ( V_295 ) {
if ( F_126 ( V_269 , V_295 , V_294 ) )
return - V_274 ;
if ( F_112 ( V_294 , V_270 ) )
return - V_274 ;
}
return 0 ;
}
static int F_127 ( struct V_2 * V_3 , struct V_304 * V_305 , int V_194 , int V_306 )
{
struct V_39 * V_40 ;
int V_31 = 0 ;
if ( V_194 & V_307 )
...
static int F_128 ( struct V_311 * V_312 , struct V_55 * V_2 ,
struct V_313 * V_314 , T_6 V_34 , int V_194 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
struct V_304 * V_315 = & V_3 -> V_222 ;
T_6 V_306 = V_34 > 1 ? 1 : 0 ;
T_6 V_316 = 0 ;
int V_18 = 0 ;
struct V_39 * V_40 , * V_317 ;
struct V_41 * V_42 = NULL ;
unsigned char V_318 = 0 ;
long V_181 = F_97 ( V_3 , V_194 & V_319 ) ;
F_57 ( V_3 ) ;
if ( F_65 ( V_3 , V_177 ) ) {
V_18 = - V_176 ;
goto V_21;
...
if ( V_18 )
goto V_21;
if ( V_194 & ~ ( V_321 | V_322 | V_307 | V_310 | V_319 | V_323 ) ) {
V_18 = - V_251 ;
goto V_21;
}
if ( V_194 & V_307 )
...
if ( F_127 ( V_3 , V_315 , V_194 , V_306 ) )
break;
if ( V_194 & V_319 ) {
V_18 = - V_327 ;
goto V_21;
...
F_75 ( F_76 ( V_3 ) , & V_183 , V_187 ) ;
F_129 ( V_328 , & V_3 -> V_136 -> V_194 ) ;
F_130 ( V_3 , & V_181 , F_127 ( V_3 , V_315 , V_194 , V_306 ) ) ;
F_131 ( V_328 , & V_3 -> V_136 -> V_194 ) ;
F_81 ( F_76 ( V_3 ) , & V_183 ) ;
}
F_132 (queue, skb, n) {
unsigned int V_329 = V_40 -> V_31 ;
V_42 = F_30 ( V_40 ) ;
if ( ( V_329 + V_316 ) > V_34 )
V_329 = V_34 - V_316 ;
if ( F_133 ( V_314 -> V_330 , V_40 -> V_32 , V_329 ) ) {
V_18 = - V_274 ;
break;
}
V_316 += V_329 ;
if ( ! ( V_194 & V_322 ) )
F_91 ( V_40 , V_329 ) ;
V_318 = V_42 -> V_308 & 0x40 ;
if ( V_40 -> V_31 == 0 ) {
F_134 ( V_40 , V_315 ) ;
F_101 ( V_40 ) ;
if ( ( V_5 -> V_82 == V_331 ) && ! F_135 ( V_3 ) ) {
V_5 -> V_82 = V_81 ;
F_44 ( V_3 , V_81 , 0 ) ;
}
}
...
V_18 = V_316 ;
if ( V_318 && ( V_3 -> V_309 == V_157 ) )
V_314 -> V_325 |= V_332 ;
V_21:
if ( V_18 == 0 )
V_18 = ( V_194 & V_322 ) ? - V_3 -> V_324 : F_78 ( V_3 ) ;
if ( ( V_18 >= 0 ) && V_314 -> V_333 ) {
memcpy ( V_314 -> V_333 , & V_5 -> V_44 , sizeof( struct V_23 ) ) ;
V_314 -> V_334 = sizeof( struct V_23 ) ;
}
F_58 ( V_3 ) ;
return V_18 ;
}
static inline int F_136 ( struct V_4 * V_5 , struct V_304 * V_315 , int V_194 )
{
unsigned char V_335 = V_5 -> V_87 & V_232 ;
if ( F_137 ( V_315 ) >= V_5 -> V_105 )
return 1 ;
if ( V_335 != V_89 ) {
if ( V_194 & V_307 ) {
if ( V_5 -> V_84 == 0 )
...
unsigned int F_138 ( struct V_168 * V_169 , int V_336 )
{
unsigned int V_337 = 230 - V_93 ;
if ( V_169 ) {
struct V_338 * V_339 = F_139 ( V_169 -> V_175 ) ;
V_336 -= F_140 ( V_169 ) ;
if ( V_339 -> V_340 )
V_336 -= 21 ;
else
...
struct V_4 * V_5 = F_2 ( V_3 ) ;
int V_341 = F_142 ( int , V_5 -> V_186 , V_5 -> V_92 ) ;
if ( V_194 & V_307 )
return 16 ;
if ( V_227 ) {
T_7 V_336 = F_143 ( V_227 ) ;
V_341 = F_142 ( int , F_138 ( V_227 -> V_169 , V_336 ) , V_341 ) ;
}
return V_341 ;
}
static inline struct V_39 * F_144 ( struct V_2 * V_3 ,
unsigned long V_342 , int V_343 ,
int * V_344 )
{
struct V_39 * V_40 = F_145 ( V_3 , V_342 ,
V_343 , V_344 ) ;
if ( V_40 ) {
V_40 -> V_153 = F_146 ( V_345 ) ;
V_40 -> V_346 = V_347 ;
}
return V_40 ;
}
static int F_147 ( struct V_311 * V_312 , struct V_55 * V_2 ,
struct V_313 * V_314 , T_6 V_34 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
T_6 V_337 ;
struct V_304 * V_315 = & V_5 -> V_49 ;
int V_194 = V_314 -> V_325 ;
int V_184 = 0 ;
T_6 V_348 = 0 ;
int V_166 = V_314 -> V_334 ;
struct V_23 * V_6 = (struct V_23 * ) V_314 -> V_333 ;
struct V_39 * V_40 = NULL ;
struct V_41 * V_42 ;
T_6 V_31 ;
unsigned char V_335 ;
long V_181 ;
if ( V_194 & ~ ( V_349 | V_307 | V_319 | V_332 | V_323 | V_350 | V_321 ) )
return - V_251 ;
if ( V_166 && ( V_166 != sizeof( struct V_23 ) ) )
return - V_171 ;
F_57 ( V_3 ) ;
V_181 = F_88 ( V_3 , V_194 & V_319 ) ;
if ( V_2 -> type == V_160 ) {
if ( V_194 & V_332 ) {
V_184 = - V_171 ;
goto V_21;
...
if ( ( V_194 & V_349 ) && V_3 -> V_52 )
F_149 ( V_3 ) ;
V_337 = V_5 -> V_92 ;
V_335 = V_5 -> V_87 & V_232 ;
V_337 = F_141 ( V_3 , V_194 ) ;
if ( V_194 & V_307 ) {
V_315 = & V_5 -> V_50 ;
if ( V_34 > V_337 ) {
V_184 = - V_355 ;
...
V_42 = F_30 ( V_40 ) ;
F_150 ( V_40 , 64 + V_93 ) ;
if ( F_151 ( F_152 ( V_40 , V_31 ) , V_314 -> V_330 , V_31 ) ) {
V_184 = - V_274 ;
goto V_21;
}
if ( V_194 & V_307 ) {
...
V_42 -> V_308 |= 0x20 ;
V_5 -> V_357 += V_31 ;
if ( ( ( V_348 + V_31 ) == V_34 ) && ( V_194 & V_332 ) ) {
V_42 -> V_308 |= 0x40 ;
V_5 -> V_357 = 0 ;
if ( V_335 == V_358 )
V_5 -> V_83 -- ;
...
V_348 += V_31 ;
F_153 ( V_3 , V_40 , V_3 -> V_67 , V_194 & V_307 ) ;
V_40 = NULL ;
V_5 -> V_112 = F_46 ( V_3 ) ;
}
V_21:
F_101 ( V_40 ) ;
F_58 ( V_3 ) ;
return V_348 ? V_348 : V_184 ;
V_351:
V_184 = F_154 ( V_3 , V_194 , V_184 ) ;
F_58 ( V_3 ) ;
return V_184 ;
}
static int F_155 ( struct V_360 * V_361 , unsigned long V_362 ,
void * V_212 )
{
...
static struct V_2 * F_159 ( struct V_366 * V_367 )
{
struct V_368 * V_72 = V_367 -> V_369 ;
struct V_2 * V_317 = NULL ;
for( V_72 -> V_370 = 0 ;
V_72 -> V_370 < V_371 ;
++ V_72 -> V_370 ) {
V_317 = F_28 ( & V_10 [ V_72 -> V_370 ] ) ;
if ( V_317 )
break;
}
return V_317 ;
}
static struct V_2 * F_160 ( struct V_366 * V_367 ,
struct V_2 * V_317 )
{
struct V_368 * V_72 = V_367 -> V_369 ;
V_317 = F_161 ( V_317 ) ;
...
static struct V_2 * F_162 ( struct V_366 * V_367 , T_8 * V_373 )
{
struct V_2 * V_3 = F_159 ( V_367 ) ;
if ( V_3 ) {
while( * V_373 && ( V_3 = F_160 ( V_367 , V_3 ) ) )
-- * V_373 ;
}
return * V_373 ? NULL : V_3 ;
}
static void * F_163 ( struct V_366 * V_367 , T_8 V_373 )
{
void * V_374 ;
F_164 ( & V_20 ) ;
V_374 = F_162 ( V_367 , & V_373 ) ;
if ( ! V_374 ) {
F_165 ( & V_20 ) ;
}
return V_374 ;
}
static void * F_166 ( struct V_366 * V_367 , T_8 * V_373 )
{
return * V_373 ? F_163 ( V_367 , * V_373 - 1 ) : V_375 ;
}
static void * F_167 ( struct V_366 * V_367 , void * V_376 , T_8 * V_373 )
{
void * V_374 ;
if ( V_376 == V_375 ) {
V_374 = F_163 ( V_367 , 0 ) ;
...
static void F_168 ( struct V_366 * V_367 , void * V_376 )
{
if ( V_376 && V_376 != V_375 )
F_165 ( & V_20 ) ;
}
static void F_169 ( struct V_23 * V_377 , unsigned char * V_30 )
{
int V_24 ;
switch ( F_4 ( V_377 -> V_27 ) ) {
case 0 :
sprintf ( V_30 , L_4 , V_377 -> V_26 ) ;
break;
default:
for ( V_24 = 0 ; V_24 < F_4 ( V_377 -> V_27 ) ; V_24 ++ ) {
V_30 [ V_24 ] = V_377 -> V_28 [ V_24 ] ;
if ( F_170 ( V_30 [ V_24 ] ) )
V_30 [ V_24 ] = '.' ;
}
V_30 [ V_24 ] = 0 ;
...
static inline void F_172 ( struct V_366 * V_367 , struct V_2 * V_3 )
{
struct V_4 * V_5 = F_2 ( V_3 ) ;
char V_379 [ V_380 ] ;
char V_381 [ V_380 ] ;
...
char V_383 [ V_36 + 3 ] ;
F_169 ( & V_5 -> V_6 , V_382 ) ;
F_169 ( & V_5 -> V_44 , V_383 ) ;
F_173 ( V_367 ,
L_22
L_23 ,
F_52 ( F_4 ( F_31 ( & V_5 -> V_6 ) ) , V_379 ) ,
V_5 -> V_11 ,
V_5 -> V_74 ,
V_5 -> V_75 ,
V_5 -> V_76 ,
...
static int F_174 ( struct V_366 * V_367 , void * V_376 )
{
if ( V_376 == V_375 ) {
F_175 ( V_367 , L_26 ) ;
} else {
...
static int F_176 ( struct V_386 * V_386 , struct V_246 * V_246 )
{
return F_177 ( V_246 , & V_387 ,
sizeof( struct V_368 ) ) ;
}
