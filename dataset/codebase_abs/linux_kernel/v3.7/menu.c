...
V_16 -> V_63 . V_21 = F_34 ( V_16 -> V_63 . V_21 , V_17 -> V_31 ) ;
}
for ( V_1 = V_17 -> V_14 ; V_1 ; V_1 = V_1 -> V_19 ) {
if ( V_16 && F_29 ( V_16 ) &&
...
{
int V_81 , V_82 ;
struct V_1 * V_83 [ 8 ] , * V_1 , * V_84 = NULL ;
struct V_85 * V_86 ;
...
V_1 = V_9 -> V_1 -> V_17 ;
for ( V_81 = 0 ; V_1 != & V_12 && V_81 < 8 ; V_1 = V_1 -> V_17 ) {
bool V_87 = F_47 ( V_1 ) ;
V_83 [ V_81 ++ ] = V_1 ;
if ( V_84 == NULL && V_87 )
V_84 = V_1 ;
...
if ( V_80 && V_84 ) {
V_86 = malloc ( sizeof( struct V_85 ) ) ;
if ( F_47 ( V_9 -> V_1 ) ) {
V_86 -> V_88 = V_9 -> V_1 ;
} else
V_86 -> V_88 = V_84 ;
...
V_86 -> V_89 = F_61 ( V_80 -> V_90 , struct V_85 ,
V_91 ) -> V_89 + 1 ;
F_62 ( & V_86 -> V_91 , V_80 ) ;
}
if ( V_81 > 0 ) {
F_57 ( V_78 , _ ( L_29 ) ) ;
for ( V_82 = 4 ; -- V_81 >= 0 ; V_82 += 2 ) {
V_1 = V_83 [ V_81 ] ;
if ( V_80 && V_84 && V_1 == V_84 )
V_86 -> V_92 = V_78 -> V_93 - 1 ;
F_57 ( V_78 , L_30 , V_82 , ' ' ,
_ ( F_51 ( V_1 ) ) ) ;
if ( V_1 -> V_16 ) {
...
void F_64 ( struct V_77 * V_78 , struct V_15 * V_16 ,
struct V_79 * V_80 )
{
bool V_94 ;
struct V_8 * V_9 ;
...
struct V_77 F_68 ( struct V_15 * * V_95 , struct V_79 * V_80 )
{
struct V_15 * V_16 ;
struct V_77 V_96 = F_69 () ;
int V_81 ;
for ( V_81 = 0 ; V_95 && ( V_16 = V_95 [ V_81 ] ) ; V_81 ++ )
F_64 ( & V_96 , V_16 , V_80 ) ;
if ( ! V_81 )
F_58 ( & V_96 , _ ( L_39 ) ) ;
return V_96 ;
}
void F_70 ( struct V_1 * V_1 , struct V_77 * V_76 )
{
struct V_15 * V_16 = V_1 -> V_16 ;
const char * V_97 = V_98 ;
if ( F_54 ( V_1 ) ) {
if ( V_16 -> V_6 )
F_57 ( V_76 , L_40 , V_99 , V_16 -> V_6 ) ;
V_97 = F_55 ( V_1 ) ;
}
F_57 ( V_76 , L_41 , _ ( V_97 ) ) ;
if ( V_16 )
F_64 ( V_76 , V_16 , NULL ) ;
}
