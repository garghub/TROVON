...
if ( V_83 & 0xFDFFA000 )
F_32 ( L_1
L_2 , F_33 ( V_4 -> V_2 ) , V_83 ) ;
if ( V_83 & V_91 )
return - V_90 ;
}
return 0 ;
}
int F_34 ( struct V_3 * V_4 , T_2 V_78 , T_2 V_79 , T_2 V_80 ,
unsigned int V_81 )
{
return F_29 ( V_4 , V_78 , V_79 , V_80 , V_81 , true ) ;
}
int F_30 ( struct V_3 * V_4 , T_1 * V_83 )
{
int V_5 ;
struct V_6 V_7 = { 0 } ;
F_2 ( ! V_4 ) ;
...
static int
F_35 ( struct V_3 * V_4 , struct V_1 * V_2 , T_2 V_8 ,
T_2 V_46 )
{
struct V_47 V_48 = { NULL } ;
struct V_6 V_7 = { 0 } ;
...
T_2 * V_94 ;
int V_32 , V_5 ;
static T_2 V_95 [ 8 ] = { 0x55 , 0xaa , 0 , 0 , 0 , 0 , 0 , 0 } ;
static T_2 V_96 [ 4 ] = { 0x5a , 0 , 0 , 0 } ;
V_53 = F_18 ( V_46 , V_55 ) ;
if ( ! V_53 )
return - V_56 ;
if ( V_46 == 8 )
...
int F_37 ( struct V_3 * V_4 , T_2 V_101 )
{
int V_5 , V_102 ;
if ( V_101 == V_103 )
V_102 = 8 ;
...
return - V_70 ;
F_35 ( V_4 , V_4 -> V_2 , V_97 , V_102 ) ;
V_5 = F_35 ( V_4 , V_4 -> V_2 , V_98 , V_102 ) ;
return V_5 ;
}
int F_38 ( struct V_3 * V_4 , T_1 * V_83 )
{
struct V_6 V_7 = { 0 } ;
unsigned int V_8 ;
int V_5 ;
