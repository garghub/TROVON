...
bool V_97 ;
F_65 ( & V_6 -> V_2 -> V_98 ) ;
V_97 = V_6 -> V_8 != V_6 -> V_99 ;
if ( V_97 ) {
* V_75 = V_6 -> V_7 [ V_6 -> V_99 ] ;
V_6 -> V_99 = ( V_6 -> V_99 + 1 ) % V_9 ;
}
F_66 ( & V_6 -> V_2 -> V_98 ) ;
return V_97 ;
}
...
struct V_93 V_75 ;
T_3 V_100 = 0 ;
while ( V_100 + F_61 () <= V_77 &&
F_64 ( V_6 , & V_75 ) ) {
if ( F_68 ( V_76 + V_100 , & V_75 ) )
return - V_95 ;
V_100 += F_61 () ;
}
return V_100 ;
...
static unsigned int F_70 ( struct V_65 * V_65 , T_6 * V_104 )
{
struct V_5 * V_6 = V_65 -> V_69 ;
F_71 ( V_65 , & V_6 -> V_10 , V_104 ) ;
if ( V_6 -> V_8 != V_6 -> V_99 )
return V_105 | V_106 ;
return 0 ;
}
...
if ( V_109 ) {
struct V_110 V_111 ;
V_111 . V_112 = V_108 -> V_112 ;
V_111 . V_20 = V_108 -> V_20 ;
memcpy ( & V_111 . V_35 , & V_108 -> V_35 ,
sizeof( struct V_113 ) ) ;
memcpy ( & V_111 . V_36 , & V_108 -> V_36 ,
sizeof( struct V_113 ) ) ;
if ( F_74 ( V_76 , & V_111 ,
sizeof( struct V_110 ) ) )
return - V_95 ;
...
V_108 -> V_20 = V_111 . V_20 ;
memcpy ( & V_108 -> V_35 , & V_111 . V_35 ,
sizeof( struct V_113 ) ) ;
memcpy ( & V_108 -> V_36 , & V_111 . V_36 ,
sizeof( struct V_113 ) ) ;
} else {
if ( F_76 ( V_108 , V_76 ,
sizeof( struct V_107 ) ) )
...
const struct V_107 * V_108 )
{
if ( F_74 ( V_76 , V_108 , sizeof( struct V_107 ) ) )
return - V_95 ;
return 0 ;
}
static int F_75 ( const char T_2 * V_76 ,
struct V_107 * V_108 )
{
if ( F_76 ( V_108 , V_76 , sizeof( struct V_107 ) ) )
return - V_95 ;
return 0 ;
}
static long F_77 ( struct V_65 * V_65 , unsigned int V_114 ,
unsigned long V_115 , void T_2 * V_116 )
{
int V_20 ;
struct V_5 * V_6 = V_65 -> V_69 ;
struct V_107 V_108 ;
...
break;
case V_122 :
V_20 = F_78 ( V_115 , V_45 , V_123 ) ;
break;
case V_124 :
V_20 = F_78 ( V_115 , V_125 , V_126 ) ;
break;
case V_127 :
V_20 = F_78 ( V_115 , V_128 , V_129 ) ;
break;
case V_130 :
V_20 = F_78 ( V_115 , V_74 , V_131 ) ;
break;
case V_132 :
V_20 = F_78 ( V_115 , V_133 , V_134 ) ;
break;
case V_135 :
V_20 = F_78 ( V_115 , V_136 , V_137 ) ;
break;
case V_138 :
V_20 = F_78 ( V_115 , V_139 , V_140 ) ;
break;
case V_141 :
V_20 = F_78 ( V_115 , V_142 , V_143 ) ;
break;
case V_144 :
V_20 = F_78 ( V_115 , V_145 , V_146 ) ;
break;
case V_147 :
V_20 = F_78 ( V_115 , V_148 , V_149 ) ;
break;
case V_150 :
if ( V_6 -> V_22 == V_23 ) {
V_20 = - V_42 ;
...
break;
case V_151 :
V_20 = F_75 ( V_116 , & V_108 ) ;
if ( V_20 )
break;
V_119 = F_8 ( V_6 , V_108 . V_112 ) ;
if ( ! V_119 || V_119 -> V_3 != V_43 ||
! V_119 -> V_38 . V_44 . V_35 ) {
V_20 = - V_42 ;
break;
}
V_108 . V_20 = 0 ;
V_108 . V_35 = * V_119 -> V_38 . V_44 . V_35 ;
if ( V_119 -> V_38 . V_44 . V_36 )
V_108 . V_36 = * V_119 -> V_38 . V_44 . V_36 ;
else
memset ( & V_108 . V_36 , 0 , sizeof( struct V_34 ) ) ;
V_20 = F_73 ( V_116 , & V_108 ) ;
break;
case V_152 :
if ( F_76 ( & V_118 , V_116 , sizeof( V_118 ) ) ) {
V_20 = - V_95 ;
break;
}
V_119 = F_8 ( V_6 , V_118 . V_112 ) ;
if ( ! V_119 || V_119 -> V_3 != V_47 ) {
V_20 = - V_42 ;
break;
}
V_118 . V_20 = 0 ;
V_118 . V_33 = V_119 -> V_38 . V_33 ;
if ( F_74 ( V_116 , & V_118 , sizeof( V_118 ) ) ) {
V_20 = - V_95 ;
break;
}
break;
...
static long F_80 ( struct V_65 * V_65 , unsigned int V_114 , unsigned long V_115 )
{
return F_77 ( V_65 , V_114 , V_115 , ( void T_2 * ) V_115 ) ;
}
static long F_81 ( struct V_65 * V_65 ,
unsigned int V_114 , unsigned long V_115 )
{
return F_77 ( V_65 , V_114 , V_115 , F_82 ( V_115 ) ) ;
}
