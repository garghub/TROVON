...
struct V_5 * V_6 = F_57 ( V_67 ) ;
struct V_30 * V_63 ;
V_63 = F_44 ( V_6 , V_116 -> type ) ;
if ( F_45 ( V_63 ) )
return F_46 ( V_63 ) ;
V_116 -> V_117 . V_118 = 0 ;
V_116 -> V_117 . V_119 = 0 ;
V_116 -> V_117 . V_92 = V_63 -> V_120 ;
V_116 -> V_117 . V_93 = V_63 -> V_121 ;
V_116 -> V_122 = V_116 -> V_117 ;
return 0 ;
}
static int F_90 ( struct V_66 * V_66 , void * V_67 , struct V_123 * V_116 )
{
struct V_5 * V_6 = F_57 ( V_67 ) ;
struct V_30 * V_63 ;
V_63 = F_44 ( V_6 , V_116 -> type ) ;
if ( F_45 ( V_63 ) )
return F_46 ( V_63 ) ;
V_116 -> V_124 . V_118 = V_63 -> V_125 ;
V_116 -> V_124 . V_119 = V_63 -> V_126 ;
V_116 -> V_124 . V_92 = V_63 -> V_92 ;
V_116 -> V_124 . V_93 = V_63 -> V_93 ;
return 0 ;
}
static int F_91 ( struct V_5 * V_6 , struct V_123 * V_116 )
{
struct V_12 * V_15 = V_6 -> V_12 ;
struct V_30 * V_55 ;
T_1 V_127 , V_128 , V_61 = 0 ;
int V_56 ;
if ( V_116 -> V_124 . V_119 < 0 || V_116 -> V_124 . V_118 < 0 ) {
...
V_128 = F_66 ( V_55 -> V_50 -> V_103 ) ? 0 : 1 ;
else
V_128 = F_64 ( V_15 -> V_42 -> V_102 ) - 1 ;
for ( V_56 = 0 ; V_56 < V_55 -> V_50 -> V_106 ; V_56 ++ )
V_61 += V_55 -> V_50 -> V_61 [ V_56 ] ;
F_67 ( & V_116 -> V_124 . V_92 , V_127 , V_55 -> V_120 ,
F_64 ( V_127 ) - 1 ,
& V_116 -> V_124 . V_93 , V_127 , V_55 -> V_121 ,
V_128 , 64 / ( F_92 ( V_61 , 8 ) ) ) ;
if ( V_116 -> V_124 . V_118 + V_116 -> V_124 . V_92 > V_55 -> V_120 )
V_116 -> V_124 . V_118 = V_55 -> V_120 - V_116 -> V_124 . V_92 ;
if ( V_116 -> V_124 . V_119 + V_116 -> V_124 . V_93 > V_55 -> V_121 )
V_116 -> V_124 . V_119 = V_55 -> V_121 - V_116 -> V_124 . V_93 ;
V_116 -> V_124 . V_118 = F_93 ( V_116 -> V_124 . V_118 , V_127 ) ;
V_116 -> V_124 . V_119 = F_93 ( V_116 -> V_124 . V_119 , V_15 -> V_42 -> V_129 ) ;
F_50 ( L_8 ,
V_116 -> V_124 . V_118 , V_116 -> V_124 . V_119 , V_116 -> V_124 . V_92 , V_116 -> V_124 . V_93 ,
V_55 -> V_59 , V_55 -> V_60 ) ;
return 0 ;
}
static int F_94 ( struct V_66 * V_66 , void * V_67 , const struct V_123 * V_130 )
{
struct V_5 * V_6 = F_57 ( V_67 ) ;
struct V_12 * V_15 = V_6 -> V_12 ;
struct V_123 V_116 = * V_130 ;
struct V_30 * V_55 ;
int V_16 ;
V_16 = F_91 ( V_6 , & V_116 ) ;
if ( V_16 )
...
if ( V_116 . type == V_2 ) {
V_16 = F_95 ( V_6 , V_116 . V_124 . V_92 ,
V_116 . V_124 . V_93 , V_6 -> V_38 . V_92 ,
V_6 -> V_38 . V_93 , V_6 -> V_131 ) ;
} else {
V_16 = F_95 ( V_6 , V_6 -> V_37 . V_92 ,
V_6 -> V_37 . V_93 , V_116 . V_124 . V_92 ,
V_116 . V_124 . V_93 , V_6 -> V_131 ) ;
}
if ( V_16 ) {
...
V_55 -> V_125 = V_116 . V_124 . V_118 ;
V_55 -> V_126 = V_116 . V_124 . V_119 ;
V_55 -> V_92 = V_116 . V_124 . V_92 ;
V_55 -> V_93 = V_116 . V_124 . V_93 ;
F_9 ( V_39 , V_6 ) ;
return 0 ;
}
static int F_96 ( void * V_28 , struct V_21 * V_132 ,
struct V_21 * V_133 )
{
struct V_5 * V_6 = V_28 ;
int V_16 ;
...
V_133 -> V_137 = & V_138 ;
V_133 -> V_139 = & V_140 ;
V_133 -> V_141 = sizeof( struct V_142 ) ;
return F_97 ( V_133 ) ;
}
...
int V_16 = - V_105 ;
F_50 ( L_10 ,
F_100 ( V_143 ) , V_15 -> V_36 , V_15 -> V_144 . V_145 ) ;
if ( F_101 ( & V_15 -> V_65 ) )
return - V_146 ;
if ( V_15 -> V_144 . V_145 > 0 )
goto V_147;
V_6 = F_102 ( sizeof( * V_6 ) , V_148 ) ;
if ( ! V_6 ) {
V_16 = - V_149 ;
goto V_147;
}
F_103 ( & V_6 -> V_67 , & V_15 -> V_13 . V_104 ) ;
V_6 -> V_12 = V_15 ;
V_6 -> V_37 . V_50 = F_104 ( 0 ) ;
V_6 -> V_38 . V_50 = F_104 ( 0 ) ;
V_16 = F_105 ( V_6 ) ;
if ( V_16 )
goto V_150;
V_6 -> V_67 . V_151 = & V_6 -> V_152 . V_153 ;
V_66 -> V_154 = & V_6 -> V_67 ;
F_106 ( & V_6 -> V_67 ) ;
V_6 -> V_36 = V_44 ;
V_6 -> V_33 = 0 ;
V_6 -> V_155 = V_156 ;
V_6 -> V_157 = V_156 ;
V_6 -> V_11 = F_107 ( V_15 -> V_13 . V_14 , V_6 , F_96 ) ;
if ( F_45 ( V_6 -> V_11 ) ) {
V_16 = F_46 ( V_6 -> V_11 ) ;
goto V_158;
}
if ( V_15 -> V_13 . V_145 ++ == 0 )
F_19 ( V_159 , & V_15 -> V_36 ) ;
F_55 ( & V_15 -> V_65 ) ;
return 0 ;
V_158:
F_108 ( V_6 ) ;
...
static int F_112 ( struct V_66 * V_66 )
{
struct V_5 * V_6 = F_57 ( V_66 -> V_154 ) ;
struct V_12 * V_15 = V_6 -> V_12 ;
F_50 ( L_11 ,
F_100 ( V_143 ) , V_15 -> V_36 , V_15 -> V_13 . V_145 ) ;
F_53 ( & V_15 -> V_65 ) ;
F_113 ( V_6 -> V_11 ) ;
F_108 ( V_6 ) ;
F_109 ( & V_6 -> V_67 ) ;
F_110 ( & V_6 -> V_67 ) ;
if ( -- V_15 -> V_13 . V_145 <= 0 )
F_114 ( V_159 , & V_15 -> V_36 ) ;
F_111 ( V_6 ) ;
F_55 ( & V_15 -> V_65 ) ;
return 0 ;
}
static unsigned int F_115 ( struct V_66 * V_66 ,
struct V_160 * V_161 )
{
struct V_5 * V_6 = F_57 ( V_66 -> V_154 ) ;
struct V_12 * V_15 = V_6 -> V_12 ;
...
if ( F_101 ( & V_15 -> V_65 ) )
return - V_146 ;
V_16 = F_116 ( V_66 , V_6 -> V_11 , V_161 ) ;
F_55 ( & V_15 -> V_65 ) ;
return V_16 ;
}
static int F_117 ( struct V_66 * V_66 , struct V_162 * V_163 )
{
struct V_5 * V_6 = F_57 ( V_66 -> V_154 ) ;
struct V_12 * V_15 = V_6 -> V_12 ;
int V_16 ;
if ( F_101 ( & V_15 -> V_65 ) )
return - V_146 ;
V_16 = F_118 ( V_66 , V_6 -> V_11 , V_163 ) ;
F_55 ( & V_15 -> V_65 ) ;
return V_16 ;
}
int F_119 ( struct V_12 * V_15 ,
struct V_164 * V_165 )
{
struct V_166 * V_104 = & V_15 -> V_13 . V_104 ;
int V_16 ;
V_15 -> V_165 = V_165 ;
...
V_104 -> V_174 = V_175 ;
snprintf ( V_104 -> V_71 , sizeof( V_104 -> V_71 ) , L_12 , V_15 -> V_176 ) ;
F_120 ( V_104 , V_15 ) ;
V_15 -> V_13 . V_14 = F_121 ( & V_177 ) ;
if ( F_45 ( V_15 -> V_13 . V_14 ) ) {
F_73 ( V_165 , L_13 ) ;
return F_46 ( V_15 -> V_13 . V_14 ) ;
}
V_16 = F_122 ( & V_104 -> V_178 , 0 , NULL , 0 ) ;
if ( V_16 )
goto V_179;
V_16 = F_123 ( V_104 , V_180 , - 1 ) ;
if ( V_16 )
goto V_181;
F_124 ( V_165 , L_14 ,
V_104 -> V_71 , F_125 ( V_104 ) ) ;
return 0 ;
V_181:
F_126 ( & V_104 -> V_178 ) ;
V_179:
...
if ( V_15 -> V_13 . V_14 )
F_127 ( V_15 -> V_13 . V_14 ) ;
if ( F_129 ( & V_15 -> V_13 . V_104 ) ) {
F_130 ( & V_15 -> V_13 . V_104 ) ;
F_126 ( & V_15 -> V_13 . V_104 . V_178 ) ;
}
}
