...
V_2 -> V_22 = V_23 ;
V_2 -> V_20 = F_5 ( V_70 -> V_71 , V_28 [ V_2 -> V_22 ] . V_29 ,
V_28 [ V_2 -> V_22 ] . V_30 ) ;
F_7 ( V_2 ) ;
return 0 ;
}
static int F_17 ( struct V_34 * V_34 , void * V_72 ,
...
for ( V_76 = 0 ; V_76 < F_18 ( V_28 ) ; V_76 ++ ) {
...
{
struct V_1 * V_2 = F_24 ( V_90 -> V_91 , struct V_1 , V_92 ) ;
switch ( V_90 -> V_93 ) {
case V_94 :
V_2 -> V_13 = V_90 -> V_3 ;
F_7 ( V_2 ) ;
...
int F_25 ( struct V_1 * V_2 , struct V_95 * V_96 )
{
int V_97 ;
V_2 -> V_13 = true ;
if ( ! V_2 -> V_47 ) {
...
F_28 ( V_106 , & V_2 -> V_100 . V_107 ) ;
if ( V_2 -> V_47 )
F_29 ( & V_2 -> V_100 , V_108 ) ;
if ( ! V_2 -> V_109 ) {
...
V_97 = F_35 ( & V_2 -> V_100 , V_112 , V_2 -> V_113 ) ;
if ( V_97 ) {
F_32 ( V_2 -> V_39 , L_6 ) ;
F_33 ( V_2 -> V_100 . V_92 ) ;
return V_97 ;
