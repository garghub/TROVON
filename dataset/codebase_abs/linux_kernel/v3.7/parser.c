...
T_2 F_11 ( char * V_26 , const T_1 * V_27 , T_2 V_28 )
{
T_2 V_18 = V_27 -> V_9 - V_27 -> V_7 ;
if ( V_28 ) {
T_2 V_5 = V_18 >= V_28 ? V_28 - 1 : V_18 ;
memcpy ( V_26 , V_27 -> V_7 , V_5 ) ;
V_26 [ V_5 ] = '\0' ;
}
return V_18 ;
}
...
{
T_2 V_29 = V_1 -> V_9 - V_1 -> V_7 + 1 ;
char * V_2 = F_6 ( V_29 , V_20 ) ;
if ( V_2 )
F_11 ( V_2 , V_1 , V_29 ) ;
return V_2 ;
}
