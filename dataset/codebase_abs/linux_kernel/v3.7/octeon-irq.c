...
F_4 ( V_104 , V_131 , 0 , 63 ) ;
for ( V_25 = 0 ; V_25 < 16 ; V_25 ++ )
F_1 ( V_25 + V_64 , 1 , V_25 + 0 , 0 , V_101 , F_76 ) ;
F_4 ( V_104 , V_132 , 1 , 17 ) ;
F_18 ( V_98 | V_99 ) ;
F_15 ( V_91 ) ;
}
...
V_8 . V_11 = F_14 ( V_18 ) ;
V_21 = 1ull << ( V_8 . V_10 . V_2 ) ;
V_133 = F_128 ( V_16 ) + ( 0x1000ull * V_8 . V_10 . line ) ;
F_39 ( V_133 , V_21 ) ;
}
...
V_8 . V_11 = F_14 ( V_18 ) ;
V_21 = 1ull << ( V_8 . V_10 . V_2 ) ;
V_133 = F_132 ( V_16 ) + ( 0x1000ull * V_8 . V_10 . line ) ;
F_39 ( V_133 , V_21 ) ;
}
...
V_8 . V_11 = F_14 ( V_18 ) ;
V_21 = 1ull << ( V_8 . V_10 . V_2 ) ;
V_133 = F_134 ( V_16 ) + ( 0x1000ull * V_8 . V_10 . line ) ;
F_39 ( V_133 , V_21 ) ;
}
...
V_21 = 1ull << ( V_8 . V_10 . V_2 ) ;
F_48 (cpu) {
T_4 V_133 = F_132 ( F_6 ( V_15 ) ) + ( 0x1000ull * V_8 . V_10 . line ) ;
F_39 ( V_133 , V_21 ) ;
}
}
...
if ( F_32 ( V_15 , V_60 ) && V_62 ) {
V_62 = false ;
V_133 = F_128 ( F_6 ( V_15 ) ) + ( 0x1000ull * V_8 . V_10 . line ) ;
} else {
V_133 = F_132 ( F_6 ( V_15 ) ) + ( 0x1000ull * V_8 . V_10 . line ) ;
}
F_39 ( V_133 , V_21 ) ;
}
return 0 ;
...
unsigned int V_80 , T_7 V_81 )
{
return F_96 ( V_66 , V_80 , V_81 , 7 , & V_135 ) ;
}
...
const unsigned long V_89 = F_9 () ;
V_138 = F_99 ( F_114 ( V_89 ) ) & 0xfful ;
if ( F_150 ( ! V_138 ) )
goto V_139;
line = F_101 ( V_138 ) - 1 ;
V_136 = F_151 ( V_89 ) + ( 0x1000 * line ) ;
V_137 = F_99 ( V_136 ) ;
if ( F_150 ( ! V_137 ) )
goto V_139;
V_2 = F_101 ( V_137 ) - 1 ;
...
F_2 ( V_124 , & V_146 , V_30 ) ;
F_2 ( V_125 , & V_146 , V_30 ) ;
F_2 ( V_147 , & V_146 , V_30 ) ;
F_2 ( V_148 , & V_146 , V_30 ) ;
F_18 ( V_98 | V_99 ) ;
F_15 ( V_91 ) ;
}
void T_2 F_157 ( void )
...
if ( F_150 ( V_150 & V_99 ) )
V_106 () ;
else if ( F_150 ( V_150 & V_98 ) )
V_107 () ;
else if ( F_150 ( V_150 & V_91 ) )
V_93 () ;
else if ( F_100 ( V_150 ) )
F_102 ( F_161 ( V_150 ) - 9 + V_153 ) ;
else
break;
}
}
