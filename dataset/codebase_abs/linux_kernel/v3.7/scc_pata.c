...
static int T_6 F_40 ( struct V_96 * V_97 ,
const struct V_106 * V_107 )
{
unsigned long V_17 ;
unsigned long V_7 ;
...
static int T_6 F_55 ( struct V_96 * V_97 , const struct V_158 * V_159 )
{
return F_40 ( V_97 , & V_160 ) ;
}
static void T_7 F_56 ( struct V_96 * V_97 )
{
struct V_15 * V_16 = F_38 ( V_97 ) ;
