...
int V_44 ;
int V_45 = 0 ;
V_45 |= F_14 ( & V_43 -> V_46 , V_47 ) ;
V_45 |= F_14 ( & V_43 -> V_48 ,
V_49 | V_50 ) ;
V_45 |= F_14 ( & V_43 -> V_51 , V_47 ) ;
V_45 |= F_14 ( & V_43 -> V_52 , V_53 ) ;
V_45 |= F_14 ( & V_43 -> V_54 , V_53 | V_55 ) ;
if ( V_45 )
return 1 ;
V_45 |= F_15 ( V_43 -> V_48 ) ;
V_45 |= F_15 ( V_43 -> V_54 ) ;
...
static int F_21 ( struct V_6 * V_7 , struct V_10 * V_11 ,
struct V_30 * V_31 , unsigned int * V_5 )
{
int V_33 ;
...
static int F_25 ( struct V_6 * V_7 , struct V_85 * V_86 )
{
const struct V_8 * V_9 = F_2 ( V_7 ) ;
int V_87 ;
unsigned long V_15 ;
...
if ( V_87 )
return V_87 ;
V_87 = F_29 ( V_7 , sizeof( struct V_96 ) ) ;
if ( V_87 < 0 )
return V_87 ;
V_11 = & V_7 -> V_12 [ 0 ] ;
V_11 -> type = V_97 ;
