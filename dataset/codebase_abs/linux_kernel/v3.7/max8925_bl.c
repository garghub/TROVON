...
struct V_27 * V_28 = V_25 -> V_16 . V_29 ;
struct V_4 * V_5 ;
struct V_1 * V_2 ;
struct V_30 V_17 ;
struct V_31 * V_32 ;
...
V_5 -> V_7 = V_7 ;
V_5 -> V_14 = 0 ;
memset ( & V_17 , 0 , sizeof( struct V_30 ) ) ;
V_17 . type = V_38 ;
V_17 . V_39 = V_10 ;
V_2 = F_14 ( L_6 , & V_25 -> V_16 , V_5 ,
& V_40 , & V_17 ) ;
if ( F_15 ( V_2 ) ) {
F_13 ( & V_25 -> V_16 , L_7 ) ;
V_9 = F_16 ( V_2 ) ;
