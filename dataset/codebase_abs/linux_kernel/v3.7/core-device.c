...
static int F_100 ( struct V_54 * V_42 , int V_55 ,
bool * V_162 )
{
T_1 V_163 ;
int V_16 , V_89 ;
...
static void F_101 ( struct V_123 * V_122 )
{
struct V_54 * V_42 =
F_12 ( V_122 , struct V_54 , V_122 . V_122 ) ;
struct V_93 * V_56 = V_42 -> V_56 ;
...
bool V_162 ;
V_64 = F_100 ( V_42 , V_42 -> V_55 , & V_162 ) ;
if ( V_64 != V_102 )
goto V_164;
if ( ! V_162 ) {
if ( F_64 ( & V_42 -> V_128 ,
...
void F_104 ( struct V_93 * V_56 , struct V_138 * V_104 , int V_168 )
{
struct V_54 * V_42 ;
switch ( V_168 ) {
case V_169 :
...
if ( V_42 == NULL )
break;
F_103 ( & V_42 -> V_128 , V_156 ) ;
V_42 -> V_56 = F_105 ( V_56 ) ;
V_42 -> V_104 = F_106 ( V_104 ) ;
