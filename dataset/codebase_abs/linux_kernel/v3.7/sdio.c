...
F_39 ( ! V_32 -> V_142 ) ;
if ( ! V_141 ) {
V_85 = F_40 ( V_32 , V_32 -> V_23 , & V_23 ) ;
if ( V_85 )
goto V_85;
}
if ( F_37 ( V_32 ) ) {
V_85 = F_41 ( V_32 , V_143 ) ;
if ( V_85 )
goto V_85;
}
V_5 = F_42 ( V_32 , NULL ) ;
...
if ( ( V_23 & V_144 ) &&
F_43 ( V_32 , V_32 -> V_23 & V_23 , V_5 -> V_145 , NULL ) == 0 ) {
V_5 -> type = V_94 ;
if ( V_140 && ( V_140 -> type != V_94 ||
memcmp ( V_5 -> V_145 , V_140 -> V_145 , sizeof( V_5 -> V_145 ) ) != 0 ) ) {
F_44 ( V_5 ) ;
return - V_146 ;
}
} else {
...
if ( V_32 -> V_112 -> V_147 )
V_32 -> V_112 -> V_147 ( V_32 , V_5 ) ;
if ( ( V_23 & V_26 ) &&
( V_32 -> V_54 &
( V_55 | V_56 |
V_57 | V_58 |
V_59 ) ) ) {
V_85 = F_45 ( V_32 , V_148 ,
true ) ;
if ( V_85 ) {
V_23 &= ~ V_26 ;
V_32 -> V_23 &= ~ V_26 ;
...
if ( ! V_141 && ! F_37 ( V_32 ) ) {
V_85 = F_46 ( V_32 , & V_5 -> V_149 ) ;
if ( V_85 )
goto remove;
if ( V_140 )
V_140 -> V_149 = V_5 -> V_149 ;
}
...
goto remove;
if ( V_140 ) {
int V_152 = ( V_5 -> V_19 . V_18 == V_140 -> V_19 . V_18 &&
...
F_6 ( ! V_32 ) ;
F_6 ( ! V_32 -> V_5 ) ;
for ( V_155 = 0 ; V_155 < V_32 -> V_5 -> V_156 ; V_155 ++ ) {
if ( V_32 -> V_5 -> V_1 [ V_155 ] ) {
F_11 ( V_32 -> V_5 -> V_1 [ V_155 ] ) ;
V_32 -> V_5 -> V_1 [ V_155 ] = NULL ;
}
}
F_44 ( V_32 -> V_5 ) ;
V_32 -> V_5 = NULL ;
...
int V_155 , V_85 = 0 ;
for ( V_155 = 0 ; V_155 < V_32 -> V_5 -> V_156 ; V_155 ++ ) {
struct V_1 * V_2 = V_32 -> V_5 -> V_1 [ V_155 ] ;
if ( V_2 && F_68 ( V_2 ) && V_2 -> V_153 . V_158 ) {
const struct V_159 * V_160 = V_2 -> V_153 . V_158 -> V_161 ;
if ( ! V_160 || ! V_160 -> V_162 || ! V_160 -> V_163 ) {
V_85 = - V_164 ;
} else
V_85 = V_160 -> V_162 ( & V_2 -> V_153 ) ;
if ( V_85 )
break;
}
}
...
F_73 ( V_32 -> V_166 ) ;
F_63 ( V_32 ) ;
for ( V_155 = 0 ; ! V_85 && V_155 < V_32 -> V_5 -> V_156 ; V_155 ++ ) {
struct V_1 * V_2 = V_32 -> V_5 -> V_1 [ V_155 ] ;
if ( V_2 && F_68 ( V_2 ) && V_2 -> V_153 . V_158 ) {
const struct V_159 * V_160 = V_2 -> V_153 . V_158 -> V_161 ;
V_85 = V_160 -> V_163 ( & V_2 -> V_153 ) ;
}
}
return V_85 ;
}
...
F_75 ( V_32 ) ;
F_54 ( V_32 ) ;
F_76 ( V_32 , V_32 -> V_167 ) ;
V_3 = F_40 ( V_32 , 0 , & V_23 ) ;
if ( V_3 )
goto V_10;
if ( V_32 -> V_168 )
V_32 -> V_167 = V_32 -> V_168 ;
...
{
int V_85 , V_155 , V_169 ;
T_1 V_23 ;
struct V_12 * V_5 ;
F_6 ( ! V_32 ) ;
F_39 ( ! V_32 -> V_142 ) ;
V_85 = F_40 ( V_32 , 0 , & V_23 ) ;
if ( V_85 )
return V_85 ;
F_80 ( V_32 , & V_170 ) ;
if ( V_32 -> V_168 )
...
V_169 = ( V_23 & 0x70000000 ) >> 28 ;
V_5 -> V_156 = 0 ;
for ( V_155 = 0 ; V_155 < V_169 ; V_155 ++ , V_5 -> V_156 ++ ) {
V_85 = F_5 ( V_32 -> V_5 , V_155 + 1 ) ;
if ( V_85 )
goto remove;
if ( V_32 -> V_54 & V_157 )
F_82 ( & V_5 -> V_1 [ V_155 ] -> V_153 ) ;
}
F_63 ( V_32 ) ;
V_85 = F_83 ( V_32 -> V_5 ) ;
if ( V_85 )
goto V_172;
for ( V_155 = 0 ; V_155 < V_169 ; V_155 ++ ) {
V_85 = F_84 ( V_32 -> V_5 -> V_1 [ V_155 ] ) ;
if ( V_85 )
goto V_172;
}
F_61 ( V_32 ) ;
