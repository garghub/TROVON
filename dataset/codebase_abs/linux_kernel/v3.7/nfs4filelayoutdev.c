...
struct V_56 *
F_62 ( struct V_94 * V_94 , struct V_127 * V_116 , T_1 V_66 )
{
...
if ( V_97 == NULL )
return NULL ;
V_106 = F_32 ( V_129 * sizeof( struct V_104 * ) , V_66 ) ;
if ( V_106 == NULL ) {
F_26 ( V_97 ) ;
return NULL ;
}
...
T_5
F_67 ( struct V_139 * V_140 , T_7 V_141 )
{
struct V_142 * V_143 = F_68 ( V_140 ) ;
T_8 V_82 ;
V_82 = V_141 - V_143 -> V_144 ;
F_69 ( V_82 , V_143 -> V_145 ) ;
V_82 += V_143 -> V_146 ;
return F_69 ( V_82 , V_143 -> V_57 -> V_114 ) ;
}
T_5
F_70 ( struct V_139 * V_140 , T_5 V_117 )
{
return F_68 ( V_140 ) -> V_57 -> V_65 [ V_117 ] ;
}
struct V_147 *
F_71 ( struct V_139 * V_140 , T_5 V_117 )
{
struct V_142 * V_143 = F_68 ( V_140 ) ;
T_5 V_58 ;
...
V_58 = F_70 ( V_140 , V_117 ) ;
} else
V_58 = V_117 ;
return V_143 -> V_151 [ V_58 ] ;
}
struct V_1 *
F_72 ( struct V_139 * V_140 , T_5 V_152 )
{
struct V_56 * V_57 = F_68 ( V_140 ) -> V_57 ;
struct V_1 * V_2 = V_57 -> V_62 [ V_152 ] ;
struct V_123 * V_153 = F_73 ( V_140 ) ;
if ( F_74 ( V_153 ) )
return NULL ;
if ( V_2 == NULL ) {
F_2 ( V_154 L_43 ,
...
if ( ! V_2 -> V_6 ) {
struct V_38 * V_155 = F_56 ( V_140 -> V_156 -> V_157 ) ;
int V_158 ;
