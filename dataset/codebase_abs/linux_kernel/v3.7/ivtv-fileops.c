...
V_102 = F_41 ( V_2 ) ;
if ( ! V_102 )
V_102 = F_39 ( V_6 , V_61 , V_104 , V_105 , V_114 -> V_117 & V_118 ) ;
F_28 ( & V_4 -> V_77 ) ;
return V_102 ;
}
int F_48 ( struct V_1 * V_2 , int V_119 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
int V_102 ;
...
if ( V_6 -> type == V_17 )
return F_50 ( V_4 , V_119 ) ;
return 0 ;
}
static T_5 F_51 ( struct V_113 * V_114 , const char T_3 * V_121 , T_2 V_104 , T_6 * V_105 )
{
struct V_1 * V_2 = F_46 ( V_114 -> V_115 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
struct V_122 * V_123 = & V_4 -> V_124 ;
struct V_58 * V_61 ;
struct V_125 V_92 ;
int V_126 = 0 ;
int V_127 ;
...
return - V_15 ;
if ( V_6 -> type == V_108 ) {
int V_128 = V_104 / sizeof( struct V_129 ) ;
F_6 ( V_65 , & V_6 -> V_11 ) ;
return F_52 ( V_4 ,
( const struct V_129 T_3 * ) V_121 , V_128 ) ;
}
V_127 = V_6 -> type == V_17 ? V_130 : V_131 ;
if ( F_53 ( V_4 , V_127 ) != V_127 ) {
F_7 ( V_6 ) ;
return - V_15 ;
}
F_54 ( & V_92 ) ;
F_6 ( V_65 , & V_6 -> V_11 ) ;
V_102 = F_48 ( V_2 , V_4 -> V_119 ) ;
if ( V_102 ) {
F_10 ( L_18 , V_6 -> V_22 ) ;
F_13 ( V_75 , & V_6 -> V_11 ) ;
F_13 ( V_65 , & V_6 -> V_11 ) ;
...
V_132:
if ( V_127 == V_131 && V_6 -> V_66 . V_55 == 0 && V_4 -> V_133 ) {
while ( V_104 >= V_4 -> V_133 ) {
V_102 = F_55 ( V_4 , ( void T_3 * ) V_121 ) ;
if ( V_102 < 0 )
return V_102 ;
V_126 += V_4 -> V_133 ;
V_121 += V_4 -> V_133 ;
...
if ( V_104 == 0 ) {
F_40 ( L_19 , V_126 , V_6 -> V_22 , V_6 -> V_66 . V_71 ) ;
return V_126 ;
}
}
for (; ; ) {
...
if ( V_6 -> type == V_107 &&
V_123 -> V_134 + V_104 > V_4 -> V_133 )
V_102 = F_56 ( V_6 , V_61 , V_121 ,
V_4 -> V_133 - V_123 -> V_134 ) ;
else
V_102 = F_56 ( V_6 , V_61 , V_121 , V_104 ) ;
if ( V_102 < 0 ) {
F_57 ( V_6 , & V_92 , NULL , & V_6 -> V_68 , 0 ) ;
return V_102 ;
}
V_121 += V_102 ;
V_104 -= V_102 ;
...
if ( V_6 -> type == V_107 ) {
V_123 -> V_134 += V_102 ;
if ( V_123 -> V_134 == V_4 -> V_133 ) {
F_26 ( V_6 , V_61 , & V_6 -> V_66 ) ;
V_123 -> V_134 = 0 ;
break;
}
}
if ( V_61 -> V_71 != V_6 -> V_135 ) {
...
if ( F_8 ( V_136 , & V_6 -> V_11 ) ) {
if ( V_6 -> V_66 . V_55 >= V_4 -> V_133 ) {
int V_137 ;
if ( V_127 == V_131 )
F_58 ( V_4 ) ;
F_28 ( & V_4 -> V_77 ) ;
F_29 ( & V_4 -> V_138 , & V_62 , V_79 ) ;
while ( ! ( V_137 = F_33 ( V_81 ) ) &&
F_8 ( V_139 , & V_6 -> V_11 ) ) {
F_30 () ;
}
F_31 ( & V_4 -> V_138 , & V_62 ) ;
...
F_13 ( V_136 , & V_6 -> V_11 ) ;
F_57 ( V_6 , & V_6 -> V_66 , NULL , & V_6 -> V_140 , V_4 -> V_133 ) ;
F_59 ( V_6 , V_4 -> V_141 + V_142 , 1 ) ;
}
}
if ( V_104 && ! ( V_114 -> V_117 & V_118 ) )
goto V_132;
F_40 ( L_19 , V_126 , V_6 -> V_22 , V_6 -> V_66 . V_71 ) ;
return V_126 ;
}
T_5 F_60 ( struct V_113 * V_114 , const char T_3 * V_121 , T_2 V_104 , T_6 * V_105 )
{
struct V_1 * V_2 = F_46 ( V_114 -> V_115 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
T_5 V_143 ;
if ( F_47 ( & V_4 -> V_77 ) )
return - V_116 ;
V_143 = F_51 ( V_114 , V_121 , V_104 , V_105 ) ;
F_28 ( & V_4 -> V_77 ) ;
return V_143 ;
}
unsigned int F_61 ( struct V_113 * V_114 , T_7 * V_62 )
{
struct V_1 * V_2 = F_46 ( V_114 -> V_115 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
int V_143 = 0 ;
F_40 ( L_21 ) ;
if ( ! F_62 ( & V_2 -> V_12 . V_144 ) ) {
F_63 ( V_114 , & V_2 -> V_12 . V_62 , V_62 ) ;
F_13 ( V_145 , & V_4 -> V_111 ) ;
if ( F_64 ( & V_2 -> V_12 ) )
V_143 = V_146 ;
} else {
F_63 ( V_114 , & V_6 -> V_78 , V_62 ) ;
F_6 ( V_145 , & V_4 -> V_111 ) ;
if ( F_8 ( V_147 , & V_4 -> V_111 ) ||
F_8 ( V_148 , & V_4 -> V_111 ) )
V_143 = V_146 ;
}
if ( V_6 -> V_68 . V_80 )
...
unsigned int F_65 ( struct V_113 * V_114 , T_7 * V_62 )
{
unsigned long V_151 = F_66 ( V_62 ) ;
struct V_1 * V_2 = F_46 ( V_114 -> V_115 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
int V_152 = F_8 ( V_103 , & V_6 -> V_11 ) ;
unsigned V_143 = 0 ;
if ( ! V_152 && ! F_8 ( V_75 , & V_6 -> V_11 ) &&
V_6 -> type != V_106 &&
( V_151 & ( V_153 | V_154 ) ) ) {
int V_102 ;
F_32 ( & V_4 -> V_77 ) ;
...
return V_143 | V_153 | V_154 ;
if ( V_152 )
return V_143 | V_156 ;
return V_143 ;
}
void F_68 ( struct V_1 * V_2 , int V_157 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
F_67 ( L_25 , V_6 -> V_22 ) ;
...
static void F_69 ( struct V_1 * V_2 , int V_57 , V_52 V_56 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
F_67 ( L_25 , V_6 -> V_22 ) ;
...
F_13 ( V_65 , & V_6 -> V_11 ) ;
F_13 ( V_103 , & V_6 -> V_11 ) ;
if ( V_4 -> V_159 == V_161 && V_2 -> V_162 )
V_4 -> V_159 = V_160 ;
V_4 -> V_119 = 0 ;
F_13 ( V_163 , & V_4 -> V_111 ) ;
F_7 ( V_6 ) ;
}
int F_72 ( struct V_113 * V_114 )
{
struct V_164 * V_12 = V_114 -> V_115 ;
...
F_73 ( V_114 ) ) {
F_74 ( V_4 ) ;
F_13 ( V_165 , & V_4 -> V_111 ) ;
F_16 ( V_4 , V_166 , V_167 , V_4 -> V_168 ) ;
F_75 ( V_4 ) ;
if ( V_4 -> V_169 & V_170 ) {
F_76 ( V_4 , V_170 , V_171 , V_172 ,
V_173 , 0 ) ;
}
if ( F_38 ( & V_4 -> V_100 ) > 0 ) {
F_43 ( V_4 , V_174 , 1 ,
F_15 ( V_4 -> V_27 . V_175 ) |
( F_15 ( V_4 -> V_27 . V_176 ) << 8 ) ) ;
}
F_77 ( V_4 ) ;
}
F_78 ( V_12 ) ;
...
goto V_177;
if ( V_6 -> type >= V_17 ) {
struct V_5 * V_178 = & V_4 -> V_7 [ V_108 ] ;
F_69 ( V_2 , V_179 | V_180 , 0 ) ;
if ( V_4 -> V_159 == V_160 && ! F_8 ( V_65 , & V_178 -> V_11 ) ) {
F_80 ( V_4 ) ;
}
} else {
F_68 ( V_2 , 0 ) ;
...
int F_82 ( struct V_113 * V_114 )
{
struct V_181 * V_182 = F_83 ( V_114 ) ;
int V_143 ;
if ( F_47 ( V_182 -> V_183 ) )
return - V_116 ;
V_143 = F_84 ( V_114 ) ;
