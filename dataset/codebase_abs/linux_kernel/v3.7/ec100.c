...
static int F_8 ( struct V_19 * V_20 , T_2 * V_38 )
{
struct V_1 * V_2 = V_20 -> V_24 ;
int V_5 ;
T_1 V_25 ;
...
static int F_9 ( struct V_19 * V_20 , T_3 * V_44 )
{
struct V_1 * V_2 = V_20 -> V_24 ;
int V_5 ;
T_1 V_25 , V_26 ;
...
static int F_10 ( struct V_19 * V_20 , T_4 * V_46 )
{
struct V_1 * V_2 = V_20 -> V_24 ;
int V_5 ;
T_1 V_25 ;
...
static int F_11 ( struct V_19 * V_20 , T_4 * V_47 )
{
* V_47 = 0 ;
return 0 ;
}
static int F_12 ( struct V_19 * V_20 , T_3 * V_48 )
{
* V_48 = 0 ;
return 0 ;
}
...
struct V_19 * F_15 ( const struct V_49 * V_10 ,
struct V_50 * V_14 )
{
int V_5 ;
struct V_1 * V_2 = NULL ;
T_1 V_25 ;
V_2 = F_16 ( sizeof( struct V_1 ) , V_51 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_14 = V_14 ;
memcpy ( & V_2 -> V_10 , V_10 , sizeof( struct V_49 ) ) ;
V_5 = F_4 ( V_2 , 0x33 , & V_25 ) ;
if ( V_5 || V_25 != 0x0b )
goto error;
memcpy ( & V_2 -> V_52 . V_30 , & V_53 ,
sizeof( struct V_54 ) ) ;
V_2 -> V_52 . V_24 = V_2 ;
return & V_2 -> V_52 ;
error:
