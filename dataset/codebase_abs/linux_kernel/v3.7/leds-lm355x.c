...
static T_3 F_17 ( struct V_60 * V_15 ,
struct V_61 * V_62 ,
const char * V_63 , T_4 V_64 )
{
T_3 V_3 ;
...
static int T_1 F_21 ( struct V_71 * V_72 ,
...
static int T_5 F_33 ( struct V_71 * V_72 )
{
struct V_1 * V_2 = F_34 ( V_72 ) ;
struct V_20 * V_21 = V_2 -> V_22 ;
F_20 ( V_2 -> V_10 , V_21 [ V_44 ] . V_24 , 0 ) ;
if ( V_2 -> type == V_13 )
F_35 ( V_2 -> V_59 . V_15 , & V_93 ) ;
F_32 ( & V_2 -> V_59 ) ;
F_36 ( & V_2 -> V_57 ) ;
F_32 ( & V_2 -> V_53 ) ;
F_36 ( & V_2 -> V_47 ) ;
