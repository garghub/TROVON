...
F_36 ( V_2 , L_13 ) ;
F_45 ( V_2 ) ;
V_44 = F_46 ( V_76 -> V_28 , V_2 ) ;
V_10:
F_12 ( & V_76 -> V_28 -> V_29 ) ;
F_47 ( V_76 ) ;
return V_44 ;
}
static int F_48 ( struct V_57 * V_58 , void * V_7 , int V_77 )
{
...
static struct V_3 * F_53 ( struct V_83 * V_84 , int V_70 ,
const char * V_85 , void * V_7 )
{
struct V_3 * V_44 ;
V_44 = F_54 ( V_84 , V_70 , V_7 , F_48 ) ;
if ( ! F_10 ( V_44 ) )
V_86 = V_44 -> V_87 ;
return V_44 ;
}
static void F_55 ( struct V_57 * V_88 )
{
F_56 ( V_88 ) ;
V_86 = NULL ;
}
