...
struct V_3 * V_3 = F_2 ( V_2 ) ;
struct V_45 * V_46 ;
F_12 ( L_2 , V_2 -> V_22 ? V_2 -> V_22 -> V_40 . V_47 : - 1 , V_22 -> V_40 . V_47 ) ;
if ( V_3 -> V_33 ) {
F_27 ( V_10 -> V_10 , L_3 ) ;
return - V_48 ;
}
...
V_46 = F_24 ( V_22 , 0 ) ;
F_28 ( V_46 ) ;
F_29 ( V_46 , V_49 , F_22 , V_2 ) ;
return 0 ;
}
static int F_30 ( struct V_1 * V_2 ,
struct V_50 * V_51 , T_2 V_52 )
{
struct V_3 * V_3 = F_2 ( V_2 ) ;
struct V_8 * V_9 = V_2 -> V_10 -> V_11 ;
if ( V_51 == V_9 -> V_53 ) {
V_2 -> V_54 =
! ! ( V_52 & ( ( 1LL << V_55 ) | ( 1LL << V_56 ) ) ) ;
}
return F_31 ( V_3 -> V_4 , V_51 , V_52 ) ;
}
struct V_1 * F_32 ( struct V_31 * V_10 ,
struct V_57 * V_58 , int V_47 )
{
struct V_1 * V_2 = NULL ;
struct V_3 * V_3 = F_33 ( sizeof( * V_3 ) , V_59 ) ;
F_12 ( L_1 , V_58 -> V_25 ) ;
if ( ! V_3 ) {
F_27 ( V_10 -> V_10 , L_4 ) ;
goto V_60;
...
V_2 = & V_3 -> V_40 ;
V_3 -> V_4 = F_34 ( V_10 , V_58 , ( 1 << V_47 ) , true ) ;
V_3 -> V_4 -> V_2 = V_2 ;
V_3 -> V_25 = V_58 -> V_25 ;
V_3 -> V_47 = V_47 ;
F_35 ( V_10 , V_2 , & V_61 ) ;
F_36 ( V_2 , & V_62 ) ;
F_37 ( V_3 -> V_4 , & V_2 -> V_40 ) ;
return V_2 ;
V_60:
if ( V_2 ) {
F_1 ( V_2 ) ;
