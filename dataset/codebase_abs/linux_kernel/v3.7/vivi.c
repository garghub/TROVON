...
snprintf ( V_136 -> V_139 , sizeof( V_136 -> V_139 ) ,
L_23 , V_11 -> V_115 . V_116 ) ;
V_136 -> V_140 = V_141 | V_142 |
V_143 ;
V_136 -> V_144 = V_136 -> V_140 | V_145 ;
return 0 ;
}
static int F_59 ( struct V_133 * V_133 , void * V_134 ,
struct V_146 * V_3 )
{
struct V_1 * V_4 ;
...
return - V_126 ;
V_4 = & V_6 [ V_3 -> V_104 ] ;
F_60 ( V_3 -> V_147 , V_4 -> V_116 , sizeof( V_3 -> V_147 ) ) ;
V_3 -> V_9 = V_4 -> V_7 ;
return 0 ;
}
...
static int F_66 ( struct V_133 * V_133 , void * V_157 ,
struct V_158 * V_159 )
{
static const struct V_160 V_122 = {
48 , V_129 , 4 ,
32 , V_130 , 1
} ;
int V_54 ;
if ( V_159 -> V_104 )
return - V_126 ;
for ( V_54 = 0 ; V_54 < F_2 ( V_6 ) ; V_54 ++ )
if ( V_6 [ V_54 ] . V_7 == V_159 -> V_161 )
break;
if ( V_54 == F_2 ( V_6 ) )
return - V_126 ;
V_159 -> type = V_162 ;
...
static int F_67 ( struct V_133 * V_133 , void * V_134 ,
struct V_164 * V_165 )
{
if ( V_165 -> V_104 >= V_166 )
return - V_126 ;
V_165 -> type = V_167 ;
sprintf ( V_165 -> V_116 , L_26 , V_165 -> V_104 ) ;
return 0 ;
}
...
static int F_69 ( struct V_133 * V_133 , void * V_134 , unsigned int V_54 )
{
struct V_10 * V_11 = F_58 ( V_133 ) ;
if ( V_54 >= V_166 )
return - V_126 ;
...
static int F_70 ( struct V_168 * V_169 )
{
struct V_10 * V_11 = F_47 ( V_169 -> V_170 , struct V_10 , V_70 ) ;
if ( V_169 == V_11 -> V_78 )
...
V_102 = V_175 . V_101 ;
F_23 ( V_102 ) ;
V_11 = F_22 ( V_102 , struct V_10 , V_175 ) ;
F_73 ( & V_11 -> V_115 , L_27 ,
F_74 ( & V_11 -> V_176 ) ) ;
F_75 ( & V_11 -> V_176 ) ;
F_76 ( & V_11 -> V_115 ) ;
F_77 ( & V_11 -> V_70 ) ;
...
struct V_118 * V_153 ;
int V_155 ;
V_11 = F_80 ( sizeof( * V_11 ) , V_182 ) ;
if ( ! V_11 )
return - V_183 ;
snprintf ( V_11 -> V_115 . V_116 , sizeof( V_11 -> V_115 . V_116 ) ,
L_28 , V_184 , V_177 ) ;
V_155 = F_81 ( NULL , & V_11 -> V_115 ) ;
if ( V_155 )
goto V_185;
V_11 -> V_4 = & V_6 [ 0 ] ;
V_11 -> V_43 = 640 ;
...
V_181 = & V_11 -> V_70 ;
F_82 ( V_181 , 11 ) ;
V_11 -> V_79 = F_83 ( V_181 , & V_186 ,
V_187 , 0 , 255 , 1 , 200 ) ;
V_11 -> V_72 = F_83 ( V_181 , & V_186 ,
V_188 , 0 , 255 , 1 , 127 ) ;
V_11 -> V_75 = F_83 ( V_181 , & V_186 ,
V_189 , 0 , 255 , 1 , 16 ) ;
V_11 -> V_76 = F_83 ( V_181 , & V_186 ,
V_190 , 0 , 255 , 1 , 127 ) ;
V_11 -> V_77 = F_83 ( V_181 , & V_186 ,
V_191 , - 128 , 127 , 1 , 0 ) ;
V_11 -> V_78 = F_83 ( V_181 , & V_186 ,
V_192 , 0 , 1 , 1 , 1 ) ;
V_11 -> V_67 = F_83 ( V_181 , & V_186 ,
V_193 , 0 , 255 , 1 , 100 ) ;
V_11 -> V_37 = F_83 ( V_181 , & V_186 ,
V_172 , 0 , 255 , 1 , 0 ) ;
V_11 -> V_173 = F_84 ( V_181 , & V_194 , NULL ) ;
V_11 -> V_80 = F_84 ( V_181 , & V_195 , NULL ) ;
V_11 -> V_81 = F_84 ( V_181 , & V_196 , NULL ) ;
V_11 -> boolean = F_84 ( V_181 , & V_197 , NULL ) ;
V_11 -> V_84 = F_84 ( V_181 , & V_198 , NULL ) ;
V_11 -> string = F_84 ( V_181 , & V_199 , NULL ) ;
V_11 -> V_83 = F_84 ( V_181 , & V_200 , NULL ) ;
V_11 -> V_86 = F_84 ( V_181 , & V_201 , NULL ) ;
if ( V_181 -> error ) {
V_155 = V_181 -> error ;
goto V_202;
}
F_85 ( 2 , & V_11 -> V_78 , 0 , true ) ;
V_11 -> V_115 . V_70 = V_181 ;
F_86 ( & V_11 -> V_99 ) ;
V_153 = & V_11 -> V_154 ;
V_153 -> type = V_203 ;
V_153 -> V_204 = V_205 | V_206 | V_207 ;
V_153 -> V_208 = V_11 ;
V_153 -> V_209 = sizeof( struct V_57 ) ;
V_153 -> V_210 = & V_211 ;
V_153 -> V_212 = & V_213 ;
V_155 = F_87 ( V_153 ) ;
if ( V_155 )
goto V_202;
F_88 ( & V_11 -> V_132 ) ;
F_89 ( & V_11 -> V_97 . V_100 ) ;
F_90 ( & V_11 -> V_97 . V_109 ) ;
V_179 = & V_11 -> V_176 ;
* V_179 = V_214 ;
V_179 -> V_215 = V_215 ;
V_179 -> V_115 = & V_11 -> V_115 ;
V_179 -> V_216 = V_153 ;
F_91 ( V_217 , & V_179 -> V_98 ) ;
V_179 -> V_71 = & V_11 -> V_132 ;
F_92 ( V_179 , V_11 ) ;
V_155 = F_93 ( V_179 , V_218 , V_219 ) ;
if ( V_155 < 0 )
goto V_202;
F_52 ( & V_11 -> V_175 , & V_175 ) ;
F_73 ( & V_11 -> V_115 , L_29 ,
F_74 ( V_179 ) ) ;
return 0 ;
V_202:
F_77 ( V_181 ) ;
...
{
const struct V_220 * V_221 = F_95 ( L_30 ) ;
int V_155 = 0 , V_54 ;
if ( V_221 == NULL ) {
F_96 ( V_222 L_31 ) ;
return - V_223 ;
