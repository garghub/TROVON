...
static T_2 F_25 ( struct V_24 * V_21 , struct V_25 * V_26 ,
const char * V_27 , T_3 V_28 )
{
struct V_29 * V_30 = F_10 ( V_21 ) ;
return F_23 ( F_11 ( V_30 ) , V_27 , V_28 ) ;
}
...
if ( V_17 )
goto V_94;
V_15 -> V_21 = F_33 ( V_96 , & V_79 -> V_21 , F_34 ( 0 , 0 ) ,
NULL , L_15 , ++ V_97 ) ;
if ( F_35 ( V_15 -> V_21 ) ) {
V_17 = F_36 ( V_15 -> V_21 ) ;
goto V_94;
...
F_37 ( V_15 -> V_21 , V_15 ) ;
V_17 = F_31 ( V_15 -> V_21 , & V_98 ) ;
if ( V_17 )
goto V_99;
V_17 = F_31 ( V_15 -> V_21 , & V_100 ) ;
if ( V_17 )
goto V_101;
F_38 ( & V_79 -> V_21 ,
L_16 ,
...
return 0 ;
V_101:
F_39 ( V_15 -> V_21 , & V_100 ) ;
V_99:
F_39 ( V_15 -> V_21 , & V_98 ) ;
F_40 ( V_15 -> V_21 ) ;
V_94:
F_39 ( & V_79 -> V_21 , & F_32 ( V_23 ) ) ;
F_39 ( & V_79 -> V_21 , & F_32 ( V_95 ) ) ;
F_30 ( V_79 , NULL ) ;
F_41 ( V_15 -> V_20 ) ;
F_8 ( V_15 ) ;
return V_17 ;
