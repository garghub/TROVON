...
{
struct V_55 * V_56 = & V_41 -> V_57 ;
struct V_1 * V_2 = V_41 -> V_42 ;
F_3 ( L_2 , V_15 ) ;
if ( V_56 -> V_58 != 8000000 )
return - V_59 ;
if ( V_41 -> V_60 . V_61 . V_62 ) {
V_41 -> V_60 . V_61 . V_62 ( V_41 ) ;
if ( V_41 -> V_60 . V_63 )
V_41 -> V_60 . V_63 ( V_41 , 0 ) ;
}
F_9 ( V_2 ) ;
return 0 ;
}
...
struct V_55 * V_56 = & V_41 -> V_57 ;
struct V_1 * V_2 = V_41 -> V_42 ;
T_1 V_64 = F_4 ( V_2 , V_65 ) ;
V_56 -> V_66 = ( V_64 & V_67 ) ? V_68 : V_69 ;
V_56 -> V_70 = V_71 ;
V_56 -> V_72 = V_73 ;
V_56 -> V_74 = V_75 ;
V_56 -> V_76 = V_77 ;
...
struct V_40 *
F_21 ( const struct V_87 * V_10 , struct V_88 * V_14 )
{
struct V_1 * V_2 = NULL ;
F_3 ( L_2 , V_15 ) ;
V_2 = F_22 ( sizeof( struct V_1 ) , V_89 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_14 = V_14 ;
