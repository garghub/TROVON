...
static int T_4 F_22 ( struct V_49 * V_50 )
{
...
V_2 -> V_7 = V_65 ;
snprintf ( V_2 -> V_14 -> V_66 , V_67 , L_11 , V_50 -> V_68 ) ;
} else {
V_2 -> V_7 = V_7 ? ( * V_7 ) : V_65 ;
snprintf ( V_2 -> V_14 -> V_66 , V_67 , L_12 ,
V_50 -> V_68 , V_50 -> V_66 ) ;
}
...
static int T_5 F_43 ( struct V_49 * V_50 )
{
struct V_56 * V_20 = & V_50 -> V_20 ;
