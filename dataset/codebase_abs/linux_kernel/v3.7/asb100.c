...
V_28 = F_56 ( & V_27 -> V_14 . V_65 , & V_66 ) ;
if ( V_28 )
goto V_67;
V_21 -> V_68 = F_57 ( & V_27 -> V_14 ) ;
if ( F_58 ( V_21 -> V_68 ) ) {
V_28 = F_59 ( V_21 -> V_68 ) ;
goto V_69;
}
...
F_49 ( V_27 , V_58 , V_72 ) ;
if ( V_72 == 0 || V_72 > 2 ) {
V_71 = F_48 ( V_27 , V_5 & 0xff ) ;
} else {
V_70 = V_21 -> V_50 [ V_72 - 1 ] ;
switch ( V_5 & 0xff ) {
case 0x50 :
V_71 = F_63 ( V_70 , 0 ) ;
break;
...
static void F_22 ( struct V_26 * V_27 , T_4 V_5 , T_4 V_73 )
{
struct V_20 * V_21 = F_19 ( V_27 ) ;
struct V_26 * V_70 ;
int V_72 ;
...
F_49 ( V_27 , V_58 , V_72 ) ;
if ( V_72 == 0 || V_72 > 2 ) {
F_49 ( V_27 , V_5 & 0xff , V_73 & 0xff ) ;
} else {
V_70 = V_21 -> V_50 [ V_72 - 1 ] ;
switch ( V_5 & 0xff ) {
case 0x52 :
F_49 ( V_70 , 1 , V_73 & 0xff ) ;
break;
case 0x53 :
F_64 ( V_70 , 2 , V_73 ) ;
break;
...
int V_39 ;
F_21 ( & V_21 -> V_29 ) ;
if ( F_66 ( V_75 , V_21 -> V_76 + V_77 + V_77 / 2 )
|| ! V_21 -> V_78 ) {
F_67 ( & V_27 -> V_14 , L_12 ) ;
for ( V_39 = 0 ; V_39 < 7 ; V_39 ++ ) {
V_21 -> V_79 [ V_39 ] = F_26 ( V_27 ,
F_68 ( V_39 ) ) ;
V_21 -> V_80 [ V_39 ] = F_26 ( V_27 ,
F_69 ( V_39 ) ) ;
...
F_72 ( V_39 ) ) ;
V_21 -> V_82 [ V_39 - 1 ] = F_26 ( V_27 ,
F_73 ( V_39 ) ) ;
V_21 -> V_83 [ V_39 - 1 ] = F_26 ( V_27 ,
F_74 ( V_39 ) ) ;
}
V_39 = F_26 ( V_27 , V_31 ) ;
V_21 -> V_34 = V_39 & 0x0f ;
