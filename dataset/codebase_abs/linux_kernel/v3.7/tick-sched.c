...
static enum V_74 F_88 ( struct V_75 * V_76 )
{
struct V_1 * V_16 =
F_89 ( V_76 , struct V_1 , V_49 ) ;
struct V_67 * V_68 = F_77 () ;
T_1 V_4 = F_26 () ;
int V_2 = F_16 () ;
#ifdef F_90
