...
struct V_78 * F_52 ( struct V_21 * V_15 )
{
struct V_78 * V_79 ;
F_8 ( & V_15 -> V_88 ) ;
if ( F_30 ( & V_15 -> V_89 ) ) {
...
void F_66 ( struct V_37 * V_38 )
{
F_8 ( & V_38 -> V_101 ) ;
V_38 -> V_102 ++ ;
F_6 ( & V_38 -> V_101 ) ;
}
int F_67 ( struct V_21 * V_15 )
{
...
struct V_21 * F_68 ( struct V_37 * V_38 , T_6 V_68 )
{
struct V_21 * V_15 ;
F_8 ( & V_38 -> V_118 ) ;
...
struct V_21 * F_70 ( struct V_37 * V_38 , T_6 V_68 )
{
struct V_21 * V_15 ;
F_8 ( & V_38 -> V_118 ) ;
F_10 (conn, &sess->sess_conn_list, conn_list) {
...
static int F_73 ( struct V_21 * V_15 , int V_127 )
{
T_5 V_77 ;
struct V_1 * V_2 ;
V_2 = F_17 ( V_15 , V_10 ) ;
...
static void F_75 ( unsigned long V_134 )
{
...
F_79 ( & V_15 -> V_155 ,
( F_80 () + V_154 -> V_156 * V_157 ) ) ;
F_6 ( & V_15 -> V_135 ) ;
}
void F_74 ( struct V_21 * V_15 )
{
struct V_37 * V_38 = V_15 -> V_38 ;
struct V_153 * V_154 = F_78 ( V_38 ) ;
F_8 ( & V_15 -> V_135 ) ;
...
static void F_85 ( unsigned long V_134 )
{
struct V_21 * V_15 = (struct V_21 * ) V_134 ;
F_69 ( V_15 ) ;
F_8 ( & V_15 -> V_135 ) ;
...
return;
F_81 ( & V_15 -> V_162 ) ;
V_15 -> V_162 . V_158 = ( F_80 () + V_154 -> V_161 * V_157 ) ;
V_15 -> V_162 . V_134 = ( unsigned long ) V_15 ;
V_15 -> V_162 . V_159 = F_85 ;
V_15 -> V_160 &= ~ V_137 ;
V_15 -> V_160 |= V_139 ;
F_82 ( & V_15 -> V_162 ) ;
F_25 ( L_38
...
V_164 = F_90 ( V_15 , & V_168 [ 0 ] , V_166 , V_165 ) ;
if ( V_165 != V_164 ) {
if ( V_164 == - V_173 ) {
F_3 ( L_40 ) ;
goto V_169;
...
T_1 V_190 = F_92 ( T_1 , V_178 , V_189 ) ;
V_191:
V_164 = V_15 -> V_192 -> V_193 -> V_194 ( V_15 -> V_192 ,
F_93 ( V_175 ) , V_175 -> V_3 + V_3 , V_190 , 0 ) ;
if ( V_164 != V_190 ) {
if ( V_164 == - V_173 ) {
F_3 ( L_41
L_42 ) ;
...
V_164 = F_90 ( V_15 , V_196 , 1 , V_2 -> V_187 ) ;
if ( V_2 -> V_187 != V_164 ) {
if ( V_164 == - V_173 ) {
F_3 ( L_40 ) ;
goto V_195;
...
int F_95 ( struct V_21 * V_15 , T_5 V_199 , T_5 V_200 )
{
T_5 V_201 [ V_113 ] ;
int V_202 ;
struct V_167 V_168 ;
struct V_203 * V_55 ;
F_96 ( V_15 , V_199 , V_200 ) ;
...
V_186 = V_209 -> V_166 ;
while ( V_211 < V_134 ) {
V_210 = F_102 ( V_15 -> V_192 , & V_213 , V_196 , V_186 ,
( V_134 - V_211 ) , V_214 ) ;
if ( V_210 <= 0 ) {
F_25 ( L_47 ,
V_210 , V_211 ) ;
...
V_186 = V_209 -> V_166 ;
while ( V_215 < V_134 ) {
V_216 = F_104 ( V_15 -> V_192 , & V_213 , V_196 , V_186 ,
( V_134 - V_215 ) ) ;
if ( V_216 <= 0 ) {
F_25 ( L_50 ,
V_216 , V_215 ) ;
...
struct V_142 * F_106 ( struct V_21 * V_15 )
{
struct V_140 * V_141 ;
if ( ! V_15 || ! V_15 -> V_38 )
return NULL ;
