...
V_43 = V_10 -> V_9 -> V_76 ( V_19 , V_10 , V_41 , V_4 -> V_71 , V_25 , & V_42 ) ;
if ( V_43 == 0 ) {
if ( V_44 ) {
F_29 ( V_27 ) ;
V_10 -> V_7 = * V_36 ;
...
V_82 -> V_88 = 0 ;
V_82 -> V_89 = 0 ;
V_82 -> V_52 = F_36 ( V_10 -> V_35 ) -> V_90 ;
V_82 -> V_47 = V_10 -> V_69 ;
V_82 -> V_46 = F_11 ( V_10 -> V_17 , V_10 -> V_29 ) ;
if ( F_37 ( V_19 , V_62 , V_10 -> V_9 -> V_3 ) )
goto V_91;
V_82 -> V_71 = V_42 ;
if ( V_72 != V_81 ) {
V_82 -> V_71 = 0 ;
if ( V_10 -> V_9 -> V_92 && V_10 -> V_9 -> V_92 ( V_10 , V_42 , V_19 , V_82 ) < 0 )
goto V_91;
}
V_83 -> V_93 = F_34 ( V_19 ) - V_84 ;
return V_19 -> V_94 ;
V_85:
V_91:
F_38 ( V_19 , V_84 ) ;
...
struct V_28 * V_82 = F_14 ( V_103 -> V_83 ) ;
unsigned long V_41 = 0 ;
const struct V_39 * V_40 ;
struct V_101 V_22 ;
if ( V_103 -> V_83 -> V_93 < F_45 ( sizeof( * V_82 ) ) )
return V_19 -> V_94 ;
