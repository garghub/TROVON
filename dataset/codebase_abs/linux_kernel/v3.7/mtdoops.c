...
while ( ( V_20 = F_23 ( V_11 , V_2 -> V_29 * V_15 ) ) > 0 ) {
V_39:
F_17 ( V_27 L_3 ,
V_2 -> V_29 * V_15 ) ;
V_36 ++ ;
...
{
struct V_1 * V_2 = & V_61 ;
T_4 V_62 = F_35 ( V_11 -> V_63 , V_15 ) ;
int V_64 ;
if ( ! strcmp ( V_11 -> V_65 , V_28 ) )
V_2 -> V_66 = V_11 -> V_67 ;
if ( V_11 -> V_67 != V_2 -> V_66 || V_2 -> V_66 < 0 )
return;
if ( V_11 -> V_63 < V_11 -> V_13 * 2 ) {
F_17 ( V_40 L_11 ,
V_11 -> V_67 ) ;
return;
}
...
if ( V_11 -> V_63 > V_68 ) {
F_17 ( V_40 L_13 ,
V_11 -> V_67 , V_68 / 1024 / 1024 ) ;
return;
}
V_2 -> V_4 = F_36 ( F_37 ( V_62 ,
...
V_2 -> V_11 = V_11 ;
V_2 -> V_30 = ( int ) V_11 -> V_63 / V_15 ;
F_29 ( V_2 ) ;
F_17 ( V_71 L_16 , V_11 -> V_67 ) ;
}
