...
F_56 ( V_12 ) ;
V_12 -> V_52 = V_53 ;
V_2 -> V_30 -> V_154 ( V_2 , V_12 ) ;
V_153 = F_57 ( & V_152 , V_151 ) ;
V_2 -> V_113 = NULL ;
F_14 ( V_12 , V_54 ) ;
F_4 ( 3 ,
F_5 ( L_17 ,
...
F_53 ( V_12 , & V_125 ) ;
if ( V_12 -> V_22 -> V_155 != V_156 ) {
struct V_157 * V_158 = F_58 ( V_12 ) ;
if ( V_158 -> V_113 )
V_25 = V_158 -> V_113 ( V_12 , V_50 , V_126 , V_25 ) ;
}
return V_25 ;
}
static int F_59 ( struct V_11 * V_12 )
{
return F_54 ( V_12 , NULL , 0 , V_159 , ~ 0 ) ;
}
void F_60 ( struct V_11 * V_12 , struct V_40 * V_160 )
{
V_12 -> V_14 -> V_15 -> V_4 -- ;
V_12 -> V_18 = 0 ;
F_61 ( & V_12 -> V_19 , V_160 ) ;
}
...
{
static unsigned char V_166 [ 6 ] = { V_51 , 0 , 0 , 0 , 0 , 0 } ;
int V_167 = 1 , V_25 ;
V_168:
V_25 = F_54 ( V_12 , V_166 , 6 , V_159 , 0 ) ;
F_4 ( 3 , F_5 ( L_23 ,
V_39 , V_12 , V_25 ) ) ;
switch ( V_25 ) {
case V_55 :
...
static int F_69 ( struct V_40 * V_169 ,
struct V_40 * V_41 ,
struct V_40 * V_160 , int V_170 )
{
struct V_11 * V_12 , * V_161 ;
struct V_35 * V_36 ;
int V_171 ;
while ( ! F_67 ( V_169 ) ) {
V_12 = F_70 ( V_169 -> V_161 , struct V_11 , V_19 ) ;
V_36 = V_12 -> V_14 ;
V_171 = ! F_19 ( V_12 -> V_14 ) ||
( V_170 && ! F_71 ( V_12 ) &&
! F_68 ( V_12 ) ) ||
! F_68 ( V_12 ) ;
...
if ( V_25 == V_54 || V_25 == V_173 ) {
V_12 -> V_18 &= ~ V_33 ;
if ( V_25 == V_173 )
F_60 ( V_12 , V_160 ) ;
else
F_61 ( & V_12 -> V_19 , & V_172 ) ;
} else
F_4 ( 3 , F_5 ( L_26
L_27
L_25 ,
...
return F_69 ( & V_172 , V_41 , V_160 , 0 ) ;
}
static int F_71 ( struct V_11 * V_12 )
{
static unsigned char V_174 [ 6 ] = { V_175 , 0 , 0 , 0 , 1 , 0 } ;
if ( V_12 -> V_14 -> V_73 ) {
int V_176 , V_25 = V_55 ;
for ( V_176 = 0 ; V_25 == V_55 && V_176 < 2 ; V_176 ++ )
V_25 = F_54 ( V_12 , V_174 , 6 , V_12 -> V_14 -> V_177 -> V_178 , 0 ) ;
if ( V_25 == V_54 )
return 0 ;
}
return 1 ;
...
F_77 ( V_41 , & V_181 ) ;
while ( ! F_67 ( & V_181 ) ) {
struct V_11 * V_161 , * V_12 ;
int V_25 ;
unsigned int V_97 ;
V_12 = F_70 ( V_181 . V_161 , struct V_11 , V_19 ) ;
V_97 = F_78 ( V_12 ) ;
F_4 ( 3 , F_5 ( L_34
L_35 ,
V_162 -> V_163 , V_97 ) ) ;
...
struct V_40 * V_160 )
{
struct V_11 * V_12 , * V_182 , * V_161 ;
F_73 ( V_172 ) ;
unsigned int V_96 ;
int V_25 ;
for ( V_96 = 0 ; V_96 <= V_2 -> V_183 ; V_96 ++ ) {
V_182 = NULL ;
F_22 (scmd, work_q, eh_entry) {
if ( V_96 == F_39 ( V_12 ) ) {
V_182 = V_12 ;
...
return F_69 ( & V_172 , V_41 , V_160 , 1 ) ;
}
...
break;
case V_185 :
return ( V_12 -> V_22 -> V_186 & V_187 ) ;
case V_188 :
return ( V_12 -> V_22 -> V_186 & V_189 ) ;
case V_190 :
if ( F_33 ( V_12 -> V_31 ) == V_102 &&
F_34 ( V_12 -> V_31 ) == V_109 )
return 0 ;
case V_191 :
return ( V_12 -> V_22 -> V_186 & V_192 ) ;
}
switch ( F_34 ( V_12 -> V_31 ) ) {
case V_105 :
if ( V_12 -> V_22 -> V_186 & V_189 ||
V_12 -> V_22 -> V_155 == V_156 )
return 1 ;
}
return 0 ;
}
...
{
struct V_22 * V_23 ;
V_23 = F_89 ( V_36 -> V_177 , V_209 , V_210 ) ;
V_23 -> V_211 [ 0 ] = V_212 ;
V_23 -> V_211 [ 1 ] = 0 ;
V_23 -> V_211 [ 2 ] = 0 ;
V_23 -> V_211 [ 3 ] = 0 ;
...
struct V_40 * V_160 )
{
if ( ! F_74 ( V_2 , V_41 , V_160 ) )
if ( ! F_75 ( V_2 , V_41 , V_160 ) )
if ( ! F_76 ( V_2 , V_41 , V_160 ) )
if ( ! F_80 ( V_2 , V_41 , V_160 ) )
if ( ! F_81 ( V_41 , V_160 ) )
F_82 ( V_41 ,
V_160 ) ;
}
void F_96 ( struct V_40 * V_160 )
{
struct V_11 * V_12 , * V_161 ;
