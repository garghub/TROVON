...
struct V_71 * V_72 = V_4 -> V_58 -> V_4 . V_72 ;
...
static int F_96 ( struct V_1 * V_39 , struct V_71 * V_72 ,
T_4 V_61 )
{
struct V_2 * V_4 = & V_39 -> V_4 ;
...
F_66 ( & V_4 -> V_105 , V_104 ) ;
V_61 = F_96 ( V_39 , V_72 , V_39 -> V_158 ) ;
F_55 ( & V_39 -> V_102 , V_85 + V_39 -> V_101 ) ;
F_67 ( & V_4 -> V_105 , V_104 ) ;
if ( V_61 )
F_53 ( V_72 ) ;
...
F_66 ( & V_4 -> V_105 , V_104 ) ;
V_61 = F_96 ( V_39 , V_72 , V_177 -> V_182 ) ;
F_67 ( & V_4 -> V_105 , V_104 ) ;
if ( V_61 )
F_53 ( V_72 ) ;
F_107 ( V_39 ) ;
...
int V_73 ;
V_39 -> V_97 = V_162 ;
V_39 -> V_158 = 2 * F_135 ( 16 , ( int ) V_4 -> V_52 ) ;
...
static unsigned int F_143 ( unsigned int V_209 , unsigned int V_210 ,
unsigned long V_211 )
{
switch ( V_209 ) {
case V_212 :
...
static void F_146 ( struct V_2 * V_4 , struct V_219 * V_220 ,
struct V_219 * V_221 )
{
struct V_1 * V_39 = F_1 ( V_4 ) ;
struct V_7 * V_8 ;
unsigned int V_222 , V_223 , V_224 ;
int V_225 = - 1 ;
V_224 = V_4 -> V_30 ? V_4 -> V_30 / 16 : 115200 ;
V_222 = F_147 ( V_4 , V_220 , V_221 , 0 , V_224 ) ;
if ( F_148 ( V_222 && V_4 -> V_30 ) )
V_225 = F_143 ( V_39 -> V_14 -> V_226 , V_222 , V_4 -> V_30 ) ;
F_13 ( V_39 ) ;
F_145 ( V_4 ) ;
V_223 = F_21 ( V_4 , V_227 ) & 3 ;
if ( ( V_220 -> V_228 & V_229 ) == V_230 )
V_223 |= 0x40 ;
if ( V_220 -> V_228 & V_231 )
V_223 |= 0x20 ;
if ( V_220 -> V_228 & V_232 )
V_223 |= 0x30 ;
if ( V_220 -> V_228 & V_233 )
V_223 |= 0x08 ;
F_149 ( V_4 , V_220 -> V_228 , V_222 ) ;
F_23 ( V_4 , V_227 , V_223 ) ;
F_49 ( V_4 -> V_28 , L_34 , V_147 , V_223 , V_225 ,
V_39 -> V_14 -> V_106 ) ;
if ( V_225 > 0 ) {
if ( V_225 >= 256 ) {
F_23 ( V_4 , V_227 , ( F_21 ( V_4 , V_227 ) & ~ 3 ) | 1 ) ;
V_225 >>= 2 ;
} else
F_23 ( V_4 , V_227 , F_21 ( V_4 , V_227 ) & ~ 3 ) ;
F_23 ( V_4 , V_234 , V_225 ) ;
F_150 ( ( 1000000 + ( V_222 - 1 ) ) / V_222 ) ;
}
F_31 ( V_4 , V_220 -> V_228 ) ;
V_8 = F_4 ( V_4 , V_143 ) ;
if ( V_8 -> V_9 ) {
...
#ifdef F_63
if ( V_39 -> V_97 ) {
V_39 -> V_101 = ( V_4 -> V_236 - V_237 / 50 ) * V_39 -> V_158 * 3 /
V_4 -> V_52 / 2 ;
F_49 ( V_4 -> V_28 ,
L_35 ,
V_39 -> V_101 * 1000 / V_237 , V_4 -> V_236 ) ;
if ( V_39 -> V_101 < F_151 ( 20 ) )
V_39 -> V_101 = F_151 ( 20 ) ;
}
#endif
if ( ( V_220 -> V_228 & V_238 ) != 0 )
F_104 ( V_4 ) ;
F_17 ( V_39 ) ;
}
...
return 0 ;
if ( V_4 -> V_104 & V_239 ) {
V_4 -> V_10 = F_155 ( V_4 -> V_240 , V_9 ) ;
if ( F_76 ( ! V_4 -> V_10 ) ) {
F_79 ( V_4 -> V_28 , L_41 , V_4 -> line ) ;
return - V_241 ;
}
} else {
V_4 -> V_10 = ( void V_55 * ) V_4 -> V_240 ;
}
return 0 ;
}
...
struct V_242 * V_243 ;
int V_111 ;
V_243 = F_160 ( V_4 -> V_240 , V_9 , F_78 ( V_4 -> V_28 ) ) ;
if ( F_76 ( V_243 == NULL ) )
return - V_244 ;
V_111 = F_154 ( V_4 ) ;
if ( F_76 ( V_111 != 0 ) ) {
...
static void F_162 ( struct V_2 * V_4 , int V_104 )
{
if ( V_104 & V_245 ) {
...
{
struct V_1 * V_39 = F_1 ( V_4 ) ;
if ( V_248 -> V_95 != V_39 -> V_14 -> V_127 [ V_249 ] || V_248 -> V_95 > V_250 )
return - V_27 ;
if ( V_248 -> V_251 < 2400 )
return - V_27 ;
return 0 ;
...
if ( V_5 -> type == V_15 )
V_5 -> V_88 = 5 ;
else if ( V_5 -> V_226 == V_215 )
V_5 -> V_88 = 9 ;
else
V_5 -> V_88 = 0 ;
V_5 -> V_258 |= ( 1 << V_5 -> V_88 ) ;
}
V_4 -> V_240 = V_5 -> V_240 ;
V_4 -> type = V_5 -> type ;
V_4 -> V_104 = V_5 -> V_104 ;
V_4 -> V_11 = V_5 -> V_11 ;
V_4 -> V_95 = V_5 -> V_127 [ V_261 ] ;
V_4 -> V_132 = 0 ;
V_4 -> V_262 = F_3 ;
V_4 -> V_263 = F_8 ;
...
unsigned V_61 )
{
struct V_1 * V_1 = & V_267 [ V_266 -> V_134 ] ;
struct V_2 * V_4 = & V_1 -> V_4 ;
unsigned short V_268 ;
F_13 ( V_1 ) ;
F_176 ( V_4 , V_39 , V_61 , F_174 ) ;
...
int V_270 = 'n' ;
int V_111 ;
if ( V_266 -> V_134 < 0 || V_266 -> V_134 >= V_271 )
return - V_272 ;
V_1 = & V_267 [ V_266 -> V_134 ] ;
V_4 = & V_1 -> V_4 ;
if ( ! V_4 -> V_42 )
return - V_272 ;
V_111 = F_154 ( V_4 ) ;
...
F_13 ( V_1 ) ;
if ( V_269 )
F_179 ( V_269 , & V_222 , & V_82 , & V_268 , & V_270 ) ;
F_17 ( V_1 ) ;
return F_180 ( V_4 , V_266 , V_222 , V_82 , V_268 , V_270 ) ;
}
...
static int F_183 ( struct V_179 * V_28 )
{
struct V_1 * V_1 = F_184 ( V_28 ) ;
struct V_2 * V_4 = & V_1 -> V_4 ;
if ( F_185 ( V_4 ) ) {
struct V_7 * V_8 ;
V_1 -> V_280 = F_21 ( V_4 , V_227 ) ;
V_1 -> V_281 = F_21 ( V_4 , V_234 ) ;
V_8 = F_4 ( V_4 , V_143 ) ;
if ( V_8 -> V_9 )
V_1 -> V_282 = F_21 ( V_4 , V_143 ) ;
else
V_1 -> V_282 = 0 ;
}
return 0 ;
}
static int F_186 ( struct V_179 * V_28 )
{
struct V_1 * V_1 = F_184 ( V_28 ) ;
struct V_2 * V_4 = & V_1 -> V_4 ;
if ( F_185 ( V_4 ) ) {
F_145 ( V_4 ) ;
F_23 ( V_4 , V_227 , V_1 -> V_280 ) ;
F_23 ( V_4 , V_234 , V_1 -> V_281 ) ;
if ( V_1 -> V_282 )
F_23 ( V_4 , V_143 , V_1 -> V_282 ) ;
...
V_111 = F_164 ( V_28 , V_285 , V_134 , V_5 ) ;
if ( V_111 )
return V_111 ;
V_111 = F_192 ( & V_284 , & V_285 -> V_4 ) ;
if ( V_111 ) {
F_171 ( V_285 ) ;
return V_111 ;
}
...
return F_181 ( V_28 ) ;
F_195 ( V_28 , V_286 ) ;
V_111 = F_191 ( V_28 , V_28 -> V_277 , V_5 , V_286 ) ;
if ( V_111 )
return V_111 ;
V_286 -> V_117 . V_287 = F_73 ;
V_111 = F_196 ( & V_286 -> V_117 ,
V_283 ) ;
if ( F_76 ( V_111 < 0 ) ) {
F_171 ( V_286 ) ;
return V_111 ;
...
static int F_199 ( struct V_179 * V_28 )
{
