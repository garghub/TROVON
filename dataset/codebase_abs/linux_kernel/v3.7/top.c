...
if ( V_2 -> V_20 -> V_21 == 1 ) {
struct V_22 * V_23 = F_2 ( V_2 -> V_20 ) ;
V_12 += SNPRINTF ( V_3 + V_12 , V_4 - V_12 , L_6 V_24 L_7 ,
( V_25 ) V_23 -> V_26 . V_27 ,
V_2 -> V_28 ? L_8 : L_9 ) ;
}
V_12 += SNPRINTF ( V_3 + V_12 , V_4 - V_12 , L_10 , F_3 ( V_2 -> V_29 ) ) ;
V_12 += SNPRINTF ( V_3 + V_12 , V_4 - V_12 , L_11 ) ;
if ( V_2 -> V_30 . V_31 )
V_12 += SNPRINTF ( V_3 + V_12 , V_4 - V_12 , L_12 ,
V_2 -> V_30 . V_31 ) ;
else if ( V_2 -> V_30 . V_32 )
V_12 += SNPRINTF ( V_3 + V_12 , V_4 - V_12 , L_13 ,
V_2 -> V_30 . V_32 ) ;
else if ( V_2 -> V_30 . V_33 != NULL )
