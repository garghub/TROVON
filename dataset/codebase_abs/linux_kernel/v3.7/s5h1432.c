...
static int F_11 ( struct V_18 * V_19 , T_3 * V_42 )
{
return 0 ;
}
...
static int F_13 ( struct V_18 * V_19 , T_4 * V_44 )
{
return 0 ;
}
static int F_14 ( struct V_18 * V_19 , T_2 * V_45 )
{
return 0 ;
}
static int F_15 ( struct V_18 * V_19 , T_2 * V_46 )
{
return 0 ;
}
...
struct V_18 * F_19 ( const struct V_49 * V_50 ,
struct V_51 * V_12 )
{
struct V_1 * V_2 = NULL ;
F_3 ( V_31 L_6 ) ;
...
V_2 -> V_12 = V_12 ;
V_2 -> V_53 = V_54 ;
V_2 -> V_55 = V_2 -> V_50 -> V_55 ;
memcpy ( & V_2 -> V_56 . V_38 , & V_57 ,
sizeof( struct V_58 ) ) ;
V_2 -> V_56 . V_21 = V_2 ;
return & V_2 -> V_56 ;
}
