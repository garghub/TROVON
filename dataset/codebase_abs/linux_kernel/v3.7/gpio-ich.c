...
static void T_2 F_15 ( struct V_16 * V_23 )
{
V_23 -> V_29 = V_30 ;
V_23 -> V_31 = V_32 ;
...
static void F_20 ( struct V_44 * V_45 , T_3 V_18 )
{
int V_47 ;
for ( V_47 = 0 ; V_47 < F_17 ( V_13 [ 0 ] ) ; V_47 ++ ) {
if ( ! ( V_18 & ( 1 << V_47 ) ) )
...
if ( ! V_11 . V_25 -> V_77 )
goto V_78;
V_55 = F_22 ( V_54 , V_75 , V_79 ) ;
if ( ! V_55 ) {
F_23 ( L_1 ) ;
goto V_78;
}
if ( ! F_18 ( V_55 -> V_48 , F_24 ( V_55 ) ,
V_54 -> V_46 ) ) {
F_23 ( L_2 ) ;
goto V_78;
}
...
static int T_4 F_28 ( struct V_53 * V_54 )
{
int V_56 ;
V_56 = F_29 ( & V_11 . V_23 ) ;
if ( V_56 ) {
