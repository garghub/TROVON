...
static int T_5 F_50 ( struct V_40 * V_41 )
{
struct V_70 * V_71 ;
struct V_72 * V_9 ;
struct V_42 V_43 ;
...
static T_6 F_56 ( T_3 V_95 , T_3 V_96 )
{
T_3 V_97 ;
T_3 V_98 ;
int V_99 ;
...
static T_6 F_57 ( unsigned int V_104 ) {
int V_101 ;
T_6 V_105 = 0 ;
...
static int T_5 F_64 ( struct V_40 * V_41 )
{
struct V_6 * V_7 ;
...
F_33 ( & V_41 -> V_2 , F_64 ) ;
F_29 ( 3 , L_19 ) ;
F_16 (KERN_INFO EDAC_MOD_STR L_58 ) ;
return 0 ;
V_69:
F_68 ( & V_41 -> V_2 ) ;
V_60:
...
V_44 = F_76 ( & V_204 ) ;
if ( V_44 )
F_16 (KERN_WARNING EDAC_MOD_STR L_62 ) ;
#ifdef F_77
V_201 = F_73 ( V_205 ) ;
if ( ( F_78 ( V_201 ) == V_206 ) ||
( F_78 ( V_201 ) == V_207 ) ) {
