...
static int T_9 F_60 ( struct V_111 * V_112 )
{
struct V_125 * V_83 = V_112 -> V_98 -> V_83 ;
struct V_9 * V_10 ;
int V_12 = - V_126 ;
T_4 V_4 ;
T_10 V_127 ;
...
F_61 ( V_83 ) ;
V_10 = & V_122 ;
V_10 -> V_96 . V_22 = V_128 ;
V_10 -> V_96 . V_129 = V_130 ;
V_10 -> V_96 . V_131 = V_132 ;
V_10 -> V_96 . V_133 = F_48 ;
V_10 -> V_96 . V_134 = F_45 ;
V_10 -> V_96 . V_135 = F_52 ;
V_10 -> V_96 . V_136 = F_53 ;
V_10 -> V_96 . V_137 = F_54 ;
V_12 = F_62 ( V_112 , & V_10 -> V_96 ) ;
if ( V_12 )
return V_12 ;
V_10 -> V_138 = F_63 ( V_123 , NULL , V_124 ,
NULL , L_27 ) ;
if ( F_64 ( V_10 -> V_138 ) ) {
ERROR ( V_10 , L_28 ) ;
goto V_139;
}
F_65 ( & V_10 -> V_36 , & V_140 ) ;
V_10 -> V_36 . V_141 = V_142 ;
V_12 = F_66 ( & V_10 -> V_36 , V_124 , 1 ) ;
if ( V_12 ) {
ERROR ( V_10 , L_29 ) ;
goto V_139;
}
if ( V_143 )
F_67 ( & V_109 [ 2 ] , V_143 , ( sizeof V_109 ) - 2 ) ;
V_4 = strlen ( V_109 ) ;
V_109 [ 0 ] = ( V_4 >> 8 ) & 0xFF ;
V_109 [ 1 ] = V_4 & 0xFF ;
F_68 ( V_83 ) ;
...
V_10 -> V_51 = 0 ;
V_10 -> V_52 = NULL ;
for ( V_127 = 0 ; V_127 < V_152 ; V_127 ++ ) {
V_6 = F_1 ( V_10 -> V_61 , V_42 , V_153 ) ;
if ( ! V_6 ) {
while ( ! F_19 ( & V_10 -> V_25 ) ) {
...
V_10 -> V_83 = V_83 ;
F_43 ( V_10 , L_30 V_154 L_31 , V_155 ) ;
return 0 ;
V_139:
F_55 ( V_112 ) ;
return V_12 ;
...
static int T_9 F_74 ( struct V_97 * V_98 )
{
int V_32 ;
V_32 = F_75 ( V_98 , V_156 ) ;
if ( V_32 < 0 )
return V_32 ;
V_157 . V_158 = V_156 [ V_159 ] . V_113 ;
V_157 . V_160 = V_156 [ V_161 ] . V_113 ;
V_157 . V_162 = V_156 [ V_163 ] . V_113 ;
V_32 = F_76 ( V_98 , & V_148 , F_60 ) ;
if ( V_32 )
return V_32 ;
F_77 ( V_98 , & V_164 ) ;
return V_32 ;
