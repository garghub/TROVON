...
{
struct V_4 * V_96 = & V_2 -> V_5 ;
T_1 V_97 ;
int V_18 ;
F_21 ( V_2 , V_98 , V_96 -> V_21 ) ;
F_21 ( V_2 , V_99 , V_96 -> V_31 ) ;
if ( F_2 ( V_2 ) ) {
F_21 ( V_2 , V_100 , V_96 -> V_82 [ 0 ] ) ;
F_21 ( V_2 , V_101 , V_96 -> V_82 [ 1 ] ) ;
for ( V_18 = 0 ; V_18 < V_102 ; V_18 ++ )
F_21 ( V_2 , F_22 ( V_18 ) ,
V_96 -> V_81 [ V_18 ] ) ;
} else
F_21 ( V_2 , V_103 , V_96 -> V_93 ) ;
if ( F_23 ( V_2 ) ) {
V_97 = F_24 ( V_2 , 0x50040 ) ;
V_97 &= 0xFFFFFEFF ;
F_21 ( V_2 , 0x50040 , V_97 ) ;
}
F_11 ( V_2 , V_104 , V_105 , 1 ) ;
F_11 ( V_2 , V_106 , V_107 , 0 ) ;
F_16 ( V_2 , V_96 -> V_47 ,
V_108 ) ;
}
