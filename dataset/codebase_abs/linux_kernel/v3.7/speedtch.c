...
int V_23 ;
F_5 ( V_5 , L_12 , V_12 ) ;
if ( ! ( V_21 = ( unsigned char * ) F_8 ( V_24 ) ) ) {
V_8 = - V_25 ;
F_5 ( V_5 , L_13 , V_12 ) ;
goto V_26;
}
...
if ( V_29 ) {
V_8 = F_10 ( V_7 , F_11 ( V_7 , V_30 ) ,
V_21 , 0x200 , & V_22 , 2000 ) ;
if ( V_8 < 0 && V_8 != - V_31 )
F_4 ( V_5 , L_15 , V_12 , V_8 ) ;
else
F_5 ( V_5 , L_16 , V_12 , V_8 ) ;
}
for ( V_23 = 0 ; V_23 < V_19 -> V_32 ; V_23 += V_33 ) {
int V_34 = F_12 ( int , V_33 , V_19 -> V_32 - V_23 ) ;
memcpy ( V_21 , V_19 -> V_35 + V_23 , V_34 ) ;
V_8 = F_10 ( V_7 , F_13 ( V_7 , V_30 ) ,
V_21 , V_34 , & V_22 , V_36 ) ;
if ( V_8 < 0 ) {
F_14 ( V_5 , L_17 , V_12 , V_8 ) ;
goto V_28;
}
F_5 ( V_5 , L_18 , V_12 , V_19 -> V_32 ) ;
}
V_8 = F_10 ( V_7 , F_11 ( V_7 , V_30 ) ,
V_21 , 0x200 , & V_22 , V_36 ) ;
if ( V_8 < 0 ) {
F_14 ( V_5 , L_19 , V_12 , V_8 ) ;
goto V_28;
}
F_5 ( V_5 , L_20 , V_12 , V_22 ) ;
for ( V_23 = 0 ; V_23 < V_20 -> V_32 ; V_23 += V_33 ) {
int V_34 = F_12 ( int , V_33 , V_20 -> V_32 - V_23 ) ;
memcpy ( V_21 , V_20 -> V_35 + V_23 , V_34 ) ;
V_8 = F_10 ( V_7 , F_13 ( V_7 , V_30 ) ,
V_21 , V_34 , & V_22 , V_36 ) ;
if ( V_8 < 0 ) {
F_14 ( V_5 , L_21 , V_12 , V_8 ) ;
goto V_28;
}
}
F_5 ( V_5 , L_22 , V_12 , V_20 -> V_32 ) ;
V_8 = F_10 ( V_7 , F_11 ( V_7 , V_30 ) ,
V_21 , 0x200 , & V_22 , V_36 ) ;
if ( V_8 < 0 ) {
F_14 ( V_5 , L_23 , V_12 , V_8 ) ;
goto V_28;
}
F_5 ( V_5 , L_24 , V_12 , V_22 ) ;
F_15 ( 1000 ) ;
if ( ( V_8 = F_16 ( V_7 , V_37 , V_2 -> V_13 . V_38 ) ) < 0 ) {
F_14 ( V_5 , L_25 , V_12 , V_2 -> V_13 . V_38 , V_8 ) ;
goto V_28;
}
if ( V_39 )
F_1 ( V_2 , 1 ) ;
...
V_8 = 0 ;
V_28:
F_17 ( ( unsigned long ) V_21 ) ;
V_26:
return V_8 ;
}
static int F_18 ( struct V_4 * V_5 , struct V_40 * V_41 ,
int V_42 , const struct V_18 * * V_43 )
{
struct V_44 * V_45 = & V_41 -> V_45 ;
const T_1 V_46 = F_19 ( F_20 ( V_41 ) -> V_47 . V_46 ) ;
const T_2 V_48 = V_46 >> 8 ;
const T_2 V_49 = V_46 & 0xff ;
char V_10 [ 24 ] ;
sprintf ( V_10 , L_26 , V_42 , V_48 , V_49 ) ;
F_5 ( V_5 , L_27 , V_12 , V_10 ) ;
if ( F_21 ( V_43 , V_10 , V_45 ) ) {
...
F_5 ( V_5 , L_27 , V_12 , V_10 ) ;
if ( F_21 ( V_43 , V_10 , V_45 ) ) {
F_14 ( V_5 , L_30 , V_12 , V_42 ) ;
return - V_50 ;
}
}
}
F_22 ( V_5 , L_31 , V_42 , V_10 ) ;
return 0 ;
}
static int F_23 ( struct V_4 * V_5 , struct V_40 * V_41 )
{
const struct V_18 * V_19 , * V_20 ;
struct V_1 * V_2 = V_5 -> V_51 ;
int V_8 ;
if ( ( V_8 = F_18 ( V_5 , V_41 , 1 , & V_19 ) ) < 0 )
return V_8 ;
if ( ( V_8 = F_18 ( V_5 , V_41 , 2 , & V_20 ) ) < 0 ) {
F_24 ( V_19 ) ;
return V_8 ;
}
if ( ( V_8 = F_7 ( V_2 , V_19 , V_20 ) ) < 0 )
F_14 ( V_5 , L_32 , V_12 , V_8 ) ;
F_24 ( V_20 ) ;
F_24 ( V_19 ) ;
return V_8 ;
}
...
if ( V_8 < 0 ) {
F_29 ( V_5 , L_40 , V_8 ) ;
V_2 -> V_69 = F_33 ( 2 * V_2 -> V_69 , V_70 ) ;
return;
}
V_2 -> V_69 = F_34 ( V_2 -> V_69 / 2 , V_71 ) ;
V_68 = V_10 [ V_52 ] ;
if ( ( V_68 != V_2 -> V_72 ) || ! V_68 ) {
F_27 ( V_5 , L_41 , V_12 , V_68 ) ;
switch ( V_68 ) {
case 0 :
F_35 ( V_65 , V_73 ) ;
if ( V_2 -> V_72 )
...
static void F_37 ( unsigned long V_35 )
{
struct V_1 * V_2 = ( void * ) V_35 ;
F_38 ( & V_2 -> V_64 ) ;
if ( V_2 -> V_69 < V_70 )
F_39 ( & V_2 -> V_77 , V_78 + F_40 ( V_2 -> V_69 ) ) ;
else
F_29 ( V_2 -> V_5 , L_47 ) ;
}
static void F_41 ( unsigned long V_35 )
{
struct V_1 * V_2 = ( void * ) V_35 ;
struct V_79 * V_80 = V_2 -> V_80 ;
int V_8 ;
F_27 ( V_2 -> V_5 , L_12 , V_12 ) ;
if ( V_80 ) {
V_8 = F_42 ( V_80 , V_81 ) ;
if ( ! V_8 )
F_38 ( & V_2 -> V_64 ) ;
else {
F_27 ( V_2 -> V_5 , L_48 , V_12 , V_8 ) ;
F_39 ( & V_2 -> V_82 , V_78 + F_40 ( V_83 ) ) ;
}
}
}
...
int V_90 ;
F_27 ( V_5 , L_52 , V_12 , V_85 ) ;
for ( V_90 = 0 ; V_90 < V_85 ; V_90 ++ )
F_45 ( L_53 , V_2 -> V_89 [ V_90 ] ) ;
F_45 ( L_54 ) ;
goto V_88;
}
if ( ( V_80 = V_2 -> V_80 ) ) {
...
static int F_46 ( struct V_4 * V_5 , struct V_65 * V_65 )
{
struct V_6 * V_7 = V_5 -> V_7 ;
struct V_1 * V_2 = V_5 -> V_51 ;
int V_90 , V_8 ;
...
if ( F_47 ( V_7 , V_7 -> V_47 . V_93 , V_91 , sizeof( V_91 ) ) == 12 ) {
for ( V_90 = 0 ; V_90 < 6 ; V_90 ++ )
V_65 -> V_92 [ V_90 ] = ( F_48 ( V_91 [ V_90 * 2 ] ) << 4 ) +
F_48 ( V_91 [ V_90 * 2 + 1 ] ) ;
}
V_8 = F_28 ( V_2 ) ;
if ( V_2 -> V_80 ) {
V_8 = F_42 ( V_2 -> V_80 , V_24 ) ;
if ( V_8 < 0 ) {
F_27 ( V_5 , L_55 , V_12 , V_8 ) ;
F_49 ( V_2 -> V_80 ) ;
V_2 -> V_80 = NULL ;
}
}
F_39 ( & V_2 -> V_77 , V_78 + F_40 ( 1000 ) ) ;
return 0 ;
}
static void F_50 ( struct V_4 * V_5 , struct V_65 * V_65 )
{
struct V_1 * V_2 = V_5 -> V_51 ;
struct V_79 * V_80 = V_2 -> V_80 ;
F_27 ( V_5 , L_12 , V_12 ) ;
...
F_14 ( V_5 , L_56 , V_12 , V_7 -> V_47 . V_106 ) ;
return - V_27 ;
}
if ( ! ( V_99 = F_9 ( V_7 , V_37 ) ) ) {
F_14 ( V_5 , L_57 , V_12 ) ;
return - V_27 ;
}
for ( V_90 = 0 ; V_90 < V_94 ; V_90 ++ ) {
V_95 = F_9 ( V_7 , V_90 ) ;
if ( ( V_90 != V_100 ) && V_95 ) {
V_8 = F_61 ( & V_96 , V_95 , V_5 ) ;
if ( V_8 < 0 ) {
F_14 ( V_5 , L_58 , V_12 , V_90 , V_8 ) ;
F_57 ( V_7 , V_90 ) ;
return V_8 ;
}
}
}
V_2 = F_62 ( sizeof( * V_2 ) , V_24 ) ;
if ( ! V_2 ) {
F_14 ( V_5 , L_59 , V_12 ) ;
V_8 = - V_25 ;
goto V_108;
...
if ( V_2 -> V_13 . V_38 )
if ( ( V_8 = F_16 ( V_7 , V_37 , V_2 -> V_13 . V_38 ) ) < 0 ) {
F_14 ( V_5 , L_60 , V_12 , V_2 -> V_13 . V_38 , V_8 ) ;
V_2 -> V_13 . V_38 = 0 ;
}
if ( ! V_2 -> V_13 . V_38 && V_105 )
if ( ( V_8 = F_16 ( V_7 , V_37 , V_112 ) ) < 0 ) {
F_5 ( V_5 , L_60 , V_12 , V_112 , V_8 ) ;
V_105 = 0 ;
}
if ( V_105 ) {
...
if ( ( V_8 = F_16 ( V_7 , V_37 , V_124 ) ) < 0 ) {
F_14 ( V_5 , L_60 , V_12 , V_124 , V_8 ) ;
goto V_125;
}
if ( ! V_2 -> V_13 . V_38 )
...
F_5 ( V_5 , L_63 , V_12 , V_5 -> V_126 & V_130 ? L_64 : L_65 ) ;
if ( ! ( V_5 -> V_126 & V_130 ) )
if ( ( V_8 = F_69 ( V_7 ) ) < 0 ) {
F_14 ( V_5 , L_66 , V_12 , V_8 ) ;
goto V_125;
}
V_5 -> V_51 = V_2 ;
return 0 ;
...
static void F_71 ( struct V_4 * V_5 , struct V_40 * V_41 )
{
struct V_6 * V_7 = F_20 ( V_41 ) ;
struct V_1 * V_2 = V_5 -> V_51 ;
F_5 ( V_5 , L_12 , V_12 ) ;
F_57 ( V_7 , V_7 -> V_103 -> V_101 . V_104 ) ;
F_49 ( V_2 -> V_80 ) ;
F_70 ( V_2 ) ;
}
static int F_72 ( struct V_40 * V_41 , const struct V_97 * V_98 )
{
return F_73 ( V_41 , V_98 , & V_131 ) ;
}
