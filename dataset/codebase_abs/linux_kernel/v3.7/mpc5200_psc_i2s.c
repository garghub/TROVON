...
if ( V_34 != 0 )
return V_34 ;
V_34 = F_15 ( & V_33 -> V_13 , V_37 , F_16 ( V_37 ) ) ;
if ( V_34 != 0 ) {
F_17 ( L_6 ) ;
return V_34 ;
}
...
F_10 ( & V_10 -> V_24 -> V_25 ,
V_10 -> V_25 | V_16 ) ;
if ( ! F_19 ( V_33 -> V_13 . V_41 , L_7 , NULL ) )
return 0 ;
while ( ( F_20 ( & V_36 -> V_42 . V_43 ) & 0x80 ) != 0 )
;
while ( ( F_20 ( & V_36 -> V_42 . V_43 ) & 0x80 ) == 0 )
;
F_21 ( & V_10 -> V_24 -> V_44 ,
...
static int T_4 F_22 ( struct V_32 * V_33 )
{
F_23 ( V_33 ) ;
F_24 ( & V_33 -> V_13 , F_16 ( V_37 ) ) ;
return 0 ;
}
