...
V_35 -> V_38 |= V_32 ;
if ( V_35 -> V_37 & 0xff0000 )
V_33 |= V_39 ;
if ( V_35 -> V_37 & 0xff00 )
V_33 |= V_40 ;
if ( V_35 -> V_37 & 0xff )
V_33 |= V_41 ;
if ( V_35 -> V_38 & 0xff0000 )
V_33 |= V_42 ;
if ( V_35 -> V_38 & 0xff00 )
V_33 |= V_43 ;
if ( V_35 -> V_38 & 0xff )
...
unsigned int V_32 ;
unsigned int V_47 ;
V_32 = 1 << F_7 ( V_46 -> V_20 ) ;
if ( V_32 & 0x0000ff )
V_47 = 0x0000ff ;
else if ( V_32 & 0x00ff00 )
V_47 = 0x00ff00 ;
else if ( V_32 & 0x0f0000 )
V_47 = 0x0f0000 ;
else
V_47 = 0xf00000 ;
switch ( V_3 [ 0 ] ) {
...
struct V_55 * V_56 )
{
const struct V_57 * V_58 = F_10 ( V_19 ) ;
struct V_9 * V_10 ;
unsigned long V_5 ;
unsigned int V_59 ;
int V_60 , V_61 , V_62 ;
V_5 = V_56 -> V_63 [ 0 ] ;
V_59 = V_58 -> V_64 ;
V_60 = F_11 ( V_19 , sizeof( struct V_34 ) ) ;
if ( V_60 < 0 )
return - V_65 ;
( (struct V_34 * ) ( V_19 -> V_36 ) ) -> V_37 = 0 ;
( (struct V_34 * ) ( V_19 -> V_36 ) ) -> V_38 = 0 ;
F_12 ( V_66 L_1 , V_19 -> V_67 ,
V_58 -> V_68 , V_5 ) ;
if ( ! V_5 || ! F_13 ( V_5 , V_59 , L_2 ) ) {
F_12 ( L_3 ) ;
return - V_69 ;
}
V_19 -> V_5 = V_5 ;
...
if ( V_60 )
return V_60 ;
for ( V_61 = 0 ; V_61 < V_19 -> V_62 ; V_61 ++ ) {
V_10 = & V_19 -> V_22 [ V_61 ] ;
F_15 ( V_19 , V_10 , F_1 ,
( unsigned long ) ( V_19 -> V_5 + V_31 * V_61 ) ) ;
V_10 -> V_72 = F_8 ;
}
return 0 ;
}
