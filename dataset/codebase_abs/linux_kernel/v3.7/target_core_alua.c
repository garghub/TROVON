...
V_47 = snprintf ( V_125 , V_167 , L_36 ,
V_165 -> V_168 -> V_169 ( V_165 ) ) ;
if ( V_165 -> V_168 -> V_170 != NULL )
snprintf ( V_125 + V_47 , V_167 - V_47 , L_37 ,
V_165 -> V_168 -> V_170 ( V_165 ) ) ;
V_47 = snprintf ( V_105 , V_106 , L_38
L_39 ,
F_6 ( & V_8 -> V_90 ) ,
V_8 -> V_171 ) ;
snprintf ( V_104 , V_126 , L_40 ,
...
F_13 ( L_75
L_76 , ( V_227 ) ?
L_77 : L_78 , V_224 -> V_168 -> V_169 ( V_224 ) ,
V_224 -> V_168 -> V_170 ( V_224 ) ,
F_42 ( & V_88 -> V_228 . V_130 ) ,
...
else if ( V_10 -> V_57 & V_207 )
return sprintf ( V_221 , L_80 ) ;
else if ( V_10 -> V_57 & V_58 )
return sprintf ( V_221 , L_81 ) ;
else
return sprintf ( V_221 , L_82 ) ;
}
T_5 F_85 (
struct V_9 * V_10 ,
const char * V_221 ,
...
char * V_221 )
{
return sprintf ( V_221 , L_86 , V_10 -> V_92 ) ;
}
T_5 F_88 (
struct V_9 * V_10 ,
const char * V_221 ,
...
char * V_221 )
{
return sprintf ( V_221 , L_86 , V_10 -> V_139 ) ;
}
T_5 F_90 (
struct V_9 * V_10 ,
const char * V_221 ,
...
char * V_221 )
{
return sprintf ( V_221 , L_86 , V_10 -> V_36 ) ;
}
T_5 F_92 (
struct V_9 * V_10 ,
const char * V_221 ,
...
char * V_221 )
{
return sprintf ( V_221 , L_86 , V_10 -> V_25 ) ;
}
T_5 F_94 (
struct V_9 * V_10 ,
const char * V_221 ,
...
char * V_221 )
{
return sprintf ( V_221 , L_86 , V_88 -> V_33 -> V_171 ) ;
}
T_5 F_98 (
struct V_32 * V_88 ,
const char * V_221 ,
