...
void F_63 ( struct V_1 * V_2 , const T_1 * V_104 ,
enum V_107 V_93 ,
T_4 V_46 )
{
struct V_8 * V_8 = V_2 -> V_7 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_64 ( V_10 , V_2 , V_104 , V_93 , V_46 ) ;
}
int F_65 ( struct V_5 * V_6 , T_5 V_108 ,
T_3 V_109 , const T_1 * V_110 ,
int V_111 )
{
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
...
return - V_67 ;
if ( V_109 & ~ ( V_118 | V_120 ) )
return - V_67 ;
V_115 = ( V_109 & V_120 ) >> 4 ;
if ( ! ( V_6 -> V_8 -> V_116 [ V_6 -> V_121 ] . V_122 & F_66 ( V_115 ) ) )
return - V_67 ;
V_114 = F_67 ( sizeof( * V_113 ) + V_111 , V_11 ) ;
if ( ! V_114 )
return - V_123 ;
F_68 ( & V_6 -> V_124 ) ;
F_69 (reg, &wdev->mgmt_registrations, list) {
int V_125 = F_70 ( V_111 , V_113 -> V_111 ) ;
if ( V_109 != F_9 ( V_113 -> V_109 ) )
continue;
if ( memcmp ( V_113 -> V_126 , V_110 , V_125 ) == 0 ) {
V_65 = - V_68 ;
break;
}
}
...
memcpy ( V_114 -> V_126 , V_110 , V_111 ) ;
V_114 -> V_111 = V_111 ;
V_114 -> V_127 = V_108 ;
V_114 -> V_109 = F_71 ( V_109 ) ;
F_72 ( & V_114 -> V_128 , & V_6 -> V_129 ) ;
if ( V_10 -> V_73 -> V_130 )
V_10 -> V_73 -> V_130 ( V_8 , V_6 , V_109 , true ) ;
V_24:
F_73 ( & V_6 -> V_124 ) ;
return V_65 ;
}
void F_74 ( struct V_5 * V_6 , T_5 V_127 )
{
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
struct V_112 * V_113 , * V_131 ;
F_68 ( & V_6 -> V_124 ) ;
F_75 (reg, tmp, &wdev->mgmt_registrations, list) {
if ( V_113 -> V_127 != V_127 )
continue;
if ( V_10 -> V_73 -> V_130 ) {
T_3 V_109 = F_9 ( V_113 -> V_109 ) ;
V_10 -> V_73 -> V_130 ( V_8 , V_6 ,
V_109 , false ) ;
}
F_76 ( & V_113 -> V_128 ) ;
F_39 ( V_113 ) ;
...
struct V_5 * V_6 ,
struct V_53 * V_54 , bool V_133 ,
enum V_101 V_102 ,
bool V_134 , unsigned int V_135 ,
const T_1 * V_3 , T_2 V_4 , bool V_136 ,
bool V_137 , T_6 * V_100 )
{
...
if ( ! F_79 ( V_16 -> V_140 ) )
return - V_67 ;
V_138 = F_9 ( V_16 -> V_140 ) & V_120 ;
if ( ! ( V_6 -> V_8 -> V_116 [ V_6 -> V_121 ] . V_141 & F_66 ( V_138 >> 4 ) ) )
return - V_67 ;
if ( F_80 ( V_16 -> V_140 ) &&
...
if ( ! F_17 ( V_16 -> V_36 , F_81 ( V_6 ) ) )
return - V_67 ;
return V_10 -> V_73 -> V_139 ( & V_10 -> V_8 , V_6 , V_54 , V_133 ,
V_102 , V_134 ,
V_135 , V_3 , V_4 , V_136 , V_137 ,
V_100 ) ;
}
bool F_82 ( struct V_5 * V_6 , int V_154 , int V_155 ,
...
int V_158 ;
bool V_159 = false ;
T_7 V_160 = V_16 -> V_140 &
F_71 ( V_118 | V_120 ) ;
T_3 V_138 ;
V_138 = ( F_9 ( V_16 -> V_140 ) & V_120 ) >> 4 ;
if ( ! ( V_157 -> V_122 & F_66 ( V_138 ) ) )
return false ;
V_50 = V_3 + F_83 ( V_16 -> V_140 ) ;
V_158 = V_4 - F_83 ( V_16 -> V_140 ) ;
F_68 ( & V_6 -> V_124 ) ;
F_69 (reg, &wdev->mgmt_registrations, list) {
if ( V_113 -> V_109 != V_160 )
continue;
if ( V_113 -> V_111 > V_158 )
continue;
if ( memcmp ( V_113 -> V_126 , V_50 , V_113 -> V_111 ) )
continue;
if ( F_84 ( V_10 , V_6 , V_113 -> V_127 ,
V_154 , V_155 ,
V_3 , V_4 , V_46 ) )
continue;
V_159 = true ;
...
void F_85 ( struct V_5 * V_6 , T_6 V_100 ,
const T_1 * V_3 , T_2 V_4 , bool V_161 , T_4 V_46 )
{
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_86 ( V_10 , V_6 , V_100 , V_3 , V_4 , V_161 , V_46 ) ;
}
...
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_88 ( V_10 , V_2 , V_163 , V_46 ) ;
}
void F_89 ( struct V_1 * V_2 ,
const T_1 * V_164 , T_5 V_165 , T_4 V_46 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_90 ( V_10 , V_2 , V_164 , V_165 , V_46 ) ;
}
void F_91 ( struct V_1 * V_2 ,
const T_1 * V_164 , T_5 V_165 ,
T_5 V_166 , T_5 V_167 , T_4 V_46 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_92 ( V_10 , V_2 , V_164 , V_165 ,
V_166 , V_167 , V_46 ) ;
}
void F_93 ( struct V_1 * V_2 , const T_1 * V_28 ,
const T_1 * V_168 , T_4 V_46 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_94 ( V_10 , V_2 , V_28 , V_168 , V_46 ) ;
}
void F_95 ( struct V_1 * V_2 , int V_169 ,
const T_1 * V_28 , bool V_170 , T_4 V_46 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_96 ( V_10 , V_2 , V_169 , V_28 , V_170 , V_46 ) ;
}
void F_97 ( struct V_1 * V_2 , int V_154 ,
enum V_101 type )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
...
struct V_53 * V_54 ;
F_3 ( V_6 ) ;
if ( F_25 ( V_6 -> V_121 != V_149 &&
V_6 -> V_121 != V_150 ) )
goto V_24;
V_54 = F_98 ( V_10 , V_154 , type ) ;
if ( F_25 ( ! V_54 ) )
goto V_24;
V_6 -> V_71 = V_54 ;
F_99 ( V_10 , V_2 , V_154 , type , V_11 ) ;
V_24:
F_6 ( V_6 ) ;
return;
}
