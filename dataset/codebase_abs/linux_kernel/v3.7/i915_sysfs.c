...
if ( V_36 )
return V_36 ;
V_36 = V_5 -> V_47 . V_48 * V_49 ;
F_15 ( & V_2 -> V_40 ) ;
return snprintf ( V_12 , V_15 , L_3 , V_36 ) ;
}
static T_3 F_22 ( struct V_8 * V_9 , struct V_10 * V_11 , char * V_12 )
{
struct V_13 * V_46 = F_6 ( V_9 , struct V_13 , V_9 ) ;
struct V_1 * V_2 = V_46 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
if ( V_36 )
return V_36 ;
V_36 = V_5 -> V_47 . V_50 * V_49 ;
F_15 ( & V_2 -> V_40 ) ;
return snprintf ( V_12 , V_15 , L_3 , V_36 ) ;
}
static T_3 F_23 ( struct V_8 * V_9 ,
struct V_10 * V_11 ,
...
V_52 = F_3 ( V_55 ) ;
V_53 = ( V_52 & 0xff ) ;
V_54 = ( ( V_52 & 0xff0000 ) >> 16 ) ;
if ( V_51 < V_54 || V_51 > V_53 || V_51 < V_5 -> V_47 . V_56 ) {
F_15 ( & V_2 -> V_40 ) ;
return - V_24 ;
}
if ( V_5 -> V_47 . V_48 > V_51 )
F_26 ( V_5 -> V_2 , V_51 ) ;
V_5 -> V_47 . V_50 = V_51 ;
F_15 ( & V_2 -> V_40 ) ;
return V_32 ;
...
V_53 = ( V_52 & 0xff ) ;
V_54 = ( ( V_52 & 0xff0000 ) >> 16 ) ;
if ( V_51 < V_54 || V_51 > V_53 || V_51 > V_5 -> V_47 . V_50 ) {
F_15 ( & V_2 -> V_40 ) ;
return - V_24 ;
}
if ( V_5 -> V_47 . V_48 < V_51 )
...
F_15 ( & V_2 -> V_40 ) ;
if ( V_11 == & V_57 ) {
V_51 = ( ( V_52 & 0x0000ff ) >> 0 ) * V_49 ;
} else if ( V_11 == & V_58 ) {
V_51 = ( ( V_52 & 0x00ff00 ) >> 8 ) * V_49 ;
} else if ( V_11 == & V_59 ) {
V_51 = ( ( V_52 & 0xff0000 ) >> 16 ) * V_49 ;
} else {
F_30 () ;
}
return snprintf ( V_12 , V_15 , L_3 , V_51 ) ;
}
...
#endif
if ( F_36 ( V_2 ) ) {
V_36 = F_37 ( & V_2 -> V_61 -> V_9 , & V_63 ) ;
if ( V_36 )
F_35 ( L_5 ) ;
}
if ( F_33 ( V_2 ) -> V_60 >= 6 ) {
V_36 = F_38 ( & V_2 -> V_61 -> V_9 . V_30 , V_64 ) ;
if ( V_36 )
F_35 ( L_6 ) ;
}
}
...
{
F_40 ( & V_2 -> V_61 -> V_9 . V_30 , V_64 ) ;
F_41 ( & V_2 -> V_61 -> V_9 , & V_63 ) ;
#ifdef F_32
F_42 ( & V_2 -> V_61 -> V_9 . V_30 , & V_62 ) ;
#endif
}
