...
V_44 -> V_53 = V_54 ;
F_24 ( 0 , V_55 ) ;
F_25 ( & V_44 -> V_56 , & V_46 [ 0 ] , V_44 -> V_53 ) ;
F_25 ( & V_44 -> V_56 , & V_46 [ 1 ] , V_44 -> V_53 ) ;
return 1 ;
}
void T_3 F_26 ( void )
{
...
V_60 = 0x81000000 ;
V_61 = V_62 ;
V_57 = ( unsigned int ) V_63 - V_64 ;
for ( V_58 = 0x00100000 ; V_58 < 0x10000000 ; V_58 <<= 1 )
if ( V_58 >= V_57 )
break;
* V_65 = ( V_58 - 1 ) & 0x0ffc0000 ;
* V_66 = 0 ;
* V_67 = 0x80000000 ;
* V_68 = 0 ;
* V_69 = 0 ;
