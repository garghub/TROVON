...
void F_33 ( struct V_7 * V_8 , int V_53 , unsigned int V_54 )
{
struct V_1 * V_2 = F_12 ( V_8 ) ;
if ( V_2 -> V_51 )
return;
...
int F_34 ( struct V_7 * V_8 , struct V_9 * V_10 )
{
...
void F_37 ( struct V_7 * V_8 , int V_80 )
{
struct V_1 * V_2 = F_12 ( V_8 ) ;
if ( V_2 -> V_51 )
return;
...
int F_38 ( struct V_7 * V_8 , const T_1 * V_53 ,
T_1 * V_86 )
{
struct V_1 * V_2 = F_12 ( V_8 ) ;
...
int F_39 ( struct V_7 * V_8 , T_1 * V_53 ,
T_1 * V_91 , T_1 * V_92 )
{
T_3 V_93 ;
T_1 V_94 , V_95 ;
...
void F_57 ( struct V_135 * V_136 )
{
struct V_1 * V_2 =
F_47 ( V_136 , struct V_1 , V_137 . V_136 ) ;
F_44 ( V_2 ) ;
F_45 ( V_2 ) ;
V_2 -> V_51 = 0 ;
...
static T_5 F_59 ( int V_141 , void * V_120 )
{
...
V_142 = F_1 ( V_2 , V_140 ) ;
F_3 ( V_2 , V_140 , V_142 ) ;
if ( V_142 & ( V_114 | V_113 ) ) {
V_144 = V_146 ;
V_2 -> V_109 = ! ! ( V_142 & V_114 ) ;
F_17 ( V_2 -> V_51 ) ;
F_58 ( V_2 ) ;
if ( V_2 -> V_51 )
goto V_147;
...
int F_63 ( struct V_36 * V_36 , const struct V_151 * V_152 )
{
int error ;
struct V_9 * V_10 ;
struct V_1 * V_2 ;
...
F_58 ( V_2 ) ;
F_13 ( V_2 ) ;
V_2 -> V_141 = V_36 -> V_141 ;
F_75 ( & V_2 -> V_49 ) ;
V_2 -> V_109 = 0 ;
F_44 ( V_2 ) ;
error = - V_172 ;
if ( F_76 ( V_36 -> V_141 , & F_59 , V_178 ,
V_153 , V_2 ) )
goto V_179;
F_60 ( V_2 -> V_148 ,
& V_2 -> V_137 , 0 ) ;
