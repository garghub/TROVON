...
static unsigned int F_27 ( unsigned int V_138 )
{
V_138 &= ~ V_139 ;
return V_138 ;
}
static void F_28 ( struct V_88 * V_89 , struct V_74 * V_74 ,
int V_140 )
{
...
void F_30 ( struct V_88 * V_89 , struct V_74 * V_74 , int V_52 ,
int V_140 )
{
switch ( V_52 ) {
case V_95 :
F_28 ( V_89 , V_74 , V_140 ) ;
break;
case V_100 :
...
static void F_31 ( struct V_145 * V_90 , int V_146 )
{
if ( V_146 ) {
V_90 -> V_91 = F_32 ( V_90 -> V_91 ) ;
V_90 -> V_92 = F_32 ( V_90 -> V_92 ) ;
V_90 -> V_93 = F_32 ( V_90 -> V_93 ) ;
V_90 -> V_94 = F_32 ( V_90 -> V_94 ) ;
V_90 -> V_13 = F_32 ( V_90 -> V_13 ) ;
} else {
...
static void F_34 ( struct V_141 * V_89 ,
int V_146 )
{
if ( V_146 ) {
V_89 -> V_77 = F_32 ( V_89 -> V_77 ) ;
F_35 ( & V_89 -> V_79 ) ;
F_35 ( & V_89 -> V_82 ) ;
F_35 ( & V_89 -> V_83 ) ;
F_35 ( & V_89 -> V_84 ) ;
...
static void F_37 ( struct V_143 * V_89 ,
int V_146 )
{
if ( V_146 ) {
F_35 ( & V_89 -> V_76 ) ;
...
static void F_38 ( struct V_147 * V_89 ,
int V_146 )
{
if ( V_146 )
V_89 -> V_92 = F_32 ( V_89 -> V_92 ) ;
else
V_89 -> V_92 = F_33 ( V_89 -> V_92 ) ;
}
static void F_39 ( struct V_148 * V_89 ,
int V_146 )
{
if ( V_146 )
F_35 ( & V_89 -> V_76 ) ;
...
void F_40 ( struct V_88 * V_89 , int V_146 )
{
T_4 V_52 = 0 ;
if ( V_146 )
V_52 = V_89 -> V_90 . V_91 ;
F_31 ( & V_89 -> V_90 , V_146 ) ;
if ( ! V_146 )
V_52 = V_89 -> V_90 . V_91 ;
switch ( V_52 ) {
case V_95 :
F_34 ( & V_89 -> V_96 . V_97 , V_146 ) ;
break;
case V_100 :
F_37 ( & V_89 -> V_96 . V_101 , V_146 ) ;
break;
case V_98 :
F_38 ( & V_89 -> V_96 . V_99 , V_146 ) ;
break;
case V_102 :
F_39 ( & V_89 -> V_96 . V_103 , V_146 ) ;
break;
default:
F_18 ( L_80 ) ;
break;
...
{
if ( V_146 ) {
V_150 -> V_151 = F_32 ( V_150 -> V_151 ) ;
V_150 -> V_152 = F_32 ( V_150 -> V_152 ) ;
V_150 -> V_76 = F_32 ( V_150 -> V_76 ) ;
V_150 -> V_80 = F_32 ( V_150 -> V_80 ) ;
} else {
...
static void F_42 ( struct V_149 * V_150 ,
...
void * F_43 ( struct V_74 * V_74 , T_1 * V_9 )
{
void * V_8 ;
struct V_149 * V_150 ;
int V_155 = V_74 -> V_83 ;
...
int V_21 ;
V_8 = F_44 ( V_106 , V_156 ) ;
if ( ! V_8 )
return NULL ;
for ( V_21 = 0 ; V_21 < V_155 ; V_21 ++ ) {
V_150 = V_8 + ( V_21 * sizeof( * V_150 ) ) ;
F_42 ( V_150 , & V_74 -> V_157 [ V_21 ] , 1 ) ;
F_41 ( V_150 , 1 ) ;
}
* V_9 = V_106 ;
return V_8 ;
}
int F_45 ( struct V_158 * V_159 , struct V_74 * V_74 )
{
void * V_8 ;
struct V_149 * V_150 ;
int V_155 = V_74 -> V_83 ;
...
void F_50 ( struct V_158 * V_159 , struct V_74 * V_74 )
{
int V_155 = V_74 -> V_83 ;
int V_21 ;
int V_169 = V_74 -> V_80 ;
...
int F_51 ( struct V_158 * V_159 , struct V_74 * V_74 )
{
int V_160 ;
int V_106 ;
if ( V_159 -> V_164 == V_165 ) {
