...
if ( V_42 &&
V_116 == V_121 &&
! strcmp ( V_119 -> V_120 -> V_113 , V_120 -> V_113 ) ) {
F_23 () ;
F_41 ( V_119 -> V_87 ) ;
} else
F_23 () ;
...
V_127 = snprintf ( V_125 , V_126 , L_36 ,
V_50 ? ( 2 << ( V_50 - 1 ) ) : 0 , ( 2 << V_50 ) - 1 ,
F_55 ( & V_5 [ V_50 ] ) ) ;
V_126 -= V_127 ;
V_125 += V_127 ;
}
V_127 = snprintf ( V_125 , V_126 , L_37 ,
2 << ( V_7 - 2 ) ,
F_55 ( & V_5 [ ( V_7 - 1 ) ] ) ) ;
V_125 += V_127 ;
F_23 () ;
...
static T_5 F_68 ( const char * V_14 , int V_138 )
{
T_5 V_139 ;
T_6 V_140 ;
V_140 = F_69 ( * ( T_6 * ) ( V_14 ) ) ;
V_140 = ( T_6 ) ( V_140 << V_138 ) ;
V_140 = F_70 ( V_140 ) ;
memcpy ( & V_139 , & V_140 , 1 ) ;
return V_139 ;
}
static T_5 F_71 ( const char * * V_14 , int * V_138 )
{
T_5 V_141 ;
V_141 = F_68 ( * V_14 , * V_138 ) ;
V_141 = V_141 >> 3 ;
V_141 &= 0x1F ;
* V_14 += ( * V_138 + 5 ) / 8 ;
* V_138 = ( * V_138 + 5 ) % 8 ;
...
static T_5 F_72 ( const char * * V_14 , int * V_138 )
{
T_5 V_141 ;
V_141 = F_68 ( * V_14 , * V_138 ) ;
V_141 = V_141 >> 2 ;
...
static T_5 F_73 ( const char * * V_14 , int * V_138 )
{
T_5 V_19 ;
V_19 = F_68 ( * V_14 , * V_138 ) ;
( * V_14 ) ++ ;
return V_19 ;
}
static T_6 F_74 ( const char * * V_14 , int * V_138 ,
struct V_142 * V_143 )
{
T_6 V_19 ;
V_19 = F_69 ( * ( T_6 * ) ( * V_14 ) ) ;
...
static T_5 F_75 ( const char * * V_14 , int * V_138 ,
struct V_142 * V_143 )
{
return F_73 ( V_14 , V_138 ) ;
}
static int F_76 ( const char * * V_54 , int * V_144 ,
unsigned char * * V_55 , struct V_142 * V_143 )
{
int V_48 ;
V_48 = F_77 ( V_54 , V_144 , V_55 , V_143 ) ;
if ( V_48 )
return V_48 ;
V_48 = F_77 ( V_54 , V_144 , V_55 , V_143 ) ;
return V_48 ;
}
static int F_77 ( const char * * V_54 , int * V_144 ,
unsigned char * * V_55 , struct V_142 * V_143 )
{
int V_48 ;
V_48 = F_78 ( V_54 , V_144 , V_55 , V_143 ) ;
if ( V_48 )
return V_48 ;
V_48 = F_78 ( V_54 , V_144 , V_55 , V_143 ) ;
return V_48 ;
}
static int F_78 ( const char * * V_54 , int * V_144 ,
unsigned char * * V_55 , struct V_142 * V_143 )
{
* * V_55 = F_68 ( * V_54 , * V_144 ) ;
( * V_54 ) ++ ;
( * V_55 ) ++ ;
* * V_55 = F_68 ( * V_54 , * V_144 ) ;
( * V_54 ) ++ ;
...
static int F_79 ( const char * * V_54 , int * V_144 ,
unsigned char * * V_55 , struct V_142 * V_143 )
{
T_5 V_19 ;
V_19 = F_75 ( V_54 , V_144 , V_143 ) ;
if ( ! V_143 -> V_145 && ( V_19 >= V_143 -> V_146 ) )
return 1 ;
memcpy ( * V_55 , V_143 -> V_147 [ V_19 ] , 8 ) ;
* V_55 += 8 ;
return 0 ;
}
static int F_80 ( const char * * V_54 , int * V_144 ,
unsigned char * * V_55 , struct V_142 * V_143 )
{
T_6 V_19 ;
V_19 = F_74 ( V_54 , V_144 , V_143 ) ;
if ( ! V_143 -> V_145 && ( V_19 >= V_143 -> V_148 ) )
return 1 ;
memcpy ( * V_55 , V_143 -> V_149 [ V_19 ] , 4 ) ;
* V_55 += 4 ;
return 0 ;
}
static int F_81 ( const char * * V_54 , int * V_144 ,
unsigned char * * V_55 , struct V_142 * V_143 )
{
T_5 V_19 ;
V_19 = F_73 ( V_54 , V_144 ) ;
if ( ! V_143 -> V_150 && ( V_19 >= V_143 -> V_151 ) )
return 1 ;
memcpy ( * V_55 , V_143 -> V_152 [ V_19 ] , 2 ) ;
* V_55 += 2 ;
return 0 ;
}
static void F_82 ( const char * V_14 , struct V_142 * V_143 )
{
unsigned char V_153 = V_143 -> V_151 ;
memcpy ( V_143 -> V_147 [ V_143 -> V_146 ] , V_14 , 8 ) ;
V_143 -> V_148 += 2 ;
V_143 -> V_146 += 1 ;
if ( ! V_143 -> V_145 && V_143 -> V_148 >= 512 ) {
V_143 -> V_145 = 1 ;
V_143 -> V_148 /= 512 ;
}
memcpy ( V_143 -> V_152 [ V_143 -> V_151 ++ ] , V_14 , 2 ) ;
memcpy ( V_143 -> V_152 [ V_143 -> V_151 ++ ] , V_14 + 2 , 2 ) ;
memcpy ( V_143 -> V_152 [ V_143 -> V_151 ++ ] , V_14 + 4 , 2 ) ;
memcpy ( V_143 -> V_152 [ V_143 -> V_151 ++ ] , V_14 + 6 , 2 ) ;
if ( V_143 -> V_151 < V_153 )
V_143 -> V_150 = 1 ;
}
static int F_30 ( const unsigned char * V_154 , int V_155 ,
unsigned char * V_156 , int * V_157 ,
const void * V_158 )
{
T_5 V_139 ;
const char * V_54 ;
int V_144 = 0 ;
unsigned char * V_55 , * V_159 , * V_160 , * V_161 ;
const char * V_162 ;
T_7 V_58 ;
int V_163 ;
int V_50 , V_164 ;
...
V_55 = V_156 ;
V_159 = V_156 + * V_157 ;
while ( ( V_139 = F_71 ( & V_54 , & V_144 ) ) != V_166 ) {
if ( V_54 >= V_162 ) {
V_48 = - V_35 ;
goto V_38;
}
...
while ( V_163 < 4 &&
( V_58 = V_169 [ V_139 ] [ V_163 ++ ] )
!= NULL ) {
V_48 = (* V_58)( & V_54 , & V_144 , & V_55 , V_143 ) ;
if ( V_48 ) {
V_48 = - V_35 ;
goto V_38;
}
