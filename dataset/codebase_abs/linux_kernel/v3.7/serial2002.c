...
struct V_109 * V_110 ,
struct V_121 * V_122 , unsigned int * V_72 )
{
int V_123 ;
int V_115 ;
V_115 = V_80 -> V_102 [ F_28 ( V_122 -> V_124 ) ] ;
for ( V_123 = 0 ; V_123 < V_122 -> V_123 ; V_123 ++ ) {
struct V_66 V_35 ;
...
int V_123 ;
int V_115 ;
V_115 = V_80 -> V_103 [ F_28 ( V_122 -> V_124 ) ] ;
for ( V_123 = 0 ; V_123 < V_122 -> V_123 ; V_123 ++ ) {
struct V_66 V_14 ;
V_14 . V_68 = V_74 ;
V_14 . V_70 = V_115 ;
V_14 . V_71 = V_72 [ V_123 ] ;
F_18 ( V_80 -> V_81 , V_14 ) ;
}
return V_123 ;
}
...
int V_123 ;
int V_115 ;
V_115 = V_80 -> V_104 [ F_28 ( V_122 -> V_124 ) ] ;
for ( V_123 = 0 ; V_123 < V_122 -> V_123 ; V_123 ++ ) {
struct V_66 V_35 ;
...
int V_123 ;
int V_115 ;
V_115 = V_80 -> V_106 [ F_28 ( V_122 -> V_124 ) ] ;
for ( V_123 = 0 ; V_123 < V_122 -> V_123 ; V_123 ++ ) {
struct V_66 V_14 ;
V_14 . V_68 = V_75 ;
V_14 . V_70 = V_115 ;
...
{
int V_123 ;
int V_115 = F_28 ( V_122 -> V_124 ) ;
for ( V_123 = 0 ; V_123 < V_122 -> V_123 ; V_123 ++ )
V_72 [ V_123 ] = V_80 -> V_125 [ V_115 ] ;
return V_123 ;
}
...
int V_123 ;
int V_115 ;
V_115 = V_80 -> V_108 [ F_28 ( V_122 -> V_124 ) ] ;
for ( V_123 = 0 ; V_123 < V_122 -> V_123 ; V_123 ++ ) {
struct V_66 V_35 ;
F_15 ( V_80 -> V_81 , V_115 ) ;
while ( 1 ) {
...
struct V_126 * V_127 )
{
const struct V_128 * V_129 = F_35 ( V_78 ) ;
struct V_109 * V_110 ;
int V_130 ;
F_36 ( V_78 -> V_131 , L_4 ) ;
V_78 -> V_132 = V_129 -> V_133 ;
if ( F_37 ( V_78 , sizeof( struct V_134 ) ) < 0 )
return - V_92 ;
V_78 -> V_135 = F_19 ;
V_78 -> V_136 = F_26 ;
V_80 -> V_79 = V_127 -> V_137 [ 0 ] ;
V_80 -> V_37 = V_127 -> V_137 [ 1 ] ;
F_36 ( V_78 -> V_131 , L_5 , V_80 -> V_79 ,
V_80 -> V_37 ) ;
V_130 = F_38 ( V_78 , 5 ) ;
if ( V_130 )
return V_130 ;
