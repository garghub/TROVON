...
V_93 = ( V_93 / V_28 ) >> V_42 ;
V_94 = ( V_94 / V_28 ) >> V_42 ;
for ( V_100 = V_93 ; V_100 <= V_94 ; ++ V_100 ) {
T_1 V_101 , V_102 ;
if ( V_44 -> V_55 [ V_100 ] )
continue;
V_66:
...
V_101 = V_44 -> V_67 + V_100 * 8 ;
V_102 = F_63 ( V_44 -> V_55 [ V_100 ] ) ;
if ( ( ( V_97 + 8 * V_99 ) != V_101 ) ||
( ( V_98 + V_95 * V_99 ) != V_102 ) ) {
if ( V_99 ) {
F_82 ( V_2 , V_97 ,
V_98 , V_99 , V_95 ,
V_103 ) ;
...
T_1 V_104 , T_4 V_82 )
{
static const T_1 V_105 = V_96 - 1 ;
T_1 V_106 = ~ 0 , V_107 = ~ 0 ;
unsigned V_99 = 0 ;
T_1 V_31 ;
V_93 = V_93 / V_28 ;
V_94 = V_94 / V_28 ;
for ( V_31 = V_93 ; V_31 < V_94 ; ) {
T_1 V_100 = V_31 >> V_42 ;
unsigned V_108 ;
T_1 V_109 ;
if ( ( V_31 & ~ V_105 ) == ( V_94 & ~ V_105 ) )
V_108 = V_94 - V_31 ;
else
V_108 = V_96 - ( V_31 & V_105 ) ;
V_109 = F_63 ( V_44 -> V_55 [ V_100 ] ) ;
V_109 += ( V_31 & V_105 ) * 8 ;
if ( ( V_106 + 8 * V_99 ) != V_109 ) {
if ( V_99 ) {
F_82 ( V_2 , V_106 ,
V_107 , V_99 ,
V_28 ,
...
struct V_110 * V_111 )
{
unsigned V_112 = V_2 -> V_113 -> V_44 . V_114 ;
struct V_115 * V_71 = & V_2 -> V_71 [ V_112 ] ;
struct V_116 * V_117 = NULL ;
struct V_45 * V_46 ;
unsigned V_108 , V_118 , V_119 ;
T_1 V_31 ;
int V_15 ;
if ( V_44 -> V_51 == NULL )
return 0 ;
...
if ( ( V_46 -> V_52 && V_111 ) || ( ! V_46 -> V_52 && V_111 == NULL ) )
return 0 ;
V_46 -> V_82 &= ~ V_103 ;
V_46 -> V_82 &= ~ V_120 ;
if ( V_111 ) {
V_31 = V_111 -> V_93 << V_14 ;
if ( V_111 -> V_121 != V_122 ) {
V_46 -> V_82 |= V_103 ;
V_46 -> V_52 = true ;
}
if ( V_111 -> V_121 == V_123 ) {
V_46 -> V_82 |= V_120 ;
} else {
V_31 += V_2 -> V_40 . V_124 ;
}
...
if ( V_44 -> V_54 && F_85 ( V_44 -> V_54 ) ) {
F_54 ( & V_44 -> V_54 ) ;
}
if ( V_44 -> V_54 && V_44 -> V_54 -> V_71 != V_112 ) {
V_15 = F_86 ( V_2 , & V_117 ) ;
if ( V_15 ) {
return V_15 ;
}
...
V_119 += ( V_118 >> 11 ) * 4 ;
V_119 += V_118 * 2 ;
V_15 = F_88 ( V_2 , V_71 , V_119 ) ;
if ( V_15 ) {
return V_15 ;
}
if ( V_117 && F_89 ( V_44 -> V_54 , V_112 ) ) {
F_90 ( V_2 , V_117 , V_44 -> V_54 -> V_71 , V_112 ) ;
F_91 ( V_44 -> V_54 , V_112 ) ;
}
V_15 = F_81 ( V_2 , V_44 , V_46 -> V_80 , V_46 -> V_81 ) ;
if ( V_15 ) {
F_92 ( V_2 , V_71 ) ;
return V_15 ;
}
F_83 ( V_2 , V_44 , V_46 -> V_80 , V_46 -> V_81 ,
V_31 , V_46 -> V_82 ) ;
F_54 ( & V_44 -> V_54 ) ;
V_15 = F_93 ( V_2 , & V_44 -> V_54 , V_112 ) ;
if ( V_15 ) {
F_92 ( V_2 , V_71 ) ;
return V_15 ;
}
F_94 ( V_2 , V_71 ) ;
F_95 ( V_2 , & V_117 , V_44 -> V_54 ) ;
F_54 ( & V_44 -> V_76 ) ;
return 0 ;
}
...
{
struct V_45 * V_46 ;
F_99 ( ! F_100 ( & V_79 -> V_125 . V_126 ) ) ;
F_45 (bo_va, &bo->va, bo_list) {
V_46 -> V_52 = false ;
}
}
void F_101 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
V_44 -> V_75 = 0 ;
V_44 -> V_54 = NULL ;
F_102 ( & V_44 -> V_58 ) ;
...
void F_103 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
