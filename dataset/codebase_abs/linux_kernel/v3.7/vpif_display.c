...
if ( V_8 -> V_66 ) {
F_21 ( & V_8 -> V_52 ) ;
V_137 = F_58 ( & V_8 -> V_135 , V_130 , V_136 ) ;
F_19 ( & V_8 -> V_52 ) ;
}
return V_137 ;
}
...
static int F_71 ( struct V_129 * V_129 , void * V_148 ,
struct V_149 * V_150 )
{
struct V_54 * V_98 = V_56 -> V_57 ;
V_150 -> V_151 = V_152 | V_153 ;
V_150 -> V_154 = V_150 -> V_151 | V_155 ;
snprintf ( V_150 -> V_156 , sizeof( V_150 -> V_156 ) , L_13 , F_72 ( V_56 ) ) ;
snprintf ( V_150 -> V_157 , sizeof( V_150 -> V_157 ) , L_14 ,
F_72 ( V_56 ) ) ;
F_73 ( V_150 -> V_158 , V_98 -> V_159 , sizeof( V_150 -> V_158 ) ) ;
return 0 ;
}
static int F_74 ( struct V_129 * V_129 , void * V_148 ,
struct V_160 * V_15 )
{
if ( V_15 -> V_161 != 0 ) {
F_9 ( L_15 ) ;
...
static int F_75 ( struct V_129 * V_129 , void * V_148 ,
struct V_27 * V_15 )
{
...
V_60 = F_77 ( & V_33 -> V_145 , V_4 -> V_145 ) ;
if ( 0 != V_60 )
return V_60 ;
V_4 -> V_142 = 1 ;
}
...
static int F_79 ( struct V_129 * V_129 , void * V_148 ,
struct V_164 * V_165 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
...
V_8 -> V_36 = V_165 -> V_36 ;
F_23 ( & V_8 -> V_49 ) ;
return F_82 ( & V_8 -> V_135 , V_165 ) ;
}
static int F_83 ( struct V_129 * V_129 , void * V_148 ,
struct V_176 * V_177 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
...
return - V_25 ;
return F_84 ( & V_8 -> V_135 , V_177 ) ;
}
static int F_85 ( struct V_129 * V_129 , void * V_148 , struct V_176 * V_47 )
{
struct V_3 * V_4 = NULL ;
...
return F_86 ( & V_8 -> V_135 , V_47 ) ;
}
static int F_87 ( struct V_129 * V_129 , void * V_148 , T_5 * V_179 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
struct V_7 * V_8 = & V_33 -> V_8 [ V_11 ] ;
...
F_51 ( V_33 ) ;
V_60 = F_88 ( & V_88 . V_181 , 1 , V_96 ,
V_182 , * V_179 ) ;
if ( V_60 < 0 ) {
F_9 ( L_24 ) ;
return V_60 ;
}
V_60 = F_88 ( & V_88 . V_181 , 1 , V_183 ,
V_184 , * V_179 ) ;
if ( V_60 < 0 )
F_9 ( L_25 ) ;
return V_60 ;
}
static int F_89 ( struct V_129 * V_129 , void * V_148 , T_5 * V_185 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
...
static int F_90 ( struct V_129 * V_129 , void * V_148 , struct V_176 * V_186 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
struct V_7 * V_8 = & V_33 -> V_8 [ V_11 ] ;
return F_91 ( & V_8 -> V_135 , V_186 ,
( V_129 -> V_187 & V_188 ) ) ;
}
...
static int F_97 ( struct V_129 * V_129 , void * V_4 ,
struct V_198 * V_199 )
{
struct V_54 * V_98 = V_56 -> V_57 ;
struct V_200 * V_201 ;
...
static int F_99 ( struct V_54 * V_205 ,
...
V_60 = F_100 ( V_213 , V_96 , V_218 , V_214 , V_199 , 0 ) ;
...
static int F_101 ( struct V_129 * V_129 , void * V_148 , unsigned int V_90 )
{
struct V_54 * V_98 = V_56 -> V_57 ;
struct V_200 * V_201 ;
struct V_3 * V_4 = V_148 ;
...
return F_99 ( V_98 , V_33 , V_90 ) ;
}
static int F_102 ( struct V_129 * V_129 , void * V_148 , unsigned int * V_90 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
* V_90 = V_33 -> V_220 ;
...
static int F_103 ( struct V_129 * V_129 , void * V_148 , enum V_223 * V_186 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
* V_186 = F_104 ( & V_33 -> V_145 ) ;
return 0 ;
}
static int F_105 ( struct V_129 * V_129 , void * V_148 , enum V_223 V_186 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
return F_106 ( & V_33 -> V_145 , & V_4 -> V_145 , V_186 ) ;
}
static int
F_107 ( struct V_129 * V_129 , void * V_148 ,
struct V_224 * V_225 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
int V_60 ;
V_60 = F_100 ( V_33 -> V_213 , V_96 , V_226 , V_225 ) ;
...
V_60 = F_100 ( V_33 -> V_213 , V_96 , V_231 , V_225 ) ;
if ( V_60 == - V_219 || V_60 == - V_227 )
V_60 = 0 ;
if ( V_60 < 0 ) {
F_49 ( 2 , V_101 , L_34 ) ;
...
static int F_109 ( struct V_129 * V_129 , void * V_148 ,
struct V_228 * V_225 )
{
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
...
return F_88 ( & V_88 . V_181 , 0 , V_183 ,
V_262 , V_255 ) ;
}
...
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
return F_100 ( V_33 -> V_213 , V_183 , V_265 , V_264 ) ;
}
static int F_112 ( struct V_129 * V_129 , void * V_148 ,
struct V_263 * V_264 ) {
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
return F_100 ( V_33 -> V_213 , V_183 , V_266 , V_264 ) ;
}
static int F_113 ( struct V_129 * V_130 , void * V_148 )
{
F_114 ( & V_88 . V_181 , 0 , V_183 , V_267 ) ;
return 0 ;
}
...
F_63 ( V_88 . V_87 [ V_272 ] ) ;
return V_271 ;
}
static T_6 int F_116 ( struct V_281 * V_282 )
{
struct V_206 * V_283 ;
struct V_54 * V_98 ;
...
V_271 = F_115 () ;
if ( V_271 ) {
F_117 ( V_56 -> V_156 , L_44 ) ;
return V_271 ;
}
V_271 = F_118 ( V_56 , & V_88 . V_181 ) ;
if ( V_271 ) {
F_117 ( V_56 -> V_156 , L_45 ) ;
return V_271 ;
}
while ( ( V_137 = F_119 ( V_282 , V_290 , V_285 ) ) ) {
for ( V_90 = V_137 -> V_291 ; V_90 <= V_137 -> V_292 ; V_90 ++ ) {
if ( F_120 ( V_90 , F_45 , V_293 ,
L_46 , ( void * )
...
V_209 = V_98 -> V_209 ;
V_283 = V_98 -> V_210 ;
V_88 . V_213 = F_62 ( sizeof( struct V_212 * ) * V_209 ,
V_140 ) ;
if ( V_88 . V_213 == NULL ) {
F_9 ( L_48 ) ;
V_271 = - V_141 ;
...
V_88 . V_213 [ V_90 ] = F_126 ( & V_88 . V_181 ,
V_287 ,
& V_283 [ V_90 ] . V_302 ,
NULL ) ;
if ( ! V_88 . V_213 [ V_90 ] ) {
...
F_131 ( V_33 -> V_221 , V_33 ) ;
V_271 = F_99 ( V_98 , V_33 , 0 ) ;
if ( V_271 )
goto V_305;
F_49 ( 1 , V_101 , L_50 ,
( int ) V_33 , ( int ) & V_33 -> V_221 ) ;
V_271 = F_132 ( V_33 -> V_221 ,
V_306 , ( V_272 ? 3 : 2 ) ) ;
if ( V_271 < 0 )
goto V_305;
}
...
V_137 = F_119 ( V_282 , V_290 , V_90 ) ;
for ( V_272 = V_137 -> V_291 ; V_272 <= V_137 -> V_292 ; V_272 ++ )
F_121 ( V_272 , ( void * ) ( & V_88 . V_87 [ V_90 ] -> V_39 ) ) ;
}
return V_271 ;
}
static int F_136 ( struct V_281 * V_307 )
{
struct V_32 * V_33 ;
int V_90 ;
F_135 ( & V_88 . V_181 ) ;
...
static int F_137 ( struct V_307 * V_87 )
{
struct V_7 * V_8 ;
struct V_32 * V_33 ;
int V_90 ;
...
static int F_139 ( struct V_307 * V_87 )
{
struct V_7 * V_8 ;
struct V_32 * V_33 ;
int V_90 ;
...
while ( ( V_137 = F_119 ( V_282 , V_290 , V_90 ) ) ) {
