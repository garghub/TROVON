...
return - V_68 ;
F_25 ( & V_13 -> V_16 ) ;
if ( ! V_7 || ! F_3 ( V_7 -> V_2 -> V_3 -> V_4 ) ) {
F_5 ( L_13 ) ;
V_42 = - V_5 ;
goto V_104;
}
V_13 -> V_105 = V_7 -> V_105 ;
V_13 -> V_71 = 0 ;
F_10 ( V_13 , V_59 ) ;
V_26 -> V_39 = V_13 ;
return 0 ;
...
static int F_51 ( struct V_154 * V_155 )
{
int V_156 ;
F_8 ( L_32 ) ;
V_7 = NULL ;
V_156 = F_52 ( & V_155 -> V_2 , & V_157 ) ;
if ( V_156 ) {
F_5 ( L_33 ) ;
return V_156 ;
}
V_156 = F_53 ( & V_155 -> V_2 ,
V_158 , F_54 ( V_158 ) ) ;
if ( V_156 ) {
F_5 ( L_34 ) ;
F_55 ( & V_155 -> V_2 ) ;
...
static int F_56 ( struct V_154 * V_155 )
{
F_57 ( & V_155 -> V_2 , F_54 ( V_158 ) ) ;
F_55 ( & V_155 -> V_2 ) ;
F_8 ( L_35 ) ;
return 0 ;
}
