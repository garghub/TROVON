...
V_2 -> V_5 = F_100 ( & V_34 -> V_35 , V_163 ) ;
if ( ! V_2 -> V_5 ) {
F_22 ( & V_34 -> V_35 , L_18 ) ;
error = - V_154 ;
goto V_172;
}
error = F_101 ( & V_34 -> V_35 , V_138 , F_80 ,
0 , L_19 , V_2 ) ;
if ( error ) {
F_22 ( & V_34 -> V_35 , L_20 ) ;
goto V_172;
}
if ( V_161 -> V_175 && F_84 ( V_2 ) )
F_53 ( & V_34 -> V_35 , L_21 ) ;
V_2 -> V_59 = F_102 ( L_22 ) ;
if ( ! V_2 -> V_59 ) {
F_22 ( & V_34 -> V_35 , L_23 ) ;
...
F_106 ( & V_34 -> V_35 , L_25 ,
( unsigned long ) V_163 -> V_174 , V_138 ) ;
return 0 ;
V_177:
F_107 ( V_2 -> V_59 ) ;
V_176:
...
static int T_7 F_110 ( struct V_158 * V_34 )
{
struct V_159 * V_32 = F_111 ( V_34 ) ;
