...
return V_13 ;
V_2 . V_7 = V_13 ;
if ( F_24 ( V_13 , & V_1 -> V_7 ) )
return - V_36 ;
}
V_3 = F_1 ( & V_2 ) ;
if ( V_3 )
return V_3 ;
return F_17 ( V_40 , & V_2 , V_13 , 1 ) ;
}
int F_25 ( struct V_8 * V_43 , int V_13 ,
struct V_1 V_37 * V_1 )
{
struct V_1 V_2 ;
if ( ! V_32 )
...
if ( F_19 ( & V_2 , V_1 , sizeof( V_2 ) ) )
return - V_36 ;
return F_17 ( V_43 , & V_2 , V_13 , 0 ) ;
}
int F_26 ( struct V_1 V_37 * V_1 )
{
struct V_1 V_2 ;
int V_13 , V_3 ;
if ( ! V_32 )
return - V_42 ;
if ( F_27 ( V_13 , & V_1 -> V_7 ) )
return - V_36 ;
V_3 = F_21 ( V_40 , & V_2 , V_13 ) ;
if ( V_3 < 0 )
goto V_30;
if ( F_28 ( V_1 , & V_2 , sizeof( V_2 ) ) )
V_3 = - V_36 ;
V_30:
return V_3 ;
}
int F_29 ( struct V_8 * V_43 , int V_13 ,
struct V_1 V_37 * V_1 )
{
struct V_1 V_2 ;
int V_3 ;
