...
{
V_77 * V_162 = F_52 ( V_159 -> V_163 . V_164 -> V_165 ) -> V_153 ;
T_1 V_35 = 0 ;
int V_10 , V_166 = 0 ;
for ( V_10 = 0 ; V_10 < V_11 ; V_10 ++ ) {
char V_167 ;
...
static int F_54 ( struct V_170 * V_170 , struct V_159 * V_159 )
{
return F_55 ( V_159 , F_49 , F_52 ( V_170 ) -> V_153 ) ;
}
int F_56 ( void )
{
T_2 V_10 ;
...
#ifdef F_57
char V_171 [ 20 ] ;
sprintf ( V_171 , V_172 , V_10 ) ;
V_173 [ V_10 ] = F_58 ( V_171 , 0660 , NULL ,
& V_174 ,
( void * ) ( V_21 + V_10 ) ) ;
if ( ! V_173 [ V_10 ] ) {
F_2 ( L_67 , V_24 ) ;
...
#endif
V_21 [ V_10 ] . V_169 = V_10 ;
V_21 [ V_10 ] . V_134 = 0 ;
V_21 [ V_10 ] . V_80 = V_114 ;
V_21 [ V_10 ] . V_33
= V_34 ;
F_60 ( & ( V_21 [ V_10 ] . V_149 ) ) ;
}
return 0 ;
}
void F_61 ( void )
