...
static int T_1 F_28 ( struct V_62 * V_63 ,
const struct V_64 * V_65 )
{
struct V_5 * V_6 = V_63 -> V_21 . V_66 ;
struct V_1 * V_2 ;
int V_3 ;
if ( ! F_29 ( V_63 -> V_67 , V_68 ) ) {
F_4 ( & V_63 -> V_21 , L_11 ) ;
return - V_69 ;
}
if ( V_6 == NULL ) {
...
V_2 = F_30 ( & V_63 -> V_21 , sizeof( struct V_1 ) ,
V_71 ) ;
if ( ! V_2 )
return - V_72 ;
V_2 -> V_6 = V_6 ;
V_2 -> V_21 = & V_63 -> V_21 ;
V_2 -> V_9 = F_31 ( V_63 , & V_73 ) ;
if ( F_25 ( V_2 -> V_9 ) ) {
V_3 = F_32 ( V_2 -> V_9 ) ;
F_4 ( & V_63 -> V_21 , L_13 ,
V_3 ) ;
