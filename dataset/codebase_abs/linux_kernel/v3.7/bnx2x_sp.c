...
memset ( V_105 , 0 , sizeof( * V_105 ) ) ;
V_105 -> V_664 = ( T_6 ) V_662 -> V_665 ;
V_105 -> V_666 = F_77 ( V_662 -> V_666 ) ;
V_105 -> V_667 = F_264 ( V_2 ) ;
V_105 -> V_668 = V_662 -> V_668 ;
return F_103 ( V_2 , V_669 , 0 ,
F_104 ( V_557 ) ,
F_105 ( V_557 ) , V_595 ) ;
}
...
return F_103 ( V_2 , V_682 , 0 ,
F_104 ( V_557 ) ,
F_105 ( V_557 ) , V_595 ) ;
}
static
inline int F_266 ( struct V_1 * V_2 ,
struct V_621 * V_399 )
{
struct V_618 * V_4 = V_399 -> V_643 ;
struct V_683 * V_105 =
...
return F_103 ( V_2 , V_692 , 0 ,
F_104 ( * V_687 ) , F_105 ( * V_687 ) ,
V_595 ) ;
}
static inline int F_267 ( struct V_1 * V_2 ,
struct V_621 * V_399 )
{
return F_103 ( V_2 , V_693 , 0 , 0 , 0 ,
V_595 ) ;
}
static inline int F_268 ( struct V_1 * V_2 ,
struct V_621 * V_399 )
{
return F_103 ( V_2 , V_694 , 0 , 0 , 0 ,
V_595 ) ;
}
...
for ( V_281 = 0 ; V_281 < F_270 ( V_105 -> V_702 ) ; V_281 ++ )
V_105 -> V_702 [ V_281 ] =
V_697 -> V_702 [ V_281 ] ;
return F_103 ( V_2 , V_703 , 0 ,
F_104 ( V_557 ) ,
F_105 ( V_557 ) , V_595 ) ;
}
