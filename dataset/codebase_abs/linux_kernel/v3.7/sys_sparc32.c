...
T_1 long F_35 ( T_5 V_71 , struct V_72 T_4 * V_73 )
{
struct V_74 V_75 ;
int V_76 ;
T_6 V_77 = F_36 () ;
F_37 ( V_78 ) ;
V_76 = F_38 ( V_71 , (struct V_74 T_4 * ) & V_75 ) ;
F_37 ( V_77 ) ;
if ( F_39 ( & V_75 , V_73 ) )
return - V_79 ;
return V_76 ;
}
T_1 long F_40 ( int V_80 ,
T_7 T_4 * V_81 ,
T_7 T_4 * V_82 ,
T_8 V_83 )
{
...
if ( F_43 ( V_82 , & V_85 , sizeof( T_7 ) ) )
return - V_79 ;
}
return 0 ;
}
T_1 long F_44 ( T_7 T_4 * V_81 ,
T_8 V_83 )
{
T_9 V_84 ;
T_7 V_85 ;
...
if ( F_43 ( V_81 , & V_85 , sizeof( T_7 ) ) )
return - V_79 ;
}
return V_76 ;
}
T_1 long F_46 ( int V_71 , int V_87 ,
...
return - V_79 ;
F_37 ( V_78 ) ;
V_76 = F_48 ( V_71 , V_87 , ( T_10 T_4 * ) & V_90 ) ;
F_37 ( V_77 ) ;
return V_76 ;
}
T_1 long F_49 ( int V_87 , struct V_91 T_4 * V_92 ,
...
T_11 V_97 ;
T_2 V_98 , V_99 ;
V_76 = F_51 ( V_98 , & V_92 -> V_100 ) ;
V_95 . V_101 . V_100 = F_3 ( V_98 ) ;
V_76 |= F_52 ( V_99 , & V_92 -> V_102 ) ;
V_95 . V_101 . V_102 = F_3 ( V_99 ) ;
V_76 |= F_52 ( V_95 . V_101 . V_103 , & V_92 -> V_103 ) ;
V_76 |= F_52 ( V_97 , & V_92 -> V_104 ) ;
if ( V_76 )
return V_76 ;
V_95 . V_105 = NULL ;
F_53 ( & V_95 . V_101 . V_104 , V_97 ) ;
}
V_76 = F_54 ( V_87 , V_92 ? & V_95 : NULL , V_93 ? & V_96 : NULL ) ;
if ( ! V_76 && V_93 ) {
V_76 = F_20 ( F_55 ( V_96 . V_101 . V_100 ) , & V_93 -> V_100 ) ;
V_76 |= F_56 ( F_55 ( V_96 . V_101 . V_102 ) , & V_93 -> V_102 ) ;
V_76 |= F_56 ( V_96 . V_101 . V_103 , & V_93 -> V_103 ) ;
V_76 |= F_56 ( V_96 . V_101 . V_104 . V_87 [ 0 ] , & V_93 -> V_104 ) ;
}
return V_76 ;
}
T_1 long F_57 ( int V_87 ,
...
V_76 = F_51 ( V_98 , & V_92 -> V_100 ) ;
V_95 . V_101 . V_100 = F_3 ( V_98 ) ;
V_76 |= F_58 ( & V_108 , & V_92 -> V_104 , sizeof( T_7 ) ) ;
switch ( V_86 ) {
...
V_76 = F_20 ( F_55 ( V_96 . V_101 . V_100 ) , & V_93 -> V_100 ) ;
V_76 |= F_59 ( & V_93 -> V_104 , & V_108 , sizeof( T_7 ) ) ;
V_76 |= F_56 ( V_96 . V_101 . V_103 , & V_93 -> V_103 ) ;
V_76 |= F_56 ( F_55 ( V_96 . V_101 . V_102 ) , & V_93 -> V_102 ) ;
if ( V_76 )
V_76 = - V_79 ;
...
T_1 long F_60 ( struct V_109 * V_110 )
{
int error , V_111 = 0 ;
struct V_65 * V_65 ;
if ( ( T_2 ) V_110 -> V_112 [ V_113 ] == 0 )
V_111 = 1 ;
V_65 = F_61 ( F_3 ( V_110 -> V_112 [ V_111 + V_114 ] ) ) ;
error = F_62 ( V_65 ) ;
if ( F_63 ( V_65 ) )
goto V_115;
error = F_64 ( V_65 -> V_116 ,
F_3 ( V_110 -> V_112 [ V_111 + V_117 ] ) ,
F_3 ( V_110 -> V_112 [ V_111 + V_118 ] ) , V_110 ) ;
F_65 ( V_65 ) ;
if ( ! error ) {
F_66 ( 0 ) ;
F_67 () -> V_119 [ 0 ] = 0 ;
...
T_1 long F_68 ( void T_4 * V_123 , T_2 V_124 ,
const char T_4 * V_125 )
{
return F_69 ( V_123 , V_124 , V_125 ) ;
}
T_1 long F_70 ( const char T_4 * V_126 ,
unsigned int V_127 )
{
return F_71 ( V_126 , V_127 ) ;
}
T_1 long F_68 ( const char T_4 * V_126 ,
struct V_128 T_4 * V_129 )
{
return - V_20 ;
}
T_1 long F_70 ( const char T_4 * V_126 )
...
T_1 T_12 F_72 ( unsigned int V_25 ,
char T_4 * V_130 ,
T_8 V_131 ,
unsigned long V_132 ,
unsigned long V_133 )
{
return F_73 ( V_25 , V_130 , V_131 , ( V_132 << 32 ) | V_133 ) ;
}
T_1 T_12 F_74 ( unsigned int V_25 ,
char T_4 * V_130 ,
T_8 V_131 ,
unsigned long V_132 ,
unsigned long V_133 )
{
return F_75 ( V_25 , V_130 , V_131 , ( V_132 << 32 ) | V_133 ) ;
}
T_1 long F_76 ( int V_25 ,
unsigned long V_134 ,
unsigned long V_135 ,
T_8 V_131 )
{
return F_77 ( V_25 , ( V_134 << 32 ) | V_135 , V_131 ) ;
}
long F_78 ( int V_25 ,
unsigned long V_134 ,
unsigned long V_135 ,
T_8 V_124 , int V_136 )
{
return F_79 ( V_25 , ( V_134 << 32 ) | V_135 , V_124 , V_136 ) ;
}
long F_80 ( int V_25 ,
...
T_1 long F_81 ( const char T_4 * V_65 ,
int V_127 , int V_35 )
{
return F_82 ( V_139 , V_65 , V_127 , V_35 ) ;
}
long F_83 ( unsigned long V_140 ,
unsigned long V_141 ,
char T_4 * V_142 , T_13 V_124 )
{
return F_84 ( ( V_140 << 32 ) | V_141 ,
V_142 , V_124 ) ;
}
long F_85 ( int V_25 , unsigned long V_143 , unsigned long V_144 , unsigned long V_145 , unsigned long V_146 , int V_127 )
{
return F_86 ( V_25 ,
( V_143 << 32 ) | V_144 ,
( V_145 << 32 ) | V_146 ,
...
T_1 long F_87 ( int V_25 , int V_35 , T_2 V_134 , T_2 V_135 ,
T_2 V_137 , T_2 V_138 )
{
return F_88 ( V_25 , V_35 , ( ( V_147 ) V_134 << 32 ) | V_135 ,
( ( V_147 ) V_137 << 32 ) | V_138 ) ;
}
