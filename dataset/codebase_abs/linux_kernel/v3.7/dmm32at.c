...
if ( V_36 -> V_48 == V_47 ) {
if ( V_36 -> V_55 > 0xfffffff0 ) {
V_36 -> V_55 = 0xfffffff0 ;
V_37 ++ ;
}
if ( V_36 -> V_55 == 0 ) {
V_36 -> V_55 = 1 ;
...
static void F_14 ( struct V_1 * V_2 , unsigned int V_59 )
{
...
static T_1 F_17 ( int V_85 , void * V_10 )
{
struct V_1 * V_2 = V_10 ;
struct V_75 * V_76 = V_2 -> V_77 ;
unsigned char V_86 ;
...
struct V_114 * V_115 )
{
const struct V_116 * V_117 = F_25 ( V_2 ) ;
struct V_75 * V_76 ;
int V_118 ;
struct V_3 * V_4 ;
unsigned char V_119 , V_120 , V_121 , V_122 , V_86 , V_123 ;
unsigned long V_19 ;
unsigned int V_85 ;
V_19 = V_115 -> V_124 [ 0 ] ;
V_85 = V_115 -> V_124 [ 1 ] ;
F_6 ( V_125 L_5 , V_2 -> V_126 ) ;
F_6 ( V_127 L_6 ,
V_19 , V_85 ) ;
if ( ! F_26 ( V_19 , V_128 , V_117 -> V_129 ) ) {
F_6 ( V_130 L_7 ,
V_2 -> V_126 ) ;
return - V_131 ;
}
...
F_27 ( 100 ) ;
V_120 = F_5 ( V_2 -> V_19 + V_21 ) ;
V_119 = F_5 ( V_2 -> V_19 + V_22 ) ;
V_121 = F_5 ( V_2 -> V_19 + V_134 ) ;
V_122 = F_5 ( V_2 -> V_19 + V_30 ) ;
V_86 = F_5 ( V_2 -> V_19 + V_74 ) ;
V_123 = F_5 ( V_2 -> V_19 + V_25 ) ;
F_6 ( V_127 L_8 ,
V_120 , V_119 , V_121 ) ;
F_6 ( V_127
L_9 ,
...
( V_122 != 0x60 || ( V_86 != 0x00 ) || V_123 != 0x0c ) ) {
F_6 ( V_130 L_10 ) ;
return - V_131 ;
}
if ( V_85 ) {
V_118 = F_28 ( V_85 , F_17 , 0 , V_117 -> V_129 , V_2 ) ;
if ( V_118 < 0 ) {
F_6 ( V_130 L_11 ) ;
return V_118 ;
}
...
V_2 -> V_135 = V_117 -> V_129 ;
if ( F_29 ( V_2 , sizeof( * V_76 ) ) < 0 )
return - V_136 ;
V_76 = V_2 -> V_77 ;
V_118 = F_30 ( V_2 , 3 ) ;
if ( V_118 )
