...
static int F_68 ( struct V_142 * V_143 , const struct V_1 * V_2 )
{
...
F_70 ( V_57 -> V_58 . V_59 ) , V_57 -> V_61 ,
( unsigned int ) V_57 -> V_117 ,
( unsigned long long ) F_71 ( & V_57 -> V_58 ) ) ;
return 0 ;
}
...
struct V_15 * V_16 = V_2 -> V_5 ;
if ( V_2 -> V_49 != V_144 &&
F_65 ( V_145 , & V_16 -> V_146 ) ) {
F_73 ( V_16 ) ;
F_74 ( V_16 ) ;
}
}
static int F_75 ( struct V_1 * V_2 , struct V_66 * V_67 )
{
struct V_15 * V_16 = V_2 -> V_5 ;
struct V_56 * V_57 = F_42 ( V_16 -> V_147 -> V_148 ) ;
struct V_1 * V_149 = V_57 -> V_150 ;
struct V_151 V_18 ;
int error ;
if ( F_65 ( V_145 , & V_16 -> V_146 ) ) {
V_149 -> V_152 -> V_153 ( V_149 , V_53 ) ;
error = F_76 ( V_16 -> V_147 , & V_18 ) ;
if ( error )
F_77 ( V_16 ) ;
if ( ! ( V_18 . V_154 & V_155 ) )
F_77 ( V_16 ) ;
if ( ! F_65 ( V_156 , & V_16 -> V_146 ) ) {
V_16 -> V_157 = V_18 . V_158 + 1 ;
F_78 ( V_16 , V_18 . V_159 ) ;
}
}
return 0 ;
}
