...
F_23 ( L_36
L_37
L_38 , V_75 -> V_47 , ( V_86 T_1 ) V_75 -> V_58 ,
...
V_34 -> V_78 = 0 ;
F_26 ( & V_17 -> V_88 ) ;
V_75 -> V_82 = F_22 ( V_17 -> V_83 ) ;
V_75 -> V_84 = F_22 ( V_17 -> V_85 ) ;
F_27 ( & V_17 -> V_88 ) ;
return 0 ;
}
static int F_28 ( struct V_11 * V_12 , struct V_33 * V_34 )
{
T_1 V_73 = 0 , V_37 ;
struct V_38 * V_39 ;
if ( F_29 ( V_12 , V_34 -> V_40 , V_89 ) < 0 )
return - 1 ;
V_39 = (struct V_38 * ) V_34 -> V_40 ;
V_37 = F_14 ( V_39 -> V_41 ) ;
F_23 ( L_39
...
V_39 -> V_91 , V_39 -> V_92 , V_37 ) ;
if ( F_13 ( V_12 , V_34 ) < 0 )
return - 1 ;
V_73 = ( ( - V_37 ) & 3 ) ;
memset ( V_34 -> V_93 , 0 , V_60 ) ;
if ( F_29 (
V_12 ,
V_34 -> V_93 ,
V_37 + V_73 ) < 0 )
...
! V_34 -> V_99 )
return 0 ;
if ( strncmp ( V_62 -> V_67 , V_31 , 4 ) && ! V_34 -> V_99 )
return 0 ;
if ( ( V_39 -> V_47 & V_100 ) &&
( V_39 -> V_47 & V_49 ) ) {
V_75 -> V_47 |= V_100 |
...
return 0 ;
V_109:
return F_35 ( V_12 , V_34 ) ;
}
static int F_43 ( struct V_11 * V_12 , struct V_33 * V_34 )
{
int V_104 ;
T_1 V_37 ;
struct V_38 * V_39 ;
...
static int F_44 ( struct V_11 * V_12 , struct V_33 * V_34 )
{
int V_114 = 0 ;
struct V_38 * V_39 ;
struct V_74 * V_75 ;
...
struct V_33 * V_34 )
{
char * V_122 = NULL , * V_123 = NULL , * V_124 = NULL ;
char * V_125 , * V_126 = NULL , * V_127 = NULL , * V_128 , * V_67 ;
struct V_16 * V_17 = V_12 -> V_17 ;
struct V_129 * V_130 ;
struct V_38 * V_39 ;
T_1 V_37 ;
...
V_34 -> V_132 = F_47 ( V_39 -> V_90 ) ;
V_34 -> V_59 = V_39 -> V_58 ;
V_34 -> V_95 = F_47 ( V_39 -> V_91 ) ;
V_34 -> V_92 = F_48 ( V_39 -> V_92 ) ;
V_34 -> V_79 = F_48 ( V_39 -> V_79 ) ;
if ( F_31 ( V_12 , V_34 ) < 0 )
return - 1 ;
V_125 = F_49 ( V_37 + 1 , V_133 ) ;
if ( ! V_125 ) {
F_4 ( L_62 ) ;
return - 1 ;
}
memcpy ( V_125 , V_34 -> V_93 , V_37 ) ;
V_125 [ V_37 ] = '\0' ;
V_126 = V_125 ;
V_127 = ( V_126 + V_37 ) ;
while ( V_126 < V_127 ) {
if ( F_50 ( V_126 , & V_128 , & V_67 ) < 0 ) {
V_104 = - 1 ;
goto V_134;
}
if ( ! strncmp ( V_128 , L_63 , 13 ) )
V_122 = V_67 ;
else if ( ! strncmp ( V_128 , L_64 , 11 ) )
V_123 = V_67 ;
else if ( ! strncmp ( V_128 , L_65 , 10 ) )
V_124 = V_67 ;
V_126 += strlen ( V_128 ) + strlen ( V_67 ) + 2 ;
}
if ( ! V_122 ) {
F_4 ( L_30
L_29 ) ;
...
F_23 ( L_72 , V_130 -> V_130 ) ;
V_12 -> V_136 = F_54 ( V_130 , V_121 ) ;
if ( ! V_12 -> V_136 ) {
F_4 ( L_73
L_74 , V_130 -> V_130 ) ;
F_55 ( V_130 ) ;
...
V_17 -> V_24 -> V_25 = 0 ;
V_17 -> V_26 -> V_22 = F_56 (
& V_12 -> V_136 -> V_140 , V_122 ) ;
if ( ! V_17 -> V_26 -> V_22 ) {
F_4 ( L_76
L_77 ,
V_122 , V_12 -> V_136 -> V_139 ) ;
F_15 ( V_12 , V_45 ,
V_141 ) ;
V_104 = - 1 ;
goto V_134;
...
{
struct V_33 * V_34 ;
V_34 = F_49 ( sizeof( struct V_33 ) , V_133 ) ;
if ( ! V_34 ) {
F_4 ( L_78 ) ;
F_15 ( V_12 , V_102 ,
V_143 ) ;
...
V_34 -> V_40 = F_58 ( V_142 , V_89 , V_133 ) ;
if ( ! V_34 -> V_40 ) {
F_4 ( L_79 ) ;
F_15 ( V_12 , V_102 ,
V_143 ) ;
