...
void
F_48 ( struct V_20 * V_21 , int V_90 , int V_206 )
{
struct V_12 * V_13 = V_21 -> V_13 ;
struct V_1 * V_2 = V_13 -> V_15 ;
struct V_11 * V_11 = F_25 ( V_21 ) ;
...
if ( F_50 ( args . V_156 . V_220 ) )
args . V_156 . V_221 = V_209 ;
else if ( F_42 ( V_21 , V_11 -> V_111 ) )
args . V_156 . V_221 = 8 ;
else
args . V_156 . V_221 = 4 ;
if ( F_50 ( args . V_156 . V_220 ) && ( V_208 == 270000 ) )
...
if ( F_50 ( args . V_218 . V_220 ) )
args . V_218 . V_221 = V_209 ;
else if ( F_42 ( V_21 , V_11 -> V_111 ) )
args . V_218 . V_221 = 8 ;
else
args . V_218 . V_221 = 4 ;
if ( F_50 ( args . V_218 . V_220 ) && ( V_208 == 270000 ) )
...
if ( V_21 -> V_247 ) {
struct V_248 * V_248 = F_51 ( V_21 -> V_247 ) ;
V_241 = V_248 -> V_241 ;
}
if ( V_213 == - 1 )
return;
...
bool
F_52 ( struct V_53 * V_89 , int V_90 )
{
struct V_177 * V_177 = F_46 ( V_89 ) ;
...
if ( F_50 ( args . V_156 . V_311 . V_220 ) ) {
if ( V_208 == 270000 )
...
if ( F_50 ( args . V_218 . V_312 . V_220 ) ) {
if ( V_208 == 270000 )
...
static void
F_56 ( struct V_20 * V_21 , bool V_322 )
{
struct V_12 * V_13 = V_21 -> V_13 ;
struct V_1 * V_2 = V_13 -> V_15 ;
struct V_11 * V_11 = F_25 ( V_21 ) ;
...
static void
F_57 ( struct V_20 * V_21 , int V_73 )
{
struct V_12 * V_13 = V_21 -> V_13 ;
struct V_1 * V_2 = V_13 -> V_15 ;
struct V_11 * V_11 = F_25 ( V_21 ) ;
...
F_55 ( V_21 , V_302 , V_344 ) ;
break;
}
}
static void
F_66 ( struct V_20 * V_21 , int V_73 )
{
struct V_12 * V_13 = V_21 -> V_13 ;
struct V_1 * V_2 = V_13 -> V_15 ;
struct V_11 * V_11 = F_25 ( V_21 ) ;
...
if ( V_302 )
F_65 ( V_21 , V_302 , V_73 ) ;
F_68 ( V_21 , ( V_73 == V_339 ) ? true : false ) ;
}
static void
...
if ( ( V_11 -> V_28 == V_92 ) ||
( V_11 -> V_28 == V_93 ) )
args . V_406 . V_407 = V_408 ;
else
args . V_406 . V_407 = V_409 ;
if ( V_177 -> V_25 & V_410 )
args . V_406 . V_411 = F_36 ( V_410 ) ;
else if ( V_177 -> V_25 & V_412 )
args . V_406 . V_411 = F_36 ( V_412 ) ;
else if ( V_177 -> V_25 & V_101 ) {
args . V_406 . V_411 = F_36 ( V_101 ) ;
if ( V_133 >= 3 )
args . V_406 . V_138 = V_413 ;
} else if ( V_177 -> V_25 & V_414 ) {
args . V_406 . V_411 = F_36 ( V_414 ) ;
if ( V_133 >= 3 )
args . V_406 . V_138 = V_413 ;
}
F_8 ( V_2 -> V_16 . V_35 , V_24 , ( V_36 * ) & args ) ;
...
if ( V_177 -> V_25 & V_414 ) {
if ( V_416 & ( V_425 | V_426 ) )
return V_421 ;
else if ( V_416 & ( V_427 | V_428 ) )
return V_421 ;
}
return V_429 ;
}
static enum V_415
F_84 ( struct V_20 * V_21 , struct V_53 * V_89 )
{
struct V_12 * V_13 = V_21 -> V_13 ;
struct V_1 * V_2 = V_13 -> V_15 ;
struct V_11 * V_11 = F_25 ( V_21 ) ;
...
struct V_22 * V_23 = V_11 -> V_27 ;
if ( V_23 ) {
V_23 -> V_213 = F_73 ( V_21 ) ;
if ( V_11 -> V_79 & V_87 ) {
if ( V_2 -> V_5 >= V_6 )
V_23 -> V_432 = V_2 -> V_16 . V_432 [ V_23 -> V_213 ] ;
else
V_23 -> V_432 = V_2 -> V_16 . V_432 [ 0 ] ;
}
}
}
F_87 ( V_21 , true ) ;
...
static void
F_97 ( struct V_20 * V_21 , int V_73 )
{
}
static bool F_98 ( struct V_20 * V_21 ,
const struct V_72 * V_73 ,
struct V_72 * V_74 )
{
return true ;
}
void F_99 ( struct V_20 * V_21 )
{
struct V_11 * V_11 = F_25 ( V_21 ) ;
if ( V_11 -> V_25 & ( V_26 ) )
F_22 ( V_11 ) ;
...
static struct V_81 *
F_101 ( struct V_11 * V_11 )
{
struct V_12 * V_13 = V_11 -> V_14 . V_13 ;
struct V_1 * V_2 = V_13 -> V_15 ;
struct V_81 * V_439 = F_102 ( sizeof( struct V_81 ) , V_57 ) ;
if ( ! V_439 )
return NULL ;
V_439 -> V_83 = F_103 ( V_2 ) ;
return V_439 ;
}
static struct V_22 *
...
struct V_22 * V_23 = F_102 ( sizeof( struct V_22 ) , V_57 ) ;
if ( ! V_23 )
return NULL ;
V_23 -> V_163 = true ;
V_23 -> V_213 = - 1 ;
...
V_11 = F_102 ( sizeof( struct V_11 ) , V_57 ) ;
if ( ! V_11 )
return;
V_21 = & V_11 -> V_14 ;
switch ( V_2 -> V_442 ) {
...
if ( V_11 -> V_25 & ( V_26 ) ) {
V_11 -> V_444 = V_449 ;
F_106 ( V_13 , V_21 , & V_450 , V_451 ) ;
V_11 -> V_27 = F_107 ( V_11 ) ;
} else {
F_106 ( V_13 , V_21 , & V_450 , V_452 ) ;
V_11 -> V_27 = F_104 ( V_11 ) ;
}
F_108 ( V_21 , & V_453 ) ;
break;
case V_92 :
F_106 ( V_13 , V_21 , & V_450 , V_454 ) ;
V_11 -> V_27 = F_101 ( V_11 ) ;
F_108 ( V_21 , & V_455 ) ;
break;
case V_95 :
case V_93 :
case V_96 :
F_106 ( V_13 , V_21 , & V_450 , V_456 ) ;
V_11 -> V_27 = F_101 ( V_11 ) ;
F_108 ( V_21 , & V_455 ) ;
break;
case V_69 :
