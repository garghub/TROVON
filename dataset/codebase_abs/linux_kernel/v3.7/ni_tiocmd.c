...
void F_31 ( struct V_1 * V_2 , int * V_68 ,
int * V_69 , int * V_70 ,
int * V_71 )
{
const unsigned short V_72 = F_32 ( V_2 ,
F_33
( V_2 ->
V_10 ) ) ;
const unsigned short V_73 = F_32 ( V_2 ,
F_34
( V_2 ->
V_10 ) ) ;
unsigned V_74 = 0 ;
