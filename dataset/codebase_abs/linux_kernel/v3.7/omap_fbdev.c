...
static void F_3 ( struct V_1 * V_2 , int V_97 , int V_98 , int V_99 , int V_100 )
{
struct V_32 * V_33 = F_14 ( V_2 ) ;
if ( ! V_33 )
return;
F_45 ( L_13 , V_97 , V_98 , V_99 , V_100 , V_2 ) ;
F_46 ( V_33 -> V_45 , V_97 , V_98 , V_99 , V_100 ) ;
}
