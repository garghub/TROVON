...
static T_4 int F_36 ( struct V_158 * V_159 ,
const struct V_160 * V_161 )
{
struct V_72 * V_73 ;
int V_12 ;
V_73 = F_37 ( & V_159 -> V_132 , sizeof( struct V_72 ) ,
V_162 ) ;
if ( V_73 == NULL )
return - V_163 ;
F_38 ( V_159 , V_73 ) ;
V_12 = F_39 ( & V_159 -> V_132 ,
& V_164 , & V_165 , 1 ) ;
return V_12 ;
}
static T_5 int F_40 ( struct V_158 * V_166 )
{
F_41 ( & V_166 -> V_132 ) ;
return 0 ;
}
