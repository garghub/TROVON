...
F_42 ( & V_65 -> V_20 , & V_7 -> V_31 ) ;
V_65 -> V_60 = false ;
V_77 = F_43 ( V_7 , V_65 , V_74 ) ;
if ( ! V_77 )
V_17 -> V_67 = V_68 ;
}
return;
}
static void F_47 ( unsigned long V_78 )
{
...
static T_3 F_48 ( int V_81 , void * V_82 )
{
struct V_6 * V_7 = V_82 ;
unsigned long V_41 ;
unsigned long V_18 ;
...
static enum V_67 F_55 ( struct V_9 * V_10 ,
...
static int F_58 ( struct V_9 * V_10 , enum V_98 V_99 ,
unsigned long V_100 )
{
switch ( V_99 ) {
case V_101 :
...
V_95 = F_62 ( V_7 , V_122 , & V_54 , & V_52 , & V_40 ,
& V_114 , & V_105 ) ;
if ( V_95 < 0 )
return NULL ;
F_64 ( & V_141 ) ;
...
V_56 |= F_61 ( V_7 , V_114 , V_105 , V_115 ) ;
V_17 -> V_97 += V_115 ;
V_28 -> V_50 . V_54 = V_54 ;
...
static int T_7 F_75 ( struct V_165 * V_166 )
{
struct V_167 * V_168 ;
struct V_1 * V_2 ;
int V_95 ;
...
V_2 = F_78 ( & V_166 -> V_16 , sizeof( * V_2 ) + V_170 -> V_177 *
...
V_2 -> V_153 = V_170 ;
F_79 ( V_166 , V_2 ) ;
V_168 = F_80 ( V_166 , V_180 , 0 ) ;
if ( ! V_168 ) {
F_18 ( & V_166 -> V_16 , L_31 ) ;
return - V_133 ;
}
V_2 -> V_5 = F_81 ( & V_166 -> V_16 , V_168 ) ;
if ( ! V_2 -> V_5 ) {
F_18 ( & V_166 -> V_16 ,
L_32 ) ;
return - V_181 ;
}
V_2 -> V_161 = F_82 ( & V_166 -> V_16 , NULL ) ;
if ( F_83 ( V_2 -> V_161 ) ) {
F_18 ( & V_166 -> V_16 , L_33 ) ;
return F_84 ( V_2 -> V_161 ) ;
}
F_85 ( & V_2 -> V_36 ) ;
F_86 ( & V_166 -> V_16 ) ;
if ( ! F_87 ( & V_166 -> V_16 ) ) {
V_95 = F_88 ( & V_166 -> V_16 ) ;
if ( V_95 ) {
...
F_74 ( V_2 -> V_161 ) ;
F_64 ( & V_2 -> V_185 . V_186 ) ;
for ( V_138 = 0 ; V_138 < V_170 -> V_177 ; V_138 ++ ) {
struct V_6 * V_7 = & V_2 -> V_186 [ V_138 ] ;
V_7 -> V_8 = V_187 +
V_138 * V_188 ;
V_168 = F_80 ( V_166 , V_189 , V_138 ) ;
if ( ! V_168 ) {
V_95 = - V_133 ;
F_18 ( & V_166 -> V_16 , L_35 , V_138 ) ;
goto V_190;
}
V_7 -> V_81 = V_168 -> V_191 ;
snprintf ( V_7 -> V_192 , sizeof( V_7 -> V_192 ) , L_36 , V_138 ) ;
V_95 = F_91 ( & V_166 -> V_16 , V_7 -> V_81 ,
F_48 , 0 , V_7 -> V_192 , V_7 ) ;
if ( V_95 ) {
F_18 ( & V_166 -> V_16 ,
L_37 ,
V_138 , V_95 ) ;
...
F_93 ( V_194 , V_2 -> V_185 . V_195 ) ;
F_93 ( V_196 , V_2 -> V_185 . V_195 ) ;
F_93 ( V_197 , V_2 -> V_185 . V_195 ) ;
V_2 -> V_185 . V_16 = & V_166 -> V_16 ;
V_2 -> V_185 . V_198 =
F_69 ;
V_2 -> V_185 . V_199 =
F_72 ;
V_2 -> V_185 . V_200 = F_63 ;
V_2 -> V_185 . V_201 = F_68 ;
V_2 -> V_185 . V_202 = F_58 ;
V_2 -> V_185 . V_203 = F_55 ;
V_2 -> V_185 . V_204 = F_53 ;
V_95 = F_94 ( & V_2 -> V_185 ) ;
if ( V_95 < 0 ) {
F_18 ( & V_166 -> V_16 ,
L_38 , V_95 ) ;
...
static int T_8 F_99 ( struct V_165 * V_166 )
{
struct V_1 * V_2 = F_100 ( V_166 ) ;
int V_138 ;
struct V_6 * V_7 ;
F_101 ( & V_2 -> V_185 ) ;
