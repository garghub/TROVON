...
int F_7 ( struct V_2 * V_16 , union V_22 * V_23 ,
T_4 V_24 , T_2 V_6 )
{
struct V_8 * V_9 ;
V_9 = F_16 ( struct V_8 , V_6 ) ;
if ( ! V_9 )
return - V_25 ;
...
V_9 -> V_29 = 1 ;
F_9 ( & V_9 -> V_19 ) ;
F_18 ( & V_9 -> V_19 , & V_16 -> V_13 ) ;
F_19 ( V_9 ) ;
return 0 ;
}
int F_20 ( struct V_2 * V_16 , union V_22 * V_30 )
{
struct V_8 * V_9 , * V_18 ;
int V_31 = 0 ;
F_10 (addr, temp, &bp->address_list, list) {
...
union V_22 * F_37 ( struct V_2 * V_16 ,
const union V_22 * V_69 ,
int V_70 ,
struct V_55 * V_56 )
{
struct V_8 * V_57 ;
...
( V_7 & V_76 ) &&
( V_7 & V_77 ) ) ) )
error = F_7 ( V_3 , V_9 , V_53 ,
V_6 ) ;
}
return error ;
}
int F_38 ( struct V_78 * V_79 , const union V_22 * V_9 )
{
...
int F_40 ( struct V_1 * V_1 , const union V_22 * V_9 , T_1 V_5 )
{
T_1 V_83 = F_41 ( V_9 ) ;
if ( V_84 == V_83 )
return 0 ;
...
struct V_2 * V_16 ;
struct V_8 * V_9 ;
V_16 = & F_43 ( V_79 ) -> V_92 -> V_93 . V_21 ;
if ( F_44 ( & V_16 -> V_13 ) ) {
V_9 = F_45 ( V_16 -> V_13 . V_94 ,
struct V_8 , V_19 ) ;
...
T_1 F_41 ( const union V_22 * V_9 )
{
struct V_43 * V_44 ;
V_44 = F_25 ( V_9 -> V_67 . V_68 ) ;
if ( ! V_44 )
return V_84 ;
return V_44 -> V_5 ( (union V_22 * ) V_9 ) ;
}
