...
{
struct V_1 * V_2 ;
V_2 = F_27 ( V_111 , struct V_1 , V_112 ) ;
F_23 ( V_2 ) ;
}
...
union V_115 * V_116 )
{
struct V_1 * V_2 = F_29 ( V_111 -> V_43 -> V_117 ) ;
int V_4 ;
int V_6 ;
switch ( V_114 ) {
case V_118 :
V_116 -> V_119 = V_2 -> V_41 ;
break;
case V_120 :
V_6 = F_25 ( V_2 , & V_4 ) ;
if ( V_6 )
...
static T_2 int F_31 ( struct V_130 * V_131 )
{
struct V_132 * V_133 = F_29 ( V_131 -> V_43 . V_117 ) ;
struct V_1 * V_2 ;
struct V_134 * V_135 ;
int V_6 ;
V_2 = F_32 ( & V_131 -> V_43 , sizeof( * V_2 ) , V_136 ) ;
if ( ! V_2 )
return - V_137 ;
V_2 -> V_138 = F_33 ( V_131 , 0 ) ;
if ( V_2 -> V_138 <= 0 ) {
F_34 ( & V_131 -> V_43 , L_16 ) ;
V_6 = - V_13 ;
goto V_20;
}
V_2 -> V_139 = F_33 ( V_131 , 1 ) ;
if ( V_2 -> V_139 <= 0 ) {
F_34 ( & V_131 -> V_43 , L_16 ) ;
V_6 = - V_13 ;
goto V_20;
...
V_2 -> V_133 = V_133 ;
V_2 -> V_7 =
( V_133 -> V_140 == V_141 ) ? V_133 -> V_142 : V_133 -> V_143 ;
V_2 -> V_43 = & V_131 -> V_43 ;
V_2 -> V_144 = V_145 ;
V_135 = V_131 -> V_43 . V_146 ;
F_35 ( & V_2 -> V_40 ) ;
F_36 ( V_131 , V_2 ) ;
F_19 ( V_2 ) ;
V_2 -> V_112 . V_147 = L_17 ;
V_2 -> V_112 . type = V_148 ;
V_2 -> V_112 . V_149 = V_150 ;
V_2 -> V_112 . V_151 = F_16 ( V_150 ) ;
V_2 -> V_112 . V_152 = F_28 ;
V_2 -> V_112 . V_153 = F_30 ;
V_2 -> V_112 . V_154 = F_26 ;
if ( V_135 && V_135 -> V_105 )
V_2 -> V_105 = V_135 -> V_105 ;
else
V_2 -> V_105 = 1500 ;
if ( V_135 && V_135 -> V_42 )
V_2 -> V_42 = V_135 -> V_42 ;
...
V_2 -> V_42 = 300 ;
V_6 = F_37 ( & V_131 -> V_43 , & V_2 -> V_112 ) ;
if ( V_6 )
goto V_20;
V_2 -> V_112 . V_43 -> V_117 = & V_131 -> V_43 ;
V_6 = F_38 ( V_2 -> V_138 , NULL ,
F_17 , V_155 ,
L_18 , V_2 ) ;
if ( V_6 < 0 ) {
F_34 ( V_133 -> V_43 , L_19 ,
V_2 -> V_138 , V_6 ) ;
goto V_156;
}
V_6 = F_38 ( V_2 -> V_139 , NULL , F_18 ,
V_155 , L_20 , V_2 ) ;
if ( V_6 < 0 ) {
F_34 ( V_133 -> V_43 , L_19 ,
V_2 -> V_139 , V_6 ) ;
...
static int T_3 F_42 ( struct V_130 * V_131 )
{
struct V_1 * V_2 = F_43 ( V_131 ) ;
F_40 ( & V_2 -> V_112 ) ;
F_39 ( V_2 -> V_139 , V_2 ) ;
F_39 ( V_2 -> V_138 , V_2 ) ;
F_41 ( V_2 ) ;
...
static int F_44 ( struct V_158 * V_43 )
{
struct V_130 * V_131 = F_45 ( V_43 ) ;
struct V_132 * V_133 = F_29 ( V_131 -> V_43 . V_117 ) ;
if ( F_46 ( V_43 ) )
V_133 -> V_159 |= 1 << V_160 ;
return 0 ;
}
static int F_47 ( struct V_158 * V_43 )
{
struct V_130 * V_131 = F_45 ( V_43 ) ;
struct V_132 * V_133 = F_29 ( V_131 -> V_43 . V_117 ) ;
if ( F_46 ( V_43 ) )
