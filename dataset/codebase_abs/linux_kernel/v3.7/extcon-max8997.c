...
F_29 ( & V_2 -> V_43 , F_12 ) ;
for ( V_47 = 0 ; V_47 < F_18 ( V_50 ) ; V_47 ++ ) {
struct V_70 * V_71 = & V_50 [ V_47 ] ;
int V_52 = 0 ;
V_52 = F_30 ( V_63 -> V_72 , V_71 -> V_51 ) ;
if ( ! V_52 )
goto V_73;
V_71 -> V_52 = V_52 ;
...
V_2 -> V_15 = F_26 ( sizeof( struct V_75 ) , V_67 ) ;
if ( ! V_2 -> V_15 ) {
F_3 ( & V_61 -> V_13 , L_20 ) ;
V_6 = - V_68 ;
goto V_73;
...
if ( V_66 -> V_80 ) {
struct V_81 * V_82 = V_2 -> V_80 ;
for ( V_47 = 0 ; V_47 < V_82 -> V_83 ; V_47 ++ ) {
F_33 ( V_2 -> V_8 , V_82 -> V_84 [ V_47 ] . V_85 ,
V_82 -> V_84 [ V_47 ] . V_58 ) ;
}
}
F_22 ( V_2 ) ;
