...
static int F_29 ( struct V_1 * V_2 , struct V_25 * V_26 )
{
struct V_8 * V_9 = V_2 -> V_10 ;
struct V_51 * V_52 = & V_26 -> V_53 -> V_52 ;
int V_4 ;
...
F_15 ( F_31 ( 2 , V_133 ) ,
V_9 -> V_42 + V_134 ) ;
F_32 ( V_9 -> V_42 + V_135 , 0 ,
2 , V_109 , 2 ) ;
F_15 ( F_31 ( 0 , V_136 ) ,
V_9 -> V_42 + V_134 ) ;
}
F_32 ( V_9 -> V_42 + V_135 , 0 , 0 , V_110 , 2 ) ;
}
switch ( V_52 -> V_58 ) {
case V_98 :
V_9 -> V_54 = 0 ;
...
static void
F_34 ( struct V_1 * V_2 , struct V_25 * V_26 ,
...
static T_1 F_35 ( int V_145 , void * V_146 )
{
...
* F_38 ( struct V_152 * V_152 )
{
int V_29 ;
for ( V_29 = 0 ; V_29 < F_39 ( V_153 ) ; V_29 ++ )
if ( V_152 -> V_154 == V_153 [ V_29 ] . V_155 )
return & V_153 [ V_29 ] ;
return NULL ;
}
static struct V_152 * F_40 ( struct V_1 * V_2 ,
struct V_156 * V_157 )
{
const struct V_6 * V_7 = F_2 ( V_2 ) ;
...
static void F_43 ( struct V_1 * V_2 , unsigned int V_145 )
{
struct V_152 * V_168 = F_44 ( V_2 ) ;
char V_169 [ 30 ] ;
if ( V_145 )
...
F_50 ( & V_9 -> V_40 ) ;
V_9 -> V_42 = F_51 ( V_152 , 2 ) ;
V_2 -> V_13 = F_51 ( V_152 , 3 ) ;
V_145 = V_152 -> V_145 ;
V_9 -> V_12 = F_52 ( sizeof( V_9 -> V_12 [ 0 ] ) *
V_7 -> V_172 , V_173 ) ;
if ( ! V_9 -> V_12 )
return - V_174 ;
V_9 -> V_77 = F_52 ( sizeof( V_9 -> V_77 [ 0 ] ) *
V_7 -> V_172 , V_173 ) ;
if ( ! V_9 -> V_77 )
return - V_174 ;
V_9 -> V_78 = F_52 ( sizeof( V_9 -> V_78 [ 0 ] ) *
V_7 -> V_172 , V_173 ) ;
if ( ! V_9 -> V_78 )
return - V_174 ;
V_9 -> V_41 = 0 ;
...
V_26 -> V_195 = V_195 =
F_52 ( sizeof( struct V_194 * ) * V_26 -> V_183 ,
V_173 ) ;
if ( ! V_26 -> V_195 )
return - V_174 ;
if ( V_159 ) {
...
static int F_56 ( struct V_1 * V_2 , struct V_156 * V_157 )
{
struct V_152 * V_152 ;
int V_171 ;
F_45 ( V_2 -> V_76 , V_124 L_18 ) ;
V_171 = F_57 ( V_2 , sizeof( struct V_8 ) ) ;
if ( V_171 < 0 ) {
F_22 ( V_2 -> V_76 , L_19 ) ;
return V_171 ;
}
V_152 = F_40 ( V_2 , V_157 ) ;
if ( ! V_152 )
return - V_209 ;
return F_47 ( V_2 , V_152 , V_157 -> V_159 ) ;
}
static int T_2
F_58 ( struct V_1 * V_2 , struct V_152 * V_152 )
{
int V_171 ;
F_45 ( V_2 -> V_76 , V_124 L_20 ,
F_46 ( V_152 ) ) ;
V_171 = F_57 ( V_2 , sizeof( struct V_8 ) ) ;
if ( V_171 < 0 ) {
F_22 ( V_2 -> V_76 , L_19 ) ;
...
static int T_2 F_65 ( struct V_152 * V_2 ,
const struct V_210
* V_211 )
{
return F_66 ( V_2 , & V_212 ) ;
}
static void T_3 F_67 ( struct V_152 * V_2 )
{
F_68 ( V_2 ) ;
}
