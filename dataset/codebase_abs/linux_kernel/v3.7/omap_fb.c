...
struct V_22 * V_88 , * V_89 ;
V_88 = ( V_6 < V_84 ) ? & V_86 -> V_17 [ V_6 ] : NULL ;
V_89 = ( V_6 < V_85 ) ? & V_87 -> V_17 [ V_6 ] : NULL ;
if ( V_88 ) {
F_24 ( V_81 , V_88 -> V_18 ) ;
V_88 -> V_38 = 0 ;
}
if ( V_89 && ! V_83 ) {
V_83 = F_26 ( V_89 -> V_18 , & V_89 -> V_38 , true ) ;
if ( ! V_83 )
F_27 ( V_89 -> V_18 , V_90 ) ;
}
}
...
struct V_22 * V_89 = & V_86 -> V_17 [ V_6 ] ;
if ( V_89 -> V_38 ) {
F_24 ( V_81 , V_89 -> V_18 ) ;
V_89 -> V_38 = 0 ;
}
...
struct V_82 * F_28 ( struct V_10 * V_11 , int V_91 )
{
struct V_15 * V_16 = F_4 ( V_11 ) ;
if ( V_91 >= F_7 ( V_11 -> V_9 ) )
return NULL ;
return V_16 -> V_17 [ V_91 ] . V_18 ;
}
struct V_92 * F_29 (
struct V_10 * V_11 , struct V_92 * V_93 )
{
struct V_94 * V_63 = V_11 -> V_63 ;
struct V_95 * V_96 = & V_63 -> V_97 . V_96 ;
struct V_92 * V_98 = V_93 ;
if ( ! V_93 ) {
return F_30 ( V_96 , F_31 ( * V_93 ) , V_99 ) ;
}
F_32 (connector, connector_list, head) {
if ( V_98 != V_93 ) {
struct V_100 * V_101 = V_98 -> V_101 ;
struct V_102 * V_103 = V_101 ? V_101 -> V_103 : NULL ;
if ( V_103 && V_103 -> V_11 == V_11 ) {
return V_98 ;
}
}
}
...
while ( ( V_98 = F_29 ( V_11 , V_98 ) ) ) {
if ( V_98 -> V_101 && V_98 -> V_101 -> V_103 ) {
struct V_102 * V_103 = V_98 -> V_101 -> V_103 ;
int V_104 = F_25 ( 0 , V_32 - V_103 -> V_32 ) ;
int V_105 = F_25 ( 0 , V_33 - V_103 -> V_33 ) ;
int V_106 = V_60 + ( V_32 - V_103 -> V_32 ) - V_104 ;
int V_107 = V_61 + ( V_33 - V_103 -> V_33 ) - V_105 ;
F_34 ( V_98 , V_104 , V_105 , V_106 , V_107 ) ;
}
}
}
void F_35 ( struct V_10 * V_11 , struct V_108 * V_109 )
{
struct V_15 * V_16 = F_4 ( V_11 ) ;
int V_6 , V_19 = F_7 ( V_11 -> V_9 ) ;
F_36 ( V_109 , L_4 , V_11 -> V_53 , V_11 -> V_55 ,
( char * ) & V_11 -> V_9 ) ;
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
F_36 ( V_109 , L_5 ,
V_6 , V_22 -> V_34 , V_22 -> V_36 ) ;
F_37 ( V_22 -> V_18 , V_109 ) ;
}
}
struct V_10 * F_38 ( struct V_94 * V_63 ,
struct V_12 * V_110 , struct V_111 * V_112 )
{
struct V_82 * V_113 [ 4 ] ;
struct V_10 * V_11 ;
int V_83 ;
V_83 = F_39 ( V_63 , V_110 , V_112 -> V_9 ,
V_113 , V_112 -> V_114 ) ;
if ( V_83 )
return F_40 ( V_83 ) ;
V_11 = F_41 ( V_63 , V_112 , V_113 ) ;
if ( F_42 ( V_11 ) ) {
int V_6 , V_19 = F_7 ( V_112 -> V_9 ) ;
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ )
F_10 ( V_113 [ V_6 ] ) ;
return V_11 ;
}
...
struct V_10 * F_41 ( struct V_94 * V_63 ,
struct V_111 * V_112 , struct V_82 * * V_113 )
{
struct V_15 * V_16 ;
struct V_10 * V_11 = NULL ;
const struct V_31 * V_31 = NULL ;
int V_83 , V_6 , V_19 = F_7 ( V_112 -> V_9 ) ;
F_8 ( L_6 ,
V_63 , V_112 , V_112 -> V_53 , V_112 -> V_55 ,
( char * ) & V_112 -> V_9 ) ;
for ( V_6 = 0 ; V_6 < F_2 ( V_7 ) ; V_6 ++ ) {
if ( V_7 [ V_6 ] . V_9 == V_112 -> V_9 ) {
V_31 = & V_7 [ V_6 ] ;
break;
}
}
...
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
int V_120 , V_36 = V_112 -> V_121 [ V_6 ] ;
if ( V_36 < ( V_112 -> V_53 * V_31 -> V_17 [ V_6 ] . V_35 ) ) {
F_17 ( V_63 -> V_63 , L_11 ,
V_36 , V_112 -> V_53 * V_31 -> V_17 [ V_6 ] . V_35 ) ;
V_83 = - V_115 ;
goto V_116;
}
V_120 = V_36 * V_112 -> V_55 / V_31 -> V_17 [ V_6 ] . V_37 ;
if ( V_120 > ( F_45 ( V_113 [ V_6 ] ) - V_112 -> V_122 [ V_6 ] ) ) {
F_17 ( V_63 -> V_63 , L_12 ,
V_113 [ V_6 ] -> V_120 - V_112 -> V_122 [ V_6 ] , V_120 ) ;
V_83 = - V_115 ;
goto V_116;
}
V_22 -> V_18 = V_113 [ V_6 ] ;
V_22 -> V_34 = V_112 -> V_122 [ V_6 ] ;
V_22 -> V_36 = V_36 ;
V_22 -> V_38 = 0 ;
}
F_46 ( V_11 , V_112 ) ;
