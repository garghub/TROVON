...
static int T_1 F_16 ( struct V_32 * V_33 )
{
int V_34 ;
struct V_35 * V_36 ;
struct V_37 * V_37 ;
struct V_1 * V_8 ;
V_8 = F_17 ( & V_33 -> V_16 , sizeof( * V_8 ) , V_38 ) ;
if ( ! V_8 ) {
F_18 ( & V_33 -> V_16 , L_2 ) ;
return - V_39 ;
}
...
static int T_2 F_28 ( struct V_32 * V_33 )
{
struct V_1 * V_8 = F_29 ( V_33 ) ;
F_10 ( & V_33 -> V_16 ) ;
F_30 ( & V_33 -> V_16 ) ;
return F_31 ( & V_8 -> V_3 ) ;
}
