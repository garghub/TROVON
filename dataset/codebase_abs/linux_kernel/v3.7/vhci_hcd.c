...
F_63 ( & V_63 -> V_86 ) ;
F_65 ( & V_63 -> V_92 ) ;
V_63 -> V_71 . V_134 . V_135 = F_55 ;
V_63 -> V_71 . V_134 . V_136 = F_60 ;
V_63 -> V_71 . V_134 . V_137 = F_61 ;
F_66 ( & V_63 -> V_71 ) ;
}
...
V_23 -> V_32 = V_140 ;
V_23 -> V_141 = 1 ;
V_138 = F_69 ( & F_70 ( V_26 ) -> V_142 , & V_143 ) ;
if ( V_138 ) {
F_19 ( L_57 ) ;
return V_138 ;
}
...
V_23 = F_81 ( & V_155 , & V_151 -> V_81 , F_82 ( & V_151 -> V_81 ) ) ;
if ( ! V_23 ) {
F_19 ( L_63 ) ;
return - V_121 ;
}
...
static int F_88 ( struct V_150 * V_151 , T_4 V_32 )
{
struct V_22 * V_23 ;
int V_9 = 0 ;
int V_157 = 0 ;
...
{
struct V_22 * V_23 ;
F_76 ( & V_151 -> V_81 , L_60 , V_147 ) ;
V_23 = F_86 ( V_151 ) ;
F_91 ( V_159 , & V_23 -> V_12 ) ;
F_7 ( V_23 ) ;
return 0 ;
}
