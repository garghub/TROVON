...
unsigned int V_64 ;
struct V_89 * V_125 ;
for ( V_64 = 0 ; V_64 < V_113 -> V_106 ; V_64 ++ ) {
V_125 = F_67 ( V_113 , V_64 ) ;
F_91 ( ! V_125 -> V_92 ) ;
F_88 ( V_125 -> V_92 , V_3 -> V_121 ) ;
V_125 -> V_92 = NULL ;
}
}
static struct V_109 * F_92 ( struct V_2 * V_3 ,
...
static void F_93 ( struct V_109 * V_110 )
{
F_79 ( & V_110 -> V_129 ) ;
}
...
static void F_98 ( struct V_75 * V_113 , int error )
{
struct V_109 * V_110 = V_113 -> V_130 ;
struct V_2 * V_3 = V_110 -> V_3 ;
unsigned V_131 = F_53 ( V_113 ) ;
if ( F_99 ( ! F_100 ( V_113 , V_132 ) && ! error ) )
error = - V_133 ;
if ( V_131 == V_69 )
F_90 ( V_3 , V_113 ) ;
F_89 ( V_113 ) ;
...
static int F_102 ( struct V_109 * V_110 , T_5 V_140 )
{
struct V_2 * V_3 = V_110 -> V_3 ;
struct V_75 * V_127 = V_110 -> V_127 ;
struct V_75 * V_113 ;
V_113 = F_103 ( V_127 , V_140 , V_3 -> V_45 ) ;
if ( ! V_113 )
return 1 ;
F_93 ( V_110 ) ;
F_86 ( V_110 , V_113 ) ;
...
static void F_105 ( struct V_109 * V_110 )
{
struct V_75 * V_113 = V_110 -> V_59 . V_76 ;
F_104 ( V_113 ) ;
}
static void F_106 ( struct V_143 * V_144 )
{
struct V_109 * V_110 = F_107 ( V_144 , struct V_109 , V_144 ) ;
if ( F_53 ( V_110 -> V_127 ) == V_134 ) {
F_93 ( V_110 ) ;
if ( F_102 ( V_110 , V_102 ) )
V_110 -> error = - V_44 ;
F_94 ( V_110 ) ;
} else
F_105 ( V_110 ) ;
...
{
struct V_2 * V_3 = V_110 -> V_3 ;
F_109 ( & V_110 -> V_144 , F_106 ) ;
F_110 ( V_3 -> V_145 , & V_110 -> V_144 ) ;
}
static void F_111 ( struct V_109 * V_110 , int V_146 )
{
struct V_75 * V_113 = V_110 -> V_59 . V_76 ;
struct V_2 * V_3 = V_110 -> V_3 ;
if ( F_99 ( V_110 -> error < 0 ) ) {
F_90 ( V_3 , V_113 ) ;
F_89 ( V_113 ) ;
F_94 ( V_110 ) ;
return;
}
F_91 ( V_110 -> V_59 . V_82 < V_113 -> V_106 ) ;
V_113 -> V_141 = V_3 -> V_142 + V_110 -> V_77 ;
if ( V_146 )
F_108 ( V_110 ) ;
else
...
if ( F_99 ( V_112 ) )
F_114 ( V_150 , V_151 / 100 ) ;
if ( F_99 ( ! V_148 && V_149 ) ) {
V_147 = F_92 ( V_110 -> V_3 , V_110 -> V_127 ,
V_77 ) ;
F_93 ( V_147 ) ;
...
struct V_109 * V_110 = F_107 ( V_59 , struct V_109 , V_59 ) ;
struct V_2 * V_3 = V_110 -> V_3 ;
if ( error == - V_108 ) {
F_117 ( & V_59 -> V_85 ) ;
return;
...
static void F_118 ( struct V_143 * V_144 )
{
struct V_109 * V_110 = F_107 ( V_144 , struct V_109 , V_144 ) ;
if ( F_53 ( V_110 -> V_127 ) == V_134 )
F_116 ( V_110 ) ;
...
static void F_101 ( struct V_109 * V_110 )
{
struct V_2 * V_3 = V_110 -> V_3 ;
F_109 ( & V_110 -> V_144 , F_118 ) ;
F_110 ( V_3 -> V_154 , & V_110 -> V_144 ) ;
}
static int F_119 ( T_1 * V_24 , char * V_155 , unsigned int V_111 )
{
char V_156 [ 3 ] ;
unsigned int V_64 ;
V_156 [ 2 ] = '\0' ;
...
static void F_121 ( char * V_155 , T_1 * V_24 , unsigned int V_111 )
{
unsigned int V_64 ;
for ( V_64 = 0 ; V_64 < V_111 ; V_64 ++ ) {
sprintf ( V_155 , L_13 , * V_24 ) ;
V_155 += 2 ;
V_24 ++ ;
}
}
...
goto V_159;
if ( V_3 -> V_25 && F_119 ( V_3 -> V_24 , V_24 , V_3 -> V_25 ) < 0 )
goto V_159;
...
goto V_174;
V_166 = V_165 ;
V_170 = F_143 ( & V_166 , L_14 ) ;
V_37 = F_143 ( & V_170 , L_16 ) ;
if ( ! V_170 )
V_3 -> V_54 = 1 ;
else if ( sscanf ( V_170 , L_17 , & V_3 -> V_54 , & V_173 ) != 1 ||
! F_144 ( V_3 -> V_54 ) ) {
V_35 -> error = L_18 ;
return - V_39 ;
}
...
if ( ! V_3 -> V_37 )
goto V_174;
V_167 = F_143 ( & V_166 , L_14 ) ;
V_169 = F_143 ( & V_166 , L_14 ) ;
V_168 = F_143 ( & V_169 , L_16 ) ;
if ( V_166 )
F_145 ( L_19 ) ;
...
if ( ! V_167 || ( ! strcmp ( V_167 , L_21 ) && ! V_168 ) ) {
V_167 = L_22 ;
V_168 = L_21 ;
}
if ( strcmp ( V_167 , L_23 ) && ! V_168 ) {
V_35 -> error = L_24 ;
return - V_39 ;
}
...
V_172 = - V_39 ;
if ( sscanf ( V_185 [ 2 ] , L_45 , & V_187 , & V_173 ) != 1 ) {
V_35 -> error = L_46 ;
goto V_42;
}
V_3 -> V_84 = V_187 ;
...
if ( sscanf ( V_185 [ 4 ] , L_45 , & V_187 , & V_173 ) != 1 ) {
V_35 -> error = L_48 ;
goto V_42;
}
V_3 -> V_142 = V_187 ;
...
struct V_109 * V_110 ;
struct V_2 * V_3 = V_35 -> V_161 ;
if ( F_99 ( V_75 -> V_139 & ( V_205 | V_206 ) ) ) {
V_75 -> V_136 = V_3 -> V_137 -> V_138 ;
if ( F_113 ( V_75 ) )
V_75 -> V_141 = V_3 -> V_142 + F_162 ( V_35 , V_75 -> V_141 ) ;
return V_207 ;
}
V_110 = F_92 ( V_3 , V_75 , F_162 ( V_35 , V_75 -> V_141 ) ) ;
if ( F_53 ( V_110 -> V_127 ) == V_134 ) {
if ( F_102 ( V_110 , V_208 ) )
F_108 ( V_110 ) ;
} else
F_101 ( V_110 ) ;
return V_209 ;
}
static int F_163 ( struct V_34 * V_35 , T_6 type ,
...
break;
case V_215 :
F_164 ( L_55 , V_3 -> V_164 ) ;
if ( V_3 -> V_25 > 0 ) {
if ( ( V_212 - V_213 ) < ( ( V_3 -> V_25 << 1 ) + 1 ) )
return - V_44 ;
F_121 ( V_211 + V_213 , V_3 -> V_24 , V_3 -> V_25 ) ;
V_213 += V_3 -> V_25 << 1 ;
} else {
if ( V_213 >= V_212 )
return - V_44 ;
...
if ( V_3 -> V_96 && V_3 -> V_96 -> V_219 ) {
V_172 = V_3 -> V_96 -> V_219 ( V_3 ) ;
if ( V_172 )
return V_172 ;
}
return F_131 ( V_3 ) ;
...
static int F_171 ( struct V_34 * V_35 , struct V_220 * V_221 ,
struct V_89 * V_222 , int V_223 )
{
struct V_2 * V_3 = V_35 -> V_161 ;
struct V_224 * V_225 = F_172 ( V_3 -> V_137 -> V_138 ) ;
if ( ! V_225 -> V_226 )
return V_223 ;
V_221 -> V_136 = V_3 -> V_137 -> V_138 ;
V_221 -> V_141 = V_3 -> V_142 + F_162 ( V_35 , V_221 -> V_141 ) ;
return F_173 ( V_223 , V_225 -> V_226 ( V_225 , V_221 , V_222 ) ) ;
}
static int F_174 ( struct V_34 * V_35 ,
T_7 V_227 , void * V_57 )
{
struct V_2 * V_3 = V_35 -> V_161 ;
return V_227 ( V_35 , V_3 -> V_137 , V_3 -> V_142 , V_35 -> V_119 , V_57 ) ;
}
