...
struct V_40 T_3 * F_46 ( const char * V_76 , int V_77 ,
struct V_33 * V_34 , void * V_78 ,
int V_79 ,
struct V_11 * V_14 ,
int V_22 , int V_80 )
{
...
if ( ! V_34 )
return F_45 ( - V_52 ) ;
return F_47 ( V_76 , V_77 , V_69 , 1 , V_78 ,
V_79 , V_14 , V_22 ,
V_80 ) ;
}
struct V_40 T_3 * F_47 ( const char * V_76 , int V_77 ,
struct V_33 * * V_69 , int V_46 ,
void * V_78 , int V_79 ,
struct V_11 * V_14 ,
int V_22 , int V_80 )
...
if ( V_8 -> V_82 != - 1 )
F_49 ( & V_8 -> V_9 , L_23 , V_8 -> V_56 , V_8 -> V_82 ) ;
else
F_49 ( & V_8 -> V_9 , L_24 , V_8 -> V_56 ) ;
V_2 = F_24 ( V_8 , V_69 , V_46 , V_14 , V_22 ) ;
if ( F_11 ( V_2 ) )
goto V_83;
V_47 = F_50 ( V_8 , V_78 , V_79 ) ;
if ( V_47 )
goto V_84;
if ( V_80 )
V_47 = F_51 ( V_8 ) ;
...
static int F_56 ( struct V_86 * V_9 )
{
struct V_40 * V_8 = F_30 ( V_9 ) ;
int V_47 ;
V_47 = F_57 ( V_9 ) ;
...
static int F_59 ( struct V_86 * V_9 )
{
return F_60 ( V_9 ) ;
}
static int F_61 ( struct V_86 * V_9 )
{
struct V_40 * V_8 = F_30 ( V_9 ) ;
F_62 ( V_8 ) ;
return F_63 ( V_9 ) ;
}
static int F_64 ( struct V_86 * V_9 )
{
struct V_40 * V_8 = F_30 ( V_9 ) ;
...
static int F_67 ( struct V_86 * V_9 )
{
struct V_40 * V_8 = F_30 ( V_9 ) ;
struct V_1 * V_2 = F_32 ( V_8 ) ;
if ( ( V_2 -> V_20 & V_89 ) &&
...
if ( V_2 -> V_90 != V_96 )
return 0 ;
else if ( V_98 > V_2 -> V_15 )
V_47 = F_7 ( V_2 , V_95 ) ;
else if ( V_98 < V_2 -> V_15 )
V_47 = F_1 ( V_2 , V_95 ) ;
return V_47 ;
}
struct V_99 * F_77 ( struct V_1 * V_2 )
{
if ( ! V_2 -> V_67 )
return NULL ;
...
struct V_86 * F_81 ( const char * V_45 )
{
struct V_33 * V_34 ;
if ( ! V_45 ) {
F_82 ( 1 , L_28 , V_74 ) ;
...
static int T_3 F_94 ( struct V_86 * V_9 , void * V_102 )
{
struct V_40 * V_8 = F_30 ( V_9 ) ;
struct V_1 * V_2 = F_32 ( V_8 ) ;
if ( ! V_2 )
