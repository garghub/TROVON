...
V_9 = V_31 -> V_106 ;
V_115 = F_76 ( & V_112 -> V_112 ) ;
if ( V_115 && V_31 -> V_105 ) {
F_77 ( V_115 , V_9 , V_31 -> V_105 ) ;
F_78 ( V_115 ) ;
}
F_79 ( V_115 ) ;
if ( V_112 -> V_116 -> V_18 != - V_117 ) {
V_85 = F_28 ( V_112 -> V_116 , V_47 ) ;
if ( V_85 )
F_19 ( & V_112 -> V_12 , L_26 , V_85 ) ;
}
}
static void F_80 ( struct V_31 * V_31 )
{
struct V_118 * V_119 ;
struct V_114 * V_115 ;
int V_18 = V_31 -> V_18 ;
...
static int F_85 ( struct V_114 * V_115 , struct V_111 * V_112 )
{
struct V_7 * V_8 ;
struct V_31 * V_31 ;
struct V_118 * V_119 ;
...
F_87 ( V_8 -> V_12 , V_112 -> V_116 -> V_13 ) ;
for ( V_132 = 0 ; V_132 < V_134 ; ++ V_132 ) {
V_31 = F_36 ( 0 , V_88 ) ;
V_119 -> V_135 [ V_132 ] = V_31 ;
if ( V_31 == NULL ) {
F_6 ( & V_112 -> V_12 , L_29 ) ;
continue;
}
...
L_30 ,
V_41 ) ;
F_14 ( V_119 -> V_135 [ V_132 ] ) ;
V_119 -> V_135 [ V_132 ] = NULL ;
continue;
}
V_131 ++ ;
}
...
F_19 ( & V_112 -> V_12 , L_31 , V_119 , V_9 ) ;
...
V_119 -> V_143 = 0x03 ;
F_3 ( V_8 , V_130 , V_144 , V_119 -> V_143 ) ;
V_119 -> V_145 = 0x0b ;
F_3 ( V_8 , V_130 , V_146 , V_119 -> V_145 ) ;
...
V_129 = F_28 ( V_112 -> V_116 , V_88 ) ;
if ( V_129 )
F_6 ( & V_112 -> V_12 , L_32 ,
V_41 , V_129 ) ;
memset ( & ( V_119 -> V_149 ) , 0x00 , sizeof( V_119 -> V_149 ) ) ;
V_119 -> V_145 = V_150 ;
V_119 -> V_120 = 1 ;
return 0 ;
}
...
{
struct V_111 * V_112 = V_115 -> V_151 ;
int V_152 ;
int V_153 = 0 ;
struct V_118 * V_119 ;
V_119 = F_86 ( V_112 ) ;
...
return;
for ( V_132 = 0 ; V_132 < V_134 ; ++ V_132 )
F_90 ( V_119 -> V_135 [ V_132 ] ) ;
for ( V_132 = 0 ; V_132 < V_134 ; ++ V_132 ) {
if ( V_119 -> V_135 [ V_132 ] ) {
F_12 ( V_119 -> V_135 [ V_132 ] -> V_106 ) ;
F_14 ( V_119 -> V_135 [ V_132 ] ) ;
}
}
F_90 ( V_112 -> V_133 ) ;
...
static void F_91 ( struct V_114 * V_115 , int V_154 )
{
struct V_111 * V_112 = V_115 -> V_151 ;
unsigned char V_9 ;
struct V_7 * V_8 ;
...
static int F_92 ( struct V_114 * V_115 )
{
struct V_111 * V_112 = V_115 -> V_151 ;
struct V_118 * V_119 ;
int V_156 = 0 ;
...
static int F_93 ( struct V_114 * V_115 , struct V_111 * V_112 ,
...
if ( F_99 ( V_115 ) ) {
unsigned char V_162 = F_100 ( V_115 ) ;
V_18 = F_93 ( V_115 , V_112 , & V_162 , 1 ) ;
if ( V_18 <= 0 )
return;
}
if ( V_115 -> V_163 . V_164 & V_165 ) {
V_119 -> V_145 &= ~ V_166 ;
...
if ( F_99 ( V_115 ) ) {
unsigned char V_167 = F_102 ( V_115 ) ;
V_18 = F_93 ( V_115 , V_112 , & V_167 , 1 ) ;
if ( V_18 <= 0 )
return;
}
if ( V_115 -> V_163 . V_164 & V_165 ) {
...
V_119 -> V_143 = V_119 -> V_143 | V_171 ;
F_3 ( V_8 , V_137 , V_144 , V_119 -> V_143 ) ;
...
static void F_107 ( struct V_114 * V_115 ,
struct V_118 * V_119 ,
struct V_180 * V_181 )
{
struct V_111 * V_112 ;
...
V_186 = 0x00 ;
V_185 = 0x00 ;
V_182 = V_115 -> V_163 . V_164 ;
V_183 = V_115 -> V_163 . V_188 ;
switch ( V_182 & V_189 ) {
case V_190 :
V_184 = V_191 ;
V_70 = 0x1f ;
...
V_18 = F_106 ( V_119 , V_168 ) ;
if ( V_182 & V_204 )
F_112 ( V_115 , V_168 , V_168 ) ;
F_3 ( V_8 , V_130 , V_141 , 0x0c ) ;
if ( V_112 -> V_116 -> V_18 != - V_117 ) {
V_18 = F_28 ( V_112 -> V_116 , V_47 ) ;
if ( V_18 )
...
V_115 -> V_163 . V_164 , F_114 ( V_115 -> V_163 . V_188 ) ) ;
F_19 ( & V_112 -> V_12 , L_56 , V_41 ,
V_181 -> V_164 , F_114 ( V_181 -> V_188 ) ) ;
F_107 ( V_115 , V_119 , V_181 ) ;
if ( V_112 -> V_116 -> V_18 != - V_117 ) {
V_18 = F_28 ( V_112 -> V_116 , V_47 ) ;
if ( V_18 )
F_19 ( & V_112 -> V_12 , L_53 , V_18 ) ;
...
struct V_118 * V_119 , unsigned int T_5 * V_17 )
{
struct V_111 * V_112 = V_115 -> V_151 ;
unsigned int V_98 = 0 ;
unsigned char V_9 = 0 ;
...
static int F_117 ( struct V_114 * V_115 )
{
struct V_111 * V_112 = V_115 -> V_151 ;
struct V_118 * V_119 = F_86 ( V_112 ) ;
unsigned int V_98 = 0 ;
...
static int F_118 ( struct V_114 * V_115 ,
...
static int F_119 ( struct V_114 * V_115 ,
struct V_228 * V_149 )
{
struct V_111 * V_112 = V_115 -> V_151 ;
struct V_118 * V_119 ;
...
static int F_120 ( struct V_118 * V_119 , unsigned int V_242 ,
...
if ( V_119 == NULL )
return - 1 ;
V_112 = (struct V_111 * ) V_119 -> V_112 ;
V_211 = V_119 -> V_145 ;
...
V_35 . type = V_248 ;
V_35 . line = V_119 -> V_112 -> V_8 -> V_138 ;
V_35 . V_112 = V_119 -> V_112 -> V_137 ;
V_35 . V_249 = 0 ;
...
static int F_123 ( struct V_114 * V_115 ,
...
return F_115 ( V_115 , V_119 ,
( unsigned int T_5 * ) V_243 ) ;
case V_244 :
case V_245 :
F_19 ( & V_112 -> V_12 , L_61 , V_41 ) ;
return F_120 ( V_119 , V_242 ,
( unsigned int T_5 * ) V_243 ) ;
case V_259 :
