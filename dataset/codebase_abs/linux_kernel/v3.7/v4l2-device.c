...
V_36 = F_30 ( V_4 -> V_41 , V_20 -> V_41 , NULL ) ;
if ( V_36 ) {
...
F_41 ( V_46 , V_20 ) ;
F_42 ( V_46 -> V_11 , V_20 -> V_11 , sizeof( V_46 -> V_11 ) ) ;
V_46 -> V_4 = V_4 ;
V_46 -> V_52 = & V_53 ;
V_46 -> V_14 = F_35 ;
V_46 -> V_41 = V_20 -> V_41 ;
V_36 = F_43 ( V_46 , V_54 , - 1 , 1 ,
V_20 -> V_37 ) ;
if ( V_36 < 0 ) {
F_37 ( V_46 ) ;
goto V_51;
...
#if F_23 ( V_33 )
V_20 -> V_35 . V_55 . V_56 . V_57 = V_58 ;
V_20 -> V_35 . V_55 . V_56 . V_59 = V_46 -> V_59 ;
#endif
V_20 -> V_47 = V_46 ;
}
return 0 ;
