...
static void V_74 ( struct V_14 * V_14 )
{
F_57 ( V_14 ) ;
F_59 ( V_14 ) ;
F_62 ( V_14 ) ;
...
unsigned long V_92 [ V_45 ] = { 0 } ;
unsigned long V_21 = V_3 >> V_31 ;
V_36 = F_85 ( V_57 ) ;
if ( ! V_36 )
return NULL ;
F_86 ( V_57 , V_36 ) ;
F_87 ( V_57 , V_91 , V_21 , V_92 ) ;
F_2 ( & V_85 ) ;
F_78 ( V_36 , NULL ) ;
F_6 ( & V_85 ) ;
return V_36 ;
...
{
return F_98 ( V_14 ) && F_99 ( V_14 ) >= V_96 ;
}
static struct V_14 * F_100 ( struct V_14 * V_14 )
{
F_9 ( F_58 ( V_14 ) & ( V_97 - 1 ) ) ;
if ( F_97 ( V_14 ) ) {
int V_98 ;
V_98 = F_99 ( V_14 ) ;
if ( ( V_98 < V_99 ) && ( V_98 >= V_96 ) )
return V_14 + ( 1 << V_98 ) ;
}
return V_14 + V_97 ;
}
...
struct V_14 * V_100 = V_14 + V_39 ;
for (; V_14 < V_100 ; V_14 = F_100 ( V_14 ) ) {
if ( ! F_102 ( V_14 ) )
return 0 ;
F_103 () ;
}
...
V_37 += V_101 ) {
V_25 = 0 ;
while ( ( V_25 < V_101 ) && ! F_105 ( V_37 + V_25 ) )
V_25 ++ ;
if ( V_25 == V_101 )
continue;
V_14 = F_68 ( V_37 + V_25 ) ;
...
static int
F_108 ( unsigned long V_21 , unsigned long V_38 )
{
unsigned long V_37 ;
struct V_14 * V_14 ;
int V_102 = V_103 ;
...
int V_59 = 0 ;
F_109 ( V_105 ) ;
for ( V_37 = V_21 ; V_37 < V_38 && V_102 > 0 ; V_37 ++ ) {
if ( ! F_32 ( V_37 ) )
continue;
V_14 = F_68 ( V_37 ) ;
if ( ! F_110 ( V_14 ) )
...
static int
F_122 ( unsigned long V_3 , unsigned long V_39 ,
void * V_110 )
{
F_123 ( V_3 , V_3 + V_39 ) ;
return 0 ;
...
static int
F_125 ( unsigned long V_21 , unsigned long V_39 ,
void * V_110 )
{
int V_59 ;
long V_111 = * ( long * ) V_110 ;
V_59 = F_126 ( V_21 , V_21 + V_39 ) ;
V_111 = V_39 ;
if ( ! V_59 )
* ( long * ) V_110 += V_111 ;
return V_59 ;
...
static long
F_127 ( unsigned long V_21 , unsigned long V_38 )
{
long V_111 = 0 ;
int V_59 ;
V_59 = F_75 ( V_21 , V_38 - V_21 , & V_111 ,
F_125 ) ;
if ( V_59 < 0 )
V_111 = ( long ) V_59 ;
return V_111 ;
}
static int T_2 F_128 ( unsigned long V_21 ,
unsigned long V_38 , unsigned long V_112 )
{
unsigned long V_37 , V_39 , V_113 ;
long V_114 ;
int V_59 , V_115 , V_116 , V_40 ;
struct V_42 * V_42 ;
struct V_81 V_78 ;
F_9 ( V_21 >= V_38 ) ;
if ( ! F_129 ( V_21 , V_97 ) )
...
F_135 () ;
F_134 () ;
V_114 = F_127 ( V_21 , V_38 ) ;
if ( V_114 < 0 ) {
V_59 = - V_62 ;
goto V_119;
}
F_11 ( V_125 L_5 , V_114 ) ;
F_124 ( V_21 , V_38 ) ;
F_136 ( V_21 , V_38 , V_117 ) ;
V_42 -> V_87 -= V_114 ;
V_42 -> V_56 -> F_71 -= V_114 ;
V_76 -= V_114 ;
F_80 () ;
if ( ! F_74 ( V_42 ) ) {
F_137 ( V_42 ) ;
...
int F_140 ( unsigned long V_21 , unsigned long V_39 )
{
return F_128 ( V_21 , V_21 + V_39 , 120 * V_128 ) ;
}
int F_141 ( T_1 V_3 , T_1 V_4 )
{
...
( V_24 <= V_130 -> V_133 ) )
continue;
V_130 = F_144 ( V_131 , V_130 ) ;
if ( ! V_130 )
continue;
V_59 = F_145 ( V_130 ) ;
if ( V_59 ) {
F_146 ( & V_130 -> V_134 . V_135 ) ;
return V_59 ;
}
}
if ( V_130 )
