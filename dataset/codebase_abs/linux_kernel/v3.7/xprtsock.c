...
static inline void F_137 ( int V_220 , struct V_36 * V_37 )
{
switch ( V_220 ) {
case V_17 :
F_131 ( V_37 ) ;
...
struct V_54 * V_54 ;
struct V_277 * V_4 ;
F_132 ( V_276 > V_278 - sizeof( struct V_277 ) ) ;
V_54 = F_167 ( V_21 ) ;
if ( ! V_54 )
return NULL ;
V_4 = F_168 ( V_54 ) ;
...
struct V_285 * V_286 ;
T_1 V_64 ;
F_2 ( L_83 , F_11 ( V_82 -> V_168 ) ) ;
V_8 = V_82 -> V_78 -> V_287 ;
V_286 = F_27 ( V_8 , struct V_285 , V_288 ) ;
if ( ! F_175 ( & V_8 -> V_289 ) ) {
F_176 ( & V_8 -> V_290 , V_74 , NULL ) ;
if ( ! F_175 ( & V_8 -> V_289 ) )
return - V_84 ;
F_177 ( & V_8 -> V_290 , V_74 ) ;
}
...
static struct V_7 * F_183 ( struct V_298 * args ,
unsigned int V_299 ,
unsigned int V_300 )
{
struct V_7 * V_8 ;
...
V_8 = F_184 ( args -> V_303 , sizeof( * V_301 ) , V_299 ,
V_300 ) ;
if ( V_8 == NULL ) {
F_2 ( L_86
L_87 ) ;
...
V_8 -> V_38 = args -> V_38 ;
if ( args -> V_215 )
memcpy ( & V_301 -> V_215 , args -> V_215 , args -> V_38 ) ;
else {
int V_57 ;
V_57 = F_181 ( args -> V_305 -> V_16 ,
(struct V_6 * ) & V_301 -> V_215 ) ;
if ( V_57 != 0 ) {
F_60 ( V_8 ) ;
return F_140 ( V_57 ) ;
}
...
switch ( V_9 -> V_16 ) {
case V_22 :
if ( ( (struct V_11 * ) V_9 ) -> V_326 != F_189 ( 0 ) )
F_129 ( V_8 ) ;
F_186 ( & V_76 -> V_124 ,
F_151 ) ;
F_15 ( V_8 , L_91 , V_327 ) ;
break;
case V_25 :
if ( ( (struct V_12 * ) V_9 ) -> V_328 != F_189 ( 0 ) )
F_129 ( V_8 ) ;
F_186 ( & V_76 -> V_124 ,
F_151 ) ;
F_15 ( V_8 , L_91 , V_329 ) ;
...
static struct V_7 * F_190 ( struct V_298 * args )
{
struct V_6 * V_9 = args -> V_305 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
...
static struct V_7 * F_191 ( struct V_298 * args )
{
struct V_6 * V_9 = args -> V_305 ;
struct V_7 * V_8 ;
struct V_75 * V_76 ;
...
if ( ! V_345 )
return - V_259 ;
V_83 = F_202 ( V_345 , 0 , & V_350 ) ;
if ( V_83 == - V_259 || V_350 < V_348 || V_350 > V_349 )
return - V_259 ;
* ( ( unsigned int * ) V_347 -> V_176 ) = V_350 ;
return 0 ;
}
static int F_203 ( const char * V_345 , const struct V_346 * V_347 )
{
return F_201 ( V_345 , V_347 ,
V_351 ,
V_352 ) ;
}
static int F_204 ( const char * V_345 ,
const struct V_346 * V_347 )
{
return F_201 ( V_345 , V_347 ,
V_353 ,
...
static int F_205 ( const char * V_345 ,
const struct V_346 * V_347 )
{
return F_201 ( V_345 , V_347 ,
V_353 ,
