...
int F_15 ( struct V_5 * V_6 , struct V_7 * V_8 ,
int (* V_13) ( int , int , int , unsigned long ) ,
unsigned long V_4 )
{
struct V_9 * V_10 ;
V_10 = F_16 ( sizeof( * V_10 ) , V_58 ) ;
if ( ! V_10 )
return - V_59 ;
V_10 -> V_4 = V_4 ;
...
void F_18 ( struct V_5 * V_6 , struct V_7 * V_8 )
{
F_19 ( V_8 -> V_11 ) ;
}
...
V_8 = & V_6 -> V_82 [ V_76 ] ;
V_4 = V_75 -> V_79 [ V_76 ] ;
if ( ! F_23 ( V_4 , V_83 , L_1 ) ) {
F_21 ( V_6 -> V_80 ,
L_3 , V_4 ) ;
V_8 -> type = V_84 ;
} else {
V_70 = F_15 ( V_6 , V_8 , NULL , V_4 ) ;
if ( V_70 )
return V_70 ;
F_24 ( V_6 -> V_80 , L_4 , V_4 ) ;
}
}
return 0 ;
}
