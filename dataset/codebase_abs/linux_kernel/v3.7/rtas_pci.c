...
int F_14 ( struct V_1 * V_5 , int V_3 , int V_6 , T_1 V_7 )
{
unsigned long V_9 , V_10 ;
int V_11 ;
if ( ! V_5 )
...
if ( V_5 && V_5 -> V_15 == V_15
&& F_13 ( V_2 ) )
return F_14 ( V_5 , V_3 , V_6 , V_7 ) ;
}
return V_12 ;
}
static int F_16 ( struct V_23 * V_30 )
{
const char * V_31 = F_17 ( V_30 , L_1 , NULL ) ;
if ( V_31 && strstr ( V_31 , L_2 ) )
return 1 ;
return 0 ;
}
static void F_18 ( struct V_23 * V_30 )
{
struct V_32 V_33 ;
void T_2 * V_34 ;
volatile T_1 V_7 ;
...
V_34 = F_21 ( V_33 . V_36 & ~ ( 0xfffffUL ) , 0x100000 ) ;
#define F_22 0x00010000
V_7 = F_23 ( V_34 + 0xf6030 ) ;
if ( V_7 & F_22 ) {
F_20 ( V_37 L_4 ) ;
V_7 &= ~ F_22 ;
F_24 ( V_34 + 0xf6030 , V_7 ) ;
V_7 = F_23 ( V_34 + 0xf6030 ) ;
F_20 ( L_5 , V_7 ) ;
}
F_25 ( V_34 ) ;
...
unsigned long T_4 F_28 ( struct V_23 * V_16 )
{
struct V_32 V_38 ;
if ( V_17 == - 1 )
return 0 ;
...
static int F_29 ( struct V_23 * V_30 ,
struct V_39 * V_16 )
{
const int * V_40 ;
unsigned int V_41 ;
V_40 = F_17 ( V_30 , L_10 , & V_41 ) ;
