...
if ( ! F_37 ( V_49 -> V_53 , V_27 ) )
F_11 ( V_2 , V_49 -> V_53 ) ;
if ( ! F_37 ( V_3 , V_27 ) )
F_11 ( V_2 , V_3 ) ;
return F_28 ( V_2 , V_49 , V_3 ) ;
}
int F_38 ( struct V_1 * V_2 , struct V_20 * V_49 ,
struct V_3 * V_3 )
{
if ( F_34 ( V_49 ) + F_35 ( V_3 ) >
F_36 ( V_49 ) ) {
...
if ( ! F_37 ( V_3 , V_27 ) )
F_11 ( V_2 , V_3 ) ;
if ( ! F_37 ( V_49 -> V_3 , V_27 ) )
F_11 ( V_2 , V_49 -> V_3 ) ;
return F_28 ( V_2 , V_49 , V_3 ) ;
}
static int F_39 ( struct V_1 * V_2 , struct V_20 * V_49 ,
struct V_20 * V_54 )
{
int V_55 ;
unsigned int V_11 =
...
if ( V_55 > F_30 ( V_2 ) )
return 0 ;
if ( F_40 ( V_49 ) && F_41 ( V_2 , V_49 , V_54 ) )
return 0 ;
V_49 -> V_22 = V_55 ;
return 1 ;
}
...
{
unsigned int V_57 = V_21 -> V_39 & V_58 ;
struct V_3 * V_3 ;
if ( V_21 -> V_39 & V_59 )
return;
...
static void F_44 ( struct V_20 * V_49 )
{
if ( F_45 ( V_49 ) ) {
struct V_61 * V_62 ;
int V_63 ;
...
static int F_52 ( struct V_1 * V_2 , struct V_20 * V_49 ,
struct V_20 * V_54 )
{
if ( ! F_53 ( V_49 ) || ! F_53 ( V_54 ) )
return 0 ;
if ( ! F_54 ( V_49 -> V_39 , V_54 -> V_39 ) )
return 0 ;
if ( F_55 ( V_49 ) + F_34 ( V_49 ) != F_55 ( V_54 ) )
return 0 ;
if ( F_49 ( V_49 ) != F_49 ( V_54 )
|| V_49 -> V_64 != V_54 -> V_64
|| V_54 -> V_56 )
return 0 ;
if ( V_49 -> V_39 & V_65 &&
! F_56 ( V_49 -> V_3 , V_54 -> V_3 ) )
return 0 ;
if ( ! F_39 ( V_2 , V_49 , V_54 ) )
return 0 ;
if ( ( V_49 -> V_39 | V_54 -> V_39 ) & V_59 ||
( V_49 -> V_39 & V_58 ) !=
( V_54 -> V_39 & V_58 ) ) {
F_42 ( V_49 ) ;
F_42 ( V_54 ) ;
}
if ( F_57 ( V_49 -> V_66 , V_54 -> V_66 ) )
V_49 -> V_66 = V_54 -> V_66 ;
...
F_58 ( V_2 , V_49 , V_54 ) ;
F_44 ( V_54 ) ;
V_49 -> V_68 = F_59 ( V_49 -> V_68 , V_54 -> V_68 ) ;
if ( F_60 ( V_54 ) )
V_49 -> V_63 = V_54 -> V_63 ;
V_54 -> V_3 = NULL ;
F_61 ( V_2 , V_54 ) ;
...
{
struct V_20 * V_54 = F_63 ( V_2 , V_21 ) ;
if ( V_54 )
return F_52 ( V_2 , V_21 , V_54 ) ;
return 0 ;
}
int F_64 ( struct V_1 * V_2 , struct V_20 * V_21 )
{
struct V_20 * V_69 = F_65 ( V_2 , V_21 ) ;
if ( V_69 )
return F_52 ( V_2 , V_69 , V_21 ) ;
return 0 ;
}
...
bool F_67 ( struct V_20 * V_21 , struct V_3 * V_3 )
{
if ( ! F_53 ( V_21 ) || ! F_68 ( V_3 ) )
return false ;
if ( ! F_54 ( V_21 -> V_39 , V_3 -> V_60 ) )
return false ;
if ( F_69 ( V_3 ) != F_49 ( V_21 ) )
return false ;
if ( V_21 -> V_64 != V_3 -> V_70 -> V_71 || V_21 -> V_56 )
return false ;
if ( F_31 ( V_3 ) != F_40 ( V_21 ) )
return false ;
if ( V_21 -> V_39 & V_65 &&
! F_56 ( V_21 -> V_3 , V_3 ) )
return false ;
...
int F_70 ( struct V_20 * V_21 , struct V_3 * V_3 )
{
if ( F_55 ( V_21 ) + F_34 ( V_21 ) == V_3 -> V_72 )
return V_73 ;
else if ( F_55 ( V_21 ) - F_35 ( V_3 ) == V_3 -> V_72 )
return V_74 ;
return V_75 ;
}
