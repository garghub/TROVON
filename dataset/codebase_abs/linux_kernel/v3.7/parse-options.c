...
if ( ! V_52 )
return V_60 ;
fprintf ( V_63 , L_21 , * V_52 ++ ) ;
while ( * V_52 && * * V_52 )
fprintf ( V_63 , L_22 , * V_52 ++ ) ;
while ( * V_52 ) {
fprintf ( V_63 , L_23 ,
* * V_52 ? L_24 : L_12 ,
* V_52 ) ;
...
fputc ( '\n' , V_63 ) ;
if ( * V_61 -> V_66 )
fprintf ( V_63 , L_25 , V_61 -> V_66 ) ;
continue;
}
if ( ! V_62 && ( V_61 -> V_4 & V_67 ) )
continue;
V_64 = fprintf ( V_63 , L_24 ) ;
if ( V_61 -> V_6 )
V_64 += fprintf ( V_63 , L_26 , V_61 -> V_6 ) ;
else
V_64 += fprintf ( V_63 , L_24 ) ;
if ( V_61 -> V_8 && V_61 -> V_6 )
V_64 += fprintf ( V_63 , L_27 ) ;
if ( V_61 -> V_8 )
V_64 += fprintf ( V_63 , L_28 , V_61 -> V_8 ) ;
switch ( V_61 -> type ) {
case V_27 :
break;
case V_32 :
...
if ( V_61 -> V_4 & V_35 )
if ( V_61 -> V_8 )
V_64 += fprintf ( V_63 , L_29 ) ;
else
V_64 += fprintf ( V_63 , L_30 ) ;
else
V_64 += fprintf ( V_63 , L_31 ) ;
break;
case V_19 :
if ( V_61 -> V_4 & V_20 )
break;
...
if ( V_61 -> V_4 & V_35 )
if ( V_61 -> V_8 )
V_64 += fprintf ( V_63 , L_32 , V_61 -> V_68 ) ;
else
V_64 += fprintf ( V_63 , L_33 , V_61 -> V_68 ) ;
else
V_64 += fprintf ( V_63 , L_34 , V_61 -> V_68 ) ;
} else {
if ( V_61 -> V_4 & V_35 )
if ( V_61 -> V_8 )
V_64 += fprintf ( V_63 , L_35 ) ;
else
V_64 += fprintf ( V_63 , L_36 ) ;
else
V_64 += fprintf ( V_63 , L_37 ) ;
}
break;
default:
case V_26 :
...
fprintf ( V_63 , L_38 , V_65 + V_70 , L_12 , V_61 -> V_66 ) ;
}
fputc ( '\n' , V_63 ) ;
return V_60 ;
}
...
const struct V_1 * V_61 )
{
return F_15 ( V_52 , V_61 , 0 ) ;
}
int F_21 ( const struct V_1 * V_2 ,
const char * V_11 V_71 ,
int V_17 )
{
int * V_72 = V_2 -> V_34 ;
if ( V_17 )
