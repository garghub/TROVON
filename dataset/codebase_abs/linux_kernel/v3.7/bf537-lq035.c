...
V_110 . type = V_132 ;
V_110 . V_133 = V_134 ;
V_135 = F_80 ( L_18 , NULL , NULL ,
& V_136 , & V_110 ) ;
V_137 = F_81 ( V_53 , & V_108 -> V_11 , NULL ,
& V_138 ) ;
if ( F_82 ( V_137 ) ) {
F_3 ( L_19 ) ;
V_8 = F_83 ( V_137 ) ;
...
static int T_2 F_89 ( struct V_107 * V_108 )
{
if ( V_38 != NULL )
F_87 ( NULL , V_114 , V_38 , 0 ) ;
if ( V_117 )
...
static int F_94 ( struct V_107 * V_108 , T_7 V_141 )
{
if ( V_64 > 0 ) {
F_36 ( 0 ) ;
F_11 () ;
