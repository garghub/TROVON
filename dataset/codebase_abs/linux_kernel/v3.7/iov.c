...
if ( ! V_8 || ( V_37 > 1 && ! V_9 ) )
return - V_69 ;
F_44 ( V_2 , V_30 + V_96 , & V_90 ) ;
V_18 = V_97 > 12 ? V_97 - 12 : 0 ;
V_90 &= ~ ( ( 1 << V_18 ) - 1 ) ;
if ( ! V_90 )
return - V_69 ;
V_90 &= ~ ( V_90 - 1 ) ;
F_66 ( V_2 , V_30 + V_98 , V_90 ) ;
V_75 = 0 ;
for ( V_18 = 0 ; V_18 < V_33 ; V_18 ++ ) {
V_24 = V_2 -> V_23 + V_34 + V_18 ;
V_18 += F_67 ( V_2 , V_99 , V_24 ,
V_30 + V_100 + V_18 * 4 ) ;
if ( ! V_24 -> V_36 )
continue;
if ( F_21 ( V_24 ) & ( V_101 - 1 ) ) {
V_12 = - V_69 ;
goto V_89;
}
...
V_26 -> V_90 = V_90 ;
V_26 -> V_61 = V_2 ;
F_44 ( V_2 , V_30 + V_103 , & V_26 -> V_49 ) ;
F_69 ( V_2 , V_30 + V_104 , & V_26 -> V_84 ) ;
if ( F_63 ( V_2 ) == V_91 )
V_26 -> V_84 = F_70 ( F_71 ( V_2 -> V_6 ) , V_26 -> V_84 ) ;
if ( V_76 )
V_26 -> V_2 = F_26 ( V_76 ) ;
else
V_26 -> V_2 = V_2 ;
...
if ( V_70 & V_87 )
return;
for ( V_18 = V_34 ; V_18 <= V_105 ; V_18 ++ )
F_76 ( V_2 , V_18 ) ;
F_66 ( V_2 , V_26 -> V_30 + V_98 , V_26 -> V_90 ) ;
...
int F_81 ( struct V_1 * V_2 , int V_107 ,
enum V_108 * type )
{
if ( V_107 < V_34 || V_107 > V_105 )
return 0 ;
F_11 ( ! V_2 -> V_86 ) ;
* type = V_99 ;
return V_2 -> V_7 -> V_30 + V_100 +
4 * ( V_107 - V_34 ) ;
}
T_5 F_82 ( struct V_1 * V_2 , int V_107 )
{
struct V_23 V_109 ;
enum V_108 type ;
int V_110 = F_81 ( V_2 , V_107 , & type ) ;
if ( ! V_110 )
return 0 ;
F_67 ( V_2 , type , & V_109 , V_110 ) ;
return F_83 ( & V_109 ) ;
}
...
int F_86 ( struct V_1 * V_2 , int V_48 )
{
F_87 () ;
if ( ! V_2 -> V_86 )
return - V_85 ;
