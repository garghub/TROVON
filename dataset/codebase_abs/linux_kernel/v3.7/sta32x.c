...
if ( ! ( V_24 -> V_43 -> V_126 & V_127 ) )
V_118 |= V_128 ;
if ( ! ( V_24 -> V_43 -> V_126 & V_129 ) )
V_118 |= V_130 ;
F_30 ( V_12 , V_40 ,
V_128 | V_130 ,
V_118 ) ;
...
static bool F_42 ( struct V_141 * V_61 , unsigned int V_142 )
{
switch ( V_142 ) {
case V_40 ... V_143 :
case V_144 ... V_145 :
...
static T_2 int F_43 ( struct V_146 * V_147 ,
const struct V_148 * V_149 )
{
struct V_23 * V_24 ;
int V_107 , V_15 ;
V_24 = F_44 ( & V_147 -> V_61 , sizeof( struct V_23 ) ,
V_150 ) ;
if ( ! V_24 )
return - V_151 ;
for ( V_15 = 0 ; V_15 < F_22 ( V_24 -> V_117 ) ; V_15 ++ )
V_24 -> V_117 [ V_15 ] . V_152 = V_153 [ V_15 ] ;
V_107 = F_45 ( & V_147 -> V_61 , F_22 ( V_24 -> V_117 ) ,
V_24 -> V_117 ) ;
if ( V_107 != 0 ) {
F_24 ( & V_147 -> V_61 , L_13 , V_107 ) ;
return V_107 ;
}
V_24 -> V_34 = F_46 ( V_147 , & V_154 ) ;
if ( F_47 ( V_24 -> V_34 ) ) {
V_107 = F_48 ( V_24 -> V_34 ) ;
F_24 ( & V_147 -> V_61 , L_14 , V_107 ) ;
return V_107 ;
}
F_49 ( V_147 , V_24 ) ;
V_107 = F_50 ( & V_147 -> V_61 , & V_155 , & V_156 , 1 ) ;
if ( V_107 != 0 )
F_24 ( & V_147 -> V_61 , L_15 , V_107 ) ;
return V_107 ;
}
static T_3 int F_51 ( struct V_146 * V_157 )
{
F_52 ( & V_157 -> V_61 ) ;
return 0 ;
}
