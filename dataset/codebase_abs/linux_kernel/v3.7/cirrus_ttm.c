...
V_9 -> V_85 = F_37 ( F_21 ( V_65 -> V_66 , 0 ) ,
F_38 ( V_65 -> V_66 , 0 ) ,
V_86 ) ;
V_9 -> V_87 = true ;
return 0 ;
...
F_41 ( V_9 -> V_85 ,
F_21 ( V_65 -> V_66 , 0 ) ,
F_38 ( V_65 -> V_66 , 0 ) , V_86 ) ;
V_9 -> V_85 = - 1 ;
}
}
void F_18 ( struct V_27 * V_28 , int V_88 )
{
T_2 V_89 = 0 ;
V_28 -> V_51 . V_90 = 0 ;
V_28 -> V_51 . V_91 = 0 ;
...
if ( V_88 & V_94 )
V_28 -> V_92 [ V_89 ++ ] = V_45 | V_44 | V_94 ;
if ( V_88 & V_50 )
V_28 -> V_92 [ V_89 ++ ] = V_37 | V_50 ;
if ( ! V_89 )
V_28 -> V_92 [ V_89 ++ ] = V_37 | V_50 ;
V_28 -> V_51 . V_95 = V_89 ;
V_28 -> V_51 . V_96 = V_89 ;
}
int F_42 ( struct V_27 * V_28 , bool V_97 )
{
int V_79 ;
V_79 = F_43 ( & V_28 -> V_28 , true , V_97 , false , 0 ) ;
if ( V_79 ) {
if ( V_79 != - V_98 )
F_9 ( L_7 , V_28 ) ;
return V_79 ;
...
int F_46 ( struct V_80 * V_65 , int V_15 , int V_99 ,
T_1 V_34 , struct V_27 * * V_100 )
{
struct V_1 * V_9 = V_65 -> V_101 ;
struct V_27 * V_49 ;
T_3 V_102 ;
int V_79 ;
...
F_18 ( V_49 , V_94 | V_50 ) ;
V_102 = F_48 ( & V_9 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_79 = F_49 ( & V_9 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_105 , & V_49 -> V_51 ,
V_99 >> V_61 , 0 , false , NULL , V_102 ,
NULL , F_12 ) ;
if ( V_79 )
return V_79 ;
* V_100 = V_49 ;
...
F_18 ( V_28 , V_106 ) ;
for ( V_108 = 0 ; V_108 < V_28 -> V_51 . V_95 ; V_108 ++ )
V_28 -> V_92 [ V_108 ] |= V_110 ;
...
V_116 = V_53 -> V_118 ;
V_9 = V_116 -> V_119 -> V_65 -> V_101 ;
return F_59 ( V_53 , V_114 , & V_9 -> V_4 . V_5 ) ;
}
