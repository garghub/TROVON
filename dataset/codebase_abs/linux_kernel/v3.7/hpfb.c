...
static int T_2 F_20 ( struct V_97 * V_98 , const struct V_99 * V_100 )
{
unsigned long V_101 , V_102 ;
V_101 = V_98 -> V_103 . V_104 ;
if ( ! F_21 ( V_98 -> V_103 . V_104 , F_22 ( & V_98 -> V_103 ) , V_98 -> V_105 ) )
return - V_106 ;
if ( V_98 -> V_107 >= V_108 ) {
V_102 = ( unsigned long ) F_23 ( V_101 , F_22 ( & V_98 -> V_103 ) ) ;
} else {
V_102 = V_101 + V_109 ;
}
F_15 ( V_85 L_6
L_7 , V_98 -> V_107 , ( V_98 -> V_87 >> 8 ) & 0xff ) ;
if ( F_12 ( V_101 , V_102 ) ) {
if ( V_98 -> V_107 >= V_108 )
F_19 ( ( void * ) V_102 ) ;
return - V_110 ;
...
static void T_3 F_24 ( struct V_97 * V_98 )
{
F_25 ( & V_6 ) ;
if ( V_98 -> V_107 >= V_108 )
F_19 ( ( void * ) V_14 ) ;
F_26 ( V_98 -> V_103 . V_104 , F_22 ( & V_98 -> V_103 ) ) ;
F_18 ( & V_6 . V_12 ) ;
if ( V_6 . V_93 )
F_19 ( V_6 . V_93 ) ;
}
...
V_112 = F_32 () ;
F_33 ( V_118 ) ;
V_114 = F_34 ( V_113 , ( unsigned char * ) F_28 + V_119 ) ;
F_33 ( V_112 ) ;
if ( ! V_114 && ( V_113 == V_120 ) && F_35 ( V_111 = F_13 ( F_28 ) ) ) {
if ( ! F_21 ( F_29 , V_121 , L_9 ) )
return - V_106 ;
F_15 ( V_85 L_10 , V_111 ) ;
if ( F_12 ( F_29 , F_28 ) ) {
return - V_110 ;
}
}
