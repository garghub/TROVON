...
if ( F_13 ( ! ( ( V_156 [ 0 ] ^ V_156 [ 2 ] ) | ( V_156 [ 1 ] ^ V_156 [ 3 ] ) ) ||
...
enum V_166 V_37 )
{
for (; V_165 > 0 ; V_164 = F_74 ( V_164 ) ) {
unsigned V_167 = F_75 ( V_165 , V_164 -> V_168 ) ;
struct V_30 * V_169 ;
T_2 V_170 ;
void * V_171 ;
V_165 -= V_167 ;
V_171 = F_76 ( F_77 ( V_164 ) ) + V_164 -> V_172 ;
V_169 = F_56 ( V_38 , V_22 , & V_170 ) ;
if ( ! V_169 ) {
V_31 = NULL ;
break;
}
F_78 ( V_164 ) = F_79 ( V_2 , V_171 , V_167 , V_37 ) ;
V_31 -> V_34 = V_169 ;
V_31 -> V_35 = V_170 ;
V_31 = V_169 ;
V_31 -> V_74 = F_78 ( V_164 ) ;
V_31 -> V_36 = V_167 ;
V_31 -> V_37 = V_37 ;
}
V_31 -> V_34 = NULL ;
...
static int F_80 ( struct V_173 * V_9 , const T_3 * V_116 ,
unsigned int V_117 )
{
...
F_54 ( & V_55 -> V_50 ) ;
F_54 ( & V_55 -> V_78 ) ;
V_55 -> V_50 . V_106 = V_174 ;
V_55 -> V_78 . V_106 = V_174 ;
...
static int F_84 ( struct V_173 * V_9 , const T_3 * V_116 ,
unsigned int V_117 )
{
struct V_54 * V_55 = F_81 ( V_9 ) ;
if ( V_117 < V_177 )
return - V_154 ;
memcpy ( V_55 -> V_178 , V_116 + ( V_117 - V_177 ) ,
V_177 ) ;
V_117 -= V_177 ;
...
{
struct V_173 * V_9 = F_86 ( V_41 ) ;
struct V_54 * V_55 = F_81 ( V_9 ) ;
unsigned V_179 = F_87 ( V_9 ) ;
struct V_104 * V_37 ;
struct V_3 * V_39 ;
unsigned int V_165 = V_41 -> V_165 ;
enum V_166 V_180 = V_181 ;
struct V_67 * V_45 = F_25 ( V_41 ) ;
struct V_30 V_182 ;
T_4 V_22 = V_41 -> V_62 . V_22 & V_183 ?
V_107 : V_18 ;
if ( F_88 ( V_101 ) )
return - V_122 ;
if ( F_89 ( & V_55 -> V_75 ) )
...
V_39 -> V_141 = 0 ;
V_39 -> V_142 = V_165 ;
F_66 ( V_179 && ! V_41 -> V_184 ) ;
memcpy ( V_39 -> V_185 , V_41 -> V_184 , V_179 ) ;
if ( V_41 -> V_52 != V_41 -> V_68 ) {
struct V_30 V_186 ;
V_39 -> V_126 |= V_187 ;
F_66 ( V_41 -> V_68 -> V_168 < V_165 ) ;
V_45 -> V_68 = NULL ;
if ( ! F_73 ( V_2 , V_41 -> V_68 , V_165 , & V_186 ,
V_22 , V_188 ) )
goto V_189;
V_180 = V_190 ;
V_45 -> V_68 = V_186 . V_34 ;
V_39 -> V_69 = V_186 . V_35 ;
} else {
V_45 -> V_68 = NULL ;
}
V_45 -> V_52 = NULL ;
if ( ! F_73 ( V_2 , V_41 -> V_52 , V_165 , & V_182 ,
V_22 , V_180 ) )
goto V_191;
V_45 -> V_52 = V_182 . V_34 ;
V_39 -> V_61 = V_182 . V_35 ;
V_39 -> V_24 |= V_64 ;
F_65 ( V_101 , F_2 ( V_39 ) ) ;
F_66 ( F_67 ( V_101 ) ) ;
return - V_192 ;
...
struct V_54 * V_55 = F_81 ( V_9 ) ;
T_3 V_185 [ V_193 ] ;
T_3 * V_184 = V_41 -> V_184 ;
int V_85 ;
memcpy ( V_185 , V_55 -> V_178 , V_177 ) ;
...
static int F_93 ( struct V_163 * V_164 , unsigned V_196 ,
unsigned int V_165 )
{
int V_172 = 0 ;
if ( ! V_165 )
...
unsigned V_179 = F_96 ( V_9 ) ;
unsigned V_47 = F_22 ( V_9 ) ;
struct V_104 * V_37 ;
struct V_3 * V_39 ;
unsigned int V_49 ;
struct V_30 * V_31 , V_182 ;
struct V_44 * V_45 = F_20 ( V_41 ) ;
T_4 V_22 = V_41 -> V_62 . V_22 & V_183 ?
V_107 : V_18 ;
if ( F_88 ( V_101 ) )
...
V_39 -> V_142 = V_198 ;
V_39 -> V_123 = 0 ;
V_39 -> V_124 = V_41 -> V_199 + V_179 + V_49 ;
F_66 ( V_179 && ! V_41 -> V_185 ) ;
memcpy ( V_39 -> V_185 , V_41 -> V_185 , V_179 ) ;
if ( V_41 -> V_52 != V_41 -> V_68 ) {
F_29 () ;
}
V_31 = F_73 ( V_2 , V_41 -> V_200 , V_41 -> V_199 , & V_182 ,
V_22 , V_190 ) ;
V_45 -> V_60 = V_182 . V_34 ;
V_39 -> V_61 = V_182 . V_35 ;
if ( ! V_31 )
goto V_175;
F_97 ( & V_45 -> V_201 , 1 ) ;
F_98 ( & V_45 -> V_201 , V_185 , V_179 ) ;
V_31 = F_73 ( V_2 , & V_45 -> V_201 , V_179 , V_31 , V_22 ,
V_181 ) ;
if ( ! V_31 )
goto V_202;
...
struct V_54 * V_55 = F_95 ( V_9 ) ;
T_2 * V_22 = & V_9 -> V_62 . V_147 ;
unsigned V_129 = F_100 ( V_9 ) -> V_204 ;
int V_85 ;
if ( ! V_55 -> V_205 && ! V_55 -> V_206 )
return 0 ;
F_82 ( & V_55 -> V_76 ) ;
F_64 ( & V_55 -> V_75 ) ;
F_54 ( & V_55 -> V_50 ) ;
F_54 ( & V_55 -> V_78 ) ;
V_85 = F_71 ( & V_9 -> V_62 , 0 , V_55 -> V_207 , V_55 -> V_205 ) ;
if ( V_85 )
goto V_175;
V_85 = F_71 ( & V_9 -> V_62 , 1 , V_55 -> V_207 , V_55 -> V_205 ) ;
if ( V_85 )
goto V_175;
V_85 = F_68 ( & V_9 -> V_62 , 0 , V_47 , V_55 -> V_208 ,
V_55 -> V_206 , V_129 ) ;
if ( V_85 )
goto V_175;
V_85 = F_68 ( & V_9 -> V_62 , 1 , V_47 , V_55 -> V_208 ,
V_55 -> V_206 , V_129 ) ;
if ( V_85 )
goto V_175;
if ( * V_22 & V_160 ) {
...
{
int V_209 = F_100 ( V_9 ) -> V_204 >> 2 ;
if ( ( V_47 >> 2 ) < 1 || ( V_47 >> 2 ) > V_209 || ( V_47 & 3 ) )
return - V_154 ;
...
{
struct V_54 * V_55 = F_95 ( V_9 ) ;
struct V_211 * V_212 = (struct V_211 * ) V_116 ;
struct V_213 * V_214 ;
if ( ! F_103 ( V_212 , V_210 ) )
goto V_215;
if ( V_212 -> V_216 != V_217 )
goto V_215;
if ( F_104 ( V_212 ) < sizeof( * V_214 ) )
goto V_215;
V_214 = F_105 ( V_212 ) ;
V_55 -> V_205 = F_106 ( V_214 -> V_218 ) ;
V_116 += F_107 ( V_212 -> V_219 ) ;
V_210 -= F_107 ( V_212 -> V_219 ) ;
if ( V_210 < V_55 -> V_205 )
goto V_215;
V_55 -> V_206 = V_210 - V_55 -> V_205 ;
memcpy ( V_55 -> V_207 , V_116 + V_55 -> V_206 , V_55 -> V_205 ) ;
memcpy ( V_55 -> V_208 , V_116 , V_55 -> V_206 ) ;
...
{
unsigned V_179 = F_96 ( F_21 ( V_41 ) ) ;
return F_94 ( V_41 , 1 , V_41 -> V_199 + V_179 ,
V_41 -> V_49 , V_41 -> V_185 ) ;
}
static int F_110 ( struct V_40 * V_41 )
{
unsigned V_179 = F_96 ( F_21 ( V_41 ) ) ;
return F_94 ( V_41 , 0 , V_41 -> V_199 + V_179 ,
V_41 -> V_49 , V_41 -> V_185 ) ;
}
static int F_111 ( struct V_220 * V_41 )
{
struct V_46 * V_9 = F_112 ( V_41 ) ;
struct V_54 * V_55 = F_95 ( V_9 ) ;
unsigned V_167 , V_179 = F_96 ( V_9 ) ;
T_5 V_221 ;
if ( ! V_55 -> V_222 ) {
F_113 ( V_55 -> V_223 , V_179 ) ;
V_55 -> V_222 = 1 ;
}
memcpy ( V_41 -> V_224 . V_185 , V_55 -> V_223 , V_179 ) ;
V_167 = V_179 ;
if ( V_179 > sizeof( V_225 ) ) {
memset ( V_41 -> V_226 , 0 , V_179 - sizeof( V_225 ) ) ;
V_167 = sizeof( V_225 ) ;
}
V_221 = F_114 ( V_41 -> V_221 ) ;
memcpy ( V_41 -> V_226 + V_179 - V_167 , & V_221 , V_167 ) ;
return F_94 ( & V_41 -> V_224 , 1 , V_41 -> V_224 . V_199 ,
V_41 -> V_224 . V_49 + V_179 , V_41 -> V_226 ) ;
}
static int T_6 F_115 ( void )
{
int V_227 = F_116 ( V_228 ) ;
int V_20 , V_99 ;
if ( F_117 ( & V_229 ) )
return - V_86 ;
F_118 ( & V_23 ) ;
...
struct V_230 * V_231 = & V_228 [ V_20 ] . V_12 ;
if ( snprintf ( V_231 -> V_232 , V_233 ,
L_10 V_234 , V_231 -> V_235 ) >=
V_233 )
{
continue;
}
if ( ! V_97 && ( V_228 [ V_20 ] . V_13 & V_149 ) ) {
continue;
}
if ( ! V_228 [ V_20 ] . V_16 ) {
V_231 -> V_236 = & V_237 ;
...
V_240 |
V_241 ;
if ( ! V_231 -> V_242 . V_243 )
V_231 -> V_242 . V_243 = F_80 ;
if ( ! V_231 -> V_242 . V_50 )
V_231 -> V_242 . V_50 = F_90 ;
if ( ! V_231 -> V_242 . V_78 )
V_231 -> V_242 . V_78 = F_91 ;
V_231 -> V_244 = F_60 ;
} else {
V_231 -> V_236 = & V_245 ;
V_231 -> V_238 = V_246 |
V_240 |
V_241 ;
V_231 -> V_247 . V_243 = F_102 ;
V_231 -> V_247 . V_248 = F_101 ;
V_231 -> V_247 . V_50 = F_109 ;
V_231 -> V_247 . V_78 = F_110 ;
V_231 -> V_247 . V_249 = F_111 ;
V_231 -> V_244 = F_61 ;
}
V_231 -> V_250 = sizeof( struct V_54 ) ;
V_231 -> V_251 = V_252 ;
V_231 -> V_253 = 3 ;
V_231 -> V_254 = 300 ;
V_231 -> V_255 = F_62 ;
