...
F_28 ( & V_1 -> V_3 ) ;
if ( F_29 ( V_1 -> V_10 ) )
memcpy ( & V_1 -> V_55 , F_29 ( V_1 -> V_10 ) ,
sizeof( V_1 -> V_55 ) ) ;
F_21 ( V_1 -> V_5 , true ) ;
switch ( V_1 -> type ) {
case V_56 :
case V_57 :
for ( V_47 = 0 ; V_47 < F_30 ( V_58 ) ; V_47 ++ )
V_1 -> V_59 [ V_47 ] . V_60
= V_58 [ V_47 ] ;
V_1 -> V_61 = F_30 ( V_58 ) ;
break;
...
V_2 = F_31 ( V_1 -> V_10 , - 1 , V_63 ,
F_30 ( V_63 ) , NULL , 0 , NULL ) ;
if ( V_2 != 0 ) {
F_8 ( V_10 , L_40 , V_2 ) ;
return V_2 ;
}
V_2 = F_32 ( V_10 , V_1 -> V_61 ,
V_1 -> V_59 ) ;
if ( V_2 != 0 ) {
F_8 ( V_10 , L_41 ,
V_2 ) ;
...
#endif
default:
F_8 ( V_1 -> V_10 , L_53 , V_46 ) ;
goto V_71;
}
F_43 ( V_10 , L_54 , V_54 , V_1 -> V_73 + 'A' ) ;
if ( V_2 != 0 )
F_8 ( V_1 -> V_10 , L_55 , V_2 ) ;
if ( ! V_1 -> V_55 . V_66 ) {
F_25 ( V_1 -> V_5 ) ;
...
for ( V_47 = 0 ; V_47 < F_30 ( V_1 -> V_55 . V_75 ) ; V_47 ++ ) {
if ( ! V_1 -> V_55 . V_75 [ V_47 ] )
continue;
F_15 ( V_1 -> V_5 , V_76 + V_47 ,
V_1 -> V_55 . V_75 [ V_47 ] ) ;
}
F_44 ( V_1 -> V_10 , 100 ) ;
F_45 ( V_1 -> V_10 ) ;
...
V_12 = V_1 -> V_55 . V_83 [ V_47 ]
<< V_84 ;
V_12 |= V_1 -> V_55 . V_85 [ V_47 ] << V_86 ;
F_3 ( V_1 -> V_5 ,
V_87 + ( V_47 * 8 ) ,
V_88 |
V_89 , V_12 ) ;
...
if ( V_1 -> V_55 . V_95 [ V_47 ] )
F_3 ( V_1 -> V_5 ,
V_96 + ( V_47 * 2 ) ,
V_97 |
V_98 ,
V_1 -> V_55 . V_95 [ V_47 ] ) ;
if ( V_1 -> V_55 . V_99 [ V_47 ] )
F_3 ( V_1 -> V_5 ,
V_100 + ( V_47 * 2 ) ,
V_101 ,
V_1 -> V_55 . V_99 [ V_47 ] ) ;
...
F_30 ( V_105 ) , NULL , 0 , NULL ) ;
break;
case V_57 :
V_2 = F_31 ( V_1 -> V_10 , - 1 , V_106 ,
F_30 ( V_106 ) , NULL , 0 , NULL ) ;
break;
}
if ( V_2 != 0 ) {
F_8 ( V_1 -> V_10 , L_63 , V_2 ) ;
goto V_107;
}
#ifdef F_49
F_22 ( V_1 -> V_53 ) ;
