...
static int F_44 ( struct V_4 * V_95 ,
struct V_62 * V_63 , unsigned long V_96 ,
T_1 V_97 , struct V_98 * * V_99 ,
unsigned long * V_91 )
{
struct V_66 * V_67 = V_63 -> V_68 ;
struct V_69 * V_70 ;
struct V_98 * V_100 = V_99 [ V_101 ] ;
struct V_98 * V_102 [ V_103 + 1 ] ;
struct V_104 V_105 ;
struct V_106 V_107 ;
unsigned int V_79 = 0 ;
unsigned int V_92 = 0 ;
...
if ( V_100 == NULL )
return - V_109 ;
V_108 = F_45 ( V_102 , V_103 , V_100 , V_110 ) ;
if ( V_108 < 0 )
return V_108 ;
if ( V_102 [ V_111 ] ) {
V_89 = F_46 ( V_102 [ V_111 ] ) ;
if ( F_47 ( V_89 ) == 0 )
return - V_109 ;
}
if ( V_102 [ V_112 ] ) {
V_71 = F_46 ( V_102 [ V_112 ] ) ;
V_79 = F_48 ( V_71 ) ;
if ( V_79 == 0 )
return - V_109 ;
if ( F_49 ( V_71 ) - 1 > V_76 )
return - V_113 ;
if ( ( V_71 & ( V_58 | V_59 ) ) &&
F_50 ( F_51 ( V_95 ) . V_114 ) != & V_37 )
return - V_113 ;
}
V_108 = F_52 ( V_63 , V_102 , V_99 [ V_115 ] , & V_105 , & V_116 ) ;
if ( V_108 < 0 )
return V_108 ;
V_108 = F_53 ( V_63 , V_102 [ V_117 ] , & V_107 ) ;
if ( V_108 < 0 )
goto V_118;
V_70 = (struct V_69 * ) * V_91 ;
if ( V_70 != NULL ) {
V_108 = - V_109 ;
if ( V_70 -> V_97 != V_97 && V_97 )
goto V_119;
V_80 = V_70 -> V_80 ;
if ( V_102 [ V_120 ] )
V_80 = F_46 ( V_102 [ V_120 ] ) ;
if ( V_80 != V_81 && V_79 > 1 )
goto V_119;
if ( V_80 == V_81 )
V_92 = V_70 -> V_92 ;
...
if ( F_54 ( V_89 ) == 0 )
V_89 = F_39 ( V_63 -> V_124 -> V_97 , V_89 ) ;
if ( F_47 ( V_89 ) == 0 )
V_89 = F_39 ( V_89 , 1 ) ;
V_108 = - V_125 ;
...
F_57 ( V_63 , & V_70 -> V_90 , & V_105 ) ;
F_58 ( V_63 , & V_70 -> V_77 , & V_107 ) ;
F_59 ( V_63 ) ;
if ( V_102 [ V_112 ] ) {
V_70 -> V_71 = V_71 ;
V_70 -> V_79 = V_79 ;
...
V_70 -> V_80 = V_80 ;
if ( V_102 [ V_129 ] )
V_70 -> V_83 = F_46 ( V_102 [ V_129 ] ) ;
if ( V_102 [ V_130 ] )
V_70 -> V_84 = F_46 ( V_102 [ V_130 ] ) ;
if ( V_102 [ V_131 ] )
V_70 -> V_85 = F_46 ( V_102 [ V_131 ] ) ;
if ( V_102 [ V_132 ] )
V_70 -> V_86 = F_46 ( V_102 [ V_132 ] ) ;
if ( V_102 [ V_133 ] )
V_70 -> V_87 = F_46 ( V_102 [ V_133 ] ) ;
if ( V_89 )
V_70 -> V_89 = V_89 ;
V_70 -> V_92 = V_92 ;
F_60 ( & V_70 -> V_93 ) ;
...
static unsigned long F_74 ( struct V_62 * V_63 , T_1 V_97 )
{
struct V_66 * V_67 = V_63 -> V_68 ;
struct V_69 * V_70 ;
F_34 (f, &head->filters, list)
...
struct V_4 * V_5 , struct V_138 * V_107 )
{
struct V_69 * V_70 = (struct V_69 * ) V_137 ;
struct V_98 * V_139 ;
if ( V_70 == NULL )
return V_5 -> V_140 ;
V_107 -> V_141 = V_70 -> V_97 ;
V_139 = F_77 ( V_5 , V_101 ) ;
if ( V_139 == NULL )
goto V_142;
if ( F_78 ( V_5 , V_112 , V_70 -> V_71 ) ||
