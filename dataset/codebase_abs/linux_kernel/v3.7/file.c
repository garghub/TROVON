...
struct V_17 * V_18 = V_1 -> V_19 ;
struct V_61 * V_62 = F_34 ( V_1 -> V_19 ) ;
struct V_76 * V_77 = F_6 ( V_1 ) ;
struct V_78 * V_79 = V_3 -> V_58 . V_79 ;
struct V_80 V_80 ;
char V_81 [ 64 ] , * V_82 ;
if ( F_36 ( ! ( V_62 -> V_83 & V_84 ) &&
! ( V_18 -> V_85 & V_86 ) ) ) {
V_62 -> V_83 |= V_84 ;
memset ( V_81 , 0 , sizeof( V_81 ) ) ;
V_80 . V_79 = V_79 ;
V_80 . V_59 = V_79 -> V_87 ;
V_82 = F_41 ( & V_80 , V_81 , sizeof( V_81 ) ) ;
if ( ! F_42 ( V_82 ) ) {
T_5 * V_88 ;
int V_51 ;
V_88 = F_43 ( V_18 , 1 ) ;
if ( F_42 ( V_88 ) )
return F_44 ( V_88 ) ;
V_51 = F_45 ( V_88 , V_62 -> V_89 ) ;
if ( V_51 ) {
F_46 ( V_88 ) ;
return V_51 ;
}
F_47 ( V_62 -> V_90 -> V_91 , V_82 ,
sizeof( V_62 -> V_90 -> V_91 ) ) ;
F_48 ( V_88 , V_18 ) ;
F_46 ( V_88 ) ;
}
}
if ( V_62 -> V_92 && ! V_77 -> V_93 && ( V_3 -> V_5 & V_6 ) ) {
struct V_94 * V_93 = F_49 ( V_95 ) ;
F_50 ( & V_1 -> V_96 ) ;
if ( ! V_77 -> V_93 ) {
if ( ! V_93 ) {
F_51 ( & V_1 -> V_96 ) ;
...
T_2 F_55 ( struct V_2 * V_2 , T_2 V_98 , int V_99 )
{
struct V_1 * V_1 = V_2 -> V_28 -> V_29 ;
T_2 V_100 ;
if ( ! ( F_18 ( V_1 , V_36 ) ) )
V_100 = F_34 ( V_1 -> V_19 ) -> V_63 ;
else
V_100 = V_1 -> V_19 -> V_101 ;
return F_56 ( V_2 , V_98 , V_99 ,
V_100 , F_27 ( V_1 ) ) ;
}
