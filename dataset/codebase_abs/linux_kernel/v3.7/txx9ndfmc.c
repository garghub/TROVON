...
F_34 ( V_9 , V_12 ) ;
F_19 ( V_9 ) ;
for ( V_70 = 0 ; V_70 < V_84 ; V_70 ++ ) {
struct V_7 * V_8 ;
struct V_4 * V_5 ;
struct V_2 * V_3 ;
if ( ! ( V_14 -> V_85 & ( 1 << V_70 ) ) )
continue;
V_8 = F_35 ( sizeof( struct V_7 ) ,
V_77 ) ;
if ( ! V_8 ) {
F_20 ( & V_9 -> V_9 , L_3
L_4 ) ;
...
if ( V_14 -> V_85 != 1 ) {
V_8 -> V_35 = V_70 ;
V_8 -> V_100 = F_36 ( V_77 , L_5 ,
F_37 ( & V_9 -> V_9 ) , V_70 ) ;
} else {
V_8 -> V_35 = - 1 ;
V_8 -> V_100 = F_38 ( F_37 ( & V_9 -> V_9 ) ,
V_77 ) ;
}
if ( ! V_8 -> V_100 ) {
F_39 ( V_8 ) ;
...
V_3 -> V_104 = V_8 -> V_100 ;
F_40 ( V_3 , NULL , NULL , NULL , 0 ) ;
V_12 -> V_105 [ V_70 ] = V_3 ;
}
return 0 ;
}
static int T_5 F_41 ( struct V_1 * V_9 )
{
struct V_11 * V_12 = F_3 ( V_9 ) ;
int V_70 ;
F_34 ( V_9 , NULL ) ;
...
return 0 ;
for ( V_70 = 0 ; V_70 < V_84 ; V_70 ++ ) {
struct V_2 * V_3 = V_12 -> V_105 [ V_70 ] ;
struct V_4 * V_5 ;
struct V_7 * V_8 ;
if ( ! V_3 )
continue;
