...
static void F_37 ( struct V_121 * V_18 )
{
...
static void F_44 ( struct V_121 * V_18 )
{
struct V_123 * V_124 ;
int V_125 ;
if ( V_18 -> V_4 -> V_53 -> V_90 != F_19 ) {
...
V_54 ) ;
F_38 ( L_10 , F_39 ( V_18 ) ) ;
V_18 -> V_127 = F_47 ( V_52 -> V_55 -> V_5 ) + 2 ;
F_48 ( V_18 , V_128 , V_18 -> V_127 ) ;
return 0 ;
}
int F_49 ( const struct V_121 * V_18 )
{
struct V_51 * V_52 ;
if ( V_18 -> V_4 -> V_53 -> V_90 != F_19 ) {
return - V_126 ;
