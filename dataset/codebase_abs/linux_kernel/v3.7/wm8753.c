...
static int T_3 F_50 ( struct V_136 * V_137 )
{
struct V_12 * V_13 ;
int V_102 ;
...
static int T_4 F_58 ( struct V_136 * V_137 )
{
struct V_12 * V_13 = F_59 ( V_137 ) ;
F_60 ( & V_137 -> V_2 ) ;
F_57 ( V_13 -> V_121 ) ;
F_61 ( V_13 ) ;
return 0 ;
}
static T_3 int F_62 ( struct V_145 * V_146 ,
const struct V_147 * V_148 )
{
struct V_12 * V_13 ;
int V_102 ;
V_13 = F_51 ( & V_146 -> V_2 , sizeof( struct V_12 ) ,
V_138 ) ;
if ( V_13 == NULL )
return - V_139 ;
F_63 ( V_146 , V_13 ) ;
V_13 -> V_121 = F_64 ( V_146 , & V_140 ) ;
if ( F_54 ( V_13 -> V_121 ) ) {
V_102 = F_55 ( V_13 -> V_121 ) ;
F_45 ( & V_146 -> V_2 , L_5 ,
V_102 ) ;
...
V_102 = F_56 ( & V_146 -> V_2 , & V_142 ,
V_143 , F_16 ( V_143 ) ) ;
if ( V_102 != 0 ) {
F_45 ( & V_146 -> V_2 , L_6 , V_102 ) ;
goto V_144;
}
return 0 ;
V_144:
...
static T_4 int F_65 ( struct V_145 * V_149 )
{
struct V_12 * V_13 = F_66 ( V_149 ) ;
F_60 ( & V_149 -> V_2 ) ;
F_57 ( V_13 -> V_121 ) ;
return 0 ;
}
