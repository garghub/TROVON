...
static int
F_176 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( ! F_8 () )
return 0 ;
...
static int F_177 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( F_59 ( ! V_2 ) )
return 0 ;
...
static int F_178 ( struct V_7 * V_8 , struct V_64 * V_65 )
{
if ( V_8 -> V_194 == V_65 )
return 1 ;
if ( V_8 -> V_279 ) {
...
static int
F_179 ( struct V_64 * V_65 , const char * V_61 ,
...
static int F_181 ( struct V_68 * V_69 ,
struct V_64 * V_65 , unsigned long V_12 )
{
struct V_7 * V_8 ;
unsigned int V_70 ;
...
static void
F_182 ( struct V_64 * V_65 , int V_286 , unsigned long V_12 )
{
struct V_68 * V_69 = V_3 ;
...
void F_184 ( struct V_64 * V_65 , const char * V_61 ,
struct V_93 * V_52 , unsigned int V_63 ,
unsigned long V_12 )
{
unsigned long V_95 ;
...
V_3 -> V_4 = 1 ;
F_164 ( V_95 ) ;
if ( F_179 ( V_65 , V_61 , V_52 , V_63 , V_12 ) )
F_130 ( V_3 ) ;
V_3 -> V_4 = 0 ;
F_67 ( V_95 ) ;
}
void F_185 ( struct V_64 * V_65 , unsigned int V_63 ,
...
F_164 ( V_95 ) ;
V_3 -> V_4 = 1 ;
F_186 ( V_65 , V_63 , V_199 , V_40 , V_218 , V_195 , V_12 ) ;
F_173 ( V_65 , V_63 , V_199 , V_40 , V_218 ,
F_162 ( V_95 ) , V_195 , V_12 , 0 ) ;
V_3 -> V_4 = 0 ;
F_67 ( V_95 ) ;
}
void F_187 ( struct V_64 * V_65 , int V_286 ,
unsigned long V_12 )
{
unsigned long V_95 ;
if ( F_59 ( V_3 -> V_4 ) )
...
V_3 -> V_4 = 1 ;
F_188 ( V_65 , V_12 ) ;
F_182 ( V_65 , V_286 , V_12 ) ;
V_3 -> V_4 = 0 ;
F_67 ( V_95 ) ;
}
int F_189 ( struct V_64 * V_65 )
{
unsigned long V_95 ;
int V_5 = 0 ;
if ( F_59 ( V_3 -> V_4 ) )
...
static int
F_192 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( ! F_8 () )
return 0 ;
...
static void
F_195 ( struct V_64 * V_65 , unsigned long V_12 )
{
struct V_68 * V_69 = V_3 ;
struct V_7 * V_8 , * V_219 ;
struct V_23 * V_25 ;
...
void F_199 ( struct V_64 * V_65 , unsigned long V_12 )
{
unsigned long V_95 ;
if ( F_59 ( ! V_38 ) )
return;
...
static void F_201 ( struct V_6 * V_24 )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_109 ; V_13 ++ ) {
if ( V_111 [ V_13 ] . V_24 == V_24 )
F_202 ( & V_111 [ V_13 ] . V_115 ) ;
}
F_202 ( & V_24 -> V_104 ) ;
F_202 ( & V_24 -> V_101 ) ;
V_24 -> V_52 = NULL ;
}
static inline int F_203 ( const void * V_82 , void * V_78 , unsigned long V_296 )
{
return V_82 >= V_78 && V_82 < V_78 + V_296 ;
}
void F_204 ( void * V_78 , unsigned long V_296 )
{
...
if ( F_86 ( V_113 ) )
continue;
F_205 (class, next, head, hash_entry) {
if ( F_203 ( V_24 -> V_52 , V_78 , V_296 ) )
F_201 ( V_24 ) ;
else if ( F_203 ( V_24 -> V_61 , V_78 , V_296 ) )
F_201 ( V_24 ) ;
}
}
if ( V_297 )
...
static void
F_208 ( struct V_68 * V_69 , const void * V_301 ,
...
static inline int F_209 ( const void * V_301 , unsigned long V_303 ,
const void * V_304 , unsigned long V_305 )
{
return V_304 + V_305 <= V_301 ||
V_301 + V_303 <= V_304 ;
}
void F_210 ( const void * V_301 , unsigned long V_303 )
{
struct V_68 * V_69 = V_3 ;
struct V_7 * V_8 ;
unsigned long V_95 ;
...
for ( V_13 = 0 ; V_13 < V_69 -> V_71 ; V_13 ++ ) {
V_8 = V_69 -> V_73 + V_13 ;
if ( F_209 ( V_301 , V_303 , V_8 -> V_194 ,
sizeof( * V_8 -> V_194 ) ) )
continue;
F_208 ( V_69 , V_301 , V_301 + V_303 , V_8 ) ;
break;
}
F_101 ( V_95 ) ;
}
static void F_211 ( struct V_68 * V_69 )
{
if ( ! F_8 () )
return;
if ( V_136 )
