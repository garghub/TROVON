...
const struct V_75 * V_76 , T_2 V_60 , T_2 V_61 )
{
int V_20 ;
if ( ! V_90 )
return;
...
T_2 V_86 = F_30 ( V_60 , V_85 -> V_60 ) ;
T_2 V_87 = F_30 ( V_61 , V_85 -> V_61 ) ;
T_2 V_95 = V_86 * V_87 * V_85 -> V_88 ;
T_3 V_96 = V_86 * V_85 -> V_88 / V_85 -> V_61 ;
V_93 -> V_95 += V_95 ;
...
static int F_47 ( struct V_37 * V_37 , void * V_107 , T_4 * V_146 )
{
struct V_41 * V_42 = F_22 ( V_37 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
int V_11 ;
...
static int F_48 ( struct V_37 * V_37 , void * V_107 , T_4 * V_146 )
{
struct V_41 * V_42 = F_22 ( V_37 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
int V_11 ;
...
static int F_62 ( struct V_37 * V_37 , void * V_38 , enum V_163 V_20 )
{
struct V_41 * V_42 = F_22 ( V_37 ) ;
F_23 ( V_42 -> V_7 , L_9 , V_43 , __LINE__ ) ;
return F_63 ( & V_42 -> V_159 , V_20 ) ;
}
...
static int F_66 ( struct V_37 * V_37 )
{
struct V_41 * V_42 = F_22 ( V_37 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
int V_11 = 0 ;
...
static unsigned int
F_75 ( struct V_37 * V_37 , struct V_169 * V_170 )
{
struct V_41 * V_42 = F_22 ( V_37 ) ;
unsigned int V_130 ;
F_23 ( V_42 -> V_7 , L_9 , V_43 , __LINE__ ) ;
F_41 ( & V_42 -> V_138 ) ;
V_130 = F_76 ( & V_42 -> V_159 , V_37 , V_170 ) ;
F_44 ( & V_42 -> V_138 ) ;
return V_130 ;
}
static int F_77 ( struct V_37 * V_37 , struct V_171 * V_172 )
{
struct V_41 * V_42 = F_22 ( V_37 ) ;
int V_11 ;
F_23 ( V_42 -> V_7 , L_9 , V_43 , __LINE__ ) ;
...
static int F_81 ( struct V_173 * V_174 , const struct V_97 * V_175 ,
unsigned int * V_176 , unsigned int * V_177 , unsigned int V_178 [] ,
void * V_179 [] )
{
struct V_41 * V_42 = F_82 ( V_174 ) ;
...
V_179 [ V_20 ] = V_42 -> V_7 -> V_22 ;
V_178 [ V_20 ] = V_90 [ V_20 ] . V_95 ;
F_23 ( V_7 , L_27 , V_20 , V_178 [ V_20 ] ) ;
}
if ( * V_176 == 0 )
* V_176 = 1 ;
return 0 ;
}
static void F_83 ( struct V_180 * V_181 )
{
struct V_182 * V_183 = F_84 ( V_181 , struct V_182 , V_181 ) ;
struct V_41 * V_42 = F_82 ( V_181 -> V_173 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
F_85 ( & V_42 -> V_184 , V_132 ) ;
F_86 ( & V_183 -> V_185 , & V_42 -> V_186 ) ;
F_87 ( & V_42 -> V_184 , V_132 ) ;
F_23 ( V_7 , L_28 ) ;
}
...
static void F_89 ( struct V_173 * V_174 )
{
struct V_41 * V_42 = F_82 ( V_174 ) ;
F_23 ( V_42 -> V_7 , L_18 , V_43 ) ;
F_44 ( & V_42 -> V_138 ) ;
}
static int F_90 ( struct V_173 * V_174 , unsigned int V_187 )
{
struct V_41 * V_42 = F_82 ( V_174 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
...
F_91 ( V_7 ) ;
F_27 ( V_42 ) ;
V_42 -> V_70 . V_188 ( V_42 ) ;
F_85 ( & V_42 -> V_184 , V_132 ) ;
V_42 -> V_189 = V_190 ;
F_87 ( & V_42 -> V_184 , V_132 ) ;
V_42 -> V_70 . V_191 ( V_42 , V_192 ) ;
F_92 ( V_7 ) ;
return 0 ;
}
static void F_93 ( unsigned long V_193 )
{
struct V_41 * V_42 = (struct V_41 * ) V_193 ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
F_12 ( V_7 , L_30 , V_42 -> V_47 . V_15 ) ;
F_85 ( & V_42 -> V_184 , V_132 ) ;
if ( V_42 -> V_194 == V_42 -> V_195 )
V_42 -> V_194 = NULL ;
if ( V_42 -> V_194 ) {
F_94 ( & V_42 -> V_194 -> V_181 , V_196 ) ;
V_42 -> V_194 = NULL ;
}
if ( V_42 -> V_195 ) {
F_94 ( & V_42 -> V_195 -> V_181 , V_196 ) ;
V_42 -> V_195 = NULL ;
}
F_87 ( & V_42 -> V_184 , V_132 ) ;
}
static int F_95 ( struct V_173 * V_174 )
{
struct V_41 * V_42 = F_82 ( V_174 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_132 ;
struct V_197 V_198 ;
struct V_182 * V_199 , * V_200 ;
F_23 ( V_7 , L_18 , V_43 ) ;
F_85 ( & V_42 -> V_184 , V_132 ) ;
V_42 -> V_189 = V_201 ;
F_96 (buf, buf_tmp, &layer->enq_list, list) {
F_97 ( & V_199 -> V_185 ) ;
F_94 ( & V_199 -> V_181 , V_196 ) ;
}
F_87 ( & V_42 -> V_184 , V_132 ) ;
F_98 ( & V_198 , F_93 ,
( unsigned long ) V_42 ) ;
F_99 ( & V_198 , V_202 + F_100 ( 1000 ) ) ;
F_101 ( V_174 ) ;
F_102 ( & V_198 ) ;
F_103 ( & V_198 ) ;
F_85 ( & V_42 -> V_184 , V_132 ) ;
...
struct V_6 * V_7 = V_42 -> V_7 ;
int V_11 ;
V_11 = F_107 ( & V_42 -> V_47 , V_205 , - 1 ) ;
if ( V_11 )
F_12 ( V_7 , L_31 ) ;
else
F_16 ( V_7 , L_32 ,
V_42 -> V_47 . V_15 , V_42 -> V_47 . V_206 ) ;
return V_11 ;
}
void F_108 ( struct V_41 * V_42 )
{
F_109 ( & V_42 -> V_47 ) ;
}
...
{
if ( V_42 -> V_70 . V_207 )
V_42 -> V_70 . V_207 ( V_42 ) ;
}
void F_111 ( struct V_41 * V_42 )
{
F_17 ( V_42 ) ;
}
static void F_112 ( struct V_155 * V_208 )
{
F_113 ( L_33 ) ;
}
struct V_41 * F_114 ( struct V_6 * V_7 ,
int V_49 , char * V_15 , struct V_209 * V_70 )
{
struct V_41 * V_42 ;
...
F_118 ( V_217 , & V_42 -> V_47 . V_132 ) ;
F_119 ( & V_42 -> V_47 , V_42 ) ;
V_42 -> V_47 . V_218 = & V_42 -> V_138 ;
V_42 -> V_47 . V_14 = & V_7 -> V_14 ;
V_42 -> V_159 = (struct V_173 ) {
. type = V_111 ,
. V_219 = V_220 | V_221 ,
. V_222 = V_42 ,
. V_223 = sizeof( struct V_182 ) ,
. V_70 = & V_224 ,
. V_225 = & V_226 ,
} ;
return V_42 ;
...
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_42 -> V_227 ; ++ V_20 )
if ( V_42 -> V_168 [ V_20 ] -> V_81 == V_81 )
return V_42 -> V_168 [ V_20 ] ;
return NULL ;
}
