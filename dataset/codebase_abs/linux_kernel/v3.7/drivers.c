...
static int F_65 ( struct V_1 * V_2 , void * V_145 )
{
...
return V_36 -> V_43 ( V_2 , V_34 ) ;
}
static int F_66 ( struct V_12 * V_144 ,
struct V_35 * V_19 , const int * V_148 ,
unsigned V_149 )
{
struct V_33 V_34 ;
memset ( & V_34 , 0 , sizeof( V_34 ) ) ;
strncpy ( V_34 . V_20 , V_19 -> V_41 , V_150 ) ;
V_34 . V_20 [ V_150 - 1 ] = '\0' ;
F_25 ( V_149 > V_151 ) ;
memcpy ( V_34 . V_148 , V_148 , V_149 * sizeof( int ) ) ;
return F_61 ( V_144 , V_19 ,
F_65 , & V_34 ) ;
}
static void F_67 ( struct V_12 * V_144 )
{
int V_16 ;
if ( V_144 == NULL )
return;
...
int F_69 ( struct V_152 * V_153 , const char * V_154 )
{
int V_155 ;
V_155 = F_70 ( V_153 ) ;
if ( V_155 < 0 )
return V_155 ;
V_155 = F_71 ( V_153 , V_154 ) ;
if ( V_155 < 0 )
F_72 ( V_153 ) ;
return V_155 ;
}
...
static int F_75 ( struct V_152 * V_156 ,
struct V_35 * V_19 )
{
int V_148 [ 2 ] ;
V_148 [ 0 ] = V_156 -> V_157 -> V_158 ;
V_148 [ 1 ] = F_76 ( V_156 -> V_159 ) ;
return F_66 ( & V_156 -> V_2 , V_19 ,
V_148 , F_77 ( V_148 ) ) ;
}
static int F_78 ( struct V_1 * V_2 , void * V_156 )
{
return V_2 -> V_19 -> V_160 ( V_2 , V_156 ) ;
}
static int F_79 ( struct V_152 * V_156 ,
struct V_35 * V_19 )
{
return F_61 ( & V_156 -> V_2 , V_19 ,
F_78 , V_156 ) ;
}
int F_80 ( struct V_152 * V_156 , struct V_35 * V_19 )
{
if ( V_19 -> V_160 )
return F_79 ( V_156 , V_19 ) ;
else
return F_75 ( V_156 , V_19 ) ;
}
void F_81 ( struct V_152 * V_156 )
{
F_67 ( & V_156 -> V_2 ) ;
}
int F_82 ( struct V_35 * V_35 ,
struct V_161 * V_161 )
{
int V_31 ;
V_31 = F_20 ( V_35 ) ;
...
struct V_35 * V_19 )
{
return F_66 ( & V_163 -> V_2 , V_19 , NULL , 0 ) ;
}
static int F_87 ( struct V_1 * V_2 , void * V_163 )
{
return V_2 -> V_19 -> V_164 ( V_2 , V_163 ) ;
}
static int F_88 ( struct V_162 * V_163 ,
struct V_35 * V_19 )
{
return F_61 ( & V_163 -> V_2 , V_19 ,
F_87 , V_163 ) ;
}
int F_89 ( struct V_162 * V_163 ,
struct V_35 * V_19 )
{
F_25 ( V_163 == NULL ) ;
if ( V_19 -> V_164 )
return F_88 ( V_163 , V_19 ) ;
else
return F_86 ( V_163 , V_19 ) ;
}
void F_90 ( struct V_162 * V_163 )
{
F_25 ( V_163 == NULL ) ;
F_67 ( & V_163 -> V_2 ) ;
}
int F_91 ( struct V_35 * V_35 ,
struct V_165 * V_165 )
{
int V_31 ;
V_31 = F_20 ( V_35 ) ;
