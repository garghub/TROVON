...
F_140 ( & V_242 ) ;
F_141 (km, &xfrm_km_list, list) {
V_249 = V_99 -> V_250 ( V_20 , V_248 , V_166 ) ;
if ( ! V_249 )
V_52 = V_249 ;
}
F_142 ( & V_242 ) ;
...
int F_144 ( struct V_19 * V_20 , T_1 * V_251 , T_6 V_252 )
{
int V_52 = - V_65 ;
struct V_241 * V_99 ;
F_140 ( & V_242 ) ;
F_141 (km, &xfrm_km_list, list) {
if ( V_99 -> V_253 )
V_52 = V_99 -> V_253 ( V_20 , V_251 , V_252 ) ;
if ( ! V_52 )
break;
}
F_142 ( & V_242 ) ;
...
int F_146 ( const struct V_255 * V_157 , T_4 V_238 , T_4 type ,
const struct V_208 * V_161 , int V_256 ,
...
F_141 (km, &xfrm_km_list, list) {
if ( V_99 -> V_260 ) {
V_259 = V_99 -> V_260 ( V_157 , V_238 , type , V_161 , V_256 , V_258 ) ;
if ( ! V_259 )
V_52 = V_259 ;
}
}
...
int F_147 ( struct V_1 * V_1 , T_4 V_9 , struct V_255 * V_157 , T_1 * V_261 )
{
int V_52 = - V_65 ;
int V_259 ;
struct V_241 * V_99 ;
...
F_141 (km, &xfrm_km_list, list) {
if ( V_99 -> V_262 ) {
V_259 = V_99 -> V_262 ( V_1 , V_9 , V_157 , V_261 ) ;
if ( ! V_259 )
V_52 = V_259 ;
}
}
...
int F_148 ( struct V_263 * V_264 , int V_265 , T_4 T_7 * V_266 , int V_267 )
{
int V_52 ;
T_4 * V_232 ;
struct V_241 * V_99 ;
struct V_165 * V_166 = NULL ;
if ( V_267 <= 0 || V_267 > V_268 )
return - V_269 ;
V_232 = F_149 ( V_267 , V_207 ) ;
if ( ! V_232 )
return - V_179 ;
V_52 = - V_270 ;
if ( F_150 ( V_232 , V_266 , V_267 ) )
goto V_67;
V_52 = - V_65 ;
F_140 ( & V_242 ) ;
F_141 (km, &xfrm_km_list, list) {
V_166 = V_99 -> V_271 ( V_264 , V_265 , V_232 ,
V_267 , & V_52 ) ;
if ( V_52 >= 0 )
break;
}
...
int F_161 ( struct V_19 * V_20 , int V_275 )
{
int V_224 ;
F_16 ( & V_20 -> V_98 ) ;
if ( V_20 -> V_99 . V_100 == V_169 &&
V_20 -> type && V_20 -> type -> V_276 )
V_224 = V_20 -> type -> V_276 ( V_20 , V_275 ) ;
else
V_224 = V_275 - V_20 -> V_23 . V_277 ;
F_17 ( & V_20 -> V_98 ) ;
return V_224 ;
}
int F_162 ( struct V_19 * V_20 , bool V_278 )
{
struct V_46 * V_47 ;
struct V_60 * V_76 ;
...
V_52 = 0 ;
if ( V_47 -> V_279 )
V_52 = V_47 -> V_279 ( V_20 ) ;
F_30 ( V_47 ) ;
if ( V_52 )
goto error;
V_52 = - V_280 ;
if ( V_20 -> V_157 . V_5 != V_281 ) {
...
V_283 = V_195 ;
V_77 = F_36 ( V_20 -> V_23 . V_61 , V_283 ) ;
if ( V_77 ) {
if ( V_77 -> V_176 & V_282 )
V_20 -> V_77 = V_77 ;
else
...
unsigned int V_285 ;
F_63 ( & V_1 -> V_6 . V_182 ) ;
V_285 = sizeof( struct V_10 ) * 8 ;
V_1 -> V_6 . V_43 = F_14 ( V_285 ) ;
if ( ! V_1 -> V_6 . V_43 )
goto V_286;
V_1 -> V_6 . V_44 = F_14 ( V_285 ) ;
if ( ! V_1 -> V_6 . V_44 )
goto V_287;
V_1 -> V_6 . V_45 = F_14 ( V_285 ) ;
if ( ! V_1 -> V_6 . V_45 )
goto V_288;
V_1 -> V_6 . V_7 = ( ( V_285 / sizeof( struct V_10 ) ) - 1 ) ;
V_1 -> V_6 . V_138 = 0 ;
...
return 0 ;
V_288:
F_15 ( V_1 -> V_6 . V_44 , V_285 ) ;
V_287:
F_15 ( V_1 -> V_6 . V_43 , V_285 ) ;
V_286:
return - V_179 ;
}
...
V_285 = ( V_1 -> V_6 . V_7 + 1 ) * sizeof( struct V_10 ) ;
F_69 ( ! F_170 ( V_1 -> V_6 . V_45 ) ) ;
F_15 ( V_1 -> V_6 . V_45 , V_285 ) ;
