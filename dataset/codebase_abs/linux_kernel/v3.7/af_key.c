...
static int F_193 ( struct V_143 * V_165 , struct V_394 * V_395 , struct V_382 * V_383 )
{
struct V_40 * V_8 ;
struct V_59 * V_60 ;
struct V_77 * V_80 ;
...
static int F_195 ( struct V_143 * V_165 , T_4 * V_510 , T_5 V_253 )
{
struct V_40 * V_8 ;
struct V_59 * V_60 ;
struct V_144 * V_136 ;
...
static int F_196 ( struct V_40 * V_8 , int V_512 , int type ,
const struct V_439 * V_184 )
{
struct V_77 * V_80 ;
V_80 = (struct V_77 * ) F_44 ( V_8 , sizeof( struct V_77 ) + V_512 ) ;
V_80 -> V_87 = ( sizeof( struct V_77 ) + V_512 ) / 8 ;
V_80 -> V_248 = type ;
...
F_165 ( V_135 ) ) ;
V_454 = (struct V_453 * ) F_44 ( V_8 , V_513 ) ;
...
V_73 V_134 , V_73 V_149 , int V_515 ,
...
F_165 ( V_135 ) ;
V_393 = (struct V_392 * ) F_44 ( V_8 , V_513 ) ;
...
V_517 = F_63 ( V_184 -> V_135 ) ;
if ( ! V_517 )
return - V_72 ;
V_176 += ( sizeof( struct V_77 ) + V_517 ) * 2 ;
...
V_176 += sizeof( struct V_59 ) + V_518 ;
V_8 = F_42 ( V_176 , V_65 ) ;
if ( V_8 == NULL )
return - V_30 ;
V_60 = (struct V_59 * ) F_44 ( V_8 , sizeof( struct V_59 ) ) ;
...
goto V_23;
F_196 ( V_8 , V_517 , V_120 , V_184 ) ;
F_196 ( V_8 , V_517 , V_121 , V_184 ) ;
V_409 = (struct V_408 * ) F_44 ( V_8 , sizeof( struct V_408 ) ) ;
V_409 -> V_410 = V_518 / 8 ;
V_409 -> V_415 = V_416 ;
V_409 -> V_417 = V_421 ;
...
V_409 -> V_426 = 0 ;
for ( V_352 = 0 , V_519 = V_444 ; V_352 < V_516 ; V_352 ++ , V_519 ++ ) {
int V_149 = F_65 ( V_519 -> V_149 ) ;
if ( V_149 < 0 )
goto V_23;
if ( F_198 ( V_8 , V_519 -> V_134 , V_149 ,
...
goto V_34;
V_23 = - V_473 ;
if ( ( unsigned int ) V_46 > V_3 -> V_527 - 32 )
goto V_34;
V_23 = - V_43 ;
V_8 = F_42 ( V_46 , V_32 ) ;
if ( V_8 == NULL )
goto V_34;
V_23 = - V_528 ;
if ( F_201 ( F_44 ( V_8 , V_46 ) , V_524 -> V_529 , V_46 ) )
goto V_34;
V_60 = F_180 ( V_8 , & V_23 ) ;
if ( ! V_60 )
goto V_34;
...
goto V_537;
F_206 ( V_524 , V_3 , V_8 ) ;
V_23 = ( V_218 & V_534 ) ? V_8 -> V_46 : V_531 ;
if ( V_6 -> V_7 . V_7 != NULL &&
