...
{
struct V_157 V_158 ;
int V_165 = - V_150 , V_193 ;
if ( V_192 > V_194 )
V_192 = V_194 ;
V_158 . V_10 = V_10 ;
V_158 . V_69 = & V_192 ;
V_193 = F_52 ( V_195 , & V_158 ) ;
if ( V_10 -> V_8 -> F_60 )
...
static long F_61 ( struct V_1 * V_10 , unsigned int V_198 ,
unsigned long V_199 )
{
struct V_200 * V_201 ;
struct V_12 V_13 ;
...
V_13 = V_10 -> V_13 ;
F_62 ( V_10 ) ;
V_165 = F_46 ( V_206 , & V_13 , sizeof( V_13 ) ) ? - V_143 : 0 ;
break;
case V_208 :
if ( F_48 ( & V_13 , V_206 , sizeof( V_13 ) ) )
return - V_143 ;
if ( ! F_8 ( V_10 ) )
return - V_4 ;
F_63 () ;
...
F_64 () ;
F_62 ( V_10 ) ;
if ( ! V_165 && F_46 ( V_206 , & V_13 , sizeof( V_13 ) ) )
V_165 = - V_143 ;
break;
case V_209 :
if ( ! F_8 ( V_10 ) )
...
V_15 = V_10 -> V_15 ;
F_62 ( V_10 ) ;
V_165 = F_46 ( V_206 , & V_15 , sizeof( V_15 ) ) ? - V_143 : 0 ;
break;
case V_210 :
if ( F_48 ( & V_185 , V_206 , sizeof( V_185 ) ) )
return - V_143 ;
...
F_64 () ;
F_62 ( V_10 ) ;
if ( V_165 == 0 && F_46 ( V_206 , & V_13 , sizeof( V_13 ) ) )
return - V_143 ;
break;
case V_213 :
V_165 = - V_150 ;
break;
case V_214 :
if ( F_48 ( & V_203 , V_206 , sizeof( V_203 ) ) )
return - V_143 ;
if ( V_203 . V_215 < 1 || V_203 . V_215 > V_216 )
return - V_150 ;
V_203 . V_217 = - 1 ;
V_158 . V_69 = & V_203 ;
if ( ! F_8 ( V_10 ) )
...
F_52 ( V_218 , & V_158 ) ;
F_62 ( V_10 ) ;
V_165 = F_46 ( V_206 , & V_203 , sizeof( V_203 ) ) ? - V_143 : 0 ;
break;
case V_219 :
if ( F_48 ( & V_203 , V_206 , sizeof( V_203 ) ) )
return - V_143 ;
if ( V_203 . V_215 < 1 || V_203 . V_215 > V_216 )
return - V_150 ;
if ( V_203 . V_217 < 0 || V_203 . V_217 >= V_3 )
return - V_150 ;
if ( ! V_6 [ V_203 . V_217 ] )
F_67 ( L_5 , V_203 . V_217 ) ;
if ( ! V_6 [ V_203 . V_217 ] ) {
V_165 = - V_150 ;
break;
}
...
V_201 = V_10 -> V_8 ;
if ( V_201 -> V_222 )
V_165 = V_201 -> V_222 ( V_10 , V_198 , V_199 ) ;
else
V_165 = - V_223 ;
F_62 ( V_10 ) ;
}
...
static long V_222 ( struct V_123 * V_123 , unsigned int V_198 , unsigned long V_199 )
{
struct V_1 * V_10 = F_42 ( V_123 ) ;
if ( ! V_10 )
return - V_4 ;
return F_61 ( V_10 , V_198 , V_199 ) ;
}
static int F_68 ( struct V_1 * V_10 , unsigned int V_198 ,
unsigned long V_199 )
{
struct V_205 T_6 * V_185 ;
struct V_224 T_6 * V_225 ;
T_9 V_69 ;
int V_135 ;
V_185 = F_69 ( sizeof( * V_185 ) ) ;
V_225 = F_70 ( V_199 ) ;
if ( F_71 ( & V_185 -> V_57 , & V_225 -> V_57 , 2 * sizeof( T_9 ) ) )
return - V_143 ;
if ( F_72 ( V_69 , & V_225 -> V_23 ) ||
F_73 ( F_70 ( V_69 ) , & V_185 -> V_23 ) ||
F_72 ( V_69 , & V_225 -> V_20 ) ||
F_73 ( F_70 ( V_69 ) , & V_185 -> V_20 ) ||
F_72 ( V_69 , & V_225 -> V_22 ) ||
F_73 ( F_70 ( V_69 ) , & V_185 -> V_22 ) ||
F_72 ( V_69 , & V_225 -> V_59 ) ||
F_73 ( F_70 ( V_69 ) , & V_185 -> V_59 ) )
return - V_143 ;
V_135 = F_61 ( V_10 , V_198 , ( unsigned long ) V_185 ) ;
if ( ! V_135 ) {
if ( F_71 ( & V_225 -> V_57 ,
& V_185 -> V_57 ,
2 * sizeof( T_9 ) ) )
...
T_9 V_69 ;
int V_135 ;
V_135 = F_46 ( & V_227 -> V_121 , & V_15 -> V_121 , sizeof( V_227 -> V_121 ) ) ;
V_69 = ( T_9 ) ( unsigned long ) V_15 -> V_228 ;
V_135 |= F_73 ( V_69 , & V_227 -> V_228 ) ;
V_135 |= F_73 ( V_15 -> V_140 , & V_227 -> V_140 ) ;
V_135 |= F_73 ( V_15 -> type , & V_227 -> type ) ;
V_135 |= F_73 ( V_15 -> V_229 , & V_227 -> V_229 ) ;
V_135 |= F_73 ( V_15 -> V_17 , & V_227 -> V_17 ) ;
V_135 |= F_73 ( V_15 -> V_153 , & V_227 -> V_153 ) ;
V_135 |= F_73 ( V_15 -> V_151 , & V_227 -> V_151 ) ;
V_135 |= F_73 ( V_15 -> V_149 , & V_227 -> V_149 ) ;
V_135 |= F_73 ( V_15 -> V_230 , & V_227 -> V_230 ) ;
V_69 = ( T_9 ) ( unsigned long ) V_15 -> V_231 ;
V_135 |= F_73 ( V_69 , & V_227 -> V_231 ) ;
V_135 |= F_73 ( V_15 -> V_232 , & V_227 -> V_232 ) ;
V_135 |= F_73 ( V_15 -> V_233 , & V_227 -> V_233 ) ;
V_135 |= F_46 ( V_227 -> V_234 , V_15 -> V_234 ,
sizeof( V_15 -> V_234 ) ) ;
return V_135 ;
}
static int F_75 ( struct V_1 * V_10 , unsigned int V_198 ,
unsigned long V_199 )
{
T_10 V_235 ;
struct V_14 V_15 ;
...
V_235 = F_76 () ;
F_77 ( V_236 ) ;
V_135 = F_61 ( V_10 , V_198 , ( unsigned long ) & V_15 ) ;
F_77 ( V_235 ) ;
if ( ! V_135 )
V_135 = F_74 ( & V_15 , V_227 ) ;
return V_135 ;
}
static long F_78 ( struct V_123 * V_123 , unsigned int V_198 ,
unsigned long V_199 )
{
struct V_1 * V_10 = F_42 ( V_123 ) ;
struct V_200 * V_201 ;
...
case V_214 :
case V_219 :
V_199 = ( unsigned long ) F_70 ( V_199 ) ;
case V_221 :
V_165 = F_61 ( V_10 , V_198 , V_199 ) ;
break;
case V_209 :
V_165 = F_75 ( V_10 , V_198 , V_199 ) ;
break;
case V_211 :
case V_210 :
V_165 = F_68 ( V_10 , V_198 , V_199 ) ;
break;
default:
if ( V_201 -> F_78 )
V_165 = V_201 -> F_78 ( V_10 , V_198 , V_199 ) ;
break;
}
return V_165 ;
}
static int
F_79 ( struct V_123 * V_123 , struct V_238 * V_239 )
{
struct V_1 * V_10 = F_42 ( V_123 ) ;
struct V_200 * V_201 ;
unsigned long V_240 ;
...
if ( ! V_10 )
return - V_4 ;
if ( V_239 -> V_241 > ( ~ 0UL >> V_242 ) )
return - V_150 ;
V_240 = V_239 -> V_241 << V_242 ;
V_201 = V_10 -> V_8 ;
if ( ! V_201 )
return - V_4 ;
F_3 ( & V_10 -> V_243 ) ;
if ( V_201 -> F_79 ) {
int V_244 ;
V_244 = V_201 -> F_79 ( V_10 , V_239 ) ;
F_5 ( & V_10 -> V_243 ) ;
return V_244 ;
}
V_57 = V_10 -> V_15 . V_228 ;
V_58 = F_80 ( ( V_57 & ~ V_245 ) + V_10 -> V_15 . V_140 ) ;
if ( V_240 >= V_58 ) {
V_240 -= V_58 ;
if ( V_10 -> V_13 . V_246 ) {
F_5 ( & V_10 -> V_243 ) ;
...
V_57 = V_10 -> V_15 . V_231 ;
V_58 = F_80 ( ( V_57 & ~ V_245 ) + V_10 -> V_15 . V_232 ) ;
}
F_5 ( & V_10 -> V_243 ) ;
V_57 &= V_245 ;
if ( ( V_239 -> V_247 - V_239 -> V_248 + V_240 ) > V_58 )
return - V_150 ;
V_240 += V_57 ;
V_239 -> V_241 = V_240 >> V_242 ;
V_239 -> V_249 = F_81 ( V_239 -> V_250 ) ;
F_82 ( V_123 , V_239 , V_240 ) ;
if ( F_83 ( V_239 , V_239 -> V_248 , V_240 >> V_242 ,
V_239 -> V_247 - V_239 -> V_248 , V_239 -> V_249 ) )
return - V_251 ;
return 0 ;
}
static int
...
{
const bool V_252 = V_119 -> V_43 & V_253 ;
V_119 -> V_43 &= ~ V_253 ;
#ifdef F_87
V_119 -> V_43 |= V_252 ? 0 : V_254 ;
#else
V_119 -> V_43 |= V_252 ? V_254 : 0 ;
#endif
if ( V_119 -> V_43 & V_254 && ! F_88 ( V_119 ) ) {
F_89 ( L_6
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_255 ;
} else if ( ! ( V_119 -> V_43 & V_254 ) && F_88 ( V_119 ) ) {
F_89 ( L_8
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_255 ;
}
...
static bool F_90 ( struct V_256 * V_257 , struct V_256 * V_258 )
{
if ( V_257 -> V_259 == V_258 -> V_259 )
return true ;
if ( V_257 -> V_259 > V_258 -> V_259 && V_257 -> V_259 < V_258 -> V_259 + V_258 -> V_39 )
return true ;
return false ;
}
static bool F_91 ( struct V_260 * V_261 ,
struct V_260 * V_262 )
{
int V_35 , V_36 ;
if ( ! V_262 || ! V_261 )
return false ;
for ( V_35 = 0 ; V_35 < V_262 -> V_7 ; ++ V_35 ) {
struct V_256 * V_75 = & V_262 -> V_263 [ V_35 ] ;
for ( V_36 = 0 ; V_36 < V_261 -> V_7 ; ++ V_36 ) {
struct V_256 * V_264 = & V_261 -> V_263 [ V_36 ] ;
F_57 ( V_265 L_9 ,
( unsigned long long ) V_264 -> V_259 ,
( unsigned long long ) V_264 -> V_39 ,
( unsigned long long ) V_75 -> V_259 ,
...
static void F_92 ( struct V_260 * V_266 ,
const char * V_267 , bool V_268 )
{
int V_35 ;
...
if ( ! V_6 [ V_35 ] )
continue;
if ( ! ( V_6 [ V_35 ] -> V_43 & V_270 ) )
continue;
V_269 = V_6 [ V_35 ] -> V_271 ;
if ( F_91 ( V_269 , V_266 ) ||
( V_268 && V_269 && V_269 -> V_7 &&
V_269 -> V_263 [ 0 ] . V_259 == V_272 ) ) {
F_57 ( V_273 L_10
L_11 ,
V_267 , V_6 [ V_35 ] -> V_15 . V_121 ) ;
F_93 ( V_6 [ V_35 ] ) ;
}
}
}
...
F_97 ( & V_1 -> V_11 ) ;
F_97 ( & V_1 -> V_243 ) ;
V_1 -> V_276 = F_98 ( V_277 , V_1 -> V_278 ,
F_99 ( V_279 , V_35 ) , NULL , L_5 , V_35 ) ;
if ( F_100 ( V_1 -> V_276 ) ) {
F_57 ( V_184 L_12 , V_35 , F_101 ( V_1 -> V_276 ) ) ;
V_1 -> V_276 = NULL ;
} else
F_102 ( V_1 ) ;
if ( V_1 -> V_280 . V_42 == NULL ) {
V_1 -> V_280 . V_42 = F_26 ( V_281 , V_102 ) ;
if ( V_1 -> V_280 . V_42 ) {
V_1 -> V_280 . V_39 = V_281 ;
V_1 -> V_280 . V_41 = 1 ;
V_1 -> V_280 . V_282 = 1 ;
V_1 -> V_280 . V_283 = 32 ;
V_1 -> V_280 . V_43 = V_284 ;
}
}
V_1 -> V_280 . V_24 = 0 ;
if ( ! V_1 -> V_280 . V_285 )
V_1 -> V_280 . V_285 = ~ ( T_2 ) 0 ;
if ( ! V_1 -> V_280 . V_286 )
V_1 -> V_280 . V_286 = ~ ( T_2 ) 0 ;
...
return - V_150 ;
if ( V_1 -> V_276 ) {
F_107 ( V_277 , F_99 ( V_279 , V_35 ) ) ;
V_1 -> V_276 = NULL ;
}
return 0 ;
}
void F_108 ( struct V_260 * V_266 ,
const char * V_267 , bool V_268 )
{
F_3 ( & V_5 ) ;
F_92 ( V_266 , V_267 , V_268 ) ;
F_5 ( & V_5 ) ;
}
int
...
void F_111 ( struct V_1 * V_10 , int V_95 )
{
struct V_157 V_158 ;
V_158 . V_10 = V_10 ;
if ( V_95 ) {
...
F_112 ( void )
{
F_113 ( L_13 , 0 , NULL , & V_293 ) ;
if ( F_114 ( V_279 , L_13 , & V_294 ) )
F_57 ( L_14 , V_279 ) ;
V_277 = F_115 ( V_295 , L_15 ) ;
if ( F_100 ( V_277 ) ) {
F_57 ( V_184 L_16 , F_101 ( V_277 ) ) ;
V_277 = NULL ;
}
return 0 ;
}
...
int F_120 ( struct V_1 * V_10 )
{
struct V_157 V_158 ;
struct V_12 V_13 = V_10 -> V_13 ;
struct V_296 * V_117 , * V_48 ;
struct V_297 * V_171 ;
struct V_167 * V_116 , V_182 ;
int V_135 = 1 ;
F_121 (pos, n, &info->modelist) {
V_171 = F_122 ( V_117 , struct V_297 , V_298 ) ;
V_116 = & V_171 -> V_182 ;
F_123 ( & V_13 , V_116 ) ;
V_13 . V_156 = V_299 ;
...
return - V_4 ;
V_158 . V_10 = V_10 ;
V_135 = F_52 ( V_300 , & V_158 ) ;
F_62 ( V_10 ) ;
}
return V_135 ;
}
int F_125 ( char * V_267 , char * * V_301 )
{
char * V_302 , * V_303 = NULL ;
int V_304 = 0 ;
int V_305 = strlen ( V_267 ) , V_35 ;
if ( V_305 && V_306 && strncmp ( V_267 , L_17 , 4 ) )
V_304 = 1 ;
if ( V_305 && ! V_304 ) {
for ( V_35 = 0 ; V_35 < V_3 ; V_35 ++ ) {
if ( V_307 [ V_35 ] == NULL )
...
continue;
V_302 = V_307 [ V_35 ] ;
if ( ! strncmp ( V_267 , V_302 , V_305 ) &&
V_302 [ V_305 ] == ':' )
V_303 = V_302 + V_305 + 1 ;
}
}
if ( V_303 && ! strncmp ( V_303 , L_18 , 3 ) )
V_304 = 1 ;
if ( V_301 )
* V_301 = V_303 ;
return V_304 ;
}
static int T_11 F_126 ( char * V_303 )
{
int V_35 , V_308 = 0 ;
if ( ! V_303 || ! * V_303 )
V_308 = 1 ;
if ( ! V_308 && ! strncmp ( V_303 , L_19 , 6 ) ) {
V_306 = 1 ;
V_308 = 1 ;
}
if ( ! V_308 && ! strchr ( V_303 , ':' ) ) {
V_309 = V_303 ;
V_308 = 1 ;
}
if ( ! V_308 ) {
