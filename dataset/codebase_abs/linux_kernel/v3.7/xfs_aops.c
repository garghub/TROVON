...
T_6 V_121 = F_86 ( V_120 , V_64 -> V_88 ) ;
T_8 V_122 = F_87 ( F_6 ( V_9 ) , V_64 -> V_85 ) ;
ASSERT ( V_64 -> V_85 != V_86 ) ;
ASSERT ( V_64 -> V_85 != V_87 ) ;
...
goto V_135;
if ( ! F_92 ( V_1 , ( * V_128 ) -> V_49 ) )
goto V_135;
V_129 = F_98 (unsigned long long,
(xfs_off_t)(page->index + 1) << PAGE_CACHE_SHIFT,
i_size_read(inode)) ;
V_131 = 1 << V_9 -> V_67 ;
V_130 = F_98 (unsigned long, end_offset & (PAGE_CACHE_SIZE - 1),
PAGE_CACHE_SIZE) ;
V_130 = V_130 ? F_99 ( V_130 , V_131 ) : V_137 ;
V_132 = V_130 / V_131 ;
V_5 = V_6 = F_2 ( V_1 ) ;
do {
if ( V_62 >= V_129 )
...
int V_57 = 0 , V_143 ;
F_105 ( & V_142 , 0 ) ;
while ( ! V_57 && V_127 <= V_140 ) {
unsigned V_131 = F_98 ( T_9 , V_144 , V_140 - V_127 + 1 ) ;
if ( ! F_106 ( & V_142 , V_9 -> V_136 , V_127 , V_131 ) )
break;
for ( V_143 = 0 ; V_143 < F_107 ( & V_142 ) ; V_143 ++ ) {
V_57 = F_95 ( V_9 , V_142 . V_145 [ V_143 ] , V_127 ++ ,
V_64 , V_128 , V_97 ) ;
if ( V_57 )
break;
}
...
unsigned long V_62 )
{
F_111 ( V_1 -> V_124 -> V_146 , V_1 , V_62 ) ;
F_112 ( V_1 , V_62 ) ;
}
STATIC void
F_113 (
...
if ( V_152 > V_153 )
V_152 = V_153 ;
F_104 ( V_9 , V_1 -> V_134 + 1 , & V_64 , & V_18 ,
V_97 , V_152 ) ;
}
V_154 = 0 ;
if ( V_18 -> V_49 != V_50 && F_12 ( V_18 ) )
V_154 = F_13 ( V_18 ) ;
F_80 ( V_97 , V_151 , V_154 ) ;
return 0 ;
error:
if ( V_151 )
F_81 ( V_151 ) ;
...
struct V_96 * V_97 )
{
F_125 ( F_6 ( V_124 -> V_146 ) , V_165 ) ;
return F_126 ( V_124 , V_97 ) ;
}
STATIC int
F_127 (
struct V_1 * V_1 ,
...
void * * V_204 )
{
T_9 V_134 = V_195 >> V_161 ;
struct V_1 * V_1 ;
int V_205 ;
ASSERT ( V_131 <= V_137 ) ;
V_1 = F_154 ( V_124 , V_134 ,
V_157 | V_206 ) ;
if ( ! V_1 )
return - V_207 ;
V_205 = F_155 ( V_1 , V_195 , V_131 , F_143 ) ;
if ( F_156 ( V_205 ) ) {
struct V_9 * V_9 = V_124 -> V_146 ;
F_151 ( V_9 , V_1 , V_195 , V_131 ) ;
F_75 ( V_1 ) ;
if ( V_195 + V_131 > F_120 ( V_9 ) )
F_157 ( V_9 , V_195 + V_131 , F_120 ( V_9 ) ) ;
F_158 ( V_1 ) ;
V_1 = NULL ;
}
* V_203 = V_1 ;
...
int V_180 ;
ASSERT ( V_131 <= V_137 ) ;
V_180 = F_160 ( V_202 , V_124 , V_195 , V_131 , V_208 , V_1 , V_204 ) ;
if ( F_156 ( V_180 < V_131 ) ) {
struct V_9 * V_9 = V_124 -> V_146 ;
T_12 V_45 = F_120 ( V_9 ) ;
...
F_24 ( V_11 , V_210 ) ;
return F_164 ( V_124 , V_209 , F_143 ) ;
}
STATIC int
F_165 (
struct V_202 * V_212 ,
...
unsigned V_214 )
{
return F_168 ( V_124 , V_145 , V_214 , F_143 ) ;
}
