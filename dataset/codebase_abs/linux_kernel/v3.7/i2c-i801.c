...
static void T_10 F_53 ( struct V_1 * V_2 )
{
if ( V_2 -> V_128 )
F_54 ( V_2 -> V_128 ) ;
}
static unsigned int T_9 F_55 ( struct V_1 * V_2 )
{
...
static int T_9 F_57 ( struct V_5 * V_6 ,
const struct V_137 * V_131 )
{
unsigned char V_138 ;
int V_116 , V_33 ;
struct V_1 * V_2 ;
...
V_6 -> V_111 == V_159 )
V_2 -> V_24 |= V_25 ;
for ( V_33 = 0 ; V_33 < F_42 ( V_160 ) ; V_33 ++ ) {
if ( V_2 -> V_24 & V_161 & ( 1 << V_33 ) )
F_60 ( & V_6 -> V_6 , L_23 ,
V_160 [ V_33 ] ) ;
}
V_2 -> V_24 &= ~ V_161 ;
...
V_116 = F_63 ( & V_6 -> V_165 [ V_163 ] ) ;
if ( V_116 ) {
V_116 = - V_164 ;
goto exit;
}
V_116 = F_64 ( V_6 , V_163 , V_166 . V_98 ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 , L_27
L_28 , V_2 -> V_162 ,
( unsigned long long ) F_65 ( V_6 , V_163 ) ) ;
goto exit;
}
...
if ( V_2 -> V_24 & V_25 ) {
F_67 ( & V_2 -> V_28 ) ;
V_116 = F_68 ( V_6 -> V_46 , F_20 , V_170 ,
V_166 . V_98 , V_2 ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 , L_31 ,
V_6 -> V_46 , V_116 ) ;
...
static void T_10 F_74 ( struct V_5 * V_6 )
{
struct V_1 * V_2 = F_75 ( V_6 ) ;
F_53 ( V_2 ) ;
F_76 ( & V_2 -> V_84 ) ;
F_28 ( V_6 , V_59 , V_2 -> V_167 ) ;
if ( V_2 -> V_24 & V_25 )
F_71 ( V_6 -> V_46 , V_2 ) ;
F_72 ( V_6 , V_163 ) ;
F_70 ( V_6 , NULL ) ;
...
static int F_77 ( struct V_5 * V_6 , T_11 V_174 )
{
struct V_1 * V_2 = F_75 ( V_6 ) ;
F_78 ( V_6 ) ;
F_28 ( V_6 , V_59 , V_2 -> V_167 ) ;
F_79 ( V_6 , F_80 ( V_6 , V_174 ) ) ;
return 0 ;
}
