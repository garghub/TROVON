...
V_1 -> V_4 = F_30 ( V_74 -> V_82 , F_31 ( V_74 ) ) ;
if ( ! V_1 -> V_4 ) {
V_75 = - V_78 ;
goto V_81;
}
...
V_74 = F_29 ( V_34 , V_84 , 0 ) ;
if ( ! V_74 ) {
V_75 = - V_80 ;
goto V_83;
}
V_1 -> V_85 = V_74 -> V_82 ;
V_1 -> V_13 = ( V_48 -> V_86 ? V_87 : 0 ) ;
V_1 -> V_36 = V_48 -> V_36 ;
if ( V_74 -> V_88 & V_89 )
F_33 ( V_1 -> V_85 , V_90 ) ;
if ( V_74 -> V_88 & V_91 )
F_33 ( V_1 -> V_85 , V_92 ) ;
V_75 = F_34 ( V_1 -> V_85 , F_5 ,
V_93 | V_94 , L_23 , V_1 ) ;
if ( V_75 )
goto V_83;
F_17 ( V_1 ) ;
...
static int F_39 ( struct V_72 * V_34 , T_6 V_97 )
{
struct V_1 * V_1 = F_40 ( V_34 ) ;
F_18 ( V_1 ) ;
return 0 ;
}
static int F_41 ( struct V_72 * V_34 )
{
struct V_1 * V_1 = F_40 ( V_34 ) ;
F_17 ( V_1 ) ;
return 0 ;
}
static int F_42 ( struct V_72 * V_34 )
{
struct V_1 * V_1 = F_40 ( V_34 ) ;
F_43 ( & V_95 ) ;
F_18 ( V_1 ) ;
