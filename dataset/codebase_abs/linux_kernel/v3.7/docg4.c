...
if ( V_98 & V_105 ) {
V_100 = F_18 ( V_4 , V_5 , V_36 ) ;
if ( V_100 == - V_48 )
V_4 -> V_106 . V_107 ++ ;
else
V_4 -> V_106 . V_108 += V_100 ;
}
}
F_2 ( 0 , V_1 + V_72 ) ;
if ( V_100 == - V_48 )
...
memset ( V_9 -> V_41 , 0xff , V_4 -> V_137 ) ;
for ( V_7 = 0 ; V_7 < V_132 -> V_6 ; V_7 ++ )
V_9 -> V_41 [ V_132 -> V_138 + V_7 ] = ~ V_132 -> V_139 [ V_7 ] ;
F_32 ( V_4 , V_86 ) ;
F_44 ( V_4 , V_9 , V_5 , 1 ) ;
V_130 = F_29 ( V_4 ) ;
if ( ! V_130 )
...
V_9 -> V_171 = V_172 | V_173 ;
V_9 -> V_12 = V_9 -> V_13 = V_15 -> V_18 + V_56 ;
V_9 -> V_174 = & V_9 -> V_175 ;
F_55 ( & V_9 -> V_174 -> V_176 ) ;
F_56 ( & V_9 -> V_174 -> V_177 ) ;
V_9 -> V_178 = F_34 ;
V_9 -> V_179 = F_13 ;
V_9 -> V_180 = F_14 ;
V_9 -> V_181 = F_25 ;
...
V_9 -> V_110 . F_35 = F_38 ;
V_9 -> V_110 . F_42 = F_44 ;
V_9 -> V_110 . V_188 = F_37 ;
V_9 -> V_110 . V_189 = F_43 ;
V_9 -> V_110 . V_190 = F_39 ;
V_9 -> V_110 . V_191 = F_45 ;
if ( V_40 ) {
V_9 -> V_171 |= V_192 ;
V_9 -> V_193 = F_50 ;
}
...
int V_6 , V_63 ;
struct V_201 * V_202 ;
struct V_203 * V_19 = & V_142 -> V_19 ;
V_202 = F_60 ( V_142 , V_204 , 0 ) ;
if ( V_202 == NULL ) {
F_10 ( V_19 , L_35 ) ;
return - V_200 ;
}
V_18 = F_61 ( V_202 -> V_205 , F_62 ( V_202 ) ) ;
if ( ! V_18 ) {
F_10 ( V_19 , L_36 , V_202 ) ;
return - V_62 ;
}
...
V_15 -> V_19 = V_19 ;
F_54 ( V_4 ) ;
V_15 -> V_46 = F_63 ( V_209 , V_170 , V_210 ) ;
if ( V_15 -> V_46 == NULL ) {
V_63 = - V_211 ;
goto V_206;
}
...
if ( V_63 )
goto V_206;
V_63 = F_66 ( V_4 , V_212 , NULL , NULL , 0 ) ;
if ( V_63 )
goto V_206;
V_15 -> V_4 = V_4 ;
return 0 ;
