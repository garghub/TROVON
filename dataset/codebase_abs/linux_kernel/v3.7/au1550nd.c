...
static int T_2 F_29 ( unsigned long V_56 )
{
void T_3 * V_20 =
( void T_3 * ) F_30 ( V_57 ) ;
...
static int T_2 F_32 ( struct V_64 * V_65 )
{
struct V_66 * V_67 ;
struct V_16 * V_17 ;
struct V_3 * V_4 ;
...
V_17 = F_34 ( sizeof( * V_17 ) , V_72 ) ;
if ( ! V_17 ) {
F_33 ( & V_65 -> V_70 , L_2 ) ;
return - V_73 ;
}
V_69 = F_35 ( V_65 , V_74 , 0 ) ;
if ( ! V_69 ) {
F_33 ( & V_65 -> V_70 , L_3 ) ;
V_6 = - V_63 ;
goto V_75;
}
if ( F_36 ( V_69 -> V_60 , F_37 ( V_69 ) , L_4 ) ) {
F_33 ( & V_65 -> V_70 , L_5 ) ;
V_6 = - V_73 ;
goto V_75;
}
V_17 -> V_20 = F_38 ( V_69 -> V_60 , 0x1000 ) ;
if ( ! V_17 -> V_20 ) {
F_33 ( & V_65 -> V_70 , L_6 ) ;
V_6 = - V_63 ;
goto V_76;
...
if ( V_67 -> V_85 )
V_4 -> V_45 |= V_46 ;
V_4 -> V_86 = ( V_67 -> V_85 ) ? F_6 : F_1 ;
V_17 -> V_44 = ( V_67 -> V_85 ) ? F_9 : F_4 ;
V_4 -> V_87 = F_12 ;
V_4 -> V_88 = ( V_67 -> V_85 ) ? F_15 : F_13 ;
V_4 -> V_89 = ( V_67 -> V_85 ) ? F_16 : F_14 ;
V_6 = F_39 ( & V_17 -> V_18 , 1 ) ;
if ( V_6 ) {
F_33 ( & V_65 -> V_70 , L_8 , V_6 ) ;
goto V_79;
}
F_40 ( & V_17 -> V_18 , V_67 -> V_90 , V_67 -> V_91 ) ;
return 0 ;
V_79:
F_41 ( V_17 -> V_20 ) ;
V_76:
F_42 ( V_69 -> V_60 , F_37 ( V_69 ) ) ;
V_75:
F_43 ( V_17 ) ;
return V_6 ;
}
...
{
struct V_16 * V_17 = F_45 ( V_65 ) ;
struct V_68 * V_69 = F_35 ( V_65 , V_74 , 0 ) ;
F_46 ( & V_17 -> V_18 ) ;
F_41 ( V_17 -> V_20 ) ;
F_42 ( V_69 -> V_60 , 0x1000 ) ;
F_43 ( V_17 ) ;
return 0 ;
}
