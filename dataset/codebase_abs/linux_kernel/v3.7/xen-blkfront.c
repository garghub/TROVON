...
V_161 = F_117 ( V_210 , V_50 -> V_212 , L_41 , L_42 ,
V_214 ) ;
if ( V_161 ) {
V_208 = L_43 ;
goto V_213;
...
const struct V_217 * V_9 )
{
int V_161 , V_129 , V_48 ;
struct V_1 * V_2 ;
V_161 = F_121 ( V_218 , V_50 -> V_212 ,
L_45 , L_46 , & V_129 ) ;
if ( V_161 != 1 ) {
V_161 = F_121 ( V_218 , V_50 -> V_212 , L_47 ,
L_46 , & V_129 ) ;
if ( V_161 != 1 ) {
...
type = F_122 ( V_218 , V_50 -> V_212 , L_50 , & V_219 ) ;
if ( F_123 ( type ) )
return - V_156 ;
...
V_2 -> V_78 = F_128 ( strrchr ( V_50 -> V_212 , '/' ) + 1 , NULL , 0 ) ;
F_129 ( & V_50 -> V_50 , V_2 ) ;
...
struct V_186 * V_224 ;
int V_225 ;
V_224 = F_131 ( sizeof( V_2 -> V_5 ) ,
V_205 | V_226 | V_206 ) ;
if ( ! V_224 )
return - V_27 ;
memcpy ( V_224 , V_2 -> V_5 , sizeof( V_2 -> V_5 ) ) ;
...
memcpy ( & V_2 -> V_5 [ V_6 -> V_7 . V_8 . V_9 ] , & V_224 [ V_48 ] , sizeof( V_224 [ V_48 ] ) ) ;
if ( V_6 -> V_79 != V_18 ) {
for ( V_225 = 0 ; V_225 < V_6 -> V_7 . V_8 . V_91 ; V_225 ++ )
F_38 (
V_6 -> V_7 . V_8 . V_98 [ V_225 ] . V_100 ,
V_2 -> V_49 -> V_96 ,
F_34 ( V_2 -> V_5 [ V_6 -> V_7 . V_8 . V_9 ] . V_97 [ V_225 ] ) ,
...
int V_161 ;
F_22 ( & V_50 -> V_50 , L_53 , V_50 -> V_212 ) ;
...
unsigned int V_121 ;
unsigned int V_232 ;
type = F_122 ( V_218 , V_2 -> V_49 -> V_233 , L_55 , NULL ) ;
if ( F_123 ( type ) )
return;
V_2 -> V_88 = 0 ;
if ( strncmp ( type , L_56 , 3 ) == 0 ) {
V_161 = F_142 ( V_218 , V_2 -> V_49 -> V_233 ,
L_57 , L_37 , & V_120 ,
L_58 , L_37 , & V_121 ,
NULL ) ;
if ( ! V_161 ) {
...
unsigned int V_234 ;
int V_161 ;
int V_235 , V_236 , V_86 ;
switch ( V_2 -> V_70 ) {
case V_71 :
V_161 = F_121 ( V_218 , V_2 -> V_49 -> V_233 ,
L_61 , L_62 , & V_42 ) ;
if ( F_144 ( V_161 ) )
return;
F_66 ( V_127 L_63 ,
...
if ( ! V_161 && V_86 )
F_141 ( V_2 ) ;
V_161 = F_71 ( V_42 , V_2 , V_234 , V_114 ) ;
if ( V_161 ) {
...
struct V_34 * V_43 = NULL ;
struct V_56 * V_247 ;
F_22 ( & V_49 -> V_50 , L_75 , V_49 -> V_212 ) ;
F_93 ( V_2 , 0 ) ;
F_135 ( & V_2 -> V_223 ) ;
V_247 = V_2 -> V_57 ;
if ( V_247 )
...
{
struct V_1 * V_2 = F_133 ( & V_50 -> V_50 ) ;
return V_2 -> V_238 && V_2 -> V_49 ;
}
static int F_152 ( struct V_34 * V_43 , T_2 V_44 )
{
struct V_56 * V_247 = V_43 -> V_39 ;
struct V_1 * V_2 ;
int V_161 = 0 ;
F_135 ( & V_248 ) ;
V_2 = V_247 -> V_47 ;
...
static int F_153 ( struct V_56 * V_247 , T_2 V_44 )
{
struct V_1 * V_2 = V_247 -> V_47 ;
struct V_34 * V_43 ;
struct V_203 * V_49 ;
F_135 ( & V_248 ) ;
V_43 = F_137 ( V_247 , 0 ) ;
