...
if ( V_106 . V_114 ) {
V_3 |= 0x20 ;
F_15 ( V_6 , V_121 , ( V_106 . V_114 >> 18 ) & 0x3f ) ;
F_15 ( V_6 , V_122 , ( V_106 . V_114 >> 9 ) & 0x1ff ) ;
F_15 ( V_6 , V_123 , V_106 . V_114 & 0x1ff ) ;
}
F_15 ( V_6 , V_120 , V_3 ) ;
...
V_118 = F_38 ( V_6 , 7 , 9 , V_133 ) ;
if ( V_118 < 0 ) {
F_19 ( V_6 -> V_2 , L_10 , V_118 ) ;
return V_118 ;
}
V_118 = F_39 ( V_6 ) ;
if ( V_118 < 0 ) {
...
static T_3 int F_42 ( struct V_145 * V_146 ,
const struct V_147 * V_148 )
{
struct V_24 * V_25 = F_36 ( & V_146 -> V_2 ) ;
struct V_7 * V_8 ;
int V_118 ;
V_8 = F_43 ( & V_146 -> V_2 , sizeof( struct V_7 ) ,
V_149 ) ;
if ( V_8 == NULL )
return - V_150 ;
V_8 -> V_87 = F_44 ( V_146 , & V_151 ) ;
if ( F_45 ( V_8 -> V_87 ) )
return F_46 ( V_8 -> V_87 ) ;
if ( V_25 && V_25 -> V_152 ) {
V_118 = F_47 ( V_8 -> V_87 , V_153 ,
0x4 , 0x4 ) ;
if ( V_118 != 0 ) {
F_19 ( & V_146 -> V_2 , L_12 ,
V_118 ) ;
...
F_48 ( V_146 , V_8 ) ;
V_118 = F_49 ( & V_146 -> V_2 ,
& V_154 , & V_155 , 1 ) ;
return V_118 ;
}
static T_4 int F_50 ( struct V_145 * V_156 )
{
F_51 ( & V_156 -> V_2 ) ;
return 0 ;
}
