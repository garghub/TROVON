...
static int T_7 F_191 ( struct V_360 * V_361 )
{
struct V_1 * V_1 = F_28 ( & V_361 -> V_65 ) ;
struct V_250 * V_251 = F_92 ( V_1 ) ;
F_192 ( & V_1 -> V_194 ) ;
F_193 ( V_251 ) ;
F_194 ( V_1 -> V_3 ) ;
...
static int T_8 F_197 ( struct V_360 * V_361 )
{
char V_362 [ 8 ] ;
...
V_364 = F_199 ( V_361 , V_371 , 0 ) ;
if ( ! V_364 ) {
V_37 = - V_188 ;
F_48 ( & V_361 -> V_65 , L_24 ) ;
goto V_370;
}
V_365 = F_199 ( V_361 , V_372 , 0 ) ;
if ( ! V_365 ) {
V_37 = - V_188 ;
F_48 ( & V_361 -> V_65 ,
L_25 ) ;
...
V_3 = F_200 ( V_364 -> V_373 , F_201 ( V_364 ) ) ;
if ( V_3 == NULL ) {
V_37 = - V_106 ;
...
V_251 = F_202 ( & V_376 , & V_361 -> V_65 , ( char * ) V_377 ) ;
if ( ! V_251 ) {
V_37 = - V_106 ;
