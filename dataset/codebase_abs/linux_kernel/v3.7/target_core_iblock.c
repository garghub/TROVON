...
T_4 V_109 = 0 ;
if ( V_19 )
V_109 += sprintf ( V_107 + V_109 , L_28 ,
F_50 ( V_19 , V_75 ) ) ;
if ( V_74 -> V_103 & V_104 )
V_109 += sprintf ( V_107 + V_109 , L_29 ,
V_74 -> V_31 ) ;
V_109 += sprintf ( V_107 + V_109 , L_30 , V_74 -> V_34 ) ;
V_109 += sprintf ( V_107 + V_109 , L_31 ) ;
if ( V_19 ) {
V_109 += sprintf ( V_107 + V_109 , L_32 ,
F_51 ( V_19 -> V_110 ) , F_52 ( V_19 -> V_110 ) , ( ! V_19 -> V_111 ) ?
L_33 : ( V_19 -> V_112 == V_74 ) ?
L_34 : L_35 ) ;
} else {
V_109 += sprintf ( V_107 + V_109 , L_36 ) ;
}
return V_109 ;
}
...
static struct V_59 *
F_56 ( struct V_61 * V_62 , T_3 V_77 , T_1 V_119 )
{
struct V_8 * V_9 = V_62 -> V_13 -> V_68 ;
struct V_59 * V_59 ;
if ( V_119 > V_120 )
V_119 = V_120 ;
V_59 = F_57 ( V_121 , V_119 , V_9 -> V_28 ) ;
if ( ! V_59 ) {
F_6 ( L_37 ) ;
return NULL ;
}
...
static void F_58 ( struct V_124 * V_125 , int V_126 )
{
struct V_127 V_128 ;
struct V_59 * V_59 ;
F_59 ( & V_128 ) ;
while ( ( V_59 = F_60 ( V_125 ) ) )
F_30 ( V_126 , V_59 ) ;
F_61 ( & V_128 ) ;
}
static int F_62 ( struct V_61 * V_62 )
{
struct V_129 * V_130 = V_62 -> V_131 ;
T_1 V_132 = V_62 -> V_133 ;
enum V_134 V_135 = V_62 -> V_135 ;
struct V_11 * V_15 = V_62 -> V_13 ;
struct V_113 * V_114 ;
struct V_59 * V_59 ;
struct V_124 V_125 ;
...
int V_139 ;
if ( V_135 == V_140 ) {
if ( V_15 -> V_46 -> V_47 . V_141 == 0 ||
( V_15 -> V_46 -> V_47 . V_142 > 0 &&
( V_62 -> V_143 & V_144 ) ) )
V_126 = V_145 ;
else
V_126 = V_146 ;
...
F_63 ( & V_114 -> V_117 , 2 ) ;
V_138 = 1 ;
F_66 (sgl, sg, sgl_nents, i) {
while ( F_67 ( V_59 , F_68 ( V_136 ) , V_136 -> V_151 , V_136 -> V_152 )
!= V_136 -> V_151 ) {
if ( V_138 >= V_153 ) {
F_58 ( & V_125 , V_126 ) ;
V_138 = 0 ;
}
V_59 = F_56 ( V_62 , V_137 , V_119 ) ;
if ( ! V_59 )
goto V_154;
F_69 ( & V_114 -> V_117 ) ;
F_65 ( & V_125 , V_59 ) ;
...
static T_1 F_70 ( struct V_11 * V_15 )
{
return V_156 ;
}
...
static T_3 F_72 ( struct V_11 * V_15 )
{
struct V_8 * V_74 = V_15 -> V_68 ;
struct V_18 * V_19 = V_74 -> V_44 ;
...
static void V_122 ( struct V_59 * V_59 , int V_60 )
{
struct V_61 * V_62 = V_59 -> V_63 ;
struct V_113 * V_114 = V_62 -> V_115 ;
if ( ! F_73 ( V_158 , & V_59 -> V_159 ) && ! V_60 )
V_60 = - V_160 ;
if ( V_60 != 0 ) {
F_6 ( L_40
L_41 , V_59 , V_60 ) ;
