...
int T_4 F_101 ( struct V_1 * V_2 , int V_191 , struct V_192 * * V_193 )
{
struct V_192 * V_51 ;
int V_116 ;
if ( V_193 )
...
static int F_102 ( struct V_96 * V_208 , struct V_209 * V_210 )
{
V_210 -> type = V_211 ;
V_210 -> V_212 = 1 ;
return 0 ;
}
static int F_103 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
...
static int F_105 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
unsigned int V_5 ;
...
static int F_106 ( struct V_96 * V_208 , struct V_209 * V_210 )
{
V_210 -> type = V_211 ;
V_210 -> V_212 = 1 ;
return 0 ;
}
static int F_107 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_108 ( struct V_96 * V_208 , struct V_209 * V_210 )
{
V_210 -> type = V_211 ;
V_210 -> V_212 = 1 ;
return 0 ;
}
static int F_109 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_110 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
unsigned int V_5 ;
...
static int F_111 ( struct V_96 * V_208 , struct V_209 * V_219 )
{
static const char * const V_220 [ 3 ] = { L_6 , L_10 , L_11 } ;
return F_112 ( V_219 , 1 , 3 , V_220 ) ;
}
static int F_113 ( struct V_96 * V_208 , struct V_213 * V_215 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
T_3 V_8 ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_114 ( struct V_96 * V_208 , struct V_213 * V_215 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
T_3 V_8 , V_224 ;
F_52 ( & V_2 -> V_30 ) ;
...
static int F_115 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
int V_8 = V_208 -> V_225 & 0xffff ;
unsigned int V_95 = ( V_208 -> V_225 >> 16 ) & 0xff ;
...
( F_9 ( V_2 , V_8 ) >> V_95 ) & V_226 ;
return 0 ;
}
static int F_116 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
int V_8 = V_208 -> V_225 & 0xffff ;
...
F_52 ( & V_2 -> V_30 ) ;
V_228 = F_9 ( V_2 , V_8 ) ;
V_5 = ( V_228 & ~ ( V_226 << V_95 ) ) | V_5 ;
V_218 = V_5 != V_228 ;
F_11 ( V_2 , V_8 , V_5 ) ;
F_53 ( & V_2 -> V_30 ) ;
return V_218 ;
}
static int F_117 ( struct V_96 * V_208 , struct V_209 * V_210 )
{
...
static int F_118 ( struct V_96 * V_208 , struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
unsigned int V_8 = V_208 -> V_225 ;
...
static int F_119 ( struct V_96 * V_208 , struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
unsigned int V_8 = V_208 -> V_225 ;
unsigned int V_232 = 0 , V_233 = 16 , V_226 = 16383 ;
...
static int F_120 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
...
static int F_121 ( struct V_96 * V_208 , struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
V_214 -> V_215 . integer . V_215 [ 0 ] = V_2 -> V_182 ;
return 0 ;
}
static int F_122 ( struct V_96 * V_208 , struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
int V_218 ;
...
static int F_125 ( struct V_96 * V_208 , struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
...
static int F_126 ( struct V_96 * V_208 , struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
int V_239 = ( int ) V_208 -> V_225 ;
...
static int F_127 ( struct V_96 * V_208 ,
struct V_209 * V_210 )
{
V_210 -> type = V_229 ;
V_210 -> V_212 = 2 ;
...
static int F_128 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
unsigned int V_78 = V_208 -> V_113 . V_245 ;
V_214 -> V_215 . integer . V_215 [ 0 ] = V_2 -> V_82 [ V_78 ] . V_83 ;
V_214 -> V_215 . integer . V_215 [ 1 ] = V_2 -> V_82 [ V_78 ] . V_87 ;
return 0 ;
}
static int F_129 ( struct V_96 * V_208 ,
struct V_213 * V_214 )
{
struct V_1 * V_2 = F_104 ( V_208 ) ;
unsigned int V_78 = V_208 -> V_113 . V_245 ;
struct V_90 * V_69 ;
unsigned long V_29 ;
if ( V_214 -> V_215 . integer . V_215 [ 0 ] != V_2 -> V_82 [ V_78 ] . V_83 ||
V_214 -> V_215 . integer . V_215 [ 1 ] != V_2 -> V_82 [ V_78 ] . V_87 ) {
V_2 -> V_82 [ V_78 ] . V_83 = V_214 -> V_215 . integer . V_215 [ 0 ] ;
V_2 -> V_82 [ V_78 ] . V_87 = V_214 -> V_215 . integer . V_215 [ 1 ] ;
if ( V_2 -> V_82 [ V_78 ] . V_83 > 0x8000 )
V_2 -> V_82 [ V_78 ] . V_83 = 0x8000 ;
if ( V_2 -> V_82 [ V_78 ] . V_87 > 0x8000 )
V_2 -> V_82 [ V_78 ] . V_87 = 0x8000 ;
V_69 = (struct V_90 * ) V_208 -> V_225 ;
F_24 ( & V_2 -> V_59 , V_29 ) ;
...
int T_4 F_132 ( struct V_1 * V_2 , int V_249 )
{
struct V_250 V_15 ;
struct V_96 * V_97 ;
struct V_90 * V_69 ;
...
if ( ( V_116 = V_246 ( V_2 -> V_111 , 0 , & V_252 , V_2 , & V_2 -> V_248 ) ) < 0 )
return V_116 ;
...
V_15 . V_16 = V_2 ;
V_15 . V_178 = F_131 ;
if ( ( V_116 = F_133 ( V_2 -> V_248 , & V_15 , & V_2 -> V_15 ) ) < 0 )
return V_116 ;
F_134 ( V_2 -> V_15 , V_256 ,
V_257 | V_258 , 0 ) ;
for ( V_46 = 0 ; V_46 < F_135 ( V_259 ) ; V_46 ++ ) {
if ( ( V_116 = F_136 ( V_2 -> V_111 , F_137 ( & V_259 [ V_46 ] , V_2 ) ) ) < 0 )
return V_116 ;
}
if ( V_2 -> V_15 -> V_260 & V_261 ) {
V_97 = F_137 ( & V_262 , V_2 ) ;
V_116 = F_136 ( V_2 -> V_111 , V_97 ) ;
if ( V_116 < 0 )
return V_116 ;
}
if ( F_32 ( ! V_2 -> V_204 ) )
return - V_263 ;
if ( ( V_116 = F_136 ( V_2 -> V_111 , V_97 = F_137 ( & V_264 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_204 -> V_191 ;
if ( ( V_116 = F_136 ( V_2 -> V_111 , V_97 = F_137 ( & V_265 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_204 -> V_191 ;
if ( ( V_116 = F_136 ( V_2 -> V_111 , V_97 = F_137 ( & V_266 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_204 -> V_191 ;
V_2 -> V_187 = V_97 ;
if ( V_2 -> V_22 == V_128 &&
( V_116 = F_136 ( V_2 -> V_111 , V_97 = F_137 ( & V_267 , V_2 ) ) ) < 0 )
return V_116 ;
if ( V_249 ) {
if ( ( V_116 = F_136 ( V_2 -> V_111 , F_137 ( & V_268 , V_2 ) ) ) < 0 )
return V_116 ;
}
V_69 = V_2 -> V_51 -> V_269 [ V_194 ] . V_69 ;
for ( V_46 = 0 ; V_46 < 32 ; ++ V_46 ) {
V_97 = F_137 ( & V_270 , V_2 ) ;
if ( ! V_97 )
return - V_56 ;
V_97 -> V_113 . V_191 = V_2 -> V_51 -> V_191 ;
V_97 -> V_113 . V_245 = V_46 ;
V_97 -> V_225 = ( unsigned long ) V_69 ;
if ( ( V_116 = F_136 ( V_2 -> V_111 , V_97 ) ) < 0 )
return V_116 ;
...
int T_4 F_142 ( struct V_1 * V_2 , int V_191 )
{
...
V_279 . V_280 = V_281 ;
V_279 . V_282 = V_283 ;
V_279 . V_111 = V_2 -> V_111 -> V_61 ;
V_279 . V_191 = V_191 ;
V_279 . V_245 = 0 ;
if ( ( V_116 = F_143 ( V_2 -> V_111 , L_2 , & V_279 , & V_168 ) ) >= 0 ) {
...
struct V_287 * V_288 )
{
struct V_1 * V_2 = V_286 -> V_16 ;
int V_25 ;
F_145 ( V_288 , L_13 ) ;
for ( V_25 = 0 ; V_25 <= V_289 ; V_25 += 4 )
F_145 ( V_288 , L_14 , V_25 , F_9 ( V_2 , V_25 ) ) ;
}
static int T_4 F_146 ( struct V_290 * V_111 , struct V_1 * V_2 )
{
struct V_285 * V_286 ;
if ( ! F_147 ( V_111 , L_15 , & V_286 ) )
...
{
T_1 V_17 ;
F_150 ( V_143 , V_292 , & V_17 ) ;
#if 0
if (cmd & 0x03) {
#endif
F_151 ( V_143 , V_292 , V_17 & 0xfc ) ;
F_151 ( V_143 , V_292 , V_17 | 0x03 ) ;
F_151 ( V_143 , V_292 , V_17 & 0xfc ) ;
F_152 ( V_143 , V_293 , 0 ) ;
F_152 ( V_143 , V_294 , 0 ) ;
#if 0
...
if ( V_116 < 0 )
return V_116 ;
V_296 = V_2 -> V_22 == V_301 ||
V_2 -> V_22 == V_302 ||
V_2 -> V_22 == V_23 ||
V_2 -> V_22 == V_128 ;
V_199 = V_296 ? L_18 : L_19 ;
V_116 = F_156 ( & V_2 -> V_303 , V_199 ,
& V_2 -> V_143 -> V_298 ) ;
if ( V_116 >= 0 ) {
if ( V_2 -> V_303 -> V_299 != V_304 ) {
F_17 ( V_12 L_20
L_21 ) ;
V_116 = - V_58 ;
}
...
F_11 ( V_2 , V_309 , 0x00000000 ) ;
V_305 = F_5 ( V_2 , V_221 ) ;
F_7 ( V_2 , V_221 , V_305 & ~ 0x0007 ) ;
V_306 = ( const T_8 * ) V_2 -> V_297 -> V_310 ;
for ( V_25 = 0 ; V_25 < V_300 / 4 ; V_25 ++ )
F_11 ( V_2 , V_311 + ( V_25 << 2 ) ,
F_36 ( V_306 [ V_25 ] ) ) ;
V_306 = ( const T_8 * ) V_2 -> V_303 -> V_310 ;
for ( V_25 = 0 ; V_25 < V_304 / 4 ; V_25 ++ )
F_11 ( V_2 , V_312 + ( V_25 << 2 ) ,
F_36 ( V_306 [ V_25 ] ) ) ;
F_153 ( V_2 ) ;
}
static int T_4 F_158 ( struct V_1 * V_2 )
{
long V_299 , V_313 ;
int V_44 , V_71 , V_8 ;
T_1 * V_314 ;
...
V_2 -> V_320 = F_9 ( V_2 , V_321 ) << 2 ;
V_2 -> V_322 = V_323 ;
V_299 = F_159 ( V_313 , 0x100 ) +
F_159 ( V_2 -> V_316 * 2 * V_47 , 0x100 ) +
F_159 ( V_2 -> V_318 * 2 * V_165 , 0x100 ) +
F_159 ( V_2 -> V_320 * 2 * V_324 , 0x100 ) +
V_2 -> V_322 ;
if ( F_50 ( V_142 , F_51 ( V_2 -> V_143 ) ,
V_299 , & V_2 -> V_325 ) < 0 )
return - V_56 ;
V_314 = V_2 -> V_325 . V_148 ;
V_315 = V_2 -> V_325 . V_146 ;
memset ( V_314 , 0 , V_299 ) ;
V_2 -> V_326 = V_314 ;
V_2 -> V_327 = V_315 ;
V_2 -> V_102 = ( T_2 * ) V_314 ;
V_2 -> V_102 [ 0 ] = F_40 ( V_47 ) ;
V_314 += F_159 ( V_313 , 0x100 ) ;
V_315 += F_159 ( V_313 , 0x100 ) ;
for ( V_44 = 0 ; V_44 < V_47 ; V_44 ++ ) {
V_2 -> V_48 [ V_44 ] . V_61 = V_44 ;
V_2 -> V_48 [ V_44 ] . V_71 = (struct V_80 * ) V_314 ;
V_2 -> V_48 [ V_44 ] . V_103 = V_315 ;
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
V_2 -> V_328 [ V_44 ] [ V_71 ] = (struct V_80 * ) V_314 ;
V_314 += V_2 -> V_316 ;
V_315 += V_2 -> V_316 ;
}
}
V_314 = ( char * ) F_159 ( ( unsigned long ) V_314 , 0x100 ) ;
V_315 = F_159 ( V_315 , 0x100 ) ;
V_2 -> V_329 = V_314 ;
V_2 -> V_330 = V_315 ;
for ( V_44 = 0 ; V_44 < V_165 ; V_44 ++ )
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
V_2 -> V_93 [ V_44 ] [ V_71 ] = (struct V_152 * ) V_314 ;
V_314 += V_2 -> V_318 ;
V_315 += V_2 -> V_318 ;
}
V_314 = ( char * ) F_159 ( ( unsigned long ) V_314 , 0x100 ) ;
...
V_2 -> V_331 = V_314 ;
V_2 -> V_332 = V_315 ;
for ( V_44 = 0 ; V_44 < V_324 ; V_44 ++ )
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
V_2 -> V_145 [ V_44 ] [ V_71 ] = (struct V_333 * ) V_314 ;
V_314 += V_2 -> V_320 ;
V_315 += V_2 -> V_320 ;
}
V_314 = ( char * ) F_159 ( ( unsigned long ) V_314 , 0x100 ) ;
...
V_2 -> V_334 = V_314 ;
V_2 -> V_335 = V_315 ;
F_32 ( V_314 + V_2 -> V_322 !=
V_2 -> V_325 . V_148 + V_2 -> V_325 . V_336 ) ;
F_11 ( V_2 , V_307 , V_2 -> V_327 ) ;
F_11 ( V_2 , V_308 , V_2 -> V_330 ) ;
F_11 ( V_2 , V_309 , V_2 -> V_332 ) ;
F_11 ( V_2 , V_289 , V_2 -> V_335 ) ;
F_11 ( V_2 , V_337 , V_2 -> V_322 >> 2 ) ;
V_2 -> V_185 = V_2 -> V_184 = V_338 & 0xffff ;
F_7 ( V_2 , V_183 , 0 ) ;
F_7 ( V_2 , V_186 , V_2 -> V_185 ) ;
F_7 ( V_2 , V_227 , 0 ) ;
...
F_55 ( & V_2 -> V_325 ) ;
F_164 ( V_2 -> V_345 ) ;
F_152 ( V_2 -> V_143 , 0x40 , V_2 -> V_349 ) ;
F_167 ( V_2 -> V_143 ) ;
F_168 ( V_2 -> V_297 ) ;
F_168 ( V_2 -> V_303 ) ;
F_77 ( V_2 ) ;
...
static int F_169 ( struct V_350 * V_191 )
{
struct V_1 * V_2 = V_191 -> V_351 ;
return F_160 ( V_2 ) ;
}
static int F_170 ( struct V_191 * V_298 )
{
struct V_291 * V_143 = F_171 ( V_298 ) ;
struct V_290 * V_111 = F_172 ( V_298 ) ;
...
F_174 ( V_2 -> V_206 ) ;
F_175 ( V_2 -> V_15 ) ;
for ( V_25 = 0 ; V_25 < V_353 ; V_25 ++ )
V_2 -> V_346 [ V_25 ] = F_9 ( V_2 , V_354 [ V_25 ] ) ;
V_2 -> V_355 = F_9 ( V_2 , V_33 ) ;
F_176 ( V_2 -> V_143 , V_356 ,
& V_2 -> V_357 ) ;
F_176 ( V_2 -> V_143 , V_358 ,
& V_2 -> V_359 ) ;
F_11 ( V_2 , V_236 , 0 ) ;
F_11 ( V_2 , V_238 , 0 ) ;
F_154 ( V_2 ) ;
...
static int F_179 ( struct V_191 * V_298 )
{
struct V_291 * V_143 = F_171 ( V_298 ) ;
struct V_290 * V_111 = F_172 ( V_298 ) ;
struct V_1 * V_2 = V_111 -> V_16 ;
...
F_185 ( 100 ) ;
for ( V_25 = 0 ; V_25 < V_353 ; V_25 ++ )
F_11 ( V_2 , V_354 [ V_25 ] , V_2 -> V_346 [ V_25 ] ) ;
F_186 ( V_2 -> V_15 ) ;
F_152 ( V_2 -> V_143 , V_356 ,
V_2 -> V_357 ) ;
F_152 ( V_2 -> V_143 , V_358 ,
V_2 -> V_359 ) ;
if ( V_2 -> V_31 > 0 ) {
F_52 ( & V_2 -> V_30 ) ;
F_11 ( V_2 , V_33 , V_2 -> V_355 ) ;
...
int T_4 F_187 ( struct V_290 * V_111 ,
struct V_291 * V_143 ,
unsigned short V_349 ,
struct V_1 * * V_364 )
{
struct V_1 * V_2 ;
int V_116 ;
static struct V_365 V_252 = {
. V_366 = F_169 ,
} ;
* V_364 = NULL ;
if ( ( V_116 = F_181 ( V_143 ) ) < 0 )
return V_116 ;
...
V_2 -> V_24 = V_143 -> V_367 ;
V_2 -> V_368 = F_190 ( V_143 , 0 ) ;
V_2 -> V_4 = F_191 ( V_2 -> V_368 , 0x8000 ) ;
F_184 ( V_143 ) ;
V_2 -> V_62 = - 1 ;
if ( ( V_2 -> V_345 = F_192 ( V_2 -> V_368 , 0x8000 , L_2 ) ) == NULL ) {
F_17 ( V_12 L_24 , V_2 -> V_368 , V_2 -> V_368 + 0x8000 - 1 ) ;
F_160 ( V_2 ) ;
return - V_13 ;
}
if ( F_193 ( V_143 -> V_161 , F_73 , V_369 ,
V_370 , V_2 ) ) {
...
#ifdef F_161
V_2 -> V_346 = F_194 ( V_353 * sizeof( T_2 ) ) ;
if ( V_2 -> V_346 == NULL ) {
F_160 ( V_2 ) ;
return - V_56 ;
}
#endif
if ( ( V_116 = F_195 ( V_111 , V_371 , V_2 , & V_252 ) ) < 0 ) {
F_160 ( V_2 ) ;
return V_116 ;
}
F_146 ( V_111 , V_2 ) ;
F_196 ( V_111 , & V_143 -> V_298 ) ;
* V_364 = V_2 ;
return 0 ;
}
