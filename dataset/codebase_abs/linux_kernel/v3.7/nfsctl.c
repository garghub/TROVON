...
V_57 = F_40 ( V_56 , sizeof( int ) , V_59 ) ;
V_11 = - V_50 ;
if ( V_57 == NULL )
goto V_60;
if ( V_3 > 0 ) {
for ( V_55 = 0 ; V_55 < V_56 ; V_55 ++ ) {
V_11 = F_27 ( & V_42 , & V_57 [ V_55 ] ) ;
if ( V_11 == - V_61 )
break;
if ( V_11 )
goto V_60;
...
V_42 = V_2 ;
V_3 = V_51 ;
for ( V_55 = 0 ; V_55 < V_56 && V_3 > 0 ; V_55 ++ ) {
snprintf ( V_42 , V_3 , L_4 , V_57 [ V_55 ] , ( V_55 == V_56 - 1 ? '\n' : ' ' ) ) ;
V_43 = strlen ( V_42 ) ;
V_3 -= V_43 ;
V_42 += V_43 ;
}
...
V_2 [ V_3 - 1 ] = 0 ;
V_62 = V_42 ;
V_43 = F_19 ( & V_42 , V_62 , V_3 ) ;
if ( V_43 <= 0 ) return - V_13 ;
do {
V_64 = * V_62 ;
if ( V_64 == '+' || V_64 == '-' )
V_65 = F_45 ( ( V_62 + 1 ) , & V_63 , 0 ) ;
else
V_65 = F_45 ( V_62 , & V_63 , 0 ) ;
if ( * V_63 == '.' ) {
if ( V_65 < 4 )
return - V_13 ;
V_67 = F_46 ( V_63 + 1 , NULL , 0 ) ;
if ( V_67 == 0 )
return - V_13 ;
if ( F_47 ( V_67 , V_64 == '-' ?
V_72 : V_73 ) < 0 )
...
V_74:
V_62 += V_43 + 1 ;
} while ( ( V_43 = F_19 ( & V_42 , V_62 , V_3 ) ) > 0 );
F_49 () ;
}
V_43 = 0 ;
V_69 = L_5 ;
V_66 = V_51 ;
for ( V_65 = 2 ; V_65 <= 4 ; V_65 ++ )
if ( F_48 ( V_65 , V_75 ) ) {
V_43 = snprintf ( V_2 , V_66 , L_6 , V_69 ,
F_48 ( V_65 , V_76 ) ? '+' : '-' ,
V_65 ) ;
V_69 = L_7 ;
if ( V_43 > V_66 )
...
if ( F_48 ( 4 , V_75 ) )
for ( V_67 = 1 ; V_67 <= V_77 ;
V_67 ++ ) {
V_43 = snprintf ( V_2 , V_66 , L_8 ,
( F_48 ( 4 , V_76 ) &&
F_47 ( V_67 , V_76 ) ) ?
'+' : '-' ,
V_67 ) ;
...
if ( V_70 == NULL )
return 0 ;
return F_52 ( V_70 , V_2 , V_51 ) ;
}
static T_1 F_53 ( char * V_2 )
{
char * V_42 = V_2 ;
int V_78 , V_16 ;
struct V_79 * V_79 = & V_21 ;
V_16 = F_27 ( & V_42 , & V_78 ) ;
if ( V_16 != 0 || V_78 < 0 )
return - V_13 ;
V_16 = F_54 () ;
...
return 0 ;
V_91:
V_83 = F_59 ( V_70 , V_81 , V_79 , V_86 , V_84 ) ;
if ( V_83 != NULL ) {
F_60 ( V_83 ) ;
F_61 ( V_83 ) ;
}
...
static T_1 F_65 ( struct V_1 * V_1 , char * V_2 , T_3 V_3 , T_6 * time )
{
char * V_42 = V_2 ;
int V_11 , V_55 ;
if ( V_3 > 0 ) {
...
if ( V_11 )
return V_11 ;
if ( V_55 < 10 || V_55 > 3600 )
return - V_13 ;
* time = V_55 ;
}
return F_35 ( V_2 , V_51 , L_11 , * time ) ;
}
static T_1 F_66 ( struct V_1 * V_1 , char * V_2 , T_3 V_3 , T_6 * time )
{
T_1 V_11 ;
F_37 ( & V_58 ) ;
V_11 = F_65 ( V_1 , V_2 , V_3 , time ) ;
F_39 ( & V_58 ) ;
return V_11 ;
}
static T_1 F_67 ( struct V_1 * V_1 , char * V_2 , T_3 V_3 )
{
return F_66 ( V_1 , V_2 , V_3 , & V_95 ) ;
}
static T_1 F_68 ( struct V_1 * V_1 , char * V_2 , T_3 V_3 )
{
return F_66 ( V_1 , V_2 , V_3 , & V_96 ) ;
}
...
static T_7 int F_82 ( struct V_79 * V_79 )
{
int V_136 ;
V_136 = F_83 ( V_79 ) ;
if ( V_136 )
...
static T_8 void F_86 ( struct V_79 * V_79 )
{
F_87 ( V_79 ) ;
F_85 ( V_79 ) ;
}
