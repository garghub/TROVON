...
F_15 ( V_6 , V_109 , L_45
L_46 , V_6 -> V_41 , V_6 -> V_42 , F_44 ( V_6 ) ) ;
F_27 ( & V_88 ) ;
return 0 ;
V_99:
F_45 ( V_6 ) ;
...
struct V_5 * F_54 ( struct V_76 * V_75 )
{
struct V_5 * V_6 ;
F_3 ( 0 , L_39 ) ;
F_26 ( & V_88 ) ;
...
static void F_56 ( unsigned long V_110 , unsigned long V_111 ,
T_1 V_44 )
{
struct V_110 * V_112 ;
void * V_113 ;
...
F_60 ( V_114 ) ;
V_113 = F_61 ( V_112 ) ;
F_62 ( V_113 + V_111 , V_44 ) ;
F_63 ( V_113 ) ;
if ( F_59 ( V_112 ) )
F_64 ( V_114 ) ;
}
int F_65 ( struct V_5 * V_6 , unsigned long V_110 )
{
...
F_67 ( V_6 , V_115 , V_62 , V_120 ) ;
}
void F_74 ( const enum V_130 type ,
struct V_5 * V_6 ,
const T_2 V_120 ,
const unsigned long V_124 ,
const unsigned long V_125 ,
...
V_124 , V_125 ,
V_24 , V_131 ) ;
F_68 ( V_6 , V_120 , V_62 , V_121 , V_14 , V_22 ,
V_122 , V_123 , V_115 ,
V_124 , V_125 , V_24 ) ;
} else {
snprintf ( V_122 , sizeof( V_122 ) ,
L_67 ,
V_124 , V_125 , V_24 ) ;
F_70 ( V_6 , V_120 , V_62 , V_121 , V_14 , V_22 ,
V_122 , V_123 , V_115 ) ;
}
}
