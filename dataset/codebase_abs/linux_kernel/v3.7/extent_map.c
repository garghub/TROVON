...
V_48 = F_24 ( & V_12 -> V_21 ) ;
if ( V_48 )
V_47 = F_18 ( V_48 , struct V_2 , V_21 ) ;
if ( V_48 && F_25 ( V_47 , V_12 ) ) {
V_12 -> V_29 = V_47 -> V_29 ;
V_12 -> V_49 += V_47 -> V_49 ;
V_12 -> V_50 += V_47 -> V_50 ;
V_12 -> V_42 = V_47 -> V_42 ;
V_47 -> V_14 = 0 ;
if ( V_47 -> V_18 > V_12 -> V_18 ) {
V_12 -> V_51 = V_12 -> V_29 ;
V_12 -> V_52 = V_12 -> V_49 ;
V_12 -> V_18 = V_47 -> V_18 ;
F_29 ( & V_12 -> V_20 , & V_7 -> V_10 ) ;
}
F_30 ( & V_47 -> V_20 ) ;
F_31 ( & V_47 -> V_21 , & V_7 -> V_8 ) ;
F_11 ( V_47 ) ;
}
}
V_48 = F_23 ( & V_12 -> V_21 ) ;
...
int F_32 ( struct V_6 * V_7 , T_2 V_29 , T_2 V_49 ,
T_2 V_53 )
{
int V_54 = 0 ;
struct V_2 * V_12 ;
...
struct V_21 * V_48 ;
struct V_2 * V_58 ;
V_58 = F_34 ( V_7 , V_12 -> V_29 , V_12 -> V_49 ) ;
if ( V_58 ) {
F_11 ( V_58 ) ;
V_54 = - V_59 ;
goto V_56;
}
V_48 = F_17 ( & V_7 -> V_8 , V_12 -> V_29 , & V_12 -> V_21 ) ;
if ( V_48 ) {
V_54 = - V_59 ;
goto V_56;
}
...
static T_2 F_39 ( T_2 V_29 , T_2 V_49 )
{
if ( V_29 + V_49 < V_29 )
return ( T_2 ) - 1 ;
return V_29 + V_49 ;
}
struct V_2 * F_40 ( struct V_6 * V_7 ,
T_2 V_29 , T_2 V_49 , int V_60 )
{
struct V_2 * V_12 ;
struct V_21 * V_21 ;
struct V_21 * V_35 = NULL ;
struct V_21 * V_38 = NULL ;
T_2 V_61 = F_39 ( V_29 , V_49 ) ;
...
if ( V_60 && ! ( V_61 > V_12 -> V_29 && V_29 < F_19 ( V_12 ) ) )
return NULL ;
F_38 ( & V_12 -> V_19 ) ;
return V_12 ;
}
...
T_2 V_29 , T_2 V_49 )
{
return F_40 ( V_7 , V_29 , V_49 , 1 ) ;
}
struct V_2 * F_41 ( struct V_6 * V_7 ,
T_2 V_29 , T_2 V_49 )
{
return F_40 ( V_7 , V_29 , V_49 , 0 ) ;
}
int F_42 ( struct V_6 * V_7 , struct V_2 * V_12 )
{
int V_54 = 0 ;
F_12 ( F_26 ( V_39 , & V_12 -> V_15 ) ) ;
F_31 ( & V_12 -> V_21 , & V_7 -> V_8 ) ;
if ( ! F_26 ( V_62 , & V_12 -> V_15 ) )
F_30 ( & V_12 -> V_20 ) ;
V_12 -> V_14 = 0 ;
return V_54 ;
}
