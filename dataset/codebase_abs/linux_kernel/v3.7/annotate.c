...
struct V_80 * V_81 = V_38 -> V_43 -> V_82 ;
int V_124 ;
for ( V_124 = 0 ; V_124 < V_70 ; V_124 ++ )
free ( V_81 [ V_124 ] . V_76 ) ;
free ( V_81 ) ;
V_38 -> V_43 -> V_82 = NULL ;
}
...
T_2 V_17 ;
T_4 * V_126 ;
V_81 [ V_124 ] . V_78 = 100.0 * V_49 -> V_12 [ V_124 ] / V_49 -> V_56 ;
if ( V_81 [ V_124 ] . V_78 <= 0.5 )
continue;
V_17 = V_53 + V_124 ;
sprintf ( V_125 , L_46 V_14 , V_93 , V_17 ) ;
V_126 = F_61 ( V_125 , L_45 ) ;
if ( ! V_126 )
continue;
if ( F_52 ( & V_76 , & V_90 , V_126 ) < 0 || ! V_90 )
goto V_83;
V_81 [ V_124 ] . V_76 = malloc ( sizeof( char ) * V_90 + 1 ) ;
if ( ! V_81 [ V_124 ] . V_76 )
goto V_83;
strcpy ( V_81 [ V_124 ] . V_76 , V_76 ) ;
F_63 ( V_117 , & V_81 [ V_124 ] ) ;
V_83:
F_62 ( V_126 ) ;
}
return 0 ;
}
static void F_69 ( struct V_116 * V_117 , const char * V_93 )
{
struct V_80 * V_81 ;
struct V_119 * V_68 ;
printf ( L_47 , V_93 ) ;
...
if ( V_49 -> V_12 [ V_17 ] != 0 )
printf ( L_51 V_14 L_52 V_57 L_10 , V_128 / 2 ,
V_36 -> V_53 + V_17 , V_49 -> V_12 [ V_17 ] ) ;
printf ( L_53 V_57 L_10 , V_128 / 2 , L_54 , V_49 -> V_56 ) ;
}
int F_74 ( struct V_35 * V_36 , struct V_34 * V_34 , int V_48 ,
bool V_129 , int V_71 , int V_72 ,
int V_130 )
{
struct V_92 * V_92 = V_34 -> V_92 ;
char * V_93 ;
...
{
struct V_58 * V_69 , * V_135 ;
F_82 (pos, n, head, node) {
F_83 ( & V_69 -> V_68 ) ;
F_41 ( V_69 ) ;
}
}
static T_1 F_84 ( struct V_58 * V_59 , T_4 * V_126 )
{
T_1 V_27 ;
if ( V_59 -> V_17 == - 1 )
return fprintf ( V_126 , L_20 , V_59 -> line ) ;
V_27 = fprintf ( V_126 , L_11 V_14 L_15 , V_59 -> V_17 , V_59 -> V_5 ) ;
if ( V_59 -> V_2 . V_4 [ 0 ] != '\0' ) {
V_27 += fprintf ( V_126 , L_57 , 6 - ( int ) V_27 , L_58 ,
V_59 -> V_2 . V_4 ) ;
}
return V_27 + fprintf ( V_126 , L_10 ) ;
}
T_1 F_85 ( struct V_66 * V_67 , T_4 * V_126 )
{
struct V_58 * V_69 ;
T_1 V_27 = 0 ;
F_76 (pos, head, node)
V_27 += F_84 ( V_69 , V_126 ) ;
return V_27 ;
}
int F_86 ( struct V_35 * V_36 , struct V_34 * V_34 , int V_48 ,
bool V_136 , bool V_129 , int V_71 ,
int V_72 )
{
struct V_92 * V_92 = V_34 -> V_92 ;
const char * V_93 = V_92 -> V_103 ;
struct V_116 V_80 = V_137 ;
T_2 V_70 ;
