...
int F_61 ( struct V_168 * V_169 ,
const char * V_170 ,
struct V_148 * V_171 ,
struct V_100 * V_172 )
{
unsigned int V_109 , V_173 ;
struct V_83 V_93 ;
int V_174 = F_4 ( V_171 -> V_175 ) ;
struct V_10 * V_110 ;
unsigned int V_176 ;
F_19 ( ! V_172 ) ;
V_110 = F_35 ( & V_172 -> V_104 , V_174 ) ;
if ( ! V_110 )
return - V_177 ;
V_176 = F_62 ( V_110 -> V_13 . V_178 , V_170 , strlen ( V_170 ) ) ;
V_109 = F_4 ( V_110 -> V_13 . V_14 ) ;
V_173 = V_110 -> V_12 ;
V_93 . V_176 = F_63 ( V_176 ) ;
V_93 . V_179 = F_63 ( - 1 ) ;
V_93 . V_110 = V_171 -> V_175 ;
F_6 ( L_56 , V_170 , V_174 , V_176 ) ;
V_169 -> V_180 = V_93 ;
V_169 -> V_181 = V_171 -> V_182 ;
return 0 ;
}
static int * F_64 ( struct V_100 * V_172 , struct V_83 V_93 ,
int * V_132 , int * V_109 )
{
struct V_86 * V_92 ;
struct V_10 * V_110 ;
int V_183 ;
unsigned int V_174 , V_176 , V_184 , V_8 , V_74 ;
V_174 = F_4 ( V_93 . V_110 ) ;
V_176 = F_65 ( V_93 . V_176 ) ;
V_110 = F_35 ( & V_172 -> V_104 , V_174 ) ;
if ( ! V_110 )
return NULL ;
V_8 = F_66 ( V_176 , F_4 ( V_110 -> V_13 . V_14 ) ,
V_110 -> V_15 ) ;
V_93 . V_176 = F_63 ( V_8 ) ;
V_92 = F_30 ( & V_172 -> V_112 , V_93 ) ;
if ( V_92 ) {
* V_109 = V_92 -> V_2 ;
return V_92 -> V_132 ;
}
V_183 = F_67 ( V_172 -> V_111 , V_110 -> V_13 . V_185 ,
V_110 -> V_13 . type , V_110 -> V_13 . V_25 ) ;
if ( V_183 < 0 ) {
F_18 ( L_57 ,
V_174 , V_110 -> V_13 . V_185 , V_110 -> V_13 . type ,
V_110 -> V_13 . V_25 ) ;
return NULL ;
}
V_184 = F_66 ( V_176 ,
...
V_110 -> V_15 ) ;
V_184 += V_174 ;
V_74 = F_68 ( V_172 -> V_111 , V_183 , V_184 , V_132 ,
F_60 ( int , V_110 -> V_13 . V_25 , * V_109 ) ,
V_172 -> V_114 ) ;
if ( V_74 < 0 ) {
F_18 ( L_58
L_59 , V_74 , V_174 , V_110 -> V_13 . V_185 ,
V_110 -> V_13 . type , V_110 -> V_13 . V_25 ) ;
return NULL ;
}
* V_109 = V_74 ;
...
int F_69 ( struct V_100 * V_172 , struct V_83 V_93 ,
int * V_186 )
{
int V_187 [ V_188 ] , * V_132 ;
int V_45 , V_189 , V_109 = V_188 ;
V_132 = F_64 ( V_172 , V_93 , V_187 , & V_109 ) ;
if ( ! V_132 )
return - 1 ;
V_189 = 0 ;
for ( V_45 = 0 ; V_45 < V_109 ; V_45 ++ )
if ( F_70 ( V_172 , V_132 [ V_45 ] ) )
V_186 [ V_189 ++ ] = V_132 [ V_45 ] ;
return V_189 ;
}
int F_71 ( struct V_100 * V_172 , struct V_83 V_93 )
{
int V_187 [ V_188 ] , * V_132 ;
int V_45 , V_109 = V_188 ;
V_132 = F_64 ( V_172 , V_93 , V_187 , & V_109 ) ;
if ( ! V_132 )
return - 1 ;
for ( V_45 = 0 ; V_45 < V_109 ; V_45 ++ )
