...
* V_185 = 0 ;
* ( T_7 * ) V_185 = F_100 ( ( void * ) ( V_54 + 1 ) , V_79 -> V_129 - sizeof( struct V_81 ) ) ;
}
}
F_101 ( V_79 ) ;
V_7 = F_61 ( V_3 -> V_7 ) ;
...
memcpy ( V_3 -> V_208 , & V_27 . V_54 . V_55 , 4 ) ;
memcpy ( V_3 -> V_209 , & V_27 . V_54 . V_56 , 4 ) ;
F_17 ( V_45 , V_42 ) ;
F_109 ( V_3 ) ;
}
}
...
static int F_111 ( struct V_2 * V_3 , int V_213 )
{
struct V_33 * V_112 = F_14 ( V_3 ) ;
if ( V_213 < 68 ||
V_213 > 0xFFF8 - V_3 -> V_160 - V_112 -> V_144 )
return - V_204 ;
V_3 -> V_72 = V_213 ;
return 0 ;
}
...
struct V_81 * V_54 = (struct V_81 * ) F_96 ( V_79 , V_42 -> V_144 ) ;
T_2 * V_27 = ( T_2 * ) ( V_54 + 1 ) ;
...
static int F_113 ( const struct V_78 * V_79 , unsigned char * V_214 )
{
const struct V_81 * V_54 = ( const struct V_81 * ) F_114 ( V_79 ) ;
memcpy ( V_214 , & V_54 -> V_55 , 4 ) ;
return 4 ;
}
...
{
struct V_33 * V_42 = F_14 ( V_3 ) ;
if ( F_13 ( V_42 -> V_53 . V_54 . V_56 ) && V_42 -> V_216 ) {
struct V_217 * V_218 ;
V_218 = F_119 ( F_8 ( V_3 ) , V_42 -> V_216 ) ;
if ( V_218 )
F_120 ( V_218 , V_42 -> V_53 . V_54 . V_56 ) ;
}
return 0 ;
}
...
memcpy ( V_3 -> V_208 , & V_112 -> V_53 . V_54 . V_55 , 4 ) ;
memcpy ( V_3 -> V_209 , & V_112 -> V_53 . V_54 . V_56 , 4 ) ;
if ( V_54 -> V_56 ) {
#ifdef F_51
if ( F_13 ( V_54 -> V_56 ) ) {
if ( ! V_54 -> V_55 )
...
static void F_128 ( struct V_44 * V_45 , struct V_231 * V_232 )
{
int V_60 ;
...
static int F_137 ( struct V_238 * V_239 [] , struct V_238 * V_82 [] )
{
T_2 V_28 ;
if ( ! V_82 )
return 0 ;
...
static int F_139 ( struct V_238 * V_239 [] , struct V_238 * V_82 [] )
{
T_3 V_56 ;
if ( V_239 [ V_242 ] ) {
if ( F_140 ( V_239 [ V_242 ] ) != V_243 )
return - V_204 ;
if ( ! F_141 ( F_142 ( V_239 [ V_242 ] ) ) )
return - V_215 ;
}
if ( ! V_82 )
goto V_244;
if ( V_82 [ V_245 ] ) {
memcpy ( & V_56 , F_142 ( V_82 [ V_245 ] ) , 4 ) ;
if ( ! V_56 )
return - V_204 ;
}
V_244:
return F_137 ( V_239 , V_82 ) ;
}
static void F_143 ( struct V_238 * V_82 [] ,
struct V_26 * V_53 )
{
...
return;
if ( V_82 [ V_246 ] )
V_53 -> V_38 = F_144 ( V_82 [ V_246 ] ) ;
if ( V_82 [ V_240 ] )
V_53 -> V_30 = F_138 ( V_82 [ V_240 ] ) ;
if ( V_82 [ V_241 ] )
V_53 -> V_74 = F_138 ( V_82 [ V_241 ] ) ;
if ( V_82 [ V_247 ] )
V_53 -> V_32 = F_145 ( V_82 [ V_247 ] ) ;
if ( V_82 [ V_248 ] )
V_53 -> V_157 = F_145 ( V_82 [ V_248 ] ) ;
if ( V_82 [ V_249 ] )
V_53 -> V_54 . V_55 = F_145 ( V_82 [ V_249 ] ) ;
if ( V_82 [ V_245 ] )
V_53 -> V_54 . V_56 = F_145 ( V_82 [ V_245 ] ) ;
if ( V_82 [ V_250 ] )
V_53 -> V_54 . V_98 = F_146 ( V_82 [ V_250 ] ) ;
if ( V_82 [ V_251 ] )
V_53 -> V_54 . V_103 = F_146 ( V_82 [ V_251 ] ) ;
if ( ! V_82 [ V_252 ] || F_146 ( V_82 [ V_252 ] ) )
...
static int F_150 ( struct V_37 * V_254 , struct V_2 * V_3 , struct V_238 * V_239 [] ,
struct V_238 * V_82 [] )
{
struct V_33 * V_66 ;
struct V_37 * V_37 = F_8 ( V_3 ) ;
...
static int F_152 ( struct V_2 * V_3 , struct V_238 * V_239 [] ,
struct V_238 * V_82 [] )
{
struct V_33 * V_42 , * V_66 ;
struct V_37 * V_37 = F_8 ( V_3 ) ;
...
if ( F_156 ( V_79 , V_246 , V_27 -> V_38 ) ||
F_157 ( V_79 , V_240 , V_27 -> V_30 ) ||
F_157 ( V_79 , V_241 , V_27 -> V_74 ) ||
F_158 ( V_79 , V_247 , V_27 -> V_32 ) ||
F_158 ( V_79 , V_248 , V_27 -> V_157 ) ||
F_158 ( V_79 , V_249 , V_27 -> V_54 . V_55 ) ||
F_158 ( V_79 , V_245 , V_27 -> V_54 . V_56 ) ||
F_159 ( V_79 , V_250 , V_27 -> V_54 . V_98 ) ||
F_159 ( V_79 , V_251 , V_27 -> V_54 . V_103 ) ||
F_159 ( V_79 , V_252 ,
! ! ( V_27 -> V_54 . V_159 & F_11 ( V_163 ) ) ) )
goto V_256;
return 0 ;
