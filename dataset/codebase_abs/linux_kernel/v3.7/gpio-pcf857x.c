...
{
int V_6 ;
V_11 -> V_18 = F_32 ( V_35 -> V_36 ,
V_11 -> V_8 . V_37 ,
& V_38 ,
NULL ) ;
if ( ! V_11 -> V_18 )
goto V_39;
V_6 = F_33 ( V_33 -> V_25 , F_24 , 0 ,
F_34 ( V_35 ) , V_11 ) ;
if ( V_6 )
goto V_39;
F_35 ( & V_11 -> V_20 , F_18 ) ;
...
V_11 = F_38 ( sizeof *V_11 , V_45 ) ;
if ( ! V_11 )
return - V_46 ;
F_39 ( & V_11 -> V_12 ) ;
F_40 ( & V_11 -> V_24 ) ;
V_11 -> V_8 . V_47 = V_33 ? V_33 -> V_48 : - 1 ;
V_11 -> V_8 . V_49 = 1 ;
V_11 -> V_8 . V_35 = & V_2 -> V_35 ;
V_11 -> V_8 . V_50 = V_51 ;
V_11 -> V_8 . V_52 = F_13 ;
V_11 -> V_8 . V_53 = F_15 ;
V_11 -> V_8 . V_54 = F_9 ;
V_11 -> V_8 . V_55 = F_14 ;
V_11 -> V_8 . V_37 = V_43 -> V_56 ;
if ( V_33 && V_33 -> V_25 ) {
V_6 = F_31 ( V_11 , V_33 , & V_2 -> V_35 ) ;
if ( V_6 < 0 ) {
F_41 ( & V_2 -> V_35 , L_2 ) ;
goto V_39;
}
...
V_6 = F_4 ( V_2 ) ;
} else if ( V_11 -> V_8 . V_37 == 16 ) {
V_11 -> V_14 = F_5 ;
V_11 -> V_16 = F_7 ;
if ( ! F_42 ( V_2 -> V_57 , V_60 ) )
V_6 = - V_59 ;
else
V_6 = F_7 ( V_2 ) ;
} else {
...
if ( V_6 < 0 )
goto V_39;
V_11 -> V_8 . V_61 = V_2 -> V_62 ;
V_11 -> V_2 = V_2 ;
F_43 ( V_2 , V_11 ) ;
V_11 -> V_13 = V_33 ? ~ V_33 -> V_63 : ~ 0 ;
V_11 -> V_6 = V_11 -> V_13 ;
V_6 = F_44 ( & V_11 -> V_8 ) ;
if ( V_6 < 0 )
goto V_39;
...
if ( V_33 && V_33 -> V_64 ) {
V_6 = V_33 -> V_64 ( V_2 ,
V_11 -> V_8 . V_47 , V_11 -> V_8 . V_37 ,
V_33 -> V_65 ) ;
if ( V_6 < 0 )
F_46 ( & V_2 -> V_35 , L_7 , V_6 ) ;
}
return 0 ;
V_39:
F_37 ( & V_2 -> V_35 , L_8 ,
...
{
struct V_32 * V_33 = V_2 -> V_35 . V_44 ;
