...
V_14 = F_13 ( V_1 ) ;
V_14 -> V_10 = F_14 ( F_15 ( V_1 -> V_17 ) , V_13 -> V_18 ) ;
if ( ! V_14 -> V_10 ) {
V_15 = - V_19 ;
goto V_20;
}
...
int F_26 ( const struct V_1 * V_1 )
{
const struct V_14 * V_14 = F_13 ( V_1 ) ;
return V_14 -> V_10 -> V_28 ;
}
static unsigned int F_27 ( const struct V_2 * V_3 )
{
unsigned int V_29 = V_3 -> V_30 - V_5 ;
if ( V_3 -> V_31 == F_28 ( V_32 ) )
V_29 -= V_33 ;
return V_29 ;
}
static int F_29 ( struct V_1 * V_1 , struct V_2 * V_3 )
{
struct V_14 * V_14 = F_13 ( V_1 ) ;
int V_34 = V_14 -> V_10 -> V_34 ;
int V_30 ;
if ( F_2 ( F_27 ( V_3 ) > V_34 && ! F_30 ( V_3 ) ) ) {
F_31 ( L_1 ,
V_14 -> V_10 -> V_18 ,
F_27 ( V_3 ) , V_34 ) ;
goto error;
...
struct V_1 * F_8 ( struct V_36 * V_10 )
{
