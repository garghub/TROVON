...
V_200 = ( V_78 - V_49 ) * V_51 ;
for ( V_187 = 0 ; V_187 < V_78 -> V_130 ; V_187 ++ )
F_58 ( V_214 , V_200 + V_187 ) ;
F_59 ( V_78 -> V_89 ) ;
V_78 -> V_89 = NULL ;
F_55 ( V_78 -> V_50 ) ;
}
static int T_8 F_60 ( struct V_218 * V_219 ,
...
V_138 = - V_37 ;
if ( V_46 >= V_48 ) {
F_63 ( & V_219 -> V_198 , L_25
L_26 , V_48 ) ;
goto V_83;
}
V_139 = & V_49 [ V_46 ] ;
V_138 = F_64 ( V_219 , 2 , L_27 ) ;
if ( V_138 ) {
F_62 ( & V_219 -> V_198 , L_28 ) ;
goto V_83;
}
V_139 -> V_89 = F_65 ( F_66 ( V_219 , 2 ) , 0x4000 ) ;
if ( V_139 -> V_89 == NULL ) {
F_62 ( & V_219 -> V_198 , L_29 ) ;
V_138 = - V_202 ;
goto V_223;
}
V_139 -> V_80 = V_222 ;
...
static void T_9 F_70 ( struct V_218 * V_219 )
{
struct V_77 * V_78 = F_71 ( V_219 ) ;
F_56 ( V_78 ) ;
F_69 ( V_219 , 2 ) ;
}
...
V_246 [ V_46 ] ;
V_78 -> V_123 = V_247 ;
V_78 -> V_89 = F_65 ( V_244 [ V_46 ] , 0x4000 ) ;
if ( ! V_78 -> V_89 ) {
F_36 ( V_99 L_35 ,
V_244 [ V_46 ] ) ;
continue;
...
static void F_87 ( struct V_249 * V_64 )
{
struct V_26 * V_27 = F_88 ( V_64 , struct V_26 , V_64 ) ;
F_89 ( V_27 ) ;
F_14 ( V_27 , 2 ) ;
}
static int F_90 ( struct V_249 * V_64 )
{
struct V_26 * V_27 = F_88 ( V_64 , struct V_26 , V_64 ) ;
int V_63 ;
F_91 ( & V_64 -> V_250 ) ;
...
static void F_93 ( struct V_249 * V_64 , int V_251 )
{
struct V_26 * V_27 = F_88 ( V_64 , struct V_26 , V_64 ) ;
F_94 ( V_27 , V_251 , V_251 ) ;
}
static int F_95 ( struct V_24 * V_25 , struct V_199 * V_252 )
{
struct V_77 * V_78 ;
struct V_26 * V_27 ;
int V_64 ;
...
F_94 ( V_27 , 1 , 1 ) ;
F_100 ( V_27 ) ;
F_101 ( V_27 , V_27 -> type == V_205 ) ;
V_27 -> V_64 . V_9 |= V_217 ;
}
F_25 ( & V_27 -> V_64 . V_69 ) ;
F_25 ( & V_216 ) ;
return F_102 ( & V_27 -> V_64 , V_25 , V_252 ) ;
}
static void F_103 ( struct V_24 * V_25 , struct V_199 * V_252 )
{
struct V_26 * V_27 = V_25 -> V_28 ;
V_27 -> V_65 = V_25 -> V_66 . V_67 ;
F_104 ( & V_27 -> V_64 , V_25 , V_252 ) ;
}
...
return 0 ;
F_6 ( & V_52 , V_9 ) ;
V_16 = F_106 ( V_25 , V_87 , V_256 ) ;
F_8 ( & V_52 , V_9 ) ;
F_107 ( V_258 , & V_27 -> V_257 ) ;
return V_16 ;
}
...
static void F_110 ( struct V_24 * V_25 )
{
struct V_26 * V_27 = V_25 -> V_28 ;
if ( V_27 == NULL )
return;
...
return;
F_99 ( V_25 , V_273 ) ;
if ( ! ( V_273 -> V_67 & V_209 ) && F_117 ( V_25 ) )
F_118 ( & V_27 -> V_64 . V_274 ) ;
}
...
if ( V_27 == NULL )
return;
if ( ! F_122 ( V_275 , & V_27 -> V_257 ) )
return;
F_123 ( V_27 ) ;
F_124 ( V_275 , & V_27 -> V_257 ) ;
}
static void F_125 ( struct V_24 * V_25 )
{
struct V_26 * V_27 = V_25 -> V_28 ;
F_126 ( & V_27 -> V_64 ) ;
}
static void F_127 ( struct V_26 * V_45 , T_4 V_63 )
{
struct V_24 * V_25 ;
unsigned long V_9 ;
V_63 = ! ! V_63 ;
...
static int F_128 ( struct V_26 * V_45 , unsigned int V_276 ,
T_2 T_1 * V_277 )
{
...
T_2 V_279 ;
if ( V_25 ) {
if ( F_122 ( V_261 , & V_45 -> V_257 ) &&
F_17 ( V_45 ) == 0 ) {
F_124 ( V_261 , & V_45 -> V_257 ) ;
F_111 ( V_25 ) ;
}
if ( F_122 ( V_258 , & V_45 -> V_257 ) && ! V_25 -> V_259 &&
F_17 ( V_45 ) <= V_280 ) {
F_124 ( V_258 , & V_45 -> V_257 ) ;
F_111 ( V_25 ) ;
}
if ( V_278 && ! F_122 ( V_281 , & V_25 -> V_9 ) &&
F_16 ( V_45 ) > 0 ) {
F_129 ( V_45 ) ;
F_130 ( V_25 ) ;
}
...
if ( ! V_278 )
goto V_282;
if ( V_25 && ( V_279 & V_286 ) && ! F_131 ( V_25 ) ) {
F_132 ( V_25 , 0 , V_287 ) ;
F_130 ( V_25 ) ;
}
if ( V_279 & V_288 )
F_127 ( V_45 , F_11 ( V_1 + V_17 ) & V_289 ) ;
V_282:
F_22 ( V_25 ) ;
return 0 ;
}
static void F_133 ( unsigned long V_290 )
{
struct V_77 * V_78 ;
T_2 T_1 * V_277 ;
...
F_128 ( & V_78 -> V_50 [ V_64 ] , ! ! V_277 , V_277 + V_64 ) ;
if ( V_277 )
F_32 ( 0 , V_78 -> V_134 ) ;
if ( V_293 ) {
...
static void F_99 ( struct V_24 * V_25 , struct V_272 * V_273 )
{
...
V_298 = 1 ;
V_295 -> V_67 &= ~ V_305 ;
F_136 ( V_27 , V_264 , V_61 , V_296 , V_297 , V_298 ) ;
V_299 = F_137 ( V_27 , V_295 , F_138 ( V_25 ) ) ;
if ( V_299 == - 1 )
V_299 = F_139 ( V_273 ) ;
F_140 ( V_25 , V_299 , V_299 ) ;
}
...
static void F_100 ( struct V_26 * V_64 )
{
void T_1 * V_1 ;
T_2 V_308 = 512 ;
V_1 = V_64 -> V_73 ;
...
static void F_89 ( struct V_26 * V_64 )
{
...
static T_12 F_141 ( struct V_26 * V_64 , T_12 V_299 )
{
void T_1 * V_1 = V_64 -> V_73 ;
...
static int F_137 ( struct V_26 * V_64 , struct V_272 * V_319 ,
T_12 V_299 )
{
void T_1 * V_1 ;
T_13 V_306 = 0 ;
...
static int F_114 ( struct V_26 * V_64 , int * V_343 ,
int * V_344 )
{
if ( V_343 )
...
static void F_94 ( struct V_26 * V_64 , int V_263 , int V_264 )
{
T_4 V_306 = 0 ;
if ( V_263 )
V_306 |= V_346 ;
...
static void F_136 ( struct V_26 * V_64 , int V_264 , int V_61 ,
...
static int F_129 ( struct V_26 * V_64 )
{
...
( V_375 + 1 - V_360 ) ;
V_16 = F_142 ( V_25 , & V_374 ,
F_143 ( V_16 , V_256 ) ) ;
F_144 ( V_374 , V_357 , V_16 ) ;
...
static int F_109 ( struct V_26 * V_64 )
{
void T_1 * V_1 = V_64 -> V_73 ;
T_2 V_13 , V_14 , V_15 ;
V_13 = F_2 ( V_1 + V_369 ) ;
...
static void F_120 ( struct V_26 * V_64 )
{
...
{
struct V_381 V_386 ;
if ( F_145 ( & V_386 , V_385 , sizeof( V_386 ) ) )
return - V_40 ;
...
F_101 ( V_380 , V_386 . type == V_205 ) ;
V_380 -> type = V_386 . type ;
return 0 ;
}
static void F_101 ( struct V_26 * V_64 , int V_391 )
{
void T_1 * V_1 = V_64 -> V_73 ;
if ( ! V_391 ) {
F_5 ( V_1 , V_392 , 0 ) ;
