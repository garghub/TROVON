...
F_26 ( V_2 , V_25 , V_70 ) )
goto V_64;
return F_27 ( V_25 , V_51 ) ;
V_64:
F_28 ( V_25 , V_51 ) ;
return - V_38 ;
}
static int F_29 ( struct V_1 * V_2 , struct V_3 * V_25 , struct V_45 * V_37 ,
...
static int F_30 ( struct V_3 * V_25 , struct V_71 * V_72 )
{
struct V_45 * V_37 ;
int V_73 , V_74 , V_75 , V_76 ;
struct V_77 * V_77 = F_31 ( V_25 -> V_2 ) ;
V_37 = F_24 ( V_72 -> V_51 ) ;
V_76 = V_72 -> args [ 0 ] ;
V_73 = V_74 = V_72 -> args [ 1 ] ;
F_13 ( & V_78 ) ;
for ( V_75 = V_76 ;
V_75 < F_32 ( V_79 ) ;
V_74 = 0 , V_75 ++ ) {
...
struct V_80 * V_81 ;
V_73 = 0 ;
F_33 (sk, node, &unix_socket_table[slot]) {
if ( ! F_34 ( F_31 ( V_2 ) , V_77 ) )
continue;
if ( V_73 < V_74 )
goto V_82;
if ( ! ( V_37 -> V_83 & ( 1 << V_2 -> V_30 ) ) )
goto V_82;
if ( F_29 ( V_2 , V_25 , V_37 ,
F_35 ( V_72 -> V_25 ) . V_46 ,
V_72 -> V_51 -> V_84 ,
V_85 ) < 0 )
goto V_86;
...
static struct V_1 * F_36 ( int V_23 )
{
int V_29 ;
struct V_1 * V_2 ;
F_13 ( & V_78 ) ;
for ( V_29 = 0 ; V_29 < F_32 ( V_79 ) ; V_29 ++ ) {
struct V_80 * V_81 ;
F_33 (sk, node, &unix_socket_table[i])
if ( V_23 == F_8 ( V_2 ) ) {
F_37 ( V_2 ) ;
F_18 ( & V_78 ) ;
return V_2 ;
...
static int F_38 ( struct V_3 * V_87 ,
...
struct V_3 * V_53 ;
unsigned int V_90 ;
struct V_77 * V_77 = F_31 ( V_87 -> V_2 ) ;
if ( V_37 -> V_60 == 0 )
goto V_91;
V_2 = F_36 ( V_37 -> V_60 ) ;
V_88 = - V_92 ;
if ( V_2 == NULL )
goto V_91;
V_88 = F_39 ( V_2 , V_37 -> V_61 ) ;
if ( V_88 )
goto V_93;
V_90 = 256 ;
V_94:
V_88 = - V_95 ;
V_53 = F_40 ( sizeof( struct V_52 ) + V_90 , V_96 ) ;
if ( ! V_53 )
goto V_93;
V_88 = F_22 ( V_2 , V_53 , V_37 , F_35 ( V_87 ) . V_46 ,
...
V_88 = F_42 ( V_77 -> V_98 , V_53 , F_35 ( V_87 ) . V_46 ,
V_99 ) ;
if ( V_88 > 0 )
V_88 = 0 ;
V_93:
...
static int F_43 ( struct V_3 * V_25 , struct V_50 * V_100 )
{
...
return F_45 ( V_77 -> V_98 , V_25 , V_100 , & V_105 ) ;
} else
return F_38 ( V_25 , V_100 , F_24 ( V_100 ) ) ;
}
