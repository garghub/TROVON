...
F_43 ( ! V_49 -> V_13 ) ;
F_43 ( ! V_49 -> V_13 -> V_5 ) ;
F_43 ( ! V_49 -> V_13 -> V_5 -> V_229 ) ;
error = F_85 ( V_49 , V_227 -> V_178 , V_203 ) ;
if ( error < 0 )
goto error;
if ( V_49 -> V_13 -> V_5 -> V_2 == 3 ) {
if ( V_49 -> V_175 == 0 || V_49 -> V_175 > V_230 )
V_49 -> V_175 = V_230 ;
if ( ! ( V_227 -> V_228 -> V_123 & V_231 ) )
V_49 -> V_149 |= V_232 ;
} else {
if ( V_49 -> V_175 == 0 || V_49 -> V_175 > V_233 )
V_49 -> V_175 = V_233 ;
}
if ( ! ( V_203 -> V_234 & V_235 ) ) {
error = V_24 -> V_5 -> V_236 ( V_49 , V_227 -> V_178 , V_203 ) ;
if ( error < 0 ) {
F_35 ( L_25 , - error ) ;
goto error;
}
}
memcpy ( & V_49 -> V_237 , & V_203 -> V_237 , sizeof( V_49 -> V_237 ) ) ;
F_35 ( L_26 ,
( unsigned long long ) V_49 -> V_237 . V_238 ,
( unsigned long long ) V_49 -> V_237 . V_239 ) ;
F_88 ( V_49 ) ;
V_49 -> V_240 = V_241 ;
F_105 ( V_203 ) ;
return V_49 ;
...
int error ;
F_35 ( L_27 ,
( unsigned long long ) V_203 -> V_237 . V_238 ,
( unsigned long long ) V_203 -> V_237 . V_239 ) ;
V_49 = F_94 () ;
if ( ! V_49 )
return F_5 ( - V_20 ) ;
error = - V_20 ;
...
F_54 ( & V_49 -> V_13 -> V_25 ) ;
F_87 ( V_49 , V_212 ) ;
V_49 -> V_237 = V_203 -> V_237 ;
error = F_75 ( V_49 ,
V_212 -> V_139 -> V_141 ,
V_110 ) ;
if ( error < 0 )
goto V_244;
error = F_85 ( V_49 , V_242 , V_243 ) ;
if ( error < 0 )
goto V_244;
if ( V_49 -> V_175 == 0 || V_49 -> V_175 > V_245 )
V_49 -> V_175 = V_245 ;
F_35 ( L_28 ,
( unsigned long long ) V_49 -> V_237 . V_238 ,
( unsigned long long ) V_49 -> V_237 . V_239 ) ;
...
static int F_111 ( struct V_249 * V_249 , struct V_250 * V_250 )
{
struct V_251 * V_252 ;
int V_253 ;
struct V_254 * V_255 = V_250 -> V_256 -> V_257 -> V_258 ;
struct V_41 * V_41 = V_255 -> V_259 -> V_260 -> V_261 ;
V_253 = F_112 ( V_250 , & V_262 ) ;
if ( V_253 < 0 )
return V_253 ;
V_252 = V_250 -> V_263 ;
V_252 -> V_264 = V_41 ;
...
static void * F_113 ( struct V_251 * V_252 , T_2 * V_265 )
{
struct V_43 * V_44 = F_28 ( V_252 -> V_264 , V_45 ) ;
F_2 ( & V_44 -> V_51 ) ;
return F_114 ( & V_44 -> V_86 , * V_265 ) ;
}
static void * F_115 ( struct V_251 * V_266 , void * V_267 , T_2 * V_268 )
{
struct V_43 * V_44 = F_28 ( V_266 -> V_264 , V_45 ) ;
return F_116 ( V_267 , & V_44 -> V_86 , V_268 ) ;
}
static void F_117 ( struct V_251 * V_266 , void * V_267 )
{
struct V_43 * V_44 = F_28 ( V_266 -> V_264 , V_45 ) ;
F_4 ( & V_44 -> V_51 ) ;
}
static int F_118 ( struct V_251 * V_252 , void * V_267 )
{
struct V_13 * V_16 ;
struct V_43 * V_44 = F_28 ( V_252 -> V_264 , V_45 ) ;
if ( V_267 == & V_44 -> V_86 ) {
...
V_16 = F_120 ( V_267 , struct V_13 , V_52 ) ;
if ( V_16 -> V_26 != V_78 )
return 0 ;
F_121 () ;
F_122 ( V_252 , L_32 ,
...
static int F_125 ( struct V_249 * V_249 , struct V_250 * V_250 )
{
struct V_251 * V_252 ;
int V_253 ;
struct V_254 * V_255 = V_250 -> V_256 -> V_257 -> V_258 ;
struct V_41 * V_41 = V_255 -> V_259 -> V_260 -> V_261 ;
V_253 = F_112 ( V_250 , & V_271 ) ;
if ( V_253 < 0 )
return V_253 ;
V_252 = V_250 -> V_263 ;
V_252 -> V_264 = V_41 ;
...
static void * F_126 ( struct V_251 * V_252 , T_2 * V_265 )
{
struct V_43 * V_44 = F_28 ( V_252 -> V_264 , V_45 ) ;
F_2 ( & V_44 -> V_51 ) ;
return F_114 ( & V_44 -> V_215 , * V_265 ) ;
}
static void * F_127 ( struct V_251 * V_266 , void * V_267 , T_2 * V_268 )
{
struct V_43 * V_44 = F_28 ( V_266 -> V_264 , V_45 ) ;
return F_116 ( V_267 , & V_44 -> V_215 , V_268 ) ;
}
static void F_128 ( struct V_251 * V_266 , void * V_267 )
{
struct V_43 * V_44 = F_28 ( V_266 -> V_264 , V_45 ) ;
F_4 ( & V_44 -> V_51 ) ;
}
static int F_129 ( struct V_251 * V_252 , void * V_267 )
{
struct V_48 * V_49 ;
struct V_13 * V_16 ;
char V_272 [ 8 ] , V_237 [ 17 ] ;
struct V_43 * V_44 = F_28 ( V_252 -> V_264 , V_45 ) ;
if ( V_267 == & V_44 -> V_215 ) {
F_119 ( V_252 , L_33 ) ;
return 0 ;
}
V_49 = F_120 ( V_267 , struct V_48 , V_214 ) ;
V_16 = V_49 -> V_13 ;
snprintf ( V_272 , 8 , L_34 ,
F_130 ( V_49 -> V_273 ) , F_131 ( V_49 -> V_273 ) ) ;
snprintf ( V_237 , 17 , L_35 ,
( unsigned long long ) V_49 -> V_237 . V_238 ,
( unsigned long long ) V_49 -> V_237 . V_239 ) ;
F_121 () ;
F_122 ( V_252 , L_36 ,
...
{
struct V_274 * V_266 ;
V_275 = F_134 ( L_37 , NULL ) ;
if ( ! V_275 )
goto V_22;
V_266 = F_135 ( L_38 , V_276 | V_277 ,
V_275 , & V_278 ) ;
if ( ! V_266 )
goto V_279;
V_266 = F_135 ( L_39 , V_276 | V_277 ,
V_275 , & V_280 ) ;
if ( ! V_266 )
goto V_281;
return 0 ;
