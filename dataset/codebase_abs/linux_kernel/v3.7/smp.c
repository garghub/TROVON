...
static int T_9 F_85 ( struct V_116 * V_94 ,
int V_122 )
{
struct V_8 * V_8 ;
T_6 V_123 ;
...
static void T_5 F_95 ( void * V_137 )
{
V_35 . V_138 = F_44 () ;
V_35 . V_67 = ( unsigned long ) V_67 ;
V_35 . V_68 = ( unsigned long ) V_139 ;
V_35 . V_69 = 0 ;
V_35 . V_70 = - 1UL ;
F_96 ( V_35 . V_56 ) ;
F_68 ( V_35 . V_55 , 0 , 15 ) ;
...
return 0 ;
F_110 ( F_111 ( 0 ) ) ;
for ( V_19 = 1 ; V_19 < V_144 && V_19 < V_128 ; V_19 ++ )
F_112 ( V_19 , true ) ;
return 0 ;
}
int F_113 ( void )
...
static T_11 F_126 ( struct V_147 * V_148 ,
struct V_149 * V_150 , char * V_151 )
{
T_11 V_152 ;
F_127 ( & V_153 ) ;
V_152 = sprintf ( V_151 , L_9 , V_20 [ V_148 -> V_154 ] . V_131 ) ;
F_128 ( & V_153 ) ;
return V_152 ;
}
static T_11 F_129 ( struct V_147 * V_148 ,
struct V_149 * V_150 ,
const char * V_151 , T_12 V_152 )
{
struct V_8 * V_8 ;
int V_19 , V_114 , V_141 ;
char V_155 ;
if ( sscanf ( V_151 , L_10 , & V_114 , & V_155 ) != 1 )
return - V_156 ;
if ( V_114 != 0 && V_114 != 1 )
return - V_156 ;
F_92 () ;
...
static T_11 F_133 ( struct V_147 * V_148 ,
struct V_149 * V_150 , char * V_151 )
{
return sprintf ( V_151 , L_9 , V_20 [ V_148 -> V_154 ] . V_10 ) ;
}
static T_11 F_134 ( struct V_147 * V_148 ,
struct V_149 * V_150 , char * V_151 )
{
...
static T_11 F_137 ( struct V_147 * V_148 ,
struct V_149 * V_150 , char * V_151 )
{
struct V_158 * V_159 = & F_135 ( V_160 , V_148 -> V_154 ) ;
...
static T_11 T_13 F_148 ( struct V_147 * V_148 ,
struct V_149 * V_150 ,
const char * V_151 ,
T_12 V_152 )
{
