...
static int F_28 ( struct V_1 * V_39 ,
struct V_3 * V_4 , unsigned long V_25 , T_1 V_15 ,
struct V_26 * * V_40 , unsigned long * V_22 )
{
int V_29 ;
struct V_8 * V_9 = (struct V_8 * ) V_4 -> V_10 ;
struct V_26 * V_27 [ V_41 + 1 ] ;
struct V_11 * V_12 = (struct V_11 * ) * V_22 ;
if ( V_40 [ V_42 ] == NULL )
return - V_30 ;
V_29 = F_29 ( V_27 , V_41 , V_40 [ V_42 ] ,
V_43 ) ;
if ( V_29 < 0 )
return V_29 ;
if ( V_12 != NULL ) {
...
return - V_30 ;
return F_21 ( V_4 , V_12 , V_25 , V_27 , V_40 [ V_44 ] ) ;
}
V_29 = - V_18 ;
...
unsigned int V_45 = 0x80000000 ;
do {
if ( ++ V_9 -> V_46 == 0x7FFFFFFF )
V_9 -> V_46 = 1 ;
} while ( -- V_45 > 0 && F_5 ( V_4 , V_9 -> V_46 ) );
if ( V_45 <= 0 ) {
F_30 ( L_1 ) ;
goto V_36;
}
...
V_29 = F_21 ( V_4 , V_12 , V_25 , V_27 , V_40 [ V_44 ] ) ;
if ( V_29 < 0 )
goto V_36;
F_19 ( V_4 ) ;
...
static void F_32 ( struct V_3 * V_4 , struct V_47 * V_22 )
{
struct V_8 * V_9 = (struct V_8 * ) V_4 -> V_10 ;
struct V_11 * V_12 ;
F_2 (f, &head->flist, link) {
...
goto V_49;
if ( V_22 -> V_50 ( V_4 , ( unsigned long ) V_12 , V_22 ) < 0 ) {
V_22 -> V_51 = 1 ;
break;
}
V_49:
...
static int F_33 ( struct V_3 * V_4 , unsigned long V_52 ,
struct V_1 * V_2 , struct V_53 * V_23 )
{
struct V_11 * V_12 = (struct V_11 * ) V_52 ;
struct V_26 * V_54 ;
if ( V_12 == NULL )
return V_2 -> V_55 ;
V_23 -> V_56 = V_12 -> V_15 ;
