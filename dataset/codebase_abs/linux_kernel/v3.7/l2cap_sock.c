...
static void F_74 ( struct V_2 * V_171 )
{
struct V_2 * V_6 ;
F_3 ( L_7 , V_171 ) ;
while ( ( V_6 = F_25 ( V_171 , NULL ) ) ) {
struct V_7 * V_8 = F_2 ( V_6 ) -> V_8 ;
F_50 ( V_8 ) ;
F_75 ( V_8 ) ;
F_69 ( V_8 , V_172 ) ;
...
static struct V_7 * F_76 ( struct V_7 * V_8 )
{
struct V_2 * V_6 , * V_171 = V_8 -> V_173 ;
if ( F_77 ( V_171 ) ) {
F_3 ( L_8 , V_171 -> V_48 ) ;
return NULL ;
}
V_6 = F_78 ( F_79 ( V_171 ) , NULL , V_174 ,
V_175 ) ;
if ( ! V_6 )
return NULL ;
F_80 ( V_6 , V_174 ) ;
...
static int F_82 ( struct V_7 * V_8 , struct V_176 * V_177 )
{
int V_12 ;
struct V_2 * V_6 = V_8 -> V_173 ;
struct V_152 * V_153 = F_2 ( V_6 ) ;
F_5 ( V_6 ) ;
if ( V_153 -> V_156 ) {
V_12 = - V_178 ;
...
static void F_84 ( struct V_7 * V_8 , int V_12 )
{
struct V_2 * V_6 = V_8 -> V_173 ;
struct V_2 * V_171 ;
F_5 ( V_6 ) ;
V_171 = F_11 ( V_6 ) -> V_171 ;
F_64 ( V_6 , V_159 ) ;
switch ( V_8 -> V_31 ) {
case V_19 :
case V_32 :
...
static void F_86 ( struct V_7 * V_8 , int V_31 )
{
struct V_2 * V_6 = V_8 -> V_173 ;
V_6 -> V_18 = V_31 ;
}
static struct V_176 * F_87 ( struct V_7 * V_8 ,
unsigned long V_11 , int V_180 )
{
struct V_176 * V_177 ;
int V_12 ;
F_52 ( V_8 ) ;
V_177 = F_88 ( V_8 -> V_6 , V_11 , V_180 , & V_12 ) ;
F_50 ( V_8 ) ;
if ( ! V_177 )
return F_89 ( V_12 ) ;
return V_177 ;
...
static void F_91 ( struct V_2 * V_6 )
{
F_3 ( L_1 , V_6 ) ;
F_63 ( F_2 ( V_6 ) -> V_8 ) ;
if ( F_2 ( V_6 ) -> V_156 ) {
...
static void F_81 ( struct V_2 * V_6 , struct V_2 * V_171 )
{
struct V_152 * V_153 = F_2 ( V_6 ) ;
struct V_7 * V_8 = V_153 -> V_8 ;
F_3 ( L_1 , V_6 ) ;
if ( V_171 ) {
struct V_7 * V_183 = F_2 ( V_171 ) -> V_8 ;
V_6 -> V_38 = V_171 -> V_38 ;
F_11 ( V_6 ) -> V_33 = F_11 ( V_171 ) -> V_33 ;
V_8 -> V_111 = V_183 -> V_111 ;
V_8 -> V_75 = V_183 -> V_75 ;
V_8 -> V_76 = V_183 -> V_76 ;
V_8 -> V_132 = V_183 -> V_132 ;
V_8 -> V_41 = V_183 -> V_41 ;
V_8 -> V_78 = V_183 -> V_78 ;
V_8 -> V_79 = V_183 -> V_79 ;
V_8 -> V_81 = V_183 -> V_81 ;
V_8 -> V_184 = V_183 -> V_184 ;
V_8 -> V_28 = V_183 -> V_28 ;
V_8 -> V_33 = V_183 -> V_33 ;
F_94 ( V_171 , V_6 ) ;
} else {
...
static struct V_2 * F_78 ( struct V_191 * V_191 , struct V_1 * V_2 , int V_192 , T_6 V_193 )
{
struct V_2 * V_6 ;
struct V_7 * V_8 ;
V_6 = F_96 ( V_191 , V_194 , V_193 , & V_195 ) ;
if ( ! V_6 )
return NULL ;
F_97 ( V_2 , V_6 ) ;
F_98 ( & F_11 ( V_6 ) -> V_196 ) ;
...
static int F_103 ( struct V_191 * V_191 , struct V_1 * V_2 , int V_201 ,
int V_202 )
{
struct V_2 * V_6 ;
F_3 ( L_10 , V_2 ) ;
...
V_2 -> type != V_185 && V_2 -> type != V_120 )
return - V_204 ;
if ( V_2 -> type == V_120 && ! V_202 && ! F_7 ( V_205 ) )
return - V_206 ;
V_2 -> V_189 = & V_207 ;
V_6 = F_78 ( V_191 , V_2 , V_201 , V_175 ) ;
if ( ! V_6 )
return - V_178 ;
F_81 ( V_6 , NULL ) ;
F_104 ( & V_170 , V_6 ) ;
...
if ( V_12 < 0 )
return V_12 ;
V_12 = F_107 ( V_174 , & V_208 ) ;
if ( V_12 < 0 ) {
F_108 ( L_11 ) ;
goto error;
}
V_12 = F_109 ( V_209 , & V_210 , L_12 , & V_170 , NULL ) ;
if ( V_12 < 0 ) {
F_108 ( L_13 ) ;
F_110 ( V_174 ) ;
goto error;
