...
static int F_56 ( struct V_82 * V_65 , unsigned int V_24 ,
T_5 V_83 )
{
F_57 ( V_24 , & V_84 ,
V_85 ) ;
...
static int T_4 F_59 ( struct V_88 * V_89 )
{
int V_15 , V_90 , V_91 ;
...
V_91 = V_90 << 5 ;
V_36 = V_91 - 1 ;
V_23 = F_64 ( - 1 , 0 , V_91 , 0 ) ;
if ( V_23 < 0 ) {
F_61 ( & V_89 -> V_96 , L_9 ) ;
goto V_102;
}
V_103 = F_65 ( V_95 , V_91 , V_23 , 0 ,
& V_104 , NULL ) ;
V_53 = V_95 ;
return 0 ;
V_102:
...
static int T_4 F_67 ( struct V_88 * V_89 )
{
struct V_3 * V_2 ;
struct V_105 * V_106 ;
struct V_107 * V_107 ;
...
if ( ! V_36 )
return - V_37 ;
V_111 = F_70 ( V_89 , L_10 ) ;
V_112 = F_70 ( V_89 , L_11 ) ;
V_113 = F_70 ( V_89 , L_12 ) ;
if ( ( V_111 > 0 && V_112 <= 0 ) || ( V_111 <= 0 && V_112 > 0 )
|| ( V_113 <= 0 ) )
return - V_37 ;
V_106 = F_71 ( V_89 , V_115 , 0 ) ;
if ( ! V_106 )
return - V_37 ;
V_46 = F_72 ( V_106 -> V_116 , F_73 ( V_106 ) ) ;
if ( ! V_46 )
return - V_37 ;
if ( V_111 > 0 )
V_114 = 2 ;
V_107 = F_74 ( & V_89 -> V_96 , NULL ) ;
if ( F_75 ( V_107 ) ) {
F_61 ( & V_89 -> V_96 , L_13 ,
F_76 ( V_107 ) ) ;
F_66 ( V_46 ) ;
