...
V_10 -> V_14 ) ;
for ( V_3 = 0 ; V_3 < V_43 ; V_3 ++ )
F_69 ( V_70 , L_21 , V_98 [ V_3 ] ,
F_87 ( V_10 , V_3 ) ) ;
F_69 ( V_70 ,
L_22 ,
V_10 -> V_99 [ 0 ] ) ;
for ( V_3 = 1 ; V_3 < F_88 ( V_10 -> V_99 ) ; V_3 ++ )
F_69 ( V_70 , L_23 , V_10 -> V_99 [ V_3 ] ) ;
F_69 ( V_70 ,
L_24
L_25 ) ;
F_2 (i) {
...
if ( * V_71 >= F_88 ( V_98 ) )
return NULL ;
V_105 = V_43 * sizeof( unsigned long ) +
V_106 * sizeof( unsigned long ) ;
#ifdef F_93
V_105 += sizeof( struct V_5 ) ;
#endif
V_33 = F_94 ( V_105 , V_107 ) ;
V_70 -> V_108 = V_33 ;
if ( ! V_33 )
return F_95 ( - V_109 ) ;
for ( V_3 = 0 ; V_3 < V_43 ; V_3 ++ )
...
V_33 [ V_113 ] /= 2 ;
#endif
return ( unsigned long * ) V_70 -> V_108 + * V_71 ;
}
...
{
unsigned long * V_114 = V_72 ;
unsigned long V_115 = V_114 - ( unsigned long * ) V_70 -> V_108 ;
F_69 ( V_70 , L_34 , V_98 [ V_115 ] , * V_114 ) ;
return 0 ;
}
...
{
struct V_121 * V_122 = & F_3 ( V_119 , V_2 ) ;
F_109 ( V_122 , F_103 ) ;
F_110 ( V_2 , V_122 , F_111 ( V_123 , V_2 ) ) ;
}
...
F_17 () ;
F_108 ( V_2 ) ;
F_113 ( F_114 ( V_2 ) , V_130 ) ;
break;
case V_131 :
case V_132 :
F_115 ( & F_3 ( V_119 , V_2 ) ) ;
F_3 ( V_119 , V_2 ) . V_122 . V_133 = NULL ;
break;
case V_134 :
case V_135 :
F_108 ( V_2 ) ;
...
#endif
#ifdef F_118
F_119 ( L_35 , V_140 , NULL , & V_141 ) ;
F_119 ( L_36 , V_140 , NULL , & V_142 ) ;
F_119 ( L_37 , V_140 , NULL , & V_143 ) ;
F_119 ( L_38 , V_140 , NULL , & V_144 ) ;
#endif
return 0 ;
}
...
for ( V_60 = 0 ; V_60 < V_64 ; ++ V_60 ) {
F_54 ( V_10 , V_60 , & V_59 ) ;
V_145 = F_120 ( V_60 , & V_59 ) ;
F_69 ( V_70 , L_39 , V_145 / 1000 , V_145 % 1000 ) ;
}
F_70 ( V_70 , '\n' ) ;
}
