...
return F_117 ( V_200 -> V_13 , V_257 , 0 , V_200 -> V_256 , V_200 ) ;
}
...
V_78 = F_137 ( V_273 , V_244 , V_274 , V_200 , V_275 ) ;
if ( V_78 )
return V_78 ;
V_78 = F_133 ( V_200 ) ;
if ( V_78 )
return V_78 ;
return F_115 ( V_244 , V_246 , V_280 , V_200 , V_257 ) ;
}
static int F_147 ( struct V_272 * V_273 , struct V_243 * V_244 ,
...
continue;
V_78 = F_144 ( V_246 , V_269 , V_244 , V_273 , V_274 ,
...
int V_283 ;
int V_153 ;
V_252 = F_141 ( V_273 , V_274 , L_25 , & V_283 ) ;
if ( ! V_252 ) {
F_150 ( L_26 ) ;
return - V_107 ;
}
V_246 -> V_250 = V_283 / sizeof( T_2 ) ;
V_246 -> V_251 = F_84 ( ( sizeof( struct V_284 ) *
V_246 -> V_250 ) ,
V_201 ) ;
if ( ! V_246 -> V_251 )
return - V_185 ;
for ( V_153 = 0 ; V_153 < V_246 -> V_250 ; V_153 ++ ) {
struct V_284 * V_285 = & V_246 -> V_251 [ V_153 ] ;
V_285 -> V_249 = V_153 + 1 ;
V_285 -> V_252 = V_252 [ V_153 ] ;
}
return 0 ;
}
...
T_2 V_274 ;
V_287 = F_114 ( V_244 -> V_244 . V_253 , L_27 , NULL ) ;
if ( ! V_287 )
return - V_107 ;
...
continue;
V_246 -> V_289 = * V_288 ;
return F_149 ( V_273 , V_274 , V_246 ) ;
}
return - V_107 ;
}
...
V_78 = F_151 ( V_273 , V_244 , & V_299 -> V_301 , L_37 ) ;
if ( V_78 ) {
...
V_78 = F_147 ( V_273 , V_244 , & V_299 -> V_301 , & V_299 -> V_300 ,
L_39 , V_263 , F_3 ,
V_109 ) ;
F_163 ( V_273 ) ;
if ( V_78 ) {
...
{
struct V_298 * V_299 = F_166 ( & V_244 -> V_244 ) ;
F_112 () ;
F_135 ( & V_299 -> V_300 ) ;
F_157 () ;
F_159 ( V_299 ) ;
...
V_78 = F_151 ( V_273 , V_244 , & V_308 -> V_310 , L_44 ) ;
if ( V_78 ) {
F_142 ( & V_244 -> V_244 , L_38 ,
V_279 ) ;
F_163 ( V_273 ) ;
...
V_78 = F_147 ( V_273 , V_244 , & V_308 -> V_310 , & V_308 -> V_309 ,
L_45 , V_5 , F_10 ,
V_296 ) ;
F_163 ( V_273 ) ;
if ( V_78 ) {
...
{
struct V_307 * V_308 = F_166 ( & V_244 -> V_244 ) ;
F_135 ( & V_308 -> V_309 ) ;
F_157 () ;
F_168 ( V_308 ) ;
return 0 ;
