...
for ( V_16 = V_22 -> V_80 . V_81 ; V_16 ; V_16 = V_16 -> V_18 ) {
if ( V_16 -> V_31 & V_82 ) {
int V_83 ;
if ( V_16 -> V_31 & V_84 ) {
V_83 = * ( int * ) ( V_71 + V_16 -> V_83 ) ;
V_83 &= 0xffff ;
} else
V_83 = V_16 -> V_83 ;
V_63 = F_8 ( ( char * ) V_71 + V_83 ) ;
} else {
V_66 = F_25 ( V_22 , V_71 + V_16 -> V_83 ,
V_16 -> V_36 ) ;
if ( V_16 -> V_31 & V_85 ) {
if ( ( long long ) V_66 >= V_86 &&
( long long ) V_66 <= V_87 )
V_63 = F_9 ( V_66 ) ;
else
V_63 = F_26 ( V_66 ) ;
...
F_24 ( V_64 , L_25 , F_31 (
( const char * ) V_58 -> V_72 , V_58 -> V_88 ) ) ;
F_24 ( V_64 , L_26 ,
F_8 ( V_74 -> V_75 ) ) ;
if ( V_61 -> V_89 ) {
F_24 ( V_64 , L_27 ,
F_8 ( V_61 -> V_89 -> V_90 -> V_30 ) ) ;
}
if ( V_61 -> V_91 ) {
F_24 ( V_64 , L_28 ,
F_8 ( V_61 -> V_91 -> V_30 ) ) ;
...
static int F_38 ( const char * V_96 , int V_97 , const char * * V_98 )
{
const char * * V_99 ;
char V_100 [ V_101 ] ;
int V_102 , V_93 = 0 ;
T_2 * V_103 ;
V_99 = malloc ( ( V_97 + 1 ) * sizeof( const char * ) ) ;
V_99 [ 0 ] = V_96 ;
for ( V_102 = 1 ; V_102 < V_97 + 1 ; V_102 ++ )
V_99 [ V_102 ] = V_98 [ V_102 - 1 ] ;
F_39 () ;
F_40 () ;
F_41 ( V_97 + 1 , ( char * * ) V_99 ) ;
V_103 = fopen ( V_96 , L_31 ) ;
if ( ! V_103 ) {
sprintf ( V_100 , L_32 , V_96 ) ;
perror ( V_100 ) ;
V_93 = - 1 ;
goto error;
}
V_93 = F_42 ( V_103 , V_96 ) ;
if ( V_93 ) {
fprintf ( V_104 , L_33 , V_96 ) ;
goto error;
}
V_93 = F_33 () ;
if ( V_93 ) {
fprintf ( V_104 , L_34 , V_96 ) ;
goto error;
}
free ( V_99 ) ;
return V_93 ;
...
static int F_45 ( struct V_105 * V_105 , const char * V_106 )
{
...
V_109 = 0 ;
V_110 = 0 ;
for ( V_107 = V_22 -> V_80 . V_81 ; V_107 ; V_107 = V_107 -> V_18 ) {
if ( V_109 ++ )
fprintf ( V_111 , L_71 ) ;
if ( ++ V_110 % 5 == 0 )
fprintf ( V_111 , L_72 ) ;
