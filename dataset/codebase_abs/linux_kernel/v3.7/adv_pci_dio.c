...
return - V_159 ;
V_2 -> V_160 = V_76 ;
V_2 -> V_161 = V_76 -> V_162 ;
V_24 = F_39 ( V_2 , sizeof( * V_49 ) ) ;
if ( V_24 < 0 )
return V_24 ;
V_49 = V_2 -> V_10 ;
V_24 = F_40 ( V_151 , V_2 -> V_161 ) ;
if ( V_24 )
return V_24 ;
V_2 -> V_13 = F_41 ( V_151 , V_76 -> V_163 ) ;
V_24 = F_42 ( V_2 , V_76 -> V_164 ) ;
if ( V_24 )
return V_24 ;
V_157 = 0 ;
...
for ( V_158 = 0 ; V_158 < V_76 -> V_170 [ V_11 ] . V_12 ; V_158 ++ ) {
V_4 = & V_2 -> V_125 [ V_157 ] ;
F_43 ( V_2 , V_4 , NULL ,
V_2 -> V_13 +
...
if ( V_2 -> V_125 ) {
for ( V_11 = 0 ; V_11 < V_2 -> V_176 ; V_11 ++ ) {
V_4 = & V_2 -> V_125 [ V_11 ] ;
if ( V_4 -> type == V_177 )
F_46 ( V_2 , V_4 ) ;
V_4 -> V_10 = NULL ;
...
static int T_1 F_48 ( struct V_150 * V_2 ,
const struct V_178 * V_179 )
{
return F_49 ( V_2 , & V_180 ) ;
}
static void T_2 F_50 ( struct V_150 * V_2 )
{
F_51 ( V_2 ) ;
}
