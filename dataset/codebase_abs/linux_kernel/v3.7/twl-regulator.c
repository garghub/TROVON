...
static int F_35 ( struct V_8 * V_9 , unsigned V_46 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
int V_62 = 0 ;
switch ( V_2 -> V_63 ) {
...
static int F_36 ( struct V_8 * V_9 , int V_53 ,
int V_54 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
int V_51 = 0 ;
...
else if ( ( V_53 > 1900000 ) && ( V_53 <= 2100000 ) )
V_51 = 62 ;
else if ( ( V_53 > 1800000 ) && ( V_53 <= 1900000 ) )
V_51 = 61 ;
else if ( ( V_53 > 1500000 ) && ( V_53 <= 1800000 ) )
V_51 = 60 ;
else if ( ( V_53 > 1350000 ) && ( V_53 <= 1500000 ) )
V_51 = 59 ;
else if ( ( V_53 > 1300000 ) && ( V_53 <= 1350000 ) )
V_51 = 58 ;
else
return - V_41 ;
break;
...
V_51 = 61 ;
else if ( ( V_53 > 1350000 ) && ( V_53 <= 1800000 ) )
V_51 = 60 ;
else if ( ( V_53 > 1350000 ) && ( V_53 <= 1500000 ) )
V_51 = 59 ;
else if ( ( V_53 > 1300000 ) && ( V_53 <= 1350000 ) )
...
if ( V_53 == 0 ) {
V_51 = 0 ;
} else if ( ( V_53 >= 2161000 ) && ( V_53 <= 4321000 ) ) {
...
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
return F_3 ( V_2 , V_10 , V_66 ,
V_49 ) ;
}
static int F_38 ( struct V_8 * V_9 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
return F_1 ( V_2 , V_10 , V_66 ) ;
}
...
static int T_2 F_41 ( struct V_69 * V_70 )
{
int V_71 , V_37 ;
struct V_1 * V_2 ;
...
V_37 = V_70 -> V_37 ;
V_74 = V_70 -> V_84 . V_87 ;
for ( V_71 = 0 , V_72 = NULL ; V_71 < F_44 ( V_83 ) ; V_71 ++ ) {
V_72 = V_83 [ V_71 ] . V_56 ;
if ( V_72 && V_72 -> V_85 . V_37 == V_37 )
break;
}
if ( V_71 == F_44 ( V_83 ) )
return - V_59 ;
...
V_82 . V_111 = V_74 ;
V_82 . V_88 = V_2 ;
V_82 . V_86 = V_70 -> V_84 . V_86 ;
V_9 = F_46 ( & V_2 -> V_85 , & V_82 ) ;
if ( F_47 ( V_9 ) ) {
F_48 ( & V_70 -> V_84 , L_1 ,
V_2 -> V_85 . V_112 , F_49 ( V_9 ) ) ;
F_50 ( V_2 ) ;
return F_49 ( V_9 ) ;
}
F_51 ( V_70 , V_9 ) ;
...
static int T_3 F_53 ( struct V_69 * V_70 )
{
struct V_8 * V_9 = F_54 ( V_70 ) ;
struct V_1 * V_2 = V_9 -> V_115 ;
F_55 ( V_9 ) ;
F_50 ( V_2 ) ;
return 0 ;
}
