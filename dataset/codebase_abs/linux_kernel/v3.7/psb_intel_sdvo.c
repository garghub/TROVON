...
if ( V_7 -> V_224 )
V_1 -> V_176 = V_7 -> V_224 > 0 ;
}
return V_32 ;
}
static enum V_216
F_66 ( struct V_5 * V_6 , bool V_225 )
{
T_4 V_36 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
V_144 = 1 << V_1 -> V_145 ;
memcpy ( & V_236 , & V_144 ,
V_77 ( sizeof( V_144 ) , sizeof( struct V_235 ) ) ) ;
...
if ( ! F_18 ( V_1 , & V_237 , 3 ) )
return;
for ( V_13 = 0 ; V_13 < F_16 ( V_239 ) ; V_13 ++ )
if ( V_237 & ( 1 << V_13 ) ) {
struct V_45 * V_240 ;
V_240 = F_73 ( V_6 -> V_10 ,
& V_239 [ V_13 ] ) ;
...
T_5 V_28 ;
int V_26 ;
V_26 = F_89 ( V_6 , V_267 , V_8 ) ;
if ( V_26 )
return V_26 ;
if ( V_267 == V_211 -> V_269 ) {
int V_13 = V_8 ;
bool V_265 ;
if ( V_13 == V_7 -> V_224 )
return 0 ;
...
if ( V_267 == V_211 -> V_271 ) {
if ( V_8 == ! ! V_1 -> V_272 )
return 0 ;
V_1 -> V_272 = V_8 ? V_273 : 0 ;
goto V_270;
}
...
return - V_275 ;
V_281:
if ( ! F_22 ( V_1 , V_28 , & V_268 , 2 ) )
return - V_286 ;
V_270:
if ( V_1 -> V_4 . V_4 . V_154 ) {
struct V_153 * V_154 = V_1 -> V_4 . V_4 . V_154 ;
F_92 ( V_154 , & V_154 -> V_46 , V_154 -> V_287 ,
V_154 -> V_288 , V_154 -> V_289 ) ;
}
return 0 ;
#undef F_90
}
...
V_292 = & ( V_211 -> V_293 [ 1 ] ) ;
if ( V_292 -> V_294 )
V_208 -> V_47 = 1 << ( ( V_292 -> V_295 & 0xf0 ) >> 4 ) ;
else
F_97 ( V_208 ) ;
}
static void
...
if ( V_296 < V_302 ) {
V_208 -> V_27 = & V_211 -> V_213 [ V_296 ] . V_215 ;
F_101 ( V_208 -> V_27 , V_297 ) ;
F_102 ( V_208 -> V_27 , true ) ;
} else
V_208 -> V_27 = & V_211 -> V_213 [ V_298 ] . V_215 ;
}
static bool
F_103 ( struct V_1 * V_1 , int V_303 )
{
return F_39 ( V_1 ) ;
}
static T_2
...
static bool
F_111 ( struct V_1 * V_1 , int V_303 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_314 * V_315 ;
struct V_7 * V_7 ;
V_7 = F_112 ( sizeof( struct V_7 ) , V_316 ) ;
if ( ! V_7 )
return false ;
if ( V_303 == 0 ) {
V_1 -> V_317 |= V_318 ;
...
static bool
F_116 ( struct V_1 * V_1 , int V_303 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_314 * V_315 ;
...
static bool
F_117 ( struct V_1 * V_1 , int V_303 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_314 * V_315 ;
...
return false ;
if ( ( V_22 & V_344 ) == 0 ) {
unsigned char V_345 [ 2 ] ;
V_1 -> V_317 = 0 ;
memcpy ( V_345 , & V_1 -> V_193 . V_206 , 2 ) ;
F_12 ( L_34 ,
F_14 ( V_1 ) ,
V_345 [ 0 ] , V_345 [ 1 ] ) ;
return false ;
}
V_1 -> V_4 . V_346 = ( 1 << 0 ) | ( 1 << 1 ) ;
return true ;
}
...
return false ;
V_7 -> V_348 = 0 ;
for ( V_13 = 0 ; V_13 < V_274 ; V_13 ++ )
if ( V_144 & ( 1 << V_13 ) )
V_7 -> V_276 [ V_7 -> V_348 ++ ] = V_13 ;
V_7 -> V_264 =
F_119 ( V_10 , V_349 ,
L_35 , V_7 -> V_348 ) ;
if ( ! V_7 -> V_264 )
return false ;
for ( V_13 = 0 ; V_13 < V_7 -> V_348 ; V_13 ++ )
F_120 (
V_7 -> V_264 , V_13 ,
V_13 , V_350 [ V_7 -> V_276 [ V_13 ] ] ) ;
V_1 -> V_145 = V_7 -> V_276 [ 0 ] ;
F_121 ( & V_7 -> V_4 . V_4 ,
V_7 -> V_264 , 0 ) ;
return true ;
}
...
return false ;
V_7 -> V_279 = V_353 [ 0 ] ;
V_7 -> V_277 = V_353 [ 0 ] - V_36 ;
V_7 -> V_278 = V_7 -> V_277 ;
V_7 -> V_247 =
F_123 ( V_10 , 0 , L_36 , 0 , V_353 [ 0 ] ) ;
if ( ! V_7 -> V_247 )
return false ;
F_121 ( V_6 ,
V_7 -> V_247 ,
...
return false ;
V_7 -> V_284 = V_353 [ 0 ] ;
V_7 -> V_282 = V_353 [ 0 ] - V_36 ;
V_7 -> V_283 = V_7 -> V_282 ;
V_7 -> V_249 =
F_123 ( V_10 , 0 , L_40 , 0 , V_353 [ 0 ] ) ;
if ( ! V_7 -> V_249 )
return false ;
F_121 ( V_6 ,
V_7 -> V_249 ,
...
if ( F_80 ( V_7 ) )
return F_122 ( V_1 , V_7 , V_352 . V_237 ) ;
else if( F_81 ( V_7 ) )
return F_125 ( V_1 , V_7 , V_352 . V_237 ) ;
else
return true ;
}
static int F_126 ( struct V_376 * V_215 ,
struct V_19 * V_20 ,
int V_377 )
{
struct V_1 * V_208 = V_215 -> V_378 ;
if ( ! F_21 ( V_208 , V_208 -> V_47 ) )
return - V_286 ;
return V_208 -> V_27 -> V_379 -> V_380 ( V_208 -> V_27 , V_20 , V_377 ) ;
}
static T_1 F_127 ( struct V_376 * V_215 )
{
struct V_1 * V_208 = V_215 -> V_378 ;
return V_208 -> V_27 -> V_379 -> V_381 ( V_208 -> V_27 ) ;
}
static bool
F_128 ( struct V_1 * V_208 ,
struct V_9 * V_10 )
{
V_208 -> V_209 . V_382 = V_383 ;
V_208 -> V_209 . V_384 = V_385 ;
snprintf ( V_208 -> V_209 . V_31 , V_386 , L_46 ) ;
V_208 -> V_209 . V_10 . V_387 = & V_10 -> V_388 -> V_10 ;
V_208 -> V_209 . V_378 = V_208 ;
V_208 -> V_209 . V_379 = & V_389 ;
...
struct V_1 * V_1 ;
int V_13 ;
V_1 = F_112 ( sizeof( struct V_1 ) , V_316 ) ;
if ( ! V_1 )
return false ;
V_1 -> V_14 = V_14 ;
...
V_390 = & V_1 -> V_4 ;
V_390 -> type = V_391 ;
F_131 ( V_10 , & V_390 -> V_4 , & V_392 , 0 ) ;
for ( V_13 = 0 ; V_13 < 0x40 ; V_13 ++ ) {
T_2 V_393 ;
if ( ! F_10 ( V_1 , V_13 , & V_393 ) ) {
F_12 ( L_47 ,
F_99 ( V_14 ) ? 'B' : 'C' ) ;
goto V_330;
}
