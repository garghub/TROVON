...
int V_58 ;
for ( V_58 = F_24 ( V_59 ) - 1 ; V_58 >= 0 ; V_58 -- ) {
if ( ( V_55 <= V_59 [ V_58 ] ) &&
( V_59 [ V_58 ] <= V_56 ) )
return F_6 ( V_5 , V_6 ,
V_60 ,
...
static int F_45 ( struct V_1 * V_2 , int V_53 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_5 = V_4 -> V_5 ;
T_1 V_6 = V_4 -> V_7 + V_22 ;
int V_104 ;
V_104 = F_46 ( V_2 , V_53 , V_53 ) ;
if ( V_104 < 0 )
return V_104 ;
return F_6 ( V_5 , V_6 , V_105 , V_104 ) ;
}
static T_3 int F_47 ( struct V_71 * V_72 )
{
struct V_5 * V_5 = F_30 ( V_72 -> V_25 . V_73 ) ;
struct V_74 * V_63 = V_5 -> V_25 -> V_75 ;
struct V_76 V_77 = { } ;
...
V_4 -> V_87 . V_78 = V_78 ;
V_4 -> V_87 . type = V_89 ;
V_4 -> V_87 . V_90 = V_106 + 1 ;
V_4 -> V_87 . V_91 = & V_107 ;
V_4 -> V_87 . V_93 = V_94 ;
V_4 -> V_87 . V_108 = V_4 -> V_7 + V_8 ;
V_4 -> V_87 . V_109 = V_105 ;
V_4 -> V_87 . V_95 = V_96 ;
V_4 -> V_87 . V_97 = 1 << V_78 ;
V_4 -> V_87 . V_40 = 850000 ;
V_4 -> V_87 . V_110 = 25000 ;
V_77 . V_25 = V_72 -> V_25 . V_73 ;
if ( V_63 )
V_77 . V_99 = V_63 -> V_4 [ V_78 ] ;
V_77 . V_98 = V_4 ;
...
static T_4 int F_48 ( struct V_71 * V_72 )
{
struct V_3 * V_4 = F_44 ( V_72 ) ;
F_39 ( V_72 , NULL ) ;
...
static T_3 int F_50 ( struct V_71 * V_72 )
{
struct V_5 * V_5 = F_30 ( V_72 -> V_25 . V_73 ) ;
struct V_74 * V_63 = V_5 -> V_25 -> V_75 ;
struct V_76 V_77 = { } ;
...
static T_4 int F_51 ( struct V_71 * V_72 )
{
struct V_3 * V_4 = F_44 ( V_72 ) ;
F_39 ( V_72 , NULL ) ;
F_40 ( F_36 ( V_4 -> V_5 , F_37 ( V_72 , L_18 ) ) ,
...
struct V_74 * V_63 = V_5 -> V_25 -> V_75 ;
struct V_76 V_77 = { } ;
int V_78 = V_72 -> V_78 % F_24 ( V_63 -> V_113 ) ;
struct V_3 * V_4 ;
int V_23 ;
