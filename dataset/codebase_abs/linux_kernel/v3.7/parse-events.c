...
int F_45 ( struct V_27 * V_36 , char * V_39 , bool V_122 )
{
struct V_34 * V_35 ;
struct V_106 V_107 ;
if ( V_39 == NULL )
return 0 ;
if ( ! V_122 && F_51 ( & V_107 , V_39 , NULL ) )
return - V_10 ;
F_36 (evsel, list, node) {
if ( V_122 && F_51 ( & V_107 , V_39 , V_35 ) )
return - V_10 ;
...
int F_52 ( struct V_27 * V_36 , char * V_22 )
{
struct V_34 * V_35 ;
F_36 (evsel, list, node) {
if ( ! V_35 -> V_22 )
...
static int F_53 ( const char * V_39 , void * V_123 , int V_124 )
{
T_5 V_125 ;
void * V_126 ;
int V_66 ;
V_66 = F_54 ( V_124 , & V_126 ) ;
if ( V_66 )
return V_66 ;
V_125 = F_55 ( V_39 , V_126 ) ;
#ifdef F_56
V_127 = 1 ;
#endif
V_66 = F_57 ( V_123 , V_126 ) ;
F_58 ( V_125 , V_126 ) ;
F_59 ( V_125 , V_126 ) ;
F_60 ( V_126 ) ;
return V_66 ;
}
int F_61 ( struct V_27 * V_128 , const char * V_39 )
{
struct V_129 V_123 = {
. V_128 = NULL ,
} ;
int V_66 ;
V_66 = F_53 ( V_39 , & V_123 , V_130 ) ;
if ( ! V_66 ) {
F_62 ( V_123 . V_128 , V_128 ) ;
free ( V_123 . V_128 ) ;
return 0 ;
}
F_63 ( V_123 . V_128 ) ;
...
int F_64 ( struct V_131 * V_132 , const char * V_39 ,
int T_6 V_133 )
{
struct V_134 V_123 = {
. V_36 = F_65 ( V_123 . V_36 ) ,
. V_29 = V_132 -> V_135 ,
} ;
int V_66 ;
V_66 = F_53 ( V_39 , & V_123 , V_136 ) ;
if ( ! V_66 ) {
int V_137 = V_123 . V_29 - V_132 -> V_135 ;
F_66 ( V_132 , & V_123 . V_36 , V_137 ) ;
return 0 ;
}
fprintf ( V_138 , L_17 , V_39 ) ;
fprintf ( V_138 , L_18 ) ;
return V_66 ;
}
int F_67 ( const struct V_139 * V_140 , const char * V_39 ,
int T_6 V_133 )
{
struct V_131 * V_132 = * (struct V_131 * * ) V_140 -> V_141 ;
return F_64 ( V_132 , V_39 , T_6 ) ;
}
...
if ( V_132 -> V_135 > 0 )
V_142 = F_69 ( V_132 ) ;
if ( V_142 == NULL || V_142 -> V_31 . type != V_25 ) {
fprintf ( V_138 ,
L_19 ) ;
return - 1 ;
}
V_142 -> V_143 = F_18 ( V_39 ) ;
if ( V_142 -> V_143 == NULL ) {
fprintf ( V_138 , L_20 ) ;
return - 1 ;
}
...
void F_70 ( const char * V_144 , const char * V_145 ,
bool V_146 )
{
T_2 * V_2 , * V_3 ;
struct V_1 * V_14 , * V_15 , V_16 , V_17 ;
...
continue;
if ( V_146 ) {
printf ( L_21 , V_16 . V_8 , V_17 . V_8 ) ;
continue;
}
snprintf ( V_4 , V_5 , L_22 ,
V_16 . V_8 , V_17 . V_8 ) ;
printf ( L_23 , V_4 ,
V_147 [ V_25 ] ) ;
}
...
static void F_72 ( T_7 type , struct V_149 * V_150 ,
unsigned V_151 )
{
char V_22 [ 64 ] ;
unsigned V_43 ;
for ( V_43 = 0 ; V_43 < V_151 ; V_43 ++ , V_150 ++ ) {
if ( strlen ( V_150 -> V_152 ) )
snprintf ( V_22 , sizeof( V_22 ) , L_24 ,
V_150 -> V_153 , V_150 -> V_152 ) ;
else
snprintf ( V_22 , sizeof( V_22 ) , L_9 , V_150 -> V_153 ) ;
printf ( L_23 , V_22 ,
V_147 [ type ] ) ;
}
}
...
{
if ( type == V_24 )
F_72 ( type , V_154 , V_155 ) ;
else
F_72 ( type , V_156 , V_157 ) ;
}
int F_74 ( const char * V_145 , bool V_146 )
{
unsigned int type , V_158 , V_43 , V_159 = 0 ;
char V_22 [ 64 ] ;
...
F_75 ( type , V_158 , V_43 ,
V_22 , sizeof( V_22 ) ) ;
if ( V_145 != NULL && ! F_28 ( V_22 , V_145 ) )
continue;
if ( V_146 )
printf ( L_25 , V_22 ) ;
else
...
static void F_76 ( const char * V_145 , unsigned type ,
struct V_149 * V_150 , unsigned V_151 ,
bool V_146 )
{
unsigned V_43 , V_159 = 0 ;
char V_22 [ V_49 ] ;
for ( V_43 = 0 ; V_43 < V_151 ; V_43 ++ , V_150 ++ ) {
if ( V_145 != NULL &&
! ( F_28 ( V_150 -> V_153 , V_145 ) ||
( V_150 -> V_152 && F_28 ( V_150 -> V_152 , V_145 ) ) ) )
continue;
if ( V_146 ) {
printf ( L_25 , V_150 -> V_153 ) ;
continue;
}
if ( strlen ( V_150 -> V_152 ) )
snprintf ( V_22 , V_49 , L_24 , V_150 -> V_153 , V_150 -> V_152 ) ;
else
strncpy ( V_22 , V_150 -> V_153 , V_49 ) ;
printf ( L_23 , V_22 , V_147 [ type ] ) ;
V_159 ++ ;
}
if ( V_159 )
printf ( L_26 ) ;
}
void F_77 ( const char * V_145 , bool V_146 )
{
if ( ! V_146 ) {
printf ( L_26 ) ;
printf ( L_27 ) ;
...
F_70 ( NULL , NULL , V_146 ) ;
}
int F_78 ( struct V_79 * V_80 )
{
return V_80 -> V_81 != V_161 ;
}
static int F_79 ( struct V_79 * * V_162 , int V_163 ,
int V_81 , char * V_12 ,
char * V_39 , T_1 V_85 )
{
struct V_79 * V_80 ;
...
int F_80 ( struct V_79 * * V_80 ,
int V_81 , char * V_12 , T_1 V_85 )
{
return F_79 ( V_80 , V_164 , V_81 ,
V_12 , NULL , V_85 ) ;
}
int F_81 ( struct V_79 * * V_80 ,
int V_81 , char * V_12 , char * V_39 )
{
return F_79 ( V_80 , V_165 , V_81 ,
V_12 , V_39 , 0 ) ;
}
int F_82 ( struct V_79 * * V_166 ,
struct V_79 * V_80 )
{
return F_79 ( V_166 , V_80 -> V_163 , V_80 -> V_81 , V_80 -> V_12 ,
V_80 -> V_84 . V_39 , V_80 -> V_84 . V_85 ) ;
}
void F_63 ( struct V_27 * V_128 )
{
struct V_79 * V_80 , * V_167 ;
F_83 (term, h, terms, list)
free ( V_80 ) ;
free ( V_128 ) ;
}
