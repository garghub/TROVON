...
F_6 ( V_8 ) ;
F_20 ( V_3 -> V_50 ) ;
F_21 ( V_3 -> V_51 , V_3 -> V_52 ) ;
F_22 ( V_3 ) ;
}
static int F_23 ( const struct V_53 * V_54 ,
struct V_7 * V_8 )
{
struct V_2 * V_3 = NULL ;
int V_55 ;
...
V_3 = F_24 ( V_54 , & V_8 -> V_8 , L_12 ) ;
if ( V_3 == NULL )
return - V_56 ;
V_3 -> V_51 = V_8 -> V_57 [ 0 ] . V_58 ;
V_3 -> V_52 = F_25 ( & V_8 -> V_57 [ 0 ] ) ;
if ( ! F_26 ( V_3 -> V_51 , V_3 -> V_52 , V_59 ) ) {
F_27 ( & V_8 -> V_8 , L_13 ) ;
V_55 = - V_60 ;
goto V_61;
}
V_11 = F_28 ( & V_8 -> V_8 , L_14 ) ;
if ( F_29 ( V_11 ) ) {
F_27 ( & V_8 -> V_8 , L_15 ) ;
V_55 = F_30 ( V_11 ) ;
goto V_62;
}
V_10 = F_28 ( & V_8 -> V_8 , L_16 ) ;
if ( F_29 ( V_10 ) ) {
F_27 ( & V_8 -> V_8 , L_17 ) ;
V_55 = F_30 ( V_10 ) ;
goto V_63;
...
F_2 ( V_8 , V_3 ) ;
V_3 -> V_50 = F_31 ( V_3 -> V_51 , V_3 -> V_52 ) ;
if ( ! V_3 -> V_50 ) {
F_27 ( & V_8 -> V_8 , L_18 ) ;
V_55 = - V_56 ;
goto V_64;
...
F_32 ( F_33 ( V_3 ) ) ;
V_55 = F_34 ( V_3 , V_8 -> V_57 [ 1 ] . V_58 , 0 ) ;
if ( V_55 != 0 )
goto V_64;
return 0 ;
V_64:
...
static int T_3 F_40 ( struct V_7 * V_68 )
{
return F_23 ( & V_69 , V_68 ) ;
}
static int T_4 F_41 ( struct V_7 * V_68 )
{
struct V_2 * V_3 = F_42 ( V_68 ) ;
F_18 ( V_3 , V_68 ) ;
return 0 ;
}
static int F_43 ( struct V_70 * V_8 )
{
struct V_2 * V_3 = F_44 ( V_8 ) ;
struct V_65 * V_66 = F_33 ( V_3 ) ;
struct V_7 * V_68 = F_45 ( V_8 ) ;
unsigned long V_21 ;
int V_71 = 0 ;
F_46 ( & V_66 -> V_72 , V_21 ) ;
if ( V_66 -> V_73 != V_74 ) {
...
static int F_49 ( struct V_70 * V_8 )
{
struct V_2 * V_3 = F_44 ( V_8 ) ;
struct V_7 * V_68 = F_45 ( V_8 ) ;
F_2 ( V_68 , V_3 ) ;
