...
static bool F_48 ( struct V_8 * V_9 , int V_10 )
{
if ( ! F_49 ( V_9 ) )
return false ;
switch ( V_10 ) {
...
int F_50 ( struct V_8 * V_9 , int V_10 , T_5 * V_43 )
{
int V_28 ;
* V_43 = 0 ;
if ( V_10 & 1 )
return - V_40 ;
if ( F_48 ( V_9 , V_10 ) ) {
V_28 = F_51 ( V_9 , F_52 ( V_9 ) + V_10 , V_43 ) ;
if ( V_28 )
* V_43 = 0 ;
return V_28 ;
}
if ( F_49 ( V_9 ) && V_10 == V_72 &&
F_45 ( V_9 ) == V_60 ) {
* V_43 = V_81 ;
}
return 0 ;
}
int F_53 ( struct V_8 * V_9 , int V_10 , T_7 * V_43 )
{
int V_28 ;
* V_43 = 0 ;
if ( V_10 & 3 )
return - V_40 ;
if ( F_48 ( V_9 , V_10 ) ) {
V_28 = F_54 ( V_9 , F_52 ( V_9 ) + V_10 , V_43 ) ;
if ( V_28 )
* V_43 = 0 ;
return V_28 ;
}
if ( F_49 ( V_9 ) && V_10 == V_71 &&
F_45 ( V_9 ) == V_60 ) {
* V_43 = V_81 ;
}
return 0 ;
}
int F_55 ( struct V_8 * V_9 , int V_10 , T_5 V_43 )
{
if ( V_10 & 1 )
return - V_40 ;
if ( ! F_48 ( V_9 , V_10 ) )
return 0 ;
return F_56 ( V_9 , F_52 ( V_9 ) + V_10 , V_43 ) ;
}
int F_57 ( struct V_8 * V_9 , int V_10 , T_7 V_43 )
{
if ( V_10 & 3 )
return - V_40 ;
if ( ! F_48 ( V_9 , V_10 ) )
return 0 ;
return F_58 ( V_9 , F_52 ( V_9 ) + V_10 , V_43 ) ;
}
...
int V_28 ;
T_5 V_43 ;
V_28 = F_50 ( V_9 , V_10 , & V_43 ) ;
if ( ! V_28 ) {
V_43 &= ~ V_82 ;
V_43 |= V_83 ;
V_28 = F_55 ( V_9 , V_10 , V_43 ) ;
}
return V_28 ;
}
...
int V_28 ;
T_7 V_43 ;
V_28 = F_53 ( V_9 , V_10 , & V_43 ) ;
if ( ! V_28 ) {
V_43 &= ~ V_82 ;
V_43 |= V_83 ;
V_28 = F_57 ( V_9 , V_10 , V_43 ) ;
}
return V_28 ;
}
