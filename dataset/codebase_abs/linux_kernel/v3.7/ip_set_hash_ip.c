...
{
V_19 -> V_21 . V_5 = V_20 -> V_5 ;
}
static int
F_12 ( struct V_22 * V_23 , const struct V_9 * V_10 ,
...
T_3 V_5 ;
F_13 ( V_10 , V_29 -> V_32 & V_33 , & V_5 ) ;
V_5 &= F_14 ( V_19 -> V_34 ) ;
if ( V_5 == 0 )
return - V_35 ;
return V_30 ( V_23 , & V_5 , F_15 ( V_29 , V_19 ) , V_29 -> V_36 ) ;
}
static int
...
V_41 = V_5 ;
if ( V_38 [ V_50 ] ) {
V_44 = F_20 ( V_38 [ V_50 ] , & V_41 ) ;
if ( V_44 )
return V_44 ;
if ( V_5 > V_41 )
F_24 ( V_5 , V_41 ) ;
} else if ( V_38 [ V_51 ] ) {
T_4 V_52 = F_25 ( V_38 [ V_51 ] ) ;
if ( ! V_52 || V_52 > 32 )
return - V_53 ;
F_26 ( V_5 , V_41 , V_52 ) ;
}
