...
struct V_10 * V_11 , const char * V_12 ,
T_3 V_13 )
{
struct V_22 * V_23 = F_10 ( V_11 , struct V_22 ,
V_26 ) ;
int V_15 , V_17 ;
V_15 = sscanf ( V_12 , L_6 , & V_17 ) ;
if ( V_15 == 0 )
V_15 = - V_20 ;
else
V_15 = F_14 ( V_23 -> V_2 , V_23 -> V_25 ,
V_17 ) ;
if ( V_15 < 0 )
return V_15 ;
return V_13 ;
}
int F_15 ( struct V_1 * V_2 , T_1 V_27 , T_1 V_17 )
{
char V_28 [ 120 ] ;
char V_29 [ 120 ] ;
char * V_30 ;
...
V_31 [ V_32 ] = NULL ;
F_17 ( & V_2 -> V_35 , V_34 ) ;
F_20 ( & V_2 -> V_9 -> V_40 , V_41 , V_31 ) ;
F_21 ( ( unsigned long ) V_30 ) ;
} else {
F_17 ( & V_2 -> V_35 , V_34 ) ;
F_22 ( V_2 -> V_9 , L_9 ) ;
F_23 ( & V_2 -> V_9 -> V_40 , V_41 ) ;
}
} else {
F_17 ( & V_2 -> V_35 , V_34 ) ;
}
...
{
return F_15 ( V_2 , 0xffffffff , V_17 ) ;
}
...
int F_25 ( struct V_1 * V_2 , const char * V_42 )
{
return F_12 ( V_2 , F_24
( V_2 , V_42 ) ) ;
}
...
return - V_20 ;
V_17 = V_45 ? ( 1 << V_44 ) : 0 ;
return F_15 ( V_2 , 1 << V_44 , V_17 ) ;
}
int F_26 ( struct V_1 * V_2 ,
const char * V_42 , bool V_45 )
{
return F_14 ( V_2 , F_24
( V_2 , V_42 ) , V_45 ) ;
}
struct V_1 * F_27 ( const char * V_46 )
{
struct V_1 * V_47 ;
F_28 ( & V_48 ) ;
F_29 (sd, &extcon_dev_list, entry) {
...
static int F_31 ( struct V_51 * V_52 , unsigned long V_53 ,
void * V_54 )
{
...
if ( ! V_56 -> V_2 )
return - V_62 ;
V_56 -> V_25 = F_24 ( V_56 -> V_2 , V_42 ) ;
if ( V_56 -> V_25 < 0 )
return - V_62 ;
V_56 -> V_59 = V_52 ;
V_56 -> V_57 . V_60 = F_31 ;
return F_33 ( & V_56 -> V_2 -> V_38 , & V_56 -> V_57 ) ;
} else {
struct V_63 V_64 ;
struct V_1 * V_65 ;
struct V_8 * V_9 ;
if ( ! V_66 )
return - V_62 ;
F_34 ( & V_64 , V_66 , NULL , NULL ) ;
while ( ( V_9 = F_35 ( & V_64 ) ) ) {
V_65 = (struct V_1 * ) F_4 ( V_9 ) ;
if ( F_24 ( V_65 , V_42 ) < 0 )
continue;
F_36 ( & V_64 ) ;
return F_32 ( V_56 , V_65 -> V_49 ,
V_42 , V_52 ) ;
}
return - V_62 ;
}
}
int F_37 ( struct V_55 * V_56 )
{
if ( ! V_56 )
return - V_20 ;
return F_38 ( & V_56 -> V_2 -> V_38 , & V_56 -> V_57 ) ;
}
int F_39 ( struct V_1 * V_2 ,
struct V_51 * V_52 )
{
return F_33 ( & V_2 -> V_38 , V_52 ) ;
}
int F_40 ( struct V_1 * V_2 ,
struct V_51 * V_52 )
{
return F_38 ( & V_2 -> V_38 , V_52 ) ;
}
...
int F_51 ( struct V_1 * V_2 , struct V_8 * V_9 )
{
int V_15 , V_44 = 0 ;
if ( ! V_66 ) {
V_15 = F_41 () ;
...
V_2 -> V_9 = F_52 ( sizeof( struct V_8 ) , V_73 ) ;
if ( ! V_2 -> V_9 )
return - V_72 ;
V_2 -> V_9 -> V_74 = V_9 ;
V_2 -> V_9 -> V_75 = V_66 ;
V_2 -> V_9 -> V_76 = F_48 ;
F_53 ( V_2 -> V_9 , V_2 -> V_49 ? V_2 -> V_49 : F_8 ( V_9 ) ) ;
if ( V_2 -> V_16 ) {
char V_12 [ 10 ] ;
char * V_77 ;
struct V_22 * V_23 ;
V_2 -> V_78 = F_52 ( sizeof( struct V_22 ) *
V_2 -> V_16 , V_73 ) ;
if ( ! V_2 -> V_78 ) {
V_15 = - V_72 ;
goto V_79;
...
V_77 = F_52 ( sizeof( char ) * ( strlen ( V_12 ) + 1 ) ,
V_73 ) ;
if ( ! V_77 ) {
...
;
V_2 -> V_86 = F_52 ( sizeof( struct V_87 * ) *
( V_44 + 1 ) , V_73 ) ;
if ( ! V_2 -> V_86 ) {
V_15 = - V_72 ;
goto V_88;
}
V_2 -> V_89 = F_52 ( sizeof( struct V_10 ) *
V_44 , V_73 ) ;
if ( ! V_2 -> V_89 ) {
V_15 = - V_72 ;
F_49 ( V_2 -> V_86 ) ;
...
strcpy ( V_49 , V_12 ) ;
F_54 ( & V_2 -> V_89 [ V_44 ] . V_11 ) ;
V_2 -> V_89 [ V_44 ] . V_11 . V_49 = V_49 ;
V_2 -> V_89 [ V_44 ] . V_11 . V_83 = 0000 ;
V_2 -> V_86 [ V_44 ] = & V_2 -> V_89 [ V_44 ]
. V_11 ;
}
V_2 -> V_90 . V_49 = V_91 ;
V_2 -> V_90 . V_82 = V_2 -> V_86 ;
}
if ( V_2 -> V_16 ) {
V_2 -> V_92 . V_93 =
F_52 ( sizeof( struct V_94 * ) *
( V_2 -> V_16 + 2 ) , V_73 ) ;
if ( ! V_2 -> V_92 . V_93 ) {
V_15 = - V_72 ;
goto V_95;
}
V_2 -> V_92 . V_49 = F_8 ( V_2 -> V_9 ) ;
V_2 -> V_92 . V_76 = F_50 ;
for ( V_44 = 0 ; V_44 < V_2 -> V_16 ; V_44 ++ )
V_2 -> V_92 . V_93 [ V_44 ] =
& V_2 -> V_78 [ V_44 ] . V_80 ;
...
if ( V_2 -> V_16 && V_2 -> V_5 ) {
for ( V_44 = 0 ; V_2 -> V_5 [ V_44 ] ; V_44 ++ )
F_49 ( V_2 -> V_89 [ V_44 ] . V_11 . V_49 ) ;
F_49 ( V_2 -> V_89 ) ;
F_49 ( V_2 -> V_86 ) ;
}
V_88:
for ( V_44 = 0 ; V_44 < V_2 -> V_16 ; V_44 ++ )
F_49 ( V_2 -> V_78 [ V_44 ] . V_80 . V_49 ) ;
V_81:
if ( V_2 -> V_16 )
F_49 ( V_2 -> V_78 ) ;
V_79:
