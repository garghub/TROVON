...
V_15 = & V_44 -> V_45 ;
F_14 ( V_44 , V_15 , V_16 ) ;
F_15 ( & V_36 , 0 , V_15 -> V_46 ) ;
if ( ! F_16 ( V_44 , V_15 , V_16 ) )
continue;
if ( F_17 ( V_44 , & V_36 , V_39 ) )
V_22 -> V_47 ( V_15 , V_16 ) ;
}
F_18 () ;
return V_48 ;
...
static int
F_21 ( struct V_20 * V_37 ,
struct V_14 * V_44 )
{
if ( V_50 == V_44 -> V_26 ) {
if ( F_22 ( V_7 , V_37 -> V_51 ) )
return - V_52 ;
return V_7 ;
} else {
if ( ! F_22 ( V_11 , V_37 -> V_51 ) )
return V_11 ;
if ( ! F_22 ( V_9 , V_37 -> V_51 ) )
return V_9 ;
return - V_52 ;
}
}
...
{
return F_26 ( V_44 , & V_54 ,
& V_55 , 0xFF ) ;
}
static struct V_56 * T_3 F_27 ( void )
{
return & V_57 ;
}
static int F_28 ( struct V_43 * V_44 )
{
return F_26 ( V_44 , & V_58 ,
& V_59 , 0xFF ) ;
}
static struct V_56 * T_3 F_29 ( void )
{
return & V_60 ;
}
static struct V_56 * T_3 F_27 ( void )
