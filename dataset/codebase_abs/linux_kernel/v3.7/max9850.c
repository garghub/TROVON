...
{
int V_50 ;
V_50 = F_18 ( V_2 , 8 , 8 , V_58 ) ;
if ( V_50 < 0 ) {
F_14 ( V_2 -> V_57 , L_2 , V_50 ) ;
return V_50 ;
}
F_9 ( V_2 , V_59 , 1 , 1 ) ;
F_9 ( V_2 , V_60 , 0x40 , 0x40 ) ;
F_9 ( V_2 , V_61 , 0xff , 0xc0 ) ;
return 0 ;
}
static int T_3 F_19 ( struct V_62 * V_63 ,
const struct V_64 * V_65 )
{
struct V_12 * V_13 ;
int V_50 ;
V_13 = F_20 ( & V_63 -> V_57 , sizeof( struct V_12 ) ,
V_66 ) ;
if ( V_13 == NULL )
return - V_67 ;
F_21 ( V_63 , V_13 ) ;
...
static T_4 int F_23 ( struct V_62 * V_70 )
{
F_24 ( & V_70 -> V_57 ) ;
return 0 ;
}
