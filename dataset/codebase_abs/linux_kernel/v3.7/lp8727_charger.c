...
return - V_70 ;
if ( V_33 -> V_91 )
V_15 -> V_71 = V_2 -> V_33 -> V_91 () ;
break;
case V_92 :
if ( ! V_33 )
return - V_70 ;
if ( V_33 -> V_93 )
V_15 -> V_71 = V_2 -> V_33 -> V_93 () ;
break;
case V_94 :
if ( ! V_33 )
return - V_70 ;
if ( V_33 -> V_95 )
V_15 -> V_71 = V_2 -> V_33 -> V_95 () ;
break;
case V_96 :
if ( ! V_33 )
return - V_70 ;
if ( V_33 -> V_97 )
V_15 -> V_71 = V_2 -> V_33 -> V_97 () ;
break;
default:
break;
}
...
static int F_40 ( struct V_121 * V_122 , const struct V_123 * V_11 )
{
struct V_1 * V_2 ;
int V_6 ;
if ( ! F_41 ( V_122 -> V_124 , V_125 ) )
return - V_9 ;
V_2 = F_35 ( & V_122 -> V_50 , sizeof( * V_2 ) , V_103 ) ;
if ( ! V_2 )
return - V_104 ;
V_2 -> V_8 = V_122 ;
V_2 -> V_50 = & V_122 -> V_50 ;
V_2 -> V_33 = V_122 -> V_50 . V_126 ;
F_42 ( V_122 , V_2 ) ;
F_43 ( & V_2 -> V_7 ) ;
V_6 = F_9 ( V_2 ) ;
if ( V_6 ) {
F_17 ( V_2 -> V_50 , L_7 , V_6 ) ;
return V_6 ;
}
V_6 = F_34 ( V_2 ) ;
if ( V_6 ) {
F_17 ( V_2 -> V_50 , L_8 , V_6 ) ;
return V_6 ;
}
V_6 = F_21 ( V_2 ) ;
if ( V_6 ) {
F_17 ( V_2 -> V_50 , L_9 , V_6 ) ;
F_39 ( V_2 ) ;
return V_6 ;
}
return 0 ;
}
static int T_4 F_44 ( struct V_121 * V_122 )
{
struct V_1 * V_2 = F_45 ( V_122 ) ;
F_26 ( V_2 ) ;
F_39 ( V_2 ) ;
return 0 ;
}
