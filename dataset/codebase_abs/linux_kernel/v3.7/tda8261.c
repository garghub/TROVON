...
struct V_1 * V_2 = V_16 -> V_18 ;
const struct V_4 * V_5 = V_2 -> V_5 ;
T_2 V_25 , V_29 , V_17 = 0 ;
T_1 V_3 [ 4 ] ;
int V_6 = 0 ;
if ( V_21 & V_24 ) {
V_25 = V_23 -> V_25 ;
if ( ( V_25 < 950000 ) || ( V_25 > 2150000 ) ) {
F_9 ( L_6 , V_14 , V_25 ) ;
return - V_28 ;
}
V_29 = ( V_25 + ( V_30 [ V_5 -> V_31 ] - 1 ) ) / V_30 [ V_5 -> V_31 ] ;
F_6 ( L_7 ,
V_14 , V_5 -> V_31 , V_30 [ V_5 -> V_31 ] , V_29 , V_29 ) ;
V_3 [ 0 ] = ( V_29 >> 8 ) & 0xff ;
V_3 [ 1 ] = V_29 & 0xff ;
V_3 [ 2 ] = ( 0x01 << 7 ) | ( ( V_32 [ V_5 -> V_31 ] & 0x07 ) << 1 ) ;
if ( V_25 < 1450000 )
V_3 [ 3 ] = 0x00 ;
else if ( V_25 < 2000000 )
V_3 [ 3 ] = 0x40 ;
else if ( V_25 < 2150000 )
V_3 [ 3 ] = 0x80 ;
if ( ( V_6 = F_4 ( V_2 , V_3 ) ) < 0 ) {
F_3 ( L_3 , V_14 ) ;
return V_6 ;
}
F_6 ( L_8 , V_14 ) ;
...
{
struct V_1 * V_2 = NULL ;
if ( ( V_2 = F_14 ( sizeof ( struct V_1 ) , V_34 ) ) == NULL )
goto exit;
V_2 -> V_5 = V_5 ;
V_2 -> V_13 = V_13 ;
V_2 -> V_16 = V_16 ;
V_16 -> V_18 = V_2 ;
V_16 -> V_35 . V_36 = V_37 ;
V_16 -> V_35 . V_36 . V_38 . V_39 = V_30 [ V_5 -> V_31 ] ;
F_15 ( L_11 , V_14 ) ;
return V_16 ;
exit:
F_12 ( V_2 ) ;
