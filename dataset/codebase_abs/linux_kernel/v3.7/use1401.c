...
T_3 V_11 ;
V_11 . V_12 = V_10 ;
if ( F_5 ( V_4 [ V_6 ] , V_7 , NULL , 0 , & V_11 , sizeof( T_3 ) , & V_9 , NULL ) &&
( V_9 >= sizeof( T_3 ) ) )
{
* V_8 = V_11 . V_13 ;
return V_11 . V_12 ;
...
T_3 V_11 ;
V_11 . V_12 = V_10 ;
if ( F_5 ( V_4 [ V_6 ] , V_7 , V_8 , sizeof( T_1 ) , & V_11 , sizeof( T_3 ) , & V_9 , NULL ) &&
( V_9 >= sizeof( T_3 ) ) )
return V_11 . V_12 ;
}
return V_10 ;
...
static T_2 F_28 ( void * V_74 , char * V_75 , int V_76 )
{
char V_77 [ 32 ] ;
...
INT T_5 F_32 ( T_4 V_78 , T_2 V_79 , T_6 V_80 )
{
int V_81 = 1 ;
switch ( V_79 )
{
