...
int V_73 = - V_20 ;
#ifdef F_18
if ( F_19 ( V_74 , V_7 -> V_19 ) )
V_73 = F_20 ( V_7 -> V_19 -> V_75 ,
L_3 , 0 ) ;
#endif
if ( V_71 && F_21 ( V_71 -> V_73 ) )
V_73 = V_71 -> V_73 ;
if ( V_73 >= 0 )
if ( F_22 ( V_7 -> V_19 , V_73 , L_4 ) )
V_73 = - V_20 ;
if ( V_73 >= 0 ) {
F_23 ( V_73 , 0 ) ;
F_24 ( 1 ) ;
...
static int T_1 F_29 ( struct V_80 * V_81 )
{
struct V_8 * V_9 ;
V_9 = F_30 ( & V_81 -> V_19 , sizeof( * V_9 ) , V_82 ) ;
if ( ! V_9 )
return - V_83 ;
F_31 ( V_81 , V_9 ) ;
V_9 -> V_76 = V_77 ;
return F_32 ( & V_81 -> V_19 , & V_84 ,
& V_85 , 1 ) ;
}
static int T_2 F_33 ( struct V_80 * V_81 )
{
F_34 ( & V_81 -> V_19 ) ;
return 0 ;
}
static int T_1 F_35 ( struct V_86 * V_87 ,
const struct V_88 * V_89 )
{
struct V_8 * V_9 ;
V_9 = F_30 ( & V_87 -> V_19 , sizeof( * V_9 ) , V_82 ) ;
if ( ! V_9 )
return - V_83 ;
F_36 ( V_87 , V_9 ) ;
V_9 -> V_76 = V_90 ;
return F_32 ( & V_87 -> V_19 , & V_84 ,
& V_85 , 1 ) ;
}
static int T_2 F_37 ( struct V_86 * V_87 )
{
F_34 ( & V_87 -> V_19 ) ;
return 0 ;
}
