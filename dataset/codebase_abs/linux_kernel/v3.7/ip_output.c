...
V_111 = V_6 -> V_8 - V_110 ;
V_109 = V_110 ;
V_112 = F_93 ( V_27 -> V_17 . V_11 , F_94 ( V_6 ) ) ;
V_113 = ( F_95 ( V_2 -> V_31 ) & V_138 ) << 3 ;
...
if ( ( V_52 = F_96 ( V_8 + V_110 + V_112 , V_74 ) ) == NULL ) {
F_97 ( V_139 L_2 ) ;
V_13 = - V_53 ;
goto V_140;
}
...
F_99 ( V_52 , V_8 + V_110 ) ;
F_16 ( V_52 ) ;
V_52 -> V_141 = V_52 -> V_142 + V_110 ;
if ( V_6 -> V_21 )
F_28 ( V_52 , V_6 -> V_21 ) ;
F_100 ( V_6 , F_91 ( V_52 ) , V_110 ) ;
if ( F_101 ( V_6 , V_109 , F_102 ( V_52 ) , V_8 ) )
F_103 () ;
V_111 -= V_8 ;
V_2 = F_4 ( V_52 ) ;
V_2 -> V_31 = F_5 ( ( V_113 >> 3 ) ) ;
...
int
F_104 ( void * V_100 , char * V_99 , int V_113 , int V_8 , int V_143 , struct V_5 * V_6 )
{
struct V_144 * V_145 = V_100 ;
if ( V_6 -> V_134 == V_146 ) {
if ( F_105 ( V_99 , V_145 , V_113 , V_8 ) < 0 )
return - V_147 ;
} else {
T_4 V_148 = 0 ;
if ( F_106 ( V_99 , V_145 , V_113 , V_8 , & V_148 ) < 0 )
return - V_147 ;
V_6 -> V_148 = F_107 ( V_6 -> V_148 , V_148 , V_143 ) ;
}
return 0 ;
}
static inline T_4
F_108 ( struct V_149 * V_149 , int V_113 , int V_150 )
{
char * V_151 ;
T_4 V_148 ;
V_151 = F_109 ( V_149 ) ;
V_148 = F_110 ( V_151 + V_113 , V_150 , 0 ) ;
F_111 ( V_149 ) ;
return V_148 ;
}
static inline int F_112 ( struct V_20 * V_21 ,
struct V_152 * V_153 ,
int F_113 ( void * V_100 , char * V_99 , int V_113 , int V_8 ,
...
return V_13 ;
F_98 ( V_6 , V_42 ) ;
F_99 ( V_6 , V_155 + V_156 ) ;
F_16 ( V_6 ) ;
V_6 -> V_141 = V_6 -> V_142 + V_155 ;
V_6 -> V_134 = V_146 ;
V_6 -> V_148 = 0 ;
...
return F_117 ( V_21 , V_6 , F_113 , V_100 ,
( V_154 - V_156 ) ) ;
}
...
struct V_162 * V_163 ,
struct V_164 * V_165 ,
int F_113 ( void * V_100 , char * V_99 , int V_113 ,
...
F_119 ( V_21 , V_119 , V_79 -> V_23 , V_15 -> V_88 ,
V_61 - V_167 ) ;
return - V_119 ;
}
if ( V_156 &&
...
V_13 = F_112 ( V_21 , V_153 , F_113 , V_100 , V_154 ,
V_42 , V_155 , V_156 ,
V_157 , V_65 ) ;
if ( V_13 )
goto error;
...
V_181 , V_157 ,
V_176 + V_156 , V_179 , 0 ) ;
V_181 -> V_148 = F_124 ( V_181 -> V_148 ,
V_6 -> V_148 ) ;
V_176 += V_179 ;
F_125 ( V_181 , V_157 ) ;
}
V_150 = V_177 - V_156 - V_179 ;
if ( V_150 > 0 && F_113 ( V_100 , V_176 + V_156 , V_113 , V_150 , V_179 , V_6 ) < 0 ) {
V_13 = - V_147 ;
F_27 ( V_6 ) ;
goto error;
}
...
if ( ! F_127 ( V_21 , V_165 ) )
goto error;
if ( ! F_128 ( V_6 , V_191 , V_165 -> V_149 ,
V_165 -> V_113 ) ) {
V_13 = - V_119 ;
if ( V_191 == V_193 )
goto error;
F_129 ( V_6 , V_191 , V_165 -> V_149 ,
V_165 -> V_113 , 0 ) ;
F_66 ( V_6 ) -> V_192 = ++ V_191 ;
F_130 ( V_165 -> V_149 ) ;
}
V_150 = F_131 ( int , V_150 , V_165 -> V_194 - V_165 -> V_113 ) ;
if ( F_113 ( V_100 ,
F_132 ( V_165 -> V_149 ) + V_165 -> V_113 ,
V_113 , V_150 , V_6 -> V_8 , V_6 ) < 0 )
goto V_195;
V_165 -> V_113 += V_150 ;
F_133 ( & F_66 ( V_6 ) -> V_196 [ V_191 - 1 ] , V_150 ) ;
V_6 -> V_8 += V_150 ;
V_6 -> V_132 += V_150 ;
V_6 -> V_130 += V_150 ;
F_134 ( V_150 , & V_21 -> V_185 ) ;
}
V_113 += V_150 ;
V_154 -= V_150 ;
}
...
static int F_135 ( struct V_20 * V_21 , struct V_162 * V_163 ,
...
if ( V_25 ) {
if ( V_163 -> V_25 == NULL ) {
V_163 -> V_25 = F_136 ( sizeof( struct V_166 ) + 40 ,
V_21 -> V_187 ) ;
...
int F_137 ( struct V_20 * V_21 , struct V_78 * V_79 ,
int F_113 ( void * V_100 , char * V_99 , int V_113 , int V_8 ,
int V_143 , struct V_5 * V_6 ) ,
void * V_100 , int V_154 , int V_156 ,
struct V_198 * V_199 , struct V_26 * * V_200 ,
...
return 0 ;
if ( F_138 ( & V_21 -> V_204 ) ) {
V_13 = F_135 ( V_21 , & V_15 -> V_163 . V_205 , V_199 , V_200 ) ;
if ( V_13 )
return V_13 ;
} else {
V_156 = 0 ;
}
return F_118 ( V_21 , V_79 , & V_21 -> V_204 , & V_15 -> V_163 . V_205 ,
F_139 ( V_21 ) , F_113 ,
V_100 , V_154 , V_156 , V_65 ) ;
}
T_5 F_140 ( struct V_20 * V_21 , struct V_78 * V_79 , struct V_149 * V_149 ,
...
F_119 ( V_21 , V_119 , V_79 -> V_23 , V_15 -> V_88 , V_61 ) ;
return - V_119 ;
}
if ( ( V_6 = F_114 ( & V_21 -> V_204 ) ) == NULL )
return - V_58 ;
V_163 -> V_154 += V_194 ;
...
V_6 = F_121 ( V_21 , V_180 , 1 , V_21 -> V_187 ) ;
if ( F_24 ( ! V_6 ) ) {
V_13 = - V_188 ;
goto error;
}
...
V_6 -> V_148 = 0 ;
F_98 ( V_6 , V_42 ) ;
F_99 ( V_6 , V_155 + V_179 ) ;
F_16 ( V_6 ) ;
V_6 -> V_141 = ( V_6 -> V_142 +
V_155 ) ;
if ( V_179 ) {
V_6 -> V_148 = F_123 ( V_181 ,
V_157 ,
F_102 ( V_6 ) ,
V_179 , 0 ) ;
V_181 -> V_148 = F_124 ( V_181 -> V_148 ,
...
F_116 ( & V_21 -> V_204 , V_6 ) ;
continue;
}
V_191 = F_66 ( V_6 ) -> V_192 ;
if ( V_8 > V_194 )
V_8 = V_194 ;
if ( F_128 ( V_6 , V_191 , V_149 , V_113 ) ) {
F_133 ( & F_66 ( V_6 ) -> V_196 [ V_191 - 1 ] , V_8 ) ;
} else if ( V_191 < V_193 ) {
F_130 ( V_149 ) ;
F_141 ( V_6 , V_191 , V_149 , V_113 , V_8 ) ;
} else {
V_13 = - V_119 ;
goto error;
}
if ( V_6 -> V_134 == V_135 ) {
T_4 V_148 ;
V_148 = F_108 ( V_149 , V_113 , V_8 ) ;
V_6 -> V_148 = F_107 ( V_6 -> V_148 , V_148 , V_6 -> V_8 ) ;
}
V_6 -> V_8 += V_8 ;
V_6 -> V_132 += V_8 ;
V_6 -> V_130 += V_8 ;
F_134 ( V_8 , & V_21 -> V_185 ) ;
V_113 += V_8 ;
V_194 -= V_8 ;
}
return 0 ;
...
static void F_142 ( struct V_162 * V_163 )
{
V_163 -> V_65 &= ~ V_201 ;
F_143 ( V_163 -> V_25 ) ;
V_163 -> V_25 = NULL ;
...
struct V_5 * F_145 ( struct V_20 * V_21 ,
struct V_78 * V_79 ,
struct V_152 * V_153 ,
struct V_162 * V_163 )
{
...
V_94 V_212 = 0 ;
T_7 V_18 ;
if ( ( V_6 = F_146 ( V_153 ) ) == NULL )
goto V_213;
V_210 = & ( F_66 ( V_6 ) -> V_131 ) ;
if ( V_6 -> V_176 < F_91 ( V_6 ) )
F_147 ( V_6 , F_148 ( V_6 ) ) ;
while ( ( V_209 = F_146 ( V_153 ) ) != NULL ) {
F_147 ( V_209 , F_149 ( V_6 ) ) ;
* V_210 = V_209 ;
V_210 = & ( V_209 -> V_126 ) ;
V_6 -> V_8 += V_209 -> V_8 ;
V_6 -> V_132 += V_209 -> V_8 ;
...
F_150 ( V_6 , & V_27 -> V_17 ) ;
if ( V_2 -> V_35 == V_216 )
F_151 ( V_211 , ( (struct V_217 * )
F_102 ( V_6 ) ) -> type ) ;
F_142 ( V_163 ) ;
V_213:
return V_6 ;
}
int F_152 ( struct V_211 * V_211 , struct V_5 * V_6 )
{
int V_13 ;
V_13 = F_8 ( V_6 ) ;
if ( V_13 ) {
...
int F_154 ( struct V_20 * V_21 , struct V_78 * V_79 )
{
struct V_5 * V_6 ;
V_6 = F_155 ( V_21 , V_79 ) ;
if ( ! V_6 )
return 0 ;
return F_152 ( F_61 ( V_21 ) , V_6 ) ;
}
...
{
struct V_5 * V_6 ;
while ( ( V_6 = F_157 ( V_153 ) ) != NULL )
F_27 ( V_6 ) ;
F_142 ( V_163 ) ;
}
void F_158 ( struct V_20 * V_21 )
{
F_156 ( V_21 , & V_21 -> V_204 , & F_13 ( V_21 ) -> V_163 . V_205 ) ;
}
struct V_5 * F_159 ( struct V_20 * V_21 ,
struct V_78 * V_79 ,
int F_113 ( void * V_100 , char * V_99 , int V_113 ,
int V_8 , int V_143 , struct V_5 * V_6 ) ,
void * V_100 , int V_154 , int V_156 ,
...
V_163 . V_202 = 0 ;
V_163 . V_25 = NULL ;
V_13 = F_135 ( V_21 , & V_163 , V_199 , V_200 ) ;
if ( V_13 )
return F_161 ( V_13 ) ;
V_13 = F_118 ( V_21 , V_79 , & V_153 , & V_163 ,
& V_218 -> V_219 , F_113 ,
V_100 , V_154 , V_156 , V_65 ) ;
if ( V_13 ) {
F_156 ( V_21 , & V_153 , & V_163 ) ;
return F_161 ( V_13 ) ;
}
return F_145 ( V_21 , V_79 , & V_153 , & V_163 ) ;
}
static int F_162 ( void * V_220 , char * V_99 , int V_113 ,
int V_8 , int V_143 , struct V_5 * V_6 )
{
T_4 V_148 ;
V_148 = F_163 ( V_220 + V_113 , V_99 , V_8 , 0 ) ;
V_6 -> V_148 = F_107 ( V_6 -> V_148 , V_148 , V_143 ) ;
return 0 ;
}
void F_164 ( struct V_211 * V_211 , struct V_5 * V_6 , T_2 V_23 ,
...
F_166 ( & V_79 , V_222 -> V_226 , 0 ,
F_167 ( V_222 -> V_30 ) ,
V_227 , F_4 ( V_6 ) -> V_35 ,
F_168 ( V_222 ) ,
V_23 , V_22 ,
F_169 ( V_6 ) -> V_228 , F_169 ( V_6 ) -> V_229 ) ;
F_170 ( V_6 , F_171 ( & V_79 ) ) ;
V_27 = F_172 ( V_211 , & V_79 ) ;
if ( F_34 ( V_27 ) )
return;
V_15 = & F_173 ( V_230 ) ;
...
F_160 ( & V_21 -> V_204 ) ;
V_21 -> V_186 = V_231 ;
F_137 ( V_21 , & V_79 , F_162 , V_222 -> V_145 -> V_232 , V_8 , 0 ,
& V_199 , & V_27 , V_158 ) ;
V_225 = F_175 ( & V_21 -> V_204 ) ;
if ( V_225 ) {
if ( V_222 -> V_233 >= 0 )
* ( ( V_234 * ) F_102 ( V_225 ) +
V_222 -> V_233 ) = F_176 ( F_177 ( V_225 -> V_148 ,
V_222 -> V_148 ) ) ;
V_225 -> V_134 = V_135 ;
F_178 ( V_225 ) ;
F_179 ( V_225 , F_180 ( V_6 ) ) ;
F_154 ( V_21 , & V_79 ) ;
}
F_181 ( V_230 ) ;
F_182 ( V_27 ) ;
