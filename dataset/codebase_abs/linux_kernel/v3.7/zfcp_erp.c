...
F_131 ( & V_2 -> V_117 ) ;
F_132 ( V_2 ) ;
F_133 ( V_2 -> V_118 , & V_2 -> V_119 ) ;
} else
F_134 ( & V_2 -> V_117 ) ;
F_135 ( & V_2 -> V_40 , V_120 ) ;
break;
}
}
...
break;
F_31 ( & V_2 -> V_52 , V_51 ) ;
V_125 = V_2 -> V_10 . V_125 ;
F_32 ( & V_2 -> V_52 , V_51 ) ;
if ( V_125 != & V_2 -> V_10 ) {
V_6 = F_141 ( V_125 , struct V_5 , V_9 ) ;
if ( F_137 ( V_6 ) != V_121 )
F_69 ( V_2 ) ;
}
}
...
{
struct V_126 * V_127 ;
V_127 = F_143 ( F_138 , V_2 , L_29 ,
F_144 ( & V_2 -> V_112 -> V_39 ) ) ;
if ( F_76 ( V_127 ) ) {
F_117 ( & V_2 -> V_112 -> V_39 ,
L_30 ) ;
return F_145 ( V_127 ) ;
...
F_70 ( & V_2 -> V_22 , V_51 ) ;
F_4 (port, &adapter->port_list, list)
F_21 ( V_128 , & V_21 -> V_12 ) ;
F_73 ( & V_2 -> V_22 , V_51 ) ;
F_14 (sdev, adapter->scsi_host)
F_21 ( V_128 , & F_11 ( V_15 ) -> V_12 ) ;
}
...
F_70 ( & V_2 -> V_22 , V_51 ) ;
F_4 (port, &adapter->port_list, list) {
F_72 ( V_128 , & V_21 -> V_12 ) ;
if ( V_130 )
F_88 ( & V_21 -> V_110 , 0 ) ;
}
F_73 ( & V_2 -> V_22 , V_51 ) ;
F_14 (sdev, adapter->scsi_host) {
F_72 ( V_128 , & F_11 ( V_15 ) -> V_12 ) ;
if ( V_130 )
