...
if ( ! V_39 -> V_3 . V_42 )
goto V_148;
if ( V_39 -> V_3 . V_42 -> type != V_66 || V_39 -> V_3 . V_42 -> V_149 )
goto V_150;
V_39 -> V_2 . V_42 = F_47 ( & V_64 , V_39 -> V_57 . V_106 ) ;
if ( ! V_39 -> V_2 . V_42 )
goto V_150;
if ( V_39 -> V_2 . V_42 -> type != V_66 || V_39 -> V_2 . V_42 -> V_149 )
goto V_151;
F_23 () ;
V_121 = F_16 ( V_39 ) ;
if ( ! V_121 )
F_48 ( & V_39 -> V_71 , & V_152 ) ;
V_151:
F_49 ( V_39 -> V_2 . V_42 ) ;
V_150:
F_49 ( V_39 -> V_3 . V_42 ) ;
...
static int F_52 ( struct V_36 * V_37 , struct V_78 * V_79 , void * V_142 )
{
struct V_38 * V_39 = NULL ;
struct V_68 * V_69 , * V_70 ;
struct V_76 * V_143 ;
...
{
F_54 ( V_153 ) ;
V_145 = F_55 ( L_2 , sizeof( struct V_38 ) ,
0 , 0 , NULL ) ;
if ( ! V_145 )
return - V_147 ;
V_154 . V_155 = F_20 ;
F_56 ( & V_154 ) ;
if ( F_57 ( V_156 , V_157 , NULL , F_34 , NULL ) ) {
F_58 ( & V_154 ) ;
F_59 ( V_145 ) ;
return - V_158 ;
}
F_57 ( V_156 , V_111 , F_44 , NULL , NULL ) ;
F_57 ( V_156 , V_159 , F_52 , NULL , NULL ) ;
return 0 ;
}
