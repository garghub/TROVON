...
* V_4 , char * V_5 )
{
return sprintf ( V_5 , L_5 , F_2 ( V_2 ) -> V_24 ) ;
}
static int T_5 F_16 ( struct V_6 * V_7 )
{
int V_18 = F_17 ( V_7 ) -> V_25 ;
struct V_10 * V_11 ;
int V_14 ;
int V_26 ;
V_11 = F_18 ( & V_7 -> V_2 , sizeof( * V_11 ) , V_27 ) ;
if ( ! V_11 )
return - V_28 ;
V_11 -> V_21 = 3300 ;
V_11 -> V_18 = V_18 ;
...
F_20 ( & V_11 -> V_16 ) ;
F_21 ( V_7 , V_11 ) ;
for ( V_26 = 0 ; V_26 < 3 + V_11 -> V_18 ; V_26 ++ ) {
V_14 = F_22 ( & V_7 -> V_2 , & V_29 [ V_26 ] . V_30 ) ;
if ( V_14 ) {
F_23 ( & V_7 -> V_2 , L_6 ) ;
goto V_31;
}
}
V_11 -> V_32 = F_24 ( & V_7 -> V_2 ) ;
if ( F_25 ( V_11 -> V_32 ) ) {
F_23 ( & V_7 -> V_2 , L_7 ) ;
V_14 = F_26 ( V_11 -> V_32 ) ;
goto V_31;
...
F_27 ( & V_7 -> V_2 , & V_29 [ V_26 ] . V_30 ) ;
F_21 ( V_7 , NULL ) ;
F_10 ( & V_11 -> V_16 ) ;
return V_14 ;
}
static int T_6 F_28 ( struct V_6 * V_7 )
{
struct V_10 * V_11 = F_4 ( V_7 ) ;
int V_26 ;
F_20 ( & V_11 -> V_16 ) ;
