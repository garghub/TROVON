...
char V_129 ;
if ( sscanf ( V_128 [ 1 ] , L_13 , & V_77 , & V_129 ) != 1 ) {
V_42 -> error = L_14 ;
return - V_130 ;
}
...
if ( sscanf ( V_128 [ 1 ] , L_17 , & V_134 , & V_129 ) != 1 ) {
V_42 -> error = L_18 ;
return NULL ;
}
* V_133 = 2 + V_134 ;
...
V_120 = F_102 ( V_128 [ 0 ] , V_42 , F_29 , V_134 ,
V_128 + 2 ) ;
if ( ! V_120 ) {
V_42 -> error = L_19 ;
return NULL ;
...
static int F_103 ( struct V_2 * V_3 , unsigned V_132 , char * * V_128 ,
unsigned * V_133 )
{
unsigned V_135 ;
...
if ( ! V_132 )
return 0 ;
if ( sscanf ( V_128 [ 0 ] , L_17 , & V_135 , & V_129 ) != 1 ) {
V_42 -> error = L_20 ;
return - V_130 ;
}
V_132 -- ;
...
static int F_104 ( struct V_41 * V_42 , unsigned int V_132 , char * * V_128 )
{
int V_69 ;
...
struct V_82 * V_120 ;
char V_129 ;
V_120 = F_101 ( V_42 , V_132 , V_128 , & V_133 ) ;
if ( ! V_120 )
return - V_130 ;
V_128 += V_133 ;
V_132 -= V_133 ;
if ( ! V_132 || sscanf ( V_128 [ 0 ] , L_17 , & V_30 , & V_129 ) != 1 ||
V_30 < 2 || V_30 > V_72 + 1 ) {
V_42 -> error = L_24 ;
F_105 ( V_120 ) ;
return - V_130 ;
...
V_3 = F_84 ( V_30 , V_120 -> type -> V_138 ( V_120 ) , V_42 , V_120 ) ;
if ( ! V_3 ) {
F_105 ( V_120 ) ;
return - V_139 ;
}
...
V_3 -> V_7 = 0 ;
F_108 ( & V_3 -> V_40 , V_40 ) ;
V_69 = F_103 ( V_3 , V_132 , V_128 , & V_133 ) ;
if ( V_69 )
goto V_146;
V_128 += V_133 ;
V_132 -= V_133 ;
...
static int F_118 ( struct V_41 * V_42 , struct V_14 * V_14 ,
union V_147 * V_148 )
{
...
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
if ( V_15 == V_20 ) {
V_148 -> V_151 = F_52 ( V_3 -> V_76 , V_14 ) ;
F_10 ( V_3 , V_14 , V_15 ) ;
return V_152 ;
}
V_69 = log -> type -> V_37 ( log , F_52 ( V_3 -> V_76 , V_14 ) , 0 ) ;
if ( V_69 < 0 && V_69 != - V_153 )
return V_69 ;
if ( ! V_69 || ( V_69 == - V_153 ) ) {
if ( V_15 == V_154 )
return - V_153 ;
...
if ( F_31 ( ! V_27 ) )
return - V_62 ;
V_150 = F_119 ( V_3 -> V_123 , V_155 ) ;
if ( F_49 ( V_150 ) ) {
F_120 ( & V_150 -> V_156 , V_14 ) ;
V_148 -> V_54 = V_150 ;
V_150 -> V_27 = V_27 ;
}
F_55 ( V_27 , V_14 ) ;
...
int error , union V_147 * V_148 )
{
int V_15 = F_64 ( V_14 ) ;
struct V_2 * V_3 = (struct V_2 * ) V_42 -> V_43 ;
struct V_25 * V_27 = NULL ;
struct V_158 * V_159 = NULL ;
struct V_149 * V_150 = V_148 -> V_54 ;
if ( V_15 == V_20 ) {
if ( ! ( V_14 -> V_50 & ( V_113 | V_108 ) ) )
F_122 ( V_3 -> V_76 , V_148 -> V_151 ) ;
return error ;
}
if ( error == - V_160 )
goto V_36;
if ( ( error == - V_153 ) && ( V_14 -> V_50 & V_161 ) )
goto V_36;
if ( F_31 ( error ) ) {
if ( ! V_150 ) {
F_35 ( L_29 ) ;
...
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
F_21 ( & V_3 -> V_89 , 0 ) ;
if ( log -> type -> V_164 && log -> type -> V_164 ( log ) )
F_27 ( L_34 ) ;
F_131 ( V_3 -> V_76 ) ;
}
...
static int F_133 ( struct V_41 * V_42 , T_5 type ,
unsigned V_165 , char * V_166 , unsigned V_167 )
{
unsigned int V_27 , V_168 = 0 ;
struct V_2 * V_3 = (struct V_2 * ) V_42 -> V_43 ;
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
...
F_134 ( L_35 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ ) {
F_134 ( L_36 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ) ;
V_169 [ V_27 ] = F_132 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_169 [ V_27 ] = '\0' ;
F_134 ( L_37 ,
( unsigned long long ) log -> type -> V_83 ( log ) ,
( unsigned long long ) V_3 -> V_78 , V_169 ) ;
V_168 += log -> type -> V_171 ( log , type , V_166 + V_168 , V_167 - V_168 ) ;
break;
case V_172 :
V_168 = log -> type -> V_171 ( log , type , V_166 , V_167 ) ;
F_134 ( L_38 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ )
F_134 ( L_39 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ,
