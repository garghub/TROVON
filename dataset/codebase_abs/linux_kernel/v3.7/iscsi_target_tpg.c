...
F_16 ( L_20 ,
V_5 -> V_9 -> V_3 , V_33 -> V_94 , V_33 -> V_95 , V_5 -> V_4 ,
( V_33 -> V_84 == V_96 ) ? L_21 : L_22 ) ;
return V_35 ;
}
static int F_51 (
struct V_34 * V_35 ,
...
{
unsigned char V_99 [ 256 ] , V_100 [ 256 ] , * V_101 = NULL ;
int V_102 ;
struct V_16 * V_17 ;
struct V_38 * V_39 = & V_5 -> V_27 ;
if ( ( V_28 != 1 ) && ( V_28 != 0 ) ) {
...
return - V_64 ;
if ( V_28 ) {
snprintf ( V_99 , sizeof( V_99 ) , L_30 , V_17 -> V_65 ) ;
V_101 = strstr ( V_99 , V_66 ) ;
if ( ! V_101 )
goto V_25;
if ( ! strncmp ( V_101 + 4 , L_31 , 1 ) ) {
if ( ! strcmp ( V_99 , V_101 ) )
sprintf ( V_100 , L_30 , V_101 + 5 ) ;
else {
V_101 -- ;
* V_101 = '\0' ;
V_102 = sprintf ( V_100 , L_30 , V_99 ) ;
V_101 += 5 ;
sprintf ( V_100 + V_102 , L_30 , V_101 ) ;
}
} else {
V_101 -- ;
* V_101 = '\0' ;
sprintf ( V_100 , L_30 , V_99 ) ;
}
if ( F_13 ( V_17 , V_100 ) < 0 )
return - V_64 ;
} else {
snprintf ( V_99 , sizeof( V_99 ) , L_30 , V_17 -> V_65 ) ;
V_101 = strstr ( V_99 , V_66 ) ;
if ( V_101 )
goto V_25;
strncat ( V_99 , L_31 , strlen ( L_31 ) ) ;
strncat ( V_99 , V_66 , strlen ( V_66 ) ) ;
if ( F_13 ( V_17 , V_99 ) < 0 )
return - V_64 ;
}
V_25:
