...
int F_81 ( T_1 V_109 , V_32 * V_33 , T_3 V_184 )
{
struct V_2 * V_3 ;
struct V_46 V_58 ;
T_1 V_185 , V_186 = F_82 ( T_1 , V_184 , V_187 ) ;
int V_50 , V_188 = 0 , V_189 = 5 ;
V_32 * V_190 = V_33 ;
V_3 = F_28 ( V_109 ) ;
if ( V_3 == NULL )
return - V_123 ;
if ( ! V_33 || ! V_186 || V_184 > V_187 )
return - V_81 ;
do {
V_58 . V_53 . V_59 = V_191 ;
V_58 . V_63 . V_192 . V_186 = F_18 ( V_186 ) ;
V_50 = F_15 ( V_3 , & V_58 ,
V_193 + V_186 ,
L_46 ) ;
if ( V_50 )
break;
V_185 = F_10 ( V_58 . V_63 . V_194 . V_195 ) ;
memcpy ( V_190 , V_58 . V_63 . V_194 . V_196 , V_185 ) ;
V_190 += V_185 ;
V_188 += V_185 ;
V_186 -= V_185 ;
} while ( V_189 -- && V_188 < V_184 );
return V_188 ? V_188 : - V_197 ;
}
...
return;
if ( V_3 -> V_19 . V_198 )
V_3 -> V_19 . V_198 ( V_3 -> V_28 ) ;
F_59 ( V_3 -> V_112 , V_199 ) ;
F_84 ( V_3 -> V_19 . V_162 . V_200 ) ;
}
static void F_85 ( struct V_55 * V_28 )
{
struct V_2 * V_3 = F_17 ( V_28 ) ;
if ( ! V_3 )
return;
...
struct V_2 * F_86 ( struct V_55 * V_28 ,
...
V_203 = F_88 ( F_87 , V_165 ) ;
if ( V_3 == NULL || V_203 == NULL )
goto V_204;
F_89 ( & V_3 -> V_6 ) ;
F_89 ( & V_3 -> V_30 ) ;
F_90 ( & V_3 -> V_176 ) ;
...
F_92 ( & V_3 -> V_168 , F_1 ,
( unsigned long ) V_3 ) ;
memcpy ( & V_3 -> V_19 , V_202 , sizeof( struct V_201 ) ) ;
V_3 -> V_112 = F_93 ( V_199 , V_205 ) ;
if ( V_3 -> V_112 >= V_205 ) {
F_11 ( V_28 , L_47 ) ;
goto V_204;
} else if ( V_3 -> V_112 == 0 )
V_3 -> V_19 . V_162 . V_161 = V_206 ;
else
V_3 -> V_19 . V_162 . V_161 = V_207 ;
F_94 ( V_3 -> V_112 , V_199 ) ;
F_95 ( V_203 , F_87 , L_48 , L_49 , V_3 -> V_112 ) ;
V_3 -> V_19 . V_162 . V_200 = V_203 ;
V_3 -> V_19 . V_162 . V_208 = V_28 ;
V_3 -> V_28 = F_54 ( V_28 ) ;
V_3 -> V_198 = V_28 -> V_198 ;
V_28 -> V_198 = F_85 ;
F_96 ( V_28 , V_3 ) ;
if ( F_97 ( & V_3 -> V_19 . V_162 ) ) {
F_11 ( V_3 -> V_28 ,
L_50 ,
V_3 -> V_19 . V_162 . V_200 ,
V_3 -> V_19 . V_162 . V_161 ) ;
goto F_57;
}
if ( F_98 ( & V_28 -> V_177 , V_3 -> V_19 . V_178 ) ) {
F_75 ( & V_3 -> V_19 . V_162 ) ;
goto F_57;
}
if ( F_99 ( & V_28 -> V_177 ) ) {
...
V_3 -> V_179 = F_100 ( V_203 ) ;
F_71 ( & V_175 ) ;
F_101 ( & V_3 -> V_176 , & V_209 ) ;
F_73 ( & V_175 ) ;
return V_3 ;
F_57:
F_57 ( V_3 -> V_28 ) ;
