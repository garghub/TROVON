...
struct V_34 * V_35 ;
struct V_116 * V_117 ;
F_85 (b, hn, &c->cache_hash[DM_BUFIO_HASH(block)],
hash_list) {
F_67 () ;
if ( V_35 -> V_37 == V_37 )
return V_35 ;
...
if ( V_98 == V_102 )
return NULL ;
if ( V_98 == V_121 && F_53 ( F_54 ( V_92 , & V_35 -> V_87 ) ) )
return NULL ;
V_35 -> V_91 ++ ;
...
struct V_34 * V_35 ;
F_4 ( V_2 ) ;
V_35 = F_86 ( V_2 , V_37 , V_98 , & V_118 ) ;
F_9 ( V_2 ) ;
if ( ! V_35 )
return V_35 ;
if ( V_118 )
F_50 ( V_35 , V_125 , V_35 -> V_37 , F_87 ) ;
F_64 ( & V_35 -> V_87 , V_92 , F_59 , V_90 ) ;
if ( V_35 -> V_122 ) {
...
struct V_34 * * V_124 )
{
return F_88 ( V_2 , V_37 , V_121 , V_124 ) ;
}
void * F_92 ( struct V_1 * V_2 , T_2 V_37 ,
struct V_34 * * V_124 )
{
F_2 ( F_6 () ) ;
return F_88 ( V_2 , V_37 , V_126 , V_124 ) ;
}
void * F_93 ( struct V_1 * V_2 , T_2 V_37 ,
struct V_34 * * V_124 )
{
F_2 ( F_6 () ) ;
return F_88 ( V_2 , V_37 , V_123 , V_124 ) ;
}
...
int V_118 ;
struct V_34 * V_35 ;
V_35 = F_86 ( V_2 , V_37 , V_102 , & V_118 ) ;
if ( F_53 ( V_35 != NULL ) ) {
F_9 ( V_2 ) ;
if ( V_118 )
F_50 ( V_35 , V_125 , V_35 -> V_37 , F_87 ) ;
...
void F_103 ( struct V_34 * V_35 , T_2 V_138 )
{
struct V_1 * V_2 = V_35 -> V_2 ;
struct V_34 * V_139 ;
F_2 ( F_6 () ) ;
...
for ( V_143 = 0 ; V_143 < V_144 ; V_143 ++ )
F_2 ( ! F_74 ( & V_2 -> V_42 [ V_143 ] ) ) ;
F_9 ( V_2 ) ;
}
static int F_115 ( struct V_34 * V_35 , T_1 V_145 ,
unsigned long V_146 )
{
...
static void F_116 ( struct V_1 * V_2 , unsigned long V_148 ,
struct V_149 * V_150 )
{
int V_151 ;
struct V_34 * V_35 , * V_108 ;
...
if ( ! F_115 ( V_35 , V_150 -> V_23 , 0 ) &&
! -- V_148 )
return;
F_67 () ;
}
}
static int F_117 ( struct V_152 * V_152 , struct V_149 * V_150 )
{
struct V_1 * V_2 =
F_52 ( V_152 , struct V_1 , V_152 ) ;
unsigned long V_53 ;
...
struct V_1 * F_118 ( struct V_154 * V_63 , unsigned V_24 ,
...
V_2 -> V_44 = F_119 ( sizeof( struct V_158 ) << V_159 ) ;
if ( ! V_2 -> V_44 ) {
V_53 = - V_156 ;
goto V_160;
}
...
V_2 -> V_30 = ( F_120 ( V_24 ) - 1 >= V_161 ) ?
F_120 ( V_24 ) - 1 - V_161 : 0 ;
V_2 -> V_4 = ( F_120 ( V_24 ) - 1 < V_161 ?
V_161 - ( F_120 ( V_24 ) - 1 ) : 0 ) ;
V_2 -> V_36 = V_36 ;
V_2 -> V_106 = V_106 ;
V_2 -> V_83 = V_83 ;
for ( V_143 = 0 ; V_143 < V_144 ; V_143 ++ ) {
F_121 ( & V_2 -> V_42 [ V_143 ] ) ;
V_2 -> V_39 [ V_143 ] = 0 ;
}
for ( V_143 = 0 ; V_143 < 1 << V_159 ; V_143 ++ )
F_122 ( & V_2 -> V_44 [ V_143 ] ) ;
F_123 ( & V_2 -> V_6 ) ;
F_121 ( & V_2 -> V_103 ) ;
V_2 -> V_105 = V_103 ;
F_124 ( & V_2 -> V_95 ) ;
...
if ( V_2 -> V_4 ) {
if ( ! F_128 ( V_2 ) ) {
F_128 ( V_2 ) = F_129 ( V_155 , L_3 , V_2 -> V_24 ) ;
if ( ! F_128 ( V_2 ) ) {
V_53 = - V_156 ;
F_10 ( & V_17 ) ;
goto V_163;
...
for ( V_143 = 0 ; V_143 < V_144 ; V_143 ++ )
if ( V_2 -> V_39 [ V_143 ] )
F_114 ( L_4 , V_143 , V_2 -> V_39 [ V_143 ] ) ;
for ( V_143 = 0 ; V_143 < V_144 ; V_143 ++ )
F_2 ( V_2 -> V_39 [ V_143 ] ) ;
F_132 ( V_2 -> V_60 ) ;
F_26 ( V_2 -> V_44 ) ;
...
{
unsigned long V_169 = F_16 ( V_170 ) ;
struct V_1 * V_2 ;
...
struct V_34 * V_35 ;
V_35 = F_75 ( V_2 -> V_42 [ V_109 ] . V_173 ,
struct V_34 , V_41 ) ;
if ( F_115 ( V_35 , 0 , V_169 * V_172 ) )
break;
F_67 () ;
}
F_9 ( V_2 ) ;
...
static void F_137 ( struct V_174 * V_175 )
{
F_136 () ;
F_138 ( V_176 , & V_177 ,
V_178 * V_172 ) ;
