...
F_11 ( V_2 ) ;
F_12 ( V_12 , V_14 , V_16 ) ;
} else if ( V_114 == V_97 -> V_102 ) {
V_5 -> V_103 = V_115 ;
F_25 ( V_2 ) ;
F_12 ( V_12 , V_14 , V_47 ) ;
F_12 ( V_12 , V_14 , V_119 ) ;
} else if ( V_114 == V_97 -> V_104 ) {
V_5 -> V_105 = V_115 ;
F_25 ( V_2 ) ;
F_12 ( V_12 , V_14 , V_47 ) ;
F_12 ( V_12 , V_14 , V_120 ) ;
} else if ( V_114 == V_97 -> V_106 ) {
if ( V_72 -> V_121 != V_122 )
return - V_123 ;
V_5 -> V_26 = V_115 ;
V_118 = true ;
} else if ( V_114 == V_97 -> V_107 ) {
V_5 -> V_108 = V_115 ;
F_22 ( V_2 ) ;
F_12 ( V_12 , V_14 , V_124 ) ;
} else if ( V_114 == V_97 -> V_109 ) {
V_5 -> V_110 = V_115 ;
F_25 ( V_2 ) ;
F_12 ( V_12 , V_14 , V_125 ) ;
} else if ( V_114 == V_97 -> V_111 ) {
V_5 -> V_112 = V_115 ;
F_25 ( V_2 ) ;
F_12 ( V_12 , V_14 , V_126 ) ;
} else if ( V_114 == V_5 -> V_8 ) {
if ( V_72 -> V_121 != V_122 )
return - V_123 ;
V_5 -> V_93 = V_115 ;
V_118 = true ;
...
V_117 -> V_129 -> V_130 ( & V_128 ) ;
}
}
return 0 ;
}
static int F_41 ( struct V_11 * V_12 , const struct V_131 * V_132 )
{
T_1 V_133 = V_134 ;
T_1 V_115 ;
int V_135 ;
F_10 ( V_12 , L_1 ) ;
V_135 = F_42 ( V_12 , & V_133 , sizeof( V_133 ) ) ;
if ( V_135 < 0 )
goto V_136;
V_135 = F_43 ( V_12 , & V_115 , sizeof( V_115 ) ) ;
if ( V_135 < 0 )
goto V_136;
F_44 ( V_12 , L_3 , V_115 ) ;
F_28 ( V_12 , 0x3d , 0x0 ) ;
...
static int F_47 ( struct V_138 * V_7 )
{
struct V_11 * V_12 = F_48 ( V_7 ) ;
F_10 ( V_12 , L_1 ) ;
F_28 ( V_12 , 0x3d , 0x0 ) ;
return 0 ;
}
...
V_5 -> V_105 = 50 ;
V_5 -> V_15 = - 1 ;
V_5 -> V_147 = F_30 ( V_12 , V_134 ) ;
if ( V_148 ) {
for ( V_140 = 0 ; V_140 < V_98 ; V_140 ++ ) {
if ( ! strcmp ( V_99 [ V_140 ] , V_148 ) ) {
V_5 -> V_26 = V_140 ;
break;
}
}
