...
V_17 = ( V_32 - V_21 ) / 2 ;
V_18 = ( V_33 - V_20 ) / 2 ;
F_9 ( V_30 , V_18 , V_17 , V_20 , V_21 ) ;
V_1 = F_10 ( V_20 , V_21 , V_18 , V_17 ) ;
F_11 ( V_1 , TRUE ) ;
V_3 = V_20 - 4 ;
V_4 = V_21 - 2 ;
V_2 = F_12 ( V_1 , V_3 , V_4 , V_18 + 1 , V_17 + 1 ) ;
F_13 ( V_2 , V_34 . V_1 . V_35 ) ;
F_14 ( V_2 , V_34 . V_1 . V_35 & V_36 ) ;
F_11 ( V_2 , TRUE ) ;
F_15 ( V_1 , 0 , 0 , V_20 , V_21 ,
V_34 . V_1 . V_35 , V_34 . V_37 . V_35 ) ;
F_13 ( V_1 , V_34 . V_37 . V_35 ) ;
F_16 ( V_1 , V_20 - 3 , 0 , V_38 ) ;
for ( V_16 = 0 ; V_16 < V_21 - 2 ; V_16 ++ )
F_17 ( V_1 , V_39 ) ;
F_13 ( V_1 , V_34 . V_1 . V_35 ) ;
F_14 ( V_1 , V_34 . V_1 . V_35 & V_36 ) ;
F_17 ( V_1 , V_40 ) ;
F_18 ( V_1 , V_9 , V_21 ) ;
F_19 ( V_1 , F_20 ( L_1 ) , V_20 - 2 , V_21 / 2 - 4 , TRUE ) ;
F_21 ( V_1 ) ;
F_22 ( V_1 , V_5 , V_6 ) ;
F_23 ( V_2 , V_3 , V_4 , V_34 . V_1 . V_35 ) ;
...
static void F_29 ( T_1 * V_54 , int V_57 , int V_21 )
{
char * line ;
line = F_7 () ;
line += F_30 ( strlen ( line ) , V_26 ) ;
F_4 ( V_54 , V_57 , 0 ) ;
F_17 ( V_54 , ' ' ) ;
F_31 ( V_54 , line , F_30 ( strlen ( line ) , V_21 - 2 ) ) ;
#if V_58
{
int V_17 = F_32 ( V_54 ) ;
int V_16 ;
...
{
int V_59 ;
F_13 ( V_54 , V_34 . V_60 . V_35 ) ;
F_14 ( V_54 , V_34 . V_60 . V_35 & V_36 ) ;
V_59 = ( V_28 - V_27 ) * 100 / strlen ( V_27 ) ;
F_4 ( V_54 , F_34 ( V_54 ) - 3 , F_35 ( V_54 ) - 9 ) ;
F_36 ( V_54 , L_2 , V_59 ) ;
}
