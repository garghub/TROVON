...
struct V_6 * V_7 = F_2 ( V_2 ) ;
int V_30 ;
if ( sscanf ( V_5 , L_2 , & V_30 ) != 1 || V_30 < 0 || V_30 > 1 )
return - V_13 ;
F_4 ( V_7 ) ;
if ( V_30 )
V_7 -> V_28 |= V_29 ;
...
struct V_6 * V_7 ;
V_7 = F_2 ( V_2 ) ;
return sprintf ( V_5 , L_8 , F_18 ( & V_7 -> V_31 ) ) ;
}
static T_1
...
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return sprintf ( V_5 , L_8 , V_7 -> V_36 ) ;
}
static T_1
...
int V_46 ;
if ( V_7 -> V_32 != V_47 )
V_46 = F_30 ( V_44 + V_7 -> V_48 ) ;
else
V_46 = F_30 ( V_7 -> V_48 ) ;
return sprintf ( V_5 , L_15 , V_46 ) ;
}
static T_1
F_32 ( struct V_1 * V_2 , struct V_3 * V_4 , char * V_5 )
{
return sprintf ( V_5 , L_8 , V_2 -> V_49 . V_50 / 1000 ) ;
}
static T_1
...
{
int V_12 ;
if ( sscanf ( V_5 , L_2 , & V_12 ) != 1 || V_12 >= V_51 / 1000 ||
V_12 <= - V_51 / 1000 )
return - V_13 ;
F_34 ( V_2 , V_12 * 1000 ) ;
return V_10 ;
...
return snprintf ( V_5 , V_66 , L_15 , V_65 -> V_67 ) ;
}
...
static T_4 F_55 ( struct V_71 * V_41 ,
struct V_72 * V_73 , int V_74 )
{
struct V_1 * V_2 = F_56 ( V_41 , struct V_1 , V_41 ) ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_73 == & V_75 . V_4 ) {
if ( V_7 -> V_76 == NULL )
return 0 ;
...
static T_1
F_57 ( struct V_82 * V_83 , struct V_71 * V_41 ,
struct V_84 * V_4 ,
...
V_61 = sprintf ( V_5 , L_15 , 1 ) ;
else
V_61 = sprintf ( V_5 , L_15 , 0 ) ;
F_6 ( V_7 ) ;
return V_61 ;
}
static T_4 F_71 ( struct V_71 * V_41 ,
struct V_72 * V_73 , int V_74 )
{
struct V_1 * V_2 = F_56 ( V_41 , struct V_1 , V_41 ) ;
