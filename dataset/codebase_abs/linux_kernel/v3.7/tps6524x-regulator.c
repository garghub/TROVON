...
static int T_3 F_31 ( struct V_48 * V_15 )
{
struct V_1 * V_2 ;
struct V_50 * V_16 = & V_15 -> V_16 ;
...
V_2 = F_32 ( & V_15 -> V_16 , sizeof( struct V_1 ) , V_56 ) ;
if ( ! V_2 ) {
F_14 ( V_16 , L_7 ) ;
return - V_57 ;
}
...
V_2 -> V_15 = F_33 ( V_15 ) ;
F_34 ( & V_2 -> V_23 ) ;
for ( V_43 = 0 ; V_43 < V_49 ; V_43 ++ , V_37 ++ , V_52 ++ ) {
V_2 -> V_38 [ V_43 ] . V_58 = V_37 -> V_58 ;
V_2 -> V_38 [ V_43 ] . V_59 = V_43 ;
V_2 -> V_38 [ V_43 ] . V_39 = V_37 -> V_39 ;
V_2 -> V_38 [ V_43 ] . V_60 = V_37 -> V_61 ;
V_2 -> V_38 [ V_43 ] . V_62 = & V_63 ;
V_2 -> V_38 [ V_43 ] . type = V_64 ;
V_2 -> V_38 [ V_43 ] . V_65 = V_66 ;
V_54 . V_16 = V_16 ;
V_54 . V_52 = V_52 ;
V_54 . V_67 = V_2 ;
V_2 -> V_34 [ V_43 ] = F_35 ( & V_2 -> V_38 [ V_43 ] , & V_54 ) ;
if ( F_36 ( V_2 -> V_34 [ V_43 ] ) ) {
V_22 = F_37 ( V_2 -> V_34 [ V_43 ] ) ;
V_2 -> V_34 [ V_43 ] = NULL ;
goto V_68;
}
}
