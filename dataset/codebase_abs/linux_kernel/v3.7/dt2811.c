...
{
V_4 -> V_26 &= ~ V_7 [ 0 ] ;
V_4 -> V_26 |= V_7 [ 0 ] & V_7 [ 1 ] ;
F_3 ( V_4 -> V_26 , V_2 -> V_14 + V_25 ) ;
V_7 [ 1 ] = V_4 -> V_26 ;
return V_6 -> V_13 ;
}
static int F_9 ( struct V_1 * V_2 , struct V_27 * V_28 )
{
const struct V_29 * V_30 = F_10 ( V_2 ) ;
int V_31 ;
struct V_3 * V_4 ;
unsigned long V_14 ;
V_14 = V_28 -> V_32 [ 0 ] ;
F_11 ( V_33 L_1 , V_2 -> V_34 , V_14 ) ;
if ( ! F_12 ( V_14 , V_35 , V_36 ) ) {
F_11 ( V_37 L_2 ) ;
return - V_38 ;
}
V_2 -> V_14 = V_14 ;
...
if ( V_31 )
return V_31 ;
V_31 = F_14 ( V_2 , sizeof( struct V_41 ) ) ;
if ( V_31 < 0 )
return V_31 ;
switch ( V_28 -> V_32 [ 2 ] ) {
case 0 :
