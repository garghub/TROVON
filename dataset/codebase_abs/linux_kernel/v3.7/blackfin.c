...
static int T_6 F_62 ( struct V_104 * V_105 )
{
...
int V_112 = - V_113 ;
int V_114 ;
V_111 = F_63 ( sizeof( * V_111 ) , V_115 ) ;
if ( ! V_111 ) {
F_64 ( & V_105 -> V_108 , L_9 ) ;
goto V_116;
}
V_114 = F_65 ( & V_105 -> V_108 , V_115 ) ;
if ( V_114 < 0 ) {
F_64 ( & V_105 -> V_108 , L_10 ) ;
V_112 = - V_113 ;
goto V_117;
}
V_5 = F_66 ( L_11 , V_114 ) ;
...
V_5 -> V_119 = V_114 ;
V_5 -> V_108 . V_120 = & V_105 -> V_108 ;
V_5 -> V_108 . V_121 = & V_122 ;
V_5 -> V_108 . V_123 = V_122 ;
V_111 -> V_108 = & V_105 -> V_108 ;
V_111 -> V_5 = V_5 ;
V_107 -> V_124 = & V_125 ;
F_67 ( V_105 , V_111 ) ;
V_112 = F_68 ( V_5 , V_105 -> V_126 ,
V_105 -> V_127 ) ;
if ( V_112 ) {
F_64 ( & V_105 -> V_108 , L_13 ) ;
goto V_128;
}
V_112 = F_69 ( V_5 , V_107 , sizeof( * V_107 ) ) ;
if ( V_112 ) {
...
F_71 ( V_5 ) ;
V_118:
F_72 ( & V_105 -> V_108 , V_114 ) ;
V_117:
F_73 ( V_111 ) ;
V_116:
return V_112 ;
}
static int T_7 F_74 ( struct V_104 * V_105 )
{
struct V_110 * V_111 = F_75 ( V_105 ) ;
F_72 ( & V_105 -> V_108 , V_111 -> V_5 -> V_119 ) ;
F_76 ( V_111 -> V_5 ) ;
F_71 ( V_111 -> V_5 ) ;
F_73 ( V_111 ) ;
return 0 ;
}
static int F_77 ( struct V_129 * V_108 )
{
struct V_110 * V_111 = F_78 ( V_108 ) ;
struct V_5 * V_5 = F_79 ( V_111 ) ;
if ( F_27 ( V_5 ) )
F_31 ( V_5 -> V_54 -> V_55 , 0 ) ;
return 0 ;
}
static int F_80 ( struct V_129 * V_108 )
{
struct V_110 * V_111 = F_78 ( V_108 ) ;
struct V_5 * V_5 = F_79 ( V_111 ) ;
F_40 ( V_5 ) ;
