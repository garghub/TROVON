...
V_110 -> V_154 = F_37 ( V_217 ) ;
if ( V_110 -> V_226 ) {
F_7 ( V_108 -> V_2 , L_11 ,
V_110 -> V_226 , V_110 -> V_227 ) ;
V_110 -> V_228 = F_38 ( V_110 -> V_154 ,
V_110 -> V_227 , 2 ,
V_110 -> V_226 ) ;
} else {
V_110 -> V_228 = F_39 ( V_217 ) ;
}
switch ( F_40 ( V_217 ) ) {
case V_229 :
break;
...
static int F_41 ( struct V_218 * V_219 , int V_248 ,
...
static int F_42 ( struct V_218 * V_219 , unsigned int V_252 )
{
struct V_107 * V_108 = V_219 -> V_108 ;
unsigned int V_221 = 0 ;
unsigned int V_223 = 0 ;
...
static int F_43 ( struct V_218 * V_219 , unsigned int V_274 ,
...
static int F_44 ( struct V_283 * V_284 , unsigned int V_285 ,
unsigned int V_286 )
{
T_1 V_287 ;
...
static int F_48 ( struct V_218 * V_219 , int V_301 , int V_302 ,
...
static int F_49 ( struct V_218 * V_322 , int V_323 )
{
...
F_6 ( V_108 , V_13 ,
V_338 , 0 ) ;
F_52 ( V_110 -> V_337 , true ) ;
F_54 ( V_110 -> V_337 ) ;
F_55 ( F_17 ( V_110 -> V_336 ) ,
V_110 -> V_336 ) ;
break;
}
...
if ( V_127 -> V_141 ) {
struct V_340 V_341 =
F_57 ( L_34 , V_110 -> V_348 ,
F_12 , F_10 ) ;
V_110 -> V_349 = F_60 ( sizeof( char * )
* V_127 -> V_141 , V_345 ) ;
if ( ! V_110 -> V_349 ) {
F_8 ( V_108 -> V_2 ,
L_35 ,
...
static T_2 int F_65 ( struct V_354 * V_355 ,
const struct V_356 * V_357 )
{
struct V_109 * V_110 ;
unsigned int V_157 ;
int V_162 , V_129 ;
V_110 = F_66 ( & V_355 -> V_2 , sizeof( struct V_109 ) ,
V_345 ) ;
if ( V_110 == NULL )
return - V_358 ;
V_110 -> V_337 = F_67 ( V_355 , & V_359 ) ;
if ( F_68 ( V_110 -> V_337 ) ) {
V_162 = F_69 ( V_110 -> V_337 ) ;
F_8 ( & V_355 -> V_2 , L_40 ,
V_162 ) ;
return V_162 ;
}
...
V_162 = F_71 ( & V_355 -> V_2 , F_17 ( V_110 -> V_336 ) ,
V_110 -> V_336 ) ;
if ( V_162 != 0 ) {
...
V_162 = F_72 ( V_110 -> V_337 , V_4 , & V_157 ) ;
if ( V_162 < 0 ) {
...
V_162 = F_72 ( V_110 -> V_337 , V_5 , & V_157 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_355 -> V_2 , L_44 ,
V_162 ) ;
goto V_364;
}
F_73 ( & V_355 -> V_2 , L_45 , V_157 + 'A' ) ;
V_162 = F_74 ( V_110 -> V_337 , V_4 , 0 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_355 -> V_2 , L_46 , V_162 ) ;
goto V_364;
}
F_75 ( V_110 -> V_337 , V_35 ,
V_365 , V_365 ) ;
F_75 ( V_110 -> V_337 , V_36 ,
V_365 , V_365 ) ;
F_75 ( V_110 -> V_337 , V_31 ,
V_366 , V_366 ) ;
F_75 ( V_110 -> V_337 , V_32 ,
V_366 , V_366 ) ;
F_75 ( V_110 -> V_337 , V_47 ,
V_367 | V_368 ,
V_367 | V_368 ) ;
F_75 ( V_110 -> V_337 , V_48 ,
V_367 | V_369 ,
V_367 | V_369 ) ;
F_75 ( V_110 -> V_337 , V_49 ,
V_370 | V_371 ,
V_370 | V_371 ) ;
F_75 ( V_110 -> V_337 , V_50 ,
V_370 | V_372 ,
V_370 | V_372 ) ;
F_75 ( V_110 -> V_337 , V_24 ,
V_373 , 0 ) ;
if ( V_110 -> V_127 ) {
...
F_75 ( V_110 -> V_337 , V_59 ,
V_378 , V_378 ) ;
F_75 ( V_110 -> V_337 , V_13 ,
V_379 , 0 ) ;
F_52 ( V_110 -> V_337 , true ) ;
F_55 ( F_17 ( V_110 -> V_336 ) , V_110 -> V_336 ) ;
V_162 = F_76 ( & V_355 -> V_2 ,
& V_380 , & V_351 , 1 ) ;
if ( V_162 != 0 )
return V_162 ;
return 0 ;
...
static T_3 int F_77 ( struct V_354 * V_381 )
{
F_78 ( & V_381 -> V_2 ) ;
return 0 ;
}
