...
static int F_35 ( struct V_1 * V_2 , T_4 V_80 )
{
T_1 V_81 = V_2 -> V_18 . V_46 ;
if ( ! ( V_2 -> V_18 . V_19 -> V_20 & V_23 ) )
V_81 = ( V_50 ) V_81 ;
if ( F_36 ( V_81 ) &&
F_36 ( ( V_81 & V_82 ) >> V_76 == V_80 ) ) {
return 1 ;
}
return F_37 ( V_2 -> V_74 , V_80 ) ;
}
int F_38 ( struct V_83 * V_84 , struct V_1 * V_2 ,
T_1 V_85 , int V_86 )
{
bool V_87 = ( V_86 == V_88 ) ;
int V_89 = V_90 ;
...
static inline int F_43 ( int V_73 )
{
#ifdef F_44
V_73 *= 2 ;
#endif
...
case V_14 :
F_46 ( V_11 ) ;
for ( V_73 = 0 ; V_73 < F_47 ( V_2 -> V_18 . V_125 ) ; V_73 ++ )
V_124 [ V_73 ] = V_128 [ F_43 ( V_73 ) ] ;
...
#ifdef F_44
F_50 ( V_11 ) ;
for ( V_73 = 0 ; V_73 < F_47 ( V_2 -> V_18 . V_127 ) ; V_73 ++ )
V_126 [ V_73 ] = V_128 [ F_43 ( V_73 ) + 1 ] ;
#endif
break;
default:
F_51 () ;
...
T_3 V_135 = F_53 ( V_2 ) ;
int V_136 ;
V_136 = F_54 ( V_2 , & V_134 , sizeof( T_3 ) , & V_135 , false ) ;
if ( V_136 == - V_108 ) {
T_1 V_20 = V_2 -> V_18 . V_19 -> V_20 ;
V_20 = F_55 ( V_20 , 33 , 33 , 1 ) ;
V_20 = F_55 ( V_20 , 34 , 36 , 0 ) ;
V_2 -> V_18 . V_19 -> V_20 = F_55 ( V_20 , 42 , 47 , 0 ) ;
F_40 ( V_2 , V_137 ) ;
return V_138 ;
}
return V_139 ;
}
static int F_56 ( struct V_1 * V_2 , unsigned int V_140 )
{
...
int F_60 ( struct V_83 * V_84 , struct V_1 * V_2 ,
unsigned int V_140 )
{
int V_89 = V_121 ;
V_2 -> V_44 . V_145 ++ ;
...
F_6 ( V_5 ) ;
if ( V_112 & 0x40000000 ) {
V_89 = F_38 ( V_84 , V_2 , F_18 ( V_2 ) , V_140 ) ;
V_2 -> V_44 . V_152 ++ ;
} else if ( V_2 -> V_18 . V_62 . V_63 ( V_2 ) &&
( ! ( V_2 -> V_18 . V_54 & V_61 ) ) ) {
...
F_6 ( V_5 ) ;
if ( V_111 & V_114 ) {
V_89 = F_38 ( V_84 , V_2 , V_109 , V_140 ) ;
} else {
...
#ifdef F_12
F_13 ( V_38 L_6 , F_18 ( V_2 ) , F_53 ( V_2 ) ) ;
#endif
if ( ( F_53 ( V_2 ) & 0xff0007ff ) !=
( V_79 & 0xfffffff7 ) ) {
F_65 ( V_2 , V_168 ) ;
V_89 = V_90 ;
break;
...
T_1 V_178 = F_67 ( V_2 , 3 ) ;
int V_73 ;
#ifdef F_68
if ( F_69 ( V_2 , V_178 ) == V_139 ) {
V_89 = V_90 ;
break;
}
#endif
...
( ( ( T_3 ) F_67 ( V_2 , 3 ) ) == V_185 ) &&
( ( ( T_3 ) F_67 ( V_2 , 4 ) ) == V_186 ) ) {
T_2 * V_187 = V_84 -> V_188 . V_187 ;
int V_73 ;
V_84 -> V_146 = V_189 ;
for ( V_73 = 0 ; V_73 < 32 ; V_73 ++ )
V_187 [ V_73 ] = F_67 ( V_2 , V_73 ) ;
V_2 -> V_18 . V_190 = 1 ;
V_89 = V_120 ;
} else if ( ! ( V_2 -> V_18 . V_19 -> V_20 & V_31 ) &&
( ( ( T_3 ) F_67 ( V_2 , 0 ) ) == V_191 ) ) {
F_70 ( V_2 , 3 , F_71 ( V_2 ) ) ;
V_89 = V_90 ;
} else {
V_2 -> V_44 . V_192 ++ ;
...
case V_196 :
if ( F_52 ( V_2 ) == V_139 ) {
V_2 -> V_18 . V_19 -> V_110 = F_72 ( V_2 ,
F_53 ( V_2 ) ) ;
V_2 -> V_18 . V_19 -> V_109 = F_73 ( V_2 ,
F_53 ( V_2 ) ) ;
F_40 ( V_2 , V_140 ) ;
}
V_89 = V_90 ;
...
for ( V_73 = 0 ; V_73 < 8 ; V_73 ++ ) {
F_81 ( V_2 , & ( V_206 -> V_216 [ V_73 ] ) , false ,
( T_3 ) V_204 -> V_207 . V_208 . V_215 . V_216 [ V_73 ] ) ;
F_81 ( V_2 , & ( V_206 -> V_216 [ V_73 ] ) , true ,
( T_3 ) ( V_204 -> V_207 . V_208 . V_215 . V_216 [ V_73 ] >> 32 ) ) ;
F_81 ( V_2 , & ( V_206 -> V_218 [ V_73 ] ) , false ,
( T_3 ) V_204 -> V_207 . V_208 . V_215 . V_218 [ V_73 ] ) ;
F_81 ( V_2 , & ( V_206 -> V_218 [ V_73 ] ) , true ,
...
int F_82 ( struct V_1 * V_2 , struct V_221 * V_222 )
{
int V_89 = - V_107 ;
switch ( V_222 -> V_223 ) {
case V_224 :
V_89 = F_83 ( ( T_2 V_225 * ) ( long ) V_222 -> V_226 ,
...
int F_84 ( struct V_1 * V_2 , struct V_221 * V_222 )
{
int V_89 = - V_107 ;
switch ( V_222 -> V_223 ) {
case V_224 :
V_89 = F_85 ( & F_4 ( V_2 ) -> V_57 ,
...
struct V_1 * F_87 ( struct V_74 * V_74 , unsigned int V_223 )
{
struct V_205 * V_227 ;
struct V_1 * V_2 ;
int V_228 = - V_229 ;
unsigned long V_230 ;
V_227 = F_88 ( sizeof( struct V_205 ) ) ;
if ( ! V_227 )
goto V_231;
V_227 -> V_8 = (struct V_4 * )
F_89 ( sizeof( * V_227 -> V_8 ) , V_232 ) ;
if ( ! V_227 -> V_8 )
goto V_233;
V_2 = & V_227 -> V_2 ;
V_228 = F_90 ( V_2 , V_74 , V_223 ) ;
if ( V_228 )
goto V_234;
V_230 = F_91 ( V_232 | V_235 ) ;
...
F_98 ( ( unsigned long ) V_2 -> V_18 . V_19 & V_77 ) ;
F_93 ( V_2 ) ;
F_94 ( V_227 -> V_8 ) ;
F_95 ( V_227 ) ;
}
int F_99 ( struct V_83 * V_83 , struct V_1 * V_2 )
{
int V_136 ;
...
unsigned long V_252 ;
F_104 ( & V_74 -> V_253 ) ;
V_89 = F_105 ( V_74 , log , & V_251 ) ;
if ( V_89 )
goto V_231;
if ( V_251 ) {
V_248 = F_106 ( V_74 -> V_254 , log -> V_255 ) ;
V_249 = V_248 -> V_256 << V_76 ;
V_250 = V_249 + ( V_248 -> V_257 << V_76 ) ;
F_107 (n, vcpu, kvm)
F_108 ( V_2 , V_249 , V_250 ) ;
V_252 = F_109 ( V_248 ) ;
...
int F_111 ( struct V_74 * V_74 , struct V_259 * V_260 )
{
V_260 -> V_168 = 0 ;
V_260 -> V_261 = 64 ;
...
int F_112 ( struct V_74 * V_74 ,
struct V_268 * V_269 )
{
return 0 ;
}
void F_113 ( struct V_74 * V_74 ,
struct V_268 * V_269 )
{
}
int F_114 ( struct V_74 * V_74 )
{
#ifdef F_115
F_116 ( & V_74 -> V_18 . V_270 ) ;
#endif
return 0 ;
}
void F_117 ( struct V_74 * V_74 )
{
#ifdef F_115
F_118 ( ! F_119 ( & V_74 -> V_18 . V_270 ) ) ;
#endif
}
static int F_120 ( void )
{
int V_89 ;
V_89 = F_121 ( NULL , sizeof( struct V_205 ) , 0 ,
V_271 ) ;
if ( V_89 )
return V_89 ;
V_89 = F_122 () ;
