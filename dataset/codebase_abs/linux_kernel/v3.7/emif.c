...
V_330 ( & V_332 -> V_39 , L_51 ,
V_80 , V_4 -> V_49 , V_250 ) ;
return 0 ;
error:
return - V_342 ;
}
static int T_3 F_89 ( struct V_331 * V_332 )
{
struct V_3 * V_4 = F_90 ( V_332 ) ;
F_13 ( V_4 ) ;
return 0 ;
}
static void F_91 ( struct V_331 * V_332 )
{
struct V_3 * V_4 = F_90 ( V_332 ) ;
F_59 ( V_4 ) ;
}
static int F_92 ( struct V_3 * V_4 , T_1 V_10 ,
struct V_5 * V_6 )
{
T_1 V_135 , V_9 , V_271 ;
T_1 V_53 , type ;
...
static struct V_5 * F_93 ( struct V_3 * V_4 , T_1 V_10 )
{
int V_29 ;
struct V_5 * * V_28 ;
struct V_5 * V_6 = NULL ;
...
static void F_94 ( struct V_3 * V_4 , T_1 V_232 )
{
F_26 ( V_4 -> V_39 , L_56 , V_80 ,
V_232 ) ;
if ( ! V_4 -> V_247 ) {
F_25 ( V_4 -> V_39 ,
L_57 ,
...
static void F_95 ( struct V_3 * V_4 , T_1 V_348 )
{
struct V_5 * V_6 ;
V_6 = F_93 ( V_4 , V_348 ) ;
if ( ! V_6 )
