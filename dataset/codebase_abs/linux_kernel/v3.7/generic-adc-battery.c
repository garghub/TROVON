...
static int T_2 F_21 ( struct V_65 * V_66 )
{
struct V_1 * V_4 ;
struct V_2 * V_3 ;
...
memcpy ( V_3 -> V_68 , V_77 , sizeof( V_77 ) ) ;
V_68 = V_3 -> V_68 + sizeof( V_77 ) ;
for ( V_69 = 0 ; V_69 < F_23 ( V_76 ) ; V_69 ++ ) {
V_4 -> V_30 [ V_69 ] = F_25 ( F_26 ( & V_66 -> V_33 ) ,
V_76 [ V_69 ] ) ;
if ( F_27 ( V_4 -> V_30 [ V_69 ] ) ) {
V_8 = F_28 ( V_4 -> V_30 [ V_69 ] ) ;
} else {
...
if ( V_70 == F_23 ( V_76 ) )
goto V_80;
V_3 -> V_81 = F_23 ( V_77 ) + V_70 ;
V_8 = F_29 ( & V_66 -> V_33 , V_3 ) ;
if ( V_8 )
goto V_82;
F_30 ( & V_4 -> V_5 , F_17 ) ;
if ( F_8 ( V_7 -> V_9 ) ) {
int V_59 ;
V_8 = F_31 ( V_7 -> V_9 , L_4 ) ;
if ( V_8 )
goto V_83;
V_59 = F_32 ( V_7 -> V_9 ) ;
V_8 = F_33 ( V_59 , F_20 ,
...
static int T_3 F_39 ( struct V_65 * V_66 )
{
int V_69 ;
struct V_1 * V_4 = F_40 ( V_66 ) ;
struct V_6 * V_7 = V_4 -> V_7 ;
F_36 ( & V_4 -> V_3 ) ;
if ( F_8 ( V_7 -> V_9 ) ) {
F_41 ( F_32 ( V_7 -> V_9 ) , V_4 ) ;
F_35 ( V_7 -> V_9 ) ;
}
for ( V_69 = 0 ; F_23 ( V_76 ) ; V_69 ++ )
F_37 ( V_4 -> V_30 [ V_69 ] ) ;
...
static int F_43 ( struct V_87 * V_33 )
{
struct V_1 * V_4 = F_44 ( V_33 ) ;
F_45 ( & V_4 -> V_5 ) ;
V_4 -> V_18 = V_88 ;
return 0 ;
}
static int F_46 ( struct V_87 * V_33 )
{
struct V_1 * V_4 = F_44 ( V_33 ) ;
struct V_6 * V_7 = V_4 -> V_7 ;
int V_61 ;
