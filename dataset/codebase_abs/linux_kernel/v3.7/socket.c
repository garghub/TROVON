...
static int F_88 ( struct V_141 * V_141 , struct V_84 * V_84 )
{
return F_89 ( V_141 , V_84 , & V_142 ,
sizeof( struct V_143 ) ) ;
}
struct V_2 * F_90 ( struct V_14 * V_14 , T_3 V_21 )
{
struct V_2 * V_3 ;
if ( ! F_12 ( V_14 , & V_144 ) )
return NULL ;
F_8 () ;
V_3 = F_91 ( V_145 . V_3 [ V_21 ] ) ;
if ( V_3 )
F_16 ( V_3 ) ;
F_17 () ;
return V_3 ;
...
F_16 ( V_3 ) ;
F_94 ( V_145 . V_3 [ V_21 ] , V_3 ) ;
V_146 = 0 ;
}
F_26 ( & V_151 ) ;
return V_146 ;
}
int F_95 ( struct V_2 * V_3 , T_3 V_21 )
{
int V_146 = - V_152 ;
if ( ! F_93 ( V_148 ) )
return - V_149 ;
...
static struct V_2 * * F_98 ( struct V_133 * V_134 , T_6 V_135 )
{
struct V_14 * V_14 = F_74 ( V_134 ) ;
unsigned int V_6 ;
if ( ! F_12 ( V_14 , & V_144 ) )
...
static struct V_2 * * F_99 ( struct V_133 * V_134 , struct V_2 * * V_3 )
{
struct V_14 * V_14 = F_74 ( V_134 ) ;
unsigned int V_6 ;
...
static void * F_100 ( struct V_133 * V_134 , T_6 * V_135 )
__acquires( V_151 )
{
F_24 ( & V_151 ) ;
return * V_135 ? F_98 ( V_134 , * V_135 - 1 ) : V_136 ;
}
static void * F_101 ( struct V_133 * V_134 , void * V_137 , T_6 * V_135 )
{
struct V_2 * * V_3 ;
if ( V_137 == V_136 )
V_3 = F_98 ( V_134 , 0 ) ;
else
V_3 = F_99 ( V_134 , V_137 ) ;
( * V_135 ) ++ ;
return V_3 ;
}
static void F_102 ( struct V_133 * V_134 , void * V_137 )
__releases( V_151 )
{
F_26 ( & V_151 ) ;
}
static int F_103 ( struct V_133 * V_134 , void * V_137 )
{
int V_35 ;
if ( V_137 == V_136 )
...
static int F_104 ( struct V_141 * V_141 , struct V_84 * V_84 )
{
return F_89 ( V_141 , V_84 , & V_155 ,
sizeof( struct V_143 ) ) ;
}
