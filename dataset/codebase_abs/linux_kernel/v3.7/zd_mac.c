...
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_52 = V_205 -> V_52 -> V_92 ;
F_17 ( & V_11 -> V_21 ) ;
return F_59 ( & V_11 -> V_16 , V_205 -> V_52 -> V_92 ) ;
}
...
static void F_129 ( struct V_206 * V_207 )
{
T_3 V_208 ;
unsigned long V_25 ;
struct V_10 * V_11 = F_130 ( V_207 , struct V_10 , V_209 ) ;
F_27 ( & V_11 -> V_21 , V_25 ) ;
V_208 = F_104 ( * ( T_4 * ) ( V_11 -> V_210 + 4 ) ) ;
F_28 ( & V_11 -> V_21 , V_25 ) ;
if ( V_208 & V_211 ) {
F_125 ( V_11 ) ;
} else {
...
F_34 ( & V_34 ) ;
F_132 (ha, mc_list) {
F_58 ( F_6 ( V_11 ) , L_15 , V_215 -> V_14 ) ;
F_133 ( & V_34 , V_215 -> V_14 ) ;
}
return V_34 . V_216 | ( ( T_5 ) V_34 . V_217 << 32 ) ;
}
...
F_135 ( & V_34 ) ;
F_27 ( & V_11 -> V_21 , V_25 ) ;
V_11 -> V_185 = ! ! ( * V_219 & V_224 ) ;
V_11 -> V_28 = ! ! ( * V_219 & V_225 ) ;
V_11 -> V_48 = V_34 ;
F_28 ( & V_11 -> V_21 , V_25 ) ;
F_35 ( & V_11 -> V_16 , & V_34 ) ;
if ( V_218 & V_225 ) {
...
V_229 = F_138 ( V_227 -> V_235 ) ;
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_229 = V_229 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_228 & V_236 ) {
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_49 = V_227 -> V_237 ;
F_17 ( & V_11 -> V_21 ) ;
F_60 ( V_11 , V_227 -> V_237 ) ;
}
}
...
struct V_8 * F_141 ( struct V_238 * V_157 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
V_9 = F_142 ( sizeof( struct V_10 ) , & V_239 ) ;
if ( ! V_9 ) {
F_58 ( & V_157 -> V_240 , L_18 ) ;
return NULL ;
}
V_11 = F_4 ( V_9 ) ;
...
V_11 -> V_9 = V_9 ;
V_11 -> type = V_199 ;
memcpy ( V_11 -> V_241 , V_190 , sizeof( V_190 ) ) ;
memcpy ( V_11 -> V_71 , V_91 , sizeof( V_91 ) ) ;
V_11 -> V_192 . V_195 = F_2 ( V_91 ) ;
V_11 -> V_192 . V_196 = V_11 -> V_71 ;
V_11 -> V_192 . V_242 = F_2 ( V_190 ) ;
V_11 -> V_192 . V_241 = V_11 -> V_241 ;
V_9 -> V_23 -> V_243 [ V_193 ] = & V_11 -> V_192 ;
V_9 -> V_25 = V_244 |
V_245 |
V_246 |
V_247 ;
...
F_147 ( V_11 ) ;
F_148 ( V_11 ) ;
F_149 ( & V_11 -> V_209 , F_129 ) ;
F_150 ( V_9 , & V_157 -> V_240 ) ;
return V_9 ;
}
static void F_151 ( struct V_206 * V_207 )
{
struct V_10 * V_11 =
F_130 ( V_207 , struct V_10 , V_47 . V_254 . V_207 ) ;
struct V_43 * V_47 ;
unsigned long V_255 ;
int V_53 , V_54 ;
if ( ! F_126 ( V_42 , & V_11 -> V_25 ) )
...
V_53 = V_11 -> V_47 . V_53 ;
V_54 = V_11 -> V_47 . V_54 ;
V_255 = V_11 -> V_47 . V_57 +
F_152 ( V_53 * 1024 / 1000 ) * 3 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_53 > 0 && F_153 ( V_255 ) ) {
F_58 ( F_6 ( V_11 ) , L_19
L_20
L_21 ,
V_53 , V_54 ) ;
...
V_256:
F_154 ( V_24 , & V_11 -> V_47 . V_254 ,
V_257 ) ;
}
static void F_148 ( struct V_10 * V_11 )
{
F_155 ( & V_11 -> V_47 . V_254 , F_151 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_156 ( & V_11 -> V_47 . V_254 ) ;
F_86 ( V_11 ) ;
}
static void F_157 ( struct V_206 * V_207 )
{
struct V_10 * V_11 =
F_130 ( V_207 , struct V_10 , V_258 . V_259 . V_207 ) ;
struct V_17 * V_16 = & V_11 -> V_16 ;
int V_260 ;
int V_13 ;
if ( ! F_126 ( V_42 , & V_11 -> V_25 ) )
...
V_261:
F_154 ( V_24 , & V_11 -> V_258 . V_259 ,
V_264 ) ;
}
static void F_147 ( struct V_10 * V_11 )
{
F_155 ( & V_11 -> V_258 . V_259 , F_157 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_156 ( & V_11 -> V_258 . V_259 ) ;
F_158 ( & V_11 -> V_16 , V_265 ) ;
}
