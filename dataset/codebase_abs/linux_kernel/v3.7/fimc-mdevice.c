...
snprintf ( V_113 , sizeof( V_113 ) , L_16 , V_10 ) ;
...
bool V_133 ;
int V_10 ;
if ( ! strcmp ( V_129 , L_23 ) )
V_133 = false ;
else if ( ! strcmp ( V_129 , L_24 ) )
V_133 = true ;
else
return V_132 ;
V_43 -> V_130 = V_133 ;
...
V_50 -> V_141 = V_142 ;
snprintf ( V_50 -> V_78 , sizeof( V_50 -> V_78 ) , L_26 ,
F_81 ( & V_56 -> V_57 ) ) ;
...
static int T_3 F_89 ( struct V_76 * V_56 )
{
struct V_42 * V_43 = F_75 ( V_56 ) ;
if ( ! V_43 )
return 0 ;
