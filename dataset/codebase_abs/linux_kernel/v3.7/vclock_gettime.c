...
T_1 static inline T_3 F_11 ( void )
{
long V_13 ;
T_4 V_14 ;
...
do {
V_21 = F_13 ( & V_15 -> V_21 ) ;
V_23 = V_15 -> clock . V_16 ;
V_8 -> V_25 = V_15 -> V_26 ;
V_22 = V_15 -> V_27 ;
V_22 += F_11 () ;
V_22 >>= V_15 -> clock . V_28 ;
} while ( F_14 ( F_15 ( & V_15 -> V_21 , V_21 ) ) );
F_16 ( V_8 , V_22 ) ;
return V_23 ;
}
