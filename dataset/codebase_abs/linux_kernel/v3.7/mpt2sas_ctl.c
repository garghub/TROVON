...
static T_22
F_116 ( struct V_140 * V_353 , struct V_354 * V_355 ,
char * V_356 )
{
struct V_357 * V_358 = F_96 ( V_353 ) ;
struct V_2 * V_3 = F_97 ( V_358 ) ;
...
V_64 = F_117 ( T_23 , V_384 ) + ( sizeof( T_1 ) * 36 ) ;
V_382 = F_39 ( V_64 , V_171 ) ;
if ( ! V_382 ) {
F_6 ( V_166 L_63\
L_109 , V_3 -> V_46 , V_105 , V_64 ) ;
goto V_7;
}
if ( F_118 ( V_3 , & V_10 , V_382 , V_64 ) !=
0 ) {
F_6 ( V_166
L_110 , V_3 -> V_46 ,
V_105 ) ;
...
V_383 = F_5 ( V_382 -> V_384 [ 24 ] ) ;
V_273 = snprintf ( V_356 , V_359 , L_103 , ( V_383 & 1 ) ) ;
V_7:
F_59 ( V_382 ) ;
return V_273 ;
}
...
V_290 = (struct V_387 * )
V_3 -> V_295 [ V_281 ] ;
if ( ( F_7 ( V_290 -> V_388 ) == 0x00000000 ||
F_7 ( V_290 -> V_388 ) == 0x01000000 ) &&
F_7 ( V_290 -> V_389 ) == 0x4742444c )
V_386 = F_7 ( V_290 -> V_390 ) ;
V_3 -> V_391 = V_386 ;
return snprintf ( V_356 , V_359 , L_103 , V_386 ) ;
}
static T_22
F_120 ( struct V_140 * V_353 , struct V_354 * V_355 ,
char * V_356 )
{
struct V_357 * V_358 = F_96 ( V_353 ) ;
struct V_2 * V_3 = F_97 ( V_358 ) ;
...
if ( V_3 -> V_392 > V_3 -> V_391 )
return 0 ;
V_386 = V_3 -> V_391 - V_3 -> V_392 ;
V_386 = ( V_386 > V_359 ) ? V_359 : V_386 ;
V_290 = V_3 -> V_295 [ 0 ] + V_3 -> V_392 ;
memcpy ( V_356 , V_290 , V_386 ) ;
return V_386 ;
}
static T_22
F_121 ( struct V_140 * V_353 , struct V_354 * V_355 ,
const char * V_356 , T_15 V_375 )
{
struct V_357 * V_358 = F_96 ( V_353 ) ;
struct V_2 * V_3 = F_97 ( V_358 ) ;
...
( ( V_3 -> V_107 [ V_281 ] &
V_108 ) == 0 ) )
return snprintf ( V_356 , V_359 , L_116 ) ;
else if ( ( V_3 -> V_107 [ V_281 ] &
V_109 ) )
return snprintf ( V_356 , V_359 , L_117 ) ;
else
return snprintf ( V_356 , V_359 , L_118 ) ;
}
static T_22
F_123 ( struct V_140 * V_353 ,
struct V_354 * V_355 , const char * V_356 , T_15 V_375 )
{
struct V_357 * V_358 = F_96 ( V_353 ) ;
struct V_2 * V_3 = F_97 ( V_358 ) ;
...
struct V_288 V_289 ;
T_6 V_103 = 0 ;
if ( sscanf ( V_356 , L_120 , V_393 ) != 1 )
return - V_175 ;
if ( ! strcmp ( V_393 , L_121 ) ) {
if ( ( V_3 -> V_295 [ V_281 ] ) &&
( V_3 -> V_107 [ V_281 ] &
V_108 ) &&
( ( V_3 -> V_107 [ V_281 ] &
...
static T_22
F_124 ( struct V_140 * V_394 , struct V_354 * V_355 ,
char * V_356 )
{
struct V_395 * V_396 = F_125 ( V_394 ) ;
struct V_128 * V_397 = V_396 -> V_141 ;
return snprintf ( V_356 , V_359 , L_100 ,
( unsigned long long ) V_397 -> V_142 -> V_54 ) ;
}
static T_22
F_126 ( struct V_140 * V_394 , struct V_354 * V_355 ,
char * V_356 )
{
struct V_395 * V_396 = F_125 ( V_394 ) ;
struct V_128 * V_397 = V_396 -> V_141 ;
return snprintf ( V_356 , V_359 , L_125 ,
V_397 -> V_142 -> V_4 ) ;
}
void
F_127 ( void )
