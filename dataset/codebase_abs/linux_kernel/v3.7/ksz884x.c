...
static void F_213 ( struct V_1 * V_2 , int V_417 , int V_67 ,
T_5 * V_85 )
{
int V_154 ;
int V_81 ;
...
for ( V_154 = 0 , V_66 = V_417 ; V_154 < V_67 ; V_154 ++ , V_66 ++ ) {
V_82 = & V_2 -> V_82 [ V_66 ] ;
for ( V_81 = V_82 -> V_83 ; V_81 < V_2 -> V_86 ; V_81 ++ )
V_85 [ V_81 ] += V_82 -> V_85 [ V_81 ] ;
}
}
static void F_214 ( struct V_418 * V_410 , struct V_419 * V_420 )
{
struct V_13 * V_14 ;
struct V_13 * V_417 ;
struct V_421 * V_422 = F_215 ( V_420 ) ;
...
static void F_220 ( struct V_258 * V_259 , int V_435 )
{
int V_28 ;
union V_15 V_12 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
V_14 = & V_26 -> V_27 [ V_28 ] ;
V_12 . V_20 = F_222 ( V_14 -> V_18 -> V_19 . V_20 ) ;
if ( V_12 . V_22 . V_17 ) {
if ( V_435 )
break;
else
...
static void F_225 ( struct V_258 * V_259 )
{
struct V_1 * V_2 = & V_259 -> V_2 ;
int V_66 ;
F_220 ( V_259 , 1 ) ;
...
if ( F_226 ( V_420 ) && F_227 ( V_420 ) )
F_228 ( V_420 ) ;
}
}
static inline void F_229 ( struct V_418 * V_438 , struct V_418 * V_410 )
{
...
static T_7 F_231 ( struct V_418 * V_410 , struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
if ( V_410 -> V_33 <= 48 ) {
if ( F_232 ( V_410 ) - V_410 -> V_20 >= 50 ) {
memset ( & V_410 -> V_20 [ V_410 -> V_33 ] , 0 , 50 - V_410 -> V_33 ) ;
V_410 -> V_33 = 50 ;
} else {
V_410 = F_233 ( V_420 , 50 ) ;
if ( ! V_410 )
return V_444 ;
...
V_442 = F_171 ( V_2 , V_410 -> V_33 , V_103 ) ;
if ( V_442 ) {
if ( V_442 < V_103 ||
( V_429 == V_410 -> V_428 &&
V_410 -> V_439 == F_235 ( V_445 ) ) ) {
struct V_418 * V_443 = V_410 ;
V_410 = F_233 ( V_420 , V_443 -> V_33 ) ;
if ( ! V_410 ) {
V_294 = V_444 ;
goto V_446;
}
F_236 ( V_443 , V_410 -> V_20 ) ;
V_443 -> V_428 = V_447 ;
...
static inline void F_240 ( struct V_418 * V_410 )
{
unsigned short V_439 ;
struct V_451 * V_452 ;
V_439 = V_410 -> V_439 ;
F_241 ( V_410 ) ;
V_452 = (struct V_451 * ) F_242 ( V_410 ) ;
if ( V_439 == F_235 ( V_453 ) ) {
V_439 = V_452 -> V_454 ;
F_230 ( V_410 , V_455 ) ;
V_452 = (struct V_451 * ) F_242 ( V_410 ) ;
}
if ( V_439 == F_235 ( V_456 ) ) {
if ( V_452 -> V_439 == V_457 )
V_410 -> V_428 = V_458 ;
}
}
static inline int F_243 ( struct V_419 * V_420 , struct V_1 * V_2 ,
...
V_412 ) ;
do {
V_410 = F_233 ( V_420 , V_459 + 2 ) ;
if ( ! V_410 ) {
V_420 -> V_432 . V_462 ++ ;
return - V_463 ;
}
F_245 ( V_410 , 2 ) ;
memcpy ( F_246 ( V_410 , V_459 ) ,
V_407 -> V_410 -> V_20 , V_459 ) ;
} while ( 0 );
V_410 -> V_439 = F_247 ( V_410 , V_420 ) ;
...
break;
if ( V_2 -> V_384 > 1 ) {
int V_93 = F_251 ( V_12 . V_16 . V_471 ) ;
...
static void F_253 ( unsigned long V_20 )
{
struct V_258 * V_259 = (struct V_258 * ) V_20 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
if ( ! V_2 -> V_213 )
return;
if ( F_254 ( ! V_259 -> V_475 ( V_259 ) ) ) {
F_164 ( V_2 ) ;
F_234 ( & V_259 -> V_436 ) ;
F_9 ( V_2 , V_476 ) ;
F_238 ( & V_259 -> V_436 ) ;
...
static void F_256 ( unsigned long V_20 )
{
struct V_258 * V_259 = (struct V_258 * ) V_20 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
F_1 ( V_2 , V_479 ) ;
...
static T_8 F_258 ( int V_481 , void * V_482 )
{
T_1 V_483 = 0 ;
...
F_1 ( V_2 , V_483 ) ;
V_483 &= V_2 -> V_7 ;
if ( F_254 ( V_483 & V_479 ) ) {
F_7 ( V_2 , V_479 ) ;
F_255 ( & V_259 -> V_485 ) ;
}
if ( F_259 ( V_483 & V_477 ) ) {
F_7 ( V_2 , V_477 ) ;
F_255 ( & V_259 -> V_478 ) ;
}
if ( F_254 ( V_483 & V_326 ) ) {
V_420 -> V_432 . V_486 ++ ;
F_164 ( V_2 ) ;
}
if ( F_254 ( V_483 & V_487 ) ) {
struct V_203 * V_66 = & V_422 -> V_66 ;
V_2 -> V_225 |= V_488 ;
F_136 ( V_66 ) ;
}
if ( F_254 ( V_483 & V_343 ) ) {
F_257 ( V_2 ) ;
break;
}
if ( F_254 ( V_483 & V_489 ) ) {
T_2 V_20 ;
V_2 -> V_7 &= ~ V_489 ;
F_260 ( L_3 ) ;
...
static void F_261 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_3 ( & V_259 -> V_2 ) ;
F_258 ( V_420 -> V_481 , V_420 ) ;
}
...
static int F_263 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
...
static void F_268 ( struct V_258 * V_259 , struct V_1 * V_2 )
{
if ( V_2 -> V_104 ) {
T_2 V_20 ;
V_20 = F_35 ( V_2 -> V_4 + V_107 ) ;
...
static int F_269 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
int V_294 = 0 ;
V_259 -> V_420 = V_420 ;
V_294 = F_270 ( V_420 -> V_481 , F_258 , V_501 , V_420 -> V_502 , V_420 ) ;
if ( V_294 )
return V_294 ;
F_271 ( & V_259 -> V_478 , F_253 ,
( unsigned long ) V_259 ) ;
F_271 ( & V_259 -> V_485 , F_256 ,
( unsigned long ) V_259 ) ;
V_2 -> V_323 = 0 ;
V_2 -> V_321 = 0 ;
V_2 -> V_379 = 0 ;
...
static void F_272 ( struct V_419 * V_420 , int V_503 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
...
F_274 ( V_420 ) ;
F_275 ( V_422 , V_504 , V_420 , L_5 ,
V_503 == V_422 -> V_503 ? L_6 : L_7 ) ;
}
static int F_276 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
if ( V_294 )
return V_294 ;
for ( V_154 = 0 ; V_154 < V_2 -> V_507 ; V_154 ++ ) {
if ( V_508 < V_393 )
V_508 = V_393 + V_497 * 2 ;
else
V_508 += V_497 * 1 ;
V_259 -> V_85 [ V_154 ] . time = V_508 ;
V_2 -> V_82 [ V_154 ] . V_162 = V_244 ;
F_32 ( V_2 , V_154 ) ;
}
if ( V_2 -> V_104 )
V_2 -> V_82 [ V_509 ] . V_162 = V_243 ;
else {
F_150 ( V_2 ) ;
F_145 ( V_2 , 0 ) ;
F_143 ( & V_259 -> V_2 ) ;
...
F_187 ( & V_422 -> V_492 ,
V_422 -> V_492 . V_395 ) ;
V_422 -> V_503 = V_66 -> V_229 -> V_162 ;
F_272 ( V_420 , V_243 ) ;
F_277 ( V_420 ) ;
return 0 ;
}
static struct V_505 * F_278 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
...
V_420 -> V_432 . V_516 = 0 ;
V_420 -> V_432 . V_517 = 0 ;
for ( V_154 = 0 , V_93 = V_66 -> V_231 ; V_154 < V_66 -> V_507 ; V_154 ++ , V_93 ++ ) {
V_81 = & V_2 -> V_82 [ V_93 ] ;
...
static int F_279 ( struct V_419 * V_420 , void * V_32 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static void F_280 ( struct V_419 * V_420 , struct V_421 * V_422 ,
...
static void F_281 ( struct V_421 * V_422 , struct V_1 * V_2 ,
int V_381 )
{
...
static void F_282 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
F_280 ( V_420 , V_422 , V_2 , ( V_420 -> V_536 & V_538 ) ) ;
if ( V_259 -> V_2 . V_384 > 1 )
V_381 |= ( V_420 -> V_536 & V_539 ) ;
F_281 ( V_422 , V_2 , V_381 ) ;
if ( V_259 -> V_2 . V_384 > 1 )
return;
if ( ( V_420 -> V_536 & V_539 ) && ! F_283 ( V_420 ) ) {
int V_154 = 0 ;
if ( F_284 ( V_420 ) > V_540 ) {
if ( V_540 != V_2 -> V_379 ) {
V_2 -> V_379 = V_540 ;
++ V_2 -> V_321 ;
F_183 ( V_2 , V_2 -> V_321 ) ;
...
if ( V_154 >= V_540 )
break;
memcpy ( V_2 -> V_380 [ V_154 ++ ] , V_535 -> V_32 , V_280 ) ;
}
V_2 -> V_379 = ( T_4 ) V_154 ;
F_182 ( V_2 ) ;
} else {
...
static int F_286 ( struct V_419 * V_420 , int V_541 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static int F_287 ( struct V_419 * V_420 , struct V_548 * V_549 , int V_550 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
int V_294 ;
int V_551 = 0 ;
struct V_552 * V_20 = F_288 ( V_549 ) ;
if ( F_289 ( & V_422 -> V_553 ) )
return - V_554 ;
V_294 = 0 ;
switch ( V_550 ) {
case V_555 :
...
F_121 ( V_2 , V_66 -> V_229 -> V_560 , V_20 -> V_558 ,
V_20 -> V_565 ) ;
break;
default:
V_551 = - V_566 ;
...
static int F_292 ( struct V_419 * V_420 , int V_556 , int V_558 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
struct V_1 * V_2 = V_66 -> V_2 ;
T_3 V_561 ;
F_120 ( V_2 , V_66 -> V_229 -> V_560 , V_558 << 1 , & V_561 ) ;
return V_561 ;
}
static void F_293 ( struct V_419 * V_420 , int V_556 , int V_558 , int V_185 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
struct V_1 * V_2 = V_66 -> V_2 ;
int V_154 ;
int V_491 ;
for ( V_154 = 0 , V_491 = V_66 -> V_231 ; V_154 < V_66 -> V_232 ; V_154 ++ , V_491 ++ )
F_121 ( V_2 , V_491 , V_558 << 1 , V_185 ) ;
}
static int F_294 ( struct V_419 * V_420 , struct V_567 * V_550 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_295 ( & V_259 -> V_568 ) ;
F_296 ( & V_422 -> V_569 , V_550 ) ;
V_550 -> V_570 |= V_571 ;
F_297 ( & V_259 -> V_568 ) ;
V_422 -> V_570 = V_550 -> V_570 ;
return 0 ;
}
static int F_298 ( struct V_419 * V_420 , struct V_567 * V_550 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
T_2 V_251 = F_299 ( V_550 ) ;
int V_294 ;
...
V_294 = F_300 ( & V_422 -> V_569 , V_550 ) ;
F_297 ( & V_259 -> V_568 ) ;
return V_294 ;
}
static int F_301 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
int V_294 ;
F_295 ( & V_259 -> V_568 ) ;
V_294 = F_302 ( & V_422 -> V_569 ) ;
F_297 ( & V_259 -> V_568 ) ;
return V_294 ;
}
static T_2 F_303 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
int V_294 ;
V_294 = F_304 ( & V_422 -> V_569 ) ;
return V_294 ;
}
static void F_305 ( struct V_419 * V_420 ,
struct V_578 * V_26 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_306 ( V_26 -> V_579 , V_580 , sizeof( V_26 -> V_579 ) ) ;
F_306 ( V_26 -> V_581 , V_582 , sizeof( V_26 -> V_581 ) ) ;
F_306 ( V_26 -> V_583 , F_307 ( V_259 -> V_261 ) ,
sizeof( V_26 -> V_583 ) ) ;
}
static int F_308 ( struct V_419 * V_420 )
{
...
static void F_309 ( struct V_419 * V_420 , struct V_590 * V_591 ,
void * V_592 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static void F_311 ( struct V_419 * V_420 ,
struct V_593 * V_594 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static T_2 F_313 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
return V_422 -> V_600 ;
}
static void F_314 ( struct V_419 * V_420 , T_2 V_97 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
V_422 -> V_600 = V_97 ;
}
...
for ( V_154 = V_603 -> V_89 / 2 ; V_154 < V_33 ; V_154 ++ )
V_605 [ V_154 ] = F_130 ( & V_259 -> V_2 , V_154 ) ;
V_603 -> V_606 = V_607 ;
memcpy ( V_20 , & V_604 [ V_603 -> V_89 ] , V_603 -> V_33 ) ;
return 0 ;
}
static int F_317 ( struct V_419 * V_420 ,
struct V_602 * V_603 , T_4 * V_20 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
for ( V_154 = 0 ; V_154 < V_601 ; V_154 ++ )
if ( V_608 [ V_154 ] != V_605 [ V_154 ] ) {
V_605 [ V_154 ] = V_608 [ V_154 ] ;
F_131 ( & V_259 -> V_2 , V_154 , V_605 [ V_154 ] ) ;
}
return 0 ;
}
static void F_318 ( struct V_419 * V_420 ,
struct V_609 * V_610 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
V_610 -> V_572 = ( V_2 -> V_122 & V_218 ) ? 0 : 1 ;
if ( ! V_2 -> V_104 ) {
V_610 -> V_611 =
( V_2 -> V_209 & V_211 ) ? 1 : 0 ;
V_610 -> V_612 =
...
F_133 ( V_2 , V_610 -> V_611 , V_610 -> V_612 ) ;
}
F_297 ( & V_259 -> V_568 ) ;
return 0 ;
}
static void F_320 ( struct V_419 * V_420 ,
struct V_614 * V_27 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static void F_321 ( struct V_419 * V_420 , T_2 V_619 , T_4 * V_24 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static int F_322 ( struct V_419 * V_420 , int V_623 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
for ( V_154 = 0 , V_93 = V_626 ; V_154 < V_66 -> V_507 - V_626 ; V_154 ++ , V_93 ++ ) {
if ( 0 == V_154 ) {
V_294 = F_325 (
V_259 -> V_85 [ V_93 ] . V_85 ,
2 == V_259 -> V_85 [ V_93 ] . V_627 ,
...
F_213 ( V_2 , V_66 -> V_231 , V_66 -> V_507 , V_85 ) ;
V_626 = V_2 -> V_86 ;
if ( V_626 > V_625 )
V_626 = V_625 ;
V_625 -= V_626 ;
for ( V_154 = 0 ; V_154 < V_626 ; V_154 ++ )
* V_20 ++ = V_85 [ V_154 ] ;
}
static int F_326 ( struct V_419 * V_420 ,
T_9 V_225 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static void F_327 ( struct V_419 * V_420 , struct V_421 * V_422 ,
struct V_203 * V_66 )
{
if ( V_422 -> V_503 != V_66 -> V_229 -> V_162 ) {
V_422 -> V_503 = V_66 -> V_229 -> V_162 ;
if ( F_226 ( V_420 ) )
F_272 ( V_420 , V_243 ) ;
}
}
static void F_328 ( struct V_629 * V_630 )
{
struct V_258 * V_259 =
F_141 ( V_630 , struct V_258 , V_496 ) ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_80 * V_81 ;
int V_154 ;
V_508 = V_393 ;
for ( V_154 = 0 ; V_154 < V_2 -> V_507 ; V_154 ++ ) {
V_81 = & V_2 -> V_82 [ V_154 ] ;
if ( V_81 -> V_84 || 1 == V_259 -> V_85 [ V_154 ] . V_627 ) {
if ( F_31 ( V_2 , V_154 ) )
break;
V_259 -> V_85 [ V_154 ] . V_627 = 0 ;
if ( 0 == V_81 -> V_84 ) {
V_259 -> V_85 [ V_154 ] . V_627 = 2 ;
F_329 (
& V_259 -> V_85 [ V_154 ] . V_85 ) ;
}
} else if ( V_393 >= V_259 -> V_85 [ V_154 ] . time ) {
if ( V_243 == V_81 -> V_162 )
V_259 -> V_85 [ V_154 ] . V_627 = 1 ;
...
static void F_330 ( unsigned long V_592 )
{
...
static void F_331 ( unsigned long V_592 )
{
...
if ( ! ( V_2 -> V_225 & V_488 ) )
F_136 ( V_66 ) ;
F_327 ( V_420 , V_422 , V_66 ) ;
F_194 ( & V_422 -> V_492 ) ;
}
static int T_10 F_332 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_215 ( V_420 ) ;
F_191 ( & V_422 -> V_492 , 500 * V_497 / 1000 ,
F_331 , V_420 ) ;
V_420 -> V_449 = V_497 / 2 ;
...
V_422 -> V_569 . F_292 = F_292 ;
V_422 -> V_569 . F_293 = F_293 ;
V_422 -> V_569 . V_556 = V_422 -> V_66 . V_231 + 1 ;
V_422 -> V_600 = F_334 ( V_600 ,
( V_638 | V_639 | V_640 ) ) ;
return 0 ;
}
static void F_335 ( struct V_419 * V_420 )
{
if ( V_420 -> V_449 )
F_336 ( V_420 ) ;
F_337 ( V_420 ) ;
}
static void F_338 ( struct V_258 * V_259 , T_4 * V_641 , int V_66 )
{
int V_154 ;
int V_373 ;
int V_642 ;
int V_103 ;
V_154 = V_373 = V_103 = V_642 = 0 ;
while ( V_373 < V_280 ) {
if ( V_641 [ V_154 ] ) {
int V_643 ;
V_642 = 1 ;
V_643 = F_339 ( V_641 [ V_154 ] ) ;
if ( V_643 >= 0 )
...
V_20 [ V_154 ] = F_130 ( V_2 , V_154 + V_646 ) ;
...
static int T_11 F_341 ( struct V_260 * V_261 ,
const struct V_647 * V_364 )
{
struct V_419 * V_420 ;
struct V_421 * V_422 ;
struct V_258 * V_259 ;
...
return V_551 ;
V_551 = - V_654 ;
if ( F_343 ( V_261 , F_344 ( 32 ) ) ||
F_345 ( V_261 , F_344 ( 32 ) ) )
return V_551 ;
V_649 = F_346 ( V_261 , 0 ) ;
V_650 = F_347 ( V_261 , 0 ) ;
if ( ( F_348 ( V_261 , 0 ) & V_655 ) != 0 )
return V_551 ;
if ( ! F_349 ( V_649 , V_650 , V_580 ) )
return V_551 ;
F_350 ( V_261 ) ;
V_551 = - V_463 ;
V_26 = F_196 ( sizeof( struct V_648 ) , V_396 ) ;
if ( ! V_26 )
goto V_656;
V_259 = & V_26 -> V_258 ;
V_259 -> V_261 = V_261 ;
V_2 = & V_259 -> V_2 ;
V_2 -> V_4 = F_351 ( V_649 , V_650 ) ;
if ( ! V_2 -> V_4 )
goto V_657;
V_67 = F_154 ( V_2 ) ;
if ( ! V_67 ) {
...
F_352 ( & V_259 -> V_261 -> V_420 , L_11 , V_2 -> V_4 , V_261 -> V_481 ) ;
V_2 -> V_384 = 1 ;
V_652 = 1 ;
V_651 = 1 ;
V_2 -> V_374 = 0 ;
...
V_2 -> V_507 = V_106 ;
V_2 -> V_104 = F_196 ( sizeof( struct V_104 ) , V_396 ) ;
if ( ! V_2 -> V_104 )
goto V_658;
V_21 = V_2 -> V_104 ;
}
...
if ( V_641 [ 0 ] != ':' )
F_338 ( V_259 , V_641 , V_644 ) ;
F_176 ( V_2 ) ;
if ( V_2 -> V_384 > 1 ) {
memcpy ( V_21 -> V_645 , V_2 -> V_281 , V_280 ) ;
F_340 ( V_2 ) ;
if ( V_664 [ 0 ] != ':' )
F_338 ( V_259 , V_664 , V_665 ) ;
}
F_156 ( V_2 ) ;
if ( V_2 -> V_104 )
F_186 ( V_2 ) ;
...
F_356 ( & V_259 -> V_496 , F_328 ) ;
F_191 ( & V_259 -> V_495 , 500 * V_497 / 1000 ,
F_330 , V_259 ) ;
for ( V_154 = 0 ; V_154 < V_2 -> V_384 ; V_154 ++ ) {
V_420 = F_357 ( sizeof( struct V_421 ) ) ;
if ( ! V_420 )
goto V_667;
V_26 -> V_668 [ V_154 ] = V_420 ;
V_422 = F_215 ( V_420 ) ;
V_422 -> V_397 = V_259 ;
V_422 -> V_364 = V_663 ++ ;
V_66 = & V_422 -> V_66 ;
...
for ( V_67 = 0 , V_491 = V_154 ; V_67 < V_652 ; V_67 ++ , V_491 ++ ) {
V_2 -> V_233 [ V_491 ] . V_560 = V_491 ;
V_2 -> V_233 [ V_491 ] . V_261 = V_420 ;
V_2 -> V_233 [ V_491 ] . V_162 = V_244 ;
}
...
if ( ! memcmp ( V_21 -> V_645 , V_2 -> V_281 ,
V_280 ) )
...
for ( V_154 = 0 ; V_154 < V_2 -> V_384 ; V_154 ++ ) {
if ( V_26 -> V_668 [ V_154 ] ) {
F_335 ( V_26 -> V_668 [ V_154 ] ) ;
V_26 -> V_668 [ V_154 ] = NULL ;
}
}
V_662:
F_212 ( V_259 ) ;
...
for ( V_154 = 0 ; V_154 < V_2 -> V_384 ; V_154 ++ ) {
if ( V_26 -> V_668 [ V_154 ] ) {
struct V_419 * V_420 = V_26 -> V_668 [ V_154 ] ;
if ( F_226 ( V_420 ) ) {
F_276 ( V_420 ) ;
F_371 ( V_420 ) ;
}
...
static int F_372 ( struct V_260 * V_261 , T_12 V_162 )
{
int V_154 ;
struct V_648 * V_26 = F_365 ( V_261 ) ;
struct V_258 * V_259 = & V_26 -> V_258 ;
...
static int T_10 F_376 ( void )
{
return F_377 ( & V_674 ) ;
}
static void T_13 F_378 ( void )
{
F_379 ( & V_674 ) ;
}
