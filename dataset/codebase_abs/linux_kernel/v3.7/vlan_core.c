...
T_1 V_4 )
{
struct V_31 * V_31 = F_18 ( V_30 -> V_31 ) ;
if ( V_31 ) {
return F_19 ( & V_31 -> V_32 , V_4 ) ;
} else {
if ( F_20 ( V_30 ) )
return F_17 ( V_30 -> V_33 , V_4 ) ;
}
return NULL ;
}
...
{
F_38 ( F_40 ( V_47 , struct V_31 , V_47 ) ) ;
}
static struct V_31 * F_41 ( struct V_7 * V_11 )
{
struct V_31 * V_31 ;
V_31 = F_42 ( sizeof( struct V_31 ) , V_48 ) ;
if ( ! V_31 )
return NULL ;
V_31 -> V_30 = V_11 ;
F_43 ( & V_31 -> V_49 ) ;
...
static struct V_50 * F_44 ( struct V_31 * V_31 ,
unsigned short V_51 )
{
struct V_50 * V_52 ;
...
static int F_47 ( struct V_31 * V_31 , unsigned short V_51 ,
struct V_50 * * V_53 )
{
struct V_7 * V_11 = V_31 -> V_30 ;
...
static void F_53 ( struct V_31 * V_31 ,
struct V_50 * V_52 )
{
struct V_7 * V_11 = V_31 -> V_30 ;
const struct V_54 * V_55 = V_11 -> V_56 ;
...
if ( ! V_31 )
return false ;
return V_31 -> V_32 . V_71 ? true : false ;
}
