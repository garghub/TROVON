...
if ( V_58 -> V_66 . V_69 )
V_58 -> V_66 . V_69 ( V_58 , 1 ) ;
V_58 -> V_66 . V_67 . V_68 ( V_58 ) ;
if ( V_58 -> V_66 . V_69 )
V_58 -> V_66 . V_69 ( V_58 , 0 ) ;
}
...
static int F_20 ( struct V_57 * V_58 , T_5 * V_92 )
{
struct V_1 * V_2 = V_58 -> V_59 ;
T_2 V_38 = 0 ;
T_2 V_93 = 0 ;
...
static int F_21 ( struct V_57 * V_58 , T_3 * V_100 )
{
struct V_1 * V_2 = V_58 -> V_59 ;
T_3 V_101 ;
T_2 V_28 ;
F_2 ( L_3 , V_19 ) ;
F_5 ( V_2 , 1 ) ;
F_4 ( V_2 , V_102 + 1 , & V_28 ) ;
V_101 = V_28 & 0x7F ;
V_101 <<= 8 ;
F_4 ( V_2 , V_102 , & V_28 ) ;
V_101 |= V_28 ;
F_5 ( V_2 , 0 ) ;
* V_100 = V_101 * 100 / 32767 ;
F_2 ( L_8 , V_19 , * V_100 ) ;
return 0 ;
}
...
F_2 ( L_9 , V_103 ) ;
V_103 = 0x400 - V_103 ;
* signal = V_103 * 0x10000 / 0x400 ;
return 0 ;
}
static int F_23 ( struct V_57 * V_58 , T_1 * V_105 )
{
F_2 ( L_3 , V_19 ) ;
* V_105 = 0 ;
return 0 ;
}
static int F_24 ( struct V_57 * V_58 , T_3 * V_106 )
{
F_2 ( L_3 , V_19 ) ;
* V_106 = 0 ;
return 0 ;
}
static int F_25 ( struct V_57 * V_58 , int V_107 )
{
struct V_1 * V_2 = V_58 -> V_59 ;
return F_1 ( V_2 , V_108 , V_107 ? 1 : 0 ) ;
}
...
return NULL ;
V_2 = F_27 ( sizeof( struct V_1 ) , V_110 ) ;
if ( V_2 == NULL )
goto V_111;
V_2 -> V_15 = V_15 ;
V_2 -> V_20 = V_20 ;
if ( F_4 ( V_2 , V_112 , & V_4 ) != 0 ) {
F_2 ( L_11 ,
V_19 , V_2 -> V_15 -> V_16 ) ;
goto V_111;
}
F_2 ( L_12 , V_4 ) ;
memcpy ( & V_2 -> V_113 . V_66 , & V_114 ,
sizeof( struct V_115 ) ) ;
V_2 -> V_113 . V_59 = V_2 ;
F_13 ( & V_2 -> V_113 ) ;
F_25 ( & V_2 -> V_113 , 1 ) ;
