...
static enum V_12 F_51 ( unsigned long V_43 , T_2 V_59 )
{
enum V_12 V_13 = V_14 ;
unsigned long V_44 , V_45 ;
struct V_1 * V_1 ;
...
void F_64 ( unsigned long V_42 )
{
V_4 . V_22 = V_42 ;
F_32 ( & V_40 , 0 ) ;
}
int F_65 ( int V_43 , struct V_1 * * V_66 , bool V_67 )
{
int V_68 = 0 ;
struct V_1 * V_1 ;
F_29 ( & V_34 ) ;
...
void F_66 ( int V_43 , struct V_1 * * V_66 )
{
int V_45 ;
F_29 ( & V_34 ) ;
for ( V_45 = 0 ; V_45 < V_43 ; V_45 ++ ) {
...
static void T_3 F_67 ( unsigned long V_74 ,
unsigned long V_66 )
{
