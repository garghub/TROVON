...
F_8 ( L_4 , V_15 -> V_53 , V_15 -> V_54 ) ;
F_8 ( L_5 , V_15 -> V_40 , V_15 -> V_41 ) ;
F_8 ( L_6 , V_15 -> V_47 , V_15 -> V_48 ) ;
if ( V_15 -> V_42 )
F_8 ( L_7 , V_15 -> V_44 , V_15 -> V_45 ) ;
return 0 ;
V_52:
F_14 ( L_8 ,
V_23 , V_34 , V_35 , V_38 , V_37 ) ;
...
V_39 = F_89 ( V_15 , (struct V_1 * ) V_15 -> V_18 , 0 , 0 ) ;
if ( V_39 )
return V_39 ;
...
static void F_90 ( const struct V_14 * V_15 , int V_23 )
{
int V_39 , V_35 = V_15 -> V_32 , V_85 , V_81 , V_97 , V_34 ;
void * V_57 , * V_115 ;
F_91 ( L_26 , V_129 -> V_130 , V_23 ) ;
V_57 = V_115 = F_88 ( V_15 -> V_32 , V_116 , V_117 ) ;
if ( ! V_57 ) {
F_14 ( L_27 ) ;
return;
...
F_91 ( L_33 ,
V_23 , V_34 ) ;
V_39 = F_92 ( V_15 , V_115 , & V_3 ) ;
for ( V_4 = 0 ; V_4 < V_6 ; V_4 ++ ) {
F_93 ( L_34 , V_3 . V_8 [ V_4 ] . V_23 ,
V_3 . V_8 [ V_4 ] . V_34 ) ;
if ( V_4 != V_6 - 1 )
F_93 ( L_35 ) ;
}
...
{
int V_4 ;
F_91 ( L_41 , V_129 -> V_130 ) ;
for ( V_4 = 0 ; V_4 < V_15 -> V_29 ; V_4 ++ )
F_90 ( V_15 , V_4 + V_15 -> V_26 ) ;
F_91 ( L_42 , V_129 -> V_130 ) ;
}
