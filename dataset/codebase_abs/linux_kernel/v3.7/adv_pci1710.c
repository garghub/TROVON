...
if ( V_129 -> V_146 != V_129 -> V_147 ) {
V_129 -> V_146 = V_129 -> V_147 ;
V_130 ++ ;
}
...
static const void * F_40 ( struct V_1 * V_2 ,
struct V_161 * V_162 )
{
const struct V_13 * V_14 ;
int V_8 ;
for ( V_8 = 0 ; V_8 < F_41 ( V_163 ) ; V_8 ++ ) {
V_14 = & V_163 [ V_8 ] ;
...
return - V_169 ;
V_2 -> V_170 = V_14 ;
V_2 -> V_171 = V_14 -> V_172 ;
V_166 = F_44 ( V_2 , sizeof( * V_16 ) ) ;
if ( V_166 < 0 )
return V_166 ;
V_16 = V_2 -> V_17 ;
V_166 = F_45 ( V_162 , V_2 -> V_171 ) ;
if ( V_166 )
return V_166 ;
V_2 -> V_23 = F_46 ( V_162 , 2 ) ;
V_168 = 0 ;
if ( V_14 -> V_173 )
V_168 ++ ;
if ( V_14 -> V_154 )
...
if ( V_14 -> V_176 )
V_168 ++ ;
V_166 = F_47 ( V_2 , V_168 ) ;
if ( V_166 )
return V_166 ;
F_39 ( V_2 ) ;
if ( V_14 -> V_177 && V_162 -> V_105 ) {
V_166 = F_48 ( V_162 -> V_105 , F_30 ,
V_178 , V_2 -> V_171 , V_2 ) ;
if ( V_166 == 0 )
...
F_49 ( V_2 -> V_210 , L_12 ,
V_2 -> V_171 , V_2 -> V_105 ? L_13 : L_14 ) ;
return 0 ;
}
static void F_50 ( struct V_1 * V_2 )
{
struct V_161 * V_162 = F_51 ( V_2 ) ;
if ( V_2 -> V_23 )
F_39 ( V_2 ) ;
if ( V_2 -> V_105 )
F_52 ( V_2 -> V_105 , V_2 ) ;
...
static int T_3 F_54 ( struct V_161 * V_2 ,
const struct V_211 * V_212 )
{
return F_55 ( V_2 , & V_213 ) ;
}
static void T_4 F_56 ( struct V_161 * V_2 )
{
F_57 ( V_2 ) ;
}
