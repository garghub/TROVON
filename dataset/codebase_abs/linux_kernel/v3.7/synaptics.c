...
default:
if ( V_86 -> V_78 != - 1 &&
( V_86 -> V_78 == V_118 -> V_78 || V_118 -> V_78 == - 1 ) )
F_63 ( V_101 , 0 , V_78 ) ;
else
F_63 ( V_101 , 0 , NULL ) ;
if ( V_86 -> V_79 != - 1 &&
( V_86 -> V_79 == V_118 -> V_79 || V_118 -> V_79 == - 1 ) )
F_63 ( V_101 , 1 , V_79 ) ;
else
F_63 ( V_101 , 1 , NULL ) ;
break;
...
F_88 ( V_160 , V_101 -> V_154 ) ;
F_88 ( V_161 , V_101 -> V_154 ) ;
} else if ( F_26 ( V_18 -> V_33 ) ) {
F_88 ( V_162 , V_101 -> V_151 ) ;
F_89 ( V_101 , 2 , 0 ) ;
F_83 ( V_101 , V_18 , V_105 ,
V_106 ) ;
}
...
void * V_164 , char * V_61 )
{
struct V_17 * V_18 = V_1 -> V_19 ;
return sprintf ( V_61 , L_15 , V_18 -> V_51 ? '1' : '0' ) ;
}
static T_2 F_92 ( struct V_1 * V_1 ,
void * V_164 , const char * V_61 ,
T_3 V_165 )
{
struct V_17 * V_18 = V_1 -> V_19 ;
unsigned int V_166 ;
int V_167 ;
V_167 = F_93 ( V_61 , 10 , & V_166 ) ;
if ( V_167 )
return V_167 ;
if ( V_166 > 1 )
return - V_168 ;
...
if ( V_172 . V_34 != V_18 -> V_34 ||
V_172 . V_22 != V_18 -> V_22 ||
V_172 . V_31 != V_18 -> V_31 ||
V_172 . V_32 != V_18 -> V_32 ) {
F_30 ( V_1 ,
L_19 ,
V_172 . V_34 , V_18 -> V_34 ,
V_172 . V_22 , V_18 -> V_22 ,
V_172 . V_31 , V_18 -> V_31 ,
V_172 . V_32 , V_18 -> V_32 ) ;
return - 1 ;
...
V_18 -> V_25 , V_18 -> V_28 ) ;
F_87 ( V_1 -> V_101 , V_18 ) ;
V_1 -> V_180 = ( ( V_18 -> V_22 & 0x00ff0000 ) >> 8 ) |
...
if ( ! V_18 -> V_49 && F_95 ( V_18 -> V_34 ) ) {
V_167 = F_108 ( & V_1 -> V_5 . V_56 -> V_101 ,
& V_170 . V_171 ) ;
if ( V_167 ) {
F_30 ( V_1 ,
L_23 ,
