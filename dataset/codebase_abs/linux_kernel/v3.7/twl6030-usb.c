...
static int T_4 F_28 ( struct V_61 * V_62 )
{
T_5 V_6 ;
struct V_1 * V_2 ;
int V_36 , V_63 ;
...
struct V_67 * V_68 = V_7 -> V_69 ;
V_2 = F_29 ( V_7 , sizeof *V_2 , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
V_2 -> V_7 = & V_62 -> V_7 ;
V_2 -> V_55 = F_30 ( V_62 , 0 ) ;
V_2 -> V_54 = F_30 ( V_62 , 1 ) ;
V_2 -> V_28 = V_37 ;
V_2 -> V_9 . V_72 = F_26 ;
V_2 -> V_9 . V_73 = F_6 ;
V_6 = F_31 ( & V_2 -> V_9 ) ;
...
F_34 ( V_62 , V_2 ) ;
if ( F_35 ( & V_62 -> V_7 , & V_77 ) )
F_36 ( & V_62 -> V_7 , L_14 ) ;
F_37 ( & V_2 -> V_57 , F_24 ) ;
V_2 -> V_78 = true ;
V_36 = F_38 ( V_2 -> V_55 , NULL , F_21 ,
V_79 | V_80 | V_81 ,
L_15 , V_2 ) ;
if ( V_36 < 0 ) {
F_3 ( & V_62 -> V_7 , L_16 ,
...
static int T_6 F_41 ( struct V_61 * V_62 )
{
struct V_1 * V_2 = F_42 ( V_62 ) ;
F_43 ( V_82 ,
V_51 ) ;
F_43 ( V_82 ,
V_52 ) ;
