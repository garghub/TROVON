...
struct V_166 * V_167 ;
struct V_168 * V_168 ;
int V_5 = 0 , V_169 , V_170 ;
T_3 V_171 ;
struct V_172 * V_173 ;
enum V_174 V_68 ;
struct V_9 * V_10 ;
V_164 = F_54 ( V_155 , V_175 , 0 ) ;
V_165 = F_54 ( V_155 , V_176 , 0 ) ;
V_169 = F_55 ( V_155 , 0 ) ;
V_170 = F_55 ( V_155 , 1 ) ;
if ( ! V_164 || V_169 < 0 || V_170 < 0 )
return - V_7 ;
...
if ( V_161 ) {
V_10 -> V_180 = (enum V_181 ) V_157 -> V_35 ;
V_5 = F_58 ( V_161 , L_3 ,
& V_10 -> V_151 ) ;
if ( V_5 ) {
F_59 ( F_21 ( V_4 -> V_2 ) ,
...
V_10 -> V_180 = V_155 -> V_182 -> V_183 ;
V_10 -> V_151 = V_165 -> V_184 ;
}
V_4 -> V_2 = V_2 ;
V_4 -> V_28 = 0 ;
V_173 = F_60 ( & V_155 -> V_159 , L_5 ) ;
if ( ! F_61 ( V_173 ) ) {
V_5 = F_62 ( V_173 ) ;
if ( V_5 ) {
F_59 ( & V_155 -> V_159 ,
...
V_168 = F_63 ( & V_155 -> V_159 ) ;
if ( F_61 ( V_168 ) ) {
V_5 = F_64 ( V_168 ) ;
goto V_179;
}
V_10 -> V_185 = F_65 ( & V_155 -> V_159 , NULL ) ;
if ( F_61 ( V_10 -> V_185 ) ) {
V_5 = F_64 ( V_10 -> V_185 ) ;
goto V_179;
}
...
F_67 ( V_171 ) ;
F_68 ( V_186 , V_171 ) ;
V_10 -> V_153 . V_187 = V_170 ;
V_10 -> V_74 = F_69 ( V_171 , F_50 , V_4 ) ;
if ( ! V_10 -> V_74 ) {
F_59 ( F_21 ( V_4 -> V_2 ) ,
L_7 , V_91 ) ;
goto V_188;
...
V_2 -> V_207 = 52 ;
V_2 -> V_208 = 1 << 0xf ;
V_2 -> V_209 = ( F_42 ( V_10 ) ) ? 0xff : 0xffffff ;
V_2 -> V_210 = ( F_42 ( V_10 ) ) ? 0xffff : 0xffffffff ;
V_2 -> V_211 = F_71 ( V_10 -> V_74 -> V_212 -> V_159 ) ;
F_72 ( V_155 , V_2 ) ;
V_5 = F_73 ( & V_155 -> V_159 , V_169 , F_25 , 0 ,
V_213 , V_4 ) ;
if ( V_5 )
goto V_214;
F_74 ( & V_4 -> V_52 ) ;
...
static int F_84 ( struct V_212 * V_159 )
{
...
static int F_87 ( struct V_212 * V_159 )
{
struct V_1 * V_2 = F_85 ( V_159 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_9 * V_10 = & V_4 -> V_10 ;
