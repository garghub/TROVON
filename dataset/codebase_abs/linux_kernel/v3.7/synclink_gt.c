...
{
V_2 -> V_447 = F_174 ( V_2 -> V_77 + 5 , V_361 ) ;
if ( V_2 -> V_447 == NULL )
return - V_245 ;
return 0 ;
}
...
unsigned int V_6 ;
unsigned int V_448 ;
V_2 -> V_262 = F_215 ( V_2 -> V_449 , V_450 , & V_2 -> V_451 ) ;
if ( V_2 -> V_262 == NULL )
return - V_245 ;
...
if ( V_6 == V_2 -> V_14 - 1 )
V_2 -> V_15 [ V_6 ] . V_346 = F_216 ( V_448 ) ;
else
V_2 -> V_15 [ V_6 ] . V_346 = F_216 ( V_448 + ( ( V_6 + 1 ) * sizeof( struct V_261 ) ) ) ;
F_159 ( V_2 -> V_15 [ V_6 ] , V_387 ) ;
}
for ( V_6 = 0 ; V_6 < V_2 -> V_10 ; V_6 ++ ) {
V_2 -> V_11 [ V_6 ] . V_452 = V_448 + ( ( V_2 -> V_14 + V_6 ) * sizeof( struct V_261 ) ) ;
if ( V_6 == V_2 -> V_10 - 1 )
V_2 -> V_11 [ V_6 ] . V_346 = F_216 ( V_448 + V_2 -> V_14 * sizeof( struct V_261 ) ) ;
else
V_2 -> V_11 [ V_6 ] . V_346 = F_216 ( V_448 + ( ( V_2 -> V_14 + V_6 + 1 ) * sizeof( struct V_261 ) ) ) ;
}
return 0 ;
}
...
{
if ( V_2 -> V_262 != NULL ) {
F_218 ( V_2 -> V_449 , V_450 , V_2 -> V_262 , V_2 -> V_451 ) ;
V_2 -> V_262 = NULL ;
V_2 -> V_15 = NULL ;
V_2 -> V_11 = NULL ;
}
}
static int F_219 ( struct V_1 * V_2 , struct V_261 * V_262 , int V_4 )
{
int V_6 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
if ( ( V_262 [ V_6 ] . V_73 = F_215 ( V_2 -> V_449 , V_387 , & V_262 [ V_6 ] . V_453 ) ) == NULL )
return - V_245 ;
V_262 [ V_6 ] . V_454 = F_216 ( ( unsigned int ) V_262 [ V_6 ] . V_453 ) ;
}
return 0 ;
}
static void F_220 ( struct V_1 * V_2 , struct V_261 * V_262 , int V_4 )
{
int V_6 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
if ( V_262 [ V_6 ] . V_73 == NULL )
continue;
F_218 ( V_2 -> V_449 , V_387 , V_262 [ V_6 ] . V_73 , V_262 [ V_6 ] . V_453 ) ;
V_262 [ V_6 ] . V_73 = NULL ;
}
}
...
V_2 -> V_10 = 32 ;
if ( F_214 ( V_2 ) < 0 ||
F_219 ( V_2 , V_2 -> V_15 , V_2 -> V_14 ) < 0 ||
F_219 ( V_2 , V_2 -> V_11 , V_2 -> V_10 ) < 0 ||
F_212 ( V_2 ) < 0 ) {
F_12 ( ( L_142 , V_2 -> V_8 ) ) ;
return - V_245 ;
}
...
{
if ( V_2 -> V_262 ) {
F_220 ( V_2 , V_2 -> V_15 , V_2 -> V_14 ) ;
F_220 ( V_2 , V_2 -> V_11 , V_2 -> V_10 ) ;
F_217 ( V_2 ) ;
}
F_213 ( V_2 ) ;
}
...
{
if ( F_225 ( V_2 -> V_154 , V_248 , L_143 ) == NULL ) {
F_12 ( ( L_144 ,
V_2 -> V_8 , V_2 -> V_154 ) ) ;
V_2 -> V_36 = V_455 ;
goto V_456;
...
V_2 -> V_457 = true ;
V_2 -> V_458 = F_226 ( V_2 -> V_154 , V_248 ) ;
if ( ! V_2 -> V_458 ) {
F_12 ( ( L_145 ,
V_2 -> V_8 , V_2 -> V_154 ) ) ;
V_2 -> V_36 = V_459 ;
...
static struct V_1 * F_232 ( int V_471 , int V_472 , struct V_473 * V_449 )
{
struct V_1 * V_2 ;
V_2 = F_233 ( sizeof( struct V_1 ) , V_361 ) ;
if ( ! V_2 ) {
F_12 ( ( L_153 ,
V_32 , V_471 , V_472 ) ) ;
} else {
...
V_2 -> V_471 = V_471 ;
V_2 -> V_472 = V_472 ;
F_237 ( & V_2 -> V_71 , V_479 , ( unsigned long ) V_2 ) ;
F_237 ( & V_2 -> V_271 , V_480 , ( unsigned long ) V_2 ) ;
V_2 -> V_449 = V_449 ;
V_2 -> V_155 = V_449 -> V_249 ;
V_2 -> V_154 = F_238 ( V_449 , 0 ) ;
V_2 -> V_481 = V_482 ;
V_2 -> V_483 = V_484 ;
V_2 -> V_36 = - 1 ;
}
...
static void F_239 ( int V_471 , struct V_473 * V_449 )
{
struct V_1 * V_353 [ V_485 ] ;
int V_6 ;
int V_352 = 1 ;
...
V_353 [ V_6 ] = F_232 ( V_471 , V_6 , V_449 ) ;
if ( V_353 [ V_6 ] == NULL ) {
for ( -- V_6 ; V_6 >= 0 ; -- V_6 )
F_177 ( V_353 [ V_6 ] ) ;
return;
...
F_236 ( & V_353 [ V_6 ] -> V_54 ) ;
}
if ( ! F_224 ( V_353 [ 0 ] ) ) {
F_221 ( V_353 [ 0 ] ) ;
for ( V_6 = 1 ; V_6 < V_352 ; ++ V_6 ) {
V_353 [ V_6 ] -> V_155 = V_353 [ 0 ] -> V_155 ;
V_353 [ V_6 ] -> V_458 = V_353 [ 0 ] -> V_458 ;
F_221 ( V_353 [ V_6 ] ) ;
}
if ( F_240 ( V_353 [ 0 ] -> V_155 ,
F_172 ,
V_353 [ 0 ] -> V_483 ,
V_353 [ 0 ] -> V_8 ,
V_353 [ 0 ] ) < 0 ) {
...
F_242 ( & V_2 -> V_38 , V_486 , V_2 -> line ,
& V_2 -> V_449 -> V_179 ) ;
}
}
static int T_10 F_243 ( struct V_473 * V_179 ,
...
static void T_11 F_246 ( struct V_473 * V_179 )
{
}
...
F_248 ( V_486 , V_2 -> line ) ;
if ( ( V_148 = F_249 ( V_486 ) ) )
F_12 ( ( L_157 , V_148 ) ) ;
F_250 ( V_486 ) ;
}
V_2 = V_34 ;
...
V_486 -> V_500 = V_501 ;
V_486 -> V_500 . V_59 =
V_502 | V_372 | V_365 | V_364 | V_380 ;
V_486 -> V_500 . V_503 = 9600 ;
V_486 -> V_500 . V_504 = 9600 ;
V_486 -> V_22 = V_505 | V_506 ;
F_255 ( V_486 , & V_25 ) ;
if ( ( V_148 = F_256 ( V_486 ) ) < 0 ) {
F_12 ( ( L_160 , V_32 ) ) ;
F_250 ( V_486 ) ;
V_486 = NULL ;
goto error;
...
static void T_13 F_258 ( void )
{
F_247 () ;
}
static T_1 F_259 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_260 () ;
return F_261 ( ( void V_508 * ) V_458 ) ;
}
static void F_262 ( struct V_1 * V_2 , unsigned int V_507 , T_1 V_174 )
{
F_260 () ;
F_263 ( V_174 , ( void V_508 * ) V_458 ) ;
}
static T_14 F_99 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_260 () ;
return F_264 ( ( void V_508 * ) V_458 ) ;
}
static void F_100 ( struct V_1 * V_2 , unsigned int V_507 , T_14 V_174 )
{
F_260 () ;
F_265 ( V_174 , ( void V_508 * ) V_458 ) ;
}
static T_8 F_165 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_260 () ;
return F_266 ( ( void V_508 * ) V_458 ) ;
}
static void F_166 ( struct V_1 * V_2 , unsigned int V_507 , T_8 V_174 )
{
F_260 () ;
F_267 ( V_174 , ( void V_508 * ) V_458 ) ;
}
...
if ( V_2 -> V_68 . V_69 != V_89 ) {
F_262 ( V_2 , V_509 , 0x49 ) ;
if ( V_2 -> V_68 . V_137 )
F_270 ( V_2 , V_2 -> V_68 . V_137 ) ;
else
F_270 ( V_2 , 3686400 ) ;
}
}
static void F_270 ( struct V_1 * V_2 , T_9 V_510 )
{
unsigned int div ;
unsigned int V_511 = V_2 -> V_147 ;
if ( V_510 ) {
div = V_511 / V_510 ;
if ( ! ( V_511 % V_510 ) && div )
div -- ;
F_100 ( V_2 , V_512 , ( unsigned short ) div ) ;
}
}
...
F_222 ( V_2 ) ;
if ( V_2 -> V_319 ) {
F_100 ( V_2 , V_409 , ( unsigned short ) ( F_99 ( V_2 , V_409 ) & ~ V_513 ) ) ;
F_182 ( V_2 , V_312 ) ;
if ( V_2 -> V_68 . V_69 == V_89 ) {
...
F_100 ( V_2 , V_409 , ( unsigned short ) ( F_99 ( V_2 , V_409 ) | V_513 ) ) ;
F_166 ( V_2 , V_514 , V_2 -> V_15 [ 0 ] . V_452 ) ;
if ( V_2 -> V_68 . V_69 != V_89 ) {
...
F_166 ( V_2 , V_516 , V_2 -> V_11 [ V_2 -> V_336 ] . V_452 ) ;
...
V_338 |= V_267 ;
F_100 ( V_2 , V_389 , V_338 ) ;
F_262 ( V_2 , V_509 , 0x69 ) ;
F_198 ( V_2 ) ;
V_338 = V_316 + V_513 + V_267 ;
if ( ( F_165 ( V_2 , V_520 ) & V_354 ) && V_2 -> V_68 . V_85 &&
( ( V_2 -> V_147 < ( V_2 -> V_68 . V_85 * 16 ) ) ||
( V_2 -> V_147 % ( V_2 -> V_68 . V_85 * 16 ) ) ) ) {
V_338 |= V_288 ;
F_270 ( V_2 , V_2 -> V_68 . V_85 * 8 ) ;
} else {
F_270 ( V_2 , V_2 -> V_68 . V_85 * 16 ) ;
}
...
V_338 |= V_316 + V_521 ;
break;
case V_280 : V_338 |= V_513 + V_521 ; break;
case V_281 : V_338 |= V_316 ; break;
case V_279 : V_338 |= V_521 ; break;
}
if ( V_2 -> V_412 & V_413 )
V_338 |= V_414 ;
switch( V_2 -> V_68 . V_136 )
{
case V_522 : V_338 |= V_315 ; break;
case V_523 : V_338 |= V_524 ; break;
case V_525 : V_338 |= V_524 + V_315 ; break;
case V_187 : V_338 |= V_526 ; break;
case V_189 : V_338 |= V_526 + V_315 ; break;
case V_191 : V_338 |= V_526 + V_524 ; break;
case V_527 : V_338 |= V_526 + V_524 + V_315 ; break;
}
switch ( V_2 -> V_68 . V_139 & V_528 )
{
case V_195 : V_338 |= V_517 ; break;
case V_197 : V_338 |= V_517 + V_354 ; break;
}
if ( V_2 -> V_68 . V_141 != V_529 )
V_338 |= V_177 ;
switch ( V_2 -> V_68 . V_140 )
{
case V_530 : V_338 |= V_333 ; break;
case V_531 : V_338 |= V_334 ; break;
case V_532 : V_338 |= V_333 + V_334 ; break;
}
if ( V_2 -> V_68 . V_22 & V_518 )
V_338 |= V_267 ;
F_100 ( V_2 , V_176 , V_338 ) ;
...
{
case V_533 : V_338 = 0x7e ; break;
case V_534 : V_338 = 0xff ; break;
case V_535 : V_338 = 0x00 ; break;
case V_536 : V_338 = 0x55 ; break;
case V_537 : V_338 = 0xaa ; break;
default: V_338 = 0x7e ; break;
}
F_262 ( V_2 , V_538 , ( unsigned char ) V_338 ) ;
V_338 = 0 ;
switch( V_2 -> V_68 . V_69 ) {
case V_282 :
V_338 |= V_316 + V_521 ;
...
if ( V_2 -> V_68 . V_137 )
V_338 |= V_266 + V_267 ;
F_262 ( V_2 , V_509 , ( unsigned char ) V_338 ) ;
...
F_270 ( V_2 , V_2 -> V_68 . V_137 * 16 ) ;
}
else
F_270 ( V_2 , V_2 -> V_68 . V_137 ) ;
F_190 ( V_2 ) ;
F_198 ( V_2 ) ;
F_100 ( V_2 , V_409 , V_316 + V_513 + V_267 ) ;
if ( V_2 -> V_68 . V_135 )
F_269 ( V_2 ) ;
}
...
{
unsigned char V_338 ;
unsigned short V_539 ;
V_539 = F_99 ( V_2 , V_176 ) ;
if ( V_2 -> V_385 & V_540 ) {
V_539 = ( V_539 & ~ ( V_177 + V_333 ) ) | V_334 ;
F_262 ( V_2 , V_538 , ( unsigned char ) ( ( V_2 -> V_385 >> 8 ) & 0xff ) ) ;
} else if ( ! ( V_539 & V_177 ) ) {
V_539 &= ~ ( V_333 + V_334 ) ;
}
F_100 ( V_2 , V_176 , V_539 ) ;
if ( V_2 -> V_385 & ( V_541 | V_540 ) ) {
V_338 = ( unsigned char ) ( V_2 -> V_385 & 0xff ) ;
} else {
switch( V_2 -> V_385 )
{
case V_478 : V_338 = 0x7e ; break;
case V_542 :
case V_543 : V_338 = 0xaa ; break;
case V_544 :
case V_545 : V_338 = 0x00 ; break;
default: V_338 = 0xff ;
}
}
F_262 ( V_2 , V_546 , V_338 ) ;
}
...
if ( V_2 -> V_412 & V_553 )
V_338 |= V_267 ;
F_262 ( V_2 , V_554 , V_338 ) ;
}
static void F_33 ( struct V_1 * V_2 )
{
unsigned char V_338 = F_259 ( V_2 , V_554 ) ;
if ( V_2 -> V_62 & V_64 )
V_338 |= V_288 ;
else
V_338 &= ~ V_288 ;
...
static void F_140 ( struct V_1 * V_2 , unsigned int V_6 , unsigned int V_555 )
{
int V_556 = 0 ;
while( ! V_556 ) {
V_2 -> V_15 [ V_6 ] . V_12 = 0 ;
...
unsigned long V_22 ;
struct V_20 * V_21 = V_2 -> V_38 . V_21 ;
unsigned char V_558 = 0xff ;
unsigned int V_559 = 0 ;
switch ( V_2 -> V_68 . V_139 & V_528 ) {
case V_195 : V_559 = 2 ; break;
case V_197 : V_559 = 4 ; break;
}
V_560:
V_557 = 0 ;
V_558 = 0xff ;
...
goto V_44;
if ( V_557 == 0 && V_2 -> V_68 . V_138 != 0xff )
V_558 = V_2 -> V_15 [ V_259 ] . V_73 [ 0 ] ;
V_557 += F_136 ( V_2 -> V_15 [ V_259 ] ) ;
if ( F_273 ( V_2 -> V_15 [ V_259 ] ) )
break;
if ( ++ V_259 == V_2 -> V_14 )
V_259 = 0 ;
if ( V_259 == V_2 -> V_13 ) {
...
V_12 = F_274 ( V_2 -> V_15 [ V_259 ] ) ;
if ( ( V_2 -> V_68 . V_139 & V_528 ) == V_193 )
V_12 &= ~ V_266 ;
if ( V_557 == 0 ||
( V_558 != 0xff && V_558 != V_2 -> V_68 . V_138 ) ) {
F_140 ( V_2 , V_258 , V_259 ) ;
goto V_560;
}
if ( V_557 < ( 2 + V_559 ) || V_12 & V_267 ) {
V_2 -> V_117 . V_164 ++ ;
V_557 = 0 ;
} else if ( V_12 & V_266 ) {
V_2 -> V_117 . V_167 ++ ;
if ( ! ( V_2 -> V_68 . V_139 & V_561 ) )
V_557 = 0 ;
}
#if V_303
if ( V_557 == 0 ) {
V_2 -> V_238 -> V_202 . V_562 ++ ;
V_2 -> V_238 -> V_202 . V_563 ++ ;
}
#endif
F_145 ( ( L_164 ,
V_2 -> V_8 , V_12 , V_557 ) ) ;
F_138 ( V_2 , V_2 -> V_15 [ V_258 ] . V_73 , F_45 ( int , V_557 , V_2 -> V_314 ) , L_94 ) ;
if ( V_557 ) {
if ( ! ( V_2 -> V_68 . V_139 & V_561 ) ) {
V_557 -= V_559 ;
V_559 = 0 ;
}
if ( V_557 > V_2 -> V_77 + V_559 )
V_2 -> V_117 . V_165 ++ ;
else {
int V_564 = V_557 ;
int V_6 = V_258 ;
...
V_2 -> V_117 . V_161 ++ ;
while( V_564 ) {
int V_566 = F_45 ( int , V_564 , V_2 -> V_314 ) ;
memcpy ( V_260 , V_2 -> V_15 [ V_6 ] . V_73 , V_566 ) ;
V_260 += V_566 ;
V_564 -= V_566 ;
if ( ++ V_6 == V_2 -> V_14 )
V_6 = 0 ;
...
if ( V_2 -> V_68 . V_139 & V_561 ) {
* V_260 = ( V_12 & V_266 ) ? V_567 : V_568 ;
V_557 ++ ;
}
#if V_303
if ( V_2 -> V_49 )
F_122 ( V_2 , V_2 -> V_447 , V_557 ) ;
else
#endif
F_8 ( V_21 , V_2 -> V_447 , V_2 -> V_569 , V_557 ) ;
}
}
F_140 ( V_2 , V_258 , V_259 ) ;
return true ;
...
static unsigned int F_276 ( struct V_1 * V_2 )
{
unsigned int V_4 = 0 ;
unsigned int V_6 = V_2 -> V_9 ;
do
...
unsigned int V_6 ;
struct V_261 * V_574 ;
if ( F_277 ( V_209 , V_387 ) > F_276 ( V_2 ) )
return false ;
...
static unsigned int V_4 = F_280 ( V_575 ) ;
unsigned int V_6 ;
int V_148 = 0 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
F_100 ( V_2 , V_546 , V_575 [ V_6 ] ) ;
F_100 ( V_2 , V_512 , V_575 [ ( V_6 + 1 ) % V_4 ] ) ;
if ( ( F_99 ( V_2 , V_546 ) != V_575 [ V_6 ] ) ||
( F_99 ( V_2 , V_512 ) != V_575 [ ( V_6 + 1 ) % V_4 ] ) ) {
V_148 = - V_33 ;
break;
}
}
V_2 -> V_357 = ( F_165 ( V_2 , V_520 ) & V_333 ) ? 1 : 0 ;
...
if ( ! ( * ( V_581 + 1 ) & ( V_517 + V_354 ) ) ) {
* V_582 = * V_581 ;
V_582 ++ ;
V_2 -> V_565 ++ ;
}
}
F_138 ( V_2 , V_2 -> V_447 , V_2 -> V_565 , L_94 ) ;
return 1 ;
}
return 0 ;
}
...
V_2 -> V_68 . V_135 = 1 ;
V_2 -> V_38 . V_21 = NULL ;
for ( V_4 = 0 ; V_4 < F_284 ; ++ V_4 )
V_73 [ V_4 ] = ( unsigned char ) V_4 ;
V_2 -> V_565 = 0 ;
memset ( V_2 -> V_447 , 0 , F_284 ) ;
F_17 ( & V_2 -> V_54 , V_22 ) ;
F_181 ( V_2 ) ;
F_148 ( V_2 ) ;
F_41 ( V_2 , V_73 , V_4 ) ;
...
static void V_479 ( unsigned long V_584 )
{
