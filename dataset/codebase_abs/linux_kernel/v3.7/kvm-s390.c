...
F_60 ( & V_53 -> V_37 . V_94 , V_95 , V_96 ) ;
F_61 ( & V_53 -> V_37 . V_97 , V_98 ,
( unsigned long ) V_53 ) ;
V_53 -> V_37 . V_94 . V_99 = V_100 ;
F_62 ( & V_53 -> V_37 . V_101 ) ;
V_53 -> V_37 . V_101 . V_102 = 0xff ;
return 0 ;
}
struct V_52 * F_63 ( struct V_22 * V_22 ,
unsigned int V_103 )
{
struct V_52 * V_53 ;
int V_31 = - V_9 ;
...
goto V_104;
V_31 = - V_36 ;
V_53 = F_64 ( sizeof( struct V_52 ) , V_40 ) ;
if ( ! V_53 )
goto V_104;
...
switch ( V_115 -> V_103 ) {
case V_116 :
V_11 = F_79 ( V_53 -> V_37 . V_59 -> V_84 ,
( V_117 T_1 * ) V_115 -> V_81 ) ;
break;
case V_118 :
V_11 = F_79 ( V_53 -> V_37 . V_59 -> V_119 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
case V_121 :
V_11 = F_79 ( V_53 -> V_37 . V_59 -> V_82 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
case V_122 :
V_11 = F_79 ( V_53 -> V_37 . V_59 -> V_83 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
default:
break;
...
int F_81 ( struct V_52 * V_53 , struct V_123 * V_75 )
{
...
int F_85 ( struct V_52 * V_53 , struct V_128 * V_129 )
{
...
static int F_87 ( struct V_52 * V_53 , T_2 V_131 )
{
int V_31 = 0 ;
...
F_101 ( V_53 ,
F_40 ( & V_53 -> V_37 . V_59 -> V_78 ) ) ;
V_31 = F_102 ( V_53 -> V_37 . V_59 , V_53 -> V_63 -> V_74 . V_75 . V_124 ) ;
if ( V_31 ) {
if ( F_31 ( V_53 -> V_22 ) ) {
V_31 = V_144 ;
} else {
...
F_105 ( V_53 , V_53 -> V_37 . V_59 -> V_143 ) ;
F_98 () ;
F_106 () ;
F_100 () ;
...
int F_107 ( struct V_52 * V_53 , struct V_146 * V_146 )
{
int V_31 ;
T_3 V_147 ;
V_148:
if ( V_53 -> V_149 )
F_108 ( V_150 , & V_53 -> V_151 , & V_147 ) ;
F_55 ( V_87 , & V_53 -> V_37 . V_59 -> V_78 ) ;
F_109 ( V_53 -> V_22 -> V_37 . V_45 . V_111 [ V_53 -> V_54 ] == NULL ) ;
switch ( V_146 -> V_152 ) {
case V_153 :
case V_154 :
case V_155 :
...
if ( V_53 -> V_149 )
F_108 ( V_150 , & V_147 , NULL ) ;
V_53 -> V_172 . V_173 ++ ;
return V_31 ;
}
static int F_113 ( struct V_52 * V_53 , V_120 V_174 , void * V_175 ,
unsigned long V_176 , int V_159 )
{
if ( V_159 )
return F_114 ( V_53 , V_174 , V_175 , V_176 ) ;
else
return F_115 ( V_53 , V_174 , V_175 , V_176 ) ;
}
int F_116 ( struct V_52 * V_53 , unsigned long V_81 )
{
...
if ( F_114 ( V_53 , 163ul , & V_177 , 1 ) )
return - V_29 ;
V_81 = V_179 ;
V_159 = 1 ;
} else
V_159 = 0 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_182 ) ,
V_53 -> V_37 . V_71 . V_130 , 128 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_183 ) ,
V_53 -> V_63 -> V_74 . V_75 . V_124 , 128 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_131 ) ,
& V_53 -> V_37 . V_59 -> V_79 , 16 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_184 ) ,
& V_53 -> V_37 . V_59 -> V_159 , 4 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 ,
V_81 + F_117 ( struct V_181 , V_185 ) ,
& V_53 -> V_37 . V_71 . V_72 , 4 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_186 ) ,
& V_53 -> V_37 . V_59 -> V_84 , 4 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_187 ) ,
& V_53 -> V_37 . V_59 -> V_82 , 8 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_188 ) ,
& V_53 -> V_37 . V_59 -> V_83 , 8 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 , V_81 + F_117 ( struct V_181 , V_189 ) ,
& V_53 -> V_63 -> V_74 . V_75 . V_76 , 64 , V_159 ) )
return - V_29 ;
if ( F_113 ( V_53 ,
V_81 + F_117 ( struct V_181 , V_190 ) ,
& V_53 -> V_37 . V_59 -> V_85 , 128 , V_159 ) )
return - V_29 ;
return 0 ;
}
long F_118 ( struct V_4 * V_5 ,
unsigned int V_6 , unsigned long V_7 )
{
...
V_11 = F_120 ( V_53 -> V_37 . V_49 , V_198 . V_199 ,
...
V_11 = F_121 ( V_53 -> V_37 . V_49 , V_198 . V_200 ,
V_198 . V_201 ) ;
break;
}
#endif
case V_203 : {
V_11 = F_122 ( V_7 , V_53 -> V_37 . V_49 ) ;
if ( ! F_123 ( V_11 ) )
V_11 = 0 ;
break;
}
...
int F_124 ( struct V_52 * V_53 , struct V_204 * V_205 )
{
#ifdef F_11
if ( ( V_205 -> V_206 == V_207 )
&& ( F_31 ( V_53 -> V_22 ) ) ) {
V_205 -> V_208 = F_125 ( V_53 -> V_37 . V_59 ) ;
F_126 ( V_205 -> V_208 ) ;
return 0 ;
}
#endif
...
void F_127 ( struct V_210 * free ,
struct V_210 * V_211 )
{
}
int F_128 ( struct V_210 * V_212 , unsigned long V_213 )
{
return 0 ;
}
int F_129 ( struct V_22 * V_22 ,
struct V_210 * V_214 ,
struct V_210 V_215 ,
struct V_216 * V_217 ,
int V_218 )
...
void F_130 ( struct V_22 * V_22 ,
struct V_216 * V_217 ,
struct V_210 V_215 ,
int V_218 )
{
int V_31 ;
V_31 = F_120 ( V_22 -> V_37 . V_49 , V_217 -> V_220 ,
...
{
int V_223 ;
V_223 = F_135 ( NULL , sizeof( struct V_52 ) , 0 , V_224 ) ;
if ( V_223 )
return V_223 ;
