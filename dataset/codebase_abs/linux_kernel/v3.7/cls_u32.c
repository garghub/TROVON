...
static int F_44 ( struct V_7 * V_97 ,
struct V_9 * V_10 , unsigned long V_83 , T_4 V_65 ,
struct V_84 * * V_98 ,
unsigned long * V_80 )
{
struct V_63 * V_64 = V_10 -> V_41 ;
...
struct V_13 * V_21 ;
struct V_2 * V_99 ;
struct V_84 * V_100 = V_98 [ V_101 ] ;
struct V_84 * V_85 [ V_102 + 1 ] ;
T_4 V_103 ;
int V_87 ;
if ( V_100 == NULL )
return V_65 ? - V_81 : 0 ;
V_87 = F_45 ( V_85 , V_102 , V_100 , V_104 ) ;
if ( V_87 < 0 )
return V_87 ;
...
if ( F_19 ( V_21 -> V_65 ) == 0 )
return - V_81 ;
return F_38 ( V_10 , V_83 , V_21 -> V_62 , V_21 , V_85 , V_98 [ V_105 ] ) ;
}
if ( V_85 [ V_106 ] ) {
unsigned int V_54 = F_40 ( V_85 [ V_106 ] ) ;
if ( -- V_54 > 0x100 )
return - V_81 ;
if ( F_19 ( V_65 ) )
return - V_81 ;
...
if ( V_85 [ V_108 ] ) {
V_103 = F_40 ( V_85 [ V_108 ] ) ;
if ( F_18 ( V_103 ) == V_67 ) {
V_19 = V_10 -> V_20 ;
V_103 = V_19 -> V_65 ;
} else {
V_19 = F_14 ( V_10 -> V_41 , F_18 ( V_103 ) ) ;
if ( V_19 == NULL )
return - V_81 ;
}
} else {
...
if ( V_19 -> V_54 < F_16 ( V_103 ) )
return - V_81 ;
if ( V_65 ) {
if ( F_18 ( V_65 ) && F_18 ( V_65 ^ V_103 ) )
return - V_81 ;
V_65 = V_103 | F_37 ( V_65 ) ;
} else
V_65 = F_36 ( V_19 , V_103 ) ;
if ( V_85 [ V_109 ] == NULL )
return - V_81 ;
V_99 = F_46 ( V_85 [ V_109 ] ) ;
V_21 = F_23 ( sizeof( * V_21 ) + V_99 -> V_38 * sizeof( struct V_29 ) , V_73 ) ;
if ( V_21 == NULL )
return - V_74 ;
#ifdef F_5
V_21 -> V_31 = F_23 ( sizeof( struct V_110 ) + V_99 -> V_38 * sizeof( V_111 ) , V_73 ) ;
if ( V_21 -> V_31 == NULL ) {
F_24 ( V_21 ) ;
return - V_74 ;
}
#endif
memcpy ( & V_21 -> V_3 , V_99 , sizeof( * V_99 ) + V_99 -> V_38 * sizeof( struct V_29 ) ) ;
V_21 -> V_62 = V_19 ;
V_21 -> V_65 = V_65 ;
V_21 -> V_4 = V_99 -> V_6 ? F_47 ( F_2 ( V_99 -> V_6 ) ) - 1 : 0 ;
#ifdef F_6
if ( V_85 [ V_112 ] ) {
struct V_113 * V_33 ;
V_33 = F_46 ( V_85 [ V_112 ] ) ;
memcpy ( & V_21 -> V_33 , V_33 , sizeof( struct V_113 ) ) ;
V_21 -> V_33 . V_37 = 0 ;
}
#endif
V_87 = F_38 ( V_10 , V_83 , V_19 , V_21 , V_85 , V_98 [ V_105 ] ) ;
if ( V_87 == 0 ) {
struct V_13 * * V_114 ;
for ( V_114 = & V_19 -> V_19 [ F_16 ( V_65 ) ] ; * V_114 ; V_114 = & ( * V_114 ) -> V_36 )
if ( F_37 ( V_65 ) < F_37 ( ( * V_114 ) -> V_65 ) )
break;
V_21 -> V_36 = * V_114 ;
F_29 ( V_10 ) ;
* V_114 = V_21 ;
...
static void F_48 ( struct V_9 * V_10 , struct V_115 * V_80 )
{
struct V_63 * V_64 = V_10 -> V_41 ;
struct V_18 * V_19 ;
struct V_13 * V_21 ;
...
continue;
if ( V_80 -> V_117 >= V_80 -> V_118 ) {
if ( V_80 -> V_119 ( V_10 , ( unsigned long ) V_19 , V_80 ) < 0 ) {
V_80 -> V_116 = 1 ;
return;
}
}
...
if ( V_80 -> V_119 ( V_10 , ( unsigned long ) V_21 , V_80 ) < 0 ) {
V_80 -> V_116 = 1 ;
return;
}
V_80 -> V_117 ++ ;
...
static int F_49 ( struct V_9 * V_10 , unsigned long V_120 ,
struct V_7 * V_8 , struct V_121 * V_122 )
{
struct V_13 * V_21 = (struct V_13 * ) V_120 ;
struct V_84 * V_123 ;
if ( V_21 == NULL )
return V_8 -> V_61 ;
V_122 -> V_124 = V_21 -> V_65 ;
V_123 = F_50 ( V_8 , V_101 ) ;
if ( V_123 == NULL )
goto V_125;
if ( F_19 ( V_21 -> V_65 ) == 0 ) {
struct V_18 * V_19 = (struct V_18 * ) V_120 ;
T_4 V_54 = V_19 -> V_54 + 1 ;
if ( F_51 ( V_8 , V_106 , V_54 ) )
goto V_125;
} else {
if ( F_52 ( V_8 , V_109 ,
...
goto V_125;
if ( V_21 -> V_62 ) {
T_4 V_103 = V_21 -> V_65 & 0xFFFFF000 ;
if ( F_51 ( V_8 , V_108 , V_103 ) )
goto V_125;
}
if ( V_21 -> V_12 . V_95 &&
...
F_52 ( V_8 , V_112 , sizeof( V_21 -> V_33 ) , & V_21 -> V_33 ) )
goto V_125;
#endif
...
#ifdef F_5
if ( F_52 ( V_8 , V_126 ,
sizeof( struct V_110 ) + V_21 -> V_3 . V_38 * sizeof( V_111 ) ,
V_21 -> V_31 ) )
goto V_125;
#endif
}
