...
static const char T_4 * F_64 ( struct V_1 * V_2 )
{
switch ( V_2 -> V_107 ) {
...
int T_4 F_65 ( struct V_116 * V_117 ,
...
int T_4 F_71 ( struct V_1 * V_2 , int V_114 , struct V_124 * * V_125 )
{
int error ;
struct V_124 * V_103 ;
...
int T_4 F_76 ( struct V_1 * V_2 , int V_114 , struct V_89 * * V_133 )
{
struct V_89 * V_86 ;
struct V_134 V_135 ;
int error ;
...
V_146 -> type = V_148 ;
V_146 -> V_149 = 2 ;
V_146 -> V_9 . V_150 . V_151 = 7 ;
if ( V_146 -> V_9 . V_150 . V_152 > 6 )
V_146 -> V_9 . V_150 . V_152 = 6 ;
strcpy ( V_146 -> V_9 . V_150 . V_131 , V_147 [ V_146 -> V_9 . V_150 . V_152 ] ) ;
return 0 ;
}
static int F_79 ( struct V_143 * V_144 , struct V_153 * V_154 )
{
struct V_1 * V_2 = F_80 ( V_144 ) ;
unsigned long V_28 ;
unsigned short V_155 ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_155 = F_10 ( V_2 , V_156 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
V_154 -> V_9 . V_150 . V_152 [ 0 ] = ( V_155 >> 12 ) & 7 ;
V_154 -> V_9 . V_150 . V_152 [ 1 ] = ( V_155 >> 4 ) & 7 ;
return 0 ;
}
static int F_81 ( struct V_143 * V_144 , struct V_153 * V_154 )
{
struct V_1 * V_2 = F_80 ( V_144 ) ;
unsigned long V_28 ;
unsigned short V_155 ;
int V_157 ;
if ( V_154 -> V_9 . V_150 . V_152 [ 0 ] > 6 ||
V_154 -> V_9 . V_150 . V_152 [ 1 ] > 6 )
return - V_53 ;
V_155 = ( V_154 -> V_9 . V_150 . V_152 [ 0 ] << 12 ) |
( V_154 -> V_9 . V_150 . V_152 [ 1 ] << 4 ) ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_157 = F_10 ( V_2 , V_156 ) != V_155 ;
F_11 ( V_2 , V_156 , V_155 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
return V_157 ;
}
static int F_82 ( struct V_143 * V_144 , struct V_145 * V_146 )
{
int V_10 = ( V_144 -> V_158 >> 16 ) & 0xff ;
V_146 -> type = V_10 == 1 ? V_159 : V_160 ;
V_146 -> V_149 = 1 ;
V_146 -> V_9 . integer . V_161 = 0 ;
V_146 -> V_9 . integer . V_162 = V_10 ;
return 0 ;
}
static int F_83 ( struct V_143 * V_144 , struct V_153 * V_154 )
{
struct V_1 * V_2 = F_80 ( V_144 ) ;
unsigned long V_28 ;
int V_8 = V_144 -> V_158 & 0xff ;
int V_163 = ( V_144 -> V_158 >> 8 ) & 0xff ;
int V_10 = ( V_144 -> V_158 >> 16 ) & 0xff ;
int V_164 = ( V_144 -> V_158 >> 24 ) & 0xff ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_154 -> V_9 . integer . V_9 [ 0 ] = ( F_10 ( V_2 , V_8 ) >> V_163 ) & V_10 ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
if ( V_164 )
V_154 -> V_9 . integer . V_9 [ 0 ] = V_10 - V_154 -> V_9 . integer . V_9 [ 0 ] ;
return 0 ;
}
static int F_84 ( struct V_143 * V_144 , struct V_153 * V_154 )
{
struct V_1 * V_2 = F_80 ( V_144 ) ;
unsigned long V_28 ;
int V_8 = V_144 -> V_158 & 0xff ;
...
int V_164 = ( V_144 -> V_158 >> 24 ) & 0xff ;
int V_157 ;
unsigned short V_165 , V_155 ;
V_155 = ( V_154 -> V_9 . integer . V_9 [ 0 ] & V_10 ) ;
if ( V_164 )
V_155 = V_10 - V_155 ;
V_155 <<= V_163 ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_165 = F_10 ( V_2 , V_8 ) ;
V_155 = ( V_165 & ~ ( V_10 << V_163 ) ) | V_155 ;
V_157 = V_155 != V_165 ;
F_11 ( V_2 , V_8 , V_155 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
return V_157 ;
}
static int F_85 ( struct V_143 * V_144 , struct V_145 * V_146 )
{
int V_10 = ( V_144 -> V_158 >> 16 ) & 0xff ;
V_146 -> type = V_10 == 1 ? V_159 : V_160 ;
V_146 -> V_149 = 2 ;
...
static int F_86 ( struct V_143 * V_144 , struct V_153 * V_154 )
{
struct V_1 * V_2 = F_80 ( V_144 ) ;
unsigned long V_28 ;
int V_8 = V_144 -> V_158 & 0xff ;
int V_166 = ( V_144 -> V_158 >> 8 ) & 0x0f ;
int V_167 = ( V_144 -> V_158 >> 12 ) & 0x0f ;
int V_10 = ( V_144 -> V_158 >> 16 ) & 0xff ;
int V_164 = ( V_144 -> V_158 >> 24 ) & 0xff ;
unsigned short V_155 ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_155 = F_10 ( V_2 , V_8 ) ;
V_154 -> V_9 . integer . V_9 [ 0 ] = ( V_155 >> V_166 ) & V_10 ;
V_154 -> V_9 . integer . V_9 [ 1 ] = ( V_155 >> V_167 ) & V_10 ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
if ( V_164 ) {
V_154 -> V_9 . integer . V_9 [ 0 ] = V_10 - V_154 -> V_9 . integer . V_9 [ 0 ] ;
V_154 -> V_9 . integer . V_9 [ 1 ] = V_10 - V_154 -> V_9 . integer . V_9 [ 1 ] ;
}
return 0 ;
}
static int F_87 ( struct V_143 * V_144 , struct V_153 * V_154 )
{
struct V_1 * V_2 = F_80 ( V_144 ) ;
unsigned long V_28 ;
int V_8 = V_144 -> V_158 & 0xff ;
...
int V_164 = ( V_144 -> V_158 >> 24 ) & 0xff ;
int V_157 ;
unsigned short V_165 , V_168 , V_169 ;
V_168 = V_154 -> V_9 . integer . V_9 [ 0 ] & V_10 ;
V_169 = V_154 -> V_9 . integer . V_9 [ 1 ] & V_10 ;
if ( V_164 ) {
V_168 = V_10 - V_168 ;
V_169 = V_10 - V_169 ;
}
...
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_165 = F_10 ( V_2 , V_8 ) ;
V_168 = ( V_165 & ~ ( ( V_10 << V_166 ) | ( V_10 << V_167 ) ) ) | V_168 | V_169 ;
V_157 = V_168 != V_165 ;
F_11 ( V_2 , V_8 , V_168 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
return V_157 ;
}
int T_4 F_88 ( struct V_1 * V_2 )
{
struct V_116 * V_117 ;
unsigned int V_170 ;
int V_171 ;
...
return - V_53 ;
V_117 = V_2 -> V_117 ;
strcpy ( V_117 -> V_172 , F_64 ( V_2 ) ) ;
for ( V_170 = 0 ; V_170 < F_89 ( V_173 ) ; V_170 ++ ) {
if ( ( V_171 = F_90 ( V_117 , F_91 ( & V_173 [ V_170 ] , V_2 ) ) ) < 0 )
return V_171 ;
}
return 0 ;
}
