...
F_64 ( & V_12 -> V_106 ) ;
F_86 ( & V_12 -> V_107 , 0 ) ;
F_58 ( & V_12 -> V_108 , V_109 ) ;
F_58 ( & V_12 -> V_110 , V_111 ) ;
F_58 ( & V_12 -> V_16 , V_112 ) ;
V_12 -> V_10 = V_10 ;
V_12 -> V_103 = V_103 ;
V_12 -> V_5 = V_5 ;
V_12 -> V_113 = V_114 ;
V_12 -> V_17 . V_115 = & V_10 -> V_7 -> V_17 ;
V_12 -> V_17 . V_116 = F_83 ;
if ( F_87 ( & V_12 -> V_17 , L_11 , ( unsigned long long ) V_5 ) ) {
F_17 ( V_12 ) ;
goto V_24;
}
V_25 = - V_117 ;
...
goto V_119;
F_89 ( & V_10 -> V_42 ) ;
F_90 ( & V_12 -> V_80 , & V_10 -> V_78 ) ;
F_91 ( & V_10 -> V_42 ) ;
F_92 ( V_102 | V_120 , & V_12 -> V_102 ) ;
return V_12 ;
V_119:
F_82 ( & V_12 -> V_17 ) ;
V_24:
...
void F_93 ( struct V_121 * V_122 , int V_123 )
{
int V_124 ;
for ( V_124 = 0 ; V_124 < V_123 ; V_124 ++ , V_122 ++ )
if ( V_122 )
F_94 ( ( unsigned long ) F_95 ( V_122 ) ) ;
else
break;
}
int F_96 ( struct V_121 * V_122 , int V_123 )
{
void * V_125 ;
int V_124 ;
F_97 ( V_122 , V_123 ) ;
for ( V_124 = 0 ; V_124 < V_123 ; V_124 ++ , V_122 ++ ) {
V_125 = ( void * ) F_98 ( V_23 ) ;
if ( ! V_125 ) {
F_93 ( V_122 , V_124 ) ;
return - V_26 ;
}
F_99 ( V_122 , V_125 , V_53 ) ;
}
return 0 ;
}
