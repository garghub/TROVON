...
static int T_1 F_34 ( struct V_30 * V_87 ,
unsigned short V_76 )
{
...
static void T_1 F_43 ( struct V_73 * V_74 ,
struct V_30 * V_31 )
{
struct V_106 * V_107 ;
...
static int T_1 F_46 ( struct V_30 * V_87 )
{
unsigned char V_114 ;
unsigned char V_115 ;
unsigned char V_116 ;
...
static int T_1 F_49 ( struct V_30 * V_87 )
{
unsigned char V_19 ;
...
static int T_1 F_52 ( struct V_73 * V_74 ,
struct V_30 * V_87 )
{
int V_20 , V_75 ;
...
static int T_1 F_56 ( struct V_73 * V_74 )
{
int error ;
struct V_30 * V_31 = V_74 -> V_110 ;
struct V_132 * V_133 ;
...
static int T_1 F_64 ( struct V_153 * V_154 , unsigned int V_155 )
{
#ifdef F_36
if ( V_156 )
return 0 ;
...
static int T_1 F_65 ( struct V_153 * V_154 , unsigned int V_155 )
{
...
static int T_2 F_73 ( struct V_153 * V_154 ,
unsigned int V_168 )
{
F_67 ( F_74 ( V_154 ) ) ;
F_72 ( V_154 , NULL ) ;
...
static int T_1 F_75 ( struct V_30 * V_87 ,
struct V_169 * V_74 ,
...
static int T_1 F_82 ( struct V_169 * V_177 ,
const struct V_170 * V_171 )
{
struct V_73 * V_74 ;
int V_75 ;
...
static void T_2 F_84 ( struct V_169 * V_177 )
{
F_67 ( F_85 ( V_177 ) ) ;
F_83 ( V_177 , NULL ) ;
V_156 = 0 ;
