...
static int F_29 ( struct V_60 * V_21 )
{
if ( ! F_30 ( V_61 , & ( V_21 -> V_62 ) ) )
return 0 ;
F_26 ( V_21 ) ;
return 0 ;
}
...
V_27 . V_72 = 0 ;
V_27 . V_4 = V_18 -> V_4 ;
V_63 = F_18 ( V_36 + V_18 -> V_4 + 1 , V_32 ) ;
if ( ! V_63 )
return - V_73 ;
F_32 ( V_63 , V_36 ) ;
F_33 ( V_18 , F_19 ( V_63 , V_18 -> V_4 ) , V_18 -> V_4 ) ;
if ( V_18 -> V_4 & 0x0001 )
* F_19 ( V_63 , 1 ) = 0 ;
memcpy ( F_34 ( V_63 , V_36 ) , & V_27 , V_36 ) ;
F_35 ( & ( V_9 -> V_19 ) , V_63 ) ;
F_4 ( V_9 ) ;
F_12 ( V_18 ) ;
return 0 ;
}
static int F_36 ( struct V_60 * V_21 , unsigned int V_74 , unsigned long V_75 )
{
return - V_76 ;
}
...
F_3 ( 0 , V_1 + V_85 ) ;
F_3 ( V_86 , V_1 + V_87 ) ;
F_3 ( ( V_88 | V_89 | V_90 ) , V_1 + V_84 ) ;
V_9 -> V_58 = F_2 ( V_9 -> V_14 -> V_15 [ 0 ] -> V_16 + V_57 )
& V_59 ;
F_3 ( V_91 | V_92 | V_93 , V_1 + V_85 ) ;
F_44 ( & ( V_9 -> V_50 ) , V_62 ) ;
F_45 ( 2000 ) ;
if ( F_46 ( V_21 ) < 0 ) {
F_5 ( L_11 ) ;
...
{
T_2 * V_9 ;
V_9 = F_51 ( & V_95 -> V_41 , sizeof( * V_9 ) , V_96 ) ;
if ( ! V_9 )
return - V_73 ;
V_9 -> V_14 = V_95 ;
V_95 -> V_97 = V_9 ;
...
static int F_55 ( struct V_94 * V_14 , void * V_101 )
{
if ( ( V_14 -> V_15 [ 1 ] -> V_102 ) || ( V_14 -> V_15 [ 1 ] -> V_102 < 8 ) )
return - V_64 ;
V_14 -> V_15 [ 0 ] -> V_62 &= ~ V_103 ;
V_14 -> V_15 [ 0 ] -> V_62 |= V_104 ;
return F_56 ( V_14 ) ;
}
static int F_52 ( struct V_94 * V_95 )
{
T_2 * V_9 = V_95 -> V_97 ;
int V_105 ;
V_95 -> V_15 [ 0 ] -> V_102 = 8 ;
V_105 = F_57 ( V_95 , F_55 , NULL ) ;
if ( V_105 )
goto V_106;
V_105 = F_58 ( V_95 , F_22 ) ;
if ( V_105 )
goto V_106;
V_105 = F_59 ( V_95 ) ;
if ( V_105 )
