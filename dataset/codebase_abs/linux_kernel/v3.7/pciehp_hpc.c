...
{
struct V_66 * V_66 ;
V_66 = F_72 ( sizeof( * V_66 ) , V_96 ) ;
if ( ! V_66 )
return - V_97 ;
V_66 -> V_2 = V_2 ;
F_73 ( & V_66 -> V_98 ) ;
F_74 ( & V_66 -> V_99 , V_100 ) ;
V_2 -> V_66 = V_66 ;
return 0 ;
}
...
F_80 ( V_2 , L_34 ) ;
F_80 ( V_2 , L_35 ,
F_81 ( V_104 ) , V_104 -> V_18 ) ;
F_80 ( V_2 , L_36 , V_104 -> V_105 ) ;
F_80 ( V_2 , L_37 , V_104 -> V_106 ) ;
F_80 ( V_2 , L_38 ,
V_104 -> V_107 ) ;
F_80 ( V_2 , L_39 ,
V_104 -> V_108 ) ;
...
continue;
F_80 ( V_2 , L_41 ,
V_102 , & V_104 -> V_110 [ V_102 ] ) ;
}
F_80 ( V_2 , L_42 , V_2 -> V_111 ) ;
F_80 ( V_2 , L_43 , F_83 ( V_2 ) ) ;
F_80 ( V_2 , L_44 ,
F_65 ( V_2 ) ? L_45 : L_46 ) ;
F_80 ( V_2 , L_47 ,
F_84 ( V_2 ) ? L_45 : L_46 ) ;
...
struct V_1 * F_89 ( struct V_112 * V_6 )
{
struct V_1 * V_2 ;
T_2 V_111 , V_113 ;
struct V_5 * V_104 = V_6 -> V_8 ;
V_2 = F_72 ( sizeof( * V_2 ) , V_96 ) ;
if ( ! V_2 ) {
F_90 ( & V_6 -> V_106 , L_56 , V_36 ) ;
goto abort;
}
V_2 -> V_7 = V_6 ;
if ( F_3 ( V_2 , V_114 , & V_111 ) ) {
F_16 ( V_2 , L_57 ) ;
goto V_115;
}
V_2 -> V_111 = V_111 ;
...
F_79 ( V_2 ) ;
if ( F_28 ( V_2 ) ||
! ( F_84 ( V_2 ) | F_85 ( V_2 ) | F_86 ( V_2 ) | F_88 ( V_2 ) ) )
V_2 -> V_38 = 1 ;
if ( F_3 ( V_2 , V_116 , & V_113 ) ) {
F_16 ( V_2 , L_58 , V_36 ) ;
goto V_115;
}
if ( V_113 & V_117 ) {
...
F_67 ( V_2 ) ;
F_80 ( V_2 , L_60 ,
V_104 -> V_105 , V_104 -> V_106 , V_104 -> V_108 ,
V_104 -> V_107 ) ;
if ( F_71 ( V_2 ) )
goto V_115;
return V_2 ;
