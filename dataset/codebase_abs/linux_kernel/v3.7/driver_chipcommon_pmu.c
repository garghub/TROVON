...
static T_1 F_19 ( struct V_1 * V_2 , T_1 V_54 , T_1 V_55 )
{
T_1 V_56 , div , V_57 , V_58 , V_59 , V_60 ;
struct V_13 * V_14 = V_2 -> V_15 -> V_14 ;
F_20 ( ( V_54 & 3 ) || ( V_54 > V_61 ) ) ;
F_20 ( ! V_55 || V_55 > 4 ) ;
...
V_57 = ( V_56 & V_72 ) >> V_73 ;
V_60 = F_17 ( V_2 ) / 1000000 ;
V_60 = ( V_58 * V_57 * V_60 ) / V_59 ;
return ( V_60 / div ) * 1000000 ;
}
static T_1 F_21 ( struct V_1 * V_2 , T_1 V_54 , T_1 V_55 )
{
...
case V_46 :
case V_47 :
return F_19 ( V_2 , V_61 ,
V_84 ) ;
case V_51 :
return F_19 ( V_2 , V_85 ,
V_84 ) ;
case V_48 :
case V_49 :
return F_19 ( V_2 , V_86 ,
V_84 ) ;
case V_52 :
return F_21 ( V_2 , V_87 ,
V_84 ) ;
case V_50 :
return 75000000 ;
default:
...
void F_25 ( struct V_1 * V_2 , int V_91 )
{
T_1 V_56 = 0 ;
T_2 V_92 = 0 ;
