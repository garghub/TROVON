...
F_24 ( V_52 , 2 , L_210 ) ;
F_27 ( V_52 , 2 , L_211 , ( T_1 ) V_123 -> V_126 . V_451 ) ;
F_27 ( V_52 , 2 , L_211 , ( T_1 ) V_123 -> V_126 . V_452 ) ;
return 0 ;
}
...
F_269 ( V_2 , V_66 -> V_66 , V_517 , L_224 ) ;
if ( ! V_517 )
return V_518 ;
if ( ( V_75 >= 15 ) && ( V_75 <= 31 ) )
return V_519 ;
...
if ( V_26 == - V_535 )
return;
F_11 ( V_104 -> V_2 , 2 , L_229 ) ;
F_35 ( V_104 -> V_2 , 2 , L_230 , V_104 -> V_420 ) ;
F_35 ( V_104 -> V_2 , 2 , L_231 , V_153 ) ;
F_35 ( V_104 -> V_2 , 2 , L_232 , V_151 ) ;
...
if ( ! F_47 ( V_2 , V_104 ) )
goto V_60;
F_35 ( V_2 , 5 , L_233 , V_546 ) ;
F_35 ( V_2 , 5 , L_234 , V_151 ) ;
F_35 ( V_2 , 5 , L_235 , V_517 ) ;
if ( V_517 ) {
F_282 ( V_2 -> V_73 ) ;
F_55 ( V_2 ) ;
goto V_60;
...
{
struct V_1 * V_2 = (struct V_1 * ) V_541 ;
F_35 ( V_2 , 2 , L_238 , V_104 ) ;
F_35 ( V_2 , 2 , L_239 , V_517 ) ;
if ( F_47 ( V_2 , V_104 ) )
...
F_35 ( V_104 -> V_2 , 5 , L_242 , V_86 ) ;
F_11 ( V_104 -> V_2 , 5 , L_243 ) ;
...
if ( ! V_104 -> V_439 ) {
F_11 ( V_104 -> V_2 , 6 , L_248 ) ;
F_43 ( & V_217 -> V_44 , V_100 ) ;
V_537 = 1 ;
} else {
F_11 ( V_104 -> V_2 , 6 , L_249 ) ;
if ( V_104 -> V_2 -> V_49 . V_266 )
...
if ( V_123 -> V_126 . V_132 ) {
F_35 ( V_2 , 4 , L_251 , V_123 -> V_126 . V_132 ) ;
...
if ( V_123 -> V_126 . V_132 ) {
F_35 ( V_2 , 4 , L_279 , V_123 -> V_126 . V_132 ) ;
return 0 ;
}
if ( V_123 -> V_110 . V_457 . V_126 . V_132 ) {
V_123 -> V_126 . V_132 =
V_123 -> V_110 . V_457 . V_126 . V_132 ;
F_35 ( V_2 , 4 , L_280 , V_123 -> V_126 . V_132 ) ;
return 0 ;
}
...
if ( V_26 )
F_27 ( V_52 , 2 , L_183 , V_26 ) ;
F_27 ( V_52 , 2 , L_293 , V_2 -> V_714 . V_715 ) ;
F_27 ( V_52 , 2 , L_294 , V_2 -> V_714 . V_716 ) ;
F_27 ( V_52 , 2 , L_294 , V_2 -> V_714 . V_717 ) ;
F_27 ( V_52 , 2 , L_295 , V_2 -> V_714 . V_718 ) ;
...
case V_51 :
F_72 ( & V_2 -> V_72 -> V_73 , L_298 ) ;
break;
case V_271 :
F_72 ( & V_2 -> V_72 -> V_73 , L_299 ) ;
break;
default:
break;
}
...
static inline int F_351 ( struct V_434 * V_749 ,
struct V_750 * V_231 ,
...
F_352 ( * V_751 , V_436 ) ;
if ( V_571 <= V_435 ) {
memcpy ( F_353 ( * V_751 , V_571 ) , V_231 -> V_236 + V_168 ,
V_571 ) ;
} else {
F_354 ( V_430 ) ;
memcpy ( F_353 ( * V_751 , V_435 ) ,
V_231 -> V_236 + V_168 , V_435 ) ;
F_355 ( * V_751 , * V_752 , V_430 ,
V_168 + V_435 ,
V_571 - V_435 ) ;
...
F_354 ( V_430 ) ;
F_355 ( * V_751 , * V_752 , V_430 , V_168 , V_571 ) ;
( * V_751 ) -> V_571 += V_571 ;
( * V_751 ) -> V_147 += V_571 ;
( * V_751 ) -> V_753 += V_571 ;
( * V_752 ) ++ ;
...
while ( V_756 ) {
V_571 = F_358 ( V_756 , ( int ) ( V_231 -> V_239 - V_168 ) ) ;
if ( V_571 ) {
if ( V_759 ) {
if ( F_351 ( V_749 , V_231 ,
& V_219 , V_168 , & V_582 , V_571 ) )
goto V_767;
} else {
memcpy ( F_353 ( V_219 , V_571 ) , V_757 ,
V_571 ) ;
}
}
V_756 -= V_571 ;
...
F_362 ( V_772 [ V_770 ] . V_308 ) ;
V_772 [ V_770 ] . V_308 = NULL ;
}
}
void F_363 ( T_5 * V_308 , int V_367 , char * V_773 , ... )
{
char V_774 [ 32 ] ;
T_6 args ;
...
int V_770 ;
for ( V_770 = 0 ; V_770 < V_771 ; V_770 ++ ) {
V_772 [ V_770 ] . V_308 = F_366 ( V_772 [ V_770 ] . V_496 ,
V_772 [ V_770 ] . V_775 ,
V_772 [ V_770 ] . V_776 ,
V_772 [ V_770 ] . V_147 ) ;
...
V_332 = F_367 ( V_772 [ V_770 ] . V_308 , V_772 [ V_770 ] . V_777 ) ;
if ( V_332 ) {
F_361 () ;
return V_332 ;
}
F_368 ( V_772 [ V_770 ] . V_308 , V_772 [ V_770 ] . V_367 ) ;
}
return 0 ;
}
...
static int F_376 ( struct V_784 * V_72 )
{
struct V_1 * V_2 ;
struct V_785 * V_73 ;
int V_26 ;
...
F_52 ( & V_72 -> V_73 ) ) ;
V_2 -> V_789 = F_366 ( V_786 , 2 , 1 , 8 ) ;
if ( ! V_2 -> V_789 ) {
F_27 ( V_52 , 2 , L_186 , L_315 ) ;
V_26 = - V_39 ;
goto V_790;
}
F_367 ( V_2 -> V_789 , & V_791 ) ;
...
static void F_382 ( struct V_784 * V_72 )
{
unsigned long V_21 ;
struct V_1 * V_2 = F_383 ( & V_72 -> V_73 ) ;
F_24 ( V_52 , 2 , L_316 ) ;
if ( V_2 -> V_276 ) {
...
static int F_384 ( struct V_784 * V_72 )
{
struct V_1 * V_2 = F_383 ( & V_72 -> V_73 ) ;
int V_26 = 0 ;
int V_800 ;
...
static void F_386 ( struct V_784 * V_72 )
{
struct V_1 * V_2 = F_383 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_276 && V_2 -> V_276 -> V_804 )
V_2 -> V_276 -> V_804 ( V_72 ) ;
}
static int F_387 ( struct V_784 * V_72 )
{
struct V_1 * V_2 = F_383 ( & V_72 -> V_73 ) ;
...
static void F_388 ( struct V_784 * V_72 )
{
struct V_1 * V_2 = F_383 ( & V_72 -> V_73 ) ;
if ( V_2 -> V_276 && V_2 -> V_276 -> V_806 )
V_2 -> V_276 -> V_806 ( V_72 ) ;
}
static int F_389 ( struct V_784 * V_72 )
{
struct V_1 * V_2 = F_383 ( & V_72 -> V_73 ) ;
...
static T_7 F_392 ( struct V_810 * V_811 ,
...
int F_394 ( struct V_606 * V_73 , int V_814 )
{
switch ( V_814 ) {
case V_815 :
...
void F_396 ( struct V_606 * V_73 , V_677 V_814 , T_3 * V_110 )
{
switch ( V_814 ) {
case V_815 :
memcpy ( V_110 , & V_816 ,
