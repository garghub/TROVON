...
int V_73 = 0 ;
int V_74 ;
V_73 |= F_33 ( & V_70 -> V_75 , V_76 ) ;
V_73 |= F_33 ( & V_70 -> V_77 ,
V_78 | V_79 ) ;
V_73 |= F_33 ( & V_70 -> V_80 , V_81 ) ;
V_73 |= F_33 ( & V_70 -> V_82 , V_83 ) ;
V_73 |= F_33 ( & V_70 -> V_84 , V_83 | V_85 ) ;
if ( V_73 )
return 1 ;
V_73 |= F_34 ( V_70 -> V_77 ) ;
V_73 |= F_34 ( V_70 -> V_84 ) ;
...
static int F_37 ( struct V_1 * V_2 , struct V_15 * V_16 )
{
const struct V_71 * V_72 = F_32 ( V_2 ) ;
...
static int F_36 ( int * V_107 , int V_108 )
{
...
int V_73 = 0 ;
int V_74 ;
V_73 |= F_33 ( & V_70 -> V_75 , V_122 ) ;
V_73 |= F_33 ( & V_70 -> V_77 , V_81 ) ;
V_73 |= F_33 ( & V_70 -> V_80 , V_76 ) ;
V_73 |= F_33 ( & V_70 -> V_82 , V_83 ) ;
V_73 |= F_33 ( & V_70 -> V_84 , V_83 | V_85 ) ;
if ( V_73 )
return 1 ;
...
V_11 -> V_53 = V_41 ;
V_11 -> V_25 = 0 ;
V_94 = F_36 ( & V_70 -> V_87 , V_97 ) ;
F_4 ( V_94 , V_2 -> V_20 + V_98 ) ;
V_11 -> V_46 = V_116 | V_128 | V_129 ;
F_4 ( V_11 -> V_46 , V_2 -> V_20 + V_51 ) ;
V_16 -> V_22 -> V_126 = F_42 ;
return 0 ;
}
...
static const struct V_135 * F_46 ( int V_136 , int V_123 )
{
if ( V_136 ) {
if ( V_123 < 0 || V_123 >= 2 )
V_123 = 0 ;
...
static const struct V_135 * F_47 ( int V_123 )
{
if ( V_123 < 0 || V_123 >= 5 )
V_123 = 0 ;
return V_139 [ V_123 ] ;
}
static int F_48 ( struct V_1 * V_2 , int V_140 , int V_141 )
{
int V_31 ;
V_11 -> V_95 = 0 ;
if ( ! V_140 && ! V_141 ) {
...
V_31 = F_49 ( V_140 , L_12 ) ;
if ( V_31 )
return - V_142 ;
V_11 -> V_26 [ 0 ] . V_27 = V_140 ;
V_31 = F_49 ( V_141 , L_13 ) ;
if ( V_31 )
return - V_142 ;
V_11 -> V_26 [ 1 ] . V_27 = V_141 ;
V_11 -> V_28 = V_143 ;
V_11 -> V_26 [ 0 ] . V_3 = ( void * ) F_50 ( V_144 | V_145 ) ;
V_11 -> V_26 [ 1 ] . V_3 = ( void * ) F_50 ( V_144 | V_145 ) ;
...
static int F_51 ( struct V_1 * V_2 , struct V_147 * V_148 )
{
const struct V_71 * V_72 = F_32 ( V_2 ) ;
int V_5 , V_42 ;
int V_31 ;
...
if ( V_42 > 0 ) {
F_5 ( V_33 L_21 , V_42 ) ;
V_31 = F_54 ( V_42 , F_22 , 0 , L_17 , V_2 ) ;
if ( V_31 < 0 ) {
F_5 ( V_24 L_22 ) ;
return - V_96 ;
}
...
V_31 = F_55 ( V_2 , sizeof( struct V_168 ) ) ;
if ( V_31 < 0 )
return V_31 ;
V_31 = F_48 ( V_2 , V_148 -> V_151 [ V_169 ] ,
V_148 -> V_151 [ V_170 ] ) ;
if ( V_31 < 0 )
return V_31 ;
V_31 = F_56 ( V_2 , 3 ) ;
...
V_16 -> V_187 = 16 ;
V_16 -> V_188 =
F_46 ( V_7 . V_136 , V_148 -> V_151 [ V_189 ] ) ;
...
V_11 -> V_198 [ 0 ] =
F_47 ( V_148 -> V_151 [ V_199 ] ) ;
V_11 -> V_198 [ 1 ] =
F_47 ( V_148 -> V_151 [ V_200 ] ) ;
...
if ( V_2 -> V_208 ) {
if ( V_11 -> V_26 [ 0 ] . V_27 )
F_60 ( V_11 -> V_26 [ 0 ] . V_27 ) ;
if ( V_11 -> V_26 [ 1 ] . V_27 )
F_60 ( V_11 -> V_26 [ 1 ] . V_27 ) ;
if ( V_11 -> V_26 [ 0 ] . V_3 )
F_61 ( ( unsigned long ) V_11 -> V_26 [ 0 ] . V_3 ) ;
if ( V_11 -> V_26 [ 1 ] . V_3 )
F_61 ( ( unsigned long ) V_11 -> V_26 [ 1 ] . V_3 ) ;
}
}
