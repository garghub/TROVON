...
V_11 -> V_19 -> V_20 ( V_11 , ( V_18 * ) V_9 -> V_11 ) ;
F_7 ( V_6 -> V_21 ) ;
V_9 -> V_22 = true ;
F_4 ( V_9 , V_23 ) ;
F_8 ( V_9 -> V_1 ) ;
...
V_118 = F_56 ( V_99 , V_125 , 0 ) ;
V_9 -> V_126 = F_57 ( & V_99 -> V_39 , V_118 ) ;
if ( ! V_9 -> V_126 ) {
V_77 = - V_41 ;
goto V_119;
}
...
F_9 ,
0 ,
V_99 -> V_39 . V_128 -> V_61 ,
V_6 ) ;
if ( V_77 ) {
F_30 ( & V_99 -> V_39 , L_29 ) ;
goto V_119;
}
V_9 -> V_129 = F_59 ( & V_99 -> V_39 , L_30 ) ;
if ( F_60 ( V_9 -> V_129 ) ) {
F_30 ( & V_99 -> V_39 , L_31 ) ;
V_77 = F_61 ( V_9 -> V_129 ) ;
goto V_130;
...
V_114 = F_63 ( V_9 -> V_129 ) ;
V_116 = F_63 ( V_9 -> V_116 ) ;
...
static int T_5 F_73 ( struct V_98 * V_99 )
{
struct V_5 * V_6 = F_74 ( V_99 ) ;
struct V_8 * V_9 = F_2 ( V_6 ) ;
F_75 ( V_6 ) ;
F_33 ( V_6 ) ;
F_36 ( V_6 ) ;
