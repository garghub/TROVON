...
break;
case V_47 :
if ( V_30 ( & V_26 -> V_48 ) != sizeof( T_6 )
|| V_30 ( & V_26 -> V_49 ) != sizeof( V_50 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
break;
case V_51 : {
T_7 * const V_52 = ( T_7 * ) V_26 ;
if ( V_30 ( & V_52 -> V_48 ) != sizeof( T_7 )
|| V_30 ( & V_52 -> V_49 ) != sizeof( V_53 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
for ( V_23 = 1 ; V_23 < V_54 ; V_23 ++ ) {
char * V_57 = V_55 [ V_23 ] ;
int const V_58 = setjmp ( V_59 ) ;
switch ( V_58 ) {
default:
fprintf ( V_10 , L_9 , V_57 ) ;
exit ( 1 ) ;
break;
case V_60 :
V_5 = - 1 ;
