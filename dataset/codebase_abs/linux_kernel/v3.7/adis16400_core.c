...
return V_103 ;
case V_109 :
* V_4 = V_7 -> V_77 -> V_110 / 1000000 ;
* V_87 = ( V_7 -> V_77 -> V_110 % 1000000 ) ;
return V_103 ;
default:
return - V_37 ;
}
...
static int T_6 F_33 ( struct V_113 * V_114 )
{
int V_5 ;
struct V_6 * V_7 ;
...
V_7 -> V_10 = V_114 ;
F_36 ( & V_7 -> V_8 ) ;
V_7 -> V_77 = & V_116 [ F_37 ( V_114 ) -> V_117 ] ;
V_2 -> V_23 . V_118 = & V_114 -> V_23 ;
V_2 -> V_82 = F_37 ( V_114 ) -> V_82 ;
V_2 -> V_119 = V_7 -> V_77 -> V_119 ;
V_2 -> V_120 = V_7 -> V_77 -> V_120 ;
V_2 -> V_121 = & V_122 ;
V_2 -> V_123 = V_124 ;
V_5 = F_38 ( V_2 ) ;
if ( V_5 )
...
static int T_7 F_46 ( struct V_113 * V_114 )
{
