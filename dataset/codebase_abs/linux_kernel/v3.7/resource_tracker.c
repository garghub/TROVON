...
( void ) F_185 ( V_31 , & V_138 , V_322 -> V_280 , V_322 -> V_282 ,
V_322 -> V_284 ) ;
F_57 ( & V_322 -> V_123 ) ;
F_16 ( V_322 ) ;
}
...
V_326 = V_327 ;
do {
V_324 = F_201 ( V_31 , V_55 , type , 0 ) ;
if ( F_203 ( V_327 , V_326 + 5 * V_328 ) )
break;
if ( V_324 )
F_204 () ;
} while ( V_324 );
if ( V_324 )
V_324 = F_201 ( V_31 , V_55 , type , 1 ) ;
return V_324 ;
}
...
F_25 ( F_24 ( V_31 ) ) ;
if ( V_341 -> V_92 . V_85 == V_55 ) {
V_117 = V_341 -> V_92 . V_7 ;
V_2 = V_341 -> V_92 . V_87 ;
while ( V_2 != 0 ) {
switch ( V_2 ) {
case V_114 :
...
if ( V_345 -> V_92 . V_85 == V_55 ) {
V_143 = V_345 -> V_92 . V_7 ;
F_44 ( & V_345 -> V_92 . V_9 ,
& V_121 -> V_46 [ V_27 ] ) ;
F_57 ( & V_345 -> V_92 . V_123 ) ;
F_16 ( V_345 ) ;
F_100 ( V_31 , V_143 ) ;
}
}
...
if ( V_347 -> V_92 . V_85 == V_55 ) {
V_174 = V_347 -> V_92 . V_7 ;
F_44 ( & V_347 -> V_92 . V_9 , & V_121 -> V_46 [ V_29 ] ) ;
F_57 ( & V_347 -> V_92 . V_123 ) ;
F_16 ( V_347 ) ;
F_103 ( V_31 , V_174 ) ;
}
}
