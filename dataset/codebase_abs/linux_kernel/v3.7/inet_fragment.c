...
int F_21 ( struct V_24 * V_25 , struct V_2 * V_3 , bool V_47 )
{
struct V_11 * V_12 ;
int V_38 , V_48 = 0 ;
if ( ! V_47 ) {
if ( F_33 ( & V_25 -> V_27 ) <= V_25 -> V_49 )
return 0 ;
}
...
struct V_11 * V_50 , struct V_2 * V_3 ,
void * V_51 )
{
struct V_11 * V_52 ;
#ifdef F_43
...
if ( V_52 -> V_31 == V_25 && V_3 -> V_53 ( V_52 , V_51 ) ) {
F_38 ( & V_52 -> V_33 ) ;
F_7 ( & V_3 -> V_7 ) ;
V_50 -> V_34 |= V_35 ;
F_45 ( V_50 , V_3 ) ;
...
#endif
V_52 = V_50 ;
if ( ! F_8 ( & V_52 -> V_32 , V_5 + V_25 -> V_54 ) )
F_38 ( & V_52 -> V_33 ) ;
F_38 ( & V_52 -> V_33 ) ;
F_6 ( & V_52 -> V_18 , & V_3 -> V_19 [ V_19 ] ) ;
F_46 ( & V_52 -> V_28 , & V_25 -> V_28 ) ;
V_25 -> V_26 ++ ;
F_7 ( & V_3 -> V_7 ) ;
return V_52 ;
}
static struct V_11 * F_47 ( struct V_24 * V_25 ,
struct V_2 * V_3 , void * V_51 )
{
struct V_11 * V_12 ;
V_12 = F_48 ( V_3 -> V_45 , V_55 ) ;
if ( V_12 == NULL )
return NULL ;
V_12 -> V_31 = V_25 ;
V_3 -> V_56 ( V_12 , V_51 ) ;
F_49 ( V_3 -> V_45 , & V_25 -> V_27 ) ;
F_12 ( & V_12 -> V_32 , V_3 -> V_57 , ( unsigned long ) V_12 ) ;
F_50 ( & V_12 -> V_7 ) ;
F_15 ( & V_12 -> V_33 , 1 ) ;
return V_12 ;
}
...
{
struct V_11 * V_12 ;
V_12 = F_47 ( V_25 , V_3 , V_51 ) ;
if ( V_12 == NULL )
return NULL ;
return F_42 ( V_25 , V_12 , V_3 , V_51 ) ;
}
struct V_11 * F_52 ( struct V_24 * V_25 ,
struct V_2 * V_3 , void * V_58 , unsigned int V_19 )
__releases( &f->lock
