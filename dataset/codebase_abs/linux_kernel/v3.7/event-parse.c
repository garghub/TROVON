...
static char * F_9 ( struct V_14 * V_14 , int V_13 )
{
...
static void F_121 ( struct V_188 * V_189 , void * V_168 , int V_2 ,
struct V_47 * V_48 )
{
struct V_114 * V_66 ;
...
int F_151 ( struct V_14 * V_14 , enum V_288 V_299 ,
char * V_1 , T_1 V_300 )
{
int V_301 ;
const char * V_302 ;
...
unsigned long long * V_151 , int V_307 )
{
if ( ! V_66 ) {
if ( V_307 )
...
return - 1 ;
V_66 = F_78 ( V_48 , V_67 ) ;
return F_154 ( V_189 , V_66 , V_67 , V_231 , V_151 , V_307 ) ;
}
...
va_start ( V_313 , V_67 ) ;
for (; ; ) {
type = va_arg ( V_313 , enum V_310 ) ;
if ( type == V_314 )
break;
if ( type < 0 || type >= V_315 ) {
F_46 ( L_177 , type ) ;
V_112 = V_316 ;
goto V_37;
}
...
if ( V_14 -> V_27 ) {
for ( V_19 = 0 ; V_19 < V_14 -> V_33 ; V_19 ++ ) {
...
if ( V_14 -> V_39 ) {
for ( V_19 = 0 ; V_19 < V_14 -> V_44 ; V_19 ++ )
