...
switch ( V_91 ) {
case V_93 :
return F_52 ( & V_11 -> V_71 . V_72 , V_85 ,
sizeof( V_11 -> V_71 . V_72 ) ) ? - V_74 : 0 ;
case V_94 :
return F_43 ( V_85 , & V_11 -> V_71 . V_72 ,
sizeof( V_11 -> V_71 . V_72 ) ) ? - V_74 : 0 ;
case V_95 :
return F_55 ( V_11 -> V_71 . V_96 , ( V_97 T_2 * ) V_85 ) ;
case V_98 :
return F_56 ( V_11 -> V_71 . V_96 , ( V_97 T_2 * ) V_85 ) ;
case V_99 :
return F_56 ( V_100 , ( V_101 T_2 * ) V_85 ) ;
case V_102 :
return F_56 ( V_11 -> V_16 , ( T_6 T_2 * ) V_85 ) ;
case V_103 :
return F_56 ( V_11 -> V_17 , ( T_6 T_2 * ) V_85 ) ;
case V_104 :
if ( F_52 ( V_11 -> V_3 , V_85 ,
sizeof( V_11 -> V_3 [ 0 ] ) * V_11 -> V_16 ) )
return - V_74 ;
for ( V_67 = 0 ; V_67 < V_11 -> V_16 ; V_67 ++ ) {
int V_105 = F_57 ( V_42 , V_11 -> V_87 [ V_67 ] ) ;
...
switch ( V_91 & ~ V_107 ) {
case ( V_108 & ~ V_107 ) :
return F_49 ( V_11 , V_85 , F_58 ( V_91 ) ) ;
case ( V_109 & ~ V_107 ) :
V_86 = F_59 ( T_3 , F_58 ( V_91 ) , sizeof( V_11 -> V_87 ) ) ;
return F_43 ( V_85 , V_11 -> V_87 , V_86 ) ? - V_74 : V_86 ;
case ( V_110 & ~ V_107 ) :
return F_53 ( V_11 , V_85 , F_58 ( V_91 ) ) ;
case ( V_111 & ~ V_107 ) :
V_86 = F_59 ( T_3 , F_58 ( V_91 ) , sizeof( V_11 -> V_62 ) ) ;
return F_43 ( V_85 , V_11 -> V_62 , V_86 ) ? - V_74 : V_86 ;
case F_60 ( 0 ) :
V_92 = V_42 -> V_92 ;
if ( ! V_92 )
return 0 ;
V_86 = F_59 ( T_3 , F_58 ( V_91 ) , strlen ( V_92 ) + 1 ) ;
return F_43 ( V_85 , V_92 , V_86 ) ? - V_74 : V_86 ;
}
return - V_77 ;
}
static long F_61 ( struct V_38 * V_38 ,
...
switch ( V_91 ) {
case V_116 :
V_46 = F_55 ( V_113 , ( V_97 T_2 * ) V_112 ) ;
if ( V_46 == 0 )
V_11 -> V_71 . V_117 = V_113 ;
break;
case V_118 :
V_113 = V_11 -> V_71 . V_117 ;
V_46 = F_56 ( V_113 , ( V_97 T_2 * ) V_112 ) ;
break;
case V_119 :
V_46 = F_52 ( & V_115 , V_85 ,
sizeof( V_115 ) ) ? - V_74 : 0 ;
if ( V_46 == 0 ) {
...
static long F_62 ( struct V_38 * V_38 ,
unsigned int V_91 , unsigned long V_112 )
{
struct V_7 * V_8 = V_38 -> V_40 ;
struct V_11 * V_11 = V_8 -> V_11 ;
...
switch ( V_91 ) {
case V_116 :
V_46 = F_55 ( V_11 -> V_71 . V_117 ,
( long T_2 * ) V_112 ) ;
break;
case V_118 :
V_46 = F_56 ( V_11 -> V_71 . V_117 ,
( long T_2 * ) V_112 ) ;
break;
case V_119 :
V_46 = F_52 ( & V_11 -> V_71 , V_85 ,
...
static void F_63 ( struct V_11 * V_11 )
{
F_28 ( & V_11 -> V_47 ) ;
V_11 -> V_48 = false ;
F_26 ( & V_11 -> V_47 ) ;
}
static void F_64 ( struct V_11 * V_11 )
{
...
static bool F_66 ( struct V_124 * V_125 , struct V_58 * V_42 )
{
if ( F_39 ( V_27 , V_42 -> V_126 ) && F_39 ( V_127 , V_42 -> V_128 ) )
return false ;
if ( F_39 ( V_27 , V_42 -> V_126 ) && F_39 ( V_129 , V_42 -> V_128 ) )
return false ;
return true ;
}
static int F_67 ( struct V_124 * V_125 , struct V_58 * V_42 ,
const struct V_130 * V_131 )
{
struct V_11 * V_11 ;
int V_67 , V_132 , V_133 , V_134 , V_135 ;
int error ;
V_134 = F_68 ( V_136 , V_137 , true ) ;
if ( V_134 < 0 ) {
error = V_134 ;
F_69 ( L_1 , error ) ;
return error ;
...
V_135 -= V_136 ;
F_73 ( & V_11 -> V_42 , L_2 , V_135 ) ;
V_11 -> V_24 . V_42 = F_74 ( V_42 ) ;
V_11 -> V_24 . V_92 = F_75 ( & V_11 -> V_42 ) ;
V_11 -> V_24 . V_125 = V_125 ;
V_11 -> V_24 . V_26 = V_11 ;
for ( V_67 = 0 ; V_67 < V_139 ; V_67 ++ )
if ( F_39 ( V_67 , V_42 -> V_140 ) ) {
V_11 -> V_34 [ V_67 ] = V_11 -> V_16 ;
V_11 -> V_87 [ V_11 -> V_16 ] = V_67 ;
V_11 -> V_16 ++ ;
}
for ( V_67 = V_141 - V_28 ; V_67 < V_90 - V_28 + 1 ; V_67 ++ )
if ( F_39 ( V_67 + V_28 , V_42 -> V_128 ) ) {
V_11 -> V_31 [ V_67 ] = V_11 -> V_17 ;
V_11 -> V_62 [ V_11 -> V_17 ] = V_67 + V_28 ;
V_11 -> V_17 ++ ;
}
for ( V_67 = 0 ; V_67 < V_141 - V_28 ; V_67 ++ )
if ( F_39 ( V_67 + V_28 , V_42 -> V_128 ) ) {
V_11 -> V_31 [ V_67 ] = V_11 -> V_17 ;
V_11 -> V_62 [ V_11 -> V_17 ] = V_67 + V_28 ;
V_11 -> V_17 ++ ;
...
for ( V_67 = 0 ; V_67 < V_11 -> V_16 ; V_67 ++ ) {
V_132 = V_11 -> V_87 [ V_67 ] ;
if ( F_76 ( V_42 , V_132 ) == F_77 ( V_42 , V_132 ) ) {
V_11 -> V_3 [ V_67 ] . type = V_4 ;
V_11 -> abs [ V_67 ] = F_57 ( V_42 , V_132 ) ;
continue;
}
V_11 -> V_3 [ V_67 ] . type = V_5 ;
V_11 -> V_3 [ V_67 ] . V_142 = F_78 ( V_42 , V_132 ) ;
V_133 = ( F_76 ( V_42 , V_132 ) + F_77 ( V_42 , V_132 ) ) / 2 ;
V_11 -> V_3 [ V_67 ] . V_6 [ 0 ] = V_133 - F_79 ( V_42 , V_132 ) ;
V_11 -> V_3 [ V_67 ] . V_6 [ 1 ] = V_133 + F_79 ( V_42 , V_132 ) ;
V_133 = ( F_76 ( V_42 , V_132 ) - F_77 ( V_42 , V_132 ) ) / 2
- 2 * F_79 ( V_42 , V_132 ) ;
if ( V_133 ) {
V_11 -> V_3 [ V_67 ] . V_6 [ 2 ] = ( 1 << 29 ) / V_133 ;
V_11 -> V_3 [ V_67 ] . V_6 [ 3 ] = ( 1 << 29 ) / V_133 ;
V_11 -> abs [ V_67 ] =
F_1 ( F_57 ( V_42 , V_132 ) ,
V_11 -> V_3 + V_67 ) ;
}
}
V_11 -> V_42 . V_143 = F_80 ( V_144 , V_134 ) ;
V_11 -> V_42 . V_145 = & V_146 ;
V_11 -> V_42 . V_147 = & V_42 -> V_42 ;
V_11 -> V_42 . V_148 = F_14 ;
F_81 ( & V_11 -> V_42 ) ;
error = F_82 ( & V_11 -> V_24 ) ;
if ( error )
goto V_149;
F_83 ( & V_11 -> V_54 , & V_150 ) ;
V_11 -> V_54 . V_151 . V_147 = & V_11 -> V_42 . V_151 ;
error = F_84 ( & V_11 -> V_54 , V_11 -> V_42 . V_143 , 1 ) ;
if ( error )
goto V_152;
error = F_85 ( & V_11 -> V_42 ) ;
if ( error )
goto V_153;
return 0 ;
V_153:
