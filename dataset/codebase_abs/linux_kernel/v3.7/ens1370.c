...
static int T_3 F_81 ( struct V_1 * V_1 , int V_27 ,
struct V_138 * * V_139 )
{
struct V_138 * V_140 ;
int V_141 ;
...
static int T_3 F_98 ( struct V_1 * V_1 ,
int V_188 , int V_189 )
{
...
static int T_3 F_107 ( struct V_1 * V_1 )
{
struct V_190 * V_142 = V_1 -> V_142 ;
struct V_17 V_18 ;
unsigned int V_219 ;
...
static int T_3 F_111 ( int V_223 )
{
switch ( V_224 [ V_223 ] ) {
case 0 :
case 1 :
...
static int T_3 F_113 ( struct V_1 * V_1 , int V_223 )
{
struct V_226 * V_227 ;
int V_228 ;
V_228 = F_111 ( V_223 ) ;
...
static void T_3 F_128 ( struct V_1 * V_1 )
{
struct V_236 * V_237 ;
...
static int F_139 ( struct V_247 * V_27 )
{
struct V_1 * V_1 = V_27 -> V_248 ;
return F_131 ( V_1 ) ;
}
...
F_8 ( V_1 -> V_68 , F_3 ( V_1 , V_69 ) ) ;
F_8 ( F_46 ( V_117 ) , F_3 ( V_1 , V_87 ) ) ;
F_8 ( V_1 -> V_245 . V_249 , F_3 ( V_1 , V_250 ) ) ;
F_8 ( 0 , F_3 ( V_1 , V_251 ) ) ;
#else
F_8 ( V_1 -> V_75 , F_3 ( V_1 , V_38 ) ) ;
F_8 ( V_1 -> V_68 , F_3 ( V_1 , V_69 ) ) ;
...
F_8 ( V_1 -> V_75 | V_253 , F_3 ( V_1 , V_38 ) ) ;
F_2 ( F_3 ( V_1 , V_38 ) ) ;
F_109 ( 20 ) ;
F_8 ( V_1 -> V_75 , F_3 ( V_1 , V_38 ) ) ;
F_1 ( V_1 ) ;
...
#endif
F_141 ( V_1 -> V_256 = 0x00 , F_3 ( V_1 , V_257 ) ) ;
F_141 ( 0x00 , F_3 ( V_1 , V_258 ) ) ;
F_8 ( V_1 -> V_174 , F_3 ( V_1 , V_24 ) ) ;
F_132 ( V_1 -> V_242 ) ;
}
static int F_142 ( struct V_27 * V_223 )
{
struct V_259 * V_26 = F_143 ( V_223 ) ;
...
static int T_3 F_157 ( struct V_190 * V_142 ,
struct V_259 * V_26 ,
struct V_1 * * V_265 )
{
struct V_1 * V_1 ;
...
V_1 -> V_285 = V_55 ;
if ( ! ( V_1 -> V_280 & V_286 ) ) {
F_141 ( F_172 ( 3 ) , F_3 ( V_1 , V_257 ) ) ;
F_141 ( V_1 -> V_256 = 0 , F_3 ( V_1 , V_257 ) ) ;
...
F_141 ( V_1 -> V_256 &= ~ V_292 , F_3 ( V_1 , V_257 ) ) ;
}
V_1 -> V_285 = NULL ;
V_1 -> V_280 &= ~ V_281 ;
F_51 ( & V_1 -> V_67 ) ;
...
F_141 ( V_1 -> V_256 &= ~ V_289 , F_3 ( V_1 , V_257 ) ) ;
}
V_1 -> V_288 = NULL ;
V_1 -> V_280 &= ~ V_286 ;
F_51 ( & V_1 -> V_67 ) ;
...
F_177 ( & V_1 -> V_67 , V_294 ) ;
if ( V_293 ) {
if ( F_180 ( V_1 -> V_256 ) == 0 ) {
V_1 -> V_256 |= F_181 ( 1 ) ;
while ( F_180 ( V_1 -> V_256 ) == 1 &&
...
static int T_3 F_182 ( struct V_1 * V_1 , int V_27 ,
struct V_277 * * V_295 )
{
struct V_277 * V_278 ;
int V_141 ;
...
static T_4 V_269 ( int V_242 , void * V_303 )
{
...
static int T_3 F_186 ( struct V_259 * V_26 ,
...
static void T_5 F_191 ( struct V_259 * V_26 )
{
F_188 ( F_192 ( V_26 ) ) ;
F_190 ( V_26 , NULL ) ;
}
