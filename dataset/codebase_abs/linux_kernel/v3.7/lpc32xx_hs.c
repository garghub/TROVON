...
struct V_39 * V_40 = F_26 ( & V_2 -> V_41 -> V_2 ) ;
if ( ! V_40 ) {
while ( ! ( F_3 ( F_9 ( V_2 -> V_4 ) ) &
V_42 ) )
;
return;
}
...
{
struct V_50 * V_51 = & V_2 -> V_41 -> V_51 ;
unsigned int V_35 ;
if ( V_2 -> V_52 ) {
...
V_54:
if ( F_32 ( V_51 ) ) {
V_35 = F_3 ( F_36 ( V_2 -> V_4 ) ) ;
V_35 &= ~ V_59 ;
F_8 ( V_35 , F_36 ( V_2 -> V_4 ) ) ;
}
}
...
V_6 V_62 ;
F_14 ( & V_2 -> V_19 ) ;
V_62 = F_3 ( F_27 ( V_2 -> V_4 ) ) ;
if ( V_62 & V_63 ) {
F_8 ( V_63 , F_27 ( V_2 -> V_4 ) ) ;
V_2 -> V_44 . V_64 ++ ;
F_38 ( V_2 ) ;
}
if ( V_62 & V_47 )
F_8 ( V_47 , F_27 ( V_2 -> V_4 ) ) ;
if ( V_62 & V_65 ) {
F_8 ( V_65 ,
F_27 ( V_2 -> V_4 ) ) ;
V_2 -> V_44 . V_66 ++ ;
...
if ( ( V_62 & V_70 ) && ( ! F_33 ( V_2 ) ) ) {
F_8 ( V_70 , F_27 ( V_2 -> V_4 ) ) ;
F_31 ( V_2 ) ;
}
F_16 ( & V_2 -> V_19 ) ;
F_30 ( V_40 ) ;
...
static void F_50 ( T_3 V_82 , int V_41 )
{
int V_83 ;
V_6 V_35 ;
switch ( V_82 ) {
...
V_63 | V_65 ) ,
F_27 ( V_2 -> V_4 ) ) ;
F_8 ( 0xFF , F_53 ( V_2 -> V_4 ) ) ;
V_35 = V_89 | V_90 |
F_54 ( 20 ) | V_91 ;
F_8 ( V_35 , F_36 ( V_2 -> V_4 ) ) ;
F_50 ( V_2 -> V_82 , 0 ) ;
F_49 ( & V_2 -> V_19 , V_15 ) ;
V_88 = F_55 ( V_2 -> V_60 , F_37 ,
0 , V_92 , V_2 ) ;
if ( ! V_88 )
F_8 ( ( V_35 | V_78 | V_79 ) ,
F_36 ( V_2 -> V_4 ) ) ;
...
V_35 |= V_78 | V_79 ;
F_8 ( V_35 , F_36 ( V_2 -> V_4 ) ) ;
F_8 ( V_96 , F_53 ( V_2 -> V_4 ) ) ;
F_60 ( V_2 , V_94 -> V_97 , V_21 ) ;
F_49 ( & V_2 -> V_19 , V_15 ) ;
if ( F_61 ( V_94 ) )
F_62 ( V_94 , V_21 , V_21 ) ;
}
...
if ( ( V_2 -> V_108 == V_109 ) && ( V_2 -> V_82 ) ) {
V_72 = 0 ;
if ( ! F_68 ( V_2 -> V_82 , V_111 , V_92 ) )
V_72 = - V_112 ;
else if ( V_2 -> V_15 & V_110 ) {
V_2 -> V_4 = F_69 ( V_2 -> V_82 , V_111 ) ;
if ( ! V_2 -> V_4 ) {
F_66 ( V_2 -> V_82 , V_111 ) ;
V_72 = - V_113 ;
}
...
static int T_4 F_72 ( struct V_120 * V_121 )
{
...
V_122 -> V_2 . V_4 = NULL ;
V_122 -> V_2 . V_60 = F_75 ( V_121 , 0 ) ;
if ( V_122 -> V_2 . V_60 < 0 ) {
F_73 ( & V_121 -> V_126 , L_4 ,
V_123 ) ;
...
F_76 ( & V_122 -> V_2 . V_19 ) ;
F_50 ( V_122 -> V_2 . V_82 , 1 ) ;
V_72 = F_77 ( & V_136 , & V_122 -> V_2 ) ;
F_78 ( V_121 , V_122 ) ;
return V_72 ;
}
static int T_5 F_79 ( struct V_120 * V_121 )
{
struct V_11 * V_122 = F_80 ( V_121 ) ;
F_81 ( & V_136 , & V_122 -> V_2 ) ;
return 0 ;
}
...
{
struct V_11 * V_122 = F_80 ( V_121 ) ;
F_83 ( & V_136 , & V_122 -> V_2 ) ;
return 0 ;
}
static int F_84 ( struct V_120 * V_121 )
{
struct V_11 * V_122 = F_80 ( V_121 ) ;
F_85 ( & V_136 , & V_122 -> V_2 ) ;
return 0 ;
}
