...
struct V_107 V_108 ;
unsigned long V_109 ;
V_109 = F_105 ( struct V_107 , V_110 ) ;
if ( F_106 ( & V_108 , ( void T_2 * ) V_61 , V_109 ) )
return - V_111 ;
...
if ( V_14 -> V_23 )
V_108 . V_110 |= V_114 ;
if ( F_107 ( ( void T_2 * ) V_61 , & V_108 , V_109 ) )
return - V_111 ;
V_15 = 0 ;
break;
}
...
{
char * V_82 ;
V_82 = F_109 ( ( const char T_2 * ) V_61 , V_118 ) ;
if ( F_34 ( V_82 ) )
return F_69 ( V_82 ) ;
V_15 = F_99 ( V_14 , V_82 ) ;
F_6 ( V_82 ) ;
...
static char * F_120 ( struct V_26 * V_27 , T_5 * V_119 )
{
...
F_25 ( & V_8 . V_12 ) ;
F_124 ( & V_8 . V_43 ) ;
V_8 . V_35 = F_125 ( V_120 , L_11 ) ;
if ( F_34 ( V_8 . V_35 ) ) {
V_15 = F_69 ( V_8 . V_35 ) ;
goto V_121;
}
V_8 . V_35 -> V_122 = F_120 ;
V_15 = F_126 ( & V_8 . V_36 , 0 , V_20 , L_11 ) ;
if ( V_15 )
goto V_123;
F_127 ( & V_8 . V_124 , & V_97 ) ;
V_15 = F_128 ( & V_8 . V_124 , V_8 . V_36 , 1 ) ;
if ( V_15 )
goto V_125;
...
F_127 ( & V_8 . V_127 , & V_128 ) ;
V_15 = F_128 ( & V_8 . V_127 ,
F_31 ( F_32 ( V_8 . V_36 ) , 1 ) , V_20 - 1 ) ;
if ( V_15 )
goto V_129;
F_129 ( V_130 L_12 V_131 L_13 ) ;
F_130 ( L_14 ) ;
return 0 ;
V_129:
