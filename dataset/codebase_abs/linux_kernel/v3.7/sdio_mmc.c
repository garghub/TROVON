...
static int
F_48 ( struct V_47 * V_48 , unsigned V_82 )
{
int V_54 ;
if ( V_82 > V_48 -> V_21 -> V_37 -> V_83 )
return - V_14 ;
if ( V_82 == 0 ) {
V_82 = F_49 ( V_48 -> V_84 , V_48 -> V_21 -> V_37 -> V_83 ) ;
V_82 = F_49 ( V_82 , 512u ) ;
}
...
F_63 ( T_4 * V_90 )
{
struct V_94 * V_95 = F_64 ( sizeof( struct V_94 ) , V_96 ) ;
if ( V_95 )
{
V_95 -> V_90 = V_90 ;
V_95 -> V_97 . V_98 = V_99 ;
F_65 ( & V_95 -> V_100 , & V_101 . V_100 ) ;
if ( F_66 ( & V_95 -> V_97 ) ) {
F_6 ( V_40 L_15 ) ;
}
}
...
F_68 (node, q, &uf_sdio_mmc_pm_notifiers.list) {
V_95 = F_69 ( V_103 , struct V_94 , V_100 ) ;
