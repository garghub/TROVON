...
int V_172 = 0 ;
T_1 V_3 ;
V_172 = F_23 ( V_65 , 8 , 16 , V_173 ) ;
if ( V_172 != 0 ) {
F_9 ( V_65 -> V_2 , L_14 , V_172 ) ;
return V_172 ;
}
V_3 = F_4 ( V_65 , V_51 ) ;
V_3 |= V_174 ;
...
F_5 ( V_65 , V_10 ,
V_3 | V_175 | V_176 ) ;
F_5 ( V_65 , V_9 , V_3 | V_175 ) ;
V_3 = F_4 ( V_65 , V_36 ) ;
F_5 ( V_65 , V_36 ,
V_3 | V_177 | V_178 ) ;
F_5 ( V_65 , V_35 , V_3 | V_179 ) ;
V_3 = F_4 ( V_65 , V_25 ) ;
F_5 ( V_65 , V_25 , V_3 | V_180 ) ;
V_3 = F_4 ( V_65 , V_8 ) ;
F_5 ( V_65 , V_8 , V_3 | V_181 ) ;
V_3 = F_4 ( V_65 , V_13 ) ;
V_3 |= V_182 ;
F_5 ( V_65 , V_13 , V_3 ) ;
V_3 = F_4 ( V_65 , V_32 ) ;
...
static T_2 int F_31 ( struct V_187 * V_188 ,
const struct V_189 * V_190 )
{
struct V_99 * V_100 ;
unsigned int V_110 ;
int V_172 ;
V_100 = F_32 ( & V_188 -> V_2 , sizeof( struct V_99 ) ,
V_191 ) ;
if ( V_100 == NULL )
return - V_192 ;
V_100 -> V_193 = F_33 ( V_188 , & V_194 ) ;
if ( F_34 ( V_100 -> V_193 ) )
return F_35 ( V_100 -> V_193 ) ;
V_172 = F_36 ( V_100 -> V_193 , V_4 , & V_110 ) ;
if ( V_172 != 0 ) {
F_9 ( & V_188 -> V_2 , L_15 , V_172 ) ;
return V_172 ;
}
if ( V_110 != 0x1801 ) {
F_9 ( & V_188 -> V_2 , L_16 , V_110 ) ;
return - V_106 ;
}
F_37 ( V_100 -> V_193 , true ) ;
V_172 = F_36 ( V_100 -> V_193 , V_8 , & V_110 ) ;
F_37 ( V_100 -> V_193 , false ) ;
if ( V_172 != 0 ) {
F_9 ( & V_188 -> V_2 , L_17 , V_172 ) ;
return V_172 ;
}
F_38 ( & V_188 -> V_2 , L_18 ,
( V_110 & V_195 ) >> V_196 ,
( ( V_110 & V_197 ) >> V_198 )
+ 'A' ) ;
V_172 = F_39 ( V_100 -> V_193 , V_4 , 0x1801 ) ;
if ( V_172 != 0 ) {
F_9 ( & V_188 -> V_2 , L_19 , V_172 ) ;
return V_172 ;
}
F_40 ( V_188 , V_100 ) ;
V_172 = F_41 ( & V_188 -> V_2 ,
& V_199 , & V_200 , 1 ) ;
return V_172 ;
}
static T_3 int F_42 ( struct V_187 * V_201 )
{
F_43 ( & V_201 -> V_2 ) ;
return 0 ;
}
