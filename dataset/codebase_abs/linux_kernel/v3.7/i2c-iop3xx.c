...
static int
F_37 ( struct V_71 * V_72 )
{
struct V_75 * V_76 ;
int V_67 , V_80 ;
struct V_56 * V_81 ;
struct V_6 * V_74 ;
V_81 = F_38 ( sizeof( struct V_56 ) , V_82 ) ;
if ( ! V_81 ) {
V_67 = - V_83 ;
goto V_84;
}
V_74 = F_38 ( sizeof( struct V_6 ) , V_82 ) ;
if ( ! V_74 ) {
V_67 = - V_83 ;
goto V_85;
}
...
if ( ! F_39 ( V_76 -> V_78 , V_79 , V_72 -> V_88 ) ) {
V_67 = - V_51 ;
goto V_87;
}
V_74 -> V_19 = V_89 ++ ;
V_74 -> V_9 = F_40 ( V_76 -> V_78 , V_79 ) ;
if ( ! V_74 -> V_9 ) {
V_67 = - V_83 ;
goto V_90;
}
