...
T_4 V_377 ;
T_6 V_378 ;
for ( V_92 = 0 ; V_92 < V_360 -> V_379 ; V_92 ++ ) {
V_27 = F_9 ( V_360 -> V_380 [ V_92 ] . V_381 ) ;
if ( ! V_27 )
continue;
V_378 = V_360 -> V_382 + V_92 ;
V_377 = V_360 -> V_380 [ V_92 ] . V_383 &
V_384 ;
if ( V_377 == V_385 )
F_149 ( V_6 , V_27 ) ;
}
...
if ( ! V_88 ) {
V_387 = F_69 ( sizeof( * V_387 ) , V_361 ) ;
if ( ! V_387 )
return;
F_154 ( & V_387 -> V_67 ) ;
V_387 -> V_27 = V_27 ;
F_24 ( & V_387 -> V_67 , & V_6 -> V_391 ) ;
F_23 ( V_6 , F_3 ( V_58
L_109 ,
V_6 -> V_35 , V_27 ) ) ;
return;
...
L_111 , V_6 -> V_35 , V_27 , V_395 ,
V_6 -> V_396 ) ) ;
V_103 = F_48 ( V_6 , V_395 ) ;
memset ( V_103 , 0 , sizeof( T_24 ) ) ;
V_103 -> V_329 = V_397 ;
V_103 -> V_398 = V_399 ;
V_103 -> V_233 = V_394 -> V_233 ;
F_163 ( V_6 , V_395 ) ;
return F_160 ( V_6 , V_88 ) ;
}
static T_6
...
struct V_386 * V_387 ;
if ( ! F_43 ( & V_6 -> V_393 ) ) {
V_387 = F_45 ( V_6 -> V_393 . V_100 ,
struct V_386 , V_67 ) ;
F_164 ( V_6 , V_88 ) ;
F_157 ( V_6 , V_387 -> V_27 ) ;
F_19 ( & V_387 -> V_67 ) ;
F_20 ( V_387 ) ;
return 0 ;
}
if ( ! F_43 ( & V_6 -> V_391 ) ) {
V_387 = F_45 ( V_6 -> V_391 . V_100 ,
struct V_386 , V_67 ) ;
F_164 ( V_6 , V_88 ) ;
F_153 ( V_6 , V_387 -> V_27 ) ;
F_19 ( & V_387 -> V_67 ) ;
F_20 ( V_387 ) ;
return 0 ;
}
...
V_401 = F_9 ( V_360 -> V_403 ) ;
if ( V_401 < V_6 -> V_31 . V_32 ) {
F_152 ( V_6 , V_360 ) ;
return;
}
if ( V_360 -> V_404 ==
...
V_27 = F_93 ( V_6 -> V_374 ,
V_6 -> V_257 . V_406 ) ;
if ( V_27 < V_6 -> V_257 . V_406 )
F_149 ( V_6 , V_27 ) ;
} while ( F_166 ( V_27 , V_6 -> V_374 ) );
} else if ( V_360 -> V_404 == V_407 )
F_152 ( V_6 , V_360 ) ;
if ( V_360 -> V_404 != V_408 )
return;
F_18 ( & V_6 -> V_356 , V_65 ) ;
F_4 (fw_event, &ioc->fw_event_list, list) {
if ( V_354 -> V_362 != V_409 ||
V_354 -> V_410 )
continue;
V_400 = V_354 -> V_360 ;
if ( V_400 -> V_404 ==
...
static void
F_168 ( T_4 V_27 , T_4 * V_412 , T_4 * V_413 )
{
if ( ! V_27 || V_27 == * V_412 || V_27 == * V_413 )
return;
if ( ! * V_412 )
* V_412 = V_27 ;
else if ( ! * V_413 )
...
T_26 * V_414 ;
int V_92 ;
T_4 V_27 , V_263 , V_412 , V_413 ;
struct V_386 * V_387 ;
V_412 = 0 ;
V_413 = 0 ;
if ( V_6 -> V_175 )
return;
V_414 = ( T_26 * ) & V_360 -> V_415 [ 0 ] ;
for ( V_92 = 0 ; V_92 < V_360 -> V_416 ; V_92 ++ , V_414 ++ ) {
if ( V_414 -> V_417 ==
V_418 ||
V_414 -> V_417 ==
V_419 ) {
V_263 = F_9 ( V_414 -> V_420 ) ;
F_167 ( V_6 , V_263 ) ;
F_168 ( V_263 , & V_412 , & V_413 ) ;
}
}
V_414 = ( T_26 * ) & V_360 -> V_415 [ 0 ] ;
for ( V_92 = 0 ; V_92 < V_360 -> V_416 ; V_92 ++ , V_414 ++ ) {
...
if ( V_414 -> V_417 != V_422 )
continue;
V_27 = F_9 ( V_414 -> V_423 ) ;
V_263 = F_9 ( V_414 -> V_420 ) ;
F_170 ( V_27 , V_6 -> V_178 ) ;
if ( ! V_263 )
F_153 ( V_6 , V_27 ) ;
else if ( V_263 == V_412 || V_263 == V_413 ) {
V_387 = F_69 ( sizeof( * V_387 ) , V_361 ) ;
F_171 ( ! V_387 ) ;
F_154 ( & V_387 -> V_67 ) ;
V_387 -> V_27 = V_27 ;
...
{
T_10 V_200 ;
if ( V_360 -> V_417 != V_424 )
return;
V_200 = F_76 ( V_360 -> V_425 ) ;
...
{
T_4 V_426 ;
unsigned char V_427 = F_176 ( V_90 ) ;
unsigned char V_428 = F_177 ( V_90 ) ;
if ( V_428 == V_429 || V_427 == V_430 )
return;
if ( V_427 == V_431 )
V_426 = V_432 ;
else if ( V_427 == V_433 )
...
V_103 -> V_444 = F_180 ( V_90 -> V_43 -> V_445 ) ;
V_103 -> V_446 = F_119 ( V_426 ) ;
}
static void
...
F_182 ( 0 , V_90 -> V_451 , V_452 , 0x10 , V_447 ) ;
V_90 -> V_348 = V_453 << 24 | ( V_454 << 16 ) |
V_455 ;
}
static inline T_6
F_183 ( struct V_5 * V_6 , T_4 V_88 )
{
return V_6 -> V_89 [ V_88 - 1 ] . V_456 ;
}
static inline void
F_184 ( struct V_5 * V_6 , T_4 V_88 , T_6 V_456 )
{
V_6 -> V_89 [ V_88 - 1 ] . V_456 = V_456 ;
}
static void
...
T_4 V_88 )
{
T_10 V_457 , V_458 , V_459 , V_460 , V_461 , V_462 ;
T_10 V_239 , V_241 ;
T_6 V_227 , * V_463 , V_92 ;
T_6 V_464 = V_90 -> V_465 [ 0 ] ;
T_1 V_466 ;
if ( V_464 == V_467 || V_464 == V_468 ||
V_464 == V_469 || V_464 == V_470 ) {
V_463 = V_103 -> V_440 . V_471 ;
if ( ( V_464 < V_467 ) || ! ( V_463 [ 2 ] | V_463 [ 3 ] | V_463 [ 4 ]
| V_463 [ 5 ] ) ) {
V_462 = F_52 ( V_90 ) >>
V_48 -> V_253 ;
V_92 = ( V_464 < V_467 ) ? 2 : 6 ;
V_457 = F_186 ( * ( V_472 * ) ( & V_463 [ V_92 ] ) ) ;
if ( ( ( T_1 ) V_457 + ( T_1 ) V_462 - 1 ) <=
( T_10 ) V_48 -> V_254 ) {
V_239 = V_48 -> V_239 ;
V_241 = V_48 -> V_252 ;
V_459 = V_457 & ( V_239 - 1 ) ;
if ( ( V_459 + V_462 ) <= V_239 ) {
V_227 = V_48 -> V_227 ;
V_458 = V_457 >> V_241 ;
V_460 = V_458 / V_227 ;
V_461 = V_458 % V_227 ;
...
V_462 = F_52 ( V_90 ) >>
V_48 -> V_253 ;
V_466 = F_187 ( * ( V_473 * ) ( & V_463 [ 2 ] ) ) ;
if ( ( V_466 + ( T_1 ) V_462 - 1 ) <=
V_48 -> V_254 ) {
V_239 = V_48 -> V_239 ;
V_241 = V_48 -> V_252 ;
V_459 = ( T_10 ) ( V_466 & ( V_239 - 1 ) ) ;
if ( ( V_459 + V_462 ) <= V_239 ) {
V_227 = V_48 -> V_227 ;
V_458 = ( T_10 ) ( V_466 >> V_241 ) ;
V_460 = V_458 / V_227 ;
V_461 = V_458 % V_227 ;
V_458 = ( V_460 << V_241 ) +
V_459 ;
...
F_96 ( V_90 -> V_43 ) && V_90 -> V_484 != 32 )
V_474 |= V_485 ;
V_88 = F_190 ( V_6 , V_6 -> V_486 , V_90 ) ;
if ( ! V_88 ) {
F_3 ( V_34 L_69 ,
V_6 -> V_35 , V_36 ) ;
goto V_75;
...
V_103 -> V_490 = F_180 ( F_52 ( V_90 ) ) ;
V_103 -> V_491 = F_180 ( V_474 ) ;
V_103 -> V_492 = F_119 ( V_90 -> V_484 ) ;
V_103 -> V_493 = V_494 ;
V_103 -> V_495 = V_496 ;
V_103 -> V_497 =
F_191 ( V_6 , V_88 ) ;
V_103 -> V_498 = F_53 ( T_11 , V_127 ) / 4 ;
V_103 -> V_499 = F_119 ( V_500 +
V_501 ) ;
V_103 -> V_502 = 0 ;
V_103 -> V_503 = 0 ;
F_120 ( V_146 -> V_95 , (struct V_333 * )
V_103 -> V_334 ) ;
memcpy ( V_103 -> V_440 . V_471 , V_90 -> V_465 , V_90 -> V_484 ) ;
if ( ! V_103 -> V_490 ) {
...
V_39 ;
T_6 V_506 = V_29 -> V_507 ;
T_6 V_508 = V_29 -> V_509 ;
char * V_510 = NULL ;
char * V_511 = NULL ;
char * V_512 = V_6 -> V_513 ;
T_10 V_514 = F_76 ( V_29 -> V_337 ) ;
struct V_45 * V_46 = NULL ;
unsigned long V_65 ;
struct V_168 * V_70 = V_90 -> V_43 -> V_345 ;
struct V_147 * V_346 = V_70 -> V_150 ;
...
V_510 , V_30 , V_88 ) ;
F_3 ( V_99 L_169
L_170 , V_6 -> V_35 , F_52 ( V_90 ) , V_90 -> V_544 ,
F_195 ( V_90 ) ) ;
F_3 ( V_99 L_171
L_172 , V_6 -> V_35 , F_9 ( V_29 -> V_545 ) ,
F_76 ( V_29 -> V_546 ) , V_90 -> V_348 ) ;
F_3 ( V_99 L_173
L_174 , V_6 -> V_35 , V_511 ,
V_508 , V_512 , V_506 ) ;
if ( V_506 & V_543 ) {
struct V_547 V_548 ;
F_196 ( V_90 -> V_451 , & V_548 ) ;
F_3 ( V_99 L_175
L_176 , V_6 -> V_35 , V_548 . V_549 ,
V_548 . V_550 , V_548 . V_447 , F_76 ( V_29 -> V_551 ) ) ;
}
if ( V_506 & V_539 ) {
V_504 = F_76 ( V_29 -> V_552 ) ;
V_505 = ( T_6 * ) & V_504 ;
F_103 ( V_6 , V_505 [ 0 ] ) ;
}
}
...
F_128 ( V_562 , V_70 , L_179 ) ;
F_21 ( & V_6 -> V_66 , V_65 ) ;
if ( V_6 -> V_563 -> V_564 == V_565 )
F_199 ( V_6 , V_27 ) ;
V_226 = F_53 ( T_31 , V_566 ) +
sizeof( T_32 ) ;
V_561 = F_69 ( V_226 , V_361 ) ;
if ( ! V_561 ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
return;
...
V_573 = F_76 ( V_29 -> V_546 ) ;
F_205 ( V_90 , F_52 ( V_90 ) - V_573 ) ;
if ( V_30 & V_576 )
V_514 = F_76 ( V_29 -> V_337 ) ;
else
V_514 = 0 ;
V_30 &= V_39 ;
V_508 = V_29 -> V_509 ;
if ( V_30 == V_520 && V_573 == 0 &&
( V_508 == V_531 ||
V_508 == V_534 ||
V_508 == V_536 ) ) {
V_30 = V_40 ;
...
if ( V_506 & V_543 ) {
struct V_547 V_548 ;
const void * V_577 = F_206 ( V_6 ,
V_88 ) ;
T_10 V_226 = F_207 ( T_10 , V_496 ,
F_76 ( V_29 -> V_551 ) ) ;
memcpy ( V_90 -> V_451 , V_577 , V_226 ) ;
F_196 ( V_90 -> V_451 , & V_548 ) ;
if ( V_548 . V_550 == 0x5D )
F_200 ( V_6 ,
F_9 ( V_29 -> V_233 ) ) ;
...
break;
case V_524 :
if ( ( V_573 == 0 ) || ( V_90 -> V_544 > V_573 ) )
V_90 -> V_348 = V_582 << 16 ;
else
V_90 -> V_348 = ( V_574 << 16 ) | V_508 ;
break;
case V_520 :
V_90 -> V_348 = ( V_574 << 16 ) | V_508 ;
if ( ( V_506 & V_543 ) )
...
V_90 -> V_348 = V_351 << 16 ;
else if ( ! V_573 && V_90 -> V_465 [ 0 ] == V_583 ) {
V_29 -> V_507 = V_543 ;
V_29 -> V_509 = V_455 ;
V_90 -> V_348 = ( V_453 << 24 ) |
V_455 ;
...
static int
F_228 ( struct V_5 * V_6 , T_4 V_27 , T_6 V_645 , T_6 V_646 )
{
T_9 V_29 ;
T_8 V_28 ;
T_37 V_599 ;
...
V_591 = V_360 -> V_380 [ V_92 ] . V_656 >> 4 ;
V_652 = V_360 -> V_380 [ V_92 ] . V_656 & 0xF ;
F_3 ( V_7 L_216
L_217 , V_378 ,
V_27 , V_651 , V_591 , V_652 ) ;
}
}
static void
...
V_616 = F_9 ( V_360 -> V_403 ) ;
if ( V_360 -> V_404 == V_411 )
if ( F_219 ( V_6 , V_616 ) != 0 )
return;
F_18 ( & V_6 -> V_80 , V_65 ) ;
V_79 = F_33 ( V_6 ,
V_616 ) ;
...
F_3 ( V_58 L_236
L_237 ,
V_6 -> V_35 , V_660 , F_9 ( V_360 -> V_233 ) ,
( unsigned long long ) F_6 ( V_360 -> V_11 ) ,
F_9 ( V_360 -> V_545 ) ) ;
if ( V_360 -> V_417 == V_571 )
F_3 ( V_58 L_238 , V_6 -> V_35 ,
V_360 -> V_572 , V_360 -> V_673 ) ;
F_3 ( V_7 L_239 ) ;
}
static void
...
L_246 , V_6 -> V_35 , V_36 , V_360 -> V_648 ,
V_360 -> V_683 ) ) ;
F_147 ( V_6 ) ;
F_18 ( & V_6 -> V_91 , V_65 ) ;
V_29 = V_6 -> V_294 . V_293 ;
...
#endif
if ( V_360 -> V_417 == V_690 &&
! V_6 -> V_31 . V_32 ) {
if ( V_692 > 0 && V_6 -> V_317 ) {
while ( V_6 -> V_317 )
F_240 ( 1 ) ;
}
F_212 ( V_6 ) ;
...
static void
F_241 ( struct V_138 * V_139 , void * V_182 )
{
int V_20 ;
...
T_6 V_694 ;
int V_92 ;
char * V_660 = NULL , * V_695 = NULL ;
V_414 = ( T_26 * ) & V_360 -> V_415 [ 0 ] ;
F_3 ( V_58 L_268 ,
V_6 -> V_35 , ( F_76 ( V_360 -> V_183 ) &
V_421 ) ?
L_269 : L_270 , V_360 -> V_416 ) ;
for ( V_92 = 0 ; V_92 < V_360 -> V_416 ; V_92 ++ , V_414 ++ ) {
switch ( V_414 -> V_417 ) {
case V_696 :
V_660 = L_203 ;
...
if ( V_6 -> V_317 )
return;
if ( V_360 -> V_417 != V_710 )
return;
V_27 = F_9 ( V_360 -> V_423 ) ;
V_200 = F_76 ( V_360 -> V_425 ) ;
if ( ! V_6 -> V_273 )
F_23 ( V_6 , F_3 ( V_58 L_50
L_283 , V_6 -> V_35 , V_36 , V_27 ,
...
V_729 . V_203 == V_205 ||
V_729 . V_203 == V_207 ) {
memset ( & V_414 , 0 , sizeof( T_26 ) ) ;
V_414 . V_417 = V_696 ;
V_414 . V_420 = V_728 . V_233 ;
F_243 ( V_6 , & V_414 ) ;
}
}
V_742:
...
void
F_269 ( struct V_5 * V_6 , int V_743 )
{
switch ( V_743 ) {
case V_744 :
...
static void
V_359 ( struct V_747 * V_748 )
{
struct V_353 * V_354 = F_270 ( V_748 ,
struct V_353 , V_358 . V_748 ) ;
...
switch ( V_354 -> V_362 ) {
case V_363 :
while ( F_271 ( V_6 -> V_142 ) || V_6 -> V_317 )
F_240 ( 1 ) ;
F_265 ( V_6 ) ;
F_268 ( V_6 ) ;
break;
...
memcpy ( V_354 -> V_360 , V_29 -> V_566 ,
V_226 ) ;
V_354 -> V_6 = V_6 ;
V_354 -> V_502 = V_29 -> V_502 ;
...
static void
F_274 ( struct V_773 * V_563 )
{
struct V_141 * V_142 = F_275 ( V_563 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
struct V_774 * V_775 ;
unsigned long V_65 ;
V_6 -> V_318 = 1 ;
...
static void T_50
F_278 ( struct V_773 * V_563 )
{
struct V_141 * V_142 = F_275 ( V_563 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
struct V_368 * V_369 , * V_776 ;
...
static int
F_291 ( struct V_773 * V_563 , const struct V_788 * V_72 )
{
struct V_5 * V_6 ;
struct V_141 * V_142 ;
V_142 = F_292 ( & V_789 ,
...
V_6 -> V_142 = V_142 ;
V_6 -> V_72 = V_792 ++ ;
sprintf ( V_6 -> V_35 , L_345 , V_793 , V_6 -> V_72 ) ;
V_6 -> V_563 = V_563 ;
if ( V_72 -> V_43 == V_794 ) {
V_6 -> V_175 = 1 ;
V_6 -> V_273 = 1 ;
...
F_3 ( V_58 L_351
L_352 , V_6 -> V_35 , V_142 -> V_808 ) ;
}
}
if ( ( F_295 ( V_142 , & V_563 -> V_169 ) ) ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
F_19 ( & V_6 -> V_67 ) ;
goto V_809;
...
static int
F_301 ( struct V_773 * V_563 , T_51 V_200 )
{
struct V_141 * V_142 = F_275 ( V_563 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
T_52 V_819 ;
F_302 ( V_6 ) ;
F_303 ( V_142 ) ;
V_819 = F_304 ( V_563 , V_200 ) ;
F_3 ( V_58 L_354
L_355 , V_6 -> V_35 , V_563 ,
F_305 ( V_563 ) , V_819 ) ;
F_306 ( V_6 ) ;
F_307 ( V_563 ) ;
F_308 ( V_563 ) ;
...
static int
F_310 ( struct V_773 * V_563 )
{
struct V_141 * V_142 = F_275 ( V_563 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
T_52 V_819 = V_563 -> V_820 ;
int V_74 ;
F_3 ( V_58 L_356
L_355 , V_6 -> V_35 , V_563 ,
F_305 ( V_563 ) , V_819 ) ;
...
static T_53
F_315 ( struct V_773 * V_563 , T_54 V_200 )
{
struct V_141 * V_142 = F_275 ( V_563 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
F_3 ( V_58 L_357 ,
