...
static int F_48 ( struct V_3 * V_62 )
{
...
F_21 ( & V_9 -> V_99 ) ;
F_21 ( & V_9 -> V_100 ) ;
V_92 = F_49 ( V_62 , V_9 , V_23 , V_25 ) ;
if ( V_92 < 0 )
return V_92 ;
return 0 ;
}
static void F_50 ( struct V_3 * V_62 )
{
struct V_8 * V_9 = & V_62 -> V_91 ;
F_51 ( V_62 , V_9 ) ;
}
