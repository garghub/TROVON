...
static int T_5 F_86 ( struct V_7 * V_4 , int V_23 )
{
struct V_1 * V_2 = NULL ;
struct V_45 * V_15 ;
int V_212 ;
...
V_15 -> V_220 = 24000000 ;
if ( V_4 -> V_21 -> V_221 )
V_15 -> V_220 = F_89 ( V_4 -> V_21 -> V_221 , V_15 -> V_220 ) ;
...
static int T_5 F_101 ( struct V_233 * V_234 )
{
...
V_141 = F_102 ( V_234 , V_242 , 0 ) ;
V_127 = F_103 ( V_234 , 0 ) ;
if ( V_141 == NULL || V_127 < 0 )
return - V_241 ;
V_141 = F_104 ( V_141 -> V_243 , F_105 ( V_141 ) ,
V_234 -> V_47 ) ;
if ( V_141 == NULL )
return - V_244 ;
V_4 = F_106 ( sizeof( struct V_7 ) , V_245 ) ;
if ( V_4 == NULL ) {
V_240 = - V_213 ;
goto V_246;
}
F_107 ( & V_4 -> V_26 , F_14 ) ;
F_107 ( & V_4 -> V_99 , F_33 ) ;
F_107 ( & V_4 -> V_125 , F_42 ) ;
F_92 ( & V_4 -> V_71 , F_45 ,
( unsigned long ) V_4 ) ;
F_108 ( & V_4 -> V_10 ) ;
F_92 ( & V_4 -> V_17 , F_49 , ( unsigned long ) V_4 ) ;
F_108 ( & V_4 -> V_111 ) ;
F_108 ( & V_4 -> V_14 ) ;
F_109 ( & V_4 -> V_16 ) ;
V_4 -> V_21 = V_21 ;
...
V_4 -> V_168 = 1 ;
V_4 -> V_127 = V_127 ;
V_4 -> V_183 = V_4 -> V_247 -> V_243 ;
V_4 -> V_137 = F_111 ( V_141 -> V_243 , F_105 ( V_141 ) ) ;
if ( ! V_4 -> V_137 )
goto V_248;
V_4 -> V_249 = F_112 ( & V_234 -> V_41 , L_35 ) ;
if ( F_113 ( V_4 -> V_249 ) ) {
V_240 = F_114 ( V_4 -> V_249 ) ;
goto V_250;
}
F_5 ( V_4 -> V_249 ) ;
V_4 -> V_11 = F_112 ( & V_234 -> V_41 , L_36 ) ;
if ( F_113 ( V_4 -> V_11 ) ) {
V_240 = F_114 ( V_4 -> V_11 ) ;
goto V_251;
}
F_115 ( V_238 ) ;
F_116 ( V_252 , V_238 ) ;
...
V_4 -> V_93 = F_117 ( V_238 , V_257 , & V_239 ) ;
#if 0
if (!host->dma_tx) {
...
V_4 -> V_95 = F_117 ( V_238 , V_257 , & V_239 ) ;
#if 0
if (!host->dma_rx) {
...
V_239 ) ;
#endif
V_240 = F_119 ( V_4 -> V_127 , F_57 , 0 , V_262 , V_4 ) ;
if ( V_240 )
goto V_263;
if ( V_21 -> V_264 != NULL ) {
V_240 = V_21 -> V_264 ( & V_234 -> V_41 ) ;
if ( V_240 < 0 )
goto V_265;
}
V_4 -> V_35 = V_21 -> V_35 ;
V_4 -> V_266 = ( F_120 () ? 1 : 2 ) ;
V_4 -> V_38 = F_121 ( L_39 , 0 , 0 ) ;
if ( ! V_4 -> V_38 )
goto V_267;
...
F_127 ( V_4 ) ;
V_246:
F_128 ( V_141 -> V_243 , F_105 ( V_141 ) ) ;
return V_240 ;
}
static int T_7 F_129 ( struct V_233 * V_234 )
{
struct V_7 * V_4 = F_130 ( V_234 ) ;
int V_32 ;
F_110 ( V_234 , NULL ) ;
F_18 ( V_4 == NULL ) ;
for ( V_32 = 0 ; V_32 < V_4 -> V_35 ; V_32 ++ )
...
F_124 ( V_4 -> V_95 ) ;
F_126 ( V_4 -> V_137 ) ;
F_128 ( V_234 -> V_237 [ 0 ] . V_243 ,
V_234 -> V_237 [ 0 ] . V_270 - V_234 -> V_237 [ 0 ] . V_243 + 1 ) ;
F_122 ( V_4 -> V_38 ) ;
F_127 ( V_4 ) ;
return 0 ;
}
static int F_131 ( struct V_233 * V_234 , T_8 V_271 )
{
int V_32 , V_240 = 0 ;
struct V_7 * V_4 = F_130 ( V_234 ) ;
