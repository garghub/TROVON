...
F_114 ( V_132 , V_312 ,
L_28
L_29 , V_312 -> type , V_315 - 1 ) ;
error = - V_39 ;
goto V_314;
}
static int
F_115 ( struct V_8 * V_319 , struct V_320 * V_321 )
{
struct V_251 * V_312 = F_116 ( V_319 -> V_322 ) ;
struct V_311 * V_43 ;
T_1 * V_12 = NULL ;
...
error = F_119 ( V_323 , F_76 ( V_246 , V_12 -> V_247 ) , 1 ) ;
if ( error )
goto V_329;
V_12 -> V_323 = V_323 ;
if ( V_330 ) {
struct V_8 * V_331 ;
V_331 = F_120 ( V_332 , V_319 -> V_322 ,
F_76 ( V_246 ,
V_12 -> V_247 ) ,
V_12 , L_33 , V_43 -> V_44 ) ;
if ( F_17 ( V_331 ) ) {
...
static void F_125 ( struct V_337 * V_337 )
{
struct V_338 * V_12 = F_89 ( V_337 , struct V_338 , V_318 ) ;
unsigned long V_13 ;
F_99 ( & V_18 , V_13 ) ;
F_113 ( & V_313 , V_12 -> V_247 ) ;
F_100 ( & V_18 , V_13 ) ;
...
static void F_126 ( struct V_8 * V_319 , struct V_320 * V_321 )
{
struct V_251 * V_312 = F_116 ( V_319 -> V_322 ) ;
T_1 * V_12 = F_127 ( V_319 ) ;
unsigned long V_166 ;
T_2 * V_5 ;
if ( ! V_12 || V_12 -> V_38 )
return;
...
F_25 ( & V_5 -> V_66 ) ;
F_102 ( & V_5 -> V_264 , V_309 , V_339 ) ;
}
F_100 ( & V_18 , V_166 ) ;
F_129 ( & V_312 -> V_334 . V_335 , L_36 ) ;
F_130 ( V_332 , F_76 ( V_246 , V_12 -> V_247 ) ) ;
F_124 ( V_12 -> V_323 ) ;
V_12 -> V_323 = NULL ;
F_28 ( V_12 ) ;
}
...
V_344 = V_345 ;
V_340 = F_132 ( F_76 ( V_246 , 0 ) ,
V_315 , L_43 ) ;
if ( V_340 )
return V_340 ;
V_332 = F_133 ( V_326 , L_44 ) ;
if ( F_17 ( V_332 ) ) {
V_340 = F_18 ( V_332 ) ;
goto V_101;
}
...
int V_347 = V_52 -> V_121 ;
unsigned int V_348 = V_52 -> V_120 ;
T_12 * V_349 = & V_50 -> V_72 ;
T_12 * V_271 = & V_5 -> V_140 ;
struct V_23 * V_24 = V_5 -> V_7 -> V_8 -> V_23 ;
struct V_350 * V_351 , V_352 ;
int V_353 = V_52 -> V_121 == V_123 ? V_354 : V_355 ;
F_14 ( 4 , F_15 ( V_299 L_45 ,
V_126 ) ) ;
V_151 = F_143 ( V_24 , V_353 , V_356 ) ;
if ( ! V_151 )
return - V_42 ;
...
V_151 -> V_359 = V_360 ;
if ( ( V_126 <= 0 ) || ( V_347 == V_125 ) )
return 0 ;
if ( V_361 && V_52 -> V_13 & V_142 &&
V_347 != V_154 && ! V_348 &&
...
if ( V_348 ) {
int V_99 , V_365 = sizeof( struct V_366 ) * V_348 ;
struct V_367 * V_368 ;
V_368 = F_147 ( V_52 -> V_127 , V_365 ) ;
if ( F_17 ( V_368 ) )
return F_18 ( V_368 ) ;
V_99 = F_148 ( V_368 , V_348 ) ;
if ( V_52 -> V_126 < V_99 ) {
V_348 = F_149 ( V_368 , V_348 , V_52 -> V_126 ) ;
V_99 = V_52 -> V_126 ;
}
V_25 = F_150 ( V_24 , V_151 , V_351 , (struct V_366 * ) V_368 ,
V_348 ,
V_99 , V_356 ) ;
F_35 ( V_368 ) ;
} else
V_25 = F_151 ( V_24 , V_151 , V_351 , V_52 -> V_127 ,
V_52 -> V_126 , V_356 ) ;
if ( ! V_25 ) {
...
T_2 * V_5 = V_50 -> V_294 ;
T_12 * V_349 = & V_50 -> V_72 ;
F_14 ( 4 , F_15 ( L_46 , ( int ) V_50 -> V_371 ) ) ;
if ( V_50 -> V_151 ) {
if ( V_50 -> V_150 )
...
static int
F_155 ( T_12 * V_372 , const T_2 * V_5 , int V_373 )
{
int V_374 = V_373 * sizeof( struct V_281 * ) ;
T_16 V_375 = V_356 | V_376 ;
V_372 -> V_282 = F_106 ( V_374 , V_375 ) ;
if ( ! V_372 -> V_282 )
return - V_42 ;
V_372 -> V_377 = V_374 ;
return V_373 ;
...
static int
F_146 ( T_12 * V_372 , T_2 * V_5 , int V_378 )
{
int V_379 = 0 , V_380 , V_111 , V_381 , V_382 , V_383 ;
...
if ( 0 == V_384 )
++ V_384 ;
V_384 = F_156 ( V_384 , V_388 ) ;
F_14 ( 4 , F_15 ( L_47 ,
V_378 , V_384 ) ) ;
V_383 = F_155 ( V_372 , V_5 , V_41 ) ;
if ( V_383 < 0 )
return V_383 ;
V_382 = V_341 ;
if ( F_91 ( V_382 != V_343 ) ) {
...
V_391:
V_379 = 1 << ( V_276 + V_385 ) ;
for ( V_111 = 0 , V_381 = V_384 ; V_381 > 0 && V_111 < V_383 ;
V_111 ++ , V_381 -= V_379 ) {
V_382 = ( V_381 > V_343 ) ?
V_343 : V_381 ;
V_372 -> V_282 [ V_111 ] = F_158 ( V_386 , V_385 ) ;
if ( ! V_372 -> V_282 [ V_111 ] )
goto V_314;
if ( V_382 == V_343 ) {
if ( F_91 ( V_379 > V_343 ) ) {
V_341 = V_379 ;
...
return 0 ;
V_314:
for ( V_380 = 0 ; V_380 < V_111 ; V_380 ++ )
F_159 ( V_372 -> V_282 [ V_380 ] , V_385 ) ;
if ( -- V_385 >= 0 )
goto V_391;
return - V_42 ;
}
...
F_63 ( T_12 * V_372 )
{
F_14 ( 4 , F_15 ( L_52 , V_372 -> V_277 ) ) ;
if ( V_372 -> V_282 && V_372 -> V_377 > 0 ) {
if ( ! V_372 -> V_369 ) {
int V_111 ;
for ( V_111 = 0 ; V_111 < V_372 -> V_277 && V_372 -> V_282 [ V_111 ] ; V_111 ++ ) {
F_14 ( 5 , F_15 (
L_53 ,
V_111 , V_372 -> V_282 [ V_111 ] ) ) ;
F_159 ( V_372 -> V_282 [ V_111 ] , V_372 -> V_279 ) ;
}
F_35 ( V_372 -> V_282 ) ;
}
}
...
static int
F_39 ( T_7 * V_50 , char T_4 * V_392 , int V_393 )
{
T_12 * V_372 = & V_50 -> V_72 ;
int V_111 , V_382 ;
F_14 ( 4 , F_15 ( L_54 ,
V_393 ) ) ;
if ( ( ! V_392 ) || ( V_393 <= 0 ) )
...
for ( V_111 = 0 ; V_111 < V_372 -> V_277 && V_372 -> V_282 [ V_111 ] ; V_111 ++ ) {
if ( V_382 > V_393 ) {
if ( F_38 ( V_392 , F_160 ( V_372 -> V_282 [ V_111 ] ) ,
V_393 ) )
return - V_56 ;
break;
} else {
...
static void
F_64 ( T_2 * V_5 , int V_394 )
{
T_12 * V_372 = & V_5 -> V_140 ;
F_14 ( 4 , F_15 ( L_55 , V_394 ) ) ;
do {
if ( V_394 < V_342 )
V_394 = V_342 ;
if ( 0 == F_146 ( V_372 , V_5 , V_394 ) )
return;
else
F_63 ( V_372 ) ;
V_394 >>= 1 ;
...
static void
F_145 ( T_2 * V_5 , T_7 * V_50 , int V_365 )
{
T_12 * V_349 = & V_50 -> V_72 ;
T_12 * V_271 = & V_5 -> V_140 ;
int V_111 , V_382 , V_395 ;
V_50 -> V_371 = 1 ;
F_14 ( 4 , F_15 ( L_56 , V_365 ) ) ;
V_395 = V_365 ;
...
unsigned long V_166 ;
F_99 ( & V_5 -> V_160 , V_166 ) ;
for ( V_397 = V_5 -> V_196 ; V_397 ; V_397 = V_397 -> V_197 ) {
if ( ( 1 == V_397 -> V_161 ) && ( ! V_397 -> V_134 ) &&
( ( - 1 == V_64 ) || ( V_397 -> V_67 . V_64 == V_64 ) ) ) {
V_397 -> V_161 = 2 ;
break;
}
}
...
for ( V_111 = 0 ; V_111 < V_214 ; ++ V_111 , ++ V_398 ) {
if ( ! V_398 -> V_294 )
break;
}
if ( V_111 < V_214 ) {
...
V_400 = V_5 -> V_196 ;
if ( V_50 == V_400 ) {
V_5 -> V_196 = V_400 -> V_197 ;
V_400 -> V_294 = NULL ;
V_25 = 1 ;
} else {
while ( ( V_398 = V_400 -> V_197 ) ) {
if ( V_50 == V_398 ) {
V_400 -> V_197 = V_398 -> V_197 ;
V_398 -> V_294 = NULL ;
V_25 = 1 ;
break;
}
...
unsigned long V_166 ;
int V_141 ;
V_5 = F_106 ( sizeof( * V_5 ) , V_356 | V_376 ) ;
if ( ! V_5 )
return NULL ;
F_111 ( & V_5 -> V_66 ) ;
F_161 ( & V_5 -> V_160 ) ;
...
V_5 -> V_7 = V_12 ;
F_99 ( & V_18 , V_166 ) ;
F_162 ( & V_5 -> V_407 , & V_12 -> V_19 ) ;
F_100 ( & V_18 , V_166 ) ;
F_14 ( 3 , F_15 ( L_59 , V_5 ) ) ;
if ( F_91 ( V_345 != V_344 ) )
V_345 = V_344 ;
V_141 = F_67 ( int , V_345 ,
F_68 ( V_12 -> V_8 -> V_23 ) * 512 ) ;
F_64 ( V_5 , V_141 ) ;
F_14 ( 3 , F_15 ( L_60 ,
...
static void F_164 ( struct V_290 * V_291 )
{
struct V_4 * V_5 = F_89 ( V_291 , struct V_4 , V_293 . V_291 ) ;
struct V_338 * V_12 = V_5 -> V_7 ;
while ( V_5 -> V_196 )
F_40 ( V_5 -> V_196 ) ;
...
static void V_46 ( struct V_337 * V_337 )
{
struct V_4 * V_5 = F_89 ( V_337 , struct V_4 , V_45 ) ;
struct V_338 * V_12 = V_5 -> V_7 ;
unsigned long V_166 ;
F_99 ( & V_18 , V_166 ) ;
F_166 ( & V_5 -> V_407 ) ;
...
unsigned long V_166 ;
F_8 ( & V_18 , V_166 ) ;
F_169 ( & V_313 , F_167 , & V_111 ) ;
F_10 ( & V_18 , V_166 ) ;
return V_111 + 1 ;
}
static T_1 * F_170 ( int V_21 )
{
return F_171 ( & V_313 , V_21 ) ;
}
...
static void F_28 ( struct V_338 * V_12 )
{
F_30 ( & V_12 -> V_318 , F_125 ) ;
}
static int
F_136 ( void )
{
int V_408 = F_172 ( V_409 ) ;
int V_111 ;
V_410 = F_173 ( V_411 , NULL ) ;
if ( ! V_410 )
return 1 ;
for ( V_111 = 0 ; V_111 < V_408 ; ++ V_111 ) {
const struct V_412 * V_413 = & V_409 [ V_111 ] ;
T_17 V_414 = V_413 -> V_415 -> V_416 ? V_417 | V_418 : V_417 ;
F_174 ( V_413 -> V_419 , V_414 , V_410 , V_413 -> V_415 ) ;
}
return 0 ;
}
static void
...
return;
for ( V_111 = 0 ; V_111 < V_408 ; ++ V_111 )
F_175 ( V_409 [ V_111 ] . V_419 , V_410 ) ;
F_175 ( V_411 , NULL ) ;
}
static int F_176 ( struct V_420 * V_421 , void * V_422 )
{
F_177 ( V_421 , L_63 , * ( ( int * ) V_421 -> V_423 ) ) ;
return 0 ;
}
static int F_178 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_179 ( V_1 , F_176 , & V_361 ) ;
}
static T_3
...
{
return F_179 ( V_1 , F_176 , & V_345 ) ;
}
static T_3
F_183 ( struct V_1 * V_2 , const char T_4 * V_424 ,
T_5 V_48 , T_6 * V_425 )
{
int V_98 ;
unsigned long V_111 = V_426 ;
if ( ! F_70 ( V_232 ) || ! F_70 ( V_233 ) )
return - V_234 ;
V_98 = F_181 ( V_424 , V_48 , 0 , & V_111 ) ;
if ( V_98 )
return V_98 ;
if ( V_111 <= 1048576 ) {
V_345 = V_111 ;
...
static int F_184 ( struct V_420 * V_421 , void * V_422 )
{
F_177 ( V_421 , L_64 , V_210 , V_428 ,
V_429 ) ;
return 0 ;
}
...
static int F_186 ( struct V_420 * V_421 , void * V_422 )
{
F_177 ( V_421 , L_65
L_66 ) ;
return 0 ;
...
static void * F_188 ( struct V_420 * V_421 , T_6 * V_430 )
{
struct V_431 * V_432 = F_33 ( sizeof( * V_432 ) , V_59 ) ;
V_421 -> V_423 = V_432 ;
if ( ! V_432 )
return NULL ;
V_432 -> V_247 = * V_430 ;
V_432 -> V_433 = F_168 () ;
if ( V_432 -> V_247 >= V_432 -> V_433 )
return NULL ;
return V_432 ;
}
static void * F_189 ( struct V_420 * V_421 , void * V_422 , T_6 * V_430 )
{
struct V_431 * V_432 = V_421 -> V_423 ;
* V_430 = ++ V_432 -> V_247 ;
return ( V_432 -> V_247 < V_432 -> V_433 ) ? V_432 : NULL ;
}
static void F_190 ( struct V_420 * V_421 , void * V_422 )
{
F_35 ( V_421 -> V_423 ) ;
}
static int F_191 ( struct V_20 * V_20 , struct V_1 * V_1 )
{
return F_192 ( V_1 , & V_434 ) ;
}
...
unsigned long V_166 ;
F_8 ( & V_18 , V_166 ) ;
V_12 = V_432 ? F_170 ( V_432 -> V_247 ) : NULL ;
...
{
return F_192 ( V_1 , & V_436 ) ;
}
static int F_196 ( struct V_420 * V_421 , void * V_422 )
{
struct V_431 * V_432 = (struct V_431 * ) V_422 ;
T_1 * V_12 ;
struct V_251 * V_312 ;
...
if ( V_12 && ( V_312 = V_12 -> V_8 ) && ( ! V_12 -> V_38 ) )
F_177 ( V_421 , L_69 ,
V_312 -> V_437 , V_312 -> V_438 , V_312 -> V_439 ) ;
else
F_177 ( V_421 , L_70 ) ;
F_10 ( & V_18 , V_166 ) ;
return 0 ;
}
static void F_197 ( struct V_420 * V_421 , T_1 * V_12 )
{
int V_111 , V_440 , V_441 , V_442 , V_443 ;
T_7 * V_50 ;
T_2 * V_444 ;
const T_8 * V_52 ;
const char * V_445 ;
...
F_54 ( V_444 -> V_69 ) ,
V_444 -> V_140 . V_141 ,
( int ) V_444 -> V_140 . V_277 ,
( int ) V_444 -> V_176 ) ;
F_177 ( V_421 , L_73 ,
( int ) V_444 -> V_137 , ( int ) V_444 -> V_57 ,
( int ) V_444 -> V_206 ) ;
for ( V_440 = 0 , V_50 = V_444 -> V_196 ;
V_50 != NULL ;
++ V_440 , V_50 = V_50 -> V_197 ) {
V_52 = & V_50 -> V_67 ;
V_441 = ( V_52 -> V_68 == '\0' ) ? 0 : 1 ;
if ( V_50 -> V_371 ) {
if ( V_441 &&
( V_139 & V_52 -> V_13 ) )
V_445 = L_74 ;
...
F_177 ( V_421 , V_445 ) ;
V_442 = V_50 -> V_72 . V_141 ;
V_443 = V_50 -> V_72 . V_277 ;
F_177 ( V_421 , V_50 -> V_161 ?
( ( 1 == V_50 -> V_161 ) ? L_78 : L_79 )
: L_80 ) ;
F_177 ( V_421 , L_81 ,
V_50 -> V_67 . V_64 , V_442 ) ;
if ( V_50 -> V_161 )
F_177 ( V_421 , L_82 , V_52 -> V_157 ) ;
else {
V_216 = F_54 ( V_158 ) ;
F_177 ( V_421 , L_83 ,
( V_441 ? V_52 -> V_69 :
...
{
return F_192 ( V_1 , & V_447 ) ;
}
static int F_201 ( struct V_420 * V_421 , void * V_422 )
{
struct V_431 * V_432 = (struct V_431 * ) V_422 ;
T_1 * V_12 ;
unsigned long V_166 ;
if ( V_432 && ( 0 == V_432 -> V_247 ) ) {
F_177 ( V_421 , L_86 ,
( int ) V_432 -> V_433 ) ;
F_177 ( V_421 , L_87 , V_345 ) ;
}
F_8 ( & V_18 , V_166 ) ;
V_12 = V_432 ? F_170 ( V_432 -> V_247 ) : NULL ;
if ( V_12 && ! F_9 ( & V_12 -> V_19 ) ) {
struct V_251 * V_312 = V_12 -> V_8 ;
F_177 ( V_421 , L_88 , V_12 -> V_43 -> V_44 ) ;
if ( V_12 -> V_38 )
F_177 ( V_421 , L_89 ) ;
else
F_177
