...
if ( ! F_22 ( V_3 , & V_8 -> V_88 [ V_89 ] ) ) {
F_23 ( V_3 , L_12 ) ;
return 0 ;
}
F_16 ( V_3 , L_13 ) ;
F_27 ( V_3 , & V_8 -> V_88 [ V_89 ] ) ;
return - V_84 ;
}
static bool F_29 ( struct V_90 * V_91 ,
struct V_92 * V_93 , void * V_34 )
{
struct V_2 * V_3 =
F_30 ( V_91 , struct V_2 , V_91 ) ;
struct V_94 * V_95 = V_34 ;
struct V_96 * V_97 ;
V_97 = ( void * ) V_93 -> V_34 ;
F_23 ( V_3 , L_14
L_15 ,
...
V_3 -> V_101 . V_104 =
F_26 ( V_97 -> V_105 ) ;
V_95 -> V_106 = V_97 -> V_100 ;
V_95 -> V_107 = V_97 -> V_98 == V_108 ;
return true ;
}
...
static bool F_38 ( struct V_90 * V_91 ,
struct V_92 * V_93 , void * V_34 )
{
struct V_2 * V_3 = V_34 ;
struct V_118 * V_13 ;
int V_33 ;
if ( V_93 -> V_13 . V_10 != V_119 ) {
F_39 ( V_93 -> V_13 . V_10 != V_120 ) ;
return true ;
}
V_13 = (struct V_118 * ) V_93 -> V_34 ;
V_33 = F_26 ( V_93 -> V_121 ) & V_122 ;
V_33 -= sizeof( T_3 ) ;
...
{
struct V_109 V_124 ;
static const T_2 V_125 [] = {
V_119 ,
V_120
} ;
int V_43 ;
F_41 ( & V_3 -> V_126 ) ;
if ( ! V_3 -> V_7 -> V_8 [ V_127 ] . V_88 [ 0 ] . V_33 )
return 0 ;
if ( V_3 -> V_128 )
return 0 ;
F_32 ( & V_3 -> V_91 , & V_124 ,
