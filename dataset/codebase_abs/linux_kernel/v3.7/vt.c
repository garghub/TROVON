...
{
F_64 ( V_5 , V_174 , V_5 -> V_178 ? ( V_5 -> V_158 + V_175 ) : V_175 ) ;
}
...
static void F_90 ( const char * V_14 , struct V_137 * V_138 )
{
while ( * V_14 ) {
F_91 ( V_138 , * V_14 , 0 ) ;
V_14 ++ ;
...
static void F_93 ( struct V_4 * V_5 , struct V_137 * V_138 )
{
char V_192 [ 40 ] ;
sprintf ( V_192 , L_2 , V_5 -> V_82 + ( V_5 -> V_178 ? V_5 -> V_158 + 1 : 1 ) , V_5 -> V_77 + 1 ) ;
F_90 ( V_192 , V_138 ) ;
}
static inline void F_94 ( struct V_137 * V_138 )
{
F_90 ( L_3 , V_138 ) ;
}
...
void F_96 ( struct V_137 * V_138 , int V_194 , int V_195 , int V_196 )
{
char V_192 [ 8 ] ;
...
static void F_98 ( struct V_4 * V_5 , int V_198 )
{
int V_79 ;
for ( V_79 = 0 ; V_79 <= V_5 -> V_182 ; V_79 ++ )
if ( V_5 -> V_199 ) {
...
V_5 -> V_186 = V_5 -> V_224 ;
V_5 -> V_187 = V_5 -> V_225 ;
V_5 -> V_184 = F_89 ( V_5 -> V_185 ? V_5 -> V_187 : V_5 -> V_186 , V_5 ) ;
F_26 ( V_5 ) ;
V_5 -> V_78 = 0 ;
}
static void F_109 ( struct V_4 * V_5 , int V_226 )
{
V_5 -> V_158 = 0 ;
V_5 -> V_159 = V_5 -> V_27 ;
V_5 -> V_227 = V_228 ;
V_5 -> V_199 = 0 ;
V_5 -> V_184 = F_89 ( V_229 , V_5 ) ;
V_5 -> V_186 = V_229 ;
V_5 -> V_187 = V_230 ;
V_5 -> V_185 = 0 ;
V_5 -> V_78 = 0 ;
...
static void F_111 ( struct V_137 * V_138 , struct V_4 * V_5 , int V_9 )
{
switch ( V_9 ) {
case 0 :
return;
...
case 14 :
V_5 -> V_185 = 1 ;
V_5 -> V_184 = F_89 ( V_5 -> V_187 , V_5 ) ;
V_5 -> V_188 = 1 ;
return;
case 15 :
V_5 -> V_185 = 0 ;
V_5 -> V_184 = F_89 ( V_5 -> V_186 , V_5 ) ;
V_5 -> V_188 = 0 ;
return;
case 24 : case 26 :
V_5 -> V_227 = V_228 ;
...
if ( V_5 -> V_183 [ 0 ] )
V_5 -> V_183 [ 0 ] -- ;
F_64 ( V_5 , V_5 -> V_183 [ 0 ] , V_5 -> V_82 ) ;
return;
case 'A' :
if ( ! V_5 -> V_183 [ 0 ] )
V_5 -> V_183 [ 0 ] ++ ;
F_64 ( V_5 , V_5 -> V_77 , V_5 -> V_82 - V_5 -> V_183 [ 0 ] ) ;
return;
case 'B' : case 'e' :
if ( ! V_5 -> V_183 [ 0 ] )
V_5 -> V_183 [ 0 ] ++ ;
...
if ( ! V_5 -> V_183 [ 0 ] )
V_5 -> V_183 [ 0 ] ++ ;
F_64 ( V_5 , V_5 -> V_77 + V_5 -> V_183 [ 0 ] , V_5 -> V_82 ) ;
return;
case 'D' :
if ( ! V_5 -> V_183 [ 0 ] )
V_5 -> V_183 [ 0 ] ++ ;
...
if ( ! V_5 -> V_183 [ 0 ] )
V_5 -> V_183 [ 0 ] ++ ;
F_64 ( V_5 , 0 , V_5 -> V_82 + V_5 -> V_183 [ 0 ] ) ;
return;
case 'F' :
if ( ! V_5 -> V_183 [ 0 ] )
V_5 -> V_183 [ 0 ] ++ ;
...
if ( V_5 -> V_183 [ 1 ] )
V_5 -> V_183 [ 1 ] -- ;
F_76 ( V_5 , V_5 -> V_183 [ 1 ] , V_5 -> V_183 [ 0 ] ) ;
return;
case 'J' :
F_84 ( V_5 , V_5 -> V_183 [ 0 ] ) ;
return;
case 'K' :
...
static int F_117 ( T_4 V_252 , const struct V_253 * V_254 , int V_255 )
{
int F_63 = 0 ;
int V_256 ;
...
return F_117 ( V_252 , V_259 , F_119 ( V_259 ) - 1 ) ;
}
static int F_120 ( struct V_137 * V_138 , const unsigned char * V_192 , int V_36 )
{
#ifdef F_18
...
static void F_128 ( struct V_280 * V_281 )
{
F_71 () ;
if ( V_282 >= 0 ) {
if ( V_282 != V_100 &&
...
static int V_291 ;
if ( V_74 != - 1 )
return F_132 ( & V_291 , V_74 ) ;
else
return V_291 ;
}
static void F_133 ( struct V_292 * V_293 , const char * V_23 , unsigned V_36 )
{
struct V_4 * V_5 = V_99 [ V_100 ] . V_25 ;
unsigned char V_9 ;
static F_134 ( V_294 ) ;
...
static struct V_299 * F_138 ( struct V_292 * V_9 , int * V_300 )
{
* V_300 = V_9 -> V_300 ? V_9 -> V_300 - 1 : V_100 ;
return V_301 ;
}
int F_139 ( struct V_137 * V_138 , unsigned long V_302 )
{
char type , V_303 ;
...
case V_307 :
F_71 () ;
V_169 = F_141 ( (struct V_308 T_7 * ) ( V_14 + 1 ) , V_138 ) ;
F_72 () ;
break;
case V_309 :
V_169 = F_142 ( V_138 ) ;
...
break;
case V_318 :
if ( F_140 ( V_19 , ( V_319 T_7 * ) ( V_14 + 4 ) ) ) {
V_169 = - V_306 ;
} else {
F_71 () ;
...
static int F_148 ( struct V_137 * V_138 , const unsigned char * V_192 , int V_36 )
{
int V_323 ;
V_323 = F_120 ( V_138 , V_192 , V_36 ) ;
F_149 ( V_138 ) ;
return V_323 ;
}
static int F_150 ( struct V_137 * V_138 , unsigned char V_324 )
{
if ( F_122 () )
return 0 ;
return F_120 ( V_138 , & V_324 , 1 ) ;
}
static int F_151 ( struct V_137 * V_138 )
{
if ( V_138 -> V_271 )
return 0 ;
return 32768 ;
...
static void F_153 ( struct V_137 * V_138 )
{
}
...
static void F_149 ( struct V_137 * V_138 )
{
struct V_4 * V_5 ;
if ( F_122 () )
return;
...
static int F_160 ( struct V_299 * V_327 , struct V_137 * V_138 )
{
...
V_169 = F_161 ( & V_5 -> V_127 , V_327 , V_138 ) ;
if ( V_169 )
goto V_328;
V_138 -> V_168 = V_5 ;
...
static int F_162 ( struct V_137 * V_138 , struct V_333 * V_334 )
{
return 0 ;
}
static void F_163 ( struct V_137 * V_138 , struct V_333 * V_334 )
{
}
...
static T_9 F_172 ( struct V_356 * V_357 ,
struct V_358 * V_359 , char * V_192 )
{
return sprintf ( V_192 , L_10 , V_100 + 1 ) ;
}
int T_8 F_173 ( const struct V_360 * V_361 )
{
F_174 ( & V_362 , V_361 ) ;
if ( F_175 ( & V_362 , F_176 ( V_363 , 0 ) , 1 ) ||
F_177 ( F_176 ( V_363 , 0 ) , 1 , L_11 ) < 0 )
F_178 ( L_12 ) ;
V_103 = F_179 ( V_364 , NULL , F_176 ( V_363 , 0 ) , NULL , L_13 ) ;
if ( F_180 ( V_103 ) )
V_103 = NULL ;
else
F_181 ( F_182 ( V_103 , & V_365 ) < 0 ) ;
F_183 () ;
V_301 = F_184 ( V_108 ) ;
if ( ! V_301 )
F_178 ( L_14 ) ;
...
static int F_191 ( const struct V_377 * V_378 , int V_257 , int V_258 ,
int V_379 )
{
...
static int F_193 ( const struct V_377 * V_378 , int V_257 , int V_258 )
{
int V_79 , V_323 = 0 ;
for ( V_79 = V_257 ; V_79 <= V_258 ; V_79 ++ ) {
struct V_4 * V_5 = V_99 [ V_79 ] . V_25 ;
...
int F_194 ( const struct V_377 * V_378 , int V_257 , int V_258 , int V_379 )
{
struct V_380 * V_111 = V_378 -> V_111 ;
...
F_193 ( V_346 -> V_346 , V_346 -> V_257 , V_346 -> V_258 ) )
goto V_135;
V_378 = V_346 -> V_346 ;
for ( V_79 = 0 ; V_79 < V_343 ; V_79 ++ ) {
...
static T_9 F_198 ( struct V_356 * V_357 , struct V_358 * V_359 ,
const char * V_192 , T_10 V_36 )
{
struct V_344 * V_346 = F_199 ( V_357 ) ;
int V_387 = F_200 ( V_192 , NULL , 0 ) ;
if ( V_387 )
F_196 ( V_346 ) ;
else
F_197 ( V_346 ) ;
...
static int F_203 ( struct V_344 * V_346 )
{
int V_79 ;
int error = 0 ;
V_346 -> V_348 |= V_389 ;
F_204 ( V_346 -> V_357 , V_346 ) ;
for ( V_79 = 0 ; V_79 < F_119 ( V_390 ) ; V_79 ++ ) {
error = F_182 ( V_346 -> V_357 , & V_390 [ V_79 ] ) ;
if ( error )
break;
}
if ( error ) {
while ( -- V_79 >= 0 )
F_205 ( V_346 -> V_357 , & V_390 [ V_79 ] ) ;
V_346 -> V_348 &= ~ V_389 ;
}
return error ;
}
static void F_206 ( struct V_344 * V_346 )
{
int V_79 ;
...
int F_195 ( const struct V_377 * V_378 )
{
int V_79 , V_391 = 0 ;
for ( V_79 = 0 ; V_79 < V_108 ; V_79 ++ ) {
if ( V_113 [ V_79 ] == V_378 ) {
...
int F_212 ( const struct V_377 * V_378 , int V_257 , int V_258 )
{
struct V_380 * V_111 = V_378 -> V_111 ;
struct V_344 * V_344 ;
const char * V_347 ;
...
if ( V_323 )
goto V_135;
V_344 -> V_357 = F_179 ( V_403 , NULL ,
F_176 ( 0 , V_344 -> V_402 ) ,
NULL , L_29 ,
V_344 -> V_402 ) ;
if ( F_180 ( V_344 -> V_357 ) ) {
F_124 ( V_404 L_30
L_31 , V_344 -> V_347 ,
F_213 ( V_344 -> V_357 ) ) ;
V_344 -> V_357 = NULL ;
...
int F_214 ( const struct V_377 * V_378 )
{
int V_79 , V_323 = - V_381 ;
F_71 () ;
if ( F_195 ( V_378 ) )
...
int F_216 ( const struct V_377 * V_378 , int V_257 , int V_258 , int V_379 )
{
int V_135 ;
V_135 = F_212 ( V_378 , V_257 , V_258 ) ;
if ( V_135 == - V_401 )
V_135 = 0 ;
if ( ! V_135 )
F_191 ( V_378 , V_257 , V_258 , V_379 ) ;
...
void F_217 ( const struct V_377 * V_378 )
{
F_214 ( V_378 ) ;
}
...
V_346 -> V_357 = F_179 ( V_403 , NULL ,
F_176 ( 0 , V_346 -> V_402 ) ,
NULL , L_29 ,
V_346 -> V_402 ) ;
if ( F_180 ( V_346 -> V_357 ) ) {
F_124 ( V_404 L_34
L_35 ,
V_346 -> V_347 , F_213 ( V_346 -> V_357 ) ) ;
V_346 -> V_357 = NULL ;
} else {
F_203 ( V_346 ) ;
}
...
{
unsigned int V_289 ;
if ( F_140 ( V_289 , V_14 + 1 ) )
return - V_306 ;
V_406 = ( V_289 < 4 ) ? V_289 : 0 ;
return 0 ;
}
void F_130 ( int V_407 )
{
struct V_4 * V_5 = V_99 [ V_100 ] . V_25 ;
int V_79 ;
F_21 () ;
...
if ( V_213 && V_406 ) {
V_350 = V_408 ;
F_168 ( & V_352 , V_353 + V_213 ) ;
}
F_68 ( V_412 , V_5 -> V_102 , V_5 -> V_102 ) ;
}
void F_221 ( int V_413 )
{
struct V_4 * V_5 ;
if ( ! V_414 )
F_123 () ;
...
F_42 ( V_5 ) ;
F_24 ( V_5 ) ;
F_68 ( V_415 , V_5 -> V_102 , V_5 -> V_102 ) ;
}
void F_143 ( void )
{
F_221 ( 0 ) ;
}
static void F_223 ( unsigned long V_416 )
{
if ( F_224 ( ! F_225 () ) ) {
F_168 ( & V_352 , V_353 + ( V_207 * V_211 ) ) ;
return;
...
int F_227 ( unsigned char T_7 * V_302 )
{
int V_79 , V_246 , V_335 ;
unsigned char V_418 [ 3 * 16 ] ;
if ( F_228 ( V_418 , V_302 , sizeof( V_418 ) ) )
return - V_306 ;
F_71 () ;
...
int F_229 ( unsigned char T_7 * V_302 )
{
int V_79 , V_335 ;
unsigned char V_418 [ 3 * 16 ] ;
F_71 () ;
...
F_72 () ;
if ( F_230 ( V_302 , V_418 , sizeof( V_418 ) ) )
return - V_306 ;
return 0 ;
}
...
static int F_231 ( struct V_4 * V_5 , struct V_419 * V_420 )
{
struct V_421 V_422 ;
int V_423 = - V_156 ;
int V_9 ;
...
V_423 = V_5 -> V_16 -> F_231 ( V_5 , & V_422 ) ;
else
V_423 = - V_425 ;
F_72 () ;
if ( V_423 )
...
if ( V_420 -> V_303 && F_230 ( V_420 -> V_303 , V_422 . V_303 , V_9 ) )
V_423 = - V_306 ;
V_426:
F_58 ( V_422 . V_303 ) ;
return V_423 ;
...
if ( F_140 ( V_434 , & V_433 [ 32 * V_79 + V_432 - 1 ] ) )
return - V_306 ;
if ( V_434 )
goto V_435;
}
...
V_422 . V_303 = F_233 ( V_420 -> V_303 , V_431 ) ;
if ( F_180 ( V_422 . V_303 ) )
return F_213 ( V_422 . V_303 ) ;
F_71 () ;
if ( V_5 -> V_87 != V_284 )
V_423 = - V_156 ;
else if ( V_5 -> V_16 -> F_232 )
V_423 = V_5 -> V_16 -> F_232 ( V_5 , & V_422 , V_420 -> V_373 ) ;
else
V_423 = - V_425 ;
F_72 () ;
F_58 ( V_422 . V_303 ) ;
...
static int F_234 ( struct V_4 * V_5 , struct V_419 * V_420 )
{
...
if ( ! V_420 -> V_303 )
V_26 = NULL ;
else if ( F_235 ( V_366 , V_420 -> V_303 , V_436 - 1 ) < 0 )
return - V_306 ;
else
V_366 [ V_436 - 1 ] = 0 ;
F_71 () ;
...
if ( V_5 -> V_16 -> F_234 )
V_423 = V_5 -> V_16 -> F_234 ( V_5 , & V_422 , V_26 ) ;
else
V_423 = - V_425 ;
F_72 () ;
if ( ! V_423 ) {
...
static int F_236 ( struct V_4 * V_5 , struct V_419 * V_420 )
{
...
V_423 = V_5 -> V_16 -> F_236 ( V_5 , V_346 ) ;
F_72 () ;
return V_423 ;
}
int F_237 ( struct V_4 * V_5 , struct V_419 * V_420 )
{
switch ( V_420 -> V_420 ) {
case V_438 :
return F_232 ( V_5 , V_420 ) ;
case V_439 :
return F_231 ( V_5 , V_420 ) ;
case V_440 :
return F_234 ( V_5 , V_420 ) ;
case V_441 :
return F_236 ( V_5 , V_420 ) ;
}
return - V_425 ;
}
T_1 F_238 ( struct V_4 * V_5 , int V_12 )
{
...
unsigned short * F_239 ( struct V_4 * V_5 , int V_443 , int V_13 )
{
...
T_1 F_242 ( struct V_4 * V_5 , const T_1 * V_444 )
{
if ( ( unsigned long ) V_444 == V_5 -> V_76 && V_81 != - 1 )
return V_81 ;
return F_19 ( V_444 ) ;
}
void F_243 ( struct V_4 * V_5 , T_1 V_445 , T_1 * V_444 )
{
F_28 ( V_445 , V_444 ) ;
