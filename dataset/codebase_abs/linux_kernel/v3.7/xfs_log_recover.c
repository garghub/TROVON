...
V_81 * V_379 ;
T_6 V_380 = 0 ;
V_379 = ( V_81 * ) V_377 -> V_381 ;
for ( V_45 = 0 ; V_45 < ( V_378 >> 2 ) ; V_45 ++ ) {
V_380 ^= F_30 ( * V_379 ) ;
V_379 ++ ;
}
V_377 -> V_382 . V_383 = F_32 ( V_380 ) ;
}
void
F_199 (
struct V_1 * log ,
...
{
int V_45 , V_46 , V_385 ;
int V_378 = V_377 -> V_386 + V_384 ;
V_81 V_387 ;
T_2 V_137 ;
F_198 ( log , V_377 , V_378 ) ;
V_387 = F_200 ( V_377 -> V_382 . V_89 ) ;
V_137 = V_377 -> V_381 ;
for ( V_45 = 0 ; V_45 < F_49 ( V_378 ) &&
V_45 < ( V_60 / V_52 ) ; V_45 ++ ) {
V_377 -> V_382 . V_388 [ V_45 ] = * ( V_81 * ) V_137 ;
* ( V_81 * ) V_137 = V_387 ;
V_137 += V_52 ;
}
if ( F_48 ( & log -> V_7 -> V_25 ) ) {
T_33 * V_389 = V_377 -> V_390 ;
for ( ; V_45 < F_49 ( V_378 ) ; V_45 ++ ) {
V_46 = V_45 / ( V_60 / V_52 ) ;
V_385 = V_45 % ( V_60 / V_52 ) ;
V_389 [ V_46 ] . V_391 . V_392 [ V_385 ] = * ( V_81 * ) V_137 ;
* ( V_81 * ) V_137 = V_387 ;
V_137 += V_52 ;
}
for ( V_45 = 1 ; V_45 < log -> V_393 ; V_45 ++ ) {
V_389 [ V_45 ] . V_391 . V_394 = V_387 ;
}
}
}
STATIC void
...
V_45 < ( V_60 / V_52 ) ; V_45 ++ ) {
* ( V_81 * ) V_137 = * ( V_81 * ) & V_73 -> V_388 [ V_45 ] ;
V_137 += V_52 ;
}
if ( F_48 ( & log -> V_7 -> V_25 ) ) {
T_33 * V_389 = ( T_33 * ) V_73 ;
for ( ; V_45 < F_49 ( F_30 ( V_73 -> V_61 ) ) ; V_45 ++ ) {
V_46 = V_45 / ( V_60 / V_52 ) ;
V_385 = V_45 % ( V_60 / V_52 ) ;
* ( V_81 * ) V_137 = V_389 [ V_46 ] . V_391 . V_392 [ V_385 ] ;
V_137 += V_52 ;
}
}
}
...
if ( F_33 (
( ! V_73 -> V_93 ||
( F_30 ( V_73 -> V_93 ) & ( ~ V_396 ) ) ) ) ) {
F_3 ( log -> V_7 , L_69 ,
V_8 , F_30 ( V_73 -> V_93 ) ) ;
return F_34 ( V_58 ) ;
}
V_395 = F_30 ( V_73 -> V_61 ) ;
if ( F_33 ( V_395 <= 0 || V_395 > V_70 ) ) {
F_4 ( L_70 ,
V_121 , log -> V_7 ) ;
return F_34 ( V_16 ) ;
}
...
int error = 0 , V_59 ;
int V_399 , V_400 ;
int V_79 , V_401 , V_402 ;
struct V_122 V_323 [ V_403 ] ;
ASSERT ( V_63 != V_72 ) ;
if ( F_48 ( & log -> V_7 -> V_25 ) ) {
V_397 = F_2 ( log , 1 ) ;
if ( ! V_397 )
return V_49 ;
error = F_19 ( log , V_72 , 1 , V_397 , & V_13 ) ;
if ( error )
goto V_404;
V_73 = ( T_5 * ) V_13 ;
error = F_202 ( log , V_73 , V_72 ) ;
if ( error )
goto V_404;
V_59 = F_30 ( V_73 -> V_59 ) ;
...
error = F_19 ( log , V_12 , V_79 , V_397 , & V_13 ) ;
if ( error )
goto V_406;
V_73 = ( T_5 * ) V_13 ;
error = F_202 ( log , V_73 , V_12 ) ;
if ( error )
goto V_406;
V_399 = ( int ) F_49 ( F_30 ( V_73 -> V_61 ) ) ;
error = F_19 ( log , V_12 + V_79 , V_399 , V_398 ,
& V_13 ) ;
if ( error )
goto V_406;
F_201 ( V_73 , V_13 , log ) ;
...
error = F_19 ( log , V_12 , V_79 , V_397 ,
& V_13 ) ;
if ( error )
goto V_406;
} else {
...
V_73 = ( T_5 * ) V_13 ;
error = F_202 ( log , V_73 ,
V_401 ? V_12 : 0 ) ;
if ( error )
goto V_406;
V_399 = ( int ) F_49 ( F_30 ( V_73 -> V_61 ) ) ;
V_12 += V_79 ;
if ( V_12 + V_399 <= log -> V_3 ) {
error = F_19 ( log , V_12 , V_399 , V_398 ,
& V_13 ) ;
if ( error )
goto V_406;
} else {
...
int error , V_45 ;
ASSERT ( V_63 != V_72 ) ;
log -> V_178 = F_72 ( V_407 *
sizeof( struct V_133 ) ,
V_129 ) ;
for ( V_45 = 0 ; V_45 < V_407 ; V_45 ++ )
F_73 ( & log -> V_178 [ V_45 ] ) ;
error = F_203 ( log , V_63 , V_72 ,
V_321 ) ;
if ( error != 0 ) {
F_103 ( log -> V_178 ) ;
log -> V_178 = NULL ;
...
V_408 = & log -> V_7 -> V_25 ;
F_212 ( log -> V_7 , F_213 ( V_6 ) ) ;
ASSERT ( V_408 -> V_409 == V_410 ) ;
ASSERT ( F_214 ( V_408 ) ) ;
F_27 ( V_6 ) ;
F_215 ( log -> V_7 ) ;
F_216 ( log ) ;
...
return error ;
if ( V_72 != V_63 ) {
if ( ( error = F_217 ( log -> V_7 , L_72 ) ) ) {
return error ;
}
F_116 ( log -> V_7 , L_73 ,
log -> V_7 -> V_413 ? log -> V_7 -> V_413
: L_74 ) ;
...
V_420 = 0LL ;
for ( V_352 = 0 ; V_352 < V_23 -> V_25 . V_374 ; V_352 ++ ) {
error = F_221 ( V_23 , NULL , V_352 , 0 , & V_417 ) ;
if ( error ) {
F_109 ( V_23 , L_78 ,
V_8 , V_352 , error ) ;
} else {
V_416 = F_222 ( V_417 ) ;
V_418 += F_30 ( V_416 -> V_421 ) +
F_30 ( V_416 -> V_422 ) ;
F_27 ( V_417 ) ;
}
error = F_188 ( V_23 , NULL , V_352 , & V_354 ) ;
...
struct V_423 * V_353 = F_189 ( V_354 ) ;
V_419 += F_30 ( V_353 -> V_424 ) ;
V_420 += F_30 ( V_353 -> V_425 ) ;
F_27 ( V_354 ) ;
}
}
}
