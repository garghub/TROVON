...
V_32 = F_8 ( V_28 -> V_33 , struct V_31 , V_34 ) ;
if ( ! V_32 ) {
F_4 ( V_6 , L_10 ) ;
return - 1 ;
}
...
return error ;
F_14 ( L_21 ) ;
switch ( V_75 [ V_47 ] . V_16 ) {
case V_17 :
F_14 ( L_22 ) ;
F_38 ( V_23 , V_19 , V_91 , V_92 , 0 , 0 ) ;
F_38 ( V_23 , V_93 , V_94 , V_95 , 0 , 0 ) ;
F_38 ( V_23 , V_96 , V_94 , V_95 , 0 , 0 ) ;
break;
default:
break;
}
...
V_14 -> V_64 [ V_48 ] = NULL ;
if ( V_75 [ V_47 ] . V_16 == V_97 ) {
struct V_59 * V_64 ;
T_6 V_98 ;
char * V_99 ;
F_23 ( V_6 , 0 ) ;
V_98 = strlen ( F_40 ( & V_6 -> V_23 ) ) + 8 ;
for ( V_48 = 0 ; V_48 < 5 ; V_48 ++ ) {
V_64 = F_36 ( sizeof( struct V_59 ) + V_98 , V_88 ) ;
if ( ! V_64 ) {
F_4 ( V_6 , L_23 , V_48 ) ;
goto V_100;
}
V_99 = ( void * ) ( & V_64 [ 1 ] ) ;
snprintf ( V_99 , V_98 , L_24 , F_40 ( & V_6 -> V_23 ) , V_48 + 1 ) ;
V_64 -> V_99 = V_99 ;
V_64 -> V_101 = 0 ;
V_64 -> V_102 = 1 ;
V_64 -> V_103 = F_26 ;
