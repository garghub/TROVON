...
static struct V_1 * F_67 ( struct V_98 * V_15 ,
struct V_99 * V_14 ,
struct V_44 * V_26 )
{
struct V_1 * V_3 ;
V_3 = F_68 ( sizeof( * V_3 ) , V_100 ) ;
if ( ! V_3 ) {
F_69 ( & V_15 -> V_15 , L_15 , V_16 ) ;
return NULL ;
}
V_3 -> V_15 = F_70 ( V_15 ) ;
V_3 -> type = V_26 ;
...
static const struct V_101 * F_73 ( struct V_99 * V_102 ,
struct V_44 * V_45 )
{
struct V_103 * V_104 ;
F_74 ( & V_45 -> V_105 . V_106 ) ;
F_75 (dynid, &drv->dynids.list, node) {
if ( F_76 ( V_102 , & V_104 -> V_107 ) ) {
...
static const struct V_101 * F_78 ( struct V_44 * V_45 ,
struct V_99 * V_102 )
{
const struct V_101 * V_107 ;
V_107 = F_79 ( V_102 , V_45 -> V_108 ) ;
if ( V_107 ) {
F_6 ( & V_102 -> V_15 , L_16 ) ;
goto exit;
}
V_107 = F_73 ( V_102 , V_45 ) ;
if ( V_107 )
F_6 ( & V_102 -> V_15 , L_17 ) ;
exit:
return V_107 ;
}
static struct V_44 * F_80 (
struct V_99 * V_109 )
{
const struct V_101 * V_107 = NULL ;
struct V_44 * V_45 ;
struct V_110 * V_26 = F_81 ( V_109 -> V_15 . V_26 ) ;
F_75 (drv, &usb_serial_driver_list, driver_list) {
if ( V_45 -> V_110 == V_26 )
V_107 = F_78 ( V_45 , V_109 ) ;
if ( V_107 )
return V_45 ;
}
return NULL ;
}
static int F_82 ( struct V_39 * V_18 )
{
...
static void F_83 ( struct V_39 * V_18 , int V_113 )
{
struct V_20 * V_111 = F_22 ( V_18 , struct V_20 , V_18 ) ;
struct V_44 * V_45 = V_111 -> V_3 -> type ;
if ( V_45 -> V_114 )
...
static int F_84 ( struct V_99 * V_14 ,
const struct V_101 * V_107 )
{
struct V_92 * V_115 = & V_14 -> V_15 ;
struct V_98 * V_15 = F_85 ( V_14 ) ;
struct V_1 * V_3 = NULL ;
struct V_20 * V_18 ;
struct V_116 * V_117 ;
struct V_118 * V_119 ;
...
F_3 ( & V_4 ) ;
V_3 = F_67 ( V_15 , V_14 , type ) ;
if ( ! V_3 ) {
F_20 ( type -> V_26 . V_33 ) ;
F_69 ( V_115 , L_15 , V_16 ) ;
return - V_132 ;
}
if ( type -> V_133 ) {
const struct V_101 * V_107 ;
V_107 = F_78 ( type , V_14 ) ;
...
V_18 = F_68 ( sizeof( struct V_20 ) , V_100 ) ;
if ( ! V_18 )
goto V_150;
F_94 ( & V_18 -> V_18 ) ;
...
V_119 = V_123 [ V_11 ] ;
V_18 = V_3 -> V_18 [ V_11 ] ;
V_125 = F_98 ( int , V_3 -> type -> V_156 ,
F_99 ( V_119 ) ) ;
V_18 -> V_156 = V_125 ;
V_18 -> V_157 = V_119 -> V_158 ;
for ( V_12 = 0 ; V_12 < F_60 ( V_18 -> V_87 ) ; ++ V_12 ) {
F_100 ( V_12 , & V_18 -> V_159 ) ;
V_18 -> V_87 [ V_12 ] = F_101 ( 0 , V_100 ) ;
if ( ! V_18 -> V_87 [ V_12 ] ) {
F_69 ( V_115 , L_32 ) ;
goto V_150;
}
V_18 -> V_93 [ V_12 ] = F_102 ( V_125 ,
V_100 ) ;
if ( ! V_18 -> V_93 [ V_12 ] ) {
F_69 ( V_115 , L_33 ) ;
goto V_150;
}
F_103 ( V_18 -> V_87 [ V_12 ] , V_15 ,
F_104 ( V_15 ,
V_119 -> V_158 ) ,
...
V_119 = V_124 [ V_11 ] ;
V_18 = V_3 -> V_18 [ V_11 ] ;
if ( F_105 ( & V_18 -> V_95 , V_162 , V_100 ) )
goto V_150;
...
F_100 ( V_12 , & V_18 -> V_165 ) ;
V_18 -> V_88 [ V_12 ] = F_101 ( 0 , V_100 ) ;
if ( ! V_18 -> V_88 [ V_12 ] ) {
F_69 ( V_115 , L_32 ) ;
goto V_150;
}
V_18 -> V_94 [ V_12 ] = F_102 ( V_125 ,
V_100 ) ;
if ( ! V_18 -> V_94 [ V_12 ] ) {
F_69 ( V_115 , L_34 ) ;
goto V_150;
}
F_103 ( V_18 -> V_88 [ V_12 ] , V_15 ,
F_106 ( V_15 ,
V_119 -> V_158 ) ,
...
V_18 -> V_170 =
V_119 -> V_158 ;
V_18 -> V_96 = F_102 ( V_125 ,
V_100 ) ;
if ( ! V_18 -> V_96 ) {
F_69 ( V_115 , L_35 ) ;
goto V_150;
}
F_107 ( V_18 -> V_90 , V_15 ,
F_108 ( V_15 ,
V_119 -> V_158 ) ,
V_18 -> V_96 , V_125 ,
V_3 -> type -> V_169 , V_18 ,
...
V_18 -> V_174 =
V_119 -> V_158 ;
V_18 -> V_97 = F_102 ( V_125 ,
V_100 ) ;
if ( ! V_18 -> V_97 ) {
F_69 ( V_115 , L_37 ) ;
goto V_150;
}
F_107 ( V_18 -> V_91 , V_15 ,
F_109 ( V_15 ,
V_119 -> V_158 ) ,
V_18 -> V_97 , V_125 ,
V_3 -> type -> V_172 , V_18 ,
...
V_18 = V_3 -> V_18 [ V_11 ] ;
F_111 ( & V_18 -> V_15 , L_40 , V_18 -> V_19 ) ;
F_6 ( V_115 , L_41 , F_112 ( & V_18 -> V_15 ) ) ;
F_113 ( & V_18 -> V_15 ) ;
V_30 = F_114 ( & V_18 -> V_15 ) ;
if ( V_30 )
F_69 ( V_115 , L_42 ) ;
}
V_3 -> V_7 = 0 ;
...
static void F_116 ( struct V_99 * V_14 )
{
int V_11 ;
struct V_1 * V_3 = F_117 ( V_14 ) ;
...
static void F_141 ( struct V_44 * V_92 )
{
F_142 ( V_92 , V_41 ) ;
F_142 ( V_92 , V_53 ) ;
F_142 ( V_92 , V_47 ) ;
...
static int F_143 ( struct V_44 * V_26 )
{
int V_30 ;
if ( F_144 () )
return - V_31 ;
...
F_2 ( & V_4 ) ;
F_146 ( & V_26 -> V_216 , & V_217 ) ;
V_30 = F_147 ( V_26 ) ;
if ( V_30 ) {
F_129 ( L_52 , V_30 , V_26 -> V_72 ) ;
F_148 ( & V_26 -> V_216 ) ;
} else
F_149 ( L_53 , V_26 -> V_72 ) ;
F_3 ( & V_4 ) ;
return V_30 ;
}
static void F_150 ( struct V_44 * V_92 )
{
F_149 ( L_54 , V_92 -> V_72 ) ;
F_2 ( & V_4 ) ;
F_148 ( & V_92 -> V_216 ) ;
F_151 ( V_92 ) ;
F_3 ( & V_4 ) ;
}
int F_152 ( struct V_44 * const V_218 [] ,
const char * V_191 ,
...
void F_154 ( struct V_44 * const V_218 [] )
{
