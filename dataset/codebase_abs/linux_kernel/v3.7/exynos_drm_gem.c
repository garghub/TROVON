...
int V_46 ;
F_5 ( L_8 , __FILE__ ) ;
V_15 -> V_18 |= V_82 | V_83 | V_84 ;
F_4 ( V_37 , V_15 ) ;
V_78 = V_79 = V_15 -> V_85 - V_15 -> V_81 ;
V_40 = V_37 -> V_40 ;
if ( V_78 > V_40 -> V_20 )
return - V_11 ;
if ( V_37 -> V_9 & V_42 ) {
...
V_13 -> V_65 -> V_90 = & V_91 ;
V_13 -> V_65 -> V_77 = V_13 ;
V_89 = F_60 ( V_13 -> V_65 , 0 , args -> V_20 ,
V_92 | V_93 , V_94 , 0 ) ;
F_38 ( V_13 ) ;
if ( F_16 ( ( void * ) V_89 ) )
return F_26 ( ( void * ) V_89 ) ;
args -> V_95 = V_89 ;
F_5 ( L_21 , ( unsigned long ) args -> V_95 ) ;
return 0 ;
}
int F_61 ( struct V_64 * V_61 , void * V_67 ,
struct V_55 * V_56 )
{ struct V_12 * V_37 ;
struct V_96 * args = V_67 ;
struct V_27 * V_13 ;
F_62 ( & V_61 -> V_97 ) ;
V_13 = F_52 ( V_61 , V_56 , args -> V_57 ) ;
if ( ! V_13 ) {
...
args -> V_20 = args -> V_99 * args -> V_102 ;
V_37 = F_47 ( V_61 , args -> V_9 , args -> V_20 ) ;
if ( F_16 ( V_37 ) )
return F_26 ( V_37 ) ;
V_46 = F_36 ( & V_37 -> V_58 , V_56 ,
...
* V_71 = ( V_104 ) V_13 -> V_62 . V_105 . V_106 << V_33 ;
...
int F_72 ( struct V_14 * V_15 , struct V_107 * V_108 )
{
struct V_27 * V_13 = V_15 -> V_109 ;
struct V_64 * V_61 = V_13 -> V_61 ;
unsigned long V_35 ;
T_2 V_36 ;
int V_46 ;
V_36 = ( ( unsigned long ) V_108 -> V_110 -
V_15 -> V_81 ) >> V_33 ;
V_35 = ( unsigned long ) V_108 -> V_110 ;
F_62 ( & V_61 -> V_97 ) ;
