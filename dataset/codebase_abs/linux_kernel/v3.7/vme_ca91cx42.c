...
static T_4 F_48 ( struct V_114 * V_70 ,
void * V_172 , T_5 V_173 , T_6 V_174 )
{
T_4 V_116 ;
void * V_77 = V_70 -> V_120 + V_174 ;
...
if ( ( V_177 ) V_77 & 0x2 ) {
if ( ( V_173 - V_175 ) < 2 ) {
F_49 ( * ( V_178 * ) ( V_172 + V_175 ) , V_77 + V_175 ) ;
V_175 += 1 ;
goto V_179;
} else {
F_50 ( * ( V_180 * ) ( V_172 + V_175 ) , V_77 + V_175 ) ;
V_175 += 2 ;
}
}
V_176 = ( V_173 - V_175 ) & ~ 0x3 ;
...
static int F_53 ( struct V_193 * V_194 ,
...
F_54 ( & V_199 -> V_194 , & V_194 -> V_237 ) ;
if ( V_199 -> V_194 . V_200 != & V_194 -> V_237 ) {
V_200 = F_55 ( V_199 -> V_194 . V_200 , struct V_198 ,
V_194 ) ;
V_205 = F_56 ( & V_199 -> V_208 ) ;
...
F_60 ( & V_194 -> V_194 , & V_240 -> V_243 ) ;
}
V_199 = F_61 ( & V_194 -> V_237 , struct V_198 ,
V_194 ) ;
V_241 = F_56 ( & V_199 -> V_208 ) ;
F_28 ( & V_240 -> V_242 ) ;
...
F_62 ( V_259 ) ;
V_199 = F_55 ( V_259 , struct V_198 , V_194 ) ;
F_33 ( V_199 ) ;
}
return 0 ;
}
static int F_65 ( struct V_261 * V_262 ,
unsigned long long V_263 , T_1 V_75 , T_1 V_76 )
{
T_1 V_264 , V_265 = 0 ;
int V_6 ;
struct V_1 * V_2 ;
...
if ( V_76 & V_111 )
V_265 |= V_273 ;
F_14 ( V_263 , V_2 -> V_19 + V_274 ) ;
F_14 ( V_265 , V_2 -> V_19 + V_275 ) ;
F_28 ( & V_262 -> V_242 ) ;
return 0 ;
}
static int F_66 ( struct V_261 * V_262 ,
unsigned long long * V_263 , T_1 * V_75 , T_1 * V_76 )
{
T_1 V_265 , V_71 = 0 ;
struct V_1 * V_2 ;
V_2 = V_262 -> V_21 -> V_18 ;
F_26 ( & V_262 -> V_242 ) ;
* V_263 = ( unsigned long long ) F_7 ( V_2 -> V_19 + V_274 ) ;
V_265 = F_7 ( V_2 -> V_19 + V_275 ) ;
if ( V_265 & V_276 )
V_71 = 1 ;
if ( ( V_265 & V_277 ) == V_267 )
* V_75 = V_83 ;
if ( ( V_265 & V_277 ) == V_268 )
* V_75 = V_85 ;
if ( ( V_265 & V_277 ) == V_269 )
* V_75 = V_87 ;
* V_76 = 0 ;
if ( V_265 & V_270 )
* V_76 |= V_105 ;
...
static int F_67 ( struct V_261 * V_262 , int V_278 ,
void (* F_68)( int ) )
{
T_1 V_265 , V_45 ;
struct V_1 * V_2 ;
...
F_26 ( & V_262 -> V_242 ) ;
V_265 = F_7 ( V_2 -> V_19 + V_275 ) ;
if ( ( V_265 & ( V_272 | V_273 ) ) == 0 ) {
F_28 ( & V_262 -> V_242 ) ;
F_8 ( V_48 , L_34 ) ;
return - V_66 ;
}
if ( V_2 -> V_9 [ V_278 ] != NULL ) {
F_28 ( & V_262 -> V_242 ) ;
F_8 ( V_48 , L_35 ) ;
return - V_244 ;
}
...
static int F_69 ( struct V_261 * V_262 , int V_278 )
{
T_1 V_45 ;
struct V_1 * V_2 ;
V_2 = V_262 -> V_21 -> V_18 ;
...
V_35 ) ) == 0 ) {
V_45 = F_7 ( V_2 -> V_19 + V_275 ) ;
V_45 &= ~ V_276 ;
F_14 ( V_45 , V_2 -> V_19 + V_275 ) ;
}
F_28 ( & V_262 -> V_242 ) ;
return 0 ;
}
...
V_2 = V_16 -> V_18 ;
if ( ! V_280 ) {
V_279 = F_7 ( V_2 -> V_19 + V_281 ) ;
V_279 = ( ( V_279 & V_282 ) >> 27 ) ;
} else
V_279 = V_280 ;
return ( int ) V_279 ;
}
static void * F_71 ( struct V_185 * V_21 , T_5 V_73 ,
T_3 * V_283 )
{
struct V_46 * V_47 ;
V_47 = F_16 ( V_21 , struct V_46 , V_48 ) ;
return F_72 ( V_47 , V_73 , V_283 ) ;
}
static void F_73 ( struct V_185 * V_21 , T_5 V_73 ,
void * V_284 , T_3 V_283 )
{
struct V_46 * V_47 ;
V_47 = F_16 ( V_21 , struct V_46 , V_48 ) ;
F_74 ( V_47 , V_73 , V_284 , V_283 ) ;
}
...
V_279 = F_70 ( V_16 ) ;
if ( V_280 )
F_14 ( V_280 << 27 , V_2 -> V_19 + V_281 ) ;
F_78 ( & V_47 -> V_48 , L_36 , V_279 ) ;
if ( V_279 == 0 ) {
F_8 ( & V_47 -> V_48 , L_37
L_38 ) ;
return - V_66 ;
}
V_2 -> V_286 = F_72 ( V_47 , V_287 ,
& V_2 -> V_288 ) ;
if ( V_2 -> V_286 == NULL ) {
F_8 ( & V_47 -> V_48 , L_39
L_40 ) ;
...
memset ( V_2 -> V_286 , 0 , V_287 ) ;
V_285 = V_279 * ( 512 * 1024 ) ;
F_14 ( V_2 -> V_288 - V_285 , V_2 -> V_19 + V_289 ) ;
V_45 = F_7 ( V_2 -> V_19 + V_290 ) ;
V_45 |= V_291 ;
F_14 ( V_45 , V_2 -> V_19 + V_290 ) ;
return 0 ;
}
...
V_45 &= ~ V_291 ;
F_14 ( V_45 , V_2 -> V_19 + V_290 ) ;
F_14 ( 0 , V_2 -> V_19 + V_289 ) ;
F_74 ( V_47 , V_287 , V_2 -> V_286 ,
V_2 -> V_288 ) ;
}
static int F_80 ( struct V_46 * V_47 , const struct V_292 * V_293 )
{
int V_116 , V_6 ;
T_1 V_294 ;
struct V_258 * V_259 = NULL , * V_295 ;
struct V_15 * V_16 ;
struct V_1 * V_296 ;
struct V_114 * V_297 ;
struct V_69 * V_298 ;
struct V_239 * V_299 ;
struct V_261 * V_262 ;
V_16 = F_81 ( sizeof( struct V_15 ) , V_206 ) ;
if ( V_16 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_296 = F_81 ( sizeof( struct V_1 ) , V_206 ) ;
if ( V_296 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_116 = F_83 ( V_47 , V_53 ) ;
if ( V_116 ) {
F_8 ( & V_47 -> V_48 , L_43 ) ;
goto V_131;
}
V_296 -> V_19 = F_37 ( F_84 ( V_47 , 0 ) ,
4096 ) ;
if ( ! V_296 -> V_19 ) {
F_8 ( & V_47 -> V_48 , L_44 ) ;
V_116 = - V_303 ;
...
V_294 = F_7 ( V_296 -> V_19 + V_304 ) & 0x0000FFFF ;
if ( V_294 != V_305 ) {
F_8 ( & V_47 -> V_48 , L_45 ) ;
V_116 = - V_303 ;
goto V_306;
...
V_297 = F_35 ( sizeof( struct V_114 ) ,
V_206 ) ;
if ( V_297 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_48 ) ;
...
V_297 -> V_311 = 0 ;
V_297 -> V_82 = V_6 ;
V_297 -> V_312 = V_83 | V_85 | V_87 |
V_94 | V_89 | V_91 ;
V_297 -> V_313 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
V_297 -> V_314 = V_147 | V_149 | V_151 | V_153 ;
memset ( & V_297 -> V_117 , 0 ,
sizeof( struct V_122 ) ) ;
V_297 -> V_120 = NULL ;
F_54 ( & V_297 -> V_194 ,
& V_16 -> V_308 ) ;
...
V_298 -> V_311 = 0 ;
V_298 -> V_82 = V_6 ;
V_298 -> V_312 = V_85 | V_87 | V_89 |
V_91 ;
if ( V_6 == 0 || V_6 == 4 )
V_298 -> V_312 |= V_83 ;
V_298 -> V_313 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
F_54 ( & V_298 -> V_194 ,
& V_16 -> V_315 ) ;
}
...
V_299 = F_35 ( sizeof( struct V_239 ) ,
V_206 ) ;
if ( V_299 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_50 ) ;
...
F_17 ( & V_16 -> V_325 ) ;
V_262 = F_35 ( sizeof( struct V_261 ) , V_206 ) ;
if ( V_262 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_51 ) ;
V_116 = - V_125 ;
...
V_16 -> V_344 = F_71 ;
V_16 -> V_345 = F_73 ;
V_294 = F_7 ( V_296 -> V_19 + V_346 ) ;
F_78 ( & V_47 -> V_48 , L_52 ,
( V_294 & V_347 ) ? L_53 : L_54 ) ;
F_78 ( & V_47 -> V_48 , L_55 ,
F_70 ( V_16 ) ) ;
if ( F_77 ( V_16 , V_47 ) )
F_8 ( & V_47 -> V_48 , L_56 ) ;
...
F_79 ( V_16 , V_47 ) ;
V_326:
F_64 (pos, n, &ca91cx42_bridge->lm_resources) {
V_262 = F_55 ( V_259 , struct V_261 , V_194 ) ;
F_62 ( V_259 ) ;
F_33 ( V_262 ) ;
}
V_320:
F_64 (pos, n, &ca91cx42_bridge->dma_resources) {
V_299 = F_55 ( V_259 , struct V_239 , V_194 ) ;
F_62 ( V_259 ) ;
F_33 ( V_299 ) ;
}
V_317:
F_64 (pos, n, &ca91cx42_bridge->slave_resources) {
V_298 = F_55 ( V_259 , struct V_69 , V_194 ) ;
F_62 ( V_259 ) ;
F_33 ( V_298 ) ;
}
V_310:
F_64 (pos, n, &ca91cx42_bridge->master_resources) {
V_297 = F_55 ( V_259 , struct V_114 ,
V_194 ) ;
F_62 ( V_259 ) ;
F_33 ( V_297 ) ;
}
