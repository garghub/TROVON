...
unsigned int F_24 ( const struct V_46 * V_20 )
{
return ( unsigned int ) ( F_2 ( V_20 -> V_16 -> V_5 ) - V_20 -> V_47 ) << 2 ;
}
void F_25 ( struct V_46 * V_20 , struct V_15 * V_16 , T_1 * V_1 )
{
...
T_1 * F_26 ( struct V_46 * V_20 , T_3 V_10 )
{
T_1 * V_1 = V_20 -> V_1 ;
T_1 * V_51 ;
V_10 += 3 ;
...
void F_28 ( struct V_46 * V_20 , struct V_22 * * V_18 , unsigned int V_23 ,
unsigned int V_5 )
{
...
static void F_29 ( struct V_46 * V_20 , struct V_24 * V_48 ,
unsigned int V_5 )
{
if ( V_5 > V_48 -> V_29 )
V_5 = V_48 -> V_29 ;
...
static int F_30 ( struct V_46 * V_20 ,
...
static void F_32 ( struct V_46 * V_20 )
{
unsigned int V_61 ;
V_61 = ( 1 + V_20 -> V_53 - V_20 -> V_16 -> V_18 ) << V_58 ;
V_61 -= V_20 -> V_16 -> V_19 ;
if ( F_30 ( V_20 , V_61 , V_60 ) < 0 )
F_29 ( V_20 , V_20 -> V_16 -> V_26 , V_20 -> V_16 -> V_5 ) ;
}
static bool F_33 ( struct V_46 * V_20 )
{
if ( V_20 -> V_53 != NULL )
F_32 ( V_20 ) ;
else if ( V_20 -> V_48 == V_20 -> V_16 -> V_25 ) {
if ( F_30 ( V_20 , 0 , V_60 ) < 0 )
F_29 ( V_20 , V_20 -> V_16 -> V_26 , V_20 -> V_16 -> V_5 ) ;
}
return V_20 -> V_1 != V_20 -> V_50 ;
}
void F_34 ( struct V_46 * V_20 , struct V_15 * V_16 , T_1 * V_1 )
{
V_20 -> V_16 = V_16 ;
V_20 -> V_62 . V_27 = NULL ;
V_20 -> V_62 . V_29 = 0 ;
...
void F_35 ( struct V_46 * V_20 , struct V_15 * V_16 ,
...
static T_1 * F_36 ( struct V_46 * V_20 , T_3 V_10 )
{
unsigned int V_47 = F_2 ( V_10 ) ;
T_1 * V_1 = V_20 -> V_1 ;
T_1 * V_51 = V_1 + V_47 ;
if ( F_27 ( V_47 > V_20 -> V_47 || V_51 > V_20 -> V_50 || V_51 < V_1 ) )
return NULL ;
V_20 -> V_1 = V_51 ;
V_20 -> V_47 -= V_47 ;
return V_1 ;
}
void F_37 ( struct V_46 * V_20 , void * V_16 , T_3 V_28 )
{
V_20 -> V_62 . V_27 = V_16 ;
V_20 -> V_62 . V_29 = V_28 ;
}
static T_1 * F_38 ( struct V_46 * V_20 , T_3 V_10 )
{
T_1 * V_1 ;
...
T_1 * F_39 ( struct V_46 * V_20 , T_3 V_10 )
{
T_1 * V_1 ;
if ( V_10 == 0 )
return V_20 -> V_1 ;
...
static unsigned int F_40 ( struct V_46 * V_20 , unsigned int V_5 )
{
struct V_15 * V_16 = V_20 -> V_16 ;
struct V_24 * V_48 ;
unsigned int V_47 = F_2 ( V_5 ) ;
unsigned int V_65 = F_24 ( V_20 ) ;
if ( V_20 -> V_47 == 0 )
return 0 ;
V_48 = V_16 -> V_25 ;
if ( V_48 -> V_29 > V_65 ) {
...
F_22 ( V_16 , V_16 -> V_30 - V_5 ) ;
V_20 -> V_47 = F_2 ( V_16 -> V_5 - V_65 ) ;
}
return V_5 ;
}
unsigned int F_41 ( struct V_46 * V_20 , unsigned int V_5 )
{
struct V_15 * V_16 = V_20 -> V_16 ;
struct V_24 * V_48 ;
unsigned int V_47 ;
...
void F_42 ( struct V_46 * V_20 , unsigned int V_5 )
{
V_5 = F_40 ( V_20 , V_5 ) ;
if ( V_5 != 0 )
F_30 ( V_20 , 0 , V_5 ) ;
...
void
F_43 ( struct V_24 * V_48 , struct V_15 * V_16 )
{
V_16 -> V_25 [ 0 ] = * V_48 ;
V_16 -> V_26 [ 0 ] = V_66 ;
V_16 -> V_30 = 0 ;
...
if ( V_23 < V_16 -> V_30 ) {
V_67 -> V_30 = F_46 ( V_16 -> V_30 - V_23 , V_5 ) ;
V_23 += V_16 -> V_19 ;
V_67 -> V_19 = V_23 & ~ V_39 ;
...
V_67 -> V_26 [ 0 ] . V_29 = F_45 (unsigned int, len,
...
static void F_47 ( struct V_15 * V_67 , void * V_3 , unsigned int V_5 )
{
unsigned int V_68 ;
V_68 = F_45 (unsigned int, len, subbuf->head[0].iov_len) ;
memcpy ( V_3 , V_67 -> V_25 [ 0 ] . V_27 , V_68 ) ;
V_5 -= V_68 ;
V_3 += V_68 ;
V_68 = F_45 (unsigned int, len, subbuf->page_len) ;
if ( V_68 )
F_20 ( V_3 , V_67 -> V_18 , V_67 -> V_19 , V_68 ) ;
V_5 -= V_68 ;
V_3 += V_68 ;
V_68 = F_45 (unsigned int, len, subbuf->tail[0].iov_len) ;
memcpy ( V_3 , V_67 -> V_26 [ 0 ] . V_27 , V_68 ) ;
}
int F_48 ( struct V_15 * V_16 , unsigned int V_23 , void * V_3 , unsigned int V_5 )
{
struct V_15 V_67 ;
int V_69 ;
V_69 = F_44 ( V_16 , & V_67 , V_23 , V_5 ) ;
if ( V_69 != 0 )
return V_69 ;
F_47 ( & V_67 , V_3 , V_5 ) ;
return 0 ;
...
T_1 V_70 ;
int V_69 ;
V_69 = F_48 ( V_16 , V_23 , & V_70 , sizeof( * V_3 ) ) ;
if ( V_69 )
return V_69 ;
* V_3 = F_5 ( V_70 ) ;
return 0 ;
...
{
T_1 V_70 = F_3 ( V_3 ) ;
return F_50 ( V_16 , V_23 , & V_70 , sizeof( V_3 ) ) ;
}
int F_53 ( struct V_15 * V_16 , struct V_2 * V_3 , unsigned int V_21 )
{
struct V_15 V_67 ;
if ( F_51 ( V_16 , V_21 , & V_3 -> V_5 ) )
return - V_71 ;
if ( F_44 ( V_16 , & V_67 , V_21 + 4 , V_3 -> V_5 ) )
return - V_71 ;
...
F_47 ( & V_67 , V_3 -> V_6 , V_3 -> V_5 ) ;
return 0 ;
}
static int
F_54 ( struct V_15 * V_16 , unsigned int V_23 ,
...
unsigned int V_89 ;
V_80 = F_46 ( V_79 , V_16 -> V_30 - V_23 ) ;
V_79 -= V_80 ;
V_23 += V_16 -> V_19 ;
V_81 = V_16 -> V_18 + ( V_23 >> V_38 ) ;
V_23 &= ~ V_39 ;
V_89 = F_45 (unsigned int, PAGE_CACHE_SIZE - base,
avail_here) ;
V_77 = F_56 ( * V_81 ) + V_23 ;
while ( V_80 ) {
V_80 -= V_89 ;
if ( V_78 || V_89 < V_74 -> V_85 ) {
unsigned int V_90 = F_46 ( V_89 ,
V_74 -> V_85 - V_78 ) ;
if ( ! V_76 ) {
V_76 = F_55 ( V_74 -> V_85 ,
V_88 ) ;
...
return - V_57 ;
return F_54 ( V_16 , V_23 , V_74 , 1 ) ;
}
int
F_61 ( struct V_15 * V_16 , unsigned int V_21 , unsigned int V_5 ,
int (* F_62)( struct V_91 * , void * ) , void * V_6 )
{
int V_92 , V_93 = 0 ;
...
if ( V_94 > V_5 )
V_94 = V_5 ;
F_64 ( V_96 , V_16 -> V_25 [ 0 ] . V_27 + V_21 , V_94 ) ;
V_93 = F_62 ( V_96 , V_6 ) ;
if ( V_93 )
goto V_87;
V_21 = 0 ;
...
if ( V_94 > V_30 )
V_94 = V_30 ;
F_65 ( V_96 , V_16 -> V_18 [ V_92 ] , V_94 , V_95 ) ;
V_93 = F_62 ( V_96 , V_6 ) ;
if ( V_93 )
goto V_87;
V_30 -= V_94 ;
...
if ( V_94 > V_5 )
V_94 = V_5 ;
F_64 ( V_96 , V_16 -> V_26 [ 0 ] . V_27 + V_21 , V_94 ) ;
V_93 = F_62 ( V_96 , V_6 ) ;
V_5 -= V_94 ;
}
if ( V_5 != 0 )
