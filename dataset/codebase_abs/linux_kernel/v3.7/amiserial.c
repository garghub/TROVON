...
static int T_5 F_111 ( struct V_213 * V_214 )
{
int error ;
struct V_1 * V_103 = F_112 ( V_214 ) ;
...
{
return F_114 ( & V_239 , F_102 ) ;
}
static void T_5 F_115 ( void )
{
F_116 ( & V_239 ) ;
}
static void F_117 ( char V_135 )
{
V_20 . V_59 = ( unsigned char ) V_135 | 0x100 ;
while ( ! ( V_20 . V_30 & 0x2000 ) )
F_118 () ;
}
static void F_119 ( struct V_240 * V_241 , const char * V_242 ,
unsigned V_134 )
{
...
static struct V_243 * F_120 ( struct V_240 * V_135 , int * V_144 )
{
* V_144 = 0 ;
return V_215 ;
}
