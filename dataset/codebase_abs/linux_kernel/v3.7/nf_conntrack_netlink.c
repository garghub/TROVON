...
V_124 = V_201 ( V_23 , V_200 , V_163 ) ;
if ( V_124 == - V_143 ) {
#ifdef F_115
F_11 () ;
F_116 () ;
if ( F_117 ( L_2 , F_17 ( V_23 ) ) < 0 ) {
F_118 () ;
F_8 () ;
return - V_175 ;
}
...
goto V_12;
#ifdef F_63
if ( ! F_165 ( & exp -> V_287 , & V_288 ) ||
exp -> V_289 . V_278 ) {
V_9 = F_2 ( V_2 , V_290 | V_11 ) ;
if ( ! V_9 )
goto V_12;
if ( F_13 ( V_2 , V_291 , F_14 ( exp -> V_46 ) ) )
goto V_12;
V_281 . V_20 . V_21 = F_17 ( V_216 ) ;
V_281 . V_20 . V_183 = exp -> V_287 ;
V_281 . V_14 . V_15 = F_18 ( V_216 ) ;
V_281 . V_20 . V_277 = exp -> V_289 ;
if ( F_161 ( V_2 , & V_281 ,
V_292 ) < 0 )
goto V_12;
F_5 ( V_2 , V_9 ) ;
...
static int
F_167 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_85 ,
...
static int
F_168 ( unsigned int V_119 , struct V_302 * V_121 )
{
struct V_280 * exp = V_121 -> exp ;
struct V_122 * V_122 = F_169 ( exp ) ;
struct V_95 * V_96 ;
struct V_97 * V_98 ;
struct V_1 * V_2 ;
...
static int F_170 ( struct V_144 * V_145 )
{
if ( V_145 -> args [ 1 ] )
F_171 ( (struct V_280 * ) V_145 -> args [ 1 ] ) ;
return 0 ;
}
static int
F_172 ( struct V_1 * V_2 , struct V_144 * V_145 )
{
struct V_122 * V_122 = F_77 ( V_2 -> V_147 ) ;
...
V_158:
F_173 (exp, n, &net->ct.expect_hash[cb->args[0]],
hnode) {
...
static int
F_175 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_122 * V_122 = F_77 ( V_182 ) ;
...
F_8 () ;
V_124 = F_167 ( V_187 , F_82 ( V_2 ) . V_94 ,
...
static int
F_177 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_122 * V_122 = F_77 ( V_182 ) ;
...
if ( ! V_164 [ V_291 ] || ! V_164 [ V_292 ] )
return - V_170 ;
V_124 = F_91 ( ( const struct V_8 * const * ) V_164 ,
& V_281 , V_292 , V_183 ) ;
if ( V_124 < 0 )
return V_124 ;
exp -> V_287 = V_281 . V_20 . V_183 ;
exp -> V_289 = V_281 . V_20 . V_277 ;
exp -> V_46 = F_102 ( F_103 ( V_164 [ V_291 ] ) ) ;
return 0 ;
#else
return - V_175 ;
#endif
...
static int
F_182 ( struct V_122 * V_122 , T_4 V_174 ,
const struct V_8 * const V_171 [] ,
V_116 V_183 ,
T_2 V_94 , int V_134 )
{
...
if ( V_171 [ V_290 ] ) {
V_124 = F_181 ( V_171 [ V_290 ] ,
exp , V_183 ) ;
if ( V_124 < 0 )
goto V_320;
}
V_124 = F_185 ( exp , V_94 , V_134 ) ;
V_320:
F_171 ( exp ) ;
V_39:
F_74 ( F_81 ( V_150 ) ) ;
...
static int
F_186 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_122 * V_122 = F_77 ( V_182 ) ;
...
return V_124 ;
F_78 ( & V_156 ) ;
exp = F_187 ( V_122 , V_174 , & V_4 ) ;
if ( ! exp ) {
F_85 ( & V_156 ) ;
V_124 = - V_184 ;
if ( V_96 -> V_188 & V_130 ) {
V_124 = F_182 ( V_122 , V_174 , V_171 ,
V_183 ,
F_82 ( V_2 ) . V_94 ,
F_100 ( V_96 ) ) ;
}
...
V_124 = - V_234 ;
if ( ! ( V_96 -> V_188 & V_131 ) )
V_124 = F_180 ( exp , V_171 ) ;
F_85 ( & V_156 ) ;
return V_124 ;
}
static int
F_188 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_85 , int V_235 ,
const struct V_236 * V_237 )
{
struct V_95 * V_96 ;
struct V_97 * V_98 ;
...
static int
F_189 ( struct V_1 * V_2 , struct V_144 * V_145 )
{
int V_235 ;
struct V_122 * V_122 = F_77 ( V_2 -> V_147 ) ;
if ( V_145 -> args [ 0 ] == V_265 )
...
continue;
V_237 = F_153 ( V_122 -> V_23 . V_266 , V_235 ) ;
if ( F_188 ( V_2 , F_82 ( V_145 -> V_2 ) . V_94 ,
V_145 -> V_96 -> V_161 ,
V_235 , V_237 ) < 0 )
break;
}
...
static int
F_190 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
if ( V_96 -> V_188 & V_189 ) {
...
static int T_8 F_191 ( struct V_122 * V_122 )
{
#ifdef F_192
int V_7 ;
V_7 = F_193 ( V_122 , & V_328 ) ;
if ( V_7 < 0 ) {
F_194 ( L_5 ) ;
goto V_320;
}
V_7 = F_195 ( V_122 , & V_329 ) ;
if ( V_7 < 0 ) {
F_194 ( L_6 ) ;
goto V_330;
}
...
static void F_197 ( struct V_122 * V_122 )
{
#ifdef F_192
F_198 ( V_122 , & V_329 ) ;
F_196 ( V_122 , & V_328 ) ;
...
static void T_9 F_199 ( struct V_331 * V_332 )
{
struct V_122 * V_122 ;
