...
{
struct V_14 * V_15 = F_21 ( V_38 ) ;
if ( V_15 -> V_32 & V_44 )
return 1 ;
return 0 ;
}
static void F_23 ( struct V_37 * V_38 , int V_45 )
{
struct V_14 * V_15 = F_21 ( V_38 ) ;
unsigned long V_27 ;
F_11 ( & V_15 -> V_31 , V_27 ) ;
...
static int F_28 ( struct V_47 * V_48 , struct V_37 * V_38 )
{
struct V_49 * V_43 = V_38 -> V_43 ;
struct V_14 * V_15 = F_21 ( V_38 ) ;
int V_6 ;
V_15 -> V_20 = V_40 ;
V_6 = F_14 ( V_43 -> V_2 , V_15 ) ;
if ( V_6 )
goto V_30;
V_6 = F_8 ( V_43 -> V_2 , V_15 -> V_36 ) ;
if ( V_6 )
goto V_30;
V_6 = F_7 ( V_43 -> V_2 , V_15 ) ;
if ( V_6 )
goto V_30;
F_2 ( & V_38 -> V_2 , L_3 , V_50 ) ;
V_6 = F_29 ( V_38 -> V_46 , V_28 ) ;
if ( V_6 ) {
F_30 ( & V_38 -> V_2 , L_4
L_5 , V_50 , V_6 ) ;
F_25 ( V_38 ) ;
...
static void F_34 ( struct V_47 * V_48 , int V_53 )
{
const T_3 V_54 =
V_55 | ( ( T_3 ) V_56 << 8 ) ;
...
V_59 = F_10 ( 2 , V_28 ) ;
if ( ! V_59 ) {
F_30 ( & V_38 -> V_2 , L_6 , V_50 ) ;
return;
}
V_6 = F_5 ( V_38 -> V_43 -> V_2 , V_60 ,
V_54 , 0 , V_59 , 2 ) ;
if ( V_6 < 0 ) {
F_30 ( & V_38 -> V_2 , L_7 ,
V_50 , V_6 ) ;
...
V_15 -> V_34 = 1 ;
F_12 ( & V_15 -> V_31 , V_27 ) ;
if ( ( V_15 -> V_32 ^ V_77 ) & V_44 ) {
struct V_47 * V_48 = F_39 ( & V_38 -> V_38 ) ;
if ( V_48 )
F_40 ( V_38 , V_48 ,
V_15 -> V_32 & V_44 ) ;
F_41 ( V_48 ) ;
...
static int F_42 ( struct V_37 * V_38 , unsigned int V_80 )
{
struct V_14 * V_15 = F_21 ( V_38 ) ;
unsigned long V_27 ;
T_1 V_81 ;
...
unsigned int V_93 , unsigned long V_80 )
{
struct V_37 * V_38 = V_48 -> V_57 ;
F_2 ( & V_38 -> V_2 , L_16 , V_50 , V_38 -> V_94 , V_93 ) ;
switch ( V_93 ) {
case V_95 :
F_2 ( & V_38 -> V_2 , L_17 , V_50 , V_38 -> V_94 ) ;
return F_42 ( V_38 , V_80 ) ;
default:
F_2 ( & V_38 -> V_2 , L_18 , V_50 , V_93 ) ;
break;
}
return - V_96 ;
}
...
V_73 = V_15 -> V_32 ;
F_12 ( & V_15 -> V_31 , V_27 ) ;
V_98 = ( ( V_97 & V_42 ) ? V_67 : 0 )
| ( ( V_97 & V_41 ) ? V_66 : 0 )
| ( ( V_73 & V_92 ) ? V_91 : 0 )
| ( ( V_73 & V_89 ) ? V_88 : 0 )
| ( ( V_73 & V_87 ) ? V_99 : 0 )
| ( ( V_73 & V_44 ) ? V_90 : 0 ) ;
F_2 ( & V_38 -> V_2 , L_19 , V_50 , V_98 ) ;
return V_98 ;
}
static int F_47 ( struct V_49 * V_43 )
{
struct V_14 * V_15 ;
V_15 = F_21 ( V_43 -> V_38 [ 0 ] ) ;
F_14 ( V_43 -> V_2 , V_15 ) ;
return 0 ;
}
