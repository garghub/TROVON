...
{
struct V_1 * V_2 = (struct V_1 * ) V_8 ;
unsigned char T_9 * V_211 = V_2 -> V_8 . V_9 ;
F_33 ( F_2 ( V_211 + V_176 ) , V_211 + V_136 ) ;
F_33 ( F_2 ( V_211 + V_88 ) & ~ V_87 , V_211 + V_88 ) ;
}
...
int V_213 ;
if ( ! F_91 ( V_2 -> V_214 ) ) {
V_213 = F_92 ( V_2 -> V_215 , V_2 -> V_214 ) ;
if ( V_213 )
F_19 ( V_8 -> V_41 ,
L_21 ) ;
}
V_213 = F_93 ( V_2 -> V_216 ) ;
if ( V_213 )
goto V_217;
V_2 -> V_8 . V_218 = F_94 ( V_2 -> V_216 ) ;
F_33 ( V_132 | V_133 | V_134 | V_135 |
V_179 | V_180 , V_2 -> V_8 . V_9 + V_136 ) ;
V_2 -> V_86 = F_2 ( V_2 -> V_8 . V_9 + V_88 ) ;
F_33 ( V_153 | V_125 , V_2 -> V_8 . V_9 + V_88 ) ;
...
goto V_220;
F_33 ( V_2 -> V_86 , V_2 -> V_8 . V_9 + V_88 ) ;
V_213 = F_96 ( V_2 -> V_8 . V_170 , F_80 , 0 , L_22 , V_2 ) ;
if ( V_213 )
goto V_220;
F_33 ( V_2 -> V_147 -> V_221 , V_2 -> V_8 . V_9 + V_222 ) ;
V_193 = V_223 | V_224 | V_204 ;
F_33 ( V_193 , V_2 -> V_8 . V_9 + V_194 ) ;
F_33 ( 0 , V_2 -> V_8 . V_9 + V_225 ) ;
F_33 ( 1 , V_2 -> V_8 . V_9 + V_226 ) ;
F_33 ( 0 , V_2 -> V_8 . V_9 + V_2 -> V_227 ) ;
if ( V_2 -> V_209 != V_2 -> V_227 ) {
int V_228 ;
for ( V_228 = 0 ; V_228 < 10 ; ++ V_228 )
...
while ( F_2 ( V_2 -> V_8 . V_9 + V_10 ) & V_152 )
F_67 () ;
V_193 = V_2 -> V_229 & ( V_196 | V_198 ) ;
V_193 |= V_223 | V_230 | V_224 ;
F_33 ( V_193 , V_2 -> V_8 . V_9 + V_194 ) ;
...
F_33 ( V_193 , V_2 -> V_8 . V_9 + V_194 ) ;
F_98 ( V_2 , V_2 -> V_227 ) ;
if ( V_2 -> V_227 != V_2 -> V_209 )
F_98 ( V_2 , V_2 -> V_209 ) ;
F_97 ( V_2 -> V_216 ) ;
if ( ! F_91 ( V_2 -> V_234 ) ) {
V_213 = F_92 ( V_2 -> V_215 , V_2 -> V_234 ) ;
if ( V_213 )
F_19 ( V_8 -> V_41 ,
L_23 ) ;
}
...
if ( V_2 -> V_147 -> V_241 ) {
if ( ( V_238 >= 3000000 ) && ( V_238 < 3250000 ) && ( V_239 > 1 ) )
V_239 -= 1 ;
else if ( ( V_238 > 3250000 ) && ( V_239 > 2 ) )
V_239 -= 2 ;
}
F_33 ( V_239 & 0x3f , V_8 -> V_9 + V_225 ) ;
F_33 ( V_239 >> 6 , V_8 -> V_9 + V_226 ) ;
F_33 ( V_208 , V_8 -> V_9 + V_2 -> V_227 ) ;
if ( V_2 -> V_227 != V_2 -> V_209 ) {
int V_228 ;
for ( V_228 = 0 ; V_228 < 10 ; ++ V_228 )
F_33 ( 0xff , V_2 -> V_8 . V_9 + V_176 ) ;
...
V_282 = F_117 ( & V_2 -> V_8 . V_79 ) ;
else
F_49 ( & V_2 -> V_8 . V_79 ) ;
V_229 = F_2 ( V_2 -> V_8 . V_9 + V_194 ) ;
V_281 = V_229 & ~ V_266 ;
V_281 |= V_223 | V_224 ;
F_33 ( V_281 , V_2 -> V_8 . V_9 + V_194 ) ;
F_118 ( & V_2 -> V_8 , V_278 , V_94 , F_113 ) ;
do {
V_3 = F_2 ( V_2 -> V_8 . V_9 + V_10 ) ;
} while ( V_3 & V_152 );
F_33 ( V_229 , V_2 -> V_8 . V_9 + V_194 ) ;
if ( V_282 )
F_47 ( & V_2 -> V_8 . V_79 ) ;
F_119 ( V_77 ) ;
F_120 ( V_2 -> V_216 ) ;
...
static void T_3
F_121 ( struct V_1 * V_2 , int * V_238 ,
int * V_22 , int * V_285 )
{
if ( F_2 ( V_2 -> V_8 . V_9 + V_194 ) & V_223 ) {
...
* V_285 = 8 ;
V_286 = F_2 ( V_2 -> V_8 . V_9 + V_226 ) ;
V_287 = F_2 ( V_2 -> V_8 . V_9 + V_225 ) ;
...
static int T_3 F_122 ( struct V_276 * V_277 , char * V_288 )
{
struct V_1 * V_2 ;
int V_238 = 38400 ;
int V_285 = 8 ;
...
return - V_291 ;
if ( ! F_91 ( V_2 -> V_214 ) ) {
V_111 = F_92 ( V_2 -> V_215 , V_2 -> V_214 ) ;
if ( V_111 )
F_19 ( V_2 -> V_8 . V_41 ,
L_21 ) ;
}
V_111 = F_123 ( V_2 -> V_216 ) ;
if ( V_111 )
return V_111 ;
if ( V_2 -> V_8 . V_41 -> V_45 ) {
struct V_43 * V_44 ;
...
V_2 -> V_8 . V_218 = F_94 ( V_2 -> V_216 ) ;
if ( V_288 )
F_124 ( V_288 , & V_238 , & V_22 , & V_285 , & V_289 ) ;
else
F_121 ( V_2 , & V_238 , & V_22 , & V_285 ) ;
return F_125 ( & V_2 -> V_8 , V_277 , V_238 , V_22 , V_285 , V_289 ) ;
}
static int F_126 ( int V_280 , struct V_40 * V_41 )
{
struct V_292 * V_293 ;
static bool V_294 = false ;
static bool V_295 = false ;
int V_111 = V_280 ;
if ( ! F_127 ( V_296 ) )
return V_111 ;
V_293 = V_41 -> V_297 ;
if ( ! V_293 )
return V_111 ;
V_111 = F_128 ( V_293 , L_24 ) ;
if ( F_129 ( V_111 ) ) {
V_295 = true ;
V_111 = V_280 ;
} else {
V_294 = true ;
if ( V_111 >= F_130 ( V_279 ) || V_279 [ V_111 ] != NULL ) {
...
static int F_131 ( struct V_298 * V_41 , const struct V_299 * V_300 )
{
struct V_1 * V_2 ;
struct V_301 * V_147 = V_300 -> V_75 ;
void T_9 * V_302 ;
int V_228 , V_111 ;
for ( V_228 = 0 ; V_228 < F_130 ( V_279 ) ; V_228 ++ )
if ( V_279 [ V_228 ] == NULL )
break;
if ( V_228 == F_130 ( V_279 ) ) {
V_111 = - V_101 ;
goto V_217;
}
...
V_228 = F_126 ( V_228 , & V_41 -> V_41 ) ;
V_302 = F_132 ( V_41 -> V_303 . V_304 , F_133 ( & V_41 -> V_303 ) ) ;
if ( ! V_302 ) {
V_111 = - V_39 ;
goto free;
}
V_2 -> V_215 = F_134 ( & V_41 -> V_41 ) ;
if ( F_91 ( V_2 -> V_215 ) ) {
V_111 = F_135 ( V_2 -> V_215 ) ;
goto V_305;
}
V_2 -> V_214 = F_136 ( V_2 -> V_215 ,
V_306 ) ;
if ( F_91 ( V_2 -> V_214 ) )
F_19 ( & V_41 -> V_41 , L_27 ) ;
V_2 -> V_234 = F_136 ( V_2 -> V_215 ,
V_307 ) ;
if ( F_91 ( V_2 -> V_234 ) )
F_39 ( & V_41 -> V_41 , L_28 ) ;
V_2 -> V_216 = F_137 ( & V_41 -> V_41 , NULL ) ;
if ( F_91 ( V_2 -> V_216 ) ) {
V_111 = F_135 ( V_2 -> V_216 ) ;
goto V_305;
}
V_2 -> V_147 = V_147 ;
V_2 -> V_227 = V_147 -> V_227 ;
V_2 -> V_209 = V_147 -> V_209 ;
V_2 -> V_229 = 0 ;
V_2 -> V_55 = V_147 -> V_55 ;
V_2 -> V_8 . V_41 = & V_41 -> V_41 ;
V_2 -> V_8 . V_49 = V_41 -> V_303 . V_304 ;
V_2 -> V_8 . V_9 = V_302 ;
V_2 -> V_8 . V_308 = V_309 ;
...
F_33 ( 0xffff , V_2 -> V_8 . V_9 + V_136 ) ;
snprintf ( V_2 -> type , sizeof( V_2 -> type ) , L_29 , F_138 ( V_41 ) ) ;
V_279 [ V_228 ] = V_2 ;
F_139 ( V_41 , V_2 ) ;
V_111 = F_140 ( & V_313 , & V_2 -> V_8 ) ;
if ( V_111 ) {
F_139 ( V_41 , NULL ) ;
V_279 [ V_228 ] = NULL ;
F_29 ( V_2 ) ;
...
static int F_146 ( struct V_298 * V_41 , T_10 V_84 )
{
struct V_1 * V_2 = F_144 ( V_41 ) ;
if ( ! V_2 )
return - V_42 ;
return F_147 ( & V_313 , & V_2 -> V_8 ) ;
}
static int F_148 ( struct V_298 * V_41 )
{
struct V_1 * V_2 = F_144 ( V_41 ) ;
if ( ! V_2 )
return - V_42 ;
return F_149 ( & V_313 , & V_2 -> V_8 ) ;
}
