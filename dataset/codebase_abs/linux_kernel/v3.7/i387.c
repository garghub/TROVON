...
{
return F_35 ( V_41 ) ? V_43 -> V_44 : 0 ;
}
int F_39 ( struct V_5 * V_41 , const struct V_42 * V_43 )
{
return ( V_11 && F_35 ( V_41 ) ) ? V_43 -> V_44 : 0 ;
}
...
return V_38 ;
F_41 ( V_41 ) ;
return F_42 ( & V_45 , & V_46 , & V_47 , & V_48 ,
& V_41 -> V_39 . V_28 . V_29 -> V_31 , 0 , - 1 ) ;
}
int F_43 ( struct V_5 * V_41 , const struct V_42 * V_43 ,
unsigned int V_45 , unsigned int V_46 ,
...
static inline unsigned short F_47 ( unsigned short V_36 )
{
unsigned int V_61 ;
V_61 = ~ V_36 ;
...
static inline T_3 F_48 ( struct V_13 * V_31 )
{
struct V_62 * V_63 ;
...
void
F_50 ( struct V_73 * V_74 , struct V_5 * V_8 )
{
...
int F_55 ( struct V_5 * V_41 , const struct V_42 * V_43 ,
unsigned int V_45 , unsigned int V_46 ,
void * V_47 , void T_2 * V_48 )
{
struct V_73 V_74 ;
...
return V_38 ;
if ( ! V_16 )
return F_56 ( V_41 , V_43 , V_45 , V_46 , V_47 , V_48 ) ;
if ( ! V_11 ) {
return F_42 ( & V_45 , & V_46 , & V_47 , & V_48 ,
...
F_50 ( & V_74 , V_41 ) ;
return F_42 ( & V_45 , & V_46 , & V_47 , & V_48 , & V_74 , 0 , - 1 ) ;
}
...
F_50 ( & V_74 , V_41 ) ;
V_38 = F_44 ( & V_45 , & V_46 , & V_47 , & V_48 , & V_74 , 0 , - 1 ) ;
if ( ! V_38 )
F_54 ( V_41 , & V_74 ) ;
if ( V_51 )
...
int F_59 ( struct V_3 * V_4 , struct V_89 * V_28 )
{
struct V_5 * V_8 = V_1 ;
int V_90 ;
V_90 = ! ! F_60 () ;
