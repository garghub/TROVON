...
{
F_87 ( ! V_118 -> V_130 -> V_49 -> V_199 ) ;
return V_118 -> V_130 -> V_49 -> V_199 ( V_118 ) ;
}
...
static void F_158 ( struct V_118 * V_118 , T_2 V_135 , int V_200 )
{
if ( V_200 )
F_155 ( V_118 , V_135 ) ;
else
...
struct V_30 * * V_201 = V_118 -> V_119 ;
int V_200 = V_89 & V_202 ;
if ( ! F_143 ( V_118 ) ) {
F_156 ( V_118 , V_135 , V_200 ) ;
goto V_83;
}
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ )
...
continue;
if ( V_200 )
F_116 ( V_201 [ V_56 ] , V_135 ) ;
else
F_115 ( V_201 [ V_56 ] , V_135 ) ;
}
F_156 ( V_118 , V_135 , V_200 ) ;
F_6 ( & V_203 ) ;
if ( V_200 )
...
int V_56 , V_51 = 0 ;
struct V_154 V_155 [ V_27 ] ;
struct V_30 * const * V_201 = V_118 -> V_119 ;
if ( ! F_143 ( V_118 ) )
return 0 ;
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ )
V_155 [ V_56 ] . V_166 = V_175 ;
...
if ( ! V_201 [ V_56 ] )
continue;
V_51 = F_137 ( V_201 [ V_56 ] , 1 , & V_155 [ V_56 ] ) ;
if ( V_51 )
goto V_207;
}
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ ) {
...
if ( ! V_201 [ V_56 ] )
continue;
V_208 = F_142 ( V_201 [ V_56 ] , V_135 ) ;
if ( V_208 != V_175 )
F_131 ( & V_155 [ V_56 ] , V_201 [ V_56 ] , V_208 ) ;
if ( V_200 )
F_119 ( V_201 [ V_56 ] , V_135 ) ;
else
F_121 ( V_201 [ V_56 ] , V_135 ) ;
}
F_158 ( V_118 , V_135 , V_200 ) ;
F_6 ( & V_203 ) ;
if ( V_200 )
