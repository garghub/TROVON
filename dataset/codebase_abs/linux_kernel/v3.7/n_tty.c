...
V_2 -> V_16 = ( V_2 -> V_16 + 1 ) & ( V_7 - 1 ) ;
V_2 -> V_8 ++ ;
}
}
static void F_8 ( unsigned char V_14 , struct V_1 * V_2 )
{
unsigned long V_17 ;
F_9 ( & V_2 -> V_18 , V_17 ) ;
F_7 ( V_14 , V_2 ) ;
...
V_2 -> V_25 - V_2 -> V_20 :
V_2 -> V_25 + ( V_7 - V_2 -> V_20 ) ;
}
F_10 ( & V_2 -> V_18 , V_17 ) ;
return V_34 ;
}
static inline int F_19 ( unsigned char V_14 )
{
return ( V_14 & 0xc0 ) == 0x80 ;
}
static inline int F_20 ( unsigned char V_14 , struct V_1 * V_2 )
{
return F_21 ( V_2 ) && F_19 ( V_14 ) ;
}
static int F_22 ( unsigned char V_14 , struct V_1 * V_2 , int V_35 )
{
int V_36 ;
if ( ! V_35 )
return - 1 ;
...
static int F_30 ( unsigned char V_14 , struct V_1 * V_2 )
{
int V_35 , V_42 ;
F_14 ( & V_2 -> V_43 ) ;
V_35 = F_31 ( V_2 ) ;
V_42 = F_22 ( V_14 , V_2 , V_35 ) ;
F_15 ( & V_2 -> V_43 ) ;
if ( V_42 < 0 )
return - 1 ;
else
...
static void F_36 ( unsigned char V_14 , struct V_1 * V_2 )
{
int V_62 ;
if ( V_2 -> V_23 == V_7 ) {
V_62 = V_2 -> V_22 ;
...
static void F_39 ( unsigned int V_54 , int V_63 ,
struct V_1 * V_2 )
{
F_14 ( & V_2 -> V_21 ) ;
F_36 ( V_50 , V_2 ) ;
...
static void F_41 ( unsigned char V_14 , struct V_1 * V_2 )
{
F_14 ( & V_2 -> V_21 ) ;
if ( V_14 == V_50 ) {
F_36 ( V_50 , V_2 ) ;
...
static void F_44 ( unsigned char V_14 , struct V_1 * V_2 )
{
...
if ( V_14 == F_45 ( V_2 ) )
V_67 = V_64 ;
else if ( V_14 == F_46 ( V_2 ) )
V_67 = V_65 ;
else {
if ( ! F_47 ( V_2 ) ) {
F_9 ( & V_2 -> V_18 , V_17 ) ;
V_2 -> V_8 -= ( ( V_2 -> V_16 - V_2 -> V_25 ) &
( V_7 - 1 ) ) ;
V_2 -> V_16 = V_2 -> V_25 ;
F_10 ( & V_2 -> V_18 , V_17 ) ;
return;
}
if ( ! F_48 ( V_2 ) || ! F_49 ( V_2 ) || ! F_50 ( V_2 ) ) {
F_9 ( & V_2 -> V_18 , V_17 ) ;
V_2 -> V_8 -= ( ( V_2 -> V_16 - V_2 -> V_25 ) &
( V_7 - 1 ) ) ;
V_2 -> V_16 = V_2 -> V_25 ;
...
V_68 = ( V_68 - 1 ) & ( V_7 - 1 ) ;
V_14 = V_2 -> V_15 [ V_68 ] ;
} while ( F_20 ( V_14 , V_2 ) && V_68 != V_2 -> V_25 );
if ( F_20 ( V_14 , V_2 ) )
break;
if ( V_67 == V_65 ) {
...
while ( -- V_70 > 0 ) {
V_68 = ( V_68 + 1 ) & ( V_7 - 1 ) ;
F_40 ( V_2 -> V_15 [ V_68 ] , V_2 ) ;
F_37 ( V_2 ) ;
}
} else if ( V_67 == V_64 && ! F_50 ( V_2 ) ) {
F_41 ( F_45 ( V_2 ) , V_2 ) ;
} else if ( V_14 == '\t' ) {
unsigned int V_54 = 0 ;
int V_63 = 0 ;
...
if ( F_42 ( V_2 ) )
V_54 += 2 ;
} else if ( ! F_20 ( V_14 , V_2 ) ) {
V_54 ++ ;
}
}
F_39 ( V_54 , V_63 , V_2 ) ;
} else {
if ( iscntrl ( V_14 ) && F_42 ( V_2 ) ) {
F_40 ( '\b' , V_2 ) ;
F_40 ( ' ' , V_2 ) ;
F_40 ( '\b' , V_2 ) ;
}
...
if ( V_2 -> V_16 == V_2 -> V_25 && F_47 ( V_2 ) )
F_43 ( V_2 ) ;
}
static inline void F_53 ( int V_72 , struct V_1 * V_2 , int V_73 )
{
if ( V_2 -> V_74 )
F_54 ( V_2 -> V_74 , V_72 , 1 ) ;
if ( V_73 || ! F_55 ( V_2 ) ) {
F_16 ( V_2 ) ;
F_56 ( V_2 ) ;
}
...
if ( ! F_35 ( V_14 , V_2 -> V_86 ) || V_2 -> V_87 ) {
V_2 -> V_87 = 0 ;
V_81 = ( V_14 == ( unsigned char ) '\377' && F_5 ( V_2 ) ) ? 1 : 0 ;
if ( V_2 -> V_8 >= ( V_7 - V_81 - 1 ) ) {
if ( F_47 ( V_2 ) )
F_30 ( '\a' , V_2 ) ;
return;
}
...
V_14 = '\r' ;
if ( V_2 -> V_9 ) {
if ( V_14 == F_45 ( V_2 ) || V_14 == F_51 ( V_2 ) ||
( V_14 == F_46 ( V_2 ) && F_71 ( V_2 ) ) ) {
F_44 ( V_14 , V_2 ) ;
F_33 ( V_2 ) ;
return;
}
...
V_81 = ( V_14 == ( unsigned char ) '\377' && F_5 ( V_2 ) )
? 1 : 0 ;
if ( V_2 -> V_8 >= ( V_7 - V_81 ) ) {
if ( F_47 ( V_2 ) )
F_30 ( '\a' , V_2 ) ;
...
if ( V_2 -> V_104 ) {
F_9 ( & V_2 -> V_18 , V_103 ) ;
V_45 = F_98 ( V_7 - V_2 -> V_8 ,
V_7 - V_2 -> V_16 ) ;
V_45 = F_98 ( V_19 , V_45 ) ;
memcpy ( V_2 -> V_15 + V_2 -> V_16 , V_46 , V_45 ) ;
V_2 -> V_16 = ( V_2 -> V_16 + V_45 ) & ( V_7 - 1 ) ;
V_2 -> V_8 += V_45 ;
V_46 += V_45 ;
V_19 -= V_45 ;
V_45 = F_98 ( V_7 - V_2 -> V_8 ,
...
if ( V_121 && ! F_104 ( V_2 ) && V_2 -> V_8 )
F_17 ( & V_2 -> V_33 ) ;
V_2 -> V_9 = ( F_104 ( V_2 ) != 0 ) ;
if ( F_35 ( V_125 , & V_2 -> V_17 ) ) {
V_2 -> V_82 = 1 ;
V_2 -> V_104 = 1 ;
F_4 ( V_2 ) ;
return;
...
F_90 ( '\n' , V_2 -> V_86 ) ;
if ( F_104 ( V_2 ) ) {
F_90 ( F_45 ( V_2 ) , V_2 -> V_86 ) ;
F_90 ( F_51 ( V_2 ) , V_2 -> V_86 ) ;
...
return - V_129 ;
if ( ! V_2 -> V_15 ) {
V_2 -> V_15 = F_109 ( V_7 , V_130 ) ;
if ( ! V_2 -> V_15 )
return - V_131 ;
}
if ( ! V_2 -> V_49 ) {
V_2 -> V_49 = F_109 ( V_7 , V_130 ) ;
if ( ! V_2 -> V_49 )
return - V_131 ;
}
F_13 ( V_2 ) ;
...
V_42 = 0 ;
F_9 ( & V_2 -> V_18 , V_17 ) ;
V_34 = F_98 ( V_2 -> V_8 , V_7 - V_2 -> V_20 ) ;
V_34 = F_98 ( * V_44 , V_34 ) ;
F_10 ( & V_2 -> V_18 , V_17 ) ;
if ( V_34 ) {
...
V_34 -= V_42 ;
V_134 = V_34 == 1 &&
V_2 -> V_15 [ V_2 -> V_20 ] == F_89 ( V_2 ) ;
F_2 ( V_2 , & V_2 -> V_15 [ V_2 -> V_20 ] , V_34 ) ;
F_9 ( & V_2 -> V_18 , V_17 ) ;
V_2 -> V_20 = ( V_2 -> V_20 + V_34 ) & ( V_7 - 1 ) ;
V_2 -> V_8 -= V_34 ;
if ( F_72 ( V_2 ) && V_2 -> V_9 && V_134 && ! V_2 -> V_8 )
V_34 = 0 ;
F_10 ( & V_2 -> V_18 , V_17 ) ;
* V_133 += V_34 ;
* V_44 -= V_34 ;
...
static int F_114 ( struct V_1 * V_2 , struct V_135 * V_135 )
{
if ( V_135 -> V_136 -> V_40 != V_137 &&
...
static T_2 F_118 ( struct V_1 * V_2 , struct V_135 * V_135 ,
...
if ( F_120 ( ! V_2 -> V_15 ) )
return - V_147 ;
V_14 = F_114 ( V_2 , V_135 ) ;
if ( V_14 < 0 )
return V_14 ;
V_143 = time = 0 ;
V_145 = V_148 ;
if ( ! V_2 -> V_9 ) {
time = ( V_79 / 10 ) * F_121 ( V_2 ) ;
V_143 = F_122 ( V_2 ) ;
if ( V_143 ) {
if ( time )
V_2 -> V_110 = 1 ;
...
V_152 = V_2 -> V_28 -> V_31 ;
V_2 -> V_28 -> V_31 = 0 ;
F_10 ( & V_2 -> V_28 -> V_29 , V_17 ) ;
if ( F_1 ( V_2 , V_152 , V_133 ++ ) ) {
V_42 = - V_153 ;
V_133 -- ;
break;
}
...
F_126 ( V_154 ) ;
if ( ( ( V_143 - ( V_133 - V_12 ) ) < V_2 -> V_110 ) &&
( ( V_143 - ( V_133 - V_12 ) ) >= 1 ) )
V_2 -> V_110 = ( V_143 - ( V_133 - V_12 ) ) ;
if ( ! F_110 ( V_2 , 0 ) ) {
if ( F_35 ( V_155 , & V_2 -> V_17 ) ) {
V_42 = - V_139 ;
break;
}
if ( F_127 ( V_135 ) )
...
static T_2 F_133 ( struct V_1 * V_2 , struct V_135 * V_135 ,
...
int V_14 ;
T_2 V_42 = 0 ;
if ( F_134 ( V_2 ) && V_135 -> V_136 -> V_40 != V_137 ) {
V_42 = F_135 ( V_2 ) ;
if ( V_42 )
return V_42 ;
}
F_33 ( V_2 ) ;
F_125 ( & V_2 -> V_128 , & V_142 ) ;
while ( 1 ) {
F_126 ( V_154 ) ;
if ( F_128 ( V_112 ) ) {
V_42 = - V_141 ;
...
if ( F_127 ( V_135 ) || ( V_2 -> V_28 && ! V_2 -> V_28 -> V_19 ) ) {
V_42 = - V_139 ;
break;
}
if ( F_34 ( V_2 ) && ! ( F_35 ( V_59 , & V_2 -> V_17 ) ) ) {
while ( V_44 > 0 ) {
T_2 V_161 = F_32 ( V_2 , V_133 , V_44 ) ;
if ( V_161 < 0 ) {
if ( V_161 == - V_147 )
break;
V_42 = V_161 ;
...
V_47:
F_130 ( V_156 ) ;
F_132 ( & V_2 -> V_128 , & V_142 ) ;
if ( V_133 - V_12 != V_44 && V_2 -> V_94 )
F_90 ( V_97 , & V_2 -> V_17 ) ;
return ( V_133 - V_12 ) ? V_133 - V_12 : V_42 ;
}
static unsigned int F_137 ( struct V_1 * V_2 , struct V_135 * V_135 ,
T_4 * V_142 )
{
unsigned int V_162 = 0 ;
F_138 ( V_135 , & V_2 -> V_33 , V_142 ) ;
F_138 ( V_135 , & V_2 -> V_128 , V_142 ) ;
if ( F_110 ( V_2 , F_121 ( V_2 ) ? 0 : F_122 ( V_2 ) ) )
V_162 |= V_163 | V_164 ;
if ( V_2 -> V_30 && V_2 -> V_28 -> V_31 )
V_162 |= V_165 | V_163 | V_164 ;
if ( F_35 ( V_155 , & V_2 -> V_17 ) )
V_162 |= V_166 ;
if ( F_127 ( V_135 ) )
V_162 |= V_166 ;
if ( ! ( V_162 & ( V_166 | V_163 | V_164 ) ) ) {
if ( F_122 ( V_2 ) && ! F_121 ( V_2 ) )
V_2 -> V_110 = F_122 ( V_2 ) ;
else
V_2 -> V_110 = 1 ;
}
if ( V_2 -> V_39 -> V_40 && ! F_139 ( V_2 ) &&
F_140 ( V_2 ) < V_167 &&
F_31 ( V_2 ) > 0 )
V_162 |= V_168 | V_169 ;
return V_162 ;
...
V_68 = V_2 -> V_25 ;
V_71 = V_2 -> V_20 ;
V_44 = ( V_68 - V_71 ) & ( V_7 - 1 ) ;
while ( V_68 != V_71 ) {
if ( F_35 ( V_71 , V_2 -> V_27 ) &&
V_2 -> V_15 [ V_71 ] == V_93 )
V_44 -- ;
V_71 = ( V_71 + 1 ) & ( V_7 - 1 ) ;
}
...
static int F_142 ( struct V_1 * V_2 , struct V_135 * V_135 ,
unsigned int V_170 , unsigned long V_171 )
{
int V_42 ;
switch ( V_170 ) {
case V_172 :
return F_3 ( F_140 ( V_2 ) , ( int T_1 * ) V_171 ) ;
case V_173 :
V_42 = V_2 -> V_8 ;
if ( F_104 ( V_2 ) )
V_42 = F_141 ( V_2 ) ;
return F_3 ( V_42 , ( unsigned int T_1 * ) V_171 ) ;
default:
return F_143 ( V_2 , V_135 , V_170 , V_171 ) ;
}
}
void F_144 ( struct V_174 * V_39 )
{
* V_39 = V_175 ;
V_39 -> V_176 = NULL ;
V_39 -> V_177 = V_39 -> V_17 = 0 ;
}
