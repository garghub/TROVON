...
for ( V_50 = 0 ; V_50 < F_93 ( V_162 ) ; V_50 ++ )
if ( V_161 [ V_50 ] == V_178 )
V_182 -> V_183 ( V_182 ,
V_50 ,
V_179 ) ;
...
static void F_97 ( struct V_16 * V_12 )
{
...
static void F_98 ( void * V_191 , T_4 V_192 )
{
...
static void F_100 ( void * V_191 , T_4 V_192 )
{
struct V_16 * V_193 = V_191 ;
int V_39 ;
if ( V_193 -> V_46 == V_197 &&
...
static void F_102 ( struct V_8 * V_199 ,
...
static void F_103 ( struct V_8 * V_9 , bool V_169 ,
struct V_166 * V_200 ,
struct V_166 * V_201 )
{
struct V_48 * V_93 ;
...
default:
V_169 = F_74 ( V_9 ) ;
F_103 ( V_9 , V_169 , V_200 , V_201 ) ;
break;
}
}
static int F_106 ( struct V_16 * V_12 , int V_146 )
{
struct V_17 * V_14 = V_12 -> V_14 ;
struct V_8 * V_9 ;
struct V_16 * V_193 ;
...
& V_202 ) ;
F_112 ( & V_202 ) ;
F_90 ( V_12 , & V_201 , V_146 , false ) ;
F_97 ( V_12 ) ;
F_90 ( V_12 , & V_200 , V_146 , true ) ;
F_15 (d, &dapm->card->dapm_list, list)
F_111 ( F_100 , V_193 ,
& V_202 ) ;
F_112 ( & V_202 ) ;
...
static T_5 F_114 ( struct V_206 * V_206 ,
char T_6 * V_207 ,
T_3 V_208 , T_7 * V_209 )
{
...
V_39 = F_115 ( V_207 , V_208 , V_209 , V_5 , V_39 ) ;
F_7 ( V_5 ) ;
return V_39 ;
}
static T_5 F_116 ( struct V_206 * V_206 , char T_6 * V_207 ,
T_3 V_208 , T_7 * V_209 )
{
...
return F_115 ( V_207 , V_208 , V_209 , V_42 ,
strlen ( V_42 ) ) ;
}
void F_117 ( struct V_16 * V_12 ,
struct V_211 * V_212 )
{
struct V_211 * V_193 ;
V_12 -> V_213 = F_118 ( L_55 , V_212 ) ;
if ( ! V_12 -> V_213 ) {
F_67 ( V_12 -> V_3 ,
L_56 ) ;
return;
}
V_193 = F_119 ( L_57 , 0444 ,
V_12 -> V_213 , V_12 ,
& V_214 ) ;
if ( ! V_193 )
F_67 ( V_12 -> V_3 ,
...
static void F_121 ( struct V_16 * V_12 )
{
F_122 ( V_12 -> V_213 ) ;
}
void F_117 ( struct V_16 * V_12 ,
...
static inline void F_120 ( struct V_8 * V_9 )
{
}
static inline void F_121 ( struct V_16 * V_12 )
{
}
static int F_123 ( struct V_8 * V_125 ,
...
if ( V_217 ) {
F_10 ( V_125 , L_62 ) ;
F_106 ( V_125 -> V_12 , V_218 ) ;
}
return V_217 ;
}
int F_124 ( struct V_8 * V_125 ,
struct V_107 * V_96 , int V_216 , struct V_63 * V_64 )
{
struct V_17 * V_14 = V_125 -> V_12 -> V_14 ;
int V_39 ;
F_61 ( & V_14 -> V_18 , V_142 ) ;
V_39 = F_123 ( V_125 , V_96 , V_216 , V_64 ) ;
F_16 ( & V_14 -> V_18 ) ;
if ( V_39 > 0 )
F_125 ( V_125 ) ;
return V_39 ;
}
static int F_126 ( struct V_8 * V_125 ,
...
int F_127 ( struct V_8 * V_125 ,
struct V_107 * V_96 , int V_61 )
{
struct V_17 * V_14 = V_125 -> V_12 -> V_14 ;
int V_39 ;
F_61 ( & V_14 -> V_18 , V_142 ) ;
V_39 = F_126 ( V_125 , V_96 , V_61 ) ;
F_16 ( & V_14 -> V_18 ) ;
if ( V_39 > 0 )
F_125 ( V_125 ) ;
return V_39 ;
}
static T_5 F_128 ( struct V_2 * V_3 ,
struct V_219 * V_220 , char * V_5 )
{
struct V_221 * V_222 = F_129 ( V_3 ) ;
...
F_92 (w, next_w, &dapm->card->widgets, list) {
if ( V_9 -> V_12 != V_12 )
continue;
F_135 ( & V_9 -> V_97 ) ;
F_92 (p, next_p, &w->sources, list_sink) {
F_135 ( & V_49 -> V_99 ) ;
F_135 ( & V_49 -> V_101 ) ;
F_135 ( & V_49 -> V_97 ) ;
F_7 ( V_49 -> V_119 ) ;
...
F_92 (p, next_p, &w->sinks, list_source) {
F_135 ( & V_49 -> V_99 ) ;
F_135 ( & V_49 -> V_101 ) ;
F_135 ( & V_49 -> V_97 ) ;
F_7 ( V_49 -> V_119 ) ;
...
static int F_137 ( struct V_16 * V_12 ,
const char * V_228 , int V_231 )
{
struct V_8 * V_9 = F_136 ( V_12 , V_228 , true ) ;
if ( ! V_9 ) {
...
if ( V_93 ) {
F_10 ( V_93 -> V_138 , L_75 ) ;
F_10 ( V_93 -> V_136 , L_75 ) ;
F_135 ( & V_93 -> V_97 ) ;
F_135 ( & V_93 -> V_99 ) ;
F_135 ( & V_93 -> V_101 ) ;
F_7 ( V_93 ) ;
...
const struct V_233 * V_234 )
{
struct V_8 * V_138 = F_136 ( V_12 ,
V_234 -> V_138 ,
true ) ;
struct V_8 * V_136 = F_136 ( V_12 ,
V_234 -> V_136 ,
true ) ;
struct V_48 * V_93 ;
int V_208 = 0 ;
...
int F_146 ( struct V_107 * V_96 ,
struct V_245 * V_246 )
{
struct V_112 * V_113 = F_147 ( V_96 ) ;
...
V_31 = V_31 << V_58 ;
F_61 ( & V_14 -> V_18 , V_142 ) ;
V_36 = F_150 ( V_125 -> V_24 , V_30 , V_34 , V_31 ) ;
if ( V_36 ) {
...
F_61 ( & V_14 -> V_18 , V_142 ) ;
V_36 = F_150 ( V_125 -> V_24 , V_64 -> V_30 , V_34 , V_31 ) ;
if ( V_36 ) {
for ( V_247 = 0 ; V_247 < V_113 -> V_117 ; V_247 ++ ) {
V_125 = V_113 -> V_118 [ V_247 ] ;
V_125 -> V_35 = V_31 ;
...
F_123 ( V_125 , V_96 , V_125 -> V_35 , V_64 ) ;
}
}
F_16 ( & V_14 -> V_18 ) ;
return V_39 ;
...
switch ( V_9 -> V_19 ) {
case V_79 :
V_9 -> V_150 = F_164 ( V_12 -> V_3 , V_9 -> V_13 ) ;
if ( F_165 ( V_9 -> V_150 ) ) {
V_39 = F_166 ( V_9 -> V_150 ) ;
F_26 ( V_12 -> V_3 , L_85 ,
V_9 -> V_13 , V_39 ) ;
return NULL ;
}
...
case V_80 :
#ifdef F_167
V_9 -> V_151 = F_168 ( V_12 -> V_3 , V_9 -> V_13 ) ;
if ( F_165 ( V_9 -> V_151 ) ) {
V_39 = F_166 ( V_9 -> V_151 ) ;
F_26 ( V_12 -> V_3 , L_85 ,
V_9 -> V_13 , V_39 ) ;
return NULL ;
}
...
int V_39 ;
F_89 ( ! V_259 ) ;
F_89 ( F_9 ( & V_9 -> V_100 ) || F_9 ( & V_9 -> V_102 ) ) ;
V_256 = F_88 ( & V_9 -> V_100 , struct V_48 ,
V_99 ) ;
V_257 = F_88 ( & V_9 -> V_102 , struct V_48 ,
V_101 ) ;
F_89 ( ! V_256 || ! V_257 ) ;
F_89 ( ! V_257 -> V_138 || ! V_256 -> V_136 ) ;
F_89 ( ! V_256 -> V_138 || ! V_257 -> V_136 ) ;
V_138 = V_256 -> V_138 -> V_264 ;
V_136 = V_257 -> V_136 -> V_264 ;
if ( V_259 -> V_265 ) {
V_4 = F_171 ( V_259 -> V_265 ) - 1 ;
} else {
F_67 ( V_9 -> V_12 -> V_3 , L_87 ,
V_259 -> V_265 ) ;
V_4 = 0 ;
}
...
F_172 ( F_173 ( V_260 , V_266 ) , V_4 ) ;
F_174 ( V_260 , V_267 ) -> V_254 =
V_259 -> V_268 ;
F_174 ( V_260 , V_267 ) -> V_59 =
V_259 -> V_269 ;
F_174 ( V_260 , V_270 ) -> V_254
= V_259 -> V_271 ;
F_174 ( V_260 , V_270 ) -> V_59
= V_259 -> V_272 ;
...
F_67 ( V_136 -> V_3 , L_89 , V_39 ) ;
V_39 = 0 ;
break;
case V_172 :
V_39 = F_175 ( V_136 , 1 ) ;
if ( V_39 != 0 && V_39 != - V_276 )
F_67 ( V_136 -> V_3 , L_90 , V_39 ) ;
V_39 = 0 ;
break;
default:
F_20 () ;
...
V_280 = F_177 ( V_14 -> V_3 , V_279 , V_7 ) ;
if ( ! V_280 )
return - V_116 ;
snprintf ( V_280 , V_279 , L_91 , V_138 -> V_13 , V_136 -> V_13 ) ;
...
V_172 ;
F_53 ( V_14 -> V_3 , L_92 , V_280 ) ;
V_9 = F_163 ( & V_14 -> V_12 , & V_278 ) ;
if ( ! V_9 ) {
F_26 ( V_14 -> V_3 , L_93 ,
V_280 ) ;
return - V_116 ;
...
static void F_181 ( struct V_221 * V_222 , int V_141 ,
int V_146 )
{
...
F_106 ( & V_222 -> V_14 -> V_12 , V_146 ) ;
}
void F_182 ( struct V_221 * V_222 , int V_141 ,
int V_146 )
{
struct V_17 * V_14 = V_222 -> V_14 ;
F_61 ( & V_14 -> V_18 , V_142 ) ;
F_181 ( V_222 , V_141 , V_146 ) ;
F_16 ( & V_14 -> V_18 ) ;
}
int F_161 ( struct V_16 * V_12 , const char * V_228 )
{
return F_137 ( V_12 , V_228 , 1 ) ;
}
...
const char * V_228 )
{
return F_137 ( V_12 , V_228 , 0 ) ;
}
int F_184 ( struct V_16 * V_12 , const char * V_228 )
{
return F_137 ( V_12 , V_228 , 0 ) ;
}
...
const char * V_228 )
{
struct V_8 * V_9 = F_136 ( V_12 , V_228 , false ) ;
if ( ! V_9 ) {
F_26 ( V_12 -> V_3 , L_70 , V_228 ) ;
return - V_122 ;
}
