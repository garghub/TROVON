...
static int F_153 ( T_1 V_222 , T_10 V_239 ,
bool V_243 , struct V_11 * V_29 )
{
int V_18 ;
V_18 = memcmp ( & V_222 , V_244 , sizeof( V_222 ) ) ;
if ( V_18 == 0 ) {
F_32 ( L_82 ) ;
if ( V_243 )
...
if ( V_29 -> V_31 ) {
F_149 ( V_12 , F_155 ( struct V_225 ,
V_14 ) ) ;
}
if ( V_12 -> V_17 != sizeof( * V_12 ) ) {
if ( V_12 -> V_17 == F_155 ( F_156 ( * V_12 ) , V_14 ) )
F_157 ( V_12 -> V_14 , V_217 ) ;
else
return - 1 ;
} else if ( V_29 -> V_31 ) {
F_149 ( & V_12 -> V_14 ,
...
static int F_161 ( struct V_201 * T_13 ,
struct V_11 * V_29 ,
int V_13 , int V_15 , void * V_202 )
{
if ( F_80 ( V_15 , T_13 -> V_145 , V_148 ) == ( T_11 ) - 1 ) {
...
static int F_162 ( struct V_220 * V_12 ,
struct V_11 * V_29 , int V_15 ,
bool V_249 )
{
int V_18 ;
...
if ( V_18 <= 0 )
return - 1 ;
if ( F_153 ( V_12 -> V_222 , V_12 -> V_17 , true , V_29 ) < 0 ) {
F_32 ( L_85 ) ;
return - 1 ;
}
if ( V_29 -> V_31 )
...
static int F_163 ( struct V_61 * V_62 , int V_15 )
{
struct V_11 * V_12 = & V_62 -> V_12 ;
struct V_220 V_221 ;
if ( F_162 ( & V_221 , V_12 , V_15 ,
V_62 -> V_249 ) < 0 ) {
F_32 ( L_86 ) ;
return - V_251 ;
}
...
static int F_164 ( int V_15 , struct V_11 * V_29 ,
struct V_226 * V_227 )
{
...
static int F_165 ( struct V_110 * V_111 ,
struct V_257 * V_257 )
{
struct V_258 * V_203 ;
char V_20 [ 128 ] ;
if ( V_111 -> V_259 )
return 0 ;
V_203 = F_166 ( V_257 , V_111 -> V_115 . V_170 ) ;
if ( V_203 == NULL )
return - 1 ;
if ( ! V_111 -> V_2 ) {
...
static int F_167 ( struct V_88 * V_89 ,
struct V_257 * V_257 )
{
struct V_110 * V_46 ;
...
int F_168 ( struct V_61 * V_62 , int V_15 )
{
struct V_11 * V_12 = & V_62 -> V_12 ;
struct V_225 V_221 ;
struct V_226 V_227 ;
...
V_62 -> V_89 = F_169 ( NULL , NULL ) ;
if ( V_62 -> V_89 == NULL )
return - V_8 ;
if ( V_62 -> V_264 )
return F_163 ( V_62 , V_15 ) ;
if ( F_154 ( & V_221 , V_12 , V_15 ) < 0 )
return - V_251 ;
...
V_25 = F_175 ( V_269 , & V_111 -> V_115 , V_111 -> V_116 ,
V_111 -> V_1 , F_150 ) ;
if ( V_25 ) {
F_32 ( L_91 ) ;
return V_25 ;
...
if ( V_89 == NULL ) {
* V_274 = V_89 = F_169 ( NULL , NULL ) ;
if ( V_89 == NULL )
return - V_8 ;
}
V_111 = F_170 ( & V_203 -> V_115 . V_115 , V_89 -> V_114 ) ;
if ( V_111 == NULL )
return - V_8 ;
F_171 ( V_89 , V_111 ) ;
...
if ( F_172 ( V_111 , 1 , V_275 ) )
return - V_8 ;
for ( V_10 = 0 ; V_10 < V_275 ; V_10 ++ ) {
F_173 ( V_89 , V_111 , 0 , V_10 , V_203 -> V_115 . V_1 [ V_10 ] ) ;
}
return 0 ;
}
int F_178 ( struct V_268 * V_269 ,
T_1 V_9 , char * V_2 ,
T_14 F_150 ,
struct V_52 * V_52 )
{
...
int F_180 ( struct V_268 * V_269 V_87 ,
union V_270 * V_203 )
{
...
int F_181 ( struct V_268 * V_269 , int V_15 ,
struct V_88 * V_89 ,
T_14 F_150 )
{
union V_270 V_271 ;
...
int V_25 V_87 = 0 ;
V_279 = F_182 ( & V_89 -> V_90 , V_15 , true ) ;
if ( ! V_279 )
return - 1 ;
memset ( & V_271 , 0 , sizeof( V_271 ) ) ;
...
int F_187 ( struct V_268 * V_269 V_87 ,
union V_270 * V_203 ,
struct V_61 * V_62 )
{
F_105 ( & V_203 -> V_37 ,
