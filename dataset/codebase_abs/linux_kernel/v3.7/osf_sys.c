...
unsigned long V_100 )
{
struct V_101 * V_102 = F_29 ( V_103 -> V_104 , V_98 ) ;
while ( 1 ) {
if ( V_100 - V_99 < V_98 )
return - V_105 ;
if ( ! V_102 || V_98 + V_99 <= V_102 -> V_106 )
return V_98 ;
V_98 = V_102 -> V_107 ;
V_102 = V_102 -> V_108 ;
}
...
unsigned long
F_30 ( struct V_109 * V_110 , unsigned long V_98 ,
unsigned long V_99 , unsigned long V_111 ,
unsigned long V_77 )
{
unsigned long V_100 ;
...
if ( V_98 != ( unsigned long ) - V_105 )
return V_98 ;
}
V_98 = F_28 ( F_31 ( V_116 ) ,
V_99 , V_100 ) ;
if ( V_98 != ( unsigned long ) - V_105 )
return V_98 ;
V_98 = F_28 ( V_117 , V_99 , V_100 ) ;
return V_98 ;
}
static int
F_32 ( const struct V_118 T_3 * V_119 , unsigned long V_16 )
{
unsigned long V_87 ;
for ( V_87 = 0 ; V_87 < V_16 ; V_87 ++ ) {
int T_3 * V_120 = ( int T_3 * ) & V_119 [ V_87 ] . V_121 + 1 ;
if ( F_3 ( 0 , V_120 ) )
return - V_23 ;
}
return 0 ;
