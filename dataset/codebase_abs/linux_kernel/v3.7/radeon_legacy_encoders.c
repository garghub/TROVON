...
static void F_61 ( struct V_1 * V_2 , int V_10 )
{
struct V_11 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
T_1 V_188 = F_5 ( V_189 ) ;
...
static void F_69 ( struct V_1 * V_2 , int V_10 )
{
struct V_11 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_3 * V_3 = F_2 ( V_2 ) ;
...
static enum V_134 F_79 ( struct V_1 * V_2 ,
struct V_89 * V_135 )
{
struct V_11 * V_12 = V_2 -> V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
...
bool V_141 = true ;
struct V_317 * V_58 ;
F_80 (crtc, &dev->mode_config.crtc_list, head) {
...
static struct V_164 * F_81 ( struct V_3 * V_2 )
{
struct V_11 * V_12 = V_2 -> V_79 . V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_164 * V_165 = NULL ;
bool V_332 ;
V_165 = F_82 ( sizeof( struct V_164 ) , V_92 ) ;
if ( ! V_165 )
return NULL ;
if ( V_14 -> V_26 )
V_332 = F_83 ( V_2 , V_165 ) ;
else
...
static struct V_333 * F_86 ( struct V_3 * V_2 )
{
struct V_11 * V_12 = V_2 -> V_79 . V_12 ;
struct V_13 * V_14 = V_12 -> V_15 ;
...
if ( V_14 -> V_26 )
return NULL ;
V_165 = F_82 ( sizeof( struct V_333 ) , V_92 ) ;
if ( ! V_165 )
return NULL ;
V_332 = F_87 ( V_2 , V_165 ) ;
if ( V_332 == false )
F_88 ( V_2 , V_165 ) ;
return V_165 ;
}
void
F_89 ( struct V_11 * V_12 , T_1 V_334 , T_1 V_335 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_1 * V_2 ;
struct V_3 * V_3 ;
...
V_3 = F_82 ( sizeof( struct V_3 ) , V_92 ) ;
if ( ! V_3 )
return;
V_2 = & V_3 -> V_79 ;
if ( V_14 -> V_116 & V_117 )
...
break;
case V_346 :
F_90 ( V_12 , V_2 , & V_347 , V_348 ) ;
F_91 ( V_2 , & V_349 ) ;
V_3 -> V_25 = F_81 ( V_3 ) ;
break;
case V_350 :
F_90 ( V_12 , V_2 , & V_351 , V_352 ) ;
F_91 ( V_2 , & V_353 ) ;
if ( V_14 -> V_26 )
V_3 -> V_25 = F_94 ( V_3 ) ;
else
