...
if ( V_21 == V_3 -> V_23 - 1 && V_29 -> V_4 != V_24 )
F_18 ( V_29 -> V_4 ) ;
if ( F_8 ( V_3 -> V_9 ) )
...
{
struct V_1 * V_30 = F_1 ( V_3 , V_21 ) , * V_31 ;
F_18 ( V_30 -> V_4 ) ;
...
static int
F_22 ( struct V_10 * V_11 , struct V_32 * V_33 [] ,
enum V_16 V_17 , T_1 * V_34 , T_1 V_35 , bool V_36 )
{
struct V_2 * V_3 = V_11 -> V_20 ;
...
if ( V_33 [ V_46 ] )
* V_34 = F_25 ( V_33 [ V_46 ] ) ;
V_4 = F_26 ( F_27 ( V_33 [ V_42 ] ) , & V_41 ) ;
if ( V_4 == V_24 )
return - V_47 ;
if ( V_41 -> type -> V_48 & V_49 ) {
V_22 = - V_50 ;
goto V_51;
}
if ( V_33 [ V_44 ] ) {
T_1 V_52 = F_28 ( V_33 [ V_44 ] ) ;
V_39 = V_52 & V_53 ;
}
if ( V_39 && ! V_33 [ V_54 ] ) {
V_22 = - V_55 ;
...
V_8 = F_1 ( V_3 , V_21 ) ;
if ( V_8 -> V_4 == V_24 ||
( V_39 != 0 && V_21 + 1 >= V_3 -> V_23 ) )
break;
else if ( F_8 && F_5 ( V_3 , V_21 ) )
continue;
else if ( V_39 > 0 && V_8 -> V_4 == V_4 )
V_22 = F_13 ( V_3 , V_21 + 1 , V_40 ) ;
else if ( V_39 < 0 && V_8 -> V_4 == V_40 )
...
if ( ( V_39 > 1 &&
! F_12 ( V_3 , V_21 + 1 , V_40 ) ) ||
( V_39 < 0 &&
( V_21 == 0 || ! F_12 ( V_3 , V_21 - 1 , V_40 ) ) ) ) {
V_22 = - V_58 ;
goto V_51;
}
V_29 -> V_9 = F_19 ( V_9 ) ;
...
case V_27 :
V_22 = - V_58 ;
for ( V_21 = 0 ; V_21 < V_3 -> V_23 && V_22 == - V_58 ; V_21 ++ ) {
V_8 = F_1 ( V_3 , V_21 ) ;
if ( V_8 -> V_4 == V_24 ) {
V_22 = V_39 != 0 ? - V_60
: - V_58 ;
...
( V_39 == 0 ||
( V_39 > 0 && F_12 ( V_3 , V_21 + 1 , V_40 ) ) ) )
V_22 = F_20 ( V_3 , V_21 ) ;
else if ( V_8 -> V_4 == V_40 &&
V_39 < 0 && F_12 ( V_3 , V_21 + 1 , V_4 ) )
...
if ( ! V_62 )
goto V_64;
if ( F_37 ( V_13 , V_65 , F_38 ( V_3 -> V_23 ) ) ||
( F_8 ( V_3 -> V_9 ) &&
F_37 ( V_13 , V_43 , F_38 ( V_3 -> V_9 ) ) ) ||
F_37 ( V_13 , V_66 , F_38 ( V_11 -> V_67 - 1 ) ) ||
F_37 ( V_13 , V_68 ,
...
struct V_12 * V_13 , struct V_70 * V_71 )
{
const struct V_2 * V_3 = V_11 -> V_20 ;
struct V_32 * V_72 , * V_62 ;
T_1 V_21 , V_73 = V_71 -> args [ 2 ] ;
const struct V_1 * V_29 ;
V_72 = F_36 ( V_13 , V_74 ) ;
if ( ! V_72 )
return - V_69 ;
for (; V_71 -> args [ 2 ] < V_3 -> V_23 ; V_71 -> args [ 2 ] ++ ) {
V_21 = V_71 -> args [ 2 ] ;
V_29 = F_1 ( V_3 , V_21 ) ;
if ( V_29 -> V_4 == V_24 )
goto V_51;
...
goto V_64;
if ( F_8 ( V_3 -> V_9 ) ) {
const struct V_7 * V_75 =
( const struct V_7 * ) V_29 ;
T_3 V_76 = F_38 ( F_44 ( V_75 -> V_9 ) ) ;
if ( F_37 ( V_13 , V_43 , V_76 ) )
goto V_64;
}
F_39 ( V_13 , V_62 ) ;
}
...
static bool
F_45 ( const struct V_10 * V_30 , const struct V_10 * V_31 )
{
const struct V_2 * V_77 = V_30 -> V_20 ;
const struct V_2 * V_78 = V_31 -> V_20 ;
return V_77 -> V_23 == V_78 -> V_23 &&
V_77 -> V_9 == V_78 -> V_9 ;
}
static void
...
F_21 ( V_3 ) ;
F_48 ( & V_11 -> V_80 ) ;
V_3 -> V_61 . V_81 = V_82 + F_49 ( V_3 -> V_9 ) * V_83 ;
F_50 ( & V_3 -> V_61 ) ;
}
static void
...
struct V_2 * V_3 = V_11 -> V_20 ;
F_52 ( & V_3 -> V_61 ) ;
V_3 -> V_61 . V_20 = ( unsigned long ) V_11 ;
V_3 -> V_61 . V_84 = F_46 ;
V_3 -> V_61 . V_81 = V_82 + F_49 ( V_3 -> V_9 ) * V_83 ;
F_50 ( & V_3 -> V_61 ) ;
}
...
static int
F_55 ( struct V_10 * V_11 , struct V_32 * V_33 [] , T_1 V_35 )
{
T_1 V_23 = V_86 ;
if ( F_23 ( ! F_24 ( V_33 , V_65 ) ||
! F_24 ( V_33 , V_43 ) ) )
return - V_45 ;
if ( V_33 [ V_65 ] )
V_23 = F_28 ( V_33 [ V_65 ] ) ;
