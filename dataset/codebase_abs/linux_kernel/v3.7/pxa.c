...
static int T_2
F_61 ( struct V_160 * V_161 , char * V_167 )
{
struct V_1 * V_2 ;
int V_119 = 9600 ;
int V_168 = 8 ;
int V_33 = 'n' ;
int V_169 = 'n' ;
if ( V_161 -> V_37 == - 1 || V_161 -> V_37 >= V_170 . V_171 )
V_161 -> V_37 = 0 ;
V_2 = V_163 [ V_161 -> V_37 ] ;
if ( ! V_2 )
return - V_172 ;
if ( V_167 )
F_62 ( V_167 , & V_119 , & V_33 , & V_168 , & V_169 ) ;
return F_63 ( & V_2 -> V_4 , V_161 , V_119 , V_33 , V_168 , V_169 ) ;
}
static int F_64 ( struct V_173 * V_174 )
{
struct V_1 * V_175 = F_65 ( V_174 ) ;
if ( V_175 )
F_66 ( & V_170 , & V_175 -> V_4 ) ;
return 0 ;
}
...
struct V_1 * V_175 = F_65 ( V_174 ) ;
if ( V_175 )
F_68 ( & V_170 , & V_175 -> V_4 ) ;
return 0 ;
}
static int F_69 ( struct V_176 * V_177 ,
struct V_1 * V_175 )
{
struct V_178 * V_179 = V_177 -> V_174 . V_180 ;
int V_75 ;
if ( ! V_179 )
return 1 ;
V_75 = F_70 ( V_179 , L_1 ) ;
if ( V_75 < 0 ) {
F_71 ( & V_177 -> V_174 , L_2 , V_75 ) ;
return V_75 ;
}
V_175 -> V_4 . line = V_75 ;
return 0 ;
}
static int F_72 ( struct V_176 * V_174 )
{
struct V_1 * V_175 ;
struct V_181 * V_182 , * V_183 ;
int V_75 ;
V_182 = F_73 ( V_174 , V_184 , 0 ) ;
V_183 = F_73 ( V_174 , V_185 , 0 ) ;
if ( ! V_182 || ! V_183 )
return - V_172 ;
V_175 = F_74 ( sizeof( struct V_1 ) , V_186 ) ;
if ( ! V_175 )
return - V_187 ;
V_175 -> V_105 = F_75 ( & V_174 -> V_174 , NULL ) ;
if ( F_76 ( V_175 -> V_105 ) ) {
V_75 = F_77 ( V_175 -> V_105 ) ;
goto V_188;
}
V_175 -> V_4 . type = V_153 ;
V_175 -> V_4 . V_189 = V_190 ;
V_175 -> V_4 . V_191 = V_182 -> V_192 ;
V_175 -> V_4 . V_65 = V_183 -> V_192 ;
V_175 -> V_4 . V_49 = 64 ;
V_175 -> V_4 . V_193 = & V_194 ;
V_175 -> V_4 . V_174 = & V_174 -> V_174 ;
V_175 -> V_4 . V_74 = V_195 | V_196 ;
V_175 -> V_4 . V_104 = F_33 ( V_175 -> V_105 ) ;
V_75 = F_69 ( V_174 , V_175 ) ;
if ( V_75 > 0 )
V_175 -> V_4 . line = V_174 -> V_197 ;
else if ( V_75 < 0 )
goto V_198;
snprintf ( V_175 -> V_106 , V_199 - 1 , L_3 , V_175 -> V_4 . line + 1 ) ;
V_175 -> V_4 . V_5 = F_78 ( V_182 -> V_192 , F_79 ( V_182 ) ) ;
if ( ! V_175 -> V_4 . V_5 ) {
V_75 = - V_187 ;
goto V_198;
}
V_163 [ V_175 -> V_4 . line ] = V_175 ;
F_80 ( & V_170 , & V_175 -> V_4 ) ;
F_81 ( V_174 , V_175 ) ;
return 0 ;
V_198:
F_82 ( V_175 -> V_105 ) ;
...
static int F_84 ( struct V_176 * V_174 )
{
struct V_1 * V_175 = F_85 ( V_174 ) ;
F_81 ( V_174 , NULL ) ;
F_86 ( & V_170 , & V_175 -> V_4 ) ;
F_82 ( V_175 -> V_105 ) ;
F_83 ( V_175 ) ;
return 0 ;
}
