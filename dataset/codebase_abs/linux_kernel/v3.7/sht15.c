...
struct V_4 * V_5 ;
T_1 V_24 = 0 ;
V_5 = F_56 ( & V_78 -> V_18 , sizeof( * V_5 ) , V_94 ) ;
if ( ! V_5 )
return - V_95 ;
F_57 ( & V_5 -> V_43 , F_49 ) ;
F_57 ( & V_5 -> V_85 , F_52 ) ;
...
V_21 = F_66 ( & V_78 -> V_18 , V_5 -> V_11 -> V_14 , L_9 ) ;
if ( V_21 ) {
F_13 ( & V_78 -> V_18 , L_10 ) ;
goto V_104;
}
F_4 ( V_5 -> V_11 -> V_14 , 0 ) ;
V_21 = F_66 ( & V_78 -> V_18 , V_5 -> V_11 -> V_12 ,
L_11 ) ;
if ( V_21 ) {
F_13 ( & V_78 -> V_18 , L_10 ) ;
goto V_104;
}
V_21 = F_67 ( & V_78 -> V_18 , F_28 ( V_5 -> V_11 -> V_12 ) ,
F_47 ,
V_105 ,
L_12 ,
V_5 ) ;
...
V_21 = F_68 ( & V_78 -> V_18 . V_106 , & V_107 ) ;
if ( V_21 ) {
F_13 ( & V_78 -> V_18 , L_14 ) ;
goto V_104;
}
V_5 -> V_108 = F_69 ( V_5 -> V_18 ) ;
if ( F_62 ( V_5 -> V_108 ) ) {
V_21 = F_70 ( V_5 -> V_108 ) ;
goto V_109;
}
return 0 ;
V_109:
F_71 ( & V_78 -> V_18 . V_106 , & V_107 ) ;
V_104:
if ( ! F_62 ( V_5 -> V_86 ) ) {
F_72 ( V_5 -> V_86 , & V_5 -> V_88 ) ;
F_65 ( V_5 -> V_86 ) ;
}
return V_21 ;
}
static int T_7 F_73 ( struct V_77 * V_78 )
{
struct V_4 * V_5 = F_74 ( V_78 ) ;
F_22 ( & V_5 -> V_31 ) ;
if ( F_15 ( V_5 ) ) {
F_24 ( & V_5 -> V_31 ) ;
return - V_110 ;
