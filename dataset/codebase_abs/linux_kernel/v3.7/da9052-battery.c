...
int * V_4 = V_66 ;
int V_5 ;
struct V_2 * V_3 = F_21 ( V_76 , struct V_2 ,
V_76 ) ;
if ( V_3 -> V_6 == V_7 )
return - V_80 ;
...
return F_22 ( V_3 -> V_9 , V_87 ,
V_88 , V_79 ) ;
}
static int F_23 ( struct V_89 * V_73 ,
enum V_90 V_91 ,
union V_92 * V_93 )
{
int V_5 ;
int V_39 ;
struct V_2 * V_3 = F_21 ( V_73 , struct V_2 ,
V_73 ) ;
V_5 = F_10 ( V_3 , & V_39 ) ;
if ( V_5 < 0 )
return V_5 ;
...
static T_3 T_4 F_24 ( struct V_108 * V_109 )
{
struct V_110 * V_111 ;
struct V_2 * V_3 ;
int V_5 ;
int V_65 ;
int V_49 ;
V_3 = F_25 ( sizeof( struct V_2 ) , V_112 ) ;
if ( ! V_3 )
return - V_113 ;
V_3 -> V_9 = F_26 ( V_109 -> V_114 . V_115 ) ;
V_3 -> V_73 = V_116 ;
V_3 -> V_30 = V_35 ;
V_3 -> V_6 = V_117 ;
V_3 -> V_58 = V_60 ;
...
V_3 -> V_73 . V_120 = 1 ;
for ( V_49 = 0 ; V_49 < F_27 ( V_121 ) ; V_49 ++ ) {
V_65 = F_28 ( V_109 , V_121 [ V_49 ] ) ;
V_5 = F_29 ( V_3 -> V_9 -> V_67 + V_65 ,
NULL , F_18 ,
V_122 | V_123 ,
V_121 [ V_49 ] , V_3 ) ;
if ( V_5 != 0 ) {
...
while ( -- V_49 >= 0 ) {
V_65 = F_28 ( V_109 , V_121 [ V_49 ] ) ;
F_33 ( V_3 -> V_9 -> V_67 + V_65 , V_3 ) ;
}
F_34 ( V_3 ) ;
return V_5 ;
}
static int T_5 F_35 ( struct V_108 * V_109 )
{
int V_49 ;
int V_65 ;
