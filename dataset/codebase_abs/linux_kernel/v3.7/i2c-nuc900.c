...
static int T_3 F_28 ( struct V_73 * V_74 )
{
struct V_1 * V_2 ;
struct V_75 * V_76 ;
struct V_77 * V_78 ;
...
V_2 = F_29 ( sizeof( struct V_1 ) , V_80 ) ;
if ( ! V_2 ) {
F_14 ( & V_74 -> V_4 , L_19 ) ;
return - V_81 ;
}
F_30 ( V_2 -> V_64 . V_82 , L_20 , sizeof( V_2 -> V_64 . V_82 ) ) ;
V_2 -> V_64 . V_83 = V_84 ;
V_2 -> V_64 . V_85 = & V_86 ;
V_2 -> V_64 . V_67 = 2 ;
V_2 -> V_64 . V_87 = V_88 | V_89 ;
F_31 ( & V_2 -> V_61 ) ;
F_32 ( & V_2 -> V_9 ) ;
V_2 -> V_4 = & V_74 -> V_4 ;
V_2 -> V_90 = F_33 ( & V_74 -> V_4 , NULL ) ;
if ( F_34 ( V_2 -> V_90 ) ) {
F_14 ( & V_74 -> V_4 , L_21 ) ;
V_3 = - V_91 ;
goto V_92;
}
F_2 ( & V_74 -> V_4 , L_22 , V_2 -> V_90 ) ;
F_35 ( V_2 -> V_90 ) ;
V_78 = F_36 ( V_74 , V_93 , 0 ) ;
if ( V_78 == NULL ) {
F_14 ( & V_74 -> V_4 , L_23 ) ;
V_3 = - V_91 ;
goto V_94;
}
V_2 -> V_95 = F_37 ( V_78 -> V_96 , F_38 ( V_78 ) ,
V_74 -> V_82 ) ;
if ( V_2 -> V_95 == NULL ) {
F_14 ( & V_74 -> V_4 , L_24 ) ;
V_3 = - V_33 ;
...
V_2 -> V_11 = F_39 ( V_78 -> V_96 , F_38 ( V_78 ) ) ;
if ( V_2 -> V_11 == NULL ) {
F_14 ( & V_74 -> V_4 , L_25 ) ;
V_3 = - V_33 ;
goto V_97;
...
F_2 ( & V_74 -> V_4 , L_26 ,
V_2 -> V_11 , V_2 -> V_95 , V_78 ) ;
V_2 -> V_64 . V_65 = V_2 ;
V_2 -> V_64 . V_4 . V_98 = & V_74 -> V_4 ;
F_40 ( & V_74 -> V_4 , NULL ) ;
F_41 ( V_2 -> V_90 ) ;
V_3 = ( V_2 -> V_90 . V_99 ) / ( V_76 -> V_100 * 5 ) - 1 ;
F_6 ( V_3 & 0xffff , V_2 -> V_11 + V_101 ) ;
V_2 -> V_102 = V_3 = F_42 ( V_74 , 0 ) ;
if ( V_3 <= 0 ) {
F_14 ( & V_74 -> V_4 , L_27 ) ;
goto V_103;
}
V_3 = F_43 ( V_2 -> V_102 , F_17 , V_104 ,
F_44 ( & V_74 -> V_4 ) , V_2 ) ;
if ( V_3 != 0 ) {
F_14 ( & V_74 -> V_4 , L_28 , V_2 -> V_102 ) ;
goto V_103;
}
V_2 -> V_64 . V_105 = V_76 -> V_106 ;
V_3 = F_45 ( & V_2 -> V_64 ) ;
if ( V_3 < 0 ) {
F_14 ( & V_74 -> V_4 , L_29 ) ;
goto V_107;
...
static int T_4 F_54 ( struct V_73 * V_74 )
{
struct V_1 * V_2 = F_55 ( V_74 ) ;
F_56 ( & V_2 -> V_64 ) ;
F_48 ( V_2 -> V_102 , V_2 ) ;
F_52 ( V_2 -> V_90 ) ;
F_53 ( V_2 -> V_90 ) ;
