...
int F_24 ( struct V_35 * V_36 , T_4 V_56 )
{
int V_57 ;
T_4 V_58 , V_52 , V_59 ;
unsigned V_60 , V_61 ;
V_52 = V_36 -> V_52 + V_56 ;
V_60 = F_25 ( V_36 -> V_52 , V_36 -> V_50 ) ;
V_61 = F_25 ( V_52 , V_36 -> V_50 ) ;
V_59 = F_25 ( V_52 , V_36 -> V_50 ) ;
...
struct V_3 * V_4 ;
struct V_43 V_63 ;
V_57 = F_26 ( V_36 -> V_38 , & V_64 , & V_4 ) ;
if ( V_57 < 0 )
return V_57 ;
V_63 . V_8 = F_3 ( F_4 ( V_4 ) ) ;
V_57 = F_27 ( V_36 -> V_38 , V_4 ) ;
if ( V_57 < 0 )
return V_57 ;
...
struct V_43 V_69 ;
struct V_3 * V_70 ;
V_4 = F_29 ( V_68 , V_36 -> V_50 ) ;
V_57 = V_36 -> V_71 ( V_36 , V_68 , & V_69 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_30 ( V_36 -> V_38 , F_8 ( V_69 . V_8 ) ,
& V_64 , & V_70 ) ;
if ( V_57 < 0 )
return V_57 ;
* V_33 = F_15 ( F_13 ( V_70 ) , V_4 ) ;
return F_27 ( V_36 -> V_38 , V_70 ) ;
}
int F_31 ( struct V_35 * V_36 , T_4 V_4 , V_48 * V_33 )
{
V_11 V_72 ;
int V_57 = F_28 ( V_36 , V_4 , V_33 ) ;
if ( V_57 )
return V_57 ;
if ( * V_33 != 3 )
return V_57 ;
V_57 = F_32 ( & V_36 -> V_47 , V_36 -> V_54 , & V_4 , & V_72 ) ;
if ( V_57 < 0 )
return V_57 ;
* V_33 = F_10 ( V_72 ) ;
return V_57 ;
...
struct V_43 V_69 ;
T_4 V_58 , V_73 = V_31 ;
T_4 V_74 = F_25 ( V_32 , V_36 -> V_50 ) ;
V_31 = F_29 ( V_73 , V_36 -> V_50 ) ;
...
V_57 = F_20 ( F_13 ( V_70 ) ,
F_34 ( unsigned , V_31 , F_10 ( V_69 . V_66 ) ) ,
V_76 , & V_75 ) ;
if ( V_57 == - V_34 ) {
F_27 ( V_36 -> V_38 , V_70 ) ;
continue;
...
void * V_83 ;
int V_44 ;
V_80 = F_29 ( V_68 , V_36 -> V_50 ) ;
V_57 = V_36 -> V_71 ( V_36 , V_68 , & V_69 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_36 ( V_36 -> V_38 , F_8 ( V_69 . V_8 ) ,
& V_64 , & V_82 , & V_44 ) ;
if ( V_57 < 0 ) {
F_9 ( L_7 ) ;
return V_57 ;
...
V_36 -> V_85 -- ;
F_40 ( & V_69 . V_65 , 1 ) ;
V_69 . V_66 = F_5 ( F_41 ( F_10 ( V_69 . V_66 ) , V_80 ) ) ;
}
return V_36 -> V_67 ( V_36 , V_68 , & V_69 ) ;
}
int F_42 ( struct V_35 * V_36 , T_4 V_4 , enum V_78 * V_79 )
{
int V_57 ;
V_48 V_87 ;
V_57 = F_31 ( V_36 , V_4 , & V_87 ) ;
if ( V_57 )
return V_57 ;
return F_35 ( V_36 , V_4 , V_87 + 1 , V_79 ) ;
}
...
static int F_45 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
...
int V_57 ;
struct V_3 * V_91 ;
V_57 = F_30 ( V_36 -> V_38 , V_36 -> V_53 ,
& V_90 , & V_91 ) ;
if ( V_57 )
return V_57 ;
memcpy ( & V_36 -> V_7 , F_2 ( V_91 ) , sizeof( V_36 -> V_7 ) ) ;
return F_27 ( V_36 -> V_38 , V_91 ) ;
}
static T_4 F_49 ( struct V_35 * V_36 )
{
return V_92 ;
}
...
int V_57 , V_44 ;
struct V_3 * V_4 ;
V_57 = F_36 ( V_36 -> V_38 , V_36 -> V_53 , & V_90 , & V_4 , & V_44 ) ;
if ( V_57 )
return V_57 ;
memcpy ( F_2 ( V_4 ) , & V_36 -> V_7 , sizeof( V_36 -> V_7 ) ) ;
V_36 -> V_53 = F_4 ( V_4 ) ;
...
if ( V_57 < 0 )
return V_57 ;
V_57 = F_52 ( & V_36 -> V_47 , & V_36 -> V_54 ) ;
if ( V_57 < 0 )
return V_57 ;
return 0 ;
}
int F_53 ( struct V_35 * V_36 , struct V_37 * V_38 ,
void * V_95 , T_1 V_96 )
{
int V_57 ;
...
static int F_54 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
return F_32 ( & V_36 -> V_39 , V_36 -> V_53 , & V_68 , V_89 ) ;
}
static int F_55 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
F_38 ( V_89 ) ;
return F_39 ( & V_36 -> V_39 , V_36 -> V_53 ,
& V_68 , V_89 , & V_36 -> V_53 ) ;
}
static int F_56 ( struct V_35 * V_36 )
{
return F_52 ( & V_36 -> V_39 , & V_36 -> V_53 ) ;
}
static int F_57 ( struct V_35 * V_36 )
{
return 0 ;
}
static T_4 F_58 ( struct V_35 * V_36 )
{
return - 1ULL ;
}
