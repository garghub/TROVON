...
if ( V_9 -> V_72 ) {
V_3 = F_32 ( V_52 -> V_53 ) ;
if ( V_52 -> V_111 < ( 1000000 / 8 * V_3 ) ) {
V_52 -> V_111 = 1000000 / 8 * V_3 ;
V_4 ++ ;
}
V_98 =
...
if ( V_52 -> V_112 != V_52 -> V_53 ) {
V_52 -> V_112 = V_52 -> V_53 ;
V_4 ++ ;
}
if ( V_52 -> V_107 == V_106 ) {
} else {
...
static void F_36 ( unsigned int V_114 ,
T_2 * V_115 ,
T_2 * V_116 )
{
if ( V_114 < 8 )
...
static int F_37 ( struct V_1 * V_9 , int V_117 )
{
int V_118 , V_119 ;
V_9 -> V_120 [ 0 ] = V_117 ;
#ifdef F_38
...
static int F_42 ( struct V_1 * V_9 , int V_124 )
{
int V_118 = ( - V_12 ) ;
int V_125 ;
int V_3 ;
...
V_114 = F_46 ( V_52 -> V_136 [ V_3 ] ) ;
F_36 ( V_114 , & V_115 , & V_116 ) ;
if ( V_3 >= V_137 ) {
F_11 ( & V_9 -> V_7 -> V_8 ,
L_51 ,
V_8 -> V_36 ) ;
...
static int F_48 ( struct V_14 * V_8 , int V_114 )
{
struct V_1 * V_9 = V_8 -> V_18 ;
T_2 V_133 = 0 ;
V_54 V_142 ;
...
L_69
L_70 , V_8 -> V_36 , V_4 , V_52 -> V_102 ,
V_52 -> V_111 , V_52 -> V_104 , V_52 -> V_150 ) ;
if ( V_4 )
return 3 ;
return 0 ;
}
...
return F_65 ( V_8 , V_16 , F_46 ( V_140 -> V_144 ) , V_141 [ 0 ] , 0 ) ;
}
...
static void F_77 ( struct V_14 * V_8 )
{
...
static void F_78 ( const struct V_232 * V_233 ,
void * V_27 )
{
struct V_1 * V_2 = V_27 ;
...
V_11 = F_27 ( V_2 , V_233 -> V_141 , V_233 -> V_234 ) ;
if ( V_11 ) {
F_11 ( & V_228 -> V_8 ,
L_100 , V_11 ) ;
goto V_148;
...
static int F_81 ( struct V_227 * V_228 ,
const struct V_236 * V_237 )
{
struct V_238 * V_239 = F_82 ( V_228 ) ;
...
F_3 ( V_8 , L_104
L_105 , V_241 ) ;
F_83 ( & ( V_1 [ V_241 ] . V_19 ) , 1 ) ;
V_1 [ V_241 ] . V_45 = V_239 ;
V_1 [ V_241 ] . V_7 = V_228 ;
V_1 [ V_241 ] . V_244 = V_228 -> V_245 -> V_246 . V_247 ;
F_70 ( V_228 , & ( V_1 [ V_241 ] ) ) ;
F_3 ( V_8 , L_106 , V_1 [ V_241 ] . V_244 ) ;
V_1 [ V_241 ] . V_72 =
( V_1 [ V_241 ] . V_45 -> V_248 == V_249 ) ;
V_1 [ V_241 ] . V_68 = F_84 ( V_67 , V_91 ) ;
if ( ! V_1 [ V_241 ] . V_68 ) {
F_11 ( V_8 , L_107
L_108 ) ;
F_69 ( & ( V_1 [ V_241 ] ) ) ;
...
V_1 [ V_241 ] . V_120 = F_84 ( V_122 , V_91 ) ;
if ( ! V_1 [ V_241 ] . V_120 ) {
F_11 ( V_8 , L_107
L_109 ) ;
F_69 ( & ( V_1 [ V_241 ] ) ) ;
...
V_1 [ V_241 ] . V_128 = F_84 ( V_129 , V_91 ) ;
if ( ! ( V_1 [ V_241 ] . V_128 ) ) {
F_11 ( V_8 , L_107
L_111 ) ;
F_69 ( & ( V_1 [ V_241 ] ) ) ;
...
V_1 [ V_241 ] . V_146 = F_84 ( V_71 , V_91 ) ;
if ( ! ( V_1 [ V_241 ] . V_146 ) ) {
F_11 ( V_8 , L_107
L_112 ) ;
F_69 ( & ( V_1 [ V_241 ] ) ) ;
...
V_1 [ V_241 ] . V_6 = V_251 ;
V_1 [ V_241 ] . V_5 =
F_84 ( sizeof( struct V_22 * ) * V_1 [ V_241 ] . V_6 ,
V_91 ) ;
if ( ! ( V_1 [ V_241 ] . V_5 ) ) {
F_11 ( V_8 , L_107
L_115 ) ;
...
V_1 [ V_241 ] . V_57 =
F_84 ( sizeof( struct V_22 * ) * V_1 [ V_241 ] . V_58 ,
V_91 ) ;
if ( ! ( V_1 [ V_241 ] . V_57 ) ) {
F_11 ( V_8 , L_107
L_118 ) ;
...
V_1 [ V_241 ] . V_57 [ V_3 ] = F_86 ( 1 , V_91 ) ;
...
static void F_90 ( struct V_227 * V_261 )
{
struct V_1 * V_2 = F_76 ( V_261 ) ;
struct V_238 * V_239 = F_82 ( V_261 ) ;
if ( ! V_2 ) {
F_11 ( & V_261 -> V_8 ,
L_123 ) ;
return;
