...
static int F_84 ( struct V_226 * V_139 ,
int (* F_85)( struct V_171 * , struct V_226 * ) )
{
struct V_59 * V_60 = V_199 ;
int V_198 ;
...
if ( V_60 -> V_139 )
return - V_228 ;
if ( ! F_85 || ! V_139 -> V_140 || V_139 -> V_229 < V_162 ) {
F_86 ( & V_60 -> V_141 . V_62 , L_72 ,
F_85 , V_139 -> V_140 , V_139 -> V_229 ) ;
return - V_183 ;
}
#if F_87 ( V_230 )
if ( ! V_139 -> V_231 ) {
F_86 ( & V_60 -> V_141 . V_62 , L_73 ) ;
return - V_183 ;
}
#endif
V_60 -> V_139 = V_139 ;
V_60 -> V_141 . V_62 . V_139 = & V_139 -> V_139 ;
V_198 = F_88 ( & V_60 -> V_141 . V_62 ) ;
if ( V_198 ) {
F_86 ( & V_60 -> V_141 . V_62 , L_74 , V_198 ) ;
goto V_232;
}
F_6 ( V_89 , L_75 ,
V_139 -> V_139 . V_179 ) ;
V_198 = F_85 ( & V_60 -> V_141 , V_139 ) ;
if ( V_198 ) {
F_89 ( & V_60 -> V_141 . V_62 ) ;
goto V_232;
}
F_74 ( V_60 ) ;
return 0 ;
V_232:
V_60 -> V_139 = NULL ;
V_60 -> V_141 . V_62 . V_139 = NULL ;
return V_198 ;
}
static int F_90 ( struct V_226 * V_139 )
{
struct V_59 * V_60 = V_199 ;
if ( ! V_60 )
return - V_227 ;
if ( ! V_139 || V_139 != V_60 -> V_139 || ! V_139 -> V_231 )
return - V_183 ;
F_6 ( V_89 , L_76 ,
V_139 -> V_139 . V_179 ) ;
if ( V_139 -> V_209 )
V_139 -> V_209 ( & V_60 -> V_141 ) ;
V_139 -> V_231 ( & V_60 -> V_141 ) ;
F_89 ( & V_60 -> V_141 . V_62 ) ;
V_60 -> V_139 = NULL ;
F_75 ( V_60 ) ;
return 0 ;
...
{
struct V_59 * V_60 = & V_235 ;
struct V_236 * V_62 = & V_234 -> V_62 ;
int V_198 ;
int V_212 ;
F_92 ( V_62 , L_69 , V_75 ) ;
V_237 = F_93 ( NULL , L_77 ) ;
if ( F_94 ( V_237 ) ) {
F_86 ( V_62 , L_78 ) ;
return F_95 ( V_237 ) ;
}
F_96 ( V_237 ) ;
V_238 = F_93 ( NULL , L_79 ) ;
if ( F_94 ( V_238 ) ) {
F_86 ( V_62 , L_80 ) ;
return F_95 ( V_238 ) ;
}
...
F_97 ( 10 ) ;
F_92 ( V_62 , L_81 ) ;
if ( strncmp ( V_234 -> V_179 , L_82 , 7 ) == 0 ) {
F_98 ( V_62 , L_83 ) ;
V_235 . V_51 [ 1 ] . V_239 = V_240 ;
V_235 . V_51 [ 2 ] . V_239 = V_240 ;
V_235 . V_51 [ 3 ] . V_239 = V_240 ;
V_235 . V_51 [ 4 ] . V_239 = V_240 ;
}
F_99 ( & V_60 -> V_158 ) ;
V_206 = V_234 -> V_62 . V_241 ;
V_242 = V_243 ;
V_244 = V_245 ;
if ( ! F_100 ( V_242 , V_244 , V_246 ) )
return - V_228 ;
V_2 = F_101 ( V_242 , V_244 ) ;
if ( ! V_2 ) {
V_198 = - V_247 ;
goto V_248;
}
F_102 ( & V_60 -> V_141 . V_62 ) ;
V_60 -> V_141 . V_62 . V_249 = & V_234 -> V_62 ;
V_60 -> V_141 . V_62 . V_250 = V_234 -> V_62 . V_250 ;
V_199 = V_60 ;
F_103 ( V_234 , V_60 ) ;
F_75 ( V_60 ) ;
F_83 ( V_60 ) ;
V_198 = F_104 ( V_169 , F_46 ,
0 , V_246 , V_60 ) ;
if ( V_198 != 0 ) {
F_86 ( V_62 , L_84 , V_169 , V_198 ) ;
V_198 = - V_228 ;
goto V_251;
}
F_92 ( V_62 , L_85 , V_169 ) ;
if ( V_206 && V_206 -> V_213 > 0 ) {
V_198 = F_105 ( V_206 -> V_213 , L_86 ) ;
if ( V_198 < 0 ) {
F_86 ( V_62 , L_87 ) ;
goto V_252;
}
V_212 = F_106 ( V_206 -> V_213 ) ;
if ( V_212 < 0 ) {
F_86 ( V_62 , L_88 ) ;
goto V_253;
}
V_198 = F_104 ( V_212 , F_78 ,
V_254
| V_255 | V_256 ,
V_246 , V_60 ) ;
if ( V_198 != 0 ) {
...
F_92 ( V_62 , L_85 , V_212 ) ;
} else {
V_60 -> V_211 = 1 ;
}
if ( V_206 && ! V_206 -> V_207 &&
F_73 ( V_206 -> V_208 ) ) {
V_198 = F_107 ( V_206 -> V_208 ,
V_206 -> V_214 ?
V_257 : V_258 ,
L_90 ) ;
if ( V_198 )
...
V_198 = F_108 ( & V_234 -> V_62 , & V_60 -> V_141 ) ;
if ( V_198 )
goto V_260;
if ( V_261 ) {
V_60 -> V_262 = F_109 ( L_91 , V_263 ,
V_261 ,
V_60 , & V_264 ) ;
if ( ! V_60 -> V_262 )
F_110 ( V_62 , L_92 ) ;
...
{
struct V_59 * V_60 = F_116 ( V_234 ) ;
unsigned int V_212 ;
F_92 ( & V_234 -> V_62 , L_69 , V_75 ) ;
F_117 ( & V_60 -> V_141 ) ;
if ( V_60 -> V_139 )
return - V_228 ;
F_118 ( V_60 -> V_262 ) ;
...
F_114 ( V_242 , V_244 ) ;
F_103 ( V_234 , NULL ) ;
if ( ! F_94 ( V_238 ) && V_238 != NULL ) {
F_119 ( V_238 ) ;
F_120 ( V_238 ) ;
V_238 = NULL ;
}
if ( ! F_94 ( V_237 ) && V_237 != NULL ) {
F_119 ( V_237 ) ;
F_120 ( V_237 ) ;
V_237 = NULL ;
}
F_92 ( & V_234 -> V_62 , L_94 , V_75 ) ;
return 0 ;
}
static int
F_121 ( struct V_233 * V_234 , T_8 V_265 )
{
F_81 ( V_221 ) ;
return 0 ;
}
...
{
int V_198 ;
F_6 ( V_89 , L_95 , V_246 , V_266 ) ;
V_261 = F_124 ( V_246 , NULL ) ;
if ( F_94 ( V_261 ) ) {
F_125 ( L_96 ,
V_246 , F_95 ( V_261 ) ) ;
V_261 = NULL ;
