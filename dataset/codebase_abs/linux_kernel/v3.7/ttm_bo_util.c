...
V_103 -> V_104 = V_105 ;
V_103 -> V_36 = ( void * ) ( ( ( V_106 * ) V_2 -> V_3 . V_31 . V_37 ) + V_41 ) ;
} else {
V_103 -> V_104 = V_107 ;
if ( V_3 -> V_15 & V_39 )
V_103 -> V_36 = F_26 ( V_2 -> V_3 . V_31 . V_40 + V_2 -> V_3 . V_31 . V_41 + V_41 ,
V_42 ) ;
else
V_103 -> V_36 = F_27 ( V_2 -> V_3 . V_31 . V_40 + V_2 -> V_3 . V_31 . V_41 + V_41 ,
V_42 ) ;
}
return ( ! V_103 -> V_36 ) ? - V_43 : 0 ;
}
...
V_103 -> V_104 = V_109 ;
V_103 -> V_46 = V_10 -> V_54 [ V_108 ] ;
V_103 -> V_36 = F_38 ( V_103 -> V_46 ) ;
} else {
V_52 = ( V_3 -> V_15 & V_95 ) ?
V_55 :
F_46 ( V_3 -> V_15 , V_55 ) ;
V_103 -> V_104 = V_110 ;
V_103 -> V_36 = F_37 ( V_10 -> V_54 + V_108 , V_69 ,
0 , V_52 ) ;
}
return ( ! V_103 -> V_36 ) ? - V_43 : 0 ;
}
int F_63 ( struct V_1 * V_2 ,
unsigned long V_108 , unsigned long V_69 ,
struct V_102 * V_103 )
{
struct V_19 * V_20 =
...
return F_61 ( V_2 , V_108 , V_69 , V_103 ) ;
} else {
V_41 = V_108 << V_48 ;
V_42 = V_69 << V_48 ;
return F_60 ( V_2 , V_41 , V_42 , V_103 ) ;
}
}
void F_64 ( struct V_102 * V_103 )
{
...
( void ) F_9 ( V_20 , false ) ;
F_21 ( V_103 -> V_2 -> V_28 , & V_103 -> V_2 -> V_3 ) ;
F_13 ( V_20 ) ;
V_103 -> V_36 = NULL ;
V_103 -> V_46 = NULL ;
}
