...
goto V_76;
V_53 = F_58 ( V_7 , V_77 , sizeof( struct V_38 ) ) ;
if ( ! V_53 )
goto V_76;
F_59 ( V_7 , V_66 ) ;
return F_60 ( V_53 ) ;
...
static T_2 F_71 ( void )
{
T_2 V_6 ;
V_6 = F_64 ( sizeof( T_4 ) ) +
F_64 ( sizeof( struct V_38 ) ) + F_64 ( 0 ) ;
#ifdef F_55
V_6 += F_64 ( 0 ) ;
#endif
return V_6 ;
...
static int F_74 ( struct V_4 * V_7 , struct V_1 * V_2 )
{
if ( V_2 -> V_82 [ V_89 ] )
return F_67 ( V_2 ) ;
...
static struct V_38 * F_75 ( struct V_36 * V_37 )
{
struct V_97 * V_98 = V_37 -> signal ;
struct V_38 * V_39 ;
if ( V_98 -> V_39 || F_76 ( V_37 ) )
goto V_53;
V_39 = F_77 ( V_99 , V_9 ) ;
F_78 ( & V_37 -> V_51 -> V_52 ) ;
if ( ! V_98 -> V_39 ) {
...
void F_81 ( struct V_36 * V_37 , int V_100 )
{
int V_17 ;
struct V_18 * V_19 ;
struct V_38 * V_39 ;
...
{
unsigned int V_104 ;
V_99 = F_87 ( V_38 , V_105 ) ;
F_88 (i) {
F_89 ( & ( F_47 ( V_63 , V_104 ) . V_27 ) ) ;
F_90 ( & ( F_47 ( V_63 , V_104 ) . V_26 ) ) ;
}
}
