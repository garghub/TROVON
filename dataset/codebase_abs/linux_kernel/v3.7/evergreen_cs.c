...
V_143 = F_69 ( V_138 ) ;
V_155 = F_74 ( V_53 -> V_166 -> V_167 , V_160 , V_168 ) ;
if ( ! V_155 ) {
F_63 ( L_62 , V_160 ) ;
return - V_68 ;
}
...
V_87 = F_78 ( V_53 , V_133 , V_105 , V_143 ) ;
if ( V_87 ) {
return V_87 ;
}
}
...
static int F_81 ( struct V_52 * V_53 , T_1 V_143 , T_1 V_105 )
{
...
V_89 [ V_105 ] &= ~ F_83 ( 0xf ) ;
V_13 -> V_33 &= ~ F_83 ( 0xf ) ;
V_89 [ V_105 ] |= F_83 ( F_1 ( V_174 -> V_212 . V_1 ) ) ;
V_13 -> V_33 |= F_83 ( F_1 ( V_174 -> V_212 . V_1 ) ) ;
if ( V_174 -> V_212 . V_1 & V_2 ) {
unsigned V_75 , V_78 , V_220 , V_221 ;
F_84 ( V_174 -> V_212 . V_1 ,
& V_75 , & V_78 , & V_220 ,
& V_221 ) ;
V_89 [ V_105 ] |= F_85 ( F_2 ( V_13 -> V_7 ) ) ;
V_89 [ V_105 ] |= F_86 ( V_221 ) |
F_87 ( V_75 ) |
F_88 ( V_78 ) |
F_89 ( V_220 ) ;
}
...
V_89 [ V_105 ] |= F_90 ( F_1 ( V_174 -> V_212 . V_1 ) ) ;
V_13 -> V_21 [ V_91 ] |= F_90 ( F_1 ( V_174 -> V_212 . V_1 ) ) ;
}
V_13 -> V_28 = true ;
break;
case V_268 :
...
& V_75 , & V_78 , & V_220 ,
& V_221 ) ;
V_89 [ V_105 ] |= F_91 ( F_2 ( V_13 -> V_7 ) ) ;
V_89 [ V_105 ] |= F_92 ( V_221 ) |
F_93 ( V_75 ) |
F_94 ( V_78 ) |
F_95 ( V_220 ) ;
}
...
static bool F_97 ( struct V_52 * V_53 , T_1 V_143 , T_1 V_105 )
{
...
( ( T_2 ) ( V_91 & 0xff ) << 32 ) ;
V_89 [ V_105 + 0 ] = V_86 ;
V_89 [ V_105 + 1 ] = ( V_91 & 0xffffff00 ) | ( F_99 ( V_86 ) & 0xff ) ;
}
break;
case V_462 :
if ( V_133 -> V_140 != 1 ) {
...
V_89 [ V_105 + 2 ] = ( V_89 [ V_105 + 2 ] & 0xffffff00 ) | ( F_99 ( V_86 ) & 0xff ) ;
break;
}
case V_480 :
{
...
V_143 = V_457 + ( 4 * V_14 ) ;
V_87 = F_81 ( V_53 , V_143 , V_105 + 1 + V_14 ) ;
if ( V_87 )
return V_87 ;
}
break;
...
T_1 V_106 , V_107 ;
T_1 V_93 , V_86 , V_490 , V_491 ;
switch ( F_100 ( F_42 ( V_53 , V_105 + 1 + ( V_14 * 8 ) + 7 ) ) ) {
case V_492 :
V_87 = F_71 ( V_53 , & V_174 ) ;
if ( V_87 ) {
F_63 ( L_97 ) ;
...
F_101 ( F_1 ( V_174 -> V_212 . V_1 ) ) ;
if ( V_174 -> V_212 . V_1 & V_2 ) {
unsigned V_75 , V_78 , V_220 , V_221 ;
F_84 ( V_174 -> V_212 . V_1 ,
& V_75 , & V_78 , & V_220 ,
& V_221 ) ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 6 ] |= F_102 ( V_221 ) ;
...
V_491 = V_89 [ V_105 + 1 + ( V_14 * 8 ) + 0 ] & 0x7 ;
V_490 = V_89 [ V_105 + 1 + ( V_14 * 8 ) + 3 ] ;
if ( ( V_491 == V_493 || V_491 == V_494 ) &&
! V_490 &&
! F_72 ( V_53 ) ) {
V_107 = 0 ;
V_104 = NULL ;
...
V_496 = V_174 -> V_212 . V_213 + V_86 ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 0 ] = V_496 ;
...
int V_87 ;
if ( V_53 -> V_13 == NULL ) {
V_13 = F_108 ( sizeof( * V_13 ) , V_514 ) ;
if ( V_13 == NULL )
return - V_515 ;
F_3 ( V_13 ) ;
if ( V_53 -> V_166 -> V_114 >= V_177 )
V_91 = V_53 -> V_166 -> V_516 . V_517 . V_518 ;
else
V_91 = V_53 -> V_166 -> V_516 . V_519 . V_518 ;
switch ( V_91 & 0xf ) {
case 0 :
V_13 -> V_76 = 1 ;
break;
...
switch ( V_133 . type ) {
case V_142 :
V_87 = F_80 ( V_53 , & V_133 ) ;
break;
case V_146 :
break;
case V_144 :
V_87 = F_98 ( V_53 , & V_133 ) ;
break;
default:
F_63 ( L_115 , V_133 . type ) ;
F_109 ( V_53 -> V_13 ) ;
V_53 -> V_13 = NULL ;
return - V_68 ;
}
...
static int F_111 ( struct V_594 * V_166 ,
...
int F_112 ( struct V_594 * V_166 , struct V_609 * V_89 )
{
int V_610 = 0 ;
T_1 V_105 = 0 ;
struct V_132 V_133 ;
...
V_610 = F_111 ( V_166 , V_89 -> V_90 , & V_133 ) ;
V_105 += V_133 . V_140 + 2 ;
break;
default:
F_96 ( V_166 -> V_66 , L_115 , V_133 . type ) ;
V_610 = - V_68 ;
break;
}
if ( V_610 )
