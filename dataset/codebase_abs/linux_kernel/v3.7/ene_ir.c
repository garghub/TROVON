...
static void F_58 ( struct V_170 * V_68 , bool V_176 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
if ( V_176 ) {
F_32 ( V_2 ) ;
...
static int F_59 ( struct V_170 * V_68 , unsigned * V_177 , unsigned V_178 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
unsigned long V_110 ;
V_2 -> V_131 = V_177 ;
...
static int F_61 ( struct V_179 * V_179 , const struct V_180 * V_181 )
{
int error = - V_182 ;
struct V_170 * V_68 ;
struct V_1 * V_2 ;
V_2 = F_62 ( sizeof( struct V_1 ) , V_183 ) ;
V_68 = F_63 () ;
if ( ! V_2 || ! V_68 )
goto V_184;
error = - V_31 ;
...
F_73 ( & V_179 -> V_2 , true ) ;
error = - V_204 ;
if ( ! F_74 ( V_2 -> V_4 , V_185 , V_194 ) ) {
V_2 -> V_4 = - 1 ;
V_2 -> V_100 = - 1 ;
goto error;
}
V_2 -> V_100 = F_75 ( V_179 , 0 ) ;
if ( F_76 ( V_2 -> V_100 , F_46 ,
V_205 , V_194 , ( void * ) V_2 ) ) {
V_2 -> V_100 = - 1 ;
goto error;
}
error = F_77 ( V_68 ) ;
...
static void F_82 ( struct V_179 * V_179 )
{
struct V_1 * V_2 = F_83 ( V_179 ) ;
unsigned long V_110 ;
F_34 ( & V_2 -> V_111 , V_110 ) ;
F_31 ( V_2 ) ;
F_15 ( V_2 ) ;
...
{
V_69 = V_69 && F_86 ( & V_2 -> V_179 -> V_2 ) ;
F_18 ( L_75 , V_69 ? L_76 : L_77 ) ;
F_9 ( V_2 , V_35 , V_206 , V_69 ) ;
}
static int F_87 ( struct V_179 * V_179 , T_5 V_207 )
{
struct V_1 * V_2 = F_83 ( V_179 ) ;
F_85 ( V_2 , true ) ;
return 0 ;
}
static int F_88 ( struct V_179 * V_179 )
{
struct V_1 * V_2 = F_83 ( V_179 ) ;
F_50 ( V_2 ) ;
if ( V_2 -> V_108 )
...
static void F_89 ( struct V_179 * V_179 )
{
struct V_1 * V_2 = F_83 ( V_179 ) ;
F_85 ( V_2 , true ) ;
}
