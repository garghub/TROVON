...
static inline void F_13 ( struct V_1 * V_12 , struct V_1 * V_21 ) {}
static inline void F_14 ( struct V_1 * V_6 , struct V_1 * V_7 ) {}
static inline void F_15 ( struct V_1 * V_6 , struct V_1 * V_7 ) {}
void F_16 ( struct V_1 * V_12 , struct V_8 * V_9 )
{
F_7 ( V_12 , V_9 , F_15 ) ;
}
...
struct V_1 * F_20 ( const struct V_8 * V_9 )
{
struct V_1 * V_23 ;
V_23 = V_9 -> V_1 ;
if ( ! V_23 )
...
struct V_1 * F_22 ( const struct V_1 * V_12 )
{
struct V_1 * V_11 ;
if ( F_23 ( V_12 ) )
return NULL ;
...
struct V_1 * F_24 ( const struct V_1 * V_12 )
{
struct V_1 * V_11 ;
if ( F_23 ( V_12 ) )
return NULL ;
...
void F_25 ( struct V_1 * V_24 , struct V_1 * V_7 ,
struct V_8 * V_9 )
{
struct V_1 * V_11 = F_4 ( V_24 ) ;
F_6 ( V_24 , V_7 , V_11 , V_9 ) ;
if ( V_24 -> V_17 )
F_12 ( V_24 -> V_17 , V_7 ) ;
if ( V_24 -> V_15 )
F_12 ( V_24 -> V_15 , V_7 ) ;
