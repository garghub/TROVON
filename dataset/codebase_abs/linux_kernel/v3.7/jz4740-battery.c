...
static int T_2 F_24 ( struct V_55 * V_15 )
{
int V_24 = 0 ;
...
V_1 -> V_64 = F_29 ( V_15 , V_65 , 0 ) ;
if ( ! V_1 -> V_64 ) {
V_24 = - V_66 ;
F_25 ( & V_15 -> V_57 , L_4 ) ;
goto V_63;
}
V_1 -> V_64 = F_30 ( V_1 -> V_64 -> V_67 ,
F_31 ( V_1 -> V_64 ) , V_15 -> V_68 ) ;
if ( ! V_1 -> V_64 ) {
V_24 = - V_69 ;
F_25 ( & V_15 -> V_57 , L_5 ) ;
goto V_63;
}
V_1 -> V_17 = F_32 ( V_1 -> V_64 -> V_67 ,
F_31 ( V_1 -> V_64 ) ) ;
if ( ! V_1 -> V_17 ) {
V_24 = - V_69 ;
F_25 ( & V_15 -> V_57 , L_6 ) ;
...
F_35 ( & V_1 -> V_12 ) ;
F_36 ( & V_1 -> V_45 , F_22 ) ;
V_24 = F_37 ( V_1 -> V_5 , F_3 , 0 , V_15 -> V_68 ,
V_1 ) ;
if ( V_24 ) {
...
F_42 ( V_15 -> V_57 . V_58 , V_84 ,
V_84 ) ;
else
F_42 ( V_15 -> V_57 . V_58 , V_84 , 0 ) ;
...
F_47 ( V_1 -> V_17 ) ;
V_70:
F_48 ( V_1 -> V_64 -> V_67 , F_31 ( V_1 -> V_64 ) ) ;
V_63:
F_49 ( V_1 ) ;
return V_24 ;
}
static int T_3 F_50 ( struct V_55 * V_15 )
{
...
{
struct V_1 * V_1 = F_55 ( V_57 ) ;
F_52 ( & V_1 -> V_45 ) ;
V_1 -> V_32 = V_87 ;
return 0 ;
}
static int F_56 ( struct V_86 * V_57 )
{
struct V_1 * V_1 = F_55 ( V_57 ) ;
F_23 ( & V_1 -> V_45 , 0 ) ;
return 0 ;
