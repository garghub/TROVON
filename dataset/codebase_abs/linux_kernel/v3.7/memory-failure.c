...
static int F_78 ( struct V_100 * V_101 , struct V_1 * V_2 ,
unsigned long V_29 )
{
int V_98 ;
int V_102 ;
...
if ( F_89 ( V_2 ) && F_112 ( V_2 ) && F_105 ( V_96 ) ) {
F_75 ( V_29 , L_28 ,
V_88 ) ;
F_97 ( V_96 ) ;
F_111 ( V_96 ) ;
...
F_98 ( V_96 ) ;
F_113 ( V_2 ) ;
if ( F_79 ( V_2 , V_29 , V_28 , V_30 ) != V_112 ) {
F_14 ( V_34 L_29 , V_29 ) ;
V_95 = - V_104 ;
goto V_122;
}
...
V_126 = & F_115 ( V_125 ) ;
F_116 ( & V_126 -> V_130 , V_127 ) ;
if ( F_117 ( & V_126 -> V_131 , & V_129 ) )
F_118 ( F_119 () , & V_126 -> V_132 ) ;
else
F_120 ( L_31 ,
V_29 ) ;
...
if ( ! F_107 ( F_17 ( V_2 ) ) ) {
if ( F_89 ( V_2 ) ) {
F_30 ( L_36 , V_141 , V_29 ) ;
V_33 = F_74 ( F_17 ( V_2 ) ) ;
} else if ( F_24 ( V_2 ) ) {
F_30 ( L_37 , V_141 , V_29 ) ;
F_99 ( V_2 ) ;
V_33 = 0 ;
} else {
F_30 ( L_38 ,
