...
int V_83 ;
V_81 . V_84 = V_85 ;
V_81 . V_86 = & F_46 ( V_2 ) -> V_87 -> V_86 ;
V_81 . V_88 = NULL ;
V_81 . V_89 = 0 ;
for ( V_82 = F_47 ( V_79 ) , V_83 = F_48 ( V_79 ) ; V_83 > 0 ;
V_82 = F_49 ( V_82 , & V_83 ) ) {
switch ( F_50 ( V_82 ) ) {
case V_90 :
V_81 . V_88 = V_82 ;
...
return F_52 ( V_74 , V_2 , & V_81 ) ;
}
static int F_53 ( struct V_73 * V_74 , struct V_1 * V_2 ,
const struct V_78 * V_79 )
{
const struct V_78 * V_92 = NULL ;
const struct V_78 * V_82 ;
int V_83 ;
for ( V_82 = F_47 ( V_79 ) , V_83 = F_48 ( V_79 ) ; V_83 > 0 ;
V_82 = F_49 ( V_82 , & V_83 ) ) {
...
return F_55 ( V_74 , V_2 , F_47 ( V_92 ) ,
F_48 ( V_92 ) , true ) ;
}
static int F_56 ( struct V_1 * V_2 ,
const struct V_78 * V_95 )
{
int V_8 = 0 ;
switch ( F_50 ( V_95 ) ) {
case V_96 :
...
break;
case V_98 :
V_8 = F_22 ( V_2 , F_47 ( V_95 ) ) ;
break;
case V_99 :
V_8 = F_32 ( V_2 , F_47 ( V_95 ) ) ;
break;
case V_100 :
V_8 = F_40 ( V_2 , F_47 ( V_95 ) ) ;
break;
case V_101 :
V_8 = F_39 ( V_2 , F_47 ( V_95 ) ) ;
break;
}
return V_8 ;
}
static int F_55 ( struct V_73 * V_74 , struct V_1 * V_2 ,
const struct V_78 * V_79 , int V_23 , bool V_102 )
{
int V_103 = - 1 ;
const struct V_78 * V_82 ;
int V_83 ;
for ( V_82 = V_79 , V_83 = V_23 ; V_83 > 0 ;
V_82 = F_49 ( V_82 , & V_83 ) ) {
int V_8 = 0 ;
if ( V_103 != - 1 ) {
F_41 ( V_74 , F_57 ( V_2 , V_4 ) , V_103 ) ;
V_103 = - 1 ;
}
switch ( F_50 ( V_82 ) ) {
case V_104 :
...
break;
case V_108 :
V_8 = F_56 ( V_2 , F_47 ( V_82 ) ) ;
break;
case V_109 :
V_8 = F_53 ( V_74 , V_2 , V_82 ) ;
break;
}
if ( F_6 ( V_8 ) ) {
F_43 ( V_2 ) ;
...
{
struct V_110 * V_111 = F_60 ( F_46 ( V_2 ) -> V_87 -> V_112 ) ;
return F_55 ( V_74 , V_2 , V_111 -> V_113 ,
V_111 -> V_114 , false ) ;
}
