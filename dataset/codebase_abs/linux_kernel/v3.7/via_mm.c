...
goto V_36;
V_39:
if ( F_18 ( & V_7 -> V_40 , V_34 ) == 0 ) {
V_24 = - V_35 ;
goto V_41;
}
V_24 = F_19 ( & V_7 -> V_40 , V_27 , 1 , & V_25 ) ;
if ( V_24 == - V_42 )
goto V_39;
if ( V_24 )
goto V_41;
F_20 ( & V_27 -> V_43 , & V_5 -> V_44 ) ;
F_4 ( & V_2 -> V_9 ) ;
...
struct V_26 * V_47 ;
F_2 ( & V_2 -> V_9 ) ;
V_47 = F_24 ( & V_7 -> V_40 , V_23 -> V_46 ) ;
if ( V_47 == NULL ) {
F_4 ( & V_2 -> V_9 ) ;
return - V_32 ;
}
F_25 ( & V_7 -> V_40 , V_23 -> V_46 ) ;
F_26 ( & V_47 -> V_43 ) ;
F_21 ( & V_47 -> V_38 ) ;
F_22 ( V_47 ) ;
F_4 ( & V_2 -> V_9 ) ;
...
{
struct V_28 * V_5 = V_22 -> V_29 ;
struct V_26 * V_48 , * V_49 ;
if ( ! ( V_22 -> V_50 -> V_51 && V_22 -> V_51 -> V_52 . V_53 ) )
return;
F_28 ( & V_22 -> V_51 -> V_52 ) ;
F_2 ( & V_2 -> V_9 ) ;
if ( F_29 ( & V_5 -> V_44 ) ) {
