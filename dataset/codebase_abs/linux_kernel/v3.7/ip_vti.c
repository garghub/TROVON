...
goto V_128;
V_62 = - V_129 ;
if ( V_114 . V_36 . V_130 != 4 || V_114 . V_36 . V_92 != V_73 ||
V_114 . V_36 . V_131 != 5 )
goto V_128;
...
V_31 -> V_35 . V_133 = V_114 . V_133 ;
V_31 -> V_35 . V_36 . V_92 = V_73 ;
memcpy ( V_3 -> V_134 , & V_114 . V_36 . V_37 , 4 ) ;
memcpy ( V_3 -> V_135 , & V_114 . V_36 . V_38 , 4 ) ;
F_15 ( V_33 , V_31 ) ;
F_61 ( V_3 ) ;
}
}
...
static int F_63 ( struct V_2 * V_3 , int V_138 )
{
if ( V_138 < 68 || V_138 > 0xFFF8 )
return - V_129 ;
V_3 -> V_109 = V_138 ;
return 0 ;
}
...
V_3 -> V_141 = F_64 ;
V_3 -> type = V_142 ;
V_3 -> V_108 = V_143 + sizeof( struct V_59 ) ;
V_3 -> V_109 = V_144 ;
V_3 -> V_39 = V_145 ;
V_3 -> V_110 = 0 ;
V_3 -> V_146 = 4 ;
...
memcpy ( V_3 -> V_134 , & V_79 -> V_35 . V_36 . V_37 , 4 ) ;
memcpy ( V_3 -> V_135 , & V_79 -> V_35 . V_36 . V_38 , 4 ) ;
...
return - V_152 ;
F_23 ( V_3 ) ;
F_14 ( V_33 -> V_153 [ 0 ] , V_79 ) ;
return 0 ;
}
static void F_69 ( struct V_32 * V_33 , struct V_154 * V_155 )
{
int V_43 ;
...
int V_62 ;
struct V_32 * V_33 = F_8 ( V_26 , V_34 ) ;
V_33 -> V_44 [ 0 ] = V_33 -> V_153 ;
V_33 -> V_44 [ 1 ] = V_33 -> V_157 ;
V_33 -> V_44 [ 2 ] = V_33 -> V_158 ;
V_33 -> V_44 [ 3 ] = V_33 -> V_159 ;
...
static int F_78 ( struct V_163 * V_164 [] , struct V_163 * V_60 [] )
{
return 0 ;
}
static void F_79 ( struct V_163 * V_60 [] ,
struct V_41 * V_35 )
{
...
return;
if ( V_60 [ V_165 ] )
V_35 -> V_72 = F_80 ( V_60 [ V_165 ] ) ;
if ( V_60 [ V_166 ] )
V_35 -> V_95 = F_81 ( V_60 [ V_166 ] ) ;
if ( V_60 [ V_167 ] )
V_35 -> V_133 = F_81 ( V_60 [ V_167 ] ) ;
if ( V_60 [ V_168 ] )
V_35 -> V_36 . V_37 = F_81 ( V_60 [ V_168 ] ) ;
if ( V_60 [ V_169 ] )
V_35 -> V_36 . V_38 = F_81 ( V_60 [ V_169 ] ) ;
}
static int F_82 ( struct V_26 * V_170 , struct V_2 * V_3 ,
struct V_163 * V_164 [] , struct V_163 * V_60 [] )
{
struct V_25 * V_49 ;
struct V_26 * V_26 = F_26 ( V_3 ) ;
struct V_32 * V_33 = F_8 ( V_26 , V_34 ) ;
...
static int F_83 ( struct V_2 * V_3 , struct V_163 * V_164 [] ,
struct V_163 * V_60 [] )
{
struct V_25 * V_31 , * V_49 ;
struct V_26 * V_26 = F_26 ( V_3 ) ;
...
F_87 ( V_57 , V_165 , V_114 -> V_72 ) ;
F_88 ( V_57 , V_166 , V_114 -> V_95 ) ;
F_88 ( V_57 , V_167 , V_114 -> V_133 ) ;
F_88 ( V_57 , V_168 , V_114 -> V_36 . V_37 ) ;
F_88 ( V_57 , V_169 , V_114 -> V_36 . V_38 ) ;
return 0 ;
}
