...
sizeof( V_51 -> V_71 ) ) ;
V_51 -> V_62 = 0 ;
memset ( V_51 -> V_63 , 0 , sizeof( V_51 -> V_63 ) ) ;
}
return 0 ;
}
...
static void F_75 ( struct V_1 * V_2 , struct V_141 * V_142 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_50 * V_51 = & V_5 -> V_43 ;
unsigned int V_143 ;
...
for ( V_56 = 0 ; V_56 < V_51 -> V_70 ; V_56 ++ ) {
int V_145 = V_143 ? 0 : V_146 ;
if ( V_144 && ( V_5 -> V_6 == V_147 ) )
V_145 = 0 ;
V_34 = V_51 -> V_71 [ V_56 ] ;
F_77 ( V_2 , V_34 , V_145 ) ;
}
if ( V_5 -> V_148 ) {
unsigned int V_149 = V_143 ?
V_5 -> V_148 : V_5 -> V_150 ;
F_2 ( V_2 , 0x01 , 0 ,
V_151 , V_149 ) ;
}
...
static void F_78 ( struct V_1 * V_2 , struct V_141 * V_142 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_50 * V_51 = & V_5 -> V_43 ;
T_1 V_34 ;
...
for ( V_56 = 0 ; V_56 < V_51 -> V_62 ; V_56 ++ )
F_77 ( V_2 , V_51 -> V_63 [ V_56 ] , V_146 ) ;
for ( V_56 = 0 ; V_56 < V_51 -> V_66 ; V_56 ++ ) {
T_1 V_34 = V_51 -> V_67 [ V_56 ] ;
F_77 ( V_2 , V_34 , V_153 ) ;
if ( ! V_51 -> V_70 )
continue;
if ( F_33 ( V_2 , V_34 ) & V_159 ) {
F_81 ( V_2 , V_34 , V_160 , F_75 ) ;
V_5 -> V_161 = 1 ;
}
}
for ( V_56 = 0 ; V_56 < V_51 -> V_70 ; V_56 ++ )
F_77 ( V_2 , V_51 -> V_71 [ V_56 ] , V_146 ) ;
if ( V_5 -> V_161 || V_5 -> V_162 )
F_75 ( V_2 , NULL ) ;
}
...
const struct V_180 * V_181 , int V_182 )
{
if ( V_182 == V_183 ) {
struct V_4 * V_5 = V_2 -> V_5 ;
V_5 -> V_148 = 2 ;
...
V_113 -> type = V_190 ;
V_113 -> V_115 = 1 ;
V_113 -> V_116 . integer . V_191 = 0 ;
V_113 -> V_116 . integer . V_192 = 3 ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_60 ( V_111 ) ;
unsigned int V_194 = V_121 -> V_116 . integer . V_116 [ 0 ] ;
unsigned int V_9 =
F_1 ( V_2 , V_193 ) ;
unsigned int V_195 = V_9 ;
V_9 &= ~ 0x0003 ;
V_9 |= ( V_194 & 0x0003 ) ;
if ( V_195 == V_9 )
return 0 ;
...
V_9 &= ~ 0x0010 ;
F_4 ( V_2 , V_197 , V_9 ) ;
if ( ( V_5 -> V_174 || V_5 -> V_152 ) &&
F_35 ( V_2 , V_198 ) ) {
V_196 = F_29 ( V_2 , V_198 ) ;
V_196 &= ~ V_199 ;
V_196 |= ( V_60 << V_200 ) ;
F_106 ( V_2 , V_198 , V_196 ) ;
}
}
...
static int F_112 ( struct V_88 * V_111 ,
struct V_120 * V_121 )
{
struct V_1 * V_2 = F_60 ( V_111 ) ;
struct V_4 * V_5 = V_2 -> V_5 ;
return F_113 ( V_2 , & V_5 -> V_204 , V_121 ,
V_5 -> V_22 [ 0 ] , & V_5 -> V_21 ) ;
}
static int F_114 ( struct V_1 * V_2 , int V_119 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_50 * V_51 = & V_5 -> V_43 ;
const struct V_205 * V_206 = & V_5 -> V_204 ;
T_1 V_48 = V_51 -> V_52 [ V_119 ] . V_48 ;
struct V_88 * V_107 ;
T_2 V_99 ;
if ( ! ( F_33 ( V_2 , V_48 ) & V_133 ) )
...
if ( V_99 <= 1 )
return 0 ;
return F_45 ( V_2 , V_206 -> V_118 [ V_119 ] . V_132 , 0 ,
F_54 ( V_48 , 3 , 0 , V_131 ) , 1 , & V_107 ) ;
}
...
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_50 * V_51 = & V_5 -> V_43 ;
struct V_205 * V_206 = & V_5 -> V_204 ;
int V_56 , V_103 , V_207 ;
const char * V_132 ;
if ( ! V_5 -> V_74 )
return 0 ;
V_5 -> V_135 [ 0 ] = F_64 ( V_2 , & V_136 ) ;
...
F_116 ( V_206 , V_132 , V_5 -> V_20 [ V_56 ] , & V_207 ) ;
V_103 = F_114 ( V_2 , V_56 ) ;
if ( V_103 < 0 )
return V_103 ;
}
