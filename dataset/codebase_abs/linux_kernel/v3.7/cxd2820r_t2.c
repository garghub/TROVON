...
V_15 [ 1 ] = ( ( V_13 >> 8 ) & 0xff ) ;
V_15 [ 2 ] = ( ( V_13 >> 0 ) & 0xff ) ;
V_9 = F_6 ( V_4 , 0x020b6 , V_15 , 3 ) ;
if ( V_9 )
goto error;
V_9 = F_6 ( V_4 , 0x0209f , V_17 [ V_11 ] , 5 ) ;
if ( V_9 )
goto error;
...
int F_11 ( struct V_1 * V_2 , T_4 * V_69 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
T_3 V_15 [ 1 ] ;
...
F_2 ( & V_4 -> V_24 -> V_25 , L_4 , V_26 , V_15 [ 0 ] ) ;
return V_9 ;
error:
F_2 ( & V_4 -> V_24 -> V_25 , L_3 , V_26 , V_9 ) ;
return V_9 ;
}
int F_12 ( struct V_1 * V_2 , T_1 * V_75 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
T_3 V_15 [ 4 ] ;
...
goto error;
if ( ( V_15 [ 0 ] >> 4 ) & 0x01 ) {
V_76 = ( V_15 [ 0 ] & 0x0f ) << 24 | V_15 [ 1 ] << 16 |
V_15 [ 2 ] << 8 | V_15 [ 3 ] ;
if ( V_76 )
* V_75 = V_76 * 64 / 16588800 ;
}
return V_9 ;
error:
F_2 ( & V_4 -> V_24 -> V_25 , L_3 , V_26 , V_9 ) ;
...
if ( V_9 )
goto error;
V_78 = ( V_15 [ 0 ] & 0x0f ) << 8 | V_15 [ 1 ] ;
V_78 = ~ V_78 & 0x0fff ;
* V_77 = V_78 * 0xffff / 0x0fff ;
return V_9 ;
error:
F_2 ( & V_4 -> V_24 -> V_25 , L_3 , V_26 , V_9 ) ;
return V_9 ;
}
int F_14 ( struct V_1 * V_2 , T_5 * V_79 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
T_3 V_15 [ 2 ] ;
...
if ( V_78 )
* V_79 = ( F_16 ( V_78 ) - F_15 ) / ( ( 1 << 24 )
/ 100 ) ;
else
* V_79 = 0 ;
F_2 ( & V_4 -> V_24 -> V_25 , L_5 , V_26 , * V_79 ,
V_78 ) ;
return V_9 ;
error:
F_2 ( & V_4 -> V_24 -> V_25 , L_3 , V_26 , V_9 ) ;
...
int F_17 ( struct V_1 * V_2 , T_1 * V_80 )
{
* V_80 = 0 ;
return 0 ;
}
...
{
V_83 -> V_84 = 1500 ;
V_83 -> V_85 = V_2 -> V_30 . V_86 . V_87 * 2 ;
V_83 -> V_88 = ( V_2 -> V_30 . V_86 . V_87 * 2 ) + 1 ;
return 0 ;
}
