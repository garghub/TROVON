...
break;
case V_116 :
V_131 = F_47 ( V_53 + 1 , V_131 , V_24 , va_arg ( args , void * ) ,
V_26 ) ;
while ( isalnum ( * V_53 ) )
V_53 ++ ;
break;
...
int F_61 ( T_7 * V_138 , T_6 V_19 , const char * V_53 , T_5 args )
{
struct V_25 V_26 = { 0 } ;
char * V_131 , * V_24 ;
V_131 = ( char * ) V_138 ;
...
return ( T_7 * ) ( F_63 ( V_131 , sizeof( T_7 ) ) ) - V_138 ;
#undef F_62
}
int F_64 ( char * V_9 , T_6 V_19 , const char * V_53 , const T_7 * V_138 )
{
struct V_25 V_26 = { 0 } ;
char * V_131 , * V_24 ;
...
case V_116 :
V_131 = F_47 ( V_53 + 1 , V_131 , V_24 , F_65 ( void * ) , V_26 ) ;
while ( isalnum ( * V_53 ) )
V_53 ++ ;
break;
case V_118 :
...
int F_66 ( T_7 * V_138 , T_6 V_19 , const char * V_53 , ... )
{
T_5 args ;
int V_142 ;
va_start ( args , V_53 ) ;
V_142 = F_61 ( V_138 , V_19 , V_53 , args ) ;
va_end ( args ) ;
return V_142 ;
}
