...
return F_58 ( V_51 ) ;
F_59 ( V_24 ) ;
F_60 ( V_24 , V_51 -> V_4 -> V_125 ) ;
F_59 ( V_24 ) ;
switch ( V_51 -> V_54 . V_55 ) {
case V_126 :
F_61 ( V_51 -> V_54 . V_35 & V_127 ) ;
...
static void F_64 ( struct V_23 * V_24 , struct V_131 * V_132 )
{
struct V_1 * V_2 = V_24 -> V_5 -> V_111 ;
...
static int T_6 F_65 ( struct V_153 * V_154 )
{
struct V_1 * V_2 ;
...
T_7 V_157 = NULL ;
int V_36 = 0 ;
V_156 = F_66 ( V_154 , V_158 , 0 ) ;
if ( ! V_156 )
return - V_159 ;
if ( ! F_67 ( & V_154 -> V_4 , V_156 -> V_160 , F_68 ( V_156 ) ,
V_161 ) ) {
F_17 ( & V_154 -> V_4 , L_27 ) ;
return - V_162 ;
}
