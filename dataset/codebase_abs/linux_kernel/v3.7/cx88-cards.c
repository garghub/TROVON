...
if ( F_51 ( & V_2 -> V_188 , 13 ) ) {
F_52 ( & V_2 -> V_187 ) ;
F_50 ( V_2 ) ;
return NULL ;
}
if ( F_51 ( & V_2 -> V_189 , 13 ) ) {
F_53 ( & V_2 -> V_188 ) ;
F_52 ( & V_2 -> V_187 ) ;
F_50 ( V_2 ) ;
return NULL ;
...
F_35 ( V_2 -> V_18 , V_69 ) ;
V_2 -> V_190 = F_54 ( F_41 ( V_69 , 0 ) ,
F_42 ( V_69 , 0 ) ) ;
V_2 -> V_191 = ( T_1 V_192 * ) V_2 -> V_190 ;
if ( V_2 -> V_190 == NULL ) {
F_55 ( F_41 ( V_69 , 0 ) ,
F_42 ( V_69 , 0 ) ) ;
F_53 ( & V_2 -> V_188 ) ;
...
V_2 -> V_25 = V_145 ;
if ( V_193 [ V_2 -> V_172 ] < F_8 ( V_72 ) )
V_2 -> V_25 = V_193 [ V_2 -> V_172 ] ;
for ( V_38 = 0 ; V_145 == V_2 -> V_25 && V_38 < F_8 ( V_194 ) ; V_38 ++ )
if ( V_69 -> V_70 == V_194 [ V_38 ] . V_195 &&
V_69 -> V_71 == V_194 [ V_38 ] . V_196 )
V_2 -> V_25 = V_194 [ V_38 ] . V_193 ;
if ( V_145 == V_2 -> V_25 ) {
V_2 -> V_25 = V_197 ;
F_27 ( V_2 , V_69 ) ;
}
memcpy ( & V_2 -> V_4 , & V_72 [ V_2 -> V_25 ] , sizeof( V_2 -> V_4 ) ) ;
if ( ! V_2 -> V_4 . V_198 && ( V_2 -> V_4 . V_199 & V_200 ) )
V_2 -> V_4 . V_198 = 1 ;
F_3 ( V_2 , L_44 ,
V_69 -> V_70 , V_69 -> V_71 , V_2 -> V_4 . V_18 ,
V_2 -> V_25 , V_193 [ V_2 -> V_172 ] == V_2 -> V_25 ?
L_45 : L_46 ,
V_2 -> V_4 . V_198 ) ;
...
static const unsigned short V_201 [] = {
0x42 , 0x43 , 0x4a , 0x4b ,
0x60 , 0x61 , 0x62 , 0x63 , 0x64 , 0x65 , 0x66 , 0x67 ,
0x68 , 0x69 , 0x6a , 0x6c , 0x6d , 0x6e ,
V_202
} ;
int V_203 = ( V_2 -> V_4 . V_151 & V_204 ) ;
F_58 ( & V_2 -> V_187 , & V_2 -> V_43 ,
L_48 , 0 , F_59 ( V_205 ) ) ;
if ( V_203 )
F_58 ( & V_2 -> V_187 ,
& V_2 -> V_43 , L_48 ,
0 , F_59 ( V_206 ) ) ;
if ( V_2 -> V_4 . V_150 == V_207 ) {
F_58 ( & V_2 -> V_187 ,
& V_2 -> V_43 , L_48 ,
0 , V_203 ? V_201 + 4 : V_201 ) ;
} else {
F_58 ( & V_2 -> V_187 , & V_2 -> V_43 ,
