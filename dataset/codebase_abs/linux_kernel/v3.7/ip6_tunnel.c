...
T_3 F_38 ( struct V_59 * V_60 , T_4 * V_61 )
{
...
static void
F_128 ( struct V_43 * V_44 , const struct V_207 * V_187 )
{
V_44 -> V_38 = V_187 -> V_38 ;
V_44 -> V_39 = V_187 -> V_39 ;
V_44 -> V_40 = V_187 -> V_40 ;
V_44 -> V_180 = V_187 -> V_180 ;
V_44 -> V_106 = V_187 -> V_106 ;
V_44 -> V_202 = V_187 -> V_202 ;
V_44 -> V_142 = V_187 -> V_142 ;
V_44 -> V_99 = V_187 -> V_99 ;
memcpy ( V_44 -> V_51 , V_187 -> V_51 , sizeof( V_187 -> V_51 ) ) ;
}
static void
F_129 ( struct V_207 * V_187 , const struct V_43 * V_44 )
{
V_187 -> V_38 = V_44 -> V_38 ;
V_187 -> V_39 = V_44 -> V_39 ;
V_187 -> V_40 = V_44 -> V_40 ;
V_187 -> V_180 = V_44 -> V_180 ;
V_187 -> V_106 = V_44 -> V_106 ;
V_187 -> V_202 = V_44 -> V_202 ;
V_187 -> V_142 = V_44 -> V_142 ;
V_187 -> V_99 = V_44 -> V_99 ;
memcpy ( V_187 -> V_51 , V_44 -> V_51 , sizeof( V_187 -> V_51 ) ) ;
}
static int
F_130 ( struct V_7 * V_8 , struct V_208 * V_209 , int V_210 )
{
int V_53 = 0 ;
struct V_207 V_44 ;
struct V_43 V_211 ;
...
case V_212 :
if ( V_8 == V_35 -> V_58 ) {
if ( F_131 ( & V_44 , V_209 -> V_213 . V_214 , sizeof ( V_44 ) ) ) {
V_53 = - V_215 ;
break;
}
F_128 ( & V_211 , & V_44 ) ;
V_20 = F_33 ( V_31 , & V_211 , 0 ) ;
} else {
memset ( & V_44 , 0 , sizeof( V_44 ) ) ;
}
if ( V_20 == NULL )
V_20 = F_29 ( V_8 ) ;
F_129 ( & V_44 , & V_20 -> V_37 ) ;
if ( F_132 ( V_209 -> V_213 . V_214 , & V_44 , sizeof ( V_44 ) ) ) {
V_53 = - V_215 ;
}
break;
case V_216 :
...
break;
F_128 ( & V_211 , & V_44 ) ;
V_20 = F_33 ( V_31 , & V_211 , V_210 == V_216 ) ;
if ( V_8 != V_35 -> V_58 && V_210 == V_217 ) {
if ( V_20 != NULL ) {
if ( V_20 -> V_8 != V_8 ) {
V_53 = - V_221 ;
break;
...
static int
F_137 ( struct V_7 * V_8 , int V_224 )
{
if ( V_224 < V_108 ) {
return - V_220 ;
}
...
V_8 -> V_227 = F_22 ;
V_8 -> type = V_228 ;
V_8 -> V_206 = V_229 + sizeof ( struct V_62 ) ;
V_8 -> V_101 = V_230 - sizeof ( struct V_62 ) ;
V_20 = F_29 ( V_8 ) ;
if ( ! ( V_20 -> V_37 . V_40 & V_185 ) )
V_8 -> V_101 -= 8 ;
V_8 -> V_40 |= V_231 ;
V_8 -> V_232 = sizeof( struct V_1 ) ;
V_8 -> V_233 |= V_234 ;
V_8 -> V_235 &= ~ V_236 ;
}
static inline int
...
static void T_10 F_141 ( struct V_34 * V_35 )
{
int V_45 ;
struct V_19 * V_20 ;
F_142 ( V_238 ) ;
for ( V_45 = 0 ; V_45 < V_239 ; V_45 ++ ) {
V_20 = F_20 ( V_35 -> V_240 [ V_45 ] ) ;
while ( V_20 != NULL ) {
F_143 ( V_20 -> V_8 , & V_238 ) ;
V_20 = F_20 ( V_20 -> V_49 ) ;
}
}
...
static int T_9 F_145 ( struct V_31 * V_31 )
{
struct V_34 * V_35 = F_12 ( V_31 , V_36 ) ;
struct V_19 * V_20 = NULL ;
int V_53 ;
V_35 -> V_47 [ 0 ] = V_35 -> V_42 ;
V_35 -> V_47 [ 1 ] = V_35 -> V_240 ;
V_53 = - V_237 ;
...
goto V_241;
F_28 ( V_35 -> V_58 , V_31 ) ;
V_53 = F_140 ( V_35 -> V_58 ) ;
if ( V_53 < 0 )
goto V_242;
V_53 = F_146 ( V_35 -> V_58 ) ;
if ( V_53 < 0 )
goto V_242;
V_20 = F_29 ( V_35 -> V_58 ) ;
...
static void T_10 F_147 ( struct V_31 * V_31 )
{
struct V_34 * V_35 = F_12 ( V_31 , V_36 ) ;
F_148 () ;
F_141 ( V_35 ) ;
...
if ( V_53 < 0 )
goto V_244;
V_53 = F_152 ( & V_245 , V_246 ) ;
if ( V_53 < 0 ) {
F_153 ( L_10 , V_247 ) ;
goto V_248;
}
V_53 = F_152 ( & V_249 , V_250 ) ;
if ( V_53 < 0 ) {
F_153 ( L_11 , V_247 ) ;
goto V_251;
}
...
{
if ( F_154 ( & V_245 , V_246 ) )
F_157 ( L_12 , V_247 ) ;
if ( F_154 ( & V_249 , V_250 ) )
F_157 ( L_13 , V_247 ) ;
F_155 ( & V_243 ) ;
}
