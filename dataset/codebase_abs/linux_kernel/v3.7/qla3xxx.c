...
int V_12 ;
int V_259 = 0 ;
if ( V_256 -> V_199 & V_260 ) {
F_122 ( V_2 -> V_17 ,
L_29 ) ;
}
V_258 = & V_2 -> V_261 [ V_256 -> V_262 ] ;
if ( V_256 -> V_199 & V_260 ) {
F_9 ( V_2 -> V_17 ,
L_30 ) ;
V_2 -> V_17 -> V_263 . V_264 ++ ;
V_259 = - V_144 ;
goto V_265;
}
if ( V_258 -> V_266 == 0 ) {
...
V_258 -> V_266 -- ;
if ( V_258 -> V_266 ) {
for ( V_12 = 1 ; V_12 < V_258 -> V_266 ; V_12 ++ ) {
F_126 ( V_2 -> V_38 ,
...
V_2 -> V_17 -> V_263 . V_269 ++ ;
V_2 -> V_17 -> V_263 . V_270 += V_258 -> V_34 -> V_271 ;
V_265:
F_127 ( V_258 -> V_34 ) ;
V_258 -> V_34 = NULL ;
V_267:
...
struct V_282 * V_34 ;
V_65 V_283 = F_132 ( V_279 -> V_283 ) ;
F_129 ( V_2 ) ;
if ( V_2 -> V_210 == V_284 )
V_280 = F_130 ( V_2 ) ;
V_281 = F_130 ( V_2 ) ;
V_34 = V_281 -> V_34 ;
V_2 -> V_17 -> V_263 . V_285 ++ ;
V_2 -> V_17 -> V_263 . V_286 += V_283 ;
F_133 ( V_34 , V_283 ) ;
F_123 ( V_2 -> V_38 ,
F_124 ( V_281 , V_43 ) ,
F_125 ( V_281 , V_44 ) ,
...
F_134 ( V_34 -> V_39 ) ;
F_135 ( V_34 ) ;
V_34 -> V_287 = F_136 ( V_34 , V_2 -> V_17 ) ;
F_137 ( V_34 ) ;
V_281 -> V_34 = NULL ;
if ( V_2 -> V_210 == V_284 )
F_26 ( V_2 , V_280 ) ;
...
struct V_27 * V_280 = NULL ;
struct V_27 * V_281 = NULL ;
struct V_282 * V_290 = NULL , * V_291 ;
struct V_67 * V_17 = V_2 -> V_17 ;
V_65 V_283 = F_132 ( V_289 -> V_283 ) ;
V_65 V_292 = 0 ;
F_129 ( V_2 ) ;
if ( V_2 -> V_210 == V_284 ) {
V_280 = F_130 ( V_2 ) ;
...
if ( V_2 -> V_210 == V_284 ) {
F_139 ( V_290 , V_295 ,
F_140 ( V_291 , V_292 ) , V_292 ) ;
} else {
V_65 V_72 = F_132 ( V_289 -> V_72 ) ;
if ( V_72 &
( V_296 |
V_297 ) ) {
F_9 ( V_17 ,
...
V_291 -> V_287 = F_136 ( V_291 , V_2 -> V_17 ) ;
F_137 ( V_291 ) ;
V_17 -> V_263 . V_285 ++ ;
V_17 -> V_263 . V_286 += V_283 ;
V_281 -> V_34 = NULL ;
if ( V_2 -> V_210 == V_284 )
F_26 ( V_2 , V_280 ) ;
F_26 ( V_2 , V_281 ) ;
...
struct V_67 * V_17 = V_2 -> V_17 ;
int V_308 = 0 ;
while ( ( F_142 ( * ( V_2 -> V_309 ) ) !=
V_2 -> V_310 ) && ( V_308 < V_305 ) ) {
V_307 = V_2 -> V_311 ;
F_143 () ;
if ( V_2 -> V_210 == V_211 )
V_307 -> V_312 &= 0x7f ;
...
case V_315 :
case V_316 :
F_131 ( V_2 , (struct V_278 * )
V_307 ) ;
( * V_304 ) ++ ;
break;
case V_317 :
case V_318 :
F_138 ( V_2 , (struct V_288 * )
V_307 ) ;
( * V_304 ) ++ ;
break;
default: {
...
L_37 ,
V_307 -> V_312 ,
( unsigned long int ) V_319 [ 0 ] ,
( unsigned long int ) V_319 [ 1 ] ,
( unsigned long int ) V_319 [ 2 ] ,
( unsigned long int ) V_319 [ 3 ] ) ;
}
}
V_2 -> V_310 ++ ;
if ( V_2 -> V_310 == V_320 ) {
...
static int F_144 ( struct V_322 * V_323 , int V_324 )
{
struct V_1 * V_2 = F_97 ( V_323 , struct V_1 , V_323 ) ;
int V_304 = 0 , V_303 = 0 ;
unsigned long V_23 ;
struct V_5 T_2 * V_6 =
V_2 -> V_7 ;
F_141 ( V_2 , & V_303 , & V_304 , V_324 ) ;
if ( V_303 + V_304 != V_324 ) {
F_12 ( & V_2 -> V_24 , V_23 ) ;
F_145 ( V_323 ) ;
F_118 ( V_2 ) ;
F_120 ( V_2 ) ;
...
static T_6 F_146 ( int V_326 , void * V_327 )
{
struct V_67 * V_17 = V_327 ;
struct V_1 * V_2 = F_108 ( V_17 ) ;
struct V_5 T_2 * V_6 =
V_2 -> V_7 ;
T_1 V_8 ;
...
F_150 ( V_2 -> V_336 , & V_2 -> V_337 , 0 ) ;
F_151 ( & V_2 -> V_332 ) ;
} else if ( V_8 & V_338 ) {
F_24 ( V_2 ) ;
if ( F_152 ( F_153 ( & V_2 -> V_323 ) ) )
F_154 ( & V_2 -> V_323 ) ;
} else
return V_339 ;
return F_155 ( V_328 ) ;
}
static int F_156 ( struct V_1 * V_2 , unsigned short V_340 )
{
if ( V_2 -> V_210 == V_284 )
return 1 ;
if ( V_340 <= 2 )
...
static void F_157 ( const struct V_282 * V_34 ,
struct V_341 * V_342 )
{
const struct V_343 * V_344 = F_158 ( V_34 ) ;
V_342 -> V_345 = F_159 ( V_34 ) ;
V_342 -> V_346 = V_344 -> V_347 ;
if ( V_344 -> V_287 == V_348 ) {
V_342 -> V_349 |= V_350 |
V_351 ;
} else {
V_342 -> V_349 |= V_352 |
...
struct V_353 * V_353 ;
struct V_354 * V_354 ;
int V_271 = F_161 ( V_34 ) ;
T_3 V_29 ;
int V_30 ;
int V_355 , V_12 ;
int V_356 , V_357 = 0 ;
int V_358 = ( int ) F_162 ( V_34 ) -> V_359 ;
V_356 = V_258 -> V_266 ;
V_29 = F_30 ( V_2 -> V_38 , V_34 -> V_39 , V_271 , V_268 ) ;
V_30 = F_31 ( V_2 -> V_38 , V_29 ) ;
if ( V_30 ) {
F_9 ( V_2 -> V_17 , L_4 ,
V_30 ) ;
...
V_354 = (struct V_354 * ) & V_342 -> V_361 ;
V_354 -> V_362 = F_33 ( F_34 ( V_29 ) ) ;
V_354 -> V_363 = F_33 ( F_35 ( V_29 ) ) ;
V_354 -> V_271 = F_33 ( V_271 ) ;
F_36 ( & V_258 -> V_29 [ V_357 ] , V_43 , V_29 ) ;
F_37 ( & V_258 -> V_29 [ V_357 ] , V_44 , V_271 ) ;
V_357 ++ ;
if ( V_356 == 1 ) {
V_354 -> V_271 |= F_33 ( V_364 ) ;
return V_365 ;
}
V_353 = V_258 -> V_353 ;
for ( V_355 = 0 ;
V_355 < V_358 ;
V_355 ++ , V_357 ++ ) {
T_7 * V_366 = & F_162 ( V_34 ) -> V_340 [ V_355 ] ;
V_354 ++ ;
if ( ( V_357 == 2 && V_356 > 3 ) ||
( V_357 == 7 && V_356 > 8 ) ||
( V_357 == 12 && V_356 > 13 ) ||
( V_357 == 17 && V_356 > 18 ) ) {
V_29 = F_30 ( V_2 -> V_38 , V_353 ,
sizeof( struct V_353 ) ,
V_268 ) ;
V_30 = F_31 ( V_2 -> V_38 , V_29 ) ;
if ( V_30 ) {
...
V_354 -> V_362 = F_33 ( F_34 ( V_29 ) ) ;
V_354 -> V_363 = F_33 ( F_35 ( V_29 ) ) ;
V_354 -> V_271 = F_33 ( sizeof( struct V_353 ) |
V_368 ) ;
F_36 ( & V_258 -> V_29 [ V_357 ] , V_43 , V_29 ) ;
F_37 ( & V_258 -> V_29 [ V_357 ] , V_44 ,
sizeof( struct V_353 ) ) ;
V_354 = (struct V_354 * ) V_353 ;
V_353 ++ ;
V_357 ++ ;
}
V_29 = F_163 ( & V_2 -> V_38 -> V_369 , V_366 , 0 , F_164 ( V_366 ) ,
V_370 ) ;
V_30 = F_165 ( & V_2 -> V_38 -> V_369 , V_29 ) ;
if ( V_30 ) {
F_9 ( V_2 -> V_17 ,
L_41 ,
V_30 ) ;
...
V_354 -> V_362 = F_33 ( F_34 ( V_29 ) ) ;
V_354 -> V_363 = F_33 ( F_35 ( V_29 ) ) ;
V_354 -> V_271 = F_33 ( F_164 ( V_366 ) ) ;
F_36 ( & V_258 -> V_29 [ V_357 ] , V_43 , V_29 ) ;
F_37 ( & V_258 -> V_29 [ V_357 ] , V_44 , F_164 ( V_366 ) ) ;
}
V_354 -> V_271 |= F_33 ( V_364 ) ;
return V_365 ;
V_367:
...
V_354 = (struct V_354 * ) & V_342 -> V_361 ;
V_353 = V_258 -> V_353 ;
for ( V_12 = 0 ; V_12 < V_355 ; V_12 ++ , V_357 ++ ) {
V_354 ++ ;
if ( ( V_357 == 2 && V_356 > 3 ) ||
( V_357 == 7 && V_356 > 8 ) ||
( V_357 == 12 && V_356 > 13 ) ||
( V_357 == 17 && V_356 > 18 ) ) {
F_123 ( V_2 -> V_38 ,
F_124 ( & V_258 -> V_29 [ V_357 ] , V_43 ) ,
F_125 ( & V_258 -> V_29 [ V_357 ] , V_44 ) ,
V_268 ) ;
V_353 ++ ;
V_357 ++ ;
}
...
static T_8 F_166 ( struct V_282 * V_34 ,
struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
struct V_5 T_2 * V_6 =
V_2 -> V_7 ;
struct V_257 * V_258 ;
T_1 V_371 = V_34 -> V_271 ;
struct V_341 * V_342 ;
if ( F_28 ( F_167 ( & V_2 -> V_272 ) < 2 ) )
return V_360 ;
V_258 = & V_2 -> V_261 [ V_2 -> V_372 ] ;
V_258 -> V_266 = F_156 ( V_2 ,
F_162 ( V_34 ) -> V_359 ) ;
if ( V_258 -> V_266 == - 1 ) {
F_9 ( V_17 , L_42 , V_76 ) ;
return V_365 ;
...
V_342 = V_258 -> V_373 ;
memset ( ( void * ) V_342 , 0 , sizeof( struct V_341 ) ) ;
V_342 -> V_312 = V_2 -> V_374 ;
V_342 -> V_199 = V_375 ;
V_342 -> V_199 |= V_2 -> V_376 ;
V_342 -> V_262 = V_2 -> V_372 ;
V_342 -> V_377 = F_45 ( ( V_65 ) V_371 ) ;
V_258 -> V_34 = V_34 ;
if ( V_2 -> V_210 == V_211 &&
V_34 -> V_301 == V_378 )
F_157 ( V_34 , V_342 ) ;
if ( F_160 ( V_2 , V_342 , V_258 , V_34 ) != V_365 ) {
F_9 ( V_17 , L_43 , V_76 ) ;
return V_360 ;
}
F_119 () ;
...
{
V_2 -> V_382 =
( T_1 ) ( V_379 * sizeof( struct V_341 ) ) ;
V_2 -> V_383 = V_320 * sizeof( struct V_306 ) ;
F_119 () ;
V_2 -> V_384 =
F_170 ( V_2 -> V_38 ,
( V_385 ) V_2 -> V_382 ,
...
& V_2 -> V_388 ) ;
if ( ( V_2 -> V_321 == NULL ) ||
F_34 ( V_2 -> V_388 ) & ( V_2 -> V_383 - 1 ) ) {
F_9 ( V_2 -> V_17 , L_46 ) ;
F_171 ( V_2 -> V_38 , ( V_385 ) V_2 -> V_382 ,
V_2 -> V_384 ,
V_2 -> V_386 ) ;
return - V_387 ;
}
...
{
V_2 -> V_390 =
V_2 -> V_252 * sizeof( struct V_391 ) ;
if ( V_2 -> V_390 < V_392 )
V_2 -> V_393 = V_392 ;
else
V_2 -> V_393 = V_2 -> V_390 * 2 ;
V_2 -> V_275 =
F_174 ( V_2 -> V_277 * sizeof( struct V_27 ) ,
V_394 ) ;
if ( V_2 -> V_275 == NULL ) {
F_9 ( V_2 -> V_17 , L_48 ) ;
return - V_387 ;
...
V_405 = V_2 -> V_402 ;
for ( V_12 = 0 ; V_12 < ( V_407 * V_243 ) ; V_12 ++ ) {
V_405 -> V_249 =
F_33 ( V_2 -> V_412 ) ;
V_405 -> V_250 =
F_33 ( V_2 -> V_411 +
...
int V_12 = 0 ;
struct V_27 * V_28 ;
for ( V_12 = 0 ; V_12 < V_2 -> V_277 ; V_12 ++ ) {
V_28 = & V_2 -> V_275 [ V_12 ] ;
if ( V_28 -> V_34 ) {
F_32 ( V_28 -> V_34 ) ;
F_123 ( V_2 -> V_38 ,
...
int V_12 ;
struct V_27 * V_28 ;
struct V_245 * V_414 = V_2 -> V_253 ;
for ( V_12 = 0 ; V_12 < V_2 -> V_277 ; V_12 ++ ) {
V_28 = & V_2 -> V_275 [ V_12 ] ;
V_414 -> V_249 = V_28 -> V_42 ;
V_414 -> V_250 = V_28 -> V_41 ;
V_414 ++ ;
}
V_2 -> V_276 = 0 ;
V_2 -> V_36 = 0 ;
...
struct V_257 * V_258 ;
int V_12 ;
struct V_341 * V_415 = V_2 -> V_384 ;
for ( V_12 = 0 ; V_12 < V_379 ; V_12 ++ ) {
V_258 = & V_2 -> V_261 [ V_12 ] ;
V_258 -> V_34 = NULL ;
V_258 -> V_373 = V_415 ;
V_415 ++ ;
V_258 -> V_353 = F_174 ( 512 , V_394 ) ;
if ( V_258 -> V_353 == NULL )
return - V_387 ;
}
return 0 ;
...
static void F_195 ( struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
...
V_2 -> V_210 == V_211 ? L_65 : L_66 ,
V_2 -> V_541 ) ;
F_64 ( V_17 , L_67 ,
F_93 ( V_209 , & V_2 -> V_199 ) ? L_68 : L_69 ) ;
F_64 ( V_17 , L_70 ,
( ( V_2 -> V_542 == 64 ) ? L_71 : L_72 ) ,
( ( V_2 -> V_543 ) ? L_73 : L_74 ) ) ;
F_64 ( V_17 , L_75 ,
V_2 -> V_7 ) ;
F_64 ( V_17 , L_76 , V_38 -> V_326 ) ;
F_78 ( V_2 , V_544 , V_17 , L_77 , V_17 -> V_70 ) ;
}
static int F_196 ( struct V_1 * V_2 , int V_545 )
{
struct V_67 * V_17 = V_2 -> V_17 ;
int V_259 = 0 ;
F_148 ( V_17 ) ;
...
V_30 = F_203 ( V_2 -> V_38 -> V_326 , F_146 ,
...
static int F_205 ( struct V_1 * V_2 , int V_555 )
{
if ( F_196 ( V_2 , V_555 ) || F_201 ( V_2 ) ) {
F_9 ( V_2 -> V_17 ,
L_89 ) ;
F_206 () ;
F_207 ( V_2 -> V_17 ) ;
...
static int F_209 ( struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
...
static int F_211 ( struct V_67 * V_17 , void * V_69 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
struct V_5 T_2 * V_6 =
V_2 -> V_7 ;
...
static void F_214 ( struct V_67 * V_17 )
{
struct V_1 * V_2 = F_108 ( V_17 ) ;
F_9 ( V_17 , L_90 ) ;
F_148 ( V_17 ) ;
F_150 ( V_2 -> V_336 , & V_2 -> V_562 , 0 ) ;
}
static void F_215 ( struct V_201 * V_202 )
{
struct V_1 * V_2 =
F_97 ( V_202 , struct V_1 , V_337 . V_202 ) ;
struct V_67 * V_17 = V_2 -> V_17 ;
T_1 V_8 ;
struct V_257 * V_258 ;
int V_520 , V_12 ;
...
F_125 ( & V_258 -> V_29 [ 0 ] , V_44 ) ,
V_268 ) ;
for ( V_563 = 1 ; V_563 < V_258 -> V_266 ; V_563 ++ ) {
F_126 ( V_2 -> V_38 ,
...
V_2 -> V_543 = 0 ;
V_2 -> V_541 = ( T_5 ) F_218 ( V_2 -> V_38 -> V_568 ) ;
}
static void F_219 ( unsigned long V_569 )
{
struct V_1 * V_2 = (struct V_1 * ) V_569 ;
F_150 ( V_2 -> V_336 , & V_2 -> V_203 , 0 ) ;
}
static int T_9 F_220 ( struct V_538 * V_38 ,
...
V_30 = F_222 ( V_38 , V_539 ) ;
if ( V_30 ) {
F_47 ( L_98 , F_113 ( V_38 ) ) ;
goto V_576;
}
F_223 ( V_38 ) ;
if ( ! F_224 ( V_38 , F_225 ( 64 ) ) ) {
V_574 = 1 ;
V_30 = F_226 ( V_38 , F_225 ( 64 ) ) ;
} else if ( ! ( V_30 = F_224 ( V_38 , F_225 ( 32 ) ) ) ) {
V_574 = 0 ;
V_30 = F_226 ( V_38 , F_225 ( 32 ) ) ;
}
if ( V_30 ) {
F_47 ( L_99 , F_113 ( V_38 ) ) ;
goto V_577;
}
V_17 = F_227 ( sizeof( struct V_1 ) ) ;
if ( ! V_17 ) {
V_30 = - V_387 ;
goto V_577;
}
F_228 ( V_17 , & V_38 -> V_369 ) ;
F_229 ( V_38 , V_17 ) ;
V_2 = F_108 ( V_17 ) ;
V_2 -> V_73 = V_572 ;
V_2 -> V_17 = V_17 ;
...
if ( V_547 )
V_2 -> V_547 = 1 ;
V_2 -> V_236 = F_230 ( V_579 , V_580 ) ;
if ( V_574 )
V_17 -> V_581 |= V_582 ;
if ( V_2 -> V_210 == V_211 )
V_17 -> V_581 |= V_583 | V_584 ;
V_2 -> V_7 = F_231 ( V_38 , 1 ) ;
if ( ! V_2 -> V_7 ) {
...
F_233 ( V_17 , & V_588 ) ;
V_17 -> V_589 = 5 * V_208 ;
F_234 ( V_17 , & V_2 -> V_323 , F_144 , 64 ) ;
V_17 -> V_326 = V_38 -> V_326 ;
if ( F_46 ( V_2 ) ) {
F_235 ( L_101 ,
V_76 , V_2 -> V_73 ) ;
V_30 = - V_144 ;
...
F_194 ( V_2 ) ;
if ( V_2 -> V_15 ) {
V_17 -> V_416 = V_2 -> V_74 . V_170 . V_591 ;
F_44 ( V_17 , V_2 -> V_74 . V_592 . V_593 ) ;
} else {
V_17 -> V_416 = V_2 -> V_74 . V_169 . V_591 ;
F_44 ( V_17 , V_2 -> V_74 . V_594 . V_593 ) ;
}
memcpy ( V_17 -> V_595 , V_17 -> V_70 , V_17 -> V_561 ) ;
V_17 -> V_596 = V_379 ;
F_217 ( V_2 ) ;
if ( V_2 -> V_543 )
...
V_30 = F_237 ( V_17 ) ;
if ( V_30 ) {
F_47 ( L_102 , F_113 ( V_38 ) ) ;
goto V_590;
}
F_149 ( V_17 ) ;
F_148 ( V_17 ) ;
V_2 -> V_336 = F_238 ( V_17 -> V_125 ) ;
F_239 ( & V_2 -> V_337 , F_215 ) ;
F_239 ( & V_2 -> V_562 , F_216 ) ;
F_239 ( & V_2 -> V_203 , F_96 ) ;
F_240 ( & V_2 -> V_206 ) ;
V_2 -> V_206 . V_597 = F_219 ;
...
static void T_10 F_245 ( struct V_538 * V_38 )
{
