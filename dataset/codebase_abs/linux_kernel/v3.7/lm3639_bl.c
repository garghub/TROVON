...
goto V_10;
if ( ! V_6 -> V_15 )
V_4 = V_6 -> V_17 | V_6 -> V_18 ;
else
V_4 = V_6 -> V_17 | V_6 -> V_18 | 0x01 ;
...
static T_2 F_10 ( struct V_29 * V_20 ,
struct V_30 * V_31 ,
...
static int T_1 F_16 ( struct V_43 * V_44 ,
const struct V_45 * V_46 )
{
int V_3 ;
struct V_1 * V_2 ;
struct V_5 * V_6 = V_44 -> V_20 . V_47 ;
struct V_48 V_25 ;
if ( ! F_17 ( V_44 -> V_49 , V_50 ) ) {
F_4 ( & V_44 -> V_20 , L_7 ) ;
return - V_51 ;
}
if ( V_6 == NULL ) {
...
V_2 = F_18 ( & V_44 -> V_20 ,
sizeof( struct V_1 ) , V_53 ) ;
if ( ! V_2 )
return - V_54 ;
V_2 -> V_6 = V_6 ;
V_2 -> V_20 = & V_44 -> V_20 ;
V_2 -> V_7 = F_19 ( V_44 , & V_55 ) ;
if ( F_20 ( V_2 -> V_7 ) ) {
V_3 = F_21 ( V_2 -> V_7 ) ;
F_4 ( & V_44 -> V_20 , L_9 ,
V_3 ) ;
...
F_26 ( & V_2 -> V_42 ) ;
V_66:
F_27 ( & ( V_2 -> V_59 -> V_20 ) , & V_62 ) ;
V_63:
F_28 ( V_2 -> V_59 ) ;
V_56:
return V_3 ;
}
static int T_4 F_29 ( struct V_43 * V_44 )
{
