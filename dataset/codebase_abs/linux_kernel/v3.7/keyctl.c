...
long F_81 ( T_2 V_6 , unsigned V_114 , T_2 V_26 )
{
return F_82 ( V_6 , V_114 , V_56 , V_26 ) ;
}
long F_82 ( T_2 V_6 , unsigned V_114 , unsigned error ,
T_2 V_26 )
{
const struct V_97 * V_97 = F_73 () ;
struct V_90 * V_91 ;
...
if ( V_3 < 0 )
goto error;
V_3 = F_83 ( V_91 -> V_107 , V_114 , error ,
V_96 , V_39 ) ;
F_33 ( V_96 ) ;
if ( V_3 == 0 )
F_68 ( NULL ) ;
...
long F_89 ( T_2 V_6 , unsigned V_114 )
{
struct V_38 * V_38 , * V_39 ;
T_3 V_8 ;
long V_3 ;
...
const struct V_97 * V_139 , * V_140 ;
struct V_141 * V_142 , * V_143 ;
T_3 V_144 ;
struct V_97 * V_97 ;
int V_3 ;
V_144 = F_4 ( V_145 , 0 , V_33 ) ;
if ( F_5 ( V_144 ) )
return F_6 ( V_144 ) ;
V_3 = - V_19 ;
V_97 = F_95 () ;
...
V_140 = F_100 ( V_138 ) ;
if ( V_139 == V_140 ||
V_139 -> V_148 -> V_149 == V_140 -> V_148 -> V_149 ) {
V_3 = 0 ;
goto V_156;
}
if ( ! F_54 ( V_140 -> V_44 , V_139 -> V_157 ) ||
! F_54 ( V_140 -> V_157 , V_139 -> V_157 ) ||
! F_54 ( V_140 -> V_158 , V_139 -> V_157 ) ||
! F_55 ( V_140 -> V_45 , V_139 -> V_159 ) ||
! F_55 ( V_140 -> V_159 , V_139 -> V_159 ) ||
! F_55 ( V_140 -> V_160 , V_139 -> V_159 ) )
goto V_156;
if ( ( V_140 -> V_148 -> V_149 &&
! F_54 ( V_140 -> V_148 -> V_149 -> V_44 , V_139 -> V_157 ) ) ||
! F_54 ( V_139 -> V_148 -> V_149 -> V_44 , V_139 -> V_157 ) )
goto V_156;
V_143 = F_101 ( V_138 , V_150 ) ;
V_3 = F_102 ( V_138 , V_142 , true ) ;
if ( ! V_3 )
V_142 = NULL ;
V_156:
F_103 ( & V_152 ) ;
F_104 () ;
if ( V_143 )
F_105 ( F_106 ( V_143 , struct V_97 , V_147 ) ) ;
if ( V_142 )
F_105 ( V_97 ) ;
return V_3 ;
V_146:
