...
static struct V_170 * F_65 ( struct V_1 * V_6 ,
struct V_145 * V_103 ,
struct V_170 * V_171 )
{
unsigned long V_177 ;
F_66 ( & V_6 -> V_141 , V_177 ) ;
if ( ! V_171 ) {
V_171 = V_103 -> V_171 ;
V_103 -> V_171 = NULL ;
} else if ( V_103 -> V_171 == V_171 ) {
V_103 -> V_171 = NULL ;
} else {
V_171 = NULL ;
}
F_67 ( & V_6 -> V_141 , V_177 ) ;
return V_171 ;
}
static void F_68 ( struct V_1 * V_6 ,
struct V_145 * V_103 , struct V_170 * V_171 ,
T_4 V_178 )
{
unsigned long V_177 ;
...
F_66 ( & V_6 -> V_141 , V_177 ) ;
V_6 -> V_179 += V_178 ;
F_69 ( & V_103 -> V_164 , & V_6 -> V_180 ) ;
F_67 ( & V_6 -> V_141 , V_177 ) ;
}
static void F_70 ( struct V_1 * V_6 , struct V_145 * V_103 )
{
struct V_170 * V_171 = F_65 ( V_6 , V_103 , NULL ) ;
if ( V_171 ) {
F_68 ( V_6 , V_103 , V_171 , 0 ) ;
V_171 -> V_181 = V_182 << 16 ;
V_171 -> V_183 ( V_171 ) ;
}
}
...
if ( V_32 )
goto V_58;
while ( F_72 ( V_6 -> V_55 , 1 , & V_186 ) > 0 )
;
while ( F_72 ( V_6 -> V_59 , 1 , & V_186 ) > 0 )
;
...
F_73 ( & V_6 -> V_191 ) ;
for ( V_77 = 0 ; V_77 < V_61 ; ++ V_77 )
F_74 ( & V_6 -> V_79 [ V_77 ] -> V_164 , & V_6 -> V_191 ) ;
V_6 -> V_192 = 0 ;
V_32 = F_59 ( V_6 ) ;
if ( V_32 )
goto V_58;
...
V_6 -> V_142 = V_161 ;
F_75 ( & V_6 -> V_160 , F_51 ) ;
F_76 ( V_193 , & V_6 -> V_160 ) ;
}
F_47 ( & V_6 -> V_141 ) ;
return V_32 ;
}
static void F_77 ( struct V_194 * V_142 , T_5 V_195 ,
unsigned int V_196 , T_6 V_197 )
{
struct V_198 * V_199 = V_142 -> V_199 ;
V_199 -> V_200 = F_78 ( V_195 ) ;
...
static int F_79 ( struct V_194 * V_142 ,
struct V_1 * V_6 )
{
...
return 0 ;
if ( V_142 -> V_208 == 1 ) {
F_77 ( V_142 , V_142 -> V_209 , V_142 -> V_210 ,
V_6 -> V_197 ) ;
V_142 -> V_208 = V_142 -> V_210 = 0 ;
return 0 ;
}
V_206 = F_80 ( V_23 -> V_211 , V_142 -> V_212 ,
V_142 -> V_208 , V_207 ) ;
if ( F_20 ( V_206 ) )
return F_21 ( V_206 ) ;
* V_142 -> V_213 ++ = V_206 ;
V_142 -> V_176 ++ ;
F_77 ( V_142 , 0 , V_142 -> V_210 , V_206 -> V_206 -> V_197 ) ;
V_142 -> V_208 = V_142 -> V_210 = 0 ;
return 0 ;
}
static void F_81 ( struct V_194 * V_142 ,
...
static int F_82 ( struct V_194 * V_142 ,
struct V_1 * V_6 ,
struct V_214 * V_215 , int V_216 ,
int V_220 )
{
...
T_5 V_195 = F_83 ( V_144 , V_215 ) ;
unsigned int V_196 = F_84 ( V_144 , V_215 ) ;
unsigned int V_202 ;
int V_32 ;
if ( ! V_196 )
return 0 ;
if ( V_220 == V_221 ) {
F_77 ( V_142 , V_195 , V_196 , V_6 -> V_197 ) ;
return 0 ;
}
...
V_202 = F_85 (unsigned int, dma_len, dev->fmr_page_size) ;
if ( ! V_142 -> V_208 )
V_142 -> V_209 = V_195 ;
...
static int F_86 ( struct V_170 * V_171 , struct V_1 * V_6 ,
struct V_145 * V_103 )
{
...
V_23 = V_6 -> V_12 -> V_22 ;
V_144 = V_23 -> V_23 ;
V_230 = F_87 ( V_144 , V_226 , V_229 , V_171 -> V_174 ) ;
if ( F_88 ( V_230 == 0 ) )
return - V_237 ;
V_234 = V_238 ;
...
V_19 -> V_200 = F_78 ( F_83 ( V_144 , V_226 ) ) ;
V_19 -> V_201 = F_39 ( V_6 -> V_197 ) ;
V_19 -> V_202 = F_39 ( F_84 ( V_144 , V_226 ) ) ;
V_103 -> V_176 = 0 ;
goto V_240;
}
V_232 = ( void * ) V_228 -> V_239 ;
F_89 ( V_144 , V_103 -> V_150 ,
V_6 -> V_151 , V_152 ) ;
...
F_90 (scat, sg, count, i) {
if ( F_82 ( & V_142 , V_6 , V_215 , V_77 , V_220 ) ) {
T_5 V_195 ;
unsigned int V_196 ;
V_242:
V_215 = V_142 . V_217 ;
V_77 = V_142 . V_218 ;
V_195 = F_83 ( V_144 , V_215 ) ;
V_196 = F_84 ( V_144 , V_215 ) ;
...
if ( F_88 ( V_6 -> V_243 < V_142 . V_204 &&
! V_6 -> V_244 ) ) {
F_31 ( V_84 , V_6 -> V_85 ,
L_11 ) ;
return - V_237 ;
}
V_230 = F_91 ( V_142 . V_204 , V_6 -> V_243 ) ;
...
V_232 -> V_247 . V_200 = F_78 ( V_103 -> V_150 ) ;
...
static void F_93 ( struct V_1 * V_6 , struct V_11 * V_17 ,
enum V_251 V_252 )
{
unsigned long V_177 ;
F_66 ( & V_6 -> V_141 , V_177 ) ;
F_74 ( & V_17 -> V_164 , & V_6 -> V_191 ) ;
if ( V_252 != V_253 )
++ V_6 -> V_179 ;
F_67 ( & V_6 -> V_141 , V_177 ) ;
}
static struct V_11 * F_94 ( struct V_1 * V_6 ,
enum V_251 V_252 )
{
...
V_17 = F_96 ( & V_6 -> V_191 , struct V_11 , V_164 ) ;
F_54 ( & V_17 -> V_164 ) ;
return V_17 ;
}
static int F_97 ( struct V_1 * V_6 ,
...
V_260 . V_118 = V_270 ;
V_260 . V_271 = V_272 ;
return F_98 ( V_6 -> V_29 , & V_260 , & V_261 ) ;
}
static int F_99 ( struct V_1 * V_6 , struct V_11 * V_17 )
{
...
V_260 . V_268 = & V_164 ;
V_260 . V_269 = 1 ;
return F_100 ( V_6 -> V_29 , & V_260 , & V_261 ) ;
}
static void F_101 ( struct V_1 * V_6 , struct V_274 * V_275 )
{
struct V_145 * V_103 ;
struct V_170 * V_171 ;
unsigned long V_177 ;
if ( F_88 ( V_275 -> V_120 & V_276 ) ) {
F_66 ( & V_6 -> V_141 , V_177 ) ;
V_6 -> V_179 += F_102 ( V_275 -> V_178 ) ;
F_67 ( & V_6 -> V_141 , V_177 ) ;
V_6 -> V_277 = - 1 ;
if ( F_102 ( V_275 -> V_278 ) >= 4 )
V_6 -> V_277 = V_275 -> V_279 [ 3 ] ;
F_32 ( & V_6 -> V_280 ) ;
} else {
V_103 = & V_6 -> V_146 [ V_275 -> V_120 ] ;
V_171 = F_65 ( V_6 , V_103 , NULL ) ;
if ( ! V_171 ) {
F_31 ( V_84 , V_6 -> V_85 ,
L_12 ,
...
if ( V_275 -> V_177 & V_281 ) {
memcpy ( V_171 -> V_282 , V_275 -> V_279 +
F_102 ( V_275 -> V_278 ) ,
F_85 ( int , F_102 ( V_275 -> V_283 ) ,
V_284 ) ) ;
}
if ( V_275 -> V_177 & ( V_285 | V_286 ) )
F_103 ( V_171 , F_102 ( V_275 -> V_287 ) ) ;
else if ( V_275 -> V_177 & ( V_288 | V_289 ) )
F_103 ( V_171 , F_102 ( V_275 -> V_290 ) ) ;
F_68 ( V_6 , V_103 , V_171 ,
F_102 ( V_275 -> V_178 ) ) ;
V_171 -> V_291 = NULL ;
V_171 -> V_183 ( V_171 ) ;
}
}
static int F_104 ( struct V_1 * V_6 , T_4 V_292 ,
...
F_89 ( V_23 , V_17 -> V_21 , V_202 , V_152 ) ;
memcpy ( V_17 -> V_19 , V_275 , V_202 ) ;
F_92 ( V_23 , V_17 -> V_21 , V_202 , V_152 ) ;
V_58 = F_97 ( V_6 , V_17 , V_202 ) ;
if ( V_58 ) {
F_31 ( V_84 , V_6 -> V_85 , V_86
L_14 , V_58 ) ;
F_93 ( V_6 , V_17 , V_253 ) ;
...
T_4 V_296 = F_102 ( V_103 -> V_178 ) ;
if ( F_104 ( V_6 , V_296 , & V_275 , sizeof V_275 ) )
F_31 ( V_84 , V_6 -> V_85 , V_86
L_15 ) ;
}
...
static void F_107 ( struct V_1 * V_6 , struct V_185 * V_186 )
{
struct V_143 * V_23 = V_6 -> V_12 -> V_22 -> V_23 ;
struct V_11 * V_17 = (struct V_11 * ) ( V_267 ) V_186 -> V_266 ;
int V_301 ;
T_1 V_118 ;
F_89 ( V_23 , V_17 -> V_21 , V_6 -> V_302 ,
V_175 ) ;
V_118 = * ( T_1 * ) V_17 -> V_19 ;
if ( 0 ) {
F_31 ( V_84 , V_6 -> V_85 ,
V_86 L_18 , V_118 ) ;
F_108 ( V_84 , L_19 , V_303 , 8 , 1 ,
...
static int F_109 ( struct V_2 * V_154 , struct V_170 * V_171 )
{
...
if ( ! V_17 )
goto V_313;
V_103 = F_96 ( & V_6 -> V_180 , struct V_145 , V_164 ) ;
F_54 ( & V_103 -> V_164 ) ;
F_67 ( & V_6 -> V_141 , V_177 ) ;
...
V_228 -> V_118 = V_314 ;
V_228 -> V_300 = F_78 ( ( T_7 ) V_171 -> V_315 -> V_300 << 48 ) ;
V_228 -> V_120 = V_103 -> V_316 ;
memcpy ( V_228 -> V_317 , V_171 -> V_318 , V_171 -> V_319 ) ;
V_103 -> V_171 = V_171 ;
V_103 -> V_228 = V_17 ;
V_202 = F_86 ( V_171 , V_6 , V_103 ) ;
if ( V_202 < 0 ) {
F_31 ( V_84 , V_6 -> V_85 ,
V_86 L_25 ) ;
goto V_320;
}
F_92 ( V_23 , V_17 -> V_21 , V_6 -> V_122 ,
V_152 ) ;
if ( F_97 ( V_6 , V_17 , V_202 ) ) {
...
F_93 ( V_6 , V_17 , V_312 ) ;
F_66 ( & V_6 -> V_141 , V_177 ) ;
F_74 ( & V_103 -> V_164 , & V_6 -> V_180 ) ;
V_313:
F_67 ( & V_6 -> V_141 , V_177 ) ;
V_58:
return V_322 ;
}
static int F_110 ( struct V_1 * V_6 )
{
int V_77 ;
for ( V_77 = 0 ; V_77 < V_57 ; ++ V_77 ) {
...
V_6 -> V_302 = F_102 ( V_324 -> V_302 ) ;
V_6 -> V_179 = F_102 ( V_324 -> V_178 ) ;
V_6 -> V_85 -> V_327
= F_91 ( V_6 -> V_179 - V_256 ,
V_6 -> V_85 -> V_327 ) ;
} else {
F_31 ( V_98 , V_6 -> V_85 ,
...
if ( V_32 )
goto V_329;
V_32 = F_113 ( V_52 , NULL , 0 ) ;
V_329:
F_9 ( V_184 ) ;
error:
V_6 -> V_80 = V_32 ;
}
static void F_114 ( struct V_49 * V_52 ,
struct V_331 * V_26 ,
struct V_1 * V_6 )
{
...
V_52 -> V_341 = F_102 ( V_333 -> V_342 ) & 0x00ffffff ;
...
static int F_116 ( struct V_1 * V_6 ,
...
if ( ! V_17 )
return - 1 ;
F_89 ( V_23 , V_17 -> V_21 , sizeof *V_367 ,
V_152 ) ;
V_367 = V_17 -> V_19 ;
memset ( V_367 , 0 , sizeof *V_367 ) ;
V_367 -> V_118 = V_368 ;
V_367 -> V_300 = F_78 ( ( T_7 ) V_300 << 48 ) ;
V_367 -> V_120 = V_364 | V_276 ;
V_367 -> V_369 = V_365 ;
V_367 -> V_370 = V_364 ;
F_92 ( V_23 , V_17 -> V_21 , sizeof *V_367 ,
V_152 ) ;
if ( F_97 ( V_6 , V_17 , sizeof *V_367 ) ) {
F_93 ( V_6 , V_17 , V_255 ) ;
return - 1 ;
}
if ( ! F_117 ( & V_6 -> V_280 ,
...
if ( ! V_103 || V_6 -> V_192 || ! F_65 ( V_6 , V_103 , V_171 ) )
return V_372 ;
F_116 ( V_6 , V_103 -> V_316 , V_171 -> V_315 -> V_300 ,
V_373 ) ;
F_68 ( V_6 , V_103 , V_171 , 0 ) ;
V_171 -> V_181 = V_374 << 16 ;
V_171 -> V_183 ( V_171 ) ;
return V_375 ;
}
...
if ( V_6 -> V_192 )
return V_372 ;
if ( F_116 ( V_6 , V_376 , V_171 -> V_315 -> V_300 ,
V_377 ) )
return V_372 ;
if ( V_6 -> V_277 )
return V_372 ;
...
static int F_121 ( struct V_170 * V_171 )
{
struct V_1 * V_6 = F_1 ( V_171 -> V_315 -> V_3 ) ;
int V_32 = V_372 ;
...
static T_8 F_122 ( struct V_315 * V_23 , struct V_155 * V_31 ,
char * V_19 )
{
struct V_1 * V_6 = F_1 ( F_123 ( V_23 ) ) ;
return sprintf ( V_19 , L_46 ,
( unsigned long long ) F_41 ( V_6 -> V_134 ) ) ;
}
static T_8 F_124 ( struct V_315 * V_23 , struct V_155 * V_31 ,
char * V_19 )
{
struct V_1 * V_6 = F_1 ( F_123 ( V_23 ) ) ;
return sprintf ( V_19 , L_46 ,
...
static T_8 F_125 ( struct V_315 * V_23 ,
...
static T_8 F_127 ( struct V_315 * V_23 , struct V_155 * V_31 ,
char * V_19 )
{
struct V_1 * V_6 = F_1 ( F_123 ( V_23 ) ) ;
...
static T_8 F_134 ( struct V_315 * V_23 ,
struct V_155 * V_31 , char * V_19 )
{
struct V_1 * V_6 = F_1 ( F_123 ( V_23 ) ) ;
return sprintf ( V_19 , L_50 , V_6 -> V_244 ? L_52 : L_53 ) ;
}
static int F_135 ( struct V_12 * V_3 , struct V_1 * V_6 )
{
struct V_380 V_381 ;
struct V_382 * V_383 ;
sprintf ( V_6 -> V_5 , L_54 ,
( unsigned long long ) F_41 ( V_6 -> V_134 ) ) ;
if ( F_136 ( V_6 -> V_85 , V_3 -> V_22 -> V_23 -> V_384 ) )
return - V_385 ;
memcpy ( V_381 . V_386 , & V_6 -> V_134 , 8 ) ;
memcpy ( V_381 . V_386 + 8 , & V_6 -> V_10 , 8 ) ;
V_381 . V_387 = V_388 ;
V_383 = F_137 ( V_6 -> V_85 , & V_381 ) ;
if ( F_20 ( V_383 ) ) {
F_57 ( V_6 -> V_85 ) ;
return F_21 ( V_383 ) ;
}
F_53 ( & V_3 -> V_163 ) ;
F_69 ( & V_6 -> V_164 , & V_3 -> V_389 ) ;
F_55 ( & V_3 -> V_163 ) ;
V_6 -> V_142 = V_187 ;
F_138 ( & V_6 -> V_85 -> V_390 ,
0 , V_6 -> V_391 , V_392 , 0 ) ;
return 0 ;
}
static void F_139 ( struct V_315 * V_23 )
{
struct V_12 * V_3 =
F_52 ( V_23 , struct V_12 , V_23 ) ;
F_32 ( & V_3 -> V_393 ) ;
}
static int F_140 ( const char * V_19 , struct V_1 * V_6 )
{
char * V_394 , * V_395 ;
char * V_396 ;
char V_343 [ 3 ] ;
...
int V_32 = - V_236 ;
int V_77 ;
V_394 = F_141 ( V_19 , V_33 ) ;
if ( ! V_394 )
return - V_34 ;
V_395 = V_394 ;
while ( ( V_396 = F_142 ( & V_395 , L_55 ) ) != NULL ) {
if ( ! * V_396 )
continue;
V_399 = F_143 ( V_396 , V_400 , args ) ;
V_398 |= V_399 ;
switch ( V_399 ) {
case V_401 :
V_396 = F_144 ( args ) ;
...
V_6 -> V_134 = F_78 ( F_145 ( V_396 , NULL , 16 ) ) ;
F_9 ( V_396 ) ;
break;
case V_402 :
V_396 = F_144 ( args ) ;
...
V_6 -> V_10 = F_78 ( F_145 ( V_396 , NULL , 16 ) ) ;
F_9 ( V_396 ) ;
break;
case V_403 :
V_396 = F_144 ( args ) ;
...
F_147 ( V_343 , V_396 + V_77 * 2 , 3 ) ;
V_6 -> V_36 . V_343 . V_344 [ V_77 ] = F_148 ( V_343 , NULL , 16 ) ;
}
F_9 ( V_396 ) ;
...
V_6 -> V_106 = F_78 ( F_145 ( V_396 , NULL , 16 ) ) ;
...
V_6 -> V_85 -> V_409 = F_91 ( V_399 , V_147 ) ;
break;
case V_410 :
if ( F_149 ( args , & V_399 ) ) {
F_146 ( L_60 , V_396 ) ;
...
V_6 -> V_132 = F_78 ( F_145 ( V_396 , NULL , 16 ) ) ;
F_9 ( V_396 ) ;
break;
case V_413 :
if ( F_150 ( args , & V_399 ) || V_399 < 1 || V_399 > 255 ) {
F_146 ( L_62 ,
V_396 ) ;
goto V_18;
}
...
for ( V_77 = 0 ; V_77 < F_151 ( V_400 ) ; ++ V_77 )
...
static T_8 F_152 ( struct V_315 * V_23 ,
struct V_155 * V_31 ,
...
F_155 ( V_144 , V_3 -> V_35 , 0 , & V_6 -> V_36 . V_129 ) ;
...
static T_8 F_157 ( struct V_315 * V_23 , struct V_155 * V_31 ,
char * V_19 )
{
struct V_12 * V_3 = F_52 ( V_23 , struct V_12 , V_23 ) ;
return sprintf ( V_19 , L_49 , V_3 -> V_35 ) ;
}
static struct V_12 * F_158 ( struct V_205 * V_315 , T_1 V_35 )
{
struct V_12 * V_3 ;
...
F_159 ( & V_3 -> V_23 , L_71 , V_315 -> V_23 -> V_379 , V_35 ) ;
if ( F_160 ( & V_3 -> V_23 ) )
goto V_439;
if ( F_161 ( & V_3 -> V_23 , & V_440 ) )
goto V_441;
if ( F_161 ( & V_3 -> V_23 , & V_442 ) )
goto V_441;
if ( F_161 ( & V_3 -> V_23 , & V_443 ) )
goto V_441;
return V_3 ;
V_441:
F_162 ( & V_3 -> V_23 ) ;
...
static void F_163 ( struct V_143 * V_315 )
{
struct V_205 * V_22 ;
struct V_444 * V_445 ;
struct V_446 V_447 ;
...
if ( ! V_445 )
return;
if ( F_164 ( V_315 , V_445 ) ) {
F_146 ( L_72 , V_315 -> V_379 ) ;
goto V_452;
}
V_22 = F_5 ( sizeof *V_22 , V_33 ) ;
if ( ! V_22 )
goto V_452;
V_449 = F_165 ( 12 , F_166 ( V_445 -> V_453 ) - 1 ) ;
V_22 -> V_225 = 1 << V_449 ;
V_22 -> V_222 = ~ ( ( T_7 ) V_22 -> V_225 - 1 ) ;
V_22 -> V_223 = V_22 -> V_225 * V_224 ;
F_73 ( & V_22 -> V_454 ) ;
V_22 -> V_23 = V_315 ;
V_22 -> V_74 = F_167 ( V_315 ) ;
if ( F_20 ( V_22 -> V_74 ) )
goto V_455;
V_22 -> V_429 = F_168 ( V_22 -> V_74 ,
V_456 |
V_42 |
V_43 ) ;
if ( F_20 ( V_22 -> V_429 ) )
...
V_43 |
V_42 ) ;
V_22 -> V_211 = F_169 ( V_22 -> V_74 , & V_447 ) ;
if ( ! F_20 ( V_22 -> V_211 ) )
break;
}
if ( F_20 ( V_22 -> V_211 ) )
...
V_3 = F_158 ( V_22 , V_396 ) ;
if ( V_3 )
F_69 ( & V_3 -> V_164 , & V_22 -> V_454 ) ;
}
F_170 ( V_315 , & V_469 , V_22 ) ;
goto V_452;
V_457:
F_171 ( V_22 -> V_74 ) ;
V_455:
...
static void F_172 ( struct V_143 * V_315 )
{
struct V_205 * V_22 ;
struct V_12 * V_3 , * V_470 ;
F_173 ( V_389 ) ;
struct V_1 * V_6 , * V_471 ;
V_22 = F_174 ( V_315 , & V_469 ) ;
F_175 (host, tmp_host, &srp_dev->dev_list, list) {
F_162 ( & V_3 -> V_23 ) ;
F_36 ( & V_3 -> V_393 ) ;
F_53 ( & V_3 -> V_163 ) ;
F_176 (target, &host->target_list, list) {
F_46 ( & V_6 -> V_141 ) ;
V_6 -> V_142 = V_162 ;
F_47 ( & V_6 -> V_141 ) ;
}
...
{
int V_32 ;
F_181 ( F_182 ( struct V_185 , V_266 ) < sizeof( void * ) ) ;
if ( V_472 ) {
F_146 ( L_73 ) ;
if ( ! V_430 )
V_430 = V_472 ;
