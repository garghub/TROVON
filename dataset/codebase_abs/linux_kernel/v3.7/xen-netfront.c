...
static struct V_19 * T_7 F_137 ( struct V_212 * V_20 )
{
int V_14 , V_119 ;
struct V_19 * V_60 ;
struct V_11 * V_12 ;
...
static int T_7 F_150 ( struct V_212 * V_20 ,
...
static int F_167 ( struct V_212 * V_20 , T_8 V_233 [] )
{
...
static void F_196 ( struct V_19 * V_20 , T_9 V_272 , T_8 * V_23 )
{
int V_14 ;
switch ( V_272 ) {
case V_269 :
...
static T_10 F_197 ( struct V_118 * V_20 ,
...
static T_10 F_199 ( struct V_118 * V_20 ,
struct V_274 * V_275 ,
const char * V_276 , T_11 V_79 )
{
struct V_19 * V_60 = F_198 ( V_20 ) ;
...
static T_10 F_201 ( struct V_118 * V_20 ,
struct V_274 * V_275 , char * V_276 )
{
struct V_19 * V_60 = F_198 ( V_20 ) ;
struct V_11 * V_227 = F_11 ( V_60 ) ;
...
static T_10 F_202 ( struct V_118 * V_20 ,
struct V_274 * V_275 ,
const char * V_276 , T_11 V_79 )
{
struct V_19 * V_60 = F_198 ( V_20 ) ;
...
static T_10 F_203 ( struct V_118 * V_20 ,
struct V_274 * V_275 , char * V_276 )
{
struct V_19 * V_60 = F_198 ( V_20 ) ;
struct V_11 * V_227 = F_11 ( V_60 ) ;
...
static int T_12 F_207 ( struct V_212 * V_20 )
{
struct V_11 * V_227 = F_165 ( & V_20 -> V_20 ) ;
F_166 ( & V_20 -> V_20 , L_27 , V_20 -> V_232 ) ;
F_160 ( V_227 ) ;
