...
{
struct V_4 * V_21 = F_11 ( V_12 ) ;
int V_16 = 0 ;
T_1 V_22 ;
static const T_1 V_23 [] [ V_24 ] = {
...
V_16 |= F_13 ( & V_21 -> V_7 [ 0 ] , V_23 [ 0 ] ) ;
V_16 |= F_13 ( & V_21 -> V_7 [ 1 ] , V_23 [ 1 ] ) ;
V_16 |= F_13 ( & V_21 -> V_7 [ 2 ] , V_23 [ 2 ] ) ;
if ( V_16 ) {
F_14 ( & V_12 -> V_36 , L_1 ) ;
return - 1 ;
}
...
static int F_13 ( struct V_5 * V_6 , const T_1 * V_23 )
{
struct V_4 * V_21 = F_3 ( V_6 ) ;
struct V_11 * V_12 = V_21 -> V_12 ;
int V_16 = 0 ;
...
static void F_23 ( T_3 V_51 , char * V_57 )
{
int V_54 , V_58 = 0 ;
for ( V_54 = 0 ; V_54 < V_56 ; V_54 ++ )
V_58 += sprintf ( V_57 + V_58 , L_7 , F_24 ( V_51 , V_54 ) ) ;
V_57 [ V_58 ] = '\0' ;
}
static T_5 F_25 ( struct V_59 * V_36 ,
struct V_60 * V_61 ,
char * V_15 , int V_62 )
{
struct V_11 * V_12 = F_26 ( V_36 ) ;
struct V_4 * V_21 = F_11 ( V_12 ) ;
char V_46 [ V_56 + 1 ] ;
F_23 ( V_21 -> V_7 [ V_62 - 1 ] . V_51 , V_46 ) ;
return sprintf ( V_15 , L_8 , V_46 ) ;
}
static T_5 F_27 ( struct V_59 * V_36 ,
struct V_60 * V_61 ,
...
F_28 ( & V_21 -> V_64 ) ;
V_16 = - V_63 ;
if ( V_21 -> V_7 [ V_62 - 1 ] . V_42 != V_47 )
goto V_65;
if ( F_18 ( & V_21 -> V_7 [ V_62 - 1 ] , V_46 ) )
goto V_65;
V_16 = V_53 ;
V_65:
F_29 ( & V_21 -> V_64 ) ;
...
static T_5 F_30 ( struct V_59 * V_36 ,
struct V_60 * V_61 ,
char * V_15 )
{
struct V_11 * V_12 = F_26 ( V_36 ) ;
...
T_1 V_22 , V_66 , V_67 ;
F_28 ( & V_21 -> V_64 ) ;
V_16 = F_7 ( V_21 -> V_12 , V_39 , & V_22 ) ;
if ( V_16 < 0 )
goto V_44;
if ( ( V_21 -> V_68 ) && ( V_21 -> V_68 -> V_69 == V_70 ) )
if ( ( V_22 & V_71 ) == 0 )
goto V_44;
F_5 ( V_21 -> V_12 , V_72 ,
V_73 | 16 ) ;
...
if ( ! ( V_22 & V_74 ) )
F_12 ( 3000 , 6000 ) ;
V_16 |= F_7 ( V_21 -> V_12 , V_75 , & V_67 ) ;
V_67 -- ;
for ( V_54 = 0 ; V_54 < V_56 ; V_54 ++ ) {
if ( V_21 -> V_68 -> V_76 [ V_54 ] . V_77 == 0 )
continue;
F_5 ( V_21 -> V_12 ,
V_78 + V_54 ,
V_21 -> V_68 -> V_76 [ V_54 ] . V_77 ) ;
F_5 ( V_21 -> V_12 , V_79 + V_54 , 0xff ) ;
F_12 ( 2000 , 4000 ) ;
F_5 ( V_21 -> V_12 ,
V_72 ,
V_73 | V_54 ) ;
...
if ( ! ( V_22 & V_74 ) )
F_12 ( 3000 , 6000 ) ;
V_16 |= F_7 ( V_21 -> V_12 , V_75 , & V_66 ) ;
if ( V_66 >= V_67 || V_66 < V_80 )
V_58 += sprintf ( V_15 + V_58 , L_9 , V_54 ) ;
F_5 ( V_21 -> V_12 , V_79 + V_54 , 0x00 ) ;
F_5 ( V_21 -> V_12 ,
V_78 + V_54 ,
V_21 -> V_10 [ V_9 ] . V_77 ) ;
V_9 ++ ;
...
struct V_11 * V_12 = F_26 ( V_36 ) ;
struct V_4 * V_21 = F_11 ( V_12 ) ;
return F_34 ( & V_21 -> V_7 [ V_62 - 1 ] , V_15 , V_53 ) ;
}
...
static T_5 F_37 ( struct V_59 * V_36 ,
struct V_60 * V_61 ,
const char * V_15 , T_4 V_53 , int V_62 )
{
struct V_11 * V_12 = F_26 ( V_36 ) ;
struct V_4 * V_21 = F_11 ( V_12 ) ;
struct V_5 * V_6 = & V_21 -> V_7 [ V_62 - 1 ] ;
F_28 ( & V_21 -> V_64 ) ;
...
static T_5 F_39 ( struct V_59 * V_36 ,
struct V_60 * V_61 ,
char * V_15 )
{
struct V_2 * V_92 = F_40 ( V_36 ) ;
...
static T_5 F_42 ( struct V_59 * V_36 ,
struct V_60 * V_61 ,
const char * V_15 , T_4 V_53 )
{
struct V_2 * V_92 = F_40 ( V_36 ) ;
...
int V_54 ;
F_47 ( & V_36 -> V_95 , & V_96 ) ;
for ( V_54 = 0 ; V_54 < V_21 -> V_97 ; V_54 ++ )
F_47 ( & V_21 -> V_10 [ V_54 ] . V_3 . V_36 -> V_95 ,
& V_98 ) ;
}
static void F_38 ( struct V_5 * V_6 , T_1 V_42 )
{
...
return - 1 ;
V_6 -> V_8 = V_8 ;
V_6 -> V_45 = V_100 >> F_49 ( V_8 ) ;
V_6 -> V_52 = V_8 - 1 ;
V_6 -> V_49 = V_8 + 2 ;
return 0 ;
}
static int T_7 F_50 ( struct V_1 * V_9 , struct V_59 * V_36 ,
...
if ( V_68 -> V_76 [ V_101 ] . V_104 ) {
V_9 -> V_3 . V_104 = V_68 -> V_76 [ V_101 ] . V_104 ;
} else {
snprintf ( V_104 , sizeof( V_104 ) , L_24 ,
V_68 -> V_106 ? : V_103 , V_101 ) ;
V_9 -> V_3 . V_104 = V_104 ;
}
V_9 -> V_3 . V_107 = F_31 ;
V_105 = F_51 ( V_36 , & V_9 -> V_3 ) ;
if ( V_105 < 0 ) {
F_14 ( V_36 , L_25 ,
V_101 ) ;
return V_105 ;
}
V_105 = F_45 ( & V_9 -> V_3 . V_36 -> V_95 ,
& V_98 ) ;
if ( V_105 < 0 ) {
F_14 ( V_36 , L_26 ) ;
F_52 ( & V_9 -> V_3 ) ;
...
static int T_7 F_53 ( struct V_11 * V_12 ,
const struct V_108 * V_8 )
{
struct V_4 * V_21 ;
struct V_102 * V_68 ;
int V_16 , V_54 , V_9 ;
V_21 = F_54 ( & V_12 -> V_36 , sizeof( * V_21 ) , V_109 ) ;
if ( ! V_21 )
return - V_110 ;
F_55 ( V_12 , V_21 ) ;
V_21 -> V_12 = V_12 ;
V_68 = V_12 -> V_36 . V_111 ;
if ( ! V_68 ) {
F_14 ( & V_12 -> V_36 , L_27 ) ;
return - V_63 ;
}
...
if ( V_16 )
goto V_115;
F_16 ( & V_12 -> V_36 , L_28 , V_8 -> V_104 ) ;
for ( V_54 = 0 ; V_54 < F_57 ( V_21 -> V_7 ) ; V_54 ++ ) {
V_16 = F_48 ( & V_21 -> V_7 [ V_54 ] , V_54 + 1 ) ;
if ( V_16 ) {
F_14 ( & V_12 -> V_36 , L_29 ) ;
goto V_115;
}
...
V_21 -> V_116 = V_68 -> V_116 ;
V_21 -> V_97 = 0 ;
V_9 = 0 ;
for ( V_54 = 0 ; V_54 < V_68 -> V_116 ; V_54 ++ ) {
if ( V_68 -> V_76 [ V_54 ] . V_77 == 0 )
continue;
F_58 ( & V_21 -> V_10 [ V_9 ] . V_84 ,
F_33 ) ;
V_16 = F_50 ( & V_21 -> V_10 [ V_9 ] , & V_12 -> V_36 , V_54 , V_68 ,
V_8 -> V_104 ) ;
if ( V_16 ) {
F_14 ( & V_12 -> V_36 , L_31 ) ;
goto V_117;
...
V_21 -> V_97 ++ ;
V_21 -> V_10 [ V_9 ] . V_8 = V_9 ;
F_5 ( V_12 ,
V_78 + V_21 -> V_10 [ V_9 ] . V_87 ,
V_21 -> V_10 [ V_9 ] . V_77 ) ;
V_9 ++ ;
}
V_16 = F_44 ( V_12 ) ;
...
V_117:
for ( V_54 = 0 ; V_54 < V_21 -> V_97 ; V_54 ++ ) {
F_52 ( & V_21 -> V_10 [ V_54 ] . V_3 ) ;
F_59 ( & V_21 -> V_10 [ V_54 ] . V_84 ) ;
}
V_115:
if ( V_68 -> V_113 )
V_68 -> V_113 ( 0 ) ;
