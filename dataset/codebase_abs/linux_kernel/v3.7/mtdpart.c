...
if ( V_12 -> V_68 ) {
T_5 V_112 = 0 ;
while ( V_112 < V_73 -> V_2 . V_26 ) {
if ( F_47 ( V_12 , V_112 + V_73 -> V_15 ) )
V_73 -> V_2 . V_13 . V_70 ++ ;
V_112 += V_73 -> V_2 . V_95 ;
}
}
...
int F_48 ( struct V_1 * V_12 , char * V_72 ,
long long V_15 , long long V_113 )
{
struct V_78 V_8 ;
struct V_7 * V_71 , * V_114 ;
T_5 V_115 , V_104 ;
int V_55 = 0 ;
if ( V_15 == V_93 ||
V_15 == V_94 )
...
if ( V_71 -> V_12 == V_12 ) {
if ( ( V_115 >= V_71 -> V_15 ) &&
( V_115 < ( V_71 -> V_15 + V_71 -> V_2 . V_26 ) ) )
goto V_116;
if ( ( V_104 >= V_71 -> V_15 ) &&
( V_104 < ( V_71 -> V_15 + V_71 -> V_2 . V_26 ) ) )
goto V_116;
}
F_52 ( & V_114 -> V_77 , & V_117 ) ;
F_38 ( & V_76 ) ;
F_53 ( & V_114 -> V_2 ) ;
return V_55 ;
V_116:
...
const struct V_78 * V_119 ,
int V_120 )
{
struct V_7 * V_73 ;
T_5 V_80 = 0 ;
int V_102 ;
F_42 ( V_96 L_10 , V_120 , V_12 -> V_72 ) ;
for ( V_102 = 0 ; V_102 < V_120 ; V_102 ++ ) {
V_73 = F_39 ( V_12 , V_119 + V_102 , V_102 , V_80 ) ;
if ( F_49 ( V_73 ) )
return F_50 ( V_73 ) ;
F_34 ( & V_76 ) ;
F_52 ( & V_73 -> V_77 , & V_117 ) ;
F_38 ( & V_76 ) ;
F_53 ( & V_73 -> V_2 ) ;
...
static struct V_121 * F_56 ( const char * V_72 )
{
struct V_121 * V_71 , * V_55 = NULL ;
F_57 ( & V_122 ) ;
...
int F_60 ( struct V_121 * V_71 )
{
F_57 ( & V_122 ) ;
F_52 ( & V_71 -> V_77 , & V_123 ) ;
F_59 ( & V_122 ) ;
return 0 ;
}
int F_61 ( struct V_121 * V_71 )
{
F_57 ( & V_122 ) ;
F_37 ( & V_71 -> V_77 ) ;
F_59 ( & V_122 ) ;
...
int F_62 ( struct V_1 * V_12 , const char * * V_124 ,
struct V_78 * * V_125 ,
struct V_126 * V_127 )
{
struct V_121 * V_128 ;
...
if ( ! V_124 )
V_124 = V_129 ;
for ( ; V_55 <= 0 && * V_124 ; V_124 ++ ) {
V_128 = F_56 ( * V_124 ) ;
if ( ! V_128 && ! F_63 ( L_11 , * V_124 ) )
V_128 = F_56 ( * V_124 ) ;
if ( ! V_128 )
continue;
V_55 = (* V_128 -> V_130 )( V_12 , V_125 , V_127 ) ;
F_64 ( V_128 ) ;
if ( V_55 > 0 ) {
F_42 ( V_96 L_12 ,
V_55 , V_128 -> V_72 , V_12 -> V_72 ) ;
break;
}
}
return V_55 ;
