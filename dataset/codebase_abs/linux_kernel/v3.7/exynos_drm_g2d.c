...
static int T_4 F_63 ( struct V_149 * V_150 )
{
struct V_3 * V_4 = & V_150 -> V_4 ;
struct V_151 * V_152 ;
struct V_1 * V_2 ;
struct V_153 * V_73 ;
int V_9 ;
V_2 = F_64 ( & V_150 -> V_4 , sizeof( * V_2 ) , V_13 ) ;
if ( ! V_2 ) {
F_3 ( V_4 , L_10 ) ;
return - V_14 ;
}
...
F_70 ( V_4 ) ;
V_152 = F_71 ( V_150 , V_157 , 0 ) ;
V_2 -> V_59 = F_72 ( & V_150 -> V_4 , V_152 ) ;
if ( ! V_2 -> V_59 ) {
F_3 ( V_4 , L_16 ) ;
V_9 = - V_158 ;
goto V_159;
}
V_2 -> V_83 = F_73 ( V_150 , 0 ) ;
if ( V_2 -> V_83 < 0 ) {
F_3 ( V_4 , L_17 ) ;
V_9 = V_2 -> V_83 ;
goto V_159;
}
V_9 = F_74 ( & V_150 -> V_4 , V_2 -> V_83 , F_46 , 0 ,
L_18 , V_2 ) ;
if ( V_9 < 0 ) {
F_3 ( V_4 , L_19 ) ;
goto V_159;
...
static int T_5 F_82 ( struct V_149 * V_150 )
{
struct V_1 * V_2 = F_83 ( V_150 ) ;
F_84 ( & V_2 -> V_68 ) ;
F_85 ( & V_2 -> V_73 ) ;
while ( V_2 -> V_53 ) {
F_32 ( V_2 , V_2 -> V_53 ) ;
