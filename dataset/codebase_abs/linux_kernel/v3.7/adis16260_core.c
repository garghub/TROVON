...
int F_21 ( struct V_1 * V_2 , bool V_43 )
{
int V_5 ;
T_2 V_44 ;
...
{
int V_5 ;
struct V_88 * V_89 = V_87 -> V_24 . V_90 ;
struct V_6 * V_7 ;
struct V_1 * V_2 ;
V_2 = F_31 ( sizeof( * V_7 ) ) ;
if ( V_2 == NULL ) {
...
V_7 -> V_10 = V_87 ;
F_33 ( & V_7 -> V_8 ) ;
V_2 -> V_93 = F_16 ( V_7 -> V_10 ) -> V_93 ;
V_2 -> V_24 . V_94 = & V_87 -> V_24 ;
V_2 -> V_95 = & V_96 ;
V_2 -> V_97
= F_34 ( V_98 ) ;
if ( V_89 && V_89 -> V_99 )
...
static int T_7 F_45 ( struct V_86 * V_87 )
{
