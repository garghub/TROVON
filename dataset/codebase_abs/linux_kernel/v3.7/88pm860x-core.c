...
static int T_3 F_21 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
...
static void T_3 F_34 ( struct V_7 * V_8 )
{
...
static void T_3 F_36 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 , V_11 ;
if ( V_40 && V_40 -> V_76 ) {
...
static void T_3 F_38 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 , V_11 ;
if ( V_40 && V_40 -> V_82 ) {
...
static void T_3 F_39 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 ;
if ( V_40 == NULL )
...
static void T_3 F_40 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 ;
if ( ( V_40 == NULL ) )
...
static void T_3 F_41 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 ;
if ( V_40 == NULL )
...
static void T_3 F_42 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 ;
if ( V_40 == NULL )
...
static void T_3 F_43 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 ;
...
static void T_3 F_44 ( struct V_3 * V_4 ,
struct V_39 * V_40 )
{
int V_46 ;
...
static void T_3 F_45 ( struct V_3 * V_4 ,
struct V_7 * V_8 ,
struct V_39 * V_40 )
{
int V_2 , V_46 ;
...
static void T_3 F_47 ( struct V_3 * V_4 ,
struct V_7 * V_8 ,
struct V_39 * V_40 )
{
F_34 ( V_8 ) ;
...
static void T_4 F_49 ( struct V_3 * V_4 )
{
F_29 ( V_4 ) ;
F_50 ( V_4 -> V_29 ) ;
}
...
static int T_3 F_52 ( struct V_49 * V_140 ,
struct V_141 * V_29 ,
struct V_39 * V_40 )
{
int V_46 ;
...
static int T_3 F_55 ( struct V_7 * V_14 ,
...
V_4 -> V_15 = F_65 ( V_4 -> V_14 -> V_149 ,
V_4 -> V_142 ) ;
V_4 -> V_150 = F_59 ( V_4 -> V_15 ,
& V_148 ) ;
if ( F_60 ( V_4 -> V_150 ) ) {
V_46 = F_61 ( V_4 -> V_150 ) ;
F_9 ( & V_4 -> V_15 -> V_29 ,
...
static int T_4 F_67 ( struct V_7 * V_14 )
{
...
static int F_70 ( struct V_141 * V_29 )
{
struct V_7 * V_14 = F_71 ( V_29 , struct V_7 , V_29 ) ;
struct V_3 * V_4 = F_35 ( V_14 ) ;
if ( F_72 ( V_29 ) && V_4 -> V_151 )
F_73 ( V_4 -> V_61 ) ;
return 0 ;
}
static int F_74 ( struct V_141 * V_29 )
{
struct V_7 * V_14 = F_71 ( V_29 , struct V_7 , V_29 ) ;
struct V_3 * V_4 = F_35 ( V_14 ) ;
if ( F_72 ( V_29 ) && V_4 -> V_151 )
