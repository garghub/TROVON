...
V_260 = V_315 | F_150 ( V_315 ) ;
while ( ! ( F_7 ( V_2 , V_316 ) & V_260 ) && -- V_314 )
F_44 ( 1000 ) ;
if ( V_314 == 0 ) {
F_151 ( L_93 ) ;
return - V_129 ;
...
F_152 ( V_28 ) ;
V_28 -> V_5 |= V_319 ;
F_153 ( V_28 , & V_2 -> V_184 , F_74 , V_320 ) ;
V_28 -> V_321 = & V_322 ;
V_28 -> V_323 = & V_324 ;
return 0 ;
}
static int T_7 F_154 ( struct V_21 * V_22 )
{
struct V_23 * V_28 ;
struct V_1 * V_2 ;
struct V_325 * V_326 ;
...
V_326 = F_159 ( V_22 , V_327 ,
L_104 ) ;
if ( ! V_326 )
V_326 = F_160 ( V_22 , V_327 , 0 ) ;
F_161 ( V_326 -> V_328 , F_162 ( V_326 ) ) ;
F_163 ( V_2 -> V_7 ) ;
( void ) F_28 ( V_22 ) ;
F_32 ( V_22 ) ;
F_164 ( V_28 ) ;
...
if ( ! V_331 )
return - V_129 ;
V_4 -> V_132 = F_166 ( V_331 ) ;
V_332 = F_167 ( V_331 ) ;
if ( V_332 )
memcpy ( V_4 -> V_332 , V_332 , V_91 ) ;
F_168 ( V_331 , L_105 , & V_4 -> V_334 ) ;
F_168 ( V_331 , L_106 , & V_333 ) ;
if ( V_333 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
if ( F_169 ( V_331 , L_107 , NULL ) )
V_4 -> V_226 = V_335 ;
if ( F_169 ( V_331 , L_108 , NULL ) )
V_4 -> V_228 = V_336 ;
if ( F_169 ( V_331 , L_109 , NULL ) )
V_4 -> V_5 |= V_57 ;
if ( F_169 ( V_331 , L_110 , NULL ) )
V_4 -> V_5 |= V_59 ;
if ( F_169 ( V_331 , L_111 , NULL ) )
V_4 -> V_5 |= V_318 ;
return 0 ;
}
...
static int T_5 F_170 ( struct V_21 * V_22 )
{
...
V_340 = F_162 ( V_326 ) ;
V_339 = F_160 ( V_22 , V_344 , 0 ) ;
if ( ! V_339 ) {
F_172 ( L_114 ) ;
V_342 = - V_129 ;
goto V_343;
}
if ( ! F_173 ( V_326 -> V_328 , V_340 , V_288 ) ) {
V_342 = - V_274 ;
goto V_343;
}
...
V_2 -> V_7 = F_176 ( V_326 -> V_328 , V_340 ) ;
V_2 -> V_28 = V_28 ;
V_2 -> V_292 = ( ( 1 << V_347 ) - 1 ) ;
F_156 ( V_22 , V_28 ) ;
V_342 = F_30 ( V_22 ) ;
...
static int F_181 ( struct V_356 * V_28 )
{
...
static int F_183 ( struct V_356 * V_28 )
{
struct V_23 * V_24 = F_182 ( V_28 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_314 = 100 ;
F_14 ( V_2 , V_37 , 0 ) ;
while ( ! ( F_7 ( V_2 , V_316 ) & V_315 ) && -- V_314 )
F_44 ( 1000 ) ;
