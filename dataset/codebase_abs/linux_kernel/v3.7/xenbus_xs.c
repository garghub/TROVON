...
{
#ifdef F_54
T_2 V_76 , V_77 , V_78 , V_79 , V_80 ;
V_80 = F_55 () ;
F_56 ( V_80 + 1 , & V_76 , & V_77 , & V_78 , & V_79 ) ;
if ( ( V_76 >> 16 ) < 4 )
return true ;
#endif
return false ;
...
if ( V_28 != 1 || ! V_81 )
return;
V_28 = F_29 ( F_28 ( V_62 , V_82 , L_5 , NULL ) ) ;
if ( V_28 && V_28 != - V_83 )
F_3 ( V_5 L_11 , V_28 ) ;
}
int F_60 ( struct V_74 * V_84 )
{
char V_70 [ sizeof( V_84 ) * 2 + 1 ] ;
int V_28 ;
sprintf ( V_70 , L_12 , ( long ) V_84 ) ;
F_61 ( & V_13 . V_85 ) ;
F_5 ( & V_86 ) ;
F_62 ( F_51 ( V_70 ) ) ;
F_63 ( & V_84 -> V_18 , & V_87 ) ;
F_7 ( & V_86 ) ;
V_28 = F_49 ( V_84 -> V_52 , V_70 ) ;
if ( V_28 ) {
F_5 ( & V_86 ) ;
F_10 ( & V_84 -> V_18 ) ;
F_7 ( & V_86 ) ;
...
if ( V_11 -> V_20 . V_84 . V_94 != V_84 )
continue;
F_10 ( & V_11 -> V_18 ) ;
F_11 ( V_11 -> V_20 . V_84 . V_95 ) ;
F_11 ( V_11 ) ;
}
F_7 ( & V_93 ) ;
if ( V_89 -> V_90 != V_91 )
...
F_7 ( & V_93 ) ;
if ( V_99 != & V_101 ) {
V_11 = F_9 ( V_99 , struct V_10 , V_18 ) ;
V_11 -> V_20 . V_84 . V_94 -> V_102 (
V_11 -> V_20 . V_84 . V_94 ,
( const char * * ) V_11 -> V_20 . V_84 . V_95 ,
V_11 -> V_20 . V_84 . V_103 ) ;
F_11 ( V_11 -> V_20 . V_84 . V_95 ) ;
F_11 ( V_11 ) ;
}
F_15 ( & V_92 ) ;
...
V_28 = F_79 ( & V_11 -> V_19 , sizeof( V_11 -> V_19 ) ) ;
if ( V_28 ) {
F_11 ( V_11 ) ;
goto V_104;
}
if ( V_11 -> V_19 . V_9 > V_105 ) {
F_11 ( V_11 ) ;
V_28 = - V_6 ;
goto V_104;
}
...
if ( V_11 -> V_19 . type == V_106 ) {
V_11 -> V_20 . V_84 . V_95 = F_34 ( V_12 , V_11 -> V_19 . V_9 ,
& V_11 -> V_20 . V_84 . V_103 ) ;
if ( F_26 ( V_11 -> V_20 . V_84 . V_95 ) ) {
V_28 = F_30 ( V_11 -> V_20 . V_84 . V_95 ) ;
F_11 ( V_11 ) ;
goto V_104;
}
F_5 ( & V_86 ) ;
V_11 -> V_20 . V_84 . V_94 = F_51 (
V_11 -> V_20 . V_84 . V_95 [ V_107 ] ) ;
if ( V_11 -> V_20 . V_84 . V_94 != NULL ) {
F_5 ( & V_93 ) ;
F_80 ( & V_11 -> V_18 , & V_101 ) ;
F_18 ( & V_100 ) ;
F_7 ( & V_93 ) ;
} else {
F_11 ( V_11 -> V_20 . V_84 . V_95 ) ;
...
if ( V_28 )
return V_28 ;
V_109 = F_89 ( F_73 , NULL , L_16 ) ;
if ( F_26 ( V_109 ) )
return F_30 ( V_109 ) ;
V_91 = V_109 -> V_90 ;
V_109 = F_89 ( F_81 , NULL , L_17 ) ;
if ( F_26 ( V_109 ) )
return F_30 ( V_109 ) ;
F_57 () ;
return 0 ;
