...
V_88 = F_47 ( V_13 ) ;
V_25 = F_48 ( V_88 * sizeof( int ) ) ;
V_27 = F_48 ( V_88 * sizeof( int ) ) ;
do {
F_49 ( V_89 , V_87 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
if ( V_83 == 0 )
break;
V_25 [ V_87 ] = V_84 ;
V_27 [ V_87 ] = V_83 ;
...
F_49 ( V_89 , 0 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
...
void T_5 F_62 ( void )
{
static T_6 void (* F_63)( void ) = F_56 ;
void (* F_64)( void );
if ( ! V_90 )
return;
F_64 = F_63 ;
...
static inline void T_4 F_65 ( void )
{
V_62 -> V_5 . V_6 . V_7 =
F_51 ( V_39 , F_52 ( struct V_43 ) ) ;
if ( ! V_28 )
F_50 () ;
}
void T_5 F_66 ( void )
{
static T_6 void (* F_67)( void ) = F_65 ;
F_68 () ;
F_69 () -> V_49 = 0 ;
if ( V_92 == V_93 )
F_70 ( V_100 ) ;
