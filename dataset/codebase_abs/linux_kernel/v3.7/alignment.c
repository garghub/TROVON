...
F_44 ( V_76 ) ;
if ( F_45 ( V_32 ) ) {
V_41 = F_46 ( V_60 , ( T_5 * ) ( V_72 & ~ 1 ) ) ;
if ( ! V_41 ) {
if ( F_2 () >= V_77 &&
F_47 ( V_60 ) ) {
T_5 V_69 = 0 ;
V_41 = F_46 ( V_69 , ( T_5 * ) ( V_72 + 2 ) ) ;
V_30 = ( V_60 << 16 ) | V_69 ;
V_75 = 1 ;
} else {
V_74 = 2 ;
...
V_92 . V_95 = 0 ;
V_92 . V_96 = V_97 ;
V_92 . V_98 = ( void T_2 * ) V_29 ;
F_57 ( V_92 . V_93 , & V_92 , V_90 ) ;
} else {
F_58 () ;
if ( ! ( F_59 () -> V_99 & V_100 ) )
F_60 ( V_101 ) ;
...
#ifdef F_62
struct V_102 * V_103 ;
V_103 = F_63 ( L_18 , V_104 | V_105 , NULL ,
& V_106 ) ;
if ( ! V_103 )
return - V_107 ;
#endif
...
F_64 ( V_109 , F_39 , V_94 , V_97 ,
L_19 ) ;
if ( F_2 () <= V_1 ) {
F_64 ( 3 , F_39 , V_94 , V_97 ,
L_19 ) ;
}
return 0 ;
}
