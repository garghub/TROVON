...
V_2 -> V_84 = V_78 ;
V_2 -> V_85 = V_78 -> V_86 ;
V_49 = F_37 ( V_2 , sizeof( * V_5 ) ) ;
if ( V_49 < 0 )
return - V_87 ;
V_5 = V_2 -> V_6 ;
V_49 = F_38 ( V_59 , V_2 -> V_88 -> V_89 ) ;
if ( V_49 < 0 )
return V_49 ;
V_2 -> V_90 = 1 ;
V_5 -> V_42 = F_39 ( F_40 ( V_59 , 0 ) ,
F_41 ( V_59 , 0 ) ) ;
V_5 -> V_7 = F_39 ( F_40 ( V_59 , 2 ) ,
F_41 ( V_59 , 2 ) ) ;
if ( ! V_5 -> V_42 || ! V_5 -> V_7 )
return - V_87 ;
V_49 = F_42 ( V_2 , 3 ) ;
...
V_16 -> V_99 = & V_104 ;
V_16 = & V_2 -> V_91 [ 2 ] ;
V_49 = F_43 ( V_2 , V_16 , F_32 ,
( unsigned long ) ( V_5 -> V_7 + V_105 ) ) ;
if ( V_49 )
return V_49 ;
F_44 ( V_2 -> V_106 , L_1 ,
V_2 -> V_88 -> V_89 , V_2 -> V_85 ) ;
return 0 ;
}
...
static int T_5 F_51 ( struct V_58 * V_2 ,
const struct V_108 * V_109 )
{
return F_52 ( V_2 , & V_110 ) ;
}
static void T_6 F_53 ( struct V_58 * V_2 )
{
F_54 ( V_2 ) ;
}
