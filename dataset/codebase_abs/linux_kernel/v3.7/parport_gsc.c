...
struct V_1 * T_1 F_16 ( unsigned long V_22 ,
unsigned long V_23 ,
int V_24 , int V_25 ,
struct V_26 * V_5 )
{
...
V_12 -> V_25 = V_38 ;
F_18 ( L_5 ) ;
#define F_22 ( T_2 ) {if(p->modes&PARPORT_MODE_##x){printk("%s%s",f?",":"",#x);f++;}}
{
int V_45 = 0 ;
F_22 ( V_46 ) ;
F_22 ( V_47 ) ;
...
static int T_1 F_25 ( struct V_51 * V_5 )
{
struct V_1 * V_12 ;
unsigned long V_52 ;
if ( ! V_5 -> V_24 ) {
...
static int T_3 F_28 ( struct V_51 * V_5 )
{
