...
int V_32 ;
int V_34 ;
F_33 ( V_10 , L_25 , V_37 , V_84 ? L_4 : L_5 ) ;
if ( ! F_10 ( V_3 ) ) {
V_34 = - V_60 ;
F_5 ( V_10 , L_26 ) ;
goto V_85;
...
static int F_110 ( struct V_43 * V_44 )
{
return 0 ;
}
...
struct V_2 * V_3 = F_67 ( V_8 ) ;
struct V_27 * V_21 ;
T_3 * V_135 = F_118 ( V_8 , V_135 ) ;
int V_136 = F_118 ( V_8 , V_136 ) ;
int V_137 , V_33 , V_32 ;
V_137 = V_138 ;
...
V_44 -> V_146 = 1 ;
V_3 = F_71 ( V_44 ) ;
F_132 ( V_8 , & V_3 -> V_12 , V_147 ) ;
V_3 -> V_12 . V_148 = L_48 ;
V_3 -> V_12 . V_149 = F_122 ;
V_3 -> V_12 . V_150 = F_128 ;
F_133 ( V_3 ) ;
F_134 (udev, hpriv, i) {
V_26 -> V_46 = NULL ;
F_40 ( & V_26 -> V_41 ) ;
