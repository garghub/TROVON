...
static int F_55 ( struct V_1 * V_2 , struct V_55 * V_56 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
...
static int F_72 ( struct V_1 * V_2 , struct V_55 * V_56 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
...
static T_2 F_74 ( int V_244 , void * V_245 )
{
...
static bool F_76 ( const struct V_3 * V_254 ,
struct V_255 * V_255 )
{
...
static const struct V_3 * F_78 ( struct V_255 * V_255 )
{
unsigned int V_24 ;
for ( V_24 = 0 ; V_24 < F_79 ( V_258 ) ; V_24 ++ )
if ( F_76 ( & V_258 [ V_24 ] , V_255 ) )
return & V_258 [ V_24 ] ;
return NULL ;
}
static struct V_255 * F_80 ( struct V_1 * V_2 ,
struct V_259 * V_260 )
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
...
struct V_5 * V_6 ;
int V_93 ;
V_93 = F_84 ( V_2 , sizeof( struct V_5 ) ) ;
if ( V_93 ) {
F_32 ( V_2 -> V_87 , L_26 ) ;
return V_93 ;
}
...
F_90 ( V_2 -> V_87 , L_32 , V_255 -> V_244 ) ;
}
V_273 = F_93 ( V_2 , 3 ) ;
if ( V_273 )
return V_273 ;
...
static int F_95 ( struct V_1 * V_2 , struct V_259 * V_260 )
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_255 * V_255 ;
int V_273 ;
...
if ( V_273 )
return V_273 ;
V_255 = F_80 ( V_2 , V_260 ) ;
if ( ! V_255 )
return - V_276 ;
return F_86 ( V_2 , V_255 ) ;
}
...
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_255 * V_307 = F_100 ( V_2 ) ;
if ( V_2 -> V_284 && V_4 -> V_193 )
F_101 ( V_2 , & V_2 -> V_284 [ 2 ] ) ;
if ( V_2 -> V_244 )
F_102 ( V_2 -> V_244 , V_2 ) ;
if ( V_307 ) {
if ( V_2 -> V_9 )
...
static int T_3 F_105 ( struct V_255 * V_2 ,
const struct V_308 * V_309 )
{
return F_106 ( V_2 , & V_310 ) ;
}
static void T_4 F_107 ( struct V_255 * V_2 )
{
F_108 ( V_2 ) ;
}
