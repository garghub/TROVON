...
V_145 = F_58 ( V_147 ) ;
V_144 -> V_149 = V_145 ;
} while ( ! F_59 ( V_144 -> V_151 , V_145 ) -> V_152 );
F_30 ( & V_144 -> V_148 , V_88 ) ;
return V_145 ;
}
static void F_60 ( struct V_1 * V_153 ,
struct V_154 * V_155 ,
struct V_156 * V_157 )
{
unsigned long V_88 ;
F_28 ( & V_155 -> V_158 , V_88 ) ;
F_2 ( & V_153 -> V_158 ) ;
if ( V_153 -> V_159 == 0 ) {
V_153 -> V_159 ++ ;
F_61 ( & V_153 -> V_121 , & V_155 -> V_160 ) ;
V_155 -> V_161 ++ ;
F_62 ( V_157 ) ;
} else
V_153 -> V_159 ++ ;
F_3 ( & V_153 -> V_158 ) ;
F_30 ( & V_155 -> V_158 , V_88 ) ;
}
static void F_45 ( struct V_1 * V_153 )
{
int V_162 ;
struct V_154 * V_155 ;
struct V_156 * V_157 ;
...
V_162 = F_53 ( V_144 ) ;
F_63 ( ! F_64 ( V_162 ) ) ;
V_155 = F_59 ( V_144 -> V_151 , V_162 ) ;
V_157 = * F_59 ( V_144 -> V_163 , V_162 ) ;
F_63 ( ! V_155 || ! V_157 ) ;
F_28 ( & V_155 -> V_158 , V_88 ) ;
V_161 = V_155 -> V_161 ;
F_30 ( & V_155 -> V_158 , V_88 ) ;
...
F_60 ( V_153 , V_155 , V_157 ) ;
}
static void F_65 ( struct V_154 * V_155 )
{
struct V_1 * V_2 ;
while ( ! F_66 ( & V_155 -> V_160 ) ) {
V_2 = F_67 ( V_155 -> V_160 . V_164 , struct V_1 , V_121 ) ;
F_68 ( & V_155 -> V_158 ) ;
F_1 ( V_2 ) ;
if ( F_18 ( & V_2 -> V_52 ) )
F_19 ( & V_2 -> V_58 ) ;
...
V_2 -> V_159 -- ;
if ( ! V_2 -> V_159 ) {
F_70 ( V_155 -> V_160 . V_164 ) ;
V_155 -> V_161 -- ;
}
F_3 ( & V_2 -> V_158 ) ;
}
}
static void F_71 ( unsigned int V_145 )
{
struct V_154 * V_155 = F_59 ( V_144 -> V_151 , V_145 ) ;
struct V_154 * V_165 ;
struct V_156 * V_157 ;
...
V_155 -> V_161 = 0 ;
V_155 -> V_152 = 0 ;
F_73 ( & V_155 -> V_160 , & V_167 ) ;
F_68 ( & V_155 -> V_158 ) ;
V_145 = F_53 ( V_144 ) ;
V_165 = F_59 ( V_144 -> V_151 , V_145 ) ;
V_157 = * F_59 ( V_144 -> V_163 , V_145 ) ;
F_69 ( & V_165 -> V_158 ) ;
F_74 (cq, tmp, &list, entry) {
F_75 ( & V_2 -> V_121 ) ;
F_60 ( V_2 , V_165 , V_157 ) ;
}
F_68 ( & V_165 -> V_158 ) ;
}
static void F_76 ( unsigned int V_145 , bool V_168 )
{
struct V_154 * V_155 = F_59 ( V_144 -> V_151 , V_145 ) ;
F_69 ( & V_155 -> V_158 ) ;
V_155 -> V_161 = 0 ;
V_155 -> V_152 = 0 ;
F_77 ( ! F_66 ( & V_155 -> V_160 ) ) ;
F_68 ( & V_155 -> V_158 ) ;
}
static int F_78 ( unsigned int V_145 )
{
struct V_154 * V_155 = F_59 ( V_144 -> V_151 , V_145 ) ;
return V_155 -> V_161 ;
}
static void F_79 ( unsigned int V_145 )
{
struct V_154 * V_155 = F_80 ( V_144 -> V_151 ) ;
int V_169 ;
F_69 ( & V_155 -> V_158 ) ;
V_169 = F_66 ( & V_155 -> V_160 ) ;
if ( ! V_169 ) {
F_81 ( V_170 ) ;
F_65 ( V_155 ) ;
}
...
if ( ! V_126 )
return 0 ;
V_144 = F_83 ( sizeof( struct V_143 ) , V_171 ) ;
if ( V_144 == NULL )
return - V_24 ;
F_84 ( & V_144 -> V_148 ) ;
V_144 -> V_149 = F_85 ( V_147 ) ;
V_144 -> V_151 = F_86 ( struct V_154 ) ;
if ( ! V_144 -> V_151 )
goto V_172;
V_144 -> V_163 = F_86 ( struct V_156 * ) ;
if ( ! V_144 -> V_163 )
goto V_173;
F_87 (cpu) {
struct V_154 * V_155 ;
V_155 = F_59 ( V_144 -> V_151 , V_145 ) ;
F_84 ( & V_155 -> V_158 ) ;
F_88 ( & V_155 -> V_160 ) ;
}
V_174 . V_175 = V_144 -> V_163 ;
V_21 = F_89 ( & V_174 ) ;
if ( V_21 )
goto V_176;
F_90 ( L_51 ) ;
