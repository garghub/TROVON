...
static int T_10 F_75 ( struct V_63 * V_64 ,
...
F_80 ( V_64 , V_113 ) ;
F_40 ( V_113 ) ;
error = F_81 ( V_64 -> V_134 , F_61 , V_155 , L_7 , V_113 ) ;
if ( error )
goto V_156;
F_41 ( V_113 ) ;
F_82 ( & V_113 -> V_125 , & V_157 ) ;
V_113 -> V_125 . V_158 = V_159 ;
V_148 = V_147 * V_102 ;
...
int error ;
T_12 V_73 ;
V_142 = F_87 ( V_159 , L_11 ) ;
if ( F_85 ( V_142 ) ) {
error = F_88 ( V_142 ) ;
goto V_130;
}
error = F_89 ( & V_73 , 0 , V_162 , V_152 ) ;
if ( error )
goto V_163;
V_143 = F_90 ( V_73 ) ;
error = F_91 ( & V_164 ) ;
...
static void T_13 F_93 ( void )
{
F_94 ( & V_164 ) ;
F_92 ( F_71 ( V_143 , 0 ) , V_162 ) ;
V_163 ( V_142 ) ;
}
