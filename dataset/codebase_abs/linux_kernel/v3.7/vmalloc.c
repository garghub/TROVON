...
V_148 -> V_155 |= V_156 | V_157 ;
return 0 ;
}
static int F_200 ( T_2 * V_4 , T_10 V_158 , unsigned long V_2 , void * V_159 )
{
T_2 * * * V_33 = V_159 ;
if ( V_33 ) {
* ( * V_33 ) = V_4 ;
...
struct V_107 * F_201 ( T_8 V_40 , T_2 * * V_160 )
{
struct V_107 * V_113 ;
...
if ( V_30 -> va_end > V_3 ) {
* V_161 = V_30 ;
* V_162 = F_204 ( F_50 ( & ( * V_161 ) -> V_27 ) ) ;
} else {
* V_162 = V_30 ;
* V_161 = F_204 ( F_206 ( & ( * V_162 ) -> V_27 ) ) ;
}
return true ;
}
static unsigned long F_207 ( struct V_26 * * V_161 ,
struct V_26 * * V_162 ,
unsigned long V_41 )
{
const unsigned long V_163 = V_63 & ~ ( V_41 - 1 ) ;
unsigned long V_2 ;
if ( * V_161 )
V_2 = F_208 ( ( * V_161 ) -> va_start & ~ ( V_41 - 1 ) , V_163 ) ;
else
V_2 = V_163 ;
...
struct V_107 * * F_209 ( const unsigned long * V_164 ,
const T_8 * V_165 , int V_166 ,
T_8 V_41 )
{
const unsigned long V_167 = F_58 ( V_62 , V_41 ) ;
const unsigned long V_163 = V_63 & ~ ( V_41 - 1 ) ;
struct V_26 * * V_168 , * V_37 , * V_9 ;
struct V_107 * * V_169 ;
int V_113 , V_170 , V_171 , V_172 ;
unsigned long V_173 , V_17 , V_3 , V_174 ;
bool V_46 = false ;
F_16 ( V_41 & ~ V_48 || ! F_53 ( V_41 ) ) ;
for ( V_171 = 0 , V_113 = 0 ; V_113 < V_166 ; V_113 ++ ) {
V_17 = V_164 [ V_113 ] ;
V_3 = V_17 + V_165 [ V_113 ] ;
F_16 ( ! F_210 ( V_164 [ V_113 ] , V_41 ) ) ;
F_16 ( ! F_210 ( V_165 [ V_113 ] , V_41 ) ) ;
if ( V_17 > V_164 [ V_171 ] )
V_171 = V_113 ;
...
V_169 = F_211 ( V_166 , sizeof( V_169 [ 0 ] ) , V_106 ) ;
V_168 = F_211 ( V_166 , sizeof( V_168 [ 0 ] ) , V_106 ) ;
if ( ! V_168 || ! V_169 )
goto V_177;
for ( V_113 = 0 ; V_113 < V_166 ; V_113 ++ ) {
V_168 [ V_113 ] = F_143 ( sizeof( struct V_26 ) , V_106 ) ;
V_169 [ V_113 ] = F_143 ( sizeof( struct V_107 ) , V_106 ) ;
if ( ! V_168 [ V_113 ] || ! V_169 [ V_113 ] )
goto V_178;
}
V_50:
F_57 ( & V_51 ) ;
...
V_113 = ( V_113 + V_166 - 1 ) % V_166 ;
if ( V_113 == V_172 )
break;
V_17 = V_164 [ V_113 ] ;
V_3 = V_17 + V_165 [ V_113 ] ;
F_205 ( V_173 + V_3 , & V_9 , & V_37 ) ;
}
V_58:
for ( V_113 = 0 ; V_113 < V_166 ; V_113 ++ ) {
struct V_26 * V_30 = V_168 [ V_113 ] ;
V_30 -> va_start = V_173 + V_164 [ V_113 ] ;
V_30 -> va_end = V_30 -> va_start + V_165 [ V_113 ] ;
F_46 ( V_30 ) ;
}
V_64 = V_173 + V_164 [ V_171 ] ;
F_61 ( & V_51 ) ;
for ( V_113 = 0 ; V_113 < V_166 ; V_113 ++ )
F_152 ( V_169 [ V_113 ] , V_168 [ V_113 ] , V_134 ,
F_209 ) ;
F_65 ( V_168 ) ;
return V_169 ;
V_178:
...
void F_212 ( struct V_107 * * V_169 , int V_166 )
{
int V_97 ;
...
static void * F_213 ( struct V_179 * V_180 , T_11 * V_181 )
__acquires( &vmlist_lock
static void * F_214 ( struct V_179 * V_180 , void * V_33 , T_11 * V_181 )
{
struct V_107 * V_182 = V_33 ;
++ * V_181 ;
return V_182 -> V_9 ;
}
static void F_215 ( struct V_179 * V_180 , void * V_33 )
__releases( &vmlist_lock
static void F_216 ( struct V_179 * V_180 , struct V_107 * V_182 )
{
if ( V_183 ) {
unsigned int V_14 , * V_184 = V_180 -> V_185 ;
if ( ! V_184 )
return;
memset ( V_184 , 0 , V_186 * sizeof( unsigned int ) ) ;
for ( V_14 = 0 ; V_14 < V_182 -> V_122 ; V_14 ++ )
V_184 [ F_217 ( V_182 -> V_13 [ V_14 ] ) ] ++ ;
F_218 (nr, N_HIGH_MEMORY)
if ( V_184 [ V_14 ] )
F_219 ( V_180 , L_7 , V_14 , V_184 [ V_14 ] ) ;
}
}
static int F_220 ( struct V_179 * V_180 , void * V_33 )
{
struct V_107 * V_182 = V_33 ;
F_219 ( V_180 , L_8 ,
V_182 -> V_2 , V_182 -> V_2 + V_182 -> V_40 , V_182 -> V_40 ) ;
if ( V_182 -> V_114 )
F_219 ( V_180 , L_9 , V_182 -> V_114 ) ;
if ( V_182 -> V_122 )
F_219 ( V_180 , L_10 , V_182 -> V_122 ) ;
if ( V_182 -> V_187 )
F_219 ( V_180 , L_11 , ( unsigned long long ) V_182 -> V_187 ) ;
if ( V_182 -> V_59 & V_117 )
F_219 ( V_180 , L_12 ) ;
if ( V_182 -> V_59 & V_134 )
F_219 ( V_180 , L_13 ) ;
...
static int F_222 ( struct V_189 * V_189 , struct V_190 * V_190 )
{
unsigned int * V_191 = NULL ;
int V_19 ;
if ( V_183 ) {
V_191 = F_223 ( V_186 * sizeof( unsigned int ) , V_106 ) ;
if ( V_191 == NULL )
return - V_15 ;
}
V_19 = F_224 ( V_190 , & V_192 ) ;
if ( ! V_19 ) {
struct V_179 * V_180 = V_190 -> V_193 ;
V_180 -> V_185 = V_191 ;
} else
F_65 ( V_191 ) ;
return V_19 ;
