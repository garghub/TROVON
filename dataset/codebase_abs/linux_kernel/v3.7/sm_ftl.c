...
int F_42 ( struct V_12 * V_13 , struct V_61 * V_62 )
{
int V_35 ;
...
struct V_91 * F_55 ( struct V_12 * V_13 , int V_89 )
{
struct V_91 * V_46 ;
int error ;
F_30 ( V_89 >= V_13 -> V_50 ) ;
...
void F_58 ( struct V_12 * V_13 , char * V_56 , int V_48 )
{
memcpy ( V_13 -> V_134 + V_48 , V_56 , V_49 ) ;
F_59 ( V_48 / V_49 , & V_13 -> V_130 ) ;
V_13 -> V_131 = 0 ;
}
int F_60 ( struct V_12 * V_13 , char * V_56 , int V_48 )
{
if ( F_33 ( V_48 / V_49 ,
& V_13 -> V_130 ) )
return - 1 ;
...
static int F_76 ( struct V_143 * V_2 )
{
struct V_12 * V_13 = V_2 -> V_98 ;
F_66 ( & V_13 -> V_142 ) ;
F_77 ( & V_13 -> V_148 ) ;
