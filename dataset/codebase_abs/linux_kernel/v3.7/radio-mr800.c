...
{
struct V_1 * V_4 =
F_2 ( V_92 -> V_93 , struct V_1 , V_94 ) ;
switch ( V_92 -> V_95 ) {
case V_96 :
return F_9 ( V_4 , V_92 -> V_97 ) ;
}
return - V_51 ;
}
...
static int F_38 ( struct V_33 * V_34 , T_3 V_99 )
{
struct V_1 * V_4 = F_1 ( F_15 ( V_34 ) ) ;
F_16 ( & V_4 -> V_35 ) ;
if ( ! V_4 -> V_23 ) {
...
const struct V_100 * V_95 )
{
struct V_1 * V_4 ;
int V_10 = 0 ;
V_4 = F_46 ( sizeof( struct V_1 ) , V_101 ) ;
if ( ! V_4 ) {
F_47 ( & V_34 -> V_17 , L_9 ) ;
V_10 = - V_102 ;
goto V_103;
}
V_4 -> V_12 = F_48 ( V_14 , V_101 ) ;
if ( ! V_4 -> V_12 ) {
F_47 ( & V_34 -> V_17 , L_10 ) ;
V_10 = - V_102 ;
goto V_104;
...
F_52 ( & V_4 -> V_35 ) ;
V_4 -> V_3 . V_108 = & V_4 -> V_94 ;
V_4 -> V_3 . V_109 = F_41 ;
F_24 ( V_4 -> V_16 . V_52 , V_4 -> V_3 . V_52 ,
sizeof( V_4 -> V_16 . V_52 ) ) ;
V_4 -> V_16 . V_3 = & V_4 -> V_3 ;
V_4 -> V_16 . V_110 = & V_111 ;
V_4 -> V_16 . V_112 = & V_113 ;
V_4 -> V_16 . V_109 = V_114 ;
V_4 -> V_16 . V_35 = & V_4 -> V_35 ;
F_53 ( V_115 , & V_4 -> V_16 . V_116 ) ;
V_4 -> V_13 = F_54 ( V_34 ) ;
V_4 -> V_34 = V_34 ;
F_18 ( V_34 , & V_4 -> V_3 ) ;
V_4 -> V_28 = 95.16 * V_56 ;
