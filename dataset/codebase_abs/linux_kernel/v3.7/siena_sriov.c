...
V_17 = F_5 ( V_5 , V_194 , ( T_1 * ) V_187 ,
V_186 * sizeof( * V_187 ) , NULL , 0 , NULL ) ;
F_13 ( V_17 < 0 ) ;
V_184 = F_73 ( V_2 -> V_195 ,
F_60 ( V_2 ) ,
V_184 ) ;
V_186 = 0 ;
for ( V_3 = 0 ; V_3 < V_37 ; ++ V_3 ) {
...
F_37 ( V_5 , V_2 -> V_196 , NULL ,
V_197 * F_2 ( V_5 ) ) ;
F_15 ( V_187 ) ;
F_63 ( V_2 ) ;
V_2 -> V_147 = 0 ;
return V_184 ? 0 : V_198 ;
}
static int F_77 ( struct V_1 * V_2 )
{
struct V_6 * V_5 = V_2 -> V_5 ;
struct V_129 * V_36 = V_2 -> V_115 . V_72 ;
unsigned V_149 = V_36 -> V_131 . V_199 . V_200 ;
unsigned V_162 ;
...
L_11
L_12 , V_2 -> V_71 , V_149 ,
V_36 -> V_131 . V_199 . V_162 ) ;
return V_136 ;
}
V_162 = 0 ;
if ( V_36 -> V_131 . V_199 . V_162 & V_201 )
V_162 |= V_202 ;
if ( V_36 -> V_131 . V_199 . V_162 & V_203 )
V_162 |= V_204 ;
V_2 -> V_83 = V_162 ;
V_2 -> V_84 = V_149 ;
V_2 -> V_82 = true ;
...
struct V_6 * V_5 = V_2 -> V_5 ;
struct V_129 * V_36 = V_2 -> V_115 . V_72 ;
T_7 V_205 = V_36 -> V_131 . V_206 . V_105 ;
T_7 V_207 =
( V_107 -
F_32 ( struct V_129 , V_131 . V_206 . V_208 [ 0 ] ) )
/ sizeof( V_36 -> V_131 . V_206 . V_208 [ 0 ] ) ;
if ( ! V_36 -> V_131 . V_206 . V_104 || V_205 > V_207 ) {
if ( F_44 () )
F_45 ( V_5 , V_69 , V_5 -> V_70 ,
L_13 ,
V_2 -> V_71 ) ;
...
F_56 ( & V_5 -> V_209 ) ;
F_56 ( & V_2 -> V_95 ) ;
V_2 -> V_96 = V_36 -> V_131 . V_206 . V_104 ;
F_15 ( V_2 -> V_106 ) ;
V_2 -> V_106 = NULL ;
V_2 -> V_105 = 0 ;
if ( V_205 ) {
V_2 -> V_106 = F_80 ( V_205 , sizeof( T_7 ) ,
V_45 ) ;
if ( V_2 -> V_106 ) {
memcpy ( V_2 -> V_106 ,
V_36 -> V_131 . V_206 . V_208 ,
V_205 * sizeof( T_7 ) ) ;
V_2 -> V_105 = V_205 ;
}
}
...
static void F_82 ( struct V_210 * V_211 )
{
struct V_1 * V_2 = F_83 ( V_211 , struct V_1 , V_36 ) ;
struct V_6 * V_5 = V_2 -> V_5 ;
struct V_129 * V_36 = V_2 -> V_115 . V_72 ;
struct V_35 V_89 [ 2 ] ;
int V_17 ;
...
if ( V_36 -> V_214 < V_215 && V_216 [ V_36 -> V_214 ] != NULL ) {
V_17 = V_216 [ V_36 -> V_214 ] ( V_2 ) ;
if ( V_17 == 0 ) {
...
F_18 ( V_5 , V_69 , V_5 -> V_70 ,
L_16
L_17 , V_36 -> V_214 , V_2 -> V_71 ,
( unsigned long long ) V_2 -> V_212 ) ;
V_17 = V_217 ;
}
V_2 -> V_213 = false ;
F_84 () ;
...
V_89 [ 0 ] . V_49 = V_2 -> V_100 ;
V_89 [ 0 ] . V_51 = V_2 -> V_212 + F_32 ( struct V_129 , V_17 ) ;
V_89 [ 0 ] . V_55 = sizeof( V_36 -> V_17 ) ;
V_89 [ 1 ] . V_53 = & V_36 -> V_214 ;
V_89 [ 1 ] . V_49 = V_2 -> V_100 ;
V_89 [ 1 ] . V_51 = V_2 -> V_212 + F_32 ( struct V_129 , V_214 ) ;
V_89 [ 1 ] . V_55 = sizeof( V_36 -> V_214 ) ;
( void ) F_10 ( V_5 , V_89 , F_34 ( V_89 ) ) ;
}
static void F_85 ( struct V_1 * V_2 , struct V_219 * V_220 )
{
struct V_6 * V_5 = V_2 -> V_5 ;
struct V_35 V_221 [ 4 ] ;
T_6 V_94 ;
unsigned int V_92 , V_37 , V_222 , V_134 , V_133 ;
T_3 V_29 ;
T_9 V_223 ;
int V_17 ;
F_23 ( V_220 -> V_224 != V_107 ) ;
if ( ! V_2 -> V_147 )
return;
...
memcpy ( V_220 -> V_72 + V_92 , & V_94 , sizeof( V_94 ) ) ;
for ( V_92 = 0 ; V_92 < V_2 -> V_147 ; V_92 += V_37 ) {
V_37 = F_86 ( unsigned , V_2 -> V_147 - V_92 ,
F_34 ( V_221 ) ) ;
for ( V_222 = 0 ; V_222 < V_37 ; V_222 ++ ) {
V_221 [ V_222 ] . V_53 = NULL ;
V_221 [ V_222 ] . V_40 = V_5 -> V_102 -> V_103 ;
V_221 [ V_222 ] . V_54 = V_220 -> V_104 ;
V_221 [ V_222 ] . V_49 = V_2 -> V_100 ;
V_221 [ V_222 ] . V_51 = V_2 -> V_146 [ V_92 + V_222 ] ;
V_221 [ V_222 ] . V_55 = V_107 ;
}
V_17 = F_10 ( V_5 , V_221 , V_37 ) ;
if ( V_17 ) {
if ( F_44 () )
F_45 ( V_5 , V_69 , V_5 -> V_70 ,
L_18
...
F_47 ( V_5 , & V_29 , V_145 , V_133 ) ;
F_87 ( V_223 , V_226 , 0 ) ;
F_88 ( V_5 , & V_223 , V_227 , V_133 ) ;
F_57 ( & V_2 -> V_95 ) ;
}
static void F_89 ( struct V_210 * V_211 )
{
struct V_1 * V_2 = F_83 ( V_211 , struct V_1 , V_36 ) ;
struct V_6 * V_5 = V_2 -> V_5 ;
struct V_219 V_115 ;
if ( ! F_90 ( V_5 , & V_115 , V_107 ) ) {
F_85 ( V_2 , & V_115 ) ;
F_91 ( V_5 , & V_115 ) ;
}
}
...
static int F_93 ( struct V_229 * V_33 )
{
V_33 -> V_5 -> V_32 = V_33 ;
return 0 ;
}
static void
F_94 ( struct V_229 * V_33 , char * V_115 , T_2 V_224 )
{
snprintf ( V_115 , V_224 , L_22 , V_33 -> V_5 -> V_230 ) ;
}
void F_95 ( struct V_6 * V_5 )
{
unsigned V_37 ;
if ( ! V_231 )
return;
...
static void F_96 ( struct V_210 * V_235 )
{
struct V_6 * V_5 = F_83 ( V_235 , struct V_6 , V_86 ) ;
...
F_103 ( & V_91 -> V_248 , & V_5 -> V_244 ) ;
V_239 = (struct V_238 * ) V_91 -> V_223 ;
...
& V_241 , struct V_90 , V_248 ) ;
F_102 ( & V_91 -> V_248 ) ;
F_104 ( & V_5 -> V_102 -> V_247 , V_107 ,
V_91 -> V_223 , V_91 -> V_72 ) ;
F_15 ( V_91 ) ;
}
for ( V_92 = 0 ; V_92 < V_5 -> V_21 ; ++ V_92 ) {
V_2 = V_5 -> V_2 + V_92 ;
...
static void F_105 ( struct V_6 * V_5 )
{
struct V_236 * V_237 ;
struct V_90 * V_91 ;
while ( ! F_99 ( & V_5 -> V_249 ) ) {
V_237 = F_101 ( & V_5 -> V_249 ,
struct V_236 , V_248 ) ;
F_102 ( & V_237 -> V_248 ) ;
F_15 ( V_237 ) ;
}
while ( ! F_99 ( & V_5 -> V_244 ) ) {
V_91 = F_101 ( & V_5 -> V_244 ,
struct V_90 , V_248 ) ;
F_102 ( & V_91 -> V_248 ) ;
F_104 ( & V_5 -> V_102 -> V_247 , V_107 ,
V_91 -> V_223 , V_91 -> V_72 ) ;
...
static void F_110 ( struct V_6 * V_5 )
{
struct V_1 * V_2 ;
unsigned int V_92 ;
for ( V_92 = 0 ; V_92 < V_5 -> V_21 ; ++ V_92 ) {
...
static int F_111 ( struct V_6 * V_5 )
{
struct V_102 * V_102 = V_5 -> V_102 ;
unsigned V_3 , V_103 , V_251 , V_196 ;
T_5 V_114 , V_252 ;
struct V_1 * V_2 ;
int V_17 ;
V_251 = F_112 ( V_102 , V_253 ) ;
if ( ! V_251 )
return - V_254 ;
F_113 ( V_102 , V_251 + V_255 , & V_114 ) ;
F_113 ( V_102 , V_251 + V_256 , & V_252 ) ;
V_196 = V_5 -> V_257 ;
...
L_23 ,
F_114 ( V_102 -> V_258 ) , V_102 -> V_258 -> V_259 ,
F_115 ( V_103 ) , F_116 ( V_103 ) ) ;
V_17 = F_90 ( V_5 , & V_2 -> V_115 , V_107 ) ;
if ( V_17 )
goto V_260;
V_103 += V_252 ;
}
...
if ( V_17 )
goto V_263;
V_17 = F_90 ( V_5 , & V_5 -> V_87 , sizeof( * V_87 ) ) ;
if ( V_17 )
goto V_264;
V_87 = V_5 -> V_87 . V_72 ;
...
void F_123 ( struct V_229 * V_33 , T_6 * V_94 )
{
struct V_6 * V_5 = V_33 -> V_5 ;
struct V_1 * V_2 ;
unsigned V_274 , V_275 , type , V_235 ;
V_274 = F_124 ( * V_94 , V_276 ) ;
F_66 ( V_277 != 0 ) ;
V_275 = F_124 ( * V_94 , V_110 ) ;
type = F_124 ( * V_94 , V_112 ) ;
V_235 = F_124 ( * V_94 , V_278 ) ;
...
case V_282 :
case V_283 :
V_2 -> V_212 |= ( T_7 ) V_235 << ( V_2 -> V_280 << 4 ) ;
++ V_2 -> V_280 ;
return;
case V_284 :
V_2 -> V_212 |= ( T_7 ) V_235 << 48 ;
V_2 -> V_280 = V_279 ;
V_2 -> V_213 = true ;
F_29 ( V_85 , & V_2 -> V_36 ) ;
return;
...
return;
if ( V_287 ) {
F_132 ( V_274 , V_2 -> V_182 ) ;
F_133 ( & V_2 -> V_181 ) ;
} else {
F_129 ( V_274 , V_2 -> V_155 ) ;
-- V_2 -> V_156 ;
}
if ( F_60 ( V_2 ) )
F_130 ( & V_2 -> V_195 ) ;
}
void F_134 ( struct V_6 * V_5 , unsigned V_290 )
{
struct V_1 * V_2 ;
unsigned int V_291 ;
...
int F_141 ( struct V_261 * V_70 , int V_127 , T_1 * V_292 )
{
...
int F_143 ( struct V_261 * V_70 , int V_127 ,
T_5 V_66 , T_1 V_294 )
{
struct V_6 * V_5 = F_142 ( V_70 ) ;
struct V_1 * V_2 ;
...
int F_145 ( struct V_261 * V_70 , int V_127 ,
bool V_296 )
{
struct V_6 * V_5 = F_142 ( V_70 ) ;
struct V_1 * V_2 ;
