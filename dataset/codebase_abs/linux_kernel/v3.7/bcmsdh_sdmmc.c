...
if ( V_22 ) {
if ( V_28 == 4 )
F_18 ( V_2 -> V_12 [ V_12 ] , * V_27 , V_26 ,
& V_13 ) ;
else if ( V_28 == 2 )
F_19 ( V_2 -> V_12 [ V_12 ] , ( * V_27 & 0xFFFF ) ,
V_26 , & V_13 ) ;
else
F_8 ( ERROR , L_10 , V_28 ) ;
} else {
if ( V_28 == 4 )
* V_27 = F_20 ( V_2 -> V_12 [ V_12 ] , V_26 , & V_13 ) ;
else if ( V_28 == 2 )
* V_27 = F_21 ( V_2 -> V_12 [ V_12 ] , V_26 ,
& V_13 ) & 0xFFFF ;
else
F_8 ( ERROR , L_10 , V_28 ) ;
}
...
static int
F_22 ( struct V_1 * V_2 , T_2 V_31 , bool V_32 ,
T_2 V_12 , T_2 V_26 , struct V_33 * V_34 , T_2 V_35 )
{
int V_13 = 0 ;
if ( ( V_31 ) && ( ! V_32 ) ) {
V_13 = F_23 ( V_2 -> V_12 [ V_12 ] , V_26 ,
( ( T_3 * ) ( V_34 -> V_36 ) ) , V_35 ) ;
} else if ( V_31 ) {
V_13 = F_23 ( V_2 -> V_12 [ V_12 ] , V_26 ,
( ( T_3 * ) ( V_34 -> V_36 ) ) , V_35 ) ;
...
static int F_29 ( struct V_1 * V_2 , T_4 V_8 )
{
int V_48 , V_49 ;
T_4 V_50 , V_51 ;
T_5 V_52 ;
...
struct V_73 * V_74 ;
F_8 ( V_42 , L_12 ) ;
F_8 ( V_42 , L_29 , V_12 -> V_75 ) ;
F_8 ( V_42 , L_30 , V_12 -> V_76 ) ;
F_8 ( V_42 , L_31 , V_12 -> V_77 ) ;
F_8 ( V_42 , L_32 , V_12 -> V_20 ) ;
if ( V_12 -> V_20 == 1 ) {
...
struct V_1 * V_2 ;
F_8 ( V_42 , L_12 ) ;
F_8 ( V_23 , L_29 , V_12 -> V_75 ) ;
F_8 ( V_23 , L_30 , V_12 -> V_76 ) ;
F_8 ( V_23 , L_31 , V_12 -> V_77 ) ;
F_8 ( V_23 , L_32 , V_12 -> V_20 ) ;
if ( V_12 -> V_20 == 2 ) {
V_74 = F_44 ( & V_12 -> V_79 ) ;
V_2 = V_74 -> V_80 . V_81 ;
F_8 ( V_42 , L_35 ) ;
