...
if ( ! V_20 ) {
F_4 ( V_42 L_1 , V_2 -> V_12 ) ;
F_5 ( V_16 ) ;
return - V_43 ;
}
V_4 . V_9 . V_10 . V_22 . V_23 = V_20 ;
V_4 . V_9 . V_10 . V_22 . V_44 . V_45 = V_2 -> V_44 . V_45 ;
V_4 . V_9 . V_10 . V_22 . V_44 . V_46 = V_2 -> V_44 . V_46 ;
V_4 . V_9 . V_10 . V_22 . V_44 . V_47 = V_2 -> V_44 . V_47 ;
V_4 . V_9 . V_10 . V_22 . V_44 . V_48 =
V_2 -> V_44 . V_48 ;
...
continue;
F_4 ( L_3 ,
V_18 -> type , V_18 -> V_50 , ( V_51 ) V_18 -> V_39 ) ;
}
} else if ( V_21 != - V_43 )
F_7 ( V_42 L_4 ,
V_21 , V_2 -> V_12 ) ;
...
if ( ! F_11 ( V_2 , V_54 ) )
V_54 -> V_44 |= V_89 ;
if ( V_54 -> V_44 != ( V_89 | V_88 | V_87 | V_84 ) ) {
F_15 ( V_42 L_5 ,
V_2 -> V_12 , V_54 -> V_44 ) ;
V_21 = - V_90 ;
goto V_91;
...
F_4 ( L_7 ,
( V_19 == V_81 -> V_93 ? '*' : ' ' ) , V_19 ,
( V_51 ) V_81 -> V_26 [ V_19 ] . V_94 ,
( V_51 ) V_81 -> V_26 [ V_19 ] . V_22 ,
( V_51 ) V_81 -> V_26 [ V_19 ] . V_95 ) ;
}
} else if ( V_21 != - V_43 )
F_15 ( V_42 L_8 ,
V_21 , V_2 -> V_12 ) ;
...
static T_2 T_1
F_22 ( T_3 V_109 , V_51 V_110 , void * V_111 , void * * V_112 )
{
V_51 V_12 ;
T_2 V_113 ;
T_4 V_114 ;
...
static int T_1 F_28 ( struct V_1 * V_130 )
{
if ( ! V_130 )
return - V_90 ;
...
V_130 -> V_12 = V_19 ;
V_130 -> V_44 . V_22 = F_34 ( V_19 , V_129 ) ;
( void ) F_16 ( V_130 ) ;
}
}
F_5 ( V_128 ) ;
...
F_43 (i) {
struct V_92 * V_81 ;
V_81 = F_45 ( V_145 , V_19 ) ;
V_147 = F_52 ( V_81 , V_19 ) ;
if ( V_147 )
goto V_148;
}
V_147 = F_53 ( V_149 ) ;
...
continue;
if ( ! V_130 ) {
V_130 = F_55 ( sizeof( struct V_1 ) , V_24 ) ;
if ( V_130 )
