...
int V_3 ;
T_1 V_126 ;
F_67 (i, MAX_NUMNODES, &start_pfn, &end_pfn, NULL) {
V_85 = F_68 (unsigned long, start_pfn, MAX_DMA_PFN) ;
V_86 = F_68 (unsigned long, end_pfn, MAX_DMA_PFN) ;
V_124 += V_86 - V_85 ;
}
F_69 (u, MAX_NUMNODES, &start, &end, NULL) {
V_85 = F_68 (unsigned long, PFN_UP(start), MAX_DMA_PFN) ;
V_86 = F_68 (unsigned long, PFN_DOWN(end), MAX_DMA_PFN) ;
if ( V_85 < V_86 )
V_125 += V_86 - V_85 ;
}
F_70 ( V_124 - V_125 ) ;
