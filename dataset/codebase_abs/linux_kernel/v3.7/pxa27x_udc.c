...
static int F_119 ( struct V_220 * V_11 ,
int (* F_120)( struct V_203 * , struct V_220 * ) )
{
struct V_4 * V_5 = V_221 ;
int V_222 ;
if ( ! V_11 || V_11 -> V_223 < V_215 || ! F_120
...
F_98 ( V_5 , 1 ) ;
V_222 = F_121 ( & V_5 -> V_78 . V_90 ) ;
if ( V_222 ) {
F_19 ( V_5 -> V_90 , L_72 , V_222 ) ;
goto V_227;
}
V_222 = F_120 ( & V_5 -> V_78 , V_11 ) ;
if ( V_222 ) {
F_19 ( V_5 -> V_90 , L_73 ,
...
static void F_124 ( struct V_4 * V_5 , struct V_220 * V_11 )
{
int V_48 ;
...
static int F_125 ( struct V_220 * V_11 )
{
struct V_4 * V_5 = V_221 ;
if ( ! V_5 )
return - V_10 ;
...
V_11 -> V_11 . V_16 ) ;
if ( ! F_105 ( V_5 -> V_208 ) )
return F_122 ( V_5 -> V_208 -> V_229 , NULL ) ;
return 0 ;
}
...
F_128 ( V_235 . V_233 . V_241 ) , F_128 ( V_235 . V_233 . V_242 ) ,
F_128 ( V_235 . V_233 . V_243 ) ) ;
if ( F_59 ( V_236 ) )
goto V_238;
...
static void F_129 ( struct V_4 * V_5 , int V_245 , int V_246 )
{
T_1 V_247 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
static void F_130 ( struct V_4 * V_5 , int V_92 )
{
struct V_232 V_47 ;
...
static void F_131 ( struct V_4 * V_5 , int V_100 , int V_102 )
{
struct V_232 V_47 ;
...
static void F_132 ( int V_256 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
...
F_29 ( V_5 , V_36 , F_133 ( 0 , V_261 ) ) ;
F_129 ( V_5 , ! ! ( V_257 & V_262 ) ,
! ! ( V_257 & V_263 ) ) ;
}
V_257 >>= 2 ;
...
if ( ! ( V_257 & V_261 ) )
continue;
F_29 ( V_5 , V_36 , F_133 ( V_48 , V_261 ) ) ;
F_56 ( V_48 >= F_134 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_134 ( V_5 -> V_44 ) ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_39 . V_68 ++ ;
F_89 ( V_45 ) ;
}
...
F_29 ( V_5 , V_37 , F_133 ( V_48 - 16 , V_261 ) ) ;
if ( ! ( V_259 & V_261 ) )
continue;
F_56 ( V_48 >= F_134 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_134 ( V_5 -> V_44 ) ) {
...
static T_5 F_139 ( int V_256 , void * V_271 )
{
...
static int T_2 F_141 ( struct V_274 * V_275 )
{
struct V_276 * V_277 ;
struct V_4 * V_5 = & V_278 ;
int V_222 = 0 , V_279 ;
V_277 = F_142 ( V_275 , V_280 , 0 ) ;
if ( ! V_277 )
return - V_281 ;
V_5 -> V_256 = F_143 ( V_275 , 0 ) ;
if ( V_5 -> V_256 < 0 )
return V_5 -> V_256 ;
V_5 -> V_90 = & V_275 -> V_90 ;
V_5 -> V_196 = V_275 -> V_90 . V_282 ;
V_5 -> V_208 = F_144 ( V_283 ) ;
V_279 = V_5 -> V_196 -> V_197 ;
if ( F_99 ( V_279 ) ) {
V_222 = F_145 ( V_279 , L_90 ) ;
if ( V_222 == 0 )
F_146 ( V_279 ,
V_5 -> V_196 -> V_198 ) ;
}
...
V_5 -> V_212 = F_147 ( & V_275 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_212 ) ) {
V_222 = F_148 ( V_5 -> V_212 ) ;
goto V_284;
}
V_222 = - V_285 ;
V_5 -> V_277 = F_149 ( V_277 -> V_286 , F_150 ( V_277 ) ) ;
if ( ! V_5 -> V_277 ) {
F_19 ( & V_275 -> V_90 , L_92 ) ;
goto V_287;
}
F_151 ( & V_5 -> V_78 . V_90 ) ;
V_5 -> V_78 . V_90 . V_288 = & V_275 -> V_90 ;
V_5 -> V_78 . V_90 . V_289 = NULL ;
V_5 -> V_207 = 0 ;
V_221 = V_5 ;
F_152 ( V_275 , V_5 ) ;
F_114 ( V_5 ) ;
F_49 ( V_5 ) ;
V_222 = F_153 ( V_5 -> V_256 , F_139 ,
V_290 , V_14 , V_5 ) ;
if ( V_222 != 0 ) {
F_19 ( V_5 -> V_90 , L_93 ,
V_14 , V_5 -> V_256 , V_222 ) ;
goto V_291;
}
V_222 = F_154 ( & V_275 -> V_90 , & V_5 -> V_78 ) ;
if ( V_222 )
goto V_292;
F_14 ( V_5 ) ;
return 0 ;
...
static int T_6 F_158 ( struct V_274 * V_271 )
{
struct V_4 * V_5 = F_159 ( V_271 ) ;
...
static void F_164 ( struct V_274 * V_271 )
{
struct V_4 * V_5 = F_159 ( V_271 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_109 ( V_5 ) ;
}
static int F_165 ( struct V_274 * V_271 , T_7 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_159 ( V_271 ) ;
struct V_44 * V_45 ;
...
static int F_166 ( struct V_274 * V_271 )
{
int V_48 ;
struct V_4 * V_5 = F_159 ( V_271 ) ;
struct V_44 * V_45 ;
...
static int T_2 F_168 ( void )
{
if ( ! F_169 () && ! F_170 () )
return - V_10 ;
F_171 ( V_296 L_95 , V_14 , V_15 ) ;
return F_172 ( & V_297 , F_141 ) ;
}
