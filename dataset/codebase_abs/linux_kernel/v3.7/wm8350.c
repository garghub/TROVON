...
static int F_30 ( struct V_57 * V_135 , int V_136 )
{
...
V_10 = 0 ;
F_31 ( V_2 , V_138 , V_137 , V_10 ) ;
return 0 ;
}
static inline int F_32 ( struct V_139 * V_140 , unsigned int V_141 ,
unsigned int V_142 )
{
T_2 V_143 ;
...
static void F_43 ( struct V_3 * V_157 ,
struct V_214 * V_215 ,
T_1 V_216 )
{
struct V_6 * V_6 = V_157 -> V_6 ;
...
if ( F_50 ( V_6 -> V_164 ) )
F_51 ( V_6 -> V_164 , 250 ) ;
F_15 ( & V_157 -> V_221 . V_30 , 200 ) ;
return V_225 ;
}
int F_53 ( struct V_1 * V_2 , enum V_226 V_227 ,
struct V_228 * V_215 , int V_217 )
{
struct V_3 * V_157 = F_2 ( V_2 ) ;
struct V_6 * V_6 = V_157 -> V_6 ;
int V_223 ;
...
V_9 = F_3 ( V_6 , V_218 ) ;
if ( V_9 & V_238 )
V_217 |= V_157 -> V_239 . V_240 ;
if ( V_9 & V_241 )
V_217 |= V_157 -> V_239 . V_217 ;
F_44 ( V_157 -> V_239 . V_215 , V_217 ,
V_157 -> V_239 . V_217 | V_157 -> V_239 . V_240 ) ;
return V_225 ;
}
...
struct V_3 * V_157 = F_2 ( V_2 ) ;
struct V_6 * V_6 = V_157 -> V_6 ;
V_157 -> V_239 . V_215 = V_215 ;
V_157 -> V_239 . V_217 = V_242 ;
V_157 -> V_239 . V_240 = V_240 ;
if ( V_242 || V_240 ) {
F_5 ( V_6 , V_161 , V_236 ) ;
F_5 ( V_6 , V_180 ,
V_243 ) ;
...
F_60 ( V_2 , V_157 ) ;
V_157 -> V_6 = V_6 ;
for ( V_34 = 0 ; V_34 < F_39 ( V_246 ) ; V_34 ++ )
V_157 -> V_189 [ V_34 ] . V_247 = V_246 [ V_34 ] ;
V_55 = F_61 ( V_6 -> V_164 , F_39 ( V_157 -> V_189 ) ,
V_157 -> V_189 ) ;
if ( V_55 != 0 )
return V_55 ;
V_2 -> V_248 = V_6 -> V_249 ;
F_62 ( V_2 , 8 , 16 , V_250 ) ;
F_24 ( V_6 , V_251 , V_252 ) ;
F_63 ( & V_2 -> V_32 . V_33 , F_7 ) ;
F_63 ( & V_157 -> V_219 . V_30 , F_45 ) ;
F_63 ( & V_157 -> V_221 . V_30 , F_46 ) ;
F_5 ( V_6 , V_251 , V_252 ) ;
F_20 ( V_2 , V_253 , 0xa7 ) ;
F_20 ( V_2 , 0xde , 0x13 ) ;
F_20 ( V_2 , V_253 , 0 ) ;
...
F_24 ( V_6 , V_237 ,
V_232 | V_235 ) ;
F_24 ( V_6 , V_161 , V_236 ) ;
F_66 ( V_6 , V_263 , V_157 ) ;
F_66 ( V_6 , V_262 , V_157 ) ;
F_66 ( V_6 , V_231 , V_157 ) ;
F_66 ( V_6 , V_234 , V_157 ) ;
V_157 -> V_219 . V_215 = NULL ;
V_157 -> V_221 . V_215 = NULL ;
V_157 -> V_239 . V_215 = NULL ;
F_67 ( & V_157 -> V_219 . V_30 ) ;
F_67 ( & V_157 -> V_221 . V_30 ) ;
F_68 ( & V_2 -> V_32 . V_33 ) ;
F_37 ( V_2 , V_188 ) ;
F_24 ( V_6 , V_251 , V_252 ) ;
F_69 ( F_39 ( V_157 -> V_189 ) , V_157 -> V_189 ) ;
return 0 ;
}
static int T_4 F_70 ( struct V_264 * V_265 )
{
return F_71 ( & V_265 -> V_164 , & V_266 ,
& V_267 , 1 ) ;
}
static int T_5 F_72 ( struct V_264 * V_265 )
{
F_73 ( & V_265 -> V_164 ) ;
return 0 ;
}
