...
static int F_50 ( struct V_83 * V_9 )
{
int V_55 = 0 ;
struct V_1 * V_2 = NULL ;
if ( ! V_9 )
return - V_6 ;
V_2 = F_51 ( sizeof( struct V_1 ) , V_102 ) ;
if ( ! V_2 )
return - V_103 ;
V_2 -> V_9 = V_9 ;
strcpy ( V_2 -> V_44 , V_9 -> V_76 . V_104 ) ;
strcpy ( F_52 ( V_9 ) , V_105 ) ;
...
static int F_56 ( struct V_83 * V_9 , int type )
{
struct V_1 * V_2 = NULL ;
if ( ! V_9 || ! F_47 ( V_9 ) )
return - V_6 ;
...
static int F_58 ( struct V_9 * V_78 )
{
struct V_1 * V_2 ;
int V_25 , V_84 , V_111 , V_55 ;
if ( ! V_78 )
return - V_6 ;
V_2 = F_47 ( F_59 ( V_78 ) ) ;
if ( ! V_2 )
...
if ( ! V_2 -> V_27 . V_45 [ V_25 ] . V_29 . V_24 )
break;
V_2 -> V_27 . V_45 [ V_25 ] . V_29 . V_112 = 1 ;
for ( V_84 = 0 ; V_84 < V_2 -> V_27 . V_45 [ V_25 ] . V_23 . V_85 ; V_84 ++ ) {
V_55 = F_60 (
V_2 -> V_27 . V_45 [ V_25 ] . V_23 . V_86 [ V_84 ] ,
& V_111 ) ;
if ( V_55 || ( V_111 != V_113 ) ) {
V_2 -> V_27 . V_45 [ V_25 ] . V_29 . V_112 = 0 ;
break;
}
}
V_2 -> V_114 . V_45 |= V_2 -> V_27 . V_45 [ V_25 ] . V_29 . V_112 ;
}
F_15 ( V_2 ) ;
return V_4 ;
}
static int F_61 ( const struct V_115 * V_116 ) {
if ( V_46 == 0 ) {
F_10 ( V_117 L_36
L_37 , V_116 -> V_118 ) ;
V_46 = - 1 ;
...
static int F_62 ( const struct V_115 * V_116 ) {
F_10 ( V_117 L_36
L_38 , V_116 -> V_118 ) ;
V_79 = 1 ;
return 0 ;
}
static int F_63 ( const struct V_115 * V_116 ) {
if ( V_101 == 0 ) {
F_10 ( V_117 L_36
L_39 , V_116 -> V_118 ) ;
V_101 = 300 ;
