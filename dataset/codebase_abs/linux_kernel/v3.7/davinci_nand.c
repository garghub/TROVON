...
V_104 = F_43 ( V_102 -> V_110 , F_44 ( V_102 ) ) ;
V_4 = F_43 ( V_103 -> V_110 , F_44 ( V_103 ) ) ;
if ( ! V_104 || ! V_4 ) {
F_40 ( & V_84 -> V_85 , L_14 ) ;
V_105 = - V_67 ;
goto V_111;
...
V_2 -> V_134 = F_48 ( & V_84 -> V_85 , L_15 ) ;
if ( F_49 ( V_2 -> V_134 ) ) {
V_105 = F_50 ( V_2 -> V_134 ) ;
F_51 ( & V_84 -> V_85 , L_16 , V_105 ) ;
goto V_135;
}
V_105 = F_52 ( V_2 -> V_134 ) ;
if ( V_105 < 0 ) {
F_51 ( & V_84 -> V_85 , L_17 ,
V_105 ) ;
goto V_136;
...
F_3 ( V_2 , V_34 , V_46 ) ;
F_47 ( & V_33 ) ;
V_105 = F_54 ( & V_2 -> V_7 , V_88 -> V_26 ? 2 : 1 , NULL ) ;
if ( V_105 < 0 ) {
F_51 ( & V_84 -> V_85 , L_19 ) ;
goto V_142;
}
...
if ( V_105 < 0 )
goto V_142;
V_105 = F_57 ( & V_2 -> V_7 , NULL , NULL , V_88 -> V_154 ,
V_88 -> V_155 ) ;
if ( V_105 < 0 )
goto V_142;
V_46 = F_1 ( V_2 , V_156 ) ;
...
static int T_7 F_63 ( struct V_83 * V_84 )
{
struct V_1 * V_2 = F_64 ( V_84 ) ;
F_46 ( & V_33 ) ;
if ( V_2 -> V_24 . V_44 . V_30 == V_157 )
V_127 = false ;
F_47 ( & V_33 ) ;
F_61 ( V_2 -> V_4 ) ;
F_61 ( V_2 -> V_104 ) ;
