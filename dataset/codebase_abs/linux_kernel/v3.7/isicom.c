...
static int T_4 F_95 ( struct V_151 * V_152 ,
...
static int T_4 F_101 ( struct V_151 * V_152 ,
...
static int T_4 F_106 ( struct V_151 * V_152 ,
...
F_112 ( & V_108 -> V_37 [ V_109 ] . V_10 ,
V_182 , V_108 -> V_109 * 16 + V_109 ,
& V_152 -> V_157 ) ;
return 0 ;
V_181:
F_113 ( V_108 -> V_54 , V_108 ) ;
V_180:
F_114 ( V_152 , 3 ) ;
V_178:
V_108 -> V_1 = 0 ;
...
static void T_6 F_116 ( struct V_151 * V_152 )
{
struct V_4 * V_108 = F_96 ( V_152 ) ;
unsigned int V_183 ;
for ( V_183 = 0 ; V_183 < V_108 -> V_36 ; V_183 ++ )
F_117 ( V_182 , V_108 -> V_109 * 16 + V_183 ) ;
F_113 ( V_108 -> V_54 , V_108 ) ;
F_114 ( V_152 , 3 ) ;
V_108 -> V_1 = 0 ;
V_172 -- ;
...
V_182 -> V_193 = V_194 ;
V_182 -> V_195 = V_196 ;
V_182 -> V_195 . V_78 = V_197 | V_91 | V_198 | V_199 |
V_200 ;
V_182 -> V_8 = V_201 |
V_202 | V_203 ;
F_122 ( V_182 , & V_204 ) ;
