...
T_2 V_2 ;
int V_81 ;
if ( V_101 <= V_210 || V_101 - V_210 >= V_211 )
return 0 ;
F_9 ( V_69 -> V_12 , & V_1 , & V_2 ) ;
F_8 ( V_2 != 0 ) ;
V_81 = F_104 ( V_23 , V_69 , V_142 , V_1 , V_2 ) ;
...
int V_81 ;
F_92 ( V_23 ) ;
for ( V_212 = V_3 - 1 ; V_212 >= 0 ; V_212 -- ) {
if ( V_101 > ( V_212 + 1 ) * V_213 )
break;
V_197 . V_142 = V_25 -> V_58 [ V_212 ] ;
if ( ! V_197 . V_142 )
continue;
V_69 = F_52 ( V_23 , V_212 , 0 ) ;
if ( ! V_69 )
return - V_136 ;
V_81 = F_104 ( V_23 , V_69 , V_197 . V_142 , V_212 , 0 ) ;
if ( V_81 ) {
F_57 ( V_69 ) ;
return V_81 ;
}
...
{
return V_214 [ V_2 ] * V_213 ;
}
static inline T_1 F_176 ( T_2 V_2 )
{
return V_215 [ ( V_13 T_3 ) V_2 ] ;
}
...
if ( V_81 )
return V_81 ;
for ( V_212 = V_107 - 1 ; V_212 >= 0 ; V_212 -- ) {
V_217 = V_1 + V_212 * F_174 ( F_106 ( V_2 ) ) ;
V_218 = V_217 + F_174 ( F_106 ( V_2 ) ) ;
if ( V_101 > V_218 * V_213 )
break;
V_207 . V_142 = F_118 ( F_100 ( V_135 , V_212 ) ) ;
if ( ! V_207 . V_142 )
continue;
V_69 = F_52 ( V_23 , V_217 , F_106 ( V_2 ) ) ;
if ( ! V_69 )
return - V_136 ;
if ( ( V_13 T_3 ) V_2 > 1 )
...
int F_181 ( struct V_23 * V_23 , T_1 V_219 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
T_1 V_101 = F_28 ( V_23 ) ;
int V_81 = 0 ;
V_101 = F_30 ( V_101 , V_220 ) ;
while ( V_101 > V_219 ) {
if ( V_101 > V_220 )
V_101 -= V_220 ;
else
...
if ( ! V_81 )
V_81 = F_182 ( V_23 , V_219 ) ;
F_4 ( V_81 ) ;
return V_81 ;
}
static void F_183 ( struct V_23 * V_23 , struct V_69 * V_69 )
{
struct V_24 * V_25 = V_24 ( V_23 ) ;
struct V_95 * V_96 = V_95 ( V_69 ) ;
if ( ! V_96 )
...
static void F_185 ( struct V_69 * V_69 , struct V_23 * V_23 )
{
struct V_24 * V_25 = V_24 ( V_23 ) ;
...
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_71 * V_72 = V_71 ( V_63 ) ;
struct V_23 * V_221 = V_72 -> V_222 ;
struct V_69 * V_69 ;
struct V_21 * V_22 ;
T_1 V_105 = V_23 -> V_98 ;
if ( V_105 << V_63 -> V_67 > F_28 ( V_221 ) )
return - V_223 ;
if ( ! F_109 ( V_221 , V_105 ) )
return - V_223 ;
V_69 = F_187 ( V_221 -> V_75 , V_105 ,
( V_224 * ) V_225 , NULL ) ;
if ( F_126 ( V_69 ) )
return F_188 ( V_69 ) ;
V_22 = F_76 ( V_69 ) ;
...
static struct V_69 * F_189 ( struct V_23 * V_23 )
{
struct V_23 * V_221 = V_71 ( V_23 -> V_64 ) -> V_222 ;
struct V_21 * V_22 ;
struct V_69 * V_69 ;
F_8 ( V_23 -> V_98 == V_99 ) ;
V_69 = F_52 ( V_221 , V_23 -> V_98 , 0 ) ;
if ( ! V_69 )
return NULL ;
V_22 = F_76 ( V_69 ) ;
F_23 ( V_23 , V_22 ) ;
...
static int F_190 ( struct V_23 * V_23 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_23 * V_221 = V_71 ( V_63 ) -> V_222 ;
...
if ( ! V_69 )
return - V_136 ;
V_81 = F_65 ( V_221 , V_69 , 0 ) ;
if ( V_81 )
F_183 ( V_23 , V_69 ) ;
F_57 ( V_69 ) ;
return V_81 ;
}
static void F_192 ( struct V_62 * V_63 , T_8 V_185 ,
int V_226 ,
void (* F_193)( struct V_227 * , long ) ,
long V_228 )
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
struct V_23 * V_23 ;
...
T_4 V_230 ;
int V_194 ;
V_230 = V_185 >> ( V_63 -> V_67 - 3 ) ;
V_194 = V_185 & ( ( V_63 -> V_231 >> 3 ) - 1 ) ;
V_23 = V_72 -> V_232 ;
V_69 = F_52 ( V_23 , V_230 , 0 ) ;
F_8 ( ! V_69 ) ;
if ( ! F_161 ( V_69 ) )
F_107 ( V_23 , V_69 , V_233 ) ;
if ( V_226 )
F_97 ( V_23 , V_69 , 0 ) ;
V_229 = F_76 ( V_69 ) ;
F_193 ( V_229 + V_194 , V_228 ) ;
if ( V_226 ) {
F_151 ( V_63 , V_95 ( V_69 ) , V_194 ) ;
F_8 ( ( int ) F_17 ( V_229 [ V_194 ] . V_234 ) > V_72 -> V_235 ) ;
}
F_77 ( V_229 ) ;
F_57 ( V_69 ) ;
}
static void F_194 ( struct V_227 * V_229 , long V_236 )
{
struct V_227 * V_219 = ( void * ) V_236 ;
* V_219 = * V_229 ;
}
void F_195 ( struct V_62 * V_63 , T_8 V_185 ,
struct V_227 * V_229 )
{
F_192 ( V_63 , V_185 , 0 , F_194 , ( long ) V_229 ) ;
}
static void F_196 ( struct V_227 * V_229 , long V_139 )
{
T_8 V_234 ;
V_234 = F_17 ( V_229 -> V_234 ) ;
V_234 += V_139 ;
V_229 -> V_234 = F_25 ( V_234 ) ;
}
void F_197 ( struct V_62 * V_63 , T_1 V_142 , int V_139 )
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
T_8 V_185 = V_142 >> V_72 -> V_193 ;
if ( ! V_139 )
return;
F_192 ( V_63 , V_185 , 1 , F_196 , V_139 ) ;
}
static void F_198 ( struct V_227 * V_229 , long V_237 )
{
V_229 -> V_237 = F_25 ( V_237 ) ;
}
void F_199 ( struct V_62 * V_63 , T_8 V_185 , T_8 V_238 ,
T_7 V_144 )
{
T_8 V_237 = V_238 << 4 | ( V_13 T_3 ) V_144 ;
F_192 ( V_63 , V_185 , 1 , F_198 , V_237 ) ;
}
static void F_200 ( struct V_227 * V_229 , long V_239 )
{
V_229 -> V_234 = F_25 ( V_240 ) ;
}
void F_201 ( struct V_62 * V_63 , T_8 V_185 )
{
F_192 ( V_63 , V_185 , 1 , F_200 , 0 ) ;
}
static void F_202 ( struct V_227 * V_229 ,
long V_237 )
{
V_229 -> V_234 = 0 ;
V_229 -> V_237 = F_25 ( V_237 ) ;
}
void F_203 ( struct V_62 * V_63 , T_8 V_185 , T_8 V_238 )
{
T_8 V_237 = V_238 << 4 ;
F_192 ( V_63 , V_185 , 1 , F_202 ,
V_237 ) ;
}
...
F_185 ( V_69 , V_23 ) ;
F_37 ( V_63 , V_69 , 1 ) ;
V_89 = F_167 ( V_221 , V_69 ) ;
F_40 ( V_63 , V_69 , 1 ) ;
F_57 ( V_69 ) ;
return V_89 ;
}
void F_205 ( struct V_23 * V_23 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_24 * V_25 = V_24 ( V_23 ) ;
struct V_95 * V_96 = V_25 -> V_119 ;
...
F_206 ( & V_23 -> V_242 , 0 ) ;
F_207 ( V_23 ) ;
F_8 ( V_23 -> V_243 & V_244 && V_23 -> V_61 ) ;
if ( ! V_96 )
return;
if ( ( V_71 ( V_63 ) -> V_245 & V_246 ) ) {
V_96 -> V_113 -> V_189 ( V_23 -> V_64 , V_96 ) ;
return;
}
V_69 = F_189 ( V_23 ) ;
...
F_8 ( V_81 ) ;
F_8 ( F_86 ( V_69 ) || V_69 -> V_247 ) ;
F_57 ( V_69 ) ;
F_127 ( V_23 , V_145 ) ;
}
int F_209 ( struct V_23 * V_23 , const void * V_248 , T_10 V_249 ,
...
return - V_136 ;
V_250 = F_76 ( V_69 ) ;
memcpy ( V_250 , V_248 , V_249 ) ;
F_133 ( V_69 ) ;
F_77 ( V_250 ) ;
if ( F_28 ( V_23 ) < V_104 + V_213 )
F_191 ( V_23 , V_104 + V_213 ) ;
V_81 = F_65 ( V_23 , V_69 , V_198 ) ;
F_57 ( V_69 ) ;
return V_81 ;
}
...
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
int V_252 = 3 * V_72 -> V_253 ;
F_91 ( & V_72 -> V_195 ) ;
F_91 ( & V_72 -> V_161 ) ;
F_213 ( & V_72 -> V_74 ) ;
V_72 -> V_118 = F_214 ( V_252 ,
sizeof( struct V_95 ) ) ;
V_72 -> V_184 = F_214 ( V_252 ,
sizeof( struct V_181 ) ) ;
return 0 ;
}
