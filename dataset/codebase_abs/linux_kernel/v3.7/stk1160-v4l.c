...
return - V_61 ;
case V_103 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_104 , V_19 ) ;
return 0 ;
case V_105 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_104 , V_19 ) ;
return 0 ;
...
return - V_61 ;
case V_103 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_107 , V_19 ) ;
return 0 ;
case V_105 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_107 , V_19 ) ;
return 0 ;
...
static int F_42 ( struct V_78 * V_108 , const struct V_67 * V_109 ,
unsigned int * V_110 , unsigned int * V_111 ,
unsigned int V_112 [] , void * V_113 [] )
{
struct V_1 * V_2 = F_43 ( V_108 ) ;
unsigned long V_106 ;
V_106 = V_2 -> V_70 * V_2 -> V_71 * 2 ;
* V_110 = F_44 (unsigned int, *nbuffers,
...
{
unsigned long V_117 ;
struct V_1 * V_2 = F_43 ( V_116 -> V_78 ) ;
struct V_118 * V_119 =
F_46 ( V_116 , struct V_118 , V_116 ) ;
F_47 ( & V_2 -> V_120 , V_117 ) ;
if ( ! V_2 -> V_28 ) {
F_48 ( & V_119 -> V_116 , V_121 ) ;
} else {
V_119 -> V_122 = F_49 ( V_116 , 0 ) ;
V_119 -> V_123 = F_50 ( V_116 , 0 ) ;
V_119 -> V_124 = 0 ;
V_119 -> V_125 = 0 ;
if ( V_119 -> V_123 < V_2 -> V_70 * V_2 -> V_71 * 2 )
F_48 ( & V_119 -> V_116 , V_121 ) ;
else
F_51 ( & V_119 -> V_126 , & V_2 -> V_127 ) ;
}
F_52 ( & V_2 -> V_120 , V_117 ) ;
}
static int F_53 ( struct V_78 * V_108 , unsigned int V_128 )
{
struct V_1 * V_2 = F_43 ( V_108 ) ;
return F_7 ( V_2 ) ;
}
static int F_54 ( struct V_78 * V_108 )
{
struct V_1 * V_2 = F_43 ( V_108 ) ;
return F_17 ( V_2 ) ;
}
...
unsigned long V_117 ;
F_47 ( & V_2 -> V_120 , V_117 ) ;
while ( ! F_55 ( & V_2 -> V_127 ) ) {
V_119 = F_56 ( & V_2 -> V_127 ,
struct V_118 , V_126 ) ;
F_57 ( & V_119 -> V_126 ) ;
F_48 ( & V_119 -> V_116 , V_121 ) ;
F_5 ( L_14 ,
V_119 , V_119 -> V_116 . V_129 . V_60 ) ;
}
V_2 -> V_34 . V_119 = NULL ;
F_52 ( & V_2 -> V_120 , V_117 ) ;
}
...
V_79 = & V_2 -> V_80 ;
V_79 -> type = V_130 ;
V_79 -> V_131 = V_132 | V_133 | V_134 ;
V_79 -> V_135 = V_2 ;
V_79 -> V_136 = sizeof( struct V_118 ) ;
V_79 -> V_137 = & V_138 ;
V_79 -> V_139 = & V_140 ;
V_30 = F_59 ( V_79 ) ;
if ( V_30 < 0 )
...
int V_30 ;
V_2 -> V_91 = V_141 ;
V_2 -> V_91 . V_142 = V_143 ;
V_2 -> V_91 . V_144 = & V_2 -> V_80 ;
V_2 -> V_91 . V_145 = & V_2 -> V_32 ;
V_2 -> V_91 . V_144 -> V_145 = & V_2 -> V_146 ;
V_2 -> V_91 . V_40 = & V_2 -> V_40 ;
F_62 ( V_147 , & V_2 -> V_91 . V_117 ) ;
V_2 -> V_17 = V_148 ;
V_2 -> V_70 = 720 ;
V_2 -> V_71 = 480 ;
V_2 -> V_68 = & V_63 [ 0 ] ;
