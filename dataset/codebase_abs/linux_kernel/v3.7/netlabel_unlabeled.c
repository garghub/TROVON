...
void * V_69 )
{
struct V_45 * V_46 = V_69 ;
struct V_3 * V_4 = NULL ;
if ( ! F_55 ( F_56 ( V_46 ) , & V_70 ) )
return V_71 ;
if ( V_68 == V_72 ) {
F_17 ( & V_32 ) ;
V_4 = F_13 ( V_46 -> V_13 ) ;
...
T_1 V_42 ;
if ( V_78 -> V_80 [ V_81 ] ) {
V_42 = F_59 ( V_78 -> V_80 [ V_81 ] ) ;
if ( V_42 != sizeof( struct V_22 ) &&
V_42 != F_59 ( V_78 -> V_80 [ V_82 ] ) )
return - V_51 ;
* V_79 = V_42 ;
* V_23 = F_60 ( V_78 -> V_80 [ V_81 ] ) ;
* V_24 = F_60 ( V_78 -> V_80 [ V_82 ] ) ;
return 0 ;
} else if ( V_78 -> V_80 [ V_83 ] ) {
V_42 = F_59 ( V_78 -> V_80 [ V_83 ] ) ;
if ( V_42 != sizeof( struct V_34 ) &&
V_42 != F_59 ( V_78 -> V_80 [ V_84 ] ) )
return - V_51 ;
* V_79 = V_42 ;
* V_23 = F_60 ( V_78 -> V_80 [ V_83 ] ) ;
* V_24 = F_60 ( V_78 -> V_80 [ V_84 ] ) ;
return 0 ;
}
return - V_51 ;
}
static int F_61 ( struct V_85 * V_86 , struct V_77 * V_78 )
{
T_2 V_73 ;
struct V_43 V_44 ;
if ( V_78 -> V_80 [ V_87 ] ) {
V_73 = F_62 ( V_78 -> V_80 [ V_87 ] ) ;
if ( V_73 == 1 || V_73 == 0 ) {
F_63 ( V_86 , & V_44 ) ;
F_57 ( V_73 , & V_44 ) ;
return 0 ;
...
static int F_64 ( struct V_85 * V_86 , struct V_77 * V_78 )
{
int V_26 = - V_51 ;
struct V_85 * V_88 ;
void * V_89 ;
...
return - V_51 ;
F_63 ( V_86 , & V_44 ) ;
V_26 = F_58 ( V_78 , & V_23 , & V_24 , & V_42 ) ;
if ( V_26 != 0 )
return V_26 ;
V_41 = F_60 ( V_78 -> V_80 [ V_96 ] ) ;
V_26 = F_72 (
F_60 ( V_78 -> V_80 [ V_95 ] ) ,
F_59 ( V_78 -> V_80 [ V_95 ] ) ,
& V_25 ) ;
...
char * V_49 ;
T_1 V_50 ;
V_89 = F_77 ( V_100 -> V_86 , F_78 ( V_100 -> V_101 -> V_86 ) . V_102 ,
V_100 -> V_103 , & V_93 ,
V_104 , V_97 ) ;
if ( V_89 == NULL )
goto V_105;
...
goto V_105;
V_100 -> V_103 ++ ;
return F_68 ( V_100 -> V_86 , V_89 ) ;
V_105:
F_81 ( V_100 -> V_86 , V_89 ) ;
return V_26 ;
}
static int F_82 ( struct V_85 * V_86 ,
struct V_107 * V_108 )
{
struct V_99 V_100 ;
T_1 V_109 = V_108 -> args [ 0 ] ;
T_1 V_110 = V_108 -> args [ 1 ] ;
T_1 V_111 = V_108 -> args [ 2 ] ;
T_1 V_112 = V_108 -> args [ 3 ] ;
T_1 V_113 ;
T_1 V_114 = 0 , V_115 = 0 , V_116 = 0 ;
struct V_3 * V_4 ;
struct V_17 * V_117 ;
struct V_5 * V_55 ;
#if F_2 ( V_8 )
...
V_100 . V_101 = V_108 ;
V_100 . V_86 = V_86 ;
V_100 . V_103 = V_108 -> V_118 -> V_119 ;
F_27 () ;
for ( V_113 = V_109 ;
V_113 < F_29 ( V_14 ) -> V_15 ;
V_113 ++ , V_114 = 0 , V_115 = 0 , V_116 = 0 ) {
V_117 = & F_29 ( V_14 ) -> V_20 [ V_113 ] ;
...
struct V_99 V_100 ;
struct V_3 * V_4 ;
T_1 V_111 = V_108 -> args [ 0 ] ;
T_1 V_112 = V_108 -> args [ 1 ] ;
T_1 V_115 = 0 ;
struct V_5 * V_55 ;
#if F_2 ( V_8 )
T_1 V_116 = 0 ;
...
if ( V_15 == 0 )
return - V_51 ;
V_126 = F_88 ( sizeof( * V_126 ) , V_91 ) ;
if ( V_126 == NULL )
return - V_29 ;
V_126 -> V_15 = 1 << V_15 ;
V_126 -> V_20 = F_89 ( V_126 -> V_15 ,
sizeof( struct V_17 ) ,
V_91 ) ;
if ( V_126 -> V_20 == NULL ) {
F_6 ( V_126 ) ;
...
for ( V_19 = 0 ; V_19 < V_126 -> V_15 ; V_19 ++ )
F_23 ( & V_126 -> V_20 [ V_19 ] ) ;
F_17 ( & V_32 ) ;
F_25 ( V_14 , V_126 ) ;
F_19 ( & V_32 ) ;
F_90 ( & V_127 ) ;
...
struct V_5 * V_55 ;
V_135 = F_92 ( V_86 ) ;
V_55 = F_93 ( V_135 -> V_136 ,
& V_4 -> V_33 ) ;
if ( V_55 == NULL )
goto V_132;
V_130 -> V_137 . V_25 = F_7 ( V_55 ) -> V_25 ;
break;
}
#if F_2 ( V_8 )
case V_138 : {
...
struct V_9 * V_57 ;
V_140 = F_94 ( V_86 ) ;
V_57 = F_95 ( & V_140 -> V_136 ,
& V_4 -> V_37 ) ;
if ( V_57 == NULL )
goto V_132;
V_130 -> V_137 . V_25 = F_10 ( V_57 ) -> V_25 ;
break;
}
#endif
default:
