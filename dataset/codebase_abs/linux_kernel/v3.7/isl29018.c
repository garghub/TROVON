...
static bool F_28 ( struct V_44 * V_23 , unsigned int V_70 )
{
switch ( V_70 ) {
case V_25 :
case V_26 :
...
V_2 -> V_3 = 1000 ;
V_2 -> V_34 = 16 ;
V_2 -> V_8 = F_33 ( V_72 , & V_77 ) ;
if ( F_34 ( V_2 -> V_8 ) ) {
V_75 = F_35 ( V_2 -> V_8 ) ;
F_7 ( V_2 -> V_23 , L_18 , V_75 ) ;
goto exit;
}
V_75 = F_27 ( V_2 ) ;
if ( V_75 )
...
static int T_4 F_38 ( struct V_71 * V_72 )
{
struct V_48 * V_49 = F_39 ( V_72 ) ;
F_40 ( & V_72 -> V_23 , L_20 , V_88 ) ;
F_41 ( V_49 ) ;
F_37 ( V_49 ) ;
return 0 ;
}
