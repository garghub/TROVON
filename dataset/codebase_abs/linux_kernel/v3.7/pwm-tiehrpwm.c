...
F_8 ( V_18 , V_37 -> V_51 ) ;
F_5 ( V_18 -> V_35 , V_55 , V_75 , V_76 ) ;
return 0 ;
}
static void F_16 ( struct V_2 * V_3 , struct V_36 * V_37 )
{
struct V_1 * V_18 = F_1 ( V_3 ) ;
unsigned short V_65 , V_66 ;
if ( V_37 -> V_51 ) {
...
V_79 ) ;
F_5 ( V_18 -> V_35 , V_74 , V_66 , V_65 ) ;
F_5 ( V_18 -> V_35 , V_55 , V_75 , V_80 ) ;
F_13 ( V_3 -> V_52 ) ;
}
static void F_17 ( struct V_2 * V_3 , struct V_36 * V_37 )
{
struct V_1 * V_18 = F_1 ( V_3 ) ;
if ( F_18 ( V_81 , & V_37 -> V_82 ) ) {
F_19 ( V_3 -> V_52 , L_3 ) ;
F_13 ( V_3 -> V_52 ) ;
}
V_18 -> V_41 [ V_37 -> V_51 ] = 0 ;
}
static int T_1 F_20 ( struct V_83 * V_84 )
{
int V_85 ;
struct V_86 * V_87 ;
struct V_88 * V_88 ;
struct V_1 * V_18 ;
V_18 = F_21 ( & V_84 -> V_52 , sizeof( * V_18 ) , V_89 ) ;
if ( ! V_18 ) {
F_11 ( & V_84 -> V_52 , L_4 ) ;
return - V_90 ;
}
V_88 = F_22 ( & V_84 -> V_52 , L_5 ) ;
if ( F_23 ( V_88 ) ) {
F_11 ( & V_84 -> V_52 , L_6 ) ;
return F_24 ( V_88 ) ;
}
...
V_18 -> V_3 . V_4 = - 1 ;
V_18 -> V_3 . V_93 = V_50 ;
V_87 = F_26 ( V_84 , V_94 , 0 ) ;
if ( ! V_87 ) {
F_11 ( & V_84 -> V_52 , L_8 ) ;
return - V_95 ;
}
V_18 -> V_35 = F_27 ( & V_84 -> V_52 , V_87 ) ;
if ( ! V_18 -> V_35 )
return - V_96 ;
V_85 = F_28 ( & V_18 -> V_3 ) ;
if ( V_85 < 0 ) {
F_11 ( & V_84 -> V_52 , L_9 , V_85 ) ;
return V_85 ;
}
F_29 ( & V_84 -> V_52 ) ;
F_30 ( V_84 , V_18 ) ;
...
static int T_2 F_31 ( struct V_83 * V_84 )
{
struct V_1 * V_18 = F_32 ( V_84 ) ;
F_13 ( & V_84 -> V_52 ) ;
F_33 ( & V_84 -> V_52 ) ;
return F_34 ( & V_18 -> V_3 ) ;
}
