...
static int
F_49 ( const struct V_118 * V_119 , const char * V_120 , int V_121 )
{
struct V_10 * V_11 = (struct V_10 * ) V_119 -> V_70 ;
char * V_122 , * V_123 ;
char * V_124 ;
if ( V_121 ) {
V_11 -> V_80 = true ;
...
if ( ! V_120 )
return 0 ;
V_122 = strtok ( ( char * ) V_120 , L_32 ) ;
if ( ! V_122 )
return - 1 ;
if ( ! strncmp ( V_122 , L_33 , strlen ( V_120 ) ) )
V_81 . V_82 = V_125 ;
else if ( ! strncmp ( V_122 , L_34 , strlen ( V_120 ) ) )
V_81 . V_82 = V_126 ;
else if ( ! strncmp ( V_122 , L_35 , strlen ( V_120 ) ) )
V_81 . V_82 = V_127 ;
else if ( ! strncmp ( V_122 , L_36 , strlen ( V_120 ) ) ) {
V_81 . V_82 = V_83 ;
V_22 . V_23 = false ;
return 0 ;
}
...
goto V_128;
if ( V_123 [ 0 ] != 'c' ) {
V_81 . V_130 = strtoul ( V_123 , & V_124 , 0 ) ;
V_123 = strtok ( NULL , L_32 ) ;
if ( ! V_123 )
goto V_128;
}
if ( ! strcmp ( V_123 , L_37 ) )
V_81 . V_131 = V_132 ;
else if ( ! strcmp ( V_123 , L_38 ) )
V_81 . V_131 = V_133 ;
else
return - 1 ;
V_128:
...
static int
F_50 ( const struct V_118 * V_119 V_62 ,
const char * T_5 V_62 , int V_121 )
{
V_59 = ! V_121 ;
return 0 ;
}
int F_51 ( int V_134 , const char * * V_135 , const char * T_6 V_62 )
{
struct V_72 * V_74 ;
struct V_136 V_137 ;
bool V_138 = false ;
...
const struct V_118 V_160 [] = {
F_52 ( 'i' , L_43 , & V_141 . V_161 , L_44 ,
L_45 ) ,
F_53 ( 'v' , L_46 , & V_114 ,
L_47 ) ,
F_54 ( 'D' , L_48 , & V_115 ,
L_49 ) ,
F_52 ( 'k' , L_50 , & V_22 . V_162 ,
L_44 , L_51 ) ,
F_52 ( 0 , L_52 , & V_22 . V_163 ,
L_44 , L_53 ) ,
F_54 ( 'f' , L_54 , & V_141 . V_164 , L_55 ) ,
F_54 ( 'm' , L_56 , & V_22 . V_165 ,
L_57 ) ,
F_54 ( 'n' , L_58 , & V_22 . V_166 ,
L_59 ) ,
F_54 ( 'T' , L_60 , & V_141 . V_63 ,
L_61 ) ,
F_52 ( 0 , L_62 , & V_141 . V_100 , L_63 ,
L_64 ) ,
F_54 ( 0 , L_65 , & V_141 . V_167 , L_66 ) ,
F_54 ( 0 , L_67 , & V_141 . V_168 , L_68 ) ,
F_54 ( 0 , L_69 , & V_141 . V_169 ,
L_70 ) ,
F_52 ( 's' , L_71 , & V_95 , L_72 ,
L_73
L_74 ) ,
F_54 ( 0 , L_75 , & V_22 . V_170 ,
L_76 ) ,
F_52 ( 'p' , L_77 , & V_97 , L_78 ,
L_79 ) ,
F_54 ( 'x' , L_80 , & V_22 . V_171 ,
L_81 ) ,
F_55 ( 'g' , L_82 , & V_141 , L_83 ,
L_84
L_85 , & F_49 , V_139 ) ,
F_54 ( 'G' , L_86 , & V_141 . V_172 ,
L_87 ) ,
F_52 ( 'd' , L_88 , & V_22 . V_173 , L_89 ,
L_90 ) ,
F_52 ( 'c' , L_91 , & V_22 . V_174 , L_92 ,
L_93 ) ,
F_52 ( 'S' , L_94 , & V_22 . V_175 , L_95 ,
L_96 ) ,
F_52 ( 0 , L_97 , & V_141 . V_116 , L_98 ,
L_99 ) ,
F_52 ( 'w' , L_100 , & V_22 . V_176 ,
L_101 ,
L_102 ) ,
F_52 ( 't' , L_103 , & V_22 . V_177 , L_104 ,
L_105
L_106 ) ,
F_54 ( 'U' , L_107 , & V_141 . V_29 ,
L_108 ) ,
F_52 ( 0 , L_109 , & V_22 . V_178 , L_110 ,
L_111 ) ,
F_52 ( 'C' , L_112 , & V_141 . V_56 , L_112 ,
L_113 ) ,
F_54 ( 'I' , L_114 , & V_141 . V_106 ,
L_115 ) ,
F_54 ( 0 , L_116 , & V_22 . V_179 ,
L_117 ) ,
F_54 ( 0 , L_118 , & V_22 . V_180 ,
L_119 ) ,
F_52 ( 'M' , L_120 , & V_181 , L_121 ,
L_122 ) ,
F_54 ( 0 , L_123 , & V_22 . V_182 ,
L_124 ) ,
F_56 ( 'b' , L_125 , & V_59 , L_126 ,
L_127 , F_50 ) ,
F_52 ( 0 , L_128 , & V_183 , L_129 ,
L_130 ) ,
F_57 ()
} ;
V_134 = F_58 ( V_134 , V_135 , V_160 , V_140 , 0 ) ;
if ( V_141 . V_169 )
V_36 = 0 ;
else if ( V_141 . V_167 )
V_36 = 1 ;
...
if ( V_141 . V_172 )
V_81 . V_131 = V_132 ;
if ( ! V_141 . V_161 || ! strlen ( V_141 . V_161 ) ) {
if ( ! F_59 ( V_184 , & V_137 ) && F_60 ( V_137 . V_185 ) )
V_141 . V_161 = L_131 ;
else
V_141 . V_161 = L_132 ;
}
V_74 = F_61 ( V_141 . V_161 , V_186 ,
V_141 . V_164 , false , & V_141 . V_2 ) ;
if ( V_74 == NULL )
return - V_27 ;
V_141 . V_74 = V_74 ;
V_138 = F_62 ( & V_74 -> V_54 ,
V_187 ) ;
if ( V_59 == - 1 && V_138 )
V_59 = 1 ;
if ( V_59 == 1 ) {
...
F_65 ( V_140 , V_160 ) ;
if ( V_36 == 1 && V_37 ) {
V_22 . V_188 = sizeof( struct V_34 ) ;
V_141 . V_52 = V_189 ;
if ( V_114 ) {
V_22 . V_188 += sizeof( V_190 ) ;
V_22 . V_191 = true ;
}
}
if ( F_66 () < 0 )
...
F_69 ( & V_194 , V_22 . V_195 , L_135 , stdout ) ;
if ( V_59 == 1 ) {
F_69 ( & V_196 , V_22 . V_197 , L_136 , stdout ) ;
F_69 ( & V_198 , V_22 . V_199 , L_137 , stdout ) ;
F_69 ( & V_200 , V_22 . V_201 , L_138 , stdout ) ;
F_69 ( & V_202 , V_22 . V_203 , L_139 , stdout ) ;
} else {
F_69 ( & V_204 , V_22 . V_205 , L_140 , stdout ) ;
F_69 ( & V_206 , V_22 . V_207 , L_141 , stdout ) ;
}
V_88 = F_34 ( & V_141 ) ;
error:
F_70 ( V_74 ) ;
