...
static void
F_53 ( const char * V_29 , unsigned V_26 )
{
unsigned V_21 = 0 ;
while ( F_11 () & V_20 )
continue;
...
static void
F_54 ( struct V_53 * V_54 , const char * V_29 , unsigned V_26 )
{
if ( V_27 == NULL )
F_53 ( V_29 , V_26 ) ;
else
...
static struct V_55 *
F_55 ( struct V_53 * V_54 , int * V_56 )
{
* V_56 = V_54 -> V_56 ;
return V_41 ;
}
...
static void T_3
F_58 ( struct V_53 * V_54 , const char * V_29 , unsigned int V_26 )
{
F_53 ( V_29 , V_26 ) ;
}
struct V_53 * T_3
F_59 ( unsigned int V_11 , unsigned int V_58 )
{
return & V_59 ;
}
