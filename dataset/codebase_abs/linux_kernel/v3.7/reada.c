...
V_13 -> V_24 = 1 ;
V_72 = V_71 ;
V_46 = F_40 ( V_68 , V_74 , V_49 , & V_72 , & V_51 , 0 ) ;
if ( V_46 || ! V_51 || V_72 < V_71 )
goto error;
if ( V_51 -> V_61 > V_75 ) {
F_14 ( V_76 L_3
L_4 , V_75 ) ;
...
for ( V_73 = 0 ; V_73 < V_51 -> V_61 ; ++ V_73 ) {
struct V_47 * V_52 ;
V_48 = V_51 -> V_63 [ V_73 ] . V_48 ;
...
F_42 ( & V_15 -> V_23 , V_18 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_73 ; ++ V_9 ) {
struct V_47 * V_52 = V_13 -> V_77 [ V_9 ] ;
F_42 ( & V_52 -> V_60 -> V_78 , V_18 ) ;
}
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_73 ; ++ V_9 ) {
struct V_47 * V_52 = V_13 -> V_77 [ V_9 ] ;
...
static void V_57 ( struct V_79 * V_79 )
{
struct V_47 * V_52 = F_43 ( V_79 , struct V_47 , V_24 ) ;
F_42 ( & V_52 -> V_60 -> V_56 ,
V_52 -> V_55 >> V_19 ) ;
F_20 ( V_52 ) ;
}
...
{
struct V_35 * V_36 = F_43 ( V_79 , struct V_35 ,
V_24 ) ;
F_20 ( V_36 ) ;
}
...
F_44 ( & V_36 -> V_42 ) ;
F_3 ( & V_13 -> V_25 ) ;
F_45 ( & V_29 -> V_17 , & V_13 -> V_26 ) ;
F_5 ( & V_13 -> V_25 ) ;
return 0 ;
}
static void F_46 ( struct V_47 * V_52 , int V_25 )
{
int V_9 ;
unsigned long V_18 = V_52 -> V_55 >> V_19 ;
for ( V_9 = 0 ; V_9 < V_52 -> V_64 ; ++ V_9 ) {
struct V_47 * V_80 ;
V_80 = F_4 ( & V_52 -> V_62 [ V_9 ] -> V_56 , V_18 ) ;
if ( V_80 && V_80 -> V_60 != V_52 -> V_60 )
V_80 -> V_59 = V_25 ;
}
}
static int F_47 ( struct V_20 * V_48 )
{
...
V_48 -> V_86 >> V_19 , 1 ) ;
if ( V_46 == 0 || V_13 -> V_49 >= V_48 -> V_85 -> V_55 ) {
V_46 = F_47 ( V_48 ) ;
if ( ! V_46 ) {
F_5 ( & V_15 -> V_22 ) ;
return 0 ;
...
V_48 -> V_86 = V_13 -> V_49 + V_13 -> V_71 ;
V_13 -> V_24 ++ ;
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_73 ; ++ V_9 ) {
if ( V_13 -> V_77 [ V_9 ] -> V_60 == V_48 ) {
V_87 = V_9 + 1 ;
break;
}
}
...
return 0 ;
F_44 ( & V_48 -> V_45 ) ;
V_46 = F_49 ( V_15 -> V_89 , V_49 , V_71 ,
V_87 , & V_4 ) ;
if ( V_46 )
F_1 ( V_15 -> V_89 , NULL , V_49 , V_46 ) ;
else if ( V_4 )
F_1 ( V_15 -> V_89 , V_4 , V_4 -> V_5 , V_46 ) ;
if ( V_4 )
F_50 ( V_4 ) ;
return 1 ;
}
...
struct V_14 * V_15 ;
int V_94 ;
V_93 = F_43 ( V_91 , struct V_92 , V_91 ) ;
V_15 = V_93 -> V_15 ;
F_20 ( V_93 ) ;
V_94 = F_52 ( F_53 ( V_95 ) ,
F_54 ( V_95 ) ) ;
...
{
struct V_92 * V_93 ;
V_93 = F_33 ( sizeof( * V_93 ) , V_58 ) ;
if ( ! V_93 ) {
F_58 () ;
}
V_93 -> V_91 . V_102 = F_51 ;
V_93 -> V_15 = V_15 ;
F_59 ( & V_15 -> V_103 , & V_93 -> V_91 ) ;
}
static void F_60 ( struct V_14 * V_15 , int V_104 )
{
struct V_20 * V_60 ;
struct V_97 * V_98 = V_15 -> V_98 ;
unsigned long V_18 ;
...
V_52 -> V_59 ) ;
for ( V_105 = 0 ; V_105 < V_52 -> V_64 ; ++ V_105 ) {
F_14 ( V_108 L_8 ,
V_52 -> V_62 [ V_105 ] -> V_107 ) ;
}
if ( V_60 -> V_85 == V_52 )
F_14 ( V_108 L_9 ,
V_60 -> V_86 - V_52 -> V_5 ) ;
...
V_13 -> V_77 [ V_9 ] -> V_5 ,
V_13 -> V_77 [ V_9 ] -> V_55 ) ;
for ( V_105 = 0 ; V_105 < V_13 -> V_77 [ V_9 ] -> V_64 ; ++ V_105 ) {
F_14 ( V_108 L_8 ,
V_13 -> V_77 [ V_9 ] -> V_62 [ V_105 ] -> V_107 ) ;
}
}
F_14 ( V_108 L_10 ) ;
...
F_14 ( V_37
L_13 ,
V_13 -> V_49 , V_13 -> V_71 , F_17 ( & V_13 -> V_26 ) ,
...
struct V_35 * F_61 ( struct V_1 * V_2 ,
...
while ( F_57 ( & V_36 -> V_42 ) ) {
F_67 ( V_36 -> V_44 , F_57 ( & V_36 -> V_42 ) == 0 ,
5 * V_114 ) ;
F_60 ( V_36 -> V_2 -> V_15 , V_36 -> V_42 < 10 ? 1 : 0 ) ;
}
F_60 ( V_36 -> V_2 -> V_15 , V_36 -> V_42 < 10 ? 1 : 0 ) ;
F_23 ( & V_36 -> V_24 , V_43 ) ;
return 0 ;
...
struct V_35 * V_36 = V_113 ;
while ( F_57 ( & V_36 -> V_42 ) ) {
F_68 ( V_36 -> V_44 , F_57 ( & V_36 -> V_42 ) == 0 ) ;
}
F_23 ( & V_36 -> V_24 , V_43 ) ;
return 0 ;
}
void F_69 ( void * V_113 )
{
struct V_35 * V_36 = V_113 ;
F_23 ( & V_36 -> V_24 , V_43 ) ;
}
