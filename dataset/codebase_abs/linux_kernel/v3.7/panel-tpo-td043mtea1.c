...
V_37 = F_55 ( V_2 ) ;
if ( V_37 < 0 ) {
F_40 ( & V_2 -> V_14 , L_18 , V_37 ) ;
return V_37 ;
}
V_28 = F_56 ( sizeof( * V_28 ) , V_77 ) ;
if ( V_28 == NULL )
return - V_78 ;
V_28 -> V_2 = V_2 ;
V_28 -> V_42 = V_25 -> V_62 ;
...
static int T_5 F_59 ( struct V_1 * V_2 )
{
...
static int F_62 ( struct V_31 * V_14 )
{
struct V_27 * V_28 = F_9 ( V_14 ) ;
int V_37 ;
F_35 ( V_14 , L_20 ) ;
