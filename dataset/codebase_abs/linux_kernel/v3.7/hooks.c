...
static int F_136 ( const void * V_127 , struct V_36 * V_36 , unsigned V_394 )
{
return F_105 ( V_127 , V_36 , F_113 ( V_36 ) ) ? V_394 + 1 : 0 ;
}
static inline void F_137 ( const struct V_7 * V_7 ,
struct V_395 * V_396 )
{
...
if ( V_400 )
F_141 () ;
V_401 = F_142 ( V_396 , 0 , F_136 , V_7 ) ;
if ( ! V_401 )
return;
V_397 = F_143 ( & V_406 , V_407 , V_7 ) ;
if ( F_75 ( V_397 ) )
V_397 = NULL ;
do {
F_144 ( V_401 - 1 , V_397 , 0 ) ;
} while ( ( V_401 = F_142 ( V_396 , V_401 , F_136 , V_7 ) ) != 0 );
if ( V_397 )
F_145 ( V_397 ) ;
}
static void F_146 ( struct V_367 * V_368 )
{
struct V_10 * V_370 ;
...
V_409 -> V_415 = F_148 ( V_409 -> V_416 , V_410 -> V_415 ) ;
}
F_149 ( V_8 ) ;
F_150 ( V_8 , V_408 ( V_417 ) ) ;
}
}
...
F_152 ( V_82 , & V_419 , NULL ) ;
F_153 ( & V_8 -> V_421 -> V_422 ) ;
if ( ! ( V_8 -> signal -> V_69 & V_423 ) ) {
F_154 ( V_8 ) ;
F_155 ( V_8 , 1 ) ;
F_156 ( & V_8 -> V_424 ) ;
}
F_157 ( & V_8 -> V_421 -> V_422 ) ;
}
F_158 ( & V_425 ) ;
F_159 ( V_8 , V_8 -> V_426 ) ;
F_160 ( & V_425 ) ;
}
static int F_161 ( struct V_41 * V_42 )
{
return F_29 ( V_42 ) ;
}
...
static inline int F_163 ( char * V_144 , int V_427 , char * V_428 , int V_429 )
{
if ( V_427 > V_429 )
return 0 ;
return ! memcmp ( V_144 , V_428 , V_427 ) ;
}
static inline int F_164 ( char * V_428 , int V_84 )
{
return ( F_163 ( V_146 , sizeof( V_146 ) - 1 , V_428 , V_84 ) ||
F_163 ( V_147 , sizeof( V_147 ) - 1 , V_428 , V_84 ) ||
F_163 ( V_149 , sizeof( V_149 ) - 1 , V_428 , V_84 ) ||
F_163 ( V_148 , sizeof( V_148 ) - 1 , V_428 , V_84 ) ||
F_163 ( V_150 , sizeof( V_150 ) - 1 , V_428 , V_84 ) ) ;
}
static inline void F_165 ( char * * V_430 , char * V_431 , int * V_432 , int V_84 )
{
if ( ! * V_432 ) {
* * V_430 = ',' ;
* V_430 += 1 ;
...
static inline void F_166 ( char * * V_430 , char * V_431 , int * V_432 ,
int V_84 )
{
int V_433 = 0 ;
if ( ! * V_432 ) {
...
static int F_167 ( char * V_434 , char * V_435 )
{
...
if ( F_164 ( V_438 , V_84 ) )
F_166 ( & V_440 , V_438 , & V_38 , V_84 ) ;
else
F_165 ( & V_442 , V_438 , & V_436 , V_84 ) ;
V_438 = V_439 + 1 ;
}
} while ( * V_439 ++ );
strcpy ( V_437 , V_441 ) ;
...
static int F_169 ( struct V_41 * V_42 , void * V_141 )
{
int V_47 , V_82 , * V_69 ;
struct V_80 V_81 ;
char * V_444 , * * V_107 ;
...
static int F_172 ( struct V_41 * V_42 , int V_69 , void * V_141 )
{
const struct V_7 * V_7 = F_52 () ;
struct V_251 V_252 ;
int V_47 ;
...
return F_111 ( V_7 , V_42 , V_449 , & V_252 ) ;
}
static int F_173 ( struct V_52 * V_52 )
{
const struct V_7 * V_7 = F_52 () ;
struct V_251 V_252 ;
V_252 . type = V_264 ;
V_252 . V_257 . V_52 = V_52 -> V_450 -> V_54 ;
return F_111 ( V_7 , V_52 -> V_450 , V_451 , & V_252 ) ;
}
static int F_174 ( const char * V_452 ,
struct V_215 * V_215 ,
const char * type ,
unsigned long V_69 ,
void * V_141 )
...
const struct V_7 * V_7 = F_52 () ;
if ( V_69 & V_453 )
return F_111 ( V_7 , V_215 -> V_52 -> V_450 ,
V_454 , NULL ) ;
else
return F_104 ( V_7 , V_215 , V_455 ) ;
}
static int F_175 ( struct V_456 * V_378 , int V_69 )
{
const struct V_7 * V_7 = F_52 () ;
return F_111 ( V_7 , V_378 -> V_457 ,
V_458 , NULL ) ;
}
...
static void F_177 ( struct V_19 * V_19 )
{
F_20 ( V_19 ) ;
}
static int F_178 ( struct V_19 * V_19 , struct V_19 * V_269 ,
...
return - V_65 ;
if ( V_64 ) {
V_462 = F_179 ( V_463 , V_23 ) ;
if ( ! V_462 )
return - V_24 ;
* V_64 = V_462 ;
}
if ( V_460 && V_84 ) {
V_47 = F_180 ( V_271 , & V_83 , & V_461 ) ;
if ( V_47 ) {
F_28 ( V_462 ) ;
return V_47 ;
}
...
static int F_181 ( struct V_19 * V_269 , struct V_52 * V_52 , T_5 V_151 )
{
return F_106 ( V_269 , V_52 , V_29 ) ;
}
static int F_182 ( struct V_52 * V_290 , struct V_19 * V_269 , struct V_52 * V_292 )
{
return F_108 ( V_269 , V_290 , V_283 ) ;
}
static int F_183 ( struct V_19 * V_269 , struct V_52 * V_52 )
{
return F_108 ( V_269 , V_52 , V_285 ) ;
}
static int F_184 ( struct V_19 * V_269 , struct V_52 * V_52 , const char * V_64 )
{
return F_106 ( V_269 , V_52 , V_156 ) ;
}
static int F_185 ( struct V_19 * V_269 , struct V_52 * V_52 , T_5 V_301 )
{
return F_106 ( V_269 , V_52 , V_161 ) ;
}
static int F_186 ( struct V_19 * V_269 , struct V_52 * V_52 )
{
return F_108 ( V_269 , V_52 , V_287 ) ;
}
static int F_187 ( struct V_19 * V_269 , struct V_52 * V_52 , T_5 V_151 , T_8 V_221 )
{
return F_106 ( V_269 , V_52 , F_68 ( V_151 ) ) ;
}
static int F_188 ( struct V_19 * V_464 , struct V_52 * V_290 ,
struct V_19 * V_465 , struct V_52 * V_292 )
{
return F_109 ( V_464 , V_290 , V_465 , V_292 ) ;
}
...
static int F_190 ( struct V_52 * V_52 , struct V_466 * V_466 )
{
const struct V_7 * V_7 = F_52 () ;
return F_103 ( V_7 , V_52 , V_305 ) ;
}
static T_9 int F_191 ( struct V_19 * V_19 ,
...
V_47 = F_192 ( F_14 () , V_21 -> V_14 , V_21 -> V_28 , V_238 ,
V_467 , V_468 , & V_252 , V_69 ) ;
if ( V_47 )
return V_47 ;
return 0 ;
}
static int F_193 ( struct V_19 * V_19 , int V_301 )
{
const struct V_7 * V_7 = F_52 () ;
T_2 V_238 ;
bool V_470 ;
...
V_467 = F_194 ( V_238 , & V_254 , V_47 ,
V_470 ? V_473 : 0 ,
& V_468 ) ;
if ( F_133 ( ! V_467 ) )
return V_47 ;
V_261 = F_191 ( V_19 , V_238 , V_467 , V_468 , V_69 ) ;
if ( V_261 )
return V_261 ;
return V_47 ;
}
...
static int F_196 ( struct V_456 * V_378 , struct V_52 * V_52 )
{
const struct V_7 * V_7 = F_52 () ;
struct V_215 V_215 ;
V_215 . V_52 = V_52 ;
...
static int F_197 ( struct V_52 * V_52 , const char * V_64 )
{
const struct V_7 * V_7 = F_52 () ;
...
V_495 = F_201 ( V_8 -> V_497 , V_91 , V_498 ) ;
F_202 ( V_495 , L_37 ) ;
F_203 ( V_495 , V_460 , V_496 ) ;
F_204 ( V_495 ) ;
return V_47 ;
}
V_47 = F_205 ( V_460 , V_491 , & V_271 ) ;
}
if ( V_47 )
return V_47 ;
...
if ( V_47 )
return V_47 ;
V_47 = F_206 ( V_21 -> V_14 , V_271 , V_14 ,
V_21 -> V_28 ) ;
if ( V_47 )
return V_47 ;
return F_35 ( V_271 ,
...
static int F_211 ( const struct V_19 * V_19 , const char * V_64 , void * * V_214 , bool V_501 )
{
T_2 V_491 ;
int error ;
char * V_83 = NULL ;
...
return - V_65 ;
error = F_123 ( F_52 () , & V_364 , V_493 ,
V_366 ) ;
if ( ! error )
error = F_180 ( V_21 -> V_14 , & V_83 ,
& V_491 ) ;
else
...
static int F_213 ( struct V_19 * V_19 , char * V_214 , T_7 V_503 )
{
...
static void F_214 ( const struct V_19 * V_19 , T_2 * V_504 )
{
struct V_20 * V_21 = V_19 -> V_30 ;
* V_504 = V_21 -> V_14 ;
}
static int F_215 ( struct V_36 * V_36 , int V_301 )
{
const struct V_7 * V_7 = F_52 () ;
struct V_19 * V_19 = V_36 -> V_266 . V_52 -> V_56 ;
...
static int F_220 ( struct V_36 * V_36 , unsigned int V_507 ,
unsigned long V_508 )
{
const struct V_7 * V_7 = F_52 () ;
int error = 0 ;
...
static int F_221 ( struct V_36 * V_36 , unsigned long V_521 , int V_522 )
{
const struct V_7 * V_7 = F_52 () ;
int V_47 = 0 ;
if ( V_523 &&
...
static int F_222 ( unsigned long V_527 )
{
int V_47 = 0 ;
T_2 V_14 = F_14 () ;
if ( V_527 < V_528 ) {
...
static int F_224 ( struct V_36 * V_36 , unsigned long V_531 ,
unsigned long V_521 , unsigned long V_69 )
{
if ( V_532 )
V_521 = V_531 ;
return F_221 ( V_36 , V_521 ,
( V_69 & V_533 ) == V_534 ) ;
}
static int F_225 ( struct V_535 * V_536 ,
unsigned long V_531 ,
unsigned long V_521 )
{
const struct V_7 * V_7 = F_52 () ;
...
return F_221 ( V_536 -> V_545 , V_521 , V_536 -> V_537 & V_550 ) ;
}
static int F_226 ( struct V_36 * V_36 , unsigned int V_507 )
{
const struct V_7 * V_7 = F_52 () ;
...
static int F_228 ( struct V_36 * V_36 )
{
struct V_37 * V_38 ;
V_38 = V_36 -> V_40 ;
V_38 -> V_39 = F_14 () ;
...
static int F_229 ( struct V_17 * V_248 ,
...
T_2 V_228 ;
struct V_37 * V_38 ;
V_36 = F_230 ( V_568 , struct V_36 , V_570 ) ;
V_38 = V_36 -> V_40 ;
if ( ! V_569 )
V_228 = F_89 ( V_571 ) ;
else
...
static int F_231 ( struct V_36 * V_36 )
{
const struct V_7 * V_7 = F_52 () ;
return F_105 ( V_7 , V_36 , F_113 ( V_36 ) ) ;
}
static int F_232 ( struct V_36 * V_36 , const struct V_7 * V_7 )
{
struct V_37 * V_38 ;
struct V_20 * V_21 ;
V_38 = V_36 -> V_40 ;
...
static int F_233 ( unsigned long V_572 )
{
return F_92 ( V_8 , V_573 ) ;
}
static int F_234 ( struct V_7 * V_7 , T_11 V_574 )
{
struct V_10 * V_11 ;
...
static void F_235 ( struct V_7 * V_7 )
{
...
static int F_236 ( struct V_7 * V_329 , const struct V_7 * V_330 ,
T_11 V_574 )
{
const struct V_10 * V_369 ;
struct V_10 * V_11 ;
V_369 = V_330 -> V_16 ;
V_11 = F_237 ( V_369 , sizeof( struct V_10 ) , V_574 ) ;
if ( ! V_11 )
return - V_24 ;
V_329 -> V_16 = V_11 ;
return 0 ;
}
static void F_238 ( struct V_7 * V_329 , const struct V_7 * V_330 )
{
const struct V_10 * V_369 = V_330 -> V_16 ;
struct V_10 * V_11 = V_329 -> V_16 ;
* V_11 = * V_369 ;
}
static int F_239 ( struct V_7 * V_329 , T_2 V_504 )
{
struct V_10 * V_11 = V_329 -> V_16 ;
T_2 V_14 = F_14 () ;
int V_575 ;
...
static int F_240 ( struct V_7 * V_329 , struct V_19 * V_19 )
{
struct V_20 * V_21 = V_19 -> V_30 ;
struct V_10 * V_11 = V_329 -> V_16 ;
T_2 V_14 = F_14 () ;
...
static int F_242 ( struct V_17 * V_127 , T_12 V_582 )
{
...
static void F_245 ( struct V_17 * V_127 , T_2 * V_504 )
{
* V_504 = F_10 ( V_127 ) ;
}
static int F_246 ( struct V_17 * V_127 , int V_586 )
{
int V_47 ;
V_47 = F_247 ( V_127 , V_586 ) ;
if ( V_47 )
return V_47 ;
return F_92 ( V_127 , V_587 ) ;
}
static int F_248 ( struct V_17 * V_127 , int V_588 )
{
int V_47 ;
V_47 = F_249 ( V_127 , V_588 ) ;
if ( V_47 )
return V_47 ;
return F_92 ( V_127 , V_587 ) ;
}
static int F_250 ( struct V_17 * V_127 )
{
return F_92 ( V_127 , V_589 ) ;
}
static int F_251 ( struct V_17 * V_127 , unsigned int V_590 ,
struct V_408 * V_591 )
{
...
static int F_252 ( struct V_17 * V_127 )
{
int V_47 ;
V_47 = F_253 ( V_127 ) ;
if ( V_47 )
...
static int F_256 ( struct V_17 * V_127 , struct V_594 * V_595 ,
int V_227 , T_2 V_504 )
{
T_2 V_228 ;
int V_47 ;
...
static void F_258 ( struct V_17 * V_127 ,
struct V_19 * V_19 )
{
struct V_20 * V_21 = V_19 -> V_30 ;
T_2 V_14 = F_10 ( V_127 ) ;
...
if ( F_262 ( V_604 -> V_613 ) & V_614 )
break;
V_600 += V_601 ;
V_612 = F_261 ( V_598 , V_600 , sizeof( V_611 ) , & V_611 ) ;
if ( V_612 == NULL )
break;
...
break;
V_600 += V_601 ;
V_621 = F_261 ( V_598 , V_600 , sizeof( V_620 ) , & V_620 ) ;
if ( V_621 == NULL )
break;
...
break;
V_600 += V_601 ;
V_625 = F_261 ( V_598 , V_600 , sizeof( V_624 ) , & V_624 ) ;
if ( V_625 == NULL )
break;
...
static int F_263 ( struct V_597 * V_598 ,
struct V_251 * V_252 , T_13 * V_599 )
{
T_13 V_628 ;
...
T_14 V_613 ;
V_600 = F_260 ( V_598 ) ;
V_631 = F_261 ( V_598 , V_600 , sizeof( V_630 ) , & V_630 ) ;
if ( V_631 == NULL )
goto V_66;
...
V_628 = V_631 -> V_628 ;
V_600 += sizeof( V_630 ) ;
V_600 = F_264 ( V_598 , V_600 , & V_628 , & V_613 ) ;
if ( V_600 < 0 )
goto V_66;
if ( V_599 )
* V_599 = V_628 ;
...
static int F_265 ( struct V_597 * V_598 , struct V_251 * V_252 ,
...
case V_177 :
V_575 = F_259 ( V_598 , V_252 , V_599 ) ;
if ( V_575 )
goto V_636;
V_635 = ( char * ) ( V_634 ? & V_252 -> V_257 . V_606 -> V_607 . V_608 :
& V_252 -> V_257 . V_606 -> V_607 . V_609 ) ;
goto V_637;
#if F_266 ( V_638 ) || F_266 ( V_639 )
case V_178 :
V_575 = F_263 ( V_598 , V_252 , V_599 ) ;
if ( V_575 )
goto V_636;
...
static int F_267 ( struct V_597 * V_598 , T_4 V_170 , T_2 * V_14 )
{
int V_552 ;
T_2 V_640 ;
T_2 V_641 ;
T_2 V_642 ;
F_268 ( V_598 , & V_640 ) ;
F_269 ( V_598 , V_170 , & V_642 , & V_641 ) ;
V_552 = F_270 ( V_641 , V_642 , V_640 , V_14 ) ;
if ( F_101 ( V_552 ) ) {
F_38 ( V_61
L_42
L_43 ) ;
...
static int F_272 ( struct V_17 * V_18 , struct V_646 * V_647 , T_2 V_238 )
{
...
V_47 = F_271 ( V_11 , V_643 , & V_271 ) ;
if ( V_47 )
return V_47 ;
return F_35 ( V_11 -> V_14 , V_271 , V_643 , V_654 , NULL ) ;
}
static int F_274 ( struct V_655 * V_646 , int V_170 ,
int type , int V_166 , int V_653 )
{
const struct V_10 * V_11 = F_15 () ;
struct V_20 * V_21 = F_275 ( V_646 ) -> V_30 ;
struct V_648 * V_649 ;
int V_552 = 0 ;
...
V_552 = F_271 ( V_11 , V_21 -> V_28 , & ( V_21 -> V_14 ) ) ;
if ( V_552 )
return V_552 ;
}
V_21 -> V_114 = 1 ;
...
V_552 = F_276 ( V_646 -> V_647 , V_170 ) ;
}
return V_552 ;
}
static int F_277 ( struct V_655 * V_646 , struct V_656 * V_657 , int V_658 )
{
struct V_646 * V_647 = V_646 -> V_647 ;
T_4 V_170 ;
int V_552 ;
V_552 = F_272 ( V_8 , V_647 , V_659 ) ;
if ( V_552 )
goto V_66;
V_170 = V_647 -> V_660 ;
...
V_552 = F_279 ( V_647 -> V_677 ,
V_665 , & V_14 ) ;
if ( V_552 )
goto V_66;
V_252 . type = V_652 ;
V_252 . V_257 . V_606 = & V_606 ;
V_252 . V_257 . V_606 -> V_615 = F_280 ( V_665 ) ;
...
static int F_282 ( struct V_655 * V_646 , struct V_656 * V_657 , int V_658 )
{
struct V_646 * V_647 = V_646 -> V_647 ;
struct V_648 * V_649 = V_647 -> V_650 ;
int V_552 ;
V_552 = F_272 ( V_8 , V_647 , V_683 ) ;
if ( V_552 )
return V_552 ;
if ( V_649 -> V_28 == V_179 ||
V_649 -> V_28 == V_183 ) {
...
V_552 = F_279 ( V_647 -> V_677 , V_665 , & V_14 ) ;
if ( V_552 )
goto V_66;
...
V_252 . type = V_652 ;
V_252 . V_257 . V_606 = & V_606 ;
V_252 . V_257 . V_606 -> V_617 = F_280 ( V_665 ) ;
V_252 . V_257 . V_606 -> V_170 = V_647 -> V_660 ;
V_552 = F_35 ( V_649 -> V_14 , V_14 , V_649 -> V_28 , V_228 , & V_252 ) ;
if ( V_552 )
goto V_66;
}
V_552 = F_283 ( V_647 , V_657 ) ;
V_66:
return V_552 ;
}
static int F_284 ( struct V_655 * V_646 , int V_687 )
{
return F_272 ( V_8 , V_646 -> V_647 , V_688 ) ;
}
static int F_285 ( struct V_655 * V_646 , struct V_655 * V_689 )
{
int V_552 ;
struct V_20 * V_21 ;
struct V_20 * V_123 ;
V_552 = F_272 ( V_8 , V_646 -> V_647 , V_690 ) ;
if ( V_552 )
return V_552 ;
V_123 = F_275 ( V_689 ) -> V_30 ;
V_21 = F_275 ( V_646 ) -> V_30 ;
V_123 -> V_28 = V_21 -> V_28 ;
V_123 -> V_14 = V_21 -> V_14 ;
V_123 -> V_114 = 1 ;
return 0 ;
}
static int F_286 ( struct V_655 * V_646 , struct V_691 * V_692 ,
int V_491 )
{
return F_272 ( V_8 , V_646 -> V_647 , V_693 ) ;
}
static int F_287 ( struct V_655 * V_646 , struct V_691 * V_692 ,
int V_491 , int V_69 )
{
return F_272 ( V_8 , V_646 -> V_647 , V_694 ) ;
}
static int F_288 ( struct V_655 * V_646 )
{
return F_272 ( V_8 , V_646 -> V_647 , V_695 ) ;
}
static int F_289 ( struct V_655 * V_646 )
{
return F_272 ( V_8 , V_646 -> V_647 , V_695 ) ;
}
static int F_290 ( struct V_655 * V_646 , int V_696 , int V_697 )
{
int V_552 ;
V_552 = F_272 ( V_8 , V_646 -> V_647 , V_698 ) ;
if ( V_552 )
return V_552 ;
return F_291 ( V_646 , V_696 , V_697 ) ;
}
static int F_292 ( struct V_655 * V_646 , int V_696 ,
int V_697 )
{
return F_272 ( V_8 , V_646 -> V_647 , V_699 ) ;
}
static int F_293 ( struct V_655 * V_646 , int V_700 )
{
return F_272 ( V_8 , V_646 -> V_647 , V_701 ) ;
}
static int F_294 ( struct V_646 * V_646 ,
struct V_646 * V_702 ,
struct V_646 * V_703 )
{
...
V_552 = F_295 ( V_705 -> V_14 , V_704 -> V_14 ,
& V_706 -> V_14 ) ;
if ( V_552 )
return V_552 ;
...
static int F_296 ( struct V_655 * V_646 ,
struct V_655 * V_702 )
{
...
static int F_297 ( int V_712 , char * V_635 , T_4 V_170 ,
T_2 V_708 ,
struct V_251 * V_252 )
{
int V_552 ;
...
if ( V_552 )
return V_552 ;
V_552 = F_281 ( V_635 , V_170 , & V_714 ) ;
if ( V_552 )
return V_552 ;
return F_35 ( V_708 , V_714 ,
V_717 , V_718 , V_252 ) ;
}
static int F_299 ( struct V_646 * V_647 , struct V_597 * V_598 ,
T_4 V_170 )
{
int V_552 = 0 ;
struct V_648 * V_649 = V_647 -> V_650 ;
...
V_252 . V_257 . V_606 -> V_170 = V_170 ;
V_552 = F_265 ( V_598 , & V_252 , & V_635 , 1 , NULL ) ;
if ( V_552 )
return V_552 ;
if ( F_4 () ) {
...
V_552 = F_300 ( V_649 , V_598 , V_170 , & V_252 ) ;
if ( V_552 )
return V_552 ;
V_552 = F_301 ( V_649 -> V_14 , V_598 , & V_252 ) ;
return V_552 ;
}
static int F_302 ( struct V_646 * V_647 , struct V_597 * V_598 )
{
int V_552 ;
struct V_648 * V_649 = V_647 -> V_650 ;
...
if ( V_170 != V_177 && V_170 != V_178 )
return 0 ;
if ( V_170 == V_178 && V_598 -> V_166 == F_280 ( V_727 ) )
V_170 = V_177 ;
if ( ! V_728 )
return F_299 ( V_647 , V_598 , V_170 ) ;
V_725 = F_4 () ;
V_726 = F_303 () || F_304 () ;
if ( ! V_725 && ! V_726 )
return 0 ;
...
if ( V_726 ) {
T_2 V_708 ;
V_552 = F_267 ( V_598 , V_170 , & V_708 ) ;
if ( V_552 )
return V_552 ;
V_552 = F_297 ( V_598 -> V_721 , V_635 , V_170 ,
V_708 , & V_252 ) ;
if ( V_552 ) {
F_305 ( V_598 , V_552 , 0 ) ;
return V_552 ;
...
static int F_306 ( struct V_655 * V_646 , char T_15 * V_731 ,
...
if ( F_307 ( V_731 , V_733 , V_734 ) )
V_552 = - V_737 ;
V_736:
if ( F_308 ( V_734 , V_732 ) )
V_552 = - V_737 ;
F_28 ( V_733 ) ;
return V_552 ;
}
static int F_309 ( struct V_655 * V_646 , struct V_597 * V_598 , T_2 * V_504 )
{
T_2 V_738 = V_645 ;
T_4 V_170 ;
if ( V_598 && V_598 -> V_166 == F_280 ( V_727 ) )
V_170 = V_177 ;
else if ( V_598 && V_598 -> V_166 == F_280 ( V_739 ) )
V_170 = V_178 ;
else if ( V_646 )
...
F_214 ( F_275 ( V_646 ) , & V_738 ) ;
else if ( V_598 )
F_267 ( V_598 , V_170 , & V_738 ) ;
V_66:
* V_504 = V_738 ;
if ( V_738 == V_645 )
return - V_86 ;
...
static int F_310 ( struct V_646 * V_647 , int V_170 , T_11 V_740 )
{
struct V_648 * V_649 ;
...
static void F_312 ( struct V_646 * V_647 )
{
struct V_648 * V_649 = V_647 -> V_650 ;
V_647 -> V_650 = NULL ;
F_313 ( V_649 ) ;
...
static void F_314 ( const struct V_646 * V_647 , struct V_646 * V_703 )
{
struct V_648 * V_649 = V_647 -> V_650 ;
...
static void F_315 ( struct V_646 * V_647 , T_2 * V_504 )
{
if ( ! V_647 )
* V_504 = V_742 ;
else {
...
static void F_316 ( struct V_646 * V_647 , struct V_655 * V_324 )
{
struct V_20 * V_21 = F_275 ( V_324 ) -> V_30 ;
struct V_648 * V_649 = V_647 -> V_650 ;
...
static int F_317 ( struct V_646 * V_647 , struct V_597 * V_598 ,
struct V_743 * V_744 )
{
struct V_648 * V_649 = V_647 -> V_650 ;
int V_552 ;
...
V_552 = F_295 ( V_649 -> V_14 , V_745 , & V_271 ) ;
if ( V_552 )
return V_552 ;
V_744 -> V_504 = V_271 ;
V_744 -> V_738 = V_745 ;
}
return F_318 ( V_744 , V_170 ) ;
}
static void F_319 ( struct V_646 * V_703 ,
const struct V_743 * V_744 )
{
struct V_648 * V_741 = V_703 -> V_650 ;
V_741 -> V_14 = V_744 -> V_504 ;
V_741 -> V_708 = V_744 -> V_738 ;
F_320 ( V_703 , V_744 -> V_746 -> V_170 ) ;
}
static void F_321 ( struct V_646 * V_647 , struct V_597 * V_598 )
{
T_4 V_170 = V_647 -> V_660 ;
struct V_648 * V_649 = V_647 -> V_650 ;
if ( V_170 == V_178 && V_598 -> V_166 == F_280 ( V_727 ) )
V_170 = V_177 ;
F_267 ( V_598 , V_170 , & V_649 -> V_708 ) ;
}
...
static void F_327 ( const struct V_743 * V_744 ,
struct V_749 * V_750 )
{
...
{
T_2 V_14 = F_14 () ;
return F_35 ( V_14 , V_14 , V_752 , V_753 ,
NULL ) ;
}
static void F_329 ( struct V_646 * V_647 )
{
struct V_648 * V_649 = V_647 -> V_650 ;
V_649 -> V_14 = F_14 () ;
V_649 -> V_28 = V_752 ;
}
static int F_330 ( struct V_646 * V_647 )
{
struct V_648 * V_649 = V_647 -> V_650 ;
T_2 V_14 = F_14 () ;
int V_552 ;
V_552 = F_35 ( V_14 , V_649 -> V_14 , V_752 ,
V_754 , NULL ) ;
if ( V_552 )
return V_552 ;
V_552 = F_35 ( V_14 , V_14 , V_752 ,
V_755 , NULL ) ;
if ( V_552 )
return V_552 ;
V_649 -> V_14 = V_14 ;
...
static int F_331 ( struct V_646 * V_647 , struct V_597 * V_598 )
{
int V_552 = 0 ;
T_2 V_228 ;
struct V_756 * V_757 ;
struct V_648 * V_649 = V_647 -> V_650 ;
if ( V_598 -> V_84 < F_332 ( 0 ) ) {
V_552 = - V_86 ;
goto V_66;
}
V_757 = F_333 ( V_598 ) ;
V_552 = F_334 ( V_649 -> V_28 , V_757 -> V_758 , & V_228 ) ;
if ( V_552 ) {
if ( V_552 == - V_86 ) {
F_335 ( V_8 -> V_497 , V_12 , V_498 ,
L_44
L_45 ,
V_757 -> V_758 , V_649 -> V_28 ) ;
if ( ! V_3 || F_336 () )
V_552 = 0 ;
}
if ( V_552 == - V_759 )
...
V_552 = F_272 ( V_8 , V_647 , V_228 ) ;
V_66:
return V_552 ;
}
static unsigned int F_337 ( struct V_597 * V_598 , int V_712 ,
T_4 V_170 )
{
int V_552 ;
char * V_635 ;
...
if ( ! V_725 && ! V_726 )
return V_761 ;
if ( F_267 ( V_598 , V_170 , & V_708 ) != 0 )
return V_762 ;
V_252 . type = V_652 ;
V_252 . V_257 . V_606 = & V_606 ;
V_252 . V_257 . V_606 -> V_720 = V_712 ;
V_252 . V_257 . V_606 -> V_170 = V_170 ;
if ( F_265 ( V_598 , & V_252 , & V_635 , 1 , NULL ) != 0 )
return V_762 ;
if ( V_726 ) {
V_552 = F_297 ( V_712 , V_635 , V_170 ,
V_708 , & V_252 ) ;
if ( V_552 ) {
F_305 ( V_598 , V_552 , 1 ) ;
return V_762 ;
...
return V_762 ;
if ( V_760 )
if ( F_338 ( V_598 , V_170 , V_708 ) != 0 )
return V_762 ;
return V_761 ;
}
static unsigned int F_339 ( unsigned int V_764 ,
struct V_597 * V_598 ,
const struct V_765 * V_766 ,
const struct V_765 * V_66 ,
int (* F_340)( struct V_597 * ) )
{
return F_337 ( V_598 , V_766 -> V_712 , V_177 ) ;
}
static unsigned int F_341 ( unsigned int V_764 ,
struct V_597 * V_598 ,
const struct V_765 * V_766 ,
const struct V_765 * V_66 ,
int (* F_340)( struct V_597 * ) )
{
return F_337 ( V_598 , V_766 -> V_712 , V_178 ) ;
}
static unsigned int F_342 ( struct V_597 * V_598 ,
T_4 V_170 )
{
T_2 V_14 ;
if ( ! F_303 () )
...
V_14 = V_15 ;
if ( F_338 ( V_598 , V_170 , V_14 ) != 0 )
return V_762 ;
return V_761 ;
}
static unsigned int F_343 ( unsigned int V_764 ,
struct V_597 * V_598 ,
const struct V_765 * V_766 ,
const struct V_765 * V_66 ,
int (* F_340)( struct V_597 * ) )
{
return F_342 ( V_598 , V_177 ) ;
}
static unsigned int F_344 ( struct V_597 * V_598 ,
int V_712 ,
T_4 V_170 )
{
...
V_252 . V_257 . V_606 -> V_720 = V_712 ;
V_252 . V_257 . V_606 -> V_170 = V_170 ;
if ( F_265 ( V_598 , & V_252 , & V_635 , 0 , & V_599 ) )
return V_762 ;
if ( F_4 () )
if ( F_35 ( V_649 -> V_14 , V_598 -> V_722 ,
V_723 , V_767 , & V_252 ) )
return F_345 ( - V_768 ) ;
if ( F_346 ( V_649 -> V_14 , V_598 , & V_252 , V_599 ) )
return F_345 ( - V_768 ) ;
return V_761 ;
}
static unsigned int F_347 ( struct V_597 * V_598 , int V_712 ,
T_4 V_170 )
{
T_2 V_769 ;
T_2 V_708 ;
...
T_13 V_726 ;
if ( ! V_728 )
return F_344 ( V_598 , V_712 , V_170 ) ;
#ifdef F_348
if ( F_349 ( V_598 ) != NULL && F_349 ( V_598 ) -> V_770 != NULL )
return V_761 ;
#endif
V_725 = F_4 () ;
V_726 = F_303 () || F_304 () ;
...
V_252 . V_257 . V_606 -> V_720 = V_712 ;
V_252 . V_257 . V_606 -> V_170 = V_170 ;
if ( F_265 ( V_598 , & V_252 , & V_635 , 0 , NULL ) )
return V_762 ;
if ( V_725 )
if ( F_35 ( V_708 , V_598 -> V_722 ,
V_723 , V_769 , & V_252 ) )
...
T_2 V_713 ;
T_2 V_714 ;
if ( F_298 ( V_712 , & V_713 ) )
return V_762 ;
if ( F_35 ( V_708 , V_713 ,
V_715 , V_772 , & V_252 ) )
return F_345 ( - V_768 ) ;
if ( F_281 ( V_635 , V_170 , & V_714 ) )
return V_762 ;
if ( F_35 ( V_708 , V_714 ,
V_717 , V_773 , & V_252 ) )
return F_345 ( - V_768 ) ;
...
static unsigned int F_350 ( unsigned int V_764 ,
struct V_597 * V_598 ,
const struct V_765 * V_766 ,
const struct V_765 * V_66 ,
int (* F_340)( struct V_597 * ) )
{
return F_347 ( V_598 , V_66 -> V_712 , V_177 ) ;
}
static unsigned int F_351 ( unsigned int V_764 ,
struct V_597 * V_598 ,
const struct V_765 * V_766 ,
const struct V_765 * V_66 ,
int (* F_340)( struct V_597 * ) )
{
return F_347 ( V_598 , V_66 -> V_712 , V_178 ) ;
}
static int F_352 ( struct V_646 * V_647 , struct V_597 * V_598 )
{
int V_552 ;
V_552 = F_353 ( V_647 , V_598 ) ;
if ( V_552 )
return V_552 ;
return F_331 ( V_647 , V_598 ) ;
}
static int F_354 ( struct V_17 * V_18 ,
struct V_774 * V_228 ,
T_4 V_28 )
{
struct V_775 * V_21 ;
T_2 V_14 ;
V_21 = F_7 ( sizeof( struct V_775 ) , V_12 ) ;
if ( ! V_21 )
return - V_24 ;
V_14 = F_10 ( V_18 ) ;
V_21 -> V_28 = V_28 ;
...
static void F_355 ( struct V_774 * V_228 )
{
struct V_775 * V_21 = V_228 -> V_16 ;
V_228 -> V_16 = NULL ;
F_28 ( V_21 ) ;
}
static int F_356 ( struct V_776 * V_692 )
{
struct V_777 * V_778 ;
V_778 = F_7 ( sizeof( struct V_777 ) , V_12 ) ;
if ( ! V_778 )
return - V_24 ;
V_778 -> V_14 = V_27 ;
V_692 -> V_16 = V_778 ;
...
static void F_357 ( struct V_776 * V_692 )
{
struct V_777 * V_778 = V_692 -> V_16 ;
V_692 -> V_16 = NULL ;
F_28 ( V_778 ) ;
}
static int F_358 ( struct V_774 * V_779 ,
T_2 V_238 )
{
struct V_775 * V_21 ;
struct V_251 V_252 ;
...
V_21 = V_779 -> V_16 ;
V_252 . type = V_780 ;
V_252 . V_257 . V_781 = V_779 -> V_782 ;
return F_35 ( V_14 , V_21 -> V_14 , V_21 -> V_28 , V_238 , & V_252 ) ;
}
static int F_359 ( struct V_776 * V_692 )
{
return F_356 ( V_692 ) ;
}
static void F_360 ( struct V_776 * V_692 )
{
F_357 ( V_692 ) ;
}
static int F_361 ( struct V_783 * V_784 )
{
struct V_775 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_354 ( V_8 , & V_784 -> V_785 , V_786 ) ;
if ( V_47 )
return V_47 ;
V_21 = V_784 -> V_785 . V_16 ;
V_252 . type = V_780 ;
V_252 . V_257 . V_781 = V_784 -> V_785 . V_782 ;
V_47 = F_35 ( V_14 , V_21 -> V_14 , V_786 ,
V_787 , & V_252 ) ;
if ( V_47 ) {
F_355 ( & V_784 -> V_785 ) ;
return V_47 ;
...
static void F_362 ( struct V_783 * V_784 )
{
F_355 ( & V_784 -> V_785 ) ;
}
static int F_363 ( struct V_783 * V_784 , int V_788 )
{
struct V_775 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
V_252 . type = V_780 ;
V_252 . V_257 . V_781 = V_784 -> V_785 . V_782 ;
return F_35 ( V_14 , V_21 -> V_14 , V_786 ,
V_789 , & V_252 ) ;
}
static int F_364 ( struct V_783 * V_784 , int V_507 )
{
int V_552 ;
int V_238 ;
switch ( V_507 ) {
...
V_552 = F_358 ( & V_784 -> V_785 , V_238 ) ;
return V_552 ;
}
static int F_365 ( struct V_783 * V_784 , struct V_776 * V_692 , int V_788 )
{
struct V_775 * V_21 ;
struct V_777 * V_778 ;
struct V_251 V_252 ;
...
V_778 = V_692 -> V_16 ;
if ( V_778 -> V_14 == V_27 ) {
V_47 = F_87 ( V_14 , V_21 -> V_14 , V_800 ,
NULL , & V_778 -> V_14 ) ;
if ( V_47 )
return V_47 ;
}
...
V_801 , & V_252 ) ;
if ( ! V_47 )
V_47 = F_35 ( V_14 , V_778 -> V_14 , V_800 ,
V_802 , & V_252 ) ;
if ( ! V_47 )
V_47 = F_35 ( V_778 -> V_14 , V_21 -> V_14 , V_786 ,
V_803 , & V_252 ) ;
return V_47 ;
}
static int F_366 ( struct V_783 * V_784 , struct V_776 * V_692 ,
struct V_17 * V_237 ,
long type , int V_151 )
{
struct V_775 * V_21 ;
...
V_786 , V_804 , & V_252 ) ;
if ( ! V_47 )
V_47 = F_35 ( V_14 , V_778 -> V_14 ,
V_800 , V_805 , & V_252 ) ;
return V_47 ;
}
static int F_367 ( struct V_806 * V_807 )
{
struct V_775 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_354 ( V_8 , & V_807 -> V_808 , V_809 ) ;
if ( V_47 )
return V_47 ;
V_21 = V_807 -> V_808 . V_16 ;
V_252 . type = V_780 ;
V_252 . V_257 . V_781 = V_807 -> V_808 . V_782 ;
V_47 = F_35 ( V_14 , V_21 -> V_14 , V_809 ,
V_810 , & V_252 ) ;
if ( V_47 ) {
F_355 ( & V_807 -> V_808 ) ;
return V_47 ;
...
static void F_368 ( struct V_806 * V_807 )
{
F_355 ( & V_807 -> V_808 ) ;
}
static int F_369 ( struct V_806 * V_807 , int V_811 )
{
struct V_775 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
V_252 . type = V_780 ;
V_252 . V_257 . V_781 = V_807 -> V_808 . V_782 ;
return F_35 ( V_14 , V_21 -> V_14 , V_809 ,
V_812 , & V_252 ) ;
}
static int F_370 ( struct V_806 * V_807 , int V_507 )
{
int V_238 ;
int V_552 ;
switch ( V_507 ) {
...
V_552 = F_358 ( & V_807 -> V_808 , V_238 ) ;
return V_552 ;
}
static int F_371 ( struct V_806 * V_807 ,
char T_15 * V_821 , int V_811 )
{
T_2 V_238 ;
if ( V_811 & V_822 )
V_238 = V_823 ;
...
V_238 = V_823 | V_824 ;
return F_358 ( & V_807 -> V_808 , V_238 ) ;
}
static int F_372 ( struct V_825 * V_826 )
{
struct V_775 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_354 ( V_8 , & V_826 -> V_827 , V_828 ) ;
if ( V_47 )
return V_47 ;
V_21 = V_826 -> V_827 . V_16 ;
V_252 . type = V_780 ;
V_252 . V_257 . V_781 = V_826 -> V_827 . V_782 ;
V_47 = F_35 ( V_14 , V_21 -> V_14 , V_828 ,
V_829 , & V_252 ) ;
if ( V_47 ) {
F_355 ( & V_826 -> V_827 ) ;
return V_47 ;
...
static void F_373 ( struct V_825 * V_826 )
{
F_355 ( & V_826 -> V_827 ) ;
}
static int F_374 ( struct V_825 * V_826 , int V_830 )
{
struct V_775 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
V_252 . type = V_780 ;
V_252 . V_257 . V_781 = V_826 -> V_827 . V_782 ;
return F_35 ( V_14 , V_21 -> V_14 , V_828 ,
V_831 , & V_252 ) ;
}
static int F_375 ( struct V_825 * V_826 , int V_507 )
{
int V_552 ;
T_2 V_238 ;
switch ( V_507 ) {
...
V_552 = F_358 ( & V_826 -> V_827 , V_238 ) ;
return V_552 ;
}
static int F_376 ( struct V_825 * V_826 ,
struct V_846 * V_847 , unsigned V_848 , int V_849 )
{
T_2 V_238 ;
if ( V_849 )
V_238 = V_839 | V_842 ;
...
V_238 = V_839 ;
return F_358 ( & V_826 -> V_827 , V_238 ) ;
}
static int F_377 ( struct V_774 * V_850 , short V_98 )
{
T_2 V_255 = 0 ;
V_255 = 0 ;
if ( V_98 & V_851 )
...
if ( V_255 == 0 )
return 0 ;
return F_358 ( V_850 , V_255 ) ;
}
static void F_378 ( struct V_774 * V_850 , T_2 * V_504 )
{
struct V_775 * V_21 = V_850 -> V_16 ;
* V_504 = V_21 -> V_14 ;
}
static void F_379 ( struct V_52 * V_52 , struct V_19 * V_19 )
{
if ( V_19 )
F_33 ( V_19 , V_52 ) ;
}
...
static int F_381 ( struct V_17 * V_127 ,
...
static int F_387 ( T_2 V_504 , char * * V_444 , T_2 * V_864 )
{
return F_47 ( V_504 , V_444 , V_864 ) ;
}
static int F_388 ( const char * V_444 , T_2 V_864 , T_2 * V_504 )
{
return F_54 ( V_444 , V_864 , V_504 ) ;
}
static void F_389 ( char * V_444 , T_2 V_864 )
{
F_28 ( V_444 ) ;
}
static int F_390 ( struct V_19 * V_19 , void * V_278 , T_2 V_865 )
{
return F_212 ( V_19 , V_463 , V_278 , V_865 , 0 ) ;
}
static int F_391 ( struct V_52 * V_52 , void * V_278 , T_2 V_865 )
{
return F_392 ( V_52 , V_67 , V_278 , V_865 , 0 ) ;
}
static int F_393 ( struct V_19 * V_19 , void * * V_278 , T_2 * V_865 )
{
int V_84 = 0 ;
V_84 = F_211 ( V_19 , V_463 ,
V_278 , true ) ;
if ( V_84 < 0 )
return V_84 ;
* V_865 = V_84 ;
...
static int F_394 ( struct V_782 * V_866 , const struct V_7 * V_7 ,
unsigned long V_69 )
{
const struct V_10 * V_11 ;
struct V_867 * V_868 ;
V_868 = F_7 ( sizeof( struct V_867 ) , V_12 ) ;
if ( ! V_868 )
return - V_24 ;
V_11 = V_7 -> V_16 ;
if ( V_11 -> V_372 )
V_868 -> V_14 = V_11 -> V_372 ;
else
V_868 -> V_14 = V_11 -> V_14 ;
V_866 -> V_16 = V_868 ;
return 0 ;
}
static void F_395 ( struct V_782 * V_866 )
{
struct V_867 * V_868 = V_866 -> V_16 ;
V_866 -> V_16 = NULL ;
F_28 ( V_868 ) ;
}
static int F_396 ( T_16 V_869 ,
const struct V_7 * V_7 ,
T_17 V_228 )
{
struct V_782 * V_782 ;
...
V_782 = F_397 ( V_869 ) ;
V_868 = V_782 -> V_16 ;
return F_35 ( V_14 , V_868 -> V_14 , V_279 , V_228 , NULL ) ;
}
static int F_398 ( struct V_782 * V_782 , char * * V_870 )
{
struct V_867 * V_868 = V_782 -> V_16 ;
char * V_83 = NULL ;
unsigned V_84 ;
int V_47 ;
V_47 = F_47 ( V_868 -> V_14 , & V_83 , & V_84 ) ;
if ( ! V_47 )
V_47 = V_84 ;
* V_870 = V_83 ;
return V_47 ;
}
static T_1 int F_399 ( void )
{
if ( ! F_400 ( & V_871 ) ) {
V_5 = 0 ;
return 0 ;
...
static void F_404 ( struct V_41 * V_42 , void * V_875 )
{
F_62 ( V_42 , NULL ) ;
}
void F_405 ( void )
...
static int T_1 F_407 ( void )
{
int V_552 = 0 ;
if ( ! V_5 )
goto V_66;
F_38 ( V_74 L_61 ) ;
V_552 = F_408 ( V_876 , F_39 ( V_876 ) ) ;
if ( V_552 )
F_8 ( L_62 , V_552 ) ;
#if F_266 ( V_638 ) || F_266 ( V_639 )
V_552 = F_408 ( V_877 , F_39 ( V_877 ) ) ;
if ( V_552 )
F_8 ( L_63 , V_552 ) ;
#endif
V_66:
...
{
F_38 ( V_74 L_64 ) ;
F_410 ( V_876 , F_39 ( V_876 ) ) ;
#if F_266 ( V_638 ) || F_266 ( V_639 )
F_410 ( V_877 , F_39 ( V_877 ) ) ;
#endif
}
int F_411 ( void )
{
