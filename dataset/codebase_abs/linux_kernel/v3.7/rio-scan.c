...
static int T_4 F_37 ( struct V_22 * V_23 )
{
int V_64 ;
V_64 = F_38 ( & V_23 -> V_45 ) ;
if ( V_64 )
...
static struct V_22 T_4 * F_45 ( struct V_1 * V_2 ,
...
static int T_4 F_67 ( struct V_1 * V_2 , struct V_14 * V_15 ,
...
static struct V_1 T_4 * F_76 ( struct V_14 * V_15 ,
int V_48 , T_1 V_10 )
{
struct V_1 * V_2 ;
...
int T_4 F_84 ( struct V_14 * V_156 )
{
struct V_1 * V_2 = NULL ;
int V_134 = 0 ;
...
int T_4 F_86 ( struct V_14 * V_156 )
{
struct V_1 * V_2 = NULL ;
unsigned long V_162 ;
