...
struct V_32 * V_33 ;
struct V_224 * V_225 ;
struct V_226 * V_227 = V_218 -> V_202 . V_228 ;
int V_20 ;
V_33 = F_55 ( & V_218 -> V_202 , sizeof( struct V_32 ) , V_229 ) ;
if ( V_33 == NULL ) {
...
V_225 = F_55 ( & V_218 -> V_202 , sizeof( * V_225 ) ,
V_229 ) ;
if ( V_225 == NULL ) {
F_42 ( & V_218 -> V_202 , L_8 ) ;
return - V_230 ;
}
V_20 = F_57 ( V_227 , L_9 , 0 ) ;
if ( V_20 >= 0 )
V_33 -> V_141 = V_20 ;
else
V_33 -> V_141 = - 1 ;
...
V_33 -> V_37 = V_220 -> V_232 ;
V_20 = F_59 ( & V_218 -> V_202 ,
& V_233 , & V_234 , 1 ) ;
return V_20 ;
}
static int F_60 ( struct V_217 * V_235 )
{
F_61 ( & V_235 -> V_202 ) ;
return 0 ;
}
