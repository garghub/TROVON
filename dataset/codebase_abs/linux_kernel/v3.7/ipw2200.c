...
return - V_905 ;
F_59 ( & V_23 -> V_109 ) ;
V_211 -> V_3 . V_415 = F_3 ( ( T_1 ) V_211 -> V_3 . V_415 , sizeof( V_23 -> V_1223 ) ) ;
...
memcpy ( V_23 -> V_882 , V_1244 -> V_666 , V_4 ) ;
V_23 -> V_873 = V_4 ;
V_107 = & V_23 -> V_187 ;
} else if ( V_1244 -> V_699 == V_875 ) {
V_107 = & V_23 -> V_188 ;
}
} else {
V_107 = & V_23 -> V_186 ;
...
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
return F_441 ( V_23 -> V_163 , V_902 , V_211 , V_903 ) ;
}
...
F_59 ( & V_23 -> V_109 ) ;
V_432 = F_443 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
...
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
return F_445 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
}
...
if ( F_447 ( V_23 -> V_1180 ) == V_365 )
V_23 -> V_1180 = V_1251 | V_363 ;
else
V_23 -> V_1180 = V_1251 | V_23 -> V_1180 ;
V_557 = F_184 ( V_23 , F_447 ( V_23 -> V_1180 ) ) ;
if ( V_557 ) {
F_326 ( L_458 ) ;
F_60 ( & V_23 -> V_109 ) ;
return V_557 ;
...
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
int V_11 = F_447 ( V_23 -> V_1180 ) ;
char * V_134 = V_903 ;
V_134 += snprintf ( V_134 , V_1253 , L_463 , V_11 ) ;
switch ( V_11 ) {
case V_365 :
V_134 += snprintf ( V_134 , V_1253 - ( V_134 - V_903 ) , L_464 ) ;
break;
case V_363 :
V_134 += snprintf ( V_134 , V_1253 - ( V_134 - V_903 ) , L_465 ) ;
break;
default:
...
if ( ! ( V_23 -> V_1180 & V_1251 ) )
V_134 += snprintf ( V_134 , V_1253 - ( V_134 - V_903 ) , L_467 ) ;
...
case V_119 :
strncpy ( V_903 , L_473 , V_1253 ) ;
break;
case V_608 :
strncpy ( V_903 , L_474 , V_1253 ) ;
break;
case V_119 | V_608 :
strncpy ( V_903 , L_475 , V_1253 ) ;
break;
case V_121 :
strncpy ( V_903 , L_476 , V_1253 ) ;
break;
case V_119 | V_121 :
strncpy ( V_903 , L_477 , V_1253 ) ;
break;
case V_608 | V_121 :
strncpy ( V_903 , L_478 , V_1253 ) ;
break;
case V_119 | V_608 | V_121 :
strncpy ( V_903 , L_479 , V_1253 ) ;
break;
default:
strncpy ( V_903 , L_480 , V_1253 ) ;
break;
}
F_326 ( L_481 , V_903 ) ;
...
F_59 ( & V_23 -> V_109 ) ;
if ( V_23 -> V_59 & V_821 )
snprintf ( V_211 -> V_158 , V_1257 , L_483 ) ;
else
snprintf ( V_211 -> V_158 , V_1257 , L_484 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
F_60 ( & V_23 -> V_109 ) ;
F_443 ( V_23 -> V_163 , V_902 , & V_1259 , NULL ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( ! ( V_23 -> V_37 & V_99 ) ) {
F_264 ( L_488
L_489 ) ;
...
static struct V_1262 * F_459 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
...
static int F_465 ( struct V_17 * V_23 , struct V_1288 * V_532 ,
int V_1289 )
{
...
if ( ! ( V_23 -> V_37 & V_103 ) )
goto V_1135;
V_1294 = F_392 ( F_221 ( V_1054 -> V_1136 ) ) ;
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
V_1007 = ! F_365 ( V_1054 -> V_1070 ) ;
V_1293 = F_262 ( V_23 , V_1054 -> V_1070 ) ;
if ( V_1293 == V_552 ) {
V_1293 = F_261 ( V_23 , V_1054 -> V_1070 ) ;
if ( V_1293 == V_552 ) {
F_93 ( L_492
L_493 ,
V_1054 -> V_1070 ) ;
...
memset ( V_767 , 0 , sizeof( * V_767 ) ) ;
V_767 -> V_538 . V_3 . V_1295 = V_1293 ;
V_767 -> V_535 . V_536 = V_1296 ;
V_767 -> V_535 . V_769 = V_770 ;
V_767 -> V_538 . V_3 . V_836 = V_1297 ;
V_767 -> V_538 . V_3 . V_4 = F_173 ( V_532 -> V_1298 ) ;
if ( V_23 -> V_559 . V_347 == V_352 )
V_767 -> V_538 . V_3 . V_1010 |= V_1299 ;
else
V_767 -> V_538 . V_3 . V_1010 |= V_1300 ;
if ( V_23 -> V_559 . V_1030 == V_1031 )
V_767 -> V_538 . V_3 . V_1013 |= V_1031 ;
V_1055 = F_221 ( V_1054 -> V_1136 ) ;
V_1054 -> V_1136 = F_173 ( V_1055 & ~ V_1301 ) ;
memcpy ( & V_767 -> V_538 . V_3 . V_767 . V_1302 . V_1016 , V_1054 , V_1294 ) ;
if ( F_466 ( V_1007 ) )
V_767 -> V_538 . V_3 . V_1013 |= V_1014 ;
if ( V_532 -> V_1303 && ! V_23 -> V_163 -> V_842 ) {
switch ( V_23 -> V_163 -> V_244 . V_11 ) {
case V_843 :
V_767 -> V_538 . V_3 . V_767 . V_1302 . V_1016 . V_1136 |=
F_173 ( V_1057 ) ;
if ( ! V_1007 )
V_767 -> V_538 . V_3 . V_1013 |= V_1014 ;
V_767 -> V_538 . V_3 . V_1013 &= ~ V_1304 ;
V_767 -> V_538 . V_3 . V_1010 |= V_851 ;
V_767 -> V_538 . V_3 . V_839 = 0 ;
V_767 -> V_538 . V_3 . V_839 |= V_1305 ;
break;
case V_846 :
V_767 -> V_538 . V_3 . V_767 . V_1302 . V_1016 . V_1136 |=
F_173 ( V_1057 ) ;
...
#ifdef F_292
if ( V_1055 & V_1308 )
F_366 ( V_23 , V_1289 , & ( V_767 -> V_538 . V_3 ) ) ;
#endif
V_767 -> V_538 . V_3 . V_539 = F_179 ( F_3 ( ( T_2 ) ( V_540 - 2 ) ,
V_532 -> V_1309 ) ) ;
F_467 ( L_494 ,
V_532 -> V_1309 , F_226 ( V_767 -> V_538 . V_3 . V_539 ) ) ;
...
F_4 ( V_1312 L_497 ,
V_1311 ) ;
V_501 = F_299 ( V_1311 , V_139 ) ;
if ( V_501 != NULL ) {
V_767 -> V_538 . V_3 . V_478 [ V_7 ] = F_173 ( V_1311 ) ;
for ( V_8 = V_7 ; V_8 < V_532 -> V_1309 ; V_8 ++ ) {
...
static int F_469 ( struct V_165 * V_166 , int V_1289 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
#ifdef F_292
int V_1292 = F_363 ( V_23 , V_1289 ) ;
...
struct V_1005 * V_802 = V_532 -> V_1291 [ V_172 ] ;
...
V_4 = V_802 -> V_4 ;
V_1316 = F_299 ( V_4 + sizeof( * V_1079 ) + sizeof( T_4 ) * 2 , V_139 ) ;
if ( ! V_1316 )
continue;
V_1079 = ( void * ) F_382 ( V_1316 , sizeof( * V_1079 ) ) ;
V_1079 -> V_1080 = V_1081 ;
V_1079 -> V_1082 = 0 ;
V_1079 -> V_1084 = 0 ;
V_1079 -> V_1084 |= F_179 ( 1 << V_1088 ) ;
* ( T_8 * ) F_382 ( V_1316 , sizeof( T_4 ) ) = F_173 (
F_386 ( V_23 -> V_197 ) ) ;
if ( V_23 -> V_197 > 14 )
* ( T_8 * ) F_382 ( V_1316 , sizeof( T_4 ) ) =
F_173 ( V_1100 |
V_1101 ) ;
...
F_471 ( V_802 , F_382 ( V_1316 , V_4 ) , V_4 ) ;
if ( ! F_384 ( V_23 -> V_159 -> V_163 , V_1316 , & V_1314 ) )
F_393 ( V_1316 ) ;
}
}
static T_12 F_472 ( struct V_1288 * V_532 ,
struct V_165 * V_166 , int V_1289 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
unsigned long V_41 ;
T_12 V_432 ;
F_145 ( L_500 , V_532 -> V_1298 ) ;
F_41 ( & V_23 -> V_98 , V_41 ) ;
#ifdef F_269
if ( V_156 && F_92 ( V_23 -> V_157 ) )
F_470 ( V_23 , V_532 ) ;
#endif
V_432 = F_465 ( V_23 , V_532 , V_1289 ) ;
if ( V_432 == V_1313 )
F_63 ( V_23 ) ;
F_42 ( & V_23 -> V_98 , V_41 ) ;
return V_432 ;
...
char V_1323 [ 32 ] ;
T_3 V_4 ;
F_477 ( V_902 -> V_1324 , V_1325 , sizeof( V_902 -> V_1324 ) ) ;
F_477 ( V_902 -> V_983 , V_1326 , sizeof( V_902 -> V_983 ) ) ;
V_4 = sizeof( V_1322 ) ;
F_48 ( V_134 , V_1327 , V_1322 , & V_4 ) ;
V_4 = sizeof( V_1323 ) ;
F_48 ( V_134 , V_1328 , V_1323 , & V_4 ) ;
snprintf ( V_902 -> V_1329 , sizeof( V_902 -> V_1329 ) , L_501 ,
V_1322 , V_1323 ) ;
F_477 ( V_902 -> V_1330 , F_478 ( V_134 -> V_477 ) ,
sizeof( V_902 -> V_1330 ) ) ;
V_902 -> V_1331 = V_386 ;
}
...
static T_13 F_483 ( int V_1334 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
static int T_14 F_494 ( struct V_17 * V_23 )
{
int V_432 = 0 ;
F_495 ( & V_23 -> V_228 ) ;
F_495 ( & V_23 -> V_486 ) ;
F_496 ( & V_23 -> V_668 , F_323 ) ;
F_497 ( & V_23 -> V_333 , F_374 ) ;
F_497 ( & V_23 -> V_558 , F_267 ) ;
F_497 ( & V_23 -> V_564 , F_268 ) ;
F_497 ( & V_23 -> V_779 , F_301 ) ;
F_497 ( & V_23 -> V_246 , F_164 ) ;
F_496 ( & V_23 -> V_191 , F_488 ) ;
F_497 ( & V_23 -> V_193 , V_1340 ) ;
F_497 ( & V_23 -> V_190 , V_1341 ) ;
...
F_497 ( & V_23 -> V_705 , F_373 ) ;
F_496 ( & V_23 -> V_322 , F_169 ) ;
F_497 ( & V_23 -> V_675 , F_491 ) ;
F_497 ( & V_23 -> V_241 , F_493 ) ;
F_496 ( & V_23 -> V_108 , F_57 ) ;
F_496 ( & V_23 -> V_104 , F_62 ) ;
F_496 ( & V_23 -> V_114 , F_66 ) ;
F_497 ( & V_23 -> V_815 , F_312 ) ;
#ifdef F_292
F_497 ( & V_23 -> V_961 , F_367 ) ;
#endif
F_498 ( & V_23 -> V_1337 , ( void (*) ( unsigned long ) )
...
int V_155 , V_7 , V_8 ;
if ( V_23 -> V_1354 ) {
F_501 ( V_23 -> V_163 , V_23 -> V_1354 ) ;
V_23 -> V_1354 = 0 ;
}
if ( V_23 -> V_37 & V_700 )
return - V_306 ;
if ( V_149 && ! V_23 -> V_149 ) {
V_23 -> V_149 = F_502 ( V_149 , sizeof( * V_23 -> V_149 ) ,
V_148 ) ;
if ( V_23 -> V_149 == NULL ) {
F_46 ( L_509 ,
V_149 ) ;
...
memcpy ( V_23 -> V_167 -> V_1356 , V_23 -> V_543 , V_217 ) ;
for ( V_8 = 0 ; V_8 < F_222 ( V_1357 ) ; V_8 ++ ) {
if ( ! memcmp ( & V_23 -> V_123 [ V_1358 ] ,
V_1357 [ V_8 ] . V_158 , 3 ) )
break;
}
if ( V_8 == F_222 ( V_1357 ) ) {
...
if ( F_503 ( V_23 -> V_163 , & V_1357 [ V_8 ] ) ) {
F_93 ( L_511 ) ;
return 0 ;
}
if ( V_23 -> V_37 & V_184 ) {
...
memcpy ( V_182 -> V_183 -> V_1356 , V_23 -> V_543 , V_217 ) ;
if ( V_202 -> V_203 ) {
struct V_1361 * V_1362 = & V_23 -> V_163 -> V_1362 ;
V_1362 -> V_881 = V_1363 ;
V_1362 -> V_1364 = V_202 -> V_203 ;
V_1362 -> V_869 = F_502 ( V_202 -> V_203 ,
...
V_1362 -> V_1371 = V_1372 ;
V_1362 -> V_1373 = V_1374 ;
V_182 -> V_183 -> V_1375 [ V_1363 ] = V_1362 ;
}
if ( V_202 -> V_209 ) {
struct V_1361 * V_1376 = & V_23 -> V_163 -> V_1376 ;
V_1376 -> V_881 = V_1377 ;
V_1376 -> V_1364 = V_202 -> V_209 ;
V_1376 -> V_869 = F_502 ( V_202 -> V_209 ,
sizeof( struct V_1365 ) ,
V_148 ) ;
if ( ! V_1376 -> V_869 ) {
V_155 = - V_476 ;
...
for ( V_7 = 0 ; V_7 < V_202 -> V_209 ; V_7 ++ ) {
V_1376 -> V_869 [ V_7 ] . V_881 = V_1377 ;
V_1376 -> V_869 [ V_7 ] . V_1366 = V_202 -> V_18 [ V_7 ] . V_1149 ;
V_1376 -> V_869 [ V_7 ] . V_1367 = V_202 -> V_18 [ V_7 ] . V_197 ;
V_1376 -> V_869 [ V_7 ] . V_346 = V_202 -> V_18 [ V_7 ] . V_346 ;
if ( V_202 -> V_18 [ V_7 ] . V_41 & V_207 )
V_1376 -> V_869 [ V_7 ] . V_41 |=
V_1368 ;
...
V_1376 -> V_1371 = V_1378 ;
V_1376 -> V_1373 = V_1379 ;
V_182 -> V_183 -> V_1375 [ V_1377 ] = V_1376 ;
}
V_182 -> V_183 -> V_1380 = V_1381 ;
V_182 -> V_183 -> V_1382 = F_222 ( V_1381 ) ;
...
{
struct V_1383 * V_159 = F_341 ( V_166 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_511 ( sizeof( struct V_1383 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
...
static int T_14 F_517 ( struct V_477 * V_1386 ,
...
F_520 ( V_1386 ) ;
V_557 = F_521 ( V_1386 , F_522 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_523 ( V_1386 , F_522 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_528 ) ;
goto V_1392;
}
F_524 ( V_1386 , V_23 ) ;
V_557 = F_525 ( V_1386 , V_1325 ) ;
if ( V_557 )
goto V_1392;
F_526 ( V_1386 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_527 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_528 ( V_1386 , 0 ) ;
V_23 -> V_1393 = V_415 ;
V_137 = F_529 ( V_1386 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1390 ;
goto V_1394;
}
...
F_410 ( V_23 , 1 ) ;
V_557 = F_530 ( V_1386 -> V_1334 , F_483 , V_1396 , V_1325 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_532 , V_1386 -> V_1334 ) ;
goto V_1395;
}
F_513 ( V_167 , & V_1386 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1397 = F_472 ;
V_23 -> V_163 -> V_896 = F_499 ;
V_23 -> V_163 -> V_1398 = F_469 ;
#ifdef F_292
...
V_167 -> V_1406 = & V_1407 ;
V_167 -> V_1408 = & V_1409 ;
V_557 = F_531 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
if ( V_557 ) {
F_46 ( L_533 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1412;
...
F_87 ( V_23 -> V_163 -> V_1376 . V_869 ) ;
F_87 ( V_23 -> V_163 -> V_1362 . V_869 ) ;
V_1413:
F_533 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
V_1412:
F_534 ( V_1386 -> V_1334 , V_23 ) ;
V_1395:
F_535 ( V_23 -> V_22 ) ;
V_1394:
F_536 ( V_1386 ) ;
...
static void T_16 F_538 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_539 ( V_1386 ) ;
...
static int F_542 ( struct V_477 * V_1386 , T_17 V_664 )
{
struct V_17 * V_23 = F_539 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
F_4 ( V_1312 L_538 , V_166 -> V_158 ) ;
F_161 ( V_23 ) ;
F_543 ( V_166 ) ;
F_544 ( V_1386 ) ;
F_537 ( V_1386 ) ;
F_545 ( V_1386 , F_546 ( V_1386 , V_664 ) ) ;
V_23 -> V_1415 = F_547 () ;
return 0 ;
}
static int F_548 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_539 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
T_3 V_21 ;
F_4 ( V_1312 L_539 , V_166 -> V_158 ) ;
F_545 ( V_1386 , V_1416 ) ;
V_557 = F_519 ( V_1386 ) ;
if ( V_557 ) {
F_4 ( V_1059 L_540 ,
...
F_527 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
F_550 ( V_166 ) ;
V_23 -> V_1354 = F_547 () - V_23 -> V_1415 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_551 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_539 ( V_1386 ) ;
F_161 ( V_23 ) ;
F_537 ( V_1386 ) ;
}
static int T_18 F_552 ( void )
{
int V_432 ;
...
V_432 = F_554 ( & V_1417 . V_1324 , & V_1418 ) ;
if ( V_432 ) {
F_46 ( L_544 ) ;
F_555 ( & V_1417 ) ;
return V_432 ;
...
static void T_19 F_556 ( void )
{
F_557 ( & V_1417 . V_1324 , & V_1418 ) ;
F_555 ( & V_1417 ) ;
}
