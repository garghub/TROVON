...
V_28 = V_39 -> V_71 ( V_10 , V_67 ) ;
if ( F_4 ( V_28 != 0 ) )
goto V_73;
V_18 -> V_74 = & V_75 ;
V_18 -> V_21 = V_10 ;
V_18 -> V_57 |= V_76 | V_77 | V_78 | V_79 ;
return 0 ;
V_73:
F_23 ( & V_10 ) ;
return V_28 ;
}
int F_28 ( struct V_17 * V_18 , struct V_1 * V_10 )
{
if ( V_18 -> V_50 != 0 )
return - V_80 ;
V_18 -> V_74 = & V_75 ;
V_18 -> V_21 = F_21 ( V_10 ) ;
V_18 -> V_57 |= V_76 | V_77 | V_78 ;
return 0 ;
}
T_1 F_29 ( struct V_2 * V_3 , struct V_66 * V_67 ,
...
V_93 += V_22 ;
if ( V_85 )
V_28 = F_32 ( V_93 , V_81 , V_92 ) ;
else
V_28 = F_33 ( V_82 , V_93 , V_92 ) ;
F_34 ( & V_87 ) ;
F_19 ( V_10 ) ;
F_23 ( & V_10 ) ;
if ( F_4 ( V_28 != 0 ) )
...
T_1 F_35 ( struct V_1 * V_10 , const char T_2 * V_81 ,
