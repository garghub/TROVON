...
return - V_121 ;
if ( V_238 != V_245 [ F_160 ( V_236 ) ] ) {
F_28 ( L_56 ,
V_238 , V_245 [ F_160 ( V_236 ) ] ) ;
return - V_121 ;
}
...
if ( V_236 == V_247 )
V_131 = F_163 ( V_2 , V_250 -> V_254 , V_250 -> V_255 ,
V_250 -> V_256 ) ;
else
V_131 = F_164 ( V_2 , V_250 -> V_254 ) ;
F_114 ( & V_15 -> V_251 ) ;
goto V_253;
}
if ( F_162 ( & V_160 ) ) {
...
static void
F_165 ( struct V_268 * V_9 , struct V_53 * V_92 )
{
V_9 -> V_58 = V_92 -> V_58 ;
...
static inline int
F_169 ( struct V_2 * V_2 , const struct V_275 * V_270 ,
...
return - V_121 ;
if ( * V_238 < V_279 [ F_173 ( V_236 ) ] ) {
F_28 ( L_58 ,
* V_238 , V_279 [ F_173 ( V_236 ) ] ) ;
return - V_121 ;
}
V_277 = V_279 [ F_173 ( V_236 ) ] ;
if ( V_277 > 128 )
return - V_121 ;
if ( F_161 ( V_239 , V_237 , V_277 ) != 0 )
return - V_246 ;
if ( V_236 == V_280 ) {
...
if ( V_15 -> V_282 & V_283 ) {
V_281 [ 0 ] . V_254 = V_283 ;
F_166 ( V_281 [ 0 ] . V_255 , V_15 -> V_284 ,
sizeof( V_281 [ 0 ] . V_255 ) ) ;
V_281 [ 0 ] . V_256 = V_15 -> V_285 ;
}
if ( V_15 -> V_282 & V_286 ) {
V_281 [ 1 ] . V_254 = V_286 ;
F_166 ( V_281 [ 1 ] . V_255 , V_15 -> V_287 ,
sizeof( V_281 [ 1 ] . V_255 ) ) ;
V_281 [ 1 ] . V_256 = V_15 -> V_288 ;
}
if ( F_168 ( V_237 , & V_281 , sizeof( V_281 ) ) != 0 )
V_131 = - V_246 ;
F_114 ( & V_15 -> V_251 ) ;
return V_131 ;
}
...
sprintf ( V_290 , L_59 ,
F_137 ( V_199 ) , V_200 ) ;
if ( F_168 ( V_237 , V_290 , strlen ( V_290 ) + 1 ) != 0 ) {
V_131 = - V_246 ;
goto V_67;
}
...
if ( F_168 ( V_237 , & V_293 , sizeof( V_293 ) ) != 0 )
V_131 = - V_246 ;
}
break;
case V_296 :
...
if ( V_54 ) {
F_165 ( V_273 , V_54 ) ;
if ( F_168 ( V_237 , V_273 , sizeof( * V_273 ) ) != 0 )
V_131 = - V_246 ;
} else
V_131 = - V_262 ;
}
...
struct V_216 V_300 ;
F_170 ( V_2 , & V_300 ) ;
if ( F_168 ( V_237 , & V_300 , sizeof( V_300 ) ) != 0 )
V_131 = - V_246 ;
}
break;
default:
...
static int F_174 ( struct V_301 * V_302 , int V_303 ,
struct V_91 * V_77 )
{
struct V_90 V_215 ;
struct V_304 * V_305 = F_175 ( V_302 , V_303 ) ;
if ( ! V_305 )
return - V_306 ;
F_65 ( & V_215 , V_77 ) ;
if ( F_176 ( V_302 , V_307 , V_215 . V_94 ) ||
F_176 ( V_302 , V_308 , V_215 . V_95 ) ||
F_176 ( V_302 , V_309 , V_215 . V_96 ) ||
F_177 ( V_302 , V_310 , V_215 . V_97 ) ||
F_177 ( V_302 , V_311 , V_215 . V_98 ) ||
F_176 ( V_302 , V_312 , V_215 . V_207 ) ||
F_176 ( V_302 , V_313 , V_215 . V_208 ) ||
F_176 ( V_302 , V_314 , V_215 . V_209 ) ||
F_176 ( V_302 , V_315 , V_215 . V_210 ) ||
F_176 ( V_302 , V_316 , V_215 . V_211 ) )
goto V_317;
F_178 ( V_302 , V_305 ) ;
return 0 ;
V_317:
...
. V_320 = ~ 0 } ;
V_318 = F_175 ( V_302 , V_321 ) ;
if ( ! V_318 )
return - V_306 ;
if ( F_181 ( V_302 , V_322 , V_54 -> V_40 ) )
goto V_317;
if ( V_54 -> V_52 ) {
if ( F_176 ( V_302 , V_323 , V_54 -> V_52 ) )
goto V_317;
} else {
if ( F_181 ( V_302 , V_324 , V_54 -> V_58 ) ||
F_182 ( V_302 , V_325 , sizeof( V_54 -> V_4 ) , & V_54 -> V_4 ) ||
F_181 ( V_302 , V_326 , V_54 -> V_43 ) )
goto V_317;
}
if ( F_183 ( V_302 , V_327 , V_54 -> V_114 -> V_163 ) ||
( V_54 -> V_143 &&
F_183 ( V_302 , V_328 , V_54 -> V_143 -> V_163 ) ) ||
F_182 ( V_302 , V_329 , sizeof( V_12 ) , & V_12 ) ||
F_176 ( V_302 , V_330 , V_54 -> V_148 / V_149 ) ||
F_176 ( V_302 , V_331 , V_54 -> V_147 ) )
goto V_317;
if ( F_174 ( V_302 , V_332 , & V_54 -> V_77 ) )
goto V_317;
F_178 ( V_302 , V_318 ) ;
return 0 ;
V_317:
...
static int F_184 ( struct V_301 * V_302 ,
struct V_53 * V_54 ,
struct V_333 * V_334 )
{
void * V_335 ;
V_335 = F_185 ( V_302 , F_186 ( V_334 -> V_302 ) . V_336 , V_334 -> V_337 -> V_338 ,
& V_339 , V_340 ,
V_341 ) ;
if ( ! V_335 )
return - V_306 ;
if ( F_180 ( V_302 , V_54 ) < 0 )
goto V_317;
return F_187 ( V_302 , V_335 ) ;
V_317:
F_188 ( V_302 , V_335 ) ;
return - V_306 ;
}
static int F_189 ( struct V_301 * V_302 ,
struct V_333 * V_334 )
{
int V_158 = 0 , V_17 ;
int V_213 = V_334 -> args [ 0 ] ;
struct V_53 * V_54 ;
struct V_2 * V_2 = F_190 ( V_302 ) ;
F_113 ( & V_160 ) ;
for ( V_17 = 0 ; V_17 < V_159 ; V_17 ++ ) {
F_36 (svc, &ip_vs_svc_table[i], s_list) {
if ( ++ V_158 <= V_213 || ! F_38 ( V_54 -> V_2 , V_2 ) )
continue;
if ( F_184 ( V_302 , V_54 , V_334 ) < 0 ) {
V_158 -- ;
goto V_317;
}
}
...
if ( V_349 ) {
V_229 -> V_58 = V_68 ;
V_229 -> V_52 = F_194 ( V_349 ) ;
} else {
V_229 -> V_58 = F_193 ( V_350 ) ;
F_195 ( & V_229 -> V_4 , V_351 , sizeof( V_229 -> V_4 ) ) ;
V_229 -> V_43 = F_193 ( V_348 ) ;
V_229 -> V_52 = 0 ;
}
if ( V_229 -> V_52 )
V_54 = F_39 ( V_2 , V_229 -> V_40 , V_229 -> V_52 ) ;
...
return - V_121 ;
F_195 ( & V_12 , V_355 , sizeof( V_12 ) ) ;
if ( V_54 )
V_229 -> V_12 = V_54 -> V_12 ;
V_229 -> V_12 = ( V_229 -> V_12 & ~ V_12 . V_320 ) |
( V_12 . V_12 & V_12 . V_320 ) ;
V_229 -> V_144 = F_196 ( V_354 ) ;
V_229 -> V_146 = V_356 ? F_196 ( V_356 ) : NULL ;
V_229 -> V_148 = F_194 ( V_357 ) ;
V_229 -> V_147 = F_194 ( V_358 ) ;
}
return 0 ;
}
...
struct V_53 * V_54 ;
int V_131 ;
V_131 = F_191 ( V_2 , & V_229 , V_342 , 0 , & V_54 ) ;
return V_131 ? F_198 ( V_131 ) : V_54 ;
}
static int F_199 ( struct V_301 * V_302 , struct V_75 * V_76 )
{
struct V_304 * V_359 ;
V_359 = F_175 ( V_302 , V_360 ) ;
if ( ! V_359 )
return - V_306 ;
if ( F_182 ( V_302 , V_361 , sizeof( V_76 -> V_4 ) , & V_76 -> V_4 ) ||
F_181 ( V_302 , V_362 , V_76 -> V_43 ) ||
F_176 ( V_302 , V_363 ,
( F_15 ( & V_76 -> V_102 ) &
V_86 ) ) ||
F_176 ( V_302 , V_364 ,
F_15 ( & V_76 -> V_103 ) ) ||
F_176 ( V_302 , V_365 , V_76 -> V_108 ) ||
F_176 ( V_302 , V_366 , V_76 -> V_110 ) ||
F_176 ( V_302 , V_367 ,
F_15 ( & V_76 -> V_128 ) ) ||
F_176 ( V_302 , V_368 ,
F_15 ( & V_76 -> V_129 ) ) ||
...
F_15 ( & V_76 -> V_130 ) ) )
goto V_317;
if ( F_174 ( V_302 , V_370 , & V_76 -> V_77 ) )
goto V_317;
F_178 ( V_302 , V_359 ) ;
return 0 ;
V_317:
...
static int F_200 ( struct V_301 * V_302 , struct V_75 * V_76 ,
struct V_333 * V_334 )
{
void * V_335 ;
V_335 = F_185 ( V_302 , F_186 ( V_334 -> V_302 ) . V_336 , V_334 -> V_337 -> V_338 ,
...
static int F_201 ( struct V_301 * V_302 ,
struct V_333 * V_334 )
{
int V_158 = 0 ;
int V_213 = V_334 -> args [ 0 ] ;
...
struct V_2 * V_2 = F_190 ( V_302 ) ;
F_113 ( & V_160 ) ;
if ( F_202 ( V_334 -> V_337 , V_373 , V_345 ,
V_372 , V_374 ) )
goto V_145;
V_54 = F_197 ( V_2 , V_345 [ V_321 ] ) ;
if ( F_203 ( V_54 ) || V_54 == NULL )
goto V_145;
F_36 (dest, &svc->destinations, n_list) {
if ( ++ V_158 <= V_213 )
continue;
if ( F_200 ( V_302 , V_76 , V_334 ) < 0 ) {
V_158 -- ;
goto V_317;
}
}
...
return - V_121 ;
memset ( V_100 , 0 , sizeof( * V_100 ) ) ;
F_195 ( & V_100 -> V_4 , V_351 , sizeof( V_100 -> V_4 ) ) ;
V_100 -> V_43 = F_193 ( V_348 ) ;
if ( V_343 ) {
...
return - V_121 ;
V_100 -> V_102 = F_194 ( V_377 )
& V_86 ;
V_100 -> V_103 = F_194 ( V_378 ) ;
V_100 -> V_108 = F_194 ( V_379 ) ;
V_100 -> V_110 = F_194 ( V_380 ) ;
}
return 0 ;
}
...
{
struct V_304 * V_381 ;
V_381 = F_175 ( V_302 , V_382 ) ;
if ( ! V_381 )
return - V_306 ;
if ( F_176 ( V_302 , V_383 , V_254 ) ||
F_183 ( V_302 , V_384 , V_255 ) ||
F_176 ( V_302 , V_385 , V_256 ) )
goto V_317;
F_178 ( V_302 , V_381 ) ;
return 0 ;
V_317:
...
static int F_206 ( struct V_301 * V_302 , T_2 V_254 ,
const char * V_255 , T_2 V_256 ,
struct V_333 * V_334 )
{
void * V_335 ;
...
if ( ! V_335 )
return - V_306 ;
if ( F_205 ( V_302 , V_254 , V_255 , V_256 ) )
goto V_317;
return F_187 ( V_302 , V_335 ) ;
V_317:
F_188 ( V_302 , V_335 ) ;
...
static int F_207 ( struct V_301 * V_302 ,
struct V_333 * V_334 )
{
struct V_2 * V_2 = F_190 ( V_302 ) ;
struct V_14 * V_15 = F_41 ( V_2 ) ;
...
static int F_210 ( struct V_2 * V_2 , struct V_304 * * V_345 )
{
struct V_216 V_300 ;
F_170 ( V_2 , & V_300 ) ;
if ( V_345 [ V_387 ] )
V_300 . V_221 = F_194 ( V_345 [ V_387 ] ) ;
if ( V_345 [ V_388 ] )
V_300 . V_222 =
F_194 ( V_345 [ V_388 ] ) ;
if ( V_345 [ V_389 ] )
V_300 . V_223 = F_194 ( V_345 [ V_389 ] ) ;
return F_152 ( V_2 , & V_300 ) ;
}
...
static int F_213 ( struct V_301 * V_302 , struct V_390 * V_293 )
{
struct V_301 * V_405 ;
void * V_406 ;
...
V_405 = F_214 ( V_412 , V_124 ) ;
if ( ! V_405 )
return - V_125 ;
F_113 ( & V_160 ) ;
V_406 = F_215 ( V_405 , V_293 , & V_339 , 0 , V_407 ) ;
if ( V_406 == NULL )
goto V_317;
switch ( V_236 ) {
case V_408 :
...
#endif
#ifdef V_218
if ( F_176 ( V_405 , V_389 , V_300 . V_223 ) )
goto V_317;
#endif
break;
}
case V_409 :
if ( F_176 ( V_405 , V_413 ,
V_199 ) ||
F_176 ( V_405 , V_414 ,
V_200 ) )
goto V_317;
...
F_86 ( & V_15 -> V_33 ) ;
if ( ! F_38 ( V_2 , & V_417 ) ) {
V_416 = F_225 ( V_418 , sizeof( V_418 ) , V_124 ) ;
if ( V_416 == NULL )
return - V_125 ;
} else
V_416 = V_418 ;
...
V_15 -> V_434 = F_228 ( int , V_435 , 0 , 3 ) ;
V_416 [ V_158 ++ ] . V_180 = & V_15 -> V_434 ;
V_416 [ V_158 ++ ] . V_180 = & V_15 -> V_436 ;
V_15 -> V_437 = 1 ;
V_416 [ V_158 ++ ] . V_180 = & V_15 -> V_437 ;
V_15 -> V_438 = F_229 ( V_2 , L_63 , V_416 ) ;
if ( V_15 -> V_438 == NULL ) {
if ( ! F_38 ( V_2 , & V_417 ) )
F_51 ( V_416 ) ;
return - V_125 ;
...
F_236 ( V_2 , L_64 , 0 , & V_441 ) ;
F_236 ( V_2 , L_65 , 0 , & V_442 ) ;
F_236 ( V_2 , L_66 , 0 ,
& V_443 ) ;
if ( F_224 ( V_2 ) )
goto V_444;
