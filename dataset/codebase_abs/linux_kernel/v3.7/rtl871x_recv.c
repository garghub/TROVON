...
memcpy ( V_101 -> V_110 , F_46 ( V_80 ) , V_114 ) ;
memcpy ( V_101 -> V_113 , F_47 ( V_80 ) , V_114 ) ;
memcpy ( V_101 -> V_115 , F_48 ( V_80 ) , V_114 ) ;
...
static T_1 F_50 ( struct V_8 * V_15 ,
union V_11 * V_72 ,
struct V_47 * * V_84 )
{
V_3 * V_80 = V_72 -> V_23 . V_26 . V_60 ;
...
if ( ( F_51 ( V_80 ) & V_123 ) ==
V_123 ) {
if ( F_51 ( V_80 ) & ( F_52 ( 4 ) | F_52 ( 5 ) | F_52 ( 6 ) ) )
return V_20 ;
}
if ( ! memcmp ( V_106 , V_101 -> V_113 , V_114 ) )
return V_20 ;
...
static T_1 F_56 ( struct V_8 * V_15 ,
union V_11 * V_72 )
{
int V_36 ;
V_3 V_92 ;
...
V_36 = F_50 ( V_15 , V_72 , & V_84 ) ;
break;
case 2 :
memcpy ( V_101 -> V_59 , V_126 , V_114 ) ;
memcpy ( V_101 -> V_56 , V_124 , V_114 ) ;
V_36 = F_53 ( V_15 , V_72 , & V_84 ) ;
break;
case 3 :
memcpy ( V_101 -> V_59 , F_46 ( V_80 ) , V_114 ) ;
memcpy ( V_101 -> V_56 , F_47 ( V_80 ) , V_114 ) ;
return V_20 ;
default:
return V_20 ;
}
...
V_101 -> V_128 = 0 ;
if ( V_101 -> V_129 == 1 ) {
V_101 -> V_69 = F_61 ( ( V_80 + 24 ) ) ;
V_101 -> V_130 = F_62 ( ( V_80 + 24 ) ) ;
V_101 -> V_128 = F_63 ( ( V_80 + 24 ) ) ;
...
return V_20 ;
if ( V_101 -> V_136 ) {
F_64 ( V_53 , V_84 , V_101 -> V_57 ,
F_29 ( V_101 -> V_59 ) ) ;
F_65 ( V_101 -> V_67 , V_101 -> V_68 ,
V_101 -> V_57 ) ;
} else {
V_101 -> V_57 = 0 ;
...
type = F_67 ( V_80 ) ;
V_137 = F_51 ( V_80 ) ;
V_101 -> V_127 = F_68 ( V_80 ) ;
V_101 -> V_98 = F_69 ( V_80 ) ;
V_101 -> V_97 = F_70 ( V_80 ) ;
V_101 -> V_140 = F_71 ( V_80 ) ;
V_101 -> V_141 = F_72 ( V_80 ) ;
V_101 -> V_142 = F_73 ( V_80 ) ;
V_101 -> V_136 = F_74 ( V_80 ) ;
V_101 -> V_131 = F_75 ( V_80 ) ;
switch ( type ) {
case V_143 :
...
break;
case V_145 :
V_101 -> V_129 = ( V_137 & F_52 ( 7 ) ) ? 1 : 0 ;
V_138 = F_56 ( V_15 , V_72 ) ;
break;
default:
return V_20 ;
}
...
* ( V_80 + 1 ) = 0x12 ;
V_147 = 0x8712 ;
V_80 = F_77 ( V_12 , ( V_146 -
sizeof( struct V_157 ) + 2 ) - 24 ) ;
memcpy ( V_80 , F_78 ( V_12 ) , 24 ) ;
V_80 += 24 ;
} else
V_80 = F_77 ( V_12 , ( V_146 -
