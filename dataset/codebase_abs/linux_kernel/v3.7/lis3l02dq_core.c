...
static T_7 F_20 ( struct V_58 * V_28 ,
struct V_59 * V_60 ,
char * V_61 )
{
...
static T_7 F_22 ( struct V_58 * V_28 ,
struct V_59 * V_60 ,
const char * V_61 ,
T_8 V_20 )
{
...
static int T_10 F_35 ( struct V_101 * V_102 )
{
int V_12 ;
struct V_8 * V_9 ;
struct V_4 * V_5 ;
...
V_9 -> V_22 = V_102 ;
F_38 ( & V_9 -> V_21 ) ;
V_5 -> V_104 = V_102 -> V_28 . V_105 -> V_104 ;
V_5 -> V_28 . V_106 = & V_102 -> V_28 ;
V_5 -> V_107 = & V_108 ;
V_5 -> V_109 = V_110 ;
V_5 -> V_111 = F_39 ( V_110 ) ;
V_5 -> V_112 = V_113 ;
V_12 = F_40 ( V_5 ) ;
if ( V_12 )
goto V_114;
...
if ( V_102 -> V_1 && F_43 ( F_44 ( V_102 -> V_1 ) ) > 0 ) {
...
return 0 ;
V_121:
if ( V_102 -> V_1 && F_43 ( F_44 ( V_102 -> V_1 ) ) )
F_48 ( V_5 ) ;
V_120:
if ( V_102 -> V_1 && F_43 ( F_44 ( V_102 -> V_1 ) ) > 0 )
...
static int T_11 F_54 ( struct V_101 * V_102 )
{
