...
F_90 ( ! V_301 ) ;
if ( F_45 ( V_6 -> V_332 ) && V_6 -> V_333 == V_334 )
goto V_332;
V_307 = F_154 ( V_6 , V_4 ) ;
if ( ! V_307 )
break;
...
void F_179 ( struct V_1 * V_2 , unsigned int V_305 ,
int V_303 )
{
if ( F_45 ( V_2 -> V_185 == V_336 ) )
return;
if ( F_55 ( V_2 , V_305 , V_303 , 0 ,
F_180 ( V_2 , V_191 ) ) )
F_181 ( V_2 ) ;
}
void F_182 ( struct V_1 * V_2 , unsigned int V_251 )
{
struct V_3 * V_4 = F_162 ( V_2 ) ;
F_90 ( ! V_4 || V_4 -> V_71 < V_251 ) ;
F_55 ( V_2 , V_251 , V_306 , 1 , V_2 -> V_337 ) ;
}
T_4 F_29 ( struct V_1 * V_2 )
{
struct V_29 * V_30 = F_18 ( V_2 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_15 = V_30 -> V_33 . V_338 ;
int V_339 = F_183 ( V_2 ) ;
int V_340 = F_26 ( int , V_6 -> V_41 , F_184 ( V_2 ) ) ;
int V_236 ;
if ( V_15 > V_340 )
V_15 = V_340 ;
if ( V_339 < ( V_340 >> 1 ) ) {
...
if ( V_236 <= V_339 - V_15 || V_236 > V_339 )
V_236 = ( V_339 / V_15 ) * V_15 ;
else if ( V_15 == V_340 &&
V_339 > V_236 + ( V_340 >> 1 ) )
V_236 = V_339 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_3 * V_343 = F_187 ( V_2 , V_4 ) ;
int V_344 , V_345 ;
V_344 = V_4 -> V_71 ;
V_345 = V_343 -> V_71 ;
F_90 ( F_5 ( V_4 ) != 1 || F_5 ( V_343 ) != 1 ) ;
F_188 ( V_2 , V_343 , V_4 ) ;
F_172 ( V_343 , V_2 ) ;
F_189 ( V_343 , F_128 ( V_4 , V_345 ) ,
V_345 ) ;
if ( V_343 -> V_79 == V_80 )
V_4 -> V_79 = V_80 ;
if ( V_4 -> V_79 != V_80 )
V_4 -> V_81 = F_190 ( V_4 -> V_81 , V_343 -> V_81 , V_344 ) ;
F_4 ( V_4 ) -> V_10 = F_4 ( V_343 ) -> V_10 ;
F_4 ( V_4 ) -> V_58 |= F_4 ( V_343 ) -> V_58 ;
F_4 ( V_4 ) -> V_82 |= F_4 ( V_343 ) -> V_82 & V_346 ;
F_191 ( V_6 ) ;
if ( V_343 == V_6 -> V_347 )
V_6 -> V_347 = V_4 ;
F_118 ( V_2 , V_343 , F_5 ( V_343 ) ) ;
F_173 ( V_2 , V_343 ) ;
}
static bool F_192 ( const struct V_1 * V_2 , const struct V_3 * V_4 )
{
if ( F_5 ( V_4 ) > 1 )
return false ;
if ( F_38 ( V_4 ) -> V_271 != 0 )
...
static void F_193 ( struct V_1 * V_2 , struct V_3 * V_348 ,
int V_45 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
if ( F_176 ( & V_2 -> V_215 ) >
F_17 ( V_2 -> V_250 + ( V_2 -> V_250 >> 2 ) , V_2 -> V_352 ) )
return - V_353 ;
...
F_4 ( V_4 ) -> V_160 = V_19 ;
if ( F_45 ( V_357 && ( ( unsigned long ) V_4 -> V_192 & 3 ) ) ) {
struct V_3 * V_321 = F_198 ( V_4 , V_358 ,
V_191 ) ;
return V_321 ? F_89 ( V_2 , V_321 , 0 , V_191 ) :
- V_225 ;
} else {
return F_89 ( V_2 , V_4 , 1 , V_191 ) ;
}
}
int F_199 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_222 = F_195 ( V_2 , V_4 ) ;
if ( V_222 == 0 ) {
F_200 ( F_105 ( V_2 ) , V_359 ) ;
V_6 -> V_360 ++ ;
#if V_361 > 0
if ( F_4 ( V_4 ) -> V_82 & V_258 ) {
F_201 ( L_1 ) ;
...
break;
V_369 = V_373 ;
} else if ( ! F_8 ( F_4 ( V_4 ) -> V_72 , V_6 -> V_371 ) ) {
V_6 -> V_371 = V_368 ;
if ( ! F_202 ( V_2 ) )
break;
if ( V_367 != NULL ) {
...
if ( V_367 == NULL && ! ( V_82 & ( V_258 | V_257 ) ) )
V_367 = V_4 ;
continue;
} else {
V_368 = F_4 ( V_4 ) -> V_10 ;
...
continue;
if ( F_199 ( V_2 , V_4 ) ) {
F_206 ( F_105 ( V_2 ) , V_377 ) ;
return;
}
F_206 ( F_105 ( V_2 ) , V_369 ) ;
if ( F_178 ( V_2 ) )
V_6 -> V_335 += F_5 ( V_4 ) ;
if ( V_4 == F_204 ( V_2 ) )
F_207 ( V_2 , V_378 ,
...
F_179 ( V_2 , V_251 , V_380 ) ;
}
void F_212 ( struct V_1 * V_2 , T_11 V_381 )
{
struct V_3 * V_4 ;
V_4 = F_213 ( V_358 , V_381 ) ;
if ( ! V_4 ) {
F_214 ( F_105 ( V_2 ) , V_382 ) ;
return;
}
F_211 ( V_4 , V_358 ) ;
F_40 ( V_4 , F_7 ( V_2 ) ,
V_244 | V_383 ) ;
F_4 ( V_4 ) -> V_160 = V_19 ;
if ( F_89 ( V_2 , V_4 , 0 , V_381 ) )
F_214 ( F_105 ( V_2 ) , V_382 ) ;
F_200 ( F_105 ( V_2 ) , V_384 ) ;
}
...
if ( F_92 ( V_4 ) ) {
struct V_3 * V_321 = F_217 ( V_4 , V_191 ) ;
if ( V_321 == NULL )
return - V_269 ;
F_172 ( V_4 , V_2 ) ;
F_109 ( V_321 ) ;
...
struct V_3 * F_219 ( struct V_1 * V_2 , struct V_13 * V_14 ,
struct V_64 * V_65 ,
struct V_387 * V_388 ,
struct V_135 * V_136 )
{
struct V_95 V_96 ;
struct V_172 * V_173 = F_220 ( V_388 ) ;
struct V_174 * V_175 = F_34 ( V_65 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
int V_15 ;
int V_389 = 0 ;
if ( V_146 != NULL && V_146 -> V_390 && V_146 -> V_389 )
V_389 = V_146 -> V_389 ;
V_4 = F_213 ( V_358 + 15 + V_389 ,
F_180 ( V_2 , V_191 ) ) ;
if ( F_45 ( ! V_4 ) ) {
F_221 ( V_14 ) ;
return NULL ;
...
F_222 ( V_4 , V_14 ) ;
V_15 = F_12 ( V_14 ) ;
if ( V_6 -> V_54 . V_391 && V_6 -> V_54 . V_391 < V_15 )
V_15 = V_6 -> V_54 . V_391 ;
if ( V_65 -> V_40 == 0 ) {
T_5 V_43 ;
V_65 -> V_41 = V_6 -> V_41 ? : F_223 ( V_14 , V_392 ) ;
if ( V_2 -> V_393 & V_394 &&
( V_65 -> V_41 > F_184 ( V_2 ) || V_65 -> V_41 == 0 ) )
V_65 -> V_41 = F_184 ( V_2 ) ;
F_24 ( F_184 ( V_2 ) ,
...
#ifdef F_224
if ( F_45 ( V_65 -> V_396 ) )
F_4 ( V_4 ) -> V_160 = F_225 ( V_65 ) ;
else
#endif
F_4 ( V_4 ) -> V_160 = V_19 ;
V_221 = F_51 ( V_2 , V_65 , V_15 ,
V_4 , & V_96 , & V_144 , V_173 , V_136 )
+ sizeof( * V_67 ) ;
F_97 ( V_4 , V_221 ) ;
F_98 ( V_4 ) ;
V_67 = F_37 ( V_4 ) ;
...
V_67 -> V_398 = 1 ;
F_33 ( V_65 , V_67 ) ;
V_67 -> V_230 = V_175 -> V_399 ;
V_67 -> V_232 = V_175 -> V_400 ;
F_40 ( V_4 , F_52 ( V_65 ) -> V_401 ,
V_85 | V_244 ) ;
if ( V_99 & V_96 . V_97 ) {
if ( V_389 ) {
T_8 * V_402 = F_128 ( V_4 , V_389 ) ;
memcpy ( V_402 , V_146 -> V_403 , V_389 ) ;
F_4 ( V_4 ) -> V_10 += V_389 ;
}
if ( V_96 . V_117 > 0 ) {
T_1 V_404 [ V_405 ] ;
T_4 * V_406 = & V_173 -> V_407 [ V_408 ] ;
T_4 * V_409 = & V_406 [ V_410 - 1 ] ;
* V_409 -- ^= V_96 . V_114 ;
* V_409 -- ^= F_52 ( V_65 ) -> V_411 + 1 ;
* V_409 -- ^= F_4 ( V_4 ) -> V_72 + 1 ;
* V_409 -- ^= ( ( ( V_412 T_4 ) V_67 -> V_232 << 16 ) | ( V_412 T_4 ) V_67 -> V_230 ) ;
* V_409 -- ^= ( T_4 ) ( unsigned long ) V_146 ;
F_226 ( ( T_1 * ) & V_173 -> V_407 [ 0 ] ,
( char * ) V_406 ,
& V_404 [ 0 ] ) ;
V_96 . V_105 =
( T_5 * ) & V_173 -> V_407 [ 0 ] ;
...
V_67 -> V_234 = F_46 ( F_52 ( V_65 ) -> V_56 ) ;
...
#endif
if ( V_6 -> V_54 . V_391 )
V_6 -> V_54 . V_284 = V_6 -> V_54 . V_391 ;
V_6 -> V_414 = 0 ;
F_146 ( V_2 ) ;
F_147 ( V_2 , F_149 ( V_14 ) ) ;
if ( ! V_6 -> V_41 )
V_6 -> V_41 = F_223 ( V_14 , V_392 ) ;
V_6 -> V_16 = F_12 ( V_14 ) ;
if ( V_6 -> V_54 . V_391 && V_6 -> V_54 . V_391 < V_6 -> V_16 )
V_6 -> V_16 = V_6 -> V_54 . V_391 ;
F_228 ( V_2 ) ;
if ( V_2 -> V_393 & V_394 &&
( V_6 -> V_41 > F_184 ( V_2 ) || V_6 -> V_41 == 0 ) )
V_6 -> V_41 = F_184 ( V_2 ) ;
F_24 ( F_184 ( V_2 ) ,
V_6 -> V_16 - ( V_6 -> V_54 . V_415 ? V_6 -> V_70 - sizeof( struct V_66 ) : 0 ) ,
& V_6 -> V_40 ,
& V_6 -> V_41 ,
V_163 ,
& V_43 ,
...
static int F_234 ( struct V_1 * V_2 , struct V_3 * V_397 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_152 * V_421 = V_6 -> V_154 ;
int V_422 = 0 , V_45 , V_211 , V_222 = 0 , V_423 = V_421 -> V_192 -> V_424 ;
struct V_3 * V_425 = NULL , * V_192 ;
unsigned long V_426 = 0 ;
V_6 -> V_54 . V_284 = V_6 -> V_16 ;
F_235 ( V_2 , & V_6 -> V_54 . V_284 , & V_421 -> V_167 ,
& V_422 , & V_426 ) ;
if ( V_422 > 1 &&
F_236 ( V_317 , V_426 + ( 60 * V_427 << V_422 ) ) ) {
V_421 -> V_167 . V_71 = - 1 ;
goto V_428;
}
if ( V_429 & V_430 )
V_421 -> V_167 . V_71 = - 1 ;
else if ( V_421 -> V_167 . V_71 <= 0 )
goto V_428;
if ( V_6 -> V_54 . V_391 && V_6 -> V_54 . V_391 < V_6 -> V_54 . V_284 )
V_6 -> V_54 . V_284 = V_6 -> V_54 . V_391 ;
V_45 = F_143 ( V_2 , F_18 ( V_2 ) -> V_294 ) -
V_149 ;
V_425 = F_237 ( V_397 , F_238 ( V_397 ) , V_45 ,
V_2 -> V_337 ) ;
if ( V_425 == NULL )
goto V_428;
for ( V_211 = 0 ; V_211 < V_423 && V_425 -> V_71 < V_45 ; ++ V_211 ) {
struct V_431 * V_432 = & V_421 -> V_192 -> V_433 [ V_211 ] ;
unsigned char T_12 * V_434 = V_432 -> V_435 ;
int V_71 = V_432 -> V_436 ;
if ( V_425 -> V_71 + V_71 > V_45 )
V_71 = V_45 - V_425 -> V_71 ;
else if ( V_211 + 1 == V_423 )
V_421 -> V_192 = NULL ;
if ( F_239 ( V_425 , V_434 , V_71 ) )
goto V_428;
}
V_192 = F_93 ( V_425 , V_2 -> V_337 ) ;
if ( V_192 == NULL )
goto V_428;
F_4 ( V_192 ) -> V_72 ++ ;
F_4 ( V_192 ) -> V_58 &= ~ V_85 ;
...
F_232 ( V_2 , V_192 ) ;
V_421 -> V_437 = V_192 -> V_71 ;
if ( F_89 ( V_2 , V_425 , 0 , V_2 -> V_337 ) == 0 ) {
V_6 -> V_425 = ( V_421 -> V_437 > 0 ) ;
F_214 ( F_105 ( V_2 ) , V_438 ) ;
goto V_439;
}
V_425 = NULL ;
V_428:
if ( V_421 -> V_167 . V_71 > 0 )
V_421 -> V_167 . V_71 = 0 ;
V_222 = F_89 ( V_2 , V_397 , 1 , V_2 -> V_337 ) ;
if ( V_222 )
V_6 -> V_169 = 0 ;
F_240 ( V_425 ) ;
V_439:
...
int V_222 ;
F_227 ( V_2 ) ;
V_264 = F_209 ( V_358 + 15 , V_2 -> V_337 ) ;
if ( F_45 ( V_264 == NULL ) )
return - V_225 ;
F_211 ( V_264 , V_358 ) ;
F_40 ( V_264 , V_6 -> V_249 ++ , V_85 ) ;
V_6 -> V_364 = F_4 ( V_264 ) -> V_160 = V_19 ;
F_232 ( V_2 , V_264 ) ;
F_32 ( V_2 , V_264 ) ;
V_222 = V_6 -> V_154 ? F_234 ( V_2 , V_264 ) :
F_89 ( V_2 , V_264 , 1 , V_2 -> V_337 ) ;
if ( V_222 == - V_440 )
return V_222 ;
V_6 -> V_9 = V_6 -> V_249 ;
V_6 -> V_441 = V_6 -> V_249 ;
F_200 ( F_105 ( V_2 ) , V_442 ) ;
F_207 ( V_2 , V_378 ,
F_18 ( V_2 ) -> V_26 , V_379 ) ;
return 0 ;
}
...
int V_445 = V_427 / 2 ;
if ( V_30 -> V_33 . V_36 ||
( V_30 -> V_33 . V_446 & V_447 ) )
V_445 = V_448 ;
if ( V_6 -> V_449 ) {
int V_450 = F_19 ( V_6 -> V_449 >> 3 , V_444 ) ;
if ( V_450 < V_445 )
V_445 = V_450 ;
}
V_35 = F_17 ( V_35 , V_445 ) ;
}
V_443 = V_317 + V_35 ;
if ( V_30 -> V_33 . V_446 & V_451 ) {
if ( V_30 -> V_33 . V_452 ||
F_243 ( V_30 -> V_33 . V_443 , V_317 + ( V_35 >> 2 ) ) ) {
F_244 ( V_2 ) ;
return;
}
if ( ! F_236 ( V_443 , V_30 -> V_33 . V_443 ) )
V_443 = V_30 -> V_33 . V_443 ;
}
V_30 -> V_33 . V_446 |= V_453 | V_451 ;
V_30 -> V_33 . V_443 = V_443 ;
F_245 ( V_2 , & V_30 -> V_454 , V_443 ) ;
}
...
if ( V_2 -> V_185 == V_336 )
return;
V_264 = F_213 ( V_358 , F_180 ( V_2 , V_191 ) ) ;
if ( V_264 == NULL ) {
F_246 ( V_2 ) ;
F_18 ( V_2 ) -> V_33 . V_35 = V_455 ;
F_207 ( V_2 , V_38 ,
V_448 , V_379 ) ;
return;
}
...
F_89 ( V_2 , V_264 , 0 , F_180 ( V_2 , V_191 ) ) ;
}
static int F_247 ( struct V_1 * V_2 , int V_456 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_3 * V_4 ;
V_4 = F_213 ( V_358 , F_180 ( V_2 , V_191 ) ) ;
if ( V_4 == NULL )
return - 1 ;
F_211 ( V_4 , V_358 ) ;
F_40 ( V_4 , V_6 -> V_87 - ! V_456 , V_244 ) ;
F_4 ( V_4 ) -> V_160 = V_19 ;
...
unsigned int V_459 = F_9 ( V_6 ) - F_4 ( V_4 ) -> V_72 ;
if ( F_8 ( V_6 -> V_441 , F_4 ( V_4 ) -> V_10 ) )
V_6 -> V_441 = F_4 ( V_4 ) -> V_10 ;
if ( V_459 < F_4 ( V_4 ) -> V_10 - F_4 ( V_4 ) -> V_72 ||
V_4 -> V_71 > V_15 ) {
V_459 = F_17 ( V_459 , V_15 ) ;
F_4 ( V_4 ) -> V_58 |= V_270 ;
if ( F_121 ( V_2 , V_4 , V_459 , V_15 ) )
return - 1 ;
} else if ( ! F_5 ( V_4 ) )
F_112 ( V_2 , V_4 , V_15 ) ;
F_4 ( V_4 ) -> V_58 |= V_270 ;
...
if ( F_250 ( V_6 -> V_88 , V_6 -> V_87 + 1 , V_6 -> V_87 + 0xFFFF ) )
F_247 ( V_2 , 1 ) ;
return F_247 ( V_2 , 0 ) ;
}
}
...
V_30 -> V_460 ++ ;
F_207 ( V_2 , V_463 ,
F_17 ( V_30 -> V_26 << V_30 -> V_461 , V_379 ) ,
V_379 ) ;
} else {
if ( ! V_30 -> V_460 )
V_30 -> V_460 = 1 ;
F_207 ( V_2 , V_463 ,
F_17 ( V_30 -> V_26 << V_30 -> V_461 ,
V_464 ) ,
V_379 ) ;
}
}
