...
V_115 . V_17 . V_18 =
V_94 ;
V_115 . V_20 . V_21 . V_117 . V_45 = V_45 ;
V_118:
...
F_27 ( & V_4 -> V_123 , V_78 ) ;
if ( V_87 -> V_45 != V_46 )
V_87 -> V_124 -> V_45 = V_125 ;
V_87 -> V_124 -> V_126 -- ;
if ( V_87 -> V_124 -> V_126 == 0 ) {
V_121 = true ;
V_114 = V_87 -> V_96 . V_127 . V_128 ;
V_45 = V_87 -> V_124 -> V_45 ;
F_48 ( & V_87 -> V_124 -> V_80 ,
& V_4 -> V_129 ) ;
}
F_48 ( & V_87 -> V_80 , & V_4 -> V_129 ) ;
F_28 ( & V_4 -> V_123 , V_78 ) ;
if ( V_121 )
F_45 ( V_3 , V_114 , V_45 ) ;
}
...
F_27 ( & V_4 -> V_123 , V_78 ) ;
while ( ! F_51 ( & V_4 -> V_129 ) ) {
F_52 ( V_4 -> V_129 . V_137 , & V_134 ) ;
...
V_132 = (struct V_132 * ) V_134 . V_137 ;
F_32 ( & V_132 -> V_80 ) ;
V_132 -> V_45 = V_46 ;
V_132 -> V_126 = V_126 - 1 ;
if ( V_132 -> V_126 != V_131 -> V_138 ) {
F_11 ( V_5 , L_27
L_28 ,
V_131 -> V_138 , V_132 -> V_126 ) ;
}
for ( V_133 = 0 ; V_133 < ( V_126 - 1 ) ; V_133 ++ ) {
V_76 = (struct V_75 * ) V_134 . V_137 ;
F_32 ( & V_76 -> V_80 ) ;
V_76 -> V_45 = V_46 ;
V_76 -> V_124 = V_132 ;
V_76 -> V_96 . V_127 . V_140 =
F_47 ;
V_76 -> V_96 . V_127 . V_141 =
V_76 ;
V_76 -> V_3 = V_3 ;
V_76 -> V_96 . V_127 . V_128 =
V_131 -> V_139 . V_95 ;
V_76 -> V_142 = ( void * ) ( ( unsigned long ) V_4 ->
V_28 + V_131 -> V_143 [ V_133 ] . V_144 ) ;
V_76 -> V_145 =
V_131 -> V_143 [ V_133 ] . V_146 ;
F_53 ( V_3 , V_76 ) ;
F_47 ( V_76 ->
V_96 . V_127 . V_141 ) ;
}
...
int V_151 = V_152 ;
struct V_4 * V_5 ;
V_87 = F_3 ( V_152 * sizeof( unsigned char ) ,
V_153 ) ;
if ( ! V_87 )
return;
V_150 = V_87 ;
...
V_5 = V_4 -> V_5 ;
do {
V_15 = F_55 ( V_3 -> V_25 , V_150 , V_151 ,
& V_147 , & V_148 ) ;
if ( V_15 == 0 ) {
if ( V_147 > 0 ) {
V_149 = (struct V_86 * ) V_150 ;
switch ( V_149 -> type ) {
case V_119 :
F_35 ( V_3 , V_149 ) ;
break;
...
int F_57 ( struct V_2 * V_3 , void * V_156 )
{
int V_15 = 0 ;
int V_133 ;
int V_157 =
( (struct V_158 * ) V_156 ) -> V_157 ;
struct V_1 * V_4 ;
...
F_60 ( & V_4 -> V_42 ) ;
V_15 = F_61 ( V_3 -> V_25 , V_157 * V_161 ,
V_157 * V_161 , NULL , 0 ,
F_54 , V_3 ) ;
if ( V_15 != 0 ) {
F_11 ( V_5 , L_33 , V_15 ) ;
