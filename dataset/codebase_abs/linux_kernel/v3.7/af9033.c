...
{
struct V_1 * V_2 = V_29 -> V_30 ;
struct V_65 * V_26 = & V_29 -> V_66 ;
int V_6 , V_21 , V_67 , V_68 ;
T_2 V_20 , V_7 [ 3 ] , V_69 ;
T_1 V_70 , V_71 , V_72 ;
F_10 ( & V_2 -> V_14 -> V_15 , L_13 ,
V_27 , V_26 -> V_73 , V_26 -> V_57 ) ;
switch ( V_26 -> V_57 ) {
case 6000000 :
V_69 = 0x00 ;
break;
...
if ( V_29 -> V_75 . V_76 . V_77 )
V_29 -> V_75 . V_76 . V_77 ( V_29 ) ;
if ( V_26 -> V_57 != V_2 -> V_57 ) {
for ( V_21 = 0 ; V_21 < F_14 ( V_78 ) ; V_21 ++ ) {
if ( V_78 [ V_21 ] . clock == V_2 -> V_11 . clock &&
V_78 [ V_21 ] . V_57 == V_26 -> V_57 ) {
break;
}
}
V_6 = F_1 ( V_2 , 0x800001 ,
V_78 [ V_21 ] . V_4 , sizeof( V_78 [ V_21 ] . V_4 ) ) ;
}
if ( V_26 -> V_57 != V_2 -> V_57 ) {
V_67 = V_2 -> V_11 . V_67 ? - 1 : 1 ;
for ( V_21 = 0 ; V_21 < F_14 ( V_41 ) ; V_21 ++ ) {
if ( V_41 [ V_21 ] . clock == V_2 -> V_11 . clock )
break;
}
V_72 = V_41 [ V_21 ] . V_42 ;
if ( V_29 -> V_75 . V_76 . V_79 )
V_29 -> V_75 . V_76 . V_79 ( V_29 , & V_70 ) ;
else
V_70 = 0 ;
V_68 = V_70 ;
while ( V_68 > ( V_72 / 2 ) )
...
V_6 = F_7 ( V_2 , 0x80f904 , V_69 , 0x03 ) ;
if ( V_6 < 0 )
goto V_40;
...
static int F_20 ( struct V_28 * V_29 , T_3 * V_105 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_6 ;
T_2 V_20 ;
...
static int F_21 ( struct V_28 * V_29 , T_4 * V_111 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_6 , V_21 , V_5 ;
T_2 V_7 [ 3 ] , V_20 ;
...
for ( V_21 = 0 ; V_21 < V_5 ; V_21 ++ ) {
V_20 = V_115 [ V_21 ] . V_111 ;
if ( V_112 < V_115 [ V_21 ] . V_4 )
break;
}
* V_111 = V_20 * 10 ;
return 0 ;
...
static int F_22 ( struct V_28 * V_29 , T_4 * V_119 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_6 ;
T_2 V_120 ;
V_6 = F_6 ( V_2 , 0x800048 , & V_120 ) ;
if ( V_6 < 0 )
goto V_40;
* V_119 = V_120 * 0xffff / 100 ;
return 0 ;
V_40:
F_10 ( & V_2 -> V_14 -> V_15 , L_11 , V_27 , V_6 ) ;
return V_6 ;
...
T_4 V_123 ;
T_2 V_7 [ 7 ] ;
if ( F_24 ( V_124 , V_2 -> V_125 + F_25 ( 500 ) ) ) {
V_6 = F_4 ( V_2 , 0x800032 , V_7 , sizeof( V_7 ) ) ;
if ( V_6 < 0 )
goto V_40;
V_123 = ( V_7 [ 1 ] << 8 ) + V_7 [ 0 ] ;
V_121 = ( V_7 [ 4 ] << 16 ) + ( V_7 [ 3 ] << 8 ) + V_7 [ 2 ] ;
V_122 = ( V_7 [ 6 ] << 8 ) + V_7 [ 5 ] ;
if ( V_122 < V_123 ) {
V_123 = 1000 ;
...
V_121 -= ( T_1 ) V_123 * 8 * 8 ;
V_122 *= 8 * 8 ;
V_2 -> V_126 = V_121 * ( 0xffffffff / V_122 ) ;
}
}
V_2 -> V_127 += V_123 ;
V_2 -> V_125 = V_124 ;
...
static int F_26 ( struct V_28 * V_29 , T_1 * V_126 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_6 ;
V_6 = F_23 ( V_2 ) ;
...
static int F_27 ( struct V_28 * V_29 , T_1 * V_128 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_6 ;
V_6 = F_23 ( V_2 ) ;
...
static int F_28 ( struct V_28 * V_29 , int V_129 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_6 ;
F_10 ( & V_2 -> V_14 -> V_15 , L_16 , V_27 , V_129 ) ;
V_6 = F_7 ( V_2 , 0x00fa04 , V_129 , 0x01 ) ;
if ( V_6 < 0 )
goto V_40;
return 0 ;
V_40:
...
struct V_28 * F_29 ( const struct V_130 * V_131 ,
struct V_132 * V_14 )
{
int V_6 ;
struct V_1 * V_2 ;
...
V_2 = F_30 ( sizeof( struct V_1 ) , V_133 ) ;
if ( V_2 == NULL )
goto V_40;
V_2 -> V_14 = V_14 ;
memcpy ( & V_2 -> V_11 , V_131 , sizeof( struct V_130 ) ) ;
...
memcpy ( & V_2 -> V_29 . V_75 , & V_135 , sizeof( struct V_136 ) ) ;
V_2 -> V_29 . V_30 = V_2 ;
return & V_2 -> V_29 ;
V_40:
F_12 ( V_2 ) ;
