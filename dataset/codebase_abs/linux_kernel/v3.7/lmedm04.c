...
const char * F_43 ( struct V_9 * V_10 , int V_114 )
{
struct V_15 * V_16 = V_10 -> V_17 ;
...
V_16 -> V_56 = V_64 ;
V_16 -> V_139 =
V_42 -> V_99 [ 0 ] -> V_147 . V_157 ;
V_42 -> V_99 [ 0 ] -> V_147 . V_158 =
F_53 ;
...
struct V_9 * V_10 = F_17 ( V_42 ) ;
struct V_15 * V_16 = F_15 ( V_42 ) ;
char * V_163 [] = { L_27 , L_37 , L_38 , L_39 , L_40 } ;
int V_6 = 0 ;
switch ( V_16 -> V_56 ) {
case V_57 :
if ( F_61 ( V_164 , V_42 -> V_99 [ 0 ] , 0xc0 ,
& V_10 -> V_150 , 1 ) )
V_6 = V_16 -> V_56 ;
break;
case V_62 :
if ( F_61 ( V_165 , V_42 -> V_99 [ 0 ] , & V_166 ,
& V_10 -> V_150 ) )
V_6 = V_16 -> V_56 ;
break;
case V_63 :
if ( F_61 ( V_167 , V_42 -> V_99 [ 0 ] , 0xc0 ,
& V_10 -> V_150 , V_168 ) )
V_6 = V_16 -> V_56 ;
break;
case V_64 :
...
{
struct V_15 * V_16 = V_10 -> V_17 ;
static T_1 V_169 [] = V_170 ;
static T_1 V_171 [] = V_172 ;
static T_1 V_13 [ 1 ] ;
int V_6 = 0 , V_4 = 3 , V_14 = 1 ;
F_26 ( & V_10 -> V_73 ) ;
if ( V_71 )
V_6 = F_6 ( V_10 , V_169 , V_4 , V_13 , V_14 ) ;
else
...
F_67 ( V_10 -> V_24 ) ;
F_68 ( V_10 -> V_24 ,
V_10 -> V_173 -> V_174 -> V_144 . V_175 , 1 ) ;
V_16 -> V_118 = V_118 ;
if ( F_28 ( V_10 ) == 0x44 ) {
* V_145 = F_43 ( V_10 , 0 ) ;
return V_176 ;
...
static int F_69 ( struct V_98 * V_99 , T_1 * V_177 ,
struct V_178 * V_127 )
{
struct V_41 * V_42 = F_39 ( V_99 ) ;
struct V_9 * V_10 = F_17 ( V_42 ) ;
