...
V_93 -> V_97 ( V_2 , V_107 ) ;
F_20 ( V_29 , L_3 ,
F_37 ( & F_38 ( V_105 ) -> V_108 ) ,
V_106 -> V_96 , '@' + F_28 ( V_105 -> V_4 -> V_6 ) ) ;
}
void F_39 ( struct V_1 * V_2 , bool V_109 )
{
struct V_9 * V_10 = V_2 -> V_10 ;
struct V_3 * V_4 = F_2 ( V_2 ) -> V_4 ;
if ( F_34 ( V_10 ) ) {
T_2 * V_110 = & F_40 ( V_10 ) -> V_110 [ F_28 ( V_4 -> V_6 ) - 1 ] ;
int V_111 = V_82 + F_1 ( V_2 ) ;
T_2 V_112 = F_15 ( V_10 , 0 , V_111 ) ;
if ( V_109 ) {
* V_110 |= 1 << V_4 -> V_96 ;
F_16 ( V_10 , 0 , V_111 , V_112 | V_102 ) ;
} else {
* V_110 &= ~ ( 1 << V_4 -> V_96 ) ;
if ( ! * V_110 )
F_16 ( V_10 , 0 , V_111 ,
...
( F_40 ( V_10 ) -> V_110 [ F_28 ( V_4 -> V_6 ) - 1 ] & ~ ( 1 << V_4 -> V_96 ) ) ;
}
...
struct V_9 * V_10 = V_2 -> V_10 ;
if ( F_34 ( V_10 ) )
V_105 -> V_114 . V_115 = F_15 ( V_10 , 0 , V_82 +
F_1 ( V_2 ) ) ;
}
...
int
F_47 ( struct V_26 * V_27 , struct V_3 * V_117 )
{
const struct V_92 * V_93 ;
struct F_2 * V_105 = NULL ;
struct V_9 * V_10 = V_27 -> V_10 ;
struct V_1 * V_2 ;
V_105 = F_48 ( sizeof( * V_105 ) , V_118 ) ;
if ( ! V_105 )
return - V_119 ;
V_2 = F_49 ( V_105 ) ;
V_105 -> V_4 = V_117 ;
V_105 -> V_6 = F_28 ( V_117 -> V_6 ) - 1 ;
if ( F_34 ( V_10 ) )
V_93 = & V_120 ;
else
V_93 = & V_121 ;
