...
int V_64 = V_2 -> V_8 . V_61 -> V_65 >> 28 ;
int V_66 = ( ( V_2 -> V_8 . V_61 -> V_65 & 0x0fff0000 ) >> 16 ) ;
T_3 V_45 ;
T_1 V_3 = V_2 -> V_67 -> V_68 . V_69 . V_70 [ V_63 ] ;
T_4 V_71 ;
int V_10 ;
if ( V_2 -> V_8 . V_61 -> V_72 . V_73 & V_74 )
return F_26 ( V_2 ,
V_75 ) ;
V_71 = V_66 ;
if ( V_64 )
V_71 += V_2 -> V_67 -> V_68 . V_69 . V_70 [ V_64 ] ;
if ( V_60 % 2 )
V_45 = V_2 -> V_67 -> V_68 . V_69 . V_70 [ V_60 ] ;
else
V_45 = V_2 -> V_67 -> V_68 . V_69 . V_70 [ V_60 + 1 ] ;
F_27 ( V_2 , V_71 , V_3 , V_45 ) ;
switch ( V_71 ) {
case V_76 :
V_2 -> V_77 . V_78 ++ ;
V_10 = F_1 ( V_2 , V_3 ,
& V_2 -> V_67 -> V_68 . V_69 . V_70 [ V_60 ] ) ;
break;
case V_79 :
V_2 -> V_77 . V_80 ++ ;
V_10 = F_16 ( V_2 , V_3 ) ;
...
if ( V_10 < 0 )
return V_10 ;
V_2 -> V_8 . V_61 -> V_72 . V_73 &= ~ ( 3ul << 44 ) ;
V_2 -> V_8 . V_61 -> V_72 . V_73 |= ( V_10 & 3ul ) << 44 ;
return 0 ;
}
