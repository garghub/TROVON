...
static int
F_39 ( struct V_1 * V_2 , struct V_68 * V_69 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = V_5 ( V_2 ) ;
T_1 V_108 , V_109 ;
...
F_40 ( V_4 , 0x001098 , 0x00000008 , 0x00000000 ) ;
F_41 ( V_4 , 0x001304 , 0x00000000 ) ;
if ( F_3 ( V_6 -> V_4 ) -> V_7 >= 0x92 )
F_41 ( V_4 , 0x001318 , 0x00000000 ) ;
for ( V_82 = 0 ; V_82 < V_69 -> V_104 / 4 ; V_82 ++ )
F_41 ( V_4 , V_108 + ( V_82 * 4 ) , V_69 -> V_110 . T_1 [ V_82 ] ) ;
F_40 ( V_4 , 0x001098 , 0x00000018 , 0x00000018 ) ;
F_41 ( V_4 , 0x00130c , V_109 ) ;
if ( ! F_42 ( V_4 , 0x001308 , 0x00000100 , 0x00000000 ) ) {
F_7 ( V_6 , L_4 ) ;
...
int
F_43 ( struct V_1 * V_2 , void * V_74 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_65 * V_66 = V_74 ;
struct V_112 V_15 ;
int V_53 = - V_113 ;
F_40 ( V_4 , 0x002504 , 0x00000001 , 0x00000001 ) ;
if ( ! F_42 ( V_4 , 0x002504 , 0x00000010 , 0x00000010 ) )
goto V_114;
if ( ! F_42 ( V_4 , 0x00251c , 0x0000003f , 0x0000003f ) )
goto V_114;
#define F_44 ( V_61 , V_62 ) nouveau_bios_run_init_table((a), (b), NULL, 0)
if ( V_66 -> V_70 . V_104 ) {
if ( ! F_45 ( V_2 , 'M' , & V_15 ) && V_15 . V_115 == 1 ) {
if ( V_15 . V_116 >= 6 )
F_44 ( V_2 , F_46 ( V_15 . V_74 [ 5 ] ) ) ;
if ( V_15 . V_116 >= 8 )
F_44 ( V_2 , F_46 ( V_15 . V_74 [ 7 ] ) ) ;
if ( V_15 . V_116 >= 10 )
F_44 ( V_2 , F_46 ( V_15 . V_74 [ 9 ] ) ) ;
F_44 ( V_2 , V_66 -> V_105 ) ;
}
V_53 = F_39 ( V_2 , & V_66 -> V_70 ) ;
if ( V_53 )
goto V_114;
}
V_53 = F_39 ( V_2 , & V_66 -> V_107 ) ;
V_114:
F_40 ( V_4 , 0x002504 , 0x00000001 , 0x00000000 ) ;
F_38 ( V_66 ) ;
return V_53 ;
}
