...
V_263 [ V_261 ] = V_248 ;
V_261 = ( V_261 + 1 ) & ( F_129 ( V_263 ) - 1 ) ;
V_258 = V_186 + V_175 ;
V_250:
T_5 = F_126 ( V_19 , V_175 , V_253 , V_248 ) ;
if ( ! T_5 ) {
if ( V_263 [ V_261 ] ) {
F_130 ( V_263 [ V_261 ] , V_253 ) ;
V_263 [ V_261 ] = NULL ;
}
V_257 = V_262 * ( V_175 / V_262 ) ;
V_186 += V_257 ;
V_175 -= V_257 ;
goto V_269;
}
...
bool F_132 ( struct V_1 * V_19 , const char * V_271 )
{
if ( ! ( F_99 ( V_19 -> V_17 ) & V_272 ) ) {
F_3 ( L_63 , V_271 ) ;
return false ;
}
return true ;
}
int F_133 ( struct V_73 * * V_273 ,
const char * V_274 , T_3 V_71 )
{
char * V_275 ;
enum V_276 V_65 ;
struct V_277 * V_278 ;
V_278 = F_22 ( sizeof( struct V_277 ) ) ;
if ( V_278 == NULL )
return - V_197 ;
V_278 -> V_58 = F_134 ( V_274 ) ;
if ( V_278 -> V_58 == NULL ) {
free ( V_278 ) ;
return - V_197 ;
}
V_275 = strchr ( V_278 -> V_58 , ']' ) ;
if ( V_275 )
* V_275 = '\0' ;
V_278 -> V_71 = V_71 ;
for ( V_65 = 0 ; V_65 < V_279 ; ++ V_65 ) {
struct V_280 * V_280 = F_135 ( V_273 [ V_65 ] ) ;
V_280 -> V_277 = V_278 ;
}
return 0 ;
}
T_2 F_136 ( struct V_1 * V_2 , T_13 * V_281 )
{
return F_137 ( & V_2 -> V_21 . V_282 , V_281 ) +
F_137 ( & V_2 -> V_21 . V_283 , V_281 ) +
F_138 ( & V_2 -> V_22 , V_281 ) ;
}
T_2 F_139 ( struct V_1 * V_2 , T_13 * V_281 ,
bool V_284 )
{
T_2 V_23 = F_140 ( & V_2 -> V_21 , V_281 , V_284 ) ;
return V_23 + F_141 ( & V_2 -> V_22 , V_281 , V_284 ) ;
}
T_2 F_142 ( struct V_1 * V_19 , T_13 * V_281 )
{
struct V_110 * V_285 ;
T_2 V_23 = fprintf ( V_281 , L_64 ) ;
V_23 += F_143 ( & V_19 -> V_41 , V_281 ) ;
F_144 (pos, &session->evlist->entries, node) {
V_23 += fprintf ( V_281 , L_65 , F_145 ( V_285 ) ) ;
V_23 += F_143 ( & V_285 -> V_41 , V_281 ) ;
}
return V_23 ;
}
T_2 F_146 ( struct V_1 * V_19 , T_13 * V_281 )
{
return F_147 ( & V_19 -> V_21 , V_281 ) ;
}
...
const char * V_291 , unsigned long * V_292 )
{
int V_65 ;
struct V_293 * V_73 ;
for ( V_65 = 0 ; V_65 < V_294 ; ++ V_65 ) {
struct V_110 * V_111 ;
...
void F_161 ( struct V_1 * V_19 , T_13 * V_281 ,
bool V_296 )
{
struct V_4 V_28 ;
int V_23 ;
if ( V_19 == NULL || V_281 == NULL )
return;
V_23 = F_5 ( V_19 -> V_8 , & V_28 ) ;
if ( V_23 == - 1 )
return;
fprintf ( V_281 , L_77 ) ;
fprintf ( V_281 , L_78 , ctime ( & V_28 . V_297 ) ) ;
F_162 ( V_19 , V_281 , V_296 ) ;
fprintf ( V_281 , L_79 ) ;
}
...
T_2 V_65 ;
int V_11 ;
for ( V_65 = 0 ; V_65 < V_300 ; V_65 ++ ) {
V_11 = - V_197 ;
V_303 = F_134 ( V_299 [ V_65 ] . V_58 ) ;
if ( V_303 == NULL )
goto V_31;
V_11 = - V_13 ;
V_58 = strchr ( V_303 , ':' ) ;
...
goto V_304;
* V_58 ++ = '\0' ;
V_302 = F_164 ( V_19 -> V_305 ,
V_303 , V_58 ) ;
if ( V_302 == NULL ) {
goto V_171;
}
V_111 = F_165 ( V_17 , V_302 -> V_155 ) ;
if ( V_111 == NULL )
goto V_171;
V_11 = - V_306 ;
if ( V_111 -> V_307 . V_308 != NULL )
goto V_304;
V_111 -> V_307 . V_308 = V_299 [ V_65 ] . V_307 ;
V_171:
free ( V_303 ) ;
}
V_11 = 0 ;
