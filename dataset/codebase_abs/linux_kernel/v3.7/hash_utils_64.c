...
V_14 = F_79 ( V_146 ) ;
V_23 = F_80 ( V_145 -> V_140 . V_172 , V_146 , V_14 ) ;
break;
case V_173 :
V_145 = & V_174 ;
V_23 = F_4 ( V_146 , V_90 ) ;
...
F_77 ( L_33 , V_145 , V_145 -> V_176 , V_23 ) ;
V_162 = V_145 -> V_176 ;
if ( V_162 == NULL )
return 1 ;
V_166 = F_81 ( F_82 () ) ;
...
F_8 ( F_78 ( V_146 ) != V_171 ) ;
#ifdef F_93
if ( F_94 ( F_67 ( V_145 , V_146 ) != V_145 -> V_140 . V_143 ) )
return;
#endif
F_77 ( L_44
L_45 , V_145 , V_145 -> V_176 , V_146 , V_159 , V_130 ) ;
V_162 = V_145 -> V_176 ;
if ( V_162 == NULL )
return;
...
int V_168 )
{
unsigned long V_21 , V_137 , V_18 , V_183 , V_184 ;
F_77 ( L_46 , V_24 ) ;
F_99 (pte, psize, vpn, index, shift) {
V_21 = F_7 ( V_24 , V_18 , V_14 ) ;
V_183 = F_100 ( V_129 , V_137 ) ;
if ( V_183 & V_185 )
V_21 = ~ V_21 ;
V_184 = ( V_21 & V_26 ) * V_27 ;
V_184 += V_183 & V_186 ;
F_77 ( L_47 , V_137 , V_184 , V_183 ) ;
V_28 . V_187 ( V_184 , V_24 , V_13 , V_14 , V_168 ) ;
} F_101 () ;
}
void F_102 ( unsigned long V_188 , int V_168 )
{
if ( V_28 . F_102 )
V_28 . F_102 ( V_188 , V_168 ) ;
else {
int V_189 ;
struct V_190 * V_191 =
& F_103 ( V_190 ) ;
for ( V_189 = 0 ; V_189 < V_188 ; V_189 ++ )
F_98 ( V_191 -> V_24 [ V_189 ] , V_191 -> V_129 [ V_189 ] ,
V_191 -> V_13 , V_191 -> V_14 , V_168 ) ;
}
}
void F_104 ( struct V_192 * V_193 , unsigned long V_194 , int V_70 )
{
if ( F_105 ( V_193 ) ) {
#ifdef F_106
if ( V_70 == - 2 )
F_107 ( V_195 , V_193 , V_196 , V_194 ) ;
else
#endif
F_107 ( V_197 , V_193 , V_198 , V_194 ) ;
} else
F_108 ( V_193 , V_194 , V_197 ) ;
}
static void F_109 ( unsigned long V_15 , unsigned long V_199 )
{
unsigned long V_21 , V_22 ;
unsigned long V_23 = F_4 ( V_15 , V_90 ) ;
unsigned long V_24 = F_5 ( V_15 , V_23 , V_90 ) ;
unsigned long V_200 = F_1 ( V_89 ) ;
int V_19 ;
...
F_110 ( & V_201 ) ;
F_8 ( V_33 [ V_199 ] & 0x80 ) ;
V_33 [ V_199 ] = V_19 | 0x80 ;
F_111 ( & V_201 ) ;
}
static void F_112 ( unsigned long V_15 , unsigned long V_199 )
{
unsigned long V_21 , V_183 , V_184 ;
unsigned long V_23 = F_4 ( V_15 , V_90 ) ;
unsigned long V_24 = F_5 ( V_15 , V_23 , V_90 ) ;
V_21 = F_7 ( V_24 , V_31 , V_90 ) ;
F_110 ( & V_201 ) ;
F_8 ( ! ( V_33 [ V_199 ] & 0x80 ) ) ;
V_183 = V_33 [ V_199 ] & 0x7f ;
V_33 [ V_199 ] = 0 ;
F_111 ( & V_201 ) ;
if ( V_183 & V_185 )
V_21 = ~ V_21 ;
V_184 = ( V_21 & V_26 ) * V_27 ;
V_184 += V_183 & V_186 ;
V_28 . V_187 ( V_184 , V_24 , V_74 , V_90 , 0 ) ;
}
void F_113 ( struct V_131 * V_131 , int V_202 , int V_203 )
{
unsigned long V_133 , V_15 , V_199 ;
int V_189 ;
F_96 ( V_133 ) ;
for ( V_189 = 0 ; V_189 < V_202 ; V_189 ++ , V_131 ++ ) {
V_15 = ( unsigned long ) F_114 ( V_131 ) ;
V_199 = F_33 ( V_15 ) >> V_31 ;
if ( V_199 >= V_32 )
continue;
if ( V_203 )
F_109 ( V_15 , V_199 ) ;
...
void F_115 ( T_7 V_204 ,
T_7 V_205 )
{
F_8 ( V_204 != 0 ) ;
V_117 = F_116 ( V_124 , V_205 , 0x40000000 ) ;
F_49 ( V_117 ) ;
}
