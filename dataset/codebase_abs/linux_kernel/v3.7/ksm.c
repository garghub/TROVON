...
V_87 = V_27 + V_65 ;
F_72 ( V_13 , V_86 , V_87 ) ;
V_82 = F_97 ( V_13 , V_94 , V_27 , & V_83 ) ;
if ( ! F_98 ( * V_82 , V_81 ) ) {
F_87 ( V_82 , V_83 ) ;
goto V_88;
}
F_99 ( V_91 ) ;
F_100 ( V_91 , V_26 , V_27 ) ;
F_77 ( V_26 , V_27 , F_101 ( * V_82 ) ) ;
F_79 ( V_26 , V_27 , V_82 ) ;
F_86 ( V_13 , V_27 , V_82 , F_102 ( V_91 , V_26 -> V_95 ) ) ;
F_103 ( V_28 ) ;
if ( ! F_104 ( V_28 ) )
F_105 ( V_28 ) ;
F_28 ( V_28 ) ;
...
static int F_106 ( struct V_28 * V_28 )
{
int V_29 = 0 ;
struct V_28 * V_96 = F_35 ( V_28 ) ;
if ( V_96 ) {
if ( F_47 ( V_96 ) ) {
if ( F_38 ( V_96 ) )
V_29 = F_107 ( V_96 ) ;
...
static struct V_28 * F_118 ( struct V_2 * V_2 ,
struct V_28 * V_28 ,
struct V_2 * V_98 ,
struct V_28 * V_99 )
{
int V_64 ;
V_64 = F_116 ( V_2 , V_28 , NULL ) ;
if ( ! V_64 ) {
V_64 = F_116 ( V_98 ,
V_99 , V_28 ) ;
if ( V_64 )
...
static struct V_28 * F_119 ( struct V_28 * V_28 )
{
struct V_100 * V_18 = V_47 . V_100 ;
struct V_5 * V_5 ;
V_5 = F_120 ( V_28 ) ;
if ( V_5 ) {
F_99 ( V_28 ) ;
...
int V_29 ;
F_23 () ;
V_5 = F_121 ( V_18 , struct V_5 , V_18 ) ;
V_99 = F_44 ( V_5 ) ;
if ( ! V_99 )
return NULL ;
V_29 = F_68 ( V_28 , V_99 ) ;
...
static struct V_5 * F_122 ( struct V_28 * V_91 )
{
struct V_100 * * V_103 = & V_47 . V_100 ;
...
int V_29 ;
F_23 () ;
V_5 = F_121 ( * V_103 , struct V_5 , V_18 ) ;
V_99 = F_44 ( V_5 ) ;
if ( ! V_99 )
return NULL ;
V_29 = F_68 ( V_91 , V_99 ) ;
...
static
struct V_2 * F_126 ( struct V_2 * V_2 ,
struct V_28 * V_28 ,
struct V_28 * * V_105 )
{
struct V_100 * * V_103 = & V_59 . V_100 ;
struct V_100 * V_104 = NULL ;
while ( * V_103 ) {
struct V_2 * V_98 ;
struct V_28 * V_99 ;
int V_29 ;
F_23 () ;
V_98 = F_121 ( * V_103 , struct V_2 , V_18 ) ;
V_99 = F_39 ( V_98 ) ;
if ( F_25 ( V_99 ) )
return NULL ;
if ( V_28 == V_99 ) {
...
V_2 -> V_22 |= V_55 ;
V_2 -> V_22 |= ( V_57 . V_58 & V_106 ) ;
F_123 ( & V_2 -> V_18 , V_104 , V_103 ) ;
F_124 ( & V_2 -> V_18 , & V_59 ) ;
V_60 ++ ;
return NULL ;
}
...
static void F_128 ( struct V_28 * V_28 , struct V_2 * V_2 )
{
struct V_2 * V_98 ;
struct V_28 * V_99 = NULL ;
struct V_5 * V_5 ;
struct V_28 * V_91 ;
unsigned int V_76 ;
int V_64 ;
...
V_91 = F_119 ( V_28 ) ;
if ( V_91 ) {
V_64 = F_116 ( V_2 , V_28 , V_91 ) ;
if ( ! V_64 ) {
F_50 ( V_91 ) ;
F_127 ( V_2 , F_120 ( V_91 ) ) ;
F_52 ( V_91 ) ;
}
F_28 ( V_91 ) ;
return;
...
static struct V_2 * F_129 ( struct V_8 * V_8 ,
struct V_2 * * V_61 ,
unsigned long V_27 )
{
struct V_2 * V_2 ;
...
static struct V_2 * F_130 ( struct V_28 * * V_28 )
{
struct V_14 * V_13 ;
struct V_8 * V_108 ;
struct V_25 * V_26 ;
...
V_59 = V_109 ;
F_58 ( & V_68 ) ;
V_108 = F_59 ( V_108 -> V_70 . V_43 , struct V_8 , V_70 ) ;
V_57 . V_8 = V_108 ;
F_60 ( & V_68 ) ;
if ( V_108 == & V_69 )
return NULL ;
...
F_54 ( V_108 , V_57 . V_61 ) ;
F_58 ( & V_68 ) ;
V_57 . V_8 = F_59 ( V_108 -> V_70 . V_43 ,
struct V_8 , V_70 ) ;
if ( V_57 . V_22 == 0 ) {
F_51 ( & V_108 -> V_21 ) ;
F_61 ( & V_108 -> V_70 ) ;
...
static void F_133 ( unsigned int V_111 )
{
struct V_2 * V_2 ;
struct V_28 * V_112 ( V_28 ) ;
while ( V_111 -- && F_134 ( ! F_135 ( V_66 ) ) ) {
F_23 () ;
V_2 = F_130 ( & V_28 ) ;
if ( ! V_2 )
return;
...
{
return ( V_113 & V_114 ) && ! F_131 ( & V_69 . V_70 ) ;
}
static int F_137 ( void * V_115 )
{
F_138 () ;
F_139 ( V_66 , 5 ) ;
while ( ! F_140 () ) {
...
int F_147 ( struct V_25 * V_26 , unsigned long V_62 ,
unsigned long V_63 , int V_120 , unsigned long * V_37 )
{
struct V_14 * V_13 = V_26 -> V_31 ;
int V_64 ;
switch ( V_120 ) {
case V_121 :
if ( * V_37 & ( V_38 | V_122 | V_123 |
V_124 | V_125 | V_126 |
V_127 | V_128 | V_129 ) )
return 0 ;
#ifdef F_148
...
if ( ! V_8 )
return - V_10 ;
V_131 = F_131 ( & V_69 . V_70 ) ;
F_58 ( & V_68 ) ;
F_17 ( V_13 , V_8 ) ;
F_151 ( & V_8 -> V_70 , & V_57 . V_8 -> V_70 ) ;
F_60 ( & V_68 ) ;
F_152 ( V_74 , & V_13 -> V_75 ) ;
F_153 ( & V_13 -> V_132 ) ;
if ( V_131 )
F_154 ( & V_119 ) ;
return 0 ;
}
void F_155 ( struct V_14 * V_13 )
{
struct V_8 * V_8 ;
int V_133 = 0 ;
F_58 ( & V_68 ) ;
...
struct V_28 * F_159 ( struct V_28 * V_28 ,
struct V_25 * V_26 , unsigned long V_22 )
{
struct V_28 * V_134 ;
V_134 = F_160 ( V_135 , V_26 , V_22 ) ;
if ( V_134 ) {
F_161 ( V_134 , V_28 , V_22 , V_26 ) ;
F_162 ( V_134 ) ;
F_163 ( V_134 ) ;
F_164 ( V_134 ) ;
F_165 ( V_134 ) ;
...
int F_169 ( struct V_28 * V_28 , struct V_137 * V_138 ,
unsigned long * V_37 )
{
struct V_5 * V_5 ;
struct V_2 * V_2 ;
struct V_17 * V_42 ;
unsigned int V_139 = F_80 ( V_28 ) ;
int V_140 = 0 ;
int V_141 = 0 ;
F_170 ( ! F_26 ( V_28 ) ) ;
F_170 ( ! F_171 ( V_28 ) ) ;
...
continue;
if ( V_138 && ! F_174 ( V_26 -> V_31 , V_138 ) )
continue;
V_140 += F_175 ( V_28 , V_26 ,
V_2 -> V_22 , & V_139 , V_37 ) ;
if ( ! V_141 || ! V_139 )
break;
}
...
int F_177 ( struct V_28 * V_28 , enum V_145 V_75 )
{
struct V_5 * V_5 ;
struct V_17 * V_42 ;
struct V_2 * V_2 ;
...
if ( ( V_2 -> V_13 == V_26 -> V_31 ) == V_141 )
continue;
V_29 = F_178 ( V_28 , V_26 ,
V_2 -> V_22 , V_75 ) ;
if ( V_29 != V_146 || ! F_104 ( V_28 ) ) {
F_176 ( V_39 ) ;
goto V_3;
}
}
...
int F_179 ( struct V_28 * V_28 , int (* F_180)( struct V_28 * ,
...
if ( ( V_2 -> V_13 == V_26 -> V_31 ) == V_141 )
continue;
V_29 = F_180 ( V_28 , V_26 , V_2 -> V_22 , V_148 ) ;
if ( V_29 != V_146 ) {
F_176 ( V_39 ) ;
goto V_3;
}
...
void F_181 ( struct V_28 * V_149 , struct V_28 * V_150 )
{
struct V_5 * V_5 ;
F_170 ( ! F_171 ( V_150 ) ) ;
F_170 ( ! F_171 ( V_149 ) ) ;
F_170 ( V_149 -> V_52 != V_150 -> V_52 ) ;
V_5 = F_120 ( V_149 ) ;
if ( V_5 ) {
F_170 ( V_5 -> V_49 != F_78 ( V_150 ) ) ;
V_5 -> V_49 = F_78 ( V_149 ) ;
}
}
static struct V_5 * F_182 ( unsigned long V_151 ,
unsigned long V_152 )
{
struct V_100 * V_18 ;
for ( V_18 = F_183 ( & V_47 ) ; V_18 ; V_18 = F_184 ( V_18 ) ) {
struct V_5 * V_5 ;
V_5 = F_121 ( V_18 , struct V_5 , V_18 ) ;
if ( V_5 -> V_49 >= V_151 &&
V_5 -> V_49 < V_152 )
...
static int F_185 ( struct V_153 * V_154 ,
...
{
return sprintf ( V_168 , L_1 , V_118 ) ;
}
...
unsigned long V_170 ;
int V_64 ;
V_64 = F_189 ( V_168 , 10 , & V_170 ) ;
if ( V_64 || V_170 > V_171 )
return - V_172 ;
V_118 = V_170 ;
return V_169 ;
}
static T_8 F_190 ( struct V_164 * V_165 ,
struct V_166 * V_167 , char * V_168 )
{
return sprintf ( V_168 , L_1 , V_117 ) ;
}
static T_8 F_191 ( struct V_164 * V_165 ,
struct V_166 * V_167 ,
const char * V_168 , T_9 V_169 )
{
int V_64 ;
unsigned long V_161 ;
V_64 = F_189 ( V_168 , 10 , & V_161 ) ;
if ( V_64 || V_161 > V_171 )
return - V_172 ;
V_117 = V_161 ;
return V_169 ;
}
static T_8 F_192 ( struct V_164 * V_165 , struct V_166 * V_167 ,
char * V_168 )
{
return sprintf ( V_168 , L_1 , V_113 ) ;
}
static T_8 F_193 ( struct V_164 * V_165 , struct V_166 * V_167 ,
const char * V_168 , T_9 V_169 )
{
int V_64 ;
unsigned long V_75 ;
V_64 = F_189 ( V_168 , 10 , & V_75 ) ;
if ( V_64 || V_75 > V_171 )
return - V_172 ;
if ( V_75 > V_173 )
return - V_172 ;
...
static T_8 F_198 ( struct V_164 * V_165 ,
struct V_166 * V_167 , char * V_168 )
{
return sprintf ( V_168 , L_2 , V_60 ) ;
}
static T_8 F_199 ( struct V_164 * V_165 ,
struct V_166 * V_167 , char * V_168 )
{
long V_177 ;
V_177 = V_12 - V_45
...
static T_8 F_200 ( struct V_164 * V_165 ,
struct V_166 * V_167 , char * V_168 )
{
