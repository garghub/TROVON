...
if ( V_13 != V_28 )
return 0 ;
V_239 -> V_245 = ( T_2 ) ( V_242 -> V_246 ) ;
V_239 -> V_247 = ( T_2 ) ( ( ( V_248 ) V_242 -> V_246 ) >> 32 ) ;
V_239 -> V_249 = V_250 ;
V_239 -> V_251 = ( T_2 ) ( V_242 -> V_252 ) ;
V_239 -> V_253 = ( T_2 ) ( ( ( V_248 ) V_242 -> V_252 ) >> 32 ) ;
V_239 -> V_254 = V_250 ;
V_239 -> V_255 = ( T_2 ) ( V_242 -> V_256 ) ;
V_239 -> V_257 = ( T_2 ) ( ( ( V_248 ) V_242 -> V_256 ) >> 32 ) ;
V_239 -> V_258 = V_259 ;
if ( V_242 -> V_260 ) {
V_243 = F_29 ( V_242 -> V_260 ) ;
V_239 -> V_261 = ( T_2 ) * V_243 ;
V_239 -> V_262 = ( T_2 ) ( ( ( V_248 ) * V_243 ) >> 32 ) ;
...
int F_31 ( struct V_1 * V_2 , T_4 V_284 ,
T_1 V_5 , T_2 V_32 ,
void * V_76 , void * V_285 )
{
struct V_3 * V_286 = V_285 ;
int V_167 = 0 ;
switch ( V_284 ) {
case V_287 :
V_167 = F_32 ( V_2 , V_286 ) ;
break;
case V_31 :
V_167 = F_3 ( V_2 , V_286 , V_5 ,
V_76 ) ;
break;
case V_118 :
V_167 = F_16 ( V_2 , V_286 ,
V_5 ) ;
break;
case V_129 :
V_167 = F_17 ( V_286 , V_5 ,
V_76 ) ;
break;
case V_56 :
V_167 = F_10 ( V_2 , V_286 , V_5 ,
V_76 ) ;
break;
case V_74 :
V_167 = F_11 ( V_286 , V_5 ,
V_76 ) ;
break;
case V_78 :
V_167 = F_12 ( V_2 , V_286 , V_5 ,
V_76 ) ;
break;
case V_85 :
V_167 = F_13 ( V_2 , V_286 , V_5 ,
V_76 ) ;
break;
case V_288 :
V_167 = F_33 ( V_2 , V_286 , V_5 ,
( T_4 ) V_32 , V_76 ) ;
break;
case V_105 :
V_167 = F_14 ( V_2 , V_286 , V_5 ,
(struct V_98 * ) V_76 ) ;
break;
case V_289 :
V_167 = F_34 ( V_286 , V_76 ) ;
break;
case V_290 :
V_167 = F_35 ( V_286 ) ;
break;
case V_291 :
V_167 = F_36 ( V_2 , V_286 , V_76 ) ;
break;
case V_136 :
V_167 = F_18 ( V_2 , V_286 ,
V_76 ) ;
break;
case V_292 :
V_167 = F_37 ( V_2 , V_286 ,
V_76 ) ;
break;
case V_45 :
V_167 = F_9 ( V_286 ) ;
...
break;
case V_7 :
V_167 = F_1 ( V_2 , V_286 , V_5 ) ;
break;
case V_37 :
V_167 = F_5 ( V_2 , V_286 , V_5 ,
V_32 , V_76 ) ;
break;
case V_294 :
V_286 -> V_6 =
...
case V_297 :
V_286 -> V_6 = F_2 ( V_284 ) ;
V_286 -> V_11 . V_298 . V_299 =
( V_58 ) ( * ( ( T_2 * ) V_76 ) ) ;
memcpy ( & V_286 -> V_11 , V_76 ,
sizeof( struct V_300 ) ) ;
V_286 -> V_8 =
F_2 ( sizeof( struct V_300 ) +
V_10 ) ;
V_167 = 0 ;
break;
case V_301 :
V_286 -> V_6 = F_2 ( V_284 ) ;
V_286 -> V_11 . V_302 . V_13 = F_2 ( V_5 ) ;
V_286 -> V_11 . V_302 . V_303 = F_15 ( * ( T_2 * ) V_76 ) ;
V_286 -> V_8 =
F_2 ( sizeof( struct V_304 ) +
V_10 ) ;
V_167 = 0 ;
break;
case V_305 :
...
case V_307 :
V_286 -> V_6 = F_2 ( V_284 ) ;
V_286 -> V_11 . V_308 . V_13 = F_2 ( V_5 ) ;
V_286 -> V_11 . V_308 . V_75 = F_2 ( * ( T_1 * ) V_76 ) ;
V_286 -> V_8 =
F_2 ( sizeof( struct V_309 ) +
V_10 ) ;
break;
case V_310 :
if ( V_2 -> V_29 -> V_311 == V_312 )
V_2 -> V_29 -> V_311 = V_313 ;
V_286 -> V_6 = F_2 ( V_284 ) ;
V_286 -> V_8 = F_2 ( V_10 ) ;
break;
case V_314 :
V_2 -> V_29 -> V_311 = V_312 ;
V_286 -> V_6 = F_2 ( V_284 ) ;
V_286 -> V_8 = F_2 ( V_10 ) ;
break;
case V_315 :
V_167 = F_39 ( V_286 , V_76 ) ;
break;
case V_316 :
V_167 = F_40 ( V_286 , V_76 ) ;
break;
case V_317 :
V_167 = F_41 ( V_2 , V_286 , V_76 ) ;
break;
case V_168 :
V_167 = F_22 ( V_2 , V_286 ,
V_5 , V_32 ,
V_76 ) ;
break;
case V_203 :
V_167 = F_24 ( V_2 , V_286 ,
V_5 ) ;
break;
case V_318 :
V_167 = F_42 ( V_2 , V_286 , V_5 ,
V_76 ) ;
break;
case V_319 :
V_167 = F_43 ( V_286 , V_5 ,
V_76 ) ;
break;
case V_320 :
V_167 = F_44 ( V_286 , V_5 , V_76 ) ;
break;
case V_321 :
F_6 ( V_2 -> V_29 -> V_30 ,
L_22 ) ;
V_286 -> V_6 = F_2 ( V_321 ) ;
V_286 -> V_8 =
F_2 ( sizeof( struct V_322 ) +
V_10 ) ;
V_167 = 0 ;
break;
case V_213 :
V_167 = F_25 ( V_286 , V_5 ,
V_76 ) ;
break;
case V_216 :
case V_220 :
...
case V_229 :
case V_231 :
V_167 = F_26 ( V_286 , V_5 , V_76 ) ;
break;
case V_323 :
V_286 -> V_6 = F_2 ( V_284 ) ;
if ( V_2 -> V_324 == V_325 )
V_286 -> V_11 . V_324 . V_326 =
V_327 ;
else if ( V_2 -> V_324 == V_328 )
V_286 -> V_11 . V_324 . V_326 =
V_329 ;
else if ( V_2 -> V_324 == V_330 )
V_286 -> V_11 . V_324 . V_326 = V_331 ;
V_286 -> V_8 = F_2 ( sizeof( struct
V_332 ) + V_10 ) ;
V_167 = 0 ;
break;
case V_244 :
V_167 = F_28 ( V_2 , V_286 , V_5 ) ;
break;
case V_271 :
V_167 = F_30 ( V_2 , V_286 , V_76 ) ;
break;
default:
F_4 ( V_2 -> V_29 -> V_30 ,
L_23 , V_284 ) ;
...
int F_45 ( struct V_1 * V_2 , V_58 V_333 )
{
int V_167 ;
T_1 V_209 = true ;
struct V_334 V_335 ;
...
V_167 = F_46 ( V_2 , V_310 ,
V_28 , 0 , NULL ) ;
if ( V_167 )
return - 1 ;
V_167 = F_46 ( V_2 , V_287 ,
V_39 , 0 , NULL ) ;
if ( V_167 )
return - 1 ;
V_167 = F_46 ( V_2 ,
...
V_2 -> V_29 -> V_359 = V_320 ;
V_341 . V_360 = V_361 ;
V_167 = F_46 ( V_2 , V_320 ,
V_28 , 0 , & V_341 ) ;
V_167 = - V_362 ;
return V_167 ;
}
