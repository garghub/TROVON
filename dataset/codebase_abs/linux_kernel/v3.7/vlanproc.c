...
struct V_8 * V_9 = F_7 ( F_15 ( V_23 ) , V_10 ) ;
V_25 -> V_26 =
F_16 ( V_23 -> V_27 , V_17 | V_18 | V_19 ,
V_9 -> V_13 , & V_28 , V_23 ) ;
if ( ! V_25 -> V_26 )
return - V_21 ;
return 0 ;
