...
int F_49 ( struct V_1 * V_8 , unsigned int V_28 ,
T_1 V_45 , int V_42 )
{
int V_47 ;
...
unsigned int F_51 ( struct V_2 * V_53 ,
...
unsigned int F_48 ( struct V_1 * V_8 ,
T_1 V_24 )
{
struct V_32 * V_58 ;
if ( V_8 == NULL )
...
return F_18 ( V_8 , V_24 ) ;
case V_18 :
return F_56 ( V_8 , V_24 ) ;
case V_14 :
F_57 () ;
V_58 = F_58 ( & V_8 -> V_15 . V_16 , V_24 ) ;
F_59 () ;
if ( V_58 )
return V_58 -> V_31 ;
break;
...
unsigned int F_56 ( struct V_1 * V_8 ,
T_1 V_24 )
{
F_60 ( V_8 -> V_4 != V_18 ) ;
...
static int F_68 ( struct V_73 * V_73 , struct V_74 * V_74 )
{
return F_69 ( V_74 , F_61 , V_73 -> V_75 ) ;
}
static int T_3 F_70 ( void )
{
if ( F_71 ( L_34 , V_76 , NULL ,
NULL , & V_77 ) == NULL )
return - V_78 ;
return 0 ;
}
int F_72 ( struct V_1 * V_79 , struct V_2 * V_80 ,
const T_2 * V_54 , unsigned int V_55 ,
