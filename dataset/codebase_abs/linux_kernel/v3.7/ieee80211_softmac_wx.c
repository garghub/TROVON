...
int F_14 ( struct V_1 * V_2 , struct V_3 * V_4 , union V_5 * V_6 , char * V_7 )
{
int V_50 , V_8 = 0 ;
unsigned long V_32 ;
if ( V_2 -> V_13 == V_36 )
...
union V_5 * V_6 , char * V_31 )
{
F_30 ( V_6 -> V_78 , L_4 , V_79 ) ;
if( V_2 -> V_80 & V_81 ) {
F_31 ( V_6 -> V_78 , L_5 , V_79 ) ;
if( V_2 -> V_80 & V_82 )
F_31 ( V_6 -> V_78 , L_6 , V_79 ) ;
} else if( V_2 -> V_80 & V_82 )
F_31 ( V_6 -> V_78 , L_7 , V_79 ) ;
if( ( V_2 -> V_28 == V_29 ) ||
( V_2 -> V_28 == V_38 ) )
F_31 ( V_6 -> V_78 , L_8 , V_79 ) ;
else if( V_2 -> V_28 != V_83 )
F_31 ( V_6 -> V_78 , L_9 , V_79 ) ;
return 0 ;
}
...
if ( V_6 -> V_88 . V_32 & V_98 ) {
V_2 -> V_99 = V_6 -> V_88 . V_58 / 1000 ;
F_26 ( L_11 , V_2 -> V_99 ) ;
}
if ( V_6 -> V_88 . V_32 & V_100 ) {
V_8 = - V_15 ;
goto exit;
}
exit:
