...
static void F_160 ( struct V_300 * V_301 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_29 ( V_9 ) ;
}
static void F_161 ( struct V_180 * V_324 )
{
struct V_325 * V_181 = F_2 ( V_324 , struct V_325 ,
V_181 ) ;
struct V_1 * V_9 = V_181 -> V_9 ;
int V_326 = V_181 -> V_326 ;
F_29 ( V_181 ) ;
if ( V_9 -> V_11 & V_77 )
F_31 ( V_9 ) ;
if ( V_9 -> V_11 & V_131 )
...
F_57 ( V_9 ) ;
F_162 ( V_9 -> V_4 . V_75 -> V_76 ) ;
}
static int F_163 ( struct V_2 * V_3 , unsigned V_329 , unsigned V_326 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
if ( ( V_326 == V_327 ) || ( V_326 == V_328 ) ) {
struct V_325 * V_181 ;
V_181 = F_18 ( sizeof( * V_181 ) , V_15 ) ;
if ( ! V_181 )
return - V_55 ;
F_74 ( & V_181 -> V_181 , F_161 ) ;
V_181 -> V_9 = V_9 ;
V_181 -> V_326 = V_326 ;
F_164 ( & V_181 -> V_181 ) ;
return V_330 ;
...
static int F_167 ( struct V_300 * V_301 )
{
struct V_1 * V_9 ;
int V_10 ;
...
V_9 -> V_4 . V_342 = F_165 ;
V_9 -> V_97 = V_259 ;
V_303 . V_343 = V_344 [ V_345 ] . V_346 ;
V_305 . V_343 = V_344 [ V_347 ] . V_346 ;
V_10 = F_168 ( V_301 , & V_9 -> V_4 ) ;
if ( V_10 )
goto V_65;
return 0 ;
V_65:
...
static int F_169 ( struct V_83 * V_76 )
{
int V_10 ;
V_10 = F_170 ( V_76 , V_344 ) ;
if ( V_10 )
return V_10 ;
V_348 . V_349 =
V_344 [ V_350 ] . V_346 ;
V_348 . V_351 = V_344 [ V_352 ] . V_346 ;
V_348 . V_353 =
V_344 [ V_354 ] . V_346 ;
V_355 . V_356 =
V_344 [ V_357 ] . V_346 ;
V_10 = F_171 ( V_76 , & V_355 ,
F_167 ) ;
if ( V_10 )
return V_10 ;
F_172 ( V_76 , & V_358 ) ;
