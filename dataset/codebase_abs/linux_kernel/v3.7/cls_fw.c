...
static int F_24 ( struct V_4 * V_44 ,
struct V_6 * V_7 , unsigned long V_34 ,
T_1 V_1 ,
struct V_31 * * V_33 ,
unsigned long * V_27 )
{
struct V_10 * V_11 = (struct V_10 * ) V_7 -> V_12 ;
struct V_13 * V_14 = (struct V_13 * ) * V_27 ;
struct V_31 * V_45 = V_33 [ V_46 ] ;
struct V_31 * V_32 [ V_47 + 1 ] ;
int V_37 ;
if ( ! V_45 )
return V_1 ? - V_30 : 0 ;
V_37 = F_25 ( V_32 , V_47 , V_45 , V_48 ) ;
if ( V_37 < 0 )
return V_37 ;
if ( V_14 != NULL ) {
...
if ( V_32 [ V_43 ] )
V_18 = F_20 ( V_32 [ V_43 ] ) ;
V_11 = F_26 ( sizeof( struct V_10 ) , V_49 ) ;
if ( V_11 == NULL )
return - V_50 ;
V_11 -> V_18 = V_18 ;
F_16 ( V_7 ) ;
...
V_14 = F_26 ( sizeof( struct V_13 ) , V_49 ) ;
if ( V_14 == NULL )
return - V_50 ;
V_14 -> V_16 = V_1 ;
...
static void F_27 ( struct V_6 * V_7 , struct V_51 * V_27 )
{
struct V_10 * V_11 = (struct V_10 * ) V_7 -> V_12 ;
int V_26 ;
if ( V_11 == NULL )
...
if ( V_27 -> V_53 < V_27 -> V_54 ) {
V_27 -> V_53 ++ ;
continue;
}
if ( V_27 -> V_55 ( V_7 , ( unsigned long ) V_14 , V_27 ) < 0 ) {
V_27 -> V_52 = 1 ;
return;
}
V_27 -> V_53 ++ ;
...
static int F_28 ( struct V_6 * V_7 , unsigned long V_56 ,
struct V_4 * V_5 , struct V_57 * V_3 )
{
struct V_10 * V_11 = (struct V_10 * ) V_7 -> V_12 ;
struct V_13 * V_14 = (struct V_13 * ) V_56 ;
unsigned char * V_58 = F_29 ( V_5 ) ;
struct V_31 * V_59 ;
if ( V_14 == NULL )
return V_5 -> V_60 ;
V_3 -> V_61 = V_14 -> V_16 ;
