...
{
F_102 ( F_103 () ) . V_134 [ V_135 ] ++ ;
F_56 ( & V_79 ) ;
}
static int F_104 ( struct V_52 * V_53 , void * V_85 )
{
return F_30 ( V_53 ) -> V_5 == ( T_4 ) ( unsigned long ) V_85 ;
}
static void F_105 ( struct V_52 * V_53 )
{
struct V_42 * V_43 = F_30 ( V_53 ) ;
F_106 ( V_43 ) ;
}
static void F_75 ( struct V_136 * V_137 )
{
struct V_42 * V_43 ;
struct V_52 * V_53 ;
T_4 V_5 ;
...
V_43 -> V_52 . V_144 = V_145 ;
if ( F_115 ( & V_43 -> V_52 , L_18 ,
F_25 ( V_43 -> V_5 ) ) ) {
F_106 ( V_43 ) ;
continue;
}
V_43 -> V_52 . V_146 = F_105 ;
V_30 = F_116 ( & V_43 -> V_52 ) ;
if ( V_30 ) {
F_111 ( & V_43 -> V_52 ) ;
continue;
}
V_30 = F_117 ( & V_43 -> V_52 . V_147 ,
& V_148 ) ;
if ( ! V_30 ) {
F_33 ( & V_43 -> V_58 ) ;
V_43 -> V_80 = 0 ;
...
static int F_123 ( struct V_42 * V_43 , unsigned long * V_75 )
{
struct V_4 V_15 ;
struct V_97 * V_98 ;
if ( V_43 -> V_47 <= 0 )
...
V_43 -> V_127 -> V_151 , V_43 -> V_127 -> V_34 ) ;
switch ( V_15 . V_18 ) {
case V_19 :
F_124 ( & V_101 ) ;
F_28 ( V_43 ) ;
F_125 (ap_msg, &ap_dev->pendingq, list) {
...
static int F_127 ( struct V_42 * V_43 , unsigned long * V_75 )
{
struct V_4 V_15 ;
struct V_97 * V_98 ;
if ( V_43 -> V_60 <= 0 ||
V_43 -> V_47 >= V_43 -> V_6 )
return 0 ;
V_98 = F_128 ( V_43 -> V_142 . V_99 , struct V_97 , V_95 ) ;
V_15 = F_17 ( V_43 -> V_5 , V_98 -> V_32 ,
V_98 -> V_151 , V_98 -> V_34 , V_98 -> V_35 ) ;
switch ( V_15 . V_18 ) {
case V_19 :
F_129 ( & V_101 ) ;
F_26 ( V_43 ) ;
F_130 ( & V_98 -> V_95 , & V_43 -> V_141 ) ;
V_43 -> V_60 -- ;
V_43 -> V_61 ++ ;
...
static inline int F_131 ( struct V_42 * V_43 , unsigned long * V_75 )
{
int V_30 ;
V_30 = F_123 ( V_43 , V_75 ) ;
if ( V_30 )
return V_30 ;
return F_127 ( V_43 , V_75 ) ;
}
static int F_132 ( struct V_42 * V_43 , struct V_97 * V_98 )
{
struct V_4 V_15 ;
if ( F_133 ( & V_43 -> V_142 ) &&
V_43 -> V_47 < V_43 -> V_6 ) {
V_15 = F_17 ( V_43 -> V_5 , V_98 -> V_32 ,
V_98 -> V_151 , V_98 -> V_34 ,
V_98 -> V_35 ) ;
switch ( V_15 . V_18 ) {
case V_19 :
F_134 ( & V_98 -> V_95 , & V_43 -> V_141 ) ;
F_129 ( & V_101 ) ;
V_43 -> V_61 ++ ;
F_26 ( V_43 ) ;
V_43 -> V_59 ++ ;
...
void F_135 ( struct V_42 * V_43 , struct V_97 * V_98 )
{
unsigned long V_75 ;
int V_30 ;
F_136 ( ! V_98 -> V_100 ) ;
F_33 ( & V_43 -> V_58 ) ;
if ( ! V_43 -> V_80 ) {
V_30 = F_131 ( V_43 , & V_75 ) ;
if ( ! V_30 )
V_30 = F_132 ( V_43 , V_98 ) ;
if ( ! V_30 )
F_137 ( & V_153 ) ;
if ( V_30 == - V_3 )
V_43 -> V_80 = 1 ;
...
void F_138 ( struct V_42 * V_43 , struct V_97 * V_98 )
{
struct V_97 * V_154 ;
F_33 ( & V_43 -> V_58 ) ;
if ( ! F_133 ( & V_98 -> V_95 ) ) {
F_125 (tmp, &ap_dev->pendingq, list)
if ( V_154 -> V_32 == V_98 -> V_32 ) {
V_43 -> V_61 -- ;
goto V_155;
}
V_43 -> V_60 -- ;
...
static enum F_122 F_139 ( struct V_156 * V_137 )
{
F_56 ( & V_79 ) ;
return V_157 ;
}
static void F_140 ( struct V_42 * V_43 )
{
int V_30 ;
V_43 -> V_49 = V_51 ;
F_68 ( V_43 -> V_47 , & V_101 ) ;
...
static void F_141 ( unsigned long V_41 )
{
unsigned long V_75 ;
struct V_42 * V_43 ;
if ( F_1 () )
...
V_75 = 0 ;
F_143 ( & V_94 ) ;
F_125 (ap_dev, &ap_device_list, list) {
F_143 ( & V_43 -> V_58 ) ;
F_47 ( V_43 , & V_75 ) ;
F_144 ( & V_43 -> V_58 ) ;
}
...
F_154 ( & V_165 ) ;
if ( ! V_109 ) {
V_109 = F_155 ( F_145 , NULL , L_19 ) ;
V_30 = F_156 ( V_109 ) ? F_157 ( V_109 ) : 0 ;
if ( V_30 )
V_109 = NULL ;
}
else
...
static void V_143 ( unsigned long V_85 )
{
...
V_30 = F_169 ( & V_106 , V_167 [ V_16 ] ) ;
if ( V_30 )
goto V_168;
}
V_145 = F_170 ( L_23 ) ;
V_30 = F_156 ( V_145 ) ? F_157 ( V_145 ) : 0 ;
if ( V_30 )
goto V_168;
V_78 = F_53 ( L_16 ) ;
if ( ! V_78 ) {
...
static int F_178 ( struct V_52 * V_53 , void * V_85 )
{
return 1 ;
}
void F_179 ( void )
...
F_180 ( & V_79 ) ;
F_173 ( V_145 ) ;
while ( ( V_53 = F_107 ( & V_106 , NULL , NULL ,
F_178 ) ) )
{
F_110 ( V_53 ) ;
F_111 ( V_53 ) ;
