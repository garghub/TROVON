...
if ( sscanf ( V_9 , L_53 , & V_213 ) != 1 )
return - V_87 ;
if ( V_213 < V_318 || V_213 > V_319 )
return - V_87 ;
V_18 -> V_320 = ( T_2 ) V_213 ;
for ( V_3 = 0 ; V_3 < V_18 -> V_321 ; V_3 += V_322 )
F_120 ( V_18 , V_3 ) ;
return strlen ( V_9 ) ;
}
static int
F_121 ( struct V_17 * V_18 , int V_213 )
{
if ( V_18 -> V_44 != V_45 ) {
V_18 -> V_320 = 0 ;
return 0 ;
...
static int
F_122 ( struct V_14 * V_15 , int V_213 )
{
struct V_12 * V_13 = F_87 ( V_15 ) ;
struct V_248 * V_249 , * V_324 ;
if ( V_213 == V_15 -> V_325 )
return 0 ;
...
V_15 -> V_325 = V_213 ;
F_62 ( V_13 -> V_250 ) ;
F_123 (ndlp, next_ndlp, &vport->fc_nodes, nlp_listp) {
if ( ! F_89 ( V_249 ) )
continue;
if ( V_249 -> V_326 == V_327 )
continue;
V_249 -> V_328 = V_15 -> V_329 ;
}
F_63 ( V_13 -> V_250 ) ;
return 0 ;
}
...
return - V_87 ;
if ( memcmp ( V_9 , V_334 , V_333 ) )
return - V_87 ;
if ( ! ( V_15 -> V_76 & V_96 ) )
return - V_98 ;
F_62 ( & V_18 -> V_214 ) ;
for ( V_330 = 0 ; V_330 < V_85 - V_333 ;
V_330 += sizeof( T_2 ) )
F_46 ( * ( ( T_2 * ) ( V_9 + V_330 + V_333 ) ) ,
V_18 -> V_335 + V_291 + V_330 ) ;
F_63 ( & V_18 -> V_214 ) ;
return V_85 ;
}
static T_1
F_125 ( struct V_285 * V_286 , struct V_287 * V_288 ,
struct V_289 * V_290 ,
char * V_9 , T_10 V_291 , T_5 V_85 )
{
T_5 V_330 ;
...
return - V_87 ;
F_62 ( & V_18 -> V_214 ) ;
for ( V_330 = 0 ; V_330 < V_85 ; V_330 += sizeof( T_2 ) ) {
V_336 = ( T_2 * ) ( V_9 + V_330 ) ;
* V_336 = F_45 ( V_18 -> V_335 + V_291 + V_330 ) ;
}
F_63 ( & V_18 -> V_214 ) ;
return V_85 ;
}
static T_1
F_126 ( struct V_285 * V_286 , struct V_287 * V_288 ,
struct V_289 * V_290 ,
char * V_9 , T_10 V_291 , T_5 V_85 )
{
return - V_98 ;
...
static T_1
F_127 ( struct V_285 * V_286 , struct V_287 * V_288 ,
struct V_289 * V_290 ,
char * V_9 , T_10 V_291 , T_5 V_85 )
{
return - V_98 ;
...
struct V_12 * V_13 = F_87 ( V_15 ) ;
int error ;
error = F_129 ( & V_13 -> V_337 . V_288 ,
& V_338 ) ;
if ( error || V_15 -> V_207 == V_339 )
goto V_170;
error = F_129 ( & V_13 -> V_337 . V_288 ,
& V_340 ) ;
if ( error )
...
return 0 ;
V_343:
F_130 ( & V_13 -> V_337 . V_288 , & V_340 ) ;
V_341:
F_130 ( & V_13 -> V_337 . V_288 ,
& V_338 ) ;
V_170:
return error ;
}
...
( ( V_18 -> V_74 == V_75 ) &&
( V_15 -> V_76 & V_77 ) ) ) )
V_371 = F_75 ( V_18 -> V_372 . V_373 . V_102 . V_296 ) ;
else
V_371 = 0 ;
F_63 ( V_13 -> V_250 ) ;
F_142 ( V_13 ) = V_371 ;
...
struct V_374 * V_375 = & V_18 -> V_376 ;
struct V_377 * V_378 = & V_126 -> V_379 ;
T_6 * V_93 ;
T_7 * V_185 ;
unsigned long V_380 ;
int V_128 = 0 ;
...
V_375 -> V_383 = V_185 -> V_192 . V_384 . V_385 ;
V_375 -> V_386 = ( V_387 )
( ( V_387 ) V_185 -> V_192 . V_384 . V_388
* ( V_387 ) 256 ) ;
V_375 -> V_389 = V_185 -> V_192 . V_384 . V_390 ;
V_375 -> V_391 = ( V_387 )
( ( V_387 ) V_185 -> V_192 . V_384 . V_392
* ( V_387 ) 256 ) ;
memset ( V_93 , 0 , sizeof ( T_6 ) ) ;
V_185 -> V_104 = V_393 ;
V_185 -> V_106 = V_107 ;
...
V_375 -> V_394 = V_185 -> V_192 . V_395 . V_396 ;
V_375 -> V_397 = V_185 -> V_192 . V_395 . V_398 ;
V_375 -> V_399 = V_185 -> V_192 . V_395 . V_400 ;
V_375 -> V_401 = V_185 -> V_192 . V_395 . V_402 ;
V_375 -> V_403 = V_185 -> V_192 . V_395 . V_404 ;
V_375 -> V_405 = V_185 -> V_192 . V_395 . V_406 ;
V_375 -> V_407 = V_185 -> V_192 . V_395 . V_406 ;
V_375 -> V_394 -= V_378 -> V_394 ;
V_375 -> V_397 -= V_378 -> V_397 ;
V_375 -> V_399 -= V_378 -> V_399 ;
V_375 -> V_401 -= V_378 -> V_401 ;
V_375 -> V_403 -= V_378 -> V_403 ;
V_375 -> V_405 -= V_378 -> V_405 ;
V_375 -> V_407 -= V_378 -> V_407 ;
if ( V_18 -> V_19 & V_408 ) {
V_375 -> V_409 = - 1 ;
V_375 -> V_410 = ( V_18 -> V_411 >> 1 ) ;
V_375 -> V_410 -= V_378 -> V_411 ;
} else if ( V_18 -> V_74 == V_75 ) {
V_375 -> V_409 = ( V_18 -> V_412 >> 1 ) ;
V_375 -> V_409 -= V_378 -> V_411 ;
V_375 -> V_410 = - 1 ;
} else {
V_375 -> V_409 = - 1 ;
V_375 -> V_410 = ( V_18 -> V_412 >> 1 ) ;
V_375 -> V_410 -= V_378 -> V_411 ;
}
V_375 -> V_413 = - 1 ;
V_380 = F_145 () ;
if ( V_380 < V_126 -> V_414 )
V_375 -> V_415 = V_380 +
( ( unsigned long ) - 1 - V_126 -> V_414 ) ;
else
V_375 -> V_415 = V_380 - V_126 -> V_414 ;
F_32 ( V_93 , V_18 -> V_99 ) ;
return V_375 ;
}
static void
...
V_378 -> V_394 = V_185 -> V_192 . V_395 . V_396 ;
V_378 -> V_397 = V_185 -> V_192 . V_395 . V_398 ;
V_378 -> V_399 = V_185 -> V_192 . V_395 . V_400 ;
V_378 -> V_401 = V_185 -> V_192 . V_395 . V_402 ;
V_378 -> V_403 = V_185 -> V_192 . V_395 . V_404 ;
V_378 -> V_405 = V_185 -> V_192 . V_395 . V_406 ;
V_378 -> V_407 = V_185 -> V_192 . V_395 . V_406 ;
if ( V_18 -> V_19 & V_408 )
V_378 -> V_411 = ( V_18 -> V_411 >> 1 ) ;
else
V_378 -> V_411 = ( V_18 -> V_412 >> 1 ) ;
V_126 -> V_414 = F_145 () ;
F_32 ( V_93 , V_18 -> V_99 ) ;
return;
}
static struct V_248 *
F_147 ( struct V_417 * V_418 )
{
struct V_12 * V_13 = F_148 ( V_418 -> V_6 . V_419 ) ;
struct V_14 * V_15 = (struct V_14 * ) V_13 -> V_16 ;
struct V_248 * V_249 ;
F_62 ( V_13 -> V_250 ) ;
F_88 (ndlp, &vport->fc_nodes, nlp_listp) {
...
static void
F_149 ( struct V_417 * V_418 )
{
struct V_248 * V_249 = F_147 ( V_418 ) ;
F_150 ( V_418 ) = V_249 ? V_249 -> V_423 : - 1 ;
}
static void
F_151 ( struct V_417 * V_418 )
{
struct V_248 * V_249 = F_147 ( V_418 ) ;
F_152 ( V_418 ) =
V_249 ? F_75 ( V_249 -> V_424 . V_102 . V_296 ) : 0 ;
}
static void
F_153 ( struct V_417 * V_418 )
{
struct V_248 * V_249 = F_147 ( V_418 ) ;
F_154 ( V_418 ) =
...
static void
F_155 ( struct V_425 * V_251 , T_2 V_426 )
{
if ( V_426 )
V_251 -> V_252 = V_426 ;
else
...
static void
F_156 ( struct V_427 * V_427 )
{
struct V_14 * V_15 = * (struct V_14 * * ) V_427 -> V_428 ;
if ( V_15 -> V_62 == V_71 )
F_157 ( V_15 , V_429 , 0 , 0 ) ;
}
static void
F_158 ( struct V_17 * V_18 , T_2 V_430 )
{
V_18 -> V_431 = V_430 ;
}
void
F_159 ( struct V_17 * V_18 )
{
F_160 ( V_18 , V_432 ) ;
F_161 ( V_18 , V_433 ) ;
F_162 ( V_18 , V_434 ) ;
