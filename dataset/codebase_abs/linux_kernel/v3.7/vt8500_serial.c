...
static int T_4 F_61 ( struct V_100 * V_101 )
{
struct V_6 * V_6 ;
struct V_102 * V_103 , * V_104 ;
struct V_105 * V_106 = V_101 -> V_107 . V_108 ;
int V_62 ;
int V_2 ;
V_103 = F_62 ( V_101 , V_109 , 0 ) ;
V_104 = F_62 ( V_101 , V_110 , 0 ) ;
if ( ! V_103 || ! V_104 )
return - V_99 ;
V_6 = F_63 ( sizeof( struct V_6 ) , V_111 ) ;
if ( ! V_6 )
return - V_112 ;
if ( V_106 )
V_2 = F_64 ( V_106 , L_2 ) ;
...
V_6 -> V_7 . type = V_81 ;
V_6 -> V_7 . V_116 = V_117 ;
V_6 -> V_7 . V_118 = V_103 -> V_119 ;
V_6 -> V_7 . V_47 = V_104 -> V_119 ;
V_6 -> V_7 . V_120 = 16 ;
V_6 -> V_7 . V_121 = & V_122 ;
V_6 -> V_7 . line = V_2 ;
V_6 -> V_7 . V_107 = & V_101 -> V_107 ;
V_6 -> V_7 . V_69 = V_123 | V_124 ;
V_6 -> V_125 = F_67 ( V_101 -> V_107 . V_108 , 0 ) ;
if ( V_6 -> V_125 ) {
V_6 -> V_7 . V_126 = F_68 ( V_6 -> V_125 ) ;
} else {
F_69 ( L_3 , V_127 ) ;
V_6 -> V_7 . V_126 = 24000000 ;
}
snprintf ( V_6 -> V_63 , sizeof( V_6 -> V_63 ) ,
L_4 , V_101 -> V_128 ) ;
V_6 -> V_7 . V_5 = F_70 ( V_103 -> V_119 , F_71 ( V_103 ) ) ;
if ( ! V_6 -> V_7 . V_5 ) {
V_62 = - V_112 ;
goto V_129;
}
...
static int T_5 F_75 ( struct V_100 * V_101 )
{
struct V_6 * V_6 = F_76 ( V_101 ) ;
F_73 ( V_101 , NULL ) ;
F_77 ( & V_93 , & V_6 -> V_7 ) ;
F_74 ( V_6 ) ;
return 0 ;
