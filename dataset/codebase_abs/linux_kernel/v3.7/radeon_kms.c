...
int F_29 ( struct V_1 * V_2 , struct V_16 * V_95 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
V_95 -> V_96 = NULL ;
if ( V_4 -> V_37 >= V_65 ) {
...
struct V_99 * V_100 ;
int V_7 ;
V_98 = F_7 ( sizeof( * V_98 ) , V_9 ) ;
if ( F_30 ( ! V_98 ) ) {
return - V_10 ;
}
F_31 ( V_4 , & V_98 -> V_101 ) ;
V_100 = F_32 ( V_4 , & V_98 -> V_101 ,
V_4 -> V_102 . V_103 ) ;
V_7 = F_33 ( V_4 , V_100 , V_104 ,
V_105 |
V_106 ) ;
if ( V_7 ) {
F_34 ( V_4 , & V_98 -> V_101 ) ;
...
{
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_4 -> V_37 >= V_65 && V_95 -> V_96 ) {
struct V_97 * V_98 = V_95 -> V_96 ;
struct V_99 * V_100 ;
int V_7 ;
V_7 = F_36 ( V_4 -> V_102 . V_103 , false ) ;
if ( ! V_7 ) {
V_100 = F_37 ( & V_98 -> V_101 ,
V_4 -> V_102 . V_103 ) ;
if ( V_100 )
F_38 ( V_4 , V_100 ) ;
F_39 ( V_4 -> V_102 . V_103 ) ;
}
F_34 ( V_4 , & V_98 -> V_101 ) ;
F_5 ( V_98 ) ;
V_95 -> V_96 = NULL ;
...
F_44 ( & V_4 -> V_108 . V_109 , V_107 ) ;
V_4 -> V_108 . V_110 [ V_32 ] = true ;
V_7 = F_45 ( V_4 ) ;
F_46 ( & V_4 -> V_108 . V_109 , V_107 ) ;
return V_7 ;
}
...
struct V_31 * V_114 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_32 < 0 || V_32 >= V_2 -> V_115 ) {
F_22 ( L_12 , V_32 ) ;
return - V_42 ;
}
V_114 = & V_4 -> V_27 . V_55 [ V_32 ] -> V_56 ;
return F_49 ( V_2 , V_32 , V_111 ,
V_113 , V_6 ,
V_114 ) ;
}
