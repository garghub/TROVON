...
int F_18 ( struct V_3 * V_3 , const char * V_14 ,
const void * V_15 , T_2 V_16 )
{
...
void F_20 ( struct V_3 * V_3 , const char * V_14 ,
const void * V_15 , T_2 V_16 )
{
if ( ! V_42 || ( ! F_10 ( V_14 )
&& ! F_17 ( V_14 ) ) )
...
int F_24 ( struct V_3 * V_3 , struct V_48 * V_49 )
{
...
void F_25 ( struct V_3 * V_3 , int V_50 )
{
if ( ! V_42 )
return;
if ( V_50 & ( V_51 | V_52 | V_53 ) )
...
struct V_19 * V_20 ;
int V_24 ;
if ( ! V_42 || ! F_10 ( V_54 -> V_56 ) )
return 0 ;
V_20 = F_27 ( sizeof( * V_20 ) , V_27 ) ;
if ( ! V_20 )
return - V_57 ;
V_20 -> type = V_32 ;
V_24 = F_28 ( V_4 , V_54 , V_20 -> V_33 ) ;
if ( V_24 < 0 )
goto V_31;
V_55 -> V_58 = V_20 ;
V_55 -> V_59 = sizeof( * V_20 ) ;
V_55 -> V_56 = F_29 ( V_60 , V_27 ) ;
return 0 ;
V_31:
F_9 ( V_20 ) ;
return V_24 ;
