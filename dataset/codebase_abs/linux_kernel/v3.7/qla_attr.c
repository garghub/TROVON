...
V_169 = V_170 = 0 ;
if ( F_81 ( V_11 ) )
F_9 ( V_47 , V_11 , 0x707b ,
L_66 ) ;
else if ( ! V_11 -> V_15 -> V_89 . V_172 )
V_16 = F_108 ( V_11 , & V_169 , & V_170 ) ;
if ( V_16 != V_46 )
return snprintf ( V_7 , V_118 , L_58 ) ;
return snprintf ( V_7 , V_118 , L_56 , V_169 , V_170 ) ;
}
static T_1
...
return snprintf ( V_7 , V_118 , L_67 , V_173 [ 0 ] ,
...
if ( ! F_112 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_118 , L_58 ) ;
return snprintf ( V_7 , V_118 , L_68 , V_11 -> V_174 . V_175 ) ;
}
static T_1
...
if ( ! F_112 ( V_11 -> V_15 ) )
return snprintf ( V_7 , V_118 , L_58 ) ;
return snprintf ( V_7 , V_118 , L_68 ,
V_11 -> V_174 . V_176 >> 20 ) ;
}
static T_1
...
! F_91 ( V_226 , & V_209 -> V_11 -> V_34 ) ) {
if ( F_23 ( V_209 -> V_11 -> V_15 ) )
V_209 -> V_11 -> V_15 -> V_36 -> V_227 ( V_209 -> V_11 ,
...
struct V_228 * V_232 ;
V_232 = & V_11 -> V_233 ;
memset ( V_232 , - 1 , sizeof( struct V_228 ) ) ;
if ( F_91 ( V_226 , & V_11 -> V_34 ) )
goto V_234;
if ( F_32 ( F_33 ( V_14 -> V_62 ) ) )
goto V_234;
V_230 = F_43 ( V_14 -> V_81 , V_82 , & V_231 ) ;
if ( V_230 == NULL ) {
F_9 ( V_47 , V_11 , 0x707d ,
L_69 ) ;
goto V_234;
}
memset ( V_230 , 0 , V_235 ) ;
V_16 = V_168 ;
if ( F_23 ( V_14 ) ) {
V_16 = F_141 ( V_86 , V_230 , V_231 ) ;
} else if ( F_80 ( & V_86 -> V_132 ) == V_137 &&
! F_81 ( V_11 ) && ! V_14 -> V_236 ) {
V_16 = F_142 ( V_86 , V_86 -> V_224 ,
V_230 , V_231 ) ;
}
if ( V_16 != V_46 )
goto V_237;
V_232 -> V_238 = V_230 -> V_239 ;
V_232 -> V_240 = V_230 -> V_241 ;
V_232 -> V_242 = V_230 -> V_243 ;
V_232 -> V_244 = V_230 -> V_245 ;
V_232 -> V_246 = V_230 -> V_247 ;
V_232 -> V_248 = V_230 -> V_249 ;
if ( F_23 ( V_14 ) ) {
V_232 -> V_250 = V_230 -> V_251 ;
V_232 -> V_252 = V_230 -> V_252 ;
V_232 -> V_253 = V_230 -> V_253 ;
V_232 -> V_254 = V_230 -> V_254 ;
V_232 -> V_255 = V_230 -> V_256 ;
}
V_232 -> V_257 = V_11 -> V_156 . V_258 >> 20 ;
V_232 -> V_259 = V_11 -> V_156 . V_260 >> 20 ;
V_237:
F_143 ( V_14 -> V_81 , V_230 , V_231 ) ;
V_234:
return V_232 ;
}
static void
...
{
T_7 * V_11 = F_2 ( V_177 ) ;
F_18 ( V_261 , & V_11 -> V_34 ) ;
}
static void
F_148 ( struct V_106 * V_177 )
{
T_7 * V_11 = F_2 ( V_177 ) ;
T_6 V_210 [ V_262 ] = { 0xFF , 0xFF , 0xFF , 0xFF , \
0xFF , 0xFF , 0xFF , 0xFF } ;
T_10 V_263 = F_123 ( V_210 ) ;
if ( V_11 -> V_135 & V_264 )
V_263 = F_123 ( V_11 -> V_265 ) ;
F_149 ( V_177 ) = V_263 ;
}
static void
...
static int
F_152 ( struct V_274 * V_274 , bool V_275 )
{
int V_108 = 0 ;
T_6 V_276 = 0 ;
T_7 * V_86 = F_2 ( V_274 -> V_177 ) ;
T_7 * V_11 = NULL ;
struct V_13 * V_14 = V_86 -> V_15 ;
T_4 V_277 = 0 ;
int V_41 ;
struct V_278 * V_279 = V_14 -> V_280 [ 0 ] ;
V_108 = F_153 ( V_274 ) ;
if ( V_108 ) {
...
V_11 = F_154 ( V_274 ) ;
if ( V_11 == NULL ) {
F_9 ( V_47 , V_11 , 0x707f , L_71 ) ;
return V_281 ;
}
if ( V_275 ) {
F_155 ( & V_11 -> V_282 , V_283 ) ;
F_156 ( V_274 , V_284 ) ;
} else
F_155 ( & V_11 -> V_282 , V_285 ) ;
...
( V_291 > 1 || F_160 ( V_14 ) ) )
V_295 |= V_305 ;
F_161 ( V_11 -> V_88 , V_295 ) ;
} else
V_11 -> V_89 . V_296 = 0 ;
}
if ( F_162 ( V_11 -> V_88 , & V_274 -> V_101 ,
& V_14 -> V_62 -> V_101 ) ) {
F_17 ( V_32 , V_11 , 0x7083 ,
L_75 , V_11 -> V_200 ) ;
goto V_306;
}
F_163 ( V_11 -> V_88 ) = V_14 -> V_307 ;
...
if ( V_14 -> V_89 . V_308 ) {
V_279 = V_14 -> V_280 [ 1 ] ;
F_17 ( V_309 , V_11 , 0xc000 ,
L_76
L_77 ,
V_279 , V_11 -> V_200 , V_14 -> V_89 . V_308 ) ;
goto V_310;
} else if ( V_311 == 1 || ! V_14 -> V_312 )
goto V_310;
for ( V_41 = 0 ; V_41 < V_14 -> V_313 ; V_41 ++ ) {
if ( memcmp ( V_14 -> V_312 [ V_41 ] . V_214 , V_11 -> V_214 , 8 ) == 0
&& memcmp ( V_14 -> V_312 [ V_41 ] . V_210 , V_11 -> V_210 ,
8 ) == 0 ) {
V_276 = V_14 -> V_312 [ V_41 ] . V_314 ;
break;
}
}
if ( V_276 ) {
V_108 = F_170 ( V_14 , V_277 , V_11 -> V_200 , 0 , 0 ,
V_276 ) ;
if ( ! V_108 )
...
F_17 ( V_309 , V_11 , 0xc001 ,
L_79 ,
V_108 , V_276 , V_11 -> V_200 ) ;
F_17 ( V_32 , V_11 , 0x7085 ,
L_79 ,
V_108 , V_276 , V_11 -> V_200 ) ;
V_279 = V_14 -> V_280 [ V_108 ] ;
}
}
V_310:
V_11 -> V_279 = V_279 ;
...
static int
F_174 ( struct V_274 * V_274 )
{
T_7 * V_11 = V_274 -> V_219 ;
struct V_13 * V_14 = V_11 -> V_15 ;
T_4 V_212 = V_11 -> V_200 ;
while ( F_91 ( V_315 , & V_11 -> V_34 ) ||
F_91 ( V_316 , & V_11 -> V_34 ) )
F_175 ( 1000 ) ;
F_171 ( V_11 ) ;
V_11 -> V_89 . V_317 = 1 ;
F_176 ( V_11 -> V_88 ) ;
...
if ( V_319 & V_32 )
F_175 ( F_179 () % 10 ) ;
F_180 ( F_80 ( & V_11 -> V_320 ) ) ;
F_181 ( V_11 ) ;
F_182 ( & V_14 -> V_321 ) ;
V_14 -> V_322 -- ;
F_183 ( V_11 -> V_200 , V_14 -> V_323 ) ;
F_184 ( & V_14 -> V_321 ) ;
if ( V_11 -> V_279 -> V_212 && ! V_14 -> V_89 . V_308 ) {
if ( F_185 ( V_11 , V_11 -> V_279 ) != V_46 )
F_9 ( V_47 , V_11 , 0x7087 ,
L_81 ) ;
}
F_9 ( V_29 , V_11 , 0x7088 , L_82 , V_212 ) ;
F_173 ( V_11 -> V_88 ) ;
return 0 ;
}
static int
F_169 ( struct V_274 * V_274 , bool V_275 )
{
T_7 * V_11 = V_274 -> V_219 ;
if ( V_275 )
F_171 ( V_11 ) ;
...
F_164 ( V_11 -> V_88 ) = F_123 ( V_11 -> V_210 ) ;
F_165 ( V_11 -> V_88 ) = F_123 ( V_11 -> V_214 ) ;
F_166 ( V_11 -> V_88 ) = V_14 -> V_324 . V_325 ?
( V_326 | V_327 ) : V_327 ;
F_188 ( V_11 -> V_88 ) = V_14 -> V_328 ;
F_189 ( V_11 -> V_88 ) = V_14 -> V_322 ;
if ( F_38 ( V_14 ) )
V_183 = V_195 ;
else if ( F_39 ( V_14 ) )
V_183 = V_197 | V_193 |
