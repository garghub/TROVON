...
V_14 -> V_192 = F_70 ;
V_14 -> V_193 = V_195 ;
if ( ( V_23 = F_76 ( V_14 , V_196 ) ) < 0 ) {
F_71 ( V_6 ) ;
return V_23 ;
}
if ( ( V_23 = F_77 ( V_14 , V_197 , 256 , V_198 ) ) < 0 ) {
F_71 ( V_6 ) ;
return V_23 ;
}
V_23 = F_78 ( V_14 , 48000 ) ;
if ( V_23 < 0 ) {
F_71 ( V_6 ) ;
return V_23 ;
}
...
V_6 -> type = V_123 ;
V_6 -> V_7 = V_7 ;
V_6 -> V_166 = V_199 | V_200 ;
V_6 -> V_169 = V_201 ;
V_6 -> V_129 = V_202 ;
V_6 -> V_122 = V_203 ;
V_6 -> V_172 = V_2 -> V_78 ? V_204 : V_205 ;
V_14 -> V_15 = V_6 ;
V_14 -> V_192 = F_70 ;
V_14 -> V_193 = V_206 ;
V_2 -> V_207 = F_3 ;
V_2 -> V_9 = V_7 ;
F_81 ( V_14 , 0 , V_208 , & V_209 ) ;
F_81 ( V_14 , 0 , V_210 , & V_211 ) ;
return 0 ;
}
...
V_6 -> type = V_212 ;
V_6 -> V_7 = V_7 ;
V_6 -> V_166 = V_213 | V_214 ;
V_6 -> V_169 = V_215 ;
V_6 -> V_129 = V_216 ;
V_6 -> V_122 = V_217 ;
V_6 -> V_172 = V_2 -> V_78 ? V_218 : V_219 ;
V_7 -> V_14 -> V_15 = V_6 ;
V_7 -> V_14 -> V_192 = F_70 ;
V_14 -> V_193 = V_206 ;
V_14 -> V_193 . V_220 = V_221 ;
V_14 -> V_193 . V_222 = V_14 -> V_193 . V_223 = 8000 ;
V_14 -> V_193 . V_224 = 1 ;
V_2 -> V_225 = F_4 ;
V_2 -> V_10 = V_7 ;
F_81 ( V_14 , 0 , V_208 , & V_209 ) ;
...
V_7 -> V_14 -> V_192 = F_70 ;
V_14 -> V_193 = V_233 ;
V_14 -> V_193 . V_220 = V_234 ;
V_14 -> V_193 . V_222 = V_14 -> V_193 . V_223 = 48000 ;
F_86 ( & V_2 -> V_73 ) ;
if ( V_2 -> V_86 -> V_87 ) {
#if 1
switch ( V_2 -> V_235 . V_236 ) {
case 0 :
V_14 -> V_193 . V_220 = V_237 ;
V_14 -> V_193 . V_222 = V_14 -> V_193 . V_223 = 44100 ;
V_14 -> V_193 . V_224 =
V_14 -> V_193 . V_238 = 16 ;
break;
case 1 :
...
#endif
V_14 -> V_193 . V_239 = V_240 ;
} else {
V_14 -> V_193 . V_224 = V_14 -> V_193 . V_238 = 0 ;
for ( V_121 = 0 ; V_121 < V_226 ; V_121 ++ ) {
if ( V_2 -> V_241 [ V_121 / 32 ] & ( 1 << ( V_121 % 32 ) ) ) {
V_14 -> V_193 . V_224 ++ ;
V_14 -> V_193 . V_238 ++ ;
}
}
}
V_6 -> V_134 = V_2 -> V_241 [ 0 ] ;
V_6 -> V_170 = V_2 -> V_241 [ 1 ] ;
F_87 ( & V_2 -> V_73 ) ;
V_2 -> V_242 = F_5 ;
V_2 -> V_11 = V_7 ;
F_81 ( V_14 , 0 , V_208 , & V_209 ) ;
...
int T_2 V_5 ( struct V_1 * V_2 , int V_243 , struct V_244 * * V_245 )
{
struct V_244 * V_246 ;
struct V_12 * V_7 ;
int V_23 ;
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_181 , L_2 , V_243 , 32 , 1 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_90 ( V_246 , V_247 , & V_248 ) ;
F_90 ( V_246 , V_249 , & V_250 ) ;
V_246 -> V_251 = 0 ;
V_246 -> V_252 = V_253 ;
strcpy ( V_246 -> V_254 , L_3 ) ;
V_2 -> V_246 = V_246 ;
for ( V_7 = V_246 -> V_255 [ V_247 ] . V_7 ; V_7 ; V_7 = V_7 -> V_256 )
if ( ( V_23 = F_91 ( V_7 , V_257 , F_92 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ) < 0 )
return V_23 ;
for ( V_7 = V_246 -> V_255 [ V_249 ] . V_7 ; V_7 ; V_7 = V_7 -> V_256 )
F_91 ( V_7 , V_259 , F_92 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ;
if ( V_245 )
* V_245 = V_246 ;
return 0 ;
}
int T_2 F_93 ( struct V_1 * V_2 , int V_243 , struct V_244 * * V_245 )
{
struct V_244 * V_246 ;
struct V_12 * V_7 ;
int V_23 ;
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_181 , L_2 , V_243 , 1 , 0 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_90 ( V_246 , V_247 , & V_260 ) ;
V_246 -> V_251 = 0 ;
V_246 -> V_252 = V_253 ;
strcpy ( V_246 -> V_254 , L_4 ) ;
V_2 -> V_261 = V_246 ;
for ( V_7 = V_246 -> V_255 [ V_247 ] . V_7 ; V_7 ; V_7 = V_7 -> V_256 )
if ( ( V_23 = F_91 ( V_7 , V_257 , F_92 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ) < 0 )
return V_23 ;
...
int T_2 F_94 ( struct V_1 * V_2 , int V_243 , struct V_244 * * V_245 )
{
struct V_244 * V_246 ;
int V_23 ;
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_181 , L_5 , V_243 , 0 , 1 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_90 ( V_246 , V_249 , & V_262 ) ;
V_246 -> V_251 = 0 ;
strcpy ( V_246 -> V_254 , L_6 ) ;
V_2 -> V_263 = V_246 ;
F_95 ( V_246 , V_259 , F_92 ( V_2 -> V_258 ) , 64 * 1024 , 64 * 1024 ) ;
if ( V_245 )
* V_245 = V_246 ;
return 0 ;
}
static int F_96 ( struct V_173 * V_264 , struct V_265 * V_266 )
{
struct V_1 * V_2 = F_97 ( V_264 ) ;
int V_226 = V_2 -> V_78 ? 64 : 32 ;
V_266 -> type = V_267 ;
V_266 -> V_268 = V_226 ;
V_266 -> V_269 . integer . V_270 = 0 ;
V_266 -> V_269 . integer . V_271 = 1 ;
return 0 ;
}
static int F_98 ( struct V_173 * V_264 , struct V_272 * V_273 )
{
struct V_1 * V_2 = F_97 ( V_264 ) ;
int V_226 = V_2 -> V_78 ? 64 : 32 ;
int V_121 ;
F_86 ( & V_2 -> V_73 ) ;
for ( V_121 = 0 ; V_121 < V_226 ; V_121 ++ )
V_273 -> V_269 . integer . V_269 [ V_121 ] = ( V_2 -> V_241 [ V_121 / 32 ] & ( 1 << ( V_121 % 32 ) ) ) ? 1 : 0 ;
F_87 ( & V_2 -> V_73 ) ;
return 0 ;
}
static int F_99 ( struct V_173 * V_264 , struct V_272 * V_273 )
{
struct V_1 * V_2 = F_97 ( V_264 ) ;
unsigned int V_274 [ 2 ] , V_275 ;
int V_226 = V_2 -> V_78 ? 64 : 32 ;
int V_276 = V_2 -> V_78 ? 7 : 6 ;
int V_277 , V_121 ;
V_274 [ 0 ] = V_274 [ 1 ] = 0 ;
for ( V_121 = 0 , V_275 = 0 ; V_121 < V_226 ; V_121 ++ )
if ( V_273 -> V_269 . integer . V_269 [ V_121 ] ) {
V_274 [ V_121 / 32 ] |= 1 << ( V_121 % 32 ) ;
V_275 ++ ;
}
for ( V_121 = 0 ; V_121 < V_276 ; V_121 ++ )
if ( 1 << V_121 == V_275 )
break;
if ( V_121 >= V_276 )
return - V_165 ;
F_86 ( & V_2 -> V_73 ) ;
V_277 = ( V_274 [ 0 ] != V_2 -> V_241 [ 0 ] ) ||
( V_274 [ 1 ] != V_2 -> V_241 [ 1 ] ) ;
V_2 -> V_241 [ 0 ] = V_274 [ 0 ] ;
V_2 -> V_241 [ 1 ] = V_274 [ 1 ] ;
F_87 ( & V_2 -> V_73 ) ;
...
static void F_101 ( unsigned short * V_278 ,
unsigned short * V_279 ,
...
struct V_282 * V_283 , T_3 V_284 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
unsigned int V_287 = V_246 -> V_21 ;
unsigned short * V_280 = ( unsigned short * ) ( V_7 -> V_14 -> V_288 + V_283 -> V_289 ) ;
unsigned int V_290 = V_284 >> 2 , V_268 ;
unsigned int V_291 = V_246 -> V_291 ;
unsigned int V_281 = V_246 -> V_281 ;
while ( V_290 > V_291 ) {
V_268 = V_291 + 1 ;
F_101 ( ( unsigned short * ) V_2 -> V_286 . V_292 . V_293 + V_291 ,
( unsigned short * ) V_2 -> V_286 . V_292 . V_293 + V_291 + V_287 / 2 ,
V_280 , V_268 , V_281 ) ;
V_280 += V_268 * 2 ;
V_290 -= V_268 ;
V_291 = ( V_287 / 2 ) - 1 ;
...
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
unsigned int V_24 ;
for ( V_24 = 0 ; V_24 < V_246 -> V_71 ; V_24 ++ )
F_22 ( V_2 , V_295 + 0x80 + V_246 -> V_296 [ V_24 ] , 0 , 0 ) ;
F_34 ( V_7 ) ;
return 0 ;
}
...
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
unsigned int V_24 ;
memset ( & V_246 -> V_294 , 0 , sizeof( V_246 -> V_294 ) ) ;
V_246 -> V_294 . V_297 = V_246 -> V_21 * 2 ;
V_246 -> V_294 . V_298 = F_38 ( V_7 ) ;
V_246 -> V_291 = F_108 ( V_246 -> V_21 ) ;
V_246 -> V_281 = 0 ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_300 , 0 , 0 ) ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_301 , 0 , 0 ) ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_302 , 0 , V_14 -> V_21 ) ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_303 , 0 , 0 ) ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_304 , 0 , V_14 -> V_156 ) ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_305 , 0 , V_14 -> V_156 ) ;
for ( V_24 = 0 ; V_24 < V_246 -> V_71 ; V_24 ++ )
F_22 ( V_2 , V_295 + 0x80 + V_246 -> V_296 [ V_24 ] , 0 , ( V_306 | V_307 ) + V_24 * ( V_14 -> V_21 / V_246 -> V_71 ) ) ;
return 0 ;
}
...
V_275 = V_308 | V_309 |
V_310 | V_311 | V_312 |
0x00001200 | V_313 | V_314 | V_315 ;
F_22 ( V_2 , V_316 + V_24 , 0 , V_275 ) ;
}
}
#endif
V_158 = F_111 ( V_2 , F_100 , V_246 -> V_300 , V_7 , & V_246 -> V_317 ) ;
if ( V_158 < 0 )
goto V_318;
F_103 ( V_7 ) ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_301 , 0 , 1 ) ;
break;
case V_162 :
case V_163 :
case V_164 :
F_112 ( V_2 , V_246 -> V_317 ) ; V_246 -> V_317 = NULL ;
F_22 ( V_2 , V_2 -> V_299 + V_246 -> V_301 , 0 , 0 ) ;
V_246 -> V_291 = F_108 ( V_246 -> V_21 ) ;
V_246 -> V_281 = 0 ;
break;
...
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
T_3 V_16 ;
if ( ! F_8 ( V_2 , V_2 -> V_299 + V_246 -> V_301 , 0 ) )
return 0 ;
V_16 = F_8 ( V_2 , V_2 -> V_299 + V_246 -> V_303 , 0 ) << 2 ;
return F_114 ( V_7 , & V_246 -> V_294 , V_16 ) ;
}
...
struct V_285 * V_246 = & V_2 -> V_286 . V_246 [ V_7 -> V_20 ] ;
V_14 -> V_193 = V_319 ;
V_14 -> V_193 . V_224 = V_14 -> V_193 . V_238 = V_246 -> V_71 ;
V_14 -> V_193 . V_320 = ( V_246 -> V_21 * 2 ) / 2 ;
F_86 ( & V_2 -> V_73 ) ;
if ( V_246 -> V_321 == 0 ) {
F_87 ( & V_2 -> V_73 ) ;
return - V_322 ;
...
int T_2 F_117 ( struct V_1 * V_2 , int V_243 , struct V_244 * * V_245 )
{
struct V_244 * V_246 ;
struct V_173 * V_174 ;
int V_23 ;
if ( V_245 )
* V_245 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_181 , L_7 , V_243 , 8 , 1 , & V_246 ) ) < 0 )
return V_23 ;
V_246 -> V_15 = V_2 ;
F_90 ( V_246 , V_247 , & V_324 ) ;
F_90 ( V_246 , V_249 , & V_325 ) ;
V_246 -> V_251 = 0 ;
strcpy ( V_246 -> V_254 , L_8 ) ;
V_2 -> V_326 = V_246 ;
if ( V_245 )
* V_245 = V_246 ;
if ( V_2 -> V_78 ) {
V_2 -> V_241 [ 0 ] = 0 ;
if ( V_2 -> V_86 -> V_87 )
V_2 -> V_241 [ 1 ] = 0xffffffff ;
else
V_2 -> V_241 [ 1 ] = 0xffff ;
} else {
V_2 -> V_241 [ 0 ] = 0xffff0000 ;
V_2 -> V_241 [ 1 ] = 0 ;
}
V_174 = F_118 ( & V_327 , V_2 ) ;
if ( ! V_174 )
return - V_113 ;
V_174 -> V_177 . V_243 = V_243 ;
