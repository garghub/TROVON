...
int F_26 ( const struct V_42 * V_43 )
{
struct V_1 * V_2 ;
T_2 V_44 ;
T_2 V_45 ;
...
F_31 ( V_2 , L_5 ,
V_24 , V_43 -> type , V_43 -> V_20 , V_43 -> V_35 ) ;
switch ( V_43 -> type ) {
case V_51 :
if ( V_43 -> V_20 != sizeof( T_2 ) ) {
V_8 = - V_52 ;
break;
}
V_44 = F_10 ( V_2 ) ;
if ( F_19 ( ( void V_38 * ) V_43 -> V_35 , & V_44 ,
sizeof( T_2 ) ) )
V_8 = - V_39 ;
break;
case V_53 :
...
V_45 = F_24 ( V_43 -> V_20 ) ;
V_46 = F_25 ( V_43 -> V_20 ) ;
V_8 = F_12 ( V_2 , V_46 , V_45 ) ;
break;
case V_55 :
V_45 = F_24 ( V_43 -> V_20 ) ;
V_46 = F_25 ( V_43 -> V_20 ) ;
V_8 = F_18 ( V_2 , V_46 , V_45 , V_43 -> V_35 ) ;
break;
case V_56 :
V_45 = F_24 ( V_43 -> V_20 ) ;
V_46 = F_25 ( V_43 -> V_20 ) ;
V_8 = F_22 ( V_2 , V_46 , V_45 , V_43 -> V_35 ) ;
break;
default:
F_9 ( V_2 , L_6 ,
V_24 , V_43 -> type ) ;
