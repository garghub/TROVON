...
V_3 = V_51 -> V_3 ;
if ( V_49 != V_4 )
F_21 ( F_36 ( V_49 -> V_60 ) , V_35 ) ;
if ( V_11 -> V_13 == V_34 ) {
F_37 ( & V_49 -> V_58 , & V_11 -> V_39 ) ;
return 0 ;
}
V_16 = F_4 ( V_11 , & V_3 ) ;
if ( ! V_16 ) {
...
if ( V_3 . type == V_17 )
F_37 ( & V_49 -> V_58 , & V_16 -> V_66 ) ;
else
F_37 ( & V_49 -> V_58 , & V_16 -> V_67 ) ;
V_51 -> V_68 = V_16 ;
return 0 ;
}
static void F_38 ( struct V_7 * V_11 ,
struct V_48 * V_49 )
{
struct V_50 * V_51 ;
struct V_10 * V_16 ;
V_51 = (struct V_50 * ) V_49 -> V_51 ;
F_37 ( & V_49 -> V_58 , & V_11 -> V_38 ) ;
V_16 = V_51 -> V_68 ;
if ( ! V_16 )
return;
V_51 -> V_68 = NULL ;
...
static int F_47 ( struct V_48 * V_103 , struct V_7 * V_11 )
{
unsigned long V_35 ;
...
struct V_50 * V_51 ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
F_48 (pavgroup, tempgroup, &lcu->grouplist, group) {
F_48 (device, tempdev, &pavgroup->baselist,
alias_list) {
F_37 ( & V_49 -> V_58 , & V_11 -> V_39 ) ;
V_51 = (struct V_50 * ) V_49 -> V_51 ;
V_51 -> V_68 = NULL ;
}
F_48 (device, tempdev, &pavgroup->aliaslist,
alias_list) {
F_37 ( & V_49 -> V_58 , & V_11 -> V_39 ) ;
V_51 = (struct V_50 * ) V_49 -> V_51 ;
V_51 -> V_68 = NULL ;
...
F_21 ( & V_11 -> V_46 , V_35 ) ;
V_80 = F_41 ( V_103 , V_11 ) ;
if ( V_80 )
return V_80 ;
F_35 ( F_36 ( V_103 -> V_60 ) , V_35 ,
V_107 ) ;
F_25 ( & V_11 -> V_46 ) ;
V_11 -> V_13 = V_34 ;
...
F_48 (device, tempdev, &lcu->active_devices,
alias_list) {
F_34 ( V_11 , V_49 , V_103 ) ;
}
F_26 ( & V_11 -> V_46 ) ;
F_21 ( F_36 ( V_103 -> V_60 ) , V_35 ) ;
return 0 ;
}
...
unsigned long V_35 ;
int V_80 ;
V_43 = F_49 ( V_113 , struct V_114 , V_44 . V_113 ) ;
V_11 = F_49 ( V_43 , struct V_7 , V_43 ) ;
V_49 = V_43 -> V_49 ;
V_80 = F_47 ( V_49 , V_11 ) ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
...
F_50 ( V_115 , V_49 , L_1
L_2 , V_80 ) ;
if ( ! F_51 ( & V_11 -> V_43 . V_44 , 30 * V_87 ) )
F_30 ( V_49 ) ;
} else {
F_30 ( V_49 ) ;
V_11 -> V_43 . V_49 = NULL ;
...
V_11 = V_51 -> V_11 ;
V_80 = 0 ;
F_20 ( F_36 ( V_49 -> V_60 ) , V_35 ) ;
F_25 ( & V_11 -> V_46 ) ;
if ( ! ( V_11 -> V_35 & V_37 ) ) {
V_80 = F_34 ( V_11 , V_49 , V_49 ) ;
if ( V_80 )
V_11 -> V_35 |= V_37 ;
}
if ( V_11 -> V_35 & V_37 ) {
...
struct V_48 * F_56 ( struct V_48 * V_118 )
{
struct V_48 * V_119 ;
struct V_10 * V_16 ;
struct V_7 * V_11 ;
...
V_11 -> V_35 & ( V_36 | V_37 ) )
return NULL ;
if ( F_57 ( ! ( V_51 -> V_121 . V_122 [ 8 ] & 0x01 ) ) ) {
F_50 ( V_123 , V_118 , L_3 ,
L_4 ) ;
return NULL ;
}
F_20 ( & V_11 -> V_46 , V_35 ) ;
...
{
struct V_10 * V_68 ;
struct V_48 * V_49 , * V_130 ;
struct V_50 * V_51 ;
int V_80 ;
unsigned long V_35 ;
F_67 ( V_131 ) ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
F_48 (device, temp, &lcu->active_devices,
alias_list) {
V_51 = (struct V_50 * ) V_49 -> V_51 ;
if ( V_51 -> V_3 . type == V_17 )
continue;
F_37 ( & V_49 -> V_58 , & V_131 ) ;
}
F_2 (pavgroup, &lcu->grouplist, group) {
F_68 ( & V_68 -> V_67 , & V_131 ) ;
}
while ( ! F_5 ( & V_131 ) ) {
V_49 = F_6 ( & V_131 , struct V_48 ,
V_58 ) ;
F_21 ( & V_11 -> V_46 , V_35 ) ;
V_80 = F_69 ( V_49 ) ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
...
unsigned long V_35 ;
struct V_48 * V_49 ;
V_40 = F_49 ( V_113 , struct V_133 ,
V_41 ) ;
V_11 = F_49 ( V_40 , struct V_7 , V_40 ) ;
V_49 = V_40 -> V_49 ;
F_66 ( V_11 ) ;
F_20 ( F_36 ( V_49 -> V_60 ) , V_35 ) ;
F_74 ( V_49 ,
