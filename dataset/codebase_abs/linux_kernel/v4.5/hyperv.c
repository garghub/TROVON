...
{
T_1 V_178 , V_179 , V_180 , V_56 ;
T_8 V_181 , V_182 , V_183 , V_184 = V_185 , V_186 = 0 ;
bool V_187 , V_188 ;
if ( V_143 -> V_189 ( V_18 ) != 0 || ! F_127 ( V_18 ) ) {
F_128 ( V_18 , V_190 ) ;
return 0 ;
}
V_188 = F_129 ( V_18 ) ;
if ( ! V_188 ) {
V_178 = ( ( T_1 ) F_130 ( V_18 , V_191 ) << 32 ) |
( F_130 ( V_18 , V_192 ) & 0xffffffff ) ;
V_179 = ( ( T_1 ) F_130 ( V_18 , V_193 ) << 32 ) |
( F_130 ( V_18 , V_194 ) & 0xffffffff ) ;
V_180 = ( ( T_1 ) F_130 ( V_18 , V_195 ) << 32 ) |
( F_130 ( V_18 , V_196 ) & 0xffffffff ) ;
}
#ifdef F_131
else {
V_178 = F_130 ( V_18 , V_194 ) ;
V_179 = F_130 ( V_18 , V_191 ) ;
V_180 = F_130 ( V_18 , V_197 ) ;
}
#endif
V_181 = V_178 & 0xffff ;
V_187 = ( V_178 >> 16 ) & 0x1 ;
V_183 = ( V_178 >> 32 ) & 0xfff ;
V_182 = ( V_178 >> 48 ) & 0xfff ;
F_132 ( V_181 , V_187 , V_183 , V_182 , V_179 , V_180 ) ;
switch ( V_181 ) {
case V_198 :
F_133 ( V_18 ) ;
break;
...
V_56 = V_184 | ( ( ( T_1 ) V_186 & 0xfff ) << 32 ) ;
if ( V_188 ) {
F_134 ( V_18 , V_192 , V_56 ) ;
} else {
F_134 ( V_18 , V_191 , V_56 >> 32 ) ;
F_134 ( V_18 , V_192 , V_56 & 0xffffffff ) ;
}
return 1 ;
}
