...
F_78 ( V_9 , F_79 ( V_131 -> V_130 ) ) ;
V_20 -> V_66 . V_67 . V_68 = F_79 ( V_131 -> V_128 ) ;
if ( ( ( V_20 -> V_88 & ~ V_89 ) == V_103 ) ) {
if ( V_134 == V_138 ) {
F_80 ( V_9 , V_9 -> V_71 -> V_72 () ) ;
}
return 0 ;
}
F_81 ( V_9 , V_134 ) ;
...
V_111 = F_88 ( V_2 -> V_145 . V_146 , struct V_5 , V_143 ) ;
F_84 ( V_111 ) ;
}
}
