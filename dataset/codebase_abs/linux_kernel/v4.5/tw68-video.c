...
unsigned V_66 = V_61 -> V_62 + * V_62 ;
unsigned V_56 = ( V_7 -> V_50 -> V_67 * V_7 -> V_11 * V_7 -> V_12 ) >> 3 ;
if ( V_66 < 2 )
V_66 = 2 ;
V_66 = F_16 ( V_56 , V_66 ) ;
* V_62 = V_66 - V_61 -> V_62 ;
...
unsigned V_56 , V_85 ;
V_56 = ( V_7 -> V_11 * V_7 -> V_12 * V_7 -> V_50 -> V_67 ) >> 3 ;
if ( F_31 ( V_71 , 0 ) < V_56 )
return - V_69 ;
F_32 ( V_71 , 0 , V_56 ) ;
V_85 = ( V_7 -> V_11 * V_7 -> V_50 -> V_67 ) >> 3 ;
switch ( V_7 -> V_16 ) {
case V_86 :
...
( V_119 -> V_50 . V_120 . V_11 * ( V_7 -> V_50 -> V_67 ) ) >> 3 ;
...
V_119 -> V_50 . V_120 . V_122 =
( V_119 -> V_50 . V_120 . V_11 * ( V_50 -> V_67 ) ) >> 3 ;
V_119 -> V_50 . V_120 . V_123 =
V_119 -> V_50 . V_120 . V_12 * V_119 -> V_50 . V_120 . V_122 ;
V_119 -> V_50 . V_120 . V_124 = V_125 ;
return 0 ;
