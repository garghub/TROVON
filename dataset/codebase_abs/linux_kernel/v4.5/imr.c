...
int V_15 ;
F_6 ( V_19 ) ;
V_15 = F_7 ( V_16 , V_20 , V_12 ++ , V_2 -> V_7 ) ;
if ( V_15 )
goto V_21;
V_15 = F_7 ( V_16 , V_20 , V_12 ++ , V_2 -> V_8 ) ;
if ( V_15 )
goto V_21;
V_15 = F_7 ( V_16 , V_20 , V_12 ++ , V_2 -> V_3 ) ;
if ( V_15 )
goto V_21;
V_15 = F_7 ( V_16 , V_20 , V_12 ++ , V_2 -> V_5 ) ;
if ( V_15 )
goto V_21;
if ( V_18 ) {
V_2 -> V_7 |= V_22 ;
...
unsigned long V_51 , V_28 ;
int V_29 ;
int V_15 ;
for ( V_29 = 0 ; V_29 < V_10 -> V_33 ; V_29 ++ )
F_31 ( V_29 ) ;
V_51 = ( unsigned long ) V_49 ;
V_28 = ( unsigned long ) V_50 - 1 ;
V_15 = F_25 ( V_27 , V_31 , V_52 , V_52 , false ) ;
if ( V_15 < 0 ) {
F_22 ( L_13 ,
V_31 / 1024 , V_51 , V_28 ) ;
} else {
