...
V_6 -> V_46 = F_9 ;
V_6 -> V_47 = F_13 ;
snprintf ( V_6 -> V_48 , V_49 , L_5 ,
F_19 ( & V_40 -> V_2 ) ) ;
V_6 -> V_17 = & V_40 -> V_2 ;
V_2 = V_6 -> V_7 ;
V_2 -> V_3 = F_20 ( & V_40 -> V_2 , V_42 -> V_50 , F_21 ( V_42 ) ) ;
if ( ! V_2 -> V_3 ) {
F_8 ( & V_40 -> V_2 , L_6 ) ;
V_22 = - V_29 ;
goto V_51;
...
F_22 ( & V_2 -> V_16 ) ;
V_2 -> V_52 = F_23 ( & V_40 -> V_2 , NULL ) ;
if ( ! F_24 ( V_2 -> V_52 ) )
F_25 ( V_2 -> V_52 ) ;
V_2 -> V_13 = F_26 ( V_40 , 0 ) ;
if ( V_2 -> V_13 > 0 ) {
V_22 = F_27 ( & V_40 -> V_2 , V_2 -> V_13 ,
F_14 ,
V_53 , V_40 -> V_45 , V_2 ) ;
if ( V_22 )
goto V_51;
F_11 ( V_36 ,
V_2 -> V_3 + V_54 ) ;
} else if ( V_2 -> V_13 == - V_55 ) {
return - V_55 ;
}
F_28 ( & V_2 -> V_23 ) ;
if ( V_40 -> V_2 . V_56 )
V_22 = F_29 ( V_6 , V_40 -> V_2 . V_56 ) ;
else
V_22 = F_30 ( V_6 ) ;
if ( V_22 < 0 ) {
