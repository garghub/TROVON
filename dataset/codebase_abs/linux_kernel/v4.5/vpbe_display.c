...
static int F_70 ( struct V_202 * V_42 , void * V_203 )
{
struct V_204 * V_153 = F_71 ( V_42 ) ;
struct V_1 * V_205 = V_203 ;
if ( strcmp ( L_44 , V_153 -> V_206 ) == 0 )
V_205 -> V_4 = F_72 ( V_153 ) ;
if ( strstr ( V_153 -> V_206 , L_45 ) != NULL )
V_205 -> V_22 = F_72 ( V_153 ) ;
return 0 ;
}
static int F_73 ( int V_41 , struct V_1 * V_2 ,
struct V_204 * V_153 )
{
struct V_13 * V_207 = NULL ;
struct V_208 * V_209 = NULL ;
V_2 -> V_42 [ V_41 ] =
F_74 ( sizeof( struct V_13 ) , V_210 ) ;
if ( ! V_2 -> V_42 [ V_41 ] ) {
F_75 ( V_211 L_46 ) ;
return - V_212 ;
}
F_76 ( & V_2 -> V_42 [ V_41 ] -> V_213 ) ;
...
V_209 -> V_219 = & V_220 ;
V_209 -> V_221 = - 1 ;
V_209 -> V_11 = & V_2 -> V_4 -> V_11 ;
V_209 -> V_222 = & V_207 -> V_199 ;
V_209 -> V_223 = V_224 ;
if ( V_2 -> V_4 -> V_102 . V_183 &
V_184 )
V_209 -> V_225 = ( V_114 | V_115 ) ;
snprintf ( V_209 -> V_206 , sizeof( V_209 -> V_206 ) ,
L_47 ,
( V_226 >> 16 ) & 0xff ,
( V_226 >> 8 ) & 0xff ,
( V_226 ) & 0xff ) ;
V_207 -> V_81 = V_41 ;
V_207 -> V_33 . V_34 =
( ( V_41 == V_82 ) ? V_227 : V_228 ) ;
return 0 ;
}
static int F_78 ( struct V_13 * V_207 ,
struct V_1 * V_2 ,
struct V_204 * V_153 )
{
int V_197 ;
...
( int ) V_207 ,
( int ) & V_207 -> V_214 ) ;
V_207 -> V_214 . V_229 = & V_207 -> V_48 ;
V_197 = F_80 ( & V_207 -> V_214 ,
V_230 ,
- 1 ) ;
if ( V_197 )
return - V_231 ;
...
static int F_83 ( struct V_204 * V_153 )
{
struct V_1 * V_2 ;
struct V_232 * V_11 ;
...
return - V_212 ;
F_76 ( & V_2 -> V_24 ) ;
V_197 = F_85 ( & V_237 , NULL , V_2 ,
F_70 ) ;
if ( V_197 < 0 )
return V_197 ;
V_11 = & V_2 -> V_4 -> V_11 ;
if ( NULL != V_2 -> V_4 -> V_31 . V_238 ) {
V_197 = V_2 -> V_4 -> V_31 . V_238 ( & V_153 -> V_42 ,
V_2 -> V_4 ) ;
if ( V_197 ) {
F_3 ( V_11 , L_51 ) ;
V_197 = - V_212 ;
...
V_56 -> type = V_160 ;
V_56 -> V_243 = V_244 | V_245 | V_246 ;
V_56 -> V_247 = V_2 -> V_42 [ V_41 ] ;
V_56 -> V_31 = & V_248 ;
V_56 -> V_249 = & V_250 ;
V_56 -> V_251 = sizeof( struct V_27 ) ;
V_56 -> V_252 = V_253 ;
V_56 -> V_254 = 1 ;
V_56 -> V_222 = & V_2 -> V_42 [ V_41 ] -> V_199 ;
V_197 = F_88 ( V_56 ) ;
if ( V_197 ) {
F_3 ( V_11 , L_54 ) ;
goto V_239;
...
V_2 -> V_42 [ V_41 ] -> V_67 =
F_89 ( V_2 -> V_4 -> V_153 ) ;
if ( F_90 ( V_2 -> V_42 [ V_41 ] -> V_67 ) ) {
F_3 ( V_11 , L_55 ) ;
V_197 = F_91 ( V_2 -> V_42 [ V_41 ] -> V_67 ) ;
goto V_239;
}
...
return 0 ;
V_239:
for ( V_235 = 0 ; V_235 < V_47 ; V_235 ++ ) {
if ( V_2 -> V_42 [ V_235 ] != NULL ) {
F_93 ( V_2 -> V_42 [ V_235 ] -> V_67 ) ;
F_94 ( & V_2 -> V_42 [ V_235 ] -> V_214 ) ;
F_95 ( V_2 -> V_42 [ V_235 ] ) ;
}
}
return V_197 ;
}
static int F_96 ( struct V_204 * V_153 )
{
struct V_13 * V_207 ;
...
if ( NULL != V_4 -> V_31 . V_255 )
V_4 -> V_31 . V_255 ( & V_153 -> V_42 , V_4 ) ;
for ( V_41 = 0 ; V_41 < V_47 ; V_41 ++ ) {
V_207 = V_2 -> V_42 [ V_41 ] ;
F_93 ( V_207 -> V_67 ) ;
F_94 ( & V_207 -> V_214 ) ;
