...
static struct V_35 * T_2 F_20 (
const char * V_36 , const char * V_37 ,
struct V_38 * V_39 , void T_3 * V_40 ,
T_4 * V_8 )
{
struct V_3 * V_4 ;
struct V_35 * V_35 ;
...
V_4 -> V_8 = V_8 ;
V_4 -> V_2 . V_42 = & V_42 ;
V_35 = F_24 ( NULL , & V_4 -> V_2 ) ;
if ( F_25 ( V_35 ) )
F_26 ( V_4 ) ;
return V_35 ;
}
static void F_27 ( struct V_52 * V_23 )
{
F_5 ( V_23 , V_53 [ V_23 -> V_54 ] , 1 ) ;
F_5 ( V_23 , V_53 [ V_23 -> V_54 ] , 0 ) ;
}
static void F_28 ( struct V_52 * V_23 )
{
unsigned long V_5 = 0 ;
F_5 ( V_23 , V_53 [ V_23 -> V_54 ] , 0 ) ;
F_5 ( V_23 , V_55 [ V_23 -> V_54 ] , V_23 -> V_56 ) ;
F_5 ( V_23 , V_57 [ V_23 -> V_54 ] , V_23 -> V_57 ) ;
F_5 ( V_23 , V_58 [ V_23 -> V_54 ] , V_23 -> V_58 ) ;
if ( V_23 -> V_8 )
F_4 ( V_23 -> V_8 , V_5 ) ;
if ( V_23 -> V_9 -> V_59 )
F_5 ( V_23 , V_60 [ V_23 -> V_54 ] , V_23 -> V_60 ) ;
if ( V_23 -> V_8 )
F_6 ( V_23 -> V_8 , V_5 ) ;
}
static int F_29 ( struct V_1 * V_2 )
{
struct V_52 * V_23 = F_30 ( V_2 ) ;
unsigned long V_5 = 0 ;
F_18 ( L_4 , V_28 , F_15 ( V_2 ) ) ;
F_28 ( V_23 ) ;
if ( V_23 -> V_8 )
F_4 ( V_23 -> V_8 , V_5 ) ;
F_5 ( V_23 , V_61 [ V_23 -> V_54 ] , ! V_23 -> V_9 -> V_62 ) ;
if ( V_23 -> V_9 -> V_63 )
F_5 ( V_23 , V_64 [ V_23 -> V_54 ] , 0 ) ;
if ( V_23 -> V_8 )
F_6 ( V_23 -> V_8 , V_5 ) ;
F_27 ( V_23 ) ;
return 0 ;
...
{
struct V_52 * V_23 = F_30 ( V_2 ) ;
T_1 V_61 = F_7 ( V_23 , V_61 [ V_23 -> V_54 ] ) ;
F_18 ( L_5 ,
V_28 , F_15 ( V_2 ) , V_61 ) ;
...
{
unsigned long V_67 = ( 1 << V_23 -> V_58 ) ;
unsigned long V_66 ;
T_5 V_65 ;
V_66 = ( V_23 -> V_60 == 1 ) ? 1 : 3 ;
V_65 = ( V_71 * ( 32 + V_23 -> V_55 ) + 32 * V_23 -> V_57 ) * V_67 * V_66 ;
* V_24 = ( unsigned long ) F_34 ( V_21 * V_71 * 32 , V_65 ) ;
return 0 ;
}
static int F_37 ( struct V_52 * V_23 ,
struct V_22 * V_27 )
{
V_27 -> V_55 = F_7 ( V_23 , V_55 [ V_23 -> V_54 ] ) ;
V_27 -> V_57 = F_7 ( V_23 , V_57 [ V_23 -> V_54 ] ) ;
V_27 -> V_58 = F_7 ( V_23 , V_58 [ V_23 -> V_54 ] ) ;
if ( V_23 -> V_9 -> V_59 )
V_27 -> V_60 = F_7 ( V_23 , V_60 [ V_23 -> V_54 ] ) ;
else
V_27 -> V_60 = 1 ;
if ( ! V_27 -> V_55 && ! V_27 -> V_57 && ! V_27 -> V_58 )
return 1 ;
V_23 -> V_56 = V_27 -> V_55 ;
V_23 -> V_57 = V_27 -> V_57 ;
V_23 -> V_58 = V_27 -> V_58 ;
...
F_18 ( L_7 ,
V_28 , F_15 ( V_2 ) ,
V_24 , ( unsigned int ) V_27 . V_58 , ( unsigned int ) V_27 . V_55 ,
( unsigned int ) V_27 . V_57 , ( unsigned int ) V_27 . V_60 ) ;
return V_24 ;
}
static void F_42 ( struct V_52 * V_23 ,
struct V_22 * V_27 )
{
V_23 -> V_56 = V_27 -> V_55 ;
V_23 -> V_57 = V_27 -> V_57 ;
...
static struct V_35 * T_2 F_44 (
const char * V_36 , const char * V_37 ,
struct V_38 * V_39 , void T_3 * V_40 , T_1 V_54 ,
T_4 * V_8 )
{
struct V_52 * V_23 ;
struct V_35 * V_35 ;
...
struct V_87 * V_88 ;
int V_89 ;
V_88 = F_23 ( sizeof( * V_88 ) , V_43 ) ;
if ( ! V_88 )
return;
V_88 -> V_90 = V_91 ;
V_88 -> V_92 = F_23 ( V_91 * sizeof( struct V_35 * ) ,
V_43 ) ;
if ( ! V_88 -> V_92 ) {
F_26 ( V_88 ) ;
return;
...
if ( ! V_97 )
return;
V_86 = F_55 ( V_43 , L_10 , V_85 -> V_36 ) ;
if ( ! V_86 )
return;
V_8 = F_23 ( sizeof( * V_8 ) , V_43 ) ;
if ( ! V_8 )
goto V_99;
F_56 ( V_8 ) ;
V_35 = F_20 ( V_86 , V_97 ,
(struct V_38 * ) V_96 -> V_9 , V_40 , V_8 ) ;
if ( F_25 ( V_35 ) )
goto V_99;
else
F_18 ( L_9 ,
