...
int V_218 , V_4 , V_219 ;
T_1 V_32 , V_220 [ 3 ] ;
V_35 = F_108 ( & V_209 -> V_10 , sizeof( * V_35 ) , V_221 ) ;
if ( ! V_35 )
return - V_222 ;
V_2 -> V_35 = V_35 ;
V_35 -> V_64 = (enum V_223 ) F_109 ( & V_209 -> V_10 ) ;
if ( ! V_35 -> V_64 )
return 1 ;
...
if ( F_36 ( V_2 -> V_52 ) )
V_2 -> V_52 = NULL ;
V_35 -> V_73 = F_112 ( & V_209 -> V_10 ) ;
if ( V_35 -> V_73 == V_192 )
V_35 -> V_73 = V_74 ;
V_35 -> V_70 = V_71 ;
if ( ! F_113 ( V_214 , L_56 , & V_32 ) )
if ( V_32 == V_102 )
V_35 -> V_70 = V_32 ;
if ( ! F_113 ( V_214 , L_57 , & V_32 ) && V_32 < 2 )
V_2 -> V_53 = V_32 ;
V_2 -> V_6 [ V_89 ] = V_224 ;
V_2 -> V_6 [ V_7 ] = V_225 ;
V_2 -> V_6 [ V_8 ] = V_226 ;
if ( F_114 ( V_214 , L_58 , & V_218 ) &&
V_218 == sizeof( V_220 ) ) {
F_115 ( V_214 , L_58 ,
...
V_2 -> V_207 . V_200 . V_229 = F_106 ;
V_4 = F_120 ( V_211 , V_231 ,
& V_2 -> V_207 . V_200 ) ;
if ( V_4 < 0 ) {
F_3 ( & V_209 -> V_10 , L_63 ) ;
F_122 ( V_2 -> V_204 . V_228 ,
V_230 , & V_2 -> V_204 . V_200 ) ;
return V_4 ;
}
V_4 = F_121 ( V_211 , V_231 ) ;
if ( V_4 )
F_49 ( V_161 , & V_2 -> V_162 ) ;
else
F_55 ( V_161 , & V_2 -> V_162 ) ;
}
V_217 = F_123 ( V_214 , L_64 , & V_218 ) ;
if ( ! V_217 || ! V_218 )
return 0 ;
V_219 = V_218 / sizeof( T_1 ) ;
if ( V_219 >= V_40 ) {
F_124 ( & V_209 -> V_10 , L_65 , V_219 ) ;
return 0 ;
}
V_35 -> V_37 = F_108 ( & V_209 -> V_10 , V_218 , V_221 ) ;
if ( ! V_35 -> V_37 )
return 0 ;
V_4 = F_115 ( V_214 , L_64 ,
V_35 -> V_37 , V_219 ) ;
if ( ! V_4 )
V_35 -> V_41 = V_219 ;
return 0 ;
}
static int F_125 ( struct V_199 * V_232 ,
...
struct V_24 * V_9 ;
void T_2 * V_240 ;
V_2 = F_108 ( & V_209 -> V_10 , sizeof( struct V_1 ) , V_221 ) ;
if ( ! V_2 )
return - V_222 ;
...
V_9 = & V_2 -> V_9 ;
V_9 -> V_10 = & V_209 -> V_10 ;
V_2 -> V_105 = F_127 ( & V_209 -> V_10 , V_237 ? L_66 : L_67 ) ;
if ( F_36 ( V_2 -> V_105 ) ) {
F_3 ( & V_209 -> V_10 , L_68 ) ;
return F_111 ( V_2 -> V_105 ) ;
}
V_2 -> V_104 = F_127 ( & V_209 -> V_10 , V_237 ? L_69 : L_70 ) ;
if ( F_36 ( V_2 -> V_104 ) ) {
F_3 ( & V_209 -> V_10 , L_71 ) ;
...
V_237 ? L_72 : L_73 ) ;
V_239 = F_128 ( V_209 , V_241 , 0 ) ;
if ( ! V_239 )
return - V_193 ;
V_2 -> V_236 = F_129 ( & V_209 -> V_10 , V_239 -> V_242 , F_130 ( V_239 ) ) ;
if ( ! V_2 -> V_236 )
return - V_222 ;
V_35 = F_131 ( & V_209 -> V_10 ) ;
if ( ! V_35 ) {
if ( ! V_237 )
return - V_243 ;
V_4 = F_107 ( V_209 , V_2 ) ;
...
if ( V_2 -> V_53 ) {
V_240 = F_132 ( & V_209 -> V_10 , V_244 , 4 ) ;
if ( ! V_240 ) {
V_4 = - V_222 ;
goto V_245;
}
...
V_236 [ 1 ] . V_246 = L_77 ;
V_236 [ 2 ] . V_246 = L_78 ;
V_4 = F_134 ( V_2 -> V_9 . V_10 , F_135 ( V_236 ) , V_236 ) ;
if ( V_4 )
goto V_245;
V_2 -> V_5 = V_236 [ 0 ] . V_247 ;
V_2 -> V_12 = V_236 [ 1 ] . V_247 ;
V_2 -> V_15 = V_236 [ 2 ] . V_247 ;
F_136 ( V_2 -> V_105 , 60000000 ) ;
F_37 ( V_2 -> V_105 ) ;
F_37 ( V_2 -> V_104 ) ;
if ( ! F_36 ( V_2 -> V_68 ) )
F_37 ( V_2 -> V_68 ) ;
...
F_13 ( 0 , V_251 ) ;
F_13 ( 0 , V_72 ) ;
F_137 ( & V_2 -> V_128 , F_84 ) ;
F_138 ( & V_2 -> V_139 , F_81 ) ;
V_4 = F_139 ( & V_209 -> V_10 , V_2 -> V_96 , F_88 , V_121 ,
L_52 , V_2 ) ;
if ( V_4 ) {
F_3 ( & V_209 -> V_10 , L_82 ) ;
goto V_250;
...
{
struct V_1 * V_2 = F_147 ( V_209 ) ;
struct V_24 * V_9 = & V_2 -> V_9 ;
int V_26 = 0 ;
if ( V_9 -> V_93 -> V_94 || V_9 -> V_93 -> V_130 )
return - V_259 ;
F_148 ( & V_2 -> V_234 ) ;
F_105 ( V_2 -> V_205 , 0 ) ;
F_122 ( V_2 -> V_207 . V_228 , V_231 , & V_2 -> V_207 . V_200 ) ;
F_122 ( V_2 -> V_204 . V_228 , V_230 , & V_2 -> V_204 . V_200 ) ;
F_103 () ;
F_86 ( & V_2 -> V_139 ) ;
F_149 ( & V_2 -> V_128 ) ;
F_150 ( & V_209 -> V_10 ) ;
...
static int F_154 ( struct V_260 * V_10 )
{
...
static int F_157 ( struct V_260 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
F_60 ( V_10 , L_86 ) ;
return F_43 ( V_2 ) ;
}
static int F_158 ( struct V_260 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
F_60 ( V_10 , L_87 ) ;
return F_53 ( V_2 ) ;
}
static int F_159 ( struct V_260 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
F_60 ( V_10 , L_88 ) ;
return F_43 ( V_2 ) ;
}
static int F_160 ( struct V_260 * V_10 )
{
struct V_1 * V_2 = F_155 ( V_10 ) ;
int V_4 ;
F_60 ( V_10 , L_89 ) ;
