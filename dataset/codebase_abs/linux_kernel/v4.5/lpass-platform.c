...
struct V_5 * V_75 )
{
struct V_76 * V_77 = & V_2 -> V_16 ;
T_5 V_78 = V_9 . V_11 ;
V_77 -> V_13 . type = V_79 ;
V_77 -> V_13 . V_13 = V_75 -> V_23 -> V_13 ;
V_77 -> V_7 = NULL ;
V_77 -> V_80 = F_44 ( V_75 -> V_23 -> V_13 , V_78 , & V_77 -> V_81 ,
V_82 ) ;
if ( ! V_77 -> V_80 ) {
F_4 ( V_75 -> V_23 -> V_13 , L_15 ,
V_14 ) ;
return - V_83 ;
}
V_77 -> V_84 = V_78 ;
...
struct V_76 * V_77 = & V_2 -> V_16 ;
if ( V_77 -> V_80 ) {
F_46 ( V_75 -> V_13 , V_77 -> V_84 , V_77 -> V_80 ,
V_77 -> V_81 ) ;
}
V_77 -> V_80 = NULL ;
}
...
{
struct V_85 * V_61 = V_6 -> V_61 ;
struct V_1 * V_2 =
V_61 -> V_86 [ V_87 ] . V_2 ;
struct V_88 * V_89 = V_6 -> V_89 ;
struct V_21 * V_22 =
F_8 ( V_6 -> V_23 ) ;
struct V_24 * V_25 = V_22 -> V_26 ;
int V_8 ;
struct V_19 * V_72 ;
V_72 = F_48 ( V_6 -> V_13 , sizeof( * V_72 ) , V_82 ) ;
if ( ! V_72 )
return - V_83 ;
if ( V_25 -> V_90 )
V_72 -> V_43 = V_25 -> V_90 ( V_22 ) ;
if ( F_49 ( V_72 -> V_43 ) )
return V_72 -> V_43 ;
V_22 -> V_2 [ V_72 -> V_43 ] = V_2 ;
V_72 -> V_32 = V_89 -> V_91 -> V_92 ;
F_50 ( V_6 , V_72 ) ;
V_8 = F_43 ( V_2 , V_6 ) ;
if ( V_8 )
return V_8 ;
...
static void F_51 ( struct V_85 * V_61 )
{
struct V_1 * V_2 =
V_61 -> V_86 [ V_87 ] . V_2 ;
struct V_5 * V_6 = V_2 -> V_7 ;
...
if ( V_25 -> V_94 )
V_25 -> V_94 ( V_22 , V_72 -> V_43 ) ;
F_45 ( V_2 , V_6 ) ;
}
int F_52 ( struct V_95 * V_96 )
{
struct V_21 * V_22 = F_53 ( V_96 ) ;
struct V_24 * V_25 = V_22 -> V_26 ;
int V_8 ;
V_22 -> V_97 = F_54 ( V_96 , L_16 ) ;
if ( V_22 -> V_97 < 0 ) {
F_4 ( & V_96 -> V_13 , L_17 ,
V_14 , V_22 -> V_97 ) ;
return - V_98 ;
