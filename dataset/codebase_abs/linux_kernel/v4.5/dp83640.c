...
F_61 ( & V_26 -> V_210 . V_211 ) ;
if ( ! V_206 )
F_62 ( & V_42 -> V_154 , & V_26 -> V_42 ) ;
V_209:
F_63 ( & V_26 -> V_208 , V_118 ) ;
}
...
T_2 V_176 , type ;
V_218 = V_145 -> V_174 + 2 ;
for ( V_175 = F_68 ( V_145 ) - 2 ; V_175 > sizeof( type ) ; V_175 -= V_219 ) {
type = * ( T_2 * ) V_218 ;
V_176 = type & 0x0fff ;
type = type & 0xf000 ;
V_175 -= sizeof( type ) ;
...
F_73 ( & clock -> V_79 ) ;
F_73 ( & clock -> V_224 ) ;
F_74 ( & clock -> V_22 -> V_31 ) ;
F_75 ( clock -> V_90 . V_128 ) ;
F_75 ( clock ) ;
}
F_15 ( & V_223 ) ;
}
static void F_76 ( struct V_57 * clock , struct V_225 * V_22 )
{
F_77 ( & clock -> V_154 ) ;
clock -> V_22 = V_22 ;
F_78 ( & clock -> V_79 ) ;
...
static struct V_57 * F_82 ( struct V_225 * V_22 )
{
...
if ( clock )
goto V_209;
clock = F_83 ( sizeof( struct V_57 ) , V_242 ) ;
if ( ! clock )
goto V_209;
...
return 0 ;
clock = F_82 ( V_18 -> V_21 . V_22 ) ;
if ( ! clock )
goto V_245;
V_26 = F_83 ( sizeof( struct V_25 ) , V_242 ) ;
if ( ! V_26 )
goto V_246;
V_26 -> V_18 = V_18 ;
F_86 ( & V_26 -> V_247 , V_248 ) ;
F_77 ( & V_26 -> V_42 ) ;
F_77 ( & V_26 -> V_155 ) ;
...
static int F_99 ( struct V_17 * V_18 , struct V_264 * V_265 )
{
struct V_25 * V_26 = V_18 -> V_27 ;
struct V_266 V_267 ;
T_2 V_268 , V_269 ;
if ( F_100 ( & V_267 , V_265 -> V_270 , sizeof( V_267 ) ) )
return - V_271 ;
if ( V_267 . V_118 )
return - V_68 ;
...
return F_101 ( V_265 -> V_270 , & V_267 , sizeof( V_267 ) ) ? - V_271 : 0 ;
}
...
F_102 ( & V_26 -> V_210 , V_145 ) ;
break;
}
F_60 ( V_145 ) ;
}
if ( ! F_103 ( & V_26 -> V_210 ) )
F_104 ( & V_26 -> V_247 , V_55 ) ;
}
static bool F_105 ( struct V_17 * V_18 ,
