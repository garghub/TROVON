...
static struct V_18 * F_14 ( struct V_19 * V_20 ,
...
static void F_21 ( struct V_35 * V_36 , enum V_37 V_38 )
{
...
static unsigned long F_36 ( struct V_3 * V_4 ,
unsigned long V_10 )
{
struct V_45 * V_46 = F_30 ( V_4 ) ;
T_1 V_2 ;
...
static int F_37 ( struct V_3 * V_4 , unsigned long V_57 ,
unsigned long V_10 )
{
struct V_45 * V_46 = F_30 ( V_4 ) ;
unsigned long V_23 = 0 ;
...
static long F_38 ( struct V_3 * V_4 , unsigned long V_57 ,
unsigned long * V_60 )
{
struct V_45 * V_46 = F_30 ( V_4 ) ;
...
static struct V_18 * F_39 ( struct V_19 * V_20 ,
const char * V_21 , const char * V_22 ,
...
static void T_5 F_40 ( struct V_35 * V_36 )
{
const char * V_39 = V_36 -> V_40 ;
struct V_18 * V_18 ;
struct V_65 V_66 ;
...
if ( strcmp ( V_66 . V_21 , L_21 ) == 0 )
V_62 . V_53 = V_68 ;
else
V_62 . V_48 = V_68 ;
}
if ( F_43 ( V_36 , L_22 , & V_62 . V_51 ) )
V_62 . V_51 = 0 ;
if ( F_43 ( V_36 , L_23 , & V_62 . V_52 ) )
V_62 . V_52 = 0xF ;
if ( F_43 ( V_36 , L_24 ,
& V_62 . V_49 ) )
V_62 . V_49 = 0x8 ;
if ( F_43 ( V_36 , L_25 , & V_62 . V_50 ) )
V_62 . V_50 = 0xF ;
if ( F_43 ( V_36 , L_26 ,
& V_62 . V_54 ) )
V_62 . V_54 = 0 ;
...
F_23 ( V_36 , L_8 , & V_39 ) ;
V_18 = F_39 ( NULL , V_39 ,
F_24 ( V_36 , 0 ) , & V_62 , & V_42 ) ;
if ( F_19 ( V_18 ) )
goto V_69;
F_7 ( L_29 , V_39 ) ;
V_63 = F_25 ( V_36 , V_43 , V_18 ) ;
if ( V_63 != 0 )
F_16 ( L_30 , V_29 ,
V_36 -> V_40 ) ;
return;
