...
struct V_122 * V_123 = F_56 ( V_2 -> V_99 ) ;
int V_43 = 0 ;
V_5 = F_57 ( V_2 -> V_99 , sizeof( * V_5 ) , V_124 ) ;
if ( V_5 == NULL )
return - V_125 ;
F_58 ( V_2 , V_5 ) ;
V_5 -> V_2 = V_2 ;
V_2 -> V_7 = V_6 ;
V_5 -> V_126 = F_59 ( V_123 , 0 ) ;
if ( V_5 -> V_126 < 0 ) {
F_48 ( V_2 -> V_99 , L_9 ) ;
return - V_77 ;
}
...
{
return F_67 ( & V_123 -> V_99 , & V_129 ,
V_130 , F_68 ( V_130 ) ) ;
}
static int F_69 ( struct V_122 * V_123 )
{
F_70 ( & V_123 -> V_99 ) ;
return 0 ;
}
