...
T_1 F_14 ( T_2 * V_9 , void * V_18 , T_2 V_8 )
{
if ( ! V_9 || ! V_18 )
return V_3 ;
if ( ( * V_9 >> V_10 ) != V_8 )
...
T_1 F_16 ( T_2 * V_9 , void * V_20 , T_2 V_8 )
{
V_16 * V_21 = ( V_16 * ) V_20 ;
T_2 V_22 ;
if ( ! V_20 || ! V_9 )
...
static T_2 * F_17 ( T_2 * V_1 , T_3 V_6 )
{
T_2 * V_9 ;
if ( ! V_1 )
return NULL ;
...
static T_1 F_20 ( T_2 * V_9 , T_2 * * V_35 ,
const struct V_23 * V_24 )
{
T_2 V_22 , V_6 , V_36 = 0 ;
T_1 V_37 = 0 ;
...
T_1 F_21 ( struct V_39 * V_40 , T_2 * V_1 ,
struct V_41 * V_42 ,
...
V_37 = F_20 ( V_1 , V_35 , V_44 -> V_9 ) ;
if ( V_37 < 0 )
return V_37 ;
return V_44 -> V_46 ( V_40 , V_35 , V_42 ) ;
}
T_1 F_22 ( struct V_39 * V_40 , T_2 * * V_35 ,
struct V_41 * V_42 )
{
return V_27 ;
}
static void F_23 ( T_2 * V_1 , T_2 V_47 )
{
if ( V_47 & ( 1 << V_48 ) )
F_2 ( V_1 , V_48 ,
V_49 ) ;
...
T_1 F_33 ( struct V_39 * V_40 , T_2 * * V_35 ,
struct V_41 * V_42 )
{
T_2 * V_74 [ V_38 ] ;
