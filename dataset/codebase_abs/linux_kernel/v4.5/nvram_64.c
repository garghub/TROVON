...
if ( V_16 . V_122 == NULL )
return - V_123 ;
return F_46 ( V_119 , V_120 , V_121 , V_124 ,
V_16 . V_122 () ) ;
}
static T_5 F_47 ( struct V_119 * V_119 , char T_6 * V_76 ,
T_3 V_69 , T_1 * V_125 )
{
T_5 V_33 ;
char * V_126 = NULL ;
...
V_69 = F_48 ( T_3 , V_69 , V_13 - * V_125 ) ;
V_69 = F_49 ( V_69 , V_127 ) ;
...
if ( V_33 <= 0 )
goto V_29;
if ( F_50 ( V_76 , V_126 , V_33 ) )
V_33 = - V_128 ;
V_29:
F_27 ( V_126 ) ;
return V_33 ;
}
static T_5 F_51 ( struct V_119 * V_119 , const char T_6 * V_76 ,
T_3 V_69 , T_1 * V_125 )
{
T_5 V_33 ;
char * V_126 = NULL ;
...
static long F_53 ( struct V_119 * V_119 , unsigned int V_129 ,
unsigned long V_130 )
{
switch( V_129 ) {
#ifdef F_54
...
if ( ! F_32 ( V_134 ) )
return - V_135 ;
if ( F_52 ( & V_2 , ( void T_6 * ) V_130 , sizeof( V_2 ) ) != 0 )
return - V_128 ;
...
if ( V_120 < 0 )
return V_120 ;
if ( F_50 ( ( void T_6 * ) V_130 , & V_120 , sizeof( V_120 ) ) != 0 )
return - V_128 ;
return 0 ;
}
#endif
...
static void T_2 F_57 ( char * V_138 )
{
struct V_139 * V_140 ;
F_55 ( V_132 L_26 , V_138 ) ;
F_55 ( V_132 L_27 ) ;
...
static int T_2 F_59 ( struct V_139 * V_2 )
{
T_1 V_8 ;
int V_7 ;
struct V_144 V_145 ;
...
static unsigned char T_2 F_60 ( struct V_144 * V_21 )
{
...
static int F_61 ( struct V_139 * V_2 ,
...
V_152 -> V_141 . V_143 = F_60 ( & V_2 -> V_141 ) ;
V_7 = F_59 ( V_2 ) ;
if ( V_7 <= 0 ) {
F_55 ( V_154 L_30 , V_7 ) ;
return V_7 ;
...
long V_13 = 0 ;
int V_7 ;
V_25 = F_64 ( V_25 , V_159 ) / V_159 ;
V_24 = F_64 ( V_24 , V_159 ) / V_159 ;
if ( V_24 == 0 )
V_24 = V_25 ;
if ( V_24 > V_25 )
return - V_135 ;
...
V_156 -> V_141 . V_143 = F_60 ( & V_156 -> V_141 ) ;
V_7 = F_59 ( V_156 ) ;
if ( V_7 <= 0 ) {
F_3 ( L_32 , V_18 , V_7 ) ;
F_27 ( V_156 ) ;
