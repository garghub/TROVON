...
static int F_107 ( struct V_110 * V_110 , struct V_111 * V_111 )
{
return F_108 ( V_111 , & V_112 ) ;
}
static int F_109 ( struct V_110 * V_110 , struct V_111 * V_111 )
{
return F_108 ( V_111 , & V_113 ) ;
}
static void F_110 ( struct V_78 * V_79 , T_1 * V_21 ,
struct V_10 * V_10 )
{
int V_3 ;
...
L_24 ,
V_10 -> V_118 [ 0 ] ) ;
for ( V_3 = 1 ; V_3 < F_111 ( V_10 -> V_118 ) ; V_3 ++ )
...
{
T_1 * V_21 = ( T_1 * ) V_81 ;
F_72 ( V_79 , V_21 , F_110 ) ;
return 0 ;
}
static int F_115 ( struct V_110 * V_110 , struct V_111 * V_111 )
{
return F_108 ( V_111 , & V_122 ) ;
}
static void * F_116 ( struct V_78 * V_79 , T_5 * V_80 )
{
unsigned long * V_33 ;
int V_3 , V_123 ;
if ( * V_80 >= F_111 ( V_117 ) )
...
static void * F_122 ( struct V_78 * V_79 , void * V_81 , T_5 * V_80 )
{
( * V_80 ) ++ ;
if ( * V_80 >= F_111 ( V_117 ) )
return NULL ;
...
static void F_124 ( struct V_78 * V_79 , void * V_81 )
{
F_125 ( V_79 -> V_126 ) ;
V_79 -> V_126 = NULL ;
}
static int F_126 ( struct V_110 * V_110 , struct V_111 * V_111 )
{
return F_108 ( V_111 , & V_134 ) ;
}
...
if ( V_141 != V_142 )
return;
if ( F_137 ( F_129 () , V_137 ) )
return;
if ( ! F_133 ( F_129 () ) )
return;
F_46 ( false ) ;
}
static void F_138 ( struct V_135 * V_136 )
{
int V_2 ;
F_5 () ;
F_139 (cpu, cpu_stat_off) {
struct V_143 * V_144 = & F_3 ( V_139 , V_2 ) ;
if ( F_133 ( V_2 ) ) {
if ( F_128 ( V_2 , V_137 ) )
F_130 ( V_2 , V_138 , V_144 , 0 ) ;
} else {
F_140 ( V_144 ) ;
}
}
...
int V_2 ;
F_143 (cpu)
F_144 ( F_19 ( & V_139 , V_2 ) ,
F_127 ) ;
if ( ! F_145 ( & V_137 , V_125 ) )
F_146 () ;
F_147 ( V_137 , V_146 ) ;
V_138 = F_148 ( L_37 , V_147 | V_148 , 0 ) ;
F_141 ( & V_145 ,
F_131 ( V_140 ) ) ;
}
static void F_149 ( int V_56 )
{
int V_2 ;
F_5 () ;
F_2 (cpu)
...
static int F_152 ( struct V_151 * V_152 ,
unsigned long V_153 ,
void * V_154 )
{
long V_2 = ( long ) V_154 ;
...
#endif
#ifdef F_160
F_161 ( L_38 , V_165 , NULL , & V_166 ) ;
F_161 ( L_39 , V_165 , NULL , & V_167 ) ;
F_161 ( L_37 , V_165 , NULL , & V_168 ) ;
F_161 ( L_40 , V_165 , NULL , & V_169 ) ;
#endif
return 0 ;
}
static int F_162 ( unsigned int V_69 ,
struct V_67 * V_68 )
{
if ( V_68 -> V_70 == 0 )
return 1000 ;
...
static void F_163 ( struct V_78 * V_79 ,
T_1 * V_21 , struct V_10 * V_10 )
{
unsigned int V_69 ;
int V_170 ;
...
for ( V_69 = 0 ; V_69 < V_73 ; ++ V_69 ) {
F_63 ( V_10 , V_69 , & V_68 ) ;
V_170 = F_162 ( V_69 , & V_68 ) ;
F_78 ( V_79 , L_41 , V_170 / 1000 , V_170 % 1000 ) ;
}
F_79 ( V_79 , '\n' ) ;
}
static int F_164 ( struct V_78 * V_79 , void * V_81 )
{
T_1 * V_21 = ( T_1 * ) V_81 ;
if ( ! F_106 ( V_21 -> V_84 , V_108 ) )
return 0 ;
F_72 ( V_79 , V_21 , F_163 ) ;
return 0 ;
}
static int F_165 ( struct V_110 * V_110 , struct V_111 * V_111 )
{
return F_108 ( V_111 , & V_171 ) ;
}
...
{
T_1 * V_21 = ( T_1 * ) V_81 ;
F_72 ( V_79 , V_21 , F_166 ) ;
return 0 ;
}
static int F_168 ( struct V_110 * V_110 , struct V_111 * V_111 )
{
return F_108 ( V_111 , & V_172 ) ;
}
static int T_6 F_169 ( void )
{
struct V_173 * V_174 ;
V_174 = F_170 ( L_42 , NULL ) ;
if ( ! V_174 )
return - V_127 ;
if ( ! F_171 ( L_43 , 0444 ,
V_174 , NULL , & V_175 ) )
