...
F_3 ( & V_2 , V_13 ) ;
F_6 ( & V_2 , V_13 , V_19 ) ;
F_8 ( & V_2 , V_41 , V_13 -> V_35 -> V_42 ,
V_13 -> V_35 -> V_23 , V_13 -> V_35 -> V_43 ) ;
F_12 (cmd, &gpu->active_cmd_list, node)
F_8 ( & V_2 , V_44 , V_30 -> V_42 ,
V_30 -> V_23 , V_30 -> V_43 ) ;
if ( V_32 ) {
V_34 = V_33 = V_2 . V_9 ;
...
for ( V_49 = 0 ; V_49 < V_28 -> V_38 . V_23 > > V_39 ; V_49 ++ )
* V_33 ++ = F_9 ( F_18 ( * V_47 ++ ) ) ;
}
V_2 . V_5 -> V_24 = F_9 ( V_26 -> V_24 ) ;
V_42 = F_19 ( & V_28 -> V_38 ) ;
if ( V_42 )
memcpy ( V_2 . V_9 , V_42 , V_28 -> V_38 . V_23 ) ;
F_1 ( & V_2 , V_50 , V_2 . V_9 +
V_28 -> V_38 . V_23 ) ;
}
F_1 ( & V_2 , V_51 , V_2 . V_9 ) ;
F_20 ( V_13 -> V_40 , V_2 . V_10 , V_2 . V_9 - V_2 . V_10 , V_52 ) ;
}
