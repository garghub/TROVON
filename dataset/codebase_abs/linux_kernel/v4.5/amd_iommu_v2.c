...
F_56 ( & V_38 -> V_77 ) ;
V_62 = F_57 ( V_38 , V_40 ) ;
if ( ! V_62 || V_40 < V_62 -> V_78 )
goto V_79;
if ( F_54 ( V_62 , V_53 ) )
goto V_79;
V_27 = F_58 ( V_38 , V_62 , V_40 , V_9 ) ;
V_79:
F_59 ( & V_38 -> V_77 ) ;
if ( V_27 & V_73 )
F_52 ( V_53 ) ;
...
int V_27 ;
V_85 = V_83 ;
V_47 = V_85 -> V_47 & 0x1ff ;
V_51 = ( V_85 -> V_47 >> 9 ) & 1 ;
V_27 = V_86 ;
V_8 = F_4 ( V_85 -> F_1 ) ;
if ( V_8 == NULL )
goto V_79;
V_17 = F_22 ( V_8 , V_85 -> V_18 ) ;
if ( V_17 == NULL || V_17 -> V_32 ) {
F_51 ( V_8 -> V_2 , V_85 -> V_18 ,
V_56 , V_47 ) ;
goto V_87;
}
F_5 ( & V_17 -> V_28 , V_9 ) ;
...
int F_75 ( struct V_1 * V_2 , int V_100 )
{
struct V_7 * V_8 ;
struct V_12 * V_13 ;
unsigned long V_9 ;
...
if ( ! F_65 () )
return - V_91 ;
if ( V_100 <= 0 || V_100 > ( V_102 + 1 ) )
return - V_92 ;
V_3 = F_1 ( V_2 ) ;
V_8 = F_61 ( sizeof( * V_8 ) , V_93 ) ;
if ( V_8 == NULL )
return - V_29 ;
F_68 ( & V_8 -> V_28 ) ;
F_67 ( & V_8 -> V_16 ) ;
...
V_8 -> V_3 = V_3 ;
V_101 = V_100 ;
for ( V_8 -> V_24 = 0 ; ( V_101 - 1 ) & ~ 0x1ff ; V_101 >>= 9 )
V_8 -> V_24 += 1 ;
F_66 ( & V_8 -> V_11 , 1 ) ;
V_8 -> V_36 = V_100 ;
V_27 = - V_29 ;
V_8 -> V_25 = ( void * ) F_19 ( V_93 ) ;
if ( V_8 -> V_25 == NULL )
goto V_103;
V_8 -> V_15 = F_76 ( & V_104 ) ;
if ( V_8 -> V_15 == NULL )
