...
static void F_12 ( struct V_20 * V_21 , T_2 const * V_22 ,
int V_23 )
{
while ( V_23 -- ) {
F_8 ( V_21 -> V_8 , V_22 ) ;
...
int F_13 ( struct V_25 * V_26 , const T_2 * V_27 ,
unsigned int V_28 )
{
return F_14 ( V_26 , V_27 , V_28 , F_12 ) ;
}
static int F_15 ( struct V_25 * V_26 , T_2 * V_29 )
{
F_16 ( V_26 , F_12 ) ;
return F_17 ( V_26 , V_29 ) ;
}
int F_18 ( struct V_25 * V_26 , const T_2 * V_27 ,
unsigned int V_28 , T_2 * V_30 )
{
F_14 ( V_26 , V_27 , V_28 , F_12 ) ;
return F_15 ( V_26 , V_30 ) ;
}
static int T_3 F_19 ( void )
{
return F_20 ( V_31 , F_21 ( V_31 ) ) ;
}
