...
V_39 -> V_102 = F_185 ( V_385 ) ;
if ( ! V_39 -> V_102 ) {
V_40 = - V_65 ;
goto V_393;
}
F_4 ( & V_7 , V_6 ) ;
F_28 ( & V_39 -> V_316 , & V_394 ) ;
F_5 ( & V_7 , V_6 ) ;
V_40 = F_168 ( V_39 ) ;
if ( V_40 ) {
F_67 ( & V_3 -> V_52 , L_48 ) ;
...
int V_396 , V_23 ;
V_396 = F_192 ( V_3 ) ;
for ( V_23 = V_396 ; V_23 <= F_193 ( V_3 ) ; V_23 ++ ) {
if ( ! F_194 ( V_3 , V_23 ) )
continue;
if ( F_180 ( V_3 , V_23 ) ) {
...
static void F_197 ( struct V_2 * V_3 , void * V_398 )
{
int V_23 ;
...
{
V_378 = F_199 ( V_378 , V_399 ) ;
V_378 = F_200 ( V_378 , V_400 ) ;
V_376 = F_199 ( V_376 , V_399 ) ;
V_376 = F_200 ( V_376 , V_400 ) ;
F_21 ( & V_394 ) ;
if ( F_201 ( & V_401 ) ) {
F_105 ( L_54 ) ;
return - V_41 ;
