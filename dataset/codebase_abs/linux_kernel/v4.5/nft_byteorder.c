...
V_8 -> V_11 = F_13 ( V_31 [ V_33 ] ) ;
V_8 -> V_21 = F_7 ( F_12 ( V_31 [ V_35 ] ) ) ;
V_32 = F_14 ( V_8 -> V_11 , V_8 -> V_21 ) ;
if ( V_32 < 0 )
return V_32 ;
V_8 -> V_13 = F_13 ( V_31 [ V_34 ] ) ;
return F_15 ( V_29 , V_8 -> V_13 , NULL ,
V_39 , V_8 -> V_21 ) ;
}
static int F_16 ( struct V_40 * V_41 , const struct V_1 * V_2 )
{
const struct V_7 * V_8 = F_2 ( V_2 ) ;
if ( F_17 ( V_41 , V_33 , V_8 -> V_11 ) )
goto V_42;
if ( F_17 ( V_41 , V_34 , V_8 -> V_13 ) )
goto V_42;
if ( F_18 ( V_41 , V_37 , F_8 ( V_8 -> V_19 ) ) )
goto V_42;
if ( F_18 ( V_41 , V_35 , F_8 ( V_8 -> V_21 ) ) )
goto V_42;
if ( F_18 ( V_41 , V_36 , F_8 ( V_8 -> V_17 ) ) )
goto V_42;
return 0 ;
V_42:
return - 1 ;
