...
struct V_125 * V_126 =
F_123 ( V_13 , V_126 ) ;
int V_127 = F_123 ( V_13 , V_127 ) ;
int V_128 ;
int V_28 ;
V_7 = F_79 ( sizeof( struct V_6 ) , V_129 ) ;
if ( ! V_7 ) {
F_48 ( V_11 , L_17 ) ;
return - V_130 ;
}
V_2 = F_79 ( sizeof( struct V_1 ) * V_127 , V_129 ) ;
if ( ! V_2 ) {
F_48 ( V_11 , L_18 ) ;
V_28 = - V_130 ;
goto V_131;
}
V_7 -> V_118 = F_124 ( V_132 ) ;
F_125 ( V_11 , L_19 ,
V_7 -> V_118 ? L_20 : L_21 ) ;
F_126 ( V_13 , & V_7 -> V_99 , V_133 ) ;
V_7 -> V_99 . V_60 = L_22 ;
V_7 -> V_99 . V_134 = F_120 ;
V_7 -> V_99 . V_135 = F_121 ;
V_7 -> V_2 = V_2 ;
V_7 -> V_136 = V_127 ;
F_127 ( V_7 ) ;
V_7 -> V_30 . V_11 . V_137 = V_11 ;
V_7 -> V_30 . V_60 = L_23 ;
V_7 -> V_30 . V_138 = & V_139 ;
V_7 -> V_30 . V_116 = V_140 ;
F_128 ( & V_7 -> V_30 . V_141 ) ;
F_129 (uep, gpriv, i) {
V_2 -> V_7 = V_7 ;
V_2 -> V_9 = NULL ;
snprintf ( V_2 -> V_142 , V_143 , L_24 , V_128 ) ;
V_2 -> V_15 . V_60 = V_2 -> V_142 ;
V_2 -> V_15 . V_138 = & V_144 ;
F_128 ( & V_2 -> V_15 . V_141 ) ;
if ( F_130 ( V_2 ) ) {
V_7 -> V_30 . V_145 = & V_2 -> V_15 ;
F_131 ( & V_2 -> V_15 , 64 ) ;
V_2 -> V_15 . V_146 . V_147 = true ;
} else {
if ( V_126 [ V_128 ] . type == V_148 )
V_2 -> V_15 . V_146 . V_149 = true ;
if ( V_126 [ V_128 ] . type == V_150 )
V_2 -> V_15 . V_146 . V_151 = true ;
if ( V_126 [ V_128 ] . type == V_152 )
V_2 -> V_15 . V_146 . V_153 = true ;
F_131 ( & V_2 -> V_15 ,
V_126 [ V_128 ] . V_154 ) ;
F_132 ( & V_2 -> V_15 . V_141 , & V_7 -> V_30 . V_141 ) ;
}
V_2 -> V_15 . V_146 . V_155 = true ;
V_2 -> V_15 . V_146 . V_156 = true ;
}
