...
{
unsigned long V_137 = 1UL << 31 ;
if ( V_138 >= ( 64ULL << ( 30 - V_65 ) ) ) {
F_161 ( L_19 ) ;
...
return V_139 ;
while ( V_137 > V_139 ) {
if ( ! ( ( V_92 << V_65 ) & ( V_137 - 1 ) ) )
break;
V_137 >>= 1 ;
}
F_38 ( V_140 L_20 , V_137 >> 20 ) ;
return V_137 ;
}
...
static int T_9 F_163 ( unsigned long V_30 ,
unsigned long V_4 , int V_142 , struct V_107 * V_108 )
{
unsigned long V_3 ;
unsigned long V_11 ;
T_3 * V_24 ;
...
for ( V_3 = V_30 ; V_3 < V_4 ; V_3 = V_11 ) {
V_11 = F_118 ( V_3 , V_4 ) ;
V_24 = F_164 ( V_3 , V_142 ) ;
if ( ! V_24 )
return - V_17 ;
V_12 = F_165 ( V_24 , V_3 , V_142 ) ;
if ( ! V_12 )
return - V_17 ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_43 ( * V_7 ) ) {
void * V_143 ;
V_143 = F_166 ( V_6 , V_142 , V_108 ) ;
if ( V_143 ) {
T_7 V_144 ;
V_144 = F_67 ( F_12 ( V_143 ) >> V_65 ,
V_55 ) ;
F_4 ( V_7 , F_5 ( F_66 ( V_144 ) ) ) ;
if ( V_145 != V_143 || V_146 != V_142 ) {
if ( V_147 )
F_35 ( L_21 ,
V_148 , V_149 - 1 , V_147 , V_145 - 1 , V_146 ) ;
V_148 = V_3 ;
V_146 = V_142 ;
V_147 = V_143 ;
}
...
F_167 ( ( T_7 * ) V_7 , V_142 , V_3 , V_11 ) ;
continue;
}
F_168 ( L_22 ) ;
if ( F_169 ( V_3 , V_11 , V_142 ) )
return - V_17 ;
}
return 0 ;
}
int T_9 F_170 ( unsigned long V_30 , unsigned long V_4 , int V_142 )
{
struct V_107 * V_108 = F_99 ( V_30 ) ;
int V_150 ;
if ( V_151 )
V_150 = F_163 ( V_30 , V_4 , V_142 , V_108 ) ;
else if ( V_108 ) {
F_171 ( L_23 ,
V_152 ) ;
V_150 = - V_17 ;
} else
V_150 = F_169 ( V_30 , V_4 , V_142 ) ;
if ( ! V_150 )
F_20 ( V_30 , V_4 - 1 , 0 ) ;
return V_150 ;
}
void F_172 ( unsigned long V_153 ,
struct V_34 * V_154 , unsigned long V_51 )
{
unsigned long V_3 = ( unsigned long ) V_154 ;
unsigned long V_4 = ( unsigned long ) ( V_154 + V_51 ) ;
unsigned long V_11 ;
T_3 * V_24 ;
T_2 * V_12 ;
T_1 * V_7 ;
...
F_173 ( V_153 , V_19 ( * V_24 ) , V_111 ) ;
V_12 = F_16 ( V_24 , V_3 ) ;
if ( F_40 ( * V_12 ) ) {
V_11 = ( V_3 + V_42 ) & V_43 ;
continue;
}
F_173 ( V_153 , V_10 ( * V_12 ) , V_111 ) ;
if ( ! V_151 ) {
V_11 = ( V_3 + V_42 ) & V_43 ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_43 ( * V_7 ) )
