...
struct V_1 * V_2 ;
* V_115 = NULL ;
V_2 = F_81 ( V_26 , V_89 , V_29 ) ;
if ( ! V_2 )
return - V_24 ;
ASSERT ( V_2 -> V_20 == 1 ) ;
V_2 -> V_40 = V_109 ;
V_2 -> V_19 [ 0 ] . V_41 = V_114 ;
V_2 -> V_7 |= V_106 ;
V_2 -> V_104 = V_111 ;
F_74 ( V_2 ) ;
if ( V_2 -> V_116 ) {
...
T_4 V_122 ;
int V_50 ;
V_121 = ( unsigned long ) V_118 & V_64 ;
V_59 = ( unsigned long ) V_118 - V_121 ;
V_122 = F_87 ( V_119 + V_59 ) ;
V_50 = V_122 >> V_65 ;
if ( V_2 -> V_51 )
F_30 ( V_2 ) ;
V_2 -> V_51 = NULL ;
...
int error , V_30 ;
struct V_1 * V_2 ;
F_89 ( V_27 , V_109 , V_89 ) ;
V_2 = F_15 ( V_26 , & V_27 , 1 , 0 ) ;
if ( F_17 ( V_2 == NULL ) )
goto V_123;
V_50 = F_87 ( V_89 << V_124 ) >> V_65 ;
error = F_28 ( V_2 , V_50 ) ;
if ( error )
goto V_125;
...
struct V_1 * V_2 )
{
bool V_131 = V_2 -> V_7 & V_106 ;
F_116 ( V_2 , V_49 ) ;
V_2 -> V_7 &= ~ ( V_106 | V_108 | V_35 ) ;
if ( ! V_2 -> V_116 && V_2 -> V_132 )
F_70 ( V_2 , V_2 -> V_132 ) ;
if ( V_131 && ! V_2 -> V_116 && V_2 -> V_104 ) {
ASSERT ( ! V_2 -> V_103 ) ;
V_2 -> V_104 -> V_133 ( V_2 ) ;
}
if ( ! V_2 -> V_116 )
...
struct V_1 * V_2 )
{
F_121 ( & V_2 -> V_137 , F_118 ) ;
F_122 ( V_2 -> V_138 , & V_2 -> V_137 ) ;
}
void
F_70 (
T_2 * V_2 ,
...
F_53 ( V_2 -> V_14 -> V_47 ,
L_5 ,
( V_140 ) F_125 ( V_2 ) , V_139 , - V_2 -> V_116 , V_2 -> V_42 ) ;
}
int
F_126 (
struct V_1 * V_2 )
...
F_5 ( & V_2 -> V_10 ) ;
if ( ! V_2 -> V_132 )
V_2 -> V_132 = V_143 -> V_145 ;
F_10 ( & V_2 -> V_10 ) ;
}
if ( ! V_2 -> V_116 && F_1 ( V_2 ) && ( V_2 -> V_7 & V_106 ) )
...
void * V_198 )
{
struct V_1 * V_2 = F_119 ( V_194 , struct V_1 , V_16 ) ;
