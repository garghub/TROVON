...
static void F_136 ( struct V_1 * V_211 )
{
struct V_1 * V_212 ;
...
static int F_149 ( struct V_1 * V_211 )
{
struct V_1 * V_2 ;
int V_39 ;
int V_29 , V_224 ;
...
static void F_153 ( struct V_1 * V_2 , int V_232 )
{
struct V_1 * V_211 ;
int V_39 ;
int V_223 ;
...
{
T_6 V_254 = F_174 ( 0 , 0 ) ;
F_175 ( & V_2 -> V_2 , L_103 , F_173 ) ;
if ( V_255 ) {
F_176 ( L_104 ,
F_173 , F_177 ( V_256 ) , F_178 ( & V_2 -> V_2 ) ) ;
V_254 = F_179 () ;
}
return V_254 ;
}
static void F_180 ( struct V_1 * V_2 , T_6 V_254 ,
void (* F_173)( struct V_1 * V_2 ) )
{
T_6 V_257 , V_258 ;
...
if ( V_255 ) {
V_258 = F_179 () ;
V_257 = F_181 ( V_258 , V_254 ) ;
V_259 = ( unsigned long long ) F_182 ( V_257 ) >> 10 ;
F_176 ( L_105 ,
F_173 , V_259 , F_178 ( & V_2 -> V_2 ) ) ;
}
}
static void F_183 ( struct V_1 * V_2 )
{
void T_4 * V_260 = F_184 ( V_2 , 0 , 0 ) ;
if ( V_260 == NULL ) {
F_52 ( & V_2 -> V_2 , L_106 ) ;
return;
}
...
if ( ! V_266 )
return;
if ( F_195 ( F_196 ( V_266 , L_109 , & V_267 ) )
|| F_195 ( F_196 ( V_266 , L_110 , & V_268 ) )
|| F_195 ( F_196 ( V_266 , L_111 , & V_269 ) ) )
return;
F_6 ( & V_2 -> V_2 , L_112 ) ;
F_197 ( V_267 , NULL , 1 ) ;
F_197 ( V_268 , NULL , 0 ) ;
...
if ( F_193 ( V_2 ) != V_274 )
return;
V_272 = F_114 ( V_2 -> V_51 , 0x0 ) ;
if ( V_272 == V_2 )
goto V_228;
if ( ! V_272 || ! V_272 -> V_83 )
goto V_228;
V_273 = F_114 ( V_272 -> V_83 , 0x0 ) ;
if ( ! V_273 )
goto V_228;
if ( V_273 -> V_161 != V_7
...
goto V_228;
F_6 ( & V_2 -> V_2 , L_113 ) ;
F_200 ( & V_2 -> V_2 , & V_273 -> V_2 ) ;
V_228:
F_17 ( V_273 ) ;
F_17 ( V_272 ) ;
}
static void F_201 ( struct V_1 * V_2 , struct V_275 * V_276 ,
struct V_275 * V_36 )
{
T_6 V_254 ;
...
V_254 = F_172 ( V_2 , V_276 -> V_279 ) ;
V_276 -> V_279 ( V_2 ) ;
F_180 ( V_2 , V_254 , V_276 -> V_279 ) ;
}
}
void F_202 ( enum V_280 V_281 , struct V_1 * V_2 )
{
...
static int F_205 ( struct V_1 * V_2 , int V_312 )
{
if ( V_312 )
return 0 ;
if ( ! F_206 ( V_2 ) )
F_169 ( & V_2 -> V_2 , L_117 ) ;
F_207 ( V_2 , V_313 , V_314 ) ;
F_198 ( 100 ) ;
return 0 ;
}
static int F_208 ( struct V_1 * V_2 , int V_312 )
{
void T_4 * V_315 ;
unsigned long V_316 ;
T_1 V_76 ;
...
if ( ! V_315 )
return - V_317 ;
F_209 ( 0x00000002 , V_315 + V_318 ) ;
F_209 ( 0x00000005 , V_315 + V_319 ) ;
V_76 = F_210 ( V_315 + V_320 ) & 0xfffffffe ;
F_209 ( V_76 , V_315 + V_320 ) ;
V_316 = V_321 + F_211 ( V_322 ) ;
do {
V_76 = F_210 ( V_315 + V_323 ) ;
if ( ( V_76 & 0xb0000000 ) == 0 )
goto V_324;
F_198 ( 10 ) ;
} while ( F_212 ( V_321 , V_316 ) );
F_52 ( & V_2 -> V_2 , L_118 ) ;
V_324:
F_209 ( 0x00000002 , V_315 + V_325 ) ;
F_185 ( V_2 , V_315 ) ;
return 0 ;
}
static int F_213 ( struct V_1 * V_2 , int V_312 )
{
T_2 V_326 ;
T_2 V_327 ;
...
V_326 | V_329 ) ;
F_214 ( V_2 ) ;
F_33 ( V_2 , V_2 -> V_330 + V_331 , & V_327 ) ;
if ( ( V_327 & V_332 ) == 0 )
F_54 ( V_2 , V_2 -> V_330 + V_331 ,
V_327 |
V_332 |
V_333 ) ;
if ( ! F_206 ( V_2 ) )
...
int F_216 ( struct V_1 * V_2 , int V_312 )
{
...
{
if ( F_95 ( V_2 -> V_89 ) != 0 ) {
V_2 -> V_336 = F_115 ( F_62 ( V_2 -> V_89 ) , 0 ) ;
V_2 -> V_109 |= V_337 ;
}
}
...
{
if ( F_95 ( V_2 -> V_89 ) != 1 ) {
V_2 -> V_336 = F_115 ( F_62 ( V_2 -> V_89 ) , 1 ) ;
V_2 -> V_109 |= V_337 ;
}
}
...
static void F_221 ( struct V_1 * V_54 )
{
if ( ! F_190 ( V_54 -> V_51 ) &&
V_54 -> V_150 == V_342 &&
! F_222 ( V_54 ) && F_222 ( V_54 -> V_51 -> V_343 ) &&
F_193 ( V_54 -> V_51 -> V_343 ) != V_344 )
V_54 -> V_109 |= V_345 ;
}
...
static int F_228 ( struct V_1 * V_2 , T_2 V_350 )
{
#ifdef F_229
struct V_351 * V_352 = NULL ;
T_9 V_353 ;
if ( ! V_2 -> V_151 || ! F_190 ( V_2 -> V_51 ) )
return - V_354 ;
V_353 = F_230 ( L_123 , 0 , & V_352 ) ;
if ( F_195 ( V_353 ) )
return - V_354 ;
...
{
int V_29 ;
if ( ! F_222 ( V_2 ) || F_193 ( V_2 ) != V_359 )
return false ;
for ( V_29 = 0 ; V_29 < F_232 ( V_360 ) ; V_29 ++ )
...
static int F_234 ( struct V_1 * V_2 , T_2 V_350 )
{
V_350 &= ~ ( V_363 | V_364 | V_355 |
V_356 | V_365 | V_358 ) ;
return V_350 ? 0 : 1 ;
}
int F_235 ( struct V_1 * V_2 , T_2 V_350 )
{
...
void T_4 * V_371 ;
F_237 ( V_2 -> V_51 , F_115 ( 31 , 0 ) ,
V_372 , & V_132 ) ;
if ( ! ( V_132 & V_373 ) )
return - V_374 ;
V_371 = F_84 ( V_132 & V_375 ,
F_238 ( V_376 ) ) ;
if ( ! V_371 )
return - V_317 ;
V_369 = F_86 ( V_371 + V_377 ) ;
V_369 &= V_378 | V_379 ;
if ( V_369 != ( V_378 | V_379 ) ) {
V_370 = F_86 ( V_371 + V_376 ) ;
if ( V_370 & V_380 ) {
F_6 ( & V_2 -> V_2 , L_124 ) ;
V_370 &= ~ V_380 ;
F_87 ( V_370 , V_371 + V_376 ) ;
}
}
F_89 ( V_371 ) ;
return 0 ;
...
T_2 V_387 , * V_388 ;
struct V_389 * V_390 ;
if ( V_54 -> V_391 || F_146 ( V_54 , V_392 ) )
return;
V_39 = F_146 ( V_54 , V_393 ) ;
if ( ! V_39 )
return;
...
return;
V_39 = 0x50 ;
F_33 ( V_54 , V_39 , & V_387 ) ;
if ( V_387 == ( 0x0000 | V_392 ) ) {
T_1 V_353 ;
#ifndef F_243
#define F_243 7
#endif
int V_40 = F_243 * sizeof( T_2 ) ;
V_54 -> V_391 = V_39 ;
F_33 ( V_54 , V_39 + V_394 , & V_387 ) ;
V_54 -> V_395 = V_387 ;
F_33 ( V_54 , V_39 + V_396 , & V_387 ) ;
...
if ( F_244 ( V_54 , V_392 ) )
return;
V_390 = F_245 ( sizeof( * V_390 ) + V_40 , V_401 ) ;
if ( ! V_390 )
return;
...
F_246 ( V_54 , V_313 , & V_388 [ V_29 ++ ] ) ;
F_246 ( V_54 , V_405 , & V_388 [ V_29 ++ ] ) ;
F_246 ( V_54 , V_406 , & V_388 [ V_29 ++ ] ) ;
F_246 ( V_54 , V_407 , & V_388 [ V_29 ++ ] ) ;
F_246 ( V_54 , V_408 , & V_388 [ V_29 ++ ] ) ;
F_246 ( V_54 , V_409 , & V_388 [ V_29 ++ ] ) ;
F_246 ( V_54 , V_410 , & V_388 [ V_29 ++ ] ) ;
F_247 ( & V_390 -> V_411 , & V_54 -> V_412 ) ;
}
}
