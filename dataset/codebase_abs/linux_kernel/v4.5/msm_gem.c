...
T_4 V_90 = F_65 ( V_4 ,
V_91 | V_92 ) ;
return F_66 ( V_2 -> V_7 , V_89 , V_90 ) ;
}
void F_67 ( struct V_1 * V_2 ,
struct V_93 * V_94 , bool V_95 , T_4 V_90 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_4 -> V_94 = V_94 ;
if ( V_95 )
...
V_4 -> V_96 = 0 ;
F_68 ( & V_4 -> V_98 ) ;
F_69 ( & V_4 -> V_98 , & V_6 -> V_100 ) ;
}
int F_71 ( struct V_1 * V_2 , T_4 V_101 , T_5 * V_102 )
{
struct V_24 * V_7 = V_2 -> V_7 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_17 = 0 ;
if ( F_72 ( V_4 ) ) {
T_4 V_90 = F_65 ( V_4 , V_101 ) ;
if ( V_101 & V_103 )
V_102 = NULL ;
V_17 = F_73 ( V_7 , V_90 , V_102 , true ) ;
}
return V_17 ;
}
...
void F_75 ( struct V_1 * V_2 , struct V_104 * V_105 )
{
struct V_24 * V_7 = V_2 -> V_7 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_3 V_106 = F_76 ( & V_2 -> V_61 ) ;
F_44 ( ! F_45 ( & V_7 -> V_33 ) ) ;
F_77 ( V_105 , L_6 ,
V_4 -> V_27 , F_72 ( V_4 ) ? 'A' : 'I' ,
V_4 -> V_97 , V_4 -> V_96 ,
V_2 -> V_107 , V_2 -> V_108 . V_108 . V_109 ,
V_106 , V_4 -> V_85 , V_2 -> V_25 ) ;
}
void F_78 ( struct V_110 * V_111 , struct V_104 * V_105 )
{
struct V_3 * V_4 ;
int V_112 = 0 ;
T_6 V_25 = 0 ;
F_79 (msm_obj, list, mm_list) {
...
F_44 ( F_72 ( V_4 ) ) ;
F_81 ( & V_4 -> V_98 ) ;
for ( V_63 = 0 ; V_63 < F_82 ( V_4 -> V_65 ) ; V_63 ++ ) {
struct V_67 * V_68 = V_6 -> V_69 [ V_63 ] ;
if ( V_68 && V_4 -> V_65 [ V_63 ] . V_64 ) {
T_4 V_62 = V_4 -> V_65 [ V_63 ] . V_64 ;
V_68 -> V_71 -> V_114 ( V_68 , V_62 , V_4 -> V_26 , V_2 -> V_25 ) ;
}
}
if ( V_2 -> V_115 ) {
if ( V_4 -> V_85 )
F_83 ( V_2 -> V_115 -> V_116 , V_4 -> V_85 ) ;
if ( V_4 -> V_23 )
F_8 ( V_4 -> V_23 ) ;
F_84 ( V_2 , V_4 -> V_26 ) ;
} else {
...
if ( V_17 )
return V_17 ;
V_2 = F_88 ( V_7 , V_25 , V_27 ) ;
F_26 ( & V_7 -> V_33 ) ;
if ( F_12 ( V_2 ) )
return F_14 ( V_2 ) ;
V_17 = F_89 ( V_43 , V_2 , V_82 ) ;
F_60 ( V_2 ) ;
return V_17 ;
}
static int F_90 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_27 ,
struct V_1 * * V_2 )
{
struct V_5 * V_6 = V_7 -> V_8 ;
...
V_120 = true ;
if ( F_44 ( V_120 && ! V_6 -> V_12 . V_25 ) )
return - V_70 ;
V_119 = sizeof( * V_4 ) ;
if ( V_120 )
V_119 += sizeof( struct V_124 ) ;
V_4 = F_91 ( V_119 , V_125 ) ;
if ( ! V_4 )
return - V_19 ;
if ( V_120 )
V_4 -> V_9 = ( void * ) & V_4 [ 1 ] ;
...
struct V_1 * F_88 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_27 )
{
struct V_1 * V_2 = NULL ;
int V_17 ;
F_44 ( ! F_45 ( & V_7 -> V_33 ) ) ;
V_25 = F_56 ( V_25 ) ;
V_17 = F_90 ( V_7 , V_25 , V_27 , & V_2 ) ;
if ( V_17 )
goto V_84;
if ( F_3 ( V_2 ) ) {
V_17 = F_94 ( V_7 , V_2 , V_25 ) ;
if ( V_17 )
goto V_84;
} else {
F_95 ( V_7 , V_2 , V_25 ) ;
...
struct V_1 * F_97 ( struct V_24 * V_7 ,
...
V_17 = F_98 ( V_26 , V_4 -> V_23 , NULL , V_15 ) ;
if ( V_17 )
goto V_84;
return V_2 ;
V_84:
