...
static int F_33 ( unsigned char * V_77 , unsigned char * V_78 , int V_19 )
{
unsigned char * V_63 = V_78 ;
unsigned char V_79 ;
* V_63 ++ = V_80 ;
while ( V_19 -- > 0 ) {
switch ( V_79 = * V_77 ++ ) {
...
static int F_70 ( struct V_51 * V_47 , struct V_83 * V_83 ,
...
return - V_20 ;
default:
return F_72 ( V_47 , V_83 , V_84 , V_85 ) ;
}
}
static long F_73 ( struct V_51 * V_47 , struct V_83 * V_83 ,
unsigned int V_84 , unsigned long V_85 )
{
switch ( V_84 ) {
case V_86 :
case V_89 :
return F_70 ( V_47 , V_83 , V_84 ,
