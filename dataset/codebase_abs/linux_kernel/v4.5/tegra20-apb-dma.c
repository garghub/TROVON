...
V_180 = F_81 ( V_181 , & V_174 -> V_16 ) ;
if ( ! V_180 ) {
F_18 ( & V_174 -> V_16 , L_28 ) ;
return - V_182 ;
}
V_178 = V_180 -> V_88 ;
V_2 = F_82 ( & V_174 -> V_16 , sizeof( * V_2 ) + V_178 -> V_183 *
...
V_2 -> V_43 = V_178 ;
F_83 ( V_174 , V_2 ) ;
V_176 = F_84 ( V_174 , V_186 , 0 ) ;
V_2 -> V_5 = F_85 ( & V_174 -> V_16 , V_176 ) ;
if ( F_86 ( V_2 -> V_5 ) )
return F_87 ( V_2 -> V_5 ) ;
V_2 -> V_187 = F_88 ( & V_174 -> V_16 , NULL ) ;
if ( F_86 ( V_2 -> V_187 ) ) {
F_18 ( & V_174 -> V_16 , L_30 ) ;
return F_87 ( V_2 -> V_187 ) ;
}
V_2 -> V_188 = F_89 ( & V_174 -> V_16 , L_31 ) ;
if ( F_86 ( V_2 -> V_188 ) ) {
...
F_77 ( & V_174 -> V_16 ) ;
F_67 ( & V_2 -> V_172 . V_191 ) ;
for ( V_144 = 0 ; V_144 < V_178 -> V_183 ; V_144 ++ ) {
struct V_6 * V_7 = & V_2 -> V_191 [ V_144 ] ;
V_7 -> V_8 = V_2 -> V_5 +
V_192 +
( V_144 * V_178 -> V_193 ) ;
V_176 = F_84 ( V_174 , V_194 , V_144 ) ;
if ( ! V_176 ) {
V_106 = - V_138 ;
F_18 ( & V_174 -> V_16 , L_33 , V_144 ) ;
goto V_195;
}
V_7 -> V_91 = V_176 -> V_196 ;
snprintf ( V_7 -> V_197 , sizeof( V_7 -> V_197 ) , L_34 , V_144 ) ;
V_106 = F_97 ( V_7 -> V_91 , F_51 , 0 , V_7 -> V_197 , V_7 ) ;
if ( V_106 ) {
F_18 ( & V_174 -> V_16 ,
L_35 ,
V_106 , V_144 ) ;
...
F_99 ( V_199 , V_2 -> V_172 . V_200 ) ;
F_99 ( V_201 , V_2 -> V_172 . V_200 ) ;
F_99 ( V_202 , V_2 -> V_172 . V_200 ) ;
V_2 -> V_38 = 0 ;
...
V_2 -> V_172 . V_204 =
F_75 ;
V_2 -> V_172 . V_205 = F_66 ;
V_2 -> V_172 . V_206 = F_71 ;
V_2 -> V_172 . V_207 = F_100 ( V_111 ) |
F_100 ( V_113 ) |
F_100 ( V_115 ) |
F_100 ( V_117 ) ;
V_2 -> V_172 . V_208 = F_100 ( V_111 ) |
F_100 ( V_113 ) |
F_100 ( V_115 ) |
F_100 ( V_117 ) ;
V_2 -> V_172 . V_209 = F_100 ( V_134 ) | F_100 ( V_129 ) ;
V_2 -> V_172 . V_210 = V_211 ;
V_2 -> V_172 . V_212 = F_27 ;
V_2 -> V_172 . V_213 = F_57 ;
V_2 -> V_172 . V_214 = F_58 ;
V_2 -> V_172 . V_215 = F_56 ;
...
struct V_6 * V_7 ;
F_103 ( & V_2 -> V_172 ) ;
for ( V_144 = 0 ; V_144 < V_2 -> V_43 -> V_183 ; ++ V_144 ) {
V_7 = & V_2 -> V_191 [ V_144 ] ;
F_104 ( V_7 -> V_91 , V_7 ) ;
F_105 ( & V_7 -> V_93 ) ;
}
...
if ( V_106 < 0 )
return V_106 ;
V_2 -> V_218 = F_3 ( V_2 , V_39 ) ;
for ( V_144 = 0 ; V_144 < V_2 -> V_43 -> V_183 ; V_144 ++ ) {
struct V_6 * V_7 = & V_2 -> V_191 [ V_144 ] ;
struct V_56 * V_219 = & V_7 -> V_220 ;
if ( ! V_7 -> V_35 )
continue;
V_219 -> V_47 = F_6 ( V_7 , V_49 ) ;
V_219 -> V_65 = F_6 ( V_7 , V_64 ) ;
