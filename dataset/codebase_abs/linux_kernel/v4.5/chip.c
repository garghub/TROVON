...
if ( V_139 != V_152 )
continue;
V_138 = ( V_30 & V_153 ) >> V_154 ;
if ( * V_135 == 0 && V_138 == V_155 )
* V_135 = V_30 & V_156 ;
...
T_1 V_30 ;
T_3 V_52 ;
T_4 V_158 , V_159 , V_160 , V_161 , V_11 ;
T_1 V_9 , V_162 ;
int V_163 ;
V_131 = V_2 -> V_6 -> V_7 ( V_2 -> V_8 , F_40 ( V_164 , V_165 ) ) ;
while ( V_157 != V_147 ) {
V_30 = F_37 ( V_2 , & V_131 , & V_157 ) ;
if ( ! ( V_30 & V_166 ) )
continue;
if ( V_157 == V_167 )
continue;
...
V_30 = F_37 ( V_2 , & V_131 , & V_157 ) ;
if ( F_27 ( ( V_30 & V_132 ) != V_168 ) )
return - V_148 ;
V_158 = ( V_30 & V_171 ) >> V_172 ;
V_159 = ( V_30 & V_173 ) >> V_174 ;
V_160 = ( V_30 & V_175 ) >> V_176 ;
V_161 = ( V_30 & V_177 ) >> V_178 ;
V_11 = ( V_30 & V_179 ) >> V_180 ;
if ( V_160 + V_161 == 0 )
continue;
V_163 = F_38 ( V_2 , & V_131 , & V_9 , & V_162 ) ;
if ( V_163 )
continue;
V_4 = F_15 ( V_2 , V_52 , V_9 , V_162 ) ;
if ( F_41 ( V_4 ) )
return F_42 ( V_4 ) ;
V_4 -> V_11 = V_11 ;
}
...
T_1 V_181 ;
int V_21 ;
V_5 = V_2 -> V_6 -> V_7 ( V_2 -> V_8 , F_40 ( V_164 , V_45 ) ) ;
V_2 -> V_15 . V_14 = V_5 & V_182 ;
V_2 -> V_15 . V_90 = ( V_5 & V_183 ) >> V_184 ;
V_181 = ( V_5 & V_185 ) >> V_186 ;
F_14 ( V_2 -> V_15 . V_14 , V_2 -> V_15 . V_124 , sizeof( V_2 -> V_15 . V_124 ) ) ;
F_21 ( V_59 , L_14 ,
V_181 == V_187 ? L_15 : L_16 , V_2 -> V_15 . V_124 ,
V_2 -> V_15 . V_90 ) ;
if ( V_181 == V_187 ) {
if ( V_2 -> V_15 . V_14 != V_188 ) {
F_9 ( L_17 ) ;
return - V_65 ;
}
V_2 -> V_189 = F_4 ;
...
V_196 , 0 ) ;
F_1 ( V_2 , V_4 ) ;
V_4 = F_15 ( V_2 , V_197 , 0x18001000 , 0 ) ;
F_1 ( V_2 , V_4 ) ;
} else if ( V_181 == V_198 ) {
V_2 -> V_189 = F_5 ;
V_2 -> V_190 = F_10 ;
...
case V_62 :
case V_63 :
V_199 = F_36 ( V_4 , struct V_12 , V_15 ) ;
V_30 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_199 -> V_22 + V_23 ) ;
V_30 &= V_200 ;
F_29 ( V_4 , V_30 , V_200 ,
V_200 ) ;
break;
...
int V_21 = 0 ;
V_15 = & V_14 -> V_15 ;
V_202 = F_48 ( & V_14 -> V_54 , struct V_12 , V_53 ) ;
V_9 = V_202 -> V_15 . V_9 ;
V_15 -> V_203 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 ,
F_40 ( V_9 , V_204 ) ) ;
if ( V_15 -> V_203 & V_205 ) {
V_30 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 ,
F_40 ( V_9 , V_206 ) ) ;
V_15 -> V_207 = V_30 & V_208 ;
V_15 -> V_209 = V_30 ;
}
F_21 ( V_59 , L_20 ,
V_202 -> V_15 . V_11 , V_15 -> V_207 , V_15 -> V_209 ) ;
if ( V_14 -> V_6 -> V_210 )
V_21 = V_14 -> V_6 -> V_210 ( V_14 -> V_8 , V_15 ) ;
return V_21 ;
}
struct V_201 * F_49 ( void * V_8 ,
const struct V_211 * V_6 )
{
struct V_1 * V_14 ;
int V_163 = 0 ;
if ( F_27 ( ! V_6 -> V_7 ) )
...
void F_51 ( struct V_201 * V_15 )
{
struct V_1 * V_14 ;
struct V_12 * V_4 ;
struct V_12 * V_216 ;
V_14 = F_36 ( V_15 , struct V_1 , V_15 ) ;
F_52 (core, tmp, &chip->cores, list) {
F_53 ( & V_4 -> V_53 ) ;
F_54 ( V_4 ) ;
}
F_54 ( V_14 ) ;
}
struct V_3 * F_35 ( struct V_201 * V_15 , T_3 V_49 )
{
struct V_1 * V_14 ;
struct V_12 * V_4 ;
V_14 = F_36 ( V_15 , struct V_1 , V_15 ) ;
...
struct V_3 * F_55 ( struct V_201 * V_15 )
{
struct V_1 * V_14 ;
struct V_12 * V_202 ;
V_14 = F_36 ( V_15 , struct V_1 , V_15 ) ;
V_202 = F_48 ( & V_14 -> V_54 , struct V_12 , V_53 ) ;
if ( F_27 ( ! V_202 || V_202 -> V_15 . V_52 != V_192 ) )
return F_35 ( V_15 , V_192 ) ;
return & V_202 -> V_15 ;
}
...
return V_4 -> V_14 -> V_189 ( V_4 ) ;
}
void F_46 ( struct V_3 * V_15 , T_1 V_28 , T_1 V_29 )
{
struct V_12 * V_4 ;
V_4 = F_36 ( V_15 , struct V_12 , V_15 ) ;
V_4 -> V_14 -> V_190 ( V_4 , V_28 , V_29 ) ;
}
...
struct V_12 * V_4 ;
V_4 = F_36 ( V_15 , struct V_12 , V_15 ) ;
V_4 -> V_14 -> V_191 ( V_4 , V_28 , V_29 , V_40 ) ;
}
static void
F_56 ( struct V_1 * V_14 )
{
struct V_3 * V_4 ;
struct V_12 * V_75 ;
F_45 ( V_14 , V_60 ) ;
V_4 = F_35 ( & V_14 -> V_15 , V_197 ) ;
F_29 ( V_4 , V_217 |
V_218 ,
V_218 ,
V_218 ) ;
...
F_23 ( V_75 , F_25 ( V_219 ) , 0 ) ;
}
}
static bool F_57 ( struct V_1 * V_14 )
{
struct V_3 * V_4 ;
V_4 = F_35 ( & V_14 -> V_15 , V_61 ) ;
if ( ! F_28 ( V_4 ) ) {
...
V_14 -> V_6 -> V_213 ( V_14 -> V_8 , & V_14 -> V_15 , 0 ) ;
V_4 = F_35 ( & V_14 -> V_15 , V_60 ) ;
F_29 ( V_4 , 0 , 0 , 0 ) ;
return true ;
}
static inline void
F_58 ( struct V_1 * V_14 )
{
struct V_3 * V_4 ;
F_45 ( V_14 , V_62 ) ;
V_4 = F_35 ( & V_14 -> V_15 , V_197 ) ;
...
static bool F_59 ( struct V_1 * V_14 , T_1 V_220 )
{
struct V_3 * V_4 ;
V_14 -> V_6 -> V_213 ( V_14 -> V_8 , & V_14 -> V_15 , V_220 ) ;
V_4 = F_35 ( & V_14 -> V_15 , V_62 ) ;
F_29 ( V_4 , V_200 , 0 , 0 ) ;
return true ;
}
static inline void
F_60 ( struct V_1 * V_14 )
{
struct V_3 * V_4 ;
F_45 ( V_14 , V_63 ) ;
V_4 = F_35 ( & V_14 -> V_15 , V_197 ) ;
...
static bool F_61 ( struct V_1 * V_14 , T_1 V_220 )
{
struct V_3 * V_4 ;
V_14 -> V_6 -> V_213 ( V_14 -> V_8 , & V_14 -> V_15 , V_220 ) ;
...
void F_44 ( struct V_201 * V_15 )
{
struct V_1 * V_14 ;
struct V_3 * V_221 ;
F_21 ( V_222 , L_22 ) ;
V_14 = F_36 ( V_15 , struct V_1 , V_15 ) ;
V_221 = F_35 ( V_15 , V_62 ) ;
if ( V_221 ) {
F_58 ( V_14 ) ;
return;
}
V_221 = F_35 ( V_15 , V_63 ) ;
if ( V_221 ) {
F_60 ( V_14 ) ;
return;
}
V_221 = F_35 ( V_15 , V_60 ) ;
if ( V_221 ) {
F_56 ( V_14 ) ;
return;
}
}
bool F_62 ( struct V_201 * V_15 , T_1 V_220 )
{
struct V_1 * V_14 ;
struct V_3 * V_221 ;
F_21 ( V_222 , L_22 ) ;
...
V_221 = F_35 ( V_15 , V_62 ) ;
if ( V_221 )
return F_59 ( V_14 , V_220 ) ;
V_221 = F_35 ( V_15 , V_63 ) ;
if ( V_221 )
return F_61 ( V_14 , V_220 ) ;
V_221 = F_35 ( V_15 , V_60 ) ;
if ( V_221 )
return F_57 ( V_14 ) ;
return false ;
}
bool F_63 ( struct V_201 * V_15 )
{
T_1 V_9 , V_223 , V_66 , V_224 = ~ 0 ;
struct V_1 * V_14 ;
F_21 ( V_222 , L_22 ) ;
if ( V_15 -> V_207 < 17 )
return false ;
...
case V_110 :
case V_111 :
V_223 = F_40 ( V_9 , V_226 ) ;
V_14 -> V_6 -> V_31 ( V_14 -> V_8 , V_223 , 3 ) ;
V_223 = F_40 ( V_9 , V_227 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_223 ) ;
return ( V_66 & V_224 ) != 0 ;
case V_91 :
V_223 = F_40 ( V_9 , V_228 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_223 ) ;
return V_66 != 0 ;
default:
V_223 = F_40 ( V_9 , V_229 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_223 ) ;
if ( ( V_66 & V_230 ) == 0 )
return false ;
V_223 = F_40 ( V_9 , V_231 ) ;
V_66 = V_14 -> V_6 -> V_7 ( V_14 -> V_8 , V_223 ) ;
return ( V_66 & ( V_232 |
V_233 ) ) == 0 ;
}
