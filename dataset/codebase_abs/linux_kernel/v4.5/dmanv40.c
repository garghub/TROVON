...
int V_47 = - V_48 ;
F_22 ( V_44 , L_1 , V_42 ) ;
if ( ! ( V_47 = F_23 ( V_47 , & V_41 , & V_42 , args -> V_46 , 0 , 0 , false ) ) ) {
F_22 ( V_44 , L_2
L_3 , args -> V_46 . V_49 ,
args -> V_46 . V_50 , args -> V_46 . V_51 ) ;
if ( ! args -> V_46 . V_50 )
return - V_35 ;
} else
return V_47 ;
if ( ! ( V_15 = F_24 ( sizeof( * V_15 ) , V_52 ) ) )
return - V_53 ;
* V_43 = & V_15 -> V_12 . V_31 ;
V_47 = F_25 ( & V_54 , & V_17 -> V_12 ,
0x1000 , 0x1000 , false , 0 , args -> V_46 . V_50 ,
( 1ULL << V_7 ) |
( 1ULL << V_9 ) |
( 1ULL << V_10 ) |
( 1ULL << V_8 ) ,
...
F_8 ( V_21 -> V_26 ) ;
F_9 ( V_21 -> V_26 , V_15 -> V_26 + 0x00 , args -> V_46 . V_51 ) ;
F_9 ( V_21 -> V_26 , V_15 -> V_26 + 0x04 , args -> V_46 . V_51 ) ;
F_9 ( V_21 -> V_26 , V_15 -> V_26 + 0x0c , V_15 -> V_12 . V_55 -> V_29 >> 4 ) ;
