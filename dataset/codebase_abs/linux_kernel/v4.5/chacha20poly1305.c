...
return F_66 ( V_35 ) ;
V_3 = - V_81 ;
V_54 = F_86 ( sizeof( * V_54 ) + sizeof( * V_9 ) , V_82 ) ;
if ( ! V_54 )
goto V_83;
V_9 = F_63 ( V_54 ) ;
V_9 -> V_12 = V_75 - V_67 ;
V_72 = F_87 ( V_35 ) ;
V_3 = F_88 ( & V_9 -> V_35 , V_72 ,
F_89 ( V_54 ) ) ;
if ( V_3 )
goto V_84;
F_90 ( & V_9 -> V_28 , F_89 ( V_54 ) ) ;
V_3 = F_91 ( & V_9 -> V_28 , V_73 , 0 ,
F_92 ( V_69 -> type ,
V_69 -> V_77 ) ) ;
if ( V_3 )
goto V_85;
V_28 = F_93 ( & V_9 -> V_28 ) ;
V_3 = - V_44 ;
if ( V_28 -> V_86 . V_67 != V_13 )
goto V_87;
if ( V_28 -> V_88 != 1 )
goto V_87;
V_3 = - V_89 ;
if ( snprintf ( V_54 -> V_90 . V_91 . V_92 , V_93 ,
L_1 , V_66 , V_73 ,
V_74 ) >= V_93 )
goto V_87;
if ( snprintf ( V_54 -> V_90 . V_91 . V_94 , V_93 ,
L_1 , V_66 , V_28 -> V_94 ,
V_35 -> V_94 ) >= V_93 )
goto V_87;
V_54 -> V_90 . V_91 . V_95 = ( V_28 -> V_95 | V_35 -> V_95 ) &
V_96 ;
V_54 -> V_90 . V_91 . V_97 = ( V_28 -> V_97 +
V_35 -> V_97 ) / 2 ;
V_54 -> V_90 . V_91 . V_88 = 1 ;
V_54 -> V_90 . V_91 . V_98 = V_28 -> V_98 |
V_35 -> V_98 ;
V_54 -> V_90 . V_91 . V_99 = sizeof( struct V_8 ) +
V_9 -> V_12 ;
V_54 -> V_90 . V_67 = V_67 ;
V_54 -> V_90 . V_100 = V_46 ;
V_54 -> V_90 . V_101 = F_61 ;
V_54 -> V_90 . exit = F_76 ;
V_54 -> V_90 . V_102 = F_51 ;
V_54 -> V_90 . V_103 = F_52 ;
V_54 -> V_90 . V_104 = F_53 ;
V_54 -> V_90 . V_105 = F_60 ;
V_54 -> free = F_78 ;
V_3 = F_94 ( V_63 , V_54 ) ;
if ( V_3 )
goto V_87;
...
static int F_96 ( struct V_62 * V_63 , struct V_64 * * V_65 )
{
return F_82 ( V_63 , V_65 , L_2 , 12 ) ;
}
static int F_97 ( struct V_62 * V_63 , struct V_64 * * V_65 )
{
