...
V_54 = V_43 -> V_60 ;
V_55 = V_53 * V_54 ;
V_56 = ( T_1 ) F_23 ( & V_44 -> V_35 , 0 ) ;
V_57 = ( T_1 ) F_23 ( & V_45 -> V_35 ,
0 ) ;
if ( ! V_56 || ! V_57 ) {
F_24 ( & V_23 -> V_61 ,
L_5 ) ;
...
{
struct V_20 * V_21 = F_59 ( V_145 -> V_123 ) ;
struct V_1 * V_4 ;
F_8 ( V_21 -> V_24 , L_20 , V_145 -> V_123 -> type ) ;
V_4 = F_1 ( V_145 -> V_123 -> type ) ;
if ( F_61 ( V_145 , 0 ) < V_4 -> V_126 ) {
F_8 ( V_21 -> V_24 , L_21 ,
V_93 , F_61 ( V_145 , 0 ) , ( long ) V_4 -> V_126 ) ;
return - V_120 ;
}
F_62 ( V_145 , 0 , V_4 -> V_126 ) ;
return 0 ;
}
static void F_63 ( struct V_144 * V_145 )
{
struct V_32 * V_146 = F_64 ( V_145 ) ;
struct V_20 * V_21 = F_59 ( V_145 -> V_123 ) ;
F_65 ( V_21 -> V_25 , V_146 ) ;
}
static int F_66 ( void * V_19 , struct V_123 * V_147 ,
struct V_123 * V_148 )
{
struct V_20 * V_21 = V_19 ;
int V_132 ;
V_147 -> type = V_3 ;
V_147 -> V_149 = V_150 | V_151 ;
V_147 -> V_152 = V_21 ;
V_147 -> V_153 = sizeof( struct V_154 ) ;
V_147 -> V_155 = & V_156 ;
V_147 -> V_157 = & V_158 ;
V_147 -> V_159 = V_160 ;
V_4 [ V_5 ] . V_11 = & V_14 [ 0 ] ;
...
V_148 -> V_152 = V_21 ;
V_148 -> V_153 = sizeof( struct V_154 ) ;
V_148 -> V_155 = & V_156 ;
V_148 -> V_157 = & V_158 ;
V_148 -> V_159 = V_160 ;
V_4 [ V_7 ] . V_11 = & V_14 [ 0 ] ;
...
V_21 -> V_63 = F_70 ( sizeof( struct V_164 ) +
sizeof( struct V_165 ) , V_161 ) ;
if ( ! V_21 -> V_63 ) {
F_74 ( V_21 ) ;
return - V_162 ;
}
...
int V_132 ;
F_11 ( V_21 ) ;
V_132 = F_78 ( V_100 , V_21 -> V_25 , V_167 ) ;
F_13 ( V_21 ) ;
return V_132 ;
}
static int F_79 ( struct V_100 * V_100 , struct V_168 * V_169 )
{
struct V_20 * V_21 = V_100 -> V_163 ;
return F_80 ( V_100 , V_21 -> V_25 , V_169 ) ;
}
...
T_3 V_174 ;
int V_132 = 0 ;
V_23 = F_82 ( & V_171 -> V_24 , sizeof( * V_23 ) , V_161 ) ;
if ( ! V_23 )
return - V_162 ;
F_83 ( & V_23 -> V_175 ) ;
F_84 ( V_174 ) ;
F_85 ( V_176 , V_174 ) ;
V_23 -> V_46 = F_86 ( V_174 , NULL , V_23 ) ;
if ( ! V_23 -> V_46 )
return - V_177 ;
if ( ! F_87 ( V_176 , V_23 -> V_46 -> V_50 -> V_178 ) ) {
F_24 ( & V_23 -> V_61 , L_24 ) ;
goto V_179;
}
V_132 = F_88 ( & V_171 -> V_24 , & V_23 -> V_61 ) ;
if ( V_132 )
goto V_179;
F_16 ( & V_23 -> V_26 , 0 ) ;
F_89 ( & V_23 -> V_29 ) ;
V_173 = & V_23 -> V_173 ;
* V_173 = V_180 ;
V_173 -> V_181 = & V_23 -> V_29 ;
V_173 -> V_61 = & V_23 -> V_61 ;
V_132 = F_90 ( V_173 , V_182 , 0 ) ;
if ( V_132 ) {
F_24 ( & V_23 -> V_61 , L_25 ) ;
goto V_183;
}
F_91 ( V_173 , V_23 ) ;
snprintf ( V_173 -> V_119 , sizeof( V_173 -> V_119 ) , L_26 , V_180 . V_119 ) ;
F_92 ( & V_23 -> V_61 , V_184
L_27 , V_173 -> V_116 ) ;
F_93 ( V_171 , V_23 ) ;
V_23 -> V_143 = F_94 ( & V_171 -> V_24 ) ;
if ( F_72 ( V_23 -> V_143 ) ) {
F_24 ( & V_23 -> V_61 , L_28 ) ;
V_132 = F_73 ( V_23 -> V_143 ) ;
goto V_185;
}
V_23 -> V_28 = F_95 ( & V_186 ) ;
if ( F_72 ( V_23 -> V_28 ) ) {
F_24 ( & V_23 -> V_61 , L_29 ) ;
...
static int F_100 ( struct V_170 * V_171 )
{
struct V_22 * V_23 = F_101 ( V_171 ) ;
F_92 ( & V_23 -> V_61 , L_30 V_184 ) ;
F_102 ( V_23 -> V_28 ) ;
F_96 ( & V_23 -> V_173 ) ;
F_98 ( & V_23 -> V_61 ) ;
F_97 ( V_23 -> V_143 ) ;
