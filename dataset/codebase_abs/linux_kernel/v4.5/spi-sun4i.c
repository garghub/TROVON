...
static int F_12 ( struct V_28 * V_19 ,
struct V_16 * V_17 ,
struct V_29 * V_30 )
{
struct V_1 * V_2 = F_10 ( V_19 ) ;
unsigned int V_31 , div , V_32 ;
unsigned int V_33 = 0 ;
int V_34 = 0 ;
T_1 V_3 ;
if ( V_30 -> V_6 > V_35 )
...
V_31 = F_14 ( V_2 -> V_48 ) ;
if ( V_31 < ( 2 * V_30 -> V_49 ) ) {
F_15 ( V_2 -> V_48 , 2 * V_30 -> V_49 ) ;
V_31 = F_14 ( V_2 -> V_48 ) ;
}
div = V_31 / ( 2 * V_30 -> V_49 ) ;
if ( div <= ( V_50 + 1 ) ) {
if ( div > 0 )
div -- ;
V_3 = F_16 ( div ) | V_51 ;
} else {
div = F_17 ( V_31 ) - F_17 ( V_30 -> V_49 ) ;
V_3 = F_18 ( div ) ;
}
F_3 ( V_2 , V_52 , V_3 ) ;
if ( V_2 -> V_14 )
V_33 = V_30 -> V_6 ;
F_3 ( V_2 , V_53 , F_19 ( V_30 -> V_6 ) ) ;
F_3 ( V_2 , V_54 , F_20 ( V_33 ) ) ;
F_7 ( V_2 , V_35 ) ;
F_3 ( V_2 , V_55 , V_56 ) ;
V_3 = F_1 ( V_2 , V_20 ) ;
