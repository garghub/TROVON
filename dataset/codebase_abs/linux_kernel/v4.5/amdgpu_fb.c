...
{
if ( V_2 -> V_78 . V_14 )
F_40 ( & V_2 -> V_78 . V_14 -> V_36 ) ;
}
static int F_41 ( struct V_79 * V_34 , struct V_13 * V_14 )
{
...
static void F_44 ( struct V_82 * V_83 , T_2 V_84 , T_2 V_85 ,
T_2 V_86 , int V_87 )
{
struct V_88 * V_88 = F_45 ( V_83 ) ;
V_88 -> V_89 [ V_87 ] = V_84 >> 6 ;
V_88 -> V_90 [ V_87 ] = V_85 >> 6 ;
V_88 -> V_91 [ V_87 ] = V_86 >> 6 ;
}
static void F_46 ( struct V_82 * V_83 , T_2 * V_84 , T_2 * V_85 ,
T_2 * V_86 , int V_87 )
{
struct V_88 * V_88 = F_45 ( V_83 ) ;
...
if ( ! V_2 -> V_78 . V_93 )
return 0 ;
if ( F_48 ( & V_2 -> V_50 -> V_73 . V_94 ) )
return 0 ;
if ( V_2 -> V_62 . V_95 <= ( 32 * 1024 * 1024 ) )
V_92 = 8 ;
V_14 = F_49 ( sizeof( struct V_13 ) , V_96 ) ;
if ( ! V_14 )
return - V_30 ;
V_14 -> V_2 = V_2 ;
V_2 -> V_78 . V_14 = V_14 ;
...
void F_56 ( struct V_1 * V_2 , int V_100 )
{
if ( V_2 -> V_78 . V_14 )
...
if ( ! V_2 -> V_78 . V_14 )
return 0 ;
V_101 = F_3 ( V_2 -> V_78 . V_14 -> V_51 . V_81 ) ;
V_21 += F_29 ( V_101 ) ;
return V_21 ;
}
bool F_59 ( struct V_1 * V_2 , struct V_10 * V_101 )
{
if ( ! V_2 -> V_78 . V_14 )
return false ;
if ( V_101 == F_3 ( V_2 -> V_78 . V_14 -> V_51 . V_81 ) )
return true ;
return false ;
}
void F_60 ( struct V_1 * V_2 )
{
struct V_13 * V_102 = V_2 -> V_78 . V_14 ;
struct V_35 * V_103 ;
int V_12 ;
if ( ! V_102 )
return;
