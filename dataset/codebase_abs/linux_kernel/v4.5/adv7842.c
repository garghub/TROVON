...
if ( F_89 ( V_153 -> V_158 + 1 , V_154 , V_153 -> V_159 , 0 ,
( V_153 -> V_160 == '+' ? V_161 : 0 ) |
( V_153 -> V_162 == '+' ? V_163 : 0 ) ,
false , V_92 ) )
return 0 ;
...
V_226 -> V_7 = V_40 -> V_92 . V_6 . V_7 ;
V_226 -> V_99 = V_40 -> V_92 . V_6 . V_99 ;
V_226 -> V_227 = V_228 ;
V_226 -> V_229 = V_230 ;
if ( V_40 -> V_92 . V_6 . V_23 & V_130 )
V_226 -> V_229 = ( V_40 -> V_92 . V_6 . V_99 <= 576 ) ?
V_231 : V_232 ;
}
...
F_112 ( V_234 ) = F_111 ( V_235 , V_236 , V_237 , V_234 , V_238 , V_239 ) ,
F_112 ( V_236 ) = F_111 ( V_237 , V_234 , V_235 , V_236 , V_239 , V_238 ) ,
F_112 ( V_239 ) = F_111 ( V_236 , V_235 , V_238 , V_239 , V_237 , V_234 ) ,
F_112 ( V_237 ) = F_111 ( V_239 , V_238 , V_234 , V_237 , V_236 , V_235 ) ,
F_112 ( V_238 ) = F_111 ( V_238 , V_239 , V_236 , V_235 , V_234 , V_237 ) ,
F_112 ( V_235 ) = F_111 ( V_234 , V_237 , V_239 , V_238 , V_235 , V_236 ) ,
} ;
...
V_226 -> V_226 . V_7 = 720 ;
if ( V_40 -> V_251 & V_252 )
V_226 -> V_226 . V_99 = 480 ;
else
V_226 -> V_226 . V_99 = 576 ;
V_226 -> V_226 . V_229 = V_231 ;
return 0 ;
}
F_109 ( V_40 , & V_226 -> V_226 ) ;
if ( V_226 -> V_253 == V_254 ) {
struct V_225 * V_255 ;
V_255 = F_115 ( V_10 , V_222 , V_226 -> V_168 ) ;
...
static void F_117 ( struct V_9 * V_10 , bool V_257 )
{
if ( V_257 ) {
F_23 ( V_10 , 0x46 , 0x9c ) ;
F_23 ( V_10 , 0x5a , 0x10 ) ;
...
static int F_118 ( struct V_9 * V_10 , T_3 V_148 , bool * V_258 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 V_259 , V_260 , V_261 ;
T_2 V_262 [ 6 ] ;
F_117 ( V_10 , false ) ;
V_262 [ 0 ] = F_21 ( V_10 , 0x43 ) ;
V_262 [ 1 ] = F_21 ( V_10 , 0x57 ) ;
V_262 [ 2 ] = F_21 ( V_10 , 0x70 ) ;
V_262 [ 3 ] = F_21 ( V_10 , 0x75 ) ;
V_262 [ 4 ] = F_21 ( V_10 , 0x9d ) ;
V_262 [ 5 ] = F_21 ( V_10 , 0x66 ) ;
if ( V_262 [ 0 ] )
F_23 ( V_10 , 0x44 , V_262 [ 0 ] ) ;
if ( V_262 [ 1 ] )
F_23 ( V_10 , 0x58 , V_262 [ 1 ] ) ;
if ( V_262 [ 2 ] )
F_23 ( V_10 , 0x71 , V_262 [ 2 ] ) ;
if ( V_262 [ 3 ] )
F_23 ( V_10 , 0x76 , V_262 [ 3 ] ) ;
if ( V_262 [ 4 ] )
F_23 ( V_10 , 0x9e , V_262 [ 4 ] ) ;
if ( V_262 [ 5 ] )
F_23 ( V_10 , 0x67 , V_262 [ 5 ] ) ;
F_117 ( V_10 , true ) ;
F_56 ( 1 , V_52 , V_10 , L_54 , V_53 ,
V_262 [ 0 ] , V_262 [ 1 ] , V_262 [ 2 ] ,
V_262 [ 3 ] , V_262 [ 4 ] , V_262 [ 5 ] ) ;
V_259 = V_262 [ 0 ] & 0x9c ;
if ( V_40 -> V_57 == V_150 )
V_261 = ( V_262 [ 1 ] & 0x30 ) | ( V_262 [ 4 ] & 0x09 ) ;
else
V_261 = 0 ;
if ( F_60 ( V_10 ) )
V_260 = V_262 [ 3 ] & 0x03 ;
...
static int F_119 ( struct V_9 * V_10 , struct V_263 * V_74 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 * V_20 = NULL ;
memset ( V_74 -> V_264 , 0 , sizeof( V_74 -> V_264 ) ) ;
switch ( V_74 -> V_168 ) {
case V_71 :
case V_72 :
...
if ( V_74 -> V_266 >= 2 )
return - V_78 ;
if ( V_74 -> V_266 + V_74 -> V_267 > 2 )
V_74 -> V_267 = 2 - V_74 -> V_266 ;
memcpy ( V_74 -> V_74 , V_20 + V_74 -> V_266 * 128 , V_74 -> V_267 * 128 ) ;
return 0 ;
}
static int F_120 ( struct V_9 * V_10 , struct V_263 * T_7 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
int V_30 = 0 ;
memset ( T_7 -> V_264 , 0 , sizeof( T_7 -> V_264 ) ) ;
if ( T_7 -> V_168 > V_265 )
return - V_78 ;
if ( T_7 -> V_266 != 0 )
return - V_78 ;
...
V_40 -> V_73 . V_69 = T_7 -> V_267 ? 0x1 : 0x0 ;
memcpy ( & V_40 -> V_73 . V_74 , T_7 -> V_74 , 128 * T_7 -> V_267 ) ;
V_30 = F_64 ( V_10 ) ;
break;
case V_71 :
case V_72 :
...
V_40 -> V_70 . V_69 &= ~ ( 0x04 << T_7 -> V_168 ) ;
memcpy ( & V_40 -> V_70 . V_74 , T_7 -> V_74 , 128 * T_7 -> V_267 ) ;
...
static void F_122 ( struct V_9 * V_10 , struct V_269 * V_270 )
{
int V_4 ;
T_2 V_271 [ 32 ] ;
union V_272 V_273 ;
T_2 V_81 ;
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_274 * V_275 = & V_16 -> V_275 ;
if ( ! ( F_21 ( V_10 , 0x60 ) & V_270 -> V_276 ) ) {
F_69 ( V_10 , L_61 , V_270 -> V_277 ) ;
return;
}
for ( V_4 = 0 ; V_4 < 3 ; V_4 ++ )
V_271 [ V_4 ] = F_31 ( V_10 , V_270 -> V_278 + V_4 ) ;
V_81 = V_271 [ 2 ] + 1 ;
if ( V_81 + 3 > sizeof( V_271 ) ) {
F_78 ( V_10 , L_62 , V_53 , V_270 -> V_277 , V_81 ) ;
return;
}
for ( V_4 = 0 ; V_4 < V_81 ; V_4 ++ )
V_271 [ V_4 + 3 ] = F_31 ( V_10 , V_270 -> V_279 + V_4 ) ;
if ( F_123 ( & V_273 , V_271 ) < 0 ) {
F_78 ( V_10 , L_63 , V_53 , V_270 -> V_277 ) ;
return;
}
F_124 ( V_280 , V_275 , & V_273 ) ;
}
...
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_1 V_92 ;
T_2 V_283 = F_21 ( V_10 , 0x02 ) ;
T_2 V_284 = F_21 ( V_10 , 0x21 ) ;
T_2 V_285 = F_42 ( V_10 , 0x77 ) ;
T_2 V_286 = F_42 ( V_10 , 0x7d ) ;
bool V_287 = F_47 ( V_10 , 0x04 ) & 0x01 ;
bool V_288 = F_47 ( V_10 , 0x18 ) & 0x01 ;
bool V_289 = F_21 ( V_10 , 0x65 ) & 0x40 ;
static const char * const V_290 [ 16 ] = {
...
static const char * const V_292 [] = {
L_122 ,
L_112 ,
L_113 ,
} ;
static const char * const V_293 [ 4 ] = {
L_123 ,
L_124 ,
L_125 ,
L_126
...
F_69 ( V_10 , L_132 ,
( ( V_286 & 0x04 ) && ( V_285 & 0x04 ) ) ?
L_99 : L_100 ,
( ( V_286 & 0x08 ) && ( V_285 & 0x08 ) ) ?
L_99 : L_100 ) ;
F_69 ( V_10 , L_133 ,
V_284 & 0x02 ? L_99 : L_100 ,
V_284 & 0x01 ? L_99 : L_100 ) ;
...
T_3 V_294 = ( ( F_50 ( V_10 , 0xb8 ) & 0x1f ) << 8 ) | F_50 ( V_10 , 0xb9 ) ;
...
V_291 [ V_283 >> 4 ] ) ;
F_69 ( V_10 , L_153 ,
( V_283 & 0x02 ) ? L_154 : L_155 ,
( V_283 & 0x04 ) ? L_156 : L_157 ,
( ( V_283 & 0x04 ) ^ ( V_283 & 0x01 ) ) ?
L_99 : L_100 ) ;
F_69 ( V_10 , L_158 ,
V_290 [ F_50 ( V_10 , 0xf4 ) >> 4 ] ) ;
if ( ! F_60 ( V_10 ) )
return 0 ;
...
static int F_129 ( struct V_9 * V_10 , T_10 * V_295 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
...
static void F_130 ( struct V_9 * V_10 , struct V_304 * V_305 )
{
if ( V_305 && V_305 -> V_306 ) {
F_34 ( V_10 , 0x94 , ( V_305 -> V_307 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x95 , V_305 -> V_307 & 0xff ) ;
F_34 ( V_10 , 0x96 , ( V_305 -> V_308 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x97 , V_305 -> V_308 & 0xff ) ;
F_34 ( V_10 , 0x98 , ( V_305 -> V_309 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x99 , V_305 -> V_309 & 0xff ) ;
F_34 ( V_10 , 0x9a , ( V_305 -> V_310 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x9b , V_305 -> V_310 & 0xff ) ;
F_34 ( V_10 , 0xa8 , V_305 -> V_311 ) ;
F_34 ( V_10 , 0xa9 , V_305 -> V_312 ) ;
F_34 ( V_10 , 0xaa , V_305 -> V_313 ) ;
F_34 ( V_10 , 0xab , V_305 -> V_314 ) ;
F_34 ( V_10 , 0xac , V_305 -> V_315 ) ;
F_34 ( V_10 , 0xad , V_305 -> V_316 ) ;
F_34 ( V_10 , 0xae , V_305 -> V_317 ) ;
F_34 ( V_10 , 0xaf , V_305 -> V_318 ) ;
} else {
F_34 ( V_10 , 0x94 , 0x00 ) ;
F_34 ( V_10 , 0x95 , 0x00 ) ;
F_34 ( V_10 , 0x96 , 0x00 ) ;
...
static int F_131 ( struct V_9 * V_10 , T_10 V_251 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_319 * V_240 = & V_40 -> V_240 ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
return - V_170 ;
if ( V_251 & V_320 )
F_130 ( V_10 , & V_240 -> V_321 ) ;
else if ( V_251 & V_252 )
F_130 ( V_10 , & V_240 -> V_322 ) ;
else
F_130 ( V_10 , NULL ) ;
if ( V_251 & V_303 ) {
V_40 -> V_251 = V_251 ;
...
static int F_132 ( struct V_9 * V_10 , T_10 * V_251 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
...
V_240 -> V_326 << 2 |
V_240 -> V_327 << 0 ) ;
F_24 ( V_10 , 0x05 , 0xf0 , V_240 -> V_328 << 3 |
V_240 -> V_329 << 2 |
V_240 -> V_330 << 1 ) ;
F_113 ( V_40 ) ;
...
V_240 -> V_332 << 2 |
V_240 -> V_333 ) ;
F_52 ( V_10 , 0xba , 0xfc , V_240 -> V_334 |
( V_240 -> V_335 << 1 ) ) ;
F_38 ( V_10 , 0xdd , 0xf0 , V_240 -> V_336 |
( V_240 -> V_337 << 1 ) |
( V_240 -> V_338 << 2 ) |
( V_240 -> V_339 << 3 ) ) ;
F_51 ( V_10 , 0x69 , 0x14 ) ;
...
F_51 ( V_10 , 0xf3 , 0xdc ) ;
F_40 ( V_10 , 0xb5 , 0x01 ) ;
F_40 ( V_10 , 0x02 , V_240 -> V_340 ) ;
F_24 ( V_10 , 0x30 , ~ ( 1 << 4 ) , V_240 -> V_341 << 4 ) ;
F_104 ( V_10 , & V_240 -> F_104 ) ;
if ( V_240 -> V_342 >= 128 ) {
F_37 ( V_10 , 0x12 , 0x0d ) ;
if ( V_240 -> V_343 ) {
F_34 ( V_10 , 0x6f , 0x00 ) ;
...
F_23 ( V_10 , 0x19 , 0x80 | V_240 -> V_345 ) ;
F_23 ( V_10 , 0x33 , 0x40 ) ;
F_23 ( V_10 , 0x40 , 0xf2 ) ;
F_117 ( V_10 , true ) ;
return F_134 ( V_10 -> V_346 ) ;
}
...
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_319 * V_240 = V_16 -> V_275 . V_351 ;
struct V_1 V_92 ;
int V_28 = 0 ;
if ( ! V_240 )
return - V_352 ;
if ( ! V_240 -> V_342 || ! V_240 -> V_343 ) {
F_69 ( V_10 , L_181 ) ;
return - V_78 ;
}
F_55 ( V_10 ) ;
...
static long F_138 ( struct V_9 * V_10 , unsigned int V_353 , void * V_354 )
{
switch ( V_353 ) {
case V_355 :
return F_137 ( V_10 ) ;
...
switch ( V_360 -> type ) {
case V_361 :
return F_140 ( V_10 , V_358 , V_360 ) ;
case V_362 :
return F_141 ( V_10 , V_358 , V_360 ) ;
default:
return - V_78 ;
}
}
...
static struct V_15 * F_144 ( struct V_9 * V_10 , const char * V_277 ,
T_2 V_22 , T_2 V_363 )
{
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_15 * V_364 ;
F_23 ( V_10 , V_363 , V_22 << 1 ) ;
if ( V_22 == 0 ) {
F_78 ( V_10 , L_182 , V_277 ) ;
return NULL ;
}
V_364 = F_145 ( V_16 -> V_21 , F_21 ( V_10 , V_363 ) >> 1 ) ;
if ( ! V_364 )
F_78 ( V_10 , L_183 , V_277 , V_22 ) ;
return V_364 ;
}
...
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_319 * V_240 = & V_40 -> V_240 ;
V_40 -> V_41 = F_144 ( V_10 , L_184 , V_240 -> V_41 , 0xf3 ) ;
V_40 -> V_42 = F_144 ( V_10 , L_185 , V_240 -> V_42 , 0xf4 ) ;
V_40 -> V_43 = F_144 ( V_10 , L_186 , V_240 -> V_43 , 0xf5 ) ;
V_40 -> V_44 = F_144 ( V_10 , L_187 , V_240 -> V_44 , 0xf2 ) ;
V_40 -> V_45 = F_144 ( V_10 , L_188 , V_240 -> V_45 , 0xf1 ) ;
V_40 -> V_46 = F_144 ( V_10 , L_189 , V_240 -> V_46 , 0xf8 ) ;
V_40 -> V_47 = F_144 ( V_10 , L_190 , V_240 -> V_47 , 0xf9 ) ;
V_40 -> V_48 = F_144 ( V_10 , L_191 , V_240 -> V_48 , 0xfa ) ;
V_40 -> V_49 = F_144 ( V_10 , L_192 , V_240 -> V_49 , 0xfb ) ;
V_40 -> V_50 = F_144 ( V_10 , L_193 , V_240 -> V_50 , 0xfd ) ;
V_40 -> V_51 = F_144 ( V_10 , L_194 , V_240 -> V_51 , 0xfe ) ;
if ( ! V_40 -> V_41 ||
! V_40 -> V_42 ||
! V_40 -> V_43 ||
! V_40 -> V_44 ||
...
const struct V_365 * V_133 )
{
struct V_8 * V_40 ;
static const struct V_1 V_366 =
V_367 ;
struct V_319 * V_240 = V_16 -> V_275 . V_351 ;
struct V_368 * V_3 ;
struct V_9 * V_10 ;
T_4 V_369 ;
int V_30 ;
if ( ! F_148 ( V_16 -> V_21 , V_370 ) )
return - V_27 ;
F_149 ( 1 , V_52 , V_16 , L_195 ,
V_16 -> V_22 << 1 ) ;
if ( ! V_240 ) {
F_16 ( V_16 , L_196 ) ;
return - V_352 ;
}
V_40 = F_150 ( & V_16 -> V_275 , sizeof( struct V_8 ) , V_371 ) ;
if ( ! V_40 ) {
F_16 ( V_16 , L_197 ) ;
return - V_372 ;
}
...
V_10 = & V_40 -> V_10 ;
F_151 ( V_10 , V_16 , & V_373 ) ;
V_10 -> V_23 |= V_374 | V_375 ;
V_40 -> V_57 = V_240 -> V_57 ;
V_40 -> V_207 = V_240 -> V_208 == V_211 ;
V_40 -> V_171 = true ;
V_369 = F_14 ( V_16 , 0xea , false ) << 8 |
F_14 ( V_16 , 0xeb , false ) ;
if ( V_369 != 0x2012 ) {
F_69 ( V_10 , L_198 , V_369 ) ;
V_369 = F_14 ( V_16 , 0xea , false ) << 8 |
F_14 ( V_16 , 0xeb , false ) ;
}
if ( V_369 != 0x2012 ) {
...
F_153 ( V_3 , & V_377 ,
V_137 , 0 , 128 , 1 , 0 ) ;
V_40 -> V_87 = F_153 ( V_3 , NULL ,
V_378 , 0 , 3 , 0 , 0 ) ;
V_40 -> V_379 = F_154 ( V_3 ,
& V_380 , NULL ) ;
V_40 -> V_381 = F_154 ( V_3 ,
& V_382 , NULL ) ;
V_40 -> V_383 = F_154 ( V_3 ,
& V_384 , NULL ) ;
V_40 -> V_385 =
F_155 ( V_3 , & V_377 ,
V_147 , V_132 ,
...
V_40 -> V_87 -> V_387 = true ;
V_40 -> V_385 -> V_387 = true ;
V_40 -> V_379 -> V_387 = true ;
V_40 -> V_381 -> V_387 = true ;
V_40 -> V_383 -> V_387 = true ;
if ( F_72 ( V_10 ) ) {
V_30 = - V_352 ;
goto V_386;
}
...
F_157 ( & V_40 -> V_68 ,
F_62 ) ;
V_40 -> V_168 . V_23 = V_389 ;
V_30 = F_158 ( & V_10 -> V_390 , 1 , & V_40 -> V_168 ) ;
if ( V_30 )
goto V_391;
V_30 = F_133 ( V_10 ) ;
if ( V_30 )
...
static int F_163 ( struct V_15 * V_16 )
{
struct V_9 * V_10 = F_164 ( V_16 ) ;
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_117 ( V_10 , false ) ;
F_160 ( & V_40 -> V_68 ) ;
F_161 ( V_40 -> V_75 ) ;
