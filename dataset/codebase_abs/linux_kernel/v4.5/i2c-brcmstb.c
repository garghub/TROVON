...
int V_54 = F_1 ( V_2 ) ;
if ( V_51 || V_45 <= V_54 ) {
V_31 = ( V_47 -> V_52 & V_55 ) ? V_56
: V_57 ;
V_34 -> V_58 |= V_59 ;
} else {
V_31 = ( V_47 -> V_52 & V_55 ) ? V_39 : V_40 ;
V_34 -> V_58 &= ~ V_59 ;
}
F_5 ( V_2 , V_34 -> V_58 , V_58 ) ;
V_7 = V_34 -> V_7 & ~ V_60 ;
if ( V_31 == V_40 || V_31 == V_57 )
V_34 -> V_7 = V_7 | V_61 ;
else
V_34 -> V_7 = V_7 | V_62 ;
F_5 ( V_2 , F_20 ( V_4 ) &
...
for ( V_48 = 0 , V_50 = 0 ; V_48 < V_45 ; V_48 += V_4 , V_50 ++ ) {
T_2 V_67 = F_7 ( V_2 , V_68 [ V_50 ] ) ;
for ( V_49 = 0 ; V_49 < V_4 &&
( V_49 + V_48 ) < V_45 ; V_49 ++ ) {
V_44 [ V_48 + V_49 ] = V_67 & 0xff ;
V_67 >>= V_65 ;
}
}
}
...
T_3 * V_44 , unsigned int V_69 )
{
enum V_30 V_31 = V_69 ? V_40 : V_57 ;
F_5 ( V_2 , 1 , V_43 ) ;
F_5 ( V_2 , * V_44 , V_66 ) ;
...
unsigned char V_71 ;
if ( V_70 -> V_52 & V_72 ) {
V_71 = 0xF0 | ( ( V_70 -> V_71 & 0x300 ) >> 7 ) ;
F_5 ( V_2 , V_71 , V_73 ) ;
V_71 = V_70 -> V_71 & 0xFF ;
if ( F_21 ( V_2 , & V_71 , 0 ) < 0 )
return - V_42 ;
if ( V_70 -> V_52 & V_55 ) {
F_16 ( V_2 , V_74
| V_75 ) ;
V_71 = 0xF0 | ( ( V_70 -> V_71 & 0x300 ) >> 7 ) | 0x01 ;
if ( F_21 ( V_2 , & V_71 , 0 ) < 0 )
return - V_42 ;
}
} else {
...
struct V_46 V_78 [] , int V_79 )
{
struct V_1 * V_2 = F_24 ( V_77 ) ;
struct V_46 * V_47 ;
int V_32 = 0 ;
int V_50 ;
int V_80 ;
...
if ( V_50 < ( V_79 - 1 ) && ( V_78 [ V_50 + 1 ] . V_52 & V_84 ) )
F_16 ( V_2 , ~ ( V_29 ) ) ;
else
F_16 ( V_2 ,
V_74 | V_75 ) ;
...
static T_2 F_26 ( struct V_76 * V_86 )
{
...
struct V_104 * V_105 ;
const char * V_106 ;
V_2 = F_32 ( & V_103 -> V_2 , sizeof( * V_2 ) , V_107 ) ;
if ( ! V_2 )
return - V_108 ;
V_2 -> V_6 = F_32 ( & V_103 -> V_2 , sizeof( * V_2 -> V_6 ) , V_107 ) ;
if ( ! V_2 -> V_6 )
return - V_108 ;
F_33 ( V_103 , V_2 ) ;
V_2 -> V_14 = & V_103 -> V_2 ;
F_34 ( & V_2 -> V_17 ) ;
V_105 = F_35 ( V_103 , V_109 , 0 ) ;
V_2 -> V_110 = F_36 ( V_2 -> V_14 , V_105 ) ;
if ( F_37 ( V_2 -> V_110 ) ) {
V_32 = - V_108 ;
goto V_111;
}
V_32 = F_38 ( V_2 -> V_14 -> V_112 , L_9 ,
& V_106 ) ;
if ( V_32 < 0 )
V_106 = NULL ;
V_2 -> V_9 = F_39 ( V_103 , 0 ) ;
F_3 ( V_2 , V_16 ) ;
V_32 = F_40 ( & V_103 -> V_2 , V_2 -> V_9 , F_6 ,
V_113 ,
...
F_43 ( V_86 , V_2 ) ;
V_86 -> V_115 = V_116 ;
F_44 ( V_86 -> V_114 , L_14 , sizeof( V_86 -> V_114 ) ) ;
if ( V_106 )
F_45 ( V_86 -> V_114 , V_106 , sizeof( V_86 -> V_114 ) ) ;
V_86 -> V_117 = & V_118 ;
