...
struct V_78 * V_79 = V_73 -> V_69 . V_80 ;
V_77 = F_29 ( V_81 , & V_73 -> V_69 ) ;
if ( ! V_77 )
return - V_82 ;
V_75 = F_30 ( V_73 , V_83 , 0 ) ;
...
V_1 = F_36 ( & V_73 -> V_69 , sizeof( * V_1 ) , V_84 ) ;
if ( ! V_1 )
return - V_85 ;
if ( F_37 ( V_79 , L_6 , NULL ) ) {
V_1 -> V_24 = F_38
( V_79 , L_6 ) ;
if ( F_32 ( V_1 -> V_24 ) ) {
F_26 ( & V_73 -> V_69 ,
...
{
unsigned int V_30 = V_45 ? V_95 : V_96 ;
if ( ! V_1 -> V_24 )
return;
if ( F_1 ( V_1 ) )
F_12 ( V_1 -> V_24 , V_30 ,
...
static int F_47 ( struct V_99 * V_69 )
{
...
static int F_50 ( struct V_99 * V_69 )
{
struct V_1 * V_1 = F_48 ( V_69 ) ;
if ( F_49 ( V_69 ) )
F_46 ( V_1 , false ) ;
