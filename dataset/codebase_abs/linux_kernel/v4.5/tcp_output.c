...
if ( F_133 ( ! V_378 ) )
goto V_381;
if ( ( V_378 > 1 ) && ( V_4 -> V_81 > ( V_378 - 1 ) * V_19 ) ) {
if ( F_52 ( F_132 ( V_2 , V_4 , ( V_378 - 1 ) * V_19 , V_19 ,
V_180 ) ) )
goto V_381;
V_4 = F_207 ( V_2 , V_4 ) ;
}
...
F_61 ( V_2 , V_251 , V_333 , 1 , V_2 -> V_385 ) ;
}
...
int V_387 = F_213 ( V_2 ) ;
int V_388 = F_214 ( V_2 ) ;
int V_389 = F_30 ( int , V_8 -> V_45 , V_388 ) ;
int V_228 ;
if ( V_19 > V_389 )
V_19 = V_389 ;
if ( V_387 < ( V_389 >> 1 ) ) {
...
4U * V_8 -> V_20 ) ;
V_387 = F_216 ( V_387 , 1 << V_8 -> V_58 . V_47 ) ;
...
if ( V_228 <= V_387 - V_19 || V_228 > V_387 )
V_228 = ( V_387 / V_19 ) * V_19 ;
else if ( V_19 == V_389 &&
V_387 > V_228 + ( V_389 >> 1 ) )
V_228 = V_387 ;
}
...
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_3 * V_392 = F_207 ( V_2 , V_4 ) ;
int V_393 , V_394 ;
V_393 = V_4 -> V_81 ;
V_394 = V_392 -> V_81 ;
...
F_218 ( V_2 , V_392 , V_4 ) ;
F_190 ( V_392 , V_2 ) ;
F_219 ( V_392 , F_138 ( V_4 , V_394 ) ,
V_394 ) ;
if ( V_392 -> V_89 == V_90 )
V_4 -> V_89 = V_90 ;
if ( V_4 -> V_89 != V_90 )
V_4 -> V_91 = F_220 ( V_4 -> V_91 , V_392 -> V_91 , V_393 ) ;
F_5 ( V_4 ) -> V_12 = F_5 ( V_392 ) -> V_12 ;
F_5 ( V_4 ) -> V_64 |= F_5 ( V_392 ) -> V_64 ;
F_5 ( V_4 ) -> V_92 |= F_5 ( V_392 ) -> V_92 & V_395 ;
F_221 ( V_8 ) ;
if ( V_392 == V_8 -> V_396 )
V_8 -> V_396 = V_4 ;
F_127 ( V_2 , V_392 , F_6 ( V_392 ) ) ;
F_191 ( V_2 , V_392 ) ;
}
...
if ( F_194 ( & V_2 -> V_204 ) >
F_20 ( V_2 -> V_250 + ( V_2 -> V_250 >> 2 ) , V_2 -> V_401 ) )
return - V_402 ;
if ( F_202 ( V_2 , V_4 ) )
return - V_403 ;
...
return - V_278 ;
F_171 ( V_4 , V_332 ) ;
F_127 ( V_2 , V_4 , V_406 - F_6 ( V_4 ) ) ;
}
}
if ( ( F_5 ( V_4 ) -> V_64 & V_407 ) == V_407 )
F_41 ( V_2 , V_4 ) ;
F_223 ( V_2 , V_4 , V_332 ) ;
if ( F_52 ( ( V_408 && ( ( unsigned long ) V_4 -> V_181 & 3 ) ) ||
F_226 ( V_4 ) >= 0xFFFF ) ) {
...
return;
V_427 = F_235 ( V_169 ) ;
V_2 -> V_428 += V_427 * V_429 ;
F_236 ( V_2 , V_427 ) ;
if ( V_430 && V_2 -> V_431 )
F_237 ( V_2 -> V_431 , V_427 ) ;
}
void F_238 ( struct V_1 * V_2 )
{
struct V_3 * V_4 , * V_432 = F_169 ( V_2 ) ;
struct V_7 * V_8 = F_3 ( V_2 ) ;
if ( V_432 && ( F_176 ( V_2 ) || F_215 ( V_2 ) ) ) {
V_433:
F_5 ( V_432 ) -> V_64 |= V_94 ;
F_5 ( V_432 ) -> V_12 ++ ;
V_8 -> V_249 ++ ;
...
F_209 ( V_2 , F_62 ( V_2 ) , V_379 ) ;
}
void F_241 ( struct V_1 * V_2 , T_10 V_434 )
{
struct V_3 * V_4 ;
V_4 = F_242 ( V_323 , V_434 ) ;
if ( ! V_4 ) {
F_34 ( F_9 ( V_2 ) , V_435 ) ;
return;
}
...
if ( F_100 ( V_4 ) ) {
struct V_3 * V_349 = F_245 ( V_4 , V_180 ) ;
if ( ! V_349 )
return - V_278 ;
F_190 ( V_4 , V_2 ) ;
F_119 ( V_349 ) ;
...
struct V_3 * F_247 ( const struct V_1 * V_2 , struct V_17 * V_18 ,
struct V_74 * V_75 ,
struct V_132 * V_133 ,
bool V_440 )
{
...
F_240 ( V_4 , V_323 ) ;
if ( V_440 ) {
F_249 ( V_4 , F_250 ( V_75 ) ) ;
} else {
F_249 ( V_4 , (struct V_1 * ) V_2 ) ;
}
F_251 ( V_4 , V_18 ) ;
V_19 = F_15 ( V_18 ) ;
V_441 = F_252 ( V_8 -> V_58 . V_441 ) ;
if ( V_441 && V_441 < V_19 )
V_19 = V_441 ;
memset ( & V_99 , 0 , sizeof( V_99 ) ) ;
#ifdef F_253
if ( F_52 ( V_75 -> V_442 ) )
V_4 -> V_217 . V_443 = F_254 ( V_75 ) ;
else
#endif
F_99 ( & V_4 -> V_217 ) ;
#ifdef F_56
F_255 () ;
V_143 = F_256 ( V_75 ) -> V_149 -> V_444 ( V_2 , F_250 ( V_75 ) ) ;
#endif
F_257 ( V_4 , F_256 ( V_75 ) -> V_445 , V_446 ) ;
...
V_77 -> V_448 = 1 ;
F_42 ( V_75 , V_77 ) ;
V_77 -> V_222 = F_111 ( V_166 -> V_449 ) ;
V_77 -> V_224 = V_166 -> V_450 ;
F_48 ( V_4 , F_256 ( V_75 ) -> V_451 ,
V_93 | V_236 ) ;
V_77 -> V_82 = F_53 ( F_5 ( V_4 ) -> V_82 ) ;
V_77 -> V_226 = F_53 ( F_256 ( V_75 ) -> V_60 ) ;
V_77 -> V_228 = F_111 ( F_20 ( V_75 -> V_452 , 65535U ) ) ;
F_51 ( ( T_8 * ) ( V_77 + 1 ) , NULL , & V_99 ) ;
V_77 -> V_453 = ( V_215 >> 2 ) ;
F_258 ( F_9 ( V_2 ) , V_237 ) ;
#ifdef F_56
if ( V_143 )
F_256 ( V_75 ) -> V_149 -> V_234 ( V_99 . V_105 ,
V_143 , F_250 ( V_75 ) , V_4 ) ;
F_259 () ;
#endif
V_4 -> V_241 . V_242 = 0 ;
return V_4 ;
}
static void F_260 ( struct V_1 * V_2 , const struct V_17 * V_18 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
const struct V_454 * V_455 ;
T_4 V_456 = F_261 ( V_18 , V_457 ) ;
if ( V_456 == V_458 )
return;
F_255 () ;
V_455 = F_262 ( V_456 ) ;
if ( F_54 ( V_455 && F_263 ( V_455 -> V_459 ) ) ) {
F_264 ( V_6 -> V_460 -> V_459 ) ;
V_6 -> V_461 = F_265 ( V_18 ) ;
V_6 -> V_460 = V_455 ;
}
F_259 () ;
}
...
#endif
if ( V_8 -> V_58 . V_441 )
V_8 -> V_58 . V_291 = V_8 -> V_58 . V_441 ;
V_8 -> V_462 = 0 ;
F_156 ( V_2 ) ;
F_157 ( V_2 , F_159 ( V_18 ) ) ;
F_260 ( V_2 , V_18 ) ;
if ( ! V_8 -> V_45 )
V_8 -> V_45 = F_261 ( V_18 , V_463 ) ;
V_8 -> V_20 = F_15 ( V_18 ) ;
if ( V_8 -> V_58 . V_441 && V_8 -> V_58 . V_441 < V_8 -> V_20 )
V_8 -> V_20 = V_8 -> V_58 . V_441 ;
F_267 ( V_2 ) ;
if ( V_2 -> V_464 & V_465 &&
( V_8 -> V_45 > F_214 ( V_2 ) || V_8 -> V_45 == 0 ) )
V_8 -> V_45 = F_214 ( V_2 ) ;
F_28 ( F_214 ( V_2 ) ,
V_8 -> V_20 - ( V_8 -> V_58 . V_466 ? V_8 -> V_80 - sizeof( struct V_76 ) : 0 ) ,
& V_8 -> V_44 ,
& V_8 -> V_45 ,
V_157 ,
& V_47 ,
...
static int F_273 ( struct V_1 * V_2 , struct V_3 * V_447 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_146 * V_473 = V_8 -> V_148 ;
int V_474 = 0 , V_49 , V_216 = 0 ;
unsigned long V_475 = 0 ;
struct V_3 * V_476 ;
V_8 -> V_58 . V_291 = V_8 -> V_20 ;
F_274 ( V_2 , & V_8 -> V_58 . V_291 , & V_473 -> V_161 ,
& V_474 , & V_475 ) ;
if ( V_474 > 1 &&
F_275 ( V_477 , V_475 + ( 60 * V_348 << V_474 ) ) ) {
V_473 -> V_161 . V_81 = - 1 ;
goto V_478;
}
if ( V_479 & V_480 )
V_473 -> V_161 . V_81 = - 1 ;
else if ( V_473 -> V_161 . V_81 <= 0 )
goto V_478;
if ( V_8 -> V_58 . V_441 && V_8 -> V_58 . V_441 < V_8 -> V_58 . V_291 )
V_8 -> V_58 . V_291 = V_8 -> V_58 . V_441 ;
V_49 = F_152 ( V_2 , F_2 ( V_2 ) -> V_303 ) -
V_145 ;
V_49 = F_30 ( V_481 , V_49 , V_473 -> V_169 ) ;
V_49 = F_30 ( V_481 , V_49 , F_276 ( V_323 ) ) ;
V_476 = F_136 ( V_2 , V_49 , V_2 -> V_385 , false ) ;
if ( ! V_476 )
goto V_478;
V_476 -> V_89 = V_90 ;
memcpy ( V_476 -> V_243 , V_447 -> V_243 , sizeof( V_447 -> V_243 ) ) ;
if ( V_49 ) {
int V_482 = F_277 ( F_138 ( V_476 , V_49 ) , V_49 ,
& V_473 -> V_181 -> V_483 ) ;
if ( F_52 ( ! V_482 ) ) {
F_278 ( V_476 ) ;
goto V_478;
...
V_473 -> V_482 = V_49 ;
F_271 ( V_2 , V_476 ) ;
V_216 = F_97 ( V_2 , V_476 , 1 , V_2 -> V_385 ) ;
V_447 -> V_217 = V_476 -> V_217 ;
F_5 ( V_476 ) -> V_82 ++ ;
F_5 ( V_476 ) -> V_64 = V_236 | V_279 ;
if ( ! V_216 ) {
V_8 -> V_476 = ( V_473 -> V_482 > 0 ) ;
F_34 ( F_9 ( V_2 ) , V_16 ) ;
goto V_484;
}
V_478:
if ( V_473 -> V_161 . V_81 > 0 )
V_473 -> V_161 . V_81 = 0 ;
V_216 = F_97 ( V_2 , V_447 , 1 , V_2 -> V_385 ) ;
if ( V_216 )
V_8 -> V_163 = 0 ;
V_484:
V_473 -> V_161 . V_81 = - 1 ;
...
V_273 = F_136 ( V_2 , 0 , V_2 -> V_385 , true ) ;
if ( F_52 ( ! V_273 ) )
return - V_218 ;
...
F_271 ( V_2 , V_273 ) ;
F_39 ( V_2 , V_273 ) ;
V_216 = V_8 -> V_148 ? F_273 ( V_2 , V_273 ) :
F_97 ( V_2 , V_273 , 1 , V_2 -> V_385 ) ;
if ( V_216 == - V_485 )
return V_216 ;
V_8 -> V_11 = V_8 -> V_249 ;
V_8 -> V_486 = V_8 -> V_249 ;
...
V_37 = F_20 ( V_37 , V_490 ) ;
}
V_366 = V_477 + V_37 ;
if ( V_6 -> V_35 . V_491 & V_493 ) {
if ( V_6 -> V_35 . V_494 ||
F_282 ( V_6 -> V_35 . V_366 , V_477 + ( V_37 >> 2 ) ) ) {
F_283 ( V_2 ) ;
return;
}
if ( ! F_275 ( V_366 , V_6 -> V_35 . V_366 ) )
V_366 = V_6 -> V_35 . V_366 ;
}
V_6 -> V_35 . V_491 |= V_495 | V_493 ;
V_6 -> V_35 . V_366 = V_366 ;
F_284 ( V_2 , & V_6 -> V_496 , V_366 ) ;
}
...
F_18 ( V_2 , V_497 ) ;
V_273 = F_242 ( V_323 ,
F_210 ( V_2 , V_180 | V_498 ) ) ;
if ( F_52 ( ! V_273 ) ) {
F_285 ( V_2 ) ;
F_2 ( V_2 ) -> V_35 . V_37 = V_499 ;
F_201 ( V_2 , V_40 ,
V_374 , V_376 ) ;
return;
}
...
F_286 ( V_273 ) ;
F_99 ( & V_273 -> V_217 ) ;
F_97 ( V_2 , V_273 , 0 , ( V_500 T_10 ) 0 ) ;
}
static int F_287 ( struct V_1 * V_2 , int V_501 , int V_502 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_3 * V_4 ;
V_4 = F_242 ( V_323 ,
...
return - 1 ;
F_240 ( V_4 , V_323 ) ;
F_48 ( V_4 , V_8 -> V_95 - ! V_501 , V_236 ) ;
F_99 ( & V_4 -> V_217 ) ;
F_34 ( F_9 ( V_2 ) , V_502 ) ;
return F_97 ( V_2 , V_4 , 0 , ( V_500 T_10 ) 0 ) ;
}
void F_288 ( struct V_1 * V_2 )
{
if ( V_2 -> V_173 == V_503 ) {
F_3 ( V_2 ) -> V_504 = F_3 ( V_2 ) -> V_60 - 1 ;
F_287 ( V_2 , 0 , V_505 ) ;
}
}
int F_289 ( struct V_1 * V_2 , int V_502 )
{
struct V_7 * V_8 = F_3 ( V_2 ) ;
struct V_3 * V_4 ;
if ( V_2 -> V_173 == V_384 )
...
unsigned int V_506 = F_12 ( V_8 ) - F_5 ( V_4 ) -> V_82 ;
if ( F_11 ( V_8 -> V_486 , F_5 ( V_4 ) -> V_12 ) )
V_8 -> V_486 = F_5 ( V_4 ) -> V_12 ;
if ( V_506 < F_5 ( V_4 ) -> V_12 - F_5 ( V_4 ) -> V_82 ||
V_4 -> V_81 > V_19 ) {
V_506 = F_20 ( V_506 , V_19 ) ;
F_5 ( V_4 ) -> V_64 |= V_279 ;
if ( F_132 ( V_2 , V_4 , V_506 , V_19 , V_180 ) )
return - 1 ;
} else if ( ! F_6 ( V_4 ) )
F_122 ( V_4 , V_19 ) ;
F_5 ( V_4 ) -> V_64 |= V_279 ;
...
if ( F_290 ( V_8 -> V_96 , V_8 -> V_95 + 1 , V_8 -> V_95 + 0xFFFF ) )
F_287 ( V_2 , 1 , V_502 ) ;
return F_287 ( V_2 , 0 , V_502 ) ;
}
}
...
int F_293 ( const struct V_1 * V_2 , struct V_74 * V_75 )
{
const struct V_513 * V_514 = F_256 ( V_75 ) -> V_149 ;
struct V_515 V_248 ;
int V_516 ;
F_256 ( V_75 ) -> V_445 = F_294 () ;
V_516 = V_514 -> V_517 ( V_2 , NULL , & V_248 , V_75 , NULL , true ) ;
if ( ! V_516 ) {
F_258 ( F_9 ( V_2 ) , V_409 ) ;
F_204 ( F_9 ( V_2 ) , V_410 ) ;
}
