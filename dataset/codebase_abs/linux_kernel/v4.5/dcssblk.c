...
goto V_101;
if ( F_65 ( V_90 ) > F_66 ( V_90 -> V_100 -> V_84 ) ) {
goto V_101;
}
if ( V_4 -> V_42 ) {
switch ( V_4 -> V_32 ) {
...
F_69 (bvec, bio, iter) {
V_96 = ( unsigned long )
F_70 ( V_92 . V_106 ) + V_92 . V_107 ;
V_97 = V_4 -> V_23 + ( V_95 << 12 ) + V_98 ;
if ( F_71 ( ( V_96 & 4095 ) != 0 ) || ( V_92 . V_108 & 4095 ) != 0 )
goto V_101;
if ( F_67 ( V_90 ) == V_109 ) {
...
static long
F_74 ( struct V_81 * V_82 , T_5 V_111 ,
...
* V_113 = F_75 ( F_76 ( V_4 -> V_23 + V_114 ) , V_116 ) ;
return V_115 - V_114 ;
}
static void
F_77 ( void )
...
V_26 = F_93 ( V_57 , & V_126 ) ;
if ( V_26 )
goto V_127;
V_26 = F_93 ( V_57 , & V_128 ) ;
if ( V_26 )
goto V_127;
V_26 = F_94 ( 0 , V_123 ) ;
if ( V_26 < 0 )
