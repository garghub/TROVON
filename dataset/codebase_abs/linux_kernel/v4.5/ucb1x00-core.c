...
F_3 ( V_2 , V_39 , V_36 ) ;
F_3 ( V_2 , V_39 , 0 ) ;
for ( V_37 = 0 ; V_37 < 16 && V_36 ; V_37 ++ , V_36 >>= 1 )
if ( V_36 & 1 )
F_26 ( V_2 -> V_21 + V_37 ) ;
F_11 ( V_2 ) ;
}
...
F_10 ( V_2 ) ;
if ( V_2 -> V_40 & V_20 )
F_3 ( V_2 , V_41 , V_2 -> V_40 &
V_2 -> V_42 ) ;
if ( V_2 -> V_43 & V_20 )
F_3 ( V_2 , V_44 , V_2 -> V_43 &
V_2 -> V_42 ) ;
F_11 ( V_2 ) ;
}
...
{
struct V_1 * V_2 = F_30 ( V_46 ) ;
unsigned V_20 = 1 << ( V_46 -> V_47 - V_2 -> V_21 ) ;
F_31 ( & V_2 -> V_48 ) ;
V_2 -> V_42 &= ~ V_20 ;
F_27 ( V_2 , V_20 ) ;
F_32 ( & V_2 -> V_48 ) ;
...
static int F_34 ( struct V_45 * V_46 , unsigned int type )
{
struct V_1 * V_2 = F_30 ( V_46 ) ;
unsigned V_20 = 1 << ( V_46 -> V_47 - V_2 -> V_21 ) ;
F_31 ( & V_2 -> V_48 ) ;
...
static int F_35 ( struct V_45 * V_46 , unsigned int V_51 )
{
struct V_1 * V_2 = F_30 ( V_46 ) ;
...
unsigned V_47 = V_2 -> V_21 + V_37 ;
F_61 ( V_47 , & V_90 , V_91 ) ;
F_62 ( V_47 , V_2 ) ;
F_63 ( V_47 , V_92 ) ;
}
F_64 ( V_2 -> V_47 , V_49 ) ;
F_65 ( V_2 -> V_47 , F_24 , V_2 ) ;
if ( V_53 && V_53 -> V_93 ) {
V_2 -> V_17 . V_94 = F_66 ( & V_2 -> V_63 ) ;
V_2 -> V_17 . V_85 = & V_2 -> V_63 ;
V_2 -> V_17 . V_95 = V_96 ;
V_2 -> V_17 . V_88 = V_53 -> V_93 ;
V_2 -> V_17 . V_97 = 10 ;
V_2 -> V_17 . V_9 = F_8 ;
V_2 -> V_17 . V_98 = F_12 ;
V_2 -> V_17 . V_99 = F_13 ;
...
F_41 ( & V_2 -> V_104 ) ;
F_79 (l, n, &ucb->devs) {
struct V_62 * V_63 = F_80 ( V_108 , struct V_62 , V_68 ) ;
F_40 ( V_63 ) ;
}
F_23 ( & V_103 ) ;
if ( V_2 -> V_17 . V_88 != - 1 )
...
F_41 ( & V_61 -> V_104 ) ;
F_79 (l, n, &drv->devs) {
struct V_62 * V_63 = F_80 ( V_108 , struct V_62 , V_70 ) ;
F_40 ( V_63 ) ;
}
F_23 ( & V_103 ) ;
}
