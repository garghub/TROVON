...
static bool F_33 ( struct V_59 * V_5 , unsigned int V_82 ,
enum V_83 V_84 )
{
int V_36 = F_27 ( V_5 , V_82 ) ;
const struct V_72 * V_42 = & V_5 -> V_6 -> V_11 [ V_36 ] ;
switch ( V_84 ) {
case V_85 :
return true ;
...
static int F_34 ( struct V_1 * V_2 , unsigned V_82 ,
unsigned long * V_92 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_59 * V_5 = V_4 -> V_5 ;
enum V_83 V_84 = F_35 ( * V_92 ) ;
unsigned long V_62 ;
if ( ! F_33 ( V_5 , V_82 , V_84 ) )
return - V_93 ;
switch ( V_84 ) {
case V_85 :
case V_86 :
...
static int F_36 ( struct V_1 * V_2 , unsigned V_82 ,
...
static int F_38 ( struct V_1 * V_2 , unsigned V_41 ,
unsigned long * V_22 ,
unsigned V_23 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_36 ( V_2 , V_11 [ V_54 ] , V_22 , V_23 ) ;
return 0 ;
}
static int F_39 ( struct V_59 * V_5 , struct V_3 * V_4 )
{
unsigned int V_54 ;
V_4 -> V_11 = F_40 ( V_5 -> V_33 ,
sizeof( * V_4 -> V_11 ) * V_5 -> V_6 -> V_13 ,
V_25 ) ;
if ( F_41 ( ! V_4 -> V_11 ) )
return - V_26 ;
V_4 -> V_22 = F_40 ( V_5 -> V_33 ,
...
int F_42 ( struct V_59 * V_5 )
{
struct V_3 * V_4 ;
int V_43 ;
V_4 = F_40 ( V_5 -> V_33 , sizeof( * V_4 ) , V_25 ) ;
if ( F_41 ( ! V_4 ) )
return - V_26 ;
V_4 -> V_5 = V_5 ;
V_5 -> V_104 = V_4 ;
...
V_4 -> V_115 = F_43 ( & V_4 -> V_105 , V_5 -> V_33 , V_4 ) ;
if ( F_44 ( V_4 -> V_115 ) )
return F_45 ( V_4 -> V_115 ) ;
return 0 ;
}
int F_46 ( struct V_59 * V_5 )
{
