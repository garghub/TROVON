...
if ( V_288 -> V_249 && ! ( V_288 -> V_81 & V_293 ) )
return;
...
static int F_225 ( struct V_320 * V_85 , T_7 V_177 )
{
struct V_1 * V_64 ;
int V_40 ;
...
static int F_232 ( struct V_320 * V_85 , struct V_325 * V_326 )
{
struct V_1 * V_64 ;
V_64 = F_226 ( V_85 -> V_86 ) ;
if ( ! V_64 )
...
V_326 -> V_328 = F_233 ( V_85 ) >> V_64 -> V_34 -> V_70 ;
F_23 ( V_64 ) ;
return 0 ;
}
static void
...
static void F_243 ( void * V_19 , T_8 V_340 )
{
...
V_56 -> V_343 = & F_152 ;
if ( ( F_248 ( V_56 , V_344 ) > 0 ) ||
( V_345 && F_249 ( F_35 ( & V_56 -> V_57 ) ) != 0 ) )
F_250 ( F_243 , V_56 ) ;
return 0 ;
}
...
F_263 ( V_350 , & V_2 -> V_190 ) ;
} else
if ( F_137 ( V_252 , & V_2 -> V_190 ) ) {
F_23 ( V_2 ) ;
return - V_207 ;
}
if ( F_264 ( V_350 , & V_2 -> V_190 ) &&
...
int F_268 ( struct V_225 * V_56 , int V_353 )
{
struct V_1 * V_2 ;
int V_341 ;
V_2 = F_149 ( V_56 ) ;
...
void F_269 ( struct V_225 * V_56 , int * V_358 )
{
int V_359 ;
T_9 V_360 , V_361 ;
struct V_1 * V_2 ;
...
if ( F_30 ( V_2 ) )
return;
for ( V_359 = 0 ; V_359 < 8 ; V_359 ++ ) {
V_361 = 0x80 >> V_359 ;
if ( V_358 [ V_359 ] & V_362 ) {
V_360 = V_2 -> V_215 . V_216 ;
V_2 -> V_215 . V_216 &= ~ V_361 ;
V_2 -> V_215 . V_219 &= ~ V_361 ;
V_2 -> V_215 . V_220 &= ~ V_361 ;
if ( V_360 && ! V_2 -> V_215 . V_216 ) {
F_266 ( & V_2 -> V_56 -> V_57 ,
L_117
L_112 ) ;
F_39 ( V_60 , V_2 ,
...
if ( V_358 [ V_359 ] & V_363 ) {
V_2 -> V_215 . V_216 &= ~ V_361 ;
V_2 -> V_215 . V_219 &= ~ V_361 ;
V_2 -> V_215 . V_220 &= ~ V_361 ;
V_2 -> V_215 . V_221 |= V_361 ;
F_75 ( V_2 ) ;
}
if ( V_358 [ V_359 ] & V_364 ) {
if ( ! ( V_2 -> V_215 . V_216 & V_361 ) &&
! ( V_2 -> V_215 . V_221 & V_361 ) ) {
V_2 -> V_215 . V_221 |= V_361 ;
F_75 ( V_2 ) ;
}
...
if ( F_30 ( V_2 ) )
return F_103 ( V_2 ) ;
F_121 ( V_366 , & V_2 -> V_190 ) ;
if ( V_2 -> V_42 -> V_367 )
V_40 = V_2 -> V_42 -> V_367 ( V_2 ) ;
F_176 ( V_2 , V_368 ) ;
F_12 ( & V_365 ) ;
F_170 ( F_142 ( V_56 ) ) ;
V_40 = 0 ;
...
V_192 = V_99 -> V_188 ;
V_192 -> V_373 = V_374 ;
if ( F_277 ( V_370 , V_371 ) ) {
V_372 = ( unsigned long * ) ( V_99 -> V_19 ) ;
V_192 -> V_375 = ( V_376 ) ( V_377 ) V_372 ;
V_192 -> V_190 = V_378 ;
V_372 = F_278 ( V_372 , V_370 , V_371 ) ;
} else {
V_192 -> V_375 = ( V_376 ) ( V_377 ) V_370 ;
V_192 -> V_190 = 0 ;
}
V_192 -> V_379 = V_371 ;
V_99 -> V_109 = V_2 ;
...
int V_341 ;
struct V_98 * V_99 ;
V_99 = F_276 ( V_2 , V_370 , V_371 ,
V_184 ) ;
if ( F_30 ( V_99 ) )
return F_103 ( V_99 ) ;
V_341 = F_195 ( V_99 ) ;
F_128 ( V_99 , V_99 -> V_369 ) ;
return V_341 ;
}
...
char * V_381 = NULL ;
if ( F_281 ( & V_228 -> V_232 ) && ( V_228 -> V_232 . V_382 . V_383 == 0x01 ) ) {
if ( V_228 -> V_232 . V_382 . V_384 )
V_380 = F_282 ( (struct V_384 * ) ( unsigned long )
V_228 -> V_232 . V_382 . V_384 ) ;
if ( V_380 && V_380 -> V_385 == 64 && V_380 -> V_190 )
switch ( V_380 -> V_190 & 0x07 ) {
case 1 :
V_381 = V_380 -> V_386 . V_387 . V_381 ;
break;
case 2 :
V_381 = V_380 -> V_386 . V_388 . V_381 ;
break;
default:
break;
}
} else if ( V_228 -> V_242 . V_389 . V_390 . V_391 ) {
V_381 = V_228 -> V_392 ;
}
return V_381 ;
}
