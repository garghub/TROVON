...
struct V_268 * V_262 ;
if ( V_76 -> V_92 && V_68 -> V_277 == V_304 )
F_183 ( V_154 ) &= ~ V_305 ;
else
F_183 ( V_154 ) |= V_305 ;
V_156 = (struct V_155 * ) F_147 ( V_68 ) ;
V_156 = F_76 ( V_154 ) ;
if ( V_156 -> V_161 == V_306 && V_156 -> V_275 == V_307 )
return 0 ;
V_2 = ( (struct V_72 * ) F_41 ( V_76 ) ) -> V_78 ;
V_47 = F_2 ( V_2 ) ;
if ( F_143 ( V_47 ) && F_184 ( V_154 ) == V_308 &&
F_148 ( V_156 -> V_309 ) == V_310 ) {
F_17 ( L_49 ) ;
return - V_113 ;
}
if ( ! ( F_183 ( V_154 ) & V_305 ) ||
...
static int V_214 ( void * V_317 )
{
struct V_209 * V_210 = V_317 ;
struct V_67 * V_68 ;
struct V_318 V_319 ;
F_51 ( & V_319 ) ;
F_197 ( V_320 , V_321 ) ;
...
static void F_262 ( struct V_389 * V_390 , struct V_153 * V_154 , void * V_317 )
{
struct V_5 * V_6 = V_317 ;
...
static void F_267 ( struct V_389 * V_390 , struct V_153 * V_154 , void * V_317 )
{
struct V_77 * V_76 = V_317 ;
...
V_6 , V_399 ) ;
case V_308 :
if ( F_148 ( V_156 -> V_253 ) != V_310 )
break;
return F_271 ( V_76 , V_397 , V_154 , V_398 , F_267 ,
V_76 , V_399 ) ;
}
return F_271 ( V_76 , V_397 , V_154 , V_398 , F_270 , V_317 , V_399 ) ;
}
