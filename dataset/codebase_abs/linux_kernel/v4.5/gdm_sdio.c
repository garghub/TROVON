...
F_11 ( & V_4 -> V_15 ) ;
V_70 = 0 ;
} else if ( ! V_3 -> V_73 && ! F_9 ( & V_3 -> V_24 ) ) {
V_68 = F_33 () ;
V_69 = V_3 -> V_64 ;
V_71 = F_37 ( F_38 ( V_68 , V_69 ) ) ;
if ( V_71 >= 0 && V_71 < V_74 ) {
F_39 ( & V_17 -> V_67 ) ;
F_31 ( & V_3 -> V_26 , V_55 ) ;
return;
...
static int F_40 ( void * V_75 , void * V_37 , int V_38 ,
void (* F_41)( void * V_37 ) , void * V_63 )
{
struct V_16 * V_17 = V_75 ;
struct V_2 * V_3 = & V_17 -> V_3 ;
struct V_1 * V_4 ;
T_1 * V_76 = V_37 ;
int V_12 = 0 ;
...
static int F_42 ( struct V_16 * V_17 , T_1 * V_80 , int V_38 )
{
struct V_2 * V_3 = & V_17 -> V_3 ;
T_3 V_58 ;
unsigned long V_55 ;
F_28 ( & V_3 -> V_26 , V_55 ) ;
V_58 = ( V_80 [ 0 ] << 8 ) | ( V_80 [ 1 ] ) ;
if ( V_58 != V_81 )
goto V_82;
if ( V_80 [ 4 ] == 0 ) {
...
{
struct V_83 * V_83 = F_44 ( V_36 ) ;
struct V_16 * V_17 = V_83 -> V_75 ;
struct V_2 * V_3 = & V_17 -> V_3 ;
struct V_9 * V_10 = & V_17 -> V_10 ;
struct V_8 * V_11 ;
unsigned long V_55 ;
T_1 V_84 , V_85 [ V_86 ] , * V_6 ;
T_4 V_38 , V_40 , V_39 ;
int V_22 , V_41 ;
V_84 = F_45 ( V_36 , 0x13 , & V_22 ) ;
if ( V_84 & 0x01 )
F_46 ( V_36 , 0x01 , 0x13 , & V_22 ) ;
else
return;
V_22 = F_47 ( V_36 , V_85 , 0x0 , V_86 ) ;
if ( V_22 ) {
F_25 ( & V_36 -> V_44 ,
L_5 , V_36 -> V_87 ) ;
goto V_88;
}
V_38 = ( V_85 [ 2 ] << 16 ) | ( V_85 [ 1 ] << 8 ) | V_85 [ 0 ] ;
if ( V_38 > ( V_34 - V_56 ) ) {
...
F_39 ( & V_17 -> V_67 ) ;
F_31 ( & V_3 -> V_26 , V_55 ) ;
F_32 ( & V_36 -> V_44 , L_7 , F_48 ( * V_89 ) ) ;
goto V_88;
}
memcpy ( V_10 -> V_21 , V_85 + V_56 ,
V_86 - V_56 ) ;
V_6 = V_10 -> V_21 + V_86 - V_56 ;
V_41 = V_38 - V_86 + V_56 ;
if ( V_41 <= 0 )
goto V_45;
V_40 = V_41 / V_36 -> V_42 ;
...
F_31 ( & V_10 -> V_26 , V_55 ) ;
V_88:
F_46 ( V_36 , 0x00 , 0x10 , & V_22 ) ;
if ( ! V_83 -> V_90 )
F_49 ( V_83 , & V_36 -> V_44 ) ;
}
static int F_50 ( void * V_75 ,
void (* F_41)( void * V_63 , void * V_37 , int V_38 ) ,
void * V_63 )
{
struct V_16 * V_17 = V_75 ;
struct V_9 * V_10 = & V_17 -> V_10 ;
