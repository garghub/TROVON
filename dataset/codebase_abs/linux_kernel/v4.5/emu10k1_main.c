...
F_37 ( F_27 , V_2 ,
L_23 ) ;
if ( F_38 ( V_2 -> V_183 . V_234 ) ) {
V_152 = F_39 ( V_2 -> V_183 . V_234 ) ;
V_2 -> V_183 . V_234 = NULL ;
F_7 ( V_2 -> V_73 -> V_74 ,
L_24 ) ;
return V_152 ;
}
F_40 ( V_2 -> V_183 . V_234 ) ;
}
#if 0
snd_emu1010_fpga_link_dst_src_write(emu,
...
static int F_56 ( struct V_263 * V_264 )
{
struct V_1 * V_2 = V_264 -> V_265 ;
return F_41 ( V_2 ) ;
}
int F_57 ( struct V_266 * V_73 ,
struct V_267 * V_166 ,
...
V_2 -> V_293 = NULL ;
V_2 -> V_98 = V_166 -> V_98 ;
F_63 ( V_166 , V_294 , & V_2 -> V_295 ) ;
F_64 ( V_166 , V_296 , & V_2 -> V_103 ) ;
F_35 ( V_73 -> V_74 ,
L_25 ,
...
F_35 ( V_73 -> V_74 , L_27 , V_276 -> V_300 ) ;
else if ( V_271 )
F_35 ( V_73 -> V_74 , L_28
L_29
L_30 , V_276 -> V_300 ,
...
int V_145 , V_78 = 0 ;
F_66 ( V_73 -> V_301 , V_276 -> V_301 , sizeof( V_73 -> V_301 ) ) ;
for (; ; ) {
...
if ( V_78 >= V_304 )
break;
snprintf ( V_73 -> V_301 , sizeof( V_73 -> V_301 ) , L_32 , V_276 -> V_301 , V_78 ) ;
}
}
V_274 = V_2 -> V_30 = V_276 -> V_305 ;
V_2 -> V_89 = V_274 ? 0 : 1 ;
V_2 -> V_306 = V_2 -> V_89 ? V_307 : V_308 ;
if ( F_67 ( & V_166 -> V_74 , V_2 -> V_306 ) < 0 ||
F_68 ( & V_166 -> V_74 , V_2 -> V_306 ) < 0 ) {
F_65 ( V_73 -> V_74 ,
L_33 ,
V_2 -> V_306 ) ;
F_55 ( V_2 ) ;
...
V_2 -> V_310 = V_312 ;
V_152 = F_69 ( V_166 , L_34 ) ;
if ( V_152 < 0 ) {
F_55 ( V_2 ) ;
F_54 ( V_166 ) ;
return V_152 ;
}
V_2 -> V_41 = F_70 ( V_166 , 0 ) ;
V_2 -> V_313 = V_270 >> V_314 ;
if ( F_71 ( V_315 , F_72 ( V_166 ) ,
( V_2 -> V_89 ? 32 : 16 ) * 1024 , & V_2 -> V_85 ) < 0 ) {
V_152 = - V_281 ;
goto error;
}
V_2 -> V_261 = F_73 ( V_2 -> V_313 * sizeof( void * ) ) ;
V_2 -> V_262 = F_73 ( V_2 -> V_313 *
...
V_2 -> V_259 = F_74 ( V_2 -> V_313 * V_317 ) ;
if ( V_2 -> V_259 == NULL ) {
V_152 = - V_281 ;
goto error;
}
...
if ( F_76 ( V_166 -> V_256 , V_328 , V_329 ,
V_330 , V_2 ) ) {
V_152 = - V_331 ;
goto error;
}
...
( ( T_1 * ) V_2 -> V_85 . V_260 ) [ V_273 ] = F_78 ( V_36 | V_273 ) ;
...
goto error;
F_13 ( V_2 ) ;
V_152 = F_81 ( V_73 , V_344 , V_2 , & V_278 ) ;
if ( V_152 < 0 )
goto error;
#ifdef F_82
F_83 ( V_2 ) ;
