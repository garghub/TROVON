...
static unsigned int F_52 ( struct V_69 * V_61 )
{
if ( V_61 -> V_66 == & V_67 )
return V_61 -> V_70 ;
return sizeof( struct V_71 * ) ;
}
static int F_53 ( struct V_72 * V_73 , struct V_69 * V_61 )
{
struct V_74 V_75 ;
strncpy ( V_75 . type , L_1 , sizeof( V_75 . type ) ) ;
V_75 . V_76 = V_61 -> V_77 ;
V_75 . V_78 = F_54 ( V_61 ) -> V_78 ;
if ( F_55 ( V_73 , V_79 ,
...
static void F_56 ( struct V_82 * V_83 , struct V_69 * V_61 )
{
F_57 ( V_83 , L_2 ) ;
F_57 ( V_83 , L_3 , V_61 -> V_84 & V_13 ?
L_4 : L_5 ) ;
F_57 ( V_83 , L_6 , V_61 -> V_77 ) ;
F_57 ( V_83 , L_7 ,
F_54 ( V_61 ) -> V_78 ) ;
}
struct V_2 * F_58 ( const char * V_85 , T_3 type ,
T_3 V_41 )
{
return F_59 ( V_85 , & V_67 , type , V_41 ) ;
}
static int F_60 ( struct V_1 * V_61 )
{
struct V_69 * V_25 = & V_61 -> V_4 . V_25 ;
if ( V_61 -> V_4 . V_78 > V_11 / 8 ||
V_61 -> V_4 . V_86 > V_11 / 8 ||
V_61 -> V_4 . V_86 == 0 )
return - V_87 ;
V_25 -> V_66 = & V_67 ;
V_25 -> V_84 &= ~ V_88 ;
...
if ( V_21 )
return V_21 ;
return F_66 ( V_91 , F_67 ( V_93 ) ) ;
}
void F_68 ( struct V_94 * V_93 )
{
F_69 ( F_70 ( V_93 ) ) ;
F_71 ( V_92 ( V_93 ) ) ;
}
...
struct V_94 * V_93 )
{
return F_73 ( & V_96 -> V_25 , & V_61 -> V_25 , V_93 ,
& V_67 ) ;
}
struct V_97 * F_74 ( struct V_98 * V_99 , T_3 type , T_3 V_41 )
{
struct V_69 * V_61 ;
V_61 = F_75 ( V_99 , & V_67 , type , V_41 ) ;
