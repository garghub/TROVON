...
static int F_58 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
if ( F_29 ( V_21 , & V_26 ) != 0 )
return - V_71 ;
...
static int F_83 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
if ( F_81 ( V_21 , & V_26 ) )
return - V_71 ;
...
static int F_101 ( struct V_68 V_21 , void * V_91 )
{
struct V_26 V_26 ;
...
static int F_102 ( struct V_128 * V_126 ,
struct V_68 * V_21 )
{
struct V_124 V_125 ;
V_125 . V_126 = * V_126 ;
...
void F_103 ( struct V_128 * V_126 )
{
struct V_68 V_129 ( V_21 ) ;
F_104 () ;
if ( F_102 ( V_126 , & V_21 ) != 0 )
F_105 ( L_19 ) ;
F_106 ( * ( ( V_43 * ) & V_21 ) ) ;
}
int T_1 F_107 ( struct V_130 * V_131 )
{
...
int F_109 ( struct V_7 * V_8 , struct V_138 * V_138 , T_5 V_19 , T_5 V_30 )
{
int V_98 ;
