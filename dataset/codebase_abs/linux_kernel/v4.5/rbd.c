...
F_17 ( V_208 -> V_226 <= V_227 ) ;
V_183 -> V_213 = V_208 -> V_228 [ 0 ] ;
F_17 ( V_183 -> V_213 < ( V_107 ) V_229 ) ;
V_224 = V_208 -> V_230 [ 0 ] . V_231 ;
switch ( V_224 ) {
case V_232 :
F_151 ( V_183 ) ;
break;
case V_233 :
F_17 ( V_208 -> V_230 [ 1 ] . V_231 == V_234 ||
V_208 -> V_230 [ 1 ] . V_231 == V_235 ) ;
case V_234 :
case V_235 :
F_153 ( V_183 ) ;
break;
...
default:
F_103 ( NULL , L_30 ,
V_183 -> V_243 , ( unsigned short ) V_224 ) ;
break;
}
if ( F_109 ( V_183 ) )
F_148 ( V_183 ) ;
...
F_17 ( V_247 == 1 || ( ( V_88 == V_90 ) && V_247 == 2 ) ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_208 = F_163 ( V_207 , V_113 , V_247 , false ,
V_248 ) ;
if ( ! V_208 )
return NULL ;
...
V_208 -> V_253 = F_158 ;
V_208 -> V_223 = V_183 ;
V_208 -> V_254 . V_255 = F_164 ( V_22 -> V_256 ) ;
F_165 ( & V_208 -> V_257 , V_183 -> V_243 ) ;
return V_208 ;
}
static struct V_220 *
...
static struct V_182 * F_169 ( const char * V_243 ,
V_107 V_146 , V_107 V_152 ,
enum V_202 type )
{
struct V_182 * V_183 ;
...
if ( ! V_144 )
return NULL ;
V_183 = F_170 ( V_259 , V_149 ) ;
if ( ! V_183 ) {
F_36 ( V_144 ) ;
return NULL ;
}
V_183 -> V_243 = memcpy ( V_144 , V_243 , V_97 ) ;
V_183 -> V_146 = V_146 ;
V_183 -> V_152 = V_152 ;
V_183 -> V_32 = 0 ;
V_183 -> V_133 = V_198 ;
...
struct V_194 * V_269 ;
struct V_182 * V_271 ;
V_269 = F_53 ( V_61 , struct V_194 , V_61 ) ;
V_271 = V_269 -> V_183 ;
V_269 -> V_183 = NULL ;
F_118 ( V_271 ) ;
F_141 ( V_269 ) ;
...
V_272 = V_183 -> V_133 < V_185 -> V_197 - 1 ;
} else {
F_17 ( V_185 -> V_265 != NULL ) ;
V_272 = F_185 ( V_185 -> V_265 , V_212 , V_213 ) ;
if ( ! V_272 )
F_186 ( V_185 -> V_265 , V_212 ) ;
}
return V_272 ;
}
...
struct V_194 * V_185 = V_183 -> V_185 ;
struct V_21 * V_22 = V_185 -> V_22 ;
V_107 V_274 = F_84 ( & V_22 -> V_110 ) ;
V_107 V_146 = V_183 -> V_146 ;
V_107 V_152 = V_183 -> V_152 ;
V_107 V_275 ;
T_8 V_224 ;
if ( V_88 == V_91 ) {
if ( ! V_146 && V_152 == V_274 &&
( ! F_145 ( V_185 ) ||
! F_114 ( V_183 ) ) ) {
V_224 = V_237 ;
} else if ( ( V_146 + V_152 == V_274 ) ) {
V_224 = V_238 ;
} else {
F_178 ( & V_22 -> V_263 ) ;
V_275 = V_22 -> V_110 . V_125 ;
F_179 ( & V_22 -> V_263 ) ;
if ( V_183 -> V_190 + V_152 == V_275 )
V_224 = V_238 ;
else
V_224 = V_239 ;
}
...
if ( V_224 == V_237 )
F_191 ( V_273 , V_247 , V_224 , 0 ) ;
else
F_192 ( V_273 , V_247 , V_224 ,
V_146 , V_152 , 0 , 0 ) ;
if ( V_183 -> type == V_204 )
F_193 ( V_273 , V_247 ,
V_183 -> V_218 , V_152 ) ;
...
V_107 V_146 ;
V_107 V_152 ;
V_243 = F_80 ( V_22 , V_190 ) ;
if ( ! V_243 )
goto V_280;
V_146 = F_82 ( V_22 , V_190 ) ;
V_152 = F_83 ( V_22 , V_190 , V_278 ) ;
V_183 = F_169 ( V_243 ,
V_146 , V_152 , type ) ;
F_78 ( V_243 ) ;
if ( ! V_183 )
...
if ( type == V_204 ) {
unsigned int V_281 ;
F_17 ( V_152 <= ( V_107 ) V_229 ) ;
V_281 = ( unsigned int ) V_152 ;
V_183 -> V_218 =
F_102 ( & V_218 ,
& V_277 ,
V_281 ,
...
V_271 = V_185 -> V_183 ;
F_17 ( V_271 != NULL ) ;
F_17 ( F_124 ( V_271 -> type ) ) ;
V_284 = V_185 -> V_212 ;
V_285 = V_185 -> V_152 ;
F_17 ( V_285 == V_185 -> V_213 ) ;
F_120 ( V_185 ) ;
F_17 ( V_271 -> V_185 ) ;
V_22 = V_271 -> V_185 -> V_22 ;
F_17 ( V_22 ) ;
if ( ! V_22 -> V_191 ) {
struct V_206 * V_207 ;
F_172 ( V_169 , V_260 ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_284 = F_125 ( V_207 , V_271 ) ;
if ( ! V_284 )
return;
}
if ( V_284 )
...
V_271 -> V_282 = V_169 ;
V_271 -> V_283 = V_260 ;
F_198 ( V_208 , 0 , V_240 , L_39 , L_40 ) ;
F_199 ( V_208 , 0 , V_169 , V_285 , 0 ,
false , false ) ;
V_88 = F_146 ( V_271 -> V_185 ) ;
F_189 ( V_271 , V_208 , V_88 , 1 ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_284 = F_125 ( V_207 , V_271 ) ;
if ( ! V_284 )
return;
...
V_260 = ( T_5 ) F_196 ( 0 , V_152 ) ;
V_169 = F_201 ( V_260 , V_59 ) ;
if ( F_30 ( V_169 ) ) {
V_212 = F_202 ( V_169 ) ;
V_169 = NULL ;
goto V_118;
...
T_6 V_97 ;
int V_39 ;
V_97 = sizeof ( V_106 ) + sizeof ( V_287 ) + sizeof ( V_287 ) ;
V_260 = ( T_5 ) F_196 ( 0 , V_97 ) ;
V_169 = F_201 ( V_260 , V_59 ) ;
if ( F_30 ( V_169 ) )
return F_202 ( V_169 ) ;
V_39 = - V_57 ;
V_286 = F_169 ( V_183 -> V_243 , 0 , 0 ,
V_205 ) ;
if ( ! V_286 )
goto V_49;
F_116 ( V_183 ) ;
...
F_17 ( V_183 -> V_185 ) ;
V_22 = V_183 -> V_185 -> V_22 ;
V_286 -> V_208 = F_162 ( V_22 , V_89 , 1 ,
V_286 ) ;
if ( ! V_286 -> V_208 )
goto V_49;
V_286 -> V_201 = F_204 ;
F_191 ( V_286 -> V_208 , 0 , V_236 , 0 ) ;
F_207 ( V_286 -> V_208 , 0 , V_169 , V_97 , 0 ,
false , false ) ;
F_159 ( V_286 ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_39 = F_125 ( V_207 , V_286 ) ;
V_49:
if ( V_39 )
F_118 ( V_183 ) ;
return V_39 ;
...
V_288 = V_183 -> V_190 + V_183 -> V_152 ;
if ( V_288 > V_22 -> V_191 ) {
V_107 V_213 = 0 ;
if ( V_183 -> V_190 < V_22 -> V_191 )
V_213 = V_22 -> V_191 -
V_183 -> V_190 ;
V_183 -> V_213 = F_210 ( V_289 , V_213 ) ;
} else {
V_183 -> V_213 = V_289 ;
}
V_49:
...
static int F_211 ( struct V_21 * V_22 , V_107 V_291 )
{
struct V_182 * V_183 ;
struct V_206 * V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
int V_39 ;
V_183 = F_169 ( V_22 -> V_292 , 0 , 0 ,
V_203 ) ;
if ( ! V_183 )
return - V_57 ;
V_39 = - V_57 ;
...
static void F_213 ( V_107 V_293 , V_107 V_291 , T_9 V_224 , void * V_294 )
{
struct V_21 * V_22 = (struct V_21 * ) V_294 ;
int V_39 ;
if ( ! V_22 )
return;
F_25 ( L_42 , V_58 ,
V_22 -> V_292 , ( unsigned long long ) V_291 ,
( unsigned int ) V_224 ) ;
V_39 = F_214 ( V_22 ) ;
if ( V_39 )
F_103 ( V_22 , L_43 , V_39 ) ;
V_39 = F_211 ( V_22 , V_291 ) ;
if ( V_39 )
...
{
struct V_206 * V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
struct V_54 * V_296 = V_207 -> V_63 -> V_101 ;
struct V_182 * V_183 ;
int V_39 ;
V_183 = F_169 ( V_22 -> V_292 , 0 , 0 ,
V_203 ) ;
...
F_212 ( V_183 -> V_208 , 0 , V_242 ,
V_22 -> V_297 -> V_298 , 0 , V_295 ) ;
F_161 ( V_183 ) ;
if ( V_295 )
...
T_5 V_260 ;
int V_39 ;
V_260 = ( T_5 ) F_196 ( 0 , V_306 ) ;
V_169 = F_201 ( V_260 , V_59 ) ;
if ( F_30 ( V_169 ) )
return F_202 ( V_169 ) ;
V_39 = - V_57 ;
V_183 = F_169 ( V_243 , 0 , V_306 ,
V_205 ) ;
if ( ! V_183 )
goto V_49;
V_183 -> V_169 = V_169 ;
...
if ( ! V_183 -> V_208 )
goto V_49;
F_198 ( V_183 -> V_208 , 0 , V_240 ,
V_301 , V_302 ) ;
if ( V_304 ) {
struct V_307 * V_308 ;
V_308 = F_26 ( sizeof ( * V_308 ) , V_309 ) ;
if ( ! V_308 )
goto V_49;
F_222 ( V_308 ) ;
F_223 ( V_308 , V_303 , V_304 ) ;
F_224 ( V_183 -> V_208 , 0 ,
V_308 ) ;
}
F_225 ( V_183 -> V_208 , 0 ,
...
F_226 ( V_169 , V_305 , 0 , V_183 -> V_213 ) ;
V_49:
if ( V_183 )
F_118 ( V_183 ) ;
else
...
static void F_227 ( struct V_310 * V_311 )
{
struct V_312 * V_265 = F_228 ( V_311 ) ;
struct V_21 * V_22 = V_265 -> V_313 -> V_314 ;
struct V_194 * V_185 ;
struct V_105 * V_113 = NULL ;
V_107 V_146 = ( V_107 ) F_229 ( V_265 ) << V_103 ;
V_107 V_152 = F_230 ( V_265 ) ;
enum V_87 V_88 ;
V_107 V_315 ;
int V_212 ;
if ( V_265 -> V_316 != V_317 ) {
F_25 ( L_46 , V_58 ,
( int ) V_265 -> V_316 ) ;
V_212 = - V_132 ;
goto V_318;
}
if ( V_265 -> V_319 & V_320 )
V_88 = V_91 ;
else if ( V_265 -> V_319 & V_321 )
V_88 = V_90 ;
else
V_88 = V_89 ;
if ( ! V_152 ) {
...
F_231 ( V_265 ) ;
F_178 ( & V_22 -> V_263 ) ;
V_315 = V_22 -> V_27 . V_97 ;
if ( V_88 != V_89 ) {
V_113 = V_22 -> V_110 . V_113 ;
F_232 ( V_113 ) ;
}
F_179 ( & V_22 -> V_263 ) ;
if ( V_146 + V_152 > V_315 ) {
...
static int F_234 ( struct V_326 * V_327 ,
const struct V_328 * V_329 )
{
struct V_312 * V_265 = V_329 -> V_265 ;
struct V_310 * V_311 = F_235 ( V_265 ) ;
F_236 ( V_330 , V_311 ) ;
return V_331 ;
}
static void F_237 ( struct V_21 * V_22 )
{
...
F_14 ( & V_22 -> V_30 ) ;
if ( ! V_25 ) {
V_97 = ( T_10 ) V_22 -> V_27 . V_97 / V_337 ;
F_25 ( L_54 , ( unsigned long long ) V_97 ) ;
F_246 ( V_22 -> V_36 , V_97 ) ;
F_247 ( V_22 -> V_36 ) ;
}
}
...
V_49:
F_251 ( & V_22 -> V_263 ) ;
if ( ! V_39 && V_315 != V_22 -> V_27 . V_97 )
F_245 ( V_22 ) ;
return V_39 ;
}
static int F_252 ( void * V_294 , struct V_312 * V_265 ,
...
static int F_254 ( struct V_21 * V_22 )
{
struct V_35 * V_36 ;
struct V_341 * V_313 ;
V_107 V_151 ;
...
if ( ! V_36 )
return - V_57 ;
snprintf ( V_36 -> V_343 , sizeof( V_36 -> V_343 ) , V_344 L_55 ,
V_22 -> V_5 ) ;
V_36 -> V_345 = V_22 -> V_345 ;
V_36 -> V_346 = V_22 -> V_7 ;
if ( V_13 )
V_36 -> V_32 |= V_347 ;
V_36 -> V_348 = & V_349 ;
V_36 -> V_24 = V_22 ;
memset ( & V_22 -> V_334 , 0 , sizeof( V_22 -> V_334 ) ) ;
V_22 -> V_334 . V_350 = & V_351 ;
V_22 -> V_334 . V_84 = V_22 -> V_296 -> V_84 ;
V_22 -> V_334 . V_340 = V_352 ;
V_22 -> V_334 . V_32 = V_353 | V_354 ;
V_22 -> V_334 . V_355 = 1 ;
V_22 -> V_334 . V_356 = sizeof( struct V_310 ) ;
V_318 = F_256 ( & V_22 -> V_334 ) ;
if ( V_318 )
goto V_357;
V_313 = F_257 ( & V_22 -> V_334 ) ;
if ( F_30 ( V_313 ) ) {
V_318 = F_202 ( V_313 ) ;
goto V_358;
}
...
F_259 ( V_313 , V_151 / V_337 ) ;
V_313 -> V_360 . V_361 = F_260 ( V_313 ) ;
F_261 ( V_313 , V_151 / V_337 ) ;
F_262 ( V_313 , V_151 ) ;
F_263 ( V_313 , V_151 ) ;
F_264 ( V_313 , V_151 ) ;
F_258 ( V_362 , V_313 ) ;
V_313 -> V_360 . V_363 = V_151 ;
V_313 -> V_360 . V_364 = V_151 ;
F_265 ( V_313 , V_151 / V_337 ) ;
V_313 -> V_360 . V_365 = 1 ;
if ( ! F_266 ( V_22 -> V_53 -> V_63 , V_366 ) )
V_313 -> V_367 . V_368 |= V_369 ;
V_36 -> V_333 = V_313 ;
V_313 -> V_314 = V_22 ;
V_22 -> V_36 = V_36 ;
return 0 ;
...
static struct V_21 * F_267 ( struct V_17 * V_18 )
{
return F_53 ( V_18 , struct V_21 , V_18 ) ;
}
static T_11 F_268 ( struct V_17 * V_18 ,
struct V_370 * V_11 , char * V_163 )
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_56 ,
...
struct V_21 * V_22 = F_267 ( V_18 ) ;
if ( V_22 -> V_345 )
return sprintf ( V_163 , L_58 , V_22 -> V_345 ) ;
return sprintf ( V_163 , L_59 ) ;
}
static T_11 F_271 ( struct V_17 * V_18 ,
struct V_370 * V_11 , char * V_163 )
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_58 , V_22 -> V_7 ) ;
}
...
F_273 ( V_22 -> V_53 -> V_63 ) ) ;
}
static T_11 F_274 ( struct V_17 * V_18 ,
struct V_370 * V_11 , char * V_163 )
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_61 , V_22 -> V_45 -> V_371 ) ;
}
...
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_56 ,
( unsigned long long ) V_22 -> V_45 -> V_372 ) ;
}
...
struct V_21 * V_22 = F_267 ( V_18 ) ;
if ( V_22 -> V_45 -> V_373 )
return sprintf ( V_163 , L_61 , V_22 -> V_45 -> V_373 ) ;
...
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_61 , V_22 -> V_45 -> V_374 ) ;
}
...
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_61 , V_22 -> V_45 -> V_134 ) ;
}
...
for ( ; V_22 -> V_270 ; V_22 = V_22 -> V_270 ) {
struct V_376 * V_45 = V_22 -> V_261 ;
V_375 += sprintf ( & V_163 [ V_375 ] , L_64
L_65
L_66
L_67
L_68 ,
! V_375 ? L_69 : L_70 ,
V_45 -> V_372 , V_45 -> V_371 ,
V_45 -> V_374 , V_45 -> V_373 ? : L_71 ,
...
static struct V_376 * F_281 ( struct V_376 * V_45 )
{
F_40 ( & V_45 -> V_61 ) ;
return V_45 ;
}
static void F_175 ( struct V_376 * V_45 )
{
if ( V_45 )
F_56 ( & V_45 -> V_61 , V_377 ) ;
}
static struct V_376 * F_282 ( void )
{
struct V_376 * V_45 ;
V_45 = F_283 ( sizeof ( * V_45 ) , V_59 ) ;
if ( ! V_45 )
return NULL ;
V_45 -> V_372 = V_378 ;
V_45 -> V_46 = V_47 ;
...
static void V_377 ( struct V_61 * V_61 )
{
struct V_376 * V_45 = F_53 ( V_61 , struct V_376 , V_61 ) ;
F_36 ( V_45 -> V_371 ) ;
F_36 ( V_45 -> V_374 ) ;
F_36 ( V_45 -> V_373 ) ;
F_36 ( V_45 -> V_134 ) ;
...
F_28 ( & V_22 -> V_62 ) ;
F_288 ( & V_22 -> V_263 ) ;
V_22 -> V_18 . V_381 = & V_382 ;
V_22 -> V_18 . type = & V_383 ;
V_22 -> V_18 . V_270 = & V_384 ;
F_289 ( & V_22 -> V_18 ) ;
V_22 -> V_53 = V_56 ;
V_22 -> V_45 = V_45 ;
V_22 -> V_296 = V_296 ;
V_22 -> V_256 . V_385 = F_290 ( 1 << V_386 ) ;
V_22 -> V_256 . V_387 = F_290 ( 1 ) ;
V_22 -> V_256 . V_388 = F_290 ( 1 << V_386 ) ;
V_22 -> V_256 . V_389 = F_290 ( ( T_5 ) V_45 -> V_372 ) ;
if ( V_22 -> V_296 )
F_291 ( V_380 ) ;
return V_22 ;
}
...
{
V_106 V_390 = F_293 ( V_46 ) ;
int V_39 ;
struct {
T_9 V_102 ;
V_106 V_97 ;
} V_391 ( ( V_392 ) ) V_393 = { 0 } ;
V_39 = F_221 ( V_22 , V_22 -> V_292 ,
L_39 , L_72 ,
& V_390 , sizeof ( V_390 ) ,
& V_393 , sizeof ( V_393 ) ) ;
F_25 ( L_73 , V_58 , V_39 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( V_39 < sizeof ( V_393 ) )
return - V_394 ;
if ( V_102 ) {
* V_102 = V_393 . V_102 ;
F_25 ( L_74 , ( unsigned int ) * V_102 ) ;
}
* V_142 = F_60 ( V_393 . V_97 ) ;
F_25 ( L_75 ,
...
goto V_49;
V_396 = V_395 ;
V_22 -> V_110 . V_112 = F_296 ( & V_396 ,
V_396 + V_39 , NULL , V_149 ) ;
V_39 = 0 ;
if ( F_30 ( V_22 -> V_110 . V_112 ) ) {
V_39 = F_202 ( V_22 -> V_110 . V_112 ) ;
V_22 -> V_110 . V_112 = NULL ;
} else {
F_25 ( L_77 , V_22 -> V_110 . V_112 ) ;
}
V_49:
F_36 ( V_395 ) ;
return V_39 ;
...
if ( V_39 < 0 )
return V_39 ;
if ( V_39 < sizeof ( V_399 ) )
return - V_394 ;
V_398 = F_60 ( V_399 . V_398 ) ;
if ( V_398 & ~ V_400 )
return - V_324 ;
* V_143 = F_60 ( V_399 . V_131 ) ;
F_25 ( L_79 ,
( unsigned long long ) V_46 ,
( unsigned long long ) * V_143 ,
( unsigned long long ) F_60 ( V_399 . V_398 ) ) ;
return 0 ;
}
...
sizeof ( V_106 ) +
sizeof ( V_106 ) ;
V_395 = F_26 ( V_97 , V_59 ) ;
if ( ! V_395 ) {
V_39 = - V_57 ;
goto V_118;
}
V_390 = F_293 ( V_22 -> V_45 -> V_46 ) ;
V_39 = F_221 ( V_22 , V_22 -> V_292 ,
L_39 , L_80 ,
& V_390 , sizeof ( V_390 ) ,
V_395 , V_97 ) ;
...
V_39 = - V_132 ;
if ( V_372 > ( V_107 ) V_403 ) {
F_103 ( NULL , L_82 ,
( unsigned long long ) V_372 , V_403 ) ;
goto V_118;
}
V_374 = F_296 ( & V_396 , V_170 , NULL , V_59 ) ;
if ( F_30 ( V_374 ) ) {
V_39 = F_202 ( V_374 ) ;
goto V_118;
}
F_298 ( & V_396 , V_170 , V_46 , V_118 ) ;
F_298 ( & V_396 , V_170 , V_401 , V_118 ) ;
if ( ! V_22 -> V_261 ) {
V_261 -> V_372 = V_372 ;
V_261 -> V_374 = V_374 ;
V_261 -> V_46 = V_46 ;
...
return - V_394 ;
V_39 = - V_4 ;
V_405 = ( V_107 ) 1 << V_22 -> V_110 . V_126 ;
V_396 = & V_404 ;
V_129 = F_301 ( & V_396 ) ;
if ( V_129 != V_405 ) {
F_103 ( V_22 , L_86
...
static char * F_302 ( struct V_21 * V_22 )
{
T_6 V_406 ;
char * V_374 ;
void * V_396 ;
...
char * V_373 = NULL ;
int V_39 ;
F_17 ( ! V_22 -> V_45 -> V_373 ) ;
V_117 = strlen ( V_22 -> V_45 -> V_374 ) ;
V_406 = sizeof ( V_287 ) + V_117 ;
V_374 = F_26 ( V_406 , V_59 ) ;
if ( ! V_374 )
return NULL ;
V_396 = V_374 ;
V_170 = V_374 + V_406 ;
F_303 ( & V_396 , V_170 , V_22 -> V_45 -> V_374 , ( T_5 ) V_117 ) ;
V_97 = sizeof ( V_287 ) + V_407 ;
V_395 = F_26 ( V_97 , V_59 ) ;
if ( ! V_395 )
goto V_49;
V_39 = F_221 ( V_22 , V_408 ,
L_39 , L_90 ,
V_374 , V_406 ,
V_395 , V_97 ) ;
if ( V_39 < 0 )
...
V_396 = V_395 ;
V_170 = V_395 + V_39 ;
V_373 = F_296 ( & V_396 , V_170 , & V_117 , V_59 ) ;
if ( F_30 ( V_373 ) )
V_373 = NULL ;
else
F_25 ( L_91 , V_58 , V_373 , V_117 ) ;
V_49:
F_36 ( V_395 ) ;
F_36 ( V_374 ) ;
return V_373 ;
}
static V_107 F_304 ( struct V_21 * V_22 , const char * V_144 )
{
struct V_105 * V_113 = V_22 -> V_110 . V_113 ;
const char * V_134 ;
T_5 V_133 = 0 ;
...
{
if ( V_22 -> V_94 == 1 )
return F_304 ( V_22 , V_144 ) ;
return F_305 ( V_22 , V_144 ) ;
}
static int F_307 ( struct V_21 * V_22 )
{
struct V_376 * V_45 = V_22 -> V_45 ;
F_17 ( V_45 -> V_372 != V_378 && V_45 -> V_371 ) ;
F_17 ( V_45 -> V_374 && V_45 -> V_373 ) ;
F_17 ( V_45 -> V_134 ) ;
if ( strcmp ( V_45 -> V_134 , V_141 ) ) {
V_107 V_46 ;
V_46 = F_306 ( V_22 , V_45 -> V_134 ) ;
if ( V_46 == V_47 )
return - V_34 ;
V_45 -> V_46 = V_46 ;
} else {
...
const char * V_134 ;
int V_39 ;
F_17 ( V_45 -> V_372 != V_378 ) ;
F_17 ( V_45 -> V_374 ) ;
F_17 ( V_45 -> V_46 != V_47 ) ;
V_371 = F_309 ( V_207 -> V_409 , V_45 -> V_372 ) ;
if ( ! V_371 ) {
F_103 ( V_22 , L_92 , V_45 -> V_372 ) ;
return - V_132 ;
}
V_371 = F_66 ( V_371 , V_59 ) ;
if ( ! V_371 )
return - V_57 ;
V_373 = F_302 ( V_22 ) ;
if ( ! V_373 )
...
struct V_105 * V_113 ;
T_5 V_116 ;
V_97 = sizeof ( V_106 ) + sizeof ( V_287 ) +
V_410 * sizeof ( V_106 ) ;
V_395 = F_283 ( V_97 , V_59 ) ;
if ( ! V_395 )
return - V_57 ;
V_39 = F_221 ( V_22 , V_22 -> V_292 ,
L_39 , L_94 , NULL , 0 ,
...
V_170 = V_395 + V_39 ;
V_39 = - V_394 ;
F_298 ( & V_396 , V_170 , V_119 , V_49 ) ;
F_311 ( & V_396 , V_170 , V_98 , V_49 ) ;
if ( V_98 > ( V_104 - sizeof ( struct V_105 ) )
/ sizeof ( V_107 ) ) {
V_39 = - V_4 ;
goto V_49;
}
if ( ! F_312 ( & V_396 , V_170 , V_98 * sizeof ( V_106 ) ) )
goto V_49;
V_39 = 0 ;
V_113 = F_63 ( V_98 , V_59 ) ;
if ( ! V_113 ) {
...
V_396 = V_395 ;
V_170 = V_395 + V_39 ;
V_134 = F_296 ( & V_396 , V_170 , NULL , V_59 ) ;
if ( F_30 ( V_134 ) )
goto V_49;
F_25 ( L_97 ,
...
F_318 ( & V_22 -> V_62 ) ;
F_34 ( & V_415 ) ;
F_319 ( & V_413 , V_22 -> V_5 ) ;
F_25 ( L_99 , V_22 , V_22 -> V_5 ) ;
}
static inline T_6 F_320 ( const char * * V_163 )
{
const char * V_417 = L_100 ;
* V_163 += strspn ( * V_163 , V_417 ) ;
return strcspn ( * V_163 , V_417 ) ;
}
static inline char * F_321 ( const char * * V_163 , T_6 * V_418 )
{
char * V_419 ;
T_6 V_117 ;
V_117 = F_320 ( V_163 ) ;
V_419 = F_322 ( * V_163 , V_117 + 1 , V_59 ) ;
if ( ! V_419 )
return NULL ;
* ( V_419 + V_117 ) = '\0' ;
* V_163 += V_117 ;
...
static int F_323 ( const char * V_163 ,
struct V_54 * * V_55 ,
struct V_73 * * V_296 ,
struct V_376 * * V_376 )
{
...
V_134 = F_322 ( V_163 , V_117 + 1 , V_59 ) ;
if ( ! V_134 )
goto V_423;
* ( V_134 + V_117 ) = '\0' ;
V_45 -> V_134 = V_134 ;
V_74 = F_283 ( sizeof ( * V_74 ) , V_59 ) ;
if ( ! V_74 )
goto V_423;
V_74 -> V_28 = V_425 ;
V_74 -> V_84 = V_426 ;
V_422 = F_324 ( V_101 , V_420 ,
V_420 + V_421 - 1 ,
F_44 , V_74 ) ;
if ( F_30 ( V_422 ) ) {
V_39 = F_202 ( V_422 ) ;
...
static int F_325 ( struct V_53 * V_56 , const char * V_371 )
{
struct V_54 * V_296 = V_56 -> V_63 -> V_101 ;
V_107 V_427 ;
int V_428 = 0 ;
int V_39 ;
V_429:
V_39 = F_326 ( V_56 -> V_63 -> V_207 . V_409 , V_371 ) ;
if ( V_39 == - V_34 && V_428 ++ < 1 ) {
V_39 = F_327 ( & V_56 -> V_63 -> V_430 , L_105 ,
& V_427 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( V_56 -> V_63 -> V_207 . V_409 -> V_431 < V_427 ) {
F_328 ( & V_56 -> V_63 -> V_430 ) ;
( void ) F_329 ( & V_56 -> V_63 -> V_430 ,
V_427 ,
V_296 -> V_299 ) ;
goto V_429;
} else {
...
char * V_374 ;
if ( V_22 -> V_45 -> V_374 ) {
V_22 -> V_94 = * V_22 -> V_45 -> V_374 ? 2 : 1 ;
return 0 ;
}
V_97 = sizeof ( V_433 ) + strlen ( V_22 -> V_45 -> V_373 ) ;
V_243 = F_26 ( V_97 , V_149 ) ;
if ( ! V_243 )
return - V_57 ;
sprintf ( V_243 , L_106 , V_433 , V_22 -> V_45 -> V_373 ) ;
F_25 ( L_107 , V_243 ) ;
V_97 = sizeof ( V_287 ) + V_402 ;
V_432 = F_283 ( V_97 , V_149 ) ;
if ( ! V_432 ) {
V_39 = - V_57 ;
goto V_49;
}
V_39 = F_221 ( V_22 , V_243 ,
L_39 , L_108 , NULL , 0 ,
V_432 , V_402 ) ;
F_25 ( L_73 , V_58 , V_39 ) ;
if ( V_39 == - V_34 ) {
V_374 = F_66 ( L_69 , V_59 ) ;
V_39 = V_374 ? 0 : - V_57 ;
if ( ! V_39 )
V_22 -> V_94 = 1 ;
} else if ( V_39 >= 0 ) {
void * V_396 = V_432 ;
V_374 = F_296 ( & V_396 , V_396 + V_39 ,
NULL , V_149 ) ;
V_39 = F_331 ( V_374 ) ;
if ( ! V_39 )
V_22 -> V_94 = 2 ;
...
static int F_333 ( struct V_21 * V_22 , int V_435 )
{
struct V_21 * V_270 = NULL ;
int V_39 ;
if ( ! V_22 -> V_261 )
return 0 ;
if ( ++ V_435 > V_436 ) {
...
V_270 = F_286 ( V_22 -> V_53 , V_22 -> V_261 ,
NULL ) ;
if ( ! V_270 ) {
V_39 = - V_57 ;
goto V_118;
...
static int F_335 ( struct V_21 * V_22 )
{
int V_39 ;
V_39 = F_315 ( V_22 ) ;
if ( V_39 )
...
F_336 ( V_437
< sizeof ( V_344 ) + V_438 ) ;
sprintf ( V_22 -> V_144 , L_111 , V_344 , V_22 -> V_5 ) ;
if ( ! V_13 ) {
V_39 = F_337 ( 0 , V_22 -> V_144 ) ;
if ( V_39 < 0 )
goto V_439;
V_22 -> V_345 = V_39 ;
V_22 -> V_7 = 0 ;
...
if ( V_39 )
goto V_442;
F_246 ( V_22 -> V_36 , V_22 -> V_27 . V_97 / V_337 ) ;
F_21 ( V_22 -> V_36 , V_22 -> V_27 . V_28 ) ;
F_338 ( & V_22 -> V_18 , L_55 , V_22 -> V_5 ) ;
V_39 = F_339 ( & V_22 -> V_18 ) ;
if ( V_39 )
goto V_443;
F_111 ( V_323 , & V_22 -> V_32 ) ;
F_340 ( V_22 -> V_36 ) ;
F_299 ( L_112 , V_22 -> V_36 -> V_343 ,
( unsigned long long ) V_22 -> V_27 . V_97 ) ;
return V_39 ;
V_443:
F_77 ( V_22 ) ;
...
V_441:
if ( ! V_13 )
F_341 ( V_22 -> V_345 , V_22 -> V_144 ) ;
V_439:
F_317 ( V_22 ) ;
return V_39 ;
}
static int F_342 ( struct V_21 * V_22 )
{
struct V_376 * V_45 = V_22 -> V_45 ;
T_6 V_97 ;
F_17 ( F_57 ( V_22 -> V_94 ) ) ;
if ( V_22 -> V_94 == 1 )
V_97 = strlen ( V_45 -> V_373 ) + sizeof ( V_444 ) ;
else
V_97 = sizeof ( V_445 ) + strlen ( V_45 -> V_374 ) ;
V_22 -> V_292 = F_26 ( V_97 , V_59 ) ;
if ( ! V_22 -> V_292 )
return - V_57 ;
if ( V_22 -> V_94 == 1 )
sprintf ( V_22 -> V_292 , L_106 ,
V_45 -> V_373 , V_444 ) ;
else
sprintf ( V_22 -> V_292 , L_106 ,
V_445 , V_45 -> V_374 ) ;
...
static void F_343 ( struct V_21 * V_22 )
{
F_332 ( V_22 ) ;
F_36 ( V_22 -> V_292 ) ;
V_22 -> V_292 = NULL ;
V_22 -> V_94 = 0 ;
F_36 ( V_22 -> V_45 -> V_374 ) ;
V_22 -> V_45 -> V_374 = NULL ;
F_292 ( V_22 ) ;
}
static int F_334 ( struct V_21 * V_22 , int V_435 )
{
int V_39 ;
V_39 = F_330 ( V_22 ) ;
if ( V_39 )
...
V_39 = F_333 ( V_22 , V_435 ) ;
if ( V_39 )
goto V_449;
F_25 ( L_116 ,
V_22 -> V_94 , V_22 -> V_292 ) ;
return 0 ;
V_449:
F_332 ( V_22 ) ;
V_448:
...
static T_11 F_344 ( struct V_451 * V_381 ,
const char * V_163 ,
T_6 V_375 )
{
struct V_21 * V_22 = NULL ;
...
if ( ! F_345 ( V_380 ) )
return - V_453 ;
V_452 = F_323 ( V_163 , & V_55 , & V_74 , & V_45 ) ;
if ( V_452 < 0 )
goto V_49;
V_56 = F_49 ( V_55 ) ;
if ( F_30 ( V_56 ) ) {
...
V_452 = F_325 ( V_56 , V_45 -> V_371 ) ;
if ( V_452 < 0 ) {
if ( V_452 == - V_34 )
F_299 ( L_117 , V_45 -> V_371 ) ;
goto V_455;
}
V_45 -> V_372 = ( V_107 ) V_452 ;
if ( V_45 -> V_372 > ( V_107 ) V_403 ) {
F_103 ( NULL , L_118 ,
( unsigned long long ) V_45 -> V_372 , V_403 ) ;
V_452 = - V_132 ;
goto V_455;
}
...
static T_11 F_346 ( struct V_451 * V_381 ,
const char * V_163 ,
T_6 V_375 )
{
if ( V_13 )
return - V_4 ;
return F_344 ( V_381 , V_163 , V_375 ) ;
}
static T_11 F_347 ( struct V_451 * V_381 ,
const char * V_163 ,
T_6 V_375 )
{
return F_344 ( V_381 , V_163 , V_375 ) ;
}
static void F_348 ( struct V_21 * V_22 )
{
F_237 ( V_22 ) ;
F_142 ( V_323 , & V_22 -> V_32 ) ;
F_349 ( & V_22 -> V_18 ) ;
...
{
while ( V_22 -> V_270 ) {
struct V_21 * V_457 = V_22 ;
struct V_21 * V_458 = V_457 -> V_270 ;
struct V_21 * V_459 ;
while ( V_458 && ( V_459 = V_458 -> V_270 ) ) {
V_457 = V_458 ;
V_458 = V_459 ;
}
F_17 ( V_458 ) ;
...
static T_11 F_350 ( struct V_451 * V_381 ,
const char * V_163 ,
T_6 V_375 )
{
struct V_21 * V_22 = NULL ;
...
V_39 = - V_34 ;
F_32 ( & V_415 ) ;
F_352 (tmp, &rbd_dev_list) {
V_22 = F_353 ( V_156 , struct V_21 , V_62 ) ;
if ( V_22 -> V_5 == V_5 ) {
V_39 = 0 ;
break;
}
...
F_220 ( V_22 ) ;
F_25 ( L_119 , V_58 ) ;
F_354 ( & V_22 -> V_53 -> V_63 -> V_207 ) ;
F_348 ( V_22 ) ;
F_343 ( V_22 ) ;
return V_375 ;
}
static T_11 F_355 ( struct V_451 * V_381 ,
const char * V_163 ,
T_6 V_375 )
{
if ( V_13 )
return - V_4 ;
return F_350 ( V_381 , V_163 , V_375 ) ;
}
static T_11 F_356 ( struct V_451 * V_381 ,
const char * V_163 ,
T_6 V_375 )
{
return F_350 ( V_381 , V_163 , V_375 ) ;
