...
if ( V_39 )
return V_39 ;
V_36 -> V_127 = F_61 ( V_98 , & V_112 -> V_12 , V_36 ) ;
if ( F_58 ( V_36 -> V_127 ) ) {
F_7 ( & V_112 -> V_12 , L_17 ) ;
...
V_153 = F_73 ( V_112 , V_156 , 0 ) ;
if ( V_153 )
V_36 -> V_157 = V_153 -> V_158 ;
...
const T_3 * V_162 = V_58 -> type -> V_78 ;
const T_3 * V_163 = V_58 -> type -> V_75 ;
enum V_81 type ;
if ( ! V_163 [ V_164 ] )
continue;
for ( type = 0 ; type < V_86 ; type ++ )
if ( V_163 [ type ] )
V_58 -> V_165 [ type ] = F_30 ( V_55 + V_162 [ type ] ) ;
if ( V_163 [ V_76 ] * V_58 -> V_62 > 32 ) {
V_58 -> V_165 [ V_86 ] =
F_30 ( V_55 + V_162 [ V_76 ] + 4 ) ;
F_78 ( L_26 ,
V_58 -> V_8 , V_55 ,
V_58 -> V_165 [ V_76 ] ,
V_58 -> V_165 [ V_86 ] ) ;
...
F_78 ( L_28 ,
V_58 -> V_8 , V_55 ,
F_30 ( V_55 + V_162 [ V_76 ] ) ,
F_30 ( V_55 + V_162 [ V_76 ] + 4 ) ,
V_58 -> V_165 [ V_76 ] ,
V_58 -> V_165 [ V_86 ] ) ;
F_31 ( V_58 -> V_165 [ V_86 ] ,
V_55 + V_162 [ V_76 ] + 4 ) ;
} else {
F_78 ( L_29 , V_58 -> V_8 ,
V_55 , F_30 ( V_55 + V_162 [ V_76 ] ) ,
V_58 -> V_165 [ V_76 ] ) ;
}
for ( type = 0 ; type < V_86 ; type ++ )
if ( V_163 [ type ] )
F_31 ( V_58 -> V_165 [ type ] , V_55 + V_162 [ type ] ) ;
}
}
