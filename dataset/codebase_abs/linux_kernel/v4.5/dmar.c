...
V_259 * V_264 ) ;
V_263 = F_175 ( V_263 ) ;
F_119 ( V_265 , V_74 -> V_146 + V_146 +
V_259 * V_264 + 12 ) ;
F_122 ( & V_74 -> V_175 , V_250 ) ;
F_168 ( V_74 , type , V_240 ,
V_256 , V_263 ) ;
V_259 ++ ;
if ( V_259 >= F_176 ( V_74 -> V_132 ) )
V_259 = 0 ;
F_121 ( & V_74 -> V_175 , V_250 ) ;
}
F_119 ( V_266 | V_261 , V_74 -> V_146 + V_196 ) ;
V_262:
F_122 ( & V_74 -> V_175 , V_250 ) ;
return V_267 ;
}
int F_177 ( struct V_145 * V_74 )
{
int V_179 , V_54 ;
if ( V_74 -> V_179 )
return 0 ;
V_179 = F_178 ( V_74 -> V_156 , V_74 -> V_86 , V_74 ) ;
if ( V_179 > 0 ) {
V_74 -> V_179 = V_179 ;
} else {
F_71 ( L_53 ) ;
...
V_54 = F_179 ( V_179 , F_169 , V_268 , V_74 -> V_152 , V_74 ) ;
if ( V_54 )
F_71 ( L_54 ) ;
return V_54 ;
}
...
F_186 ( & V_126 , & V_127 ) ;
F_36 ( & V_66 ) ;
F_187 (dmaru, dmaru_n, &dmar_drhd_units, list) {
F_188 ( & V_55 -> V_4 ) ;
F_42 ( V_55 ) ;
}
F_37 ( & V_66 ) ;
...
static inline bool F_189 ( T_6 V_271 , int V_272 )
{
return F_190 ( V_271 , V_273 , V_274 , 1 << V_272 ) ;
}
static int F_191 ( T_6 V_271 , int V_272 ,
...
if ( ! F_189 ( V_271 , V_272 ) )
return 0 ;
V_277 = F_192 ( V_271 , V_273 , V_274 ,
V_272 , NULL , V_283 ) ;
if ( ! V_277 )
return - V_118 ;
...
if ( ! V_55 )
return - V_118 ;
V_54 = F_195 ( V_55 , true ) ;
if ( V_54 == 0 )
V_54 = F_196 ( V_55 , true ) ;
return V_54 ;
}
static int F_197 ( struct V_70 * V_58 , void * V_71 )
{
int V_21 , V_54 ;
struct V_22 * V_26 ;
struct V_1 * V_55 ;
...
return - V_153 ;
V_54 = F_195 ( V_55 , false ) ;
if ( V_54 == 0 )
V_54 = F_196 ( V_55 , false ) ;
return V_54 ;
}
static int F_198 ( struct V_70 * V_58 , void * V_71 )
{
struct V_1 * V_55 ;
V_55 = F_38 ( (struct V_56 * ) V_58 ) ;
if ( V_55 ) {
...
static int F_200 ( T_6 V_271 )
{
int V_54 ;
int V_115 = 0 ;
V_54 = F_191 ( V_271 , V_280 ,
& F_80 , ( void * ) 1 ) ;
if ( V_54 )
goto V_72;
V_54 = F_191 ( V_271 , V_280 ,
...
V_54 = F_191 ( V_271 , V_282 ,
& F_48 , NULL ) ;
if ( V_54 )
goto V_286;
V_54 = F_191 ( V_271 , V_281 ,
& V_117 , NULL ) ;
if ( V_54 )
goto V_287;
V_54 = F_191 ( V_271 , V_280 ,
...
& F_197 , NULL ) ;
if ( V_54 == 0 ) {
F_202 ( F_191 ( V_271 , V_281 ,
& V_288 , NULL ) ) ;
F_202 ( F_191 ( V_271 , V_280 ,
& F_198 , NULL ) ) ;
} else {
F_191 ( V_271 , V_280 ,
& F_194 , NULL ) ;
...
static T_4 F_203 ( T_6 V_271 , T_10 V_290 ,
void * V_291 , void * * V_292 )
{
T_6 * V_293 = V_292 ;
if ( F_189 ( V_271 , V_280 ) ) {
* V_293 = V_271 ;
return V_294 ;
}
return V_99 ;
}
static int F_204 ( T_6 V_271 , bool V_295 )
{
int V_54 ;
T_6 V_30 = NULL ;
T_4 V_98 ;
...
int F_207 ( T_6 V_271 )
{
return F_204 ( V_271 , true ) ;
}
int F_208 ( T_6 V_271 )
{
return F_204 ( V_271 , false ) ;
}
