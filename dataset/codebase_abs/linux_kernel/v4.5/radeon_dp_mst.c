...
int V_63 ;
V_92 = V_12 -> V_45 -> V_93 ;
V_63 = F_77 ( & V_12 -> V_45 -> V_18 ,
V_92 -> V_121 , V_116 -> clock ,
& V_92 -> V_122 ,
& V_92 -> V_90 ) ;
if ( V_63 ) {
V_92 -> V_122 = 0 ;
...
F_7 ( L_15 , V_92 ,
V_92 -> V_122 , V_92 -> V_90 ) ;
}
return true ;
}
static void F_78 ( struct V_72 * V_86 )
{
struct V_38 * V_38 ;
struct V_9 * V_9 , * V_10 ;
struct V_11 * V_12 ;
...
static void
F_79 ( struct V_72 * V_86 ,
struct V_65 * V_66 ,
struct V_65 * V_116 )
{
F_7 ( L_6 ) ;
}
static void F_80 ( struct V_72 * V_86 )
{
F_58 ( V_86 , V_103 ) ;
F_7 ( L_6 ) ;
}
void F_81 ( struct V_72 * V_86 )
{
F_31 ( V_86 ) ;
F_32 ( V_86 ) ;
}
...
int
F_84 ( struct V_38 * V_38 )
{
struct V_16 * V_17 = V_38 -> V_18 . V_17 ;
if ( ! V_38 -> V_134 -> V_135 )
return 0 ;
V_38 -> V_52 . V_136 = & V_137 ;
return F_85 ( & V_38 -> V_52 , V_17 -> V_17 ,
& V_38 -> V_134 -> V_138 , 16 , 6 ,
V_38 -> V_18 . V_18 . V_1 ) ;
}
int
F_86 ( struct V_38 * V_38 )
{
...
if ( ! F_59 ( V_20 ) )
return 0 ;
if ( V_92 -> V_121 [ V_141 ] < 0x12 )
return 0 ;
V_63 = F_87 ( & V_38 -> V_134 -> V_138 , V_142 , V_139 ,
1 ) ;
if ( V_63 ) {
if ( V_139 [ 0 ] & V_143 ) {
F_7 ( L_19 ) ;
...
int V_63 = 0 ;
bool V_148 ;
V_147 = F_87 ( & V_38 -> V_134 -> V_138 ,
V_149 , V_146 , 8 ) ;
V_150:
if ( V_147 == 8 ) {
F_7 ( L_21 , V_146 [ 0 ] , V_146 [ 1 ] , V_146 [ 2 ] ) ;
V_63 = F_90 ( & V_38 -> V_52 , V_146 , & V_148 ) ;
if ( V_148 ) {
for ( V_145 = 0 ; V_145 < 3 ; V_145 ++ ) {
int V_151 ;
V_151 = F_91 ( & V_38 -> V_134 -> V_138 ,
V_149 + 1 , & V_146 [ 1 ] , 3 ) ;
if ( V_151 == 3 )
break;
}
...
static int F_92 ( struct V_153 * V_154 , void * V_155 )
{
...
if ( ! V_92 -> V_144 )
continue;
F_93 ( V_154 , & V_38 -> V_52 ) ;
for ( V_42 = 0 ; V_42 < V_38 -> V_55 ; V_42 ++ )
F_94 ( V_154 , L_24 , V_42 ,
V_38 -> V_54 [ V_42 ] . V_28 ,
V_38 -> V_54 [ V_42 ] . V_32 ) ;
}
F_46 ( V_17 ) ;
...
int F_95 ( struct V_19 * V_20 )
{
#if F_96 ( V_161 )
return F_97 ( V_20 , V_162 , 1 ) ;
#endif
return 0 ;
}
