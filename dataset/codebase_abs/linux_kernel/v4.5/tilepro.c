...
static int F_138 ( struct V_56 * V_39 , struct V_244 * V_245 , int V_205 )
{
return - V_246 ;
}
static struct V_247 * F_139 ( struct V_56 * V_39 ,
struct V_247 * V_85 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
...
static int F_142 ( struct V_56 * V_39 , int V_256 )
{
F_74 ( L_39 ) ;
...
static int F_143 ( struct V_56 * V_39 , void * V_259 )
{
struct V_260 * V_261 = V_259 ;
if ( ! F_144 ( V_261 -> V_262 ) )
return - V_263 ;
memcpy ( V_39 -> V_97 , V_261 -> V_262 , V_39 -> V_264 ) ;
return 0 ;
}
static int F_145 ( struct V_56 * V_39 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
char V_265 [ 32 ] ;
int V_3 ;
...
V_59 -> V_118 = F_146 ( ( V_119 ) V_265 , 0 ) ;
F_74 ( L_42 ,
...
static struct V_56 * F_151 ( const char * V_137 )
{
int V_115 ;
struct V_56 * V_39 ;
struct V_58 * V_59 ;
V_39 = F_152 ( sizeof( * V_59 ) , V_137 , V_285 ,
F_149 ) ;
if ( ! V_39 ) {
F_64 ( L_47 , V_137 ) ;
return NULL ;
...
V_59 -> V_39 = V_39 ;
F_153 ( & V_59 -> V_165 , F_100 ) ;
F_154 ( & V_59 -> V_63 ) ;
V_59 -> V_123 = F_155 ( V_286 | V_287 , V_124 ) ;
if ( ! V_59 -> V_123 ) {
F_156 ( V_39 ) ;
return NULL ;
}
V_59 -> V_49 = F_157 ( V_59 -> V_123 ) ;
V_115 = F_158 ( V_39 ) ;
if ( V_115 ) {
F_64 ( L_48 , V_39 -> V_137 , V_115 ) ;
F_159 ( V_59 -> V_123 , V_124 ) ;
F_156 ( V_39 ) ;
return NULL ;
}
V_115 = F_145 ( V_39 ) ;
...
static int T_20 F_163 ( char * V_290 )
{
int V_291 = F_164 ( V_290 , & V_132 ) ;
if ( V_291 != 0 ) {
F_71 ( L_50 , V_290 ) ;
} else {
F_165 ( & V_132 , & V_132 ,
