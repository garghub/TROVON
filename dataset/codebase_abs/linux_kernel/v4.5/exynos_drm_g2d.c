...
V_199 = (struct V_198 * ) ( unsigned long ) V_197 -> V_199 ;
...
struct V_198 * V_218 ;
V_218 = (struct V_198 * )
( unsigned long ) V_197 -> V_218 ;
if ( F_54 ( V_25 -> V_40 + V_25 -> V_41 ,
( void V_142 * ) V_218 ,
sizeof( * V_218 ) * V_197 -> V_215 ) ) {
V_11 = - V_77 ;
goto V_217;
}
...
V_25 -> V_40 [ V_25 -> V_41 ++ ] = V_220 ;
V_25 -> V_40 [ V_25 -> V_41 ++ ] = V_221 ;
V_25 -> V_222 = V_25 -> V_41 / 2 ;
V_25 -> V_40 [ V_25 -> V_41 ] = 0 ;
F_19 ( V_35 , V_6 ) ;
return 0 ;
V_219:
...
static int F_92 ( struct V_228 * V_229 )
{
struct V_3 * V_4 = & V_229 -> V_4 ;
struct V_230 * V_231 ;
struct V_1 * V_2 ;
struct V_8 * V_9 ;
int V_11 ;
...
F_100 ( V_4 ) ;
V_231 = F_101 ( V_229 , V_235 , 0 ) ;
V_2 -> V_147 = F_102 ( V_4 , V_231 ) ;
if ( F_26 ( V_2 -> V_147 ) ) {
V_11 = F_99 ( V_2 -> V_147 ) ;
goto V_236;
}
V_2 -> V_169 = F_103 ( V_229 , 0 ) ;
if ( V_2 -> V_169 < 0 ) {
F_5 ( V_4 , L_23 ) ;
V_11 = V_2 -> V_169 ;
goto V_236;
