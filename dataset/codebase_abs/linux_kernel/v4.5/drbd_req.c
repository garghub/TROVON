...
V_59 = F_37 ( V_4 -> V_5 ) ;
V_60 = ( V_36 & V_45 ) || ( V_36 & V_44 ) ;
error = F_38 ( V_4 -> V_65 ) ;
if ( V_59 == V_16 &&
V_4 -> V_18 == F_18 ( & F_39 ( V_2 ) -> V_51 -> V_55 ) )
F_31 ( F_39 ( V_2 ) -> V_51 ) ;
F_4 ( V_2 , V_4 ) ;
if ( ! V_60 && V_59 == V_66 && ! F_40 ( & V_4 -> V_25 ) )
V_4 -> V_15 |= V_37 ;
if ( ! ( V_4 -> V_15 & V_37 ) ) {
V_57 -> error = V_60 ? 0 : ( error ? : - V_67 ) ;
V_57 -> V_11 = V_4 -> V_5 ;
V_4 -> V_5 = NULL ;
V_4 -> V_6 . V_68 = true ;
}
...
static int F_41 ( struct V_3 * V_4 , struct V_56 * V_57 , int V_69 )
{
struct V_1 * V_2 = V_4 -> V_2 ;
F_42 ( V_2 , V_57 || ( V_4 -> V_15 & V_37 ) ) ;
if ( ! F_43 ( V_69 , & V_4 -> V_30 ) )
return 0 ;
F_36 ( V_4 , V_57 ) ;
if ( V_4 -> V_15 & V_37 ) {
F_44 ( V_4 ) ;
...
{
struct V_50 * V_51 = V_71 ? V_71 -> V_51 : NULL ;
if ( ! V_51 )
return;
if ( V_51 -> V_72 == NULL )
V_51 -> V_72 = V_4 ;
...
int V_79 = 0 ;
int V_80 = 0 ;
if ( F_53 ( V_2 ) && ! ( ( V_36 | V_77 ) & V_64 ) )
V_78 |= V_64 ;
V_4 -> V_15 &= ~ V_77 ;
V_4 -> V_15 |= V_78 ;
if ( V_4 -> V_15 == V_36 )
return;
if ( ! ( V_36 & V_38 ) && ( V_78 & V_38 ) )
F_32 ( & V_4 -> V_30 ) ;
if ( ! ( V_36 & V_63 ) && ( V_78 & V_63 ) ) {
F_54 ( V_2 ) ;
F_32 ( & V_4 -> V_30 ) ;
}
if ( ! ( V_36 & V_62 ) && ( V_78 & V_62 ) ) {
F_32 ( & V_4 -> V_30 ) ;
F_45 ( V_71 , V_4 ) ;
}
if ( ! ( V_36 & V_81 ) && ( V_78 & V_81 ) )
F_55 ( & V_4 -> V_31 ) ;
if ( ! ( V_36 & V_75 ) && ( V_78 & V_75 ) ) {
if ( ! ( V_36 & V_40 ) ) {
...
if ( ! ( V_36 & V_64 ) && ( V_78 & V_64 ) )
F_32 ( & V_4 -> V_30 ) ;
if ( ( V_36 & V_64 ) && ( V_77 & V_64 ) )
++ V_79 ;
if ( ! ( V_36 & V_61 ) && ( V_78 & V_61 ) ) {
...
if ( V_80 || V_79 ) {
int V_86 = V_80 + ! ! V_79 ;
int V_87 = F_18 ( & V_4 -> V_31 . V_87 ) ;
if ( V_87 < V_86 )
F_19 ( V_2 ,
L_7 ,
V_36 , V_4 -> V_15 , V_87 , V_86 ) ;
}
if ( V_4 -> V_6 . V_24 )
F_15 ( & V_2 -> V_35 ) ;
if ( V_79 )
V_80 += F_41 ( V_4 , V_57 , V_79 ) ;
if ( V_80 )
F_59 ( & V_4 -> V_31 , V_80 , F_16 ) ;
}
...
struct V_50 * const V_51 = V_71 ? V_71 -> V_51 : NULL ;
struct V_96 * V_97 ;
int V_98 , V_99 = 0 ;
if ( V_57 )
V_57 -> V_11 = NULL ;
...
F_69 ( V_118 , & V_2 -> V_119 ) ;
F_42 ( V_2 , V_4 -> V_15 & V_63 ) ;
F_52 ( V_4 , V_57 , 0 , V_62 | V_81 ) ;
V_4 -> V_26 . V_120 = V_123 ;
F_70 ( & V_51 -> V_52 ,
& V_4 -> V_26 ) ;
F_64 () ;
V_97 = F_65 ( V_51 -> V_96 ) ;
...
case V_128 :
case V_129 :
F_52 ( V_4 , V_57 , V_62 , 0 ) ;
break;
case V_130 :
if ( F_62 ( V_4 ) )
F_52 ( V_4 , V_57 , V_62 | V_63 ,
V_75 | V_44 ) ;
else
F_52 ( V_4 , V_57 , V_62 , V_75 ) ;
break;
case V_131 :
F_52 ( V_4 , V_57 , V_62 , V_40 ) ;
break;
case V_132 :
F_52 ( V_4 , V_57 ,
V_44 | V_63 | V_64 ,
...
goto V_136;
case V_137 :
F_42 ( V_2 , V_4 -> V_15 & V_93 ) ;
V_136:
F_52 ( V_4 , V_57 , V_63 , V_44 ) ;
break;
case V_138 :
F_42 ( V_2 , V_4 -> V_15 & V_92 ) ;
F_42 ( V_2 , V_4 -> V_15 & V_63 ) ;
...
break;
case V_139 :
F_52 ( V_4 , V_57 , V_44 | V_63 , 0 ) ;
break;
case V_140 :
if ( ! ( V_4 -> V_15 & V_108 ) )
break;
F_52 ( V_4 , V_57 , V_64 , 0 ) ;
break;
case V_141 :
if ( ! ( V_4 -> V_15 & V_108 ) )
break;
...
V_99 = V_143 ;
F_71 ( V_2 ) ;
V_4 -> V_26 . V_120 = V_144 ;
F_70 ( & V_51 -> V_52 ,
& V_4 -> V_26 ) ;
break;
case V_145 :
if ( ! ( V_4 -> V_15 & V_17 ) && ! V_4 -> V_26 . V_120 ) {
F_52 ( V_4 , V_57 , V_64 , 0 ) ;
break;
}
if ( ! ( V_4 -> V_15 & V_44 ) ) {
F_52 ( V_4 , V_57 , V_64 , V_62 | V_63 ) ;
if ( V_4 -> V_26 . V_120 ) {
F_70 ( & V_51 -> V_52 ,
& V_4 -> V_26 ) ;
V_99 = V_4 -> V_15 & V_17 ? V_143 : V_142 ;
}
break;
}
case V_146 :
...
return false ;
if ( F_76 ( V_2 , V_4 -> V_6 . V_19 , V_159 ) ) {
if ( V_4 -> V_65 ) {
F_92 ( V_4 -> V_65 ) ;
V_4 -> V_65 = NULL ;
F_26 ( V_2 ) ;
...
bool F_93 ( union V_200 V_36 )
{
return V_36 . V_197 == V_155 ||
( V_36 . V_197 >= V_156 &&
V_36 . V_190 >= V_201 &&
V_36 . V_190 < V_191 ) ;
}
static bool F_94 ( union V_200 V_36 )
{
return V_36 . V_190 == V_191 || V_36 . V_190 == V_202 ;
}
static int F_95 ( struct V_3 * V_4 )
{
struct V_1 * V_2 = V_4 -> V_2 ;
int V_203 , V_204 ;
V_203 = F_93 ( V_2 -> V_153 ) ;
V_204 = F_94 ( V_2 -> V_153 ) ;
if ( F_96 ( V_4 -> V_6 . V_7 == 0 ) ) {
F_42 ( V_2 , V_4 -> V_5 -> V_205 & V_206 ) ;
if ( V_203 )
F_97 ( V_4 , V_148 ) ;
return V_203 ;
}
...
{
F_85 ( & V_2 -> V_182 -> V_183 ) ;
F_103 ( & V_4 -> V_25 , & V_2 -> V_211 . V_212 ) ;
F_103 ( & V_4 -> V_28 ,
& V_2 -> V_213 [ 1 ] ) ;
F_83 ( & V_2 -> V_182 -> V_183 ) ;
F_104 ( V_2 -> V_211 . V_214 , & V_2 -> V_211 . V_215 ) ;
F_15 ( & V_2 -> V_216 ) ;
}
static struct V_3 *
F_105 ( struct V_1 * V_2 , struct V_11 * V_11 , unsigned long V_10 )
{
...
F_1 ( V_2 , V_4 ) ;
if ( V_59 == V_16 && V_4 -> V_65 && V_4 -> V_6 . V_7
&& ! F_107 ( V_218 , & V_2 -> V_119 ) ) {
if ( ! F_108 ( V_2 , & V_4 -> V_6 ) ) {
F_32 ( & V_2 -> V_219 ) ;
F_102 ( V_2 , V_4 ) ;
return NULL ;
}
...
V_4 -> V_18 = F_18 ( & F_39 ( V_2 ) -> V_51 -> V_55 ) ;
if ( F_110 ( V_4 -> V_6 . V_7 != 0 ) ) {
if ( V_59 == V_16 )
F_39 ( V_2 ) -> V_51 -> V_54 ++ ;
F_103 ( & V_4 -> V_25 , & F_39 ( V_2 ) -> V_51 -> V_73 ) ;
}
if ( V_59 == V_16 ) {
if ( ! F_95 ( V_4 ) )
V_222 = true ;
...
void F_112 ( struct V_1 * V_2 , struct V_11 * V_11 , unsigned long V_10 )
{
struct V_3 * V_4 = F_105 ( V_2 , V_11 , V_10 ) ;
if ( F_113 ( V_4 ) )
return;
F_109 ( V_2 , V_4 ) ;
}
static void F_114 ( struct V_1 * V_2 , struct V_228 * V_229 )
{
struct V_3 * V_4 , * V_230 ;
F_115 (req, tmp, incoming, tl_requests) {
...
F_85 ( & V_2 -> V_235 ) ;
F_115 (req, tmp, incoming, tl_requests) {
V_234 = F_118 ( V_2 , & V_4 -> V_6 ) ;
if ( V_234 == - V_236 )
break;
if ( V_234 == - V_237 )
V_233 = 1 ;
if ( V_234 )
F_119 ( & V_4 -> V_25 , V_232 ) ;
else
F_119 ( & V_4 -> V_25 , V_231 ) ;
}
F_83 ( & V_2 -> V_235 ) ;
if ( V_233 )
F_15 ( & V_2 -> V_216 ) ;
...
void F_120 ( struct V_1 * V_2 , struct V_228 * V_231 )
{
struct V_3 * V_4 , * V_230 ;
F_115 (req, tmp, pending, tl_requests) {
V_4 -> V_15 |= V_47 ;
V_4 -> V_220 = V_84 ;
F_116 ( & V_2 -> V_219 ) ;
F_20 ( & V_4 -> V_25 ) ;
...
void F_121 ( struct V_238 * V_239 )
{
struct V_1 * V_2 = F_17 ( V_239 , struct V_1 , V_211 . V_215 ) ;
F_122 ( V_229 ) ;
F_122 ( V_231 ) ;
F_122 ( V_240 ) ;
F_85 ( & V_2 -> V_182 -> V_183 ) ;
F_123 ( & V_2 -> V_211 . V_212 , & V_229 ) ;
F_83 ( & V_2 -> V_182 -> V_183 ) ;
for (; ; ) {
F_80 ( V_180 ) ;
F_124 ( & V_240 , & V_229 ) ;
...
break;
for (; ; ) {
F_82 ( & V_2 -> V_216 , & V_180 , V_181 ) ;
F_124 ( & V_240 , & V_229 ) ;
F_117 ( V_2 , & V_229 , & V_231 , & V_240 ) ;
if ( ! F_40 ( & V_231 ) )
break;
F_84 () ;
if ( ! F_40 ( & V_229 ) )
...
F_86 ( & V_2 -> V_216 , & V_180 ) ;
while ( F_40 ( & V_229 ) ) {
F_122 ( V_241 ) ;
F_122 ( V_242 ) ;
bool V_243 ;
if ( F_40 ( & V_2 -> V_211 . V_212 ) )
break;
F_85 ( & V_2 -> V_182 -> V_183 ) ;
F_123 ( & V_2 -> V_211 . V_212 , & V_242 ) ;
F_83 ( & V_2 -> V_182 -> V_183 ) ;
if ( F_40 ( & V_242 ) )
break;
V_243 = F_117 ( V_2 , & V_242 , & V_241 , & V_240 ) ;
F_123 ( & V_241 , & V_231 ) ;
F_123 ( & V_242 , & V_229 ) ;
if ( ! V_243 )
break;
...
T_2 F_126 ( struct V_244 * V_245 , struct V_11 * V_11 )
{
struct V_1 * V_2 = (struct V_1 * ) V_245 -> V_246 ;
unsigned long V_10 ;
F_127 ( V_245 , & V_11 , V_245 -> V_247 ) ;
V_10 = V_84 ;
F_42 ( V_2 , F_128 ( V_11 -> V_20 . V_22 , 512 ) ) ;
F_129 ( V_2 ) ;
F_112 ( V_2 , V_11 , V_10 ) ;
return V_248 ;
}
static bool F_130 ( struct V_3 * V_249 ,
struct V_50 * V_51 ,
unsigned long V_250 , unsigned long V_251 ,
unsigned int V_252 , unsigned int V_253 )
{
struct V_1 * V_2 = V_249 -> V_2 ;
if ( ! F_131 ( V_250 , V_249 -> V_254 + V_251 ) )
return false ;
if ( F_132 ( V_250 , V_51 -> V_255 , V_51 -> V_255 + V_251 ) )
return false ;
if ( V_249 -> V_15 & V_63 ) {
F_28 ( V_2 , L_17 ,
F_133 ( V_250 - V_249 -> V_254 ) , V_252 , V_253 ) ;
return true ;
}
if ( V_249 -> V_18 == V_51 -> V_256 . V_257 ) {
F_28 ( V_2 ,
L_18 ,
F_133 ( V_250 - V_249 -> V_254 ) , V_252 , V_253 ) ;
return false ;
}
if ( F_131 ( V_250 , V_51 -> V_256 . V_258 + V_251 ) ) {
F_28 ( V_2 , L_19 ,
V_51 -> V_256 . V_258 , V_250 ,
F_133 ( V_250 - V_51 -> V_256 . V_258 ) , V_252 , V_253 ) ;
return true ;
}
return false ;
}
void F_134 ( unsigned long V_259 )
{
...
struct V_96 * V_97 ;
unsigned long V_263 ;
unsigned long V_251 = 0 , V_264 = 0 , V_265 , V_266 ;
unsigned long V_250 ;
unsigned int V_252 = 0 , V_253 = 0 ;
F_64 () ;
V_97 = F_65 ( V_51 -> V_96 ) ;
if ( V_97 && V_2 -> V_153 . V_190 >= V_267 ) {
V_252 = V_97 -> V_252 ;
V_253 = V_97 -> V_253 ;
}
if ( F_71 ( V_2 ) ) {
V_264 = F_65 ( V_2 -> V_90 -> V_198 ) -> V_268 * V_269 / 10 ;
F_26 ( V_2 ) ;
}
F_66 () ;
V_251 = V_253 * V_269 / 10 * V_252 ;
V_265 = F_135 ( V_264 , V_251 ) ;
if ( ! V_265 )
return;
V_250 = V_84 ;
V_266 = V_250 + V_265 ;
F_85 ( & V_2 -> V_182 -> V_183 ) ;
V_260 = F_136 ( & V_2 -> V_227 [ 0 ] , struct V_3 , V_29 ) ;
V_261 = F_136 ( & V_2 -> V_227 [ 1 ] , struct V_3 , V_29 ) ;
V_262 = V_51 -> V_74 ;
if ( ! V_262 )
V_262 = V_51 -> V_76 ;
...
V_263 =
( V_261 && V_260 )
? ( F_137 ( V_261 -> V_226 , V_260 -> V_226 )
? V_261 -> V_226 : V_260 -> V_226 )
: V_261 ? V_261 -> V_226
: V_260 ? V_260 -> V_226 : V_250 ;
if ( V_251 && V_262 && F_130 ( V_262 , V_51 , V_250 , V_251 , V_252 , V_253 ) )
F_138 ( V_51 , F_139 ( V_190 , V_270 ) , V_271 | V_272 ) ;
if ( V_264 && V_263 != V_250 &&
F_131 ( V_250 , V_263 + V_264 ) &&
! F_132 ( V_250 , V_2 -> V_273 , V_2 -> V_273 + V_264 ) ) {
F_28 ( V_2 , L_20 ) ;
F_67 ( V_2 , V_274 ) ;
}
V_251 = ( V_251 && V_262 && F_137 ( V_250 , V_262 -> V_254 + V_251 ) )
? V_262 -> V_254 + V_251 : V_250 + V_265 ;
V_264 = ( V_264 && V_263 != V_250 && F_137 ( V_250 , V_263 + V_264 ) )
? V_263 + V_264 : V_250 + V_265 ;
V_266 = F_137 ( V_251 , V_264 ) ? V_251 : V_264 ;
V_224:
F_83 ( & V_2 -> V_182 -> V_183 ) ;
F_140 ( & V_2 -> V_275 , V_266 ) ;
}
