...
char * F_18 ( const char * V_30 , bool V_31 , T_2 V_32 , int * V_33 )
{
T_2 V_29 = V_32 * 28 + 1 ;
T_2 V_34 , V_35 = 0 ;
char * V_36 = malloc ( V_29 ) ;
if ( V_36 ) {
const char * V_37 = L_3 , * V_38 = L_4 ;
char * V_39 = V_36 ;
if ( ! V_31 ) {
V_37 = L_5 ;
V_38 = L_6 ;
...
goto V_40;
if ( V_34 > 0 )
V_35 += snprintf ( V_39 + V_35 , V_29 - V_35 , L_7 , V_37 ) ;
V_35 += F_19 ( V_39 + V_35 , V_29 - V_35 ,
L_8 , V_30 , V_38 , V_33 [ V_34 ] ) ;
}
}
return V_36 ;
V_40:
