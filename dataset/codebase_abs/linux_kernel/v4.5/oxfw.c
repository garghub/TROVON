...
static void F_9 ( struct V_40 * V_33 )
{
struct V_9 * V_10 = V_33 -> V_41 ;
unsigned int V_5 ;
F_10 ( V_10 , & V_10 -> V_42 ) ;
if ( V_10 -> V_43 )
F_10 ( V_10 , & V_10 -> V_44 ) ;
...
V_15 = V_4 = 0 ;
F_17 ( & V_51 , V_12 -> V_20 + 5 ) ;
while ( F_18 ( & V_51 , & V_52 , & V_53 ) ) {
if ( V_52 == V_21 )
V_15 = V_53 ;
else if ( V_52 == V_8 )
V_4 = V_53 ;
...
if ( V_6 < 0 )
goto error;
V_6 = F_30 ( V_10 , & V_10 -> V_42 ) ;
if ( V_6 < 0 )
goto error;
if ( V_10 -> V_43 ) {
V_6 = F_30 ( V_10 , & V_10 -> V_44 ) ;
if ( V_6 < 0 )
goto error;
}
V_6 = F_31 ( V_33 ) ;
