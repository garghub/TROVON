...
T_8 V_101 ;
T_3 V_305 ;
V_7 = F_42 ( sizeof( * V_7 ) , V_260 ) ;
if ( V_7 == NULL ) {
F_40 ( & V_299 -> V_13 , L_38 ) ;
goto V_306;
}
V_7 -> V_13 = & V_299 -> V_13 ;
...
if ( ! V_327 )
return - V_103 ;
V_328 = F_140 ( V_301 , L_39 , NULL ) ;
if ( ! V_328 || strcmp ( V_328 , L_40 ) )
return - V_147 ;
V_7 = F_130 ( V_299 ) ;
if ( ! V_7 ) {
F_40 ( & V_299 -> V_13 , L_41 ) ;
return - V_96 ;
}
