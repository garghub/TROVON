...
F_76 ( & V_120 ) ;
F_77 ( V_34 , V_120 . V_123 , V_120 . V_124 ) ;
F_78 ( V_34 ) ;
if ( F_79 ( & V_115 ) == 1 ) {
V_85 = 0 ;
F_80 ( & V_99 ) ;
V_37 = F_37 ( F_81 ( F_49 , NULL ,
L_29 ) ) ;
if ( F_82 ( V_37 ) ) {
F_2 ( L_30 ,
V_34 -> V_49 , V_37 ) ;
...
if ( ! V_126 -> V_138 ||
! V_126 -> V_138 -> V_82 -> V_76 . V_77 . V_83 ) {
F_5 ( V_11 , L_37 ,
V_16 -> V_19 ) ;
F_11 ( V_16 ) ;
break;
...
static int F_96 ( struct V_139 * exp , struct V_153 * V_154 ,
...
if ( V_143 == NULL )
return - V_39 ;
F_97 ( & V_143 -> V_149 , & V_174 , V_175 , 0 ) ;
F_93 ( V_143 ) ;
V_143 -> V_151 = V_170 ? 5 : V_176 ;
V_37 = F_98 ( exp , & V_143 , & V_164 , & V_16 -> V_50 , NULL , V_157 ,
NULL , 0 , V_177 , V_131 , 0 ) ;
F_92 ( V_143 ) ;
return V_37 ;
}
static void F_99 ( struct V_33 * V_178 )
{
F_21 ( & V_20 ) ;
V_85 |= V_94 ;
F_15 ( & V_20 ) ;
...
static int F_101 ( const struct V_103 * V_104 , struct V_139 * exp ,
...
static int F_108 ( const struct V_103 * V_104 , struct V_139 * exp ,
...
static int F_113 ( struct V_33 * V_230 ,
struct V_15 * V_16 ,
T_1 V_231 ,
...
if ( V_37 < 0 ) {
F_2 ( L_62 ,
F_119 ( V_235 -> V_76 . V_262 [ 0 ] ) ) ;
break;
}
F_5 ( V_18 , L_63 ,
V_252 , F_119 ( V_235 -> V_76 . V_262 [ 0 ] ) ) ;
V_242 += strlen ( V_252 ) ;
V_242 += sprintf ( V_240 + V_242 , L_64 , V_235 -> V_264 ) ;
F_12 ( V_242 < V_241 ) ;
F_120 ( & V_237 , 1 , V_251 ) ;
V_37 = - V_39 ;
V_53 = F_121 ( V_265 , & V_237 ) ;
if ( V_53 == NULL ) {
F_2 ( L_65 ) ;
break;
}
...
if ( V_27 -> V_43 == 0 )
V_273 = V_278 ;
V_272 = F_125 ( V_273 , sizeof( * V_272 ) , V_245 ) ;
if ( V_272 == NULL ) {
V_37 = - V_39 ;
goto V_279;
}
for ( V_275 = 0 ; V_275 < V_273 ; V_275 ++ ) {
V_272 [ V_275 ] = F_126 ( V_245 ) ;
if ( V_272 [ V_275 ] == NULL ) {
V_37 = - V_39 ;
goto V_279;
}
...
V_143 = F_129 ( F_90 ( V_16 -> V_25 ) ,
& V_281 ) ;
if ( V_143 == NULL ) {
V_37 = - V_39 ;
goto V_279;
}
V_37 = F_130 ( V_143 , V_147 , V_282 ) ;
if ( V_37 )
goto V_279;
V_267 = F_91 ( & V_143 -> V_149 , & V_283 ) ;
F_12 ( V_267 != NULL ) ;
F_12 ( sizeof( V_267 -> V_284 ) > strlen ( V_16 -> V_19 ) ) ;
if ( F_131 ( V_267 -> V_284 , V_16 -> V_19 , sizeof( V_267 -> V_284 ) )
>= sizeof( V_267 -> V_284 ) ) {
V_37 = - V_246 ;
goto V_279;
}
...
V_267 -> V_287 = V_288 ;
V_267 -> V_289 = V_273 ;
V_128 = F_132 ( V_143 , V_273 , 1 , V_290 ,
V_291 ) ;
if ( V_128 == NULL ) {
V_37 = - V_39 ;
goto V_279;
...
for ( V_275 = 0 ; V_275 < V_273 ; V_275 ++ )
F_133 ( V_128 , V_272 [ V_275 ] , 0 , V_244 ) ;
F_93 ( V_143 ) ;
V_37 = F_94 ( V_143 ) ;
if ( V_37 )
goto V_279;
V_269 = F_95 ( & V_143 -> V_149 , & V_292 ) ;
...
V_276 = F_134 ( V_143 , V_143 -> V_295 , 0 ) ;
if ( V_276 < 0 ) {
V_37 = V_276 ;
goto V_279;
}
...
int V_299 ;
void * V_60 ;
V_60 = F_137 ( V_272 [ V_275 ] ) ;
V_299 = F_113 ( V_34 , V_16 , V_269 -> V_294 , V_60 ,
F_138 ( int , V_276 , V_244 ) ,
V_233 ) ;
F_139 ( V_272 [ V_275 ] ) ;
if ( V_299 < 0 ) {
F_140 ( L_69 ,
...
static int F_142 ( struct V_33 * V_230 ,
...
if ( ! V_104 )
return - V_39 ;
V_37 = F_143 ( V_104 , V_302 ) ;
if ( V_37 )
goto V_303;
V_106 = F_59 ( V_230 , V_108 ) ;
F_12 ( V_106 ) ;
if ( V_300 ) {
V_37 = - V_304 ;
goto V_305;
...
V_37 = F_145 ( V_104 , V_106 , V_16 -> V_19 ,
& V_16 -> V_31 ) ;
V_305:
F_146 ( V_104 , V_106 ) ;
if ( V_301 ) {
...
V_307 = F_96 ( V_230 -> V_76 . V_77 . V_309 , NULL , V_310 , NULL ,
V_311 , & V_157 , NULL , NULL , NULL ,
V_16 , 0 , NULL , & V_131 ) ;
if ( V_307 == 0 ) {
F_8 ( V_16 ) ;
V_37 = F_151 ( & V_131 , ( void * ) V_16 ) ;
F_12 ( V_37 == 0 ) ;
} else {
F_5 ( V_11 , L_71 , V_307 ) ;
V_16 -> V_101 = 1 ;
...
V_37 = 0 ;
if ( V_307 == 0 )
V_37 = F_124 ( V_230 , V_16 ) ;
} else {
V_37 = F_142 ( V_230 , V_16 , V_307 != 0 ) ;
}
F_5 ( V_11 , L_72 ,
...
static int F_153 ( struct V_33 * V_34 , T_4 V_2 , void * V_240 )
{
...
V_180 = (struct V_179 * ) F_155 ( V_53 , 1 ) ;
F_5 ( V_11 , L_75 ,
V_180 -> V_186 , V_180 -> V_314 ) ;
V_37 = F_100 ( V_34 -> V_76 . V_77 . V_309 , V_180 ) ;
break;
}
case V_315 :
F_2 ( L_76 ) ;
