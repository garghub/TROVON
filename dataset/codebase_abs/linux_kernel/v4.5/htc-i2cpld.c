...
F_34 ( V_22 , V_4 ) ;
snprintf ( V_22 -> V_72 , V_70 , L_14 , V_22 -> V_67 ) ;
V_4 -> V_22 = V_22 ;
F_21 ( V_22 ) ;
...
V_16 = F_24 ( V_50 ) ;
V_16 -> V_20 = V_59 -> V_86 ;
V_16 -> V_4 = F_41 ( V_14 , sizeof( struct V_3 ) * V_16 -> V_20 ,
V_87 ) ;
if ( ! V_16 -> V_4 ) {
F_8 ( V_14 , L_17 ) ;
return - V_88 ;
...
for ( V_17 = 0 ; V_17 < V_16 -> V_20 ; V_17 ++ ) {
int V_73 ;
V_16 -> V_4 [ V_17 ] . V_48 = V_59 -> V_4 [ V_17 ] . V_48 ;
V_16 -> V_4 [ V_17 ] . V_27 = V_59 -> V_4 [ V_17 ] . V_48 ;
V_16 -> V_4 [ V_17 ] . V_29 = 0 ;
V_16 -> V_4 [ V_17 ] . V_14 = V_14 ;
V_16 -> V_4 [ V_17 ] . V_7 = V_59 -> V_4 [ V_17 ] . V_89 ;
V_16 -> V_4 [ V_17 ] . V_26 = V_59 -> V_4 [ V_17 ] . V_90 ;
F_42 ( & ( V_16 -> V_4 [ V_17 ] . V_40 ) , & F_16 ) ;
F_43 ( & ( V_16 -> V_4 [ V_17 ] . V_28 ) ) ;
if ( V_16 -> V_91 ) {
V_73 = F_23 ( V_50 , V_17 ) ;
if ( V_73 )
continue;
...
F_44 ( V_14 , L_18 , V_59 -> V_4 [ V_17 ] . V_67 ) ;
}
return 0 ;
}
...
V_16 = F_41 ( V_14 , sizeof( struct V_15 ) , V_87 ) ;
if ( ! V_16 )
return - V_88 ;
V_93 = F_46 ( V_50 , V_95 , 0 ) ;
if ( V_93 ) {
int V_8 ;
V_16 -> V_91 = V_93 -> V_96 ;
V_8 = V_97 | V_98 |
