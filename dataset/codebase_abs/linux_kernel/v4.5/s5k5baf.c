...
static int F_134 ( struct V_23 * V_30 ,
struct V_32 * V_33 )
{
struct V_19 * V_25 ;
int V_11 ;
...
F_137 ( V_33 -> V_44 ) , V_33 -> V_31 ) ;
V_25 -> V_316 = & V_317 ;
V_25 -> V_39 |= V_318 ;
V_30 -> V_319 . V_39 = V_320 ;
V_25 -> V_26 . V_27 = V_28 ;
V_11 = F_138 ( & V_25 -> V_26 , V_321 , & V_30 -> V_319 ) ;
if ( V_11 < 0 )
goto V_133;
V_25 = & V_30 -> V_25 ;
F_139 ( V_25 , V_33 , & V_322 ) ;
...
V_11 = F_138 ( & V_25 -> V_26 , V_327 , V_30 -> V_324 ) ;
if ( ! V_11 )
return 0 ;
F_140 ( & V_30 -> V_29 . V_26 ) ;
V_133:
F_2 ( & V_33 -> V_2 , L_43 , V_25 -> V_246 ) ;
return V_11 ;
}
static int F_141 ( struct V_23 * V_30 )
{
struct V_32 * V_33 = F_10 ( & V_30 -> V_25 ) ;
int V_11 ;
int V_9 ;
...
V_11 = F_142 ( & V_33 -> V_2 , V_169 ,
V_30 -> V_170 ) ;
if ( V_11 < 0 )
F_15 ( V_33 , L_44 ) ;
return V_11 ;
}
static int F_143 ( struct V_32 * V_33 ,
...
if ( V_11 < 0 )
goto V_331;
V_30 -> clock = F_145 ( V_30 -> V_25 . V_2 , V_332 ) ;
if ( F_70 ( V_30 -> clock ) ) {
V_11 = - V_333 ;
goto V_331;
}
...
V_331:
F_140 ( & V_30 -> V_25 . V_26 ) ;
F_140 ( & V_30 -> V_29 . V_26 ) ;
return V_11 ;
}
static int F_147 ( struct V_32 * V_33 )
{
struct V_19 * V_25 = F_148 ( V_33 ) ;
struct V_23 * V_30 = F_8 ( V_25 ) ;
F_149 ( V_25 ) ;
F_116 ( V_25 -> V_279 ) ;
F_140 ( & V_25 -> V_26 ) ;
