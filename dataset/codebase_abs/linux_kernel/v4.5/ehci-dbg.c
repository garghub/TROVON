...
case 0: tmp = L_81; break;
case 1: tmp = L_82; break;
case 2: tmp = L_83; break;
...
unsigned V_7 ;
T_3 V_144 ;
V_142 = F_59 ( V_145 * sizeof *V_142 , V_146 ) ;
if ( ! V_142 )
return 0 ;
V_143 = 0 ;
V_110 = F_47 ( V_8 -> V_86 ) ;
...
V_100 = V_8 -> V_112 ;
V_99 = V_8 -> V_113 ;
V_98 = F_29 ( V_100 , V_99 , L_92 , V_2 -> V_147 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
F_49 ( & V_2 -> V_114 , V_111 ) ;
...
V_2 ,
V_14 -> V_17 ) >> 8 ) ) {
case 0 : type = L_81 ; continue;
case 1 : type = L_82 ; continue;
}
}
V_98 = F_29 ( V_100 , V_99 ,
L_96
...
V_98 = F_29 ( V_100 , V_99 ,
L_110 , V_180 ,
( V_180 & ( 1 << 24 ) ) ? L_111 : L_3 ,
( V_180 & ( 1 << 16 ) ) ? L_112 : L_3 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
V_179 += 4 ;
...
V_98 = F_29 ( V_100 , V_99 , L_114 , V_7 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
V_7 = F_2 ( V_2 , & V_2 -> V_5 -> V_12 ) ;
V_98 = F_29 ( V_100 , V_99 , L_115 , V_7 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
...
& V_213 ) )
goto V_212;
if ( ! F_93 ( L_123 , V_210 , V_2 -> V_207 , V_86 ,
& V_214 ) )
goto V_212;
if ( ! F_93 ( L_124 , V_210 , V_2 -> V_207 , V_86 ,
& V_215 ) )
goto V_212;
return;
V_212:
