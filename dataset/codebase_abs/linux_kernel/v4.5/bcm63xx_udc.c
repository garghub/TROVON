...
F_32 ( V_11 , V_66 ) ;
if ( ! F_63 ( & V_27 -> V_128 ) ) {
F_67 (breq, n, &bep->queue, queue) {
F_68 ( & V_11 -> V_4 , & V_78 -> V_10 ,
V_66 -> V_87 ) ;
F_55 ( & V_78 -> V_128 ) ;
V_78 -> V_10 . V_202 = - V_197 ;
F_61 ( & V_11 -> V_198 , V_194 ) ;
F_69 ( & V_66 -> V_27 -> V_7 , & V_78 -> V_10 ) ;
F_60 ( & V_11 -> V_198 , V_194 ) ;
}
}
V_7 -> V_170 = NULL ;
...
unsigned long V_194 ;
int V_132 = 0 ;
if ( F_75 ( ! V_10 || ! V_10 -> V_204 || ! V_10 -> V_205 || ! V_7 ) )
return - V_114 ;
V_10 -> V_206 = 0 ;
V_10 -> V_202 = 0 ;
V_78 -> V_84 = 0 ;
...
struct V_5 * V_27 = F_3 ( V_7 ) ;
struct V_1 * V_11 = V_27 -> V_11 ;
struct V_8 * V_78 = F_4 ( V_10 ) , * V_210 ;
unsigned long V_194 ;
int V_132 = 0 ;
F_60 ( & V_11 -> V_198 , V_194 ) ;
if ( F_63 ( & V_27 -> V_128 ) ) {
...
V_210 = F_80 ( & V_27 -> V_128 , struct V_8 , V_128 ) ;
F_68 ( & V_11 -> V_4 , & V_78 -> V_10 , V_27 -> V_66 -> V_87 ) ;
if ( V_78 == V_210 ) {
F_32 ( V_11 , V_27 -> V_66 ) ;
F_55 ( & V_78 -> V_128 ) ;
if ( ! F_63 ( & V_27 -> V_128 ) ) {
struct V_8 * V_211 ;
V_211 = F_80 ( & V_27 -> V_128 ,
struct V_8 , V_128 ) ;
F_28 ( V_11 , V_27 -> V_66 , V_211 ) ;
}
} else {
F_55 ( & V_78 -> V_128 ) ;
}
...
static int F_81 ( struct V_6 * V_7 , int V_212 )
{
struct V_5 * V_27 = F_3 ( V_7 ) ;
struct V_1 * V_11 = V_27 -> V_11 ;
unsigned long V_194 ;
F_60 ( & V_11 -> V_198 , V_194 ) ;
F_20 ( V_11 , V_27 , ! ! V_212 ) ;
V_27 -> V_169 = V_212 ;
F_61 ( & V_11 -> V_198 , V_194 ) ;
return 0 ;
}
...
int V_132 ;
F_85 ( & V_11 -> V_198 ) ;
V_132 = V_11 -> V_196 -> V_215 ( & V_11 -> V_4 , V_214 ) ;
F_86 ( & V_11 -> V_198 ) ;
return V_132 ;
}
...
V_214 . V_219 = V_220 ;
V_214 . V_221 = F_88 ( V_11 -> V_58 ) ;
V_214 . V_222 = 0 ;
V_214 . V_223 = 0 ;
V_132 = F_84 ( V_11 , & V_214 ) ;
if ( V_132 < 0 ) {
F_89 ( V_11 -> V_119 ,
L_5 ,
V_11 -> V_58 ) ;
...
struct V_213 V_214 ;
int V_132 ;
V_214 . V_216 = V_217 | V_224 ;
V_214 . V_219 = V_225 ;
V_214 . V_221 = F_88 ( V_11 -> V_74 ) ;
V_214 . V_222 = F_88 ( V_11 -> V_72 ) ;
V_214 . V_223 = 0 ;
V_132 = F_84 ( V_11 , & V_214 ) ;
if ( V_132 < 0 ) {
F_89 ( V_11 -> V_119 ,
...
{
struct V_9 * V_10 = V_11 -> V_207 ;
V_11 -> V_207 = NULL ;
F_68 ( & V_11 -> V_4 , V_10 , V_87 ) ;
if ( V_11 -> V_226 == V_10 ) {
V_11 -> V_227 = 0 ;
V_11 -> V_226 = NULL ;
}
F_92 ( V_11 , V_10 , - V_197 ) ;
}
static int F_94 ( struct V_1 * V_11 )
{
struct V_9 * V_10 = V_11 -> V_226 ;
V_11 -> V_227 = 0 ;
V_11 -> V_226 = NULL ;
return V_10 -> V_206 ;
}
...
int V_83 )
{
struct V_9 * V_10 = & V_11 -> V_228 . V_10 ;
V_10 -> V_205 = V_11 -> V_160 ;
V_10 -> V_83 = V_83 ;
V_10 -> V_204 = NULL ;
F_91 ( V_11 , V_111 , V_10 ) ;
}
static enum V_229 F_96 ( struct V_1 * V_11 )
{
int V_132 ;
struct V_213 * V_214 = ( void * ) V_11 -> V_160 ;
V_132 = F_94 ( V_11 ) ;
if ( V_132 < 0 ) {
F_34 ( V_11 -> V_119 , L_7 ) ;
return V_230 ;
...
V_11 -> V_173 = F_96 ( V_11 ) ;
return V_11 -> V_173 == V_230 ? - V_239 : 0 ;
} else if ( V_11 -> V_240 ) {
V_11 -> V_240 = 0 ;
V_11 -> V_227 = 0 ;
V_11 -> V_226 = NULL ;
F_32 ( V_11 , & V_11 -> V_66 [ V_241 ] ) ;
F_68 ( & V_11 -> V_4 ,
& V_11 -> V_228 . V_10 , 0 ) ;
F_30 () ;
V_11 -> V_173 = V_174 ;
...
{
enum V_229 V_173 = V_11 -> V_173 ;
bool V_242 = V_11 -> V_235 || V_11 -> V_240 ;
switch ( V_11 -> V_173 ) {
case V_231 :
F_95 ( V_11 , V_241 ,
V_161 ) ;
...
static void F_99 ( struct V_248 * V_249 )
{
struct V_1 * V_11 = F_2 ( V_249 , struct V_1 , V_208 ) ;
F_86 ( & V_11 -> V_198 ) ;
while ( F_98 ( V_11 ) == 0 )
;
F_85 ( & V_11 -> V_198 ) ;
...
F_43 ( V_11 , true ) ;
V_11 -> V_196 = V_196 ;
V_196 -> V_196 . V_254 = NULL ;
V_11 -> V_4 . V_119 . V_255 = V_11 -> V_119 -> V_255 ;
F_61 ( & V_11 -> V_198 , V_194 ) ;
return 0 ;
}
...
{
T_1 V_256 = F_5 ( V_11 , V_137 ) ;
V_11 -> V_58 = ( V_256 & V_257 ) >> V_258 ;
V_11 -> V_72 = ( V_256 & V_259 ) >> V_260 ;
V_11 -> V_74 = ( V_256 & V_261 ) >>
V_262 ;
F_25 ( V_11 ) ;
}
...
{
T_1 V_256 = F_5 ( V_11 , V_137 ) ;
enum V_263 V_264 = V_11 -> V_4 . V_35 ;
switch ( ( V_256 & V_265 ) >> V_266 ) {
case V_185 :
V_11 -> V_4 . V_35 = V_36 ;
break;
case V_187 :
...
static void F_110 ( struct V_1 * V_11 , bool V_268 )
{
int V_37 ;
F_111 (i, &udc->wedgemap, BCM63XX_NUM_EP) {
F_20 ( V_11 , & V_11 -> V_27 [ V_37 ] , V_268 ) ;
if ( ! V_268 )
F_64 ( V_37 , & V_11 -> V_199 ) ;
}
}
static T_3 F_112 ( int V_269 , void * V_270 )
{
struct V_1 * V_11 = V_270 ;
T_1 V_271 ;
bool V_272 = false , V_273 = false ;
V_271 = F_5 ( V_11 , V_144 ) &
F_5 ( V_11 , V_143 ) ;
F_7 ( V_11 , V_271 , V_144 ) ;
F_113 ( & V_11 -> V_198 ) ;
if ( V_271 & F_40 ( V_142 ) ) {
if ( ! ( F_5 ( V_11 , V_274 ) &
V_275 ) &&
...
F_114 ( & V_11 -> V_198 ) ;
if ( V_272 && V_11 -> V_196 )
V_11 -> V_196 -> V_276 ( & V_11 -> V_4 ) ;
else if ( V_273 && V_11 -> V_196 )
F_115 ( & V_11 -> V_4 , V_11 -> V_196 ) ;
return V_277 ;
}
static T_3 F_116 ( int V_269 , void * V_270 )
{
struct V_77 * V_66 = V_270 ;
...
if ( V_132 >= 0 ) {
V_10 -> V_206 += V_132 ;
if ( V_10 -> V_206 >= V_10 -> V_83 || V_78 -> V_90 > V_132 ) {
V_11 -> V_227 = 1 ;
V_278 = true ;
F_76 ( & V_11 -> V_208 ) ;
V_10 -> V_206 = F_117 ( V_10 -> V_206 , V_10 -> V_83 ) ;
} else {
F_28 ( V_11 , V_66 , V_78 ) ;
}
}
...
F_114 ( & V_11 -> V_198 ) ;
if ( V_278 ) {
F_68 ( & V_11 -> V_4 , V_10 , V_66 -> V_87 ) ;
if ( V_10 -> V_204 )
V_10 -> V_204 ( & V_27 -> V_7 , V_10 ) ;
}
return V_277 ;
}
static int F_118 ( struct V_279 * V_280 , void * V_281 )
{
...
V_283 [ V_11 -> V_173 ] ) ;
F_119 ( V_280 , L_16 ,
V_11 -> V_235 ? L_17 : L_18 ,
V_11 -> V_236 ? L_19 : L_18 ,
V_11 -> V_238 ? L_20 : L_18 ,
V_11 -> V_240 ? L_21 : L_18 ,
V_11 -> V_226 ? L_22 : L_18 ,
V_11 -> V_227 ? L_23 : L_18 ,
V_11 -> V_207 ? L_24 : L_18 ) ;
F_119 ( V_280 , L_25 ,
...
static int F_120 ( struct V_279 * V_280 , void * V_281 )
{
struct V_1 * V_11 = V_280 -> V_282 ;
int V_111 , V_37 ;
T_1 V_284 , V_285 ;
...
F_119 ( V_280 , V_111 & 0x01 ? L_33 : L_34 ) ;
F_119 ( V_280 , L_35 ,
F_121 ( int , V_43 [ V_111 ] . V_31 , 0 ) ) ;
F_119 ( V_280 , L_36 ,
...
V_285 = F_13 ( V_11 , V_291 , V_111 ) ;
F_119 ( V_280 , L_37 ,
F_13 ( V_11 , V_126 , V_111 ) ,
V_284 >> 16 , V_284 & 0xffff ,
V_285 >> 16 , V_285 & 0xffff ,
F_13 ( V_11 , V_292 , V_111 ) ) ;
F_119 ( V_280 , L_38 , V_66 -> V_89 ,
V_66 -> V_104 ) ;
if ( V_66 -> V_27 ) {
V_37 = 0 ;
F_122 (pos, &iudma->bep->queue)
V_37 ++ ;
F_119 ( V_280 , L_39 , V_37 ) ;
} else {
F_119 ( V_280 , L_40 ) ;
}
...
static int F_123 ( struct V_293 * V_293 , struct V_294 * V_294 )
{
return F_124 ( V_294 , F_118 , V_293 -> V_295 ) ;
}
static int F_125 ( struct V_293 * V_293 , struct V_294 * V_294 )
{
return F_124 ( V_294 , F_120 , V_293 -> V_295 ) ;
}
static void F_126 ( struct V_1 * V_11 )
{
struct V_296 * V_297 , * V_298 , * V_66 ;
if ( ! F_127 ( V_299 ) )
return;
V_297 = F_128 ( V_11 -> V_4 . V_164 , NULL ) ;
if ( F_57 ( V_297 ) || ! V_297 )
goto V_300;
V_298 = F_129 ( L_4 , 0400 , V_297 , V_11 ,
& V_301 ) ;
if ( ! V_298 )
goto V_302;
V_66 = F_129 ( L_44 , 0400 , V_297 , V_11 ,
& V_303 ) ;
if ( ! V_66 )
goto V_304;
V_11 -> V_305 = V_297 ;
...
static void F_131 ( struct V_1 * V_11 )
{
F_130 ( V_11 -> V_307 ) ;
F_130 ( V_11 -> V_306 ) ;
F_130 ( V_11 -> V_305 ) ;
...
static int F_132 ( struct V_308 * V_309 )
{
struct V_310 * V_119 = & V_309 -> V_119 ;
struct V_311 * V_147 = F_133 ( V_119 ) ;
struct V_1 * V_11 ;
struct V_312 * V_313 ;
int V_132 = - V_131 , V_37 , V_269 ;
...
V_313 = F_135 ( V_309 , V_314 , 0 ) ;
V_11 -> V_13 = F_136 ( V_119 , V_313 ) ;
if ( F_57 ( V_11 -> V_13 ) )
return F_137 ( V_11 -> V_13 ) ;
V_313 = F_135 ( V_309 , V_314 , 1 ) ;
V_11 -> V_15 = F_136 ( V_119 , V_313 ) ;
if ( F_57 ( V_11 -> V_15 ) )
return F_137 ( V_11 -> V_15 ) ;
F_138 ( & V_11 -> V_198 ) ;
F_139 ( & V_11 -> V_208 , F_99 ) ;
V_11 -> V_4 . V_167 = & V_315 ;
V_11 -> V_4 . V_164 = F_140 ( V_119 ) ;
if ( ! V_147 -> V_316 && ! V_316 )
V_11 -> V_4 . V_184 = V_36 ;
else
V_11 -> V_4 . V_184 = V_267 ;
V_132 = F_52 ( V_11 ) ;
if ( V_132 )
return V_132 ;
V_132 = - V_317 ;
...
if ( F_142 ( V_119 , V_269 , & F_112 , 0 ,
F_140 ( V_119 ) , V_11 ) < 0 ) {
F_34 ( V_119 , L_48 , V_269 ) ;
goto V_318;
}
for ( V_37 = 0 ; V_37 < V_40 ; V_37 ++ ) {
V_269 = F_141 ( V_309 , V_37 + 1 ) ;
if ( V_269 < 0 ) {
F_34 ( V_119 , L_49 , V_37 + 1 ) ;
goto V_318;
}
if ( F_142 ( V_119 , V_269 , & F_116 , 0 ,
F_140 ( V_119 ) , & V_11 -> V_66 [ V_37 ] ) < 0 ) {
F_34 ( V_119 , L_48 , V_269 ) ;
goto V_318;
}
}
F_126 ( V_11 ) ;
V_132 = F_143 ( V_119 , & V_11 -> V_4 ) ;
if ( ! V_132 )
return 0 ;
F_131 ( V_11 ) ;
V_318:
...
static int F_144 ( struct V_308 * V_309 )
{
struct V_1 * V_11 = F_145 ( V_309 ) ;
F_131 ( V_11 ) ;
F_146 ( & V_11 -> V_4 ) ;
F_62 ( V_11 -> V_196 ) ;
F_50 ( V_11 ) ;
