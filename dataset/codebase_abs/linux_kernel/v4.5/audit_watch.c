...
F_47 ( V_2 , V_49 , V_7 -> V_72 -> V_73 , V_7 -> V_74 , 0 ) ;
...
struct V_96 * V_97 ;
char * V_98 ;
V_98 = F_36 ( F_82 ( V_36 -> V_66 ) , V_20 ) ;
if ( ! V_98 )
return - V_21 ;
V_97 = F_83 ( V_37 , V_98 , strlen ( V_98 ) ) ;
if ( F_33 ( V_97 ) ) {
F_4 ( V_98 ) ;
return F_34 ( V_97 ) ;
}
...
int F_84 ( struct V_99 * V_100 , struct V_96 * V_6 )
{
struct V_101 * V_102 ;
unsigned long V_15 ;
T_1 V_16 ;
F_85 () ;
V_102 = F_86 ( V_100 -> V_103 -> V_102 ) ;
V_15 = V_102 -> V_104 -> V_74 ;
V_16 = V_102 -> V_104 -> V_72 -> V_73 ;
F_87 () ;
