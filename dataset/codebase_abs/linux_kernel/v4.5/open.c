...
long F_6 ( struct V_17 * V_17 , T_1 V_2 )
{
struct V_18 * V_18 ;
long error ;
V_18 = V_17 -> V_1 -> V_16 ;
...
static int F_34 ( struct V_17 * V_17 , T_3 V_48 )
{
...
static int F_37 ( struct V_17 * V_17 , T_4 V_71 , T_5 V_72 )
{
struct V_18 * V_18 = V_17 -> V_1 -> V_16 ;
struct V_18 * V_65 = NULL ;
int error ;
...
struct V_18 * V_18 = V_1 -> V_16 ;
V_4 -> V_40 = * V_17 ;
if ( V_1 -> V_118 & V_119 ) {
V_18 = V_1 -> V_120 -> V_121 ( V_1 , V_4 -> V_38 ) ;
if ( F_68 ( V_18 ) )
return F_69 ( V_18 ) ;
}
return F_45 ( V_4 , V_18 , NULL , V_86 ) ;
}
struct V_4 * F_70 ( const struct V_17 * V_17 , int V_122 ,
const struct V_86 * V_86 )
{
int error ;
struct V_4 * V_36 ;
...
static inline int F_76 ( int V_122 , T_3 V_48 , struct V_123 * V_124 )
{
int V_29 = 0 ;
int V_125 = F_77 ( V_122 ) ;
if ( V_122 & ( V_108 | V_126 ) )
V_124 -> V_48 = ( V_48 & V_69 ) | V_127 ;
else
V_124 -> V_48 = 0 ;
V_122 &= ~ V_128 & ~ V_129 ;
if ( V_122 & V_130 )
V_122 |= V_131 ;
if ( V_122 & V_126 ) {
if ( ( V_122 & V_132 ) != V_133 )
return - V_9 ;
if ( ! ( V_125 & V_23 ) )
return - V_9 ;
} else if ( V_122 & V_94 ) {
V_122 &= V_134 | V_135 | V_94 ;
V_125 = 0 ;
}
V_124 -> V_136 = V_122 ;
if ( V_122 & V_111 )
...
V_125 |= V_138 ;
V_124 -> V_125 = V_125 ;
V_124 -> V_139 = V_122 & V_94 ? 0 : V_140 ;
if ( V_122 & V_108 ) {
V_124 -> V_139 |= V_141 ;
if ( V_122 & V_109 )
V_124 -> V_139 |= V_142 ;
...
struct V_4 * F_78 ( struct V_144 * V_145 , int V_122 , T_3 V_48 )
{
struct V_123 V_124 ;
int V_146 = F_76 ( V_122 , V_48 , & V_124 ) ;
return V_146 ? F_74 ( V_146 ) : F_79 ( V_32 , V_145 , & V_124 ) ;
}
struct V_4 * F_80 ( const char * V_144 , int V_122 , T_3 V_48 )
{
struct V_144 * V_145 = F_81 ( V_144 ) ;
struct V_4 * V_4 = F_82 ( V_145 ) ;
if ( ! F_68 ( V_145 ) ) {
V_4 = F_78 ( V_145 , V_122 , V_48 ) ;
F_83 ( V_145 ) ;
}
return V_4 ;
}
struct V_4 * F_84 ( struct V_1 * V_1 , struct V_147 * V_21 ,
const char * V_144 , int V_122 )
{
struct V_123 V_124 ;
int V_146 = F_76 ( V_122 , 0 , & V_124 ) ;
if ( V_146 )
return F_74 ( V_146 ) ;
if ( V_122 & V_108 )
return F_74 ( - V_9 ) ;
return F_85 ( V_1 , V_21 , V_144 , & V_124 ) ;
}
long F_86 ( int V_148 , const char T_2 * V_144 , int V_122 , T_3 V_48 )
{
struct V_123 V_124 ;
int V_34 = F_76 ( V_122 , V_48 , & V_124 ) ;
struct V_144 * V_149 ;
if ( V_34 )
return V_34 ;
V_149 = F_87 ( V_144 ) ;
...
V_34 = F_88 ( V_122 ) ;
if ( V_34 >= 0 ) {
struct V_4 * V_36 = F_79 ( V_148 , V_149 , & V_124 ) ;
if ( F_68 ( V_36 ) ) {
F_89 ( V_34 ) ;
V_34 = F_69 ( V_36 ) ;
} else {
...
int F_92 ( struct V_4 * V_5 , T_8 V_150 )
{
int V_151 = 0 ;
if ( ! F_93 ( V_5 ) ) {
F_94 ( V_152 L_1 ) ;
...
if ( V_5 -> V_63 -> V_153 )
V_151 = V_5 -> V_63 -> V_153 ( V_5 , V_150 ) ;
...
int F_97 ( struct V_18 * V_18 , struct V_4 * V_5 )
{
if ( ! ( V_5 -> V_38 & V_39 ) && F_98 ( V_18 ) > V_44 )
return - V_154 ;
return 0 ;
}
