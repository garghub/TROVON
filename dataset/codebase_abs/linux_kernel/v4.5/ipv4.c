...
F_32 ( V_81 -> V_2 ) ;
if ( ! F_33 ( V_79 , F_34 ( V_81 ) -> V_83 , F_34 ( V_81 ) -> V_84 ) ) {
F_35 ( V_82 , V_85 ) ;
} else {
F_36 ( V_81 -> V_86 , V_81 ) ;
}
...
static void F_38 ( struct V_75 * V_76 , T_3 V_87 )
{
...
struct V_10 * V_11 ;
struct V_8 * V_9 ;
const int type = F_39 ( V_76 ) -> type ;
const int V_93 = F_39 ( V_76 ) -> V_93 ;
struct V_1 * V_2 ;
T_6 V_79 ;
int V_20 ;
struct V_82 * V_82 = F_40 ( V_76 -> V_94 ) ;
if ( V_76 -> V_95 < V_89 + sizeof( * V_92 ) ||
V_76 -> V_95 < V_89 + F_41 ( V_92 ) ) {
F_42 ( V_82 , V_96 ) ;
return;
}
V_2 = F_43 ( V_82 , & V_97 ,
V_63 -> V_14 , V_92 -> V_98 ,
V_63 -> V_47 , F_44 ( V_92 -> V_99 ) ,
F_45 ( V_76 ) ) ;
if ( ! V_2 ) {
F_42 ( V_82 , V_96 ) ;
return;
...
! F_33 ( V_79 , V_11 -> V_105 , V_11 -> V_106 ) ) {
F_35 ( V_82 , V_85 ) ;
goto V_59;
}
switch ( type ) {
...
struct V_75 * V_76 ;
struct V_65 * V_54 ;
struct V_82 * V_82 = F_40 ( F_81 ( V_149 ) -> V_94 ) ;
...
static void F_86 ( struct V_80 * V_81 )
{
F_87 ( & F_34 ( V_81 ) -> V_160 ) ;
F_88 ( F_63 ( V_81 ) -> V_31 ) ;
}
void F_89 ( const struct V_80 * V_81 )
{
}
int F_90 ( struct V_1 * V_2 , struct V_75 * V_76 )
{
struct V_128 * V_129 ;
struct V_80 * V_81 ;
struct V_161 * V_162 ;
const T_2 V_163 = F_91 ( V_76 ) -> V_164 ;
struct V_165 * V_166 = F_92 ( V_76 ) ;
...
if ( F_94 ( V_2 ) )
goto V_169;
if ( F_61 ( V_2 ) && F_95 ( V_2 ) > 1 )
goto V_169;
V_81 = F_96 ( & V_171 , V_2 , true ) ;
if ( V_81 == NULL )
goto V_169;
if ( F_97 ( V_81 , F_3 ( V_2 ) , V_76 ) )
goto V_172;
V_162 = F_34 ( V_81 ) ;
if ( F_98 ( V_2 , V_162 , V_76 ) )
goto V_172;
if ( F_99 ( V_2 , V_76 , V_81 ) )
goto V_172;
V_129 = F_63 ( V_81 ) ;
...
int F_102 ( struct V_1 * V_2 , struct V_75 * V_76 )
{
struct V_91 * V_92 = V_91 ( V_76 ) ;
if ( V_2 -> V_66 == V_180 ) {
...
if ( F_104 ( V_2 , V_76 , V_92 , V_76 -> V_95 ) )
goto V_181;
return 0 ;
V_181:
F_80 ( V_2 , V_76 ) ;
...
int F_106 ( struct V_75 * V_76 )
{
const struct V_91 * V_92 ;
unsigned int V_182 ;
if ( V_76 -> V_183 != V_184 )
return 1 ;
if ( ! F_107 ( V_76 , sizeof( struct V_91 ) ) ) {
F_108 ( L_1 ) ;
return 1 ;
}
V_92 = V_91 ( V_76 ) ;
...
if ( V_92 -> V_186 < F_109 ( V_76 ) / sizeof( T_3 ) ) {
F_108 ( L_3 , V_92 -> V_186 ) ;
return 1 ;
}
if ( ! F_107 ( V_76 , V_92 -> V_186 * sizeof( T_3 ) ) ) {
F_108 ( L_4 , V_92 -> V_186 ) ;
return 1 ;
}
if ( ( V_92 -> V_154 < V_187 ||
...
V_76 -> V_124 = F_112 ( V_76 , 0 , V_182 , 0 ) ;
return 0 ;
}
...
V_92 = V_91 ( V_76 ) ;
F_92 ( V_76 ) -> V_176 = F_48 ( V_92 ) ;
F_92 ( V_76 ) -> V_193 = V_92 -> V_154 ;
F_114 ( L_8 ,
F_110 ( V_92 -> V_154 ) ,
& V_63 -> V_47 , F_44 ( V_92 -> V_99 ) ,
& V_63 -> V_14 , F_44 ( V_92 -> V_98 ) ,
( unsigned long long ) F_92 ( V_76 ) -> V_176 ) ;
if ( F_115 ( V_76 ) ) {
F_92 ( V_76 ) -> V_194 = V_195 ;
F_116 ( L_9 ) ;
} else {
F_92 ( V_76 ) -> V_194 = F_117 ( V_76 ) ;
F_116 ( L_10 , ( unsigned long long )
F_92 ( V_76 ) -> V_194 ) ;
}
V_196:
V_2 = F_118 ( & V_97 , V_76 ,
