...
return - V_34 ;
V_23 = & V_14 -> V_23 ;
V_30 = F_23 ( V_23 -> V_35 -> V_36 , V_23 ) ;
if ( ! V_30 )
return - V_37 ;
V_32 = F_24 ( V_23 , V_38 , 1 ,
V_39 ) ;
if ( F_25 ( V_32 ) ) {
F_12 ( V_23 , L_3 ) ;
return - V_37 ;
...
if ( ! V_45 )
return - V_37 ;
V_46 = F_30 ( V_45 , L_6 , 0 ) ;
if ( V_46 < 0 ) {
F_12 ( & V_14 -> V_23 ,
L_7 ) ;
return V_46 ;
}
V_12 = F_31 ( & V_14 -> V_23 , V_46 ,
V_48 , V_38 ) ;
if ( V_12 ) {
F_12 ( & V_14 -> V_23 , L_8 ) ;
return V_12 ;
...
V_3 -> V_41 . V_42 = V_50 -> V_42 ;
V_3 -> V_41 . V_43 = V_50 -> V_43 ;
return 0 ;
}
static int F_35 ( struct V_13 * V_14 ,
const struct V_52 * V_30 )
{
struct V_2 * V_3 ;
struct V_49 * V_50 ;
int V_12 ;
F_19 ( & V_14 -> V_23 , L_11 , V_53 ) ;
F_19 ( & V_14 -> V_23 , L_12 , V_14 -> V_9 ) ;
if ( ! F_36 ( V_14 -> V_54 , V_55 ) ) {
F_12 ( & V_14 -> V_23 , L_13 ) ;
return - V_37 ;
}
