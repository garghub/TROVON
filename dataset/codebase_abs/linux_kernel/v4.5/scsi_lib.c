...
V_253 -> V_311 = V_311 ;
} else if ( ( F_234 ( V_28 ) == V_317 ) &&
F_233 ( V_54 ) &&
V_54 -> V_140 == V_146 && V_312 ) {
V_312 -- ;
goto V_314;
}
return V_28 ;
...
int
F_236 ( struct V_7 * V_20 , enum V_320 V_321 )
{
enum V_320 V_322 = V_20 -> V_190 ;
if ( V_321 == V_322 )
return 0 ;
switch ( V_321 ) {
case V_323 :
...
static void F_239 ( struct V_7 * V_20 , struct V_326 * V_327 )
{
int V_328 = 0 ;
char * V_329 [ 3 ] ;
switch ( V_327 -> V_330 ) {
...
V_329 [ V_328 ++ ] = NULL ;
F_240 ( & V_20 -> V_24 . V_338 , V_339 , V_329 ) ;
}
...
enum V_340 V_330 ;
F_47 ( V_341 ) ;
V_20 = F_59 ( V_80 , struct V_7 , V_342 ) ;
for ( V_330 = V_343 ; V_330 <= V_344 ; V_330 ++ )
if ( F_242 ( V_330 , V_20 -> V_345 ) )
F_243 ( V_20 , V_330 , V_257 ) ;
while ( 1 ) {
struct V_326 * V_327 ;
struct V_346 * V_347 , * V_69 ;
unsigned long V_26 ;
F_11 ( & V_20 -> V_108 , V_26 ) ;
F_48 ( & V_20 -> V_341 , & V_341 ) ;
F_14 ( & V_20 -> V_108 , V_26 ) ;
if ( F_49 ( & V_341 ) )
break;
F_244 (this, tmp, &event_list) {
V_327 = F_50 ( V_347 , struct V_326 , V_348 ) ;
F_245 ( & V_327 -> V_348 ) ;
F_239 ( V_20 , V_327 ) ;
F_28 ( V_327 ) ;
}
...
void F_246 ( struct V_7 * V_20 , struct V_326 * V_327 )
{
unsigned long V_26 ;
#if 0
...
#endif
F_11 ( & V_20 -> V_108 , V_26 ) ;
F_147 ( & V_327 -> V_348 , & V_20 -> V_341 ) ;
F_247 ( & V_20 -> V_342 ) ;
F_14 ( & V_20 -> V_108 , V_26 ) ;
}
struct V_326 * F_248 ( enum V_340 V_330 ,
T_2 V_349 )
{
struct V_326 * V_327 = F_26 ( sizeof( struct V_326 ) , V_349 ) ;
if ( ! V_327 )
return NULL ;
V_327 -> V_330 = V_330 ;
F_155 ( & V_327 -> V_348 ) ;
...
enum V_340 V_330 , T_2 V_349 )
{
struct V_326 * V_327 = F_248 ( V_330 , V_349 ) ;
if ( ! V_327 ) {
...
static void
F_252 ( struct V_7 * V_20 , void * V_253 )
{
F_249 ( V_20 ) ;
}
void
...
static void
F_255 ( struct V_7 * V_20 , void * V_253 )
{
F_251 ( V_20 ) ;
}
void
...
unsigned long V_26 ;
int V_350 = 0 ;
V_350 = F_236 ( V_20 , V_196 ) ;
if ( V_350 ) {
V_350 = F_236 ( V_20 , V_197 ) ;
if ( V_350 )
return V_350 ;
}
if ( V_22 -> V_29 ) {
...
static void
F_262 ( struct V_7 * V_20 , void * V_253 )
{
F_257 ( V_20 ) ;
}
static int
F_263 ( struct V_6 * V_267 , void * V_253 )
{
if ( F_264 ( V_267 ) )
F_254 ( F_265 ( V_267 ) , NULL ,
F_262 ) ;
return 0 ;
}
void
F_266 ( struct V_6 * V_267 )
{
if ( F_264 ( V_267 ) )
F_254 ( F_265 ( V_267 ) , NULL ,
F_262 ) ;
else
F_267 ( V_267 , NULL , F_263 ) ;
}
static void
F_268 ( struct V_7 * V_20 , void * V_253 )
{
F_260 ( V_20 , * (enum V_320 * ) V_253 ) ;
}
static int
F_269 ( struct V_6 * V_267 , void * V_253 )
{
if ( F_264 ( V_267 ) )
F_254 ( F_265 ( V_267 ) , V_253 ,
F_268 ) ;
return 0 ;
}
void
F_270 ( struct V_6 * V_267 , enum V_320 V_351 )
{
if ( F_264 ( V_267 ) )
F_254 ( F_265 ( V_267 ) , & V_351 ,
F_268 ) ;
else
F_267 ( V_267 , & V_351 , F_269 ) ;
}
void * F_271 ( struct V_85 * V_86 , int V_352 ,
T_5 * V_353 , T_5 * V_139 )
{
int V_289 ;
T_5 V_354 = 0 , V_355 = 0 ;
...
F_171 ( V_194 L_31
L_32 ,
V_226 , V_354 , * V_353 , V_352 ) ;
F_272 ( 1 ) ;
return NULL ;
}
* V_353 = * V_353 - V_355 + V_236 -> V_353 ;
V_356 = F_275 ( F_276 ( V_236 ) , ( * V_353 >> V_266 ) ) ;
* V_353 &= ~ V_357 ;
V_354 = V_358 - * V_353 ;
if ( * V_139 > V_354 )
* V_139 = V_354 ;
...
{
if ( F_120 ( F_43 ( & V_20 -> V_360 ) <= 0 ) )
return;
F_32 ( & V_20 -> V_360 ) ;
}
int F_282 ( struct V_7 * V_20 , char * V_361 , T_5 V_362 )
{
T_6 V_363 = 0xff ;
T_6 V_364 = 0 ;
unsigned char * V_365 , * V_366 ;
unsigned char T_7 * V_367 ;
int V_368 = - V_303 ;
F_283 () ;
V_367 = F_284 ( V_20 -> V_367 ) ;
if ( ! V_367 ) {
F_285 () ;
return - V_369 ;
}
...
memset ( V_361 , 0 , V_362 ) ;
V_365 = V_367 + 4 ;
while ( V_365 < V_367 + V_20 -> V_370 ) {
if ( ( V_365 [ 1 ] & 0x30 ) != 0x00 )
goto V_371;
switch ( V_365 [ 1 ] & 0xf ) {
case 0x2 :
if ( V_364 > V_365 [ 3 ] )
...
int F_286 ( struct V_7 * V_20 , int * V_372 )
{
unsigned char * V_365 ;
unsigned char T_7 * V_367 ;
int V_373 = - V_374 , V_375 = - 1 ;
F_283 () ;
V_367 = F_284 ( V_20 -> V_367 ) ;
if ( ! V_367 ) {
F_285 () ;
...
V_365 = V_20 -> V_367 + 4 ;
while ( V_365 < V_20 -> V_367 + V_20 -> V_370 ) {
switch ( V_365 [ 1 ] & 0xf ) {
case 0x4 :
V_375 = F_287 ( & V_365 [ 6 ] ) ;
break;
