...
V_78 = F_26 ( V_23 ) ;
for ( V_58 = V_78 -> V_59 ; V_58 != V_78 ; V_58 = V_58 -> V_59 ) {
...
if ( V_8 -> V_258 ) {
if ( memcmp ( V_255 -> V_16 . V_81 , V_8 -> V_259 , V_80 ) )
goto exit;
}
if ( V_8 -> V_24 . V_102 ) {
...
int V_10 = V_11 ;
V_267 = F_129 ( sizeof( struct V_266 ) , V_273 ) ;
if ( V_267 == NULL ) {
V_10 = V_27 ;
goto exit;
}
V_269 = F_129 ( sizeof( struct V_268 ) , V_273 ) ;
if ( V_269 == NULL ) {
F_11 ( V_267 ) ;
V_10 = V_27 ;
goto exit;
...
( L_55 ,
V_94 -> V_188 ) ) ;
V_10 = F_130 ( V_271 , V_267 ) ;
exit:
return V_10 ;
}
int F_131 ( struct V_1 * V_1 , struct V_93 * V_94 , int V_281 , T_1 V_282 )
{
T_1 V_283 ;
struct V_266 * V_267 ;
struct V_284 * V_285 ;
...
if ( V_267 == NULL )
return V_27 ;
V_285 = F_129 ( sizeof( struct V_284 ) , V_273 ) ;
if ( V_285 == NULL ) {
V_10 = V_27 ;
goto V_286;
}
...
int F_133 ( struct V_1 * V_1 , T_1 * V_300 , T_1 * V_301 , T_5 V_302 , T_5 V_303 )
{
...
static int F_134 ( struct V_1 * V_306 , T_1 * V_307 )
{
...
static int F_135 ( struct V_1 * V_306 , int V_312 , T_1 * V_87 , T_5 V_313 )
{
struct V_93 * V_94 = & V_306 -> V_95 ;
if ( V_87 [ 13 ] <= 20 ) {
V_87 [ V_313 ] = 1 ;
...
int F_136 ( struct V_1 * V_1 , T_1 * V_300 , T_1 * V_301 , T_5 V_302 )
{
T_1 V_315 ;
T_5 V_304 ;
int V_312 ;
...
F_137 ( V_1 , V_315 , V_94 -> V_326 ) ;
}
V_312 = F_134 ( V_1 , V_8 -> V_259 ) ;
if ( V_312 < 0 ) {
return V_304 ;
} else {
if ( V_315 == V_324 )
V_304 = F_135 ( V_1 , V_312 , V_301 , V_304 ) ;
}
return V_304 ;
}
...
V_355 = 0 ;
F_107 ( V_2 , V_363 , ( T_1 * ) ( & V_355 ) ) ;
} else {
V_355 = 1 ;
F_107 ( V_2 , V_363 , ( T_1 * ) ( & V_355 ) ) ;
}
}
unsigned int F_142 ( struct V_1 * V_2 , T_1 * V_300 , T_1 * V_301 , T_5 V_302 , T_5 * V_364 )
{
T_2 V_365 , V_366 ;
enum V_367 V_368 ;
unsigned char * V_369 ;
...
T_2 V_376 , V_377 ;
V_357 -> V_362 = false ;
V_369 = F_143 ( V_300 + 12 , V_378 , & V_365 , V_302 - 12 ) ;
if ( V_369 && V_365 > 0 ) {
if ( V_374 -> V_236 == 0 ) {
V_366 = * V_364 ;
F_144 ( V_301 + V_366 , V_379 ,
V_380 , V_372 , V_364 ) ;
V_374 -> V_236 = 1 ;
}
V_366 = * V_364 ;
...
F_144 ( V_301 + V_366 , V_378 ,
sizeof( struct V_370 ) , ( unsigned char * ) & V_371 , V_364 ) ;
V_357 -> V_362 = true ;
V_369 = F_143 ( V_300 + 12 , V_392 , & V_365 , V_302 - 12 ) ;
if ( V_369 && ( V_365 == sizeof( struct V_393 ) ) ) {
V_366 = * V_364 ;
F_144 ( V_301 + V_366 , V_392 , V_365 , V_369 + 2 , V_364 ) ;
}
}
return V_357 -> V_362 ;
}
void F_98 ( struct V_1 * V_2 , T_1 * V_394 , T_5 V_313 )
{
T_1 * V_369 , V_395 ;
int V_145 ;
struct V_370 * V_396 ;
...
V_145 = 0 ;
V_369 = F_143 ( V_394 + sizeof( struct V_126 ) , V_378 , & V_145 , V_313 - sizeof( struct V_126 ) ) ;
if ( V_369 && V_145 > 0 ) {
...
V_145 = 0 ;
V_369 = F_143 ( V_394 + sizeof( struct V_126 ) , V_392 , & V_145 , V_313 - sizeof( struct V_126 ) ) ;
if ( ( V_250 -> V_401 ) &&
( F_33 ( V_221 -> V_402 . V_403 . V_404 . V_405 ) & F_132 ( 1 ) ) &&
( V_221 -> V_406 . V_407 [ 0 ] & F_132 ( 2 ) ) ) {
int V_3 ;
T_1 V_408 ;
...
void F_145 ( struct V_1 * V_2 , struct V_428 * V_429 )
{
T_1 V_430 ;
int V_431 ;
...
V_167 = F_76 ( & V_2 -> V_162 , V_433 -> V_436 ) ;
if ( V_167 == NULL )
return;
V_357 = & V_167 -> V_358 ;
...
if ( 0 == V_430 ) {
F_52 ( L_65 , V_431 ) ;
V_167 -> V_358 . V_440 |= F_132 ( ( T_1 ) V_431 ) ;
F_147 ( V_2 , ( T_1 ) V_431 , V_433 -> V_436 ) ;
}
}
}
