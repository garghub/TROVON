...
if ( V_10 -> V_32 . V_243 < 3 )
return;
V_224 = 0 ;
if ( V_189 & V_244 )
V_224 |= V_245 ;
V_10 -> V_32 . V_224 = V_224 ;
}
STATIC void
F_89 (
struct V_9 * V_10 )
...
struct V_207 * V_208 )
{
struct V_250 * V_82 = V_10 -> V_23 ;
if ( ( V_10 -> V_32 . V_223 || V_10 -> V_251 ) &&
F_92 ( V_10 ) != ( V_208 -> V_210 & V_239 ) )
return - V_16 ;
if ( V_208 -> V_210 & V_239 ) {
if ( V_82 -> V_143 . V_252 == 0 || V_82 -> V_143 . V_253 == 0 ||
( V_10 -> V_32 . V_212 % V_82 -> V_143 . V_253 ) )
return - V_16 ;
}
...
{
struct V_250 * V_82 = V_10 -> V_23 ;
if ( ( V_208 -> V_210 & V_241 ) && ! F_7 ( V_10 -> V_32 . V_230 ) )
return - V_16 ;
if ( ( V_208 -> V_210 & V_235 ) &&
! F_8 ( V_10 -> V_32 . V_230 ) )
return - V_16 ;
if ( F_7 ( V_10 -> V_32 . V_230 ) && V_10 -> V_32 . V_223 &&
( ( V_10 -> V_32 . V_212 << V_82 -> V_143 . V_213 ) != V_208 -> V_211 ) )
return - V_16 ;
if ( V_208 -> V_211 != 0 ) {
T_24 V_119 ;
T_25 V_263 ;
V_263 = F_99 ( V_82 , V_208 -> V_211 ) ;
if ( V_263 > V_264 )
return - V_16 ;
if ( F_92 ( V_10 ) ||
( V_208 -> V_210 & V_239 ) ) {
V_119 = V_82 -> V_143 . V_253 << V_82 -> V_143 . V_213 ;
} else {
V_119 = V_82 -> V_143 . V_265 ;
if ( V_263 > V_82 -> V_143 . V_266 / 2 )
return - V_16 ;
}
if ( V_208 -> V_211 % V_119 )
return - V_16 ;
} else
V_208 -> V_210 &= ~ ( V_241 | V_235 ) ;
return 0 ;
}
static int
F_100 (
...
int V_272 ;
F_104 ( V_10 ) ;
V_272 = F_100 ( V_10 , V_208 ) ;
if ( V_272 )
return V_272 ;
if ( F_105 ( V_82 ) ) {
V_272 = F_106 ( V_10 , V_10 -> V_32 . V_273 ,
V_10 -> V_32 . V_274 , V_208 -> V_214 ,
...
V_272 = F_109 ( V_83 , V_10 , V_269 , NULL , V_270 ,
F_22 ( V_277 ) ? V_278 : 0 ) ;
if ( V_272 )
goto V_279;
}
V_272 = F_98 ( V_10 , V_208 ) ;
if ( V_272 )
goto V_279;
V_272 = F_91 ( V_83 , V_10 , V_208 ) ;
if ( V_272 )
goto V_279;
if ( ( V_10 -> V_32 . V_230 & ( V_280 | V_281 ) ) &&
! F_110 ( F_90 ( V_10 ) , V_282 ) )
V_10 -> V_32 . V_230 &= ~ ( V_280 | V_281 ) ;
if ( F_87 ( V_10 ) != V_208 -> V_214 ) {
if ( F_107 ( V_82 ) && F_108 ( V_82 ) ) {
V_271 = F_111 ( V_83 , V_10 ,
& V_10 -> V_283 , V_270 ) ;
}
ASSERT ( V_10 -> V_32 . V_243 > 1 ) ;
F_112 ( V_10 , V_208 -> V_214 ) ;
}
if ( V_10 -> V_32 . V_200 & ( V_242 | V_236 ) )
...
STATIC int
F_117 ( void * * V_286 , struct V_287 * V_288 , int * V_289 )
{
...
struct V_287 V_292 ;
int error ;
if ( F_17 ( & V_292 , V_91 , sizeof( struct V_287 ) ) )
return - V_36 ;
if ( V_292 . V_293 < 2 )
return - V_16 ;
...
if ( V_137 & V_149 )
V_292 . V_294 |= V_297 ;
error = F_119 ( V_10 , & V_292 , F_117 ,
( V_298 struct V_290 * ) V_91 + 1 ) ;
if ( error )
return error ;
if ( F_11 ( V_91 , & V_292 , sizeof( struct V_290 ) ) )
return - V_36 ;
return 0 ;
}
STATIC int
F_120 ( void * * V_286 , struct V_287 * V_288 , int * V_289 )
{
...
struct V_287 V_292 ;
int error ;
if ( F_17 ( & V_292 , V_91 , sizeof( V_292 ) ) )
return - V_36 ;
if ( V_292 . V_293 < 2 )
return - V_16 ;
if ( V_292 . V_294 & ( ~ V_299 ) )
return - V_16 ;
error = F_119 ( V_10 , & V_292 , F_120 ,
( V_298 struct V_287 * ) V_91 + 1 ) ;
if ( error )
return error ;
if ( F_11 ( V_91 , & V_292 , sizeof( struct V_287 ) ) )
return - V_36 ;
return 0 ;
}
int
...
if ( ! ( V_302 . V_12 -> V_72 & V_67 ) ||
! ( V_302 . V_12 -> V_72 & V_304 ) ||
( V_302 . V_12 -> V_70 & V_65 ) ) {
error = - V_13 ;
goto V_307;
}
if ( F_123 ( F_3 ( V_7 . V_12 ) ) ||
F_123 ( F_3 ( V_302 . V_12 ) ) ) {
error = - V_16 ;
goto V_307;
}
...
struct V_250 * V_82 = V_10 -> V_23 ;
void V_14 * V_91 = ( void V_14 * ) V_308 ;
int V_137 = 0 ;
int error ;
if ( V_57 -> V_72 & V_73 )
V_137 |= V_149 ;
...
T_27 * V_313 =
F_92 ( V_10 ) ?
V_82 -> V_314 : V_82 -> V_315 ;
V_312 . V_316 = V_312 . V_317 = V_313 -> V_318 ;
V_312 . V_319 = V_122 & ~ ( V_312 . V_317 - 1 ) ;
if ( F_11 ( V_91 , & V_312 , sizeof( V_312 ) ) )
return - V_36 ;
return 0 ;
}
case V_183 :
...
case V_323 :
return F_128 ( V_5 -> V_324 , ( int V_14 * ) V_91 ) ;
case V_325 :
...
case V_340 : {
struct V_341 V_300 ;
if ( F_17 ( & V_300 , V_91 , sizeof( T_26 ) ) )
return - V_36 ;
error = F_50 ( V_57 ) ;
if ( error )
return error ;
...
if ( ! F_22 ( V_59 ) )
return - V_60 ;
if ( F_134 ( V_345 , ( T_14 V_14 * ) V_91 ) )
return - V_36 ;
return F_135 ( V_82 , V_345 ) ;
}
case V_352 : {
T_34 V_345 ;
if ( ! F_22 ( V_59 ) )
