...
if ( V_2 -> V_62 != V_63 ) {
if ( ! ( V_61 -> V_64 & V_65 ) &&
( ! V_2 -> V_66 || V_2 -> V_66 -> V_67 &
( V_68 | V_69 ) ) ) {
V_2 -> V_62 = V_63 ;
V_2 -> V_70 = F_14 ( V_2 ) +
F_15 ( V_2 ) +
F_16 ( V_2 ) ;
V_2 -> V_71 = ( void * ) V_54 - V_49 ;
...
F_19 ( V_54 , V_2 ,
F_20 ( V_59 ) , F_20 ( V_58 ) , true ) ;
}
static int F_21 ( struct V_73 * V_74 [] ,
struct V_35 * V_36 )
{
if ( V_74 [ V_75 ] ) {
V_36 -> V_37 . V_22 = F_22 ( V_74 [ V_75 ] ) ;
V_36 -> V_76 |= V_77 ;
}
if ( V_74 [ V_78 ] )
V_36 -> V_38 . V_22 = F_22 ( V_74 [ V_78 ] ) ;
else
...
enum V_5 V_6 = F_24 ( V_80 ) ;
enum V_44 V_85 = F_25 ( V_81 ) ;
unsigned int V_86 = F_16 ( V_2 ) ;
const struct V_41 * V_42 ;
struct V_10 V_43 ;
unsigned long V_7 ;
F_26 ( V_80 == V_87 || V_80 == V_88 ) ;
if ( ! F_7 ( V_2 , V_86 + sizeof( * V_84 ) ) )
return 0 ;
if ( F_27 ( V_2 , V_81 , V_86 , 0 ) )
return 0 ;
V_84 = ( void * ) V_2 -> V_49 + V_86 ;
if ( V_84 -> V_83 . type == V_89 ) {
if ( ( V_4 -> V_18 & V_90 ) != V_90 )
return 0 ;
if ( V_4 -> V_18 & V_31 )
return 0 ;
}
...
if ( ! ( V_4 -> V_18 & V_7 ) )
return 1 ;
V_42 = F_28 ( V_94 , V_84 -> V_22 . V_95 ) ;
if ( ! F_6 ( V_2 , V_86 + sizeof( V_84 -> V_83 ) ,
V_42 , & V_4 -> V_12 [ ! V_6 ] . V_13 , ! V_85 ) )
return 0 ;
if ( V_2 -> V_62 != V_63 ) {
V_84 = ( void * ) V_2 -> V_49 + V_86 ;
V_84 -> V_83 . V_96 = 0 ;
