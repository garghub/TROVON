...
struct V_21 * V_21 = F_17 ( V_39 -> V_40 . V_22 ) ;
enum V_51 V_51 = V_21 -> V_51 ;
struct V_57 * V_58 = V_34 -> V_59 ;
const T_4 * V_37 = V_27 -> V_37 ;
struct V_60 * V_61 =
F_25 ( & V_39 -> V_40 ) ;
enum V_62 V_62 = V_61 -> V_62 ;
T_2 V_15 ;
int V_48 , V_3 ;
int V_11 , V_8 ;
F_3 ( L_7 ,
...
T_2 V_15 ;
int V_48 , V_3 ;
T_3 V_73 , V_68 , V_74 , V_69 ;
F_3 ( L_11 ,
F_30 ( V_62 ) , F_18 ( V_51 ) , F_11 ( V_37 ) ) ;
if ( F_31 ( V_62 == V_65 ) )
return;
if ( F_32 ( V_27 -> V_35 ) ) {
V_73 = F_40 ( V_51 ) ;
...
if ( V_34 -> V_79 . V_80 )
V_34 -> V_79 . V_80 ( V_27 , V_38 ,
V_2 ) ;
F_19 ( & V_34 -> V_52 ) ;
V_61 -> V_81 = V_27 ;
V_34 -> V_82 [ V_62 ] = V_38 ;
F_23 ( & V_34 -> V_52 ) ;
if ( V_58 && V_58 -> V_83 && V_58 -> V_83 -> V_84 )
V_58 -> V_83 -> V_84 ( V_58 -> V_83 -> V_85 , ( int ) V_62 ) ;
}
...
void F_50 ( struct V_76 * V_35 )
{
struct V_33 * V_34 = V_35 -> V_36 ;
if ( F_51 ( V_35 ) ) {
V_34 -> V_79 . V_80 = F_13 ;
V_34 -> V_79 . V_86 = F_12 ;
} else if ( F_34 ( V_35 ) || F_35 ( V_35 ) ) {
V_34 -> V_79 . V_80 = F_39 ;
V_34 -> V_79 . V_86 = F_29 ;
} else if ( F_52 ( V_35 ) || F_53 ( V_35 ) -> V_87 >= 8 ) {
V_34 -> V_79 . V_80 = F_24 ;
V_34 -> V_79 . V_86 = F_16 ;
} else if ( F_54 ( V_35 ) ) {
V_34 -> V_79 . V_80 = F_39 ;
...
static void F_55 ( struct V_88 * V_35 )
{
F_56 ( F_57 ( V_35 ) , V_89 ) ;
}
static void F_58 ( struct V_88 * V_35 )
{
F_59 ( F_57 ( V_35 ) , V_89 ) ;
}
static void F_60 ( struct V_88 * V_35 ,
bool V_90 )
{
...
static int F_64 ( struct V_88 * V_35 )
{
struct V_33 * V_34 = F_57 ( V_35 ) ;
int V_93 ;
if ( F_65 ( ! F_66 ( V_34 ) ) )
return - V_94 ;
F_56 ( V_34 , V_89 ) ;
V_93 = V_34 -> V_79 . V_95 ( V_34 -> V_35 ) ;
F_59 ( V_34 , V_89 ) ;
return V_93 ;
}
static int F_67 ( struct V_88 * V_35 ,
int V_62 , int V_8 )
{
struct V_33 * V_34 = F_57 ( V_35 ) ;
struct V_38 * V_38 ;
...
static int F_69 ( struct V_88 * V_35 , int V_62 ,
bool * V_99 ,
unsigned char * V_100 , int V_101 )
{
struct V_33 * V_34 = F_57 ( V_35 ) ;
struct V_38 * V_38 ;
struct V_60 * V_61 ;
...
V_37 = V_61 -> V_81 -> V_37 ;
V_93 = F_11 ( V_37 ) ;
memcpy ( V_100 , V_37 , F_14 ( V_101 , V_93 ) ) ;
}
}
F_23 ( & V_34 -> V_52 ) ;
return V_93 ;
}
static int F_70 ( struct V_88 * V_103 ,
struct V_88 * V_104 , void * V_105 )
{
struct V_57 * V_58 = V_105 ;
struct V_33 * V_34 = F_57 ( V_103 ) ;
int V_3 ;
if ( F_31 ( V_58 -> V_106 || V_58 -> V_35 ) )
return - V_107 ;
F_71 ( V_34 -> V_35 ) ;
V_58 -> V_106 = & V_108 ;
V_58 -> V_35 = V_103 ;
F_72 ( V_109 != V_110 ) ;
for ( V_3 = 0 ; V_3 < F_2 ( V_58 -> V_67 ) ; V_3 ++ )
V_58 -> V_67 [ V_3 ] = 0 ;
V_34 -> V_59 = V_58 ;
F_73 ( V_34 -> V_35 ) ;
return 0 ;
}
static void F_74 ( struct V_88 * V_103 ,
struct V_88 * V_104 , void * V_105 )
{
struct V_57 * V_58 = V_105 ;
struct V_33 * V_34 = F_57 ( V_103 ) ;
...
{
int V_93 ;
V_93 = F_76 ( V_34 -> V_35 -> V_35 , & V_111 ) ;
if ( V_93 < 0 ) {
F_28 ( L_17 , V_93 ) ;
return;
}
