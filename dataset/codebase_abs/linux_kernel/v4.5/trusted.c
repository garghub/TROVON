...
if ( V_133 < 0 )
return V_133 ;
V_127 -> V_68 = V_133 ? V_134 : V_135 ;
V_127 -> V_136 = V_137 [ V_127 -> V_68 ] ;
while ( ( V_119 = F_45 ( & V_30 , L_8 ) ) ) {
if ( * V_119 == '\0' || * V_119 == ' ' || * V_119 == '\t' )
continue;
V_129 = F_46 ( V_119 , V_138 , args ) ;
if ( F_47 ( V_129 , & V_132 ) )
return - V_24 ;
switch ( V_129 ) {
case V_139 :
V_127 -> V_125 = strlen ( args [ 0 ] . V_140 ) / 2 ;
if ( V_127 -> V_125 > V_141 )
return - V_24 ;
V_130 = F_48 ( V_127 -> V_91 , args [ 0 ] . V_140 ,
V_127 -> V_125 ) ;
if ( V_130 < 0 )
return - V_24 ;
break;
case V_142 :
V_130 = F_49 ( args [ 0 ] . V_140 , 16 , & V_75 ) ;
if ( V_130 < 0 )
return - V_24 ;
V_127 -> V_85 = V_143 ;
V_127 -> V_86 = V_75 ;
break;
case V_144 :
if ( strlen ( args [ 0 ] . V_140 ) != 2 * V_29 )
return - V_24 ;
V_130 = F_48 ( V_127 -> V_87 , args [ 0 ] . V_140 ,
V_29 ) ;
if ( V_130 < 0 )
return - V_24 ;
break;
...
if ( strlen ( args [ 0 ] . V_140 ) != 2 * V_29 )
return - V_24 ;
V_130 = F_48 ( V_127 -> V_90 , args [ 0 ] . V_140 ,
V_29 ) ;
if ( V_130 < 0 )
return - V_24 ;
break;
...
break;
case V_147 :
V_130 = F_49 ( args [ 0 ] . V_140 , 10 , & V_131 ) ;
if ( V_130 < 0 )
return - V_24 ;
V_127 -> F_25 = V_131 ;
break;
...
if ( F_50 ( V_149 , & V_132 ) )
return - V_24 ;
for ( V_102 = 0 ; V_102 < V_150 ; V_102 ++ ) {
if ( ! strcmp ( args [ 0 ] . V_140 , V_151 [ V_102 ] ) ) {
V_127 -> V_68 = V_102 ;
V_127 -> V_136 =
V_137 [ V_127 -> V_68 ] ;
break;
...
case V_149 :
if ( ! V_133 ||
strlen ( args [ 0 ] . V_140 ) != ( 2 * V_127 -> V_136 ) )
return - V_24 ;
V_130 = F_48 ( V_127 -> V_152 , args [ 0 ] . V_140 ,
V_127 -> V_136 ) ;
if ( V_130 < 0 )
return - V_24 ;
break;
...
static int F_51 ( char * V_155 , struct V_118 * V_119 ,
struct V_120 * V_121 )
{
T_6 args [ V_128 ] ;
long V_18 ;
...
if ( V_14 < 0 || V_18 < V_158 || V_18 > V_159 )
return - V_24 ;
V_119 -> V_122 = V_18 ;
V_14 = F_43 ( V_155 , V_119 , V_121 ) ;
if ( V_14 < 0 )
return V_14 ;
V_14 = V_157 ;
break;
...
struct V_166 * V_167 )
{
struct V_118 * V_168 = NULL ;
struct V_120 * V_164 = NULL ;
T_5 V_12 = V_167 -> V_12 ;
char * V_155 ;
int V_14 = 0 ;
int V_156 ;
...
if ( V_133 < 0 )
return V_133 ;
if ( V_12 <= 0 || V_12 > 32767 || ! V_167 -> V_11 )
return - V_24 ;
V_155 = F_3 ( V_12 + 1 , V_6 ) ;
if ( ! V_155 )
return - V_7 ;
memcpy ( V_155 , V_167 -> V_11 , V_12 ) ;
V_155 [ V_12 ] = '\0' ;
V_164 = F_53 () ;
if ( ! V_164 ) {
V_14 = - V_7 ;
...
case V_160 :
if ( V_133 )
V_14 = F_59 ( V_70 , V_168 , V_164 ) ;
else
V_14 = F_42 ( V_168 , V_164 ) ;
F_57 ( V_168 ) ;
F_58 ( V_164 ) ;
if ( V_14 < 0 )
F_7 ( L_10 , V_14 ) ;
...
case V_157 :
V_122 = V_168 -> V_122 ;
V_14 = F_27 ( V_70 , V_168 -> V_17 , V_122 ) ;
if ( V_14 != V_122 ) {
F_7 ( L_11 , V_14 ) ;
goto V_23;
}
if ( V_133 )
V_14 = F_60 ( V_70 , V_168 , V_164 ) ;
else
V_14 = F_40 ( V_168 , V_164 ) ;
if ( V_14 < 0 )
F_7 ( L_12 , V_14 ) ;
break;
default:
...
{
struct V_118 * V_119 ;
V_119 = F_63 ( V_170 , struct V_118 , V_170 ) ;
memset ( V_119 -> V_17 , 0 , V_119 -> V_122 ) ;
F_10 ( V_119 ) ;
}
static int F_64 ( struct V_17 * V_17 , struct V_166 * V_167 )
{
struct V_118 * V_119 ;
struct V_118 * V_171 ;
struct V_120 * V_172 ;
...
char * V_155 ;
int V_14 = 0 ;
if ( F_50 ( V_173 , & V_17 -> V_10 ) )
return - V_174 ;
V_119 = V_17 -> V_168 . V_11 [ 0 ] ;
if ( ! V_119 -> V_123 )
return - V_66 ;
if ( V_12 <= 0 || V_12 > 32767 || ! V_167 -> V_11 )
return - V_24 ;
...
V_171 -> V_123 = V_119 -> V_123 ;
V_171 -> V_122 = V_119 -> V_122 ;
memcpy ( V_171 -> V_17 , V_119 -> V_17 , V_119 -> V_122 ) ;
F_57 ( V_119 ) ;
F_57 ( V_171 ) ;
V_14 = F_40 ( V_171 , V_172 ) ;
if ( V_14 < 0 ) {
F_7 ( L_12 , V_14 ) ;
F_10 ( V_171 ) ;
goto V_23;
...
V_175 = F_3 ( 2 * V_119 -> V_124 , V_6 ) ;
if ( ! V_175 )
return - V_7 ;
V_176 = V_175 ;
for ( V_102 = 0 ; V_102 < V_119 -> V_124 ; V_102 ++ )
V_176 = F_68 ( V_176 , V_119 -> V_88 [ V_102 ] ) ;
if ( ( F_69 ( V_32 , V_175 , 2 * V_119 -> V_124 ) ) != 0 ) {
F_10 ( V_175 ) ;
return - V_177 ;
}
F_10 ( V_175 ) ;
...
{
struct V_118 * V_119 = V_17 -> V_168 . V_11 [ 0 ] ;
if ( ! V_119 )
return;
memset ( V_119 -> V_17 , 0 , V_119 -> V_122 ) ;
F_10 ( V_17 -> V_168 . V_11 [ 0 ] ) ;
}
...
{
int V_14 ;
V_21 = F_74 ( V_22 , 0 , V_178 ) ;
if ( F_6 ( V_21 ) ) {
F_7 ( L_14 ,
V_22 ) ;
return F_8 ( V_21 ) ;
}
V_15 = F_74 ( V_16 , 0 , V_178 ) ;
if ( F_6 ( V_15 ) ) {
F_7 ( L_14 ,
V_16 ) ;
V_14 = F_8 ( V_15 ) ;
