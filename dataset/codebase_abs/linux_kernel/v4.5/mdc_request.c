...
static int F_174 ( const struct V_230 * V_231 ,
struct V_9 * exp ,
T_5 V_249 , void * V_251 ,
...
static int F_178 ( const struct V_230 * V_231 , struct V_9 * exp ,
...
static int F_179 ( struct V_9 * exp , const struct V_10 * V_67 ,
struct V_1 * * V_42 )
{
struct V_1 * V_2 ;
int V_8 ;
...
static int F_180 ( struct V_186 * V_187 , struct V_163 * V_164 ,
enum V_500 V_501 )
{
int V_8 = 0 ;
...
if ( V_4 -> V_504 != NULL )
F_181 ( V_4 -> V_504 ) ;
V_8 = F_182 ( V_187 , V_187 , V_505 , NULL ) ;
break;
}
case V_506 : {
...
case V_511 :
V_8 = F_182 ( V_187 , V_187 , V_512 , NULL ) ;
if ( V_8 == 0 )
V_8 = F_184 ( V_466 ,
F_173 ,
( void * ) V_164 ) ;
break;
case V_513 :
V_8 = F_182 ( V_187 , V_187 , V_514 , NULL ) ;
break;
case V_515 :
case V_516 :
break;
...
return F_185 ( NULL , V_518 , V_67 ) ;
}
static struct V_375 * F_186 ( struct V_9 * exp )
{
struct V_3 * V_4 = & exp -> V_103 -> V_7 . V_4 ;
return & V_4 -> V_376 ;
}
static int F_187 ( struct V_519 * V_520 )
{
...
static int F_188 ( struct V_528 * V_529 )
{
if ( V_529 -> V_530 )
V_529 -> V_530 = NULL ;
return 0 ;
}
static int F_189 ( struct V_186 * V_187 )
{
struct V_531 * V_532 = & V_187 -> V_533 ;
struct V_351 * V_352 ;
int V_8 ;
V_8 = F_190 ( NULL , V_187 , V_532 , V_354 , V_187 ,
& V_534 ) ;
if ( V_8 )
return V_8 ;
V_352 = F_191 ( V_532 , V_354 ) ;
F_192 ( V_352 ) ;
F_132 ( V_352 ) ;
return 0 ;
}
static void F_193 ( struct V_186 * V_187 )
{
struct V_351 * V_352 ;
...
static int F_195 ( struct V_186 * V_187 , struct V_535 * V_536 )
{
struct V_3 * V_4 = & V_187 -> V_7 . V_4 ;
...
F_196 ( V_4 -> V_203 ) ;
V_8 = F_198 ( V_187 , V_536 ) ;
if ( V_8 )
goto V_540;
F_199 ( & V_538 ) ;
F_200 ( V_187 , V_538 . V_541 , V_538 . V_542 ) ;
F_201 ( V_187 ) ;
F_202 ( V_187 ) ;
F_203 ( V_187 -> V_509 , F_187 ) ;
...
static int F_206 ( struct V_9 * exp , int V_545 ,
...
static int F_207 ( struct V_186 * V_187 , enum V_550 V_551 )
{
switch ( V_551 ) {
case V_552 :
break;
...
static int F_204 ( struct V_186 * V_187 )
{
struct V_3 * V_4 = & V_187 -> V_7 . V_4 ;
F_109 ( V_4 -> V_104 ) ;
F_109 ( V_4 -> V_203 ) ;
...
static int F_213 ( struct V_186 * V_187 , T_5 V_313 , void * V_112 )
{
...
static int F_215 ( struct V_9 * exp , const struct V_10 * V_67 ,
T_2 V_74 , struct V_1 * * V_42 )
{
struct V_1 * V_2 ;
int V_8 ;
