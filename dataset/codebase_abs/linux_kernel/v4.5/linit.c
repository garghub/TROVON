...
static void F_102 ( struct V_10 * V_40 )
{
int V_161 ;
F_67 ( V_40 ) ;
if ( V_40 -> V_169 -> V_63 == V_170 ||
...
F_71 ( V_40 -> V_169 -> V_178 , & ( V_40 -> V_177 [ 0 ] ) ) ;
}
} else {
F_71 ( V_40 -> V_169 -> V_178 , V_40 ) ;
}
...
{
int V_161 , V_230 ;
int V_231 = V_11 -> V_115 ;
const char * V_15 = V_11 -> V_15 ;
unsigned long V_232 ;
while ( ! ( ( V_232 = F_104 ( V_11 , V_233 . V_234 ) ) & V_235 )
|| V_232 == 0xffffffff )
F_105 ( 20 ) ;
F_67 ( V_11 ) ;
F_106 ( V_11 ) ;
if ( ( V_11 -> V_169 -> V_63 == V_171 ||
V_11 -> V_169 -> V_63 == V_172 ||
V_11 -> V_169 -> V_63 == V_173 ) )
F_107 ( V_11 ) ;
if ( V_11 -> V_236 )
F_108 ( V_11 , V_237 ) ;
if ( ! V_11 -> V_207 && V_11 -> V_236 && V_11 -> V_174 > 1 ) {
for ( V_161 = 0 ; V_161 < V_11 -> V_174 ; V_161 ++ ) {
V_11 -> V_177 [ V_161 ] . V_238 = V_161 ;
V_11 -> V_177 [ V_161 ] . V_11 = V_11 ;
if ( F_109 ( V_11 -> V_175 [ V_161 ] . V_176 ,
V_11 -> V_239 . V_240 ,
0 , L_31 , & ( V_11 -> V_177 [ V_161 ] ) ) ) {
F_25 ( V_72 L_32 ,
V_15 , V_231 , V_161 ) ;
for ( V_230 = 0 ; V_230 < V_161 ; V_230 ++ )
F_71 ( V_11 -> V_175 [ V_230 ] . V_176 ,
& ( V_11 -> V_177 [ V_230 ] ) ) ;
F_73 ( V_11 -> V_169 ) ;
goto V_241;
}
...
V_11 -> V_177 [ 0 ] . V_238 = 0 ;
V_11 -> V_177 [ 0 ] . V_11 = V_11 ;
if ( F_109 ( V_11 -> V_169 -> V_178 , V_11 -> V_239 . V_240 ,
V_242 , L_31 ,
& ( V_11 -> V_177 [ 0 ] ) ) < 0 ) {
if ( V_11 -> V_143 )
F_72 ( V_11 -> V_169 ) ;
...
static int F_111 ( struct V_179 * V_169 , T_6 V_243 )
{
struct V_1 * V_2 = F_112 ( V_169 ) ;
...
F_114 ( V_169 ) ;
F_101 ( V_169 ) ;
F_115 ( V_169 , F_116 ( V_169 , V_243 ) ) ;
return 0 ;
}
static int F_117 ( struct V_179 * V_169 )
{
struct V_1 * V_2 = F_112 ( V_169 ) ;
struct V_10 * V_40 = (struct V_10 * ) V_2 -> V_12 ;
int V_5 ;
...
return 0 ;
V_245:
F_25 ( V_208 L_34 , V_40 -> V_15 , V_40 -> V_115 ) ;
F_100 ( V_2 ) ;
F_101 ( V_169 ) ;
return - V_113 ;
}
static void F_121 ( struct V_179 * V_11 )
{
struct V_1 * V_2 = F_112 ( V_11 ) ;
F_113 ( V_2 ) ;
F_63 ( (struct V_10 * ) V_2 -> V_12 ) ;
}
static void F_122 ( struct V_179 * V_169 )
{
struct V_1 * V_2 = F_112 ( V_169 ) ;
struct V_10 * V_40 = (struct V_10 * ) V_2 -> V_12 ;
F_123 ( V_2 ) ;
