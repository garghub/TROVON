...
return V_6 ;
V_33:
F_10 ( V_28 -> V_40 , L_1 , V_30 ) ;
return V_31 ;
}
static int F_11 ( struct V_41 * V_42 ,
const struct V_43 * V_44 )
{
struct V_45 * V_46 = F_12 ( & V_42 -> V_40 ) ;
struct V_27 * V_28 ;
struct V_47 V_48 = { } ;
int error , V_21 , V_6 = 0 ;
V_28 = F_13 ( & V_42 -> V_40 , sizeof( struct V_27 ) , V_49 ) ;
if ( ! V_28 )
return - V_50 ;
V_28 -> V_40 = & V_42 -> V_40 ;
V_28 -> V_8 = F_14 ( V_42 , & V_51 ) ;
if ( F_15 ( V_28 -> V_8 ) ) {
error = F_16 ( V_28 -> V_8 ) ;
F_10 ( V_28 -> V_40 , L_2 ,
error ) ;
...
F_17 ( V_42 , V_28 ) ;
if ( V_42 -> V_26 != 0 ) {
V_6 = F_18 ( V_28 -> V_8 , V_52 , 0xFF ) ;
if ( V_6 < 0 ) {
F_10 ( V_28 -> V_40 ,
L_3 , V_6 ) ;
return V_6 ;
}
V_6 = F_18 ( V_28 -> V_8 , V_53 , 0xFF ) ;
if ( V_6 < 0 ) {
F_10 ( V_28 -> V_40 ,
L_4 , V_6 ) ;
return V_6 ;
}
V_6 = F_18 ( V_28 -> V_8 , V_54 , 0xFF ) ;
if ( V_6 < 0 ) {
F_10 ( V_28 -> V_40 ,
L_5 , V_6 ) ;
return V_6 ;
...
if ( V_46 )
V_48 . V_46 = & V_46 [ V_21 ] ;
V_48 . V_59 = ( void * ) & V_60 [ V_21 ] ;
V_28 -> V_2 [ V_21 ] = F_21 ( V_28 -> V_40 ,
& V_60 [ V_21 ] . V_61 , & V_48 ) ;
if ( F_15 ( V_28 -> V_2 [ V_21 ] ) ) {
F_10 ( V_28 -> V_40 ,
L_10 ) ;
return F_16 ( V_28 -> V_2 [ V_21 ] ) ;
}
}
return 0 ;
}
