...
static T_3 F_246 ( void * V_474 )
{
T_3 V_321 = sizeof( struct V_437 ) ;
struct V_431 * V_475 ;
V_475 = (struct V_431 * ) ( V_474 + V_321 ) ;
while ( V_475 -> V_321 ) {
V_321 += V_475 -> V_321 * sizeof( T_3 ) ;
V_475 += 1 ;
}
return V_321 ;
}
...
V_475 = (struct V_431 * ) ( V_438 + 1 ) ;
V_445 = F_248 ( F_249 ( V_475 -> V_193 ) ) ;
if ( V_445 == V_456 )
F_243 ( V_438 , V_475 ) ;
...
V_479:
V_44 = F_251 ( V_32 , V_116 -> V_394 , & V_288 -> V_268 ,
V_288 -> V_293 , 0 ,
V_482 , V_473 ,
V_397 ) ;
if ( V_44 )
...
V_44 = F_50 ( V_32 , V_33 , V_288 -> V_268 , V_29 , & V_476 ) ;
if ( V_44 )
goto V_483;
V_477 = F_246 ( V_116 -> V_118 ) ;
V_476 -> V_484 = F_25 ( V_477 , V_89 ) ;
if ( ! V_476 -> V_484 ) {
V_44 = - V_90 ;
goto V_485;
}
V_476 -> V_486 = V_477 ;
V_476 -> V_487 = 0 ;
memcpy ( V_476 -> V_484 , V_116 -> V_118 , V_477 ) ;
V_438 = (struct V_437 * ) V_476 -> V_484 ;
if ( V_438 -> V_36 == 1 )
V_438 -> V_36 = 2 ;
else
V_438 -> V_36 = 1 ;
...
F_174 ( & V_414 -> V_211 ) ;
V_485:
F_55 ( V_32 , V_33 , V_288 -> V_268 , V_29 ) ;
V_483:
if ( V_44 )
...
static int F_254 ( struct V_31 * V_32 , struct V_226 * V_489 )
{
int V_44 ;
V_44 = F_94 ( V_32 , V_489 -> V_198 . V_189 , V_489 -> V_198 . V_7 , 1 , V_29 , 0 ) ;
if ( V_44 ) {
F_61 ( V_32 , L_39 ) ;
return V_44 ;
}
F_204 ( V_32 , V_489 -> V_198 . V_7 , 0 , 0 , V_488 ,
V_473 , V_397 ) ;
return 0 ;
}
int F_255 ( struct V_31 * V_32 , int V_33 ,
struct V_287 * V_288 ,
struct V_115 * V_116 ,
struct V_115 * V_289 ,
struct V_290 * V_266 )
...
V_424 )
return - V_478 ;
V_44 = F_50 ( V_32 , V_33 , V_288 -> V_267 , V_29 , & V_476 ) ;
if ( V_44 )
return V_44 ;
if ( ! V_476 -> V_484 ) {
F_61 ( V_32 , L_40 ) ;
...
F_31 ( V_476 -> V_484 ) ;
F_55 ( V_32 , V_33 , V_288 -> V_267 , V_29 ) ;
V_44 = F_50 ( V_32 , V_33 , V_476 -> V_139 , V_20 , & V_414 ) ;
if ( V_44 )
return V_44 ;
if ( V_490 && F_252 ( V_32 ) ) {
V_44 = F_50 ( V_32 , V_33 , V_490 , V_29 , & V_476 ) ;
if ( V_44 ) {
F_61 ( V_32 , L_41 ) ;
} else {
F_55 ( V_32 , V_33 , V_490 , V_29 ) ;
F_254 ( V_32 , V_476 ) ;
}
}
...
F_176 ( & V_414 -> V_211 ) ;
V_59:
F_55 ( V_32 , V_33 , V_476 -> V_139 , V_20 ) ;
return V_44 ;
}
...
static void F_257 ( struct V_31 * V_32 , int V_33 , struct V_206 * V_414 )
{
struct V_413 * V_491 ;
struct V_413 * V_201 ;
struct V_421 V_66 ;
...
switch ( V_32 -> V_62 . V_423 ) {
case V_424 :
F_234 ( V_32 , V_491 -> V_420 ) ;
break;
case V_425 :
V_66 . V_139 = V_414 -> V_208 ;
( void ) F_235 ( V_32 , & V_66 , V_491 -> V_415 ,
V_491 -> V_417 , V_491 -> V_419 ) ;
break;
}
F_95 ( & V_491 -> V_236 ) ;
F_31 ( V_491 ) ;
...
static int F_258 ( struct V_31 * V_32 , int V_33 ,
enum V_18 type , int V_492 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 =
& V_38 -> V_41 . V_42 . V_43 ;
...
V_495 = V_496 ;
do {
V_493 = F_258 ( V_32 , V_33 , type , 0 ) ;
if ( F_260 ( V_496 , V_495 + 5 * V_497 ) )
break;
if ( V_493 )
F_261 () ;
} while ( V_493 );
if ( V_493 )
V_493 = F_258 ( V_32 , V_33 , type , 1 ) ;
return V_493 ;
}
...
static int F_253 ( struct V_31 * V_32 , struct V_226 * V_489 )
{
struct V_115 * V_385 ;
int V_44 ;
struct V_226 * V_509 ;
...
memcpy ( V_385 -> V_118 , V_489 -> V_484 , V_489 -> V_486 ) ;
V_44 = F_251 ( V_32 , V_385 -> V_394 , & V_420 , V_489 -> V_486 >> 2 , 0 ,
V_482 , V_473 ,
V_397 ) ;
F_205 ( V_32 , V_385 ) ;
if ( V_44 )
goto V_44;
V_44 = F_77 ( V_32 , V_489 -> V_198 . V_189 , V_420 , 1 , V_29 , V_489 -> V_139 ) ;
if ( V_44 )
goto V_483;
V_44 = F_50 ( V_32 , V_489 -> V_198 . V_189 , V_420 , V_29 , & V_509 ) ;
if ( V_44 )
goto V_510;
V_489 -> V_487 = V_420 ;
V_509 -> V_487 = 0 ;
V_509 -> V_486 = 0 ;
V_509 -> V_484 = NULL ;
F_55 ( V_32 , V_489 -> V_198 . V_189 , V_420 , V_29 ) ;
return 0 ;
V_510:
F_94 ( V_32 , V_489 -> V_198 . V_189 , V_420 , 1 , V_29 , 0 ) ;
V_483:
F_204 ( V_32 , V_420 , 0 , 0 , V_488 ,
V_473 , V_397 ) ;
V_44:
return V_44 ;
}
static int F_268 ( struct V_31 * V_32 , bool V_511 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 =
& V_38 -> V_41 . V_42 . V_43 ;
struct V_5 * V_6 = & V_200 -> V_94 [ V_29 ] ;
struct V_8 * V_512 ;
struct V_226 * V_489 ;
int V_44 = 0 ;
F_264 ( V_513 ) ;
for ( V_512 = F_269 ( V_6 ) ; V_512 ; V_512 = F_270 ( V_512 ) ) {
V_489 = F_271 ( V_512 , struct V_226 , V_198 . V_9 ) ;
if ( ( V_511 && V_489 -> V_486 ) ||
( ! V_511 && ! V_489 -> V_486 ) )
F_78 ( & V_489 -> V_513 , & V_513 ) ;
}
F_59 (fs_rule, &mirr_list, mirr_list) {
if ( V_511 )
V_44 += F_253 ( V_32 , V_489 ) ;
else
V_44 += F_254 ( V_32 , V_489 ) ;
}
return V_44 ;
}
int F_272 ( struct V_31 * V_32 )
{
return F_268 ( V_32 , true ) ;
}
int F_273 ( struct V_31 * V_32 )
{
return F_268 ( V_32 , false ) ;
}
static void F_274 ( struct V_31 * V_32 , int V_33 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_199 * V_200 =
& V_38 -> V_41 . V_42 . V_43 ;
...
F_53 ( F_52 ( V_32 ) ) ;
if ( V_489 -> V_198 . V_189 == V_33 ) {
V_233 = V_489 -> V_198 . V_7 ;
V_2 = V_489 -> V_198 . V_191 ;
while ( V_2 != 0 ) {
switch ( V_2 ) {
case V_227 :
...
V_397 ) ;
F_51 ( F_52 ( V_32 ) ) ;
F_79 ( & V_489 -> V_198 . V_9 ,
& V_200 -> V_94 [ V_29 ] ) ;
F_95 ( & V_489 -> V_198 . V_236 ) ;
F_53 ( F_52 ( V_32 ) ) ;
F_31 ( V_489 ) ;
V_2 = 0 ;
break;
...
int V_44 ;
int V_286 ;
V_44 = F_259 ( V_32 , V_33 , V_30 ) ;
if ( V_44 )
F_10 ( V_32 , L_57 ,
V_33 ) ;
F_51 ( F_52 ( V_32 ) ) ;
F_128 (xrcd, tmp, xrcdn_list, com.list) {
if ( V_519 -> V_198 . V_189 == V_33 ) {
V_286 = V_519 -> V_198 . V_7 ;
F_79 ( & V_519 -> V_198 . V_9 , & V_200 -> V_94 [ V_30 ] ) ;
F_95 ( & V_519 -> V_198 . V_236 ) ;
F_31 ( V_519 ) ;
F_145 ( V_32 , V_286 ) ;
}
}
...
void F_278 ( struct V_520 * V_521 )
{
struct V_522 * V_523 =
F_3 ( V_521 , struct V_522 , V_523 ) ;
struct V_115 * V_385 ;
struct V_461 * V_524 ;
struct V_31 * V_32 = & V_523 -> V_38 -> V_32 ;
struct V_199 * V_200 =
& V_523 -> V_38 -> V_41 . V_42 . V_43 ;
struct V_276 * V_498 =
& V_200 -> V_87 [ V_523 -> V_33 ] . V_92 [ V_20 ] ;
struct V_206 * V_66 ;
struct V_206 * V_201 ;
T_1 V_525 =
( ( 1ULL << V_526 ) |
...
V_167 ;
V_524 = V_385 -> V_118 ;
V_524 -> V_463 = F_241 ( 1ULL << V_543 ) ;
F_51 ( F_52 ( V_32 ) ) ;
F_128 (qp, tmp, qp_list, com.list) {
F_53 ( F_52 ( V_32 ) ) ;
if ( V_66 -> V_198 . V_189 == V_523 -> V_33 ) {
if ( V_66 -> V_198 . V_191 != V_248 ||
! V_66 -> V_131 ||
...
V_524 -> V_462 = F_241 ( V_532 ) ;
else
V_524 -> V_462 =
F_241 ( V_532 | V_525 ) ;
if ( V_523 -> V_542 == V_146 ) {
V_524 -> V_470 . V_152 = V_66 -> V_152 ;
V_524 -> V_470 . V_130 . V_157 = V_66 -> V_157 ;
V_524 -> V_470 . V_130 . V_169 = V_66 -> V_169 ;
V_524 -> V_470 . V_130 . V_171 = V_66 -> V_171 ;
V_524 -> V_470 . V_130 . V_173 = V_66 -> V_344 ;
V_524 -> V_470 . V_130 . V_176 = V_66 -> V_176 ;
V_524 -> V_470 . V_130 . V_131 =
V_66 -> V_131 ;
} else {
V_524 -> V_470 . V_152 = V_66 -> V_152 & ~ F_46 ( V_153 ) ;
V_524 -> V_470 . V_130 . V_157 = V_157 ;
V_524 -> V_470 . V_130 . V_171 = V_523 -> V_545 ;
V_524 -> V_470 . V_130 . V_169 =
V_66 -> V_169 | V_170 ;
V_524 -> V_470 . V_130 . V_173 =
V_66 -> V_344 | V_174 | V_175 ;
V_524 -> V_470 . V_130 . V_176 =
...
if ( V_44 ) {
F_279 ( V_32 , L_59 ,
V_523 -> V_33 , V_36 , V_66 -> V_208 , V_44 ) ;
V_540 ++ ;
}
}
F_51 ( F_52 ( V_32 ) ) ;
...
if ( V_540 )
F_61 ( V_32 , L_60 ,
V_540 , V_523 -> V_33 , V_523 -> V_36 ) ;
if ( V_523 -> V_128 & V_549 && ! V_540 &&
V_550 != V_523 -> V_551 )
F_138 ( & V_523 -> V_38 -> V_32 , V_523 -> V_36 ,
V_523 -> V_552 ) ;
V_59:
F_31 ( V_523 ) ;
return;
