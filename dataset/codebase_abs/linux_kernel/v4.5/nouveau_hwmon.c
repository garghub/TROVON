...
F_39 ( struct V_6 * V_7 )
{
#if F_40 ( V_37 ) || ( F_40 ( V_38 ) && F_40 ( V_39 ) )
struct V_8 * V_9 = V_8 ( V_7 ) ;
struct V_10 * V_11 = F_3 ( & V_9 -> V_1 ) ;
struct V_35 * V_36 = F_36 ( & V_9 -> V_1 ) ;
struct V_40 * V_41 ;
struct V_1 * V_42 ;
int V_28 = 0 ;
V_41 = V_9 -> V_41 = F_41 ( sizeof( * V_41 ) , V_43 ) ;
if ( ! V_41 )
return - V_44 ;
V_41 -> V_7 = V_7 ;
if ( ! V_11 || ! V_11 -> V_14 || ! V_11 -> V_19 )
return - V_31 ;
V_42 = F_42 ( & V_7 -> V_45 -> V_7 ) ;
if ( F_43 ( V_42 ) ) {
V_28 = F_44 ( V_42 ) ;
F_45 ( V_9 , L_6 , V_28 ) ;
return V_28 ;
...
F_46 ( V_42 , V_7 ) ;
V_28 = F_47 ( & V_42 -> V_46 , & V_47 ) ;
if ( V_28 )
goto error;
if ( F_4 ( V_11 ) >= 0 ) {
V_28 = F_47 ( & V_42 -> V_46 , & V_48 ) ;
if ( V_28 )
goto error;
}
...
if ( V_41 -> V_41 ) {
F_50 ( & V_41 -> V_41 -> V_46 , & V_47 ) ;
F_50 ( & V_41 -> V_41 -> V_46 , & V_48 ) ;
F_50 ( & V_41 -> V_41 -> V_46 , & V_49 ) ;
F_50 ( & V_41 -> V_41 -> V_46 , & V_50 ) ;
F_50 ( & V_41 -> V_41 -> V_46 , & V_51 ) ;
F_48 ( V_41 -> V_41 ) ;
}
V_8 ( V_7 ) -> V_41 = NULL ;
F_51 ( V_41 ) ;
