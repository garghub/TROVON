...
F_96 ( V_19 ) ;
F_97 ( V_26 -> V_207 , ( V_26 -> V_116 & V_231 ) , V_19 ) ;
...
int F_117 ( struct V_1 * log , T_3 V_236 , int V_237 )
{
int V_93 = - V_96 ;
struct V_3 * V_4 ;
struct V_170 * V_170 ;
...
struct V_25 * V_26 ;
F_5 ( L_46 ,
( long long ) V_236 , V_237 ) ;
V_4 = F_29 ( log -> V_152 . V_66 , struct V_3 , V_161 ) ;
V_26 = F_32 ( log , 1 ) ;
V_239 = V_237 >> V_4 -> V_240 ;
V_170 = (struct V_170 * ) V_26 -> V_42 ;
V_170 -> V_174 = F_33 ( V_175 ) ;
V_170 -> V_241 = F_33 ( V_242 ) ;
V_170 -> V_177 = F_33 ( V_178 ) ;
V_170 -> V_45 = F_33 ( V_4 -> V_141 ) ;
V_170 -> V_92 = F_33 ( V_239 ) ;
V_170 -> V_243 = F_33 ( V_4 -> V_243 ) ;
V_170 -> V_167 = F_33 ( V_4 -> V_167 ) ;
V_170 -> V_179 = F_33 ( 2 * V_61 + V_63 + V_67 ) ;
V_26 -> V_116 = V_89 | V_180 | V_228 ;
V_26 -> V_209 = V_236 + V_4 -> V_244 ;
F_108 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
V_28 = (struct V_27 * ) V_26 -> V_42 ;
V_28 -> V_81 . V_70 = V_28 -> V_88 . V_70 = F_33 ( V_239 - 3 ) ;
V_28 -> V_81 . V_43 = V_28 -> V_88 . V_43 = F_21 ( V_63 + V_67 ) ;
V_238 = (struct V_11 * ) & V_28 -> V_47 ;
V_238 -> V_130 = 0 ;
V_238 -> V_131 = 0 ;
V_238 -> type = F_21 ( V_132 ) ;
V_238 -> V_60 = 0 ;
V_238 -> log . V_129 . V_128 = 0 ;
V_26 -> V_209 += V_4 -> V_244 ;
V_26 -> V_116 = V_89 | V_180 | V_228 ;
F_108 ( V_26 ) ;
if ( ( V_93 = F_76 ( V_26 , 0 ) ) )
goto exit;
for ( V_79 = 0 ; V_79 < V_239 - 3 ; V_79 ++ ) {
...
static int F_118 ( struct V_245 * V_246 , void * V_247 )
{
F_119 ( V_246 ,
L_47
L_48
...
static int F_120 ( struct V_248 * V_248 , struct V_249 * V_249 )
{
return F_121 ( V_249 , F_118 , NULL ) ;
}
