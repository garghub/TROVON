...
if ( V_209 & V_213 ) {
V_210 = F_63 ( V_4 , V_208 -> V_181 , NULL ) ;
} else {
F_4 ( L_17 , V_209 ) ;
V_210 = - V_85 ;
}
...
struct V_214 * F_66 ( struct V_87 * V_90 ,
...
if ( V_208 -> V_217 )
return F_29 ( - V_85 ) ;
V_216 = F_50 ( sizeof( * V_216 ) , V_193 ) ;
if ( ! V_216 )
return F_29 ( - V_204 ) ;
return V_216 ;
}
int F_67 ( struct V_214 * V_216 )
{
F_25 ( L_9 ) ;
F_52 ( V_216 ) ;
return 0 ;
}
struct V_218 * F_68 ( struct V_190 * V_51 , T_1 V_219 , T_1 V_220 ,
T_1 V_221 , int V_222 ,
struct V_5 * V_6 )
{
struct V_223 * V_224 ;
...
F_25 ( L_18 , V_219 ,
V_221 , V_220 ) ;
V_224 = F_50 ( sizeof( * V_224 ) , V_193 ) ;
if ( ! V_224 )
return F_29 ( - V_32 ) ;
V_224 -> V_225 = F_69 ( F_55 ( V_51 ) -> V_65 , V_219 , V_220 ,
V_222 , 0 ) ;
if ( F_9 ( V_224 -> V_225 ) ) {
...
int F_70 ( struct V_218 * V_227 )
{
struct V_223 * V_224 = F_71 ( V_227 ) ;
F_25 ( L_19 , V_224 -> V_225 -> V_230 , V_224 -> V_225 -> V_220 ) ;
F_72 ( V_224 -> V_225 , V_227 -> V_51 -> V_198 -> V_192 -> V_231 ) ;
F_52 ( V_224 ) ;
return 0 ;
}
...
F_75 ( & V_192 -> V_207 ) ;
F_38 ( & V_8 -> V_62 ) ;
F_60 ( & V_192 -> V_45 , & V_8 -> V_232 ) ;
F_42 ( & V_8 -> V_62 ) ;
return & V_192 -> V_233 ;
}
int F_76 ( struct V_191 * V_234 )
{
struct V_196 * V_192 = F_57 ( V_234 ) ;
...
struct V_246 * F_81 ( struct V_190 * V_51 ,
struct V_247 * V_248 )
{
F_25 ( L_9 ) ;
return F_29 ( - V_249 ) ;
}
int F_82 ( struct V_246 * V_250 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_83 ( struct V_174 * V_183 , struct V_251 * V_252 ,
struct V_251 * * V_253 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_84 ( struct V_174 * V_183 , struct V_254 * V_252 ,
struct V_254 * * V_253 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_85 ( struct V_214 * V_255 , int V_256 ,
struct V_257 * V_258 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_86 ( struct V_214 * V_216 ,
enum V_259 V_217 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
struct V_218 * F_87 ( struct V_190 * V_51 , int V_260 )
{
F_25 ( L_9 ) ;
return F_29 ( - V_32 ) ;
}
