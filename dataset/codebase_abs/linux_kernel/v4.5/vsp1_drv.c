...
int V_8 ;
V_41 -> V_44 = V_7 -> V_44 ;
F_18 ( V_41 -> V_45 , L_1 , sizeof( V_41 -> V_45 ) ) ;
...
F_26 ( & V_7 -> V_48 -> V_18 . V_37 , & V_7 -> V_49 ) ;
V_7 -> V_50 = F_27 ( V_7 , true ) ;
if ( F_24 ( V_7 -> V_50 ) ) {
V_8 = F_25 ( V_7 -> V_50 ) ;
goto V_47;
}
F_26 ( & V_7 -> V_50 -> V_18 . V_37 , & V_7 -> V_49 ) ;
V_7 -> V_51 = F_27 ( V_7 , false ) ;
if ( F_24 ( V_7 -> V_51 ) ) {
V_8 = F_25 ( V_7 -> V_51 ) ;
goto V_47;
}
F_26 ( & V_7 -> V_51 -> V_18 . V_37 , & V_7 -> V_49 ) ;
...
F_26 ( & V_7 -> V_54 -> V_18 . V_37 , & V_7 -> V_49 ) ;
}
...
F_26 ( & V_7 -> V_56 -> V_18 . V_37 , & V_7 -> V_49 ) ;
}
...
F_26 ( & V_7 -> V_60 -> V_18 . V_37 , & V_7 -> V_49 ) ;
}
...
( 8 << V_72 ) ) ;
for ( V_10 = 0 ; V_10 < V_7 -> V_11 . V_57 ; ++ V_10 )
F_5 ( V_7 , F_43 ( V_10 ) , V_73 ) ;
for ( V_10 = 0 ; V_10 < V_7 -> V_11 . V_61 ; ++ V_10 )
F_5 ( V_7 , F_44 ( V_10 ) , V_73 ) ;
F_5 ( V_7 , V_74 , V_73 ) ;
F_5 ( V_7 , V_75 , V_73 ) ;
F_5 ( V_7 , V_76 , V_73 ) ;
F_5 ( V_7 , V_77 , V_73 ) ;
...
static int F_56 ( struct V_86 * V_44 )
{
struct V_6 * V_7 = F_52 ( V_44 ) ;
F_53 ( F_54 ( & V_7 -> V_84 ) ) ;
if ( V_7 -> V_85 == 0 )
...
{
struct V_87 * V_88 = V_7 -> V_44 -> V_89 ;
struct V_90 * V_11 = & V_7 -> V_11 ;
if ( F_59 ( V_88 , L_5 ) )
V_11 -> V_52 |= V_53 ;
if ( F_59 ( V_88 , L_6 ) )
V_11 -> V_52 |= V_55 ;
if ( F_59 ( V_88 , L_7 ) )
V_11 -> V_52 |= V_59 ;
F_60 ( V_88 , L_8 , & V_11 -> V_57 ) ;
F_60 ( V_88 , L_9 , & V_11 -> V_61 ) ;
F_60 ( V_88 , L_10 , & V_11 -> V_12 ) ;
if ( V_11 -> V_57 <= 0 || V_11 -> V_57 > V_91 ) {
F_22 ( V_7 -> V_44 , L_11 ,
V_11 -> V_57 ) ;
return - V_92 ;
}
...
struct V_97 * V_98 ;
int V_8 ;
V_7 = F_62 ( & V_96 -> V_44 , sizeof( * V_7 ) , V_99 ) ;
if ( V_7 == NULL )
return - V_100 ;
V_7 -> V_44 = & V_96 -> V_44 ;
F_63 ( & V_7 -> V_84 ) ;
...
if ( V_8 < 0 )
return V_8 ;
V_98 = F_65 ( V_96 , V_101 , 0 ) ;
V_7 -> V_102 = F_66 ( & V_96 -> V_44 , V_98 ) ;
if ( F_24 ( V_7 -> V_102 ) )
return F_25 ( V_7 -> V_102 ) ;
V_7 -> clock = F_67 ( & V_96 -> V_44 , NULL ) ;
if ( F_24 ( V_7 -> clock ) ) {
F_22 ( & V_96 -> V_44 , L_14 ) ;
return F_25 ( V_7 -> clock ) ;
}
V_1 = F_65 ( V_96 , V_103 , 0 ) ;
if ( ! V_1 ) {
F_22 ( & V_96 -> V_44 , L_15 ) ;
return - V_92 ;
}
V_8 = F_68 ( & V_96 -> V_44 , V_1 -> V_104 , F_1 ,
V_105 , F_19 ( & V_96 -> V_44 ) , V_7 ) ;
if ( V_8 < 0 ) {
F_22 ( & V_96 -> V_44 , L_16 ) ;
return V_8 ;
}
