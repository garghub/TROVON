...
V_7 -> V_24 -> V_26 . V_57 = ( void ( * ) ( struct V_58 * ) ) F_5 ;
V_7 -> V_24 -> V_29 . V_26 . type = V_59 ;
...
struct V_61 * V_62 ;
int V_44 = - V_45 ;
if ( ! ( V_62 = F_15 ( sizeof( * V_62 ) , V_48 ) ) )
return - V_49 ;
F_17 ( & V_62 -> V_8 , & V_6 -> V_64 ) ;
if ( ! ( V_44 = F_14 ( V_44 , & V_11 , & V_12 , args -> V_14 , 0 , 0 , true ) ) ) {
V_62 -> V_22 = args -> V_14 . V_22 ;
V_62 -> V_20 = args -> V_14 . V_20 ;
args -> V_14 . V_22 = V_65 ;
args -> V_14 . V_20 = ( unsigned long ) ( void * ) V_62 ;
V_44 = F_16 ( V_40 , V_37 , V_38 ) ;
args -> V_14 . V_20 = V_62 -> V_20 ;
args -> V_14 . V_22 = V_62 -> V_22 ;
}
if ( V_44 )
F_22 ( V_62 ) ;
return V_44 ;
...
int
F_24 ( struct V_2 * V_3 , void T_2 * V_66 , T_1 V_38 )
{
struct V_5 * V_6 = V_5 ( V_3 ) ;
struct V_39 * V_40 = & V_6 -> V_26 ;
...
if ( V_44 = - V_49 , ! V_37 )
goto V_53;
if ( V_44 = - V_69 , F_25 ( V_37 , V_66 , V_12 ) )
goto V_53;
if ( ! ( V_44 = F_14 ( - V_45 , & V_11 , & V_12 , V_37 -> V_14 , 0 , 0 , true ) ) ) {
V_68 = V_37 -> V_14 . V_68 ;
if ( V_37 -> V_14 . V_62 == 0ULL )
V_37 -> V_14 . V_68 = V_70 ;
else
V_37 -> V_14 . V_68 = V_65 ;
} else
...
F_26 ( & V_6 -> V_71 ) ;
if ( V_37 -> V_14 . V_22 ) {
if ( V_44 = - V_72 , V_37 -> V_14 . V_22 == 0xff )
...
if ( V_37 -> V_14 . V_22 == V_65 ) {
V_62 = ( void * ) ( unsigned long ) V_37 -> V_14 . V_20 ;
V_37 -> V_14 . V_22 = V_62 -> V_22 ;
V_37 -> V_14 . V_20 = V_62 -> V_20 ;
if ( V_44 == 0 && V_37 -> V_14 . type == V_78 ) {
F_4 ( & V_62 -> V_8 ) ;
F_5 ( V_62 ) ;
}
} else {
