...
static int F_55 ( struct V_108 * V_142 , struct V_1 * V_5 )
{
struct V_2 * V_3 = F_45 ( V_142 ) ;
return F_56 ( V_3 , V_5 ) ;
}
static void F_57 ( struct V_2 * V_3 , void * V_36 ,
struct V_1 * V_30 )
{
struct V_143 * V_144 = V_36 ;
int V_16 ;
if ( F_18 ( V_30 ) ) {
V_16 = F_58 ( V_30 ) ;
V_30 = NULL ;
...
V_144 -> V_146 ( V_144 -> V_33 , V_30 , V_16 ) ;
F_20 ( V_144 ) ;
}
static int F_61 ( struct V_108 * V_108 , struct V_71 * V_72 ,
struct V_1 * V_5 , T_10 V_146 ,
void * V_33 )
{
struct V_2 * V_3 = F_45 ( V_108 ) ;
struct V_143 * V_144 ;
int V_16 ;
V_144 = F_27 ( sizeof( struct V_143 ) , V_8 ) ;
if ( ! V_144 ) {
F_24 ( L_17 ) ;
return - V_53 ;
}
...
struct V_2 * F_65 ( struct V_147 * V_19 ,
T_6 V_107 ,
T_6 V_148 ,
int V_6 , int V_7 )
{
...
! V_19 -> V_20 || ( V_19 -> V_51 && ! V_19 -> V_149 ) )
return NULL ;
...
V_3 -> V_6 = V_6 + V_156 ;
V_3 -> V_7 = V_7 + V_157 ;
V_3 -> V_108 = F_68 ( & V_158 , V_3 -> V_120 ,
V_3 -> V_6 ,
V_3 -> V_7 ) ;
if ( ! V_3 -> V_108 ) {
F_24 ( L_18 ) ;
