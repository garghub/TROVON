...
F_43 ( & V_17 -> V_31 ) = F_3 ( V_3 -> V_10 , V_55 = V_17 -> V_55 ) ;
F_9 ( V_17 ) ;
return V_55 ;
}
bool F_46 ( struct V_2 * V_3 , unsigned V_55 )
{
struct V_16 * V_17 = F_5 ( V_3 ) ;
F_29 ( V_17 -> V_46 ) ;
...
{
unsigned V_55 = F_45 ( V_3 ) ;
return ! F_46 ( V_3 , V_55 ) ;
}
...
struct V_2 * F_51 ( unsigned int V_67 ,
unsigned int V_32 ,
unsigned int V_68 ,
struct V_69 * V_10 ,
bool V_46 ,
...
unsigned int V_7 ;
if ( V_32 & ( V_32 - 1 ) ) {
F_52 ( & V_10 -> V_72 , L_8 , V_32 ) ;
return NULL ;
}
V_17 = F_2 ( sizeof( * V_17 ) + sizeof( void * ) * V_32 , V_73 ) ;
if ( ! V_17 )
return NULL ;
F_53 ( & V_17 -> V_31 , V_32 , V_70 , V_68 ) ;
V_17 -> V_17 . V_66 = V_66 ;
V_17 -> V_17 . V_10 = V_10 ;
V_17 -> V_17 . V_71 = V_71 ;
V_17 -> V_17 . V_34 = V_32 ;
...
V_17 -> V_44 = 0 ;
V_17 -> V_48 = 0 ;
F_54 ( & V_17 -> V_17 . V_74 , & V_10 -> V_75 ) ;
#ifdef F_10
V_17 -> V_76 = false ;
V_17 -> V_29 = false ;
#endif
V_17 -> V_25 = F_55 ( V_10 , V_77 ) ;
V_17 -> V_52 = F_55 ( V_10 , V_78 ) ;
if ( ! V_66 ) {
V_17 -> V_59 |= V_60 ;
...
void F_56 ( struct V_2 * V_17 )
{
F_57 ( & V_17 -> V_74 ) ;
F_34 ( F_5 ( V_17 ) ) ;
}
void F_58 ( struct V_69 * V_10 )
{
unsigned int V_7 ;
...
unsigned int F_60 ( struct V_2 * V_3 )
{
struct V_16 * V_17 = F_5 ( V_3 ) ;
...
void F_62 ( struct V_69 * V_72 )
{
struct V_2 * V_3 ;
F_63 (_vq, &dev->vqs, list) {
struct V_16 * V_17 = F_5 ( V_3 ) ;
V_17 -> V_26 = true ;
}
}
