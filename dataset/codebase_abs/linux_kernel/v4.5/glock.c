...
void F_77 ( struct V_1 * V_2 , unsigned int V_75 , T_2 V_140 ,
struct V_39 * V_40 )
{
F_78 ( & V_40 -> V_43 ) ;
V_40 -> V_145 = V_2 ;
...
void F_81 ( unsigned int V_75 , T_2 V_140 , struct V_39 * V_40 )
{
V_40 -> V_44 = V_75 ;
V_40 -> V_46 = V_140 ;
V_40 -> V_52 = 0 ;
...
unsigned int V_75 , T_2 V_140 , struct V_39 * V_40 )
{
struct V_1 * V_2 ;
int error ;
...
static void F_123 ( T_4 V_208 , const struct V_3 * V_4 )
{
struct V_1 * V_2 ;
struct V_209 * V_210 ;
...
static const char * F_141 ( char * V_217 , T_2 V_140 , unsigned long V_218 )
{
char * V_184 = V_217 ;
if ( V_140 & V_59 )
* V_184 ++ = 't' ;
...
static void * F_163 ( struct V_159 * V_160 , T_5 * V_210 )
{
...
static void * F_169 ( struct V_159 * V_160 , T_5 * V_210 )
{
F_68 () ;
if ( * V_210 >= V_259 )
return NULL ;
