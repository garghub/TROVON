...
V_58 = 0 ;
F_20 ( V_1 , V_60 , V_11 , V_62 ,
V_63 , 0 ) ;
V_55 . V_64 = V_65 ;
V_55 . V_66 = V_67 ;
V_55 . type = V_68 ;
F_21 ( V_1 , V_6 , V_69 , & V_55 ) ;
V_1 -> V_70 . V_6 = 0 ;
V_1 -> V_70 . type = V_71 ;
V_1 -> V_70 . V_72 = V_73 ;
F_21 ( V_1 , V_6 , V_74 , & V_1 -> V_70 ) ;
F_22 ( V_20 , V_75 , 0x00404050 ) ;
F_20 ( V_1 , V_76 , V_77 , 1 ) ;
F_20 ( V_1 , V_60 , V_61 , V_56 ) ;
F_21 ( V_1 , V_60 , V_61 , V_56 ) ;
F_23 ( V_1 , V_60 , V_11 , 3 , 17 , 0 ) ;
F_23 ( V_1 , V_60 , V_11 , 3 , 13 , 0 ) ;
V_1 -> V_29 = 0 ;
...
case V_105 :
V_58 = V_62 ;
V_59 = F_23 ( V_1 , V_60 , V_11 , 3 , 17 , 0 ) ;
if ( ! V_59 )
V_59 = F_23 ( V_1 , V_60 , V_11 , 3 , 13 , 0 ) ;
break;
case V_106 :
V_58 = V_107 ;
break;
...
case V_110 :
V_58 = V_62 ;
V_59 = F_23 ( V_1 , V_60 , V_11 , 1 , 17 , 0 ) ;
break;
}
if ( V_59 )
return V_59 ;
if ( F_20 ( V_1 , V_60 , V_11 , V_58 , V_63 , 0 ) )
F_16 ( L_15 ) ;
V_1 -> V_78 = V_28 [ V_13 ] ;
if ( 0 == V_1 -> V_26 )
F_3 ( V_1 , V_1 -> V_78 ) ;
...
{
struct V_19 * V_20 = ( (struct V_104 * ) V_99 ) -> V_20 ;
return F_33 ( V_20 , V_60 , V_119 , V_118 ) ;
}
...
if ( V_71 != V_121 -> type )
return - V_30 ;
F_28 ( L_21 , V_1 -> V_70 . V_72 ) ;
F_21 ( V_1 , V_6 , V_74 , V_121 ) ;
V_1 -> V_70 = * V_121 ;
F_21 ( V_1 , V_6 , V_125 , & V_1 -> V_70 ) ;
if ( V_1 -> V_78 == 0 )
F_1 ( V_1 ) ;
if ( V_1 -> V_29 )
return 0 ;
