...
static T_1 F_31 ( const char * V_35 )
{
int V_14 = 0 ;
int V_36 = 0 , V_37 = 0 ;
if ( ! V_38 )
...
static T_1 F_33 ( char * V_35 , T_2 V_36 )
{
int V_14 = 0 ;
int V_37 = 0 ;
F_34 ( ! V_38 ) ;
...
static int F_37 ( T_3 V_42 , void * V_43 )
{
struct V_44 * V_45 ;
F_11 ( & V_1 . V_15 ) ;
V_1 . V_42 = V_42 ;
...
F_11 ( & V_1 . V_15 ) ;
V_1 . V_2 = V_45 ;
F_42 ( ( V_46 ) ( unsigned long ) V_45 ) ;
F_43 ( V_45 ) ;
F_12 ( & V_1 . V_15 ) ;
return 0 ;
}
static int F_44 ( bool V_47 ,
char * V_48 , T_2 V_49 )
{
T_4 V_50 ;
if ( V_47 )
...
static int F_49 ( struct V_54 * V_54 , struct V_55 * V_55 )
{
int V_14 = 0 ;
T_4 V_50 ;
F_11 ( & V_1 . V_15 ) ;
...
static int F_52 ( struct V_54 * V_54 , struct V_55 * V_55 )
{
F_11 ( & V_1 . V_15 ) ;
V_1 . V_63 -- ;
if ( V_55 == V_61 ) {
...
static int F_55 ( char T_5 * V_27 , int V_28 )
{
int V_14 ;
struct V_9 * V_29 = & V_1 . V_19 ;
int V_30 ;
...
F_30 () ;
V_31 = & V_29 -> V_27 [ V_29 -> V_34 ] ;
V_30 = F_26 ( V_28 , F_56 ( V_29 ) ) ;
if ( F_57 ( V_27 , V_31 , V_30 ) ) {
V_14 = - V_22 ;
goto V_23;
}
F_25 () ;
...
static T_1 F_58 ( struct V_55 * V_55 , char T_5 * V_27 ,
T_2 V_36 , T_6 * V_64 )
{
int V_14 = 0 ;
int V_37 = 0 ;
if ( ! V_36 )
return 0 ;
if ( ! F_59 ( V_65 , V_27 , V_36 ) )
return - V_22 ;
while ( V_36 > 0 ) {
V_40:
V_14 = F_55 ( V_27 + V_37 , V_36 ) ;
if ( V_14 == - V_24 ) {
if ( V_55 -> V_58 & V_66 )
break;
else {
...
static int F_60 ( const char T_5 * V_27 , int V_28 )
{
int V_14 ;
struct V_9 * V_29 = & V_1 . V_17 ;
int V_30 ;
...
static T_1 F_62 ( struct V_55 * V_55 , const char T_5 * V_27 ,
T_2 V_36 , T_6 * V_64 )
{
int V_14 = 0 ;
int V_37 = 0 ;
if ( ! V_36 )
return 0 ;
if ( ! F_59 ( V_67 , V_27 , V_36 ) )
return - V_22 ;
while ( V_36 > 0 ) {
V_40:
V_14 = F_60 ( V_27 + V_37 , V_36 ) ;
if ( V_14 == - V_24 ) {
if ( V_55 -> V_58 & V_66 )
break;
else {
...
static unsigned int F_63 ( struct V_55 * V_55 , T_7 * V_26 )
{
int V_68 = 0 ;
F_64 ( V_55 , & V_1 . V_26 , V_26 ) ;
if ( F_17 () )
V_68 |= V_69 | V_70 ;
if ( F_18 () )
V_68 |= V_71 | V_72 ;
