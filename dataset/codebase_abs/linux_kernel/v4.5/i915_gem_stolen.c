...
struct V_78 * V_79 ;
F_49 ( L_8 , V_76 , V_5 ) ;
F_50 ( V_76 > V_2 -> V_16 . V_34 - V_5 ) ;
V_77 = F_51 ( sizeof( * V_77 ) , V_80 ) ;
if ( V_77 == NULL )
return NULL ;
if ( F_52 ( V_77 , 1 , V_80 ) ) {
F_53 ( V_77 ) ;
...
V_79 -> V_76 = 0 ;
V_79 -> V_82 = V_5 ;
F_54 ( V_79 ) = ( V_83 ) V_2 -> V_10 . V_52 + V_76 ;
F_55 ( V_79 ) = V_5 ;
return V_77 ;
}
...
V_101 -> V_104 |= V_105 ;
F_75 ( V_101 ) ;
F_76 ( & V_101 -> V_106 , & V_99 -> V_107 ) ;
}
F_76 ( & V_85 -> V_108 , & V_2 -> V_10 . V_109 ) ;
F_65 ( V_85 ) ;
return V_85 ;
V_103:
F_77 ( & V_85 -> V_23 ) ;
