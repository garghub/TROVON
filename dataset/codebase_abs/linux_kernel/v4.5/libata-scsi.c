...
V_74 = F_47 ( V_9 ) ;
F_9 ( V_9 -> V_21 , V_16 ) ;
return F_49 ( V_74 , ( unsigned long T_5 * ) V_90 ) ;
case V_130 :
...
int F_51 ( struct V_28 * V_102 , int V_57 , void T_5 * V_90 )
{
return F_48 ( F_3 ( V_102 -> V_34 ) ,
V_102 , V_57 , V_90 ) ;
}
static struct V_139 * F_52 ( struct V_12 * V_13 ,
struct V_56 * V_57 )
{
struct V_139 * V_140 ;
V_140 = F_53 ( V_13 , V_57 -> V_141 -> V_142 ) ;
if ( V_140 ) {
V_140 -> V_143 = V_57 ;
V_140 -> V_144 = V_57 -> V_80 ;
V_140 -> V_145 = F_54 ( V_57 ) ;
V_140 -> V_146 = F_55 ( V_57 ) ;
} else {
...
V_140 -> V_152 = F_57 ( V_149 ) + V_140 -> V_150 ;
}
static void F_58 ( unsigned V_93 , struct V_153 * V_154 )
{
T_3 V_155 = V_154 -> V_156 , V_157 = V_154 -> V_158 ;
F_59 ( V_159 L_4 , V_93 , V_155 ) ;
if ( V_155 & V_160 ) {
F_59 ( L_5 ) ;
} else {
if ( V_155 & V_161 ) F_59 ( L_6 ) ;
if ( V_155 & V_162 ) F_59 ( L_7 ) ;
if ( V_155 & V_163 ) F_59 ( L_8 ) ;
if ( V_155 & V_164 ) F_59 ( L_9 ) ;
if ( V_155 & V_165 ) F_59 ( L_10 ) ;
if ( V_155 & V_166 ) F_59 ( L_11 ) ;
if ( V_155 & V_167 ) F_59 ( L_12 ) ;
F_59 ( L_13 ) ;
if ( V_157 ) {
F_59 ( V_159 L_14 , V_93 , V_157 ) ;
if ( V_157 & V_168 ) F_59 ( L_15 ) ;
if ( V_157 & V_169 ) {
if ( V_157 & V_168 )
F_59 ( L_16 ) ;
else F_59 ( L_17 ) ;
}
if ( V_157 & V_170 ) F_59 ( L_18 ) ;
if ( V_157 & V_171 ) F_59 ( L_19 ) ;
if ( V_157 & V_172 ) F_59 ( L_20 ) ;
if ( V_157 & V_173 ) F_59 ( L_21 ) ;
F_59 ( L_13 ) ;
}
}
}
static void F_60 ( unsigned V_93 , T_3 V_174 , T_3 V_175 , T_3 * V_58 ,
...
F_60 ( V_140 -> V_9 -> V_191 , V_154 -> V_156 , V_154 -> V_158 ,
...
static int F_65 ( struct V_141 * V_207 )
{
if ( F_66 ( V_207 -> V_208 != V_209 ) )
return 0 ;
if ( ! F_67 ( V_207 ) || ( V_207 -> V_210 & V_211 ) )
return 0 ;
return F_68 ( V_207 -> V_57 [ 0 ] ) == V_212 ;
}
...
F_74 ( V_214 , F_65 , V_4 , V_219 ) ;
} else {
V_29 -> V_217 = F_75 ( V_13 -> V_93 ) ;
V_29 -> V_221 = 1 ;
}
if ( V_29 -> V_217 > V_27 )
F_76 ( V_13 ,
L_25 ,
V_29 -> V_217 ) ;
F_77 ( V_214 , V_29 -> V_217 - 1 ) ;
if ( V_13 -> V_16 & V_222 )
F_78 ( V_223 , V_29 -> V_224 ) ;
if ( V_13 -> V_16 & V_225 ) {
int V_226 ;
V_226 = F_79 ( V_29 -> V_34 -> V_227 , F_80 ( V_13 -> V_93 ) ) ;
V_226 = F_79 ( V_228 - 1 , V_226 ) ;
F_81 ( V_29 , V_226 ) ;
}
F_82 ( V_214 , false ) ;
V_13 -> V_29 = V_29 ;
...
{
struct V_8 * V_9 = F_3 ( V_29 -> V_34 ) ;
struct V_12 * V_13 = F_84 ( V_9 , V_29 ) ;
int V_33 = 0 ;
F_64 ( V_29 ) ;
if ( V_13 )
V_33 = F_69 ( V_29 , V_13 ) ;
...
int F_86 ( struct V_8 * V_9 , struct V_28 * V_29 ,
int V_232 )
{
struct V_12 * V_13 ;
unsigned long V_16 ;
...
F_5 ( V_9 -> V_21 , V_16 ) ;
V_13 -> V_16 &= ~ V_233 ;
if ( V_232 == 1 || ! F_88 ( V_13 ) ) {
V_13 -> V_16 |= V_233 ;
V_232 = 1 ;
}
F_9 ( V_9 -> V_21 , V_16 ) ;
V_232 = F_79 ( V_232 , V_29 -> V_34 -> V_227 ) ;
V_232 = F_79 ( V_232 , F_80 ( V_13 -> V_93 ) ) ;
V_232 = F_79 ( V_232 , V_228 - 1 ) ;
if ( V_29 -> V_232 == V_232 )
return - V_20 ;
return F_81 ( V_29 , V_232 ) ;
}
int F_89 ( struct V_28 * V_29 , int V_232 )
{
struct V_8 * V_9 = F_3 ( V_29 -> V_34 ) ;
return F_86 ( V_9 , V_29 , V_232 ) ;
}
static unsigned int F_90 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
...
static unsigned int F_92 ( struct V_139 * V_140 )
{
struct V_153 * V_154 = & V_140 -> V_154 ;
V_154 -> V_16 |= V_238 ;
V_154 -> V_240 = V_241 ;
...
static void F_93 ( const T_3 * V_234 , T_7 * V_257 , T_8 * V_258 )
{
T_7 V_259 = 0 ;
T_8 V_45 ;
F_94 ( L_26 ) ;
...
static unsigned int F_97 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
struct V_153 * V_154 = & V_140 -> V_154 ;
struct V_12 * V_13 = V_140 -> V_13 ;
...
static unsigned int F_101 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
const T_3 * V_234 = V_149 -> V_235 ;
...
V_33 = F_102 ( & V_140 -> V_154 , V_140 -> V_13 , V_201 , V_261 , V_274 ,
V_140 -> V_142 ) ;
if ( F_66 ( V_33 == 0 ) )
return 0 ;
if ( V_33 == - V_283 )
...
{
struct V_56 * V_57 = V_140 -> V_143 ;
void (* F_104)( struct V_56 * ) = V_140 -> V_144 ;
F_105 ( V_140 ) ;
F_104 ( V_57 ) ;
}
static void F_106 ( struct V_139 * V_140 )
{
...
F_58 ( V_9 -> V_191 , & V_140 -> V_187 ) ;
F_103 ( V_140 ) ;
}
static int F_107 ( struct V_12 * V_13 , struct V_56 * V_57 ,
T_9 V_286 )
{
...
F_108 ( V_140 , F_54 ( V_57 ) , F_55 ( V_57 ) ) ;
...
static void * F_110 ( struct V_56 * V_57 , bool V_300 ,
unsigned long * V_16 )
{
F_5 ( & V_301 , * V_16 ) ;
memset ( V_302 , 0 , V_303 ) ;
if ( V_300 )
F_111 ( F_54 ( V_57 ) , F_55 ( V_57 ) ,
V_302 , V_303 ) ;
return V_302 ;
}
static inline void F_112 ( struct V_56 * V_57 , bool V_304 ,
unsigned long * V_16 )
{
if ( V_304 )
F_113 ( F_54 ( V_57 ) , F_55 ( V_57 ) ,
V_302 , V_303 ) ;
F_9 ( & V_301 , * V_16 ) ;
}
...
static unsigned int F_120 ( struct V_305 * args , T_3 * V_306 )
{
struct V_153 V_154 ;
...
V_154 . V_193 = 0x1 ;
V_154 . V_192 = 0x1 ;
F_121 ( & V_154 , 0 , 1 , & V_306 [ 36 ] ) ;
V_306 [ 36 ] = 0x34 ;
V_306 [ 56 ] = V_319 ;
memcpy ( & V_306 [ 60 ] , & args -> V_93 [ 0 ] , 512 ) ;
return 0 ;
}
static unsigned int F_122 ( struct V_305 * args , T_3 * V_306 )
{
T_6 V_320 ;
V_306 [ 1 ] = 0xb0 ;
V_306 [ 3 ] = 0x3c ;
V_320 = 1 << F_123 ( args -> V_93 ) ;
F_124 ( V_320 , & V_306 [ 6 ] ) ;
if ( F_125 ( args -> V_93 ) ) {
F_126 ( 65535 * 512 / 8 , & V_306 [ 36 ] ) ;
F_127 ( 1 , & V_306 [ 28 ] ) ;
}
return 0 ;
}
...
{
int V_321 = F_129 ( args -> V_93 ) ;
int V_322 = F_130 ( args -> V_93 ) ;
V_306 [ 1 ] = 0xb1 ;
V_306 [ 3 ] = 0x3c ;
V_306 [ 4 ] = V_322 >> 8 ;
V_306 [ 5 ] = V_322 ;
...
static void F_133 ( T_3 * V_323 , const T_3 * V_324 , int V_325 , bool V_326 )
{
if ( V_326 ) {
...
static unsigned int F_134 ( T_6 * V_93 , T_3 * V_4 , bool V_326 )
{
F_133 ( V_4 , V_327 , sizeof( V_327 ) , V_326 ) ;
if ( V_326 || F_135 ( V_93 ) )
V_4 [ 2 ] |= ( 1 << 2 ) ;
if ( ! V_326 && ! F_136 ( V_93 ) )
V_4 [ 12 ] |= ( 1 << 5 ) ;
...
{
F_133 ( V_4 , V_328 , sizeof( V_328 ) , V_326 ) ;
return sizeof( V_328 ) ;
}
static unsigned int F_138 ( T_3 * V_4 , bool V_326 )
{
F_133 ( V_4 , V_329 , sizeof( V_329 ) ,
V_326 ) ;
return sizeof( V_329 ) ;
}
static int F_139 ( T_6 * V_93 )
{
...
if ( ! F_140 ( V_93 ) )
return 0 ;
F_141 ( V_93 , V_330 , V_96 , sizeof( V_330 ) ) ;
F_141 ( V_93 , V_331 , V_98 , sizeof( V_331 ) ) ;
...
break;
case V_345 :
V_333 += F_134 ( args -> V_93 , V_333 , V_338 == 1 ) ;
break;
case V_346 :
...
V_340 = 0 ;
if ( F_139 ( args -> V_93 ) && ( V_13 -> V_16 & V_266 ) &&
...
T_3 V_352 ;
T_6 V_353 ;
V_217 = F_75 ( V_13 -> V_93 ) ;
V_352 = F_123 ( V_13 -> V_93 ) ;
V_353 = F_144 ( V_13 -> V_93 , V_352 ) ;
F_94 ( L_31 ) ;
...
static unsigned int F_147 ( struct V_305 * args , T_3 * V_306 )
{
F_94 ( L_31 ) ;
V_306 [ 3 ] = 8 ;
return 0 ;
...
static inline int F_149 ( struct V_8 * V_9 )
{
return ( V_9 -> V_16 & V_127 ) ;
}
static void F_150 ( struct V_139 * V_140 )
{
struct V_8 * V_9 = V_140 -> V_9 ;
struct V_56 * V_57 = V_140 -> V_143 ;
F_100 ( L_45 ) ;
...
F_152 ( V_140 ) ;
F_153 ( & V_140 -> V_359 , V_57 -> V_64 , V_111 ) ;
F_108 ( V_140 , & V_140 -> V_359 , 1 ) ;
V_140 -> V_291 = V_116 ;
...
unsigned long V_16 ;
T_3 * V_4 ;
V_4 = F_110 ( V_57 , true , & V_16 ) ;
if ( V_4 [ 2 ] == 0 ) {
V_4 [ 2 ] = 0x5 ;
V_4 [ 3 ] = 0x32 ;
}
F_112 ( V_57 , true , & V_16 ) ;
}
V_57 -> V_61 = V_252 ;
}
F_103 ( V_140 ) ;
}
static unsigned int F_155 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
struct V_12 * V_13 = V_140 -> V_13 ;
...
V_140 -> V_154 . V_156 = V_362 ;
F_56 ( V_140 ) ;
if ( ! V_370 && ! V_371 && F_156 ( V_140 ) )
V_371 = 1 ;
V_152 = F_79 ( F_157 ( V_140 ) , ( unsigned int ) 63 * 1024 ) ;
if ( V_152 & 0x1 )
V_152 ++ ;
...
static struct V_12 * F_158 ( struct V_8 * V_9 , int V_43 )
{
if ( ! F_159 ( V_9 ) ) {
if ( F_66 ( V_43 < F_160 ( & V_9 -> V_11 ) ) )
return & V_9 -> V_11 . V_1 [ V_43 ] ;
} else {
if ( F_66 ( V_43 < V_9 -> V_375 ) )
return & V_9 -> V_376 [ V_43 ] . V_1 [ 0 ] ;
}
return NULL ;
}
static struct V_12 * F_84 ( struct V_8 * V_9 ,
...
return F_158 ( V_9 , V_43 ) ;
}
static struct V_12 *
F_13 ( struct V_8 * V_9 , const struct V_28 * V_102 )
{
struct V_12 * V_13 = F_84 ( V_9 , V_102 ) ;
if ( F_19 ( ! V_13 || ! F_87 ( V_13 ) ) )
return NULL ;
return V_13 ;
}
static T_3
...
static unsigned int F_162 ( struct V_139 * V_140 )
{
struct V_153 * V_154 = & ( V_140 -> V_154 ) ;
struct V_56 * V_149 = V_140 -> V_143 ;
struct V_12 * V_13 = V_140 -> V_13 ;
const T_3 * V_234 = V_149 -> V_235 ;
if ( ( V_154 -> V_240 = F_161 ( V_234 [ 1 ] ) ) == V_383 )
goto V_237;
V_154 -> V_16 |= V_243 ;
if ( V_234 [ 0 ] == V_118 ) {
if ( V_234 [ 1 ] & 0x01 ) {
...
static unsigned int F_164 ( struct V_139 * V_140 )
{
struct V_153 * V_154 = & V_140 -> V_154 ;
struct V_56 * V_149 = V_140 -> V_143 ;
struct V_12 * V_13 = V_140 -> V_13 ;
...
if ( ! F_55 ( V_149 ) )
goto V_237;
V_4 = F_165 ( F_166 ( F_54 ( V_149 ) ) ) ;
V_423 = F_167 ( V_4 , 512 , V_201 , V_261 ) ;
if ( F_88 ( V_13 ) && F_168 ( V_13 ) ) {
V_154 -> V_240 = V_382 ;
V_154 -> V_156 = V_424 ;
...
static int F_169 ( struct V_139 * V_140 ,
...
static unsigned int F_170 ( struct V_139 * V_140 )
{
struct V_56 * V_149 = V_140 -> V_143 ;
const T_3 * V_234 = V_149 -> V_235 ;
const T_3 * V_333 ;
...
goto V_237;
if ( ! F_55 ( V_149 ) || F_54 ( V_149 ) -> V_438 < V_45 )
goto V_439;
V_333 = F_165 ( F_166 ( F_54 ( V_149 ) ) ) ;
if ( V_45 < V_435 )
goto V_439;
if ( V_339 )
V_436 = V_333 [ 3 ] ;
...
static inline T_9 F_171 ( struct V_12 * V_13 , T_3 V_57 )
{
switch ( V_57 ) {
case V_281 :
case V_279 :
...
static inline void F_173 ( struct V_8 * V_9 ,
struct V_56 * V_57 )
{
#ifdef F_174
...
static inline int F_175 ( struct V_56 * V_149 ,
struct V_12 * V_13 )
{
...
goto V_446;
V_286 = F_171 ( V_13 , V_445 ) ;
} else {
if ( F_19 ( ! V_149 -> V_236 ) )
goto V_446;
V_286 = NULL ;
if ( F_66 ( ( V_445 != V_118 ) || ! V_447 ) ) {
int V_45 = F_176 ( V_445 ) ;
...
int F_178 ( struct V_6 * V_7 , struct V_56 * V_57 )
{
struct V_8 * V_9 ;
struct V_12 * V_13 ;
struct V_28 * V_102 = V_57 -> V_1 ;
...
void F_177 ( struct V_12 * V_13 , struct V_56 * V_57 )
{
struct V_305 args ;
...
int F_180 ( struct V_461 * V_34 , struct V_462 * V_463 )
{
int V_177 , V_33 ;
...
struct V_6 * V_7 ;
V_33 = - V_113 ;
V_7 = F_181 ( V_463 , sizeof( struct V_8 * ) ) ;
if ( ! V_7 )
goto V_466;
V_7 -> V_467 = 1 ;
...
void F_185 ( struct V_8 * V_9 , int V_480 )
{
int V_481 = 5 ;
...
V_377 = V_11 -> V_484 ;
V_29 = F_187 ( V_9 -> V_469 , V_377 , V_93 , 0 ,
NULL ) ;
if ( ! F_188 ( V_29 ) ) {
V_13 -> V_29 = V_29 ;
F_189 ( V_29 ) ;
...
F_192 ( V_486 , & V_9 -> V_487 ,
F_193 ( V_120 ) ) ;
}
int F_194 ( struct V_12 * V_13 )
{
if ( V_13 -> V_29 ) {
F_195 ( V_13 -> V_29 , V_488 ) ;
return 1 ;
}
return 0 ;
}
...
{
if ( V_13 -> V_29 )
F_207 ( V_13 -> V_29 , V_223 ,
V_492 ) ;
}
void F_208 ( struct V_493 * V_494 )
{
struct V_8 * V_9 =
F_209 ( V_494 , struct V_8 , V_487 . V_494 ) ;
int V_177 ;
if ( V_9 -> V_39 & V_495 ) {
F_100 ( L_53 ) ;
return;
...
F_203 ( & V_9 -> V_376 [ V_177 ] ) ;
F_185 ( V_9 , 0 ) ;
F_200 ( & V_9 -> V_497 ) ;
F_100 ( L_33 ) ;
}
int F_211 ( struct V_6 * V_7 , unsigned int V_377 ,
...
struct V_12 * V_13 = F_158 ( V_9 , V_43 ) ;
if ( V_13 ) {
...
void F_212 ( struct V_493 * V_494 )
{
struct V_8 * V_9 =
F_209 ( V_494 , struct V_8 , V_504 ) ;
struct V_10 * V_11 ;
struct V_12 * V_13 ;
unsigned long V_16 ;
F_197 ( & V_9 -> V_497 ) ;
...
int V_33 = 0 ;
F_173 ( V_9 , V_57 ) ;
if ( F_66 ( F_87 ( V_9 -> V_11 . V_1 ) ) )
V_33 = F_175 ( V_57 , V_9 -> V_11 . V_1 ) ;
else {
V_57 -> V_61 = ( V_449 << 16 ) ;
V_57 -> V_80 ( V_57 ) ;
}
...
void F_229 ( unsigned int V_142 , struct V_8 * V_9 )
{
F_230 ( V_142 , & V_9 -> V_522 ) ;
}
