...
V_35 = ( void * ) ( & V_30 [ 1 ] ) ;
snprintf ( V_35 , V_34 , L_6 , V_2 -> V_41 ) ;
V_30 -> V_35 = V_35 ;
V_30 -> V_43 = 0 ;
V_30 -> V_44 = 1 ;
V_30 -> V_45 = F_8 ;
...
V_35 = ( void * ) ( & V_30 [ 1 ] ) ;
snprintf ( V_35 , V_34 , L_8 , V_2 -> V_41 , V_28 + 1 ) ;
V_30 -> V_35 = V_35 ;
V_30 -> V_43 = 0 ;
V_30 -> V_44 = 1 ;
V_30 -> V_45 = F_10 ;
...
static T_4 * F_22 ( struct V_1 * V_2 , T_4 * V_48 ,
unsigned int * V_49 )
{
if ( * V_49 >= 115 && V_48 [ 11 ] == 0x02 && V_48 [ 13 ] == 0xc8
&& V_48 [ 29 ] == 0xbb && V_48 [ 40 ] == 0xc5 ) {
F_23 ( V_2 , L_10 ) ;
V_48 = V_50 ;
* V_49 = sizeof( V_50 ) ;
}
