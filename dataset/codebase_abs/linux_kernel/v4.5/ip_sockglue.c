...
static int F_118 ( struct V_90 * V_49 , int V_155 , int V_140 ,
char T_7 * V_156 , int T_7 * V_17 , unsigned int V_50 )
{
struct V_47 * V_48 = F_23 ( V_49 ) ;
bool V_157 = F_117 ( V_140 ) ;
int V_64 , V_34 = 0 ;
int V_40 ;
if ( V_155 != V_10 )
return - V_274 ;
if ( F_76 ( V_140 ) )
return F_119 ( V_49 , V_140 , V_156 , V_17 ) ;
if ( F_75 ( V_40 , V_17 ) )
return - V_174 ;
if ( V_40 < 0 )
return - V_67 ;
...
return F_120 ( 0 , V_17 ) ;
F_11 ( V_16 ) ;
V_40 = F_121 (unsigned int, len, opt->optlen) ;
if ( F_120 ( V_40 , V_17 ) )
return - V_174 ;
if ( F_122 ( V_156 , V_16 -> V_24 , V_40 ) )
return - V_174 ;
return 0 ;
}
case V_11 :
...
{
struct V_215 V_79 ;
V_40 = F_121 (unsigned int, len, sizeof(struct in_addr)) ;
V_79 . V_8 = V_48 -> V_221 ;
F_103 ( V_49 ) ;
if ( F_120 ( V_40 , V_17 ) )
return - V_174 ;
if ( F_122 ( V_156 , & V_79 , V_40 ) )
return - V_174 ;
return 0 ;
}
case V_146 :
...
if ( F_120 ( V_40 , V_17 ) )
return - V_174 ;
if ( F_122 ( V_156 , & V_175 , 1 ) )
return - V_174 ;
} else {
V_40 = F_121 (unsigned int, sizeof(int), len) ;
if ( F_120 ( V_40 , V_17 ) )
return - V_174 ;
if ( F_122 ( V_156 , & V_64 , V_40 ) )
return - V_174 ;
}
return 0 ;
V_135:
...
int F_128 ( struct V_90 * V_49 , int V_155 ,
int V_140 , char T_7 * V_156 , int T_7 * V_17 )
{
int V_34 ;
V_34 = F_118 ( V_49 , V_155 , V_140 , V_156 , V_17 , 0 ) ;
#ifdef F_112
...
return - V_174 ;
F_79 ( V_49 ) ;
V_34 = F_129 ( V_49 , V_184 , V_140 , V_156 ,
& V_40 ) ;
F_103 ( V_49 ) ;
if ( V_34 >= 0 )
V_34 = F_120 ( V_40 , V_17 ) ;
return V_34 ;
}
#endif
return V_34 ;
}
int F_130 ( struct V_90 * V_49 , int V_155 , int V_140 ,
char T_7 * V_156 , int T_7 * V_17 )
{
int V_34 ;
if ( V_140 == V_149 )
return F_131 ( V_49 , V_155 , V_140 , V_156 , V_17 ,
F_128 ) ;
V_34 = F_118 ( V_49 , V_155 , V_140 , V_156 , V_17 ,
V_287 ) ;
#ifdef F_112
if ( V_34 == - V_197 && V_140 != V_281 &&
! F_76 ( V_140 ) ) {
...
return - V_174 ;
F_79 ( V_49 ) ;
V_34 = F_132 ( V_49 , V_184 , V_140 , V_156 , & V_40 ) ;
F_103 ( V_49 ) ;
if ( V_34 >= 0 )
V_34 = F_120 ( V_40 , V_17 ) ;
return V_34 ;
