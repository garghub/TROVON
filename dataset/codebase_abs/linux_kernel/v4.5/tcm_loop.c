...
V_21 -> V_50 -> V_123 = F_107 (
V_68 , ( unsigned char * ) V_154 ) ;
if ( ! V_21 -> V_50 -> V_123 ) {
F_108 ( V_21 -> V_50 ) ;
goto V_159;
}
F_109 ( V_68 , V_21 -> V_50 -> V_123 ,
V_21 -> V_50 , V_21 ) ;
V_25 -> V_21 = V_21 ;
F_24 ( L_40
L_41 , F_92 ( V_23 ) ,
...
static T_4 F_112 ( struct V_148 * V_149 , char * V_150 )
{
struct V_67 * V_68 = F_113 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
struct V_20 * V_21 ;
T_4 V_71 ;
...
V_71 = F_105 ( V_25 , V_167 ) ;
if ( V_71 < 0 )
return V_71 ;
return V_151 ;
}
static T_4 F_115 ( struct V_148 * V_149 ,
char * V_150 )
{
struct V_67 * V_68 = F_113 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
...
static T_4 F_116 ( struct V_148 * V_149 ,
const char * V_150 , T_5 V_151 )
{
struct V_67 * V_68 = F_113 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
...
static T_4 F_118 ( struct V_148 * V_149 ,
char * V_150 )
{
struct V_67 * V_68 = F_113 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
...
int V_71 ;
unsigned long V_176 ;
if ( strstr ( V_154 , L_62 ) != V_154 ) {
F_26 ( L_63
L_64 ) ;
return F_120 ( - V_153 ) ;
}
if ( F_104 ( V_154 + 5 , 10 , & V_176 ) )
return F_120 ( - V_153 ) ;
if ( V_176 >= V_177 ) {
F_26 ( L_65
L_66 , V_176 , V_177 ) ;
...
V_25 -> V_23 = V_23 ;
V_25 -> V_121 = V_176 ;
V_71 = F_121 ( V_172 , & V_25 -> V_76 , V_23 -> V_141 ) ;
if ( V_71 < 0 )
return F_120 ( - V_155 ) ;
F_24 ( L_67
L_68 , F_92 ( V_23 ) ,
F_122 ( & V_172 -> V_178 . V_179 ) , V_176 ) ;
return & V_25 -> V_76 ;
}
static void F_123 (
struct V_67 * V_68 )
...
V_166 = strstr ( V_154 , L_50 ) ;
if ( V_166 ) {
V_23 -> V_141 = V_142 ;
goto V_184;
}
V_166 = strstr ( V_154 , L_53 ) ;
if ( V_166 ) {
V_23 -> V_141 = V_143 ;
V_183 = 3 ;
goto V_184;
}
V_166 = strstr ( V_154 , L_55 ) ;
if ( ! V_166 ) {
F_26 ( L_72
L_73 , V_154 ) ;
V_71 = - V_153 ;
...
F_26 ( L_74
L_48 , V_154 , F_92 ( V_23 ) ,
V_165 ) ;
V_71 = - V_153 ;
goto V_159;
}
snprintf ( & V_23 -> V_120 [ 0 ] , V_165 , L_49 , & V_154 [ V_183 ] ) ;
V_71 = F_54 ( V_23 , V_185 ) ;
if ( V_71 )
goto V_159;
V_57 = V_23 -> V_57 ;
V_185 ++ ;
...
F_24 ( L_77
L_76 ,
F_92 ( V_23 ) , V_23 -> V_120 ,
V_23 -> V_57 -> V_58 ) ;
F_127 ( & V_23 -> V_13 ) ;
}
static T_4 F_128 ( struct V_148 * V_149 , char * V_150 )
{
return sprintf ( V_150 , L_78 , V_186 ) ;
}
