...
V_28 . V_24 = V_24 ;
V_28 . V_34 = V_25 ;
V_30 = ! F_19 ( V_22 , L_2 , NULL ) ;
for ( V_29 = 0 ; V_29 < F_11 ( V_6 -> V_4 ) ; V_29 ++ ) {
snprintf ( V_26 , F_11 ( V_26 ) , L_3 , V_29 ) ;
V_6 -> V_4 [ V_29 ] . V_6 = V_6 ;
V_6 -> V_4 [ V_29 ] . V_9 = V_29 ;
V_6 -> V_4 [ V_29 ] . V_2 . V_28 = & V_28 ;
if ( V_30 )
V_28 . V_31 -> V_35 ( & V_6 -> V_4 [ V_29 ] . V_2 , 1 ) ;
V_6 -> V_4 [ V_29 ] . V_16 = F_20 ( NULL ,
& V_6 -> V_4 [ V_29 ] . V_2 ) ;
F_6 ( F_21 ( V_6 -> V_4 [ V_29 ] . V_16 ) ) ;
}
F_22 ( V_22 , F_10 , V_6 ) ;
}
