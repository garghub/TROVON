...
unsigned int V_165 ;
if ( V_377 ) {
F_30 ( V_160 -> V_167 , V_107 , 0x0006 ) ;
F_56 ( V_175 , L_16 ) ;
F_56 ( V_175 , L_17 ) ;
F_57 ( V_175 ) ;
if ( ! V_175 -> V_378 -> V_379 ) {
F_15 ( V_160 -> V_167 , V_82 ,
V_367 | V_369 ,
V_367 | V_369 ) ;
F_15 ( V_160 -> V_167 , V_84 ,
V_380 , V_380 ) ;
...
V_382 , V_382 ) ;
F_15 ( V_160 -> V_167 , V_12 ,
V_383 , V_383 ) ;
F_33 ( 100 ) ;
F_15 ( V_160 -> V_167 , V_13 ,
V_382 , 0 ) ;
F_33 ( 600 ) ;
F_61 ( V_160 -> V_167 , V_14 , & V_165 ) ;
V_165 &= 0x7 ;
...
F_15 ( V_160 -> V_167 , V_19 ,
V_389 , V_390 ) ;
} else {
V_160 -> V_384 = 0 ;
F_15 ( V_160 -> V_167 , V_28 ,
V_271 | V_272 ,
V_271 | V_272 ) ;
F_15 ( V_160 -> V_167 , V_13 ,
V_382 , V_382 ) ;
...
return;
case 1 :
V_165 = F_27 ( V_160 -> V_2 , V_15 ) & 0x0070 ;
break;
default:
V_165 = F_27 ( V_160 -> V_2 , V_15 ) & 0x0020 ;
break;
}
switch ( V_165 ) {
case 0x30 :
...
V_160 -> V_387 = V_429 ;
V_160 -> V_403 = F_92 ( & V_422 -> V_5 , L_27 ,
V_430 ) ;
if ( F_93 ( V_160 -> V_403 ) ) {
F_24 ( & V_422 -> V_5 , L_28 ) ;
return F_94 ( V_160 -> V_403 ) ;
}
for ( V_7 = 0 ; V_7 < F_4 ( V_160 -> V_431 ) ; V_7 ++ )
V_160 -> V_431 [ V_7 ] . V_432 = V_433 [ V_7 ] ;
V_166 = F_95 ( & V_422 -> V_5 ,
F_4 ( V_160 -> V_431 ) ,
V_160 -> V_431 ) ;
if ( V_166 ) {
...
V_166 = F_96 ( F_4 ( V_160 -> V_431 ) ,
V_160 -> V_431 ) ;
if ( V_166 ) {
F_24 ( & V_422 -> V_5 , L_30 , V_166 ) ;
return V_166 ;
}
V_167 = F_97 ( V_422 , & V_434 ) ;
if ( F_93 ( V_167 ) ) {
V_166 = F_94 ( V_167 ) ;
F_24 ( & V_422 -> V_5 , L_31 ,
V_166 ) ;
...
F_61 ( V_167 , V_26 , & V_165 ) ;
switch ( V_165 ) {
case V_435 :
V_160 -> V_167 = F_97 ( V_422 , & V_436 ) ;
V_160 -> V_218 = V_243 ;
break;
case V_437 :
V_160 -> V_167 = F_97 ( V_422 , & V_438 ) ;
V_160 -> V_218 = V_219 ;
break;
default:
F_24 ( & V_422 -> V_5 ,
...
if ( F_93 ( V_160 -> V_167 ) ) {
V_166 = F_94 ( V_160 -> V_167 ) ;
F_24 ( & V_422 -> V_5 , L_33 ,
V_166 ) ;
return V_166 ;
}
F_30 ( V_160 -> V_167 , V_3 , 0 ) ;
V_166 = F_98 ( V_160 -> V_167 , V_441 ,
F_4 ( V_441 ) ) ;
if ( V_166 != 0 )
F_99 ( & V_422 -> V_5 , L_34 , V_166 ) ;
if ( V_160 -> V_218 == V_219 ) {
V_166 = F_98 ( V_160 -> V_167 , V_442 ,
F_4 ( V_442 ) ) ;
if ( V_166 != 0 )
F_99 ( & V_422 -> V_5 , L_35 ,
V_166 ) ;
...
F_101 ( & V_160 -> V_373 , F_65 ) ;
F_101 ( & V_160 -> V_171 , F_70 ) ;
if ( V_160 -> V_422 -> V_411 ) {
V_166 = F_102 ( V_160 -> V_422 -> V_411 , NULL , F_64 ,
V_484 | V_485
| V_486 , L_36 , V_160 ) ;
if ( V_166 ) {
...
V_489:
if ( V_160 -> V_422 -> V_411 )
F_104 ( V_160 -> V_422 -> V_411 , V_160 ) ;
V_440:
F_105 ( F_4 ( V_160 -> V_431 ) , V_160 -> V_431 ) ;
return V_166 ;
}
static int F_106 ( struct V_421 * V_422 )
{
struct V_159 * V_160 = F_107 ( V_422 ) ;
if ( V_422 -> V_411 )
F_104 ( V_422 -> V_411 , V_160 ) ;
F_108 ( & V_160 -> V_373 ) ;
F_108 ( & V_160 -> V_171 ) ;
F_109 ( & V_422 -> V_5 ) ;
F_105 ( F_4 ( V_160 -> V_431 ) , V_160 -> V_431 ) ;
...
F_15 ( V_160 -> V_167 , V_146 ,
V_490 , V_490 ) ;
F_15 ( V_160 -> V_167 , V_13 , V_382 ,
V_382 ) ;
F_15 ( V_160 -> V_167 , V_12 , V_383 ,
0 ) ;
F_33 ( 20 ) ;
F_30 ( V_160 -> V_167 , V_3 , 0 ) ;
}
