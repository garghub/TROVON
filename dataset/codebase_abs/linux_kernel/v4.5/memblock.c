...
V_22 , ( void * ) V_67 ) ;
return F_42 ( type , V_8 , V_9 , V_21 , V_22 ) ;
}
...
#ifdef F_44
if ( F_40 ( V_59 ) != V_37 )
snprintf ( V_114 , sizeof( V_114 ) , L_19 ,
F_40 ( V_59 ) ) ;
#endif
F_112 ( L_20 ,
...
{
struct V_123 * V_124 = F_121 ( L_27 , NULL ) ;
if ( ! V_124 )
return - V_125 ;
F_122 ( L_1 , V_126 , V_124 , & V_5 . V_6 , & V_127 ) ;
F_122 ( L_2 , V_126 , V_124 , & V_5 . V_7 , & V_127 ) ;
#ifdef F_123
F_122 ( L_28 , V_126 , V_124 , & V_5 . V_128 , & V_127 ) ;
#endif
return 0 ;
}
