...
int F_39 ( struct V_1 * V_2 , const struct V_19 * V_20 )
{
return 0 ;
}
...
if ( V_30 -> V_36 . V_37 & V_4 -> V_38 ) {
V_4 -> V_8 = V_30 ;
return 0 ;
}
V_30 = (struct V_29 * ) ( ( unsigned long ) V_30 + V_5 -> V_39 ) ;
}
switch ( V_4 -> V_38 ) {
case V_40 :
case V_41 :
...
return - V_48 ;
if ( F_5 ( V_2 -> V_10 -> V_11 , V_49 ) )
return F_74 ( V_2 -> V_5 , & V_43 ) ;
return 0 ;
}
