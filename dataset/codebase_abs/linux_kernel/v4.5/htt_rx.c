...
{
struct V_380 * V_199 =
(struct V_380 * ) V_9 -> V_36 ;
F_152 ( V_3 , V_199 -> V_370 ,
sizeof( * V_199 ) + F_58 ( V_199 -> V_19 ) ) ;
F_10 ( V_9 ) ;
}
...
struct V_296 * V_297 ;
struct V_1 * V_9 ;
while ( ( V_9 = F_154 ( & V_8 -> V_52 ) ) ) {
F_133 ( V_8 -> V_3 , V_9 ) ;
F_10 ( V_9 ) ;
}
F_29 ( & V_8 -> V_13 . V_41 ) ;
while ( ( V_9 = F_120 ( & V_8 -> V_53 ) ) ) {
V_297 = (struct V_296 * ) V_9 -> V_36 ;
F_129 ( V_8 , & V_297 -> V_381 ) ;
F_10 ( V_9 ) ;
}
while ( ( V_9 = F_120 ( & V_8 -> V_54 ) ) ) {
F_144 ( V_3 , V_9 ) ;
F_10 ( V_9 ) ;
}
F_34 ( & V_8 -> V_13 . V_41 ) ;
