...
V_21 = V_44 + V_31 - 1 ;
F_3 ( & V_16 -> V_26 . V_27 , V_18 ) ;
if ( ( V_16 -> V_26 . V_21 - V_16 -> V_26 . y1 ) &&
...
V_5 -> V_17 = V_16 ;
F_49 ( V_3 -> V_102 , & V_16 -> V_23 , & V_80 , V_69 ) ;
V_95 = & V_16 -> V_23 . V_24 ;
V_16 -> V_66 . V_95 = V_95 ;
V_16 -> V_42 = V_42 ;
strcpy ( V_5 -> V_9 . V_103 , L_5 ) ;
F_50 ( V_5 , V_95 -> V_25 [ 0 ] , V_95 -> V_13 ) ;
V_5 -> V_18 = V_104 | V_105 | V_106 ;
V_5 -> V_107 = & V_108 ;
V_5 -> V_9 . V_109 = V_3 -> V_110 ;
V_5 -> V_9 . V_111 = V_69 -> V_83 ;
V_5 -> V_112 = V_16 -> V_42 ;
V_5 -> V_113 = V_69 -> V_83 ;
F_51 ( V_5 , & V_16 -> V_66 , V_93 -> V_114 ,
V_93 -> V_115 ) ;
V_5 -> V_116 -> V_117 [ 0 ] . V_24 = V_3 -> V_102 -> V_118 . V_119 ;
V_5 -> V_116 -> V_117 [ 0 ] . V_83 = V_3 -> V_120 ;
V_5 -> V_9 . V_121 = 0 ;
V_5 -> V_9 . V_122 = 0 ;
if ( V_5 -> V_112 == NULL ) {
V_72 = - V_123 ;
...
V_3 -> V_127 = V_5 ;
V_3 -> V_77 = & V_16 -> V_23 ;
F_53 ( L_6 , V_5 -> V_9 . V_109 , ( unsigned long ) V_5 -> V_113 ) ;
...
static int F_59 ( struct V_130 * V_131 , struct V_15 * V_16 )
{
struct V_132 * V_23 = & V_16 -> V_23 ;
F_60 ( & V_16 -> V_66 ) ;
F_54 ( & V_16 -> V_66 ) ;
if ( V_23 -> V_78 ) {
F_21 ( V_23 -> V_78 ) ;
...
int V_133 = 32 ;
int V_72 ;
V_16 = F_64 ( sizeof( struct V_15 ) , V_134 ) ;
if ( ! V_16 )
return - V_87 ;
V_16 -> V_3 = V_3 ;
V_3 -> V_65 . V_16 = V_16 ;
...
F_65 ( & V_16 -> V_26 . V_27 ) ;
F_66 ( & V_16 -> V_136 ) ;
F_67 ( V_3 -> V_102 , & V_16 -> V_66 ,
& V_137 ) ;
V_72 = F_68 ( V_3 -> V_102 , & V_16 -> V_66 ,
V_138 ,
V_139 ) ;
if ( V_72 )
goto free;
...
if ( ! V_3 -> V_65 . V_16 )
return;
F_59 ( V_3 -> V_102 , V_3 -> V_65 . V_16 ) ;
F_57 ( V_3 -> V_65 . V_16 ) ;
V_3 -> V_65 . V_16 = NULL ;
}
void F_72 ( struct V_2 * V_3 , int V_141 )
{
F_73 ( & V_3 -> V_65 . V_16 -> V_66 , V_141 ) ;
}
bool F_74 ( struct V_2 * V_3 , struct V_70 * V_142 )
{
if ( V_142 == F_22 ( V_3 -> V_65 . V_16 -> V_23 . V_78 ) )
return true ;
return false ;
}
