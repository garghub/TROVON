...
if ( V_4 -> V_16 & ( 1 << V_3 ) )
return - V_17 ;
return F_10 ( V_5 , 1 << V_3 , V_18 ) ;
}
static int F_11 ( struct V_19 * V_20 , unsigned int type )
{
struct V_1 * V_21 = F_12 ( V_20 ) ;
...
static void F_23 ( struct V_46 * V_47 , struct V_1 * V_21 )
{
unsigned V_40 ;
unsigned V_48 = V_21 -> V_61 ;
for ( V_40 = 0 ; V_40 < V_21 -> V_62 ; V_40 ++ , V_48 ++ ) {
F_20 ( V_47 , V_21 , V_40 , V_48 ) ;
F_22 ( V_47 , L_12 ) ;
}
}
static T_2 F_24 ( int V_63 , void * V_64 )
{
struct V_4 * V_4 = V_64 ;
struct V_5 * V_5 = V_4 -> V_5 ;
...
{
struct V_5 * V_5 = F_30 ( V_77 -> V_64 . V_78 ) ;
struct V_79 * V_80 = V_77 -> V_64 . V_81 ;
struct V_4 * V_4 ;
int V_10 ;
int V_63 = 0 ;
V_63 = F_31 ( V_77 , 0 ) ;
V_4 = F_32 ( sizeof( struct V_4 ) , V_82 ) ;
if ( ! V_4 )
return - V_83 ;
F_33 ( & V_4 -> V_32 ) ;
V_4 -> V_64 = & V_77 -> V_64 ;
...
if ( V_10 )
goto V_87;
V_10 = F_38 ( & V_4 -> V_2 , V_4 ) ;
if ( V_10 ) {
F_39 ( & V_77 -> V_64 , L_16 , V_10 ) ;
goto V_88;
}
if ( V_63 > 0 ) {
V_10 = F_40 ( & V_77 -> V_64 , V_63 , NULL ,
F_24 , V_89 ,
L_17 , V_4 ) ;
if ( V_10 ) {
F_39 ( & V_77 -> V_64 , L_18 , V_10 ) ;
goto V_88;
}
V_10 = F_41 ( & V_4 -> V_2 ,
& V_90 ,
