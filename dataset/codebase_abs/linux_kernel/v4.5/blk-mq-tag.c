...
void F_54 ( struct V_11 * V_12 , T_3 * V_62 ,
void * V_69 )
{
if ( V_12 -> V_51 )
...
void F_55 ( struct V_70 * V_46 , T_2 * V_62 ,
void * V_69 )
{
struct V_18 * V_19 ;
int V_3 ;
...
F_69 ( & V_2 -> V_26 [ V_3 ] . V_55 , V_2 -> V_56 ) ;
}
return 0 ;
}
...
goto V_80;
if ( F_62 ( & V_12 -> V_28 , V_12 -> V_51 , V_75 , true ) )
goto V_80;
return V_12 ;
V_80:
F_70 ( & V_12 -> V_13 ) ;
...
{
struct V_70 * V_46 = V_65 -> V_46 ;
struct V_18 * V_19 ;
int V_87 = 0 ;
if ( V_46 -> V_47 ) {
V_19 = V_46 -> V_47 -> V_48 ( V_46 , V_65 -> V_88 -> V_49 ) ;
V_87 = V_19 -> V_89 ;
}
return ( V_87 << V_90 ) |
( V_65 -> V_35 & V_91 ) ;
