...
F_31 ( ! V_9 || ! V_51 ) ;
F_32 ( V_51 , V_49 ) ;
F_33 (pos, &priv->bank_list) {
struct V_4 * V_5 =
F_34 ( V_53 , struct V_4 , V_54 ) ;
F_22 ( V_5 ) ;
}
F_35 ( V_51 , V_49 ) ;
}
static int F_36 ( struct V_55 * V_56 ,
unsigned long V_57 , void * V_39 )
{
struct V_1 * V_9 =
F_37 ( V_56 , struct V_1 , V_58 ) ;
if ( V_57 == V_59 )
F_15 ( V_9 , 1 ) ;
return V_60 ;
}
static int F_38 ( struct V_61 * V_37 ,
struct V_62 * V_63 , struct V_64 * V_65 )
{
int V_66 = F_39 ( V_65 ) / V_67 ;
int V_68 =
F_40 ( V_63 , L_5 ) ;
if ( V_66 != V_68 ) {
F_18 ( V_37 , L_6 ,
...
static int F_41 ( struct V_69 * V_36 )
{
struct V_1 * V_9 = F_42 ( V_36 ) ;
struct V_52 * V_53 ;
struct V_4 * V_5 ;
int V_34 = 0 ;
if ( ! V_9 ) {
F_18 ( & V_36 -> V_37 , L_7 , V_70 ) ;
return - V_71 ;
}
F_33 (pos, &priv->bank_list) {
V_5 = F_34 ( V_53 , struct V_4 , V_54 ) ;
F_43 ( & V_5 -> V_3 ) ;
}
if ( V_9 -> V_58 . V_72 ) {
V_34 = F_44 ( & V_9 -> V_58 ) ;
...
const struct V_73 * V_74 , T_1 * V_13 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
int V_7 ;
...
if ( F_46 ( V_74 -> V_76 < V_3 -> V_75 ) )
return - V_33 ;
V_7 = V_74 -> args [ 0 ] - ( V_3 -> V_77 - V_9 -> V_78 ) ;
if ( V_7 >= V_3 -> V_79 || V_7 < 0 )
return - V_33 ;
if ( F_47 ( V_7 >= V_5 -> V_47 ) ) {
F_48 ( & V_9 -> V_36 -> V_37 ,
L_9 ,
V_74 -> args [ 0 ] ) ;
}
...
static int F_49 ( struct V_69 * V_36 ,
struct V_4 * V_5 )
{
struct V_1 * V_9 = V_5 -> V_6 ;
struct V_61 * V_37 = & V_36 -> V_37 ;
struct V_62 * V_63 = V_37 -> V_80 ;
V_5 -> V_50 . V_81 = F_50 ( V_37 ) ;
V_5 -> V_50 . V_82 = F_7 ;
V_5 -> V_50 . V_83 = F_9 ;
V_5 -> V_50 . V_84 = F_10 ;
V_5 -> V_50 . V_13 = V_85 ;
if ( F_51 ( V_86 ) && ! V_9 -> V_87 &&
F_52 ( V_63 , L_10 ) ) {
V_9 -> V_35 = F_53 ( V_36 , 1 ) ;
if ( V_9 -> V_35 < 0 ) {
F_25 ( V_37 ,
L_11 ) ;
} else {
...
if ( V_9 -> V_87 )
V_5 -> V_50 . V_89 = F_19 ;
F_58 ( & V_5 -> V_3 , & V_5 -> V_50 , 0 ,
V_90 , V_91 ) ;
F_59 ( & V_5 -> V_3 , & V_5 -> V_50 ,
V_9 -> V_92 , F_28 ) ;
return 0 ;
}
static int F_60 ( struct V_69 * V_36 )
{
struct V_61 * V_37 = & V_36 -> V_37 ;
struct V_62 * V_63 = V_37 -> V_80 ;
void T_3 * V_16 ;
...
V_9 = F_61 ( V_37 , sizeof( * V_9 ) , V_97 ) ;
if ( ! V_9 )
return - V_98 ;
F_62 ( V_36 , V_9 ) ;
F_63 ( & V_9 -> V_99 ) ;
V_65 = F_64 ( V_36 , V_100 , 0 ) ;
V_16 = F_65 ( V_37 , V_65 ) ;
if ( F_66 ( V_16 ) )
return F_67 ( V_16 ) ;
V_9 -> V_78 = V_78 ;
...
if ( F_38 ( V_37 , V_63 , V_65 ) )
return - V_33 ;
#if F_68 ( V_102 ) && F_68 ( V_103 )
V_13 = V_104 ;
#endif
F_69 (np, L_5 , prop, p,
bank_width) {
...
V_3 = & V_5 -> V_3 ;
V_88 = F_70 ( V_3 , V_37 , 4 ,
V_16 + F_71 ( V_5 -> V_17 ) ,
NULL , NULL , NULL ,
V_16 + F_72 ( V_5 -> V_17 ) , V_13 ) ;
if ( V_88 ) {
F_18 ( V_37 , L_17 ) ;
goto V_105;
}
...
F_74 ( V_37 , L_19 , V_5 -> V_17 ,
V_3 -> V_77 , V_3 -> V_79 , V_5 -> V_47 ) ;
F_75 ( & V_5 -> V_54 , & V_9 -> V_99 ) ;
V_68 ++ ;
}
F_76 ( V_37 , L_20 ,
V_68 , V_9 -> V_78 , V_78 - 1 ) ;
return 0 ;
V_105:
( void ) F_41 ( V_36 ) ;
return V_88 ;
