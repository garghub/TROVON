...
V_15 = V_20 -> V_27 -> V_26 ;
if ( ! V_94 -> V_100 ) {
V_94 -> V_100 = F_65 ( V_15 ) ;
if ( ! V_94 -> V_100 )
return - V_6 ;
V_94 -> V_100 -> V_65 = F_67 ;
}
V_94 -> V_20 = V_20 ;
F_23 ( & V_94 -> V_95 ) ;
V_94 -> V_96 = 0 ;
...
struct V_13 * V_17 ;
struct V_14 * V_15 ;
int V_102 , V_103 , V_11 , V_3 ;
do {
V_20 = V_94 -> V_20 ;
F_73 ( V_104 ) ;
if ( ! V_20 || ! V_20 -> V_27
|| ! V_20 -> V_27 -> V_26 || ! V_94 -> V_100 )
goto V_105;
V_17 = V_94 -> V_100 ;
V_15 = V_20 -> V_27 -> V_26 ;
F_29 ( & V_94 -> V_95 ) ;
...
if ( V_11 < V_3 )
V_3 = V_11 ;
V_102 = F_9 ( & V_94 -> V_106 , V_17 -> V_10 , V_3 ) ;
V_17 -> V_18 = V_102 ;
F_21 ( & V_94 -> V_95 ) ;
V_103 = F_22 ( V_15 , V_17 , V_41 ) ;
F_23 ( & V_94 -> V_95 ) ;
if ( V_103 < 0 )
V_94 -> V_96 = 0 ;
else
...
static int F_76 ( struct V_108 * V_109 , char * V_110 )
{
struct V_93 * V_94 = & V_93 ;
int V_28 ;
V_94 -> V_20 = NULL ;
...
F_70 ( L_26 , V_42 ) ;
F_3 ( & V_94 -> V_106 ) ;
return F_80 ( V_94 -> V_97 ) ;
}
F_68 ( V_94 -> V_97 ) ;
return 0 ;
}
static void F_81 ( struct V_108 * V_109 ,
const char * V_10 , unsigned V_11 )
{
struct V_93 * V_94 = & V_93 ;
unsigned long V_55 ;
F_56 ( & V_94 -> V_95 , V_55 ) ;
F_8 ( & V_94 -> V_106 , V_10 , V_11 ) ;
F_57 ( & V_94 -> V_95 , V_55 ) ;
F_68 ( V_94 -> V_97 ) ;
}
static struct V_112 * F_82 ( struct V_108 * V_109 , int * V_71 )
{
struct V_112 * * V_83 = (struct V_112 * * ) V_109 -> V_101 ;
if ( ! * V_83 )
return NULL ;
* V_71 = V_109 -> V_71 ;
return * V_83 ;
...
static int
F_88 ( unsigned V_38 , struct V_113 * V_114 )
{
struct V_19 * V_20 ;
int V_103 = 0 ;
F_47 ( & V_72 [ V_38 ] . V_73 ) ;
...
F_91 ( & V_20 -> V_36 ) ;
F_91 ( & V_20 -> V_87 ) ;
F_92 ( & V_20 -> V_60 , F_28 , ( unsigned long ) V_20 ) ;
F_93 ( & V_20 -> V_45 ) ;
F_93 ( & V_20 -> V_51 ) ;
F_93 ( & V_20 -> V_25 ) ;
V_20 -> V_38 = V_38 ;
...
int F_101 ( unsigned char * V_117 )
{
struct V_113 V_114 ;
struct V_118 * V_119 ;
int V_103 ;
int V_38 ;
V_114 . V_120 = F_102 ( 9600 ) ;
V_114 . V_121 = 8 ;
V_114 . V_122 = V_123 ;
V_114 . V_124 = V_125 ;
for ( V_38 = 0 ; V_38 < V_126 ; V_38 ++ ) {
V_103 = F_88 ( V_38 , & V_114 ) ;
if ( V_103 == - V_76 )
continue;
if ( V_103 )
return V_103 ;
...
if ( V_103 )
return V_103 ;
V_119 = F_103 ( & V_72 [ V_38 ] . V_20 -> V_20 ,
V_116 , V_38 , NULL ) ;
if ( F_79 ( V_119 ) ) {
struct V_19 * V_20 ;
F_70 ( L_27 ,
V_42 , V_38 , F_80 ( V_119 ) ) ;
V_103 = F_80 ( V_119 ) ;
V_20 = V_72 [ V_38 ] . V_20 ;
V_72 [ V_38 ] . V_20 = NULL ;
F_95 ( V_20 ) ;
...
int F_104 ( struct V_80 * V_81 , V_39 V_38 )
{
struct V_19 * V_20 ;
unsigned long V_55 ;
int V_28 ;
...
V_28 = F_105 ( V_81 -> V_26 ) ;
if ( V_28 < 0 )
return V_28 ;
V_81 -> V_26 -> V_61 = V_20 ;
V_28 = F_105 ( V_81 -> V_46 ) ;
if ( V_28 < 0 )
goto V_129;
V_81 -> V_46 -> V_61 = V_20 ;
F_56 ( & V_20 -> V_40 , V_55 ) ;
...
void F_107 ( struct V_80 * V_81 )
{
struct V_19 * V_20 = V_81 -> V_130 ;
unsigned long V_55 ;
if ( ! V_20 )
return;
F_56 ( & V_20 -> V_40 , V_55 ) ;
V_20 -> V_115 = V_81 -> V_115 ;
V_20 -> V_27 = NULL ;
V_81 -> V_130 = NULL ;
...
V_116 -> type = V_132 ;
V_116 -> V_133 = V_134 ;
V_116 -> V_55 = V_135 | V_136 ;
V_116 -> V_137 = V_138 ;
V_116 -> V_137 . V_139 =
V_140 | V_141 | V_142 | V_143 | V_144 ;
V_116 -> V_137 . V_145 = 9600 ;
V_116 -> V_137 . V_146 = 9600 ;
F_111 ( V_116 , & V_147 ) ;
for ( V_64 = 0 ; V_64 < V_126 ; V_64 ++ )
F_112 ( & V_72 [ V_64 ] . V_73 ) ;
V_28 = F_113 ( V_116 ) ;
if ( V_28 ) {
F_70 ( L_33 ,
V_42 , V_28 ) ;
