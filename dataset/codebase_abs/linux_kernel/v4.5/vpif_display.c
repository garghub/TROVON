...
unsigned V_28 = V_10 -> V_12 . V_12 . V_13 . V_14 ;
if ( * V_25 ) {
if ( V_26 [ 0 ] < V_28 )
return - V_15 ;
V_28 = V_26 [ 0 ] ;
...
struct V_139 V_140 ;
int V_45 ;
if ( V_82 -> V_60 [ V_7 -> V_52 ] . V_141 == NULL )
return - V_142 ;
...
V_51 = F_72 () ;
if ( V_51 ) {
F_90 ( V_39 -> V_120 , L_26 ) ;
return V_51 ;
}
V_51 = F_91 ( V_39 , & V_72 . V_146 ) ;
if ( V_51 ) {
F_90 ( V_39 -> V_120 , L_27 ) ;
return V_51 ;
}
while ( ( V_251 = F_92 ( V_246 , V_253 , V_252 ) ) ) {
V_51 = F_93 ( & V_246 -> V_71 , V_251 -> V_254 , F_40 ,
V_255 , V_121 ,
...
V_72 . V_160 = F_73 ( sizeof( struct V_159 * ) * V_156 ,
V_207 ) ;
if ( V_72 . V_160 == NULL ) {
F_11 ( L_29 ) ;
V_51 = - V_208 ;
...
V_72 . V_211 . V_260 = V_72 . V_82 -> V_214 ;
V_72 . V_211 . V_261 = V_72 . V_82 -> V_257 [ 0 ] ;
V_72 . V_211 . V_262 = F_75 ;
V_72 . V_211 . V_263 = F_88 ;
V_51 = F_96 ( & V_72 . V_146 ,
& V_72 . V_211 ) ;
if ( V_51 ) {
F_11 ( L_31 ) ;
V_51 = - V_15 ;
...
static int F_99 ( struct V_264 * V_71 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
...
static int F_103 ( struct V_264 * V_71 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
