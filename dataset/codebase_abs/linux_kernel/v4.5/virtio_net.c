...
V_43 = F_55 ( V_11 -> V_2 , V_11 -> V_96 , 2 , V_8 , V_93 ) ;
if ( V_43 < 0 )
F_24 ( V_8 ) ;
return V_43 ;
}
...
F_53 ( & V_11 -> V_96 [ V_99 ] , F_16 ( V_97 ) , V_38 ) ;
...
F_53 ( & V_11 -> V_96 [ 1 ] , V_17 + V_28 , V_38 - V_28 ) ;
V_97 -> V_14 = ( unsigned long ) V_98 ;
V_43 = F_55 ( V_11 -> V_2 , V_11 -> V_96 , V_37 + 2 ,
V_97 , V_93 ) ;
if ( V_43 < 0 )
F_6 ( V_11 , V_97 ) ;
return V_43 ;
...
V_43 = F_55 ( V_11 -> V_2 , V_11 -> V_96 , 1 , ( void * ) V_46 , V_93 ) ;
if ( V_43 < 0 )
F_22 ( F_33 ( V_26 ) ) ;
return V_43 ;
}
...
V_43 = F_56 ( V_19 , V_11 , V_93 ) ;
else
V_43 = F_50 ( V_19 , V_11 , V_93 ) ;
V_105 = V_43 == - V_95 ;
if ( V_43 )
break;
...
if ( ! F_64 ( V_19 , V_11 , V_56 ) )
F_76 ( & V_19 -> V_111 , 0 ) ;
}
return V_117 ;
}
static int F_79 ( struct V_118 * V_91 , int V_116 )
{
struct V_10 * V_11 =
F_74 ( V_91 , struct V_10 , V_91 ) ;
...
static int F_83 ( struct V_118 * V_91 )
{
struct V_10 * V_11 =
F_74 ( V_91 , struct V_10 , V_91 ) ;
struct V_18 * V_19 = V_11 -> V_2 -> V_20 -> V_21 ;
...
static int F_85 ( struct V_42 * V_22 )
{
...
if ( V_19 -> V_35 )
V_30 -> V_48 = 0 ;
F_52 ( V_129 -> V_96 , F_27 ( V_8 ) -> V_41 + ( V_138 ? 1 : 2 ) ) ;
if ( V_138 ) {
F_98 ( V_8 , V_32 ) ;
...
return F_100 ( V_129 -> V_2 , V_129 -> V_96 , V_137 , V_8 , V_56 ) ;
}
static T_4 F_101 ( struct V_7 * V_8 , struct V_42 * V_22 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
int V_141 = F_102 ( V_8 ) ;
...
F_116 ( V_19 -> V_159 , V_152 , V_154 , 1 , V_19 , V_56 ) ;
...
static int F_119 ( struct V_42 * V_22 , void * V_17 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
...
unsigned int V_178 ;
F_124 (cpu) {
struct V_61 * V_44 = F_125 ( V_19 -> V_44 , V_177 ) ;
T_6 V_179 , V_180 , V_181 , V_182 ;
do {
V_178 = F_126 ( & V_44 -> V_130 ) ;
V_179 = V_44 -> V_132 ;
V_180 = V_44 -> V_131 ;
} while ( F_127 ( & V_44 -> V_130 , V_178 ) );
do {
V_178 = F_126 ( & V_44 -> V_65 ) ;
V_181 = V_44 -> V_67 ;
V_182 = V_44 -> V_66 ;
} while ( F_127 ( & V_44 -> V_65 , V_178 ) );
V_176 -> V_67 += V_181 ;
V_176 -> V_132 += V_179 ;
V_176 -> V_66 += V_182 ;
V_176 -> V_131 += V_180 ;
...
static void F_128 ( struct V_42 * V_22 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
int V_99 ;
for ( V_99 = 0 ; V_99 < V_19 -> V_113 ; V_99 ++ )
F_129 ( & V_19 -> V_11 [ V_99 ] . V_91 ) ;
}
...
static int F_134 ( struct V_42 * V_22 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
int V_99 ;
F_135 ( & V_19 -> V_111 ) ;
for ( V_99 = 0 ; V_99 < V_19 -> V_127 ; V_99 ++ )
F_75 ( & V_19 -> V_11 [ V_99 ] . V_91 ) ;
return 0 ;
}
static void F_136 ( struct V_42 * V_22 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
struct V_150 V_96 [ 2 ] ;
struct V_194 * V_195 ;
...
static int F_144 ( struct V_42 * V_22 ,
T_7 V_212 , T_2 V_213 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
struct V_150 V_96 ;
...
static void F_154 ( struct V_42 * V_22 ,
struct V_229 * V_230 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
...
static int F_158 ( struct V_42 * V_22 ,
struct V_242 * V_243 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
...
static void F_163 ( struct V_42 * V_22 ,
struct V_242 * V_243 )
{
struct V_18 * V_19 = F_86 ( V_22 ) ;
...
static int F_164 ( struct V_42 * V_22 , int V_250 )
{
...
static void F_165 ( struct V_109 * V_110 )
{
struct V_18 * V_19 =
F_74 ( V_110 , struct V_18 , V_254 ) ;
T_2 V_255 ;
if ( F_166 ( V_19 -> V_20 , V_256 ,
...
static void F_172 ( struct V_161 * V_20 )
{
...
F_178 ( F_7 ( & V_19 -> V_11 [ V_99 ] , V_114 ) , 0 ) ;
}
}
...
V_261 = F_139 ( V_262 * sizeof( * V_261 ) , V_114 ) ;
if ( ! V_261 )
goto V_264;
V_260 = F_184 ( V_262 * sizeof( * V_260 ) , V_114 ) ;
if ( ! V_260 )
goto V_265;
V_263 = F_184 ( V_262 * sizeof( * V_263 ) , V_114 ) ;
if ( ! V_263 )
goto V_266;
if ( V_19 -> V_188 ) {
V_260 [ V_262 - 1 ] = NULL ;
...
if ( ! V_19 -> V_11 )
goto V_273;
F_186 ( & V_19 -> V_111 , F_73 ) ;
for ( V_99 = 0 ; V_99 < V_19 -> V_127 ; V_99 ++ ) {
V_19 -> V_11 [ V_99 ] . V_15 = NULL ;
F_187 ( V_19 -> V_22 , & V_19 -> V_11 [ V_99 ] . V_91 , F_79 ,
V_274 ) ;
F_52 ( V_19 -> V_11 [ V_99 ] . V_96 , F_115 ( V_19 -> V_11 [ V_99 ] . V_96 ) ) ;
F_188 ( & V_19 -> V_11 [ V_99 ] . V_60 ) ;
...
static T_9 F_190 ( struct V_276 * V_277 ,
struct V_278 * V_279 , char * V_26 )
{
struct V_18 * V_19 = F_86 ( V_277 -> V_22 ) ;
unsigned int V_280 = F_191 ( V_277 ) ;
struct V_100 * V_281 ;
F_25 ( V_280 >= V_19 -> V_127 ) ;
V_281 = & V_19 -> V_11 [ V_280 ] . V_60 ;
return sprintf ( V_26 , L_26 , F_57 ( V_281 ) ) ;
}
static bool F_192 ( struct V_161 * V_20 ,
unsigned int V_282 ,
const char * V_283 , const char * V_284 )
{
if ( ! F_114 ( V_20 , V_282 ) )
return false ;
F_193 ( & V_20 -> V_22 , L_27 ,
V_283 , V_284 ) ;
return true ;
}
...
static int F_196 ( struct V_161 * V_20 )
{
int V_99 , V_43 ;
struct V_42 * V_22 ;
struct V_18 * V_19 ;
T_2 V_127 ;
if ( ! V_20 -> V_258 -> V_286 ) {
F_193 ( & V_20 -> V_22 , L_29 ,
V_287 ) ;
return - V_170 ;
}
if ( ! F_194 ( V_20 ) )
return - V_170 ;
V_43 = F_166 ( V_20 , V_189 ,
struct V_173 ,
V_288 , & V_127 ) ;
if ( V_43 || V_127 < V_289 ||
V_127 > V_290 ||
! F_114 ( V_20 , V_156 ) )
V_127 = 1 ;
V_22 = F_197 ( sizeof( struct V_18 ) , V_127 ) ;
if ( ! V_22 )
return - V_95 ;
...
V_19 -> V_20 = V_20 ;
V_20 -> V_21 = V_19 ;
V_19 -> V_44 = F_201 ( struct V_61 ) ;
V_43 = - V_95 ;
if ( V_19 -> V_44 == NULL )
goto free;
F_124 (i) {
struct V_61 * V_61 ;
V_61 = F_125 ( V_19 -> V_44 , V_99 ) ;
F_202 ( & V_61 -> V_130 ) ;
F_202 ( & V_61 -> V_65 ) ;
}
F_203 ( & V_19 -> V_254 , F_165 ) ;
if ( F_114 ( V_20 , V_320 ) ||
F_114 ( V_20 , V_321 ) ||
F_114 ( V_20 , V_322 ) ||
F_114 ( V_20 , V_323 ) )
...
V_19 -> V_222 . V_333 = & F_153 ;
V_43 = F_207 ( & V_19 -> V_222 ) ;
if ( V_43 ) {
F_36 ( L_31 ) ;
goto V_332;
}
if ( F_114 ( V_19 -> V_20 , V_256 ) ) {
F_170 ( V_22 ) ;
F_173 ( & V_19 -> V_254 ) ;
} else {
V_19 -> V_120 = V_121 ;
...
static void F_212 ( struct V_161 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
F_213 ( & V_19 -> V_222 ) ;
F_214 ( & V_19 -> V_254 ) ;
...
static int F_215 ( struct V_161 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
int V_99 ;
F_213 ( & V_19 -> V_222 ) ;
...
static int F_218 ( struct V_161 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
int V_43 , V_99 ;
V_43 = F_189 ( V_19 ) ;
