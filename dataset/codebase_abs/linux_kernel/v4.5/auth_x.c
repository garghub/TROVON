...
static void F_66 ( struct V_1 * V_2 , int V_118 )
{
struct V_30 * V_32 ;
V_32 = F_15 ( V_2 , V_118 ) ;
if ( ! F_30 ( V_32 ) )
...
char V_99 [ 40 ] ;
T_4 V_98 [ 5 ] = {
F_44 ( 16 ) , V_136 -> V_138 . V_139 , V_136 -> V_140 . V_141 ,
...
static int F_69 ( struct V_119 * V_96 ,
struct V_135 * V_136 )
{
int V_21 ;
if ( F_70 ( F_71 ( V_136 -> V_144 -> V_145 ) , V_146 ) )
return 0 ;
V_21 = F_68 ( (struct V_74 * ) V_96 -> V_120 ,
...
static int F_72 ( struct V_119 * V_96 ,
struct V_135 * V_136 )
{
V_106 V_149 ;
int V_21 ;
