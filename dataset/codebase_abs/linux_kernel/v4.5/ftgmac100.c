...
{
struct V_1 * V_2 = F_103 ( V_11 ) ;
return F_121 ( V_2 -> V_119 , V_146 ) ;
}
static int F_122 ( struct V_10 * V_11 ,
struct V_145 * V_146 )
{
struct V_1 * V_2 = F_103 ( V_11 ) ;
return F_123 ( V_2 -> V_119 , V_146 ) ;
}
static T_6 F_124 ( int V_147 , void * V_148 )
{
...
static int F_128 ( struct V_150 * V_85 , int V_151 )
{
struct V_1 * V_2 = F_129 ( V_85 , struct V_1 , V_85 ) ;
struct V_10 * V_11 = V_2 -> V_11 ;
unsigned int V_152 ;
bool V_153 = true ;
int V_154 = 0 ;
V_152 = F_8 ( V_2 -> V_4 + V_155 ) ;
F_2 ( V_152 , V_2 -> V_4 + V_155 ) ;
if ( V_152 & ( V_156 | V_157 ) ) {
bool V_158 ;
do {
V_158 = F_50 ( V_2 , & V_154 ) ;
} while ( V_158 && V_154 < V_151 );
if ( V_158 && V_154 == V_151 )
V_153 = false ;
}
if ( V_152 & ( V_159 | V_160 ) ) {
F_88 ( V_2 ) ;
}
if ( V_152 & ( V_157 | V_161 |
V_162 | V_163 ) ) {
if ( F_46 () )
F_47 ( V_11 , L_16 , V_152 ,
V_152 & V_157 ? L_17 : L_18 ,
V_152 & V_161 ? L_19 : L_18 ,
V_152 & V_162 ? L_20 : L_18 ,
V_152 & V_163 ? L_21 : L_18 ) ;
if ( V_152 & V_157 ) {
V_11 -> V_60 . V_164 ++ ;
}
if ( V_152 & V_161 ) {
...
V_117 = F_132 ( V_2 -> V_147 , F_124 , 0 , V_11 -> V_124 , V_11 ) ;
if ( V_117 ) {
F_10 ( V_11 , L_23 , V_2 -> V_147 ) ;
goto V_168;
}
V_2 -> V_58 = 0 ;
V_2 -> V_101 = 0 ;
...
V_72 = F_140 ( V_2 -> V_73 , V_68 -> V_134 , F_83 ( V_68 ) , V_105 ) ;
if ( F_45 ( F_95 ( V_2 -> V_73 , V_72 ) ) ) {
if ( F_46 () )
F_10 ( V_11 , L_25 ) ;
V_11 -> V_60 . V_171 ++ ;
...
static int F_141 ( struct V_10 * V_11 , struct V_172 * V_173 , int V_146 )
{
struct V_1 * V_2 = F_103 ( V_11 ) ;
return F_142 ( V_2 -> V_119 , V_173 , V_146 ) ;
}
static int F_143 ( struct V_174 * V_175 )
{
struct V_176 * V_177 ;
int V_147 ;
struct V_10 * V_11 ;
...
if ( ! V_175 )
return - V_125 ;
V_177 = F_144 ( V_175 , V_178 , 0 ) ;
if ( ! V_177 )
return - V_179 ;
V_147 = F_145 ( V_175 , 0 ) ;
if ( V_147 < 0 )
return V_147 ;
V_11 = F_146 ( sizeof( * V_2 ) ) ;
if ( ! V_11 ) {
V_117 = - V_115 ;
goto V_180;
}
F_147 ( V_11 , & V_175 -> V_73 ) ;
V_11 -> V_181 = & V_182 ;
V_11 -> V_183 = & V_184 ;
...
V_2 -> V_73 = & V_175 -> V_73 ;
F_149 ( & V_2 -> V_106 ) ;
F_150 ( V_11 , & V_2 -> V_85 , F_128 , 64 ) ;
V_2 -> V_177 = F_151 ( V_177 -> V_188 , F_152 ( V_177 ) ,
F_119 ( & V_175 -> V_73 ) ) ;
if ( ! V_2 -> V_177 ) {
F_153 ( & V_175 -> V_73 , L_26 ) ;
V_117 = - V_115 ;
goto V_189;
}
V_2 -> V_4 = F_154 ( V_177 -> V_188 , F_152 ( V_177 ) ) ;
if ( ! V_2 -> V_4 ) {
F_153 ( & V_175 -> V_73 , L_27 ) ;
V_117 = - V_16 ;
goto V_190;
}
V_2 -> V_147 = V_147 ;
...
V_2 -> V_123 -> V_2 = V_11 ;
V_2 -> V_123 -> V_194 = F_111 ;
V_2 -> V_123 -> V_195 = F_115 ;
V_117 = F_156 ( V_2 -> V_123 ) ;
if ( V_117 ) {
F_153 ( & V_175 -> V_73 , L_30 ) ;
goto V_196;
}
V_117 = F_105 ( V_2 ) ;
if ( V_117 ) {
F_153 ( & V_175 -> V_73 , L_31 ) ;
goto V_197;
}
V_117 = F_157 ( V_11 ) ;
if ( V_117 ) {
F_153 ( & V_175 -> V_73 , L_32 ) ;
goto V_198;
}
F_47 ( V_11 , L_33 , V_2 -> V_147 , V_2 -> V_4 ) ;
if ( ! F_158 ( V_11 -> V_28 ) ) {
F_159 ( V_11 ) ;
F_47 ( V_11 , L_34 ,
V_11 -> V_28 ) ;
...
static int T_7 F_167 ( struct V_174 * V_175 )
{
struct V_10 * V_11 ;
struct V_1 * V_2 ;
V_11 = F_168 ( V_175 ) ;
