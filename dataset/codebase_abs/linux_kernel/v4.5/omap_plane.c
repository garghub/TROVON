...
static void F_38 ( struct V_73 * V_74 , T_2 V_75 )
{
struct V_10 * V_10 =
...
struct V_5 * F_40 ( struct V_59 * V_55 ,
...
V_10 = F_35 ( sizeof( * V_10 ) , V_70 ) ;
if ( ! V_10 )
return F_41 ( - V_78 ) ;
V_10 -> V_79 = F_42 (
V_10 -> V_80 , F_43 ( V_10 -> V_80 ) ,
F_44 ( V_46 ) ) ;
V_10 -> V_46 = V_46 ;
V_10 -> V_17 = V_77 [ V_46 ] ;
V_6 = & V_10 -> V_4 ;
...
V_10 -> V_56 . V_74 = F_38 ;
F_45 ( V_55 , & V_10 -> V_56 ) ;
V_16 = F_46 ( V_55 , V_6 , ( 1 << V_61 -> V_83 ) - 1 ,
& V_84 , V_10 -> V_80 ,
V_10 -> V_79 , type , NULL ) ;
if ( V_16 < 0 )
goto error;
