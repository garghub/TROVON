...
( ( V_103 -> V_7 == V_86 ) &&
F_61 ( V_103 -> V_9 . V_87 , V_4 -> V_9 . V_87 ) ) )
goto V_125;
V_63 = - V_66 ;
if ( ! V_101 )
goto V_125;
...
goto V_124;
if ( ! V_57 . V_95 ) {
if ( F_62 ( & ( (struct V_56 T_4 * ) V_58 ) -> V_95 ,
...
static struct V_1 * F_63 ( struct V_127 * V_128 )
{
struct V_1 * V_4 = NULL ;
struct V_129 * V_130 = F_64 ( V_128 ) ;
struct V_2 * V_2 = F_65 ( V_128 ) ;
...
static struct V_1 * F_66 ( struct V_127 * V_128 , struct V_1 * V_4 )
{
struct V_129 * V_130 = F_64 ( V_128 ) ;
struct V_2 * V_2 = F_65 ( V_128 ) ;
F_67 (fl) {
...
static struct V_1 * F_68 ( struct V_127 * V_128 , T_5 V_134 )
{
struct V_1 * V_4 = F_63 ( V_128 ) ;
if ( V_4 )
while ( V_134 && ( V_4 = F_66 ( V_128 , V_4 ) ) != NULL )
-- V_134 ;
return V_134 ? NULL : V_4 ;
}
static void * F_69 ( struct V_127 * V_128 , T_5 * V_134 )
__acquires( T_6 )
{
F_5 () ;
return * V_134 ? F_68 ( V_128 , * V_134 - 1 ) : V_135 ;
}
static void * F_70 ( struct V_127 * V_128 , void * V_136 , T_5 * V_134 )
{
struct V_1 * V_4 ;
if ( V_136 == V_135 )
V_4 = F_63 ( V_128 ) ;
else
V_4 = F_66 ( V_128 , V_136 ) ;
++ * V_134 ;
return V_4 ;
}
static void F_71 ( struct V_127 * V_128 , void * V_136 )
__releases( T_6 )
{
F_7 () ;
}
static int F_72 ( struct V_127 * V_128 , void * V_136 )
{
struct V_129 * V_130 = F_64 ( V_128 ) ;
if ( V_136 == V_135 ) {
F_73 ( V_128 , L_2 ) ;
...
V_4 -> V_7 ,
( ( V_4 -> V_7 == V_8 ) ?
F_76 ( V_4 -> V_9 . V_10 , V_130 -> V_137 ) :
( ( V_4 -> V_7 == V_86 ) ?
F_77 ( F_78 ( V_128 ) , V_4 -> V_9 . V_87 ) :
0 ) ) ,
F_23 ( & V_4 -> V_6 ) ,
V_4 -> V_17 / V_53 ,
...
static int F_79 ( struct V_138 * V_138 , struct V_139 * V_139 )
{
struct V_127 * V_128 ;
struct V_129 * V_130 ;
int V_63 ;
V_63 = F_80 ( V_138 , V_139 , & V_140 ,
sizeof( struct V_129 ) ) ;
if ( ! V_63 ) {
V_128 = V_139 -> V_141 ;
V_130 = F_64 ( V_128 ) ;
F_81 () ;
V_130 -> V_137 = F_82 ( F_83 ( V_84 ) ) ;
F_84 () ;
}
return V_63 ;
}
static int F_85 ( struct V_138 * V_138 , struct V_139 * V_139 )
{
struct V_127 * V_128 = V_139 -> V_141 ;
struct V_129 * V_130 = F_64 ( V_128 ) ;
F_86 ( V_130 -> V_137 ) ;
return F_87 ( V_138 , V_139 ) ;
}
static int T_7 F_88 ( struct V_2 * V_2 )
{
if ( ! F_89 ( L_4 , V_142 , V_2 -> V_143 ,
& V_144 ) )
return - V_66 ;
return 0 ;
}
