...
V_72 = V_70 -> V_7 . V_9 ;
if ( V_71 != V_72 )
return F_19 ( V_71 ) < F_19 ( V_72 ) ? - 1 : 1 ;
return F_20 ( V_69 -> V_7 . V_10 . V_6 , V_69 -> V_7 . V_10 . V_12 ,
...
int V_73 , V_12 , type ;
F_1 ( V_2 , V_48 -> V_58 , V_15 , NULL ) ;
V_73 = F_22 ( V_48 , & V_14 , sizeof( V_14 ) ) ;
if ( V_73 )
return V_73 ;
type = V_14 . type ;
...
F_28 (rd, &HFS_I(dir)->open_dir_list, list) {
if ( V_48 . V_82 -> V_83 ( V_48 . V_58 , ( void * ) & V_77 -> V_3 ) < 0 )
V_77 -> V_29 -> V_84 -- ;
}
V_73 = F_17 ( & V_48 ) ;
if ( V_73 )
...
int F_29 ( T_2 V_15 , struct V_16 * V_85 , struct V_5 * V_86 ,
struct V_16 * V_87 , struct V_5 * V_88 )
{
struct V_1 * V_2 ;
