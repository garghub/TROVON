...
V_93 = & V_60 -> V_98 [ 0 ] ;
if ( V_60 -> V_99 > 1 ||
V_93 -> V_100 != V_60 -> V_74 -> V_37 . V_58 ) {
F_8 ( L_24
L_25 , V_60 -> V_99 , V_93 -> V_100 ,
V_60 -> V_74 -> V_37 . V_58 ) ;
return V_101 ;
}
...
F_55 ( & V_62 -> V_65 , 1 ) ;
while ( V_96 ) {
while ( F_56 ( V_69 , F_57 ( V_93 ) , V_93 -> V_100 , V_93 -> V_104 )
!= V_93 -> V_100 ) {
V_69 = F_38 ( V_60 , V_94 , 1 ) ;
if ( ! V_69 )
goto V_105;
...
int V_20 = 0 , V_115 ;
unsigned long V_116 ;
V_113 = F_59 ( V_108 , V_12 ) ;
if ( ! V_113 )
return - V_21 ;
V_110 = V_113 ;
while ( ( V_111 = F_60 ( & V_113 , L_26 ) ) != NULL ) {
if ( ! * V_111 )
continue;
V_115 = F_61 ( V_111 , V_117 , args ) ;
switch ( V_115 ) {
case V_118 :
if ( V_11 -> V_36 ) {
F_8 ( L_27
...
V_27:
F_24 ( V_110 ) ;
return ( ! V_20 ) ? V_109 : V_20 ;
}
static T_6 F_65 ( struct V_2 * V_3 , char * V_123 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
...
T_6 V_126 = 0 ;
if ( V_16 )
V_126 += sprintf ( V_123 + V_126 , L_33 ,
F_66 ( V_16 , V_124 ) ) ;
if ( V_11 -> V_22 & V_23 )
V_126 += sprintf ( V_123 + V_126 , L_34 ,
V_11 -> V_28 ) ;
V_126 += sprintf ( V_123 + V_126 , L_35 , V_11 -> V_31 ) ;
V_126 += sprintf ( V_123 + V_126 , L_36 ) ;
if ( V_16 ) {
V_126 += sprintf ( V_123 + V_126 , L_37 ,
F_67 ( V_16 -> V_127 ) , F_68 ( V_16 -> V_127 ) , ( ! V_16 -> V_128 ) ?
L_38 : ( V_16 -> V_129 == V_11 ) ?
L_39 : L_40 ) ;
} else {
V_126 += sprintf ( V_123 + V_126 , L_41 ) ;
}
return V_126 ;
}
static int
F_69 ( struct V_59 * V_60 , struct V_69 * V_69 )
{
struct V_2 * V_3 = V_60 -> V_74 ;
struct V_17 * V_18 ;
struct V_130 * V_131 ;
...
V_131 = F_70 ( V_69 , V_76 , V_60 -> V_135 ) ;
if ( F_12 ( V_131 ) ) {
F_8 ( L_43 ) ;
return F_13 ( V_131 ) ;
}
V_131 -> V_136 . V_137 = ( V_60 -> V_138 / V_3 -> V_37 . V_58 ) *
V_3 -> V_139 ;
V_131 -> V_136 . V_80 = V_69 -> V_79 . V_80 ;
F_4 ( L_44 , V_131 -> V_136 . V_137 ,
( unsigned long long ) V_131 -> V_136 . V_80 ) ;
F_71 (cmd->t_prot_sg, sg, cmd->t_prot_nents, i) {
V_133 = F_72 ( V_69 , F_57 ( V_93 ) , V_93 -> V_100 ,
V_93 -> V_104 ) ;
if ( V_133 != V_93 -> V_100 ) {
F_8 ( L_45 , V_133 ) ;
return - V_21 ;
...
F_4 ( L_46 ,
F_57 ( V_93 ) , V_93 -> V_100 , V_93 -> V_104 ) ;
}
return 0 ;
}
static T_5
F_73 ( struct V_59 * V_60 , struct V_92 * V_140 , T_1 V_141 ,
enum V_142 V_143 )
{
struct V_2 * V_3 = V_60 -> V_74 ;
T_4 V_94 = F_50 ( V_3 , V_60 -> V_95 ) ;
struct V_61 * V_62 ;
struct V_69 * V_69 , * V_144 ;
struct V_81 V_82 ;
struct V_92 * V_93 ;
T_1 V_73 = V_141 ;
unsigned V_145 ;
...
if ( V_60 -> V_155 && V_3 -> V_37 . V_49 ) {
int V_133 = F_69 ( V_60 , V_144 ) ;
if ( V_133 )
goto V_105;
}
F_40 ( & V_82 , V_83 ) ;
