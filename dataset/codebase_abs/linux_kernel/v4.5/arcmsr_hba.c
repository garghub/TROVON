...
int V_172 = V_421 -> V_73 -> V_172 ;
T_4 V_472 = V_421 -> V_340 [ 0 ] ;
V_421 -> V_258 = F_182 ;
V_421 -> V_473 = NULL ;
V_421 -> V_262 = 0 ;
if ( ( V_472 == V_474 ) || ( V_472 == V_475 ) ) {
if( V_6 -> V_147 [ V_171 ] [ V_172 ] == V_148 ) {
V_421 -> V_262 = ( V_279 << 16 ) ;
}
V_421 -> V_258 ( V_421 ) ;
return 0 ;
}
...
{
struct V_50 * V_46 = V_6 -> V_51 ;
char * V_478 = V_6 -> V_479 ;
char * V_480 = V_6 -> V_481 ;
char * V_482 = V_6 -> V_168 ;
char T_1 * V_483 ;
char T_1 * V_484 ;
char T_1 * V_485 ;
int V_486 ;
V_483 = ( char T_1 * ) ( & V_46 -> V_89 [ 15 ] ) ;
V_484 = ( char T_1 * ) ( & V_46 -> V_89 [ 17 ] ) ;
V_485 = ( char T_1 * ) ( & V_46 -> V_89 [ 21 ] ) ;
F_184 ( V_6 ) ;
F_13 ( V_487 , V_46 -> V_56 ) ;
if ( ! F_25 ( V_6 ) ) {
F_9 ( V_488 L_34 , V_6 -> V_19 -> V_20 ) ;
return false ;
}
F_13 ( V_489 , V_46 -> V_56 ) ;
if ( ! F_25 ( V_6 ) ) {
...
V_6 -> V_490 = F_12 ( & V_46 -> V_89 [ 1 ] ) ;
V_6 -> V_491 = F_12 ( & V_46 -> V_89 [ 2 ] ) ;
V_6 -> V_492 = F_12 ( & V_46 -> V_89 [ 3 ] ) ;
V_6 -> V_493 = F_12 ( & V_46 -> V_89 [ 4 ] ) ;
V_6 -> V_151 = F_12 ( & V_46 -> V_89 [ 25 ] ) ;
return true ;
}
static bool F_185 ( struct V_5 * V_57 )
{
T_6 V_244 , V_494 , V_495 = 0 ;
struct V_58 T_1 * V_46 = V_57 -> V_24 ;
char * V_478 = V_57 -> V_479 ;
char * V_480 = V_57 -> V_481 ;
char T_1 * V_483 = ( char T_1 * ) ( & V_46 -> V_136 [ 15 ] ) ;
char T_1 * V_484 = ( char T_1 * ) ( & V_46 -> V_136 [ 17 ] ) ;
int V_486 ;
V_244 = F_12 ( & V_46 -> V_273 ) ;
F_13 ( V_244 | V_274 , & V_46 -> V_273 ) ;
do {
V_495 = F_12 ( & V_46 -> V_110 ) ;
} while ( ( V_495 & V_496 ) == 0 );
F_13 ( V_497 , & V_46 -> V_65 ) ;
F_13 ( V_67 , & V_46 -> V_68 ) ;
for ( V_494 = 0 ; V_494 < 2000 ; V_494 ++ ) {
...
V_57 -> V_479 ,
V_57 -> V_481 ) ;
V_57 -> V_490 = F_12 ( & V_46 -> V_136 [ 1 ] ) ;
V_57 -> V_491 = F_12 ( & V_46 -> V_136 [ 2 ] ) ;
V_57 -> V_492 = F_12 ( & V_46 -> V_136 [ 3 ] ) ;
V_57 -> V_493 = F_12 ( & V_46 -> V_136 [ 4 ] ) ;
...
T_8 V_486 ;
struct V_60 * V_46 = V_6 -> V_61 ;
V_483 = ( char T_1 * ) ( & V_46 -> V_136 [ 15 ] ) ;
V_484 = ( char T_1 * ) ( & V_46 -> V_136 [ 17 ] ) ;
V_485 = ( char T_1 * ) ( & V_46 -> V_136 [ 21 ] ) ;
...
V_6 -> V_490 = F_12 ( & V_46 -> V_136 [ 1 ] ) ;
V_6 -> V_491 = F_12 ( & V_46 -> V_136 [ 2 ] ) ;
V_6 -> V_492 = F_12 ( & V_46 -> V_136 [ 3 ] ) ;
V_6 -> V_493 = F_12 ( & V_46 -> V_136 [ 4 ] ) ;
...
V_6 -> V_498 = V_6 -> V_491 - 1 ;
V_6 -> V_19 -> V_210 = V_6 -> V_498 ;
return V_69 ;
}
...
struct V_138 * V_252 ;
struct V_291 * V_160 ;
T_6 V_289 , V_48 , V_500 = 0 , V_312 = 0 ;
int V_69 ;
bool error ;
V_501:
V_312 ++ ;
...
V_500 |= ( V_252 == V_499 ) ? 1 : 0 ;
if ( ( V_252 -> V_6 != V_6 ) || ( V_252 -> V_256 != V_285 ) ) {
if ( ( V_252 -> V_256 == V_286 ) || ( V_252 == V_499 ) ) {
F_9 ( V_18 L_39
L_40
, V_6 -> V_19 -> V_20
...
{
bool error ;
T_6 V_500 = 0 , V_312 = 0 , V_289 , V_290 ;
...
switch ( V_6 -> V_7 ) {
case V_16 : {
V_69 = F_189 ( V_6 , V_499 ) ;
}
break;
case V_8 : {
V_69 = F_190 ( V_6 , V_499 ) ;
}
break;
case V_23 : {
V_69 = F_191 ( V_6 , V_499 ) ;
}
break;
case V_9 :
V_69 = F_192 ( V_6 , V_499 ) ;
break;
}
return V_69 ;
}
