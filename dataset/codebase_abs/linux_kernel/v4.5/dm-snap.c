...
static void F_144 ( void * V_81 , int V_158 )
{
...
static void F_146 ( struct V_74 * V_75 )
{
struct V_2 * V_3 = V_75 -> V_38 ;
V_3 -> V_7 -> type -> V_164 ( V_3 -> V_7 , & V_75 -> V_68 , ! V_75 -> V_165 ,
F_144 , V_75 ) ;
}
static void F_147 ( int V_113 , unsigned long V_114 , void * V_81 )
{
struct V_74 * V_75 = V_81 ;
struct V_2 * V_3 = V_75 -> V_38 ;
V_75 -> V_165 = V_113 || V_114 ;
if ( V_75 -> V_166 == V_3 -> V_132 ) {
V_3 -> V_132 ++ ;
F_146 ( V_75 ) ;
while ( ! F_50 ( & V_3 -> V_133 ) ) {
V_75 = F_148 ( V_3 -> V_133 . V_67 ,
struct V_74 , V_167 ) ;
if ( V_75 -> V_166 != V_3 -> V_132 )
break;
V_3 -> V_132 ++ ;
...
V_169 = F_148 ( V_168 , struct V_74 , V_167 ) ;
...
F_105 ( V_3 -> V_111 , & V_102 , 1 , & V_103 , 0 , F_147 , V_75 ) ;
}
static void V_163 ( struct V_13 * V_13 )
{
void * V_171 = V_13 -> V_172 ;
F_151 ( V_171 , 0 , V_13 -> V_173 ? 1 : 0 ) ;
}
static void F_152 ( struct V_74 * V_75 ,
struct V_13 * V_13 )
{
struct V_2 * V_3 = V_75 -> V_38 ;
void * V_171 ;
...
if ( ! V_68 )
return NULL ;
return F_155 ( V_68 , struct V_74 , V_68 ) ;
}
static struct V_74 *
...
V_75 -> V_174 = 0 ;
V_75 -> V_161 = NULL ;
if ( V_3 -> V_7 -> type -> V_175 ( V_3 -> V_7 , & V_75 -> V_68 ) ) {
F_67 ( V_75 ) ;
return NULL ;
}
V_75 -> V_166 = V_3 -> V_131 ++ ;
F_71 ( & V_3 -> V_89 , & V_75 -> V_68 ) ;
return V_75 ;
}
static void F_157 ( struct V_2 * V_3 , struct V_65 * V_68 ,
struct V_13 * V_13 , T_2 V_8 )
{
V_13 -> V_176 = V_3 -> V_5 -> V_29 ;
V_13 -> V_177 . V_178 =
F_3 ( V_3 -> V_7 , F_73 ( V_68 -> V_80 ) +
( V_8 - V_68 -> V_69 ) ) +
( V_13 -> V_177 . V_178 & V_3 -> V_7 -> V_179 ) ;
}
static int F_158 ( struct V_116 * V_45 , struct V_13 * V_13 )
{
struct V_65 * V_68 ;
struct V_2 * V_3 = V_45 -> V_142 ;
int V_54 = V_154 ;
...
V_8 = F_159 ( V_3 -> V_7 , V_13 -> V_177 . V_178 ) ;
if ( ! V_3 -> V_108 )
return - V_156 ;
F_46 ( & V_3 -> V_46 ) ;
if ( ! V_3 -> V_108 || ( F_102 ( V_3 -> V_130 ) && F_160 ( V_13 ) == V_182 ) ) {
V_54 = - V_156 ;
goto V_183;
}
V_68 = F_59 ( & V_3 -> V_84 , V_8 ) ;
if ( V_68 ) {
F_157 ( V_3 , V_68 , V_13 , V_8 ) ;
goto V_183;
}
if ( F_160 ( V_13 ) == V_182 ) {
V_75 = F_154 ( V_3 , V_8 ) ;
...
static int F_162 ( struct V_116 * V_45 , struct V_13 * V_13 )
{
struct V_65 * V_68 ;
struct V_2 * V_3 = V_45 -> V_142 ;
int V_54 = V_154 ;
...
static int F_164 ( struct V_116 * V_45 , struct V_13 * V_13 , int error )
{
struct V_2 * V_3 = V_45 -> V_142 ;
if ( F_8 ( V_13 ) )
F_15 ( V_3 , V_13 ) ;
...
static void F_165 ( struct V_116 * V_45 )
{
struct V_2 * V_3 = V_45 -> V_142 ;
F_109 ( V_3 ) ;
}
static int F_166 ( struct V_116 * V_45 )
{
int V_54 = 0 ;
struct V_2 * V_3 = V_45 -> V_142 ;
struct V_2 * V_39 = NULL , * V_40 = NULL ;
...
static void F_168 ( struct V_116 * V_45 )
{
struct V_2 * V_3 = V_45 -> V_142 ;
struct V_2 * V_39 = NULL , * V_40 = NULL , * V_188 = NULL ;
struct V_36 * V_33 ;
...
if ( V_33 )
V_190 = F_169 ( V_33 -> V_45 -> V_61 ) ;
if ( ! V_190 ) {
( void ) F_39 ( V_3 , NULL , NULL , & V_188 ) ;
if ( V_188 )
V_190 = F_169 ( V_188 -> V_45 -> V_61 ) ;
}
if ( V_190 == F_169 ( V_45 -> V_61 ) )
V_190 = NULL ;
if ( V_190 ) {
if ( F_170 ( V_190 ) )
V_190 = NULL ;
...
if ( V_190 ) {
F_171 ( V_190 ) ;
if ( V_188 && F_101 ( V_90 , & V_188 -> V_91 ) ) {
V_191 = true ;
F_109 ( V_188 ) ;
}
}
...
static T_3 F_175 ( struct V_10 * V_29 )
{
T_3 V_193 ;
F_41 ( & V_28 ) ;
V_193 = F_77 ( F_31 ( V_29 ) ) ;
F_42 ( & V_28 ) ;
return V_193 ;
}
static void F_176 ( struct V_116 * V_45 )
{
struct V_2 * V_3 = V_45 -> V_142 ;
F_168 ( V_45 ) ;
V_45 -> V_151 = F_175 ( V_3 -> V_4 -> V_29 ) ;
F_107 ( V_3 ) ;
}
static void F_177 ( struct V_116 * V_45 , T_7 type ,
unsigned V_194 , char * V_195 , unsigned V_196 )
{
unsigned V_197 = 0 ;
...
if ( V_38 -> V_7 -> type -> V_199 ) {
T_1 V_200 , V_201 ,
V_202 ;
V_38 -> V_7 -> type -> V_199 ( V_38 -> V_7 ,
& V_200 ,
& V_201 ,
& V_202 ) ;
F_178 ( L_41 ,
...
break;
case V_203 :
F_178 ( L_43 , V_38 -> V_4 -> V_204 , V_38 -> V_5 -> V_204 ) ;
V_38 -> V_7 -> type -> V_205 ( V_38 -> V_7 , type , V_195 + V_197 ,
V_196 - V_197 ) ;
break;
}
}
static int F_179 ( struct V_116 * V_45 ,
T_8 V_206 , void * V_207 )
{
struct V_2 * V_38 = V_45 -> V_142 ;
int V_54 ;
V_54 = V_206 ( V_45 , V_38 -> V_4 , 0 , V_45 -> V_208 , V_207 ) ;
if ( ! V_54 )
V_54 = V_206 ( V_45 , V_38 -> V_5 , 0 , F_81 ( V_38 -> V_5 -> V_29 ) , V_207 ) ;
return V_54 ;
}
static int F_180 ( struct V_24 * V_55 , T_1 V_110 ,
struct V_13 * V_13 )
{
int V_54 = V_154 ;
struct V_2 * V_38 ;
...
goto V_211;
if ( V_110 >= F_181 ( V_38 -> V_45 -> V_61 ) )
goto V_211;
V_8 = F_159 ( V_38 -> V_7 , V_110 ) ;
...
V_33 = F_31 ( V_4 -> V_29 ) ;
if ( V_33 )
V_54 = F_180 ( & V_33 -> V_55 , V_13 -> V_177 . V_178 , V_13 ) ;
F_42 ( & V_28 ) ;
return V_54 ;
}
static int F_103 ( struct V_2 * V_212 ,
...
struct V_4 * V_33 ;
F_41 ( & V_28 ) ;
V_33 = F_31 ( V_212 -> V_4 -> V_29 ) ;
for ( V_152 = 0 ; V_152 < V_58 ; V_152 += V_212 -> V_45 -> V_151 )
if ( F_180 ( & V_33 -> V_55 , V_110 + V_152 , NULL ) ==
V_184 )
V_213 = 1 ;
F_42 ( & V_28 ) ;
return V_213 ;
}
static int F_182 ( struct V_116 * V_45 , unsigned int V_117 , char * * V_118 )
{
int V_54 ;
struct V_36 * V_33 ;
if ( V_117 != 1 ) {
...
static void F_183 ( struct V_116 * V_45 )
{
struct V_36 * V_33 = V_45 -> V_142 ;
F_130 ( V_45 , V_33 -> V_37 ) ;
F_27 ( V_33 ) ;
}
static int F_184 ( struct V_116 * V_45 , struct V_13 * V_13 )
{
struct V_36 * V_33 = V_45 -> V_142 ;
unsigned V_216 ;
V_13 -> V_176 = V_33 -> V_37 -> V_29 ;
if ( F_102 ( V_13 -> V_180 & V_181 ) )
return V_154 ;
if ( F_160 ( V_13 ) != V_182 )
return V_154 ;
V_216 = V_33 -> V_217 -
( ( unsigned ) V_13 -> V_177 . V_178 & ( V_33 -> V_217 - 1 ) ) ;
if ( F_185 ( V_13 ) > V_216 )
F_186 ( V_13 , V_216 ) ;
return F_140 ( V_33 -> V_37 , V_13 ) ;
}
static void F_187 ( struct V_116 * V_45 )
{
struct V_36 * V_33 = V_45 -> V_142 ;
V_33 -> V_217 = F_175 ( V_33 -> V_37 -> V_29 ) ;
F_46 ( & V_28 ) ;
F_36 ( V_33 ) ;
F_47 ( & V_28 ) ;
}
...
static void F_189 ( struct V_116 * V_45 , T_7 type ,
unsigned V_194 , char * V_195 , unsigned V_196 )
{
struct V_36 * V_33 = V_45 -> V_142 ;
switch ( type ) {
...
break;
case V_203 :
snprintf ( V_195 , V_196 , L_47 , V_33 -> V_37 -> V_204 ) ;
break;
}
}
static int F_190 ( struct V_116 * V_45 ,
T_8 V_206 , void * V_207 )
{
struct V_36 * V_33 = V_45 -> V_142 ;
return V_206 ( V_45 , V_33 -> V_37 , 0 , V_45 -> V_208 , V_207 ) ;
}
