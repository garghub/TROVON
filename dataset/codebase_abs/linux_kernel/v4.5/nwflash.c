...
V_41 = ( unsigned char * ) ( ( unsigned int ) ( V_3 + 0x8000 + ( V_29 << 16 ) ) ) ;
V_1 = * V_41 ;
F_2 () ;
* ( volatile unsigned char * ) V_41 = 0x20 ;
* ( volatile unsigned char * ) V_41 = 0xD0 ;
F_18 ( 10 ) ;
V_42 = V_45 + 10 * V_46 ;
V_1 = 0 ;
while ( ! ( V_1 & 0x80 ) && F_19 ( V_45 , V_42 ) ) {
F_18 ( 10 ) ;
V_1 = * ( volatile unsigned char * ) ( V_41 ) ;
}
F_2 () ;
* ( volatile unsigned char * ) V_41 = 0xFF ;
if ( V_1 & 0x20 ) {
F_9 ( V_38 L_13 , V_41 ) ;
* ( volatile unsigned char * ) ( V_3 + 0x8000 ) = 0x50 ;
return - 2 ;
...
F_18 ( 10 ) ;
V_41 = ( unsigned char * ) ( ( unsigned int ) ( V_3 + ( V_29 << 16 ) ) ) ;
for ( V_30 = 0 ; V_30 < 16 * 1024 ; V_30 ++ , V_41 += 4 ) {
if ( ( V_43 = * ( volatile unsigned int * ) V_41 ) != 0xFFFFFFFF ) {
F_9 ( V_38 L_14 ,
V_41 , V_43 ) ;
return - 1 ;
}
...
unsigned long V_42 ;
unsigned long V_48 ;
V_41 = ( unsigned char * ) ( ( unsigned int ) ( V_3 + V_26 ) ) ;
V_39 = V_26 & 0xFFFF ;
if ( V_39 + V_27 > 0x10000 )
V_27 = 0x10000 - V_39 ;
V_42 = V_45 + 30 * V_46 ;
for ( V_39 = 0 ; V_39 < V_27 ; V_39 ++ , V_41 ++ ) {
V_47 = ( unsigned int ) V_41 ;
V_47 &= 0xFFFFFFFC ;
if ( F_20 ( V_2 , V_18 + V_39 ) )
return - V_36 ;
V_49:
V_1 = * ( volatile unsigned char * ) ( V_3 + 0x8000 ) ;
F_2 () ;
* V_44 = ( unsigned int ) V_41 & 3 ;
* ( volatile unsigned char * ) ( V_47 ) = 0x40 ;
* ( volatile unsigned char * ) ( V_47 ) = V_2 ;
* ( volatile unsigned char * ) ( V_3 + 0x10000 ) = 0x70 ;
V_1 = 0 ;
V_48 = V_45 + 1 * V_46 ;
while ( ! ( V_1 & 0x80 ) && F_19 ( V_45 , V_48 ) )
V_1 = * ( volatile unsigned char * ) ( V_3 + 0x8000 ) ;
if ( F_21 ( V_45 , V_48 ) ) {
F_2 () ;
* ( volatile unsigned char * ) ( V_3 + 0x8000 ) = 0x50 ;
