...
F_41 ( V_52 L_38 , V_41 ,
V_12 [ V_237 ] . V_14 ) ;
if ( V_246 >= V_260 || ! V_6 -> V_261 -> V_250 [ V_246 ] )
return - V_258 ;
if ( V_12 [ V_237 ] . V_250 >= 0 )
V_250 = & V_6 -> V_261 -> V_250 [ V_12 [ V_237 ] . V_250 ] -> V_247 [ 0 ] ;
else if ( V_246 < V_6 -> V_261 -> V_163 . V_262 )
V_250 = & V_6 -> V_261 -> V_250 [ V_246 ] -> V_247 [ 0 ] ;
else {
F_17 ( & V_227 -> V_6 , L_39 ,
V_246 , V_6 -> V_261 -> V_163 . V_262 - 1 ) ;
V_110 = - V_258 ;
goto V_259;
}
if ( V_250 -> V_163 . V_263 < 2 ) {
F_17 ( & V_227 -> V_6 , L_40
L_41 , V_246 , V_250 -> V_163 . V_263 ) ;
V_110 = - V_258 ;
goto V_259;
}
...
if ( V_11 == NULL ) {
F_17 ( & V_227 -> V_6 , L_45 , V_41 ) ;
V_110 = - V_216 ;
goto V_259;
}
if ( V_6 -> V_253 . V_265 > 1 )
V_11 -> V_30 = V_266 ;
else if ( V_237 == V_267 )
V_11 -> V_30 = V_268 ;
else
V_11 -> V_30 = V_269 ;
F_22 ( V_215 , L_46 , V_11 -> V_30 ) ;
V_245 = V_6 -> V_261 -> V_250 [ 0 ] ;
V_11 -> V_270 = V_245 -> V_271 ;
F_22 ( V_215 , L_47 , V_11 -> V_270 ) ;
V_11 -> V_236 = F_125 ( 32 * V_11 -> V_270 , V_228 ) ;
if ( V_11 -> V_236 == NULL ) {
F_17 ( & V_227 -> V_6 , L_48 ) ;
V_110 = - V_216 ;
goto V_272;
}
for ( V_155 = 0 ; V_155 < V_11 -> V_270 ; V_155 ++ ) {
T_8 V_273 = F_126 ( V_245 -> V_247 [ V_155 ] . V_252 [ 1 ] . V_163 .
V_274 ) ;
V_11 -> V_236 [ V_155 ] =
( V_273 & 0x07ff ) * ( ( ( V_273 & 0x1800 ) >> 11 ) + 1 ) ;
...
if ( V_11 -> V_64 )
V_11 -> V_277 = V_12 [ V_237 ] . V_277 ;
V_11 -> V_13 = V_237 ;
V_11 -> V_51 = 0 ;
V_11 -> V_209 = V_246 ;
V_11 -> V_208 = 0 ;
V_11 -> V_278 = V_252 -> V_279 ;
V_11 -> V_280 = 0 ;
V_11 -> V_281 = 0 ;
V_11 -> V_20 = 0 ;
V_11 -> V_26 = V_282 ;
