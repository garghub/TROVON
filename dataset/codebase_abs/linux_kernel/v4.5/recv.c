...
F_99 ( V_2 , V_144 , V_166 , V_167 -> V_164 ) ;
if ( F_100 ( & V_2 -> V_177 , V_144 , V_166 , V_167 -> V_164 ) )
F_97 ( V_178 ) ;
return - V_154 ;
}
F_56 ( & V_2 -> V_79 ) ;
...
V_167 -> V_186 = V_12 -> V_181 -> V_139 -> V_186 ;
V_167 -> V_187 = V_12 -> V_181 -> V_139 -> V_188 ;
V_167 -> V_31 = V_166 -> V_189 ;
V_167 -> V_190 |= V_191 ;
#ifdef F_107
...
{
struct V_11 * V_12 = V_2 -> V_4 ;
struct V_193 * V_194 = & V_12 -> V_5 ;
struct V_13 * V_14 = F_3 ( V_12 ) ;
if ( ! ( V_12 -> V_5 . V_6 & V_195 ) )
return;
if ( V_2 -> V_27 . V_32 != V_150 -> V_189 ) {
if ( ++ V_2 -> V_27 . V_33 >= 3 )
F_8 ( V_2 , V_150 -> V_189 ) ;
} else {
V_2 -> V_27 . V_33 = 0 ;
...
{
if ( V_150 -> V_198 ) {
V_161 -> V_190 |= V_199 | V_200 ;
V_161 -> V_201 = V_2 -> V_27 . V_202 ;
if ( ! V_150 -> V_203 ) {
V_161 -> V_190 |= V_204 ;
V_2 -> V_27 . V_202 ++ ;
}
if ( V_150 -> V_205 & V_206 )
V_161 -> V_190 |= V_207 ;
}
}
int F_67 ( struct V_1 * V_2 , int V_10 , bool V_208 )
{
struct V_8 * V_9 ;
struct V_17 * V_18 = NULL , * V_209 , * V_210 ;
struct V_160 * V_161 ;
struct V_11 * V_12 = V_2 -> V_4 ;
struct V_13 * V_14 = F_3 ( V_12 ) ;
struct V_169 * V_74 = V_2 -> V_74 ;
...
struct V_149 V_150 ;
enum V_36 V_37 ;
bool V_212 = ! ! ( V_12 -> V_5 . V_6 & V_64 ) ;
int V_213 ;
T_3 V_162 = 0 ;
unsigned long V_214 ;
T_4 V_215 ;
unsigned int V_216 = 512 ;
struct V_143 * V_144 ;
if ( V_212 )
V_213 = V_51 ;
else
V_213 = V_69 ;
V_37 = V_208 ? V_50 : V_49 ;
V_162 = F_113 ( V_12 ) ;
do {
bool V_168 = false ;
...
continue;
if ( V_2 -> V_27 . V_217 )
V_210 = V_2 -> V_27 . V_217 ;
else
V_210 = V_18 ;
V_161 = F_114 ( V_210 ) ;
memset ( V_161 , 0 , sizeof( struct V_160 ) ) ;
V_211 = F_96 ( V_2 , V_210 , & V_150 , V_161 ,
& V_168 , V_162 ) ;
if ( V_211 )
goto V_218;
V_209 = F_41 ( V_14 , V_14 -> V_26 , V_219 ) ;
if ( ! V_209 ) {
F_97 ( V_220 ) ;
goto V_218;
}
V_215 = F_42 ( V_2 -> V_45 , V_209 -> V_25 ,
V_14 -> V_26 , V_213 ) ;
if ( F_43 ( F_44 ( V_2 -> V_45 , V_215 ) ) ) {
F_34 ( V_209 ) ;
goto V_218;
}
F_33 ( V_2 -> V_45 , V_9 -> V_22 ,
...
if ( V_2 -> V_27 . V_217 ) {
int V_224 = V_18 -> V_130 - F_118 ( V_210 ) ;
if ( F_119 ( V_210 , 0 , V_224 , V_219 ) < 0 ) {
F_54 ( V_18 ) ;
F_97 ( V_220 ) ;
goto V_218;
}
V_2 -> V_27 . V_217 = NULL ;
F_120 ( V_18 , F_115 ( V_210 , V_18 -> V_130 ) ,
V_18 -> V_130 ) ;
F_34 ( V_18 ) ;
V_18 = V_210 ;
}
if ( V_161 -> V_190 & V_225 )
F_121 ( V_18 , V_18 -> V_130 - 8 ) ;
F_122 ( & V_2 -> V_226 , V_214 ) ;
if ( ( V_2 -> V_135 & ( V_136 |
V_141 |
V_147 ) ) ||
F_1 ( V_2 ) )
F_78 ( V_2 , V_18 , V_150 . V_180 ) ;
F_123 ( & V_2 -> V_226 , V_214 ) ;
F_110 ( V_2 , & V_150 ) ;
