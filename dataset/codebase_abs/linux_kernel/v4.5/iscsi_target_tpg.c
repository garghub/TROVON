...
int F_40 ( struct V_1 * V_5 , int V_73 )
{
struct V_2 * V_3 ;
T_2 V_74 = V_5 -> V_7 ;
F_15 ( & V_5 -> V_14 ) ;
...
struct V_87 * V_88 = V_86 -> V_87 ;
struct V_89 * V_90 = F_42 ( V_88 , struct V_89 ,
V_87 ) ;
return & V_90 -> V_91 ;
}
struct V_33 * F_43 (
...
F_17 ( L_22 ,
V_5 -> V_9 -> V_3 , & V_32 -> V_107 , V_5 -> V_4 ,
V_32 -> V_108 -> V_109 ) ;
return V_35 ;
}
static int F_54 (
...
F_15 ( & V_35 -> V_100 -> V_95 ) ;
F_37 ( & V_35 -> V_102 ) ;
F_16 ( & V_35 -> V_100 -> V_95 ) ;
}
F_15 ( & V_5 -> V_15 ) ;
F_37 ( & V_35 -> V_101 ) ;
V_5 -> V_105 -- ;
...
{
unsigned char V_110 [ 256 ] , V_111 [ 256 ] , * V_112 = NULL ;
int V_113 ;
struct V_16 * V_17 ;
struct V_40 * V_41 = & V_5 -> V_26 ;
if ( ( V_27 != 1 ) && ( V_27 != 0 ) ) {
...
return - V_76 ;
if ( V_27 ) {
snprintf ( V_110 , sizeof( V_110 ) , L_30 , V_17 -> V_77 ) ;
V_112 = strstr ( V_110 , V_78 ) ;
if ( ! V_112 )
goto V_24;
if ( ! strncmp ( V_112 + 4 , L_31 , 1 ) ) {
if ( ! strcmp ( V_110 , V_112 ) )
sprintf ( V_111 , L_30 , V_112 + 5 ) ;
else {
V_112 -- ;
* V_112 = '\0' ;
V_113 = sprintf ( V_111 , L_30 , V_110 ) ;
V_112 += 5 ;
sprintf ( V_111 + V_113 , L_30 , V_112 ) ;
}
} else {
V_112 -- ;
* V_112 = '\0' ;
sprintf ( V_111 , L_30 , V_110 ) ;
}
if ( F_14 ( V_17 , V_111 ) < 0 )
return - V_76 ;
} else {
snprintf ( V_110 , sizeof( V_110 ) , L_30 , V_17 -> V_77 ) ;
V_112 = strstr ( V_110 , V_78 ) ;
if ( V_112 )
goto V_24;
strncat ( V_110 , L_31 , strlen ( L_31 ) ) ;
strncat ( V_110 , V_78 , strlen ( V_78 ) ) ;
