...
if ( F_101 ( V_1 -> V_270 ) ) {
F_58 ( V_181 L_11 , V_35 , F_102 ( V_1 -> V_270 ) ) ;
V_1 -> V_270 = NULL ;
} else
F_103 ( V_1 ) ;
...
F_115 ( void )
{
F_116 ( L_12 , 0 , NULL , & V_289 ) ;
if ( F_117 ( V_273 , L_12 , & V_290 ) )
F_58 ( L_13 , V_273 ) ;
V_271 = F_118 ( V_291 , L_14 ) ;
if ( F_101 ( V_271 ) ) {
F_58 ( V_181 L_15 , F_102 ( V_271 ) ) ;
V_271 = NULL ;
}
return 0 ;
}
...
struct V_292 * V_117 , * V_48 ;
struct V_293 * V_168 ;
struct V_164 * V_116 , V_179 ;
int V_132 = 1 ;
F_124 (pos, n, &info->modelist) {
V_168 = F_125 ( V_117 , struct V_293 , V_294 ) ;
V_116 = & V_168 -> V_179 ;
F_126 ( & V_13 , V_116 ) ;
V_13 . V_153 = V_295 ;
