...
if ( V_15 -> V_36 > V_37 )
F_25 ( V_15 , V_51 ) ;
V_117 . V_113 = & V_2 -> V_65 ;
V_117 . V_16 = 0xa0 >> 1 ;
V_9 = F_61 ( & V_117 , V_115 , sizeof( V_115 ) ) ;
if ( F_6 ( V_9 ) )
return 0 ;
F_62 ( & V_117 , & V_15 -> V_118 , ( 0x84 == V_115 [ 0xa0 ] ) ?
...
static void F_69 ( struct V_120 * V_121 , T_1 V_122 )
{
F_3 ( L_26 , V_12 , V_122 ) ;
V_121 -> type = V_123 ;
V_121 -> V_124 = 5 ;
V_121 -> V_122 = V_122 ;
V_121 -> V_125 . V_126 . V_127 = 8192 ;
}
static void F_70 ( struct V_120 * V_121 ,
T_1 V_122 , int V_128 , int V_129 )
{
F_3 ( L_27 , V_12 , V_122 ,
V_128 * V_129 ) ;
V_121 -> type = V_130 ;
V_121 -> V_124 = 5 ;
V_121 -> V_122 = V_122 ;
V_121 -> V_125 . V_131 . V_128 = V_128 ;
V_121 -> V_125 . V_131 . V_129 = V_129 ;
V_121 -> V_125 . V_131 . V_132 = 1 ;
}
static int F_71 ( struct V_40 * V_41 ,
T_1 * V_133 , struct V_120 * V_121 )
{
F_3 ( L_28 , V_12 , V_41 -> V_28 ) ;
* V_133 = V_134 ;
if ( V_60 )
F_70 ( V_121 , 4 , 96 , 564 ) ;
else
