...
{
struct V_433 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_17 ( V_2 , F_18 ( V_375 -> V_19 ) ) ;
...
{
struct V_438 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_10 ( V_2 ) ;
F_6 ( V_2 ) ;
...
{
struct V_446 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_17 ( V_2 , F_18 ( V_375 -> V_19 ) ) ;
...
if ( V_18 -> V_447 == V_448 )
F_34 ( V_449 , & V_18 -> V_9 ) ;
if ( ( V_18 -> type == V_196 && V_375 -> V_436 == 0x02 ) ||
V_18 -> type == V_237 )
F_34 ( V_445 , & V_18 -> V_9 ) ;
} else {
F_3 ( V_383 , & V_18 -> V_9 ) ;
...
if ( ! V_375 -> V_5 && V_375 -> V_436 && V_18 -> type == V_196 ) {
struct V_452 V_165 ;
struct V_453 V_454 ;
if ( ! ( V_2 -> V_98 [ 20 ] & 0x10 ) ) {
V_18 -> V_442 = V_443 ;
...
F_191 ( & V_454 , V_455 , sizeof( V_165 ) , & V_165 ) ;
if ( F_192 ( & V_454 , F_188 ) ) {
F_100 ( L_20 ) ;
V_18 -> V_442 = V_443 ;
goto V_75;
}
...
F_185 ( V_18 , V_375 -> V_5 , V_375 -> V_436 ) ;
V_168:
F_9 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_456 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_17 ( V_2 , F_18 ( V_375 -> V_19 ) ) ;
...
struct V_3 * V_4 )
{
struct V_458 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_17 ( V_2 , F_18 ( V_375 -> V_19 ) ) ;
...
break;
default:
F_2 ( L_21 , V_2 -> V_7 , * V_440 ) ;
break;
}
if ( * V_440 != V_503 )
F_97 ( & V_2 -> V_504 ) ;
if ( V_375 -> V_505 && ! F_54 ( V_29 , & V_2 -> V_9 ) )
F_199 ( & V_2 -> V_506 , 1 ) ;
F_200 ( V_2 , * V_440 , * V_5 , V_459 ,
V_460 ) ;
if ( F_201 ( & V_2 -> V_506 ) && ! F_202 ( & V_2 -> V_507 ) )
F_203 ( V_2 -> V_215 , & V_2 -> V_508 ) ;
}
...
T_9 * V_460 )
{
struct V_509 * V_375 = ( void * ) V_4 -> V_6 ;
F_198 ( V_4 , sizeof( * V_375 ) ) ;
* V_440 = F_18 ( V_375 -> V_440 ) ;
* V_5 = V_375 -> V_5 ;
switch ( * V_440 ) {
...
F_199 ( & V_2 -> V_506 , 1 ) ;
if ( V_375 -> V_5 ||
( V_2 -> V_511 && ! F_205 ( V_2 -> V_511 ) -> V_512 . V_513 ) )
F_200 ( V_2 , * V_440 , V_375 -> V_5 , V_459 ,
V_460 ) ;
if ( F_201 ( & V_2 -> V_506 ) && ! F_202 ( & V_2 -> V_507 ) )
F_203 ( V_2 -> V_215 , & V_2 -> V_508 ) ;
}
...
{
struct V_514 * V_375 = ( void * ) V_4 -> V_6 ;
V_2 -> V_515 = V_375 -> V_516 ;
F_203 ( V_2 -> V_517 , & V_2 -> V_518 ) ;
}
static void F_207 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_519 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_70 ( V_2 , V_196 , & V_375 -> V_145 ) ;
...
{
struct V_520 * V_375 = ( void * ) V_4 -> V_6 ;
int V_521 ;
if ( V_2 -> V_131 != V_522 ) {
...
V_375 -> V_523 * sizeof( struct V_524 ) ) {
F_2 ( L_23 , V_2 -> V_7 ) ;
return;
}
F_2 ( L_24 , V_2 -> V_7 , V_375 -> V_523 ) ;
for ( V_521 = 0 ; V_521 < V_375 -> V_523 ; V_521 ++ ) {
struct V_524 * V_369 = & V_375 -> V_525 [ V_521 ] ;
struct V_17 * V_18 ;
T_2 V_19 , V_526 ;
V_19 = F_18 ( V_369 -> V_19 ) ;
V_526 = F_18 ( V_369 -> V_526 ) ;
V_18 = F_17 ( V_2 , V_19 ) ;
if ( ! V_18 )
continue;
V_18 -> V_25 -= V_526 ;
...
case V_532 :
V_529 = F_211 ( V_2 , V_19 ) ;
if ( V_529 )
return V_529 -> V_18 ;
break;
default:
F_100 ( L_26 , V_2 -> V_7 , V_2 -> V_530 ) ;
break;
}
return NULL ;
}
...
{
struct V_533 * V_375 = ( void * ) V_4 -> V_6 ;
int V_521 ;
if ( V_2 -> V_131 != V_534 ) {
F_100 ( L_22 , V_2 -> V_131 ) ;
return;
...
if ( V_4 -> V_166 < sizeof( * V_375 ) || V_4 -> V_166 < sizeof( * V_375 ) +
V_375 -> V_523 * sizeof( struct V_535 ) ) {
F_2 ( L_23 , V_2 -> V_7 ) ;
return;
}
...
V_375 -> V_523 ) ;
for ( V_521 = 0 ; V_521 < V_375 -> V_523 ; V_521 ++ ) {
struct V_535 * V_369 = & V_375 -> V_525 [ V_521 ] ;
struct V_17 * V_18 = NULL ;
T_2 V_19 , V_536 ;
V_19 = F_18 ( V_369 -> V_19 ) ;
V_536 = F_18 ( V_369 -> V_537 ) ;
V_18 = F_210 ( V_2 , V_19 ) ;
if ( ! V_18 )
continue;
V_18 -> V_25 -= V_536 ;
...
{
struct V_539 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_17 ( V_2 , F_18 ( V_375 -> V_19 ) ) ;
...
V_544 = 0 ;
F_215 ( V_2 , & V_375 -> V_145 , V_544 ) ;
}
V_168:
F_9 ( V_2 ) ;
}
static void F_216 ( struct V_17 * V_18 , T_3 V_447 , T_3 V_198 )
{
if ( V_447 == V_545 )
return;
V_18 -> V_197 = V_198 ;
...
{
struct V_553 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_554 V_165 ;
struct V_17 * V_18 ;
struct V_555 * V_556 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
...
return;
F_6 ( V_2 ) ;
V_556 = F_159 ( V_2 , & V_375 -> V_145 ) ;
if ( ! V_556 ) {
F_2 ( L_28 , V_2 -> V_7 ,
& V_375 -> V_145 ) ;
goto V_557;
}
F_2 ( L_29 , V_2 -> V_7 , V_556 -> type ,
& V_375 -> V_145 ) ;
V_18 = F_70 ( V_2 , V_196 , & V_375 -> V_145 ) ;
if ( V_18 ) {
F_3 ( V_558 , & V_18 -> V_9 ) ;
...
if ( V_556 -> type == V_549 && V_556 -> V_198 < 16 &&
( V_18 -> V_301 == V_305 ||
V_18 -> V_301 == V_304 ) ) {
F_2 ( L_31 ,
V_2 -> V_7 ) ;
...
F_216 ( V_18 , V_556 -> type , V_556 -> V_198 ) ;
}
F_56 ( & V_165 . V_145 , & V_375 -> V_145 ) ;
memcpy ( V_165 . V_555 , V_556 -> V_559 , V_443 ) ;
F_128 ( V_2 , V_560 , sizeof( V_165 ) , & V_165 ) ;
F_9 ( V_2 ) ;
return;
V_557:
F_128 ( V_2 , V_561 , 6 , & V_375 -> V_145 ) ;
F_9 ( V_2 ) ;
}
static void F_218 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_562 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
struct V_555 * V_556 ;
bool V_563 ;
T_3 V_198 = 0 ;
...
F_123 ( V_18 ) ;
F_34 ( V_558 , & V_18 -> V_9 ) ;
F_216 ( V_18 , V_375 -> V_447 , V_18 -> V_197 ) ;
if ( ! F_7 ( V_2 , V_50 ) )
goto V_168;
V_556 = F_219 ( V_2 , V_18 , & V_375 -> V_145 , V_375 -> V_555 ,
V_375 -> V_447 , V_198 , & V_563 ) ;
if ( ! V_556 )
goto V_168;
if ( V_375 -> V_447 == V_545 )
F_216 ( V_18 , V_556 -> type , V_556 -> V_198 ) ;
F_220 ( V_2 , V_556 , V_563 ) ;
if ( V_556 -> type == V_548 &&
! F_7 ( V_2 , V_564 ) ) {
F_221 ( & V_556 -> V_325 ) ;
F_222 ( V_556 , V_565 ) ;
...
{
struct V_566 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_17 ( V_2 , F_18 ( V_375 -> V_19 ) ) ;
...
{
struct V_570 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_307 * V_394 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_394 = F_169 ( V_2 , & V_375 -> V_145 ) ;
...
return;
F_6 ( V_2 ) ;
if ( ( V_4 -> V_166 - 1 ) / V_370 != sizeof( struct V_571 ) ) {
struct V_572 * V_369 ;
...
struct V_571 * V_369 = ( void * ) ( V_4 -> V_6 + 1 ) ;
for (; V_370 ; V_370 -- , V_369 ++ ) {
T_6 V_9 ;
F_56 ( & V_6 . V_145 , & V_369 -> V_145 ) ;
V_6 . V_310 = V_369 -> V_310 ;
...
static inline T_10 F_230 ( T_3 * V_579 , T_10 V_580 )
{
T_10 V_581 = 0 ;
while ( V_581 < V_580 ) {
T_3 V_582 = V_579 [ 0 ] ;
...
{
struct V_367 V_6 ;
struct V_583 * V_369 = ( void * ) ( V_4 -> V_6 + 1 ) ;
int V_370 = * ( ( T_1 * ) V_4 -> V_6 ) ;
T_10 V_580 ;
F_2 ( L_14 , V_2 -> V_7 , V_370 ) ;
if ( ! V_370 )
...
V_6 . V_373 = 0x01 ;
if ( F_7 ( V_2 , V_50 ) )
V_584 = F_232 ( V_369 -> V_6 ,
sizeof( V_369 -> V_6 ) ,
V_585 , NULL ) ;
else
V_584 = true ;
V_9 = F_156 ( V_2 , & V_6 , V_584 ) ;
V_580 = F_230 ( V_369 -> V_6 , sizeof( V_369 -> V_6 ) ) ;
F_96 ( V_2 , & V_369 -> V_145 , V_196 , 0x00 ,
V_369 -> V_70 , V_369 -> V_227 ,
V_9 , V_369 -> V_6 , V_580 , NULL , 0 ) ;
}
F_9 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_586 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
...
if ( V_18 -> V_587 == V_588 ||
V_18 -> V_587 == V_589 )
return V_18 -> V_587 | ( V_18 -> V_303 & 0x01 ) ;
if ( V_18 -> V_590 != V_591 &&
V_18 -> V_592 != V_591 )
return V_18 -> V_587 | 0x01 ;
return ( V_18 -> V_587 & ~ 0x01 ) | ( V_18 -> V_303 & 0x01 ) ;
}
...
if ( ! F_7 ( V_2 , V_451 ) )
return V_6 -> V_594 ;
if ( ! memcmp ( V_6 -> V_595 , V_596 , 16 ) ||
! memcmp ( V_6 -> V_597 , V_596 , 16 ) )
return 0x00 ;
return 0x02 ;
}
if ( ! memcmp ( V_6 -> V_598 , V_596 , 16 ) ||
! memcmp ( V_6 -> V_599 , V_596 , 16 ) )
return 0x00 ;
return 0x01 ;
}
static void F_238 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_600 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_18 = F_70 ( V_2 , V_196 , & V_375 -> V_145 ) ;
...
if ( F_7 ( V_2 , V_543 ) ||
F_54 ( V_330 , & V_18 -> V_9 ) ||
( V_18 -> V_587 & ~ 0x01 ) == V_588 ) {
struct V_601 V_165 ;
F_56 ( & V_165 . V_145 , & V_375 -> V_145 ) ;
V_165 . V_602 = ( V_18 -> V_592 == 0x04 ) ?
V_603 : V_18 -> V_592 ;
if ( V_18 -> V_587 == 0xff ) {
if ( V_18 -> V_592 != V_591 &&
V_18 -> V_303 != V_588 )
...
if ( ! F_7 ( V_2 , V_543 ) )
V_18 -> V_303 &= V_589 ;
V_165 . V_604 = V_18 -> V_303 ;
V_165 . V_593 = F_235 ( V_18 ) ;
F_128 ( V_2 , V_605 ,
sizeof( V_165 ) , & V_165 ) ;
} else {
struct V_606 V_165 ;
...
{
struct V_609 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_18 = F_70 ( V_2 , V_196 , & V_375 -> V_145 ) ;
if ( ! V_18 )
goto V_168;
V_18 -> V_590 = V_375 -> V_602 ;
V_18 -> V_587 = V_375 -> V_604 ;
V_168:
F_9 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_610 * V_375 = ( void * ) V_4 -> V_6 ;
int V_611 , V_612 , V_613 = 0 ;
struct V_17 * V_18 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
if ( ! F_7 ( V_2 , V_50 ) )
...
if ( ! V_18 )
goto V_168;
V_611 = ( V_18 -> V_303 & 0x01 ) ;
V_612 = ( V_18 -> V_587 & 0x01 ) ;
if ( V_18 -> V_301 > V_306 &&
V_18 -> V_590 == V_591 ) {
F_2 ( L_33 ) ;
F_128 ( V_2 , V_494 ,
...
if ( ( ! V_611 || V_18 -> V_590 == V_591 ) &&
( ! V_612 || V_18 -> V_592 == V_591 ) ) {
...
struct V_3 * V_4 )
{
struct V_619 * V_375 = ( void * ) V_4 -> V_6 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
if ( F_7 ( V_2 , V_50 ) )
...
struct V_3 * V_4 )
{
struct V_620 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
V_18 = F_70 ( V_2 , V_196 , & V_375 -> V_145 ) ;
if ( ! V_18 )
return;
V_18 -> V_621 = F_66 ( V_375 -> V_618 ) ;
V_18 -> V_622 = 0 ;
if ( F_7 ( V_2 , V_50 ) )
F_246 ( V_2 , & V_18 -> V_345 , V_18 -> type ,
V_18 -> V_346 , V_18 -> V_621 ,
V_18 -> V_622 ) ;
}
...
struct V_3 * V_4 )
{
struct V_629 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_18 = F_70 ( V_2 , V_196 , & V_375 -> V_145 ) ;
...
struct V_3 * V_4 )
{
struct V_630 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_307 * V_394 ;
struct V_17 * V_18 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
...
struct V_3 * V_4 )
{
struct V_631 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_593 * V_6 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
if ( ! F_7 ( V_2 , V_50 ) )
...
F_56 ( & V_165 . V_145 , & V_375 -> V_145 ) ;
if ( F_7 ( V_2 , V_451 ) ) {
memset ( V_165 . V_599 , 0 , sizeof( V_165 . V_599 ) ) ;
memset ( V_165 . V_598 , 0 , sizeof( V_165 . V_598 ) ) ;
} else {
memcpy ( V_165 . V_599 , V_6 -> V_599 , sizeof( V_165 . V_599 ) ) ;
memcpy ( V_165 . V_598 , V_6 -> V_598 , sizeof( V_165 . V_598 ) ) ;
}
memcpy ( V_165 . V_597 , V_6 -> V_597 , sizeof( V_165 . V_597 ) ) ;
memcpy ( V_165 . V_595 , V_6 -> V_595 , sizeof( V_165 . V_595 ) ) ;
F_128 ( V_2 , V_635 ,
sizeof( V_165 ) , & V_165 ) ;
} else {
struct V_636 V_165 ;
F_56 ( & V_165 . V_145 , & V_375 -> V_145 ) ;
memcpy ( V_165 . V_637 , V_6 -> V_599 , sizeof( V_165 . V_637 ) ) ;
memcpy ( V_165 . rand , V_6 -> V_598 , sizeof( V_165 . rand ) ) ;
F_128 ( V_2 , V_638 ,
sizeof( V_165 ) , & V_165 ) ;
}
V_168:
...
{
struct V_639 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_640 ;
F_2 ( L_36 , V_2 -> V_7 , V_375 -> V_641 ) ;
F_198 ( V_4 , sizeof( * V_375 ) ) ;
V_640 = F_17 ( V_2 , V_375 -> V_641 ) ;
if ( ! V_640 )
return;
F_252 ( V_2 , V_640 ) ;
}
...
struct V_17 * V_640 , * V_643 ;
F_2 ( L_37 , V_2 -> V_7 , V_375 -> V_641 ,
V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_640 = F_17 ( V_2 , V_375 -> V_641 ) ;
if ( ! V_640 ) {
...
V_643 = V_640 -> V_644 -> V_645 -> V_640 ;
V_640 -> V_240 = V_320 ;
F_56 ( & V_640 -> V_345 , & V_643 -> V_345 ) ;
F_158 ( V_640 ) ;
V_640 -> V_379 = V_381 ;
F_123 ( V_640 ) ;
F_160 ( V_640 ) ;
...
{
struct V_646 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_640 ;
struct V_528 * V_647 ;
struct V_644 * V_648 ;
F_2 ( L_38 ,
V_2 -> V_7 , F_64 ( V_375 -> V_19 ) , V_375 -> V_641 ,
V_375 -> V_5 ) ;
V_640 = F_17 ( V_2 , V_375 -> V_641 ) ;
if ( ! V_640 )
return;
...
if ( ! V_647 )
return;
V_647 -> V_19 = F_64 ( V_375 -> V_19 ) ;
F_2 ( L_39 , V_640 , V_640 -> V_644 , V_647 ) ;
V_648 = V_640 -> V_644 ;
if ( V_648 && V_648 -> V_649 ) {
struct V_650 * V_649 = V_648 -> V_649 ;
F_257 ( V_649 ) ;
V_649 -> V_18 -> V_651 = V_2 -> V_158 ;
F_258 ( V_649 , V_647 , 0 ) ;
F_158 ( V_640 ) ;
F_259 ( V_649 ) ;
}
...
struct V_3 * V_4 )
{
struct V_652 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_528 * V_647 ;
F_2 ( L_40 , V_2 -> V_7 ,
...
return;
F_6 ( V_2 ) ;
V_647 = F_211 ( V_2 , F_64 ( V_375 -> V_19 ) ) ;
if ( ! V_647 )
goto V_168;
F_261 ( V_647 , V_375 -> V_388 ) ;
V_168:
F_9 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_653 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_640 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
if ( V_375 -> V_5 )
return;
...
{
struct V_654 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_423 * V_424 ;
struct V_17 * V_18 ;
struct V_655 * V_656 ;
T_3 V_657 ;
...
V_18 -> V_660 = V_2 -> V_660 ;
V_18 -> V_661 = V_2 -> V_661 ;
}
V_656 = F_265 ( V_2 , & V_18 -> V_345 , V_18 -> V_346 ) ;
if ( V_656 ) {
F_56 ( & V_18 -> V_345 , & V_656 -> V_145 ) ;
V_18 -> V_346 = V_656 -> V_657 ;
}
if ( V_375 -> V_5 ) {
...
V_657 = V_664 ;
if ( F_168 ( & V_2 -> V_396 , & V_18 -> V_345 , V_657 ) ) {
F_123 ( V_18 ) ;
goto V_168;
}
...
V_18 -> V_19 = F_18 ( V_375 -> V_19 ) ;
V_18 -> V_240 = V_297 ;
V_18 -> V_666 = F_64 ( V_375 -> V_149 ) ;
V_18 -> V_667 = F_64 ( V_375 -> V_668 ) ;
V_18 -> V_669 = F_64 ( V_375 -> V_670 ) ;
F_160 ( V_18 ) ;
F_161 ( V_18 ) ;
if ( ! V_375 -> V_5 ) {
if ( V_18 -> V_300 ||
...
V_424 = F_267 ( & V_2 -> V_432 , & V_18 -> V_345 ,
V_18 -> V_346 ) ;
if ( V_424 ) {
F_177 ( & V_424 -> V_431 ) ;
if ( V_424 -> V_18 ) {
...
struct V_3 * V_4 )
{
struct V_672 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
if ( V_375 -> V_5 )
return;
...
struct V_17 * V_18 ;
struct V_423 * V_424 ;
if ( V_674 != V_675 && V_674 != V_676 )
return NULL ;
if ( F_168 ( & V_2 -> V_396 , V_673 , V_657 ) )
return NULL ;
if ( V_2 -> V_677 . V_678 > 0 )
return NULL ;
V_424 = F_267 ( & V_2 -> V_432 , V_673 ,
V_657 ) ;
if ( ! V_424 )
return NULL ;
if ( ! V_424 -> V_679 ) {
...
V_18 = F_271 ( V_2 , V_673 , V_657 , V_665 ,
V_680 , V_289 ) ;
if ( ! F_272 ( V_18 ) ) {
if ( ! V_424 -> V_679 )
...
T_3 V_226 , T_4 * V_682 ,
T_3 V_683 , T_5 V_227 , T_3 * V_6 , T_3 V_166 )
{
struct V_220 * V_221 = & V_2 -> V_222 ;
struct V_655 * V_656 ;
struct V_17 * V_18 ;
...
T_6 V_9 ;
T_3 * V_685 , V_686 ;
for ( V_685 = V_6 ; V_685 < V_6 + V_166 && * V_685 ; V_685 += * V_685 + 1 ) {
if ( V_685 + 1 + * V_685 > V_6 + V_166 )
break;
}
V_686 = V_685 - V_6 ;
if ( V_166 != V_686 ) {
...
if ( V_682 ) {
if ( ! F_277 ( V_682 , V_683 ) )
return;
if ( ! F_7 ( V_2 , V_658 ) )
return;
if ( ! F_278 ( V_2 , V_2 -> V_656 , V_682 ) )
return;
}
V_656 = F_265 ( V_2 , V_145 , V_226 ) ;
if ( V_656 ) {
V_145 = & V_656 -> V_145 ;
V_226 = V_656 -> V_657 ;
}
...
{
T_3 V_694 = V_4 -> V_6 [ 0 ] ;
void * V_685 = & V_4 -> V_6 [ 1 ] ;
F_6 ( V_2 ) ;
while ( V_694 -- ) {
struct V_695 * V_375 = V_685 ;
T_5 V_227 ;
V_227 = V_375 -> V_6 [ V_375 -> V_696 ] ;
F_275 ( V_2 , V_375 -> V_697 , & V_375 -> V_145 ,
V_375 -> V_226 , NULL , 0 , V_227 ,
V_375 -> V_6 , V_375 -> V_696 ) ;
V_685 += sizeof( * V_375 ) + V_375 -> V_696 + 1 ;
}
F_9 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_698 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_17 * V_18 ;
F_2 ( L_1 , V_2 -> V_7 , V_375 -> V_5 ) ;
F_6 ( V_2 ) ;
V_18 = F_17 ( V_2 , F_18 ( V_375 -> V_19 ) ) ;
...
{
struct V_699 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_700 V_165 ;
struct V_701 V_702 ;
struct V_17 * V_18 ;
struct V_703 * V_704 ;
...
if ( V_18 == NULL )
goto V_557;
V_704 = F_282 ( V_2 , & V_18 -> V_345 , V_18 -> V_346 , V_18 -> V_20 ) ;
if ( ! V_704 )
goto V_557;
if ( F_283 ( V_704 ) ) {
if ( V_375 -> V_705 || V_375 -> rand )
goto V_557;
} else {
if ( V_375 -> V_705 != V_704 -> V_705 || V_375 -> rand != V_704 -> rand )
goto V_557;
}
memcpy ( V_165 . V_704 , V_704 -> V_559 , V_704 -> V_706 ) ;
memset ( V_165 . V_704 + V_704 -> V_706 , 0 , sizeof( V_165 . V_704 ) - V_704 -> V_706 ) ;
V_165 . V_19 = F_163 ( V_18 -> V_19 ) ;
V_18 -> V_301 = F_284 ( V_704 ) ;
V_18 -> V_442 = V_704 -> V_706 ;
F_128 ( V_2 , V_707 , sizeof( V_165 ) , & V_165 ) ;
if ( V_704 -> type == V_708 ) {
F_34 ( V_709 , & V_18 -> V_9 ) ;
F_221 ( & V_704 -> V_325 ) ;
F_222 ( V_704 , V_565 ) ;
...
return;
V_557:
V_702 . V_19 = V_375 -> V_19 ;
F_128 ( V_2 , V_710 , sizeof( V_702 ) , & V_702 ) ;
F_9 ( V_2 ) ;
}
...
V_165 . V_388 = V_388 ;
F_128 ( V_2 , V_712 , sizeof( V_165 ) ,
& V_165 ) ;
}
static void F_286 ( struct V_1 * V_2 ,
struct V_3 * V_4 )
{
struct V_713 * V_375 = ( void * ) V_4 -> V_6 ;
struct V_714 V_165 ;
struct V_17 * V_640 ;
T_7 V_19 , V_715 , V_716 , V_668 , V_717 ;
V_19 = F_64 ( V_375 -> V_19 ) ;
V_715 = F_64 ( V_375 -> V_718 ) ;
V_716 = F_64 ( V_375 -> V_719 ) ;
V_668 = F_64 ( V_375 -> V_668 ) ;
V_717 = F_64 ( V_375 -> V_717 ) ;
V_640 = F_17 ( V_2 , V_19 ) ;
if ( ! V_640 || V_640 -> V_240 != V_320 )
return F_285 ( V_2 , V_19 ,
V_720 ) ;
if ( F_287 ( V_715 , V_716 , V_668 , V_717 ) )
return F_285 ( V_2 , V_19 ,
V_721 ) ;
if ( V_640 -> V_20 == V_289 ) {
struct V_423 * V_424 ;
...
F_9 ( V_2 ) ;
F_288 ( V_2 , & V_640 -> V_345 , V_640 -> V_346 ,
V_722 , V_715 , V_716 , V_668 , V_717 ) ;
}
V_165 . V_19 = V_375 -> V_19 ;
V_165 . V_718 = V_375 -> V_718 ;
V_165 . V_719 = V_375 -> V_719 ;
V_165 . V_668 = V_375 -> V_668 ;
V_165 . V_717 = V_375 -> V_717 ;
V_165 . V_726 = 0 ;
V_165 . V_727 = 0 ;
F_128 ( V_2 , V_728 , sizeof( V_165 ) , & V_165 ) ;
}
...
F_6 ( V_2 ) ;
while ( V_694 -- ) {
struct V_729 * V_375 = V_685 ;
F_275 ( V_2 , V_375 -> V_697 , & V_375 -> V_145 ,
V_375 -> V_226 , & V_375 -> V_682 ,
V_375 -> V_683 , V_375 -> V_227 , NULL , 0 ) ;
V_685 += sizeof( * V_375 ) ;
}
F_9 ( V_2 ) ;
}
...
{
struct V_730 * V_731 = ( void * ) V_4 -> V_6 ;
F_198 ( V_4 , sizeof( * V_731 ) ) ;
switch ( V_731 -> V_732 ) {
case V_733 :
F_263 ( V_2 , V_4 ) ;
break;
...
static bool F_291 ( struct V_1 * V_2 , T_7 V_440 ,
T_3 V_740 , struct V_3 * V_4 )
{
struct V_461 * V_375 ;
struct V_741 * V_742 ;
if ( ! V_4 )
return false ;
if ( V_4 -> V_166 < sizeof( * V_742 ) ) {
F_100 ( L_43 ) ;
return false ;
}
V_742 = ( void * ) V_4 -> V_6 ;
F_198 ( V_4 , V_743 ) ;
if ( V_740 ) {
if ( V_742 -> V_744 != V_740 )
return false ;
return true ;
}
if ( V_742 -> V_744 != V_745 ) {
F_2 ( L_44 , V_742 -> V_744 ) ;
return false ;
}
...
{
struct V_741 * V_742 = ( void * ) V_4 -> V_6 ;
T_8 V_459 = NULL ;
T_9 V_460 = NULL ;
struct V_3 * V_746 = NULL ;
T_3 V_5 = 0 , V_740 = V_742 -> V_744 , V_747 = 0 ;
T_7 V_440 = V_503 ;
if ( V_2 -> V_511 && F_205 ( V_2 -> V_511 ) -> V_512 . V_513 == V_740 ) {
struct V_748 * V_749 = ( void * ) V_2 -> V_511 -> V_6 ;
V_440 = F_18 ( V_749 -> V_440 ) ;
F_200 ( V_2 , V_440 , V_5 , & V_459 ,
& V_460 ) ;
V_747 = V_740 ;
}
if ( V_460 || V_740 == V_750 ||
V_740 == V_745 )
V_746 = F_293 ( V_4 , V_751 ) ;
F_198 ( V_4 , V_743 ) ;
switch ( V_740 ) {
case V_752 :
F_154 ( V_2 , V_4 ) ;
...
break;
case V_745 :
F_197 ( V_2 , V_4 , & V_440 , & V_5 ,
& V_459 , & V_460 ) ;
break;
case V_750 :
F_204 ( V_2 , V_4 , & V_440 , & V_5 , & V_459 ,
& V_460 ) ;
break;
case V_762 :
F_206 ( V_2 , V_4 ) ;
...
break;
default:
F_2 ( L_47 , V_2 -> V_7 , V_740 ) ;
break;
}
if ( V_459 ) {
V_459 ( V_2 , V_5 , V_440 ) ;
} else if ( V_460 ) {
if ( ! F_291 ( V_2 , V_440 , V_747 , V_746 ) ) {
F_295 ( V_746 ) ;
V_746 = NULL ;
}
V_460 ( V_2 , V_5 , V_440 , V_746 ) ;
}
F_295 ( V_746 ) ;
F_295 ( V_4 ) ;
V_2 -> V_794 . V_795 ++ ;
