...
struct V_5 V_6 ;
T_2 V_22 ;
int V_53 = V_7 ? V_54 : V_55 ;
if ( V_30 != 0 )
return - V_56 ;
V_22 = F_24 ( V_53 , V_46 , V_47 , V_49 , & V_51 , & V_6 ) ;
if ( V_22 < 0 )
return V_22 ;
if ( ! F_2 ( & V_6 ) )
goto V_57;
V_22 = F_25 ( V_58 , V_28 , V_29 , V_49 ,
V_50 , & V_52 ) ;
if ( V_22 <= 0 )
goto V_57;
...
static T_2
F_26 ( T_5 V_26 ,
const struct V_59 T_4 * V_46 ,
unsigned long V_47 ,
const struct V_59 T_4 * V_28 ,
unsigned long V_29 ,
unsigned long V_30 , int V_7 )
{
struct V_27 V_48 [ V_49 ] ;
...
if ( V_30 != 0 )
return - V_56 ;
V_22 = F_27 ( V_53 , V_46 , V_47 , V_49 , & V_51 , & V_6 ) ;
if ( V_22 < 0 )
return V_22 ;
if ( ! F_2 ( & V_6 ) )
goto V_57;
V_22 = F_28 ( V_58 , V_28 , V_29 ,
V_49 , V_50 ,
& V_52 ) ;
if ( V_22 <= 0 )
goto V_57;
