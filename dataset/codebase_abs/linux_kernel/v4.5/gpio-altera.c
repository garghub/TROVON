...
static int F_13 ( struct V_20 * V_21 , unsigned V_22 )
{
struct V_5 * V_6 ;
V_6 = F_14 ( V_21 ) ;
return ! ! ( F_5 ( V_6 -> V_11 + V_23 ) & F_6 ( V_22 ) ) ;
}
static void F_15 ( struct V_20 * V_21 , unsigned V_22 , int V_24 )
{
struct V_5 * V_6 ;
struct V_3 * V_25 ;
unsigned long V_7 ;
...
V_4 -> V_9 . V_21 . V_51 = F_13 ;
V_4 -> V_9 . V_21 . V_52 = F_15 ;
V_4 -> V_9 . V_21 . V_53 = V_54 ;
V_4 -> V_9 . V_21 . V_55 = & V_38 -> V_41 ;
V_44 = F_32 ( V_40 , & V_4 -> V_9 , V_4 ) ;
if ( V_44 ) {
F_33 ( & V_38 -> V_41 , L_3 ) ;
return V_44 ;
}
F_34 ( V_38 , V_4 ) ;
V_4 -> V_56 = F_35 ( V_38 , 0 ) ;
if ( V_4 -> V_56 < 0 )
goto V_57;
