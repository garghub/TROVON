...
int
F_34 ( char * V_87 , unsigned int V_88 , struct V_89 * V_74 )
{
struct V_33 * V_82 = (struct V_33 * ) V_87 ;
T_2 V_90 = F_35 ( V_82 -> V_52 ) ;
T_2 V_91 ;
F_3 ( V_5 , L_7 ,
V_88 , V_90 ) ;
...
( V_82 -> V_81 == 0 ) ) {
char * V_94 = ( char * ) V_82 ;
if ( V_94 [ sizeof( struct V_33 ) ] == 0 ) {
V_94 [ sizeof( struct V_33 ) + 1 ] = 0 ;
return 0 ;
}
F_3 ( V_84 , L_8 ) ;
} else {
...
if ( 4 + V_90 != V_91 ) {
V_59 V_96 = F_33 ( V_82 ) ;
if ( ( V_90 > 64 * 1024 ) && ( V_90 > V_91 ) ) {
if ( ( ( 4 + V_90 ) & 0xFFFF ) == ( V_91 & 0xFFFF ) )
return 0 ;
}
F_3 ( V_5 , L_11 ,
V_91 , 4 + V_90 , V_96 ) ;
...
if ( V_111 -> V_108 . V_92 . V_93 ) {
F_3 ( V_5 , L_16 ,
V_111 -> V_108 . V_92 . V_93 ) ;
return true ;
}
return false ;
}
...
if ( ( V_118 ) ==
F_39 ( V_99 -> V_108 . V_92 . V_93 ) ) {
F_3 ( V_5 , L_17 ) ;
return true ;
} else if ( V_119 ==
F_40 ( V_99 -> V_108 . V_92 . V_120 . Error ) ) {
return true ;
} else {
return false ;
}
...
V_65 = F_42 ( V_94 , struct V_7 , V_14 ) ;
