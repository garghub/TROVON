...
V_48 -> V_173 = V_180 = F_144 ( V_41 ) ;
if ( ! V_180 )
return - V_121 ;
if ( F_101 ( V_180 , V_132 , V_204 , V_205 , NULL ) )
return - V_121 ;
V_182 = F_141 ( V_180 , V_160 -> V_174 ) ;
if ( F_103 ( V_182 ) ) {
F_98 ( V_180 , V_132 , V_204 , V_205 ) ;
return F_102 ( V_182 ) ;
}
F_145 ( L_14 ,
V_156 , F_146 ( V_156 ) ) ;
...
{
return F_151 ( V_211 , V_37 , V_213 -> V_214 -> V_215 , F_143 ) ;
}
static void F_152 ( struct V_47 * V_48 )
{
struct V_156 * V_156 = V_48 -> V_208 ;
struct V_159 * V_160 = F_115 ( V_156 , V_161 ) ;
F_116 ( & V_160 -> V_162 ) ;
if ( V_160 -> V_177 != V_48 ) {
F_117 ( & V_160 -> V_162 ) ;
