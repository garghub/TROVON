...
int F_19 ( T_4 V_30 , int V_64 , int * V_21 ,
int * V_22 , char * * V_65 )
{
int V_34 ;
struct V_66 * V_29 ;
...
F_24 ( V_5 -> V_29 ) ) ) ;
if ( V_5 -> V_60 == 0 )
F_27 ( V_5 -> V_29 -> V_30 , L_33 , NULL , NULL ) ;
F_23 ( & V_67 ) ;
return ( V_5 -> V_14 . V_35 ) ;
}
static int F_28 ( struct V_66 * V_29 ,
...
return - V_46 ;
V_5 -> V_29 = V_29 ;
strcpy ( F_29 ( V_29 ) , V_71 ) ;
strcpy ( F_30 ( V_29 ) , V_72 ) ;
V_29 -> V_73 = V_5 ;
F_22 ( & V_67 ) ;
V_34 = F_4 ( V_5 ) ;
if ( V_34 )
...
for ( V_6 = 0 ; V_6 < V_5 -> V_14 . V_20 ; V_6 ++ ) {
if ( V_5 -> V_14 . V_35 == V_5 -> V_14 . V_19 [ V_6 ] ) {
F_3 ( V_74 L_35 , V_5 -> V_14 . V_19 [ V_6 ] ) ;
V_70 = 1 ;
} else
F_3 ( V_74 L_36 , V_5 -> V_14 . V_19 [ V_6 ] ) ;
}
F_3 ( V_74 L_37 ) ;
if ( ! V_70 )
F_3 ( V_74 L_35 , V_5 -> V_14 . V_35 ) ;
if ( ! V_5 -> V_29 -> V_28 . V_38 )
F_3 ( V_74 L_38 ) ;
F_3 ( V_74 L_39 ) ;
F_31 ( & V_5 -> V_75 , & V_76 ) ;
V_37:
F_27 ( V_29 -> V_30 , L_33 , NULL , NULL ) ;
F_23 ( & V_67 ) ;
if ( V_34 )
F_15 ( V_5 ) ;
...
{
if ( V_5 -> V_60 && V_5 -> V_14 . V_35 && V_5 -> V_14 . V_59 )
...
static void F_34 ( struct V_66 * V_29 )
{
struct V_4 * V_5 ;
V_5 = F_21 ( V_29 ) ;
F_22 ( & V_67 ) ;
...
static int T_3 F_36 ( char * V_77 , int V_78 )
{
int V_6 ;
...
bool F_40 ( int V_14 )
{
return V_14 >= 0 && ( V_14 >= F_38 ( V_58 ) ||
V_58 [ V_14 ] < V_62 ) ;
}
void F_41 ( int V_14 , int V_82 , int V_22 )
{
if ( V_14 >= 0 && V_14 < F_38 ( V_58 ) ) {
if ( V_82 != V_83 ||
V_22 != V_84 )
...
static int T_3 F_42 ( char * V_77 )
{
return F_36 ( V_77 , 1 ) ;
}
static int T_3 F_43 ( char * V_77 )
{
return F_36 ( V_77 , 0 ) ;
}
static int T_3 F_44 ( char * V_77 )
{
V_61 = 0 ;
return 1 ;
}
static int T_3 F_45 ( char * V_77 )
{
V_61 = 1 ;
return 1 ;
}
