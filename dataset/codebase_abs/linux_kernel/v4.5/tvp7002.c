...
if ( ! V_94 )
return NULL ;
V_92 = F_34 ( & V_89 -> V_97 , sizeof( * V_92 ) , V_100 ) ;
if ( ! V_92 )
goto V_101;
F_35 ( V_94 , & V_91 ) ;
...
static int F_37 ( struct V_10 * V_11 , const struct V_114 * V_38 )
{
...
V_119 | V_120 ) )
return - V_121 ;
V_24 = F_34 ( & V_11 -> V_97 , sizeof( struct V_1 ) , V_100 ) ;
if ( ! V_24 )
return - V_122 ;
V_3 = & V_24 -> V_3 ;
V_24 -> V_92 = V_92 ;
...
error = F_43 ( & V_24 -> V_3 . V_131 , 1 , & V_24 -> V_75 ) ;
if ( error < 0 )
return error ;
#endif
F_44 ( & V_24 -> V_7 , 1 ) ;
