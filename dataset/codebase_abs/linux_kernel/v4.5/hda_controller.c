...
goto V_29;
do {
V_186 = F_100 ( V_3 , V_191 ) ;
if ( V_186 == 0 || V_186 == 0xffffffff )
break;
V_188 = true ;
V_187 = false ;
if ( F_128 ( V_55 , V_186 , F_122 ) )
V_187 = true ;
V_186 = F_129 ( V_3 , V_192 ) ;
if ( V_186 & V_193 ) {
V_187 = true ;
if ( V_186 & V_194 ) {
if ( V_3 -> V_50 & V_51 )
...
F_130 ( V_3 , V_192 , V_193 ) ;
}
} while ( V_187 && ++ V_189 < 10 );
V_29:
F_45 ( & V_55 -> V_72 ) ;
return F_131 ( V_188 ) ;
}
static int F_132 ( struct V_2 * V_3 , int V_138 )
{
unsigned int V_53 = ( V_138 << 28 ) | ( V_195 << 20 ) |
( V_196 << 8 ) | V_197 ;
struct V_54 * V_55 = F_3 ( V_3 ) ;
int V_35 ;
...
if ( ! V_3 -> V_202 )
return 0 ;
V_200 = V_3 -> V_202 [ V_3 -> V_203 ] ;
if ( V_200 == 0 )
return 0 ;
if ( V_200 < 50 || V_200 > 60000 )
V_201 = 0 ;
else
V_201 = F_87 ( V_200 ) ;
if ( V_201 == 0 )
...
int F_136 ( struct V_2 * V_3 , const char * V_204 ,
const struct V_205 * V_206 )
{
struct V_115 * V_55 = & V_3 -> V_55 ;
int V_35 ;
V_35 = F_137 ( & V_55 -> V_30 , V_3 -> V_47 -> V_48 , & V_207 ,
V_206 ) ;
if ( V_35 < 0 )
return V_35 ;
V_55 -> V_47 = V_3 -> V_47 ;
F_138 ( & V_55 -> V_208 ) ;
V_55 -> V_209 = V_3 -> V_209 ;
V_55 -> V_210 = V_204 ;
V_55 -> V_211 = - 1 ;
V_55 -> V_30 . V_212 = F_139 ( V_3 ) ;
if ( V_3 -> V_76 [ 0 ] != F_48 ||
V_3 -> V_76 [ 1 ] != F_48 )
V_55 -> V_30 . V_213 = true ;
V_55 -> V_30 . V_214 = V_3 -> V_214 ;
if ( V_3 -> V_50 & V_215 )
V_55 -> V_30 . V_216 = true ;
if ( V_3 -> V_50 & V_217 )
...
int F_140 ( struct V_2 * V_3 , unsigned int V_221 )
{
struct V_54 * V_55 = F_3 ( V_3 ) ;
...
if ( ( V_55 -> V_225 & ( 1 << V_222 ) ) & V_3 -> V_226 ) {
struct V_117 * V_19 ;
V_35 = F_141 ( & V_3 -> V_55 , V_3 -> V_47 , V_222 , & V_19 ) ;
if ( V_35 < 0 )
continue;
V_19 -> V_227 = F_135 ( V_3 ) ;
V_19 -> V_228 = V_3 -> V_228 ;
V_223 ++ ;
}
}
if ( ! V_223 ) {
F_33 ( V_3 -> V_47 -> V_48 , L_13 ) ;
return - V_229 ;
}
return 0 ;
}
...
{
struct V_117 * V_19 ;
F_143 (codec, &chip->bus) {
F_144 ( V_19 ) ;
}
return 0 ;
}
static int F_145 ( struct V_2 * V_3 , unsigned char V_71 )
{
if ( V_71 >= V_3 -> V_230 &&
...
int V_200 ;
int V_231 [ 2 ] = { 0 , 0 } ;
for ( V_200 = 0 ; V_200 < V_3 -> V_232 ; V_200 ++ ) {
struct V_1 * V_1 = F_80 ( sizeof( * V_1 ) , V_126 ) ;
int V_233 , V_234 ;
if ( ! V_1 )
return - V_127 ;
V_233 = F_145 ( V_3 , V_200 ) ;
if ( V_3 -> V_50 & V_235 )
V_234 = ++ V_231 [ V_233 ] ;
else
V_234 = V_200 + 1 ;
F_147 ( F_3 ( V_3 ) , F_7 ( V_1 ) ,
V_200 , V_233 , V_234 ) ;
}
return 0 ;
}
...
struct V_54 * V_55 = F_3 ( V_3 ) ;
struct V_6 * V_7 ;
while ( ! F_149 ( & V_55 -> V_236 ) ) {
V_7 = F_150 ( & V_55 -> V_236 , struct V_6 , V_114 ) ;
F_73 ( & V_7 -> V_114 ) ;
F_74 ( F_4 ( V_7 ) ) ;
}
}
