...
( V_13 -> V_68 == 0 ) )
return 0 ;
if ( V_13 -> V_69 < 2 || V_13 -> V_68 < 2 ) {
F_2 ( & V_13 -> V_70 -> V_7 , L_24 ) ;
return - V_8 ;
}
#define F_27 ( T_2 , T_3 ) \
do { \
...
int V_72 ;
if ( V_13 -> V_73 < 2 ) {
F_2 ( & V_13 -> V_70 -> V_7 , L_25 ) ;
return - V_8 ;
}
V_4 = V_13 -> V_4 [ 0 ] ;
V_4 -> V_74 =
V_13 -> V_4 [ 1 ] -> V_74 ;
V_71 = F_29 ( V_13 -> V_7 , V_4 -> V_74 ) ;
for ( V_72 = 0 ; V_72 < F_30 ( V_4 -> V_75 ) ; ++ V_72 )
V_4 -> V_75 [ V_72 ] -> V_71 = V_71 ;
return 0 ;
}
