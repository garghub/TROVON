...
V_73 = & V_65 -> V_73 ;
F_82 (desc, _desc, descs_list, desc_node) {
...
static void F_85 ( struct V_6 * V_19 )
{
struct V_15 * V_65 ;
struct V_16 * V_17 ;
V_65 = F_38 ( & V_19 -> V_70 , struct V_15 , V_69 ) ;
V_17 = & V_65 -> V_18 ;
if ( V_17 -> V_202 && ( V_17 -> V_116 & V_203 ) )
V_17 -> V_202 ( V_17 -> V_204 ) ;
}
...
F_18 () ;
F_82 (desc, _desc, &atchan->xfers_list, xfer_node)
F_83 ( V_19 , V_65 ) ;
F_98 ( V_22 , & V_19 -> V_21 ) ;
F_98 ( V_20 , & V_19 -> V_21 ) ;
F_30 ( & V_19 -> V_68 , V_116 ) ;
...
struct V_1 * V_2 = F_5 ( V_9 -> V_10 ) ;
struct V_15 * V_65 , * V_187 ;
F_82 (desc, _desc, &atchan->free_descs_list, desc_node) {
...
F_82 (chan, _chan, &atxdmac->dma.channels, device_node) {
struct V_6 * V_19 = F_2 ( V_9 ) ;
