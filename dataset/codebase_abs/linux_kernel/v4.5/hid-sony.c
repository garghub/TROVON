...
{
static const union V_128 V_129 = {
. V_74 = {
0x01 ,
...
struct V_130 * V_61 =
(struct V_130 * ) V_27 -> V_131 ;
int V_54 ;
memcpy ( V_61 , & V_129 , sizeof( struct V_130 ) ) ;
#ifdef F_55
V_61 -> V_132 . V_133 = V_27 -> V_134 ? 1 : 0 ;
V_61 -> V_132 . V_135 = V_27 -> V_136 ;
#endif
V_61 -> V_137 |= V_27 -> V_86 [ 0 ] << 1 ;
V_61 -> V_137 |= V_27 -> V_86 [ 1 ] << 2 ;
V_61 -> V_137 |= V_27 -> V_86 [ 2 ] << 3 ;
V_61 -> V_137 |= V_27 -> V_86 [ 3 ] << 4 ;
if ( ( V_61 -> V_137 & 0x1E ) == 0 )
V_61 -> V_137 |= 0x20 ;
for ( V_54 = 0 ; V_54 < 4 ; V_54 ++ ) {
if ( V_27 -> V_105 [ V_54 ] || V_27 -> V_106 [ V_54 ] ) {
V_61 -> V_95 [ 3 - V_54 ] . V_138 = V_27 -> V_106 [ V_54 ] ;
V_61 -> V_95 [ 3 - V_54 ] . V_139 = V_27 -> V_105 [ V_54 ] ;
}
}
F_29 ( V_27 -> V_2 , V_61 -> V_140 , ( T_1 * ) V_61 ,
sizeof( struct V_130 ) ,
V_91 , V_80 ) ;
}
...
struct V_1 * V_2 = V_27 -> V_2 ;
struct V_143 * V_61 =
(struct V_143 * ) V_27 -> V_131 ;
memset ( V_61 , 0 , V_144 ) ;
V_61 -> type = 0x02 ;
V_61 -> V_145 = V_27 -> V_86 [ 0 ] ;
V_61 -> V_146 = V_27 -> V_86 [ 1 ] ;
V_61 -> V_147 = V_27 -> V_86 [ 2 ] ;
#ifdef F_55
V_61 -> V_132 = V_16 ( V_27 -> V_134 , V_27 -> V_136 ) ;
#endif
F_30 ( V_2 , ( T_1 * ) V_61 , V_144 ) ;
}
...
{
struct V_26 * V_27 = F_60 ( V_150 , struct V_26 , V_93 ) ;
V_27 -> V_148 ( V_27 ) ;
}
...
( V_27 -> V_28 & V_36 ) )
V_27 -> V_131 =
F_28 ( sizeof( union V_128 ) ,
V_75 ) ;
else if ( V_27 -> V_28 & V_32 )
V_27 -> V_131 = F_28 ( V_142 ,
V_75 ) ;
else if ( V_27 -> V_28 & V_30 )
V_27 -> V_131 = F_28 ( V_141 ,
V_75 ) ;
else if ( V_27 -> V_28 & V_35 )
V_27 -> V_131 = F_28 ( V_144 ,
V_75 ) ;
else
return 0 ;
if ( ! V_27 -> V_131 )
...
static int F_62 ( struct V_52 * V_98 , void * V_151 ,
struct V_152 * V_153 )
{
struct V_1 * V_18 = F_63 ( V_98 ) ;
struct V_26 * V_27 = F_9 ( V_18 ) ;
if ( V_153 -> type != V_154 )
return 0 ;
V_27 -> V_136 = V_153 -> V_155 . V_132 . V_156 / 256 ;
V_27 -> V_134 = V_153 -> V_155 . V_132 . V_157 / 256 ;
F_41 ( & V_27 -> V_93 ) ;
return 0 ;
}
...
struct V_9 , V_51 ) ;
struct V_52 * V_52 = V_48 -> V_53 ;
F_65 ( V_52 , V_158 , V_154 ) ;
return F_66 ( V_52 , NULL , F_62 ) ;
}
static int F_64 ( struct V_26 * V_27 )
{
return 0 ;
...
{
struct V_174 V_175 = { . V_100 = V_27 , } ;
struct V_1 * V_2 = V_27 -> V_2 ;
int V_69 ;
V_27 -> V_44 = 100 ;
V_27 -> V_176 . V_177 = V_178 ;
V_27 -> V_176 . V_179 = F_6 ( V_178 ) ;
V_27 -> V_176 . V_180 = F_67 ;
V_27 -> V_176 . type = V_181 ;
V_27 -> V_176 . V_182 = 0 ;
V_27 -> V_176 . V_115 = F_70 ( V_75 ,
L_20 ,
V_27 -> V_183 ) ;
if ( ! V_27 -> V_176 . V_115 )
return - V_76 ;
V_27 -> V_184 = F_71 ( & V_2 -> V_98 , & V_27 -> V_176 ,
& V_175 ) ;
if ( F_72 ( V_27 -> V_184 ) ) {
V_69 = F_73 ( V_27 -> V_184 ) ;
F_26 ( V_2 , L_21 ) ;
goto V_185;
}
F_74 ( V_27 -> V_184 , & V_2 -> V_98 ) ;
return 0 ;
V_185:
F_31 ( V_27 -> V_176 . V_115 ) ;
V_27 -> V_176 . V_115 = NULL ;
return V_69 ;
}
...
V_69 = memcmp ( V_27 -> V_183 , V_186 -> V_183 ,
sizeof( V_27 -> V_183 ) ) ;
if ( ! V_69 ) {
V_69 = - V_188 ;
F_10 ( V_27 -> V_2 , L_22 ,
...
{
int V_69 ;
V_69 = strlen ( V_27 -> V_2 -> V_192 ) ;
if ( V_69 != 17 )
return - V_62 ;
V_69 = sscanf ( V_27 -> V_2 -> V_192 ,
L_23 ,
& V_27 -> V_183 [ 5 ] , & V_27 -> V_183 [ 4 ] , & V_27 -> V_183 [ 3 ] ,
& V_27 -> V_183 [ 2 ] , & V_27 -> V_183 [ 1 ] , & V_27 -> V_183 [ 0 ] ) ;
if ( V_69 != 6 )
return - V_62 ;
return 0 ;
}
...
memcpy ( V_27 -> V_183 , & V_74 [ 1 ] , sizeof( V_27 -> V_183 ) ) ;
...
{
if ( V_27 -> V_84 >= 0 ) {
F_88 ( & V_198 , V_27 -> V_84 ) ;
V_27 -> V_84 = - 1 ;
}
}
static inline void F_89 ( struct V_26 * V_27 ,
void (* V_148)( struct V_26 * ) )
{
V_27 -> V_148 = V_148 ;
if ( ! V_27 -> V_199 )
F_90 ( & V_27 -> V_93 , F_59 ) ;
...
static int F_93 ( struct V_1 * V_2 , const struct V_200 * V_83 )
{
int V_69 ;
unsigned long V_28 = V_83 -> V_201 ;
struct V_26 * V_27 ;
unsigned int V_202 = V_203 ;
V_27 = F_94 ( & V_2 -> V_98 , sizeof( * V_27 ) , V_75 ) ;
if ( V_27 == NULL ) {
F_26 ( V_2 , L_27 ) ;
return - V_76 ;
}
...
static int F_103 ( struct V_1 * V_2 , T_6 V_211 )
{
if ( V_112 || V_209 ) {
struct V_26 * V_27 = F_9 ( V_2 ) ;
#ifdef F_55
V_27 -> V_136 = V_27 -> V_134 = 0 ;
#endif
memcpy ( V_27 -> V_212 , V_27 -> V_86 ,
sizeof( V_27 -> V_212 ) ) ;
memset ( V_27 -> V_86 , 0 , sizeof( V_27 -> V_86 ) ) ;
F_58 ( V_27 ) ;
}
return 0 ;
}
