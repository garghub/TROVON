...
struct V_65 * F_40 ( struct V_55 * V_56 ,
unsigned V_10 )
{
struct V_1 * V_1 = F_34 ( V_56 ) ;
int V_66 ;
...
V_85 ++ ;
V_85 *= V_64 ;
V_89 = F_50 ( V_56 , V_81 , V_82 , V_83 ,
V_85 ) ;
if ( V_89 < 0 )
goto exit;
for ( V_66 = 0 ; V_66 < V_64 ; V_66 ++ ) {
const char * V_91 , * V_92 ;
V_89 = F_51 ( V_69 , L_2 , V_66 , & V_70 ) ;
if ( V_89 )
goto exit;
...
static const char * F_59 ( struct V_55 * V_56 ,
unsigned V_61 )
{
return V_74 [ V_61 ] ;
}
...
T_2 V_59 ;
F_62 ( V_56 -> V_43 , L_6 ,
V_74 [ V_98 ] , V_1 -> V_62 [ V_91 ] . V_63 ) ;
V_10 = V_1 -> V_62 [ V_91 ] . V_10 ;
V_59 = F_33 ( V_56 , V_10 ) ;
V_59 &= ( ~ V_99 ) ;
V_59 |= ( V_98 & V_99 ) ;
F_62 ( V_56 -> V_43 , L_7 , V_10 , V_59 ) ;
F_36 ( V_56 , V_10 , V_59 ) ;
return 0 ;
}
...
{
struct V_1 * V_1 = F_34 ( V_56 ) ;
unsigned V_101 = F_64 ( * V_100 ) , V_102 = 0 ;
struct V_65 * V_67 = V_1 -> V_62 + V_91 ;
unsigned V_57 = V_67 -> V_10 ;
T_2 V_103 ;
V_103 = F_33 ( V_56 , V_57 ) ;
switch ( V_101 ) {
case V_104 :
if ( ! ( V_103 & V_105 ) )
return - V_29 ;
...
unsigned V_101 = F_64 ( V_86 [ V_66 ] ) ;
unsigned V_102 = F_67 ( V_86 [ V_66 ] ) ;
F_62 ( V_56 -> V_43 , L_8 ,
V_115 , V_57 , V_86 [ V_66 ] ) ;
switch ( V_101 ) {
case V_108 :
V_59 &= ( ~ V_105 ) ;
V_59 &= ( ~ V_107 ) ;
...
F_62 ( V_56 -> V_43 , L_10 , V_115 , V_59 ) ;
F_36 ( V_56 , V_57 , V_59 ) ;
return 0 ;
}
static void F_69 ( struct V_55 * V_56 ,
struct V_120 * V_121 , unsigned V_57 )
{
struct V_1 * V_1 = F_34 ( V_56 ) ;
T_2 V_59 ;
...
V_59 = F_33 ( V_56 , V_57 ) ;
if ( V_59 & V_105 )
F_70 ( V_121 , L_12 , L_13 ) ;
if ( V_59 & V_107 )
F_70 ( V_121 , L_12 , L_14 ) ;
if ( V_59 & V_117 )
F_70 ( V_121 , L_12 , L_15 ) ;
if ( V_59 & V_110 )
F_70 ( V_121 , L_12 , L_16 ) ;
if ( V_59 & V_112 )
F_70 ( V_121 , L_12 , L_17 ) ;
}
static int F_71 ( struct V_79 * V_43 )
{
struct V_122 * V_123 = F_72 ( V_43 ) ;
struct V_1 * V_1 = F_73 ( V_123 ) ;
int V_66 ;
...
static int F_74 ( struct V_79 * V_43 )
{
struct V_122 * V_123 = F_72 ( V_43 ) ;
struct V_1 * V_1 = F_73 ( V_123 ) ;
int V_66 ;
...
struct V_1 * V_1 ;
struct V_130 * V_130 ;
V_1 = F_76 ( V_43 , sizeof( * V_1 ) , V_131 ) ;
if ( ! V_1 )
return - V_132 ;
V_1 -> V_43 = V_43 ;
V_1 -> V_78 = V_43 -> V_133 ;
F_77 ( V_123 , V_1 ) ;
V_128 = F_78 ( V_134 , V_43 -> V_133 ) ;
if ( ! V_128 ) {
F_20 ( V_43 , L_18 ) ;
return - V_135 ;
}
V_130 = (struct V_130 * ) V_128 -> V_136 ;
V_1 -> V_42 = V_130 -> V_42 ;
V_1 -> V_60 = V_1 -> V_42 * V_46 ;
V_103 = F_79 ( V_123 , V_137 , 0 ) ;
if ( ! V_103 ) {
F_20 ( V_43 , L_19 ) ;
return - V_29 ;
}
V_1 -> V_4 = F_80 ( V_43 , V_103 ) ;
if ( F_81 ( V_1 -> V_4 ) )
return - V_29 ;
V_1 -> V_138 = F_82 ( V_43 , NULL ) ;
if ( F_81 ( V_1 -> V_138 ) ) {
F_20 ( V_43 , L_20 ) ;
return F_83 ( V_1 -> V_138 ) ;
}
V_1 -> V_11 = F_76 ( V_43 , sizeof( * V_1 -> V_11 )
* V_1 -> V_60 , V_131 ) ;
if ( ! V_1 -> V_11 )
return - V_132 ;
V_126 = F_76 ( V_43 , sizeof( * V_126 )
* V_1 -> V_60 , V_131 ) ;
if ( ! V_126 )
return - V_132 ;
V_139 . V_11 = V_126 ;
V_139 . V_60 = V_1 -> V_60 ;
V_97 = F_76 ( V_43 , sizeof( * V_97 )
* V_1 -> V_60 , V_131 ) ;
if ( ! V_97 )
return - V_132 ;
V_1 -> V_97 = V_97 ;
V_1 -> V_62 = F_76 ( & V_123 -> V_43 ,
...
V_1 -> V_11 [ V_66 ] = F_76 ( V_43 ,
sizeof( * * V_1 -> V_11 ) , V_131 ) ;
if ( ! V_1 -> V_11 [ V_66 ] )
return - V_132 ;
V_1 -> V_11 [ V_66 ] -> V_57 = V_66 ;
V_1 -> V_11 [ V_66 ] -> V_2 = V_2 ;
V_1 -> V_11 [ V_66 ] -> line = line ;
V_126 [ V_66 ] . V_140 = V_66 ;
V_126 [ V_66 ] . V_63 = F_84 ( V_131 , L_21 ,
V_2 + 'A' , line ) ;
V_91 -> V_63 = V_97 [ V_66 ] = V_126 [ V_66 ] . V_63 ;
V_91 -> V_10 = V_126 [ V_66 ] . V_140 ;
F_62 ( V_43 , L_22 , V_66 , V_2 , line ) ;
}
V_1 -> V_47 = & V_141 ;
V_1 -> V_47 -> V_133 = V_43 -> V_133 ;
V_1 -> V_47 -> V_142 = V_1 -> V_60 ;
V_1 -> V_47 -> V_143 = F_85 ( V_43 ) ;
V_1 -> V_47 -> V_77 = V_43 ;
V_1 -> V_47 -> V_144 = V_1 -> V_97 ;
V_1 -> V_34 = F_76 ( V_43 ,
sizeof( * V_1 -> V_34 )
* V_1 -> V_42 , V_131 ) ;
if ( ! V_1 -> V_34 )
...
if ( ! V_1 -> V_124 )
return - V_132 ;
V_1 -> V_33 = F_76 ( V_43 , sizeof( * V_1 -> V_33 )
* V_1 -> V_42 , V_131 ) ;
if ( ! V_1 -> V_33 )
return - V_132 ;
for ( V_66 = 0 ; V_66 < V_1 -> V_42 ; V_66 ++ ) {
V_103 = F_79 ( V_123 , V_145 , V_66 ) ;
if ( ! V_103 ) {
F_20 ( V_43 , L_23 ,
'A' + V_66 ) ;
return - V_29 ;
}
V_1 -> V_33 [ V_66 ] = V_103 -> V_146 ;
F_86 ( V_103 -> V_146 , F_16 ) ;
F_87 ( V_103 -> V_146 , V_1 ) ;
F_62 ( V_43 , L_24 , V_66 , V_103 ) ;
}
V_1 -> V_54 = F_88 ( V_43 -> V_133 ,
V_1 -> V_47 -> V_142 ,
& V_147 , NULL ) ;
if ( ! V_1 -> V_54 ) {
F_20 ( V_43 , L_25 ) ;
...
V_89 = F_94 ( V_1 -> V_47 , V_1 ) ;
if ( V_89 ) {
F_20 ( V_43 , L_30 ) ;
goto V_152;
}
V_89 = F_95 ( V_1 -> V_47 , F_85 ( V_43 ) ,
0 , 0 , V_1 -> V_47 -> V_142 ) ;
if ( V_89 ) {
F_20 ( V_43 , L_31 ) ;
goto V_153;
}
F_96 ( & V_123 -> V_43 , L_32 ) ;
return 0 ;
V_150:
F_97 ( V_1 -> V_54 ) ;
V_151:
