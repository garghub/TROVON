...
V_85 = F_96 ( & V_244 -> V_136 , V_80 , F_15 , 0 , L_34 , V_6 ) ;
if ( V_85 ) {
...
static int F_100 ( struct V_276 * V_136 )
{
...
static int F_102 ( struct V_276 * V_136 )
{
struct V_104 * V_127 = F_26 ( V_136 ) ;
struct V_5 * V_6 = F_30 ( V_127 ,
struct V_5 , V_127 ) ;
return F_103 ( V_6 -> V_265 ) ;
}
