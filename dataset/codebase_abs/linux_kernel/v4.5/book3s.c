...
int V_230 ;
int V_231 ;
if ( ! F_129 ( V_227 ) || ( V_227 > sizeof( V_229 ) ) )
return V_232 ;
V_230 = F_130 ( & V_2 -> V_9 -> V_233 ) ;
V_231 = F_131 ( V_2 , V_234 , V_228 , V_227 , & V_229 ) ;
F_132 ( & V_2 -> V_9 -> V_233 , V_230 ) ;
if ( V_231 != 0 )
return V_232 ;
switch ( V_227 ) {
case 1 :
...
break;
case 2 :
F_84 ( V_2 , 4 , F_133 ( * ( V_236 * ) & V_229 ) ) ;
break;
case 4 :
F_84 ( V_2 , 4 , F_134 ( * ( V_237 * ) & V_229 ) ) ;
break;
case 8 :
F_84 ( V_2 , 4 , F_135 ( * ( V_238 * ) & V_229 ) ) ;
break;
default:
F_136 () ;
}
...
break;
case 2 :
* ( V_236 * ) & V_229 = F_138 ( V_148 ) ;
break;
case 4 :
* ( V_237 * ) & V_229 = F_139 ( V_148 ) ;
break;
case 8 :
* ( V_238 * ) & V_229 = F_140 ( V_148 ) ;
break;
default:
return V_232 ;
}
V_230 = F_130 ( & V_2 -> V_9 -> V_233 ) ;
V_231 = F_141 ( V_2 , V_234 , V_228 , V_227 , & V_229 ) ;
F_132 ( & V_2 -> V_9 -> V_233 , V_230 ) ;
if ( V_231 != 0 )
return V_232 ;
return V_239 ;
...
int F_143 ( struct V_9 * V_9 , unsigned long V_240 )
{
...
{
int V_106 ;
V_106 = F_145 ( NULL , sizeof( struct V_1 ) , 0 , V_242 ) ;
if ( V_106 )
return V_106 ;
#ifdef F_146
V_106 = F_147 () ;
