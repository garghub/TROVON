...
T_9 V_54 ( V_55 ) ;
error = F_28 ( V_8 , V_37 -> V_15 , V_40 , & V_55 ) ;
if ( error )
return error ;
...
F_30 ( V_37 -> V_56 , V_8 -> V_43 . V_44 ) ;
V_42 = V_37 -> V_56 ;
V_37 -> V_50 = V_40 ;
if ( ( error = F_31 ( V_37 -> V_15 , V_37 -> V_56 , 1 , V_37 -> V_50 ,
& V_40 , V_38 , V_37 -> V_59 , V_39 , & V_42 ) ) )
return error ;
if ( V_42 == V_60 && V_39 > 1 &&
( error = F_31 ( V_37 -> V_15 , V_37 -> V_56 , 1 ,
V_37 -> V_50 , & V_40 , V_38 ,
V_37 -> V_59 , 1 , & V_42 ) ) )
return error ;
V_37 -> V_56 = V_42 ;
...
struct V_71 V_72 ;
int error ;
error = F_35 ( NULL , V_2 , V_70 , & V_72 , V_47 ) ;
if ( error || * V_47 )
return error ;
...
int V_77 ;
error = F_43 ( V_8 , V_15 , V_88 , 0 , & V_84 , V_91 ,
& V_92 ) ;
if ( error )
return error ;
* V_78 += 1 ;
...
* V_78 += 1 ;
V_90 = F_44 ( V_85 ) ;
V_89 = F_45 ( V_90 -> V_93 . V_94 . V_95 ) ;
F_46 ( V_15 , V_85 ) ;
}
V_87 = F_47 ( V_8 , V_10 , 1 , V_8 -> V_96 [ 1 ] ) ;
V_88 = F_45 ( * V_87 ) ;
if ( F_48 ( ( error =
F_42 ( V_8 , V_15 , V_75 , V_88 , V_86 , V_78 ) ) < 0 ) ) {
F_46 ( V_15 , V_84 ) ;
F_49 ( L_1 ,
V_97 , V_8 ) ;
return - V_33 ;
...
V_89 = F_45 ( V_10 -> V_93 . V_94 . V_95 ) ;
V_77 = F_50 ( V_10 -> V_98 ) ;
F_39 ( V_8 , V_10 , V_77 , V_78 ) ;
F_46 ( V_15 , V_84 ) ;
if ( V_89 == V_60 )
break;
V_88 = V_89 ;
error = F_43 ( V_8 , V_15 , V_88 , 0 , & V_84 ,
V_91 ,
& V_92 ) ;
if ( error )
return error ;
...
V_10 = V_75 -> V_102 ;
V_86 = F_50 ( V_10 -> V_103 ) ;
ASSERT ( V_86 > 0 ) ;
V_87 = F_54 ( V_8 , V_10 , 1 , V_75 -> V_104 ) ;
V_88 = F_45 ( * V_87 ) ;
ASSERT ( V_88 != V_60 ) ;
ASSERT ( F_55 ( V_8 , V_88 ) < V_8 -> V_43 . V_105 ) ;
ASSERT ( F_56 ( V_8 , V_88 ) < V_8 -> V_43 . V_106 ) ;
if ( F_48 ( F_42 ( V_8 , V_15 , V_75 , V_88 , V_86 , V_78 ) < 0 ) ) {
F_49 ( L_2 , V_97 ,
V_8 ) ;
return - V_33 ;
}
...
V_8 = V_2 -> V_4 ;
V_108 -> V_116 = - 1 ;
V_112 = F_3 ( V_8 , F_58 ( V_8 , F_59 ( V_2 ) ) ) ;
V_112 -= V_108 -> V_117 ;
...
V_114 = F_60 ( V_2 -> V_4 , V_108 -> V_117 ) ;
V_75 = F_52 ( V_2 , V_120 ) ;
if ( F_61 ( V_75 , V_114 , & V_113 ) &&
...
if ( V_123 -> V_118 == - 1 ) {
V_112 = F_3 ( V_8 , F_58 ( V_8 , V_112 ) ) ;
V_123 -> V_118 =
F_64 ( T_19 , V_112 - V_123 -> V_117 , 0 ) ;
...
return - V_152 ;
V_108 = F_65 ( V_123 -> V_150 * sizeof( struct V_107 ) , 0 ) ;
if ( ! V_108 )
return - V_152 ;
F_26 ( V_2 , V_153 ) ;
if ( V_70 == V_120 ) {
if ( ! ( V_134 & V_154 ) &&
( V_2 -> V_64 || F_59 ( V_2 ) > V_2 -> V_61 . V_155 ) ) {
error = F_66 ( F_9 ( V_2 ) -> V_156 ) ;
if ( error )
goto V_157;
}
V_128 = F_67 ( V_2 ) ;
...
if ( V_130 > F_69 ( V_2 , V_70 ) * 2 + 1 )
V_130 = F_69 ( V_2 , V_70 ) * 2 + 1 ;
V_135 = F_70 ( V_70 ) ;
if ( ! ( V_134 & V_158 ) )
V_135 |= V_159 ;
error = - V_152 ;
V_132 = 16 ;
V_129 = F_71 ( V_132 * sizeof( * V_129 ) , V_160 | V_161 ) ;
if ( ! V_129 )
goto V_162;
V_123 -> V_149 = 0 ;
if ( F_69 ( V_2 , V_70 ) == 0 &&
...
error = F_72 ( V_2 , F_6 ( V_8 , V_123 -> V_117 ) ,
F_60 ( V_8 , V_123 -> V_118 ) ,
V_129 , & V_133 , V_135 ) ;
if ( error )
goto V_163;
ASSERT ( V_133 <= V_132 ) ;
...
V_129 [ V_127 ] . V_73 <= F_58 ( V_8 , F_59 ( V_2 ) ) )
...
T_2 V_177 ;
T_22 V_17 ;
error = F_72 ( V_2 , V_5 , 1 , & V_175 , & V_176 ,
V_178 ) ;
if ( error ) {
if ( ! F_77 ( V_2 -> V_4 ) ) {
F_78 ( V_2 -> V_4 ,
...
F_79 ( V_175 . V_74 == 0 ) ;
F_80 ( & V_17 , & V_177 ) ;
error = F_81 ( NULL , V_2 , V_5 , 1 , 0 , 1 , & V_177 ,
& V_17 , & V_174 ) ;
if ( error )
break;
...
bool
F_82 ( struct V_1 * V_2 , bool V_181 )
{
if ( ! F_83 ( V_2 -> V_61 . V_182 ) )
return false ;
if ( F_9 ( V_2 ) -> V_183 == 0 &&
...
int V_176 ;
T_21 V_175 ;
V_189 = F_58 ( V_8 , ( V_192 ) F_59 ( V_2 ) ) ;
V_190 = F_58 ( V_8 , V_8 -> V_12 -> V_148 ) ;
if ( V_190 <= V_189 )
return 0 ;
V_191 = V_190 - V_189 ;
V_176 = 1 ;
F_26 ( V_2 , V_193 ) ;
error = F_72 ( V_2 , V_189 , V_191 , & V_175 , & V_176 , 0 ) ;
F_74 ( V_2 , V_193 ) ;
if ( ! error && ( V_176 != 0 ) &&
( V_175 . V_167 != V_115 ||
V_2 -> V_64 ) ) {
...
error = F_89 ( V_15 , & F_90 ( V_8 ) -> V_197 , 0 , 0 ) ;
if ( error ) {
ASSERT ( F_77 ( V_8 ) ) ;
F_88 ( V_15 ) ;
if ( V_188 )
...
V_215 *= V_202 ;
V_216 = V_204 + V_201 ;
if ( ( V_203 = F_25 ( V_204 , V_202 ) ) )
V_216 += V_203 ;
if ( ( V_203 = F_25 ( V_216 , V_202 ) ) )
V_216 += V_202 - V_203 ;
} else {
V_215 = 0 ;
V_216 = V_201 ;
}
V_212 = F_97 ( T_10 , ( V_216 - V_215 ) , ( V_51 * V_176 ) ) ;
if ( F_48 ( V_207 ) ) {
V_213 = V_211 = V_212 ;
V_213 /= V_8 -> V_43 . V_44 ;
V_212 = F_98 ( V_8 , 0 ) ;
...
V_213 = 0 ;
V_212 = V_211 = F_98 ( V_8 , V_212 ) ;
V_206 = V_218 ;
}
V_15 = F_86 ( V_8 , V_219 ) ;
error = F_89 ( V_15 , & F_90 ( V_8 ) -> V_220 ,
V_212 , V_213 ) ;
if ( error ) {
ASSERT ( error == - V_221 || F_77 ( V_8 ) ) ;
F_88 ( V_15 ) ;
break;
}
F_26 ( V_2 , V_53 ) ;
error = F_99 ( V_15 , V_2 , V_211 ,
0 , V_206 ) ;
if ( error )
goto V_222;
F_27 ( V_15 , V_2 , 0 ) ;
F_80 ( & V_210 , & V_205 ) ;
error = F_100 ( V_15 , V_2 , V_204 ,
V_201 , V_199 , & V_205 ,
V_212 , V_209 , & V_176 , & V_210 ) ;
if ( error )
goto V_223;
error = F_13 ( & V_15 , & V_210 , NULL ) ;
if ( error )
goto V_223;
error = F_92 ( V_15 ) ;
F_74 ( V_2 , V_53 ) ;
...
V_223:
F_101 ( & V_210 ) ;
F_102 ( V_15 , V_2 , ( long ) V_211 , 0 , V_206 ) ;
V_222:
F_88 ( V_15 ) ;
F_74 ( V_2 , V_53 ) ;
return error ;
...
V_227 = 1 ;
V_228 = F_67 ( V_2 ) ;
error = F_72 ( V_2 , V_225 , 1 , & V_175 , & V_227 , 0 ) ;
F_74 ( V_2 , V_228 ) ;
if ( error || V_227 < 1 )
break;
ASSERT ( V_175 . V_74 >= 1 ) ;
...
V_207 = F_2 ( V_2 ) ;
V_204 = F_58 ( V_8 , V_49 ) ;
V_234 = F_96 ( V_8 , V_49 + V_198 ) ;
F_111 ( F_9 ( V_2 ) ) ;
V_238 = F_64 ( T_3 , 1 << V_8 -> V_43 . V_239 , V_240 ) ;
V_235 = F_112 ( V_49 , V_238 ) ;
V_236 = F_113 ( V_49 + V_198 , V_238 ) - 1 ;
error = F_114 ( F_9 ( V_2 ) -> V_156 , V_235 ,
V_236 ) ;
if ( error )
goto V_108;
F_115 ( F_9 ( V_2 ) , V_235 , V_236 ) ;
if ( V_207 && ! F_116 ( & V_8 -> V_43 ) ) {
V_227 = 1 ;
error = F_72 ( V_2 , V_204 , 1 ,
& V_175 , & V_227 , 0 ) ;
if ( error )
goto V_108;
...
ASSERT ( V_175 . V_167 != V_119 ) ;
V_10 = V_175 . V_167 ;
V_237 = F_30 ( V_10 , V_8 -> V_43 . V_44 ) ;
if ( V_237 )
V_204 += V_8 -> V_43 . V_44 - V_237 ;
}
V_227 = 1 ;
error = F_72 ( V_2 , V_234 - 1 , 1 ,
& V_175 , & V_227 , 0 ) ;
if ( error )
goto V_108;
ASSERT ( V_227 == 0 || V_227 == 1 ) ;
...
error = F_103 ( V_2 , V_49 , V_49 + V_198 - 1 ) ;
else {
...
while ( ! error && ! V_174 ) {
V_15 = F_86 ( V_8 , V_219 ) ;
error = F_89 ( V_15 , & F_90 ( V_8 ) -> V_220 , V_212 , 0 ) ;
if ( error ) {
ASSERT ( error == - V_221 || F_77 ( V_8 ) ) ;
F_88 ( V_15 ) ;
break;
...
error = F_109 ( V_2 , V_49 , V_198 ) ;
if ( error )
goto V_108;
error = F_94 ( V_2 , F_112 ( V_49 , V_244 ) ,
F_113 ( V_49 + V_198 , V_244 ) -
F_112 ( V_49 , V_244 ) ,
V_245 ) ;
V_108:
return error ;
...
if ( V_247 == V_252 ) {
V_250 = F_58 ( V_8 , V_49 + V_198 ) ;
V_249 = F_58 ( V_8 , F_9 ( V_2 ) -> V_183 ) ;
} else {
V_250 = V_60 ;
V_249 = F_58 ( V_8 , V_49 ) ;
}
V_251 = F_58 ( V_8 , V_198 ) ;
if ( F_82 ( V_2 , true ) ) {
error = F_84 ( V_8 , V_2 , false ) ;
if ( error )
return error ;
}
error = F_114 ( F_9 ( V_2 ) -> V_156 ,
V_49 , - 1 ) ;
if ( error )
return error ;
error = F_121 ( F_9 ( V_2 ) -> V_156 ,
V_49 >> V_254 , - 1 ) ;
if ( error )
return error ;
if ( V_247 == V_253 ) {
error = F_122 ( V_2 , V_249 ) ;
if ( error )
return error ;
}
while ( ! error && ! V_174 ) {
...
F_26 ( V_2 , V_53 ) ;
error = F_117 ( V_15 , V_8 , V_2 -> V_241 ,
V_2 -> V_242 , V_2 -> V_243 ,
F_98 ( V_8 , 0 ) , 0 ,
V_218 ) ;
if ( error )
...
F_27 ( V_15 , V_2 , V_53 ) ;
F_80 ( & V_210 , & V_248 ) ;
error = F_123 ( V_15 , V_2 , & V_250 , V_251 ,
...
{
int error ;
ASSERT ( F_76 ( V_2 , V_195 ) ) ;
F_125 ( V_2 ) ;
error = F_109 ( V_2 , V_49 , V_198 ) ;
if ( error )
return error ;
return F_120 ( V_2 , V_49 , V_198 , V_252 ) ;
}
int
F_126 (
struct V_1 * V_2 ,
...
ASSERT ( F_76 ( V_2 , V_195 ) ) ;
F_127 ( V_2 ) ;
return F_120 ( V_2 , V_49 , V_198 , V_253 ) ;
}
static int
F_128 (
T_18 * V_2 ,
...
if ( F_130 ( V_2 ) &&
F_131 ( V_258 -> V_185 . V_102 ) > F_130 ( V_2 ) )
return - V_143 ;
if ( F_69 ( V_258 , V_120 ) <=
F_129 ( V_2 , V_120 ) )
return - V_143 ;
...
if ( F_130 ( V_258 ) &&
F_131 ( V_2 -> V_185 . V_102 ) > F_130 ( V_258 ) )
return - V_143 ;
if ( F_69 ( V_2 , V_120 ) <=
F_129 ( V_258 , V_120 ) )
return - V_143 ;
...
T_27 V_269 ;
int V_270 ;
V_263 = F_71 ( sizeof( T_11 ) , V_160 ) ;
if ( ! V_263 ) {
error = - V_152 ;
goto V_108;
}
V_270 = V_195 | V_271 ;
F_134 ( V_2 , V_258 , V_195 ) ;
F_134 ( V_2 , V_258 , V_271 ) ;
...
goto V_273;
V_15 = F_86 ( V_8 , V_274 ) ;
error = F_89 ( V_15 , & F_90 ( V_8 ) -> V_275 , 0 , 0 ) ;
if ( error ) {
F_88 ( V_15 ) ;
goto V_273;
}
F_134 ( V_2 , V_258 , V_53 ) ;
V_270 |= V_53 ;
F_27 ( V_15 , V_2 , V_270 ) ;
F_27 ( V_15 , V_258 , V_270 ) ;
if ( V_260 -> V_276 != 0 ||
...
if ( ( ( F_63 ( V_2 ) != 0 ) && ( V_2 -> V_61 . V_287 > 0 ) ) &&
( V_2 -> V_61 . V_140 != V_142 ) ) {
error = F_51 ( V_15 , V_2 , V_139 , & V_267 ) ;
if ( error )
goto V_255;
}
if ( ( ( F_63 ( V_258 ) != 0 ) && ( V_258 -> V_61 . V_287 > 0 ) ) &&
( V_258 -> V_61 . V_140 != V_142 ) ) {
error = F_51 ( V_15 , V_258 , V_139 ,
& V_268 ) ;
if ( error )
goto V_255;
}
