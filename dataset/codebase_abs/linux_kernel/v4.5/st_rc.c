...
const char * V_58 ;
V_1 = F_28 ( V_10 , sizeof( struct V_9 ) , V_59 ) ;
if ( ! V_1 )
return - V_60 ;
V_2 = F_29 () ;
if ( ! V_2 )
return - V_60 ;
if ( V_56 && ! F_30 ( V_56 , L_2 , & V_58 ) ) {
if ( ! strcmp ( V_58 , L_3 ) ) {
V_1 -> V_61 = true ;
...
V_54 = F_36 ( V_45 , V_63 , 0 ) ;
V_1 -> V_41 = F_37 ( V_10 , V_54 ) ;
if ( F_33 ( V_1 -> V_41 ) ) {
V_50 = F_34 ( V_1 -> V_41 ) ;
goto V_62;
}
...
static int F_44 ( struct V_52 * V_10 )
{
struct V_9 * V_1 = F_45 ( V_10 ) ;
if ( F_46 ( V_10 ) ) {
if ( ! F_47 ( V_1 -> V_5 ) )
V_1 -> V_13 = 1 ;
else
...
static int F_50 ( struct V_52 * V_10 )
{
struct V_9 * V_1 = F_45 ( V_10 ) ;
