...
struct V_143 * V_144 =
F_118 ( V_8 , V_144 ) ;
int V_145 = F_118 ( V_8 , V_145 ) ;
int V_146 , V_33 , V_32 ;
V_146 = V_147 ;
for ( V_32 = 0 ; V_32 < V_145 ; V_32 ++ ) {
V_33 = ( V_144 [ V_32 ] . type == V_146 ) ;
V_146 = V_144 [ V_32 ] . type ;
if ( V_147 == V_144 [ V_32 ] . type ) {
V_21 = F_119 ( V_8 ) ;
F_120 ( V_3 ) = V_21 ;
} else {
V_21 = F_121 ( V_8 ,
...
struct V_2 * V_3 = F_67 ( V_8 ) ;
struct V_44 * V_45 = F_55 ( V_3 ) ;
struct V_149 * V_12 = F_123 ( V_8 ) ;
struct V_9 * V_10 = F_3 ( V_8 ) ;
int V_34 ;
V_34 = F_124 ( V_45 , 0 , 0 ) ;
if ( V_34 < 0 )
return 0 ;
F_125 ( V_45 -> V_48 . V_150 ) ;
F_126 ( V_8 ) ;
F_127 ( V_8 ,
F_88 ) ;
F_117 ( V_8 ) ;
...
V_45 -> V_156 = 1 ;
V_3 = F_71 ( V_45 ) ;
F_133 ( V_8 , & V_3 -> V_12 , V_157 ) ;
V_3 -> V_12 . V_158 = L_46 ;
V_3 -> V_12 . V_159 = F_122 ;
V_3 -> V_12 . V_160 = F_129 ;
F_134 ( V_3 ) ;
F_135 (udev, hpriv, i) {
V_26 -> V_47 = NULL ;
F_40 ( & V_26 -> V_42 ) ;
