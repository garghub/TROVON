...
{
if ( V_9 -> type == V_20 )
F_13 ( (struct V_21 * ) V_9 -> V_14 ) ;
else if ( F_14 ( F_15 ( V_7 ) ) )
...
return V_28 -> V_25 -> V_29 == V_26 ;
}
static struct V_27 * F_27 ( const struct V_30 * V_31 )
{
struct V_24 * V_25 ;
F_28 ( ! V_31 ) ;
V_25 = F_29 ( V_32 , NULL , V_31 , F_25 ) ;
...
V_7 -> V_39 = F_37 ( V_40 , V_41 ) ;
if ( ! V_7 -> V_39 )
return - V_13 ;
V_7 -> V_38 = F_38 ( F_19 ( V_7 ) ,
...
static int
F_40 ( struct V_45 * V_46 , struct V_6 * V_7 , int V_5 )
{
int V_36 ;
...
assert ( V_7 -> V_44 == 0 ) ;
assert ( V_7 -> V_43 == 0 ) ;
V_7 -> V_42 = F_41 ( V_7 -> V_34 , sizeof( V_7 -> V_42 [ 0 ] ) ,
V_41 ) ;
if ( ! V_7 -> V_42 ) {
V_36 = - V_13 ;
goto V_49;
...
static int F_42 ( struct V_52 * V_53 , struct V_45 * V_46 ,
struct V_27 * V_25 )
{
int V_36 ;
V_46 -> V_25 = V_25 ;
V_46 -> V_54 = V_53 ;
V_36 = F_40 ( V_46 , & V_46 -> V_55 , V_46 -> V_55 . V_5 | V_56 ) ;
if ( V_36 )
goto V_49;
V_36 = F_40 ( V_46 , & V_46 -> V_57 , V_46 -> V_57 . V_5 & ~ V_56 ) ;
if ( V_36 )
goto V_58;
if ( V_25 -> V_59 -> V_60 )
V_25 -> V_59 -> V_60 ( V_46 ) ;
...
int F_44 ( struct V_62 * V_63 )
{
return F_45 ( & V_64 , V_63 ) ;
}
...
for ( V_33 = 0 ; V_33 < V_54 -> V_65 ; V_33 ++ ) {
V_36 = F_42 ( V_54 , V_54 -> V_66 [ V_33 ] , V_54 -> V_25 ) ;
if ( V_36 )
goto V_68;
}
return 0 ;
...
struct V_52 * F_50 ( struct V_24 * V_69 ,
...
V_54 -> V_25 = V_25 ;
V_54 -> V_69 = V_69 ;
V_54 -> V_72 = V_72 ? V_72 : & V_75 ;
V_54 -> V_76 = V_70 ;
for ( V_33 = 0 ; V_33 < V_54 -> V_65 ; V_33 ++ ) {
V_36 = F_42 ( V_54 , V_54 -> V_66 [ V_33 ] , V_25 ) ;
if ( V_36 )
goto V_68;
}
F_53 ( V_25 -> V_77 ) ;
F_1 ( & V_25 -> V_1 , & V_54 -> V_3 , & V_25 -> V_78 ) ;
return V_54 ;
V_68:
for ( V_35 = V_33 - 1 ; V_35 >= 0 ; V_35 -- )
F_43 ( V_54 -> V_66 [ V_35 ] ) ;
...
int F_57 ( struct V_27 * V_28 , struct V_80 * V_77 )
{
static T_3 V_81 = F_58 ( - 1 ) ;
int V_36 ;
if ( ! V_28 -> V_25 )
return - V_73 ;
...
return - V_48 ;
V_28 -> V_77 = V_77 ;
V_28 -> V_81 = ( int ) F_59 ( & V_81 ) ;
V_28 -> V_86 . V_87 = V_28 -> V_25 ;
V_28 -> V_86 . V_88 = V_32 ;
V_28 -> V_86 . V_89 = F_56 ;
( void ) F_60 ( & V_28 -> V_86 , L_2 , V_28 -> V_81 ) ;
V_36 = F_61 ( & V_28 -> V_86 ) ;
if ( V_36 )
return V_36 ;
F_53 ( V_90 ) ;
