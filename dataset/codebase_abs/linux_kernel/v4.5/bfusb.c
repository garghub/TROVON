...
static int F_42 ( struct V_65 * V_19 , struct V_4 * V_5 )
{
struct V_2 * V_3 = F_36 ( V_19 ) ;
struct V_4 * V_68 ;
...
F_47 ( L_22 ) ;
V_41 = F_48 ( V_75 + 3 , V_78 ) ;
if ( ! V_41 ) {
F_14 ( L_23 ) ;
return - V_15 ;
}
V_12 = F_49 ( V_3 -> V_16 , 0 ) ;
if ( F_50 ( V_3 -> V_16 , V_12 , V_79 ,
0 , 1 , 0 , NULL , 0 , V_80 ) < 0 ) {
F_14 ( L_24 ) ;
F_51 ( V_41 ) ;
return - V_81 ;
...
V_12 = F_11 ( V_3 -> V_16 , V_3 -> V_17 ) ;
while ( V_60 ) {
V_36 = F_44 ( V_74 , V_60 , V_75 + 3 ) ;
memcpy ( V_41 , V_77 + V_69 , V_36 ) ;
V_11 = F_52 ( V_3 -> V_16 , V_12 , V_41 , V_36 ,
& V_13 , V_83 ) ;
if ( V_11 || ( V_13 != V_36 ) ) {
F_14 ( L_25 ) ;
goto error;
...
V_11 = F_52 ( V_3 -> V_16 , V_12 , NULL , 0 ,
& V_13 , V_83 ) ;
if ( V_11 < 0 ) {
F_14 ( L_26 ) ;
goto error;
...
F_51 ( V_41 ) ;
V_12 = F_49 ( V_3 -> V_16 , 0 ) ;
F_50 ( V_3 -> V_16 , V_12 , V_79 ,
0 , 0 , 0 , NULL , 0 , V_80 ) ;
return V_11 ;
}
static int F_53 ( struct V_84 * V_85 , const struct V_86 * V_87 )
{
const struct V_77 * V_77 ;
struct V_88 * V_16 = F_54 ( V_85 ) ;
struct V_89 * V_17 ;
struct V_89 * V_38 ;
struct V_65 * V_19 ;
struct V_2 * V_3 ;
...
V_3 = F_55 ( & V_85 -> V_28 , sizeof( struct V_2 ) , V_78 ) ;
if ( ! V_3 )
return - V_15 ;
V_3 -> V_16 = V_16 ;
V_3 -> V_38 = V_38 -> V_91 . V_95 ;
V_3 -> V_17 = V_17 -> V_91 . V_95 ;
V_3 -> V_76 = F_56 ( V_17 -> V_91 . V_96 ) ;
F_57 ( & V_3 -> V_35 ) ;
V_3 -> V_42 = NULL ;
F_58 ( & V_3 -> V_26 ) ;
F_58 ( & V_3 -> V_9 ) ;
F_58 ( & V_3 -> V_6 ) ;
if ( F_59 ( & V_77 , L_31 , & V_16 -> V_28 ) < 0 ) {
F_14 ( L_32 ) ;
goto V_94;
}
F_2 ( L_33 , V_77 -> V_3 , V_77 -> V_36 ) ;
if ( F_46 ( V_3 , V_77 -> V_3 , V_77 -> V_36 ) < 0 ) {
F_14 ( L_34 ) ;
goto V_97;
}
F_60 ( V_77 ) ;
