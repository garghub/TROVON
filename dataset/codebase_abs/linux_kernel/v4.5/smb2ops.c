...
V_14 = 0 ;
V_259 = (struct V_258 * ) V_257 -> V_263 ;
V_260 = F_11 ( V_259 -> V_264 ) ;
V_261 = F_11 ( V_259 -> V_265 ) ;
* V_255 = F_104 (
( char * ) V_259 -> V_266 + V_261 ,
V_260 , true , V_94 -> V_267 ) ;
if ( ! ( * V_255 ) ) {
F_42 ( V_96 ) ;
return - V_97 ;
}
F_105 ( * V_255 , '/' ) ;
F_2 ( V_9 , L_57 , V_262 , * V_255 ) ;
F_42 ( V_96 ) ;
return V_14 ;
}
static long F_106 ( struct V_268 * V_268 , struct V_58 * V_59 ,
T_11 V_247 , T_11 V_168 , bool V_269 )
{
struct V_201 * V_201 ;
struct V_148 * V_203 ;
struct V_146 * V_147 = V_268 -> V_270 ;
struct V_271 V_272 ;
long V_14 ;
unsigned int V_53 ;
V_53 = F_107 () ;
...
return - V_218 ;
if ( V_269 == false )
if ( F_108 ( V_201 ) < V_247 + V_168 )
return - V_218 ;
F_2 ( V_9 , L_58 , V_247 , V_168 ) ;
V_272 . V_273 = F_67 ( V_247 ) ;
V_272 . V_274 = F_67 ( V_247 + V_168 ) ;
V_14 = F_32 ( V_53 , V_59 , V_147 -> V_81 . V_88 ,
V_147 -> V_81 . V_89 , V_275 ,
true , ( char * ) & V_272 ,
sizeof( struct V_271 ) , NULL , NULL ) ;
F_109 ( V_53 ) ;
return V_14 ;
}
static long F_110 ( struct V_268 * V_268 , struct V_58 * V_59 ,
...
static long F_111 ( struct V_268 * V_268 , struct V_58 * V_59 ,
T_11 V_276 , T_11 V_168 , bool V_269 )
{
struct V_201 * V_201 ;
struct V_148 * V_203 ;
struct V_146 * V_147 = V_268 -> V_270 ;
...
if ( V_269 == true )
return 0 ;
else if ( F_108 ( V_201 ) >= V_276 + V_168 )
return 0 ;
else
return - V_218 ;
}
if ( ( V_269 == true ) || ( F_108 ( V_201 ) >= V_276 + V_168 ) ) {
if ( ( V_276 > 8192 ) || ( V_276 + V_168 + 8192 < F_108 ( V_201 ) ) )
return - V_218 ;
...
static long F_112 ( struct V_268 * V_268 , struct V_58 * V_59 , int V_277 ,
T_11 V_276 , T_11 V_168 )
{
if ( V_277 & V_278 )
return F_110 ( V_268 , V_59 , V_276 , V_168 ) ;
else if ( V_277 & V_279 ) {
if ( V_277 & V_280 )
return F_106 ( V_268 , V_59 , V_276 , V_168 , true ) ;
return F_106 ( V_268 , V_59 , V_276 , V_168 , false ) ;
} else if ( V_277 == V_280 )
return F_111 ( V_268 , V_59 , V_276 , V_168 , true ) ;
else if ( V_277 == 0 )
return F_111 ( V_268 , V_59 , V_276 , V_168 , false ) ;
return - V_218 ;
}
static void
F_113 ( struct V_1 * V_2 ,
struct V_148 * V_149 , bool V_281 )
{
if ( V_281 )
V_2 -> V_16 -> V_152 ( V_149 , V_282 ,
0 , NULL ) ;
else
V_2 -> V_16 -> V_152 ( V_149 , 0 , 0 , NULL ) ;
}
static void
F_114 ( struct V_148 * V_149 , T_8 V_76 ,
...
unsigned int V_153 , bool * V_154 )
{
unsigned int V_296 = V_149 -> V_76 ;
F_115 ( V_149 , V_76 , V_153 , V_154 ) ;
if ( V_154 ) {
* V_154 = false ;
if ( V_296 == V_289 ) {
if ( V_149 -> V_76 == V_289 &&
( V_153 - V_149 -> V_153 > 0 ) )
* V_154 = true ;
else if ( V_149 -> V_76 == V_297 &&
( V_153 - V_149 -> V_153 > 1 ) )
* V_154 = true ;
else if ( V_149 -> V_76 == V_285 &&
( V_153 - V_149 -> V_153 > 1 ) )
* V_154 = true ;
...
static char *
F_120 ( T_3 * V_241 , T_3 V_76 )
{
struct V_301 * V_38 ;
V_38 = F_45 ( sizeof( struct V_301 ) , V_104 ) ;
if ( ! V_38 )
return NULL ;
V_38 -> V_302 . V_303 = F_67 ( * ( ( T_5 * ) V_241 ) ) ;
V_38 -> V_302 . V_304 = F_67 ( * ( ( T_5 * ) ( V_241 + 8 ) ) ) ;
V_38 -> V_302 . V_305 = F_119 ( V_76 ) ;
V_38 -> V_306 . V_190 = F_83 ( F_121
( struct V_301 , V_302 ) ) ;
V_38 -> V_306 . V_191 = F_66 ( sizeof( struct V_307 ) ) ;
V_38 -> V_306 . V_308 = F_83 ( F_121
( struct V_301 , V_309 ) ) ;
V_38 -> V_306 . V_310 = F_83 ( 4 ) ;
V_38 -> V_309 [ 0 ] = 'R' ;
V_38 -> V_309 [ 1 ] = 'q' ;
V_38 -> V_309 [ 2 ] = 'L' ;
V_38 -> V_309 [ 3 ] = 's' ;
...
static char *
F_122 ( T_3 * V_241 , T_3 V_76 )
{
struct V_311 * V_38 ;
V_38 = F_45 ( sizeof( struct V_311 ) , V_104 ) ;
if ( ! V_38 )
return NULL ;
V_38 -> V_302 . V_303 = F_67 ( * ( ( T_5 * ) V_241 ) ) ;
V_38 -> V_302 . V_304 = F_67 ( * ( ( T_5 * ) ( V_241 + 8 ) ) ) ;
...
V_38 -> V_306 . V_190 = F_83 ( F_121
( struct V_311 , V_302 ) ) ;
V_38 -> V_306 . V_191 = F_66 ( sizeof( struct V_312 ) ) ;
V_38 -> V_306 . V_308 = F_83 ( F_121
( struct V_311 , V_309 ) ) ;
V_38 -> V_306 . V_310 = F_83 ( 4 ) ;
V_38 -> V_309 [ 0 ] = 'R' ;
...
static T_4
F_123 ( void * V_38 , unsigned int * V_153 )
{
struct V_301 * V_313 = (struct V_301 * ) V_38 ;
* V_153 = 0 ;
if ( V_313 -> V_302 . V_314 & V_315 )
return V_283 ;
return F_33 ( V_313 -> V_302 . V_305 ) ;
}
static T_4
F_124 ( void * V_38 , unsigned int * V_153 )
{
struct V_311 * V_313 = (struct V_311 * ) V_38 ;
* V_153 = F_11 ( V_313 -> V_302 . V_316 ) ;
if ( V_313 -> V_302 . V_314 & V_315 )
return V_283 ;
return F_33 ( V_313 -> V_302 . V_305 ) ;
}
static unsigned int
F_125 ( struct V_201 * V_201 )
{
return F_17 (unsigned int, CIFS_SB(inode->i_sb)->wsize,
SMB2_MAX_BUFFER_SIZE) ;
}
static bool
F_126 ( struct V_146 * V_147 )
{
return ! V_147 -> V_317 ;
}
