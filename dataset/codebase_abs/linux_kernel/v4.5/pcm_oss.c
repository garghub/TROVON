...
#if F_151 ( V_323 ) || ( F_151 ( V_324 ) && F_151 ( V_325 ) )
if ( ( ( V_260 >> 8 ) & 0xff ) == 'M' ) {
struct V_20 * V_49 ;
int V_178 ;
for ( V_178 = 0 ; V_178 < 2 ; ++ V_178 ) {
...
if ( F_43 ( V_178 >= 2 ) )
return - V_211 ;
return F_185 ( V_49 -> V_21 -> V_309 , V_260 , V_318 ) ;
}
#endif
if ( ( ( V_260 >> 8 ) & 0xff ) != 'P' )
return - V_7 ;
...
static long F_188 ( struct V_246 * V_246 , unsigned int V_260 ,
unsigned long V_318 )
{
return F_183 ( V_246 , V_260 , ( unsigned long ) F_189 ( V_318 ) ) ;
}
static T_7 F_190 ( struct V_246 * V_246 , char V_194 * V_202 , T_6 V_356 , T_12 * V_357 )
{
struct V_175 * V_176 ;
struct V_20 * V_49 ;
V_176 = V_246 -> V_300 ;
...
#ifndef F_103
return F_120 ( V_49 , V_202 , V_356 ) ;
#else
{
T_7 V_221 = F_120 ( V_49 , V_202 , V_356 ) ;
F_79 ( V_49 -> V_21 ,
L_26 ,
( long ) V_356 , ( long ) V_221 ) ;
return V_221 ;
}
#endif
}
static T_7 F_191 ( struct V_246 * V_246 , const char V_194 * V_202 , T_6 V_356 , T_12 * V_357 )
{
struct V_175 * V_176 ;
struct V_20 * V_49 ;
long V_220 ;
...
return - V_211 ;
V_49 -> V_213 = V_246 -> V_213 & V_214 ;
V_220 = F_115 ( V_49 , V_202 , V_356 ) ;
#ifdef F_103
F_79 ( V_49 -> V_21 , L_27 ,
( long ) V_356 , ( long ) V_220 ) ;
#endif
return V_220 ;
}
static int F_192 ( struct V_20 * V_49 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
if ( F_69 ( & V_49 -> V_112 ) )
...
static int F_194 ( struct V_20 * V_49 )
{
struct V_50 * V_51 = V_49 -> V_51 ;
if ( F_69 ( & V_49 -> V_112 ) )
return V_51 -> V_55 . V_183 !=
...
static unsigned int F_196 ( struct V_246 * V_246 , T_13 * V_222 )
{
struct V_175 * V_176 ;
unsigned int V_139 ;
struct V_20 * V_258 = NULL , * V_259 = NULL ;
...
F_197 ( V_246 , & V_51 -> V_224 , V_222 ) ;
F_127 ( V_259 ) ;
if ( ( V_360 = V_51 -> V_190 -> V_191 ) != V_226 ||
F_194 ( V_259 ) )
V_139 |= V_361 | V_362 ;
F_128 ( V_259 ) ;
if ( V_360 != V_226 && V_51 -> V_55 . V_157 ) {
struct V_175 V_363 ;
memset ( & V_363 , 0 , sizeof( V_363 ) ) ;
V_363 . V_180 [ V_160 ] = V_176 -> V_180 [ V_160 ] ;
V_51 -> V_55 . V_157 = 0 ;
F_154 ( & V_363 , V_263 ) ;
}
}
...
static int F_198 ( struct V_246 * V_246 , struct V_364 * V_365 )
{
struct V_175 * V_176 ;
...
#endif
V_176 = V_246 -> V_300 ;
switch ( ( V_365 -> V_366 & ( V_367 | V_368 ) ) ) {
case V_367 | V_368 :
V_49 = V_176 -> V_180 [ V_154 ] ;
if ( V_49 )
break;
...
if ( V_365 -> V_371 != 0 )
return - V_7 ;
V_22 = F_199 ( V_49 , V_246 , V_365 ) ;
if ( V_22 < 0 )
return V_22 ;
V_51 -> V_55 . V_113 = V_365 -> V_372 - V_365 -> V_373 ;
V_51 -> V_167 = 0 ;
V_51 -> V_168 = 0 ;
#ifdef F_103
F_186 ( L_29 ,
...
static void F_200 ( struct V_374 * V_375 ,
struct V_376 * V_170 )
{
struct V_377 * V_249 = V_375 -> V_300 ;
...
static void F_202 ( struct V_377 * V_249 )
{
struct V_280 * V_114 , * V_378 ;
...
static void F_203 ( struct V_374 * V_375 ,
struct V_376 * V_170 )
{
struct V_377 * V_249 = V_375 -> V_300 ;
char line [ 128 ] , V_379 [ 32 ] , V_279 [ 32 ] ;
const char * V_188 ;
int V_380 ;
struct V_280 * V_114 , * V_381 , V_382 ;
while ( ! F_204 ( V_170 , line , sizeof( line ) ) ) {
F_116 ( & V_249 -> V_55 . V_282 ) ;
memset ( & V_382 , 0 , sizeof( V_382 ) ) ;
V_188 = F_205 ( V_279 , line , sizeof( V_279 ) ) ;
...
V_188 = F_205 ( V_379 , V_188 , sizeof( V_379 ) ) ;
V_382 . V_121 = F_206 ( V_379 , NULL , 10 ) ;
V_188 = F_205 ( V_379 , V_188 , sizeof( V_379 ) ) ;
V_382 . V_115 = F_206 ( V_379 , NULL , 10 ) ;
for ( V_380 = 31 ; V_380 >= 0 ; V_380 -- )
if ( V_382 . V_115 & ( 1 << V_380 ) )
break;
for ( V_380 -- ; V_380 >= 0 ; V_380 -- )
V_382 . V_115 &= ~ ( 1 << V_380 ) ;
do {
V_188 = F_205 ( V_379 , V_188 , sizeof( V_379 ) ) ;
if ( ! strcmp ( V_379 , L_40 ) ) {
V_382 . V_299 = 1 ;
} else if ( ! strcmp ( V_379 , L_41 ) ) {
V_382 . V_135 = 1 ;
} else if ( ! strcmp ( V_379 , L_42 ) ) {
V_382 . V_287 = 1 ;
} else if ( ! strcmp ( V_379 , L_43 ) ) {
V_382 . V_286 = 1 ;
} else if ( ! strcmp ( V_379 , L_44 ) ) {
V_382 . V_212 = 1 ;
} else if ( ! strcmp ( V_379 , L_45 ) ) {
V_382 . V_166 = 1 ;
} else if ( ! strcmp ( V_379 , L_46 ) ) {
V_382 . V_269 = 1 ;
}
} while ( * V_379 );
if ( V_114 == NULL ) {
...
for ( V_381 = V_249 -> V_55 . V_283 ;
V_381 -> V_54 ; V_381 = V_381 -> V_54 ) ;
V_381 -> V_54 = V_114 ;
}
V_382 . V_279 = F_207 ( V_279 , V_44 ) ;
if ( ! V_382 . V_279 ) {
F_40 ( V_114 ) ;
V_170 -> error = - V_45 ;
F_97 ( & V_249 -> V_55 . V_282 ) ;
...
static void F_208 ( struct V_278 * V_21 )
{
int V_153 ;
for ( V_153 = 0 ; V_153 < 2 ; ++ V_153 ) {
struct V_374 * V_375 ;
struct V_377 * V_249 = & V_21 -> V_180 [ V_153 ] ;
if ( V_249 -> V_250 == 0 )
continue;
if ( ( V_375 = F_209 ( V_21 -> V_309 , L_47 , V_249 -> V_383 ) ) != NULL ) {
V_375 -> V_384 = V_385 ;
V_375 -> V_386 = V_387 | V_388 | V_389 ;
V_375 -> V_28 . V_390 . V_391 = F_200 ;
V_375 -> V_28 . V_390 . V_392 = F_203 ;
V_375 -> V_300 = V_249 ;
if ( F_210 ( V_375 ) < 0 ) {
F_211 ( V_375 ) ;
V_375 = NULL ;
...
V_249 -> V_55 . V_393 = V_375 ;
}
}
static void F_212 ( struct V_278 * V_21 )
{
int V_153 ;
for ( V_153 = 0 ; V_153 < 2 ; ++ V_153 ) {
struct V_377 * V_249 = & V_21 -> V_180 [ V_153 ] ;
F_211 ( V_249 -> V_55 . V_393 ) ;
V_249 -> V_55 . V_393 = NULL ;
F_202 ( V_249 ) ;
}
}
static void F_213 ( struct V_278 * V_21 , int V_394 )
{
if ( F_214 ( V_306 ,
V_21 -> V_309 , V_394 , & V_395 ,
V_21 ) < 0 ) {
F_131 ( V_21 , L_48 ,
V_21 -> V_309 -> V_396 , V_21 -> V_397 ) ;
}
}
static int F_215 ( struct V_278 * V_21 )
{
V_21 -> V_55 . V_398 = 0 ;
if ( V_399 [ V_21 -> V_309 -> V_396 ] == ( int ) V_21 -> V_397 ) {
char V_303 [ 128 ] ;
int V_400 ;
F_213 ( V_21 , 0 ) ;
V_400 = ( V_21 -> V_180 [ V_154 ] . V_250 > 0 &&
V_21 -> V_180 [ V_160 ] . V_250 &&
! ( V_21 -> V_296 & V_297 ) ) ;
sprintf ( V_303 , L_49 , V_21 -> V_303 , V_400 ? L_50 : L_32 ) ;
#ifdef F_216
F_217 ( F_216 ,
V_21 -> V_309 -> V_396 ,
V_303 ) ;
...
if ( V_402 [ V_21 -> V_309 -> V_396 ] == ( int ) V_21 -> V_397 ) {
F_213 ( V_21 , 1 ) ;
V_21 -> V_55 . V_398 ++ ;
V_21 -> V_55 . V_401 |= 2 ;
}
...
static int F_218 ( struct V_278 * V_21 )
{
if ( V_21 -> V_55 . V_398 ) {
if ( V_21 -> V_55 . V_401 & 1 ) {
V_21 -> V_55 . V_401 &= ~ 1 ;
F_219 ( V_306 ,
V_21 -> V_309 , 0 ) ;
}
if ( V_21 -> V_55 . V_401 & 2 ) {
V_21 -> V_55 . V_401 &= ~ 2 ;
F_219 ( V_306 ,
V_21 -> V_309 , 1 ) ;
}
...
static int F_221 ( struct V_278 * V_21 )
{
F_218 ( V_21 ) ;
F_212 ( V_21 ) ;
return 0 ;
...
int V_3 ;
int V_22 ;
for ( V_3 = 0 ; V_3 < V_403 ; V_3 ++ ) {
if ( V_399 [ V_3 ] < 0 || V_399 [ V_3 ] >= V_404 ) {
F_223 ( L_51 ,
V_3 , V_399 [ V_3 ] ) ;
V_399 [ V_3 ] = 0 ;
}
if ( V_402 [ V_3 ] < 0 || V_402 [ V_3 ] >= V_404 ) {
F_223 ( L_52 ,
V_3 , V_402 [ V_3 ] ) ;
V_402 [ V_3 ] = 1 ;
}
}
if ( ( V_22 = F_224 ( & V_405 , 0 ) ) < 0 )
return V_22 ;
return 0 ;
}
static void T_15 F_225 ( void )
{
F_224 ( & V_405 , 1 ) ;
}
