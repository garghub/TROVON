...
struct V_7 *
F_8 ( struct V_1 * V_2 , unsigned int V_23 , unsigned int V_24 ,
struct V_25 * * V_26 )
{
...
V_27 = F_9 ( 1 + 8 * V_23 ) ;
V_28 = ( V_24 * 8 ) / V_27 ;
V_8 = F_10 ( sizeof( * V_8 ) , V_34 ) ;
if ( ! V_8 )
goto V_33;
V_8 -> V_13 = F_11 ( V_27 , V_28 , 0 ) ;
if ( ! V_8 -> V_13 )
goto V_33;
if ( V_8 -> V_13 -> V_35 != V_24 ) {
F_7 ( V_32 L_4 ,
V_24 , V_8 -> V_13 -> V_35 ) ;
goto V_33;
}
...
V_8 -> V_15 = F_12 ( V_24 , V_34 ) ;
V_8 -> V_18 = F_12 ( V_28 * sizeof( * V_8 -> V_18 ) , V_34 ) ;
...
memset ( V_8 -> V_15 , 0 , V_24 ) ;
F_3 ( V_8 -> V_13 , V_31 , V_23 , V_8 -> V_15 ) ;
F_13 ( V_31 ) ;
