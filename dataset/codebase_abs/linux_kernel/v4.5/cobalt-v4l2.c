...
unsigned V_10 = V_8 -> V_11 * V_8 -> V_12 ;
if ( * V_3 < 3 )
* V_3 = 3 ;
if ( * V_3 > V_13 )
* V_3 = V_13 ;
V_6 [ 0 ] = V_8 -> V_14 -> V_15 ;
if ( * V_4 )
return V_5 [ 0 ] < V_10 ? - V_16 : 0 ;
* V_4 = 1 ;
V_5 [ 0 ] = V_10 ;
return 0 ;
}
static int F_2 ( struct V_17 * V_18 )
{
struct V_7 * V_8 = V_18 -> V_1 -> V_9 ;
...
struct V_26 * V_27 = & V_8 -> V_28 [ V_18 -> V_29 ] ;
struct V_30 * V_31 = F_3 ( V_18 , 0 ) ;
unsigned V_10 ;
int V_32 ;
V_10 = V_8 -> V_11 * V_8 -> V_12 ;
if ( F_4 ( V_18 , 0 ) < V_10 ) {
F_5 ( L_1 ,
F_4 ( V_18 , 0 ) , V_10 ) ;
return - V_16 ;
...
if ( V_27 -> V_33 == NULL ) {
V_27 -> V_34 = & V_14 -> V_35 -> V_34 ;
F_6 ( V_27 ,
V_8 -> V_36 ? V_25 : V_23 ) ;
if ( V_27 -> V_33 == NULL )
return - V_37 ;
}
V_32 = F_7 ( V_14 , V_31 -> V_38 ,
! V_8 -> V_39 , V_31 -> V_40 , V_10 ,
V_8 -> V_41 * V_8 -> V_42 , V_8 -> V_11 , V_27 ) ;
if ( V_32 )
F_8 ( V_27 ) ;
return V_32 ;
}
...
{
struct V_43 * V_44 = F_11 ( V_18 ) ;
struct V_7 * V_8 = V_18 -> V_1 -> V_9 ;
F_12 ( V_18 , 0 , V_8 -> V_11 * V_8 -> V_12 ) ;
V_44 -> V_45 = V_46 ;
return 0 ;
}
static void F_13 ( struct V_7 * V_8 )
{
struct V_26 * V_27 [ V_13 ] ;
struct V_47 * V_48 ;
struct V_49 * V_50 ;
int V_51 = 0 ;
F_14 (p, &s->bufs) {
V_48 = F_15 ( V_50 , struct V_47 , V_52 ) ;
V_27 [ V_51 ] = & V_8 -> V_28 [ V_48 -> V_18 . V_53 . V_29 ] ;
if ( V_51 > 0 )
...
{
struct V_14 * V_14 = V_8 -> V_14 ;
struct V_57 * V_58 = & V_8 -> V_59 . V_58 ;
struct V_60 T_2 * V_61 =
F_25 ( V_14 ) ;
unsigned V_62 = V_8 -> V_63 != V_64 ?
V_65 : 0 ;
struct V_66 V_67 = {
. V_68 = V_69 ,
} ;
if ( ! F_26 ( V_14 , V_58 -> V_70 ) ) {
F_27 ( L_2 ) ;
return;
}
V_67 . V_71 . V_72 = V_8 -> V_72 ;
V_67 . V_71 . V_73 = V_8 -> V_73 ;
V_67 . V_71 . V_74 = V_8 -> V_74 ;
V_67 . V_71 . V_75 = V_8 -> V_75 ;
V_67 . V_71 . V_41 = V_58 -> V_41 ;
V_67 . V_71 . V_12 = V_58 -> V_12 ;
switch ( V_8 -> V_63 ) {
case V_76 :
V_67 . V_71 . V_77 = V_78 ;
break;
...
F_28 ( V_8 -> V_80 , V_81 , V_82 , NULL , & V_67 ) ;
F_29 ( 0 , & V_61 -> V_83 ) ;
...
V_8 -> V_111 == 0 ? L_4 : L_5 ,
L_6 ) ;
V_106 = F_32 ( V_14 , V_103 ) ;
switch ( V_8 -> V_63 ) {
case V_76 :
F_29 ( V_112 |
( 1 << V_113 ) ,
& V_106 -> V_83 ) ;
F_28 ( V_8 -> V_80 , V_81 , V_82 , NULL ,
& V_107 ) ;
break;
case V_114 :
F_29 ( V_112 |
...
V_48 = F_36 ( & V_8 -> V_56 , struct V_47 , V_52 ) ;
F_37 ( V_8 , & V_8 -> V_28 [ V_48 -> V_18 . V_53 . V_29 ] ) ;
F_23 ( & V_8 -> V_55 , V_54 ) ;
}
...
int V_116 = V_8 -> V_104 ;
struct V_130 T_2 * V_131 = F_39 ( V_14 , V_116 ) ;
struct V_117 T_2 * V_118 = F_34 ( V_14 , V_116 ) ;
struct V_57 * V_58 = & V_8 -> V_59 . V_58 ;
T_4 V_132 ;
T_3 V_133 ;
if ( V_8 -> V_36 )
...
F_30 ( V_8 ) ;
V_127 = F_40 ( V_14 , V_116 ) ;
V_125 = F_41 ( V_14 , V_116 ) ;
V_129 = F_42 ( V_14 , V_116 ) ;
F_29 ( V_119 , & V_118 -> V_83 ) ;
F_29 ( V_120 , & V_118 -> V_83 ) ;
F_29 ( V_58 -> V_41 , & V_131 -> V_136 ) ;
F_29 ( V_58 -> V_12 , & V_131 -> V_137 ) ;
...
& V_129 -> V_142 ) ;
F_29 ( V_58 -> V_41 * V_58 -> V_12 , & V_127 -> V_143 ) ;
...
F_14 (p, &s->bufs) {
V_48 = F_15 ( V_50 , struct V_47 , V_52 ) ;
V_27 = & V_8 -> V_28 [ V_48 -> V_18 . V_53 . V_29 ] ;
F_47 ( V_27 ) ;
}
F_23 ( & V_8 -> V_55 , V_54 ) ;
if ( ! F_48 ( V_8 -> V_2 . V_157 , F_49 ( V_8 ) ,
F_50 ( V_156 ) ) ) {
F_51 ( V_8 ) ;
F_52 ( L_7 ) ;
}
...
static int F_58 ( struct V_14 * V_14 , unsigned int V_162 , void * V_163 )
{
struct V_164 * V_165 = V_163 ;
void T_2 * V_166 = V_14 -> V_167 + V_165 -> V_168 ;
F_5 ( L_8 , V_166 ) ;
if ( ! F_59 ( V_169 ) )
return - V_170 ;
V_165 -> V_10 = 4 ;
...
struct V_164 * V_168 )
{
struct V_7 * V_8 = F_61 ( V_173 ) ;
struct V_14 * V_14 = V_8 -> V_14 ;
return F_58 ( V_14 , V_175 , V_168 ) ;
}
...
T_3 V_189 , V_190 ;
T_3 V_191 , V_192 ;
V_131 = F_39 ( V_14 , V_116 ) ;
V_125 = F_41 ( V_14 , V_116 ) ;
V_127 = F_40 ( V_14 , V_116 ) ;
V_129 = F_42 ( V_14 , V_116 ) ;
V_106 = F_32 ( V_14 , V_116 ) ;
...
if ( ! V_229 ) {
V_8 -> V_59 = * V_59 ;
V_8 -> V_41 = V_59 -> V_58 . V_41 ;
V_8 -> V_12 = V_59 -> V_58 . V_12 ;
V_8 -> V_11 = V_59 -> V_58 . V_41 * V_8 -> V_42 ;
}
return V_229 ;
}
...
V_67 . V_81 = V_8 -> V_108 ;
V_67 . V_68 = V_69 ;
F_28 ( V_8 -> V_80 , V_81 , V_247 , NULL , & V_67 ) ;
F_82 ( V_244 , & V_67 . V_71 ) ;
}
V_244 -> V_241 = V_8 -> V_63 ;
V_244 -> V_248 = V_244 -> V_245 * V_244 -> V_12 ;
return 0 ;
}
...
struct V_243 * V_244 = & V_239 -> V_62 . V_244 ;
struct V_66 V_67 ;
if ( ( V_244 -> V_41 < 176 ) || ( V_244 -> V_12 < 144 ) ) {
V_244 -> V_41 = 176 ;
V_244 -> V_12 = 144 ;
}
if ( ( V_244 -> V_41 > 1920 ) || ( V_244 -> V_12 > 1080 ) ) {
V_244 -> V_41 = 1920 ;
V_244 -> V_12 = 1080 ;
}
V_244 -> V_41 &= ~ 0x3 ;
...
return - V_16 ;
if ( F_76 ( & V_8 -> V_2 ) && ( V_244 -> V_241 != V_8 -> V_63 ||
V_244 -> V_41 != V_8 -> V_41 || V_244 -> V_12 != V_8 -> V_12 ||
V_244 -> V_245 != V_8 -> V_11 ) )
return - V_230 ;
switch ( V_244 -> V_241 ) {
case V_76 :
...
if ( V_8 -> V_111 == 1 )
return 0 ;
return F_28 ( V_8 -> V_80 , V_231 , V_259 ,
V_260 , 0 , 0 ) ;
}
...
T_3 V_81 = V_267 -> V_81 ;
int V_32 ;
if ( V_267 -> V_81 >= ( V_8 -> V_39 ? 1 : 2 ) )
return - V_16 ;
V_267 -> V_81 = 0 ;
V_32 = F_28 ( V_8 -> V_80 , V_81 , V_268 , V_267 ) ;
V_267 -> V_81 = V_81 ;
return V_32 ;
}
...
return - V_16 ;
V_267 -> V_81 = 0 ;
V_32 = F_28 ( V_8 -> V_80 , V_81 , V_269 , V_267 ) ;
V_267 -> V_81 = V_81 ;
return V_32 ;
}
...
static int F_103 ( struct V_14 * V_14 , int V_283 )
{
static const struct V_228 V_284 =
V_285 ;
struct V_7 * V_8 = V_14 -> V_286 + V_283 ;
struct V_287 * V_288 = & V_8 -> V_288 ;
struct V_1 * V_2 = & V_8 -> V_2 ;
int V_32 ;
F_104 ( & V_8 -> V_289 ) ;
F_105 ( & V_8 -> V_55 ) ;
snprintf ( V_288 -> V_255 , sizeof( V_288 -> V_255 ) ,
L_62 , V_14 -> V_290 . V_255 , V_283 ) ;
V_8 -> V_41 = 1920 ;
V_8 -> V_12 = V_8 -> V_36 ? 4 : 1080 ;
if ( V_8 -> V_36 ) {
V_8 -> V_42 = 1 ;
V_8 -> V_63 = V_291 ;
} else if ( V_8 -> V_39 ) {
...
V_8 -> V_72 = V_246 ;
V_8 -> V_11 = V_8 -> V_41 * V_8 -> V_42 ;
if ( ! V_8 -> V_36 ) {
if ( V_8 -> V_292 )
F_106 ( L_63 , V_283 ) ;
V_288 -> V_290 = & V_14 -> V_290 ;
if ( V_8 -> V_292 )
V_288 -> V_293 = & V_294 ;
else
V_288 -> V_293 = V_8 -> V_39 ? & V_295 :
& V_296 ;
V_288 -> V_297 = V_298 ;
V_288 -> V_299 = V_8 -> V_39 ? V_300 : V_301 ;
V_288 -> V_289 = & V_8 -> V_289 ;
if ( V_8 -> V_80 )
V_288 -> V_302 = V_8 -> V_80 -> V_302 ;
V_8 -> V_59 = V_284 ;
F_28 ( V_8 -> V_80 , V_231 , V_232 , & V_8 -> V_59 ) ;
if ( ! V_8 -> V_39 && V_8 -> V_80 )
F_30 ( V_8 ) ;
V_288 -> V_303 = V_8 -> V_292 ? & V_304 :
& V_305 ;
}
F_107 ( & V_8 -> V_56 ) ;
V_2 -> type = V_8 -> V_39 ? V_306 :
V_276 ;
V_2 -> V_307 = V_308 | V_309 | V_310 ;
V_2 -> V_307 |= V_8 -> V_39 ? V_311 : V_312 ;
V_2 -> V_9 = V_8 ;
...
int F_112 ( struct V_14 * V_14 )
{
int V_283 , V_32 ;
for ( V_283 = 0 ; V_283 < V_323 ; V_283 ++ ) {
V_32 = F_103 ( V_14 , V_283 ) ;
if ( V_32 )
return V_32 ;
}
return 0 ;
}
void F_113 ( struct V_14 * V_14 )
{
int V_283 ;
for ( V_283 = 0 ; V_283 < V_323 ; V_283 ++ ) {
struct V_7 * V_8 = V_14 -> V_286 + V_283 ;
