...
int F_73 ( struct V_11 * V_40 ,
int V_3 , struct V_149 * * V_150 )
{
struct V_1 * V_13 = V_40 -> V_13 ;
int V_153 ;
V_153 = F_74 ( V_13 , V_3 , V_150 ) ;
F_9 ( V_40 -> V_46 , L_48 , V_153 ,
V_3 ? L_40 : L_41 ) ;
return V_153 ;
}
static int F_75 ( struct V_11 * V_40 , int V_3 ,
struct V_149 * * V_154 )
{
struct V_43 * V_44 ;
...
V_44 -> V_131 = V_143 ;
V_44 -> V_45 -> V_44 [ V_3 ] . V_156 = V_157 ;
V_155 ++ ;
}
F_9 ( V_40 -> V_46 , L_50 , V_155 ) ;
return V_155 ;
}
...
struct V_149 * V_150 = * V_154 ;
struct V_11 * V_45 ;
int V_14 , V_158 = 0 , V_159 ;
for ( V_14 = 0 ; V_14 < V_150 -> V_151 ; V_14 ++ ) {
switch ( V_150 -> V_152 [ V_14 ] -> V_160 ) {
case V_161 :
if ( V_3 != V_6 )
continue;
break;
...
if ( ! V_45 -> V_24 -> V_97 )
continue;
if ( ! V_40 -> V_44 [ V_3 ] . V_31 && ! V_40 -> V_163 )
continue;
V_159 = F_58 ( V_40 , V_45 , V_3 ) ;
if ( V_159 < 0 ) {
F_13 ( V_40 -> V_46 , L_52 ,
V_150 -> V_152 [ V_14 ] -> V_47 ) ;
break;
...
continue;
V_45 -> V_44 [ V_3 ] . V_156 = V_157 ;
V_158 ++ ;
}
F_9 ( V_40 -> V_46 , L_53 , V_158 ) ;
return V_158 ;
}
int F_77 ( struct V_11 * V_40 ,
int V_3 , struct V_149 * * V_150 , int V_158 )
{
if ( V_158 )
return F_76 ( V_40 , V_3 , V_150 ) ;
else
return F_75 ( V_40 , V_3 , V_150 ) ;
}
void F_78 ( struct V_11 * V_40 , int V_3 )
{
struct V_43 * V_44 ;
F_8 (dpcm, &fe->dpcm[stream].be_clients, list_be)
V_44 -> V_45 -> V_44 [ V_3 ] . V_156 =
V_164 ;
}
static void F_79 ( struct V_11 * V_40 ,
int V_3 )
{
struct V_43 * V_44 ;
F_8 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
if ( -- V_45 -> V_44 [ V_3 ] . V_141 != 0 )
continue;
if ( V_45 -> V_44 [ V_3 ] . V_131 != V_165 )
continue;
F_43 ( V_140 ) ;
V_140 -> V_31 = NULL ;
V_45 -> V_44 [ V_3 ] . V_131 = V_166 ;
}
}
int F_80 ( struct V_11 * V_40 , int V_3 )
{
struct V_43 * V_44 ;
int V_159 , V_167 = 0 ;
F_8 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
if ( ! F_81 ( V_40 , V_45 , V_3 ) )
continue;
if ( V_45 -> V_44 [ V_3 ] . V_141 == V_168 )
F_13 ( V_45 -> V_46 , L_56 ,
V_3 ? L_40 : L_41 ,
V_45 -> V_44 [ V_3 ] . V_131 ) ;
if ( V_45 -> V_44 [ V_3 ] . V_141 ++ != 0 )
continue;
if ( ( V_45 -> V_44 [ V_3 ] . V_131 != V_169 ) &&
( V_45 -> V_44 [ V_3 ] . V_131 != V_166 ) )
continue;
F_9 ( V_45 -> V_46 , L_57 ,
...
V_45 -> V_44 [ V_3 ] . V_131 = V_165 ;
V_167 ++ ;
}
return V_167 ;
V_170:
F_82 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_11 * V_45 = V_44 -> V_45 ;
struct V_26 * V_140 =
F_64 ( V_45 , V_3 ) ;
if ( ! F_81 ( V_40 , V_45 , V_3 ) )
...
static T_1 F_84 ( struct V_26 * V_27 )
{
...
T_1 V_172 = F_84 ( V_27 ) ;
if ( V_27 -> V_3 == V_6 )
F_83 ( V_31 , & V_72 -> V_8 , V_172 ) ;
else
F_83 ( V_31 , & V_72 -> V_9 , V_172 ) ;
}
static void F_86 ( struct V_11 * V_40 ,
int V_3 , enum V_173 V_131 )
{
struct V_26 * V_27 =
F_64 ( V_40 , V_3 ) ;
F_87 ( V_27 ) ;
if ( V_131 == V_164 && V_40 -> V_44 [ V_3 ] . V_174 ) {
F_88 ( V_27 ,
V_40 -> V_44 [ V_3 ] . V_174 - 1 ) ;
V_40 -> V_44 [ V_3 ] . V_174 = 0 ;
}
V_40 -> V_44 [ V_3 ] . V_156 = V_131 ;
F_89 ( V_27 ) ;
}
static int F_90 ( struct V_26 * V_139 ,
int V_3 )
{
struct V_43 * V_44 ;
struct V_11 * V_40 = V_139 -> V_49 ;
struct V_1 * V_175 = V_40 -> V_13 ;
int V_159 ;
if ( F_19 ( V_139 ) )
V_139 -> V_31 -> V_29 . V_32 |= V_98 ;
if ( V_175 -> V_20 ) {
V_159 = F_11 ( V_139 , V_175 ) ;
if ( V_159 < 0 )
return V_159 ;
}
F_8 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
int F_92 ( struct V_11 * V_40 , int V_3 )
{
struct V_43 * V_44 ;
F_8 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_11 * V_45 = V_44 -> V_45 ;
...
if ( ! F_81 ( V_40 , V_45 , V_3 ) )
continue;
if ( ! F_95 ( V_40 , V_45 , V_3 ) )
continue;
if ( V_45 -> V_44 [ V_3 ] . V_141 > 1 )
continue;
if ( ( V_45 -> V_44 [ V_3 ] . V_131 != V_179 ) &&
( V_45 -> V_44 [ V_3 ] . V_131 != V_180 ) &&
( V_45 -> V_44 [ V_3 ] . V_131 != V_178 ) &&
( V_45 -> V_44 [ V_3 ] . V_131 != V_181 ) &&
...
{
struct V_11 * V_40 = V_27 -> V_49 ;
int V_159 , V_3 = V_27 -> V_3 ;
F_33 ( & V_40 -> V_112 -> V_184 , V_185 ) ;
F_86 ( V_40 , V_3 , V_176 ) ;
...
V_40 -> V_24 -> V_47 ) ;
V_159 = F_94 ( V_40 , V_3 ) ;
V_40 -> V_44 [ V_3 ] . V_131 = V_178 ;
F_86 ( V_40 , V_3 , V_164 ) ;
F_37 ( & V_40 -> V_112 -> V_184 ) ;
return 0 ;
}
int F_97 ( struct V_11 * V_40 , int V_3 )
{
struct V_43 * V_44 ;
int V_50 ;
F_8 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
if ( ! F_81 ( V_40 , V_45 , V_3 ) )
continue;
if ( ! F_98 ( V_40 , V_45 , V_3 ) )
continue;
if ( ( V_45 -> V_44 [ V_3 ] . V_131 != V_165 ) &&
( V_45 -> V_44 [ V_3 ] . V_131 != V_179 ) &&
( V_45 -> V_44 [ V_3 ] . V_131 != V_178 ) )
continue;
F_9 ( V_45 -> V_46 , L_70 ,
V_44 -> V_40 -> V_24 -> V_47 ) ;
...
V_44 -> V_40 -> V_24 -> V_47 , V_122 ) ;
V_50 = F_55 ( V_27 , V_122 ) ;
if ( V_50 < 0 )
F_13 ( V_44 -> V_45 -> V_46 , L_76 , V_50 ) ;
return V_50 ;
}
int F_101 ( struct V_11 * V_40 , int V_3 ,
int V_122 )
{
struct V_43 * V_44 ;
int V_50 = 0 ;
...
switch ( V_122 ) {
case V_187 :
if ( ( V_45 -> V_44 [ V_3 ] . V_131 != V_180 ) &&
( V_45 -> V_44 [ V_3 ] . V_131 != V_182 ) )
continue;
V_50 = F_100 ( V_44 , V_140 , V_122 ) ;
if ( V_50 )
return V_50 ;
V_45 -> V_44 [ V_3 ] . V_131 = V_188 ;
break;
case V_189 :
...
static int F_88 ( struct V_26 * V_27 , int V_122 )
{
struct V_11 * V_40 = V_27 -> V_49 ;
int V_3 = V_27 -> V_3 , V_50 ;
enum V_194 V_123 = V_40 -> V_24 -> V_123 [ V_3 ] ;
V_40 -> V_44 [ V_3 ] . V_156 = V_176 ;
switch ( V_123 ) {
case V_195 :
F_9 ( V_40 -> V_46 , L_77 ,
...
V_50 = F_101 ( V_40 , V_27 -> V_3 , V_122 ) ;
break;
case V_196 :
V_50 = F_101 ( V_40 , V_27 -> V_3 , V_122 ) ;
if ( V_50 < 0 ) {
...
V_89:
V_40 -> V_44 [ V_3 ] . V_156 = V_164 ;
return V_50 ;
}
static int F_102 ( struct V_26 * V_27 , int V_122 )
{
struct V_11 * V_40 = V_27 -> V_49 ;
int V_3 = V_27 -> V_3 ;
if ( V_40 -> V_44 [ V_3 ] . V_156 != V_164 ) {
V_40 -> V_44 [ V_3 ] . V_174 = V_122 + 1 ;
return 0 ;
}
return F_88 ( V_27 , V_122 ) ;
}
...
F_86 ( V_40 , V_3 , V_176 ) ;
if ( F_105 ( & V_40 -> V_44 [ V_3 ] . V_134 ) ) {
F_13 ( V_40 -> V_46 , L_85 ,
V_40 -> V_24 -> V_47 ) ;
V_50 = - V_63 ;
goto V_89;
}
V_50 = F_103 ( V_40 , V_27 -> V_3 ) ;
if ( V_50 < 0 )
goto V_89;
V_50 = F_47 ( V_27 ) ;
if ( V_50 < 0 ) {
...
unsigned int V_122 , void * V_198 )
{
struct V_11 * V_12 = V_27 -> V_49 ;
struct V_83 * V_84 = V_12 -> V_84 ;
if ( V_84 -> V_7 -> V_87 && V_84 -> V_7 -> V_87 -> V_199 )
return V_84 -> V_7 -> V_87 -> V_199 ( V_27 , V_122 , V_198 ) ;
return F_107 ( V_27 , V_122 , V_198 ) ;
}
static int F_108 ( struct V_11 * V_40 , int V_3 )
{
struct V_26 * V_27 =
F_64 ( V_40 , V_3 ) ;
enum V_194 V_123 = V_40 -> V_24 -> V_123 [ V_3 ] ;
...
F_9 ( V_40 -> V_46 , L_88 ,
V_40 -> V_24 -> V_47 ) ;
V_159 = F_56 ( V_27 , V_191 ) ;
if ( V_159 < 0 )
F_13 ( V_40 -> V_46 , L_78 , V_159 ) ;
} else {
F_9 ( V_40 -> V_46 , L_89 ,
V_40 -> V_24 -> V_47 ) ;
V_159 = F_101 ( V_40 , V_3 , V_191 ) ;
if ( V_159 < 0 )
F_13 ( V_40 -> V_46 , L_78 , V_159 ) ;
}
V_159 = F_94 ( V_40 , V_3 ) ;
if ( V_159 < 0 )
F_13 ( V_40 -> V_46 , L_90 , V_159 ) ;
V_159 = F_92 ( V_40 , V_3 ) ;
if ( V_159 < 0 )
F_13 ( V_40 -> V_46 , L_91 , V_159 ) ;
F_7 ( V_40 , V_3 , V_200 ) ;
return 0 ;
}
...
F_9 ( V_40 -> V_46 , L_92 ,
V_3 ? L_40 : L_41 , V_40 -> V_24 -> V_47 ) ;
if ( V_40 -> V_44 [ V_3 ] . V_131 == V_178 ||
V_40 -> V_44 [ V_3 ] . V_131 == V_166 )
return - V_63 ;
V_50 = F_80 ( V_40 , V_3 ) ;
if ( V_50 < 0 )
goto V_201;
if ( V_40 -> V_44 [ V_3 ] . V_131 == V_165 )
return 0 ;
V_50 = F_97 ( V_40 , V_3 ) ;
if ( V_50 < 0 )
goto V_102;
if ( V_40 -> V_44 [ V_3 ] . V_131 == V_179 )
return 0 ;
V_50 = F_103 ( V_40 , V_3 ) ;
if ( V_50 < 0 )
goto V_121;
F_7 ( V_40 , V_3 , V_200 ) ;
if ( V_40 -> V_44 [ V_3 ] . V_131 == V_180 ||
V_40 -> V_44 [ V_3 ] . V_131 == V_182 )
return 0 ;
if ( V_123 == V_197 ) {
F_9 ( V_40 -> V_46 , L_93 ,
V_40 -> V_24 -> V_47 ) ;
V_50 = F_56 ( V_27 , V_187 ) ;
if ( V_50 < 0 ) {
...
int F_112 ( struct V_144 * V_112 )
{
struct V_11 * V_40 ;
int V_202 , V_158 , V_153 ;
F_33 ( & V_112 -> V_184 , V_185 ) ;
...
V_158 = F_77 ( V_40 , V_6 , & V_150 , 1 ) ;
if ( V_158 ) {
F_110 ( V_40 , V_6 ) ;
F_78 ( V_40 , V_6 ) ;
F_65 ( V_40 , V_6 ) ;
}
V_202 = F_77 ( V_40 , V_6 , & V_150 , 0 ) ;
if ( V_202 ) {
F_111 ( V_40 , V_6 ) ;
F_78 ( V_40 , V_6 ) ;
F_65 ( V_40 , V_6 ) ;
...
V_158 = F_77 ( V_40 , V_110 , & V_150 , 1 ) ;
if ( V_158 ) {
F_110 ( V_40 , V_110 ) ;
F_78 ( V_40 , V_110 ) ;
F_65 ( V_40 , V_110 ) ;
}
V_202 = F_77 ( V_40 , V_110 , & V_150 , 0 ) ;
if ( V_202 ) {
F_111 ( V_40 , V_110 ) ;
F_78 ( V_40 , V_110 ) ;
F_65 ( V_40 , V_110 ) ;
...
int F_114 ( struct V_11 * V_40 , int V_203 )
{
struct V_43 * V_44 ;
struct V_204 * V_205 =
& V_40 -> V_44 [ V_6 ] . V_134 ;
...
for ( V_14 = 0 ; V_14 < V_45 -> V_17 ; V_14 ++ ) {
struct V_1 * V_2 = V_45 -> V_18 [ V_14 ] ;
struct V_64 * V_207 = V_2 -> V_7 ;
F_9 ( V_45 -> V_46 , L_100 ,
V_45 -> V_24 -> V_47 ) ;
if ( V_207 -> V_87 && V_207 -> V_87 -> V_208 &&
V_2 -> V_16 )
V_207 -> V_87 -> V_208 ( V_2 , V_203 ) ;
}
}
return 0 ;
}
static int F_115 ( struct V_26 * V_139 )
{
struct V_11 * V_40 = V_139 -> V_49 ;
struct V_43 * V_44 ;
struct V_149 * V_150 ;
...
int F_117 ( struct V_11 * V_12 , int V_209 )
{
struct V_83 * V_84 = V_12 -> V_84 ;
struct V_1 * V_69 ;
struct V_1 * V_13 = V_12 -> V_13 ;
...
if ( V_12 -> V_24 -> V_97 ) {
snprintf ( V_212 , sizeof( V_212 ) , L_102 ,
V_12 -> V_24 -> V_106 ) ;
V_50 = F_118 ( V_12 -> V_112 -> V_217 , V_212 , V_209 ,
V_8 , V_9 , & V_211 ) ;
} else {
if ( V_12 -> V_24 -> V_96 )
snprintf ( V_212 , sizeof( V_212 ) , L_103 ,
V_12 -> V_24 -> V_106 ) ;
else
snprintf ( V_212 , sizeof( V_212 ) , L_104 ,
V_12 -> V_24 -> V_106 ,
( V_12 -> V_17 > 1 ) ?
L_12 : V_12 -> V_69 -> V_47 , V_209 ) ;
V_50 = F_119 ( V_12 -> V_112 -> V_217 , V_212 , V_209 , V_8 ,
V_9 , & V_211 ) ;
}
if ( V_50 < 0 ) {
...
F_9 ( V_12 -> V_112 -> V_46 , L_106 , V_209 , V_212 ) ;
F_120 ( & V_12 -> V_105 , F_41 ) ;
V_211 -> V_218 = V_12 -> V_24 -> V_218 ;
V_12 -> V_211 = V_211 ;
V_211 -> V_49 = V_12 ;
if ( V_12 -> V_24 -> V_97 ) {
if ( V_8 )
V_211 -> V_219 [ V_6 ] . V_27 -> V_49 = V_12 ;
if ( V_9 )
V_211 -> V_219 [ V_110 ] . V_27 -> V_49 = V_12 ;
goto V_89;
}
if ( V_12 -> V_24 -> V_96 ) {
V_12 -> V_87 . V_90 = F_115 ;
V_12 -> V_87 . V_117 = F_99 ;
V_12 -> V_87 . V_111 = F_104 ;
V_12 -> V_87 . V_123 = F_102 ;
V_12 -> V_87 . V_121 = F_96 ;
V_12 -> V_87 . V_102 = F_116 ;
V_12 -> V_87 . V_128 = F_57 ;
V_12 -> V_87 . V_199 = F_106 ;
} else {
V_12 -> V_87 . V_90 = F_30 ;
...
if ( V_84 -> V_7 -> V_87 ) {
V_12 -> V_87 . V_220 = V_84 -> V_7 -> V_87 -> V_220 ;
V_12 -> V_87 . V_221 = V_84 -> V_7 -> V_87 -> V_221 ;
V_12 -> V_87 . V_222 = V_84 -> V_7 -> V_87 -> V_222 ;
V_12 -> V_87 . V_223 = V_84 -> V_7 -> V_87 -> V_223 ;
V_12 -> V_87 . V_224 = V_84 -> V_7 -> V_87 -> V_224 ;
}
if ( V_8 )
F_121 ( V_211 , V_6 , & V_12 -> V_87 ) ;
if ( V_9 )
F_121 ( V_211 , V_110 , & V_12 -> V_87 ) ;
if ( V_84 -> V_7 -> V_225 ) {
V_50 = V_84 -> V_7 -> V_225 ( V_12 ) ;
if ( V_50 < 0 ) {
F_13 ( V_84 -> V_46 ,
L_107 ,
V_50 ) ;
...
V_211 -> V_226 = V_84 -> V_7 -> V_227 ;
V_89:
F_122 ( V_12 -> V_112 -> V_46 , L_108 ,
( V_12 -> V_17 > 1 ) ? L_12 : V_12 -> V_69 -> V_47 ,
V_13 -> V_47 ) ;
return V_50 ;
}
int F_123 ( struct V_11 * V_40 , int V_3 )
{
if ( V_40 -> V_44 [ V_3 ] . V_156 == V_176 )
return 1 ;
return 0 ;
}
int F_81 ( struct V_11 * V_40 ,
struct V_11 * V_45 , int V_3 )
{
if ( ( V_40 -> V_44 [ V_3 ] . V_156 == V_176 ) ||
( ( V_40 -> V_44 [ V_3 ] . V_156 == V_157 ) &&
V_45 -> V_44 [ V_3 ] . V_156 ) )
return 1 ;
return 0 ;
}
...
{
return V_45 -> V_211 -> V_219 [ V_3 ] . V_27 ;
}
enum V_228
F_124 ( struct V_11 * V_45 , int V_3 )
{
return V_45 -> V_44 [ V_3 ] . V_131 ;
}
void F_125 ( struct V_11 * V_45 ,
int V_3 , enum V_228 V_131 )
{
V_45 -> V_44 [ V_3 ] . V_131 = V_131 ;
}
int F_95 ( struct V_11 * V_40 ,
struct V_11 * V_45 , int V_3 )
{
struct V_43 * V_44 ;
int V_131 ;
...
static char * F_127 ( enum V_228 V_131 )
{
switch ( V_131 ) {
case V_169 :
return L_109 ;
...
struct V_43 * V_44 ;
T_4 V_125 = 0 ;
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 ,
L_120 , V_40 -> V_24 -> V_47 ,
V_3 ? L_121 : L_122 ) ;
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 , L_123 ,
F_127 ( V_40 -> V_44 [ V_3 ] . V_131 ) ) ;
if ( ( V_40 -> V_44 [ V_3 ] . V_131 >= V_179 ) &&
( V_40 -> V_44 [ V_3 ] . V_131 <= V_182 ) )
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 ,
L_124
...
F_16 ( V_61 ) ,
F_15 ( V_61 ) ) ;
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 , L_126 ) ;
if ( F_105 ( & V_40 -> V_44 [ V_3 ] . V_134 ) ) {
V_125 += snprintf ( V_229 + V_125 , V_230 - V_125 ,
L_127 ) ;
goto V_89;
...
static T_4 F_130 ( struct V_231 * V_231 , char T_6 * V_232 ,
T_5 V_167 , T_7 * V_233 )
{
struct V_11 * V_40 = V_231 -> V_49 ;
T_4 V_234 = V_235 , V_125 = 0 , V_50 = 0 ;
char * V_229 ;
V_229 = F_131 ( V_234 , V_129 ) ;
if ( ! V_229 )
return - V_130 ;
if ( V_40 -> V_13 -> V_7 -> V_8 . V_81 )
V_125 += F_128 ( V_40 , V_6 ,
V_229 + V_125 , V_234 - V_125 ) ;
if ( V_40 -> V_13 -> V_7 -> V_9 . V_81 )
V_125 += F_128 ( V_40 , V_110 ,
V_229 + V_125 , V_234 - V_125 ) ;
V_50 = F_132 ( V_232 , V_167 , V_233 , V_229 , V_125 ) ;
F_69 ( V_229 ) ;
return V_50 ;
}
...
if ( ! V_12 -> V_112 -> V_236 )
return;
V_12 -> V_137 = F_134 ( V_12 -> V_24 -> V_47 ,
V_12 -> V_112 -> V_236 ) ;
if ( ! V_12 -> V_137 ) {
F_9 ( V_12 -> V_46 ,
L_131 ,
