...
int V_64 ;
T_3 V_65 , V_66 ;
struct V_67 * V_68 = V_9 -> V_69 -> V_70 . V_71 ;
struct V_72 * V_73 = V_68 -> V_74 ;
V_64 = F_1 ( V_9 -> V_1 . V_2 ) ;
if ( V_64 != 0 )
F_26 ( V_9 -> V_12 , L_1 ) ;
V_65 = ( ( T_3 ) V_12 -> V_75 [ 0 ] << 24 ) |
( ( T_3 ) V_12 -> V_75 [ 1 ] << 16 ) |
( ( T_3 ) V_12 -> V_75 [ 2 ] << 8 ) |
( T_3 ) V_12 -> V_75 [ 3 ] ;
V_66 = ( ( T_3 ) V_12 -> V_75 [ 4 ] << 24 ) |
( ( T_3 ) V_12 -> V_75 [ 5 ] << 16 ) ;
F_2 ( V_2 , V_76 , V_65 ) ;
F_2 ( V_2 , V_77 , V_66 ) ;
F_2 ( V_2 , V_56 , V_9 -> V_1 . V_20 ) ;
...
F_28 ( V_12 ) ;
#ifdef F_27
F_17 ( V_2 , V_84 , 0xC0000000 ) ;
#else
F_2 ( V_2 , V_85 , 0x78000000 ) ;
#endif
F_2 ( V_2 , V_86 , V_73 -> V_86 ) ;
F_2 ( V_2 , V_87 , 0xffc0 ) ;
#ifndef F_27
F_2 ( V_2 , V_88 , ( F_29 ( V_9 -> V_13 ) / 2 ) << 29 ) ;
F_2 ( V_2 , V_42 , V_89 ) ;
#else
F_17 ( V_2 , V_42 , V_33 -> V_90 ?
V_91 : V_89 ) ;
#endif
if ( V_9 -> V_69 -> V_92 ) {
F_22 ( V_2 , V_42 , V_93 ) ;
...
V_99 | V_100 ) ;
F_2 ( V_2 , V_4 , V_5 | V_101 ) ;
F_2 ( V_2 , V_102 , 0x01000000 ) ;
}
...
const struct V_32 * V_33 = V_9 -> V_33 ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
struct V_72 * V_103 = V_9 -> V_69 -> V_70 . V_71 -> V_74 ;
int V_3 ;
if ( ( F_3 ( V_2 , V_4 ) & V_101 ) == 0 )
return;
F_2 ( V_2 , V_94 , 0x01 ) ;
for ( V_3 = 0 ; ( ( F_3 ( V_2 , V_87 ) & 0x10000000 ) == 0 ) &&
V_3 < V_7 ; V_3 ++ )
F_4 ( 1 ) ;
if ( V_3 == V_7 )
F_31 ( V_9 -> V_12 , L_2 ) ;
...
V_91 :
V_89 ) ;
F_17 ( V_2 , V_4 , V_5 | V_101 ) ;
F_2 ( V_2 , V_87 , V_105 ) ;
F_2 ( V_2 , V_86 , V_103 -> V_86 ) ;
}
}
...
struct V_8 * V_9 = F_10 ( V_12 ) ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
F_2 ( V_2 , V_106 , 0x01000000 ) ;
}
static T_3 F_41 ( struct V_19 * V_12 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
return F_3 ( V_2 , V_87 ) & F_3 ( V_2 , V_96 ) ;
}
static void F_42 ( struct V_19 * V_12 , T_3 V_107 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
F_2 ( V_2 , V_87 , V_107 ) ;
}
static void F_43 ( struct V_19 * V_12 , T_3 V_107 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
F_31 ( V_9 -> V_12 , L_3 , V_107 ) ;
}
static int F_44 ( struct V_19 * V_12 , void * V_108 , int * V_109 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
if ( * V_109 < sizeof( struct V_1 ) )
return - V_16 ;
F_45 ( V_108 , V_9 -> V_1 . V_2 , sizeof( struct V_1 ) ) ;
return 0 ;
}
