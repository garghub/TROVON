...
V_12 = F_11 ( V_8 , V_24 , V_27 , V_15 -> V_6 , V_11 ) ;
if ( V_12 == NULL ) {
V_16 = - V_28 ;
goto V_26;
}
...
if ( ! V_41 )
return V_107 ;
if ( ! F_65 ( V_41 , sizeof( struct V_55 ) ) )
goto V_26;
V_56 = F_24 ( V_41 ) ;
V_46 = F_66 ( & V_56 -> V_65 ) ;
if ( V_46 < 2 )
goto V_26;
V_46 -= 2 ;
if ( ( V_46 > V_41 -> V_46 ) || F_67 ( V_41 , V_46 ) )
goto V_26;
F_20 ( V_41 ) ;
F_68 ( V_41 , & V_106 ) ;
if ( F_69 ( & V_106 ) == V_60 ) {
...
if ( F_48 ( & V_106 ) == 0 ) {
struct V_10 * V_12 = F_52 ( V_8 , V_106 . V_108 ) ;
if ( V_12 )
return F_71 ( V_12 , V_41 , 0 ) ;
}
if ( F_41 ( V_8 , F_69 ( & V_106 ) ) == 0 ) {
struct V_10 * V_12 = F_72 ( V_8 , & V_106 ) ;
if ( V_12 )
return F_71 ( V_12 , V_41 , 0 ) ;
if ( F_58 ( V_41 ) ) {
F_61 ( V_41 ) ;
...
struct V_42 * V_109 ;
V_109 = F_54 ( V_8 , F_69 ( & V_106 ) ) ;
if ( ! V_109 ) {
F_73 ( L_2 ,
F_69 ( & V_106 ) ) ;
goto V_26;
}
F_74 ( V_41 , sizeof( struct V_55 ) ) ;
V_41 -> V_43 = V_109 ;
if ( V_109 == V_43 ) {
F_73 ( L_3 ,
F_69 ( & V_106 ) ,
...
if ( F_75 ( V_41 , V_109 -> V_111 ) )
goto V_109;
if ( F_33 ( V_41 , V_109 , V_48 , NULL , NULL ,
V_41 -> V_46 ) < 0 )
goto V_109;
F_35 ( V_41 ) ;
F_57 ( V_109 ) ;
...
void F_81 ( unsigned int V_2 , struct V_1 * V_3 )
{
F_78 ( & V_114 ) ;
F_82 ( V_5 [ V_2 ] != V_3 ) ;
F_83 ( V_5 [ V_2 ] , NULL ) ;
