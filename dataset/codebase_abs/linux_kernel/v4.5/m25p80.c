...
int V_11 ;
V_41 = F_15 ( & V_10 -> V_12 ) ;
V_7 = F_16 ( & V_10 -> V_12 , sizeof( * V_7 ) , V_46 ) ;
if ( ! V_7 )
return - V_47 ;
V_2 = & V_7 -> V_1 ;
V_2 -> V_48 = F_13 ;
...
V_2 -> V_51 = F_1 ;
V_2 -> V_12 = & V_10 -> V_12 ;
F_17 ( V_2 , V_10 -> V_12 . V_52 ) ;
V_2 -> V_8 = V_7 ;
F_18 ( V_10 , V_7 ) ;
V_7 -> V_10 = V_10 ;
if ( V_10 -> V_43 & V_53 )
V_43 = V_33 ;
else if ( V_10 -> V_43 & V_54 )
V_43 = V_32 ;
if ( V_41 && V_41 -> V_55 )
V_2 -> V_56 . V_55 = V_41 -> V_55 ;
if ( V_41 && V_41 -> type )
V_45 = V_41 -> type ;
else if ( ! strcmp ( V_10 -> V_57 , L_2 ) )
V_45 = NULL ;
else
V_45 = V_10 -> V_57 ;
V_11 = F_19 ( V_2 , V_45 , V_43 ) ;
if ( V_11 )
return V_11 ;
return F_20 ( & V_2 -> V_56 , V_41 ? V_41 -> V_58 : NULL ,
V_41 ? V_41 -> V_59 : 0 ) ;
}
static int F_21 ( struct V_9 * V_10 )
{
struct V_6 * V_7 = F_22 ( V_10 ) ;
return F_23 ( & V_7 -> V_1 . V_56 ) ;
}
