...
if ( V_47 )
goto V_64;
V_47 = F_31 ( V_3 -> V_21 , V_5 , V_24 . V_65 ) ;
if ( V_47 )
goto V_66;
F_32 ( V_3 -> V_21 , true ) ;
V_47 = F_33 ( V_3 -> V_21 , & V_24 ) ;
if ( V_47 )
goto V_66;
F_34 ( V_3 -> V_21 , V_24 . V_67 ,
V_24 . V_68 ) ;
V_47 = F_35 ( V_5 , V_29 ) ;
if ( F_36 ( V_47 < 0 ) )
goto V_69;
V_70 . V_71 = V_29 [ V_72 ] . V_33 ;
if ( F_2 ( V_6 ) && ! V_8 [ 0 ] ) {
struct V_73 * V_74 ;
V_74 = F_37 ( V_6 ) ;
if ( ! V_74 )
...
static int F_45 ( struct V_23 * V_5 )
{
#ifdef F_16
F_9 ( V_38 ) ;
#endif
