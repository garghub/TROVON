...
static void F_65 ( int V_95 , T_1 V_1 )
{
switch ( V_95 ) {
case 0 :
...
static void F_68 ( T_1 * V_96 , T_1 * V_97 )
{
T_1 V_98 ;
T_1 V_99 ;
F_69 ( F_70 () ) ;
* V_96 = F_71 () ;
V_98 = * V_96 | F_72 ( 10 ) | F_72 ( 11 ) ;
F_73 ( V_98 ) ;
* V_97 = F_74 ( V_100 ) ;
V_99 = * V_97 | V_101 ;
F_75 ( V_100 , V_99 ) ;
}
static void F_76 ( T_1 V_96 , T_1 V_97 )
{
F_69 ( F_70 () ) ;
F_75 ( V_100 , V_97 ) ;
F_3 () ;
...
static T_1 F_77 ( unsigned int V_102 )
{
static const T_1 V_103 [] = { V_104 ,
V_105 ,
V_106 } ;
return V_103 [ V_102 ] ;
}
...
T_1 V_107 ;
T_1 V_108 , V_109 ;
unsigned int V_102 = F_79 ( V_27 ) ;
unsigned int V_110 = F_80 ( V_27 ) ;
unsigned int V_111 = F_81 ( V_27 ) ;
unsigned int V_112 ;
bool V_113 = F_82 ( V_27 ) ;
V_112 = V_110 * 8 ;
V_107 = 0xff << V_112 ;
if ( V_113 )
V_1 = V_114 ;
...
static T_1 F_83 ( T_1 V_1 , int V_110 )
{
T_1 V_107 ;
int V_112 ;
V_112 = V_110 * 8 ;
...
static int F_88 ( struct V_10 * V_11 , unsigned int V_102 ,
unsigned int V_110 )
{
int V_117 ;
struct V_13 * V_14 = & V_11 -> V_15 ;
...
int V_117 = - 1 ;
struct V_13 * V_14 = & V_11 -> V_15 ;
unsigned int V_102 = F_79 ( V_14 -> V_27 ) ;
unsigned int V_111 = F_81 ( V_14 -> V_27 ) ;
unsigned int V_110 = F_80 ( V_14 -> V_27 ) ;
bool V_113 = F_82 ( V_14 -> V_27 ) ;
bool V_119 = F_90 ( V_14 -> V_27 ) ;
if ( V_113 || V_119 ) {
if ( V_110 > 3 || V_102 > 2 )
return - V_120 ;
if ( V_113 && ( V_111 & 0xe0 ) )
return - V_120 ;
V_117 = F_88 ( V_11 , V_102 , V_110 ) ;
if ( F_39 ( V_117 , V_32 -> V_44 ) )
return - V_45 ;
}
V_7 = F_38 ( V_32 , V_11 ) ;
if ( V_7 < 0 && V_117 >= 0 )
F_91 ( V_117 , V_32 -> V_44 ) ;
return V_7 ;
}
...
static void F_96 ( int V_95 , T_1 V_1 )
{
switch ( V_95 ) {
case 0 :
...
static T_1 F_97 ( unsigned int V_102 )
{
static const T_1 V_103 [] = { V_124 ,
V_125 ,
V_126 ,
V_127 } ;
return V_103 [ V_102 ] ;
...
static int F_103 ( struct V_10 * V_11 , unsigned int V_102 ,
unsigned int V_110 )
{
int V_117 ;
struct V_13 * V_14 = & V_11 -> V_15 ;
...
unsigned int V_110 = F_80 ( V_14 -> V_27 ) ;
bool V_113 = F_82 ( V_14 -> V_27 ) ;
bool V_129 = F_90 ( V_14 -> V_27 ) ;
if ( V_113 || V_129 ) {
if ( V_110 > 3 || V_102 > 3 )
return - V_120 ;
V_117 = F_103 ( V_11 , V_102 , V_110 ) ;
if ( F_39 ( V_117 , V_32 -> V_44 ) )
return - V_45 ;
}
V_7 = F_38 ( V_32 , V_11 ) ;
