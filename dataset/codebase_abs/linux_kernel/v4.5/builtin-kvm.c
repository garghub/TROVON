...
V_14 -> V_61 *= V_233 ;
V_107 = F_139 ( & V_14 -> V_85 . V_86 ) ;
if ( V_107 ) {
F_140 ( & V_14 -> V_85 . V_86 , V_107 , V_215 , V_216 ) ;
F_141 ( L_3 , V_215 ) ;
}
if ( F_142 ( & V_14 -> V_85 . V_86 ) )
V_14 -> V_85 . V_86 . V_87 = true ;
V_14 -> V_120 = F_127 () ;
if ( V_14 -> V_120 == NULL ) {
V_107 = - 1 ;
...
if ( F_143 ( V_14 -> V_120 , & V_14 -> V_85 . V_86 ) < 0 )
F_126 ( V_221 , V_217 ) ;
V_14 -> V_112 = F_106 ( & V_189 , false , & V_14 -> V_103 ) ;
if ( V_14 -> V_112 == NULL ) {
V_107 = - 1 ;
...
F_144 ( V_14 -> V_112 ) ;
F_145 ( & V_14 -> V_112 -> V_126 , true ) ;
F_146 ( & V_14 -> V_112 -> V_237 . V_238 , & V_14 -> V_85 . V_86 ,
...
static int F_148 ( const char * V_191 , int V_196 , const char * * V_197 )
{
struct V_13 V_14 = {
. V_191 = V_191 ,
. V_60 = - 1 ,
...
#endif
V_240:
return F_150 ( V_196 , V_197 , NULL ) ;
}
static int F_151 ( const char * V_191 , int V_196 , const char * * V_197 )
{
...
V_200 [ V_28 ] = V_197 [ V_35 ] ;
F_22 ( V_28 != V_198 ) ;
return F_153 ( V_28 , V_200 , NULL ) ;
}
static int
F_154 ( const char * V_191 , int V_196 , const char * * V_197 )
{
int V_198 , V_28 = 0 , V_35 ;
const char * * V_200 ;
V_198 = V_196 + 2 ;
...
int F_156 ( int V_196 , const char * * V_197 , const char * T_6 V_12 )
{
...
V_243 = 0 ;
V_242 = 1 ;
V_196 = F_157 ( V_196 , V_197 , V_241 , V_248 , V_249 ,
V_250 ) ;
if ( ! V_196 )
F_126 ( V_249 , V_241 ) ;
if ( ! V_243 )
...
return F_148 ( V_191 , V_196 , V_197 ) ;
#endif
else
F_126 ( V_249 , V_241 ) ;
return 0 ;
