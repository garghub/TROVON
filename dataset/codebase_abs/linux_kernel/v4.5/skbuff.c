...
static unsigned char * F_211 ( struct V_1 * V_2 , unsigned V_6 )
{
F_131 ( V_2 , V_6 ) ;
F_212 ( V_2 , V_2 -> V_8 , V_6 ) ;
return V_2 -> V_8 ;
}
unsigned char * F_213 ( struct V_1 * V_2 , unsigned int V_6 )
{
...
struct V_1 * F_216 ( struct V_1 * V_236 ,
T_9 V_237 )
{
...
unsigned int V_240 = V_236 -> V_8 - F_217 ( V_236 ) ;
struct V_1 * V_241 = V_236 ;
unsigned int V_139 = V_240 ;
unsigned int V_242 = F_218 ( V_236 ) ;
unsigned int V_124 ;
unsigned int V_6 ;
T_10 V_243 ;
bool V_179 ;
...
V_97 -> V_100 = V_9 ;
if ( V_236 -> V_92 == V_256 ) {
F_228 ( V_9 -> V_27 , V_236 -> V_27 ) ;
F_228 ( V_9 -> V_92 , V_236 -> V_92 ) ;
F_228 ( V_9 -> V_101 , V_236 -> V_101 ) ;
}
return V_97 ;
V_135:
F_51 ( V_97 ) ;
...
int F_229 ( struct V_1 * * V_7 , struct V_1 * V_2 )
{
struct V_32 * V_257 , * V_258 = F_23 ( V_2 ) ;
unsigned int V_139 = F_230 ( V_2 ) ;
unsigned int V_259 = F_113 ( V_2 ) ;
unsigned int V_6 = F_231 ( V_2 ) ;
struct V_1 * V_260 , * V_261 = * V_7 ;
unsigned int V_262 ;
if ( F_42 ( V_261 -> V_6 + V_6 >= 65536 ) )
return - V_263 ;
V_260 = F_232 ( V_261 ) -> V_264 ;
V_257 = F_23 ( V_260 ) ;
if ( V_259 <= V_139 ) {
T_4 * V_75 ;
T_4 * V_265 ;
...
F_214 ( V_2 , V_139 ) ;
if ( F_232 ( V_261 ) -> V_264 == V_261 )
F_23 ( V_261 ) -> V_78 = V_2 ;
else
F_232 ( V_261 ) -> V_264 -> V_98 = V_2 ;
F_232 ( V_261 ) -> V_264 = V_2 ;
F_233 ( V_2 ) ;
V_260 = V_261 ;
V_142:
F_232 ( V_261 ) -> V_270 ++ ;
...
static int
F_236 ( struct V_1 * V_2 , struct V_274 * V_244 , int V_139 , int V_6 )
{
int V_150 = F_113 ( V_2 ) ;
int V_71 , V_152 = V_150 - V_139 ;
struct V_1 * V_151 ;
...
if ( V_152 > V_6 )
V_152 = V_6 ;
F_237 ( V_244 , V_2 -> V_8 + V_139 , V_152 ) ;
V_275 ++ ;
if ( ( V_6 -= V_152 ) == 0 )
return V_275 ;
V_139 += V_152 ;
...
if ( V_152 > V_6 )
V_152 = V_6 ;
F_238 ( & V_244 [ V_275 ] , F_94 ( V_75 ) , V_152 ,
...
if ( V_152 > V_6 )
V_152 = V_6 ;
V_275 += F_236 ( V_151 , V_244 + V_275 , V_139 - V_150 ,
V_152 ) ;
if ( ( V_6 -= V_152 ) == 0 )
return V_275 ;
V_139 += V_152 ;
...
int F_239 ( struct V_1 * V_2 , struct V_274 * V_244 ,
int V_139 , int V_6 )
{
return F_236 ( V_2 , V_244 , V_139 , V_6 ) ;
}
int F_240 ( struct V_1 * V_2 , struct V_274 * V_244 , int V_139 , int V_6 )
{
int V_276 = F_236 ( V_2 , V_244 , V_139 , V_6 ) ;
F_241 ( & V_244 [ V_276 - 1 ] ) ;
return V_276 ;
}
int F_242 ( struct V_1 * V_2 , int V_277 , struct V_1 * * V_278 )
{
int V_279 ;
int V_275 ;
struct V_1 * V_44 , * * V_280 ;
if ( ( F_121 ( V_2 ) || F_23 ( V_2 ) -> V_83 ) &&
F_140 ( V_2 , F_243 ( V_2 ) - F_113 ( V_2 ) ) == NULL )
return - V_109 ;
if ( ! F_116 ( V_2 ) ) {
if ( F_127 ( V_2 ) < V_277 &&
...
F_246 ( V_2 -> V_27 , & V_101 -> V_281 ) ;
}
int F_247 ( struct V_158 * V_101 , struct V_1 * V_2 )
{
...
if ( ! F_250 ( V_101 , V_284 ) )
V_101 -> V_285 ( V_101 ) ;
return 0 ;
}
struct V_1 * F_251 ( struct V_158 * V_101 )
{
...
V_2 = F_177 ( V_286 ) ;
if ( V_2 && ( V_287 = F_252 ( V_286 ) ) )
V_135 = F_253 ( V_287 ) -> V_288 . V_289 ;
...
struct V_1 * F_254 ( struct V_1 * V_2 )
{
struct V_158 * V_101 = V_2 -> V_101 ;
struct V_1 * V_147 ;
if ( ! V_101 || ! F_255 ( & V_101 -> V_292 ) )
return NULL ;
...
V_101 -> V_307 == V_308 )
V_296 -> V_288 . V_303 -= V_101 -> V_309 ;
}
V_135 = F_247 ( V_101 , V_2 ) ;
if ( V_135 )
F_76 ( V_2 ) ;
}
static bool F_258 ( struct V_158 * V_101 , bool V_310 )
{
bool V_171 ;
if ( F_74 ( V_311 || V_310 ) )
return true ;
F_259 ( & V_101 -> V_312 ) ;
V_171 = V_101 -> V_313 && V_101 -> V_313 -> V_314 &&
F_260 ( V_101 -> V_313 -> V_314 , & V_315 , V_316 ) ;
F_261 ( & V_101 -> V_312 ) ;
return V_171 ;
}
...
{
struct V_158 * V_101 = V_2 -> V_101 ;
if ( ! F_258 ( V_101 , false ) )
return;
F_263 ( V_101 ) ;
* F_264 ( V_2 ) = * V_318 ;
F_257 ( V_2 , V_101 , V_319 ) ;
F_256 ( V_101 ) ;
}
void F_265 ( struct V_1 * V_320 ,
struct V_317 * V_318 ,
...
if ( ! V_101 )
return;
V_310 = V_101 -> V_301 & V_321 ;
if ( ! F_258 ( V_101 , V_310 ) )
return;
if ( V_310 )
V_2 = F_266 ( 0 , V_52 ) ;
else
V_2 = F_101 ( V_320 , V_52 ) ;
if ( ! V_2 )
return;
if ( V_310 ) {
F_23 ( V_2 ) -> V_84 = F_23 ( V_320 ) -> V_84 ;
F_23 ( V_2 ) -> V_304 = F_23 ( V_320 ) -> V_304 ;
}
if ( V_318 )
* F_264 ( V_2 ) = * V_318 ;
else
V_2 -> V_322 = F_267 () ;
F_257 ( V_2 , V_101 , V_294 ) ;
}
void F_268 ( struct V_1 * V_320 ,
struct V_317 * V_318 )
{
return F_265 ( V_320 , V_318 , V_320 -> V_101 ,
V_319 ) ;
}
void F_269 ( struct V_1 * V_2 , bool V_323 )
{
struct V_158 * V_101 = V_2 -> V_101 ;
struct V_295 * V_296 ;
int V_135 ;
...
bool F_270 ( struct V_1 * V_2 , T_12 V_150 , T_12 V_73 )
{
...
if ( V_327 > V_2 -> V_6 )
V_327 = V_2 -> V_6 ;
if ( F_140 ( V_2 , V_327 - F_113 ( V_2 ) ) == NULL )
return - V_109 ;
if ( F_113 ( V_2 ) < V_6 )
return - V_328 ;
return 0 ;
}
static int F_273 ( struct V_1 * V_2 , bool V_329 )
{
unsigned int V_73 ;
bool V_330 ;
V_193 * V_179 ;
...
if ( V_135 < 0 )
goto V_23;
if ( F_274 ( V_2 ) -> V_333 & F_275 ( V_334 | V_335 ) )
V_330 = true ;
V_73 = F_276 ( V_2 ) ;
V_135 = - V_328 ;
if ( V_330 )
goto V_23;
V_179 = F_277 ( V_2 , F_274 ( V_2 ) -> V_336 , V_73 ) ;
if ( F_278 ( V_179 ) )
return F_279 ( V_179 ) ;
if ( V_329 )
* V_179 = ~ F_280 ( F_274 ( V_2 ) -> V_337 ,
F_274 ( V_2 ) -> V_338 ,
V_2 -> V_6 - V_73 ,
F_274 ( V_2 ) -> V_336 , 0 ) ;
V_135 = 0 ;
...
static int F_281 ( struct V_1 * V_2 , bool V_329 )
{
int V_135 ;
T_3 V_339 ;
unsigned int V_73 ;
...
V_330 = false ;
V_142 = false ;
V_73 = sizeof( struct V_340 ) ;
V_135 = F_272 ( V_2 , V_73 , V_341 ) ;
if ( V_135 < 0 )
goto V_23;
V_339 = F_282 ( V_2 ) -> V_339 ;
V_6 = sizeof( struct V_340 ) + F_283 ( F_282 ( V_2 ) -> V_342 ) ;
...
if ( V_135 < 0 )
goto V_23;
V_347 = F_284 ( struct V_346 , V_2 , V_73 ) ;
V_339 = V_347 -> V_339 ;
V_73 += F_285 ( V_347 ) ;
break;
}
...
if ( V_135 < 0 )
goto V_23;
V_347 = F_284 ( struct V_349 , V_2 , V_73 ) ;
V_339 = V_347 -> V_339 ;
V_73 += F_286 ( V_347 ) ;
break;
}
...
if ( V_135 < 0 )
goto V_23;
V_347 = F_284 ( struct V_351 , V_2 , V_73 ) ;
if ( V_347 -> V_333 & F_275 ( V_352 | V_353 ) )
V_330 = true ;
V_339 = V_347 -> V_339 ;
V_73 += sizeof( struct V_351 ) ;
break;
}
default:
V_142 = true ;
...
if ( ! V_142 || V_330 )
goto V_23;
V_179 = F_277 ( V_2 , V_339 , V_73 ) ;
if ( F_278 ( V_179 ) )
return F_279 ( V_179 ) ;
if ( V_329 )
* V_179 = ~ F_287 ( & F_282 ( V_2 ) -> V_337 ,
& F_282 ( V_2 ) -> V_338 ,
V_2 -> V_6 - V_73 , V_339 , 0 ) ;
V_135 = 0 ;
V_23:
return V_135 ;
}
int F_288 ( struct V_1 * V_2 , bool V_329 )
{
int V_135 ;
switch ( V_2 -> V_336 ) {
case F_275 ( V_354 ) :
V_135 = F_273 ( V_2 , V_329 ) ;
break;
case F_275 ( V_355 ) :
V_135 = F_281 ( V_2 , V_329 ) ;
break;
default:
V_135 = - V_328 ;
break;
...
static struct V_1 * F_289 ( struct V_1 * V_2 ,
unsigned int V_356 )
{
struct V_1 * V_357 ;
unsigned int V_6 = F_290 ( V_2 ) + V_356 ;
int V_171 ;
if ( V_2 -> V_6 < V_6 )
return NULL ;
else if ( V_2 -> V_6 == V_6 )
return V_2 ;
V_357 = F_101 ( V_2 , V_52 ) ;
if ( ! V_357 )
return NULL ;
V_171 = F_291 ( V_357 , V_6 ) ;
if ( V_171 ) {
F_76 ( V_357 ) ;
return NULL ;
}
...
struct V_1 * F_292 ( struct V_1 * V_2 ,
unsigned int V_356 ,
V_193 (* F_293)( struct V_1 * V_2 ) )
{
struct V_1 * V_357 ;
unsigned int V_139 = F_290 ( V_2 ) ;
V_193 V_171 ;
V_357 = F_289 ( V_2 , V_356 ) ;
if ( ! V_357 )
goto V_135;
if ( ! F_294 ( V_357 , V_139 ) )
goto V_135;
F_213 ( V_357 , V_139 ) ;
V_171 = F_293 ( V_357 ) ;
F_211 ( V_357 , V_139 ) ;
...
void F_295 ( const struct V_1 * V_2 )
{
F_227 ( L_7 ,
V_2 -> V_11 -> V_12 ) ;
}
void F_296 ( struct V_1 * V_2 , bool V_358 )
{
if ( V_358 ) {
F_64 ( V_2 ) ;
F_27 ( V_25 , V_2 ) ;
...
bool F_297 ( struct V_1 * V_149 , struct V_1 * V_178 ,
bool * V_359 , int * V_262 )
{
...
void F_299 ( struct V_1 * V_2 , bool V_360 )
{
V_2 -> V_322 . V_361 = 0 ;
V_2 -> V_362 = V_363 ;
V_2 -> V_364 = 0 ;
...
unsigned int F_304 ( const struct V_1 * V_2 )
{
...
V_367 = F_305 ( V_2 ) -
F_306 ( V_2 ) ;
if ( F_74 ( V_33 -> V_122 & ( V_369 | V_370 ) ) )
V_367 += F_307 ( V_2 ) ;
} else if ( F_74 ( V_33 -> V_122 & ( V_369 | V_370 ) ) ) {
V_367 = F_308 ( V_2 ) ;
}
return V_367 + V_33 -> V_120 ;
}
static struct V_1 * F_309 ( struct V_1 * V_2 )
{
if ( F_310 ( V_2 , F_86 ( V_2 ) ) < 0 ) {
F_76 ( V_2 ) ;
return NULL ;
}
memmove ( V_2 -> V_8 - V_371 , V_2 -> V_8 - V_2 -> V_102 - V_372 ,
2 * V_373 ) ;
V_2 -> V_29 += V_372 ;
return V_2 ;
}
struct V_1 * F_311 ( struct V_1 * V_2 )
{
struct V_374 * V_375 ;
T_12 V_376 ;
if ( F_42 ( F_312 ( V_2 ) ) ) {
...
if ( F_42 ( ! V_2 ) )
goto V_377;
if ( F_42 ( ! F_294 ( V_2 , V_372 ) ) )
goto V_377;
V_375 = (struct V_374 * ) V_2 -> V_8 ;
V_376 = F_283 ( V_375 -> V_378 ) ;
F_314 ( V_2 , V_2 -> V_336 , V_376 ) ;
F_213 ( V_2 , V_372 ) ;
F_315 ( V_2 , V_375 ) ;
V_2 = F_309 ( V_2 ) ;
if ( F_42 ( ! V_2 ) )
...
int F_318 ( struct V_1 * V_2 , int V_379 )
{
if ( ! F_294 ( V_2 , V_379 ) )
return - V_109 ;
if ( ! F_121 ( V_2 ) || F_319 ( V_2 , V_379 ) )
return 0 ;
return F_117 ( V_2 , 0 , 0 , V_52 ) ;
}
static int F_320 ( struct V_1 * V_2 , T_12 * V_376 )
{
struct V_374 * V_375 ;
unsigned int V_139 = V_2 -> V_8 - F_217 ( V_2 ) ;
int V_135 ;
F_219 ( V_2 , V_139 ) ;
V_135 = F_318 ( V_2 , V_380 ) ;
if ( F_42 ( V_135 ) )
goto V_381;
F_215 ( V_2 , V_2 -> V_8 + ( 2 * V_373 ) , V_372 ) ;
V_375 = (struct V_374 * ) ( V_2 -> V_8 + V_371 ) ;
* V_376 = F_283 ( V_375 -> V_378 ) ;
memmove ( V_2 -> V_8 + V_372 , V_2 -> V_8 , 2 * V_373 ) ;
F_214 ( V_2 , V_372 ) ;
F_315 ( V_2 , V_375 ) ;
V_2 -> V_29 += V_372 ;
if ( F_321 ( V_2 ) < V_371 )
...
if ( F_42 ( ( V_2 -> V_336 != F_275 ( V_383 ) &&
V_2 -> V_336 != F_275 ( V_384 ) ) ||
V_2 -> V_6 < V_380 ) )
return 0 ;
V_135 = F_320 ( V_2 , & V_376 ) ;
if ( V_135 )
return V_135 ;
}
if ( F_74 ( ( V_2 -> V_336 != F_275 ( V_383 ) &&
V_2 -> V_336 != F_275 ( V_384 ) ) ||
V_2 -> V_6 < V_380 ) )
return 0 ;
V_382 = V_2 -> V_336 ;
...
if ( F_42 ( V_135 ) )
return V_135 ;
F_314 ( V_2 , V_382 , V_376 ) ;
return 0 ;
}
int F_324 ( struct V_1 * V_2 , T_10 V_382 , T_12 V_376 )
{
if ( F_312 ( V_2 ) ) {
unsigned int V_139 = V_2 -> V_8 - F_217 ( V_2 ) ;
int V_135 ;
F_219 ( V_2 , V_139 ) ;
V_135 = F_325 ( V_2 , V_2 -> V_382 ,
F_326 ( V_2 ) ) ;
if ( V_135 )
return V_135 ;
V_2 -> V_336 = V_2 -> V_382 ;
...
F_214 ( V_2 , V_139 ) ;
if ( V_2 -> V_111 == V_385 )
V_2 -> V_179 = F_327 ( V_2 -> V_179 , F_328 ( V_2 -> V_8
+ ( 2 * V_373 ) , V_372 , 0 ) ) ;
}
F_314 ( V_2 , V_382 , V_376 ) ;
return 0 ;
}
struct V_1 * F_329 ( unsigned long V_386 ,
unsigned long V_74 ,
int V_387 ,
int * V_388 ,
T_2 V_24 )
{
int V_389 = ( V_74 + ( V_62 - 1 ) ) >> V_390 ;
unsigned long V_391 ;
struct V_1 * V_2 ;
struct V_72 * V_72 ;
T_2 V_392 ;
...
V_392 |= V_393 ;
* V_388 = - V_394 ;
V_2 = F_266 ( V_386 , V_392 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_27 += V_389 << V_390 ;
for ( V_71 = 0 ; V_389 > 0 ; V_71 ++ ) {
int V_395 = V_387 ;
while ( V_395 ) {
if ( V_389 >= 1 << V_395 ) {
V_72 = F_330 ( ( V_24 & ~ V_63 ) |
V_396 |
V_22 |
V_397 ,
V_395 ) ;
...
goto V_399;
V_398:
V_391 = F_148 (unsigned long, data_len,
PAGE_SIZE << order) ;
F_47 ( V_2 , V_71 , V_72 , 0 , V_391 ) ;
V_74 -= V_391 ;
V_389 -= 1 << V_395 ;
}
return V_2 ;
