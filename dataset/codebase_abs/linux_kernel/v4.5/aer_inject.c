...
static T_1 * F_14 ( struct V_1 * V_2 , int V_22 ,
int * V_23 )
{
int V_24 = 0 ;
T_1 * V_25 = NULL ;
...
int V_6 , V_66 ;
T_1 V_67 , V_68 , V_69 , V_70 = 0 , V_71 = 0 ;
int V_72 = 0 ;
V_9 = F_32 ( V_59 -> V_3 , V_59 -> V_4 , V_5 ) ;
if ( ! V_9 )
return - V_73 ;
V_63 = F_23 ( V_9 ) ;
if ( ! V_63 ) {
...
static T_2 F_41 ( struct V_91 * V_92 , const char T_3 * V_93 ,
T_4 V_94 , T_5 * V_95 )
{
struct V_58 V_59 ;
int V_72 ;
