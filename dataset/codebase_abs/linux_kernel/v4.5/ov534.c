...
struct V_166 * V_167 = & V_164 -> V_168 ;
struct V_30 * V_30 = (struct V_30 * ) V_1 ;
if ( V_167 -> V_171 == 0 || V_167 -> V_172 == 0 )
V_30 -> V_45 = 30 ;
else
V_30 -> V_45 = V_167 -> V_172 / V_167 -> V_171 ;
if ( V_1 -> V_67 )
F_14 ( V_1 ) ;
V_167 -> V_171 = 1 ;
V_167 -> V_172 = V_30 -> V_45 ;
}
static int F_52 ( struct V_173 * V_174 , const struct V_57 * V_58 )
{
return F_53 ( V_174 , V_58 , & V_175 , sizeof( struct V_30 ) ,
V_176 ) ;
}
