...
T_8 V_5 ;
V_5 = F_135 ( V_215 , V_64 -> V_221 [ V_11 ] , 0 , V_41 ,
V_225 ) ;
if ( F_136 ( V_215 , V_5 ) ) {
while ( V_11 -- ) {
F_137 ( V_215 , V_111 -> V_112 [ V_11 ] ,
V_41 , V_225 ) ;
V_111 -> V_112 [ V_11 ] = 0 ;
}
F_138 ( V_64 ) ;
...
#ifdef F_132
if ( F_133 () ) {
F_140 ( ( void * ) V_64 , V_2 -> V_2 ) ;
return;
}
#endif
for ( V_11 = 0 ; V_11 < V_64 -> V_71 ; V_11 ++ ) {
if ( V_111 -> V_112 [ V_11 ] ) {
F_137 ( V_215 , V_111 -> V_112 [ V_11 ] , V_41 ,
V_225 ) ;
}
}
F_138 ( V_64 ) ;
...
void
F_142 ( struct V_28 * V_29 , struct V_22 * V_19 , bool V_227 )
{
struct V_45 * V_203 = V_29 -> V_26 . V_203 ;
if ( V_227 )
F_143 ( V_203 , & V_19 -> V_188 ) ;
else if ( V_19 )
F_144 ( V_203 , & V_19 -> V_188 ) ;
}
struct V_199 *
...
int
F_146 ( struct V_28 * V_29 , struct V_228 * V_54 ,
struct V_199 * V_159 )
{
...
F_147 ( & V_159 -> V_61 , & V_29 -> V_63 ) ;
V_159 -> V_229 = 1 ;
return 0 ;
}
void
F_148 ( struct V_28 * V_29 , struct V_199 * V_159 )
{
if ( V_159 -> V_158 ) {
if ( V_29 -> V_26 . V_70 . V_99 != V_136 )
F_113 ( V_159 ) ;
