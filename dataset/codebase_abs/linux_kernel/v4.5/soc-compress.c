...
if ( V_52 -> V_11 -> V_53 . V_115 )
V_53 = 1 ;
if ( V_52 -> V_11 -> V_112 . V_115 )
V_112 = 1 ;
V_112 = V_112 && V_58 -> V_11 -> V_112 . V_115 ;
V_53 = V_53 && V_58 -> V_11 -> V_53 . V_115 ;
if ( V_53 + V_112 != 1 ) {
...
V_4 -> V_17 -> V_54 ,
V_4 -> V_52 -> V_15 , V_105 ) ;
V_8 = F_51 ( V_4 -> V_35 -> V_124 , V_105 , V_20 ,
V_111 , V_108 ) ;
if ( V_8 < 0 ) {
F_3 ( L_19 ,
V_91 -> V_14 . V_15 ) ;
