...
if ( F_48 ( V_164 , V_172 ) &&
F_48 ( V_163 , V_173 ) &&
( strncmp ( V_170 , L_48 , strlen ( L_48 ) ) == 0 ) )
return 0 ;
if ( strcmp ( V_164 , L_49 ) == 0 &&
F_48 ( V_163 , V_173 ) &&
( strncmp ( V_170 , L_50 , strlen ( L_50 ) ) == 0 ) )
return 0 ;
if ( F_48 ( V_164 , V_174 ) &&
F_48 ( V_163 , V_173 ) &&
...
{
return V_4 [ 0 ] == '$' && strchr ( L_51 , V_4 [ 1 ] )
&& ( V_4 [ 2 ] == '\0' || V_4 [ 2 ] == '.' ) ;
}
...
if ( * V_22 == '.' )
V_22 ++ ;
if ( strstr ( V_22 , L_52 ) != NULL )
strcat ( V_15 , L_53 ) ;
else if ( strstr ( V_22 , L_54 ) != NULL )
strcat ( V_15 , L_55 ) ;
else
strcat ( V_15 , L_56 ) ;
return V_189 ;
...
{
switch ( V_192 ) {
case 0 : * V_14 = L_60 ; * V_193 = L_15 ; break;
case 1 : * V_14 = L_61 ; * V_193 = L_62 ; break;
default: * V_14 = L_63 ; * V_193 = L_15 ; break;
}
}
...
{
T_2 V_258 = strcspn ( V_22 , L_121 ) ;
if ( V_258 && V_22 [ V_258 ] ) {
T_2 V_259 = strspn ( V_22 + V_258 + 1 , L_122 ) ;
...
V_261 = F_44 ( V_67 . V_114 , V_67 . V_115 , L_123 ) ;
...
( F_5 ( V_6 ) && V_263 ) )
F_82 ( V_11 , V_6 , & V_67 ) ;
V_260 = F_44 ( V_67 . V_114 , V_67 . V_115 , L_127 ) ;
if ( V_260 )
...
F_33 ( & V_67 ) ;
if ( V_266 )
V_11 -> V_141 = F_12 ( L_128 , 0 , V_11 -> V_141 ) ;
}
static void F_89 ( const char * V_50 )
{
T_11 * V_267 = V_268 ;
char V_269 [ V_270 ] ;
if ( strcmp ( V_50 , L_129 ) != 0 ) {
V_267 = fopen ( V_50 , L_130 ) ;
if ( ! V_267 )
F_1 ( L_131 , V_50 ) ;
}
...
V_15 = V_22 -> V_10 -> V_14 ;
F_95 ( V_276 , L_164 , V_282 ? L_15 : L_165 , V_15 ) ;
V_282 = 0 ;
}
F_95 ( V_276 , L_166 ) ;
}
...
goto V_286;
V_284 = F_9 ( malloc ( V_276 -> V_63 ) ) ;
if ( fread ( V_284 , 1 , V_276 -> V_63 , V_64 ) != V_276 -> V_63 )
goto V_287;
if ( memcmp ( V_284 , V_276 -> V_15 , V_276 -> V_63 ) != 0 )
goto V_287;
free ( V_284 ) ;
fclose ( V_64 ) ;
return;
...
char * V_127 , * V_6 , * V_185 , * V_23 , * V_288 ;
unsigned int V_48 ;
struct V_10 * V_11 ;
struct V_20 * V_22 ;
...
* V_23 ++ = '\0' ;
if ( V_23 && ( ( V_288 = strchr ( V_23 , '\t' ) ) != NULL ) )
* V_288 = '\0' ;
...
int main ( int V_291 , char * * V_292 )
{
struct V_10 * V_11 ;
struct V_271 V_272 = { } ;
char * V_293 = NULL , * V_294 = NULL ;
char * V_295 = NULL , * V_296 = NULL ;
int V_297 ;
int V_279 ;
struct V_298 * V_299 ;
struct V_298 * V_300 = NULL ;
while ( ( V_297 = F_105 ( V_291 , V_292 , L_171 ) ) != - 1 ) {
switch ( V_297 ) {
case 'i' :
V_293 = V_301 ;
break;
