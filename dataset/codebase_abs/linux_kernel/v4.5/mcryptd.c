...
V_46 -> V_50 . V_101 . V_86 . V_103 = sizeof( struct V_73 ) ;
V_46 -> V_50 . V_101 . V_86 . V_104 = F_47 ;
V_46 -> V_50 . V_101 . V_86 . V_105 = F_54 ;
...
char V_122 [ V_57 ] ;
struct V_78 * V_44 ;
if ( snprintf ( V_122 , V_57 ,
L_5 , V_121 ) >= V_57 )
return F_42 ( - V_117 ) ;
V_44 = F_102 ( V_122 , type , V_66 ) ;
if ( F_46 ( V_44 ) )
return F_103 ( V_44 ) ;
if ( V_44 -> V_86 . V_123 -> V_124 != V_125 ) {
F_104 ( V_44 ) ;
return F_42 ( - V_117 ) ;
}
return F_105 ( V_44 ) ;
...
struct V_96 * V_126 = F_106 ( V_44 ) ;
return V_126 -> V_107 ( V_89 , NULL , 0 ) ;
}
...
struct V_75 * V_44 = V_89 -> V_44 ;
struct V_96 * V_126 = F_106 ( V_44 ) ;
return V_126 -> V_109 ( V_89 , NULL , 0 , V_34 -> V_127 ) ;
}
...
struct V_75 * V_44 = V_89 -> V_44 ;
struct V_96 * V_126 = F_106 ( V_44 ) ;
return V_126 -> V_108 ( V_89 , V_34 -> V_127 ) ;
}
struct V_75 * F_107 ( struct V_120 * V_44 )
{
