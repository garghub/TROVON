...
if ( F_122 ( V_119 ) )
return F_123 ( V_119 ,
F_5 ( V_119 -> V_141 ) , V_90 ) ;
return F_124 ( V_119 , V_90 ) ;
}
STATIC int
F_125 (
struct V_1 * V_1 ,
...
type = V_120 ;
F_130 ( F_6 ( V_9 ) , V_40 , V_41 , type , V_59 ) ;
if ( V_163 ) {
ASSERT ( type == V_120 ) ;
...
{
T_2 V_165 ;
V_165 = V_59 -> V_83 + V_59 -> V_84 - V_164 ;
V_165 <<= V_9 -> V_62 ;
ASSERT ( V_165 > 0 ) ;
if ( V_165 > V_41 )
V_165 = V_41 ;
if ( V_40 < F_116 ( V_9 ) &&
V_40 + V_165 >= F_116 ( V_9 ) ) {
V_165 = F_136 ( F_116 ( V_9 ) - V_40 ,
1 << V_9 -> V_62 ) ;
}
if ( V_165 > V_166 )
V_165 = V_166 ;
...
if ( F_35 ( V_13 ) )
return - V_53 ;
V_40 = ( T_2 ) V_164 << V_9 -> V_62 ;
ASSERT ( V_162 -> V_100 >= ( 1 << V_9 -> V_62 ) ) ;
V_41 = V_162 -> V_100 ;
if ( ! V_167 && V_168 && V_40 >= F_116 ( V_9 ) )
return 0 ;
if ( V_167 && ! V_168 ) {
V_169 = V_43 ;
F_19 ( V_11 , V_169 ) ;
...
( V_59 . V_80 == V_81 ||
V_59 . V_80 == V_82 ) ||
( F_139 ( V_9 ) && F_129 ( & V_59 ) ) ) ) {
if ( V_168 || F_140 ( V_11 ) ) {
if ( V_169 == V_43 )
F_141 ( V_11 , V_169 ) ;
error = F_142 ( V_11 , V_40 , V_41 ,
& V_59 , V_67 ) ;
if ( error )
return error ;
V_170 = 1 ;
...
V_170 = 1 ;
error = F_143 ( V_11 , V_40 , V_41 , & V_59 ) ;
if ( error )
goto V_171;
F_21 ( V_11 , V_169 ) ;
}
F_144 ( V_11 , V_40 , V_41 ,
F_129 ( & V_59 ) ? V_47
: V_79 , & V_59 ) ;
} else if ( V_67 ) {
F_145 ( V_11 , V_40 , V_41 ,
F_129 ( & V_59 ) ? V_47
: V_120 , & V_59 ) ;
F_21 ( V_11 , V_169 ) ;
} else {
F_146 ( V_11 , V_40 , V_41 ) ;
goto V_171;
}
if ( F_139 ( V_9 ) && V_167 ) {
ASSERT ( ! F_129 ( & V_59 ) ) ;
...
if ( V_168 || V_41 > ( 1 << V_9 -> V_62 ) )
F_135 ( V_9 , V_164 , V_162 ,
& V_59 , V_40 , V_41 ) ;
if ( V_59 . V_80 != V_81 &&
V_59 . V_80 != V_82 &&
( V_167 || ! F_129 ( & V_59 ) ) ) {
...
int V_167 )
{
return F_137 ( V_9 , V_164 , V_162 , V_167 , false , false ) ;
}
int
F_151 (
struct V_9 * V_9 ,
...
int V_167 )
{
return F_137 ( V_9 , V_164 , V_162 , V_167 , true , false ) ;
}
int
F_152 (
struct V_9 * V_9 ,
...
int V_167 )
{
return F_137 ( V_9 , V_164 , V_162 , V_167 , true , true ) ;
}
static void
F_153 (
struct V_9 * V_9 ,
...
void * V_176 )
{
struct V_9 * V_9 = F_158 ( V_175 -> V_177 ) ;
struct V_25 * V_18 = V_176 ;
F_159 ( F_6 ( V_9 ) , V_40 , V_41 ,
V_18 ? V_18 -> V_46 : 0 , NULL ) ;
if ( ! V_18 ) {
ASSERT ( V_40 + V_41 <= F_116 ( V_9 ) ) ;
return;
}
F_153 ( V_9 , V_18 , V_40 , V_41 ) ;
}
static inline T_6
F_160 (
struct V_9 * V_9 ,
...
struct V_8 * V_180 ;
if ( F_139 ( V_9 ) )
return F_162 ( V_175 , V_9 , V_179 , V_40 ,
F_151 , F_161 , 0 ) ;
V_180 = F_5 ( V_9 ) ;
return F_163 ( V_175 , V_9 , V_180 , V_179 , V_40 ,
F_151 , F_161 , NULL , V_152 ) ;
}
STATIC T_6
F_164 (
struct V_174 * V_175 ,
...
T_5 V_40 )
{
struct V_9 * V_9 = V_175 -> V_177 -> V_181 -> V_141 ;
if ( F_165 ( V_179 ) == V_94 )
return F_160 ( V_9 , V_175 , V_179 , V_40 ,
F_157 , V_182 ) ;
return F_160 ( V_9 , V_175 , V_179 , V_40 , NULL , 0 ) ;
}
STATIC void
F_166 (
struct V_9 * V_9 ,
...
T_7 V_64 ;
int error ;
V_144 = F_43 ( V_11 -> V_14 , V_183 ) ;
V_64 = F_43 ( V_11 -> V_14 , V_184 ) ;
if ( V_64 <= V_144 )
return;
F_19 ( V_11 , V_43 ) ;
...
T_5 V_187 ;
T_5 V_188 ;
T_5 V_189 = V_185 & ( V_131 - 1 ) ;
T_5 V_190 = V_189 + V_125 ;
struct V_4 * V_5 , * V_6 ;
V_186 = ( V_185 >> V_156 ) << V_156 ;
ASSERT ( V_186 + V_189 == V_185 ) ;
V_6 = F_2 ( V_1 ) ;
V_187 = 0 ;
for ( V_5 = V_6 ; V_5 != V_6 || ! V_187 ;
V_5 = V_5 -> V_7 , V_187 = V_188 ,
V_186 += V_5 -> V_100 ) {
V_188 = V_187 + V_5 -> V_100 ;
if ( V_188 <= V_189 )
continue;
if ( V_187 >= V_190 )
break;
...
void * * V_193 )
{
T_10 V_128 = V_185 >> V_156 ;
struct V_1 * V_1 ;
int V_194 ;
ASSERT ( V_125 <= V_131 ) ;
V_1 = F_173 ( V_119 , V_128 , V_152 ) ;
if ( ! V_1 )
return - V_195 ;
V_194 = F_174 ( V_1 , V_185 , V_125 , F_150 ) ;
if ( F_175 ( V_194 ) ) {
struct V_9 * V_9 = V_119 -> V_141 ;
T_3 V_42 = F_116 ( V_9 ) ;
F_167 ( V_9 , V_1 , V_185 , V_125 ) ;
F_71 ( V_1 ) ;
if ( V_185 + V_125 > V_42 ) {
T_6 V_183 = F_176 ( T_6 , V_185 , V_42 ) ;
F_177 ( V_9 , V_183 , V_185 + V_125 ) ;
}
F_178 ( V_1 ) ;
V_1 = NULL ;
}
...
int V_197 ;
ASSERT ( V_125 <= V_131 ) ;
V_197 = F_180 ( V_191 , V_119 , V_185 , V_125 , V_196 , V_1 , V_193 ) ;
if ( F_175 ( V_197 < V_125 ) ) {
struct V_9 * V_9 = V_119 -> V_141 ;
T_3 V_42 = F_116 ( V_9 ) ;
T_5 V_190 = V_185 + V_125 ;
if ( V_190 > V_42 ) {
if ( V_185 > V_42 )
V_42 = V_185 ;
F_166 ( V_9 , V_42 , V_190 ) ;
F_177 ( V_9 , V_42 , V_190 ) ;
}
}
return V_197 ;
}
...
F_183 ( V_119 ) ;
F_21 ( V_11 , V_199 ) ;
return F_184 ( V_119 , V_198 , F_150 ) ;
}
STATIC int
F_185 (
struct V_191 * V_200 ,
struct V_1 * V_1 )
{
F_186 ( V_1 -> V_119 -> V_141 , 1 ) ;
return F_187 ( V_1 , F_150 ) ;
}
STATIC int
F_188 (
struct V_191 * V_200 ,
...
unsigned V_202 )
{
F_189 ( V_119 -> V_141 , V_202 ) ;
return F_190 ( V_119 , V_139 , V_202 , F_150 ) ;
}
STATIC int
F_191 (
struct V_1 * V_1 )
...
if ( V_203 ) {
unsigned long V_152 ;
F_195 ( & V_119 -> V_207 , V_152 ) ;
if ( V_1 -> V_119 ) {
F_115 ( ! F_98 ( V_1 ) ) ;
F_196 ( V_1 , V_119 , V_205 ) ;
F_197 ( & V_119 -> V_208 ,
F_198 ( V_1 ) , V_209 ) ;
}
F_199 ( & V_119 -> V_207 , V_152 ) ;
}
F_200 ( V_205 ) ;
if ( V_203 )
F_201 ( V_119 -> V_141 , V_210 ) ;
return V_203 ;
}
