...
V_62 . V_63 = V_60 ;
V_62 . V_64 = V_65 ;
V_41 = F_25 ( 65536 , V_66 ) ;
if ( ! V_41 )
return - V_67 ;
if ( V_68 == 0 )
V_69 [ V_68 ++ ] = V_70 ;
for ( V_29 = 0 ; V_29 < V_68 ; V_29 ++ ) {
V_71 [ V_29 ] . V_26 . V_49 . V_55 = V_72 ;
V_71 [ V_29 ] . V_26 . V_49 . V_73 . V_74 . V_4 = F_17 ( V_69 [ V_29 ] ) ;
V_71 [ V_29 ] . V_26 . V_51 . V_75 = V_56 ;
V_71 [ V_29 ] . V_76 = & V_62 ;
V_71 [ V_29 ] . V_77 = V_78 ;
V_71 [ V_29 ] . F_4 = F_4 ;
if ( V_69 [ V_29 ] == V_70 )
sprintf ( V_71 [ V_29 ] . V_79 , L_10 ) ;
else
sprintf ( V_71 [ V_29 ] . V_79 , L_11 , V_29 ) ;
V_30 = F_26 ( & V_71 [ V_29 ] ) ;
if ( V_30 ) {
F_24 ( L_12 ,
V_71 [ V_29 ] . V_26 . V_49 . V_55 , V_69 [ V_29 ] ) ;
F_27 () ;
return V_30 ;
}
}
