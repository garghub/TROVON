...
{
F_136 ( & V_164 -> V_14 . V_176 , & V_238 ) ;
}
static int F_137 ( struct V_16 * V_164 )
{
return F_138 ( & V_164 -> V_14 . V_176 , & V_238 ) ;
}
static int F_139 ( struct V_1 * V_2 )
{
int V_80 ;
if ( ! F_10 ( V_239 , 0 , 0 , & V_80 ) )
F_129 ( L_41 , V_80 ) ;
if ( ! F_10 ( V_240 , 0 , 0x9 , & V_80 ) ) {
F_129 ( L_42 , V_80 >> 16 , V_80 & 0xFF ) ;
V_2 -> V_241 = V_80 ;
}
if ( ! F_10 ( V_242 , 0 , 0 , & V_80 ) ) {
F_129 ( L_43 , V_80 ) ;
V_2 -> V_158 = V_80 ;
}
if ( ! F_10 ( V_243 , 0 , 0 , NULL ) )
V_2 -> V_50 = V_243 ;
else
V_2 -> V_50 = V_244 ;
...
static int F_141 ( struct V_246 * V_247 , void * V_105 )
{
struct V_1 * V_2 = V_247 -> V_112 ;
int V_3 ;
T_1 V_25 = - 1 ;
V_3 = F_17 ( V_2 , V_2 -> V_248 . V_49 , & V_25 ) ;
if ( V_3 < 0 )
return V_3 ;
F_142 ( V_247 , L_44 , V_2 -> V_248 . V_49 , V_25 ) ;
return 0 ;
}
static int F_143 ( struct V_246 * V_247 , void * V_105 )
{
struct V_1 * V_2 = V_247 -> V_112 ;
int V_3 ;
T_1 V_25 = - 1 ;
V_3 = F_18 ( V_2 -> V_248 . V_49 , V_2 -> V_248 . V_51 ,
& V_25 ) ;
if ( V_3 < 0 )
return V_3 ;
F_142 ( V_247 , L_45 , V_2 -> V_248 . V_49 ,
V_2 -> V_248 . V_51 , V_25 ) ;
return 0 ;
}
static int F_144 ( struct V_246 * V_247 , void * V_105 )
{
struct V_1 * V_2 = V_247 -> V_112 ;
struct V_26 args = {
. V_23 = V_2 -> V_248 . V_49 ,
...
V_34 = (union V_33 * ) V_30 . V_37 ;
if ( V_34 && V_34 -> type == V_38 )
F_142 ( V_247 , L_46 , V_2 -> V_248 . V_22 ,
V_2 -> V_248 . V_49 , V_2 -> V_248 . V_51 ,
( T_1 ) V_34 -> integer . V_39 ) ;
else
F_142 ( V_247 , L_47 , V_2 -> V_248 . V_22 ,
V_2 -> V_248 . V_49 , V_2 -> V_248 . V_51 ,
V_34 ? V_34 -> type : - 1 ) ;
F_13 ( V_34 ) ;
return 0 ;
}
static int F_145 ( struct V_249 * V_249 , struct V_250 * V_250 )
{
struct V_251 * V_109 = V_249 -> V_252 ;
return F_146 ( V_250 , V_109 -> V_253 , V_109 -> V_2 ) ;
}
static void F_147 ( struct V_1 * V_2 )
{
F_148 ( V_2 -> V_248 . V_254 ) ;
}
static int F_149 ( struct V_1 * V_2 )
{
struct V_255 * V_256 ;
int V_257 ;
V_2 -> V_248 . V_254 = F_150 ( V_2 -> V_7 -> V_6 , NULL ) ;
if ( ! V_2 -> V_248 . V_254 ) {
F_53 ( L_48 ) ;
goto V_258;
}
V_256 = F_151 ( L_49 , V_259 | V_260 ,
V_2 -> V_248 . V_254 , & V_2 -> V_248 . V_22 ) ;
if ( ! V_256 )
goto V_258;
V_256 = F_151 ( L_50 , V_259 | V_260 ,
V_2 -> V_248 . V_254 , & V_2 -> V_248 . V_49 ) ;
if ( ! V_256 )
goto V_258;
V_256 = F_151 ( L_51 , V_259 | V_260 ,
V_2 -> V_248 . V_254 , & V_2 -> V_248 . V_51 ) ;
if ( ! V_256 )
goto V_258;
for ( V_257 = 0 ; V_257 < F_152 ( V_261 ) ; V_257 ++ ) {
struct V_251 * V_109 = & V_261 [ V_257 ] ;
V_109 -> V_2 = V_2 ;
V_256 = F_153 ( V_109 -> V_6 , V_262 | V_259 ,
V_2 -> V_248 . V_254 , V_109 ,
& V_263 ) ;
if ( ! V_256 ) {
F_53 ( L_52 , V_109 -> V_6 ) ;
goto V_258;
...
{
struct V_264 * V_265 = F_156 ( V_179 -> V_14 . V_7 ) ;
struct V_266 * V_267 = F_157 ( V_265 ) ;
struct V_1 * V_2 ;
const char * V_268 ;
T_2 V_32 ;
int V_3 ;
...
V_282 = ! F_20 ( V_2 ,
V_141 ) ;
F_49 ( V_2 -> V_134 . V_99 , V_282 ) ;
}
if ( V_2 -> V_135 . V_99 ) {
V_282 = ! F_20 ( V_2 , V_143 ) ;
F_49 ( V_2 -> V_135 . V_99 , V_282 ) ;
}
if ( V_2 -> V_136 . V_99 ) {
V_282 = ! F_20 ( V_2 , V_145 ) ;
F_49 ( V_2 -> V_136 . V_99 , V_282 ) ;
}
if ( V_2 -> V_137 . V_99 ) {
V_282 = ! F_20 ( V_2 , V_147 ) ;
F_49 ( V_2 -> V_137 . V_99 , V_282 ) ;
}
if ( V_2 -> V_138 . V_99 ) {
V_282 = ! F_20 ( V_2 , V_149 ) ;
F_49 ( V_2 -> V_138 . V_99 , V_282 ) ;
}
if ( ! F_37 ( V_2 -> V_72 . V_14 ) )
F_24 ( V_2 -> V_66 , & V_2 -> V_67 ) ;
return 0 ;
...
if ( V_267 -> V_278 && ! F_168 ( V_267 -> V_278 ) ) {
F_51 ( L_58 ) ;
return - V_42 ;
}
if ( V_267 -> V_283 ) {
V_114 = V_267 -> V_283 ( V_179 ) ;
if ( V_114 )
return V_114 ;
}
return F_155 ( V_179 ) ;
}
int T_9 F_169 ( struct V_266 * V_7 )
{
struct V_264 * V_264 ;
struct V_16 * V_16 ;
if ( V_284 )
...
V_264 = & V_7 -> V_264 ;
V_264 -> remove = F_163 ;
V_264 -> V_7 . V_285 = V_7 -> V_285 ;
V_264 -> V_7 . V_6 = V_7 -> V_6 ;
V_264 -> V_7 . V_286 = & V_287 ;
V_16 = F_170 ( V_264 ,
F_167 ,
NULL , 0 , NULL , 0 ) ;
if ( F_109 ( V_16 ) )
