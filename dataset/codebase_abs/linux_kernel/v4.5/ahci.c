...
{}
static T_7 F_67 ( int V_114 , void * V_115 )
{
struct V_13 * V_14 = V_115 ;
struct V_3 * V_4 ;
unsigned int V_31 = 0 ;
void T_2 * V_57 ;
T_3 V_116 , V_117 ;
...
V_4 = V_14 -> V_16 ;
V_57 = V_4 -> V_57 ;
V_116 = F_12 ( V_57 + V_119 ) ;
if ( ! V_116 )
return V_120 ;
do {
V_117 = V_116 & V_4 -> V_18 ;
F_68 ( & V_14 -> V_121 ) ;
V_31 = F_69 ( V_14 , V_117 ) ;
if ( ! V_31 )
V_118 = 0 ;
F_11 ( V_116 , V_57 + V_119 ) ;
V_116 = F_12 ( V_57 + V_119 ) ;
F_70 ( & V_14 -> V_121 ) ;
} while ( V_116 );
F_13 ( L_58 ) ;
...
static int F_72 ( struct V_1 * V_2 , unsigned int V_111 ,
...
V_4 -> V_127 [ V_49 ] . V_128 = V_49 ;
V_31 = F_74 ( V_2 , V_4 -> V_127 , V_122 ) ;
if ( V_31 < 0 )
goto V_126;
if ( V_122 > 1 )
V_4 -> V_10 |= V_125 ;
V_4 -> V_114 = V_4 -> V_127 [ 0 ] . V_129 ;
return V_122 ;
V_126:
F_32 ( & V_2 -> V_8 ,
L_59 ,
...
static int F_75 ( struct V_1 * V_2 , unsigned int V_111 ,
struct V_3 * V_4 )
{
int V_31 , V_122 ;
if ( V_4 -> V_10 & V_123 )
...
static int F_80 ( struct V_1 * V_2 , unsigned int V_111 ,
struct V_3 * V_4 )
{
int V_122 ;
V_122 = F_72 ( V_2 , V_111 , V_4 , V_125 ) ;
if ( V_122 >= 0 )
return V_122 ;
V_122 = F_75 ( V_2 , V_111 , V_4 ) ;
if ( V_122 >= 0 )
return V_122 ;
V_122 = F_72 ( V_2 , V_111 , V_4 , 0 ) ;
if ( V_122 >= 0 )
return V_122 ;
F_81 ( V_2 , 1 ) ;
V_4 -> V_114 = V_2 -> V_114 ;
...
static int F_82 ( struct V_1 * V_2 , const struct V_107 * V_135 )
{
unsigned int V_136 = V_135 -> V_96 ;
struct V_137 V_138 = V_139 [ V_136 ] ;
const struct V_137 * V_140 [] = { & V_138 , NULL } ;
...
F_2 ( & V_2 -> V_8 ,
L_61 ) ;
if ( V_2 -> V_5 == V_149 && V_2 -> V_7 == 0xCC06 )
V_141 = V_150 ;
...
V_31 = F_87 ( V_2 , 1 << V_141 , V_155 ) ;
if ( V_31 == - V_156 )
F_88 ( V_2 ) ;
if ( V_31 )
return V_31 ;
V_4 = F_89 ( V_8 , sizeof( * V_4 ) , V_157 ) ;
if ( ! V_4 )
return - V_158 ;
V_4 -> V_10 |= ( unsigned long ) V_138 . V_16 ;
if ( V_136 == V_159 &&
( V_2 -> V_160 == 0xa1 || V_2 -> V_160 == 0xa2 ) )
V_4 -> V_10 |= V_123 ;
if ( V_136 == V_161 && V_2 -> V_160 >= 0x40 )
V_4 -> V_10 &= ~ V_162 ;
if ( F_52 ( V_2 ) )
V_4 -> V_10 &= ~ V_163 ;
V_4 -> V_57 = F_90 ( V_2 ) [ V_141 ] ;
if ( F_61 ( V_2 ) )
V_4 -> V_10 |= V_164 ;
#ifdef F_91
...
V_111 = F_93 ( F_94 ( V_4 -> V_166 ) , F_95 ( V_4 -> V_18 ) ) ;
V_14 = F_96 ( & V_2 -> V_8 , V_140 , V_111 ) ;
if ( ! V_14 )
return - V_158 ;
V_14 -> V_16 = V_4 ;
V_4 -> V_127 = F_89 ( & V_2 -> V_8 ,
sizeof( struct V_176 ) * V_111 , V_157 ) ;
if ( ! V_4 -> V_127 )
return - V_158 ;
F_80 ( V_2 , V_111 , V_4 ) ;
if ( ! ( V_4 -> V_166 & V_177 ) || V_178 )
V_14 -> V_10 |= V_179 ;
else
F_2 ( & V_2 -> V_8 , L_65 ) ;
if ( V_138 . V_10 & V_180 )
...
for ( V_49 = 0 ; V_49 < V_14 -> V_111 ; V_49 ++ ) {
struct V_28 * V_29 = V_14 -> V_84 [ V_49 ] ;
F_98 ( V_29 , V_141 , - 1 , L_66 ) ;
F_98 ( V_29 , V_141 ,
0x100 + V_29 -> V_53 * 0x80 , L_67 ) ;
if ( V_29 -> V_10 & V_180 )
V_29 -> V_181 = V_4 -> V_182 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_49 ) ) )
V_29 -> V_85 = & V_183 ;
}
F_45 ( V_14 ) ;
F_64 ( V_14 ) ;
V_31 = F_39 ( V_2 , V_4 -> V_166 & V_184 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
