...
{
struct V_359 * V_370 = & V_15 -> V_370 [ 0 ] ;
struct V_267 * V_268 = & V_15 -> V_22 ;
struct V_357 * V_371 = & V_268 -> V_358 ;
static T_5 V_372 ;
struct V_373 * V_374 ;
...
F_116 ( V_268 , V_15 ) ;
V_268 -> V_362 |= V_383 ;
V_370 [ V_320 ] . V_362 = V_384 ;
V_370 [ V_324 ] . V_362 = V_385 ;
V_15 -> V_301 = V_302 ;
V_15 -> V_306 = V_307 ;
V_371 -> V_386 = & V_387 ;
F_117 ( & V_15 -> V_348 , 2 ) ;
F_118 ( & V_15 -> V_348 , & V_388 ,
V_351 , 0 ,
V_389 , 1 , 16 ) ;
F_118 ( & V_15 -> V_348 , & V_388 ,
V_353 , 0 ,
