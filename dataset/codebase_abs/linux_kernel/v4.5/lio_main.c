...
V_456 . V_90 . V_475 = 1 ;
V_456 . V_90 . V_474 . V_476 = ( F_131 ( V_28 ) -> V_199 + 1 ) ;
F_248 ( & V_430 . V_173 , & V_456 , V_451 ) ;
...
if ( F_131 ( V_28 ) -> V_479 ) {
struct V_480 * V_481 =
(struct V_480 * ) & V_430 . V_173 . V_481 ;
union V_482 * V_482 = (union V_482 * ) & V_430 . V_173 . V_483 [ 0 ] ;
V_481 -> V_36 = 1 ;
V_482 -> V_90 . V_479 = F_131 ( V_28 ) -> V_479 ;
V_482 -> V_90 . V_484 = F_131 ( V_28 ) -> V_484 ;
}
V_431 = V_28 -> V_431 ;
...
static void F_254 ( struct V_85 * V_86 )
{
struct V_82 * V_82 ;
V_82 = F_62 ( V_86 ) ;
F_78 ( V_82 , V_459 , V_82 -> V_86 ,
...
int F_255 ( struct V_85 * V_86 , int V_173 )
{
struct V_82 * V_82 = F_62 ( V_86 ) ;
struct V_4 * V_5 = V_82 -> V_96 ;
struct V_168 V_169 ;
...
static T_9 F_256 ( struct V_85 * V_86 ,
T_9 V_490 )
{
struct V_82 * V_82 = F_257 ( V_86 ) ;
if ( ( V_490 & V_287 ) &&
! ( V_82 -> V_491 & V_287 ) )
V_490 &= ~ V_287 ;
if ( ( V_490 & V_492 ) &&
...
static int F_263 ( struct V_498 * V_499 , void * V_23 )
{
...
V_119 = (union V_118 * ) F_264 ( V_501 -> V_505 [ 0 ] ) ;
...
static int F_266 ( struct V_4 * V_310 )
{
...
F_277 ( V_310 , V_30 , V_519 ,
V_521 , V_18 ,
V_514 . V_121 , 0 ) ;
V_30 -> V_438 = F_162 ;
V_30 -> V_35 = V_30 ;
V_30 -> V_364 = 1000 ;
V_315 = F_278 ( V_310 , V_30 ) ;
if ( V_315 ) {
F_20 ( & V_310 -> V_50 -> V_37 ,
L_81 ,
V_315 ) ;
...
V_509 = F_280 ( V_261 -> V_523 . V_525 ) ;
V_510 = F_280 ( V_261 -> V_523 . V_526 ) ;
if ( ! ( V_509 ) || ! ( V_510 ) ) {
F_20 ( & V_310 -> V_50 -> V_37 ,
L_83 ,
V_261 -> V_523 . V_525 ,
...
V_82 -> V_107 = F_286 ( V_310 , V_82 -> V_19 ) ;
V_82 -> V_545 = F_287 ( V_310 , V_82 -> V_544 ) ;
if ( F_71 ( V_82 ) ) {
F_20 ( & V_310 -> V_50 -> V_37 ,
L_88 ) ;
goto V_522;
...
static void F_292 ( struct V_318 * V_164 )
{
struct V_4 * V_5 ;
struct V_319 * V_320 = (struct V_319 * ) V_164 ;
...
V_570 ,
V_310 ) ;
F_199 ( & V_310 -> V_163 . V_164 , F_292 ) ;
V_310 -> V_163 . V_265 = ( void * ) V_310 ;
F_293 ( & V_310 -> V_163 . V_164 ,
V_568 ) ;
