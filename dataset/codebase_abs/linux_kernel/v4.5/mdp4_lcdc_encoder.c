...
F_46 ( & V_1 -> V_11 , V_95 ) ;
F_47 ( V_9 -> V_96 ) ;
for ( V_90 = 0 ; V_90 < F_48 ( V_9 -> V_97 ) ; V_90 ++ ) {
V_91 = F_49 ( V_9 -> V_97 [ V_90 ] ) ;
if ( V_91 )
...
V_102 |
V_103 ) ;
F_56 ( V_3 -> V_99 , V_104 , 0 ) ;
F_11 ( V_9 , 1 ) ;
for ( V_90 = 0 ; V_90 < F_48 ( V_9 -> V_97 ) ; V_90 ++ ) {
V_91 = F_57 ( V_9 -> V_97 [ V_90 ] ) ;
if ( V_91 )
F_6 ( V_6 -> V_6 , L_10 , V_91 ) ;
}
F_8 ( L_11 , V_98 ) ;
V_91 = F_58 ( V_9 -> V_96 , V_98 ) ;
if ( V_91 )
...
long F_62 ( struct V_2 * V_3 , unsigned long V_105 )
{
struct V_9 * V_9 =
F_14 ( V_3 ) ;
return F_63 ( V_9 -> V_96 , V_105 ) ;
}
struct V_2 * F_64 ( struct V_10 * V_6 ,
struct V_106 * V_94 )
{
struct V_2 * V_3 = NULL ;
struct V_9 * V_9 ;
