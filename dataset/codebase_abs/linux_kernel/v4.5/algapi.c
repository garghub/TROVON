...
char * V_103 ;
int V_49 ;
V_103 = F_99 ( V_102 + sizeof( * V_21 ) + sizeof( struct V_29 ) ,
V_104 ) ;
if ( ! V_103 )
return F_38 ( - V_105 ) ;
...
void F_102 ( struct V_109 * V_110 , unsigned int V_111 )
{
F_29 ( & V_110 -> V_32 ) ;
...
V_110 -> V_113 ++ ;
F_104 ( & V_115 -> V_32 , & V_110 -> V_32 ) ;
V_52:
return V_49 ;
}
struct V_114 * F_105 ( struct V_109 * V_110 )
{
struct V_25 * V_115 ;
if ( F_55 ( ! V_110 -> V_113 ) )
return NULL ;
...
F_79 ( V_115 ) ;
return F_106 ( V_115 , struct V_114 , V_32 ) ;
}
int F_107 ( struct V_109 * V_110 , struct V_83 * V_84 )
{
struct V_114 * V_120 ;
...
static inline void F_108 ( T_2 * V_121 , unsigned int V_122 )
{
...
void F_109 ( T_2 * V_121 , unsigned int V_122 )
{
...
static inline void F_112 ( T_2 * V_121 , const T_2 * V_123 , unsigned int V_122 )
{
for (; V_122 ; V_122 -- )
* V_121 ++ ^= * V_123 ++ ;
}
void F_113 ( T_2 * V_125 , const T_2 * V_126 , unsigned int V_122 )
{
T_1 * V_121 = ( T_1 * ) V_125 ;
T_1 * V_123 = ( T_1 * ) V_126 ;
for (; V_122 >= 4 ; V_122 -= 4 )
* V_121 ++ ^= * V_123 ++ ;
F_112 ( ( T_2 * ) V_121 , ( T_2 * ) V_123 , V_122 ) ;
}
unsigned int F_114 ( struct V_1 * V_2 )
{
return V_2 -> V_127 +
( V_2 -> V_14 & ~ ( F_115 () - 1 ) ) ;
}
