...
static void F_40 ( struct V_3 * V_4 , int V_32 )
{
if ( V_32 & V_33 )
F_41 ( F_2 ( V_4 ) ) ;
}
...
static struct V_34 * F_46 ( struct V_3 * V_4 ,
struct V_34 * V_15 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
...
static int F_51 ( struct V_3 * V_4 , int V_42 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
if ( V_42 < 68 || V_42 > F_52 ( V_6 ) )
return - V_43 ;
V_4 -> V_44 = V_42 ;
#if F_53 ( V_45 )
F_54 ( & V_6 -> V_46 . V_10 , V_47 , V_42 ) ;
#endif
return 0 ;
}
static int F_55 ( struct V_3 * V_4 , void * V_48 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
...
return - V_52 ;
F_57 ( & V_6 -> V_53 ) ;
if ( ! F_58 ( V_4 -> V_54 , V_50 -> V_51 ) ) {
F_59 ( V_6 , V_50 -> V_51 ) ;
}
F_60 ( & V_6 -> V_53 ) ;
return 0 ;
}
static void F_61 ( struct V_3 * V_4 , struct V_55 * V_56 )
{
F_62 ( V_56 -> V_57 , L_1 , sizeof( V_56 -> V_57 ) ) ;
F_62 ( V_56 -> V_58 , V_59 , sizeof( V_56 -> V_58 ) ) ;
F_62 ( V_56 -> V_60 , L_2 , sizeof( V_56 -> V_60 ) ) ;
F_62 ( V_56 -> V_61 , L_2 , sizeof( V_56 -> V_61 ) ) ;
}
static T_3 F_63 ( struct V_3 * V_4 ,
T_3 V_62 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_64 ( V_6 , V_62 ) ;
}
static void F_65 ( struct V_3 * V_63 )
{
}
...
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_64 * V_48 ;
F_67 (p, &br->port_list, list)
F_68 ( V_48 ) ;
}
static int F_69 ( struct V_64 * V_48 )
{
struct V_65 * V_66 ;
int V_30 ;
V_66 = F_70 ( sizeof( * V_48 -> V_66 ) , V_67 ) ;
if ( ! V_66 )
return - V_31 ;
V_30 = F_71 ( V_66 , V_48 -> V_4 ) ;
if ( V_30 ) {
F_72 ( V_66 ) ;
return V_30 ;
}
...
int F_73 ( struct V_64 * V_48 )
{
if ( ! V_48 -> V_6 -> V_4 -> V_68 )
return 0 ;
return F_69 ( V_48 ) ;
}
static int F_74 ( struct V_3 * V_4 , struct V_69 * V_70 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_64 * V_48 ;
int V_30 = 0 ;
...
static int F_76 ( struct V_3 * V_4 , struct V_3 * V_72 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_77 ( V_6 , V_72 ) ;
}
