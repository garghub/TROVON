...
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
F_11 ( V_7 , V_207 , V_10 , L_62 ,
V_51 , V_51 - V_10 -> V_205 ) ;
V_10 -> V_78 . V_79 ++ ;
F_42 ( V_10 ) ;
return;
}
...
V_210 -> V_213 = 1 ;
F_22 ( & V_7 -> V_77 ) ;
for ( V_27 = 0 ; V_27 < V_208 ; V_27 += 2 ) {
unsigned int V_28 = 0 ;
F_9 ( V_7 -> V_30 . V_31 , V_27 , & V_28 ) ;
V_212 [ V_27 ] = V_28 & 0xffff ;
}
F_24 ( & V_7 -> V_77 ) ;
}
...
struct V_214 * V_215 )
{
F_95 ( V_215 -> V_216 , V_4 , sizeof( V_215 -> V_216 ) ) ;
F_95 ( V_215 -> V_213 , V_217 , sizeof( V_215 -> V_213 ) ) ;
F_95 ( V_215 -> V_218 , F_96 ( V_10 -> V_10 . V_219 ) ,
sizeof( V_215 -> V_218 ) ) ;
}
...
struct V_6 * V_7 = F_69 ( V_10 ) ;
V_36 -> V_221 = V_222 ;
V_36 -> V_223 = V_224 | V_225 |
V_226 | V_227 |
V_228 | V_229 ;
F_98 ( V_36 , V_7 -> V_45 ) ;
V_36 -> V_171 = V_7 -> V_48 ? V_172 : V_230 ;
V_36 -> V_231 = V_232 ;
...
static int F_103 ( struct V_234 * V_188 )
{
int V_29 ;
struct V_9 * V_11 ;
struct V_6 * V_7 ;
...
V_7 = F_69 ( V_11 ) ;
F_105 ( V_188 , V_7 ) ;
F_106 ( & V_188 -> V_10 , V_7 ) ;
F_107 ( V_11 , & V_188 -> V_10 ) ;
V_7 -> V_233 = F_108 ( V_237 , V_238 ) ;
V_7 -> V_11 = V_11 ;
V_7 -> V_48 = true ;
V_7 -> V_41 = V_42 ;
V_7 -> V_45 = V_46 ;
V_7 -> V_30 . V_188 = V_188 ;
F_109 ( & V_188 -> V_10 , & V_7 -> V_30 ) ;
...
F_111 ( & V_7 -> V_198 ) ;
F_112 ( & V_7 -> V_204 , F_89 ) ;
F_112 ( & V_7 -> V_193 , F_83 ) ;
V_7 -> V_244 = F_113 ( V_245 , & V_7 -> V_198 ,
L_65 ) ;
if ( F_114 ( V_7 -> V_244 ) ) {
V_29 = F_115 ( V_7 -> V_244 ) ;
goto V_243;
}
F_71 ( V_7 , V_11 -> V_181 ) ;
V_11 -> V_246 = & V_247 ;
V_29 = F_116 ( V_11 ) ;
if ( F_10 ( V_29 ) ) {
F_11 ( V_7 , V_241 , V_11 , L_66 ,
V_29 ) ;
goto V_243;
}
V_235 = F_8 ( V_7 , V_136 ) ;
if ( ( ( V_235 & V_248 ) >> V_249 ) != V_250 ) {
V_29 = - V_124 ;
goto V_251;
}
F_35 ( V_7 , V_241 , V_11 , L_67 ,
( V_235 & V_252 ) >> V_253 ) ;
...
static int F_119 ( struct V_234 * V_188 )
{
struct V_6 * V_7 = F_120 ( & V_188 -> V_10 ) ;
F_117 ( V_7 -> V_11 ) ;
F_118 ( V_7 -> V_11 ) ;
return 0 ;
}
