...
return F_40 ( V_49 , V_50 , L_9 , ( unsigned ) V_7 -> V_43 ) ;
}
static T_1 F_41 ( struct V_1 * V_2 ,
struct V_47 * V_48 ,
const char * V_49 , T_2 V_51 )
{
int V_25 ;
unsigned long V_52 ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
V_25 = F_42 ( V_49 , 10 , & V_52 ) ;
if ( V_25 )
return V_25 ;
if ( V_52 )
V_7 -> V_43 = true ;
...
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return F_40 ( V_49 , V_50 , L_9 , ( unsigned ) V_7 -> V_9 ) ;
}
...
V_15 = & V_8 -> V_19 [ V_12 ] ;
if ( V_15 -> V_20 == NULL ) {
if ( ! strcmp ( F_9 ( & V_7 -> V_2 ) , V_15 -> V_55 ) ) {
V_15 -> V_20 = V_7 ;
} else {
V_53 = true ;
}
...
V_56 = V_3 ;
V_8 = F_2 ( V_2 ) ;
if ( V_56 && ! strcmp ( V_56 , F_9 ( & V_8 -> V_2 ) ) )
return 1 ;
return 0 ;
}
...
int F_52 ( void T_3 * V_57 , T_4 V_58 , int V_59 , int V_60 )
{
int V_12 ;
T_4 V_52 ;
for ( V_12 = V_61 ; V_12 > 0 ; V_12 -- ) {
V_52 = F_53 ( V_57 + V_58 ) ;
if ( V_60 ) {
if ( V_52 & F_54 ( V_59 ) )
return 0 ;
...
struct V_6 * F_58 ( struct V_63 * V_64 )
{
int V_12 ;
int V_25 ;
int V_28 ;
...
V_66 = F_60 ( V_65 , sizeof( * V_66 ) , V_67 ) ;
if ( ! V_66 ) {
V_25 = - V_68 ;
goto V_72;
}
V_7 -> V_26 = V_66 ;
V_7 -> V_35 = V_64 -> V_71 -> V_35 ;
V_7 -> V_18 = V_64 -> V_71 -> V_18 ;
V_19 = F_60 ( V_7 -> V_18 , sizeof( * V_19 ) , V_67 ) ;
if ( ! V_19 ) {
V_25 = - V_68 ;
goto V_73;
}
for ( V_12 = 0 ; V_12 < V_7 -> V_18 ; V_12 ++ ) {
V_19 [ V_12 ] . V_24 = V_64 -> V_71 -> V_74 [ V_12 ] ;
V_19 [ V_12 ] . V_55 = V_64 -> V_71 -> V_75 [ V_12 ] ;
V_19 [ V_12 ] . V_21 = V_64 -> V_71 -> V_76 [ V_12 ] ;
}
V_7 -> V_19 = V_19 ;
V_7 -> type = V_64 -> type ;
V_7 -> V_31 = V_64 -> V_31 ;
V_7 -> V_77 = V_64 -> V_77 ;
V_7 -> V_54 = false ;
V_7 -> V_2 . type = & V_78 [ V_64 -> type ] ;
V_7 -> V_2 . V_79 = V_64 -> V_79 ;
V_7 -> V_2 . V_13 = V_64 -> V_2 ;
V_7 -> V_2 . V_80 = F_45 ;
V_7 -> V_2 . V_81 = & V_11 ;
F_61 ( & V_7 -> V_2 , L_10 , V_64 -> V_71 -> V_82 ) ;
V_25 = F_62 ( & V_7 -> V_2 ) ;
if ( V_25 )
goto V_83;
F_36 ( & V_45 ) ;
