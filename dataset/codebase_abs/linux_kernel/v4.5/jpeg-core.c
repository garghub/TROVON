...
unsigned int V_289 [] , void * V_290 [] )
{
struct V_9 * V_10 = F_179 ( V_167 ) ;
struct V_113 * V_168 = NULL ;
unsigned int V_71 , V_291 = * V_287 ;
...
{
struct V_293 * V_294 = F_185 ( V_64 ) ;
struct V_9 * V_10 = F_179 ( V_64 -> V_166 ) ;
if ( V_10 -> V_96 == V_102 &&
V_64 -> V_166 -> type == V_163 ) {
struct V_113 V_295 , * V_168 ;
V_10 -> V_172 = F_63 ( & V_295 ,
...
V_168 = & V_10 -> V_73 ;
V_168 -> V_133 = V_295 . V_133 ;
V_168 -> V_134 = V_295 . V_134 ;
V_168 -> V_74 = V_295 . V_74 ;
memcpy ( V_168 -> V_78 . V_79 , V_295 . V_78 . V_79 ,
sizeof( V_295 . V_78 . V_79 ) ) ;
memcpy ( V_168 -> V_78 . V_39 , V_295 . V_78 . V_39 , sizeof( V_295 . V_78 . V_39 ) ) ;
V_168 -> V_78 . V_76 = V_295 . V_78 . V_76 ;
memcpy ( V_168 -> V_82 . V_79 , V_295 . V_82 . V_79 ,
sizeof( V_295 . V_82 . V_79 ) ) ;
memcpy ( V_168 -> V_82 . V_39 , V_295 . V_82 . V_39 , sizeof( V_295 . V_82 . V_39 ) ) ;
V_168 -> V_82 . V_76 = V_295 . V_82 . V_76 ;
V_168 -> V_81 = V_295 . V_81 ;
V_168 -> V_80 = V_295 . V_80 ;
V_168 = & V_10 -> V_109 ;
V_168 -> V_133 = V_295 . V_133 ;
V_168 -> V_134 = V_295 . V_134 ;
}
F_189 ( V_10 -> V_24 . V_65 , V_294 ) ;
}
static int F_190 ( struct V_166 * V_297 , unsigned int V_291 )
{
struct V_9 * V_10 = F_179 ( V_297 ) ;
int V_89 ;
V_89 = F_191 ( V_10 -> V_25 -> V_298 ) ;
return V_89 > 0 ? 0 : V_89 ;
}
static void F_192 ( struct V_166 * V_297 )
{
struct V_9 * V_10 = F_179 ( V_297 ) ;
F_193 ( V_10 -> V_25 -> V_298 ) ;
}
static int V_107 ( void * V_136 , struct V_166 * V_299 ,
struct V_166 * V_300 )
{
struct V_9 * V_10 = V_136 ;
int V_89 ;
V_299 -> type = V_163 ;
V_299 -> V_301 = V_302 | V_303 ;
V_299 -> V_304 = V_10 ;
V_299 -> V_305 = sizeof( struct V_306 ) ;
V_299 -> V_307 = & V_308 ;
V_299 -> V_309 = & V_310 ;
V_299 -> V_311 = V_312 ;
V_299 -> V_92 = & V_10 -> V_25 -> V_92 ;
V_89 = F_194 ( V_299 ) ;
if ( V_89 )
return V_89 ;
V_300 -> type = V_164 ;
...
V_300 -> V_304 = V_10 ;
V_300 -> V_305 = sizeof( struct V_306 ) ;
V_300 -> V_307 = & V_308 ;
V_300 -> V_309 = & V_310 ;
V_300 -> V_311 = V_312 ;
...
static T_3 F_195 ( int V_313 , void * V_314 )
{
struct V_62 * V_25 = V_314 ;
struct V_9 * V_315 ;
struct V_293 * V_257 , * V_258 ;
...
bool V_322 = false ;
F_196 ( & V_25 -> V_244 ) ;
V_315 = F_197 ( V_25 -> V_106 ) ;
V_257 = F_198 ( V_315 -> V_24 . V_65 ) ;
V_258 = F_199 ( V_315 -> V_24 . V_65 ) ;
if ( V_315 -> V_96 == V_97 )
V_320 = F_200 ( V_25 -> V_36 ) ;
...
V_316 = F_206 ( V_25 -> V_36 ) ;
}
V_258 -> V_323 = V_257 -> V_323 ;
V_258 -> V_324 . V_325 = V_257 -> V_324 . V_325 ;
V_258 -> V_152 &= ~ V_326 ;
V_258 -> V_152 |=
V_257 -> V_152 & V_326 ;
F_207 ( V_257 , V_318 ) ;
if ( V_315 -> V_96 == V_97 )
F_183 ( & V_258 -> V_324 , 0 , V_316 ) ;
F_207 ( V_258 , V_318 ) ;
F_208 ( V_25 -> V_106 , V_315 -> V_24 . V_65 ) ;
V_315 -> V_12 = F_209 ( V_25 -> V_36 ) ;
F_210 ( & V_25 -> V_244 ) ;
F_211 ( V_25 -> V_36 ) ;
return V_327 ;
}
static T_3 F_212 ( int V_313 , void * V_136 )
{
unsigned int V_328 ;
struct V_293 * V_329 , * V_330 ;
struct V_62 * V_25 = V_136 ;
struct V_9 * V_315 ;
unsigned long V_316 = 0 ;
F_196 ( & V_25 -> V_244 ) ;
V_315 = F_197 ( V_25 -> V_106 ) ;
V_329 = F_198 ( V_315 -> V_24 . V_65 ) ;
V_330 = F_199 ( V_315 -> V_24 . V_65 ) ;
V_328 = F_213 ( V_25 -> V_36 ) ;
if ( V_328 ) {
switch ( V_328 & 0x1f ) {
case 0x1 :
V_25 -> V_331 = V_332 ;
...
V_315 -> V_12 = F_215 ( V_25 -> V_36 ) ;
F_210 ( & V_25 -> V_244 ) ;
return V_327 ;
}
static T_3 F_216 ( int V_313 , void * V_314 )
{
struct V_62 * V_25 = V_314 ;
struct V_9 * V_315 ;
struct V_293 * V_257 , * V_258 ;
...
static int F_225 ( struct V_346 * V_347 )
{
struct V_62 * V_25 ;
struct V_348 * V_349 ;
int V_2 , V_89 ;
V_25 = F_226 ( & V_347 -> V_298 , sizeof( struct V_62 ) , V_90 ) ;
if ( ! V_25 )
return - V_91 ;
V_25 -> V_26 = F_227 ( & V_347 -> V_298 ) ;
F_228 ( & V_25 -> V_92 ) ;
F_229 ( & V_25 -> V_244 ) ;
V_25 -> V_298 = & V_347 -> V_298 ;
V_349 = F_230 ( V_347 , V_350 , 0 ) ;
V_25 -> V_36 = F_231 ( & V_347 -> V_298 , V_349 ) ;
if ( F_52 ( V_25 -> V_36 ) )
return F_53 ( V_25 -> V_36 ) ;
V_25 -> V_313 = V_89 = F_232 ( V_347 , 0 ) ;
if ( V_89 < 0 ) {
F_219 ( & V_347 -> V_298 , L_7 ) ;
return V_89 ;
}
V_89 = F_233 ( & V_347 -> V_298 , V_25 -> V_313 , V_25 -> V_26 -> V_351 ,
0 , F_234 ( & V_347 -> V_298 ) , V_25 ) ;
if ( V_89 ) {
F_219 ( & V_347 -> V_298 , L_8 , V_25 -> V_313 ) ;
return V_89 ;
}
for ( V_2 = 0 ; V_2 < V_25 -> V_26 -> V_352 ; V_2 ++ ) {
V_25 -> V_353 [ V_2 ] = F_235 ( & V_347 -> V_298 ,
V_25 -> V_26 -> V_354 [ V_2 ] ) ;
if ( F_52 ( V_25 -> V_353 [ V_2 ] ) ) {
F_219 ( & V_347 -> V_298 , L_9 ,
V_25 -> V_26 -> V_354 [ V_2 ] ) ;
return F_53 ( V_25 -> V_353 [ V_2 ] ) ;
}
}
V_89 = F_236 ( & V_347 -> V_298 , & V_25 -> V_202 ) ;
if ( V_89 ) {
F_219 ( & V_347 -> V_298 , L_10 ) ;
return V_89 ;
}
V_25 -> V_106 = F_237 ( V_25 -> V_26 -> V_355 ) ;
if ( F_52 ( V_25 -> V_106 ) ) {
F_77 ( & V_25 -> V_202 , L_11 ) ;
V_89 = F_53 ( V_25 -> V_106 ) ;
goto V_356;
}
V_25 -> V_292 = F_238 ( & V_347 -> V_298 ) ;
if ( F_52 ( V_25 -> V_292 ) ) {
F_77 ( & V_25 -> V_202 , L_12 ) ;
V_89 = F_53 ( V_25 -> V_292 ) ;
goto V_357;
}
V_25 -> V_95 = F_239 () ;
if ( ! V_25 -> V_95 ) {
...
V_89 = F_240 ( V_25 -> V_369 , V_368 , - 1 ) ;
if ( V_89 ) {
F_77 ( & V_25 -> V_202 , L_15 ) ;
V_365 ( V_25 -> V_369 ) ;
goto V_370;
}
F_241 ( V_25 -> V_369 , V_25 ) ;
F_242 ( & V_25 -> V_202 ,
L_18 ,
V_25 -> V_369 -> V_151 ) ;
F_243 ( V_347 , V_25 ) ;
...
static int F_249 ( struct V_346 * V_347 )
{
struct V_62 * V_25 = F_250 ( V_347 ) ;
int V_2 ;
F_251 ( V_25 -> V_298 ) ;
F_245 ( V_25 -> V_369 ) ;
F_245 ( V_25 -> V_95 ) ;
...
F_247 ( V_25 -> V_106 ) ;
F_248 ( & V_25 -> V_202 ) ;
if ( ! F_252 ( & V_347 -> V_298 ) ) {
for ( V_2 = V_25 -> V_26 -> V_352 - 1 ; V_2 >= 0 ; V_2 -- )
F_253 ( V_25 -> V_353 [ V_2 ] ) ;
}
return 0 ;
}
static int F_254 ( struct V_371 * V_298 )
{
struct V_62 * V_25 = F_255 ( V_298 ) ;
int V_2 ;
for ( V_2 = V_25 -> V_26 -> V_352 - 1 ; V_2 >= 0 ; V_2 -- )
F_253 ( V_25 -> V_353 [ V_2 ] ) ;
return 0 ;
}
static int F_256 ( struct V_371 * V_298 )
{
struct V_62 * V_25 = F_255 ( V_298 ) ;
unsigned long V_152 ;
int V_2 , V_89 ;
for ( V_2 = 0 ; V_2 < V_25 -> V_26 -> V_352 ; V_2 ++ ) {
V_89 = F_257 ( V_25 -> V_353 [ V_2 ] ) ;
if ( V_89 ) {
while ( -- V_2 > 0 )
F_253 ( V_25 -> V_353 [ V_2 ] ) ;
return V_89 ;
...
static int F_258 ( struct V_371 * V_298 )
{
if ( F_259 ( V_298 ) )
return 0 ;
return F_254 ( V_298 ) ;
}
static int F_260 ( struct V_371 * V_298 )
{
if ( F_259 ( V_298 ) )
return 0 ;
return F_256 ( V_298 ) ;
}
static void * F_227 ( struct V_371 * V_298 )
{
struct V_372 * V_373 = NULL ;
const struct V_374 * V_375 ;
if ( ! F_261 ( V_376 ) || ! V_298 -> V_377 )
return & V_378 ;
V_375 = F_262 ( V_379 , V_298 -> V_377 ) ;
if ( V_375 )
V_373 = (struct V_372 * ) V_375 -> V_72 ;
return V_373 ;
}
