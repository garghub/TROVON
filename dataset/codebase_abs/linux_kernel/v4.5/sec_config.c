...
static void F_8 ( struct V_14 * V_33 )
{
...
static int F_11 ( char * V_43 , struct V_35 * V_36 )
{
char * V_44 , * V_45 ;
int V_46 ;
F_9 ( V_36 ) ;
...
return 0 ;
V_54 = V_49 -> V_50 + 8 ;
V_53 = F_19 ( V_54 , sizeof( * V_49 -> V_52 ) , V_55 ) ;
if ( V_53 == NULL )
return - V_56 ;
if ( V_49 -> V_51 ) {
F_14 ( V_49 -> V_50 && V_49 -> V_52 ) ;
...
static inline int F_21 ( struct V_35 * V_36 )
{
return ( V_36 -> V_37 != F_10 ( V_38 ) ) ;
}
...
static inline int F_23 ( struct V_35 * V_57 ,
struct V_35 * V_58 )
{
...
static inline int F_27 ( char V_69 )
{
return ( ( V_69 >= '0' && V_69 <= '9' ) ||
( V_69 >= 'a' && V_69 <= 'f' ) ) ;
}
static void F_28 ( const char * V_70 , char * V_71 , int V_72 )
{
const char * V_73 ;
int V_74 ;
V_73 = strrchr ( V_70 , '-' ) ;
...
! F_27 ( V_73 [ 4 ] ) || ! F_27 ( V_73 [ 5 ] ) ||
! F_27 ( V_73 [ 6 ] ) || ! F_27 ( V_73 [ 7 ] ) )
V_73 = NULL ;
}
if ( V_73 == NULL )
V_74 = strlen ( V_70 ) ;
...
{
F_25 ( V_86 , L_15 , V_76 -> V_87 ) ;
F_30 ( V_76 ) ;
F_32 ( & V_76 -> V_88 ) ;
F_15 ( V_76 ) ;
}
static
struct V_77 * F_35 ( struct V_75 * V_76 ,
const char * V_89 ,
int V_90 )
{
struct V_77 * V_78 ;
F_36 (conf_tgt, &conf->sc_tgts, sct_list) {
if ( strcmp ( V_78 -> V_91 , V_89 ) == 0 )
return V_78 ;
}
if ( ! V_90 )
return NULL ;
V_78 = F_37 ( sizeof( * V_78 ) , V_55 ) ;
if ( V_78 ) {
F_4 ( V_78 -> V_91 , V_89 , sizeof( V_78 -> V_91 ) ) ;
F_16 ( & V_78 -> V_81 ) ;
...
{
struct V_75 * V_76 ;
F_36 (conf, &sptlrpc_confs, sc_list) {
if ( strcmp ( V_76 -> V_87 , V_71 ) == 0 )
return V_76 ;
}
if ( ! V_90 )
return NULL ;
V_76 = F_37 ( sizeof( * V_76 ) , V_55 ) ;
if ( ! V_76 )
return NULL ;
...
V_74 = F_29 ( ( int ) ( V_73 - V_101 ) , V_72 - 1 ) ;
...
char V_89 [ V_97 ] ;
int V_74 , V_46 = 0 ;
F_28 ( V_93 -> V_107 , V_89 , sizeof( V_89 ) ) ;
F_44 ( & V_99 ) ;
V_76 = F_39 ( V_89 , 0 ) ;
if ( V_76 == NULL )
goto V_108;
...
V_46 = F_26 ( & V_76 -> V_80 , V_65 , V_66 , V_67 , V_33 ) ;
V_108:
F_45 ( & V_99 ) ;
if ( V_46 == 0 )
F_8 ( V_33 ) ;
...
{
struct V_109 * V_110 ;
F_14 ( strcmp ( V_3 -> V_4 -> V_5 , V_111 ) == 0 ||
strcmp ( V_3 -> V_4 -> V_5 , V_112 ) == 0 ) ;
F_25 ( V_86 , L_25 , V_3 -> V_113 . V_114 . V_115 . V_107 ) ;
...
F_44 ( & V_99 ) ;
F_31 (conf, conf_next, &sptlrpc_confs, sc_list) {
F_34 ( V_76 ) ;
}
F_14 ( F_33 ( & V_92 ) ) ;
F_45 ( & V_99 ) ;
