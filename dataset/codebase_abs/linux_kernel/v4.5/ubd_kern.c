...
if( V_54 -> V_154 == - 1 )
return 0 ;
V_3 = F_120 ( V_54 -> V_166 [ 1 ] , & V_54 -> V_155 ,
sizeof( V_54 -> V_155 ) , V_54 -> V_154 ) ;
...
T_1 V_5 ;
if ( V_54 -> V_159 == V_171 ) {
V_3 = F_122 ( V_54 -> V_166 [ 0 ] ) ;
if ( V_3 != 0 ) {
F_18 ( L_69
L_70 , - V_3 , V_54 -> V_166 [ 0 ] ) ;
V_54 -> error = 1 ;
}
return;
}
...
V_78 = & V_78 [ V_3 ] ;
V_80 -= V_3 ;
V_3 = F_44 ( V_54 -> V_166 [ V_1 ] , V_78 , V_80 , V_5 ) ;
if ( V_3 < 0 ) {
F_18 ( L_71
L_70 , - V_3 , V_54 -> V_166 [ V_1 ] ) ;
V_54 -> error = 1 ;
return;
}
...
V_3 = F_120 ( V_54 -> V_166 [ V_1 ] , V_78 , V_80 , V_5 ) ;
if( V_3 != V_80 ) {
F_18 ( L_72
L_70 , - V_3 , V_54 -> V_166 [ V_1 ] ) ;
V_54 -> error = 1 ;
