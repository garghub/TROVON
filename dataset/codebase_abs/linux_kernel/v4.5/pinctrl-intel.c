...
V_80 = F_64 ( V_3 -> V_11 , V_117 , F_58 , V_126 ,
F_60 ( V_3 -> V_11 ) , V_3 ) ;
if ( V_80 ) {
F_62 ( V_3 -> V_11 , L_17 ) ;
goto V_125;
}
V_80 = F_65 ( & V_3 -> V_84 , & V_127 , 0 ,
V_128 , V_129 ) ;
if ( V_80 ) {
F_62 ( V_3 -> V_11 , L_18 ) ;
goto V_125;
}
F_66 ( & V_3 -> V_84 , & V_127 , V_117 ,
NULL ) ;
return 0 ;
V_125:
F_67 ( & V_3 -> V_84 ) ;
...
struct V_132 * V_133 ;
int V_6 ;
V_133 = F_70 ( V_3 -> V_11 , V_28 -> V_10 , sizeof( * V_133 ) , V_134 ) ;
if ( ! V_133 )
return - V_135 ;
...
if ( ! V_140 )
return - V_71 ;
V_3 = F_72 ( & V_139 -> V_11 , sizeof( * V_3 ) , V_134 ) ;
if ( ! V_3 )
return - V_135 ;
V_3 -> V_11 = & V_139 -> V_11 ;
V_3 -> V_28 = V_140 ;
...
V_3 -> V_8 = F_70 ( & V_139 -> V_11 , V_3 -> V_7 ,
...
V_142 = F_74 ( V_139 , V_144 ,
V_5 -> V_145 ) ;
V_21 = F_75 ( & V_139 -> V_11 , V_142 ) ;
if ( F_76 ( V_21 ) )
return F_77 ( V_21 ) ;
...
return V_80 ;
V_3 -> V_147 = V_148 ;
V_3 -> V_147 . V_31 = F_60 ( & V_139 -> V_11 ) ;
V_3 -> V_147 . V_32 = V_3 -> V_28 -> V_32 ;
V_3 -> V_147 . V_10 = V_3 -> V_28 -> V_10 ;
V_3 -> V_27 = F_80 ( & V_3 -> V_147 , & V_139 -> V_11 , V_3 ) ;
if ( F_76 ( V_3 -> V_27 ) ) {
F_62 ( & V_139 -> V_11 , L_20 ) ;
