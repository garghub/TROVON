...
{
struct V_3 * V_103 = F_74 ( V_218 ) ;
struct V_2 * V_209 = F_28 ( V_103 ) ;
...
static T_6
F_75 ( struct V_3 * V_103 , struct V_222 * V_220 ,
char * V_156 )
{
struct V_2 * V_209 = F_28 ( V_103 ) ;
return sprintf ( V_156 , L_38 , V_209 -> V_223 & 0xff ) ;
}
int F_76 ( struct V_2 * V_209 , unsigned int V_224 )
{
...
V_104 = F_80 ( & V_209 -> V_103 , & V_246 ) ;
if ( V_104 )
F_21 ( V_209 ,
L_57 , V_104 ) ;
F_81 ( V_209 , L_58 ,
V_156 , V_211 , V_209 -> V_247 >> 8 , V_209 -> V_247 & 0xff ,
type , V_209 -> V_182 , V_209 -> V_248 ) ;
return 0 ;
}
...
static T_6 F_86 ( struct V_250 * V_251 , const char * V_156 ,
T_8 V_95 )
{
struct V_178 * V_179 = F_87 ( V_251 ) ;
struct V_252 * V_253 ;
V_53 V_211 , V_136 , V_138 ;
unsigned long V_254 = 0 ;
int V_104 ;
V_104 = sscanf ( V_156 , L_59 ,
& V_211 , & V_136 , & V_138 , & V_254 ) ;
if ( V_104 < 3 )
return - V_33 ;
V_253 = F_2 ( sizeof( * V_253 ) , V_10 ) ;
if ( ! V_253 )
return - V_36 ;
V_253 -> V_4 . V_211 = V_211 ;
V_253 -> V_4 . V_130 = V_213 ;
V_253 -> V_4 . V_136 = V_136 ;
V_253 -> V_4 . V_138 = V_138 ;
V_253 -> V_4 . V_254 = V_254 ;
F_88 ( & V_179 -> V_255 ) ;
F_3 ( & V_253 -> V_13 , & V_179 -> V_256 ) ;
F_89 ( & V_179 -> V_255 ) ;
...
if ( F_70 ( V_209 , & V_253 -> V_4 ) ) {
F_89 ( & V_179 -> V_255 ) ;
return & V_253 -> V_4 ;
}
}
F_89 ( & V_179 -> V_255 ) ;
return F_71 ( V_209 , V_179 -> V_257 ) ;
}
static int F_96 ( struct V_3 * V_103 , struct V_250 * V_251 )
{
struct V_178 * V_179 = F_87 ( V_251 ) ;
struct V_2 * V_209 = F_28 ( V_103 ) ;
...
{
struct V_178 * V_179 = F_87 ( V_103 -> V_167 ) ;
struct V_2 * V_209 = F_28 ( V_103 ) ;
const struct V_210 * V_4 ;
int V_104 = 0 ;
if ( F_98 ( & V_209 -> V_258 ) )
...
V_209 -> V_167 = V_179 ;
if ( V_179 -> V_262 ) {
V_104 = V_179 -> V_262 ( V_209 , V_4 ) ;
} else {
V_104 = F_40 ( V_209 ) ;
if ( ! V_104 )
V_104 = F_99 ( V_209 , V_263 ) ;
}
if ( V_104 ) {
F_25 ( V_209 ) ;
V_209 -> V_167 = NULL ;
...
char * V_156 )
{
struct V_2 * V_209 = F_103 ( V_103 , struct V_2 , V_103 ) ;
return F_104 ( V_156 , V_264 , L_60 ,
V_209 -> V_211 , V_209 -> V_130 , V_209 -> V_136 , V_209 -> V_138 ) ;
}
static int F_105 ( struct V_3 * V_103 , struct V_265 * V_266 )
{
struct V_2 * V_209 = F_28 ( V_103 ) ;
if ( F_106 ( V_266 , L_61 ,
V_209 -> V_211 , V_209 -> V_136 , V_209 -> V_138 ) )
return - V_36 ;
if ( F_106 ( V_266 , L_62 , V_209 -> V_182 ) )
return - V_36 ;
if ( F_106 ( V_266 , L_63 , V_209 -> V_248 ) )
return - V_36 ;
if ( F_106 ( V_266 , L_64 , V_209 -> V_267 ) )
return - V_36 ;
if ( F_106 ( V_266 , L_65 ,
V_209 -> V_211 , V_209 -> V_130 , V_209 -> V_136 , V_209 -> V_138 ) )
return - V_36 ;
...
bool F_107 ( struct V_2 * V_209 )
{
if ( V_209 -> V_226 & V_268 )
return false ;
if ( V_209 -> V_226 & V_269 )
return true ;
switch ( V_209 -> V_136 ) {
case V_270 :
if ( V_209 -> V_138 >= V_271 &&
V_209 -> V_138 <= V_272 )
return true ;
break;
case V_273 :
if ( V_209 -> V_138 >= V_274 &&
V_209 -> V_138 <= V_275 )
return true ;
if ( V_209 -> V_138 == V_276 &&
! strcmp ( V_209 -> V_182 , L_66 ) )
return true ;
break;
case V_277 :
if ( V_209 -> V_138 >= V_278 &&
V_209 -> V_138 <= V_279 )
return true ;
break;
case V_280 :
if ( V_209 -> V_138 >= V_281 &&
V_209 -> V_138 <= V_282 )
return true ;
break;
case V_283 :
if ( V_209 -> V_138 == V_284 &&
V_209 -> type == V_285 )
return true ;
break;
case V_286 :
if ( ( V_209 -> V_138 >= V_287 &&
V_209 -> V_138 <= V_288 ) ||
( V_209 -> V_138 >= V_289 &&
V_209 -> V_138 <= V_290 ) )
return true ;
break;
case V_291 :
if ( V_209 -> V_138 == V_292 &&
V_209 -> V_211 == V_232 &&
strncmp ( V_209 -> V_182 , L_67 , 22 ) == 0 )
return true ;
break;
}
if ( V_209 -> type == V_293 &&
F_71 ( V_209 , V_294 ) )
return true ;
return ! ! F_71 ( V_209 , V_295 ) ;
}
int F_108 ( struct V_2 * V_209 )
{
static T_9 V_4 = F_109 ( 0 ) ;
int V_104 ;
if ( F_46 ( V_209 -> V_116 & V_296 ) )
return - V_206 ;
if ( F_107 ( V_209 ) )
return - V_204 ;
...
V_104 = F_36 ( V_209 ) ;
if ( V_104 )
F_21 ( V_209 , L_69 , V_104 ) ;
}
F_110 ( & V_209 -> V_103 , L_70 , V_209 -> V_211 ,
V_209 -> V_136 , V_209 -> V_138 , F_111 ( & V_4 ) ) ;
F_112 ( V_209 , F_20 ( & V_209 -> V_103 ) ) ;
V_104 = F_113 ( & V_209 -> V_103 ) ;
if ( ! V_104 )
V_209 -> V_116 |= V_296 ;
else
F_114 ( V_209 ) ;
...
return F_116 ( V_104 ) ;
F_117 ( & V_209 -> V_103 ) ;
V_209 -> V_103 . V_300 = F_27 ;
V_209 -> V_103 . V_211 = & V_301 ;
F_118 ( & V_209 -> V_103 ) ;
F_25 ( V_209 ) ;
F_119 ( & V_209 -> V_302 ) ;
F_26 ( & V_209 -> V_180 ) ;
...
static void F_122 ( struct V_2 * V_209 )
{
if ( V_209 -> V_116 & V_296 ) {
F_123 ( & V_209 -> V_103 ) ;
F_114 ( V_209 ) ;
V_209 -> V_116 &= ~ V_296 ;
}
...
void F_124 ( struct V_2 * V_209 )
{
F_122 ( V_209 ) ;
F_125 ( & V_209 -> V_103 ) ;
}
int F_126 ( struct V_178 * V_179 , struct V_304 * V_305 ,
const char * V_306 )
{
int V_104 ;
V_179 -> V_167 . V_182 = V_179 -> V_182 ;
V_179 -> V_167 . V_211 = & V_301 ;
V_179 -> V_167 . V_305 = V_305 ;
V_179 -> V_167 . V_306 = V_306 ;
F_26 ( & V_179 -> V_256 ) ;
F_120 ( & V_179 -> V_255 ) ;
V_104 = F_127 ( & V_179 -> V_167 ) ;
if ( V_104 )
return V_104 ;
V_104 = F_128 ( & V_179 -> V_167 , & V_307 ) ;
if ( V_104 )
F_129 ( & V_179 -> V_167 ) ;
return V_104 ;
}
void F_130 ( struct V_178 * V_179 )
{
F_131 ( & V_179 -> V_167 , & V_307 ) ;
F_129 ( & V_179 -> V_167 ) ;
F_91 ( V_179 ) ;
}
...
for ( V_48 = 0 ; V_48 < F_133 ( V_310 ) ; V_48 ++ )
if ( V_309 -> V_311 -> V_312 [ V_48 ] )
return 1 ;
}
return 0 ;
}
