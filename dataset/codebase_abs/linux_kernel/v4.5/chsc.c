...
static void
F_68 ( struct V_65 * V_66 , T_2 V_176 ,
struct V_177 * V_178 )
{
int V_15 , V_16 ;
...
V_16 = 0x80 >> ( V_15 + 3 ) ;
if ( V_176 & V_16 )
V_66 -> V_177 . V_180 [ V_15 ] = V_178 -> V_180 [ V_15 ] ;
else
V_66 -> V_177 . V_180 [ V_15 ] = 0 ;
}
}
...
V_186 -> V_169 = V_66 -> V_35 . V_36 ;
V_186 -> V_170 = V_66 -> V_35 . V_36 ;
V_13 = F_4 ( V_186 ) ;
if ( V_13 > 0 ) {
V_14 = ( V_13 == 3 ) ? - V_27 : - V_4 ;
goto V_28;
...
if ( V_186 -> V_181 )
goto V_28;
V_66 -> V_184 = V_186 -> V_184 ;
V_66 -> V_182 = V_186 -> V_182 ;
if ( V_66 -> V_184 != 2 && V_66 -> V_184 != 3 ) {
goto V_28;
}
F_68 ( V_66 , V_186 -> V_176 ,
...
int F_74 ( struct V_192 * V_193 , int V_46 )
{
int V_14 ;
V_193 -> V_20 . V_21 = 0x0400 ;
V_193 -> V_20 . V_22 = 0x0031 ;
V_193 -> V_46 = V_46 ;
V_14 = F_4 ( V_193 ) ;
if ( V_14 > 0 ) {
...
switch ( V_193 -> V_1 . V_22 ) {
case 0x0101 :
V_14 = - V_3 ;
break;
default:
V_14 = F_1 ( V_193 -> V_1 . V_22 ) ;
}
V_28:
return V_14 ;
}
...
memset ( V_18 , 0 , V_19 ) ;
V_201 = V_18 ;
V_201 -> V_20 . V_21 = 0x0010 ;
V_201 -> V_20 . V_22 = 0x0010 ;
V_194 = F_4 ( V_201 ) ;
if ( V_194 ) {
V_194 = ( V_194 == 3 ) ? - V_27 : - V_4 ;
goto exit;
}
V_194 = F_1 ( V_201 -> V_1 . V_22 ) ;
if ( V_194 == 0 ) {
memcpy ( & V_52 , V_201 -> V_199 ,
sizeof( V_52 ) ) ;
memcpy ( & V_187 , V_201 -> V_200 ,
sizeof( V_187 ) ) ;
} else
F_28 ( 2 , L_41 ,
V_201 -> V_1 . V_22 ) ;
...
int F_77 ( void * V_164 , unsigned int V_114 , T_5 V_202 )
{
struct {
struct V_147 V_20 ;
unsigned int V_203 ;
unsigned int V_114 : 8 ;
unsigned int V_204 : 8 ;
unsigned int V_202 : 16 ;
unsigned int V_205 [ 5 ] ;
struct V_147 V_1 ;
unsigned int V_206 [ 7 ] ;
} V_155 ( ( V_156 ) ) * V_207 ;
int V_208 ;
memset ( V_164 , 0 , V_19 ) ;
V_207 = V_164 ;
...
int F_78 ( void * V_164 , void * V_194 , T_6 V_209 )
{
struct {
struct V_147 V_20 ;
unsigned int V_203 [ 3 ] ;
struct V_147 V_1 ;
char V_57 [ V_209 ] ;
} V_155 ( ( V_156 ) ) * V_207 ;
int V_208 ;
