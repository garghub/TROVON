...
V_46 -> V_74 = & V_78 ;
V_46 -> V_79 = V_2 -> V_80 . V_81 ;
F_43 ( V_46 -> V_79 , V_46 -> V_50 ,
sizeof( V_2 -> V_80 . V_81 ) - 1 ) ;
}
} else
F_44 ( V_46 , V_46 -> V_47 , F_45 ( V_2 -> V_82 ) ) ;
F_46 ( V_46 ) ;
return V_46 ;
}
static void F_47 ( struct V_83 * V_84 )
{
struct V_28 * V_28 = F_48 ( V_84 , struct V_28 , V_85 ) ;
F_49 ( V_23 , V_28 -> V_62 ) ;
}
void
F_50 ( struct V_28 * V_46 )
{
F_51 ( & V_46 -> V_86 ) ;
F_52 ( V_46 ) ;
F_53 ( & V_46 -> V_85 , F_47 ) ;
