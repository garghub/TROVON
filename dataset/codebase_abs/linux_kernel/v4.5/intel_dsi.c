...
static enum V_127
F_83 ( struct V_128 * V_129 ,
struct V_65 * V_130 )
{
struct V_63 * V_63 = F_84 ( V_129 ) ;
struct V_65 * V_66 = V_63 -> V_67 . V_66 ;
int V_131 = F_85 ( V_129 -> V_7 ) -> V_132 ;
F_34 ( L_7 ) ;
if ( V_130 -> V_36 & V_133 ) {
F_34 ( L_9 ) ;
return V_134 ;
...
static T_5 F_86 ( T_1 V_140 , unsigned int V_141 )
{
switch ( V_140 ) {
case V_142 :
default:
...
static T_5 F_87 ( T_5 V_145 , int V_146 , int V_147 ,
T_5 V_148 )
{
return F_88 ( F_88 ( V_145 * V_146 * V_148 ,
8 * 100 ) , V_147 ) ;
}
...
enum V_2 V_2 ;
unsigned int V_146 = V_76 -> V_100 -> V_124 ;
unsigned int V_147 = V_1 -> V_147 ;
T_5 V_149 , V_150 , V_151 , V_152 , V_153 , V_154 , V_155 ;
V_149 = V_68 -> V_156 ;
...
V_153 = V_68 -> V_160 - V_68 -> V_161 ;
V_154 = V_68 -> V_162 - V_68 -> V_160 ;
V_155 = V_68 -> V_163 - V_68 -> V_162 ;
V_149 = F_87 ( V_149 , V_146 , V_147 ,
V_1 -> V_148 ) ;
V_150 = F_87 ( V_150 , V_146 , V_147 , V_1 -> V_148 ) ;
V_151 = F_87 ( V_151 , V_146 , V_147 ,
V_1 -> V_148 ) ;
V_152 = F_87 ( V_152 , V_146 , V_147 , V_1 -> V_148 ) ;
F_38 (port, intel_dsi->ports) {
if ( F_47 ( V_7 ) ) {
F_8 ( F_90 ( V_2 ) ,
V_68 -> V_156 ) ;
...
static void F_58 ( struct V_60 * V_60 )
{
...
F_8 ( F_104 ( V_2 ) , V_1 -> V_169 ) ;
F_8 ( F_105 ( V_2 ) ,
V_68 -> V_161 << V_170 |
V_164 << V_171 ) ;
}
F_89 ( V_4 , V_68 ) ;
V_21 = V_1 -> V_147 << V_172 ;
if ( F_31 ( V_1 ) ) {
