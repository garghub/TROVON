...
* V_25 = F_10 ( V_18 , V_19 , V_20 , V_26 , V_27 ) ;
if ( ! * V_25 )
return 0 ;
if ( ! V_23 && ! F_11 ( V_19 , V_20 ) ) {
F_6 ( L_5 ) ;
F_9 ( L_4 , V_19 , false ) ;
F_9 ( L_6 , V_20 , false ) ;
return - V_29 ;
...
int F_12 ( struct V_13 * V_14 , struct V_1 * V_2 ,
struct V_15 * V_16 ,
int V_31 , int V_32 ,
...
static struct V_13 * F_19 ( struct V_6 * V_7 )
{
struct V_13 * V_57 ;
int V_49 ;
V_57 = F_14 ( sizeof( * V_57 ) , V_53 ) ;
if ( V_57 == NULL ) {
F_6 ( L_7 ) ;
return NULL ;
}
V_57 -> V_58 = true ;
V_49 = F_20 ( V_7 , V_57 , 0 ,
& V_59 ,
V_60 ,
F_21 ( V_60 ) ,
V_61 , NULL ) ;
...
int F_22 ( struct V_6 * V_7 , struct V_1 * V_2 ,
const struct V_62 * V_51 )
{
struct V_13 * V_57 ;
V_57 = F_19 ( V_7 ) ;
return F_23 ( V_7 , V_2 , V_57 , NULL , V_51 ,
NULL ) ;
}
...
int F_31 ( struct V_13 * V_14 , struct V_1 * V_2 ,
struct V_15 * V_16 ,
int V_31 , int V_32 ,
unsigned int V_33 , unsigned int V_34 ,
T_1 V_35 , T_1 V_36 ,
...
V_64 -> V_38 = V_38 ;
V_64 -> V_37 = V_37 ;
return F_24 ( V_14 , V_64 , V_14 -> V_16 ) ;
}
