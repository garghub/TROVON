...
F_16 ( V_135 , V_129 ) ;
V_133 = F_71 () ;
if ( ( V_24 -> V_136 == V_129 ) || ( V_24 -> V_137 == V_133 ) ) {
F_72 ( V_132 ) ;
return;
}
F_72 ( V_132 ) ;
V_24 -> V_138 = V_24 -> V_126 . time ;
V_24 -> V_126 . time = F_73 () ;
V_24 -> V_126 . V_128 = V_128 ;
V_24 -> V_126 . V_129 = V_129 ;
V_24 -> V_126 . V_133 = V_133 ;
V_24 -> V_126 . V_128 -= V_24 -> V_139 ;
V_24 -> V_126 . V_129 -= V_24 -> V_136 ;
V_24 -> V_126 . V_133 -= V_24 -> V_137 ;
F_67 ( V_24 ) ;
V_24 -> V_139 = V_128 ;
V_24 -> V_136 = V_129 ;
V_24 -> V_137 = V_133 ;
...
V_146 = F_68 ( V_145 * V_24 -> V_35 . V_116 *
V_24 -> V_35 . V_36 , V_150 ) ;
V_129 = V_24 -> V_126 . V_129 + V_146 ;
V_24 -> V_149 = V_144 ;
V_148 = F_68 ( F_7 ( 100 ) * V_129 , V_126 -> V_133 ) ;
V_24 -> V_126 . V_151 = V_148 ;
return V_24 -> V_35 . V_115 - F_11 ( & V_24 -> V_8 , V_148 ) ;
}
static inline T_1 F_80 ( struct V_23 * V_24 )
{
T_1 V_152 , V_36 , V_115 , V_153 ;
T_2 V_154 ;
V_53 V_155 ;
V_152 = V_24 -> V_126 . V_131 ;
V_36 = F_7 ( V_24 -> V_35 . V_121 ) ;
V_115 = F_7 ( V_24 -> V_35 . V_115 ) ;
V_152 = F_1 ( V_152 , F_2 ( V_36 , V_115 ) ) ;
V_155 = V_25 . V_143 * V_156 ;
V_154 = F_81 ( V_24 -> V_126 . time ,
V_24 -> V_138 ) ;
if ( V_154 > V_155 * 3 ) {
V_153 = F_2 ( F_7 ( V_155 ) ,
F_7 ( V_154 ) ) ;
...
V_24 -> V_126 . V_151 = V_152 ;
return V_24 -> V_35 . V_115 - F_11 ( & V_24 -> V_8 , V_152 ) ;
}
static inline void F_82 ( struct V_23 * V_24 )
{
int V_157 , V_158 ;
struct V_126 * V_126 ;
V_157 = V_24 -> V_35 . V_115 ;
V_158 = V_117 . V_159 ( V_24 ) ;
F_64 ( V_24 , V_158 , true ) ;
V_126 = & V_24 -> V_126 ;
F_83 ( F_5 ( V_126 -> V_131 ) ,
F_5 ( V_126 -> V_151 ) ,
V_157 ,
V_24 -> V_35 . V_115 ,
V_126 -> V_129 ,
...
static void F_84 ( unsigned long V_160 )
{
struct V_23 * V_24 = (struct V_23 * ) V_160 ;
F_69 ( V_24 ) ;
F_74 ( V_24 ) ;
}
static void F_85 ( unsigned long V_160 )
{
struct V_23 * V_24 = (struct V_23 * ) V_160 ;
F_69 ( V_24 ) ;
F_82 ( V_24 ) ;
...
static int F_86 ( unsigned int V_161 )
{
struct V_23 * V_24 ;
if ( ! V_29 [ V_161 ] )
V_29 [ V_161 ] = F_87 ( sizeof( struct V_23 ) ,
V_162 ) ;
if ( ! V_29 [ V_161 ] )
return - V_163 ;
V_24 = V_29 [ V_161 ] ;
...
V_24 -> V_141 . V_164 = V_142 + V_165 / 100 ;
if ( ! V_57 )
V_24 -> V_141 . V_166 = F_85 ;
else
V_24 -> V_141 . V_166 = F_84 ;
F_12 ( V_24 ) ;
F_69 ( V_24 ) ;
F_89 ( & V_24 -> V_141 , V_161 ) ;
F_58 ( L_7 , V_161 ) ;
return 0 ;
}
static unsigned int F_90 ( unsigned int V_167 )
{
struct V_126 * V_126 ;
struct V_23 * V_24 ;
V_24 = V_29 [ V_167 ] ;
...
F_58 ( L_9 ) ;
V_32 = & V_175 ;
V_32 -> V_78 = ( V_169 -> V_38 * 100 ) / V_169 -> V_170 . V_171 ;
V_32 -> V_78 = F_38 ( int , V_32 -> V_78 , 0 , 100 ) ;
V_32 -> V_77 = F_92 ( V_169 -> V_40 * 100 ,
V_169 -> V_170 . V_171 ) ;
...
{
int V_167 = V_169 -> V_24 ;
struct V_23 * V_24 = V_29 [ V_167 ] ;
F_58 ( L_10 , V_167 ) ;
F_97 ( & V_29 [ V_167 ] -> V_141 ) ;
if ( V_57 )
return;
F_64 ( V_24 , V_24 -> V_35 . V_69 , false ) ;
}
...
struct V_23 * V_24 ;
int V_83 ;
V_83 = F_86 ( V_169 -> V_24 ) ;
if ( V_83 )
return V_83 ;
V_24 = V_29 [ V_169 -> V_24 ] ;
if ( V_32 -> V_48 == 100 && V_32 -> V_49 == 100 )
V_169 -> V_169 = V_173 ;
else
V_169 -> V_169 = V_176 ;
V_169 -> V_38 = V_24 -> V_35 . V_69 * V_24 -> V_35 . V_116 ;
V_169 -> V_40 = V_24 -> V_35 . V_37 * V_24 -> V_35 . V_116 ;
V_169 -> V_170 . V_177 = V_24 -> V_35 . V_69 * V_24 -> V_35 . V_116 ;
V_169 -> V_170 . V_171 =
V_24 -> V_35 . V_37 * V_24 -> V_35 . V_116 ;
V_169 -> V_170 . V_178 = V_179 ;
F_99 ( V_169 -> V_24 , V_169 -> V_180 ) ;
return 0 ;
}
...
static void F_101 ( struct V_181 * V_169 )
{
V_25 . V_143 = V_169 -> V_143 ;
V_25 . V_26 = V_169 -> V_26 ;
V_25 . V_28 = V_169 -> V_28 ;
V_25 . V_27 = V_169 -> V_27 ;
V_25 . V_11 = V_169 -> V_11 ;
V_25 . V_9 = V_169 -> V_9 ;
}
static void F_102 ( struct V_117 * V_182 )
{
V_117 . V_120 = V_182 -> V_120 ;
V_117 . V_122 = V_182 -> V_122 ;
V_117 . V_119 = V_182 -> V_119 ;
V_117 . V_123 = V_182 -> V_123 ;
V_117 . V_124 = V_182 -> V_124 ;
V_117 . V_118 = V_182 -> V_118 ;
V_117 . V_125 = V_182 -> V_125 ;
V_117 . V_159 = V_182 -> V_159 ;
}
...
T_8 V_183 ;
union V_184 * V_185 ;
struct V_186 V_187 = { V_188 , NULL } ;
struct V_189 * V_190 = F_105 ( V_191 , V_56 ) ;
if ( ! V_190 )
continue;
V_183 = F_106 ( V_190 -> V_192 , L_11 , NULL , & V_187 ) ;
if ( F_107 ( V_183 ) )
continue;
V_185 = V_187 . V_193 ;
if ( V_185 && V_185 -> type == V_194 ) {
F_108 ( V_185 ) ;
return false ;
}
F_108 ( V_185 ) ;
...
if ( V_204 ||
F_107 ( F_113 ( V_205 , 0 , & V_196 ) ) )
return false ;
for ( V_198 = V_206 ; V_198 -> V_207 ; V_198 ++ ) {
if ( ! strncmp ( V_196 . V_208 , V_198 -> V_208 , V_209 ) &&
! strncmp ( V_196 . V_210 , V_198 -> V_210 ,
V_211 ) )
switch ( V_198 -> V_212 ) {
case V_213 :
return F_103 () ;
...
if ( F_111 () )
return - V_172 ;
V_217 = (struct V_216 * ) V_200 -> V_220 ;
F_101 ( & V_217 -> V_221 ) ;
F_102 ( & V_217 -> V_182 ) ;
if ( F_100 () )
return - V_172 ;
F_115 ( L_13 ) ;
V_29 = F_116 ( sizeof( void * ) * F_117 () ) ;
if ( ! V_29 )
return - V_163 ;
if ( F_118 ( V_222 ) && ! V_223 ) {
F_115 ( L_14 ) ;
V_57 ++ ;
}
if ( ! V_57 && V_224 )
...
static int T_4 F_121 ( char * V_227 )
{
if ( ! V_227 )
return - V_74 ;
if ( ! strcmp ( V_227 , L_15 ) )
V_218 = 1 ;
if ( ! strcmp ( V_227 , L_16 ) ) {
F_115 ( L_17 ) ;
V_223 = 1 ;
}
if ( ! strcmp ( V_227 , L_18 ) )
V_215 = 1 ;
if ( ! strcmp ( V_227 , L_19 ) )
V_224 = 1 ;
return 0 ;
}
