...
if ( ! error )
error = F_38 ( & args -> V_74 , args -> V_76 , V_49 ) ;
if ( error ) {
args -> V_74 = NULL ;
F_39 ( args -> V_76 ) ;
return error ;
...
V_25 = F_41 ( V_2 -> V_69 , V_63 , V_64 , 0 ) ;
if ( ! V_25 )
return - V_79 ;
V_25 -> V_80 = & V_70 ;
...
V_63 = F_29 ( V_2 , V_47 . V_65 ) ,
V_64 = F_30 ( V_2 , V_47 . V_68 ) ;
V_25 = F_45 ( V_2 -> V_69 , V_63 , V_64 , V_82 ) ;
if ( V_25 ) {
F_46 ( V_25 ) ;
F_32 ( V_25 ) ;
V_25 = NULL ;
...
while ( ! V_81 ) {
F_36 ( args -> V_76 , args -> V_77 ) ;
error = F_47 ( args -> V_74 , args -> V_49 , V_51 , V_55 ,
V_62 , 1 , args -> V_77 ,
args -> V_76 , & V_81 ) ;
if ( ! error )
error = F_38 ( & args -> V_74 , args -> V_76 ,
args -> V_49 ) ;
if ( error ) {
args -> V_74 = NULL ;
F_39 ( args -> V_76 ) ;
...
error = F_40 ( & args -> V_74 , args -> V_49 ) ;
if ( error )
return error ;
}
return 0 ;
