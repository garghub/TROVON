...
{
unsigned int V_278 = F_143 ( V_279 ) ;
if ( V_77 )
F_144 ( V_279 , V_278 | V_280 ) ;
else
F_144 ( V_279 , V_278 & ~ ( V_280 ) ) ;
}
...
V_13 -> V_260 = 0 ;
V_13 -> V_75 = F_149 ( V_284 , L_66 , 0 ,
& V_114 ) ;
V_13 -> V_76 = ( V_114 & V_291 ) ? 1 : 0 ;
V_288 = NULL ;
while ( ( V_288 = F_150 ( V_284 , V_288 ) ) )
V_13 -> V_260 ++ ;
V_289 = F_151 ( & V_60 -> V_61 , sizeof( struct V_3 ) * V_13 -> V_260 ,
V_11 ) ;
if ( ! V_289 )
return F_148 ( - V_12 ) ;
...
while ( ( V_288 = F_150 ( V_284 , V_288 ) ) ) {
V_4 = & V_289 [ V_38 ] ;
V_40 = F_152 ( V_288 , L_67 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_68 , V_40 ) ;
goto V_277;
}
V_4 -> V_119 = V_73 ;
V_40 = F_152 ( V_288 , L_69 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_70 , V_40 ) ;
goto V_277;
}
V_4 -> V_122 = V_73 ;
V_40 = F_152 ( V_288 , L_71 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_72 , V_40 ) ;
goto V_277;
}
V_4 -> V_138 = V_73 ;
V_4 -> V_53 = F_153 ( V_288 , L_73 ) ;
V_4 -> V_136 = F_153 ( V_288 , L_74 ) ;
V_40 = F_154 ( V_288 , L_75 , & V_46 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_76 , V_40 ) ;
goto V_277;
}
V_4 -> V_4 . V_46 = V_46 ;
V_4 -> V_293 = V_13 -> V_43 + F_155 ( V_38 ) ;
V_4 -> V_294 = V_13 -> V_43 + F_156 ( V_38 ) ;
V_4 -> V_84 = V_13 -> V_84 + F_157 ( V_38 ) ;
V_4 -> V_4 . V_295 = & V_296 ;
F_158 ( & V_4 -> V_4 , V_4 -> V_122 ) ;
V_4 -> V_13 = V_13 ;
F_3 ( & V_4 -> V_17 ) ;
if ( V_4 -> V_119 == 0 ) {
...
static struct V_3 * F_159 ( struct V_281 * V_60 ,
struct V_37 * V_13 )
{
struct V_305 * V_306 = F_160 ( & V_60 -> V_61 ) ;
struct V_3 * V_289 ;
int V_38 ;
if ( ! V_306 )
return F_148 ( - V_307 ) ;
V_289 = F_151 ( & V_60 -> V_61 , sizeof( struct V_3 ) * V_306 -> V_260 ,
V_11 ) ;
if ( ! V_289 )
return F_148 ( - V_12 ) ;
V_13 -> V_65 . V_71 = & V_289 [ 0 ] . V_4 ;
...
static int F_161 ( struct V_281 * V_60 )
{
struct V_63 * V_43 , * V_84 ;
struct V_308 * V_268 , * V_269 ;
struct V_37 * V_13 ;
int V_246 , V_40 , V_38 ;
V_13 = F_151 ( & V_60 -> V_61 , sizeof( * V_13 ) , V_11 ) ;
if ( ! V_13 )
return - V_12 ;
V_13 -> V_65 = V_309 ;
F_3 ( & V_13 -> V_65 . V_292 ) ;
...
if ( V_246 < 0 )
return V_246 ;
V_268 = F_163 ( & V_60 -> V_61 , L_78 ) ;
if ( F_34 ( V_268 ) )
return F_164 ( V_268 ) ;
V_269 = F_163 ( & V_60 -> V_61 , L_79 ) ;
if ( F_34 ( V_269 ) )
return F_164 ( V_269 ) ;
F_165 ( & V_13 -> V_14 ) ;
F_166 ( & V_13 -> V_273 ) ;
...
V_13 -> V_75 = - V_175 ;
V_40 = - V_12 ;
V_13 -> V_43 = F_167 ( & V_60 -> V_61 , V_43 -> V_311 , F_37 ( V_43 ) ) ;
if ( ! V_13 -> V_43 ) {
F_31 ( & V_60 -> V_61 , L_80 ) ;
return V_40 ;
}
F_109 ( & V_60 -> V_61 , L_81 ,
( unsigned long ) V_43 -> V_311 , V_13 -> V_43 ) ;
V_13 -> V_84 = F_167 ( & V_60 -> V_61 , V_84 -> V_311 , F_37 ( V_84 ) ) ;
if ( ! V_13 -> V_84 ) {
F_31 ( & V_60 -> V_61 , L_82 ) ;
return V_40 ;
}
...
V_13 -> V_3 = F_159 ( V_60 , V_13 ) ;
F_46 ( V_13 , 0 ) ;
if ( F_34 ( V_13 -> V_3 ) )
return F_164 ( V_13 -> V_3 ) ;
V_40 = F_169 ( & V_60 -> V_61 , V_246 , F_123 , 0 ,
L_85 , V_13 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_86 ,
V_246 , V_40 ) ;
...
V_13 -> V_246 = V_246 ;
if ( F_44 ( V_13 -> V_75 ) ) {
if ( ! F_170 ( & V_60 -> V_61 , V_13 -> V_75 , L_85 ) ) {
F_171 ( F_139 ( V_13 -> V_75 ) ,
V_312 ) ;
V_40 = F_172 ( & V_60 -> V_61 ,
...
V_40 = F_173 ( & V_60 -> V_61 , & V_13 -> V_65 ) ;
if ( V_40 )
return V_40 ;
F_174 ( & V_60 -> V_61 , 1 ) ;
F_33 ( V_13 ) ;
...
static int F_175 ( struct V_281 * V_60 )
{
struct V_37 * V_13 ;
int V_38 ;
V_13 = F_176 ( V_60 ) ;
...
static int F_178 ( struct V_197 * V_61 )
{
struct V_37 * V_13 = F_179 ( V_61 ) ;
if ( ! V_13 -> V_167 )
return 0 ;
F_134 ( & V_13 -> V_273 ) ;
if ( ! F_180 ( V_61 ) ) {
...
if ( F_44 ( V_13 -> V_75 ) ) {
F_132 ( V_13 ) ;
F_181 ( F_139 ( V_13 -> V_75 ) ) ;
}
V_42:
F_135 ( & V_13 -> V_273 ) ;
return 0 ;
}
static int F_182 ( struct V_197 * V_61 )
{
struct V_37 * V_13 = F_179 ( V_61 ) ;
if ( ! V_13 -> V_167 )
return 0 ;
if ( F_180 ( V_61 ) && F_44 ( V_13 -> V_75 ) )
F_183 ( F_139 ( V_13 -> V_75 ) ) ;
F_134 ( & V_13 -> V_273 ) ;
V_13 -> V_274 = F_43 ( V_13 ) ;
if ( V_13 -> V_274 )
F_131 ( V_13 ) ;
