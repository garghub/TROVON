...
F_8 ( V_12 ) ;
F_17 ( & V_12 -> V_42 ) ;
if ( ! F_18 ( F_9 ( V_12 , struct V_31 ,
V_32 ) ) ) {
V_39 = 0 ;
goto V_43;
}
V_39 = F_19 ( F_9 ( V_12 , struct V_31 , V_32 ) ,
0 , V_44 , V_45 ) ;
V_43:
F_16 ( & V_12 -> V_42 ) ;
V_12 -> V_40 = F_15 () ;
...
return F_19 ( V_49 , V_47 , V_44 , V_54 ) ;
}
...
static int F_24 ( struct V_11 * V_12 , int V_47 , T_4 V_48 )
{
int V_62 = 0 ;
if ( V_12 -> V_57 -> V_63 != NULL ) {
...
static int F_25 ( struct V_67 * V_68 , void * V_50 )
{
int V_17 , V_19 , V_21 ;
int V_69 , V_70 ;
...
static T_6 F_27 ( struct V_76 * V_77 , struct V_78 * V_79 ,
char * V_80 )
{
...
int V_83 ;
F_31 ( & V_12 -> V_82 ) ;
V_83 = F_32 ( & V_12 -> V_81 , & V_84 , & V_49 -> V_85 ,
L_10 ) ;
return V_83 ;
}
...
V_89 [ 0 ] . V_99 = V_90 ;
F_41 ( V_100 , V_12 , & V_101 ) ;
V_12 -> V_23 = F_42 ( V_102 -
V_103 , 0 ) ;
if ( ! V_12 -> V_23 ) {
V_91 = - V_94 ;
goto V_97;
...
V_104 | V_105 ,
L_13 , L_14 ) ;
F_43 ( V_12 -> V_23 , V_106 ,
V_104 | V_105 ,
L_15 , L_14 ) ;
F_43 ( V_12 -> V_23 , V_107 ,
V_104 | V_105 ,
L_16 , L_14 ) ;
F_43 ( V_12 -> V_23 , V_26 ,
V_104 | V_105 ,
...
int F_52 ( struct V_11 * V_12 , struct V_31 * V_49 ,
int V_108 , T_7 V_109 )
{
int V_91 ;
F_53 ( & V_12 -> V_42 ) ;
...
F_46 ( V_12 ) ;
F_49 ( V_12 ) ;
F_56 ( V_12 , 0x5a , sizeof( * V_12 ) ) ;
}
void F_57 ( struct V_11 * V_12 , struct V_113 * V_114 )
{
if ( V_114 -> V_115 -> V_116 == V_117 )
return;
F_58 ( & V_12 -> V_18 ) ;
F_58 ( & V_12 -> V_20 ) ;
F_59 ( V_12 -> V_23 , V_106 ) ;
}
void F_60 ( struct V_11 * V_12 , struct V_113 * V_114 )
{
if ( V_114 -> V_115 -> V_116 == V_117 )
return;
F_10 ( F_6 ( & V_12 -> V_18 ) > 0 ) ;
F_61 ( & V_12 -> V_18 ) ;
F_58 ( & V_12 -> V_22 ) ;
F_59 ( V_12 -> V_23 , V_107 ) ;
}
...
V_124 += F_24 ( & V_49 -> V_32 , V_62 , V_48 ) ;
F_80 ( V_49 ) ;
}
F_74 ( V_121 ) ;
return V_124 ;
