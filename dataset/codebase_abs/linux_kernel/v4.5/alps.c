...
if ( F_52 ( V_99 ) ) {
V_93 -> V_55 = 5 ;
} else if ( V_93 -> V_87 [ 3 ] . V_20 == V_125 &&
V_93 -> V_87 [ 3 ] . V_21 == V_126 ) {
V_93 -> V_87 [ 3 ] . V_20 = 0 ;
V_93 -> V_87 [ 3 ] . V_21 = 0 ;
V_93 -> V_55 = 3 ;
} else {
...
static void F_56 ( struct V_131 * V_132 )
{
struct V_1 * V_2 =
F_57 ( V_132 , struct V_1 , V_133 . V_132 ) ;
...
snprintf ( V_2 -> V_138 , sizeof( V_2 -> V_138 ) , L_4 ,
V_17 -> V_139 . V_140 -> V_141 ,
( V_2 -> V_8 ? L_5 : L_6 ) ) ;
V_134 -> V_141 = V_2 -> V_138 ;
V_134 -> V_142 = L_7 ;
V_134 -> V_143 . V_144 = V_145 ;
V_134 -> V_143 . V_146 = 0x0002 ;
V_134 -> V_143 . V_147 = V_148 ;
V_134 -> V_143 . V_149 = 0x0000 ;
V_134 -> V_12 . V_150 = & V_17 -> V_139 . V_140 -> V_12 ;
F_61 ( V_134 , V_151 , V_33 ) ;
F_61 ( V_134 , V_151 , V_34 ) ;
F_61 ( V_134 , V_152 , V_13 ) ;
F_61 ( V_134 , V_152 , V_15 ) ;
F_61 ( V_134 , V_152 , V_16 ) ;
F_62 ( V_153 , V_134 -> V_154 ) ;
error = F_63 ( V_134 ) ;
if ( error ) {
F_60 ( V_17 ,
L_8 ,
...
static int F_80 ( struct V_17 * V_17 , int V_169 )
{
struct V_139 * V_139 = & V_17 -> V_139 ;
struct V_1 * V_2 = V_17 -> V_18 ;
int V_170 ;
unsigned char * V_171 ;
...
if ( F_82 ( V_139 , V_171 , V_170 ) )
return - 1 ;
return 0 ;
}
static int F_83 ( struct V_17 * V_17 , int V_174 )
{
struct V_139 * V_139 = & V_17 -> V_139 ;
struct V_1 * V_2 = V_17 -> V_18 ;
int V_57 , V_169 ;
if ( F_82 ( V_139 , NULL , V_2 -> V_175 ) )
return - 1 ;
for ( V_57 = 12 ; V_57 >= 0 ; V_57 -= 4 ) {
V_169 = ( V_174 >> V_57 ) & 0xf ;
if ( F_80 ( V_17 , V_169 ) )
return - 1 ;
}
return 0 ;
}
static int F_84 ( struct V_17 * V_17 , int V_174 )
{
struct V_139 * V_139 = & V_17 -> V_139 ;
unsigned char V_171 [ 4 ] ;
if ( F_82 ( V_139 , V_171 , V_176 ) )
return - 1 ;
if ( V_174 != ( ( V_171 [ 0 ] << 8 ) | V_171 [ 1 ] ) )
return - 1 ;
return V_171 [ 2 ] ;
}
static int F_85 ( struct V_17 * V_17 , int V_174 )
{
if ( F_83 ( V_17 , V_174 ) )
return - 1 ;
return F_84 ( V_17 , V_174 ) ;
}
static int F_86 ( struct V_17 * V_17 , T_3 V_177 )
{
if ( F_80 ( V_17 , ( V_177 >> 4 ) & 0xf ) )
return - 1 ;
if ( F_80 ( V_17 , V_177 & 0xf ) )
return - 1 ;
return 0 ;
}
...
if ( F_83 ( V_17 , V_174 ) )
return - 1 ;
return F_86 ( V_17 , V_177 ) ;
}
static int F_88 ( struct V_17 * V_17 , int V_178 ,
int V_179 , unsigned char * V_171 )
{
struct V_139 * V_139 = & V_17 -> V_139 ;
V_171 [ 0 ] = 0 ;
if ( V_178 && F_82 ( V_139 , V_171 , V_178 ) )
return - V_180 ;
if ( F_82 ( V_139 , NULL , V_179 ) ||
F_82 ( V_139 , NULL , V_179 ) ||
F_82 ( V_139 , NULL , V_179 ) )
return - V_180 ;
...
static bool F_89 ( unsigned char V_143 [] )
{
if ( V_143 [ 0 ] == 0x73 )
return true ;
if ( V_143 [ 0 ] == 0x88 &&
...
{
struct V_139 * V_139 = & V_17 -> V_139 ;
if ( F_82 ( V_139 , NULL , V_182 ) )
return - 1 ;
return 0 ;
}
static int F_92 ( struct V_17 * V_17 , bool V_183 )
{
struct V_139 * V_139 = & V_17 -> V_139 ;
int V_184 = V_183 ? V_185 : V_186 ;
if ( F_82 ( V_139 , NULL , V_184 ) ||
F_82 ( V_139 , NULL , V_184 ) ||
F_82 ( V_139 , NULL , V_184 ) ||
F_82 ( V_139 , NULL , V_187 ) )
return - 1 ;
F_93 ( V_139 , 3 , 100 ) ;
return 0 ;
}
...
{
struct V_139 * V_139 = & V_17 -> V_139 ;
if ( F_82 ( V_139 , NULL , V_187 ) ||
F_82 ( V_139 , NULL , V_187 ) ||
F_82 ( V_139 , NULL , V_187 ) ||
F_82 ( V_139 , NULL , V_187 ) ||
F_82 ( V_139 , NULL , V_188 ) )
return - 1 ;
return F_82 ( & V_17 -> V_139 , NULL , V_189 ) ;
}
static int F_95 ( struct V_17 * V_17 , T_4 V_190 )
{
int V_57 , V_169 ;
for ( V_57 = 0 ; V_57 <= 8 ; V_57 += 4 ) {
V_169 = ( V_190 >> V_57 ) & 0xf ;
if ( F_80 ( V_17 , V_169 ) )
return - 1 ;
}
return 0 ;
...
static int F_97 ( struct V_17 * V_17 , bool V_183 )
{
struct V_139 * V_139 = & V_17 -> V_139 ;
if ( V_183 ) {
if ( F_82 ( V_139 , NULL , V_181 ) ||
F_82 ( V_139 , NULL , V_176 ) ||
F_82 ( V_139 , NULL , V_187 ) ||
F_82 ( V_139 , NULL , V_187 ) ||
F_82 ( V_139 , NULL , V_185 ) ||
F_82 ( V_139 , NULL , V_186 ) ||
F_82 ( V_139 , NULL , V_185 ) ||
F_82 ( V_139 , NULL , V_176 ) )
return - 1 ;
} else {
...
if ( F_97 ( V_17 , true ) )
return - 1 ;
V_192 = F_96 ( V_17 , 0x000 , V_191 ) ;
if ( F_97 ( V_17 , false ) )
V_192 = - 1 ;
return V_192 ;
}
static int F_99 ( struct V_17 * V_17 , char * V_171 )
{
if ( F_88 ( V_17 , 0 , V_187 , V_171 ) )
return - 1 ;
return 0 ;
}
static int F_100 ( struct V_17 * V_17 , int V_183 )
{
struct V_139 * V_139 = & V_17 -> V_139 ;
...
if ( V_2 -> V_29 & V_198 )
F_92 ( V_17 , true ) ;
V_197 = F_82 ( & V_17 -> V_139 , V_196 ,
V_199 | ( V_17 -> V_162 << 8 ) ) < 0 ;
if ( V_2 -> V_29 & V_198 )
F_92 ( V_17 , false ) ;
if ( V_197 || ( V_196 [ 0 ] & V_2 -> V_4 ) != V_2 -> V_5 )
return - 1 ;
if ( ( V_17 -> V_200 & 0xc8 ) == 0x08 ) {
if ( F_82 ( & V_17 -> V_139 , V_196 , V_199 | ( 3 << 8 ) ) )
return - 1 ;
}
...
if ( F_92 ( V_17 , true ) )
return - 1 ;
if ( F_82 ( & V_17 -> V_139 , NULL , V_186 ) ||
F_82 ( & V_17 -> V_139 , NULL , V_186 ) ||
F_82 ( & V_17 -> V_139 , NULL , V_186 ) ||
F_82 ( & V_17 -> V_139 , & V_171 [ 0 ] , V_193 ) ||
F_82 ( & V_17 -> V_139 , & V_171 [ 1 ] , V_193 ) )
return - 1 ;
if ( F_92 ( V_17 , false ) )
return - 1 ;
if ( F_98 ( V_17 ) ) {
...
int V_201 , bool V_183 )
{
int V_191 , V_192 = - 1 ;
if ( F_90 ( V_17 ) )
return - 1 ;
V_191 = F_85 ( V_17 , V_201 + 0x0008 ) ;
if ( V_191 == - 1 )
goto error;
if ( V_183 )
V_191 |= 0x01 ;
...
if ( F_90 ( V_17 ) )
goto error;
V_191 = F_85 ( V_17 , V_201 + 0x08 ) ;
if ( V_191 == - 1 )
goto error;
V_192 = V_191 & 0x80 ? 0 : - V_202 ;
error:
F_91 ( V_17 ) ;
return V_192 ;
}
...
return - V_180 ;
if ( F_88 ( V_17 , 0 , V_185 , V_171 ) ) {
F_21 ( V_17 , L_19 ) ;
V_192 = - V_202 ;
} else {
F_22 ( V_17 , L_20 , V_171 ) ;
if ( F_82 ( V_139 , NULL , V_186 ) ||
F_82 ( V_139 , NULL , V_186 ) ||
F_82 ( V_139 , NULL , V_186 ) ||
F_80 ( V_17 , 0x9 ) ||
F_80 ( V_17 , 0x4 ) ) {
...
V_191 = F_85 ( V_17 , 0x0006 ) ;
if ( V_191 == - 1 )
goto error;
if ( F_86 ( V_17 , V_191 | 0x01 ) )
goto error;
V_191 = F_85 ( V_17 , 0x0007 ) ;
if ( V_191 == - 1 )
goto error;
if ( F_86 ( V_17 , V_191 | 0x01 ) )
goto error;
...
V_210 = V_206 * ( V_208 - 1 ) ;
V_211 = V_207 * ( V_209 - 1 ) ;
V_2 -> V_212 = V_2 -> V_75 * 10 / V_210 ;
V_2 -> V_213 = V_2 -> V_77 * 10 / V_211 ;
F_22 ( V_17 ,
L_24 ,
...
goto error;
V_191 = F_85 ( V_17 , 0xc2c6 ) ;
if ( V_191 == - 1 )
goto error;
if ( F_86 ( V_17 , V_191 & 0xfd ) )
goto error;
if ( F_87 ( V_17 , 0xc2c9 , 0x64 ) )
goto error;
V_191 = F_85 ( V_17 , 0xc2c4 ) ;
if ( V_191 == - 1 )
goto error;
if ( F_86 ( V_17 , V_191 | 0x02 ) )
goto error;
F_91 ( V_17 ) ;
return F_82 ( V_139 , NULL , V_188 ) ;
error:
F_91 ( V_17 ) ;
return V_192 ;
}
...
V_171 [ 1 ] = 0x64 ;
V_171 [ 2 ] = 0x50 ;
if ( F_82 ( V_139 , & V_171 [ 0 ] , V_193 ) ||
F_82 ( V_139 , & V_171 [ 1 ] , V_193 ) ||
F_82 ( V_139 , & V_171 [ 2 ] , V_193 ) ||
F_82 ( V_139 , V_171 , V_215 ) )
return - 1 ;
V_171 [ 0 ] = 0x64 ;
if ( F_82 ( V_139 , V_171 , V_193 ) ||
F_82 ( V_139 , NULL , V_188 ) ) {
...
case 0 :
if ( F_82 ( V_139 , NULL , V_182 ) ||
F_82 ( V_139 , NULL , V_182 ) ||
F_82 ( V_139 , V_217 , V_176 ) )
return - 1 ;
break;
case 1 :
if ( F_82 ( V_139 , NULL , V_189 ) ||
F_82 ( V_139 , NULL , V_189 ) ||
F_82 ( V_139 , V_217 , V_176 ) )
return - 1 ;
break;
}
...
V_2 -> V_75 = ( V_218 - 1 ) * V_222 ;
V_2 -> V_77 = ( V_219 - 1 ) * V_222 ;
...
F_82 ( V_139 , NULL , V_189 ) ||
F_82 ( V_139 , NULL , V_189 ) ||
F_82 ( V_139 , & V_171 [ 0 ] , V_193 ) ||
F_82 ( V_139 , & V_171 [ 0 ] , V_193 ) )
return - 1 ;
if ( F_82 ( V_139 , V_171 , V_176 ) )
return - 1 ;
V_218 = V_225 + ( V_171 [ 2 ] & 0x0F ) ;
V_219 = V_226 + ( ( V_171 [ 2 ] >> 4 ) & 0x0F ) ;
V_2 -> V_76 = V_218 ;
V_2 -> V_78 = V_219 ;
V_2 -> V_75 = ( V_218 - 1 ) * V_227 ;
V_2 -> V_77 = ( V_219 - 1 ) * V_227 ;
if ( F_91 ( V_17 ) )
return - 1 ;
return 0 ;
}
...
{
V_17 -> V_18 = V_2 ;
F_122 ( & V_2 -> V_158 , F_76 , ( unsigned long ) V_17 ) ;
V_2 -> V_27 = V_229 -> V_149 ;
V_2 -> V_5 = V_229 -> V_5 ;
V_2 -> V_4 = V_229 -> V_4 ;
V_2 -> V_29 = V_229 -> V_29 ;
V_2 -> V_75 = 2000 ;
...
static const struct V_228 * F_124 ( unsigned char * V_243 ,
unsigned char * V_244 )
{
const struct V_245 * V_246 ;
int V_57 ;
for ( V_57 = 0 ; V_57 < F_125 ( V_247 ) ; V_57 ++ ) {
V_246 = & V_247 [ V_57 ] ;
if ( ! memcmp ( V_243 , V_246 -> V_248 , sizeof( V_246 -> V_248 ) ) &&
( ! V_246 -> V_249 ||
V_246 -> V_249 == V_244 [ 2 ] ) ) {
return & V_246 -> V_250 ;
}
...
{
const struct V_228 * V_229 ;
unsigned char V_251 [ 4 ] , V_243 [ 4 ] , V_244 [ 4 ] ;
int error ;
if ( F_88 ( V_17 , V_194 ,
V_186 , V_251 ) )
return - V_180 ;
if ( ( V_251 [ 0 ] & 0xf8 ) != 0 || V_251 [ 1 ] != 0 || ( V_251 [ 2 ] != 10 && V_251 [ 2 ] != 100 ) )
return - V_252 ;
if ( F_88 ( V_17 , V_194 ,
V_185 , V_243 ) ||
F_88 ( V_17 , V_194 ,
...
F_91 ( V_17 ) )
return - V_180 ;
V_229 = F_124 ( V_243 , V_244 ) ;
if ( ! V_229 ) {
if ( V_243 [ 0 ] == 0x73 && V_243 [ 1 ] == 0x03 && V_243 [ 2 ] == 0x50 &&
V_244 [ 0 ] == 0x73 && ( V_244 [ 1 ] == 0x01 || V_244 [ 1 ] == 0x02 ) ) {
V_229 = & V_253 ;
} else if ( V_244 [ 0 ] == 0x88 &&
( ( V_244 [ 1 ] & 0xf0 ) == 0xb0 || ( V_244 [ 1 ] & 0xf0 ) == 0xc0 ) ) {
V_229 = & V_254 ;
} else if ( V_244 [ 0 ] == 0x88 && V_244 [ 1 ] == 0x08 ) {
V_229 = & V_255 ;
} else if ( V_244 [ 0 ] == 0x88 && V_244 [ 1 ] == 0x07 &&
V_244 [ 2 ] >= 0x90 && V_244 [ 2 ] <= 0x9d ) {
V_229 = & V_256 ;
} else if ( V_243 [ 0 ] == 0x73 && V_243 [ 1 ] == 0x03 &&
V_243 [ 2 ] == 0x14 && V_244 [ 1 ] == 0x02 ) {
V_229 = & V_257 ;
} else {
F_22 ( V_17 ,
L_25 , V_243 , V_244 ) ;
...
F_135 ( V_7 , V_90 , V_2 -> V_212 ) ;
F_135 ( V_7 , V_91 , V_2 -> V_213 ) ;
F_136 ( V_258 , V_7 -> V_259 ) ;
F_136 ( V_260 , V_7 -> V_259 ) ;
}
...
{
F_134 ( V_2 , V_7 ) ;
F_136 ( V_264 , V_7 -> V_259 ) ;
F_137 ( V_7 , V_94 ,
V_261 | V_262 |
V_265 ) ;
F_136 ( V_264 , V_7 -> V_259 ) ;
}
static void V_242 ( struct V_1 * V_2 ,
struct V_6 * V_7 )
{
F_134 ( V_2 , V_7 ) ;
F_133 ( V_7 , V_39 , 0 , 127 , 0 , 0 ) ;
...
if ( error )
goto V_266;
F_139 ( V_151 , V_7 -> V_267 ) ;
F_139 ( V_33 , V_7 -> V_268 ) ;
F_139 ( V_34 , V_7 -> V_268 ) ;
V_7 -> V_267 [ F_140 ( V_152 ) ] |= F_141 ( V_152 ) ;
V_7 -> V_259 [ F_140 ( V_41 ) ] |= F_141 ( V_41 ) ;
V_7 -> V_259 [ F_140 ( V_40 ) ] |= F_141 ( V_40 ) ;
V_7 -> V_259 [ F_140 ( V_13 ) ] |=
F_141 ( V_13 ) | F_141 ( V_15 ) ;
V_7 -> V_267 [ F_140 ( V_269 ) ] |= F_141 ( V_269 ) ;
V_2 -> V_231 ( V_2 , V_7 ) ;
if ( V_2 -> V_29 & V_42 ) {
V_7 -> V_267 [ F_140 ( V_151 ) ] |= F_141 ( V_151 ) ;
V_7 -> V_268 [ F_140 ( V_43 ) ] |= F_141 ( V_43 ) ;
}
if ( V_2 -> V_29 & ( V_30 | V_31 ) ) {
V_7 -> V_259 [ F_140 ( V_44 ) ] |= F_141 ( V_44 ) ;
V_7 -> V_259 [ F_140 ( V_45 ) ] |= F_141 ( V_45 ) ;
}
if ( V_2 -> V_29 & V_46 ) {
V_7 -> V_259 [ F_140 ( V_47 ) ] |= F_141 ( V_47 ) ;
V_7 -> V_259 [ F_140 ( V_48 ) ] |= F_141 ( V_48 ) ;
V_7 -> V_259 [ F_140 ( V_49 ) ] |= F_141 ( V_49 ) ;
V_7 -> V_259 [ F_140 ( V_50 ) ] |= F_141 ( V_50 ) ;
} else if ( V_2 -> V_29 & V_120 ) {
F_136 ( V_270 , V_7 -> V_154 ) ;
F_142 ( V_15 , V_7 -> V_259 ) ;
} else {
V_7 -> V_259 [ F_140 ( V_16 ) ] |= F_141 ( V_16 ) ;
}
if ( V_2 -> V_29 & V_32 ) {
struct V_6 * V_8 ;
V_8 = F_59 () ;
...
snprintf ( V_2 -> V_271 , sizeof( V_2 -> V_271 ) , L_27 ,
V_17 -> V_139 . V_140 -> V_141 ) ;
V_8 -> V_141 = V_2 -> V_271 ;
V_8 -> V_142 = L_28 ;
V_8 -> V_143 . V_144 = V_145 ;
V_8 -> V_143 . V_146 = 0x0002 ;
V_8 -> V_143 . V_147 = V_272 ;
V_8 -> V_143 . V_149 = V_2 -> V_27 ;
V_8 -> V_12 . V_150 = & V_17 -> V_139 . V_140 -> V_12 ;
F_61 ( V_8 , V_151 , V_33 ) ;
F_61 ( V_8 , V_151 , V_34 ) ;
F_61 ( V_8 , V_152 , V_13 ) ;
F_61 ( V_8 , V_152 , V_15 ) ;
F_61 ( V_8 , V_152 , V_16 ) ;
F_62 ( V_153 , V_8 -> V_154 ) ;
F_62 ( V_273 , V_8 -> V_154 ) ;
error = F_63 ( V_8 ) ;
if ( error ) {
F_60 ( V_17 ,
L_29 ,
...
V_17 -> V_276 = F_129 ;
V_17 -> V_277 = F_127 ;
V_17 -> V_162 = V_2 -> V_27 == V_81 ? 8 : 6 ;
V_17 -> V_278 = 0 ;
V_17 -> V_279 = V_17 -> V_162 * 2 ;
return 0 ;
V_266:
F_128 ( V_17 ) ;
F_132 ( V_17 -> V_18 ) ;
...
int F_144 ( struct V_17 * V_17 , bool V_280 )
{
struct V_1 * V_2 ;
int error ;
...
return error ;
F_128 ( V_17 ) ;
V_2 = F_145 ( sizeof( struct V_1 ) , V_281 ) ;
if ( ! V_2 )
return - V_137 ;
