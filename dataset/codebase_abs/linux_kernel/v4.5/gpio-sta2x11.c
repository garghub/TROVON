...
struct V_2 * V_3 ;
struct V_87 * V_88 ;
V_84 = * (struct V_83 * * ) F_33 ( & V_20 -> V_20 ) ;
V_86 = F_33 ( & V_84 -> V_20 ) ;
if ( V_86 == NULL )
F_34 ( & V_20 -> V_20 , L_4 ) ;
F_22 ( L_5 , V_86 ) ;
V_88 = F_35 ( V_20 , V_89 , 0 ) ;
V_3 = F_36 ( & V_20 -> V_20 , sizeof( * V_3 ) , V_90 ) ;
if ( ! V_3 )
return - V_91 ;
V_3 -> V_20 = & V_20 -> V_20 ;
V_3 -> V_71 = F_37 ( & V_20 -> V_20 , V_88 ) ;
if ( F_38 ( V_3 -> V_71 ) )
return F_39 ( V_3 -> V_71 ) ;
for ( V_62 = 0 ; V_62 < V_65 ; V_62 ++ ) {
