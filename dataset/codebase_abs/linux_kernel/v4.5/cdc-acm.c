...
if ( V_22 & V_268 )
V_266 -> V_37 -> V_264 |= V_269 ;
V_266 -> V_98 = V_1 ;
}
F_137 ( V_48 , V_1 ) ;
V_26 = F_138 ( & V_48 -> V_16 , & V_270 ) ;
if ( V_26 < 0 )
goto V_267;
if ( V_205 ) {
V_1 -> V_50 = F_139 ( V_205 -> V_271 - 4 , V_9 ) ;
if ( ! V_1 -> V_50 )
goto V_272;
V_1 -> V_51 = V_205 -> V_271 - 4 ;
memcpy ( V_1 -> V_50 , ( T_4 * ) & V_205 -> V_273 ,
V_205 -> V_271 - 4 ) ;
V_1 -> V_52 = V_205 -> V_274 ;
V_26 = F_138 ( & V_48 -> V_16 , & V_275 ) ;
if ( V_26 < 0 ) {
F_67 ( V_1 -> V_50 ) ;
V_1 -> V_50 = NULL ;
V_1 -> V_51 = 0 ;
...
V_1 -> line . V_186 = 8 ;
F_105 ( V_1 , & V_1 -> line ) ;
F_143 ( & V_277 , V_211 , V_1 ) ;
F_137 ( V_211 , V_1 ) ;
F_144 ( V_210 ) ;
V_224 = F_145 ( & V_1 -> V_7 , V_278 , V_2 ,
& V_210 -> V_16 ) ;
if ( F_146 ( V_224 ) ) {
V_155 = F_147 ( V_224 ) ;
goto V_279;
...
F_109 ( V_1 ) ;
if ( ! V_1 -> V_223 )
F_157 ( & V_277 , V_48 == V_1 -> V_15 ?
V_1 -> V_43 : V_1 -> V_15 ) ;
F_55 ( & V_1 -> V_7 ) ;
}
static int F_158 ( struct V_47 * V_48 , T_5 V_281 )
{
struct V_1 * V_1 = F_28 ( V_48 ) ;
int V_282 ;
F_61 ( & V_1 -> V_34 ) ;
...
V_278 -> type = V_290 ,
V_278 -> V_291 = V_292 ,
V_278 -> V_33 = V_293 | V_294 ;
V_278 -> V_295 = V_296 ;
V_278 -> V_295 . V_178 = V_297 | V_189 | V_298 |
V_299 | V_190 ;
F_165 ( V_278 , & V_300 ) ;
V_14 = F_166 ( V_278 ) ;
if ( V_14 ) {
