...
if ( ! V_36 -> V_77 . V_53 )
return - V_60 ;
return V_36 -> V_77 . V_53 ( V_16 , V_3 , V_13 , V_17 , V_8 , V_38 ) ;
default:
break;
}
return - V_42 ;
...
static int
F_13 ( const struct V_78 * V_79 ,
void * V_13 , T_2 V_17 , struct V_27 * * V_80 )
{
const struct V_81 * V_82 = V_79 -> V_83 ;
struct V_32 * V_33 = V_32 ( V_79 -> V_84 ) ;
return V_82 -> V_85 ( V_82 -> V_36 , V_82 -> V_28 , V_33 , V_82 -> V_86 ,
V_79 , V_13 , V_17 , V_80 ) ;
}
static int
F_14 ( const struct V_78 * V_79 ,
void * V_13 , T_2 V_17 , struct V_27 * * V_80 )
{
const struct V_87 * V_82 = V_79 -> V_83 ;
struct V_32 * V_33 = V_32 ( V_79 -> V_84 ) ;
return V_82 -> V_85 ( V_82 -> V_36 , V_82 -> V_28 , V_33 , V_82 -> V_86 ,
V_79 , V_13 , V_17 , V_80 ) ;
}
static int
F_15 ( struct V_27 * V_16 , int V_88 ,
struct V_78 * V_82 )
{
struct V_32 * V_33 = V_32 ( V_16 ) ;
if ( V_88 < F_16 ( V_33 -> V_36 -> V_89 ) ) {
V_82 -> V_4 = V_33 -> V_36 -> V_89 [ V_88 ] -> V_4 ;
V_82 -> V_83 = V_33 -> V_36 -> V_89 [ V_88 ] ;
V_82 -> V_85 = F_13 ;
return 0 ;
}
V_88 -= F_16 ( V_33 -> V_36 -> V_89 ) ;
if ( V_88 < F_16 ( V_33 -> V_36 -> V_90 ) ) {
V_82 -> V_4 = V_33 -> V_36 -> V_90 [ V_88 ] -> V_4 ;
V_82 -> V_83 = V_33 -> V_36 -> V_90 [ V_88 ] ;
V_82 -> V_85 = F_14 ;
return 0 ;
}
return - V_42 ;
...
static int
F_17 ( struct V_27 * V_16 , bool V_91 )
{
struct V_32 * V_33 = V_32 ( V_16 ) ;
V_33 -> V_36 -> V_92 ( V_33 ) ;
return 0 ;
...
int
F_22 ( const struct V_96 * V_36 ,
struct V_97 * V_4 , const struct V_78 * V_79 ,
void * V_13 , T_2 V_17 , struct V_27 * * V_80 )
{
...
struct V_1 * V_2 = V_3 -> V_4 . V_5 . V_6 . V_2 ;
int V_14 ;
if ( ! ( V_33 = F_23 ( sizeof( * V_33 ) , V_98 ) ) )
return - V_99 ;
* V_80 = & V_33 -> V_16 ;
F_24 ( & V_100 , V_79 , & V_33 -> V_16 ) ;
V_33 -> V_36 = V_36 ;
V_33 -> V_3 = V_3 ;
V_14 = F_25 ( V_3 -> V_4 . V_5 . V_6 . V_2 , 0x10000 , 0x10000 ,
false , NULL , & V_33 -> V_95 ) ;
if ( V_14 )
return V_14 ;
return F_26 ( V_2 , 0x1000 , 0 , V_33 -> V_95 , & V_33 -> V_94 ) ;
}
void
...
T_2 V_101 ;
int V_102 ;
V_101 = F_2 ( V_2 , 0x614004 ) ;
F_28 ( V_2 , 0x610184 , V_101 ) ;
for ( V_102 = 0 ; V_102 < V_3 -> V_4 . V_8 . V_46 ; V_102 ++ ) {
V_101 = F_2 ( V_2 , 0x616100 + ( V_102 * 0x800 ) ) ;
F_28 ( V_2 , 0x610190 + ( V_102 * 0x10 ) , V_101 ) ;
V_101 = F_2 ( V_2 , 0x616104 + ( V_102 * 0x800 ) ) ;
F_28 ( V_2 , 0x610194 + ( V_102 * 0x10 ) , V_101 ) ;
V_101 = F_2 ( V_2 , 0x616108 + ( V_102 * 0x800 ) ) ;
F_28 ( V_2 , 0x610198 + ( V_102 * 0x10 ) , V_101 ) ;
V_101 = F_2 ( V_2 , 0x61610c + ( V_102 * 0x800 ) ) ;
F_28 ( V_2 , 0x61019c + ( V_102 * 0x10 ) , V_101 ) ;
}
for ( V_102 = 0 ; V_102 < V_3 -> V_36 -> V_52 . V_46 ; V_102 ++ ) {
V_101 = F_2 ( V_2 , 0x61a000 + ( V_102 * 0x800 ) ) ;
F_28 ( V_2 , 0x6101d0 + ( V_102 * 0x04 ) , V_101 ) ;
}
for ( V_102 = 0 ; V_102 < V_3 -> V_36 -> V_57 . V_46 ; V_102 ++ ) {
V_101 = F_2 ( V_2 , 0x61c000 + ( V_102 * 0x800 ) ) ;
F_28 ( V_2 , 0x6101e0 + ( V_102 * 0x04 ) , V_101 ) ;
}
for ( V_102 = 0 ; V_102 < V_3 -> V_36 -> V_77 . V_46 ; V_102 ++ ) {
V_101 = F_2 ( V_2 , 0x61e000 + ( V_102 * 0x800 ) ) ;
F_28 ( V_2 , 0x6101f0 + ( V_102 * 0x04 ) , V_101 ) ;
}
...
F_28 ( V_2 , 0x610010 , ( V_33 -> V_95 -> V_104 >> 8 ) | 9 ) ;
F_28 ( V_2 , 0x61002c , 0x00000370 ) ;
F_28 ( V_2 , 0x610028 , 0x00000000 ) ;
return 0 ;
}
static int
F_32 ( struct V_97 * V_3 , const struct V_78 * V_79 ,
void * V_13 , T_2 V_17 , struct V_27 * * V_80 )
{
return F_22 ( & V_32 , V_3 , V_79 ,
V_13 , V_17 , V_80 ) ;
}
