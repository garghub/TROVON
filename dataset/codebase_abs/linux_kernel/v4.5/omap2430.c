...
static void F_28 ( enum V_43 V_44 )
{
...
F_25 ( V_2 -> V_11 , V_93 ) ,
F_25 ( V_2 -> V_11 , V_99 ) ) ;
F_53 ( & V_32 , F_1 , ( unsigned long ) V_2 ) ;
if ( V_46 -> V_44 != V_100 )
F_32 ( V_46 ) ;
F_54 ( V_2 -> V_88 ) ;
F_55 ( V_2 -> V_88 ) ;
...
V_46 = F_64 ( & V_102 -> V_51 , sizeof( * V_46 ) , V_112 ) ;
if ( ! V_46 )
goto V_113;
V_2 = F_65 ( L_22 , V_114 ) ;
if ( ! V_2 ) {
...
V_46 -> V_2 = V_2 ;
V_46 -> V_44 = V_100 ;
V_46 -> V_61 = F_66 ( - V_118 ) ;
if ( V_106 ) {
struct V_105 * V_119 ;
struct V_101 * V_120 ;
V_53 = F_64 ( & V_102 -> V_51 , sizeof( * V_53 ) , V_112 ) ;
if ( ! V_53 )
goto V_121;
V_55 = F_64 ( & V_102 -> V_51 , sizeof( * V_55 ) , V_112 ) ;
if ( ! V_55 )
goto V_121;
V_108 = F_64 ( & V_102 -> V_51 , sizeof( * V_108 ) , V_112 ) ;
if ( ! V_108 )
goto V_121;
F_67 ( V_106 , L_24 , ( T_2 * ) & V_53 -> V_122 ) ;
F_67 ( V_106 , L_25 ,
( T_2 * ) & V_55 -> V_69 ) ;
F_67 ( V_106 , L_26 , ( T_2 * ) & V_108 -> V_123 ) ;
F_67 ( V_106 , L_27 , ( T_2 * ) & V_108 -> V_124 ) ;
F_67 ( V_106 , L_28 , ( T_2 * ) & V_53 -> V_4 ) ;
V_109 = F_67 ( V_106 , L_29 , & V_111 ) ;
if ( ! V_109 && V_111 )
V_108 -> V_125 = true ;
V_53 -> V_56 = V_55 ;
V_53 -> V_108 = V_108 ;
V_119 = F_68 ( V_106 , L_30 , 0 ) ;
if ( V_119 ) {
V_120 = F_69 ( V_119 ) ;
if ( ! V_120 ) {
...
V_109 = F_73 ( V_2 , V_104 ,
F_72 ( V_104 ) ) ;
if ( V_109 ) {
F_21 ( & V_102 -> V_51 , L_32 ) ;
goto V_121;
}
V_109 = F_74 ( V_2 , V_53 , sizeof( * V_53 ) ) ;
if ( V_109 ) {
...
static int F_82 ( struct V_50 * V_51 )
{
