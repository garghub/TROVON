...
{
int V_47 , V_521 ;
for ( V_47 = 0 , V_521 = 0 ; V_47 < sizeof( struct V_92 ) ;
V_47 += sizeof( T_1 ) , V_521 ++ ) {
( ( T_1 * ) V_97 ) [ V_521 ] = F_91 ( ( ( T_1 * ) V_92 ) [ V_521 ] ) ;
}
}
static void
...
& V_32 -> V_92 -> V_525 ) ;
V_523 = & V_92 -> V_526 [ 0 ] ;
memcpy ( V_523 , V_13 -> V_14 , V_13 -> V_527 ) ;
if ( V_13 -> V_527 < V_528 ) {
V_523 += V_13 -> V_527 ;
memset ( V_523 , 0 , ( V_528 - V_13 -> V_527 ) ) ;
}
V_92 -> V_529 = V_530 ;
V_524 = ( V_8 -> V_115 == V_455 ) ;
V_522 -> V_84 . V_111 . V_216 . V_531 = 0 ;
if ( F_84 ( V_13 ) ) {
if ( V_207 == V_296 ) {
V_201 -> V_532 = V_533 ;
V_201 -> V_534 = V_535 ;
...
V_340 = F_92 ( V_13 ) ;
if ( V_340 < V_5 -> V_536 )
V_522 -> V_84 . V_111 . V_216 . V_531 = V_340 ;
else
V_522 -> V_84 . V_111 . V_216 . V_531 =
V_5 -> V_536 ;
}
V_92 -> V_539 = V_540 ;
V_8 -> V_541 ++ ;
...
V_522 -> V_84 . V_456 = V_40 -> V_547 ;
if ( V_524 )
V_522 -> V_84 . V_456 =
V_8 -> V_133 . V_548 [ V_40 -> V_547 ] ;
if ( V_40 -> V_549 & V_550 )
V_522 -> V_84 . V_551 = 1 ;
else
V_522 -> V_84 . V_551 = 0 ;
V_522 -> V_84 . V_126 = ( V_40 -> V_549 & 0x0f ) ;
V_522 -> V_130 = V_32 ;
V_522 -> V_552 = F_145 ;
V_522 -> V_84 . V_553 = V_32 -> V_554 ;
V_522 -> V_5 = V_5 ;
}
static int
...
F_151 ( V_409 , & V_92 -> V_525 ) ;
V_92 -> V_443 = V_555 ;
if ( V_5 -> V_8 -> V_115 == 3 &&
! ( V_5 -> V_8 -> V_116 & V_117 ) )
F_149 ( V_556 -> V_119 . V_120 . V_121 , V_92 ) ;
V_556 -> V_532 = V_545 ;
V_556 -> V_456 = V_143 -> V_547 ;
if ( V_5 -> V_8 -> V_115 == V_455 ) {
V_556 -> V_456 =
V_5 -> V_8 -> V_133 . V_548 [ V_143 -> V_547 ] ;
}
V_556 -> V_551 = ( V_143 -> V_549 & V_550 ) ? 1 : 0 ;
V_556 -> V_126 = ( V_143 -> V_549 & 0x0f ) ;
V_556 -> V_534 = 0 ;
V_556 -> V_111 . V_216 . V_217 = 0 ;
if ( V_32 -> V_554 > 0xff ) {
V_556 -> V_553 = 0 ;
} else
V_556 -> V_553 = V_32 -> V_554 ;
if ( V_5 -> V_8 -> V_115 == V_455 )
F_14 ( V_5 -> V_8 , V_32 ) ;
return 1 ;
}
int
F_153 ( struct V_12 * V_8 , V_189 V_557 )
{
V_8 -> F_135 = F_135 ;
V_8 -> F_150 = F_150 ;
switch ( V_557 ) {
...
struct V_12 * V_8 = V_5 -> V_8 ;
int V_353 , V_564 = 0 ;
static char V_565 [ 384 ] ;
memset ( V_565 , 0 , 384 ) ;
if ( V_8 && V_8 -> V_209 ) {
strncpy ( V_565 , V_8 -> V_566 , 256 ) ;
V_353 = strlen ( V_565 ) ;
snprintf ( V_565 + V_353 ,
384 - V_353 ,
L_88 ,
V_8 -> V_209 -> V_567 -> V_568 ,
V_8 -> V_209 -> V_569 ,
V_8 -> V_209 -> V_570 ) ;
V_353 = strlen ( V_565 ) ;
if ( V_8 -> V_571 [ 0 ] ) {
...
V_564 = F_156 ( V_8 ) ;
if ( V_564 != 0 )
snprintf ( V_565 + V_353 , 384 - V_353 ,
L_90 , V_564 ) ;
}
return V_565 ;
}
...
{
unsigned long V_572 =
( V_49 + F_147 ( V_8 -> V_573 ) ) ;
if ( ! F_56 ( & V_8 -> V_147 . V_148 [ V_574 ] . V_575 ) )
F_158 ( & V_8 -> V_576 ,
V_572 ) ;
}
...
void F_160 ( unsigned long V_523 )
{
struct V_12 * V_8 = (struct V_12 * ) V_523 ;
if ( V_8 -> V_518 & V_519 ) {
F_161 ( V_8 ,
& V_8 -> V_147 . V_148 [ V_574 ] , V_577 ) ;
if ( V_8 -> V_518 & V_578 )
F_157 ( V_8 ) ;
}
}
...
V_32 -> V_100 . V_84 . V_485 ,
V_32 -> V_100 . V_84 . V_553 ,
( T_1 )
( V_14 -> V_382 -> V_554 / 1000 ) ) ;
goto V_585;
}
if ( V_8 -> V_518 & V_519 ) {
F_161 ( V_8 ,
...
L_135
L_136 ,
F_173 ( V_555 ) , V_632 , V_633 ,
V_40 -> V_547 , V_40 -> V_537 , V_142 -> V_150 ,
V_142 -> V_101 ) ;
V_128 = F_177 ( V_8 , V_574 ,
V_142 , V_634 , V_32 -> V_554 ) ;
if ( ( V_128 != V_636 ) ||
