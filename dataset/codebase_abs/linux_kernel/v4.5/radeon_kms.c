...
T_3 F_60 ( struct V_1 * V_2 , unsigned int V_180 )
{
...
F_65 ( & V_4 -> V_190 . V_191 , V_189 ) ;
V_4 -> V_190 . V_192 [ V_39 ] = true ;
V_9 = F_66 ( V_4 ) ;
F_67 ( & V_4 -> V_190 . V_191 , V_189 ) ;
return V_9 ;
}
