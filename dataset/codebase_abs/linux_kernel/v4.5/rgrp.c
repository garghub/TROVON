...
V_22 -> V_113 -> V_144 . V_66 = ( V_22 -> V_23 * V_136 ) & V_145 ;
V_22 -> V_113 -> V_144 . V_7 = F_77 ( ( V_22 -> V_23 +
V_22 -> V_57 ) * V_136 ) - 1 ;
V_22 -> V_146 = (struct V_147 * ) V_22 -> V_113 -> V_148 . V_149 ;
V_22 -> V_150 &= ~ ( V_151 | V_152 ) ;
if ( V_22 -> V_49 > V_75 -> V_153 )
V_75 -> V_153 = V_22 -> V_49 ;
F_28 ( & V_75 -> V_87 ) ;
error = F_69 ( V_22 ) ;
F_30 ( & V_75 -> V_87 ) ;
if ( ! error )
...
V_164 -> V_165 = F_86 ( V_22 -> V_150 & ~ V_166 ) ;
...
static void F_89 ( struct V_147 * V_173 , const void * V_40 )
{
const struct V_53 * V_164 = V_40 ;
...
V_22 -> V_150 |= ( V_151 | V_187 ) ;
V_22 -> V_188 = V_22 -> V_79 ;
V_22 -> V_104 = V_22 -> V_79 ;
}
if ( F_86 ( V_179 ) != V_22 -> V_146 -> V_178 ) {
V_22 -> V_146 -> V_182 = F_86 ( F_91 ( V_22 ) ) ;
F_89 ( V_22 -> V_146 ,
...
if ( F_86 ( V_179 ) != V_22 -> V_146 -> V_178 )
return F_94 ( V_22 ) ;
V_174 = F_68 ( V_22 -> V_146 -> V_174 ) ;
V_174 &= ~ V_166 ;
V_22 -> V_150 &= V_166 ;
V_22 -> V_150 |= ( V_174 | V_151 | V_187 ) ;
if ( V_22 -> V_146 -> V_182 == 0 )
V_22 -> V_150 &= ~ V_187 ;
V_22 -> V_79 = F_68 ( V_22 -> V_146 -> V_175 ) ;
V_22 -> V_188 = V_22 -> V_79 ;
V_22 -> V_80 = F_68 ( V_22 -> V_146 -> V_176 ) ;
V_22 -> V_169 = F_74 ( V_22 -> V_146 -> V_177 ) ;
return 0 ;
}
...
return;
V_223 = F_123 ( & V_2 , V_61 , & V_241 , V_93 , true , V_240 ) ;
if ( V_223 == 0 ) {
V_36 -> V_38 = V_2 ;
V_36 -> V_39 = V_241 ;
V_36 -> V_99 = V_93 -> V_96 ;
...
static unsigned char F_148 ( struct V_69 * V_22 , T_2 V_44 )
{
struct V_1 V_2 = { . V_22 = V_22 , } ;
int V_223 ;
V_223 = F_16 ( & V_2 , V_44 ) ;
...
static void F_149 ( const struct V_1 * V_2 , bool V_317 ,
unsigned int * V_59 )
{
...
static struct V_69 * F_150 ( struct V_74 * V_75 , T_2 V_321 ,
...
if ( V_10 != V_323 ) {
if ( ! V_10 -> V_25 ) {
V_10 -> V_25 = F_152 ( V_10 -> V_17 -> V_68 ,
V_120 | V_324 ) ;
...
void F_153 ( struct V_97 * V_98 , const struct V_111 * V_112 )
{
...
return;
F_42 ( V_98 , L_16 ,
( unsigned long long ) V_22 -> V_23 , V_22 -> V_150 ,
...
static void F_154 ( struct V_69 * V_22 )
{
struct V_74 * V_75 = V_22 -> V_55 ;
F_107 ( V_75 , L_17 ,
( unsigned long long ) V_22 -> V_23 ) ;
F_107 ( V_75 , L_18 ) ;
F_153 ( NULL , V_22 -> V_113 ) ;
V_22 -> V_150 |= V_312 ;
}
static void F_155 ( struct V_92 * V_93 ,
...
F_28 ( & V_22 -> V_107 ) ;
if ( F_44 ( V_36 ) ) {
if ( F_156 ( & V_36 -> V_38 , V_2 ) ) {
V_44 = F_12 ( V_2 ) ;
V_223 = F_16 ( & V_36 -> V_38 , V_44 + V_34 ) ;
V_326 = F_157 ( V_36 -> V_39 , V_34 ) ;
V_36 -> V_39 -= V_326 ;
V_22 -> V_103 -= V_326 ;
F_45 ( V_36 , V_327 ) ;
if ( V_36 -> V_39 && ! V_223 )
goto V_67;
F_158 ( V_328 , & V_36 -> V_244 ) ;
}
F_43 ( V_36 ) ;
}
V_67:
...
int F_160 ( struct V_92 * V_93 , T_2 * V_329 , unsigned int * V_330 ,
...
T_2 V_44 ;
int error ;
F_159 ( & V_2 , V_93 , V_317 ) ;
error = F_123 ( & V_2 , V_61 , NULL , V_93 , false , NULL ) ;
if ( error == - V_262 ) {
F_159 ( & V_2 , V_93 , V_317 ) ;
...
F_149 ( & V_2 , V_317 , V_330 ) ;
V_44 = F_12 ( & V_2 ) ;
V_2 . V_22 -> V_247 = V_44 - V_2 . V_22 -> V_46 ;
if ( F_44 ( & V_93 -> V_110 ) )
F_155 ( V_93 , & V_2 , * V_330 ) ;
V_333 = * V_330 ;
if ( V_317 )
V_333 -- ;
if ( ! V_317 ) {
V_93 -> V_95 = V_44 + V_333 - 1 ;
error = F_161 ( V_93 , & V_332 ) ;
if ( error == 0 ) {
struct V_335 * V_336 =
...
F_89 ( V_2 . V_22 -> V_146 , V_2 . V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_162 ( V_75 , 0 , - ( T_9 ) * V_330 , V_317 ? 1 : 0 ) ;
if ( V_317 )
F_163 ( V_75 , V_44 , * V_330 ) ;
F_164 ( V_93 , * V_330 , V_93 -> V_94 . V_339 , V_93 -> V_94 . V_340 ) ;
V_2 . V_22 -> V_188 -= * V_330 ;
F_165 ( V_93 , V_2 . V_22 , V_44 , * V_330 ,
V_317 ? V_319 : V_320 ) ;
* V_329 = V_44 ;
return 0 ;
V_334:
...
void F_166 ( struct V_92 * V_93 , T_2 V_321 , T_4 V_322 , int V_341 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
V_22 = F_150 ( V_75 , V_321 , V_322 , V_61 ) ;
if ( ! V_22 )
return;
F_165 ( V_93 , V_22 , V_321 , V_322 , V_61 ) ;
V_22 -> V_79 += V_322 ;
V_22 -> V_150 &= ~ V_234 ;
F_116 ( V_22 -> V_113 , V_22 -> V_78 [ 0 ] . V_17 ) ;
F_85 ( V_22 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_89 ( V_22 -> V_146 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
if ( V_341 || V_93 -> V_342 )
F_167 ( V_93 , V_321 , V_322 ) ;
}
void F_168 ( struct V_92 * V_93 , T_2 V_321 , T_4 V_322 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
F_166 ( V_93 , V_321 , V_322 , 1 ) ;
F_162 ( V_75 , 0 , + V_322 , 0 ) ;
F_164 ( V_93 , - ( T_9 ) V_322 , V_93 -> V_94 . V_339 , V_93 -> V_94 . V_340 ) ;
}
void F_169 ( struct V_126 * V_126 )
{
struct V_92 * V_93 = F_65 ( V_126 ) ;
struct V_74 * V_75 = F_36 ( V_126 ) ;
struct V_69 * V_22 ;
T_2 V_343 = V_93 -> V_96 ;
V_22 = F_150 ( V_75 , V_343 , 1 , V_183 ) ;
if ( ! V_22 )
return;
F_165 ( V_93 , V_22 , V_343 , 1 , V_183 ) ;
F_116 ( V_22 -> V_113 , V_22 -> V_78 [ 0 ] . V_17 ) ;
F_85 ( V_22 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_89 ( V_22 -> V_146 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_90 ( V_22 , 1 ) ;
}
static void F_170 ( struct V_69 * V_22 , T_2 V_343 )
{
struct V_74 * V_75 = V_22 -> V_55 ;
struct V_69 * V_344 ;
V_344 = F_150 ( V_75 , V_343 , 1 , V_61 ) ;
if ( ! V_344 )
return;
F_171 ( V_75 , V_22 == V_344 ) ;
if ( ! V_22 -> V_80 )
F_7 ( V_22 ) ;
V_22 -> V_80 -- ;
V_22 -> V_79 ++ ;
...
void F_172 ( struct V_69 * V_22 , struct V_92 * V_93 )
{
F_170 ( V_22 , V_93 -> V_96 ) ;
F_165 ( V_93 , V_22 , V_93 -> V_96 , 1 , V_61 ) ;
F_164 ( V_93 , - 1 , V_93 -> V_94 . V_339 , V_93 -> V_94 . V_340 ) ;
F_167 ( V_93 , V_93 -> V_96 , 1 ) ;
}
int F_173 ( struct V_74 * V_75 , T_2 V_345 , unsigned int type )
{
struct V_69 * V_22 ;
struct V_160 V_346 ;
int error = - V_48 ;
...
if ( error )
goto V_141;
if ( F_148 ( V_22 , V_345 ) != type )
error = - V_347 ;
F_83 ( & V_346 ) ;
V_141:
return error ;
}
void F_174 ( struct V_92 * V_93 , struct V_348 * V_349 ,
T_2 V_44 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
...
void F_175 ( struct V_348 * V_349 , unsigned int V_30 )
{
unsigned int V_77 ;
V_349 -> V_351 = F_63 ( V_349 -> V_352 , sizeof( struct V_160 ) ,
V_120 | V_324 ) ;
for ( V_77 = 0 ; V_77 < V_349 -> V_352 ; V_77 ++ )
F_176 ( V_349 -> V_353 [ V_77 ] -> V_113 ,
V_30 , 0 ,
& V_349 -> V_351 [ V_77 ] ) ;
}
void F_177 ( struct V_348 * V_349 )
{
unsigned int V_77 ;
F_38 ( V_349 -> V_353 ) ;
if ( V_349 -> V_351 ) {
for ( V_77 = 0 ; V_77 < V_349 -> V_352 ; V_77 ++ )
F_178 ( & V_349 -> V_351 [ V_77 ] ) ;
F_38 ( V_349 -> V_351 ) ;
V_349 -> V_351 = NULL ;
}
}
