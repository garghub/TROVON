...
{
struct V_209 * V_226 = ( (struct V_32 * ) V_44 -> V_48 ) -> V_37 ;
struct V_233 * V_234 = V_226 -> V_227 . V_228 . V_229 ;
char * V_235 = NULL ;
char * V_236 ;
char * V_237 ;
int V_238 = 1 ;
const char V_239 [] = L_49 ;
const int V_240 = sizeof( V_239 ) - 1 ;
if ( V_46 > V_53 - 1 || V_46 <= V_240 )
return - V_117 ;
V_235 = F_43 ( V_46 + 1 , V_106 ) ;
if ( ! V_235 )
return - V_107 ;
if ( F_44 ( V_235 , V_45 , V_46 ) ) {
V_46 = - V_118 ;
goto V_119;
}
V_235 [ V_46 ] = 0 ;
if ( strncmp ( V_239 , V_235 , V_240 ) != 0 ) {
V_46 = - V_117 ;
goto V_119;
}
V_236 = V_235 + V_240 ;
V_237 = strstr ( V_236 , L_50 ) ;
if ( V_237 ) {
T_1 V_241 ;
char * V_242 ;
* V_237 = 0 ;
V_238 = 0 ;
V_237 += strlen ( L_50 ) ;
V_241 = F_100 ( V_237 , & V_242 , 10 ) ;
if ( * V_242 ) {
F_101 ( L_51 , V_237 ) ;
} else if ( V_241 != V_234 -> V_243 . V_244 ) {
F_102 ( V_245 , L_52 ,
V_234 -> V_219 -> V_246 ,
V_234 -> V_243 . V_244 , V_241 ) ;
V_238 = 1 ;
} else {
F_102 ( V_245 , L_53 ,
V_234 -> V_219 -> V_246 , V_241 ) ;
}
}
if ( V_238 )
F_103 ( V_234 , V_236 , 1 ) ;
...
{
struct V_209 * V_226 = ( (struct V_32 * ) V_44 -> V_48 ) -> V_37 ;
struct V_248 * V_228 = & V_226 -> V_227 . V_228 ;
struct V_233 * V_234 = V_228 -> V_229 ;
int V_17 , V_50 ;
V_17 = F_19 ( V_45 , V_46 , & V_50 ) ;
if ( V_17 < 0 )
return V_17 ;
