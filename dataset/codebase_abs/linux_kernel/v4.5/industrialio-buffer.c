...
return 0 ;
V_104 = V_7 -> V_104 ;
F_72 (buffer, &indio_dev->buffer_list, buffer_list) {
if ( V_22 == V_99 )
continue;
V_104 &= V_22 -> V_4 -> V_104 ;
V_101 -> V_30 = F_73 ( V_101 -> V_30 , V_22 -> V_30 ) ;
}
if ( V_98 ) {
V_104 &= V_98 -> V_4 -> V_104 ;
V_101 -> V_30 = F_73 ( V_101 -> V_30 ,
V_98 -> V_30 ) ;
}
...
return 0 ;
V_117:
F_78 (buffer, &indio_dev->buffer_list,
buffer_list)
F_65 ( V_22 , V_7 ) ;
V_115:
V_7 -> V_118 = V_120 ;
...
static T_2 F_83 ( struct V_39 * V_40 ,
struct V_41 * V_42 ,
const char * V_2 ,
T_1 V_72 )
{
...
static T_2 F_84 ( struct V_39 * V_40 ,
struct V_41 * V_42 ,
char * V_2 )
{
struct V_6 * V_7 = F_22 ( V_40 ) ;
...
struct V_133 * * V_42 ;
struct V_1 * V_22 = V_7 -> V_22 ;
int V_24 , V_91 , V_134 , V_80 , V_135 = 0 ;
const struct V_78 * V_136 ;
V_136 = V_7 -> V_136 ;
if ( V_136 ) {
int V_137 = V_7 -> V_61 ;
for ( V_91 = 0 ; V_91 < V_7 -> V_138 ; V_91 ++ )
V_137 = F_87 ( V_137 , V_136 [ V_91 ] . V_44 + 1 ) ;
V_7 -> V_61 = V_137 ;
}
if ( ! V_22 )
return 0 ;
...
V_42 [ 2 ] = & V_144 . V_42 ;
if ( V_22 -> V_139 )
memcpy ( & V_42 [ F_88 ( V_140 ) ] , V_22 -> V_139 ,
sizeof( struct V_133 * ) * V_80 ) ;
V_42 [ V_80 + F_88 ( V_140 ) ] = NULL ;
...
goto V_150;
V_80 += V_24 ;
if ( V_136 [ V_91 ] . type == V_83 )
V_7 -> V_92 =
V_136 [ V_91 ] . V_44 ;
}
if ( V_7 -> V_61 && V_22 -> V_59 == NULL ) {
V_22 -> V_59 = F_74 ( F_28 ( V_7 -> V_61 ) ,
sizeof( * V_22 -> V_59 ) ,
V_68 ) ;
if ( V_22 -> V_59 == NULL ) {
V_24 = - V_69 ;
...
V_134 = V_135 ;
F_72 (p, &buffer->scan_el_dev_attr_list, l)
...
static const void * F_93 ( struct V_1 * V_22 ,
const void * V_155 )
{
struct V_156 * V_157 ;
if ( F_2 ( & V_22 -> V_37 ) )
return V_155 ;
F_72 (t, &buffer->demux_list, l)
memcpy ( V_22 -> V_158 + V_157 -> V_159 ,
V_155 + V_157 -> V_160 , V_157 -> V_84 ) ;
return V_22 -> V_158 ;
}
static int F_94 ( struct V_1 * V_22 , const void * V_161 )
{
const void * V_162 = F_93 ( V_22 , V_161 ) ;
int V_24 ;
V_24 = V_22 -> V_4 -> V_163 ( V_22 , V_162 ) ;
if ( V_24 )
return V_24 ;
F_95 ( & V_22 -> V_31 , V_35 | V_36 ) ;
return 0 ;
}
...
int F_98 ( struct V_6 * V_7 , const void * V_161 )
{
int V_24 ;
struct V_1 * V_2 ;
F_72 (buf, &indio_dev->buffer_list, buffer_list) {
V_24 = F_94 ( V_2 , V_161 ) ;
if ( V_24 < 0 )
return V_24 ;
}
...
static int F_99 ( struct V_1 * V_22 ,
...
V_84 = V_89 -> V_47 . V_56 / 8 ;
V_167 = F_103 ( V_167 , V_84 ) ;
V_166 = F_103 ( V_166 , V_84 ) ;
V_24 = F_99 ( V_22 , & V_132 , V_166 , V_167 , V_84 ) ;
if ( V_24 )
goto V_170;
V_167 += V_84 ;
V_166 += V_84 ;
...
static void F_105 ( struct V_171 * V_38 )
{
struct V_1 * V_22 = F_106 ( V_38 , struct V_1 , V_38 ) ;
V_22 -> V_4 -> V_172 ( V_22 ) ;
}
