...
if ( F_172 ( V_114 , V_247 ) )
break;
}
if ( F_173 ( V_114 < V_229 ) ) {
* V_181 = F_78 ( V_238 , V_114 ) ;
return 0 ;
}
return - V_57 ;
}
...
return 0 ;
V_120 = F_30 () ;
V_255 . V_257 = F_11 ( V_182 ) ;
V_255 . V_258 = F_11 ( V_168 ) ;
V_255 . V_259 = F_11 ( V_244 ) ;
V_255 . V_260 = F_11 ( V_242 ) ;
V_255 . V_261 = F_11 ( V_132 ) ;
V_255 . V_262 = F_11 ( V_36 ) ;
if ( V_120 >= 4 )
V_255 . V_263 = F_11 ( V_127 ) ;
V_255 . V_264 = F_11 ( V_125 ) ;
V_255 . V_265 = F_11 ( V_126 ) ;
V_255 . V_266 = F_11 ( V_124 ) ;
V_255 . V_267 = F_11 ( V_42 ) ;
V_255 . V_268 = F_11 ( V_38 ) ;
#ifdef F_88
if ( V_120 >= 5 )
V_255 . V_269 = F_11 ( V_128 ) ;
#endif
#ifdef F_89
if ( V_120 >= 6 )
V_255 . V_270 = F_11 ( V_129 ) ;
#endif
F_24 ( V_21 ) ;
F_90 () ;
F_189 () ;
...
F_25 ( V_182 , V_255 . V_257 ) ;
F_25 ( V_242 , V_255 . V_260 ) ;
F_25 ( V_244 , V_255 . V_259 ) ;
F_25 ( V_168 , V_255 . V_258 ) ;
F_25 ( V_132 , V_255 . V_261 ) ;
F_25 ( V_125 , V_255 . V_264 ) ;
F_25 ( V_126 , V_255 . V_265 ) ;
#ifdef F_88
if ( V_120 >= 5 )
F_25 ( V_128 , V_255 . V_269 ) ;
#endif
#ifdef F_89
if ( V_120 >= 6 )
F_25 ( V_129 , V_255 . V_270 ) ;
#endif
if ( V_120 >= 4 )
F_25 ( V_127 , V_255 . V_263 ) ;
F_25 ( V_36 , V_255 . V_262 ) ;
F_25 ( V_38 , V_255 . V_268 ) ;
F_25 ( V_42 , V_255 . V_267 ) ;
F_25 ( V_130 , 0 ) ;
F_11 ( V_130 ) ;
F_25 ( V_124 , V_255 . V_266 ) ;
F_25 ( V_130 , 0 ) ;
F_11 ( V_130 ) ;
F_191 ( V_121 ) ;
F_27 ( V_21 ) ;
...
static void F_110 ( void ) { }
static int F_194 ( const struct V_272 * V_273 )
{
if ( V_274 )
return 0 ;
F_17 ( L_90 , V_273 -> V_275 ) ;
V_274 = 1 ;
return 0 ;
}
...
if ( ! V_1 )
return - V_57 ;
if ( ! strncmp ( L_95 , V_1 , 3 ) )
V_152 = V_175 ;
else if ( ! strncmp ( L_96 , V_1 , 4 ) )
V_152 = V_153 ;
else if ( ! strncmp ( L_97 , V_1 , 3 ) )
V_152 = V_285 ;
else {
F_209 ( L_98 , V_1 ) ;
return - V_57 ;
