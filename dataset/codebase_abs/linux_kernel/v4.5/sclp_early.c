...
void T_1 F_12 ( struct V_61 * V_73 )
{
* V_73 = V_61 ;
}
...
if ( V_3 )
return - V_22 ;
if ( ( (struct V_74 * ) V_2 ) -> V_21 != 0x0020 )
return - V_22 ;
return 0 ;
}
static void T_1 F_14 ( struct V_75 * V_2 )
{
memset ( V_2 , 0 , sizeof( * V_2 ) ) ;
V_2 -> V_76 . V_17 = sizeof( * V_2 ) ;
V_2 -> V_77 . V_76 . V_17 = sizeof( struct V_78 ) ;
V_2 -> V_77 . V_76 . type = V_79 ;
V_2 -> V_77 . V_80 = V_81 ;
V_2 -> V_77 . V_82 = V_83 ;
V_2 -> V_77 . V_84 = 4712 ;
V_2 -> V_77 . V_85 = 1 ;
}
static int T_1 F_15 ( struct V_86 * V_2 ,
unsigned long V_87 ,
unsigned long V_88 )
{
memset ( V_2 , 0 , sizeof( * V_2 ) ) ;
V_2 -> V_16 . V_17 = sizeof( * V_2 ) ;
V_2 -> V_89 = sizeof( V_90 ) ;
V_2 -> V_87 = V_87 ;
V_2 -> V_88 = V_88 ;
return F_13 ( V_91 , V_2 ) ;
}
static long T_1 F_16 ( struct V_75 * V_2 )
{
F_14 ( V_2 ) ;
if ( F_13 ( V_92 , V_2 ) )
return - V_22 ;
if ( V_2 -> V_77 . V_93 == 0 )
return 0 ;
return ( V_2 -> V_77 . V_93 - 1 ) * V_94 ;
}
static long T_1 F_17 ( struct V_74 * V_2 )
{
memset ( V_2 , 0 , V_94 ) ;
V_2 -> V_17 = V_94 ;
if ( F_13 ( V_95 , V_2 ) )
return - V_22 ;
if ( ( (struct V_75 * ) V_2 ) -> V_77 . V_93 == 0 )
return 0 ;
return ( ( (struct V_75 * ) V_2 ) -> V_77 . V_93 - 1 ) * V_94 ;
}
...
static unsigned int T_1 F_19 ( struct V_86 * V_2 )
{
if ( ! ( V_2 -> V_98 & V_99 ) )
return 0 ;
if ( ! ( V_2 -> V_100 & ( V_101 | V_102 ) ) )
return 0 ;
return 1 ;
}
static void T_1 F_20 ( struct V_86 * V_2 )
{
