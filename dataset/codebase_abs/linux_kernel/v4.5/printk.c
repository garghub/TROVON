...
void F_154 ( struct V_157 * V_234 )
{
int V_56 ;
unsigned long V_29 ;
struct V_157 * V_235 = NULL ;
struct V_202 * V_47 ;
if ( V_159 )
F_87 (bcon)
if ( F_155 ( V_235 == V_234 ,
L_28 ,
V_235 -> V_199 , V_235 -> V_204 ) )
return;
if ( V_159 && V_234 -> V_29 & V_236 ) {
F_87 (bcon) {
if ( ! ( V_235 -> V_29 & V_236 ) ) {
F_61 ( L_29 ,
...
if ( V_159 && V_159 -> V_29 & V_236 )
V_235 = V_159 ;
if ( V_237 < 0 || V_235 || ! V_159 )
V_237 = V_205 ;
if ( V_237 < 0 ) {
if ( V_234 -> V_204 < 0 )
V_234 -> V_204 = 0 ;
if ( V_234 -> V_238 == NULL ||
V_234 -> V_238 ( V_234 , NULL ) == 0 ) {
V_234 -> V_29 |= V_161 ;
if ( V_234 -> V_232 ) {
V_234 -> V_29 |= V_239 ;
V_237 = 0 ;
...
V_56 ++ , V_47 ++ ) {
if ( ! V_234 -> V_240 ||
V_234 -> V_240 ( V_234 , V_47 -> V_199 , V_47 -> V_204 , V_47 -> V_200 ) != 0 ) {
F_156 ( sizeof( V_47 -> V_199 ) != sizeof( V_234 -> V_199 ) ) ;
if ( strcmp ( V_47 -> V_199 , V_234 -> V_199 ) != 0 )
continue;
if ( V_234 -> V_204 >= 0 &&
V_234 -> V_204 != V_47 -> V_204 )
continue;
if ( V_234 -> V_204 < 0 )
V_234 -> V_204 = V_47 -> V_204 ;
if ( F_157 ( V_234 , V_47 ) )
return;
if ( V_234 -> V_238 &&
V_234 -> V_238 ( V_234 , V_47 -> V_200 ) != 0 )
break;
}
V_234 -> V_29 |= V_161 ;
if ( V_56 == V_205 ) {
...
if ( ! ( V_234 -> V_29 & V_161 ) )
return;
if ( V_235 && ( ( V_234 -> V_29 & ( V_239 | V_236 ) ) == V_239 ) )
V_234 -> V_29 &= ~ V_241 ;
F_135 () ;
if ( ( V_234 -> V_29 & V_239 ) || V_159 == NULL ) {
V_234 -> V_132 = V_159 ;
V_159 = V_234 ;
if ( V_234 -> V_132 )
V_234 -> V_132 -> V_29 &= ~ V_239 ;
} else {
V_234 -> V_132 = V_159 -> V_132 ;
V_159 -> V_132 = V_234 ;
}
if ( V_234 -> V_29 & V_164 )
if ( ! V_173 ++ )
...
F_158 () ;
F_61 ( L_31 ,
( V_234 -> V_29 & V_236 ) ? L_32 : L_33 ,
V_234 -> V_199 , V_234 -> V_204 ) ;
if ( V_235 &&
( ( V_234 -> V_29 & ( V_239 | V_236 ) ) == V_239 ) &&
! V_233 ) {
F_87 (bcon)
if ( V_235 -> V_29 & V_236 )
F_159 ( V_235 ) ;
...
{
struct V_157 * V_242 , * V_243 ;
int V_244 ;
F_61 ( L_34 ,
( V_157 -> V_29 & V_236 ) ? L_32 : L_33 ,
...
for ( V_242 = V_159 -> V_132 , V_243 = V_159 ;
V_242 ; V_243 = V_242 , V_242 = V_243 -> V_132 ) {
if ( V_242 == V_157 ) {
V_243 -> V_132 = V_242 -> V_132 ;
V_244 = 0 ;
break;
}
}
}
if ( ! V_244 && ( V_157 -> V_29 & V_164 ) )
V_173 -- ;
if ( V_159 != NULL && V_157 -> V_29 & V_239 )
V_159 -> V_29 |= V_239 ;
V_157 -> V_29 &= ~ V_161 ;
F_117 () ;
F_158 () ;
...
static void F_164 ( struct V_245 * V_245 )
{
int V_246 = F_165 ( V_247 , 0 ) ;
if ( V_246 & V_248 ) {
if ( F_98 () )
F_117 () ;
}
...
int F_173 ( const char * V_251 )
{
return F_174 ( & V_252 , V_251 ) ;
}
bool F_175 ( unsigned long * V_253 ,
unsigned int V_254 )
{
unsigned long V_255 = V_123 - * V_253 ;
if ( * V_253 && V_255 <= F_74 ( V_254 ) )
return false ;
* V_253 = V_123 ;
return true ;
}
int F_176 ( struct V_256 * V_257 )
{
unsigned long V_29 ;
int V_100 = - V_258 ;
if ( ! V_257 -> V_259 )
...
bool F_187 ( struct V_256 * V_257 , bool V_127 ,
...
goto V_81;
V_7 = F_8 ( V_257 -> V_271 ) ;
V_273 = F_80 ( V_7 , 0 , V_127 , line , V_20 ) ;
V_257 -> V_271 = F_9 ( V_257 -> V_271 ) ;
V_257 -> V_270 ++ ;
V_62 = true ;
V_81:
if ( V_10 )
...
bool F_188 ( struct V_256 * V_257 , bool V_127 ,
char * line , T_5 V_20 , T_5 * V_10 )
{
unsigned long V_29 ;
bool V_62 ;
F_67 ( & V_77 , V_29 ) ;
V_62 = F_187 ( V_257 , V_127 , line , V_20 , V_10 ) ;
F_68 ( & V_77 , V_29 ) ;
return V_62 ;
}
bool F_189 ( struct V_256 * V_257 , bool V_127 ,
...
V_9 = V_257 -> V_271 ;
V_84 = 0 ;
while ( V_49 < V_257 -> V_141 ) {
struct V_6 * V_7 = F_8 ( V_9 ) ;
V_273 += F_80 ( V_7 , V_84 , true , NULL , 0 ) ;
V_9 = F_9 ( V_9 ) ;
V_49 ++ ;
V_84 = V_7 -> V_29 ;
}
...
V_9 = V_257 -> V_271 ;
V_84 = 0 ;
while ( V_273 > V_20 && V_49 < V_257 -> V_141 ) {
struct V_6 * V_7 = F_8 ( V_9 ) ;
V_273 -= F_80 ( V_7 , V_84 , true , NULL , 0 ) ;
V_9 = F_9 ( V_9 ) ;
V_49 ++ ;
...
while ( V_49 < V_257 -> V_141 ) {
struct V_6 * V_7 = F_8 ( V_9 ) ;
V_273 += F_80 ( V_7 , V_84 , V_127 , V_48 + V_273 , V_20 - V_273 ) ;
V_9 = F_9 ( V_9 ) ;
V_49 ++ ;
V_84 = V_7 -> V_29 ;
}
...
void T_9 F_192 ( const char * V_177 , ... )
{
T_11 args ;
va_start ( args , V_177 ) ;
...
void F_193 ( const char * V_275 )
{
F_123 ( L_35 ,
V_275 , F_194 () , V_42 -> V_276 , V_42 -> V_43 ,
F_195 () , F_196 () -> V_277 ,
( int ) strcspn ( F_196 () -> V_278 , L_36 ) ,
F_196 () -> V_278 ) ;
if ( V_274 [ 0 ] != '\0' )
F_123 ( L_37 ,
V_275 , V_274 ) ;
