...
F_8 ( F_5 ( V_5 ) ) ;
F_50 (scan, io) {
if ( V_39 -> V_24 -> V_25 [ V_5 -> V_6 ] . V_91 == NULL )
continue;
...
V_40 = 0 ;
F_50 (scan, io) {
if ( V_39 -> V_24 -> V_25 [ V_5 -> V_6 ] . V_98 == NULL )
continue;
...
F_8 ( F_5 ( V_5 ) ) ;
F_53 (scan, io) {
if ( V_39 -> V_24 -> V_25 [ V_5 -> V_6 ] . V_99 != NULL )
...
F_8 ( V_5 -> V_14 == V_15 || V_5 -> V_14 == V_16 ) ;
F_8 ( F_5 ( V_5 ) ) ;
F_12 ( F_71 ( V_111 , V_5 ) || V_111 -> V_132 != NULL ) ;
F_12 ( F_67 ( V_111 , V_5 ) ) ;
F_50 (scan, io) {
...
F_12 ( V_170 -> V_182 == 0 ) ;
F_8 ( F_9 ( & V_170 -> V_176 ) ) ;
F_8 ( F_117 ( V_170 -> V_183 > 0 , V_170 -> V_184 != NULL ) ) ;
if ( V_170 -> V_184 != NULL ) {
...
for ( V_180 = 0 ; V_180 < V_170 -> V_183 ; ++ V_180 )
F_12 ( V_170 -> V_184 [ V_180 ] . V_185 != NULL ) ;
V_40 = 0 ;
F_34 (slice, &req->crq_layers, crs_linkage) {
if ( V_18 -> V_178 -> V_199 != NULL ) {
