...
{
F_19 ( V_31 , V_31 -> V_32 . V_33 ) ;
F_17 ( V_31 -> V_32 . V_33 ) ;
}
static void F_20 ( unsigned long V_39 , struct V_40 * V_41 ,
struct V_42 * V_43 )
{
...
return V_62 ;
F_25 ( V_63 ) ;
F_26 (afi, &dev_net(dev)->nft.af_info, list) {
V_43 . V_57 = V_57 ;
if ( V_57 -> V_64 != V_65 )
continue;
F_26 (table, &afi->tables, list) {
V_43 . V_59 = V_59 ;
F_27 (chain, nr, &table->chains, list) {
if ( ! ( V_46 -> V_66 & V_67 ) )
continue;
V_43 . V_46 = V_46 ;
F_20 ( V_39 , V_41 , & V_43 ) ;
