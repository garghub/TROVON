...
char * V_52 = NULL ;
int V_8 ;
for ( V_8 = 0 ; V_8 < F_31 ( V_53 ) ; V_8 ++ ) {
if ( V_53 [ V_8 ] . V_54 == V_2 -> V_11 -> V_55 &&
V_53 [ V_8 ] . V_56 == V_2 -> V_11 -> V_57 ) {
V_52 = V_53 [ V_8 ] . V_58 ;
break;
}
}
...
V_64 -> V_69 [ V_8 ] . V_70 = F_34 ( V_66 +
F_35 ( struct V_63 , V_71 [ V_8 ] [ 0 ] ) ) ;
for ( V_8 = 0 ; V_8 < V_72 ; ++ V_8 )
V_64 -> V_73 [ V_8 ] . V_70 = F_34 ( V_66 +
F_35 ( struct V_63 , V_74 [ V_8 ] [ 0 ] ) ) ;
...
V_259 -> V_260 = 0 ;
for ( V_8 = 0 ; V_8 < V_260 ; ++ V_8 ) {
struct V_233 * V_233 = F_54 ( V_261 ) ;
struct V_244 * V_263 ;
if ( ! V_233 )
break;
V_263 = & V_259 -> V_256 [ V_8 ] ;
...
{
int V_8 ;
for ( V_8 = 0 ; V_8 < V_259 -> V_260 ; ++ V_8 ) {
struct V_244 * V_263 = & V_259 -> V_256 [ V_8 ] ;
F_57 ( F_49 ( V_263 ) ) ;
V_263 -> V_254 = 0 ;
}
V_259 -> V_260 = 0 ;
...
V_8 = V_64 -> V_90 ; V_291 = V_64 -> V_82 ;
while ( V_291 != 0 ) {
if ( V_64 -> V_73 [ V_8 ] . V_225 & F_34 ( V_226 ) )
break;
if ( V_2 -> V_223 [ V_8 ] ) {
V_2 -> V_292 ++ ;
V_2 -> V_293 = 0 ;
F_74 ( V_2 -> V_223 [ V_8 ] , error ) ;
F_73 ( V_2 , V_8 ) ;
}
if ( ++ V_8 == V_72 )
V_8 = 0 ;
...
V_64 -> V_90 = V_8 ; V_64 -> V_82 = V_291 ;
V_8 = V_64 -> V_88 ; V_291 = V_64 -> V_80 ;
while ( V_291 != 0 ) {
if ( V_64 -> V_75 [ V_8 ] . V_225 & F_34 ( V_226 ) )
break;
if ( ++ V_8 == V_76 )
V_8 = 0 ;
V_291 -- ;
}
V_64 -> V_88 = V_8 ; V_64 -> V_80 = V_291 ;
V_8 = V_64 -> V_87 ; V_291 = V_64 -> V_79 ;
while ( V_291 != 0 ) {
if ( V_64 -> V_69 [ V_8 ] . V_225 & F_34 ( V_226 ) )
break;
if ( ++ V_8 == V_68 )
V_8 = 0 ;
V_291 -- ;
}
V_64 -> V_87 = V_8 ; V_64 -> V_79 = V_291 ;
V_8 = V_64 -> V_89 ; V_291 = V_64 -> V_81 ;
while ( V_291 != 0 ) {
if ( V_64 -> V_77 [ V_8 ] . V_225 & F_34 ( V_226 ) )
break;
if ( ++ V_8 == V_78 )
V_8 = 0 ;
V_291 -- ;
}
V_64 -> V_89 = V_8 ; V_64 -> V_81 = V_291 ;
...
for ( V_8 = 0 ; V_8 < V_72 ; ++ V_8 ) {
F_79 ( L_30 , V_64 -> V_73 [ V_8 ] . V_225 , V_2 -> V_223 [ V_8 ] ) ;
if ( V_2 -> V_223 [ V_8 ] ) {
F_74 ( V_2 -> V_223 [ V_8 ] , - V_59 ) ;
F_73 ( V_2 , V_8 ) ;
}
}
F_79 ( L_31 ) ;
...
int V_8 ;
for ( V_8 = 0 ; V_8 < V_72 ; ++ V_8 ) {
struct V_315 * V_316 = & V_64 -> V_73 [ V_8 ] ;
if ( V_2 -> V_223 [ V_8 ] ) {
F_74 ( V_2 -> V_223 [ V_8 ] ,
...
if ( V_253 == V_322 ) {
T_1 V_323 [ V_324 ] ;
int V_4 = F_90 ( V_323 , V_173 ) ;
if ( F_91 ( V_4 == 0 ) && ( V_277 -> V_325 & V_326 ) ) {
V_277 -> V_325 |= V_327 ;
return - V_232 ;
}
}
...
{
int V_8 , V_274 ;
for ( V_8 = 0 ; V_8 < F_31 ( V_366 ) ; ++ V_8 ) {
V_274 = F_127 ( V_2 , & V_366 [ V_8 ] ) ;
if ( V_274 )
goto V_279;
}
return 0 ;
...
V_51 = F_148 ( V_11 , V_8 ) ;
V_235 = F_145 ( V_11 , V_8 ) ;
V_2 -> V_5 [ V_8 ] = F_149 ( V_51 , V_235 ) ;
if ( ! V_2 -> V_5 [ V_8 ] ) {
V_274 = - V_343 ;
goto V_376;
}
