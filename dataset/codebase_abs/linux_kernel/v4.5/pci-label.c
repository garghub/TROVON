...
static T_2 F_4 ( struct V_20 * V_21 ,
struct V_5 * V_22 , int V_23 )
{
struct V_24 * V_25 ;
struct V_1 * V_2 ;
V_25 = F_5 ( V_21 ) ;
...
static T_3 F_7 ( struct V_24 * V_25 ,
...
{
int V_32 ;
V_32 = F_14 ( ( const V_33 * ) V_31 -> V_34 . V_35 ,
V_31 -> V_34 . V_36 ,
V_37 ,
V_3 , V_16 ) ;
V_3 [ V_32 ] = '\n' ;
}
static int F_15 ( struct V_24 * V_25 , char * V_3 ,
enum V_38 V_22 )
{
T_4 V_39 ;
union V_30 * V_31 , * V_40 ;
int V_32 = - 1 ;
V_39 = F_16 ( V_25 ) ;
if ( ! V_39 )
return - 1 ;
V_31 = F_17 ( V_39 , V_41 , 0x2 ,
V_42 , NULL ) ;
if ( ! V_31 )
return - 1 ;
V_40 = V_31 -> V_43 . V_44 ;
if ( V_31 -> type == V_45 && V_31 -> V_43 . V_46 == 2 &&
V_40 [ 0 ] . type == V_47 &&
( V_40 [ 1 ] . type == V_48 ||
V_40 [ 1 ] . type == V_49 ) ) {
if ( V_22 == V_50 ) {
F_3 ( V_3 , V_16 , L_3 , V_40 -> integer . V_51 ) ;
} else if ( V_22 == V_52 ) {
if ( V_40 [ 1 ] . type == V_48 )
F_3 ( V_3 , V_16 , L_2 ,
V_40 [ 1 ] . string . V_35 ) ;
else if ( V_40 [ 1 ] . type == V_49 )
F_13 ( V_40 + 1 , V_3 ) ;
}
...
if ( ! V_39 )
return false ;
return ! ! F_20 ( V_39 , V_41 , 0x2 ,
1 << V_42 ) ;
}
static T_2 F_21 ( struct V_20 * V_21 ,
struct V_5 * V_22 , int V_23 )
{
struct V_24 * V_25 ;
V_25 = F_5 ( V_21 ) ;
...
static T_3 F_22 ( struct V_24 * V_25 ,
struct V_28 * V_22 , char * V_3 )
{
return F_15 ( V_25 , V_3 , V_52 ) ;
}
...
{
return F_10 ( & V_2 -> V_25 . V_21 , & V_53 ) ;
}
static int F_25 ( struct V_1 * V_2 )
{
F_12 ( & V_2 -> V_25 . V_21 , & V_53 ) ;
return 0 ;
}
...
static inline bool F_19 ( struct V_24 * V_25 )
{
return false ;
}
