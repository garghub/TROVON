...
V_173 -> V_226 = V_227 ;
F_141 ( V_173 , V_219 ) ;
F_142 ( V_173 , V_214 , V_220 ) ;
if ( F_143 ( V_2 , & V_218 , V_228 ) ) {
V_179 = & V_229 ;
} else
V_179 = & V_218 ;
F_132 ( V_8 , V_173 , V_13 , V_179 , & V_230 , V_231 , 0 ) ;
memcpy ( F_134 ( V_173 , sizeof( V_183 ) ) , V_183 , sizeof( V_183 ) ) ;
F_144 ( V_173 , F_145 ( V_173 ) - V_173 -> V_232 ) ;
...
{
struct V_178 * V_239 = F_120 ( V_173 ) ;
struct V_216 * V_217 =
...
F_8 () ;
V_2 = F_22 ( V_173 -> V_13 ) ;
F_147 ( V_18 , V_2 , V_244 , V_173 -> V_176 ) ;
V_177 = ( F_145 ( V_173 ) - F_148 ( V_173 ) ) -
sizeof( * V_239 ) ;
V_240 = F_145 ( V_173 ) - F_126 ( V_173 ) ;
V_239 -> V_177 = F_124 ( V_177 ) ;
V_217 -> V_236 = F_149 ( & V_239 -> V_179 , & V_239 -> V_208 , V_240 ,
V_223 ,
F_150 ( F_126 ( V_173 ) ,
V_240 , 0 ) ) ;
F_151 ( V_18 -> V_147 . V_215 , & V_242 , V_234 ,
& F_120 ( V_173 ) -> V_179 , & F_120 ( V_173 ) -> V_208 ,
V_173 -> V_13 -> V_9 ) ;
V_27 = F_152 ( V_173 -> V_13 , & V_242 ) ;
V_19 = 0 ;
if ( F_153 ( V_27 ) ) {
V_19 = F_154 ( V_27 ) ;
V_27 = NULL ;
...
goto V_245;
V_177 = V_173 -> V_176 ;
V_19 = F_156 ( V_246 , V_247 ,
V_18 , V_18 -> V_147 . V_215 , V_173 , NULL , V_173 -> V_13 ,
V_248 ) ;
V_249:
if ( ! V_19 ) {
F_157 ( V_18 , V_2 , V_234 ) ;
F_158 ( V_18 , V_2 , V_250 ) ;
} else {
F_159 ( V_18 , V_2 , V_251 ) ;
}
F_11 () ;
return;
V_245:
...
static int F_161 ( struct V_90 * V_46 , int type , int V_252 , int V_253 )
{
return sizeof( struct V_254 ) + 16 * F_131 ( V_46 , type , V_252 , V_253 ) ;
}
static struct V_172 * F_162 ( struct V_172 * V_173 , struct V_90 * V_46 ,
int type , struct V_254 * * V_255 )
{
...
if ( ! V_173 )
return NULL ;
V_256 = (struct V_254 * ) F_134 ( V_173 , sizeof( struct V_254 ) ) ;
V_256 -> V_257 = type ;
V_256 -> V_258 = 0 ;
V_256 -> V_259 = 0 ;
V_256 -> V_260 = V_46 -> V_93 ;
V_217 = (struct V_216 * ) F_126 ( V_173 ) ;
V_217 -> V_238 = F_124 ( F_115 ( V_217 -> V_238 ) + 1 ) ;
* V_255 = V_256 ;
return V_173 ;
}
static struct V_172 * F_163 ( struct V_172 * V_173 , struct V_90 * V_46 ,
int type , int V_200 , int V_201 , int V_261 )
{
struct V_1 * V_2 = V_46 -> V_2 ;
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_216 * V_217 ;
struct V_254 * V_256 = NULL ;
struct V_107 * V_108 , * V_117 , * V_262 , * * V_263 ;
int V_144 , V_264 , V_265 , V_266 , V_267 ;
if ( V_46 -> V_96 & V_100 )
return V_173 ;
V_266 = type == V_202 ||
type == V_203 ;
...
type == V_205 ;
V_264 = V_144 = 0 ;
V_263 = V_201 ? & V_46 -> V_109 : & V_46 -> V_110 ;
if ( ! * V_263 )
goto V_268;
V_217 = V_173 ? (struct V_216 * ) F_126 ( V_173 ) : NULL ;
if ( V_267 ) {
if ( V_217 && V_217 -> V_238 &&
...
V_265 = 1 ;
V_262 = NULL ;
for ( V_108 = * V_263 ; V_108 ; V_108 = V_117 ) {
struct V_10 * V_269 ;
V_117 = V_108 -> V_111 ;
if ( ! F_130 ( V_46 , V_108 , type , V_200 , V_201 ) ) {
V_262 = V_108 ;
...
if ( V_266 )
V_108 -> V_146 = 0 ;
if ( F_164 ( V_173 ) < sizeof( * V_269 ) +
V_265 * sizeof( struct V_254 ) ) {
if ( V_267 && ! V_265 )
break;
if ( V_256 )
V_256 -> V_259 = F_124 ( V_144 ) ;
if ( V_173 )
F_146 ( V_173 ) ;
V_173 = F_136 ( V_2 , V_13 -> V_214 ) ;
V_265 = 1 ;
...
if ( V_265 ) {
V_173 = F_162 ( V_173 , V_46 , type , & V_256 ) ;
V_265 = 0 ;
}
if ( ! V_173 )
return NULL ;
V_269 = (struct V_10 * ) F_134 ( V_173 , sizeof( * V_269 ) ) ;
* V_269 = V_108 -> V_129 ;
V_144 ++ ; V_264 ++ ;
if ( ( type == V_206 ||
...
type == V_207 )
return V_173 ;
if ( V_46 -> V_101 || V_266 || V_261 ) {
if ( V_173 && F_164 ( V_173 ) < sizeof( struct V_254 ) ) {
F_146 ( V_173 ) ;
V_173 = NULL ;
}
V_173 = F_162 ( V_173 , V_46 , type , & V_256 ) ;
...
static void F_166 ( struct V_107 * * V_270 )
{
struct V_107 * V_262 , * V_117 , * V_108 ;
V_262 = NULL ;
for ( V_108 = * V_270 ; V_108 ; V_108 = V_117 ) {
V_117 = V_108 -> V_111 ;
if ( V_108 -> V_112 == 0 ) {
if ( V_262 )
V_262 -> V_111 = V_108 -> V_111 ;
...
{
struct V_90 * V_46 , * V_116 , * V_271 ;
struct V_172 * V_173 = NULL ;
int type , V_272 ;
F_29 ( & V_2 -> V_39 ) ;
F_128 ( & V_2 -> V_113 ) ;
V_116 = NULL ;
for ( V_46 = V_2 -> V_114 ; V_46 ; V_46 = V_271 ) {
V_271 = V_46 -> V_24 ;
if ( V_46 -> V_106 == V_63 ) {
type = V_207 ;
V_272 = V_207 ;
V_173 = F_163 ( V_173 , V_46 , type , 1 , 0 , 0 ) ;
V_173 = F_163 ( V_173 , V_46 , V_272 , 1 , 1 , 0 ) ;
}
if ( V_46 -> V_101 ) {
if ( V_46 -> V_106 == V_30 ) {
type = V_204 ;
...
V_173 = F_163 ( V_173 , V_46 , type , 0 , 0 , 0 ) ;
V_173 = F_163 ( V_173 , V_46 , V_272 , 0 , 1 , 0 ) ;
if ( V_46 -> V_101 ) {
if ( V_46 -> V_106 == V_30 )
type = V_205 ;
else
...
struct V_172 * V_173 ;
struct V_165 * V_210 ;
const struct V_10 * V_273 , * V_179 ;
struct V_10 V_218 ;
int V_219 = F_137 ( V_13 ) ;
int V_220 = V_13 -> V_221 ;
int V_19 , V_176 , V_177 , V_274 ;
T_3 V_183 [ 8 ] = { V_223 , 0 ,
V_224 , 2 , 0 , 0 ,
V_225 , 0 } ;
struct V_241 V_242 ;
...
V_274 = sizeof( struct V_178 ) + V_177 ;
F_8 () ;
F_147 ( V_18 , F_22 ( V_13 ) ,
V_244 , V_274 ) ;
F_11 () ;
V_173 = F_140 ( V_8 , V_219 + V_220 + V_274 , 1 , & V_19 ) ;
if ( ! V_173 ) {
F_8 () ;
...
V_173 -> V_226 = V_227 ;
F_141 ( V_173 , V_219 ) ;
if ( F_169 ( V_13 , & V_218 , V_228 ) ) {
V_179 = & V_229 ;
} else
V_179 = & V_218 ;
F_132 ( V_8 , V_173 , V_13 , V_179 , V_273 , V_231 , V_177 ) ;
memcpy ( F_134 ( V_173 , sizeof( V_183 ) ) , V_183 , sizeof( V_183 ) ) ;
V_210 = (struct V_165 * ) F_134 ( V_173 , sizeof( struct V_165 ) ) ;
memset ( V_210 , 0 , sizeof( struct V_165 ) ) ;
V_210 -> V_277 = type ;
V_210 -> V_185 = * V_11 ;
V_210 -> V_278 = F_149 ( V_179 , V_273 , V_176 ,
V_223 ,
F_150 ( V_210 , V_176 , 0 ) ) ;
F_8 () ;
V_2 = F_22 ( V_173 -> V_13 ) ;
F_151 ( V_8 , & V_242 , type ,
& F_120 ( V_173 ) -> V_179 , & F_120 ( V_173 ) -> V_208 ,
V_173 -> V_13 -> V_9 ) ;
V_27 = F_152 ( V_173 -> V_13 , & V_242 ) ;
if ( F_153 ( V_27 ) ) {
...
static void F_172 ( unsigned long V_232 )
{
...
const struct V_10 * V_280 )
{
struct V_107 * V_108 , * V_262 ;
int V_52 = 0 ;
V_262 = NULL ;
for ( V_108 = V_46 -> V_110 ; V_108 ; V_108 = V_108 -> V_111 ) {
if ( F_10 ( & V_108 -> V_129 , V_280 ) )
break;
V_262 = V_108 ;
}
...
if ( V_108 -> V_282 && ! ( V_46 -> V_96 & V_100 ) &&
! F_2 ( V_2 ) ) {
...
int V_29 , int V_283 , const struct V_10 * V_280 ,
int V_284 )
{
struct V_90 * V_46 ;
int V_285 = 0 ;
...
V_19 = 0 ;
for ( V_50 = 0 ; V_50 < V_283 ; V_50 ++ ) {
int V_52 = F_173 ( V_46 , V_29 , & V_280 [ V_50 ] ) ;
V_285 |= V_52 > 0 ;
if ( ! V_19 && V_52 < 0 )
V_19 = V_52 ;
}
...
V_108 -> V_282 = V_108 -> V_130 [ V_63 ] != 0 ;
}
static int F_175 ( struct V_90 * V_46 )
{
struct V_107 * V_108 , * V_287 ;
int V_286 = V_46 -> V_125 [ V_30 ] ;
int V_288 = V_46 -> V_2 -> V_102 ;
int V_289 , V_52 ;
V_52 = 0 ;
for ( V_108 = V_46 -> V_110 ; V_108 ; V_108 = V_108 -> V_111 ) {
if ( V_46 -> V_125 [ V_30 ] ) {
V_289 = V_286 == V_108 -> V_130 [ V_30 ] &&
! V_108 -> V_130 [ V_63 ] ;
} else
V_289 = V_108 -> V_130 [ V_63 ] != 0 ;
if ( V_289 ) {
if ( ! V_108 -> V_282 ) {
struct V_107 * V_290 = NULL ;
for ( V_287 = V_46 -> V_109 ; V_287 ;
V_287 = V_287 -> V_111 ) {
if ( F_10 ( & V_287 -> V_129 ,
& V_108 -> V_129 ) )
break;
...
if ( V_287 ) {
if ( V_290 )
V_290 -> V_111 = V_287 -> V_111 ;
else
V_46 -> V_109 = V_287 -> V_111 ;
F_68 ( V_287 ) ;
}
V_108 -> V_112 = V_288 ;
V_52 ++ ;
...
V_108 -> V_112 = 0 ;
for ( V_287 = V_46 -> V_109 ; V_287 ; V_287 = V_287 -> V_111 )
if ( F_10 ( & V_287 -> V_129 ,
& V_108 -> V_129 ) )
break;
if ( ! V_287 ) {
V_287 = F_177 ( sizeof( * V_287 ) , V_70 ) ;
if ( ! V_287 )
continue;
* V_287 = * V_108 ;
V_287 -> V_111 = V_46 -> V_109 ;
V_46 -> V_109 = V_287 ;
}
V_287 -> V_112 = V_288 ;
V_52 ++ ;
...
F_51 ( & V_46 -> V_95 ) ;
F_174 ( V_46 ) ;
V_291 = V_46 -> V_106 == V_30 ;
if ( ! V_284 )
V_46 -> V_125 [ V_29 ] ++ ;
V_19 = 0 ;
for ( V_50 = 0 ; V_50 < V_283 ; V_50 ++ ) {
V_19 = F_176 ( V_46 , V_29 , & V_280 [ V_50 ] ) ;
if ( V_19 )
break;
}
if ( V_19 ) {
...
F_173 ( V_46 , V_29 , & V_280 [ V_51 ] ) ;
} else if ( V_291 != ( V_46 -> V_125 [ V_30 ] != 0 ) ) {
struct V_107 * V_108 ;
if ( V_46 -> V_125 [ V_30 ] )
V_46 -> V_106 = V_30 ;
...
{
struct V_107 * V_108 , * V_292 ;
for ( V_108 = V_46 -> V_109 ; V_108 ; V_108 = V_292 ) {
V_292 = V_108 -> V_111 ;
F_68 ( V_108 ) ;
}
V_46 -> V_109 = NULL ;
for ( V_108 = V_46 -> V_110 ; V_108 ; V_108 = V_292 ) {
V_292 = V_108 -> V_111 ;
F_68 ( V_108 ) ;
}
V_46 -> V_110 = NULL ;
...
if ( V_126 -> V_96 & V_100 )
return;
F_168 ( & V_126 -> V_93 , V_126 -> V_2 -> V_13 , V_293 ) ;
...
static int F_23 ( struct V_7 * V_8 , struct V_14 * V_294 ,
struct V_1 * V_2 )
{
int V_19 ;
if ( ! V_294 -> V_32 ) {
return F_37 ( V_2 , & V_294 -> V_11 , V_294 -> V_29 , 0 , NULL , 0 ) ;
}
V_19 = F_37 ( V_2 , & V_294 -> V_11 , V_294 -> V_29 ,
V_294 -> V_32 -> V_61 , V_294 -> V_32 -> V_62 , 0 ) ;
F_16 ( V_8 , V_294 -> V_32 , F_39 ( V_294 -> V_32 -> V_66 ) ) ;
V_294 -> V_32 = NULL ;
return V_19 ;
}
...
static void F_178 ( unsigned long V_232 )
{
struct V_1 * V_2 = (struct V_1 * ) V_232 ;
V_2 -> V_133 = 0 ;
F_165 ( V_2 , NULL ) ;
...
static void F_179 ( unsigned long V_232 )
{
struct V_1 * V_2 = (struct V_1 * ) V_232 ;
F_167 ( V_2 ) ;
if ( V_2 -> V_137 ) {
...
static void V_120 ( unsigned long V_232 )
{
struct V_90 * V_126 = (struct V_90 * ) V_232 ;
if ( F_2 ( V_126 -> V_2 ) )
F_168 ( & V_126 -> V_93 , V_126 -> V_2 -> V_13 , V_293 ) ;
else
...
static inline struct V_90 * F_187 ( struct V_299 * V_300 )
{
struct V_90 * V_105 = NULL ;
struct V_301 * V_302 = F_188 ( V_300 ) ;
struct V_18 * V_18 = F_189 ( V_300 ) ;
V_302 -> V_2 = NULL ;
F_190 (net, state->dev) {
struct V_1 * V_2 ;
V_2 = F_22 ( V_302 -> V_13 ) ;
...
static struct V_90 * F_191 ( struct V_299 * V_300 , struct V_90 * V_105 )
{
struct V_301 * V_302 = F_188 ( V_300 ) ;
V_105 = V_105 -> V_24 ;
while ( ! V_105 ) {
if ( F_192 ( V_302 -> V_2 ) )
F_30 ( & V_302 -> V_2 -> V_39 ) ;
V_302 -> V_13 = F_193 ( V_302 -> V_13 ) ;
if ( ! V_302 -> V_13 ) {
V_302 -> V_2 = NULL ;
break;
}
V_302 -> V_2 = F_22 ( V_302 -> V_13 ) ;
if ( ! V_302 -> V_2 )
continue;
F_29 ( & V_302 -> V_2 -> V_39 ) ;
V_105 = V_302 -> V_2 -> V_119 ;
}
return V_105 ;
}
static struct V_90 * F_194 ( struct V_299 * V_300 , T_4 V_303 )
{
struct V_90 * V_105 = F_187 ( V_300 ) ;
if ( V_105 )
while ( V_303 && ( V_105 = F_191 ( V_300 , V_105 ) ) != NULL )
-- V_303 ;
return V_303 ? NULL : V_105 ;
}
static void * F_195 ( struct V_299 * V_300 , T_4 * V_303 )
__acquires( T_5 )
{
F_8 () ;
return F_194 ( V_300 , * V_303 ) ;
}
static void * F_196 ( struct V_299 * V_300 , void * V_304 , T_4 * V_303 )
{
struct V_90 * V_105 = F_191 ( V_300 , V_304 ) ;
++ * V_303 ;
return V_105 ;
}
static void F_197 ( struct V_299 * V_300 , void * V_304 )
__releases( T_5 )
{
struct V_301 * V_302 = F_188 ( V_300 ) ;
if ( F_192 ( V_302 -> V_2 ) ) {
...
static int F_198 ( struct V_299 * V_300 , void * V_304 )
{
struct V_90 * V_105 = (struct V_90 * ) V_304 ;
struct V_301 * V_302 = F_188 ( V_300 ) ;
F_199 ( V_300 ,
L_2 ,
V_302 -> V_13 -> V_9 , V_302 -> V_13 -> V_305 ,
& V_105 -> V_93 ,
...
static int F_201 ( struct V_306 * V_306 , struct V_307 * V_307 )
{
return F_202 ( V_306 , V_307 , & V_308 ,
sizeof( struct V_301 ) ) ;
}
static inline struct V_107 * F_203 ( struct V_299 * V_300 )
{
struct V_107 * V_108 = NULL ;
struct V_90 * V_105 = NULL ;
struct V_309 * V_302 = F_204 ( V_300 ) ;
struct V_18 * V_18 = F_189 ( V_300 ) ;
V_302 -> V_2 = NULL ;
V_302 -> V_105 = NULL ;
F_190 (net, state->dev) {
...
static struct V_107 * F_205 ( struct V_299 * V_300 , struct V_107 * V_108 )
{
struct V_309 * V_302 = F_204 ( V_300 ) ;
V_108 = V_108 -> V_111 ;
while ( ! V_108 ) {
F_54 ( & V_302 -> V_105 -> V_95 ) ;
V_302 -> V_105 = V_302 -> V_105 -> V_24 ;
while ( ! V_302 -> V_105 ) {
if ( F_192 ( V_302 -> V_2 ) )
F_30 ( & V_302 -> V_2 -> V_39 ) ;
V_302 -> V_13 = F_193 ( V_302 -> V_13 ) ;
...
continue;
F_29 ( & V_302 -> V_2 -> V_39 ) ;
V_302 -> V_105 = V_302 -> V_2 -> V_119 ;
}
if ( ! V_302 -> V_105 )
break;
F_51 ( & V_302 -> V_105 -> V_95 ) ;
V_108 = V_302 -> V_105 -> V_110 ;
}
V_249:
return V_108 ;
}
static struct V_107 * F_206 ( struct V_299 * V_300 , T_4 V_303 )
{
struct V_107 * V_108 = F_203 ( V_300 ) ;
if ( V_108 )
while ( V_303 && ( V_108 = F_205 ( V_300 , V_108 ) ) != NULL )
-- V_303 ;
return V_303 ? NULL : V_108 ;
}
static void * F_207 ( struct V_299 * V_300 , T_4 * V_303 )
__acquires( T_5 )
{
F_8 () ;
return * V_303 ? F_206 ( V_300 , * V_303 - 1 ) : V_310 ;
}
static void * F_208 ( struct V_299 * V_300 , void * V_304 , T_4 * V_303 )
{
struct V_107 * V_108 ;
if ( V_304 == V_310 )
V_108 = F_203 ( V_300 ) ;
else
V_108 = F_205 ( V_300 , V_304 ) ;
++ * V_303 ;
return V_108 ;
}
static void F_209 ( struct V_299 * V_300 , void * V_304 )
__releases( T_5 )
{
struct V_309 * V_302 = F_204 ( V_300 ) ;
if ( F_192 ( V_302 -> V_105 ) ) {
F_54 ( & V_302 -> V_105 -> V_95 ) ;
V_302 -> V_105 = NULL ;
}
if ( F_192 ( V_302 -> V_2 ) ) {
...
static int F_210 ( struct V_299 * V_300 , void * V_304 )
{
struct V_107 * V_108 = (struct V_107 * ) V_304 ;
struct V_309 * V_302 = F_204 ( V_300 ) ;
if ( V_304 == V_310 ) {
F_211 ( V_300 , L_3 ) ;
} else {
...
static int F_212 ( struct V_306 * V_306 , struct V_307 * V_307 )
{
return F_202 ( V_306 , V_307 , & V_311 ,
sizeof( struct V_309 ) ) ;
}
...
int V_19 ;
V_19 = - V_23 ;
if ( ! F_214 ( L_5 , V_312 , V_18 -> V_313 , & V_314 ) )
goto V_249;
if ( ! F_214 ( L_6 , V_312 , V_18 -> V_313 ,
& V_315 ) )
goto V_316;
V_19 = 0 ;
V_249:
return V_19 ;
V_316:
F_215 ( L_5 , V_18 -> V_313 ) ;
goto V_249;
}
static void T_7 F_216 ( struct V_18 * V_18 )
{
F_215 ( L_6 , V_18 -> V_313 ) ;
F_215 ( L_5 , V_18 -> V_313 ) ;
}
...
{
int V_19 ;
V_19 = F_218 ( & V_18 -> V_147 . V_215 , V_317 ,
V_318 , V_223 , V_18 ) ;
if ( V_19 < 0 ) {
F_219 ( L_7 ,
V_19 ) ;
...
V_19 = F_218 ( & V_18 -> V_147 . V_319 , V_317 ,
V_318 , V_223 , V_18 ) ;
if ( V_19 < 0 ) {
F_219 ( L_8 ,
V_19 ) ;
