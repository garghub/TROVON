...
if ( V_26 -> V_41 [ V_14 ] . V_31 == '*' &&
V_30 == V_26 -> V_41 [ V_14 ] . V_30 ) {
V_32 = V_26 -> V_41 [ V_14 ] . V_42 ;
break;
} else if ( V_30 == V_26 -> V_41 [ V_14 ] . V_30 &&
V_31 == V_26 -> V_41 [ V_14 ] . V_31 ) {
V_32 = V_26 -> V_41 [ V_14 ] . V_42 ;
break;
} else if ( V_26 -> V_41 [ V_14 ] . V_30 == '*' &&
V_26 -> V_41 [ V_14 ] . V_31 == '*' )
V_32 = V_26 -> V_41 [ V_14 ] . V_42 ;
}
if ( V_32 == V_33 ) {
...
const struct V_21 * V_22 ;
int V_49 ;
V_10 = F_19 ( V_48 , F_20 ( * V_10 ) , V_12 . V_48 ) ;
V_12 = & V_10 -> V_12 ;
V_49 = F_21 ( & V_22 , V_10 -> V_12 . V_50 ,
& V_10 -> V_3 -> V_51 -> V_3 ) ;
if ( ! V_22 )
goto V_52;
