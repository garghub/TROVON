...
unsigned long F_22 ( struct V_59 * V_17 , unsigned long V_60 )
{
struct V_1 * V_2 = F_23 ( V_17 ) ;
return F_24 ( V_2 ) ;
}
int F_25 ( struct V_59 * V_17 )
{
struct V_1 * V_2 = F_23 ( V_17 ) ;
int V_26 ;
struct V_4 * V_5 ;
...
if ( F_17 ( V_17 ) ==
F_17 ( F_27 ( V_5 -> V_66 ) ) ) {
F_28 ( V_61 != F_27 ( V_5 -> V_66 ) ) ;
V_26 = F_14 ( V_2 ) ;
} else {
F_28 ( V_61 != F_27 ( V_5 -> V_24 ) ) ;
V_26 = F_10 ( V_2 ) ;
}
return V_26 ;
}
void F_29 ( struct V_59 * V_17 )
{
struct V_1 * V_2 = F_23 ( V_17 ) ;
F_15 ( V_2 ) ;
if ( V_2 -> V_62 )
...
( V_5 -> V_29 & ( 1 << V_30 ) ) ) {
V_69 -> V_71 = F_27 ( V_5 -> V_66 ) ;
} else {
V_69 -> V_70 = F_31 ( V_17 , V_69 -> V_70 ,
& V_69 -> V_72 ) ;
V_69 -> V_71 = F_27 ( V_5 -> V_24 ) ;
}
V_69 -> V_72 = V_69 -> V_70 ;
return 0 ;
}
int F_32 ( struct V_59 * V_17 , T_1 V_73 )
{
struct V_1 * V_2 = F_23 ( V_17 ) ;
int V_14 ;
if ( ! V_17 )
...
int F_33 ( struct V_59 * V_17 , unsigned long V_70 ,
unsigned long V_60 )
{
struct V_1 * V_2 = F_23 ( V_17 ) ;
struct V_4 * V_5 ;
...
static struct V_1 * F_35 ( struct V_59 * V_17 )
{
struct V_1 * V_78 = NULL ;
do {
do {
V_17 = F_18 ( V_17 ) ;
} while ( V_17 && ( F_36 ( V_17 ) & V_79 ) );
if ( ! V_17 )
break;
V_78 = F_23 ( V_17 ) ;
} while ( V_78 && ! V_78 -> V_4 );
...
unsigned long F_37 ( struct V_59 * V_17 ,
unsigned long V_60 )
{
const struct V_4 * V_5 ;
unsigned long V_70 ;
...
int F_38 ( struct V_59 * V_17 , unsigned long V_70 ,
unsigned long V_60 )
{
if ( F_21 () -> V_41 & V_82 ) {
F_6 ( L_12 ) ;
...
return F_33 ( V_17 , V_70 , V_60 ) ;
}
int F_39 ( struct V_59 * V_17 , unsigned long V_70 ,
