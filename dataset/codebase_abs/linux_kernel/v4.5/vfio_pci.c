...
static void F_108 ( struct V_6 * V_8 )
{
struct V_4 * V_5 ;
V_5 = F_109 ( & V_8 -> V_26 ) ;
if ( ! V_5 )
return;
F_102 ( V_8 -> V_26 . V_75 , & V_8 -> V_26 ) ;
F_20 ( V_5 ) ;
if ( F_9 ( V_8 ) ) {
F_106 ( V_8 , NULL , NULL , NULL ) ;
F_107 ( V_8 ,
V_12 | V_13 |
V_14 | V_15 ) ;
}
...
static T_9 F_110 ( struct V_6 * V_8 ,
T_10 V_189 )
{
struct V_4 * V_5 ;
struct V_190 * V_191 ;
V_191 = F_111 ( & V_8 -> V_26 ) ;
if ( V_191 == NULL )
return V_192 ;
V_5 = F_112 ( V_191 ) ;
if ( V_5 == NULL ) {
...
static int F_114 ( struct V_6 * V_8 , void * V_72 )
{
