...
V_70 -> V_147 . string = V_146 ;
V_70 -> V_147 . V_148 = strlen ( V_146 ) ;
V_70 -> V_61 = V_61 ;
F_68 ( & V_70 -> V_149 ) ;
F_68 ( & V_70 -> V_150 ) ;
}
...
return 0 ;
V_70 -> V_147 . V_148 -- ;
return V_70 -> V_147 . string [ V_70 -> V_147 . V_151 ++ ] ;
}
static char F_70 ( struct V_69 * V_70 )
{
if ( V_70 -> V_147 . V_151 == strlen ( V_70 -> V_147 . string ) )
return 0 ;
return V_70 -> V_147 . string [ V_70 -> V_147 . V_151 ] ;
}
...
int V_152 , int V_153 )
{
return V_70 -> V_61 [ V_152 ] . V_154 < V_70 -> V_61 [ V_153 ] . V_154 ;
}
static inline int F_73 ( struct V_69 * V_70 , char V_155 )
{
int V_32 ;
for ( V_32 = 0 ; strcmp ( V_70 -> V_61 [ V_32 ] . string , L_8 ) ; V_32 ++ ) {
if ( V_70 -> V_61 [ V_32 ] . string [ 0 ] == V_155 )
return 1 ;
}
return 0 ;
}
static int F_74 ( struct V_69 * V_70 , char V_156 )
{
char V_157 = F_70 ( V_70 ) ;
char V_158 [ 3 ] ;
int V_32 ;
V_158 [ 0 ] = V_156 ;
V_158 [ 1 ] = V_157 ;
V_158 [ 2 ] = '\0' ;
for ( V_32 = 0 ; strcmp ( V_70 -> V_61 [ V_32 ] . string , L_8 ) ; V_32 ++ ) {
if ( ! strcmp ( V_158 , V_70 -> V_61 [ V_32 ] . string ) ) {
F_71 ( V_70 ) ;
return V_70 -> V_61 [ V_32 ] . V_159 ;
}
}
V_158 [ 1 ] = '\0' ;
for ( V_32 = 0 ; strcmp ( V_70 -> V_61 [ V_32 ] . string , L_8 ) ; V_32 ++ ) {
...
{
memset ( V_70 -> V_161 . string , '\0' , V_162 ) ;
V_70 -> V_161 . V_151 = 0 ;
}
static inline int F_76 ( struct V_69 * V_70 , char V_155 )
{
if ( V_70 -> V_161 . V_151 == V_162 - 1 )
return - V_50 ;
V_70 -> V_161 . string [ V_70 -> V_161 . V_151 ++ ] = V_155 ;
return 0 ;
}
static int F_77 ( struct V_69 * V_70 , int V_17 )
{
struct V_163 * V_163 ;
V_163 = F_30 ( sizeof( * V_163 ) , V_75 ) ;
if ( ! V_163 )
return - V_76 ;
V_163 -> V_17 = V_17 ;
F_78 ( & V_163 -> V_164 , & V_70 -> V_149 ) ;
return 0 ;
}
static int F_79 ( struct V_69 * V_70 )
{
return F_80 ( & V_70 -> V_149 ) ;
}
...
if ( F_79 ( V_70 ) )
return V_160 ;
V_163 = F_82 ( & V_70 -> V_149 , struct V_163 , V_164 ) ;
return V_163 -> V_17 ;
}
...
{
return V_70 -> V_161 . string ;
}
static int F_87 ( struct V_69 * V_70 , char * V_161 )
{
struct V_165 * V_166 ;
V_166 = F_30 ( sizeof( * V_166 ) , V_75 ) ;
if ( ! V_166 )
return - V_76 ;
V_166 -> V_17 = V_160 ;
V_166 -> V_161 = F_27 ( V_161 , V_75 ) ;
if ( ! V_166 -> V_161 ) {
F_25 ( V_166 ) ;
return - V_76 ;
}
F_88 ( & V_166 -> V_164 , & V_70 -> V_150 ) ;
return 0 ;
}
...
{
struct V_165 * V_166 ;
while ( ! F_80 ( & V_70 -> V_150 ) ) {
V_166 = F_82 ( & V_70 -> V_150 , struct V_165 , V_164 ) ;
F_84 ( & V_166 -> V_164 ) ;
F_25 ( V_166 -> V_161 ) ;
F_25 ( V_166 ) ;
}
...
struct V_103 * V_104 ,
int V_17 , char * V_174 , char * V_175 )
{
struct V_115 * V_116 ;
...
if ( V_166 -> V_17 == V_100 || V_166 -> V_17 == V_60 ) {
V_179 ++ ;
V_148 -- ;
continue;
}
...
int * V_51 , void * V_47 )
{
struct V_182 * V_64 = V_47 ;
if ( F_22 ( V_64 -> V_183 ++ > V_64 -> V_184 ) ) {
* V_51 = - V_50 ;
return V_53 ;
}
return V_65 ;
...
{
int V_183 = 0 , V_52 ;
V_52 = F_16 ( V_37 , V_45 , F_98 , & V_183 ) ;
F_22 ( V_52 ) ;
return V_183 ;
}
...
int * V_51 , void * V_47 )
{
struct V_185 * V_64 = V_47 ;
struct V_1 * V_45 = V_64 -> V_45 ;
if ( V_40 != V_48 )
return V_65 ;
if ( V_2 -> V_56 != V_57 )
return V_65 ;
if ( F_22 ( V_64 -> V_183 == V_64 -> V_186 ) ) {
* V_51 = - V_50 ;
return V_53 ;
}
V_2 -> V_38 &= ~ V_101 ;
V_45 -> V_61 [ V_64 -> V_183 ++ ] = V_2 -> V_38 ;
return V_65 ;
}
...
if ( V_45 -> V_56 == V_57 )
return 0 ;
V_186 = F_99 ( V_37 , & V_37 [ V_45 -> V_56 ] ) ;
V_186 += F_99 ( V_37 , & V_37 [ V_45 -> V_58 ] ) ;
V_45 -> V_61 = F_41 ( V_186 , sizeof( * V_45 -> V_61 ) , V_75 ) ;
if ( ! V_45 -> V_61 )
return - V_76 ;
V_45 -> V_16 = V_186 ;
V_47 . V_186 = V_186 ;
...
V_2 = F_92 ( V_70 , V_104 , V_166 -> V_17 , V_174 , V_175 ) ;
if ( ! V_2 ) {
V_51 = - V_50 ;
goto V_189;
}
...
if ( F_113 ( V_85 ) )
continue;
V_195 = F_51 ( sizeof( * V_195 ) , V_75 ) ;
if ( ! V_195 )
goto V_197;
F_88 ( & V_195 -> V_164 , & V_194 ) ;
V_195 -> V_67 = F_50 () ;
if ( ! V_195 -> V_67 )
goto V_197;
V_67 = V_195 -> V_67 ;
...
static int F_118 ( char * V_199 , bool V_200 ,
struct V_69 * * V_201 ,
struct V_66 * * V_202 )
{
struct V_66 * V_67 ;
...
struct V_69 * V_70 = NULL ;
int V_51 ;
V_51 = F_118 ( V_199 , V_200 , & V_70 , & V_67 ) ;
if ( ! V_51 ) {
...
struct V_66 * * V_202 )
{
return F_120 ( V_104 , V_199 , V_200 , V_202 ) ;
}
static int F_122 ( struct V_107 * V_108 ,
struct V_109 * V_110 ,
char * V_199 , struct V_66 * * V_202 )
{
struct V_66 * V_67 = NULL ;
struct V_69 * V_70 = NULL ;
int V_51 ;
V_51 = F_118 ( V_199 , true , & V_70 , & V_67 ) ;
if ( ! V_51 ) {
V_51 = F_114 ( V_108 , V_110 , V_70 , V_199 ) ;
if ( ! V_51 ) {
F_25 ( V_67 -> V_74 ) ;
V_67 -> V_74 = NULL ;
} else {
...
char * V_74 )
{
struct V_91 * system = V_108 -> V_204 ;
...
static char * *
F_127 ( char * V_79 , int V_11 , int * V_183 )
{
char * V_25 , * * V_209 ;
...
return NULL ;
F_129 ( V_25 , ',' , ' ' ) ;
V_209 = F_130 ( V_75 , V_25 , V_183 ) ;
F_25 ( V_25 ) ;
return V_209 ;
}
static int F_131 ( struct V_210 * V_61 , int V_67 ,
int V_211 , char * V_209 , int V_11 )
{
int V_52 ;
if ( V_67 )
V_52 = F_132 ( V_61 , V_209 , V_11 , V_211 ) ;
else
V_52 = F_133 ( V_61 , V_209 , V_11 , V_211 ) ;
return V_52 ;
}
static int F_134 ( int V_67 , char * V_79 , int V_11 ,
struct V_212 * V_47 )
{
int V_32 , V_213 , V_52 = - V_50 ;
int * V_211 ;
char * * V_209 ;
V_211 = V_67 ? & V_47 -> V_214 : & V_47 -> V_215 ;
V_209 = F_127 ( V_79 , V_11 , & V_213 ) ;
if ( ! V_209 )
return - V_50 ;
for ( V_32 = 0 ; V_32 < V_213 ; V_32 ++ ) {
V_52 = F_131 ( V_47 -> V_61 , V_67 , * V_211 ,
V_209 [ V_32 ] , strlen ( V_209 [ V_32 ] ) ) ;
if ( V_52 )
break;
if ( * V_211 )
* V_211 = 0 ;
...
static int F_136 ( struct V_1 * V_2 , int V_216 )
{
...
static int F_138 ( struct V_208 * V_3 ,
struct V_66 * V_67 )
{
struct V_212 V_47 = {
. V_214 = 1 ,
...
int F_139 ( struct V_208 * V_3 , int V_217 ,
char * V_199 )
{
int V_51 ;
struct V_66 * V_67 ;
...
if ( V_3 -> V_67 )
goto V_207;
V_51 = F_120 ( V_104 , V_199 , false , & V_67 ) ;
if ( V_51 )
goto V_220;
if ( F_140 ( V_104 ) )
V_51 = F_138 ( V_3 , V_67 ) ;
...
int V_32 ;
F_142 ( V_222 L_12 ) ;
for ( V_32 = 0 ; V_32 < V_224 ; V_32 ++ ) {
struct V_66 * V_67 = NULL ;
struct V_225 * V_64 = & V_226 [ V_32 ] ;
int V_51 ;
V_51 = F_120 ( & V_227 , V_64 -> V_67 ,
false , & V_67 ) ;
if ( V_51 ) {
F_142 ( V_222
L_13 ,
