...
if ( V_51 == NULL )
V_38 = - V_76 ;
else if ( V_64 -> V_77 == V_78 )
V_38 = V_51 -> V_79 ( V_11 , V_64 ) ;
else if ( V_64 -> V_77 == V_80 && V_51 -> V_81 )
V_38 = V_51 -> V_81 ( V_11 , V_64 ) ;
else
V_38 = - V_82 ;
F_29 ( & V_56 ) ;
return V_38 ;
...
static int F_51 ( struct V_88 * V_88 , int V_53 )
{
switch ( V_53 ) {
case V_89 :
case V_90 :
...
int F_52 ( struct V_1 * V_2 , int V_38 )
{
if ( ! F_53 ( F_4 ( V_2 ) -> V_94 , V_95 ) )
return - V_96 ;
if ( ! V_2 -> V_97 -> V_98 )
return - V_82 ;
return V_2 -> V_97 -> V_98 ( V_2 , V_38 ) ;
}
static int T_4 F_54 ( struct V_88 * V_88 )
{
struct V_99 V_100 = {
. V_101 = V_102 ,
. V_103 = F_49 ,
...
V_88 -> V_60 = F_55 ( V_88 , V_75 , & V_100 ) ;
return V_88 -> V_60 == NULL ? - V_107 : 0 ;
}
static void T_5 F_56 ( struct V_88 * V_88 )
{
F_57 ( V_88 -> V_60 ) ;
V_88 -> V_60 = NULL ;
}
