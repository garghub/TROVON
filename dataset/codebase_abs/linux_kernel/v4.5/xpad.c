...
int V_155 ;
int V_65 , error ;
for ( V_65 = 0 ; V_156 [ V_65 ] . V_157 ; V_65 ++ ) {
if ( ( F_86 ( V_84 -> V_158 . V_157 ) == V_156 [ V_65 ] . V_157 ) &&
( F_86 ( V_84 -> V_158 . V_159 ) == V_156 [ V_65 ] . V_159 ) )
break;
}
if ( V_156 [ V_65 ] . V_37 == V_60 &&
V_51 -> V_91 -> V_93 . V_160 != 0 ) {
return - V_161 ;
}
...
V_2 -> V_84 = V_84 ;
V_2 -> V_51 = V_51 ;
V_2 -> V_7 = V_156 [ V_65 ] . V_7 ;
V_2 -> V_37 = V_156 [ V_65 ] . V_37 ;
V_2 -> V_126 = V_156 [ V_65 ] . V_126 ;
F_89 ( & V_2 -> V_43 , F_7 ) ;
if ( V_2 -> V_37 == V_83 ) {
...
static int F_94 ( struct V_79 * V_51 , T_2 V_174 )
{
struct V_1 * V_2 = F_93 ( V_51 ) ;
struct V_5 * V_175 = V_2 -> V_6 ;
if ( V_2 -> V_37 == V_38 ) {
F_69 ( V_2 ) ;
} else {
F_95 ( & V_175 -> V_176 ) ;
