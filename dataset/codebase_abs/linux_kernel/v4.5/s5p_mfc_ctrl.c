...
int F_38 ( struct V_1 * V_2 , struct V_69 * V_70 )
{
int V_54 = 0 ;
...
V_77:
if ( V_70 -> type == V_72 )
F_31 ( V_2 -> V_63 , V_79 , V_70 ) ;
V_74:
F_31 ( V_2 -> V_63 , V_80 , V_70 ) ;
V_20:
return V_54 ;
}
void F_41 ( struct V_1 * V_2 , struct V_69 * V_70 )
{
V_70 -> V_81 = V_82 ;
F_39 ( V_70 ) ;
F_31 ( V_2 -> V_63 , V_75 , V_2 ) ;
