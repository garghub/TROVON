...
return V_182 ;
if ( ! ( V_182 = F_124 ( V_3 , V_487 , & V_485 ) ) )
V_182 = F_150 ( V_3 , V_487 , V_485 ) ;
return V_182 != - V_119 ? V_182 : 0 ;
}
int F_176 ( struct V_2 * V_3 , enum V_488 V_489 ,
bool V_490 )
{
...
if ( V_491 )
F_178 ( 10 ) ;
V_174 -> V_25 . V_485 &= ~ V_494 ;
return F_150 ( V_3 , V_487 , V_494 ) ;
}
int F_179 ( struct V_2 * V_3 , unsigned long V_464 )
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_173 * V_174 = & V_3 -> V_175 ;
const unsigned long * V_495 = F_180 ( V_174 ) ;
int V_182 ;
if ( V_174 -> V_25 . V_496 & V_497 )
return 0 ;
if ( V_5 -> V_42 & V_449 ) {
V_182 = F_175 ( V_3 , V_495 , V_464 ) ;
...
if ( F_181 ( V_3 ) )
V_174 -> V_25 . V_496 &= ~ V_498 ;
return 0 ;
}
int F_182 ( struct V_2 * V_3 , const unsigned long * V_495 ,
unsigned long V_464 ,
bool * V_499 , int (* F_166)( struct V_2 * ) )
{
T_1 V_386 ;
int V_182 ;
F_30 ( L_131 ) ;
...
V_500 = F_167 ( V_466 ,
V_501 ) ;
if ( F_168 ( V_500 , V_464 ) )
V_500 = V_464 ;
F_165 ( V_3 , V_500 , F_166 ) ;
}
V_182 = - V_283 ;
goto V_460;
}
...
unsigned long V_464 )
{
const unsigned long * V_495 = F_180 ( & V_3 -> V_175 ) ;
bool V_499 ;
int V_182 ;
V_182 = F_182 ( V_3 , V_495 , V_464 , & V_499 , NULL ) ;
return V_499 ? - V_283 : V_182 ;
}
void F_187 ( struct V_2 * V_3 , unsigned int * V_374 )
{
T_1 V_485 ;
F_30 ( L_131 ) ;
if ( ! F_124 ( V_3 , V_487 , & V_485 ) )
F_150 ( V_3 , V_487 , V_485 ) ;
F_141 ( V_3 ) ;
F_30 ( L_134 ) ;
}
static int F_188 ( struct V_14 * V_15 , unsigned int V_502 ,
const T_4 * V_503 )
{
const T_4 * V_504 = V_15 -> V_144 ;
unsigned char V_505 [ 2 ] [ V_315 + 1 ] ;
unsigned char V_506 [ 2 ] [ V_507 + 1 ] ;
if ( V_15 -> V_183 != V_502 ) {
F_57 ( V_15 , L_135 ,
V_15 -> V_183 , V_502 ) ;
return 0 ;
}
F_41 ( V_504 , V_505 [ 0 ] , V_329 , sizeof( V_505 [ 0 ] ) ) ;
F_41 ( V_503 , V_505 [ 1 ] , V_329 , sizeof( V_505 [ 1 ] ) ) ;
F_41 ( V_504 , V_506 [ 0 ] , V_508 , sizeof( V_506 [ 0 ] ) ) ;
F_41 ( V_503 , V_506 [ 1 ] , V_508 , sizeof( V_506 [ 1 ] ) ) ;
if ( strcmp ( V_505 [ 0 ] , V_505 [ 1 ] ) ) {
F_57 ( V_15 , L_136 ,
V_505 [ 0 ] , V_505 [ 1 ] ) ;
return 0 ;
}
if ( strcmp ( V_506 [ 0 ] , V_506 [ 1 ] ) ) {
F_57 ( V_15 , L_137 ,
V_506 [ 0 ] , V_506 [ 1 ] ) ;
return 0 ;
}
...
int F_58 ( struct V_14 * V_15 , unsigned int V_509 )
{
unsigned int V_183 = V_15 -> V_183 ;
T_4 * V_144 = ( void * ) V_15 -> V_3 -> V_5 -> V_303 ;
int V_182 ;
V_182 = F_91 ( V_15 , & V_183 , V_509 , V_144 ) ;
if ( V_182 )
return V_182 ;
...
int F_161 ( struct V_14 * V_15 , unsigned int V_502 ,
unsigned int V_509 )
{
...
F_41 ( V_15 -> V_144 , V_511 , V_328 , sizeof( V_511 ) ) ;
while ( V_513 -> V_510 ) {
if ( F_190 ( V_513 -> V_510 , V_510 ) ) {
if ( V_513 -> V_511 == NULL )
return V_513 -> V_48 ;
if ( F_190 ( V_513 -> V_511 , V_511 ) )
return V_513 -> V_48 ;
}
V_513 ++ ;
}
...
V_47 &= F_89 ( V_15 ) ;
if ( V_5 -> V_215 -> V_520 )
V_47 = V_5 -> V_215 -> V_520 ( V_15 , V_47 ) ;
if ( V_47 & ( 0xF8 << V_125 ) )
if ( F_195 ( V_5 ) ) {
F_24 ( V_15 ,
L_147 ) ;
...
unsigned int F_97 ( struct V_14 * V_15 , T_2 V_523 , T_2 V_72 )
{
struct V_67 V_68 ;
unsigned int V_159 ;
F_30 ( L_150 ) ;
...
int V_526 = V_195 -> V_200 ;
F_198 ( V_230 == NULL ) ;
F_199 ( L_152 , V_195 -> V_203 ) ;
if ( V_195 -> V_203 )
F_200 ( V_5 -> V_15 , V_230 , V_195 -> V_527 , V_526 ) ;
V_195 -> V_42 &= ~ V_528 ;
V_195 -> V_230 = NULL ;
}
...
{
struct V_4 * V_5 = V_195 -> V_5 ;
if ( ! ( V_195 -> V_15 -> V_48 & V_529 ) &&
F_5 ( V_195 -> V_232 & 15 ) )
return 1 ;
if ( V_5 -> V_215 -> V_530 )
return V_5 -> V_215 -> V_530 ( V_195 ) ;
return 0 ;
}
...
return - 1 ;
F_30 ( L_154 , V_203 ) ;
V_195 -> V_527 = V_195 -> V_203 ;
V_195 -> V_203 = V_203 ;
V_195 -> V_42 |= V_528 ;
return 0 ;
}
void F_95 ( T_4 * V_243 , unsigned int V_533 )
{
#ifdef F_207
unsigned int V_25 ;
...
case V_521 :
if ( V_195 -> V_68 . V_72 != V_542 &&
V_195 -> V_68 . V_72 != V_543 )
break;
case V_525 :
case V_544 :
...
while ( V_551 ) {
struct V_194 * V_195 ;
unsigned int V_108 = F_225 ( V_551 ) ;
...
V_195 -> V_42 |= V_235 ;
V_5 -> V_220 |= 1 << V_195 -> V_108 ;
if ( F_198 ( F_228 ( V_552 ) &&
( ! V_195 -> V_230 || ! V_195 -> V_203 || ! V_195 -> V_232 ) ) )
goto V_553;
if ( F_229 ( V_552 ) || ( F_216 ( V_552 ) &&
( V_5 -> V_42 & V_554 ) ) )
if ( F_205 ( V_195 ) )
goto V_553;
if ( F_5 ( V_195 -> V_15 -> V_42 & V_548 ) ) {
V_3 -> V_541 . V_496 |= V_555 ;
F_230 ( & V_3 -> V_541 , L_156 ) ;
F_231 ( V_3 ) ;
return;
}
V_5 -> V_215 -> V_556 ( V_195 ) ;
F_232 ( V_195 ) ;
V_195 -> V_159 |= V_5 -> V_215 -> V_557 ( V_195 ) ;
if ( F_5 ( V_195 -> V_159 ) )
goto V_558;
return;
V_553:
...
{
struct V_4 * V_5 = V_3 -> V_5 ;
return ( V_5 -> V_42 & V_449 ) && V_5 -> V_215 -> V_559 ;
}
int F_124 ( struct V_2 * V_3 , int V_560 , T_1 * V_561 )
{
if ( F_13 ( V_3 ) ) {
if ( F_101 ( V_3 ) )
return V_3 -> V_5 -> V_215 -> V_559 ( V_3 , V_560 , V_561 ) ;
return - V_393 ;
}
return F_233 ( V_3 , V_560 , V_561 ) ;
}
int F_150 ( struct V_2 * V_3 , int V_560 , T_1 V_561 )
{
if ( F_13 ( V_3 ) ) {
if ( F_101 ( V_3 ) )
return V_3 -> V_5 -> V_215 -> V_562 ( V_3 , V_560 , V_561 ) ;
return - V_393 ;
}
return F_234 ( V_3 , V_560 , V_561 ) ;
}
int F_183 ( struct V_2 * V_3 , int V_560 , T_1 V_561 )
{
if ( F_13 ( V_3 ) ) {
int V_182 ;
if ( F_101 ( V_3 ) ) {
V_182 = V_3 -> V_5 -> V_215 -> V_562 ( V_3 , V_560 , V_561 ) ;
if ( V_182 == 0 )
V_182 = V_3 -> V_5 -> V_215 -> V_559 ( V_3 , V_560 , & V_561 ) ;
return V_182 ;
}
return - V_393 ;
}
...
unsigned int V_496 , unsigned int V_565 ,
bool V_566 )
{
struct V_2 * V_3 ;
unsigned long V_42 ;
if ( V_5 -> V_212 & V_567 ) {
F_236 ( V_5 ) ;
F_85 ( V_5 -> V_212 & V_567 ) ;
}
F_67 ( V_5 -> V_211 , V_42 ) ;
V_5 -> V_568 = V_564 ;
V_5 -> V_212 |= V_567 ;
F_196 (link, ap, HOST_FIRST) {
V_3 -> V_541 . V_496 |= V_496 ;
...
static void F_237 ( struct V_4 * V_5 , T_6 V_564 )
{
F_235 ( V_5 , V_564 , 0 , V_569 , false ) ;
}
static void F_238 ( struct V_4 * V_5 , T_6 V_564 )
{
F_235 ( V_5 , V_564 , 0 , V_569 , true ) ;
}
...
{
F_237 ( F_240 ( V_15 ) , V_572 ) ;
return 0 ;
}
static void F_244 ( struct V_4 * V_5 , T_6 V_564 )
{
F_235 ( V_5 , V_564 , V_555 , V_573 , false ) ;
}
static void F_245 ( struct V_4 * V_5 , T_6 V_564 )
{
F_235 ( V_5 , V_564 , V_555 , V_573 , true ) ;
}
static int F_246 ( struct V_21 * V_15 )
{
F_245 ( F_240 ( V_15 ) , V_574 ) ;
F_247 ( V_15 ) ;
F_248 ( V_15 ) ;
F_249 ( V_15 ) ;
return 0 ;
...
{
F_237 ( F_240 ( V_15 ) , V_575 ) ;
return 0 ;
}
static int F_253 ( struct V_21 * V_15 )
{
F_244 ( F_240 ( V_15 ) , V_576 ) ;
return 0 ;
}
...
int F_256 ( struct V_519 * V_273 , T_6 V_564 )
{
V_273 -> V_15 -> V_577 . V_578 = V_564 ;
return 0 ;
}
void F_257 ( struct V_519 * V_273 )
{
...
T_2 V_136 ;
int V_182 ;
V_182 = F_124 ( V_3 , V_389 , & V_3 -> V_587 ) ;
if ( V_182 )
return V_182 ;
...
struct V_4 * F_262 ( struct V_519 * V_273 )
{
struct V_4 * V_5 ;
F_30 ( L_131 ) ;
V_5 = F_263 ( sizeof( * V_5 ) , V_588 ) ;
if ( ! V_5 )
return NULL ;
V_5 -> V_212 |= V_589 | V_213 ;
...
#endif
F_265 ( & V_5 -> V_599 ) ;
F_266 ( & V_5 -> V_600 , V_601 ) ;
F_267 ( & V_5 -> V_602 , V_603 ) ;
F_268 ( & V_5 -> V_604 ) ;
F_269 ( & V_5 -> V_605 ) ;
F_270 ( & V_5 -> V_606 ) ;
F_271 ( & V_5 -> V_607 ) ;
...
static void F_274 ( struct V_21 * V_614 , void * V_615 )
{
struct V_519 * V_273 = F_275 ( V_614 ) ;
int V_25 ;
...
struct V_519 * F_279 ( struct V_21 * V_15 , int V_618 )
{
struct V_519 * V_273 ;
T_5 V_619 ;
int V_25 ;
F_30 ( L_131 ) ;
if ( ! F_280 ( V_15 , NULL , V_588 ) )
return NULL ;
V_619 = sizeof( struct V_519 ) + ( V_618 + 1 ) * sizeof( void * ) ;
V_273 = F_281 ( F_274 , V_619 , V_588 ) ;
if ( ! V_273 )
goto V_264;
F_282 ( V_15 , V_273 ) ;
F_278 ( V_15 , V_273 ) ;
...
struct V_519 * F_286 ( struct V_21 * V_15 ,
...
V_5 -> V_215 = V_624 -> V_626 ;
if ( ! V_273 -> V_215 && ( V_624 -> V_626 != & V_627 ) )
V_273 -> V_215 = V_624 -> V_626 ;
}
return V_273 ;
}
...
static void F_288 ( struct V_21 * V_614 , void * V_615 )
{
struct V_519 * V_273 = F_275 ( V_614 ) ;
int V_25 ;
F_85 ( ! ( V_273 -> V_42 & V_630 ) ) ;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_617 [ V_25 ] ;
if ( V_5 -> V_215 -> V_631 )
V_5 -> V_215 -> V_631 ( V_5 ) ;
}
if ( V_273 -> V_215 -> V_632 )
V_273 -> V_215 -> V_632 ( V_273 ) ;
}
static void F_289 ( struct V_633 * V_215 )
{
static F_290 ( V_211 ) ;
const struct V_633 * V_482 ;
void * * V_634 = ( void * * ) V_215 ;
void * * V_635 = ( void * * ) & V_215 -> V_636 ;
void * * V_637 ;
if ( ! V_215 || ! V_215 -> V_636 )
return;
F_291 ( & V_211 ) ;
for ( V_482 = V_215 -> V_636 ; V_482 ; V_482 = V_482 -> V_636 ) {
void * * V_638 = ( void * * ) V_482 ;
...
void F_299 ( struct V_519 * V_273 , struct V_21 * V_15 ,
struct V_633 * V_215 )
{
F_283 ( & V_273 -> V_211 ) ;
F_265 ( & V_273 -> V_620 ) ;
...
static void F_302 ( void * V_610 , T_7 V_648 )
{
struct V_4 * V_5 = V_610 ;
if ( ! ( V_5 -> V_273 -> V_42 & V_469 ) && V_5 -> V_621 != 0 )
F_303 ( V_648 ) ;
( void ) F_301 ( V_5 ) ;
F_303 ( V_648 ) ;
F_304 ( V_5 , 1 ) ;
}
int F_305 ( struct V_519 * V_273 , struct V_649 * V_650 )
{
int V_25 , V_182 ;
V_273 -> V_642 = F_306 ( V_650 -> V_294 , 1 , V_295 - 1 ) ;
if ( ! ( V_273 -> V_42 & V_630 ) ) {
...
F_277 ( V_273 -> V_617 [ V_25 ] ) ;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ ) {
V_273 -> V_617 [ V_25 ] -> V_31 = F_307 ( & V_651 ) ;
V_273 -> V_617 [ V_25 ] -> V_590 = V_25 + 1 ;
}
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ ) {
V_182 = F_308 ( V_273 -> V_15 , V_273 -> V_617 [ V_25 ] ) ;
if ( V_182 ) {
goto V_652;
}
}
V_182 = F_309 ( V_273 , V_650 ) ;
if ( V_182 )
goto V_652;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_617 [ V_25 ] ;
...
V_652:
while ( -- V_25 >= 0 ) {
F_312 ( V_273 -> V_617 [ V_25 ] ) ;
}
return V_182 ;
}
int F_313 ( struct V_519 * V_273 , int V_653 ,
T_8 V_654 , unsigned long V_655 ,
struct V_649 * V_650 )
{
int V_25 , V_182 ;
char * V_656 ;
...
if ( ! V_653 ) {
F_85 ( V_654 ) ;
return F_305 ( V_273 , V_650 ) ;
}
V_656 = F_314 ( V_273 -> V_15 , V_588 , L_163 ,
F_315 ( V_273 -> V_15 ) ,
F_316 ( V_273 -> V_15 ) ) ;
if ( ! V_656 )
return - V_629 ;
V_182 = F_317 ( V_273 -> V_15 , V_653 , V_654 , V_655 ,
V_656 , V_273 ) ;
if ( V_182 )
return V_182 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ )
F_318 ( V_273 -> V_617 [ V_25 ] , L_164 , V_653 ) ;
V_182 = F_305 ( V_273 , V_650 ) ;
if ( V_182 )
F_319 ( V_273 -> V_15 , V_653 , V_273 ) ;
return V_182 ;
}
...
void F_325 ( struct V_519 * V_273 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_616 ; V_25 ++ )
F_320 ( V_273 -> V_617 [ V_25 ] ) ;
F_326 ( V_273 ) ;
}
void F_327 ( struct V_661 * V_662 )
{
struct V_519 * V_273 = F_328 ( V_662 ) ;
F_325 ( V_273 ) ;
}
int F_329 ( struct V_661 * V_662 , const struct V_663 * V_132 )
{
unsigned long V_387 = 0 ;
switch ( V_132 -> V_664 ) {
case 1 : {
T_2 V_665 = 0 ;
F_330 ( V_662 , V_132 -> V_560 , & V_665 ) ;
V_387 = V_665 ;
break;
}
case 2 : {
T_4 V_666 = 0 ;
F_331 ( V_662 , V_132 -> V_560 , & V_666 ) ;
V_387 = V_666 ;
break;
}
case 4 : {
T_1 V_667 = 0 ;
F_332 ( V_662 , V_132 -> V_560 , & V_667 ) ;
V_387 = V_667 ;
break;
}
default:
...
V_387 &= V_132 -> V_391 ;
return ( V_387 == V_132 -> V_561 ) ? 1 : 0 ;
}
void F_333 ( struct V_661 * V_662 , T_6 V_564 )
{
F_334 ( V_662 ) ;
F_335 ( V_662 ) ;
if ( V_564 . V_668 & V_669 )
F_336 ( V_662 , V_670 ) ;
}
int F_337 ( struct V_661 * V_662 )
{
int V_182 ;
F_336 ( V_662 , V_671 ) ;
F_338 ( V_662 ) ;
...
int F_341 ( struct V_661 * V_662 , T_6 V_564 )
{
struct V_519 * V_273 = F_328 ( V_662 ) ;
int V_182 = 0 ;
V_182 = F_256 ( V_273 , V_564 ) ;
if ( V_182 )
return V_182 ;
F_333 ( V_662 , V_564 ) ;
return 0 ;
}
int F_342 ( struct V_661 * V_662 )
{
struct V_519 * V_273 = F_328 ( V_662 ) ;
int V_182 ;
V_182 = F_337 ( V_662 ) ;
...
int F_343 ( struct V_672 * V_662 )
{
struct V_519 * V_273 = F_344 ( V_662 ) ;
F_325 ( V_273 ) ;
return 0 ;
}
static int T_9 F_345 ( char * * V_482 ,
struct V_27 * V_673 ,
const char * * V_255 )
{
static const struct V_674 V_675 [] V_676 = {
{ L_166 , . V_33 = V_370 } ,
{ L_167 , . V_33 = V_371 } ,
{ L_168 , . V_33 = V_518 } ,
{ L_169 , . V_33 = V_372 } ,
...
{ L_177 , . V_50 = V_308 } ,
{ L_178 , . V_49 = V_270 } ,
{ L_179 , . V_47 = 1 << ( V_121 + 0 ) } ,
{ L_180 , . V_47 = 1 << ( V_121 + 1 ) } ,
{ L_181 , . V_47 = 1 << ( V_121 + 2 ) } ,
{ L_182 , . V_47 = 1 << ( V_121 + 3 ) } ,
{ L_183 , . V_47 = 1 << ( V_121 + 4 ) } ,
{ L_184 , . V_47 = 1 << ( V_121 + 5 ) } ,
{ L_185 , . V_47 = 1 << ( V_121 + 6 ) } ,
{ L_186 , . V_47 = 1 << ( V_123 + 0 ) } ,
{ L_187 , . V_47 = 1 << ( V_123 + 1 ) } ,
{ L_188 , . V_47 = 1 << ( V_123 + 2 ) } ,
{ L_189 , . V_47 = 1 << ( V_123 + 3 ) } ,
{ L_190 , . V_47 = 1 << ( V_123 + 4 ) } ,
{ L_191 , . V_47 = 1 << ( V_125 + 0 ) } ,
{ L_192 , . V_47 = 1 << ( V_125 + 0 ) } ,
{ L_193 , . V_47 = 1 << ( V_125 + 0 ) } ,
{ L_194 , . V_47 = 1 << ( V_125 + 1 ) } ,
{ L_195 , . V_47 = 1 << ( V_125 + 1 ) } ,
{ L_196 , . V_47 = 1 << ( V_125 + 1 ) } ,
{ L_197 , . V_47 = 1 << ( V_125 + 2 ) } ,
{ L_198 , . V_47 = 1 << ( V_125 + 2 ) } ,
{ L_199 , . V_47 = 1 << ( V_125 + 2 ) } ,
{ L_200 , . V_47 = 1 << ( V_125 + 3 ) } ,
{ L_201 , . V_47 = 1 << ( V_125 + 3 ) } ,
{ L_202 , . V_47 = 1 << ( V_125 + 3 ) } ,
{ L_203 , . V_47 = 1 << ( V_125 + 4 ) } ,
{ L_204 , . V_47 = 1 << ( V_125 + 4 ) } ,
{ L_205 , . V_47 = 1 << ( V_125 + 4 ) } ,
{ L_206 , . V_47 = 1 << ( V_125 + 5 ) } ,
{ L_207 , . V_47 = 1 << ( V_125 + 5 ) } ,
{ L_208 , . V_47 = 1 << ( V_125 + 5 ) } ,
{ L_209 , . V_47 = 1 << ( V_125 + 6 ) } ,
{ L_210 , . V_47 = 1 << ( V_125 + 6 ) } ,
{ L_211 , . V_47 = 1 << ( V_125 + 6 ) } ,
{ L_212 , . V_47 = 1 << ( V_125 + 7 ) } ,
{ L_213 , . V_41 = V_677 } ,
{ L_214 , . V_41 = V_678 } ,
{ L_215 , . V_41 = V_677 | V_678 } ,
{ L_216 , . V_41 = V_679 } ,
{ L_217 , . V_49 = V_356 } ,
{ L_218 , . V_49 = V_316 } ,
} ;
char * V_465 = * V_482 , * V_149 = * V_482 ;
char * V_144 , * V_561 , * V_680 ;
...
if ( V_149 ) {
* V_149 ++ = '\0' ;
V_673 -> V_21 = F_347 ( V_149 , & V_680 , 10 ) ;
if ( V_149 == V_680 || * V_680 != '\0' ) {
* V_255 = L_219 ;
return - V_119 ;
}
}
V_673 -> V_30 = F_347 ( V_144 , & V_680 , 10 ) ;
if ( V_149 == V_680 || * V_680 != '\0' ) {
* V_255 = L_220 ;
return - V_119 ;
}
...
if ( strncasecmp ( V_561 , V_684 -> V_35 , strlen ( V_561 ) ) )
continue;
V_682 ++ ;
V_681 = V_684 ;
if ( strcasecmp ( V_561 , V_684 -> V_35 ) == 0 ) {
V_682 = 1 ;
break;
}
}
...
if ( * V_149 == ',' )
V_686 ++ ;
V_29 = F_263 ( sizeof( V_29 [ 0 ] ) * V_686 , V_588 ) ;
if ( ! V_29 ) {
F_349 ( V_690 L_223
L_224 ) ;
return;
...
F_349 ( V_271 L_227 V_693 L_228 ) ;
return 0 ;
V_264:
return V_182 ;
}
static void T_10 F_355 ( void )
{
F_356 ( V_692 ) ;
F_357 () ;
F_354 () ;
...
void F_172 ( struct V_4 * V_5 , unsigned int V_695 )
{
bool V_696 = V_5 && V_5 -> V_273 -> V_697 == V_698 ;
if ( V_696 )
F_75 ( V_5 ) ;
if ( V_695 < 20 ) {
unsigned long V_699 = V_695 * V_700 ;
F_360 ( V_699 , V_699 + 50 ) ;
} else {
F_178 ( V_695 ) ;
}
if ( V_696 )
...
T_1 F_361 ( struct V_4 * V_5 , void T_11 * V_560 , T_1 V_391 , T_1 V_561 ,
...
while ( ( V_387 & V_391 ) == V_561 && F_171 ( V_466 , V_464 ) ) {
F_172 ( V_5 , V_478 ) ;
V_387 = F_362 ( V_560 ) ;
}
return V_387 ;
...
void F_366 ( const struct V_4 * V_5 , const char * V_706 ,
const char * V_707 , ... )
{
struct V_708 V_709 ;
T_12 args ;
...
V_709 . V_707 = V_707 ;
V_709 . V_710 = & args ;
F_349 ( L_229 , V_706 , V_5 -> V_31 , & V_709 ) ;
va_end ( args ) ;
}
void F_367 ( const struct V_2 * V_3 , const char * V_706 ,
const char * V_707 , ... )
{
struct V_708 V_709 ;
T_12 args ;
...
F_349 ( L_230 ,
V_706 , V_3 -> V_5 -> V_31 , V_3 -> V_38 , & V_709 ) ;
else
F_349 ( L_229 ,
V_706 , V_3 -> V_5 -> V_31 , & V_709 ) ;
va_end ( args ) ;
}
void F_368 ( const struct V_14 * V_15 , const char * V_706 ,
const char * V_707 , ... )
{
struct V_708 V_709 ;
T_12 args ;
...
V_709 . V_710 = & args ;
F_349 ( L_230 ,
V_706 , V_15 -> V_3 -> V_5 -> V_31 , V_15 -> V_3 -> V_38 + V_15 -> V_24 ,
& V_709 ) ;
va_end ( args ) ;
}
void F_369 ( const struct V_21 * V_15 , const char * V_711 )
{
F_370 ( V_271 , V_15 , L_231 , V_711 ) ;
}
