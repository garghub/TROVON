...
const struct V_27 * V_28 )
{
const struct V_54 * V_30 = F_8 ( V_24 ) ;
struct V_2 * V_3 = V_28 -> V_3 ;
const T_1 * V_55 = & V_26 -> V_7 [ V_30 -> V_56 ] ;
int V_4 , V_57 ;
T_3 V_58 , V_59 ;
T_4 V_60 ;
switch ( V_30 -> V_34 ) {
...
( V_30 -> V_34 != V_38 ||
V_3 -> V_63 != V_64 ) ) {
if ( F_4 ( V_3 , V_57 , & V_60 , sizeof( V_60 ) ) < 0 )
goto V_36;
V_58 = F_23 ( V_3 , V_4 , V_30 -> V_5 , 0 ) ;
V_59 = F_24 ( V_55 , V_30 -> V_5 , 0 ) ;
V_60 = F_25 ( F_26 ( F_27 ( ~ F_28 ( V_60 ) , V_58 ) ,
V_59 ) ) ;
if ( V_60 == 0 )
V_60 = V_65 ;
if ( ! F_29 ( V_3 , V_57 + sizeof( V_60 ) ) ||
F_30 ( V_3 , V_57 , & V_60 , sizeof( V_60 ) ) < 0 )
goto V_36;
}
if ( ! F_29 ( V_3 , F_31 ( V_4 + V_30 -> V_5 , 0 ) ) ||
F_30 ( V_3 , V_4 , V_55 , V_30 -> V_5 ) < 0 )
goto V_36;
return;
V_36:
V_26 -> V_41 . V_42 = V_43 ;
...
const struct V_46 * const V_47 [] )
{
struct V_54 * V_30 = F_8 ( V_24 ) ;
V_30 -> V_34 = F_14 ( F_15 ( V_47 [ V_48 ] ) ) ;
V_30 -> V_4 = F_14 ( F_15 ( V_47 [ V_49 ] ) ) ;
V_30 -> V_5 = F_14 ( F_15 ( V_47 [ V_50 ] ) ) ;
V_30 -> V_56 = F_16 ( V_47 [ V_66 ] ) ;
if ( V_47 [ V_67 ] )
V_30 -> V_61 =
F_14 ( F_15 ( V_47 [ V_67 ] ) ) ;
if ( V_47 [ V_68 ] )
...
return F_33 ( V_30 -> V_56 , V_30 -> V_5 ) ;
}
static int F_34 ( struct V_2 * V_3 , const struct V_23 * V_24 )
{
const struct V_54 * V_30 = F_8 ( V_24 ) ;
if ( F_19 ( V_3 , V_66 , V_30 -> V_56 ) ||
F_20 ( V_3 , V_48 , F_21 ( V_30 -> V_34 ) ) ||
F_20 ( V_3 , V_49 , F_21 ( V_30 -> V_4 ) ) ||
F_20 ( V_3 , V_50 , F_21 ( V_30 -> V_5 ) ) ||
F_20 ( V_3 , V_67 , F_21 ( V_30 -> V_61 ) ) ||
F_20 ( V_3 , V_68 ,
F_21 ( V_30 -> V_57 ) ) )
goto V_53;
return 0 ;
