...
struct V_1 *
F_58 ( struct V_43 * V_44 , int V_85 )
{
struct V_8 * V_24 = F_37 ( V_11 ) ;
struct V_30 * V_83 ;
int V_13 ;
int V_86 = 0 ;
F_57 (tbl, node, i) {
...
{
struct V_8 * V_24 ;
static const T_2 V_127 [ V_58 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
struct V_1 * V_2 ;
struct V_30 * V_83 ;
...
static void F_91 ( struct V_121 * V_132 )
{
