...
F_6 ( V_2 -> V_67 -> V_68 ) ) ;
F_7 ( V_69 , V_2 , L_3 ,
F_6 ( V_2 -> V_67 -> V_68 ) , V_2 -> V_66 ) ;
return - V_71 ;
}
}
static void F_12 ( struct V_79 * V_67 ,
struct V_3 * V_80 ,
struct V_3 * V_59 )
{
