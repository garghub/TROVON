...
F_53 ( V_201 ) ;
F_54 ( V_201 -> V_202 , V_203 ) ;
ASSERT ( F_55 ( V_201 -> V_202 ) || V_201 -> V_204 == 0 ) ;
...
F_68 ( & V_199 -> V_216 ) ;
F_69 ( V_199 ) ;
F_54 ( V_201 -> V_202 , V_217 ) ;
F_54 ( V_201 -> V_202 , V_218 ) ;
F_70 ( V_201 ) ;
}
STATIC int
F_71 (
...
if ( error )
goto V_317;
V_10 -> V_318 . V_319 = F_126 ( struct V_320 ) ;
if ( ! V_10 -> V_318 . V_319 ) {
error = - V_24 ;
goto V_321;
}
error = F_127 ( V_10 , V_267 ) ;
if ( error )
goto V_322;
error = F_110 ( V_10 ) ;
if ( error )
...
goto V_323;
V_13 -> V_324 = V_237 ;
V_13 -> V_325 = V_10 -> V_141 . V_248 ;
V_13 -> V_326 = F_7 ( V_13 -> V_325 ) - 1 ;
V_13 -> V_327 = F_17 ( V_13 -> V_326 ) ;
V_13 -> V_328 = V_329 ;
V_13 -> V_330 = 1 ;
F_129 ( V_13 ) ;
if ( F_130 ( & V_10 -> V_141 ) == V_331 )
V_13 -> V_26 |= V_332 ;
if ( V_10 -> V_28 & V_109 ) {
F_6 ( V_10 ,
L_34 ) ;
...
L_35 ) ;
V_10 -> V_28 &= ~ V_109 ;
} else if ( ! V_13 -> V_172 -> V_334 -> V_335 -> V_336 ) {
F_131 ( V_10 ,
L_36 ) ;
V_10 -> V_28 &= ~ V_109 ;
}
...
if ( error )
goto V_337;
V_279 = F_134 ( F_61 ( V_10 -> V_338 ) ) ;
if ( ! V_279 ) {
error = - V_339 ;
goto V_340;
}
V_13 -> V_341 = F_135 ( V_279 ) ;
if ( ! V_13 -> V_341 ) {
error = - V_24 ;
goto V_340;
}
...
void * V_290 )
{
return F_143 ( V_343 , V_267 , V_344 , V_290 , F_121 ) ;
}
static long
F_144 (
struct V_12 * V_13 ,
...
struct V_345 * V_346 )
{
return F_147 ( F_76 ( V_13 ) , V_346 -> V_347 ) ;
}
STATIC int T_14
F_148 ( void )
{
V_348 = F_149 ( sizeof( V_349 ) , L_39 ) ;
if ( ! V_348 )
goto V_173;
V_350 = F_150 ( 4 * V_351 ,
V_348 ) ;
if ( ! V_350 )
goto V_352;
V_353 = F_149 ( sizeof( V_354 ) ,
L_40 ) ;
if ( ! V_353 )
goto V_355;
V_356 = F_149 ( sizeof( V_357 ) ,
L_41 ) ;
if ( ! V_356 )
goto V_358;
V_359 = F_149 ( sizeof( V_360 ) ,
L_42 ) ;
if ( ! V_359 )
goto V_361;
V_362 = F_149 ( sizeof( V_363 ) ,
L_43 ) ;
if ( ! V_362 )
goto V_364;
V_365 = F_149 ( sizeof( V_366 ) , L_44 ) ;
if ( ! V_365 )
goto V_367;
V_368 = F_149 ( sizeof( V_369 ) , L_45 ) ;
if ( ! V_368 )
goto V_370;
V_371 =
F_149 ( sizeof( struct V_372 ) ,
L_46 ) ;
if ( ! V_371 )
goto V_373;
V_374 = F_149 ( sizeof( struct V_375 ) ,
L_47 ) ;
if ( ! V_374 )
goto V_376;
V_377 = F_149 ( ( sizeof( V_378 ) +
( ( V_379 - 1 ) *
sizeof( V_380 ) ) ) , L_48 ) ;
if ( ! V_377 )
goto V_381;
V_382 = F_149 ( ( sizeof( V_383 ) +
( ( V_384 - 1 ) *
sizeof( V_380 ) ) ) , L_49 ) ;
if ( ! V_382 )
goto V_385;
V_386 =
F_151 ( sizeof( T_10 ) , L_50 ,
V_387 | V_388 | V_389 |
V_390 , F_59 ) ;
if ( ! V_386 )
goto V_391;
V_392 =
F_151 ( sizeof( V_393 ) , L_51 ,
V_389 , NULL ) ;
if ( ! V_392 )
goto V_394;
V_395 = F_149 ( sizeof( struct V_396 ) ,
L_52 ) ;
if ( ! V_395 )
goto V_397;
return 0 ;
...
{
int error ;
F_159 (KERN_INFO XFS_VERSION_STRING L_54
...
if ( error )
goto V_403;
V_300 = F_165 ( L_56 , NULL , V_404 ) ;
if ( ! V_300 ) {
error = - V_24 ;
goto V_405;
}
V_320 . V_406 . V_298 . V_299 = V_300 ;
V_320 . V_319 = F_126 ( struct V_320 ) ;
if ( ! V_320 . V_319 ) {
error = - V_24 ;
goto V_407;
}
error = F_166 ( & V_320 . V_406 , & V_408 , NULL ,
L_57 ) ;
if ( error )
goto V_322;
#ifdef F_167
V_409 . V_298 . V_299 = V_300 ;
error = F_166 ( & V_409 , & V_410 , NULL , L_58 ) ;
if ( error )
goto V_411;
#endif
error = F_168 () ;
