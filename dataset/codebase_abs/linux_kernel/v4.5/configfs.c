...
static void F_99 ( struct V_10 * V_32 )
{
struct V_105 * V_45 ;
...
if ( V_56 -> V_151 ) {
F_102 ( & V_32 -> V_26 . V_152 -> V_153 , L_13
L_14 , V_56 -> V_1 , V_56 ) ;
...
V_32 -> V_67 [ V_164 ] = NULL ;
V_15 = F_107 ( & V_32 -> V_26 , V_32 -> V_67 ,
V_170 ) ;
if ( F_32 ( V_15 ) ) {
V_7 = F_33 ( V_15 ) ;
goto V_165;
}
V_32 -> V_26 . V_27 . V_171 = V_15 [ V_167 ] . V_172 ;
V_32 -> V_26 . V_27 . V_173 = V_15 [ V_168 ] . V_172 ;
V_32 -> V_26 . V_27 . V_174 = V_15 [ V_169 ] . V_172 ;
}
if ( V_32 -> V_93 ) {
V_26 -> V_175 = true ;
V_26 -> V_95 = V_32 -> V_95 ;
memcpy ( V_26 -> V_96 , V_32 -> V_96 , V_97 ) ;
}
...
V_15 = F_107 ( & V_32 -> V_26 , V_44 -> V_67 , 1 ) ;
if ( F_32 ( V_15 ) ) {
V_7 = F_33 ( V_15 ) ;
goto V_165;
}
...
if ( ! V_32 )
return F_48 ( - V_21 ) ;
V_32 -> V_13 . V_83 = V_32 -> V_83 ;
V_32 -> V_13 . V_83 [ 0 ] = & V_32 -> V_75 ;
V_32 -> V_13 . V_83 [ 1 ] = & V_32 -> V_80 ;
V_32 -> V_13 . V_83 [ 2 ] = & V_32 -> V_84 ;
V_32 -> V_13 . V_83 [ 3 ] = & V_32 -> V_103 ;
F_59 ( & V_32 -> V_75 , L_17 ,
& V_183 ) ;
F_59 ( & V_32 -> V_80 , L_18 ,
& V_184 ) ;
...
& V_144 ) ;
V_32 -> V_30 . V_186 = F_98 ;
V_32 -> V_30 . V_151 = F_98 ;
...
V_32 -> V_26 . V_27 . V_25 = F_12 ( F_120 () ) ;
