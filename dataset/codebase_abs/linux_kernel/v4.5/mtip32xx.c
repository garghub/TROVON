...
static int F_105 ( struct V_4 * V_5 , unsigned int V_16 ,
unsigned long V_287 )
{
switch ( V_16 ) {
case V_288 :
...
static void F_107 ( struct V_4 * V_5 , struct V_13 * V_14 ,
struct V_12 * V_76 , int V_230 ,
struct V_18 * V_19 )
{
struct V_82 * V_83 ;
struct V_22 * V_23 = V_5 -> V_23 ;
int V_294 = F_108 ( V_14 ) == V_295 ? V_269 : V_268 ;
T_8 V_187 = F_109 ( V_14 ) ;
unsigned int V_262 = F_110 ( V_14 ) ;
V_230 = F_111 ( & V_5 -> V_2 -> V_10 , V_76 -> V_26 , V_230 , V_294 ) ;
F_112 ( & V_23 -> V_91 ) ;
V_76 -> V_27 = V_230 ;
V_76 -> V_106 = V_296 ;
V_83 = V_76 -> V_76 ;
...
static T_11 F_113 ( struct V_197 * V_10 ,
struct V_303 * V_304 ,
char * V_86 )
{
struct V_4 * V_5 = F_114 ( V_10 ) -> V_305 ;
int V_306 = 0 ;
...
static T_11 F_115 ( struct V_307 * V_308 , char * V_86 )
{
int V_306 = 0 ;
struct V_4 * V_5 , * V_44 ;
unsigned long V_91 ;
...
if ( ! V_174 || * V_315 )
return 0 ;
V_86 = F_121 ( V_316 , V_159 ) ;
if ( ! V_86 ) {
F_38 ( & V_5 -> V_2 -> V_10 ,
L_82 ) ;
return - V_219 ;
}
V_306 += F_115 ( NULL , V_86 ) ;
...
static T_11 F_122 ( struct V_312 * V_313 , char T_7 * V_314 ,
T_12 V_174 , T_13 * V_315 )
{
struct V_4 * V_5 = (struct V_4 * ) V_313 -> V_305 ;
char * V_86 ;
...
static T_11 F_123 ( struct V_312 * V_313 , char T_7 * V_314 ,
T_12 V_174 , T_13 * V_315 )
{
struct V_4 * V_5 = (struct V_4 * ) V_313 -> V_305 ;
char * V_86 ;
...
static int F_124 ( struct V_4 * V_5 , struct V_318 * V_319 )
{
if ( ! V_319 || ! V_5 )
return - V_205 ;
if ( F_125 ( V_319 , & V_320 . V_304 ) )
F_5 ( & V_5 -> V_2 -> V_10 ,
L_96 ) ;
return 0 ;
}
static int F_126 ( struct V_4 * V_5 , struct V_318 * V_319 )
{
if ( ! V_319 || ! V_5 )
return - V_205 ;
F_127 ( V_319 , & V_320 . V_304 ) ;
return 0 ;
}
...
if ( ! V_321 )
return - 1 ;
V_5 -> V_322 = F_129 ( V_5 -> V_323 -> V_324 , V_321 ) ;
if ( F_130 ( V_5 -> V_322 ) ) {
F_5 ( & V_5 -> V_2 -> V_10 ,
L_97 ,
V_5 -> V_323 -> V_324 ) ;
...
F_131 ( L_98 , V_325 , V_5 -> V_322 , V_5 ,
& V_326 ) ;
F_131 ( L_99 , V_325 , V_5 -> V_322 , V_5 ,
& V_327 ) ;
return 0 ;
}
...
static inline void F_134 ( struct V_4 * V_5 )
{
T_2 V_328 ;
...
V_362 = V_5 -> V_59 * 32 ;
F_134 ( V_5 ) ;
V_5 -> V_23 = F_150 ( sizeof( struct V_22 ) , V_159 ,
V_5 -> V_366 ) ;
if ( ! V_5 -> V_23 ) {
F_38 ( & V_5 -> V_2 -> V_10 ,
L_112 ) ;
...
V_5 -> V_367 = 0 ;
F_151 ( & V_5 -> V_23 -> V_30 , V_5 -> V_367 ) ;
for ( V_49 = 0 ; V_49 < V_123 ; V_49 ++ )
F_152 ( & V_5 -> V_23 -> V_40 [ V_49 ] ) ;
...
F_155 ( V_5 -> V_2 -> V_129 , F_156 ( V_5 -> V_377 ) ) ;
F_21 ( F_22 ( V_5 -> V_34 + V_35 ) | V_69 ,
V_5 -> V_34 + V_35 ) ;
F_157 ( & V_5 -> V_23 -> V_107 ) ;
if ( F_25 ( V_37 , & V_5 -> V_38 ) ) {
V_67 = - V_68 ;
goto V_378;
}
...
F_21 ( F_22 ( V_5 -> V_34 + V_35 ) & ~ V_69 ,
V_5 -> V_34 + V_35 ) ;
F_155 ( V_5 -> V_2 -> V_129 , NULL ) ;
F_158 ( & V_5 -> V_2 -> V_10 , V_5 -> V_2 -> V_129 , V_5 ) ;
V_374:
F_35 ( V_5 -> V_23 ) ;
F_144 ( V_5 ) ;
V_365:
...
static int F_165 ( struct V_387 * V_10 ,
T_14 V_388 ,
unsigned V_16 ,
unsigned long V_287 )
{
...
return - V_68 ;
if ( F_168 ( V_252 . V_266 , & V_395 -> V_266 ) )
return - V_68 ;
if ( F_168 ( V_252 . V_267 , & V_395 -> V_267 ) )
return - V_68 ;
...
( 2 * sizeof( V_397 ) ) ) )
return - V_68 ;
if ( F_169 ( V_252 . V_266 , & V_395 -> V_266 ) )
return - V_68 ;
if ( F_169 ( V_252 . V_267 , & V_395 -> V_267 ) )
return - V_68 ;
return V_293 ;
}
default:
...
static int F_170 ( struct V_387 * V_10 ,
struct V_398 * V_399 )
{
struct V_4 * V_5 = V_10 -> V_389 -> V_305 ;
T_9 V_400 ;
...
V_399 -> V_401 = 224 ;
V_399 -> V_191 = 56 ;
F_171 ( V_400 , ( V_399 -> V_401 * V_399 -> V_191 ) ) ;
V_399 -> V_402 = V_400 ;
return 0 ;
}
static inline bool F_172 ( struct V_4 * V_5 )
{
...
static int F_174 ( struct V_18 * V_19 , struct V_13 * V_14 )
{
...
if ( V_14 -> V_405 & V_406 ) {
int V_259 ;
V_259 = F_84 ( V_5 , F_109 ( V_14 ) , F_110 ( V_14 ) ) ;
F_19 ( V_14 , V_259 ) ;
return 0 ;
}
V_230 = F_175 ( V_19 -> V_7 , V_14 , V_16 -> V_26 ) ;
F_107 ( V_5 , V_14 , V_16 , V_230 , V_19 ) ;
return 0 ;
}
static bool F_176 ( struct V_18 * V_19 ,
struct V_13 * V_14 )
{
struct V_4 * V_5 = V_19 -> V_7 -> V_403 ;
struct V_12 * V_16 = F_8 ( V_14 ) ;
if ( F_108 ( V_14 ) == V_295 || ! V_5 -> V_367 )
return false ;
if ( F_110 ( V_14 ) <= 64 ) {
if ( ( F_109 ( V_14 ) & 7 ) || ( F_110 ( V_14 ) & 7 ) )
V_16 -> V_29 = 1 ;
}
if ( V_16 -> V_29 && F_177 ( & V_5 -> V_23 -> V_30 ) )
return true ;
return false ;
}
...
int V_293 ;
if ( F_16 ( F_176 ( V_19 , V_14 ) ) )
return V_409 ;
F_179 ( V_14 ) ;
V_293 = F_174 ( V_19 , V_14 ) ;
if ( F_46 ( ! V_293 ) )
return V_410 ;
V_14 -> V_411 = V_293 ;
return V_412 ;
}
static void F_180 ( void * V_114 , struct V_13 * V_14 ,
...
static int F_181 ( void * V_114 , struct V_13 * V_14 , unsigned int V_413 ,
...
V_5 -> V_323 = F_183 ( V_427 , V_5 -> V_366 ) ;
if ( V_5 -> V_323 == NULL ) {
F_38 ( & V_5 -> V_2 -> V_10 ,
L_121 ) ;
V_67 = - V_205 ;
...
do {
if ( ! F_184 ( & V_429 , V_159 ) )
goto V_430;
F_28 ( & V_431 ) ;
V_67 = F_185 ( & V_429 , & V_380 ) ;
F_31 ( & V_431 ) ;
} while ( V_67 == - V_173 );
if ( V_67 )
goto V_430;
...
F_188 ( V_5 -> V_7 , V_423 ) ;
F_189 ( V_5 -> V_7 , 4096 ) ;
F_190 ( V_5 -> V_7 , 0xffff ) ;
F_191 ( V_5 -> V_7 , 0x400000 ) ;
F_192 ( V_5 -> V_7 , 4096 ) ;
F_193 ( V_5 -> V_7 , V_5 -> V_2 -> V_452 ) ;
F_194 ( V_5 -> V_7 , 0 ) ;
if ( V_5 -> V_186 == true ) {
...
F_196 ( V_5 -> V_323 , V_400 ) ;
F_197 ( V_5 -> V_323 ) ;
V_5 -> V_458 = F_198 ( V_5 -> V_323 , 0 ) ;
V_319 = F_199 ( & F_200 ( V_5 -> V_323 ) -> V_319 ) ;
if ( V_319 ) {
F_124 ( V_5 , V_319 ) ;
F_201 ( V_319 ) ;
}
...
static void F_215 ( int V_462 )
{
V_463 [ V_462 ] -- ;
}
static int F_216 ( int V_464 )
{
...
F_48 ( & V_2 -> V_10 , L_134 ,
V_488 , F_227 ( V_2 -> V_479 ) , F_229 ( & V_2 -> V_10 ) ,
F_230 ( F_231 () ) , F_231 () ) ;
V_5 = F_150 ( sizeof( struct V_4 ) , V_159 , V_488 ) ;
if ( V_5 == NULL ) {
F_38 ( & V_2 -> V_10 ,
L_135 ) ;
return - V_219 ;
...
V_67 = F_234 ( V_2 , 1 << V_364 , V_94 ) ;
if ( V_67 < 0 ) {
F_38 ( & V_2 -> V_10 , L_137 ) ;
goto V_490;
}
if ( ! F_235 ( V_2 , F_236 ( 64 ) ) ) {
V_67 = F_237 ( V_2 , F_236 ( 64 ) ) ;
if ( V_67 ) {
V_67 = F_237 ( V_2 ,
F_236 ( 32 ) ) ;
if ( V_67 ) {
...
F_53 ( & V_2 -> V_10 , L_143 ) ;
V_5 -> V_377 = F_216 ( V_5 -> V_366 ) ;
F_48 ( & V_2 -> V_10 , L_144 ,
F_230 ( V_5 -> V_377 ) , V_5 -> V_377 ) ;
V_5 -> V_124 [ 0 ] . V_125 = V_5 -> V_377 ;
V_5 -> V_124 [ 1 ] . V_125 = F_216 ( V_5 -> V_366 ) ;
V_5 -> V_124 [ 2 ] . V_125 = F_216 ( V_5 -> V_366 ) ;
...
F_244 ( & V_5 -> V_124 [ 0 ] . V_124 , V_497 ) ;
F_244 ( & V_5 -> V_124 [ 1 ] . V_124 , V_498 ) ;
F_244 ( & V_5 -> V_124 [ 2 ] . V_124 , V_499 ) ;
F_244 ( & V_5 -> V_124 [ 3 ] . V_124 , V_500 ) ;
F_244 ( & V_5 -> V_124 [ 4 ] . V_124 , V_501 ) ;
F_244 ( & V_5 -> V_124 [ 5 ] . V_124 , V_502 ) ;
F_244 ( & V_5 -> V_124 [ 6 ] . V_124 , V_503 ) ;
F_244 ( & V_5 -> V_124 [ 7 ] . V_124 , V_504 ) ;
F_245 ( V_2 ) ;
V_67 = F_246 ( V_2 ) ;
if ( V_67 ) {
F_5 ( & V_2 -> V_10 ,
...
F_249 ( V_5 -> V_126 ) ;
F_250 ( V_5 -> V_126 ) ;
F_215 ( V_5 -> V_124 [ 0 ] . V_125 ) ;
F_215 ( V_5 -> V_124 [ 1 ] . V_125 ) ;
F_215 ( V_5 -> V_124 [ 2 ] . V_125 ) ;
}
V_491:
F_251 ( V_2 , 1 << V_364 ) ;
V_490:
...
static int F_255 ( struct V_1 * V_2 , T_15 V_508 )
{
int V_67 = 0 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( ! V_5 ) {
...
static int T_16 F_262 ( void )
{
int error ;
F_263 ( V_94 L_153 V_512 L_91 ) ;
F_152 ( & V_310 ) ;
F_238 ( & V_493 ) ;
F_238 ( & V_507 ) ;
error = F_264 ( 0 , V_94 ) ;
