...
static void F_129 ( struct V_8 * V_9 , enum V_301 V_302 )
{
switch ( V_302 ) {
case V_303 :
F_73 ( ! V_55 ) ;
F_130 ( V_9 , V_9 -> V_39 . V_304 , F_131 ( V_9 ) ) ;
break;
default:
F_78 () ;
}
...
{
struct V_179 * V_314 = F_134 ( V_9 , V_180 ) ;
return V_314 -> V_88 ;
}
...
static void F_138 ( struct V_8 * V_9 , struct V_115 * V_331 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
{
unsigned long V_342 = F_149 () & V_343 ;
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_157 ( V_9 -> V_39 . V_327 [ 0 ] , 0 ) ;
F_157 ( V_9 -> V_39 . V_327 [ 1 ] , 1 ) ;
F_157 ( V_9 -> V_39 . V_327 [ 2 ] , 2 ) ;
F_157 ( V_9 -> V_39 . V_327 [ 3 ] , 3 ) ;
V_9 -> V_39 . V_247 = F_154 ( V_9 ) ;
V_9 -> V_39 . V_357 = V_10 -> V_1 -> V_58 . V_357 ;
V_9 -> V_39 . V_358 &= ~ V_359 ;
F_12 ( V_10 ) ;
}
static void F_158 ( struct V_8 * V_9 , unsigned long V_355 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
F_162 ( & V_10 -> V_9 , V_360 ) ;
V_141 = F_163 ( & V_10 -> V_9 , V_360 , V_81 ,
V_10 -> V_1 -> V_2 . V_364 ,
V_10 -> V_1 -> V_2 . V_365 ) ;
break;
case V_366 :
...
T_2 V_397 ;
int V_65 ;
V_65 = F_194 ( V_9 , F_195 ( V_258 ) , & V_397 ,
...
F_72 ( F_201 ( V_9 ) ) ;
F_202 ( V_9 ) ;
V_9 -> V_39 . V_405 . V_406 = F_197 ;
V_9 -> V_39 . V_405 . V_407 = F_192 ;
V_9 -> V_39 . V_405 . V_408 = F_193 ;
V_9 -> V_39 . V_405 . V_409 = F_198 ;
V_9 -> V_39 . V_405 . V_410 = F_25 () ;
F_203 ( V_9 , & V_9 -> V_39 . V_405 ) ;
...
static void * F_211 ( struct V_7 * V_10 , T_2 V_421 , struct V_163 * * V_422 )
{
struct V_163 * V_163 ;
F_212 () ;
V_163 = F_213 ( & V_10 -> V_9 , V_421 >> V_134 ) ;
if ( F_214 ( V_163 ) )
goto error;
* V_422 = V_163 ;
return F_215 ( V_163 ) ;
...
V_97 = 0 ;
if ( F_220 ( & V_10 -> V_9 , V_421 , & V_97 , V_423 ) )
return V_415 ;
...
return V_415 ;
V_43 *= 4 ;
if ( F_220 ( & V_10 -> V_9 , V_10 -> V_17 . V_428 + V_43 , & V_355 , 4 ) )
return V_415 ;
...
static inline void F_224 ( struct V_1 * V_439 , struct V_1 * V_440 )
{
...
V_1 -> V_2 . V_445 ,
V_447 ) ;
V_446 = F_211 ( V_10 , V_10 -> V_17 . V_1 , & V_163 ) ;
if ( ! V_446 )
return 1 ;
F_226 ( & V_10 -> V_9 ) ;
V_10 -> V_17 . V_1 = 0 ;
...
V_446 -> V_58 . V_335 = F_227 ( & V_10 -> V_9 ) ;
V_446 -> V_58 . V_258 = F_131 ( & V_10 -> V_9 ) ;
V_446 -> V_58 . V_414 = V_1 -> V_58 . V_414 ;
V_446 -> V_58 . V_253 = V_10 -> V_9 . V_39 . V_253 ;
V_446 -> V_58 . V_300 = F_228 ( & V_10 -> V_9 ) ;
...
if ( F_220 ( & V_10 -> V_9 , V_43 , & V_355 , 4 ) )
return false ;
...
V_446 = F_211 ( V_10 , V_10 -> V_1 -> V_58 . V_449 , & V_163 ) ;
if ( ! V_446 )
return false ;
if ( ! F_234 ( V_446 ) ) {
...
F_236 ( V_10 -> V_1 -> V_58 . V_84 , V_456 ,
V_446 -> V_58 . V_84 ,
V_446 -> V_2 . V_232 ,
V_446 -> V_2 . V_90 ,
V_446 -> V_2 . V_255 ) ;
F_237 ( V_446 -> V_2 . V_19 & 0xffff ,
V_446 -> V_2 . V_19 >> 16 ,
V_446 -> V_2 . V_21 ,
V_446 -> V_2 . V_22 ) ;
F_229 ( & V_10 -> V_9 ) ;
...
V_18 -> V_58 . V_335 = F_227 ( & V_10 -> V_9 ) ;
V_18 -> V_58 . V_253 = V_10 -> V_9 . V_39 . V_253 ;
V_18 -> V_58 . V_300 = F_228 ( & V_10 -> V_9 ) ;
...
static void F_240 ( struct V_1 * V_440 , struct V_1 * V_459 )
{
...
{
struct V_8 * V_9 = & V_10 -> V_9 ;
F_247 ( V_10 -> V_1 -> V_58 . V_84 , F_248 ( & V_10 -> V_9 , V_427 ) ,
F_248 ( & V_10 -> V_9 , V_453 ) ) ;
F_249 ( V_9 , F_248 ( & V_10 -> V_9 , V_453 ) ) ;
V_10 -> V_71 = F_36 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
{
F_251 ( V_10 -> V_1 -> V_58 . V_84 , F_248 ( & V_10 -> V_9 , V_453 ) ) ;
F_169 ( & V_10 -> V_9 , V_201 ) ;
return 1 ;
}
...
{
T_2 V_472 = F_255 ( & V_10 -> V_9 ) ;
T_1 V_145 = F_248 ( & V_10 -> V_9 , V_427 ) ;
if ( F_256 ( & V_10 -> V_9 , V_145 , V_472 ) == 0 ) {
V_10 -> V_71 = F_36 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
...
if ( V_475 != V_492 )
V_477 = - 1 ;
if ( F_258 ( & V_10 -> V_9 , V_473 , V_477 , V_474 ,
V_80 , V_81 ) == V_494 ) {
...
F_249 ( & V_10 -> V_9 , V_10 -> V_1 -> V_2 . V_363 ) ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
if ( V_510 >= 16 ) {
if ( ! F_276 ( & V_10 -> V_9 , V_510 - 16 ) )
return 1 ;
V_97 = F_248 ( & V_10 -> V_9 , V_302 ) ;
F_277 ( & V_10 -> V_9 , V_510 - 16 , V_97 ) ;
} else {
if ( ! F_276 ( & V_10 -> V_9 , V_510 ) )
return 1 ;
F_278 ( & V_10 -> V_9 , V_510 , & V_97 ) ;
F_107 ( & V_10 -> V_9 , V_302 , V_97 ) ;
}
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
...
struct V_368 * V_368 = V_10 -> V_9 . V_369 ;
int V_141 ;
T_4 V_511 = F_274 ( & V_10 -> V_9 ) ;
V_141 = F_268 ( V_10 ) ;
if ( F_280 ( & V_10 -> V_9 ) )
return V_141 ;
if ( V_511 <= F_274 ( & V_10 -> V_9 ) )
return V_141 ;
V_368 -> V_375 = V_512 ;
return 0 ;
}
static T_2 F_281 ( struct V_8 * V_9 , T_2 V_513 )
{
struct V_1 * V_1 = F_8 ( F_4 ( V_9 ) ) ;
return V_1 -> V_2 . V_187 + V_513 ;
}
static int F_282 ( struct V_8 * V_9 , struct V_514 * V_515 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
switch ( V_515 -> V_145 ) {
case V_516 : {
...
{
T_1 V_538 = F_248 ( & V_10 -> V_9 , V_427 ) ;
struct V_514 V_515 ;
V_515 . V_145 = V_538 ;
V_515 . V_539 = false ;
if ( F_282 ( & V_10 -> V_9 , & V_515 ) ) {
F_289 ( V_538 ) ;
F_206 ( & V_10 -> V_9 , 0 ) ;
} else {
F_290 ( V_538 , V_515 . V_517 ) ;
...
static int F_291 ( struct V_8 * V_9 , T_2 V_517 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_540 , V_541 ;
if ( V_517 & ~ V_542 )
...
static int F_292 ( struct V_8 * V_9 , struct V_514 * V_42 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
break;
case V_532 :
return F_291 ( V_9 , V_517 ) ;
case V_548 :
F_294 ( V_9 , L_13 , V_538 , V_517 ) ;
break;
default:
return F_295 ( V_9 , V_42 ) ;
}
return 0 ;
}
...
struct V_514 V_42 ;
T_1 V_538 = F_248 ( & V_10 -> V_9 , V_427 ) ;
T_2 V_517 = F_255 ( & V_10 -> V_9 ) ;
V_42 . V_517 = V_517 ;
V_42 . V_145 = V_538 ;
V_42 . V_539 = false ;
V_10 -> V_71 = F_36 ( & V_10 -> V_9 ) + 2 ;
if ( F_297 ( & V_10 -> V_9 , & V_42 ) ) {
F_298 ( V_538 , V_517 ) ;
F_206 ( & V_10 -> V_9 , 0 ) ;
} else {
F_299 ( V_538 , V_517 ) ;
...
static void F_309 ( struct V_8 * V_9 , T_2 * V_551 , T_2 * V_552 )
{
...
if ( F_7 ( V_9 ) ) {
int V_412 ;
F_312 ( V_10 -> V_1 -> V_58 . V_84 , V_402 ,
V_10 -> V_1 -> V_2 . V_363 ,
V_10 -> V_1 -> V_2 . V_361 ,
V_10 -> V_1 -> V_2 . V_444 ,
V_10 -> V_1 -> V_2 . V_445 ,
...
static void F_318 ( struct V_7 * V_10 )
{
int V_140 = F_54 () ;
struct V_113 * V_114 = F_57 ( V_123 , V_140 ) ;
...
static inline void F_320 ( struct V_7 * V_10 , int V_561 )
{
struct V_11 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_443 = V_561 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_73 ( ! ( F_20 ( V_10 ) ) ) ;
F_322 ( V_9 -> V_39 . V_564 . V_79 ) ;
++ V_9 -> V_295 . V_565 ;
V_10 -> V_1 -> V_2 . V_90 = V_9 -> V_39 . V_564 . V_79 |
V_63 | V_64 ;
}
static void F_323 ( struct V_8 * V_9 , int V_566 , int V_567 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_324 ( struct V_8 * V_9 , bool V_568 )
{
return;
}
static bool F_325 ( void )
{
return false ;
}
...
static void F_327 ( struct V_8 * V_9 , T_2 * V_569 )
{
return;
}
...
static void F_331 ( struct V_8 * V_9 , bool V_570 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_570 ) {
V_10 -> V_9 . V_39 . V_40 |= V_559 ;
...
static int F_335 ( struct V_270 * V_270 , unsigned int V_50 )
{
return 0 ;
}
...
F_341 ( & V_10 -> V_9 , V_575 , V_96 ) ;
} else
F_342 ( & V_10 -> V_9 , V_575 ) ;
break;
case V_491 :
F_343 ( & V_10 -> V_9 , V_575 , false ) ;
break;
default:
break;
}
...
static void F_349 ( struct V_8 * V_9 , unsigned long V_398 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void
F_352 ( struct V_8 * V_9 , unsigned char * V_584 )
{
V_584 [ 0 ] = 0x0f ;
V_584 [ 1 ] = 0x01 ;
V_584 [ 2 ] = 0xd9 ;
}
static void F_353 ( void * V_585 )
{
* ( int * ) V_585 = 0 ;
}
...
static T_2 F_356 ( struct V_8 * V_9 , T_11 V_586 , bool V_587 )
{
return 0 ;
}
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_450 = ! ! F_358 ( & V_10 -> V_9 ) ;
}
static void F_359 ( T_1 V_588 , struct V_589 * V_590 )
{
switch ( V_588 ) {
case 0x80000001 :
if ( V_17 )
...
static void F_369 ( struct V_8 * V_9 )
{
F_166 () ;
}
static void F_370 ( struct V_8 * V_9 , int V_140 )
{
}
static int T_5 F_371 ( void )
{
return F_372 ( & V_626 , sizeof( struct V_7 ) ,
F_373 ( struct V_7 ) , V_627 ) ;
}
static void T_6 F_374 ( void )
{
F_375 () ;
}
