...
static struct V_91 * F_43 ( struct V_105 * args )
{
struct V_106 * V_107 ;
if ( args -> V_108 != V_109 )
return F_44 ( args ) ;
...
if ( V_107 ) {
F_45 ( V_107 ) ;
return F_46 ( args , V_107 ) ;
}
return F_44 ( args ) ;
}
static int F_47 ( struct V_89 * V_90 , struct V_112 * V_113 , struct V_20 * V_93 )
{
int V_114 = F_36 ( V_90 -> V_79 ) ;
struct V_115 V_116 = {
. V_117 = V_114 ,
. V_118 = 0 ,
. V_119 = V_114 ,
...
static void F_51 ( struct V_89 * V_90 , int V_155 )
{
F_2 ( L_11 ,
...
{
if ( F_53 ( V_158 , & V_90 -> V_159 ) )
return;
V_90 -> V_160 = V_161 ;
F_51 ( V_90 , V_155 ) ;
}
static void F_54 ( struct V_89 * V_90 , int V_155 )
{
if ( F_53 ( V_158 , & V_90 -> V_159 ) )
return;
V_90 -> V_160 = V_162 ;
...
static void F_55 ( struct V_163 * V_164 , void * V_165 )
{
struct V_89 * V_90 = F_34 ( V_165 , struct V_89 , V_166 ) ;
if ( V_164 -> V_167 )
F_52 ( V_90 , V_164 -> V_167 ) ;
else
V_90 -> V_160 = V_168 ;
}
...
{
V_90 -> V_160 = V_169 ;
F_57 ( V_158 , & V_90 -> V_159 ) ;
F_58 ( & V_90 -> V_166 ) ;
}
void F_59 ( struct V_89 * V_90 )
{
F_56 ( V_90 ) ;
F_60 ( V_170 ) ;
}
void F_61 ( struct V_89 * V_90 , struct V_112 * V_113 )
{
V_90 -> V_160 = V_169 ;
F_62 ( & V_90 -> V_171 ) ;
...
static bool F_64 ( struct V_89 * V_90 , struct V_163 * V_164 )
{
if ( F_65 ( 0 , & V_90 -> V_172 ) != 0 ) {
F_66 ( & V_90 -> V_173 , V_164 , NULL ) ;
if ( F_65 ( 0 , & V_90 -> V_172 ) != 0 ) {
F_2 ( L_12 , V_34 ) ;
return false ;
}
F_67 ( & V_90 -> V_173 , V_164 ) ;
}
return true ;
}
static void F_68 ( struct V_163 * V_164 , void * V_165 )
{
struct V_50 * V_51 = V_165 ;
...
static bool F_70 ( struct V_163 * V_164 , struct V_50 * V_51 )
{
struct V_89 * V_90 = V_51 -> V_52 ;
...
static void F_76 ( struct V_163 * V_164 , void * V_165 )
{
struct V_50 * V_51 = V_165 ;
struct V_89 * V_90 = V_51 -> V_52 ;
F_2 ( L_15 , V_34 ,
...
if ( V_51 -> V_68 ) {
F_77 ( V_164 -> V_167 ) ;
V_164 -> V_167 = V_51 -> V_68 ;
}
switch ( V_51 -> V_184 -> V_185 ( V_51 , V_164 ) ) {
case 0 :
V_164 -> V_167 = 0 ;
F_75 ( V_164 ) ;
return;
...
static void F_79 ( void * V_165 )
{
struct V_50 * V_51 = V_165 ;
if ( V_51 -> V_183 )
F_58 ( V_51 ) ;
else
V_51 -> V_184 -> V_186 ( V_51 ) ;
}
int F_80 ( void )
{
V_170 = F_81 ( L_16 ) ;
...
void F_84 ( struct V_89 * V_90 )
{
F_57 ( V_187 , & V_90 -> V_159 ) ;
F_58 ( & V_90 -> V_166 ) ;
F_60 ( V_170 ) ;
}
static struct V_188 * F_85 ( struct V_89 * V_90 )
{
struct V_20 * V_189 ;
struct V_188 * V_190 ;
...
if ( V_90 -> V_147 . V_146 ) {
F_89 ( V_90 -> V_147 . V_146 ) ;
V_90 -> V_147 . V_146 = NULL ;
}
if ( F_53 ( V_187 , & V_90 -> V_159 ) )
return;
F_62 ( & V_90 -> V_171 ) ;
F_8 ( ! ( V_90 -> V_159 & V_194 ) ) ;
F_73 ( V_158 , & V_90 -> V_159 ) ;
memcpy ( & V_113 , & V_51 -> V_52 -> V_147 , sizeof( struct V_112 ) ) ;
V_190 = F_85 ( V_90 ) ;
if ( V_190 ) {
F_90 ( V_190 -> V_195 ) ;
V_113 . V_146 = V_190 -> V_195 ;
V_93 = V_190 -> V_196 ;
}
F_63 ( & V_90 -> V_171 ) ;
V_193 = F_47 ( V_90 , & V_113 , V_93 ) ;
if ( V_193 ) {
F_52 ( V_90 , V_193 ) ;
return;
}
...
{
struct V_50 * V_51 =
F_34 ( V_198 , struct V_50 , V_199 ) ;
struct V_89 * V_90 = V_51 -> V_52 ;
struct V_91 * V_200 ;
if ( V_51 -> V_183 ) {
V_51 -> V_183 = false ;
} else {
if ( V_51 -> V_184 && V_51 -> V_184 -> V_201 )
V_51 -> V_184 -> V_201 ( V_51 ) ;
}
if ( V_90 -> V_159 & V_194 )
F_87 ( V_51 ) ;
V_200 = V_90 -> V_153 ;
if ( ! V_200 ) {
if ( V_51 -> V_184 && V_51 -> V_184 -> V_186 )
V_51 -> V_184 -> V_186 ( V_51 ) ;
return;
}
if ( ! V_51 -> V_184 && V_90 -> V_94 ) {
V_90 -> V_160 = V_168 ;
return;
}
V_51 -> V_202 . V_88 = V_90 -> V_154 ;
F_92 ( V_200 , & V_51 -> V_202 , V_203 | V_204 ,
V_51 -> V_184 ? & V_205 : & V_206 , V_51 ) ;
}
void F_93 ( struct V_50 * V_51 , struct V_89 * V_90 ,
const struct V_207 * V_208 , enum V_209 V_8 )
{
V_51 -> V_52 = V_90 ;
V_51 -> V_202 . V_210 = & V_211 [ V_8 ] ;
V_51 -> V_202 . V_212 = V_51 ;
V_51 -> V_202 . V_213 = V_51 ;
V_51 -> V_184 = V_208 ;
F_94 ( & V_51 -> V_199 , F_91 ) ;
V_51 -> V_61 = 1 ;
V_51 -> V_68 = 0 ;
V_51 -> V_183 = false ;
}
