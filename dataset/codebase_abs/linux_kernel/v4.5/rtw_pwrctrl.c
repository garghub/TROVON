...
T_2 F_48 ( struct V_1 * V_2 , T_3 V_105 )
{
unsigned long V_106 ;
T_1 V_107 = false ;
T_2 V_108 = 0 ;
...
int F_57 ( struct V_1 * V_2 , T_3 V_121 , const char * V_122 )
{
struct V_3 * V_4 = & V_2 -> V_5 ;
struct V_14 * V_15 = & V_2 -> V_16 ;
unsigned long V_123 ;
unsigned long V_124 ;
int V_58 = V_46 ;
V_123 = V_60 + F_58 ( V_121 ) ;
if ( F_59 ( V_4 -> V_59 , V_123 ) )
V_4 -> V_59 = V_60 + F_58 ( V_121 ) ;
V_124 = V_60 ;
if ( V_4 -> V_70 ) {
F_2 ( L_31 , V_22 ) ;
while ( V_4 -> V_70 &&
F_50 ( V_60 - V_124 ) <= 3000 )
F_60 ( 1000 , 3000 ) ;
if ( V_4 -> V_70 )
F_2 ( L_32 , V_22 ) ;
else
...
int F_61 ( struct V_1 * V_2 , T_1 V_127 )
{
int V_58 = 0 ;
struct V_3 * V_5 = & V_2 -> V_5 ;
if ( V_127 < V_128 ) {
...
int F_62 ( struct V_1 * V_2 , T_1 V_127 )
{
struct V_3 * V_5 = & V_2 -> V_5 ;
if ( V_127 == V_130 || V_127 == V_41 ) {
F_63 ( V_5 , V_127 ) ;
F_2 ( L_37 , V_22 , V_127 == V_130 ? L_38 : L_39 ) ;
return 0 ;
} else if ( V_127 == V_73 ) {
F_63 ( V_5 , V_127 ) ;
F_2 ( L_37 , V_22 , L_40 ) ;
if ( ( V_2 -> V_10 == 0 ) && ( V_125 == F_64 ( V_2 ) ) )
return - V_131 ;
} else {
return - V_129 ;
}
