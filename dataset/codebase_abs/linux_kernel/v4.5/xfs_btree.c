...
ASSERT ( V_102 != V_26 ) ;
V_104 = F_49 ( V_10 , V_102 ) ;
F_60 ( V_10 -> V_80 , V_104 , V_10 -> V_81 * V_118 , V_117 ) ;
}
void
F_61 (
struct V_9 * V_10 ,
...
F_61 ( V_2 -> V_11 , V_2 -> V_39 . V_40 . V_105 ,
...
return F_52 ( V_2 -> V_11 , V_2 -> V_39 . V_40 . V_105 ,
F_5 ( V_52 -> V_42 ) ) ;
}
}
STATIC void
...
F_74 ( & V_128 -> V_13 . V_14 . V_15 , & V_10 -> V_12 . V_16 ) ;
...
F_74 ( & V_128 -> V_13 . V_42 . V_15 , & V_10 -> V_12 . V_16 ) ;
...
F_72 ( V_2 -> V_11 , F_23 ( V_7 ) , V_7 -> V_18 ,
F_6 ( V_2 ) , V_5 , V_131 ,
V_132 , V_2 -> V_46 ) ;
}
STATIC int
...
{
F_91 ( V_2 , V_160 ) ;
F_92 ( V_2 , V_7 , V_111 , V_112 ) ;
if ( V_7 ) {
F_93 ( V_2 -> V_67 , V_7 , V_161 ) ;
F_94 ( V_2 -> V_67 , V_7 ,
F_39 ( V_2 , V_111 ) ,
F_39 ( V_2 , V_112 + 1 ) - 1 ) ;
} else {
...
F_100 ( struct V_3 , V_13 . V_42 . V_134 ) ,
F_100 ( struct V_3 , V_13 . V_42 . V_164 ) ,
V_86
} ;
...
F_100 ( struct V_3 , V_13 . V_14 . V_134 ) ,
F_100 ( struct V_3 , V_13 . V_14 . V_164 ) ,
...
V_4 = F_47 ( V_2 , V_125 , & V_7 ) ;
#ifdef F_104
error = F_17 ( V_2 , V_4 , V_125 , V_7 ) ;
if ( error )
goto V_171;
#endif
if ( ++ V_2 -> V_78 [ V_125 ] <= F_105 ( V_4 ) )
break;
F_64 ( V_2 , V_125 , V_124 ) ;
}
if ( V_125 == V_2 -> V_65 ) {
if ( V_2 -> V_46 & V_101 )
goto V_173;
...
for ( V_4 = F_47 ( V_2 , V_125 , & V_7 ) ; V_125 > V_5 ; ) {
union V_51 * V_175 ;
V_175 = F_43 ( V_2 , V_2 -> V_78 [ V_125 ] , V_4 ) ;
-- V_125 ;
error = F_83 ( V_2 , V_175 , 0 , & V_4 , & V_7 ) ;
if ( error )
goto V_171;
F_67 ( V_2 , V_125 , V_7 ) ;
V_2 -> V_78 [ V_125 ] = 1 ;
...
V_7 = V_2 -> V_66 [ V_5 ] ;
if ( V_7 && F_35 ( V_7 ) == F_65 ( V_2 , V_178 ) ) {
* V_179 = F_23 ( V_7 ) ;
return 0 ;
}
error = F_83 ( V_2 , V_178 , 0 , V_179 , & V_7 ) ;
if ( error )
return error ;
F_67 ( V_2 , V_5 , V_7 ) ;
return 0 ;
...
if ( V_2 -> V_78 [ V_5 ] <= 1 )
goto V_173;
error = F_83 ( V_2 , & V_201 , 0 , & V_121 , & V_197 ) ;
if ( error )
goto V_171;
V_198 = F_105 ( V_121 ) ;
...
union V_94 * V_207 ;
union V_51 * V_208 ;
V_207 = F_42 ( V_2 , V_198 , V_121 ) ;
V_202 = F_42 ( V_2 , 1 , V_122 ) ;
V_208 = F_43 ( V_2 , V_198 , V_121 ) ;
V_203 = F_43 ( V_2 , 1 , V_122 ) ;
#ifdef F_104
error = F_21 ( V_2 , V_203 , 0 , V_5 ) ;
if ( error )
goto V_171;
#endif
F_84 ( V_2 , V_207 , V_202 , 1 ) ;
F_86 ( V_2 , V_208 , V_203 , 1 ) ;
F_90 ( V_2 , V_197 , V_198 , V_198 ) ;
F_98 ( V_2 , V_197 , V_198 , V_198 ) ;
ASSERT ( V_2 -> V_23 -> V_209 ( V_2 ,
F_42 ( V_2 , V_198 - 1 , V_121 ) , V_207 ) ) ;
} else {
union V_93 * V_210 ;
V_210 = F_41 ( V_2 , V_198 , V_121 ) ;
V_204 = F_41 ( V_2 , 1 , V_122 ) ;
F_85 ( V_2 , V_210 , V_204 , 1 ) ;
F_97 ( V_2 , V_197 , V_198 , V_198 ) ;
ASSERT ( V_2 -> V_23 -> V_211 ( V_2 ,
F_41 ( V_2 , V_198 - 1 , V_121 ) , V_210 ) ) ;
}
F_117 ( V_121 , V_198 ) ;
F_99 ( V_2 , V_197 , V_212 ) ;
F_117 ( V_122 , V_200 ) ;
F_99 ( V_2 , V_199 , V_212 ) ;
F_116 ( V_2 , V_206 , V_200 - 1 ) ;
if ( V_5 > 0 ) {
#ifdef F_104
int V_64 ;
...
goto V_173;
error = F_83 ( V_2 , & V_214 , 0 , & V_122 , & V_199 ) ;
if ( error )
goto V_171;
V_200 = F_105 ( V_122 ) ;
...
#endif
F_87 ( V_2 , V_202 , 1 , V_200 ) ;
F_89 ( V_2 , V_203 , 1 , V_200 ) ;
#ifdef F_104
error = F_21 ( V_2 , V_208 , 0 , V_5 ) ;
if ( error )
goto V_171;
#endif
F_84 ( V_2 , V_202 , V_207 , 1 ) ;
F_86 ( V_2 , V_203 , V_208 , 1 ) ;
F_90 ( V_2 , V_199 , 1 , V_200 + 1 ) ;
...
V_210 = F_41 ( V_2 , V_198 , V_121 ) ;
V_204 = F_41 ( V_2 , 1 , V_122 ) ;
F_88 ( V_2 , V_204 , 1 , V_200 ) ;
F_85 ( V_2 , V_204 , V_210 , 1 ) ;
...
goto V_171;
V_64 = F_55 ( V_213 , V_5 ) ;
F_119 ( V_2 -> V_11 , V_64 == 1 , V_171 ) ;
error = F_102 ( V_213 , V_5 , & V_64 ) ;
if ( error )
goto V_216;
error = F_111 ( V_213 , V_202 , V_5 + 1 ) ;
if ( error )
goto V_216;
F_30 ( V_213 , V_217 ) ;
F_91 ( V_2 , V_162 ) ;
...
union V_94 * V_202 ;
union V_51 * V_203 ;
V_207 = F_42 ( V_2 , V_223 , V_121 ) ;
V_208 = F_43 ( V_2 , V_223 , V_121 ) ;
V_202 = F_42 ( V_2 , 1 , V_122 ) ;
V_203 = F_43 ( V_2 , 1 , V_122 ) ;
#ifdef F_104
...
#endif
F_84 ( V_2 , V_202 , V_207 , V_200 ) ;
F_86 ( V_2 , V_203 , V_208 , V_200 ) ;
F_90 ( V_2 , V_199 , 1 , V_200 ) ;
F_98 ( V_2 , V_199 , 1 , V_200 ) ;
F_84 ( V_2 , V_157 , V_202 , 1 ) ;
} else {
union V_93 * V_210 ;
union V_93 * V_204 ;
V_210 = F_41 ( V_2 , V_223 , V_121 ) ;
V_204 = F_41 ( V_2 , 1 , V_122 ) ;
F_85 ( V_2 , V_204 , V_210 , V_200 ) ;
F_97 ( V_2 , V_199 , 1 , V_200 ) ;
V_2 -> V_23 -> V_182 ( V_157 ,
F_41 ( V_2 , 1 , V_122 ) ) ;
}
F_70 ( V_2 , V_121 , & V_220 , V_127 ) ;
F_71 ( V_2 , V_122 , & V_220 , V_127 ) ;
F_71 ( V_2 , V_122 , & V_201 , V_126 ) ;
F_71 ( V_2 , V_121 , & V_214 , V_127 ) ;
V_198 -= V_200 ;
F_117 ( V_121 , V_198 ) ;
F_117 ( V_122 , F_105 ( V_122 ) + V_200 ) ;
F_99 ( V_2 , V_199 , V_166 ) ;
F_99 ( V_2 , V_197 , V_212 | V_127 ) ;
if ( ! F_68 ( V_2 , & V_220 ) ) {
error = F_83 ( V_2 , & V_220 ,
0 , & V_222 , & V_221 ) ;
if ( error )
goto V_171;
F_71 ( V_2 , V_222 , & V_214 , V_126 ) ;
F_99 ( V_2 , V_221 , V_126 ) ;
}
...
F_124 ( & V_230 , V_231 ) ;
args -> V_237 = F_120 ( args -> V_2 , args -> V_5 , args -> V_175 ,
...
F_128 ( V_238 ) ;
if ( V_2 -> V_68 != V_69 )
return F_120 ( V_2 , V_5 , V_175 , V_157 , V_219 , V_170 ) ;
args . V_2 = V_2 ;
args . V_5 = V_5 ;
args . V_175 = V_175 ;
args . V_157 = V_157 ;
...
args . V_238 = & V_238 ;
args . V_233 = F_129 () ;
F_130 ( & args . V_228 , F_122 ) ;
F_131 ( V_239 , & args . V_228 ) ;
F_132 ( & V_238 ) ;
F_133 ( & args . V_228 ) ;
return args . V_237 ;
}
...
F_106 ( V_2 , V_226 ) ;
error = F_82 ( V_2 , & V_245 , 0 , & V_242 , & V_241 ) ;
if ( error )
goto V_171;
memcpy ( V_242 , V_4 , F_36 ( V_2 ) ) ;
if ( V_2 -> V_46 & V_83 ) {
if ( V_2 -> V_46 & V_47 )
...
V_243 = F_42 ( V_2 , 1 , V_242 ) ;
F_84 ( V_2 , V_243 , V_181 , F_105 ( V_242 ) ) ;
V_244 = F_43 ( V_2 , 1 , V_242 ) ;
#ifdef F_104
...
#endif
F_86 ( V_2 , V_244 , V_178 , F_105 ( V_242 ) ) ;
#ifdef F_104
error = F_21 ( V_2 , & V_245 , 0 , V_5 ) ;
if ( error )
goto V_171;
#endif
F_86 ( V_2 , V_178 , & V_245 , 1 ) ;
F_136 ( V_2 -> V_39 . V_70 . V_97 ,
1 - F_105 ( V_242 ) ,
V_2 -> V_39 . V_70 . V_98 ) ;
F_67 ( V_2 , V_5 , V_241 ) ;
F_99 ( V_2 , V_241 , V_166 ) ;
F_90 ( V_2 , V_241 , 1 , F_7 ( V_242 -> V_22 ) ) ;
F_98 ( V_2 , V_241 , 1 , F_7 ( V_242 -> V_22 ) ) ;
* V_240 |=
V_247 | F_96 ( V_2 -> V_39 . V_70 . V_98 ) ;
* V_170 = 1 ;
F_91 ( V_2 , V_162 ) ;
return 0 ;
V_171:
...
goto V_173;
F_106 ( V_2 , V_226 ) ;
error = F_82 ( V_2 , & V_201 , 0 , & V_74 , & V_248 ) ;
if ( error )
goto V_171;
...
F_76 ( V_2 , V_248 , V_2 -> V_65 , 2 ) ;
F_99 ( V_2 , V_248 , V_166 ) ;
ASSERT ( ! F_68 ( V_2 , & V_201 ) &&
! F_68 ( V_2 , & V_214 ) ) ;
if ( F_44 ( V_121 ) > 0 ) {
F_84 ( V_2 ,
F_42 ( V_2 , 1 , V_74 ) ,
...
int V_240 = 0 ;
error = F_134 ( V_2 , & V_240 , V_170 ) ;
if ( error || * V_170 == 0 )
return error ;
F_95 ( V_2 -> V_67 , V_97 , V_240 ) ;
}
return 0 ;
}
error = F_118 ( V_2 , V_5 , V_170 ) ;
if ( error || * V_170 )
return error ;
error = F_115 ( V_2 , V_5 , V_170 ) ;
if ( error )
return error ;
if ( * V_170 ) {
...
error = F_127 ( V_2 , V_5 , V_245 , & V_157 , V_73 , V_170 ) ;
if ( error || * V_170 == 0 )
return error ;
* V_53 = V_2 -> V_78 [ V_5 ] ;
...
#endif
F_91 ( V_2 , V_160 ) ;
F_140 ( V_2 , V_5 , * V_175 , V_255 ) ;
V_73 = NULL ;
if ( ! ( V_2 -> V_46 & V_101 ) &&
( V_5 >= V_2 -> V_65 ) ) {
error = F_137 ( V_2 , V_170 ) ;
F_69 ( V_2 , V_175 ) ;
F_91 ( V_2 , V_162 ) ;
return error ;
}
...
#endif
F_87 ( V_2 , V_181 , 1 , V_131 - V_52 + 1 ) ;
F_89 ( V_2 , V_178 , 1 , V_131 - V_52 + 1 ) ;
#ifdef F_104
error = F_21 ( V_2 , V_175 , 0 , V_5 ) ;
if ( error )
goto V_171;
#endif
F_84 ( V_2 , V_181 , & V_157 , 1 ) ;
F_86 ( V_2 , V_178 , V_175 , 1 ) ;
V_131 ++ ;
F_117 ( V_4 , V_131 ) ;
F_98 ( V_2 , V_7 , V_52 , V_131 ) ;
F_90 ( V_2 , V_7 , V_52 , V_131 ) ;
#ifdef F_104
if ( V_52 < V_131 ) {
...
union V_93 * V_194 ;
V_194 = F_41 ( V_2 , V_52 , V_4 ) ;
F_88 ( V_2 , V_194 , 1 , V_131 - V_52 + 1 ) ;
F_85 ( V_2 , V_194 , V_255 , 1 ) ;
F_117 ( V_4 , ++ V_131 ) ;
...
do {
error = F_139 ( V_259 , V_5 , & V_245 , & V_159 , & V_73 , & V_64 ) ;
if ( error ) {
if ( V_259 != V_2 )
F_30 ( V_259 , V_218 ) ;
goto V_171;
...
#endif
if ( V_52 < V_131 ) {
F_87 ( V_2 , V_207 , - 1 , V_131 - V_52 ) ;
F_89 ( V_2 , V_208 , - 1 , V_131 - V_52 ) ;
F_90 ( V_2 , V_7 , V_52 , V_131 - 1 ) ;
F_98 ( V_2 , V_7 , V_52 , V_131 - 1 ) ;
}
if ( V_52 == 1 )
...
V_64 = F_55 ( V_213 , V_5 ) ;
F_119 ( V_2 -> V_11 , V_64 == 1 , V_171 ) ;
V_122 = F_47 ( V_213 , V_5 , & V_199 ) ;
#ifdef F_104
error = F_17 ( V_213 , V_122 , V_5 , V_199 ) ;
if ( error )
goto V_171;
#endif
F_70 ( V_213 , V_122 , & V_264 , V_126 ) ;
if ( F_105 ( V_122 ) - 1 >=
V_2 -> V_23 -> V_267 ( V_213 , V_5 ) ) {
error = F_115 ( V_213 , V_5 , & V_64 ) ;
if ( error )
goto V_171;
if ( V_64 ) {
ASSERT ( F_105 ( V_4 ) >=
...
V_64 = F_54 ( V_213 , V_5 ) ;
F_119 ( V_2 -> V_11 , V_64 == 1 , V_171 ) ;
V_121 = F_47 ( V_213 , V_5 , & V_197 ) ;
#ifdef F_104
error = F_17 ( V_2 , V_121 , V_5 , V_197 ) ;
if ( error )
goto V_171;
#endif
F_70 ( V_213 , V_121 , & V_264 , V_127 ) ;
if ( F_105 ( V_121 ) - 1 >=
V_2 -> V_23 -> V_267 ( V_213 , V_5 ) ) {
error = F_118 ( V_213 , V_5 , & V_64 ) ;
if ( error )
goto V_171;
if ( V_64 ) {
ASSERT ( F_105 ( V_4 ) >=
...
union V_94 * V_202 ;
union V_51 * V_203 ;
V_207 = F_42 ( V_2 , V_198 + 1 , V_121 ) ;
V_208 = F_43 ( V_2 , V_198 + 1 , V_121 ) ;
V_202 = F_42 ( V_2 , 1 , V_122 ) ;
V_203 = F_43 ( V_2 , 1 , V_122 ) ;
#ifdef F_104
...
#endif
F_84 ( V_2 , V_207 , V_202 , V_200 ) ;
F_86 ( V_2 , V_208 , V_203 , V_200 ) ;
F_90 ( V_2 , V_197 , V_198 + 1 , V_198 + V_200 ) ;
F_98 ( V_2 , V_197 , V_198 + 1 , V_198 + V_200 ) ;
} else {
union V_93 * V_210 ;
union V_93 * V_204 ;
V_210 = F_41 ( V_2 , V_198 + 1 , V_121 ) ;
V_204 = F_41 ( V_2 , 1 , V_122 ) ;
F_85 ( V_2 , V_210 , V_204 , V_200 ) ;
F_97 ( V_2 , V_197 , V_198 + 1 , V_198 + V_200 ) ;
}
F_106 ( V_2 , V_268 ) ;
F_117 ( V_121 , V_198 + V_200 ) ;
F_70 ( V_2 , V_122 , & V_264 , V_127 ) ,
F_71 ( V_2 , V_121 , & V_264 , V_127 ) ;
F_99 ( V_2 , V_197 , V_212 | V_127 ) ;
F_70 ( V_2 , V_121 , & V_264 , V_127 ) ;
if ( ! F_68 ( V_2 , & V_264 ) ) {
error = F_83 ( V_2 , & V_264 , 0 , & V_222 , & V_221 ) ;
if ( error )
goto V_171;
F_71 ( V_2 , V_222 , & V_201 , V_126 ) ;
F_99 ( V_2 , V_221 , V_126 ) ;
}
...
if ( F_68 ( V_2 , & V_214 ) )
return - V_273 ;
return F_108 ( V_2 , V_5 , & V_214 , & V_4 ) ;
}
int
F_151 (
struct V_1 * V_2 ,
...
return false ;
if ( V_275 && F_5 ( V_4 -> V_13 . V_42 . V_134 ) != V_275 -> V_277 )
return false ;
return true ;
}
bool
