...
static inline T_2 F_97 ( struct V_4 * V_5 , T_2 V_92 ,
...
void F_99 ( struct V_4 * V_5 , T_2 V_92 ,
unsigned long V_95 , const enum V_42 V_43 )
{
struct V_3 * V_7 , * V_11 ;
unsigned long V_6 ;
int V_96 ;
...
T_2 F_105 ( const struct V_4 * V_5 , bool V_102 )
{
unsigned long V_6 ;
T_2 V_103 ;
F_2 ( V_5 , & V_6 ) ;
...
void F_112 ( struct V_4 * V_5 , T_1 V_1 ,
enum V_42 V_43 )
{
F_45 ( V_5 , V_1 , V_43 ) ;
F_43 ( V_5 , V_1 , V_43 ) ;
}
bool F_104 ( const struct V_4 * V_5 )
{
struct V_17 * V_9 ;
unsigned int V_107 ;
do {
V_9 = F_113 ( V_5 -> V_7 -> V_9 ) ;
V_107 = F_114 ( & V_9 -> V_107 ) ;
if ( V_5 -> V_38 != V_91 ||
V_9 -> V_108 == V_5 )
return true ;
} while ( F_115 ( & V_9 -> V_107 , V_107 ) ||
V_9 != F_113 ( V_5 -> V_7 -> V_9 ) );
return false ;
}
static void F_116 ( struct V_17 * V_9 ,
struct V_3 * V_7 ,
...
static void F_121 ( struct V_17 * V_9 , T_2 V_82 )
{
struct V_3 * V_7 = V_9 -> V_26 ;
unsigned int V_47 = V_9 -> V_48 ;
for (; V_47 ; V_7 ++ , V_47 >>= 1 ) {
...
if ( V_112 . V_15 < F_122 ( V_5 ) )
break;
F_116 ( V_9 , V_7 , V_5 , & V_112 ) ;
}
}
}
void F_123 ( struct V_113 * V_114 )
{
struct V_17 * V_9 = F_15 ( & V_20 ) ;
...
static enum V_109 F_130 ( struct V_4 * V_5 )
{
struct V_128 * V_129 =
...
void F_132 ( struct V_128 * V_132 , struct V_130 * V_131 )
{
V_132 -> V_5 . V_36 = F_130 ;
V_132 -> V_131 = V_131 ;
}
static int T_7 F_133 ( struct V_128 * V_129 , enum V_42 V_43 )
{
F_132 ( V_129 , V_76 ) ;
do {
F_134 ( V_133 ) ;
F_135 ( & V_129 -> V_5 , V_43 ) ;
if ( F_3 ( V_129 -> V_131 ) )
F_136 () ;
F_28 ( & V_129 -> V_5 ) ;
V_43 = V_105 ;
} while ( V_129 -> V_131 && ! F_137 ( V_76 ) );
F_138 ( V_134 ) ;
return V_129 -> V_131 == NULL ;
}
static int F_139 ( struct V_4 * V_5 , struct V_135 T_8 * V_136 )
{
struct V_135 V_137 ;
T_2 V_103 ;
V_103 = F_108 ( V_5 ) ;
...
return 0 ;
V_137 = F_140 ( V_103 ) ;
if ( F_141 ( V_136 , & V_137 , sizeof( * V_136 ) ) )
return - V_138 ;
return 1 ;
}
long T_7 F_142 ( struct V_139 * V_90 )
{
struct V_128 V_129 ;
...
V_105 ) ;
F_143 ( & V_129 . V_5 , V_90 -> V_140 . V_12 ) ;
if ( F_133 ( & V_129 , V_105 ) )
goto V_141;
V_136 = V_90 -> V_140 . V_136 ;
if ( V_136 ) {
V_101 = F_139 ( & V_129 . V_5 , V_136 ) ;
if ( V_101 <= 0 )
goto V_141;
}
V_101 = - V_142 ;
...
long F_144 ( struct V_135 * V_143 , struct V_135 T_8 * V_136 ,
...
unsigned long V_144 ;
V_144 = V_76 -> V_145 ;
if ( F_145 ( V_76 ) || F_146 ( V_76 ) )
V_144 = 0 ;
F_41 ( & V_129 . V_5 , V_44 , V_43 ) ;
F_100 ( & V_129 . V_5 , F_147 ( * V_143 ) , V_144 ) ;
if ( F_133 ( & V_129 , V_43 ) )
goto V_141;
if ( V_43 == V_105 ) {
V_101 = - V_146 ;
...
V_90 -> V_140 . V_12 = F_64 ( & V_129 . V_5 ) ;
V_101 = - V_142 ;
V_141:
F_44 ( & V_129 . V_5 ) ;
return V_101 ;
}
static void F_148 ( int V_66 )
{
struct V_17 * V_9 = & F_12 ( V_20 , V_66 ) ;
int V_147 ;
for ( V_147 = 0 ; V_147 < V_148 ; V_147 ++ ) {
V_9 -> V_26 [ V_147 ] . V_9 = V_9 ;
F_149 ( & V_9 -> V_26 [ V_147 ] . V_47 ) ;
}
V_9 -> V_66 = V_66 ;
F_65 ( V_9 ) ;
}
static void F_150 ( struct V_3 * V_149 ,
struct V_3 * V_11 )
{
struct V_4 * V_5 ;
struct V_49 * V_51 ;
...
F_124 ( F_17 ( V_5 ) ) ;
F_49 ( V_5 ) ;
F_93 ( V_5 , V_149 , V_86 , 0 ) ;
V_5 -> V_7 = V_11 ;
F_91 ( V_5 , V_11 ) ;
}
}
static void F_151 ( int V_150 )
{
...
V_11 = F_15 ( & V_20 ) ;
F_19 ( & V_11 -> V_10 ) ;
F_155 ( & V_149 -> V_10 , V_151 ) ;
for ( V_147 = 0 ; V_147 < V_148 ; V_147 ++ ) {
F_150 ( & V_149 -> V_26 [ V_147 ] ,
& V_11 -> V_26 [ V_147 ] ) ;
}
F_18 ( & V_149 -> V_10 ) ;
F_18 ( & V_11 -> V_10 ) ;
...
static int F_157 ( struct V_152 * V_153 ,
...
void T_5 F_159 ( void )
{
F_157 ( & V_161 , ( unsigned long ) V_156 ,
( void * ) ( long ) F_160 () ) ;
F_161 ( & V_161 ) ;
}
int T_7
F_162 ( T_2 * V_12 , unsigned long V_85 ,
...
int T_7 F_164 ( T_2 * V_12 , unsigned long V_85 ,
const enum V_42 V_43 )
{
return F_162 ( V_12 , V_85 , V_43 ,
V_106 ) ;
}
int T_7 F_165 ( T_2 * V_12 ,
const enum V_42 V_43 )
{
return F_164 ( V_12 , 0 , V_43 ) ;
}
