...
F_19 () ;
if ( V_26 && V_26 -> F_45 )
return V_26 -> F_45 ( V_9 , V_44 , V_55 ) ;
F_30 (dev, lower_dev, iter) {
V_33 = F_45 ( V_27 , V_44 , V_55 ) ;
break;
}
return V_33 ;
}
...
if ( V_33 && V_33 != - V_34 )
return V_33 ;
return F_59 ( V_69 , V_84 , V_85 , V_9 , V_88 ,
...
if ( F_65 ( V_24 ) != V_70 )
continue;
if ( F_68 ( V_24 ) != sizeof( struct V_64 ) )
return - V_77 ;
V_65 = F_69 ( V_24 ) ;
...
struct V_96 * V_106 ;
int V_33 = 0 ;
V_99 = F_71 ( V_110 , sizeof( struct V_111 ) ,
V_112 ) ;
if ( V_99 ) {
V_33 = F_62 ( V_9 , V_99 ) ;
if ( V_33 )
...
V_106 = F_71 ( V_110 , sizeof( struct V_111 ) ,
V_113 ) ;
if ( V_106 )
V_33 = F_66 ( V_9 , V_106 ,
V_53 ) ;
...
V_113 ) ;
if ( V_106 )
return F_66 ( V_9 , V_106 ,
V_54 ) ;
return 0 ;
}
int F_73 ( struct V_114 * V_115 , struct V_96 * V_116 [] ,
...
F_74 ( V_119 . V_117 , V_117 ) ;
return V_53 ( V_9 , & V_119 . V_44 ) ;
}
int F_75 ( struct V_114 * V_115 , struct V_96 * V_116 [] ,
struct V_8 * V_9 , const unsigned char * V_117 ,
T_5 V_68 )
{
struct V_50 V_119 = {
...
F_74 ( V_119 . V_117 , V_117 ) ;
return V_54 ( V_9 , & V_119 . V_44 ) ;
}
static int F_76 ( struct V_43 * V_44 )
{
struct V_50 * V_119 = F_77 ( V_44 ) ;
struct V_120 * V_63 =
F_56 ( V_119 , struct V_120 , V_119 ) ;
T_4 V_121 = F_78 ( V_63 -> V_55 -> V_69 ) . V_121 ;
T_4 V_85 = V_63 -> V_55 -> V_110 -> V_122 ;
struct V_109 * V_110 ;
struct V_114 * V_115 ;
if ( V_63 -> V_123 < V_63 -> V_55 -> args [ 0 ] )
goto V_124;
V_110 = F_79 ( V_63 -> V_69 , V_121 , V_85 , V_125 ,
sizeof( * V_115 ) , V_126 ) ;
if ( ! V_110 )
return - V_71 ;
V_115 = F_80 ( V_110 ) ;
...
goto V_139;
if ( V_119 -> V_68 && F_81 ( V_63 -> V_69 , V_140 , V_119 -> V_68 ) )
goto V_139;
F_82 ( V_63 -> V_69 , V_110 ) ;
V_124:
V_63 -> V_123 ++ ;
return 0 ;
V_139:
...
int F_84 ( struct V_81 * V_69 , struct V_141 * V_55 ,
struct V_8 * V_9 ,
struct V_8 * V_142 , int V_123 )
{
struct V_120 V_63 = {
. V_119 . V_44 . V_82 = V_9 ,
. V_119 . V_44 . V_31 = V_49 ,
. V_9 = V_9 ,
. V_69 = V_69 ,
. V_55 = V_55 ,
. V_123 = V_123 ,
...
static struct V_8 * F_86 ( struct V_144 * V_145 )
{
struct V_23 V_24 = {
. V_31 = V_146 ,
} ;
...
int V_148 ;
F_19 () ;
for ( V_148 = 0 ; V_148 < V_145 -> V_149 ; V_148 ++ ) {
const struct V_150 * V_151 = & V_145 -> V_150 [ V_148 ] ;
if ( ! V_151 -> V_152 )
return NULL ;
V_9 = F_85 ( V_151 -> V_152 ) ;
if ( ! V_9 )
return NULL ;
V_24 . V_82 = V_9 ;
if ( F_29 ( V_9 , & V_24 ) )
return NULL ;
if ( V_148 > 0 &&
! F_87 ( & V_147 . V_94 . V_153 , & V_24 . V_94 . V_153 ) )
return NULL ;
V_147 = V_24 ;
}
return V_9 ;
}
int F_88 ( T_4 V_154 , int V_155 , struct V_144 * V_145 ,
T_6 V_156 , T_6 type , T_4 V_86 , T_4 V_157 )
{
struct V_48 V_158 = {
. V_44 . V_31 = V_47 ,
. V_154 = V_154 ,
...
struct V_8 * V_9 ;
int V_33 = 0 ;
memcpy ( & V_158 . V_145 , V_145 , sizeof( V_158 . V_145 ) ) ;
#ifdef F_89
if ( V_145 -> V_159 -> V_160 . V_161 )
return 0 ;
#endif
if ( V_145 -> V_159 -> V_160 . V_162 )
return 0 ;
V_9 = F_86 ( V_145 ) ;
if ( ! V_9 )
return 0 ;
V_158 . V_44 . V_82 = V_9 ;
V_33 = V_53 ( V_9 , & V_158 . V_44 ) ;
if ( ! V_33 )
V_145 -> V_163 |= V_164 ;
return V_33 == - V_34 ? 0 : V_33 ;
}
int F_90 ( T_4 V_154 , int V_155 , struct V_144 * V_145 ,
T_6 V_156 , T_6 type , T_4 V_157 )
{
struct V_48 V_158 = {
. V_44 . V_31 = V_47 ,
. V_154 = V_154 ,
...
{
F_92 ( V_145 -> V_159 ) ;
V_145 -> V_159 -> V_160 . V_162 = true ;
}
static bool F_93 ( struct V_8 * V_165 ,
struct V_8 * V_166 )
{
struct V_23 V_167 = {
. V_82 = V_165 ,
...
F_29 ( V_166 , & V_168 ) )
return false ;
return F_87 ( & V_167 . V_94 . V_153 , & V_168 . V_94 . V_153 ) ;
}
...
static void F_95 ( struct V_8 * V_169 ,
T_4 V_171 , T_4 * V_172 )
{
struct V_8 * V_27 ;
struct V_28 * V_29 ;
...
F_19 () ;
if ( V_173 )
V_174 = F_94 ( V_9 , V_169 ) ;
else if ( V_9 -> V_170 == V_174 )
F_95 ( V_169 , V_174 ,
& V_172 ) ;
}
V_9 -> V_170 = V_174 ;
