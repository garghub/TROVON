...
static int F_37 ( struct V_114 * V_115 , unsigned int V_134 ,
struct V_110 * V_111 ,
enum V_112 V_113 )
{
int V_124 = F_35 ( V_113 ) ;
...
if ( V_119 -> V_135 == F_38 ( V_136 ) && V_124 != V_137 )
return V_132 ;
if ( V_119 -> V_138 == F_38 ( V_139 ) && V_124 != V_125 )
return V_132 ;
