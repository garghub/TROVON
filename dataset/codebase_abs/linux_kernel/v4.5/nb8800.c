...
if ( F_178 ( V_273 -> V_22 . V_284 ) ) {
V_132 = F_179 ( V_273 -> V_22 . V_284 ) ;
if ( V_132 < 0 ) {
F_156 ( & V_273 -> V_22 , L_15 ) ;
goto V_293;
}
V_2 -> V_213 = F_180 ( V_273 -> V_22 . V_284 ) ;
}
if ( ! V_2 -> V_213 )
V_2 -> V_213 = F_181 ( V_273 -> V_22 . V_284 ,
L_16 , 0 ) ;
if ( ! V_2 -> V_213 ) {
F_156 ( & V_273 -> V_22 , L_17 ) ;
V_132 = - V_218 ;
goto V_293;
}
V_2 -> V_11 = V_12 ;
...
F_187 ( V_22 , & V_2 -> V_34 , F_55 , V_300 ) ;
F_188 ( V_22 , L_19 , V_22 -> V_177 ) ;
return 0 ;
V_212:
F_114 ( V_22 ) ;
V_293:
...
static int F_192 ( struct V_272 * V_273 )
{
struct V_21 * V_301 = F_193 ( V_273 ) ;
