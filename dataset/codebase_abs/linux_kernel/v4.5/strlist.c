...
struct V_6 * F_19 ( const char * V_27 , const struct V_28 * V_29 )
{
...
struct V_7 * F_23 ( const struct V_6 * V_11 , unsigned int V_36 )
{
struct V_7 * V_8 = NULL ;
struct V_1 * V_1 ;
V_1 = F_24 ( & V_11 -> V_2 , V_36 ) ;
if ( V_1 )
V_8 = F_2 ( V_1 , struct V_7 , V_1 ) ;
return V_8 ;
}
