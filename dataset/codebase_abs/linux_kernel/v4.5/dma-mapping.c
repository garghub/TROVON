...
V_83 = F_93 ( V_18 , V_81 , V_78 , V_79 , V_62 ,
F_90 ) ;
if ( ! V_83 )
return NULL ;
...
if ( F_123 ( V_92 , V_90 , V_8 ) )
goto V_98;
V_18 -> V_99 . V_100 = & V_101 ;
return true ;
V_98:
F_124 ( V_92 , V_18 ) ;
V_97:
...
static void F_128 ( struct V_17 * V_18 , const struct V_88 * V_89 ,
T_7 V_90 , T_7 V_8 )
{
struct V_102 * V_103 ;
V_103 = F_129 ( sizeof( * V_103 ) , V_63 ) ;
if ( ! V_103 )
return;
V_103 -> V_18 = V_18 ;
V_103 -> V_89 = V_89 ;
...
V_103 -> V_8 = V_8 ;
F_130 ( & V_104 ) ;
F_131 ( & V_103 -> V_105 , & V_106 ) ;
F_132 ( & V_104 ) ;
}
static int F_133 ( struct V_107 * V_108 ,
unsigned long V_109 , void * V_110 )
{
struct V_102 * V_111 , * V_112 ;
if ( V_109 != V_113 )
return 0 ;
F_130 ( & V_104 ) ;
F_134 (master, tmp, &iommu_dma_masters, list) {
if ( F_121 ( V_111 -> V_18 , V_111 -> V_89 ,
V_111 -> V_90 , V_111 -> V_8 ) ) {
F_135 ( & V_111 -> V_105 ) ;
F_136 ( V_111 ) ;
}
}
...
static int T_2 F_137 ( struct V_114 * V_115 )
{
struct V_107 * V_108 = F_129 ( sizeof( * V_108 ) , V_63 ) ;
int V_44 ;
if ( ! V_108 )
return - V_72 ;
V_108 -> V_116 = F_133 ;
V_108 -> V_117 = - 100 ;
V_44 = F_138 ( V_115 , V_108 ) ;
if ( V_44 ) {
F_126 ( L_7 ,
V_115 -> V_118 ) ;
F_136 ( V_108 ) ;
...
V_44 = F_137 ( & V_120 ) ;
if ( ! V_44 )
F_133 ( NULL , V_113 , NULL ) ;
return V_44 ;
}
static void F_141 ( struct V_17 * V_18 , T_7 V_90 , T_7 V_8 ,
...
F_128 ( V_18 , V_89 , V_90 , V_8 ) ;
}
}
void F_144 ( struct V_17 * V_18 )
{
struct V_91 * V_92 = F_110 ( V_18 ) ;
if ( V_92 ) {
F_124 ( V_92 , V_18 ) ;
...
V_18 -> V_99 . V_100 = NULL ;
}
static void F_141 ( struct V_17 * V_18 , T_7 V_90 , T_7 V_8 ,
struct V_88 * V_123 )
{ }
void F_145 ( struct V_17 * V_18 , T_7 V_90 , T_7 V_8 ,
struct V_88 * V_123 , bool V_4 )
{
if ( ! V_18 -> V_99 . V_100 )
V_18 -> V_99 . V_100 = & V_124 ;
V_18 -> V_99 . V_125 = V_4 ;
F_141 ( V_18 , V_90 , V_8 , V_123 ) ;
}
