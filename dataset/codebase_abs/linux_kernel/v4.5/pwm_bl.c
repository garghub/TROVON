...
struct V_50 V_18 ;
struct V_16 * V_17 ;
struct V_32 * V_33 = V_48 -> V_7 . V_34 ;
struct V_1 * V_2 ;
int V_51 = V_20 ;
int V_39 ;
if ( ! V_31 ) {
...
if ( V_31 -> V_14 ) {
unsigned int V_54 ;
for ( V_54 = 0 ; V_54 <= V_31 -> V_42 ; V_54 ++ )
if ( V_31 -> V_14 [ V_54 ] > V_2 -> V_15 )
V_2 -> V_15 = V_31 -> V_14 [ V_54 ] ;
V_2 -> V_14 = V_31 -> V_14 ;
} else
V_2 -> V_15 = V_31 -> V_42 ;
V_2 -> V_24 = V_31 -> V_24 ;
...
V_2 -> V_6 = F_30 ( & V_48 -> V_7 , L_7 ) ;
if ( F_22 ( V_2 -> V_6 ) ) {
V_39 = F_23 ( V_2 -> V_6 ) ;
goto V_53;
}
if ( V_33 && V_33 -> V_57 && ! F_31 ( V_2 -> V_6 ) )
V_51 = V_59 ;
V_2 -> V_9 = F_32 ( & V_48 -> V_7 , NULL ) ;
if ( F_22 ( V_2 -> V_9 ) && F_23 ( V_2 -> V_9 ) != - V_60 && ! V_33 ) {
F_3 ( & V_48 -> V_7 , L_8 ) ;
V_2 -> V_61 = true ;
V_2 -> V_9 = F_33 ( V_31 -> V_62 , L_9 ) ;
}
if ( F_22 ( V_2 -> V_9 ) ) {
V_39 = F_23 ( V_2 -> V_9 ) ;
if ( V_39 != - V_60 )
...
F_34 ( & V_48 -> V_7 , L_11 ) ;
V_2 -> V_10 = F_35 ( V_2 -> V_9 ) ;
if ( ! V_2 -> V_10 && ( V_31 -> V_63 > 0 ) ) {
V_2 -> V_10 = V_31 -> V_63 ;
F_36 ( V_2 -> V_9 , V_31 -> V_63 ) ;
}
V_2 -> V_12 = V_31 -> V_12 * ( V_2 -> V_10 / V_2 -> V_15 ) ;
memset ( & V_18 , 0 , sizeof( struct V_50 ) ) ;
V_18 . type = V_64 ;
V_18 . V_42 = V_31 -> V_42 ;
V_17 = F_37 ( F_38 ( & V_48 -> V_7 ) , & V_48 -> V_7 , V_2 ,
& V_65 , & V_18 ) ;
if ( F_22 ( V_17 ) ) {
F_3 ( & V_48 -> V_7 , L_12 ) ;
V_39 = F_23 ( V_17 ) ;
...
static int F_47 ( struct V_29 * V_7 )
{
struct V_16 * V_17 = F_48 ( V_7 ) ;
struct V_1 * V_2 = F_12 ( V_17 ) ;
if ( V_2 -> V_24 )
V_2 -> V_24 ( V_2 -> V_7 , 0 ) ;
F_6 ( V_2 ) ;
