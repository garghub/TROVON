...
static int F_57 ( struct V_1 * V_2 , T_1 * V_265 )
{
T_1 V_84 [ V_253 ] ;
int V_27 ;
if ( ! V_265 || F_58 ( V_265 ) )
...
memcpy ( V_84 , V_265 , V_253 ) ;
V_27 = F_44 ( V_2 , V_266 ,
V_227 , 0 , V_84 , true ) ;
return V_27 ;
}
int F_59 ( struct V_1 * V_2 , T_1 * V_265 )
{
int V_27 = 0 ;
if ( ! V_2 -> V_158 )
return 0 ;
...
struct V_1 * V_2 ;
int V_30 ;
for ( V_30 = 0 ; V_30 < V_8 -> V_271 ; V_30 ++ ) {
V_2 = V_8 -> V_2 [ V_30 ] ;
if ( V_2 )
F_59 ( V_2 , NULL ) ;
}
