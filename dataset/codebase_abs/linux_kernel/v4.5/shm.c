...
if ( V_44 )
goto V_216;
F_47 ( & V_43 -> V_217 -> V_218 ) ;
if ( V_69 && ! ( V_94 & V_198 ) ) {
V_44 = - V_83 ;
if ( V_69 + V_96 < V_69 )
goto V_219;
if ( F_120 ( V_43 -> V_217 , V_69 , V_69 + V_96 ) )
goto V_219;
}
V_69 = F_121 ( V_37 , V_69 , V_96 , V_189 , V_89 , 0 , & V_193 ) ;
* V_187 = V_69 ;
V_44 = 0 ;
if ( F_122 ( V_69 ) )
V_44 = ( long ) V_69 ;
...
V_14 -> V_42 ,
V_14 -> V_16 ,
F_127 ( V_223 , V_14 -> V_15 . V_137 ) ,
F_128 ( V_223 , V_14 -> V_15 . V_138 ) ,
F_127 ( V_223 , V_14 -> V_15 . V_224 ) ,
F_128 ( V_223 , V_14 -> V_15 . V_225 ) ,
V_14 -> V_41 ,
V_14 -> V_52 ,
V_14 -> V_119 ,
V_158 * V_47 ,
