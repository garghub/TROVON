...
F_112 ( V_6 , V_247 ) ;
V_6 -> V_248 ( V_6 ) ;
V_6 -> V_15 &= F_119 ( V_249 ) ;
}
V_28:
F_11 ( V_6 ) ;
return V_220 ;
}
int F_120 ( T_11 V_250 )
{
struct V_5 * V_6 ;
int V_24 ;
V_6 = F_75 ( V_250 ) ;
...
static void F_141 ( struct V_5 * V_6 , T_7 V_140 )
{
bool V_278 , V_279 ;
...
int F_145 ( unsigned int V_284 , void T_2 * V_204 )
{
struct V_5 * V_6 ;
struct V_285 V_286 ;
int V_24 = 0 ;
...
static int F_150 ( void * V_166 , bool V_317 )
{
...
{
struct V_5 * V_6 = F_152 ( V_319 , struct V_5 , V_320 ) ;
int V_24 ;
F_23 ( L_11 , V_6 -> V_36 ) ;
if ( F_6 ( V_14 , & V_6 -> V_15 ) &&
F_2 ( V_6 , V_239 ) &&
...
{
struct V_5 * V_6 = F_152 ( V_319 , struct V_5 ,
V_252 . V_319 ) ;
F_23 ( L_11 , V_6 -> V_36 ) ;
F_128 ( V_6 ) ;
}
...
{
struct V_5 * V_6 = F_152 ( V_319 , struct V_5 , V_322 ) ;
F_23 ( L_11 , V_6 -> V_36 ) ;
if ( V_6 -> V_323 )
...
{
struct V_331 * V_332 ;
F_160 (k, &hdev->long_term_keys, list) {
F_161 ( & V_332 -> V_171 ) ;
F_162 ( V_332 , V_330 ) ;
}
}
...
{
struct V_333 * V_332 ;
F_160 (k, &hdev->identity_resolving_keys, list) {
F_161 ( & V_332 -> V_171 ) ;
F_162 ( V_332 , V_330 ) ;
}
}
struct V_328 * F_165 ( struct V_5 * V_6 , T_9 * V_111 )
{
struct V_328 * V_332 ;
F_166 () ;
F_160 (k, &hdev->link_keys, list) {
...
static bool F_168 ( struct V_5 * V_6 , struct V_334 * V_256 ,
T_7 V_335 , T_7 V_336 )
{
if ( V_335 < 0x03 )
return true ;
...
static T_7 F_169 ( T_7 type )
{
if ( type == V_342 )
return V_343 ;
return V_344 ;
}
struct V_331 * F_170 ( struct V_5 * V_6 , T_9 * V_111 ,
T_7 V_345 , T_7 V_346 )
{
struct V_331 * V_332 ;
F_166 () ;
...
continue;
if ( F_171 ( V_332 ) || F_169 ( V_332 -> type ) == V_346 ) {
F_167 () ;
return V_332 ;
}
}
...
struct V_333 * F_172 ( struct V_5 * V_6 , T_9 * V_348 )
{
struct V_333 * V_349 ;
F_166 () ;
F_160 (irk, &hdev->identity_resolving_keys, list) {
...
F_160 (irk, &hdev->identity_resolving_keys, list) {
if ( F_173 ( V_6 , V_349 -> V_350 , V_348 ) ) {
...
struct V_333 * F_174 ( struct V_5 * V_6 , T_9 * V_111 ,
T_7 V_345 )
{
struct V_333 * V_349 ;
...
struct V_328 * F_175 ( struct V_5 * V_6 , struct V_334 * V_256 ,
T_9 * V_111 , T_7 * V_350 , T_7 type ,
T_7 V_353 , bool * V_354 )
{
struct V_328 * V_329 , * V_355 ;
T_7 V_336 ;
V_355 = F_165 ( V_6 , V_111 ) ;
if ( V_355 ) {
V_336 = V_355 -> type ;
V_329 = V_355 ;
} else {
...
V_329 -> type = type ;
if ( V_354 )
* V_354 = F_168 ( V_6 , V_256 , type ,
V_336 ) ;
return V_329 ;
}
struct V_331 * F_177 ( struct V_5 * V_6 , T_9 * V_111 ,
T_7 V_345 , T_7 type , T_7 V_359 ,
T_7 V_360 [ 16 ] , T_7 V_361 , T_5 V_362 , T_12 rand )
{
struct V_331 * V_329 , * V_355 ;
T_7 V_346 = F_169 ( type ) ;
V_355 = F_170 ( V_6 , V_111 , V_345 , V_346 ) ;
if ( V_355 )
V_329 = V_355 ;
else {
V_329 = F_97 ( sizeof( * V_329 ) , V_181 ) ;
...
struct V_333 * F_178 ( struct V_5 * V_6 , T_9 * V_111 ,
T_7 V_345 , T_7 V_350 [ 16 ] , T_9 * V_348 )
{
struct V_333 * V_349 ;
V_349 = F_174 ( V_6 , V_111 , V_345 ) ;
if ( ! V_349 ) {
...
V_349 -> V_345 = V_345 ;
F_176 ( & V_349 -> V_171 , & V_6 -> V_364 ) ;
}
memcpy ( V_349 -> V_350 , V_350 , 16 ) ;
F_60 ( & V_349 -> V_348 , V_348 ) ;
return V_349 ;
}
int F_179 ( struct V_5 * V_6 , T_9 * V_111 )
{
struct V_328 * V_329 ;
V_329 = F_165 ( V_6 , V_111 ) ;
if ( ! V_329 )
return - V_365 ;
...
int F_180 ( struct V_5 * V_6 , T_9 * V_111 , T_7 V_347 )
{
struct V_331 * V_332 ;
int V_366 = 0 ;
F_160 (k, &hdev->long_term_keys, list) {
...
void F_181 ( struct V_5 * V_6 , T_9 * V_111 , T_7 V_345 )
{
struct V_333 * V_332 ;
F_160 (k, &hdev->identity_resolving_keys, list) {
...
bool F_182 ( struct V_5 * V_6 , T_9 * V_111 , T_7 type )
{
struct V_331 * V_332 ;
struct V_333 * V_349 ;
T_7 V_345 ;
...
static void F_184 ( struct V_318 * V_319 )
{
struct V_5 * V_6 = F_152 ( V_319 , struct V_5 ,
V_260 . V_319 ) ;
if ( V_6 -> V_246 ) {
struct V_369 * V_370 = ( void * ) V_6 -> V_246 -> V_166 ;
T_8 V_371 = F_185 ( V_370 -> V_371 ) ;
F_30 ( L_20 , V_6 -> V_36 , V_371 ) ;
} else {
F_30 ( L_21 , V_6 -> V_36 ) ;
}
F_113 ( & V_6 -> V_229 , 1 ) ;
F_186 ( V_6 -> V_267 , & V_6 -> V_241 ) ;
}
struct V_372 * F_187 ( struct V_5 * V_6 ,
T_9 * V_111 , T_7 V_347 )
{
struct V_372 * V_166 ;
...
int F_189 ( struct V_5 * V_6 , T_9 * V_111 ,
...
struct V_379 * F_190 ( struct V_5 * V_6 , T_7 V_380 )
{
struct V_379 * V_381 ;
...
{
struct V_379 * V_382 ;
V_382 = F_190 ( V_6 , V_380 ) ;
if ( ! V_382 )
return NULL ;
if ( V_382 == F_192 ( & V_6 -> V_383 ,
struct V_379 , V_171 ) )
return F_193 ( & V_6 -> V_383 ,
struct V_379 , V_171 ) ;
else
return F_194 ( V_382 , V_171 ) ;
}
int F_195 ( struct V_5 * V_6 , T_7 V_380 )
{
struct V_379 * V_381 ;
V_381 = F_190 ( V_6 , V_380 ) ;
if ( ! V_381 )
return - V_365 ;
...
int F_197 ( struct V_5 * V_6 , T_7 V_380 , T_10 V_15 ,
T_8 V_387 , T_7 * V_388 ,
T_8 V_389 , T_7 * V_390 ,
T_8 V_391 , T_8 V_392 )
{
...
struct V_398 * F_198 ( struct V_169 * V_398 ,
T_9 * V_111 , T_7 type )
{
struct V_398 * V_352 ;
...
int F_200 ( struct V_169 * V_171 , T_9 * V_111 , T_7 type )
{
struct V_398 * V_399 ;
if ( ! F_90 ( V_111 , V_112 ) )
return - V_400 ;
if ( F_198 ( V_171 , V_111 , type ) )
return - V_401 ;
...
struct V_255 * F_202 ( struct V_5 * V_6 ,
T_9 * V_402 , T_7 V_345 )
{
struct V_255 * V_403 ;
...
struct V_255 * F_203 ( struct V_169 * V_171 ,
T_9 * V_402 , T_7 V_345 )
{
struct V_255 * V_54 ;
...
struct V_255 * F_204 ( struct V_5 * V_6 ,
T_9 * V_402 , T_7 V_345 )
{
struct V_255 * V_403 ;
V_403 = F_202 ( V_6 , V_402 , V_345 ) ;
if ( V_403 )
return V_403 ;
...
static void F_205 ( struct V_255 * V_403 )
{
if ( V_403 -> V_256 ) {
F_125 ( V_403 -> V_256 ) ;
F_126 ( V_403 -> V_256 ) ;
...
void F_206 ( struct V_5 * V_6 , T_9 * V_402 , T_7 V_345 )
{
struct V_255 * V_403 ;
V_403 = F_202 ( V_6 , V_402 , V_345 ) ;
if ( ! V_403 )
...
void F_209 ( struct V_5 * V_6 , T_9 * V_111 ,
T_7 * V_347 )
{
if ( F_2 ( V_6 , V_417 ) ||
! F_90 ( & V_6 -> V_111 , V_112 ) ||
...
F_88 ( & V_6 -> V_383 ) ;
F_212 ( & V_6 -> V_242 , V_460 ) ;
F_212 ( & V_6 -> V_241 , V_461 ) ;
F_212 ( & V_6 -> V_240 , V_462 ) ;
F_212 ( & V_6 -> V_320 , F_151 ) ;
F_212 ( & V_6 -> V_322 , F_157 ) ;
F_213 ( & V_6 -> V_252 , F_156 ) ;
F_214 ( & V_6 -> V_244 ) ;
F_214 ( & V_6 -> V_243 ) ;
F_214 ( & V_6 -> V_269 ) ;
F_215 ( & V_6 -> V_463 ) ;
F_213 ( & V_6 -> V_260 , F_184 ) ;
F_216 ( V_6 ) ;
F_217 ( V_6 ) ;
F_218 ( V_6 ) ;
return V_6 ;
}
void F_219 ( struct V_5 * V_6 )
{
F_220 ( & V_6 -> V_250 ) ;
}
int F_221 ( struct V_5 * V_6 )
{
int V_148 , error ;
...
switch ( V_6 -> V_51 ) {
case V_52 :
V_148 = F_222 ( & V_465 , 0 , 0 , V_181 ) ;
break;
case V_53 :
V_148 = F_222 ( & V_465 , 1 , 0 , V_181 ) ;
break;
default:
return - V_18 ;
}
...
V_6 -> V_267 = F_223 ( L_11 , V_466 | V_467 |
V_468 , 1 , V_6 -> V_36 ) ;
if ( ! V_6 -> V_267 ) {
error = - V_219 ;
goto V_24;
}
V_6 -> V_253 = F_223 ( L_11 , V_466 | V_467 |
V_468 , 1 , V_6 -> V_36 ) ;
if ( ! V_6 -> V_253 ) {
F_224 ( V_6 -> V_267 ) ;
error = - V_219 ;
...
if ( ! F_225 ( V_469 ) )
V_6 -> V_30 = F_226 ( V_6 -> V_36 , V_469 ) ;
F_227 ( & V_6 -> V_250 , L_11 , V_6 -> V_36 ) ;
error = F_228 ( & V_6 -> V_250 ) ;
if ( error < 0 )
goto V_470;
V_6 -> V_471 = F_229 ( V_6 -> V_36 , & V_6 -> V_250 ,
V_472 , & V_473 ,
V_6 ) ;
if ( V_6 -> V_471 ) {
if ( F_230 ( V_6 -> V_471 ) < 0 ) {
F_231 ( V_6 -> V_471 ) ;
V_6 -> V_471 = NULL ;
}
}
if ( V_6 -> V_471 && F_232 ( V_6 -> V_471 ) )
F_18 ( V_6 , V_222 ) ;
F_18 ( V_6 , V_136 ) ;
F_18 ( V_6 , V_251 ) ;
if ( V_6 -> V_51 == V_52 ) {
...
F_112 ( V_6 , V_475 ) ;
F_78 ( V_6 ) ;
F_186 ( V_6 -> V_253 , & V_6 -> V_320 ) ;
return V_148 ;
V_470:
F_224 ( V_6 -> V_267 ) ;
F_224 ( V_6 -> V_253 ) ;
V_24:
F_235 ( & V_465 , V_6 -> V_148 ) ;
return error ;
}
...
return - V_219 ;
F_249 ( V_11 ) = V_482 ;
memcpy ( F_250 ( V_11 , 3 ) , V_479 , 3 ) ;
return F_251 ( V_6 , V_11 ) ;
}
int F_251 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
...
F_252 ( V_11 ) -> V_486 = 1 ;
F_253 ( V_11 ) ;
F_254 ( & V_6 -> V_244 , V_11 ) ;
F_186 ( V_6 -> V_267 , & V_6 -> V_242 ) ;
return 0 ;
}
int F_255 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
F_249 ( V_11 ) = V_487 ;
F_253 ( V_11 ) ;
F_254 ( & V_6 -> V_244 , V_11 ) ;
...
int F_256 ( struct V_488 * V_489 )
{
F_23 ( L_32 , V_489 , V_489 -> V_36 ) ;
F_257 ( & V_490 ) ;
F_258 ( & V_489 -> V_171 , & V_491 ) ;
F_259 ( & V_490 ) ;
return 0 ;
}
int F_260 ( struct V_488 * V_489 )
{
F_23 ( L_32 , V_489 , V_489 -> V_36 ) ;
F_257 ( & V_490 ) ;
F_86 ( & V_489 -> V_171 ) ;
...
static void F_261 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
int V_24 ;
F_23 ( L_33 , V_6 -> V_36 , F_249 ( V_11 ) ,
V_11 -> V_492 ) ;
F_253 ( V_11 ) ;
F_262 ( V_6 , V_11 ) ;
if ( F_263 ( & V_6 -> V_493 ) ) {
...
int F_266 ( struct V_5 * V_6 , T_11 V_371 , T_13 V_494 ,
const void * V_54 )
{
struct V_10 * V_11 ;
F_23 ( L_35 , V_6 -> V_36 , V_371 , V_494 ) ;
V_11 = F_267 ( V_6 , V_371 , V_494 , V_54 ) ;
if ( ! V_11 ) {
F_30 ( L_36 , V_6 -> V_36 ) ;
return - V_219 ;
}
F_252 ( V_11 ) -> V_495 . V_496 |= V_497 ;
F_254 ( & V_6 -> V_243 , V_11 ) ;
F_186 ( V_6 -> V_267 , & V_6 -> V_241 ) ;
return 0 ;
}
void * F_268 ( struct V_5 * V_6 , T_11 V_371 )
{
struct V_369 * V_498 ;
if ( ! V_6 -> V_246 )
return NULL ;
...
struct V_10 * F_269 ( struct V_5 * V_6 , T_8 V_371 , T_10 V_494 ,
const void * V_54 , T_10 V_391 )
{
struct V_10 * V_11 ;
if ( ! F_6 ( V_14 , & V_6 -> V_15 ) )
return F_270 ( - V_16 ) ;
F_271 ( V_6 , L_38 , V_371 , V_494 ) ;
F_9 ( V_6 ) ;
V_11 = F_10 ( V_6 , V_371 , V_494 , V_54 , V_391 ) ;
F_11 ( V_6 ) ;
return V_11 ;
}
static void F_272 ( struct V_10 * V_11 , T_11 V_500 , T_11 V_15 )
{
struct V_501 * V_498 ;
int V_492 = V_11 -> V_492 ;
F_273 ( V_11 , V_502 ) ;
F_274 ( V_11 ) ;
V_498 = (struct V_501 * ) F_275 ( V_11 ) ;
V_498 -> V_500 = F_32 ( F_276 ( V_500 , V_15 ) ) ;
V_498 -> V_503 = F_32 ( V_492 ) ;
}
static void F_277 ( struct V_504 * V_505 , struct V_506 * V_507 ,
struct V_10 * V_11 , T_11 V_15 )
{
struct V_334 * V_256 = V_505 -> V_256 ;
struct V_5 * V_6 = V_256 -> V_6 ;
struct V_10 * V_171 ;
V_11 -> V_492 = F_278 ( V_11 ) ;
V_11 -> V_508 = 0 ;
F_249 ( V_11 ) = V_484 ;
switch ( V_6 -> V_51 ) {
case V_52 :
F_272 ( V_11 , V_256 -> V_500 , V_15 ) ;
break;
case V_53 :
F_272 ( V_11 , V_505 -> V_500 , V_15 ) ;
break;
default:
F_30 ( L_39 , V_6 -> V_36 , V_6 -> V_51 ) ;
return;
}
V_171 = F_279 ( V_11 ) -> V_509 ;
if ( ! V_171 ) {
F_23 ( L_40 , V_6 -> V_36 , V_11 , V_11 -> V_492 ) ;
F_254 ( V_507 , V_11 ) ;
} else {
F_23 ( L_41 , V_6 -> V_36 , V_11 , V_11 -> V_492 ) ;
F_279 ( V_11 ) -> V_509 = NULL ;
F_280 ( & V_507 -> V_450 ) ;
F_281 ( V_507 , V_11 ) ;
V_15 &= ~ V_510 ;
V_15 |= V_511 ;
...
void F_283 ( struct V_504 * V_505 , struct V_10 * V_11 , T_11 V_15 )
{
struct V_5 * V_6 = V_505 -> V_256 -> V_6 ;
F_23 ( L_42 , V_6 -> V_36 , V_505 , V_15 ) ;
F_277 ( V_505 , & V_505 -> V_513 , V_11 , V_15 ) ;
F_186 ( V_6 -> V_267 , & V_6 -> V_240 ) ;
}
void F_284 ( struct V_334 * V_256 , struct V_10 * V_11 )
{
struct V_5 * V_6 = V_256 -> V_6 ;
struct V_514 V_498 ;
...
F_273 ( V_11 , V_515 ) ;
F_274 ( V_11 ) ;
memcpy ( F_275 ( V_11 ) , & V_498 , V_515 ) ;
F_249 ( V_11 ) = V_485 ;
F_254 ( & V_256 -> V_513 , V_11 ) ;
F_186 ( V_6 -> V_267 , & V_6 -> V_240 ) ;
}
static struct V_334 * F_285 ( struct V_5 * V_6 , T_6 type ,
int * V_516 )
{
...
F_166 () ;
F_160 (c, &h->list, list) {
if ( V_519 -> type != type || F_286 ( & V_519 -> V_513 ) )
continue;
...
static void F_288 ( struct V_5 * V_6 , T_6 type )
{
struct V_517 * V_518 = & V_6 -> V_459 ;
struct V_334 * V_519 ;
F_30 ( L_46 , V_6 -> V_36 ) ;
...
static struct V_504 * F_290 ( struct V_5 * V_6 , T_6 type ,
int * V_516 )
{
struct V_517 * V_518 = & V_6 -> V_459 ;
...
continue;
V_530 ++ ;
F_160 (tmp, &conn->chan_list, list) {
struct V_10 * V_11 ;
if ( F_286 ( & V_327 -> V_513 ) )
continue;
V_11 = F_291 ( & V_327 -> V_513 ) ;
if ( V_11 -> V_531 < V_529 )
continue;
if ( V_11 -> V_531 > V_529 ) {
V_187 = 0 ;
...
static void F_292 ( struct V_5 * V_6 , T_6 type )
{
struct V_517 * V_518 = & V_6 -> V_459 ;
struct V_334 * V_256 ;
int V_187 = 0 ;
...
continue;
V_187 ++ ;
F_160 (chan, &conn->chan_list, list) {
struct V_10 * V_11 ;
if ( V_505 -> V_370 ) {
V_505 -> V_370 = 0 ;
continue;
}
if ( F_286 ( & V_505 -> V_513 ) )
continue;
V_11 = F_291 ( & V_505 -> V_513 ) ;
...
static inline int F_293 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
return F_294 ( V_11 -> V_492 - V_502 , V_6 -> V_535 ) ;
}
static void F_295 ( struct V_5 * V_6 , unsigned int V_522 )
{
if ( ! F_2 ( V_6 , V_213 ) ) {
if ( ! V_522 && F_296 ( V_186 , V_6 -> V_536 +
V_537 ) )
F_288 ( V_6 , V_524 ) ;
}
}
...
F_295 ( V_6 , V_522 ) ;
while ( V_6 -> V_273 &&
( V_505 = F_290 ( V_6 , V_524 , & V_516 ) ) ) {
T_10 V_531 = ( F_291 ( & V_505 -> V_513 ) ) -> V_531 ;
while ( V_516 -- && ( V_11 = F_291 ( & V_505 -> V_513 ) ) ) {
F_23 ( L_50 , V_505 , V_11 ,
V_11 -> V_492 , V_11 -> V_531 ) ;
if ( V_11 -> V_531 < V_531 )
break;
V_11 = F_298 ( & V_505 -> V_513 ) ;
F_299 ( V_505 -> V_256 ,
F_252 ( V_11 ) -> V_538 ) ;
F_261 ( V_6 , V_11 ) ;
V_6 -> V_536 = V_186 ;
...
type = V_524 ;
while ( V_6 -> V_533 > 0 &&
( V_505 = F_290 ( V_6 , type , & V_516 ) ) ) {
T_10 V_531 = ( F_291 ( & V_505 -> V_513 ) ) -> V_531 ;
while ( V_516 > 0 && ( V_11 = F_291 ( & V_505 -> V_513 ) ) ) {
int V_539 ;
F_23 ( L_50 , V_505 , V_11 ,
V_11 -> V_492 , V_11 -> V_531 ) ;
if ( V_11 -> V_531 < V_531 )
...
{
F_23 ( L_11 , V_6 -> V_36 ) ;
if ( ! F_287 ( V_6 , V_524 ) && V_6 -> V_51 == V_52 )
return;
if ( ! F_287 ( V_6 , V_532 ) && V_6 -> V_51 == V_53 )
return;
switch ( V_6 -> V_38 ) {
case V_39 :
F_297 ( V_6 ) ;
...
if ( ! F_287 ( V_6 , V_525 ) )
return;
while ( V_6 -> V_274 && ( V_256 = F_285 ( V_6 , V_525 , & V_516 ) ) ) {
while ( V_516 -- && ( V_11 = F_298 ( & V_256 -> V_513 ) ) ) {
...
if ( ! F_287 ( V_6 , V_526 ) )
return;
while ( V_6 -> V_274 && ( V_256 = F_285 ( V_6 , V_526 ,
& V_516 ) ) ) {
while ( V_516 -- && ( V_11 = F_298 ( & V_256 -> V_513 ) ) ) {
F_23 ( L_51 , V_11 , V_11 -> V_492 ) ;
F_261 ( V_6 , V_11 ) ;
...
F_296 ( V_186 , V_6 -> V_540 + V_541 * 45 ) )
F_288 ( V_6 , V_339 ) ;
}
V_522 = V_6 -> V_315 ? V_6 -> V_275 : V_6 -> V_273 ;
V_327 = V_522 ;
while ( V_522 && ( V_505 = F_290 ( V_6 , V_339 , & V_516 ) ) ) {
T_10 V_531 = ( F_291 ( & V_505 -> V_513 ) ) -> V_531 ;
while ( V_516 -- && ( V_11 = F_291 ( & V_505 -> V_513 ) ) ) {
F_23 ( L_50 , V_505 , V_11 ,
V_11 -> V_492 , V_11 -> V_531 ) ;
...
{
struct V_5 * V_6 = F_152 ( V_319 , struct V_5 , V_240 ) ;
struct V_10 * V_11 ;
...
while ( ( V_11 = F_298 ( & V_6 -> V_269 ) ) )
F_261 ( V_6 , V_11 ) ;
}
static void F_305 ( struct V_5 * V_6 , struct V_10 * V_11 )
{
struct V_501 * V_498 = ( void * ) V_11 -> V_166 ;
struct V_334 * V_256 ;
T_11 V_500 , V_15 ;
F_306 ( V_11 , V_502 ) ;
V_500 = F_185 ( V_498 -> V_500 ) ;
V_15 = F_307 ( V_500 ) ;
V_500 = F_308 ( V_500 ) ;
...
V_6 -> V_276 . V_542 ++ ;
F_101 ( V_6 ) ;
V_256 = F_309 ( V_6 , V_500 ) ;
F_104 ( V_6 ) ;
if ( V_256 ) {
F_299 ( V_256 , V_543 ) ;
F_310 ( V_256 , V_11 , V_15 ) ;
return;
} else {
F_30 ( L_54 ,
V_6 -> V_36 , V_500 ) ;
...
static bool F_313 ( struct V_5 * V_6 )
{
struct V_10 * V_11 ;
V_11 = F_291 ( & V_6 -> V_243 ) ;
if ( ! V_11 )
return true ;
return ( F_252 ( V_11 ) -> V_495 . V_496 & V_497 ) ;
}
...
V_371 = F_185 ( V_370 -> V_371 ) ;
if ( V_371 == V_22 )
return;
V_11 = F_315 ( V_6 -> V_246 , V_181 ) ;
if ( ! V_11 )
return;
F_316 ( & V_6 -> V_243 , V_11 ) ;
F_186 ( V_6 -> V_267 , & V_6 -> V_241 ) ;
}
void F_317 ( struct V_5 * V_6 , T_8 V_371 , T_7 V_545 ,
T_14 * V_546 ,
T_15 * V_547 )
{
struct V_10 * V_11 ;
...
if ( ! V_545 && ! F_313 ( V_6 ) )
return;
if ( F_252 ( V_6 -> V_246 ) -> V_495 . V_496 & V_548 ) {
* V_547 = F_252 ( V_6 -> V_246 ) -> V_495 . V_547 ;
return;
}
if ( F_252 ( V_6 -> V_246 ) -> V_495 . V_546 ) {
* V_546 = F_252 ( V_6 -> V_246 ) -> V_495 . V_546 ;
return;
}
F_318 ( & V_6 -> V_243 . V_450 , V_15 ) ;
while ( ( V_11 = F_319 ( & V_6 -> V_243 ) ) ) {
if ( F_252 ( V_11 ) -> V_495 . V_496 & V_497 ) {
F_320 ( & V_6 -> V_243 , V_11 ) ;
break;
}
if ( F_252 ( V_11 ) -> V_495 . V_496 & V_548 )
* V_547 = F_252 ( V_11 ) -> V_495 . V_547 ;
else
* V_546 = F_252 ( V_11 ) -> V_495 . V_546 ;
F_14 ( V_11 ) ;
}
F_321 ( & V_6 -> V_243 . V_450 , V_15 ) ;
}
static void V_460 ( struct V_318 * V_319 )
{
struct V_5 * V_6 = F_152 ( V_319 , struct V_5 , V_242 ) ;
struct V_10 * V_11 ;
F_23 ( L_11 , V_6 -> V_36 ) ;
while ( ( V_11 = F_298 ( & V_6 -> V_244 ) ) ) {
F_262 ( V_6 , V_11 ) ;
if ( F_263 ( & V_6 -> V_493 ) ) {
F_264 ( V_6 , V_11 ) ;
}
...
{
struct V_5 * V_6 = F_152 ( V_319 , struct V_5 , V_241 ) ;
struct V_10 * V_11 ;
F_23 ( L_61 , V_6 -> V_36 ,
F_263 ( & V_6 -> V_229 ) , F_323 ( & V_6 -> V_243 ) ) ;
if ( F_263 ( & V_6 -> V_229 ) ) {
V_11 = F_298 ( & V_6 -> V_243 ) ;
if ( ! V_11 )
return;
F_14 ( V_6 -> V_246 ) ;
V_6 -> V_246 = F_315 ( V_11 , V_181 ) ;
if ( V_6 -> V_246 ) {
F_324 ( & V_6 -> V_229 ) ;
F_261 ( V_6 , V_11 ) ;
