...
F_54 ( V_23 , V_3 , V_21 , V_5 -> V_3 -> V_39 ) ;
V_56 = F_55 ( V_23 , V_3 , V_47 , NULL , NULL , 0 ) ;
if ( V_56 < 0 )
return V_56 ;
return V_72 ;
}
static int F_56 ( struct V_22 * V_23 , struct V_2 * V_3 ,
...
static void F_65 ( struct V_2 * V_5 ,
struct V_93 * V_94 ,
void * V_95 )
{
F_66 ( & V_94 -> V_96 , & V_97 ) ;
}
static int F_67 ( struct V_2 * V_5 )
{
F_68 ( V_5 , F_65 , NULL ) ;
V_5 -> V_98 = & V_99 ;
return 0 ;
}
static void F_69 ( struct V_2 * V_5 )
{
V_5 -> V_100 = 0 ;
V_5 -> V_101 = 0 ;
...
static void F_70 ( T_3 * V_111 , T_3 * V_63 , T_3 V_67 )
{
V_111 [ 0 ] = V_63 [ 5 ] ;
V_111 [ 1 ] = V_63 [ 4 ] ;
V_111 [ 2 ] = V_63 [ 3 ] ;
...
static void F_71 ( struct V_2 * V_3 , T_1 * V_63 ,
T_3 V_67 )
{
V_3 -> V_112 = V_113 ;
F_70 ( V_3 -> V_39 , V_63 -> V_66 , V_67 ) ;
}
...
V_56 = F_78 ( V_3 ) ;
if ( V_56 < 0 )
F_75 ( L_14 , V_3 -> V_91 , V_56 ) ;
F_76 () ;
}
static void F_79 ( struct V_114 * V_115 )
{
struct V_1 * V_5 = F_80 ( V_115 , struct V_1 ,
V_116 . V_115 ) ;
F_81 ( V_5 -> V_3 ) ;
}
static bool F_82 ( struct V_117 * V_31 )
{
if ( V_31 -> type != V_118 )
return false ;
if ( ! V_119 )
...
static void F_86 ( T_3 V_67 , T_3 * V_63 )
{
if ( V_67 == V_61 )
* V_63 |= 0x02 ;
else
...
static struct V_17 * F_87 ( struct V_17 * V_14 ,
struct V_1 * V_5 )
{
struct V_6 * V_7 ;
V_7 = F_88 ( sizeof( * V_7 ) , V_34 ) ;
if ( ! V_7 )
return NULL ;
V_7 -> V_14 = V_14 ;
...
F_70 ( ( T_3 * ) & V_7 -> V_29 . V_65 + 8 , V_14 -> V_15 . V_66 ,
V_14 -> V_16 ) ;
memcpy ( & V_7 -> V_38 , ( T_3 * ) & V_7 -> V_29 . V_65 + 8 ,
V_125 ) ;
F_86 ( V_14 -> V_16 , ( T_3 * ) & V_7 -> V_29 . V_65 + 8 ) ;
F_89 ( & V_126 ) ;
F_90 ( & V_7 -> V_8 ) ;
F_2 ( V_5 , V_7 ) ;
F_91 ( & V_126 ) ;
F_92 ( & V_5 -> V_116 , F_79 ) ;
F_93 ( & V_5 -> V_116 , F_94 ( 100 ) ) ;
return V_7 -> V_14 ;
}
static int F_95 ( struct V_17 * V_14 , struct V_1 * * V_5 )
{
struct V_2 * V_3 ;
int V_56 = 0 ;
V_3 = F_96 ( F_97 ( sizeof( struct V_1 ) ) ,
V_127 , V_128 ,
F_69 ) ;
if ( ! V_3 )
return - V_129 ;
F_71 ( V_3 , & V_14 -> V_130 , V_14 -> V_131 ) ;
V_3 -> V_107 = & V_107 ;
F_98 ( V_3 , & V_14 -> V_19 -> V_31 -> V_32 -> V_5 ) ;
F_99 ( V_3 , & V_132 ) ;
* V_5 = V_1 ( V_3 ) ;
( * V_5 ) -> V_3 = V_3 ;
...
{
struct V_1 * V_30 = F_80 ( V_115 , struct V_1 ,
F_106 ) ;
F_107 ( V_30 -> V_3 ) ;
}
