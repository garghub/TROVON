...
static int F_54 ( struct V_15 * V_16 , struct V_3 * V_4 )
{
struct V_1 * V_2 = F_7 ( V_16 ) ;
struct V_83 * V_84 ;
struct V_40 V_88 = {
...
void F_74 ( struct V_1 * V_2 , T_2 * V_19 ,
struct V_124 * V_125 )
{
if ( * V_19 == 0xff ) {
...
F_75 ( & V_4 -> V_28 ) ;
F_76 ( & V_4 -> V_30 , & V_2 -> V_32 ) ;
F_77 ( & V_4 -> V_28 , V_125 ) ;
}
}
}
void F_78 ( struct V_124 * V_125 )
{
struct V_3 * V_4 , * V_38 ;
F_79 (mcast, tmcast, remove_list, list) {
F_70 ( V_4 -> V_16 , V_4 ) ;
F_5 ( V_4 ) ;
}
}
void F_80 ( struct V_15 * V_16 , T_2 * V_126 , struct V_72 * V_73 )
{
struct V_1 * V_2 = F_7 ( V_16 ) ;
struct V_3 * V_4 ;
unsigned long V_7 ;
...
sizeof ( union V_34 ) ) ;
F_22 ( V_16 , V_4 ) ;
F_77 ( & V_4 -> V_28 , & V_2 -> V_128 ) ;
}
if ( F_81 ( & V_4 -> V_22 ) < V_129 )
F_82 ( & V_4 -> V_22 , V_73 ) ;
else {
++ V_16 -> V_23 . V_17 ;
F_11 ( V_73 ) ;
...
struct V_130 * V_131 ;
F_67 ( & V_2 -> V_44 , V_7 ) ;
V_131 = F_83 ( V_16 , V_126 ) ;
F_66 ( & V_2 -> V_44 , V_7 ) ;
if ( ! V_131 ) {
V_131 = F_84 ( V_126 , V_16 ) ;
if ( V_131 ) {
F_85 ( & V_4 -> V_21 -> V_132 ) ;
V_131 -> V_21 = V_4 -> V_21 ;
F_77 ( & V_131 -> V_28 , & V_4 -> V_29 ) ;
}
}
F_67 ( & V_2 -> V_44 , V_7 ) ;
F_86 ( V_16 , V_73 , V_4 -> V_21 , V_133 ) ;
if ( V_131 )
F_87 ( V_131 ) ;
return;
}
...
F_6 ( V_2 , L_28 ) ;
F_66 ( & V_2 -> V_44 , V_7 ) ;
F_79 (mcast, tmcast, &priv->multicast_list, list) {
F_75 ( & V_4 -> V_28 ) ;
F_76 ( & V_4 -> V_30 , & V_2 -> V_32 ) ;
F_77 ( & V_4 -> V_28 , & V_125 ) ;
}
if ( V_2 -> V_43 ) {
F_76 ( & V_2 -> V_43 -> V_30 , & V_2 -> V_32 ) ;
F_77 ( & V_2 -> V_43 -> V_28 , & V_125 ) ;
V_2 -> V_43 = NULL ;
}
F_67 ( & V_2 -> V_44 , V_7 ) ;
F_79 (mcast, tmcast, &remove_list, list)
...
static int F_91 ( const T_2 * V_134 , const T_2 * V_43 )
{
...
! F_97 ( V_2 -> V_79 , V_2 -> V_64 , & V_19 , & V_88 ) ) {
F_6 ( V_2 , L_30 ,
V_19 . V_20 ) ;
continue;
}
...
struct V_141 * F_103 ( struct V_15 * V_16 )
{
struct V_141 * V_142 ;
V_142 = F_104 ( sizeof *V_142 , V_25 ) ;
if ( ! V_142 )
return NULL ;
V_142 -> V_16 = V_16 ;
...
V_142 -> V_27 = V_4 -> V_27 ;
V_142 -> V_143 = F_81 ( & V_4 -> V_22 ) ;
V_142 -> F_53 = ! ! V_4 -> V_21 ;
V_142 -> V_144 = ! ! ( V_4 -> V_7 & ( 1 << V_57 ) ) ;
V_33 = 0 ;
break;
}
V_31 = F_107 ( V_31 ) ;
