...
error = F_13 ( V_29 , L_3 , 1 , & V_11 ) ;
if ( error < 0 ) {
F_12 ( V_2 , L_5 ) ;
return error ;
}
V_4 -> V_11 = V_11 ;
error = F_13 ( V_29 , L_3 , 2 , & V_12 ) ;
if ( error < 0 ) {
F_12 ( V_2 , L_6 ) ;
return error ;
}
...
struct V_34 * V_35 ;
int error ;
V_4 = F_19 ( & V_26 -> V_2 , sizeof( * V_4 ) , V_36 ) ;
if ( ! V_4 )
return - V_37 ;
error = F_10 ( V_26 , V_4 ) ;
if ( error )
return error ;
V_35 = F_20 ( V_26 , V_38 , 0 ) ;
V_4 -> V_16 = F_21 ( & V_26 -> V_2 , V_35 ) ;
if ( F_16 ( V_4 -> V_16 ) )
return F_17 ( V_4 -> V_16 ) ;
V_33 = F_22 ( & V_26 -> V_2 ) ;
if ( ! V_33 )
return - V_37 ;
snprintf ( V_4 -> V_39 , sizeof( V_4 -> V_39 ) , L_8 , F_23 ( & V_26 -> V_2 ) ) ;
V_4 -> V_33 = V_33 ;
V_4 -> V_2 = & V_26 -> V_2 ;
V_33 -> V_5 = V_4 ;
V_33 -> V_40 = V_41 ;
...
F_24 ( V_33 -> V_14 , V_46 , V_21 ) ;
F_25 ( V_33 -> V_14 , V_23 , 0 , V_22 , 0 , 0 ) ;
F_25 ( V_33 -> V_14 , V_24 , 0 , V_22 , 0 , 0 ) ;
error = F_26 ( V_33 ) ;
if ( error ) {
F_12 ( & V_26 -> V_2 ,
L_10 ,
