...
T_1 V_26 = args -> V_26 & V_104 ;
F_72 ( L_12 , V_2 , V_96 ,
args -> V_105 . V_106 , V_26 ) ;
return F_73 ( V_2 , V_96 , args -> V_105 , V_26 ,
& args -> V_107 ) ;
}
static int F_74 ( struct V_1 * V_2 , void * V_94 ,
struct V_95 * V_96 )
{
struct V_108 * args = V_94 ;
struct V_109 * V_110 ;
int V_14 ;
F_72 ( L_13 , V_2 , V_96 , args -> V_107 , args -> V_111 ) ;
V_110 = F_75 ( V_2 , V_96 , args -> V_107 ) ;
if ( ! V_110 )
return - V_112 ;
V_14 = F_76 ( V_110 , args -> V_111 ) ;
if ( ! V_14 )
V_14 = F_77 ( V_110 , args -> V_111 ) ;
F_78 ( V_110 ) ;
return V_14 ;
}
...
struct V_109 * V_110 ;
int V_14 ;
F_72 ( L_14 , V_2 , V_96 , args -> V_107 ) ;
V_110 = F_75 ( V_2 , V_96 , args -> V_107 ) ;
if ( ! V_110 )
return - V_112 ;
V_14 = 0 ;
if ( ! V_14 )
V_14 = F_80 ( V_110 , args -> V_111 ) ;
F_78 ( V_110 ) ;
return V_14 ;
}
...
if ( ! V_110 )
return - V_112 ;
args -> V_105 = F_82 ( V_110 ) ;
args -> V_115 = F_83 ( V_110 ) ;
F_78 ( V_110 ) ;
return V_14 ;
}
static int F_84 ( struct V_1 * V_2 , unsigned long V_26 )
{
struct V_116 * V_117 = V_2 -> V_2 -> V_118 ;
struct V_3 * V_4 ;
unsigned int V_13 ;
int V_14 ;
F_2 ( L_15 , V_2 ) ;
...
if ( ! V_4 )
return - V_28 ;
V_4 -> V_101 = V_117 -> V_101 ;
V_2 -> V_5 = V_4 ;
V_4 -> V_119 = F_85 ( L_16 , 0 ) ;
F_86 ( & V_4 -> V_18 . V_22 ) ;
F_87 ( & V_4 -> V_18 . V_19 ) ;
F_88 ( & V_4 -> V_18 . V_37 ) ;
F_87 ( & V_4 -> V_120 ) ;
...
static int F_102 ( struct V_1 * V_2 , struct V_95 * V_122 )
{
V_122 -> V_123 = NULL ;
F_2 ( L_20 , V_2 , V_122 ) ;
return 0 ;
...
static void F_106 ( struct V_1 * V_2 , struct V_95 * V_122 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_124 * V_34 ;
unsigned long V_26 ;
...
if ( V_34 -> V_96 == V_122 ) {
V_122 -> V_125 += V_34 -> V_34 -> V_126 ;
V_34 -> V_96 = NULL ;
}
}
F_31 ( & V_2 -> V_31 , V_26 ) ;
}
static void F_108 ( struct V_1 * V_2 , struct V_95 * V_122 )
{
F_2 ( L_24 , V_2 , V_122 ) ;
}
static int F_109 ( struct V_127 * V_128 )
{
int V_50 ;
if ( F_110 () == false )
return - V_53 ;
...
static int F_117 ( struct V_128 * V_2 )
{
struct V_1 * V_130 = F_118 ( V_2 ) ;
F_119 ( V_130 ) ;
return 0 ;
}
static int F_120 ( struct V_128 * V_2 )
{
struct V_1 * V_130 = F_118 ( V_2 ) ;
F_121 ( V_130 ) ;
return F_122 ( V_2 ) ;
...
{
F_2 ( L_27 ) ;
return F_124 ( V_131 , F_47 ( V_131 ) ) ;
}
static void T_3 F_125 ( void )
{
F_2 ( L_28 ) ;
F_126 ( V_131 , F_47 ( V_131 ) ) ;
}
