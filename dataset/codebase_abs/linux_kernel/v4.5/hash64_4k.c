...
if ( F_4 ( V_2 & ~ V_12 ) )
return 1 ;
V_13 = V_12 | V_21 | V_22 | V_23 ;
if ( V_2 & V_24 )
V_13 |= V_25 ;
} while ( V_12 != F_5 ( ( unsigned long * ) V_4 ,
V_12 , V_13 ) );
V_10 = F_6 ( V_13 ) ;
if ( ! F_7 ( V_26 ) &&
! F_7 ( V_27 ) )
V_10 = F_8 ( V_10 , F_9 ( V_12 ) , V_5 ) ;
V_14 = F_10 ( V_1 , V_3 , V_7 ) ;
if ( F_4 ( V_12 & V_23 ) ) {
V_15 = F_11 ( V_14 , V_17 , V_7 ) ;
if ( V_12 & V_28 )
V_15 = ~ V_15 ;
V_16 = ( V_15 & V_29 ) * V_30 ;
V_16 += ( V_12 & V_31 ) >> V_32 ;
