...
{
struct V_23 * V_3 =
F_27 ( struct V_23 , V_46 ) ;
struct V_48 * V_49 ;
struct V_48 * V_61 ;
V_49 = F_27 ( struct V_48 , V_44 ) ;
if ( ( V_49 -> type == V_62 ) ||
( V_49 -> type == V_63 ) ||
( V_49 -> type == V_64 ) ) {
V_3 -> V_25 ++ ;
...
F_29 ( F_30
( V_73 , V_70 , V_36 ) ) ;
memset ( V_3 , 0 , sizeof( struct V_31 ) ) ;
V_3 -> V_33 = V_70 ;
V_3 -> V_35 = V_36 ;
V_3 -> V_37 = NULL ;
V_3 -> V_38 = V_39 ;
