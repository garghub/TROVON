...
V_158 -> V_161 = & V_162 ;
if ( type == V_73 )
V_158 -> V_163 = & V_5 -> V_60 -> V_118 ;
else
V_158 -> V_163 = & V_5 -> V_60 -> V_120 ;
V_158 -> V_69 = V_164 ;
V_158 -> V_50 = & V_5 -> V_165 ;
V_158 -> V_111 = & V_5 -> V_111 ;
V_158 -> V_166 = 0 ;
for ( V_160 = 0 ; V_160 < V_5 -> V_60 -> V_167 ; V_160 ++ )
V_158 -> V_166 |= V_5 -> V_60 -> V_168 [ V_160 ] . V_169 ;
F_69 ( V_158 -> V_159 , V_159 , sizeof( V_158 -> V_159 ) ) ;
F_70 ( V_158 , V_5 ) ;
V_109 = F_71 ( V_158 , type , - 1 ) ;
if ( V_109 < 0 ) {
F_62 ( L_38 ) ;
return V_109 ;
}
F_72 ( L_39 ,
V_5 -> V_159 , F_31 ( V_158 ) ) ;
return 0 ;
}
int F_73 ( struct V_47 * V_158 , struct V_4 * V_5 )
{
F_7 ( L_36 , V_5 ) ;
F_74 ( V_158 ) ;
return 0 ;
