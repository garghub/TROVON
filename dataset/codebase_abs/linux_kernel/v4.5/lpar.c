...
static void F_53 ( unsigned long V_73 ,
int V_28 , int V_30 )
{
unsigned long V_24 ;
...
static void F_54 ( unsigned long V_100 , int V_75 )
{
unsigned long V_24 ;
...
static int T_2 F_62 ( char * V_104 )
{
char * V_117 ;
V_117 = F_63 ( V_104 ) ;
if ( strcasecmp ( V_117 , L_21 ) == 0 || strcasecmp ( V_117 , L_19 ) == 0 ) {
F_60 ( V_105 L_22 ) ;
V_118 = 0 ;
return 1 ;
}
V_118 = 1 ;
F_60 ( V_105 L_23 ) ;
if ( strcasecmp ( V_117 , L_24 ) == 0 || strcasecmp ( V_117 , L_25 ) == 0 )
return 1 ;
return 0 ;
}
static void F_64 ( struct V_119 * V_119 , int V_120 ,
unsigned long V_121 )
{
int V_48 , V_61 ;
unsigned long V_122 , V_3 ;
V_122 = F_65 () ;
V_3 = F_7 ( ( unsigned long ) F_66 ( V_119 ) ) ;
for ( V_48 = 0 ; V_48 < ( 1 << V_120 ) ; V_48 ++ , V_3 += V_123 ) {
for ( V_61 = 0 ; V_61 < V_123 ; V_61 += V_122 )
F_67 ( V_124 , V_121 , V_3 + V_61 , 0 ) ;
}
}
void F_68 ( struct V_119 * V_119 , int V_120 )
{
if ( ! V_118 || ! F_10 ( V_125 ) )
return;
F_64 ( V_119 , V_120 , V_126 ) ;
}
void F_69 ( void )
{
F_70 ( & V_127 ) ;
...
void F_73 ( unsigned long V_129 , unsigned long * args )
{
unsigned long V_32 ;
unsigned int * V_130 ;
if ( V_129 == V_131 )
...
void F_78 ( long V_129 , unsigned long V_134 ,
unsigned long * V_135 )
{
unsigned long V_32 ;
unsigned int * V_130 ;
...
goto V_133;
( * V_130 ) ++ ;
F_79 ( V_129 , V_134 , V_135 ) ;
F_80 () ;
( * V_130 ) -- ;
V_133:
F_77 ( V_32 ) ;
}
int F_81 ( struct V_136 * V_137 )
{
int V_64 ;
unsigned long V_135 [ V_138 ] ;
V_64 = F_47 ( V_139 , V_135 ) ;
V_137 -> V_140 = V_135 [ 0 ] ;
V_137 -> V_141 = V_135 [ 1 ] ;
...
int F_82 ( struct V_150 * V_151 )
{
int V_64 ;
unsigned long V_135 [ V_138 ] = { 0 } ;
V_64 = F_47 ( V_152 , V_135 ) ;
V_151 -> V_153 = V_135 [ 0 ] ;
V_151 -> V_154 = V_135 [ 1 ] ;
V_151 -> V_155 = V_135 [ 2 ] ;
V_151 -> V_156 = V_135 [ 3 ] ;
