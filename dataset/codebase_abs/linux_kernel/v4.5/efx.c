...
static void F_219 ( struct V_249 * V_7 )
{
struct V_1 * V_2 = F_208 ( V_7 ) ;
struct V_9 * V_10 ;
F_54 (channel, efx)
...
static struct V_267 * F_229 ( struct V_249 * V_7 ,
struct V_267 * V_268 )
{
struct V_1 * V_2 = F_208 ( V_7 ) ;
F_197 ( & V_2 -> V_233 ) ;
...
static void F_230 ( struct V_249 * V_7 )
{
struct V_1 * V_2 = F_208 ( V_7 ) ;
...
static int F_231 ( struct V_249 * V_7 , int V_271 )
{
struct V_1 * V_2 = F_208 ( V_7 ) ;
int V_40 ;
V_40 = F_1 ( V_2 ) ;
...
static int F_232 ( struct V_249 * V_7 , void * V_133 )
{
struct V_1 * V_2 = F_208 ( V_7 ) ;
...
static void F_234 ( struct V_249 * V_7 )
{
struct V_1 * V_2 = F_208 ( V_7 ) ;
if ( V_2 -> V_93 )
F_235 ( V_2 -> V_227 , & V_2 -> V_134 ) ;
}
static int F_236 ( struct V_249 * V_7 , T_6 V_133 )
{
struct V_1 * V_2 = F_208 ( V_7 ) ;
...
static int F_239 ( struct V_283 * V_284 ,
unsigned long V_285 , void * V_286 )
{
struct V_249 * V_7 = F_240 ( V_286 ) ;
if ( ( V_7 -> V_287 == & V_288 ) &&
V_285 == V_289 )
F_237 ( F_208 ( V_7 ) ) ;
return V_290 ;
...
static T_7
F_241 ( struct V_291 * V_167 , struct V_292 * V_293 , char * V_60 )
{
struct V_1 * V_2 = F_242 ( F_243 ( V_167 ) ) ;
return sprintf ( V_60 , L_71 , V_2 -> V_294 ) ;
}
static T_7 F_244 ( struct V_291 * V_167 , struct V_292 * V_293 ,
char * V_60 )
{
struct V_1 * V_2 = F_242 ( F_243 ( V_167 ) ) ;
struct V_295 * V_296 = F_245 ( V_2 ) ;
return F_246 ( V_60 , V_77 , L_71 , V_296 -> V_297 ) ;
}
static T_7 F_247 ( struct V_291 * V_167 , struct V_292 * V_293 ,
...
F_129 ( V_2 ) ;
F_254 () ;
V_40 = F_255 ( & V_2 -> V_159 -> V_167 , & V_310 ) ;
if ( V_40 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_73 ) ;
goto V_311;
...
#ifdef F_256
V_40 = F_255 ( & V_2 -> V_159 -> V_167 , & V_312 ) ;
if ( V_40 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_73 ) ;
goto V_313;
...
#ifdef F_256
F_257 ( & V_2 -> V_159 -> V_167 , & V_312 ) ;
#endif
F_257 ( & V_2 -> V_159 -> V_167 , & V_310 ) ;
F_262 ( V_2 -> V_7 ) ;
}
}
void F_263 ( struct V_1 * V_2 , enum V_315 V_316 )
{
F_73 ( V_2 ) ;
if ( V_316 == V_317 )
V_2 -> type -> V_318 ( V_2 ) ;
...
int F_264 ( struct V_1 * V_2 , enum V_315 V_316 , bool V_321 )
{
int V_40 ;
F_73 ( V_2 ) ;
if ( V_316 == V_317 )
...
int F_226 ( struct V_1 * V_2 , enum V_315 V_316 )
{
int V_40 , V_102 ;
bool V_325 ;
...
F_266 ( V_316 , & V_2 -> V_225 ) ;
F_138 ( V_2 -> V_159 ) ;
V_107:
V_325 = V_40 ||
V_316 == V_109 ||
V_316 == V_328 ;
V_102 = F_264 ( V_2 , V_316 , ! V_325 ) ;
if ( V_102 ) {
V_325 = true ;
if ( ! V_40 )
V_40 = V_102 ;
...
{
#ifdef F_269
struct V_329 * V_330 = F_270 ( V_2 -> V_159 ) ;
if ( F_271 ( V_330 ) ) {
return 1 ;
}
#endif
...
F_22 ( V_2 , V_6 , V_2 -> V_7 ,
L_85 ,
F_265 ( V_316 ) , F_265 ( type ) ) ;
break;
}
F_277 ( V_316 , & V_2 -> V_225 ) ;
F_250 () ;
if ( F_275 ( V_2 -> V_3 ) != V_308 )
return;
F_168 ( V_2 ) ;
F_235 ( V_340 , & V_2 -> V_334 ) ;
}
...
F_282 ( & V_2 -> V_342 ) ;
#endif
F_284 ( & V_2 -> V_334 , F_274 ) ;
F_285 ( & V_2 -> V_149 , F_205 ) ;
F_285 ( & V_2 -> V_343 , V_344 ) ;
V_2 -> V_159 = V_159 ;
V_2 -> V_345 = V_346 ;
V_2 -> V_3 = V_314 ;
...
void F_291 ( struct V_1 * V_2 , T_8 * V_268 )
{
T_8 V_355 = 0 ;
struct V_9 * V_10 ;
F_54 (channel, efx)
...
V_362 = F_300 ( V_167 , 0 , sizeof( V_360 ) , V_360 ) ;
if ( V_362 <= 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_88 ) ;
return;
}
V_363 = F_301 ( V_360 , 0 , V_362 , V_365 ) ;
if ( V_363 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_89 ) ;
return;
}
V_364 = F_302 ( & V_360 [ V_363 ] ) ;
V_46 = V_364 ;
V_44 = V_363 + V_366 ;
if ( V_44 + V_46 > V_362 )
V_46 = V_362 - V_44 ;
V_44 = F_303 ( V_360 , V_44 , V_46 , L_90 ) ;
if ( V_44 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_91 ) ;
return;
}
V_46 = F_304 ( & V_360 [ V_44 ] ) ;
V_44 += V_367 ;
if ( V_44 + V_46 > V_362 ) {
...
V_44 = V_363 + V_366 ;
V_46 = V_364 ;
V_44 = F_303 ( V_360 , V_44 , V_46 , L_94 ) ;
if ( V_44 < 0 ) {
...
V_375 | V_376 |
V_377 ) ;
if ( V_2 -> type -> V_213 & ( V_378 | V_379 ) )
V_7 -> V_280 |= V_380 ;
V_7 -> V_381 |= ( V_379 | V_374 |
V_375 | V_382 |
V_377 ) ;
