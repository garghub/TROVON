...
if ( V_4 -> V_21 . V_22 != V_39 && V_4 -> V_21 . V_40 ) {
V_31 = F_17 ( & V_4 -> V_35 , & V_4 -> V_36 ,
L_7 , V_4 -> V_21 . V_41 , NULL ) ;
if ( V_31 == NULL )
F_7 ( L_8 ) ;
V_29 . V_32 = V_32 ;
V_29 . type = V_4 -> V_21 . V_22 ;
V_29 . V_26 = V_4 -> V_21 . V_41 ;
V_29 . V_42 = F_4 ;
F_19 ( & V_4 -> V_35 , 0 , V_43 , V_44 ,
& V_29 ) ;
}
#endif
}
