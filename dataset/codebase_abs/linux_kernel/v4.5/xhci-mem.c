...
if ( ! V_172 )
return - V_174 ;
V_171 -> V_185 |= F_5 ( F_83 ( V_172 ) ) ;
for ( V_162 = V_144 ; V_162 -> V_169 && V_162 -> V_169 -> V_169 ;
V_162 = V_162 -> V_169 )
;
V_81 -> V_186 = V_162 -> V_170 ;
V_81 -> V_128 = V_172 ;
F_32 ( V_3 , L_22 , V_172 ) ;
F_32 ( V_3 , L_23 , V_81 -> V_186 ) ;
if ( ! V_144 -> V_136 || ! V_144 -> V_136 -> V_187 -> V_169 ) {
...
if ( V_189 -> V_122 != V_144 -> V_136 -> V_187 -> V_122 )
continue;
if ( ! V_81 -> V_144 -> V_136 -> V_139 ||
( V_144 -> V_136 -> V_139 &&
V_189 -> V_145 == V_81 -> V_144 -> V_145 ) ) {
V_81 -> V_142 = & V_189 -> V_142 ;
V_81 -> V_126 = V_189 ;
break;
}
}
...
if ( V_144 -> V_136 && V_144 -> V_136 -> V_187 -> V_169 ) {
V_171 -> V_126 = F_5 ( V_144 -> V_136 -> V_187 -> V_122 |
( V_144 -> V_145 << 8 ) ) ;
if ( V_144 -> V_136 -> V_139 )
V_171 -> V_175 |= F_5 ( V_190 ) ;
}
F_32 ( V_3 , L_25 , V_144 -> V_136 ) ;
F_32 ( V_3 , L_26 , V_144 -> V_145 ) ;
V_160 -> V_191 = F_5 ( F_85 ( V_192 ) ) ;
V_160 -> V_191 |= F_5 ( F_86 ( 0 ) | F_87 ( 3 ) |
V_173 ) ;
...
{
unsigned int V_194 ;
V_194 = F_89 ( V_89 -> V_195 . V_196 , 1 , 16 ) - 1 ;
if ( V_194 != V_89 -> V_195 . V_196 - 1 )
F_90 ( & V_144 -> V_81 ,
L_27 ,
V_89 -> V_195 . V_197 ,
1 << V_194 ,
V_144 -> V_165 == V_180 ? L_4 : L_28 ) ;
...
struct V_193 * V_89 , unsigned int V_198 ,
unsigned int V_199 , unsigned int V_200 )
{
unsigned int V_194 ;
V_194 = F_57 ( V_198 ) - 1 ;
V_194 = F_89 ( V_194 , V_199 , V_200 ) ;
if ( ( 1 << V_194 ) != V_198 )
F_92 ( & V_144 -> V_81 ,
L_29 ,
V_89 -> V_195 . V_197 ,
...
struct V_193 * V_89 )
{
if ( V_89 -> V_195 . V_196 == 0 )
return 0 ;
return F_91 ( V_144 , V_89 ,
V_89 -> V_195 . V_196 , 0 , 15 ) ;
}
static unsigned int F_94 ( struct V_133 * V_144 ,
struct V_193 * V_89 )
{
return F_91 ( V_144 , V_89 ,
V_89 -> V_195 . V_196 * 8 , 3 , 10 ) ;
}
...
if ( F_96 ( & V_89 -> V_195 ) ||
F_97 ( & V_89 -> V_195 ) ) {
V_194 = F_93 ( V_144 , V_89 ) ;
break;
}
case V_166 :
if ( F_98 ( & V_89 -> V_195 ) ||
F_99 ( & V_89 -> V_195 ) ) {
V_194 = F_88 ( V_144 , V_89 ) ;
}
break;
case V_180 :
if ( F_99 ( & V_89 -> V_195 ) ) {
...
! F_99 ( & V_89 -> V_195 ) )
return 0 ;
return V_89 -> V_201 . V_202 ;
}
static T_3 F_103 ( struct V_193 * V_89 )
{
int V_203 ;
T_3 type ;
V_203 = F_104 ( & V_89 -> V_195 ) ;
if ( F_96 ( & V_89 -> V_195 ) ) {
type = F_85 ( V_192 ) ;
} else if ( F_97 ( & V_89 -> V_195 ) ) {
if ( V_203 )
type = F_85 ( V_204 ) ;
else
type = F_85 ( V_205 ) ;
} else if ( F_99 ( & V_89 -> V_195 ) ) {
if ( V_203 )
type = F_85 ( V_206 ) ;
else
type = F_85 ( V_207 ) ;
} else if ( F_98 ( & V_89 -> V_195 ) ) {
if ( V_203 )
type = F_85 ( V_208 ) ;
else
type = F_85 ( V_209 ) ;
...
static T_3 F_105 ( struct V_133 * V_144 ,
struct V_193 * V_89 )
{
int V_210 ;
int V_211 ;
...
return 0 ;
if ( V_144 -> V_165 == V_166 )
return F_106 ( V_89 -> V_201 . V_212 ) ;
V_211 = F_107 ( F_108 ( & V_89 -> V_195 ) ) ;
V_210 = ( F_108 ( & V_89 -> V_195 ) & 0x1800 ) >> 11 ;
return V_211 * ( V_210 + 1 ) ;
}
...
T_3 V_213 ;
T_3 V_214 ;
V_56 = F_110 ( & V_89 -> V_195 ) ;
V_113 = F_42 ( V_3 , V_55 -> V_155 , V_56 ) ;
V_214 = F_103 ( V_89 ) ;
if ( ! V_214 )
return - V_174 ;
V_113 -> V_191 = F_5 ( V_214 ) ;
type = F_111 ( & V_89 -> V_195 ) ;
V_55 -> V_61 [ V_56 ] . V_215 =
F_29 ( V_3 , 2 , 1 , type , V_38 ) ;
if ( ! V_55 -> V_61 [ V_56 ] . V_215 ) {
if ( V_55 -> V_58 == 0 )
return - V_51 ;
V_55 -> V_58 -- ;
V_55 -> V_61 [ V_56 ] . V_215 =
...
F_33 ( V_3 , V_55 -> V_61 [ V_56 ] . V_215 ,
1 , type ) ;
}
V_55 -> V_61 [ V_56 ] . V_216 = false ;
V_161 = V_55 -> V_61 [ V_56 ] . V_215 ;
V_113 -> V_119 = F_10 ( V_161 -> V_42 -> V_7 | V_161 -> V_4 ) ;
V_113 -> V_116 = F_5 ( F_95 ( V_144 , V_89 )
| F_112 ( F_102 ( V_144 , V_89 ) ) ) ;
if ( ! F_99 ( & V_89 -> V_195 ) )
V_113 -> V_191 |= F_5 ( F_87 ( 3 ) ) ;
else
V_113 -> V_191 |= F_5 ( F_87 ( 0 ) ) ;
V_211 = F_107 ( F_108 ( & V_89 -> V_195 ) ) ;
V_210 = 0 ;
switch ( V_144 -> V_165 ) {
case V_166 :
V_210 = V_89 -> V_201 . V_217 ;
break;
case V_178 :
if ( F_97 ( & V_89 -> V_195 ) )
V_211 = 512 ;
...
V_113 -> V_191 |= F_5 ( F_82 ( V_211 ) |
F_86 ( V_210 ) ) ;
V_213 = F_105 ( V_144 , V_89 ) ;
V_113 -> V_218 = F_5 ( F_113 ( V_213 ) ) ;
if ( F_96 ( & V_89 -> V_195 ) && V_3 -> V_219 >= 0x100 )
V_113 -> V_218 |= F_5 ( F_114 ( 8 ) ) ;
else
V_113 -> V_218 |=
F_5 ( F_114 ( V_213 ) ) ;
return 0 ;
...
V_221 = & V_55 -> V_61 [ V_8 ] . V_221 ;
if ( ! F_118 ( V_226 , V_8 ) && F_119 ( V_226 , V_8 ) ) {
F_116 ( V_221 ) ;
continue;
}
if ( F_118 ( V_226 , V_8 ) ) {
V_113 = F_42 ( V_3 , V_155 , V_8 ) ;
V_227 = F_120 ( F_11 ( V_113 -> V_191 ) ) ;
if ( V_227 != V_207 && V_227 != V_209 &&
V_227 != V_206 &&
V_227 != V_208 )
continue;
V_221 -> V_222 = F_121 (
...
struct V_76 * V_228 ;
struct V_76 * V_229 ;
V_228 = F_42 ( V_3 , V_156 , V_56 ) ;
V_229 = F_42 ( V_3 , V_155 , V_56 ) ;
V_229 -> V_116 = V_228 -> V_116 ;
V_229 -> V_191 = V_228 -> V_191 ;
V_229 -> V_119 = V_228 -> V_119 ;
V_229 -> V_218 = V_228 -> V_218 ;
}
...
struct V_75 * V_230 ;
struct V_75 * V_231 ;
V_230 = F_41 ( V_3 , V_155 ) ;
V_231 = F_41 ( V_3 , V_156 ) ;
V_230 -> V_175 = V_231 -> V_175 ;
V_230 -> V_185 = V_231 -> V_185 ;
V_230 -> V_126 = V_231 -> V_126 ;
V_230 -> V_232 = V_231 -> V_232 ;
}
static int F_128 ( struct V_2 * V_3 , T_1 V_5 )
{
int V_8 ;
struct V_80 * V_81 = F_44 ( V_3 ) -> V_82 . V_83 ;
int V_233 = F_129 ( V_3 -> V_234 ) ;
F_35 ( V_3 , V_235 ,
L_30 , V_233 ) ;
if ( ! V_233 )
return 0 ;
V_3 -> V_236 = F_2 ( sizeof( * V_3 -> V_236 ) , V_5 ) ;
if ( ! V_3 -> V_236 )
goto V_237;
V_3 -> V_236 -> V_238 = F_47 ( V_81 ,
V_233 * sizeof( T_5 ) ,
& V_3 -> V_236 -> V_239 , V_5 ) ;
if ( ! V_3 -> V_236 -> V_238 )
goto V_240;
V_3 -> V_236 -> V_241 = F_2 ( sizeof( void * ) * V_233 , V_5 ) ;
if ( ! V_3 -> V_236 -> V_241 )
goto V_242;
V_3 -> V_236 -> V_243 =
F_2 ( sizeof( T_2 ) * V_233 , V_5 ) ;
if ( ! V_3 -> V_236 -> V_243 )
goto V_244;
V_3 -> V_151 -> V_152 [ 0 ] = F_10 ( V_3 -> V_236 -> V_239 ) ;
for ( V_8 = 0 ; V_8 < V_233 ; V_8 ++ ) {
T_2 V_7 ;
void * V_245 = F_47 ( V_81 , V_3 -> V_246 , & V_7 ,
V_5 ) ;
if ( ! V_245 )
goto V_247;
V_3 -> V_236 -> V_238 [ V_8 ] = V_7 ;
V_3 -> V_236 -> V_241 [ V_8 ] = V_245 ;
V_3 -> V_236 -> V_243 [ V_8 ] = V_7 ;
}
return 0 ;
V_247:
...
struct V_248 * F_52 ( struct V_2 * V_3 ,
bool V_249 , bool V_250 ,
T_1 V_38 )
{
struct V_248 * V_251 ;
V_251 = F_2 ( sizeof( * V_251 ) , V_38 ) ;
if ( ! V_251 )
return NULL ;
if ( V_249 ) {
V_251 -> V_155 =
...
if ( V_250 ) {
V_251 -> V_252 =
F_2 ( sizeof( struct V_252 ) , V_38 ) ;
if ( ! V_251 -> V_252 ) {
F_39 ( V_3 , V_251 -> V_155 ) ;
F_4 ( V_251 ) ;
return NULL ;
}
F_75 ( V_251 -> V_252 ) ;
...
int V_8 , V_138 , V_137 ;
F_133 ( & V_3 -> V_257 ) ;
V_70 = sizeof( struct V_258 ) * ( V_3 -> V_259 . V_260 ) ;
if ( V_3 -> V_259 . V_261 )
F_45 ( V_81 , V_70 ,
...
struct V_141 * V_266 = & V_3 -> V_130 [ V_8 ] . V_142 ;
for ( V_138 = 0 ; V_138 < V_146 ; V_138 ++ ) {
struct V_123 * V_89 = & V_266 -> V_147 [ V_138 ] . V_148 ;
while ( ! F_71 ( V_89 ) )
F_135 ( V_89 -> V_15 ) ;
}
}
for ( V_8 = 1 ; V_8 < V_267 ; ++ V_8 )
F_70 ( V_3 , V_8 ) ;
F_136 ( V_3 -> V_10 ) ;
V_3 -> V_10 = NULL ;
F_35 ( V_3 , V_235 , L_34 ) ;
...
T_2 V_283 ,
struct V_1 * V_284 ,
char * V_285 , int V_286 )
{
unsigned long long V_287 ;
unsigned long long V_288 ;
struct V_1 * V_6 ;
V_287 = F_60 ( V_280 , V_281 ) ;
V_288 = F_60 ( V_280 , V_282 ) ;
V_6 = F_138 ( V_3 , V_280 , V_281 , V_282 , V_283 , false ) ;
if ( V_6 != V_284 ) {
F_72 ( V_3 , L_38 ,
V_285 , V_286 ) ;
F_72 ( V_3 , L_39
...
F_72 ( V_3 , L_43 ,
V_284 , V_6 ) ;
F_138 ( V_3 , V_280 , V_281 , V_282 , V_283 ,
true ) ;
return - 1 ;
}
return 0 ;
...
{ 0 , NULL } ,
{ V_3 -> V_263 -> V_42 -> V_7 - 16 , NULL } ,
{ V_3 -> V_263 -> V_42 -> V_7 - 1 , NULL } ,
{ V_3 -> V_263 -> V_42 -> V_7 , V_3 -> V_263 -> V_42 } ,
{ V_3 -> V_263 -> V_42 -> V_7 + ( V_11 - 1 ) * 16 ,
V_3 -> V_263 -> V_42 } ,
{ V_3 -> V_263 -> V_42 -> V_7 + ( V_11 - 1 ) * 16 + 1 , NULL } ,
{ V_3 -> V_263 -> V_42 -> V_7 + ( V_11 ) * 16 , NULL } ,
{ ( T_2 ) ( ~ 0 ) , NULL } ,
} ;
struct {
struct V_1 * V_280 ;
...
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = V_3 -> V_263 -> V_42 -> V_9 ,
. V_282 = & V_3 -> V_263 -> V_42 -> V_9 [ V_11 - 1 ] ,
. V_283 = V_3 -> V_265 -> V_42 -> V_7 ,
. V_284 = NULL ,
} ,
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = V_3 -> V_263 -> V_42 -> V_9 ,
. V_282 = & V_3 -> V_265 -> V_42 -> V_9 [ V_11 - 1 ] ,
. V_283 = V_3 -> V_265 -> V_42 -> V_7 ,
. V_284 = NULL ,
} ,
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = V_3 -> V_265 -> V_42 -> V_9 ,
. V_282 = & V_3 -> V_265 -> V_42 -> V_9 [ V_11 - 1 ] ,
. V_283 = V_3 -> V_265 -> V_42 -> V_7 ,
. V_284 = NULL ,
} ,
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = & V_3 -> V_263 -> V_42 -> V_9 [ 0 ] ,
. V_282 = & V_3 -> V_263 -> V_42 -> V_9 [ 3 ] ,
. V_283 = V_3 -> V_263 -> V_42 -> V_7 + 4 * 16 ,
. V_284 = NULL ,
} ,
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = & V_3 -> V_263 -> V_42 -> V_9 [ 3 ] ,
. V_282 = & V_3 -> V_263 -> V_42 -> V_9 [ 6 ] ,
. V_283 = V_3 -> V_263 -> V_42 -> V_7 + 2 * 16 ,
. V_284 = NULL ,
} ,
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = & V_3 -> V_263 -> V_42 -> V_9 [ V_11 - 3 ] ,
. V_282 = & V_3 -> V_263 -> V_42 -> V_9 [ 1 ] ,
. V_283 = V_3 -> V_263 -> V_42 -> V_7 + 2 * 16 ,
. V_284 = NULL ,
} ,
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = & V_3 -> V_263 -> V_42 -> V_9 [ V_11 - 3 ] ,
. V_282 = & V_3 -> V_263 -> V_42 -> V_9 [ 1 ] ,
. V_283 = V_3 -> V_263 -> V_42 -> V_7 + ( V_11 - 4 ) * 16 ,
. V_284 = NULL ,
} ,
{ . V_280 = V_3 -> V_263 -> V_42 ,
. V_281 = & V_3 -> V_263 -> V_42 -> V_9 [ V_11 - 3 ] ,
. V_282 = & V_3 -> V_263 -> V_42 -> V_9 [ 1 ] ,
. V_283 = V_3 -> V_265 -> V_42 -> V_7 + 2 * 16 ,
. V_284 = NULL ,
} ,
} ;
unsigned int V_291 ;
...
T_5 V_292 ;
T_2 V_119 ;
V_119 = F_60 ( V_3 -> V_263 -> V_48 ,
V_3 -> V_263 -> V_47 ) ;
if ( V_119 == 0 && ! F_142 () )
F_72 ( V_3 , L_47
L_48 ) ;
V_292 = F_143 ( V_3 , & V_3 -> V_293 -> V_294 ) ;
V_292 &= V_295 ;
V_292 &= ~ V_296 ;
F_35 ( V_3 , V_235 ,
L_49
L_50 ) ;
F_144 ( V_3 , ( ( T_5 ) V_119 & ( T_5 ) ~ V_295 ) | V_292 ,
& V_3 -> V_293 -> V_294 ) ;
}
static void F_145 ( struct V_2 * V_3 , unsigned int V_137 ,
T_6 T_7 * V_100 , int V_297 )
{
T_3 V_292 , V_298 , V_299 ;
int V_8 ;
T_8 V_300 ;
struct V_301 * V_302 ;
V_292 = F_146 ( V_100 ) ;
...
V_302 -> V_305 = F_147 ( V_292 ) ;
V_302 -> V_306 = F_148 ( V_292 ) ;
V_292 = F_146 ( V_100 + 2 ) ;
V_298 = F_149 ( V_292 ) ;
V_299 = F_150 ( V_292 ) ;
F_35 ( V_3 , V_235 ,
L_53
L_54 ,
V_100 , V_298 , V_299 , V_300 ) ;
if ( V_298 == 0 || ( V_298 + V_299 - 1 ) > V_137 )
return;
V_302 -> V_307 = F_151 ( V_292 ) ;
if ( V_302 -> V_307 ) {
V_302 -> V_308 = F_152 ( V_302 -> V_307 , sizeof( * V_302 -> V_308 ) ,
V_309 ) ;
if ( ! V_302 -> V_308 )
V_302 -> V_307 = 0 ;
V_302 -> V_310 ++ ;
for ( V_8 = 0 ; V_8 < V_302 -> V_307 ; V_8 ++ ) {
V_302 -> V_308 [ V_8 ] = F_146 ( V_100 + 4 + V_8 ) ;
if ( V_8 && ( F_153 ( V_302 -> V_308 [ V_8 ] ) !=
F_153 ( V_302 -> V_308 [ V_8 - 1 ] ) ) )
V_302 -> V_310 ++ ;
F_32 ( V_3 , L_55 ,
F_153 ( V_302 -> V_308 [ V_8 ] ) ,
F_154 ( V_302 -> V_308 [ V_8 ] ) ,
F_155 ( V_302 -> V_308 [ V_8 ] ) ,
F_156 ( V_302 -> V_308 [ V_8 ] ) ,
F_157 ( V_302 -> V_308 [ V_8 ] ) ,
F_158 ( V_302 -> V_308 [ V_8 ] ) ) ;
}
}
if ( V_300 < 0x03 && V_3 -> V_311 < V_297 )
V_3 -> V_276 [ V_3 -> V_311 ++ ] = V_292 ;
if ( ( V_3 -> V_219 == 0x96 ) && ( V_300 != 0x03 ) &&
( V_292 & V_312 ) ) {
F_35 ( V_3 , V_235 ,
L_56 ) ;
V_3 -> V_313 = 1 ;
}
if ( ( V_3 -> V_219 >= 0x100 ) && ( V_300 != 0x03 ) ) {
F_35 ( V_3 , V_235 ,
L_57 ) ;
V_3 -> V_313 = 1 ;
if ( V_292 & V_314 ) {
...
V_298 -- ;
for ( V_8 = V_298 ; V_8 < ( V_298 + V_299 ) ; V_8 ++ ) {
if ( V_3 -> V_275 [ V_8 ] != 0 ) {
F_72 ( V_3 , L_59
L_60 , V_100 , V_8 ) ;
F_72 ( V_3 , L_61
L_62 ,
V_3 -> V_275 [ V_8 ] , V_300 ) ;
if ( V_3 -> V_275 [ V_8 ] != V_300 &&
V_3 -> V_275 [ V_8 ] != V_316 ) {
if ( V_3 -> V_275 [ V_8 ] == 0x03 )
V_3 -> V_271 -- ;
else
V_3 -> V_270 -- ;
V_3 -> V_275 [ V_8 ] = V_316 ;
...
static int F_159 ( struct V_2 * V_3 , T_1 V_5 )
{
void T_7 * V_317 ;
T_3 V_318 ;
unsigned int V_137 ;
...
T_3 V_321 ;
V_137 = F_65 ( V_3 -> V_129 ) ;
V_3 -> V_275 = F_2 ( sizeof( * V_3 -> V_275 ) * V_137 , V_5 ) ;
if ( ! V_3 -> V_275 )
return - V_51 ;
...
V_317 = & V_3 -> V_322 -> V_323 ;
V_321 = F_160 ( V_317 , 0 , V_324 ) ;
if ( ! V_321 ) {
F_161 ( V_3 , L_63 ) ;
return - V_325 ;
}
...
while ( V_318 ) {
V_320 ++ ;
V_318 = F_160 ( V_317 , V_318 ,
V_324 ) ;
}
V_3 -> V_276 = F_2 ( sizeof( * V_3 -> V_276 ) * V_320 , V_5 ) ;
if ( ! V_3 -> V_276 )
return - V_51 ;
V_318 = V_321 ;
while ( V_318 ) {
F_145 ( V_3 , V_137 , V_317 + V_318 , V_320 ) ;
if ( V_3 -> V_270 + V_3 -> V_271 == V_137 )
break;
V_318 = F_160 ( V_317 , V_318 ,
V_324 ) ;
}
if ( V_3 -> V_270 == 0 && V_3 -> V_271 == 0 ) {
F_72 ( V_3 , L_64 ) ;
return - V_325 ;
}
F_35 ( V_3 , V_235 ,
...
if ( V_3 -> V_270 ) {
V_3 -> V_273 = F_162 ( sizeof( * V_3 -> V_273 ) *
V_3 -> V_270 , V_5 ) ;
if ( ! V_3 -> V_273 )
return - V_51 ;
V_319 = 0 ;
...
T_2 V_7 ;
struct V_80 * V_81 = F_44 ( V_3 ) -> V_82 . V_83 ;
unsigned int V_19 , V_330 ;
T_5 V_331 ;
struct V_1 * V_6 ;
T_3 V_246 , V_292 ;
int V_8 ;
F_30 ( & V_3 -> V_254 ) ;
F_63 ( & V_3 -> V_257 , V_332 ,
( unsigned long ) V_3 ) ;
V_246 = F_146 ( & V_3 -> V_327 -> V_246 ) ;
F_35 ( V_3 , V_235 ,
L_71 , V_246 ) ;
...
F_72 ( V_3 , L_73 ) ;
V_3 -> V_277 = 12 ;
V_3 -> V_246 = 1 << V_3 -> V_277 ;
F_35 ( V_3 , V_235 ,
L_74 , V_3 -> V_246 / 1024 ) ;
V_19 = F_164 ( F_146 ( & V_3 -> V_322 -> V_129 ) ) ;
F_35 ( V_3 , V_235 ,
L_75 , V_19 ) ;
V_330 = F_146 ( & V_3 -> V_327 -> V_333 ) ;
V_19 |= ( V_330 & ~ V_334 ) ;
F_35 ( V_3 , V_235 ,
L_76 , V_19 ) ;
F_165 ( V_19 , & V_3 -> V_327 -> V_333 ) ;
...
F_144 ( V_3 , V_7 , & V_3 -> V_327 -> V_335 ) ;
V_3 -> V_10 = F_166 ( L_78 , V_81 ,
V_336 , V_336 , V_3 -> V_246 ) ;
V_3 -> V_73 = F_166 ( L_79 , V_81 ,
2112 , 64 , V_3 -> V_246 ) ;
...
goto V_53;
V_3 -> V_265 = F_29 ( V_3 , 1 , 1 , V_337 , V_5 ) ;
if ( ! V_3 -> V_265 )
goto V_53;
F_35 ( V_3 , V_235 ,
L_82 , V_3 -> V_265 ) ;
F_35 ( V_3 , V_235 , L_83 ,
( unsigned long long ) V_3 -> V_265 -> V_42 -> V_7 ) ;
V_331 = F_143 ( V_3 , & V_3 -> V_327 -> V_265 ) ;
V_331 = ( V_331 & ( T_5 ) V_338 ) |
( V_3 -> V_265 -> V_42 -> V_7 & ( T_5 ) ~ V_338 ) |
V_3 -> V_265 -> V_4 ;
F_35 ( V_3 , V_235 ,
L_84 , V_19 ) ;
F_144 ( V_3 , V_331 , & V_3 -> V_327 -> V_265 ) ;
F_167 ( V_3 ) ;
V_3 -> V_264 = F_52 ( V_3 , true , true , V_5 ) ;
if ( ! V_3 -> V_264 )
goto V_53;
V_3 -> V_101 ++ ;
V_19 = F_146 ( & V_3 -> V_322 -> V_339 ) ;
V_19 &= V_340 ;
F_35 ( V_3 , V_235 ,
L_85
L_86 , V_19 ) ;
V_3 -> V_341 = ( void T_7 * ) V_3 -> V_322 + V_19 ;
F_168 ( V_3 ) ;
F_169 ( V_3 ) ;
V_3 -> V_293 = & V_3 -> V_342 -> V_293 [ 0 ] ;
F_35 ( V_3 , V_235 , L_87 ) ;
V_3 -> V_263 = F_29 ( V_3 , V_343 , 1 , V_20 ,
V_5 ) ;
if ( ! V_3 -> V_263 )
goto V_53;
if ( F_139 ( V_3 ) < 0 )
goto V_53;
V_3 -> V_259 . V_261 = F_47 ( V_81 ,
sizeof( struct V_258 ) * V_343 , & V_7 ,
V_309 ) ;
if ( ! V_3 -> V_259 . V_261 )
goto V_53;
F_35 ( V_3 , V_235 ,
...
memset ( V_3 -> V_259 . V_261 , 0 , sizeof( struct V_258 ) * V_343 ) ;
V_3 -> V_259 . V_260 = V_343 ;
V_3 -> V_259 . V_262 = V_7 ;
F_35 ( V_3 , V_235 ,
L_89 ,
V_3 -> V_259 . V_260 ,
...
for ( V_19 = 0 , V_6 = V_3 -> V_263 -> V_42 ; V_19 < V_343 ; V_19 ++ ) {
struct V_258 * V_344 = & V_3 -> V_259 . V_261 [ V_19 ] ;
V_344 -> V_345 = F_10 ( V_6 -> V_7 ) ;
V_344 -> V_346 = F_5 ( V_11 ) ;
V_344 -> V_347 = 0 ;
V_6 = V_6 -> V_15 ;
}
V_19 = F_146 ( & V_3 -> V_293 -> V_348 ) ;
V_19 &= V_349 ;
V_19 |= V_343 ;
F_35 ( V_3 , V_235 ,
L_90 ,
V_19 ) ;
F_165 ( V_19 , & V_3 -> V_293 -> V_348 ) ;
F_35 ( V_3 , V_235 ,
L_91 ) ;
F_35 ( V_3 , V_235 ,
L_92 ,
( unsigned long long ) V_3 -> V_259 . V_262 ) ;
V_331 = F_143 ( V_3 , & V_3 -> V_293 -> V_350 ) ;
V_331 &= V_295 ;
V_331 |= ( V_3 -> V_259 . V_262 & ( T_5 ) ~ V_295 ) ;
F_144 ( V_3 , V_331 , & V_3 -> V_293 -> V_350 ) ;
F_141 ( V_3 ) ;
F_35 ( V_3 , V_235 ,
L_93 ) ;
F_170 ( V_3 , 0 ) ;
...
V_3 -> V_150 [ V_8 ] = NULL ;
for ( V_8 = 0 ; V_8 < V_326 ; ++ V_8 ) {
V_3 -> V_278 [ 0 ] . V_352 [ V_8 ] = 0 ;
V_3 -> V_278 [ 1 ] . V_352 [ V_8 ] = 0 ;
F_75 ( & V_3 -> V_278 [ 1 ] . V_353 [ V_8 ] ) ;
}
if ( F_128 ( V_3 , V_5 ) )
goto V_53;
if ( F_159 ( V_3 , V_5 ) )
goto V_53;
V_292 = F_146 ( & V_3 -> V_327 -> V_354 ) ;
V_292 &= ~ V_355 ;
V_292 |= V_356 ;
F_165 ( V_292 , & V_3 -> V_327 -> V_354 ) ;
return 0 ;
V_53:
F_72 ( V_3 , L_94 ) ;
F_171 ( V_3 ) ;
