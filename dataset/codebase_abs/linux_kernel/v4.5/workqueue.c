...
static void F_39 ( struct V_2 * V_6 )
{
F_38 () ;
F_31 ( V_6 , V_41 , 0 ) ;
}
static struct V_22 * F_40 ( struct V_2 * V_6 )
{
unsigned long V_33 = F_41 ( & V_6 -> V_33 ) ;
if ( V_33 & V_38 )
return ( void * ) ( V_33 & V_42 ) ;
else
return NULL ;
}
static struct V_14 * F_42 ( struct V_2 * V_6 )
{
unsigned long V_33 = F_41 ( & V_6 -> V_33 ) ;
int V_39 ;
F_43 () ;
...
if ( V_39 == V_19 )
return NULL ;
return F_44 ( & V_18 , V_39 ) ;
}
static int F_45 ( struct V_2 * V_6 )
{
unsigned long V_33 = F_41 ( & V_6 -> V_33 ) ;
if ( V_33 & V_38 )
return ( (struct V_22 * )
...
static void F_46 ( struct V_2 * V_6 )
{
unsigned long V_39 = F_45 ( V_6 ) ;
V_39 <<= V_40 ;
F_31 ( V_6 , V_39 | V_43 , V_37 ) ;
}
static bool F_47 ( struct V_2 * V_6 )
{
unsigned long V_33 = F_41 ( & V_6 -> V_33 ) ;
...
{
return ! F_49 ( & V_15 -> V_44 ) ;
}
static bool F_50 ( struct V_14 * V_15 )
{
return ! F_51 ( & V_15 -> V_45 ) && F_48 ( V_15 ) ;
}
...
{
return ! F_51 ( & V_15 -> V_45 ) &&
F_49 ( & V_15 -> V_44 ) <= 1 ;
}
static bool F_54 ( struct V_14 * V_15 )
{
return F_50 ( V_15 ) && ! F_52 ( V_15 ) ;
}
static bool F_55 ( struct V_14 * V_15 )
{
bool V_47 = F_56 ( & V_15 -> V_48 ) ;
...
{
if ( F_26 ( F_51 ( & V_15 -> V_53 ) ) )
return NULL ;
return F_58 ( & V_15 -> V_53 , struct V_52 , V_54 ) ;
}
...
void F_62 ( struct V_56 * V_55 , int V_57 )
{
struct V_52 * V_52 = F_63 ( V_55 ) ;
if ( ! ( V_52 -> V_34 & V_58 ) ) {
F_9 ( V_52 -> V_15 -> V_57 != V_57 ) ;
F_64 ( & V_52 -> V_15 -> V_44 ) ;
}
}
struct V_56 * F_65 ( struct V_56 * V_55 , int V_57 )
{
struct V_52 * V_52 = F_63 ( V_55 ) , * V_59 = NULL ;
struct V_14 * V_15 ;
if ( V_52 -> V_34 & V_58 )
return NULL ;
V_15 = V_52 -> V_15 ;
if ( F_9 ( V_57 != F_66 () || V_15 -> V_57 != V_57 ) )
return NULL ;
if ( F_67 ( & V_15 -> V_44 ) &&
! F_51 ( & V_15 -> V_45 ) )
V_59 = F_57 ( V_15 ) ;
...
static inline void F_68 ( struct V_52 * V_52 , unsigned int V_34 )
{
...
static inline void F_70 ( struct V_52 * V_52 , unsigned int V_34 )
{
struct V_14 * V_15 = V_52 -> V_15 ;
...
static struct V_52 * F_71 ( struct V_14 * V_15 ,
struct V_2 * V_6 )
{
struct V_52 * V_52 ;
...
static void F_73 ( struct V_2 * V_6 , struct V_64 * V_65 ,
struct V_2 * * V_66 )
{
struct V_2 * V_67 ;
...
static void F_76 ( struct V_22 * V_35 )
{
F_22 ( & V_35 -> V_15 -> V_69 ) ;
F_9 ( V_35 -> V_70 <= 0 ) ;
V_35 -> V_70 ++ ;
...
static void F_79 ( struct V_22 * V_35 )
{
if ( V_35 ) {
F_80 ( & V_35 -> V_15 -> V_69 ) ;
F_77 ( V_35 ) ;
...
{
struct V_22 * V_35 = F_40 ( V_6 ) ;
F_83 ( V_6 ) ;
if ( F_51 ( & V_35 -> V_15 -> V_45 ) )
V_35 -> V_15 -> V_73 = V_74 ;
F_73 ( V_6 , & V_35 -> V_15 -> V_45 , NULL ) ;
F_84 ( V_75 , F_7 ( V_6 ) ) ;
V_35 -> V_76 ++ ;
}
static void F_85 ( struct V_22 * V_35 )
{
struct V_2 * V_6 = F_58 ( & V_35 -> V_77 ,
struct V_2 , V_54 ) ;
F_82 ( V_6 ) ;
}
static void F_86 ( struct V_22 * V_35 , int V_29 )
{
if ( V_29 == V_78 )
goto V_79;
V_35 -> V_80 [ V_29 ] -- ;
...
if ( F_60 ( V_35 -> V_82 != V_29 ) )
goto V_79;
if ( V_35 -> V_80 [ V_29 ] )
goto V_79;
V_35 -> V_82 = - 1 ;
if ( F_67 ( & V_35 -> V_24 -> V_83 ) )
F_87 ( & V_35 -> V_24 -> V_84 -> V_85 ) ;
V_79:
F_77 ( V_35 ) ;
}
static int F_88 ( struct V_2 * V_6 , bool V_86 ,
unsigned long * V_34 )
{
struct V_14 * V_15 ;
struct V_22 * V_35 ;
F_89 ( * V_34 ) ;
if ( V_86 ) {
struct V_12 * V_87 = F_90 ( V_6 ) ;
if ( F_60 ( F_91 ( & V_87 -> V_13 ) ) )
return 1 ;
}
if ( ! F_92 ( V_88 , F_7 ( V_6 ) ) )
return 0 ;
V_15 = F_42 ( V_6 ) ;
if ( ! V_15 )
goto V_89;
...
static void F_98 ( struct V_22 * V_35 , struct V_2 * V_6 ,
...
if ( F_10 ( ! F_51 ( & V_6 -> V_54 ) ) ) {
F_95 ( & V_35 -> V_15 -> V_69 ) ;
return;
}
V_35 -> V_80 [ V_35 -> V_109 ] ++ ;
V_102 = F_28 ( V_35 -> V_109 ) ;
if ( F_60 ( V_35 -> V_76 < V_35 -> V_81 ) ) {
F_83 ( V_6 ) ;
V_35 -> V_76 ++ ;
V_45 = & V_35 -> V_15 -> V_45 ;
if ( F_51 ( V_45 ) )
...
if ( F_51 ( & V_35 -> V_142 ) ) {
F_76 ( V_35 ) ;
F_99 ( & V_35 -> V_142 , & V_24 -> V_143 ) ;
F_61 ( V_24 -> V_141 -> V_55 ) ;
}
}
...
{
while ( ! F_51 ( & V_52 -> V_123 ) ) {
struct V_2 * V_6 = F_58 ( & V_52 -> V_123 ,
struct V_2 , V_54 ) ;
F_157 ( V_52 , V_6 ) ;
}
}
...
if ( ! F_50 ( V_15 ) )
goto V_151;
if ( F_26 ( ! F_52 ( V_15 ) ) && F_155 ( V_52 ) )
goto V_150;
F_9 ( ! F_51 ( & V_52 -> V_123 ) ) ;
F_70 ( V_52 , V_124 | V_132 ) ;
do {
struct V_2 * V_6 =
F_58 ( & V_15 -> V_45 ,
struct V_2 , V_54 ) ;
V_15 -> V_73 = V_74 ;
if ( F_60 ( ! ( * F_7 ( V_6 ) & V_68 ) ) ) {
F_157 ( V_52 , V_6 ) ;
if ( F_26 ( ! F_51 ( & V_52 -> V_123 ) ) )
F_158 ( V_52 ) ;
} else {
F_73 ( V_6 , & V_52 -> V_123 , NULL ) ;
F_158 ( V_52 ) ;
}
} while ( F_53 ( V_15 ) );
F_68 ( V_52 , V_124 ) ;
...
V_155 = F_164 () ;
F_80 ( & V_140 ) ;
while ( ! F_51 ( & V_24 -> V_143 ) ) {
struct V_22 * V_35 = F_58 ( & V_24 -> V_143 ,
struct V_22 , V_142 ) ;
struct V_14 * V_15 = V_35 -> V_15 ;
struct V_2 * V_6 , * V_67 ;
bool V_158 = true ;
...
F_9 ( V_24 -> V_82 == V_176 . V_82 ) ;
F_99 ( & V_176 . V_177 , & V_24 -> V_183 ) ;
F_173 ( V_24 , - 1 , V_24 -> V_109 ) ;
}
} else {
F_99 ( & V_176 . V_177 , & V_24 -> V_181 ) ;
}
F_166 ( V_24 , NULL ) ;
F_136 ( & V_24 -> V_180 ) ;
F_181 ( & V_176 . V_85 ) ;
...
bool V_188 ;
F_80 ( & V_35 -> V_15 -> V_69 ) ;
V_188 = ! V_35 -> V_76 && F_51 ( & V_35 -> V_77 ) ;
F_81 ( & V_35 -> V_15 -> V_69 ) ;
if ( V_188 )
continue;
if ( ++ V_185 == 10 ||
...
return - V_241 ;
if ( F_10 ( ( V_24 -> V_34 & V_242 ) && ! F_51 ( & V_24 -> V_226 ) ) )
return - V_241 ;
...
V_306 -> V_304 . V_323 = V_24 -> V_108 ;
V_306 -> V_304 . V_324 = F_353 ;
F_354 ( & V_306 -> V_304 , true ) ;
V_16 = F_355 ( & V_306 -> V_304 ) ;
if ( V_16 ) {
F_146 ( V_306 ) ;
V_24 -> V_306 = NULL ;
return V_16 ;
...
if ( V_24 -> V_34 & V_71 ) {
struct V_307 * V_308 ;
for ( V_308 = V_325 ; V_308 -> V_308 . V_108 ; V_308 ++ ) {
...
F_354 ( & V_306 -> V_304 , false ) ;
F_357 ( & V_306 -> V_304 . V_326 , V_327 ) ;
return 0 ;
}
...
V_328 = V_74 ;
F_276 (cpu)
F_277 ( V_329 , V_57 ) = V_74 ;
}
static void F_359 ( unsigned long V_33 )
{
unsigned long V_330 = F_360 ( V_331 ) * V_332 ;
bool V_333 = false ;
struct V_14 * V_15 ;
int V_280 ;
if ( ! V_330 )
...
F_361 () ;
F_313 (pool, pi) {
unsigned long V_334 , V_335 , V_336 ;
if ( F_51 ( & V_15 -> V_45 ) )
continue;
V_334 = F_360 ( V_15 -> V_73 ) ;
V_335 = F_360 ( V_328 ) ;
if ( F_362 ( V_334 , V_335 ) )
V_336 = V_334 ;
else
V_336 = V_335 ;
if ( V_15 -> V_57 >= 0 ) {
...
F_360 ( F_277 ( V_329 ,
V_15 -> V_57 ) ) ;
if ( F_362 ( V_337 , V_336 ) )
V_336 = V_337 ;
}
if ( F_362 ( V_74 , V_336 + V_330 ) ) {
V_333 = true ;
F_363 ( L_45 ) ;
F_303 ( V_15 ) ;
F_302 ( L_46 ,
F_314 ( V_74 - V_334 ) / 1000 ) ;
}
}
F_364 () ;
if ( V_333 )
...
static void F_366 ( unsigned long V_330 )
{
V_331 = 0 ;
F_200 ( & V_338 ) ;
if ( V_330 ) {
V_331 = V_330 ;
F_358 () ;
F_128 ( & V_338 , V_74 + V_330 * V_332 ) ;
}
}
static int F_367 ( const char * V_312 ,
const struct V_339 * V_340 )
{
unsigned long V_330 ;
int V_16 ;
V_16 = F_368 ( V_312 , 0 , & V_330 ) ;
if ( V_16 )
return V_16 ;
if ( V_341 )
F_366 ( V_330 ) ;
...
V_246 = F_215 ( V_20 ) ;
F_254 ( ! V_246 ) ;
V_342 = F_216 ( V_239 * sizeof( V_342 [ 0 ] ) , V_20 ) ;
F_254 ( ! V_342 ) ;
F_244 (node)
F_254 ( ! F_372 ( & V_342 [ V_25 ] , V_20 ,
F_373 ( V_25 ) ? V_25 : V_26 ) ) ;
F_276 (cpu) {
V_25 = F_114 ( V_57 ) ;
if ( F_10 ( V_25 == V_26 ) ) {
F_105 ( L_48 , V_57 ) ;
...
F_374 ( V_57 , V_342 [ V_25 ] ) ;
}
V_221 = V_342 ;
V_220 = true ;
}
static int T_11 F_375 ( void )
{
int V_344 [ V_345 ] = { 0 , V_346 } ;
int V_268 , V_57 ;
F_10 ( F_376 ( struct V_22 ) < F_376 (long long) ) ;
F_254 ( ! F_217 ( & V_97 , V_20 ) ) ;
F_218 ( V_97 , V_206 ) ;
V_223 = F_377 ( V_22 , V_347 ) ;
F_378 ( F_322 , V_348 ) ;
F_379 ( F_323 , V_349 ) ;
F_370 () ;
F_276 (cpu) {
...
F_254 ( F_227 ( V_15 ) ) ;
V_15 -> V_57 = V_57 ;
F_218 ( V_15 -> V_126 -> V_127 , F_380 ( V_57 ) ) ;
V_15 -> V_126 -> V_135 = V_344 [ V_268 ++ ] ;
...
V_341 = F_381 ( L_49 , 0 , 0 ) ;
V_296 = F_381 ( L_50 , V_249 , 0 ) ;
V_350 = F_381 ( L_51 , 0 , 0 ) ;
V_351 = F_381 ( L_52 , V_71 ,
V_255 ) ;
V_352 = F_381 ( L_53 ,
V_228 , 0 ) ;
V_353 = F_381 ( L_54 ,
