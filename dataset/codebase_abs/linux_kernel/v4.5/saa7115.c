...
V_21 = F_53 ( & V_11 -> V_225 , sizeof( * V_21 ) , V_226 ) ;
if ( V_21 == NULL )
return - V_227 ;
V_3 = & V_21 -> V_3 ;
F_54 ( V_3 , V_11 , & V_228 ) ;
F_47 ( V_11 , L_48 , V_190 ,
V_11 -> V_219 << 1 , V_11 -> V_223 -> V_190 ) ;
V_7 = & V_21 -> V_7 ;
F_55 ( V_7 , 6 ) ;
F_56 ( V_7 , & V_229 ,
V_61 , 0 , 255 , 1 , 128 ) ;
...
F_56 ( V_7 , & V_229 ,
V_67 , - 128 , 127 , 1 , 0 ) ;
V_21 -> V_57 = F_56 ( V_7 , & V_229 ,
V_56 , 0 , 1 , 1 , 1 ) ;
V_21 -> V_59 = F_56 ( V_7 , & V_229 ,
V_230 , 0 , 127 , 1 , 40 ) ;
V_3 -> V_231 = V_7 ;
if ( V_7 -> error ) {
int V_30 = V_7 -> error ;
