...
V_264 = F_119 ( V_265 , struct V_67 , V_70 ) ;
F_120 ( & V_264 -> V_70 ) ;
F_17 ( V_264 ) ;
}
F_17 ( V_21 ) ;
}
static int F_121 ( struct V_39 * V_267 , const struct V_39 * V_268 ,
T_1 V_59 )
{
...
static void F_122 ( struct V_39 * V_267 , const struct V_39 * V_268 )
{
struct V_20 * V_269 = V_268 -> V_40 ;
...
static int F_123 ( struct V_39 * V_267 , T_4 V_230 )
{
struct V_20 * V_270 = V_267 -> V_40 ;
struct V_11 * V_47 = F_124 ( V_230 ) ;
if ( V_47 == NULL )
return - V_139 ;
V_270 -> V_22 = V_47 ;
return 0 ;
}
static int F_125 ( struct V_39 * V_267 ,
struct V_27 * V_27 )
{
struct V_28 * V_29 = V_27 -> V_30 ;
...
static int F_126 ( struct V_25 * V_122 , int V_271 ,
const char * V_272 )
{
struct V_81 V_82 ;
...
static int F_127 ( struct V_25 * V_122 , T_5 V_273 )
{
...
static void F_130 ( struct V_25 * V_122 , T_4 * V_230 )
{
struct V_11 * V_47 = F_7 ( V_122 ) ;
* V_230 = V_47 -> V_231 ;
}
...
static int F_132 ( struct V_25 * V_122 , int V_275 )
{
return F_126 ( V_122 , V_5 , V_93 ) ;
}
...
static int F_137 ( struct V_25 * V_122 , struct V_276 * V_277 ,
int V_278 , T_4 V_230 )
{
struct V_81 V_82 ;
struct V_11 * V_47 ;
...
static int F_140 ( struct V_219 * V_223 , int V_279 , T_1 V_280 )
{
struct V_11 * V_47 = F_44 () ;
struct V_216 * V_217 ;
...
static void F_141 ( struct V_219 * V_223 )
{
F_17 ( V_223 -> V_224 ) ;
}
static struct V_11 * F_142 ( struct V_282 * V_283 )
{
struct V_284 * V_285 ;
...
static bool F_143 ( struct V_292 * V_283 )
{
...
static struct V_11 * F_145 ( struct V_292 * V_283 )
{
struct V_296 * V_285 ;
...
static int F_146 ( struct V_219 * V_223 , int V_301 )
{
struct V_11 * V_47 ;
...
V_47 = V_217 -> V_228 ;
V_14 = F_150 ( V_223 , V_223 -> V_304 , & V_47 -> V_305 ) ;
}
F_151 ( V_223 ) ;
F_152 () ;
return V_14 ;
}
static int F_153 ( struct V_219 * V_223 , struct V_282 * V_298 )
{
struct V_11 * V_47 ;
int V_14 ;
int V_306 ;
...
if ( V_14 != 0 )
return V_14 ;
return F_146 ( V_223 , V_306 ) ;
}
static int F_156 ( struct V_11 * V_319 ,
struct V_11 * V_320 ,
...
V_82 . V_311 . V_312 . V_309 -> V_314 = F_144 ( V_321 -> V_324 ) ;
if ( V_322 == V_325 )
...
static void F_157 ( struct V_218 * V_219 , struct V_328 * V_321 )
{
...
static int F_158 ( struct V_219 * V_223 , struct V_292 * V_321 ,
int V_322 )
{
struct V_330 * V_331 ;
struct V_216 * V_217 = V_223 -> V_224 ;
...
return F_156 ( V_47 , V_320 , V_321 , V_322 ) ;
if ( V_47 == NULL )
V_47 = V_302 ;
if ( V_320 == NULL )
V_320 = V_302 ;
...
static int F_162 ( struct V_218 * V_219 , int V_279 ,
int type , int V_341 , int V_342 )
{
struct V_216 * V_217 ;
if ( V_219 -> V_223 == NULL )
return 0 ;
if ( F_112 ( V_23 -> V_160 & V_343 ) ) {
V_217 = V_219 -> V_223 -> V_224 ;
V_217 -> V_226 = & V_212 ;
V_217 -> V_228 = & V_212 ;
}
if ( V_279 != V_339 )
return 0 ;
return F_146 ( V_219 -> V_223 , V_318 ) ;
}
static int F_163 ( struct V_218 * V_219 , struct V_328 * V_321 ,
int V_344 )
{
...
static int F_164 ( struct V_218 * V_219 , struct V_328 * V_298 ,
int V_344 )
{
int V_14 = 0 ;
#if F_165 ( V_345 )
...
return - V_139 ;
V_14 = F_153 ( V_219 -> V_223 , (struct V_282 * ) V_298 ) ;
break;
case V_323 :
...
V_346 = F_145 ( V_283 ) ;
if ( V_346 != NULL )
V_14 = F_156 ( V_217 -> V_228 , V_346 , V_283 ,
V_336 ) ;
#endif
#ifdef F_161
V_14 = F_158 ( V_219 -> V_223 , V_283 , V_336 ) ;
#endif
break;
}
return V_14 ;
}
static int F_167 ( int V_160 )
{
int V_182 = 0 ;
if ( V_160 & V_347 )
V_182 |= V_4 ;
...
static int F_168 ( struct V_350 * V_351 )
{
struct V_11 * V_47 = F_44 () ;
V_351 -> V_40 = V_47 ;
return 0 ;
...
static struct V_11 * F_170 ( struct V_352 * V_353 )
{
return (struct V_11 * ) V_353 -> V_354 . V_40 ;
}
static int F_171 ( struct V_352 * V_353 )
{
...
static void F_172 ( struct V_352 * V_353 )
{
struct V_355 * V_29 = & V_353 -> V_354 ;
V_29 -> V_40 = NULL ;
}
static int F_173 ( struct V_352 * V_353 , int V_271 )
{
struct V_11 * V_217 = F_170 ( V_353 ) ;
struct V_81 V_82 ;
int V_14 ;
#ifdef F_154
...
static int F_174 ( struct V_352 * V_353 , int V_359 )
{
int V_182 ;
V_182 = F_167 ( V_359 ) ;
return F_173 ( V_353 , V_182 ) ;
}
static int F_175 ( struct V_352 * V_353 , int V_233 )
{
int V_182 ;
switch ( V_233 ) {
case V_360 :
...
static int F_176 ( struct V_352 * V_353 , char T_8 * V_368 ,
int V_359 )
{
int V_182 ;
V_182 = F_167 ( V_359 ) ;
...
static struct V_11 * F_177 ( struct V_369 * V_370 )
{
return (struct V_11 * ) V_370 -> V_371 . V_40 ;
}
static int F_178 ( struct V_369 * V_370 )
{
...
static void F_179 ( struct V_369 * V_370 )
{
struct V_355 * V_29 = & V_370 -> V_371 ;
V_29 -> V_40 = NULL ;
}
static int F_180 ( struct V_369 * V_370 , int V_271 )
{
struct V_11 * V_217 = F_177 ( V_370 ) ;
struct V_81 V_82 ;
int V_14 ;
#ifdef F_154
F_32 ( & V_82 , V_93 , V_356 ) ;
...
static int F_181 ( struct V_369 * V_370 , int V_372 )
{
int V_182 ;
V_182 = F_167 ( V_372 ) ;
return F_180 ( V_370 , V_182 ) ;
}
static int F_182 ( struct V_369 * V_370 , int V_233 )
{
int V_182 ;
switch ( V_233 ) {
case V_373 :
...
static int F_183 ( struct V_369 * V_370 , struct V_382 * V_383 ,
unsigned V_384 , int V_385 )
{
return F_180 ( V_370 , V_76 ) ;
}
static int F_184 ( struct V_386 * V_387 )
{
...
static void F_185 ( struct V_386 * V_387 )
{
struct V_355 * V_388 = & V_387 -> V_389 ;
V_388 -> V_40 = NULL ;
}
static struct V_11 * F_186 ( struct V_386 * V_387 )
{
return (struct V_11 * ) V_387 -> V_389 . V_40 ;
}
static int F_187 ( struct V_386 * V_387 , int V_271 )
{
struct V_11 * V_390 = F_186 ( V_387 ) ;
struct V_81 V_82 ;
int V_14 ;
#ifdef F_154
F_32 ( & V_82 , V_93 , V_356 ) ;
...
static int F_188 ( struct V_386 * V_387 , int V_391 )
{
int V_182 ;
V_182 = F_167 ( V_391 ) ;
return F_187 ( V_387 , V_182 ) ;
}
static int F_189 ( struct V_386 * V_387 , int V_233 )
{
int V_182 ;
switch ( V_233 ) {
case V_360 :
...
static int F_191 ( struct V_386 * V_387 , struct V_350 * V_351 ,
struct V_25 * V_394 , long type , int V_1 )
{
return F_187 ( V_387 , V_76 ) ;
}
static int F_192 ( struct V_355 * V_395 , short V_396 )
{
struct V_11 * V_397 = V_395 -> V_40 ;
int V_182 = F_167 ( V_396 ) ;
struct V_81 V_82 ;
int V_14 ;
#ifdef F_154
F_32 ( & V_82 , V_93 , V_356 ) ;
...
static void F_193 ( struct V_355 * V_395 , T_4 * V_230 )
{
struct V_11 * V_397 = V_395 -> V_40 ;
* V_230 = V_397 -> V_231 ;
}
static void F_194 ( struct V_44 * V_398 , struct V_27 * V_27 )
{
struct V_98 * V_163 ;
struct V_100 * V_101 ;
struct V_28 * V_29 ;
...
static int F_209 ( struct V_218 * V_219 , struct V_417 * V_351 ,
int V_199 )
{
...
switch ( V_219 -> V_223 -> V_304 ) {
case V_419 :
V_14 = F_153 ( V_219 -> V_223 , V_283 ) ;
break;
case V_420 :
#ifdef F_166
V_346 = F_145 ( V_298 ) ;
if ( V_346 != NULL )
V_14 = F_156 ( V_217 -> V_228 , V_346 , V_298 ,
V_336 ) ;
#endif
#ifdef F_161
V_14 = F_158 ( V_219 -> V_223 , V_298 , V_421 ) ;
#endif
break;
}
return V_14 ;
}
static struct V_11 * F_210 ( struct V_422 * V_298 ,
struct V_216 * V_217 )
{
struct V_11 * V_47 ;
int V_299 = 0 ;
...
V_423 = F_211 ( V_298 -> V_426 . V_427 . V_430 ,
V_423 + 1 ) ;
V_424 = F_211 (
...
V_47 = F_124 ( V_298 -> V_426 . V_230 ) ;
F_212 ( V_47 == NULL ) ;
return V_47 ;
}
return V_302 ;
}
static int F_213 ( struct V_432 * V_433 , struct V_292 * V_283 )
{
T_9 V_434 ;
int V_435 ;
int V_436 = - V_139 ;
...
V_47 = F_124 ( V_433 -> V_457 ) ;
goto V_458;
}
#endif
F_219 ( & V_455 ) ;
V_14 = F_220 ( V_433 , V_223 -> V_304 , & V_455 ) ;
if ( V_14 == 0 )
...
int V_14 ;
if ( V_433 != NULL ) {
if ( V_433 -> V_341 == F_229 ( V_467 ) )
V_279 = V_339 ;
#if F_165 ( V_345 )
else if ( V_433 -> V_341 == F_229 ( V_468 ) )
V_279 = V_323 ;
#endif
}
...
{
return F_159 ( V_27 , V_183 , V_515 , V_516 , 0 ) ;
}
