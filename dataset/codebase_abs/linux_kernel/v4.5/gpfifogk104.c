...
int V_32 = - V_56 , V_57 ;
F_30 ( V_51 , L_2 , V_47 ) ;
if ( ! ( V_32 = F_31 ( V_32 , & V_46 , & V_47 , args -> V_50 , 0 , 0 , false ) ) ) {
F_30 ( V_51 , L_3
L_4 ,
args -> V_50 . V_58 , args -> V_50 . V_37 , args -> V_50 . V_53 ,
args -> V_50 . V_54 , args -> V_50 . V_8 ) ;
} else
return V_32 ;
for ( V_57 = 0 , V_55 = 0 ; V_57 < F_32 ( V_4 -> V_8 ) ; V_57 ++ ) {
T_2 V_59 = F_33 ( V_57 ) ;
if ( ! F_34 ( V_10 , F_35 ( V_59 ) ) )
continue;
V_55 |= ( 1 << V_57 ) ;
}
if ( ! args -> V_50 . V_8 ) {
...
if ( ! ( V_2 = F_37 ( sizeof( * V_2 ) , V_61 ) ) )
return - V_62 ;
* V_48 = & V_2 -> V_7 . V_13 ;
V_2 -> V_4 = V_4 ;
V_2 -> V_8 = F_38 ( args -> V_50 . V_8 ) ;
F_39 ( & V_2 -> V_40 ) ;
V_32 = F_40 ( & V_63 , & V_4 -> V_7 ,
0x1000 , 0x1000 , true , args -> V_50 . V_37 , 0 ,
F_33 ( V_2 -> V_8 ) ,
1 , V_4 -> V_64 . V_65 . V_29 , 0x200 ,
V_45 , & V_2 -> V_7 ) ;
if ( V_32 )
return V_32 ;
...
F_8 ( V_4 -> V_64 . V_66 ) ;
for ( V_57 = 0 ; V_57 < 0x200 ; V_57 += 4 )
F_9 ( V_4 -> V_64 . V_66 , V_52 + V_57 , 0x00000000 ) ;
F_10 ( V_4 -> V_64 . V_66 ) ;
V_52 = F_43 ( V_4 -> V_64 . V_66 ) + V_52 ;
F_8 ( V_2 -> V_7 . V_31 ) ;
