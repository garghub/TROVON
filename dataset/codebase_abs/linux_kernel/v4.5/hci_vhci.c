...
if ( ! V_7 )
return - V_15 ;
if ( F_24 ( F_20 ( V_7 , V_30 ) , V_30 , V_29 ) != V_30 ) {
F_14 ( V_7 ) ;
return - V_34 ;
}
V_31 = * ( ( T_1 * ) V_7 -> V_4 ) ;
...
char T_4 * V_43 = V_41 ;
int V_30 ;
V_30 = F_29 (unsigned int, skb->len, count) ;
if ( F_30 ( V_43 , V_7 -> V_4 , V_30 ) )
return - V_34 ;
if ( ! V_4 -> V_2 )
return V_30 ;
V_4 -> V_2 -> V_44 . V_45 += V_30 ;
switch ( F_8 ( V_7 ) ) {
case V_46 :
V_4 -> V_2 -> V_44 . V_47 ++ ;
break;
...
static T_2 F_36 ( struct V_56 * V_57 , struct V_28 * V_29 )
{
struct V_50 * V_50 = V_57 -> V_58 ;
struct V_3 * V_4 = V_50 -> V_52 ;
return F_22 ( V_4 , V_29 ) ;
}
static unsigned int F_37 ( struct V_50 * V_50 , T_6 * V_59 )
{
struct V_3 * V_4 = V_50 -> V_52 ;
F_38 ( V_50 , & V_4 -> V_8 , V_59 ) ;
if ( ! F_35 ( & V_4 -> V_5 ) )
return V_60 | V_61 ;
return V_62 | V_63 ;
}
...
V_40 . V_65 ) ;
F_11 ( V_4 , V_66 ? V_12 : V_11 ) ;
}
static int F_41 ( struct V_67 * V_67 , struct V_50 * V_50 )
{
struct V_3 * V_4 ;
V_4 = F_42 ( sizeof( struct V_3 ) , V_14 ) ;
if ( ! V_4 )
return - V_15 ;
F_43 ( & V_4 -> V_5 ) ;
F_44 ( & V_4 -> V_8 ) ;
