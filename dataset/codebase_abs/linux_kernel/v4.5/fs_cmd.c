...
if ( V_49 -> V_68 . type ==
V_69 )
V_13 = V_49 -> V_68 . V_4 -> V_13 ;
else
V_13 = V_49 -> V_68 . V_70 ;
F_3 ( V_46 , V_52 , V_71 , V_13 ) ;
V_52 += F_10 ( V_46 ) ;
}
memset ( V_7 , 0 , sizeof( V_7 ) ) ;
...
memset ( V_5 , 0 , sizeof( V_5 ) ) ;
memset ( V_7 , 0 , sizeof( V_7 ) ) ;
F_3 ( V_78 , V_5 , V_9 , V_79 ) ;
F_3 ( V_78 , V_5 , V_11 , V_4 -> type ) ;
F_3 ( V_78 , V_5 , V_12 , V_4 -> V_13 ) ;
F_3 ( V_78 , V_5 , V_57 , V_58 ) ;
