...
F_111 ( V_149 L_14 , V_131 , V_137 ) ;
for ( V_148 += V_139 ; V_125 < V_148 ; V_125 ++ )
if ( V_147 -> V_127 [ V_125 ] != V_128 )
F_111 ( V_149 L_15 , V_132 ,
V_147 -> V_127 [ V_125 ] ) ;
else
F_111 ( V_149 L_16 , V_134 ) ;
}
}
F_111 ( V_149 L_12 ) ;
}
int T_6 F_112 ( const struct V_119 * V_122 ,
void * V_6 )
{
static int V_150 [ V_151 ] V_152 ;
static int V_153 [ V_151 ] V_152 ;
T_2 V_144 = V_122 -> V_144 ;
T_2 V_154 = V_122 -> V_108 + V_122 -> V_143 + V_144 ;
...
F_113 ( ! V_6 ) ;
F_113 ( F_100 ( V_6 ) ) ;
F_113 ( V_122 -> V_142 < V_154 ) ;
F_113 ( F_100 ( V_122 -> V_142 ) ) ;
F_113 ( V_122 -> V_142 < V_92 ) ;
F_113 ( V_122 -> V_144 < V_161 ) ;
F_113 ( F_114 ( V_122 ) < 0 ) ;
V_157 = F_115 ( V_122 -> V_120 *
sizeof( V_157 [ 0 ] ) , 0 ) ;
V_158 = F_115 ( V_122 -> V_120 *
sizeof( V_158 [ 0 ] ) , 0 ) ;
V_160 = F_115 ( V_162 * sizeof( V_160 [ 0 ] ) , 0 ) ;
V_159 = F_115 ( V_162 * sizeof( V_159 [ 0 ] ) , 0 ) ;
...
const struct V_146 * V_147 = & V_122 -> V_126 [ V_137 ] ;
V_157 [ V_137 ] = V_147 -> V_164 ;
V_158 [ V_137 ] = V_147 -> V_121 * V_122 -> V_142 ;
...
F_113 ( V_20 >= V_162 ) ;
F_113 ( ! F_116 ( V_20 ) ) ;
F_113 ( V_160 [ V_20 ] != V_163 ) ;
V_160 [ V_20 ] = V_125 + V_33 ;
V_159 [ V_20 ] = V_147 -> V_164 + V_33 * V_122 -> V_142 ;
if ( V_117 == V_128 ||
V_159 [ V_20 ] < V_159 [ V_117 ] )
V_117 = V_20 ;
if ( V_118 == V_128 ||
...
F_117 ( V_23 ) * sizeof( unsigned long ) ;
V_12 = F_5 ( V_7 ) + 2 ;
V_44 = F_115 (
...
V_155 -> V_6 = V_6 ;
V_155 -> V_35 = V_150 ;
V_155 -> V_48 = F_118 ( V_150 ) ;
V_155 -> V_98 = true ;
F_119 ( V_155 -> V_29 , V_23 ) ;
V_155 -> V_83 = V_23 ;
if ( V_122 -> V_143 ) {
V_155 -> V_15 = V_122 -> V_143 ;
V_42 = V_155 ;
...
V_155 -> V_35 [ 0 ] = 1 ;
V_155 -> V_35 [ 1 ] = V_122 -> V_108 ;
V_155 -> V_37 = 1 ;
if ( V_155 -> V_15 )
V_155 -> V_35 [ ++ V_155 -> V_37 ] = V_122 -> V_108 + V_155 -> V_15 ;
V_155 -> V_35 [ V_155 -> V_37 ] |= 1 ;
if ( V_144 ) {
V_156 = F_115 ( V_81 , 0 ) ;
F_49 ( & V_156 -> V_43 ) ;
F_50 ( & V_156 -> V_50 , F_39 ) ;
V_156 -> V_6 = V_6 ;
V_156 -> V_35 = V_153 ;
V_156 -> V_48 = F_118 ( V_153 ) ;
V_156 -> V_98 = true ;
F_119 ( V_156 -> V_29 , V_23 ) ;
V_156 -> V_83 = V_23 ;
V_156 -> V_16 = V_156 -> V_15 = V_144 ;
V_156 -> V_35 [ 0 ] = 1 ;
V_156 -> V_35 [ 1 ] = V_8 ;
...
static int T_6 F_120 ( char * V_171 )
{
if ( ! V_171 )
return - V_172 ;
if ( 0 )
...
static struct V_119 * T_6 F_123 (
T_2 V_143 , T_2 V_144 ,
T_2 V_145 ,
T_8 V_176 )
{
static int V_177 [ V_128 ] V_152 ;
static int V_178 [ V_128 ] V_152 ;
const T_2 V_108 = V_109 - V_110 ;
int V_120 = 1 , V_121 = 0 ;
T_2 V_154 , V_179 , V_141 ;
int V_139 , V_180 , V_181 ( V_182 ) ;
int V_183 , V_137 , V_125 ;
unsigned int V_20 , V_184 ;
struct V_119 * V_122 ;
unsigned int * V_127 ;
memset ( V_177 , 0 , sizeof( V_177 ) ) ;
memset ( V_178 , 0 , sizeof( V_178 ) ) ;
V_154 = F_104 ( V_108 + V_143 +
F_29 ( T_2 , V_144 , V_161 ) ) ;
V_144 = V_154 - V_108 - V_143 ;
V_179 = F_29 ( T_2 , V_154 , V_92 ) ;
V_141 = F_124 ( V_179 , V_145 ) ;
V_139 = V_141 / V_179 ;
...
V_183 = V_187 ;
for ( V_139 = V_180 ; V_139 ; V_139 -- ) {
int V_188 = 0 , V_189 = 0 ;
if ( V_141 % V_139 || ( F_100 ( V_141 / V_139 ) ) )
continue;
for ( V_137 = 0 ; V_137 < V_120 ; V_137 ++ ) {
int V_190 = F_125 ( V_178 [ V_137 ] , V_139 ) ;
V_188 += V_190 ;
V_189 += V_190 * V_139 - V_178 [ V_137 ] ;
}
if ( V_189 > F_108 () / 3 )
continue;
if ( V_188 > V_183 )
...
V_122 -> V_145 = V_145 ;
V_122 -> V_141 = V_141 ;
for ( V_137 = 0 , V_125 = 0 ; V_178 [ V_137 ] ; V_137 ++ ) {
struct V_146 * V_147 = & V_122 -> V_126 [ V_137 ] ;
V_147 -> V_164 = V_125 * V_122 -> V_142 ;
F_71 (cpu)
if ( V_177 [ V_20 ] == V_137 )
V_147 -> V_127 [ V_147 -> V_121 ++ ] = V_20 ;
V_147 -> V_121 = F_124 ( V_147 -> V_121 , V_139 ) ;
V_125 += V_147 -> V_121 ;
}
F_47 ( V_125 != V_121 ) ;
return V_122 ;
}
int T_6 F_127 ( T_2 V_143 , T_2 V_144 ,
T_2 V_145 ,
T_8 V_176 ,
T_9 V_191 ,
T_10 V_192 )
{
void * V_111 = ( void * ) V_193 ;
void * * V_194 = NULL ;
struct V_119 * V_122 ;
T_2 V_154 , V_195 , V_196 ;
int V_137 , V_33 , V_197 ;
V_122 = F_123 ( V_143 , V_144 , V_145 ,
V_176 ) ;
if ( F_128 ( V_122 ) )
return F_129 ( V_122 ) ;
V_154 = V_122 -> V_108 + V_122 -> V_143 + V_122 -> V_144 ;
V_195 = F_104 ( V_122 -> V_120 * sizeof( void * ) ) ;
V_194 = F_103 ( V_195 , 0 ) ;
if ( ! V_194 ) {
V_197 = - V_58 ;
goto V_198;
...
V_20 = V_147 -> V_127 [ V_33 ] ;
F_47 ( V_20 == V_128 ) ;
V_32 = V_191 ( V_20 , V_147 -> V_121 * V_122 -> V_142 , V_145 ) ;
if ( ! V_32 ) {
V_197 = - V_58 ;
goto V_199;
}
...
for ( V_137 = 0 ; V_137 < V_122 -> V_120 ; V_137 ++ ) {
struct V_146 * V_147 = & V_122 -> V_126 [ V_137 ] ;
void * V_32 = V_194 [ V_137 ] ;
for ( V_33 = 0 ; V_33 < V_147 -> V_121 ; V_33 ++ , V_32 += V_122 -> V_142 ) {
if ( V_147 -> V_127 [ V_33 ] == V_128 ) {
V_192 ( V_32 , V_122 -> V_142 ) ;
continue;
}
memcpy ( V_32 , V_200 , V_122 -> V_108 ) ;
V_192 ( V_32 + V_154 , V_122 -> V_142 - V_154 ) ;
}
}
V_196 = 0 ;
for ( V_137 = 0 ; V_137 < V_122 -> V_120 ; V_137 ++ ) {
V_122 -> V_126 [ V_137 ] . V_164 = V_194 [ V_137 ] - V_111 ;
V_196 = F_29 ( T_2 , V_196 ,
V_122 -> V_126 [ V_137 ] . V_164 ) ;
}
V_196 += V_122 -> V_142 ;
if ( V_196 > V_201 * 3 / 4 ) {
F_74 ( L_20
...
F_76 ( L_22 ,
F_30 ( V_154 ) , V_111 , V_122 -> V_108 , V_122 -> V_143 ,
V_122 -> V_144 , V_122 -> V_142 ) ;
V_197 = F_112 ( V_122 , V_111 ) ;
goto V_198;
V_199:
for ( V_137 = 0 ; V_137 < V_122 -> V_120 ; V_137 ++ )
if ( V_194 [ V_137 ] )
...
T_2 V_207 ;
struct V_17 * * V_208 ;
int V_125 , V_33 , V_78 , V_197 ;
snprintf ( V_205 , sizeof( V_205 ) , L_23 , V_30 >> 10 ) ;
V_122 = F_123 ( V_143 , 0 , V_30 , NULL ) ;
if ( F_128 ( V_122 ) )
return F_129 ( V_122 ) ;
F_47 ( V_122 -> V_120 != 1 ) ;
F_47 ( V_122 -> V_126 [ 0 ] . V_121 != F_108 () ) ;
V_206 = V_122 -> V_142 >> V_25 ;
V_207 = F_104 ( V_206 * F_108 () *
sizeof( V_208 [ 0 ] ) ) ;
V_208 = F_115 ( V_207 , 0 ) ;
V_78 = 0 ;
...
F_130 ( V_32 ) ;
V_208 [ V_78 ++ ] = F_132 ( V_32 ) ;
}
V_204 . V_57 = V_210 ;
V_204 . V_9 = F_108 () * V_122 -> V_142 ;
F_133 ( & V_204 , V_30 ) ;
for ( V_125 = 0 ; V_125 < F_108 () ; V_125 ++ ) {
unsigned long V_211 =
( unsigned long ) V_204 . V_3 + V_125 * V_122 -> V_142 ;
for ( V_33 = 0 ; V_33 < V_206 ; V_33 ++ )
V_202 ( V_211 + ( V_33 << V_25 ) ) ;
V_197 = F_134 ( V_211 , & V_208 [ V_125 * V_206 ] ,
V_206 ) ;
if ( V_197 < 0 )
F_135 ( L_26 , V_197 ) ;
memcpy ( ( void * ) V_211 , V_200 , V_122 -> V_108 ) ;
}
F_76 ( L_27 ,
V_206 , V_205 , V_204 . V_3 , V_122 -> V_108 ,
V_122 -> V_143 , V_122 -> V_144 ) ;
V_197 = F_112 ( V_122 , V_204 . V_3 ) ;
goto V_212;
V_209:
while ( -- V_78 >= 0 )
V_192 ( F_136 ( V_208 [ V_78 ] ) , V_30 ) ;
V_197 = - V_58 ;
V_212:
F_106 ( F_97 ( V_208 ) , V_207 ) ;
F_105 ( V_122 ) ;
return V_197 ;
}
static void * T_6 F_137 ( unsigned int V_20 , T_2 V_9 ,
T_2 V_64 )
{
return F_138 (
V_9 , V_64 , F_97 ( V_213 ) ) ;
}
static void T_6 F_139 ( void * V_32 , T_2 V_9 )
{
F_106 ( F_97 ( V_32 ) , V_9 ) ;
}
void T_6 F_140 ( void )
...
if ( V_197 < 0 )
F_135 ( L_28 ) ;
V_214 = ( unsigned long ) V_112 - ( unsigned long ) V_110 ;
F_71 (cpu)
V_217 [ V_20 ] = V_214 + V_24 [ V_20 ] ;
}
void T_6 F_140 ( void )
{
const T_2 V_142 =
...
unsigned long V_57 ;
int V_33 ;
for ( V_33 = 0 ; ( V_14 = V_219 [ V_33 ] ) ; V_33 ++ ) {
int * V_35 ;
