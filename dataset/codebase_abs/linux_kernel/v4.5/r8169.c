...
unsigned int V_346 ;
F_444 ( & V_6 -> V_18 ) ;
if ( F_89 ( V_18 ) && F_445 ( & V_6 -> V_18 ) )
F_427 ( V_18 , V_23 ) ;
do {
V_346 = F_446 ( & V_2 -> V_726 . V_697 ) ;
V_292 -> V_294 = V_2 -> V_726 . V_698 ;
V_292 -> V_755 = V_2 -> V_726 . V_699 ;
} while ( F_447 ( & V_2 -> V_726 . V_697 , V_346 ) );
do {
V_346 = F_446 ( & V_2 -> V_696 . V_697 ) ;
V_292 -> V_293 = V_2 -> V_696 . V_698 ;
V_292 -> V_756 = V_2 -> V_696 . V_699 ;
} while ( F_447 ( & V_2 -> V_696 . V_697 , V_346 ) );
...
static int F_450 ( struct V_596 * V_596 )
{
struct V_5 * V_6 = F_451 ( V_596 ) ;
struct V_53 * V_18 = F_452 ( V_6 ) ;
F_448 ( V_18 ) ;
return 0 ;
}
static void F_453 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_454 ( V_18 ) ;
F_239 ( V_2 ) ;
...
static void F_461 ( struct V_5 * V_6 )
{
struct V_53 * V_18 = F_452 ( V_6 ) ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
static unsigned F_468 ( struct V_1 * V_2 ,
...
static int F_473 ( struct V_5 * V_6 , const struct V_770 * V_771 )
{
...
V_2 -> V_18 = V_18 ;
V_2 -> V_5 = V_6 ;
V_2 -> V_269 = F_477 ( V_777 . V_269 , V_781 ) ;
V_212 = & V_2 -> V_212 ;
V_212 -> V_18 = V_18 ;
V_212 -> V_782 = F_43 ;
V_212 -> V_783 = F_41 ;
...
if ( F_482 ( V_6 , V_774 ) < V_178 ) {
F_11 ( V_2 , V_335 , V_18 ,
L_37 ) ;
V_195 = - V_417 ;
goto V_792;
}
V_195 = F_483 ( V_6 , V_173 ) ;
if ( V_195 < 0 ) {
...
V_2 -> V_243 = 0 ;
if ( ( sizeof( T_6 ) > 4 ) &&
! F_484 ( V_6 , F_141 ( 64 ) ) && V_793 ) {
V_2 -> V_243 |= V_693 ;
V_18 -> V_165 |= V_694 ;
} else {
V_195 = F_484 ( V_6 , F_141 ( 32 ) ) ;
if ( V_195 < 0 ) {
...
V_18 -> V_799 = & V_800 ;
V_18 -> V_801 = V_802 ;
F_491 ( V_18 , & V_2 -> V_611 , F_425 , V_803 ) ;
V_18 -> V_165 |= V_242 |
V_804 | V_245 ;
