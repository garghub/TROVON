...
if ( strstr ( V_89 -> V_49 , L_32 ) ) {
V_19 = F_17 ( V_60 , V_2 ) ;
if ( V_19 ) {
F_7 ( & V_61 -> V_18 , L_33 ) ;
goto V_114;
}
} else if ( strstr ( V_89 -> V_49 , L_34 ) ) {
V_2 -> V_16 . V_25 [ 1 ] = V_115 ;
V_2 -> V_16 . V_25 [ 0 ] = V_116 ;
} else if ( strstr ( V_89 -> V_49 , L_35 ) ) {
V_2 -> V_16 . V_25 [ 1 ] = V_117 ;
V_2 -> V_16 . V_25 [ 0 ] = V_117 ;
}
snprintf ( V_2 -> V_49 , sizeof( V_2 -> V_49 ) , L_36 ,
F_1 ( V_2 ) ? L_37 :
V_96 -> V_49 ) ;
V_2 -> V_61 = V_61 ;
...
V_2 -> V_12 . V_118 = F_1 ( V_2 ) ?
V_119 : V_120 ;
V_2 -> V_12 . V_121 = F_25 ;
V_2 -> V_12 . V_122 = F_40 ( V_120 ) ;
V_2 -> V_12 . V_123 = V_124 ;
V_2 -> V_12 . V_125 = F_40 ( V_124 ) ;
memcpy ( V_2 -> V_48 , V_126 ,
sizeof( struct V_127 ) * F_40 ( V_2 -> V_48 ) ) ;
V_19 = F_41 ( & V_2 -> V_12 , L_38 ) ;
if ( V_19 ) {
F_7 ( & V_61 -> V_18 , L_39 , V_19 ) ;
goto V_114;
}
V_2 -> V_48 [ 0 ] . V_128 = V_89 ;
V_2 -> V_48 [ 0 ] . V_97 = V_97 ;
if ( ! F_1 ( V_2 ) )
V_2 -> V_48 [ 0 ] . V_129 = V_90 ;
else {
T_1 V_130 ;
V_19 = F_18 ( V_89 , L_40 , & V_130 ) ;
if ( V_19 ) {
F_7 ( & V_61 -> V_18 ,
L_41 ) ;
goto V_114;
...
V_2 -> V_48 [ 0 ] . V_132 = V_89 ;
V_2 -> V_48 [ 0 ] . V_3 = V_2 -> V_3 ;
V_2 -> V_12 . V_133 = 1 ;
if ( V_93 ) {
V_2 -> V_48 [ 1 ] . V_128 = V_91 ;
V_2 -> V_48 [ 1 ] . V_132 = V_91 ;
V_2 -> V_48 [ 2 ] . V_97 = V_97 ;
V_2 -> V_48 [ 2 ] . V_129 = V_90 ;
V_2 -> V_48 [ 2 ] . V_131 =
V_2 -> V_48 [ 0 ] . V_131 ;
V_2 -> V_48 [ 2 ] . V_128 = V_89 ;
