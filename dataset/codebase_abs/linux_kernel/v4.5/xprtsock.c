...
F_158 ( V_8 , L_53 ,
& V_240 [ 1 ] , L_54 , & V_241 [ 1 ] ) ;
}
static inline void F_159 ( struct V_39 * V_7 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
F_158 ( V_8 , L_55 ,
& V_240 [ 0 ] , L_56 , & V_241 [ 0 ] ) ;
}
static inline void F_160 ( struct V_39 * V_7 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
F_158 ( V_8 , L_57 ,
& V_240 [ 1 ] , L_58 , & V_241 [ 1 ] ) ;
}
static inline void F_161 ( int V_242 , struct V_39 * V_7 )
{
F_162 ( F_163 ( V_7 -> V_8 ) ) ;
if ( F_163 ( V_7 -> V_8 ) )
return;
...
struct V_82 * V_83 , int V_242 , int type ,
int V_33 , bool V_243 )
{
struct V_39 * V_7 ;
int V_64 ;
V_64 = F_166 ( V_11 -> V_244 , V_242 , type , V_33 , & V_7 , 1 ) ;
if ( V_64 < 0 ) {
F_2 ( L_59 ,
V_33 , - V_64 ) ;
goto V_78;
...
{
struct V_82 * V_255 = F_28 ( V_11 , struct V_82 , V_11 ) ;
if ( F_181 ( & V_11 -> V_133 ) != 1 )
return 0 ;
if ( F_182 ( & V_11 -> V_119 , V_256 , V_257 ) )
return - V_258 ;
if ( V_255 -> V_86 )
F_179 ( V_255 -> V_86 ) ;
F_46 ( V_11 , NULL ) ;
...
if ( ! V_83 -> V_86 ) {
struct V_7 * V_8 = V_7 -> V_8 ;
unsigned int V_262 = V_11 -> V_263 -> V_264 / V_265 ;
unsigned int V_266 = V_11 -> V_263 -> V_267 + 1 ;
unsigned int V_268 = 1 ;
unsigned int V_269 ;
F_143 ( V_7 , V_225 , V_270 ,
( char * ) & V_268 , sizeof( V_268 ) ) ;
F_143 ( V_7 , V_271 , V_272 ,
( char * ) & V_262 , sizeof( V_262 ) ) ;
F_143 ( V_7 , V_271 , V_273 ,
( char * ) & V_262 , sizeof( V_262 ) ) ;
F_143 ( V_7 , V_271 , V_274 ,
( char * ) & V_266 , sizeof( V_266 ) ) ;
V_269 = F_192 ( V_11 -> V_263 -> V_264 ) *
( V_11 -> V_263 -> V_267 + 1 ) ;
F_143 ( V_7 , V_271 , V_275 ,
...
V_90 = F_169 ( V_7 , F_4 ( V_11 ) , V_11 -> V_40 , V_279 ) ;
switch ( V_90 ) {
case 0 :
F_149 ( V_83 , V_7 ) ;
case - V_280 :
...
static void F_200 ( struct V_6 * V_11 , struct V_285 * V_286 )
{
long V_287 = 0 ;
if ( F_31 ( V_11 ) )
V_287 = ( long ) ( V_250 - V_11 -> V_288 ) / V_265 ;
F_201 ( V_286 , L_74
L_75 ,
V_11 -> V_247 . V_289 ,
V_11 -> V_247 . V_248 ,
...
static void F_202 ( struct V_6 * V_11 , struct V_285 * V_286 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
F_201 ( V_286 , L_76
L_77 ,
...
static void F_203 ( struct V_6 * V_11 , struct V_285 * V_286 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
long V_287 = 0 ;
if ( F_31 ( V_11 ) )
...
struct V_58 * V_58 ;
struct V_299 * V_4 ;
F_162 ( V_60 > V_300 - sizeof( struct V_299 ) ) ;
if ( V_60 > V_300 - sizeof( struct V_299 ) )
return NULL ;
V_58 = F_205 ( V_24 ) ;
if ( ! V_58 )
return NULL ;
...
static void F_207 ( void * V_301 )
{
struct V_299 * V_4 ;
if ( ! V_301 )
return;
V_4 = F_28 ( V_301 , struct V_299 , V_191 ) ;
F_208 ( ( unsigned long ) V_4 ) ;
}
static int F_209 ( struct V_88 * V_89 )
{
int V_73 ;
struct V_54 * V_302 = & V_89 -> V_101 ;
struct V_6 * V_11 = V_89 -> V_85 ;
struct V_82 * V_83 =
F_28 ( V_11 , struct V_82 , V_11 ) ;
struct V_39 * V_7 = V_83 -> V_7 ;
...
unsigned long V_304 ;
F_34 ( V_302 ) ;
V_304 = ( unsigned long ) V_302 -> V_79 [ 0 ] . V_52 & ~ V_69 ;
V_303 = ( unsigned long ) V_302 -> V_77 [ 0 ] . V_52 & ~ V_69 ;
V_73 = F_210 ( V_7 , V_302 ,
F_211 ( V_302 -> V_77 [ 0 ] . V_52 ) , V_303 ,
V_302 -> V_79 [ 0 ] . V_52 , V_304 ) ;
if ( V_73 != V_302 -> V_73 ) {
F_106 ( V_305 L_79 ) ;
V_73 = - V_91 ;
}
...
V_11 = V_89 -> V_85 -> V_307 ;
if ( ! F_213 ( & V_11 -> V_308 ) ) {
F_214 ( & V_11 -> V_309 , V_81 , NULL ) ;
if ( ! F_213 ( & V_11 -> V_308 ) )
return - V_91 ;
F_215 ( & V_11 -> V_309 , V_81 ) ;
}
if ( F_216 ( V_310 , & V_11 -> V_311 ) )
V_73 = - V_96 ;
else
V_73 = F_209 ( V_89 ) ;
F_68 ( & V_11 -> V_308 ) ;
...
static int F_219 ( const int V_242 , struct V_10 * V_16 )
{
static const struct V_14 sin = {
. V_312 = V_25 ,
. V_26 . V_27 = F_220 ( V_313 ) ,
} ;
...
static struct V_6 * F_221 ( struct V_317 * args ,
unsigned int V_318 ,
unsigned int V_319 )
{
struct V_6 * V_11 ;
...
V_11 = F_222 ( args -> V_186 , sizeof( * V_320 ) , V_318 ,
V_319 ) ;
if ( V_11 == NULL ) {
F_2 ( L_84
L_85 ) ;
...
V_320 = F_28 ( V_11 , struct V_82 , V_11 ) ;
F_223 ( & V_320 -> V_135 ) ;
memcpy ( & V_11 -> V_12 , args -> V_323 , args -> V_40 ) ;
V_11 -> V_40 = args -> V_40 ;
if ( args -> V_237 )
memcpy ( & V_320 -> V_237 , args -> V_237 , args -> V_40 ) ;
else {
int V_64 ;
V_64 = F_219 ( args -> V_323 -> V_19 ,
(struct V_10 * ) & V_320 -> V_237 ) ;
if ( V_64 != 0 ) {
F_73 ( V_11 ) ;
return F_167 ( V_64 ) ;
}
...
static struct V_6 * F_224 ( struct V_317 * args )
{
struct V_13 * V_18 = (struct V_13 * ) args -> V_323 ;
struct V_82 * V_83 ;
struct V_6 * V_11 ;
struct V_6 * V_90 ;
V_11 = F_221 ( args , V_324 ,
V_325 ) ;
if ( F_187 ( V_11 ) )
return V_11 ;
V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
V_11 -> V_326 = 0 ;
V_11 -> V_327 = sizeof( V_99 ) / sizeof( T_1 ) ;
V_11 -> V_328 = V_329 ;
V_11 -> V_330 = V_331 ;
V_11 -> V_136 = V_205 ;
V_11 -> V_332 = V_333 ;
...
static struct V_6 * F_228 ( struct V_317 * args )
{
struct V_10 * V_12 = args -> V_323 ;
struct V_6 * V_11 ;
struct V_82 * V_83 ;
struct V_6 * V_90 ;
V_11 = F_221 ( args , V_339 ,
V_339 ) ;
if ( F_187 ( V_11 ) )
return V_11 ;
V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
...
static struct V_6 * F_230 ( struct V_317 * args )
{
struct V_10 * V_12 = args -> V_323 ;
struct V_6 * V_11 ;
struct V_82 * V_83 ;
struct V_6 * V_90 ;
unsigned int V_319 = V_325 ;
if ( args -> V_61 & V_346 )
V_319 = V_347 ;
V_11 = F_221 ( args , V_324 ,
V_319 ) ;
...
static struct V_6 * F_231 ( struct V_317 * args )
{
struct V_10 * V_12 = args -> V_323 ;
struct V_6 * V_11 ;
struct V_82 * V_83 ;
...
V_11 -> V_22 [ V_35 ] ) ;
F_232 ( V_11 ) ;
args -> V_307 -> V_355 = V_11 ;
V_11 -> V_307 = args -> V_307 ;
V_353 = F_28 ( args -> V_307 , struct V_352 , V_356 ) ;
V_83 -> V_7 = V_353 -> V_357 ;
V_83 -> V_86 = V_353 -> V_358 ;
F_172 ( V_11 ) ;
if ( F_227 ( V_139 ) )
return V_11 ;
args -> V_307 -> V_355 = NULL ;
F_233 ( V_11 ) ;
V_90 = F_167 ( - V_259 ) ;
V_337:
F_72 ( V_11 ) ;
...
static int F_241 ( const char * V_366 ,
const struct V_367 * V_368 ,
unsigned int V_369 , unsigned int V_370 )
{
unsigned int V_371 ;
int V_90 ;
if ( ! V_366 )
return - V_259 ;
V_90 = F_242 ( V_366 , 0 , & V_371 ) ;
if ( V_90 == - V_259 || V_371 < V_369 || V_371 > V_370 )
return - V_259 ;
* ( ( unsigned int * ) V_368 -> V_190 ) = V_371 ;
return 0 ;
}
static int F_243 ( const char * V_366 , const struct V_367 * V_368 )
{
return F_241 ( V_366 , V_368 ,
V_372 ,
V_373 ) ;
}
static int F_244 ( const char * V_366 ,
const struct V_367 * V_368 )
{
return F_241 ( V_366 , V_368 ,
V_374 ,
...
static int F_245 ( const char * V_366 ,
const struct V_367 * V_368 )
{
return F_241 ( V_366 , V_368 ,
V_374 ,
