...
{
unsigned long V_126 ;
struct V_3 * V_4 = F_43 ( V_125 -> V_102 ) ;
struct V_127 * V_128 = F_45 ( V_125 ) ;
struct V_129 * V_130 =
F_46 ( V_128 , struct V_129 , V_125 ) ;
F_47 ( & V_4 -> V_131 , V_126 ) ;
if ( ! V_4 -> V_47 ) {
F_48 ( & V_130 -> V_125 . V_132 , V_133 ) ;
} else {
V_130 -> V_134 = F_49 ( V_125 , 0 ) ;
V_130 -> V_135 = F_50 ( V_125 , 0 ) ;
V_130 -> V_136 = 0 ;
V_130 -> V_137 = 0 ;
if ( V_130 -> V_135 < V_4 -> V_90 * V_4 -> V_91 * 2 )
F_48 ( & V_130 -> V_125 . V_132 , V_133 ) ;
else
F_51 ( & V_130 -> V_138 , & V_4 -> V_139 ) ;
}
F_52 ( & V_4 -> V_131 , V_126 ) ;
}
static int F_53 ( struct V_102 * V_118 , unsigned int V_140 )
{
struct V_3 * V_4 = F_43 ( V_118 ) ;
return F_8 ( V_4 ) ;
}
...
unsigned long V_126 ;
F_47 ( & V_4 -> V_131 , V_126 ) ;
while ( ! F_55 ( & V_4 -> V_139 ) ) {
V_130 = F_56 ( & V_4 -> V_139 ,
struct V_129 , V_138 ) ;
F_57 ( & V_130 -> V_138 ) ;
F_48 ( & V_130 -> V_125 . V_132 , V_133 ) ;
F_3 ( L_15 ,
V_130 , V_130 -> V_125 . V_132 . V_80 ) ;
}
if ( V_4 -> V_53 . V_130 ) {
V_130 = V_4 -> V_53 . V_130 ;
V_4 -> V_53 . V_130 = NULL ;
F_48 ( & V_130 -> V_125 . V_132 , V_133 ) ;
F_3 ( L_15 ,
V_130 , V_130 -> V_125 . V_132 . V_80 ) ;
...
V_103 = & V_4 -> V_104 ;
V_103 -> type = V_141 ;
V_103 -> V_142 = V_143 | V_144 | V_145 | V_146 ;
V_103 -> V_147 = V_4 ;
V_103 -> V_148 = sizeof( struct V_129 ) ;
V_103 -> V_149 = & V_150 ;
V_103 -> V_151 = & V_152 ;
V_103 -> V_153 = V_154 ;
V_49 = F_59 ( V_103 ) ;
...
int V_49 ;
V_4 -> V_113 = V_155 ;
V_4 -> V_113 . V_156 = & V_4 -> V_104 ;
V_4 -> V_113 . V_157 = & V_4 -> V_51 ;
V_4 -> V_113 . V_156 -> V_157 = & V_4 -> V_158 ;
