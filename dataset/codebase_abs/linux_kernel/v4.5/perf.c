...
{
struct V_40 V_6 = V_59 ;
const char * V_60 ;
int V_43 ;
F_40 ( & V_6 , L_39 , V_10 [ 0 ] ) ;
V_60 = V_10 [ 0 ] ;
V_10 [ 0 ] = V_6 . V_41 ;
V_43 = F_41 ( V_10 , 0 ) ;
if ( V_43 != - V_61 ) {
