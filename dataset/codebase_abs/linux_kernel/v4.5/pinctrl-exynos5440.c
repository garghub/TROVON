...
unsigned long V_136 ;
V_135 = F_54 ( V_134 ) ;
V_136 = F_19 ( V_135 -> V_54 + V_137 ) ;
V_136 |= 1 << V_134 -> V_138 ;
F_20 ( V_136 , V_135 -> V_54 + V_137 ) ;
}
...
static T_3 F_56 ( int V_139 , void * V_36 )
{
struct V_140 * V_141 = V_36 ;
struct V_3 * V_135 = V_141 -> V_4 ;
int V_82 ;
V_82 = F_57 ( V_135 -> V_84 , V_141 -> V_136 ) ;
if ( ! V_82 )
return V_142 ;
F_58 ( V_82 ) ;
return V_143 ;
}
static int F_59 ( struct V_84 * V_144 , unsigned int V_82 ,
T_4 V_145 )
{
...
struct V_16 * V_17 = & V_86 -> V_17 ;
struct V_140 * V_141 ;
int V_63 , V_139 , V_103 ;
V_141 = F_38 ( V_17 , sizeof( * V_141 ) * V_149 ,
V_28 ) ;
if ( ! V_141 )
return - V_29 ;
for ( V_63 = 0 ; V_63 < V_149 ; V_63 ++ ) {
V_139 = F_63 ( V_17 -> V_95 , V_63 ) ;
if ( V_139 <= 0 ) {
F_8 ( V_17 , L_14 ) ;
return - V_27 ;
}
...
if ( ! V_4 )
return - V_29 ;
V_152 = F_68 ( V_86 , V_154 , 0 ) ;
V_4 -> V_54 = F_69 ( & V_86 -> V_17 , V_152 ) ;
if ( F_46 ( V_4 -> V_54 ) )
