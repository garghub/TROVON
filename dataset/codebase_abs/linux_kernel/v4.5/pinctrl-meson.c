...
static int F_29 ( struct V_71 * V_72 , unsigned V_73 )
{
return F_30 ( V_72 -> V_74 + V_73 ) ;
}
static void F_31 ( struct V_71 * V_72 , unsigned V_73 )
{
struct V_1 * V_2 = F_32 ( V_72 ) ;
F_33 ( V_2 -> V_7 -> V_18 + V_73 ) ;
}
static int F_34 ( struct V_71 * V_72 , unsigned V_73 )
{
struct V_1 * V_2 = F_32 ( V_72 ) ;
...
static void F_36 ( struct V_71 * V_72 , unsigned V_73 , int V_77 )
{
struct V_1 * V_2 = F_32 ( V_72 ) ;
unsigned int V_22 , V_23 , V_3 ;
struct V_4 * V_5 ;
...
static int F_37 ( struct V_71 * V_72 , unsigned V_73 )
{
struct V_1 * V_2 = F_32 ( V_72 ) ;
...
V_2 -> V_72 . V_87 = V_2 -> V_7 -> V_19 ;
V_2 -> V_72 . V_88 = false ;
V_2 -> V_72 . V_89 = V_2 -> V_89 ;
V_2 -> V_72 . V_90 = 2 ;
V_49 = F_39 ( & V_2 -> V_72 , V_2 ) ;
if ( V_49 ) {
F_40 ( V_14 -> V_37 , L_8 ,
V_2 -> V_7 -> V_32 ) ;
goto V_91;
}
V_49 = F_41 ( & V_2 -> V_72 , F_10 ( V_14 -> V_37 ) ,
0 , V_2 -> V_7 -> V_18 ,
V_2 -> V_72 . V_87 ) ;
if ( V_49 ) {
F_40 ( V_14 -> V_37 , L_9 ) ;
...
V_91:
for ( V_6 -- ; V_6 >= 0 ; V_6 -- )
F_42 ( & V_14 -> V_17 [ V_6 ] . V_72 ) ;
return V_49 ;
}
static struct V_92 * F_43 ( struct V_13 * V_14 ,
struct V_93 * V_94 )
{
int V_6 ;
for ( V_6 = 0 ; V_6 < V_14 -> V_7 -> V_16 ; V_6 ++ ) {
if ( ! strcmp ( V_94 -> V_32 , V_14 -> V_7 -> V_95 [ V_6 ] . V_32 ) )
return & V_14 -> V_7 -> V_95 [ V_6 ] ;
}
return NULL ;
}
static struct V_96 * F_44 ( struct V_13 * V_14 ,
struct V_93 * V_97 , char * V_32 )
{
struct V_98 V_99 ;
void T_2 * V_74 ;
int V_6 ;
V_6 = F_45 ( V_97 , L_10 , V_32 ) ;
if ( F_46 ( V_97 , V_6 , & V_99 ) )
return F_47 ( - V_100 ) ;
V_74 = F_48 ( V_14 -> V_37 , & V_99 ) ;
if ( F_49 ( V_74 ) )
return F_50 ( V_74 ) ;
V_101 . V_102 = F_51 ( & V_99 ) - 4 ;
V_101 . V_32 = F_52 ( V_14 -> V_37 , V_103 ,
L_11 , V_97 -> V_32 ,
V_32 ) ;
if ( ! V_101 . V_32 )
return F_47 ( - V_104 ) ;
return F_53 ( V_14 -> V_37 , V_74 , & V_101 ) ;
}
...
V_2 -> V_89 = V_94 ;
V_2 -> V_43 = F_44 ( V_14 , V_94 , L_15 ) ;
if ( F_49 ( V_2 -> V_43 ) ) {
F_40 ( V_14 -> V_37 , L_16 ) ;
return F_58 ( V_2 -> V_43 ) ;
}
V_2 -> V_60 = F_44 ( V_14 , V_94 , L_17 ) ;
if ( F_49 ( V_2 -> V_60 ) ) {
F_40 ( V_14 -> V_37 , L_18 ) ;
return F_58 ( V_2 -> V_60 ) ;
}
V_2 -> V_63 = F_44 ( V_14 , V_94 , L_19 ) ;
if ( F_49 ( V_2 -> V_63 ) )
V_2 -> V_63 = V_2 -> V_60 ;
V_2 -> V_76 = F_44 ( V_14 , V_94 , L_20 ) ;
if ( F_49 ( V_2 -> V_76 ) ) {
F_40 ( V_14 -> V_37 , L_21 ) ;
return F_58 ( V_2 -> V_76 ) ;
}
V_6 ++ ;
}
return 0 ;
...
struct V_110 * V_37 = & V_107 -> V_37 ;
struct V_13 * V_14 ;
int V_49 ;
V_14 = F_57 ( V_37 , sizeof( struct V_13 ) , V_103 ) ;
if ( ! V_14 )
return - V_104 ;
V_14 -> V_37 = V_37 ;
V_109 = F_60 ( V_111 , V_107 -> V_37 . V_89 ) ;
V_14 -> V_7 = (struct V_112 * ) V_109 -> V_7 ;
V_49 = F_54 ( V_14 , V_107 -> V_37 . V_89 ) ;
if ( V_49 )
return V_49 ;
V_14 -> V_25 . V_32 = L_22 ;
V_14 -> V_25 . V_113 = V_114 ;
V_14 -> V_25 . V_115 = & V_116 ;
V_14 -> V_25 . V_117 = & V_118 ;
V_14 -> V_25 . V_119 = & V_120 ;
V_14 -> V_25 . V_33 = V_14 -> V_7 -> V_33 ;
V_14 -> V_25 . V_121 = V_14 -> V_7 -> V_19 ;
V_14 -> V_28 = F_61 ( & V_14 -> V_25 , V_14 -> V_37 , V_14 ) ;
if ( F_49 ( V_14 -> V_28 ) ) {
F_40 ( V_14 -> V_37 , L_23 ) ;
return F_58 ( V_14 -> V_28 ) ;
}
V_49 = F_38 ( V_14 ) ;
if ( V_49 ) {
F_62 ( V_14 -> V_28 ) ;
