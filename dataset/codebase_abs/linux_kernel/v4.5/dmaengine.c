...
V_65 -> V_71 = V_2 -> V_71 ;
V_65 -> V_72 = V_2 -> V_72 ;
V_65 -> V_73 = ! ! ( V_2 -> V_74 && V_2 -> V_75 ) ;
V_65 -> V_76 = ! ! V_2 -> V_77 ;
return 0 ;
}
static struct V_1 * F_56 ( const T_2 * V_78 ,
struct V_22 * V_3 ,
T_5 V_79 , void * V_80 )
{
struct V_1 * V_6 ;
if ( V_78 && ! F_15 ( V_3 , V_78 ) ) {
F_57 ( L_5 , V_46 ) ;
return NULL ;
}
if ( V_3 -> V_81 > 1 && ! F_23 ( V_36 , V_3 -> V_26 ) )
...
T_5 V_79 , void * V_80 )
{
struct V_1 * V_6 = F_56 ( V_78 , V_2 , V_79 , V_80 ) ;
int V_12 ;
if ( V_6 ) {
F_60 ( V_36 , V_2 -> V_26 ) ;
V_2 -> V_82 ++ ;
...
F_60 ( V_53 , V_78 ) ;
F_5 ( & V_13 ) ;
V_6 = F_59 ( V_2 , & V_78 , NULL , NULL ) ;
F_8 ( & V_13 ) ;
return F_67 ( V_6 ) ? NULL : V_6 ;
}
struct V_1 * F_68 ( const T_2 * V_78 ,
T_5 V_79 , void * V_80 )
{
struct V_22 * V_2 , * V_86 ;
struct V_1 * V_6 = NULL ;
F_5 ( & V_13 ) ;
F_69 (device, _d, &dma_device_list, global_node) {
V_6 = F_59 ( V_2 , V_78 , V_79 , V_80 ) ;
if ( ! F_67 ( V_6 ) )
break;
V_6 = NULL ;
}
...
static const struct V_87 * F_70 ( struct V_22 * V_2 ,
const char * V_88 ,
struct V_2 * V_3 )
{
int V_11 ;
if ( ! V_2 -> V_89 . V_90 )
return NULL ;
for ( V_11 = 0 ; V_11 < V_2 -> V_89 . V_90 ; V_11 ++ ) {
const struct V_87 * V_91 = & V_2 -> V_89 . V_91 [ V_11 ] ;
if ( ! strcmp ( V_91 -> V_92 , F_71 ( V_3 ) ) &&
! strcmp ( V_91 -> V_93 , V_88 ) )
return V_91 ;
}
return NULL ;
}
struct V_1 * F_72 ( struct V_2 * V_3 , const char * V_88 )
{
struct V_22 * V_94 , * V_86 ;
struct V_1 * V_6 = NULL ;
if ( V_3 -> V_95 )
V_6 = F_73 ( V_3 -> V_95 , V_88 ) ;
if ( F_74 ( V_3 ) && ! V_6 )
V_6 = F_75 ( V_3 , V_88 ) ;
if ( V_6 ) {
if ( ! F_67 ( V_6 ) || F_76 ( V_6 ) == - V_84 )
return V_6 ;
}
F_5 ( & V_13 ) ;
F_69 (d, _d, &dma_device_list, global_node) {
T_2 V_78 ;
const struct V_87 * V_91 = F_70 ( V_94 , V_88 , V_3 ) ;
if ( ! V_91 )
continue;
F_66 ( V_78 ) ;
F_60 ( V_53 , V_78 ) ;
V_6 = F_59 ( V_94 , & V_78 , V_94 -> V_89 . V_79 , V_91 -> V_96 ) ;
if ( ! F_67 ( V_6 ) )
break;
}
F_8 ( & V_13 ) ;
...
const char * V_88 )
{
struct V_1 * V_97 = F_72 ( V_3 , V_88 ) ;
if ( F_67 ( V_97 ) )
return NULL ;
return V_97 ;
}
struct V_1 * F_78 ( const T_2 * V_78 )
{
struct V_1 * V_6 ;
if ( ! V_78 )
return F_63 ( - V_16 ) ;
V_6 = F_68 ( V_78 , NULL , NULL ) ;
if ( ! V_6 )
V_6 = F_63 ( - V_16 ) ;
return V_6 ;
}
...
return false ;
#endif
#if F_86 ( V_98 ) || F_86 ( V_99 )
if ( ! F_23 ( V_100 , V_2 -> V_26 ) )
return false ;
#endif
#if F_86 ( V_101 ) || F_86 ( V_102 )
...
int V_109 ;
F_5 ( & V_13 ) ;
V_109 = F_90 ( & V_20 , NULL , 0 , 0 , V_110 ) ;
if ( V_109 >= 0 )
V_2 -> V_21 = V_109 ;
F_8 ( & V_13 ) ;
return V_109 < 0 ? V_109 : 0 ;
}
...
if ( ! V_2 )
return - V_16 ;
F_83 ( F_23 ( V_100 , V_2 -> V_26 ) &&
! V_2 -> V_111 ) ;
F_83 ( F_23 ( V_103 , V_2 -> V_26 ) &&
! V_2 -> V_112 ) ;
F_83 ( F_23 ( V_104 , V_2 -> V_26 ) &&
! V_2 -> V_113 ) ;
F_83 ( F_23 ( V_107 , V_2 -> V_26 ) &&
! V_2 -> V_114 ) ;
F_83 ( F_23 ( V_108 , V_2 -> V_26 ) &&
! V_2 -> V_115 ) ;
F_83 ( F_23 ( V_116 , V_2 -> V_26 ) &&
! V_2 -> V_117 ) ;
F_83 ( F_23 ( V_52 , V_2 -> V_26 ) &&
! V_2 -> V_118 ) ;
F_83 ( F_23 ( V_119 , V_2 -> V_26 ) &&
! V_2 -> V_120 ) ;
F_83 ( F_23 ( V_121 , V_2 -> V_26 ) &&
! V_2 -> V_122 ) ;
F_83 ( F_23 ( V_123 , V_2 -> V_26 ) &&
! V_2 -> V_124 ) ;
F_83 ( ! V_2 -> V_125 ) ;
F_83 ( ! V_2 -> V_58 ) ;
F_83 ( ! V_2 -> V_3 ) ;
...
if ( V_6 -> V_14 == NULL )
goto V_35;
V_6 -> V_3 = F_94 ( sizeof( * V_6 -> V_3 ) , V_110 ) ;
if ( V_6 -> V_3 == NULL ) {
F_39 ( V_6 -> V_14 ) ;
V_6 -> V_14 = NULL ;
goto V_35;
...
V_6 -> V_127 = V_81 ++ ;
V_6 -> V_3 -> V_2 . V_128 = & V_129 ;
V_6 -> V_3 -> V_2 . V_130 = V_2 -> V_3 ;
V_6 -> V_3 -> V_6 = V_6 ;
V_6 -> V_3 -> V_19 = V_19 ;
...
static struct V_132 * F_103 ( int V_133 )
{
int V_134 = F_104 ( V_133 ) ;
switch ( V_134 ) {
case 0 ... 1 :
return & V_135 [ 0 ] ;
case 2 ... 4 :
...
static void F_106 ( struct V_136 * V_136 )
{
struct V_137 * V_138 = F_2 ( V_136 , F_3 ( * V_138 ) , V_136 ) ;
struct V_2 * V_3 = V_138 -> V_3 ;
int V_139 , V_11 ;
V_139 = V_138 -> V_140 ;
for ( V_11 = 0 ; V_11 < V_139 ; V_11 ++ )
F_107 ( V_3 , V_138 -> V_141 [ V_11 ] , V_138 -> V_142 ,
V_143 ) ;
V_139 += V_138 -> V_144 ;
for (; V_11 < V_139 ; V_11 ++ )
F_107 ( V_3 , V_138 -> V_141 [ V_11 ] , V_138 -> V_142 ,
...
V_139 += V_138 -> V_146 ;
for (; V_11 < V_139 ; V_11 ++ ) {
if ( V_138 -> V_141 [ V_11 ] == 0 )
continue;
F_107 ( V_3 , V_138 -> V_141 [ V_11 ] , V_138 -> V_142 ,
V_147 ) ;
}
V_139 = V_138 -> V_148 ;
F_108 ( V_138 , F_103 ( V_139 ) -> V_149 ) ;
}
void F_109 ( struct V_137 * V_138 )
{
if ( V_138 )
F_110 ( & V_138 -> V_136 , F_106 ) ;
}
static void F_111 ( void )
{
int V_11 ;
for ( V_11 = 0 ; V_11 < F_112 ( V_135 ) ; V_11 ++ ) {
struct V_132 * V_150 = & V_135 [ V_11 ] ;
F_113 ( V_150 -> V_149 ) ;
V_150 -> V_149 = NULL ;
F_114 ( V_150 -> V_151 ) ;
V_150 -> V_151 = NULL ;
...
struct V_132 * V_150 = & V_135 [ V_11 ] ;
T_7 V_152 ;
V_152 = sizeof( struct V_137 ) +
sizeof( V_153 ) * V_150 -> V_152 ;
V_150 -> V_151 = F_116 ( V_150 -> V_88 , V_152 , 0 ,
V_154 , NULL ) ;
if ( ! V_150 -> V_151 )
break;
V_150 -> V_149 = F_117 ( 1 , V_150 -> V_151 ) ;
if ( ! V_150 -> V_149 )
break;
}
if ( V_11 == F_112 ( V_135 ) )
...
struct V_137 *
F_118 ( struct V_2 * V_3 , int V_133 , T_8 V_155 )
{
struct V_137 * V_138 ;
V_138 = F_119 ( F_103 ( V_133 ) -> V_149 , V_155 ) ;
if ( ! V_138 )
return NULL ;
...
enum V_41
F_124 ( struct V_156 * V_157 )
{
unsigned long V_44 = V_45 + F_28 ( 5000 ) ;
if ( ! V_157 )
return V_159 ;
while ( V_157 -> V_42 == - V_85 ) {
if ( F_31 ( V_45 , V_44 ) ) {
F_32 ( L_16 ,
V_46 ) ;
return V_47 ;
...
return F_27 ( V_157 -> V_6 , V_157 -> V_42 ) ;
}
void F_125 ( struct V_156 * V_157 )
{
struct V_156 * V_160 = F_126 ( V_157 ) ;
struct V_156 * V_161 ;
struct V_1 * V_6 ;
if ( ! V_160 )
return;
F_127 ( V_157 ) ;
V_6 = V_160 -> V_6 ;
for (; V_160 ; V_160 = V_161 ) {
F_128 ( V_160 ) ;
F_129 ( V_160 ) ;
V_161 = F_126 ( V_160 ) ;
if ( V_161 && V_161 -> V_6 == V_6 )
F_127 ( V_160 ) ;
else
V_161 = NULL ;
F_130 ( V_160 ) ;
