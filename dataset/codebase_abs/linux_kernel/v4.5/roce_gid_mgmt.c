...
F_32 ( V_41 ) ;
F_15 () ;
F_33 (sin_iter, sin_temp, &sin_list, list) {
...
return;
F_38 ( & V_62 -> V_68 ) ;
F_39 (ifp, &in6_dev->addr_list, if_list) {
...
F_40 ( & V_62 -> V_68 ) ;
F_41 ( V_62 ) ;
F_33 (sin6_iter, sin6_temp, &sin6_list, list) {
union V_12 V_13 ;
...
static void F_42 ( struct V_1 * V_2 , T_1 V_3 ,
struct V_21 * V_35 )
{
F_25 ( V_2 , V_3 , V_35 ) ;
if ( F_43 ( V_72 ) )
...
static void F_45 ( struct V_1 * V_2 , T_1 V_3 ,
struct V_21 * V_28 , void * V_29 )
{
struct V_21 * V_30 = (struct V_21 * ) V_29 ;
F_46 ( V_2 , V_3 , V_30 ) ;
...
static void F_54 ( struct V_1 * V_74 ,
T_1 V_3 ,
struct V_21 * V_28 ,
void * V_29 )
{
...
F_26 ( V_77 ) ;
F_12 () ;
F_57 (ndev, upper, iter) {
struct V_77 * V_51 = F_58 ( sizeof( * V_51 ) ,
V_52 ) ;
if ( ! V_51 ) {
F_59 ( L_3 ) ;
continue;
...
F_15 () ;
F_56 ( V_2 , V_3 , V_35 ) ;
F_33 (upper_iter, upper_temp, &upper_list,
list) {
F_56 ( V_2 , V_3 , V_79 -> V_23 ) ;
F_61 ( V_79 -> V_23 ) ;
F_34 ( & V_79 -> V_44 ) ;
F_35 ( V_79 ) ;
}
...
struct V_21 * V_28 , void * V_29 )
{
F_55 ( V_2 , V_3 , V_29 , F_62 ) ;
}
static void F_64 ( struct V_1 * V_2 , T_1 V_3 ,
struct V_21 * V_28 , void * V_29 )
{
F_55 ( V_2 , V_3 , V_29 , F_42 ) ;
}
...
static void F_66 ( struct V_1 * V_2 , T_1 V_3 ,
struct V_21 * V_28 , void * V_29 )
{
struct V_21 * V_30 = (struct V_21 * ) V_29 ;
...
{
struct V_84 * V_85 =
F_68 ( V_83 , struct V_84 , V_85 ) ;
unsigned int V_4 ;
for ( V_4 = 0 ; V_4 < F_69 ( V_85 -> V_86 ) && V_85 -> V_86 [ V_4 ] . V_87 ; V_4 ++ ) {
F_70 ( V_85 -> V_86 [ V_4 ] . V_88 ,
V_85 -> V_86 [ V_4 ] . V_89 ,
V_85 -> V_86 [ V_4 ] . V_87 ,
V_85 -> V_86 [ V_4 ] . V_35 ) ;
F_61 ( V_85 -> V_86 [ V_4 ] . V_35 ) ;
F_61 ( V_85 -> V_86 [ V_4 ] . V_89 ) ;
}
F_35 ( V_85 ) ;
}
static int F_71 ( struct V_90 * V_86 ,
struct V_21 * V_35 )
{
unsigned int V_4 ;
struct V_84 * V_91 =
F_58 ( sizeof( * V_91 ) , V_92 ) ;
if ( ! V_91 ) {
F_30 ( L_4 ) ;
return V_93 ;
}
memcpy ( V_91 -> V_86 , V_86 , sizeof( V_91 -> V_86 ) ) ;
for ( V_4 = 0 ; V_4 < F_69 ( V_91 -> V_86 ) && V_91 -> V_86 [ V_4 ] . V_87 ; V_4 ++ ) {
if ( ! V_91 -> V_86 [ V_4 ] . V_35 )
V_91 -> V_86 [ V_4 ] . V_35 = V_35 ;
if ( ! V_91 -> V_86 [ V_4 ] . V_89 )
V_91 -> V_86 [ V_4 ] . V_89 = V_35 ;
F_60 ( V_91 -> V_86 [ V_4 ] . V_35 ) ;
F_60 ( V_91 -> V_86 [ V_4 ] . V_89 ) ;
}
F_72 ( & V_91 -> V_85 , F_67 ) ;
F_73 ( V_94 , & V_91 -> V_85 ) ;
return V_93 ;
...
static int F_75 ( struct V_103 * V_104 , unsigned long V_105 ,
void * V_106 )
{
...
return F_71 ( V_86 , V_35 ) ;
}
static void F_77 ( struct V_82 * V_83 )
{
struct V_75 * V_85 =
F_68 ( V_83 , struct V_75 , V_85 ) ;
F_70 ( F_11 , V_85 -> V_15 . V_35 ,
F_54 , V_85 ) ;
F_61 ( V_85 -> V_15 . V_35 ) ;
F_35 ( V_85 ) ;
}
...
return F_78 ( V_104 , V_105 , (struct V_36 * ) & V_123 , V_35 ) ;
}
static int F_80 ( struct V_103 * V_104 , unsigned long V_105 ,
void * V_106 )
{
struct V_64 V_126 ;
struct V_21 * V_35 ;
...
return F_78 ( V_104 , V_105 , (struct V_36 * ) & V_126 , V_35 ) ;
}
int T_2 F_81 ( void )
{
F_82 ( & V_129 ) ;
