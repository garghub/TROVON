...
struct V_87 * V_88 = F_22 ( V_84 ) ;
struct V_90 * V_91 = F_8 ( V_88 ) ;
unsigned int V_115 = V_109 -> V_111 . integer . V_111 [ 0 ] ;
int V_110 = 0 ;
if ( V_115 > 1 )
return - V_120 ;
F_24 ( & V_91 -> V_121 ) ;
...
V_91 -> V_236 . V_253 = V_91 -> V_2 ;
if ( V_250 -> V_254 )
V_91 -> V_236 . V_255 = V_250 -> V_254 ;
else
V_91 -> V_236 . V_255 = - 1 ;
...
static int F_57 ( struct V_256 * V_257 ,
struct V_249 * V_250 )
{
struct V_258 * V_258 = F_58 ( V_257 -> V_222 ) ;
if ( ! V_258 ) {
F_37 ( & V_257 -> V_2 , L_23 ,
V_257 -> V_222 ) ;
return - V_120 ;
...
static int F_60 ( struct V_256 * V_257 ,
struct V_249 * V_250 )
{
const struct V_263 * V_264 = V_257 -> V_2 . V_265 ;
T_3 V_266 ;
int V_100 ;
if ( F_61 ( V_264 , L_24 , & V_266 ) >= 0 )
V_250 -> V_267 = V_266 ;
if ( F_61 ( V_264 , L_25 , & V_266 ) >= 0 )
V_250 -> V_268 = V_266 ;
if ( F_62 ( V_264 , L_26 , V_250 -> V_269 ,
F_12 ( V_250 -> V_269 ) ) >= 0 ) {
for ( V_100 = 0 ; V_100 < F_12 ( V_250 -> V_269 ) ; V_100 ++ ) {
if ( V_250 -> V_269 [ V_100 ] == 0 ) {
V_250 -> V_269 [ V_100 ] = V_270 ;
} else if ( V_250 -> V_269 [ V_100 ] == 0xffffffff ) {
V_250 -> V_269 [ V_100 ] = 0 ;
} else if ( V_250 -> V_269 [ V_100 ] > 0x7fff ) {
F_37 ( & V_257 -> V_2 , L_27 ,
V_100 , V_250 -> V_269 [ V_100 ] ) ;
return - V_120 ;
}
}
}
...
static int F_63 ( struct V_256 * V_257 ,
const struct V_271 * V_272 )
{
struct V_249 * V_250 = F_64 ( & V_257 -> V_2 ) ;
struct V_90 * V_91 ;
int V_273 ;
bool V_274 = false ;
unsigned int V_101 , V_275 ;
int V_110 , V_100 ;
V_91 = F_65 ( & V_257 -> V_2 , sizeof( struct V_90 ) ,
V_276 ) ;
if ( V_91 == NULL )
return - V_277 ;
F_66 ( & V_91 -> V_121 ) ;
V_91 -> V_2 = & V_257 -> V_2 ;
V_91 -> V_228 = F_67 ( V_257 , & V_278 ) ;
if ( F_68 ( V_91 -> V_228 ) ) {
...
if ( V_257 -> V_222 ) {
V_110 = F_57 ( V_257 , V_91 -> V_250 ) ;
if ( V_110 != 0 )
return V_110 ;
}
if ( V_257 -> V_2 . V_265 ) {
V_110 = F_60 ( V_257 , V_91 -> V_250 ) ;
if ( V_110 != 0 )
return V_110 ;
}
}
...
if ( V_110 != 0 ) {
F_37 ( & V_257 -> V_2 , L_30 , V_110 ) ;
goto V_279;
}
if ( V_101 != 0x8903 ) {
F_37 ( & V_257 -> V_2 , L_31 , V_101 ) ;
V_110 = - V_280 ;
goto V_279;
}
V_110 = F_36 ( V_91 -> V_228 , V_5 , & V_101 ) ;
if ( V_110 != 0 ) {
F_37 ( & V_257 -> V_2 , L_32 , V_110 ) ;
goto V_279;
}
F_71 ( & V_257 -> V_2 , L_33 ,
( V_101 & V_281 ) + 'A' ) ;
...
F_53 ( V_91 ) ;
for ( V_100 = 0 ; V_100 < F_12 ( V_250 -> V_269 ) ; V_100 ++ ) {
if ( ( ! V_250 -> V_269 [ V_100 ] ) ||
( V_250 -> V_269 [ V_100 ] > V_270 ) )
continue;
F_72 ( V_91 -> V_228 , V_70 + V_100 ,
V_250 -> V_269 [ V_100 ] & 0x7fff ) ;
V_101 = ( V_250 -> V_269 [ V_100 ] & V_240 )
>> V_243 ;
switch ( V_101 ) {
case V_282 :
case V_283 :
...
V_220 , V_220 ) ;
F_4 ( ! V_274 && ( V_250 -> V_267 & V_221 ) ) ;
V_91 -> V_235 = V_250 -> V_268 ;
if ( V_257 -> V_222 ) {
if ( V_250 -> V_261 ) {
V_273 = V_284 ;
V_275 = V_285 ;
...
V_285 , V_275 ) ;
V_110 = F_73 ( V_257 -> V_222 , NULL , F_35 ,
V_273 | V_287 ,
L_34 , V_91 ) ;
if ( V_110 != 0 ) {
F_37 ( V_91 -> V_2 , L_35 ,
...
static int F_75 ( struct V_256 * V_297 )
{
struct V_90 * V_91 = F_76 ( V_297 ) ;
if ( V_297 -> V_222 )
F_77 ( V_297 -> V_222 , V_91 ) ;
F_55 ( V_91 ) ;
F_78 ( & V_297 -> V_2 ) ;
return 0 ;
}
