...
V_2 -> V_213 = & V_214 ;
F_180 ( V_2 ) ;
F_181 ( V_2 , & V_4 -> V_215 , V_216 , V_217 ) ;
V_2 -> V_218 = V_219 ;
V_2 -> V_6 |= V_220 | V_221 ;
V_2 -> V_222 = V_223 ;
V_2 -> V_224 = V_156 ;
...
F_106 ( & V_4 -> V_231 ) ;
F_106 ( & V_4 -> V_232 ) ;
F_185 ( & V_4 -> V_233 , V_234 ) ;
F_186 ( & V_4 -> V_235 , V_236 ) ;
F_186 ( & V_4 -> V_237 , V_238 ) ;
F_186 ( & V_4 -> V_239 , V_240 ) ;
F_186 ( & V_4 -> V_241 , V_242 ) ;
F_186 ( & V_4 -> V_159 , V_243 ) ;
F_185 ( & V_4 -> V_244 , V_245 ) ;
F_185 ( & V_4 -> V_188 , F_151 ) ;
}
struct V_3 * F_187 ( const char * V_204 )
{
struct V_1 * V_2 ;
V_2 = F_188 ( ( int ) sizeof( struct V_3 ) , V_204 ,
V_246 , F_179 ) ;
if ( ! V_2 )
return NULL ;
return F_2 ( V_2 ) ;
}
static T_7 F_189 ( struct V_247 * V_2 ,
struct V_248 * V_249 , char * V_63 )
{
struct V_3 * V_4 = F_2 ( F_190 ( V_2 ) ) ;
return sprintf ( V_63 , L_27 , V_4 -> V_60 ) ;
}
static T_7 F_191 ( struct V_247 * V_2 ,
struct V_248 * V_249 , char * V_63 )
{
struct V_3 * V_4 = F_2 ( F_190 ( V_2 ) ) ;
return sprintf ( V_63 , L_28 , F_7 ( V_250 , & V_4 -> V_6 ) ) ;
}
void F_192 ( struct V_1 * V_251 , int V_252 )
{
struct V_3 * V_4 = F_2 ( V_251 ) ;
if ( V_252 > 0 ) {
F_5 ( V_250 , & V_4 -> V_6 ) ;
F_25 ( V_4 , L_29
L_30 ) ;
...
static T_7 F_193 ( struct V_247 * V_2 ,
struct V_248 * V_249 ,
const char * V_63 , T_8 V_253 )
{
unsigned long V_252 = F_194 ( V_63 , NULL , 0 ) ;
F_192 ( F_190 ( V_2 ) , V_252 ) ;
return V_253 ;
}
int F_195 ( struct V_1 * V_2 )
{
return F_196 ( & V_2 -> V_2 , & V_254 ) ;
}
static T_7 F_197 ( struct V_247 * V_2 ,
struct V_248 * V_249 ,
const char * V_63 , T_8 V_253 )
{
int V_60 ;
...
return - V_14 ;
V_60 |= 0x8000 ;
V_62 = F_198 ( F_190 ( V_2 ) , V_60 ) ;
return V_62 ? V_62 : V_253 ;
}
static T_7 F_199 ( struct V_247 * V_2 ,
struct V_248 * V_249 ,
const char * V_63 , T_8 V_253 )
{
int V_60 ;
...
return - V_14 ;
V_62 = F_200 ( F_190 ( V_2 ) , V_60 ) ;
return V_62 ? V_62 : V_253 ;
}
int F_201 ( struct V_1 * V_2 )
{
return F_196 ( & V_2 -> V_2 , & V_255 ) ;
}
int F_202 ( struct V_3 * V_4 , struct V_59 * V_256 )
{
V_4 -> V_257 = V_256 -> V_258 . V_259 ;
if ( V_4 -> V_257 & V_260 ) {
V_4 -> V_2 -> V_261 = V_262 |
V_17 | V_263 ;
if ( V_4 -> V_257 & V_264 )
V_4 -> V_2 -> V_261 |= V_18 ;
V_4 -> V_2 -> V_15 |= V_4 -> V_2 -> V_261 ;
}
return 0 ;
}
static struct V_1 * F_203 ( const char * V_265 ,
struct V_59 * V_256 , T_4 V_58 )
{
struct V_3 * V_4 ;
struct V_266 V_249 ;
int V_44 = - V_194 ;
...
if ( ! V_4 )
goto V_267;
F_204 ( V_4 -> V_2 , V_256 -> V_268 ) ;
V_4 -> V_2 -> V_269 = V_58 - 1 ;
V_44 = F_205 ( V_256 , V_58 , & V_249 ) ;
if ( ! V_44 )
V_4 -> V_22 = F_206 ( V_249 . V_270 ) ;
else {
F_170 ( V_203 L_32 ,
V_256 -> V_204 , V_58 ) ;
goto V_271;
...
V_4 -> V_2 -> V_272 = sizeof( struct V_103 ) ;
V_44 = F_207 ( V_256 , V_58 , 0 , & V_4 -> V_60 ) ;
if ( V_44 ) {
F_170 ( V_203 L_33 ,
V_256 -> V_204 , V_58 , V_44 ) ;
goto V_271;
}
V_44 = F_202 ( V_4 , V_256 ) ;
if ( V_44 )
goto V_271;
V_4 -> V_60 |= 0x8000 ;
V_4 -> V_2 -> V_115 [ 8 ] = V_4 -> V_60 >> 8 ;
V_4 -> V_2 -> V_115 [ 9 ] = V_4 -> V_60 & 0xff ;
V_44 = F_208 ( V_256 , V_58 , 0 , & V_4 -> V_56 , NULL ) ;
if ( V_44 ) {
F_170 ( V_203 L_34 ,
V_256 -> V_204 , V_58 , V_44 ) ;
goto V_271;
...
if ( F_195 ( V_4 -> V_2 ) )
goto V_277;
if ( F_196 ( & V_4 -> V_2 -> V_2 , & V_278 ) )
goto V_277;
if ( F_196 ( & V_4 -> V_2 -> V_2 , & V_279 ) )
goto V_277;
return V_4 -> V_2 ;
V_277:
F_176 ( V_4 -> V_2 ) ;
...
static void F_219 ( struct V_59 * V_247 )
{
struct V_45 * V_57 ;
struct V_1 * V_2 ;
struct V_3 * V_4 ;
...
return;
F_106 ( V_57 ) ;
for ( V_281 = F_220 ( V_247 ) ; V_281 <= F_221 ( V_247 ) ; ++ V_281 ) {
if ( ! F_47 ( V_247 , V_281 ) )
continue;
V_2 = F_203 ( L_39 , V_247 , V_281 ) ;
if ( ! F_222 ( V_2 ) ) {
V_4 = F_2 ( V_2 ) ;
F_62 ( & V_4 -> V_82 , V_57 ) ;
V_253 ++ ;
...
F_223 ( V_247 , & V_282 , V_57 ) ;
}
static void F_224 ( struct V_59 * V_247 , void * V_61 )
{
struct V_3 * V_4 , * V_283 ;
struct V_45 * V_57 = V_61 ;
if ( ! V_57 )
return;
...
static int T_9 F_225 ( void )
{
int V_62 ;
V_202 = F_161 ( V_202 ) ;
V_202 = F_27 ( V_202 , V_284 ) ;
V_202 = F_226 ( V_202 , V_285 ) ;
V_206 = F_161 ( V_206 ) ;
V_206 = F_27 ( V_206 , V_284 ) ;
V_206 = F_227 ( V_206 , 2 * V_286 , V_285 ) ;
#ifdef F_228
V_287 = F_27 ( V_287 , V_288 ) ;
#endif
F_229 ( V_289 > V_290 ) ;
V_62 = F_230 () ;
if ( V_62 )
