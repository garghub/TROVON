...
if ( ! V_2 -> V_90 ||
( ! F_35 ( V_2 , V_31 -> V_86 , V_77 ) &&
( F_14 ( V_31 -> V_76 ) != V_91 ) ) ) {
V_75 = F_27 ( V_2 , V_9 ) ;
return V_75 ;
}
V_78 = ( V_49 ) F_14 ( V_31 -> V_76 ) ;
V_75 = F_36 ( V_2 , F_14 ( V_31 -> V_89 ) ,
V_31 -> V_86 , V_77 , V_78 ,
V_9 ) ;
if ( V_75 || ( V_76 == V_85 ) )
F_28 ( V_9 ) ;
...
V_94 = ( ( void * ) V_9 -> V_40 - ( sizeof( * V_93 ) + V_96 ) - NULL ) &
( V_101 - 1 ) ;
F_40 ( V_9 , sizeof( * V_93 ) + V_94 ) ;
V_93 = (struct V_92 * ) V_9 -> V_40 ;
memset ( V_93 , 0 , sizeof( * V_93 ) ) ;
V_93 -> V_57 = V_2 -> V_57 ;
V_93 -> V_58 = V_2 -> V_58 ;
V_93 -> V_102 = F_41 ( ( T_1 ) ( V_9 -> V_62 - ( sizeof( * V_93 ) +
V_94 ) ) ) ;
V_93 -> V_86 = ( V_49 ) V_9 -> V_86 ;
V_93 -> V_103 = F_42 ( V_2 , V_9 ) ;
if ( V_13 -> V_17 & V_104 ||
V_13 -> V_17 & V_105 ) {
V_93 -> V_106 = V_13 -> V_107 ;
V_93 -> V_17 |= V_108 ;
}
if ( V_93 -> V_86 < F_43 ( V_2 -> V_20 . V_109 ) )
V_93 -> V_110 =
F_44 ( V_2 -> V_20 . V_109 [ V_93 -> V_86 ] ) ;
V_95 = sizeof( * V_93 ) + V_94 ;
if ( V_78 == V_83 ) {
V_93 -> V_111 = F_41 ( V_78 ) ;
V_95 += V_112 ;
}
V_93 -> V_113 = F_41 ( V_95 ) ;
F_40 ( V_9 , V_96 ) ;
if ( ! V_93 -> V_110 )
V_93 -> V_110 = F_44 ( V_2 -> V_114 ) ;
return V_9 -> V_40 ;
}
