...
if ( F_47 ( & V_2 -> V_200 , & V_2 -> V_201 ) )
return;
if ( V_199 & V_105 ) {
struct V_202 * V_203 =
F_48 ( & V_2 -> V_204 . V_171 ) ;
T_3 V_74 ;
T_3 V_205 ;
...
V_205 = V_74 - V_62 -> V_74 ;
if ( V_74 < V_62 -> V_74 )
V_205 -- ;
V_62 -> V_74 = V_74 ;
F_50 ( V_205 , & V_203 -> V_207 ) ;
}
}
if ( ! ( V_199 & V_104 ) )
return;
...
{
struct V_202 * V_203 = F_48 ( & V_2 -> V_204 . V_171 ) ;
T_2 V_208 , V_209 ;
struct V_182 * V_7 = V_2 -> V_7 ;
if ( ! V_2 -> V_146 )
return;
V_208 = F_12 ( V_2 -> V_7 , V_2 -> V_8 , V_143 ) ;
F_4 ( V_2 -> V_7 , V_2 -> V_8 , V_143 , V_208 ) ;
if ( V_208 & V_140 ) {
V_209 = F_12 ( V_2 -> V_7 , V_2 -> V_8 ,
V_134 ) ;
...
{
if ( V_217 == V_218 )
return F_56 ( & V_2 -> V_204 , V_215 , V_169 ) ;
...
struct V_202 * V_203 = F_48 ( & V_2 -> V_204 . V_171 ) ;
int V_246 ;
V_203 -> V_247 = F_31 ( V_243 -> V_248 -> V_171 ) ;
V_246 = F_67 ( V_203 , V_243 ) ;
if ( V_246 < 0 )
return V_246 ;
...
unsigned int V_233 = V_260 -> V_233 ;
if ( F_79 ( V_261 -> V_171 ) )
V_233 |= 2 << 16 ;
switch ( V_233 ) {
case V_178 :
...
{
int V_252 ;
V_252 = F_84 ( V_265 , & V_2 -> V_204 ) ;
if ( V_252 < 0 )
goto error;
V_252 = F_85 ( & V_2 -> V_179 , V_265 ) ;
if ( V_252 < 0 )
goto error;
return 0 ;
error:
...
static int F_86 ( struct V_1 * V_2 , const char * V_266 )
{
struct V_166 * V_231 = & V_2 -> V_204 ;
struct V_168 * V_170 = V_2 -> V_170 ;
struct V_259 * V_267 = & V_231 -> V_171 ;
int V_252 ;
char V_268 [ V_269 ] ;
F_87 ( V_231 , & V_270 ) ;
V_231 -> V_271 = & V_272 ;
snprintf ( V_268 , sizeof( V_268 ) , L_9 , V_266 ) ;
snprintf ( V_231 -> V_268 , sizeof( V_231 -> V_268 ) , L_10 , V_268 ) ;
V_231 -> V_273 = 1 << 16 ;
F_88 ( V_231 , V_2 ) ;
V_231 -> V_262 |= V_274 ;
V_170 [ V_178 ] . V_262 = V_275 ;
V_170 [ V_34 ] . V_262 = V_276 ;
V_267 -> V_277 = & V_278 ;
V_252 = F_89 ( V_267 , V_279 , V_170 ) ;
if ( V_252 < 0 )
return V_252 ;
F_69 ( V_231 , NULL ) ;
V_2 -> V_179 . type = V_280 ;
V_2 -> V_179 . V_277 = & V_281 ;
V_2 -> V_179 . V_282 = 32 ;
V_2 -> V_179 . V_283 = 1 ;
V_2 -> V_179 . V_284 = 0x1ffe0 ;
V_2 -> V_179 . V_7 = V_2 -> V_7 ;
V_2 -> V_179 . V_285 = F_90 ( 4096 * 4096 ) * 3 ;
V_252 = F_91 ( & V_2 -> V_179 , V_268 ) ;
if ( V_252 < 0 )
goto V_286;
return 0 ;
V_286:
F_92 ( & V_2 -> V_204 . V_171 ) ;
return V_252 ;
}
int F_93 ( struct V_182 * V_7 )
{
...
V_287 -> V_146 = 1 ;
V_287 -> V_8 = V_289 ;
V_287 -> V_148 = & V_7 -> V_290 ;
V_287 -> V_255 = V_291 ;
V_287 -> V_253 = V_254 ;
F_94 ( & V_287 -> V_200 ) ;
V_252 = F_86 ( V_287 , L_11 ) ;
if ( V_252 < 0 )
return V_252 ;
V_288 -> V_7 = V_7 ;
V_288 -> V_146 = 1 ;
V_288 -> V_8 = V_292 ;
V_288 -> V_148 = & V_7 -> V_293 ;
V_288 -> V_255 = V_294 ;
V_288 -> V_253 = V_254 ;
F_94 ( & V_288 -> V_200 ) ;
V_252 = F_86 ( V_288 , L_12 ) ;
if ( V_252 < 0 )
return V_252 ;
return 0 ;
}
...
struct V_1 * V_288 = & V_7 -> V_288 ;
int V_252 ;
V_252 = F_96 ( & V_287 -> V_204 . V_171 , V_178 ,
& V_287 -> V_179 . V_211 . V_171 , 0 , 0 ) ;
if ( V_252 < 0 )
return V_252 ;
V_252 = F_96 ( & V_288 -> V_204 . V_171 , V_178 ,
& V_288 -> V_179 . V_211 . V_171 , 0 , 0 ) ;
if ( V_252 < 0 )
return V_252 ;
return 0 ;
}
...
struct V_1 * V_288 = & V_7 -> V_288 ;
F_98 ( & V_287 -> V_179 ) ;
F_92 ( & V_287 -> V_204 . V_171 ) ;
F_98 ( & V_288 -> V_179 ) ;
F_92 ( & V_288 -> V_204 . V_171 ) ;
}
