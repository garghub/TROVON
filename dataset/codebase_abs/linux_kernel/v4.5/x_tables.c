...
static int F_56 ( struct V_89 * V_9 )
{
unsigned int V_28 ;
int V_99 ;
...
V_9 -> V_100 = F_58 ( V_28 , V_96 ) ;
if ( V_9 -> V_100 == NULL )
return - V_59 ;
if ( V_9 -> V_105 == 0 )
return 0 ;
V_28 = sizeof( void * ) * V_9 -> V_105 * 2u ;
F_50 (cpu) {
if ( V_28 > V_94 )
V_9 -> V_100 [ V_99 ] = F_59 ( V_28 ,
F_60 ( V_99 ) ) ;
else
V_9 -> V_100 [ V_99 ] = F_61 ( V_28 ,
V_96 , F_60 ( V_99 ) ) ;
...
struct V_101 * F_71 ( struct V_102 * V_102 ,
...
V_45 = F_72 ( V_117 , sizeof( struct V_101 ) , V_96 ) ;
if ( ! V_45 ) {
V_42 = - V_59 ;
goto V_119;
}
...
V_45 -> V_108 = V_118 ;
if ( ! F_62 ( V_45 , 0 , V_107 , & V_42 ) )
goto V_121;
V_108 = V_45 -> V_108 ;
F_64 ( L_24 , V_108 -> V_57 ) ;
...
static void * F_75 ( struct V_123 * V_124 , T_7 * V_125 )
{
struct V_126 * V_127 = V_124 -> V_108 ;
struct V_102 * V_102 = F_76 ( V_124 ) ;
T_1 V_3 = V_127 -> V_3 ;
F_2 ( & V_5 [ V_3 ] . V_6 ) ;
return F_77 ( & V_102 -> V_5 . V_122 [ V_3 ] , * V_125 ) ;
}
static void * F_78 ( struct V_123 * V_124 , void * V_128 , T_7 * V_125 )
{
struct V_126 * V_127 = V_124 -> V_108 ;
struct V_102 * V_102 = F_76 ( V_124 ) ;
T_1 V_3 = V_127 -> V_3 ;
return F_79 ( V_128 , & V_102 -> V_5 . V_122 [ V_3 ] , V_125 ) ;
}
static void F_80 ( struct V_123 * V_124 , void * V_128 )
{
struct V_126 * V_127 = V_124 -> V_108 ;
T_1 V_3 = V_127 -> V_3 ;
F_4 ( & V_5 [ V_3 ] . V_6 ) ;
}
static int F_81 ( struct V_123 * V_124 , void * V_128 )
{
struct V_101 * V_45 = F_82 ( V_128 , struct V_101 , V_7 ) ;
if ( * V_45 -> V_13 )
F_83 ( V_124 , L_25 , V_45 -> V_13 ) ;
return 0 ;
}
static int F_84 ( struct V_129 * V_129 , struct V_130 * V_130 )
{
int V_42 ;
struct V_126 * V_127 ;
V_42 = F_85 ( V_129 , V_130 , & V_131 ,
sizeof( struct V_126 ) ) ;
if ( ! V_42 ) {
V_127 = ( (struct V_123 * ) V_130 -> V_132 ) -> V_108 ;
V_127 -> V_3 = ( unsigned long ) F_86 ( V_129 ) ;
}
return V_42 ;
}
static void * F_87 ( struct V_123 * V_124 , void * V_128 , T_7 * V_133 ,
bool V_134 )
{
...
static void * F_88 ( struct V_123 * V_124 , T_7 * V_125 ,
bool V_134 )
{
struct V_139 * V_140 = V_124 -> V_108 ;
unsigned int V_146 ;
...
if ( F_87 ( V_124 , NULL , NULL , V_134 ) == NULL )
return NULL ;
return V_140 ;
}
static void F_89 ( struct V_123 * V_124 , void * V_128 )
{
struct V_139 * V_140 = V_124 -> V_108 ;
switch ( V_140 -> V_141 ) {
case V_136 :
...
static void * F_90 ( struct V_123 * V_124 , T_7 * V_125 )
{
return F_88 ( V_124 , V_125 , false ) ;
}
static void * F_91 ( struct V_123 * V_124 , void * V_128 , T_7 * V_133 )
{
return F_87 ( V_124 , V_128 , V_133 , false ) ;
}
static int F_92 ( struct V_123 * V_124 , void * V_128 )
{
...
if ( V_140 -> V_144 == V_140 -> V_143 )
return 0 ;
V_12 = F_82 ( V_140 -> V_144 , struct V_11 , V_7 ) ;
if ( * V_12 -> V_13 )
F_83 ( V_124 , L_25 , V_12 -> V_13 ) ;
}
return 0 ;
}
static int F_93 ( struct V_129 * V_129 , struct V_130 * V_130 )
{
struct V_139 * V_140 ;
V_140 = F_94 ( V_130 , & V_147 , sizeof( * V_140 ) ) ;
if ( ! V_140 )
return - V_59 ;
V_140 -> V_20 = ( unsigned long ) F_86 ( V_129 ) ;
return 0 ;
}
static void * F_95 ( struct V_123 * V_124 , T_7 * V_125 )
{
return F_88 ( V_124 , V_125 , true ) ;
}
static void * F_96 ( struct V_123 * V_124 , void * V_128 , T_7 * V_133 )
{
return F_87 ( V_124 , V_128 , V_133 , true ) ;
}
static int F_97 ( struct V_123 * V_124 , void * V_128 )
{
const struct V_139 * V_140 = V_124 -> V_108 ;
...
if ( V_140 -> V_144 == V_140 -> V_143 )
return 0 ;
V_2 = F_82 ( V_140 -> V_144 , struct V_1 , V_7 ) ;
if ( * V_2 -> V_13 )
F_83 ( V_124 , L_25 , V_2 -> V_13 ) ;
}
return 0 ;
}
static int F_98 ( struct V_129 * V_129 , struct V_130 * V_130 )
{
struct V_139 * V_140 ;
V_140 = F_94 ( V_130 , & V_148 , sizeof( * V_140 ) ) ;
if ( ! V_140 )
return - V_59 ;
V_140 -> V_20 = ( unsigned long ) F_86 ( V_129 ) ;
return 0 ;
}
struct V_149 * F_99 ( const struct V_101 * V_45 , T_8 * V_150 )
{
unsigned int V_47 = V_45 -> V_151 ;
T_3 V_9 , V_152 = F_100 ( V_47 ) ;
T_3 V_153 ;
struct V_149 * V_154 ;
int V_42 ;
V_154 = F_48 ( sizeof( * V_154 ) * V_152 , V_96 ) ;
if ( V_154 == NULL )
return F_16 ( - V_59 ) ;
...
V_154 [ V_9 ] . V_156 = V_45 -> V_3 ;
V_154 [ V_9 ] . V_153 = V_153 ;
V_154 [ V_9 ] . V_157 = V_45 -> V_157 ;
++ V_9 ;
}
V_42 = F_101 ( V_154 , V_152 ) ;
if ( V_42 < 0 ) {
F_73 ( V_154 ) ;
return F_16 ( V_42 ) ;
}
...
void F_102 ( const struct V_101 * V_45 , struct V_149 * V_154 )
{
F_103 ( V_154 , F_100 ( V_45 -> V_151 ) ) ;
F_73 ( V_154 ) ;
}
int F_104 ( struct V_102 * V_102 , T_1 V_3 )
{
#ifdef F_105
char V_27 [ V_158 ] ;
struct V_159 * V_160 ;
...
return - V_44 ;
#ifdef F_105
V_161 = F_106 ( V_102 -> V_163 , 0 ) ;
V_162 = F_107 ( V_102 -> V_163 , 0 ) ;
F_108 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_109 ( V_27 , V_164 , sizeof( V_27 ) ) ;
V_160 = F_110 ( V_27 , 0440 , V_102 -> V_165 , & V_166 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_160 )
goto V_119;
if ( F_111 ( V_161 ) && F_112 ( V_162 ) )
F_113 ( V_160 , V_161 , V_162 ) ;
F_108 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_109 ( V_27 , V_167 , sizeof( V_27 ) ) ;
V_160 = F_110 ( V_27 , 0440 , V_102 -> V_165 , & V_168 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_160 )
goto V_169;
if ( F_111 ( V_161 ) && F_112 ( V_162 ) )
F_113 ( V_160 , V_161 , V_162 ) ;
F_108 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_109 ( V_27 , V_170 , sizeof( V_27 ) ) ;
V_160 = F_110 ( V_27 , 0440 , V_102 -> V_165 , & V_171 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_160 )
goto V_172;
if ( F_111 ( V_161 ) && F_112 ( V_162 ) )
...
void F_115 ( struct V_102 * V_102 , T_1 V_3 )
{
#ifdef F_105
char V_27 [ V_158 ] ;
F_108 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
...
static int T_11 F_116 ( struct V_102 * V_102 )
{
int V_9 ;
for ( V_9 = 0 ; V_9 < V_173 ; V_9 ++ )
F_117 ( & V_102 -> V_5 . V_122 [ V_9 ] ) ;
return 0 ;
}
static int T_12 F_118 ( void )
{
unsigned int V_9 ;
int V_174 ;
F_50 (i) {
F_119 ( & F_120 ( V_175 , V_9 ) ) ;
}
V_5 = F_48 ( sizeof( struct V_54 ) * V_173 , V_96 ) ;
if ( ! V_5 )
return - V_59 ;
for ( V_9 = 0 ; V_9 < V_173 ; V_9 ++ ) {
F_121 ( & V_5 [ V_9 ] . V_6 ) ;
