...
V_167 -> V_87 = & V_176 ;
V_167 -> V_177 = & V_178 ;
V_167 -> V_179 = sizeof( struct V_64 ) ;
V_167 -> V_180 = V_181 ;
V_43 = F_103 ( V_167 ) ;
if ( V_43 ) {
F_99 ( V_6 -> V_70 ) ;
...
{
struct V_5 * V_6 = F_59 ( V_106 ) ;
struct V_183 * V_50 = V_106 -> V_182 ;
struct V_49 * V_166 = F_63 ( V_50 ) ;
F_88 ( V_106 , V_50 , V_6 -> type ) ;
F_98 ( & V_6 -> V_6 . V_29 , 0 , & V_166 -> V_32 ) ;
F_107 ( & V_166 -> V_88 ) ;
F_20 ( & V_166 -> V_32 ) ;
F_104 ( V_50 ) ;
F_105 ( V_166 ) ;
...
static unsigned int F_108 ( struct V_106 * V_106 , T_3 * V_184 )
{
struct V_49 * V_50 = F_63 ( V_106 -> V_182 ) ;
return F_109 ( & V_50 -> V_88 , V_106 , V_184 ) ;
}
static int F_110 ( struct V_106 * V_106 , struct V_185 * V_186 )
{
struct V_49 * V_50 = F_63 ( V_106 -> V_182 ) ;
return F_111 ( & V_50 -> V_88 , V_186 ) ;
}
...
int F_120 ( struct V_5 * V_6 , struct V_200 * V_201 )
{
int V_43 ;
V_6 -> V_6 . V_202 = V_201 ;
V_43 = F_121 ( & V_6 -> V_6 , V_195 , - 1 ) ;
if ( V_43 < 0 )
F_122 ( V_6 -> V_70 -> V_71 ,
L_7 , V_43 ) ;
return V_43 ;
