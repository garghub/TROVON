...
static int F_60 ( struct V_88 * V_64 )
{
struct V_9 * V_9 = F_61 ( V_64 ) ;
int V_53 , V_89 = F_29 ( V_9 -> V_8 . V_24 , V_55 ) ;
void T_2 * V_90 ;
for ( V_53 = 0 ; V_53 < V_89 ; V_53 ++ ) {
V_90 = V_9 -> V_1 + V_53 * sizeof( int * ) ;
if ( V_9 -> V_16 . V_31 != - 1 )
V_9 -> V_73 [ V_53 ] . V_31 =
F_4 ( V_9 -> V_16 . V_31 + V_90 ) ;
if ( V_9 -> V_16 . V_43 != - 1 )
V_9 -> V_73 [ V_53 ] . V_43 =
F_4 ( V_9 -> V_16 . V_43 + V_90 ) ;
V_9 -> V_73 [ V_53 ] . V_23 = F_4 ( V_9 -> V_16 . V_23 +
V_90 ) ;
V_9 -> V_73 [ V_53 ] . V_17 = F_4 ( V_9 -> V_16 . V_17 +
V_90 ) ;
V_9 -> V_73 [ V_53 ] . V_40 = F_4 ( V_9 -> V_16 . V_40 + V_90 ) ;
}
return 0 ;
}
static int F_62 ( struct V_88 * V_64 )
{
struct V_9 * V_9 = F_61 ( V_64 ) ;
int V_53 , V_89 = F_29 ( V_9 -> V_8 . V_24 , V_55 ) ;
void T_2 * V_90 ;
...
V_90 = V_9 -> V_1 + V_53 * sizeof( int * ) ;
if ( V_53 == V_89 - 1 ) {
V_91 = ( 1 << ( V_9 -> V_8 . V_24 - V_53 *
V_55 ) ) - 1 ;
if ( V_9 -> V_16 . V_31 != - 1 )
F_63 ( V_31 , V_90 , V_91 , V_21 ) ;
if ( V_9 -> V_16 . V_43 != - 1 )
F_63 ( V_43 , V_90 , V_91 , V_21 ) ;
F_63 ( V_23 , V_90 , V_91 , V_21 ) ;
F_63 ( V_17 , V_90 , V_91 , V_21 ) ;
F_63 ( V_40 , V_90 , V_91 , V_21 ) ;
}
...
V_9 -> V_16 . V_43 + V_90 ) ;
F_6 ( V_9 -> V_73 [ V_53 ] . V_40 , V_9 -> V_16 . V_40 + V_90 ) ;
if ( V_9 -> V_16 . V_31 != - 1 )
