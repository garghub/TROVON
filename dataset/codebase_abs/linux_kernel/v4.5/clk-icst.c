...
static void T_3 F_22 ( struct V_49 * V_50 )
{
struct V_49 * V_51 ;
struct V_28 * V_7 ;
struct V_24 V_52 ;
const char * V_26 = V_50 -> V_26 ;
const char * V_27 ;
struct V_21 * V_53 ;
V_51 = F_23 ( V_50 ) ;
if ( ! V_51 ) {
...
if ( F_25 ( V_50 , L_7 , & V_52 . V_41 ) ) {
F_7 ( L_8 ) ;
return;
}
if ( F_25 ( V_50 , L_9 , & V_52 . V_42 ) ) {
F_7 ( L_10 ) ;
return;
}
if ( F_26 ( V_50 , L_11 ) )
V_52 . V_17 = & V_54 ;
else if ( F_26 ( V_50 , L_12 ) )
V_52 . V_17 = & V_55 ;
else {
F_7 ( L_13 , V_26 ) ;
return;
...
V_27 = F_27 ( V_50 , 0 ) ;
V_53 = F_12 ( NULL , & V_52 , V_26 , V_27 , V_7 ) ;
if ( F_18 ( V_53 ) ) {
F_7 ( L_14 , V_26 ) ;
return;
}
