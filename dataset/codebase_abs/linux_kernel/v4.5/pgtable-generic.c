...
T_3 V_3 ;
F_22 ( V_6 & ~ V_17 ) ;
F_22 ( ! F_28 ( * V_16 ) && ! F_29 ( * V_16 ) ) ;
V_3 = F_30 ( V_5 -> V_11 , V_6 , V_16 ) ;
F_24 ( V_5 , V_6 , V_6 + V_18 ) ;
return V_3 ;
}
void F_31 ( struct V_13 * V_14 , T_3 * V_16 ,
T_5 V_19 )
{
F_32 ( F_33 ( V_14 , V_16 ) ) ;
if ( ! F_34 ( V_14 , V_16 ) )
...
F_36 ( & V_19 -> V_20 , & F_34 ( V_14 , V_16 ) -> V_20 ) ;
F_34 ( V_14 , V_16 ) = V_19 ;
}
T_5 F_37 ( struct V_13 * V_14 , T_3 * V_16 )
{
T_5 V_19 ;
F_32 ( F_33 ( V_14 , V_16 ) ) ;
V_19 = F_34 ( V_14 , V_16 ) ;
F_34 ( V_14 , V_16 ) = F_38 ( & V_19 -> V_20 ,
struct V_21 , V_20 ) ;
if ( F_34 ( V_14 , V_16 ) )
F_39 ( & V_19 -> V_20 ) ;
return V_19 ;
}
void F_40 ( struct V_4 * V_5 , unsigned long V_6 ,
T_3 * V_16 )
{
T_3 V_8 = * V_16 ;
F_23 ( V_5 -> V_11 , V_6 , V_16 , F_41 ( V_8 ) ) ;
F_24 ( V_5 , V_6 , V_6 + V_18 ) ;
}
T_3 F_42 ( struct V_4 * V_5 , unsigned long V_6 ,
T_3 * V_16 )
{
T_3 V_3 ;
F_22 ( V_6 & ~ V_17 ) ;
