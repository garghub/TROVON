...
void F_45 ( struct V_1 * V_2 , struct V_38 * V_31 )
{
struct V_12 * V_13 = F_46 ( V_2 ) ;
struct V_10 * V_11 , * V_39 ;
F_47 (p, n, &br->port_list, list) {
F_31 ( V_11 ) ;
}
F_36 ( V_13 , NULL , 0 , 1 ) ;
F_48 ( V_13 ) ;
...
struct V_10 * V_11 ;
unsigned long * V_42 ;
V_42 = F_54 ( F_55 ( V_43 ) , sizeof( unsigned long ) ,
V_44 ) ;
if ( ! V_42 )
return - V_45 ;
F_56 ( 0 , V_42 ) ;
...
static struct V_10 * F_58 ( struct V_12 * V_13 ,
struct V_1 * V_2 )
{
int V_41 ;
struct V_10 * V_11 ;
...
int F_66 ( struct V_52 * V_52 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_53 ;
V_2 = F_67 ( sizeof( struct V_12 ) , V_9 , V_54 ,
V_55 ) ;
if ( ! V_2 )
return - V_45 ;
F_68 ( V_2 , V_52 ) ;
...
int F_71 ( struct V_52 * V_52 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_58 = 0 ;
F_72 () ;
...
int F_75 ( const struct V_12 * V_13 )
{
...
int F_81 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
int V_20 = 0 ;
bool V_70 ;
...
if ( V_20 )
goto V_84;
V_20 = F_88 ( & V_11 -> V_29 , & V_85 , & ( V_2 -> V_2 . V_29 ) ,
V_86 ) ;
if ( V_20 )
goto V_87;
V_20 = F_89 ( V_11 ) ;
...
if ( V_20 )
goto V_89;
V_20 = F_91 ( V_2 , V_90 , V_11 ) ;
if ( V_20 )
goto V_91;
V_2 -> V_22 |= V_36 ;
V_20 = F_92 ( V_2 , V_13 -> V_2 , NULL , NULL ) ;
if ( V_20 )
goto V_92;
F_93 ( V_2 ) ;
F_94 ( & V_11 -> V_35 , & V_13 -> V_65 ) ;
F_21 ( V_13 ) ;
F_95 ( V_13 -> V_2 ) ;
if ( V_13 -> V_2 -> V_93 < V_2 -> V_93 )
V_13 -> V_2 -> V_93 = V_2 -> V_93 ;
if ( F_96 ( V_13 , V_11 , V_2 -> V_75 , 0 ) )
F_97 ( V_2 , L_3 ) ;
V_20 = F_98 ( V_11 ) ;
if ( V_20 ) {
F_97 ( V_2 , L_4 ) ;
...
int F_101 ( struct V_12 * V_13 , struct V_1 * V_2 )
{
struct V_10 * V_11 ;
bool V_70 ;
V_11 = F_102 ( V_2 ) ;
...
void F_103 ( struct V_10 * V_11 , unsigned long V_68 )
{
struct V_12 * V_13 = V_11 -> V_13 ;
if ( V_68 & V_98 )
F_21 ( V_13 ) ;
