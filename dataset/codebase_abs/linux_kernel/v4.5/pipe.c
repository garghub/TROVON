...
{
T_1 V_38 = F_10 ( V_2 ) & V_35 ;
return ( int ) ( V_38 == V_40 || V_38 == V_39 ) ;
}
void F_35 ( struct V_1 * V_2 , int V_44 )
{
if ( ! F_36 ( V_2 , V_45 ) )
return;
...
if ( F_37 ( V_2 ) ) {
int V_48 = F_38 ( V_2 ) ;
F_16 ( V_2 , 0xffff , F_39 ( V_44 , V_48 ) ) ;
F_21 ( V_2 , V_47 , V_47 ) ;
}
}
...
void F_44 ( struct V_1 * V_2 , T_1 V_74 ,
T_1 V_55 , T_1 V_48 )
{
struct V_5 * V_6 = F_6 ( V_2 ) ;
int V_7 = F_18 ( V_2 ) ;
...
{
return F_45 ( V_2 , V_66 ) ;
}
int F_46 ( struct V_1 * V_2 )
{
return F_45 ( V_2 , V_64 ) ;
}
...
void F_50 ( struct V_1 * V_2 , int V_79 )
{
T_1 V_9 = ( V_80 | V_81 ) ;
T_1 V_10 ;
switch ( V_79 ) {
...
void F_54 ( struct V_1 * V_2 , int V_84 )
{
int V_79 ;
if ( F_8 ( V_2 ) )
return;
...
static struct V_1 * F_55 ( struct V_5 * V_6 , T_3 type )
{
struct V_1 * V_86 , * V_2 ;
int V_87 ;
V_2 = NULL ;
...
int (* F_60)( struct V_89 * V_90 , int V_91 ) )
{
struct V_92 * V_93 = F_61 ( V_6 ) ;
struct V_1 * V_2 ;
int V_87 ;
F_56 (pipe, priv, i) {
F_57 ( V_2 ) ;
...
struct V_1 * F_63 ( struct V_5 * V_6 ,
int V_97 ,
int V_50 )
{
struct V_18 * V_19 = F_17 ( V_6 ) ;
