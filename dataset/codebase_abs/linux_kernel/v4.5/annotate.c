...
{
const int V_32 = F_28 ( V_33 ) ;
return bsearch ( V_5 , V_33 , V_32 , sizeof( struct V_7 ) , F_27 ) ;
}
int F_29 ( struct V_34 * V_34 V_30 , struct V_35 * V_36 )
{
struct V_37 * V_38 = F_30 ( V_36 ) ;
F_31 ( & V_38 -> V_39 , NULL ) ;
return 0 ;
}
...
/ V_44 . V_45 )
return - 1 ;
V_38 -> V_43 = F_17 ( sizeof( * V_38 -> V_43 ) + V_44 . V_45 * V_40 ) ;
if ( V_38 -> V_43 == NULL )
return - 1 ;
V_38 -> V_43 -> V_40 = V_40 ;
...
unsigned V_17 ;
struct V_42 * V_59 ;
F_41 ( L_9 V_14 L_10 , V_60 , V_34 -> V_61 ( V_34 , V_12 ) ) ;
if ( V_12 < V_36 -> V_50 || V_12 >= V_36 -> V_62 ) {
F_42 ( L_11 V_14 L_12 V_14 L_13 V_14 L_10 ,
...
V_59 -> V_64 ++ ;
V_59 -> V_12 [ V_17 ] ++ ;
F_41 ( L_14 V_14 L_15 V_14 L_16 V_14
L_17 V_65 L_10 , V_36 -> V_50 , V_36 -> V_5 ,
V_12 , V_12 - V_36 -> V_50 , V_58 , V_59 -> V_12 [ V_17 ] ) ;
return 0 ;
}
static struct V_37 * F_44 ( struct V_35 * V_36 , bool V_51 )
{
struct V_37 * V_38 = F_30 ( V_36 ) ;
if ( V_38 -> V_43 == NULL ) {
if ( F_32 ( V_36 ) < 0 )
...
static int F_45 ( struct V_35 * V_36 , struct V_34 * V_34 ,
int V_58 , T_2 V_12 )
{
struct V_37 * V_38 ;
if ( V_36 == NULL )
return 0 ;
V_38 = F_44 ( V_36 , false ) ;
if ( V_38 == NULL )
return - V_66 ;
return F_40 ( V_36 , V_34 , V_38 , V_58 , V_12 ) ;
}
static int F_46 ( T_2 V_12 , T_2 V_50 ,
...
V_69 = V_50 -> V_71 ;
if ( V_69 == 0 )
F_48 ( L_18 V_14 L_19 V_14 L_20 V_14 L_21 V_14 L_10 ,
V_68 -> V_12 ,
V_50 ? V_50 -> V_12 : 0 ,
V_68 -> V_36 ? V_68 -> V_36 -> V_50 + V_68 -> V_34 -> V_50 : 0 ,
V_69 ) ;
V_70 = F_46 ( V_68 -> V_71 , V_69 , V_68 -> V_36 , V_51 ) ;
if ( V_70 )
F_48 ( L_22 , V_70 ) ;
return V_70 ;
}
int F_49 ( struct V_67 * V_68 , int V_58 )
{
return F_45 ( V_68 -> V_36 , V_68 -> V_34 , V_58 , V_68 -> V_71 ) ;
}
int F_50 ( struct V_72 * V_73 , int V_58 , T_2 V_74 )
{
return F_45 ( V_73 -> V_75 . V_36 , V_73 -> V_75 . V_34 , V_58 , V_74 ) ;
}
static void F_51 ( struct V_76 * V_77 )
{
V_77 -> V_7 = F_19 ( V_77 -> V_5 ) ;
if ( V_77 -> V_7 == NULL )
return;
if ( ! V_77 -> V_7 -> V_2 )
return;
...
static int F_18 ( char * line , char * * V_22 , char * * V_78 )
{
char * V_5 = line , V_79 ;
while ( isspace ( V_5 [ 0 ] ) )
++ V_5 ;
...
static struct V_76 * F_52 ( T_3 V_17 , char * line ,
T_1 V_81 , int V_82 )
{
struct V_76 * V_77 = F_17 ( sizeof( * V_77 ) + V_81 ) ;
if ( V_77 != NULL ) {
V_77 -> V_17 = V_17 ;
V_77 -> line = F_9 ( line ) ;
V_77 -> V_82 = V_82 ;
...
goto V_83;
if ( V_17 != - 1 ) {
if ( F_18 ( V_77 -> line , & V_77 -> V_5 , & V_77 -> V_2 . V_4 ) < 0 )
goto V_84;
F_51 ( V_77 ) ;
}
}
...
int F_54 ( struct V_76 * V_77 , char * V_8 , T_1 V_9 , bool V_4 )
{
if ( V_4 || ! V_77 -> V_7 )
return F_4 ( V_8 , V_9 , L_1 , V_77 -> V_5 , V_77 -> V_2 . V_4 ) ;
return F_5 ( V_77 -> V_7 , V_8 , V_9 , & V_77 -> V_2 ) ;
}
static void F_55 ( struct V_85 * V_86 , struct V_76 * line )
{
F_56 ( & line -> V_87 , V_86 ) ;
}
struct V_76 * F_57 ( struct V_85 * V_86 , struct V_76 * V_88 )
{
F_58 (pos, head, node)
if ( V_88 -> V_17 >= 0 )
return V_88 ;
...
double F_59 ( struct V_37 * V_38 , int V_58 , T_3 V_17 ,
...
struct V_42 * V_59 = F_43 ( V_38 , V_58 ) ;
unsigned int V_99 = 0 ;
while ( V_17 < V_62 )
V_99 += V_59 -> V_12 [ V_17 ++ ] ;
if ( V_59 -> V_64 ) {
...
static int F_60 ( struct V_76 * V_77 , struct V_35 * V_36 , T_2 V_50 ,
...
return 1 ;
if ( V_105 != NULL ) {
F_62 (queue, &notes->src->source, node) {
if ( V_105 == V_77 )
break;
F_60 ( V_105 , V_36 , V_50 , V_101 , V_102 ,
0 , 0 , 1 , NULL ) ;
}
}
V_113 = F_63 ( V_108 ) ;
...
V_113 = F_63 ( V_94 ) ;
if ( V_44 . V_117 )
F_64 ( stdout , V_113 , L_24 V_65 ,
V_90 ) ;
else
F_64 ( stdout , V_113 , L_25 , V_94 ) ;
}
printf ( L_26 ) ;
F_64 ( stdout , V_118 , L_27 V_14 L_28 , V_12 ) ;
F_64 ( stdout , V_119 , L_29 , V_77 -> line ) ;
if ( V_109 != & V_94 )
free ( V_109 ) ;
if ( V_110 != & V_90 )
free ( V_110 ) ;
...
static int F_65 ( struct V_35 * V_36 , struct V_34 * V_34 ,
T_4 * V_121 , T_1 V_81 ,
int * V_82 )
{
struct V_37 * V_38 = F_30 ( V_36 ) ;
...
if ( V_126 != - 1 ) {
T_2 V_50 = F_67 ( V_34 , V_36 -> V_50 ) ,
V_62 = F_67 ( V_34 , V_36 -> V_62 ) ;
V_17 = V_126 - V_50 ;
...
V_77 = F_52 ( V_17 , V_122 , V_81 , * V_82 ) ;
free ( line ) ;
( * V_82 ) ++ ;
if ( V_77 == NULL )
return - 1 ;
...
F_67 ( V_34 , V_36 -> V_50 ) ;
if ( V_77 -> V_7 && F_11 ( V_77 -> V_7 ) && ! V_77 -> V_2 . V_6 . V_5 ) {
struct V_67 V_6 = {
. V_34 = V_34 ,
...
V_77 -> V_2 . V_6 . V_5 = F_9 ( V_6 . V_36 -> V_5 ) ;
}
F_55 ( & V_38 -> V_43 -> V_3 , V_77 ) ;
return 0 ;
}
int F_69 ( struct V_35 * V_36 , struct V_34 * V_34 , T_1 V_81 )
{
struct V_130 * V_130 = V_34 -> V_130 ;
char * V_131 = F_70 ( V_130 , NULL , 0 ) ;
bool V_132 = true ;
char V_133 [ V_134 * 2 ] ;
T_4 * V_121 ;
int V_70 = 0 ;
...
goto V_142;
} else if ( F_74 ( V_135 , V_133 , sizeof( V_133 ) ) < 0 ||
strstr ( V_133 , L_34 ) ||
F_75 ( V_135 , V_143 ) ) {
free ( V_131 ) ;
V_142:
...
F_42 ( L_44 V_14 L_13 V_14 L_10 , V_60 ,
...
if ( F_73 ( V_130 ) ) {
V_137 . V_153 = V_135 ;
V_137 . V_12 = F_67 ( V_34 , V_36 -> V_50 ) ;
V_137 . V_154 = V_36 -> V_50 ;
V_137 . V_102 = V_36 -> V_62 - V_36 -> V_50 ;
if ( ! F_77 ( & V_137 ) ) {
V_138 = true ;
F_78 ( V_135 , V_137 . V_155 ,
sizeof( V_135 ) ) ;
if ( V_132 ) {
free ( V_131 ) ;
V_132 = false ;
...
V_159 = F_82 ( V_157 . V_160 , V_135 , V_158 ) ;
if ( V_159 )
F_72 ( L_47 , V_157 . V_160 , V_135 ) ;
free ( V_157 . V_160 ) ;
F_83 ( V_158 ) ;
if ( ! V_159 )
goto V_150;
...
static void F_89 ( struct V_166 * V_167 , struct V_91 * V_92 )
{
struct V_91 * V_168 ;
...
while ( * V_170 != NULL ) {
V_171 = * V_170 ;
V_168 = F_90 ( V_171 , struct V_91 , V_87 ) ;
...
F_91 ( & V_92 -> V_87 , V_171 , V_170 ) ;
F_92 ( & V_92 -> V_87 , V_167 ) ;
}
static int F_93 ( struct V_91 * V_175 , struct V_91 * V_176 )
{
int V_111 ;
...
static void F_94 ( struct V_166 * V_167 , struct V_91 * V_92 )
{
struct V_91 * V_168 ;
struct V_169 * * V_170 = & V_167 -> V_169 ;
struct V_169 * V_171 = NULL ;
...
static void F_95 ( struct V_166 * V_177 , struct V_166 * V_178 )
{
struct V_91 * V_92 ;
struct V_169 * V_87 ;
V_87 = F_96 ( V_178 ) ;
while ( V_87 ) {
struct V_169 * V_114 ;
V_92 = F_90 ( V_87 , struct V_91 , V_87 ) ;
V_114 = F_97 ( V_87 ) ;
F_98 ( V_87 , V_178 ) ;
F_94 ( V_177 , V_92 ) ;
V_87 = V_114 ;
...
static void F_99 ( struct V_35 * V_36 , int V_102 )
{
struct V_37 * V_38 = F_30 ( V_36 ) ;
struct V_91 * V_92 = V_38 -> V_43 -> V_93 ;
T_1 V_95 ;
...
static int F_101 ( struct V_35 * V_36 , struct V_34 * V_34 ,
struct V_100 * V_101 ,
...
if ( ! V_38 -> V_43 -> V_93 )
return - 1 ;
V_50 = F_67 ( V_34 , V_36 -> V_50 ) ;
for ( V_111 = 0 ; V_111 < V_102 ; V_111 ++ ) {
T_2 V_17 ;
double V_183 = 0.0 ;
V_92 -> V_97 = V_97 ;
for ( V_179 = 0 ; V_179 < V_97 ; V_179 ++ ) {
V_59 = F_43 ( V_38 , V_58 + V_179 ) ;
...
goto V_114;
V_17 = V_50 + V_111 ;
V_92 -> V_89 = F_102 ( V_34 -> V_130 , V_17 , NULL , false ) ;
F_89 ( & V_180 , V_92 ) ;
V_114:
V_92 = ( void * ) V_92 + V_95 ;
}
...
static void F_103 ( struct V_166 * V_167 , const char * V_131 )
{
struct V_91 * V_92 ;
struct V_169 * V_87 ;
printf ( L_59 , V_131 ) ;
...
V_89 = V_92 -> V_89 ;
V_113 = F_63 ( V_183 ) ;
F_64 ( stdout , V_113 , L_62 , V_89 ) ;
V_87 = F_97 ( V_87 ) ;
}
}
static void F_105 ( struct V_35 * V_36 , struct V_100 * V_101 )
{
struct V_37 * V_38 = F_30 ( V_36 ) ;
struct V_42 * V_59 = F_43 ( V_38 , V_101 -> V_116 ) ;
T_2 V_102 = F_33 ( V_36 ) , V_17 ;
...
if ( V_196 )
F_105 ( V_36 , V_101 ) ;
F_109 (pos, &notes->src->source, node) {
if ( V_187 && V_105 == NULL ) {
V_105 = V_88 ;
V_190 = 0 ;
}
switch ( F_60 ( V_88 , V_36 , V_50 , V_101 , V_102 ,
V_103 , V_27 , V_104 ,
V_105 ) ) {
case 0 :
++ V_27 ;
...
break;
if ( V_190 == V_187 )
V_105 = F_110 ( V_105 -> V_87 . V_114 , F_111 ( * V_105 ) , V_87 ) ;
else
++ V_190 ;
break;
}
...
void F_113 ( struct V_35 * V_36 , int V_58 )
{
struct V_37 * V_38 = F_30 ( V_36 ) ;
struct V_42 * V_59 = F_43 ( V_38 , V_58 ) ;
int V_102 = F_33 ( V_36 ) , V_17 ;
V_59 -> V_64 = 0 ;
for ( V_17 = 0 ; V_17 < V_102 ; ++ V_17 ) {
...
void F_114 ( struct V_85 * V_86 )
{
struct V_76 * V_88 , * V_197 ;
F_115 (pos, n, head, node) {
F_116 ( & V_88 -> V_87 ) ;
F_53 ( V_88 ) ;
}
}
static T_1 F_117 ( struct V_76 * V_77 , T_4 * V_198 )
{
T_1 V_27 ;
if ( V_77 -> V_17 == - 1 )
...
T_1 F_118 ( struct V_85 * V_86 , T_4 * V_198 )
{
struct V_76 * V_88 ;
T_1 V_27 = 0 ;
F_109 (pos, head, node)
V_27 += F_117 ( V_88 , V_198 ) ;
return V_27 ;
}
int F_119 ( struct V_35 * V_36 , struct V_34 * V_34 ,
...
T_2 V_102 ;
if ( F_69 ( V_36 , V_34 , 0 ) < 0 )
return - 1 ;
V_102 = F_33 ( V_36 ) ;
if ( V_199 ) {
V_200 = V_186 ;
F_101 ( V_36 , V_34 , V_101 , & V_91 , V_102 ) ;
F_103 ( & V_91 , V_130 -> V_144 ) ;
}
F_106 ( V_36 , V_34 , V_101 , V_186 ,
V_103 , V_104 , 0 ) ;
if ( V_199 )
F_99 ( V_36 , V_102 ) ;
F_114 ( & F_30 ( V_36 ) -> V_43 -> V_3 ) ;
return 0 ;
}
int F_120 ( struct V_72 * V_73 , T_1 V_81 )
{
return F_69 ( V_73 -> V_75 . V_36 , V_73 -> V_75 . V_34 , V_81 ) ;
}
bool F_121 ( void )
{
