...
static int F_109 ( struct V_254 * V_255 , T_7 V_256 )
{
...
static void F_116 ( struct V_257 * V_258 , T_7 V_256 )
{
F_113 ( V_258 ) ;
}
static int F_117 ( struct V_254 * V_255 ,
struct V_265 * V_266 )
{
...
static int F_118 ( struct V_267 * V_268 , struct V_269 * V_46 )
{
if ( V_46 -> V_270 != V_271 &&
V_46 -> V_270 != V_272 ) {
F_119 ( V_46 , L_92 ) ;
...
static void F_120 ( struct V_267 * V_268 )
{
...
F_110 ( & V_261 ) ;
V_23 -> V_264 = F_130 ( & V_263 , V_44 , 0 , 256 , V_201 ) ;
F_111 ( & V_261 ) ;
if ( V_23 -> V_264 < 0 )
return V_23 -> V_264 ;
V_23 -> V_258 = F_131 ( 0 ) ;
...
V_23 -> V_252 = F_132 ( F_120 , & V_23 -> V_251 ) ;
if ( ! V_23 -> V_252 ) {
V_280 = - V_202 ;
goto V_287;
}
V_23 -> V_252 -> V_277 = V_44 ;
F_133 ( V_23 -> V_252 , F_118 ) ;
F_134 ( V_23 -> V_252 , V_281 ) ;
F_135 ( V_23 -> V_252 , V_288 ) ;
F_136 ( V_23 -> V_252 , V_289 ) ;
F_137 ( V_23 -> V_252 ,
V_288 * V_23 -> V_102 ) ;
F_138 ( V_23 -> V_252 , V_23 -> V_102 ) ;
...
F_139 ( V_23 -> V_258 , V_283 ) ;
F_40 ( L_98 , V_283 ) ;
V_23 -> V_262 = 1 ;
V_23 -> V_220 = F_140 ( L_99 , V_295 ) ;
F_141 ( & V_23 -> V_221 , F_98 ) ;
