...
log -> V_4 - log -> V_8 ,
V_46 , 0 ) ;
F_85 ( V_51 , log -> V_28 -> V_54 , V_5 ,
V_46 , 0 ) ;
}
}
static void F_86 ( struct V_1 * log )
{
T_1 V_129 = F_87 ( & log -> V_129 , 0 ) ;
T_1 V_130 ;
T_1 V_114 ;
T_4 V_117 ;
F_36 ( & log -> V_19 ) ;
...
static void F_90 ( struct V_132 * V_33 )
{
...
if ( V_138 < V_137 )
return;
} while ( F_91 ( & log -> V_129 , V_137 , V_138 ) != V_137 );
F_21 ( log -> V_139 ) ;
}
void F_92 ( struct V_1 * log , int V_13 )
{
struct V_29 * V_29 ;
if ( ! log || V_13 == 2 )
return;
...
static int F_99 ( struct V_1 * log ,
struct V_142 * V_143 )
{
struct V_81 * V_81 = V_143 -> V_30 ;
struct V_35 * V_144 ;
T_2 V_37 , V_145 ;
if ( ! F_100 ( log -> V_28 , V_143 -> V_146 , V_41 , V_81 , V_147 , false ) )
return - V_148 ;
V_144 = F_23 ( V_81 ) ;
V_145 = F_101 ( V_144 -> V_42 ) ;
V_144 -> V_42 = 0 ;
if ( F_101 ( V_144 -> V_62 ) != V_63 ||
F_102 ( V_144 -> V_66 ) != V_143 -> V_66 ||
V_144 -> V_64 != V_65 ||
F_102 ( V_144 -> V_67 ) != V_143 -> V_146 )
return - V_104 ;
V_37 = F_25 ( log -> V_40 , V_144 , V_41 ) ;
if ( V_145 != V_37 )
return - V_104 ;
if ( F_101 ( V_144 -> V_38 ) > V_41 )
return - V_104 ;
V_143 -> V_149 = V_55 ;
return 0 ;
}
static int F_103 ( struct V_1 * log ,
struct V_142 * V_143 ,
T_1 V_150 ,
int * V_151 , T_1 * V_152 )
{
...
struct V_76 * V_77 ;
int V_153 ;
V_15 = F_104 ( V_134 , V_150 , 0 , 0 , 0 ) ;
while ( 1 ) {
V_77 = F_23 ( V_143 -> V_30 ) + * V_151 ;
if ( F_105 ( V_77 -> V_78 . type ) == V_92 ) {
F_106 ( V_134 ,
F_102 ( V_77 -> V_72 ) , 0 ,
& V_153 , V_15 ) ;
F_100 ( log -> V_28 , * V_152 , V_41 ,
...
sizeof( V_80 ) *
( F_101 ( V_77 -> V_6 ) >> ( V_79 - 9 ) ) ;
if ( F_105 ( V_77 -> V_78 . type ) == V_94 )
break;
}
...
& V_15 -> V_89 [ V_153 ] . V_26 ) )
continue;
V_28 = F_97 ( V_134 -> V_87 [ V_153 ] . V_28 ) ;
if ( V_28 )
F_100 ( V_28 , V_150 , V_41 ,
V_15 -> V_89 [ V_153 ] . V_81 , V_44 , false ) ;
V_156 = F_97 ( V_134 -> V_87 [ V_153 ] . V_157 ) ;
if ( V_156 )
F_100 ( V_156 , V_150 , V_41 ,
V_15 -> V_89 [ V_153 ] . V_81 , V_44 , false ) ;
}
F_10 ( V_15 ) ;
return 0 ;
...
static int F_108 ( struct V_1 * log ,
struct V_142 * V_143 )
{
struct V_133 * V_134 = log -> V_28 -> V_29 -> V_135 ;
struct V_76 * V_77 ;
...
while ( V_151 < F_101 ( V_144 -> V_38 ) ) {
int V_159 ;
V_77 = ( void * ) V_144 + V_151 ;
V_158 = F_106 ( V_134 ,
F_102 ( V_77 -> V_72 ) , 0 , & V_159 , NULL ) ;
if ( F_103 ( log , V_143 , V_158 ,
& V_151 , & V_152 ) )
return - V_104 ;
}
return 0 ;
}
static void F_109 ( struct V_1 * log ,
struct V_142 * V_143 )
{
while ( 1 ) {
if ( F_99 ( log , V_143 ) )
...
static int F_110 ( struct V_1 * log , T_1 V_146 ,
T_4 V_66 )
{
struct V_81 * V_81 ;
struct V_35 * V_144 ;
T_2 V_37 ;
V_81 = F_111 ( V_160 | V_161 ) ;
if ( ! V_81 )
return - V_71 ;
V_144 = F_23 ( V_81 ) ;
...
if ( ! F_100 ( log -> V_28 , V_146 , V_41 , V_81 , V_162 , false ) ) {
F_112 ( V_81 ) ;
return - V_148 ;
}
F_112 ( V_81 ) ;
...
static int F_113 ( struct V_1 * log )
{
struct V_142 V_143 ;
V_143 . V_146 = log -> V_8 ;
V_143 . V_66 = log -> V_131 ;
V_143 . V_30 = F_111 ( V_160 ) ;
if ( ! V_143 . V_30 )
return - V_71 ;
F_109 ( log , & V_143 ) ;
F_112 ( V_143 . V_30 ) ;
...
int V_86 ;
V_86 = F_110 ( log , V_143 . V_146 , V_143 . V_66 + 10 ) ;
if ( V_86 )
return V_86 ;
...
static int F_114 ( struct V_1 * log )
{
...
bool V_166 = false ;
int V_86 ;
if ( V_163 >= V_28 -> V_167 || F_115 ( V_163 , V_55 ) != V_163 )
V_163 = 0 ;
V_81 = F_111 ( V_160 ) ;
if ( ! V_81 )
return - V_71 ;
if ( ! F_100 ( V_28 , V_163 , V_41 , V_81 , V_147 , false ) ) {
V_86 = - V_148 ;
goto V_168;
}
V_144 = F_23 ( V_81 ) ;
...
log -> V_131 = F_102 ( V_144 -> V_66 ) ;
log -> V_4 = F_115 ( V_28 -> V_167 , V_55 ) ;
...
int F_117 ( struct V_133 * V_134 , struct V_155 * V_28 )
{
struct V_1 * log ;
if ( V_41 != 4096 )
return - V_104 ;
log = F_118 ( sizeof( * log ) , V_160 ) ;
if ( ! log )
return - V_71 ;
log -> V_28 = V_28 ;
log -> V_32 = ( V_28 -> V_51 -> V_172 -> V_173 -> V_174 != 0 ) ;
...
F_32 ( & log -> V_22 ) ;
F_121 ( & log -> V_120 ) ;
log -> V_176 = F_122 ( V_10 , 0 ) ;
if ( ! log -> V_176 )
goto V_176;
log -> V_58 = F_123 ( V_177 , log -> V_176 ) ;
if ( ! log -> V_58 )
goto V_58;
log -> V_48 = F_124 ( V_177 , 0 ) ;
if ( ! log -> V_48 )
goto V_178;
log -> V_31 = F_125 ( V_177 , 0 ) ;
if ( ! log -> V_31 )
goto V_179;
log -> V_139 = F_93 ( F_90 ,
log -> V_28 -> V_29 , L_1 ) ;
