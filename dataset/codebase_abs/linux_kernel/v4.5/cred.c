...
#ifdef F_74
if ( F_75 () && V_1 -> V_29 ) {
if ( ( unsigned long ) V_1 -> V_29 < V_73 )
return true ;
if ( ( * ( T_2 * ) V_1 -> V_29 & 0xffffff00 ) ==
( V_74 << 24 | V_74 << 16 | V_74 << 8 ) )
return true ;
}
#endif
return false ;
}
static void F_76 ( const struct V_1 * V_1 , const char * V_75 ,
...
void F_80 ( const struct V_1 * V_1 , const char * V_77 , unsigned line )
{
F_77 ( V_76 L_27 ) ;
F_77 ( V_76 L_28 , V_77 , line ) ;
F_76 ( V_1 , L_29 , V_19 ) ;
F_81 () ;
}
void F_82 ( struct V_21 * V_22 ,
const char * V_77 , unsigned line )
{
