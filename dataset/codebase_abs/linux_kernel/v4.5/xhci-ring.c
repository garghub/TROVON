...
{
unsigned int V_381 ;
if ( V_10 -> V_351 < 0x100 || V_218 -> V_215 != V_382 )
return 0 ;
...
if ( V_350 == 0 )
V_350 ++ ;
V_401 = F_177 ( V_10 , V_74 -> V_75 , V_74 ,
V_350 ) ;
V_385 = F_178 ( V_10 ,
V_74 -> V_75 , V_74 , V_350 ) ;
...
if ( F_186 ( V_10 -> V_405 ) )
V_399 -> V_410 = V_74 -> V_387 + V_395 * V_74 -> V_342 ;
if ( F_45 ( V_10 ) -> V_119 . V_120 == 0 ) {
if ( V_10 -> V_35 & V_121 )
F_188 () ;
}
...
if ( F_186 ( V_10 -> V_405 ) && ! F_29 ( & V_82 -> V_69 ) ) {
if ( ( F_3 ( V_95 -> V_151 ) & V_152 ) ==
V_329 ) {
V_74 -> V_387 = V_399 -> V_410 ;
goto V_411;
}
}
...
T_2 V_318 , T_2 V_319 ,
T_2 V_320 , T_2 V_321 , bool V_413 )
{
int V_414 = V_10 -> V_415 ;
int V_47 ;
if ( V_10 -> V_53 ) {
F_15 ( V_10 , L_130 ) ;
return - V_55 ;
...
T_1 V_416 , T_2 V_56 , enum V_417 V_364 )
{
return F_190 ( V_10 , V_174 , F_170 ( V_416 ) ,
F_171 ( V_416 ) , 0 ,
F_39 ( V_201 ) | F_193 ( V_56 )
| ( V_364 == V_418 ? V_419 : 0 ) , false ) ;
}
...
int V_56 , unsigned int V_57 , int V_420 )
{
T_2 V_421 = F_193 ( V_56 ) ;
T_2 V_422 = F_199 ( V_57 ) ;
T_2 type = F_39 ( V_202 ) ;
T_2 V_423 = F_200 ( V_420 ) ;
return F_190 ( V_10 , V_174 , 0 , 0 , 0 ,
V_421 | V_422 | type | V_423 , false ) ;
}
...
F_170 ( V_85 ) | V_425 | V_128 -> V_98 ,
F_171 ( V_85 ) , V_424 ,
V_421 | V_422 | type , false ) ;
if ( V_47 < 0 ) {
F_203 ( V_10 , V_174 ) ;
return;
}
