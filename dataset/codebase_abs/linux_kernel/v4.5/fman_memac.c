...
F_11 ( V_62 -> V_72 , V_73 , V_65 ) ;
V_65 = V_74 ;
F_11 ( V_62 -> V_72 , V_75 , V_65 ) ;
F_11 ( V_62 -> V_72 , V_76 , V_77 ) ;
F_11 ( V_62 -> V_72 , V_78 , V_79 ) ;
if ( ! V_64 )
V_65 = V_80 | V_81 ;
else
V_65 = V_80 & ~ V_82 ;
F_11 ( V_62 -> V_72 , 0x0 , V_65 ) ;
}
static void F_12 ( struct V_61 * V_62 )
{
T_5 V_65 ;
V_65 = V_83 ;
F_11 ( V_62 -> V_72 , V_75 , V_65 ) ;
F_11 ( V_62 -> V_72 , V_76 , V_84 ) ;
F_11 ( V_62 -> V_72 , V_78 , V_85 ) ;
V_65 = V_80 | V_81 ;
F_11 ( V_62 -> V_72 , 0x0 , V_65 ) ;
}
...
static int F_16 ( enum V_90 V_91 )
{
T_3 V_92 ;
switch ( V_91 ) {
case V_93 :
...
{
F_20 ( V_62 -> V_109 , V_110 , V_62 -> V_111 ,
V_112 ) ;
F_20 ( V_62 -> V_109 , V_110 , V_62 -> V_111 ,
V_113 ) ;
F_21 ( V_62 -> V_114 ) ;
...
static bool F_22 ( struct V_19 * V_116 )
{
if ( ! V_116 )
return true ;
return false ;
}
int F_23 ( struct V_61 * V_62 , enum V_117 V_118 )
{
struct V_1 T_1 * V_2 = V_62 -> V_2 ;
T_3 V_11 ;
if ( ! F_22 ( V_62 -> V_119 ) )
...
int F_25 ( struct V_61 * V_62 , bool V_124 )
{
struct V_1 T_1 * V_2 = V_62 -> V_2 ;
T_3 V_11 ;
if ( ! F_22 ( V_62 -> V_119 ) )
...
int F_26 ( struct V_61 * V_62 , T_5 V_22 )
{
struct V_1 T_1 * V_2 = V_62 -> V_2 ;
T_3 V_11 ;
if ( ! F_22 ( V_62 -> V_119 ) )
...
int F_27 ( struct V_61 * V_62 , T_5 V_124 )
{
if ( F_22 ( V_62 -> V_119 ) )
return - V_87 ;
...
int F_28 ( struct V_61 * V_62 , bool V_17 )
{
if ( F_22 ( V_62 -> V_119 ) )
return - V_87 ;
...
int F_30 ( struct V_61 * V_62 , T_2 V_134 ,
T_5 V_135 , T_5 V_136 )
{
struct V_1 T_1 * V_2 = V_62 -> V_2 ;
T_3 V_11 ;
...
int F_32 ( struct V_61 * V_62 , bool V_142 )
{
struct V_1 T_1 * V_2 = V_62 -> V_2 ;
T_3 V_11 ;
if ( ! F_22 ( V_62 -> V_119 ) )
...
int F_33 ( struct V_61 * V_62 , T_7 * V_143 )
{
if ( ! F_22 ( V_62 -> V_119 ) )
return - V_87 ;
...
int F_34 ( struct V_61 * V_62 , T_7 * V_55 )
{
struct V_1 T_1 * V_2 = V_62 -> V_2 ;
struct V_144 * V_145 ;
T_3 V_146 ;
...
int F_39 ( struct V_61 * V_62 , T_7 * V_55 )
{
struct V_1 T_1 * V_2 = V_62 -> V_2 ;
...
V_86 = F_35 ( * V_55 ) ;
V_146 = F_9 ( V_86 ) & V_148 ;
F_40 (pos, &memac->multicast_addr_hash->lsts[hash]) {
V_145 = F_41 ( V_156 ) ;
if ( V_145 -> V_86 == V_86 ) {
F_42 ( & V_145 -> V_151 ) ;
F_43 ( V_145 ) ;
...
if ( F_44 ( & V_62 -> V_114 -> V_152 [ V_146 ] ) )
F_2 ( V_146 & ~ V_153 , & V_2 -> V_154 ) ;
return 0 ;
}
...
T_2 V_166 , V_167 ;
V_167 = V_62 -> V_72 -> V_168 . V_86 ;
V_166 = ( T_2 ) ( ( V_167 << 2 ) | V_59 ) ;
V_62 -> V_72 -> V_168 . V_86 = V_166 ;
if ( V_62 -> V_164 )
F_12 ( V_62 ) ;
else
F_10 ( V_62 , V_64 ) ;
V_62 -> V_72 -> V_168 . V_86 = V_167 ;
}
}
V_157 = F_48 ( V_62 -> V_109 , V_62 -> V_111 ,
V_119 -> V_32 ) ;
if ( V_157 ) {
F_14 ( L_7 ) ;
return V_157 ;
}
V_62 -> V_114 = F_49 ( V_169 ) ;
if ( ! V_62 -> V_114 ) {
F_19 ( V_62 ) ;
F_14 ( L_8 ) ;
return - V_150 ;
}
V_62 -> V_115 = F_49 ( V_169 ) ;
if ( ! V_62 -> V_115 ) {
F_19 ( V_62 ) ;
F_14 ( L_8 ) ;
return - V_150 ;
}
F_50 ( V_62 -> V_109 , V_110 , V_62 -> V_111 ,
V_112 , F_17 , V_62 ) ;
F_50 ( V_62 -> V_109 , V_110 , V_62 -> V_111 ,
V_113 , F_18 , V_62 ) ;
F_43 ( V_119 ) ;
...
struct V_61 * F_52 ( struct V_170 * V_171 )
{
struct V_61 * V_62 ;
struct V_19 * V_119 ;
void T_1 * V_172 ;
V_172 = V_171 -> V_172 ;
V_62 = F_53 ( sizeof( * V_62 ) , V_149 ) ;
if ( ! V_62 )
return NULL ;
V_119 = F_53 ( sizeof( * V_119 ) , V_149 ) ;
if ( ! V_119 ) {
F_51 ( V_62 ) ;
return NULL ;
}
V_62 -> V_119 = V_119 ;
F_8 ( V_119 ) ;
V_62 -> V_86 = F_35 ( V_171 -> V_86 ) ;
V_62 -> V_2 = V_172 ;
V_62 -> V_162 = V_171 -> V_162 ;
V_62 -> V_21 = V_171 -> V_21 ;
V_62 -> V_111 = V_171 -> V_111 ;
V_62 -> V_24 = ( V_98 | V_94 |
V_96 | V_100 ) ;
V_62 -> V_88 = V_171 -> V_88 ;
V_62 -> V_89 = V_171 -> V_89 ;
V_62 -> V_105 = V_171 -> V_105 ;
V_62 -> V_109 = V_171 -> V_109 ;
V_62 -> V_164 = V_171 -> V_164 ;
F_54 ( V_62 -> V_109 , & V_62 -> V_159 ) ;
if ( V_62 -> V_21 == V_163 ) {
if ( ! V_171 -> V_173 ) {
F_14 ( L_9 ) ;
F_51 ( V_62 ) ;
