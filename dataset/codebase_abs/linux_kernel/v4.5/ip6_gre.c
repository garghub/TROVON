...
T_6 V_76 ;
int V_92 ;
memset ( & ( F_63 ( V_57 ) -> V_59 ) , 0 , sizeof( F_63 ( V_57 ) -> V_59 ) ) ;
...
static int F_159 ( struct V_12 * V_261 , struct V_6 * V_7 ,
