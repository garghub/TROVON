...
static int F_28 ( struct V_51 * V_47 )
{
struct V_52 * V_53 = F_29 ( V_47 ) ;
struct V_5 * V_6 = V_53 -> V_54 ;
struct V_7 * V_8 = V_6 -> V_9 ;
int V_55 ;
V_55 = F_30 ( V_47 ) ;
F_16 ( V_8 ) ;
...
static int F_31 ( struct V_51 * V_47 )
{
struct V_52 * V_53 = F_29 ( V_47 ) ;
struct V_5 * V_6 = V_53 -> V_54 ;
struct V_7 * V_8 = V_6 -> V_9 ;
...
{
struct V_51 * V_47 = & V_41 -> V_47 ;
struct V_7 * V_8 ;
struct V_5 * V_6 ;
struct V_43 * V_44 ;
int V_55 ;
V_8 = F_34 ( V_47 , sizeof( * V_8 ) , V_56 ) ;
if ( ! V_8 )
return - V_57 ;
V_8 -> V_47 = V_47 ;
...
if ( F_20 ( V_8 -> V_14 ) )
return F_35 ( V_8 -> V_14 ) ;
if ( F_36 ( V_47 -> V_58 , L_5 ) ) {
V_8 -> V_30 |= V_59 ;
V_8 -> V_30 |= V_31 ;
}
F_27 ( V_8 ) ;
...
{
struct V_52 * V_53 = F_29 ( & V_41 -> V_47 ) ;
struct V_5 * V_6 = V_53 -> V_54 ;
struct V_7 * V_8 = V_6 -> V_9 ;
int V_55 ;
V_55 = F_41 ( V_41 ) ;
