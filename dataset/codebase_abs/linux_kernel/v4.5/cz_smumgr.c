...
struct V_47 V_48 = { 0 } ;
V_21 -> V_156 = 0 ;
for ( V_39 = 0 ; V_39 < sizeof( V_168 ) / sizeof( * V_168 ) ; V_39 ++ ) {
V_166 = F_22 ( V_2 ,
V_168 [ V_39 ] ) ;
V_167 = F_23 ( V_166 ) ;
V_46 = F_16 ( V_2 -> V_3 ,
...
static int F_37 ( struct V_1 * V_2 , void * * V_177 )
{
struct V_20 * V_21 = (struct V_20 * ) V_2 -> V_22 ;
unsigned long V_39 ;
for ( V_39 = 0 ; V_39 < V_21 -> V_142 ; V_39 ++ ) {
...
F_40 ( V_184 , 32 ) +
F_40 ( V_185 , 32 ) +
F_40 ( sizeof( struct V_186 ) , 32 ) +
F_40 ( sizeof( struct V_178 ) , 32 ) ;
V_46 = F_41 ( V_2 -> V_3 ,
V_21 -> V_29 . V_149 ,
V_187 ,
V_188 ,
...
{
struct V_20 * V_21 ;
V_21 = F_46 ( sizeof( struct V_20 ) , V_190 ) ;
if ( V_21 == NULL )
return - V_191 ;
V_2 -> V_22 = V_21 ;
V_2 -> V_192 = & V_193 ;
