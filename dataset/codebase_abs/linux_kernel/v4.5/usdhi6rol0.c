...
V_2 -> V_36 = V_155 ;
V_2 -> V_184 = F_94 ( 4000 ) ;
V_239 = F_102 ( V_237 , V_247 , 0 ) ;
V_2 -> V_5 = F_103 ( V_80 , V_239 ) ;
if ( F_58 ( V_2 -> V_5 ) ) {
V_91 = F_104 ( V_2 -> V_5 ) ;
goto V_246;
}
V_2 -> V_248 = F_105 ( V_80 , NULL ) ;
if ( F_58 ( V_2 -> V_248 ) ) {
V_91 = F_104 ( V_2 -> V_248 ) ;
goto V_246;
}
V_2 -> V_126 = F_106 ( V_2 -> V_248 ) ;
V_91 = F_107 ( V_2 -> V_248 ) ;
if ( V_91 < 0 )
goto V_246;
V_243 = F_7 ( V_2 , V_249 ) ;
...
V_6 -> V_262 = 32 ;
V_6 -> V_263 = 512 ;
V_6 -> V_264 = V_265 * V_6 -> V_262 ;
V_6 -> V_266 = V_6 -> V_264 / V_6 -> V_263 ;
V_6 -> V_267 = V_6 -> V_264 ;
if ( ! V_6 -> V_268 )
V_6 -> V_268 = V_2 -> V_126 ;
V_6 -> V_269 = V_2 -> V_126 / 512 ;
F_112 ( V_237 , V_2 ) ;
V_91 = F_113 ( V_6 ) ;
if ( V_91 < 0 )
goto V_250;
