...
static int F_98 ( struct V_119 * V_120 , unsigned V_18 )
{
struct V_117 * V_173 = F_64 ( V_120 ) ;
void T_1 * V_49 = V_173 -> V_42 ;
unsigned V_50 = 1 << V_18 ;
...
static void F_100 ( struct V_119 * V_120 , unsigned V_18 ,
int V_147 )
{
struct V_117 * V_173 = F_64 ( V_120 ) ;
void T_1 * V_49 = V_173 -> V_42 ;
...
static void F_101 ( struct V_119 * V_120 ,
unsigned long * V_50 , unsigned long * V_180 )
{
struct V_117 * V_173 = F_64 ( V_120 ) ;
void T_1 * V_49 = V_173 -> V_42 ;
#define F_102 ( V_180 ) (((bits) == 32) ? ~0U : (BIT(bits) - 1))
T_3 V_181 = ( * V_50 & * V_180 ) & F_102 ( V_120 -> V_182 ) ;
T_3 V_183 = ( * V_50 & ~ ( * V_180 ) ) & F_102 ( V_120 -> V_182 ) ;
...
static void F_104 ( struct V_16 * V_17 , struct V_119 * V_120 )
{
enum V_64 V_184 ;
int V_6 ;
struct V_117 * V_173 = F_64 ( V_120 ) ;
...
{
struct V_117 * V_173 = F_107 ( V_189 ) ;
void T_1 * V_49 = V_173 -> V_42 ;
...
static int F_109 ( struct V_188 * V_189 , unsigned type )
{
switch ( type ) {
case V_192 :
case V_193 :
...
case V_192 :
default:
F_112 ( L_51 , F_113 ( V_189 -> V_205 ) ) ;
return - V_15 ;
}
F_25 ( V_50 , V_49 + V_206 ) ;
return 0 ;
}
static void F_114 ( struct V_188 * V_189 )
{
}
static int F_115 ( struct V_188 * V_189 , unsigned V_207 )
{
struct V_117 * V_173 = F_107 ( V_189 ) ;
...
V_49 = V_41 [ V_6 ] -> V_42 ;
if ( ! V_210 [ V_6 ] )
F_122 ( V_41 [ V_6 ] -> clock ) ;
F_25 ( V_210 [ V_6 ] , V_49 + V_51 ) ;
F_25 ( V_212 [ V_6 ] , V_49 + V_191 ) ;
}
}
static void F_123 ( struct V_215 * V_216 )
{
struct V_217 * V_120 = F_124 ( V_216 ) ;
struct V_119 * V_119 = F_125 ( V_216 ) ;
...
struct V_188 * V_189 = F_132 ( V_173 -> V_211 ) ;
int V_101 , V_6 ;
V_173 -> V_225 = F_133 ( V_189 ) ;
V_226 . V_227 = V_173 -> V_104 -> V_228 ;
F_25 ( ~ 0 , V_173 -> V_42 + V_51 ) ;
V_101 = F_134 ( & V_173 -> V_120 ,
& V_226 ,
0 ,
V_229 ,
V_193 ) ;
...
int V_101 = 0 ;
int V_205 , V_6 ;
int V_232 = F_138 ( V_20 , L_54 ) ;
T_3 V_182 ;
char * * V_233 ;
F_139 ( V_232 >= F_140 ( V_41 ) ) ;
if ( V_41 [ V_232 ] ) {
V_101 = - V_234 ;
goto V_235;
}
...
V_231 = F_142 ( V_160 , V_236 , 0 ) ;
V_118 -> V_42 = F_143 ( & V_160 -> V_9 , V_231 ) ;
if ( F_90 ( V_118 -> V_42 ) ) {
...
V_118 -> V_211 = V_205 ;
V_118 -> V_208 = V_232 ;
V_118 -> clock = F_144 ( & V_160 -> V_9 , NULL ) ;
if ( F_90 ( V_118 -> clock ) ) {
F_11 ( & V_160 -> V_9 , L_55 ) ;
V_101 = F_91 ( V_118 -> clock ) ;
goto V_235;
}
V_101 = F_145 ( V_118 -> clock ) ;
if ( V_101 )
goto V_238;
...
V_115 -> V_121 = V_120 ;
V_101 = F_149 ( V_120 , V_118 ) ;
if ( V_101 )
goto V_244;
V_41 [ V_232 ] = V_118 ;
V_92 = F_150 ( V_92 , V_232 + 1 ) ;
V_101 = F_131 ( V_160 , V_118 ) ;
if ( V_101 )
goto V_245;
...
{
return F_155 ( V_246 , F_140 ( V_246 ) ) ;
}
static void T_6 F_156 ( void )
{
F_157 ( V_246 , F_140 ( V_246 ) ) ;
}
