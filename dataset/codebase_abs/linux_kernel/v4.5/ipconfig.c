...
unsigned int V_113 ;
#ifdef F_99
F_100 ( L_49 , V_212 , V_49 . V_213 , & V_214 ) ;
#endif
if ( ! V_215 )
return 0 ;
F_12 ( L_50 ) ;
...
#ifdef F_104
else if ( ! strncmp ( V_6 , L_65 , 4 ) ) {
char * V_220 ;
V_22 &= ~ V_21 ;
V_220 = strstr ( V_6 , L_66 ) ;
if ( V_220 ) {
char * V_200 ;
V_220 = V_220 + 5 ;
V_200 = strchr ( V_220 , ',' ) ;
...
static int T_1 F_108 ( char * V_221 )
{
...
* V_207 ++ = '\0' ;
if ( strlen ( V_222 ) > 0 ) {
F_12 ( L_71 , V_224 , V_222 ) ;
switch ( V_224 ) {
case 0 :
if ( ( V_58 = F_94 ( V_222 ) ) == V_226 )
V_58 = V_68 ;
break;
case 1 :
if ( ( V_80 = F_94 ( V_222 ) ) == V_226 )
V_80 = V_68 ;
break;
case 2 :
if ( ( V_67 = F_94 ( V_222 ) ) == V_226 )
V_67 = V_68 ;
break;
case 3 :
if ( ( V_60 = F_94 ( V_222 ) ) == V_226 )
V_60 = V_68 ;
break;
case 4 :
if ( ( V_223 = strchr ( V_222 , '.' ) ) ) {
* V_223 ++ = '\0' ;
F_109 ( F_61 () -> V_168 , V_223 ,
sizeof( F_61 () -> V_168 ) ) ;
}
F_109 ( F_61 () -> V_78 , V_222 ,
sizeof( F_61 () -> V_78 ) ) ;
V_77 = 1 ;
break;
case 5 :
F_109 ( V_5 , V_222 , sizeof( V_5 ) ) ;
break;
case 6 :
if ( F_103 ( V_222 ) == 0 &&
V_58 == V_68 ) {
...
static int T_1 F_110 ( char * V_221 )
{
return F_108 ( V_221 ) ;
}
static int T_1 F_111 ( char * V_221 )
{
if ( F_109 ( V_124 , V_221 ,
sizeof( V_124 ) )
>= sizeof( V_124 ) )
F_8 ( L_72 ,
V_124 ) ;
