...
V_175 [ 1 ] = V_193 [ 1 ] ;
V_2 -> V_198 = F_57 ( & V_7 -> V_8 , V_177 *
sizeof( * V_2 -> V_198 ) , V_157 ) ;
V_2 -> V_163 = F_57 ( & V_7 -> V_8 , V_177 *
sizeof( * V_2 -> V_163 ) , V_157 ) ;
V_2 -> V_199 . V_200 = V_177 ;
V_2 -> V_199 . V_201 = F_57 ( & V_7 -> V_8 ,
V_177 * sizeof( * V_2 -> V_199 . V_201 ) , V_157 ) ;
if ( F_73 ( ! V_2 -> V_198 || ! V_2 -> V_163 ||
! V_2 -> V_199 . V_201 ) ) {
V_5 = - V_158 ;
goto V_189;
}
for ( V_178 = 0 ; V_178 < V_177 ; V_178 ++ ) {
V_2 -> V_198 [ V_178 ] . V_12 = V_178 ;
V_2 -> V_198 [ V_178 ] . V_2 = V_2 ;
V_2 -> V_198 [ V_178 ] . V_28 . V_173 = & V_173 ;
memset ( & V_173 , 0 , sizeof( V_173 ) ) ;
V_173 . V_160 = V_202 [ V_178 ] ;
V_173 . V_185 = & V_203 ;
V_173 . V_187 = 0 ;
...
V_173 . V_175 = V_175 ;
V_173 . V_176 = 2 ;
V_174 = F_72 ( & V_7 -> V_8 , & V_2 -> V_198 [ V_178 ] . V_28 ) ;
if ( F_68 ( V_174 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_173 . V_160 ) ;
V_5 = F_67 ( V_174 ) ;
