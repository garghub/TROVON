...
V_24 [ V_12 ] . V_22 = F_9 ( V_14 [ 3 ] | ( V_14 [ 4 ] << 8 ) ) ;
break;
}
V_12 ++ ;
} while ( 1 );
...
V_26 [ V_12 ] . V_22 = F_7 ( V_14 [ 3 ] | ( V_14 [ 4 ] << 8 ) | ( V_14 [ 5 ] << 16 ) | ( V_14 [ 6 ] << 24 ) ) ;
break;
}
V_12 ++ ;
} while ( 1 );
...
int F_14 ( struct V_41 * V_41 , T_1 * V_1 , int V_10 ,
struct V_42 * V_43 )
{
int V_36 = 1 ;
T_1 V_44 ;
...
break;
case 'I' :
V_43 -> type = F_10 ( V_1 , V_10 ) ;
V_43 -> V_47 = V_45 ;
F_8 ( V_48 , L_8 ) ;
F_15 ( V_41 , V_1 - 4 , V_10 + 4 ) ;
break;
case 'N' :
F_16 ( V_41 , V_1 - 4 , V_10 + 4 ) ;
V_43 -> type = 0 ;
break;
case 'S' :
F_8 ( V_48 , L_9 ) ;
F_17 ( V_41 , V_1 - 4 , V_10 + 4 ) ;
break;
default:
F_8 ( V_48 , L_10 ,
