...
static int F_44 ( struct V_92 * V_19 ,
T_2 V_96 )
{
struct V_17 * V_18 = V_19 -> V_20 ;
void T_1 * V_23 ;
int V_97 ;
if ( ! F_4 ( V_18 -> V_56 + V_98 ) ) {
for ( V_97 = 0 ; V_97 < V_19 -> V_99 ; V_97 ++ ) {
if ( V_96 & ( 1 << V_97 ) )
continue;
V_23 = F_13 ( V_19 -> V_100 [ V_97 ] ) ;
if ( F_4 ( V_23 + V_101 ) )
V_96 |= ( 1 << V_97 ) ;
}
}
return F_45 ( V_19 , V_96 ) ;
}
static T_5 F_46 ( int V_102 , void * V_103 )
{
struct V_92 * V_19 = V_103 ;
struct V_17 * V_18 ;
unsigned int V_34 = 0 ;
void T_1 * V_56 ;
T_2 V_104 , V_96 ;
...
F_4 ( V_18 -> V_56 + V_98 ) ;
F_3 ( 0 , V_2 -> V_109 + V_110 ) ;
V_11 = F_4 ( V_2 -> V_109 + V_110 ) ;
F_2 ( V_2 -> V_3 , L_7 ,
V_110 , V_11 ) ;
F_3 ( 0x0 , V_2 -> V_109 + V_111 ) ;
F_4 ( V_2 -> V_109 + V_111 ) ;
F_3 ( 0x0 , V_2 -> V_112 + V_113 ) ;
F_4 ( V_2 -> V_112 + V_113 ) ;
F_3 ( 0xffffffff , V_2 -> V_109 + V_114 ) ;
F_3 ( 0xffffffff , V_2 -> V_109 + V_115 ) ;
F_3 ( 0xffffffff , V_2 -> V_109 + V_116 ) ;
F_3 ( 0xffffffff , V_2 -> V_109 + V_117 ) ;
V_11 = F_4 ( V_2 -> V_109 + V_118 ) ;
V_11 &= ~ 0x00000002 ;
V_11 &= ~ 0x00000001 ;
F_3 ( V_11 , V_2 -> V_109 + V_118 ) ;
V_11 = F_4 ( V_2 -> V_109 + V_119 ) ;
V_11 |= ( 1 << 3 ) ;
V_11 |= ( 1 << 9 ) ;
F_3 ( V_11 , V_2 -> V_109 + V_119 ) ;
V_11 = F_4 ( V_2 -> V_109 + V_119 ) ;
F_2 ( V_2 -> V_3 , L_8 ,
V_119 , V_11 ) ;
return V_34 ;
...
if ( ! V_2 -> V_120 )
return 0 ;
V_11 = F_4 ( V_2 -> V_120 + V_121 ) ;
V_11 &= ~ V_122 ;
F_3 ( V_11 , V_2 -> V_120 + V_121 ) ;
V_11 = F_4 ( V_2 -> V_120 + V_121 ) ;
return V_11 & V_122 ? - 1 : 0 ;
}
static int F_53 ( struct V_123 * V_124 )
{
struct V_74 * V_3 = & V_124 -> V_3 ;
struct V_17 * V_18 ;
struct V_1 * V_2 ;
struct V_125 * V_126 ;
...
if ( F_55 ( V_18 ) )
return F_56 ( V_18 ) ;
V_2 = F_57 ( V_3 , sizeof( * V_2 ) , V_136 ) ;
if ( ! V_2 )
return - V_137 ;
V_18 -> V_33 = V_2 ;
V_2 -> V_18 = V_18 ;
V_2 -> V_3 = V_3 ;
V_126 = F_58 ( V_124 , V_138 , 1 ) ;
V_2 -> V_109 = F_59 ( V_3 , V_126 ) ;
if ( F_55 ( V_2 -> V_109 ) )
return F_56 ( V_2 -> V_109 ) ;
V_126 = F_58 ( V_124 , V_138 , 2 ) ;
V_2 -> V_4 = F_59 ( V_3 , V_126 ) ;
if ( F_55 ( V_2 -> V_4 ) )
return F_56 ( V_2 -> V_4 ) ;
V_126 = F_58 ( V_124 , V_138 , 3 ) ;
V_2 -> V_112 = F_59 ( V_3 , V_126 ) ;
if ( F_55 ( V_2 -> V_112 ) )
return F_56 ( V_2 -> V_112 ) ;
V_126 = F_58 ( V_124 , V_138 , 4 ) ;
if ( V_126 ) {
void T_1 * V_139 = F_59 ( V_3 , V_126 ) ;
if ( F_55 ( V_139 ) )
return F_56 ( V_139 ) ;
V_2 -> V_120 = V_139 ;
}
V_128 = F_60 ( V_140 , V_3 ) ;
if ( V_128 ) {
if ( V_128 -> V_141 )
V_130 = (enum V_129 ) V_128 -> V_141 ;
}
#ifdef F_61
else {
...
struct V_144 * V_145 ;
T_6 V_146 ;
V_143 = F_62 ( V_147 , & V_124 -> V_3 ) ;
if ( ! V_143 ) {
F_34 ( & V_124 -> V_3 , L_9 ) ;
V_130 = V_131 ;
} else if ( V_143 -> V_148 ) {
V_130 = (enum V_129 ) V_143 -> V_148 ;
V_146 = F_63 ( F_64 ( & V_124 -> V_3 ) , & V_145 ) ;
if ( F_65 ( V_146 ) ) {
F_34 ( & V_124 -> V_3 , L_10 ,
V_149 ) ;
V_130 = V_131 ;
...
V_34 = F_70 ( V_124 , V_18 , V_133 [ V_130 - 1 ] ,
& V_159 ) ;
if ( V_34 )
goto V_154;
F_2 ( V_3 , L_14 ) ;
