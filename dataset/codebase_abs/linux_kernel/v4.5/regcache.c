...
void * V_8 ;
if ( V_2 -> V_28 == V_29 ) {
if ( V_27 -> V_14 || V_27 -> V_9 )
F_4 ( V_2 -> V_19 ,
L_2 ) ;
V_2 -> V_12 = true ;
return 0 ;
}
if ( V_27 -> V_14 && ! V_27 -> V_13 ) {
F_10 ( V_2 -> V_19 ,
L_3 ) ;
return - V_10 ;
}
...
V_45 = V_2 -> V_12 ;
V_37 = V_2 -> V_34 -> V_37 ;
F_14 ( V_2 -> V_19 , L_13 , V_37 , V_43 , V_44 ) ;
F_26 ( V_2 , V_37 , L_14 ) ;
if ( ! V_2 -> V_48 )
goto V_49;
V_2 -> V_50 = true ;
...
return - V_10 ;
if ( V_2 -> V_60 . V_62 )
return V_2 -> V_60 . V_62 ( F_40 ( V_2 , V_58 ,
V_59 ) ) ;
switch ( V_2 -> V_31 ) {
case 1 : {
const T_1 * V_33 = V_58 ;
...
static int F_41 ( const void * V_63 , const void * V_64 )
{
...
sizeof( struct V_15 ) , F_41 ) ;
if ( V_68 )
return V_68 - V_2 -> V_14 ;
else
return - V_69 ;
}
static bool F_42 ( unsigned long * V_70 , unsigned int V_59 )
{
if ( ! V_70 )
return true ;
return F_43 ( V_59 , V_70 ) ;
}
static int F_44 ( struct V_1 * V_2 , void * V_71 ,
unsigned long * V_70 ,
unsigned int V_72 ,
...
static int F_45 ( struct V_1 * V_2 , const void * * V_76 ,
unsigned int V_58 , unsigned int V_77 )
{
T_5 V_78 = V_2 -> V_60 . V_78 ;
int V_5 , V_6 ;
if ( * V_76 == NULL )
return 0 ;
...
V_2 -> V_12 = true ;
V_5 = F_46 ( V_2 , V_58 , * V_76 , V_6 * V_78 ) ;
if ( V_5 )
F_10 ( V_2 -> V_19 , L_17 ,
...
static int F_47 ( struct V_1 * V_2 , void * V_71 ,
unsigned long * V_70 ,
...
if ( ! V_76 ) {
V_76 = F_40 ( V_2 , V_71 , V_3 ) ;
V_58 = V_75 ;
}
}
return F_45 ( V_2 , & V_76 , V_58 , V_75 +
V_2 -> V_11 ) ;
}
int F_48 ( struct V_1 * V_2 , void * V_71 ,
unsigned long * V_70 ,
unsigned int V_72 , unsigned int V_73 ,
unsigned int V_74 )
{
if ( F_49 ( V_2 ) && ! V_2 -> V_79 )
return F_47 ( V_2 , V_71 , V_70 ,
V_72 , V_73 , V_74 ) ;
else
return F_44 ( V_2 , V_71 , V_70 ,
V_72 , V_73 , V_74 ) ;
}
