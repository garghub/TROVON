...
struct V_2 * V_5 ;
int V_38 = - V_39 ;
V_5 = F_46 ( sizeof( * V_5 ) , V_40 ) ;
if ( ! V_5 )
goto V_41;
V_5 -> V_29 = F_47 ( V_42 ,
sizeof( V_5 -> V_29 [ 0 ] ) , V_40 ) ;
if ( ! V_5 -> V_29 )
goto V_43;
V_5 -> V_22 = F_48 () ;
if ( V_5 -> V_22 == 0 )
...
struct V_19 * F_58 ( struct V_56 * V_24 ,
struct V_2 * V_12 )
{
struct V_19 * V_20 = NULL ;
F_41 (pdd, &p->per_device_data, per_device_list)
...
struct V_19 * F_59 ( struct V_56 * V_24 ,
struct V_2 * V_12 )
{
struct V_19 * V_20 = NULL ;
V_20 = F_46 ( sizeof( * V_20 ) , V_40 ) ;
if ( V_20 != NULL ) {
V_20 -> V_24 = V_24 ;
F_52 ( & V_20 -> V_57 . V_58 ) ;
F_52 ( & V_20 -> V_57 . V_59 ) ;
V_20 -> V_57 . V_60 = V_24 -> V_60 ;
V_20 -> V_26 = false ;
F_60 ( & V_20 -> V_28 , & V_12 -> V_52 ) ;
}
return V_20 ;
}
struct V_19 * F_61 ( struct V_56 * V_24 ,
struct V_2 * V_12 )
{
struct V_19 * V_20 ;
int V_38 ;
...
if ( V_20 -> V_61 )
return V_20 ;
V_38 = F_63 ( V_24 -> V_27 , V_12 -> V_22 , V_12 -> V_50 ) ;
if ( V_38 < 0 )
return F_8 ( V_38 ) ;
V_20 -> V_61 = true ;
return V_20 ;
}
void F_64 ( struct V_56 * V_24 , unsigned int V_22 )
{
struct V_2 * V_12 ;
struct V_19 * V_20 ;
int V_13 , V_62 ;
F_7 ( V_24 == NULL ) ;
V_13 = F_19 ( & V_14 ) ;
F_65 (kfd_processes_table, i, p, kfd_processes)
if ( V_12 -> V_22 == V_22 )
break;
F_20 ( & V_14 , V_13 ) ;
F_7 ( V_12 -> V_22 != V_22 ) ;
F_10 ( & V_12 -> V_23 ) ;
if ( ( V_24 -> V_63 ) && ( V_24 -> V_63 -> V_22 == V_12 -> V_22 ) )
F_66 ( V_24 -> V_63 ) ;
F_40 ( & V_12 -> V_37 ) ;
V_20 = F_58 ( V_24 , V_12 ) ;
if ( ! V_20 ) {
...
struct V_19 * V_20 )
{
if ( F_70 ( & V_20 -> V_28 , & V_12 -> V_52 ) )
return NULL ;
return F_71 ( V_20 , V_28 ) ;
}
bool F_72 ( struct V_2 * V_12 )
{
return ! ( F_73 ( & V_12 -> V_52 ) ) ;
}
...
unsigned int V_21 ;
int V_13 = F_19 ( & V_14 ) ;
F_65 (kfd_processes_table, temp, p, kfd_processes) {
if ( V_12 -> V_22 == V_22 ) {
F_10 ( & V_12 -> V_23 ) ;
break;
}
