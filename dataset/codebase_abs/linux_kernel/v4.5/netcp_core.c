...
V_205 . V_206 = V_207 ;
V_205 . V_208 . V_209 . V_210 = false ;
V_205 . V_208 . V_209 . V_211 = false ;
V_205 . V_208 . V_209 . V_212 = V_213 ;
V_175 -> V_203 = F_127 ( V_36 ,
V_175 -> V_214 , & V_205 ) ;
if ( F_76 ( V_175 -> V_203 ) ) {
F_20 ( V_36 , L_35 ,
V_175 -> V_214 ) ;
...
snprintf ( V_26 , sizeof( V_26 ) , L_36 , F_128 ( V_36 ) ) ;
V_175 -> V_193 = F_129 ( V_26 , V_175 -> V_216 ,
V_217 ) ;
if ( F_130 ( V_175 -> V_193 ) ) {
F_20 ( V_36 , L_37 ,
V_26 , V_29 ) ;
V_29 = F_131 ( V_175 -> V_193 ) ;
goto V_215;
}
F_31 ( V_36 , L_38 , V_26 ) ;
return 0 ;
...
int F_132 ( struct V_174 * V_175 ,
struct V_32 * V_32 ,
const char * V_214 , unsigned int V_216 )
{
...
static struct V_218 * F_133 ( struct V_27 * V_28 ,
const T_8 * V_219 ,
enum V_220 type )
{
struct V_218 * V_221 ;
...
if ( V_221 -> type != type )
continue;
if ( V_219 && memcmp ( V_219 , V_221 -> V_219 , V_222 ) )
continue;
return V_221 ;
}
return NULL ;
}
static struct V_218 * F_134 ( struct V_27 * V_28 ,
const T_8 * V_219 ,
enum V_220 type )
{
struct V_218 * V_221 ;
V_221 = F_135 ( V_28 -> V_36 , sizeof( * V_221 ) , V_135 ) ;
if ( ! V_221 )
return NULL ;
V_221 -> type = type ;
V_221 -> V_80 = 0 ;
V_221 -> V_28 = V_28 ;
if ( V_219 )
F_136 ( V_221 -> V_219 , V_219 ) ;
else
F_137 ( V_221 -> V_219 ) ;
F_25 ( & V_221 -> V_25 , & V_28 -> V_223 ) ;
return V_221 ;
}
static void F_138 ( struct V_27 * V_28 , struct V_218 * V_221 )
{
F_26 ( & V_221 -> V_25 ) ;
F_27 ( V_28 -> V_36 , V_221 ) ;
}
...
static void F_140 ( struct V_27 * V_28 , const T_8 * V_219 ,
enum V_220 type )
{
struct V_218 * V_221 ;
V_221 = F_133 ( V_28 , V_219 , type ) ;
if ( V_221 ) {
V_221 -> V_80 |= V_224 ;
return;
}
V_221 = F_134 ( V_28 , V_219 , type ) ;
if ( ! F_117 ( ! V_221 ) )
V_221 -> V_80 |= V_225 ;
}
static void F_141 ( struct V_27 * V_28 )
{
struct V_218 * V_221 , * V_43 ;
struct V_54 * V_226 ;
struct V_33 * V_34 ;
int error ;
F_38 (naddr, tmp, &netcp->addr_list, node) {
if ( V_221 -> V_80 & ( V_224 | V_225 ) )
continue;
F_31 ( V_28 -> V_94 , L_39 ,
V_221 -> V_219 , V_221 -> type ) ;
F_142 (netcp, priv) {
V_34 = V_226 -> V_33 ;
if ( ! V_34 -> V_227 )
continue;
error = V_34 -> V_227 ( V_226 -> V_51 ,
V_221 ) ;
F_117 ( error ) ;
}
F_138 ( V_28 , V_221 ) ;
...
if ( ! V_34 -> V_228 )
continue;
error = V_34 -> V_228 ( V_226 -> V_51 , V_221 ) ;
F_117 ( error ) ;
}
}
}
static void F_144 ( struct V_194 * V_30 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
struct V_229 * V_230 ;
bool V_231 ;
V_231 = ( V_30 -> V_80 & V_232 ||
V_30 -> V_80 & V_233 ||
F_145 ( V_30 ) > V_234 ) ;
F_146 ( & V_28 -> V_81 ) ;
F_139 ( V_28 ) ;
F_140 ( V_28 , V_30 -> V_235 , V_236 ) ;
F_147 (ndev, ndev_addr)
F_140 ( V_28 , V_230 -> V_219 , V_237 ) ;
F_148 (ndev_addr, ndev)
F_140 ( V_28 , V_230 -> V_219 , V_238 ) ;
F_149 (ndev_addr, ndev)
F_140 ( V_28 , V_230 -> V_219 , V_239 ) ;
if ( V_231 )
F_140 ( V_28 , NULL , V_240 ) ;
F_141 ( V_28 ) ;
F_143 ( V_28 ) ;
F_150 ( & V_28 -> V_81 ) ;
}
static void F_151 ( struct V_27 * V_28 )
{
int V_13 ;
if ( V_28 -> V_241 ) {
F_125 ( V_28 -> V_241 ) ;
...
static int F_153 ( struct V_194 * V_30 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
struct V_242 V_243 ;
struct V_204 V_205 ;
...
V_28 -> V_93 = F_154 ( V_26 , V_28 -> V_128 ,
V_28 -> V_245 ) ;
if ( F_76 ( V_28 -> V_93 ) ) {
F_20 ( V_28 -> V_94 , L_42 ) ;
V_29 = F_131 ( V_28 -> V_93 ) ;
goto V_67;
}
snprintf ( V_26 , sizeof( V_26 ) , L_43 , V_30 -> V_26 ) ;
V_28 -> V_153 = F_154 ( V_26 , V_28 -> V_246 ,
V_28 -> V_247 ) ;
if ( F_76 ( V_28 -> V_153 ) ) {
F_20 ( V_28 -> V_94 , L_44 ) ;
V_29 = F_131 ( V_28 -> V_153 ) ;
goto V_67;
}
snprintf ( V_26 , sizeof( V_26 ) , L_45 , V_30 -> V_26 ) ;
V_28 -> V_155 = F_129 ( V_26 , V_28 -> V_172 , 0 ) ;
if ( F_76 ( V_28 -> V_155 ) ) {
V_29 = F_131 ( V_28 -> V_155 ) ;
goto V_67;
}
V_28 -> V_172 = F_155 ( V_28 -> V_155 ) ;
V_243 . V_248 = F_108 ;
V_243 . V_249 = V_28 ;
V_29 = F_156 ( V_28 -> V_155 ,
V_250 ,
( unsigned long ) & V_243 ) ;
if ( V_29 )
goto V_67;
...
V_28 -> V_98 = F_129 ( V_26 , V_28 -> V_142 , 0 ) ;
if ( F_76 ( V_28 -> V_98 ) ) {
V_29 = F_131 ( V_28 -> V_98 ) ;
goto V_67;
}
V_28 -> V_142 = F_155 ( V_28 -> V_98 ) ;
V_243 . V_248 = F_98 ;
V_243 . V_249 = V_28 ;
V_29 = F_156 ( V_28 -> V_98 ,
V_250 ,
( unsigned long ) & V_243 ) ;
if ( V_29 )
goto V_67;
...
V_28 -> V_126 [ V_13 ] = F_129 ( V_26 , V_251 , 0 ) ;
if ( F_76 ( V_28 -> V_126 [ V_13 ] ) ) {
V_29 = F_131 ( V_28 -> V_126 [ V_13 ] ) ;
goto V_67;
}
}
memset ( & V_205 , 0 , sizeof( V_205 ) ) ;
V_205 . V_206 = V_252 ;
V_205 . V_208 . V_253 . V_254 = true ;
V_205 . V_208 . V_253 . V_255 = true ;
V_205 . V_208 . V_253 . V_256 = V_257 ;
V_205 . V_208 . V_253 . V_258 = V_259 ;
V_205 . V_208 . V_253 . V_260 = false ;
V_205 . V_208 . V_253 . V_261 = V_115 ;
V_205 . V_208 . V_253 . V_262 = V_28 -> V_142 ;
V_205 . V_208 . V_253 . V_263 = V_264 ;
for ( V_13 = 0 ; V_13 < V_127 ; ++ V_13 ) {
if ( V_28 -> V_126 [ V_13 ] )
V_244 = F_155 ( V_28 -> V_126 [ V_13 ] ) ;
V_205 . V_208 . V_253 . V_125 [ V_13 ] = V_244 ;
}
V_28 -> V_241 = F_127 ( V_28 -> V_32 -> V_35 ,
V_28 -> V_214 , & V_205 ) ;
if ( F_76 ( V_28 -> V_241 ) ) {
F_20 ( V_28 -> V_94 , L_48 ,
V_28 -> V_214 ) ;
...
F_31 ( V_28 -> V_94 , L_49 , V_28 -> V_241 ) ;
return 0 ;
V_67:
F_151 ( V_28 ) ;
return V_29 ;
}
static int F_157 ( struct V_194 * V_30 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
struct V_54 * V_55 ;
struct V_33 * V_34 ;
...
F_142 (netcp, intf_modpriv) {
V_34 = V_55 -> V_33 ;
if ( V_34 -> V_265 ) {
V_29 = V_34 -> V_265 ( V_55 -> V_51 , V_30 ) ;
if ( V_29 != 0 ) {
F_20 ( V_28 -> V_94 , L_51 ) ;
goto V_266;
}
...
V_34 = V_55 -> V_33 ;
if ( V_34 -> V_267 )
V_34 -> V_267 ( V_55 -> V_51 , V_30 ) ;
}
V_67:
F_151 ( V_28 ) ;
return V_29 ;
}
static int F_161 ( struct V_194 * V_30 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
struct V_54 * V_55 ;
struct V_33 * V_34 ;
...
V_34 = V_55 -> V_33 ;
if ( V_34 -> V_267 ) {
V_215 = V_34 -> V_267 ( V_55 -> V_51 , V_30 ) ;
if ( V_215 != 0 )
F_20 ( V_28 -> V_94 , L_53 ) ;
}
}
F_58 ( V_28 ) ;
F_102 ( V_28 , V_28 -> V_246 ) ;
if ( F_77 ( V_28 -> V_153 ) != V_28 -> V_246 )
F_20 ( V_28 -> V_94 , L_54 ,
V_28 -> V_246 - F_77 ( V_28 -> V_153 ) ) ;
F_151 ( V_28 ) ;
F_31 ( V_28 -> V_94 , L_55 , V_30 -> V_26 ) ;
return 0 ;
}
static int F_164 ( struct V_194 * V_30 ,
struct V_268 * V_269 , int V_270 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
struct V_54 * V_55 ;
struct V_33 * V_34 ;
int V_29 = - 1 , V_215 = - V_271 ;
if ( ! F_104 ( V_30 ) )
return - V_62 ;
F_142 (netcp, intf_modpriv) {
V_34 = V_55 -> V_33 ;
if ( ! V_34 -> V_272 )
continue;
V_215 = V_34 -> V_272 ( V_55 -> V_51 , V_269 , V_270 ) ;
if ( ( V_215 < 0 ) && ( V_215 != - V_271 ) ) {
V_29 = V_215 ;
goto V_185;
}
if ( V_215 == 0 )
...
V_185:
return ( V_29 == 0 ) ? 0 : V_215 ;
}
static int F_165 ( struct V_194 * V_30 , int V_273 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
if ( ( V_273 < 68 ) ||
( V_273 > ( V_274 - V_275 - V_119 ) ) ) {
F_20 ( V_28 -> V_94 , L_56 , V_273 ) ;
return - V_62 ;
}
V_30 -> V_276 = V_273 ;
return 0 ;
}
static void F_166 ( struct V_194 * V_30 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
unsigned int V_277 = F_77 ( V_28 -> V_153 ) ;
F_20 ( V_28 -> V_94 , L_57 , V_277 ) ;
F_102 ( V_28 , V_28 -> V_246 ) ;
V_30 -> V_200 = V_201 ;
F_160 ( V_30 ) ;
}
static int F_167 ( struct V_194 * V_30 , T_9 V_278 , T_6 V_279 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
struct V_54 * V_55 ;
struct V_33 * V_34 ;
unsigned long V_80 ;
int V_215 = 0 ;
F_31 ( V_28 -> V_94 , L_58 , V_279 ) ;
F_41 ( & V_28 -> V_81 , V_80 ) ;
F_142 (netcp, intf_modpriv) {
V_34 = V_55 -> V_33 ;
if ( ( V_34 -> V_280 ) && ( V_279 != 0 ) ) {
V_215 = V_34 -> V_280 ( V_55 -> V_51 , V_279 ) ;
if ( V_215 != 0 ) {
F_20 ( V_28 -> V_94 , L_59 ,
V_279 ) ;
break;
...
static int F_168 ( struct V_194 * V_30 , T_9 V_278 , T_6 V_279 )
{
struct V_27 * V_28 = F_121 ( V_30 ) ;
struct V_54 * V_55 ;
struct V_33 * V_34 ;
unsigned long V_80 ;
int V_215 = 0 ;
F_31 ( V_28 -> V_94 , L_60 , V_279 ) ;
F_41 ( & V_28 -> V_81 , V_80 ) ;
F_142 (netcp, intf_modpriv) {
V_34 = V_55 -> V_33 ;
if ( V_34 -> V_281 ) {
V_215 = V_34 -> V_281 ( V_55 -> V_51 , V_279 ) ;
if ( V_215 != 0 ) {
F_20 ( V_28 -> V_94 , L_61 ,
V_279 ) ;
break;
...
static T_6 F_169 ( struct V_194 * V_36 , struct V_110 * V_111 ,
void * V_282 ,
T_10 V_283 )
{
return 0 ;
}
static int F_170 ( struct V_194 * V_36 , T_8 V_284 )
{
int V_13 ;
F_171 () ;
if ( ( V_36 -> V_285 <= 1 ) ||
...
V_28 -> V_30 = V_30 ;
V_28 -> V_94 = & V_30 -> V_36 ;
V_28 -> V_300 = F_179 ( V_301 , V_302 ) ;
V_28 -> V_202 = V_303 ;
V_28 -> V_157 = V_28 -> V_202 ;
V_28 -> V_56 = V_56 ;
V_29 = F_180 ( V_56 , L_63 , & V_19 ) ;
if ( V_19 ) {
if ( F_181 ( V_25 , V_304 , & V_288 ) ) {
F_20 ( V_36 , L_64 ) ;
V_29 = - V_61 ;
goto V_305;
}
V_286 = F_182 ( & V_288 ) ;
if ( ! F_183 ( V_36 , V_288 . V_306 , V_286 ,
F_128 ( V_36 ) ) ) {
F_20 ( V_36 , L_65 ) ;
V_29 = - V_47 ;
goto V_305;
}
V_289 = F_184 ( V_36 , V_288 . V_306 , V_286 ) ;
if ( ! V_289 ) {
F_20 ( V_36 , L_66 ) ;
F_185 ( V_36 , V_288 . V_306 , V_286 ) ;
V_29 = - V_47 ;
goto V_305;
}
F_12 ( V_291 , V_289 , V_19 ) ;
if ( F_186 ( V_291 ) )
F_136 ( V_30 -> V_307 , V_291 ) ;
else
F_187 ( V_30 -> V_307 ) ;
F_188 ( V_36 , V_289 ) ;
F_185 ( V_36 , V_288 . V_306 , V_286 ) ;
...
V_29 = F_180 ( V_56 , L_69 ,
& V_28 -> V_142 ) ;
if ( V_29 < 0 ) {
F_23 ( V_36 , L_70 ) ;
V_28 -> V_142 = V_308 ;
}
V_29 = F_190 ( V_56 , L_71 ,
V_28 -> V_146 ,
V_127 ) ;
if ( V_29 < 0 ) {
F_20 ( V_36 , L_72 ) ;
...
V_29 = F_180 ( V_56 , L_78 ,
& V_28 -> V_172 ) ;
if ( V_29 < 0 ) {
F_23 ( V_36 , L_79 ) ;
V_28 -> V_172 = V_308 ;
}
F_191 ( V_30 , & V_28 -> V_149 , F_94 , V_309 ) ;
F_192 ( V_30 , & V_28 -> V_161 , F_107 , V_309 ) ;
V_30 -> V_310 = 0 ;
V_30 -> V_311 = V_312 ;
V_30 -> V_313 = & V_314 ;
F_193 ( V_30 , V_36 ) ;
F_25 ( & V_28 -> V_315 , & V_32 -> V_316 ) ;
return 0 ;
V_305:
F_194 ( V_30 ) ;
return V_29 ;
...
static int F_199 ( struct V_317 * V_318 )
{
struct V_24 * V_25 = V_318 -> V_36 . V_39 ;
struct V_27 * V_27 , * V_69 ;
struct V_24 * V_40 , * V_319 ;
struct V_32 * V_32 ;
struct V_35 * V_36 = & V_318 -> V_36 ;
int V_29 ;
if ( ! V_25 ) {
F_20 ( V_36 , L_83 ) ;
return - V_61 ;
...
static int F_205 ( struct V_317 * V_318 )
{
struct V_32 * V_32 = F_206 ( V_318 ) ;
struct V_27 * V_27 , * V_69 ;
...
inst_list) {
V_34 = V_42 -> V_33 ;
F_31 ( & V_318 -> V_36 , L_88 , V_34 -> V_26 ) ;
