...
switch ( V_8 -> V_46 ) {
case V_71 :
if ( F_31 ( V_16 , V_58 , F_38 ( V_85 -> V_110 ) ) ||
F_31 ( V_16 , V_60 , F_38 ( V_85 -> V_111 ) ) ||
F_29 ( V_16 , V_62 , ! V_83 -> V_112 ) )
goto V_89;
case V_72 :
#if F_22 ( V_48 )
if ( V_87 ) {
...
static int F_43 ( struct V_15 * V_16 , struct V_118 * V_119 )
{
...
if ( V_8 == NULL )
goto V_24;
if ( F_15 ( V_16 , F_46 ( V_119 -> V_16 ) . V_77 ,
...
V_125 = F_5 ( V_3 -> V_11 [ V_127 ] ) ;
if ( ! V_3 -> V_11 [ V_128 ] ) {
V_19 = - V_42 ;
goto V_24;
}
V_41 . V_129 = F_21 ( V_3 -> V_11 [ V_128 ] ) ;
if ( V_41 . V_129 >= V_130 ) {
V_19 = - V_42 ;
goto V_24;
}
if ( V_8 -> V_88 > 2 ) {
if ( V_3 -> V_11 [ V_131 ] )
V_41 . V_132 = F_21 ( V_3 -> V_11 [ V_131 ] ) ;
if ( V_3 -> V_11 [ V_133 ] )
V_41 . V_134 = F_20 ( V_3 -> V_11 [ V_133 ] ) ;
V_41 . V_135 = V_136 ;
if ( V_3 -> V_11 [ V_137 ] )
V_41 . V_135 = F_20 ( V_3 -> V_11 [ V_137 ] ) ;
V_41 . V_138 = 4 ;
if ( V_3 -> V_11 [ V_139 ] )
V_41 . V_138 = F_20 ( V_3 -> V_11 [ V_139 ] ) ;
if ( V_3 -> V_11 [ V_140 ] ) {
T_3 V_124 = F_48 ( V_3 -> V_11 [ V_140 ] ) ;
if ( V_124 > 8 ) {
V_19 = - V_42 ;
goto V_24;
}
V_41 . V_141 = V_124 ;
memcpy ( & V_41 . V_142 [ 0 ] , F_3 ( V_3 -> V_11 [ V_140 ] ) , V_124 ) ;
}
if ( V_3 -> V_11 [ V_143 ] ) {
T_3 V_124 = F_48 ( V_3 -> V_11 [ V_143 ] ) ;
if ( V_124 > 8 ) {
V_19 = - V_42 ;
goto V_24;
}
V_41 . V_144 = V_124 ;
memcpy ( & V_41 . V_145 [ 0 ] , F_3 ( V_3 -> V_11 [ V_143 ] ) , V_124 ) ;
}
if ( V_3 -> V_11 [ V_12 ] )
V_41 . V_6 = F_3 ( V_3 -> V_11 [ V_12 ] ) ;
if ( V_3 -> V_11 [ V_146 ] )
V_41 . V_147 = F_21 ( V_3 -> V_11 [ V_146 ] ) ;
}
if ( V_3 -> V_11 [ V_68 ] )
V_41 . V_69 = F_5 ( V_3 -> V_11 [ V_68 ] ) ;
if ( V_3 -> V_11 [ V_148 ] )
V_41 . V_149 = F_20 ( V_3 -> V_11 [ V_148 ] ) ;
if ( V_3 -> V_11 [ V_150 ] )
V_41 . V_151 = F_20 ( V_3 -> V_11 [ V_150 ] ) ;
if ( V_3 -> V_11 [ V_152 ] )
V_41 . V_153 = F_20 ( V_3 -> V_11 [ V_152 ] ) ;
if ( V_3 -> V_11 [ V_154 ] )
V_41 . V_155 = F_49 ( V_3 -> V_11 [ V_154 ] ) ;
if ( V_3 -> V_11 [ V_156 ] )
V_41 . V_157 = F_21 ( V_3 -> V_11 [ V_156 ] ) ;
if ( V_3 -> V_11 [ V_158 ] )
V_41 . V_159 = F_21 ( V_3 -> V_11 [ V_158 ] ) ;
#ifdef F_50
if ( V_160 [ V_41 . V_129 ] == NULL ) {
F_51 () ;
F_52 ( L_1 , V_41 . V_129 ) ;
F_53 () ;
}
...
V_19 = - V_162 ;
if ( V_160 [ V_41 . V_129 ] -> V_161 )
V_19 = ( * V_160 [ V_41 . V_129 ] -> V_161 ) ( V_10 , V_4 ,
V_5 , V_125 , & V_41 ) ;
if ( V_19 >= 0 ) {
V_9 = F_7 ( V_10 , V_8 , V_5 ) ;
if ( V_9 )
...
V_129 = V_9 -> V_171 ;
if ( V_129 < V_130 )
if ( V_160 [ V_129 ] && V_160 [ V_129 ] -> V_172 )
V_19 = ( * V_160 [ V_129 ] -> V_172 ) ( V_9 ) ;
V_24:
return V_19 ;
}
...
if ( V_3 -> V_11 [ V_133 ] )
V_9 -> V_134 = F_20 ( V_3 -> V_11 [ V_133 ] ) ;
if ( V_3 -> V_11 [ V_148 ] )
V_9 -> V_149 = F_20 ( V_3 -> V_11 [ V_148 ] ) ;
if ( V_3 -> V_11 [ V_150 ] ) {
...
if ( V_3 -> V_11 [ V_154 ] )
V_9 -> V_155 = F_49 ( V_3 -> V_11 [ V_154 ] ) ;
if ( V_3 -> V_11 [ V_156 ] )
V_9 -> V_157 = F_21 ( V_3 -> V_11 [ V_156 ] ) ;
if ( V_3 -> V_11 [ V_158 ] )
...
F_31 ( V_16 , V_128 , V_9 -> V_171 ) ||
F_31 ( V_16 , V_156 , V_9 -> V_157 ) ||
( V_9 -> V_159 &&
...
( V_9 -> V_141 &&
F_58 ( V_16 , V_140 , V_9 -> V_141 ,
& V_9 -> V_142 [ 0 ] ) ) ||
( V_9 -> V_144 &&
F_58 ( V_16 , V_143 , V_9 -> V_144 ,
& V_9 -> V_145 [ 0 ] ) ) ||
F_29 ( V_16 , V_148 , V_9 -> V_149 ) ||
F_29 ( V_16 , V_150 , V_9 -> V_151 ) ||
F_29 ( V_16 , V_152 , V_9 -> V_153 ) ||
#ifdef F_59
( ( ( V_83 ) && ( V_83 -> V_174 [ 0 ] || V_83 -> V_174 [ 1 ] ) ) &&
F_29 ( V_16 , V_175 , 1 ) ) ||
#endif
( V_9 -> V_155 &&
F_60 ( V_16 , V_154 , V_9 -> V_155 ) ) )
goto V_89;
V_81 = F_32 ( V_16 , V_90 ) ;
if ( V_81 == NULL )
goto V_89;
...
static int F_62 ( struct V_15 * V_16 , struct V_118 * V_119 )
{
struct V_10 * V_10 = F_44 ( V_16 -> V_83 ) ;
struct V_1 * V_9 ;
struct V_7 * V_8 = NULL ;
int V_120 = V_119 -> args [ 0 ] ;
int V_177 = V_119 -> args [ 1 ] ;
for (; ; ) {
if ( V_8 == NULL ) {
V_8 = F_45 ( V_10 , V_120 ) ;
if ( V_8 == NULL )
...
if ( F_18 ( V_16 , F_46 ( V_119 -> V_16 ) . V_77 ,
V_119 -> V_121 -> V_122 , V_123 ,
V_9 , V_176 ) < 0 )
break;
V_177 ++ ;
...
int F_64 ( enum V_178 V_129 , const struct V_160 * V_179 )
{
int V_19 ;
V_19 = - V_42 ;
if ( V_129 >= V_130 )
