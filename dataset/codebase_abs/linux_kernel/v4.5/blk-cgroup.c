...
int V_99 , V_100 , V_32 ;
char * V_101 ;
if ( sscanf ( V_89 , L_9 , & V_97 , & V_98 , & V_99 ) != 2 )
return - V_102 ;
V_101 = V_89 + V_99 ;
if ( ! isspace ( * V_101 ) )
return - V_102 ;
V_101 = F_93 ( V_101 ) ;
V_92 = F_94 ( F_95 ( V_97 , V_98 ) , & V_100 ) ;
if ( ! V_92 )
return - V_34 ;
if ( V_100 ) {
V_96 = V_92 -> V_103 -> V_96 ;
F_96 ( V_92 ) ;
F_97 ( V_96 ) ;
return - V_34 ;
}
...
void F_101 ( struct V_90 * V_91 )
__releases( V_91 -> V_92 -> V_93 -> V_27 ) __releases( T_3 )
{
struct V_95 * V_96 ;
F_60 ( V_91 -> V_92 -> V_93 -> V_27 ) ;
F_68 () ;
V_96 = V_91 -> V_92 -> V_103 -> V_96 ;
F_96 ( V_91 -> V_92 ) ;
F_97 ( V_96 ) ;
}
static int F_102 ( struct V_65 * V_66 , void * V_70 )
{
...
V_105 = F_72 ( & V_73 . V_80 [ V_75 ] ) ;
V_106 = F_72 ( & V_73 . V_80 [ V_76 ] ) ;
V_73 = F_84 ( V_8 , NULL ,
F_81 ( struct V_7 , V_15 ) ) ;
V_107 = F_72 ( & V_73 . V_80 [ V_75 ] ) ;
V_108 = F_72 ( & V_73 . V_80 [ V_76 ] ) ;
F_60 ( V_8 -> V_2 -> V_27 ) ;
if ( V_105 || V_106 || V_107 || V_108 )
F_69 ( V_66 , L_10 ,
V_71 , V_105 , V_106 , V_107 , V_108 ) ;
}
F_68 () ;
return 0 ;
}
static void F_103 ( struct V_59 * V_33 )
{
struct V_12 * V_12 = F_55 ( V_33 ) ;
F_57 ( & V_12 -> V_43 ) ;
while ( ! F_104 ( & V_12 -> V_45 ) ) {
struct V_7 * V_8 = F_105 ( V_12 -> V_45 . V_109 ,
struct V_7 , V_44 ) ;
...
static void F_109 ( struct V_59 * V_33 )
{
struct V_12 * V_12 = F_55 ( V_33 ) ;
int V_9 ;
F_56 ( & V_62 ) ;
...
for ( V_9 = 0 ; V_9 < V_10 ; V_9 ++ )
if ( V_12 -> V_111 [ V_9 ] )
V_3 [ V_9 ] -> F_111 ( V_12 -> V_111 [ V_9 ] ) ;
F_61 ( & V_62 ) ;
F_7 ( V_12 ) ;
}
static struct V_59 *
F_112 ( struct V_59 * V_112 )
{
struct V_12 * V_12 ;
struct V_59 * V_32 ;
int V_9 ;
...
if ( ! V_4 || ! V_4 -> V_116 )
continue;
V_111 = V_4 -> V_116 ( V_113 ) ;
if ( ! V_111 ) {
V_32 = F_34 ( - V_38 ) ;
goto V_117;
}
V_12 -> V_111 [ V_9 ] = V_111 ;
V_111 -> V_12 = V_12 ;
V_111 -> V_5 = V_9 ;
if ( V_4 -> V_118 )
V_4 -> V_118 ( V_111 ) ;
...
F_114 ( & V_12 -> V_43 ) ;
F_115 ( & V_12 -> V_25 , V_37 ) ;
F_116 ( & V_12 -> V_45 ) ;
#ifdef F_117
F_11 ( & V_12 -> V_119 ) ;
#endif
F_118 ( & V_12 -> V_110 , & V_120 ) ;
F_61 ( & V_62 ) ;
return & V_12 -> V_33 ;
V_117:
for ( V_9 -- ; V_9 >= 0 ; V_9 -- )
...
static void F_132 ( struct V_59 * V_130 )
{
int V_9 ;
F_56 ( & V_62 ) ;
for ( V_9 = 0 ; V_9 < V_10 ; V_9 ++ ) {
...
if ( V_12 -> V_111 [ V_4 -> V_5 ] )
V_4 -> V_131 ( V_12 -> V_111 [ V_4 -> V_5 ] ) ;
}
F_61 ( & V_62 ) ;
}
...
F_133 (blkcg, &all_blkcgs, all_blkcgs_node) {
if ( V_12 -> V_111 [ V_4 -> V_5 ] ) {
V_4 -> F_111 ( V_12 -> V_111 [ V_4 -> V_5 ] ) ;
V_12 -> V_111 [ V_4 -> V_5 ] = NULL ;
}
}
}
V_3 [ V_4 -> V_5 ] = NULL ;
