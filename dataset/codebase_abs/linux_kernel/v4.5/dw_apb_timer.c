...
& V_16 -> V_4 ) ;
V_16 -> V_4 . V_40 = F_31 ( 5000 , & V_16 -> V_4 ) ;
...
void F_42 ( struct V_5 * V_57 )
{
T_1 V_13 = F_4 ( & V_57 -> V_9 , V_14 ) ;
V_13 &= ~ V_26 ;
...
unsigned long V_30 )
{
struct V_5 * V_57 = F_29 ( sizeof( * V_57 ) , V_36 ) ;
if ( ! V_57 )
return NULL ;
V_57 -> V_9 . V_11 = V_11 ;
V_57 -> V_9 . V_30 = V_30 ;
...
V_57 -> V_7 . V_35 = V_35 ;
V_57 -> V_7 . V_60 = F_44 ;
V_57 -> V_7 . V_61 = F_47 ( 32 ) ;
V_57 -> V_7 . V_53 = V_62 ;
V_57 -> V_7 . V_63 = F_45 ;
return V_57 ;
}
void F_48 ( struct V_5 * V_57 )
{
F_49 ( & V_57 -> V_7 , V_57 -> V_9 . V_30 ) ;
}
T_4 F_43 ( struct V_5 * V_57 )
{
return ( T_4 ) ~ F_4 ( & V_57 -> V_9 , V_59 ) ;
}
