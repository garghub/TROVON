...
T_1 V_193 , V_194 ;
int V_8 ;
V_194 = F_46 ( V_20 -> V_2 , V_20 -> V_21 [ 0 ] , V_46 ) ;
...
if ( ! -- V_191 ) {
F_116 ( V_20 -> V_75 . V_76 . V_83 -> V_44 ,
L_48 ,
V_132 ) ;
break;
}
...
enum V_197 V_141 ;
unsigned long V_102 ;
V_141 = F_119 ( V_76 , V_198 , V_200 ) ;
if ( V_141 == V_201 || ! V_200 )
return V_141 ;
F_70 ( & V_20 -> V_75 . V_104 , V_102 ) ;
if ( V_20 -> V_82 && V_20 -> V_82 -> V_80 . V_79 . V_198 == V_198 )
V_200 -> V_146 = F_115 ( V_20 -> V_82 ) ;
else if ( ( V_80 = F_120 ( & V_20 -> V_75 , V_198 ) ) )
V_200 -> V_146 = F_60 ( & V_80 -> V_79 ) -> V_146 ;
F_72 ( & V_20 -> V_75 . V_104 , V_102 ) ;
return V_141 ;
}
static bool F_121 ( int V_23 , T_6 * V_202 )
{
if ( ! V_202 )
return false ;
while ( * V_202 != - 1 ) {
...
static void F_122 ( struct V_1 * V_2 , bool V_203 )
{
...
int V_8 , V_9 ;
F_123 ( V_204 -> V_206 ) ;
F_124 ( V_207 , V_204 -> V_206 ) ;
F_124 ( V_208 , V_204 -> V_206 ) ;
if ( V_2 -> V_203 && ! V_202 ) {
F_45 ( V_2 -> V_44 ,
L_49 ) ;
F_124 ( V_209 , V_204 -> V_206 ) ;
V_204 -> V_210 = F_87 ;
V_204 -> V_211 = F_31 ( V_131 ) ;
}
V_204 -> V_212 = F_80 ;
V_204 -> V_213 = F_89 ;
V_204 -> V_214 = F_110 ;
...
V_204 -> V_222 = V_223 ;
V_204 -> V_224 = V_223 ;
V_204 -> V_211 |= ( F_31 ( V_130 ) | F_31 ( V_128 ) ) ;
V_204 -> V_225 = V_226 ;
V_204 -> V_44 = V_2 -> V_44 ;
F_125 ( & V_204 -> V_227 ) ;
if ( V_202 ) {
V_205 = F_126 ( V_2 -> V_44 , sizeof( * V_205 ) , V_228 ) ;
V_2 -> V_229 = V_205 ;
F_123 ( V_205 -> V_206 ) ;
F_124 ( V_209 , V_205 -> V_206 ) ;
V_205 -> V_210 = F_87 ;
V_205 -> V_214 = F_110 ;
V_205 -> V_215 = F_111 ;
V_205 -> V_216 = F_113 ;
...
if ( V_205 && F_121 ( V_8 , V_202 ) )
F_128 ( & V_20 -> V_75 , V_205 ) ;
else
F_128 ( & V_20 -> V_75 , V_204 ) ;
F_125 ( & V_20 -> V_86 ) ;
for ( V_9 = 0 ; V_9 < V_190 ; V_9 ++ )
V_20 -> V_21 [ V_9 ] = - 1 ;
}
}
static int F_129 ( struct V_83 * V_44 , struct V_231 * V_232 ,
struct V_1 * V_2 )
{
int V_8 ;
T_2 V_233 , V_234 ;
...
F_48 ( V_44 , L_51 , V_234 ) ;
F_48 ( V_44 , L_52 , V_2 -> V_237 ) ;
F_48 ( V_44 , L_53 , V_2 -> V_34 ) ;
F_48 ( V_44 , L_54 , V_2 -> V_238 ) ;
F_48 ( V_44 , L_55 , V_2 -> V_32 ) ;
F_48 ( V_44 , L_56 , V_2 -> V_67 ) ;
F_48 ( V_44 , L_57 , V_2 -> V_24 ? L_58 : L_59 ) ;
if ( V_232 -> V_240 )
return 0 ;
V_235 = F_136 ( V_44 , V_2 -> V_67 + 1 , sizeof( F_130 ) ,
V_228 ) ;
if ( ! V_235 )
return - V_37 ;
...
static int F_137 ( struct V_83 * V_44 , struct V_231 * V_232 ,
T_3 V_241 )
{
const char V_242 [] = L_60 ;
struct V_243 V_244 ;
void T_7 * V_245 ;
F_138 ( * V_246 ) [ 2 ] ;
T_3 V_247 = V_241 / sizeof( F_138 ) ;
T_2 V_248 , V_3 , V_249 ;
int V_141 , V_8 ;
V_246 = F_136 ( V_44 , V_247 + 2 , sizeof( F_138 ) , V_228 ) ;
if ( ! V_246 )
return - V_37 ;
V_141 = F_139 ( V_44 -> V_250 , 1 , & V_244 ) ;
if ( V_141 )
return - V_37 ;
V_245 = F_140 ( V_44 , V_244 . V_251 , F_141 ( & V_244 ) ) ;
if ( ! V_245 )
return - V_37 ;
V_141 = F_142 ( V_44 -> V_250 , V_242 , ( V_252 * ) V_246 ,
V_247 ) ;
if ( V_141 )
return - V_253 ;
V_247 >>= 1 ;
...
V_249 = F_143 ( V_245 + V_3 ) ;
V_249 &= ~ ( 0xff << V_248 ) ;
V_249 |= V_246 [ V_8 ] [ 0 ] << V_248 ;
F_144 ( V_249 , ( V_245 + V_3 ) ) ;
}
V_232 -> V_246 = ( const F_138 ( * ) [ 2 ] ) V_246 ;
return 0 ;
}
static struct V_231 * F_145 ( struct V_83 * V_44 ,
bool V_203 )
{
struct V_231 * V_186 ;
struct V_254 * V_255 ;
T_3 V_241 ;
int V_141 ;
V_186 = F_126 ( V_44 , sizeof( struct V_231 ) , V_228 ) ;
if ( ! V_186 )
return F_146 ( - V_37 ) ;
if ( V_203 ) {
V_255 = F_147 ( V_44 -> V_250 , L_60 ,
& V_241 ) ;
if ( V_255 ) {
V_141 = F_137 ( V_44 , V_186 , V_241 ) ;
if ( V_141 )
return F_146 ( V_141 ) ;
}
return V_186 ;
}
V_255 = F_147 ( V_44 -> V_250 , L_61 , & V_241 ) ;
if ( V_255 ) {
const char V_242 [] = L_61 ;
T_3 V_247 = V_241 / sizeof( T_6 ) ;
T_6 * V_256 ;
V_256 = F_136 ( V_44 , V_247 + 1 , sizeof( T_6 ) ,
V_228 ) ;
if ( ! V_256 )
return F_146 ( - V_37 ) ;
V_141 = F_148 ( V_44 -> V_250 , V_242 ,
( T_2 * ) V_256 , V_247 ) ;
if ( V_141 )
return F_146 ( V_141 ) ;
V_256 [ V_247 ] = - 1 ;
...
V_255 = F_147 ( V_44 -> V_250 , L_62 ,
& V_241 ) ;
if ( V_255 ) {
const char V_242 [] = L_62 ;
T_2 ( * V_257 ) [ 2 ] ;
F_138 ( * V_258 ) [ 2 ] ;
...
if ( ! V_247 )
return V_186 ;
V_257 = F_149 ( V_247 , sizeof( * V_257 ) , V_228 ) ;
if ( ! V_257 )
return F_146 ( - V_37 ) ;
V_260 = F_126 ( V_44 , sizeof( * V_260 ) , V_228 ) ;
if ( ! V_260 ) {
F_62 ( V_257 ) ;
return F_146 ( - V_37 ) ;
}
V_258 = F_136 ( V_44 , V_247 + 1 , sizeof( * V_258 ) ,
V_228 ) ;
if ( ! V_258 ) {
F_62 ( V_257 ) ;
return F_146 ( - V_37 ) ;
...
V_258 [ V_247 ] [ 1 ] = - 1 ;
V_186 -> V_261 = V_260 ;
V_186 -> V_261 -> V_258 = ( const F_138 ( * ) [ 2 ] ) V_258 ;
F_62 ( V_257 ) ;
}
return V_186 ;
}
static struct V_73 * F_150 ( struct V_262 * V_263 ,
struct V_264 * V_265 )
{
...
if ( ! V_76 )
return NULL ;
if ( V_20 -> V_2 -> V_203 && V_263 -> V_267 == 1 )
goto V_268;
if ( ! V_20 -> V_2 -> V_203 && V_263 -> V_267 == 2 &&
V_263 -> args [ 1 ] < V_20 -> V_2 -> V_67 ) {
V_20 -> V_105 = & V_20 -> V_2 -> V_185 [ V_263 -> args [ 1 ] ] ;
goto V_268;
}
return NULL ;
V_268:
...
static int F_152 ( struct V_182 * V_269 )
{
struct V_231 * V_186 = V_269 -> V_44 . V_270 ;
F_130 ( * V_240 ) [ 2 ] ;
int V_8 , V_271 , V_272 ;
const F_138 ( * V_258 ) [ 2 ] ;
const F_138 ( * V_246 ) [ 2 ] ;
...
char * V_273 ;
struct V_243 * V_274 ;
struct V_275 * V_86 = V_269 -> V_44 . V_250 ;
...
V_277 = F_153 ( V_278 , V_86 ) ;
if ( V_277 && ( T_2 ) V_277 -> V_162 == V_279 )
V_203 = false ;
V_186 = F_145 ( V_44 , V_203 ) ;
if ( F_154 ( V_186 ) ) {
F_78 ( V_44 , L_63 ) ;
return F_155 ( V_186 ) ;
}
...
V_141 = F_156 ( V_44 , F_157 ( 32 ) ) ;
if ( V_141 )
return V_141 ;
V_2 = F_126 ( V_44 , sizeof( * V_2 ) , V_228 ) ;
if ( ! V_2 ) {
F_78 ( V_44 , L_65 ) ;
return - V_37 ;
}
...
if ( V_2 -> V_41 < 0 )
V_2 -> V_41 = 0 ;
V_274 = F_158 ( V_269 , V_281 , L_66 ) ;
if ( ! V_274 ) {
F_48 ( V_44 , L_67 ) ;
V_274 = F_159 ( V_269 , V_281 , 0 ) ;
if ( ! V_274 ) {
F_78 ( V_44 , L_68 ) ;
return - V_280 ;
}
}
V_2 -> V_4 = F_160 ( V_44 , V_274 ) ;
if ( F_154 ( V_2 -> V_4 ) )
return F_155 ( V_2 -> V_4 ) ;
F_161 ( V_269 , V_2 ) ;
V_141 = F_129 ( V_44 , V_186 , V_2 ) ;
if ( V_141 )
return V_141 ;
V_2 -> V_170 = F_136 ( V_44 , V_2 -> V_34 ,
sizeof( * V_2 -> V_170 ) , V_228 ) ;
if ( ! V_2 -> V_170 )
return - V_37 ;
V_2 -> V_36 = F_136 ( V_44 , F_162 ( V_2 -> V_32 ) ,
...
V_161 = F_163 ( V_269 , L_69 ) ;
if ( V_161 < 0 && V_86 )
V_161 = F_164 ( V_86 , 0 ) ;
if ( V_161 >= 0 ) {
V_273 = F_165 ( V_44 , V_228 , L_70 ,
F_109 ( V_44 ) ) ;
V_141 = F_166 ( V_44 , V_161 , F_95 , 0 , V_273 ,
V_2 ) ;
if ( V_141 ) {
F_78 ( V_44 , L_71 , V_161 , V_141 ) ;
return V_141 ;
}
}
V_161 = F_163 ( V_269 , L_72 ) ;
if ( V_161 < 0 && V_86 )
V_161 = F_164 ( V_86 , 2 ) ;
if ( V_161 >= 0 ) {
V_273 = F_165 ( V_44 , V_228 , L_73 ,
F_109 ( V_44 ) ) ;
V_141 = F_166 ( V_44 , V_161 , F_99 , 0 , V_273 ,
V_2 ) ;
if ( V_141 ) {
F_78 ( V_44 , L_74 , V_161 , V_141 ) ;
return V_141 ;
}
}
...
int V_282 = 0 ;
struct V_262 V_283 ;
V_2 -> V_185 = F_136 ( V_44 , V_2 -> V_67 ,
sizeof( * V_2 -> V_185 ) , V_228 ) ;
if ( ! V_2 -> V_185 )
return - V_37 ;
for ( V_8 = 0 ; ; V_8 ++ ) {
V_141 = F_167 ( V_86 , L_76 ,
1 , V_8 , & V_283 ) ;
if ( V_141 || V_8 == V_2 -> V_67 )
break;
V_2 -> V_185 [ V_8 ] . V_86 = V_283 . V_284 ;
V_2 -> V_185 [ V_8 ] . V_41 = V_8 ;
V_240 [ V_8 ] [ 1 ] = V_283 . args [ 0 ] ;
if ( V_240 [ V_8 ] [ 1 ] > V_282 ) {
V_282 = V_240 [ V_8 ] [ 1 ] ;
V_186 -> V_66 = V_8 ;
}
}
...
V_2 -> V_72 . V_286 . V_287 = V_186 -> V_288 ;
V_2 -> V_72 . V_286 . V_289 = V_186 -> V_290 ;
V_2 -> V_72 . V_286 . V_291 = V_292 ;
V_141 = F_168 ( & V_2 -> V_72 ) ;
if ( V_141 ) {
F_78 ( V_44 , L_77 , V_141 ) ;
goto V_293;
}
if ( V_2 -> V_229 ) {
V_141 = F_168 ( V_2 -> V_229 ) ;
if ( V_141 ) {
F_78 ( V_44 , L_78 ,
V_141 ) ;
F_169 ( & V_2 -> V_72 ) ;
...
static int F_171 ( struct V_182 * V_269 )
{
struct V_83 * V_44 = & V_269 -> V_44 ;
struct V_1 * V_2 = F_172 ( V_44 ) ;
if ( V_44 -> V_250 )
F_173 ( V_44 -> V_250 ) ;
F_169 ( & V_2 -> V_72 ) ;
if ( V_2 -> V_229 )
...
static int F_176 ( struct V_182 * V_269 )
{
return 0 ;
}
