...
V_27 = V_13 -> V_40 . V_27 ;
F_4 ( & V_10 -> V_11 ) ;
V_9 = F_30 ( NULL , & V_7 -> V_12 -> V_40 , NULL ) ;
if ( V_9 )
goto V_47;
V_2 = F_31 ( V_8 ) ;
if ( F_21 ( V_2 ) ) {
...
V_2 -> V_49 . V_61 = V_10 -> V_58 . V_59 + F_32 ( V_13 ) ;
V_2 -> V_49 . V_62 = V_27 ;
V_2 -> V_63 =
F_33 ( V_23 -> V_36 . V_64 + F_32 ( V_13 ) ,
V_27 ) ;
if ( ! V_2 -> V_63 ) {
F_19 ( L_8 ) ;
V_9 = - V_65 ;
...
static void F_40 ( struct V_72 * V_73 , T_1 V_74 , T_1 V_75 ,
T_1 V_76 , int V_77 )
{
struct V_78 * V_78 = F_41 ( V_73 ) ;
V_78 -> V_79 [ V_77 ] = V_74 >> 8 ;
V_78 -> V_80 [ V_77 ] = V_75 >> 8 ;
V_78 -> V_81 [ V_77 ] = V_76 >> 8 ;
}
static void F_42 ( struct V_72 * V_73 , T_1 * V_74 , T_1 * V_75 ,
T_1 * V_76 , int V_77 )
{
struct V_78 * V_78 = F_41 ( V_73 ) ;
...
static struct V_82 *
F_43 ( struct V_3 * V_4 , struct V_72 * V_73 )
{
int V_83 ;
...
T_2 V_98 = 0 , V_99 ;
int V_100 = 0 ;
V_94 = F_45 ( V_10 -> V_58 . V_101 , sizeof( bool ) ,
V_102 ) ;
if ( ! V_94 )
return false ;
...
F_28 ( L_14 ,
V_108 -> V_116 ) ;
V_89 [ V_83 ] = F_46 ( V_106 , V_29 , V_31 ) ;
if ( ! V_89 [ V_83 ] ) {
F_28 ( L_15 ,
V_108 -> V_116 , V_108 -> V_113 ) ;
V_89 [ V_83 ] = F_47 ( V_106 , V_29 ,
V_31 ) ;
}
if ( ! V_89 [ V_83 ] && ! F_48 ( & V_108 -> V_89 ) ) {
F_28 ( L_16 ,
V_108 -> V_116 ) ;
V_89 [ V_83 ] = F_49 ( & V_108 -> V_89 ,
struct V_88 ,
V_120 ) ;
}
if ( ! V_89 [ V_83 ] ) {
...
F_28 ( L_18 ,
V_108 -> V_116 ,
F_50 ( F_41 ( V_110 -> V_73 ) -> V_122 ) ,
V_110 -> V_73 -> V_40 . V_50 ,
V_89 [ V_83 ] -> V_123 , V_89 [ V_83 ] -> V_124 ,
V_89 [ V_83 ] -> V_51 & V_125 ? L_19 : L_20 ) ;
V_95 = false ;
V_98 |= ( 1 << V_83 ) ;
}
if ( ( V_98 & V_99 ) != V_99 ) {
...
F_59 (dev, crtc) {
struct V_26 * V_13 =
F_60 ( V_73 -> V_128 -> V_129 -> V_12 ) ;
V_78 = F_41 ( V_73 ) ;
if ( ! V_73 -> V_129 -> V_130 || ! V_13 ) {
F_28 ( L_24 ,
F_50 ( V_78 -> V_122 ) ) ;
continue;
}
if ( V_13 -> V_40 . V_27 > V_127 ) {
F_28 ( L_25 ,
F_50 ( V_78 -> V_122 ) ) ;
V_12 = F_24 ( V_73 -> V_128 -> V_129 -> V_12 ) ;
V_127 = V_13 -> V_40 . V_27 ;
}
}
if ( ! V_12 ) {
F_28 ( L_26 ) ;
...
F_28 ( L_28 ,
F_50 ( V_78 -> V_122 ) ) ;
V_131 = V_78 -> V_132 -> V_40 . V_133 . V_134 ;
V_131 = V_131 * V_12 -> V_40 . V_135 / 8 ;
if ( V_12 -> V_40 . V_33 [ 0 ] < V_131 ) {
F_28 ( L_29 ,
F_50 ( V_78 -> V_122 ) ,
V_131 , V_12 -> V_40 . V_33 [ 0 ] ) ;
V_12 = NULL ;
break;
}
V_131 = V_78 -> V_132 -> V_40 . V_133 . V_136 ;
V_131 = F_61 ( V_10 , V_131 ,
V_12 -> V_40 . V_34 ,
V_12 -> V_40 . V_137 [ 0 ] ) ;
V_131 *= V_12 -> V_40 . V_33 [ 0 ] ;
F_28 ( L_30 ,
F_50 ( V_78 -> V_122 ) ,
V_78 -> V_132 -> V_40 . V_133 . V_134 ,
V_78 -> V_132 -> V_40 . V_133 . V_136 ,
V_12 -> V_40 . V_135 ,
V_131 ) ;
if ( V_131 > V_127 ) {
F_28 ( L_31 ,
...
static void F_64 ( struct V_139 * V_140 )
{
F_65 ( F_2 ( V_140 ,
struct V_22 ,
V_141 ) -> V_10 ,
...
struct V_22 * V_23 = V_10 -> V_43 ;
int V_9 ;
if ( F_29 ( F_51 ( V_10 ) -> V_126 == 0 ) )
return - V_143 ;
V_7 = F_67 ( sizeof( struct V_6 ) , V_102 ) ;
if ( V_7 == NULL )
return - V_38 ;
F_68 ( V_10 , & V_7 -> V_8 , & V_144 ) ;
if ( ! F_58 ( V_10 , V_7 ) )
V_7 -> V_138 = 32 ;
...
V_7 -> V_8 . V_145 = true ;
V_23 -> V_146 = V_7 ;
F_70 ( & V_23 -> V_141 , F_64 ) ;
F_71 ( & V_7 -> V_8 ) ;
return 0 ;
}
static void F_72 ( void * V_147 , T_3 V_148 )
{
struct V_22 * V_23 = V_147 ;
struct V_6 * V_7 = V_23 -> V_146 ;
if ( F_73 ( & V_7 -> V_8 ,
V_7 -> V_138 ) )
F_74 ( V_23 -> V_10 ) ;
}
...
if ( ! F_78 () )
F_79 () ;
F_53 ( V_10 , V_23 -> V_146 ) ;
F_52 ( V_23 -> V_146 ) ;
V_23 -> V_146 = NULL ;
}
void F_65 ( struct V_21 * V_10 , int V_129 , bool V_149 )
{
struct V_22 * V_23 = V_10 -> V_43 ;
struct V_6 * V_7 = V_23 -> V_146 ;
struct V_1 * V_2 ;
...
if ( V_129 == V_142 && V_7 -> V_12 -> V_13 -> V_70 )
F_36 ( V_2 -> V_63 , 0 , V_2 -> V_67 ) ;
F_83 ( & V_7 -> V_8 , V_129 ) ;
F_84 () ;
}
