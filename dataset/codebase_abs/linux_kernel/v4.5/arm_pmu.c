...
static int F_79 ( struct V_5 * V_98 )
{
int V_40 ;
int V_80 ;
struct V_33 T_6 * V_120 ;
V_120 = F_80 ( struct V_33 ) ;
if ( ! V_120 )
return - V_121 ;
V_98 -> V_114 . V_122 = F_77 ;
V_40 = F_81 ( & V_98 -> V_114 ) ;
if ( V_40 )
goto V_123;
F_82 (cpu) {
struct V_33 * V_37 = F_68 ( V_120 , V_80 ) ;
F_83 ( & V_37 -> V_124 ) ;
V_37 -> V_103 = V_98 ;
}
V_98 -> V_34 = V_120 ;
...
static void F_86 ( struct V_5 * V_98 )
{
F_87 ( & V_98 -> V_114 ) ;
F_85 ( V_98 -> V_34 ) ;
}
static int F_88 ( struct V_5 * V_7 ,
const struct V_127 * V_128 )
{
int V_80 = F_89 () ;
unsigned int V_129 = F_90 () ;
int V_15 = - V_107 ;
F_91 ( L_8 , V_80 ) ;
...
static int F_93 ( struct V_5 * V_7 )
{
int * V_100 , V_99 = 0 ;
bool V_132 = false ;
struct V_56 * V_133 = V_7 -> V_57 ;
V_100 = F_94 ( V_133 -> V_102 , sizeof( * V_100 ) , V_134 ) ;
if ( ! V_100 )
return - V_121 ;
do {
struct V_135 * V_136 ;
int V_80 , V_54 ;
V_136 = F_95 ( V_133 -> V_55 . V_137 , L_9 , V_99 ) ;
if ( ! V_136 )
break;
V_54 = F_63 ( V_133 , V_99 ) ;
if ( V_54 >= 0 ) {
bool V_138 = ! F_64 ( V_54 ) ;
...
V_93 = V_7 ;
V_7 -> V_57 = V_133 ;
if ( V_145 && ( V_144 = F_104 ( V_142 , V_133 -> V_55 . V_137 ) ) ) {
F_102 = V_144 -> V_96 ;
V_15 = F_93 ( V_7 ) ;
if ( ! V_15 )
V_15 = F_102 ( V_7 ) ;
