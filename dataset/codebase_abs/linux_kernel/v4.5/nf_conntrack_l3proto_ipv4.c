...
{
#if F_41 ( V_89 ) && F_41 ( V_90 )
struct V_91 * V_92 = & V_45 -> V_32 . V_93 ;
V_92 -> V_94 = F_42 ( V_95 ,
sizeof( V_95 ) ,
V_96 ) ;
if ( ! V_92 -> V_94 )
return - V_97 ;
V_92 -> V_94 [ 0 ] . V_98 = & V_99 ;
V_92 -> V_94 [ 1 ] . V_98 = & V_45 -> V_32 . V_100 ;
V_92 -> V_94 [ 2 ] . V_98 = & V_45 -> V_32 . V_101 ;
V_92 -> V_94 [ 3 ] . V_98 = & V_45 -> V_32 . V_102 ;
V_92 -> V_94 [ 4 ] . V_98 = & V_45 -> V_32 . V_103 ;
#endif
return 0 ;
}
...
{
int V_104 = 0 ;
V_104 = F_44 ( V_45 , & V_105 ) ;
if ( V_104 < 0 ) {
F_45 ( L_8 ) ;
goto V_106;
}
V_104 = F_44 ( V_45 , & V_107 ) ;
if ( V_104 < 0 ) {
F_45 ( L_9 ) ;
goto V_108;
}
V_104 = F_44 ( V_45 , & V_109 ) ;
if ( V_104 < 0 ) {
F_45 ( L_10 ) ;
goto V_110;
}
V_104 = F_46 ( V_45 , & V_111 ) ;
if ( V_104 < 0 ) {
F_45 ( L_11 ) ;
goto V_112;
}
...
static void F_48 ( struct V_45 * V_45 )
{
F_49 ( V_45 , & V_111 ) ;
F_47 ( V_45 , & V_109 ) ;
F_47 ( V_45 , & V_107 ) ;
