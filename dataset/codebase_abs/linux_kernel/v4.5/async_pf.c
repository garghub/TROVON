...
T_1 V_16 = V_12 -> V_16 ;
F_14 () ;
F_15 ( NULL , V_14 , V_15 , 1 , 1 , 0 , NULL ) ;
F_1 ( V_2 , V_12 ) ;
F_16 ( & V_2 -> V_7 . V_10 ) ;
...
int F_38 ( struct V_1 * V_2 , T_1 V_16 , unsigned long V_22 ,
struct V_23 * V_24 )
{
struct V_3 * V_4 ;
if ( V_2 -> V_7 . V_21 >= V_25 )
return 0 ;
V_4 = F_39 ( V_5 , V_26 | V_27 ) ;
if ( ! V_4 )
return 0 ;
V_4 -> V_28 = false ;
V_4 -> V_2 = V_2 ;
