...
return - V_350 ;
V_349 = V_55 -> V_331 ;
error = F_272 ( V_343 , & V_349 , & V_347 , & V_348 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
error = F_273 ( V_343 , V_349 ,
& V_345 ) ;
if ( error ) {
F_56 ( error ) ;
goto V_17;
...
static inline int F_280 ( struct V_55 * V_343 , struct V_335 * V_352 )
{
if ( F_281 ( V_352 ) )
return - V_353 ;
if ( F_282 ( V_343 ) )
return - V_354 ;
return F_283 ( V_343 , V_355 | V_356 ) ;
}
static int F_284 ( struct V_335 * V_336 , struct V_55 * V_343 ,
struct V_335 * V_344 , bool V_322 )
{
struct V_55 * V_55 = F_265 ( V_336 ) ;
int error ;
if ( ! V_55 )
return - V_354 ;
error = F_280 ( V_343 , V_344 ) ;
if ( error )
return error ;
if ( V_343 -> V_76 != V_55 -> V_76 )
return - V_357 ;
if ( F_285 ( V_55 ) || F_286 ( V_55 ) )
return - V_358 ;
if ( ! F_287 ( V_55 -> V_331 ) )
return - V_358 ;
if ( V_322 ) {
if ( ! F_288 ( F_289 () , V_55 -> V_329 ) && ! F_290 ( V_359 ) )
return - V_358 ;
if ( ! F_291 ( V_55 -> V_330 ) && ! F_290 ( V_359 ) )
return - V_358 ;
}
if ( ! V_322 ) {
error = F_283 ( V_55 , V_360 ) ;
if ( error )
return error ;
}
F_100 ( V_55 ) ;
...
int F_294 ( struct V_55 * V_55 ,
const char T_8 * V_361 ,
const char T_8 * V_362 ,
bool V_322 )
{
struct V_335 * V_344 ;
struct V_204 V_363 , V_364 ;
int error ;
if ( ! V_1 ( F_13 ( V_55 -> V_76 ) ) )
return - V_350 ;
error = F_295 ( V_365 , V_361 , 0 , & V_363 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
V_344 = F_296 ( V_365 , V_362 , & V_364 , 0 ) ;
error = F_79 ( V_344 ) ;
if ( F_78 ( V_344 ) ) {
F_56 ( error ) ;
goto V_17;
...
error = - V_357 ;
if ( V_363 . V_366 != V_364 . V_366 ) {
F_56 ( error ) ;
goto V_367;
}
error = F_284 ( V_363 . V_335 ,
F_265 ( V_364 . V_335 ) ,
V_344 , V_322 ) ;
V_367:
F_297 ( & V_364 , V_344 ) ;
