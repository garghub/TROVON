...
if ( V_16 -> V_37 ) {
F_3 ( V_16 -> V_85 ==
V_110 + V_16 -> V_37 -> V_121 ) ;
for ( V_108 = 0 ; V_108 < V_16 -> V_37 -> V_121 ; V_108 ++ ) {
V_2 = V_16 -> V_37 -> V_2 [ V_108 ] ;
V_16 -> V_17 [ V_2 -> V_14 ] = V_2 ;
}
}
else
...
if ( ! V_46 )
return - V_50 ;
V_19 = F_88 ( V_16 , V_14 , V_46 , 0 ) ;
if ( V_19 && V_19 != V_127 ) {
V_19 = 0 ;
goto V_51;
}
V_126 = F_89 ( V_46 -> V_11 ) ;
if ( V_11 != V_126 && V_126 - V_11 > 1 ) {
F_17 ( V_16 , L_40 , V_14 ) ;
F_17 ( V_16 , L_41 , V_126 , V_11 ) ;
F_90 () ;
V_19 = 1 ;
} else
V_19 = 0 ;
...
static struct V_1 * F_91 ( struct V_15 * V_16 )
{
struct V_1 * V_2 ;
...
F_19 ( V_16 , V_2 ) ;
F_13 ( & V_16 -> V_23 ) ;
V_19 = F_94 ( V_16 , V_2 -> V_14 , V_16 -> V_129 ,
V_16 -> V_130 - V_16 -> V_129 ) ;
if ( V_19 ) {
