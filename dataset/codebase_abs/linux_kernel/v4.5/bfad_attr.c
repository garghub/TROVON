...
F_3 ( & V_8 -> V_16 , V_12 ) ;
if ( strlen ( V_130 ) > 0 )
F_69 ( & V_132 -> V_133 , V_130 ) ;
F_7 ( & V_8 -> V_16 , V_12 ) ;
}
static T_7
F_70 ( struct V_157 * V_13 , struct V_158 * V_40 ,
char * V_159 )
{
...
static T_7
F_75 ( struct V_157 * V_13 , struct V_158 * V_40 ,
char * V_159 )
{
struct V_3 * V_4 = F_71 ( V_13 ) ;
struct V_5 * V_6 =
...
if ( V_167 == 1 && F_77 ( & V_8 -> V_41 . V_168 ) )
snprintf ( V_165 , V_166 ,
L_11 ) ;
else if ( V_167 == 1 && ! F_77 ( & V_8 -> V_41 . V_168 ) )
snprintf ( V_165 , V_166 ,
L_29 ) ;
else if ( V_167 == 2 && F_77 ( & V_8 -> V_41 . V_168 ) )
snprintf ( V_165 , V_166 ,
L_13 ) ;
else if ( V_167 == 2 && ! F_77 ( & V_8 -> V_41 . V_168 ) )
snprintf ( V_165 , V_166 ,
...
struct V_21 * V_22 = V_6 -> V_22 ;
T_2 V_128 ;
V_128 = F_79 ( V_22 -> V_23 ) ;
return snprintf ( V_159 , V_162 , L_35 , F_11 ( V_128 ) ) ;
}
static T_7
F_80 ( struct V_157 * V_13 , struct V_158 * V_40 ,
char * V_159 )
{
struct V_3 * V_4 = F_71 ( V_13 ) ;
struct V_5 * V_6 =
...
char V_169 [ V_170 ] ;
F_20 ( & V_8 -> V_26 . V_27 . V_28 , & V_25 ) ;
strncpy ( V_169 , V_25 . V_123 . V_130 . V_169 ,
V_170 ) ;
return snprintf ( V_159 , V_162 , L_1 , V_169 ) ;
}
static T_7
...
char V_171 [ V_172 ] ;
F_82 ( & V_8 -> V_41 , V_171 ) ;
return snprintf ( V_159 , V_162 , L_1 , V_171 ) ;
}
static T_7
...
static T_7
F_88 ( struct V_157 * V_13 , struct V_158 * V_40 ,
char * V_159 )
{
struct V_3 * V_4 = F_71 ( V_13 ) ;
struct V_5 * V_6 =
...
char * V_159 )
{
return snprintf ( V_159 , V_162 , L_1 , V_176 ) ;
}
static T_7
F_90 ( struct V_157 * V_13 ,
struct V_158 * V_40 , char * V_159 )
{
struct V_3 * V_4 = F_71 ( V_13 ) ;
struct V_5 * V_6 =
...
F_3 ( & V_8 -> V_16 , V_12 ) ;
F_91 ( V_22 -> V_23 , V_179 , & V_177 ) ;
F_7 ( & V_8 -> V_16 , V_12 ) ;
F_38 ( V_179 ) ;
return snprintf ( V_159 , V_162 , L_36 , V_177 ) ;
}
