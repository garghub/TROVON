...
static int T_4 F_24 ( struct V_51 * V_6 )
{
...
static int T_4 F_28 ( struct V_51 * V_6 )
{
struct V_1 * V_2 = F_25 ( V_6 ) ;
F_26 ( & V_2 -> V_14 -> V_52 ) ;
if ( V_2 -> V_50 && ! V_2 -> V_49 && V_2 -> V_14 -> V_53 )
...
static T_5 F_30 ( struct V_51 * V_6 ,
struct V_55 * V_56 , char * V_9 )
{
struct V_1 * V_2 = F_25 ( V_6 ) ;
return sprintf ( V_9 , L_1 , V_2 -> V_49 ) ;
}
static T_5 F_31 ( struct V_51 * V_6 ,
struct V_55 * V_56 ,
...
struct V_1 * F_45 ( struct V_51 * V_6 , T_1 V_84 , unsigned int V_36 ,
const struct V_85 * V_4 )
{
...
V_2 -> V_94 = V_69 -> V_94 ;
V_2 -> V_95 = V_69 -> V_95 ;
snprintf ( V_2 -> V_96 , sizeof( V_2 -> V_96 ) , L_6 , F_49 ( V_6 ) ) ;
V_13 -> V_97 = L_7 ;
V_13 -> V_96 = V_2 -> V_96 ;
V_13 -> V_6 . V_83 = V_6 ;
...
if ( V_61 < 0 ) {
F_41 ( V_6 , L_8 , V_13 -> V_97 ) ;
goto V_90;
}
V_86 = F_1 ( V_2 , V_113 ) ;
V_13 -> V_98 . V_114 = ( V_86 & 0xff ) ;
V_13 -> V_98 . V_115 = V_86 >> 8 ;
if ( V_13 -> V_98 . V_114 != V_84 ) {
F_41 ( V_6 , L_9 ,
V_13 -> V_97 , V_84 , V_86 ) ;
V_61 = - V_116 ;
goto V_90;
