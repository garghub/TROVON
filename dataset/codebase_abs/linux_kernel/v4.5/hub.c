...
V_72 , V_430 ) ;
if ( V_83 ) {
F_22 ( & V_81 -> V_22 , L_123 , V_83 ) ;
} else {
F_22 ( & V_11 -> V_22 , L_124 ,
( F_210 ( V_424 ) ? L_114 : L_40 ) ) ;
F_66 ( V_440 ) ;
V_83 = F_28 ( V_2 , V_72 , & V_3 , & V_180 ) ;
F_66 ( 10 ) ;
...
break;
default:
F_71 ( & V_11 -> V_22 , L_129 ,
V_118 , V_463 ? L_130 : L_131 ) ;
return - V_69 ;
}
if ( V_11 -> V_90 != V_91 ) {
F_22 ( & V_11 -> V_22 , L_132
L_133 ,
V_118 , V_463 ? L_130 : L_131 ,
V_461 [ V_90 ] ) ;
return 0 ;
...
int F_238 ( struct V_1 * V_2 , int V_72 , bool V_482 )
{
int V_57 ;
T_1 V_180 , V_3 ;
unsigned V_483 = 0xffff ;
int V_179 , V_484 = 0 ;
struct V_80 * V_81 = V_2 -> V_82 [ V_72 - 1 ] ;
for ( V_179 = 0 ; ; V_179 += V_184 ) {
V_57 = F_28 ( V_2 , V_72 , & V_3 , & V_180 ) ;
...
int V_486 ;
struct V_193 * V_159 = F_60 ( V_11 -> V_173 ) ;
if ( ! V_159 -> V_160 -> V_487 && V_171 <= 1 )
return - V_69 ;
if ( V_11 -> V_90 == V_433 )
return 0 ;
if ( V_11 -> V_90 != V_411 )
return - V_69 ;
if ( V_159 -> V_160 -> V_487 )
V_486 = V_159 -> V_160 -> V_487 ( V_159 , V_11 ) ;
else
V_486 = F_14 ( V_11 , F_243 () ,
V_488 , 0 , V_171 , 0 ,
NULL , 0 , V_203 ) ;
if ( V_486 == 0 ) {
F_139 ( V_11 , V_171 ) ;
...
if ( ( V_11 -> V_17 -> V_18 -> V_20 & F_245 ( V_490 ) ) ||
V_371 == V_374 ) {
V_11 -> V_491 = 1 ;
F_211 ( V_11 , 1 ) ;
}
...
{
struct V_193 * V_159 = F_60 ( V_11 -> V_173 ) ;
if ( ! V_159 -> V_160 -> V_492 )
return 0 ;
if ( V_11 -> V_90 == V_433 )
return 0 ;
if ( V_11 -> V_90 != V_411 )
return - V_69 ;
return V_159 -> V_160 -> V_492 ( V_159 , V_11 ) ;
}
static int
...
int V_56 , V_494 , V_486 ;
unsigned V_195 = V_399 ;
enum V_495 V_496 = V_11 -> V_14 ;
const char * V_14 ;
...
V_486 = F_195 ( V_2 , V_72 , V_11 , V_195 , false ) ;
if ( V_486 < 0 )
goto V_246;
V_486 = - V_116 ;
if ( V_496 != V_498 && V_496 != V_11 -> V_14 ) {
F_22 ( & V_11 -> V_22 , L_149 ) ;
goto V_246;
}
V_496 = V_11 -> V_14 ;
switch ( V_11 -> V_14 ) {
case V_52 :
case V_402 :
V_11 -> V_344 . V_283 . V_499 = F_230 ( 512 ) ;
break;
case V_15 :
V_11 -> V_344 . V_283 . V_499 = F_230 ( 64 ) ;
break;
case V_16 :
V_11 -> V_344 . V_283 . V_499 = F_230 ( 64 ) ;
break;
case V_403 :
V_11 -> V_344 . V_283 . V_499 = F_230 ( 8 ) ;
break;
default:
goto V_246;
}
...
F_7 ( & V_11 -> V_22 ,
L_151 ,
( V_11 -> V_355 ) ? L_152 : L_153 , V_14 ,
V_171 , V_11 -> V_173 -> V_500 -> V_160 -> V_501 ) ;
if ( V_4 -> V_145 ) {
...
for ( V_56 = 0 ; V_56 < V_502 ; ( ++ V_56 , F_66 ( 100 ) ) ) {
bool V_503 = false ;
if ( F_191 ( V_11 , V_493 ) ) {
struct V_504 * V_505 ;
int V_506 = 0 ;
...
#define F_249 64
V_505 = F_56 ( F_249 , V_209 ) ;
if ( ! V_505 ) {
V_486 = - V_168 ;
continue;
}
for ( V_494 = 0 ; V_494 < 3 ; ++ V_494 ) {
V_505 -> V_507 = 0 ;
V_506 = F_14 ( V_11 , F_250 () ,
V_64 , V_65 ,
V_508 << 8 , 0 ,
V_505 , F_249 ,
V_509 ) ;
...
if ( V_11 -> V_336 == 0 ) {
for ( V_494 = 0 ; V_494 < V_513 ; ++ V_494 ) {
V_486 = F_242 ( V_11 , V_171 ) ;
if ( V_486 >= 0 )
break;
F_66 ( 200 ) ;
}
...
goto V_246;
if ( ( V_11 -> V_14 == V_52 ) &&
( F_12 ( V_11 -> V_36 . V_514 ) < 0x0300 ) ) {
F_30 ( & V_11 -> V_22 , L_160
L_161 ) ;
F_195 ( V_2 , V_72 , V_11 ,
V_515 , true ) ;
V_486 = - V_69 ;
...
if ( V_11 -> V_36 . V_507 == 0xff ||
V_11 -> V_14 == V_52 )
V_56 = 512 ;
else
V_56 = V_11 -> V_36 . V_507 ;
if ( F_251 ( & V_11 -> V_344 . V_283 ) != V_56 ) {
if ( V_11 -> V_14 == V_403 ||
! ( V_56 == 8 || V_56 == 16 || V_56 == 32 || V_56 == 64 ) ) {
F_30 ( & V_11 -> V_22 , L_162 , V_56 ) ;
V_486 = - V_512 ;
goto V_246;
}
if ( V_11 -> V_14 == V_16 )
F_22 ( & V_11 -> V_22 , L_163 , V_56 ) ;
else
F_71 ( & V_11 -> V_22 , L_164 , V_56 ) ;
V_11 -> V_344 . V_283 . V_499 = F_230 ( V_56 ) ;
F_239 ( V_11 ) ;
}
V_486 = F_187 ( V_11 , V_516 ) ;
if ( V_486 < ( signed ) sizeof( V_11 -> V_36 ) ) {
if ( V_486 != - V_116 )
F_30 ( & V_11 -> V_22 , L_165 ,
V_486 ) ;
if ( V_486 >= 0 )
V_486 = - V_517 ;
goto V_246;
...
F_252 ( V_11 ) ;
if ( V_11 -> V_336 == 0 && F_12 ( V_11 -> V_36 . V_514 ) >= 0x0201 ) {
V_486 = F_253 ( V_11 ) ;
if ( ! V_486 ) {
V_11 -> V_26 = F_5 ( V_11 ) ;
F_11 ( V_11 ) ;
...
V_486 = 0 ;
if ( V_159 -> V_160 -> V_518 )
V_159 -> V_160 -> V_518 ( V_159 , V_11 ) ;
F_244 ( V_11 ) ;
V_246:
if ( V_486 ) {
F_72 ( V_2 , V_72 , 0 ) ;
...
if ( V_11 -> V_12 & V_521 )
return;
V_520 = F_56 ( sizeof *V_520 , V_245 ) ;
if ( V_520 == NULL )
return;
V_83 = F_255 ( V_11 , V_522 , 0 ,
V_520 , sizeof *V_520 ) ;
if ( V_83 == sizeof *V_520 ) {
F_7 ( & V_11 -> V_22 , L_166
L_167 ) ;
if ( V_2 -> V_227 ) {
...
V_243 = 100 ;
if ( V_11 -> V_8 )
V_523 = F_257 ( V_11 , V_11 -> V_8 ) ;
else if ( V_72 != V_11 -> V_173 -> V_361 || V_4 -> V_25 )
V_523 = V_243 ;
else
V_523 = 8 ;
if ( V_523 > V_2 -> V_278 )
F_71 ( & V_81 -> V_22 , L_168 ,
V_523 , V_2 -> V_278 ) ;
V_281 -= V_523 ;
}
if ( V_281 < 0 ) {
F_71 ( V_2 -> V_117 , L_169 ,
- V_281 ) ;
V_281 = 0 ;
}
return V_281 ;
...
static int V_524 = - 1 ;
if ( V_11 ) {
if ( V_159 -> V_525 && ! V_4 -> V_25 )
F_259 ( V_159 -> V_525 , V_11 -> V_14 ) ;
F_86 ( & V_81 -> V_187 ) ;
}
if ( ! ( V_3 & V_210 ) ||
( V_180 & V_212 ) )
...
if ( V_11 -> V_12 & V_529 )
F_66 ( 1000 ) ;
if ( V_11 -> V_36 . V_530 == V_531
&& V_11 -> V_277 <= V_243 ) {
T_1 V_532 ;
V_83 = F_100 ( V_11 , V_274 , 0 ,
& V_532 ) ;
if ( V_83 ) {
F_22 ( & V_11 -> V_22 , L_172 , V_83 ) ;
goto V_533;
}
if ( ( V_532 & ( 1 << V_280 ) ) == 0 ) {
F_30 ( & V_11 -> V_22 ,
...
if ( F_12 ( V_11 -> V_36 . V_514 ) >= 0x0200
&& V_11 -> V_14 == V_16
&& V_292 != 0 )
F_254 ( V_2 , V_11 , V_72 ) ;
V_83 = 0 ;
...
V_408:
F_72 ( V_2 , V_72 , 1 ) ;
if ( V_159 -> V_160 -> V_535 && ! V_2 -> V_4 -> V_25 )
V_159 -> V_160 -> V_535 ( V_159 , V_72 ) ;
}
...
V_57 = F_76 ( V_123 ) ;
if ( V_57 ) {
F_22 ( V_237 , L_178 , V_57 ) ;
goto V_536;
}
if ( V_2 -> V_92 )
goto V_537;
if ( V_2 -> error ) {
F_22 ( V_237 , L_179 , V_2 -> error ) ;
V_57 = F_267 ( V_4 ) ;
if ( V_57 ) {
F_22 ( V_237 , L_180 , V_57 ) ;
goto V_537;
}
V_2 -> V_137 = 0 ;
V_2 -> error = 0 ;
...
int V_554 ;
char * V_505 ;
if ( memcmp ( & V_11 -> V_36 , V_547 ,
sizeof( * V_547 ) ) != 0 )
return 1 ;
if ( ( V_549 && ! V_11 -> V_17 ) || ( ! V_549 && V_11 -> V_17 ) )
return 1 ;
if ( V_11 -> V_17 ) {
V_552 = F_12 ( V_11 -> V_17 -> V_283 -> V_358 ) ;
if ( V_552 != F_12 ( V_549 -> V_283 -> V_358 ) )
return 1 ;
if ( memcmp ( V_11 -> V_17 -> V_283 , V_549 -> V_283 , V_552 ) )
return 1 ;
}
if ( V_11 -> V_352 )
V_551 = strlen ( V_11 -> V_352 ) + 1 ;
V_552 = V_551 ;
for ( V_550 = 0 ; V_550 < V_11 -> V_36 . V_555 ; V_550 ++ ) {
V_553 = F_12 ( V_11 -> V_355 [ V_550 ] . V_283 . V_358 ) ;
V_552 = F_278 ( V_552 , V_553 ) ;
}
V_505 = F_56 ( V_552 , V_209 ) ;
if ( V_505 == NULL ) {
F_30 ( & V_11 -> V_22 , L_188 ) ;
return 1 ;
}
for ( V_550 = 0 ; V_550 < V_11 -> V_36 . V_555 ; V_550 ++ ) {
V_553 = F_12 ( V_11 -> V_355 [ V_550 ] . V_283 . V_358 ) ;
V_554 = F_255 ( V_11 , V_556 , V_550 , V_505 ,
V_553 ) ;
if ( V_554 != V_553 ) {
...
if ( memcmp ( V_505 , V_11 -> V_357 [ V_550 ] , V_553 )
!= 0 ) {
...
if ( ! V_88 && V_551 ) {
V_554 = F_279 ( V_11 , V_11 -> V_36 . V_349 ,
V_505 , V_551 ) ;
if ( V_554 + 1 != V_551 ) {
F_22 ( & V_11 -> V_22 , L_191 ,
V_554 ) ;
V_88 = 1 ;
} else if ( memcmp ( V_505 , V_11 -> V_352 , V_554 ) != 0 ) {
...
{
struct V_7 * V_559 = V_11 -> V_25 ;
struct V_1 * V_560 ;
struct V_193 * V_159 = F_60 ( V_11 -> V_173 ) ;
struct V_504 V_36 = V_11 -> V_36 ;
struct V_548 * V_17 ;
int V_56 , V_494 , V_57 = 0 ;
int V_72 = V_11 -> V_129 ;
if ( V_11 -> V_90 == V_188 ||
V_11 -> V_90 == V_326 ) {
F_22 ( & V_11 -> V_22 , L_193 ,
V_11 -> V_90 ) ;
return - V_69 ;
}
if ( ! V_559 )
...
V_57 = F_212 ( V_11 ) ;
if ( V_57 ) {
F_30 ( & V_11 -> V_22 , L_194 , V_118 ) ;
goto V_562;
}
V_57 = F_204 ( V_11 ) ;
if ( V_57 ) {
F_30 ( & V_11 -> V_22 , L_195 ,
V_118 ) ;
goto V_562;
}
V_17 = V_11 -> V_17 ;
...
for ( V_56 = 0 ; V_56 < V_526 ; ++ V_56 ) {
F_239 ( V_11 ) ;
V_57 = F_247 ( V_560 , V_11 , V_72 , V_56 ) ;
...
V_57 = F_14 ( V_11 , F_17 ( V_11 , 0 ) ,
V_564 , 0 ,
V_11 -> V_8 -> V_283 . V_558 , 0 ,
NULL , 0 , V_203 ) ;
if ( V_57 < 0 ) {
F_30 ( & V_11 -> V_22 ,
L_199 ,
V_11 -> V_8 -> V_283 . V_558 , V_57 ) ;
F_31 ( V_159 -> V_479 ) ;
goto V_563;
}
F_31 ( V_159 -> V_479 ) ;
F_73 ( V_11 , V_91 ) ;
for ( V_56 = 0 ; V_56 < V_11 -> V_8 -> V_283 . V_565 ; V_56 ++ ) {
struct V_566 * V_355 = V_11 -> V_8 ;
...
V_123 -> V_569 = 1 ;
V_57 = F_99 ( V_11 , V_283 -> V_570 ,
V_283 -> V_568 ) ;
V_123 -> V_569 = 0 ;
}
if ( V_57 < 0 ) {
F_30 ( & V_11 -> V_22 , L_200
L_201 ,
V_283 -> V_570 ,
V_283 -> V_568 ,
V_57 ) ;
...
for ( V_494 = 0 ; V_494 < V_123 -> V_296 -> V_283 . V_305 ; V_494 ++ )
V_123 -> V_296 -> V_235 [ V_494 ] . V_571 = 0 ;
}
V_408:
F_211 ( V_11 , 1 ) ;
F_213 ( V_11 ) ;
...
F_186 ( V_11 ) ;
if ( V_355 ) {
for ( V_56 = 0 ; V_56 < V_355 -> V_283 . V_565 ; ++ V_56 ) {
struct V_122 * V_573 = V_355 -> V_10 [ V_56 ] ;
struct V_574 * V_158 ;
int V_575 = 0 ;
if ( V_573 -> V_22 . V_160 ) {
V_158 = F_285 ( V_573 -> V_22 . V_160 ) ;
if ( V_158 -> V_576 && V_158 -> V_577 )
V_575 = ( V_158 -> V_576 ) ( V_573 ) ;
else if ( V_573 -> V_578 ==
V_579 )
V_575 = 1 ;
if ( V_575 )
...
F_200 ( V_81 ) ;
if ( V_355 ) {
for ( V_56 = V_355 -> V_283 . V_565 - 1 ; V_56 >= 0 ; -- V_56 ) {
struct V_122 * V_573 = V_355 -> V_10 [ V_56 ] ;
struct V_574 * V_158 ;
int V_580 = V_573 -> V_581 ;
if ( ! V_580 && V_573 -> V_22 . V_160 ) {
V_158 = F_285 ( V_573 -> V_22 . V_160 ) ;
if ( V_158 -> V_577 )
V_580 = ( V_158 -> V_577 ) ( V_573 ) ;
else if ( V_573 -> V_578 ==
V_579 )
V_580 = 1 ;
if ( V_580 )
...
if ( V_371 == V_374 ) {
T_2 V_585 = 1 << ( V_56 % 8 ) ;
if ( ! ( V_283 -> V_37 . V_251 . V_252 [ V_56 / 8 ] & V_585 ) ) {
F_22 ( & V_81 -> V_22 , L_203 ) ;
V_283 -> V_37 . V_251 . V_252 [ V_56 / 8 ] |= V_585 ;
}
}
}
} else {
T_1 V_586 = F_12 ( V_283 -> V_37 . V_38 . V_252 ) ;
for ( V_56 = 1 ; V_56 <= V_4 -> V_9 ; V_56 ++ ) {
struct V_80 * V_81 = V_2 -> V_82 [ V_56 - 1 ] ;
V_371 = V_81 -> V_371 ;
if ( V_371 == V_374 ) {
...
V_283 -> V_37 . V_38 . V_252 = F_230 ( V_586 ) ;
}
}
