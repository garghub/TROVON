...
static int F_20 ( const struct V_47 * V_48 ,
struct V_1 * V_2 )
{
int V_15 ;
do {
...
V_49 , L_6 ) ;
} while ( V_15 == - V_50 || V_15 == - V_51 );
return V_15 ;
}
static int F_21 ( const struct V_47 * V_48 ,
struct V_1 * V_2 , T_2 * V_52 )
{
int V_15 ;
F_22 ( F_14 ( & V_2 -> V_24 ) ) ;
if ( F_17 ( & V_2 -> V_24 ) ) {
...
* V_61 = V_2 -> V_64 ;
F_27 ( & V_2 -> V_58 ) ;
F_23 ( V_38 , L_12 V_70 L_2 , V_2 -> V_45 , F_38 ( V_61 ) ) ;
return V_15 ;
}
...
{
int V_15 ;
V_2 -> V_71 = F_45 ( V_2 -> V_45 ,
V_72 ,
NULL , NULL ) ;
if ( F_42 ( V_2 -> V_71 ) ) {
F_15 ( L_13 , V_2 -> V_45 ) ;
V_15 = V_2 -> V_71 ? F_46 ( V_2 -> V_71 )
: - V_19 ;
V_2 -> V_71 = NULL ;
return V_15 ;
}
...
int F_54 ( struct V_79 * V_80 ,
struct V_7 * exp , enum V_75 type )
{
struct V_81 * V_41 = & V_80 -> V_40 . V_41 ;
char * V_76 ;
int V_15 ;
V_41 -> V_82 = F_55 ( sizeof( * V_41 -> V_82 ) , V_83 ) ;
if ( ! V_41 -> V_82 )
return - V_19 ;
V_76 = F_55 ( V_84 + 5 , V_83 ) ;
if ( ! V_76 ) {
V_15 = - V_19 ;
goto V_85;
}
snprintf ( V_76 , V_84 + 5 , L_15 , V_80 -> V_86 ) ;
V_15 = F_50 ( V_41 -> V_82 , exp , type , V_76 ) ;
F_56 ( V_76 ) ;
if ( V_15 )
goto V_85;
return V_15 ;
