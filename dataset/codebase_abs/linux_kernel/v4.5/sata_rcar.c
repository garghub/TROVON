...
V_2 -> V_201 = F_73 ( & V_191 -> V_94 , NULL ) ;
if ( F_74 ( V_2 -> V_201 ) ) {
F_75 ( & V_191 -> V_94 , L_16 ) ;
return F_76 ( V_2 -> V_201 ) ;
}
F_77 ( V_2 -> V_201 ) ;
V_37 = F_78 ( & V_191 -> V_94 , 1 ) ;
if ( ! V_37 ) {
F_75 ( & V_191 -> V_94 , L_17 ) ;
V_196 = - V_198 ;
goto V_202;
}
V_37 -> V_38 = V_2 ;
V_195 = F_79 ( V_191 , V_203 , 0 ) ;
V_2 -> V_3 = F_80 ( & V_191 -> V_94 , V_195 ) ;
if ( F_74 ( V_2 -> V_3 ) ) {
V_196 = F_76 ( V_2 -> V_3 ) ;
goto V_202;
}
...
static int F_86 ( struct V_51 * V_94 )
{
struct V_153 * V_37 = F_87 ( V_94 ) ;
struct V_1 * V_2 = V_37 -> V_38 ;
void T_1 * V_3 = V_2 -> V_3 ;
int V_196 ;
V_196 = F_88 ( V_37 , V_205 ) ;
if ( ! V_196 ) {
F_2 ( 0 , V_3 + V_189 ) ;
F_2 ( 0x7ff , V_3 + V_39 ) ;
F_82 ( V_2 -> V_201 ) ;
...
static int F_89 ( struct V_51 * V_94 )
{
struct V_153 * V_37 = F_87 ( V_94 ) ;
struct V_1 * V_2 = V_37 -> V_38 ;
void T_1 * V_3 = V_2 -> V_3 ;
...
static int F_91 ( struct V_51 * V_94 )
{
struct V_153 * V_37 = F_87 ( V_94 ) ;
struct V_1 * V_2 = V_37 -> V_38 ;
F_77 ( V_2 -> V_201 ) ;
