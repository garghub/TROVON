...
static unsigned int F_26 ( struct V_2 * V_2 ,
struct V_58 * V_59 )
{
struct V_3 * V_4 = V_2 -> V_22 ;
unsigned int V_60 ;
F_27 ( V_2 , & V_4 -> V_15 , V_59 ) ;
V_60 = 0 ;
...
static int F_30 ( struct V_3 * V_4 , char * args )
{
unsigned long V_35 ;
F_2 ( L_10 , args ) ;
if ( ! * args )
return - V_53 ;
V_35 = F_31 ( args , & args , 10 ) ;
if ( args [ 0 ] != '%' || args [ 1 ] != '\0' )
return - V_53 ;
if ( V_35 <= V_4 -> V_17 || V_35 >= 100 )
return F_28 ( V_4 , args ) ;
V_4 -> V_16 = V_35 ;
return 0 ;
}
...
static int F_49 ( struct V_3 * V_4 , char * args )
{
struct V_68 V_68 ;
const struct V_69 * V_70 ;
int V_47 ;
