...
T_8 V_102 = F_50 ( V_101 -> V_103 ) ;
T_8 V_104 = F_50 ( V_101 -> V_105 ) ;
T_8 V_106 = F_50 ( V_101 -> V_107 ) ;
if ( ( V_101 -> V_108 & V_109 ) != V_110 ||
( V_101 -> V_108 & V_111 ) != V_112 )
return false ;
switch ( V_101 -> V_113 ) {
case V_114 :
V_102 >>= 8 ;
...
int V_122 = - V_123 ;
T_8 V_103 = F_50 ( V_101 -> V_103 ) ;
T_8 V_105 = F_50 ( V_101 -> V_105 ) ;
T_8 V_107 = F_50 ( V_101 -> V_107 ) ;
F_14 ( V_22 , L_23 ,
V_101 -> V_108 , V_101 -> V_113 , V_105 , V_103 , V_107 ) ;
switch ( V_101 -> V_108 & V_111 ) {
case V_112 :
switch ( V_101 -> V_113 ) {
case V_114 :
if ( ( V_103 >> 8 ) != V_22 -> V_97 )
break;
V_122 = ( V_22 -> V_124 [ 0 ] << 8 ) | V_22 -> V_124 [ 1 ] ;
memcpy ( V_19 -> V_21 , V_22 -> V_124 , V_122 ) ;
...
F_16 ( V_22 ,
L_25 ,
V_101 -> V_108 , V_101 -> V_113 ,
V_105 , V_103 , V_107 ) ;
break;
}
if ( V_122 >= 0 ) {
V_19 -> V_20 = V_122 ;
V_19 -> V_71 = V_122 < V_107 ;
...
int V_88 ;
F_29 ( & V_162 -> V_26 ) ;
V_88 = F_73 ( V_163 , V_162 -> V_124 + 2 , V_115 - 2 ) ;
F_30 ( & V_162 -> V_26 ) ;
return V_88 ;
}
...
int V_88 , V_164 ;
F_29 ( & V_162 -> V_26 ) ;
V_88 = F_73 ( V_162 -> V_124 + 2 , V_163 , V_115 - 2 ) ;
V_164 = strlen ( V_162 -> V_124 + 2 ) + 2 ;
V_162 -> V_124 [ 0 ] = ( V_164 >> 8 ) & 0xFF ;
V_162 -> V_124 [ 1 ] = V_164 & 0xFF ;
F_30 ( & V_162 -> V_26 ) ;
return V_88 ;
}
static T_2 F_75 ( struct V_158 * V_159 ,
char * V_163 )
{
struct V_157 * V_162 = F_68 ( V_159 ) ;
int V_88 ;
...
V_44 = F_77 ( V_163 , 0 , & V_165 ) ;
if ( V_44 )
goto V_75;
V_162 -> V_143 = ( unsigned ) V_165 ;
V_44 = V_17 ;
V_75:
F_30 ( & V_162 -> V_26 ) ;
return V_44 ;
...
static inline void F_81 ( int V_148 )
{
F_80 ( & V_167 , V_148 ) ;
}
static void F_82 ( struct V_169 * V_3 )
{
struct V_157 * V_162 ;
...
static struct V_169 * F_85 ( void )
{
struct V_157 * V_162 ;
struct V_169 * V_44 ;
int V_24 = 0 ;
V_162 = F_86 ( sizeof( * V_162 ) , V_144 ) ;
if ( ! V_162 )
return F_87 ( - V_142 ) ;
F_88 ( & V_162 -> V_26 ) ;
V_162 -> V_160 . V_172 = F_82 ;
V_44 = & V_162 -> V_160 ;
F_29 ( & V_170 ) ;
if ( F_83 ( & V_167 . V_171 ) ) {
V_24 = F_89 ( V_168 ) ;
...
V_162 -> V_148 = F_78 () ;
if ( V_162 -> V_148 < 0 ) {
V_44 = F_87 ( V_162 -> V_148 ) ;
F_9 ( V_162 ) ;
if ( F_83 ( & V_167 . V_171 ) )
F_84 () ;
goto V_173;
}
F_90 ( & V_162 -> V_160 . V_161 , L_32 ,
& V_174 ) ;
V_173:
F_30 ( & V_170 ) ;
return V_44 ;
...
struct V_1 * V_22 = F_1 ( V_3 ) ;
struct V_157 * V_162 ;
V_162 = F_2 ( V_3 -> V_175 , struct V_157 , V_160 ) ;
F_9 ( V_22 ) ;
F_29 ( & V_162 -> V_26 ) ;
-- V_162 -> V_166 ;
F_30 ( & V_162 -> V_26 ) ;
...
static struct V_2 * F_96 ( struct V_169 * V_175 )
{
struct V_1 * V_22 ;
struct V_157 * V_162 ;
V_162 = F_2 ( V_175 , struct V_157 , V_160 ) ;
F_29 ( & V_162 -> V_26 ) ;
if ( V_162 -> V_148 >= V_176 ) {
F_30 ( & V_162 -> V_26 ) ;
return F_87 ( - V_177 ) ;
}
V_22 = F_86 ( sizeof( * V_22 ) , V_144 ) ;
if ( ! V_22 ) {
F_30 ( & V_162 -> V_26 ) ;
return F_87 ( - V_142 ) ;
}
...
static int F_89 ( int V_186 )
{
int V_24 ;
T_9 V_131 ;
V_149 = F_100 ( V_152 , L_34 ) ;
if ( F_60 ( V_149 ) ) {
V_24 = F_61 ( V_149 ) ;
V_149 = NULL ;
F_101 ( L_35 , V_24 ) ;
