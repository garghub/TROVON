...
static void F_36 ( struct V_16 * V_2 )
{
struct V_1 * V_30 = F_19 ( V_2 ) ;
struct V_8 * V_31 = F_37 ( V_30 ) ;
...
static int F_41 ( struct V_1 * V_30 )
{
struct V_18 * V_19 = NULL ;
struct V_16 * V_2 = & V_30 -> V_2 ;
F_14 ( V_2 , & V_19 ,
V_44 , F_42 ( V_44 ) ) ;
return F_43 ( V_2 , & V_45 , V_19 ) ;
}
static int F_44 ( struct V_1 * V_30 )
{
F_45 ( & V_30 -> V_2 , & V_45 ) ;
return 0 ;
}
...
{
int V_23 , V_34 ;
for ( V_23 = 0 ; V_23 < F_42 ( V_44 ) ; V_23 ++ ) {
V_34 = F_47 ( V_44 [ V_23 ] ) ;
if ( V_34 ) {
while ( -- V_23 >= 0 )
F_48 ( V_44 [ V_23 ] ) ;
...
{
int V_23 ;
for ( V_23 = F_42 ( V_44 ) - 1 ; V_23 >= 0 ; V_23 -- )
F_48 ( V_44 [ V_23 ] ) ;
F_48 ( & V_46 ) ;
}
