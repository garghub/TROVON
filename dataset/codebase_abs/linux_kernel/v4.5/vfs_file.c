...
int F_56 ( struct V_2 * V_26 , T_3 V_48 , T_3 V_86 ,
int V_87 )
{
struct V_8 * V_9 ;
struct V_1 * V_1 = V_26 -> V_88 -> V_89 ;
...
static int
F_58 ( struct V_2 * V_26 , struct V_92 * V_93 )
{
int V_79 ;
V_79 = F_59 ( V_26 , V_93 ) ;
if ( ! V_79 )
...
static int
F_60 ( struct V_2 * V_26 , struct V_92 * V_93 )
{
int V_79 ;
struct V_1 * V_1 ;
struct V_4 * V_5 ;
...
static int
F_61 ( struct V_92 * V_93 , struct V_99 * V_100 )
{
struct V_4 * V_5 ;
struct V_101 * V_101 = V_100 -> V_101 ;
struct V_2 * V_26 = V_93 -> V_102 ;
struct V_1 * V_1 = F_20 ( V_26 ) ;
F_2 ( V_11 , L_7 ,
V_101 , ( unsigned long ) V_26 -> V_13 ) ;
F_62 ( V_26 ) ;
V_5 = F_3 ( V_1 ) ;
F_63 ( V_1 , V_101 ) ;
F_27 ( ! V_5 -> V_22 ) ;
F_64 ( V_101 ) ;
if ( V_101 -> V_103 != V_1 -> V_34 )
goto V_60;
F_65 ( V_101 ) ;
return V_104 ;
V_60:
...
static T_2
F_67 ( struct V_72 * V_73 , struct V_74 * V_75 )
{
return F_40 ( V_73 , V_75 ) ;
}
static T_2
F_68 ( struct V_72 * V_73 , struct V_74 * V_78 )
{
...
. V_108 = V_109 ,
. V_110 = V_111 ,
. V_112 = V_93 -> V_113 * V_114 ,
. V_115 = V_93 -> V_113 * V_114 +
( V_93 -> V_116 - V_93 -> V_117 - 1 ) ,
} ;
F_2 ( V_11 , L_8 , V_93 ) ;
V_1 = F_20 ( V_93 -> V_102 ) ;
if ( ! F_70 ( V_1 -> V_34 ) )
