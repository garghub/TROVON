...
{
return F_133 ( V_202 , L_20 ) ;
}
static T_1 F_134 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
if ( ! F_41 ( V_83 ) )
return - V_84 ;
...
static T_1 F_135 ( struct V_61 * V_168 , char T_2 * V_62 ,
T_3 V_174 , T_4 * V_64 )
{
struct V_6 * V_7 ;
T_1 V_25 = - V_60 ;
...
static T_1 F_136 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
char * V_54 ;
struct V_6 * V_7 ;
...
static void * F_137 ( struct V_74 * V_75 , T_4 * V_76 )
{
struct V_193 * V_194 = F_113 () ;
return F_24 ( V_75 , V_76 , & V_194 -> V_205 ) ;
}
static void * F_138 ( struct V_74 * V_75 , void * V_78 , T_4 * V_76 )
{
struct V_193 * V_194 = F_113 () ;
return F_28 ( V_75 , V_78 , V_76 , & V_194 -> V_205 ) ;
}
static int F_139 ( struct V_74 * V_75 , void * V_78 )
{
struct V_15 * V_34 = V_78 ;
struct V_178 * V_179 =
...
static int F_140 ( struct V_81 * V_81 , struct V_61 * V_61 )
{
return F_39 ( V_61 , & V_206 ) ;
}
static T_1 F_141 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
struct V_193 * V_194 = F_113 () ;
char * V_54 ;
...
if ( ! V_25 || ( V_25 == - V_60 && F_68 ( & V_188 ) ) ) {
F_103 ( & V_194 -> V_205 ) ;
F_142 ( & V_188 , & V_194 -> V_205 ) ;
return V_63 ;
}
F_103 ( & V_188 ) ;
return V_25 ;
}
static T_1 F_143 ( struct V_61 * V_168 , char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
char V_169 [ 32 ] ;
T_1 V_25 ;
...
static T_1 F_144 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
char V_169 [ 32 ] ;
int V_59 ;
...
static int F_145 ( struct V_210 * V_211 , void * V_54 , int V_212 )
{
int V_25 ;
struct V_81 * V_213 ;
...
V_25 = F_148 ( V_211 , V_264 , V_215 ) ;
if ( V_25 != 0 ) {
F_44 ( V_265 L_43 ,
V_90 , V_25 ) ;
return V_25 ;
}
V_213 = F_149 ( V_211 -> V_266 ) ;
return 0 ;
}
static struct V_267 * F_150 ( struct V_268 * V_269 ,
int V_270 , const char * V_271 , void * V_54 )
{
return F_151 ( V_269 , V_270 , V_54 , F_145 ) ;
}
static int T_7 F_152 ( struct V_6 * V_7 )
{
