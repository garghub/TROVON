...
V_313 = F_240 ( V_65 -> V_2 , V_357 ,
V_295 -> V_206 . V_207 , V_6 ,
V_65 , V_7 , V_388 ) ;
if ( V_313 == 0 ) {
F_241 ( V_65 -> V_2 , V_6 ,
V_295 -> V_206 . V_207 ) ;
F_242 ( V_65 -> V_2 , V_295 -> V_206 . V_207 , V_388 ) ;
}
}
if ( V_384 && V_295 -> V_364 )
* V_384 |= V_395 ;
if ( F_243 ( V_386 , V_295 -> V_207 . V_261 , V_14 ) ) {
...
static struct V_64 * F_244 ( struct V_2 * V_3 ,
struct V_307 * V_308 ,
int V_219 ,
struct V_5 * V_6 ,
struct V_1 * V_7 ,
...
int V_313 ;
do {
V_313 = F_236 ( V_3 , V_308 , V_219 , V_6 , V_7 , V_384 ) ;
V_56 = V_308 -> V_65 ;
F_245 ( V_308 , V_219 , V_313 ) ;
if ( V_313 == 0 )
break;
if ( V_313 == - V_396 ) {
F_246 ( L_5
...
static int F_247 ( struct V_2 * V_2 , struct V_323 * V_357 ,
...
if ( F_248 ( & V_401 . V_257 , V_2 , V_188 ) ) {
...
if ( ! F_249 ( V_65 ) )
return - V_413 ;
if ( F_250 ( & V_401 . V_257 , V_65 , V_191 ,
& V_408 ) == - V_35 )
return - V_413 ;
} else
...
F_44 ( V_14 , V_115 ) ;
F_251 ( V_2 , & V_401 . V_257 , V_313 ) ;
return V_313 ;
}
static int F_240 ( struct V_2 * V_2 , struct V_323 * V_357 ,
struct V_397 * V_398 , struct V_5 * V_6 ,
struct V_64 * V_65 , struct V_1 * V_399 ,
struct V_1 * V_388 )
{
...
int V_8 ;
do {
V_8 = F_247 ( V_2 , V_357 , V_398 , V_6 , V_65 , V_399 , V_388 ) ;
switch ( V_8 ) {
case - V_69 :
if ( ! ( V_6 -> V_253 & V_406 ) ) {
F_252 ( L_25
...
static bool
F_253 ( struct V_2 * V_2 , struct V_102 * V_103 )
{
if ( V_2 == NULL || ! F_254 ( V_2 ) )
return false ;
return F_255 ( V_2 , V_103 ) ;
}
static void F_256 ( void * V_161 )
{
struct V_416 * V_159 = V_161 ;
struct V_217 * V_218 = V_159 -> V_65 -> V_232 ;
struct V_259 * V_260 = V_159 -> V_65 -> V_2 -> V_417 ;
if ( V_159 -> V_418 )
F_257 ( V_159 -> V_65 -> V_2 ) ;
F_110 ( V_159 -> V_65 ) ;
...
static void F_258 ( struct V_102 * V_103 , void * V_161 )
{
struct V_416 * V_159 = V_161 ;
...
return;
F_259 ( V_65 , & V_159 -> V_401 , & V_159 -> V_56 , V_103 -> V_107 ) ;
switch ( V_103 -> V_107 ) {
case 0 :
...
static void F_261 ( struct V_102 * V_103 , void * V_161 )
{
struct V_416 * V_159 = V_161 ;
struct V_64 * V_65 = V_159 -> V_65 ;
...
int V_425 = 0 ;
F_8 ( L_29 , V_34 ) ;
if ( F_193 ( V_159 -> V_401 . V_209 , V_103 ) != 0 )
goto V_329;
...
static bool F_263 ( struct V_2 * V_2 )
{
if ( ! F_254 ( V_2 ) )
return false ;
return F_264 ( V_2 ) ;
}
int F_265 ( struct V_64 * V_65 , T_6 V_221 , int V_428 )
{
struct V_13 * V_14 = F_94 ( V_65 -> V_2 ) ;
struct V_223 * ( * V_224 ) ( struct V_225 * , T_6 ) ;
struct V_416 * V_159 ;
...
static struct V_2 *
F_267 ( struct V_2 * V_3 , struct V_307 * V_308 ,
int V_234 , struct V_5 * V_433 , int * V_384 )
{
struct V_64 * V_65 ;
struct V_1 V_17 = { 0 , 0 , 0 , NULL } , * V_7 = NULL ;
V_7 = F_1 ( V_3 , V_308 -> V_4 , V_433 , & V_17 ) ;
V_65 = F_244 ( V_3 , V_308 , V_234 , V_433 , V_7 , V_384 ) ;
F_4 ( V_7 ) ;
if ( F_51 ( V_65 ) )
return F_268 ( V_65 ) ;
return V_65 -> V_2 ;
}
static void F_269 ( struct V_307 * V_308 , int V_434 )
{
if ( V_308 -> V_65 == NULL )
return;
if ( V_434 )
F_270 ( V_308 -> V_65 , V_308 -> V_265 ) ;
else
F_173 ( V_308 -> V_65 , V_308 -> V_265 ) ;
}
static int F_271 ( struct V_13 * V_14 , struct V_435 * V_436 )
{
...
int F_273 ( struct V_13 * V_14 , struct V_435 * V_436 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
...
static int F_275 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_475 * V_476 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_274 ( V_14 , V_436 , V_476 ) ;
F_276 ( V_14 , V_436 , V_476 -> V_398 , V_8 ) ;
switch ( V_8 ) {
case 0 :
case - V_22 :
goto V_136;
...
static int F_277 ( struct V_13 * V_14 , struct V_435 * V_436 ,
...
struct V_483 * V_484 ;
int V_51 ;
V_484 = F_278 ( & V_481 , V_14 -> V_98 ) ;
if ( F_51 ( V_484 ) ) {
V_51 = - V_29 ;
goto V_136;
}
V_51 = F_275 ( V_14 , V_436 , V_476 ) ;
V_136:
return V_51 ;
}
static int F_279 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_475 * V_476 )
{
...
for ( V_489 = 0 ; V_489 < F_280 ( V_485 ) ; V_489 ++ ) {
V_313 = F_277 ( V_14 , V_436 , V_476 ,
V_485 [ V_489 ] ) ;
if ( V_313 == - V_22 || V_313 == - V_29 )
continue;
...
static int F_281 ( struct V_13 * V_14 ,
struct V_435 * V_436 , struct V_475 * V_476 )
{
int V_493 = V_14 -> V_62 -> V_438 ;
return V_494 [ V_493 ] -> F_282 ( V_14 , V_436 , V_476 ) ;
}
int F_283 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_475 * V_476 ,
bool V_495 )
{
int V_313 = 0 ;
if ( ! V_495 )
V_313 = F_275 ( V_14 , V_436 , V_476 ) ;
if ( V_495 || V_313 == V_22 )
V_313 = F_281 ( V_14 , V_436 , V_476 ) ;
if ( V_313 == 0 )
V_313 = F_273 ( V_14 , V_436 ) ;
if ( V_313 == 0 )
V_313 = F_284 ( V_14 , V_436 , V_476 ) ;
return F_7 ( V_313 ) ;
}
static int F_285 ( struct V_13 * V_14 , struct V_435 * V_496 ,
struct V_475 * V_476 )
{
int error ;
struct V_397 * V_398 = V_476 -> V_398 ;
struct V_1 * V_7 = NULL ;
error = F_273 ( V_14 , V_496 ) ;
if ( error < 0 ) {
F_8 ( L_32 , - error ) ;
return error ;
}
...
if ( F_51 ( V_7 ) )
return F_78 ( V_7 ) ;
error = F_204 ( V_14 , V_496 , V_398 , V_7 ) ;
if ( error < 0 ) {
F_8 ( L_33 , - error ) ;
goto V_230;
}
if ( V_398 -> V_304 & V_497 &&
! F_286 ( & V_14 -> V_498 , & V_398 -> V_498 ) )
memcpy ( & V_14 -> V_498 , & V_398 -> V_498 , sizeof( V_14 -> V_498 ) ) ;
V_230:
F_104 ( V_7 ) ;
return error ;
}
static int F_287 ( struct V_54 * V_98 , struct V_2 * V_3 ,
...
if ( V_500 == NULL )
goto V_136;
V_502 = F_289 ( sizeof( struct V_501 ) , V_389 ) ;
if ( V_502 == NULL )
goto V_136;
V_313 = F_290 ( V_98 , V_3 , V_247 , V_502 , V_500 ) ;
if ( V_313 != 0 )
goto V_136;
if ( F_286 ( & F_94 ( V_3 ) -> V_498 , & V_502 -> V_398 . V_498 ) ) {
F_8 ( L_34
...
static int F_293 ( struct V_13 * V_14 , struct V_435 * V_436 ,
...
static int F_204 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_397 * V_398 , struct V_1 * V_7 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_293 ( V_14 , V_436 , V_398 , V_7 ) ;
F_294 ( V_14 , V_436 , V_398 , V_8 ) ;
V_8 = F_31 ( V_14 , V_8 ,
& V_61 ) ;
} while ( V_61 . V_68 );
return V_8 ;
...
static int
F_295 ( struct V_4 * V_4 , struct V_397 * V_398 ,
struct V_5 * V_6 )
{
...
if ( F_51 ( V_7 ) )
return F_78 ( V_7 ) ;
V_313 = F_240 ( V_2 , V_357 , V_398 , V_6 , V_65 , NULL , V_7 ) ;
if ( V_313 == 0 ) {
F_241 ( V_2 , V_6 , V_398 ) ;
F_242 ( V_2 , V_398 , V_7 ) ;
}
...
static int F_300 ( struct V_54 * V_55 , struct V_2 * V_3 ,
...
static void F_301 ( struct V_397 * V_398 )
{
...
static int F_302 ( struct V_54 * * V_55 , struct V_2 * V_3 ,
...
int V_8 ;
do {
V_8 = F_300 ( V_98 , V_3 , V_247 , V_436 , V_398 , V_7 ) ;
F_303 ( V_3 , V_247 , V_8 ) ;
switch ( V_8 ) {
case - V_26 :
V_8 = - V_309 ;
goto V_136;
case - V_77 :
V_8 = F_287 ( V_98 , V_3 , V_247 , V_398 , V_436 ) ;
if ( V_8 == - V_77 )
...
static int F_306 ( struct V_2 * V_3 , struct V_499 * V_247 ,
struct V_435 * V_436 , struct V_397 * V_398 ,
struct V_1 * V_7 )
{
int V_313 ;
struct V_54 * V_98 = F_307 ( V_3 ) ;
V_313 = F_302 ( & V_98 , V_3 , V_247 , V_436 , V_398 , V_7 ) ;
if ( V_98 != F_307 ( V_3 ) ) {
F_305 ( V_98 ) ;
F_301 ( V_398 ) ;
}
...
struct V_54 *
F_308 ( struct V_2 * V_3 , struct V_499 * V_247 ,
struct V_435 * V_436 , struct V_397 * V_398 )
{
struct V_54 * V_98 = F_307 ( V_3 ) ;
int V_313 ;
V_313 = F_302 ( & V_98 , V_3 , V_247 , V_436 , V_398 , NULL ) ;
if ( V_313 < 0 )
return F_52 ( V_313 ) ;
return ( V_98 == F_307 ( V_3 ) ) ? F_309 ( V_98 ) : V_98 ;
}
static int F_310 ( struct V_2 * V_2 , struct V_358 * V_519 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
struct V_520 args = {
. V_251 = F_102 ( V_2 ) ,
...
V_313 = F_80 ( V_14 -> V_98 , V_14 , & V_166 , & args . V_163 , & V_56 . V_164 , 0 ) ;
if ( ! V_313 ) {
F_201 ( V_519 , V_56 . V_214 ) ;
F_159 ( V_2 , V_56 . V_398 ) ;
}
F_313 ( V_56 . V_398 ) ;
return V_313 ;
}
static int F_314 ( struct V_2 * V_2 , struct V_358 * V_519 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
...
static int F_317 ( struct V_2 * V_2 , struct V_500 * V_500 ,
unsigned int V_48 , unsigned int V_527 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_316 ( V_2 , V_500 , V_48 , V_527 ) ;
F_318 ( V_2 , V_8 ) ;
V_8 = F_31 ( F_94 ( V_2 ) , V_8 ,
& V_61 ) ;
} while ( V_61 . V_68 );
...
static int
F_319 ( struct V_2 * V_3 , struct V_4 * V_4 , struct V_5 * V_6 ,
int V_219 )
{
...
struct V_64 * V_65 ;
int V_313 = 0 ;
V_308 = F_320 ( V_4 , V_190 ) ;
if ( F_51 ( V_308 ) )
return F_78 ( V_308 ) ;
V_399 = F_1 ( V_3 , V_4 , V_6 , & V_17 ) ;
V_6 -> V_10 &= ~ F_321 () ;
V_65 = F_244 ( V_3 , V_308 , V_219 , V_6 , V_399 , NULL ) ;
if ( F_51 ( V_65 ) ) {
V_313 = F_78 ( V_65 ) ;
goto V_136;
}
...
static int F_323 ( struct V_2 * V_3 , struct V_499 * V_247 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
...
static void F_325 ( struct V_165 * V_166 , struct V_2 * V_3 )
{
struct V_13 * V_14 = F_94 ( V_3 ) ;
...
static void F_326 ( struct V_102 * V_103 , struct V_535 * V_161 )
{
F_70 ( F_94 ( V_161 -> V_3 ) ,
& V_161 -> args . V_163 ,
& V_161 -> V_56 . V_164 ,
...
static int F_327 ( struct V_102 * V_103 , struct V_2 * V_3 )
{
...
static void F_328 ( struct V_165 * V_166 , struct V_2 * V_3 )
{
struct V_13 * V_14 = F_94 ( V_3 ) ;
...
static void F_329 ( struct V_102 * V_103 , struct V_540 * V_161 )
{
...
static int F_330 ( struct V_102 * V_103 , struct V_2 * V_541 ,
struct V_2 * V_542 )
{
...
static int F_331 ( struct V_2 * V_2 , struct V_2 * V_3 , struct V_499 * V_247 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
struct V_545 V_401 = {
. V_251 = F_102 ( V_2 ) ,
...
if ( ! V_313 ) {
F_81 ( V_3 , & V_56 . V_175 ) ;
V_313 = F_332 ( V_2 , V_56 . V_398 ) ;
if ( ! V_313 )
F_242 ( V_2 , V_56 . V_398 , V_56 . V_7 ) ;
}
F_104 ( V_56 . V_7 ) ;
V_136:
F_313 ( V_56 . V_398 ) ;
...
static int F_333 ( struct V_2 * V_2 , struct V_2 * V_3 , struct V_499 * V_247 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
...
static struct V_548 * F_334 ( struct V_2 * V_3 ,
...
static int F_335 ( struct V_2 * V_3 , struct V_4 * V_4 , struct V_548 * V_161 )
{
int V_313 = F_80 ( F_94 ( V_3 ) -> V_98 , F_94 ( V_3 ) , & V_161 -> V_166 ,
& V_161 -> V_401 . V_163 , & V_161 -> V_56 . V_164 , 1 ) ;
if ( V_313 == 0 ) {
F_81 ( V_3 , & V_161 -> V_56 . V_551 ) ;
V_313 = F_336 ( V_4 , V_161 -> V_56 . V_251 , V_161 -> V_56 . V_398 , V_161 -> V_56 . V_7 ) ;
}
return V_313 ;
}
static void F_337 ( struct V_548 * V_161 )
{
F_104 ( V_161 -> V_7 ) ;
F_105 ( V_161 ) ;
}
...
goto V_136;
V_313 = - V_132 ;
V_161 = F_334 ( V_3 , & V_4 -> V_11 , V_6 , V_554 ) ;
if ( V_161 == NULL )
goto V_136;
...
do {
V_8 = F_338 ( V_3 , V_4 , V_500 , V_12 , V_6 , V_7 ) ;
F_340 ( V_3 , & V_4 -> V_11 , V_8 ) ;
V_8 = F_31 ( F_94 ( V_3 ) , V_8 ,
& V_61 ) ;
} while ( V_61 . V_68 );
F_4 ( V_7 ) ;
...
struct V_548 * V_161 ;
int V_313 = - V_132 ;
V_161 = F_334 ( V_3 , & V_4 -> V_11 , V_6 , V_557 ) ;
if ( V_161 == NULL )
goto V_136;
V_161 -> V_401 . V_7 = V_7 ;
V_313 = F_335 ( V_3 , V_4 , V_161 ) ;
...
V_6 -> V_10 &= ~ F_321 () ;
do {
V_8 = F_341 ( V_3 , V_4 , V_6 , V_7 ) ;
F_343 ( V_3 , & V_4 -> V_11 , V_8 ) ;
V_8 = F_31 ( F_94 ( V_3 ) , V_8 ,
& V_61 ) ;
} while ( V_61 . V_68 );
F_4 ( V_7 ) ;
...
static int F_344 ( struct V_4 * V_4 , struct V_323 * V_357 ,
...
static int F_346 ( struct V_4 * V_4 , struct V_323 * V_357 ,
T_2 V_36 , struct V_500 * * V_42 , unsigned int V_49 , int V_558 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_344 ( V_4 , V_357 , V_36 ,
V_42 , V_49 , V_558 ) ;
F_347 ( F_14 ( V_4 ) , V_8 ) ;
...
static int F_348 ( struct V_2 * V_3 , struct V_4 * V_4 ,
struct V_5 * V_6 , struct V_1 * V_7 , T_10 V_563 )
{
struct V_548 * V_161 ;
int V_265 = V_6 -> V_10 ;
int V_313 = - V_132 ;
V_161 = F_334 ( V_3 , & V_4 -> V_11 , V_6 , V_564 ) ;
if ( V_161 == NULL )
goto V_136;
if ( F_349 ( V_265 ) )
...
V_161 -> V_401 . V_255 . V_567 . V_568 = F_351 ( V_563 ) ;
V_161 -> V_401 . V_255 . V_567 . V_569 = F_352 ( V_563 ) ;
}
else if ( F_353 ( V_265 ) ) {
...
V_6 -> V_10 &= ~ F_321 () ;
do {
V_8 = F_348 ( V_3 , V_4 , V_6 , V_7 , V_563 ) ;
...
static int F_357 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_571 * V_572 )
{
struct V_573 args = {
. V_251 = V_436 ,
...
static int F_358 ( struct V_13 * V_14 , struct V_435 * V_436 , struct V_571 * V_572 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_31 ( V_14 ,
F_357 ( V_14 , V_436 , V_572 ) ,
& V_61 ) ;
} while ( V_61 . V_68 );
return V_8 ;
}
static int F_359 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_475 * V_576 )
{
struct V_577 args = {
. V_251 = V_436 ,
...
static int F_284 ( struct V_13 * V_14 , struct V_435 * V_436 , struct V_475 * V_576 )
{
struct V_60 V_61 = { } ;
unsigned long V_580 = V_157 ;
int V_8 ;
do {
V_8 = F_359 ( V_14 , V_436 , V_576 ) ;
F_360 ( V_14 , V_436 , V_576 -> V_398 , V_8 ) ;
if ( V_8 == 0 ) {
struct V_62 * V_63 = V_14 -> V_62 ;
F_41 ( & V_63 -> V_116 ) ;
...
static int F_361 ( struct V_13 * V_14 , struct V_435 * V_436 , struct V_475 * V_576 )
{
int error ;
F_90 ( V_576 -> V_398 ) ;
error = F_284 ( V_14 , V_436 , V_576 ) ;
if ( error == 0 ) {
V_14 -> V_583 = V_576 -> V_584 ;
F_362 ( V_14 , V_436 , V_576 -> V_585 ) ;
}
return error ;
}
...
static int F_364 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_586 * V_587 )
{
struct V_60 V_61 = { } ;
int V_8 ;
...
if ( V_593 != NULL )
V_408 = & V_593 -> V_408 ;
return F_250 ( V_257 , V_308 -> V_65 , V_188 , V_408 ) ;
}
static bool F_366 ( T_8 * V_257 ,
const struct V_307 * V_308 ,
const struct V_592 * V_593 ,
T_5 V_188 )
{
T_8 V_594 ;
if ( F_365 ( & V_594 , V_308 , V_593 , V_188 ) == - V_35 )
return true ;
return F_146 ( V_257 , & V_594 ) ;
}
static bool F_367 ( int V_8 )
{
switch ( V_8 ) {
case - V_70 :
case - V_71 :
...
void F_368 ( struct V_595 * V_596 )
{
F_345 ( V_596 -> V_2 ) ;
}
static int F_369 ( struct V_102 * V_103 , struct V_595 * V_596 )
{
struct V_13 * V_14 = F_94 ( V_596 -> V_2 ) ;
F_370 ( V_596 , V_103 -> V_107 ) ;
if ( F_38 ( V_103 , V_14 ,
...
static bool F_371 ( struct V_102 * V_103 ,
struct V_598 * args )
{
if ( ! F_367 ( V_103 -> V_107 ) ||
F_366 ( & args -> V_257 ,
args -> V_597 ,
args -> V_599 ,
V_190 ) )
...
static int F_372 ( struct V_102 * V_103 , struct V_595 * V_596 )
{
F_8 ( L_11 , V_34 ) ;
if ( ! F_67 ( V_103 , & V_596 -> V_56 . V_164 ) )
return - V_108 ;
if ( F_371 ( V_103 , & V_596 -> args ) )
return - V_108 ;
return V_596 -> V_600 ? V_596 -> V_600 ( V_103 , V_596 ) :
F_369 ( V_103 , V_596 ) ;
}
static void F_373 ( struct V_595 * V_596 ,
struct V_165 * V_166 )
{
V_596 -> V_115 = V_157 ;
V_596 -> V_600 = F_369 ;
...
static int F_374 ( struct V_102 * V_103 ,
struct V_595 * V_596 )
{
...
V_103 ) )
return 0 ;
if ( F_365 ( & V_596 -> args . V_257 , V_596 -> args . V_597 ,
V_596 -> args . V_599 ,
V_596 -> V_602 -> V_603 ) == - V_35 )
return - V_35 ;
if ( F_375 ( F_33 ( V_604 , & V_596 -> args . V_597 -> V_219 ) ) )
return - V_35 ;
return 0 ;
}
static int F_376 ( struct V_102 * V_103 ,
struct V_595 * V_596 )
{
struct V_2 * V_2 = V_596 -> V_2 ;
F_377 ( V_596 , V_103 -> V_107 ) ;
...
static bool F_379 ( struct V_102 * V_103 ,
struct V_598 * args )
{
if ( ! F_367 ( V_103 -> V_107 ) ||
F_366 ( & args -> V_257 ,
...
static int F_380 ( struct V_102 * V_103 , struct V_595 * V_596 )
{
if ( ! F_67 ( V_103 , & V_596 -> V_56 . V_164 ) )
return - V_108 ;
if ( F_379 ( V_103 , & V_596 -> args ) )
return - V_108 ;
return V_596 -> V_600 ? V_596 -> V_600 ( V_103 , V_596 ) :
F_376 ( V_103 , V_596 ) ;
}
static
bool F_381 ( struct V_595 * V_596 )
{
if ( V_596 -> V_605 != NULL || V_596 -> V_606 != NULL )
return false ;
return F_382 ( V_596 -> V_2 , V_190 ) == 0 ;
}
static void F_383 ( struct V_595 * V_596 ,
struct V_165 * V_166 )
{
struct V_13 * V_14 = F_94 ( V_596 -> V_2 ) ;
if ( ! F_381 ( V_596 ) ) {
...
static void F_384 ( struct V_102 * V_103 , struct V_608 * V_161 )
{
F_70 ( F_94 ( V_161 -> V_2 ) ,
& V_161 -> args . V_163 ,
& V_161 -> V_56 . V_164 ,
...
static int F_385 ( struct V_102 * V_103 , struct V_608 * V_161 )
{
struct V_2 * V_2 = V_161 -> V_2 ;
F_386 ( V_161 , V_103 -> V_107 ) ;
if ( F_38 ( V_103 , F_94 ( V_2 ) ,
NULL , NULL ) == - V_108 ) {
F_65 ( V_103 ) ;
return - V_108 ;
...
static int F_387 ( struct V_102 * V_103 , struct V_608 * V_161 )
{
if ( ! F_67 ( V_103 , & V_161 -> V_56 . V_164 ) )
return - V_108 ;
return V_161 -> V_609 ( V_103 , V_161 ) ;
}
static void F_388 ( struct V_608 * V_161 , struct V_165 * V_166 )
{
...
static void F_389 ( void * V_159 )
{
struct V_611 * V_161 = V_159 ;
struct V_62 * V_63 = V_161 -> V_98 ;
if ( F_390 ( & V_63 -> V_612 ) > 1 )
F_391 ( V_63 ) ;
F_392 ( V_63 ) ;
F_105 ( V_161 ) ;
}
static void F_393 ( struct V_102 * V_103 , void * V_159 )
{
struct V_611 * V_161 = V_159 ;
struct V_62 * V_63 = V_161 -> V_98 ;
unsigned long V_115 = V_161 -> V_115 ;
F_394 ( V_63 , V_103 -> V_107 ) ;
switch ( V_103 -> V_107 ) {
case 0 :
break;
case - V_78 :
...
static int F_396 ( struct V_62 * V_63 , struct V_323 * V_357 , unsigned V_616 )
{
struct V_165 V_166 = {
. V_318 = & V_319 [ V_617 ] ,
. V_321 = V_63 ,
...
if ( ! F_397 ( & V_63 -> V_612 ) )
return - V_35 ;
V_161 = F_289 ( sizeof( * V_161 ) , V_310 ) ;
if ( V_161 == NULL )
return - V_132 ;
V_161 -> V_98 = V_63 ;
V_161 -> V_115 = V_157 ;
return F_398 ( V_63 -> V_110 , & V_166 , V_618 ,
& V_619 , V_161 ) ;
}
static int F_399 ( struct V_62 * V_63 , struct V_323 * V_357 )
{
struct V_165 V_166 = {
. V_318 = & V_319 [ V_617 ] ,
. V_321 = V_63 ,
...
unsigned long V_580 = V_157 ;
int V_313 ;
V_313 = F_400 ( V_63 -> V_110 , & V_166 , V_618 ) ;
if ( V_313 < 0 )
return V_313 ;
F_40 ( V_63 , V_580 ) ;
return 0 ;
}
static inline int F_401 ( struct V_13 * V_14 )
{
return V_14 -> V_94 & V_451 ;
}
static int F_402 ( const void * V_620 , T_9 V_621 ,
struct V_500 * * V_42 )
{
...
V_623 = V_42 ;
do {
V_12 = F_403 ( T_9 , V_625 , V_621 ) ;
V_622 = F_288 ( V_389 ) ;
if ( V_622 == NULL )
goto V_626;
memcpy ( F_404 ( V_622 ) , V_620 , V_12 ) ;
V_620 += V_12 ;
V_621 -= V_12 ;
* V_42 ++ = V_622 ;
V_624 ++ ;
...
static void F_405 ( struct V_2 * V_2 , struct V_627 * V_628 )
{
...
static void F_406 ( struct V_2 * V_2 )
{
F_405 ( V_2 , NULL ) ;
}
static inline T_11 F_407 ( struct V_2 * V_2 , char * V_620 , T_9 V_621 )
{
struct V_176 * V_177 = F_82 ( V_2 ) ;
struct V_627 * V_628 ;
int V_51 = - V_309 ;
...
static void F_408 ( struct V_2 * V_2 , struct V_500 * * V_42 , T_9 V_48 , T_9 V_633 )
{
struct V_627 * V_628 ;
T_9 V_621 = sizeof( * V_628 ) + V_633 ;
if ( V_621 <= V_625 ) {
V_628 = F_289 ( V_621 , V_389 ) ;
if ( V_628 == NULL )
goto V_136;
V_628 -> V_631 = 1 ;
F_409 ( V_628 -> V_161 , V_42 , V_48 , V_633 ) ;
} else {
V_628 = F_289 ( sizeof( * V_628 ) , V_389 ) ;
if ( V_628 == NULL )
goto V_136;
V_628 -> V_631 = 0 ;
}
...
static T_11 F_410 ( struct V_2 * V_2 , void * V_620 , T_9 V_621 )
{
...
unsigned int V_639 = F_411 ( V_621 , V_625 ) ;
...
V_42 [ V_489 ] = F_288 ( V_389 ) ;
if ( ! V_42 [ V_489 ] )
goto V_317;
}
V_56 . V_640 = F_288 ( V_389 ) ;
if ( ! V_56 . V_640 )
goto V_317;
...
F_408 ( V_2 , V_42 , V_56 . V_644 , V_56 . V_633 ) ;
if ( V_620 ) {
if ( V_56 . V_633 > V_621 ) {
V_51 = - V_632 ;
goto V_317;
}
F_409 ( V_620 , V_42 , V_56 . V_644 , V_56 . V_633 ) ;
}
V_643:
V_51 = V_56 . V_633 ;
V_317:
...
static T_11 F_412 ( struct V_2 * V_2 , void * V_620 , T_9 V_621 )
{
struct V_60 V_61 = { } ;
T_11 V_51 ;
do {
V_51 = F_410 ( V_2 , V_620 , V_621 ) ;
F_413 ( V_2 , V_51 ) ;
if ( V_51 >= 0 )
break;
...
static T_11 F_414 ( struct V_2 * V_2 , void * V_620 , T_9 V_621 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
int V_51 ;
if ( ! F_401 ( V_14 ) )
...
F_416 ( V_2 ) ;
V_51 = F_407 ( V_2 , V_620 , V_621 ) ;
if ( V_51 != - V_309 )
return V_51 ;
return F_412 ( V_2 , V_620 , V_621 ) ;
}
static int F_417 ( struct V_2 * V_2 , const void * V_620 , T_9 V_621 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
...
if ( V_639 > F_280 ( V_42 ) )
return - V_632 ;
V_489 = F_402 ( V_620 , V_621 , V_401 . V_636 ) ;
if ( V_489 < 0 )
return V_489 ;
F_150 ( V_2 ) ;
...
static int F_420 ( struct V_2 * V_2 , const void * V_620 , T_9 V_621 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_417 ( V_2 , V_620 , V_621 ) ;
F_421 ( V_2 , V_8 ) ;
V_8 = F_31 ( F_94 ( V_2 ) , V_8 ,
& V_61 ) ;
} while ( V_61 . V_68 );
...
static int F_423 ( struct V_2 * V_2 , void * V_620 ,
T_9 V_621 )
{
struct V_60 V_61 = { } ;
int V_8 ;
...
static int
F_428 ( struct V_4 * V_4 , const void * V_620 , T_9 V_621 )
{
...
V_313 = F_426 ( V_2 , & V_399 , & V_398 , V_388 ) ;
if ( V_313 == 0 )
F_242 ( V_2 , & V_398 , V_388 ) ;
F_104 ( V_388 ) ;
V_136:
F_222 ( V_357 ) ;
return V_313 ;
}
static void F_430 ( const struct V_62 * V_63 ,
T_12 * V_653 )
{
T_3 V_254 [ 2 ] ;
if ( F_33 ( V_654 , & V_63 -> V_106 ) ) {
V_254 [ 0 ] = 0 ;
V_254 [ 1 ] = F_431 ( V_655 + 1 ) ;
} else {
struct V_656 * V_657 = F_432 ( V_63 -> V_658 , V_659 ) ;
V_254 [ 0 ] = F_431 ( V_657 -> V_660 . V_661 ) ;
V_254 [ 1 ] = F_431 ( V_657 -> V_660 . V_662 ) ;
}
...
return 0 ;
F_144 () ;
V_12 = 14 + strlen ( V_63 -> V_665 ) + 1 +
strlen ( F_434 ( V_63 -> V_110 , V_666 ) ) +
1 +
strlen ( F_434 ( V_63 -> V_110 , V_667 ) ) +
1 ;
F_147 () ;
if ( V_12 > V_668 + 1 )
return - V_27 ;
V_663 = F_289 ( V_12 , V_389 ) ;
if ( ! V_663 )
return - V_132 ;
F_144 () ;
F_435 ( V_663 , V_12 , L_42 ,
V_63 -> V_665 ,
F_434 ( V_63 -> V_110 , V_666 ) ,
F_434 ( V_63 -> V_110 , V_667 ) ) ;
F_147 () ;
V_63 -> V_664 = V_663 ;
return 0 ;
}
...
V_12 = 10 + 10 + 1 + 10 + 1 +
strlen ( V_669 ) + 1 +
strlen ( V_63 -> V_110 -> V_670 ) + 1 ;
if ( V_12 > V_668 + 1 )
return - V_27 ;
V_663 = F_289 ( V_12 , V_389 ) ;
if ( ! V_663 )
return - V_132 ;
F_435 ( V_663 , V_12 , L_43 ,
V_63 -> V_671 -> V_672 , V_63 -> V_438 ,
V_669 ,
V_63 -> V_110 -> V_670 ) ;
V_63 -> V_664 = V_663 ;
return 0 ;
...
static unsigned int
F_438 ( const struct V_62 * V_63 , char * V_620 , T_9 V_12 )
{
if ( strchr ( V_63 -> V_665 , ':' ) != NULL )
return F_435 ( V_620 , V_12 , L_45 ) ;
else
return F_435 ( V_620 , V_12 , L_46 ) ;
}
static void F_439 ( struct V_102 * V_103 , void * V_159 )
{
struct V_673 * V_674 = V_159 ;
if ( V_103 -> V_107 == 0 )
V_674 -> V_675 = F_218 ( V_103 -> V_676 -> V_677 ) ;
}
int F_440 ( struct V_62 * V_63 , T_1 V_678 ,
unsigned short V_679 , struct V_323 * V_357 ,
struct V_680 * V_56 )
{
T_12 V_681 ;
struct V_673 V_682 = {
...
V_682 . V_690 ,
sizeof( V_682 . V_690 ) ) ;
V_682 . V_691 = F_435 ( V_682 . V_692 ,
sizeof( V_682 . V_692 ) , L_47 ,
V_63 -> V_665 , V_679 >> 8 , V_679 & 255 ) ;
F_8 ( L_48 ,
V_63 -> V_110 -> V_111 -> V_693 -> V_694 ,
V_63 -> V_664 ) ;
V_103 = F_77 ( & V_324 ) ;
if ( F_51 ( V_103 ) ) {
V_313 = F_78 ( V_103 ) ;
...
static void F_445 ( struct V_102 * V_103 , void * V_159 )
{
struct V_697 * V_161 = V_159 ;
if ( ! F_67 ( V_103 , & V_161 -> V_56 . V_164 ) )
return;
F_446 ( & V_161 -> args , & V_161 -> V_56 , V_103 -> V_107 ) ;
switch ( V_103 -> V_107 ) {
case 0 :
...
static void F_449 ( struct V_102 * V_103 , void * V_161 )
{
struct V_697 * V_698 ;
V_698 = (struct V_697 * ) V_161 ;
if ( F_253 ( V_698 -> V_2 , V_103 ) )
return;
if ( V_698 -> V_418 )
F_262 ( V_698 -> V_2 , & V_698 -> V_420 ) ;
F_70 ( V_698 -> V_56 . V_14 ,
& V_698 -> args . V_163 ,
& V_698 -> V_56 . V_164 ,
V_103 ) ;
}
static int F_450 ( struct V_2 * V_2 , struct V_323 * V_357 , const T_8 * V_257 , int V_699 )
{
struct V_697 * V_161 ;
struct V_13 * V_14 = F_94 ( V_2 ) ;
struct V_102 * V_103 ;
...
int F_453 ( struct V_2 * V_2 , struct V_323 * V_357 , const T_8 * V_257 , int V_699 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_450 ( V_2 , V_357 , V_257 , V_699 ) ;
F_454 ( V_2 , V_257 , V_8 ) ;
switch ( V_8 ) {
case - V_75 :
case - V_74 :
...
static int F_456 ( struct V_64 * V_65 , int V_703 , struct V_704 * V_705 )
{
...
struct V_289 * V_290 ;
int V_313 ;
V_401 . V_711 . V_241 = V_63 -> V_242 ;
V_313 = F_457 ( V_65 , V_705 ) ;
if ( V_313 != 0 )
goto V_136;
V_290 = V_705 -> V_712 . V_713 . V_232 ;
V_401 . V_711 . V_243 = V_290 -> V_714 . V_246 ;
V_401 . V_711 . V_715 = V_14 -> V_715 ;
V_313 = F_80 ( V_14 -> V_98 , V_14 , & V_166 , & V_401 . V_163 , & V_56 . V_164 , 1 ) ;
switch ( V_313 ) {
case 0 :
V_705 -> V_716 = V_717 ;
...
V_705 -> V_718 -> V_719 ( V_705 ) ;
V_705 -> V_718 = NULL ;
V_136:
return V_313 ;
}
static int F_458 ( struct V_64 * V_65 , int V_703 , struct V_704 * V_705 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
V_8 = F_456 ( V_65 , V_703 , V_705 ) ;
F_459 ( V_705 , V_65 , V_703 , V_8 ) ;
V_8 = F_31 ( F_94 ( V_65 -> V_2 ) , V_8 ,
& V_61 ) ;
} while ( V_61 . V_68 );
return V_8 ;
}
static int F_460 ( struct V_2 * V_2 , struct V_704 * V_707 )
{
return F_461 ( V_2 , V_707 ) ;
}
static struct V_720 * F_462 ( struct V_704 * V_707 ,
struct V_307 * V_308 ,
struct V_289 * V_290 ,
struct V_223 * V_209 )
{
...
V_41 -> V_401 . V_707 = & V_41 -> V_707 ;
V_41 -> V_401 . V_209 = V_209 ;
V_41 -> V_56 . V_209 = V_209 ;
V_41 -> V_290 = V_290 ;
F_99 ( & V_290 -> V_721 ) ;
V_41 -> V_308 = F_168 ( V_308 ) ;
memcpy ( & V_41 -> V_707 , V_707 , sizeof( V_41 -> V_707 ) ) ;
V_41 -> V_14 = F_94 ( V_2 ) ;
return V_41 ;
}
static void F_463 ( void * V_161 )
{
struct V_720 * V_159 = V_161 ;
F_109 ( V_159 -> V_401 . V_209 ) ;
F_464 ( V_159 -> V_290 ) ;
F_180 ( V_159 -> V_308 ) ;
F_105 ( V_159 ) ;
...
F_460 ( V_159 -> V_290 -> V_291 -> V_2 , & V_159 -> V_707 ) ;
...
if ( F_33 ( V_722 , & V_159 -> V_290 -> V_723 ) == 0 ) {
goto V_330;
}
V_159 -> V_115 = V_157 ;
if ( F_70 ( V_159 -> V_14 ,
...
static struct V_102 * F_467 ( struct V_704 * V_707 ,
struct V_307 * V_308 ,
struct V_289 * V_290 ,
struct V_223 * V_209 )
{
...
struct V_167 V_324 = {
. V_169 = F_307 ( V_290 -> V_291 -> V_2 ) ,
. V_165 = & V_166 ,
. V_170 = & V_725 ,
. V_326 = V_327 ,
. V_219 = V_328 ,
} ;
F_266 ( F_94 ( V_290 -> V_291 -> V_2 ) -> V_62 ,
V_430 , & V_324 . V_169 , & V_166 ) ;
V_707 -> V_716 = V_717 ;
V_161 = F_462 ( V_707 , V_308 , V_290 , V_209 ) ;
if ( V_161 == NULL ) {
F_109 ( V_209 ) ;
return F_52 ( - V_132 ) ;
}
...
static int F_468 ( struct V_64 * V_65 , int V_703 , struct V_704 * V_705 )
{
struct V_2 * V_2 = V_65 -> V_2 ;
struct V_217 * V_218 = V_65 -> V_232 ;
struct V_176 * V_177 = F_82 ( V_2 ) ;
...
struct V_223 * ( * V_224 ) ( struct V_225 * , T_6 ) ;
int V_313 = 0 ;
unsigned char V_726 = V_705 -> V_726 ;
V_313 = F_457 ( V_65 , V_705 ) ;
V_705 -> V_726 |= V_727 ;
F_469 ( & V_218 -> V_728 ) ;
F_470 ( & V_177 -> V_729 ) ;
if ( F_460 ( V_2 , V_705 ) == - V_309 ) {
F_471 ( & V_177 -> V_729 ) ;
F_472 ( & V_218 -> V_728 ) ;
goto V_136;
}
...
goto V_136;
V_290 = V_705 -> V_712 . V_713 . V_232 ;
if ( F_33 ( V_722 , & V_290 -> V_723 ) == 0 )
goto V_136;
V_224 = F_94 ( V_2 ) -> V_62 -> V_171 -> V_224 ;
V_209 = V_224 ( & V_290 -> V_714 , V_389 ) ;
V_313 = - V_132 ;
if ( F_51 ( V_209 ) )
goto V_136;
V_103 = F_467 ( V_705 , F_299 ( V_705 -> V_730 ) , V_290 , V_209 ) ;
V_313 = F_78 ( V_103 ) ;
if ( F_51 ( V_103 ) )
goto V_136;
V_313 = F_116 ( V_103 ) ;
...
V_136:
V_705 -> V_726 = V_726 ;
F_473 ( V_705 , V_65 , V_731 , V_313 ) ;
return V_313 ;
}
static struct V_732 * F_474 ( struct V_704 * V_707 ,
...
V_41 -> V_401 . V_251 = F_102 ( V_2 ) ;
V_41 -> V_401 . V_707 = & V_41 -> V_707 ;
V_41 -> V_401 . V_733 = F_475 ( & V_290 -> V_291 -> V_232 -> V_229 , V_221 ) ;
if ( F_51 ( V_41 -> V_401 . V_733 ) )
goto V_317;
V_224 = V_14 -> V_62 -> V_171 -> V_224 ;
V_41 -> V_401 . V_734 = V_224 ( & V_290 -> V_714 , V_221 ) ;
if ( F_51 ( V_41 -> V_401 . V_734 ) )
goto V_735;
V_41 -> V_401 . V_711 . V_241 = V_14 -> V_62 -> V_242 ;
V_41 -> V_401 . V_711 . V_243 = V_290 -> V_714 . V_246 ;
V_41 -> V_401 . V_711 . V_715 = V_14 -> V_715 ;
V_41 -> V_56 . V_734 = V_41 -> V_401 . V_734 ;
V_41 -> V_290 = V_290 ;
V_41 -> V_14 = V_14 ;
F_99 ( & V_290 -> V_721 ) ;
V_41 -> V_308 = F_168 ( V_308 ) ;
...
{
struct V_732 * V_161 = V_159 ;
struct V_64 * V_65 = V_161 -> V_290 -> V_291 ;
F_8 ( L_29 , V_34 ) ;
if ( F_193 ( V_161 -> V_401 . V_734 , V_103 ) != 0 )
goto V_329;
if ( ! F_33 ( V_722 , & V_161 -> V_290 -> V_723 ) ) {
if ( F_193 ( V_161 -> V_401 . V_733 , V_103 ) != 0 ) {
goto V_736;
}
F_136 ( & V_161 -> V_401 . V_278 ,
& V_65 -> V_278 ) ;
V_161 -> V_401 . V_737 = 1 ;
V_161 -> V_56 . V_733 = V_161 -> V_401 . V_733 ;
} else {
V_161 -> V_401 . V_737 = 0 ;
F_136 ( & V_161 -> V_401 . V_738 ,
& V_161 -> V_290 -> V_293 ) ;
}
if ( ! F_249 ( V_65 ) ) {
V_161 -> V_301 = - V_413 ;
...
V_161 -> V_115 ) ;
if ( V_161 -> V_401 . V_740 ) {
V_161 -> V_707 . V_726 &= ~ ( V_741 | V_742 ) ;
if ( F_460 ( V_290 -> V_291 -> V_2 , & V_161 -> V_707 ) < 0 ) {
F_65 ( V_103 ) ;
break;
}
}
if ( V_161 -> V_401 . V_737 != 0 ) {
F_187 ( & V_290 -> V_714 , 0 ) ;
F_136 ( & V_290 -> V_293 , & V_161 -> V_56 . V_257 ) ;
F_133 ( V_722 , & V_290 -> V_723 ) ;
...
& V_290 -> V_291 -> V_278 ) )
F_65 ( V_103 ) ;
} else if ( ! F_146 ( & V_161 -> V_401 . V_738 ,
& V_290 -> V_293 ) )
F_65 ( V_103 ) ;
}
F_8 ( L_30 , V_34 , V_161 -> V_301 ) ;
}
static void F_479 ( void * V_159 )
{
struct V_732 * V_161 = V_159 ;
F_8 ( L_29 , V_34 ) ;
F_109 ( V_161 -> V_401 . V_733 ) ;
if ( V_161 -> V_316 != 0 ) {
struct V_102 * V_103 ;
V_103 = F_467 ( & V_161 -> V_707 , V_161 -> V_308 , V_161 -> V_290 ,
V_161 -> V_401 . V_734 ) ;
if ( ! F_51 ( V_103 ) )
F_480 ( V_103 ) ;
F_8 ( L_53 , V_34 ) ;
...
F_464 ( V_161 -> V_290 ) ;
F_180 ( V_161 -> V_308 ) ;
F_481 ( V_161 -> V_707 . V_730 ) ;
F_105 ( V_161 ) ;
F_8 ( L_31 , V_34 ) ;
}
static void F_482 ( struct V_13 * V_14 , struct V_289 * V_290 , int V_737 , int error )
{
switch ( error ) {
case - V_71 :
case - V_72 :
V_290 -> V_714 . V_219 &= ~ V_743 ;
if ( V_737 != 0 ||
F_33 ( V_722 , & V_290 -> V_723 ) != 0 )
...
static int F_483 ( struct V_64 * V_65 , int V_703 , struct V_704 * V_707 , int V_744 )
{
struct V_732 * V_161 ;
struct V_102 * V_103 ;
struct V_165 V_166 = {
...
int V_51 ;
F_8 ( L_29 , V_34 ) ;
V_161 = F_474 ( V_707 , F_299 ( V_707 -> V_730 ) ,
V_707 -> V_712 . V_713 . V_232 ,
V_744 == V_747 ? V_389 : V_310 ) ;
if ( V_161 == NULL )
return - V_132 ;
if ( F_484 ( V_703 ) )
V_161 -> V_401 . V_748 = 1 ;
...
V_51 = V_161 -> V_301 ;
if ( V_51 )
F_482 ( V_161 -> V_14 , V_161 -> V_290 ,
V_161 -> V_401 . V_737 , V_51 ) ;
} else
V_161 -> V_316 = 1 ;
F_79 ( V_103 ) ;
F_8 ( L_30 , V_34 , V_51 ) ;
F_485 ( V_707 , V_65 , & V_161 -> V_56 . V_257 , V_703 , V_51 ) ;
return V_51 ;
}
static int F_486 ( struct V_64 * V_65 , struct V_704 * V_705 )
{
struct V_13 * V_14 = F_94 ( V_65 -> V_2 ) ;
struct V_60 V_61 = {
. V_2 = V_65 -> V_2 ,
...
if ( F_33 ( V_280 , & V_65 -> V_219 ) != 0 )
return 0 ;
V_8 = F_483 ( V_65 , V_731 , V_705 , V_749 ) ;
if ( V_8 != - V_89 )
break;
F_31 ( V_14 , V_8 , & V_61 ) ;
} while ( V_61 . V_68 );
...
static int F_487 ( struct V_64 * V_65 , struct V_704 * V_705 )
{
struct V_13 * V_14 = F_94 ( V_65 -> V_2 ) ;
struct V_60 V_61 = {
. V_2 = V_65 -> V_2 ,
...
int V_8 ;
V_8 = F_457 ( V_65 , V_705 ) ;
if ( V_8 != 0 )
return V_8 ;
if ( ! V_751 ) {
F_133 ( V_752 , & V_705 -> V_712 . V_713 . V_232 -> V_723 ) ;
return 0 ;
}
do {
if ( F_33 ( V_280 , & V_65 -> V_219 ) != 0 )
return 0 ;
V_8 = F_483 ( V_65 , V_731 , V_705 , V_753 ) ;
switch ( V_8 ) {
default:
goto V_136;
case - V_91 :
...
static int F_490 ( struct V_64 * V_65 , struct V_704 * V_705 )
{
int V_313 = V_370 ;
if ( F_33 ( V_754 , & V_65 -> V_219 ) )
V_313 = F_488 ( V_65 ) ;
if ( V_313 != V_370 )
V_313 = F_487 ( V_65 , V_705 ) ;
return V_313 ;
}
static int F_491 ( struct V_64 * V_65 , int V_703 , struct V_704 * V_705 )
{
struct V_176 * V_177 = F_82 ( V_65 -> V_2 ) ;
unsigned char V_726 = V_705 -> V_726 ;
int V_313 = - V_755 ;
...
goto V_136;
V_705 -> V_726 |= V_742 ;
V_313 = F_460 ( V_65 -> V_2 , V_705 ) ;
if ( V_313 < 0 )
goto V_136;
F_470 ( & V_177 -> V_729 ) ;
if ( F_33 ( V_280 , & V_65 -> V_219 ) ) {
V_705 -> V_726 = V_726 & ~ V_741 ;
V_313 = F_460 ( V_65 -> V_2 , V_705 ) ;
F_471 ( & V_177 -> V_729 ) ;
goto V_136;
}
F_471 ( & V_177 -> V_729 ) ;
V_313 = F_483 ( V_65 , V_703 , V_705 , V_747 ) ;
V_136:
V_705 -> V_726 = V_726 ;
return V_313 ;
}
static int F_492 ( struct V_64 * V_65 , int V_703 , struct V_704 * V_705 )
{
struct V_60 V_61 = {
. V_65 = V_65 ,
. V_2 = V_65 -> V_2 ,
...
static int
F_493 ( struct V_757 * V_758 , int V_703 , struct V_704 * V_705 )
{
struct V_307 * V_308 ;
struct V_64 * V_65 ;
unsigned long V_50 = V_759 ;
int V_313 ;
V_308 = F_299 ( V_758 ) ;
V_65 = V_308 -> V_65 ;
if ( V_705 -> V_760 < 0 || V_705 -> V_761 < 0 )
return - V_27 ;
if ( F_494 ( V_703 ) ) {
if ( V_65 != NULL )
return F_458 ( V_65 , V_762 , V_705 ) ;
return 0 ;
}
if ( ! ( F_495 ( V_703 ) || F_484 ( V_703 ) ) )
return - V_27 ;
if ( V_705 -> V_716 == V_717 ) {
if ( V_65 != NULL )
return F_468 ( V_65 , V_703 , V_705 ) ;
return 0 ;
}
if ( V_65 == NULL )
return - V_755 ;
switch ( V_705 -> V_716 ) {
case V_763 :
if ( ! ( V_758 -> V_764 & V_190 ) )
return - V_413 ;
break;
case V_765 :
if ( ! ( V_758 -> V_764 & V_191 ) )
return - V_413 ;
}
do {
V_313 = F_492 ( V_65 , V_703 , V_705 ) ;
if ( ( V_313 != - V_108 ) || F_495 ( V_703 ) )
break;
V_50 = F_455 ( V_50 ) ;
V_313 = - V_58 ;
if ( F_496 () )
...
int F_497 ( struct V_704 * V_707 , struct V_64 * V_65 , const T_8 * V_257 )
{
struct V_13 * V_14 = F_94 ( V_65 -> V_2 ) ;
int V_8 ;
V_8 = F_457 ( V_65 , V_707 ) ;
if ( V_8 != 0 )
return V_8 ;
V_8 = F_483 ( V_65 , V_731 , V_707 , V_747 ) ;
return F_181 ( V_14 , V_65 , V_257 , V_8 ) ;
}
static void F_498 ( struct V_102 * V_103 , void * V_159 )
{
struct V_766 * V_161 = V_159 ;
struct V_13 * V_14 = V_161 -> V_14 ;
F_48 ( V_14 -> V_62 -> V_158 ,
& V_161 -> args . V_163 , & V_161 -> V_56 . V_164 , V_103 ) ;
V_161 -> args . V_711 . V_241 = V_14 -> V_62 -> V_242 ;
V_161 -> V_115 = V_157 ;
}
...
static void F_500 ( void * V_159 )
{
struct V_766 * V_161 = V_159 ;
F_501 ( V_161 -> V_14 , V_161 -> V_290 ) ;
F_105 ( V_159 ) ;
}
static void
F_502 ( struct V_13 * V_14 , struct V_289 * V_290 )
{
struct V_766 * V_161 ;
struct V_165 V_166 = {
. V_318 = & V_319 [ V_767 ] ,
...
V_161 -> V_14 = V_14 ;
V_161 -> args . V_711 . V_241 = V_14 -> V_62 -> V_242 ;
V_161 -> args . V_711 . V_243 = V_290 -> V_714 . V_246 ;
V_161 -> args . V_711 . V_715 = V_14 -> V_715 ;
V_166 . V_321 = & V_161 -> args ;
V_166 . V_322 = & V_161 -> V_56 ;
F_46 ( & V_161 -> args . V_163 , & V_161 -> V_56 . V_164 , 0 ) ;
F_398 ( V_14 -> V_98 , & V_166 , 0 , & V_768 , V_161 ) ;
}
static int F_503 ( const struct V_769 * V_770 ,
struct V_4 * V_4 , const char * V_771 ,
const void * V_620 , T_9 V_621 ,
int V_219 )
{
return F_420 ( F_14 ( V_4 ) , V_620 , V_621 ) ;
}
static int F_504 ( const struct V_769 * V_770 ,
struct V_4 * V_4 , const char * V_771 ,
void * V_620 , T_9 V_621 )
{
return F_414 ( F_14 ( V_4 ) , V_620 , V_621 ) ;
}
static bool F_505 ( struct V_4 * V_4 )
{
return F_401 ( F_94 ( F_14 ( V_4 ) ) ) ;
}
static int F_506 ( const struct V_769 * V_770 ,
struct V_4 * V_4 , const char * V_771 ,
const void * V_620 , T_9 V_621 ,
int V_219 )
{
if ( F_507 ( V_771 ) )
return F_428 ( V_4 , V_620 , V_621 ) ;
return - V_645 ;
}
static int F_508 ( const struct V_769 * V_770 ,
struct V_4 * V_4 , const char * V_771 ,
void * V_620 , T_9 V_621 )
{
if ( F_507 ( V_771 ) )
return F_423 ( F_14 ( V_4 ) , V_620 , V_621 ) ;
return - V_645 ;
}
static T_11
F_509 ( struct V_2 * V_2 , char * V_772 , T_9 V_773 )
{
int V_12 = 0 ;
if ( F_2 ( V_2 , V_9 ) ) {
V_12 = F_510 ( V_2 , V_772 , V_773 ) ;
if ( V_773 && V_12 > V_773 )
return - V_632 ;
}
return V_12 ;
...
static void F_291 ( struct V_397 * V_398 )
{
if ( ! ( ( ( V_398 -> V_304 & V_774 ) ||
( V_398 -> V_304 & V_775 ) ) &&
( V_398 -> V_304 & V_497 ) &&
( V_398 -> V_304 & V_776 ) ) )
return;
...
static int F_511 ( struct V_54 * V_98 , struct V_2 * V_3 ,
...
int F_290 ( struct V_54 * V_98 , struct V_2 * V_3 ,
const struct V_499 * V_247 ,
struct V_501 * V_778 ,
struct V_500 * V_500 )
{
...
static int F_513 ( struct V_2 * V_2 ,
struct V_501 * V_502 ,
...
& args . V_163 , & V_56 . V_164 ) ;
if ( V_313 == V_788 &&
V_56 . V_164 . V_150 & V_789 )
V_313 = - V_78 ;
return V_313 ;
}
int F_515 ( struct V_2 * V_2 ,
struct V_501 * V_502 ,
struct V_500 * V_500 , struct V_323 * V_357 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
...
int V_313 ;
F_8 ( L_56 , V_34 ,
( unsigned long long ) V_14 -> V_498 . V_793 ,
( unsigned long long ) V_14 -> V_498 . V_794 ,
V_63 -> V_97 ) ;
F_516 ( F_102 ( V_2 ) , V_34 ) ;
do {
V_313 = V_791 -> V_795 ( V_2 , V_502 , V_500 , V_357 ) ;
if ( V_313 != - V_89 )
break;
...
static int F_517 ( struct V_2 * V_2 , struct V_323 * V_357 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
...
static int F_520 ( struct V_2 * V_2 , struct V_323 * V_357 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
struct V_54 * V_55 = V_14 -> V_98 ;
struct V_796 args = {
...
int F_521 ( struct V_2 * V_2 , struct V_323 * V_357 )
{
struct V_13 * V_14 = F_94 ( V_2 ) ;
struct V_62 * V_63 = V_14 -> V_62 ;
const struct V_790 * V_791 =
...
static int F_522 ( struct V_2 * V_3 , const struct V_499 * V_247 , struct V_800 * V_492 , bool V_801 )
{
int V_313 ;
struct V_802 args = {
. V_511 = F_102 ( V_3 ) ,
...
int F_524 ( struct V_2 * V_3 , const struct V_499 * V_247 ,
struct V_800 * V_492 )
{
struct V_60 V_61 = { } ;
int V_8 ;
...
V_8 = F_522 ( V_3 , V_247 , V_492 , true ) ;
if ( V_8 == - V_22 )
V_8 = F_522 ( V_3 , V_247 , V_492 , false ) ;
F_525 ( V_3 , V_247 , V_8 ) ;
V_8 = F_31 ( F_94 ( V_3 ) , V_8 ,
& V_61 ) ;
} while ( V_61 . V_68 );
...
static bool
F_527 ( struct V_812 * V_813 ,
struct V_812 * V_814 )
{
if ( V_813 -> V_815 == V_814 -> V_815 &&
memcmp ( V_813 -> V_816 , V_814 -> V_816 , V_813 -> V_815 ) == 0 )
return true ;
return false ;
}
int F_528 ( struct V_62 * V_63 , struct V_323 * V_357 )
{
int V_313 ;
struct V_817 args = {
. V_98 = V_63 ,
...
F_8 ( L_11 , V_34 ) ;
F_529 ( & args . V_821 , & V_63 -> V_87 -> V_822 ) ;
if ( ! ( V_63 -> V_87 -> V_219 & V_823 ) )
args . V_3 = V_824 ;
V_313 = F_400 ( V_63 -> V_110 , & V_166 , V_618 ) ;
F_530 ( V_63 , V_313 ) ;
if ( V_313 == 0 ) {
if ( memcmp ( V_56 . V_821 . V_161 ,
V_63 -> V_87 -> V_822 . V_161 , V_825 ) ) {
F_8 ( L_59 , V_34 ) ;
V_313 = - V_35 ;
goto V_136;
}
...
static int F_531 ( struct V_62 * V_63 ,
struct V_827 * V_218 )
{
static const T_1 V_828 [ V_829 ] = {
[ 1 ] = 1 << ( V_830 - 32 ) |
1 << ( V_831 - 32 ) |
1 << ( V_832 - 32 ) |
1 << ( V_833 - 32 ) |
...
unsigned int V_489 ;
if ( V_218 -> V_835 == V_836 ) {
F_532 ( V_837 , L_63 ) ;
for ( V_489 = 0 ; V_489 <= V_838 ; V_489 ++ ) {
if ( F_33 ( V_489 , V_218 -> V_839 . V_255 . V_840 ) )
F_532 ( V_837 , L_64 , V_489 ) ;
if ( F_33 ( V_489 , V_218 -> V_841 . V_255 . V_840 ) )
F_532 ( V_837 , L_65 , V_489 ) ;
}
for ( V_489 = 0 ; V_489 < V_829 ; V_489 ++ ) {
if ( V_218 -> V_839 . V_255 . V_842 [ V_489 ] & ~ V_828 [ V_489 ] ) {
F_532 ( V_837 , L_66 ) ;
return - V_27 ;
}
}
if ( F_33 ( V_830 , V_218 -> V_839 . V_255 . V_840 ) &&
F_33 ( V_832 , V_218 -> V_839 . V_255 . V_840 ) &&
F_33 ( V_833 , V_218 -> V_839 . V_255 . V_840 ) &&
F_33 ( V_834 , V_218 -> V_839 . V_255 . V_840 ) ) {
F_532 ( V_837 , L_67 ) ;
F_532 ( V_837 , L_68 ) ;
F_133 ( V_843 , & V_63 -> V_844 ) ;
} else {
F_532 ( V_837 , L_66 ) ;
return - V_27 ;
}
if ( F_33 ( V_845 , V_218 -> V_841 . V_255 . V_840 ) &&
F_33 ( V_846 , V_218 -> V_841 . V_255 . V_840 ) &&
F_33 ( V_847 , V_218 -> V_841 . V_255 . V_840 ) &&
F_33 ( V_848 , V_218 -> V_841 . V_255 . V_840 ) ) {
F_532 ( V_837 , L_69 ) ;
F_133 ( V_430 , & V_63 -> V_844 ) ;
}
if ( F_33 ( V_849 , V_218 -> V_841 . V_255 . V_840 ) ) {
F_532 ( V_837 , L_70 ) ;
F_133 ( V_850 ,
& V_63 -> V_844 ) ;
}
if ( F_33 ( V_851 , V_218 -> V_841 . V_255 . V_840 ) &&
F_33 ( V_852 , V_218 -> V_841 . V_255 . V_840 ) ) {
F_532 ( V_837 , L_71 ) ;
F_133 ( V_805 , & V_63 -> V_844 ) ;
}
if ( F_33 ( V_853 , V_218 -> V_841 . V_255 . V_840 ) &&
F_33 ( V_854 , V_218 -> V_841 . V_255 . V_840 ) ) {
F_532 ( V_837 , L_72 ) ;
F_133 ( V_855 , & V_63 -> V_844 ) ;
}
if ( F_33 ( V_856 , V_218 -> V_841 . V_255 . V_840 ) ) {
F_532 ( V_837 , L_73 ) ;
F_133 ( V_857 , & V_63 -> V_844 ) ;
}
if ( F_33 ( V_858 , V_218 -> V_841 . V_255 . V_840 ) ) {
F_532 ( V_837 , L_74 ) ;
F_133 ( V_859 , & V_63 -> V_844 ) ;
}
}
return 0 ;
}
static int F_533 ( struct V_62 * V_63 , struct V_323 * V_357 ,
T_1 V_860 )
{
T_12 V_37 ;
struct V_861 args = {
...
V_63 -> V_110 -> V_111 -> V_693 -> V_694 ,
V_63 -> V_664 ) ;
V_56 . V_867 = F_95 ( sizeof( struct V_868 ) ,
V_310 ) ;
if ( F_375 ( V_56 . V_867 == NULL ) ) {
V_313 = - V_132 ;
goto V_136;
}
V_56 . V_816 = F_95 ( sizeof( struct V_812 ) ,
V_310 ) ;
if ( F_375 ( V_56 . V_816 == NULL ) ) {
V_313 = - V_132 ;
goto V_869;
}
V_56 . V_870 = F_95 ( sizeof( struct V_871 ) , V_310 ) ;
if ( F_375 ( V_56 . V_870 == NULL ) ) {
V_313 = - V_132 ;
goto V_872;
}
switch ( V_860 ) {
case V_873 :
args . V_874 . V_835 = V_873 ;
break;
case V_836 :
args . V_874 = V_875 ;
break;
...
F_535 ( V_63 , V_313 ) ;
if ( V_313 == 0 )
V_313 = F_526 ( V_56 . V_219 ) ;
if ( V_313 == 0 )
V_313 = F_531 ( V_63 , & V_56 . V_874 ) ;
if ( V_313 == 0 ) {
V_63 -> V_242 = V_56 . V_241 ;
V_63 -> V_877 = V_56 . V_219 ;
if ( ! ( V_56 . V_219 & V_878 ) ) {
F_135 ( V_879 ,
& V_63 -> V_87 -> V_880 ) ;
V_63 -> V_881 = V_56 . V_209 ;
}
F_105 ( V_63 -> V_882 ) ;
V_63 -> V_882 = V_56 . V_867 ;
V_56 . V_867 = NULL ;
F_105 ( V_63 -> V_883 ) ;
V_63 -> V_883 = V_56 . V_870 ;
V_56 . V_870 = NULL ;
if ( V_63 -> V_884 != NULL &&
! F_527 ( V_63 -> V_884 ,
V_56 . V_816 ) ) {
F_8 ( L_76 ,
V_34 ) ;
F_133 ( V_885 , & V_63 -> V_106 ) ;
F_105 ( V_63 -> V_884 ) ;
V_63 -> V_884 = NULL ;
}
if ( V_63 -> V_884 == NULL ) {
V_63 -> V_884 = V_56 . V_816 ;
V_56 . V_816 = NULL ;
}
}
V_876:
...
F_8 ( L_77
L_78 ,
V_63 -> V_883 -> V_886 , V_63 -> V_883 -> V_247 ,
V_63 -> V_883 -> V_887 . V_888 ,
V_63 -> V_883 -> V_887 . V_889 ) ;
F_8 ( L_79 , V_313 ) ;
return V_313 ;
}
int F_536 ( struct V_62 * V_63 , struct V_323 * V_357 )
{
T_4 V_890 = V_63 -> V_110 -> V_111 -> V_112 ;
int V_313 ;
if ( V_890 == V_113 ||
V_890 == V_114 ) {
V_313 = F_533 ( V_63 , V_357 , V_836 ) ;
if ( ! V_313 )
return 0 ;
}
return F_533 ( V_63 , V_357 , V_873 ) ;
}
...
unsigned int V_892 ;
int V_51 ;
for ( V_892 = V_893 ; V_892 != 0 ; V_892 -- ) {
V_51 = F_537 ( V_63 , V_357 ) ;
switch ( V_51 ) {
case - V_89 :
case - V_894 :
F_183 ( 1 ) ;
...
static void F_541 ( struct V_102 * V_103 ,
void * V_159 )
{
struct V_896 * V_161 =
(struct V_896 * ) V_159 ;
...
static void F_542 ( struct V_102 * V_103 , void * V_159 )
{
struct V_896 * V_161 =
(struct V_896 * ) V_159 ;
F_8 ( L_11 , V_34 ) ;
if ( ! F_60 ( V_103 , & V_161 -> V_56 -> V_898 ) )
return;
switch ( V_103 -> V_107 ) {
case - V_89 :
case - V_91 :
...
int F_543 ( struct V_62 * V_63 , struct V_475 * V_576 )
{
struct V_102 * V_103 ;
struct V_899 args ;
struct V_900 V_56 = {
...
static void F_544 ( struct V_904 * args )
{
unsigned int V_905 , V_906 ;
V_905 = V_907 + V_908 ;
V_906 = V_907 + V_909 ;
args -> V_910 . V_905 = V_905 ;
args -> V_910 . V_906 = V_906 ;
args -> V_910 . V_911 = V_912 ;
args -> V_910 . V_913 = V_914 ;
F_8 ( L_85
L_86 ,
V_34 ,
args -> V_910 . V_905 , args -> V_910 . V_906 ,
args -> V_910 . V_911 , args -> V_910 . V_913 ) ;
args -> V_915 . V_905 = V_625 ;
args -> V_915 . V_906 = V_625 ;
args -> V_915 . V_916 = 0 ;
args -> V_915 . V_911 = V_917 ;
args -> V_915 . V_913 = 1 ;
F_8 ( L_87
L_88 ,
V_34 ,
args -> V_915 . V_905 , args -> V_915 . V_906 ,
args -> V_915 . V_916 , args -> V_915 . V_911 ,
args -> V_915 . V_913 ) ;
}
static int F_545 ( struct V_904 * args ,
struct V_918 * V_56 )
{
struct V_919 * V_920 = & args -> V_910 ;
struct V_919 * V_921 = & V_56 -> V_910 ;
if ( V_921 -> V_906 > V_920 -> V_906 )
return - V_27 ;
if ( V_921 -> V_911 < V_920 -> V_911 )
return - V_27 ;
if ( V_921 -> V_913 == 0 )
return - V_27 ;
if ( V_921 -> V_913 > V_922 )
V_921 -> V_913 = V_922 ;
return 0 ;
}
static int F_546 ( struct V_904 * args ,
struct V_918 * V_56 )
{
struct V_919 * V_920 = & args -> V_915 ;
struct V_919 * V_921 = & V_56 -> V_915 ;
if ( ! ( V_56 -> V_219 & V_823 ) )
goto V_136;
if ( V_921 -> V_905 > V_920 -> V_905 )
return - V_27 ;
if ( V_921 -> V_906 < V_920 -> V_906 )
return - V_27 ;
if ( V_921 -> V_916 > V_920 -> V_916 )
return - V_27 ;
if ( V_921 -> V_911 != V_920 -> V_911 )
return - V_27 ;
if ( V_921 -> V_913 != V_920 -> V_913 )
return - V_27 ;
V_136:
return 0 ;
}
static int F_547 ( struct V_904 * args ,
struct V_918 * V_56 )
{
int V_51 ;
V_51 = F_545 ( args , V_56 ) ;
if ( V_51 )
return V_51 ;
return F_546 ( args , V_56 ) ;
}
static void F_548 ( struct V_138 * V_139 ,
struct V_918 * V_56 )
{
F_529 ( & V_139 -> V_822 , & V_56 -> V_821 ) ;
V_139 -> V_63 -> V_877 |= V_878 ;
F_133 ( V_879 , & V_139 -> V_880 ) ;
V_139 -> V_219 = V_56 -> V_219 ;
memcpy ( & V_139 -> V_910 , & V_56 -> V_910 , sizeof( V_139 -> V_910 ) ) ;
if ( V_56 -> V_219 & V_823 )
memcpy ( & V_139 -> V_915 , & V_56 -> V_915 ,
sizeof( V_139 -> V_915 ) ) ;
}
...
int V_313 ;
F_544 ( & args ) ;
args . V_219 = ( V_926 | V_823 ) ;
V_313 = F_400 ( V_139 -> V_63 -> V_110 , & V_166 , V_618 ) ;
F_550 ( V_63 , V_313 ) ;
if ( ! V_313 ) {
V_313 = F_547 ( & args , & V_56 ) ;
if ( V_63 -> V_881 == V_56 . V_209 )
V_63 -> V_881 ++ ;
if ( V_313 )
goto V_136;
F_548 ( V_139 , & V_56 ) ;
...
int F_551 ( struct V_62 * V_63 , struct V_323 * V_357 )
{
int V_313 ;
unsigned * V_927 ;
struct V_138 * V_139 = V_63 -> V_87 ;
F_8 ( L_89 , V_34 , V_63 , V_139 ) ;
V_313 = F_549 ( V_63 , V_357 ) ;
if ( V_313 )
goto V_136;
V_313 = F_552 ( V_139 ) ;
F_8 ( L_90 , V_313 ) ;
if ( V_313 )
goto V_136;
V_927 = ( unsigned * ) & V_139 -> V_822 . V_161 [ 0 ] ;
F_8 ( L_91 , V_34 ,
V_63 -> V_881 , V_927 [ 0 ] , V_927 [ 1 ] , V_927 [ 2 ] , V_927 [ 3 ] ) ;
V_136:
F_8 ( L_82 , V_34 ) ;
return V_313 ;
}
int F_553 ( struct V_138 * V_139 ,
struct V_323 * V_357 )
{
struct V_165 V_166 = {
. V_318 = & V_319 [ V_928 ] ,
...
int V_313 = 0 ;
F_8 ( L_92 ) ;
if ( ! F_126 ( V_879 , & V_139 -> V_880 ) )
return 0 ;
V_313 = F_400 ( V_139 -> V_63 -> V_110 , & V_166 , V_618 ) ;
F_554 ( V_139 -> V_63 , V_313 ) ;
if ( V_313 )
F_8 ( L_93
L_94 , V_313 ) ;
F_8 ( L_95 ) ;
...
static void F_555 ( void * V_161 )
{
struct V_929 * V_159 = V_161 ;
...
static int F_556 ( struct V_102 * V_103 , struct V_62 * V_63 )
{
switch( V_103 -> V_107 ) {
case - V_89 :
F_35 ( V_103 , V_52 ) ;
...
static void F_557 ( struct V_102 * V_103 , void * V_161 )
{
struct V_929 * V_159 = V_161 ;
struct V_62 * V_63 = V_159 -> V_63 ;
if ( ! F_60 ( V_103 , V_103 -> V_333 . V_322 ) )
return;
F_558 ( V_63 , V_103 -> V_107 ) ;
if ( V_103 -> V_107 < 0 ) {
F_8 ( L_96 , V_34 , V_103 -> V_107 ) ;
if ( F_390 ( & V_63 -> V_612 ) == 1 )
goto V_136;
if ( F_556 ( V_103 , V_63 ) == - V_108 ) {
F_65 ( V_103 ) ;
return;
}
}
...
static struct V_102 * F_560 ( struct V_62 * V_63 ,
struct V_323 * V_357 ,
bool V_930 )
{
struct V_929 * V_159 ;
...
static int F_561 ( struct V_62 * V_63 , struct V_323 * V_357 , unsigned V_616 )
{
struct V_102 * V_103 ;
int V_51 = 0 ;
if ( ( V_616 & V_933 ) == 0 )
return - V_108 ;
V_103 = F_560 ( V_63 , V_357 , false ) ;
if ( F_51 ( V_103 ) )
V_51 = F_78 ( V_103 ) ;
else
F_480 ( V_103 ) ;
...
static int F_562 ( struct V_62 * V_63 , struct V_323 * V_357 )
{
struct V_102 * V_103 ;
int V_51 ;
V_103 = F_560 ( V_63 , V_357 , true ) ;
if ( F_51 ( V_103 ) ) {
V_51 = F_78 ( V_103 ) ;
goto V_136;
}
...
{
struct V_934 * V_159 = V_161 ;
F_68 ( V_159 -> V_63 -> V_87 ,
& V_159 -> V_401 . V_163 ,
& V_159 -> V_56 . V_164 ,
V_103 ) ;
}
static int F_564 ( struct V_102 * V_103 , struct V_62 * V_63 )
{
switch( V_103 -> V_107 ) {
case 0 :
case - V_935 :
...
if ( ! F_60 ( V_103 , V_56 ) )
return;
F_566 ( V_63 , V_103 -> V_107 ) ;
if ( F_564 ( V_103 , V_63 ) == - V_108 ) {
F_65 ( V_103 ) ;
return;
}
F_8 ( L_82 , V_34 ) ;
}
static void F_567 ( void * V_161 )
{
struct V_934 * V_159 = V_161 ;
F_105 ( V_159 ) ;
}
static int F_568 ( struct V_62 * V_63 ,
struct V_323 * V_357 )
{
struct V_934 * V_159 ;
struct V_102 * V_103 ;
...
static void
F_569 ( struct V_102 * V_103 , void * V_159 )
{
struct V_939 * V_940 = V_159 ;
struct V_13 * V_14 = F_94 ( V_940 -> args . V_2 ) ;
struct V_138 * V_139 = F_71 ( V_14 ) ;
int V_51 ;
F_8 ( L_11 , V_34 ) ;
if ( F_68 ( V_139 , & V_940 -> args . V_163 ,
& V_940 -> V_56 . V_164 , V_103 ) )
return;
V_51 = F_570 ( & V_940 -> args . V_257 ,
F_82 ( V_940 -> args . V_2 ) -> V_941 ,
& V_940 -> args . V_942 ,
V_940 -> args . V_308 -> V_65 ) ;
if ( V_51 < 0 )
F_571 ( V_103 , V_51 ) ;
}
static void F_572 ( struct V_102 * V_103 , void * V_159 )
{
struct V_939 * V_940 = V_159 ;
struct V_2 * V_2 = V_940 -> args . V_2 ;
struct V_13 * V_14 = F_94 ( V_2 ) ;
struct V_943 * V_944 ;
struct V_64 * V_65 = NULL ;
unsigned long V_945 , V_580 , V_946 ;
F_8 ( L_98 , V_34 , - V_103 -> V_107 ) ;
if ( ! F_60 ( V_103 , & V_940 -> V_56 . V_164 ) )
goto V_136;
switch ( V_103 -> V_107 ) {
case 0 :
goto V_136;
...
goto V_950;
case - V_19 :
if ( V_940 -> args . V_951 == 0 )
goto V_950;
case - V_20 :
V_945 = F_573 ( V_103 -> V_952 ) ;
V_946 = V_940 -> args . V_115 + V_945 ;
V_580 = V_157 ;
if ( F_574 ( V_946 , V_580 ) ) {
unsigned long V_66 ;
V_66 = F_575 (unsigned long, NFS4_POLL_RETRY_MIN,
min((giveup - now - 1),
...
case - V_72 :
F_41 ( & V_2 -> V_178 ) ;
if ( F_146 ( & V_940 -> args . V_257 ,
& V_940 -> args . V_308 -> V_65 -> V_257 ) ) {
F_43 ( & V_2 -> V_178 ) ;
V_65 = V_940 -> args . V_308 -> V_65 ;
break;
}
V_944 = F_82 ( V_2 ) -> V_941 ;
if ( V_944 && F_146 ( & V_940 -> args . V_257 ,
& V_944 -> V_954 ) ) {
F_576 ( V_955 ) ;
F_133 ( V_956 , & V_944 -> V_957 ) ;
F_577 ( V_944 , & V_955 , NULL ) ;
F_43 ( & V_2 -> V_178 ) ;
F_578 ( & V_955 ) ;
} else
F_43 ( & V_2 -> V_178 ) ;
...
if ( F_38 ( V_103 , V_14 , V_65 , & V_940 -> V_50 ) == - V_108 )
goto V_953;
V_136:
F_8 ( L_82 , V_34 ) ;
return;
...
static T_9 F_579 ( struct V_13 * V_14 )
{
T_1 V_906 = V_14 -> V_62 -> V_87 -> V_910 . V_906 ;
return F_580 ( 0 , V_906 ) ;
}
static void F_581 ( struct V_500 * * V_42 , T_9 V_959 )
{
int V_489 ;
if ( ! V_42 )
return;
for ( V_489 = 0 ; V_489 < V_959 ; V_489 ++ ) {
if ( ! V_42 [ V_489 ] )
break;
F_292 ( V_42 [ V_489 ] ) ;
}
...
static struct V_500 * * F_582 ( T_9 V_959 , T_6 V_960 )
{
struct V_500 * * V_42 ;
int V_489 ;
V_42 = F_583 ( V_959 , sizeof( struct V_500 * ) , V_960 ) ;
if ( ! V_42 ) {
F_8 ( L_100 , V_34 , V_959 ) ;
return NULL ;
}
for ( V_489 = 0 ; V_489 < V_959 ; V_489 ++ ) {
V_42 [ V_489 ] = F_288 ( V_960 ) ;
if ( ! V_42 [ V_489 ] ) {
F_8 ( L_101 , V_34 ) ;
F_581 ( V_42 , V_959 ) ;
return NULL ;
...
static void F_584 ( void * V_159 )
{
struct V_939 * V_940 = V_159 ;
struct V_2 * V_2 = V_940 -> args . V_2 ;
struct V_13 * V_14 = F_94 ( V_2 ) ;
T_9 V_961 = F_579 ( V_14 ) ;
F_8 ( L_11 , V_34 ) ;
F_581 ( V_940 -> args . V_941 . V_42 , V_961 ) ;
F_585 ( F_82 ( V_2 ) -> V_941 ) ;
F_180 ( V_940 -> args . V_308 ) ;
F_105 ( V_159 ) ;
F_8 ( L_82 , V_34 ) ;
}
struct V_962 *
F_586 ( struct V_939 * V_940 , T_6 V_960 )
{
struct V_2 * V_2 = V_940 -> args . V_2 ;
struct V_13 * V_14 = F_94 ( V_2 ) ;
T_9 V_961 = F_579 ( V_14 ) ;
...
struct V_962 * V_965 = NULL ;
int V_313 = 0 ;
F_8 ( L_11 , V_34 ) ;
F_587 ( F_82 ( V_2 ) -> V_941 ) ;
V_940 -> args . V_941 . V_42 = F_582 ( V_961 , V_960 ) ;
if ( ! V_940 -> args . V_941 . V_42 ) {
F_584 ( V_940 ) ;
return F_52 ( - V_132 ) ;
}
V_940 -> args . V_941 . V_527 = V_961 * V_625 ;
V_940 -> args . V_115 = V_157 ;
V_940 -> V_56 . V_966 = & V_940 -> args . V_941 ;
V_940 -> V_56 . V_164 . V_124 = NULL ;
F_46 ( & V_940 -> args . V_163 , & V_940 -> V_56 . V_164 , 0 ) ;
V_103 = F_77 ( & V_324 ) ;
if ( F_51 ( V_103 ) )
return F_268 ( V_103 ) ;
V_313 = F_116 ( V_103 ) ;
if ( V_313 == 0 )
V_313 = V_103 -> V_107 ;
F_588 ( V_940 -> args . V_308 ,
& V_940 -> args . V_942 ,
& V_940 -> V_56 . V_942 ,
& V_940 -> V_56 . V_257 ,
V_313 ) ;
if ( V_313 == 0 && V_940 -> V_56 . V_966 -> V_12 )
V_965 = F_589 ( V_940 ) ;
F_79 ( V_103 ) ;
F_8 ( L_16 , V_34 , V_313 ) ;
if ( V_313 )
...
static void
F_590 ( struct V_102 * V_103 , void * V_159 )
{
struct V_967 * V_968 = V_159 ;
F_8 ( L_11 , V_34 ) ;
F_68 ( V_968 -> V_63 -> V_87 ,
& V_968 -> args . V_163 ,
& V_968 -> V_56 . V_164 ,
V_103 ) ;
}
static void F_591 ( struct V_102 * V_103 , void * V_159 )
{
struct V_967 * V_968 = V_159 ;
struct V_13 * V_14 ;
F_8 ( L_11 , V_34 ) ;
if ( ! F_60 ( V_103 , & V_968 -> V_56 . V_164 ) )
return;
V_14 = F_94 ( V_968 -> args . V_2 ) ;
switch ( V_103 -> V_107 ) {
default:
V_103 -> V_107 = 0 ;
case 0 :
...
static void F_592 ( void * V_159 )
{
struct V_967 * V_968 = V_159 ;
struct V_943 * V_944 = V_968 -> args . V_941 ;
F_576 ( V_969 ) ;
F_8 ( L_11 , V_34 ) ;
F_41 ( & V_944 -> V_970 -> V_178 ) ;
F_577 ( V_944 , & V_969 , & V_968 -> args . V_942 ) ;
F_593 ( V_944 ) ;
if ( V_968 -> V_56 . V_971 )
F_594 ( V_944 , & V_968 -> V_56 . V_257 , true ) ;
F_595 ( V_944 ) ;
F_43 ( & V_944 -> V_970 -> V_178 ) ;
F_578 ( & V_969 ) ;
F_585 ( V_968 -> args . V_941 ) ;
F_448 ( V_968 -> V_2 ) ;
F_105 ( V_159 ) ;
F_8 ( L_82 , V_34 ) ;
}
int F_596 ( struct V_967 * V_968 , bool V_972 )
{
struct V_102 * V_103 ;
struct V_165 V_166 = {
. V_318 = & V_319 [ V_973 ] ,
...
struct V_167 V_324 = {
. V_169 = F_94 ( V_968 -> args . V_2 ) -> V_98 ,
. V_165 = & V_166 ,
. V_170 = & V_974 ,
. V_173 = V_968 ,
} ;
int V_313 = 0 ;
F_266 ( F_94 ( V_968 -> args . V_2 ) -> V_62 ,
V_850 ,
& V_324 . V_169 , & V_166 ) ;
F_8 ( L_11 , V_34 ) ;
if ( ! V_972 ) {
V_968 -> V_2 = F_451 ( V_968 -> args . V_2 ) ;
if ( ! V_968 -> V_2 ) {
F_592 ( V_968 ) ;
return - V_108 ;
}
...
F_46 ( & V_968 -> args . V_163 , & V_968 -> V_56 . V_164 , 1 ) ;
V_103 = F_77 ( & V_324 ) ;
if ( F_51 ( V_103 ) )
return F_78 ( V_103 ) ;
if ( V_972 )
V_313 = V_103 -> V_107 ;
F_597 ( V_968 -> args . V_2 , & V_968 -> args . V_257 , V_313 ) ;
F_8 ( L_16 , V_34 , V_313 ) ;
F_79 ( V_103 ) ;
return V_313 ;
}
...
do {
V_8 = F_31 ( V_14 ,
F_598 ( V_14 , V_976 , V_357 ) ,
& V_61 ) ;
} while ( V_61 . V_68 );
return V_8 ;
}
static void F_600 ( struct V_102 * V_103 , void * V_159 )
{
struct V_985 * V_161 = V_159 ;
...
static void
F_601 ( struct V_102 * V_103 , void * V_159 )
{
struct V_985 * V_161 = V_159 ;
struct V_13 * V_14 = F_94 ( V_161 -> args . V_2 ) ;
...
static void F_602 ( void * V_159 )
{
struct V_985 * V_161 = V_159 ;
F_603 ( V_161 ) ;
F_452 ( V_161 -> args . V_2 ,
V_161 -> V_56 . V_398 ) ;
F_222 ( V_161 -> V_357 ) ;
F_448 ( V_161 -> V_2 ) ;
F_105 ( V_161 ) ;
...
int
F_604 ( struct V_985 * V_161 , bool V_972 )
{
struct V_165 V_166 = {
. V_318 = & V_319 [ V_987 ] ,
. V_321 = & V_161 -> args ,
...
L_104 , V_972 ,
V_161 -> args . V_989 ,
V_161 -> args . V_2 -> V_990 ) ;
if ( ! V_972 ) {
V_161 -> V_2 = F_451 ( V_161 -> args . V_2 ) ;
if ( V_161 -> V_2 == NULL ) {
F_602 ( V_161 ) ;
return - V_108 ;
}
...
if ( V_972 )
V_313 = V_103 -> V_107 ;
F_605 ( V_161 -> args . V_2 , & V_161 -> args . V_257 , V_313 ) ;
F_8 ( L_105 , V_34 , V_313 ) ;
F_79 ( V_103 ) ;
return V_313 ;
}
static int
F_606 ( struct V_13 * V_14 , struct V_435 * V_436 ,
struct V_475 * V_476 ,
struct V_800 * V_492 , bool V_801 )
{
struct V_991 args = {
. V_992 = V_993 ,
} ;
...
struct V_475 * V_476 , struct V_800 * V_492 )
{
struct V_60 V_61 = { } ;
int V_8 ;
do {
...
V_492 = F_404 ( V_500 ) ;
V_8 = F_607 ( V_14 , V_436 , V_476 , V_492 ) ;
if ( V_8 == - V_22 || V_8 == - V_995 ) {
V_8 = F_279 ( V_14 , V_436 , V_476 ) ;
goto V_999;
}
if ( V_8 )
goto V_999;
for ( V_489 = 0 ; V_489 < V_492 -> V_1000 ; V_489 ++ ) {
V_998 = & V_492 -> V_492 [ V_489 ] ;
switch ( V_998 -> V_109 ) {
case V_488 :
case V_487 :
case V_1001 :
V_109 = F_609 ( V_998 -> V_109 ,
& V_998 -> V_1002 ) ;
break;
default:
V_109 = V_996 ;
...
if ( ! F_610 ( & V_14 -> V_490 , V_109 ) )
V_109 = V_996 ;
if ( V_109 != V_996 ) {
V_8 = F_277 ( V_14 , V_436 ,
V_476 , V_109 ) ;
if ( ! V_8 )
break;
}
...
static void F_612 ( struct V_102 * V_103 , void * V_159 )
{
struct V_1006 * V_161 = V_159 ;
...
static void F_614 ( void * V_159 )
{
F_105 ( V_159 ) ;
}
static struct V_102 * F_615 ( struct V_13 * V_14 ,
T_8 * V_257 ,
struct V_323 * V_357 ,
bool V_1007 )
{
...
struct V_102 * V_103 ;
int V_51 ;
V_103 = F_615 ( V_14 , V_257 , V_357 , true ) ;
if ( F_51 ( V_103 ) )
return F_78 ( V_103 ) ;
V_51 = F_117 ( V_103 ) ;
if ( ! V_51 )
...
static void
F_616 ( struct V_13 * V_14 , struct V_289 * V_290 )
{
struct V_102 * V_103 ;
struct V_323 * V_357 = V_290 -> V_291 -> V_232 -> V_298 ;
V_103 = F_615 ( V_14 , & V_290 -> V_293 , V_357 , false ) ;
F_501 ( V_14 , V_290 ) ;
if ( F_51 ( V_103 ) )
return;
F_79 ( V_103 ) ;
}
static bool F_617 ( const T_8 * V_1010 ,
const T_8 * V_1011 )
{
if ( memcmp ( V_1010 -> V_1012 , V_1011 -> V_1012 , sizeof( V_1010 -> V_1012 ) ) != 0 )
return false ;
if ( V_1010 -> V_209 == V_1011 -> V_209 )
return true ;
if ( V_1010 -> V_209 == 0 || V_1011 -> V_209 == 0 )
return true ;
return false ;
}
static bool F_618 ( const T_8 * V_1010 ,
const T_8 * V_1011 )
{
return F_146 ( V_1010 , V_1011 ) ;
}
static struct V_223 *
F_619 ( struct V_225 * V_1013 , T_6 V_1014 )
{
return NULL ;
}
T_11 F_620 ( struct V_4 * V_4 , char * V_772 , T_9 V_959 )
{
T_11 error , V_1015 ;
error = F_621 ( V_4 , V_772 , V_959 ) ;
if ( error < 0 )
return error ;
if ( V_772 ) {
V_772 += error ;
...
V_1015 = F_509 ( F_14 ( V_4 ) , V_772 , V_959 ) ;
if ( V_1015 < 0 )
return V_1015 ;
return error + V_1015 ;
}
