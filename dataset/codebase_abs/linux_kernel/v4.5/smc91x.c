...
static int F_156 ( struct V_287 * V_288 )
{
struct V_10 * V_289 = F_157 ( V_288 ) ;
struct V_12 * V_13 = F_5 ( V_289 ) ;
unsigned long V_28 ;
unsigned char V_290 , V_291 ;
void T_2 * V_205 ;
struct V_292 * V_293 ;
V_293 = F_158 ( V_288 , V_294 , L_63 ) ;
if ( ! V_293 )
return 0 ;
V_205 = F_159 ( V_293 -> V_295 , V_296 ) ;
if ( ! V_205 )
return - V_297 ;
F_160 ( V_28 ) ;
V_290 = F_161 ( V_205 + ( V_298 << V_262 ) ) & ~ V_299 ;
F_162 ( V_290 | V_299 , V_205 + ( V_298 << V_262 ) ) ;
F_161 ( V_205 + ( V_298 << V_262 ) ) ;
F_14 ( 100 ) ;
F_162 ( V_290 , V_205 + ( V_298 << V_262 ) ) ;
F_162 ( V_290 | V_300 , V_205 + ( V_298 << V_262 ) ) ;
V_291 = F_161 ( V_205 + ( V_301 << V_262 ) ) & ~ V_302 ;
if ( ! F_163 ( V_13 ) )
V_291 |= V_302 ;
F_162 ( V_291 , V_205 + ( V_301 << V_262 ) ) ;
F_164 ( V_28 ) ;
F_165 ( V_205 ) ;
F_74 ( 1 ) ;
return 0 ;
}
static int F_166 ( struct V_287 * V_288 ,
struct V_10 * V_289 )
{
struct V_292 * V_293 = F_158 ( V_288 , V_294 , L_63 ) ;
struct V_12 * V_13 V_303 = F_5 ( V_289 ) ;
if ( ! V_293 )
return 0 ;
if ( ! F_167 ( V_293 -> V_295 , V_296 , V_48 ) )
return - V_304 ;
return 0 ;
}
static void F_168 ( struct V_287 * V_288 ,
struct V_10 * V_289 )
{
struct V_292 * V_293 = F_158 ( V_288 , V_294 , L_63 ) ;
struct V_12 * V_13 V_303 = F_5 ( V_289 ) ;
if ( V_293 )
F_169 ( V_293 -> V_295 , V_296 ) ;
}
static inline void F_170 ( struct V_287 * V_288 , struct V_10 * V_289 )
{
if ( V_305 ) {
struct V_292 * V_293 = F_158 ( V_288 , V_294 , L_64 ) ;
struct V_12 * V_13 = F_5 ( V_289 ) ;
if ( ! V_293 )
return;
if( ! F_167 ( V_293 -> V_295 , V_306 , V_48 ) ) {
F_63 ( V_289 , L_65 ,
V_48 ) ;
return;
}
V_13 -> V_307 = F_159 ( V_293 -> V_295 , V_306 ) ;
}
}
static void F_171 ( struct V_287 * V_288 , struct V_10 * V_289 )
{
if ( V_305 ) {
struct V_12 * V_13 = F_5 ( V_289 ) ;
struct V_292 * V_293 = F_158 ( V_288 , V_294 , L_64 ) ;
...
V_13 -> V_307 = NULL ;
if ( V_293 )
F_169 ( V_293 -> V_295 , V_306 ) ;
}
}
static int F_172 ( struct V_308 * V_11 ,
struct V_309 * * V_310 ,
const char * V_277 , int V_311 ,
int V_312 , unsigned int V_313 )
{
struct V_309 * V_314 = * V_310 ;
enum V_315 V_28 = V_312 ? V_316 : V_317 ;
V_314 = F_173 ( V_11 , V_277 , V_311 , V_28 ) ;
if ( F_174 ( V_314 ) )
return F_175 ( V_314 ) ;
if ( V_314 ) {
if ( V_313 )
...
static int F_178 ( struct V_287 * V_288 )
{
struct V_318 * V_319 = F_179 ( & V_288 -> V_11 ) ;
const struct V_320 * V_321 = NULL ;
struct V_12 * V_13 ;
struct V_10 * V_289 ;
struct V_292 * V_293 ;
unsigned int T_2 * V_205 ;
unsigned long V_256 = V_322 ;
unsigned long V_323 ;
int V_216 ;
V_289 = F_180 ( sizeof( struct V_12 ) ) ;
if ( ! V_289 ) {
V_216 = - V_297 ;
goto V_324;
}
F_181 ( V_289 , & V_288 -> V_11 ) ;
V_13 = F_5 ( V_289 ) ;
V_13 -> V_17 . V_28 = 0 ;
if ( V_319 ) {
memcpy ( & V_13 -> V_17 , V_319 , sizeof( V_13 -> V_17 ) ) ;
V_13 -> V_325 = F_182 ( V_13 -> V_17 . V_28 ) ;
}
#if F_183 ( V_326 )
V_321 = F_184 ( F_185 ( V_327 ) , & V_288 -> V_11 ) ;
if ( V_321 ) {
struct V_328 * V_329 = V_288 -> V_11 . V_330 ;
T_4 V_108 ;
V_216 = F_172 ( & V_288 -> V_11 , & V_13 -> V_331 ,
L_66 , 0 , 0 , 100 ) ;
if ( V_216 )
return V_216 ;
V_216 = F_172 ( & V_288 -> V_11 , & V_13 -> V_332 ,
L_67 , 0 , 0 , 100 ) ;
if ( V_216 )
return V_216 ;
if ( V_13 -> V_332 )
F_176 ( 750 , 1000 ) ;
if ( ! F_186 ( V_329 , L_68 , & V_108 ) ) {
if ( V_108 & 1 )
V_13 -> V_17 . V_28 |= V_333 ;
if ( ( V_108 == 0 ) || ( V_108 & 2 ) )
V_13 -> V_17 . V_28 |= V_334 ;
if ( V_108 & 4 )
V_13 -> V_17 . V_28 |= V_335 ;
} else {
V_13 -> V_17 . V_28 |= V_334 ;
}
}
#endif
if ( ! V_319 && ! V_321 ) {
V_13 -> V_17 . V_28 |= ( V_336 ) ? V_333 : 0 ;
V_13 -> V_17 . V_28 |= ( V_337 ) ? V_334 : 0 ;
V_13 -> V_17 . V_28 |= ( V_338 ) ? V_335 : 0 ;
V_13 -> V_17 . V_28 |= ( V_339 ) ? V_29 : 0 ;
}
if ( ! V_13 -> V_17 . V_209 && ! V_13 -> V_17 . V_211 ) {
V_13 -> V_17 . V_209 = V_340 ;
V_13 -> V_17 . V_211 = V_341 ;
}
V_289 -> V_342 = ( unsigned char ) - 1 ;
V_293 = F_158 ( V_288 , V_294 , L_69 ) ;
if ( ! V_293 )
V_293 = F_187 ( V_288 , V_294 , 0 ) ;
if ( ! V_293 ) {
V_216 = - V_260 ;
goto V_343;
}
if ( ! F_167 ( V_293 -> V_295 , V_344 , V_48 ) ) {
V_216 = - V_304 ;
goto V_343;
}
V_289 -> V_182 = F_188 ( V_288 , 0 ) ;
if ( V_289 -> V_182 < 0 ) {
V_216 = V_289 -> V_182 ;
goto V_345;
}
V_323 = F_189 ( F_190 ( V_289 -> V_182 ) ) ;
if ( V_256 == - 1 || V_323 & V_346 )
V_256 = V_323 & V_346 ;
V_216 = F_166 ( V_288 , V_289 ) ;
if ( V_216 )
goto V_345;
#if F_191 ( V_347 )
if ( F_192 () && F_193 () )
...
{
struct V_12 * V_13 = F_5 ( V_289 ) ;
V_13 -> V_308 = & V_288 -> V_11 ;
V_13 -> V_350 = V_293 -> V_295 ;
}
#endif
V_216 = F_136 ( V_289 , V_205 , V_256 ) ;
if ( V_216 != 0 )
goto V_351;
F_170 ( V_288 , V_289 ) ;
return 0 ;
...
F_168 ( V_288 , V_289 ) ;
V_345:
F_169 ( V_293 -> V_295 , V_344 ) ;
V_343:
F_196 ( V_289 ) ;
V_324:
F_197 ( L_70 , V_48 , V_216 ) ;
return V_216 ;
}
static int F_198 ( struct V_287 * V_288 )
{
struct V_10 * V_289 = F_157 ( V_288 ) ;
struct V_12 * V_13 = F_5 ( V_289 ) ;
struct V_292 * V_293 ;
F_199 ( V_289 ) ;
F_200 ( V_289 -> V_182 , V_289 ) ;
#ifdef F_148
if ( V_13 -> V_285 )
F_155 ( V_13 -> V_285 ) ;
#endif
...
static int F_201 ( struct V_308 * V_11 )
{
struct V_287 * V_288 = F_202 ( V_11 ) ;
struct V_10 * V_289 = F_157 ( V_288 ) ;
if ( V_289 ) {
if ( F_203 ( V_289 ) ) {
F_204 ( V_289 ) ;
...
static int F_205 ( struct V_308 * V_11 )
{
struct V_287 * V_288 = F_202 ( V_11 ) ;
struct V_10 * V_289 = F_157 ( V_288 ) ;
if ( V_289 ) {
