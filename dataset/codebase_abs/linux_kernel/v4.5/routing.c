...
if ( F_24 ( V_27 ) < 0 )
return V_38 ;
V_117 = (struct V_116 * ) V_27 -> V_39 ;
V_118 = ( unsigned char * ) ( V_27 -> V_39 + V_59 ) ;
V_119 = F_64 ( V_117 -> V_120 ) ;
if ( V_119 > V_27 -> V_44 - V_59 )
return V_38 ;
...
{
struct V_1 * V_2 = F_36 ( V_6 -> V_56 ) ;
struct V_3 * V_121 = NULL ;
struct V_122 * V_123 ;
int V_37 = V_38 ;
if ( F_38 ( V_2 , V_27 ,
sizeof( * V_123 ) ) < 0 )
goto V_18;
V_123 = (struct V_122 * ) V_27 -> V_39 ;
V_121 = F_28 ( V_2 , V_123 -> V_15 ) ;
if ( ! V_121 )
goto V_18;
if ( ! F_37 ( V_2 , V_123 -> V_87 ) &&
F_68 ( V_27 , V_6 , V_121 ) ) {
V_37 = V_53 ;
goto V_18;
}
F_45 ( V_2 , V_124 ) ;
F_46 ( V_2 , V_125 , V_27 -> V_44 ) ;
if ( ! F_69 ( & V_27 , V_121 ) )
goto V_18;
if ( V_27 )
F_70 ( V_27 , V_6 -> V_48 ,
...
goto V_18;
V_128 = (struct V_127 * ) V_27 -> V_39 ;
if ( F_37 ( V_2 , V_128 -> V_15 ) )
goto V_18;
if ( V_128 -> V_50 < 2 )
goto V_18;
V_4 = F_28 ( V_2 , V_128 -> V_15 ) ;
if ( ! V_4 )
goto V_18;
F_10 ( & V_4 -> V_131 ) ;
V_130 = F_72 ( V_128 -> V_130 ) ;
if ( F_73 ( V_4 -> V_132 , V_4 -> V_133 ,
V_130 ) )
goto V_134;
V_129 = V_130 - V_4 -> V_133 ;
if ( F_16 ( V_2 , V_129 ,
& V_4 -> V_135 ) )
goto V_134;
if ( F_74 ( V_2 , V_4 -> V_132 , V_129 , 1 ) )
V_4 -> V_133 = V_130 ;
F_12 ( & V_4 -> V_131 ) ;
if ( F_75 ( V_2 , V_27 ) )
goto V_18;
F_44 ( V_27 , sizeof( struct V_127 ) ) ;
F_76 ( V_2 , V_27 , 1 ) ;
