...
static int F_40 ( struct V_5 * V_6 , bool V_56 )
{
...
static int F_41 ( struct V_58 * V_59 , const struct V_60 * V_61 )
{
struct V_19 * V_20 ;
struct V_5 * V_6 ;
int V_21 ;
...
return - V_65 ;
V_20 = F_42 ( & V_59 -> V_7 , sizeof( * V_20 ) , V_32 ) ;
if ( ! V_20 )
return - V_33 ;
V_20 -> V_34 = F_43 ( V_59 ) ;
F_44 ( & V_20 -> V_37 ) ;
