...
F_79 ( V_41 , V_7 ) ;
V_7 -> V_93 = 0 ;
if ( ! F_80 ( V_41 ) || ! ( V_89 = F_81 ( V_41 , V_7 ) ) )
return 0 ;
if ( F_76 ( V_89 ) ) {
if ( F_82 ( V_89 ) == - V_94 ) {
F_69 ( V_95 L_16 ,
...
F_64 ( & F_45 ( V_41 ) -> V_71 , V_98 ) ;
for ( V_16 = 1 , V_90 = 0 ; V_16 < V_89 -> V_99 ; V_16 ++ )
if ( V_89 -> V_100 [ V_16 ] . V_101 )
V_90 = V_16 ;
F_46 ( V_41 , V_90 ) ;
for ( V_16 = 1 ; V_16 < V_89 -> V_99 ; V_16 ++ ) {
T_4 V_101 , V_102 ;
struct V_50 * V_51 = NULL ;
V_101 = V_89 -> V_100 [ V_16 ] . V_101 ;
if ( ! V_101 )
continue;
V_102 = V_89 -> V_100 [ V_16 ] . V_102 ;
if ( V_102 >= F_80 ( V_41 ) ) {
F_69 ( V_95
L_18 ,
V_41 -> F_1 , V_16 , ( unsigned long long ) V_102 ) ;
if ( F_68 ( V_41 ) )
goto V_91;
continue;
}
if ( V_102 + V_101 > F_80 ( V_41 ) ) {
F_69 ( V_95
L_19 ,
...
V_101 = F_80 ( V_41 ) - V_102 ;
}
}
if ( V_89 -> V_100 [ V_16 ] . V_103 )
V_51 = & V_89 -> V_100 [ V_16 ] . V_51 ;
V_37 = F_43 ( V_41 , V_16 , V_102 , V_101 ,
V_89 -> V_100 [ V_16 ] . V_49 ,
& V_89 -> V_100 [ V_16 ] . V_51 ) ;
if ( F_76 ( V_37 ) ) {
F_69 ( V_104 L_20 ,
V_41 -> F_1 , V_16 , - F_82 ( V_37 ) ) ;
continue;
}
#ifdef F_83
if ( V_89 -> V_100 [ V_16 ] . V_49 & V_105 )
F_84 ( F_34 ( V_37 ) -> V_34 ) ;
#endif
}
F_77 ( V_89 ) ;
...
int F_85 ( struct V_1 * V_41 , struct V_6 * V_7 )
{
int V_84 ;
if ( ! V_7 -> V_93 )
return 0 ;
...
static struct V_106 * F_87 ( struct V_6 * V_7 , T_4 V_107 )
{
struct V_108 * V_109 = V_7 -> V_110 -> V_111 ;
return F_88 ( V_109 , ( V_112 ) ( V_107 >> ( V_113 - 9 ) ) ,
NULL ) ;
}
unsigned char * F_89 ( struct V_6 * V_7 , T_4 V_107 , T_5 * V_16 )
{
struct V_106 * V_106 ;
if ( F_90 ( V_7 -> V_110 ) )
V_106 = F_91 ( V_7 , V_107 ) ;
else
V_106 = F_87 ( V_7 , V_107 ) ;
if ( ! F_76 ( V_106 ) ) {
if ( F_92 ( V_106 ) )
goto V_114;
V_16 -> V_115 = V_106 ;
return ( unsigned char * ) F_93 ( V_106 ) + ( ( V_107 & ( ( 1 << ( V_113 - 9 ) ) - 1 ) ) << 9 ) ;
V_114:
F_94 ( V_106 ) ;
}
V_16 -> V_115 = NULL ;
