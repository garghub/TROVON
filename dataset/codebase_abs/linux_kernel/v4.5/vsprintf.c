...
static T_1
char * F_76 ( const char * V_57 , char * V_9 , char * V_30 , void * V_72 ,
struct V_31 V_32 )
{
const int V_172 = 2 * sizeof( void * ) ;
if ( ! V_72 && * V_57 != 'K' ) {
if ( V_32 . V_39 == - 1 )
V_32 . V_39 = V_172 ;
...
switch ( V_136 -> V_174 . V_177 ) {
case V_178 :
return F_66 ( V_9 , V_30 , & V_136 -> V_175 , V_32 , V_57 ) ;
case V_179 :
return F_64 ( V_9 , V_30 , & V_136 -> V_176 , V_32 , V_57 ) ;
default:
...
{
T_6 V_180 ;
F_78 ( V_180 , * ( (struct V_181 * ) V_72 ) -> V_180 ) ;
V_9 += vsnprintf ( V_9 , V_30 > V_9 ? V_30 - V_9 : 0 ,
( (struct V_181 * ) V_72 ) -> V_57 , V_180 ) ;
va_end ( V_180 ) ;
return V_9 ;
}
case 'K' :
...
V_183 = F_82 () ;
if ( ! F_83 ( V_184 , V_185 ) ||
! F_84 ( V_183 -> V_186 , V_183 -> V_187 ) ||
! F_85 ( V_183 -> V_188 , V_183 -> V_189 ) )
V_72 = NULL ;
break;
}
case 2 :
...
( ( const struct V_190 * ) V_72 ) -> V_191 . V_55 ,
V_32 , V_57 ) ;
#ifdef F_86
case 'g' :
...
static T_1
int F_87 ( const char * V_57 , struct V_31 * V_32 )
{
...
F_16 ( V_201 + V_44 != V_202 ) ;
V_32 -> type = V_201 + ( V_32 -> V_36 & V_44 ) ;
} else if ( F_88 ( V_192 ) == 'z' ) {
V_32 -> type = V_203 ;
} else if ( V_192 == 't' ) {
V_32 -> type = V_204 ;
} else if ( V_192 == 'H' ) {
F_16 ( V_205 + V_44 != V_206 ) ;
V_32 -> type = V_205 + ( V_32 -> V_36 & V_44 ) ;
} else if ( V_192 == 'h' ) {
F_16 ( V_207 + V_44 != V_208 ) ;
V_32 -> type = V_207 + ( V_32 -> V_36 & V_44 ) ;
} else {
F_16 ( V_209 + V_44 != V_210 ) ;
V_32 -> type = V_209 + ( V_32 -> V_36 & V_44 ) ;
}
return ++ V_57 - V_93 ;
}
static void
F_91 ( struct V_31 * V_32 , int V_211 )
{
V_32 -> V_39 = V_211 ;
if ( F_90 ( V_32 -> V_39 != V_211 , L_27 , V_211 ) ) {
V_32 -> V_39 = F_92 ( V_211 , - V_212 , V_212 ) ;
}
}
static void
F_93 ( struct V_31 * V_32 , int V_213 )
{
V_32 -> V_40 = V_213 ;
if ( F_90 ( V_32 -> V_40 != V_213 , L_28 , V_213 ) ) {
V_32 -> V_40 = F_92 ( V_213 , 0 , V_214 ) ;
}
}
...
while ( * V_57 ) {
const char * V_217 = V_57 ;
int V_218 = F_87 ( V_57 , & V_32 ) ;
V_57 += V_218 ;
switch ( V_32 . type ) {
case V_194 : {
int V_219 = V_218 ;
...
if ( V_219 > V_30 - V_215 )
V_219 = V_30 - V_215 ;
memcpy ( V_215 , V_217 , V_219 ) ;
}
V_215 += V_218 ;
break;
}
case V_193 :
F_91 ( & V_32 , va_arg ( args , int ) ) ;
break;
case V_195 :
...
case V_197 :
V_215 = string ( V_215 , V_30 , va_arg ( args , char * ) , V_32 ) ;
break;
case V_51 :
V_215 = F_76 ( V_57 , V_215 , V_30 , va_arg ( args , void * ) ,
V_32 ) ;
while ( isalnum ( * V_57 ) )
V_57 ++ ;
break;
...
case V_203 :
if ( V_32 . V_36 & V_44 )
V_25 = va_arg ( args , V_221 ) ;
else
V_25 = va_arg ( args , T_3 ) ;
break;
case V_204 :
V_25 = va_arg ( args , V_222 ) ;
break;
case V_205 :
...
V_215 = F_15 ( V_215 , V_30 , V_25 , V_32 ) ;
}
}
V_220:
if ( V_24 > 0 ) {
...
int F_95 ( char * V_9 , T_3 V_24 , const char * V_57 , T_6 args )
{
int V_8 ;
...
int F_96 ( char * V_9 , T_3 V_24 , const char * V_57 , ... )
{
T_6 args ;
int V_8 ;
va_start ( args , V_57 ) ;
V_8 = F_95 ( V_9 , V_24 , V_57 , args ) ;
va_end ( args ) ;
return V_8 ;
}
int vsprintf ( char * V_9 , const char * V_57 , T_6 args )
{
return vsnprintf ( V_9 , V_216 , V_57 , args ) ;
}
...
int V_8 ;
va_start ( args , V_57 ) ;
V_8 = vsnprintf ( V_9 , V_216 , V_57 , args ) ;
va_end ( args ) ;
return V_8 ;
}
int F_97 ( T_5 * V_223 , T_3 V_24 , const char * V_57 , T_6 args )
{
struct V_31 V_32 = { 0 } ;
char * V_215 , * V_30 ;
V_215 = ( char * ) V_223 ;
V_30 = ( char * ) ( V_223 + V_24 ) ;
#define F_98 ( type ) \
do { \
if (sizeof(type) == 8) { \
...
break;
case V_197 : {
const char * V_224 = va_arg ( args , char * ) ;
T_3 V_29 ;
if ( ( unsigned long ) V_224 > ( unsigned long ) - V_54
|| ( unsigned long ) V_224 < V_54 )
V_224 = L_1 ;
V_29 = strlen ( V_224 ) + 1 ;
if ( V_215 + V_29 < V_30 )
memcpy ( V_215 , V_224 , V_29 ) ;
V_215 += V_29 ;
break;
}
case V_51 :
...
V_220:
return ( T_5 * ) ( F_99 ( V_215 , sizeof( T_5 ) ) ) - V_223 ;
#undef F_98
}
int F_100 ( char * V_9 , T_3 V_24 , const char * V_57 , const T_5 * V_223 )
{
struct V_31 V_32 = { 0 } ;
char * V_215 , * V_30 ;
const char * args = ( const char * ) V_223 ;
if ( F_94 ( V_24 > V_216 ) )
return 0 ;
V_215 = V_9 ;
V_30 = V_9 + V_24 ;
...
case V_197 : {
const char * V_225 = args ;
args += strlen ( V_225 ) + 1 ;
V_215 = string ( V_215 , V_30 , ( char * ) V_225 , V_32 ) ;
break;
}
case V_51 :
V_215 = F_76 ( V_57 , V_215 , V_30 , F_101 ( void * ) , V_32 ) ;
while ( isalnum ( * V_57 ) )
V_57 ++ ;
break;
case V_198 :
...
switch ( V_32 . type ) {
case V_200 :
V_25 = F_101 (long long) ;
break;
case V_201 :
case V_202 :
V_25 = F_101 (unsigned long) ;
break;
case V_203 :
V_25 = F_101 ( T_3 ) ;
break;
...
break;
case V_205 :
V_25 = F_101 (unsigned char) ;
break;
case V_206 :
V_25 = F_101 (signed char) ;
break;
case V_207 :
V_25 = F_101 (unsigned short) ;
break;
case V_208 :
V_25 = F_101 ( short ) ;
break;
case V_209 :
V_25 = F_101 (unsigned int) ;
break;
default:
V_25 = F_101 ( int ) ;
}
...
int F_102 ( T_5 * V_223 , T_3 V_24 , const char * V_57 , ... )
{
T_6 args ;
int V_226 ;
va_start ( args , V_57 ) ;
V_226 = F_97 ( V_223 , V_24 , V_57 , args ) ;
va_end ( args ) ;
return V_226 ;
}
int vsscanf ( const char * V_9 , const char * V_57 , T_6 args )
{
const char * V_215 = V_9 ;
char * V_227 ;
char V_228 ;
int V_25 = 0 ;
T_4 V_192 ;
...
V_39 = V_231 ;
V_215 = F_103 ( V_215 ) ;
while ( * V_215 && ! isspace ( * V_215 ) && V_39 -- )
* V_7 ++ = * V_215 ++ ;
* V_7 = '\0' ;
V_25 ++ ;
}
...
V_228 = * ( V_215 + 1 ) ;
if ( ! V_228
|| ( V_3 == 16 && ! isxdigit ( V_228 ) )
|| ( V_3 == 10 && ! isdigit ( V_228 ) )
|| ( V_3 == 8 && ( ! isdigit ( V_228 ) || V_228 > '7' ) )
|| ( V_3 == 0 && ! isdigit ( V_228 ) ) )
break;
if ( V_230 )
V_106 . V_7 = V_192 != 'L' ?
...
F_4 ( V_215 , & V_227 , V_3 ) :
F_1 ( V_215 , & V_227 , V_3 ) ;
if ( V_39 > 0 && V_227 - V_215 > V_39 ) {
if ( V_3 == 0 )
F_2 ( V_215 , & V_3 ) ;
while ( V_227 - V_215 > V_39 ) {
if ( V_230 )
V_106 . V_7 = F_104 ( V_106 . V_7 , V_3 ) ;
else
V_106 . V_229 = F_105 ( V_106 . V_229 , V_3 ) ;
-- V_227 ;
}
}
switch ( V_192 ) {
...
* va_arg (args, unsigned char *) = V_106 . V_229 ;
break;
case 'h' :
if ( V_230 )
* va_arg ( args , short * ) = V_106 . V_7 ;
else
* va_arg (args, unsigned short *) = V_106 . V_229 ;
break;
case 'l' :
if ( V_230 )
* va_arg ( args , long * ) = V_106 . V_7 ;
else
* va_arg (args, unsigned long *) = V_106 . V_229 ;
break;
case 'L' :
if ( V_230 )
* va_arg (args, long long *) = V_106 . V_7 ;
else
* va_arg (args, unsigned long long *) = V_106 . V_229 ;
break;
case 'Z' :
case 'z' :
* va_arg ( args , T_3 * ) = V_106 . V_229 ;
break;
default:
if ( V_230 )
* va_arg ( args , int * ) = V_106 . V_7 ;
else
* va_arg (args, unsigned int *) = V_106 . V_229 ;
break;
}
V_25 ++ ;
if ( ! V_227 )
