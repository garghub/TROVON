...
static void F_72 ( unsigned long V_189 , unsigned long V_138 )
{
unsigned long V_24 ;
...
static T_5 F_78 ( struct V_195 * V_196 ,
struct V_197 * V_198 ,
...
static T_5 F_80 ( struct V_195 * V_196 ,
struct V_197 * V_198 ,
char * V_89 )
{
return sprintf ( V_89 , L_70 , V_10 . V_20 ) ;
}
static T_5 F_81 ( struct V_195 * V_196 ,
struct V_197 * V_198 ,
char * V_89 )
{
return sprintf ( V_89 , L_70 , V_10 . V_65 ) ;
}
...
static int F_83 ( struct V_202 * V_203 , void * V_204 )
{
...
static int F_85 ( struct V_207 * V_207 , struct V_208 * V_208 )
{
return F_86 ( V_208 , F_83 , V_207 -> V_209 ) ;
}
static void F_87 ( void )
{
struct V_210 * V_211 ;
int V_61 = 0 ;
V_61 = F_88 ( V_212 , & V_213 . V_198 ) ;
if ( V_61 )
F_20 ( V_64 L_76
L_77 , V_61 ) ;
V_61 = F_88 ( V_212 , & V_214 . V_198 ) ;
if ( V_61 )
F_20 ( V_64 L_76
L_78 , V_61 ) ;
V_211 = F_89 ( L_79 , 0444 ,
V_215 , NULL ,
& V_216 ) ;
if ( ! V_211 )
F_20 ( V_64 L_80
