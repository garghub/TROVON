...
V_11 = V_2 -> V_22 -> V_23 ( V_2 , V_75 , V_79 -> V_18 [ V_80 ] . V_107 ) ;
if ( V_11 < 0 )
goto V_101;
...
V_110 -> V_77 . V_58 ,
L_19 ) ;
V_79 -> V_81 = F_66 ( V_110 -> V_77 . V_58 ,
L_20 ) ;
V_110 -> V_30 = F_72 ( V_110 -> V_77 . V_58 , 0 ) ;
} else {
V_79 = F_73 ( & V_110 -> V_77 ) ;
if ( ! V_79 ) {
V_79 = F_74 ( & V_110 -> V_77 ,
sizeof( struct V_78 ) ,
V_117 ) ;
V_79 -> V_74 = - 1 ;
}
}
V_2 = F_75 ( sizeof( * V_2 ) , V_117 ) ;
if ( ! V_2 )
return - V_118 ;
V_2 -> V_30 = V_110 -> V_30 ;
V_11 = F_62 ( V_2 , & V_110 -> V_77 , V_110 , V_110 -> V_12 ,
V_112 -> V_119 , V_79 , 0 ) ;
if ( V_11 )
goto V_101;
F_76 ( V_110 , V_2 ) ;
...
static int F_78 ( struct V_109 * V_110 )
{
struct V_1 * V_2 = F_79 ( V_110 ) ;
...
const struct V_114 * V_115 ;
T_5 V_125 = 0 ;
V_115 = F_70 ( F_71 ( V_126 ) , & V_122 -> V_77 ) ;
if ( V_115 ) {
type = ( int ) ( V_127 ) V_115 -> V_4 ;
V_11 = F_86 ( V_122 -> V_77 . V_58 ,
L_21 , & V_125 ) ;
if ( V_11 ) {
V_11 = F_86 ( V_122 -> V_77 . V_58 ,
L_22 , & V_125 ) ;
...
V_122 -> V_77 . V_58 ,
L_19 ) ;
V_79 -> V_81 = F_66 ( V_122 -> V_77 . V_58 ,
L_20 ) ;
} else {
type = F_87 ( V_122 ) -> V_119 ;
V_79 = F_73 ( & V_122 -> V_77 ) ;
if ( ! V_79 ) {
V_79 = F_74 ( & V_122 -> V_77 ,
sizeof( struct V_78 ) ,
V_117 ) ;
V_79 -> V_74 = - 1 ;
}
...
return - V_118 ;
F_88 ( V_122 , V_4 ) ;
V_122 -> V_30 = F_72 ( V_122 -> V_77 . V_58 , 0 ) ;
for ( V_12 = 0 ; V_12 < F_58 ( V_79 -> V_18 ) ; V_12 ++ ) {
if ( ! ( V_125 & ( 1 << V_12 ) ) )
continue;
V_123 -- ;
...
V_11 = F_62 ( V_4 -> V_2 [ V_12 ] , & V_122 -> V_77 , V_122 ,
0x40 | ( V_12 << 1 ) , type , V_79 ,
V_12 ) ;
if ( V_11 < 0 )
goto V_101;
if ( V_79 -> V_74 != - 1 )
V_79 -> V_74 += ( type == V_90 ) ? 16 : 8 ;
V_38 += ( type == V_90 ) ? 16 : 8 ;
}
V_4 -> V_38 = V_38 ;
return 0 ;
...
static int F_89 ( struct V_121 * V_122 )
{
struct V_124 * V_4 = F_90 ( V_122 ) ;
unsigned V_12 ;
for ( V_12 = 0 ; V_12 < F_58 ( V_4 -> V_2 ) ; V_12 ++ ) {
if ( ! V_4 -> V_2 [ V_12 ] )
continue;
