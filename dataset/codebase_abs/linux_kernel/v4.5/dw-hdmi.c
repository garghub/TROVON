...
static bool F_76 ( struct V_395 * V_396 ,
const struct V_227 * V_228 ,
struct V_227 * V_400 )
{
return true ;
...
static void F_79 ( struct V_395 * V_396 )
{
}
static enum V_401
F_80 ( struct V_402 * V_403 , bool V_387 )
{
struct V_1 * V_2 = F_81 ( V_403 , struct V_1 ,
V_403 ) ;
F_21 ( & V_2 -> V_399 ) ;
V_2 -> V_387 = V_390 ;
F_73 ( V_2 ) ;
F_74 ( V_2 ) ;
F_22 ( & V_2 -> V_399 ) ;
return F_10 ( V_2 , V_209 ) & V_404 ?
V_405 : V_406 ;
}
static int F_82 ( struct V_402 * V_403 )
{
struct V_1 * V_2 = F_81 ( V_403 , struct V_1 ,
V_403 ) ;
struct V_407 * V_407 ;
...
if ( ! V_2 -> V_408 )
return 0 ;
V_407 = F_83 ( V_403 , V_2 -> V_408 ) ;
if ( V_407 ) {
F_17 ( V_2 -> V_29 , L_10 ,
V_407 -> V_409 , V_407 -> V_410 ) ;
V_2 -> V_213 = F_84 ( V_407 ) ;
V_2 -> V_349 = F_85 ( V_407 ) ;
F_86 ( V_403 , V_407 ) ;
V_212 = F_87 ( V_403 , V_407 ) ;
F_88 ( V_403 , V_407 ) ;
F_89 ( V_407 ) ;
} else {
F_17 ( V_2 -> V_29 , L_11 ) ;
...
static enum V_411
F_90 ( struct V_402 * V_403 ,
struct V_227 * V_228 )
{
struct V_1 * V_2 = F_81 ( V_403 ,
struct V_1 , V_403 ) ;
enum V_411 V_412 = V_413 ;
if ( V_228 -> V_40 & V_414 )
return V_415 ;
if ( V_2 -> V_178 -> V_416 )
V_412 = V_2 -> V_178 -> V_416 ( V_403 , V_228 ) ;
return V_412 ;
}
static struct V_417 * F_91 ( struct V_402
* V_403 )
{
struct V_1 * V_2 = F_81 ( V_403 , struct V_1 ,
V_403 ) ;
...
static void F_92 ( struct V_402 * V_403 )
{
F_93 ( V_403 ) ;
F_94 ( V_403 ) ;
}
...
V_403 ) ;
F_21 ( & V_2 -> V_399 ) ;
V_2 -> V_387 = V_403 -> V_387 ;
F_73 ( V_2 ) ;
F_74 ( V_2 ) ;
F_22 ( & V_2 -> V_399 ) ;
}
static T_4 F_96 ( int V_419 , void * V_420 )
{
struct V_1 * V_2 = V_420 ;
T_1 V_421 ;
V_421 = F_10 ( V_2 , V_360 ) ;
if ( V_421 )
F_9 ( V_2 , ~ 0 , V_379 ) ;
return V_421 ? V_422 : V_423 ;
}
static T_4 F_97 ( int V_419 , void * V_420 )
{
struct V_1 * V_2 = V_420 ;
T_1 V_421 , V_424 , V_425 , V_426 ;
V_421 = F_10 ( V_2 , V_360 ) ;
V_424 = F_10 ( V_2 , V_427 ) ;
V_426 = F_10 ( V_2 , V_209 ) ;
V_425 = 0 ;
if ( V_421 & V_358 )
V_425 |= V_404 ;
if ( V_421 & V_428 )
...
static int F_99 ( struct V_437 * V_438 , struct V_1 * V_2 )
{
struct V_417 * V_418 = V_2 -> V_418 ;
struct V_395 * V_396 ;
int V_212 ;
V_396 = F_100 ( V_438 -> V_29 , sizeof( * V_396 ) , V_439 ) ;
if ( ! V_396 ) {
F_101 ( L_15 ) ;
return - V_440 ;
}
...
V_396 -> V_398 = V_2 ;
V_396 -> V_441 = & V_442 ;
V_212 = F_102 ( V_438 , V_396 ) ;
if ( V_212 ) {
F_101 ( L_16 ) ;
return - V_187 ;
}
V_418 -> V_396 = V_396 ;
V_2 -> V_403 . V_443 = V_444 ;
F_103 ( & V_2 -> V_403 ,
& V_445 ) ;
if ( F_104 ( V_438 , V_446 ) )
F_105 ( V_438 , & V_2 -> V_403 ,
& V_447 ,
V_448 ) ;
else
F_105 ( V_438 , & V_2 -> V_403 ,
& V_449 ,
V_448 ) ;
F_106 ( & V_2 -> V_403 , V_418 ) ;
return 0 ;
}
int F_107 ( struct V_450 * V_29 , struct V_450 * V_451 ,
void * V_8 , struct V_417 * V_418 ,
struct V_452 * V_453 , int V_419 ,
const struct V_176 * V_178 )
{
struct V_437 * V_438 = V_8 ;
struct V_454 * V_455 = V_29 -> V_456 ;
struct V_457 V_458 ;
struct V_454 * V_459 ;
struct V_460 V_461 ;
struct V_1 * V_2 ;
int V_212 ;
T_3 V_3 = 1 ;
V_2 = F_100 ( V_29 , sizeof( * V_2 ) , V_439 ) ;
if ( ! V_2 )
return - V_440 ;
V_2 -> V_403 . V_462 = 1 ;
V_2 -> V_178 = V_178 ;
...
V_2 -> V_388 = true ;
V_2 -> V_391 = true ;
V_2 -> V_356 = ( T_1 ) ~ ( V_404 | V_394 ) ;
F_108 ( & V_2 -> V_399 ) ;
F_108 ( & V_2 -> V_35 ) ;
F_109 ( & V_2 -> V_31 ) ;
F_110 ( V_455 , L_17 , & V_3 ) ;
switch ( V_3 ) {
case 4 :
V_2 -> V_6 = F_1 ;
V_2 -> V_7 = F_3 ;
...
V_459 = F_111 ( V_455 , L_19 , 0 ) ;
if ( V_459 ) {
V_2 -> V_408 = F_112 ( V_459 ) ;
F_113 ( V_459 ) ;
if ( ! V_2 -> V_408 ) {
F_17 ( V_2 -> V_29 , L_20 ) ;
return - V_463 ;
...
V_2 -> V_5 = F_114 ( V_29 , V_453 ) ;
if ( F_115 ( V_2 -> V_5 ) )
return F_116 ( V_2 -> V_5 ) ;
V_2 -> V_464 = F_117 ( V_2 -> V_29 , L_22 ) ;
if ( F_115 ( V_2 -> V_464 ) ) {
V_212 = F_116 ( V_2 -> V_464 ) ;
F_55 ( V_2 -> V_29 , L_23 , V_212 ) ;
return V_212 ;
}
V_212 = F_118 ( V_2 -> V_464 ) ;
if ( V_212 ) {
F_55 ( V_2 -> V_29 , L_24 , V_212 ) ;
return V_212 ;
}
V_2 -> V_465 = F_117 ( V_2 -> V_29 , L_25 ) ;
if ( F_115 ( V_2 -> V_465 ) ) {
V_212 = F_116 ( V_2 -> V_465 ) ;
F_55 ( V_2 -> V_29 , L_26 , V_212 ) ;
goto V_466;
}
V_212 = F_118 ( V_2 -> V_465 ) ;
if ( V_212 ) {
...
F_10 ( V_2 , V_470 ) ) ;
F_70 ( V_2 ) ;
V_212 = F_120 ( V_29 , V_419 , F_96 ,
F_97 , V_471 ,
F_121 ( V_29 ) , V_2 ) ;
if ( V_212 )
goto V_472;
F_20 ( V_2 ) ;
F_9 ( V_2 , V_404 | V_394 , V_427 ) ;
F_9 ( V_2 , V_358 | V_359 ,
V_360 ) ;
V_212 = F_69 ( V_2 ) ;
if ( V_212 )
goto V_472;
V_212 = F_99 ( V_438 , V_2 ) ;
if ( V_212 )
goto V_472;
F_9 ( V_2 , ~ ( V_358 | V_359 ) ,
V_379 ) ;
...
V_458 . V_473 = V_29 ;
V_458 . V_474 = V_475 ;
if ( F_10 ( V_2 , V_476 ) & V_477 ) {
V_461 . V_478 = V_453 -> V_479 ;
V_461 . V_480 = V_2 -> V_5 ;
V_461 . V_419 = V_419 ;
V_461 . V_2 = V_2 ;
V_461 . V_481 = V_2 -> V_403 . V_481 ;
V_458 . V_482 = L_29 ;
V_458 . V_8 = & V_461 ;
V_458 . V_483 = sizeof( V_461 ) ;
V_458 . V_484 = F_122 ( 32 ) ;
V_2 -> V_461 = F_123 ( & V_458 ) ;
}
F_124 ( V_29 , V_2 ) ;
return 0 ;
V_472:
...
void F_126 ( struct V_450 * V_29 , struct V_450 * V_451 , void * V_8 )
{
struct V_1 * V_2 = F_127 ( V_29 ) ;
if ( V_2 -> V_461 && ! F_115 ( V_2 -> V_461 ) )
F_128 ( V_2 -> V_461 ) ;
F_9 ( V_2 , ~ 0 , V_379 ) ;
V_2 -> V_403 . V_441 -> V_485 ( & V_2 -> V_403 ) ;
V_2 -> V_418 -> V_441 -> V_485 ( V_2 -> V_418 ) ;
F_125 ( V_2 -> V_465 ) ;
F_125 ( V_2 -> V_464 ) ;
F_129 ( V_2 -> V_408 ) ;
}
