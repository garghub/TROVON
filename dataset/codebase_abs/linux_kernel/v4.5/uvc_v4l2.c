...
{
struct V_221 T_7 * V_222 ;
struct V_221 T_7 * V_223 ;
T_8 V_224 ;
if ( ! F_100 ( V_225 , V_220 , sizeof( * V_220 ) ) ||
...
if ( F_104 ( V_224 , & V_220 -> V_26 ) )
return - V_27 ;
V_222 = F_105 ( V_224 ) ;
if ( ! F_100 ( V_225 , V_222 , V_218 -> V_22 * sizeof( * V_222 ) ) )
return - V_27 ;
V_223 = F_106 ( V_218 -> V_22 * sizeof( * V_223 ) ) ;
if ( V_223 == NULL )
return - V_27 ;
V_218 -> V_26 = V_223 ;
if ( F_107 ( V_223 , V_222 , V_218 -> V_22 * sizeof( * V_222 ) ) )
return - V_27 ;
return 0 ;
}
static int F_108 ( const struct V_3 * V_218 ,
struct V_219 T_7 * V_220 )
{
struct V_221 T_7 * V_222 ;
struct V_221 T_7 * V_223 = V_218 -> V_26 ;
T_8 V_224 ;
if ( ! F_100 ( V_226 , V_220 , sizeof( * V_220 ) ) ||
F_109 ( V_220 , V_218 , F_102 ( F_103 ( * V_220 ) , V_26 ) ) ||
F_110 ( V_218 -> V_22 , & V_220 -> V_22 ) )
return - V_27 ;
if ( F_111 ( V_220 -> V_172 , sizeof( V_220 -> V_172 ) ) )
return - V_27 ;
if ( V_218 -> V_22 == 0 )
return 0 ;
if ( F_112 ( V_224 , & V_220 -> V_26 ) )
return - V_27 ;
V_222 = F_105 ( V_224 ) ;
if ( F_107 ( V_222 , V_223 , V_218 -> V_22 * sizeof( * V_222 ) ) )
return - V_27 ;
return 0 ;
}
static int F_113 ( struct V_227 * V_218 ,
const struct V_228 T_7 * V_220 )
{
T_6 T_7 * V_229 ;
T_6 T_7 * V_230 ;
T_8 V_224 ;
if ( ! F_100 ( V_225 , V_220 , sizeof( * V_220 ) ) ||
F_101 ( V_218 , V_220 , F_102 ( F_103 ( * V_220 ) , V_231 ) ) )
return - V_27 ;
if ( V_218 -> V_7 == 0 ) {
V_218 -> V_231 = NULL ;
return 0 ;
}
if ( F_104 ( V_224 , & V_220 -> V_231 ) )
return - V_27 ;
V_229 = F_105 ( V_224 ) ;
if ( ! F_100 ( V_225 , V_229 , V_218 -> V_7 ) )
return - V_27 ;
V_230 = F_106 ( V_218 -> V_7 ) ;
if ( V_230 == NULL )
return - V_27 ;
V_218 -> V_231 = V_230 ;
if ( F_107 ( V_230 , V_229 , V_218 -> V_7 ) )
return - V_27 ;
return 0 ;
}
static int F_114 ( const struct V_227 * V_218 ,
struct V_228 T_7 * V_220 )
{
T_6 T_7 * V_229 ;
T_6 T_7 * V_230 = V_218 -> V_231 ;
T_8 V_224 ;
if ( ! F_100 ( V_226 , V_220 , sizeof( * V_220 ) ) ||
F_109 ( V_220 , V_218 , F_102 ( F_103 ( * V_220 ) , V_231 ) ) )
return - V_27 ;
if ( V_218 -> V_7 == 0 )
return 0 ;
if ( F_112 ( V_224 , & V_220 -> V_231 ) )
return - V_27 ;
V_229 = F_105 ( V_224 ) ;
if ( ! F_100 ( V_225 , V_229 , V_218 -> V_7 ) )
return - V_27 ;
if ( F_107 ( V_229 , V_230 , V_218 -> V_7 ) )
return - V_27 ;
return 0 ;
}
...
case V_235 :
V_214 = V_216 ;
V_8 = F_99 ( & V_233 . V_4 , V_220 ) ;
break;
case V_236 :
V_214 = V_217 ;
V_8 = F_113 ( & V_233 . V_232 , V_220 ) ;
break;
default:
return - V_237 ;
}
V_234 = F_116 () ;
F_117 ( V_238 ) ;
V_8 = F_118 ( V_109 , V_214 , ( unsigned long ) & V_233 ) ;
F_117 ( V_234 ) ;
if ( V_8 < 0 )
return V_8 ;
switch ( V_214 ) {
case V_216 :
V_8 = F_108 ( & V_233 . V_4 , V_220 ) ;
break;
case V_217 :
V_8 = F_114 ( & V_233 . V_232 , V_220 ) ;
break;
}
return V_8 ;
}
static T_10 F_119 ( struct V_109 * V_109 , char T_7 * V_231 ,
T_11 V_182 , T_12 * V_239 )
{
F_5 ( V_110 , L_11 ) ;
return - V_24 ;
}
static int F_120 ( struct V_109 * V_109 , struct V_240 * V_241 )
{
struct V_103 * V_104 = V_109 -> V_116 ;
struct V_41 * V_42 = V_104 -> V_42 ;
F_5 ( V_110 , L_12 ) ;
return F_121 ( & V_42 -> V_86 , V_241 ) ;
}
static unsigned int F_122 ( struct V_109 * V_109 , T_13 * V_242 )
{
struct V_103 * V_104 = V_109 -> V_116 ;
struct V_41 * V_42 = V_104 -> V_42 ;
F_5 ( V_110 , L_13 ) ;
return F_123 ( & V_42 -> V_86 , V_109 , V_242 ) ;
}
static unsigned long F_124 ( struct V_109 * V_109 ,
unsigned long V_243 , unsigned long V_244 , unsigned long V_245 ,
unsigned long V_134 )
{
struct V_103 * V_104 = V_109 -> V_116 ;
struct V_41 * V_42 = V_104 -> V_42 ;
F_5 ( V_110 , L_14 ) ;
return F_125 ( & V_42 -> V_86 , V_245 ) ;
}
