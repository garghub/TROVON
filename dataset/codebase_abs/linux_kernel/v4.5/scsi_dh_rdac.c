...
{
struct V_58 * V_30 =
F_12 ( V_136 , struct V_58 , V_71 ) ;
struct V_1 * V_7 ;
struct V_2 * V_3 = V_30 -> V_69 ;
struct V_20 * V_21 = V_3 -> V_123 ;
struct V_8 * V_9 = V_3 -> V_8 ;
int V_76 , V_137 = V_138 ;
...
V_30 = V_28 -> V_21 -> V_30 ;
F_28 ( & V_30 -> V_70 ) ;
F_39 ( & V_28 -> V_140 , & V_30 -> V_73 ) ;
if ( ! V_30 -> V_68 ) {
V_30 -> V_68 = 1 ;
V_30 -> V_69 = V_3 ;
F_40 ( V_146 , & V_30 -> V_71 ) ;
}
F_29 ( & V_30 -> V_70 ) ;
return V_87 ;
}
...
static int F_42 ( struct V_2 * V_3 , struct V_1 * V_148 )
{
struct V_20 * V_21 = V_3 -> V_123 ;
int V_122 = V_149 ;
if ( V_21 -> V_95 != V_96 ) {
...
F_4 ( V_160 , V_3 ,
L_10 ,
V_161 , V_21 -> V_48 , V_99 [ ( int ) V_21 -> V_99 ] ,
