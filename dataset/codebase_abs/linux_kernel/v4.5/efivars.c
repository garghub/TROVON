...
F_42 ( V_74 ) ;
F_42 ( V_76 ) ;
error = F_43 ( & V_69 -> V_39 , V_74 ) ;
if ( error ) {
F_9 ( V_26 L_18
L_19 , error ) ;
goto V_75;
}
error = F_43 ( & V_69 -> V_39 , V_76 ) ;
if ( error ) {
F_9 ( V_26 L_20
L_19 , error ) ;
F_44 ( & V_69 -> V_39 , V_74 ) ;
...
static int F_45 ( T_2 * V_20 , T_3 V_21 ,
...
static int F_48 ( T_2 * V_20 , T_3 V_21 ,
unsigned long V_77 , void * V_24 )
{
struct V_1 * V_2 ;
V_2 = F_27 ( sizeof( * V_2 ) , V_56 ) ;
...
static int F_49 ( struct V_1 * V_2 , void * V_24 )
{
F_50 ( V_2 ) ;
F_34 ( V_2 ) ;
return 0 ;
...
F_9 ( V_83 L_21 , V_84 ,
V_85 ) ;
V_69 = F_57 ( L_22 , NULL , V_80 ) ;
if ( ! V_69 ) {
F_9 ( V_26 L_23 ) ;
return - V_57 ;
}
F_47 ( F_48 , NULL , false ,
true , & V_58 ) ;
error = F_41 () ;
if ( error ) {
F_51 () ;
