...
T_5 F_90 ( struct V_118 * V_118 , unsigned long V_144 , T_4 V_26 , T_6 V_57 )
{
T_5 V_147 = F_89 ( V_118 , ( void T_1 * ) V_144 , V_57 , & V_26 ) ;
if ( V_147 > 0 )
F_91 ( V_144 , V_144 + V_57 ) ;
return V_147 ;
}
static int F_92 ( struct V_19 * V_20 )
{
struct V_148 * V_149 ;
struct V_19 * V_150 , * V_151 ;
V_149 = V_21 ;
V_150 = V_21 -> V_20 ;
F_93 ( V_149 , V_150 ) ;
if ( V_150 ) {
...
F_96 ( & V_150 -> V_45 ) ;
F_2 ( V_151 != V_150 ) ;
F_101 ( & V_149 -> signal -> V_155 , V_150 ) ;
F_102 ( V_150 ) ;
F_103 ( V_150 ) ;
return 0 ;
}
...
static int F_104 ( struct V_148 * V_149 )
{
struct V_156 * V_157 = V_149 -> signal ;
struct V_158 * V_159 = V_149 -> V_160 ;
T_7 * V_161 = & V_159 -> V_162 ;
if ( F_105 ( V_149 ) )
goto V_163;
F_106 ( V_161 ) ;
if ( F_107 ( V_157 ) ) {
...
F_108 ( V_161 ) ;
if ( ! F_110 ( V_149 ) ) {
struct V_148 * V_169 = V_149 -> V_170 ;
for (; ; ) {
F_114 ( V_149 ) ;
F_115 ( & V_171 ) ;
V_157 -> V_166 = - 1 ;
if ( F_116 ( V_169 -> V_172 ) )
break;
F_111 ( V_167 ) ;
F_117 ( & V_171 ) ;
F_118 ( V_149 ) ;
...
V_149 -> V_173 = V_169 -> V_173 ;
V_149 -> V_174 = V_169 -> V_174 ;
F_2 ( ! F_119 ( V_169 , V_149 ) ) ;
F_2 ( F_120 ( V_149 ) ) ;
V_149 -> V_175 = V_169 -> V_175 ;
F_121 ( V_149 , V_176 , F_122 ( V_169 ) ) ;
F_123 ( V_169 , V_149 , V_177 ) ;
F_123 ( V_169 , V_149 , V_178 ) ;
F_124 ( & V_169 -> V_179 , & V_149 -> V_179 ) ;
F_125 ( & V_169 -> V_180 , & V_149 -> V_180 ) ;
V_149 -> V_170 = V_149 ;
V_169 -> V_170 = V_149 ;
V_149 -> V_181 = V_182 ;
V_169 -> V_181 = - 1 ;
F_2 ( V_169 -> V_172 != V_183 ) ;
V_169 -> V_172 = V_184 ;
if ( F_45 ( V_169 -> V_185 ) )
F_126 ( V_169 , V_169 -> V_186 ) ;
F_117 ( & V_171 ) ;
F_118 ( V_149 ) ;
F_127 ( V_169 ) ;
}
...
F_128 ( V_157 ) ;
F_129 () ;
if ( F_130 ( & V_159 -> F_49 ) != 1 ) {
struct V_158 * V_187 ;
V_187 = F_131 ( V_188 , V_43 ) ;
if ( ! V_187 )
return - V_44 ;
F_132 ( & V_187 -> F_49 , 1 ) ;
memcpy ( V_187 -> V_189 , V_159 -> V_189 ,
sizeof( V_187 -> V_189 ) ) ;
F_115 ( & V_171 ) ;
F_133 ( & V_159 -> V_162 ) ;
F_134 ( V_149 -> V_160 , V_187 ) ;
F_135 ( & V_159 -> V_162 ) ;
F_117 ( & V_171 ) ;
F_136 ( V_159 ) ;
}
...
char * F_139 ( char * V_190 , struct V_148 * V_149 )
{
F_97 ( V_149 ) ;
strncpy ( V_190 , V_149 -> V_191 , sizeof( V_149 -> V_191 ) ) ;
F_100 ( V_149 ) ;
return V_190 ;
}
void F_140 ( struct V_148 * V_149 , const char * V_190 , bool V_111 )
{
F_97 ( V_149 ) ;
F_141 ( V_149 , V_190 ) ;
F_142 ( V_149 -> V_191 , V_190 , sizeof( V_149 -> V_191 ) ) ;
F_100 ( V_149 ) ;
F_143 ( V_149 , V_111 ) ;
}
...
F_13 ( V_17 , 0 ) ;
V_192 = F_92 ( V_17 -> V_20 ) ;
if ( V_192 )
goto V_78;
V_17 -> V_20 = NULL ;
F_61 ( V_193 ) ;
V_21 -> V_122 &= ~ ( V_194 | V_195 | V_196 |
V_197 | V_198 ) ;
F_146 () ;
V_21 -> V_199 &= ~ V_17 -> V_200 ;
return 0 ;
V_78:
return V_192 ;
}
...
{
if ( F_148 ( F_79 ( V_118 ) , V_201 ) < 0 )
V_17 -> V_202 |= V_203 ;
}
void F_149 ( struct V_16 * V_17 )
{
F_150 ( V_21 -> V_20 ) ;
V_21 -> V_204 = V_21 -> V_205 = 0 ;
if ( F_151 ( F_152 () , F_153 () ) && F_154 ( F_155 () , F_156 () ) )
F_157 ( V_21 -> V_20 , V_206 ) ;
else
F_157 ( V_21 -> V_20 , V_207 ) ;
F_158 () ;
F_140 ( V_21 , F_159 ( V_17 -> V_120 ) , true ) ;
V_21 -> V_20 -> V_208 = V_209 ;
if ( ! F_151 ( V_17 -> V_210 -> V_211 , F_152 () ) ||
! F_154 ( V_17 -> V_210 -> V_212 , F_155 () ) ) {
V_21 -> V_213 = 0 ;
} else {
...
{
if ( F_163 ( & V_21 -> signal -> V_216 ) )
return - V_217 ;
V_17 -> V_210 = F_164 () ;
if ( F_116 ( V_17 -> V_210 ) )
return 0 ;
F_165 ( & V_21 -> signal -> V_216 ) ;
return - V_44 ;
}
...
if ( V_17 -> V_218 != V_17 -> V_120 )
F_169 ( V_17 -> V_218 ) ;
F_169 ( V_17 ) ;
}
int F_170 ( char * V_218 , struct V_16 * V_17 )
{
if ( V_17 -> V_218 != V_17 -> V_120 )
F_169 ( V_17 -> V_218 ) ;
V_17 -> V_218 = F_171 ( V_218 , V_43 ) ;
if ( ! V_17 -> V_218 )
return - V_44 ;
return 0 ;
}
...
V_219 = V_56 ;
V_220 = 1 ;
F_133 ( & V_56 -> V_226 -> V_161 ) ;
F_180 () ;
F_181 (p, t) {
if ( V_219 -> V_226 == V_56 -> V_226 )
V_220 ++ ;
}
F_182 () ;
if ( V_56 -> V_226 -> V_227 > V_220 )
V_17 -> V_222 |= V_228 ;
else
V_56 -> V_226 -> V_229 = 1 ;
F_135 ( & V_56 -> V_226 -> V_161 ) ;
}
...
T_8 V_211 ;
T_9 V_212 ;
V_17 -> V_210 -> V_232 = F_152 () ;
V_17 -> V_210 -> V_233 = F_155 () ;
if ( V_17 -> V_118 -> V_141 . V_10 -> V_11 & V_234 )
return;
if ( F_179 ( V_21 ) )
return;
V_230 = F_79 ( V_17 -> V_118 ) ;
V_231 = F_184 ( V_230 -> V_140 ) ;
...
V_212 = V_230 -> V_238 ;
F_186 ( V_230 ) ;
if ( ! F_187 ( V_17 -> V_210 -> V_239 , V_211 ) ||
! F_188 ( V_17 -> V_210 -> V_239 , V_212 ) )
return;
if ( V_231 & V_235 ) {
V_17 -> V_200 |= V_240 ;
V_17 -> V_210 -> V_232 = V_211 ;
}
if ( ( V_231 & ( V_236 | V_241 ) ) == ( V_236 | V_241 ) ) {
V_17 -> V_200 |= V_240 ;
V_17 -> V_210 -> V_233 = V_212 ;
}
}
...
return V_192 ;
V_17 -> V_242 = 1 ;
memset ( V_17 -> V_190 , 0 , V_243 ) ;
return F_87 ( V_17 -> V_118 , 0 , V_17 -> V_190 , V_243 ) ;
}
...
int F_194 ( struct V_16 * V_17 )
{
bool V_244 = F_195 ( V_245 ) ;
struct V_1 * V_2 ;
int V_192 ;
if ( V_17 -> V_246 > 5 )
return - V_247 ;
...
F_10 ( V_2 ) ;
V_17 -> V_246 -- ;
if ( V_192 < 0 && ! V_17 -> V_20 ) {
F_138 ( & V_5 ) ;
F_199 ( V_250 , V_21 ) ;
return V_192 ;
}
if ( V_192 != - V_251 || ! V_17 -> V_118 ) {
F_138 ( & V_5 ) ;
return V_192 ;
}
}
F_138 ( & V_5 ) ;
if ( V_244 ) {
if ( F_200 ( V_17 -> V_190 [ 0 ] ) && F_200 ( V_17 -> V_190 [ 1 ] ) &&
F_200 ( V_17 -> V_190 [ 2 ] ) && F_200 ( V_17 -> V_190 [ 3 ] ) )
return V_192 ;
if ( F_201 ( L_1 , * ( V_252 * ) ( V_17 -> V_190 + 2 ) ) < 0 )
return V_192 ;
V_244 = false ;
goto V_249;
}
...
V_253 = V_21 -> V_175 ;
F_180 () ;
V_254 = F_203 ( V_21 , F_204 ( V_21 -> V_186 ) ) ;
F_182 () ;
V_28 = F_194 ( V_17 ) ;
if ( V_28 >= 0 ) {
F_205 ( V_17 ) ;
F_206 ( V_21 , V_253 , V_17 ) ;
F_207 ( V_255 , V_254 ) ;
F_208 ( V_21 ) ;
}
return V_28 ;
}
static int F_209 ( int V_119 , struct V_120 * V_120 ,
struct V_62 V_63 ,
struct V_62 V_256 ,
int V_122 )
{
...
if ( V_120 -> V_121 [ 0 ] == '\0' )
V_257 = F_215 ( V_268 , L_2 , V_119 ) ;
else
V_257 = F_215 ( V_268 , L_3 ,
V_119 , V_120 -> V_121 ) ;
if ( ! V_257 ) {
V_192 = - V_44 ;
goto V_267;
}
if ( F_216 ( V_119 , F_217 ( V_21 -> V_215 -> V_269 ) ) )
V_17 -> V_202 |= V_270 ;
V_17 -> V_120 = V_257 ;
}
V_17 -> V_218 = V_17 -> V_120 ;
V_192 = F_40 ( V_17 ) ;
if ( V_192 )
goto V_267;
V_17 -> V_73 = F_49 ( V_63 , V_271 ) ;
if ( ( V_192 = V_17 -> V_73 ) < 0 )
goto V_78;
V_17 -> V_272 = F_49 ( V_256 , V_271 ) ;
if ( ( V_192 = V_17 -> V_272 ) < 0 )
goto V_78;
V_192 = F_189 ( V_17 ) ;
if ( V_192 < 0 )
goto V_78;
V_192 = F_59 ( 1 , & V_17 -> V_120 , V_17 ) ;
if ( V_192 < 0 )
goto V_78;
V_17 -> V_111 = V_17 -> V_56 ;
V_192 = F_53 ( V_17 -> V_272 , V_256 , V_17 ) ;
if ( V_192 < 0 )
goto V_78;
V_192 = F_53 ( V_17 -> V_73 , V_63 , V_17 ) ;
if ( V_192 < 0 )
goto V_78;
V_192 = F_202 ( V_17 ) ;
if ( V_192 < 0 )
...
int F_222 ( struct V_120 * V_120 ,
const char T_1 * const T_1 * V_82 ,
const char T_1 * const T_1 * V_273 )
{
struct V_62 V_63 = { . V_68 . V_65 = V_82 } ;
struct V_62 V_256 = { . V_68 . V_65 = V_273 } ;
return F_209 ( V_143 , V_120 , V_63 , V_256 , 0 ) ;
}
int F_223 ( int V_119 , struct V_120 * V_120 ,
const char T_1 * const T_1 * V_82 ,
const char T_1 * const T_1 * V_273 ,
int V_122 )
{
struct V_62 V_63 = { . V_68 . V_65 = V_82 } ;
struct V_62 V_256 = { . V_68 . V_65 = V_273 } ;
return F_209 ( V_119 , V_120 , V_63 , V_256 , V_122 ) ;
}
static int F_224 ( struct V_120 * V_120 ,
const T_2 T_1 * V_82 ,
const T_2 T_1 * V_273 )
{
struct V_62 V_63 = {
...
static int F_225 ( int V_119 , struct V_120 * V_120 ,
const T_2 T_1 * V_82 ,
const T_2 T_1 * V_273 ,
int V_122 )
{
...
void F_157 ( struct V_19 * V_20 , int V_276 )
{
unsigned long V_277 , V_274 ;
if ( F_3 ( ( unsigned ) V_276 > V_278 ) )
return;
do {
V_277 = F_19 ( V_20 -> V_122 ) ;
V_274 = ( V_277 & ~ V_279 ) | V_276 ;
} while ( F_228 ( & V_20 -> V_122 , V_277 , V_274 ) != V_277 );
}
