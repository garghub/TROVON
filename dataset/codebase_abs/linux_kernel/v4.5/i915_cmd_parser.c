...
& V_22 -> V_22 [ V_24 ] ;
struct V_41 * V_42 =
F_12 ( sizeof( * V_42 ) , V_43 ) ;
if ( ! V_42 )
return - V_44 ;
V_42 -> V_27 = V_27 ;
F_13 ( V_16 -> V_40 , & V_42 -> V_45 ,
V_27 -> V_29 . V_30 & V_46 ) ;
}
}
return 0 ;
...
struct V_41 * V_42 ;
int V_20 ;
F_15 (ring->cmd_hash, i, tmp, desc_node, node) {
F_16 ( & V_42 -> V_45 ) ;
F_17 ( V_42 ) ;
}
}
...
{
struct V_41 * V_42 ;
F_28 (ring->cmd_hash, desc_node, node,
...
int V_81 = V_80 - V_78 ;
struct V_82 * * V_83 ;
V_83 = F_32 ( V_81 , sizeof( * V_83 ) ) ;
if ( V_83 == NULL ) {
F_2 ( L_8 ) ;
goto V_84;
}
V_20 = 0 ;
F_33 (obj->pages->sgl, &sg_iter, obj->pages->nents, first_page) {
V_83 [ V_20 ++ ] = F_34 ( & V_77 ) ;
if ( V_20 == V_81 )
break;
}
V_37 = F_35 ( V_83 , V_20 , 0 , V_85 ) ;
if ( V_37 == NULL ) {
F_2 ( L_9 ) ;
goto V_84;
}
...
static T_1 * F_37 ( struct V_72 * V_86 ,
struct V_72 * V_87 ,
T_1 V_88 ,
T_1 V_89 )
{
...
V_99:
F_44 ( V_87 ) ;
return V_21 ? F_38 ( V_21 ) : V_93 ;
}
bool F_45 ( struct V_15 * V_16 )
{
if ( ! V_16 -> V_65 )
return false ;
if ( ! F_46 ( V_16 -> V_49 ) )
...
static bool F_47 ( const struct V_15 * V_16 ,
const struct V_26 * V_27 ,
...
F_30 ( V_16 -> V_35 , V_16 -> V_36 ,
V_111 ) ;
if ( ! V_109 && V_103 )
V_109 = F_30 ( V_16 -> V_38 ,
V_16 -> V_39 ,
V_111 ) ;
if ( ! V_109 ) {
F_2 ( L_16 ,
...
if ( ! F_47 ( V_16 , V_27 , V_29 , V_71 , V_103 ,
& V_104 ) ) {
V_21 = - V_127 ;
break;
}
