...
struct V_29 , V_33 ) ;
V_30 -> V_34 . V_35 . V_36 = F_20 () ;
V_30 -> V_34 . V_37 = V_27 -> V_28 ++ ;
F_21 ( 1 , L_31 , V_30 ,
V_30 -> V_34 . V_35 . V_38 ,
V_28 , V_27 -> V_28 ) ;
F_22 ( & V_30 -> V_33 ) ;
F_23 ( & V_30 -> V_34 . V_35 , V_39 ) ;
}
...
if ( V_178 [ V_2 -> V_167 ] . V_225 == V_226 ) {
if ( F_61 ( V_2 ) < 0 ) {
F_15 ( V_100 L_79
L_80 , V_46 ) ;
}
...
if ( V_178 [ V_2 -> V_167 ] . V_210 == V_207 ) {
if ( V_178 [ V_2 -> V_167 ] . V_228 )
V_2 -> V_211 . V_114 =
V_178 [ V_2 -> V_167 ] . V_228 ;
if ( F_62 ( & V_2 -> V_211 ) < 0 ) {
F_15 ( V_100
L_83 ,
V_46 ) ;
...
static T_2 * F_72 ( T_2 * V_233 , struct V_234 * V_235 ,
unsigned int V_236 , T_1 V_237 ,
unsigned int V_42 , unsigned int V_238 ,
unsigned int V_43 , unsigned int V_239 , bool V_240 )
{
struct V_234 * V_241 ;
unsigned int line , V_242 , V_243 ;
if ( V_240 ) {
* ( V_233 ++ ) = F_30 ( V_16 ) ;
* ( V_233 ++ ) = F_30 ( 0 ) ;
* ( V_233 ++ ) = F_30 ( 0 ) ;
...
if ( V_237 != V_244 )
* ( V_233 ++ ) = F_30 ( V_245 | V_237 ) ;
V_241 = V_235 ;
for ( line = 0 ; line < V_43 ; line ++ ) {
while ( V_236 && V_236 >= F_73 ( V_241 ) ) {
V_236 -= F_73 ( V_241 ) ;
V_241 = F_74 ( V_241 ) ;
}
if ( V_239 && line > 0 && ! ( line % V_239 ) )
V_243 = V_246 | V_247 | V_248 ;
else
V_243 = V_246 ;
if ( V_42 <= F_73 ( V_241 ) - V_236 ) {
* ( V_233 ++ ) = F_30 ( V_12 | V_243 | V_249 | V_42 ) ;
* ( V_233 ++ ) = F_30 ( F_75 ( V_241 ) + V_236 ) ;
* ( V_233 ++ ) = F_30 ( 0 ) ;
V_236 += V_42 ;
} else {
V_242 = V_42 ;
* ( V_233 ++ ) = F_30 ( V_12 | V_243 |
( F_73 ( V_241 ) - V_236 ) ) ;
* ( V_233 ++ ) = F_30 ( F_75 ( V_241 ) + V_236 ) ;
* ( V_233 ++ ) = F_30 ( 0 ) ;
V_242 -= ( F_73 ( V_241 ) - V_236 ) ;
V_236 = 0 ;
V_241 = F_74 ( V_241 ) ;
while ( V_242 > F_73 ( V_241 ) ) {
* ( V_233 ++ ) = F_30 ( V_12 |
F_73 ( V_241 ) ) ;
* ( V_233 ++ ) = F_30 ( F_75 ( V_241 ) ) ;
* ( V_233 ++ ) = F_30 ( 0 ) ;
V_242 -= F_73 ( V_241 ) ;
V_241 = F_74 ( V_241 ) ;
}
* ( V_233 ++ ) = F_30 ( V_12 | V_249 | V_242 ) ;
* ( V_233 ++ ) = F_30 ( F_75 ( V_241 ) ) ;
* ( V_233 ++ ) = F_30 ( 0 ) ;
V_236 += V_242 ;
}
...
int F_76 ( struct V_250 * V_99 , struct V_61 * V_9 ,
struct V_234 * V_235 , unsigned int V_251 ,
unsigned int V_252 , unsigned int V_42 ,
unsigned int V_238 , unsigned int V_43 )
{
T_1 V_253 , V_254 ;
T_2 * V_233 ;
V_254 = 0 ;
...
if ( V_168 != V_252 )
V_254 ++ ;
V_253 = V_254 * ( 1 + ( ( V_42 + V_238 ) * V_43 )
/ V_255 + V_43 ) ;
V_253 += 5 ;
V_9 -> V_65 = V_253 * 12 ;
V_9 -> V_63 = F_77 ( V_99 , V_9 -> V_65 , & V_9 -> V_64 ) ;
if ( V_9 -> V_63 == NULL )
return - V_256 ;
V_233 = V_9 -> V_63 ;
if ( V_168 != V_251 )
V_233 = F_72 ( V_233 , V_235 , V_251 , 0 ,
V_42 , V_238 , V_43 , 0 , true ) ;
if ( V_168 != V_252 )
V_233 = F_72 ( V_233 , V_235 , V_252 , 0x200 ,
V_42 , V_238 , V_43 , 0 , V_168 == V_251 ) ;
V_9 -> V_257 = V_233 ;
F_26 ( ( V_9 -> V_257 - V_9 -> V_63 + 2 ) * sizeof( * V_9 -> V_63 ) > V_9 -> V_65 ) ;
return 0 ;
}
int F_78 ( struct V_250 * V_99 ,
struct V_61 * V_9 ,
struct V_234 * V_235 ,
unsigned int V_42 ,
unsigned int V_43 , unsigned int V_239 )
{
T_1 V_253 ;
T_2 * V_233 ;
V_253 = 1 + ( V_42 * V_43 ) / V_255 + V_43 ;
V_253 += 4 ;
V_9 -> V_65 = V_253 * 12 ;
V_9 -> V_63 = F_77 ( V_99 , V_9 -> V_65 , & V_9 -> V_64 ) ;
if ( V_9 -> V_63 == NULL )
return - V_256 ;
V_233 = V_9 -> V_63 ;
V_233 = F_72 ( V_233 , V_235 , 0 , V_244 ,
V_42 , 0 , V_43 , V_239 , V_239 == 0 ) ;
V_9 -> V_257 = V_233 ;
F_26 ( ( V_9 -> V_257 - V_9 -> V_63 + 2 ) * sizeof( * V_9 -> V_63 ) > V_9 -> V_65 ) ;
return 0 ;
}
int F_79 ( struct V_250 * V_99 , struct V_61 * V_9 ,
struct V_234 * V_235 , unsigned int V_251 ,
unsigned int V_252 , unsigned int V_42 ,
unsigned int V_238 , unsigned int V_43 )
{
...
void F_80 ( struct V_1 * V_2 , struct V_29 * V_30 )
{
struct V_61 * V_9 = & V_30 -> V_9 ;
F_26 ( F_81 () ) ;
F_82 ( V_2 -> V_99 , V_9 -> V_65 , V_9 -> V_63 , V_9 -> V_64 ) ;
}
...
T_1 V_260 ;
F_21 ( 1 , L_108 , V_46 ,
V_2 -> V_261 , V_2 -> V_262 , V_2 -> V_263 ) ;
F_9 ( V_25 -> V_119 , V_25 -> V_103 ) ;
F_24 ( V_2 ,
& V_2 -> V_87 [ V_25 -> V_140 ] ,
V_25 -> V_264 , V_30 -> V_9 . V_64 ) ;
if ( V_265 > 5 ) {
F_27 ( V_2 ,
& V_2 -> V_87 [ V_25 -> V_140 ] ) ;
F_28 ( V_25 , & V_30 -> V_9 ) ;
}
F_25 ( V_25 -> V_120 , V_25 -> V_264 ) ;
if ( ( ! ( V_178 [ V_2 -> V_167 ] . V_206 & V_207 ) ) &&
...
F_86 ( 100 ) ;
if ( V_25 -> V_136 )
F_25 ( V_25 -> V_136 , V_25 -> V_267 ) ;
F_25 ( V_25 -> V_122 , V_25 -> V_106 ) ;
F_25 ( V_25 -> V_134 , V_25 -> V_268 ) ;
F_25 ( V_25 -> V_132 , V_25 -> V_105 ) ;
F_25 ( V_25 -> V_124 , V_25 -> V_269 ) ;
F_86 ( 100 ) ;
F_25 ( V_25 -> V_117 , 3 ) ;
V_27 -> V_28 = 0 ;
if ( V_178 [ V_2 -> V_167 ] . V_206 == V_207 ) {
...
int F_88 ( struct V_29 * V_30 , struct V_24 * V_25 )
{
struct V_1 * V_2 = V_25 -> V_2 ;
int V_65 = V_25 -> V_264 * V_25 -> V_271 ;
struct V_272 * V_273 = F_89 ( & V_30 -> V_34 . V_35 , 0 ) ;
F_21 ( 1 , L_111 , V_46 , V_30 ) ;
if ( F_90 ( & V_30 -> V_34 . V_35 , 0 ) < V_65 )
return - V_266 ;
F_91 ( & V_30 -> V_34 . V_35 , 0 , V_65 ) ;
F_78 ( V_2 -> V_99 , & V_30 -> V_9 ,
V_273 -> V_274 ,
V_25 -> V_264 , V_25 -> V_271 , 0 ) ;
return 0 ;
}
...
struct V_29 * V_275 ;
struct V_1 * V_2 = V_25 -> V_2 ;
struct V_26 * V_276 = & V_25 -> V_109 ;
unsigned long V_4 ;
V_30 -> V_9 . V_63 [ 1 ] = F_30 ( V_30 -> V_9 . V_64 + 12 ) ;
V_30 -> V_9 . V_257 [ 0 ] = F_30 ( V_16 | V_248 ) ;
V_30 -> V_9 . V_257 [ 1 ] = F_30 ( V_30 -> V_9 . V_64 + 12 ) ;
V_30 -> V_9 . V_257 [ 2 ] = F_30 ( 0 ) ;
F_2 ( & V_2 -> V_107 , V_4 ) ;
if ( F_18 ( & V_276 -> V_31 ) ) {
F_93 ( & V_30 -> V_33 , & V_276 -> V_31 ) ;
F_21 ( 1 , L_112 ,
V_30 , V_30 -> V_34 . V_35 . V_38 , V_46 ) ;
} else {
V_30 -> V_9 . V_63 [ 0 ] |= F_30 ( V_247 ) ;
V_275 = F_19 ( V_276 -> V_31 . V_275 , struct V_29 ,
V_33 ) ;
F_93 ( & V_30 -> V_33 , & V_276 -> V_31 ) ;
V_275 -> V_9 . V_257 [ 1 ] = F_30 ( V_30 -> V_9 . V_64 ) ;
F_21 ( 1 , L_113 ,
V_30 , V_30 -> V_34 . V_35 . V_38 , V_46 ) ;
}
F_3 ( & V_2 -> V_107 , V_4 ) ;
}
static void F_94 ( struct V_24 * V_25 , char * V_277 )
{
struct V_1 * V_2 = V_25 -> V_2 ;
...
V_33 ) ;
F_22 ( & V_30 -> V_33 ) ;
F_23 ( & V_30 -> V_34 . V_35 , V_278 ) ;
F_21 ( 1 , L_114 ,
V_30 , V_30 -> V_34 . V_35 . V_38 , V_277 ,
( unsigned long ) V_30 -> V_9 . V_64 ) ;
}
F_3 ( & V_25 -> V_107 , V_4 ) ;
}
...
int F_96 ( struct V_1 * V_2 , T_1 V_279 )
{
...
if ( V_279 ) {
F_25 ( V_25 -> V_139 , V_279 ) ;
V_280 = 1 ;
}
return V_280 ;
}
static int F_98 ( struct V_24 * V_25 , T_1 V_279 )
{
struct V_1 * V_2 = V_25 -> V_2 ;
int V_280 = 0 ;
T_1 V_28 ;
...
static T_3 F_99 ( int V_294 , void * V_295 )
{
...
T_1 V_302 , V_303 ;
T_1 V_304 , V_305 ;
int V_306 = 0 , V_307 = 0 , V_308 = 0 , V_280 = 0 ;
int V_309 = 0 ;
bool V_310 ;
V_296 = F_13 ( V_79 ) ;
V_297 = F_12 ( V_2 ) ;
...
V_304 = F_13 ( V_82 ) ;
V_305 = F_13 ( V_76 ) ;
if ( ( V_296 == 0 ) && ( V_304 == 0 ) && ( V_302 == 0 ) )
goto V_311;
V_306 = F_13 ( V_312 ) ;
V_309 = F_13 ( V_313 ) ;
V_307 = F_13 ( V_209 -> V_115 ) ;
V_308 = F_13 ( V_211 -> V_115 ) ;
F_21 ( 7 , L_133 ,
V_296 , V_297 ) ;
F_21 ( 7 , L_134 ,
V_298 , V_299 , V_306 ) ;
...
if ( V_178 [ V_2 -> V_167 ] . V_229 == 1 &&
( V_296 & ( V_325 | V_324 ) ) )
V_280 += F_100 ( V_2 , V_296 ) ;
if ( V_178 [ V_2 -> V_167 ] . V_229 == 2 &&
( V_296 & V_324 ) )
V_280 += F_101 ( V_2 ) ;
if ( V_302 ) {
if ( V_178 [ V_2 -> V_167 ] . V_206 == V_207 )
V_280 += F_98 ( V_209 , V_302 ) ;
else
if ( V_178 [ V_2 -> V_167 ] . V_206 == V_208 )
V_280 += F_96 ( V_2 , V_302 ) ;
}
if ( V_304 ) {
if ( V_178 [ V_2 -> V_167 ] . V_210 == V_207 )
V_280 += F_98 ( V_211 , V_304 ) ;
else
if ( V_178 [ V_2 -> V_167 ] . V_210 == V_208 )
V_280 += F_96 ( V_2 , V_304 ) ;
}
if ( V_298 )
V_280 += F_102 ( V_2 , V_298 ) ;
if ( V_300 )
V_280 += F_103 ( V_2 , V_300 , V_301 ) ;
if ( V_296 & V_327 ) {
V_310 = false ;
F_104 ( V_2 -> V_328 , V_222 , V_329 ,
V_296 , & V_310 ) ;
if ( V_310 )
V_280 ++ ;
}
if ( ( V_296 & V_297 ) & V_326 ) {
F_8 ( V_2 , V_326 ) ;
F_105 ( & V_2 -> V_330 ) ;
V_280 ++ ;
}
...
case V_333 :
if ( V_157 == V_2 -> V_328 )
F_109 ( V_157 , * ( T_1 * ) V_332 ) ;
break;
case V_334 :
if ( V_157 == V_2 -> V_328 )
F_110 ( V_157 , * ( T_1 * ) V_332 ) ;
break;
}
}
static void F_111 ( struct V_1 * V_2 )
{
F_112 ( & V_2 -> V_330 , V_335 ) ;
F_112 ( & V_2 -> V_336 , V_337 ) ;
F_112 ( & V_2 -> V_338 , V_339 ) ;
V_2 -> V_158 . V_340 = F_107 ;
}
...
{
if ( V_3 & 0x00000007 )
return ( F_13 ( V_341 ) >> 8 ) & V_3 & 0x7 ;
if ( V_3 & 0x0007fff8 ) {
if ( F_113 ( V_2 ) || F_114 ( V_2 ) )
F_15 ( V_100
L_155 ,
V_2 -> V_47 ) ;
return ( F_13 ( V_342 ) & ( ( V_3 & 0x7fff8 ) >> 3 ) ) << 3 ;
}
if ( V_3 & 0x00f80000 )
F_15 ( V_62 L_153 , V_2 -> V_47 ) ;
return 0 ;
}
void F_60 ( struct V_1 * V_2 , T_1 V_3 , int V_343 )
{
if ( ( V_3 & 0x00000007 ) && V_343 )
F_5 ( V_341 , ( V_3 & 0x7 ) << 16 ) ;
else if ( ( V_3 & 0x00000007 ) && ! V_343 )
F_9 ( V_341 , ( V_3 & 0x7 ) << 16 ) ;
if ( V_3 & 0x0007fff8 ) {
if ( F_113 ( V_2 ) || F_114 ( V_2 ) )
F_15 ( V_100
L_156 ,
...
if ( ( V_3 & 0x0007fff8 ) && V_343 )
F_9 ( V_344 , ( V_3 & 0x7fff8 ) >> 3 ) ;
else if ( ( V_3 & 0x0007fff8 ) && ! V_343 )
F_5 ( V_344 , ( V_3 & 0x7fff8 ) >> 3 ) ;
}
static int F_118 ( struct V_250 * V_250 ,
const struct V_345 * V_346 )
{
struct V_1 * V_2 ;
struct V_347 * V_348 ;
int V_349 ;
V_2 = F_119 ( sizeof( * V_2 ) , V_350 ) ;
if ( NULL == V_2 )
return - V_256 ;
V_349 = F_120 ( & V_250 -> V_2 , & V_2 -> V_158 ) ;
if ( V_349 < 0 )
goto V_351;
V_348 = & V_2 -> V_352 ;
F_121 ( V_348 , 6 ) ;
...
V_2 -> V_355 = V_250 -> V_356 ;
F_123 ( V_250 , V_357 , & V_2 -> V_358 ) ;
F_15 ( V_62 L_157
L_158 , V_2 -> V_47 ,
F_124 ( V_250 ) , V_2 -> V_355 , V_250 -> V_294 ,
V_2 -> V_358 ,
( unsigned long long ) F_38 ( V_250 , 0 ) ) ;
F_125 ( V_250 ) ;
V_349 = F_126 ( V_250 , 0xffffffff ) ;
if ( V_349 ) {
F_15 ( L_159 , V_2 -> V_47 ) ;
goto V_359;
}
V_2 -> V_360 = F_127 ( & V_250 -> V_2 ) ;
if ( F_128 ( V_2 -> V_360 ) ) {
V_349 = F_129 ( V_2 -> V_360 ) ;
goto V_359;
}
V_349 = F_130 ( V_250 -> V_294 , F_99 ,
V_361 , V_2 -> V_47 , V_2 ) ;
if ( V_349 < 0 ) {
F_15 ( V_100 L_160 ,
V_2 -> V_47 , V_250 -> V_294 ) ;
goto V_362;
}
switch ( V_2 -> V_167 ) {
case V_363 :
...
static void F_137 ( struct V_250 * V_250 )
{
struct V_365 * V_158 = F_138 ( V_250 ) ;
struct V_1 * V_2 = F_108 ( V_158 ) ;
F_139 ( V_2 ) ;
F_140 ( V_2 ) ;
F_31 ( V_2 ) ;
F_141 ( V_250 -> V_294 , V_2 ) ;
F_142 ( V_250 ) ;
F_64 ( V_2 ) ;
F_133 ( V_2 -> V_360 ) ;
F_134 ( & V_2 -> V_352 ) ;
