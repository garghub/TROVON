...
unsigned int V_69 ;
const T_1 V_259 = F_142 ( V_33 ) ? V_33 -> V_110 : V_33 -> V_179 ;
...
break;
V_69 = F_82 ( V_4 ) ;
V_258 = ( V_254 - V_257 ) * V_69 ;
if ( V_258 < V_4 -> V_10 &&
F_83 ( V_2 , V_4 , V_258 , V_69 , V_169 ) < 0 )
break;
V_256 = V_254 ;
}
F_75 ( V_33 , V_4 ) ;
...
static void F_144 ( struct V_1 * V_2 , int V_260 )
{
struct V_32 * V_33 = F_7 ( V_2 ) ;
if ( F_69 ( V_33 ) ) {
F_143 ( V_2 , 1 , 1 ) ;
} else if ( F_66 ( V_33 ) ) {
int V_258 = V_33 -> V_136 - V_33 -> V_59 ;
if ( V_258 <= 0 )
V_258 = 1 ;
F_143 ( V_2 , V_258 , 0 ) ;
} else {
...
F_188 ( V_2 , V_335 , V_318 , - 1L , V_318 ) ;
}
...
V_358 = F_188 ( V_2 , V_180 , V_326 , V_327 ,
V_328 ) ;
if ( V_180 & V_329 ) {
F_194 ( V_2 ) ;
...
F_363 ( V_332 ) -> V_677 = F_388 ( V_2 , V_4 ) ;
V_667 -> V_678 ( V_332 , V_2 , V_4 ) ;
if ( F_389 ( V_2 , V_4 , V_332 ) )
goto V_679;
if ( ! V_658 && ! V_668 ) {
if ( V_680 . V_681 ) {
bool V_682 ;
V_30 = V_667 -> V_683 ( V_2 , & V_673 , V_332 , & V_682 ) ;
if ( V_30 && V_682 &&
! F_390 ( V_332 , V_30 , true ,
V_670 . V_263 ) ) {
F_70 ( F_71 ( V_2 ) , V_684 ) ;
goto V_685;
}
...
( V_686 - F_391 ( V_2 ) <
( V_686 >> 2 ) ) &&
! F_390 ( V_332 , V_30 , false ,
V_670 . V_263 ) ) {
F_362 ( V_332 , F_154 ( F_6 ( V_4 ) -> V_642 ) ,
V_665 -> V_624 ) ;
goto V_685;
}
V_668 = V_667 -> V_687 ( V_4 ) ;
}
if ( ! V_30 ) {
V_30 = V_667 -> V_683 ( V_2 , & V_673 , V_332 , NULL ) ;
if ( ! V_30 )
goto V_679;
}
F_365 ( V_332 , V_4 , V_2 , V_30 ) ;
if ( V_658 ) {
V_668 = F_392 ( V_667 , V_2 , V_4 , & V_332 -> V_69 ) ;
V_332 -> V_639 = V_670 . V_441 ;
if ( ! V_670 . V_441 )
F_363 ( V_332 ) -> V_632 = 0 ;
}
F_190 ( V_332 ) -> V_688 = V_668 ;
F_190 ( V_332 ) -> V_689 = F_393 () ;
F_394 ( V_332 , V_2 , V_30 ) ;
if ( ! V_658 ) {
F_379 ( V_2 , V_332 , V_4 ) ;
V_671 = F_395 ( V_2 , V_4 , V_332 , & V_416 , V_30 ) ;
}
if ( V_671 ) {
V_667 -> V_690 ( V_671 , V_30 , & V_673 , V_332 ,
& V_416 , false ) ;
F_396 ( V_2 , V_332 , V_671 ) ;
V_2 -> V_533 ( V_2 ) ;
F_397 ( V_671 ) ;
F_398 ( V_671 ) ;
} else {
F_190 ( V_332 ) -> V_691 = false ;
if ( ! V_658 )
F_399 ( V_2 , V_332 , V_692 ) ;
V_667 -> V_690 ( V_2 , V_30 , & V_673 , V_332 ,
& V_416 , ! V_658 ) ;
if ( V_658 )
goto V_679;
}
