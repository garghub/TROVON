...
static void F_21 ( enum V_58 V_59 , const char * V_60 )
{
T_1 V_4 ;
V_4 = F_2 ( V_5 + V_61 ) ;
V_4 |= 0x105 ;
...
V_66 = F_24 ( sizeof( * V_66 ) , V_68 ) ;
if ( ! V_66 )
return;
V_66 -> V_69 = F_25 ( L_8 , V_68 ) ;
V_66 -> V_70 = F_25 ( L_9 , V_68 ) ;
V_66 -> V_30 = sizeof( L_9 ) ;
F_26 ( V_64 , V_66 ) ;
F_27 ( L_10 ) ;
}
