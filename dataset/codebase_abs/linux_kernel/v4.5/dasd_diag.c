...
V_16 = (struct V_15 * ) V_11 -> V_16 ;
if ( V_16 == NULL ) {
V_16 = F_26 ( sizeof( struct V_15 ) , V_89 ) ;
if ( V_16 == NULL ) {
F_11 ( V_59 , V_11 , L_9 ,
L_16
L_17 ) ;
...
static int
F_38 ( struct V_81 * V_26 , struct V_116 * V_117 )
{
if ( F_39 ( V_26 -> V_27 ) != 0 )
return - V_118 ;
