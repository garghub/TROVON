...
static unsigned long F_9 ( struct V_16 * V_16 , enum V_17 V_18 )
{
if ( ! F_10 () )
return F_11 ( V_16 , V_18 ) ;
return F_6 ( F_12 ( V_16 ) , V_19 + V_18 ) ;
}
int F_13 ( struct V_20 * V_20 )
{
...
static unsigned long F_21 ( struct V_31 * V_32 ,
struct V_20 * V_20 ,
unsigned long V_33 ,
unsigned long V_34 )
{
...
V_37 >= V_38 ) {
unsigned long V_47 ;
unsigned long V_48 = F_25 ( V_41 , V_37 ) ;
V_32 -> V_48 = V_48 ;
...
V_39 = F_30 ( & V_20 -> V_22 [ V_40 ] ) ;
F_31 ( V_20 , V_40 , V_35 , V_8 , V_39 , V_37 ) ;
return V_35 ;
}
static unsigned long F_32 ( T_2 V_51 , int V_40 ,
struct V_4 * V_5 ,
unsigned long V_33 ,
unsigned long V_34 )
{
...
if ( V_5 && ! ( V_20 -> V_24 & V_54 ) )
continue;
if ( ! ( V_20 -> V_24 & V_25 ) )
V_2 . V_40 = 0 ;
V_35 += F_21 ( & V_2 , V_20 , V_33 , V_34 ) ;
}
F_36 ( & V_28 ) ;
V_53:
F_28 () ;
...
static inline int F_41 ( struct V_55 * V_55 )
{
return F_42 ( V_55 ) - F_43 ( V_55 ) == 2 ;
}
static int F_44 ( struct V_56 * V_56 , struct V_1 * V_2 )
{
if ( V_57 -> V_24 & V_58 )
return 1 ;
if ( ! F_45 ( V_56 ) )
return 1 ;
if ( F_46 ( V_56 ) == V_57 -> V_59 )
return 1 ;
return 0 ;
}
...
static T_3 F_52 ( struct V_55 * V_55 , struct V_60 * V_61 ,
struct V_1 * V_2 )
{
if ( ! F_41 ( V_55 ) )
return V_62 ;
...
static int F_62 ( struct V_60 * V_61 , struct V_55 * V_55 ,
bool V_82 )
{
unsigned long V_24 ;
struct V_4 * V_5 ;
...
goto V_131;
if ( F_110 ( V_55 ) || F_71 ( V_55 ) )
V_2 -> V_33 ++ ;
V_124 = ( V_2 -> V_51 & V_132 ) ||
( F_71 ( V_55 ) && ( V_2 -> V_51 & V_133 ) ) ;
...
struct V_7 * V_7 = F_12 ( V_16 ) ;
struct V_178 * V_179 = & V_16 -> V_179 ;
while ( F_68 ( F_155 ( V_7 , V_175 , V_2 ) ) ) {
...
F_173 ( V_134 , & V_7 -> V_24 ) ;
if ( F_2 ( V_2 ) ) {
if ( V_119 && V_119 == V_120 )
F_173 ( V_192 , & V_7 -> V_24 ) ;
if ( V_118 == V_170 )
F_173 ( V_142 , & V_7 -> V_24 ) ;
if ( V_123 && F_165 () )
F_168 ( V_185 , V_186 / 10 ) ;
}
if ( ! V_2 -> V_193 && ! F_112 () &&
...
F_9 ( V_16 , V_206 ) ;
F_149 ( & V_7 -> V_174 ) ;
if ( F_68 ( V_179 -> V_189 [ 0 ] > V_215 / 4 ) ) {
V_179 -> V_189 [ 0 ] /= 2 ;
V_179 -> V_182 [ 0 ] /= 2 ;
}
if ( F_68 ( V_179 -> V_189 [ 1 ] > V_175 / 4 ) ) {
V_179 -> V_189 [ 1 ] /= 2 ;
V_179 -> V_182 [ 1 ] /= 2 ;
}
...
V_171 = F_25 ( V_21 , V_52 ) ;
switch ( V_214 ) {
case V_223 :
break;
case V_228 :
V_171 = F_191 ( V_171 * V_210 [ V_175 ] ,
V_211 ) ;
break;
case V_222 :
case V_227 :
...
static void F_193 ( struct V_7 * V_7 , struct V_4 * V_5 ,
struct V_1 * V_2 , unsigned long * V_208 )
{
struct V_16 * V_16 = F_194 ( V_7 , V_5 ) ;
...
{
if ( F_199 ( V_245 ) && V_2 -> V_173 &&
( V_2 -> V_173 > V_246 ||
V_2 -> V_148 < V_149 - 2 ) )
return true ;
return false ;
}
static inline bool F_200 ( struct V_7 * V_7 ,
unsigned long V_121 ,
unsigned long V_33 ,
struct V_1 * V_2 )
{
...
V_248 > V_247 )
return true ;
switch ( F_201 ( V_7 , V_2 -> V_173 , 0 , 0 ) ) {
case V_250 :
case V_251 :
return false ;
default:
...
static bool F_202 ( struct V_7 * V_7 , struct V_1 * V_2 ,
bool V_252 )
{
...
V_82 = V_2 -> V_121 ;
V_259 = V_2 -> V_33 ;
F_193 ( V_7 , V_5 , V_2 , & V_208 ) ;
V_258 += V_208 ;
if ( V_5 && V_252 )
F_32 ( V_2 -> V_51 , F_205 ( V_7 ) ,
V_5 , V_2 -> V_33 - V_259 ,
V_208 ) ;
F_206 ( V_2 -> V_51 , V_5 , false ,
V_2 -> V_33 - V_259 ,
V_2 -> V_121 - V_82 ) ;
if ( ! F_1 ( V_2 ) &&
V_2 -> V_121 >= V_2 -> V_235 ) {
...
F_206 ( V_2 -> V_51 , V_2 -> V_3 , true ,
V_2 -> V_33 - V_33 ,
V_2 -> V_121 - V_121 ) ;
if ( V_2 -> V_121 - V_121 )
V_254 = true ;
} while ( F_200 ( V_7 , V_2 -> V_121 - V_121 ,
V_2 -> V_33 - V_33 , V_2 ) );
return V_254 ;
}
static inline bool F_208 ( struct V_7 * V_7 , int V_173 )
{
unsigned long V_263 , V_264 ;
bool V_265 ;
V_263 = F_25 ( F_209 ( V_7 ) , F_210 (
V_7 -> V_266 , V_267 ) ) ;
V_264 = F_189 ( V_7 ) + V_263 + ( 2UL << V_173 ) ;
V_265 = F_211 ( V_7 , 0 , V_264 , 0 ) ;
if ( F_212 ( V_7 , V_173 ) )
return V_265 ;
if ( F_201 ( V_7 , V_173 , 0 , 0 ) == V_268 )
return false ;
return V_265 ;
}
static bool F_213 ( struct V_269 * V_269 , struct V_1 * V_2 )
{
struct V_270 * V_271 ;
struct V_7 * V_7 ;
unsigned long V_272 ;
unsigned long V_273 ;
T_2 V_274 ;
enum V_275 V_276 = F_214 ( V_2 -> V_51 ) ;
bool V_254 = false ;
V_274 = V_2 -> V_51 ;
if ( V_201 )
V_2 -> V_51 |= V_277 ;
F_215 (zone, z, zonelist,
requested_highidx, sc->nodemask) {
enum V_275 V_278 ;
if ( ! F_216 ( V_7 ) )
continue;
V_278 = V_276 ;
while ( ! F_216 ( V_7 -> V_279 -> V_280 +
V_278 ) )
V_278 -- ;
if ( F_1 ( V_2 ) ) {
if ( ! F_217 ( V_7 ,
...
if ( F_202 ( V_7 , V_2 , F_220 ( V_7 ) == V_278 ) )
V_254 = true ;
if ( F_1 ( V_2 ) &&
! V_254 && F_8 ( V_7 ) )
V_254 = true ;
...
static unsigned long F_221 ( struct V_269 * V_269 ,
struct V_1 * V_2 )
{
int V_282 = V_2 -> V_148 ;
...
F_96 ( V_287 ) ;
do {
F_223 ( V_2 -> V_51 , V_2 -> V_3 ,
V_2 -> V_148 ) ;
V_2 -> V_33 = 0 ;
V_285 = F_213 ( V_269 , V_2 ) ;
V_283 += V_2 -> V_33 ;
...
return true ;
V_293 = V_116 > V_291 / 2 ;
if ( ! V_293 && F_228 ( & V_290 -> V_295 ) ) {
V_290 -> V_278 = F_25 ( V_290 -> V_278 ,
(enum V_275 ) V_294 ) ;
F_229 ( & V_290 -> V_295 ) ;
}
return V_293 ;
}
static bool F_230 ( T_2 V_51 , struct V_269 * V_269 ,
T_9 * V_296 )
{
struct V_270 * V_271 ;
struct V_7 * V_7 ;
...
unsigned long F_233 ( struct V_269 * V_269 , int V_173 ,
T_2 V_51 , T_9 * V_296 )
{
unsigned long V_121 ;
struct V_1 V_2 = {
. V_235 = V_52 ,
. V_51 = ( V_51 = F_234 ( V_51 ) ) ,
. V_173 = V_173 ,
. V_296 = V_296 ,
. V_148 = V_149 ,
. V_144 = ! V_288 ,
...
if ( F_230 ( V_51 , V_269 , V_296 ) )
return 1 ;
F_235 ( V_173 ,
V_2 . V_144 ,
V_51 ) ;
V_121 = F_221 ( V_269 , & V_2 ) ;
F_236 ( V_121 ) ;
return V_121 ;
}
unsigned long F_237 ( struct V_4 * V_5 ,
T_2 V_51 , bool V_301 ,
struct V_7 * V_7 ,
unsigned long * V_33 )
{
...
static void F_246 ( struct V_7 * V_7 , struct V_1 * V_2 )
{
struct V_4 * V_5 ;
if ( ! V_205 )
return;
...
static bool F_247 ( struct V_7 * V_7 , int V_173 ,
unsigned long V_263 , int V_278 )
{
if ( ! F_211 ( V_7 , V_173 , F_189 ( V_7 ) +
V_263 , V_278 ) )
return false ;
if ( F_199 ( V_245 ) && V_173 && F_201 ( V_7 ,
V_173 , 0 , V_278 ) == V_268 )
return false ;
return true ;
}
static bool F_248 ( T_8 * V_290 , int V_173 , int V_278 )
{
...
if ( F_247 ( V_7 , V_173 , 0 , V_292 ) )
V_305 += V_7 -> V_266 ;
else if ( ! V_173 )
return false ;
}
if ( V_173 )
return V_305 >= ( V_266 >> 2 ) ;
else
return true ;
}
static bool F_249 ( T_8 * V_290 , int V_173 , long V_306 ,
int V_278 )
{
if ( V_306 )
return false ;
if ( F_228 ( & V_290 -> V_299 ) )
F_250 ( & V_290 -> V_299 ) ;
return F_248 ( V_290 , V_173 , V_278 ) ;
}
static bool F_251 ( struct V_7 * V_7 ,
int V_278 ,
struct V_1 * V_2 ,
unsigned long * V_307 )
{
...
unsigned long V_263 ;
bool V_309 ;
V_2 -> V_235 = F_241 ( V_52 , F_189 ( V_7 ) ) ;
if ( F_199 ( V_245 ) && V_2 -> V_173 &&
F_201 ( V_7 , V_2 -> V_173 , 0 , V_278 )
!= V_268 )
V_308 = 0 ;
V_263 = F_25 ( F_209 ( V_7 ) , F_210 (
V_7 -> V_266 , V_267 ) ) ;
V_309 = ( V_201 && F_252 ( V_7 ) ) ;
if ( ! V_309 && F_247 ( V_7 , V_308 ,
V_263 , V_278 ) )
return true ;
F_202 ( V_7 , V_2 , F_220 ( V_7 ) == V_278 ) ;
* V_307 += V_2 -> V_235 ;
F_253 ( V_134 , & V_7 -> V_24 ) ;
if ( F_8 ( V_7 ) &&
F_247 ( V_7 , V_308 , 0 , V_278 ) ) {
F_253 ( V_192 , & V_7 -> V_24 ) ;
F_253 ( V_142 , & V_7 -> V_24 ) ;
}
return V_2 -> V_33 >= V_2 -> V_235 ;
}
static unsigned long F_254 ( T_8 * V_290 , int V_173 ,
int * V_278 )
{
int V_292 ;
int V_310 = 0 ;
...
bool V_313 = ( V_173 > 0 ) ;
V_2 . V_121 = 0 ;
for ( V_292 = V_290 -> V_314 - 1 ; V_292 >= 0 ; V_292 -- ) {
struct V_7 * V_7 = V_290 -> V_280 + V_292 ;
if ( ! F_216 ( V_7 ) )
continue;
if ( V_2 . V_148 != V_149 &&
...
continue;
F_246 ( V_7 , & V_2 ) ;
if ( V_201 && F_255 ( V_292 ) ) {
V_310 = V_292 ;
break;
}
if ( ! F_247 ( V_7 , V_173 , 0 , 0 ) ) {
V_310 = V_292 ;
break;
} else {
F_253 ( V_192 , & V_7 -> V_24 ) ;
...
F_226 ( V_290 ) )
F_250 ( & V_290 -> V_299 ) ;
if ( V_173 && V_2 . V_121 >= 2UL << V_173 )
V_173 = V_2 . V_173 = 0 ;
if ( F_257 () || F_258 () )
break;
if ( V_313 && V_2 . V_121 > V_307 )
F_259 ( V_290 , V_173 ) ;
if ( V_312 || ! V_2 . V_121 )
V_2 . V_148 -- ;
} while ( V_2 . V_148 >= 1 &&
! F_248 ( V_290 , V_173 , * V_278 ) );
V_53:
* V_278 = V_310 ;
return V_173 ;
}
static void F_260 ( T_8 * V_290 , int V_173 , int V_278 )
{
long V_306 = 0 ;
F_261 ( V_315 ) ;
if ( F_262 ( V_57 ) || F_258 () )
return;
F_263 ( & V_290 -> V_295 , & V_315 , V_316 ) ;
if ( F_249 ( V_290 , V_173 , V_306 , V_278 ) ) {
V_306 = F_264 ( V_186 / 10 ) ;
F_265 ( & V_290 -> V_295 , & V_315 ) ;
F_263 ( & V_290 -> V_295 , & V_315 , V_316 ) ;
}
if ( F_249 ( V_290 , V_173 , V_306 , V_278 ) ) {
F_266 ( V_290 -> V_317 ) ;
...
int V_326 ;
T_8 * V_290 = ( T_8 * ) V_322 ;
struct V_327 * V_328 = V_57 ;
struct V_253 V_253 = {
. V_262 = 0 ,
} ;
const struct V_329 * V_329 = F_271 ( V_290 -> V_317 ) ;
F_272 ( V_26 ) ;
if ( ! F_273 ( V_329 ) )
F_274 ( V_328 , V_329 ) ;
V_57 -> V_253 = & V_253 ;
V_328 -> V_24 |= V_330 | V_58 | V_331 ;
F_275 () ;
V_173 = V_323 = 0 ;
V_324 = 0 ;
V_278 = V_325 = V_290 -> V_314 - 1 ;
V_326 = V_278 ;
for ( ; ; ) {
bool V_47 ;
if ( V_326 >= V_325 &&
...
V_325 = V_290 -> V_278 ;
V_290 -> V_332 = 0 ;
V_290 -> V_278 = V_290 -> V_314 - 1 ;
}
if ( V_173 < V_323 || V_278 > V_325 ) {
V_173 = V_323 ;
V_278 = V_325 ;
} else {
F_260 ( V_290 , V_324 ,
...
break;
if ( ! V_47 ) {
F_276 ( V_290 -> V_317 , V_173 ) ;
V_326 = V_278 ;
V_324 = F_254 ( V_290 , V_173 ,
& V_326 ) ;
}
}
V_328 -> V_24 &= ~ ( V_330 | V_58 | V_331 ) ;
...
void F_278 ( struct V_7 * V_7 , int V_173 , enum V_275 V_278 )
{
T_8 * V_290 ;
if ( ! F_216 ( V_7 ) )
return;
if ( ! F_217 ( V_7 , V_26 | V_281 ) )
return;
V_290 = V_7 -> V_279 ;
if ( V_290 -> V_332 < V_173 ) {
V_290 -> V_332 = V_173 ;
V_290 -> V_278 = F_25 ( V_290 -> V_278 , V_278 ) ;
}
if ( ! F_228 ( & V_290 -> V_295 ) )
return;
if ( F_247 ( V_7 , V_173 , 0 , 0 ) )
return;
F_279 ( V_290 -> V_317 , F_220 ( V_7 ) , V_173 ) ;
F_229 ( & V_290 -> V_295 ) ;
}
unsigned long F_280 ( unsigned long V_235 )
{
struct V_253 V_253 ;
struct V_1 V_2 = {
. V_235 = V_235 ,
...
struct V_269 * V_269 = F_281 ( F_282 () , V_2 . V_51 ) ;
struct V_327 * V_322 = V_57 ;
unsigned long V_121 ;
V_322 -> V_24 |= V_330 ;
F_272 ( V_2 . V_51 ) ;
V_253 . V_262 = 0 ;
...
static int F_283 ( struct V_333 * V_334 , unsigned long V_335 ,
void * V_336 )
{
int V_40 ;
if ( V_335 == V_337 || V_335 == V_338 ) {
F_284 (nid, N_MEMORY) {
T_8 * V_290 = F_243 ( V_40 ) ;
const struct V_329 * V_339 ;
V_339 = F_271 ( V_290 -> V_317 ) ;
if ( F_285 ( V_340 , V_339 ) < V_341 )
F_274 ( V_290 -> F_270 , V_339 ) ;
}
}
return V_342 ;
}
...
if ( V_290 -> F_270 )
return 0 ;
V_290 -> F_270 = F_287 ( F_270 , V_290 , L_4 , V_40 ) ;
if ( F_288 ( V_290 -> F_270 ) ) {
F_63 ( V_343 == V_344 ) ;
F_24 ( L_5 , V_40 ) ;
V_47 = F_289 ( V_290 -> F_270 ) ;
V_290 -> F_270 = NULL ;
}
return V_47 ;
}
void F_290 ( int V_40 )
{
struct V_327 * F_270 = F_243 ( V_40 ) -> F_270 ;
if ( F_270 ) {
F_291 ( F_270 ) ;
F_243 ( V_40 ) -> F_270 = NULL ;
}
}
...
static inline unsigned long F_295 ( struct V_7 * V_7 )
{
unsigned long V_345 = F_6 ( V_7 , V_346 ) ;
unsigned long V_347 = F_6 ( V_7 , V_10 ) +
F_6 ( V_7 , V_9 ) ;
return ( V_347 > V_345 ) ? ( V_347 - V_345 ) : 0 ;
}
static unsigned long F_296 ( struct V_7 * V_7 )
{
unsigned long V_348 ;
...
static int F_297 ( struct V_7 * V_7 , T_2 V_51 , unsigned int V_173 )
{
...
F_28 () ;
V_322 -> V_24 |= V_330 | V_58 ;
F_272 ( V_51 ) ;
V_253 . V_262 = 0 ;
V_322 -> V_253 = & V_253 ;
if ( F_296 ( V_7 ) > V_7 -> V_355 ) {
do {
F_202 ( V_7 , & V_2 , true ) ;
} while ( V_2 . V_121 < V_172 && -- V_2 . V_148 >= 0 );
}
V_322 -> V_253 = NULL ;
V_57 -> V_24 &= ~ ( V_330 | V_58 ) ;
F_277 () ;
return V_2 . V_121 >= V_172 ;
}
int F_298 ( struct V_7 * V_7 , T_2 V_51 , unsigned int V_173 )
{
int V_317 ;
int V_47 ;
if ( F_296 ( V_7 ) <= V_7 -> V_355 &&
F_6 ( V_7 , V_356 ) <= V_7 -> V_357 )
return V_358 ;
if ( ! F_8 ( V_7 ) )
return V_358 ;
if ( ! F_299 ( V_51 ) || ( V_57 -> V_24 & V_330 ) )
return V_359 ;
V_317 = F_205 ( V_7 ) ;
if ( F_300 ( V_317 , V_360 ) && V_317 != F_282 () )
return V_359 ;
if ( F_301 ( V_361 , & V_7 -> V_24 ) )
return V_359 ;
V_47 = F_297 ( V_7 , V_51 , V_173 ) ;
F_253 ( V_361 , & V_7 -> V_24 ) ;
if ( ! V_47 )
F_96 ( V_362 ) ;
return V_47 ;
}
...
{
return ! F_302 ( F_49 ( V_55 ) ) && ! F_303 ( V_55 ) ;
}
void F_304 ( struct V_55 * * V_363 , int V_172 )
{
struct V_16 * V_16 ;
struct V_7 * V_7 = NULL ;
int V_364 = 0 ;
...
continue;
if ( F_90 ( V_55 ) ) {
enum V_17 V_18 = F_305 ( V_55 ) ;
F_87 ( F_108 ( V_55 ) , V_55 ) ;
F_89 ( V_55 ) ;
F_153 ( V_55 , V_16 , V_367 ) ;
F_158 ( V_55 , V_16 , V_18 ) ;
V_365 ++ ;
}
}
