...
F_31 ( & V_20 -> V_93 ) ;
V_92:
V_20 -> V_21 . V_42 . V_95 ( & V_20 -> V_21 . V_42 , & V_20 -> V_88 ) ;
V_90:
V_20 -> V_21 . V_42 . V_95 ( & V_20 -> V_21 . V_42 , & V_20 -> V_83 ) ;
V_87:
F_32 ( & V_20 -> V_81 ) ;
V_82:
F_33 ( & V_20 -> V_21 ) ;
...
V_20 = F_41 ( sizeof( struct V_25 ) , V_106 ) ;
if ( V_20 == NULL ) {
F_42 ( V_2 -> V_2 ,
L_24 ) ;
return - V_107 ;
...
V_2 -> F_19 = F_19 ;
V_2 -> F_20 = F_20 ;
V_102 = F_43 ( V_2 , V_2 -> V_104 . V_108 ) ;
V_103 = F_43 ( V_2 , V_2 -> V_104 . V_109 ) ;
F_15 ( & V_2 -> V_45 ) ;
F_8 ( V_2 , V_31 ) ;
F_44 ( V_2 ) ;
switch ( V_2 -> V_110 ) {
...
V_20 -> V_43 -> V_116 = V_117 ;
if ( ! F_45 ( V_118 , V_2 -> V_20 -> V_43 ,
V_102 ,
& V_119 ) ) {
V_67 = - V_44 ;
goto V_115;
...
V_20 -> V_43 -> V_116 = V_117 ;
F_45 ( V_126 , V_2 -> V_20 -> V_43 ,
0x60 , V_102 ,
& V_135 ) ;
break;
case V_136 :
V_2 -> V_20 -> V_43 = F_45 ( V_137 ,
& V_138 ,
V_103
) ;
if ( V_2 -> V_20 -> V_43 == NULL ) {
...
V_67 = F_21 ( V_20 , V_159 , V_2 , V_2 -> V_2 ) ;
if ( V_67 < 0 )
goto V_115;
F_42 ( V_2 -> V_2 , L_36 ) ;
V_41:
