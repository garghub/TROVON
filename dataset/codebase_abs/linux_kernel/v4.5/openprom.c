...
static int F_36 ( void T_1 * V_16 , T_2 * V_29 )
{
struct V_64 V_19 ;
struct V_17 * V_18 ;
struct V_21 * V_22 ;
...
static int F_37 ( void T_1 * V_16 , T_2 * V_29 )
{
struct V_64 V_19 ;
struct V_17 * V_18 ;
char * V_65 , * V_62 ;
...
static int F_38 ( unsigned int V_28 , void T_1 * V_16 )
{
struct V_17 * V_18 ;
T_3 V_73 ;
F_16 ( sizeof( T_3 ) != sizeof( int ) ) ;
...
static int F_39 ( struct V_41 * V_41 ,
unsigned int V_28 , unsigned long V_42 )
{
T_2 * V_29 = V_41 -> V_43 ;
void T_1 * V_16 = ( void T_1 * ) V_42 ;
...
static long F_40 ( struct V_41 * V_41 ,
unsigned int V_28 , unsigned long V_42 )
{
T_2 * V_29 = V_41 -> V_43 ;
switch ( V_28 ) {
...
static long F_41 ( struct V_41 * V_41 , unsigned int V_28 ,
unsigned long V_42 )
{
long V_85 = - V_86 ;
switch ( V_28 ) {
...
case V_52 :
case V_53 :
V_85 = F_40 ( V_41 , V_28 , V_42 ) ;
break;
}
return V_85 ;
}
static int F_42 ( struct V_87 * V_87 , struct V_41 * V_41 )
{
T_2 * V_29 ;
V_29 = F_43 ( sizeof( T_2 ) , V_9 ) ;
if ( ! V_29 )
return - V_10 ;
F_27 ( & V_46 ) ;
V_29 -> V_36 = F_18 ( L_1 ) ;
...
static int F_44 ( struct V_87 * V_87 , struct V_41 * V_41 )
{
F_5 ( V_41 -> V_43 ) ;
return 0 ;
}
