...
int V_84 = V_59 -> V_84 . V_85 . V_86 [ 0 ] ;
if ( V_70 < 0 )
return V_70 ;
if ( V_84 >= V_18 -> V_87 )
return - V_42 ;
...
if ( V_70 < 0 )
return V_70 ;
V_59 -> V_84 . V_85 . V_86 [ 0 ] = V_4 -> V_75 [ V_70 ] ;
return 0 ;
}
...
if ( V_88 < 0 )
return V_88 ;
V_59 -> V_84 . V_85 . V_86 [ 0 ] = V_4 -> V_93 [ V_88 ] ;
return 0 ;
}
...
sizeof( char * ) * V_18 -> V_87 , V_380 ) ;
if ( ! V_4 -> V_394 )
return;
for ( V_7 = 0 ; V_7 < V_18 -> V_87 ; V_7 ++ )
V_4 -> V_394 [ V_7 ] = V_18 -> V_81 [ V_7 ] . V_55 ;
V_4 -> V_393 . V_381 = V_18 -> V_87 ;
