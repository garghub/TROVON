...
V_50 = F_88 ( & V_49 -> V_80 ) ;
V_27 = V_49 -> V_27 ;
if ( V_49 -> V_77 == V_82 && V_49 -> V_4 & V_33 )
V_27 += F_74 ( V_49 ) ;
} while ( F_89 ( & V_49 -> V_80 , V_50 ) );
return V_27 ;
}
static void
F_90 ( struct V_2 * V_49 ,
T_3 * V_83 , T_3 * V_84 ,
T_3 * V_85 , T_3 * V_86 ,
T_3 * V_87 , T_3 * V_88 )
{
