...
{
struct V_74 * V_56 = F_50 ( V_73 ) ;
struct V_1 * V_2 = F_83 ( V_73 -> V_127 ) ;
struct V_55 * V_75 = F_51 ( V_73 , 0 ) ;
switch ( V_2 -> V_86 ) {
case V_87 :
case V_88 :
...
return F_134 ( - V_255 ) ;
V_222 = & V_2 -> V_222 ;
V_2 -> V_133 = F_135 ( & V_3 -> V_117 -> V_118 ) ;
if ( F_91 ( V_2 -> V_133 ) ) {
V_8 = F_92 ( V_2 -> V_133 ) ;
goto V_256;
}
...
V_232 , 0 , 0xff , 1 ,
V_260 >> 8 ) ;
F_140 ( V_222 , & V_261 , NULL ) ;
V_2 -> V_239 =
F_140 ( V_222 , & V_262 , NULL ) ;
if ( V_222 -> error ) {
V_8 = V_222 -> error ;
goto V_256;
}
...
F_147 ( V_2 -> V_99 , V_2 ) ;
V_8 = F_148 ( V_2 -> V_99 , V_284 , V_252 ) ;
if ( V_8 < 0 )
goto V_285;
...
int F_156 ( struct V_3 * V_3 , unsigned V_252 )
{
int V_61 ;
F_157 ( & V_3 -> V_109 ) ;
V_3 -> V_287 = sizeof( T_5 ) ;
V_3 -> V_120 = F_145 ( V_3 -> V_117 ,
V_3 -> V_287 ,
& V_3 -> V_119 ) ;
if ( V_3 -> V_120 == NULL )
return - V_255 ;
...
while ( V_61 -- )
F_154 ( V_3 -> V_116 [ V_61 ] ) ;
F_150 ( V_3 -> V_117 , V_3 -> V_287 ,
V_3 -> V_120 , V_3 -> V_119 ) ;
V_3 -> V_120 = NULL ;
return V_8 ;
}
