...
static long F_32 ( struct V_2 * V_2 , unsigned int V_47 ,
unsigned long V_48 )
{
return F_27 ( V_2 -> V_14 , V_47 ,
( unsigned long ) F_33 ( V_48 ) ) ;
}
static long F_34 ( long V_66 , long V_67 , long V_68 , long V_69 , long V_70 )
{
...
static long F_35 ( long V_66 , long V_73 , long V_74 , int * V_75 )
{
if ( V_66 == F_34 ( * V_75 , 0 , 100 , V_73 , V_74 ) )
return * V_75 ;
return F_34 ( V_66 , V_73 , V_74 , 0 , 100 ) ;
}
static long F_36 ( long V_66 , long V_73 , long V_74 )
{
return F_34 ( V_66 , 0 , 100 , V_73 , V_74 ) ;
}
static struct V_76 * F_37 ( struct V_18 * V_13 , const char * V_22 , int V_38 )
{
...
goto V_88;
* V_43 = F_35 ( V_84 -> V_91 . integer . V_91 [ 0 ] , V_82 -> V_91 . integer . V_73 , V_82 -> V_91 . integer . V_74 , & V_32 -> V_45 [ 0 ] ) ;
if ( V_82 -> V_92 > 1 )
* V_44 = F_35 ( V_84 -> V_91 . integer . V_91 [ 1 ] , V_82 -> V_91 . integer . V_73 , V_82 -> V_91 . integer . V_74 , & V_32 -> V_45 [ 1 ] ) ;
V_88:
F_42 ( & V_4 -> V_87 ) ;
F_10 ( V_84 ) ;
F_10 ( V_82 ) ;
...
* V_43 = * V_44 = 100 ;
if ( V_42 -> V_94 & V_95 ) {
F_39 ( V_6 , V_32 , V_42 -> V_80 [ V_96 ] , V_43 , V_44 ) ;
} else if ( V_42 -> V_94 & V_97 ) {
F_39 ( V_6 , V_32 , V_42 -> V_80 [ V_98 ] , V_43 , V_44 ) ;
} else if ( V_42 -> V_94 & V_99 ) {
F_39 ( V_6 , V_32 , V_42 -> V_80 [ V_100 ] , V_43 , V_44 ) ;
}
if ( V_42 -> V_94 & V_101 ) {
F_43 ( V_6 , V_32 , V_42 -> V_80 [ V_102 ] , V_43 , V_44 , 0 ) ;
} else if ( V_42 -> V_94 & V_103 ) {
F_43 ( V_6 , V_32 , V_42 -> V_80 [ V_104 ] , V_43 , V_44 , 0 ) ;
} else if ( V_42 -> V_94 & V_105 ) {
F_43 ( V_6 , V_32 , V_42 -> V_80 [ V_106 ] , V_43 , V_44 , 1 ) ;
} else if ( V_42 -> V_94 & V_107 ) {
F_43 ( V_6 , V_32 , V_42 -> V_80 [ V_108 ] , V_43 , V_44 , 1 ) ;
}
return 0 ;
}
...
V_82 -> V_91 . integer . V_73 == 0 && V_82 -> V_91 . integer . V_74 == 1 )
goto V_88;
V_84 -> V_91 . integer . V_91 [ 0 ] = F_36 ( V_43 , V_82 -> V_91 . integer . V_73 , V_82 -> V_91 . integer . V_74 ) ;
if ( V_82 -> V_92 > 1 )
V_84 -> V_91 . integer . V_91 [ 1 ] = F_36 ( V_44 , V_82 -> V_91 . integer . V_73 , V_82 -> V_91 . integer . V_74 ) ;
if ( ( V_109 = V_85 -> V_110 ( V_85 , V_84 ) ) < 0 )
goto V_88;
if ( V_109 > 0 )
F_46 ( V_4 , V_111 , & V_85 -> V_20 ) ;
V_88:
F_42 ( & V_4 -> V_87 ) ;
F_10 ( V_84 ) ;
F_10 ( V_82 ) ;
...
struct V_42 * V_42 = V_32 -> V_14 ;
if ( V_42 -> V_94 & V_95 ) {
F_45 ( V_6 , V_32 , V_42 -> V_80 [ V_96 ] , V_43 , V_44 ) ;
if ( V_42 -> V_94 & V_112 )
F_45 ( V_6 , V_32 , V_42 -> V_80 [ V_113 ] , V_43 , V_44 ) ;
} else if ( V_42 -> V_94 & V_112 ) {
F_45 ( V_6 , V_32 ,
V_42 -> V_80 [ V_113 ] , V_43 , V_44 ) ;
} else if ( V_42 -> V_94 & V_97 ) {
F_45 ( V_6 , V_32 , V_42 -> V_80 [ V_98 ] , V_43 , V_44 ) ;
} else if ( V_42 -> V_94 & V_99 ) {
F_45 ( V_6 , V_32 , V_42 -> V_80 [ V_100 ] , V_43 , V_44 ) ;
}
if ( V_43 || V_44 ) {
if ( V_42 -> V_94 & V_101 )
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_102 ] , V_43 , V_44 , 0 ) ;
if ( V_42 -> V_94 & V_114 )
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_115 ] , V_43 , V_44 , 0 ) ;
if ( V_42 -> V_94 & V_103 )
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_104 ] , V_43 , V_44 , 0 ) ;
if ( V_42 -> V_94 & V_105 )
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_106 ] , V_43 , V_44 , 1 ) ;
if ( V_42 -> V_94 & V_116 )
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_117 ] , V_43 , V_44 , 1 ) ;
if ( V_42 -> V_94 & V_107 )
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_108 ] , V_43 , V_44 , 1 ) ;
} else {
if ( V_42 -> V_94 & V_101 ) {
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_102 ] , V_43 , V_44 , 0 ) ;
...
int V_43 , V_44 ;
V_43 = V_44 = 1 ;
F_43 ( V_6 , V_32 , V_42 -> V_80 [ V_115 ] , & V_43 , & V_44 , 0 ) ;
* V_39 = ( V_43 || V_44 ) ? 1 : 0 ;
return 0 ;
}
...
int V_43 , V_44 ;
V_43 = V_44 = 1 ;
F_43 ( V_6 , V_32 , V_42 -> V_80 [ V_117 ] , & V_43 , & V_44 , 1 ) ;
* V_39 = ( V_43 || V_44 ) ? 1 : 0 ;
return 0 ;
}
...
{
struct V_42 * V_42 = V_32 -> V_14 ;
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_115 ] , V_39 , V_39 , 0 ) ;
return 0 ;
}
...
{
struct V_42 * V_42 = V_32 -> V_14 ;
F_47 ( V_6 , V_32 , V_42 -> V_80 [ V_117 ] , V_39 , V_39 , 1 ) ;
return 0 ;
}
static int F_53 ( struct V_5 * V_6 , unsigned int * V_118 )
{
struct V_3 * V_4 = V_6 -> V_4 ;
struct V_18 * V_13 = V_6 -> V_13 ;
struct V_76 * V_85 ;
...
static int F_54 ( struct V_5 * V_6 , unsigned int V_118 )
{
struct V_3 * V_4 = V_6 -> V_4 ;
struct V_18 * V_13 = V_6 -> V_13 ;
struct V_76 * V_85 ;
...
static int F_55 ( struct V_18 * V_13 , struct V_42 * V_42 , const char * V_22 , int V_38 , int V_128 )
{
struct V_81 * V_19 ;
struct V_76 * V_129 ;
struct V_3 * V_4 = V_13 -> V_4 ;
int V_7 ;
F_40 ( & V_4 -> V_87 ) ;
V_129 = F_37 ( V_13 , V_22 , V_38 ) ;
if ( V_129 == NULL ) {
F_42 ( & V_4 -> V_87 ) ;
return 0 ;
}
V_19 = F_56 ( sizeof( * V_19 ) , V_11 ) ;
if ( ! V_19 ) {
F_42 ( & V_4 -> V_87 ) ;
return - V_12 ;
}
...
static void F_57 ( struct V_31 * V_33 )
{
...
static void F_58 ( struct V_31 * V_133 )
{
...
static int F_59 ( struct V_18 * V_13 ,
struct V_136 * V_137 ,
struct V_42 * V_42 )
{
char V_138 [ 64 ] ;
int V_7 ;
V_7 = F_55 ( V_13 , V_42 , V_137 -> V_22 , V_137 -> V_38 ,
V_100 ) ;
if ( V_7 )
return V_7 ;
sprintf ( V_138 , L_2 , V_137 -> V_22 ) ;
V_7 = F_55 ( V_13 , V_42 , V_138 , V_137 -> V_38 ,
V_104 ) ;
if ( V_7 )
return V_7 ;
...
static int F_60 ( struct V_18 * V_13 , struct V_136 * V_137 , int V_139 , int V_140 )
{
struct V_42 V_42 ;
struct V_42 * V_32 ;
struct V_76 * V_85 ;
...
if ( F_59 ( V_13 , V_137 , & V_42 ) )
return 0 ;
F_40 ( & V_13 -> V_4 -> V_87 ) ;
if ( V_137 -> V_38 == 0 && ( V_85 = F_37 ( V_13 , L_1 , 0 ) ) != NULL ) {
struct V_81 * V_82 ;
V_82 = F_7 ( sizeof( * V_82 ) , V_11 ) ;
if ( ! V_82 ) {
F_42 ( & V_13 -> V_4 -> V_87 ) ;
...
struct V_136 * V_154 ;
struct V_42 * V_42 ;
while ( ! F_66 ( V_146 , line , sizeof( line ) ) ) {
V_152 = F_67 ( V_138 , line , sizeof( V_138 ) ) ;
...
V_152 = F_67 ( V_138 , V_152 , sizeof( V_138 ) ) ;
if ( ! * V_138 ) {
F_62 ( & V_13 -> V_148 ) ;
F_58 ( & V_13 -> V_34 [ V_153 ] ) ;
F_64 ( & V_13 -> V_148 ) ;
continue;
}
F_67 ( V_151 , V_152 , sizeof( V_151 ) ) ;
V_119 = F_69 ( V_151 , NULL , 10 ) ;
if ( V_119 >= 0x4000 ) {
F_68 ( L_19 , V_119 ) ;
continue;
}
...
goto V_122;
V_154 = F_56 ( sizeof( * V_154 ) , V_11 ) ;
if ( ! V_154 )
goto V_122;
V_154 -> V_141 = V_153 ;
V_154 -> V_22 = F_70 ( V_138 , V_11 ) ;
if ( ! V_154 -> V_22 ) {
F_10 ( V_154 ) ;
goto V_122;
}
V_154 -> V_38 = V_119 ;
if ( F_60 ( V_13 , V_154 , 1 , 1 ) <= 0 ) {
F_10 ( V_154 -> V_22 ) ;
F_10 ( V_154 ) ;
}
V_122:
...
static void F_71 ( struct V_18 * V_13 )
{
struct V_143 * V_144 ;
V_144 = F_72 ( V_13 -> V_4 , L_20 ,
V_13 -> V_4 -> V_155 ) ;
if ( ! V_144 )
return;
V_144 -> V_156 = V_157 ;
V_144 -> V_158 = V_159 | V_160 | V_161 ;
V_144 -> V_162 . V_163 . V_164 = F_61 ;
V_144 -> V_162 . V_163 . V_165 = F_65 ;
V_144 -> V_14 = V_13 ;
if ( F_73 ( V_144 ) < 0 ) {
F_74 ( V_144 ) ;
V_144 = NULL ;
...
static void F_75 ( struct V_18 * V_13 )
{
F_74 ( V_13 -> V_166 ) ;
V_13 -> V_166 = NULL ;
}
static void F_76 ( struct V_18 * V_13 )
{
...
unsigned int V_119 ;
for ( V_119 = 0 ; V_119 < F_77 ( V_167 ) ; V_119 ++ )
F_60 ( V_13 , & V_167 [ V_119 ] , 0 , 0 ) ;
if ( V_13 -> V_37 ) {
V_13 -> V_28 = F_53 ;
V_13 -> V_29 = F_54 ;
}
...
static int F_79 ( struct V_3 * V_4 , int V_47 )
{
struct V_18 * V_13 ;
if ( V_47 == V_194 ) {
int V_119 , V_7 ;
V_13 = F_80 ( 2 , sizeof( * V_13 ) , V_11 ) ;
if ( V_13 == NULL )
return - V_12 ;
F_81 ( & V_13 -> V_148 ) ;
if ( ( V_7 = F_82 ( V_8 ,
