...
static int F_58 ( struct V_72 * V_80 , struct V_91 * V_92 )
{
const struct V_12 * V_16 = V_92 -> V_93 ;
int V_67 ;
F_1 () ;
...
static int F_60 ( struct V_7 * V_14 ,
struct V_72 * V_80 ,
struct V_83 * V_84 )
{
const struct V_12 * V_16 ;
struct V_49 * V_49 = F_61 ( V_80 -> V_95 ) ;
struct V_74 V_75 ;
struct V_85 * V_86 = F_56 ( V_84 ) ;
struct V_63 * * V_62 ;
int V_96 , V_36 ;
if ( ! V_14 -> V_48 && ! F_62 ( V_49 , & V_46 ) )
return - V_71 ;
V_96 = V_87 + V_14 -> V_88 ;
if ( V_84 -> V_97 < F_63 ( V_96 ) )
return - V_41 ;
...
F_3 () ;
V_67 = F_65 ( V_49 -> V_47 , V_80 , V_84 , & V_105 ) ;
F_1 () ;
} else {
struct V_104 V_105 = {
. V_106 = V_14 -> V_106 ,
...
V_62 = V_14 -> V_62 ;
if ( V_62 ) {
V_36 = F_66 ( V_84 , V_96 , V_62 , V_14 -> V_60 ,
V_16 -> V_108 ) ;
if ( V_36 < 0 )
goto V_109;
}
V_75 . V_110 = V_84 -> V_111 ;
V_75 . V_79 = F_67 ( V_80 ) . V_81 ;
V_75 . V_112 = V_84 ;
...
static int F_69 ( struct V_72 * V_80 , struct V_83 * V_84 )
{
struct V_7 * V_14 ;
int V_36 ;
...
if ( ! V_14 -> V_61 )
F_1 () ;
V_36 = F_60 ( V_14 , V_80 , V_84 ) ;
if ( ! V_14 -> V_61 )
F_3 () ;
return V_36 ;
}
static void F_70 ( struct V_72 * V_80 )
{
F_71 ( & V_2 ) ;
F_72 ( V_80 , & F_69 ) ;
F_73 ( & V_2 ) ;
}
static int F_74 ( struct V_7 * V_14 , T_5 V_81 , T_5 V_82 ,
...
if ( V_86 == NULL )
return - 1 ;
if ( F_75 ( V_80 , V_120 , V_14 -> V_9 ) ||
F_76 ( V_80 , V_121 , V_14 -> V_3 ) ||
F_77 ( V_80 , V_122 , V_14 -> V_89 ) ||
F_77 ( V_80 , V_123 , V_14 -> V_88 ) ||
F_77 ( V_80 , V_124 , V_14 -> V_60 ) )
goto V_125;
if ( V_14 -> V_15 ) {
struct V_63 * V_126 ;
int V_10 ;
V_126 = F_78 ( V_80 , V_127 ) ;
if ( V_126 == NULL )
goto V_125;
for ( V_10 = 0 ; V_10 < V_14 -> V_15 ; V_10 ++ ) {
struct V_63 * V_128 ;
...
if ( V_16 -> V_108 )
V_129 |= V_132 ;
V_128 = F_78 ( V_80 , V_10 + 1 ) ;
if ( V_128 == NULL )
goto V_125;
if ( F_77 ( V_80 , V_133 , V_16 -> V_13 ) ||
F_77 ( V_80 , V_134 , V_129 ) )
goto V_125;
F_79 ( V_80 , V_128 ) ;
}
F_79 ( V_80 , V_126 ) ;
...
static int F_82 ( struct V_7 * V_14 ,
const struct V_38 * V_39 ,
...
static int F_83 ( struct V_72 * V_80 , struct V_91 * V_92 )
{
int V_10 , V_140 = 0 ;
struct V_7 * V_141 ;
struct V_49 * V_49 = F_61 ( V_80 -> V_95 ) ;
...
if ( ! V_141 -> V_48 && ! F_62 ( V_49 , & V_46 ) )
continue;
if ( ++ V_140 < V_143 )
continue;
if ( F_74 ( V_141 , F_67 ( V_92 -> V_80 ) . V_81 ,
...
static struct V_72 * F_84 ( struct V_7 * V_14 ,
T_5 V_81 , int V_82 , T_1 V_13 )
{
struct V_72 * V_80 ;
int V_36 ;
V_80 = F_85 ( V_145 , V_33 ) ;
if ( V_80 == NULL )
return F_86 ( - V_146 ) ;
V_36 = F_74 ( V_14 , V_81 , V_82 , 0 , V_80 , V_13 ) ;
if ( V_36 < 0 ) {
F_87 ( V_80 ) ;
return F_86 ( V_36 ) ;
}
...
static int F_89 ( struct V_72 * V_80 , struct V_74 * V_75 )
{
struct V_72 * V_147 ;
struct V_7 * V_148 = NULL ;
int V_36 = - V_41 ;
if ( V_75 -> V_115 [ V_121 ] ) {
T_2 V_3 = F_90 ( V_75 -> V_115 [ V_121 ] ) ;
V_148 = F_13 ( V_3 ) ;
V_36 = - V_71 ;
}
if ( V_75 -> V_115 [ V_120 ] ) {
char * V_9 ;
V_9 = F_91 ( V_75 -> V_115 [ V_120 ] ) ;
V_148 = F_15 ( V_9 ) ;
#ifdef F_92
if ( V_148 == NULL ) {
F_3 () ;
...
if ( V_148 == NULL )
return V_36 ;
if ( ! V_148 -> V_48 && ! F_62 ( F_94 ( V_75 ) , & V_46 ) ) {
return - V_71 ;
}
V_147 = F_84 ( V_148 , V_75 -> V_79 , V_75 -> V_110 ,
V_65 ) ;
if ( F_95 ( V_147 ) )
return F_96 ( V_147 ) ;
return F_97 ( V_147 , V_75 ) ;
}
...
case V_70 :
F_28 ( V_39 ) ;
V_147 = F_84 ( V_14 , 0 , 0 , V_151 ) ;
break;
case V_66 :
case V_51 :
F_29 ( ! V_39 ) ;
V_147 = F_88 ( V_14 , V_39 , V_50 , 0 , 0 , V_151 ) ;
break;
default:
return - V_41 ;
}
...
static int F_100 ( struct V_49 * V_49 , int V_153 )
{
int V_10 , V_36 = - V_71 ;
F_71 ( & V_2 ) ;
for ( V_10 = 0 ; V_10 < V_11 ; V_10 ++ ) {
...
static void F_101 ( struct V_49 * V_49 , int V_153 )
{
int V_10 ;
F_71 ( & V_2 ) ;
for ( V_10 = 0 ; V_10 < V_11 ; V_10 ++ ) {
...
static int T_6 F_102 ( struct V_49 * V_49 )
{
struct V_157 V_158 = {
. V_159 = F_70 ,
. V_76 = V_160 ,
...
V_49 -> V_47 = F_103 ( V_49 , V_150 , & V_158 ) ;
if ( ! V_49 -> V_47 && F_62 ( V_49 , & V_46 ) )
F_104 ( L_3 ) ;
if ( ! V_49 -> V_47 )
return - V_34 ;
return 0 ;
}
static void T_7 F_105 ( struct V_49 * V_49 )
{
F_106 ( V_49 -> V_47 ) ;
V_49 -> V_47 = NULL ;
}
...
static int F_111 ( struct V_72 * V_80 , T_5 V_81 , unsigned long V_153 ,
T_4 V_76 )
{
struct V_72 * V_167 ;
...
F_32 (net) {
if ( V_168 ) {
V_167 = F_112 ( V_80 , V_76 ) ;
if ( ! V_167 ) {
V_36 = - V_34 ;
goto error;
}
V_36 = F_113 ( V_168 -> V_47 , V_167 ,
V_81 , V_153 , V_76 ) ;
if ( V_36 )
goto error;
}
...
return F_113 ( V_168 -> V_47 , V_80 , V_81 , V_153 , V_76 ) ;
error:
F_114 ( V_80 ) ;
return V_36 ;
}
int F_99 ( struct V_7 * V_14 , struct V_72 * V_80 ,
T_5 V_81 , unsigned int V_153 , T_4 V_76 )
{
if ( F_115 ( V_153 >= V_14 -> V_35 ) )
return - V_41 ;
V_153 = V_14 -> V_45 + V_153 ;
return F_111 ( V_80 , V_81 , V_153 , V_76 ) ;
}
void F_116 ( struct V_7 * V_14 , struct V_72 * V_80 ,
struct V_74 * V_75 , T_5 V_153 , T_4 V_76 )
{
struct V_49 * V_49 = F_94 ( V_75 ) ;
struct V_169 * V_95 = V_49 -> V_47 ;
int V_170 = 0 ;
if ( V_75 -> V_112 )
V_170 = F_117 ( V_75 -> V_112 ) ;
if ( F_115 ( V_153 >= V_14 -> V_35 ) )
return;
V_153 = V_14 -> V_45 + V_153 ;
F_118 ( V_95 , V_80 , V_75 -> V_79 , V_153 , V_170 , V_76 ) ;
}
