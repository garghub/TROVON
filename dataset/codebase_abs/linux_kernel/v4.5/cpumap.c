...
if ( ! V_61 )
return 0 ;
V_14 = snprintf ( V_43 , V_44 , L_21 , V_61 ) ;
if ( V_14 == V_44 ) {
F_38 ( L_16 , V_44 ) ;
return - 1 ;
}
...
if ( ! V_69 )
return 0 ;
while ( ( V_67 = F_43 ( V_69 ) ) != NULL ) {
if ( V_67 -> V_72 != V_73 || sscanf ( V_67 -> V_74 , L_22 , & V_71 ) < 1 )
continue;
V_14 = snprintf ( V_59 , V_44 , L_23 , V_43 , V_67 -> V_74 ) ;
if ( V_14 == V_44 ) {
F_38 ( L_16 , V_44 ) ;
continue;
}
...
if ( ! V_70 )
continue;
while ( ( V_68 = F_43 ( V_70 ) ) != NULL ) {
if ( V_68 -> V_72 != V_75 || sscanf ( V_68 -> V_74 , L_24 , & V_15 ) < 1 )
continue;
V_64 [ V_15 ] = V_71 ;
}
F_44 ( V_70 ) ;
