...
static int T_1 F_321 ( struct V_308 * V_309 )
{
struct V_587 V_571 ;
int V_586 ;
unsigned long V_13 ;
...
static int F_329 ( struct V_90 * V_91 )
{
int V_56 ;
V_56 = V_516 ( NULL ) ;
if ( V_56 < 0 ) {
...
return V_56 ;
while ( ( V_159 = F_46 ( & V_126 ) ) ) {
if ( F_86 ( V_159 , L_342 ) == 0 ) {
if ( V_56 < V_272 )
V_56 ++ ;
} else if ( F_86 ( V_159 , L_343 ) == 0 ) {
if ( V_56 > 0 )
V_56 -- ;
} else if ( sscanf ( V_159 , L_344 , & V_56 ) == 1 &&
V_56 >= 0 && V_56 <= V_272 ) {
} else
return - V_94 ;
}
...
static int F_332 ( T_6 * V_30 )
{
T_6 V_118 ;
if ( ! F_11 ( V_612 , & V_118 ) )
return - V_50 ;
* V_30 = V_118 ;
F_20 ( V_607 , L_350 , V_118 ) ;
return 0 ;
}
...
static int F_334 ( const T_6 V_30 )
{
if ( ! F_13 ( V_612 , V_30 ) )
return - V_50 ;
F_20 ( V_607 , L_351 , V_30 ) ;
F_335 ( 1 ) ;
return 0 ;
}
static int F_336 ( const T_6 V_30 )
{
return F_334 ( V_30 ) ;
}
static int F_337 ( const bool V_249 )
{
int V_73 ;
T_6 V_118 , V_217 ;
if ( F_157 ( & V_611 ) < 0 )
...
static int F_340 ( const T_6 V_613 )
{
int V_73 ;
T_6 V_118 , V_217 ;
if ( V_613 > V_614 )
...
{
int V_618 ;
if ( ! F_7 ( V_462 , & V_618 , L_356 , L_249 , V_616 )
|| V_618 != V_616 )
F_62 ( L_359 ) ;
}
static int F_343 ( const T_6 V_613 )
{
F_20 ( V_607 ,
L_360 , V_613 ) ;
return F_340 ( V_613 ) ;
...
static int F_346 ( struct V_625 * V_626 ,
struct V_627 * V_628 )
{
V_628 -> type = V_629 ;
V_628 -> V_35 = 1 ;
...
return F_343 ( V_632 -> V_38 . integer . V_38 [ 0 ] ) ;
}
...
V_632 -> V_38 . integer . V_38 [ 0 ] ?
L_42 : L_1 ) ;
return F_338 ( ! V_632 -> V_38 . integer . V_38 [ 0 ] ) ;
}
...
V_66 = V_634 -> V_621 ;
V_66 -> V_634 = V_634 ;
F_358 ( V_634 -> V_81 , V_640 ,
sizeof( V_634 -> V_81 ) ) ;
F_358 ( V_634 -> V_641 , V_642 ,
sizeof( V_634 -> V_641 ) ) ;
snprintf ( V_634 -> V_643 , sizeof( V_634 -> V_643 ) , L_366 ,
( V_7 . V_644 ) ?
V_7 . V_644 : L_367 ) ;
snprintf ( V_634 -> V_645 , sizeof( V_634 -> V_645 ) ,
L_368 , V_634 -> V_641 , V_612 ,
( V_7 . V_644 ) ?
V_7 . V_644 : L_369 ) ;
if ( V_605 ) {
V_646 . V_647 = F_348 ;
...
if ( ! V_186 . V_608 ) {
V_635 = F_359 ( & V_646 , NULL ) ;
V_73 = F_360 ( V_634 , V_635 ) ;
if ( V_73 < 0 ) {
F_8 ( L_370 ,
V_73 ) ;
goto V_351;
...
V_636 = F_359 ( & V_650 , NULL ) ;
V_73 = F_360 ( V_634 , V_636 ) ;
if ( V_73 < 0 ) {
F_8 ( L_371 , V_73 ) ;
goto V_351;
}
...
static int T_1 F_362 ( struct V_308 * V_309 )
{
unsigned long V_13 ;
int V_73 ;
F_17 ( V_55 , L_373 ) ;
...
static int F_363 ( struct V_90 * V_91 )
{
T_6 V_30 ;
if ( F_333 ( & V_30 ) < 0 ) {
F_84 ( V_91 , L_338 ) ;
...
V_668 -- ;
continue;
} else if ( sscanf ( V_159 , L_396 , & V_670 ) == 1 &&
V_670 >= 0 && V_670 <= V_614 ) {
V_668 = V_670 ;
continue;
}
}
if ( F_86 ( V_159 , L_397 ) == 0 )
V_669 = V_609 ;
else if ( F_86 ( V_159 , L_398 ) == 0 )
V_669 = 0 ;
else
return - V_94 ;
}
...
V_73 = F_336 ( V_669 | V_668 ) ;
}
F_344 () ;
return ( V_73 == - V_601 ) ? - V_294 : V_73 ;
}
static void inline F_344 ( void )
{
}
static int T_1 F_362 ( struct V_308 * V_309 )
{
...
static int F_372 ( unsigned int * V_687 )
{
T_6 V_688 , V_689 ;
switch ( V_681 ) {
case V_684 :
...
static void F_383 ( struct V_465 * V_703 )
{
int V_73 ;
if ( V_69 != V_70 )
return;
...
static T_8 F_384 ( struct V_74 * V_60 ,
struct V_156 * V_122 ,
char * V_126 )
{
int V_17 , V_365 ;
...
if ( V_30 > 7 )
V_30 = 7 ;
return snprintf ( V_126 , V_102 , L_412 , ( V_30 * 255 ) / 7 ) ;
}
...
if ( V_17 < 0 )
return V_17 ;
return snprintf ( V_126 , V_102 , L_412 , V_687 ) ;
}
...
static T_8 F_390 ( struct V_161 * V_162 ,
char * V_126 )
{
return snprintf ( V_126 , V_102 , L_412 , V_701 ) ;
}
...
V_701 = V_157 ;
F_379 () ;
F_82 ( L_415 , L_96 , V_157 ) ;
return V_35 ;
}
static int T_1 F_392 ( struct V_308 * V_309 )
{
int V_73 ;
unsigned long V_13 ;
F_17 ( V_55 | V_697 ,
...
static int F_396 ( struct V_90 * V_91 )
{
int V_73 ;
T_6 V_30 ;
...
if ( V_73 < 0 )
return V_73 ;
F_84 ( V_91 , L_426 , V_687 ) ;
if ( V_30 & V_679 )
F_84 ( V_91 , L_427 ) ;
else if ( V_30 & V_675 )
F_84 ( V_91 , L_428 ) ;
else
F_84 ( V_91 , L_339 , V_30 ) ;
break;
case V_705 :
default:
F_84 ( V_91 , L_46 ) ;
...
static int F_397 ( const char * V_159 , int * V_73 )
{
int V_56 ;
if ( F_86 ( V_159 , L_436 ) == 0 )
V_56 = V_675 ;
else if ( ( F_86 ( V_159 , L_437 ) == 0 ) |
( F_86 ( V_159 , L_438 ) == 0 ) )
V_56 = V_679 ;
else if ( sscanf ( V_159 , L_344 , & V_56 ) != 1 )
return 0 ;
...
static int F_403 ( struct V_725 * V_157 , bool V_205 )
{
T_3 V_541 ;
int V_726 ;
if ( ! F_19 ( F_18 ( V_129 , V_157 -> V_51 , & V_541 ) ) ) {
F_62 ( L_450 , V_157 -> V_51 ) ;
return - V_50 ;
}
...
int F_404 ( int V_729 , bool V_730 )
{
struct V_725 * V_157 ;
...
return V_157 -> V_205 ;
return F_403 ( V_157 , V_730 ) ;
}
static int F_405 ( struct V_308 * V_309 )
{
T_3 V_541 ;
int V_42 ;
...
struct V_725 * V_157 = & V_732 [ V_42 ] ;
if ( V_157 -> V_205 >= 0 )
F_403 ( V_157 , V_157 -> V_205 ) ;
}
}
static void F_408 ( const unsigned int V_733 )
{
if ( V_575 ) {
switch ( V_733 ) {
case V_734 :
...
static T_8 F_409 ( struct V_74 * V_60 ,
struct V_156 * V_122 ,
char * V_126 )
{
return snprintf ( V_126 , V_102 , L_451 , V_85 ) ;
}
static const char * T_1 F_1 ( int V_1 )
{
static char V_740 [] V_741 = L_452 ;
return ( V_1 ) ? & V_740 [ 4 ] : & V_740 [ 0 ] ;
}
static void F_410 ( struct V_67 * V_68 )
{
F_20 ( V_305 , L_453 , V_68 -> V_51 ) ;
F_411 ( & V_68 -> V_742 ) ;
if ( V_68 -> V_79 . V_80 ) {
F_20 ( V_305 ,
L_454 , V_68 -> V_51 ) ;
F_25 ( ! V_68 -> V_71 ) ;
F_412 ( * V_68 -> V_71 -> V_16 ,
V_68 -> V_71 -> type ,
F_27 ) ;
V_68 -> V_79 . V_80 = 0 ;
}
...
F_20 ( V_55 , L_457 , V_68 -> V_51 ) ;
}
static int T_1 F_415 ( struct V_308 * V_309 )
{
int V_100 ;
...
if ( V_68 -> V_101 )
V_365 |= V_753 ;
V_747 = F_417 ( V_68 -> V_51 , V_365 , V_744 ,
& V_754 , V_68 ) ;
if ( ! V_747 ) {
F_8 ( L_461 , V_68 -> V_51 ) ;
V_100 = - V_75 ;
...
static bool T_2 T_1 F_419 ( const char V_37 )
{
return ( V_37 >= '0' && V_37 <= '9' ) || ( V_37 >= 'A' && V_37 <= 'Z' ) ;
}
static bool T_2 T_1 F_420 ( const char * const V_118 ,
const char V_157 )
{
...
return 0 ;
V_118 = F_423 ( V_760 ) ;
V_757 -> V_761 = F_424 ( V_118 , V_83 ) ;
if ( V_118 && ! V_757 -> V_761 )
return - V_84 ;
if ( ! ( F_420 ( V_757 -> V_761 , 'E' ) ||
F_420 ( V_757 -> V_761 , 'C' ) ) )
return 0 ;
...
| V_757 -> V_761 [ 5 ] ;
while ( ( V_60 = F_425 ( V_762 , NULL , V_60 ) ) ) {
if ( sscanf ( V_60 -> V_51 ,
L_465 ,
V_759 ) == 1 ) {
V_759 [ sizeof( V_759 ) - 1 ] = 0 ;
V_759 [ strcspn ( V_759 , L_466 ) ] = 0 ;
V_757 -> V_644 = F_424 ( V_759 , V_83 ) ;
if ( ! V_757 -> V_644 )
return - V_84 ;
if ( F_420 ( V_759 , 'H' ) ) {
V_757 -> V_12 = V_759 [ 0 ]
...
V_118 = F_423 ( V_763 ) ;
if ( V_118 && ! ( strncasecmp ( V_118 , L_469 , 8 ) && strncasecmp ( V_118 , L_470 , 6 ) ) ) {
V_757 -> V_764 = F_424 ( V_118 , V_83 ) ;
if ( ! V_757 -> V_764 )
return - V_84 ;
} else {
V_118 = F_423 ( V_765 ) ;
if ( V_118 && ! ( strncasecmp ( V_118 , L_470 , 6 ) ) ) {
V_757 -> V_764 = F_424 ( V_118 , V_83 ) ;
if ( ! V_757 -> V_764 )
return - V_84 ;
}
...
static int T_1 F_428 ( const char * V_677 , struct V_773 * V_774 )
{
unsigned int V_42 ;
struct V_67 * V_68 ;
...
V_744 = F_440 ( V_787 , V_788 ) ;
if ( ! V_744 ) {
F_8 ( L_478 V_787 L_295 ) ;
F_430 () ;
return - V_75 ;
}
V_100 = F_441 ( & V_784 ) ;
