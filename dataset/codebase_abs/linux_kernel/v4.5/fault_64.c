...
static inline void
F_34 ( struct V_1 * V_2 , int V_30 , int V_31 ,
...
return;
F_9 ( L_12 ,
F_37 ( V_6 ) > 1 ? V_32 : V_33 ,
V_6 -> V_34 , F_37 ( V_6 ) , V_4 ,
( void * ) V_2 -> V_15 , ( void * ) V_2 -> V_16 [ V_35 ] ,
( void * ) V_2 -> V_16 [ V_36 ] , V_31 ) ;
F_38 ( V_37 L_13 , V_2 -> V_15 ) ;
F_9 ( V_37 L_14 ) ;
}
static void F_39 ( int V_31 , int V_30 , struct V_1 * V_2 ,
...
static void T_1 F_43 ( struct V_1 * V_2 , int V_42 ,
...
F_39 ( V_42 , V_60 , V_2 , V_4 , V_24 , V_39 ) ;
return;
}
V_54:
F_8 ( V_4 , V_17 , V_2 ) ;
...
V_24 = F_42 ( V_2 , V_24 ) ;
F_66 ( & V_9 -> V_86 ) ;
F_39 ( V_127 , V_128 , V_2 , V_4 , V_24 , V_39 ) ;
if ( V_2 -> V_50 & V_51 )
goto V_87;
}
