...
{
struct V_1 * V_194 ;
T_2 V_195 = F_2 ( V_4 + V_196 ) ;
V_194 = F_37 ( sizeof( const struct V_1 ) , V_197 ) ;
if ( ! V_194 )
return NULL ;
V_194 -> V_5 = V_4 ;
V_194 -> V_198 = V_192 ;
...
V_194 -> V_32 = 0 ;
if ( V_194 -> V_198 )
V_194 -> V_32 = F_38 ( V_194 -> V_198 ) ;
V_194 -> V_194 = & V_199 ;
V_194 -> V_200 = & V_201 ;
V_194 -> V_112 . V_202 = V_203 ;
V_194 -> V_112 . V_47 = V_204 ;
V_194 -> V_112 . V_205 = V_206 ;
V_194 -> V_207 . V_17 = V_208 ;
V_194 -> V_207 . V_209 = V_210 ;
V_194 -> V_211 = V_195 ;
return V_194 ;
}
