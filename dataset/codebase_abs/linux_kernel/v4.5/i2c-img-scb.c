...
static void F_32 ( unsigned long V_100 )
{
...
static T_3 F_36 ( int V_109 , void * V_110 )
{
...
static int F_44 ( struct V_130 * V_33 , struct V_131 * V_132 ,
int V_133 )
{
...
if ( ! V_132 [ V_135 ] . V_49 && V_132 [ V_135 ] . V_93 & V_94 )
return - V_92 ;
if ( ! V_132 [ V_135 ] . V_49 ||
( V_132 [ V_135 ] . V_93 & V_95 ) )
V_134 = true ;
}
V_136 = F_47 ( V_2 -> V_138 ) ;
if ( V_136 )
return V_136 ;
for ( V_135 = 0 ; V_135 < V_133 ; V_135 ++ ) {
...
static T_1 F_50 ( struct V_130 * V_33 )
{
return V_139 | V_140 ;
}
...
V_141 = F_54 ( V_2 -> V_138 ) / 1000 ;
V_147 = V_158 * V_141 / ( 256 * 16 * V_142 ) ;
V_147 = F_55 (unsigned int, prescale, 1 , 8 ) ;
V_141 /= V_147 ;
...
int V_109 , V_136 ;
T_1 V_46 ;
V_2 = F_58 ( & V_184 -> V_34 , sizeof( struct V_1 ) , V_190 ) ;
if ( ! V_2 )
return - V_191 ;
V_189 = F_59 ( V_184 , V_192 , 0 ) ;
V_2 -> V_5 = F_60 ( & V_184 -> V_34 , V_189 ) ;
if ( F_61 ( V_2 -> V_5 ) )
return F_62 ( V_2 -> V_5 ) ;
V_109 = F_63 ( V_184 , 0 ) ;
if ( V_109 < 0 ) {
F_31 ( & V_184 -> V_34 , L_13 ) ;
return V_109 ;
}
V_2 -> V_193 = F_64 ( & V_184 -> V_34 , L_14 ) ;
if ( F_61 ( V_2 -> V_193 ) ) {
F_31 ( & V_184 -> V_34 , L_15 ) ;
return F_62 ( V_2 -> V_193 ) ;
}
V_2 -> V_138 = F_64 ( & V_184 -> V_34 , L_16 ) ;
if ( F_61 ( V_2 -> V_138 ) ) {
F_31 ( & V_184 -> V_34 , L_17 ) ;
return F_62 ( V_2 -> V_138 ) ;
}
V_136 = F_65 ( & V_184 -> V_34 , V_109 , F_36 , 0 ,
V_184 -> V_194 , V_2 ) ;
if ( V_136 ) {
F_31 ( & V_184 -> V_34 , L_18 , V_109 ) ;
return V_136 ;
}
F_66 ( & V_2 -> V_65 ) ;
V_2 -> V_65 . V_195 = F_32 ;
...
static int F_73 ( struct V_183 * V_34 )
{
struct V_1 * V_2 = F_74 ( V_34 ) ;
F_75 ( & V_2 -> V_33 ) ;
F_49 ( V_2 -> V_193 ) ;
return 0 ;
}
static int F_76 ( struct V_204 * V_34 )
{
struct V_1 * V_2 = F_77 ( V_34 ) ;
F_6 ( V_2 , V_137 ) ;
F_49 ( V_2 -> V_193 ) ;
return 0 ;
}
static int F_78 ( struct V_204 * V_34 )
{
struct V_1 * V_2 = F_77 ( V_34 ) ;
int V_136 ;
V_136 = F_47 ( V_2 -> V_193 ) ;
