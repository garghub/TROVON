...
if ( ! V_256 )
return 0 ;
V_39 = V_12 -> V_259 ( V_4 -> V_9 , V_256 , V_257 , V_258 ) ;
return 0 ;
}
static int
...
if ( ! V_256 )
return 0 ;
V_39 = V_12 -> V_262 ( V_4 -> V_9 , V_256 , V_257 , V_258 ) ;
return 0 ;
}
void F_82 ( struct V_1 * V_84 )
{
V_84 -> V_263 = & V_264 ;
}
