...
while ( V_241 -- ) {
V_256 = F_249 ( V_240 ) ;
if ( ! strcasecmp ( V_256 , L_31 ) )
V_253 -> V_80 = V_82 ;
else if ( ! strcasecmp ( V_256 , L_32 ) )
V_253 -> V_80 = V_81 ;
...
T_7 V_271 ;
struct V_272 * V_68 ;
bool V_273 = V_238 -> V_84 . V_117 == V_122 ;
...
V_17 -> V_18 = F_285 ( L_51 V_288 , V_289 ) ;
if ( ! V_17 -> V_18 ) {
* error = L_52 ;
goto V_283;
}
...
F_321 ( L_83 , ( unsigned long long ) V_17 -> V_169 ) ;
...
F_321 ( L_91 , V_17 -> V_233 [ V_230 ] ) ;
if ( V_17 -> V_232 )
F_321 ( L_91 , V_17 -> V_233 [ V_17 -> V_232 - 1 ] ) ;
}
return;
V_131:
F_321 ( L_92 ) ;
...
T_11 V_50 , V_158 ;
int V_9 ;
V_9 = sscanf ( V_325 , L_93 , & V_50 , & V_158 , & V_327 ) ;
if ( V_9 < 0 )
return V_9 ;
if ( V_9 == 2 ) {
...
V_9 = sscanf ( V_325 , L_94 , & V_50 , & V_327 ) ;
if ( V_9 < 0 )
return V_9 ;
if ( V_9 == 1 ) {
V_270 -> V_34 = F_205 ( V_50 ) ;
