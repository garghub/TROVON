...
if ( ! V_2 )
return - V_30 ;
V_2 -> V_3 = F_19 ( V_22 -> V_28 . V_31 , 0 , & V_24 ) ;
if ( ! F_20 ( V_2 -> V_3 ) )
return V_2 -> V_3 ;
V_2 -> V_4 = V_24 & V_32 ;
V_27 = F_21 ( V_22 -> V_28 . V_31 , L_2 , & V_26 ) ;
if ( V_27 )
return V_27 ;
if ( ! strcmp ( V_26 , L_3 ) ) {
V_2 -> V_5 = V_6 ;
...
V_27 = F_22 ( & V_22 -> V_28 , V_2 -> V_3 , V_25 ,
F_23 ( & V_22 -> V_28 ) ) ;
if ( V_27 )
return V_27 ;
V_27 = F_24 ( V_22 -> V_28 . V_31 ,
L_5 , & V_16 ) ;
if ( V_27 )
return V_27 ;
...
if ( F_27 ( & V_2 -> V_9 , 0 , & V_22 -> V_28 ) < 0 )
V_2 -> V_9 . V_13 = V_45 ;
F_28 ( & V_2 -> V_15 , F_4 , ( unsigned long ) & V_2 -> V_9 ) ;
F_29 ( & V_2 -> V_9 ) ;
V_27 = F_30 ( & V_2 -> V_9 ) ;
if ( V_27 )
return V_27 ;
