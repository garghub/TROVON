...
if ( V_6 < 0 )
goto error;
if ( F_8 ( V_5 , V_9 , sizeof( * V_5 ) ) ||
F_9 ( V_9 -> V_13 , & V_5 -> V_13 ) ||
F_9 ( V_9 -> V_14 , & V_5 -> V_14 ) )
V_6 = - V_7 ;
error:
F_10 ( V_9 ) ;
return V_6 ;
}
static long F_11 ( struct V_16 * V_16 , unsigned int V_3 , unsigned long V_17 )
{
struct V_1 * V_2 = V_16 -> V_18 ;
void T_1 * V_19 = F_12 ( V_17 ) ;
if ( F_13 ( ! V_2 ) )
return - V_20 ;
switch ( V_3 ) {
case V_21 :
