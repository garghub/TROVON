...
&& V_19 -> V_106 >= V_107 ) {
V_2 -> V_120 = V_88 ;
V_119 = F_25 ( V_19 -> V_39 * 2000 ) ;
if ( ! F_45 ( V_2 , V_79 ) )
while ( V_2 -> V_120 == V_88 && V_119 )
V_119 = F_46 ( V_119 ) ;
}
F_47 ( V_2 ) ;
...
V_2 -> V_96 |= V_131 ;
F_6 ( & V_19 -> V_21 ) ;
if ( ! ( V_19 -> V_82 -> V_96 & V_131 ) ) {
int V_132 = 0 ;
while ( V_132 < ( ( V_19 -> V_39 * 3 ) + 3 ) &&
V_2 -> V_14 > V_15 &&
V_2 -> V_14 < V_75 ) {
V_132 ++ ;
F_28 ( 1000 ) ;
...
if ( V_2 -> V_137 ) {
V_119 = F_25 ( V_19 -> V_39 * 2000 ) ;
if ( ! F_69 ( V_2 , V_138 , 0 , 0 ) )
while ( V_2 -> V_139 && V_119 )
V_119 = F_46 ( V_119 ) ;
else
F_19 ( V_2 -> V_19 , V_140 ,
V_44 ,
...
struct V_1 * * V_147 ;
int V_148 = 0 ;
V_147 = F_75 ( ( V_19 -> V_149 + 1 ) * sizeof( struct V_1 * ) ,
V_35 ) ;
if ( V_147 == NULL )
return NULL ;
F_3 ( & V_19 -> V_21 ) ;
...
void
F_76 ( struct V_18 * V_19 , struct V_1 * * V_147 )
{
int V_150 ;
if ( V_147 == NULL )
return;
for ( V_150 = 0 ; V_150 <= V_19 -> V_149 && V_147 [ V_150 ] != NULL ; V_150 ++ )
F_59 ( F_43 ( V_147 [ V_150 ] ) ) ;
F_17 ( V_147 ) ;
}
void
F_77 ( struct V_1 * V_2 )
