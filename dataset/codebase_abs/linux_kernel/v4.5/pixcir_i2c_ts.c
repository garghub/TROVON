...
enum V_53 V_45 , bool V_54 )
{
struct V_32 * V_18 = & V_25 -> V_17 -> V_18 ;
int V_10 ;
V_10 = F_22 ( V_25 -> V_17 , V_55 ) ;
if ( V_10 < 0 ) {
F_3 ( V_18 , L_5 ,
V_19 , V_55 , V_10 ) ;
return V_10 ;
...
static int F_25 ( struct V_1 * V_25 , bool V_58 )
{
struct V_32 * V_18 = & V_25 -> V_17 -> V_18 ;
int V_10 ;
V_10 = F_22 ( V_25 -> V_17 , V_55 ) ;
...
static int F_30 ( struct V_62 * V_18 )
{
struct V_1 * V_25 = F_31 ( V_18 ) ;
return F_26 ( V_25 ) ;
}
static void F_32 ( struct V_62 * V_18 )
{
struct V_1 * V_25 = F_31 ( V_18 ) ;
F_28 ( V_25 ) ;
}
...
{
struct V_63 * V_17 = F_34 ( V_18 ) ;
struct V_1 * V_25 = F_35 ( V_17 ) ;
struct V_62 * V_33 = V_25 -> V_33 ;
int V_10 = 0 ;
F_36 ( & V_33 -> V_64 ) ;
if ( F_37 ( & V_17 -> V_18 ) ) {
if ( ! V_33 -> V_65 ) {
...
static int T_3 F_39 ( struct V_32 * V_18 )
{
struct V_63 * V_17 = F_34 ( V_18 ) ;
struct V_1 * V_25 = F_35 ( V_17 ) ;
struct V_62 * V_33 = V_25 -> V_33 ;
...
static int F_40 ( struct V_32 * V_18 ,
struct V_1 * V_2 )
{
const struct V_67 * V_68 ;
V_68 = F_41 ( F_42 ( V_69 ) , V_18 ) ;
if ( ! V_68 )
return - V_70 ;
V_2 -> V_14 = ( const struct V_13 * ) V_68 -> V_71 ;
if ( ! V_2 -> V_14 )
return - V_70 ;
return 0 ;
}
...
static int F_43 ( struct V_63 * V_17 ,
const struct V_72 * V_24 )
{
...
V_33 -> V_81 = F_30 ;
V_33 -> V_82 = F_32 ;
V_33 -> V_18 . V_83 = & V_17 -> V_18 ;
if ( V_74 ) {
F_47 ( V_33 , V_36 , 0 , V_74 -> V_84 , 0 , 0 ) ;
F_47 ( V_33 , V_37 , 0 , V_74 -> V_85 , 0 , 0 ) ;
} else {
F_48 ( V_33 , V_35 , V_36 ) ;
F_48 ( V_33 , V_35 , V_37 ) ;
F_49 ( V_33 , true ) ;
...
F_53 ( V_33 , V_2 ) ;
V_2 -> V_41 = F_54 ( V_18 , L_18 , V_88 ) ;
if ( F_55 ( V_2 -> V_41 ) ) {
error = F_56 ( V_2 -> V_41 ) ;
F_3 ( V_18 , L_19 , error ) ;
return error ;
}
V_2 -> V_43 = F_57 ( V_18 , L_20 ,
V_89 ) ;
if ( F_55 ( V_2 -> V_43 ) ) {
error = F_56 ( V_2 -> V_43 ) ;
F_3 ( V_18 , L_21 , error ) ;
...
if ( V_2 -> V_60 )
F_16 ( 100 ) ;
error = F_58 ( V_18 , V_17 -> V_38 , NULL , F_14 ,
V_92 | V_93 ,
V_17 -> V_78 , V_2 ) ;
if ( error ) {
F_3 ( V_18 , L_26 , V_17 -> V_38 ) ;
return error ;
}
F_17 ( V_2 ) ;
error = F_21 ( V_2 , V_47 ) ;
