...
V_6 -> V_144 = V_134 -> V_156 > 1 ;
V_154 = F_54 ( T_4 , V_134 -> V_157 , 511u ) ;
V_6 -> V_115 = F_54 ( T_4 , V_134 -> V_158 ,
V_154 * V_14 -> V_112 ) ;
V_6 -> V_159 = F_54 ( T_4 , V_134 -> V_156 ,
V_160 ) ;
V_6 -> V_129 = V_134 -> V_161 ;
if ( ! V_6 -> V_144 )
return;
V_155 = F_76 ( T_4 , V_162 ,
V_6 -> V_4 -> V_163 -> V_164 -> V_165 ) ;
V_155 += ( V_155 >> 4 ) + 1 ;
F_33 ( V_155 > V_6 -> V_159 ) ;
F_3 ( V_46 , L_30 , V_155 ) ;
V_67 = F_77 ( & V_6 -> V_118 , V_155 , V_166 ) ;
if ( V_67 < 0 ) {
F_10 ( L_31 ) ;
V_6 -> V_144 = false ;
}
V_6 -> V_167 = V_6 -> V_4 -> V_163 -> V_164 -> V_165 ;
}
static int F_78 ( struct V_5 * V_6 )
{
V_6 -> V_168 = F_79 ( sizeof( * V_6 -> V_168 ) , V_166 ) ;
if ( ! V_6 -> V_168 )
return - V_114 ;
...
F_104 ( & V_6 -> V_118 ) ;
V_6 -> V_76 = 0 ;
F_105 ( V_6 -> V_14 [ 1 ] -> V_133 -> V_134 -> V_176 ) ;
return 0 ;
}
static void F_106 ( struct V_153 * V_134 )
{
F_107 ( V_134 -> V_176 ) ;
V_134 -> V_177 |= V_178 ;
}
...
V_6 -> V_179 = 2 ;
F_15 ( V_6 -> V_14 [ 1 ] ) ;
V_16 = F_109 ( V_6 -> V_14 [ 1 ] , V_180 ) ;
if ( V_16 ) {
F_10 ( L_32 ) ;
F_21 ( V_6 -> V_14 [ 1 ] ) ;
goto V_181;
}
V_16 = F_109 ( V_6 -> V_14 [ 2 ] , V_182 ) ;
if ( V_16 ) {
F_10 ( L_33 ) ;
F_21 ( V_6 -> V_14 [ 1 ] ) ;
goto V_181;
...
struct V_186 * V_15 ;
F_3 ( V_23 , L_28 ) ;
F_3 ( V_23 , L_35 , V_14 -> V_194 ) ;
F_3 ( V_23 , L_36 , V_14 -> V_195 ) ;
F_3 ( V_23 , L_37 , V_14 -> V_186 ) ;
F_3 ( V_23 , L_38 , V_14 -> V_196 ) ;
V_15 = & V_14 -> V_15 ;
F_112 ( V_15 , 0 ) ;
if ( V_14 -> V_196 == 1 )
return 0 ;
...
F_118 ( V_6 ) ;
#ifdef F_119
if ( ( F_120 ( V_6 -> V_14 [ 1 ] ) & V_200 ) &&
( ( F_120 ( V_6 -> V_14 [ 1 ] ) & V_201 ) ||
...
void F_122 ( struct V_186 * V_15 , bool V_204 )
{
...
if ( F_126 ( V_6 -> V_14 [ 1 ] , V_206 ) )
F_10 ( L_45 , V_206 ) ;
return 0 ;
}
static int F_127 ( struct V_186 * V_15 )
{
struct V_3 * V_4 = F_2 ( V_15 ) ;
struct V_5 * V_6 = V_4 -> V_7 . V_8 ;
...
static int T_8 F_128 ( struct V_207 * V_208 )
{
F_3 ( V_23 , L_28 ) ;
V_199 = F_129 ( & V_208 -> V_15 ) ;
if ( V_199 -> V_209 )
V_199 -> V_209 () ;
return 0 ;
}
