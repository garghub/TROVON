...
struct V_3 * V_4 ;
struct V_15 * V_108 ;
V_4 = F_118 ( V_161 , V_75 | V_179 ) ;
if ( V_4 != NULL ) {
V_108 = F_28 ( V_4 ) ;
F_119 ( V_108 , NULL , V_8 ) ;
V_4 -> V_87 . V_180 = & V_181 ;
V_4 -> V_84 = - 1 ;
V_108 -> V_182 = & V_183 ;
} else
V_108 = NULL ;
...
struct V_63 * F_121 ( struct V_11 * V_184 )
{
struct V_15 * V_185 ;
struct V_63 * V_64 = NULL ;
if ( V_184 == NULL )
...
struct V_29 * V_188 = V_64 -> V_35 [ V_58 ] ;
if ( F_37 ( V_188 ) )
continue;
