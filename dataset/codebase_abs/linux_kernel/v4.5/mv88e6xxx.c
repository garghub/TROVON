...
static int F_86 ( struct V_1 * V_2 , int V_81 ,
T_1 V_184 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
const T_1 V_135 = ( 1 << V_4 -> V_101 ) - 1 ;
int V_16 ;
V_16 = F_11 ( V_2 , F_56 ( V_81 ) , V_185 ) ;
if ( V_16 < 0 )
return V_16 ;
V_16 &= ~ V_135 ;
V_16 |= V_184 & V_135 ;
return F_18 ( V_2 , F_56 ( V_81 ) , V_185 , V_16 ) ;
}
int F_87 ( struct V_1 * V_2 , int V_81 , T_2 V_156 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_186 ;
switch ( V_156 ) {
...
F_88 ( V_2 -> V_194 [ V_81 ] , L_5 , V_156 , V_186 ) ;
V_4 -> V_195 [ V_81 ] = V_186 ;
F_89 ( V_81 , & V_4 -> V_196 ) ;
F_34 ( & V_4 -> V_197 ) ;
return 0 ;
}
static int F_90 ( struct V_1 * V_2 , int V_81 , T_1 * V_198 )
{
int V_10 ;
V_10 = F_11 ( V_2 , F_56 ( V_81 ) , V_199 ) ;
if ( V_10 < 0 )
return V_10 ;
* V_198 = V_10 & V_200 ;
return 0 ;
}
int F_91 ( struct V_1 * V_2 , int V_81 , T_1 * V_198 )
{
int V_10 ;
V_10 = F_14 ( V_2 , F_56 ( V_81 ) , V_199 ) ;
if ( V_10 < 0 )
return V_10 ;
* V_198 = V_10 & V_200 ;
return 0 ;
}
static int F_92 ( struct V_1 * V_2 , int V_81 , T_1 V_198 )
{
return F_18 ( V_2 , F_56 ( V_81 ) , V_199 ,
V_198 & V_200 ) ;
}
static int F_93 ( struct V_1 * V_2 )
{
return F_69 ( V_2 , V_23 , V_201 ,
V_202 ) ;
}
static int F_94 ( struct V_1 * V_2 , T_1 V_169 )
{
int V_10 ;
V_10 = F_18 ( V_2 , V_23 , V_201 , V_169 ) ;
if ( V_10 < 0 )
return V_10 ;
return F_93 ( V_2 ) ;
}
...
unsigned int V_159 = ( V_11 % 4 ) * 4 + V_205 ;
T_1 V_16 = V_130 [ V_11 / 4 ] ;
V_155 -> V_47 [ V_11 ] = ( V_16 >> V_159 ) & V_207 ;
}
return 0 ;
}
...
V_130 [ V_11 / 4 ] |= ( V_47 & V_207 ) << V_159 ;
}
for ( V_11 = 0 ; V_11 < 3 ; ++ V_11 ) {
V_10 = F_18 ( V_2 , V_23 ,
V_206 + V_11 , V_130 [ V_11 ] ) ;
if ( V_10 < 0 )
return V_10 ;
}
return 0 ;
}
static int F_98 ( struct V_1 * V_2 , T_1 V_208 )
{
return F_18 ( V_2 , V_23 , V_209 ,
V_208 & V_210 ) ;
}
...
if ( V_10 < 0 )
return V_10 ;
V_10 = F_11 ( V_2 , V_23 , V_209 ) ;
if ( V_10 < 0 )
return V_10 ;
V_211 . V_208 = V_10 & V_210 ;
V_211 . V_213 = ! ! ( V_10 & V_214 ) ;
if ( V_211 . V_213 ) {
V_10 = F_96 ( V_2 , & V_211 , 0 ) ;
if ( V_10 < 0 )
return V_10 ;
...
if ( V_10 < 0 )
return V_10 ;
V_211 . V_171 = V_10 & V_216 ;
V_10 = F_11 ( V_2 , V_23 ,
V_217 ) ;
if ( V_10 < 0 )
return V_10 ;
V_211 . V_218 = V_10 & V_219 ;
}
}
* V_155 = V_211 ;
return 0 ;
...
if ( ! V_155 -> V_213 )
goto V_220;
V_10 = F_97 ( V_2 , V_155 , 0 ) ;
if ( V_10 < 0 )
return V_10 ;
if ( F_48 ( V_2 ) || F_49 ( V_2 ) ||
F_52 ( V_2 ) || F_53 ( V_2 ) ) {
V_16 = V_155 -> V_218 & V_219 ;
V_10 = F_18 ( V_2 , V_23 , V_217 , V_16 ) ;
if ( V_10 < 0 )
return V_10 ;
V_16 = V_155 -> V_171 & V_216 ;
V_10 = F_18 ( V_2 , V_23 , V_215 , V_16 ) ;
if ( V_10 < 0 )
return V_10 ;
}
V_16 = V_214 ;
V_220:
V_16 |= V_155 -> V_208 & V_210 ;
V_10 = F_18 ( V_2 , V_23 , V_209 , V_16 ) ;
if ( V_10 < 0 )
return V_10 ;
return F_94 ( V_2 , V_221 ) ;
}
static int F_101 ( struct V_1 * V_2 , T_2 V_218 ,
struct V_204 * V_155 )
{
struct V_204 V_211 = { 0 } ;
int V_10 ;
...
if ( V_10 < 0 )
return V_10 ;
return F_94 ( V_2 , V_223 ) ;
}
static int F_103 ( struct V_1 * V_2 , T_1 V_208 ,
struct V_204 * V_155 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_204 V_224 = {
...
int V_11 ;
for ( V_11 = 0 ; V_11 < V_4 -> V_101 ; ++ V_11 )
V_224 . V_47 [ V_11 ] = F_104 ( V_2 , V_11 ) || F_105 ( V_2 , V_11 )
? V_225
: V_226 ;
if ( F_48 ( V_2 ) || F_49 ( V_2 ) ||
F_52 ( V_2 ) || F_53 ( V_2 ) ) {
...
int V_170 ;
V_224 . V_218 = 0 ;
V_170 = F_101 ( V_2 , V_219 , & V_227 ) ;
if ( V_170 )
return V_170 ;
if ( V_227 . V_218 != V_224 . V_218 || ! V_227 . V_213 ) {
memset ( & V_227 , 0 , sizeof( V_227 ) ) ;
V_227 . V_213 = true ;
V_227 . V_218 = V_224 . V_218 ;
V_170 = F_102 ( V_2 , & V_227 ) ;
if ( V_170 )
return V_170 ;
}
V_170 = F_82 ( V_2 , V_224 . V_171 , true ) ;
if ( V_170 )
return V_170 ;
}
* V_155 = V_224 ;
...
int F_106 ( struct V_1 * V_2 , int V_81 ,
const struct V_228 * V_224 ,
struct V_229 * V_230 )
{
if ( V_224 -> V_231 >= 4000 )
return - V_232 ;
...
static int F_107 ( struct V_1 * V_2 , int V_81 , T_1 V_208 ,
bool V_233 )
{
struct V_204 V_224 ;
int V_170 ;
V_170 = F_98 ( V_2 , V_208 - 1 ) ;
if ( V_170 )
return V_170 ;
V_170 = F_99 ( V_2 , & V_224 ) ;
if ( V_170 )
return V_170 ;
if ( V_224 . V_208 != V_208 || ! V_224 . V_213 ) {
V_170 = F_103 ( V_2 , V_208 , & V_224 ) ;
if ( V_170 )
return V_170 ;
}
V_224 . V_47 [ V_81 ] = V_233 ?
V_234 :
V_235 ;
return F_100 ( V_2 , & V_224 ) ;
}
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
bool V_233 = V_224 -> V_236 & V_237 ;
bool V_198 = V_224 -> V_236 & V_238 ;
T_1 V_208 ;
int V_170 = 0 ;
F_15 ( & V_4 -> V_5 ) ;
for ( V_208 = V_224 -> V_239 ; V_208 <= V_224 -> V_231 ; ++ V_208 ) {
V_170 = F_107 ( V_2 , V_81 , V_208 , V_233 ) ;
if ( V_170 )
goto V_240;
}
if ( V_198 )
V_170 = F_92 ( V_2 , V_81 , V_224 -> V_231 ) ;
V_240:
F_16 ( & V_4 -> V_5 ) ;
return V_170 ;
}
static int F_109 ( struct V_1 * V_2 , int V_81 , T_1 V_208 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_204 V_224 ;
int V_11 , V_170 ;
...
return V_170 ;
if ( V_224 . V_208 != V_208 || ! V_224 . V_213 ||
V_224 . V_47 [ V_81 ] == V_226 )
return - V_232 ;
V_224 . V_47 [ V_81 ] = V_226 ;
V_224 . V_213 = false ;
for ( V_11 = 0 ; V_11 < V_4 -> V_101 ; ++ V_11 ) {
if ( F_104 ( V_2 , V_11 ) || F_105 ( V_2 , V_11 ) )
continue;
if ( V_224 . V_47 [ V_11 ] != V_226 ) {
V_224 . V_213 = true ;
break;
}
}
V_170 = F_100 ( V_2 , & V_224 ) ;
if ( V_170 )
return V_170 ;
return F_84 ( V_2 , V_224 . V_171 , V_81 , false ) ;
}
int F_110 ( struct V_1 * V_2 , int V_81 ,
const struct V_228 * V_224 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
const T_1 V_241 = 4000 + V_2 -> V_242 * V_243 + V_81 ;
T_1 V_198 , V_208 ;
int V_170 = 0 ;
F_15 ( & V_4 -> V_5 ) ;
V_170 = F_90 ( V_2 , V_81 , & V_198 ) ;
if ( V_170 )
goto V_240;
for ( V_208 = V_224 -> V_239 ; V_208 <= V_224 -> V_231 ; ++ V_208 ) {
V_170 = F_109 ( V_2 , V_81 , V_208 ) ;
if ( V_170 )
goto V_240;
if ( V_208 == V_198 ) {
V_170 = F_92 ( V_2 , V_81 , V_241 ) ;
if ( V_170 )
goto V_240;
}
}
...
int F_111 ( struct V_1 * V_2 , T_1 * V_208 ,
unsigned long * V_194 , unsigned long * V_233 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_204 V_211 ;
int V_81 ;
...
return - V_244 ;
F_15 ( & V_4 -> V_5 ) ;
V_170 = F_98 ( V_2 , * V_208 ) ;
if ( V_170 )
goto V_240;
V_170 = F_99 ( V_2 , & V_211 ) ;
V_240:
F_16 ( & V_4 -> V_5 ) ;
if ( V_170 )
return V_170 ;
...
F_112 ( V_81 , V_194 ) ;
F_112 ( V_81 , V_233 ) ;
if ( F_104 ( V_2 , V_81 ) || F_105 ( V_2 , V_81 ) )
continue;
if ( V_211 . V_47 [ V_81 ] == V_235 ||
V_211 . V_47 [ V_81 ] == V_234 )
F_89 ( V_81 , V_194 ) ;
if ( V_211 . V_47 [ V_81 ] == V_234 )
F_89 ( V_81 , V_233 ) ;
}
return 0 ;
}
...
static int F_114 ( struct V_1 * V_2 , unsigned char * V_15 )
{
int V_11 , V_10 ;
for ( V_11 = 0 ; V_11 < 3 ; V_11 ++ ) {
V_10 = F_11 ( V_2 , V_23 ,
...
if ( V_10 < 0 )
return V_10 ;
return F_79 ( V_2 , V_247 ) ;
}
static int F_116 ( struct V_1 * V_2 , int V_81 ,
const unsigned char * V_15 , T_1 V_208 ,
T_2 V_156 )
{
struct V_154 V_155 = { 0 } ;
V_155 . V_171 = V_208 ;
V_155 . V_156 = V_156 ;
F_117 ( V_155 . V_246 , V_15 ) ;
if ( V_156 != V_158 ) {
V_155 . V_160 = false ;
V_155 . V_166 = F_118 ( V_81 ) ;
}
return F_115 ( V_2 , & V_155 ) ;
}
int F_119 ( struct V_1 * V_2 , int V_81 ,
...
struct V_229 * V_230 )
{
int V_156 = F_121 ( V_249 -> V_15 ) ?
V_250 :
V_251 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_10 ;
F_15 ( & V_4 -> V_5 ) ;
V_10 = F_116 ( V_2 , V_81 , V_249 -> V_15 , V_249 -> V_208 , V_156 ) ;
F_16 ( & V_4 -> V_5 ) ;
return V_10 ;
}
...
int V_10 ;
F_15 ( & V_4 -> V_5 ) ;
V_10 = F_116 ( V_2 , V_81 , V_249 -> V_15 , V_249 -> V_208 ,
V_158 ) ;
F_16 ( & V_4 -> V_5 ) ;
return V_10 ;
}
static int F_123 ( struct V_1 * V_2 , T_1 V_171 ,
struct V_154 * V_155 )
{
struct V_154 V_211 = { 0 } ;
int V_10 ;
V_211 . V_171 = V_171 ;
V_10 = F_74 ( V_2 ) ;
if ( V_10 < 0 )
...
if ( V_10 < 0 )
return V_10 ;
V_10 = F_114 ( V_2 , V_211 . V_246 ) ;
if ( V_10 < 0 )
return V_10 ;
V_10 = F_11 ( V_2 , V_23 , V_167 ) ;
if ( V_10 < 0 )
return V_10 ;
V_211 . V_156 = V_10 & V_157 ;
if ( V_211 . V_156 != V_158 ) {
unsigned int V_135 , V_159 ;
if ( V_10 & V_161 ) {
V_211 . V_160 = true ;
V_135 = V_162 ;
...
int V_170 ;
F_15 ( & V_4 -> V_5 ) ;
V_170 = F_98 ( V_2 , V_224 . V_208 ) ;
if ( V_170 )
goto V_240;
do {
struct V_154 V_15 = {
. V_246 = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ,
} ;
V_170 = F_99 ( V_2 , & V_224 ) ;
if ( V_170 )
goto V_240;
if ( ! V_224 . V_213 )
break;
V_170 = F_113 ( V_2 , V_15 . V_246 ) ;
if ( V_170 )
goto V_240;
do {
V_170 = F_123 ( V_2 , V_224 . V_171 , & V_15 ) ;
if ( V_170 )
goto V_240;
if ( V_15 . V_156 == V_158 )
break;
if ( ! V_15 . V_160 && V_15 . V_166 & F_118 ( V_81 ) ) {
bool V_255 = V_15 . V_156 ==
( F_121 ( V_15 . V_246 ) ?
V_250 :
V_251 ) ;
V_249 -> V_208 = V_224 . V_208 ;
F_117 ( V_249 -> V_15 , V_15 . V_246 ) ;
V_249 -> V_256 = V_255 ? V_257 :
V_258 ;
V_170 = F_125 ( & V_249 -> V_254 ) ;
if ( V_170 )
goto V_240;
}
} while ( ! F_126 ( V_15 . V_246 ) );
} while ( V_224 . V_208 < V_210 );
V_240:
F_16 ( & V_4 -> V_5 ) ;
return V_170 ;
}
int F_127 ( struct V_1 * V_2 , int V_81 , T_3 V_259 )
{
return 0 ;
}
int F_128 ( struct V_1 * V_2 , int V_81 , T_3 V_259 )
{
return 0 ;
}
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
const T_1 V_198 = 4000 + V_2 -> V_242 * V_243 + V_81 ;
int V_170 ;
F_15 ( & V_4 -> V_5 ) ;
V_170 = F_107 ( V_2 , V_81 , V_198 , true ) ;
if ( ! V_170 )
V_170 = F_92 ( V_2 , V_81 , V_198 ) ;
F_16 ( & V_4 -> V_5 ) ;
return V_170 ;
}
static void F_130 ( struct V_40 * V_260 )
{
struct V_3 * V_4 ;
struct V_1 * V_2 ;
int V_81 ;
V_4 = F_31 ( V_260 , struct V_3 , V_197 ) ;
V_2 = ( (struct V_1 * ) V_4 ) - 1 ;
while ( V_4 -> V_196 ) {
V_81 = F_131 ( V_4 -> V_196 ) ;
F_112 ( V_81 , & V_4 -> V_196 ) ;
F_85 ( V_2 , V_81 , V_4 -> V_195 [ V_81 ] ) ;
}
}
static int F_132 ( struct V_1 * V_2 , int V_81 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_10 ;
T_1 V_16 ;
...
if ( F_104 ( V_2 , V_81 ) || F_105 ( V_2 , V_81 ) )
V_16 = V_278 ;
V_10 = F_18 ( V_2 , F_56 ( V_81 ) , V_279 , V_16 ) ;
if ( V_10 )
goto abort;
V_10 = F_18 ( V_2 , F_56 ( V_81 ) , V_280 ,
0x0000 ) ;
if ( V_10 )
goto abort;
if ( F_53 ( V_2 ) || F_52 ( V_2 ) ||
...
V_10 = F_18 ( V_2 , F_56 ( V_81 ) , V_289 , 0x0000 ) ;
if ( V_10 )
goto abort;
V_16 = F_118 ( V_4 -> V_101 ) - 1 ;
V_16 &= ~ F_118 ( V_81 ) ;
V_10 = F_86 ( V_2 , V_81 , V_16 ) ;
if ( V_10 )
goto abort;
V_10 = F_18 ( V_2 , F_56 ( V_81 ) , V_199 ,
0x0000 ) ;
abort:
F_16 ( & V_4 -> V_5 ) ;
return V_10 ;
...
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_41 ( & V_4 -> V_5 ) ;
V_4 -> V_49 = F_23 ( F_56 ( 0 ) , V_290 ) & 0xfff0 ;
F_42 ( & V_4 -> V_197 , F_130 ) ;
return 0 ;
}
...
F_21 ( V_23 , V_291 ,
0x0140 | V_292 ) ;
F_21 ( V_23 , V_293 , 0x0000 ) ;
F_21 ( V_23 , V_294 , 0x0000 ) ;
F_21 ( V_23 , V_295 , 0x5555 ) ;
F_21 ( V_23 , V_296 , 0x5555 ) ;
F_21 ( V_23 , V_297 , 0xaaaa ) ;
F_21 ( V_23 , V_298 , 0xaaaa ) ;
F_21 ( V_23 , V_299 , 0xffff ) ;
F_21 ( V_23 , V_300 , 0xffff ) ;
F_21 ( V_23 , V_301 , 0xfa41 ) ;
F_21 ( V_28 , V_302 , 0xffff ) ;
F_21 ( V_28 , V_303 ,
0x7 | V_304 | 0x70 |
V_305 ) ;
for ( V_11 = 0 ; V_11 < 32 ; V_11 ++ ) {
int V_306 = 0x1f ;
if ( V_2 -> V_20 -> V_307 &&
V_11 != V_2 -> V_242 && V_11 < V_2 -> V_265 -> V_20 -> V_308 )
V_306 = V_2 -> V_20 -> V_307 [ V_11 ] & 0x1f ;
F_21 ( V_28 , V_309 ,
V_310 |
( V_11 << V_311 ) |
V_306 ) ;
...
F_49 ( V_2 ) || F_48 ( V_2 ) ||
F_51 ( V_2 ) ) {
F_21 ( V_28 , V_317 , 0xffff ) ;
F_21 ( V_28 , V_318 , 0x9000 ) ;
for ( V_11 = 0 ; V_11 < 16 ; V_11 ++ )
F_21 ( V_28 , V_319 ,
0x8000 | ( V_11 << 8 ) ) ;
}
...
int F_137 ( struct V_1 * V_2 , bool V_322 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_1 V_323 = ( V_322 ? 0x8800 : 0xc800 ) ;
struct V_324 * V_325 = V_2 -> V_20 -> V_326 ;
unsigned long V_32 ;
int V_10 ;
int V_11 ;
for ( V_11 = 0 ; V_11 < V_4 -> V_101 ; V_11 ++ ) {
...
int F_140 ( struct V_1 * V_2 , int V_81 , int V_327 , int V_16 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_10 ;
F_15 ( & V_4 -> V_5 ) ;
V_10 = F_76 ( V_2 , V_81 , 0x16 , V_327 ) ;
if ( V_10 < 0 )
goto error;
...
int F_141 ( struct V_1 * V_2 , int V_81 , int V_327 ,
int V_16 , int V_21 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_10 ;
...
static int F_147 ( struct V_1 * V_2 , int * V_328 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_10 ;
int V_21 ;
...
static int F_148 ( struct V_1 * V_2 , int * V_328 )
{
int V_329 = F_51 ( V_2 ) ? 3 : 0 ;
int V_10 ;
* V_328 = 0 ;
V_10 = F_140 ( V_2 , V_329 , 6 , 27 ) ;
if ( V_10 < 0 )
return V_10 ;
* V_328 = ( V_10 & 0xff ) - 25 ;
return 0 ;
}
int F_149 ( struct V_1 * V_2 , int * V_328 )
{
if ( F_51 ( V_2 ) || F_53 ( V_2 ) )
return F_148 ( V_2 , V_328 ) ;
return F_147 ( V_2 , V_328 ) ;
}
int F_150 ( struct V_1 * V_2 , int * V_328 )
{
int V_329 = F_51 ( V_2 ) ? 3 : 0 ;
int V_10 ;
if ( ! F_51 ( V_2 ) && ! F_53 ( V_2 ) )
return - V_232 ;
* V_328 = 0 ;
V_10 = F_140 ( V_2 , V_329 , 6 , 26 ) ;
if ( V_10 < 0 )
return V_10 ;
* V_328 = ( ( ( V_10 >> 8 ) & 0x1f ) * 5 ) - 25 ;
return 0 ;
}
int F_151 ( struct V_1 * V_2 , int V_328 )
{
int V_329 = F_51 ( V_2 ) ? 3 : 0 ;
int V_10 ;
if ( ! F_51 ( V_2 ) && ! F_53 ( V_2 ) )
...
if ( V_10 < 0 )
return V_10 ;
V_328 = F_152 ( F_153 ( V_328 , 5 ) + 5 , 0 , 0x1f ) ;
return F_141 ( V_2 , V_329 , 6 , 26 ,
( V_10 & 0xe0ff ) | ( V_328 << 8 ) ) ;
}
int F_154 ( struct V_1 * V_2 , bool * V_330 )
{
int V_329 = F_51 ( V_2 ) ? 3 : 0 ;
int V_10 ;
if ( ! F_51 ( V_2 ) && ! F_53 ( V_2 ) )
...
char * F_155 ( struct V_331 * V_332 , int V_9 ,
const struct V_333 * V_334 ,
unsigned int V_335 )
{
struct V_7 * V_8 = F_12 ( V_332 ) ;
int V_11 , V_10 ;
if ( ! V_8 )
return NULL ;
V_10 = F_9 ( V_8 , V_9 , F_56 ( 0 ) , V_290 ) ;
if ( V_10 < 0 )
return NULL ;
for ( V_11 = 0 ; V_11 < V_335 ; ++ V_11 )
if ( V_334 [ V_11 ] . V_49 == V_10 )
return V_334 [ V_11 ] . V_336 ;
for ( V_11 = 0 ; V_11 < V_335 ; ++ V_11 ) {
if ( V_334 [ V_11 ] . V_49 == ( V_10 & V_337 ) ) {
F_156 ( V_332 , L_6 ,
V_10 & V_338 ,
V_10 & V_337 ) ;
return V_334 [ V_11 ] . V_336 ;
