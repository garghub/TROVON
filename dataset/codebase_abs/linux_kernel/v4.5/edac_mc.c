...
static void F_31 ( struct V_5 * V_6 , unsigned V_91 )
{
F_3 ( 0 , L_39 ) ;
if ( V_6 -> V_73 != V_92 )
return;
F_32 ( & V_6 -> V_90 , F_23 ) ;
F_28 ( & V_6 -> V_90 , F_29 ( V_91 ) ) ;
}
...
struct V_5 * F_55 ( struct V_76 * V_75 )
{
struct V_5 * V_6 ;
F_3 ( 0 , L_39 ) ;
F_26 ( & V_88 ) ;
...
static void F_57 ( unsigned long V_119 , unsigned long V_120 ,
T_1 V_44 )
{
struct V_119 * V_121 ;
void * V_122 ;
...
F_61 ( V_123 ) ;
V_122 = F_62 ( V_121 ) ;
F_63 ( V_122 + V_120 , V_44 ) ;
F_64 ( V_122 ) ;
if ( F_60 ( V_121 ) )
F_65 ( V_123 ) ;
}
int F_66 ( struct V_5 * V_6 , unsigned long V_119 )
{
...
F_68 ( V_6 , V_124 , V_62 , V_129 ) ;
}
void F_75 ( const enum V_140 type ,
struct V_5 * V_6 ,
struct V_141 * V_142 )
{
char V_131 [ 80 ] ;
...
V_131 , V_142 -> V_132 , V_142 -> V_124 ,
V_142 -> V_133 , V_142 -> V_134 , V_142 -> V_24 ) ;
} else {
snprintf ( V_131 , sizeof( V_131 ) ,
L_59 ,
V_142 -> V_133 , V_142 -> V_134 , V_142 -> V_24 ) ;
F_71 ( V_6 , V_142 -> V_129 , V_62 , V_142 -> V_130 , V_142 -> V_14 , V_142 -> V_22 ,
V_131 , V_142 -> V_132 , V_142 -> V_124 ) ;
}
}
void F_76 ( const enum V_140 type ,
struct V_5 * V_6 ,
const T_2 V_129 ,
const unsigned long V_133 ,
const unsigned long V_134 ,
...
if ( V_10 > V_142 -> V_14 )
* ( V_10 - 1 ) = '\0' ;
V_149 = F_77 ( V_142 -> V_24 ) + 1 ;
F_78 ( type , V_142 -> V_130 , V_142 -> V_22 , V_142 -> V_129 ,
