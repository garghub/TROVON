...
V_4 -> V_11 = F_36 ( V_4 -> V_8 , V_2 -> V_43 ,
V_52 ) ;
if ( ! V_4 -> V_11 )
goto V_75;
V_4 -> V_13 = F_37 ( F_15 ( V_4 -> V_8 ) ,
sizeof( * V_4 -> V_13 ) ,
V_52 ) ;
if ( ! V_4 -> V_13 )
goto V_76;
...
static int F_41 ( struct V_1 * V_2 , unsigned int V_79 ,
unsigned int V_80 )
{
struct V_15 * V_16 ;
struct V_3 * V_4 ;
