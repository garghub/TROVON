...
void * V_19 ;
V_56 V_54 ;
V_2 = F_45 ( & V_67 -> V_70 . V_71 ) ;
V_54 = F_45 ( & V_67 -> V_70 . V_54 ) ;
V_19 = & V_67 [ 1 ] ;
if ( V_2 >= V_65 )
return;
...
if ( F_46 () )
V_68 = V_72 ;
V_9 = F_47 ( sizeof( * V_9 ) + V_54 , V_68 ) ;
if ( ! V_9 )
return;
V_9 -> V_2 = V_2 ;
V_9 -> V_30 = V_67 -> V_70 . V_30 ;
memcpy ( & V_9 -> V_18 , & V_67 -> V_70 , sizeof( V_9 -> V_18 ) ) ;
memcpy ( V_9 -> V_19 , V_19 , V_54 ) ;
memcpy ( V_9 -> V_73 , V_67 -> V_74 . V_75 , V_55 ) ;
F_3 ( V_7 , V_9 ) ;
}
