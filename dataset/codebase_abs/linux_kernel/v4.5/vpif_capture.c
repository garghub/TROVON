...
unsigned V_29 = V_11 -> V_15 . V_15 . V_16 . V_17 ;
F_6 ( 2 , V_13 , L_3 ) ;
if ( * V_26 ) {
if ( V_27 [ 0 ] < V_29 )
return - V_18 ;
...
V_51 = F_71 () ;
if ( V_51 ) {
F_91 ( V_40 -> V_169 , L_42 ) ;
return V_51 ;
}
V_51 = F_92 ( V_40 , & V_74 . V_208 ) ;
if ( V_51 ) {
F_91 ( V_40 -> V_169 , L_43 ) ;
return V_51 ;
}
while ( ( V_255 = F_93 ( V_250 , V_257 , V_256 ) ) ) {
V_51 = F_94 ( & V_250 -> V_73 , V_255 -> V_258 , F_39 ,
V_259 , V_170 ,
...
V_74 . V_218 . V_267 = F_89 ;
V_51 = F_97 ( & V_74 . V_208 ,
& V_74 . V_218 ) ;
if ( V_51 ) {
F_52 ( L_47 ) ;
V_51 = - V_18 ;
...
static int F_99 ( struct V_268 * V_73 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
...
static int F_103 ( struct V_268 * V_73 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
