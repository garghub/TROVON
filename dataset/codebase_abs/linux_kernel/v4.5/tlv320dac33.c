...
static int F_50 ( struct V_100 * V_52 ,
struct V_101 * V_102 )
{
...
static void F_51 ( struct V_100 * V_52 ,
struct V_101 * V_102 )
{
struct V_1 * V_2 = V_102 -> V_2 ;
struct V_8 * V_9 = F_4 ( V_2 ) ;
...
static int F_52 ( struct V_100 * V_52 ,
struct V_103 * V_104 ,
struct V_101 * V_102 )
{
struct V_1 * V_2 = V_102 -> V_2 ;
...
case 16 :
V_9 -> V_105 = V_106 ;
V_9 -> V_78 = F_55 ( V_9 -> V_107 , 32 ) ;
break;
case 32 :
V_9 -> V_105 = V_108 ;
V_9 -> V_78 = F_55 ( V_9 -> V_107 , 64 ) ;
break;
default:
F_6 ( V_2 -> V_14 , L_11 ,
F_54 ( V_104 ) ) ;
...
static int F_28 ( struct V_100 * V_52 ,
struct V_1 * V_2 )
{
struct V_8 * V_9 = F_4 ( V_2 ) ;
unsigned int V_109 , V_110 , V_111 , V_112 ;
T_1 V_113 , V_114 , V_115 ;
switch ( V_52 -> V_116 -> V_117 ) {
case 44100 :
case 48000 :
V_109 = F_56 ( V_52 -> V_116 -> V_117 , V_9 -> V_118 ) ;
V_110 = F_57 ( V_52 -> V_116 -> V_117 ,
V_9 -> V_118 ) ;
break;
default:
F_6 ( V_2 -> V_14 , L_10 ,
...
V_112 = F_1 ( V_2 , V_130 ) ;
F_7 ( V_2 , V_130 , V_112 ) ;
F_11 ( V_2 , V_131 , V_109 ) ;
F_7 ( V_2 , V_132 , 96 ) ;
F_7 ( V_2 , V_133 , F_58 ( 2 ) |
F_59 ( 1 ) ) ;
F_7 ( V_2 , V_134 , F_60 ( 4 ) ) ;
V_111 = F_1 ( V_2 , V_36 ) ;
V_111 |= V_38 | V_39 | V_40 ;
F_7 ( V_2 , V_36 , V_111 ) ;
F_49 ( V_2 ) ;
if ( V_9 -> V_58 ) {
F_7 ( V_2 , V_135 , F_61 ( 1 ) ) ;
F_7 ( V_2 , V_136 , 1 ) ;
F_11 ( V_2 , V_137 , V_110 ) ;
F_7 ( V_2 , V_138 , V_139 ) ;
} else {
F_7 ( V_2 , V_135 , V_140 ) ;
F_7 ( V_2 , V_136 , 0 ) ;
...
static void F_27 ( struct V_100 * V_52 ,
struct V_1 * V_2 )
{
struct V_8 * V_9 = F_4 ( V_2 ) ;
unsigned int V_152 = V_52 -> V_116 -> V_152 ;
unsigned int V_117 = V_52 -> V_116 -> V_117 ;
unsigned int V_153 ;
if ( ! V_9 -> V_58 )
return;
switch ( V_9 -> V_58 ) {
...
V_9 -> V_72 = V_152 ;
V_9 -> V_155 = F_41 ( V_9 -> V_78 ,
V_9 -> V_72 ) ;
V_9 -> V_75 = 0 ;
V_9 -> V_74 = 0 ;
break;
case V_81 :
V_9 -> V_150 = F_65 ( V_152 , V_117 ,
V_9 -> V_78 ) + 9 ;
if ( V_9 -> V_150 > ( V_9 -> V_105 - V_83 ) )
V_9 -> V_150 = V_9 -> V_105 - V_83 ;
if ( V_9 -> V_150 < ( V_83 + 10 ) )
V_9 -> V_150 = ( V_83 + 10 ) ;
V_9 -> V_82 =
F_41 ( V_52 -> V_116 -> V_117 ,
V_9 -> V_150 - V_83 + 1 ) ;
V_9 -> V_75 = 0 ;
break;
default:
...
static int F_66 ( struct V_100 * V_52 , int V_156 ,
struct V_101 * V_102 )
{
struct V_1 * V_2 = V_102 -> V_2 ;
struct V_8 * V_9 = F_4 ( V_2 ) ;
...
static int F_68 ( struct V_101 * V_172 ,
...
static int F_69 ( struct V_101 * V_172 ,
unsigned int V_182 )
{
struct V_1 * V_2 = V_172 -> V_2 ;
struct V_8 * V_9 = F_4 ( V_2 ) ;
...
struct V_8 * V_9 ;
int V_11 , V_33 ;
if ( V_209 -> V_14 . V_214 == NULL ) {
F_6 ( & V_209 -> V_14 , L_20 ) ;
return - V_202 ;
}
V_213 = V_209 -> V_14 . V_214 ;
V_9 = F_80 ( & V_209 -> V_14 , sizeof( struct V_8 ) ,
V_215 ) ;
if ( V_9 == NULL )
return - V_206 ;
V_9 -> V_13 = V_209 ;
...
F_83 ( V_209 , V_9 ) ;
V_9 -> V_44 = V_213 -> V_44 ;
V_9 -> V_107 = V_213 -> V_107 ;
V_9 -> V_146 = V_213 -> V_146 ;
V_9 -> V_154 = V_213 -> V_154 ;
if ( ! V_9 -> V_154 )
V_9 -> V_154 = 10000 ;
V_9 -> V_94 = V_209 -> V_94 ;
V_9 -> V_58 = V_170 ;
...
V_9 -> V_43 [ V_33 ] . V_217 = V_218 [ V_33 ] ;
V_11 = F_86 ( & V_209 -> V_14 , F_21 ( V_9 -> V_43 ) ,
V_9 -> V_43 ) ;
if ( V_11 != 0 ) {
F_6 ( & V_209 -> V_14 , L_23 , V_11 ) ;
goto V_219;
}
V_11 = F_87 ( & V_209 -> V_14 ,
& V_220 , & V_221 , 1 ) ;
if ( V_11 < 0 )
goto V_219;
return V_11 ;
