...
{
struct V_42 V_68 = { } ;
struct V_1 * V_69 , * V_70 , * V_71 , * V_72 ;
unsigned long V_73 ;
int V_6 ;
V_72 = F_21 ( V_2 , 0 ) ;
if ( V_43 -> V_25 == F_22 ( V_72 ) ) {
V_43 -> V_50 = V_72 ;
return 0 ;
}
V_71 = F_21 ( V_2 , 2 ) ;
...
V_70 = F_21 ( V_2 , 4 ) ;
V_73 = F_22 ( V_71 ) ;
V_68 . V_25 = V_43 -> V_25 = F_52 ( V_43 -> V_25 , V_73 ) ;
if ( V_43 -> V_25 == V_73 ) {
V_43 -> V_25 = V_43 -> V_51 = V_73 ;
V_43 -> V_50 = V_71 ;
return 0 ;
}
if ( V_43 -> V_50 == V_71 ) {
if ( F_22 ( V_70 ) == V_43 -> V_25 )
V_43 -> V_50 = V_70 ;
else
V_43 -> V_50 = V_69 ;
} else if ( V_43 -> V_50 == V_70 ) {
V_43 -> V_50 = V_69 ;
} else {
V_43 -> V_50 = V_70 ;
}
V_6 = F_53 ( V_43 -> V_50 , & V_68 ) ;
if ( V_6 )
return V_6 ;
V_43 -> V_25 = V_43 -> V_51 = V_68 . V_25 ;
return 0 ;
}
...
int V_6 ;
V_13 = V_4 -> V_19 [ V_24 ] . V_13 << V_18 ;
V_6 = F_55 ( V_4 -> V_7 . V_8 , V_4 -> V_9 + V_15 , V_13 ) ;
if ( V_6 )
return V_6 ;
return F_8 ( V_4 ) ;
}
static int F_56 ( struct V_1 * V_2 , unsigned long V_25 ,
unsigned long V_31 )
{
return 0 ;
}
