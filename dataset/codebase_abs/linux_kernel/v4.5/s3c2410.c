...
int V_148 ;
int V_149 ;
V_23 = F_77 ( V_101 ) -> V_150 ;
V_6 = F_78 ( & V_101 -> V_8 , sizeof( * V_6 ) , V_151 ) ;
if ( V_6 == NULL ) {
V_147 = - V_152 ;
goto V_153;
}
F_79 ( V_101 , V_6 ) ;
F_80 ( & V_6 -> V_117 . V_154 ) ;
F_81 ( & V_6 -> V_117 . V_155 ) ;
...
if ( V_147 != 0 )
goto V_153;
V_144 = ( V_20 != NULL ) ? V_20 -> V_144 : NULL ;
V_148 = ( V_20 != NULL ) ? V_20 -> V_148 : 1 ;
V_6 -> V_105 = V_148 ;
V_140 = V_148 * sizeof( * V_6 -> V_102 ) ;
V_6 -> V_102 = F_78 ( & V_101 -> V_8 , V_140 , V_151 ) ;
if ( V_6 -> V_102 == NULL ) {
V_147 = - V_152 ;
goto V_153;
}
V_45 = V_6 -> V_102 ;
for ( V_149 = 0 ; V_149 < V_148 ; V_149 ++ , V_45 ++ ) {
struct V_2 * V_3 = F_68 ( & V_45 -> V_4 ) ;
F_16 ( L_22 ,
V_149 , V_45 , V_6 ) ;
V_3 -> V_8 . V_157 = & V_101 -> V_8 ;
F_72 ( V_6 , V_45 , V_144 ) ;
V_45 -> V_158 = F_86 ( V_3 ,
( V_144 ) ? V_144 -> V_51 : 1 ,
NULL ) ;
...
static int F_88 ( struct V_7 * V_8 , T_3 V_159 )
{
struct V_5 * V_6 = F_6 ( V_8 ) ;
if ( V_6 ) {
V_6 -> V_160 = F_31 ( V_6 -> V_49 ) ;
F_32 ( V_6 -> V_160 | V_6 -> V_50 , V_6 -> V_49 ) ;
F_11 ( V_6 , V_106 ) ;
}
return 0 ;
}
