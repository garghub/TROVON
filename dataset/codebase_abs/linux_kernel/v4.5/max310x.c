...
V_5 -> V_199 . V_222 = V_6 ;
V_5 -> V_199 . V_223 = V_217 ( V_6 ) ;
V_5 -> V_199 . V_224 = F_72 ;
V_5 -> V_199 . V_225 = F_70 ;
V_5 -> V_199 . V_226 = F_73 ;
V_5 -> V_199 . V_227 = F_71 ;
V_5 -> V_199 . V_228 = - 1 ;
V_5 -> V_199 . V_229 = V_16 -> V_110 * 4 ;
V_5 -> V_199 . V_230 = 1 ;
V_12 = F_85 ( & V_5 -> V_199 ) ;
if ( V_12 )
goto V_231;
...
F_99 ( V_252 , & V_245 -> V_6 ) ;
V_16 = (struct V_202 * ) V_251 -> V_253 ;
} else {
const struct V_254 * V_255 = F_100 ( V_245 ) ;
V_16 = (struct V_202 * ) V_255 -> V_256 ;
V_178 = V_257 ;
}
V_258 . V_259 = V_16 -> V_110 * 0x20 - 1 ;
V_8 = F_101 ( V_245 , & V_258 ) ;
return F_74 ( & V_245 -> V_6 , V_16 , V_8 , V_245 -> V_107 , V_178 ) ;
}
static int F_102 ( struct V_244 * V_245 )
{
return F_94 ( & V_245 -> V_6 ) ;
}
