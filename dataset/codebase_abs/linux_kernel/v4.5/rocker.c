...
return F_249 ( V_6 , V_12 , V_13 , V_175 , V_1 ) ;
}
...
static void F_254 ( unsigned long V_84 )
{
...
if ( F_255 ( V_430 , V_427 ) ) {
F_249 ( V_6 , NULL ,
V_13 , V_240 -> V_242 . V_175 ,
V_240 -> V_242 . V_1 ) ;
F_187 ( & V_240 -> V_240 ) ;
} else if ( F_256 ( V_430 , V_428 ) ) {
V_428 = V_430 ;
}
}
F_147 ( & V_30 -> V_332 , V_194 ) ;
F_257 ( & V_30 -> V_432 , F_258 ( V_428 ) ) ;
}
...
V_50 = F_253 ( V_6 , V_12 , V_13 ) ;
if ( V_50 )
goto V_394;
V_50 = F_260 ( V_6 , V_12 , V_13 ) ;
V_394:
if ( F_12 ( V_12 ) ) {
...
static int F_262 ( struct V_6 * V_6 ,
struct V_11 * V_12 , int V_13 )
{
if ( F_6 ( V_6 ) )
return 0 ;
return F_261 ( V_6 , V_12 , V_13 ,
V_182 ) ;
}
...
static struct V_341 *
F_264 ( const struct V_30 * V_30 , int V_449 )
{
struct V_341 * V_349 ;
...
static T_1 F_265 ( struct V_6 * V_6 ,
int V_449 )
{
struct V_30 * V_30 = V_6 -> V_30 ;
struct V_341 * V_240 ;
...
static int F_269 ( struct V_6 * V_6 ,
...
static int F_270 ( struct V_150 * V_39 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
int V_50 ;
V_50 = F_122 ( V_6 ) ;
if ( V_50 )
return V_50 ;
...
static int F_274 ( struct V_150 * V_39 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
F_275 ( V_39 ) ;
F_127 ( V_6 , false ) ;
...
static void F_277 ( const struct V_6 * V_6 ,
const struct V_82 * V_83 )
{
const struct V_30 * V_30 = V_6 -> V_30 ;
struct V_34 * V_35 = V_30 -> V_35 ;
...
if ( ! V_151 [ V_470 ] )
return;
F_278 (attr, attrs[ROCKER_TLV_TX_FRAGS], rem) {
...
static int F_279 ( const struct V_6 * V_6 ,
struct V_82 * V_83 ,
char * V_44 , T_3 V_79 )
{
const struct V_30 * V_30 = V_6 -> V_30 ;
...
static T_13 F_281 ( struct V_141 * V_142 , struct V_150 * V_39 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
struct V_30 * V_30 = V_6 -> V_30 ;
struct V_82 * V_83 ;
...
goto V_196;
V_50 = F_279 ( V_6 , V_83 ,
V_142 -> V_84 , F_282 ( V_142 ) ) ;
if ( V_50 )
goto V_479;
if ( F_283 ( V_142 ) -> V_482 > V_483 ) {
V_50 = F_284 ( V_142 ) ;
if ( V_50 )
goto V_484;
}
for ( V_46 = 0 ; V_46 < F_283 ( V_142 ) -> V_482 ; V_46 ++ ) {
const T_14 * V_477 = & F_283 ( V_142 ) -> V_480 [ V_46 ] ;
V_50 = F_279 ( V_6 , V_83 ,
F_285 ( V_477 ) ,
F_286 ( V_477 ) ) ;
if ( V_50 )
...
static int F_288 ( struct V_150 * V_39 , void * V_403 )
{
struct V_488 * V_175 = V_403 ;
struct V_6 * V_6 = F_271 ( V_39 ) ;
int V_50 ;
if ( ! F_289 ( V_175 -> V_489 ) )
return - V_490 ;
...
static int F_290 ( struct V_150 * V_39 , int V_492 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
int V_493 = F_291 ( V_39 ) ;
int V_50 ;
#define F_292 68
#define F_293 9000
if ( V_492 < F_292 || V_492 > F_293 )
return - V_107 ;
if ( V_493 )
F_274 ( V_39 ) ;
...
static int F_294 ( struct V_150 * V_39 ,
char * V_44 , T_3 V_74 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
...
static void F_296 ( struct V_396 * V_22 )
{
struct V_6 * V_6 = F_271 ( V_22 -> V_39 ) ;
int V_13 = V_356 | V_18 ;
T_10 V_388 = * ( T_10 * ) V_22 -> V_495 ;
F_222 ( V_6 , NULL ,
V_13 , V_388 , V_22 -> V_401 ) ;
}
static int F_297 ( struct V_150 * V_39 ,
struct V_496 * V_226 )
{
const struct V_6 * V_6 = F_271 ( V_39 ) ;
const struct V_30 * V_30 = V_6 -> V_30 ;
switch ( V_226 -> V_497 ) {
case V_498 :
...
{
if ( ! F_12 ( V_12 ) ) {
V_6 -> V_431 = F_300 ( V_431 ) ;
F_257 ( & V_6 -> V_30 -> V_432 , V_427 ) ;
}
return 0 ;
}
static int F_301 ( struct V_150 * V_39 ,
...
static int F_305 ( struct V_150 * V_39 ,
...
static int F_311 ( struct V_6 * V_6 ,
const struct V_507 * V_249 )
{
T_2 V_7 ;
int V_50 ;
for ( V_7 = V_249 -> V_508 ; V_7 <= V_249 -> V_509 ; V_7 ++ ) {
V_50 = F_310 ( V_6 , V_7 , V_249 -> V_13 ) ;
if ( V_50 )
return V_50 ;
}
return 0 ;
}
static int F_312 ( struct V_6 * V_6 ,
struct V_11 * V_12 ,
const struct V_510 * V_425 )
{
T_1 V_1 = F_3 ( V_6 , V_425 -> V_7 , NULL ) ;
...
static int F_313 ( struct V_150 * V_39 ,
const struct V_511 * V_512 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
const struct V_513 * V_514 ;
...
static int F_314 ( const struct V_6 * V_6 ,
struct V_510 * V_425 ,
T_15 * V_518 )
{
struct V_30 * V_30 = V_6 -> V_30 ;
...
static int F_315 ( const struct V_6 * V_6 ,
struct V_507 * V_249 ,
T_15 * V_518 )
{
T_2 V_7 ;
...
static int F_317 ( struct V_150 * V_39 ,
struct V_203 * V_204 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
return F_160 ( V_6 , V_204 ) ;
}
static int F_318 ( struct V_150 * V_39 ,
struct V_203 * V_204 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
return F_162 ( V_6 , V_204 ) ;
}
static void F_319 ( struct V_150 * V_39 ,
struct V_522 * V_523 )
{
F_320 ( V_523 -> V_524 , V_67 , sizeof( V_523 -> V_524 ) ) ;
F_320 ( V_523 -> V_525 , V_526 , sizeof( V_523 -> V_525 ) ) ;
}
static void F_321 ( struct V_150 * V_527 , T_5 V_528 ,
T_9 * V_84 )
{
T_9 * V_403 = V_84 ;
int V_46 ;
switch ( V_528 ) {
case V_529 :
for ( V_46 = 0 ; V_46 < F_322 ( V_530 ) ; V_46 ++ ) {
...
static int F_325 ( struct V_6 * V_6 ,
void * V_197 )
{
return F_145 ( V_6 , NULL , 0 ,
F_323 , NULL ,
...
static void F_326 ( struct V_150 * V_39 ,
...
static int F_327 ( struct V_150 * V_527 , int V_539 )
{
switch ( V_539 ) {
case V_529 :
return V_540 ;
...
static struct V_6 * F_328 ( struct V_541 * V_542 )
{
return F_245 ( V_542 , struct V_6 , V_188 ) ;
}
static int F_329 ( struct V_541 * V_542 , int V_543 )
{
struct V_6 * V_6 = F_328 ( V_542 ) ;
const struct V_30 * V_30 = V_6 -> V_30 ;
const struct V_82 * V_83 ;
T_5 V_120 = 0 ;
int V_50 ;
...
if ( V_120 && F_330 ( V_6 -> V_39 ) )
F_331 ( V_6 -> V_39 ) ;
F_332 ( V_542 ) ;
F_91 ( V_30 , & V_6 -> V_155 , V_120 ) ;
return 0 ;
}
static int F_333 ( const struct V_30 * V_30 ,
...
F_334 ( V_142 , V_547 ) ;
V_142 -> V_551 = F_335 ( V_142 , V_6 -> V_39 ) ;
if ( V_548 & V_552 )
...
static struct V_6 * F_337 ( struct V_541 * V_542 )
{
return F_245 ( V_542 , struct V_6 , V_189 ) ;
}
static int F_338 ( struct V_541 * V_542 , int V_543 )
{
struct V_6 * V_6 = F_337 ( V_542 ) ;
const struct V_30 * V_30 = V_6 -> V_30 ;
struct V_82 * V_83 ;
T_5 V_120 = 0 ;
int V_50 ;
...
static void F_339 ( const struct V_6 * V_6 )
{
const struct V_30 * V_30 = V_6 -> V_30 ;
...
static void F_340 ( const struct V_30 * V_30 )
{
struct V_6 * V_6 ;
int V_46 ;
for ( V_46 = 0 ; V_46 < V_30 -> V_172 ; V_46 ++ ) {
...
V_6 -> V_39 -> V_395 ) ;
if ( V_50 ) {
F_344 ( & V_35 -> V_39 , L_44 ) ;
F_345 ( V_6 -> V_39 ) ;
}
}
static int F_346 ( struct V_30 * V_30 , unsigned int V_33 )
{
const struct V_34 * V_35 = V_30 -> V_35 ;
struct V_6 * V_6 ;
struct V_150 * V_39 ;
...
V_39 -> V_563 = & V_564 ;
V_39 -> V_565 = & V_566 ;
F_348 ( V_39 , & V_6 -> V_188 , F_329 ,
V_567 ) ;
F_349 ( V_39 , & V_6 -> V_189 , F_338 ,
V_567 ) ;
F_339 ( V_6 ) ;
...
V_6 -> V_9 =
F_265 ( V_6 , V_39 -> V_449 ) ;
V_50 = F_302 ( V_6 , NULL , V_559 , 0 ) ;
if ( V_50 ) {
F_124 ( V_6 -> V_39 , L_47 ) ;
goto V_573;
}
...
static int F_352 ( struct V_30 * V_30 )
{
int V_46 ;
T_3 V_574 ;
int V_50 ;
...
static int F_353 ( struct V_30 * V_30 )
{
struct V_34 * V_35 = V_30 -> V_35 ;
int V_32 ;
int V_46 ;
...
if ( V_32 < 0 )
return V_32 ;
if ( V_32 != F_355 ( V_30 -> V_172 ) )
return - V_107 ;
V_30 -> V_32 = F_356 ( V_32 ,
sizeof( struct V_576 ) ,
V_20 ) ;
if ( ! V_30 -> V_32 )
return - V_53 ;
...
V_50 = F_357 ( V_35 , V_30 -> V_32 , V_32 ) ;
if ( V_50 < 0 )
goto V_577;
return 0 ;
V_577:
...
static void F_358 ( const struct V_30 * V_30 )
{
F_359 ( V_30 -> V_35 ) ;
V_21 ( V_30 -> V_32 ) ;
}
static int F_360 ( struct V_34 * V_35 , const struct V_578 * V_497 )
{
struct V_30 * V_30 ;
int V_50 ;
...
V_50 = F_362 ( V_35 , V_67 ) ;
if ( V_50 ) {
F_36 ( & V_35 -> V_39 , L_49 ) ;
goto V_580;
}
V_50 = F_363 ( V_35 , F_364 ( 64 ) ) ;
if ( ! V_50 ) {
V_50 = F_365 ( V_35 , F_364 ( 64 ) ) ;
if ( V_50 ) {
F_36 ( & V_35 -> V_39 , L_50 ) ;
goto V_581;
}
} else {
V_50 = F_363 ( V_35 , F_364 ( 32 ) ) ;
if ( V_50 ) {
F_36 ( & V_35 -> V_39 , L_51 ) ;
goto V_581;
}
}
if ( F_366 ( V_35 , 0 ) < V_582 ) {
F_36 ( & V_35 -> V_39 , L_52 ) ;
V_50 = - V_107 ;
goto V_583;
}
V_30 -> V_584 = F_367 ( F_368 ( V_35 , 0 ) ,
F_366 ( V_35 , 0 ) ) ;
if ( ! V_30 -> V_584 ) {
F_36 ( & V_35 -> V_39 , L_53 ) ;
V_50 = - V_40 ;
...
F_371 ( & V_30 -> V_432 , F_254 ,
( unsigned long ) V_30 ) ;
F_257 ( & V_30 -> V_432 , V_427 ) ;
V_50 = F_352 ( V_30 ) ;
if ( V_50 ) {
F_36 ( & V_35 -> V_39 , L_59 ) ;
goto V_598;
}
F_372 ( & V_35 -> V_39 , L_60 ,
...
static void F_377 ( struct V_34 * V_35 )
{
struct V_30 * V_30 = F_378 ( V_35 ) ;
F_373 ( & V_30 -> V_432 ) ;
F_185 ( V_30 ) ;
F_34 ( V_30 , V_589 , V_590 ) ;
F_340 ( V_30 ) ;
...
static bool F_379 ( const struct V_150 * V_39 )
{
...
T_2 V_559 = 0 ;
int V_50 ;
V_50 = F_310 ( V_6 , V_559 , 0 ) ;
if ( V_50 )
return V_50 ;
F_267 ( V_6 ,
V_6 -> V_39 -> V_449 ) ;
V_6 -> V_9 =
F_265 ( V_6 , V_272 -> V_449 ) ;
V_6 -> V_10 = V_272 ;
F_351 ( V_6 -> V_39 , V_272 , true ) ;
return F_302 ( V_6 , NULL , V_559 , 0 ) ;
}
...
static int F_382 ( struct V_6 * V_6 ,
struct V_150 * V_599 )
{
int V_50 ;
V_6 -> V_10 = V_599 ;
V_50 = F_263 ( V_6 , NULL , 0 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_262 ( V_6 , NULL , 0 ) ;
return V_50 ;
}
static int F_383 ( struct V_6 * V_6 ,
struct V_150 * V_599 )
{
int V_50 = 0 ;
if ( F_7 ( V_599 ) )
V_50 = F_380 ( V_6 , V_599 ) ;
else if ( F_9 ( V_599 ) )
V_50 = F_382 ( V_6 , V_599 ) ;
return V_50 ;
}
static int F_384 ( struct V_6 * V_6 )
{
int V_50 = 0 ;
if ( F_6 ( V_6 ) )
V_50 = F_381 ( V_6 ) ;
...
static int F_385 ( struct V_600 * V_601 ,
unsigned long V_602 , void * V_115 )
{
struct V_150 * V_39 = F_386 ( V_115 ) ;
struct V_603 * V_117 ;
struct V_6 * V_6 ;
int V_50 ;
if ( ! F_379 ( V_39 ) )
...
static int F_388 ( struct V_150 * V_39 , struct V_396 * V_22 )
{
struct V_6 * V_6 = F_271 ( V_39 ) ;
...
static int F_389 ( struct V_600 * V_601 ,
unsigned long V_602 , void * V_115 )
{
struct V_150 * V_39 ;
