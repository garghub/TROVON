...
struct V_1 * V_125 = V_8 -> V_1 ;
struct V_23 * V_24 ;
int V_5 ;
if ( V_123 -> V_73 != V_74 && V_123 -> V_126 ) {
if ( V_123 -> V_127 >= 0 && V_123 -> V_127 < V_107 )
V_125 -> V_128 = ~ ( 1 << V_123 -> V_127 ) ;
else
V_125 -> V_128 = 0 ;
V_5 = F_54 ( V_125 ) ;
if ( V_5 ) {
