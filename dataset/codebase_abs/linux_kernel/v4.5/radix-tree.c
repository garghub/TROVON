...
static unsigned long F_60 ( struct V_7 * V_40 , void * V_52 ,
...
unsigned long F_61 ( struct V_3 * V_4 , void * V_52 )
{
struct V_7 * V_8 ;
unsigned long V_79 ;
...
void * F_68 ( struct V_3 * V_4 , unsigned long V_39 )
{
return F_67 ( V_4 , V_39 , NULL ) ;
}
...
static T_3 unsigned long F_72 ( unsigned int V_37 )
{
...
{
unsigned int V_30 ;
for ( V_30 = 0 ; V_30 < F_74 ( V_38 ) ; V_30 ++ )
V_38 [ V_30 ] = F_72 ( V_30 ) ;
}
