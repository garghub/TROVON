...
int F_45 ( struct V_9 * V_3 , int V_5 , T_2 V_60 )
{
int V_61 ;
F_21 ( F_46 () ) ;
F_47 ( & V_3 -> V_53 , V_62 ) ;
V_61 = V_3 -> V_46 ( V_3 , V_5 , V_60 ) ;
F_48 ( & V_3 -> V_53 ) ;
return V_61 ;
}
int F_49 ( struct V_9 * V_3 , int V_5 , T_2 V_60 )
{
int V_61 ;
F_21 ( F_46 () ) ;
F_50 ( & V_3 -> V_53 ) ;
...
int F_51 ( struct V_9 * V_3 , int V_5 , T_2 V_60 , T_3 V_63 )
{
int V_44 ;
F_21 ( F_46 () ) ;
F_47 ( & V_3 -> V_53 , V_62 ) ;
V_44 = V_3 -> V_47 ( V_3 , V_5 , V_60 , V_63 ) ;
F_48 ( & V_3 -> V_53 ) ;
return V_44 ;
}
int F_52 ( struct V_9 * V_3 , int V_5 , T_2 V_60 , T_3 V_63 )
{
int V_44 ;
F_21 ( F_46 () ) ;
F_50 ( & V_3 -> V_53 ) ;
...
static int F_53 ( struct V_25 * V_26 , struct V_64 * V_65 )
{
struct V_1 * V_12 = F_54 ( V_26 ) ;
if ( F_55 ( V_26 , V_65 ) )
return 1 ;
if ( V_12 -> V_66 )
return V_12 -> V_66 ( V_26 , V_65 ) ;
return 0 ;
}
static int F_56 ( struct V_25 * V_26 )
{
struct V_1 * V_12 = F_54 ( V_26 ) ;
if ( V_12 -> V_67 && V_12 -> V_67 -> V_68 )
return V_12 -> V_67 -> V_68 ( V_26 ) ;
return 0 ;
}
static int F_57 ( struct V_25 * V_26 )
{
struct V_1 * V_12 = F_54 ( V_26 ) ;
if ( V_12 -> V_67 && V_12 -> V_67 -> V_69 )
return V_12 -> V_67 -> V_69 ( V_26 ) ;
return 0 ;
}
static int F_58 ( struct V_25 * V_26 )
{
struct V_1 * V_12 = F_54 ( V_26 ) ;
if ( V_12 -> V_67 && V_12 -> V_67 -> V_70 )
return V_12 -> V_67 -> V_70 ( V_26 ) ;
return 0 ;
}
int T_4 F_59 ( void )
{
