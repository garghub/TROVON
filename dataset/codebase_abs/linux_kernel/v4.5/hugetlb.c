...
if ( ! V_75 ) {
V_125 = F_352 ( V_66 -> V_68 ) >> F_35 ( V_8 ) ;
if ( V_161 >= V_125 )
goto V_45;
...
T_12 F_358 ( struct V_7 * V_8 , struct V_245 * V_246 ,
struct V_18 * V_19 ,
struct V_65 * V_66 ,
...
V_309 = F_359 ( ( T_12 * ) & V_308 , sizeof( V_308 ) / sizeof( T_12 ) , 0 ) ;
...
int F_360 ( struct V_245 * V_246 , struct V_18 * V_19 ,
...
V_66 = V_19 -> V_20 -> V_67 ;
V_161 = F_34 ( V_8 , V_19 , V_51 ) ;
V_309 = F_358 ( V_8 , V_246 , V_19 , V_66 , V_161 , V_51 ) ;
F_362 ( & V_224 [ V_309 ] ) ;
V_257 = F_279 ( V_259 ) ;
if ( F_283 ( V_257 ) ) {
...
long F_367 ( struct V_245 * V_246 , struct V_18 * V_19 ,
...
if ( V_321 || F_369 ( F_279 ( V_260 ) ) ||
( ( V_71 & V_323 ) &&
! F_363 ( F_279 ( V_260 ) ) ) ) {
int V_13 ;
if ( V_260 )
F_2 ( V_282 ) ;
V_13 = F_360 ( V_246 , V_19 , V_319 ,
( V_71 & V_323 ) ? V_305 : 0 ) ;
if ( ! ( V_13 & V_324 ) )
continue;
V_320 = 0 ;
...
T_9 * F_380 ( struct V_245 * V_246 , unsigned long V_144 , T_15 * V_340 )
{
...
T_11 * V_282 ;
if ( ! F_379 ( V_19 , V_144 ) )
return ( T_9 * ) F_382 ( V_246 , V_340 , V_144 ) ;
F_327 ( V_66 ) ;
...
F_2 ( V_282 ) ;
V_45:
V_260 = ( T_9 * ) F_382 ( V_246 , V_340 , V_144 ) ;
F_329 ( V_66 ) ;
return V_260 ;
}
int F_311 ( struct V_245 * V_246 , unsigned long * V_144 , T_9 * V_259 )
{
T_16 * V_344 = F_386 ( V_246 , * V_144 ) ;
T_15 * V_340 = F_387 ( V_344 , * V_144 ) ;
