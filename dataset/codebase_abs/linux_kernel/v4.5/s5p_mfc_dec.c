...
V_13 -> V_22 = V_95 ;
V_13 -> V_99 = V_90 -> V_91 ;
V_78 = F_28 ( V_32 -> V_96 , V_100 , V_13 ) ;
if ( V_78 ) {
F_15 ( L_18 ) ;
V_90 -> V_91 = 0 ;
F_22 ( & V_13 -> V_83 , V_90 ) ;
...
static int F_30 ( struct V_27 * V_27 , void * V_28 ,
struct V_89 * V_90 )
{
struct V_31 * V_32 = F_5 ( V_27 ) ;
struct V_12 * V_13 = F_12 ( V_28 ) ;
...
if ( V_13 -> V_15 == V_16 &&
V_107 -> type == V_72 ) {
V_78 = F_32 ( & V_13 -> V_81 , V_107 ) ;
} else if ( V_13 -> V_15 == V_17 &&
V_107 -> type == V_56 ) {
V_78 = F_32 ( & V_13 -> V_83 , V_107 ) ;
...
static int F_33 ( struct V_27 * V_27 , void * V_28 , struct V_106 * V_107 )
{
struct V_12 * V_13 = F_12 ( V_28 ) ;
if ( V_13 -> V_15 == V_113 ) {
F_15 ( L_25 ) ;
...
if ( V_107 -> type == V_72 )
return F_34 ( & V_13 -> V_81 , V_107 ) ;
else if ( V_107 -> type == V_56 )
return F_34 ( & V_13 -> V_83 , V_107 ) ;
return - V_52 ;
}
static int F_35 ( struct V_27 * V_27 , void * V_28 , struct V_106 * V_107 )
{
...
switch ( V_107 -> type ) {
case V_72 :
return F_36 ( & V_13 -> V_81 , V_107 , V_27 -> V_118 & V_119 ) ;
case V_56 :
V_78 = F_36 ( & V_13 -> V_83 , V_107 , V_27 -> V_118 & V_119 ) ;
if ( V_78 )
return V_78 ;
if ( V_13 -> V_15 == V_120 &&
( V_13 -> V_121 [ V_107 -> V_51 ] . V_122 & V_123 ) )
F_37 ( & V_13 -> V_124 , & V_116 ) ;
return 0 ;
default:
return - V_52 ;
}
}
static int F_38 ( struct V_27 * V_27 , void * V_28 ,
struct V_125 * V_126 )
{
struct V_12 * V_13 = F_12 ( V_28 ) ;
if ( V_126 -> type == V_72 )
return F_39 ( & V_13 -> V_81 , V_126 ) ;
if ( V_126 -> type == V_56 )
return F_39 ( & V_13 -> V_83 , V_126 ) ;
return - V_52 ;
}
...
F_13 () ;
if ( type == V_72 )
V_78 = F_41 ( & V_13 -> V_81 , type ) ;
else if ( type == V_56 )
V_78 = F_41 ( & V_13 -> V_83 , type ) ;
F_16 () ;
return V_78 ;
}
...
struct V_12 * V_13 = F_12 ( V_28 ) ;
if ( type == V_72 )
return F_43 ( & V_13 -> V_81 , type ) ;
else if ( type == V_56 )
return F_43 ( & V_13 -> V_83 , type ) ;
return - V_52 ;
}
static int F_44 ( struct V_128 * V_129 )
{
struct V_12 * V_13 = F_45 ( V_129 ) ;
switch ( V_129 -> V_130 ) {
case V_131 :
...
V_143 = F_28 ( V_32 -> V_96 , V_148 , V_13 ) ;
V_144 = V_143 >> V_149 ;
V_143 = V_143 & V_150 ;
V_145 = F_28 ( V_32 -> V_96 , V_151 , V_13 ) ;
V_146 = V_145 >> V_152 ;
V_145 = V_145 & V_153 ;
...
if ( ! V_13 -> V_81 . V_82 )
return - V_52 ;
F_49 ( & V_32 -> V_161 , V_122 ) ;
if ( F_50 ( & V_13 -> V_162 ) ) {
F_15 ( L_34 ) ;
V_13 -> V_15 = V_20 ;
if ( F_2 ( V_13 ) )
F_29 ( V_13 ) ;
F_51 ( & V_32 -> V_161 , V_122 ) ;
F_28 ( V_32 -> V_96 , V_102 , V_32 ) ;
} else {
F_15 ( L_35 ) ;
V_107 = F_52 ( V_13 -> V_162 . V_163 ,
struct V_159 , V_164 ) ;
...
static int F_53 ( struct V_166 * V_124 ,
const struct V_167 * V_168 )
{
switch ( V_168 -> type ) {
case V_117 :
return F_54 ( V_124 , V_168 , 2 , NULL ) ;
case V_169 :
return F_55 ( V_124 , V_168 ) ;
default:
return - V_52 ;
}
}
...
static int F_58 ( struct V_182 * V_183 )
{
struct V_184 * V_185 = F_59 ( V_183 ) ;
struct V_170 * V_171 = V_183 -> V_170 ;
struct V_12 * V_13 = F_12 ( V_171 -> V_176 ) ;
unsigned int V_5 ;
if ( V_171 -> type == V_56 ) {
if ( V_13 -> V_22 == V_23 )
...
if ( F_63 ( V_183 , 0 ) < V_13 -> V_70 ||
F_63 ( V_183 , 1 ) < V_13 -> V_71 ) {
F_15 ( L_40 ) ;
return - V_52 ;
}
V_5 = V_183 -> V_51 ;
V_13 -> V_121 [ V_5 ] . V_186 = V_185 ;
V_13 -> V_121 [ V_5 ] . V_187 . V_188 . V_189 =
F_62 ( V_183 , 0 ) ;
V_13 -> V_121 [ V_5 ] . V_187 . V_188 . V_190 =
F_62 ( V_183 , 1 ) ;
V_13 -> V_98 ++ ;
} else if ( V_171 -> type == V_72 ) {
if ( F_60 ( F_61 (
...
if ( F_63 ( V_183 , 0 ) < V_13 -> V_73 ) {
F_15 ( L_42 ) ;
return - V_52 ;
}
V_5 = V_183 -> V_51 ;
V_13 -> V_191 [ V_5 ] . V_186 = V_185 ;
V_13 -> V_191 [ V_5 ] . V_187 . V_192 =
F_62 ( V_183 , 0 ) ;
V_13 -> V_92 ++ ;
} else {
F_15 ( L_43 ) ;
...
static int F_64 ( struct V_170 * V_193 , unsigned int V_91 )
{
struct V_12 * V_13 = F_12 ( V_193 -> V_176 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
F_65 ( & V_13 -> V_194 ) ;
if ( V_13 -> V_15 == V_20 ||
V_13 -> V_15 == V_120 )
...
static void F_66 ( struct V_170 * V_193 )
{
unsigned long V_122 ;
struct V_12 * V_13 = F_12 ( V_193 -> V_176 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
...
if ( V_193 -> type == V_56 ) {
F_67 ( & V_13 -> V_200 , & V_13 -> V_83 ) ;
F_68 ( & V_13 -> V_200 ) ;
V_13 -> V_18 = 0 ;
V_13 -> V_201 = 1 ;
V_13 -> V_202 = 0 ;
if ( F_57 ( V_32 ) && ( V_13 -> V_15 == V_17 ) ) {
V_13 -> V_15 = V_203 ;
F_29 ( V_13 ) ;
F_28 ( V_32 -> V_96 , V_102 , V_32 ) ;
F_51 ( & V_32 -> V_161 , V_122 ) ;
...
} else if ( V_193 -> type == V_72 ) {
F_67 ( & V_13 -> V_162 , & V_13 -> V_81 ) ;
F_68 ( & V_13 -> V_162 ) ;
V_13 -> V_14 = 0 ;
}
if ( V_195 )
...
static void F_69 ( struct V_182 * V_183 )
{
struct V_170 * V_171 = V_183 -> V_170 ;
struct V_12 * V_13 = F_12 ( V_171 -> V_176 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
...
struct V_159 * V_205 ;
if ( V_171 -> type == V_72 ) {
V_205 = & V_13 -> V_191 [ V_183 -> V_51 ] ;
V_205 -> V_122 &= ~ V_165 ;
F_49 ( & V_32 -> V_161 , V_122 ) ;
F_70 ( & V_205 -> V_164 , & V_13 -> V_162 ) ;
V_13 -> V_14 ++ ;
F_51 ( & V_32 -> V_161 , V_122 ) ;
} else if ( V_171 -> type == V_56 ) {
V_205 = & V_13 -> V_121 [ V_183 -> V_51 ] ;
V_205 -> V_122 &= ~ V_165 ;
F_49 ( & V_32 -> V_161 , V_122 ) ;
F_71 ( V_183 -> V_51 , & V_13 -> V_202 ) ;
F_70 ( & V_205 -> V_164 , & V_13 -> V_200 ) ;
V_13 -> V_18 ++ ;
F_51 ( & V_32 -> V_161 , V_122 ) ;
} else {
...
const struct V_206 * F_72 ( void )
{
return & V_207 ;
}
struct V_208 * F_73 ( void )
{
return & V_209 ;
}
const struct V_210 * F_74 ( void )
{
return & V_211 ;
}
...
struct V_212 V_213 ;
int V_5 ;
F_76 ( & V_13 -> V_194 , V_214 ) ;
if ( V_13 -> V_194 . error ) {
F_15 ( L_46 ) ;
return V_13 -> V_194 . error ;
}
for ( V_5 = 0 ; V_5 < V_214 ; V_5 ++ ) {
if ( F_77 ( V_215 [ V_5 ] . V_130 ) ) {
memset ( & V_213 , 0 , sizeof( struct V_212 ) ) ;
V_213 . V_216 = & V_217 ;
V_213 . V_130 = V_215 [ V_5 ] . V_130 ;
V_213 . V_218 = V_215 [ V_5 ] . V_219 ;
V_213 . V_220 = V_215 [ V_5 ] . V_221 ;
V_213 . V_222 = V_215 [ V_5 ] . V_223 ;
V_213 . V_35 = V_215 [ V_5 ] . V_35 ;
V_213 . type = V_215 [ V_5 ] . type ;
V_213 . V_224 = V_215 [ V_5 ] . V_224 ;
V_213 . V_225 = 0 ;
V_13 -> V_226 [ V_5 ] = F_78 ( & V_13 -> V_194 ,
& V_213 , NULL ) ;
} else {
V_13 -> V_226 [ V_5 ] = F_79 ( & V_13 -> V_194 ,
& V_217 ,
V_215 [ V_5 ] . V_130 , V_215 [ V_5 ] . V_219 ,
V_215 [ V_5 ] . V_221 , V_215 [ V_5 ] . V_224 ,
V_215 [ V_5 ] . V_223 ) ;
}
if ( V_13 -> V_194 . error ) {
F_15 ( L_47 , V_5 ) ;
...
if ( V_215 [ V_5 ] . V_227 && V_13 -> V_226 [ V_5 ] )
V_13 -> V_226 [ V_5 ] -> V_122 |= V_228 ;
}
return 0 ;
}
...
V_13 -> V_74 = F_1 ( & V_3 , V_46 ) ;
if ( F_83 ( V_13 -> V_32 ) )
V_3 . V_9 . V_10 . V_11 = V_229 ;
else if ( F_57 ( V_13 -> V_32 ) )
