...
if ( F_181 ( V_50 ) < ( V_56 + sizeof( struct V_51 ) ) )
if ( F_182 ( V_50 ) ) {
F_180 ( 1 , L_11 ,
( int ) V_50 -> V_78 ) ;
F_39 ( V_50 ) ;
...
struct V_49 * V_53 ;
unsigned long V_29 ;
F_183 ( & V_11 . V_12 , V_29 ) ;
F_9 (sk, &iucv_sk_list.head)
if ( V_9 == V_143 ) {
V_7 = F_10 ( V_9 ) ;
break;
}
F_184 ( & V_11 . V_12 , V_29 ) ;
...
static int F_186 ( struct V_300 * V_278 ,
unsigned long V_301 , void * V_302 )
{
struct V_152 * V_303 = F_187 ( V_302 ) ;
struct V_8 * V_9 ;
struct V_6 * V_7 ;
switch ( V_301 ) {
case V_304 :
...
int V_10 ;
if ( V_318 ) {
F_194 ( L_13 , V_163 , sizeof( V_163 ) , & V_10 ) ;
if ( F_95 ( V_10 ) ) {
F_41 ( V_10 ) ;
V_10 = - V_132 ;
goto V_210;
}
V_100 = F_195 ( F_196 ( V_319 ) , L_14 ) ;
if ( ! V_100 ) {
F_5 ( V_5 L_15 ) ;
