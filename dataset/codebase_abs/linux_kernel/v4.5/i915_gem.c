...
if ( F_81 ( V_151 -> V_334 &&
F_137 ( V_151 -> V_334 , true ) ) ) {
V_151 -> V_187 ( V_151 ) ;
F_246 ( & V_151 -> V_334 , NULL ) ;
}
F_14 ( F_15 ( V_151 -> V_2 ) ) ;
}
bool
...
F_249 (ring, dev_priv, i) {
F_298 ( V_151 ) ;
V_335 &= F_147 ( & V_151 -> V_193 ) ;
if ( V_117 . V_298 ) {
unsigned long V_216 ;
F_299 ( & V_151 -> V_331 , V_216 ) ;
V_335 &= F_147 ( & V_151 -> V_332 ) ;
F_300 ( & V_151 -> V_331 , V_216 ) ;
F_293 ( V_151 ) ;
}
}
if ( V_335 )
...
for ( V_51 = 0 ; V_51 < V_207 ; V_51 ++ ) {
V_19 = F_311 ( V_7 , V_344 , V_159 [ V_51 ] , V_346 ) ;
if ( V_19 )
return V_19 ;
}
return 0 ;
...
static int F_320 ( struct V_33 * V_34 , bool V_170 )
{
struct V_6 * V_7 = V_34 -> V_7 ;
struct V_11 * V_12 = V_7 -> V_8 . V_2 -> V_23 ;
int V_19 ;
...
static bool F_330 ( struct V_33 * V_34 ,
unsigned long V_9 )
{
...
return true ;
V_363 = F_331 ( V_362 -> V_365 . V_366 , struct V_361 , V_365 ) ;
if ( V_363 -> V_367 && ! V_363 -> V_368 && V_363 -> V_369 != V_9 )
return false ;
V_363 = F_331 ( V_362 -> V_365 . V_72 , struct V_361 , V_365 ) ;
...
if ( V_216 & V_380 )
V_109 = F_201 ( T_14 , V_109 , ( 1ULL << 32 ) - V_53 ) ;
if ( V_371 == 0 )
...
return F_333 ( V_19 ) ;
F_79 ( V_7 ) ;
V_34 = V_355 ? F_335 ( V_7 , V_355 ) :
F_336 ( V_7 , V_284 ) ;
if ( F_24 ( V_34 ) )
goto V_382;
if ( V_216 & V_383 ) {
T_4 V_59 = V_216 & V_379 ;
if ( V_59 & ( V_371 - 1 ) || V_59 + V_13 > V_109 ) {
V_19 = - V_52 ;
goto V_384;
}
V_34 -> V_37 . V_108 = V_59 ;
V_34 -> V_37 . V_13 = V_13 ;
V_34 -> V_37 . V_369 = V_7 -> V_9 ;
V_19 = F_337 ( & V_284 -> V_14 , & V_34 -> V_37 ) ;
if ( V_19 ) {
V_19 = F_338 ( V_34 ) ;
if ( V_19 == 0 )
V_19 = F_337 ( & V_284 -> V_14 , & V_34 -> V_37 ) ;
...
V_390:
V_19 = F_339 ( & V_284 -> V_14 , & V_34 -> V_37 ,
V_13 , V_371 ,
V_7 -> V_9 ,
V_108 , V_109 ,
V_374 ,
V_375 ) ;
if ( V_19 ) {
V_19 = F_340 ( V_2 , V_284 , V_13 , V_371 ,
V_7 -> V_9 ,
V_108 , V_109 ,
V_216 ) ;
if ( V_19 == 0 )
...
if ( F_14 ( ! F_330 ( V_34 , V_7 -> V_9 ) ) ) {
V_19 = - V_52 ;
goto V_391;
}
F_341 ( V_34 , V_216 ) ;
V_19 = F_342 ( V_34 , V_7 -> V_9 , V_216 ) ;
if ( V_19 )
goto V_391;
...
V_352 ) ;
V_34 = F_347 ( V_7 ) ;
if ( V_34 && F_321 ( & V_34 -> V_37 ) && ! V_7 -> V_202 )
F_245 ( & V_34 -> V_283 ,
& F_247 ( V_7 -> V_8 . V_2 ) -> V_32 . V_8 . V_287 ) ;
return 0 ;
}
int F_348 ( struct V_6 * V_7 ,
enum V_3 V_9 )
{
struct V_1 * V_2 = V_7 -> V_8 . V_2 ;
struct V_33 * V_34 , * V_72 ;
...
int F_350 ( struct V_1 * V_2 , void * V_26 ,
struct V_27 * V_28 )
{
struct V_11 * V_12 = V_2 -> V_23 ;
struct V_395 * args = V_26 ;
...
break;
case V_399 :
if ( F_351 ( V_2 , 0 , V_403 ) )
return - V_180 ;
V_4 = V_396 ;
break;
case V_401 :
V_4 = F_352 ( V_2 ) ? V_400 : V_5 ;
break;
default:
return - V_52 ;
}
...
static int
F_355 ( struct V_1 * V_2 , struct V_27 * V_28 )
{
struct V_11 * V_12 = V_2 -> V_23 ;
struct V_189 * V_80 = V_28 -> V_190 ;
unsigned long V_406 = V_176 - V_407 ;
struct V_158 * V_195 , * V_408 = NULL ;
unsigned V_163 ;
int V_19 ;
V_19 = F_8 ( & V_12 -> V_24 ) ;
if ( V_19 )
...
if ( V_408 == NULL )
return 0 ;
V_19 = F_140 ( V_408 , V_163 , true , NULL , NULL ) ;
if ( V_19 == 0 )
...
static bool
F_356 ( struct V_33 * V_34 , T_5 V_371 , T_4 V_216 )
{
struct V_6 * V_7 = V_34 -> V_7 ;
if ( V_371 &&
...
return - V_180 ;
if ( F_14 ( V_216 & ( V_411 | V_127 ) && ! F_323 ( V_284 ) ) )
return - V_52 ;
if ( F_14 ( ( V_216 & ( V_127 | V_411 ) ) == V_127 ) )
return - V_52 ;
if ( F_14 ( F_323 ( V_284 ) != ! ! V_355 ) )
return - V_52 ;
V_34 = V_355 ? F_359 ( V_7 , V_355 ) :
F_360 ( V_7 , V_284 ) ;
if ( F_24 ( V_34 ) )
return F_25 ( V_34 ) ;
if ( V_34 ) {
if ( F_14 ( V_34 -> V_36 == V_412 ) )
return - V_75 ;
if ( F_356 ( V_34 , V_371 , V_216 ) ) {
F_145 ( V_34 -> V_36 ,
L_15
L_16
L_17 ,
V_355 ? L_18 : L_19 ,
F_361 ( V_34 -> V_37 . V_108 ) ,
F_362 ( V_34 -> V_37 . V_108 ) ,
V_371 ,
! ! ( V_216 & V_127 ) ,
V_7 -> V_359 ) ;
V_19 = F_47 ( V_34 ) ;
...
V_34 = F_332 ( V_7 , V_284 , V_355 , V_371 ,
V_216 ) ;
if ( F_24 ( V_34 ) )
return F_25 ( V_34 ) ;
} else {
...
T_4 V_216 )
{
return F_358 ( V_7 , V_284 ,
F_323 ( V_284 ) ? & V_233 : NULL ,
V_371 , V_216 ) ;
}
int
...
if ( F_207 ( ! V_232 , L_20 ) )
return - V_52 ;
return F_358 ( V_7 , F_364 ( V_7 ) , V_232 ,
V_371 , V_216 | V_411 ) ;
}
void
...
const struct V_231 * V_232 )
{
struct V_33 * V_34 = F_359 ( V_7 , V_232 ) ;
F_37 ( ! V_34 ) ;
F_14 ( V_34 -> V_36 == 0 ) ;
F_14 ( ! F_365 ( V_7 , V_232 ) ) ;
-- V_34 -> V_36 ;
}
int
...
goto V_211;
F_367 ( V_205 > 16 ) ;
args -> V_415 = V_7 -> V_202 << 16 ;
if ( V_7 -> V_203 )
args -> V_415 |= V_7 -> V_203 -> V_151 -> V_152 ;
V_211:
F_49 ( & V_7 -> V_8 ) ;
V_121:
F_19 ( & V_2 -> V_25 ) ;
...
int
F_368 ( struct V_1 * V_2 , void * V_26 ,
struct V_27 * V_80 )
{
return F_355 ( V_2 , V_80 ) ;
}
int
F_369 ( struct V_1 * V_2 , void * V_26 ,
struct V_27 * V_80 )
{
struct V_11 * V_12 = V_2 -> V_23 ;
struct V_416 * args = V_26 ;
struct V_6 * V_7 ;
int V_19 ;
switch ( args -> V_63 ) {
case V_68 :
...
static bool F_378 ( struct V_6 * V_7 )
{
if ( V_7 -> V_63 != V_71 )
return false ;
if ( V_7 -> V_8 . V_43 == NULL )
return true ;
return F_379 ( & V_7 -> V_8 . V_43 -> V_427 ) == 1 ;
}
void F_380 ( struct V_215 * V_428 )
{
struct V_6 * V_7 = F_99 ( V_428 ) ;
struct V_1 * V_2 = V_7 -> V_8 . V_2 ;
struct V_11 * V_12 = V_2 -> V_23 ;
struct V_33 * V_34 , * V_72 ;
F_118 ( V_12 ) ;
...
if ( F_14 ( V_19 == - V_184 ) ) {
bool V_429 ;
V_429 = V_12 -> V_14 . V_146 ;
V_12 -> V_14 . V_146 = false ;
F_14 ( F_47 ( V_34 ) ) ;
V_12 -> V_14 . V_146 = V_429 ;
}
}
if ( V_7 -> V_393 )
F_96 ( V_7 ) ;
...
struct V_33 * F_360 ( struct V_6 * V_7 ,
struct V_370 * V_284 )
{
struct V_33 * V_34 ;
F_18 (vma, &obj->vma_list, vma_link) {
...
const struct V_231 * V_232 )
{
struct V_370 * V_31 = F_364 ( V_7 ) ;
struct V_33 * V_34 ;
if ( F_207 ( ! V_232 , L_20 ) )
return F_333 ( - V_52 ) ;
F_18 (vma, &obj->vma_list, vma_link)
if ( V_34 -> V_284 == V_31 &&
F_384 ( & V_34 -> V_355 , V_232 ) )
return V_34 ;
return NULL ;
}
...
F_385 ( F_386 ( V_284 ) ) ;
F_169 ( & V_34 -> V_354 ) ;
F_63 ( F_247 ( V_34 -> V_7 -> V_8 . V_2 ) -> V_435 , V_34 ) ;
}
static void
...
F_387 ( V_2 ) ;
F_19 ( & V_2 -> V_25 ) ;
F_389 ( & V_12 -> V_24 . V_438 ) ;
F_389 ( & V_12 -> V_14 . V_307 ) ;
F_390 ( & V_12 -> V_14 . V_336 ) ;
...
int F_391 ( struct V_158 * V_159 , int V_439 )
{
struct V_150 * V_151 = V_159 -> V_151 ;
struct V_1 * V_2 = V_151 -> V_2 ;
struct V_11 * V_12 = V_2 -> V_23 ;
T_6 * V_440 = V_12 -> V_441 . V_440 [ V_439 ] ;
int V_51 , V_19 ;
if ( ! F_392 ( V_2 ) || ! V_440 )
return 0 ;
V_19 = F_393 ( V_159 , V_442 / 4 * 3 ) ;
if ( V_19 )
return V_19 ;
for ( V_51 = 0 ; V_51 < V_442 / 4 ; V_51 ++ ) {
F_394 ( V_151 , F_395 ( 1 ) ) ;
F_396 ( V_151 , F_397 ( V_439 , V_51 ) ) ;
F_394 ( V_151 , V_440 [ V_51 ] ) ;
}
F_398 ( V_151 ) ;
return V_19 ;
}
...
V_12 -> V_14 . V_443 == V_444 )
return;
F_400 ( V_445 , F_401 ( V_445 ) |
V_446 ) ;
if ( F_402 ( V_2 ) )
return;
F_400 ( V_447 , F_401 ( V_447 ) | V_448 ) ;
if ( F_403 ( V_2 ) )
F_400 ( V_449 , F_404 ( V_450 ) ) ;
else if ( F_405 ( V_2 ) )
F_400 ( V_449 , F_404 ( V_451 ) ) ;
else if ( F_406 ( V_2 ) )
F_400 ( V_452 , F_404 ( V_453 ) ) ;
else
F_407 () ;
}
static void F_408 ( struct V_1 * V_2 , T_6 V_8 )
{
struct V_11 * V_12 = V_2 -> V_23 ;
F_400 ( F_409 ( V_8 ) , 0 ) ;
F_400 ( F_410 ( V_8 ) , 0 ) ;
...
return 0 ;
V_463:
F_427 ( & V_12 -> V_151 [ V_464 ] ) ;
V_462:
F_427 ( & V_12 -> V_151 [ V_465 ] ) ;
V_461:
F_427 ( & V_12 -> V_151 [ V_466 ] ) ;
V_460:
F_427 ( & V_12 -> V_151 [ V_467 ] ) ;
return V_19 ;
}
int
...
struct V_150 * V_151 ;
int V_19 , V_51 , V_290 ;
if ( F_149 ( V_2 ) -> V_177 < 6 && ! F_429 () )
return - V_22 ;
F_430 ( V_12 , V_468 ) ;
if ( V_12 -> V_469 )
F_400 ( V_470 , F_401 ( V_470 ) | F_431 ( 0xf ) ) ;
if ( F_432 ( V_2 ) )
F_400 ( V_471 , F_433 ( V_2 ) ?
V_472 : V_473 ) ;
if ( F_434 ( V_2 ) ) {
if ( F_435 ( V_2 ) ) {
T_6 V_474 = F_401 ( V_475 ) ;
V_474 &= ~ ( V_476 | V_477 ) ;
F_400 ( V_475 , V_474 ) ;
} else if ( F_149 ( V_2 ) -> V_177 >= 7 ) {
T_6 V_474 = F_401 ( V_478 ) ;
V_474 &= ~ V_479 ;
F_400 ( V_478 , V_474 ) ;
}
}
...
if ( V_151 -> V_152 == V_467 ) {
for ( V_290 = 0 ; V_290 < F_440 ( V_2 ) ; V_290 ++ )
F_391 ( V_159 , V_290 ) ;
}
V_19 = F_441 ( V_159 ) ;
if ( V_19 && V_19 != - V_22 ) {
...
int F_444 ( struct V_1 * V_2 )
{
struct V_11 * V_12 = V_2 -> V_23 ;
int V_19 ;
V_117 . V_298 = F_445 ( V_2 ,
V_117 . V_298 ) ;
F_17 ( & V_2 -> V_25 ) ;
if ( ! V_117 . V_298 ) {
V_12 -> V_436 . V_481 = V_482 ;
V_12 -> V_436 . V_483 = F_417 ;
V_12 -> V_436 . V_484 = F_427 ;
V_12 -> V_436 . V_437 = V_485 ;
} else {
V_12 -> V_436 . V_481 = V_486 ;
V_12 -> V_436 . V_483 = V_487 ;
V_12 -> V_436 . V_484 = V_488 ;
V_12 -> V_436 . V_437 = V_489 ;
}
F_430 ( V_12 , V_468 ) ;
V_19 = F_446 ( V_2 ) ;
if ( V_19 )
...
if ( V_19 )
goto V_490;
V_19 = V_12 -> V_436 . V_483 ( V_2 ) ;
if ( V_19 )
goto V_490;
V_19 = F_428 ( V_2 ) ;
if ( V_19 == - V_22 ) {
F_11 ( L_25 ) ;
F_449 ( V_491 , & V_12 -> V_24 . V_163 ) ;
V_19 = 0 ;
}
V_490:
F_443 ( V_12 , V_468 ) ;
...
int V_51 ;
F_249 (ring, dev_priv, i)
V_12 -> V_436 . V_484 ( V_151 ) ;
if ( V_117 . V_298 )
F_450 ( V_2 ) ;
}
static void
F_451 ( struct V_150 * V_151 )
{
F_372 ( & V_151 -> V_282 ) ;
F_372 ( & V_151 -> V_193 ) ;
}
...
F_372 ( & V_12 -> V_493 ) ;
F_372 ( & V_12 -> V_494 ) ;
F_372 ( & V_12 -> V_14 . V_278 ) ;
F_372 ( & V_12 -> V_14 . V_286 ) ;
F_372 ( & V_12 -> V_14 . V_495 ) ;
for ( V_51 = 0 ; V_51 < V_205 ; V_51 ++ )
F_451 ( & V_12 -> V_151 [ V_51 ] ) ;
for ( V_51 = 0 ; V_51 < V_496 ; V_51 ++ )
F_372 ( & V_12 -> V_497 [ V_51 ] . V_498 ) ;
F_454 ( & V_12 -> V_14 . V_307 ,
F_303 ) ;
F_454 ( & V_12 -> V_14 . V_336 ,
F_305 ) ;
F_455 ( & V_12 -> V_24 . V_20 ) ;
V_12 -> V_499 = V_500 ;
if ( F_149 ( V_2 ) -> V_177 >= 7 && ! F_456 ( V_2 ) && ! F_457 ( V_2 ) )
V_12 -> V_501 = 32 ;
else if ( F_149 ( V_2 ) -> V_177 >= 4 || F_458 ( V_2 ) || F_459 ( V_2 ) || F_213 ( V_2 ) )
V_12 -> V_501 = 16 ;
else
V_12 -> V_501 = 8 ;
if ( F_460 ( V_2 ) )
V_12 -> V_501 =
F_401 ( F_461 ( V_502 . V_503 ) ) ;
...
F_463 ( V_12 ) ;
F_464 ( & V_12 -> V_505 . V_191 ) ;
}
void F_465 ( struct V_1 * V_2 , struct V_27 * V_28 )
{
struct V_189 * V_80 = V_28 -> V_190 ;
F_5 ( & V_80 -> V_14 . V_191 ) ;
...
F_6 ( & V_80 -> V_14 . V_191 ) ;
if ( ! F_147 ( & V_80 -> V_165 . V_506 ) ) {
F_5 ( & F_247 ( V_2 ) -> V_165 . V_507 ) ;
F_169 ( & V_80 -> V_165 . V_506 ) ;
F_6 ( & F_247 ( V_2 ) -> V_165 . V_507 ) ;
}
}
int F_466 ( struct V_1 * V_2 , struct V_27 * V_28 )
{
struct V_189 * V_80 ;
int V_19 ;
F_467 ( L_29 ) ;
V_80 = F_468 ( sizeof( * V_80 ) , V_56 ) ;
if ( ! V_80 )
return - V_57 ;
V_28 -> V_190 = V_80 ;
V_80 -> V_12 = V_2 -> V_23 ;
V_80 -> V_28 = V_28 ;
F_372 ( & V_80 -> V_165 . V_506 ) ;
F_469 ( & V_80 -> V_14 . V_191 ) ;
F_372 ( & V_80 -> V_14 . V_193 ) ;
V_19 = F_470 ( V_2 , V_28 ) ;
if ( V_19 )
F_33 ( V_80 ) ;
return V_19 ;
}
void F_471 ( struct V_6 * V_508 ,
struct V_6 * V_509 ,
unsigned V_430 )
{
if ( V_508 ) {
F_14 ( ! F_180 ( & V_508 -> V_8 . V_2 -> V_25 ) ) ;
F_14 ( ! ( V_508 -> V_430 & V_430 ) ) ;
V_508 -> V_430 &= ~ V_430 ;
}
if ( V_509 ) {
F_14 ( ! F_180 ( & V_509 -> V_8 . V_2 -> V_25 ) ) ;
F_14 ( V_509 -> V_430 & V_430 ) ;
V_509 -> V_430 |= V_430 ;
}
}
T_14 F_472 ( struct V_6 * V_510 ,
struct V_370 * V_284 )
{
struct V_11 * V_12 = V_510 -> V_8 . V_2 -> V_23 ;
struct V_33 * V_34 ;
...
F_145 ( 1 , L_30 ,
F_323 ( V_284 ) ? L_31 : L_19 ) ;
return - 1 ;
}
T_14 F_204 ( struct V_6 * V_510 ,
const struct V_231 * V_232 )
{
struct V_370 * V_31 = F_364 ( V_510 ) ;
struct V_33 * V_34 ;
F_18 (vma, &o->vma_list, vma_link)
if ( V_34 -> V_284 == V_31 &&
F_384 ( & V_34 -> V_355 , V_232 ) )
...
unsigned long F_474 ( struct V_6 * V_510 ,
struct V_370 * V_284 )
{
struct V_11 * V_12 = V_510 -> V_8 . V_2 -> V_23 ;
struct V_33 * V_34 ;
F_14 ( V_284 == & V_12 -> V_14 . V_410 -> V_8 ) ;
F_37 ( F_147 ( & V_510 -> V_360 ) ) ;
F_18 (vma, &o->vma_list, vma_link) {
if ( F_323 ( V_34 -> V_284 ) &&
V_34 -> V_355 . type != V_356 )
continue;
...
struct V_54 *
F_475 ( struct V_6 * V_7 , int V_207 )
{
struct V_54 * V_54 ;
if ( F_14 ( ( V_7 -> V_77 -> V_216 & V_511 ) == 0 ) )
return NULL ;
V_54 = F_476 ( V_7 , V_207 ) ;
F_39 ( V_54 ) ;
return V_54 ;
}
struct V_6 *
F_477 ( struct V_1 * V_2 ,
...
F_79 ( V_7 ) ;
V_50 = V_7 -> V_62 ;
V_512 = F_479 ( V_50 -> V_58 , V_50 -> V_272 , ( void * ) V_26 , V_13 ) ;
V_7 -> V_69 = 1 ;
F_96 ( V_7 ) ;
if ( F_14 ( V_512 != V_13 ) ) {
F_11 ( L_33 , V_512 , V_13 ) ;
V_19 = - V_76 ;
goto V_513;
}
return V_7 ;
