...
* V_73 = 0 ;
memset ( & V_32 , 0 , sizeof( V_32 ) ) ;
V_75 = sizeof( * V_34 ) + V_29 * sizeof( V_34 -> V_65 [ 0 ] ) ;
V_34 = F_35 ( V_75 ) ;
if ( ! V_34 )
return - V_21 ;
V_32 . V_36 . V_37 = F_10 ( V_61 ) ;
...
{
struct V_80 * V_81 = F_43 ( V_79 , struct V_80 , V_79 ) ;
struct V_1 * V_2 = V_81 -> V_2 ;
int V_35 = 0 ;
if ( V_81 -> V_29 < 0 )
V_35 = F_41 ( V_2 , V_81 -> V_5 , - 1 * V_81 -> V_29 , NULL ) ;
else if ( V_81 -> V_29 > 0 )
V_35 = F_34 ( V_2 , V_81 -> V_5 , V_81 -> V_29 , 1 ) ;
if ( V_35 )
F_19 ( V_2 , L_14 ,
V_81 -> V_29 < 0 ? L_15 : L_16 , V_35 ) ;
F_26 ( V_81 ) ;
}
...
struct V_87 * V_88 ;
int V_89 ;
V_89 = ( sizeof( V_88 -> V_34 ) + V_90 * sizeof( V_86 -> V_91 ) -
sizeof( struct V_60 ) ) /
...
{
unsigned long V_92 = V_93 + F_51 ( V_94 ) ;
struct V_13 * V_49 ;
struct V_10 * V_95 ;
int V_73 = 0 ;
int V_35 = 0 ;
do {
V_95 = F_52 ( & V_2 -> V_8 . V_9 ) ;
if ( V_95 ) {
V_49 = F_2 ( V_95 , struct V_13 , V_10 ) ;
if ( V_2 -> V_96 == V_97 ) {
F_22 ( V_2 , V_49 -> V_3 ) ;
V_73 = 1 ;
} else {
...
{
unsigned long V_92 = V_93 + F_51 ( V_99 ) ;
int V_100 = V_2 -> V_8 . V_72 ;
F_38 ( V_2 , L_24 , V_100 ,
V_2 -> V_8 . V_101 ) ;
while ( V_2 -> V_8 . V_72 ) {
if ( F_53 ( V_93 , V_92 ) ) {
F_19 ( V_2 , L_25 , V_2 -> V_8 . V_72 ) ;
return - V_102 ;
}
if ( V_2 -> V_8 . V_72 < V_100 ) {
V_92 = V_93 + F_51 ( V_99 ) ;
V_100 = V_2 -> V_8 . V_72 ;
}
F_62 ( 50 ) ;
}
F_38 ( V_2 , L_26 , V_2 -> V_8 . V_101 ) ;
return 0 ;
}
