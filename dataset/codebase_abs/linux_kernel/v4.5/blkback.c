...
V_220 = V_67 -> V_75 == V_214 ?
V_67 -> V_165 . V_166 . V_221 : V_67 -> V_75 ;
if ( ( V_67 -> V_75 == V_214 ) &&
( V_220 != V_155 ) &&
( V_220 != V_213 ) ) {
F_42 ( L_32 , V_220 ) ;
...
V_67 -> V_165 . V_166 . V_224 : V_67 -> V_165 . V_225 . V_224 ;
if ( F_50 ( V_162 == 0 && V_75 != V_223 ) ||
...
V_159 . V_81 = 0 ;
V_66 -> V_2 = V_2 ;
V_66 -> V_128 = V_67 -> V_165 . V_225 . V_128 ;
V_66 -> V_75 = V_220 ;
V_66 -> V_129 = V_173 ;
V_66 -> V_135 = V_162 ;
if ( V_67 -> V_75 != V_214 ) {
V_159 . V_84 = V_67 -> V_165 . V_225 . V_49 ;
V_159 . V_83 = V_67 -> V_165 . V_225 . V_83 ;
for ( V_10 = 0 ; V_10 < V_162 ; V_10 ++ ) {
V_42 [ V_10 ] -> V_34 = V_67 -> V_165 . V_225 . V_158 [ V_10 ] . V_34 ;
V_158 [ V_10 ] . V_171 = V_67 -> V_165 . V_225 . V_158 [ V_10 ] . V_168 -
V_67 -> V_165 . V_225 . V_158 [ V_10 ] . V_167 + 1 ;
V_158 [ V_10 ] . V_172 = ( V_67 -> V_165 . V_225 . V_158 [ V_10 ] . V_167 << 9 ) ;
if ( ( V_67 -> V_165 . V_225 . V_158 [ V_10 ] . V_168 >= ( V_170 >> 9 ) ) ||
( V_67 -> V_165 . V_225 . V_158 [ V_10 ] . V_168 <
V_67 -> V_165 . V_225 . V_158 [ V_10 ] . V_167 ) )
goto V_179;
...
V_158 [ V_10 ] . V_171 << 9 ,
V_158 [ V_10 ] . V_172 ) == 0 ) ) {
int V_228 = F_124 ( int , ( V_162 - V_10 ) , V_229 ) ;
V_194 = F_125 ( V_151 , V_228 ) ;
if ( F_50 ( V_194 == NULL ) )
goto V_230;
V_216 [ V_217 ++ ] = V_194 ;
V_194 -> V_231 = V_159 . V_86 ;
V_194 -> V_195 = V_66 ;
V_194 -> V_232 = F_108 ;
V_194 -> V_233 . V_234 = V_159 . V_83 ;
}
...
F_127 ( V_75 , V_216 [ V_10 ] ) ;
F_128 ( & V_219 ) ;
if ( V_75 == V_79 )
V_2 -> V_235 += V_159 . V_81 ;
else if ( V_75 & V_178 )
...
V_66 -> V_135 ) ;
V_179:
F_81 ( V_2 , V_67 -> V_165 . V_225 . V_128 , V_220 , V_186 ) ;
F_46 ( V_2 , V_66 ) ;
F_129 ( 1 ) ;
return - V_188 ;
V_230:
...
unsigned short V_237 , int V_238 )
{
struct V_239 V_240 ;
unsigned long V_4 ;
union V_197 * V_198 ;
...
switch ( V_2 -> V_19 -> V_206 ) {
case V_207 :
memcpy ( F_130 ( & V_198 -> V_208 , V_198 -> V_208 . V_205 ) ,
& V_240 , sizeof( V_240 ) ) ;
break;
case V_209 :
memcpy ( F_130 ( & V_198 -> V_210 , V_198 -> V_210 . V_205 ) ,
& V_240 , sizeof( V_240 ) ) ;
break;
case V_211 :
memcpy ( F_130 ( & V_198 -> V_212 , V_198 -> V_212 . V_205 ) ,
& V_240 , sizeof( V_240 ) ) ;
break;
default:
F_117 () ;
