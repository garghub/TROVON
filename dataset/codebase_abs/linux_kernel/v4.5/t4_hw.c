...
{
int V_48 , V_113 , V_216 , V_217 , V_218 ;
...
int V_48 ;
T_1 V_125 [ 2 ] ;
for ( V_48 = 0 ; V_48 < V_12 -> V_20 . V_723 . V_810 ; V_48 ++ ) {
...
switch ( V_135 ) {
case V_136 :
V_1009 = ( const char * * ) V_1002 ;
V_1010 = F_30 ( V_1002 ) ;
break;
case V_22 :
V_1009 = ( const char * * ) V_1003 ;
V_1010 = F_30 ( V_1003 ) ;
break;
case V_138 :
V_1009 = ( const char * * ) V_1004 ;
V_1010 = F_30 ( V_1004 ) ;
break;
default:
F_15 ( V_1 -> V_32 ,
...
if ( V_248 < V_1010 )
F_38 ( V_1 , L_293 , V_1009 [ V_248 ] ) ;
else
F_38 ( V_1 , L_294 , V_248 ) ;
for ( V_48 = 0 ; V_48 < F_30 ( V_1005 ) ; V_48 ++ )
F_38 ( V_1 , L_295 ,
V_1005 [ V_48 ] , F_2 ( V_1 , V_1005 [ V_48 ] ) ) ;
}
...
V_110 ) ;
V_198 . V_119 = F_51 ( F_53 ( V_198 ) ) ;
V_198 . V_38 . V_1012 . V_1013 = F_51 ( V_1014 ) ;
V_113 = F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , & V_198 ) ;
return V_113 ;
}
int F_282 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_1015 ,
enum V_1016 V_1017 , enum V_247 * V_248 )
{
int V_113 ;
struct V_1018 V_198 ;
T_1 V_11 ;
...
V_113 = F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , & V_198 ) ;
if ( V_113 < 0 ) {
if ( ( V_113 == - V_63 || V_113 == - V_64 ) && V_1020 -- > 0 )
goto V_1022;
if ( F_2 ( V_12 , V_30 ) & V_31 )
F_14 ( V_12 ) ;
return V_113 ;
}
V_11 = F_22 ( V_198 . V_1025 ) ;
V_1019 = F_289 ( V_11 ) ;
if ( V_248 ) {
if ( V_11 & V_1031 )
* V_248 = V_1032 ;
...
struct V_1044 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
F_283 ( V_198 , V_1045 , V_1024 ) ;
V_198 . V_8 = F_51 ( V_249 ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
static int F_294 ( struct V_1 * V_12 , unsigned int V_42 , int V_1046 )
{
int V_113 = 0 ;
if ( V_42 <= V_1038 ) {
struct V_1044 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
F_283 ( V_198 , V_1045 , V_1024 ) ;
V_198 . V_8 = F_51 ( V_1047 | V_1048 ) ;
V_198 . V_1049 = F_51 ( V_1050 ) ;
V_113 = F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
if ( V_113 == 0 || V_1046 ) {
F_5 ( V_12 , V_1051 , V_1052 , V_1052 ) ;
F_5 ( V_12 , V_30 , V_1053 ,
V_1053 ) ;
}
return V_113 ;
}
...
{
if ( V_249 ) {
F_5 ( V_12 , V_30 , V_1053 , 0 ) ;
if ( V_42 <= V_1038 ) {
F_5 ( V_12 , V_1051 , V_1052 , 0 ) ;
F_31 ( 100 ) ;
if ( F_293 ( V_12 , V_42 ,
V_1047 | V_1048 ) == 0 )
return 0 ;
}
F_6 ( V_12 , V_1054 , V_1047 | V_1048 ) ;
F_31 ( 2000 ) ;
} else {
int V_49 ;
F_5 ( V_12 , V_1051 , V_1052 , 0 ) ;
for ( V_49 = 0 ; V_49 < V_69 ; ) {
if ( ! ( F_2 ( V_12 , V_30 ) & V_1053 ) )
return 0 ;
F_31 ( 100 ) ;
V_49 += 100 ;
}
...
const V_68 * V_244 , unsigned int V_44 , int V_1046 )
{
const struct V_206 * V_206 = ( const struct V_206 * ) V_244 ;
int V_249 , V_113 ;
if ( ! F_112 ( V_12 , V_206 ) )
return - V_56 ;
V_113 = F_294 ( V_12 , V_42 , V_1046 ) ;
if ( V_113 < 0 && ! V_1046 )
return V_113 ;
V_113 = F_115 ( V_12 , V_244 , V_44 ) ;
if ( V_113 < 0 )
return V_113 ;
V_249 = ( ( F_22 ( V_206 -> V_655 ) & V_1055 ) == 0 ) ;
return F_295 ( V_12 , V_42 , V_249 ) ;
}
int F_296 ( struct V_1 * V_12 )
{
T_1 V_1056 , V_1057 ;
unsigned int V_1058 , V_1059 , V_1060 , V_1061 ;
V_1056 = F_2 ( V_12 , V_1062 ) ;
if ( F_12 ( V_12 -> V_20 . V_21 ) <= V_22 )
V_1061 = V_1063 ;
else
V_1061 = V_1064 ;
V_1058 = 1 << ( F_297 ( V_1056 ) + V_1061 ) ;
V_1060 = V_1058 ;
if ( ! F_13 ( V_12 -> V_20 . V_21 ) ) {
V_1057 = F_2 ( V_12 , V_1065 ) ;
V_1059 = F_298 ( V_1057 ) ;
if ( V_1059 == V_1066 )
V_1059 = 16 ;
else
V_1059 = 1 << ( V_1059 +
V_1067 ) ;
V_1060 = F_232 ( V_1058 , V_1059 ) ;
}
return V_1060 ;
}
int F_299 ( struct V_1 * V_12 , unsigned int V_1068 ,
unsigned int V_1069 )
{
unsigned int V_1070 = F_230 ( V_1068 ) - 1 ;
unsigned int V_1071 = V_1070 - 10 ;
unsigned int V_1072 = V_1069 > 64 ? 128 : 64 ;
unsigned int V_1060 = V_1069 < 32 ? 32 : V_1069 ;
unsigned int V_1073 = F_230 ( V_1060 ) - 1 ;
unsigned int V_1074 ;
F_6 ( V_12 , V_1075 ,
F_300 ( V_1071 ) |
F_301 ( V_1071 ) |
...
F_6 ( V_12 , V_1081 , V_1068 ) ;
F_6 ( V_12 , V_1082 ,
( F_2 ( V_12 , V_1082 ) + V_1060 - 1 )
& ~ ( V_1060 - 1 ) ) ;
F_6 ( V_12 , V_1083 ,
( F_2 ( V_12 , V_1083 ) + V_1060 - 1 )
& ~ ( V_1060 - 1 ) ) ;
F_6 ( V_12 , V_1084 , F_311 ( V_1070 - 12 ) ) ;
return 0 ;
}
...
unsigned int V_1085 , unsigned int V_1086 , const T_1 * V_20 ,
T_1 * V_8 , int V_677 )
{
int V_48 , V_113 ;
struct V_291 V_198 ;
...
V_113 = F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , & V_198 ) ;
if ( V_113 == 0 )
for ( V_48 = 0 , V_51 = & V_198 . V_276 [ 0 ] . V_8 ; V_48 < V_1086 ; V_48 ++ , V_51 += 2 )
* V_8 ++ = F_22 ( * V_51 ) ;
return V_113 ;
}
...
T_1 * V_8 )
{
return F_122 ( V_12 , V_42 , V_19 , V_1085 , V_1086 , V_20 , V_8 , 0 ) ;
}
int F_125 ( struct V_1 * V_12 , unsigned int V_42 ,
unsigned int V_19 , unsigned int V_1085 ,
unsigned int V_1086 , const T_1 * V_20 ,
...
return F_313 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL , V_46 ) ;
}
int F_314 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_19 ,
unsigned int V_1085 , unsigned int V_1086 , const T_1 * V_20 ,
const T_1 * V_8 )
{
return F_125 ( V_12 , V_42 , V_19 , V_1085 , V_1086 , V_20 , V_8 ,
V_69 ) ;
}
int F_315 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_19 ,
unsigned int V_1085 , unsigned int V_1087 , unsigned int V_1088 ,
unsigned int V_1089 , unsigned int V_1090 , unsigned int V_1091 ,
unsigned int V_1092 , unsigned int V_1093 , unsigned int V_1094 ,
unsigned int V_1095 , unsigned int V_1096 , unsigned int V_1097 )
{
struct V_1098 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_292 = F_51 ( F_52 ( V_1099 ) | V_117 |
V_294 | F_316 ( V_19 ) |
F_317 ( V_1085 ) ) ;
V_198 . V_295 = F_51 ( F_53 ( V_198 ) ) ;
V_198 . V_1100 = F_51 ( F_318 ( V_1089 ) |
F_319 ( V_1090 ) ) ;
V_198 . V_1101 = F_51 ( F_320 ( V_1093 ) |
F_321 ( V_1094 ) |
F_322 ( V_1087 ) ) ;
V_198 . V_1102 = F_51 ( F_323 ( V_1091 ) |
F_324 ( V_1092 ) |
F_325 ( V_1095 ) ) ;
V_198 . V_1103 = F_51 ( F_326 ( V_1096 ) |
F_327 ( V_1097 ) |
F_328 ( V_1088 ) ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
int F_329 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_324 ,
unsigned int V_19 , unsigned int V_1085 , unsigned int V_1104 , V_68 * V_1105 ,
unsigned int * V_1106 )
{
int V_113 ;
struct V_1107 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_292 = F_51 ( F_52 ( V_1108 ) | V_117 |
V_294 | V_339 |
F_330 ( V_19 ) | F_331 ( V_1085 ) ) ;
V_198 . V_1109 = F_51 ( V_1110 | F_53 ( V_198 ) ) ;
V_198 . V_1111 = F_332 ( V_324 ) ;
V_198 . V_1104 = V_1104 - 1 ;
V_113 = F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , & V_198 ) ;
if ( V_113 )
return V_113 ;
if ( V_1105 ) {
memcpy ( V_1105 , V_198 . V_1105 , sizeof( V_198 . V_1105 ) ) ;
switch ( V_1104 ) {
case 5 :
memcpy ( V_1105 + 24 , V_198 . V_1112 , sizeof( V_198 . V_1112 ) ) ;
case 4 :
memcpy ( V_1105 + 18 , V_198 . V_1113 , sizeof( V_198 . V_1113 ) ) ;
case 3 :
memcpy ( V_1105 + 12 , V_198 . V_1114 , sizeof( V_198 . V_1114 ) ) ;
case 2 :
memcpy ( V_1105 + 6 , V_198 . V_1115 , sizeof( V_198 . V_1115 ) ) ;
}
}
if ( V_1106 )
* V_1106 = F_333 ( F_116 ( V_198 . V_1116 ) ) ;
return F_334 ( F_116 ( V_198 . V_1117 ) ) ;
}
int F_335 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_19 ,
unsigned int V_1085 , unsigned int V_642 )
{
struct V_1107 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_292 = F_51 ( F_52 ( V_1108 ) |
V_117 |
V_339 |
F_330 ( V_19 ) |
F_331 ( V_1085 ) ) ;
V_198 . V_1109 = F_51 ( V_1118 | F_53 ( V_198 ) ) ;
V_198 . V_1117 = F_185 ( F_336 ( V_642 ) ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , & V_198 ) ;
}
int F_337 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_642 ,
int V_766 , int V_1119 , int V_1120 , int V_1121 , int V_1122 ,
bool V_45 )
{
struct V_1123 V_198 ;
if ( V_766 < 0 )
...
unsigned int V_642 , bool free , unsigned int V_1131 ,
const V_68 * * V_10 , T_8 * V_70 , T_3 * V_1132 , bool V_45 )
{
int V_82 , V_113 = 0 ;
struct V_1133 V_198 ;
unsigned int V_1134 = 0 ;
unsigned int V_1135 = V_12 -> V_20 . V_723 . V_1136 ;
unsigned int V_1137 = V_1131 ;
if ( V_1131 > V_1135 )
return - V_56 ;
for ( V_82 = 0 ; V_82 < V_1131 ; ) {
unsigned int V_1138 = ( V_1137 < F_30 ( V_198 . V_38 . V_1139 ) ?
V_1137 : F_30 ( V_198 . V_38 . V_1139 ) ) ;
T_4 V_1140 = F_95 ( F_92 ( struct V_1133 ,
V_38 . V_1139 [ V_1138 ] ) , 16 ) ;
struct V_1141 * V_51 ;
int V_48 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_647 = F_51 ( F_52 ( V_1142 ) |
V_117 |
V_294 |
F_345 ( free ) |
F_346 ( V_642 ) ) ;
...
F_51 ( F_347 ( free ) |
F_348 ( V_1140 ) ) ;
for ( V_48 = 0 , V_51 = V_198 . V_38 . V_1139 ; V_48 < V_1138 ; V_48 ++ , V_51 ++ ) {
V_51 -> V_1144 =
F_185 ( V_1145 |
F_349 (
V_1146 ) ) ;
memcpy ( V_51 -> V_1147 , V_10 [ V_82 + V_48 ] ,
sizeof( V_51 -> V_1147 ) ) ;
}
V_113 = F_36 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , & V_198 , V_45 ) ;
if ( V_113 && V_113 != - V_1148 )
break;
for ( V_48 = 0 , V_51 = V_198 . V_38 . V_1139 ; V_48 < V_1138 ; V_48 ++ , V_51 ++ ) {
T_8 V_689 = F_350 (
F_116 ( V_51 -> V_1144 ) ) ;
if ( V_70 )
V_70 [ V_82 + V_48 ] = ( V_689 >= V_1135 ?
0xffff : V_689 ) ;
if ( V_689 < V_1135 )
V_1134 ++ ;
else if ( V_1132 )
...
if ( V_113 == 0 || V_113 == - V_1148 )
V_113 = V_1134 ;
return V_113 ;
}
int F_351 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_642 ,
int V_70 , const V_68 * V_10 , bool V_1149 , bool V_1150 )
{
int V_113 , V_654 ;
struct V_1133 V_198 ;
struct V_1141 * V_51 = V_198 . V_38 . V_1139 ;
unsigned int V_1151 = V_12 -> V_20 . V_723 . V_1136 ;
if ( V_70 < 0 )
V_70 = V_1149 ? V_1152 : V_1146 ;
V_654 = V_1150 ? V_1153 : V_1154 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_647 = F_51 ( F_52 ( V_1142 ) |
V_117 | V_294 |
F_346 ( V_642 ) ) ;
V_198 . V_1143 = F_51 ( F_348 ( 1 ) ) ;
V_51 -> V_1144 = F_185 ( V_1145 |
F_352 ( V_654 ) |
F_349 ( V_70 ) ) ;
memcpy ( V_51 -> V_1147 , V_10 , sizeof( V_51 -> V_1147 ) ) ;
V_113 = F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , & V_198 ) ;
if ( V_113 == 0 ) {
V_113 = F_350 ( F_116 ( V_51 -> V_1144 ) ) ;
if ( V_113 >= V_1151 )
V_113 = - V_163 ;
}
return V_113 ;
}
int F_353 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_642 ,
bool V_1155 , T_3 V_1156 , bool V_45 )
{
struct V_1133 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_647 = F_51 ( F_52 ( V_1142 ) |
V_117 | V_294 |
F_354 ( V_642 ) ) ;
V_198 . V_1143 = F_51 ( V_1157 |
F_355 ( V_1155 ) |
F_348 ( 1 ) ) ;
V_198 . V_38 . V_1132 . V_1158 = F_18 ( V_1156 ) ;
return F_36 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL , V_45 ) ;
}
int F_356 ( struct V_1 * V_12 , unsigned int V_42 ,
unsigned int V_642 , bool V_1159 , bool V_1160 , bool V_1161 )
{
struct V_1162 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_647 = F_51 ( F_52 ( V_1163 ) |
V_117 | V_339 |
F_354 ( V_642 ) ) ;
V_198 . V_1164 = F_51 ( F_357 ( V_1159 ) |
F_358 ( V_1160 ) |
F_359 ( V_1161 ) |
F_53 ( V_198 ) ) ;
return F_360 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
int F_361 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_642 ,
bool V_1159 , bool V_1160 )
{
return F_356 ( V_12 , V_42 , V_642 , V_1159 , V_1160 , 0 ) ;
}
int F_362 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_642 ,
unsigned int V_1165 )
{
struct V_1162 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
...
V_117 | V_339 |
F_354 ( V_642 ) ) ;
V_198 . V_1164 = F_51 ( V_1166 | F_53 ( V_198 ) ) ;
V_198 . V_1167 = F_185 ( V_1165 ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
int F_363 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_19 ,
unsigned int V_1085 , unsigned int V_1168 , unsigned int V_1169 ,
unsigned int V_1170 , unsigned int V_1171 )
{
struct V_1172 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_292 = F_51 ( F_52 ( V_1173 ) | V_117 |
V_339 | F_364 ( V_19 ) |
F_365 ( V_1085 ) ) ;
V_198 . V_1109 = F_51 ( V_1174 | F_53 ( V_198 ) ) ;
V_198 . V_1175 = F_51 ( F_366 ( V_1168 ) ) ;
V_198 . V_1169 = F_185 ( V_1169 ) ;
V_198 . V_1170 = F_185 ( V_1170 ) ;
V_198 . V_1171 = F_185 ( V_1171 ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
int F_367 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_19 ,
unsigned int V_1085 , unsigned int V_1176 )
{
struct V_1177 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_292 = F_51 ( F_52 ( V_1178 ) |
V_117 | V_339 |
F_368 ( V_19 ) |
F_369 ( V_1085 ) ) ;
V_198 . V_1109 = F_51 ( V_1179 | F_53 ( V_198 ) ) ;
V_198 . V_1180 = F_51 ( F_370 ( V_1176 ) ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
int F_371 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_19 ,
unsigned int V_1085 , unsigned int V_1176 )
{
struct V_1181 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_292 = F_51 ( F_52 ( V_1182 ) |
V_117 | V_339 |
F_372 ( V_19 ) |
F_373 ( V_1085 ) ) ;
V_198 . V_1109 = F_51 ( V_1183 | F_53 ( V_198 ) ) ;
V_198 . V_1184 = F_51 ( F_374 ( V_1176 ) ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
int F_375 ( struct V_1 * V_12 , unsigned int V_42 , unsigned int V_19 ,
unsigned int V_1085 , unsigned int V_1176 )
{
struct V_1185 V_198 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . V_292 = F_51 ( F_52 ( V_1186 ) |
V_117 | V_339 |
F_376 ( V_19 ) |
F_377 ( V_1085 ) ) ;
V_198 . V_1109 = F_51 ( V_1187 | F_53 ( V_198 ) ) ;
V_198 . V_1180 = F_51 ( F_378 ( V_1176 ) ) ;
return F_56 ( V_12 , V_42 , & V_198 , sizeof( V_198 ) , NULL ) ;
}
int F_379 ( struct V_1 * V_12 , const T_2 * V_33 )
{
V_68 V_1188 = * ( const V_68 * ) V_33 ;
if ( V_1188 == V_338 ) {
int V_1189 = 0 , V_328 = 0 ;
const struct V_327 * V_51 = ( void * ) V_33 ;
int V_1190 = F_380 ( F_22 ( V_51 -> V_337 ) ) ;
int V_324 = V_12 -> V_1191 [ V_1190 ] ;
struct V_1192 * V_1193 = F_381 ( V_12 , V_324 ) ;
struct V_325 * V_326 = & V_1193 -> V_1194 ;
T_1 V_1195 = F_22 ( V_51 -> V_38 . V_1196 . V_1197 ) ;
int V_331 = ( V_1195 & V_1198 ) != 0 ;
T_1 V_1199 = F_382 ( V_1195 ) ;
if ( V_1195 & V_1200 )
V_328 |= V_333 ;
if ( V_1195 & V_1201 )
V_328 |= V_335 ;
if ( V_1195 & F_383 ( V_1202 ) )
V_1189 = 100 ;
else if ( V_1195 & F_383 ( V_1203 ) )
V_1189 = 1000 ;
else if ( V_1195 & F_383 ( V_1204 ) )
V_1189 = 10000 ;
else if ( V_1195 & F_383 ( V_1205 ) )
V_1189 = 40000 ;
if ( V_331 != V_326 -> V_331 || V_1189 != V_326 -> V_1189 ||
V_328 != V_326 -> V_328 ) {
V_326 -> V_331 = V_331 ;
V_326 -> V_1189 = V_1189 ;
V_326 -> V_328 = V_328 ;
V_326 -> V_342 = F_116 ( V_51 -> V_38 . V_1196 . V_1206 ) ;
F_384 ( V_12 , V_324 , V_331 ) ;
}
if ( V_1199 != V_1193 -> V_1207 ) {
V_1193 -> V_1207 = V_1199 ;
F_385 ( V_12 , V_324 ) ;
}
}
return 0 ;
}
static void F_386 ( struct V_1 * V_1 , struct V_1208 * V_51 )
{
T_8 V_8 ;
if ( F_387 ( V_1 -> V_57 ) ) {
F_388 ( V_1 -> V_57 , V_1209 , & V_8 ) ;
V_51 -> V_1189 = V_8 & V_1210 ;
V_51 -> V_1211 = ( V_8 & V_1212 ) >> 4 ;
}
}
static void F_389 ( struct V_325 * V_326 , unsigned int V_1213 )
{
V_326 -> V_342 = V_1213 ;
V_326 -> V_349 = 0 ;
V_326 -> V_1189 = 0 ;
...
int F_390 ( void T_9 * V_1216 )
{
T_1 V_634 ;
V_634 = F_391 ( V_1216 + V_635 ) ;
if ( V_634 != 0xffffffff && V_634 != V_1217 )
return 0 ;
F_31 ( 500 ) ;
V_634 = F_391 ( V_1216 + V_635 ) ;
return ( V_634 != 0xffffffff && V_634 != V_1217 ? 0 : - V_60 ) ;
}
static int F_392 ( struct V_1 * V_12 )
{
static struct V_1218 V_1219 [] = {
{ 0x150201 , 4 << 20 } ,
} ;
int V_113 ;
T_1 V_1196 ;
V_113 = F_85 ( V_12 , 1 , 1 , 0 , V_1220 ) ;
if ( ! V_113 )
V_113 = F_81 ( V_12 , 3 , 0 , 1 , & V_1196 ) ;
F_6 ( V_12 , V_186 , 0 ) ;
if ( V_113 )
return V_113 ;
for ( V_113 = 0 ; V_113 < F_30 ( V_1219 ) ; ++ V_113 )
if ( V_1219 [ V_113 ] . V_1221 == V_1196 ) {
V_12 -> V_20 . V_194 = V_1219 [ V_113 ] . V_1222 ;
V_12 -> V_20 . V_260 =
V_12 -> V_20 . V_194 / V_1223 ;
return 0 ;
}
if ( ( V_1196 & 0xff ) != 0x20 )
return - V_56 ;
V_1196 >>= 16 ;
if ( V_1196 >= 0x14 && V_1196 < 0x18 )
V_12 -> V_20 . V_260 = 1 << ( V_1196 - 16 ) ;
else if ( V_1196 == 0x18 )
V_12 -> V_20 . V_260 = 64 ;
else
return - V_56 ;
V_12 -> V_20 . V_194 = 1 << V_1196 ;
V_12 -> V_20 . V_270 =
F_2 ( V_12 , V_1051 ) & V_1224 ;
if ( V_12 -> V_20 . V_194 < V_1225 )
F_143 ( V_12 -> V_32 , L_296 ,
V_12 -> V_20 . V_194 , V_1225 ) ;
return 0 ;
}
static void F_393 ( struct V_1 * V_1 , V_68 V_147 )
{
T_8 V_8 ;
T_1 V_1226 ;
V_1226 = F_394 ( V_1 -> V_57 , V_1227 ) ;
if ( V_1226 ) {
F_395 ( V_1 -> V_57 ,
V_1226 + V_1228 , & V_8 ) ;
V_8 &= ~ V_1229 ;
...
T_10 V_1231 ;
T_1 V_1232 ;
F_386 ( V_1 , & V_1 -> V_20 . V_1233 ) ;
V_1232 = F_398 ( F_2 ( V_1 , V_1234 ) ) ;
V_113 = F_392 ( V_1 ) ;
if ( V_113 < 0 ) {
F_15 ( V_1 -> V_32 , L_297 , V_113 ) ;
return V_113 ;
}
F_395 ( V_1 -> V_57 , V_1235 , & V_1231 ) ;
V_1230 = V_1231 >> 12 ;
V_1 -> V_20 . V_21 = 0 ;
switch ( V_1230 ) {
case V_136 :
V_1 -> V_20 . V_21 |= F_399 ( V_136 , V_1232 ) ;
V_1 -> V_20 . V_723 . V_1236 = V_1237 ;
V_1 -> V_20 . V_723 . V_1136 =
V_1238 ;
V_1 -> V_20 . V_723 . V_1239 = 128 ;
V_1 -> V_20 . V_723 . V_722 = V_779 ;
V_1 -> V_20 . V_723 . V_810 = V_1240 ;
V_1 -> V_20 . V_723 . V_1241 = 128 ;
V_1 -> V_20 . V_723 . V_1242 = 2 ;
break;
case V_22 :
V_1 -> V_20 . V_21 |= F_399 ( V_22 , V_1232 ) ;
V_1 -> V_20 . V_723 . V_1236 = V_1237 | V_1243 ;
V_1 -> V_20 . V_723 . V_1136 =
V_1244 ;
V_1 -> V_20 . V_723 . V_1239 = 128 ;
V_1 -> V_20 . V_723 . V_722 = V_779 ;
...
break;
case V_138 :
V_1 -> V_20 . V_21 |= F_399 ( V_138 , V_1232 ) ;
V_1 -> V_20 . V_723 . V_1236 = 0 ;
V_1 -> V_20 . V_723 . V_1136 =
V_1244 ;
V_1 -> V_20 . V_723 . V_1239 = 256 ;
V_1 -> V_20 . V_723 . V_722 = 2 ;
V_1 -> V_20 . V_723 . V_810 = V_1245 ;
V_1 -> V_20 . V_723 . V_1241 = 256 ;
V_1 -> V_20 . V_723 . V_1242 = 3 ;
break;
default:
F_15 ( V_1 -> V_32 , L_298 ,
V_1231 ) ;
...
V_1 -> V_20 . V_1246 = V_1247 ;
F_228 ( V_1 -> V_20 . V_1248 , V_1 -> V_20 . V_1249 ) ;
V_1 -> V_20 . V_1250 = 1 ;
V_1 -> V_20 . V_278 = 1 ;
...
unsigned int * V_1255 )
{
unsigned int V_1070 , V_1068 , V_1256 , V_1257 ;
T_3 V_1258 , V_1259 ;
unsigned int V_1260 , V_1261 , V_1262 ;
if ( ! V_1253 && F_13 ( V_1 -> V_20 . V_21 ) )
return - V_56 ;
V_1070 = V_1 -> V_20 . V_1263 . V_1264 + 10 ;
V_1068 = 1 << V_1070 ;
V_1256 = ( V_1252 == V_1265
? V_1 -> V_20 . V_1263 . V_1266
: V_1 -> V_20 . V_1263 . V_1267 ) ;
V_1257 = ( 1 << V_1256 ) - 1 ;
V_1258 = ( ( T_3 ) ( V_986 >> V_1256 ) << V_1070 ) ;
V_1260 = V_986 & V_1257 ;
V_1261 = V_1260 * V_1268 ;
V_1259 = V_1258 ;
V_1262 = ( V_1261 < V_1068 ) ;
if ( V_1262 ) {
V_1259 += V_1261 ;
V_1260 = 0 ;
}
...
int F_401 ( struct V_1 * V_12 )
{
struct V_1269 * V_1270 = & V_12 -> V_20 . V_1271 ;
T_1 V_1272 ;
unsigned int V_1273 ;
struct V_1274 V_1275 ;
int V_113 ;
V_1272 =
F_2 ( V_12 , F_402 ( V_1276 , V_1277 ) ) ;
if ( V_1272 ) {
unsigned int V_1278 , V_1279 ;
V_1270 -> V_1280 = F_403 ( V_1272 ) ;
V_1270 -> V_258 = F_404 ( V_1272 ) << 4 ;
V_1279 = F_405 ( V_1272 ) ;
V_1278 = ( V_1279 + 1 ) * 128 ;
V_1270 -> V_44 = V_1278 * sizeof( struct V_1281 ) ;
return 0 ;
}
memset ( & V_1275 , 0 , sizeof( V_1275 ) ) ;
V_1275 . V_657 = F_51 ( F_52 ( V_1282 ) |
V_117 | V_118 ) ;
V_1275 . V_295 = F_51 ( F_53 ( V_1275 ) ) ;
V_113 = F_56 ( V_12 , V_12 -> V_42 , & V_1275 , sizeof( V_1275 ) ,
& V_1275 ) ;
if ( V_113 )
return V_113 ;
V_1273 =
F_22 ( V_1275 . V_1283 ) ;
V_1270 -> V_1280 = F_406 ( V_1273 ) ;
V_1270 -> V_258 = F_407 ( V_1273 ) << 4 ;
V_1270 -> V_44 = F_22 ( V_1275 . V_1284 ) ;
return 0 ;
}
int F_408 ( struct V_1 * V_1 )
{
struct V_1285 * V_1285 = & V_1 -> V_20 . V_1263 ;
T_1 V_1264 , V_1286 ;
unsigned int V_1287 , V_1288 ;
V_1264 = F_2 ( V_1 , V_1075 ) ;
V_1287 = ( V_1289 +
( V_1290 - V_1289 ) * V_1 -> V_19 ) ;
V_1285 -> V_1264 = ( ( V_1264 >> V_1287 ) & V_1291 ) ;
V_1288 = ( V_1292 +
( V_1293 - V_1292 ) * V_1 -> V_19 ) ;
V_1286 = F_2 ( V_1 , V_1294 ) ;
V_1285 -> V_1266 = ( ( V_1286 >> V_1288 ) & V_1295 ) ;
V_1286 = F_2 ( V_1 , V_1296 ) ;
V_1285 -> V_1267 = ( ( V_1286 >> V_1288 ) & V_1295 ) ;
return 0 ;
}
int F_409 ( struct V_1 * V_12 )
{
int V_1190 ;
T_1 V_11 ;
V_11 = F_2 ( V_12 , V_1297 ) ;
V_12 -> V_20 . V_782 . V_1298 = F_410 ( V_11 ) ;
V_12 -> V_20 . V_782 . V_1299 = F_411 ( V_11 ) ;
for ( V_1190 = 0 ; V_1190 < V_779 ; V_1190 ++ )
V_12 -> V_20 . V_782 . V_1300 [ V_1190 ] = V_1190 ;
if ( F_198 ( V_12 ) ) {
F_199 ( V_12 , & V_12 -> V_20 . V_782 . V_1301 , 1 ,
V_1302 , 1 ) ;
F_199 ( V_12 , & V_12 -> V_20 . V_782 . V_1303 , 1 ,
V_1304 , 1 ) ;
} else {
F_7 ( V_12 , V_682 , V_683 ,
& V_12 -> V_20 . V_782 . V_1301 , 1 ,
V_1302 ) ;
F_7 ( V_12 , V_682 , V_683 ,
& V_12 -> V_20 . V_782 . V_1303 , 1 ,
V_1304 ) ;
}
V_12 -> V_20 . V_782 . V_1305 = F_412 ( V_12 , V_1306 ) ;
V_12 -> V_20 . V_782 . V_1307 = F_412 ( V_12 , V_1308 ) ;
V_12 -> V_20 . V_782 . V_1309 = F_412 ( V_12 , V_1310 ) ;
V_12 -> V_20 . V_782 . V_1311 = F_412 ( V_12 ,
V_1312 ) ;
if ( ( V_12 -> V_20 . V_782 . V_1303 & V_1313 ) == 0 )
V_12 -> V_20 . V_782 . V_1307 = - 1 ;
return 0 ;
}
int F_412 ( const struct V_1 * V_12 , int V_1314 )
{
unsigned int V_1315 = V_12 -> V_20 . V_782 . V_1301 ;
unsigned int V_1316 ;
int V_1317 ;
if ( ( V_1315 & V_1314 ) == 0 )
return - 1 ;
for ( V_1316 = 1 , V_1317 = 0 ; V_1316 < V_1314 ; V_1316 <<= 1 ) {
switch ( V_1315 & V_1316 ) {
case V_1318 :
V_1317 += V_1319 ;
break;
case V_1310 :
...
int F_413 ( struct V_1 * V_12 , int V_42 )
{
int V_48 , V_113 ;
struct V_666 V_1334 ;
memset ( & V_1334 , 0 , sizeof( V_1334 ) ) ;
F_414 (adap, i) {
struct V_1192 * V_51 = F_381 ( V_12 , V_48 ) ;
V_1334 . V_647 =
F_51 ( F_52 ( V_667 ) |
V_117 | V_118 |
F_192 ( V_51 -> V_642 ) ) ;
V_1334 . V_295 = F_51 ( F_53 ( V_1334 ) ) ;
V_113 = F_56 ( V_12 , V_42 , & V_1334 , sizeof( V_1334 ) , & V_1334 ) ;
if ( V_113 )
return V_113 ;
V_51 -> V_1335 = F_22 ( V_1334 . V_38 . V_663 . V_668 ) ;
}
return 0 ;
}
int F_415 ( struct V_1 * V_12 , int V_42 , int V_19 , int V_1085 )
{
V_68 V_10 [ 6 ] ;
...
if ( V_113 )
return V_113 ;
V_113 = F_329 ( V_12 , V_42 , V_302 , V_19 , V_1085 , 1 , V_10 , & V_1106 ) ;
if ( V_113 < 0 )
return V_113 ;
V_51 -> V_642 = V_113 ;
V_51 -> V_1337 = V_302 ;
V_51 -> V_1338 = V_302 ;
V_51 -> V_1106 = V_1106 ;
memcpy ( V_12 -> V_324 [ V_48 ] -> V_1339 , V_10 , V_1340 ) ;
V_12 -> V_324 [ V_48 ] -> V_1341 = V_302 ;
V_113 = F_22 ( V_198 . V_38 . V_1196 . V_1197 ) ;
V_51 -> V_1342 = ( V_113 & V_1343 ) ?
F_416 ( V_113 ) : - 1 ;
V_51 -> V_825 = F_417 ( V_113 ) ;
V_51 -> V_1207 = V_1344 ;
V_1334 . V_647 =
F_51 ( F_52 ( V_667 ) |
V_117 | V_118 |
...
return V_113 ;
V_51 -> V_1335 = F_22 ( V_1334 . V_38 . V_663 . V_668 ) ;
F_389 ( & V_51 -> V_1194 , F_116 ( V_198 . V_38 . V_1196 . V_1206 ) ) ;
V_302 ++ ;
}
return 0 ;
}
void F_419 ( struct V_1 * V_12 , T_8 * V_1345 , T_8 * V_44 , T_8 * V_1346 )
{
unsigned int V_48 , V_11 ;
int V_1347 = F_13 ( V_12 -> V_20 . V_21 ) ?
V_1348 : V_1349 ;
for ( V_48 = 0 ; V_48 < V_1350 ; V_48 ++ ) {
F_6 ( V_12 , V_1351 , V_1352 |
F_420 ( V_48 ) ) ;
V_11 = F_2 ( V_12 , V_1353 ) ;
* V_1345 ++ = F_421 ( V_11 ) * 256 ;
* V_44 ++ = F_422 ( V_11 ) * 256 ;
* V_1346 ++ = F_423 ( V_11 ) * 8 ;
}
for ( V_48 = 0 ; V_48 < V_1347 ; V_48 ++ ) {
F_6 ( V_12 , V_1351 , V_1354 |
F_420 ( V_48 ) ) ;
V_11 = F_2 ( V_12 , V_1353 ) ;
* V_1345 ++ = F_421 ( V_11 ) * 256 ;
* V_44 ++ = F_422 ( V_11 ) * 256 ;
...
int F_424 ( struct V_1 * V_12 , unsigned int V_986 , T_1 * V_125 , T_4 V_197 )
{
int V_48 , V_426 , V_5 ;
unsigned int V_10 ;
const unsigned int V_192 = V_1355 * 4 ;
if ( V_986 > 5 || ( V_197 & 3 ) )
return - V_56 ;
V_10 = V_986 * V_192 ;
if ( V_197 > V_192 )
...
F_6 ( V_12 , V_1356 , F_425 ( V_10 ) |
V_1357 ) ;
V_426 = F_4 ( V_12 , V_1356 , V_1358 , 0 ,
V_5 , 1 ) ;
if ( V_426 )
return V_426 ;
* V_125 ++ = F_2 ( V_12 , V_1359 ) ;
}
F_6 ( V_12 , V_1356 , 0 ) ;
return V_48 ;
}
int F_426 ( struct V_1 * V_12 , unsigned int V_986 , T_1 * V_125 , T_4 V_197 )
{
int V_48 , V_426 ;
unsigned int V_10 , V_11 , V_192 ;
int V_1347 = F_13 ( V_12 -> V_20 . V_21 ) ?
V_1348 : V_1349 ;
if ( ( V_986 > ( V_1347 - 1 ) ) || ( V_197 & 3 ) )
return - V_56 ;
F_6 ( V_12 , V_1351 , V_1354 |
F_420 ( V_986 ) ) ;
V_11 = F_2 ( V_12 , V_1353 ) ;
...
V_197 = V_192 ;
for ( V_48 = 0 ; V_48 < V_197 ; V_48 ++ , V_10 ++ ) {
F_6 ( V_12 , V_1360 , F_427 ( V_10 ) |
V_1361 ) ;
V_426 = F_4 ( V_12 , V_1360 , V_1362 , 0 ,
2 , 1 ) ;
if ( V_426 )
return V_426 ;
* V_125 ++ = F_2 ( V_12 , V_1363 ) ;
}
F_6 ( V_12 , V_1360 , 0 ) ;
return V_48 ;
}
int F_428 ( struct V_1 * V_12 , unsigned int V_10 , unsigned int V_197 ,
unsigned int * V_7 )
{
int V_113 = 0 ;
if ( F_2 ( V_12 , V_1364 ) & V_1365 )
return - V_63 ;
for ( ; ! V_113 && V_197 -- ; V_10 += 4 ) {
F_6 ( V_12 , V_1364 , V_10 ) ;
V_113 = F_4 ( V_12 , V_1364 , V_1365 ,
0 , 5 , 2 ) ;
if ( ! V_113 )
* V_7 ++ = F_2 ( V_12 , V_1366 ) ;
}
...
int F_429 ( struct V_1 * V_12 , unsigned int V_10 , unsigned int V_197 ,
...
for ( ; ! V_113 && V_197 -- ; V_10 += 4 ) {
F_6 ( V_12 , V_1366 , * V_7 ++ ) ;
F_6 ( V_12 , V_1364 , V_10 | V_1367 ) ;
V_113 = F_4 ( V_12 , V_1364 , V_1365 ,
0 , 5 , 2 ) ;
}
return V_113 ;
}
static int F_430 ( struct V_1 * V_12 , unsigned int V_10 ,
unsigned int V_8 )
{
return F_429 ( V_12 , V_10 , 1 , & V_8 ) ;
}
int F_431 ( struct V_1 * V_12 , T_1 * V_318 , unsigned int * V_1368 )
{
int V_48 , V_113 ;
unsigned int V_303 , V_8 , V_70 ;
V_113 = F_428 ( V_12 , V_1369 , 1 , & V_303 ) ;
if ( V_113 )
return V_113 ;
if ( V_303 & V_1370 ) {
V_113 = F_430 ( V_12 , V_1369 , 0 ) ;
if ( V_113 )
return V_113 ;
}
V_113 = F_428 ( V_12 , V_1369 , 1 , & V_8 ) ;
if ( V_113 )
goto V_1371;
V_70 = F_432 ( V_8 ) ;
if ( V_1368 )
* V_1368 = V_70 ;
for ( V_48 = 0 ; V_48 < V_12 -> V_20 . V_1246 ; V_48 ++ ) {
V_113 = F_430 ( V_12 , V_1369 ,
F_433 ( V_70 ) | V_1372 ) ;
if ( V_113 )
break;
V_113 = F_428 ( V_12 , V_1369 , 1 , & V_8 ) ;
...
V_113 = F_428 ( V_12 , V_1373 , 1 , & V_318 [ V_48 ] ) ;
if ( V_113 )
break;
V_70 = ( V_70 + 1 ) & V_1374 ;
}
...
void F_434 ( struct V_1 * V_12 , T_3 * V_318 , unsigned int * V_1368 )
{
bool V_1375 ;
unsigned int V_48 , V_303 , V_8 , V_70 ;
V_303 = F_2 ( V_12 , V_1376 ) & 0xffff ;
if ( V_303 & V_1377 )
F_6 ( V_12 , V_1376 ,
V_12 -> V_20 . V_782 . V_1378 | ( V_303 ^ V_1377 ) ) ;
V_8 = F_2 ( V_12 , V_1376 ) ;
V_70 = F_435 ( V_8 ) ;
V_1375 = F_436 ( V_8 ) >= 2 && ( V_8 & V_1379 ) == 0 ;
if ( V_1375 )
V_70 = ( V_70 + 1 ) & V_1380 ;
if ( V_1368 )
* V_1368 = V_70 ;
V_8 &= 0xffff ;
V_8 &= ~ F_437 ( V_1380 ) ;
V_8 |= V_12 -> V_20 . V_782 . V_1378 ;
for ( V_48 = 0 ; V_48 < V_1381 ; V_48 ++ ) {
F_6 ( V_12 , V_1376 , F_437 ( V_70 ) | V_8 ) ;
V_318 [ V_48 ] = F_19 ( V_12 , V_1382 ) ;
V_70 = ( V_70 + 1 ) & V_1380 ;
}
if ( V_1375 )
V_318 [ V_1381 - 1 ] = ~ 0ULL ;
if ( V_303 & V_1377 )
F_6 ( V_12 , V_1376 ,
V_303 | V_12 -> V_20 . V_782 . V_1378 ) ;
}
void F_438 ( struct V_1 * V_1 ,
struct V_1383 * V_1384 )
{
V_1384 -> V_1385 = F_439 ( V_1 ) * 1000000 ;
V_1384 -> V_1386 [ 0 ] = 0 ;
V_1384 -> V_1386 [ 1 ] = 0 ;
}
void F_440 ( struct V_1 * V_1 ,
struct V_1383 * V_1384 ,
int V_1387 , int V_1388 )
{
int V_48 , V_1389 [ 2 ] ;
F_6 ( V_1 , V_1390 , 13 ) ;
V_1389 [ 0 ] = F_2 ( V_1 , V_1391 ) ;
V_1389 [ 1 ] = F_2 ( V_1 , V_1392 ) ;
for ( V_48 = 0 ; V_48 < 2 ; V_48 ++ ) {
T_1 V_1393 , V_1394 ;
if ( V_1389 [ V_48 ] < V_1384 -> V_1385 ) {
if ( V_1384 -> V_1386 [ V_48 ] >= V_1395 * V_1387 )
F_143 ( V_1 -> V_32 , L_299
L_300 ,
V_48 , V_1384 -> V_1396 [ V_48 ] ,
V_1384 -> V_1386 [ V_48 ] / V_1387 ) ;
V_1384 -> V_1386 [ V_48 ] = 0 ;
continue;
}
if ( V_1384 -> V_1386 [ V_48 ] == 0 ) {
V_1384 -> V_1386 [ V_48 ] = V_1387 ;
V_1384 -> V_1397 [ V_48 ] = 0 ;
} else {
V_1384 -> V_1386 [ V_48 ] += V_1388 ;
V_1384 -> V_1397 [ V_48 ] -= V_1388 ;
}
if ( V_1384 -> V_1386 [ V_48 ] < V_1395 * V_1387 )
continue;
if ( V_1384 -> V_1397 [ V_48 ] > 0 )
continue;
V_1384 -> V_1397 [ V_48 ] = V_1398 * V_1387 ;
F_6 ( V_1 , V_1390 , 0 ) ;
V_1393 = F_2 ( V_1 , V_1392 ) ;
V_1384 -> V_1399 [ V_48 ] = ( V_1393 >> ( V_48 * 9 ) ) & 0x3f ;
F_6 ( V_1 , V_1390 , 11 ) ;
V_1394 = F_2 ( V_1 , V_1392 ) ;
V_1384 -> V_1396 [ V_48 ] = ( V_1394 >> ( V_48 * 16 ) ) & 0xffff ;
F_143 ( V_1 -> V_32 , L_301
L_302 ,
V_48 , V_1384 -> V_1396 [ V_48 ] , V_1384 -> V_1399 [ V_48 ] ,
V_1384 -> V_1386 [ V_48 ] / V_1387 ,
V_1393 , V_1394 ) ;
F_280 ( V_1 , V_1384 -> V_1399 [ V_48 ] ) ;
}
}
