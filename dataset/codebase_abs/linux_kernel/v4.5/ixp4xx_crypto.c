...
{
V_7 -> V_110 . V_111 = sizeof( struct V_70 ) ;
return F_57 ( V_7 ) ;
}
static int F_60 ( struct V_47 * V_7 )
{
F_61 ( V_7 , sizeof( struct V_45 ) ) ;
return F_57 ( F_62 ( V_7 ) ) ;
}
...
static void F_64 ( struct V_47 * V_7 )
{
F_63 ( F_62 ( V_7 ) ) ;
}
static int F_65 ( struct V_6 * V_7 , T_3 V_112 , T_2 V_113 ,
...
static int F_70 ( struct V_6 * V_7 , int V_52 , unsigned V_48 ,
...
if ( ! V_52 )
V_38 -> V_107 |= V_138 ;
V_86 = F_65 ( V_7 , V_139 , V_131 ,
V_114 , V_132 , V_116 , V_117 ) ;
if ( V_86 )
return V_86 ;
return F_65 ( V_7 , V_140 , V_130 ,
V_114 , V_132 , V_116 , V_117 ) ;
}
...
V_40 -> V_55 = V_38 -> V_109 + sizeof( T_2 ) ;
V_40 -> V_126 = V_144 ;
...
static int F_73 ( struct V_6 * V_7 , int V_52 ,
...
static struct V_31 * F_75 ( struct V_15 * V_16 ,
struct V_163 * V_164 , unsigned V_165 ,
struct V_31 * V_32 , T_4 V_23 ,
enum V_166 V_38 )
{
for (; V_165 > 0 ; V_164 = F_76 ( V_164 ) ) {
unsigned V_167 = F_77 ( V_165 , V_164 -> V_168 ) ;
struct V_31 * V_169 ;
T_2 V_170 ;
void * V_171 ;
V_165 -= V_167 ;
V_171 = F_78 ( F_79 ( V_164 ) ) + V_164 -> V_172 ;
V_169 = F_55 ( V_39 , V_23 , & V_170 ) ;
if ( ! V_169 ) {
V_32 = NULL ;
break;
}
F_80 ( V_164 ) = F_81 ( V_16 , V_171 , V_167 , V_38 ) ;
V_32 -> V_35 = V_169 ;
V_32 -> V_36 = V_170 ;
V_32 = V_169 ;
V_32 -> V_75 = F_80 ( V_164 ) ;
V_32 -> V_37 = V_167 ;
V_32 -> V_38 = V_38 ;
}
V_32 -> V_35 = NULL ;
...
static int F_82 ( struct V_173 * V_7 , const T_3 * V_116 ,
unsigned int V_117 )
{
struct V_56 * V_57 = F_83 ( V_7 ) ;
T_2 * V_23 = & V_7 -> V_65 . V_147 ;
int V_86 ;
F_84 ( & V_57 -> V_77 ) ;
F_66 ( & V_57 -> V_76 ) ;
F_53 ( & V_57 -> V_52 ) ;
F_53 ( & V_57 -> V_79 ) ;
V_57 -> V_52 . V_107 = V_174 ;
V_57 -> V_79 . V_107 = V_174 ;
V_86 = F_73 ( & V_7 -> V_65 , 0 , V_116 , V_117 ) ;
if ( V_86 )
goto V_175;
V_86 = F_73 ( & V_7 -> V_65 , 1 , V_116 , V_117 ) ;
if ( V_86 )
goto V_175;
if ( * V_23 & V_160 ) {
if ( * V_23 & V_176 ) {
...
static int F_86 ( struct V_173 * V_7 , const T_3 * V_116 ,
unsigned int V_117 )
{
struct V_56 * V_57 = F_83 ( V_7 ) ;
if ( V_117 < V_177 )
return - V_154 ;
memcpy ( V_57 -> V_178 , V_116 + ( V_117 - V_177 ) ,
V_177 ) ;
V_117 -= V_177 ;
return F_82 ( V_7 , V_116 , V_117 ) ;
}
static int F_87 ( struct V_68 * V_42 , int V_52 )
{
struct V_173 * V_7 = F_88 ( V_42 ) ;
struct V_56 * V_57 = F_83 ( V_7 ) ;
unsigned V_179 = F_89 ( V_7 ) ;
struct V_105 * V_38 ;
struct V_1 * V_40 ;
...
V_40 -> V_141 = 0 ;
V_40 -> V_142 = V_165 ;
F_68 ( V_179 && ! V_42 -> V_184 ) ;
memcpy ( V_40 -> V_185 , V_42 -> V_184 , V_179 ) ;
if ( V_42 -> V_62 != V_42 -> V_54 ) {
struct V_31 V_186 ;
V_40 -> V_126 |= V_187 ;
V_46 -> V_54 = NULL ;
if ( ! F_75 ( V_16 , V_42 -> V_54 , V_165 , & V_186 ,
V_23 , V_188 ) )
goto V_189;
V_180 = V_190 ;
V_46 -> V_54 = V_186 . V_35 ;
V_40 -> V_64 = V_186 . V_36 ;
} else {
V_46 -> V_54 = NULL ;
}
V_46 -> V_62 = NULL ;
if ( ! F_75 ( V_16 , V_42 -> V_62 , V_165 , & V_182 ,
V_23 , V_180 ) )
goto V_191;
V_46 -> V_62 = V_182 . V_35 ;
V_40 -> V_63 = V_182 . V_36 ;
V_40 -> V_25 |= V_67 ;
F_67 ( V_102 , F_1 ( V_40 ) ) ;
F_68 ( F_69 ( V_102 ) ) ;
return - V_192 ;
...
static int F_94 ( struct V_68 * V_42 )
{
struct V_173 * V_7 = F_88 ( V_42 ) ;
struct V_56 * V_57 = F_83 ( V_7 ) ;
T_3 V_185 [ V_193 ] ;
...
static int F_95 ( struct V_41 * V_42 , int V_52 ,
int V_196 , int V_197 , T_3 * V_185 )
{
struct V_47 * V_7 = F_20 ( V_42 ) ;
struct V_56 * V_57 = F_96 ( V_7 ) ;
...
V_40 -> V_142 = V_197 ;
V_40 -> V_123 = 0 ;
V_40 -> V_124 = V_42 -> V_50 + V_51 ;
F_68 ( V_179 && ! V_42 -> V_185 ) ;
...
V_40 -> V_126 |= V_187 ;
V_180 = V_190 ;
V_32 = F_75 ( V_16 , V_42 -> V_54 , V_40 -> V_124 ,
& V_186 , V_23 , V_188 ) ;
V_46 -> V_54 = V_186 . V_35 ;
V_40 -> V_64 = V_186 . V_36 ;
if ( ! V_32 )
...
V_32 = F_75 ( V_16 , V_42 -> V_62 , V_40 -> V_124 ,
& V_182 , V_23 , V_180 ) ;
V_46 -> V_62 = V_182 . V_35 ;
V_40 -> V_63 = V_182 . V_36 ;
if ( ! V_32 )
...
struct V_56 * V_57 = F_96 ( V_7 ) ;
T_2 * V_23 = & V_7 -> V_65 . V_147 ;
unsigned V_129 = F_99 ( V_7 ) ;
int V_86 ;
if ( ! V_57 -> V_200 && ! V_57 -> V_201 )
return 0 ;
F_84 ( & V_57 -> V_77 ) ;
F_66 ( & V_57 -> V_76 ) ;
F_53 ( & V_57 -> V_52 ) ;
F_53 ( & V_57 -> V_79 ) ;
V_86 = F_73 ( & V_7 -> V_65 , 0 , V_57 -> V_202 , V_57 -> V_200 ) ;
if ( V_86 )
goto V_175;
V_86 = F_73 ( & V_7 -> V_65 , 1 , V_57 -> V_202 , V_57 -> V_200 ) ;
if ( V_86 )
goto V_175;
V_86 = F_70 ( & V_7 -> V_65 , 0 , V_48 , V_57 -> V_203 ,
V_57 -> V_201 , V_129 ) ;
if ( V_86 )
goto V_175;
V_86 = F_70 ( & V_7 -> V_65 , 1 , V_48 , V_57 -> V_203 ,
V_57 -> V_201 , V_129 ) ;
if ( V_86 )
goto V_175;
if ( * V_23 & V_160 ) {
...
{
int V_204 = F_99 ( V_7 ) >> 2 ;
if ( ( V_48 >> 2 ) < 1 || ( V_48 >> 2 ) > V_204 || ( V_48 & 3 ) )
return - V_154 ;
return F_98 ( V_7 , V_48 ) ;
}
static int F_101 ( struct V_47 * V_7 , const T_3 * V_116 ,
unsigned int V_205 )
{
struct V_56 * V_57 = F_96 ( V_7 ) ;
struct V_206 V_207 ;
if ( F_102 ( & V_207 , V_116 , V_205 ) != 0 )
goto V_208;
if ( V_207 . V_209 > sizeof( V_57 -> V_203 ) )
goto V_208;
if ( V_207 . V_210 > sizeof( V_57 -> V_202 ) )
goto V_208;
memcpy ( V_57 -> V_203 , V_207 . V_203 , V_207 . V_209 ) ;
memcpy ( V_57 -> V_202 , V_207 . V_202 , V_207 . V_210 ) ;
V_57 -> V_201 = V_207 . V_209 ;
V_57 -> V_200 = V_207 . V_210 ;
...
{
return F_95 ( V_42 , 1 , V_42 -> V_50 , V_42 -> V_51 , V_42 -> V_185 ) ;
}
static int F_105 ( struct V_41 * V_42 )
{
return F_95 ( V_42 , 0 , V_42 -> V_50 , V_42 -> V_51 , V_42 -> V_185 ) ;
}
static int T_5 F_106 ( void )
{
int V_211 = F_107 ( V_212 ) ;
int V_21 , V_100 ;
V_17 = F_108 ( & V_213 ) ;
if ( F_109 ( V_17 ) )
return F_110 ( V_17 ) ;
...
struct V_214 * V_215 = & V_212 [ V_21 ] . V_10 ;
if ( snprintf ( V_215 -> V_216 , V_217 ,
L_10 V_218 , V_215 -> V_219 ) >=
V_217 )
{
continue;
}
if ( ! V_98 && ( V_212 [ V_21 ] . V_11 & V_149 ) ) {
continue;
}
V_215 -> V_220 = & V_221 ;
V_215 -> V_222 = V_223 |
...
V_215 -> V_226 . V_227 = F_82 ;
if ( ! V_215 -> V_226 . V_52 )
V_215 -> V_226 . V_52 = F_92 ;
if ( ! V_215 -> V_226 . V_79 )
V_215 -> V_226 . V_79 = F_93 ;
V_215 -> V_228 = F_59 ;
V_215 -> V_229 = sizeof( struct V_56 ) ;
V_215 -> V_230 = V_231 ;
V_215 -> V_232 = 3 ;
V_215 -> V_233 = 300 ;
V_215 -> V_234 = F_63 ;
...
for ( V_21 = 0 ; V_21 < F_107 ( V_236 ) ; V_21 ++ ) {
struct V_237 * V_215 = & V_236 [ V_21 ] . V_10 ;
if ( snprintf ( V_215 -> V_65 . V_216 , V_217 ,
L_10 V_218 , V_215 -> V_65 . V_219 ) >=
V_217 )
continue;
if ( ! V_98 && ( V_212 [ V_21 ] . V_11 & V_149 ) )
continue;
V_215 -> V_65 . V_222 = V_224 |
V_225 ;
V_215 -> V_227 = F_101 ;
V_215 -> V_238 = F_100 ;
V_215 -> V_52 = F_104 ;
...
V_215 -> V_239 = F_60 ;
V_215 -> exit = F_64 ;
V_215 -> V_65 . V_229 = sizeof( struct V_56 ) ;
V_215 -> V_65 . V_230 = V_231 ;
V_215 -> V_65 . V_232 = 3 ;
V_215 -> V_65 . V_233 = 300 ;
if ( F_114 ( V_215 ) )
F_34 ( V_93 L_11 ,
V_215 -> V_65 . V_216 ) ;
else
...
for ( V_21 = 0 ; V_21 < F_107 ( V_236 ) ; V_21 ++ ) {
if ( V_236 [ V_21 ] . V_235 )
F_116 ( & V_236 [ V_21 ] . V_10 ) ;
}
for ( V_21 = 0 ; V_21 < V_211 ; V_21 ++ ) {
if ( V_212 [ V_21 ] . V_235 )
F_117 ( & V_212 [ V_21 ] . V_10 ) ;
}
F_49 ( & V_17 -> V_16 ) ;
F_112 ( V_17 ) ;
}
