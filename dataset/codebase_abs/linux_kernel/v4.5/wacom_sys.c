...
{
struct V_1 * V_2 = F_50 ( V_19 ) ;
struct V_14 * V_14 = F_6 ( V_2 ) ;
unsigned int V_40 ;
int V_153 ;
V_153 = F_51 ( V_3 , 10 , & V_40 ) ;
if ( V_153 )
return V_153 ;
F_38 ( & V_14 -> V_154 ) ;
...
static T_3 F_52 ( struct V_14 * V_14 , T_1 * V_155 ,
const char * V_3 , T_2 V_152 )
{
unsigned int V_79 ;
int V_153 ;
V_153 = F_51 ( V_3 , 10 , & V_79 ) ;
if ( V_153 )
return V_153 ;
F_38 ( & V_14 -> V_154 ) ;
* V_155 = V_79 & 0x7f ;
...
static T_3 F_53 ( struct V_150 * V_19 , int V_144 ,
const char * V_3 , T_2 V_152 )
{
struct V_1 * V_2 = F_50 ( V_19 ) ;
struct V_14 * V_14 = F_6 ( V_2 ) ;
...
static int F_54 ( struct V_14 * V_14 )
{
int error ;
...
V_14 -> V_134 . V_142 = 20 ;
V_14 -> V_134 . V_143 = 10 ;
error = F_55 ( & V_14 -> V_2 -> V_19 . V_163 ,
& V_164 ) ;
break;
case V_141 :
case V_140 :
...
static void F_56 ( struct V_14 * V_14 )
{
if ( ! V_14 -> V_171 )
return;
if ( ! ( V_14 -> V_16 . V_33 . V_50 & V_159 ) )
...
V_201 -> V_211 = 0 ;
V_203 -> V_204 = V_212 ;
V_203 -> V_206 = F_64 ( V_212 ) ;
V_203 -> V_207 = F_60 ;
sprintf ( V_14 -> V_16 . V_213 , L_11 , V_197 ) ;
V_203 -> V_209 = V_14 -> V_16 . V_213 ;
V_203 -> type = V_214 ;
V_203 -> V_211 = 0 ;
V_14 -> V_215 = F_65 ( & V_14 -> V_2 -> V_19 ,
& V_14 -> V_202 , & V_195 ) ;
if ( F_66 ( V_14 -> V_215 ) )
return F_67 ( V_14 -> V_215 ) ;
F_68 ( V_14 -> V_215 , & V_14 -> V_2 -> V_19 ) ;
V_14 -> V_216 = F_65 ( & V_14 -> V_2 -> V_19 ,
& V_14 -> V_203 ,
& V_195 ) ;
if ( F_66 ( V_14 -> V_216 ) ) {
F_69 ( V_14 -> V_215 ) ;
return F_67 ( V_14 -> V_216 ) ;
}
F_68 ( V_14 -> V_216 , & V_14 -> V_2 -> V_19 ) ;
}
return 0 ;
}
...
static T_3 F_72 ( struct V_150 * V_19 ,
struct V_217 * V_218 ,
const char * V_3 , T_2 V_152 )
{
struct V_1 * V_2 = F_50 ( V_19 ) ;
...
static T_3 F_74 ( struct V_221 * V_163 ,
struct V_222 * V_223 ,
char * V_3 , int V_224 )
{
struct V_150 * V_19 = F_75 ( V_163 -> V_225 ) ;
struct V_1 * V_2 = F_50 ( V_19 ) ;
struct V_14 * V_14 = F_6 ( V_2 ) ;
T_1 V_82 ;
...
int F_76 ( struct V_14 * V_14 , T_5 V_226 , int V_224 )
{
int error = 0 ;
char * V_3 ;
struct V_16 * V_16 = & V_14 -> V_16 ;
...
void F_78 ( struct V_14 * V_14 , T_5 V_226 )
{
struct V_16 * V_16 = & V_14 -> V_16 ;
int V_70 ;
if ( ! V_226 )
...
static int F_79 ( struct V_14 * V_14 , unsigned char V_232 )
{
const T_2 V_129 = 2 ;
unsigned char * V_3 ;
int V_6 ;
...
static T_3 F_80 ( struct V_221 * V_163 ,
struct V_222 * V_218 ,
const char * V_3 , T_2 V_152 )
{
...
V_14 -> V_228 [ 3 ] = V_240 ;
V_14 -> V_228 [ 4 ] = V_241 ;
V_14 -> V_229 = F_83 ( L_17 ,
& V_14 -> V_2 -> V_19 . V_163 ) ;
if ( ! V_14 -> V_229 )
return - V_84 ;
error = F_84 ( V_14 -> V_229 , V_242 ) ;
if ( error ) {
F_3 ( V_14 -> V_2 ,
L_9 , error ) ;
return error ;
...
static struct V_18 * F_85 ( struct V_14 * V_14 )
{
struct V_18 * V_18 ;
...
if ( V_14 -> V_16 . V_248 ) {
if ( V_14 -> V_16 . V_249 )
F_89 ( V_14 -> V_16 . V_248 ) ;
else
F_90 ( V_14 -> V_16 . V_248 ) ;
}
if ( V_14 -> V_16 . V_65 ) {
if ( V_14 -> V_16 . V_250 )
F_89 ( V_14 -> V_16 . V_65 ) ;
...
if ( V_14 -> V_16 . V_251 ) {
if ( V_14 -> V_16 . V_252 )
F_89 ( V_14 -> V_16 . V_251 ) ;
else
F_90 ( V_14 -> V_16 . V_251 ) ;
}
F_77 ( V_14 -> V_229 ) ;
...
{
struct V_16 * V_16 = & ( V_14 -> V_16 ) ;
V_16 -> V_248 = F_85 ( V_14 ) ;
V_16 -> V_65 = F_85 ( V_14 ) ;
V_16 -> V_251 = F_85 ( V_14 ) ;
...
static void F_99 ( struct V_266 * V_267 )
{
...
int error ;
F_70 ( V_14 ) ;
V_270 = F_100 ( V_269 -> V_276 -> V_277 [ 1 ] ) ;
V_272 = F_6 ( V_270 ) ;
V_274 = & ( V_272 -> V_16 ) ;
F_88 ( V_272 ) ;
V_271 = F_100 ( V_269 -> V_276 -> V_277 [ 2 ] ) ;
V_273 = F_6 ( V_271 ) ;
V_275 = & ( V_273 -> V_16 ) ;
F_88 ( V_273 ) ;
if ( V_16 -> V_113 == 0 ) {
...
T_2 V_289 = F_103 ( V_12 ) ;
if ( V_289 > V_4 )
V_4 = V_289 ;
}
return V_4 ;
}
static void F_104 ( struct V_14 * V_14 )
{
struct V_16 * V_16 = & V_14 -> V_16 ;
...
F_105 ( V_209 , V_14 -> V_2 -> V_209 , sizeof( V_209 ) ) ;
while ( 1 ) {
...
F_105 ( V_209 , V_33 -> V_209 , sizeof( V_209 ) ) ;
}
...
{
struct V_98 * V_99 = F_107 ( V_2 -> V_19 . V_225 ) ;
struct V_268 * V_19 = F_108 ( V_99 ) ;
struct V_14 * V_14 ;
struct V_16 * V_16 ;
struct V_32 * V_33 ;
int error ;
