...
static int F_48 ( struct V_33 * V_1 , struct V_82 * V_83 , V_4 V_16 )
{
struct V_58 * V_63 ;
struct V_12 * V_13 = F_16 ( V_1 -> V_2 ) ;
int V_40 ;
...
return - V_86 ;
if ( V_83 -> V_87 ) {
V_40 = F_11 ( V_13 , V_83 -> V_87 , V_83 -> V_88 ) ;
if ( V_40 < 0 ) {
F_27 ( L_12 , V_40 ) ;
return V_40 ;
}
...
static int F_51 ( struct V_33 * V_1 , int V_89 , int V_90 ,
char T_4 * V_91 , unsigned int V_92 )
{
struct V_12 * V_13 = F_16 ( V_1 -> V_2 ) ;
unsigned int V_93 ;
int V_40 ;
F_4 ( L_15 , V_89 , V_90 , V_92 ) ;
F_17 ( & V_13 -> V_2 ) ;
V_40 = - V_86 ;
if ( V_89 == V_94 ) {
switch ( V_90 ) {
...
if ( V_13 -> V_2 . V_41 != V_42 )
goto error;
V_40 = F_54 ( V_13 , V_91 , V_92 ) ;
goto error;
case V_100 :
V_40 = - V_17 ;
if ( V_92 != sizeof( unsigned int ) )
goto error;
V_40 = - V_80 ;
if ( V_13 -> V_2 . V_41 != V_42 )
goto error;
V_40 = F_55 ( V_93 ,
( unsigned int T_4 * ) V_91 ) ;
if ( V_40 < 0 )
goto error;
V_40 = - V_17 ;
if ( V_93 > V_101 )
...
static unsigned int F_56 ( struct V_102 * V_102 , struct V_33 * V_1 ,
T_5 * V_9 )
{
unsigned int V_103 ;
struct V_1 * V_2 = V_1 -> V_2 ;
F_57 ( V_102 , F_58 ( V_2 ) , V_9 ) ;
V_103 = 0 ;
if ( ! F_59 ( & V_2 -> V_104 ) )
V_103 |= V_105 | V_106 ;
if ( F_1 ( V_2 ) )
...
static int F_60 ( struct V_109 * V_109 , struct V_33 * V_1 , int V_110 ,
int V_111 )
{
struct V_12 * V_13 ;
struct V_1 * V_2 ;
...
V_1 -> V_115 = & V_116 ;
V_1 -> V_117 = V_118 ;
V_2 = F_62 ( V_109 , V_119 , V_81 , & V_120 , V_111 ) ;
if ( ! V_2 )
return - V_121 ;
F_63 ( V_1 , V_2 ) ;
V_2 -> V_41 = V_42 ;
...
{
struct V_12 * V_13 = F_16 ( V_2 ) ;
F_4 ( L_18 , V_2 , V_2 -> V_41 , F_2 ( & V_2 -> V_133 ) ) ;
F_72 ( V_2 ) ;
V_2 -> V_134 = V_135 ;
F_73 ( & V_2 -> V_104 . V_136 ) ;
V_2 -> V_41 = V_137 ;
F_74 ( & V_2 -> V_104 . V_136 ) ;
F_47 ( V_13 -> V_47 . V_138 , != , V_139 ) ;
if ( ! F_75 ( & V_13 -> V_47 ) ) {
F_22 ( & V_13 -> V_37 -> V_45 ) ;
F_76 ( & V_13 -> V_47 ) ;
F_25 ( & V_13 -> V_37 -> V_45 ) ;
...
{
int V_40 = - 1 ;
F_85 ( sizeof( struct V_143 ) > F_86 ( struct V_144 , V_145 ) ) ;
V_146 = F_87 ( F_88 () ) ;
V_40 = - V_121 ;
V_147 = F_89 (
...
#ifdef F_95
F_96 ( L_29 , 0 , V_112 . V_161 , & V_162 ) ;
F_96 ( L_30 , 0 , V_112 . V_161 ,
& V_163 ) ;
#endif
return 0 ;
V_160:
...
F_13 ( L_31 ) ;
F_78 ( V_140 ) ;
F_109 ( L_30 , V_112 . V_161 ) ;
F_109 ( L_29 , V_112 . V_161 ) ;
F_100 ( V_140 ) ;
F_101 ( V_147 ) ;
F_27 ( L_11 ) ;
}
