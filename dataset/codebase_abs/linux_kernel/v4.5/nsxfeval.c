...
V_70 = strcmp ( V_66 -> string , V_21 -> V_66 ) ;
F_27 ( V_66 ) ;
if ( V_70 ) {
V_8 = F_37 ( V_40 , & V_68 ) ;
if ( V_8 == V_71 ) {
...
V_69 = FALSE ;
for ( V_23 = 0 ; V_23 < V_68 -> V_29 ; V_23 ++ ) {
if ( strcmp ( V_68 -> V_73 [ V_23 ] . string , V_21 -> V_66 ) == 0 ) {
V_69 = TRUE ;
break;
}
}
...
V_8 = V_21 -> V_76 ( V_61 , V_62 ,
V_21 -> V_53 , V_54 ) ;
return ( V_8 ) ;
}
T_1
F_39 ( const char * V_77 ,
T_8 V_76 ,
void * V_53 , void * * V_54 )
{
T_1 V_8 ;
...
V_8 = F_41 ( V_40 , V_81 , V_82 ) ;
V_58:
( void ) F_33 ( V_57 ) ;
return ( V_8 ) ;
}
T_1
F_42 ( T_2 V_61 , T_9 V_81 )
{
struct V_39 * V_40 ;
T_1 V_8 ;
if ( ! V_61 || ! V_81 ) {
...
T_1
F_44 ( T_2 V_61 , T_9 V_81 ,
void * * V_82 , void (* F_45)( void * ) )
{
struct V_39 * V_40 ;
T_1 V_8 ;
if ( ! V_61 || ! V_81 || ! V_82 ) {
...
T_1
F_47 ( T_2 V_61 , T_9 V_81 , void * * V_82 )
{
return F_44 ( V_61 , V_81 , V_82 , NULL ) ;
}
