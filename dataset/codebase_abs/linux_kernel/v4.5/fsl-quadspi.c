...
struct V_160 * V_22 = & V_156 -> V_22 ;
struct V_1 * V_2 ;
struct V_161 * V_162 ;
struct V_95 * V_54 ;
struct V_163 * V_149 ;
int V_101 , V_31 = 0 ;
V_2 = F_52 ( V_22 , sizeof( * V_2 ) , V_164 ) ;
if ( ! V_2 )
return - V_147 ;
V_2 -> V_165 = F_53 ( V_22 -> V_159 ) ;
if ( ! V_2 -> V_165 || V_2 -> V_165 > V_166 )
return - V_167 ;
V_2 -> V_22 = V_22 ;
V_2 -> V_3 = F_54 ( V_22 ) ;
if ( ! V_2 -> V_3 )
return - V_167 ;
F_55 ( V_156 , V_2 ) ;
V_162 = F_56 ( V_156 , V_168 , L_12 ) ;
V_2 -> V_11 = F_57 ( V_22 , V_162 ) ;
if ( F_58 ( V_2 -> V_11 ) )
return F_59 ( V_2 -> V_11 ) ;
V_162 = F_56 ( V_156 , V_168 ,
L_13 ) ;
if ( ! F_60 ( V_22 , V_162 -> V_169 , F_61 ( V_162 ) ,
V_162 -> V_170 ) ) {
F_19 ( V_22 , L_14 , V_162 ) ;
return - V_171 ;
}
V_2 -> V_78 = V_162 -> V_169 ;
...
V_54 -> V_180 = F_47 ;
V_54 -> V_181 = F_50 ;
V_101 = F_69 ( V_158 , L_21 ,
& V_2 -> V_138 ) ;
if ( V_101 < 0 )
goto V_182;
F_39 ( V_2 , V_54 ) ;
V_101 = F_70 ( V_54 , NULL , V_183 ) ;
if ( V_101 )
goto V_182;
V_101 = F_71 ( V_149 , NULL , 0 ) ;
if ( V_101 )
goto V_182;
if ( V_2 -> V_35 == 0 ) {
V_2 -> V_35 = V_149 -> V_184 ;
F_28 ( V_2 ) ;
}
if ( V_54 -> V_185 > V_2 -> V_3 -> V_186 )
V_54 -> V_185 = V_2 -> V_3 -> V_186 ;
V_31 ++ ;
}
V_101 = F_38 ( V_2 ) ;
if ( V_101 )
...
return 0 ;
V_187:
for ( V_31 = 0 ; V_31 < V_2 -> V_165 ; V_31 ++ ) {
if ( ! V_2 -> V_174 )
V_31 *= 2 ;
F_72 ( & V_2 -> V_54 [ V_31 ] . V_149 ) ;
}
V_182:
F_73 ( & V_2 -> V_153 ) ;
V_173:
...
static int F_76 ( struct V_155 * V_156 , T_8 V_188 )
{
return 0 ;
}
