...
const struct V_13 * V_14 = V_8 -> V_11 . V_15 ;
unsigned int V_16 , V_17 ;
V_16 = V_10 -> V_18 * V_10 -> V_19 ;
if ( V_14 == NULL )
return - V_20 ;
* V_3 = F_3 ( V_21 , * V_3 , V_22 ,
V_23 ) ;
if ( * V_4 ) {
if ( * V_4 != V_14 -> V_24 )
return - V_20 ;
for ( V_17 = 0 ; V_17 < * V_4 ; V_17 ++ ) {
if ( V_5 [ V_17 ] < ( V_16 * V_14 -> V_25 [ V_17 ] ) / 8 )
return - V_20 ;
V_6 [ V_17 ] = V_8 -> V_26 ;
}
return 0 ;
...
* V_4 = V_14 -> V_24 ;
for ( V_17 = 0 ; V_17 < V_14 -> V_24 ; V_17 ++ ) {
V_5 [ V_17 ] = ( V_16 * V_14 -> V_25 [ V_17 ] ) / 8 ;
V_6 [ V_17 ] = V_8 -> V_26 ;
}
return 0 ;
}
...
{
return & F_5 ( V_29 ) -> V_8 . V_30 ;
}
static int F_6 ( struct V_1 * V_31 ,
unsigned int V_32 )
{
struct V_7 * V_8 = F_2 ( V_31 ) ;
struct V_28 * V_29 = F_7 ( V_8 ) ;
struct V_27 * V_33 = F_4 ( V_29 ) ;
struct V_34 * V_35 = & V_8 -> V_11 ;
int V_36 ;
if ( ! F_8 ( V_37 , & V_8 -> V_38 ) ||
F_8 ( V_39 , & V_8 -> V_38 ) )
return 0 ;
V_33 -> V_40 = V_41 ;
V_33 -> V_42 = V_43 ;
...
struct V_27 * V_33 = F_4 ( V_29 ) ;
int V_36 ;
V_36 = F_14 ( & V_8 -> V_11 . V_51 , V_55 , 0 ) ;
if ( V_36 < 0 )
return;
V_33 -> V_40 = V_56 ;
V_33 -> V_42 = V_57 ;
...
{
struct V_7 * V_8 = F_2 ( V_62 -> V_1 ) ;
struct V_34 * V_35 = & V_8 -> V_11 ;
int V_17 ;
if ( V_35 -> V_15 == NULL )
return - V_20 ;
for ( V_17 = 0 ; V_17 < V_35 -> V_15 -> V_24 ; V_17 ++ ) {
unsigned long V_63 = V_35 -> V_12 . V_64 [ V_17 ] . V_65 ;
if ( F_21 ( V_62 , V_17 ) < V_63 ) {
F_22 ( & V_35 -> V_51 . V_52 ,
L_3 ,
F_21 ( V_62 , V_17 ) , V_63 ) ;
return - V_20 ;
...
int V_17 ;
for ( V_17 = 0 ; V_17 < V_35 -> V_53 ; V_17 ++ )
if ( V_35 -> V_67 [ V_17 ] -> V_66 [ 0 ] == V_66 )
return 0 ;
return - V_68 ;
}
return 0 ;
...
unsigned int V_4 = V_35 -> V_15 -> V_24 ;
V_72 -> V_75 = V_35 -> V_53 ;
V_35 -> V_67 [ V_72 -> V_75 ] = V_72 ;
for ( V_17 = 0 ; V_17 < V_4 ; V_17 ++ ) {
int V_76 = V_72 -> V_75 * V_4 + V_17 ;
V_72 -> V_66 [ V_17 ] = F_24 ( V_62 , V_17 ) ;
V_29 -> V_77 -> V_78 [ 32 + V_76 ] =
V_72 -> V_66 [ V_17 ] ;
F_9 ( 2 , & V_35 -> V_51 . V_52 ,
L_4 ,
V_76 , V_72 -> V_75 , V_17 , V_62 -> V_75 ,
& V_72 -> V_66 [ V_17 ] ) ;
}
...
if ( ! F_8 ( V_39 , & V_8 -> V_38 ) )
F_6 ( V_62 -> V_1 , 0 ) ;
}
void F_31 ( struct V_28 * V_29 )
{
struct V_34 * V_35 = & V_29 -> V_8 . V_11 ;
struct V_69 * V_70 ;
int V_76 ;
if ( ! F_8 ( V_39 , & V_29 -> V_8 . V_38 ) )
return;
...
{
struct V_7 * V_8 = F_35 ( V_83 ) ;
struct V_84 * V_51 = & V_8 -> V_11 . V_51 ;
...
{
struct V_7 * V_8 = F_35 ( V_83 ) ;
F_48 ( & V_8 -> V_58 -> V_59 , V_103 , V_104 ) ;
return 0 ;
}
...
if ( V_106 -> V_75 >= V_107 )
return - V_20 ;
V_14 = F_50 ( NULL , NULL , V_106 -> V_75 ) ;
if ( F_51 ( V_14 == NULL ) )
return - V_20 ;
F_52 ( V_106 -> V_108 , V_14 -> V_109 , sizeof( V_106 -> V_108 ) ) ;
V_106 -> V_110 = V_14 -> V_111 ;
return 0 ;
}
...
{
struct V_7 * V_8 = F_35 ( V_83 ) ;
V_106 -> V_14 . V_114 = V_8 -> V_11 . V_12 ;
return 0 ;
}
...
const struct V_13 * * V_14 )
{
* V_14 = F_50 ( & V_115 -> V_110 , NULL , 2 ) ;
V_115 -> V_116 = V_117 ;
V_115 -> V_118 = V_119 ;
V_115 -> V_4 = ( * V_14 ) -> V_24 ;
V_115 -> V_110 = ( * V_14 ) -> V_111 ;
F_55 ( & V_115 -> V_18 , V_120 ,
V_121 , 3 ,
& V_115 -> V_19 , V_122 ,
V_123 , 0 , 0 ) ;
}
...
{
struct V_7 * V_8 = F_35 ( V_83 ) ;
F_54 ( V_8 , & V_106 -> V_14 . V_114 , NULL ) ;
return 0 ;
}
...
struct V_7 * V_8 = F_35 ( V_83 ) ;
struct V_28 * V_29 = F_7 ( V_8 ) ;
struct V_9 * V_115 = & V_106 -> V_14 . V_114 ;
const struct V_13 * V_124 = NULL ;
struct V_27 * V_33 = F_4 ( V_29 ) ;
F_54 ( V_8 , V_115 , & V_124 ) ;
if ( F_51 ( V_124 == NULL ) )
return - V_20 ;
V_33 -> V_15 = V_125 ;
V_33 -> V_126 = V_127 ;
V_33 -> V_128 = V_124 -> V_24 ;
V_33 -> V_129 = V_124 -> V_25 [ 0 ] ;
V_33 -> V_18 = V_115 -> V_18 ;
...
if ( V_36 < 0 && V_36 != - V_143 )
return - V_144 ;
if ( V_135 . V_15 . V_18 != V_134 . V_15 . V_18 ||
V_135 . V_15 . V_19 != V_134 . V_15 . V_19 ||
V_135 . V_15 . V_145 != V_134 . V_15 . V_145 )
return - V_144 ;
}
return 0 ;
}
...
if ( V_36 < 0 )
return V_36 ;
if ( V_151 -> V_32 && V_151 -> V_32 < V_22 ) {
V_151 -> V_32 = 0 ;
F_69 ( V_83 , V_101 , V_151 ) ;
V_36 = - V_152 ;
}
V_8 -> V_11 . V_48 = V_151 -> V_32 ;
return V_36 ;
}
...
enum V_146 type )
{
struct V_1 * V_31 = & V_8 -> V_11 . V_155 ;
struct V_34 * V_156 ;
struct V_157 * V_52 ;
int V_36 ;
if ( type == V_158 )
...
F_72 ( & V_156 -> V_160 ) ;
F_72 ( & V_156 -> V_161 ) ;
V_156 -> V_15 = F_50 ( NULL , NULL , 0 ) ;
V_156 -> V_12 . V_18 = V_162 ;
V_156 -> V_12 . V_19 = V_163 ;
V_156 -> V_12 . V_110 = V_156 -> V_15 -> V_111 ;
V_156 -> V_12 . V_116 = V_117 ;
V_156 -> V_48 = 0 ;
