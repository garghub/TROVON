...
V_20 -> V_14 -> V_223 = F_6 ;
V_20 -> V_14 -> V_224 = F_8 ;
V_20 -> V_14 -> V_140 = L_22 ;
snprintf ( V_20 -> V_14 -> V_225 , V_226 , L_23 ,
F_109 ( & V_27 -> V_17 ) , V_203 ) ;
...
static void F_119 ( struct V_93 * V_27 )
{
struct V_16 * V_17 = F_120 ( V_27 ) ;
struct V_19 * V_20 = F_7 ( V_17 ) ;
F_121 ( V_17 ) ;
F_112 ( V_20 -> V_14 ) ;
F_113 ( V_20 -> V_14 ) ;
F_114 ( & V_20 -> V_94 ) ;
F_115 ( V_27 , V_20 -> V_21 ) ;
F_116 ( V_27 ) ;
F_117 ( V_17 ) ;
F_118 ( V_27 ) ;
}
