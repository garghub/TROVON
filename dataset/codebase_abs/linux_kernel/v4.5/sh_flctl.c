...
static void F_24 ( struct V_37 * V_38 , int V_39 , int V_40 )
{
...
T_1 V_57 , V_58 ;
while ( V_10 -- ) {
V_58 = F_29 ( F_30 ( V_2 ) ) >> 24 ;
if ( ( V_58 & 0xFF ) == 4 )
return V_55 ;
if ( ! ( F_29 ( F_33 ( V_2 ) ) & V_59 ) ) {
F_11 ( 1 ) ;
continue;
}
...
static int F_39 ( struct V_1 * V_2 , unsigned long * V_67 ,
...
V_76 = F_40 ( V_73 -> V_81 -> V_9 , V_67 , V_50 , V_69 ) ;
if ( V_76 )
V_71 = F_41 ( V_73 , V_76 , V_50 ,
V_75 , V_82 | V_83 ) ;
if ( V_71 ) {
V_79 = F_29 ( F_3 ( V_2 ) ) ;
V_79 |= V_84 ;
...
static void F_49 ( struct V_1 * V_2 , int V_89 )
{
unsigned long V_57 ;
...
static void F_52 ( struct V_1 * V_2 , int V_90 , int V_89 )
{
int V_54 , V_91 ;
unsigned long * V_67 = ( unsigned long * ) & V_2 -> V_61 [ V_89 ] ;
V_91 = ( V_90 + 3 ) / 4 ;
if ( V_2 -> V_16 && V_90 >= 32 &&
F_39 ( V_2 , V_67 , V_90 , V_36 ) > 0 )
goto V_92;
for ( V_54 = 0 ; V_54 < V_91 ; V_54 ++ ) {
F_28 ( V_2 ) ;
V_67 [ V_54 ] = F_29 ( F_53 ( V_2 ) ) ;
}
V_92:
for ( V_54 = 0 ; V_54 < V_91 ; V_54 ++ )
...
F_60 ( V_38 , V_110 ,
( V_132 << 8 ) | V_110 ) ;
F_2 ( F_29 ( F_61 ( V_2 ) ) | V_133 | V_134 ,
F_61 ( V_2 ) ) ;
F_2 ( F_29 ( F_62 ( V_2 ) ) | V_130 , F_62 ( V_2 ) ) ;
F_2 ( V_40 << 2 , F_27 ( V_2 ) ) ;
F_1 ( V_2 ) ;
F_4 ( V_2 ) ;
for ( V_94 = 0 ; V_94 < V_130 ; V_94 ++ ) {
F_52 ( V_2 , 512 , 512 * V_94 ) ;
V_131 = F_55 ( V_2 ,
...
F_24 ( V_38 , ( 512 + 16 ) * V_54 + 512 , V_40 ) ;
F_2 ( 16 , F_30 ( V_2 ) ) ;
F_4 ( V_2 ) ;
F_52 ( V_2 , 16 , 16 * V_54 ) ;
F_9 ( V_2 ) ;
...
( V_115 << 8 ) | V_114 ) ;
F_1 ( V_2 ) ;
F_2 ( F_29 ( F_61 ( V_2 ) ) | V_133 , F_61 ( V_2 ) ) ;
F_2 ( F_29 ( F_62 ( V_2 ) ) | V_130 , F_62 ( V_2 ) ) ;
F_2 ( V_40 << 2 , F_27 ( V_2 ) ) ;
F_4 ( V_2 ) ;
for ( V_94 = 0 ; V_94 < V_130 ; V_94 ++ ) {
...
F_24 ( V_38 , V_39 , 0 ) ;
V_2 -> V_141 = 8 ;
F_2 ( V_2 -> V_141 , F_30 ( V_2 ) ) ;
F_1 ( V_2 ) ;
F_4 ( V_2 ) ;
F_52 ( V_2 , V_2 -> V_141 , 0 ) ;
F_9 ( V_2 ) ;
break;
case V_107 :
V_2 -> V_146 = V_40 ;
...
F_24 ( V_38 , V_2 -> V_148 , V_2 -> V_138 ) ;
F_2 ( V_2 -> V_64 , F_30 ( V_2 ) ) ;
F_4 ( V_2 ) ;
F_57 ( V_2 , V_2 -> V_64 , 0 ) ;
F_9 ( V_2 ) ;
break;
...
static T_7 F_82 ( struct V_37 * V_38 )
{
struct V_1 * V_2 = F_25 ( V_38 ) ;
T_7 * V_67 = ( T_7 * ) & V_2 -> V_61 [ V_2 -> V_64 ] ;
V_2 -> V_64 += 2 ;
return * V_67 ;
}
...
static T_8 F_85 ( int V_178 , void * V_179 )
{
...
if ( ! V_2 )
return - V_195 ;
V_95 = F_91 ( V_8 , V_196 , 0 ) ;
V_2 -> V_79 = F_92 ( & V_8 -> V_9 , V_95 ) ;
if ( F_93 ( V_2 -> V_79 ) )
return F_94 ( V_2 -> V_79 ) ;
V_2 -> V_33 = V_95 -> V_197 + 0x24 ;
V_178 = F_95 ( V_8 , 0 ) ;
if ( V_178 < 0 ) {
F_8 ( & V_8 -> V_9 , L_14 ) ;
return - V_198 ;
}
V_24 = F_96 ( & V_8 -> V_9 , V_178 , F_85 , V_199 ,
L_15 , V_2 ) ;
if ( V_24 ) {
F_8 ( & V_8 -> V_9 , L_16 ) ;
return V_24 ;
...
V_194 = & V_2 -> V_42 ;
V_193 = F_98 ( V_194 ) ;
F_99 ( V_194 , V_8 -> V_9 . V_187 ) ;
V_193 -> V_9 . V_200 = & V_8 -> V_9 ;
V_2 -> V_8 = V_8 ;
V_2 -> V_143 = V_23 -> V_190 ;
V_2 -> V_157 = V_23 -> V_191 ;
V_2 -> V_100 = V_23 -> V_99 ;
V_2 -> V_3 = V_2 -> V_143 ? ( V_201 | V_202 ) : V_201 ;
V_194 -> V_203 = 20 ;
V_194 -> V_204 = F_81 ;
V_194 -> V_129 = F_80 ;
V_194 -> V_125 = F_83 ;
...
if ( V_24 )
goto V_208;
V_24 = F_104 ( V_193 , V_23 -> V_209 , V_23 -> V_210 ) ;
return 0 ;
V_208:
F_14 ( V_2 ) ;
F_105 ( & V_8 -> V_9 ) ;
