...
switch ( V_56 ) {
case V_90 :
if ( V_11 -> V_74 . V_91 == 0 || V_57 == V_11 -> V_74 . V_91 )
V_52 = V_84 ;
break;
case V_92 :
#define F_22 1460
#define F_23 1448
if ( V_57 == V_11 -> V_74 . V_91 * V_59 ||
V_57 == V_11 -> V_74 . V_91 * F_22 ||
V_57 == V_11 -> V_74 . V_91 * F_23 )
V_52 = V_84 ;
break;
case V_93 :
if ( V_57 == V_11 -> V_74 . V_91 * ( V_59 + 40 ) ||
V_57 == V_11 -> V_74 . V_91 * ( F_22 + 40 ) ||
V_57 == V_11 -> V_74 . V_91 * ( F_23 + 40 ) )
V_52 = V_84 ;
break;
case V_94 :
if ( ( V_57 % V_11 -> V_74 . V_91 ) == 0 )
V_52 = V_84 ;
break;
}
}
...
V_54 ++ ;
if ( V_31 -> V_35 & V_71 )
F_24 ( V_1 , V_47 -> V_95 , V_47 -> V_96 , V_5 ,
V_47 -> V_97 , V_47 -> V_98 , NULL ,
L_1 ,
V_11 -> V_72 , V_11 -> V_99 , V_11 -> V_100 ,
& V_34 -> V_44 , F_19 ( V_50 -> V_101 ) ,
& V_34 -> V_102 , F_19 ( V_50 -> V_103 ) ,
V_11 -> V_37 - V_34 -> V_37 ) ;
if ( ( V_31 -> V_35 & V_71 ) &&
V_31 -> V_104 == V_105 )
break;
...
F_24 ( V_1 , V_47 -> V_95 , V_47 -> V_96 , V_5 , V_47 -> V_97 ,
V_47 -> V_98 , NULL ,
L_2 ,
& V_34 -> V_44 , F_19 ( V_50 -> V_101 ) ,
& V_34 -> V_102 , F_19 ( V_50 -> V_103 ) ) ;
...
int V_15 = - V_17 ;
int V_106 ;
for ( V_106 = 0 ; V_106 < F_27 ( V_26 ) ; ++ V_106 )
F_28 ( & V_26 [ V_106 ] ) ;
V_15 = F_29 ( & V_107 ) ;
if ( V_15 < 0 ) {
F_30 ( L_3 , V_15 ) ;
