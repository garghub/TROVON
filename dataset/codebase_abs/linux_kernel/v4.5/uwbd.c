...
{
V_19 -> F_9 . V_38 = F_19 ( F_9 , V_19 , L_5 ) ;
...
void F_23 ( struct V_22 * V_19 )
{
struct V_1 * V_2 , * V_41 ;
F_27 ( & V_19 -> F_9 . V_36 ) ;
F_28 (evt, nxt, &rc->uwbd.event_list, list_node) {
if ( V_2 -> V_19 == V_19 ) {
F_8 ( V_19 ) ;
F_15 ( & V_2 -> V_37 ) ;
if ( V_2 -> type == V_28 )
