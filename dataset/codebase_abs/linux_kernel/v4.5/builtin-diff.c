...
struct V_52 * V_53 )
{
if ( F_18 ( V_28 , V_51 , NULL , NULL , NULL ,
V_53 , true ) != NULL )
return 0 ;
return - V_54 ;
}
...
{
struct V_50 V_51 ;
struct V_28 * V_28 = F_20 ( V_59 ) ;
int V_4 = - 1 ;
if ( F_21 ( V_57 , V_60 , & V_51 , V_53 ) < 0 ) {
F_22 ( L_16 ,
V_57 -> V_61 . type ) ;
return - 1 ;
}
if ( F_17 ( V_28 , & V_51 , V_53 ) ) {
F_22 ( L_17 ) ;
goto V_62;
}
V_28 -> V_42 . V_43 += V_53 -> V_26 ;
if ( ! V_51 . V_63 )
V_28 -> V_42 . V_47 += V_53 -> V_26 ;
V_4 = 0 ;
V_62:
F_23 ( & V_51 ) ;
return V_4 ;
}
static struct V_58 * F_24 ( struct V_58 * V_59 ,
struct V_64 * V_65 )
{
struct V_58 * V_66 ;
F_25 (evlist, e) {
...
static struct V_67 * F_29 ( struct V_68 * V_69 )
{
struct V_70 * V_71 = F_30 ( V_69 , struct V_70 , V_69 ) ;
void * V_72 = V_71 - V_71 -> V_73 ;
struct V_67 * V_74 = F_30 ( V_72 , struct V_67 , V_69 ) ;
return V_74 ;
}
static struct V_24 *
F_31 ( struct V_24 * V_25 , struct V_67 * V_74 )
{
if ( F_32 ( V_25 ) ) {
struct V_24 * V_29 ;
...
static struct V_24 *
F_34 ( struct V_24 * V_25 , struct V_70 * V_71 )
{
struct V_67 * V_74 = F_29 ( & V_71 -> V_69 ) ;
return F_31 ( V_25 , V_74 ) ;
}
...
if ( ! V_89 || ! V_90 )
return V_89 ? - 1 : 1 ;
V_92 = F_31 ( V_85 , & V_93 [ V_88 ] ) ;
V_91 = F_31 ( V_86 , & V_93 [ V_88 ] ) ;
if ( ! V_92 && ! V_91 )
return 0 ;
if ( ! V_92 || ! V_91 )
return V_92 ? - 1 : 1 ;
...
F_60 (i, d)
fprintf ( stdout , L_19 ,
V_74 -> V_73 , V_74 -> V_97 . V_98 ,
! V_74 -> V_73 ? L_20 : L_21 ) ;
fprintf ( stdout , L_22 ) ;
}
static void F_61 ( void )
{
struct V_64 * V_99 = V_93 [ 0 ] . V_100 -> V_65 ;
struct V_58 * V_101 ;
bool V_102 = true ;
F_25 (evlist_base, evsel_base) {
struct V_28 * V_103 = F_20 ( V_101 ) ;
struct V_67 * V_74 ;
int V_19 ;
F_43 (i, d) {
struct V_64 * V_65 = V_74 -> V_100 -> V_65 ;
struct V_58 * V_59 ;
struct V_28 * V_28 ;
V_59 = F_24 ( V_101 , V_65 ) ;
if ( ! V_59 )
continue;
V_28 = F_20 ( V_59 ) ;
V_74 -> V_28 = V_28 ;
...
static void F_66 ( struct V_67 * V_74 )
{
int V_107 ;
for ( V_107 = 0 ; V_107 < V_108 ; V_107 ++ ) {
struct V_70 * V_69 = & V_74 -> V_69 [ V_107 ] ;
F_67 ( & V_69 -> V_61 ) ;
}
}
...
int V_4 = - V_5 , V_19 ;
F_60 (i, d) {
V_74 -> V_100 = F_69 ( & V_74 -> V_97 , false , & T_5 ) ;
if ( ! V_74 -> V_100 ) {
F_3 ( L_25 , V_74 -> V_97 . V_98 ) ;
V_4 = - 1 ;
goto V_109;
}
V_4 = F_70 ( V_74 -> V_100 ) ;
if ( V_4 ) {
F_3 ( L_26 , V_74 -> V_97 . V_98 ) ;
goto V_109;
}
F_27 ( V_74 -> V_100 -> V_65 ) ;
}
F_61 () ;
V_109:
F_60 (i, d) {
...
{
struct V_70 * V_71 =
F_30 ( V_69 , struct V_70 , V_69 ) ;
double V_112 = F_72 ( V_25 ) ;
char V_113 [ 20 ] = L_27 ;
if ( ! V_25 -> V_94 ) {
F_12 ( V_113 , 20 , L_28 , V_71 -> V_114 - 1 ) ;
...
{
double V_112 = F_72 ( V_25 ) ;
const char * V_69 = V_45 . V_115 ? L_30 : L_31 ;
int V_4 = 0 ;
if ( ! V_25 -> V_94 )
V_4 = F_12 ( V_18 , V_40 , V_69 , V_112 ) ;
return V_4 ;
}
...
struct V_70 * V_71 =
F_30 ( V_69 , struct V_70 , V_69 ) ;
struct V_24 * V_29 = F_34 ( V_25 , V_71 ) ;
double V_33 ;
T_3 V_39 ;
char V_113 [ 20 ] = L_27 ;
if ( ! V_29 )
...
V_33 = F_8 ( V_25 , V_29 ) ;
F_12 ( V_113 , 20 , L_32 , V_71 -> V_114 - 1 ) ;
return F_74 ( V_111 -> V_18 , V_111 -> V_40 ,
V_113 , V_33 ) ;
case V_49 :
if ( V_25 -> V_94 )
...
struct V_110 * V_111 , struct V_24 * V_25 )
{
return F_76 ( V_69 , V_111 , V_25 , V_20 ) ;
}
static int F_81 ( struct V_68 * V_69 ,
struct V_110 * V_111 , struct V_24 * V_25 )
{
return F_76 ( V_69 , V_111 , V_25 , V_49 ) ;
}
static int F_82 ( struct V_68 * V_69 ,
struct V_110 * V_111 , struct V_24 * V_25 )
{
return F_76 ( V_69 , V_111 , V_25 , V_11 ) ;
}
static void
F_83 ( struct V_24 * V_25 , int V_73 , char * V_18 , T_4 V_40 )
{
switch ( V_73 ) {
case V_119 :
...
static void
F_85 ( struct V_24 * V_25 , struct V_70 * V_71 ,
char * V_18 , T_4 V_40 )
{
struct V_24 * V_29 = F_34 ( V_25 , V_71 ) ;
int V_73 = V_71 -> V_73 ;
...
if ( V_29 )
F_84 ( V_25 , V_29 , V_73 , V_18 , V_40 ) ;
else
F_83 ( V_25 , V_73 , V_18 , V_40 ) ;
}
}
static int F_86 ( struct V_68 * V_127 , struct V_110 * V_111 ,
struct V_24 * V_25 )
{
struct V_70 * V_71 =
F_30 ( V_127 , struct V_70 , V_69 ) ;
char V_18 [ V_128 ] = L_27 ;
F_85 ( V_25 , V_71 , V_18 , V_128 ) ;
if ( V_45 . V_115 )
...
static int F_87 ( struct V_68 * V_69 , struct V_110 * V_111 ,
struct V_58 * V_59 V_14 )
{
struct V_70 * V_71 =
F_30 ( V_69 , struct V_70 , V_69 ) ;
F_16 ( ! V_71 -> V_61 ) ;
return F_12 ( V_111 -> V_18 , V_111 -> V_40 , V_71 -> V_61 ) ;
}
static int F_88 ( struct V_68 * V_69 ,
...
static void F_89 ( struct V_67 * V_74 , struct V_70 * V_71 )
{
#define F_90 100
char V_129 [ F_90 ] ;
char V_18 [ F_90 ] ;
...
int V_130 = 0 ;
F_16 ( V_71 -> V_73 >= V_108 ) ;
V_61 = V_131 [ V_71 -> V_73 ] . V_132 ;
V_130 = V_131 [ V_71 -> V_73 ] . V_130 ;
F_16 ( ! V_61 ) ;
if ( V_105 > 2 )
F_12 ( V_18 , F_90 , L_40 , V_61 , V_74 -> V_73 ) ;
...
V_71 -> V_114 , F_91 ) ;
V_71 -> V_61 = F_92 ( V_129 ) ;
#undef F_90
#undef F_91
}
static void F_93 ( struct V_67 * V_74 , int V_73 )
{
...
int V_19 ;
F_60 (i, d) {
F_93 ( V_74 , V_19 ? V_138 [ V_10 ] :
V_126 ) ;
if ( V_139 && V_19 )
F_93 ( V_74 , V_124 ) ;
if ( V_140 )
F_93 ( V_74 , V_19 ? V_125 :
V_119 ) ;
}
if ( ! V_95 )
return 0 ;
V_69 = F_97 ( sizeof( * V_69 ) ) ;
if ( V_69 == NULL ) {
F_3 ( L_41 ) ;
return - 1 ;
}
...
if ( V_95 >= ( unsigned int ) V_105 ) {
F_3 ( L_46 ) ;
return - V_5 ;
}
V_93 = F_97 ( sizeof( * V_93 ) * V_105 ) ;
if ( ! V_93 )
return - V_54 ;
F_60 (i, d) {
struct V_146 * V_97 = & V_74 -> V_97 ;
...
return V_4 ;
F_101 ( V_150 , NULL ) ;
V_141 = F_102 ( V_141 , V_142 , V_151 , V_152 , 0 ) ;
if ( F_103 ( NULL ) < 0 )
return - 1 ;
