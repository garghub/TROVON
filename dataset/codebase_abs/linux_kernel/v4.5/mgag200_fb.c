...
V_60 = & V_2 -> V_15 . V_16 ;
V_2 -> V_50 . V_60 = V_60 ;
strcpy ( V_34 -> V_69 . V_70 , L_3 ) ;
V_34 -> V_24 = V_71 | V_72 ;
V_34 -> V_73 = & V_74 ;
V_34 -> V_75 -> V_76 [ 0 ] . V_16 = V_57 -> V_49 -> V_77 . V_78 ;
V_34 -> V_75 -> V_76 [ 0 ] . V_51 = V_57 -> V_79 . V_80 ;
F_28 ( V_34 , V_60 -> V_31 [ 0 ] , V_60 -> V_81 ) ;
F_29 ( V_34 , & V_2 -> V_50 , V_55 -> V_82 ,
V_55 -> V_83 ) ;
V_34 -> V_84 = V_32 ;
V_34 -> V_85 = V_51 ;
V_34 -> V_86 . V_24 = V_87 ;
...
int V_18 ;
int V_89 = 32 ;
if ( F_40 ( V_57 ) && V_57 -> V_79 . V_80 < ( 2048 * 1024 ) )
V_89 = 16 ;
V_2 = F_41 ( V_57 -> V_49 -> V_49 , sizeof( struct V_1 ) , V_90 ) ;
if ( ! V_2 )
return - V_91 ;
V_57 -> V_2 = V_2 ;
F_42 ( & V_2 -> V_25 ) ;
