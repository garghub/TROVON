...
static T_3 F_77 ( int V_60 , void * V_461 )
{
...
static T_3 F_79 ( int V_60 , void * V_461 )
{
T_3 V_48 = V_463 ;
T_3 V_65 ;
do {
V_65 = F_77 ( V_60 , V_461 ) ;
if ( V_65 != V_463 )
V_48 = V_65 ;
} while ( V_65 != V_463 );
return V_48 ;
...
for ( V_12 = 0 ; V_12 < F_5 ( V_5 -> V_292 ) ; V_12 ++ ) {
V_48 = F_95 ( V_5 -> V_292 [ V_12 ] . V_501 ,
& V_5 -> V_496 [ V_12 ] ) ;
if ( V_48 != 0 ) {
F_24 ( & V_57 -> V_29 ,
L_55 ,
...
static int F_103 ( struct V_56 * V_567 )
{
struct V_4 * V_5 = F_104 ( V_567 ) ;
int V_12 ;
F_105 ( & V_567 -> V_29 ) ;
F_62 ( V_5 ) ;
if ( V_5 -> V_7 . V_293 > 0 ) {
