...
{
struct V_41 * V_95 , * V_42 = V_94 -> V_33 . V_96 ;
struct V_92 * V_92 ;
...
int V_103 = 0 ;
int V_104 , V_73 ;
V_104 = ( F_50 ( V_105 ) >> 4 ) & 0xF ;
if ( ( V_104 != 2 ) && ( V_104 != 3 ) ) {
F_43 ( V_33 , L_10 , V_104 ) ;
return - V_106 ;
}
V_7 = F_51 ( V_33 , sizeof( * V_7 ) , V_107 ) ;
if ( ! V_7 )
return - V_44 ;
V_5 = & V_7 -> V_5 ;
V_2 = F_52 ( V_5 ) ;
...
V_103 = F_56 ( V_42 , 0 , & V_98 ) ;
if ( V_103 ) {
F_43 ( V_33 , L_13 ) ;
return V_103 ;
}
V_101 = F_57 ( V_42 , L_14 , & V_73 ) ;
if ( ! V_101 || V_73 != sizeof( * V_101 ) ) {
F_43 ( V_33 , L_15 ) ;
return - V_45 ;
}
V_99 = V_98 . V_110 ;
V_100 = F_58 ( & V_98 ) ;
if ( ! F_59 ( V_33 , V_99 , V_100 , V_111 ) ) {
F_43 ( V_33 , L_16 ) ;
return - V_88 ;
}
V_7 -> V_8 = F_60 ( V_33 , V_99 , V_100 ) ;
if ( ! V_7 -> V_8 ) {
F_43 ( V_33 , L_17 ) ;
return - V_44 ;
}
...
F_5 ( V_2 , V_127 , V_128 ) ;
F_5 ( V_2 , V_129 , 0x0000 ) ;
F_5 ( V_2 , V_130 , 0xFFFF ) ;
F_5 ( V_2 , V_131 , V_132 ) ;
F_5 ( V_2 , V_26 , V_133 | V_27 |
V_134 ) ;
F_5 ( V_2 , V_135 , V_2 -> V_70 >> 1 ) ;
F_68 ( & V_7 -> V_28 ) ;
V_103 = F_69 ( V_33 , V_7 -> V_24 , & F_16 , 0 , V_111 ,
V_2 ) ;
if ( V_103 ) {
F_43 ( V_33 , L_26 ) ;
goto error;
}
if ( F_70 ( V_2 , F_71 ( V_101 ) ) ) {
F_43 ( V_33 , L_27 ) ;
V_103 = - V_106 ;
goto error;
}
switch ( V_2 -> V_136 / V_2 -> V_37 ) {
case 32 :
F_7 ( V_2 , V_26 , V_137 ) ;
break;
case 64 :
