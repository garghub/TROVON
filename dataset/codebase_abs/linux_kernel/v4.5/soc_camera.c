...
F_128 ( V_221 , sizeof( V_221 ) ,
V_216 -> V_224 , V_216 -> V_227 -> V_229 ) ;
V_19 -> V_6 = F_129 ( & V_230 , V_221 , V_19 ) ;
if ( F_130 ( V_19 -> V_6 ) ) {
V_7 = F_131 ( V_19 -> V_6 ) ;
goto V_231;
}
V_220 = F_132 ( & V_27 -> V_198 , V_219 ,
V_216 -> V_227 , NULL ) ;
if ( ! V_220 ) {
V_7 = - V_25 ;
goto V_232;
...
static int F_142 ( struct V_234 * V_235 ,
struct V_20 * V_21 ,
struct V_236 * V_237 )
{
struct V_199 * V_200 = F_143 ( V_235 ,
struct V_199 , V_235 ) ;
struct V_18 * V_19 = F_119 ( V_200 -> V_57 ) ;
if ( V_237 == V_200 -> V_238 && ! F_30 ( V_19 -> V_140 ) ) {
struct V_213 * V_214 = F_133 ( V_21 ) ;
if ( V_214 ) {
struct V_136 * V_137 = F_70 ( V_19 ) ;
struct V_3 * V_4 =
F_144 ( V_214 ) ;
...
static void F_145 ( struct V_234 * V_235 ,
struct V_20 * V_21 ,
struct V_236 * V_237 )
{
struct V_199 * V_200 = F_143 ( V_235 ,
...
V_241 = F_143 ( V_237 [ V_34 ] , struct V_240 , V_237 ) ;
if ( V_241 -> V_243 == V_244 )
break;
}
if ( V_34 >= V_239 || V_237 [ V_34 ] -> V_245 != V_246 ) {
F_4 ( V_27 -> V_198 . V_2 , L_29 ) ;
return - V_25 ;
}
V_200 = F_148 ( V_27 -> V_198 . V_2 , sizeof( * V_200 ) , V_225 ) ;
if ( ! V_200 )
return - V_116 ;
V_137 . V_217 . V_227 = F_149 ( - V_247 ) ;
...
V_200 -> V_235 . V_252 = F_142 ;
V_200 -> V_235 . V_253 = F_145 ;
V_200 -> V_235 . V_254 = F_146 ;
V_19 -> V_200 = V_200 ;
V_19 -> V_52 = V_27 -> V_198 . V_2 ;
F_128 ( V_221 , sizeof( V_221 ) ,
V_241 -> V_237 . V_255 . V_256 . V_257 ,
V_241 -> V_237 . V_255 . V_256 . V_258 ) ;
V_19 -> V_6 = F_129 ( & V_230 , V_221 , V_19 ) ;
if ( F_130 ( V_19 -> V_6 ) ) {
V_7 = F_131 ( V_19 -> V_6 ) ;
goto V_231;
}
V_7 = F_150 ( & V_27 -> V_198 , & V_200 -> V_235 ) ;
if ( ! V_7 )
return 0 ;
F_134 ( V_19 -> V_6 ) ;
V_231:
...
F_116 ( V_200 -> V_57 ) ;
V_248:
F_152 ( V_27 -> V_198 . V_2 , V_200 ) ;
F_4 ( V_27 -> V_198 . V_2 , L_30 , V_7 ) ;
return V_7 ;
}
...
F_147 ( V_27 , V_237 , V_27 -> V_260 [ V_259 ] ) ;
...
char V_221 [ V_222 ] ;
int V_7 ;
V_265 = F_148 ( V_27 -> V_198 . V_2 , sizeof( struct V_264 ) ,
V_225 ) ;
if ( ! V_265 )
return - V_116 ;
...
F_116 ( V_200 -> V_57 ) ;
V_248:
F_152 ( V_27 -> V_198 . V_2 , V_265 ) ;
F_4 ( V_27 -> V_198 . V_2 , L_30 , V_7 ) ;
return V_7 ;
}
static void F_158 ( struct V_26 * V_27 )
{
...
static inline void F_158 ( struct V_26 * V_27 ) { }
...
int V_7 ;
F_163 ( V_19 -> V_57 , L_33 , F_164 ( V_19 -> V_57 ) ) ;
V_7 = F_165 ( & V_19 -> V_148 , 16 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_166 ( V_19 ) ;
if ( V_7 < 0 )
...
goto V_127;
if ( V_216 -> V_276 )
V_7 = F_167 ( V_216 -> V_276 ) ;
V_7 = V_216 -> V_274 ( V_19 ) ;
if ( V_7 < 0 )
goto V_277;
V_140 = F_69 ( V_19 ) ;
if ( ! V_140 || ! V_140 -> V_168 || ! F_168 ( V_140 ) ||
...
static int F_175 ( struct V_18 * V_19 , struct V_175 * V_81 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_82 , V_282 , V_81 ) ;
}
static int F_176 ( struct V_18 * V_19 , const struct V_175 * V_81 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
...
return - V_67 ;
if ( ! V_27 -> V_28 -> V_183 )
V_27 -> V_28 -> V_183 = F_176 ;
if ( ! V_27 -> V_28 -> V_176 )
V_27 -> V_28 -> V_176 = F_175 ;
if ( ! V_27 -> V_28 -> V_174 )
V_27 -> V_28 -> V_174 = F_174 ;
if ( ! V_27 -> V_28 -> V_195 )
V_27 -> V_28 -> V_195 = F_178 ;
if ( ! V_27 -> V_28 -> V_194 )
V_27 -> V_28 -> V_194 = F_177 ;
if ( ! V_27 -> V_28 -> V_88 )
V_27 -> V_28 -> V_88 = F_179 ;
F_17 ( & V_129 ) ;
F_107 (ix, &hosts, list) {
...
V_7 = F_181 ( V_27 -> V_198 . V_2 , & V_27 -> V_198 ) ;
if ( V_7 < 0 )
goto V_302;
F_182 ( & V_27 -> V_303 , & V_304 ) ;
F_18 ( & V_129 ) ;
F_183 ( & V_27 -> V_133 ) ;
F_183 ( & V_27 -> V_30 ) ;
...
F_187 ( V_19 -> V_57 ) ;
F_188 ( & V_19 -> V_200 -> V_303 , & V_306 ) ;
}
F_18 ( & V_129 ) ;
F_107 (sasc, &notifiers, list) {
F_189 ( & V_200 -> V_235 ) ;
F_190 ( & V_200 -> V_57 -> V_2 ) ;
}
F_17 ( & V_129 ) ;
F_191 (icd, tmp, &devices, list)
if ( V_19 -> V_196 == V_27 -> V_197 )
F_171 ( V_19 ) ;
F_18 ( & V_129 ) ;
F_192 ( & V_27 -> V_198 ) ;
...
if ( ! V_19 -> V_52 )
return - V_25 ;
F_196 ( V_19 -> V_78 , V_19 ) ;
if ( V_19 -> V_78 -> V_79 == 0 ) {
F_197 ( V_19 -> V_78 , V_319 ) ;
F_197 ( V_19 -> V_78 , V_320 ) ;
F_197 ( V_19 -> V_78 , V_321 ) ;
}
V_7 = F_198 ( V_19 -> V_78 , V_322 , - 1 ) ;
if ( V_7 < 0 ) {
F_4 ( V_19 -> V_57 , L_34 , V_7 ) ;
return V_7 ;
}
...
if ( ! V_137 )
return - V_67 ;
V_19 = F_148 ( & V_57 -> V_2 , sizeof( * V_19 ) , V_225 ) ;
if ( ! V_19 )
return - V_116 ;
...
static int F_201 ( struct V_201 * V_57 )
{
