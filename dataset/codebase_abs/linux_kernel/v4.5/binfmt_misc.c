...
if ( F_66 ( V_79 ) )
goto V_90;
V_68 = F_38 ( V_70 , V_91 | 0644 ) ;
V_48 = - V_52 ;
if ( ! V_68 )
goto V_90;
V_48 = F_67 ( & V_92 , & V_80 , & V_81 ) ;
if ( V_48 ) {
F_68 ( V_68 ) ;
V_68 = NULL ;
goto V_90;
...
static int F_74 ( struct V_69 * V_70 , void * V_97 , int V_98 )
{
int V_48 ;
static struct V_99 V_100 [] = {
[ 2 ] = { L_31 , & V_101 , V_102 | V_103 } ,
[ 3 ] = { L_32 , & V_104 , V_102 } ,
{ L_33 }
} ;
V_48 = F_75 ( V_70 , V_105 , V_100 ) ;
if ( ! V_48 )
V_70 -> V_106 = & V_107 ;
return V_48 ;
}
static struct V_79 * F_76 ( struct V_108 * V_109 ,
int V_12 , const char * V_110 , void * V_97 )
{
return F_77 ( V_109 , V_12 , V_97 , F_74 ) ;
}
