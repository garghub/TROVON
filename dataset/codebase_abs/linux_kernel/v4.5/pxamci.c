...
if ( V_123 < 0 )
return V_123 ;
V_4 = F_66 ( sizeof( struct V_1 ) , & V_162 -> V_74 ) ;
if ( ! V_4 ) {
V_13 = - V_169 ;
goto V_182;
}
...
V_4 -> V_185 = V_186 ;
V_4 -> V_187 = V_188 ;
V_4 -> V_189 = F_67 () ? 1023 : 2048 ;
V_4 -> V_190 = 65535 ;
V_2 = F_43 ( V_4 ) ;
V_2 -> V_4 = V_4 ;
V_2 -> V_6 = V_162 -> V_74 . V_171 ;
V_2 -> V_51 = V_142 ;
V_2 -> V_141 = F_68 ( & V_162 -> V_74 , NULL ) ;
if ( F_5 ( V_2 -> V_141 ) ) {
V_13 = F_69 ( V_2 -> V_141 ) ;
V_2 -> V_141 = NULL ;
goto V_182;
}
V_2 -> V_49 = F_70 ( V_2 -> V_141 ) ;
V_4 -> V_191 = ( V_2 -> V_49 + 63 ) / 64 ;
V_4 -> V_192 = ( F_71 () ) ? 26000000 : V_2 -> V_49 ;
F_1 ( V_2 ) ;
V_4 -> V_193 = 0 ;
V_2 -> V_84 = 0 ;
if ( ! F_67 () ) {
...
V_2 -> V_123 = V_123 ;
V_2 -> V_29 = V_199 ;
V_2 -> V_19 = F_73 ( & V_162 -> V_74 , V_173 ) ;
if ( F_5 ( V_2 -> V_19 ) ) {
V_13 = F_69 ( V_2 -> V_19 ) ;
goto V_182;
}
F_12 ( V_2 ) ;
F_14 ( 0 , V_2 -> V_19 + V_200 ) ;
F_14 ( 64 , V_2 -> V_19 + V_201 ) ;
F_14 ( V_2 -> V_29 , V_2 -> V_19 + V_30 ) ;
V_13 = F_74 ( & V_162 -> V_74 , V_2 -> V_123 , F_39 , 0 ,
V_202 , V_2 ) ;
if ( V_13 )
goto V_182;
F_75 ( V_162 , V_4 ) ;
if ( ! V_162 -> V_74 . V_165 ) {
V_174 = F_64 ( V_162 , V_203 , 0 ) ;
V_175 = F_64 ( V_162 , V_203 , 1 ) ;
if ( ! V_174 || ! V_175 ) {
V_13 = - V_204 ;
goto V_182;
}
V_177 . V_205 = V_206 ;
V_177 . V_207 = V_174 -> V_58 ;
V_178 . V_205 = V_206 ;
V_178 . V_207 = V_175 -> V_58 ;
}
F_76 ( V_26 ) ;
F_77 ( V_208 , V_26 ) ;
V_2 -> V_68 =
...
V_4 -> V_211 |= V_2 -> V_6 -> V_212 ?
0 : V_213 ;
}
if ( F_10 ( V_179 ) )
V_13 = F_82 ( V_4 , V_179 , 0 ) ;
if ( V_13 ) {
F_16 ( & V_162 -> V_74 , L_22 , V_179 ) ;
goto V_182;
}
if ( V_2 -> V_6 && V_2 -> V_6 -> V_214 )
V_2 -> V_6 -> V_214 ( & V_162 -> V_74 , F_56 , V_4 ) ;
