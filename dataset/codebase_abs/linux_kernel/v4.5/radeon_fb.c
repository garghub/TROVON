...
{
F_43 ( & V_2 -> V_82 . V_15 -> V_40 ) ;
}
static int F_44 ( struct V_83 * V_37 , struct V_14 * V_15 )
{
...
int V_86 = 32 ;
int V_13 ;
if ( F_48 ( V_2 ) || V_2 -> V_66 . V_87 <= ( 32 * 1024 * 1024 ) )
V_86 = 8 ;
V_15 = F_49 ( sizeof( struct V_14 ) , V_88 ) ;
if ( ! V_15 )
return - V_32 ;
V_15 -> V_2 = V_2 ;
V_2 -> V_82 . V_15 = V_15 ;
F_50 ( V_2 -> V_54 , & V_15 -> V_40 ,
& V_89 ) ;
V_13 = F_51 ( V_2 -> V_54 , & V_15 -> V_40 ,
V_2 -> V_90 ,
V_91 ) ;
if ( V_13 )
goto free;
...
if ( ! V_2 -> V_82 . V_15 )
return;
F_44 ( V_2 -> V_54 , V_2 -> V_82 . V_15 ) ;
F_41 ( V_2 -> V_82 . V_15 ) ;
V_2 -> V_82 . V_15 = NULL ;
}
void F_56 ( struct V_1 * V_2 , int V_93 )
{
F_57 ( V_2 -> V_82 . V_15 -> V_40 . V_94 , V_93 ) ;
}
bool F_58 ( struct V_1 * V_2 , struct V_11 * V_95 )
{
if ( V_95 == F_4 ( V_2 -> V_82 . V_15 -> V_55 . V_85 ) )
return true ;
return false ;
}
void F_59 ( struct V_1 * V_2 , struct V_96 * V_97 )
{
F_60 ( & V_2 -> V_82 . V_15 -> V_40 , V_97 ) ;
}
void F_61 ( struct V_1 * V_2 , struct V_96 * V_97 )
{
F_62 ( & V_2 -> V_82 . V_15 -> V_40 , V_97 ) ;
}
