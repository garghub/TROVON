...
V_314 -> V_316 -> V_317 == V_314 -> V_316 -> V_317 ) {
if ( V_9 -> V_236 >= 1 )
return - 1 ;
...
static int F_107 ( struct V_346 * V_44 )
{
struct V_43 * V_347 = F_108 ( V_44 ) ;
struct V_8 * V_9 = F_106 ( V_44 -> V_337 ) ;
F_109 ( V_44 , 0 , V_9 -> V_3 . V_3 . V_13 . V_24 ) ;
if ( F_110 ( V_44 , 0 ) > F_111 ( V_44 , 0 ) )
return - V_89 ;
V_347 -> V_31 = V_9 -> V_3 . V_3 . V_13 . V_31 ;
return 0 ;
}
static void F_112 ( struct V_346 * V_44 )
{
struct V_43 * V_347 = F_108 ( V_44 ) ;
struct V_8 * V_9 = F_106 ( V_44 -> V_337 ) ;
struct V_42 * V_348 = F_20 ( V_347 ) ;
unsigned long V_349 = 0 ;
F_113 ( & V_9 -> V_258 , V_349 ) ;
F_114 ( & V_348 -> V_246 , & V_9 -> V_244 ) ;
F_115 ( & V_9 -> V_258 , V_349 ) ;
}
static int F_116 ( struct V_337 * V_338 , unsigned int V_350 )
{
struct V_8 * V_9 = F_106 ( V_338 ) ;
struct V_42 * V_348 , * V_351 ;
struct V_15 * V_16 ;
unsigned long V_349 ;
unsigned long V_201 ;
int V_225 ;
...
F_21 ( & V_9 -> V_37 , 1 ) ;
V_225 = F_85 ( V_16 -> V_235 , V_330 , V_352 , 1 ) ;
if ( V_225 < 0 ) {
F_54 ( V_9 , L_57 ) ;
goto V_353;
}
...
F_81 ( V_9 ) ;
V_16 = V_9 -> V_17 ;
V_225 = F_85 ( V_16 -> V_235 , V_330 , V_352 , 0 ) ;
if ( V_225 && V_225 != - V_284 && V_225 != - V_242 )
F_10 ( 1 , V_9 , L_58 ) ;
F_113 ( & V_9 -> V_258 , V_349 ) ;
if ( V_9 -> V_249 == V_9 -> V_243 ) {
...
return - V_89 ;
memset ( V_226 , 0 , sizeof( struct V_356 ) ) ;
V_226 -> type = V_220 ;
V_226 -> V_357 . V_23 = V_228 [ V_9 -> V_233 ] . V_23 ;
V_226 -> V_358 . V_23 = V_226 -> V_357 . V_23 ;
V_226 -> V_357 . V_25 = V_228 [ V_9 -> V_233 ] . V_25 ;
V_226 -> V_358 . V_25 = V_226 -> V_357 . V_25 ;
V_226 -> V_359 = V_228 [ V_9 -> V_233 ] . V_359 ;
return 0 ;
}
static int
F_120 ( struct V_238 * V_238 , void * V_360 , struct V_361 * V_21 )
{
struct V_8 * V_9 = F_61 ( V_238 ) ;
switch ( V_21 -> V_362 ) {
case V_363 :
...
static int F_121 ( struct V_51 * V_366 , struct V_51 * V_164 )
{
if ( V_366 -> V_60 < V_164 -> V_60 || V_366 -> V_63 < V_164 -> V_63 )
return 0 ;
if ( V_366 -> V_60 + V_366 -> V_23 > V_164 -> V_60 + V_164 -> V_23 )
return 0 ;
if ( V_366 -> V_63 + V_366 -> V_25 > V_164 -> V_63 + V_164 -> V_25 )
return 0 ;
return 1 ;
}
static int
F_122 ( struct V_238 * V_238 , void * V_360 , struct V_361 * V_21 )
{
struct V_8 * V_9 = F_61 ( V_238 ) ;
struct V_51 V_367 = V_9 -> V_226 ;
...
V_21 -> V_362 != V_365 )
return - V_89 ;
F_123 ( & V_170 . V_23 , 0 , V_367 . V_23 , 0 ,
& V_170 . V_25 , 0 , V_367 . V_25 , 0 , 0 ) ;
V_170 . V_60 = F_124 (unsigned int, r.left, 0 , cr.width - r.width) ;
V_170 . V_63 = F_124 (unsigned int, r.top, 0 , cr.height - r.height) ;
if ( V_21 -> V_349 & V_368 && ! F_121 ( & V_170 , & V_21 -> V_170 ) )
return - V_369 ;
if ( V_21 -> V_349 & V_370 && ! F_121 ( & V_21 -> V_170 , & V_170 ) )
return - V_369 ;
...
F_10 ( 1 , V_9 , L_60 ,
V_170 . V_60 , V_170 . V_63 , V_170 . V_23 , V_170 . V_25 , V_367 . V_23 , V_367 . V_25 ) ;
return 0 ;
}
static long F_125 ( struct V_238 * V_238 , void * V_263 ,
bool V_371 , unsigned int V_372 , void * V_373 )
{
struct V_8 * V_9 = F_61 ( V_238 ) ;
int V_225 ;
F_10 ( 2 , V_9 , L_61 ) ;
...
switch ( V_372 ) {
case V_374 :
V_225 = F_33 ( & V_9 -> V_37 , ( void T_3 * ) V_373 ) ;
if ( V_225 ) {
F_10 ( 2 , V_9 ,
L_62 ) ;
return V_225 ;
...
static int
F_126 ( struct V_376 * V_377 ,
struct V_378 * V_320 ,
struct V_379 * V_311 )
{
struct V_8 * V_9 = F_19 ( V_377 -> V_270 ,
struct V_8 , V_270 ) ;
struct V_380 V_381 ;
struct V_15 * V_16 ;
bool V_382 = false ;
...
F_10 ( 1 , V_9 , L_64 ) ;
for ( V_93 = 0 ; V_93 < F_2 ( V_9 -> V_47 -> V_311 ) ; V_93 ++ ) {
if ( V_9 -> V_47 -> V_311 [ V_93 ] -> V_383 . V_384 . V_385 == V_311 [ V_93 ] . V_383 . V_384 . V_385 ) {
...
V_9 -> V_386 . V_387 |= V_16 -> V_321 [ 0 ] . V_388 ;
...
if ( V_353 )
goto V_394;
V_9 -> V_345 = F_131 ( V_9 -> V_237 ) ;
if ( F_132 ( V_9 -> V_345 ) ) {
F_54 ( V_9 , L_66 ) ;
V_353 = F_133 ( V_9 -> V_345 ) ;
goto V_394;
}
V_393 = & V_9 -> V_291 ;
V_393 -> type = V_220 ;
V_393 -> V_395 = V_396 | V_397 | V_398 ;
V_393 -> V_399 = V_9 ;
V_393 -> V_400 = & V_401 ;
V_393 -> V_402 = & V_403 ;
V_393 -> V_404 = sizeof( struct V_42 ) ;
V_393 -> V_405 = V_406 ;
V_393 -> V_240 = & V_9 -> V_240 ;
V_393 -> V_407 = 1 ;
V_353 = F_134 ( V_393 ) ;
if ( V_353 ) {
F_54 ( V_9 , L_67 ) ;
...
F_136 ( & V_9 -> V_244 ) ;
V_392 = & V_9 -> V_386 ;
F_84 ( V_392 -> V_271 , V_267 , sizeof( V_392 -> V_271 ) ) ;
V_392 -> V_408 = V_409 ;
V_392 -> V_410 = & V_411 ;
V_392 -> V_412 = & V_413 ;
V_392 -> V_270 = & V_9 -> V_270 ;
V_392 -> V_414 = V_415 ;
V_392 -> V_416 = V_393 ;
V_392 -> V_240 = & V_9 -> V_240 ;
F_137 ( V_392 , V_9 ) ;
V_353 = F_138 ( & V_9 -> V_386 , V_417 , - 1 ) ;
if ( V_353 ) {
F_54 ( V_9 ,
L_68 ) ;
goto V_394;
...
static int F_140 ( struct V_376 * V_377 )
{
struct V_8 * V_9 = F_19 ( V_377 -> V_270 ,
struct V_8 , V_270 ) ;
return F_128 ( V_9 ) ;
...
unsigned int V_93 ;
int V_353 ;
F_142 ( & V_237 -> V_98 , L_69 ) ;
if ( ! F_143 ( V_424 ) || ! V_237 -> V_98 . V_425 )
return V_237 -> V_98 . V_426 ;
V_423 = F_144 ( & V_237 -> V_98 , sizeof( * V_423 ) , V_427 ) ;
if ( ! V_423 )
return NULL ;
for ( V_93 = 0 ; ; V_93 ++ ) {
struct V_419 * V_428 ;
V_420 = F_145 ( V_237 -> V_98 . V_425 ,
V_420 ) ;
if ( ! V_420 )
break;
V_16 = & V_423 -> V_234 [ V_93 ] ;
V_16 -> V_285 = 0 ;
V_16 -> V_321 [ 0 ] . V_289 = V_93 ;
strcpy ( V_16 -> V_321 [ 0 ] . V_271 , L_70 ) ;
V_16 -> V_321 [ 0 ] . type = V_429 ;
V_16 -> V_321 [ 0 ] . V_388 = V_430 ;
...
V_353 = F_147 ( V_420 , & V_422 ) ;
if ( V_353 ) {
F_148 ( & V_237 -> V_98 , L_72 ) ;
goto V_431;
}
V_16 -> V_19 . V_18 = V_422 . V_432 . V_433 . V_18 ;
if ( V_16 -> V_19 . V_18 < 8 ||
V_16 -> V_19 . V_18 > 16 ) {
F_148 ( & V_237 -> V_98 , L_73 ) ;
goto V_431;
}
V_349 = V_422 . V_432 . V_433 . V_349 ;
if ( V_349 & V_434 )
V_16 -> V_19 . V_208 = 1 ;
if ( V_349 & V_435 )
V_16 -> V_19 . V_207 = 1 ;
V_428 = F_149 ( V_420 ) ;
if ( ! V_428 ) {
F_148 ( & V_237 -> V_98 , L_74 ,
V_420 -> V_436 ) ;
goto V_431;
}
V_423 -> V_311 [ V_93 ] = F_144 ( & V_237 -> V_98 ,
sizeof( struct V_379 ) ,
V_427 ) ;
if ( ! V_423 -> V_311 [ V_93 ] ) {
F_150 ( V_428 ) ;
...
V_423 -> V_311 [ V_93 ] -> V_437 = V_438 ;
V_423 -> V_311 [ V_93 ] -> V_383 . V_384 . V_385 = V_428 ;
F_150 ( V_428 ) ;
}
F_150 ( V_420 ) ;
return V_423 ;
...
static int F_151 ( struct V_418 * V_237 )
{
struct V_312 * V_439 = F_141 ( V_237 ) ;
struct V_8 * V_9 ;
struct V_36 * V_37 ;
struct V_440 * V_441 ;
int V_225 ;
if ( ! V_439 ) {
F_148 ( & V_237 -> V_98 , L_75 ) ;
return - V_89 ;
}
V_9 = F_144 ( & V_237 -> V_98 , sizeof( * V_9 ) , V_427 ) ;
if ( ! V_9 )
return - V_442 ;
V_9 -> V_237 = & V_237 -> V_98 ;
V_9 -> V_47 = V_439 ;
V_37 = & V_9 -> V_37 ;
V_441 = F_152 ( V_237 , V_443 , 0 ) ;
V_37 -> V_39 . V_40 = F_153 ( & V_237 -> V_98 , V_441 ) ;
if ( F_132 ( V_37 -> V_39 . V_40 ) )
return F_133 ( V_37 -> V_39 . V_40 ) ;
V_225 = F_154 ( V_237 , 0 ) ;
if ( V_225 <= 0 ) {
F_148 ( & V_237 -> V_98 , L_76 ) ;
return - V_242 ;
}
V_9 -> V_253 = V_225 ;
V_225 = F_155 ( V_9 -> V_237 , V_9 -> V_253 , F_77 , 0 ,
L_77 , V_9 ) ;
if ( V_225 ) {
F_148 ( & V_237 -> V_98 , L_78 ) ;
return - V_89 ;
}
V_225 = F_156 ( & V_237 -> V_98 , & V_9 -> V_270 ) ;
if ( V_225 ) {
F_54 ( V_9 ,
L_79 ) ;
return V_225 ;
...
F_52 ( V_37 ) ;
F_32 ( & V_237 -> V_98 ) ;
V_9 -> V_235 = F_144 ( & V_237 -> V_98 , sizeof( struct V_378 * ) *
F_2 ( V_9 -> V_47 -> V_311 ) , V_427 ) ;
if ( ! V_9 -> V_235 ) {
V_225 = - V_442 ;
goto V_444;
}
V_9 -> V_377 . V_445 = V_9 -> V_47 -> V_311 ;
V_9 -> V_377 . V_446 = F_2 ( V_9 -> V_47 -> V_311 ) ;
V_9 -> V_377 . V_447 = F_126 ;
V_9 -> V_377 . V_448 = F_140 ;
V_225 = F_159 ( & V_9 -> V_270 ,
& V_9 -> V_377 ) ;
if ( V_225 ) {
F_54 ( V_9 , L_80 ) ;
V_225 = - V_89 ;
...
static int F_160 ( struct V_418 * V_237 )
{
struct V_8 * V_9 = F_161 ( V_237 ) ;
F_10 ( 2 , V_9 , L_81 ) ;
F_162 ( & V_237 -> V_98 ) ;
F_163 ( & V_9 -> V_377 ) ;
F_139 ( & V_9 -> V_270 ) ;
...
static void F_165 ( struct V_36 * V_37 )
{
V_37 -> V_449 [ V_46 >> 2 ] = F_14 ( V_37 , V_46 ) ;
V_37 -> V_449 [ V_77 >> 2 ] = F_14 ( V_37 , V_77 ) ;
V_37 -> V_449 [ V_76 >> 2 ] = F_14 ( V_37 , V_76 ) ;
V_37 -> V_449 [ V_202 >> 2 ] = F_14 ( V_37 , V_202 ) ;
V_37 -> V_449 [ V_72 >> 2 ] = F_14 ( V_37 , V_72 ) ;
V_37 -> V_449 [ V_73 >> 2 ] = F_14 ( V_37 , V_73 ) ;
V_37 -> V_449 [ V_75 >> 2 ] = F_14 ( V_37 , V_75 ) ;
V_37 -> V_449 [ V_74 >> 2 ] = F_14 ( V_37 , V_74 ) ;
V_37 -> V_449 [ V_67 >> 2 ] = F_14 ( V_37 , V_67 ) ;
V_37 -> V_449 [ V_71 >> 2 ] = F_14 ( V_37 , V_71 ) ;
V_37 -> V_449 [ V_120 >> 2 ] = F_14 ( V_37 , V_120 ) ;
V_37 -> V_449 [ V_140 >> 2 ] = F_14 ( V_37 , V_140 ) ;
V_37 -> V_449 [ V_95 >> 2 ] = F_14 ( V_37 , V_95 ) ;
V_37 -> V_449 [ V_450 >> 2 ] = F_14 ( V_37 ,
V_450 ) ;
V_37 -> V_449 [ V_451 >> 2 ] = F_14 ( V_37 ,
V_451 ) ;
V_37 -> V_449 [ V_62 >> 2 ] = F_14 ( V_37 ,
V_62 ) ;
V_37 -> V_449 [ V_69 >> 2 ] = F_14 ( V_37 ,
V_69 ) ;
V_37 -> V_449 [ V_70 >> 2 ] = F_14 ( V_37 ,
V_70 ) ;
V_37 -> V_449 [ V_78 >> 2 ] = F_14 ( V_37 ,
V_78 ) ;
}
static int F_166 ( struct V_97 * V_98 )
{
struct V_418 * V_237 = F_167 ( V_98 ) ;
struct V_8 * V_9 = F_161 ( V_237 ) ;
...
static void F_170 ( struct V_36 * V_37 )
{
F_16 ( V_37 , V_37 -> V_449 [ V_77 >> 2 ] , V_77 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_95 >> 2 ] , V_95 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_76 >> 2 ] , V_76 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_202 >> 2 ] , V_202 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_72 >> 2 ] , V_72 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_73 >> 2 ] , V_73 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_75 >> 2 ] , V_75 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_74 >> 2 ] , V_74 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_67 >> 2 ] , V_67 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_71 >> 2 ] , V_71 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_120 >> 2 ] , V_120 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_140 >> 2 ] , V_140 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_46 >> 2 ] , V_46 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_450 >> 2 ] ,
V_450 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_451 >> 2 ] ,
V_451 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_62 >> 2 ] ,
V_62 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_69 >> 2 ] ,
V_69 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_70 >> 2 ] ,
V_70 ) ;
F_16 ( V_37 , V_37 -> V_449 [ V_78 >> 2 ] ,
V_78 ) ;
}
static int F_171 ( struct V_97 * V_98 )
{
struct V_418 * V_237 = F_167 ( V_98 ) ;
struct V_8 * V_9 = F_161 ( V_237 ) ;
struct V_36 * V_37 = & V_9 -> V_37 ;
