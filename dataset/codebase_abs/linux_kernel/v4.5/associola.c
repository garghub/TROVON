...
F_127 ( V_6 , V_187 , F_128 ( V_187 -> V_202 ) ) ;
V_187 -> V_176 = 0 ;
}
...
static inline bool F_129 ( struct V_1 * V_2 )
{
struct V_9 * V_9 = F_2 ( V_2 -> V_15 . V_6 ) ;
switch ( V_2 -> V_20 ) {
case V_249 :
...
void F_130 ( struct V_1 * V_2 , unsigned int V_268 )
{
struct V_164 * V_269 ;
struct V_270 * V_271 ;
if ( V_2 -> V_272 ) {
...
return;
V_2 -> V_69 . V_85 = 0 ;
F_132 ( & V_2 -> V_91 , V_269 ) ;
V_271 = & V_2 -> V_55 [ V_49 ] ;
if ( F_41 ( V_271 ) )
F_42 ( V_2 ) ;
}
}
void F_133 ( struct V_1 * V_2 , unsigned int V_268 )
{
int V_275 ;
int V_276 = 0 ;
...
return F_137 ( & V_2 -> V_15 . V_18 , V_288 , V_286 ,
...
F_140 ( V_8 ) ;
F_54 ( & V_138 ) ;
V_291 = F_141 ( & V_139 , V_2 , 1 , 0 , V_292 ) ;
F_56 ( & V_138 ) ;
if ( V_290 )
F_142 () ;
if ( V_291 < 0 )
...
void F_146 ( const struct V_1 * V_2 )
{
struct V_164 * V_297 ;
struct V_164 * V_295 ;
F_84 (ack, tmp, &asoc->asconf_ack_list,
