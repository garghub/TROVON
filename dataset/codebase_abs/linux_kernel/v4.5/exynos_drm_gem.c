...
if ( V_50 > V_2 -> V_23 )
return - V_31 ;
V_11 = F_37 ( V_49 -> V_4 , V_48 , V_2 -> V_27 ,
V_2 -> V_13 , V_2 -> V_23 ,
& V_2 -> V_14 ) ;
if ( V_11 < 0 ) {
F_6 ( L_15 ) ;
...
V_11 = F_54 ( V_48 , ( unsigned long ) V_72 -> V_76 ,
F_55 ( V_74 , V_78 ) ) ;
V_77:
switch ( V_11 ) {
case 0 :
...
int F_56 ( struct V_84 * V_42 , struct V_47 * V_48 )
{
struct V_1 * V_2 ;
struct V_34 * V_35 ;
int V_11 ;
...
struct V_9 * F_62 ( struct V_34 * V_35 )
{
struct V_1 * V_2 = F_23 ( V_35 ) ;
int V_87 ;
V_87 = V_2 -> V_23 >> V_24 ;
return F_63 ( V_2 -> V_25 , V_87 ) ;
}
struct V_34 *
F_64 ( struct V_3 * V_4 ,
struct V_88 * V_89 ,
...
int V_87 ;
int V_11 ;
V_2 = F_24 ( V_4 , V_89 -> V_90 -> V_23 ) ;
if ( F_31 ( V_2 ) ) {
V_11 = F_33 ( V_2 ) ;
return F_26 ( V_11 ) ;
}
V_2 -> V_13 = F_65 ( V_10 -> V_61 ) ;
V_87 = V_2 -> V_23 >> V_24 ;
V_2 -> V_25 = F_66 ( V_87 , sizeof( struct V_26 * ) ) ;
if ( ! V_2 -> V_25 ) {
V_11 = - V_12 ;
goto V_91;
}
...
void F_68 ( struct V_34 * V_35 , void * V_93 )
{
}
