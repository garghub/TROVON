...
if ( F_13 ( V_11 ) -> V_34 < 4 ) {
V_18 = F_7 ( V_35 ) ;
V_24 -> V_36 . V_37 |= V_18 & V_38 ;
}
V_26 = V_24 -> V_39 ;
if ( F_14 ( V_13 -> V_11 ) )
F_15 ( V_24 , V_26 ) ;
V_24 -> V_4 . V_33 . V_40 = V_26 ;
}
...
struct V_10 * V_11 = V_3 -> V_4 . V_11 ;
struct V_12 * V_13 = V_11 -> V_14 ;
struct V_41 * V_42 = F_17 ( V_3 -> V_4 . V_42 ) ;
const struct V_43 * V_33 = & V_42 -> V_44 -> V_4 . V_33 ;
int V_9 = V_42 -> V_9 ;
T_1 V_45 ;
if ( F_14 ( V_11 ) ) {
F_18 ( V_13 , V_9 ) ;
...
V_45 |= V_15 -> V_55 ;
if ( F_13 ( V_11 ) -> V_34 == 4 ) {
if ( V_42 -> V_44 -> V_56 && V_42 -> V_44 -> V_57 == 18 )
V_45 |= V_58 ;
else
V_45 &= ~ V_58 ;
}
...
struct V_43 * V_71 = V_59 -> V_72 . V_71 ;
...
struct V_59 * V_59 =
& V_15 -> V_60 -> V_4 ;
struct V_43 * V_33 = & V_24 -> V_4 . V_33 ;
struct V_41 * V_41 = F_17 ( V_24 -> V_4 . V_42 ) ;
unsigned int V_80 ;
if ( F_13 ( V_11 ) -> V_34 < 4 && V_41 -> V_9 == 0 ) {
F_27 ( L_3 ) ;
return false ;
}
if ( V_15 -> V_55 == V_81 )
...
V_42 = F_65 ( V_7 ) -> V_4 . V_42 ;
if ( V_42 && V_42 -> V_121 -> V_122 ) {
F_66 ( V_42 ) ;
}
}
return 0 ;
}
static int F_67 ( const struct V_94 * V_88 )
{
F_50 ( L_8 , V_88 -> V_95 ) ;
return 1 ;
}
...
static int F_70 ( const struct V_94 * V_88 )
{
F_50 ( L_9 , V_88 -> V_95 ) ;
return 1 ;
}
...
{
if ( F_75 ( V_11 ) || F_8 ( V_11 ) )
return true ;
if ( F_13 ( V_11 ) -> V_34 <= 4 && F_76 ( V_11 ) && ! F_77 ( V_11 ) )
return true ;
return false ;
}
...
struct V_2 * V_3 ;
struct V_43 * V_146 ;
struct V_43 * V_71 = NULL ;
struct V_43 * V_147 = NULL ;
struct V_93 * V_93 ;
struct V_118 * V_42 ;
T_2 V_148 ;
T_1 V_149 ;
...
V_15 = F_79 ( sizeof( * V_15 ) , V_159 ) ;
if ( ! V_15 )
return;
V_92 = F_79 ( sizeof( * V_92 ) , V_159 ) ;
if ( ! V_92 ) {
F_61 ( V_15 ) ;
return;
}
...
V_59 = & V_92 -> V_4 ;
V_7 = & V_59 -> V_4 ;
F_81 ( V_11 , & V_59 -> V_4 , & V_160 ,
V_161 ) ;
F_82 ( V_11 , & V_8 -> V_4 , & V_162 ,
V_163 , NULL ) ;
V_8 -> V_122 = F_24 ;
V_8 -> V_164 = F_16 ;
V_8 -> V_165 = F_37 ;
...
if ( V_13 -> V_125 . V_189 ) {
F_38 ( L_15 ) ;
F_93 ( V_13 -> V_125 . V_189 ) ;
V_71 = F_47 ( V_11 , V_13 -> V_125 . V_189 ) ;
if ( V_71 ) {
V_71 -> type |= V_188 ;
goto V_22;
}
