...
int F_44 ( const char * V_4 , const char * * V_70 , T_3 V_71 )
{
struct V_3 V_72 ;
struct V_26 * V_18 ;
struct V_1 * V_2 ;
int V_66 ;
V_18 = F_45 ( & V_73 , NULL , V_4 ) ;
if ( ! V_18 ) {
F_46 ( V_74 L_2 , V_4 ) ;
return - V_75 ;
}
V_2 = F_41 ( V_18 ) ;
memcpy ( & V_72 , F_2 ( V_2 ) , sizeof( V_72 ) ) ;
F_8 ( ! V_72 . V_7 ) ;
for ( V_66 = 0 ; V_66 < V_71 ; V_66 ++ ) {
V_72 . V_39 = V_70 [ V_66 ] ;
if ( F_20 ( V_2 -> V_18 . V_15 , - 1 , & V_72 ,
V_72 . V_6 , NULL , 0 , NULL ) )
F_47 ( V_18 , L_3 ,
V_70 [ V_66 ] ) ;
}
return 0 ;
