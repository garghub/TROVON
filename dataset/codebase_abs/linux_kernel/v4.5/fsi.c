...
F_100 ( V_3 ) ;
F_101 ( V_155 , V_3 ) ;
V_32 -> V_144 = F_102 ( V_3 , V_156 ,
( void * ) V_32 -> V_157 ) ;
#else
V_32 -> V_144 = F_103 ( V_66 , V_33 ? L_31 : L_32 ) ;
#endif
if ( V_32 -> V_144 ) {
struct V_158 V_159 = {} ;
int V_7 ;
if ( V_33 ) {
V_159 . V_160 = V_14 -> V_161 + V_162 ;
V_159 . V_163 = V_164 ;
V_159 . V_165 = V_142 ;
} else {
V_159 . V_166 = V_14 -> V_161 + V_167 ;
V_159 . V_168 = V_164 ;
V_159 . V_165 = V_143 ;
}
V_7 = F_104 ( V_32 -> V_144 , & V_159 ) ;
if ( V_7 < 0 ) {
F_105 ( V_32 -> V_144 ) ;
V_32 -> V_144 = NULL ;
}
...
if ( ! V_32 -> V_144 ) {
if ( V_33 )
V_14 -> V_49 . V_169 = & V_170 ;
else
V_14 -> V_53 . V_169 = & V_171 ;
F_106 ( V_66 , L_33 ) ;
return F_38 ( V_14 , V_66 ) ;
}
return 0 ;
}
static int F_107 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
F_108 ( V_14 , V_32 ) ;
if ( V_32 -> V_144 )
F_105 ( V_32 -> V_144 ) ;
...
F_41 ( V_66 , L_35 ,
V_14 -> V_41 , V_172 ) ;
V_32 -> V_130 = F_23 ( V_14 , V_172 ) ;
if ( V_33 ) {
F_28 ( V_14 , V_175 , V_176 ) ;
F_62 ( V_14 , V_175 , V_152 , V_152 ) ;
} else {
F_28 ( V_14 , V_151 , V_176 ) ;
F_62 ( V_14 , V_151 , V_152 , V_152 ) ;
}
}
...
if ( F_12 ( V_14 ) )
V_2 = V_177 | V_178 ;
F_62 ( V_14 , V_106 , ( V_177 | V_178 ) , V_2 ) ;
V_2 = 0 ;
if ( V_14 -> V_179 )
V_2 |= ( 1 << 0 ) ;
if ( V_14 -> V_180 )
...
if ( F_14 ( V_14 ) ) {
F_49 ( V_14 , 1 ) ;
F_62 ( V_14 , V_182 , V_183 , V_183 ) ;
}
V_2 = 0 ;
switch ( V_32 -> V_63 ) {
case 2 :
V_2 = F_112 ( 16 , V_32 -> V_64 ) ;
break;
case 4 :
V_2 = F_112 ( 24 , V_32 -> V_64 ) ;
break;
}
...
static int F_116 ( struct V_18 * V_19 , int V_184 ,
struct V_22 * V_27 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
...
static int F_118 ( struct V_13 * V_14 , unsigned int V_75 )
{
switch ( V_75 & V_187 ) {
case V_188 :
V_14 -> V_75 = V_189 ;
...
if ( F_10 ( V_6 ) < 2 )
return - V_103 ;
V_14 -> V_75 = V_192 | V_191 ;
V_14 -> V_41 = 2 ;
return 0 ;
}
static int F_120 ( struct V_22 * V_27 , unsigned int V_75 )
{
...
static T_7 F_131 ( struct V_18 * V_19 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
struct V_31 * V_32 = F_29 ( V_14 , V_19 ) ;
...
V_217 -> V_8 = V_8 ;
F_41 ( V_66 , L_40 , V_213 , V_217 -> V_8 ) ;
}
...
V_14 -> V_53 . V_55 = V_14 ;
if ( V_217 -> V_223 ) {
V_14 -> V_49 . V_157 = V_217 -> V_223 ;
V_14 -> V_49 . V_169 = & V_224 ;
}
}
...
V_6 = F_143 ( & V_226 -> V_66 , sizeof( * V_6 ) , V_243 ) ;
if ( ! V_6 ) {
F_36 ( & V_226 -> V_66 , L_45 ) ;
return - V_244 ;
}
V_6 -> V_10 = F_144 ( & V_226 -> V_66 ,
...
V_14 = & V_6 -> V_29 ;
V_14 -> V_10 = V_6 -> V_10 ;
V_14 -> V_161 = V_231 -> V_153 ;
V_14 -> V_6 = V_6 ;
F_137 ( V_14 , & V_217 . V_235 ) ;
F_138 ( V_14 , & V_217 . V_235 ) ;
V_7 = F_38 ( V_14 , & V_226 -> V_66 ) ;
if ( V_7 < 0 ) {
...
V_14 -> V_161 = V_231 -> V_153 + 0x40 ;
V_14 -> V_6 = V_6 ;
F_137 ( V_14 , & V_217 . V_236 ) ;
F_138 ( V_14 , & V_217 . V_236 ) ;
V_7 = F_38 ( V_14 , & V_226 -> V_66 ) ;
if ( V_7 < 0 ) {
...
F_147 ( & V_226 -> V_66 ) ;
F_148 ( & V_226 -> V_66 , V_6 ) ;
V_7 = F_149 ( & V_226 -> V_66 , V_134 , & F_87 , 0 ,
F_150 ( & V_226 -> V_66 ) , V_6 ) ;
if ( V_7 ) {
F_36 ( & V_226 -> V_66 , L_49 ) ;
goto V_247;
}
V_7 = F_151 ( & V_226 -> V_66 , & V_248 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_226 -> V_66 , L_50 ) ;
goto V_247;
}
V_7 = F_152 ( & V_226 -> V_66 , & V_249 ,
V_250 , F_135 ( V_250 ) ) ;
if ( V_7 < 0 ) {
