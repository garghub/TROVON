...
static T_4 F_53 ( struct V_1 * V_1 , void * V_149 ,
char * V_150 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
...
return sprintf ( V_150 , L_18 , ( V_152 -> V_16 && V_12 ) ? - 1 : * V_16 ) ;
}
...
V_3 [ 2 ] < 40 )
return true ;
for ( V_23 = 0 ; V_23 < F_57 ( V_158 ) ; V_23 ++ )
if ( V_3 [ 2 ] == V_158 [ V_23 ] )
return false ;
return true ;
}
int F_58 ( struct V_1 * V_1 , bool V_159 )
{
struct V_4 * V_4 = & V_1 -> V_4 ;
unsigned char V_3 [ 3 ] ;
F_3 ( & V_1 -> V_4 , NULL , V_160 ) ;
...
{
int V_168 = ( V_10 -> V_30 & 0x0f0000 ) >> 16 ;
...
unsigned char V_3 [ 3 ] ;
struct V_27 * V_64 ;
V_1 -> V_11 = V_10 = F_68 ( sizeof( struct V_9 ) , V_172 ) ;
if ( ! V_10 )
return - V_173 ;
F_65 ( V_1 ) ;
V_10 -> V_91 [ 0 ] = 1 ;
...
error = F_70 ( & V_1 -> V_4 . V_165 -> V_28 . V_166 ,
& V_167 ) ;
if ( error ) {
F_4 ( V_1 ,
L_35 ,
...
V_10 -> V_64 = V_64 ;
snprintf ( V_10 -> V_178 , sizeof( V_10 -> V_178 ) , L_36 ,
V_1 -> V_4 . V_165 -> V_179 ) ;
V_64 -> V_179 = V_10 -> V_178 ;
V_64 -> V_164 = L_37 ;
V_64 -> V_73 . V_180 = V_181 ;
V_64 -> V_73 . V_163 = 0x0002 ;
V_64 -> V_73 . V_182 = V_183 ;
V_64 -> V_73 . V_184 = 0x0000 ;
V_64 -> V_28 . V_185 = & V_1 -> V_4 . V_165 -> V_28 ;
V_64 -> V_139 [ 0 ] = F_72 ( V_138 ) | F_72 ( V_141 ) ;
V_64 -> V_186 [ F_73 ( V_67 ) ] =
F_72 ( V_67 ) | F_72 ( V_68 ) ;
V_64 -> V_136 [ F_73 ( V_40 ) ] =
F_72 ( V_40 ) | F_72 ( V_66 ) |
F_72 ( V_41 ) ;
F_45 ( V_137 , V_64 -> V_135 ) ;
F_45 ( V_187 , V_64 -> V_135 ) ;
