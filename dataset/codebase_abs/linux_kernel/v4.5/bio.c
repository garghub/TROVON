...
unsigned int V_111 = V_145 ? F_103 ( V_145 -> V_111 ) : 0 ;
...
F_105 ( & V_138 -> V_87 , V_87 -> type , V_138 -> V_152 ,
V_87 -> V_148 , V_87 -> V_147 ) ;
V_102 = - V_123 ;
V_4 = F_106 ( V_37 , V_146 ) ;
if ( ! V_4 )
goto V_158;
if ( V_87 -> type & V_159 )
V_4 -> V_99 |= V_160 ;
...
struct V_4 * F_107 ( struct V_92 * V_93 ,
const struct V_136 * V_87 ,
T_2 V_37 )
{
int V_168 ;
...
return F_104 ( - V_123 ) ;
V_102 = - V_123 ;
V_163 = F_110 ( V_146 , sizeof( struct V_109 * ) , V_37 ) ;
if ( ! V_163 )
goto V_26;
F_108 (iov, i, *iter) {
unsigned long V_149 = ( unsigned long ) V_152 . V_153 ;
...
struct V_4 * F_118 ( struct V_92 * V_93 , void * V_88 , unsigned int V_110 ,
T_2 V_37 )
{
