...
V_23 -> V_36 &= ~ V_50 ;
F_16 ( V_23 , V_32 ) ;
V_77 = F_27 ( & V_2 -> V_82 . V_83 , & V_23 -> V_21 , V_10 , type ,
...
int F_30 ( struct V_22 * V_23 , void * * V_89 )
{
bool V_90 ;
int V_77 ;
if ( V_23 -> V_36 & V_41 )
...
V_77 = F_31 ( & V_23 -> V_21 , 0 , V_23 -> V_21 . V_93 , & V_23 -> V_94 ) ;
if ( V_77 ) {
return V_77 ;
}
V_23 -> V_92 = F_32 ( & V_23 -> V_94 , & V_90 ) ;
if ( V_89 ) {
* V_89 = V_23 -> V_92 ;
}
return 0 ;
...
struct V_22 * F_35 ( struct V_22 * V_23 )
{
if ( V_23 == NULL )
return NULL ;
F_36 ( & V_23 -> V_21 ) ;
...
int F_38 ( struct V_22 * V_23 , T_2 V_35 ,
T_1 V_95 , T_1 V_96 ,
T_1 * V_97 )
{
int V_77 , V_38 ;
unsigned V_43 , V_64 ;
if ( F_39 ( V_23 -> V_21 . V_98 ) )
return - V_91 ;
if ( F_40 ( V_95 > V_96 ) )
return - V_99 ;
if ( V_23 -> V_100 ) {
...
if ( ! V_23 -> V_34 [ V_38 ] . V_64 ||
( V_64 && V_64 < V_23 -> V_34 [ V_38 ] . V_64 ) )
V_23 -> V_34 [ V_38 ] . V_64 = V_64 ;
V_23 -> V_34 [ V_38 ] . V_36 |= V_104 ;
}
V_77 = F_42 ( & V_23 -> V_21 , & V_23 -> V_32 , false , false ) ;
if ( F_43 ( V_77 == 0 ) ) {
V_23 -> V_100 = 1 ;
if ( V_97 != NULL )
* V_97 = F_41 ( V_23 ) ;
if ( V_35 == V_40 )
V_23 -> V_2 -> V_105 += F_44 ( V_23 ) ;
else
V_23 -> V_2 -> V_106 += F_44 ( V_23 ) ;
} else {
F_45 ( V_23 -> V_2 -> V_107 , L_1 , V_23 ) ;
}
return V_77 ;
}
int F_46 ( struct V_22 * V_23 , T_2 V_35 , T_1 * V_97 )
{
return F_38 ( V_23 , V_35 , 0 , 0 , V_97 ) ;
}
int F_47 ( struct V_22 * V_23 )
{
int V_77 , V_38 ;
if ( ! V_23 -> V_100 ) {
F_48 ( V_23 -> V_2 -> V_107 , L_2 , V_23 ) ;
return 0 ;
}
V_23 -> V_100 -- ;
if ( V_23 -> V_100 )
...
return F_50 ( & V_2 -> V_82 . V_83 , V_17 ) ;
}
void F_51 ( struct V_1 * V_2 )
{
struct V_22 * V_23 , * V_109 ;
if ( F_52 ( & V_2 -> V_24 . V_110 ) ) {
return;
}
F_45 ( V_2 -> V_107 , L_4 ) ;
F_53 (bo, n, &adev->gem.objects, list) {
F_45 ( V_2 -> V_107 , L_5 ,
...
{
V_2 -> V_8 . V_112 = F_56 ( V_2 -> V_8 . V_113 ,
V_2 -> V_8 . V_114 ) ;
F_57 ( L_6 ,
V_2 -> V_8 . V_115 >> 20 ,
...
struct V_117 * V_118 )
{
return F_63 ( V_118 , & V_23 -> V_21 ) ;
}
int F_64 ( struct V_22 * V_23 , T_1 V_119 )
{
if ( F_65 ( V_119 , V_120 ) > 6 )
return - V_99 ;
V_23 -> V_119 = V_119 ;
return 0 ;
}
void F_66 ( struct V_22 * V_23 , T_1 * V_119 )
{
F_67 ( & V_23 -> V_21 . V_72 -> V_121 . V_122 ) ;
if ( V_119 )
* V_119 = V_23 -> V_119 ;
}
int F_68 ( struct V_22 * V_23 , void * V_29 ,
T_4 V_123 , T_5 V_36 )
{
void * V_124 ;
if ( ! V_123 ) {
...
int F_70 ( struct V_22 * V_23 , void * V_124 ,
T_3 V_126 , T_4 * V_123 ,
T_5 * V_36 )
{
if ( ! V_124 && ! V_123 )
...
V_77 = F_42 ( V_23 , & V_127 -> V_32 , false , false ) ;
if ( F_24 ( V_77 == - V_85 ) ) {
F_15 ( V_127 , V_49 ) ;
return F_42 ( V_23 , & V_127 -> V_32 , false , false ) ;
} else if ( F_24 ( V_77 != 0 ) ) {
return V_77 ;
}
V_128 = V_23 -> V_4 . V_6 << V_7 ;
...
void F_74 ( struct V_22 * V_23 , struct V_129 * V_129 ,
bool V_130 )
{
