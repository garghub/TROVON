...
static T_3 F_25 ( int V_61 , void * V_62 )
{
...
F_23 ( V_24 -> V_38 , L_8 , ( V_58 >> 16 ) & 0xf ) ;
return 0 ;
}
...
int V_10 ;
if ( F_30 ( V_68 ) ) {
V_24 -> V_82 = F_35 ( V_81 , L_12 ) ;
if ( V_24 -> V_82 <= 0 ) {
F_15 ( & V_81 -> V_38 , L_13 ) ;
return - V_83 ;
}
V_10 = F_36 ( & V_81 -> V_38 , V_24 -> V_82 ,
F_25 ,
V_84 | V_85 ,
L_14 , V_24 ) ;
if ( V_10 ) {
...
struct V_89 * V_1 ;
int V_10 ;
V_25 = F_39 ( & V_81 -> V_38 , sizeof( * V_25 ) , V_90 ) ;
if ( ! V_25 )
return - V_91 ;
V_24 = & V_25 -> V_24 ;
V_24 -> V_38 = & V_81 -> V_38 ;
...
L_17 ) ;
V_1 = F_41 ( V_81 , V_93 , 0 ) ;
V_24 -> V_1 = F_42 ( & V_81 -> V_38 , V_1 ) ;
if ( F_43 ( V_24 -> V_1 ) )
return F_44 ( V_24 -> V_1 ) ;
V_25 -> V_44 = F_45 ( & V_81 -> V_38 , L_18 ,
V_94 ) ;
V_25 -> V_37 = F_46 ( & V_81 -> V_38 , L_19 ) ;
if ( F_43 ( V_25 -> V_37 ) ) {
F_15 ( & V_81 -> V_38 ,
L_20 ) ;
return F_44 ( V_25 -> V_37 ) ;
}
V_25 -> V_40 = F_46 ( & V_81 -> V_38 , L_21 ) ;
if ( F_43 ( V_25 -> V_40 ) ) {
F_15 ( & V_81 -> V_38 ,
L_22 ) ;
return F_44 ( V_25 -> V_40 ) ;
}
V_25 -> V_42 = F_46 ( & V_81 -> V_38 , L_23 ) ;
if ( F_43 ( V_25 -> V_42 ) ) {
F_15 ( & V_81 -> V_38 ,
L_24 ) ;
...
{
struct V_25 * V_25 = F_50 ( V_81 ) ;
F_9 ( & V_25 -> V_24 ) ;
}
static int T_4 F_51 ( void )
{
return F_52 ( & V_95 , F_38 ) ;
}
