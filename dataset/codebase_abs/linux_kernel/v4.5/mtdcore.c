...
int F_85 ( struct V_3 * V_4 , T_4 V_118 , T_3 V_111 , T_3 * V_119 ,
...
int F_86 ( struct V_3 * V_4 , T_4 V_118 , T_3 V_111 )
{
if ( ! V_4 -> V_122 )
return - V_68 ;
if ( V_118 < 0 || V_118 >= V_4 -> V_22 || V_111 > V_4 -> V_22 - V_118 )
...
unsigned long F_87 ( struct V_3 * V_4 , unsigned long V_111 ,
...
int F_88 ( struct V_3 * V_4 , T_4 V_118 , T_3 V_111 , T_3 * V_119 ,
T_6 * V_11 )
{
int V_126 ;
* V_119 = 0 ;
...
int F_90 ( struct V_3 * V_4 , T_4 V_129 , T_3 V_111 , T_3 * V_119 ,
const T_6 * V_11 )
{
* V_119 = 0 ;
...
int F_92 ( struct V_3 * V_4 , T_4 V_118 , struct V_132 * V_133 )
{
int V_126 ;
...
int F_93 ( struct V_3 * V_4 , T_3 V_111 , T_3 * V_119 ,
struct V_136 * V_11 )
{
if ( ! V_4 -> V_137 )
return - V_68 ;
if ( ! V_111 )
return 0 ;
return V_4 -> V_137 ( V_4 , V_111 , V_119 , V_11 ) ;
}
int F_94 ( struct V_3 * V_4 , T_4 V_118 , T_3 V_111 ,
T_3 * V_119 , T_6 * V_11 )
{
* V_119 = 0 ;
if ( ! V_4 -> V_138 )
...
if ( ! V_111 )
return 0 ;
return V_4 -> V_138 ( V_4 , V_118 , V_111 , V_119 , V_11 ) ;
}
int F_95 ( struct V_3 * V_4 , T_3 V_111 , T_3 * V_119 ,
struct V_136 * V_11 )
{
if ( ! V_4 -> V_139 )
return - V_68 ;
if ( ! V_111 )
return 0 ;
return V_4 -> V_139 ( V_4 , V_111 , V_119 , V_11 ) ;
}
int F_96 ( struct V_3 * V_4 , T_4 V_118 , T_3 V_111 ,
T_3 * V_119 , T_6 * V_11 )
{
* V_119 = 0 ;
if ( ! V_4 -> V_140 )
...
if ( ! V_111 )
return 0 ;
return V_4 -> V_140 ( V_4 , V_118 , V_111 , V_119 , V_11 ) ;
}
int F_97 ( struct V_3 * V_4 , T_4 V_129 , T_3 V_111 ,
T_3 * V_119 , T_6 * V_11 )
{
int V_77 ;
* V_119 = 0 ;
...
if ( ! V_111 )
return 0 ;
V_77 = V_4 -> V_141 ( V_4 , V_129 , V_111 , V_119 , V_11 ) ;
if ( V_77 )
return V_77 ;
return ( * V_119 ) ? 0 : - V_142 ;
}
int F_98 ( struct V_3 * V_4 , T_4 V_118 , T_3 V_111 )
{
if ( ! V_4 -> V_143 )
return - V_68 ;
if ( ! V_111 )
return 0 ;
return V_4 -> V_143 ( V_4 , V_118 , V_111 ) ;
}
int F_99 ( struct V_3 * V_4 , T_4 V_144 , T_7 V_111 )
{
if ( ! V_4 -> V_145 )
return - V_68 ;
if ( V_144 < 0 || V_144 >= V_4 -> V_22 || V_111 > V_4 -> V_22 - V_144 )
return - V_112 ;
if ( ! V_111 )
return 0 ;
return V_4 -> V_145 ( V_4 , V_144 , V_111 ) ;
}
int F_39 ( struct V_3 * V_4 , T_4 V_144 , T_7 V_111 )
{
if ( ! V_4 -> V_146 )
return - V_68 ;
if ( V_144 < 0 || V_144 >= V_4 -> V_22 || V_111 > V_4 -> V_22 - V_144 )
...
if ( ! V_111 )
return 0 ;
return V_4 -> V_146 ( V_4 , V_144 , V_111 ) ;
}
int F_100 ( struct V_3 * V_4 , T_4 V_144 , T_7 V_111 )
{
if ( ! V_4 -> V_147 )
return - V_68 ;
if ( V_144 < 0 || V_144 >= V_4 -> V_22 || V_111 > V_4 -> V_22 - V_144 )
...
if ( ! V_111 )
return 0 ;
return V_4 -> V_147 ( V_4 , V_144 , V_111 ) ;
}
int F_101 ( struct V_3 * V_4 , T_4 V_144 )
{
if ( V_144 < 0 || V_144 >= V_4 -> V_22 )
return - V_112 ;
if ( ! V_4 -> V_148 )
return 0 ;
return V_4 -> V_148 ( V_4 , V_144 ) ;
}
int F_102 ( struct V_3 * V_4 , T_4 V_144 )
{
if ( V_144 < 0 || V_144 >= V_4 -> V_22 )
return - V_112 ;
if ( ! V_4 -> V_149 )
return 0 ;
return V_4 -> V_149 ( V_4 , V_144 ) ;
}
int F_103 ( struct V_3 * V_4 , T_4 V_144 )
{
if ( ! V_4 -> V_150 )
return - V_68 ;
if ( V_144 < 0 || V_144 >= V_4 -> V_22 )
...
if ( ! ( V_4 -> V_21 & V_66 ) )
return - V_113 ;
return V_4 -> V_150 ( V_4 , V_144 ) ;
}
static int F_104 ( struct V_3 * V_4 , const struct V_151 * V_152 ,
...
if ( ! V_152 [ V_5 ] . V_155 )
continue;
V_77 = F_90 ( V_4 , V_129 , V_152 [ V_5 ] . V_155 , & V_154 ,
V_152 [ V_5 ] . V_156 ) ;
V_153 += V_154 ;
if ( V_77 || V_154 != V_152 [ V_5 ] . V_155 )
break;
V_129 += V_152 [ V_5 ] . V_155 ;
}
* V_119 = V_153 ;
return V_77 ;
}
int F_105 ( struct V_3 * V_4 , const struct V_151 * V_152 ,
unsigned long V_32 , T_4 V_129 , T_3 * V_119 )
{
* V_119 = 0 ;
if ( ! ( V_4 -> V_21 & V_66 ) )
return - V_113 ;
if ( ! V_4 -> V_157 )
return F_104 ( V_4 , V_152 , V_32 , V_129 , V_119 ) ;
return V_4 -> V_157 ( V_4 , V_152 , V_32 , V_129 , V_119 ) ;
}
void * F_106 ( const struct V_3 * V_4 , T_3 * V_22 )
{
T_8 V_21 = V_158 | V_159 | V_160 ;
T_3 V_161 = F_107 ( T_3 , V_4 -> V_24 , V_20 ) ;
void * V_162 ;
* V_22 = F_108 ( T_3 , * V_22 , V_163 ) ;
while ( * V_22 > V_161 ) {
V_162 = F_109 ( * V_22 , V_21 ) ;
if ( V_162 )
return V_162 ;
* V_22 >>= 1 ;
* V_22 = F_110 ( * V_22 , V_4 -> V_24 ) ;
}
return F_109 ( * V_22 , V_59 ) ;
}
static int F_111 ( struct V_164 * V_165 , void * V_166 )
{
struct V_3 * V_4 ;
F_112 ( V_165 , L_23 ) ;
F_35 ( & V_58 ) ;
...
static int F_114 ( struct V_167 * V_167 , struct V_168 * V_168 )
{
return F_115 ( V_168 , F_111 , NULL ) ;
}
static int T_9 F_116 ( struct V_55 * V_169 , const char * V_29 )
{
int V_77 ;
V_77 = F_117 ( V_169 ) ;
if ( ! V_77 )
V_77 = F_118 ( V_169 , NULL , L_25 , V_29 ) ;
if ( V_77 )
F_119 ( V_169 ) ;
return V_77 ;
}
...
if ( V_77 )
goto V_170;
V_77 = F_116 ( & V_57 , L_26 ) ;
if ( V_77 )
goto V_171;
V_172 = F_122 ( L_26 , 0 , NULL , & V_173 ) ;
V_77 = F_123 () ;
if ( V_77 )
goto V_174;
return 0 ;
