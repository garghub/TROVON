...
F_11 ( V_15 , V_76 , V_5 ) ;
V_19 &= ~ ( V_72 - 1 ) ;
V_5 -> V_78 -> V_79 ( V_19 , V_72 , V_72 , true , V_18 -> V_23 . V_80 ) ;
return V_2 ;
}
...
if ( ! F_14 ( V_16 , V_22 ) ) {
V_78 -> V_79 ( V_19 , V_2 , F_22 ( V_18 ) ,
false , V_80 ) ;
V_78 -> V_82 ( V_80 ) ;
V_15 = F_24 ( V_16 , V_18 ) ;
F_30 ( V_18 , V_22 + 1 , V_15 ) ;
} else {
V_78 -> V_79 ( V_19 , V_2 , V_2 , true , V_80 ) ;
}
return V_2 ;
...
static int F_37 ( struct V_62 * V_63 , unsigned long V_19 ,
T_2 V_2 )
{
T_2 V_83 ;
struct V_17 * V_18 = F_27 ( V_63 ) ;
...
static T_5 F_38 ( struct V_62 * V_63 ,
unsigned long V_19 )
{
struct V_17 * V_18 = F_27 ( V_63 ) ;
...
V_18 = F_43 ( sizeof( * V_18 ) , V_101 ) ;
if ( ! V_18 )
return NULL ;
V_18 -> V_37 = F_41 ( V_5 -> V_40 ) ;
V_18 -> V_102 = V_18 -> V_37 - F_44 ( sizeof( T_4 ) ) ;
V_95 = V_5 -> V_97 - V_18 -> V_37 ;
V_18 -> V_103 = F_45 ( V_95 , V_18 -> V_102 ) ;
V_96 = V_95 - ( V_18 -> V_102 * ( V_18 -> V_103 - 1 ) ) ;
V_18 -> V_70 = 1UL << ( V_96 + F_44 ( sizeof( T_4 ) ) ) ;
...
static struct V_71 *
F_46 ( struct V_4 * V_5 , void * V_80 )
{
T_6 V_107 ;
struct V_17 * V_18 = F_42 ( V_5 ) ;
if ( ! V_18 )
return NULL ;
V_107 = ( V_108 << V_109 ) |
( V_110 << V_111 ) |
...
if ( V_18 -> V_103 == V_32 ) {
unsigned long V_136 ;
V_136 = V_18 -> V_70 >> F_44 ( sizeof( T_4 ) ) ;
if ( V_136 <= V_137 ) {
...
static void F_51 ( void * V_80 )
{
F_15 ( V_80 != V_146 ) ;
}
static void F_52 ( unsigned long V_19 , T_2 V_2 ,
T_2 V_85 , bool V_147 , void * V_80 )
{
F_15 ( V_80 != V_146 ) ;
F_15 ( ! ( V_2 & V_146 -> V_40 ) ) ;
}
static void F_53 ( void * V_80 )
{
F_15 ( V_80 != V_146 ) ;
}
static void T_7 F_54 ( struct V_62 * V_63 )
{
struct V_17 * V_18 = F_27 ( V_63 ) ;
struct V_4 * V_5 = & V_18 -> V_23 . V_5 ;
F_55 ( L_3 ,
...
static int T_7 F_56 ( struct V_4 * V_5 )
{
...
struct V_62 * V_63 ;
V_11 = true ;
for ( V_151 = 0 ; V_151 < F_57 ( V_149 ) ; ++ V_151 ) {
V_146 = V_5 ;
V_63 = F_58 ( V_149 [ V_151 ] , V_5 , V_5 ) ;
if ( ! V_63 ) {
F_55 ( L_5 ) ;
return - V_42 ;
}
if ( V_63 -> V_106 ( V_63 , 42 ) )
return F_59 ( V_63 , V_151 ) ;
if ( V_63 -> V_106 ( V_63 , V_90 + 42 ) )
return F_59 ( V_63 , V_151 ) ;
if ( V_63 -> V_106 ( V_63 , V_153 + 42 ) )
return F_59 ( V_63 , V_151 ) ;
V_19 = 0 ;
V_152 = F_60 ( & V_5 -> V_40 , V_154 ) ;
while ( V_152 != V_154 ) {
V_2 = 1UL << V_152 ;
...
V_19 += V_90 ;
V_152 ++ ;
V_152 = F_61 ( & V_5 -> V_40 , V_154 , V_152 ) ;
}
V_2 = 1UL << F_41 ( V_5 -> V_40 ) ;
...
for ( V_151 = 0 ; V_151 < F_57 ( V_155 ) ; ++ V_151 ) {
for ( V_152 = 0 ; V_152 < F_57 ( V_97 ) ; ++ V_152 ) {
