...
struct V_88 * V_89 )
{
struct V_17 * V_18 = F_24 ( V_82 ) ;
struct V_27 * V_28 = V_18 -> V_28 ;
int V_90 = V_18 -> V_91 . V_92 , V_83 ;
...
V_106 = F_30 ( V_89 ) * 32 * F_31 ( V_89 ) ;
if ( F_32 ( V_18 -> V_109 ) )
return - V_110 ;
V_107 = V_18 -> V_111 & ~ ( F_33 ( V_76 -> V_112 ) ) ;
V_95 = 0 ;
V_94 = 0 ;
...
if ( V_107 )
V_101 = F_34 ( V_18 -> V_109 ) ;
else
V_101 = F_35 ( V_18 -> V_109 , V_103 ) ;
if ( V_101 * 5 > F_34 ( V_18 -> V_84 ) )
continue;
V_101 /= V_99 ;
V_98 = V_101 / ( V_100 + 1 ) ;
if ( V_106 == V_98 )
...
V_96 = F_38 ( V_93 + 1 ) | ( V_94 ? V_113 : 0 ) |
( V_95 ? V_114 : 0 ) ;
V_97 = V_115 | V_113 |
V_114 ;
if ( V_76 -> V_112 == V_116 || V_90 )
F_13 ( V_28 , V_70 , V_97 , V_96 ) ;
else
F_13 ( V_28 , V_71 , V_97 , V_96 ) ;
if ( ! V_107 ) {
V_83 = F_39 ( V_18 -> V_109 , V_102 ) ;
if ( V_83 ) {
F_37 ( V_82 -> V_2 , L_2 ) ;
return - V_110 ;
}
...
static int F_40 ( struct V_77 * V_82 ,
...
struct V_17 * V_18 = F_24 ( V_82 ) ;
struct V_27 * V_28 = V_18 -> V_28 ;
unsigned int V_119 = F_30 ( V_89 ) ;
unsigned int V_120 = F_42 ( V_89 ) ;
T_3 V_121 = F_20 ( V_120 ) ;
int V_83 ;
T_3 V_50 ;
int V_122 ;
F_9 ( V_28 , V_52 , & V_50 ) ;
V_122 = V_50 & V_62 ;
if ( V_122 && V_18 -> V_91 . V_92 )
return 0 ;
if ( F_6 ( V_18 ) ) {
V_83 = F_29 ( V_76 , V_82 , V_89 ) ;
if ( V_83 )
return V_83 ;
if ( ! ( V_18 -> V_111 & F_33 ( V_76 -> V_112 ) ) ) {
V_83 = F_25 ( V_18 -> V_109 ) ;
if ( V_83 )
return V_83 ;
V_18 -> V_111 |= F_33 ( V_76 -> V_112 ) ;
}
}
if ( ! F_5 ( V_18 ) ) {
T_5 V_123 ;
if ( F_7 ( V_18 ) && V_120 == 16 )
V_123 = V_124 |
V_125 ;
else
V_123 = V_18 -> V_126 ;
...
if ( ( V_76 -> V_112 == V_116 ) ||
V_18 -> V_91 . V_92 )
F_13 ( V_28 , V_70 , V_128 ,
V_121 ) ;
else
F_13 ( V_28 , V_71 , V_128 ,
V_121 ) ;
return 0 ;
}
...
{
struct V_27 * V_28 = V_18 -> V_28 ;
T_3 V_130 = 0 , V_46 , V_44 , V_55 , V_97 ;
T_5 V_131 ;
V_18 -> V_19 = V_129 ;
if ( F_6 ( V_18 ) && F_32 ( V_18 -> V_109 ) ) {
F_37 ( V_2 , L_3 ) ;
return - V_110 ;
}
F_18 ( V_18 ) ;
...
if ( V_18 -> V_85 ) {
F_13 ( V_28 , V_43 , V_157 ,
V_157 ) ;
F_13 ( V_28 , V_45 , V_158 ,
V_158 ) ;
F_13 ( V_28 , V_52 , V_159 ,
V_159 ) ;
}
if ( ( V_129 & V_20 ) == V_21 )
F_19 ( V_18 ) ;
...
{
struct V_17 * V_18 = F_24 ( V_82 ) ;
return F_44 ( V_82 -> V_2 , V_18 , V_129 ) ;
}
...
F_13 ( V_28 , V_70 , V_143 ,
F_21 ( V_162 ) ) ;
F_13 ( V_28 , V_71 , V_143 ,
F_21 ( V_162 ) ) ;
F_9 ( V_28 , V_52 , & V_164 ) ;
V_164 &= V_62 ;
F_13 ( V_28 , V_52 , V_62 ,
V_62 ) ;
F_10 ( V_28 , V_165 , ~ V_160 ) ;
F_10 ( V_28 , V_166 , ~ V_161 ) ;
F_13 ( V_28 , V_52 , V_62 , V_164 ) ;
return 0 ;
}
...
{
struct V_79 * V_80 = V_76 -> V_81 ;
struct V_17 * V_18 = F_24 ( V_80 -> V_82 ) ;
struct V_27 * V_28 = V_18 -> V_28 ;
switch ( V_167 ) {
case V_168 :
case V_169 :
...
if ( F_5 ( V_18 ) ) {
if ( V_76 -> V_112 == V_116 )
F_10 ( V_28 , V_74 , V_174 ) ;
else
F_10 ( V_28 , V_74 , V_175 ) ;
}
return 0 ;
}
static int F_52 ( struct V_77 * V_78 )
{
struct V_17 * V_18 = F_24 ( V_78 ) ;
if ( V_18 -> V_31 -> V_176 && V_18 -> V_63 ) {
V_78 -> V_177 = & V_18 -> V_178 ;
V_78 -> V_179 = & V_18 -> V_180 ;
}
return 0 ;
}
...
{
struct V_27 * V_28 = V_183 -> V_28 ;
unsigned int V_184 ;
unsigned int V_185 ;
int V_83 ;
if ( V_3 > 0x7f )
return;
V_83 = F_25 ( V_183 -> V_84 ) ;
if ( V_83 ) {
F_54 ( L_5 ,
V_83 ) ;
return;
...
V_184 = V_3 << 12 ;
F_10 ( V_28 , V_13 , V_184 ) ;
V_185 = V_164 << 4 ;
F_10 ( V_28 , V_14 , V_185 ) ;
F_13 ( V_28 , V_12 , V_186 ,
V_187 ) ;
F_55 ( 100 ) ;
F_28 ( V_183 -> V_84 ) ;
}
...
struct V_17 * V_18 , void T_6 * V_195 )
{
struct V_196 * V_197 = V_194 -> V_2 . V_198 ;
T_3 V_199 [ 4 ] ;
int V_83 ;
if ( V_18 -> V_200 )
V_18 -> V_84 = F_59 ( & V_194 -> V_2 , L_7 ) ;
else
V_18 -> V_84 = F_59 ( & V_194 -> V_2 , NULL ) ;
if ( F_32 ( V_18 -> V_84 ) ) {
V_83 = F_60 ( V_18 -> V_84 ) ;
F_37 ( & V_194 -> V_2 , L_8 , V_83 ) ;
return V_83 ;
}
if ( ! V_18 -> V_200 ) {
V_83 = F_25 ( V_18 -> V_84 ) ;
if ( V_83 ) {
F_37 ( & V_194 -> V_2 , L_9 , V_83 ) ;
return V_83 ;
}
}
V_18 -> V_109 = F_59 ( & V_194 -> V_2 , L_10 ) ;
if ( F_32 ( V_18 -> V_109 ) )
F_61 ( & V_194 -> V_2 , L_11 ,
F_60 ( V_18 -> V_109 ) ) ;
V_18 -> V_178 . V_201 = V_18 -> V_156 - 2 ;
V_18 -> V_180 . V_201 = V_18 -> V_156 - 2 ;
V_18 -> V_178 . V_202 = V_18 -> V_203 + V_6 ;
V_18 -> V_180 . V_202 = V_18 -> V_203 + V_8 ;
V_83 = F_62 ( V_197 , L_12 , V_199 , 4 ) ;
if ( V_18 -> V_63 && ! V_83 && V_199 [ 2 ] == V_204 ) {
V_18 -> V_85 = true ;
V_18 -> V_178 . V_201 &= ~ 0x1 ;
V_18 -> V_180 . V_201 &= ~ 0x1 ;
}
if ( ! V_18 -> V_63 ) {
V_18 -> V_205 . V_25 = V_18 -> V_25 ;
V_18 -> V_205 . V_206 = V_195 ;
V_18 -> V_205 . V_180 =
& V_18 -> V_180 ;
V_18 -> V_205 . V_178 =
& V_18 -> V_178 ;
V_83 = F_63 ( V_194 , & V_18 -> V_205 ) ;
if ( V_83 )
goto V_207;
} else {
...
return - V_110 ;
V_18 = F_69 ( & V_194 -> V_2 , sizeof( * V_18 ) ,
V_218 ) ;
if ( ! V_18 ) {
F_37 ( & V_194 -> V_2 , L_13 ) ;
return - V_219 ;
}
V_18 -> V_31 = V_210 -> V_217 ;
V_211 = F_70 ( V_197 , L_14 , NULL ) ;
if ( V_211 ) {
if ( ! strcmp ( V_211 , L_15 ) )
V_18 -> V_19 = V_21 ;
}
V_18 -> V_63 = ! F_71 ( V_197 ,
L_16 ) ;
if ( F_5 ( V_18 ) ) {
memcpy ( & V_18 -> V_91 , & V_220 ,
sizeof( V_220 ) ) ;
V_183 = V_18 ;
...
memcpy ( & V_18 -> V_91 , & V_222 ,
sizeof( V_222 ) ) ;
}
V_18 -> V_91 . V_215 = F_73 ( & V_194 -> V_2 ) ;
V_214 = F_74 ( V_194 , V_223 , 0 ) ;
V_195 = F_75 ( & V_194 -> V_2 , V_214 ) ;
if ( F_32 ( V_195 ) )
return F_60 ( V_195 ) ;
V_18 -> V_203 = V_214 -> V_224 ;
V_83 = F_76 ( V_197 , L_18 , L_7 ) ;
if ( V_83 < 0 ) {
V_18 -> V_200 = false ;
V_18 -> V_28 = F_77 ( & V_194 -> V_2 , V_195 ,
& V_225 ) ;
} else {
V_18 -> V_200 = true ;
V_18 -> V_28 = F_78 ( & V_194 -> V_2 ,
L_7 , V_195 , & V_225 ) ;
}
if ( F_32 ( V_18 -> V_28 ) ) {
F_37 ( & V_194 -> V_2 , L_19 ) ;
...
V_18 -> V_25 = F_79 ( V_194 , 0 ) ;
if ( V_18 -> V_25 < 0 ) {
F_37 ( & V_194 -> V_2 , L_20 , V_194 -> V_215 ) ;
return V_18 -> V_25 ;
}
...
if ( V_212 )
V_18 -> V_156 = F_81 ( V_212 ) ;
else
V_18 -> V_156 = 8 ;
F_82 ( & V_194 -> V_2 , V_18 ) ;
if ( V_18 -> V_31 -> V_176 ) {
V_83 = F_58 ( V_194 , V_18 , V_195 ) ;
if ( V_83 )
return V_83 ;
}
...
& V_18 -> V_91 , 1 ) ;
if ( V_83 ) {
F_37 ( & V_194 -> V_2 , L_23 , V_83 ) ;
goto V_229;
}
if ( V_18 -> V_63 ) {
V_83 = F_84 ( & V_194 -> V_2 , V_18 -> V_25 ,
F_8 , 0 , F_73 ( & V_194 -> V_2 ) ,
V_18 ) ;
if ( V_83 < 0 ) {
F_37 ( & V_194 -> V_2 , L_24 ,
V_18 -> V_25 ) ;
...
if ( F_32 ( V_18 -> V_194 ) ) {
V_83 = F_60 ( V_18 -> V_194 ) ;
F_37 ( & V_194 -> V_2 , L_29 , V_83 ) ;
goto V_231;
}
V_230:
if ( V_18 -> V_19 )
...
{
struct V_17 * V_18 = F_91 ( & V_194 -> V_2 ) ;
F_89 ( & V_18 -> V_33 ) ;
if ( V_18 -> V_194 )
F_92 ( V_18 -> V_194 ) ;
if ( V_18 -> V_31 -> V_176 )
