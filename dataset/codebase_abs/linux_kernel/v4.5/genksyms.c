...
continue;
V_63 = F_22 ( V_59 ) ;
if ( V_63 && V_63 -> V_25 == V_8 &&
! strcmp ( V_63 -> string , L_20 ) ) {
V_27 = 1 ;
F_19 ( V_63 ) ;
V_63 = F_22 ( V_59 ) ;
}
...
V_64 = F_18 ( F_20 ( V_19 -> string ) , V_19 -> V_25 ,
V_24 , V_27 ) ;
V_64 -> V_36 = V_36 ;
F_19 ( V_19 ) ;
}
}
static void F_25 ( T_2 * V_59 , struct V_23 * V_65 )
{
if ( V_46 [ V_65 -> V_25 ] . V_53 ) {
putc ( V_46 [ V_65 -> V_25 ] . V_53 , V_59 ) ;
putc ( '#' , V_59 ) ;
}
fputs ( V_65 -> string , V_59 ) ;
}
static void F_16 ( T_2 * V_59 , struct V_23 * V_65 )
{
struct V_23 * * V_49 , * * V_58 ;
struct V_23 * V_66 , * * V_67 ;
int V_68 = 1 ;
if ( V_65 == NULL ) {
fputs ( L_21 , V_59 ) ;
return;
...
V_66 = V_65 ;
while ( ( V_66 = V_66 -> V_26 ) != NULL )
V_68 ++ ;
V_58 = F_26 ( V_68 * sizeof( * V_49 ) ) ;
V_49 = V_58 + V_68 ;
V_67 = V_49 - 1 ;
( * V_67 -- ) = V_65 ;
...
case V_8 :
if ( V_70 )
fprintf ( V_47 , L_22 , V_69 -> string ) ;
V_2 = F_2 ( V_69 -> string , V_2 ) ;
V_2 = F_1 ( ' ' , V_2 ) ;
break;
case V_7 :
case V_9 :
V_64 = F_5 ( V_69 -> string , V_69 -> V_25 , 0 ) ;
if ( V_64 -> V_43 ) {
if ( V_70 )
fprintf ( V_47 , L_22 , V_69 -> string ) ;
V_2 = F_2 ( V_69 -> string , V_2 ) ;
...
F_11 ( L_1 ) , NULL ) ;
V_64 =
F_17 ( V_69 -> string , V_69 -> V_25 , V_53 , 0 ) ;
}
if ( V_64 -> V_43 ) {
if ( V_70 ) {
fprintf ( V_47 , L_24 ,
...
if ( V_70 )
fputs ( L_16 , V_47 ) ;
printf ( L_35 , V_74 , V_14 , V_2 ) ;
}
}
static void F_13 ( void )
{
fprintf ( V_37 , L_36 , V_75 ? : L_37 , V_76 ) ;
}
...
void F_15 ( const char * V_77 , ... )
{
T_1 args ;
if ( V_78 ) {
F_13 () ;
va_start ( args , V_77 ) ;
vfprintf ( V_37 , V_77 , args ) ;
va_end ( args ) ;
putc ( '\n' , V_37 ) ;
V_73 ++ ;
}
...
while ( ( V_83 = F_31 ( V_79 , V_80 , L_72 ,
& V_85 [ 0 ] , NULL ) ) != V_62 )
#else
while ( ( V_83 = F_32 ( V_79 , V_80 , L_72 ) ) != V_62 )
#endif
switch ( V_83 ) {
case 's' :
V_74 = V_86 ;
...
F_33 () ;
if ( V_88 && V_71 ) {
while ( V_71 != (struct V_13 * ) - 1L ) {
struct V_13 * V_19 = V_71 ;
if ( V_19 -> V_36 )
fputs ( L_76 , V_81 ) ;
if ( V_46 [ V_19 -> type ] . V_53 ) {
putc ( V_46 [ V_19 -> type ] . V_53 , V_81 ) ;
putc ( '#' , V_81 ) ;
}
fputs ( V_19 -> V_14 , V_81 ) ;
putc ( ' ' , V_81 ) ;
if ( V_19 -> V_27 )
fputs ( L_15 , V_81 ) ;
F_16 ( V_81 , V_19 -> V_24 ) ;
