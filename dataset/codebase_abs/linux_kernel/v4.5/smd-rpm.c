...
struct V_1 * V_2 = F_12 ( & V_33 -> V_38 ) ;
const T_3 * V_5 = V_34 + sizeof( struct V_10 ) ;
const T_3 * V_39 = V_5 + V_35 ;
char V_40 [ 32 ] ;
int V_41 = 0 ;
T_1 V_42 , V_43 ;
...
break;
case V_46 :
V_42 = F_14 ( T_1 , F_15 ( V_43 , 4 ) , sizeof( V_40 ) ) ;
F_16 ( V_40 , V_37 -> V_47 , V_42 ) ;
V_40 [ V_42 - 1 ] = 0 ;
if ( ! strcmp ( V_40 , L_2 ) )
V_41 = - V_48 ;
else
...
V_5 = F_17 ( V_5 + 2 * sizeof( T_1 ) + V_43 , 4 ) ;
}
V_2 -> V_31 = V_41 ;
F_18 ( & V_2 -> V_28 ) ;
return 0 ;
}
static int F_19 ( struct V_32 * V_49 )
{
struct V_1 * V_2 ;
V_2 = F_20 ( & V_49 -> V_38 , sizeof( * V_2 ) , V_18 ) ;
if ( ! V_2 )
return - V_19 ;
F_21 ( & V_2 -> V_20 ) ;
F_22 ( & V_2 -> V_28 ) ;
V_2 -> V_26 = V_49 -> V_50 ;
F_23 ( & V_49 -> V_38 , V_2 ) ;
return F_24 ( V_49 -> V_38 . V_51 , NULL , NULL , & V_49 -> V_38 ) ;
}
static void F_25 ( struct V_32 * V_49 )
{
F_26 ( & V_49 -> V_38 ) ;
}
