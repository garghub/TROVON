...
* ( T_1 * ) ( V_143 + V_155 + 4 ) = V_6 -> V_162 ;
V_6 -> V_159 += V_13 -> V_157 ;
V_6 -> V_102 += V_13 -> V_158 ;
V_6 -> V_162 += V_13 -> V_158 ;
}
...
T_1 V_164 = * ( T_2 * ) ( V_142 + V_155 + 4 ) + 1 ;
T_1 V_27 = * ( T_2 * ) ( V_142 + V_155 + 5 ) ;
T_1 V_42 ;
if ( V_140 -> V_52 & 0x8 )
V_27 |= ( * ( T_1 * ) ( V_142 + 100 + V_50 * 4 ) ) & ~ 0xff ;
if ( V_163 -> V_12 . V_28 < V_23 ||
V_163 -> V_12 . V_28 - V_23 < V_164 ) {
F_2 ( L_49 ,
V_23 , V_164 , V_163 -> V_12 . V_28 ) ;
return - V_35 ;
}
if ( V_27 != 0 ) {
V_42 = ( ( V_163 -> V_12 . V_28 - V_23 - V_164 ) /
V_27 ) ;
if ( V_140 -> V_42 > V_42 ) {
F_2 ( L_50
L_51 ,
...
* ( T_1 * ) ( V_143 + V_155 ) = V_163 -> V_48 + V_23 ;
}
return 0 ;
}
int
...
V_165 = F_32 ( V_55 , V_6 , & V_6 -> V_45 [ V_50 ] ) ;
if ( V_165 )
return V_165 ;
}
return V_165 ;
