...
if ( V_30 ) {
struct V_1 * V_2 = F_13 ( V_1 , V_34 , V_28 ) ;
V_2 -> V_35 = V_8 -> V_36 -> V_37 ;
V_2 -> V_3 = V_1 ;
V_2 -> V_38 = F_1 ;
V_1 = V_2 ;
} else
V_1 -> V_35 = V_8 -> V_36 -> V_37 ;
F_14 ( V_1 ) ;
}
static void F_15 ( struct V_39 * V_40 , struct V_28 * V_28 )
{
struct V_7 * V_8 = V_28 -> V_29 ;
int V_26 ;
...
static T_1 F_18 ( struct V_28 * V_28 , T_1 V_50 , int V_51 )
{
F_19 ( V_51 ,
L_8 , V_52 ) ;
if ( V_50 == 0 )
...
static void F_26 ( struct V_28 * V_28 , void * V_59 )
{
struct V_7 * V_8 = V_59 ;
F_27 ( V_8 ) ;
}
