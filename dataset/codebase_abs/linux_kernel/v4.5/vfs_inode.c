...
if ( F_56 ( V_121 ) )
return F_64 ( V_121 ) ;
F_50 ( V_121 , F_62 ( V_135 ) , F_62 ( V_135 ) -> V_144 ) ;
F_104 ( F_62 ( V_135 ) , V_17 ) ;
F_58 ( V_121 ) ;
F_59 ( V_121 ) ;
return 0 ;
}
static int F_105 ( struct V_135 * V_135 , struct V_178 * V_178 )
{
int V_124 ;
struct V_1 * V_2 ;
struct V_128 * V_129 ;
...
return V_124 ;
if ( ( V_178 -> V_180 & V_188 ) &&
V_178 -> V_189 != F_109 ( F_62 ( V_135 ) ) )
F_110 ( F_62 ( V_135 ) , V_178 -> V_189 ) ;
F_70 ( F_62 ( V_135 ) ) ;
F_111 ( F_62 ( V_135 ) , V_178 ) ;
F_112 ( F_62 ( V_135 ) ) ;
return 0 ;
}
void
...
static int
F_119 ( struct V_63 * V_134 , struct V_135 * V_135 , const char * V_206 )
{
F_11 ( V_114 , L_22 ,
V_134 -> V_125 , V_135 , V_206 ) ;
return F_118 ( V_134 , V_135 , V_21 , V_206 ) ;
}
static int
