...
static int F_86 ( struct V_1 * V_2 , unsigned long V_20 ,
...
F_12 ( V_25 L_17 ,
V_20 , F_97 ( V_80 ) ) ;
V_54 = F_92 ( V_80 ) || ( V_21 & V_102 ) ;
F_33 ( & V_69 , V_54 , V_19 ,
V_24 != V_99 , V_2 , V_20 , V_21 ) ;
return V_24 ;
}
static void F_98 ( struct V_1 * V_80 )
{
int V_103 ;
...
static void F_100 ( struct V_1 * V_80 )
{
int V_103 ;
int V_104 = 1 << F_14 ( V_80 ) ;
for ( V_103 = 0 ; V_103 < V_104 ; V_103 ++ )
...
int F_102 ( unsigned long V_20 , int V_19 , int V_21 )
{
struct V_86 * V_87 ;
struct V_1 * V_2 ;
struct V_1 * V_80 ;
...
if ( ! F_76 ( V_2 ) && F_84 ( V_80 ) ) {
F_108 ( V_80 ) ;
if ( ! F_55 ( V_80 ) || F_113 ( F_114 ( V_80 ) ) ) {
F_112 ( V_80 ) ;
if ( ! F_55 ( V_80 ) )
F_80 ( L_13 , V_20 ) ;
else
...
if ( ! F_76 ( V_2 ) && ! F_118 ( V_2 ) && ! F_20 ( V_2 ) )
goto V_116;
if ( F_76 ( V_2 ) && F_119 ( V_2 ) && F_106 ( V_80 ) ) {
...
F_98 ( V_80 ) ;
F_120 ( V_2 ) ;
if ( F_86 ( V_2 , V_20 , V_19 , V_21 , & V_80 )
!= V_99 ) {
F_78 ( V_20 , V_118 , V_72 ) ;
V_79 = - V_90 ;
goto V_115;
}
if ( F_20 ( V_2 ) && ! F_91 ( V_2 ) && V_2 -> V_4 == NULL ) {
...
V_124 = & F_122 ( V_123 ) ;
F_123 ( & V_124 -> V_128 , V_125 ) ;
if ( F_124 ( & V_124 -> V_129 , V_127 ) )
F_125 ( F_126 () , & V_124 -> V_130 ) ;
else
F_80 ( L_23 ,
V_20 ) ;
F_127 ( & V_124 -> V_128 , V_125 ) ;
F_128 ( V_123 ) ;
}
static void F_129 ( struct V_131 * V_130 )
{
struct V_123 * V_124 ;
...
for (; ; ) {
F_123 ( & V_124 -> V_128 , V_125 ) ;
V_132 = F_131 ( & V_124 -> V_129 , & V_127 ) ;
F_127 ( & V_124 -> V_128 , V_125 ) ;
if ( ! V_132 )
break;
if ( V_127 . V_21 & V_133 )
F_132 ( F_105 ( V_127 . V_20 ) , V_127 . V_21 ) ;
else
F_102 ( V_127 . V_20 , V_127 . V_19 , V_127 . V_21 ) ;
}
}
...
int V_134 ;
F_134 (cpu) {
V_124 = & F_135 ( V_123 , V_134 ) ;
F_136 ( & V_124 -> V_128 ) ;
F_137 ( V_124 -> V_129 ) ;
F_138 ( & V_124 -> V_130 , F_129 ) ;
}
return 0 ;
}
...
static struct V_1 * F_144 ( struct V_1 * V_2 , unsigned long V_139 , int * * V_140 )
{
int V_141 = F_25 ( V_2 ) ;
if ( F_76 ( V_2 ) )
...
if ( ! F_83 ( V_2 ) ) {
if ( F_76 ( V_2 ) ) {
F_29 ( L_32 , V_143 , V_20 ) ;
V_24 = 0 ;
} else if ( F_23 ( V_2 ) ) {
F_29 ( L_33 , V_143 , V_20 ) ;
V_24 = 0 ;
} else {
F_29 ( L_34 ,
V_143 , V_20 , V_2 -> V_21 ) ;
...
F_112 ( V_80 ) ;
V_24 = F_151 ( V_80 , & V_144 ) ;
F_115 ( V_80 ) ;
if ( ! V_24 ) {
F_29 ( L_37 , V_20 ) ;
return - V_90 ;
}
V_24 = F_152 ( & V_144 , F_144 , NULL , V_145 ,
V_146 , V_147 ) ;
if ( V_24 ) {
F_29 ( L_38 ,
V_20 , V_24 , V_1 -> V_21 ) ;
