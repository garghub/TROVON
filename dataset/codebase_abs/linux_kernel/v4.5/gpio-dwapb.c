...
#ifdef F_48
V_13 -> V_5 . V_108 = V_60 -> V_62 ;
#endif
V_13 -> V_5 . V_64 = V_60 -> V_64 ;
V_13 -> V_5 . V_18 = V_60 -> V_109 ;
if ( V_60 -> V_97 == 0 )
V_13 -> V_5 . V_110 = F_31 ;
if ( V_60 -> V_54 )
F_33 ( V_2 , V_13 , V_60 ) ;
V_67 = F_49 ( & V_13 -> V_5 , V_13 ) ;
if ( V_67 )
F_26 ( V_2 -> V_39 , L_7 ,
V_60 -> V_107 ) ;
else
...
{
unsigned int V_112 ;
for ( V_112 = 0 ; V_112 < V_2 -> V_113 ; ++ V_112 )
if ( V_2 -> V_6 [ V_112 ] . V_111 )
F_51 ( & V_2 -> V_6 [ V_112 ] . V_5 ) ;
}
static struct V_114 *
F_52 ( struct V_115 * V_39 )
{
...
if ( V_118 == 0 )
return F_54 ( - V_119 ) ;
V_117 = F_46 ( V_39 , sizeof( * V_117 ) , V_99 ) ;
if ( ! V_117 )
return F_54 ( - V_100 ) ;
V_117 -> V_120 = F_56 ( V_39 , V_118 , sizeof( * V_60 ) , V_99 ) ;
if ( ! V_117 -> V_120 )
return F_54 ( - V_100 ) ;
V_117 -> V_118 = V_118 ;
V_68 = 0 ;
F_57 (node, port_np) {
V_60 = & V_117 -> V_120 [ V_68 ++ ] ;
V_60 -> V_62 = V_116 ;
if ( F_58 ( V_116 , L_8 , & V_60 -> V_97 ) ||
V_60 -> V_97 >= V_121 ) {
F_26 ( V_39 , L_9 ,
V_116 -> V_122 ) ;
return F_54 ( - V_40 ) ;
...
struct V_1 * V_2 ;
int V_67 ;
struct V_115 * V_39 = & V_124 -> V_39 ;
struct V_114 * V_117 = F_63 ( V_39 ) ;
if ( ! V_117 ) {
V_117 = F_52 ( V_39 ) ;
if ( F_64 ( V_117 ) )
return F_65 ( V_117 ) ;
...
if ( ! V_117 -> V_118 )
return - V_119 ;
V_2 = F_46 ( & V_124 -> V_39 , sizeof( * V_2 ) , V_99 ) ;
if ( ! V_2 )
return - V_100 ;
V_2 -> V_39 = & V_124 -> V_39 ;
V_2 -> V_113 = V_117 -> V_118 ;
V_2 -> V_6 = F_56 ( & V_124 -> V_39 , V_2 -> V_113 ,
sizeof( * V_2 -> V_6 ) , V_99 ) ;
if ( ! V_2 -> V_6 )
return - V_100 ;
V_126 = F_66 ( V_124 , V_127 , 0 ) ;
V_2 -> V_8 = F_67 ( & V_124 -> V_39 , V_126 ) ;
if ( F_64 ( V_2 -> V_8 ) )
return F_65 ( V_2 -> V_8 ) ;
for ( V_68 = 0 ; V_68 < V_2 -> V_113 ; V_68 ++ ) {
V_67 = F_44 ( V_2 , & V_117 -> V_120 [ V_68 ] , V_68 ) ;
if ( V_67 )
goto V_128;
}
F_68 ( V_124 , V_2 ) ;
...
{
struct V_1 * V_2 = F_70 ( V_124 ) ;
F_50 ( V_2 ) ;
F_42 ( V_2 ) ;
return 0 ;
}
static int F_71 ( struct V_115 * V_39 )
{
struct V_123 * V_124 = F_72 ( V_39 ) ;
struct V_1 * V_2 = F_70 ( V_124 ) ;
struct V_4 * V_5 = & V_2 -> V_6 [ 0 ] . V_5 ;
unsigned long V_36 ;
int V_68 ;
...
struct V_129 * V_98 = V_2 -> V_6 [ V_68 ] . V_98 ;
F_73 ( ! V_98 ) ;
V_3 = V_105 + V_97 * V_106 ;
V_98 -> V_130 = F_1 ( V_2 , V_3 ) ;
V_3 = V_103 + V_97 * V_104 ;
V_98 -> V_131 = F_1 ( V_2 , V_3 ) ;
V_3 = V_101 + V_97 * V_102 ;
V_98 -> V_132 = F_1 ( V_2 , V_3 ) ;
if ( V_97 == 0 ) {
V_98 -> V_133 = F_1 ( V_2 , V_87 ) ;
V_98 -> V_134 = F_1 ( V_2 , V_38 ) ;
V_98 -> V_135 = F_1 ( V_2 , V_17 ) ;
V_98 -> V_136 = F_1 ( V_2 , V_48 ) ;
V_98 -> V_137 = F_1 ( V_2 , V_53 ) ;
...
static int F_74 ( struct V_115 * V_39 )
{
struct V_123 * V_124 = F_72 ( V_39 ) ;
struct V_1 * V_2 = F_70 ( V_124 ) ;
struct V_4 * V_5 = & V_2 -> V_6 [ 0 ] . V_5 ;
...
F_73 ( ! V_98 ) ;
V_3 = V_103 + V_97 * V_104 ;
F_2 ( V_2 , V_3 , V_98 -> V_131 ) ;
V_3 = V_105 + V_97 * V_106 ;
F_2 ( V_2 , V_3 , V_98 -> V_130 ) ;
V_3 = V_101 + V_97 * V_102 ;
F_2 ( V_2 , V_3 , V_98 -> V_132 ) ;
if ( V_97 == 0 ) {
F_2 ( V_2 , V_48 , V_98 -> V_136 ) ;
F_2 ( V_2 , V_17 , V_98 -> V_135 ) ;
F_2 ( V_2 , V_53 , V_98 -> V_137 ) ;
F_2 ( V_2 , V_38 , V_98 -> V_134 ) ;
F_2 ( V_2 , V_87 , V_98 -> V_133 ) ;
