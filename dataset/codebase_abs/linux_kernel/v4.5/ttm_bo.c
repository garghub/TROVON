...
if ( V_23 -> V_47 && ! ( V_23 -> V_47 -> V_56 & V_57 ) )
F_32 ( & V_23 -> V_58 , & V_23 -> V_36 -> V_59 ) ;
V_11 = & V_9 -> V_11 [ V_23 -> V_27 . V_3 ] ;
F_32 ( & V_23 -> V_45 , & V_11 -> V_45 ) ;
}
}
static int F_33 ( struct V_22 * V_23 , bool V_64 )
{
struct V_8 * V_9 = V_23 -> V_9 ;
...
{
struct V_8 * V_9 = V_23 -> V_9 ;
bool V_82 = F_37 ( V_9 , & V_23 -> V_27 ) ;
bool V_83 = F_37 ( V_9 , V_27 ) ;
...
V_26 = F_41 ( V_23 -> V_47 , V_27 -> V_25 ) ;
if ( V_26 )
goto V_87;
if ( V_27 -> V_3 != V_18 ) {
V_26 = F_42 ( V_23 -> V_47 , V_27 ) ;
if ( V_26 )
goto V_87;
}
...
struct V_101 * V_101 ;
int V_4 ;
V_100 = F_50 ( V_23 -> V_48 ) ;
V_101 = F_51 ( V_23 -> V_48 ) ;
if ( V_101 && ! V_101 -> V_102 -> V_103 )
F_52 ( V_101 ) ;
for ( V_4 = 0 ; V_100 && V_4 < V_100 -> V_104 ; ++ V_4 ) {
V_101 = F_53 ( V_100 -> V_105 [ V_4 ] ,
F_54 ( V_23 -> V_48 ) ) ;
...
int V_26 ;
F_29 ( & V_36 -> V_63 ) ;
V_26 = F_56 ( V_23 , false , true , false , NULL ) ;
if ( ! V_26 ) {
if ( ! F_57 ( V_23 , false , false , true ) ) {
V_60 = F_22 ( V_23 ) ;
F_30 ( & V_36 -> V_63 ) ;
F_46 ( V_23 ) ;
F_26 ( V_23 , V_60 , true ) ;
...
int V_60 ;
int V_26 ;
V_26 = F_57 ( V_23 , false , false , true ) ;
if ( V_26 && ! V_81 ) {
long V_108 ;
F_48 ( & V_23 -> V_48 -> V_53 ) ;
F_30 ( & V_36 -> V_63 ) ;
V_108 = F_61 ( V_23 -> V_48 ,
true ,
V_80 ,
30 * V_107 ) ;
if ( V_108 < 0 )
...
V_26 = F_56 ( V_111 , false , true , false , NULL ) ;
if ( V_110 && V_26 ) {
F_30 ( & V_36 -> V_63 ) ;
V_26 = F_56 ( V_111 , false , false ,
false , NULL ) ;
F_29 ( & V_36 -> V_63 ) ;
}
if ( ! V_26 )
V_26 = F_60 ( V_111 , false ,
! V_110 ) ;
else
F_30 ( & V_36 -> V_63 ) ;
F_65 ( & V_111 -> V_40 , F_9 ) ;
...
{
return F_72 ( & V_9 -> V_106 ) ;
}
void F_73 ( struct V_8 * V_9 , int V_121 )
{
if ( V_121 )
F_59 ( & V_9 -> V_106 ,
( ( V_107 / 100 ) < 1 ) ? 1 : V_107 / 100 ) ;
}
static int F_74 ( struct V_22 * V_23 , bool V_80 ,
bool V_81 )
{
struct V_8 * V_9 = V_23 -> V_9 ;
struct V_78 V_122 ;
struct V_24 V_25 ;
int V_26 = 0 ;
V_26 = F_57 ( V_23 , false , V_80 , V_81 ) ;
if ( F_35 ( V_26 != 0 ) ) {
if ( V_26 != - V_123 ) {
F_3 ( L_13 ) ;
}
...
V_26 = F_75 ( V_23 , & V_25 , & V_122 , V_80 ,
V_81 ) ;
if ( V_26 ) {
if ( V_26 != - V_123 ) {
F_3 ( L_14 ,
...
V_26 = F_36 ( V_23 , & V_122 , true , V_80 ,
V_81 ) ;
if ( V_26 ) {
if ( V_26 != - V_123 )
F_3 ( L_15 ) ;
...
F_10 ( V_26 != 0 ) ;
F_26 ( V_23 , V_60 , true ) ;
V_26 = F_74 ( V_23 , V_80 , V_81 ) ;
F_78 ( V_23 ) ;
F_65 ( & V_23 -> V_40 , F_9 ) ;
return V_26 ;
}
void F_47 ( struct V_22 * V_23 , struct V_78 * V_27 )
{
...
static T_1 F_80 ( struct V_10 * V_11 ,
T_1 V_98 ,
T_1 V_133 )
{
...
continue;
V_143 = F_81 ( V_11 , V_3 , V_2 ,
& V_140 ) ;
if ( ! V_143 )
continue;
V_142 = true ;
V_140 = F_80 ( V_11 , V_23 -> V_27 . V_25 ,
V_140 ) ;
F_82 ( & V_140 , V_2 -> V_6 ,
~ V_145 ) ;
if ( V_3 == V_18 )
...
V_27 . V_124 . V_126 = 0 ;
V_26 = F_75 ( V_23 , V_25 , & V_27 ,
V_80 , V_81 ) ;
if ( V_26 )
goto V_112;
V_26 = F_36 ( V_23 , & V_27 , false ,
V_80 , V_81 ) ;
V_112:
if ( V_26 && V_27 . V_44 )
F_47 ( V_23 , & V_27 ) ;
...
static bool F_85 ( struct V_24 * V_25 ,
struct V_78 * V_27 ,
T_1 * V_148 )
{
int V_4 ;
...
T_1 V_148 ;
F_19 ( & V_23 -> V_48 -> V_53 . V_54 ) ;
if ( ! F_85 ( V_25 , & V_23 -> V_27 , & V_148 ) ) {
V_26 = F_84 ( V_23 , V_25 , V_80 ,
V_81 ) ;
if ( V_26 )
return V_26 ;
} else {
F_82 ( & V_23 -> V_27 . V_25 , V_148 ,
~ V_145 ) ;
}
...
bool V_156 ;
V_26 = F_88 ( V_52 , V_41 , false , false ) ;
if ( V_26 ) {
F_3 ( L_17 ) ;
if ( V_51 )
(* V_51)( V_23 ) ;
...
if ( V_23 -> type == V_68 ||
V_23 -> type == V_76 )
V_26 = F_96 ( & V_9 -> V_118 , & V_23 -> V_119 ,
V_23 -> V_27 . V_28 ) ;
if ( ! V_48 ) {
V_156 = F_97 ( & V_23 -> V_48 -> V_53 ) ;
F_62 ( ! V_156 ) ;
}
if ( F_98 ( ! V_26 ) )
V_26 = F_86 ( V_23 , V_25 , V_80 , false ) ;
if ( ! V_48 ) {
F_78 ( V_23 ) ;
...
T_3 F_99 ( struct V_8 * V_9 ,
unsigned long V_160 ,
unsigned V_161 )
{
unsigned V_162 = ( F_100 ( V_160 ) ) >> V_73 ;
T_3 V_15 = 0 ;
V_15 += F_101 ( V_161 ) ;
V_15 += F_100 ( V_162 * sizeof( void * ) ) ;
V_15 += F_101 ( sizeof( struct V_163 ) ) ;
return V_15 ;
}
T_3 F_102 ( struct V_8 * V_9 ,
unsigned long V_160 ,
unsigned V_161 )
{
unsigned V_162 = ( F_100 ( V_160 ) ) >> V_73 ;
...
V_15 += F_101 ( V_161 ) ;
V_15 += F_100 ( V_162 * sizeof( void * ) ) ;
V_15 += F_100 ( V_162 * sizeof( V_164 ) ) ;
V_15 += F_101 ( sizeof( struct V_165 ) ) ;
return V_15 ;
}
...
T_3 V_41 ;
int V_26 ;
V_23 = F_104 ( sizeof( * V_23 ) , V_166 ) ;
if ( F_35 ( V_23 == NULL ) )
return - V_75 ;
V_41 = F_99 ( V_9 , V_15 , sizeof( struct V_22 ) ) ;
V_26 = F_87 ( V_9 , V_23 , V_15 , type , V_25 , V_147 ,
V_80 , V_152 , V_41 ,
NULL , NULL , NULL ) ;
if ( F_98 ( V_26 == 0 ) )
* V_120 = V_23 ;
...
F_30 ( & V_36 -> V_63 ) ;
V_26 = F_76 ( V_9 , V_3 , NULL , false , false ) ;
if ( V_26 ) {
if ( V_167 ) {
return V_26 ;
} else {
...
int F_107 ( struct V_8 * V_9 , unsigned V_3 )
{
struct V_10 * V_11 = & V_9 -> V_11 [ V_3 ] ;
if ( V_3 == 0 || V_3 >= V_168 ) {
F_3 ( L_22 , V_3 ) ;
...
return F_105 ( V_9 , V_3 , true ) ;
}
int F_108 ( struct V_8 * V_9 , unsigned type ,
unsigned long V_170 )
{
int V_26 = - V_7 ;
struct V_10 * V_11 ;
...
static void F_109 ( struct V_30 * V_31 )
{
struct V_35 * V_36 =
F_6 ( V_31 , struct V_35 , V_31 ) ;
F_110 ( V_36 -> V_52 , & V_36 -> V_176 ) ;
F_111 ( V_36 -> V_74 ) ;
F_16 ( V_36 ) ;
}
void F_112 ( struct V_177 * V_178 )
{
struct V_35 * V_36 = V_178 -> V_179 ;
F_113 ( & V_36 -> V_31 ) ;
F_114 ( & V_36 -> V_31 ) ;
}
int F_115 ( struct V_177 * V_178 )
{
struct V_180 * V_181 =
...
V_36 -> V_74 = F_117 ( V_183 | V_184 ) ;
if ( F_35 ( V_36 -> V_74 == NULL ) ) {
V_26 = - V_75 ;
goto V_185;
}
F_91 ( & V_36 -> V_59 ) ;
F_91 ( & V_36 -> V_186 ) ;
F_118 ( & V_36 -> V_176 , V_187 ) ;
V_26 = F_119 ( V_36 -> V_52 , & V_36 -> V_176 ) ;
if ( F_35 ( V_26 != 0 ) ) {
F_3 ( L_24 ) ;
goto V_188;
}
...
V_26 = F_108 ( V_9 , V_18 , 0 ) ;
if ( F_35 ( V_26 != 0 ) )
goto V_194;
F_129 ( & V_9 -> V_118 , V_193 ,
0x10000000 ) ;
F_130 ( & V_9 -> V_106 , F_66 ) ;
F_91 ( & V_9 -> V_46 ) ;
V_9 -> V_195 = V_192 ;
V_9 -> V_36 = V_36 ;
V_9 -> V_66 = V_66 ;
...
bool F_37 ( struct V_8 * V_9 , struct V_78 * V_27 )
{
...
{
struct V_8 * V_9 = V_23 -> V_9 ;
F_131 ( & V_23 -> V_119 , V_9 -> V_195 ) ;
F_69 ( V_23 ) ;
}
void F_132 ( struct V_22 * V_23 )
{
struct V_8 * V_9 = V_23 -> V_9 ;
struct V_10 * V_11 = & V_9 -> V_11 [ V_23 -> V_27 . V_3 ] ;
F_38 ( V_11 , false ) ;
...
return - V_109 ;
F_135 ( V_48 , NULL ) ;
F_136 ( V_202 , & V_23 -> V_158 ) ;
return 0 ;
}
int F_137 ( struct V_22 * V_23 , bool V_199 )
{
int V_26 = 0 ;
V_26 = F_138 ( V_23 , true , V_199 , false , NULL ) ;
if ( F_35 ( V_26 != 0 ) )
return V_26 ;
V_26 = F_57 ( V_23 , false , true , V_199 ) ;
if ( F_98 ( V_26 == 0 ) )
F_94 ( & V_23 -> V_43 ) ;
F_78 ( V_23 ) ;
return V_26 ;
...
F_30 ( & V_36 -> V_63 ) ;
F_26 ( V_23 , V_60 , true ) ;
V_26 = F_57 ( V_23 , false , false , false ) ;
if ( F_35 ( V_26 != 0 ) )
goto V_115;
...
V_26 = F_140 ( V_23 -> V_47 , V_23 -> V_152 ) ;
V_115:
F_58 ( V_23 ) ;
F_65 ( & V_23 -> V_40 , F_9 ) ;
return V_26 ;
...
int F_142 ( struct V_22 * V_23 )
{
int V_26 ;
V_26 = F_143 ( & V_23 -> V_50 ) ;
if ( F_35 ( V_26 != 0 ) )
return - V_123 ;
if ( ! F_144 ( & V_23 -> V_48 -> V_53 ) )
goto V_112;
V_26 = F_56 ( V_23 , true , false , false , NULL ) ;
if ( F_35 ( V_26 != 0 ) )
goto V_112;
F_58 ( V_23 ) ;
V_112:
