...
static void F_41 ( struct V_4 * V_8 ,
...
static int F_42 ( struct V_4 * V_8 ,
struct V_61 * V_62 )
{
struct V_30 * V_30 , * V_117 ;
struct V_75 * V_75 ;
int type = F_24 ( V_62 ) ;
switch ( type ) {
case V_55 :
...
F_26 (nfit_spa, &acpi_desc->spas, list) {
int V_28 ;
V_28 = F_42 ( V_8 , V_68 -> V_62 ) ;
if ( V_28 )
return V_28 ;
}
F_47 ( NULL , & V_8 -> V_118 , F_44 ) ;
return 0 ;
}
...
return sprintf ( V_13 , L_30 , V_8 -> V_134 . V_135 ) ;
}
...
return sprintf ( V_13 , L_31 , V_74 -> V_77 ) ;
}
static T_6 F_56 ( struct V_21 * V_10 ,
struct V_131 * V_132 , char * V_13 )
{
struct V_73 * V_74 = F_52 ( V_10 ) ;
return sprintf ( V_13 , L_31 , V_74 -> V_136 ) ;
}
static T_6 F_57 ( struct V_21 * V_10 ,
struct V_131 * V_132 , char * V_13 )
{
struct V_79 * V_80 = F_54 ( V_10 ) ;
return sprintf ( V_13 , L_31 , V_80 -> V_137 ) ;
}
static T_6 F_58 ( struct V_21 * V_10 ,
struct V_131 * V_132 , char * V_13 )
{
struct V_79 * V_80 = F_54 ( V_10 ) ;
return sprintf ( V_13 , L_31 , V_80 -> V_138 ) ;
}
static T_6 F_59 ( struct V_21 * V_10 ,
struct V_131 * V_132 , char * V_13 )
{
struct V_79 * V_80 = F_54 ( V_10 ) ;
return sprintf ( V_13 , L_31 , V_80 -> V_139 ) ;
}
static T_6 F_60 ( struct V_21 * V_10 ,
struct V_131 * V_132 , char * V_13 )
{
struct V_79 * V_80 = F_54 ( V_10 ) ;
return sprintf ( V_13 , L_31 , V_80 -> V_140 ) ;
}
static T_6 F_61 ( struct V_21 * V_10 ,
struct V_131 * V_132 , char * V_13 )
{
struct V_79 * V_80 = F_54 ( V_10 ) ;
return sprintf ( V_13 , L_31 , V_80 -> V_141 ) ;
}
static T_6 F_62 ( struct V_21 * V_10 ,
struct V_131 * V_132 , char * V_13 )
{
T_4 V_142 = F_52 ( V_10 ) -> V_142 ;
return sprintf ( V_13 , L_32 ,
V_142 & V_143 ? L_33 : L_34 ,
V_142 & V_144 ? L_35 : L_34 ,
V_142 & V_145 ? L_36 : L_34 ,
V_142 & V_146 ? L_37 : L_34 ,
V_142 & V_147 ? L_38 : L_34 ) ;
}
...
F_71 ( V_8 -> V_10 , L_40 ,
F_8 ( V_11 ) ,
V_159 & V_143 ? L_41 : L_34 ,
V_159 & V_144 ? L_42 : L_34 ,
V_159 & V_145 ? L_43 : L_34 ,
V_159 & V_146 ? L_44 : L_34 ) ;
}
...
return sprintf ( V_13 , L_30 , V_68 -> V_62 -> V_72 ) ;
}
...
F_16 ( V_8 -> V_10 , L_46 , V_46 , V_62 -> V_72 ) ;
if ( V_235 -> type == V_237 )
...
F_16 ( V_10 , L_47 , V_46 ,
V_30 ? L_34 : L_48 ,
( V_30 && V_30 -> V_80 ) ? L_34 : L_49 ,
( V_30 && V_30 -> V_85 ) ? L_34 : L_50 ) ;
return - V_51 ;
}
...
V_189 -> V_199 = V_30 -> V_115 -> V_175 ;
V_189 -> V_89 = V_30 -> V_116 ;
V_189 -> V_62 = V_30 -> V_112 ;
V_28 = F_126 ( V_189 , V_30 -> V_116 ,
V_30 -> V_115 -> V_249 ) ;
if ( V_28 ) {
F_16 ( V_10 , L_52 ,
V_46 , F_8 ( V_11 ) ) ;
...
struct V_259 * V_12 , V_176 V_206 , V_176 V_44 )
{
V_12 -> V_238 = V_206 ;
V_12 -> V_44 = V_44 ;
return V_6 -> V_251 ( V_6 , NULL , V_165 , V_12 ,
sizeof( * V_12 ) ) ;
}
static int F_136 ( struct V_5 * V_6 ,
struct V_260 * V_12 , V_176 V_206 , V_176 V_44 )
{
int V_28 ;
V_12 -> V_238 = V_206 ;
V_12 -> V_44 = V_44 ;
V_12 -> type = V_261 ;
while ( 1 ) {
V_28 = V_6 -> V_251 ( V_6 , NULL , V_262 , V_12 ,
sizeof( * V_12 ) ) ;
if ( V_28 )
return V_28 ;
switch ( V_12 -> V_253 ) {
...
struct V_263 * V_12 , T_3 V_205 )
{
int V_28 ;
while ( 1 ) {
V_28 = V_6 -> V_251 ( V_6 , NULL , V_166 , V_12 ,
V_205 ) ;
if ( V_28 || V_12 -> V_253 & 0xffff )
return - V_51 ;
switch ( V_12 -> V_253 >> 16 ) {
case 0 :
return 0 ;
case 1 :
F_137 ( 1000 ) ;
...
static int F_139 ( struct V_133 * V_133 ,
struct V_263 * V_264 , V_176 V_240 )
{
int V_28 ;
T_3 V_29 ;
if ( V_264 -> V_238 > V_240 ||
( V_264 -> V_238 + V_264 -> V_44 < V_240 ) )
return - V_51 ;
for ( V_29 = 0 ; V_29 < V_264 -> V_265 ; V_29 ++ ) {
V_28 = F_140 ( V_133 ,
V_264 -> V_266 [ V_29 ] . V_267 ,
V_264 -> V_266 [ V_29 ] . V_44 ) ;
if ( V_28 )
return V_28 ;
}
return 0 ;
...
{
struct V_5 * V_6 = & V_8 -> V_6 ;
struct V_133 * V_133 = V_8 -> V_133 ;
struct V_263 * V_264 = NULL ;
struct V_260 * V_268 = NULL ;
struct V_259 * V_269 = NULL ;
V_176 V_240 , V_209 , V_270 , V_271 ;
T_3 V_272 ;
int V_28 ;
V_269 = F_119 ( sizeof( * V_269 ) , V_71 ) ;
if ( ! V_269 )
return - V_104 ;
V_240 = V_178 -> V_242 -> V_240 ;
V_209 = V_178 -> V_242 -> V_100 - V_178 -> V_242 -> V_240 + 1 ;
V_28 = F_135 ( V_6 , V_269 , V_240 , V_209 ) ;
if ( V_28 == - V_32 ) {
F_16 ( V_8 -> V_10 ,
L_59 ) ;
V_28 = 0 ;
...
if ( V_28 )
goto V_49;
if ( ( V_269 -> V_253 & 0xffff ) ||
! ( V_269 -> V_253 >> 16 & V_261 ) ) {
F_38 ( V_8 -> V_10 ,
L_60 ,
V_269 -> V_253 ) ;
goto V_49;
...
V_272 = V_269 -> V_273 ;
V_264 = F_119 ( V_272 , V_71 ) ;
if ( ! V_264 ) {
V_28 = - V_104 ;
goto V_49;
}
V_28 = F_138 ( V_6 , V_264 , V_272 ) ;
if ( V_28 )
goto V_49;
if ( V_264 -> V_238 <= V_240 &&
( V_264 -> V_238 + V_264 -> V_44 >= V_240 + V_209 ) ) {
V_28 = F_139 ( V_133 , V_264 , V_240 ) ;
goto V_49;
}
V_268 = F_119 ( sizeof( * V_268 ) , V_71 ) ;
if ( ! V_268 )
return - V_104 ;
V_270 = V_240 ;
V_271 = V_209 ;
do {
V_176 V_274 , V_100 ;
V_28 = F_136 ( V_6 , V_268 , V_270 , V_271 ) ;
if ( V_28 )
goto V_49;
V_28 = F_138 ( V_6 , V_264 , V_272 ) ;
if ( V_28 )
goto V_49;
V_28 = F_139 ( V_133 , V_264 , V_270 ) ;
if ( V_28 )
goto V_49;
V_100 = F_101 ( V_270 + V_271 ,
V_264 -> V_238 + V_264 -> V_44 ) ;
V_274 = V_100 - V_270 ;
V_270 += V_274 ;
V_271 -= V_274 ;
} while ( V_271 );
...
V_184 -> V_205 = V_30 -> V_85 -> V_279 ;
V_184 -> V_240 = V_30 -> V_85 -> V_280 ;
V_178 -> V_281 = V_30 -> V_85 -> V_83 ;
V_277 = 1 ;
}
V_178 -> V_184 = V_184 ;
V_178 -> V_168 = V_277 ;
...
V_276 -> V_282 = F_128 ;
V_276 -> V_283 = F_134 ;
V_276 -> V_284 = V_8 -> V_285 ;
if ( ! F_144 ( V_8 -> V_133 , V_178 ) )
return - V_104 ;
break;
}
return 0 ;
}
static int F_145 ( struct V_4 * V_8 ,
struct V_68 * V_68 )
{
static struct V_184 V_286 [ V_287 ] ;
...
if ( ! F_147 ( V_133 , V_178 ) )
return - V_104 ;
} else if ( F_24 ( V_62 ) == V_53 ) {
if ( ! F_148 ( V_133 , V_178 ) )
return - V_104 ;
}
V_68 -> V_288 = 1 ;
return 0 ;
...
int F_152 ( struct V_4 * V_8 , T_10 V_296 )
{
struct V_21 * V_10 = V_8 -> V_10 ;
struct V_65 V_66 ;
const void * V_100 ;
...
F_29 ( & V_66 . V_91 ) ;
F_29 ( & V_66 . V_97 ) ;
F_153 ( & V_66 . V_70 , & V_8 -> V_70 ,
V_8 -> V_70 . V_66 ) ;
F_153 ( & V_66 . V_76 , & V_8 -> V_76 ,
V_8 -> V_76 . V_66 ) ;
F_153 ( & V_66 . V_82 , & V_8 -> V_82 ,
V_8 -> V_82 . V_66 ) ;
F_153 ( & V_66 . V_87 , & V_8 -> V_87 ,
V_8 -> V_87 . V_66 ) ;
F_153 ( & V_66 . V_91 , & V_8 -> V_91 ,
V_8 -> V_91 . V_66 ) ;
F_153 ( & V_66 . V_97 , & V_8 -> V_97 ,
V_8 -> V_97 . V_66 ) ;
V_297 = ( T_1 * ) V_8 -> V_299 ;
V_100 = V_297 + V_296 ;
while ( ! F_154 ( V_297 ) )
V_297 = F_36 ( V_8 , & V_66 , V_297 , V_100 ) ;
if ( F_155 ( V_297 ) ) {
F_16 ( V_10 , L_67 , V_46 ,
F_156 ( V_297 ) ) ;
V_28 = F_156 ( V_297 ) ;
...
static struct V_4 * F_157 ( struct V_7 * V_31 )
{
struct V_5 * V_6 ;
struct V_4 * V_8 ;
...
static int F_161 ( struct V_7 * V_31 )
{
struct V_302 V_13 = { V_303 , NULL } ;
struct V_4 * V_8 ;
struct V_21 * V_10 = & V_31 -> V_10 ;
struct V_304 * V_305 ;
T_11 V_253 = V_306 ;
T_10 V_296 ;
int V_28 ;
V_253 = F_162 ( L_68 , 0 , & V_305 , & V_296 ) ;
if ( F_163 ( V_253 ) ) {
F_16 ( V_10 , L_69 ) ;
return 0 ;
}
...
V_8 -> V_134 = * V_305 ;
V_8 -> V_299 = ( void * ) V_305 + sizeof( struct V_307 ) ;
V_296 -= sizeof( struct V_307 ) ;
V_253 = F_164 ( V_31 -> V_25 , L_71 , NULL , & V_13 ) ;
if ( F_165 ( V_253 ) && V_13 . V_44 > 0 ) {
union V_17 * V_308 ;
V_308 = V_13 . V_43 ;
if ( V_308 -> type == V_41 ) {
V_8 -> V_299 =
(struct V_101 * ) V_308 -> V_42 . V_43 ;
V_296 = V_308 -> V_42 . V_44 ;
} else
F_16 ( V_10 , L_72 ,
V_46 , ( int ) V_308 -> type ) ;
}
V_28 = F_152 ( V_8 , V_296 ) ;
if ( V_28 ) {
F_166 ( V_8 -> V_133 ) ;
return V_28 ;
}
...
static int F_167 ( struct V_7 * V_31 )
{
struct V_4 * V_8 = F_168 ( & V_31 -> V_10 ) ;
F_166 ( V_8 -> V_133 ) ;
return 0 ;
}
static void F_169 ( struct V_7 * V_31 , T_3 V_309 )
{
struct V_4 * V_8 = F_168 ( & V_31 -> V_10 ) ;
struct V_302 V_13 = { V_303 , NULL } ;
struct V_101 * V_310 ;
...
V_8 -> V_299 =
(struct V_101 * ) V_308 -> V_42 . V_43 ;
V_311 = F_152 ( V_8 , V_308 -> V_42 . V_44 ) ;
if ( V_311 ) {
V_8 -> V_299 = V_310 ;
F_21 ( V_10 , L_76 ) ;
}
...
static T_12 int F_172 ( void )
{
F_173 ( sizeof( struct V_307 ) != 40 ) ;
F_173 ( sizeof( struct V_61 ) != 56 ) ;
F_173 ( sizeof( struct V_73 ) != 48 ) ;
F_173 ( sizeof( struct V_88 ) != 20 ) ;
F_173 ( sizeof( struct V_313 ) != 9 ) ;
F_173 ( sizeof( struct V_79 ) != 80 ) ;
F_173 ( sizeof( struct V_84 ) != 40 ) ;
F_174 ( V_314 , V_3 [ V_53 ] ) ;
F_174 ( V_315 , V_3 [ V_54 ] ) ;
F_174 ( V_316 , V_3 [ V_55 ] ) ;
F_174 ( V_317 , V_3 [ V_56 ] ) ;
F_174 ( V_318 , V_3 [ V_57 ] ) ;
F_174 ( V_319 , V_3 [ V_58 ] ) ;
F_174 ( V_320 , V_3 [ V_59 ] ) ;
F_174 ( V_321 , V_3 [ V_60 ] ) ;
F_174 ( V_322 , V_3 [ V_34 ] ) ;
F_174 ( V_323 , V_3 [ V_33 ] ) ;
return F_175 ( & V_324 ) ;
}
static T_13 void F_176 ( void )
{
F_177 ( & V_324 ) ;
}
