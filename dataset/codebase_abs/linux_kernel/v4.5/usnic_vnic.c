...
struct V_16 * V_17 ;
int V_20 ;
if ( F_23 ( V_10 , type ) < V_28 || V_28 < 0 || ! V_31 )
return F_26 ( - V_39 ) ;
...
if ( V_28 > 0 ) {
V_45 -> V_17 = F_29 ( V_28 , sizeof( * ( V_45 -> V_17 ) ) , V_46 ) ;
if ( ! V_45 -> V_17 ) {
F_28 ( L_8 ,
F_5 ( V_10 ) ) ;
F_30 ( V_45 ) ;
...
if ( ! ( F_37 ( V_54 , V_20 ) & V_56 ) )
continue;
V_10 -> V_55 [ V_20 ] . V_25 = F_38 ( V_54 , V_20 ) ;
V_10 -> V_55 [ V_20 ] . V_24 = F_39 ( V_54 , V_20 , V_10 -> V_55 [ V_20 ] . V_25 ) ;
...
V_10 -> V_55 [ V_20 ] . V_23 = F_40 ( V_54 , V_20 ) ;
}
V_10 -> V_50 = F_41 ( NULL , V_54 , V_54 , V_10 -> V_55 ,
F_16 ( V_10 -> V_55 ) ) ;
if ( ! V_10 -> V_50 ) {
F_28 ( L_10 ,
F_6 ( V_54 ) ) ;
...
if ( ! V_10 -> V_55 [ V_20 ] . V_24 )
break;
F_43 ( V_10 -> V_55 [ V_20 ] . V_24 ) ;
}
return V_49 ;
}
struct V_53 * F_7 ( struct V_9 * V_10 )
{
return F_44 ( V_10 -> V_50 ) ;
}
...
struct V_9 * F_46 ( struct V_53 * V_54 )
{
struct V_9 * V_10 ;
int V_49 = 0 ;
if ( ! F_47 ( V_54 ) ) {
