...
struct V_98 * V_152 ;
struct V_61 * V_62 ;
struct V_63 * V_64 = V_63 ;
unsigned char V_214 [ 36 ] ;
unsigned long V_67 ;
int V_215 = ( V_211 -> V_216 ) ? V_211 -> V_216 :
V_217 ;
V_31 = V_53 -> V_176 . V_196 ;
if ( ! V_31 ) {
F_52 ( L_22 ) ;
...
memset ( & V_214 , 0 , 36 ) ;
snprintf ( V_214 , sizeof( V_214 ) , L_48 , V_213 ) ;
V_62 -> V_98 = F_131 ( V_27 ,
V_214 ) ;
if ( ! V_62 -> V_98 ) {
F_132 ( V_62 ) ;
return - V_20 ;
...
F_116 ( V_31 , V_152 , V_99 , V_62 ,
V_63 , V_194 ) ;
F_120 ( V_31 , V_152 , V_99 , V_62 ,
V_63 , V_201 ) ;
F_40 ( & V_211 -> V_69 . V_70 , V_67 ) ;
F_133 ( V_152 -> V_27 , V_152 , V_62 , V_64 ) ;
return 0 ;
}
static void F_134 ( struct V_63 * V_64 , T_11 V_194 ,
T_10 V_201 , bool V_219 )
{
struct V_177 * V_69 = V_64 -> V_69 ;
struct V_210 * V_211 = V_69 -> V_211 ;
T_7 * V_53 = F_122 ( V_211 -> V_212 ) ;
...
struct V_156 , V_98 ) ;
T_3 V_195 ;
if ( V_64 -> V_201 != V_201 || V_64 -> V_194 . V_220 != V_194 . V_220 )
F_135 ( L_49 ,
V_64 , V_64 -> V_214 ,
...
{
int V_25 ;
V_25 = F_138 ( & V_31 -> V_159 ) ;
if ( V_25 ) {
F_52 ( L_53 ) ;
return V_25 ;
}
V_31 -> V_204 = F_139 ( sizeof( struct V_202 ) *
65536 ) ;
if ( ! V_31 -> V_204 ) {
F_52 ( L_54 ,
...
static int F_141 ( struct V_66 * V_53 ,
void * V_196 ,
T_2 V_223 , T_2 V_224 )
{
struct V_210 * V_211 = V_53 -> V_68 ;
struct V_30 * V_31 =
(struct V_30 * ) V_196 ;
V_211 -> V_69 . V_225 = & V_226 ;
V_53 -> V_176 . V_196 = V_196 ;
V_31 -> V_172 = V_53 ;
return 0 ;
}
static struct V_153 * F_142 (
struct V_227 * V_228 ,
struct V_184 * V_185 ,
const char * V_1 )
{
...
V_31 -> V_229 = V_22 ;
F_3 ( & V_31 -> V_230 [ 0 ] , V_10 ,
V_22 ) ;
sprintf ( V_31 -> V_32 , L_57 , ( unsigned long long ) V_22 ) ;
V_183 = F_137 ( V_31 ) ;
if ( V_183 != 0 )
goto V_231;
V_183 = F_143 ( V_31 , V_22 , 0 , 0 ,
F_141 ) ;
if ( V_183 != 0 )
goto V_232;
return & V_31 -> V_155 ;
...
static void F_145 ( struct V_153 * V_2 )
{
struct V_30 * V_31 = F_12 ( V_2 ,
struct V_30 , V_155 ) ;
struct V_66 * V_53 = V_31 -> V_172 ;
struct V_98 * V_157 ;
T_3 V_195 = 0 ;
if ( V_53 -> V_176 . V_177 && ! V_53 -> V_176 . V_177 -> V_233 )
F_146 ( V_53 -> V_176 . V_177 ) ;
F_147 ( V_53 ) ;
F_144 ( V_31 -> V_204 ) ;
...
static int F_149 ( struct V_66 * V_171 ,
void * V_196 ,
T_2 V_223 , T_2 V_224 )
{
struct V_234 * V_235 ;
struct V_236 * V_237 = V_171 -> V_238 ;
struct V_66 * V_239 ;
struct V_30 * V_31 =
(struct V_30 * ) V_196 ;
struct V_30 * V_240 =
...
if ( ! V_240 || ! V_240 -> V_192 ||
! F_86 ( & V_240 -> V_192 -> V_168 ) ) {
F_52 ( L_59 ) ;
return - V_181 ;
}
...
V_242 . V_246 = V_247 ;
V_242 . V_248 = false ;
V_235 = F_151 ( V_237 , 0 , & V_242 ) ;
if ( ! V_235 ) {
F_52 ( L_60 ) ;
return - V_180 ;
}
V_239 = (struct V_66 * ) V_235 -> V_249 ;
V_239 -> V_176 . V_196 = V_196 ;
V_31 -> V_172 = V_239 ;
F_152 ( V_239 -> V_238 ) ;
return 0 ;
}
static struct V_153 * F_153 (
struct V_227 * V_228 ,
struct V_184 * V_185 ,
const char * V_1 )
{
struct V_30 * V_31 ;
T_2 V_250 , V_223 , V_224 ;
char * V_251 , V_252 [ 128 ] ;
int V_183 ;
snprintf ( V_252 , 128 , L_61 , V_1 ) ;
V_251 = strchr ( V_252 , '@' ) ;
if ( ! V_251 ) {
F_52 ( L_62 ) ;
return F_104 ( - V_20 ) ;
...
* V_251 ++ = '\0' ;
if ( F_1 ( V_252 , & V_250 , 1 ) < 0 )
return F_104 ( - V_20 ) ;
if ( F_9 ( V_251 , strlen ( V_251 ) + 1 ,
& V_223 , & V_224 ) < 0 )
return F_104 ( - V_20 ) ;
V_31 = F_105 ( sizeof( struct V_30 ) , V_189 ) ;
if ( ! V_31 ) {
...
V_31 -> V_253 = V_223 ;
V_31 -> V_254 = V_224 ;
sprintf ( V_31 -> V_32 , L_57 , ( unsigned long long ) V_223 ) ;
V_183 = F_137 ( V_31 ) ;
if ( V_183 != 0 )
goto V_231;
V_183 = F_143 ( V_31 , V_250 , V_223 , V_224 ,
F_149 ) ;
if ( V_183 != 0 )
goto V_232;
return & V_31 -> V_155 ;
...
static void F_154 ( struct V_153 * V_2 )
{
struct V_30 * V_31 = F_12 ( V_2 ,
struct V_30 , V_155 ) ;
struct V_66 * V_239 = V_31 -> V_172 ;
struct V_210 * V_211 = V_239 -> V_68 ;
...
static T_1 F_157 ( struct V_164 * V_165 ,
char * V_166 )
{
return sprintf ( V_166 ,
L_64
V_255 L_65 , V_256 , F_158 () -> V_257 ,
F_158 () -> V_258 ) ;
}
