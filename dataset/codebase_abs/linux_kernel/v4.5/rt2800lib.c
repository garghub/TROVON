...
enum V_1310 V_1311 ,
struct V_314 * V_315 , T_3 V_1312 , T_3 * V_1313 ,
T_1 V_1314 , bool V_1315 )
{
struct V_316 * V_317 = (struct V_316 * ) V_315 -> V_1316 ;
int V_888 = 0 ;
...
break;
case V_1319 :
F_240 ( V_313 , V_315 -> V_323 , V_1312 ) ;
break;
case V_1320 :
case V_1321 :
case V_1322 :
F_241 ( V_313 , V_315 -> V_323 , V_1312 ) ;
break;
case V_1323 :
break;
default:
...
if ( V_576 != 0 )
return - V_1329 ;
V_1325 -> V_464 = V_352 -> V_856 . V_732 ;
F_31 ( V_2 , V_667 , & V_1326 ) ;
F_31 ( V_2 , V_668 , & V_1327 ) ;
F_31 ( V_2 , V_669 , & V_1328 ) ;
if ( V_1326 || V_1327 ) {
V_1325 -> V_1330 = V_1331 |
V_1332 |
V_1333 ;
V_1325 -> time = ( V_1326 + V_1327 ) / 1000 ;
V_1325 -> V_1334 = V_1327 / 1000 ;
V_1325 -> V_1335 = V_1328 / 1000 ;
}
if ( ! ( V_31 -> V_352 . V_119 & V_1336 ) )
V_1325 -> V_1330 |= V_1337 ;
return 0 ;
}
