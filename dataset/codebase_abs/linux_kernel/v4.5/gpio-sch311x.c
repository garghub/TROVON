...
struct V_11 * V_12 ;
int V_30 , V_31 ;
if ( ! F_12 ( V_26 -> V_15 + V_32 , 6 , V_2 ) ) {
F_13 ( & V_24 -> V_27 , L_3 ,
V_26 -> V_15 + V_32 , V_26 -> V_15 + V_32 + 5 ) ;
return - V_3 ;
}
V_29 = F_25 ( & V_24 -> V_27 , sizeof( * V_29 ) , V_33 ) ;
if ( ! V_29 )
return - V_34 ;
F_26 ( V_24 , V_29 ) ;
...
return 0 ;
V_47:
F_6 ( V_26 -> V_15 + V_32 , 6 ) ;
for ( -- V_31 ; V_31 >= 0 ; V_31 -- )
F_31 ( & V_29 -> V_35 [ V_31 ] . V_9 ) ;
return V_30 ;
}
...
static int T_1 F_34 ( int V_1 , unsigned short * V_48 )
{
int V_30 = 0 , V_6 ;
unsigned short V_49 ;
unsigned char V_50 ;
