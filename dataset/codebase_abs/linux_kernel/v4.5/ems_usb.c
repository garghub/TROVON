...
{
V_3 -> V_106 . V_18 . V_107 . V_108 . V_57 . V_105 = V_105 ;
...
F_41 ( & V_3 -> V_129 ) ;
F_42 ( & V_3 -> V_96 , 0 ) ;
for ( V_23 = 0 ; V_23 < V_103 ; V_23 ++ )
V_3 -> V_130 [ V_23 ] . V_102 = V_103 ;
}
...
V_115 = F_32 ( V_3 -> V_92 , V_132 , V_15 , & V_1 -> V_95 ) ;
if ( ! V_115 ) {
F_8 ( V_6 , L_8 ) ;
F_33 ( V_1 ) ;
goto V_135;
}
V_18 = (struct V_17 * ) & V_115 [ V_84 ] ;
V_18 -> V_18 . V_27 . V_28 = F_50 ( V_20 -> V_26 & V_136 ) ;
...
V_18 -> V_30 = V_139 + V_20 -> V_29 ;
}
for ( V_23 = 0 ; V_23 < V_103 ; V_23 ++ ) {
if ( V_3 -> V_130 [ V_23 ] . V_102 == V_103 ) {
V_4 = & V_3 -> V_130 [ V_23 ] ;
break;
}
}
if ( ! V_4 ) {
F_22 ( V_3 -> V_92 , V_132 , V_115 , V_1 -> V_95 ) ;
F_33 ( V_1 ) ;
F_36 ( V_6 , L_14 ) ;
return V_142 ;
}
...
V_4 -> V_102 = V_23 ;
V_4 -> V_101 = V_20 -> V_29 ;
F_18 ( V_1 , V_3 -> V_92 , F_27 ( V_3 -> V_92 , 2 ) , V_115 ,
V_132 , F_20 , V_4 ) ;
V_1 -> V_118 |= V_119 ;
F_34 ( V_1 , & V_3 -> V_129 ) ;
F_51 ( V_22 , V_6 , V_4 -> V_102 ) ;
F_52 ( & V_3 -> V_96 ) ;
V_7 = F_6 ( V_1 , V_15 ) ;
if ( F_53 ( V_7 ) ) {
F_54 ( V_6 , V_4 -> V_102 ) ;
...
{
struct V_2 * V_3 = F_44 ( V_6 ) ;
struct V_148 * V_149 = & V_3 -> V_43 . V_150 ;
T_1 V_151 , V_152 ;
V_151 = ( ( V_149 -> V_153 - 1 ) & 0x3f ) | ( ( ( V_149 -> V_154 - 1 ) & 0x3 ) << 6 ) ;
V_152 = ( ( V_149 -> V_155 + V_149 -> V_156 - 1 ) & 0xf ) |
( ( ( V_149 -> V_157 - 1 ) & 0x7 ) << 4 ) ;
if ( V_3 -> V_43 . V_158 & V_159 )
V_152 |= 0x80 ;
F_5 ( V_6 , L_18 , V_151 , V_152 ) ;
V_3 -> V_106 . V_18 . V_107 . V_108 . V_57 . V_151 = V_151 ;
V_3 -> V_106 . V_18 . V_107 . V_108 . V_57 . V_152 = V_152 ;
return F_25 ( V_3 , & V_3 -> V_106 ) ;
}
static void F_61 ( struct V_17 * V_18 )
{
struct V_160 * V_57 =
& V_18 -> V_18 . V_107 . V_108 . V_57 ;
V_18 -> type = V_161 ;
V_18 -> V_30 = sizeof( struct V_162 ) ;
V_18 -> V_112 = 0 ;
V_18 -> V_18 . V_107 . V_163 = V_164 ;
V_57 -> V_165 = 0x00 ;
V_57 -> V_166 = 0x00 ;
V_57 -> V_167 = 0x00 ;
V_57 -> V_168 = 0x00 ;
...
V_3 -> V_6 = V_6 ;
V_3 -> V_43 . V_40 = V_178 ;
V_3 -> V_43 . clock . V_179 = V_180 ;
V_3 -> V_43 . V_181 = & V_182 ;
V_3 -> V_43 . V_183 = F_60 ;
V_3 -> V_43 . V_184 = F_59 ;
V_3 -> V_43 . V_185 = V_159 ;
V_6 -> V_186 = & V_187 ;
V_6 -> V_188 |= V_189 ;
F_66 ( & V_3 -> V_120 ) ;
F_66 ( & V_3 -> V_129 ) ;
