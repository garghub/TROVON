...
if ( V_6 -> V_7 [ 0 ] >= 0 )
V_6 -> V_4 . V_53 = F_4 ;
V_5 -> V_9 . V_54 = V_6 -> V_9 ;
V_43 = F_24 ( V_39 , NULL ) ;
if ( ! V_43 )
return - V_55 ;
F_25 ( & V_6 -> V_4 , V_43 ) ;
V_5 -> V_56 = F_26 ( V_57 , L_3 , ( V_58 ) V_41 -> V_59 ,
V_43 -> V_56 ) ;
if ( ! V_5 -> V_56 ) {
V_42 = - V_60 ;
goto V_61;
}
V_42 = F_27 ( V_5 , V_6 -> V_51 ) ;
if ( V_42 )
goto V_61;
...
int V_65 ;
int V_35 ;
V_6 = F_32 ( sizeof( * V_6 ) , V_57 ) ;
if ( ! V_6 )
return - V_60 ;
V_42 = F_33 ( V_63 -> V_9 . V_66 , 0 , & V_41 ) ;
if ( V_42 ) {
F_10 ( & V_63 -> V_9 , L_4 ) ;
goto V_67;
}
V_42 = F_34 ( V_41 . V_59 , & V_6 -> V_16 ) ;
if ( V_42 ) {
F_10 ( & V_63 -> V_9 , L_5 ) ;
goto V_67;
}
V_64 = F_35 ( V_63 -> V_9 . V_66 , L_6 ,
& V_65 ) ;
if ( ! V_64 || V_65 != sizeof( V_68 ) ) {
F_10 ( & V_63 -> V_9 , L_7 ) ;
V_42 = - V_69 ;
goto V_67;
}
V_6 -> V_21 = * V_64 ;
V_64 = F_35 ( V_63 -> V_9 . V_66 , L_8 , & V_65 ) ;
if ( ! V_64 || V_65 != sizeof( V_68 ) ) {
F_10 ( & V_63 -> V_9 , L_9 ) ;
V_42 = - V_69 ;
goto V_67;
...
V_6 -> V_22 = * V_64 ;
V_64 = F_35 ( V_63 -> V_9 . V_66 ,
L_10 , & V_65 ) ;
if ( V_64 && ( V_65 / sizeof( V_68 ) ) > 0 ) {
V_6 -> V_51 = V_65 / sizeof( V_68 ) ;
if ( V_6 -> V_51 >= V_30 ) {
F_10 ( & V_63 -> V_9 , L_11 ) ;
goto V_67;
}
for ( V_35 = 0 ; V_35 < V_6 -> V_51 ; V_35 ++ )
V_6 -> V_24 [ V_35 ] = F_36 ( V_64 [ V_35 ] ) ;
} else {
V_6 -> V_51 = 1 ;
}
for ( V_35 = 0 ; V_35 < V_6 -> V_51 ; V_35 ++ ) {
V_6 -> V_7 [ V_35 ] = - 1 ;
V_7 = F_37 ( V_63 -> V_9 . V_66 , V_35 ) ;
if ( V_7 >= 0 ) {
V_42 = F_38 ( V_7 , F_39 ( & V_63 -> V_9 ) ) ;
if ( V_42 ) {
F_10 ( & V_63 -> V_9 ,
L_12 , V_35 ) ;
goto V_70;
...
F_10 ( & V_63 -> V_9 , L_13 , V_35 ) ;
goto V_70;
}
}
V_64 = F_35 ( V_63 -> V_9 . V_66 , L_14 , NULL ) ;
if ( V_64 )
V_6 -> V_44 = F_41 ( V_64 ) ;
else
V_6 -> V_44 = 50 ;
V_64 = F_35 ( V_63 -> V_9 . V_66 , L_15 , & V_65 ) ;
if ( V_64 && V_65 == sizeof( V_68 ) )
V_6 -> V_26 = F_41 ( V_64 ) ;
else
V_6 -> V_26 = V_27 |
V_36 ;
V_6 -> V_31 = F_42 ( & V_63 -> V_9 , V_41 . V_59 ,
F_43 ( & V_41 ) ) ;
if ( ! V_6 -> V_31 ) {
V_42 = - V_60 ;
goto V_70;
...
V_6 -> V_9 = & V_63 -> V_9 ;
V_6 -> V_15 = V_19 ;
V_42 = F_23 ( V_6 , V_63 -> V_9 . V_66 , & V_41 ) ;
if ( V_42 )
goto V_70;
F_44 ( & V_63 -> V_9 , V_6 ) ;
return 0 ;
