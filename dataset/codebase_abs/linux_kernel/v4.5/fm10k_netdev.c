...
static int F_122 ( struct V_61 * V_21 , struct V_154 * V_155 , int V_156 )
{
switch ( V_156 ) {
case V_157 :
return F_123 ( V_21 , V_155 ) ;
case V_158 :
return F_124 ( V_21 , V_155 ) ;
default:
return - V_159 ;
}
}
...
for ( V_18 = 0 ; V_18 < V_17 -> V_27 ; V_18 ++ ) {
V_29 = V_17 -> V_23 [ V_18 ] ;
F_126 ( V_29 -> V_161 , V_161 ) ;
}
V_17 -> V_161 = V_161 ;
}
static void * F_127 ( struct V_61 * V_4 ,
struct V_61 * V_162 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
...
if ( V_17 -> V_50 < 7 )
return F_128 ( - V_166 ) ;
V_5 = F_129 ( struct V_160 , V_167 [ 7 ] ) ;
V_161 = F_130 ( V_5 , V_14 ) ;
if ( ! V_161 )
return F_128 ( - V_15 ) ;
V_161 -> V_5 = 7 ;
V_161 -> V_165 = V_17 -> V_48 ;
F_125 ( V_17 , V_161 ) ;
} else if ( ( V_161 -> V_7 == V_168 ) ||
( V_161 -> V_7 == ( V_17 -> V_50 - 1 ) ) ) {
return F_128 ( - V_166 ) ;
} else if ( V_161 -> V_7 == V_161 -> V_5 ) {
V_163 = V_161 ;
V_5 = F_129 ( struct V_160 ,
V_167 [ ( V_161 -> V_5 * 2 ) + 1 ] ) ;
V_161 = F_130 ( V_5 , V_14 ) ;
if ( ! V_161 )
return F_128 ( - V_15 ) ;
...
F_129 ( struct V_160 ,
V_167 [ V_163 -> V_5 ] ) ) ;
V_161 -> V_5 = ( V_163 -> V_5 * 2 ) + 1 ;
F_125 ( V_17 , V_161 ) ;
F_131 ( V_163 , V_169 ) ;
}
for ( V_18 = 0 ; V_18 < V_161 -> V_5 ; V_18 ++ ) {
if ( ! V_161 -> V_167 [ V_18 ] )
break;
}
V_161 -> V_167 [ V_18 ] = V_162 ;
V_161 -> V_7 ++ ;
V_165 . V_170 = V_171 ;
V_165 . V_172 = 1 ;
V_165 . V_173 = F_132 ( V_17 -> V_174 [ V_175 ] . V_44 ) ;
V_165 . V_176 = F_132 ( V_17 -> V_174 [ V_177 ] . V_44 ) ;
V_165 . V_48 = V_17 -> V_48 ;
V_165 . V_178 = F_132 ( V_161 -> V_5 ) ;
V_43 -> V_45 . V_98 . V_179 ( V_43 , & V_165 ) ;
F_84 ( V_17 ) ;
V_48 = V_161 -> V_165 + 1 + V_18 ;
V_43 -> V_45 . V_98 . V_137 ( V_43 , V_48 , V_134 ) ;
V_43 -> V_45 . V_98 . V_99 ( V_43 , V_48 , V_162 -> V_124 , 0 , true , 0 ) ;
F_87 ( V_17 ) ;
return V_162 ;
}
static void F_133 ( struct V_61 * V_4 , void * V_180 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
struct V_160 * V_161 = F_109 ( V_17 -> V_161 ) ;
struct V_164 V_165 = { 0 } ;
struct V_42 * V_43 = & V_17 -> V_43 ;
struct V_61 * V_162 = V_180 ;
int V_18 ;
T_1 V_48 ;
if ( ! V_161 )
return;
for ( V_18 = 0 ; V_18 < V_161 -> V_5 ; V_18 ++ ) {
if ( V_161 -> V_167 [ V_18 ] == V_162 )
break;
}
if ( V_18 == V_161 -> V_5 )
return;
...
V_43 -> V_45 . V_98 . V_99 ( V_43 , V_48 , V_162 -> V_124 , 0 , false , 0 ) ;
F_87 ( V_17 ) ;
V_161 -> V_167 [ V_18 ] = NULL ;
V_161 -> V_7 -- ;
V_165 . V_170 = V_171 ;
V_165 . V_172 = 1 ;
V_165 . V_173 = F_132 ( V_17 -> V_174 [ V_175 ] . V_44 ) ;
...
static T_10 F_134 ( struct V_67 * V_30 ,
struct V_61 * V_4 ,
T_10 V_181 )
{
if ( ! V_30 -> V_182 || F_135 ( V_30 ) )
return V_181 ;
return V_181 & ~ ( V_183 | V_184 ) ;
}
struct V_61 * F_136 ( const struct V_185 * V_186 )
{
T_10 V_187 ;
struct V_16 * V_17 ;
struct V_61 * V_4 ;
V_4 = F_137 ( sizeof( struct V_16 ) , V_188 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_189 = & V_190 ;
F_138 ( V_4 ) ;
V_17 = F_41 ( V_4 ) ;
V_17 -> V_191 = ( 1 << V_192 ) - 1 ;
V_4 -> V_181 |= V_193 |
V_194 |
V_195 |
V_196 |
