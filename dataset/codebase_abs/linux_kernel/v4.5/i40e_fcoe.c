...
<< V_92 ) ;
F_34 ( V_67 , V_86 , V_68 ) ;
F_35 ( & V_28 -> V_34 -> V_35 , L_3 ) ;
}
T_2 F_36 ( struct V_27 * V_28 )
{
struct V_93 V_94 ;
struct V_66 * V_67 = & V_28 -> V_67 ;
T_2 V_95 = 0 ;
...
int F_37 ( struct V_109 * V_60 , struct V_110 * V_111 )
{
...
V_111 -> V_119 = V_120 ;
V_111 -> V_32 = V_121 ;
V_113 -> V_122 |= F_39 ( V_123 ) ;
V_113 -> V_122 &= F_39 ( ~ ( V_124 |
V_125 |
V_126 |
V_127 |
V_128 ) ) ;
...
V_38 = F_52 ( V_143 , V_35 , V_144 ,
V_145 , V_146 ) ;
if ( ! V_38 ) {
F_38 ( V_35 , L_12 , V_143 ) ;
return - V_147 ;
}
V_141 -> V_38 = V_38 ;
return 0 ;
}
void F_53 ( struct V_109 * V_60 )
{
struct V_27 * V_28 = V_60 -> V_61 ;
struct V_62 * V_63 = & V_28 -> V_63 ;
int V_139 , V_97 ;
...
F_25 ( V_60 -> V_57 , V_97 ) ;
F_54 (cpu)
F_48 ( V_63 , & V_28 -> V_34 -> V_35 , V_139 ) ;
F_55 ( V_63 -> V_141 ) ;
V_63 -> V_141 = NULL ;
F_47 ( V_60 -> V_57 , L_13 ,
V_60 -> V_42 , V_60 -> V_148 ) ;
}
int F_56 ( struct V_109 * V_60 )
{
struct V_27 * V_28 = V_60 -> V_61 ;
...
if ( V_63 -> V_141 )
return - V_149 ;
V_63 -> V_141 = F_57 ( struct V_140 ) ;
if ( ! V_63 -> V_141 ) {
F_38 ( & V_28 -> V_34 -> V_35 , L_14 ) ;
return - V_147 ;
}
F_54 (cpu) {
if ( ! F_51 ( V_63 , V_35 , V_139 ) )
continue;
F_38 ( V_35 , L_15 , V_139 ) ;
F_53 ( V_60 ) ;
return - V_147 ;
}
for ( V_97 = 0 ; V_97 < V_26 ; V_97 ++ )
...
if ( ! F_18 ( V_154 ) )
return;
V_24 = F_59 ( V_153 -> V_156 . V_157 . V_158 . V_159 ) &
( V_26 - 1 ) ;
if ( ! F_12 ( V_24 ) )
return;
V_30 = & V_63 -> V_30 [ V_24 ] ;
F_11 ( V_24 != V_30 -> V_24 ) ;
V_155 = F_60 ( V_153 -> V_156 . V_160 . V_161 ) ;
error = ( V_155 & V_162 ) >>
V_163 ;
if ( V_154 == V_43 ) {
if ( F_61 ( error ) ) {
F_38 ( & V_28 -> V_34 -> V_35 , L_17 ,
V_24 , V_30 -> V_24 ) ;
V_30 -> V_164 |= V_165 ;
}
if ( F_62 ( error ) ) {
F_38 ( & V_28 -> V_34 -> V_35 , L_18 ,
V_24 , V_30 -> V_24 ) ;
V_30 -> V_164 |= V_166 ;
}
}
if ( V_154 == V_44 ) {
if ( F_63 ( error ) ) {
F_38 ( & V_28 -> V_34 -> V_35 , L_19 ,
V_24 , V_30 -> V_24 ) ;
V_30 -> V_164 |= V_167 ;
}
F_64 ( V_168 , & V_30 -> V_32 ) ;
}
F_13 ( V_28 , V_30 ) ;
F_17 ( V_30 ) ;
}
int F_65 ( struct V_150 * V_151 ,
union V_152 * V_153 ,
struct V_9 * V_10 )
{
struct V_27 * V_28 = V_151 -> V_60 -> V_61 ;
...
if ( ! V_30 -> V_33 )
goto V_175;
V_24 = F_67 ( V_153 -> V_156 . V_157 . V_189 . V_190 . V_191 ) ;
if ( V_30 -> V_24 != V_24 ) {
F_38 ( & V_28 -> V_34 -> V_35 , L_21 ,
V_30 -> V_24 , V_24 ) ;
goto V_192;
}
if ( V_30 -> V_171 ) {
F_38 ( & V_28 -> V_34 -> V_35 , L_22 ,
V_24 , V_30 -> V_171 , V_171 ) ;
goto V_192;
}
V_30 -> V_19 = F_59 ( V_153 -> V_156 . V_157 . V_158 . V_159 ) ;
V_30 -> V_171 = V_171 ;
if ( V_170 == V_193 ) {
T_3 V_47 = F_20 ( V_46 -> V_48 ) ;
if ( ( V_47 & V_194 ) &&
...
V_198 = (struct V_197 * ) F_68 ( V_10 , sizeof( * V_198 ) ) ;
V_198 -> V_199 = V_16 ;
} else {
V_172 = 0 ;
goto V_175;
...
static int F_71 ( struct V_56 * V_57 , T_1 V_24 ,
...
F_35 ( & V_28 -> V_34 -> V_35 , L_24 ,
V_24 ) ;
return 0 ;
}
V_30 = & V_63 -> V_30 [ V_24 ] ;
if ( V_30 -> V_33 ) {
F_35 ( & V_28 -> V_34 -> V_35 , L_25 ,
V_24 , V_30 -> V_33 , V_30 -> V_36 ) ;
return 0 ;
}
F_17 ( V_30 ) ;
if ( ! V_63 -> V_141 ) {
F_35 ( & V_28 -> V_34 -> V_35 , L_26 , V_24 ) ;
return 0 ;
}
V_141 = F_49 ( V_63 -> V_141 , F_72 () ) ;
if ( ! V_141 -> V_38 ) {
F_35 ( & V_28 -> V_34 -> V_35 , L_27 , V_24 ) ;
goto V_222;
}
V_213 = F_73 ( & V_28 -> V_34 -> V_35 , V_33 , V_36 , V_37 ) ;
if ( V_213 == 0 ) {
F_35 ( & V_28 -> V_34 -> V_35 , L_28 ,
V_33 , V_36 ) ;
goto V_223;
}
V_30 -> V_39 = F_74 ( V_141 -> V_38 , V_224 , & V_30 -> V_40 ) ;
if ( ! V_30 -> V_39 ) {
F_35 ( & V_28 -> V_34 -> V_35 ,
L_29 , V_24 ) ;
goto V_223;
...
V_216 = F_78 (unsigned int, (bufflen - thisoff), len) ;
if ( ( V_212 != 0 ) && ( V_215 ) )
goto V_226;
...
V_30 -> V_24 = V_24 ;
if ( V_209 )
F_70 ( V_229 , & V_30 -> V_32 ) ;
F_70 ( V_230 , & V_30 -> V_32 ) ;
F_79 () ;
return 1 ;
V_226:
F_16 ( V_30 -> V_38 , V_30 -> V_39 , V_30 -> V_40 ) ;
...
static int F_80 ( struct V_56 * V_57 , T_1 V_24 ,
struct V_208 * V_33 , unsigned int V_36 )
{
return F_71 ( V_57 , V_24 , V_33 , V_36 , 0 ) ;
}
static int F_81 ( struct V_56 * V_57 , T_1 V_24 ,
struct V_208 * V_33 , unsigned int V_36 )
{
return F_71 ( V_57 , V_24 , V_33 , V_36 , 1 ) ;
}
static void F_82 ( struct V_150 * V_231 ,
struct V_9 * V_10 ,
...
V_237 -> V_242 |=
F_84 ( V_249 ) ;
V_235 = F_85 ( V_231 , V_97 ++ ) ;
if ( V_97 == V_231 -> V_241 )
V_97 = 0 ;
V_235 -> V_250 = F_84 ( V_30 -> V_24 | ( ( T_4 ) V_30 -> V_40 ) ) ;
V_235 -> V_251 = F_84 ( V_30 -> V_228 |
( ( T_4 ) ( V_252 |
V_253 ) <<
V_254 ) ) ;
V_233 = F_86 ( V_231 , V_97 ) ;
V_97 ++ ;
if ( V_97 == V_231 -> V_241 )
V_97 = 0 ;
V_46 = (struct V_45 * ) F_87 ( V_10 ) ;
V_233 -> V_255 = F_88 ( F_89 ( V_46 -> V_256 ) ) ;
V_233 -> V_257 = F_39 ( F_90 ( V_46 -> V_258 ) ) ;
V_233 -> V_259 = F_39 ( V_30 -> V_24 <<
V_260 ) ;
V_239 = V_261 ;
V_239 |= ( T_4 ) ( V_209 ?
V_262 :
...
static void F_93 ( struct V_150 * V_231 ,
...
if ( ( V_30 -> V_24 == V_24 ) &&
( ! F_27 ( V_229 , & V_30 -> V_32 ) ) )
F_91 ( V_231 , V_10 , V_30 ) ;
}
}
}
static int F_94 ( struct V_150 * V_231 ,
struct V_9 * V_10 ,
...
if ( ! F_95 ( V_10 ) )
return 0 ;
if ( F_96 ( V_10 ) -> V_288 != V_289 ) {
F_43 ( V_10 -> V_35 ,
L_33 ,
F_96 ( V_10 ) -> V_288 ) ;
return - V_13 ;
}
* V_282 = F_97 ( V_10 ) + sizeof( struct V_45 ) +
sizeof( struct V_197 ) ;
if ( F_98 ( F_3 ( V_4 ) ) )
V_284 = V_290 ;
else
...
V_286 = F_96 ( V_10 ) -> V_294 ;
V_287 =
( ( T_4 ) V_283 << V_295 ) |
( ( T_4 ) V_284 << V_275 ) |
( ( T_4 ) V_285 << V_296 ) |
( ( T_4 ) V_286 << V_297 ) ;
V_269 = F_92 ( V_231 , V_231 -> V_238 ) ;
V_231 -> V_238 ++ ;
if ( V_231 -> V_238 == V_231 -> V_241 )
V_231 -> V_238 = 0 ;
V_269 -> V_270 = 0 ;
V_269 -> V_271 = F_39 ( ( V_281 & V_298 )
>> V_299 ) ;
V_269 -> V_272 = F_84 ( V_287 ) ;
return 1 ;
}
static void F_99 ( struct V_150 * V_231 ,
struct V_9 * V_10 ,
struct V_300 * V_301 ,
...
V_310 ) ) ;
F_101 ( V_10 , V_10 -> V_19 - sizeof( struct V_197 ) ) ;
}
V_302 |= ( V_304 >> 1 ) << V_311 ;
F_102 ( V_231 , V_10 , V_301 , V_281 , V_282 , V_303 , V_302 ) ;
}
static inline int F_103 ( struct V_9 * V_10 )
{
...
( V_307 != F_24 ( V_105 ) ) )
return - V_13 ;
F_105 ( V_10 , V_10 -> V_312 ) ;
if ( V_307 == F_24 ( V_317 ) )
return 0 ;
F_106 ( V_10 , V_10 -> V_312 + sizeof( struct V_11 ) ) ;
return 0 ;
}
static T_7 F_107 ( struct V_9 * V_10 ,
struct V_56 * V_57 )
{
...
if ( ! F_108 ( V_10 , V_231 ) )
return V_321 ;
if ( F_109 ( V_10 , V_231 , & V_281 ) )
goto V_320;
V_301 = & V_231 -> V_322 [ V_231 -> V_238 ] ;
if ( V_10 -> V_307 == F_24 ( V_317 ) )
goto V_323;
if ( F_5 ( V_10 , & V_4 ) || F_8 ( V_10 , & V_14 ) ) {
F_43 ( V_57 , L_34 , V_4 , V_14 ) ;
goto V_320;
}
V_281 |= V_324 ;
V_319 = F_94 ( V_231 , V_10 , V_281 , & V_282 , V_4 ) ;
if ( V_319 < 0 )
goto V_320;
else if ( V_319 )
V_281 |= V_325 ;
...
F_93 ( V_231 , V_10 , V_4 ) ;
V_323:
F_99 ( V_231 , V_10 , V_301 , V_281 , V_282 , V_14 ) ;
F_110 ( V_231 , V_326 ) ;
return V_327 ;
V_320:
F_111 ( V_10 ) ;
...
static int F_112 ( struct V_56 * V_57 , int V_328 )
{
F_113 ( V_57 , L_35 ) ;
return - V_114 ;
}
static int F_114 ( struct V_56 * V_57 ,
T_8 V_329 )
{
struct V_58 * V_59 = F_26 ( V_57 ) ;
struct V_109 * V_60 = V_59 -> V_60 ;
...
void F_117 ( struct V_56 * V_57 , struct V_109 * V_60 )
{
...
V_57 -> V_337 |= V_338 ;
V_57 -> V_337 |= V_339 ;
F_118 ( V_57 -> V_340 , L_36 , V_341 - 1 ) ;
V_57 -> V_342 = V_88 ;
F_119 ( V_57 , & V_28 -> V_34 -> V_35 ) ;
F_120 ( V_57 , & V_343 ) ;
V_57 -> V_344 = 1 ;
F_121 ( & V_60 -> V_345 ) ;
F_122 ( V_60 , V_67 -> V_346 . V_347 , 0 , false , false ) ;
F_122 ( V_60 , ( T_2 [ 6 ] ) V_348 , 0 , false , false ) ;
F_122 ( V_60 , V_349 , 0 , false , false ) ;
F_122 ( V_60 , V_350 , 0 , false , false ) ;
F_123 ( & V_60 -> V_345 ) ;
F_124 ( V_57 -> V_351 , V_67 -> V_346 . V_347 ) ;
F_124 ( V_57 -> V_352 , V_67 -> V_346 . V_347 ) ;
V_57 -> V_353 = & V_354 ;
}
void F_125 ( struct V_27 * V_28 )
{
struct V_109 * V_60 ;
T_1 V_148 ;
int V_97 ;
...
V_148 = V_28 -> V_60 [ V_28 -> V_356 ] -> V_148 ;
V_60 = F_126 ( V_28 , V_135 , V_148 , 0 ) ;
if ( V_60 ) {
F_29 ( & V_28 -> V_34 -> V_35 ,
L_38 ,
V_60 -> V_148 , V_60 -> V_42 , V_60 -> V_118 , V_148 ) ;
} else {
F_35 ( & V_28 -> V_34 -> V_35 , L_39 ) ;
}
}
