...
static int F_47 ( struct V_33 * V_34 , struct V_33 * V_72 , void * V_46 )
{
struct V_1 * V_7 = F_21 ( V_34 ) ;
...
V_75 . V_80 = V_76 ;
V_75 . type = V_81 [ V_76 ] ;
V_41 = F_49 ( V_23 , & V_7 -> V_31 [ V_76 ] , V_76 ,
1 << V_7 -> V_27 , & V_75 ) ;
if ( V_41 )
return V_41 ;
}
V_73 = & V_7 -> V_31 [ V_82 ] ;
V_7 -> V_6 = F_50 ( V_23 , & V_73 -> V_18 ,
V_7 -> V_27 , V_83 ,
& V_84 , V_7 ) ;
if ( F_51 ( V_7 -> V_6 ) ) {
F_39 ( L_13 ) ;
...
static void F_57 ( struct V_33 * V_34 , struct V_33 * V_72 , void * V_46 )
{
}
...
struct V_1 * V_7 ;
int V_41 ;
V_7 = F_59 ( & V_90 -> V_34 , sizeof( * V_7 ) , V_63 ) ;
if ( ! V_7 )
return - V_52 ;
V_7 -> V_90 = V_90 ;
F_60 ( & V_7 -> V_13 , F_16 ) ;
F_61 ( & V_7 -> V_21 ) ;
F_62 ( V_90 , V_7 ) ;
V_41 = F_63 ( & V_90 -> V_34 , & V_91 ) ;
if ( V_41 < 0 ) {
F_39 ( L_16 ) ;
return V_41 ;
}
V_41 = F_64 ( & V_90 -> V_34 , & V_92 ) ;
if ( V_41 )
goto V_93;
return V_41 ;
V_93:
...
static int F_66 ( struct V_89 * V_90 )
{
struct V_1 * V_7 = F_67 ( V_90 ) ;
if ( V_7 -> V_43 != (struct V_44 * ) V_45 ) {
F_28 ( V_7 -> V_43 ) ;
V_7 -> V_43 = NULL ;
return - V_42 ;
