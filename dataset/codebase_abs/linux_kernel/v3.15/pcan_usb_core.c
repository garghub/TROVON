...
if ( ( * V_144 ) -> V_146 == V_112 -> V_133 . V_147 )
break;
V_10 = * V_144 ;
if ( ! V_10 ) {
F_71 ( L_24 ,
V_4 , V_112 -> V_133 . V_147 ) ;
return - V_54 ;
}
if ( V_10 -> V_148 ) {
V_36 = V_10 -> V_148 ( V_109 ) ;
if ( V_36 )
return V_36 ;
}
