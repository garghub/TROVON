...
V_147 = V_160 -> V_163 [ V_2 -> V_28 ] ;
if ( V_147 ) {
V_147 -> V_21 [ 0 ] -> V_35 [ V_2 -> V_31 ] = V_2 -> V_67 ;
F_42 ( V_12 , V_147 , V_164 ) ;
}
}
...
return;
V_160 = & V_12 -> V_161 [ V_162 ] ;
V_147 = V_160 -> V_163 [ V_2 -> V_33 ] ;
if ( V_147 ) {
V_55 = V_2 -> V_13 . V_34 ;
V_165 = V_147 -> V_21 [ 0 ] -> V_36 ;
V_55 = F_25 ( V_165 , V_55 ) ;
...
struct V_56 * V_57 = & V_2 -> V_13 ;
if ( V_2 -> V_87 > 0 ) {
int V_166 = V_49 -> V_51 / V_2 -> V_87 ;
V_2 -> V_145 = V_49 -> V_53 [ V_166 - 1 ] ;
}
if ( V_2 -> V_18 < 0 )
V_57 -> V_14 &= ~ V_19 ;
}
static void F_44 ( struct V_11 * V_12 , struct V_46 * V_47 )
{
struct V_1 * V_2 = F_4 ( V_12 ) ;
char * V_167 ;
...
if ( V_168 ) {
V_167 = F_46 ( & V_47 -> V_39 -> V_7 ,
strlen ( V_12 -> V_167 ) + strlen ( V_168 ) + 2 ,
V_176 ) ;
if ( V_167 ) {
sprintf ( V_167 , L_10 , V_12 -> V_167 , V_168 ) ;
V_47 -> V_39 -> V_167 = V_167 ;
}
}
}
static int F_47 ( struct V_11 * V_12 , const struct V_177 * V_30 )
{
int V_178 , V_179 ;
struct V_1 * V_2 ;
struct V_56 * V_13 = V_180 ;
for ( V_179 = 0 ; V_180 [ V_179 ] . V_167 ; V_179 ++ ) {
if ( V_30 -> V_181 == V_180 [ V_179 ] . V_167 ) {
V_13 = & ( V_180 [ V_179 ] ) ;
break;
}
}
...
if ( V_30 -> V_185 == V_186 )
V_12 -> V_14 |= V_187 ;
V_2 = F_46 ( & V_12 -> V_7 , sizeof( struct V_1 ) , V_176 ) ;
if ( ! V_2 ) {
F_8 ( & V_12 -> V_7 , L_11 ) ;
return - V_188 ;
}
...
V_2 -> V_88 = - 1 ;
F_48 ( V_12 , V_2 ) ;
V_2 -> V_50 = F_46 ( & V_12 -> V_7 , sizeof( struct V_48 ) ,
V_176 ) ;
if ( ! V_2 -> V_50 ) {
F_8 ( & V_12 -> V_7 , L_12 ) ;
return - V_188 ;
}
if ( V_30 -> V_190 == V_191 && V_30 -> V_192 == V_191 )
V_2 -> V_152 = true ;
V_178 = F_49 ( V_12 ) ;
if ( V_178 != 0 )
return V_178 ;
V_178 = F_50 ( V_12 , V_193 ) ;
if ( V_178 )
return V_178 ;
V_178 = F_51 ( & V_12 -> V_7 . V_194 , & V_195 ) ;
F_43 ( V_12 ) ;
F_41 ( V_12 ) ;
F_52 ( & V_12 -> V_7 , V_2 -> V_50 ) ;
V_2 -> V_50 = NULL ;
return 0 ;
}
