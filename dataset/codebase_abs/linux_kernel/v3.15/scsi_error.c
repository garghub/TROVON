...
int F_133 ( const T_1 * V_92 , int V_266 ,
struct V_65 * V_66 )
{
if ( ! V_92 || ! V_266 )
return 0 ;
...
struct V_65 * V_66 )
{
return F_133 ( V_238 -> V_92 ,
V_165 , V_66 ) ;
}
const T_1 * F_135 ( const T_1 * V_92 , int V_266 ,
int V_267 )
{
int V_268 , V_269 , V_270 , V_271 ;
const T_1 * V_272 ;
if ( ( V_266 < 8 ) || ( 0 == ( V_268 = V_92 [ 7 ] ) ) )
return NULL ;
...
int F_136 ( const T_1 * V_92 , int V_266 ,
T_2 * V_273 )
{
int V_274 ;
const T_1 * V_275 ;
...
void F_137 ( int V_277 , T_1 * V_278 , T_1 V_279 , T_1 V_72 , T_1 V_73 )
{
if ( V_277 ) {
V_278 [ 0 ] = 0x72 ;
V_278 [ 1 ] = V_279 ;
