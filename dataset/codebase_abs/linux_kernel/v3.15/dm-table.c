...
int F_52 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
struct V_60 * V_61 = V_57 ;
struct V_51 * V_47 = V_46 -> V_47 ;
...
V_54 = F_67 ( V_7 , V_42 ++ ) ;
if ( ! V_54 -> type -> V_102 ||
! V_54 -> type -> V_102 ( V_54 , V_158 , NULL ) )
return 0 ;
}
return 1 ;
}
static int F_123 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
struct V_58 * V_59 = F_37 ( V_46 -> V_47 ) ;
return V_59 && ! V_59 -> V_61 . V_159 ;
}
...
return false ;
if ( ! V_54 -> type -> V_102 ||
V_54 -> type -> V_102 ( V_54 , F_123 , NULL ) )
return false ;
}
return true ;
}
void F_125 ( struct V_6 * V_7 , struct V_58 * V_59 ,
struct V_60 * V_61 )
{
unsigned V_153 = 0 ;
V_59 -> V_61 = * V_61 ;
...
T_2 F_131 ( struct V_6 * V_7 )
{
return V_7 -> V_27 ;
}
static void F_132 ( struct V_6 * V_7 , unsigned V_168 )
{
int V_42 = V_7 -> V_28 ;
...
if ( V_168 ) {
if ( V_54 -> type -> V_168 )
V_54 -> type -> V_168 ( V_54 ) ;
} else if ( V_54 -> type -> V_169 )
V_54 -> type -> V_169 ( V_54 ) ;
V_54 ++ ;
}
}
...
void F_136 ( struct V_6 * V_7 , struct V_172 * V_173 )
{
F_50 ( & V_173 -> V_39 , & V_7 -> V_33 ) ;
}
int F_137 ( struct V_6 * V_7 , int V_174 )
{
struct V_37 * V_38 ;
struct V_34 * V_32 = F_84 ( V_7 ) ;
struct V_172 * V_173 ;
...
for ( V_42 = 0 ; V_42 < V_7 -> V_28 ; V_42 ++ ) {
V_54 = V_7 -> V_26 + V_42 ;
if ( V_54 -> type -> V_177 && V_54 -> type -> V_177 ( V_54 ) )
return 1 ;
}
return 0 ;
}
struct V_29 * F_142 ( struct V_6 * V_7 )
{
return V_7 -> V_30 ;
}
...
V_178 = F_144 ( V_30 ) ;
if ( V_178 ) {
F_145 ( V_178 -> V_180 , V_179 ) ;
F_146 ( V_178 ) ;
F_147 ( V_178 -> V_180 , V_179 ) ;
}
}
static int F_148 ( struct V_21 * V_54 , struct V_40 * V_46 ,
T_1 V_55 , T_1 V_56 , void * V_57 )
{
struct V_58 * V_59 = F_37 ( V_46 -> V_47 ) ;
return V_59 && F_149 ( V_59 ) ;
}
...
return 1 ;
if ( V_54 -> type -> V_102 &&
V_54 -> type -> V_102 ( V_54 , F_148 , NULL ) )
return 1 ;
}
return 0 ;
}
