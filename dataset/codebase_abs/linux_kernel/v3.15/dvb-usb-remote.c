...
F_29 ( V_14 , V_16 -> V_17 . V_18 . V_55 . V_62 ) ;
...
return 0 ;
F_33 ( V_16 -> V_45 , V_16 -> V_44 , sizeof( V_16 -> V_44 ) ) ;
F_34 ( V_16 -> V_44 , L_9 , sizeof( V_16 -> V_44 ) ) ;
...
for ( V_39 = 0 ; V_39 < V_16 -> V_17 . V_18 . V_19 . V_20 ; V_39 ++ )
if ( F_41 ( & V_4 [ V_39 ] ) == V_71 [ 1 ] &&
F_42 ( & V_4 [ V_39 ] ) == V_71 [ 3 ] ) {
* V_28 = V_4 [ V_39 ] . V_10 ;
* V_29 = V_34 ;
return 0 ;
}
