...
struct V_43 * V_43 ;
struct V_52 * V_52 ;
struct V_75 * V_26 = & V_25 -> V_26 ;
const char * V_76 = F_44 ( V_26 ) ;
int V_61 ;
V_2 = F_45 ( V_26 , sizeof( * V_2 ) , V_77 ) ;
if ( ! V_2 ) {
F_46 ( V_26 , L_5 ) ;
V_61 = - V_78 ;
goto V_79;
...
return V_61 ;
F_48 ( V_25 , V_2 ) ;
V_74 = F_49 ( V_25 , V_80 , 0 ) ;
V_34 = F_49 ( V_25 , V_81 , 0 ) ;
if ( ! V_74 || ! V_34 ) {
F_46 ( V_26 , L_6 ) ;
V_61 = - V_33 ;
goto V_79;
}
V_2 -> V_4 = F_50 ( V_26 , V_74 -> V_82 , F_51 ( V_74 ) ) ;
if ( ! V_2 -> V_4 ) {
F_46 ( V_26 , L_7 ) ;
V_61 = - V_83 ;
goto V_79;
...
F_55 ( V_26 , L_11 , V_2 -> V_20 . V_69 ) ;
if ( V_2 -> V_20 . V_100 ) {
V_61 = F_19 ( V_2 -> V_40 , 0 ) ;
if ( V_2 -> V_20 . V_100 != V_61 )
F_42 ( V_26 , L_12 ,
V_2 -> V_20 . V_100 , V_61 ) ;
}
if ( V_2 -> V_20 . V_105 ) {
V_61 = F_56 ( V_43 , V_2 -> V_20 . V_105 , 0 ,
V_43 -> V_4 , V_43 -> V_93 ) ;
if ( V_61 < 0 )
F_42 ( V_26 , L_13 ) ;
}
