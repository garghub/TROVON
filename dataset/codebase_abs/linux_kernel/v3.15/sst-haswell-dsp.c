...
static int F_28 ( struct V_103 * V_8 )
{
...
V_107 = F_29 ( V_67 -> V_43 . V_91 + V_109 ) ;
V_104 = F_27 ( V_8 ) ;
F_21 ( V_107 & ~ V_104 , V_67 -> V_43 . V_91 + V_109 ) ;
F_30 ( 10 ) ;
return 0 ;
}
...
static int F_32 ( struct V_1 * V_67 )
{
int V_110 = 10 ;
T_3 V_111 ;
V_111 = F_29 ( V_67 -> V_43 . V_91 + V_112 ) ;
F_21 ( V_111 & ~ 0x3 , V_67 -> V_43 . V_91 + V_112 ) ;
while ( V_110 -- ) {
V_111 = F_12 ( V_67 , V_78 ) ;
if ( V_111 != 0xffffffff )
return 0 ;
F_33 ( 1 ) ;
}
...
static int F_34 ( struct V_1 * V_67 , struct V_94 * V_95 )
{
const struct V_113 * V_114 ;
struct V_115 * V_23 ;
int V_60 = - V_98 , V_116 , V_117 , V_118 ;
T_3 V_45 , V_34 ;
V_23 = V_67 -> V_119 ;
switch ( V_67 -> V_31 ) {
case V_120 :
V_114 = V_121 ;
V_118 = F_35 ( V_121 ) ;
V_67 -> V_43 . V_47 = V_122 ;
V_67 -> V_43 . V_102 = V_123 ;
break;
case V_124 :
V_114 = V_125 ;
V_118 = F_35 ( V_125 ) ;
V_67 -> V_43 . V_47 = V_126 ;
V_67 -> V_43 . V_102 = V_127 ;
break;
default:
F_4 ( V_23 , L_13 ) ;
return V_60 ;
...
V_45 = V_114 [ V_116 ] . V_129 ;
V_34 = ( V_114 [ V_116 ] . V_130 - V_114 [ V_116 ] . V_129 ) / V_114 [ V_116 ] . V_26 ;
for ( V_117 = 0 ; V_117 < V_114 [ V_116 ] . V_26 ; V_117 ++ ) {
F_38 ( V_67 , V_45 , V_34 ,
V_114 [ V_116 ] . type , & V_131 , V_117 , V_67 ) ;
V_45 += V_34 ;
}
}
F_21 ( 0x0 , V_67 -> V_43 . V_91 + V_109 ) ;
return 0 ;
}
