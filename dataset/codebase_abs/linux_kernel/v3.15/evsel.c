...
int F_48 ( struct V_15 * V_16 , int V_159 , int V_160 )
{
int V_161 , V_162 ;
V_16 -> V_163 = F_49 ( V_159 , V_160 , sizeof( int ) ) ;
if ( V_16 -> V_163 ) {
for ( V_161 = 0 ; V_161 < V_159 ; V_161 ++ ) {
for ( V_162 = 0 ; V_162 < V_160 ; V_162 ++ ) {
F_50 ( V_16 , V_161 , V_162 ) = - 1 ;
}
}
}
return V_16 -> V_163 != NULL ? 0 : - V_164 ;
}
static int F_51 ( struct V_15 * V_16 , int V_159 , int V_160 ,
int V_165 , void * V_166 )
{
int V_161 , V_162 ;
for ( V_161 = 0 ; V_161 < V_159 ; V_161 ++ ) {
for ( V_162 = 0 ; V_162 < V_160 ; V_162 ++ ) {
int V_163 = F_50 ( V_16 , V_161 , V_162 ) ,
V_82 = F_52 ( V_163 , V_165 , V_166 ) ;
if ( V_82 )
return V_82 ;
}
}
...
int F_53 ( struct V_15 * V_16 , int V_159 , int V_160 ,
const char * V_167 )
{
return F_51 ( V_16 , V_159 , V_160 ,
V_168 ,
( void * ) V_167 ) ;
}
int F_54 ( struct V_15 * V_16 , int V_159 , int V_160 )
{
return F_51 ( V_16 , V_159 , V_160 ,
V_169 ,
0 ) ;
}
int F_55 ( struct V_15 * V_16 , int V_159 , int V_160 )
{
V_16 -> V_170 = F_49 ( V_159 , V_160 , sizeof( struct V_171 ) ) ;
if ( V_16 -> V_170 == NULL )
return - V_164 ;
V_16 -> V_48 = F_15 ( V_159 * V_160 * sizeof( T_1 ) ) ;
if ( V_16 -> V_48 == NULL ) {
F_56 ( V_16 -> V_170 ) ;
V_16 -> V_170 = NULL ;
return - V_164 ;
...
void F_57 ( struct V_15 * V_16 , int V_159 )
{
memset ( V_16 -> V_172 , 0 , ( sizeof( * V_16 -> V_172 ) +
( V_159 * sizeof( struct V_173 ) ) ) ) ;
}
int F_58 ( struct V_15 * V_16 , int V_159 )
{
V_16 -> V_172 = F_15 ( ( sizeof( * V_16 -> V_172 ) +
( V_159 * sizeof( struct V_173 ) ) ) ) ;
return V_16 -> V_172 != NULL ? 0 : - V_164 ;
}
...
void F_61 ( struct V_15 * V_16 , int V_159 , int V_160 )
{
int V_161 , V_162 ;
for ( V_161 = 0 ; V_161 < V_159 ; V_161 ++ )
for ( V_162 = 0 ; V_162 < V_160 ; ++ V_162 ) {
F_62 ( F_50 ( V_16 , V_161 , V_162 ) ) ;
F_50 ( V_16 , V_161 , V_162 ) = - 1 ;
}
}
...
return;
if ( V_161 == - 1 ) {
V_176 = V_16 -> V_177 -> V_178 ;
V_16 -> V_177 -> V_178 = * V_175 ;
} else {
V_176 = V_16 -> V_177 -> V_161 [ V_161 ] ;
V_16 -> V_177 -> V_161 [ V_161 ] = * V_175 ;
}
V_175 -> V_179 = V_175 -> V_179 - V_176 . V_179 ;
V_175 -> V_180 = V_175 -> V_180 - V_176 . V_180 ;
V_175 -> V_181 = V_175 -> V_181 - V_176 . V_181 ;
}
int F_70 ( struct V_15 * V_16 ,
int V_161 , int V_162 , bool V_38 )
{
struct V_173 V_175 ;
T_2 V_182 = V_38 ? 3 : 1 ;
if ( F_50 ( V_16 , V_161 , V_162 ) < 0 )
return - V_183 ;
if ( V_16 -> V_172 == NULL && F_58 ( V_16 , V_161 + 1 ) < 0 )
return - V_164 ;
if ( F_71 ( F_50 ( V_16 , V_161 , V_162 ) , & V_175 , V_182 * sizeof( T_1 ) ) < 0 )
return - V_184 ;
F_69 ( V_16 , V_161 , & V_175 ) ;
if ( V_38 ) {
if ( V_175 . V_181 == 0 )
V_175 . V_179 = 0 ;
else if ( V_175 . V_181 < V_175 . V_180 )
V_175 . V_179 = ( T_1 ) ( ( double ) V_175 . V_179 * V_175 . V_180 / V_175 . V_181 + 0.5 ) ;
} else
V_175 . V_180 = V_175 . V_181 = 0 ;
V_16 -> V_172 -> V_161 [ V_161 ] = V_175 ;
return 0 ;
}
...
T_2 V_182 = V_38 ? 3 : 1 ;
int V_161 , V_162 ;
struct V_173 * V_178 = & V_16 -> V_172 -> V_178 , V_175 ;
V_178 -> V_179 = V_178 -> V_180 = V_178 -> V_181 = 0 ;
for ( V_161 = 0 ; V_161 < V_159 ; V_161 ++ ) {
for ( V_162 = 0 ; V_162 < V_160 ; V_162 ++ ) {
if ( F_50 ( V_16 , V_161 , V_162 ) < 0 )
continue;
if ( F_71 ( F_50 ( V_16 , V_161 , V_162 ) ,
& V_175 , V_182 * sizeof( T_1 ) ) < 0 )
return - V_184 ;
V_178 -> V_179 += V_175 . V_179 ;
if ( V_38 ) {
V_178 -> V_180 += V_175 . V_180 ;
V_178 -> V_181 += V_175 . V_181 ;
}
}
}
F_69 ( V_16 , - 1 , V_178 ) ;
...
if ( V_178 -> V_181 < V_178 -> V_180 ) {
V_16 -> V_172 -> V_185 = 1 ;
V_178 -> V_179 = ( T_1 ) ( ( double ) V_178 -> V_179 * V_178 -> V_180 / V_178 -> V_181 + 0.5 ) ;
}
} else
V_178 -> V_180 = V_178 -> V_181 = 0 ;
return 0 ;
}
static int F_73 ( struct V_15 * V_16 , int V_161 , int V_162 )
{
struct V_15 * V_36 = V_16 -> V_36 ;
int V_163 ;
if ( F_46 ( V_16 ) )
return - 1 ;
F_74 ( ! V_36 -> V_163 ) ;
V_163 = F_50 ( V_36 , V_161 , V_162 ) ;
F_74 ( V_163 == - 1 ) ;
return V_163 ;
}
static T_2 F_75 ( struct V_35 * V_18 , T_6 * V_186 )
{
T_2 V_87 = 0 ;
V_87 += fprintf ( V_186 , L_30 , V_187 ) ;
V_87 += fprintf ( V_186 , L_31 ) ;
V_87 += F_76 ( type ) ;
V_87 += F_76 ( V_4 ) ;
V_87 += F_77 ( V_47 ) ;
V_87 += F_78 ( V_49 ) ;
...
V_87 += F_77 ( V_1 ) ;
V_87 += F_77 ( V_33 ) ;
V_87 += F_79 ( V_156 , V_116 ) ;
V_87 += F_79 ( V_188 , V_189 ) ;
V_87 += F_79 ( V_57 , V_56 ) ;
V_87 += F_79 ( V_58 , V_190 ) ;
V_87 += F_79 ( V_152 , V_153 ) ;
V_87 += F_79 ( V_128 , V_133 ) ;
V_87 += F_79 ( V_158 , V_191 ) ;
V_87 += F_79 ( V_145 , V_62 ) ;
V_87 += F_79 ( V_136 , V_114 ) ;
V_87 += F_79 ( V_63 , V_64 ) ;
V_87 += F_80 ( L_32 , V_192 ,
L_33 , V_108 ) ;
V_87 += F_76 ( V_193 ) ;
V_87 += F_76 ( V_146 ) ;
V_87 += F_76 ( V_194 ) ;
...
for ( V_161 = 0 ; V_161 < V_199 -> V_208 ; V_161 ++ ) {
for ( V_162 = 0 ; V_162 < V_201 -> V_208 ; V_162 ++ ) {
int V_214 ;
if ( ! V_16 -> V_174 )
V_203 = V_201 -> V_215 [ V_162 ] ;
V_214 = F_73 ( V_16 , V_161 , V_162 ) ;
V_216:
F_83 ( L_34 ,
V_203 , V_199 -> V_215 [ V_161 ] , V_214 , V_202 ) ;
F_50 ( V_16 , V_161 , V_162 ) = F_84 ( & V_16 -> V_18 ,
V_203 ,
V_199 -> V_215 [ V_161 ] ,
V_214 , V_202 ) ;
if ( F_50 ( V_16 , V_161 , V_162 ) < 0 ) {
...
if ( V_82 != - V_183 || V_161 > 0 || V_162 > 0 )
goto V_225;
if ( ! V_115 . V_193 && V_16 -> V_18 . V_193 ) {
V_115 . V_193 = true ;
goto V_210;
} else if ( ! V_115 . V_64 &&
...
void F_87 ( struct V_15 * V_16 , int V_159 , int V_160 )
{
if ( V_16 -> V_163 == NULL )
return;
F_61 ( V_16 , V_159 , V_160 ) ;
F_59 ( V_16 ) ;
}
...
V_245 -> V_161 = V_245 -> V_203 = V_245 -> V_241 = - 1 ;
...
static int F_107 ( T_6 * V_186 , bool * V_291 , const char * V_292 , ... )
{
T_8 args ;
int V_87 = 0 ;
if ( ! * V_291 ) {
V_87 += fprintf ( V_186 , L_38 ) ;
} else {
V_87 += fprintf ( V_186 , L_9 ) ;
* V_291 = false ;
}
va_start ( args , V_292 ) ;
V_87 += vfprintf ( V_186 , V_292 , args ) ;
va_end ( args ) ;
return V_87 ;
}
static int F_108 ( T_6 * V_186 , bool * V_291 , const char * V_288 , T_1 V_255 )
{
if ( V_255 == 0 )
return 0 ;
return F_107 ( V_186 , V_291 , L_39 V_293 , V_288 , V_255 ) ;
}
static int F_109 ( T_6 * V_186 , const char * V_288 , T_1 V_255 ,
struct V_294 * V_295 , bool * V_291 )
{
int V_5 = 0 , V_296 = F_107 ( V_186 , V_291 , L_40 , V_288 ) ;
bool V_297 = true ;
do {
if ( V_255 & V_295 [ V_5 ] . V_28 ) {
V_296 += fprintf ( V_186 , L_41 , V_297 ? L_1 : L_42 , V_295 [ V_5 ] . V_41 ) ;
V_297 = false ;
}
} while ( V_295 [ ++ V_5 ] . V_41 != NULL );
return V_296 ;
}
static int F_110 ( T_6 * V_186 , bool * V_291 , T_1 V_255 )
{
...
#undef F_111
return F_109 ( V_186 , L_43 , V_255 , V_295 , V_291 ) ;
}
static int F_112 ( T_6 * V_186 , bool * V_291 , T_1 V_255 )
{
...
#undef F_111
return F_109 ( V_186 , L_44 , V_255 , V_295 , V_291 ) ;
}
int F_113 ( struct V_15 * V_16 ,
struct V_302 * V_303 , T_6 * V_186 )
{
bool V_291 = true ;
int V_296 = 0 ;
if ( V_303 -> V_304 ) {
...
return 0 ;
if ( V_16 -> V_122 > 1 )
V_296 += fprintf ( V_186 , L_45 , V_16 -> V_93 ? : L_1 ) ;
V_296 += fprintf ( V_186 , L_6 , F_36 ( V_16 ) ) ;
F_40 (pos, evsel)
V_296 += fprintf ( V_186 , L_46 , F_36 ( V_95 ) ) ;
if ( V_16 -> V_122 > 1 )
V_296 += fprintf ( V_186 , L_47 ) ;
goto V_305;
}
V_296 += fprintf ( V_186 , L_6 , F_36 ( V_16 ) ) ;
if ( V_303 -> V_212 || V_303 -> V_128 ) {
V_296 += F_107 ( V_186 , & V_291 , L_48 V_293 ,
( T_1 ) V_16 -> V_18 . V_130 ) ;
}
if ( V_303 -> V_212 ) {
F_114 ( type ) ;
...
F_114 ( V_197 ) ;
F_114 ( V_4 ) ;
V_296 += F_110 ( V_186 , & V_291 , V_16 -> V_18 . V_1 ) ;
if ( V_16 -> V_18 . V_33 )
V_296 += F_112 ( V_186 , & V_291 , V_16 -> V_18 . V_33 ) ;
F_114 ( V_156 ) ;
F_114 ( V_116 ) ;
F_114 ( V_188 ) ;
F_114 ( V_189 ) ;
