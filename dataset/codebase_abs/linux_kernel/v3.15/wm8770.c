...
struct V_40 * V_41 ;
int V_61 , V_42 ;
V_41 = F_24 ( & V_83 -> V_2 , sizeof( struct V_40 ) ,
V_84 ) ;
if ( ! V_41 )
return - V_85 ;
for ( V_42 = 0 ; V_42 < F_12 ( V_41 -> V_68 ) ; V_42 ++ )
V_41 -> V_68 [ V_42 ] . V_86 = V_87 [ V_42 ] ;
V_61 = F_25 ( & V_83 -> V_2 , F_12 ( V_41 -> V_68 ) ,
V_41 -> V_68 ) ;
if ( V_61 ) {
F_14 ( & V_83 -> V_2 , L_5 , V_61 ) ;
return V_61 ;
}
V_41 -> V_88 [ 0 ] . V_89 = V_90 ;
V_41 -> V_88 [ 1 ] . V_89 = V_91 ;
V_41 -> V_88 [ 2 ] . V_89 = V_92 ;
for ( V_42 = 0 ; V_42 < F_12 ( V_41 -> V_68 ) ; V_42 ++ ) {
V_61 = F_26 ( V_41 -> V_68 [ V_42 ] . V_93 ,
& V_41 -> V_88 [ V_42 ] ) ;
if ( V_61 ) {
F_14 ( & V_83 -> V_2 ,
L_6 ,
...
V_41 -> V_69 = F_27 ( V_83 , & V_94 ) ;
if ( F_28 ( V_41 -> V_69 ) )
return F_29 ( V_41 -> V_69 ) ;
F_30 ( V_83 , V_41 ) ;
V_61 = F_31 ( & V_83 -> V_2 ,
& V_95 , & V_96 , 1 ) ;
return V_61 ;
...
{
struct V_40 * V_41 = F_33 ( V_83 ) ;
int V_42 ;
for ( V_42 = 0 ; V_42 < F_12 ( V_41 -> V_68 ) ; ++ V_42 )
F_34 ( V_41 -> V_68 [ V_42 ] . V_93 ,
& V_41 -> V_88 [ V_42 ] ) ;
F_35 ( & V_83 -> V_2 ) ;
return 0 ;
}
