...
V_8 = F_3 ( V_7 ) ;
F_4 ( V_10 L_1 , V_5 ,
( unsigned ) ( ( V_11 * ) V_7 - V_4 -> V_12 ) , V_4 -> V_13 ) ;
if ( V_2 -> V_14 -> V_15 )
...
T_2 V_30 = F_23 ( V_28 ) ;
T_2 V_31 = V_30 + V_29 ;
T_3 * V_32 = V_28 -> V_33 == V_28 -> V_34 ? NULL : V_28 -> V_33 ;
T_3 * V_35 ;
V_31 = F_24 ( V_31 ) ;
if ( V_31 <= V_36 ||
F_24 ( V_30 ) == V_31 )
return 0 ;
V_35 = F_25 ( V_32 , sizeof( T_3 ) * V_31 , V_37 ) ;
if ( ! V_35 )
return - V_38 ;
if ( ! V_32 )
memcpy ( V_35 , V_28 -> V_34 , sizeof( T_3 ) * V_30 ) ;
V_28 -> V_33 = V_35 ;
V_28 -> V_39 = V_35 + V_30 ;
return 0 ;
}
...
int F_50 ( struct V_1 * V_2 , unsigned V_47 , T_4 V_55 )
{
struct V_51 * V_52 = V_2 -> V_5 ;
F_31 ( V_52 -> V_18 ) ;
V_2 -> V_47 = V_47 ;
...
struct V_6 * V_7 )
{
return ( V_11 * ) V_7 - ( V_11 * ) F_63 ( V_52 , V_64 , 0 ) ;
}
static struct V_6 * F_66 ( struct V_51 * V_52 , unsigned V_61 )
{
return F_63 ( V_52 , F_60 ( V_61 , V_52 ) , V_52 -> V_54 [ V_61 ] . V_66 ) ;
}
static struct V_6 * F_67 ( struct V_51 * V_52 , unsigned V_61 )
{
return ( void * ) ( ( ( T_3 * ) F_66 ( V_52 , V_61 ) ) - V_52 -> V_53 [ V_61 ] ) ;
}
static struct V_6 * F_68 ( struct V_51 * V_52 , unsigned V_64 )
{
return F_63 ( V_52 , V_64 , V_52 -> V_53 [ V_64 ] ) ;
}
static inline T_3 F_69 ( T_3 V_67 , T_3 V_68 , V_50 V_63 )
{
V_68 >>= V_63 ;
V_68 |= ( V_67 << 1 ) << ( 63U - V_63 ) ;
return V_68 ;
}
static inline unsigned F_70 ( const struct V_6 * V_7 ,
struct V_49 * V_69 )
{
const T_3 * V_23 = & V_7 -> V_68 - ( V_69 -> V_70 >> 6 ) ;
return F_69 ( V_23 [ - 1 ] , V_23 [ 0 ] , V_69 -> V_70 & 63 ) & V_71 ;
}
static void F_71 ( struct V_51 * V_52 , unsigned V_61 )
{
struct V_49 * V_69 = & V_52 -> V_54 [ V_61 ] ;
struct V_6 * V_66 = F_66 ( V_52 , V_61 ) ;
struct V_6 * V_23 = F_67 ( V_52 , V_61 ) ;
struct V_6 * V_28 = F_72 ( V_61 )
? V_52 -> V_18 -> V_9
: F_67 ( V_52 , V_61 >> F_57 ( V_61 ) ) ;
struct V_6 * V_72 = F_72 ( V_61 + 1 )
? F_73 ( V_52 -> V_18 , V_52 -> V_18 -> V_13 - F_28 ( & V_52 -> V_26 ) )
: F_66 ( V_52 , V_61 >> ( F_55 ( V_61 ) + 1 ) ) ;
F_31 ( V_66 < V_28 || V_66 > V_72 ) ;
F_31 ( F_3 ( V_23 ) != V_66 ) ;
if ( F_5 ( V_28 ) != F_5 ( V_72 ) )
V_69 -> V_70 = F_74 ( F_5 ( V_72 ) ^ F_5 ( V_28 ) ) + 64 ;
else
V_69 -> V_70 = F_74 ( V_72 -> V_68 ^ V_28 -> V_68 ) ;
V_69 -> V_70 = F_75 ( int , V_69 -> V_70 - V_73 , 0 ) ;
if ( F_70 ( V_66 , V_69 ) != F_70 ( V_23 , V_69 ) )
V_69 -> V_74 = F_70 ( V_66 , V_69 ) - 1 ;
else
V_69 -> V_70 = 127 ;
}
...
void F_80 ( struct V_1 * V_2 , struct V_3 * V_4 , T_3 V_75 )
{
if ( V_4 != V_2 -> V_5 -> V_18 ) {
V_2 -> V_5 [ ++ V_2 -> V_17 ] . V_18 = V_4 ;
V_4 -> V_76 = V_2 -> V_5 -> V_18 -> V_76 ;
} else
F_81 ( & V_4 -> V_76 , sizeof( T_3 ) ) ;
V_4 -> V_75 = V_75 ;
V_4 -> V_77 = 0 ;
V_4 -> V_13 = 0 ;
F_78 ( V_2 ) ;
...
V_52 -> V_54 [ V_61 ] . V_66 = F_65 ( V_52 , V_64 ++ , V_7 ) ;
}
...
bool F_89 ( struct V_1 * V_2 , struct V_6 * V_28 , struct V_6 * V_72 )
{
if ( ! V_2 -> V_14 -> V_82 )
return false ;
if ( ! F_90 ( V_28 , V_72 ) ||
F_7 ( V_28 , & F_8 ( V_72 ) ) )
return false ;
return V_2 -> V_14 -> V_82 ( V_2 , V_28 , V_72 ) ;
}
...
F_93 ( V_52 -> V_18 , V_52 -> V_18 -> V_13 + F_28 ( V_83 ) ) >
V_46 << V_2 -> V_47 ) ;
memmove ( ( T_3 * ) V_44 + F_28 ( V_83 ) ,
V_44 ,
( void * ) F_2 ( V_52 -> V_18 ) - ( void * ) V_44 ) ;
V_52 -> V_18 -> V_13 += F_28 ( V_83 ) ;
F_94 ( V_44 , V_83 ) ;
F_88 ( V_2 , V_52 , V_44 ) ;
}
...
struct V_6 * V_66 , * V_53 = NULL ;
struct V_20 V_21 ;
F_31 ( V_2 -> V_14 -> V_16 && ! F_15 ( V_7 ) ) ;
V_66 = F_96 ( V_2 , & V_21 , V_2 -> V_14 -> V_16
? F_97 ( & F_8 ( V_7 ) )
: F_97 ( V_7 ) ) ;
if ( V_2 -> V_14 -> V_87 ( V_2 , V_7 , & V_21 , V_84 ) )
return V_85 ;
V_85 = V_88 ;
while ( V_66 != F_2 ( V_4 ) &&
F_7 ( V_7 , V_2 -> V_14 -> V_16 ? & F_8 ( V_66 ) : V_66 ) > 0 )
V_53 = V_66 , V_66 = F_3 ( V_66 ) ;
V_85 = V_89 ;
if ( V_53 &&
F_89 ( V_2 , V_53 , V_7 ) )
goto V_90;
...
static struct V_93 F_98 ( struct V_51 * V_52 ,
const struct V_6 * V_94 )
{
unsigned V_95 = 0 , V_96 = V_52 -> V_60 ;
while ( V_95 + 1 != V_96 ) {
unsigned V_66 = ( V_95 + V_96 ) >> 1 ;
if ( F_7 ( F_68 ( V_52 , V_66 ) , V_94 ) > 0 )
V_96 = V_66 ;
else
V_95 = V_66 ;
}
return (struct V_93 ) {
F_68 ( V_52 , V_95 ) ,
V_96 < V_52 -> V_60 ? F_68 ( V_52 , V_96 ) : F_2 (t->data)
} ;
}
static struct V_93 F_99 ( struct V_51 * V_52 ,
const struct V_6 * V_94 )
{
struct V_6 * V_28 , * V_72 ;
struct V_49 * V_69 ;
unsigned V_78 , V_61 , V_97 = 1 ;
do {
unsigned V_23 = V_97 << 4 ;
V_23 &= ( ( int ) ( V_23 - V_52 -> V_60 ) ) >> 31 ;
F_100 ( & V_52 -> V_54 [ V_23 ] ) ;
V_61 = V_97 ;
V_69 = & V_52 -> V_54 [ V_61 ] ;
if ( F_101 ( V_69 -> V_70 != 127 ) )
V_97 = V_61 * 2 + ( ( ( unsigned )
( V_69 -> V_74 -
F_70 ( V_94 , V_69 ) ) ) >> 31 ) ;
else
V_97 = ( F_7 ( F_66 ( V_52 , V_61 ) , V_94 ) > 0 )
? V_61 * 2
: V_61 * 2 + 1 ;
} while ( V_97 < V_52 -> V_60 );
V_78 = F_60 ( V_61 , V_52 ) ;
if ( V_97 & 1 ) {
V_28 = F_63 ( V_52 , V_78 , V_69 -> V_66 ) ;
if ( ++ V_78 != V_52 -> V_60 ) {
V_69 = & V_52 -> V_54 [ F_54 ( V_61 , V_52 -> V_60 ) ] ;
V_72 = F_63 ( V_52 , V_78 , V_69 -> V_66 ) ;
} else
V_72 = F_2 ( V_52 -> V_18 ) ;
} else {
V_72 = F_63 ( V_52 , V_78 , V_69 -> V_66 ) ;
if ( -- V_78 ) {
V_69 = & V_52 -> V_54 [ F_56 ( V_61 , V_52 -> V_60 ) ] ;
V_28 = F_63 ( V_52 , V_78 , V_69 -> V_66 ) ;
} else
V_28 = V_52 -> V_18 -> V_9 ;
}
return (struct V_93 ) { V_28 , V_72 } ;
}
...
V_4 . V_72 = F_2 ( V_52 -> V_18 ) ;
} else if ( F_87 ( V_2 , V_52 ) ) {
if ( F_103 ( F_7 ( V_94 , & V_52 -> V_26 ) >= 0 ) )
return F_2 ( V_52 -> V_18 ) ;
if ( F_103 ( F_7 ( V_94 , V_52 -> V_18 -> V_9 ) < 0 ) )
...
V_94 ) > 0 ) ;
F_31 ( V_4 . V_72 != F_2 ( V_52 -> V_18 ) &&
F_7 ( V_4 . V_72 , V_94 ) <= 0 ) ;
}
while ( F_101 ( V_4 . V_28 != V_4 . V_72 ) &&
F_7 ( V_4 . V_28 , V_94 ) <= 0 )
V_4 . V_28 = F_3 ( V_4 . V_28 ) ;
return V_4 . V_28 ;
}
static inline bool F_105 ( struct V_98 V_28 ,
struct V_98 V_72 )
{
return F_7 ( V_28 . V_7 , V_72 . V_7 ) > 0 ;
}
...
struct V_6 * V_94 )
{
return F_108 ( V_2 , V_21 , V_94 , V_2 -> V_5 ) ;
}
...
struct V_1 * V_2 , T_6 V_102 )
{
struct V_6 * V_19 ;
do {
V_19 = F_116 ( V_21 ) ;
} while ( V_19 && V_102 ( V_2 , V_19 ) );
return V_19 ;
}
void F_118 ( struct V_103 * V_104 )
{
if ( V_104 -> V_105 )
F_119 ( V_104 -> V_105 ) ;
}
int F_120 ( struct V_103 * V_104 , unsigned V_47 )
{
F_121 ( & V_104 -> time . V_106 ) ;
V_104 -> V_47 = V_47 ;
V_104 -> V_107 = F_122 ( 1 << V_47 ) ;
V_104 -> V_105 = F_123 ( 1 , V_47 ) ;
if ( ! V_104 -> V_105 )
return - V_38 ;
return 0 ;
}
static void F_124 ( struct V_1 * V_2 , struct V_3 * V_108 ,
struct V_20 * V_21 ,
bool V_109 , bool V_110 )
{
int V_4 ;
struct V_6 * V_7 , * V_111 = NULL ;
F_125 (k) V_112 ;
bool (* F_126)( struct V_1 * , const struct V_6 * ) = V_110
? F_18
: F_17 ;
for ( V_4 = V_21 -> V_99 / 2 - 1 ; V_4 >= 0 ; -- V_4 )
F_115 ( V_21 , V_4 , V_2 -> V_14 -> V_113 ) ;
while ( ! F_106 ( V_21 ) ) {
if ( V_2 -> V_14 -> V_114 && V_109 )
V_7 = V_2 -> V_14 -> V_114 ( V_21 , & V_112 . V_7 ) ;
else
V_7 = NULL ;
if ( ! V_7 )
V_7 = F_112 ( V_21 , V_2 -> V_14 -> V_113 ) ;
if ( F_126 ( V_2 , V_7 ) )
continue;
if ( ! V_111 ) {
V_111 = V_108 -> V_9 ;
F_94 ( V_111 , V_7 ) ;
} else if ( ! F_89 ( V_2 , V_111 , V_7 ) ) {
V_111 = F_3 ( V_111 ) ;
F_94 ( V_111 , V_7 ) ;
}
}
V_108 -> V_13 = V_111 ? ( T_3 * ) F_3 ( V_111 ) - V_108 -> V_12 : 0 ;
F_127 ( L_9 , V_108 -> V_13 ) ;
}
static void F_128 ( struct V_1 * V_2 , struct V_20 * V_21 ,
unsigned V_9 , unsigned V_115 , bool V_109 ,
struct V_103 * V_104 )
{
T_3 V_116 ;
bool V_117 = false ;
struct V_3 * V_108 = ( void * ) F_51 ( V_118 | V_37 ,
V_115 ) ;
if ( ! V_108 ) {
struct V_119 * V_120 ;
F_31 ( V_115 > V_104 -> V_47 ) ;
V_120 = F_129 ( V_104 -> V_105 , V_37 ) ;
V_108 = F_130 ( V_120 ) ;
V_117 = true ;
V_115 = V_104 -> V_47 ;
}
V_116 = F_131 () ;
F_124 ( V_2 , V_108 , V_21 , V_109 , false ) ;
V_2 -> V_17 = V_9 ;
if ( ! V_9 && V_115 == V_2 -> V_47 ) {
V_108 -> V_75 = V_2 -> V_5 -> V_18 -> V_75 ;
V_108 -> V_76 = V_2 -> V_5 -> V_18 -> V_76 ;
V_108 -> V_77 = V_2 -> V_5 -> V_18 -> V_77 ;
F_132 ( V_108 , V_2 -> V_5 -> V_18 ) ;
} else {
V_2 -> V_5 [ V_9 ] . V_18 -> V_13 = V_108 -> V_13 ;
memcpy ( V_2 -> V_5 [ V_9 ] . V_18 -> V_9 , V_108 -> V_9 ,
( void * ) F_2 ( V_108 ) - ( void * ) V_108 -> V_9 ) ;
}
if ( V_117 )
F_133 ( F_134 ( V_108 ) , V_104 -> V_105 ) ;
else
F_48 ( ( unsigned long ) V_108 , V_115 ) ;
F_82 ( V_2 ) ;
if ( ! V_9 )
F_135 ( & V_104 -> time , V_116 ) ;
}
void F_136 ( struct V_1 * V_2 , unsigned V_9 ,
struct V_103 * V_104 )
{
T_2 V_115 = V_2 -> V_47 , V_13 = 0 ;
struct V_20 V_21 ;
int V_30 = F_137 ( V_2 ) ;
...
V_115 = F_49 ( F_93 ( V_2 -> V_5 -> V_18 , V_13 ) ) ;
}
F_128 ( V_2 , & V_21 , V_9 , V_115 , false , V_104 ) ;
...
struct V_103 * V_104 )
{
F_128 ( V_2 , V_21 , 0 , V_2 -> V_47 , true , V_104 ) ;
}
void F_140 ( struct V_1 * V_2 , struct V_1 * V_121 ,
struct V_103 * V_104 )
{
T_3 V_116 = F_131 () ;
struct V_20 V_21 ;
F_96 ( V_2 , & V_21 , NULL ) ;
F_124 ( V_2 , V_121 -> V_5 -> V_18 , & V_21 , false , true ) ;
F_135 ( & V_104 -> time , V_116 ) ;
V_121 -> V_5 -> V_60 = 0 ;
}
void F_141 ( struct V_1 * V_2 , struct V_103 * V_104 )
{
...
V_122 *= V_104 -> V_107 ;
if ( V_2 -> V_5 [ V_4 ] . V_18 -> V_13 < V_122 ) {
F_136 ( V_2 , V_4 , V_104 ) ;
return;
}
}
...
void F_143 ( struct V_1 * V_2 , struct V_124 * V_125 )
{
unsigned V_4 ;
for ( V_4 = 0 ; V_4 <= V_2 -> V_17 ; V_4 ++ ) {
struct V_51 * V_52 = & V_2 -> V_5 [ V_4 ] ;
T_2 V_126 = V_52 -> V_18 -> V_13 * sizeof( T_3 ) ;
T_2 V_61 ;
if ( F_87 ( V_2 , V_52 ) ) {
V_125 -> V_127 ++ ;
V_125 -> V_128 += V_126 ;
V_125 -> V_129 += V_52 -> V_60 - 1 ;
for ( V_61 = 1 ; V_61 < V_52 -> V_60 ; V_61 ++ )
if ( V_52 -> V_54 [ V_61 ] . V_70 == 127 )
V_125 -> V_130 ++ ;
} else {
V_125 -> V_131 ++ ;
V_125 -> V_132 += V_126 ;
