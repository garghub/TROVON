...
static T_12
F_90 ( struct V_216 * V_216 , char T_11 * V_197 , T_13 V_217 , T_14 * V_177 )
{
int V_176 = 0 ;
T_6 V_218 ;
int V_27 ;
...
continue;
V_39 = V_93 [ V_27 ] . V_39 ;
V_176 += sprintf ( V_219 + V_176 , L_70 ) ;
V_176 += sprintf ( V_219 + V_176 , L_71 , V_173 ) ;
V_176 += sprintf ( V_219 + V_176 , L_72 ,
V_115 ) ;
V_176 += sprintf ( V_219 + V_176 ,
L_73 ,
__DATE__ , __TIME__ ) ;
V_176 += sprintf ( V_219 + V_176 , L_74 ,
V_39 -> V_45 ,
V_39 -> V_52 ) ;
V_176 += sprintf ( V_219 + V_176 , L_75 ,
V_39 -> V_56 ) ;
V_218 = F_91 ( ( V_223 void * )
V_39 -> V_54 ) ;
V_176 += sprintf ( V_219 + V_176 , L_76 ,
V_39 -> V_54 , V_218 ,
( V_224 ) F_20 ( V_39 -> V_54 ) ) ;
V_176 += sprintf ( V_219 + V_176 , L_77 ,
V_39 -> V_209 ) ;
V_176 += sprintf ( V_219 + V_176 , L_78 ) ;
}
if ( F_92 ( V_197 , V_219 , V_176 ) ) {
F_14 ( V_219 ) ;
return - V_225 ;
}
F_14 ( V_219 ) ;
...
static T_12
F_93 ( struct V_216 * V_216 , char T_11 * V_226 ,
T_13 V_227 , T_14 * V_228 )
{
return 0 ;
}
static T_12
F_94 ( struct V_216 * V_216 , const char T_11 * V_226 ,
T_13 V_227 , T_14 * V_228 )
{
char V_197 [ 4 ] ;
int V_27 , V_229 ;
...
return - V_158 ;
V_197 [ V_227 ] = '\0' ;
if ( F_96 ( V_197 , V_226 , V_227 ) ) {
F_3 ( L_79 ,
( int ) V_227 , V_197 , V_227 ) ;
return - V_225 ;
}
V_27 = sscanf ( V_197 , L_80 , & V_229 ) ;
if ( V_27 < 1 ) {
F_3 ( L_81 ,
( int ) V_227 , V_197 ) ;
return - V_225 ;
...
static T_12
F_97 ( struct V_216 * V_216 , const char T_11 * V_226 ,
T_13 V_227 , T_14 * V_228 )
{
char V_197 [ 16 ] ;
int V_27 , V_230 ;
...
switch ( V_233 -> V_3 ) {
case V_167 :
V_128 = (struct V_139 * ) V_233 -> V_10 ;
V_128 -> V_133 = ( V_234 << 16 ) ;
if ( V_128 -> V_168 )
V_128 -> V_168 ( V_128 ) ;
break;
case V_138 :
V_34 = (struct V_33 * ) V_233 -> V_10 ;
F_30 ( L_85 , V_34 ,
V_34 -> V_132 . V_126 ) ;
* ( int * ) V_34 -> V_132 . V_120 =
V_235 ;
...
static int
F_103 ( struct V_62 * V_63 , T_15 V_237 )
{
struct V_1 * V_39 =
(struct V_1 * ) ( (struct V_32 * ) V_63 -> V_76 .
V_65 ) -> V_91 ;
...
static T_12
F_113 ( struct V_142 * V_257 , struct V_258 * V_259 ,
const char * V_197 , T_13 V_227 )
{
struct V_118 V_119 ;
struct V_32 * V_18 = F_114 ( V_257 ) ;
int V_27 ;
V_27 = sscanf ( V_197 , L_95 , & V_119 . V_19 , & V_119 . V_20 , & V_119 . V_21 ) ;
if ( V_27 != 3 )
return V_27 ;
return F_45 ( V_260 , V_18 , & V_119 ) ;
}
static T_12
F_115 ( struct V_142 * V_257 , struct V_258 * V_259 ,
const char * V_197 , T_13 V_227 )
{
struct V_118 V_119 ;
struct V_32 * V_18 = F_114 ( V_257 ) ;
