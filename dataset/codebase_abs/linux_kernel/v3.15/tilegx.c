...
return;
V_2 = F_200 ( sizeof( * V_4 ) , V_228 , F_197 ,
V_317 , 1 ) ;
if ( ! V_2 ) {
F_201 ( L_42 , V_228 ) ;
return;
...
F_83 ( & V_227 ) ;
F_100 ( F_205 , NULL , 1 ) ;
for ( V_115 = 0 ; F_207 ( V_115 , V_228 , V_315 ) >= 0 ; V_115 ++ )
F_199 ( V_228 , V_315 ) ;
if ( ! F_3 () )
V_9 = * V_321 ;
return 0 ;
