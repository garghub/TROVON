...
struct V_6 * F_20 ( struct V_11 * V_12 ,
int V_35 , T_1 V_9 )
{
struct V_6 * V_7 = F_21 ( sizeof( * V_7 ) , V_36 ) ;
if ( ! V_7 )
return NULL ;
V_7 -> V_18 =
F_22 ( V_35 , sizeof( struct V_16 * ) , V_36 ) ;
V_7 -> V_33 =
F_22 ( V_35 , sizeof( unsigned long ) , V_36 ) ;
if ( ! V_7 -> V_18 || ! V_7 -> V_33 ) {
F_23 ( V_7 -> V_18 ) ;
F_23 ( V_7 -> V_33 ) ;
F_23 ( V_7 ) ;
return NULL ;
