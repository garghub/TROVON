...
static inline enum V_6 F_6 ( struct V_1 * V_2 ,
T_1 V_7 , T_1 V_8 )
{
return V_9 ;
}
...
static inline void F_17 ( struct V_26 * V_27 ,
unsigned int V_32 )
{
F_18 ( V_27 , V_32 ) ;
}
...
void F_2 ( struct V_1 * V_2 , T_1 V_33 ,
T_1 V_5 )
{
if ( ! V_2 || ( V_33 > V_2 -> V_36 ) ) {
F_8 ( L_5 , V_33 ) ;
...
V_16 -> V_21 . V_106 = ( ( V_89 + ( unsigned long ) V_83 ) &
~ V_107 ) ;
}
V_16 -> V_20 = V_82 & 0x03 ;
if ( V_16 -> V_20 ) {
V_94 = F_52 ( V_16 -> V_108 ,
( void V_109 * ) ( V_89 + V_74 - V_16 -> V_20 ) ,
V_16 -> V_20 ) ;
if ( V_94 ) {
F_8 ( L_15 ,
V_94 , V_16 -> V_20 ,
...
F_53 ( & V_110 -> V_111 -> V_112 ) ;
V_94 = F_54 ( V_110 , V_110 -> V_111 , V_89 , V_95 , V_93 == V_102 ,
0 , V_16 -> V_113 , NULL ) ;
F_55 ( & V_110 -> V_111 -> V_112 ) ;
V_16 -> V_17 = V_114 ;
if ( V_94 < V_95 ) {
F_8 ( L_16 , V_95 , V_94 ) ;
V_16 -> V_19 = V_94 ;
...
F_14 ( & V_16 -> V_27 [ 0 ] , V_16 -> V_113 [ 0 ] , 0 , V_89 & ~ V_107 ) ;
if ( V_95 > 1 ) {
V_16 -> V_27 [ 0 ] . V_115 = V_97 - V_16 -> V_27 [ 0 ] . V_30 ;
#ifdef F_16
V_16 -> V_27 [ 0 ] . V_31 = V_16 -> V_27 [ 0 ] . V_115 ;
#endif
V_74 -= V_16 -> V_27 [ 0 ] . V_115 ;
...
F_14 ( & V_16 -> V_27 [ V_92 ] , V_16 -> V_113 [ V_92 ] , V_90 , 0 ) ;
V_74 -= V_90 ;
}
} else {
if ( V_74 < 4 ) {
V_16 -> V_27 [ 0 ] . V_115 = V_74 ;
V_96 = 1 ;
} else {
V_16 -> V_27 [ 0 ] . V_115 = V_74 - V_16 -> V_20 ;
}
#ifdef F_16
V_16 -> V_27 [ 0 ] . V_31 = V_16 -> V_27 [ 0 ] . V_115 ;
#endif
}
V_16 -> V_116 = F_56 ( V_2 -> V_46 , V_16 -> V_27 ,
V_16 -> V_19 , V_16 -> V_100 ) ;
if ( V_16 -> V_116 <= 0 ) {
F_8 ( L_17 , V_16 -> V_116 , V_16 -> V_19 ) ;
F_51 ( V_2 , V_16 ) ;
return V_51 ;
}
if ( V_16 -> V_116 && V_96 )
V_16 -> V_116 -= 1 ;
V_16 -> V_17 = V_117 ;
V_16 -> V_21 . V_118 = V_82 ;
V_16 -> V_21 . V_119 = V_81 ;
V_16 -> V_21 . V_83 = V_83 ;
V_16 -> V_21 . V_120 = V_84 ;
V_16 -> V_21 . V_85 = V_85 ;
* V_86 = V_16 ;
return V_9 ;
}
enum V_6 F_51 ( struct V_1 * V_2 ,
struct V_10 * V_16 )
{
...
for ( V_121 = 0 ; V_121 < V_16 -> V_19 ; V_121 ++ ) {
V_28 = V_16 -> V_113 [ V_121 ] ;
if ( V_28 ) {
if ( ! F_57 ( V_28 ) &&
( V_16 -> V_100 == V_103 ) )
F_58 ( V_28 ) ;
...
if ( V_16 -> V_17 == V_117 )
F_60 ( V_2 -> V_46 , V_16 -> V_27 , V_16 -> V_19 ,
V_16 -> V_100 ) ;
F_11 ( V_2 , V_16 ) ;
return V_9 ;
}
...
V_122 = ( sizeof( * V_16 -> V_113 ) * V_104 ) +
( sizeof( * V_16 -> V_27 ) * V_104 ) + sizeof( * V_16 ) ;
F_49 ( V_125 , L_20 ,
V_126 , V_104 , V_122 , V_2 -> V_123 ) ;
for ( V_92 = 0 ; V_92 < V_126 ; V_92 ++ ) {
V_12 = F_38 ( V_122 , V_60 ) ;
if ( ( V_12 ) == NULL ) {
F_8 ( L_21 , V_122 ) ;
return - V_124 ;
}
...
V_12 += sizeof( * V_16 ) ;
V_16 -> V_113 = (struct V_28 * * ) V_12 ;
V_12 += ( sizeof( * V_16 -> V_113 ) * V_104 ) ;
V_16 -> V_27 = (struct V_26 * ) V_12 ;
V_16 -> V_104 = V_104 ;
V_16 -> V_108 = F_63 ( V_2 -> V_123 , V_60 ,
& V_16 -> V_127 ) ;
if ( ! V_16 -> V_108 ) {
F_8 ( L_22 ) ;
return - V_124 ;
...
F_49 ( V_125 , L_26 , V_129 ) ;
}
void F_69 ( T_1 V_43 , T_4 * V_130 , T_1 V_131 )
{
T_1 V_92 , V_132 = 1 ;
for ( V_92 = 0 ; V_92 < V_131 ; V_92 ++ ) {
if ( V_132 == 1 )
F_49 ( V_133 , L_27 , V_43 ) ;
F_49 ( V_133 , L_28 , * ( ( T_1 * ) V_130 ) ) ;
V_130 += sizeof( T_1 ) ;
V_43 += sizeof( T_1 ) ;
V_132 ++ ;
if ( ( V_92 == V_131 - 1 ) || ( V_132 > 4 ) ) {
F_49 ( V_133 , L_29 ) ;
V_132 = 1 ;
}
}
