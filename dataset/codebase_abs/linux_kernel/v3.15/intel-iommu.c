...
V_38 = ( void * ) F_276 ( V_54 , V_314 ) ;
if ( ! V_38 )
return NULL ;
memset ( V_38 , 0 , V_87 ) ;
* V_313 = F_263 ( V_70 , F_277 ( V_38 ) , V_87 ,
V_296 ,
V_70 -> V_271 ) ;
if ( * V_313 )
return V_38 ;
F_278 ( ( unsigned long ) V_38 , V_314 ) ;
return NULL ;
}
static void F_279 ( struct V_69 * V_70 , T_7 V_87 , void * V_38 ,
...
static void F_280 ( struct V_69 * V_70 , struct V_216 * V_317 ,
int V_318 , enum V_299 V_291 ,
struct V_300 * V_301 )
{
struct V_51 * V_52 ;
unsigned long V_108 , V_109 ;
...
F_59 ( ! V_52 ) ;
V_46 = F_58 ( V_52 ) ;
V_43 = F_272 ( & V_52 -> V_195 , F_167 ( V_317 [ 0 ] . V_227 ) ) ;
if ( F_273 ( ! V_43 , L_56 ,
( unsigned long long ) V_317 [ 0 ] . V_227 ) )
return;
V_108 = F_13 ( V_43 -> V_298 ) ;
V_109 = F_13 ( V_43 -> V_304 + 1 ) - 1 ;
V_115 = F_100 ( V_52 , V_108 , V_109 ) ;
...
static int F_281 ( struct V_69 * V_319 ,
struct V_216 * V_317 , int V_318 , int V_291 )
{
int V_62 ;
struct V_216 * V_217 ;
F_282 (sglist, sg, nelems, i) {
F_59 ( ! F_192 ( V_217 ) ) ;
...
static int F_283 ( struct V_69 * V_70 , struct V_216 * V_317 , int V_318 ,
...
F_59 ( V_291 == V_294 ) ;
if ( F_262 ( V_70 ) )
return F_281 ( V_70 , V_317 , V_318 , V_291 ) ;
V_52 = F_260 ( V_70 ) ;
if ( ! V_52 )
return 0 ;
V_46 = F_58 ( V_52 ) ;
...
if ( V_291 == V_297 || V_291 == V_296 )
V_220 |= V_104 ;
V_320 = F_13 ( V_43 -> V_298 ) ;
V_91 = F_197 ( V_52 , V_320 , V_317 , V_87 , V_220 ) ;
if ( F_181 ( V_91 ) ) {
F_92 ( V_52 , V_320 ,
V_320 + V_87 - 1 ) ;
F_95 ( V_52 , V_320 ,
...
if ( F_141 ( V_46 -> V_49 ) )
F_136 ( V_46 , V_52 -> V_181 , V_320 , V_87 , 0 , 1 ) ;
else
F_109 ( V_46 ) ;
return V_318 ;
}
static int F_284 ( struct V_69 * V_70 , V_228 V_321 )
{
return ! V_321 ;
}
...
static void F_292 ( struct V_74 * V_76 )
{
struct V_60 * V_61 ;
T_5 V_324 ;
int V_325 ;
V_325 = F_293 ( V_76 -> V_71 , F_294 ( 0 , 0 ) , 0xb0 , & V_324 ) ;
if ( V_325 ) {
F_295 ( & V_76 -> V_70 , L_63 ) ;
return;
}
V_324 &= 0xffff0000 ;
V_61 = F_296 ( V_76 ) ;
if ( F_297 ( ! V_61 || V_61 -> V_283 - V_324 != 0xa000 ,
V_326 ,
L_64 ) )
V_76 -> V_70 . V_234 . V_46 = V_253 ;
}
static void T_1 F_298 ( void )
{
struct V_60 * V_61 ;
struct V_69 * V_70 ;
int V_62 ;
...
static int F_303 ( void )
{
struct V_60 * V_61 ;
struct V_45 * V_46 = NULL ;
unsigned long V_121 ;
F_65 (iommu, drhd) {
V_46 -> V_329 = F_246 ( sizeof( T_5 ) * V_330 ,
V_39 ) ;
if ( ! V_46 -> V_329 )
goto V_331;
}
...
F_104 ( & V_46 -> V_122 , V_121 ) ;
V_46 -> V_329 [ V_332 ] =
V_129 ( V_46 -> V_123 + V_333 ) ;
V_46 -> V_329 [ V_334 ] =
V_129 ( V_46 -> V_123 + V_335 ) ;
V_46 -> V_329 [ V_336 ] =
V_129 ( V_46 -> V_123 + V_337 ) ;
V_46 -> V_329 [ V_338 ] =
V_129 ( V_46 -> V_123 + V_339 ) ;
F_108 ( & V_46 -> V_122 , V_121 ) ;
}
return 0 ;
V_331:
...
F_65 (iommu, drhd) {
F_104 ( & V_46 -> V_122 , V_121 ) ;
F_106 ( V_46 -> V_329 [ V_332 ] ,
V_46 -> V_123 + V_333 ) ;
F_106 ( V_46 -> V_329 [ V_334 ] ,
V_46 -> V_123 + V_335 ) ;
F_106 ( V_46 -> V_329 [ V_336 ] ,
V_46 -> V_123 + V_337 ) ;
F_106 ( V_46 -> V_329 [ V_338 ] ,
V_46 -> V_123 + V_339 ) ;
F_108 ( & V_46 -> V_122 , V_121 ) ;
}
F_65 (iommu, drhd)
...
int T_1 F_308 ( struct V_341 * V_342 )
{
struct V_343 * V_252 ;
struct V_251 * V_344 ;
V_344 = F_246 ( sizeof( * V_344 ) , V_175 ) ;
if ( ! V_344 )
return - V_118 ;
V_344 -> V_345 = V_342 ;
V_252 = (struct V_343 * ) V_342 ;
V_344 -> V_254 = V_252 -> V_254 ;
V_344 -> V_255 = V_252 -> V_255 ;
V_344 -> V_78 = F_309 ( ( void * ) ( V_252 + 1 ) ,
( ( void * ) V_252 ) + V_252 -> V_342 . V_226 ,
& V_344 -> V_327 ) ;
if ( V_344 -> V_327 && V_344 -> V_78 == NULL ) {
F_151 ( V_344 ) ;
return - V_118 ;
}
F_210 ( & V_344 -> V_346 , & V_347 ) ;
return 0 ;
}
int T_1 F_310 ( struct V_341 * V_345 )
{
struct V_348 * V_349 ;
struct V_350 * V_351 ;
V_349 = F_311 ( V_345 , struct V_348 , V_342 ) ;
V_351 = F_246 ( sizeof( * V_351 ) , V_175 ) ;
if ( ! V_351 )
return - V_118 ;
V_351 -> V_345 = V_345 ;
V_351 -> V_85 = V_349 -> V_54 & 0x1 ;
if ( ! V_351 -> V_85 ) {
V_351 -> V_78 = F_309 ( ( void * ) ( V_349 + 1 ) ,
( void * ) V_349 + V_349 -> V_342 . V_226 ,
& V_351 -> V_327 ) ;
if ( V_351 -> V_327 && V_351 -> V_78 == NULL ) {
F_151 ( V_351 ) ;
return - V_118 ;
}
}
F_312 ( & V_351 -> V_346 , & V_352 ) ;
return 0 ;
}
static void F_313 ( struct V_350 * V_351 )
{
F_314 ( & V_351 -> V_78 , & V_351 -> V_327 ) ;
F_151 ( V_351 ) ;
}
static void F_315 ( void )
{
struct V_251 * V_344 , * V_353 ;
struct V_350 * V_351 , * V_354 ;
F_316 (rmrru, rmrr_n, &dmar_rmrr_units, list) {
F_202 ( & V_344 -> V_346 ) ;
F_314 ( & V_344 -> V_78 , & V_344 -> V_327 ) ;
F_151 ( V_344 ) ;
}
F_316 (atsru, atsr_n, &dmar_atsr_units, list) {
F_202 ( & V_351 -> V_346 ) ;
F_313 ( V_351 ) ;
}
}
...
V_356 = V_71 -> V_207 ;
if ( ! V_356 || ! F_185 ( V_356 ) ||
F_235 ( V_356 ) == V_269 )
return 0 ;
if ( F_235 ( V_356 ) == V_357 )
break;
}
if ( ! V_356 )
return 0 ;
F_64 () ;
F_318 (atsru, &dmar_atsr_units, list) {
V_349 = F_311 ( V_351 -> V_345 , struct V_348 , V_342 ) ;
if ( V_349 -> V_77 != F_76 ( V_70 -> V_71 ) )
continue;
F_319 (atsru->devices, atsru->devices_cnt, i, tmp)
if ( V_73 == & V_356 -> V_70 )
goto V_79;
if ( V_351 -> V_85 )
goto V_79;
...
V_252 = F_311 ( V_344 -> V_345 ,
struct V_343 , V_342 ) ;
if ( V_153 -> V_362 == V_363 ) {
V_91 = F_321 ( V_153 , ( void * ) ( V_252 + 1 ) ,
( ( void * ) V_252 ) + V_252 -> V_342 . V_226 ,
V_252 -> V_77 , V_344 -> V_78 ,
V_344 -> V_327 ) ;
if ( V_91 > 0 )
break;
else if( V_91 < 0 )
return V_91 ;
} else if ( V_153 -> V_362 == V_364 ) {
if ( F_322 ( V_153 , V_252 -> V_77 ,
V_344 -> V_78 , V_344 -> V_327 ) )
break;
}
}
...
V_349 = F_311 ( V_351 -> V_345 , struct V_348 , V_342 ) ;
if ( V_153 -> V_362 == V_363 ) {
V_91 = F_321 ( V_153 , ( void * ) ( V_349 + 1 ) ,
( void * ) V_349 + V_349 -> V_342 . V_226 ,
V_349 -> V_77 , V_351 -> V_78 ,
V_351 -> V_327 ) ;
if ( V_91 > 0 )
break;
else if( V_91 < 0 )
...
if ( F_322 ( V_153 , V_349 -> V_77 ,
V_351 -> V_78 , V_351 -> V_327 ) )
break;
}
}
return 0 ;
}
static int F_323 ( struct V_365 * V_366 ,
unsigned long V_367 , void * V_306 )
{
...
static int F_326 ( struct V_365 * V_366 ,
unsigned long V_19 , void * V_370 )
{
struct V_371 * V_372 = V_370 ;
unsigned long long V_194 , V_83 ;
unsigned long V_320 , V_244 ;
switch ( V_19 ) {
case V_373 :
V_194 = V_372 -> V_108 << V_11 ;
V_83 = ( ( V_372 -> V_108 + V_372 -> V_219 ) << V_11 ) - 1 ;
...
case V_375 :
case V_376 :
V_320 = F_13 ( V_372 -> V_108 ) ;
V_244 = F_13 ( V_372 -> V_108 + V_372 -> V_219 - 1 ) ;
while ( V_320 <= V_244 ) {
struct V_43 * V_43 ;
struct V_60 * V_61 ;
struct V_45 * V_46 ;
struct V_14 * V_115 ;
V_43 = F_272 ( & V_245 -> V_195 , V_320 ) ;
if ( V_43 == NULL ) {
F_122 ( L_68 ,
V_320 ) ;
break;
}
V_43 = F_328 ( & V_245 -> V_195 , V_43 ,
V_320 , V_244 ) ;
if ( V_43 == NULL ) {
F_327 ( L_69 ,
V_320 , V_244 ) ;
...
return;
F_82 ( & V_155 , V_54 ) ;
F_316 (info, tmp, &domain->devices, link) {
...
if ( V_63 == 0 ) {
unsigned long V_388 ;
F_82 ( & V_52 -> V_177 , V_388 ) ;
F_154 ( V_46 -> V_173 , V_52 -> V_57 ) ;
V_52 -> V_178 -- ;
F_72 ( V_52 ) ;
F_83 ( & V_52 -> V_177 , V_388 ) ;
if ( ! ( V_52 -> V_54 & V_55 ) &&
! ( V_52 -> V_54 & V_56 ) ) {
F_82 ( & V_46 -> V_89 , V_388 ) ;
F_154 ( V_52 -> V_181 , V_46 -> V_174 ) ;
V_46 -> V_164 [ V_52 -> V_181 ] = NULL ;
F_83 ( & V_46 -> V_89 , V_388 ) ;
}
}
}
...
static int F_340 ( struct V_390 * V_52 )
{
struct V_51 * V_51 ;
V_51 = F_156 ( true ) ;
if ( ! V_51 ) {
...
V_52 -> V_391 = V_51 ;
V_52 -> V_392 . V_393 = 0 ;
V_52 -> V_392 . V_394 = F_341 ( V_51 -> V_114 ) ;
V_52 -> V_392 . V_395 = true ;
return 0 ;
}
static void F_342 ( struct V_390 * V_52 )
{
struct V_51 * V_51 = V_52 -> V_391 ;
V_52 -> V_391 = NULL ;
F_155 ( V_51 ) ;
}
static int F_343 ( struct V_390 * V_52 ,
struct V_69 * V_70 )
{
struct V_51 * V_51 = V_52 -> V_391 ;
struct V_45 * V_46 ;
...
if ( V_51 -> V_389 > ( 1LL << V_94 ) ) {
F_39 ( V_151 L_81
L_82 ,
V_397 , V_94 , V_51 -> V_389 ) ;
return - V_202 ;
}
V_51 -> V_114 = V_94 ;
...
static void F_344 ( struct V_390 * V_52 ,
struct V_69 * V_70 )
{
struct V_51 * V_51 = V_52 -> V_391 ;
F_228 ( V_51 , V_70 ) ;
}
static int F_345 ( struct V_390 * V_52 ,
unsigned long V_43 , T_8 V_398 ,
T_7 V_87 , int V_399 )
{
struct V_51 * V_51 = V_52 -> V_391 ;
V_25 V_389 ;
...
if ( V_399 & V_401 )
V_220 |= V_104 ;
if ( ( V_399 & V_402 ) && V_51 -> V_66 )
V_220 |= V_225 ;
V_389 = V_43 + V_87 ;
if ( V_51 -> V_389 < V_389 ) {
V_25 V_83 ;
V_83 = F_341 ( V_51 -> V_114 ) + 1 ;
if ( V_83 < V_389 ) {
F_39 ( V_151 L_81
L_82 ,
V_397 , V_51 -> V_114 , V_389 ) ;
return - V_202 ;
}
V_51 -> V_389 = V_389 ;
}
V_87 = F_187 ( V_398 , V_87 ) ;
V_91 = F_198 ( V_51 , V_43 >> V_12 ,
V_398 >> V_12 , V_87 , V_220 ) ;
return V_91 ;
}
static T_7 F_346 ( struct V_390 * V_52 ,
...
F_101 ( V_115 ) ;
if ( V_51 -> V_389 == V_43 + V_87 )
V_51 -> V_389 = V_43 ;
return V_87 ;
}
static T_8 F_347 ( struct V_390 * V_52 ,
V_228 V_43 )
{
struct V_51 * V_51 = V_52 -> V_391 ;
struct V_27 * V_28 ;
...
static int F_348 ( struct V_390 * V_52 ,
unsigned long V_49 )
{
struct V_51 * V_51 = V_52 -> V_391 ;
if ( V_49 == V_405 )
...
static int F_349 ( struct V_69 * V_70 )
{
struct V_74 * V_76 = F_75 ( V_70 ) ;
struct V_74 * V_356 , * V_408 = NULL ;
struct V_409 * V_410 ;
int V_91 ;
T_2 V_71 , V_72 ;
...
V_408 = F_351 ( V_76 ) ;
F_352 ( & V_408 , F_353 ( V_408 ) ) ;
if ( V_408 -> V_411 &&
! F_354 ( V_408 , V_412 ) ) {
T_2 V_62 , V_413 = F_179 ( V_408 -> V_72 ) ;
for ( V_62 = 0 ; V_62 < 8 ; V_62 ++ ) {
struct V_74 * V_73 ;
V_73 = F_355 ( V_408 -> V_71 , F_294 ( V_413 , V_62 ) ) ;
if ( ! V_73 )
continue;
if ( ! F_354 ( V_73 , V_412 ) ) {
F_352 ( & V_408 , V_73 ) ;
...
while ( ! F_234 ( V_408 -> V_71 ) ) {
struct V_355 * V_71 = V_408 -> V_71 ;
while ( ! V_71 -> V_207 ) {
if ( ! F_234 ( V_71 ) )
V_71 = V_71 -> V_95 ;
else
...
if ( F_357 ( V_71 -> V_207 , NULL , V_412 ) )
break;
F_352 ( & V_408 , F_351 ( V_71 -> V_207 ) ) ;
}
V_414:
V_410 = F_358 ( & V_408 -> V_70 ) ;
F_356 ( V_408 ) ;
if ( ! V_410 ) {
V_410 = F_359 () ;
if ( F_360 ( V_410 ) )
...
V_91 = F_362 ( V_410 , V_70 ) ;
F_363 ( V_410 ) ;
return V_91 ;
}
static void F_364 ( struct V_69 * V_70 )
{
F_365 ( V_70 ) ;
}
static void F_366 ( struct V_74 * V_70 )
{
F_39 ( V_32 L_83 ) ;
V_33 = 0 ;
}
...
struct V_74 * V_76 ;
T_10 V_418 ;
V_76 = F_370 ( V_419 , 0x3a3e , NULL ) ;
if ( ! V_76 )
return;
F_356 ( V_76 ) ;
V_76 = F_370 ( V_419 , 0x342e , NULL ) ;
if ( ! V_76 )
return;
if ( F_371 ( V_76 , 0x188 , & V_418 ) ) {
F_356 ( V_76 ) ;
return;
}
F_356 ( V_76 ) ;
