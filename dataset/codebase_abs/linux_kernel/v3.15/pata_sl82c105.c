...
static int F_27 ( struct V_8 * V_11 , const struct V_52 * V_53 )
{
...
static const struct V_54 V_64 = {
. V_56 = V_57 ,
. V_58 = V_59 ,
. V_62 = & V_63
} ;
const struct V_54 * V_65 [] = { & V_64 ,
NULL } ;
int V_66 ;
int V_33 ;
V_33 = F_28 ( V_11 ) ;
...
V_65 [ 0 ] = & V_55 ;
F_25 ( V_11 ) ;
return F_30 ( V_11 , V_65 , & V_67 , NULL , 0 ) ;
}
static int F_31 ( struct V_8 * V_9 )
{
struct V_30 * V_10 = F_32 ( V_9 ) ;
int V_33 ;
V_33 = F_33 ( V_9 ) ;
if ( V_33 )
return V_33 ;
