...
V_18 = & V_176 -> V_177 [ V_176 -> V_189 ] ;
if ( V_18 -> V_23 & 0x80 ) {
if ( ++ V_176 -> V_189 == V_176 -> V_179 )
V_176 -> V_189 = 0 ;
} else
V_18 = NULL ;
...
{
struct V_1 * V_12 = F_59 ( V_196 , struct V_1 , V_173 ) ;
...
T_7 V_197 , T_7 V_198 , int V_96 )
{
struct V_6 * V_7 = (struct V_6 * ) ( ( void * ) V_198 ) ;
union V_5 * V_37 = F_2 ( V_7 ) ;
...
static int F_62 ( struct V_60 * V_61 , T_7 V_197 ,
int V_96 )
{
struct V_2 * V_3 = F_29 ( V_61 ) ;
struct V_1 * V_12 = F_1 ( V_3 ) ;
...
static T_8 F_64 ( struct V_200 * V_103 ,
struct V_201 * V_202 , char * V_9 )
{
return snprintf ( V_9 , V_180 , L_14 , V_203 ) ;
}
static T_8 F_65 ( struct V_200 * V_103 ,
struct V_201 * V_202 , char * V_9 )
{
return snprintf ( V_9 , V_180 , L_29 , V_106 ) ;
}
static T_8 F_66 ( struct V_200 * V_103 ,
struct V_201 * V_202 , char * V_9 )
{
...
static int F_68 ( struct V_204 * V_103 , const struct V_205 * V_206 )
{
struct V_60 * V_61 ;
struct V_2 * V_3 ;
struct V_1 * V_12 ;
unsigned int * V_20 , V_207 ;
int V_66 = - V_190 ;
V_12 = F_69 ( sizeof( struct V_1 ) , V_104 ) ;
if ( ! V_12 )
return V_66 ;
V_61 = F_70 ( & V_208 , sizeof( struct V_2 ) ) ;
if ( ! V_61 )
goto V_209;
V_61 -> V_210 = V_211 ;
V_3 = F_29 ( V_61 ) ;
...
static int F_81 ( struct V_204 * V_103 )
{
...
{
struct V_217 * V_218 ;
const char * V_206 , * V_219 , * V_220 ;
const unsigned int * V_221 ;
V_218 = F_85 ( L_32 ) ;
if ( ! V_218 )
return - V_222 ;
V_219 = F_86 ( V_218 , L_33 , NULL ) ;
V_206 = F_86 ( V_218 , L_34 , NULL ) ;
if ( V_219 && V_206 )
snprintf ( V_203 , sizeof( V_203 ) , L_35 , V_219 , V_206 ) ;
V_220 = F_86 ( V_218 , L_36 , NULL ) ;
if ( V_220 )
strncpy ( V_105 , V_220 , sizeof( V_105 ) ) ;
V_221 = F_86 ( V_218 , L_37 , NULL ) ;
if ( V_221 )
V_106 = * V_221 ;
F_87 ( V_218 ) ;
return 0 ;
