...
struct V_8 * V_9 ;
struct V_25 * V_26 ;
V_9 = F_15 ( & V_24 -> V_2 , sizeof( * V_9 ) , V_27 ) ;
if ( ! V_9 )
return - V_28 ;
V_9 -> V_17 = F_16 ( V_24 ) ;
V_9 -> V_6 = F_17 ( V_24 , 0 ) ;
...
V_26 = F_19 ( V_24 , V_29 , 0 ) ;
V_9 -> V_20 = F_20 ( & V_24 -> V_2 , V_26 ) ;
if ( F_21 ( V_9 -> V_20 ) )
return F_22 ( V_9 -> V_20 ) ;
F_23 ( & V_9 -> V_10 ) ;
F_24 ( & V_9 -> V_16 ) ;
F_25 ( V_24 , V_9 ) ;
...
V_24 -> V_30 , V_9 ) ;
if ( V_15 ) {
F_18 ( & V_24 -> V_2 , L_4 , V_15 ) ;
return V_15 ;
}
F_12 ( V_9 -> V_6 ) ;
V_15 = F_27 ( & V_24 -> V_2 . V_31 , & V_32 ) ;
if ( V_15 ) {
F_18 ( & V_24 -> V_2 , L_5 , V_15 ) ;
return V_15 ;
}
...
return 0 ;
V_33:
F_29 ( & V_24 -> V_2 . V_31 , & V_32 ) ;
return V_15 ;
}
static int F_30 ( struct V_23 * V_24 )
{
struct V_8 * V_9 = F_31 ( V_24 ) ;
F_32 ( V_9 -> V_9 ) ;
F_29 ( & V_24 -> V_2 . V_31 , & V_32 ) ;
return 0 ;
}
