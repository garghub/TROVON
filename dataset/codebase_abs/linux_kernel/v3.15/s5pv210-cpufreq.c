...
unsigned long V_87 ;
int V_24 ;
V_15 -> V_88 = F_15 ( NULL , L_5 ) ;
if ( F_16 ( V_15 -> V_88 ) )
return F_17 ( V_15 -> V_88 ) ;
V_89 = F_15 ( NULL , L_6 ) ;
if ( F_16 ( V_89 ) ) {
V_24 = F_17 ( V_89 ) ;
goto V_90;
...
V_12 [ 0 ] . V_3 = F_18 ( V_89 ) ;
V_12 [ 1 ] . V_13 = ( F_11 ( V_10 + 0x30 ) * 1000 ) ;
V_12 [ 1 ] . V_3 = F_18 ( V_91 ) ;
V_15 -> V_96 = V_97 ;
return F_19 ( V_15 , V_30 , 40000 ) ;
V_92:
F_20 ( V_89 ) ;
V_90:
F_20 ( V_15 -> V_88 ) ;
