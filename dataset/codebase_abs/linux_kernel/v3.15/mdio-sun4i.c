...
V_2 -> V_31 = & F_1 ;
V_2 -> V_32 = & F_6 ;
snprintf ( V_2 -> V_33 , V_34 , L_2 , F_9 ( & V_20 -> V_23 ) ) ;
V_2 -> V_35 = & V_20 -> V_23 ;
V_2 -> V_36 = F_10 ( & V_20 -> V_23 , sizeof( int ) * V_37 ,
V_38 ) ;
if ( ! V_2 -> V_36 ) {
V_27 = - V_29 ;
goto V_39;
...
V_2 -> V_36 [ V_28 ] = V_40 ;
V_6 = V_2 -> V_7 ;
V_26 = F_11 ( V_20 , V_41 , 0 ) ;
V_6 -> V_10 = F_12 ( & V_20 -> V_23 , V_26 ) ;
if ( F_13 ( V_6 -> V_10 ) ) {
V_27 = F_14 ( V_6 -> V_10 ) ;
goto V_39;
}
V_6 -> V_42 = F_15 ( & V_20 -> V_23 , L_3 ) ;
if ( F_13 ( V_6 -> V_42 ) ) {
if ( F_14 ( V_6 -> V_42 ) == - V_43 )
return - V_43 ;
F_16 ( & V_20 -> V_23 , L_4 ) ;
} else {
V_27 = F_17 ( V_6 -> V_42 ) ;
