...
struct V_5 * F_63 ( struct V_20 * V_21 ,
const T_1 * V_54 )
{
struct V_5 * V_8 ;
struct V_7 * V_10 ;
...
goto V_80;
F_15 ( V_10 ) ;
for ( V_65 = 0 ; V_65 < V_81 ; V_65 ++ ) {
F_44 ( & V_8 -> V_82 [ V_65 ] . V_63 ) ;
F_45 ( & V_8 -> V_82 [ V_65 ] . V_83 ) ;
V_8 -> V_82 [ V_65 ] . V_66 = 0 ;
}
return V_8 ;
V_80:
F_26 ( V_8 ) ;
...
static bool F_75 ( struct V_20 * V_21 ,
struct V_5 * V_8 )
{
struct V_36 * V_99 ;
struct V_39 * V_52 ;
...
{
struct V_111 * V_88 = (struct V_111 * ) V_109 -> V_112 ;
struct V_20 * V_21 = F_83 ( V_88 ) ;
struct V_39 * V_113 ;
V_113 = F_84 ( V_109 ) ;
if ( ! V_113 )
return 0 ;
F_85 ( V_109 , L_8 ,
V_114 , V_113 -> V_88 -> V_89 ,
V_113 -> V_88 -> V_115 , V_88 -> V_89 ,
V_21 -> V_57 -> V_89 ) ;
F_86 ( V_113 ) ;
if ( ! V_21 -> V_57 -> V_116 ) {
F_87 ( V_109 ,
...
F_85 ( V_109 , L_12 ,
V_114 , V_52 -> V_88 -> V_89 ,
V_52 -> V_88 -> V_115 ,
V_52 -> V_103 -> V_89 , V_21 -> V_57 -> V_89 ) ;
