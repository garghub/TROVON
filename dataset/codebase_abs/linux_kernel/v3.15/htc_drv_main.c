...
V_3 -> V_308 ++ : V_3 -> V_308 -- ;
if ( ! V_29 -> V_35 )
F_71 ( V_307 , & V_45 -> V_86 ) ;
if ( V_3 -> V_12 -> V_50 == V_54 ) {
F_124 ( V_3 ) ;
if ( V_29 -> V_35 && ( V_3 -> V_308 == 1 ) )
F_16 ( V_3 ) ;
else if ( V_3 -> V_308 == 0 )
F_25 ( V_3 ) ;
}
...
V_309 = 20 ;
if ( V_27 -> type == V_30 ) {
V_3 -> V_318 . V_309 = V_309 ;
V_3 -> V_318 . V_319 = V_320 ;
} else {
V_12 -> V_309 = V_309 ;
F_128 ( V_12 ) ;
}
...
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
V_322 = F_130 ( V_3 -> V_12 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
return V_322 ;
}
static void F_131 ( struct V_81 * V_36 ,
struct V_26 * V_27 , T_5 V_322 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
F_132 ( V_3 -> V_12 , V_322 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
}
...
static int F_140 ( struct V_81 * V_36 , T_4 V_333 )
{
return 0 ;
}
...
V_337 . V_115 = V_126 -> V_96 ;
V_337 . V_150 = V_338 ;
V_337 . V_43 = F_53 ( V_43 -> V_216 [ V_338 ] . V_339 ) ;
F_36 ( V_340 , & V_337 ) ;
if ( V_10 ) {
F_32 ( V_45 ,
L_53
...
V_337 . V_150 = V_341 ;
V_337 . V_43 = F_53 ( V_43 -> V_216 [ V_341 ] . V_339 ) ;
F_36 ( V_340 , & V_337 ) ;
if ( V_10 ) {
F_32 ( V_45 ,
L_55
...
F_43 ( V_45 , V_90 , L_56 ,
V_43 -> V_216 [ V_338 ] . V_339 ,
V_43 -> V_216 [ V_341 ] . V_339 ) ;
V_244:
return V_10 ;
}
...
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_55 * V_12 = V_3 -> V_12 ;
struct V_344 * V_345 = & V_12 -> V_346 ;
V_343 -> V_347 = V_345 -> V_348 ;
V_343 -> V_349 = V_345 -> V_350 ;
V_343 -> V_351 = V_345 -> V_352 ;
V_343 -> V_353 = V_345 -> V_354 ;
return 0 ;
}
struct V_355 * F_144 ( struct V_2 * V_3 )
{
struct V_355 * V_356 = NULL ;
if ( F_145 ( V_3 -> V_12 ) )
V_356 = (struct V_355 * )
& V_3 -> V_12 -> V_357 . V_358 . V_359 ;
else if ( V_3 -> V_12 -> V_360 . V_361 == V_362 )
V_356 = (struct V_355 * )
& V_3 -> V_12 -> V_357 . V_363 . V_359 ;
else if ( V_3 -> V_12 -> V_360 . V_361 == V_364 )
V_356 = (struct V_355 * )
& V_3 -> V_12 -> V_357 . V_365 . V_359 ;
return V_356 ;
}
static int F_146 ( struct V_81 * V_36 , T_4 * V_366 ,
T_4 * V_367 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_355 * V_356 = F_144 ( V_3 ) ;
if ( V_356 ) {
* V_366 = V_356 -> V_368 ;
* V_367 = V_356 -> V_369 ;
} else {
