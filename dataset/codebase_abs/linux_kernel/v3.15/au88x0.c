...
static int
F_30 ( struct V_1 * V_19 , const struct V_42 * V_43 )
{
static int V_44 ;
struct V_17 * V_18 ;
T_2 * V_21 ;
...
V_22 = F_31 ( & V_19 -> V_44 , V_49 [ V_44 ] , V_50 [ V_44 ] , V_51 ,
0 , & V_18 ) ;
if ( V_22 < 0 )
return V_22 ;
...
#endif
if ( ( V_22 = F_39 ( V_19 , V_63 ,
& ( V_21 -> V_13 ) ) ) < 0 ) {
F_32 ( V_18 ) ;
return V_22 ;
}
if ( ( V_22 = F_39 ( V_19 , V_64 ,
& ( V_21 -> V_31 ) ) ) < 0 ) {
F_32 ( V_18 ) ;
return V_22 ;
}
...
static void F_45 ( struct V_1 * V_19 )
{
F_32 ( F_46 ( V_19 ) ) ;
}
