...
if ( V_42 == NULL )
return - V_136 ;
V_42 -> V_111 = F_32 ( V_129 , & V_137 ) ;
if ( F_33 ( V_42 -> V_111 ) ) {
V_112 = F_34 ( V_42 -> V_111 ) ;
F_24 ( & V_129 -> V_83 , L_3 , V_112 ) ;
return V_112 ;
}
V_112 = F_35 ( V_42 -> V_111 , V_138 , & V_133 ) ;
if ( V_112 < 0 ) {
F_24 ( & V_129 -> V_83 , L_4 , V_112 ) ;
return V_112 ;
}
V_112 = F_35 ( V_42 -> V_111 , V_139 , & V_134 ) ;
if ( V_112 < 0 ) {
F_24 ( & V_129 -> V_83 , L_5 , V_112 ) ;
return V_112 ;
}
V_134 >>= 8 ;
if ( ( V_133 != 0x10ec ) || ( V_134 != V_98 -> V_140 ) ) {
F_24 ( & V_129 -> V_83 , L_6 ) ;
F_24 ( & V_129 -> V_83 , L_7 ,
0x10ec , V_98 -> V_140 ,
V_133 , V_134 ) ;
...
F_15 ( & V_129 -> V_83 , L_8 , V_134 ) ;
V_132 = V_129 -> V_83 . V_141 ;
if ( V_132 ) {
...
F_36 ( V_129 , V_42 ) ;
V_112 = F_37 ( & V_129 -> V_83 ,
& V_144 , & V_142 , 1 ) ;
if ( V_112 != 0 )
F_24 ( & V_129 -> V_83 , L_12 , V_112 ) ;
return V_112 ;
}
static int F_38 ( struct V_128 * V_129 )
{
F_39 ( & V_129 -> V_83 ) ;
return 0 ;
}
