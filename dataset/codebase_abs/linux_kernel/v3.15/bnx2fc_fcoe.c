...
static int F_146 ( struct V_2 * V_3 , struct V_36 * V_37 )
{
int V_251 , V_252 ;
V_251 = V_37 -> V_253 + 1 ;
if ( V_254 <= 2 )
V_252 = V_37 -> V_253 + V_255 ;
else
V_252 = V_37 -> V_253 + V_256 ;
if ( ! F_147 ( V_3 , V_257 , V_251 ,
V_252 , NULL ) ) {
...
V_3 -> V_263 = 2 * 1000 ;
V_3 -> V_264 = 10 * 1000 ;
V_3 -> V_265 = ( V_266 | V_267 |
V_268 | V_269 ) ;
V_3 -> V_270 = 1 ;
memset ( & V_3 -> V_271 , 0 , sizeof( struct V_272 ) ) ;
V_3 -> V_271 . V_273 = V_274 ;
if ( F_149 ( V_3 ) )
return - V_65 ;
F_150 ( V_3 ) ;
return 0 ;
}
static int F_151 ( struct V_23 * V_24 , struct V_1 * V_99 ,
struct V_120 * V_121 ,
struct V_1 * V_275 )
{
struct V_4 * V_35 ;
...
static void F_153 ( struct V_2 * V_3 , T_1 * V_277 )
{
struct V_5 * V_34 = F_2 ( V_3 ) ;
memcpy ( V_34 -> V_109 , V_277 , V_104 ) ;
}
...
static void F_155 ( struct V_12 * V_278 , struct V_23 * V_24 )
{
V_24 -> V_99 = F_156 ( V_278 ) -> V_7 ;
F_157 ( V_24 ) ;
}
static int F_158 ( struct V_279 * V_193 , bool V_280 )
{
struct V_155 * V_156 = F_159 ( V_193 ) ;
struct V_2 * V_281 = F_100 ( V_156 ) ;
struct V_5 * V_34 = F_2 ( V_281 ) ;
struct V_4 * V_35 = V_34 -> V_6 ;
...
V_32 = F_160 ( V_193 ) ;
if ( V_32 ) {
F_161 ( V_193 -> V_283 , V_282 , sizeof( V_282 ) ) ;
F_65 (KERN_ERR PFX L_35
L_36 ,
buf) ;
return V_32 ;
}
if ( ! F_41 ( V_284 , & V_35 -> V_37 -> V_85 ) ) {
...
static void F_170 ( struct V_36 * V_37 , struct V_2 * V_3 )
{
struct V_289 * V_290 , * V_150 ;
F_8 ( & V_37 -> V_43 ) ;
...
static int F_172 ( struct V_279 * V_193 )
{
struct V_155 * V_156 = F_159 ( V_193 ) ;
struct V_2 * V_281 = F_100 ( V_156 ) ;
struct V_2 * V_135 = V_193 -> V_291 ;
struct V_5 * V_34 = F_2 ( V_135 ) ;
struct V_4 * V_35 = V_34 -> V_6 ;
struct V_2 * V_292 ;
bool V_293 = false ;
F_20 ( & V_281 -> V_241 ) ;
F_129 (v_port, &n_port->vports, list)
if ( V_292 -> V_193 == V_193 ) {
V_293 = true ;
break;
}
if ( ! V_293 ) {
...
F_171 ( & V_135 -> V_22 ) ;
F_23 ( & V_281 -> V_241 ) ;
F_170 ( V_35 -> V_37 , V_34 -> V_3 ) ;
F_173 ( V_34 -> V_3 ) ;
F_174 ( V_35 ) ;
F_175 ( V_236 , & V_34 -> V_295 ) ;
return 0 ;
}
static int F_176 ( struct V_279 * V_193 , bool V_296 )
{
struct V_2 * V_3 = V_193 -> V_291 ;
if ( V_296 ) {
F_166 ( V_193 , V_286 ) ;
F_177 ( V_3 ) ;
} else {
...
static int F_178 ( struct V_4 * V_35 )
{
struct V_1 * V_7 = V_35 -> V_7 ;
...
F_19 ( L_40 ,
V_299 -> type ) ;
F_65 ( V_301 L_41 , V_299 -> V_277 [ 0 ] ,
V_299 -> V_277 [ 1 ] , V_299 -> V_277 [ 2 ] , V_299 -> V_277 [ 3 ] ,
V_299 -> V_277 [ 4 ] , V_299 -> V_277 [ 5 ] ) ;
if ( ( V_299 -> type == V_302 ) &&
( F_181 ( V_299 -> V_277 ) ) ) {
memcpy ( V_13 -> V_108 , V_299 -> V_277 ,
V_104 ) ;
V_300 = 1 ;
F_19 ( L_42 ) ;
}
...
if ( ! V_300 )
return - V_64 ;
V_35 -> V_276 . V_303 = F_151 ;
V_35 -> V_276 . type = F_53 ( V_304 ) ;
V_35 -> V_276 . V_99 = V_7 ;
F_183 ( & V_35 -> V_276 ) ;
V_35 -> V_124 . V_303 = F_63 ;
V_35 -> V_124 . type = F_184 ( V_98 ) ;
V_35 -> V_124 . V_99 = V_7 ;
F_183 ( & V_35 -> V_124 ) ;
return 0 ;
}
...
static void F_189 ( struct V_307 * V_307 )
{
struct V_10 * V_11 ;
struct V_4 * V_35 ;
struct V_12 * V_13 ;
...
V_11 = F_130 ( V_13 ) ;
V_7 = V_35 -> V_7 ;
if ( F_190 ( V_308 , & V_35 -> V_309 ) )
F_191 ( V_13 ) ;
F_192 ( V_11 ) ;
F_193 ( V_7 ) ;
F_194 ( V_310 ) ;
}
static inline void F_195 ( struct V_4 * V_35 )
{
F_196 ( & V_35 -> V_307 ) ;
}
static inline void F_174 ( struct V_4 * V_35 )
{
F_197 ( & V_35 -> V_307 , F_189 ) ;
}
...
static struct V_36 * F_201 ( struct V_312 * V_313 )
{
struct V_36 * V_37 ;
struct V_314 * V_315 ;
int V_32 ;
V_37 = F_202 ( sizeof( * V_37 ) , V_316 ) ;
if ( ! V_37 ) {
...
struct V_4 * F_208 ( struct V_36 * V_37 ,
struct V_1 * V_7 ,
enum V_339 V_340 )
{
struct V_10 * V_11 ;
...
static struct V_2 * F_163 ( struct V_4 * V_35 ,
struct V_184 * V_346 , int V_347 )
{
struct V_12 * V_13 = F_32 ( V_35 ) ;
struct V_2 * V_3 , * V_281 ;
struct V_5 * V_34 ;
struct V_155 * V_156 ;
struct V_279 * V_193 = F_213 ( V_346 ) ;
struct V_289 * V_290 ;
struct V_36 * V_37 = V_35 -> V_37 ;
int V_32 = 0 ;
V_290 = F_202 ( sizeof( struct V_289 ) , V_316 ) ;
if ( ! V_290 ) {
F_34 ( V_13 -> V_16 , L_51 ) ;
return NULL ;
}
...
if ( ! V_347 )
V_3 = F_214 ( & V_348 , sizeof( * V_34 ) ) ;
else
V_3 = F_215 ( V_193 , sizeof( * V_34 ) ) ;
if ( ! V_3 ) {
...
F_134 ( V_3 -> V_185 ) = V_242 ;
if ( ! V_347 )
V_32 = F_146 ( V_3 , V_37 ) ;
else {
V_156 = F_159 ( V_193 ) ;
V_281 = F_100 ( V_156 ) ;
V_32 = F_217 ( V_281 , V_3 ) ;
}
if ( V_32 ) {
...
static void F_221 ( struct V_4 * V_35 )
{
F_222 ( & V_35 -> V_124 ) ;
F_222 ( & V_35 -> V_276 ) ;
F_223 () ;
...
static int F_231 ( struct V_1 * V_7 )
{
...
static int F_237 ( struct V_36 * V_37 )
{
if ( F_238 ( V_37 ) )
goto V_360;
if ( F_239 ( V_37 ) )
...
static int F_205 ( struct V_36 * V_37 )
{
struct V_312 * V_313 ;
struct V_361 * V_362 ;
if ( ! V_37 -> V_313 ) {
...
static void F_230 ( struct V_4 * V_35 )
{
struct V_12 * V_13 = F_32 ( V_35 ) ;
struct V_2 * V_3 ;
struct V_2 * V_193 ;
...
static void F_251 ( struct V_36 * V_37 )
{
if ( F_190 ( V_284 , & V_37 -> V_85 ) ) {
if ( F_252 ( V_37 ) == 0 ) {
F_253 ( & V_37 -> V_394 ) ;
...
static void F_246 ( struct V_4 * V_35 )
{
struct V_12 * V_13 = F_32 ( V_35 ) ;
struct V_2 * V_3 ;
int V_398 = 0 ;
...
V_3 = V_13 -> V_16 ;
F_34 ( V_3 , L_76 ) ;
if ( ! F_110 ( V_3 ) && V_35 -> V_237 ) {
F_34 ( V_3 , L_77 ) ;
F_132 ( V_13 ) ;
F_134 ( V_3 -> V_185 ) = V_399 ;
F_113 ( V_244 , & V_35 -> V_37 -> V_205 ) ;
}
while ( ! V_13 -> V_81 ) {
F_250 ( 250 ) ;
if ( ++ V_398 > 12 )
...
static void F_257 ( struct V_312 * V_99 )
{
struct V_36 * V_37 ;
int V_32 = 0 ;
F_19 ( L_1 , V_41 ) ;
...
static int F_262 ( struct V_10 * V_223 )
{
...
static int F_269 ( struct V_1 * V_7 , enum V_339 V_340 )
{
return F_263 ( V_7 , V_340 , V_424 ) ;
}
static int F_270 ( struct V_1 * V_7 )
{
return F_263 ( V_7 , V_413 ,
V_425 ) ;
}
static struct V_36 * F_271 ( struct V_312 * V_313 )
{
struct V_36 * V_37 ;
F_129 (hba, &adapter_list, list) {
if ( V_37 -> V_313 == V_313 )
return V_37 ;
}
return NULL ;
}
static struct V_4 * F_232 ( struct V_1
* V_7 )
{
struct V_4 * V_35 ;
F_129 (interface, &if_list, list) {
...
static struct V_36 * F_266 ( struct V_1
* V_202 )
{
struct V_36 * V_37 ;
F_129 (hba, &adapter_list, list) {
...
static void F_272 ( struct V_312 * V_99 )
{
struct V_36 * V_37 ;
struct V_4 * V_35 , * V_150 ;
F_19 ( L_98 ) ;
...
F_128 ( V_236 ) ;
F_255 ( V_37 ) ;
if ( F_190 ( V_404 , & V_37 -> V_405 ) )
V_37 -> V_313 -> V_426 ( V_37 -> V_313 , V_407 ) ;
F_198 ( V_37 ) ;
}
static int F_273 ( struct V_155 * V_156 )
{
struct V_2 * V_3 = F_100 ( V_156 ) ;
F_274 ( V_3 ) ;
return 0 ;
}
static bool F_275 ( struct V_1 * V_7 )
{
struct V_1 * V_202 = V_7 ;
F_20 ( & V_234 ) ;
if ( V_7 -> V_415 & V_416 )
...
static void F_276 ( unsigned int V_427 )
{
struct V_146 * V_147 ;
struct V_428 * V_128 ;
V_147 = & F_277 ( V_429 , V_427 ) ;
V_128 = F_278 ( F_91 ,
( void * ) V_147 , F_279 ( V_427 ) ,
L_101 , V_427 ) ;
if ( F_280 ( ! F_165 ( V_128 ) ) ) {
F_281 ( V_128 , V_427 ) ;
V_147 -> V_430 = V_128 ;
F_70 ( V_128 ) ;
}
}
static void F_282 ( unsigned int V_427 )
{
struct V_146 * V_147 ;
struct V_428 * V_128 ;
struct V_148 * V_149 , * V_150 ;
...
static int F_284 ( struct V_431 * V_432 ,
