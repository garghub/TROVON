...
if ( ! F_37 ( V_57 ) ) {
V_4 = F_38 ( V_57 ) ;
V_52 = F_39 ( V_55 -> V_65 . V_66 , V_57 , V_4 ) ;
F_40 ( V_52 == 0 ) ;
} else {
V_52 = F_28 ( V_57 , V_67 ) ;
V_4 = V_67 ;
}
V_1 = F_29 ( V_57 , V_52 , V_4 ) ;
...
static inline int F_41 ( unsigned int V_70 , int V_2 )
{
int V_33 , V_13 ;
unsigned int V_71 ;
...
static void F_42 ( struct V_21 * V_75 , unsigned long V_40 ,
int * V_2 , int * V_3 , int * V_4 , unsigned long * V_1 )
{
unsigned long V_76 , V_77 , V_78 ;
unsigned long V_31 = F_15 ( V_75 -> V_24 ) ;
unsigned long V_32 = F_15 ( V_75 -> V_37 ) ;
unsigned long V_52 , V_79 ;
int V_80 , V_81 , V_13 ;
unsigned int V_70 = ( V_32 >> V_73 ) & ( ( 1 << V_74 ) - 1 ) ;
if ( ! ( V_31 & V_82 ) ) {
V_80 = V_9 ;
V_81 = V_9 ;
} else {
...
V_31 = F_15 ( V_22 -> V_24 ) ;
if ( V_31 & V_36 ) {
F_42 ( V_22 , V_40 , & V_2 , & V_3 , & V_4 , & V_1 ) ;
V_22 -> V_24 = 0 ;
F_1 ( V_1 , V_2 , V_3 , V_4 ) ;
}
}
...
static void F_45 ( unsigned long V_91 , int V_14 )
{
unsigned long V_1 ;
