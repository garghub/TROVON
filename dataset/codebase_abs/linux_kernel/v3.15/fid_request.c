...
* V_54 = V_2 -> V_24 . V_55 ;
V_2 -> V_24 . V_55 += 1 ;
F_26 ( V_38 , L_10 V_56 L_4 , V_2 -> V_45 ,
* V_54 ) ;
return V_15 ;
}
...
* V_71 = V_2 -> V_64 ;
F_22 ( & V_2 -> V_49 ) ;
F_26 ( V_38 , L_15 V_75 L_2 , V_2 -> V_45 , F_40 ( V_71 ) ) ;
return V_15 ;
}
...
int F_57 ( struct V_84 * V_85 ,
struct V_7 * exp , enum V_80 type )
{
struct V_86 * V_41 = & V_85 -> V_40 . V_41 ;
char * V_81 ;
int V_15 ;
F_58 ( V_41 -> V_87 ) ;
if ( V_41 -> V_87 == NULL )
...
if ( V_81 == NULL )
GOTO ( V_89 , V_15 = - V_19 ) ;
snprintf ( V_81 , V_88 + 5 , L_18 , V_85 -> V_90 ) ;
V_15 = F_51 ( V_41 -> V_87 , exp , type , V_81 , NULL ) ;
F_60 ( V_81 , V_88 + 5 ) ;
if ( V_15 )
GOTO ( V_89 , V_15 ) ;
return V_15 ;
