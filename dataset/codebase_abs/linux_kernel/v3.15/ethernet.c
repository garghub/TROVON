...
const T_7 * V_32 ;
for (; ; ) {
V_109 = F_60 ( V_107 , V_109 ) ;
if ( ! V_109 )
break;
V_32 = F_61 ( V_109 , L_2 , & V_110 ) ;
if ( V_32 && ( F_62 ( * V_32 ) == V_108 ) )
break;
}
return V_109 ;
}
static struct V_106 * F_63 ( struct V_106 * V_111 ,
int V_61 , int V_13 )
{
struct V_106 * V_112 , * V_113 ;
V_112 = F_59 ( V_111 , V_61 ) ;
if ( ! V_112 )
return NULL ;
V_113 = F_59 ( V_112 , V_13 ) ;
F_64 ( V_112 ) ;
return V_113 ;
}
...
int V_122 = F_71 ( V_61 ) ;
int V_13 ;
for ( V_13 = F_72 ( V_61 , 0 ) ;
V_13 < F_72 ( V_61 , V_122 ) ;
V_13 ++ ) {
union V_123 V_124 ;
V_124 . V_74 =
F_38 ( F_73 ( V_13 ) ) ;
...
V_9 = F_18 ( V_37 ) ;
V_9 -> V_91 = F_63 ( V_111 , V_61 ,
V_132 ) ;
F_81 ( & V_9 -> V_10 ,
F_5 ) ;
V_9 -> V_129 = V_129 ;
V_9 -> V_13 = V_13 ;
V_9 -> V_97 = F_82 ( V_9 -> V_13 ) ;
V_9 -> V_117 = V_117 - F_83 ( V_13 ) * 4 ;
for ( V_119 = 0 ; V_119 < 16 ; V_119 ++ )
F_78 ( & V_9 -> V_131 [ V_119 ] ) ;
for ( V_119 = 0 ; V_119 < F_83 ( V_13 ) ;
V_119 ++ )
F_75 ( V_9 -> V_117 + V_119 * 4 , 0 ) ;
switch ( V_9 -> V_129 ) {
case V_130 :
case V_133 :
case V_134 :
...
F_84 () ;
F_85 () ;
V_147 = 150 * ( F_86 () / 1000000 ) ;
F_4 ( V_5 , & V_6 , V_7 ) ;
return 0 ;
}
static int F_87 ( struct V_114 * V_115 )
{
int V_13 ;
F_32 ( F_88 ( V_126 ) , 0 ) ;
F_89 () ;
F_90 ( V_148 + V_126 , V_12 ) ;
F_91 ( & V_4 ) ;
F_92 ( & V_6 ) ;
F_93 () ;
F_94 () ;
