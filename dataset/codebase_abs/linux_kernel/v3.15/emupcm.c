...
V_16 = F_8 ( V_2 , V_6 -> V_174 , 0 ) & 0x0000ffff ;
return F_64 ( V_14 , V_16 ) ;
}
static void F_65 ( struct V_1 * V_2 , struct V_175 * V_176 , int V_121 , int V_177 )
{
struct V_178 V_179 ;
if ( ! V_176 )
return;
if ( V_177 )
V_176 -> V_180 [ V_121 ] . V_181 &= ~ V_182 ;
else
V_176 -> V_180 [ V_121 ] . V_181 |= V_182 ;
F_66 ( V_2 -> V_171 , V_183 |
V_184 ,
F_67 ( & V_179 , V_176 , V_121 ) ) ;
}
static void F_68 ( struct V_1 * V_2 , int V_121 , int V_177 )
{
F_65 ( V_2 , V_2 -> V_185 , V_121 , V_177 ) ;
F_65 ( V_2 , V_2 -> V_186 , V_121 , V_177 ) ;
F_65 ( V_2 , V_2 -> V_187 , V_121 , V_177 ) ;
}
static void F_69 ( struct V_1 * V_2 , int V_121 , int V_177 )
{
F_65 ( V_2 , V_2 -> V_188 , V_121 , V_177 ) ;
F_65 ( V_2 , V_2 -> V_189 , V_121 , V_177 ) ;
F_65 ( V_2 , V_2 -> V_190 , V_121 , V_177 ) ;
}
...
V_14 -> V_193 = F_70 ;
V_14 -> V_194 = V_197 ;
if ( ( V_23 = F_76 ( V_14 , V_198 ) ) < 0 ) {
F_71 ( V_6 ) ;
return V_23 ;
}
if ( ( V_23 = F_77 ( V_14 , V_199 , 256 , V_200 ) ) < 0 ) {
F_71 ( V_6 ) ;
return V_23 ;
}
if ( V_2 -> V_86 -> V_87 && V_2 -> V_201 . V_202 == 0 )
V_196 = 44100 ;
else
V_196 = 48000 ;
V_23 = F_78 ( V_14 , V_196 ) ;
if ( V_23 < 0 ) {
F_71 ( V_6 ) ;
return V_23 ;
}
...
V_6 -> type = V_123 ;
V_6 -> V_7 = V_7 ;
V_6 -> V_166 = V_203 | V_204 ;
V_6 -> V_169 = V_205 ;
V_6 -> V_129 = V_206 ;
V_6 -> V_122 = V_207 ;
V_6 -> V_174 = V_2 -> V_78 ? V_208 : V_209 ;
V_14 -> V_15 = V_6 ;
V_14 -> V_193 = F_70 ;
V_14 -> V_194 = V_210 ;
V_2 -> V_211 = F_3 ;
V_2 -> V_9 = V_7 ;
F_81 ( V_14 , 0 , V_212 , & V_213 ) ;
...
V_6 -> type = V_216 ;
V_6 -> V_7 = V_7 ;
V_6 -> V_166 = V_217 | V_218 ;
V_6 -> V_169 = V_219 ;
V_6 -> V_129 = V_220 ;
V_6 -> V_122 = V_221 ;
V_6 -> V_174 = V_2 -> V_78 ? V_222 : V_223 ;
V_7 -> V_14 -> V_15 = V_6 ;
V_7 -> V_14 -> V_193 = F_70 ;
V_14 -> V_194 = V_210 ;
V_14 -> V_194 . V_224 = V_225 ;
V_14 -> V_194 . V_226 = V_14 -> V_194 . V_227 = 8000 ;
V_14 -> V_194 . V_228 = 1 ;
V_2 -> V_229 = F_4 ;
V_2 -> V_10 = V_7 ;
F_81 ( V_14 , 0 , V_212 , & V_213 ) ;
...
V_7 -> V_14 -> V_193 = F_70 ;
V_14 -> V_194 = V_237 ;
V_14 -> V_194 . V_224 = V_238 ;
V_14 -> V_194 . V_226 = V_14 -> V_194 . V_227 = 48000 ;
F_86 ( & V_2 -> V_73 ) ;
if ( V_2 -> V_86 -> V_87 ) {
#if 1
switch ( V_2 -> V_201 . V_202 ) {
case 0 :
V_14 -> V_194 . V_224 = V_239 ;
V_14 -> V_194 . V_226 = V_14 -> V_194 . V_227 = 44100 ;
V_14 -> V_194 . V_228 =
V_14 -> V_194 . V_240 = 16 ;
break;
case 1 :
...
#endif
V_14 -> V_194 . V_241 = V_242 ;
} else {
V_14 -> V_194 . V_228 = V_14 -> V_194 . V_240 = 0 ;
for ( V_121 = 0 ; V_121 < V_230 ; V_121 ++ ) {
if ( V_2 -> V_243 [ V_121 / 32 ] & ( 1 << ( V_121 % 32 ) ) ) {
V_14 -> V_194 . V_228 ++ ;
V_14 -> V_194 . V_240 ++ ;
}
}
}
V_6 -> V_134 = V_2 -> V_243 [ 0 ] ;
V_6 -> V_170 = V_2 -> V_243 [ 1 ] ;
F_87 ( & V_2 -> V_73 ) ;
V_2 -> V_244 = F_5 ;
V_2 -> V_11 = V_7 ;
F_81 ( V_14 , 0 , V_212 , & V_213 ) ;
...
int V_5 ( struct V_1 * V_2 , int V_245 , struct V_246 * * V_247 )
{
struct V_246 * V_248 ;
struct V_12 * V_7 ;
int V_23 ;
if ( V_247 )
* V_247 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_2 , V_245 , 32 , 1 , & V_248 ) ) < 0 )
return V_23 ;
V_248 -> V_15 = V_2 ;
F_90 ( V_248 , V_249 , & V_250 ) ;
F_90 ( V_248 , V_251 , & V_252 ) ;
V_248 -> V_253 = 0 ;
V_248 -> V_254 = V_255 ;
strcpy ( V_248 -> V_256 , L_3 ) ;
V_2 -> V_248 = V_248 ;
for ( V_7 = V_248 -> V_257 [ V_249 ] . V_7 ; V_7 ; V_7 = V_7 -> V_258 )
if ( ( V_23 = F_91 ( V_7 , V_259 , F_92 ( V_2 -> V_260 ) , 64 * 1024 , 64 * 1024 ) ) < 0 )
return V_23 ;
for ( V_7 = V_248 -> V_257 [ V_251 ] . V_7 ; V_7 ; V_7 = V_7 -> V_258 )
F_91 ( V_7 , V_261 , F_92 ( V_2 -> V_260 ) , 64 * 1024 , 64 * 1024 ) ;
if ( V_247 )
* V_247 = V_248 ;
return 0 ;
}
int F_93 ( struct V_1 * V_2 , int V_245 ,
struct V_246 * * V_247 )
{
struct V_246 * V_248 ;
struct V_12 * V_7 ;
...
if ( V_247 )
* V_247 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_2 , V_245 , 1 , 0 , & V_248 ) ) < 0 )
return V_23 ;
V_248 -> V_15 = V_2 ;
F_90 ( V_248 , V_249 , & V_262 ) ;
V_248 -> V_253 = 0 ;
V_248 -> V_254 = V_255 ;
strcpy ( V_248 -> V_256 , L_4 ) ;
V_2 -> V_263 = V_248 ;
for ( V_7 = V_248 -> V_257 [ V_249 ] . V_7 ; V_7 ; V_7 = V_7 -> V_258 )
if ( ( V_23 = F_91 ( V_7 , V_259 , F_92 ( V_2 -> V_260 ) , 64 * 1024 , 64 * 1024 ) ) < 0 )
return V_23 ;
...
int F_94 ( struct V_1 * V_2 , int V_245 ,
struct V_246 * * V_247 )
{
struct V_246 * V_248 ;
int V_23 ;
if ( V_247 )
* V_247 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_5 , V_245 , 0 , 1 , & V_248 ) ) < 0 )
return V_23 ;
V_248 -> V_15 = V_2 ;
F_90 ( V_248 , V_251 , & V_264 ) ;
V_248 -> V_253 = 0 ;
strcpy ( V_248 -> V_256 , L_6 ) ;
V_2 -> V_265 = V_248 ;
F_95 ( V_248 , V_261 , F_92 ( V_2 -> V_260 ) , 64 * 1024 , 64 * 1024 ) ;
if ( V_247 )
* V_247 = V_248 ;
return 0 ;
}
static int F_96 ( struct V_175 * V_266 , struct V_267 * V_268 )
{
struct V_1 * V_2 = F_97 ( V_266 ) ;
int V_230 = V_2 -> V_78 ? 64 : 32 ;
V_268 -> type = V_269 ;
V_268 -> V_270 = V_230 ;
V_268 -> V_271 . integer . V_272 = 0 ;
V_268 -> V_271 . integer . V_273 = 1 ;
return 0 ;
}
static int F_98 ( struct V_175 * V_266 , struct V_274 * V_275 )
{
struct V_1 * V_2 = F_97 ( V_266 ) ;
int V_230 = V_2 -> V_78 ? 64 : 32 ;
int V_121 ;
F_86 ( & V_2 -> V_73 ) ;
for ( V_121 = 0 ; V_121 < V_230 ; V_121 ++ )
V_275 -> V_271 . integer . V_271 [ V_121 ] = ( V_2 -> V_243 [ V_121 / 32 ] & ( 1 << ( V_121 % 32 ) ) ) ? 1 : 0 ;
F_87 ( & V_2 -> V_73 ) ;
return 0 ;
}
static int F_99 ( struct V_175 * V_266 , struct V_274 * V_275 )
{
struct V_1 * V_2 = F_97 ( V_266 ) ;
unsigned int V_276 [ 2 ] , V_277 ;
int V_230 = V_2 -> V_78 ? 64 : 32 ;
int V_278 = V_2 -> V_78 ? 7 : 6 ;
int V_279 , V_121 ;
V_276 [ 0 ] = V_276 [ 1 ] = 0 ;
for ( V_121 = 0 , V_277 = 0 ; V_121 < V_230 ; V_121 ++ )
if ( V_275 -> V_271 . integer . V_271 [ V_121 ] ) {
V_276 [ V_121 / 32 ] |= 1 << ( V_121 % 32 ) ;
V_277 ++ ;
}
for ( V_121 = 0 ; V_121 < V_278 ; V_121 ++ )
if ( 1 << V_121 == V_277 )
break;
if ( V_121 >= V_278 )
return - V_165 ;
F_86 ( & V_2 -> V_73 ) ;
V_279 = ( V_276 [ 0 ] != V_2 -> V_243 [ 0 ] ) ||
( V_276 [ 1 ] != V_2 -> V_243 [ 1 ] ) ;
V_2 -> V_243 [ 0 ] = V_276 [ 0 ] ;
V_2 -> V_243 [ 1 ] = V_276 [ 1 ] ;
F_87 ( & V_2 -> V_73 ) ;
...
static void F_101 ( unsigned short * V_280 ,
...
struct V_284 * V_285 , T_2 V_286 )
{
struct V_1 * V_2 = F_7 ( V_7 ) ;
struct V_287 * V_248 = & V_2 -> V_288 . V_248 [ V_7 -> V_20 ] ;
unsigned int V_289 = V_248 -> V_21 ;
unsigned short * V_282 = ( unsigned short * ) ( V_7 -> V_14 -> V_290 + V_285 -> V_291 ) ;
unsigned int V_292 = V_286 >> 2 , V_270 ;
unsigned int V_293 = V_248 -> V_293 ;
unsigned int V_283 = V_248 -> V_283 ;
while ( V_292 > V_293 ) {
V_270 = V_293 + 1 ;
F_101 ( ( unsigned short * ) V_2 -> V_288 . V_294 . V_295 + V_293 ,
( unsigned short * ) V_2 -> V_288 . V_294 . V_295 + V_293 + V_289 / 2 ,
V_282 , V_270 , V_283 ) ;
V_282 += V_270 * 2 ;
V_292 -= V_270 ;
V_293 = ( V_289 / 2 ) - 1 ;
...
struct V_287 * V_248 = & V_2 -> V_288 . V_248 [ V_7 -> V_20 ] ;
unsigned int V_24 ;
for ( V_24 = 0 ; V_24 < V_248 -> V_71 ; V_24 ++ )
F_22 ( V_2 , V_297 + 0x80 + V_248 -> V_298 [ V_24 ] , 0 , 0 ) ;
F_34 ( V_7 ) ;
return 0 ;
}
...
struct V_287 * V_248 = & V_2 -> V_288 . V_248 [ V_7 -> V_20 ] ;
unsigned int V_24 ;
memset ( & V_248 -> V_296 , 0 , sizeof( V_248 -> V_296 ) ) ;
V_248 -> V_296 . V_299 = V_248 -> V_21 * 2 ;
V_248 -> V_296 . V_300 = F_38 ( V_7 ) ;
V_248 -> V_293 = F_108 ( V_248 -> V_21 ) ;
V_248 -> V_283 = 0 ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_302 , 0 , 0 ) ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_303 , 0 , 0 ) ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_304 , 0 , V_14 -> V_21 ) ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_305 , 0 , 0 ) ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_306 , 0 , V_14 -> V_156 ) ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_307 , 0 , V_14 -> V_156 ) ;
for ( V_24 = 0 ; V_24 < V_248 -> V_71 ; V_24 ++ )
F_22 ( V_2 , V_297 + 0x80 + V_248 -> V_298 [ V_24 ] , 0 , ( V_308 | V_309 ) + V_24 * ( V_14 -> V_21 / V_248 -> V_71 ) ) ;
return 0 ;
}
...
V_277 = V_310 | V_311 |
V_312 | V_313 | V_314 |
0x00001200 | V_315 | V_316 | V_317 ;
F_22 ( V_2 , V_318 + V_24 , 0 , V_277 ) ;
}
}
#endif
V_158 = F_111 ( V_2 , F_100 , V_248 -> V_302 , V_7 , & V_248 -> V_319 ) ;
if ( V_158 < 0 )
goto V_320;
F_103 ( V_7 ) ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_303 , 0 , 1 ) ;
break;
case V_162 :
case V_163 :
case V_164 :
F_112 ( V_2 , V_248 -> V_319 ) ; V_248 -> V_319 = NULL ;
F_22 ( V_2 , V_2 -> V_301 + V_248 -> V_303 , 0 , 0 ) ;
V_248 -> V_293 = F_108 ( V_248 -> V_21 ) ;
V_248 -> V_283 = 0 ;
break;
...
struct V_287 * V_248 = & V_2 -> V_288 . V_248 [ V_7 -> V_20 ] ;
T_2 V_16 ;
if ( ! F_8 ( V_2 , V_2 -> V_301 + V_248 -> V_303 , 0 ) )
return 0 ;
V_16 = F_8 ( V_2 , V_2 -> V_301 + V_248 -> V_305 , 0 ) << 2 ;
return F_114 ( V_7 , & V_248 -> V_296 , V_16 ) ;
}
...
struct V_287 * V_248 = & V_2 -> V_288 . V_248 [ V_7 -> V_20 ] ;
V_14 -> V_194 = V_321 ;
V_14 -> V_194 . V_228 = V_14 -> V_194 . V_240 = V_248 -> V_71 ;
V_14 -> V_194 . V_322 = ( V_248 -> V_21 * 2 ) / 2 ;
F_86 ( & V_2 -> V_73 ) ;
if ( V_248 -> V_323 == 0 ) {
F_87 ( & V_2 -> V_73 ) ;
return - V_324 ;
...
int F_117 ( struct V_1 * V_2 , int V_245 ,
struct V_246 * * V_247 )
{
struct V_246 * V_248 ;
struct V_175 * V_176 ;
...
if ( V_247 )
* V_247 = NULL ;
if ( ( V_23 = F_89 ( V_2 -> V_171 , L_7 , V_245 , 8 , 1 , & V_248 ) ) < 0 )
return V_23 ;
V_248 -> V_15 = V_2 ;
F_90 ( V_248 , V_249 , & V_326 ) ;
F_90 ( V_248 , V_251 , & V_327 ) ;
V_248 -> V_253 = 0 ;
strcpy ( V_248 -> V_256 , L_8 ) ;
V_2 -> V_328 = V_248 ;
if ( V_247 )
* V_247 = V_248 ;
if ( V_2 -> V_78 ) {
V_2 -> V_243 [ 0 ] = 0 ;
if ( V_2 -> V_86 -> V_87 )
V_2 -> V_243 [ 1 ] = 0xffffffff ;
else
V_2 -> V_243 [ 1 ] = 0xffff ;
} else {
V_2 -> V_243 [ 0 ] = 0xffff0000 ;
V_2 -> V_243 [ 1 ] = 0 ;
}
V_176 = F_118 ( & V_329 , V_2 ) ;
if ( ! V_176 )
return - V_113 ;
V_176 -> V_179 . V_245 = V_245 ;
F_119 ( V_2 -> V_171 , V_176 ) ;
F_95 ( V_248 , V_261 , F_92 ( V_2 -> V_260 ) , 64 * 1024 , 64 * 1024 ) ;
return 0 ;
}
