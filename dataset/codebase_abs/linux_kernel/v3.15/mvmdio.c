...
V_6 -> V_47 = F_9 ;
V_6 -> V_48 = F_13 ;
snprintf ( V_6 -> V_49 , V_50 , L_6 ,
F_19 ( & V_40 -> V_2 ) ) ;
V_6 -> V_17 = & V_40 -> V_2 ;
V_6 -> V_33 = F_20 ( sizeof( int ) * V_51 , V_52 ) ;
if ( ! V_6 -> V_33 ) {
F_21 ( V_6 ) ;
return - V_45 ;
}
...
V_6 -> V_33 [ V_43 ] = V_53 ;
V_2 = V_6 -> V_7 ;
V_2 -> V_3 = F_22 ( & V_40 -> V_2 , V_42 -> V_54 , F_23 ( V_42 ) ) ;
if ( ! V_2 -> V_3 ) {
F_8 ( & V_40 -> V_2 , L_7 ) ;
V_22 = - V_29 ;
goto V_55;
...
F_24 ( & V_2 -> V_16 ) ;
V_2 -> V_56 = F_25 ( & V_40 -> V_2 , NULL ) ;
if ( ! F_26 ( V_2 -> V_56 ) )
F_27 ( V_2 -> V_56 ) ;
V_2 -> V_13 = F_28 ( V_40 , 0 ) ;
if ( V_2 -> V_13 > 0 ) {
V_22 = F_29 ( & V_40 -> V_2 , V_2 -> V_13 ,
F_14 ,
V_57 , V_40 -> V_46 , V_2 ) ;
if ( V_22 )
goto V_55;
