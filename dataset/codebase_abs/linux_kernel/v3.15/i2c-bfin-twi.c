...
int V_58 ;
unsigned int V_100 ;
V_2 = F_40 ( sizeof( struct V_1 ) , V_101 ) ;
if ( ! V_2 ) {
F_22 ( & V_96 -> V_30 , L_10 ) ;
V_58 = - V_102 ;
goto V_103;
...
F_41 ( & ( V_2 -> V_51 ) ) ;
V_99 = F_42 ( V_96 , V_104 , 0 ) ;
if ( V_99 == NULL ) {
F_22 ( & V_96 -> V_30 , L_11 ) ;
V_58 = - V_105 ;
goto V_106;
}
V_2 -> V_107 = F_43 ( V_99 -> V_108 , F_44 ( V_99 ) ) ;
if ( V_2 -> V_107 == NULL ) {
F_22 ( & V_96 -> V_30 , L_12 ) ;
V_58 = - V_60 ;
goto V_109;
}
V_2 -> V_49 = F_45 ( V_96 , 0 ) ;
if ( V_2 -> V_49 < 0 ) {
F_22 ( & V_96 -> V_30 , L_13 ) ;
V_58 = - V_105 ;
goto V_110;
...
F_46 ( V_97 -> V_93 , V_96 -> V_93 , sizeof( V_97 -> V_93 ) ) ;
V_97 -> V_113 = & V_114 ;
V_97 -> V_57 = V_2 ;
V_97 -> V_115 = V_116 | V_117 | V_118 ;
V_97 -> V_30 . V_119 = & V_96 -> V_30 ;
V_97 -> V_67 = 5 * V_120 ;
V_97 -> V_121 = 3 ;
V_58 = F_47 (
F_48 ( & V_96 -> V_30 ) ,
...
F_34 ( V_2 , ( ( F_49 () / 1000 / 1000 + 5 ) / 10 ) & 0x7F ) ;
