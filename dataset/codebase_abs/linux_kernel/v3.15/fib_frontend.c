...
static void F_74 ( int V_98 , int type , T_3 V_64 , int V_206 , struct V_133 * V_134 )
{
...
V_211 = F_76 ( V_44 , V_213 , V_110 ) ;
if ( V_211 == NULL ) {
F_77 ( L_1 , V_217 ) ;
return;
}
}
F_74 ( V_210 , V_74 , V_28 , 32 , V_211 ) ;
if ( ! ( V_27 -> V_218 & V_219 ) )
return;
if ( V_134 -> V_220 && V_134 -> V_220 != F_78 ( 0xFFFFFFFF ) )
F_74 ( V_210 , V_35 , V_134 -> V_220 , 32 , V_211 ) ;
...
if ( V_134 -> V_221 < 31 ) {
F_74 ( V_210 , V_35 , V_213 , 32 , V_211 ) ;
F_74 ( V_210 , V_35 , V_213 | ~ V_110 ,
32 , V_211 ) ;
}
}
}
void F_79 ( struct V_133 * V_134 , struct V_133 * V_223 )
{
struct V_43 * V_44 = V_134 -> V_207 ;
struct V_26 * V_27 = V_44 -> V_27 ;
struct V_133 * V_224 ;
...
int V_231 = 0 ;
if ( V_134 -> V_215 & V_216 ) {
V_211 = F_76 ( V_44 , V_227 , V_134 -> V_212 ) ;
if ( V_211 == NULL ) {
F_77 ( L_1 , V_217 ) ;
return;
}
...
if ( ! ( V_228 & F_81 ) )
F_74 ( V_232 , V_35 , V_134 -> V_220 , 32 , V_211 ) ;
if ( V_229 && V_134 -> V_221 < 31 ) {
if ( ! ( V_228 & F_83 ) )
F_74 ( V_232 , V_35 , V_226 , 32 , V_211 ) ;
if ( ! ( V_228 & F_82 ) )
F_74 ( V_232 , V_35 , V_227 , 32 , V_211 ) ;
}
if ( ! ( V_228 & F_80 ) ) {
F_74 ( V_232 , V_74 , V_134 -> V_138 , 32 , V_211 ) ;
if ( V_230 &&
F_19 ( F_26 ( V_27 ) , V_134 -> V_138 ) != V_74 ) {
if ( F_85 ( F_26 ( V_27 ) , V_134 -> V_138 ) )
F_10 ( F_26 ( V_27 ) ) ;
}
}
#undef F_80
...
static void F_86 ( struct V_235 * V_236 , struct V_2 * V_15 )
{
struct V_32 V_33 ;
struct V_29 V_30 = {
. V_60 = V_236 -> V_237 ,
...
F_64 ( V_42 ) . V_182 = 0 ;
F_64 ( V_42 ) . V_246 = 0 ;
F_92 ( V_1 -> V_10 . V_247 , V_42 , V_182 , V_248 ) ;
}
...
static void F_97 ( struct V_26 * V_27 , int V_253 )
{
if ( F_98 ( V_27 , V_253 ) )
F_10 ( F_26 ( V_27 ) ) ;
F_13 ( F_26 ( V_27 ) ) ;
...
static int F_100 ( struct V_254 * V_255 , unsigned long V_256 , void * V_257 )
{
...
static int F_103 ( struct V_254 * V_255 , unsigned long V_256 , void * V_257 )
{
struct V_26 * V_27 = F_104 ( V_257 ) ;
struct V_43 * V_44 ;
struct V_1 * V_1 = F_26 ( V_27 ) ;
if ( V_256 == V_262 ) {
F_97 ( V_27 , 2 ) ;
