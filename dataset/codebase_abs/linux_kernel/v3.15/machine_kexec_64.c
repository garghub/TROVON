...
F_28 () ;
F_33 ( L_7 ) ;
V_53 . V_54 . V_55 = F_34 () -> V_55 ;
V_53 . V_54 . V_56 = 0 ;
V_53 . V_54 . V_57 = V_58 ;
V_53 . V_54 . V_50 = F_34 () -> V_50 ;
memcpy ( & V_59 , F_14 () , sizeof( struct V_60 ) ) ;
V_59 . V_61 = 0xedeaddeadeeeeeeeUL ;
V_47 = (struct V_60 * ) F_35 ( & V_59 , 0 ) -
V_59 . V_62 ;
F_36 ( & V_59 ) ;
F_37 ( & V_53 , V_2 -> V_63 , V_2 ,
F_38 ( V_2 -> V_64 ) ,
V_12 . V_13 ) ;
}
...
if ( ! V_9 )
return - V_67 ;
V_66 = F_41 ( V_9 , V_68 . V_69 , NULL ) ;
if ( V_66 )
F_42 ( V_9 , V_66 ) ;
V_66 = F_41 ( V_9 , V_70 . V_69 , NULL ) ;
if ( V_66 )
F_42 ( V_9 , V_66 ) ;
V_71 = F_43 ( F_2 ( V_20 ) ) ;
F_44 ( V_9 , & V_68 ) ;
