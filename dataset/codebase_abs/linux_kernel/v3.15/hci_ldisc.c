...
static int F_29 ( struct V_11 * V_12 , struct V_20 * V_21 )
{
struct V_8 * V_9 = F_25 ( V_12 ) ;
if ( ! F_14 ( V_48 , & V_12 -> V_33 ) )
return - V_51 ;
F_9 ( L_6 , V_12 -> V_47 , F_12 ( V_21 ) -> V_10 , V_21 -> V_31 ) ;
V_9 -> V_23 -> V_52 ( V_9 , V_21 ) ;
F_6 ( V_9 ) ;
return 0 ;
}
...
return - V_53 ;
V_9 = F_31 ( sizeof( struct V_8 ) , V_54 ) ;
if ( ! V_9 ) {
F_19 ( L_8 ) ;
return - V_55 ;
}
...
F_32 ( & V_9 -> V_40 , F_15 ) ;
F_33 ( & V_9 -> V_58 ) ;
if ( V_26 -> V_59 -> V_34 -> V_60 )
V_26 -> V_59 -> V_34 -> V_60 ( V_26 ) ;
F_27 ( V_26 ) ;
return 0 ;
}
static void F_34 ( struct V_25 * V_26 )
{
struct V_8 * V_9 = ( void * ) V_26 -> V_56 ;
struct V_11 * V_12 ;
F_9 ( L_7 , V_26 ) ;
V_26 -> V_56 = NULL ;
if ( ! V_9 )
...
static void F_38 ( struct V_25 * V_26 , const T_1 * V_36 , char * V_33 , int V_61 )
{
struct V_8 * V_9 = ( void * ) V_26 -> V_56 ;
...
return;
F_39 ( & V_9 -> V_58 ) ;
V_9 -> V_23 -> V_62 ( V_9 , ( void * ) V_36 , V_61 ) ;
if ( V_9 -> V_12 )
V_9 -> V_12 -> V_14 . V_63 += V_61 ;
F_40 ( & V_9 -> V_58 ) ;
F_41 ( V_26 ) ;
}
...
V_12 -> V_50 = F_24 ;
V_12 -> V_68 = F_29 ;
F_45 ( V_12 , V_9 -> V_26 -> V_69 ) ;
if ( F_14 ( V_70 , & V_9 -> V_43 ) )
F_8 ( V_71 , & V_12 -> V_72 ) ;
if ( ! F_14 ( V_73 , & V_9 -> V_43 ) )
F_8 ( V_74 , & V_12 -> V_72 ) ;
if ( F_14 ( V_75 , & V_9 -> V_43 ) )
V_12 -> V_76 = V_77 ;
else
V_12 -> V_76 = V_78 ;
if ( F_14 ( V_42 , & V_9 -> V_43 ) )
...
const unsigned char * V_36 , T_4 V_61 )
{
return 0 ;
}
