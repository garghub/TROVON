...
V_126 > 127 ? V_131 : V_130 ;
#ifdef F_92
if ( F_123 ( V_126 , V_127 ) )
V_128 . V_77 = V_132 ;
else if ( F_50 ( F_124 ( V_126 ) ) )
V_128 . V_77 = V_103 ;
else
V_128 . V_77 = V_134 ;
#endif
...
V_126 > 127 ? V_131 : V_130 ;
#ifdef F_92
if ( F_126 ( V_126 , V_127 ) )
V_128 . V_77 = V_132 ;
else if ( F_50 ( F_127 ( V_126 ) ) )
V_128 . V_77 = V_103 ;
else
V_128 . V_77 = V_134 ;
#endif
...
static const struct V_75 * F_129 ( T_1 V_80 )
{
unsigned int V_126 = V_80 & 0xff ;
unsigned int V_127 = V_126 & 0x7f ;
V_128 . V_10 = V_141 ;
...
static const struct V_75 * F_130 ( T_1 V_80 )
{
unsigned int V_126 = V_80 & 0xff ;
...
F_133 ( L_22
L_23 , V_12 . V_149 , V_1 , V_143 , V_55 ,
V_55 < 0 ? L_24 : L_25 ) ;
F_136 ( & V_49 , L_26 , V_69 ) ;
return 0 ;
}
