...
int F_35 ( struct V_1 * V_2 , void * V_124 ,
...
V_129 . V_138 = V_126 ;
V_133 [ 0 ] . V_139 = & V_129 ;
V_133 [ 0 ] . V_140 = sizeof( struct V_128 ) ;
V_133 [ 1 ] . V_139 = V_124 ;
V_133 [ 1 ] . V_140 = V_125 ;
V_133 [ 2 ] . V_139 = & V_134 ;
V_133 [ 2 ] . V_140 = ( V_131 - V_130 ) ;
V_28 = F_37 ( & V_2 -> V_44 , V_133 , 3 , & signal ) ;
if ( V_28 == 0 && signal )
F_1 ( V_2 ) ;
return V_28 ;
}
...
V_129 . V_27 = V_147 ;
V_129 . V_148 = V_144 >> 3 ;
V_129 . V_149 = ( V_137 ) ( V_131 >> 3 ) ;
V_129 . V_150 = V_126 ;
V_129 . V_91 = V_73 ;
for ( V_72 = 0 ; V_72 < V_73 ; V_72 ++ ) {
V_129 . V_93 [ V_72 ] . V_151 = V_142 [ V_72 ] . V_151 ;
V_129 . V_93 [ V_72 ] . V_152 = V_142 [ V_72 ] . V_152 ;
V_129 . V_93 [ V_72 ] . V_100 = V_142 [ V_72 ] . V_100 ;
}
V_133 [ 0 ] . V_139 = & V_129 ;
V_133 [ 0 ] . V_140 = V_144 ;
V_133 [ 1 ] . V_139 = V_124 ;
...
V_88 V_134 = 0 ;
bool signal = false ;
T_1 V_82 = F_40 ( V_154 -> V_152 ,
V_154 -> V_151 ) ;
if ( ( V_82 < 0 ) || ( V_82 > V_156 ) )
return - V_35 ;
V_144 = sizeof( struct V_155 ) -
( ( V_156 - V_82 ) *
sizeof( V_88 ) ) ;
V_130 = V_144 + V_125 ;
V_131 = F_36 ( V_130 , sizeof( V_88 ) ) ;
...
V_129 . V_150 = V_126 ;
V_129 . V_91 = 1 ;
V_129 . V_93 . V_151 = V_154 -> V_151 ;
V_129 . V_93 . V_152 = V_154 -> V_152 ;
memcpy ( V_129 . V_93 . V_96 , V_154 -> V_96 ,
V_82 * sizeof( V_88 ) ) ;
V_133 [ 0 ] . V_139 = & V_129 ;
V_133 [ 0 ] . V_140 = V_144 ;
V_133 [ 1 ] . V_139 = V_124 ;
...
int F_41 ( struct V_1 * V_2 , void * V_124 ,
T_1 V_125 , T_1 * V_157 , V_88 * V_126 )
{
struct V_128 V_129 ;
T_1 V_130 ;
T_1 V_158 ;
...
* V_157 = 0 ;
* V_126 = 0 ;
V_28 = F_42 ( & V_2 -> V_46 , & V_129 ,
sizeof( struct V_128 ) ) ;
if ( V_28 != 0 )
return 0 ;
V_130 = V_129 . V_136 << 3 ;
V_158 = V_130 - ( V_129 . V_135 << 3 ) ;
* V_157 = V_158 ;
if ( V_158 > V_125 ) {
F_43 ( L_1 ,
V_125 , V_158 ) ;
...
* V_126 = V_129 . V_138 ;
V_28 = F_44 ( & V_2 -> V_46 , V_124 , V_158 ,
( V_129 . V_135 << 3 ) , & signal ) ;
if ( signal )
F_1 ( V_2 ) ;
return 0 ;
}
int F_45 ( struct V_1 * V_2 , void * V_124 ,
T_1 V_125 , T_1 * V_157 ,
V_88 * V_126 )
{
struct V_128 V_129 ;
...
* V_126 = V_129 . V_138 ;
V_28 = F_44 ( & V_2 -> V_46 , V_124 , V_130 , 0 ,
& signal ) ;
if ( signal )
F_1 ( V_2 ) ;
return V_28 ;
