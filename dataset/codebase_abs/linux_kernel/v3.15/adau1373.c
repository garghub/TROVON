...
int V_74 ;
if ( V_102 ) {
if ( V_102 -> V_106 > F_31 ( V_102 -> V_107 ) )
return - V_33 ;
if ( ! F_29 ( V_102 -> V_108 ) ||
! F_29 ( V_102 -> V_109 ) )
return - V_33 ;
for ( V_74 = 0 ; V_74 < V_102 -> V_106 ; ++ V_74 ) {
F_27 ( V_8 , V_74 ,
V_102 -> V_107 [ V_74 ] ) ;
}
F_32 ( V_7 , V_110 ,
...
F_19 ( V_8 -> V_13 , V_112 , V_11 ) ;
V_11 = 0 ;
if ( V_102 -> V_105 )
V_11 |= V_113 ;
if ( V_102 -> V_114 )
V_11 |= V_115 ;
F_19 ( V_8 -> V_13 , V_116 , V_11 ) ;
V_105 = V_102 -> V_105 ;
F_19 ( V_8 -> V_13 , V_117 ,
( V_102 -> V_108 << V_118 ) |
( V_102 -> V_109 << V_119 ) ) ;
...
static bool F_40 ( struct V_135 * V_103 , unsigned int V_136 )
{
switch ( V_136 ) {
case V_137 :
case V_138 :
...
const struct V_141 * V_29 )
{
struct V_8 * V_8 ;
int V_134 ;
V_8 = F_42 ( & V_140 -> V_103 , sizeof( * V_8 ) , V_142 ) ;
if ( ! V_8 )
return - V_143 ;
V_8 -> V_13 = F_43 ( V_140 ,
& V_144 ) ;
if ( F_44 ( V_8 -> V_13 ) )
return F_45 ( V_8 -> V_13 ) ;
F_19 ( V_8 -> V_13 , V_137 , 0x00 ) ;
F_46 ( & V_140 -> V_103 , V_8 ) ;
V_134 = F_47 ( & V_140 -> V_103 , & V_145 ,
V_146 , F_31 ( V_146 ) ) ;
return V_134 ;
}
