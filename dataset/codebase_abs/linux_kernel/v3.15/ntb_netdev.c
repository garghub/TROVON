...
static int F_32 ( struct V_70 * V_50 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
int V_15 ;
...
V_4 -> V_76 = F_35 ( V_77 ) ;
F_36 ( V_4 -> V_78 ) ;
memcpy ( V_4 -> V_79 , V_4 -> V_78 , V_4 -> V_80 ) ;
V_4 -> V_81 = & V_82 ;
F_37 ( V_4 , & V_83 ) ;
V_6 -> V_7 = F_38 ( V_4 , V_50 , & V_84 ) ;
if ( ! V_6 -> V_7 ) {
V_15 = - V_85 ;
goto V_34;
}
...
static void F_44 ( struct V_70 * V_50 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
bool V_90 = false ;
F_45 (dev, &dev_list, list) {
if ( V_6 -> V_50 == V_50 ) {
V_90 = true ;
break;
}
