...
static void F_94 ( struct V_180 * V_93 )
{
struct V_76 * V_103 = F_76 ( V_93 -> V_170 ) ;
struct V_2 * V_3 = V_103 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
static int F_96 ( struct V_75 * V_75 , void * V_112 ,
struct V_190 * V_191 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_3 -> V_108 = F_97 ( V_5 -> V_17 ) ;
if ( F_98 ( V_3 -> V_108 ) ) {
F_60 ( & V_5 -> V_105 , L_39 ) ;
return F_99 ( V_3 -> V_108 ) ;
}
V_192 = & V_3 -> V_106 ;
...
V_192 -> V_96 = & V_199 ;
V_192 -> V_200 = & V_201 ;
V_192 -> V_202 = sizeof( struct V_91 ) ;
V_33 = F_100 ( V_192 ) ;
if ( V_33 ) {
F_60 ( & V_5 -> V_105 , L_40 ) ;
F_48 ( V_5 -> V_17 ) ;
...
V_3 -> V_107 = 1 ;
F_92 ( & V_3 -> V_89 ) ;
V_33 = F_101 ( & V_3 -> V_106 , V_191 ) ;
V_146:
F_18 ( & V_3 -> V_81 ) ;
return V_33 ;
}
static int F_102 ( struct V_75 * V_75 , void * V_112 ,
struct V_203 * V_182 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_103 ( & V_3 -> V_106 , V_182 ) ;
}
static int F_104 ( struct V_75 * V_75 , void * V_112 ,
struct V_203 * V_205 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_105 ( & V_3 -> V_106 , V_205 ) ;
}
static int F_106 ( struct V_75 * V_75 , void * V_112 ,
struct V_203 * V_182 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_107 ( & V_3 -> V_106 ,
V_182 , ( V_75 -> V_207 & V_208 ) ) ;
}
static int F_108 ( struct V_75 * V_75 , void * V_112 ,
enum V_209 V_210 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
return F_109 ( & V_3 -> V_106 , V_210 ) ;
}
static int F_110 ( struct V_75 * V_75 , void * V_112 ,
enum V_209 V_210 )
{
struct V_2 * V_3 = F_27 ( V_75 ) ;
struct V_4 * V_5 = V_3 -> V_5 ;
