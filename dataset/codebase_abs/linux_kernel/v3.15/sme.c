...
void F_17 ( struct V_74 * V_75 )
{
struct V_5 * V_6 =
F_18 ( V_75 , struct V_5 , V_76 ) ;
struct V_1 * V_2 ;
...
static struct V_81 * F_26 ( struct V_1 * V_2 )
{
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
struct V_81 * V_82 ;
T_2 V_83 = V_84 ;
...
V_83 |= V_86 ;
V_82 = F_27 ( V_2 -> V_7 , V_2 -> V_3 -> V_15 . V_16 ,
V_2 -> V_3 -> V_15 . V_51 ,
V_2 -> V_3 -> V_15 . V_34 ,
V_2 -> V_3 -> V_15 . V_35 ,
V_84 | V_86 ,
...
void F_32 ( struct V_1 * V_2 , const T_1 * V_90 , T_3 V_91 )
{
struct V_7 * V_7 = V_2 -> V_7 ;
struct V_5 * V_6 = F_4 ( V_7 ) ;
struct V_92 * V_93 = (struct V_92 * ) V_90 ;
T_2 V_94 = F_33 ( V_93 -> V_95 . V_48 . V_94 ) ;
F_6 ( V_2 ) ;
...
bool F_34 ( struct V_1 * V_2 , T_2 V_103 )
{
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
if ( ! V_2 -> V_3 )
return false ;
...
if ( V_104 -> V_4 ) {
V_2 -> V_3 -> V_4 = F_41 ( V_104 -> V_4 , V_104 -> V_62 ,
V_19 ) ;
...
static int F_42 ( struct V_1 * V_2 , T_2 V_110 )
{
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
int V_11 ;
if ( ! V_2 -> V_3 )
...
void F_24 ( struct V_87 * V_88 , const T_1 * V_51 ,
...
#endif
F_6 ( V_2 ) ;
if ( F_40 ( V_2 -> V_122 != V_123 &&
V_2 -> V_122 != V_124 ) ) {
F_30 ( V_2 -> V_7 , V_82 ) ;
return;
}
F_47 ( F_4 ( V_2 -> V_7 ) , V_88 ,
V_51 , V_114 , V_115 ,
V_116 , V_117 ,
V_103 , V_19 ) ;
#ifdef F_46
...
F_48 ( V_88 , V_127 , & V_121 , V_114 ) ;
}
if ( V_116 && V_103 == V_102 ) {
memset ( & V_121 , 0 , sizeof( V_121 ) ) ;
V_121 . V_125 . V_126 = V_117 ;
F_48 ( V_88 , V_128 , & V_121 , V_116 ) ;
}
memset ( & V_121 , 0 , sizeof( V_121 ) ) ;
...
F_48 ( V_88 , V_134 , & V_121 , NULL ) ;
}
#endif
if ( ! V_82 && ( V_103 == V_102 ) ) {
F_49 ( ! F_4 ( V_2 -> V_7 ) -> V_47 -> V_104 ) ;
V_82 = F_27 ( V_2 -> V_7 , NULL , V_51 ,
V_2 -> V_34 , V_2 -> V_35 ,
V_84 ,
V_84 ) ;
if ( V_82 )
...
F_53 ( V_2 ) ;
F_54 () ;
V_119 = F_55 ( V_82 , V_136 ) ;
if ( ! V_119 ) {
F_56 () ;
return;
}
V_119 = F_41 ( V_119 , 2 + V_119 [ 1 ] , V_137 ) ;
F_56 () ;
if ( ! V_119 )
return;
F_57 ( V_2 -> V_7 , V_82 -> V_16 -> V_24 ,
V_119 + 2 , V_119 [ 1 ] ) ;
F_2 ( V_119 ) ;
}
void F_58 ( struct V_87 * V_88 , const T_1 * V_51 ,
const T_1 * V_114 , T_3 V_115 ,
const T_1 * V_116 , T_3 V_117 ,
T_2 V_103 , T_4 V_138 )
{
...
F_50 ( F_51 ( V_82 ) ) ;
V_2 -> V_106 = F_51 ( V_82 ) ;
F_64 ( F_4 ( V_2 -> V_7 ) , V_2 -> V_40 , V_82 -> V_51 ,
...
V_2 -> V_133 . V_60 = true ;
F_48 ( V_2 -> V_40 , V_134 , & V_121 , NULL ) ;
#endif
return;
V_112:
F_30 ( V_2 -> V_7 , V_82 ) ;
}
void F_65 ( struct V_87 * V_88 ,
struct V_27 * V_16 ,
const T_1 * V_51 ,
const T_1 * V_114 , T_3 V_115 ,
...
struct V_1 * V_2 = V_88 -> V_89 ;
struct V_81 * V_82 ;
V_82 = F_27 ( V_2 -> V_7 , V_16 , V_51 , V_2 -> V_34 ,
V_2 -> V_35 , V_84 ,
V_84 ) ;
if ( F_40 ( ! V_82 ) )
return;
F_66 ( V_88 , V_82 , V_114 , V_115 , V_116 ,
V_117 , V_138 ) ;
}
...
void F_67 ( struct V_87 * V_88 , const T_1 * V_4 ,
...
V_2 -> V_106 = NULL ;
V_2 -> V_35 = 0 ;
F_68 ( V_6 , V_88 , V_110 , V_4 , V_62 , V_150 ) ;
if ( V_6 -> V_47 -> V_151 )
for ( V_21 = 0 ; V_21 < 6 ; V_21 ++ )
F_69 ( V_6 , V_88 , V_21 , false , NULL ) ;
F_70 ( V_6 , V_88 , NULL ) ;
#ifdef F_46
memset ( & V_121 , 0 , sizeof( V_121 ) ) ;
V_121 . V_129 . V_130 = V_131 ;
...
void F_71 ( struct V_87 * V_88 , T_2 V_110 ,
...
struct V_139 * V_140 ;
unsigned long V_29 ;
V_140 = F_8 ( sizeof( * V_140 ) + V_62 , V_138 ) ;
if ( ! V_140 )
return;
V_140 -> type = V_153 ;
...
V_2 -> V_35 = V_104 -> V_35 ;
if ( ! V_6 -> V_47 -> V_104 )
V_11 = F_39 ( V_2 , V_104 , V_61 ) ;
else
V_11 = F_74 ( V_6 , V_88 , V_104 ) ;
if ( V_11 ) {
V_2 -> V_100 = NULL ;
V_2 -> V_35 = 0 ;
return V_11 ;
