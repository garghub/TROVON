...
F_115 ( void )
{
F_116 ( L_12 , 0 , NULL , & V_288 ) ;
if ( F_117 ( V_273 , L_12 , & V_289 ) )
F_58 ( L_13 , V_273 ) ;
V_271 = F_118 ( V_290 , L_14 ) ;
if ( F_101 ( V_271 ) ) {
...
if ( V_300 && V_301 && strncmp ( V_261 , L_16 , 4 ) )
V_299 = 1 ;
if ( V_300 && ! V_299 ) {
for ( V_35 = 0 ; V_35 < V_3 ; V_35 ++ ) {
if ( V_302 [ V_35 ] == NULL )
