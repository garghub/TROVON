...
void T_2 * V_112 ;
int V_7 ;
V_4 = F_32 ( & V_105 -> V_2 , sizeof( struct V_3 ) , V_113 ) ;
if ( ! V_4 ) {
F_7 ( & V_105 -> V_2 , L_3 ) ;
V_7 = - V_114 ;
goto V_115;
...
F_33 ( & V_105 -> V_2 , V_4 ) ;
V_107 = F_34 ( V_116 , & V_105 -> V_2 ) ;
if ( ! V_107 ) {
F_7 ( & V_105 -> V_2 , L_4 ) ;
V_7 = - V_117 ;
goto V_115;
}
V_4 -> V_69 = (struct V_118 * ) V_107 -> V_119 ;
V_4 -> V_9 = V_120 ;
V_4 -> V_9 . V_121 = F_35 ( & V_105 -> V_2 ) ;
V_7 = F_36 ( V_105 -> V_2 . V_122 ,
L_5 , V_108 ,
F_37 ( V_108 ) ) ;
if ( V_7 < 0 )
goto V_115;
...
V_110 = F_41 ( V_105 , V_125 , 0 ) ;
if ( ! V_110 ) {
F_7 ( & V_105 -> V_2 , L_7 ) ;
V_7 = - V_117 ;
goto V_126;
}
V_111 = F_42 ( & V_105 -> V_2 , V_110 -> V_127 ,
F_43 ( V_110 ) , V_128 ) ;
if ( ! V_111 ) {
F_7 ( & V_105 -> V_2 , L_8 ) ;
V_7 = - V_129 ;
...
V_112 = F_44 ( & V_105 -> V_2 , V_110 -> V_127 , F_43 ( V_110 ) ) ;
if ( ! V_112 ) {
F_7 ( & V_105 -> V_2 , L_9 ) ;
V_7 = - V_114 ;
goto V_126;
}
V_4 -> V_5 = F_45 ( & V_105 -> V_2 , V_112 ,
& V_130 ) ;
if ( F_39 ( V_4 -> V_5 ) ) {
F_7 ( & V_105 -> V_2 , L_10 ) ;
V_7 = F_40 ( V_4 -> V_5 ) ;
...
V_7 = F_51 ( & V_105 -> V_2 , & V_142 ,
& V_4 -> V_9 , 1 ) ;
if ( V_7 ) {
F_7 ( & V_105 -> V_2 , L_14 , V_7 ) ;
V_7 = - V_114 ;
goto V_143;
}
V_7 = F_52 ( & V_105 -> V_2 ,
