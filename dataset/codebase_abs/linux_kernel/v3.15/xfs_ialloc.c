...
{
struct V_26 * V_1 = V_196 -> V_208 -> V_209 ;
struct V_219 * V_220 = V_196 -> V_221 ;
if ( ! F_96 ( V_196 ) ) {
F_101 ( V_196 , V_217 ) ;
F_103 ( V_196 ) ;
return;
...
return;
if ( V_220 )
F_40 ( V_196 ) -> V_222 = F_8 ( V_220 -> V_223 . V_224 ) ;
F_105 ( V_196 , V_213 ) ;
}
int
F_106 (
...
int error ;
F_114 ( V_1 , V_31 ) ;
error = F_106 ( V_1 , V_28 , V_31 , V_225 ) ;
if ( error )
return error ;
V_20 = F_40 ( * V_225 ) ;
V_75 = F_48 ( V_1 , V_31 ) ;
