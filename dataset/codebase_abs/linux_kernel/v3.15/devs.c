...
void T_1 F_20 ( struct V_34 * V_35 ,
...
void T_1 F_21 ( struct V_42 * V_43 )
{
F_2 ( V_43 , sizeof( struct V_42 ) ,
& V_44 ) ;
}
void T_1 F_22 ( struct V_45 * V_2 )
{
struct V_45 * V_13 ;
...
void T_1 F_23 ( struct V_48 * V_2 )
{
struct V_48 * V_13 ;
V_13 = F_2 ( V_2 , sizeof( * V_13 ) , & V_49 ) ;
if ( V_13 ) {
V_13 -> V_50 = F_24 ( V_2 -> V_50 ,
...
static int T_1 F_26 ( struct V_55 * V_56 )
{
void * V_57 ;
int V_58 ;
V_58 = sizeof( struct V_59 ) * V_56 -> V_60 ;
if ( V_58 ) {
V_57 = F_24 ( V_56 -> V_61 , V_58 , V_53 ) ;
V_56 -> V_61 = V_57 ;
if ( ! V_57 )
return - V_62 ;
}
...
void T_1 F_27 ( struct V_67 * V_68 )
{
struct V_67 * V_13 ;
int V_58 ;
int V_69 ;
...
void T_1 F_28 ( struct V_77 * V_43 )
{
...
void T_1 F_31 ( struct V_80 * V_2 )
{
V_81 . V_82 . V_83 = V_2 ;
}
void T_1 F_32 ( struct V_84 * V_43 )
{
F_2 ( V_43 , sizeof( struct V_84 ) ,
& V_85 ) ;
}
void T_1 F_33 ( struct V_86 * V_87 )
{
F_2 ( V_87 ,
sizeof( struct V_86 ) , & V_88 ) ;
}
void T_1 F_33 ( struct V_86 * V_2 )
{
if ( ! V_2 )
V_2 = & V_89 ;
F_2 ( V_2 , sizeof( struct V_86 ) ,
& V_88 ) ;
}
void T_1 F_34 ( struct V_90 * V_91 )
{
F_2 ( V_91 , sizeof( struct V_90 ) ,
& V_92 ) ;
}
void T_1 F_35 ( struct V_93 * V_2 )
{
F_2 ( V_2 , sizeof( * V_2 ) , & V_94 ) ;
}
void T_1 F_36 ( struct V_95 * V_2 )
{
struct V_95 * V_13 ;
V_13 = F_2 ( V_2 , sizeof( struct V_95 ) ,
& V_96 ) ;
if ( ! V_13 -> V_97 )
V_13 -> V_97 = V_98 ;
if ( ! V_13 -> V_99 )
...
void T_1 F_37 ( struct V_101 * V_2 )
{
F_2 ( V_2 , sizeof( * V_2 ) , & V_102 ) ;
}
void T_1 F_38 ( int (* V_17)( void ) , int V_103 ,
int V_104 )
{
struct V_105 V_2 ;
if ( ! V_104 || V_103 < 0 ) {
...
void T_1 F_41 ( int (* V_17)( void ) , int V_103 ,
int V_104 )
{
struct V_105 V_2 ;
if ( ! V_104 || V_103 < 0 ) {
...
void T_1 F_42 ( int (* V_17)( void ) , int V_103 ,
int V_104 )
{
struct V_105 V_2 ;
if ( ! V_104 || V_103 < 0 ) {
...
V_2 . V_104 = V_104 ;
V_2 . V_103 = V_103 ;
V_2 . V_17 = ( V_17 ) ? V_17 : V_117 ;
#if F_40 ( V_107 )
V_2 . V_108 = V_109 ;
#elif F_40 ( V_110 )
V_2 . V_108 = V_111 ;
#endif
F_2 ( & V_2 , sizeof( V_2 ) , & V_118 ) ;
}
