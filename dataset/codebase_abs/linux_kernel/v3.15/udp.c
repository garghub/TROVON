...
struct V_1 * V_1 = F_6 ( V_7 ) ;
V_144 = & V_164 ;
F_105 ( V_144 , V_167 . V_201 , V_7 -> V_215 , V_171 ,
V_216 , V_7 -> V_152 ,
F_106 ( V_7 ) ,
...
if ( ! V_172 ) {
V_81 = F_115 ( V_7 , V_144 , F_93 , V_163 -> V_226 , V_165 ,
...
V_187:
V_125 -> V_127 += V_165 ;
V_97 = F_118 ( V_7 , V_144 , F_93 , V_163 -> V_226 , V_165 ,
sizeof( struct V_92 ) , & V_167 , & V_169 ,
...
int F_123 ( struct V_6 * V_7 , struct V_233 * V_233 , int V_132 ,
T_7 V_234 , int V_231 )
{
struct V_45 * V_61 = F_25 ( V_7 ) ;
struct V_124 * V_125 = F_7 ( V_7 ) ;
...
V_235 = F_124 ( V_7 , & V_61 -> V_156 . V_157 . V_158 . V_159 ,
V_233 , V_132 , V_234 , V_231 ) ;
if ( V_235 == - V_179 ) {
F_96 ( V_7 ) ;
return F_125 ( V_7 -> V_230 , V_233 , V_132 ,
V_234 , V_231 ) ;
}
if ( V_235 < 0 ) {
F_72 ( V_7 ) ;
...
int F_138 ( struct V_6 * V_7 , int V_245 , unsigned long V_246 )
{
switch ( V_245 ) {
case V_247 :
{
int V_248 = F_139 ( V_7 ) ;
return F_140 ( V_248 , ( int V_249 * ) V_246 ) ;
}
case V_250 :
{
unsigned int V_248 = F_126 ( V_7 ) ;
if ( V_248 )
...
bool V_244 ;
if ( V_231 & V_257 )
return F_142 ( V_7 , V_163 , V_127 , V_253 ) ;
V_258:
V_81 = F_143 ( V_7 , V_231 | ( V_252 ? V_259 : 0 ) ,
& V_255 , & V_256 , & V_97 ) ;
if ( ! V_81 )
goto V_105;
...
V_163 -> V_174 |= V_260 ;
if ( V_254 < V_165 || F_144 ( V_81 ) -> V_261 ) {
if ( F_129 ( V_81 ) )
goto V_262;
}
if ( F_145 ( V_81 ) )
...
int F_153 ( struct V_6 * V_7 , int V_231 )
{
struct V_45 * V_61 = F_25 ( V_7 ) ;
V_7 -> V_119 = V_268 ;
V_61 -> V_64 = 0 ;
...
void F_161 ( struct V_6 * V_7 , T_8 V_273 )
{
if ( F_158 ( V_7 ) ) {
struct V_22 * V_23 = V_7 -> V_24 -> V_25 . V_22 ;
...
if ( ( V_145 & V_283 ) && F_144 ( V_81 ) -> V_261 ) {
if ( V_125 -> V_284 == 0 ) {
F_117 ( V_285 L_3 ,
F_144 ( V_81 ) -> V_286 , V_81 -> V_127 ) ;
goto V_281;
}
if ( F_144 ( V_81 ) -> V_286 < V_125 -> V_284 ) {
F_117 ( V_285 L_4 ,
F_144 ( V_81 ) -> V_286 , V_125 -> V_284 ) ;
goto V_281;
}
}
if ( F_178 ( V_7 -> V_287 ) &&
F_129 ( V_81 ) )
goto V_288;
if ( F_179 ( V_7 , V_81 , V_7 -> V_289 ) )
goto V_281;
V_276 = 0 ;
F_180 ( V_7 , V_81 ) ;
F_181 ( V_7 ) ;
if ( ! F_182 ( V_7 ) )
V_276 = F_163 ( V_7 , V_81 ) ;
else if ( F_183 ( V_7 , V_81 , V_7 -> V_289 ) ) {
F_184 ( V_7 ) ;
goto V_281;
}
F_184 ( V_7 ) ;
...
static void F_185 ( struct V_6 * * V_290 , unsigned int V_36 ,
...
V_7 = V_290 [ V_292 ] ;
if ( F_95 ( V_293 == NULL ) )
V_293 = ( V_292 == V_291 ) ? V_81 : F_186 ( V_81 , V_294 ) ;
if ( ! V_293 ) {
F_131 ( & V_7 -> V_243 ) ;
F_130 ( F_6 ( V_7 ) , V_278 ,
F_84 ( V_7 ) ) ;
...
if ( V_293 && F_172 ( V_7 , V_293 ) <= 0 )
V_293 = NULL ;
}
if ( F_46 ( V_293 ) )
F_167 ( V_293 ) ;
}
static void F_187 ( struct V_6 * V_7 , struct V_295 * V_129 )
{
struct V_295 * V_296 ;
F_188 ( V_129 ) ;
V_296 = F_189 ( & V_7 -> V_297 , V_129 ) ;
F_190 ( V_296 ) ;
}
...
if ( F_46 ( V_36 == F_194 ( V_290 ) ) ) {
if ( ! V_7 )
break;
F_185 ( V_290 , V_36 , V_81 , ~ 0 ) ;
V_36 = 0 ;
}
}
for ( V_292 = 0 ; V_292 < V_36 ; V_292 ++ )
...
if ( ! F_173 ( NULL , V_280 , V_81 ) )
goto V_281;
F_174 ( V_81 ) ;
if ( F_129 ( V_81 ) )
goto V_288;
F_130 ( V_1 , V_304 , V_298 == V_299 ) ;
F_204 ( V_81 , V_108 , V_305 , 0 ) ;
F_167 ( V_81 ) ;
return 0 ;
V_302:
F_117 ( V_306 L_5 ,
...
V_165 ) ;
F_130 ( V_1 , V_241 , V_298 == V_299 ) ;
V_281:
F_130 ( V_1 , V_242 , V_298 == V_299 ) ;
F_167 ( V_81 ) ;
return 0 ;
}
...
const T_9 V_307 = F_208 ( V_87 , V_55 ) ;
F_52 () ;
V_71 = NULL ;
F_43 (sk, node, &hslot2->head) {
if ( F_209 ( V_7 , V_1 , V_308 ,
...
if ( F_46 ( ! F_47 ( & V_71 -> V_77 , 2 ) ) )
V_71 = NULL ;
else if ( F_46 ( ! F_209 ( V_7 , V_1 , V_308 ,
V_88 , V_86 ,
V_307 , V_59 ) ) ) {
F_48 ( V_71 ) ;
V_71 = NULL ;
...
int F_216 ( struct V_6 * V_7 , int V_315 , int V_316 ,
char V_249 * V_317 , unsigned int V_206 ,
...
if ( V_206 < sizeof( int ) )
return - V_186 ;
if ( F_218 ( V_318 , ( int V_249 * ) V_317 ) )
return - V_319 ;
switch ( V_316 ) {
case V_320 :
if ( V_318 != 0 ) {
...
int F_219 ( struct V_6 * V_7 , int V_315 , int V_316 ,
char V_249 * V_317 , unsigned int V_206 )
{
if ( V_315 == V_333 || V_315 == V_334 )
return F_216 ( V_7 , V_315 , V_316 , V_317 , V_206 ,
F_90 ) ;
return F_220 ( V_7 , V_315 , V_316 , V_317 , V_206 ) ;
}
...
return F_216 ( V_7 , V_315 , V_316 , V_317 , V_206 ,
F_90 ) ;
return F_222 ( V_7 , V_315 , V_316 , V_317 , V_206 ) ;
}
int F_223 ( struct V_6 * V_7 , int V_315 , int V_316 ,
char V_249 * V_317 , int V_249 * V_206 )
{
struct V_124 * V_125 = F_7 ( V_7 ) ;
int V_318 , V_127 ;
if ( F_218 ( V_127 , V_206 ) )
return - V_319 ;
...
if ( F_140 ( V_127 , V_206 ) )
return - V_319 ;
if ( F_225 ( V_317 , & V_318 , V_127 ) )
return - V_319 ;
return 0 ;
}
...
{
if ( V_315 == V_333 || V_315 == V_334 )
return F_223 ( V_7 , V_315 , V_316 , V_317 , V_206 ) ;
return F_227 ( V_7 , V_315 , V_316 , V_317 , V_206 ) ;
}
...
if ( V_315 == V_333 || V_315 == V_334 )
return F_223 ( V_7 , V_315 , V_316 , V_317 , V_206 ) ;
return F_229 ( V_7 , V_315 , V_316 , V_317 , V_206 ) ;
}
unsigned int F_230 ( struct V_335 * V_335 , struct V_336 * V_6 , T_10 * V_337 )
{
unsigned int V_33 = F_231 ( V_335 , V_6 , V_337 ) ;
struct V_6 * V_7 = V_6 -> V_7 ;
F_232 ( V_7 ) ;
if ( ( V_33 & V_338 ) && ! ( V_335 -> V_339 & V_340 ) &&
! ( V_7 -> V_341 & V_342 ) && ! F_126 ( V_7 ) )
V_33 &= ~ ( V_343 | V_338 ) ;
return V_33 ;
}
static struct V_6 * F_233 ( struct V_344 * V_345 , int V_346 )
{
struct V_6 * V_7 ;
struct V_347 * V_348 = V_345 -> V_349 ;
struct V_1 * V_1 = F_234 ( V_345 ) ;
...
static struct V_6 * F_236 ( struct V_344 * V_345 , struct V_6 * V_7 )
{
struct V_347 * V_348 = V_345 -> V_349 ;
struct V_1 * V_1 = F_234 ( V_345 ) ;
do {
...
return F_233 ( V_345 , V_348 -> V_350 + 1 ) ;
}
return V_7 ;
}
static struct V_6 * F_237 ( struct V_344 * V_345 , T_11 V_352 )
{
struct V_6 * V_7 = F_233 ( V_345 , 0 ) ;
if ( V_7 )
while ( V_352 && ( V_7 = F_236 ( V_345 , V_7 ) ) != NULL )
-- V_352 ;
return V_352 ? NULL : V_7 ;
}
static void * F_238 ( struct V_344 * V_345 , T_11 * V_352 )
{
struct V_347 * V_348 = V_345 -> V_349 ;
V_348 -> V_350 = V_353 ;
return * V_352 ? F_237 ( V_345 , * V_352 - 1 ) : V_354 ;
}
static void * F_239 ( struct V_344 * V_345 , void * V_355 , T_11 * V_352 )
{
struct V_6 * V_7 ;
if ( V_355 == V_354 )
V_7 = F_237 ( V_345 , 0 ) ;
else
V_7 = F_236 ( V_345 , V_355 ) ;
++ * V_352 ;
return V_7 ;
}
static void F_240 ( struct V_344 * V_345 , void * V_355 )
{
struct V_347 * V_348 = V_345 -> V_349 ;
if ( V_348 -> V_350 <= V_348 -> V_22 -> V_33 )
F_23 ( & V_348 -> V_22 -> V_75 [ V_348 -> V_350 ] . V_19 ) ;
}
int F_241 ( struct V_356 * V_356 , struct V_335 * V_335 )
{
struct V_357 * V_358 = F_242 ( V_356 ) ;
struct V_347 * V_89 ;
int V_97 ;
V_97 = F_243 ( V_356 , V_335 , & V_358 -> V_359 ,
sizeof( struct V_347 ) ) ;
if ( V_97 < 0 )
return V_97 ;
...
int F_244 ( struct V_1 * V_1 , struct V_357 * V_358 )
{
struct V_361 * V_362 ;
int V_276 = 0 ;
V_358 -> V_359 . V_346 = F_238 ;
V_358 -> V_359 . V_139 = F_239 ;
V_358 -> V_359 . V_363 = F_240 ;
V_362 = F_245 ( V_358 -> V_364 , V_365 , V_1 -> V_366 ,
V_358 -> V_367 , V_358 ) ;
if ( ! V_362 )
V_276 = - V_277 ;
return V_276 ;
}
void F_246 ( struct V_1 * V_1 , struct V_357 * V_358 )
{
F_247 ( V_358 -> V_364 , V_1 -> V_366 ) ;
}
static void F_248 ( struct V_6 * V_368 , struct V_344 * V_369 ,
int V_350 )
{
...
F_250 ( V_368 ) ,
0 , 0L , 0 ,
F_251 ( F_252 ( V_369 ) , F_3 ( V_368 ) ) ,
0 , F_253 ( V_368 ) ,
F_254 ( & V_368 -> V_77 ) , V_368 ,
F_254 ( & V_368 -> V_243 ) ) ;
}
int F_255 ( struct V_344 * V_345 , void * V_355 )
{
F_256 ( V_345 , 127 ) ;
if ( V_355 == V_354 )
F_257 ( V_345 , L_11
...
static int T_14 F_265 ( char * V_374 )
{
T_15 V_235 ;
if ( ! V_374 )
return 0 ;
V_235 = F_266 ( V_374 , 0 , & V_375 ) ;
if ( V_235 )
return 0 ;
...
void T_14 F_267 ( struct V_22 * V_377 , const char * V_364 )
{
unsigned int V_292 ;
V_377 -> V_75 = F_268 ( V_364 ,
2 * sizeof( struct V_3 ) ,
V_375 ,
21 ,
0 ,
...
F_269 ( & V_377 -> V_75 [ V_292 ] . V_43 , V_292 ) ;
V_377 -> V_75 [ V_292 ] . V_36 = 0 ;
F_270 ( & V_377 -> V_75 [ V_292 ] . V_19 ) ;
}
for ( V_292 = 0 ; V_292 <= V_377 -> V_33 ; V_292 ++ ) {
F_269 ( & V_377 -> V_78 [ V_292 ] . V_43 , V_292 ) ;
V_377 -> V_78 [ V_292 ] . V_36 = 0 ;
F_270 ( & V_377 -> V_78 [ V_292 ] . V_19 ) ;
}
}
...
T_16 V_383 )
{
struct V_80 * V_384 = F_275 ( - V_186 ) ;
T_8 V_385 = V_81 -> V_386 ;
int V_387 = V_81 -> V_387 ;
int V_388 = F_276 ( V_81 ) - F_78 ( V_81 ) ;
T_4 V_389 = V_81 -> V_389 ;
T_16 V_390 ;
int V_391 ;
if ( F_46 ( ! F_201 ( V_81 , V_388 ) ) )
goto V_105;
V_81 -> V_392 = 0 ;
F_277 ( V_81 , V_388 ) ;
F_278 ( V_81 ) ;
F_279 ( V_81 , F_280 ( V_81 ) ) ;
V_81 -> V_387 = F_280 ( V_81 ) ;
V_81 -> V_389 = F_85 ( V_393 ) ;
V_390 = V_81 -> V_84 -> V_394 & F_281 ( V_81 ) ;
V_384 = F_282 ( V_81 , V_390 ) ;
if ( ! V_384 || F_110 ( V_384 ) ) {
F_283 ( V_81 , V_389 , V_388 , V_385 ,
V_387 ) ;
goto V_105;
}
V_391 = F_284 ( V_81 ) ;
...
V_81 -> V_127 - V_395 ,
V_138 , 0 ) ;
V_93 -> V_137 = F_288 ( F_82 ( V_81 , V_395 ,
V_81 -> V_127 - V_395 , 0 ) ) ;
if ( V_93 -> V_137 == 0 )
V_93 -> V_137 = V_142 ;
} else if ( V_389 == F_85 ( V_397 ) ) {
struct V_398 * V_399 = F_289 ( V_81 ) ;
V_52 V_127 = V_81 -> V_127 - V_395 ;
V_93 -> V_137 = ~ F_290 ( & V_399 -> V_49 , & V_399 -> V_57 ,
V_127 , V_138 , 0 ) ;
V_93 -> V_137 = F_288 ( F_82 ( V_81 , V_395 , V_127 , 0 ) ) ;
if ( V_93 -> V_137 == 0 )
V_93 -> V_137 = V_142 ;
V_81 -> V_140 = V_141 ;
}
