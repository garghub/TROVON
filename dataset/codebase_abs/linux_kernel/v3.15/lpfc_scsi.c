...
V_370 = F_101 ( V_13 ) ;
if ( V_370 < V_5 -> V_542 )
V_524 -> V_119 . V_68 . V_248 . V_545 = V_370 ;
else
V_524 -> V_119 . V_68 . V_248 . V_545 =
V_5 -> V_542 ;
}
V_127 -> V_546 = V_547 ;
V_8 -> V_548 ++ ;
...
V_41 = & V_119 -> V_119 ;
V_600 = & V_599 -> V_119 ;
V_600 -> V_68 . V_608 . V_609 = V_610 ;
V_600 -> V_68 . V_608 . V_611 = V_41 -> V_488 ;
if ( V_8 -> V_148 == V_487 )
V_600 -> V_68 . V_608 . V_612 = V_119 -> V_182 ;
else
V_600 -> V_68 . V_608 . V_612 = V_41 -> V_489 ;
V_600 -> V_156 = 1 ;
V_600 -> V_159 = V_41 -> V_159 ;
V_599 -> V_613 = V_119 -> V_613 ;
V_599 -> V_135 |= V_614 ;
if ( F_172 ( V_8 ) )
V_600 -> V_538 = V_615 ;
else
...
static int
F_176 ( struct V_4 * V_5 , struct V_31 * V_32 )
{
struct V_128 * V_423 = V_32 -> V_128 ;
T_1 V_627 ;
T_1 V_628 ;
...
static int
F_177 ( struct V_4 * V_5 , struct V_1 * V_38 ,
unsigned V_633 , unsigned int V_634 ,
V_221 V_562 )
{
struct V_12 * V_8 = V_5 -> V_8 ;
struct V_31 * V_32 ;
...
if ( V_32 == NULL )
return V_604 ;
V_32 -> V_561 = V_8 -> V_636 ;
V_32 -> V_38 = V_38 ;
V_161 = F_155 ( V_5 , V_32 , V_634 ,
V_562 ) ;
if ( ! V_161 ) {
F_91 ( V_8 , V_32 ) ;
return V_604 ;
...
L_134
L_135 ,
F_175 ( V_562 ) , V_633 , V_634 ,
V_40 -> V_554 , V_40 -> V_543 , V_175 -> V_182 ,
V_175 -> V_135 ) ;
V_161 = F_179 ( V_8 , V_585 ,
V_175 , V_635 , V_32 -> V_561 ) ;
if ( ( V_161 != V_637 ) ||
( V_635 -> V_119 . V_476 != V_162 ) ) {
F_31 ( V_5 , V_20 , V_97 ,
L_136
L_137 ,
F_175 ( V_562 ) ,
V_633 , V_634 , V_635 -> V_119 . V_476 ,
V_635 -> V_119 . V_68 . V_474 [ 4 ] ,
V_175 -> V_135 ) ;
if ( V_161 == V_637 ) {
if ( V_635 -> V_119 . V_476 == V_485 )
V_294 = F_176 ( V_5 , V_32 ) ;
else
V_294 = V_604 ;
} else if ( V_161 == V_638 ) {
V_294 = V_639 ;
...
static int
F_180 ( struct V_4 * V_5 , struct V_13 * V_14 )
{
struct V_1 * V_38 ;
struct V_39 * V_40 ;
unsigned long V_640 ;
...
V_40 = V_38 -> V_40 ;
V_640 = F_149 ( 2 * V_5 -> V_619 * 1000 ) + V_49 ;
while ( F_148 ( V_640 , V_49 ) ) {
if ( ! V_40 || ! F_24 ( V_40 ) )
return V_604 ;
if ( V_40 -> V_509 == V_510 )
return V_601 ;
...
static int
F_182 ( struct V_4 * V_5 , T_4 V_633 ,
T_6 V_634 , T_8 V_641 )
{
struct V_12 * V_8 = V_5 -> V_8 ;
unsigned long V_640 ;
int V_642 ;
V_642 = F_183 ( V_5 , V_633 , V_634 , V_641 ) ;
if ( V_642 )
F_184 ( V_5 , & V_8 -> V_179 . V_180 [ V_8 -> V_179 . V_643 ] ,
V_633 , V_634 , V_641 ) ;
V_640 = F_149 ( 2 * V_5 -> V_619 * 1000 ) + V_49 ;
while ( F_148 ( V_640 , V_49 ) && V_642 ) {
F_181 ( F_149 ( 20 ) ) ;
V_642 = F_183 ( V_5 , V_633 , V_634 , V_641 ) ;
}
if ( V_642 ) {
...
struct V_1 * V_38 ;
struct V_39 * V_40 ;
unsigned V_633 = V_14 -> V_26 -> V_462 ;
unsigned int V_634 = V_14 -> V_26 -> V_63 ;
struct V_647 V_70 ;
int V_161 ;
V_38 = F_1 ( V_14 -> V_26 ) ;
if ( ! V_38 ) {
...
F_186 ( V_45 , F_187 () ,
sizeof( V_70 ) , ( char * ) & V_70 , V_649 ) ;
V_161 = F_177 ( V_5 , V_38 , V_633 , V_634 ,
V_623 ) ;
F_31 ( V_5 , V_20 , V_97 ,
L_146
L_147 , V_633 , V_634 , V_161 ) ;
if ( V_161 == V_601 )
V_161 = F_182 ( V_5 , V_633 , V_634 ,
V_644 ) ;
return V_161 ;
}
static int
...
V_70 . V_73 = V_652 ;
V_70 . V_63 = 0 ;
memcpy ( V_70 . V_75 , & V_5 -> V_653 , sizeof( struct V_77 ) ) ;
memcpy ( V_70 . V_78 , & V_5 -> V_654 , sizeof( struct V_77 ) ) ;
F_186 ( V_45 , F_187 () ,
sizeof( V_70 ) , ( char * ) & V_70 , V_649 ) ;
V_161 = F_170 ( V_14 ) ;
if ( V_161 != 0 && V_161 != V_601 )
return V_161 ;
for ( V_47 = 0 ; V_47 < V_655 ; V_47 ++ ) {
V_651 = 0 ;
F_79 ( V_45 -> V_51 ) ;
...
if ( ! V_651 )
continue;
V_161 = F_177 ( V_5 , V_62 -> V_114 -> V_658 ,
V_47 , 0 , V_624 ) ;
if ( V_161 != V_601 ) {
F_31 ( V_5 , V_20 , V_97 ,
L_151 ,
...
return - V_665 ;
if ( V_8 -> V_9 ) {
F_199 ( V_114 -> V_666 , V_664 . V_266 . V_267 ) ;
F_20 ( & V_8 -> V_667 , V_43 ) ;
V_663 = F_200 ( V_8 ,
& V_8 -> V_668 ,
& V_5 -> V_653 ,
...
return - V_669 ;
F_20 ( & V_8 -> V_667 , V_43 ) ;
F_25 ( & V_663 -> V_670 , & V_8 -> V_668 ) ;
}
V_663 -> V_11 = V_114 -> V_658 ;
V_663 -> V_671 = true ;
F_21 ( & V_8 -> V_667 , V_43 ) ;
V_3 -> V_7 = V_663 ;
} else {
...
V_662 = F_202 ( & V_8 -> V_662 ) ;
V_660 = V_8 -> V_672 ;
V_115 = V_5 -> V_673 + 2 ;
if ( ( V_662 * ( V_5 -> V_673 + 2 ) ) < V_660 )
return 0 ;
if ( V_660 >= V_8 -> V_674 - V_675 ) {
F_31 ( V_5 , V_96 , V_97 ,
L_155
L_156 , V_660 ) ;
return 0 ;
...
V_115 , V_8 -> V_674 ,
( V_8 -> V_674 - V_660 ) ) ;
V_115 = V_8 -> V_674 - V_660 ;
}
V_661 = F_85 ( V_5 , V_115 ) ;
if ( V_115 != V_661 ) {
F_31 ( V_5 , V_20 , V_97 ,
L_160
L_161
...
struct V_10 *
F_201 ( struct V_12 * V_8 , struct V_77 * V_676 ,
struct V_77 * V_664 , T_6 V_63 ,
bool V_677 )
{
struct V_10 * V_678 ;
int V_679 ;
if ( F_95 ( ! V_8 ) || ! V_676 || ! V_664 ||
! ( V_8 -> V_9 ) )
return NULL ;
if ( V_677 )
V_679 = V_680 ;
...
V_679 = V_130 ;
V_678 = F_206 ( V_8 -> V_681 , V_679 ) ;
if ( ! V_678 )
return NULL ;
F_87 ( & V_678 -> V_670 ) ;
V_678 -> V_11 = NULL ;
memcpy ( & V_678 -> V_682 . V_676 , V_676 ,
sizeof( struct V_77 ) ) ;
memcpy ( & V_678 -> V_682 . V_664 , V_664 ,
sizeof( struct V_77 ) ) ;
V_678 -> V_682 . V_63 = V_63 ;
V_678 -> V_417 = false ;
V_678 -> V_671 = false ;
return V_678 ;
}
void
F_205 ( struct V_12 * V_8 ,
struct V_10 * V_678 )
{
if ( F_95 ( ! V_8 ) || ! V_678 ||
! ( V_8 -> V_9 ) )
...
if ( ! F_66 ( & V_678 -> V_670 ) )
F_65 ( & V_678 -> V_670 ) ;
F_207 ( V_678 , V_8 -> V_681 ) ;
return;
}
struct V_10 *
F_200 ( struct V_12 * V_8 , struct V_191 * V_183 ,
struct V_77 * V_676 ,
struct V_77 * V_664 , T_6 V_63 )
{
struct V_10 * V_678 ;
if ( F_95 ( ! V_8 ) || ! V_183 || ! V_676 || ! V_664 ||
! V_8 -> V_9 )
return NULL ;
F_190 (lun_info, list, listentry) {
if ( ( memcmp ( & V_678 -> V_682 . V_676 , V_676 ,
sizeof( struct V_77 ) ) == 0 ) &&
( memcmp ( & V_678 -> V_682 . V_664 , V_664 ,
sizeof( struct V_77 ) ) == 0 ) &&
( V_678 -> V_682 . V_63 == V_63 ) )
return V_678 ;
}
...
bool
F_208 ( struct V_12 * V_8 , struct V_77 * V_676 ,
struct V_77 * V_664 , T_6 * V_683 ,
struct V_77 * V_684 ,
struct V_77 * V_685 ,
T_6 * V_686 ,
T_1 * V_687 )
...
* V_683 = V_689 ;
F_20 ( & V_8 -> V_667 , V_43 ) ;
F_190 (lun_info, &phba->luns, listentry) {
if ( ( ( F_209 ( V_676 -> V_266 . V_267 ) == 0 ) ||
( memcmp ( & V_678 -> V_682 . V_676 , V_676 ,
sizeof( struct V_77 ) ) == 0 ) ) &&
( ( F_209 ( V_664 -> V_266 . V_267 ) == 0 ) ||
( memcmp ( & V_678 -> V_682 . V_664 , V_664 ,
sizeof( struct V_77 ) ) == 0 ) ) &&
( V_678 -> V_417 ) ) {
V_682 = & V_678 -> V_682 ;
...
* V_683 = V_682 -> V_63 ;
memcpy ( V_676 , & V_682 -> V_676 ,
sizeof( struct V_77 ) ) ;
memcpy ( V_664 , & V_682 -> V_664 ,
sizeof( struct V_77 ) ) ;
break;
}
}
...
bool
F_210 ( struct V_12 * V_8 , struct V_77 * V_676 ,
struct V_77 * V_664 , T_6 V_63 )
{
struct V_10 * V_678 ;
unsigned long V_43 ;
...
return false ;
F_20 ( & V_8 -> V_667 , V_43 ) ;
V_678 = F_200 ( V_8 , & V_8 -> V_668 , V_676 ,
V_664 , V_63 ) ;
if ( V_678 ) {
if ( ! V_678 -> V_417 )
V_678 -> V_417 = true ;
...
V_678 = F_201 ( V_8 , V_676 , V_664 , V_63 ,
false ) ;
if ( V_678 ) {
V_678 -> V_417 = true ;
V_678 -> V_671 = false ;
F_25 ( & V_678 -> V_670 , & V_8 -> V_668 ) ;
F_21 ( & V_8 -> V_667 , V_43 ) ;
return true ;
}
F_21 ( & V_8 -> V_667 , V_43 ) ;
...
bool
F_211 ( struct V_12 * V_8 , struct V_77 * V_676 ,
struct V_77 * V_664 , T_6 V_63 )
{
struct V_10 * V_678 ;
unsigned long V_43 ;
