...
static void F_31 ( struct V_1 * V_90 ,
struct V_3 * V_4 )
{
T_3 * V_95 = ( T_3 * ) V_4 -> V_92 ;
switch ( * V_95 ) {
case 0x33221199 :
{
struct V_96 * V_97 ;
V_97 = (struct V_96 * ) V_4 -> V_92 ;
F_14 ( V_90 -> V_59 , L_9
L_10 ,
V_97 -> V_98 , V_97 -> V_99 ,
V_97 -> V_100 ) ;
...
void F_32 ( struct V_1 * V_90 ,
struct V_3 * V_4 , T_4 V_5 , T_2 V_63 )
{
struct V_8 * V_41 ;
enum V_19 V_7 ;
struct V_10 * V_11 ;
...
if ( V_7 == V_22 ) {
if ( V_41 -> V_6 & V_103 ) {
if ( F_33 ( * ( V_104 * ) V_4 -> V_92 ) == 0x00C60000 )
...
if ( V_41 -> V_6 & V_103 )
F_34 ( V_4 , V_5 - V_41 -> V_107 [ 0 ] ) ;
F_29 ( V_4 , sizeof( struct V_8 ) ) ;
V_11 = & V_90 -> V_11 [ V_7 ] ;
if ( V_11 -> V_49 . V_108 )
V_11 -> V_49 . V_108 ( V_11 -> V_49 . V_94 ,
V_4 , V_7 ) ;
}
}
struct V_1 * F_35 ( void * V_109 ,
struct V_110 * V_15 ,
struct V_111 * V_59 )
{
struct V_10 * V_11 ;
struct V_1 * V_2 ;
V_2 = F_36 ( sizeof( struct V_1 ) , V_112 ) ;
if ( ! V_2 )
return NULL ;
F_37 ( & V_2 -> V_40 ) ;
F_37 ( & V_2 -> V_52 ) ;
...
V_2 -> V_59 = V_59 ;
V_11 = & V_2 -> V_11 [ V_22 ] ;
V_11 -> V_18 = V_15 -> V_113 ;
V_11 -> V_50 = V_15 -> V_114 ;
F_38 ( & V_2 -> V_39 , 0 ) ;
return V_2 ;
}
void F_39 ( struct V_1 * V_115 )
{
F_40 ( V_115 ) ;
}
int F_41 ( struct V_1 * V_2 ,
struct V_111 * V_59 , T_1 V_116 ,
char * V_117 , T_4 V_118 )
{
if ( F_42 ( V_2 , V_59 , V_116 , V_117 , V_118 ) ) {
F_43 ( L_13 ) ;
return - V_119 ;
}
return 0 ;
}
void F_44 ( struct V_1 * V_2 , bool V_120 )
{
if ( V_2 )
F_45 ( V_2 , V_120 ) ;
}
