...
{
struct V_3 * V_4 = F_30 ( V_46 ) ;
struct V_51 * V_52 = V_46 -> V_8 . V_53 ;
struct V_12 * V_14 ;
int V_54 ;
V_54 = F_35 ( V_52 , 0 ) ;
if ( ! F_4 ( V_54 ) ) {
...
struct V_3 * V_4 ;
int V_15 ;
V_4 = F_40 ( & V_46 -> V_8 , sizeof( * V_4 ) , V_56 ) ;
if ( ! V_4 )
return - V_57 ;
F_41 ( V_46 , V_4 ) ;
F_42 ( & V_4 -> V_10 ) ;
...
V_15 = F_43 ( & V_46 -> V_8 , V_4 -> V_20 ,
V_58 , L_7 ) ;
if ( V_15 )
goto V_59;
if ( F_4 ( V_4 -> V_9 ) ) {
V_15 = F_43 ( & V_46 -> V_8 , V_4 -> V_9 ,
V_58 , L_8 ) ;
if ( V_15 )
goto V_59;
}
V_15 = F_43 ( & V_46 -> V_8 , V_4 -> V_6 ,
V_60 , L_9 ) ;
if ( V_15 )
goto V_59;
V_15 = F_44 ( & V_46 -> V_8 , F_45 ( V_4 -> V_6 ) ,
NULL , F_1 ,
V_61 | V_62 |
V_63 , L_10 , V_4 ) ;
if ( V_15 )
...
static int T_3 F_48 ( struct V_45 * V_46 )
{
struct V_3 * V_4 = F_30 ( V_46 ) ;
