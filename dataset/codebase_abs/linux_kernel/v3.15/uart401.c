...
int F_26 ( struct V_36 * V_37 , struct V_38 * V_39 )
{
T_1 * V_1 ;
char * V_40 = L_5 ;
int V_32 = 0 ;
...
F_25 ( F_9 ( L_6 ) ) ;
V_37 -> V_41 [ 4 ] = - 1 ;
if ( ! F_27 ( V_37 -> V_42 , 4 , L_7 ) ) {
F_9 ( V_43 L_8 , V_37 -> V_42 ) ;
return 0 ;
}
V_1 = F_28 ( sizeof( T_1 ) , V_44 ) ;
if ( ! V_1 ) {
F_9 ( V_15 L_9 ) ;
goto V_45;
}
...
V_1 -> V_47 = 0 ;
if ( ! V_1 -> V_47 )
if ( F_30 ( V_1 -> V_17 , F_10 , 0 , L_7 , V_1 ) < 0 ) {
F_9 ( V_15 L_10 , V_1 -> V_17 ) ;
V_1 -> V_47 = 1 ;
}
V_1 -> V_14 = F_31 () ;
F_14 ( V_1 ) ;
