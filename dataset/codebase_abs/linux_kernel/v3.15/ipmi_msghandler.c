...
if ( V_95 ) {
F_68 (KERN_ERR PFX L_94 ) ;
return V_95 ;
}
F_68 ( V_289 L_95
V_379 L_4 ) ;
#ifdef F_98
V_237 = F_102 ( L_96 , NULL ) ;
if ( ! V_237 ) {
F_68 (KERN_ERR PFX L_97 ) ;
return - V_48 ;
}
#endif
F_196 ( & V_350 , F_176 , 0 ) ;
...
V_382 = F_177 ( & V_353 ) ;
if ( V_382 != 0 )
F_68 (KERN_WARNING PFX L_98 ,
count) ;
V_382 = F_177 ( & V_356 ) ;
if ( V_382 != 0 )
F_68 (KERN_WARNING PFX L_99 ,
count) ;
}
