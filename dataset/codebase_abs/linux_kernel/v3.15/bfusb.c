...
const unsigned char * V_78 , int V_60 )
{
unsigned char * V_41 ;
int V_11 , V_12 , V_13 , V_36 , V_69 = 0 ;
F_2 ( L_21 , V_3 , V_3 -> V_16 ) ;
F_48 ( L_22 ) ;
V_41 = F_49 ( V_76 + 3 , V_79 ) ;
if ( ! V_41 ) {
F_14 ( L_23 ) ;
return - V_15 ;
}
V_12 = F_50 ( V_3 -> V_16 , 0 ) ;
if ( F_51 ( V_3 -> V_16 , V_12 , V_80 ,
0 , 1 , 0 , NULL , 0 , V_81 ) < 0 ) {
F_14 ( L_24 ) ;
F_52 ( V_41 ) ;
return - V_70 ;
...
V_12 = F_11 ( V_3 -> V_16 , V_3 -> V_17 ) ;
while ( V_60 ) {
V_36 = F_45 ( V_75 , V_60 , V_76 + 3 ) ;
memcpy ( V_41 , V_78 + V_69 , V_36 ) ;
...
V_3 = F_56 ( & V_85 -> V_28 , sizeof( struct V_2 ) , V_79 ) ;
if ( ! V_3 ) {
F_14 ( L_31 ) ;
goto V_94;
}
...
V_3 -> V_77 = F_57 ( V_17 -> V_91 . V_96 ) ;
F_58 ( & V_3 -> V_35 ) ;
V_3 -> V_42 = NULL ;
F_59 ( & V_3 -> V_26 ) ;
F_59 ( & V_3 -> V_9 ) ;
F_59 ( & V_3 -> V_6 ) ;
if ( F_60 ( & V_78 , L_32 , & V_16 -> V_28 ) < 0 ) {
F_14 ( L_33 ) ;
goto V_94;
}
F_2 ( L_34 , V_78 -> V_3 , V_78 -> V_36 ) ;
if ( F_47 ( V_3 , V_78 -> V_3 , V_78 -> V_36 ) < 0 ) {
F_14 ( L_35 ) ;
goto V_97;
}
F_61 ( V_78 ) ;
