...
static void F_97 ( const struct V_128 * V_129 , void * V_4 )
{
...
V_10 -> V_11 = F_98 ( V_10 , & V_131 ,
& V_10 -> V_18 -> V_67 ) ;
if ( V_10 -> V_11 == NULL )
goto V_132;
V_10 -> V_110 = V_129 -> V_20 ;
V_10 -> V_111 = V_129 -> V_133 ;
V_15 = F_90 ( V_10 ) ;
if ( V_15 )
goto V_134;
V_15 = F_99 ( V_10 -> V_11 ,
...
static int F_102 ( struct V_140 * V_135 )
{
struct V_141 * V_18 = F_103 ( V_135 ) ;
struct V_142 * V_143 = & V_135 -> V_144 [ 0 ] ;
struct V_145 * V_146 ;
unsigned char * V_3 ;
T_3 V_147 ;
int V_148 ;
for ( V_148 = 1 ; V_148 >= 0 ; V_148 -- ) {
V_146 = & V_143 -> V_146 [ V_148 ] . V_149 ;
if ( F_104 ( V_146 ) &&
F_105 ( V_146 ) ) {
V_147 = V_146 -> V_150 ;
break;
...
V_3 [ 19 ] = 0x2 ;
F_89 ( & V_18 -> V_67 , L_9 ) ;
V_148 = F_106 ( V_18 , F_23 ( V_18 , V_147 ) ,
V_3 , 31 , NULL , 2000 ) ;
F_3 ( V_3 ) ;
if ( V_148 )
return V_148 ;
...
static int F_108 ( struct V_140 * V_135 ,
const struct V_118 * V_151 )
{
struct V_141 * V_18 = F_103 ( V_135 ) ;
struct V_13 * V_10 ;
int V_15 = 0 ;
if ( V_151 -> V_119 == V_152 )
return F_102 ( V_135 ) ;
...
V_10 -> V_124 = V_156 ;
V_15 = F_112 ( V_157 , true , V_10 -> V_124 ,
& V_10 -> V_18 -> V_67 , V_16 ,
V_10 , F_97 ) ;
if ( V_15 ) {
F_49 ( & V_10 -> V_18 -> V_67 ,
...
static void F_114 ( struct V_141 * V_18 )
{
T_5 V_159 = 0xffffffff ;
void * V_49 ;
int V_15 ;
V_49 = F_115 ( & V_159 , 4 , V_16 ) ;
if ( ! V_49 )
return;
...
static void F_117 ( struct V_140 * V_135 )
{
struct V_141 * V_18 = F_103 ( V_135 ) ;
struct V_13 * V_10 = F_63 ( V_135 ) ;
bool V_160 = ( V_18 -> V_161 == V_162 ) ? true : false ;
if ( ! V_10 )
return;
F_118 ( & V_10 -> V_127 ) ;
if ( V_10 -> V_26 & V_139 ) {
F_119 ( V_10 -> V_11 , V_160 ) ;
F_101 ( V_10 -> V_11 ) ;
F_91 ( V_10 ) ;
}
F_107 ( V_135 , NULL ) ;
if ( ! V_160 && ( V_10 -> V_26 & V_139 ) )
F_114 ( V_18 ) ;
F_3 ( V_10 ) ;
F_89 ( & V_18 -> V_67 , L_13 ) ;
F_113 ( V_18 ) ;
}
static int F_120 ( struct V_140 * V_135 ,
T_6 V_163 )
{
struct V_13 * V_10 = F_63 ( V_135 ) ;
if ( ! ( V_10 -> V_26 & V_64 ) )
...
static int F_122 ( struct V_140 * V_135 )
{
struct V_13 * V_10 = F_63 ( V_135 ) ;
struct V_164 * V_11 = V_10 -> V_11 ;
int V_15 ;
