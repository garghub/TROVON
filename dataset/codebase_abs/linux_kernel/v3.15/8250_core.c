...
F_42 ( V_6 , V_107 ) ;
if ( V_6 -> V_2 . type == V_45 ) {
unsigned int V_336 = ( V_2 -> V_59 * 2 ) / V_294 ;
T_3 V_107 = V_336 / 32 ;
T_4 V_337 = F_146 ( V_336 % 32 , 2 ) ;
F_42 ( V_6 , V_107 ) ;
F_68 ( V_2 , 0x2 , V_337 & 0xf ) ;
}
if ( V_2 -> type == V_112 )
F_68 ( V_2 , V_38 , V_42 ) ;
F_68 ( V_2 , V_30 , V_299 ) ;
...
{
if ( V_2 -> V_338 )
V_2 -> V_338 ( V_2 , V_297 , V_298 ) ;
else
F_140 ( V_2 , V_297 , V_298 ) ;
}
static void
F_150 ( struct V_1 * V_2 , int V_339 )
{
if ( V_339 == V_340 ) {
V_2 -> V_102 |= V_341 ;
F_71 ( V_2 ) ;
...
{
if ( V_2 -> V_343 )
V_2 -> V_343 ( V_2 , V_183 , V_342 ) ;
else
F_151 ( V_2 , V_183 , V_342 ) ;
}
static unsigned int F_153 ( struct V_5 * V_344 )
{
if ( V_344 -> V_2 . V_20 == V_26 )
return 0x1000 ;
if ( F_154 ( V_344 ) )
...
if ( ! V_2 -> V_124 )
break;
if ( ! F_156 ( V_2 -> V_124 , V_345 , L_23 ) ) {
V_213 = - V_347 ;
break;
}
if ( V_2 -> V_102 & V_348 ) {
V_2 -> V_14 = F_157 ( V_2 -> V_124 , V_345 ) ;
if ( ! V_2 -> V_14 ) {
F_158 ( V_2 -> V_124 , V_345 ) ;
V_213 = - V_238 ;
}
}
break;
...
static void F_167 ( struct V_1 * V_2 , int V_102 )
{
struct V_5 * V_6 =
F_27 ( V_2 , struct V_5 , V_2 ) ;
int V_118 = V_353 ;
...
static int
F_168 ( struct V_1 * V_2 , struct V_357 * V_358 )
{
if ( V_358 -> V_145 >= V_359 || V_358 -> V_145 < 0 ||
V_358 -> V_360 < 9600 || V_358 -> type < V_129 ||
V_358 -> type >= F_169 ( V_43 ) || V_358 -> type == V_361 ||
V_358 -> type == V_362 )
return - V_352 ;
return 0 ;
}
...
void F_171 (
void (* F_172)( int V_2 , struct V_1 * V_6 , unsigned short * V_36 ) )
{
V_363 = F_172 ;
}
...
if ( V_366 > V_367 )
V_366 = V_367 ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ ) {
struct V_5 * V_6 = & V_368 [ V_132 ] ;
struct V_1 * V_2 = & V_6 -> V_2 ;
V_2 -> line = V_132 ;
F_110 ( & V_2 -> V_62 ) ;
F_174 ( & V_6 -> V_241 ) ;
...
if ( V_372 )
V_365 = V_233 ;
for ( V_132 = 0 , V_6 = V_368 ;
V_132 < F_169 ( V_373 ) && V_132 < V_366 ;
V_132 ++ , V_6 ++ ) {
struct V_1 * V_2 = & V_6 -> V_2 ;
V_2 -> V_17 = V_373 [ V_132 ] . V_2 ;
V_2 -> V_145 = F_175 ( V_373 [ V_132 ] . V_145 ) ;
V_2 -> V_239 = V_373 [ V_132 ] . V_239 ;
V_2 -> V_59 = V_373 [ V_132 ] . V_360 * 16 ;
V_2 -> V_102 = V_373 [ V_132 ] . V_102 ;
V_2 -> V_16 = V_373 [ V_132 ] . V_16 ;
V_2 -> V_14 = V_373 [ V_132 ] . V_374 ;
V_2 -> V_20 = V_373 [ V_132 ] . V_375 ;
V_2 -> V_13 = V_373 [ V_132 ] . V_376 ;
F_26 ( V_2 ) ;
V_2 -> V_239 |= V_365 ;
if ( V_363 != NULL )
V_363 ( V_132 , & V_6 -> V_2 , & V_6 -> V_36 ) ;
}
}
static void
F_176 ( struct V_5 * V_6 , unsigned int type )
{
V_6 -> V_2 . type = type ;
if ( ! V_6 -> V_2 . V_135 )
...
static void T_5
F_177 ( struct V_377 * V_378 , struct V_379 * V_380 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ ) {
struct V_5 * V_6 = & V_368 [ V_132 ] ;
...
continue;
V_6 -> V_2 . V_380 = V_380 ;
if ( V_6 -> V_2 . V_102 & V_381 )
F_176 ( V_6 , V_6 -> V_2 . type ) ;
F_178 ( V_378 , & V_6 -> V_2 ) ;
}
}
static void F_179 ( struct V_1 * V_2 , int V_164 )
{
struct V_5 * V_6 =
F_27 ( V_2 , struct V_5 , V_2 ) ;
F_125 ( V_6 , V_208 ) ;
...
static void
F_180 ( struct V_382 * V_383 , const char * V_384 , unsigned int V_69 )
{
struct V_5 * V_6 = & V_368 [ V_383 -> V_385 ] ;
struct V_1 * V_2 = & V_6 -> V_2 ;
unsigned long V_102 ;
unsigned int V_151 ;
int V_386 = 1 ;
...
static int T_5 F_183 ( struct V_382 * V_383 , char * V_389 )
{
struct V_1 * V_2 ;
int V_294 = 9600 ;
int V_265 = 8 ;
int V_176 = 'n' ;
int V_390 = 'n' ;
if ( V_383 -> V_385 >= V_366 )
V_383 -> V_385 = 0 ;
V_2 = & V_368 [ V_383 -> V_385 ] . V_2 ;
if ( ! V_2 -> V_17 && ! V_2 -> V_14 )
return - V_274 ;
if ( V_389 )
F_184 ( V_389 , & V_294 , & V_176 , & V_265 , & V_390 ) ;
return F_185 ( V_2 , V_383 , V_294 , V_176 , V_265 , V_390 ) ;
}
...
int F_190 ( struct V_1 * V_10 )
{
int line ;
struct V_1 * V_2 ;
for ( line = 0 ; line < V_366 ; line ++ ) {
V_2 = & V_368 [ line ] . V_2 ;
if ( F_191 ( V_10 , V_2 ) )
return line ;
}
...
int T_5 F_192 ( struct V_1 * V_2 )
{
struct V_1 * V_10 ;
if ( V_2 -> line >= F_169 ( V_368 ) )
return - V_274 ;
F_173 () ;
V_10 = & V_368 [ V_2 -> line ] . V_2 ;
V_10 -> V_17 = V_2 -> V_17 ;
V_10 -> V_14 = V_2 -> V_14 ;
...
void F_193 ( int line )
{
F_194 ( & V_3 , & V_368 [ line ] . V_2 ) ;
}
void F_195 ( int line )
{
struct V_5 * V_6 = & V_368 [ line ] ;
struct V_1 * V_2 = & V_6 -> V_2 ;
if ( V_6 -> V_36 & V_109 ) {
F_68 ( V_2 , V_30 , 0xE0 ) ;
F_49 ( V_6 ) ;
...
static int F_197 ( struct V_393 * V_380 )
{
struct V_394 * V_10 = F_198 ( & V_380 -> V_380 ) ;
struct V_5 V_395 ;
int V_213 , V_132 , V_365 = 0 ;
memset ( & V_395 , 0 , sizeof( V_395 ) ) ;
if ( V_372 )
V_365 = V_233 ;
for ( V_132 = 0 ; V_10 && V_10 -> V_102 != 0 ; V_10 ++ , V_132 ++ ) {
V_395 . V_2 . V_17 = V_10 -> V_17 ;
V_395 . V_2 . V_14 = V_10 -> V_14 ;
V_395 . V_2 . V_145 = V_10 -> V_145 ;
V_395 . V_2 . V_239 = V_10 -> V_239 ;
V_395 . V_2 . V_59 = V_10 -> V_59 ;
V_395 . V_2 . V_13 = V_10 -> V_13 ;
V_395 . V_2 . V_20 = V_10 -> V_20 ;
V_395 . V_2 . V_102 = V_10 -> V_102 ;
V_395 . V_2 . V_124 = V_10 -> V_124 ;
V_395 . V_2 . V_16 = V_10 -> V_16 ;
V_395 . V_2 . V_392 = V_10 -> V_392 ;
V_395 . V_2 . type = V_10 -> type ;
V_395 . V_2 . F_3 = V_10 -> F_3 ;
V_395 . V_2 . F_5 = V_10 -> F_5 ;
V_395 . V_2 . V_28 = V_10 -> V_28 ;
V_395 . V_2 . V_396 = V_10 -> V_396 ;
V_395 . V_2 . V_338 = V_10 -> V_338 ;
V_395 . V_2 . V_343 = V_10 -> V_343 ;
V_395 . V_2 . V_380 = & V_380 -> V_380 ;
V_395 . V_2 . V_239 |= V_365 ;
V_213 = F_199 ( & V_395 ) ;
if ( V_213 < 0 ) {
F_200 ( & V_380 -> V_380 , L_29
L_30 , V_132 ,
...
static int F_201 ( struct V_393 * V_380 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ ) {
struct V_5 * V_6 = & V_368 [ V_132 ] ;
if ( V_6 -> V_2 . V_380 == & V_380 -> V_380 )
F_202 ( V_132 ) ;
}
return 0 ;
}
static int F_203 ( struct V_393 * V_380 , T_6 V_183 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ ) {
struct V_5 * V_6 = & V_368 [ V_132 ] ;
if ( V_6 -> V_2 . type != V_129 && V_6 -> V_2 . V_380 == & V_380 -> V_380 )
F_194 ( & V_3 , & V_6 -> V_2 ) ;
}
return 0 ;
}
static int F_204 ( struct V_393 * V_380 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ ) {
struct V_5 * V_6 = & V_368 [ V_132 ] ;
...
int V_132 ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ )
if ( F_191 ( & V_368 [ V_132 ] . V_2 , V_2 ) )
return & V_368 [ V_132 ] ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ )
if ( V_368 [ V_132 ] . V_2 . type == V_129 &&
V_368 [ V_132 ] . V_2 . V_17 == 0 )
return & V_368 [ V_132 ] ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ )
if ( V_368 [ V_132 ] . V_2 . type == V_129 )
return & V_368 [ V_132 ] ;
...
F_105 ( & V_398 ) ;
V_395 = F_205 ( & V_6 -> V_2 ) ;
if ( V_395 && V_395 -> V_2 . type != V_273 ) {
if ( V_395 -> V_2 . V_380 )
F_206 ( & V_3 , & V_395 -> V_2 ) ;
V_395 -> V_2 . V_17 = V_6 -> V_2 . V_17 ;
V_395 -> V_2 . V_14 = V_6 -> V_2 . V_14 ;
V_395 -> V_2 . V_145 = V_6 -> V_2 . V_145 ;
V_395 -> V_2 . V_239 = V_6 -> V_2 . V_239 ;
V_395 -> V_2 . V_59 = V_6 -> V_2 . V_59 ;
V_395 -> V_2 . V_135 = V_6 -> V_2 . V_135 ;
V_395 -> V_2 . V_13 = V_6 -> V_2 . V_13 ;
V_395 -> V_2 . V_20 = V_6 -> V_2 . V_20 ;
V_395 -> V_2 . V_102 = V_6 -> V_2 . V_102 | V_399 ;
V_395 -> V_89 = V_6 -> V_89 ;
V_395 -> V_2 . V_124 = V_6 -> V_2 . V_124 ;
V_395 -> V_2 . V_392 = V_6 -> V_2 . V_392 ;
V_395 -> V_2 . V_135 = V_6 -> V_2 . V_135 ;
V_395 -> V_137 = V_6 -> V_137 ;
V_395 -> V_36 = V_6 -> V_36 ;
if ( V_395 -> V_2 . V_135 && ! V_395 -> V_137 )
V_395 -> V_137 = V_395 -> V_2 . V_135 ;
if ( V_6 -> V_2 . V_380 )
V_395 -> V_2 . V_380 = V_6 -> V_2 . V_380 ;
if ( V_6 -> V_2 . V_102 & V_381 )
F_176 ( V_395 , V_6 -> V_2 . type ) ;
F_26 ( & V_395 -> V_2 ) ;
if ( V_6 -> V_2 . F_3 )
...
V_395 -> V_19 = V_6 -> V_19 ;
if ( V_6 -> V_154 )
V_395 -> V_154 = V_6 -> V_154 ;
if ( V_363 != NULL )
V_363 ( 0 , & V_395 -> V_2 ,
& V_395 -> V_36 ) ;
V_213 = F_178 ( & V_3 , & V_395 -> V_2 ) ;
if ( V_213 == 0 )
V_213 = V_395 -> V_2 . line ;
}
F_109 ( & V_398 ) ;
return V_213 ;
}
void F_202 ( int line )
{
struct V_5 * V_395 = & V_368 [ line ] ;
F_105 ( & V_398 ) ;
F_206 ( & V_3 , & V_395 -> V_2 ) ;
if ( V_400 ) {
V_395 -> V_2 . V_102 &= ~ V_399 ;
V_395 -> V_2 . type = V_129 ;
V_395 -> V_2 . V_380 = & V_400 -> V_380 ;
V_395 -> V_36 = V_43 [ V_395 -> V_2 . type ] . V_102 ;
F_178 ( & V_3 , & V_395 -> V_2 ) ;
} else {
V_395 -> V_2 . V_380 = NULL ;
}
F_109 ( & V_398 ) ;
}
...
{
#undef V_408
#define V_408 "8250_core."
F_224 ( V_372 , & V_409 , & V_372 , 0644 ) ;
F_224 ( V_366 , & V_409 , & V_366 , 0644 ) ;
F_224 ( V_289 , & V_409 , & V_289 , 0644 ) ;
#ifdef F_56
F_225 ( V_408 , V_134 ,
& V_410 , . V_411 = & V_412 ,
0444 , - 1 ) ;
