...
struct V_30 * V_31 ;
struct V_73 * V_74 ;
error = F_66 ( V_154 , V_23 , V_163 , V_164 ,
...
struct V_172 * V_174 ;
struct V_172 * V_175 ;
V_173 = F_75 ( V_74 , V_171 -> V_176 [ 0 ] . V_163 , NULL ) ;
if ( V_173 == NULL )
return - V_12 ;
V_174 = F_75 ( V_74 , V_171 -> V_176 [ 1 ] . V_163 , NULL ) ;
if ( V_174 == NULL )
return - V_12 ;
V_175 = F_75 ( V_74 , V_171 -> V_176 [ 2 ] . V_163 , NULL ) ;
if ( V_175 == NULL )
return - V_12 ;
V_75 = F_76 ( V_173 ) ;
if ( V_75 < 0 ) {
...
V_139 = F_77 ( V_173 , 1 ) ;
V_148 = F_77 ( V_173 , 2 ) + 8 ;
V_87 -> V_101 = F_77 ( V_175 , 0 ) - 1 ;
V_87 -> V_91 = F_78 ( V_175 , 0 ) + 1 ;
V_94 = F_79 ( V_173 , 0 ) ;
V_95 = F_80 ( V_173 , 0 ) ;
V_96 = F_80 ( V_173 , 1 ) ;
if ( V_97 > 0 ) {
...
static int F_81 ( struct V_169 * V_177 ,
const struct V_170 * V_171 )
{
struct V_73 * V_74 ;
int V_75 ;
...
if ( ! V_100 )
return - V_103 ;
V_75 = F_66 ( & V_177 -> V_74 -> V_168 , V_23 , V_163 , V_164 ,
sizeof( struct V_30 ) , & V_74 ) ;
if ( V_75 < 0 )
return V_75 ;
V_74 -> V_165 = F_55 ;
V_31 = V_74 -> V_110 ;
V_75 = F_74 ( V_31 , V_177 , V_171 ) ;
if ( V_75 ) {
F_67 ( V_74 ) ;
return V_75 ;
}
...
static void F_83 ( struct V_169 * V_177 )
{
F_67 ( F_84 ( V_177 ) ) ;
F_82 ( V_177 , NULL ) ;
V_156 = 0 ;
