...
if ( V_97 < 10 )
return - V_53 ;
if ( F_14 ( V_90 , V_92 , V_97 - 1 ) )
return - V_29 ;
if ( F_15 ( 0 , V_90 + V_97 - 1 ) )
return - V_29 ;
}
if ( F_14 ( V_90 + V_97 , V_98 , V_96 ) )
return - V_29 ;
return 0 ;
}
...
return - V_53 ;
if ( F_14 ( ( char V_84 V_85 * ) V_46 -> V_112 ,
V_98 + V_24 -> V_108 . V_9 , V_24 -> V_108 . V_109 ) )
return - V_29 ;
...
static void F_24 ( struct V_126 * V_35 ,
struct V_3 * V_24 ,
struct V_3 * V_89 )
{
