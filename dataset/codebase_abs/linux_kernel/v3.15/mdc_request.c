...
return - V_282 ;
V_514 = * ( int * ) V_461 ;
if ( V_514 > exp -> V_123 -> V_20 . V_17 . V_221 )
exp -> V_123 -> V_20 . V_17 . V_221 = V_514 ;
V_515 = V_461 ;
* V_515 = exp -> V_123 -> V_20 . V_17 . V_221 ;
return 0 ;
} else if ( F_170 ( V_516 ) ) {
struct V_22 * V_23 = F_20 ( exp ) ;
struct V_517 * V_348 = V_461 ;
...
struct V_29 * V_30 ;
int V_21 ;
V_3 = F_28 ( F_20 ( exp ) , & V_519 ) ;
if ( V_3 == NULL )
return - V_34 ;
F_29 ( V_3 , & V_41 , V_7 ) ;
V_21 = F_30 ( V_3 , V_32 , V_520 ) ;
if ( V_21 ) {
F_31 ( V_3 ) ;
return V_21 ;
}
...
V_30 = F_2 ( & V_3 -> V_11 , & V_38 ) ;
if ( V_30 == NULL )
GOTO ( V_521 , V_21 = - V_12 ) ;
V_169 -> V_165 = V_30 -> V_169 ;
V_169 -> V_163 = V_164 ;
V_169 -> V_188 = F_78 () ;
if ( V_169 -> V_188 == NULL ) {
F_70 ( V_160 , V_3 , L_72 ) ;
GOTO ( V_521 , V_21 = - V_34 ) ;
}
...
if ( V_17 -> V_531 != NULL )
F_196 ( V_17 -> V_531 ) ;
V_21 = F_197 ( V_208 , V_208 , V_532 , NULL ) ;
break;
}
case V_533 : {
struct V_534 * V_535 = V_208 -> V_536 ;
F_198 ( V_535 , V_537 ) ;
break;
}
case V_538 :
V_21 = F_197 ( V_208 , V_208 , V_539 , NULL ) ;
if ( V_21 == 0 )
V_21 = F_185 ( V_23 ) ;
break;
case V_540 :
V_21 = F_197 ( V_208 , V_208 , V_541 , NULL ) ;
break;
case V_542 :
case V_543 :
break;
...
{
struct V_16 * V_17 = & exp -> V_123 -> V_20 . V_17 ;
struct V_544 * V_545 = V_17 -> V_531 ;
return F_199 ( NULL , V_545 , V_87 ) ;
}
struct V_395 * F_200 ( struct V_1 * exp ) {
struct V_16 * V_17 = & exp -> V_123 -> V_20 . V_17 ;
return & V_17 -> V_396 ;
}
static int F_201 ( struct V_546 * V_547 )
{
if ( V_547 -> V_548 -> V_549 != V_550 )
return 0 ;
if ( V_547 -> V_551 . V_552 . V_553 & V_554 )
return 0 ;
return 1 ;
}
static int F_202 ( struct V_555 * V_556 )
{
if ( V_556 -> V_557 )
V_556 -> V_557 = NULL ;
return 0 ;
}
static int F_203 ( struct V_207 * V_208 , struct V_558 * V_559 )
{
struct V_16 * V_17 = & V_208 -> V_20 . V_17 ;
...
if ( ! V_17 -> V_224 )
GOTO ( V_562 , V_21 = - V_34 ) ;
F_204 ( V_17 -> V_224 ) ;
V_21 = F_206 ( V_208 , V_559 ) ;
if ( V_21 )
GOTO ( V_563 , V_21 ) ;
F_207 ( & V_561 ) ;
F_208 ( V_208 , V_561 . V_564 ) ;
F_209 ( V_208 ) ;
F_210 ( V_208 ) ;
F_211 ( V_208 -> V_536 , F_201 ) ;
V_208 -> V_536 -> V_565 = & V_566 ;
V_21 = F_212 ( V_208 , & V_208 -> V_567 , V_208 , NULL ) ;
if ( V_21 ) {
F_213 ( V_208 ) ;
F_58 ( L_75 ) ;
}
...
static int F_215 ( struct V_1 * exp , int V_568 ,
int V_569 , int V_570 )
{
struct V_207 * V_208 = exp -> V_123 ;
struct V_16 * V_17 = & V_208 -> V_20 . V_17 ;
...
static int F_216 ( struct V_207 * V_208 , enum V_572 V_573 )
{
int V_21 = 0 ;
switch ( V_573 ) {
case V_574 :
...
static int F_223 ( struct V_207 * V_208 , struct V_577 * V_578 ,
struct V_207 * V_579 , int * V_580 )
{
struct V_371 * V_372 ;
int V_21 ;
F_24 ( V_578 == & V_208 -> V_567 ) ;
V_21 = F_224 ( NULL , V_208 , V_578 , V_374 , V_579 ,
& V_581 ) ;
if ( V_21 )
return V_21 ;
V_372 = F_225 ( V_578 , V_374 ) ;
F_226 ( V_372 ) ;
F_139 ( V_372 ) ;
return 0 ;
}
...
{
struct V_558 * V_582 = V_132 ;
struct V_560 V_561 = { 0 } ;
int V_21 = 0 ;
F_207 ( & V_561 ) ;
switch ( V_582 -> V_583 ) {
default:
V_21 = F_230 ( V_584 , V_561 . V_564 ,
V_582 , V_208 ) ;
if ( V_21 > 0 )
V_21 = 0 ;
break;
...
int V_585 )
{
struct V_586 * V_587 = args ;
struct V_29 * V_30 = NULL ;
struct V_8 * V_9 ;
if ( V_585 )
GOTO ( V_37 , V_9 = F_233 ( V_585 ) ) ;
V_30 = F_2 ( & V_3 -> V_11 , & V_38 ) ;
if ( V_30 == NULL )
...
if ( V_3 == NULL )
return - V_34 ;
F_13 ( V_3 , & V_7 -> V_15 . V_591 , V_7 , V_149 , 0 , - 1 , 0 ) ;
F_15 ( V_3 ) ;
F_43 ( sizeof( * V_587 ) <= sizeof( V_3 -> V_592 ) ) ;
V_587 = F_235 ( V_3 ) ;
V_587 -> V_589 = V_7 ;
V_587 -> V_588 = V_590 ;
V_3 -> V_593 = F_232 ;
...
struct V_560 V_561 = { 0 } ;
F_207 ( & V_561 ) ;
V_21 = F_238 ( & V_595 , & V_596 , V_561 . V_597 ,
V_598 , NULL ) ;
return V_21 ;
}
