...
static int F_63 ( struct V_84 * V_123 , struct V_34 * V_35 ,
struct V_64 * V_95 [] , struct V_64 * V_120 [] )
{
struct V_36 * V_37 = F_11 ( V_35 ) ;
if ( V_95 [ V_58 ] ) {
F_57 ( & V_37 -> V_117 ) ;
F_64 ( V_37 , F_39 ( V_95 [ V_58 ] ) ) ;
F_58 ( & V_37 -> V_117 ) ;
}
return F_65 ( V_35 ) ;
}
static T_1 F_66 ( const struct V_34 * V_35 )
{
struct V_70 * V_71 ;
if ( F_67 ( V_35 ) )
V_71 = F_20 ( F_36 ( V_35 ) ) ;
...
if ( ! V_71 )
return 0 ;
return V_71 -> V_124 * F_2 ( sizeof( struct V_72 ) ) ;
}
int T_5 F_68 ( void )
{
int V_85 ;
