...
if ( V_2 -> V_322 )
V_132 = V_140 ;
F_9 ( V_311 , V_323 , V_132 ) ;
return F_4 ( V_2 , V_324 , V_311 , sizeof( V_311 ) ,
NULL , 0 , NULL ) ;
}
...
F_3 ( V_149 != 0 ) ;
V_8 = F_4 ( V_2 , V_150 , NULL , 0 ,
V_5 , sizeof( V_5 ) , & V_325 ) ;
if ( V_8 )
return true ;
return F_5 ( V_5 , V_326 ) != 0 ;
}
static int F_55 ( struct V_1 * V_2 ,
enum V_327 V_328 , int V_329 )
{
F_2 ( V_39 , V_330 ) ;
int V_8 ;
int V_331 = V_328 == V_332 ? 0 : 1 ;
int V_333 = V_328 == V_334 ? 1 : 0 ;
int V_335 = V_328 == V_334 ? 1000 : 0 ;
T_7 V_336 = V_2 -> V_337 . V_336 ;
T_2 V_338 = V_328 != V_339 ?
V_340 * sizeof( T_3 ) : 0 ;
F_3 ( V_341 != 0 ) ;
F_56 ( V_39 , V_342 , V_336 ) ;
F_57 ( V_39 , V_343 ,
V_344 , ! ! V_333 ,
V_345 , V_329 ,
V_346 , V_331 ,
...
V_349 , 1 ,
V_350 , V_335 ) ;
F_9 ( V_39 , V_351 , V_338 ) ;
V_8 = F_4 ( V_2 , V_352 , V_39 , sizeof( V_39 ) ,
NULL , 0 , NULL ) ;
return V_8 ;
}
void F_58 ( struct V_1 * V_2 )
{
T_8 * V_353 = V_2 -> V_337 . V_56 ;
V_353 [ V_354 ] = V_355 ;
F_55 ( V_2 , V_334 , 0 ) ;
}
...
V_2 -> V_359 = & V_360 ;
V_2 -> V_152 . V_155 = V_157 | V_158 ;
V_2 -> V_152 . V_361 = F_12 ;
V_2 -> V_152 . V_362 = F_14 ;
V_8 = V_2 -> V_359 -> V_363 ( V_2 ) ;
if ( V_8 != 0 )
return V_8 ;
V_8 = F_63 ( V_2 , & V_2 -> V_337 ,
V_340 * sizeof( T_3 ) , V_147 ) ;
if ( V_8 )
return V_8 ;
F_64 ( V_2 , V_363 , V_2 -> V_34 ,
L_5 ,
( T_3 ) V_2 -> V_337 . V_336 ,
V_2 -> V_337 . V_56 ,
( T_3 ) F_65 ( V_2 -> V_337 . V_56 ) ) ;
F_55 ( V_2 , V_339 , 1 ) ;
return 0 ;
}
void F_66 ( struct V_1 * V_2 )
{
V_2 -> V_359 -> remove ( V_2 ) ;
F_67 ( V_2 , & V_2 -> V_337 ) ;
}
...
F_2 ( V_5 , V_364 ) ;
int V_8 ;
V_8 = F_4 ( V_2 , V_365 , NULL , 0 ,
V_5 , sizeof( V_5 ) , NULL ) ;
if ( V_8 )
return V_8 ;
return F_5 ( V_5 , V_366 ) ;
}
