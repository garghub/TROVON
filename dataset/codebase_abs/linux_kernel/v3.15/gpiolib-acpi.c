...
if ( ! V_8 -> V_56 )
return;
F_32 (event, ep, &acpi_gpio->events, node) {
struct V_5 * V_27 ;
F_33 ( V_16 -> V_14 , V_16 ) ;
...
static int F_36 ( struct V_18 * V_19 , void * V_3 )
{
...
struct V_5 * F_37 ( struct V_67 * V_4 , int V_61 ,
struct V_68 * V_64 )
{
struct V_58 V_59 ;
struct V_69 V_70 ;
...
return F_6 ( - V_13 ) ;
V_9 = F_2 ( V_4 ) ;
if ( ! V_9 || F_38 ( V_9 , & V_72 ) )
return F_6 ( - V_11 ) ;
memset ( & V_59 , 0 , sizeof( V_59 ) ) ;
V_59 . V_61 = V_61 ;
F_29 ( & V_70 ) ;
V_29 = F_39 ( V_72 , & V_70 , F_36 ,
& V_59 ) ;
if ( V_29 < 0 )
return F_6 ( V_29 ) ;
F_40 ( & V_70 ) ;
...
bool V_81 ;
int V_82 ;
V_10 = F_42 ( V_80 -> V_83 . V_84 ,
V_80 -> V_83 . V_85 , & V_19 ) ;
if ( F_5 ( V_10 ) )
return V_10 ;
if ( F_34 ( V_19 -> type != V_30 ) ) {
F_43 ( V_19 ) ;
return V_39 ;
}
V_24 = & V_19 -> V_3 . V_32 ;
V_81 = V_24 -> V_86 == V_87 ;
if ( F_34 ( V_24 -> V_88 == V_89 &&
V_74 == V_90 ) ) {
F_43 ( V_19 ) ;
return V_39 ;
}
for ( V_82 = 0 ; V_82 < V_24 -> V_91 ; V_82 ++ ) {
unsigned V_7 = V_24 -> V_35 [ V_82 ] ;
struct V_92 * V_93 ;
struct V_5 * V_27 ;
bool V_94 ;
V_27 = F_8 ( V_8 , V_7 ) ;
...
V_93 -> V_27 = V_27 ;
F_24 ( & V_93 -> V_54 , & V_80 -> V_99 ) ;
}
F_46 ( & V_80 -> V_96 ) ;
if ( V_74 == V_90 )
F_48 ( V_27 , ! ! ( ( 1 << V_82 ) & * V_77 ) ) ;
else
* V_77 |= ( T_7 ) F_49 ( V_27 ) << V_82 ;
}
V_95:
F_43 ( V_19 ) ;
return V_10 ;
}
static void F_50 ( struct V_21 * V_80 )
{
struct V_1 * V_8 = V_80 -> V_8 ;
T_1 V_9 = F_2 ( V_8 -> V_4 ) ;
T_2 V_10 ;
...
static void F_53 ( struct V_21 * V_80 )
{
struct V_1 * V_8 = V_80 -> V_8 ;
T_1 V_9 = F_2 ( V_8 -> V_4 ) ;
struct V_92 * V_93 , * V_101 ;
T_2 V_10 ;
V_10 = F_54 ( V_9 , V_100 ,
F_41 ) ;
if ( F_5 ( V_10 ) ) {
...
F_32 (conn, tmp, &achip->conns, node) {
F_27 ( V_93 -> V_27 ) ;
F_35 ( & V_93 -> V_54 ) ;
F_25 ( V_93 ) ;
}
