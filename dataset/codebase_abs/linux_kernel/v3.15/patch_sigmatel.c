...
if ( V_9 -> V_165 )
V_190 |= V_191 ;
V_189 = F_113 ( V_4 , & V_9 -> V_15 . V_107 , NULL , V_190 ) ;
if ( V_189 < 0 )
return V_189 ;
V_9 -> V_15 . V_192 = F_1 ;
V_9 -> V_15 . V_193 = F_3 ;
...
V_9 -> V_15 . V_196 = F_24 ;
V_9 -> V_15 . V_197 = F_26 ;
V_189 = F_114 ( V_4 , & V_9 -> V_15 . V_107 ) ;
if ( V_189 < 0 )
return V_189 ;
...
static void F_120 ( struct V_207 * V_208 ,
...
struct V_3 * V_4 , T_1 V_18 )
{
F_120 ( V_208 , V_4 , V_18 ) ;
if ( V_18 == V_4 -> V_31 )
F_122 ( V_208 , V_4 , 0xfa0 ) ;
}
static void F_124 ( struct V_207 * V_208 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_122 ( V_208 , V_4 , 0xfe0 ) ;
}
static void F_125 ( struct V_207 * V_208 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_122 ( V_208 , V_4 , 0xfeb ) ;
}
...
if ( F_140 ( F_141 ( V_4 , 0x28 ) ) == V_250 )
F_77 ( V_4 , V_251 ) ;
if ( F_141 ( V_4 , 0xa ) & V_252 )
F_142 ( V_4 , V_247 ) ;
V_9 -> V_205 = & V_253 ;
V_9 -> V_89 = 0x50 ;
V_9 -> V_93 = 0 ;
V_9 -> V_14 = 1 ;
V_9 -> V_15 . V_200 = 0x26 ;
V_9 -> V_74 = F_135 ( V_254 ) ;
V_9 -> V_75 = V_254 ;
F_102 ( V_4 , V_255 , V_256 ,
V_257 ) ;
F_103 ( V_4 , V_152 ) ;
F_136 ( V_4 ) ;
V_189 = F_112 ( V_4 ) ;
...
V_4 -> V_214 = V_215 ;
F_77 ( V_4 , V_258 ) ;
F_144 ( V_4 , 0x12 , V_116 ,
( 0 << V_259 ) |
( 2 << V_128 ) |
( 0x27 << V_260 ) |
( 0 << V_123 ) ) ;
F_102 ( V_4 , V_261 , V_262 ,
V_181 ) ;
F_103 ( V_4 , V_152 ) ;
V_189 = F_112 ( V_4 ) ;
if ( V_189 < 0 ) {
