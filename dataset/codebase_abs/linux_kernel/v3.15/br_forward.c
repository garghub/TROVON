...
struct V_3 * V_31 , bool V_29 )
{
F_29 ( V_8 , V_4 , V_31 , F_18 , V_29 ) ;
}
...
struct V_34 * V_2 ;
struct V_35 * V_36 ;
V_36 = F_36 ( F_37 ( & V_8 -> V_37 ) ) ;
V_2 = V_33 ? F_36 ( V_33 -> V_38 ) : NULL ;
while ( V_2 || V_36 ) {
struct V_1 * V_39 , * V_40 , * V_41 ;
V_40 = V_2 ? V_2 -> V_39 : NULL ;
V_41 = V_36 ? F_38 ( V_36 , struct V_1 , V_42 ) :
NULL ;
V_39 = ( unsigned long ) V_40 > ( unsigned long ) V_41 ?
V_40 : V_41 ;
V_20 = F_27 ( V_20 , V_39 , V_4 , F_24 ) ;
if ( F_31 ( V_20 ) )
goto V_27;
if ( ( unsigned long ) V_40 >= ( unsigned long ) V_39 )
V_2 = F_36 ( V_2 -> V_43 ) ;
if ( ( unsigned long ) V_41 >= ( unsigned long ) V_39 )
V_36 = F_36 ( F_39 ( V_36 ) ) ;
}
if ( ! V_20 )
goto V_27;
