...
if ( ! V_33 )
return - V_12 ;
V_33 -> V_37 . V_17 = F_14 ( & V_31 -> V_3 ,
V_4 -> V_16 ,
V_11 ) ;
if ( V_33 -> V_37 . V_17 == NULL ) {
F_5 ( & V_31 -> V_3 , L_8 ) ;
return - V_12 ;
}
V_33 -> V_37 . type = V_38 ;
V_33 -> V_37 . V_39 = V_40 ;
V_33 -> V_37 . V_41 = & V_42 ;
V_33 -> V_37 . V_43 = V_4 -> V_26 ;
if ( V_4 -> V_29 ) {
V_33 -> V_37 . V_16 = F_14 ( & V_31 -> V_3 ,
V_4 -> V_29 ,
V_11 ) ;
if ( ! V_33 -> V_37 . V_16 ) {
F_5 ( & V_31 -> V_3 ,
...
V_33 -> V_3 = F_15 ( & V_31 -> V_3 , & V_33 -> V_37 ,
& V_35 ) ;
if ( F_11 ( V_33 -> V_3 ) ) {
V_36 = F_12 ( V_33 -> V_3 ) ;
...
F_16 ( V_31 , V_33 ) ;
F_17 ( & V_31 -> V_3 , L_11 , V_33 -> V_37 . V_17 ,
V_33 -> V_37 . V_45 ) ;
return 0 ;
}
