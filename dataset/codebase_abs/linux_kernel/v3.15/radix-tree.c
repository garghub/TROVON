...
int F_39 ( struct V_3 * V_4 , unsigned long V_38 ,
...
if ( V_8 ) {
V_8 -> V_33 ++ ;
F_23 ( F_8 ( V_8 , 0 , V_38 & V_50 ) ) ;
F_23 ( F_8 ( V_8 , 1 , V_38 & V_50 ) ) ;
} else {
F_23 ( F_13 ( V_4 , 0 ) ) ;
F_23 ( F_13 ( V_4 , 1 ) ) ;
}
...
void * F_41 ( struct V_3 * V_4 , unsigned long V_38 ,
struct V_7 * * V_45 , void * * * V_46 )
{
struct V_7 * V_8 , * V_44 ;
...
{
void * * V_39 ;
if ( ! F_41 ( V_4 , V_38 , NULL , & V_39 ) )
return NULL ;
return V_39 ;
}
void * F_44 ( struct V_3 * V_4 , unsigned long V_38 )
{
return F_41 ( V_4 , V_38 , NULL , NULL ) ;
}
...
static unsigned long F_58 ( struct V_7 * V_39 , void * V_51 ,
...
unsigned long F_59 ( struct V_3 * V_4 , void * V_51 )
{
struct V_7 * V_8 ;
unsigned long V_78 ;
...
void * F_66 ( struct V_3 * V_4 , unsigned long V_38 )
{
return F_65 ( V_4 , V_38 , NULL ) ;
}
...
static T_3 unsigned long F_70 ( unsigned int V_36 )
{
