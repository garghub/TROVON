...
V_67 , F_29 ( V_68 ) , F_29 ( V_69 ) , V_66 -> V_88 , V_66 -> V_74 ,
F_29 ( V_66 -> V_36 ) , F_29 ( V_66 -> V_37 ) ) ;
return V_110 ;
}
static inline int
F_30 ( struct V_56 * V_57 , unsigned int V_58 ,
struct V_59 * V_60 ,
union V_61 * V_62 ,
unsigned int V_63 ,
struct V_1 * V_2 ,
...
static int
F_31 ( struct V_56 * V_57 , unsigned int V_58 ,
struct V_1 * V_2 , enum V_64 V_65 )
{
int V_44 = F_32 ( V_65 ) ;
const struct V_26 * V_66 = F_20 ( V_2 ) ;
...
V_60 = F_33 ( V_57 , V_134 , sizeof( V_129 ) , & V_129 ) ;
if ( ! V_60 )
return V_110 ;
V_134 += sizeof( V_129 ) ;
V_133 -= sizeof( V_129 ) ;
V_63 = V_133 ;
V_67 = F_29 ( V_60 -> V_71 ) ;
if ( V_67 > 0 && V_67 <= V_111 && V_63 < V_144 [ V_67 ] )
return V_110 ;
if ( V_63 > sizeof( * V_62 ) )
V_63 = sizeof( * V_62 ) ;
V_62 = F_33 ( V_57 , V_134 , V_63 , & V_130 ) ;
if ( ! V_62 )
return V_110 ;
V_135 = V_66 -> V_74 ;
V_136 = V_66 -> V_88 ;
F_36 ( & V_145 ) ;
if ( V_44 == V_29 )
V_45 = F_30 ( V_57 , V_58 , V_60 , V_62 , V_63 , V_2 ,
V_65 ) ;
else
