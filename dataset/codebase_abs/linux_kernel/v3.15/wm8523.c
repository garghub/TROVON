...
unsigned int V_39 ;
int V_66 , V_21 ;
V_13 = F_26 ( & V_83 -> V_2 , sizeof( struct V_12 ) ,
V_86 ) ;
if ( V_13 == NULL )
return - V_87 ;
V_13 -> V_76 = F_27 ( V_83 , & V_88 ) ;
if ( F_28 ( V_13 -> V_76 ) ) {
V_66 = F_29 ( V_13 -> V_76 ) ;
F_4 ( & V_83 -> V_2 , L_6 , V_66 ) ;
return V_66 ;
}
for ( V_21 = 0 ; V_21 < F_8 ( V_13 -> V_75 ) ; V_21 ++ )
V_13 -> V_75 [ V_21 ] . V_89 = V_90 [ V_21 ] ;
V_66 = F_30 ( & V_83 -> V_2 , F_8 ( V_13 -> V_75 ) ,
V_13 -> V_75 ) ;
if ( V_66 != 0 ) {
F_4 ( & V_83 -> V_2 , L_7 , V_66 ) ;
return V_66 ;
}
V_66 = F_17 ( F_8 ( V_13 -> V_75 ) ,
V_13 -> V_75 ) ;
if ( V_66 != 0 ) {
F_4 ( & V_83 -> V_2 , L_5 , V_66 ) ;
return V_66 ;
}
V_66 = F_31 ( V_13 -> V_76 , V_4 , & V_39 ) ;
if ( V_66 < 0 ) {
F_4 ( & V_83 -> V_2 , L_8 ) ;
goto V_91;
}
if ( V_39 != 0x8523 ) {
F_4 ( & V_83 -> V_2 , L_9 , V_66 ) ;
V_66 = - V_15 ;
goto V_91;
}
V_66 = F_31 ( V_13 -> V_76 , V_5 , & V_39 ) ;
if ( V_66 < 0 ) {
F_4 ( & V_83 -> V_2 , L_10 ) ;
goto V_91;
}
F_32 ( & V_83 -> V_2 , L_11 ,
( V_39 & V_92 ) + 'A' ) ;
V_66 = F_33 ( V_13 -> V_76 , V_4 , 0x8523 ) ;
if ( V_66 != 0 ) {
F_4 ( & V_83 -> V_2 , L_12 , V_66 ) ;
goto V_91;
}
...
static int F_36 ( struct V_82 * V_95 )
{
F_37 ( & V_95 -> V_2 ) ;
return 0 ;
}
