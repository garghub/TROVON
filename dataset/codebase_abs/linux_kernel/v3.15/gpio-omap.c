...
T_2 V_158 , V_159 ;
F_34 ( & V_2 -> V_66 , V_61 ) ;
V_158 = V_2 -> V_15 . V_33 & V_2 -> V_15 . V_43 ;
if ( V_158 )
F_7 ( V_158 | V_2 -> V_15 . V_39 ,
V_2 -> V_5 + V_2 -> V_13 -> V_39 ) ;
V_159 = V_2 -> V_15 . V_35 & V_2 -> V_15 . V_43 ;
if ( V_159 )
F_7 ( V_159 | V_2 -> V_15 . V_37 ,
...
V_156 &= ~ V_2 -> V_46 ;
V_157 &= ~ V_2 -> V_46 ;
F_7 ( V_156 , V_2 -> V_5 + V_2 -> V_13 -> V_39 ) ;
F_7 ( V_157 , V_2 -> V_5 + V_2 -> V_13 -> V_37 ) ;
V_2 -> V_164 = true ;
V_160:
if ( V_2 -> V_152 )
V_2 -> V_165 =
...
V_12 ^= V_2 -> V_163 ;
V_12 &= V_2 -> V_46 ;
V_167 = V_12 & V_2 -> V_15 . V_39 ;
V_167 &= V_2 -> V_163 ;
V_168 = V_12 & V_2 -> V_15 . V_37 ;
V_168 &= ~ ( V_2 -> V_163 ) ;
V_166 = V_12 & ( ~ ( V_2 -> V_15 . V_39 ) &
~ ( V_2 -> V_15 . V_37 ) ) ;
V_166 |= V_167 | V_168 ;
if ( V_166 ) {
T_2 V_171 , V_172 ;
V_171 = F_6 ( V_2 -> V_5 + V_2 -> V_13 -> V_33 ) ;
V_172 = F_6 ( V_2 -> V_5 + V_2 -> V_13 -> V_35 ) ;
if ( ! V_2 -> V_13 -> V_173 ) {
F_7 ( V_171 | V_166 , V_2 -> V_5 +
V_2 -> V_13 -> V_33 ) ;
F_7 ( V_172 | V_166 , V_2 -> V_5 +
V_2 -> V_13 -> V_35 ) ;
}
if ( V_2 -> V_13 -> V_173 ) {
F_7 ( V_171 | V_12 , V_2 -> V_5 +
V_2 -> V_13 -> V_33 ) ;
F_7 ( V_172 | V_12 , V_2 -> V_5 +
V_2 -> V_13 -> V_35 ) ;
}
F_7 ( V_171 , V_2 -> V_5 + V_2 -> V_13 -> V_33 ) ;
F_7 ( V_172 , V_2 -> V_5 + V_2 -> V_13 -> V_35 ) ;
}
V_2 -> V_164 = false ;
F_36 ( & V_2 -> V_66 , V_61 ) ;
return 0 ;
}
void F_122 ( int V_174 )
{
struct V_1 * V_2 ;
...
static void F_120 ( struct V_1 * V_175 )
{
struct V_176 * V_13 = V_175 -> V_13 ;
void T_1 * V_5 = V_175 -> V_5 ;
V_175 -> V_15 . V_54 = F_6 ( V_5 + V_13 -> V_54 ) ;
V_175 -> V_15 . V_16 = F_6 ( V_5 + V_13 -> V_14 ) ;
V_175 -> V_15 . V_43 = F_6 ( V_5 + V_13 -> V_42 ) ;
V_175 -> V_15 . V_33 = F_6 ( V_5 + V_13 -> V_33 ) ;
V_175 -> V_15 . V_35 = F_6 ( V_5 + V_13 -> V_35 ) ;
V_175 -> V_15 . V_37 = F_6 ( V_5 + V_13 -> V_37 ) ;
V_175 -> V_15 . V_39 = F_6 ( V_5 + V_13 -> V_39 ) ;
V_175 -> V_15 . V_76 = F_6 ( V_5 + V_13 -> V_73 ) ;
...
static inline void F_120 ( struct V_1 * V_175 ) {}
