...
static void F_15 ( struct V_1 * V_2 , enum V_26 V_27 )
{
...
static void F_16 ( struct V_1 * V_2 , T_1 V_34 ,
struct V_35 * V_36 )
{
const struct V_3 * V_37 = F_2 ( V_2 ) ;
if ( V_34 & ( 1 << ( V_38 - 1 ) ) ) {
struct V_39 V_40 = {
. V_41 = 1 ,
. V_42 = F_17 ( V_37 -> V_12 ) ,
...
F_18 ( V_36 , V_38 , sizeof( V_40 ) , & V_40 ) ;
}
}
static int T_3 F_19 ( void )
{
F_20 ( sizeof( struct V_3 ) > V_44 ) ;
return F_21 ( & V_45 ) ;
}
