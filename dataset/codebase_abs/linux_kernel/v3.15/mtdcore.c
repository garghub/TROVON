...
int F_76 ( struct V_1 * V_6 , T_5 V_90 , T_5 * V_98 ,
struct V_115 * V_12 )
{
if ( ! V_6 -> V_116 )
return - V_52 ;
if ( ! V_90 )
return 0 ;
return V_6 -> V_116 ( V_6 , V_90 , V_98 , V_12 ) ;
}
...
int F_78 ( struct V_1 * V_6 , T_5 V_90 , T_5 * V_98 ,
struct V_115 * V_12 )
{
if ( ! V_6 -> V_118 )
return - V_52 ;
if ( ! V_90 )
return 0 ;
return V_6 -> V_118 ( V_6 , V_90 , V_98 , V_12 ) ;
}
...
if ( ! V_90 )
return 0 ;
V_61 = V_6 -> V_120 ( V_6 , V_108 , V_90 , V_98 , V_12 ) ;
if ( V_61 )
return V_61 ;
return ( * V_98 ) ? 0 : - V_121 ;
}
...
if ( ! V_90 )
return 0 ;
return V_6 -> V_122 ( V_6 , V_97 , V_90 ) ;
}
int F_82 ( struct V_1 * V_6 , T_6 V_123 , T_9 V_90 )
{
if ( ! V_6 -> V_124 )
return - V_52 ;
if ( V_123 < 0 || V_123 > V_6 -> V_23 || V_90 > V_6 -> V_23 - V_123 )
return - V_91 ;
if ( ! V_90 )
return 0 ;
return V_6 -> V_124 ( V_6 , V_123 , V_90 ) ;
}
int F_31 ( struct V_1 * V_6 , T_6 V_123 , T_9 V_90 )
{
if ( ! V_6 -> V_125 )
return - V_52 ;
if ( V_123 < 0 || V_123 > V_6 -> V_23 || V_90 > V_6 -> V_23 - V_123 )
...
if ( ! V_90 )
return 0 ;
return V_6 -> V_125 ( V_6 , V_123 , V_90 ) ;
}
int F_83 ( struct V_1 * V_6 , T_6 V_123 , T_9 V_90 )
{
if ( ! V_6 -> V_126 )
return - V_52 ;
if ( V_123 < 0 || V_123 > V_6 -> V_23 || V_90 > V_6 -> V_23 - V_123 )
...
if ( ! V_90 )
return 0 ;
return V_6 -> V_126 ( V_6 , V_123 , V_90 ) ;
}
int F_84 ( struct V_1 * V_6 , T_6 V_123 )
{
if ( ! V_6 -> V_127 )
return 0 ;
if ( V_123 < 0 || V_123 > V_6 -> V_23 )
return - V_91 ;
return V_6 -> V_127 ( V_6 , V_123 ) ;
}
int F_85 ( struct V_1 * V_6 , T_6 V_123 )
{
if ( ! V_6 -> V_128 )
return - V_52 ;
if ( V_123 < 0 || V_123 > V_6 -> V_23 )
...
if ( ! ( V_6 -> V_22 & V_50 ) )
return - V_92 ;
return V_6 -> V_128 ( V_6 , V_123 ) ;
}
static int F_86 ( struct V_1 * V_6 , const struct V_129 * V_130 ,
...
if ( ! V_130 [ V_2 ] . V_133 )
continue;
V_61 = F_73 ( V_6 , V_108 , V_130 [ V_2 ] . V_133 , & V_132 ,
V_130 [ V_2 ] . V_134 ) ;
V_131 += V_132 ;
if ( V_61 || V_132 != V_130 [ V_2 ] . V_133 )
break;
V_108 += V_130 [ V_2 ] . V_133 ;
}
* V_98 = V_131 ;
return V_61 ;
}
int F_87 ( struct V_1 * V_6 , const struct V_129 * V_130 ,
unsigned long V_33 , T_6 V_108 , T_5 * V_98 )
{
* V_98 = 0 ;
if ( ! ( V_6 -> V_22 & V_50 ) )
return - V_92 ;
if ( ! V_6 -> V_135 )
return F_86 ( V_6 , V_130 , V_33 , V_108 , V_98 ) ;
return V_6 -> V_135 ( V_6 , V_130 , V_33 , V_108 , V_98 ) ;
}
void * F_88 ( const struct V_1 * V_6 , T_5 * V_23 )
{
T_10 V_22 = V_136 | V_137 |
V_138 | V_139 ;
T_5 V_140 = F_89 ( T_5 , V_6 -> V_25 , V_21 ) ;
void * V_141 ;
* V_23 = F_90 ( T_5 , * V_23 , V_142 ) ;
while ( * V_23 > V_140 ) {
V_141 = F_91 ( * V_23 , V_22 ) ;
if ( V_141 )
return V_141 ;
* V_23 >>= 1 ;
...
static int F_93 ( struct V_143 * V_144 , void * V_145 )
{
struct V_1 * V_6 ;
F_94 ( V_144 , L_20 ) ;
F_27 ( & V_42 ) ;
...
static int F_96 ( struct V_146 * V_146 , struct V_147 * V_147 )
{
return F_97 ( V_147 , F_93 , NULL ) ;
}
static int T_11 F_98 ( struct V_38 * V_148 , const char * V_30 )
{
int V_61 ;
V_61 = F_99 ( V_148 ) ;
if ( ! V_61 )
V_61 = F_100 ( V_148 , NULL , L_22 , V_30 ) ;
if ( V_61 )
F_101 ( V_148 ) ;
return V_61 ;
}
