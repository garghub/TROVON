...
static T_3 int F_63 ( void )
{
struct V_9 * V_69 ;
struct V_70 * V_71 ;
int V_72 ;
V_69 = F_64 ( NULL , NULL , L_41 ) ;
F_17 ( V_69 ) ;
if ( ! V_69 )
return - V_73 ;
V_71 = F_65 ( L_42 , - 1 ) ;
...
int F_69 ( unsigned long V_80 )
{
struct V_9 * V_81 , * V_69 = NULL ;
int V_72 = - V_73 ;
switch( V_80 ) {
case V_82 :
if ( ! ( V_69 = F_64 ( NULL , NULL , L_48 ) ) )
V_69 = F_64 ( NULL , NULL , L_49 ) ;
if ( V_69 ) {
V_81 = F_70 ( V_69 ) ;
V_83 = F_71 ( V_81 , 0 ) ;
if ( ! V_83 )
...
T_5 int T_3 F_81 ( char * V_99 )
{
if ( V_99 && strncmp ( V_99 , L_58 , 1 ) != 0 )
V_100 = 1 ;
return 0 ;
}
int T_3 F_82 ( char * V_99 )
{
unsigned long V_72 ;
if ( V_99 ) {
if ( ! F_83 ( V_99 , 0 , & V_72 ) )
...
void F_84 ( char * V_102 , unsigned short V_103 )
{
F_85 ( L_59 , V_102 ) ;
}
void F_86 ( struct V_70 * V_104 )
{
V_104 -> V_105 . V_106 = F_87 ( 32 ) ;
V_104 -> V_107 . V_106 = & V_104 -> V_105 . V_106 ;
F_88 ( & V_104 -> V_107 , & V_108 ) ;
}
