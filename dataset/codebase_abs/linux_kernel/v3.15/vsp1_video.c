...
{
struct V_67 * V_68 = F_39 ( & V_15 -> V_15 . V_11 ) ;
...
V_89 = F_41 ( & V_15 -> V_107 ,
struct V_105 , V_108 ) ;
if ( V_68 -> V_85 && F_42 ( & V_15 -> V_107 ) ) {
F_33 ( & V_15 -> V_97 , V_96 ) ;
return V_89 ;
}
F_43 ( & V_89 -> V_108 ) ;
if ( ! F_40 ( & V_15 -> V_107 ) )
V_106 = F_41 ( & V_15 -> V_107 ,
struct V_105 , V_108 ) ;
F_33 ( & V_15 -> V_97 , V_96 ) ;
V_89 -> V_109 . V_110 . V_111 = V_15 -> V_111 ++ ;
F_44 ( & V_89 -> V_109 . V_110 . V_112 ) ;
for ( V_3 = 0 ; V_3 < V_89 -> V_109 . V_52 ; ++ V_3 )
F_45 ( & V_89 -> V_109 , V_3 , V_89 -> V_113 [ V_3 ] ) ;
F_46 ( & V_89 -> V_109 , V_114 ) ;
return V_106 ;
}
...
return;
for ( V_3 = 0 ; V_3 < V_68 -> V_82 ; ++ V_3 )
F_47 ( V_68 , & V_68 -> V_81 [ V_3 ] -> V_15 ) ;
if ( ! V_68 -> V_85 )
F_47 ( V_68 , & V_68 -> V_56 -> V_15 ) ;
F_32 ( & V_68 -> V_97 , V_96 ) ;
if ( V_68 -> V_90 == V_98 ) {
V_68 -> V_90 = V_91 ;
F_49 ( & V_68 -> V_99 ) ;
...
static int
F_50 ( struct V_116 * V_117 , const struct V_118 * V_17 ,
unsigned int * V_119 , unsigned int * V_120 ,
unsigned int V_121 [] , void * V_122 [] )
{
struct V_14 * V_15 = F_51 ( V_117 ) ;
const struct V_31 * V_27 ;
struct V_31 V_123 ;
unsigned int V_3 ;
if ( V_17 ) {
...
{
struct V_14 * V_15 = F_51 ( V_126 -> V_116 ) ;
struct V_105 * V_109 = F_53 ( V_126 ) ;
...
V_109 -> V_127 [ V_3 ] = F_54 ( V_126 , V_3 ) ;
V_109 -> V_113 [ V_3 ] = F_55 ( V_126 , V_3 ) ;
...
static void F_58 ( struct V_57 * V_129 )
{
struct V_57 * V_130 ;
if ( V_129 -> V_101 == 0 )
return;
V_130 = F_59 ( V_129 -> V_130 , struct V_57 , V_18 . V_11 ) ;
F_29 ( V_129 -> V_93 , V_129 -> V_101 , V_130 -> V_64 ) ;
}
static int F_60 ( struct V_116 * V_117 , unsigned int V_131 )
{
struct V_14 * V_15 = F_51 ( V_117 ) ;
struct V_67 * V_68 = F_39 ( & V_15 -> V_15 . V_11 ) ;
struct V_57 * V_11 ;
...
static int
F_64 ( struct V_134 * V_134 , void * V_135 , struct V_136 * V_137 )
{
struct V_138 * V_139 = V_134 -> V_140 ;
struct V_14 * V_15 = F_65 ( V_139 -> V_141 ) ;
...
V_137 -> V_148 = V_146
| V_144 ;
F_66 ( V_137 -> V_149 , L_2 , sizeof( V_137 -> V_149 ) ) ;
F_66 ( V_137 -> V_150 , V_15 -> V_15 . V_151 , sizeof( V_137 -> V_150 ) ) ;
snprintf ( V_137 -> V_152 , sizeof( V_137 -> V_152 ) , L_3 ,
F_67 ( V_15 -> V_93 -> V_133 ) ) ;
return 0 ;
}
static int
...
static int
F_70 ( struct V_134 * V_134 , void * V_135 , struct V_118 * V_27 )
{
struct V_138 * V_139 = V_134 -> V_140 ;
struct V_14 * V_15 = F_65 ( V_139 -> V_141 ) ;
const struct V_1 * V_5 ;
...
static int
F_72 ( struct V_134 * V_134 , void * V_135 , enum V_154 type )
{
struct V_138 * V_139 = V_134 -> V_140 ;
struct V_14 * V_15 = F_65 ( V_139 -> V_141 ) ;
struct V_67 * V_68 ;
...
? F_39 ( & V_15 -> V_15 . V_11 ) : & V_15 -> V_68 ;
V_19 = F_73 ( & V_15 -> V_15 . V_11 , & V_68 -> V_68 ) ;
if ( V_19 < 0 )
return V_19 ;
V_19 = F_7 ( V_15 ) ;
if ( V_19 < 0 )
...
static int F_75 ( struct V_134 * V_134 )
{
struct V_14 * V_15 = F_76 ( V_134 ) ;
struct V_138 * V_139 ;
int V_19 = 0 ;
V_139 = F_77 ( sizeof( * V_139 ) , V_158 ) ;
if ( V_139 == NULL )
return - V_159 ;
F_78 ( V_139 , & V_15 -> V_15 ) ;
F_79 ( V_139 ) ;
V_134 -> V_140 = V_139 ;
if ( ! F_80 ( V_15 -> V_93 ) ) {
V_19 = - V_153 ;
...
static int F_83 ( struct V_134 * V_134 )
{
struct V_14 * V_15 = F_76 ( V_134 ) ;
struct V_138 * V_139 = V_134 -> V_140 ;
F_19 ( & V_15 -> V_87 ) ;
...
int F_87 ( struct V_14 * V_15 , struct V_57 * V_76 )
{
const char * V_160 ;
int V_19 ;
switch ( V_15 -> type ) {
...
F_90 ( & V_15 -> V_68 . V_99 ) ;
V_15 -> V_68 . V_90 = V_91 ;
V_19 = F_91 ( & V_15 -> V_15 . V_11 , 1 , & V_15 -> V_9 , 0 ) ;
if ( V_19 < 0 )
return V_19 ;
V_15 -> V_25 = F_1 ( V_34 ) ;
...
F_92 ( & V_15 -> V_15 , V_15 ) ;
V_15 -> V_124 = F_93 ( V_15 -> V_93 -> V_133 ) ;
if ( F_94 ( V_15 -> V_124 ) ) {
V_19 = F_95 ( V_15 -> V_124 ) ;
goto error;
}
...
V_19 = F_96 ( & V_15 -> V_108 ) ;
if ( V_19 < 0 ) {
F_62 ( V_15 -> V_93 -> V_133 , L_7 ) ;
goto error;
}
V_15 -> V_15 . V_108 = & V_15 -> V_108 ;
V_19 = F_97 ( & V_15 -> V_15 , V_173 , - 1 ) ;
if ( V_19 < 0 ) {
F_62 ( V_15 -> V_93 -> V_133 , L_8 ) ;
goto error;
}
return 0 ;
error:
