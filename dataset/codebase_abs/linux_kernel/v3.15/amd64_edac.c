...
F_121 ( V_9 ) ;
V_64 = - V_11 ;
V_9 -> V_287 = V_9 -> V_223 -> V_347 ( V_9 ) ;
if ( V_9 -> V_287 < 0 )
goto V_348;
V_64 = - V_344 ;
V_343 [ 0 ] . type = V_349 ;
V_343 [ 0 ] . V_350 = V_9 -> V_53 [ 0 ] . V_88 ;
V_343 [ 0 ] . V_351 = true ;
V_343 [ 1 ] . type = V_352 ;
V_343 [ 1 ] . V_350 = 2 ;
V_343 [ 1 ] . V_351 = false ;
V_27 = F_151 ( V_35 , F_14 ( V_343 ) , V_343 , 0 ) ;
if ( ! V_27 )
goto V_348;
V_27 -> V_29 = V_9 ;
...
return;
V_9 = V_27 -> V_29 ;
V_364 = F_165 ( & V_9 -> V_12 -> V_129 , V_322 ) ;
if ( ! V_364 ) {
F_166 ( L_121 , V_42 ) ;
F_166 ( L_122 , V_42 ) ;
}
...
{
int V_6 = - V_252 ;
F_168 ( V_365 L_123 , V_324 ) ;
F_169 () ;
if ( F_170 () < 0 )
goto V_345;
V_6 = - V_344 ;
V_123 = F_150 ( F_171 () * sizeof( V_123 [ 0 ] ) , V_291 ) ;
V_361 = F_150 ( F_171 () * sizeof( V_361 [ 0 ] ) , V_291 ) ;
if ( ! ( V_123 && V_361 ) )
goto V_346;
V_293 = F_172 () ;
if ( ! V_293 )
