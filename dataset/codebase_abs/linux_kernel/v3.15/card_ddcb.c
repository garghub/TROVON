...
static T_6 F_68 ( int V_155 , void * V_156 )
{
struct V_14 * V_15 = (struct V_14 * ) V_156 ;
V_15 -> V_158 ++ ;
F_42 ( & V_15 -> V_136 ) ;
...
F_62 ( & V_15 -> V_136 ) ;
V_15 -> V_177 = F_76 ( F_69 , V_15 ,
V_84 L_28 ,
V_15 -> V_21 ) ;
if ( F_77 ( V_15 -> V_177 ) ) {
V_89 = F_78 ( V_15 -> V_177 ) ;
V_15 -> V_177 = NULL ;
goto V_178;
}
V_89 = F_79 ( V_15 , V_179 ) ;
if ( V_89 > 0 )
V_89 = F_79 ( V_15 , V_89 ) ;
if ( V_89 != 0 ) {
V_89 = - V_154 ;
...
F_62 ( & V_15 -> V_161 ) ;
if ( F_73 ( V_15 ) ) {
V_89 = F_80 ( V_18 -> V_155 , F_67 , V_181 ,
V_84 , V_15 ) ;
} else {
V_89 = F_80 ( V_18 -> V_155 , F_68 , V_181 ,
V_84 , V_15 ) ;
}
if ( V_89 < 0 ) {
