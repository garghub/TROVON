...
struct V_12 * V_13 ;
struct V_42 * V_36 ;
const char * V_53 = F_36 ( V_5 ) ;
char * V_54 , * V_55 ;
int error ;
V_13 = F_37 ( sizeof( struct V_12 ) , V_56 ) ;
if ( ! V_13 )
return - V_57 ;
V_5 -> V_58 = V_13 ;
V_13 -> V_36 = V_36 = F_38 () ;
...
sprintf ( V_55 , L_8 ,
V_21 , V_64 ) ;
} else if ( ! strcmp ( V_53 , V_65 ) ||
! strcmp ( V_53 , V_66 ) ) {
V_13 -> type = V_67 ;
strcpy ( V_54 , V_68 ) ;
sprintf ( V_55 , L_8 ,
V_21 , V_69 ) ;
} else if ( ! strcmp ( V_53 , V_70 ) ) {
V_13 -> type = V_17 ;
strcpy ( V_54 , V_71 ) ;
sprintf ( V_55 , L_8 ,
V_21 , V_24 ) ;
...
if ( error )
goto V_72;
snprintf ( V_13 -> V_73 , sizeof( V_13 -> V_73 ) , L_10 , V_53 ) ;
V_36 -> V_54 = V_54 ;
V_36 -> V_73 = V_13 -> V_73 ;
V_36 -> V_74 . V_75 = V_76 ;
V_36 -> V_74 . V_77 = V_13 -> type ;
V_36 -> V_38 . V_78 = & V_5 -> V_38 ;
switch ( V_13 -> type ) {
case V_62 :
F_41 ( V_36 , V_79 , V_48 ) ;
break;
