...
V_56 -> V_92 = V_1 ;
V_56 -> V_111 [ V_1 -> V_96 -> V_98 ] |= ( 1 << V_1 -> V_96 -> V_99 ) ;
F_1 ( V_1 ) ;
return 0 ;
V_168:
return - 1 ;
...
unsigned char * V_20 ;
T_2 * V_133 = NULL , * V_220 ;
int abort = 0 ;
F_8 ( V_9 ) ;
F_23 ( V_27 , V_127 ) ;
V_56 -> V_163 = 1 ;
V_218 = F_9 ( V_25 ) & ~ ( V_56 -> V_70 ) ;
...
F_23 ( V_28 , V_72 ) ;
V_99 = ( V_219 [ 0 ] & 0x07 ) ;
for ( V_133 = ( T_2 * ) V_56 -> V_95 , V_220 = NULL ; V_133 ; V_220 = V_133 , V_133 = ( T_2 * ) V_133 -> V_94 )
if ( ( V_218 == ( 1 << V_133 -> V_96 -> V_98 ) ) && ( V_99 == V_133 -> V_96 -> V_99 )
) {
if ( V_220 ) {
REMOVE ( V_220 , V_220 -> V_94 , V_133 , V_133 -> V_94 ) ;
V_220 -> V_94 = V_133 -> V_94 ;
} else {
...
if ( ! V_133 ) {
F_15 ( V_105 L_99 , V_9 -> V_37 , V_218 , V_99 ) ;
abort = 1 ;
}
}
if ( abort ) {
...
V_56 -> V_92 = V_133 ;
F_61 ( V_221 , ( L_100 , V_9 -> V_37 , V_133 -> V_222 , V_133 -> V_99 , V_133 -> V_157 ) ) ;
}
}
...
F_35 ( V_9 ) ;
F_8 ( V_9 ) ;
F_61 ( V_224 , ( L_102 , V_9 -> V_37 ) ) ;
F_61 ( V_224 , ( L_103 , F_9 ( V_29 ) , F_9 ( V_26 ) ) ) ;
#if 0
...
#endif
F_61 ( V_224 , ( L_104 , V_9 -> V_37 ) ) ;
for ( V_220 = ( T_2 * * ) & ( V_56 -> V_93 ) , V_133 = ( T_2 * ) V_56 -> V_93 ; V_133 ; V_220 = ( T_2 * * ) & ( V_133 -> V_94 ) , V_133 = ( T_2 * ) V_133 -> V_94 )
if ( V_1 == V_133 ) {
REMOVE ( 5 , * V_220 , V_133 , V_133 -> V_94 ) ;
( * V_220 ) = ( T_2 * ) V_133 -> V_94 ;
V_133 -> V_94 = NULL ;
V_133 -> V_136 = V_225 << 16 ;
F_61 ( V_224 , ( L_105 , V_9 -> V_37 ) ) ;
V_133 -> V_140 ( V_133 ) ;
return V_226 ;
}
#if ( V_134 & V_224 )
...
#endif
if ( V_56 -> V_92 ) {
F_61 ( V_224 , ( L_107 , V_9 -> V_37 ) ) ;
return V_227 ;
}
for ( V_133 = ( T_2 * ) V_56 -> V_95 ; V_133 ; V_133 = ( T_2 * ) V_133 -> V_94 )
if ( V_1 == V_133 ) {
F_61 ( V_224 , ( L_108 , V_9 -> V_37 ) ) ;
if ( F_71 ( V_9 , V_1 , ( int ) V_1 -> V_157 ) )
return V_227 ;
F_61 ( V_224 , ( L_109 , V_9 -> V_37 ) ) ;
F_54 ( V_9 ) ;
for ( V_220 = ( T_2 * * ) & ( V_56 -> V_95 ) , V_133 = ( T_2 * ) V_56 -> V_95 ; V_133 ; V_220 = ( T_2 * * ) & ( V_133 -> V_94 ) , V_133 = ( T_2 * ) V_133 -> V_94 )
if ( V_1 == V_133 ) {
REMOVE ( 5 , * V_220 , V_133 , V_133 -> V_94 ) ;
* V_220 = ( T_2 * ) V_133 -> V_94 ;
V_133 -> V_94 = NULL ;
