...
return 3 ;
V_82 = V_80 -> V_96 ;
F_39 ( & V_80 -> V_96 , V_80 -> V_42 & V_101 ) ;
if ( V_82 != V_80 -> V_96 )
V_81 ++ ;
if ( V_81 )
return 4 ;
...
return 3 ;
V_82 = V_80 -> V_95 ;
F_39 ( & V_80 -> V_95 , V_80 -> V_42 & V_101 ) ;
if ( V_82 != V_80 -> V_95 )
V_81 ++ ;
if ( V_81 )
return 4 ;
...
struct V_16 * V_17 , unsigned int V_131 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
int V_20 ;
if ( V_131 != 0 )
...
static const struct V_142 * F_53 ( int V_143 , int V_131 )
{
if ( V_143 ) {
if ( V_131 < 0 || V_131 >= 2 )
V_131 = 0 ;
...
static const struct V_142 * F_54 ( int V_131 )
{
if ( V_131 < 0 || V_131 >= 5 )
V_131 = 0 ;
return V_146 [ V_131 ] ;
}
static int F_55 ( struct V_1 * V_2 , int V_147 , int V_148 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
int V_36 ;
V_8 -> V_103 = 0 ;
if ( ! V_147 && ! V_148 )
return 0 ;
if ( V_147 == V_148 || V_147 < 5 || V_148 < 5 || V_147 > 7 || V_148 > 7 )
return - V_71 ;
if ( V_148 < V_147 ) {
int V_10 ;
V_10 = V_147 ;
...
V_36 = F_56 ( V_147 , L_10 ) ;
if ( V_36 )
return - V_72 ;
V_8 -> V_30 [ 0 ] . V_31 = V_147 ;
V_36 = F_56 ( V_148 , L_11 ) ;
if ( V_36 )
return - V_72 ;
V_8 -> V_30 [ 1 ] . V_31 = V_148 ;
V_8 -> V_32 = V_149 ;
V_8 -> V_30 [ 0 ] . V_3 = ( void * ) F_57 ( V_150 | V_151 ) ;
V_8 -> V_30 [ 1 ] . V_3 = ( void * ) F_57 ( V_150 | V_151 ) ;
if ( ! V_8 -> V_30 [ 0 ] . V_3 || ! V_8 -> V_30 [ 1 ] . V_3 )
return - V_152 ;
V_8 -> V_103 = 1 ;
return 0 ;
}
static int F_58 ( struct V_1 * V_2 , struct V_153 * V_154 )
{
const struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 ;
struct V_16 * V_17 ;
int V_36 ;
int V_10 ;
V_36 = F_59 ( V_2 , V_154 -> V_155 [ 0 ] , V_156 ) ;
if ( V_36 )
return V_36 ;
F_5 ( V_157 , V_2 -> V_23 + V_24 ) ;
V_10 = F_23 ( V_2 -> V_23 + V_54 ) ;
if ( ( ( F_23 ( V_2 -> V_23 + V_54 ) & V_158 )
!= V_159 ) ||
( ( F_23 ( V_2 -> V_23 + V_64 ) & V_160 )
!= V_161 ) ||
( ( F_23 ( V_2 -> V_23 + V_55 ) & V_162 )
!= V_163 ) ||
( ( F_23 ( V_2 -> V_23 + V_24 ) & V_164 )
!= V_165 ) ||
( ( F_23 ( V_2 -> V_23 + V_106 ) & V_166 )
!= V_167 ) ) {
F_6 ( V_2 -> V_27 , L_12 ) ;
return - V_104 ;
}
if ( V_154 -> V_155 [ V_168 ] > 0 ) {
V_36 = F_60 ( V_154 -> V_155 [ V_168 ] , F_22 , 0 ,
V_2 -> V_169 , V_2 ) ;
if ( V_36 == 0 )
V_2 -> V_46 = V_154 -> V_155 [ V_168 ] ;
}
V_8 = F_61 ( V_2 , sizeof( * V_8 ) ) ;
if ( ! V_8 )
return - V_152 ;
if ( V_2 -> V_46 ) {
V_36 = F_55 ( V_2 , V_154 -> V_155 [ V_170 ] ,
V_154 -> V_155 [ V_171 ] ) ;
if ( V_36 < 0 )
return V_36 ;
}
...
V_17 -> type = V_173 ;
V_17 -> V_174 = V_175 |
( ( V_154 -> V_155 [ V_176 ] ) ? V_177 : V_178 ) ;
V_17 -> V_179 =
( V_154 -> V_155 [ V_176 ] ) ? V_6 -> V_180 : V_6 -> V_181 ;
V_17 -> V_182 = F_30 ;
V_17 -> V_183 = ( 1 << V_6 -> V_12 ) - 1 ;
V_17 -> V_184 =
F_53 ( V_6 -> V_143 , V_154 -> V_155 [ V_185 ] ) ;
V_8 -> V_15 = V_154 -> V_155 [ V_186 ] ;
if ( V_2 -> V_46 ) {
V_2 -> V_35 = V_17 ;
V_17 -> V_174 |= V_187 ;
V_17 -> V_188 = 16 ;
...
V_17 = & V_2 -> V_172 [ 1 ] ;
V_17 -> V_179 = V_6 -> V_192 ;
if ( V_17 -> V_179 ) {
V_17 -> type = V_193 ;
V_17 -> V_174 = V_194 ;
V_17 -> V_182 = F_43 ;
V_17 -> V_195 = F_44 ;
V_17 -> V_183 = ( 1 << V_6 -> V_123 ) - 1 ;
V_17 -> V_196 = V_8 -> V_197 ;
V_8 -> V_197 [ 0 ] =
F_54 ( V_154 -> V_155 [ V_198 ] ) ;
V_8 -> V_197 [ 1 ] =
F_54 ( V_154 -> V_155 [ V_199 ] ) ;
V_8 -> V_126 = V_154 -> V_155 [ V_200 ] ;
V_8 -> V_127 = V_154 -> V_155 [ V_201 ] ;
if ( V_2 -> V_46 ) {
V_2 -> V_18 = V_17 ;
V_17 -> V_174 |= V_202 ;
V_17 -> V_188 = 2 ;
