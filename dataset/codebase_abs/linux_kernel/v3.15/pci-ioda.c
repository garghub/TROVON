...
F_64 ( V_92 , F_29 ( V_5 -> V_29 ) , V_5 -> V_11 ) ;
if ( V_5 -> V_12 )
...
static void F_66 ( struct V_91 * V_92 , bool V_118 )
{
struct V_13 * V_5 = F_52 ( V_92 , struct V_13 ,
V_83 ) ;
T_7 V_119 = ( V_5 -> V_11 << 1 ) + 1 ;
T_6 V_26 ;
F_30 ( V_5 , L_18 , V_118 ? L_19 : L_20 ) ;
if ( V_118 ) {
T_8 V_85 = F_39 () ;
V_85 = F_67 ( V_85 ) ;
...
void T_12 F_125 ( struct V_182 * V_183 )
{
F_111 ( V_183 , 0 , V_56 ) ;
}
...
const T_5 * V_190 ;
T_1 V_184 ;
F_73 ( L_63 , V_183 -> V_195 ) ;
V_190 = F_60 ( V_183 , L_64 , NULL ) ;
if ( ! V_190 ) {
F_12 ( L_65 ) ;
return;
}
