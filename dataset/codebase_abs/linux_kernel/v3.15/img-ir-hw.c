...
F_28 ( & V_81 -> V_129 ) ;
V_81 -> V_130 = V_131 ;
V_119 -> V_132 [ V_106 ] . V_91 = 0 ;
V_119 -> V_132 [ V_106 ] . V_92 = 0 ;
F_19 ( V_78 , NULL ) ;
F_21 ( V_78 , NULL ) ;
V_81 -> V_117 = 0 ;
V_81 -> V_72 = V_72 ;
...
static void F_34 ( struct V_77 * V_78 , T_2 V_118 )
{
struct V_108 * V_119 = V_78 -> V_81 . V_119 ;
F_23 ( & V_119 -> V_144 . V_113 ) ;
V_119 -> V_144 . V_145 = F_35 ( V_118 ) ;
F_24 ( & V_119 -> V_144 . V_113 ) ;
F_36 ( & V_119 -> V_113 ) ;
F_37 ( V_119 , V_118 ) ;
F_32 ( V_119 , V_118 ) ;
F_33 ( V_119 , V_118 ) ;
...
static void F_46 ( struct V_77 * V_78 , T_1 V_151 , T_2 V_152 )
{
struct V_80 * V_81 = & V_78 -> V_81 ;
...
int V_154 ;
if ( V_134 -> V_154 )
V_112 = V_134 -> V_154 ( V_151 , V_152 , & V_154 , V_81 -> V_117 ) ;
else if ( V_151 >= 32 )
V_154 = ( T_1 ) V_152 ;
else if ( V_151 < 32 )
V_154 = ( T_1 ) V_152 & ( ( 1 << V_151 ) - 1 ) ;
F_17 ( V_78 -> V_90 , L_8 ,
V_151 , ( unsigned long long ) V_152 ) ;
if ( V_112 == V_153 ) {
F_17 ( V_78 -> V_90 , L_9 , V_154 ) ;
F_47 ( V_81 -> V_119 , V_154 , 0 ) ;
F_45 ( V_78 ) ;
} else if ( V_112 == V_155 ) {
if ( V_81 -> V_130 == V_150 ) {
F_17 ( V_78 -> V_90 , L_10 ) ;
...
unsigned long V_156 ;
F_44 ( V_78 ) ;
V_156 = V_134 -> V_73 + ( V_134 -> V_73 >> 3 ) ;
F_49 ( & V_81 -> V_129 ,
V_157 + F_50 ( V_156 ) ) ;
}
}
static void F_51 ( unsigned long V_158 )
{
struct V_77 * V_78 = (struct V_77 * ) V_158 ;
F_23 ( & V_78 -> V_113 ) ;
F_45 ( V_78 ) ;
F_24 ( & V_78 -> V_113 ) ;
}
...
F_23 ( & V_78 -> V_113 ) ;
if ( V_81 -> V_133 == V_160 -> V_162 )
goto V_116;
V_81 -> V_133 = V_160 -> V_162 ;
if ( V_81 -> V_72 ) {
...
static int F_54 ( struct V_163 * V_164 , unsigned long V_165 ,
void * V_91 )
{
struct V_77 * V_78 = F_55 ( V_164 , struct V_77 ,
V_81 . V_166 ) ;
switch ( V_165 ) {
case V_167 :
F_52 ( V_78 , V_91 ) ;
...
void F_56 ( struct V_77 * V_78 , T_1 V_169 )
{
struct V_80 * V_81 = & V_78 -> V_81 ;
T_1 V_120 , V_151 , V_170 , V_171 ;
unsigned int V_135 ;
if ( ! V_81 -> V_72 )
return;
V_120 = F_20 ( V_78 , V_124 ) ;
...
V_120 &= ~ ( V_125 | V_126 ) ;
F_16 ( V_78 , V_124 , V_120 ) ;
V_151 = ( V_120 & V_172 ) >> V_173 ;
V_135 = V_81 -> V_72 -> V_20 . V_22 ;
if ( V_81 -> V_136 [ V_135 ] & V_174 )
++ V_151 ;
V_170 = F_20 ( V_78 , V_127 ) ;
V_171 = F_20 ( V_78 , V_128 ) ;
F_46 ( V_78 , V_151 , ( T_2 ) V_171 << 32 | V_170 ) ;
}
void F_57 ( struct V_77 * V_78 )
{
struct V_71 * * V_139 ;
if ( ! V_78 -> V_81 . V_119 )
return;
...
F_39 () ;
F_58 ( V_78 ) ;
F_60 ( & V_81 -> V_129 , F_51 , ( unsigned long ) V_78 ) ;
if ( ! F_61 ( V_78 -> V_178 ) ) {
V_81 -> V_133 = F_62 ( V_78 -> V_178 ) ;
#ifdef F_63
V_81 -> V_166 . V_179 = F_54 ;
error = F_64 ( V_78 -> V_178 , & V_81 -> V_166 ) ;
if ( error )
F_65 ( V_78 -> V_90 ,
L_14 ) ;
#endif
...
int F_75 ( struct V_189 * V_90 )
{
struct V_77 * V_78 = F_76 ( V_90 ) ;
if ( F_77 ( V_90 ) && F_42 ( V_78 ) )
F_78 ( V_78 -> V_190 ) ;
return 0 ;
}
int F_79 ( struct V_189 * V_90 )
{
struct V_77 * V_78 = F_76 ( V_90 ) ;
if ( F_77 ( V_90 ) && F_43 ( V_78 ) )
F_80 ( V_78 -> V_190 ) ;
return 0 ;
}
