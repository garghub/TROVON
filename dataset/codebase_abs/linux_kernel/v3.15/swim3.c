...
++ V_79 ;
F_25 ( V_79 , V_97 , V_6 -> V_99 , 512 ) ;
++ V_79 ;
F_25 ( V_79 , V_100 , V_101 , sizeof( V_101 ) ) ;
} else {
F_25 ( V_79 , V_102 , V_6 -> V_99 , V_67 * 512 ) ;
}
++ V_79 ;
F_33 ( & V_79 -> V_84 , V_103 ) ;
...
for ( V_67 = 0 ; ( F_37 ( & V_89 -> V_22 ) & V_119 ) && V_67 < 1000 ; V_67 ++ )
F_8 ( 1 ) ;
F_6 ( & V_11 -> V_62 , 0 ) ;
...
static T_2 F_38 ( int V_120 , void * V_121 )
{
...
static int F_42 ( struct V_1 * V_2 , enum V_130 V_25 ,
int V_131 )
{
unsigned long V_115 ;
F_2 ( L_5 , L_34 ) ;
...
return V_3 ;
case V_149 :
if ( F_51 ( ( void V_150 * ) V_140 , & V_151 ,
sizeof( struct V_152 ) ) )
return - V_153 ;
return 0 ;
}
...
static int F_52 ( struct V_137 * V_138 , T_3 V_139 ,
unsigned int V_80 , unsigned long V_140 )
{
int V_155 ;
F_53 ( & V_156 ) ;
V_155 = F_49 ( V_138 , V_139 , V_80 , V_140 ) ;
F_54 ( & V_156 ) ;
return V_155 ;
}
static int F_55 ( struct V_137 * V_138 , T_3 V_139 )
{
struct V_1 * V_2 = V_138 -> V_141 -> V_142 ;
struct V_10 T_1 * V_11 = V_2 -> V_10 ;
int V_67 , V_3 = 0 ;
...
static int F_57 ( struct V_137 * V_138 , T_3 V_139 )
{
int V_155 ;
F_53 ( & V_156 ) ;
V_155 = F_55 ( V_138 , V_139 ) ;
F_54 ( & V_156 ) ;
return V_155 ;
}
static void F_58 ( struct V_170 * V_171 , T_3 V_139 )
{
...
static unsigned int F_59 ( struct V_170 * V_171 ,
unsigned int V_172 )
{
struct V_1 * V_2 = V_171 -> V_142 ;
return V_2 -> V_39 ? V_173 : 0 ;
}
static int F_60 ( struct V_170 * V_171 )
{
struct V_1 * V_2 = V_171 -> V_142 ;
...
static void F_62 ( struct V_175 * V_33 , int V_176 )
{
...
static int F_64 ( struct V_175 * V_33 , int V_31 )
{
...
F_69 ( & V_33 -> V_179 . V_180 , V_2 ) ;
if ( V_33 -> V_34 == NULL )
F_70 ( V_183 , V_178 , 0 , 1 ) ;
V_2 -> V_25 = V_26 ;
V_2 -> V_10 = (struct V_10 T_1 * )
F_71 ( F_72 ( V_33 , 0 ) , 0x200 ) ;
if ( V_2 -> V_10 == NULL ) {
F_34 ( L_5 , L_42 ) ;
V_8 = - V_184 ;
goto V_185;
...
V_2 -> V_186 = F_74 ( V_33 , 0 ) ;
V_2 -> V_187 = F_74 ( V_33 , 1 ) ;
V_2 -> V_72 = - 1 ;
V_2 -> V_125 = - 1 ;
V_2 -> V_44 = 36 ;
V_2 -> V_46 = 18 ;
V_2 -> V_37 = 2880 ;
F_75 ( & V_2 -> V_29 ) ;
V_2 -> V_87 = (struct V_78 * ) F_76 ( V_2 -> V_188 ) ;
memset ( V_2 -> V_87 , 0 , 2 * sizeof( struct V_78 ) ) ;
F_26 ( & V_2 -> V_87 [ 1 ] . V_84 , V_103 ) ;
if ( V_33 -> V_34 == NULL || F_14 ( V_33 -> V_34 ) == V_35 )
F_62 ( V_33 , V_35 ) ;
if ( F_77 ( V_2 -> V_186 , F_38 , 0 , L_44 , V_2 ) ) {
F_34 ( L_5 , L_45 ) ;
F_70 ( V_183 , V_178 , 0 , 0 ) ;
goto V_189;
return - V_148 ;
}
F_78 ( & V_2 -> V_55 ) ;
...
static int F_80 ( struct V_175 * V_33 ,
...
if ( V_8 )
return V_8 ;
V_171 = V_30 [ V_31 ] = F_81 ( 1 ) ;
if ( V_171 == NULL )
return - V_184 ;
V_171 -> V_32 = F_82 ( F_18 , & V_116 ) ;
if ( V_171 -> V_32 == NULL ) {
F_83 ( V_171 ) ;
return - V_184 ;
}
