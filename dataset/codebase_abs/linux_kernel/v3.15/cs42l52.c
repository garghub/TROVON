...
static int F_47 ( struct V_174 * V_174 ,
const struct V_175 * V_163 )
{
struct V_58 * V_59 ;
struct V_60 * V_61 = F_48 ( & V_174 -> V_2 ) ;
int V_69 ;
unsigned int V_176 = 0 ;
unsigned int V_3 ;
T_3 V_177 ;
V_59 = F_49 ( & V_174 -> V_2 , sizeof( struct V_58 ) ,
V_178 ) ;
if ( V_59 == NULL )
return - V_179 ;
V_59 -> V_2 = & V_174 -> V_2 ;
V_59 -> V_138 = F_50 ( V_174 , & V_180 ) ;
if ( F_51 ( V_59 -> V_138 ) ) {
V_69 = F_52 ( V_59 -> V_138 ) ;
...
if ( V_174 -> V_2 . V_181 ) {
if ( F_53 ( V_174 -> V_2 . V_181 ,
L_13 ) )
V_61 -> V_62 = true ;
if ( F_53 ( V_174 -> V_2 . V_181 ,
L_14 ) )
V_61 -> V_64 = true ;
if ( F_54 ( V_174 -> V_2 . V_181 ,
L_15 , & V_177 ) >= 0 )
V_61 -> V_182 = V_177 ;
if ( F_54 ( V_174 -> V_2 . V_181 ,
L_16 , & V_177 ) >= 0 )
...
F_57 ( V_59 -> V_61 . V_184 , 0 ) ;
F_57 ( V_59 -> V_61 . V_184 , 1 ) ;
}
F_58 ( V_174 , V_59 ) ;
V_69 = F_59 ( V_59 -> V_138 , V_186 ,
F_6 ( V_186 ) ) ;
if ( V_69 != 0 )
F_60 ( V_59 -> V_2 , L_20 ,
V_69 ) ;
V_69 = F_61 ( V_59 -> V_138 , V_4 , & V_3 ) ;
V_176 = V_3 & V_187 ;
if ( V_176 != V_188 ) {
V_69 = - V_189 ;
F_9 ( & V_174 -> V_2 ,
...
V_3 & V_190 ) ;
if ( V_59 -> V_61 . V_62 )
F_63 ( V_59 -> V_138 , V_19 ,
V_191 ,
V_59 -> V_61 . V_62 <<
V_192 ) ;
if ( V_59 -> V_61 . V_64 )
F_63 ( V_59 -> V_138 , V_20 ,
V_191 ,
V_59 -> V_61 . V_64 <<
V_192 ) ;
if ( V_59 -> V_61 . V_183 )
F_63 ( V_59 -> V_138 , V_55 ,
V_193 ,
V_59 -> V_61 . V_183 <<
V_194 ) ;
if ( V_59 -> V_61 . V_182 )
F_63 ( V_59 -> V_138 , V_10 ,
V_195 ,
V_59 -> V_61 . V_182 ) ;
V_69 = F_64 ( & V_174 -> V_2 ,
& V_196 , & V_197 , 1 ) ;
...
static int F_65 ( struct V_174 * V_198 )
{
F_66 ( & V_198 -> V_2 ) ;
return 0 ;
}
