...
{
struct V_122 * V_123 ;
V_123 = F_138 ( V_120 , struct V_122 , V_253 ) ;
...
{
return F_139 ( V_120 ) -> V_254 ;
}
int F_57 ( const struct V_97 * V_74 )
{
struct V_112 * V_112 = F_61 ( V_74 ) ;
struct V_255 * V_256 = F_123 ( V_112 ) ;
return ( F_140 ( F_141 ( V_112 ) ) ||
F_141 ( V_112 ) == 0 ) && V_256 -> V_236 == V_74 ;
}
struct V_112 * F_61 ( const struct V_97 * V_74 )
{
return F_137 ( V_74 ) -> V_85 ;
}
struct V_127 * F_142 ( struct V_118 * V_257 )
{
F_143 ( F_144 ( V_257 ) ) ;
return (struct V_127 * ) V_257 -> V_258 ;
}
int F_145 ( struct V_112 * V_112 , struct V_259 * V_260 )
{
struct V_14 * V_15 ;
struct V_255 * V_256 ;
struct V_97 * V_261 ;
...
int V_53 = 0 ;
int V_235 ;
F_11 ( V_260 -> V_266 -> V_109 & V_267 ) ;
F_11 ( F_140 ( F_141 ( V_112 ) ) ) ;
V_15 = F_127 ( & V_235 ) ;
if ( F_34 ( V_15 ) )
return F_35 ( V_15 ) ;
V_41 = F_146 ( V_112 ) -> V_268 ;
V_256 = F_123 ( V_112 ) ;
V_264 = & V_256 -> V_228 ;
F_11 ( F_147 ( V_264 ) ) ;
if ( V_256 -> V_236 == NULL ) {
F_11 ( V_112 -> V_269 & V_270 ) ;
V_84 . V_271 . V_272 = V_273 ;
V_261 = F_148 ( V_15 , F_10 ( V_41 -> V_274 ) ,
V_264 , & V_84 ) ;
if ( ! F_34 ( V_261 ) ) {
V_256 -> V_236 = V_261 ;
V_256 -> V_275 = F_149 ( V_260 -> V_276 ) ;
F_150 ( & V_261 -> V_203 , L_7 , V_112 ) ;
} else
V_53 = F_35 ( V_261 ) ;
} else {
V_53 = F_151 ( V_15 , V_256 -> V_236 , & V_84 ) ;
}
F_39 ( V_15 , & V_235 ) ;
if ( V_53 != 0 )
F_22 ( L_8 V_201 L_9 ,
...
{
struct V_68 * V_277 = V_74 -> V_203 . V_94 ;
T_7 V_278 ;
if ( F_134 ( F_153 ( & V_277 -> V_279 ) != 1 ) ) {
struct V_262 * V_41 = V_74 -> V_203 . V_90 -> V_24 ;
struct V_280 * V_281 ;
V_281 = F_154 ( V_41 , & V_277 -> V_282 ) ;
F_155 ( & V_278 , V_283 ) ;
F_156 ( & V_281 -> V_284 , & V_278 ) ;
while ( 1 ) {
F_157 ( V_285 ) ;
if ( F_153 ( & V_277 -> V_279 ) == 1 )
break;
F_158 () ;
}
F_157 ( V_286 ) ;
F_159 ( & V_281 -> V_284 , & V_278 ) ;
}
F_160 ( V_15 , V_74 ) ;
}
...
T_8 F_170 ( struct V_290 * V_291 )
{
T_8 type = 0 ;
struct V_292 * V_293 ;
int V_294 = 0 ;
if ( F_171 ( V_291 -> V_295 ) & V_296 ) {
const unsigned V_297 = sizeof( struct V_292 ) - 1 ;
V_294 = F_172 ( V_291 -> V_298 ) ;
V_294 = ( V_294 + V_297 ) & ~ V_297 ;
V_293 = ( void * ) V_291 -> V_299 + V_294 ;
type = F_173 ( F_172 ( V_293 -> V_300 ) ) ;
}
return type ;
}
V_204 F_174 ( const struct V_263 * V_264 , int V_301 )
{
if ( V_302 == 32 || V_301 )
return F_175 ( V_264 ) ;
else
...
T_1 F_177 ( const struct V_263 * V_264 )
{
T_1 V_303 ;
if ( F_178 ( V_264 ) ) {
V_303 = F_179 ( V_264 ) ;
...
V_303 = ( F_176 ( V_264 ) >> 32 ) ;
return V_303 ;
}
struct V_304 * F_180 ( struct V_112 * V_112 )
{
return F_181 ( F_123 ( V_112 ) -> V_236 ) ;
}
void inline F_182 ( struct V_112 * V_112 , struct V_304 * V_276 )
{
F_183 ( F_123 ( V_112 ) -> V_236 , V_276 ) ;
}
