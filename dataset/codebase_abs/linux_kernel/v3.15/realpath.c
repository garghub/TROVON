...
char V_33 [ 64 ] ;
int V_34 ;
const T_2 V_35 = V_20 -> V_30 ;
V_33 [ sizeof( V_33 ) - 1 ] = '\0' ;
snprintf ( V_33 , sizeof( V_33 ) - 1 , L_2 , F_14 ( V_35 ) ,
F_15 ( V_35 ) ) ;
V_34 = strlen ( V_33 ) ;
V_13 -= V_34 ;
if ( V_13 < V_11 )
...
V_29:
{
const char * V_33 = V_20 -> V_36 -> V_33 ;
...
{
struct V_15 * V_15 = V_10 -> V_16 -> V_17 ;
struct V_37 * V_38 = V_15 ? F_17 ( V_15 ) : NULL ;
...
V_15 = V_20 -> V_31 -> V_17 ;
if ( ! V_10 -> V_50 || ! V_15 -> V_32 -> rename )
V_13 = F_11 ( V_10 -> V_16 , V_43 ,
V_44 - 1 ) ;
else {
...
char * F_22 ( const char * V_53 )
{
struct V_10 V_10 ;
if ( V_53 && F_23 ( V_53 , 0 , & V_10 ) == 0 ) {
char * V_43 = F_18 ( & V_10 ) ;
F_24 ( & V_10 ) ;
return V_43 ;
}
