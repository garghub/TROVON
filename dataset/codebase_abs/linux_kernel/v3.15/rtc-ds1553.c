...
void T_1 * V_9 ;
int V_84 = 0 ;
V_8 = F_27 ( & V_6 -> V_2 , sizeof( * V_8 ) , V_85 ) ;
if ( ! V_8 )
return - V_86 ;
V_81 = F_28 ( V_6 , V_87 , 0 ) ;
V_9 = F_29 ( & V_6 -> V_2 , V_81 ) ;
if ( F_30 ( V_9 ) )
return F_31 ( V_9 ) ;
V_8 -> V_9 = V_9 ;
V_8 -> V_58 = F_32 ( V_6 , 0 ) ;
...
if ( V_83 & V_88 ) {
V_83 &= V_27 ;
V_82 = F_8 ( V_9 + V_30 ) & V_29 ;
F_5 ( V_12 , V_9 + V_13 ) ;
F_5 ( V_83 , V_9 + V_28 ) ;
F_5 ( V_82 & V_29 , V_9 + V_13 ) ;
}
if ( F_8 ( V_9 + V_55 ) & V_89 )
F_33 ( & V_6 -> V_2 , L_2 ) ;
F_34 ( & V_8 -> V_42 ) ;
V_8 -> V_38 = V_39 ;
F_35 ( V_6 , V_8 ) ;
V_8 -> V_66 = F_36 ( & V_6 -> V_2 , V_6 -> V_90 ,
& V_91 , V_92 ) ;
if ( F_30 ( V_8 -> V_66 ) )
