...
case V_182 : {
F_11 ( V_36 , L_56 V_183
L_57 , F_22 ( V_30 , 1 ) ,
V_30 -> V_171 , F_106 ( V_30 -> V_171 ) ) ;
...
F_11 ( V_36 , L_63 ,
V_191 , V_30 -> V_132 ) ;
V_191 = F_109 ( V_30 -> V_132 , 1U ) ;
if ( V_191 >= V_188 )
V_191 = F_109 ( V_188 / 3 , 1U ) ;
V_192 = 1 ;
GOTO ( V_37 , V_72 = 0 ) ;
}
case V_193 : {
...
struct V_195 * V_196 ;
V_196 = F_110 ( V_30 , 1 ) ;
F_11 ( V_36 , L_65 , V_196 -> V_197 ,
V_196 -> V_198 , V_196 -> V_199 , V_196 -> V_200 ) ;
GOTO ( V_37 , V_72 = 0 ) ;
}
case V_201 : {
char * V_25 ;
...
int F_118 ( char * V_216 , struct V_217 * V_218 ,
struct V_29 * V_30 , void * V_219 )
{
struct V_217 * V_220 ;
struct V_221 V_222 ;
struct V_223 V_224 ;
...
V_222 . V_232 = & V_224 ;
V_224 . V_233 = V_219 ;
for ( V_226 = 1 ; V_226 < V_30 -> V_107 ; V_226 ++ ) {
V_2 = F_110 ( V_30 , V_226 ) ;
F_5 ( V_2 , V_216 , & V_2 ) ;
V_225 = strchr ( V_2 , '=' ) ;
if ( ! V_225 || ( * ( V_225 + 1 ) == 0 ) ) {
F_4 ( L_71 , V_2 ) ;
...
V_229 = 0 ;
V_230 = 0 ;
while ( V_218 [ V_230 ] . V_34 ) {
V_220 = & V_218 [ V_230 ] ;
if ( F_5 ( V_2 , ( char * ) V_220 -> V_34 , 0 ) == 0 &&
V_227 == strlen ( V_220 -> V_34 ) ) {
V_229 ++ ;
V_26 = - V_234 ;
if ( V_220 -> V_235 && V_220 -> V_235 -> V_236 ) {
T_3 V_237 ;
V_237 = F_119 () ;
F_120 ( V_238 ) ;
V_26 = ( V_220 -> V_235 -> V_236 ) ( & V_222 , V_225 ,
V_228 , NULL ) ;
F_120 ( V_237 ) ;
}
break;
...
F_11 ( V_120 , L_74 ,
F_22 ( V_30 , 0 ) ,
( int ) strlen ( V_216 ) - 1 , V_216 ,
( int ) ( V_225 - V_2 - 1 ) , V_2 , V_225 ) ;
}
}
if ( V_26 > 0 )
V_26 = 0 ;
...
int F_122 ( const struct V_240 * V_241 ,
struct V_242 * V_243 ,
struct V_244 * V_245 , void * V_219 )
{
struct V_246 * V_247 = V_219 ;
int V_248 = V_245 -> V_249 ;
char * V_250 = ( char * ) ( V_245 + 1 ) ;
int V_26 = 0 ;
switch ( V_245 -> V_251 ) {
case V_252 : {
struct V_29 * V_30 , * V_253 ;
struct V_164 V_165 ;
char * V_254 = NULL ;
int V_255 = 0 ;
int V_256 = 0 , V_257 = 0 ;
V_30 = (struct V_29 * ) V_250 ;
if ( V_30 -> V_258 == F_123 ( V_259 ) ) {
F_124 ( V_30 ) ;
V_257 = 1 ;
}
V_26 = F_125 ( V_250 , V_248 ) ;
if ( V_26 )
GOTO ( V_37 , V_26 ) ;
if ( V_30 -> V_169 == V_194 ) {
struct V_195 * V_196 = F_110 ( V_30 , 1 ) ;
F_126 ( V_196 , V_257 ,
F_21 ( V_30 , 1 ) ) ;
F_11 ( V_120 , L_75 ,
V_247 -> V_260 , V_196 -> V_198 ) ;
if ( V_196 -> V_198 & V_261 ) {
V_247 -> V_260 = V_262 ;
if ( V_196 -> V_198 & V_263 ) {
V_247 -> V_260 |= V_264 ;
F_11 ( V_120 , L_76 ,
V_196 -> V_197 ) ;
} else if ( ( V_196 -> V_198 & V_265 ) ||
( V_247 -> V_266 &&
F_127 ( V_247 -> V_266 ,
V_196 -> V_199 ) ) ) {
V_247 -> V_260 |= V_267 ;
...
} else if ( V_196 -> V_198 & V_268 ) {
V_247 -> V_260 = 0 ;
}
}
if ( ! ( V_247 -> V_260 & V_269 ) &&
! ( V_247 -> V_260 & V_262 ) &&
( V_30 -> V_169 != V_194 ) ) {
F_111 ( L_78
L_79 ,
V_247 -> V_270 ,
V_247 -> V_271 . V_35 , V_247 -> V_260 ) ;
V_247 -> V_260 |= V_264 ;
}
if ( V_247 -> V_260 & V_264 ) {
F_11 ( V_120 , L_80 ,
V_247 -> V_260 ) ;
V_26 = 0 ;
break;
...
F_95 ( & V_165 , V_30 ) ;
if ( V_247 && V_247 -> V_270 &&
F_21 ( V_30 , 0 ) > 0 ) {
V_256 = 1 ;
V_255 = F_21 ( V_30 , 0 ) +
sizeof( V_247 -> V_270 ) * 2 + 4 ;
F_80 ( V_254 , V_255 ) ;
if ( V_254 == NULL )
GOTO ( V_37 , V_26 = - V_91 ) ;
sprintf ( V_254 , L_88 ,
...
if ( V_247 && V_247 -> V_270 == NULL &&
V_30 -> V_169 == V_275 ) {
F_128 ( & V_165 , 2 , V_165 . V_276 [ 1 ] ,
V_165 . V_277 [ 1 ] ) ;
F_128 ( & V_165 , 1 , V_165 . V_276 [ 0 ] ,
V_165 . V_277 [ 0 ] ) ;
F_96 ( & V_165 , 0 ,
V_247 -> V_278 ) ;
}
V_253 = F_97 ( V_30 -> V_169 , & V_165 ) ;
V_253 -> V_132 = V_30 -> V_132 ;
V_253 -> V_170 = V_30 -> V_170 ;
if ( V_30 -> V_172 != 0 &&
( V_30 -> V_171 >> 32 ) == 0 ) {
T_2 V_279 = ( T_2 ) ( V_30 -> V_171 & 0xffffffff ) ;
V_253 -> V_171 =
F_129 ( F_130 ( V_30 -> V_172 , 0 ) , V_279 ) ;
F_111 ( L_90 ,
V_30 -> V_172 , V_279 ,
F_106 ( V_253 -> V_171 ) ) ;
} else {
V_253 -> V_171 = V_30 -> V_171 ;
}
V_253 -> V_172 = 0 ;
V_26 = F_105 ( V_253 ) ;
F_131 ( V_253 ) ;
...
if ( V_26 ) {
F_4 ( L_92 ,
V_243 -> V_280 -> V_281 -> V_40 , V_26 ) ;
F_132 ( NULL , V_243 , V_245 , V_219 ) ;
}
return V_26 ;
}
int F_133 ( const struct V_240 * V_241 , struct V_282 * V_283 ,
char * V_34 , struct V_246 * V_162 )
{
struct V_284 V_285 = { 0 , 0 } ;
struct V_242 * V_286 ;
T_4 V_287 ;
int V_26 ;
F_11 ( V_21 , L_93 , V_34 ) ;
V_26 = F_134 ( V_241 , V_283 , & V_286 , NULL , V_34 , V_288 ) ;
if ( V_26 )
return V_26 ;
V_26 = F_135 ( V_241 , V_286 , V_289 , NULL ) ;
if ( V_26 )
GOTO ( V_290 , V_26 ) ;
if ( V_162 ) {
V_285 . V_291 = V_162 -> V_292 ;
V_287 = V_162 -> V_293 ;
F_46 ( V_287 != NULL ) ;
} else {
V_287 = F_122 ;
...
V_285 . V_294 = 0 ;
V_26 = F_136 ( V_241 , V_286 , V_287 , V_162 , & V_285 ) ;
F_11 ( V_120 , L_94 , V_34 ,
V_285 . V_291 + 1 , V_285 . V_294 , V_26 ) ;
if ( V_162 )
V_162 -> V_292 = V_285 . V_294 ;
V_290:
F_137 ( V_241 , V_286 ) ;
return V_26 ;
}
int F_138 ( struct V_244 * V_245 , char * V_1 , int V_295 )
{
struct V_29 * V_30 = (struct V_29 * ) ( V_245 + 1 ) ;
char * V_4 = V_1 ;
char * V_177 = V_1 + V_295 ;
int V_26 = 0 ;
F_46 ( V_245 -> V_251 == V_252 ) ;
V_26 = F_125 ( V_30 , V_245 -> V_249 ) ;
if ( V_26 < 0 )
return V_26 ;
V_4 += snprintf ( V_4 , V_177 - V_4 , L_95 , V_30 -> V_169 ) ;
if ( V_30 -> V_170 )
V_4 += snprintf ( V_4 , V_177 - V_4 , L_96 ,
V_30 -> V_170 ) ;
if ( V_30 -> V_132 )
V_4 += snprintf ( V_4 , V_177 - V_4 , L_97 , V_30 -> V_132 ) ;
if ( V_30 -> V_171 )
V_4 += snprintf ( V_4 , V_177 - V_4 , L_98 V_183 L_99 ,
F_106 ( V_30 -> V_171 ) ,
V_30 -> V_171 ) ;
if ( V_30 -> V_169 == V_194 ) {
struct V_195 * V_196 = F_110 ( V_30 , 1 ) ;
V_4 += snprintf ( V_4 , V_177 - V_4 , L_100 ,
V_196 -> V_197 , V_196 -> V_198 ,
V_196 -> V_199 , V_196 -> V_200 ) ;
} else {
int V_226 ;
for ( V_226 = 0 ; V_226 < V_30 -> V_107 ; V_226 ++ ) {
V_4 += snprintf ( V_4 , V_177 - V_4 , L_101 , V_226 ,
F_22 ( V_30 , V_226 ) ) ;
}
}
V_26 = V_4 - V_1 ;
...
int F_132 ( const struct V_240 * V_241 ,
struct V_242 * V_243 ,
struct V_244 * V_245 , void * V_219 )
{
char * V_296 ;
...
F_138 ( V_245 , V_296 , 256 ) ;
F_139 ( V_297 , L_102 , V_296 ) ;
} else {
F_139 ( V_297 , L_103 , V_245 -> V_251 ) ;
V_26 = - V_16 ;
}
F_82 ( V_296 , 256 ) ;
return V_26 ;
}
int F_140 ( const struct V_240 * V_241 , struct V_282 * V_283 ,
char * V_34 , struct V_246 * V_162 )
{
struct V_242 * V_286 ;
int V_26 ;
...
if ( V_26 )
GOTO ( V_290 , V_26 ) ;
V_26 = F_136 ( V_241 , V_286 , F_132 , V_162 , NULL ) ;
V_290:
F_137 ( V_241 , V_286 ) ;
F_141 ( L_105 , V_34 ) ;
return V_26 ;
...
F_96 ( & V_165 , 1 , V_298 ) ;
V_30 = F_97 ( V_208 , & V_165 ) ;
if ( ! V_30 )
return - V_91 ;
V_26 = F_105 ( V_30 ) ;
if ( V_26 ) {
F_4 ( L_111 , V_26 , V_32 -> V_40 ) ;
GOTO ( V_37 , V_26 ) ;
}
V_30 -> V_169 = V_207 ;
V_26 = F_105 ( V_30 ) ;
if ( V_26 )
F_4 ( L_112 , V_26 , V_32 -> V_40 ) ;
V_37:
F_131 ( V_30 ) ;
return V_26 ;
}
static unsigned
F_143 ( struct V_300 * V_301 , const void * V_2 , unsigned V_302 )
{
return F_144 ( ( (struct V_66 * ) V_2 ) -> V_35 ,
sizeof( ( (struct V_66 * ) V_2 ) -> V_35 ) , V_302 ) ;
}
static void *
F_145 ( struct V_303 * V_304 )
{
struct V_73 * exp ;
exp = F_146 ( V_304 , struct V_73 , V_305 ) ;
return & exp -> V_306 ;
}
static int
F_147 ( const void * V_2 , struct V_303 * V_304 )
{
struct V_73 * exp ;
F_46 ( V_2 ) ;
exp = F_146 ( V_304 , struct V_73 , V_305 ) ;
return F_148 ( V_2 , & exp -> V_306 ) &&
! exp -> V_307 ;
}
static void *
F_149 ( struct V_303 * V_304 )
{
return F_146 ( V_304 , struct V_73 , V_305 ) ;
}
static void
F_150 ( struct V_300 * V_301 , struct V_303 * V_304 )
{
struct V_73 * exp ;
exp = F_146 ( V_304 , struct V_73 , V_305 ) ;
F_151 ( exp ) ;
...
static void
F_152 ( struct V_300 * V_301 , struct V_303 * V_304 )
{
struct V_73 * exp ;
exp = F_146 ( V_304 , struct V_73 , V_305 ) ;
F_51 ( exp ) ;
...
static unsigned
F_153 ( struct V_300 * V_301 , const void * V_2 , unsigned V_302 )
{
return F_144 ( V_2 , sizeof( T_1 ) , V_302 ) ;
}
static void *
F_154 ( struct V_303 * V_304 )
{
struct V_73 * exp ;
exp = F_146 ( V_304 , struct V_73 , V_308 ) ;
return & exp -> V_309 -> V_310 . V_18 ;
}
static int
F_155 ( const void * V_2 , struct V_303 * V_304 )
{
struct V_73 * exp ;
F_46 ( V_2 ) ;
exp = F_146 ( V_304 , struct V_73 , V_308 ) ;
return exp -> V_309 -> V_310 . V_18 == * ( T_1 * ) V_2 &&
! exp -> V_307 ;
}
static void *
F_156 ( struct V_303 * V_304 )
{
return F_146 ( V_304 , struct V_73 , V_308 ) ;
}
static void
F_157 ( struct V_300 * V_301 , struct V_303 * V_304 )
{
struct V_73 * exp ;
exp = F_146 ( V_304 , struct V_73 , V_308 ) ;
F_151 ( exp ) ;
...
static void
F_158 ( struct V_300 * V_301 , struct V_303 * V_304 )
{
struct V_73 * exp ;
exp = F_146 ( V_304 , struct V_73 , V_308 ) ;
F_51 ( exp ) ;
...
static void *
F_159 ( struct V_303 * V_304 )
{
struct V_311 * V_312 ;
V_312 = F_146 ( V_304 , struct V_311 , F_153 ) ;
return & V_312 -> V_18 ;
}
static int
F_160 ( const void * V_2 , struct V_303 * V_304 )
{
return * ( T_1 * ) F_159 ( V_304 ) == * ( T_1 * ) V_2 ;
}
static void *
F_161 ( struct V_303 * V_304 )
{
return F_146 ( V_304 , struct V_311 , F_153 ) ;
}
static void
F_162 ( struct V_300 * V_301 , struct V_303 * V_304 )
{
struct V_311 * V_312 ;
V_312 = F_146 ( V_304 , struct V_311 , F_153 ) ;
F_163 ( V_312 ) ;
...
static void
F_164 ( struct V_300 * V_301 , struct V_303 * V_304 )
{
struct V_311 * V_312 ;
V_312 = F_146 ( V_304 , struct V_311 , F_153 ) ;
F_165 ( V_312 ) ;
