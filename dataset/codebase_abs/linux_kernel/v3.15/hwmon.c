...
struct V_15 * V_16 ;
int V_17 , V_18 ;
if ( V_6 && ( ! strlen ( V_6 ) || strpbrk ( V_6 , L_2 ) ) )
return F_8 ( - V_19 ) ;
V_18 = F_9 ( & V_20 , 0 , 0 , V_21 ) ;
if ( V_18 < 0 )
return F_8 ( V_18 ) ;
V_16 = F_10 ( sizeof( * V_16 ) , V_21 ) ;
if ( V_16 == NULL ) {
V_17 = - V_22 ;
goto V_23;
}
...
V_16 -> V_2 . V_26 = V_2 ;
V_16 -> V_2 . V_14 = V_14 ;
V_16 -> V_2 . V_27 = V_2 ? V_2 -> V_27 : NULL ;
F_11 ( & V_16 -> V_2 , V_12 ) ;
F_12 ( & V_16 -> V_2 , V_28 , V_18 ) ;
V_17 = F_13 ( & V_16 -> V_2 ) ;
if ( V_17 )
goto free;
return & V_16 -> V_2 ;
...
{
int V_18 ;
if ( F_17 ( sscanf ( F_18 ( V_2 ) , V_28 , & V_18 ) == 1 ) ) {
F_19 ( V_2 ) ;
F_14 ( & V_20 , V_18 ) ;
} else
F_20 ( V_2 -> V_26 ,
...
static void F_21 ( struct V_1 * V_2 , void * V_29 )
{
struct V_1 * V_16 = * (struct V_1 * * ) V_29 ;
F_16 ( V_16 ) ;
}
struct V_1 *
...
const struct V_13 * * V_14 )
{
struct V_1 * * V_30 , * V_16 ;
if ( ! V_2 )
return F_8 ( - V_19 ) ;
V_30 = F_23 ( F_21 , sizeof( * V_30 ) , V_21 ) ;
if ( ! V_30 )
return F_8 ( - V_22 ) ;
...
static int F_27 ( struct V_1 * V_2 , void * V_29 , void * V_31 )
{
struct V_1 * * V_16 = V_29 ;
return * V_16 == V_31 ;
}
