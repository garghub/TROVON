...
V_28 -> V_51 . V_91 = 0 ;
V_28 -> V_51 . V_92 = 0 ;
V_28 -> V_51 . V_51 = V_28 -> V_93 ;
V_28 -> V_51 . V_94 = V_28 -> V_93 ;
if ( V_89 & V_95 )
V_28 -> V_93 [ V_90 ++ ] = V_45 | V_44 | V_95 ;
if ( V_89 & V_50 )
V_28 -> V_93 [ V_90 ++ ] = V_37 | V_50 ;
if ( ! V_90 )
V_28 -> V_93 [ V_90 ++ ] = V_37 | V_50 ;
V_28 -> V_51 . V_96 = V_90 ;
V_28 -> V_51 . V_97 = V_90 ;
}
int F_43 ( struct V_81 * V_67 , int V_15 , int V_98 ,
T_1 V_34 , struct V_27 * * V_99 )
{
struct V_1 * V_58 = V_67 -> V_100 ;
struct V_27 * V_49 ;
T_3 V_101 ;
int V_80 ;
...
F_18 ( V_49 , V_95 | V_50 ) ;
V_101 = F_45 ( & V_58 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_80 = F_46 ( & V_58 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_103 , & V_49 -> V_51 ,
V_98 >> V_63 , false , NULL , V_101 ,
NULL , F_12 ) ;
if ( V_80 )
return V_80 ;
* V_99 = V_49 ;
...
int F_48 ( struct V_27 * V_28 , T_2 V_104 , T_4 * V_105 )
{
int V_106 , V_80 ;
if ( V_28 -> V_107 ) {
V_28 -> V_107 ++ ;
...
F_18 ( V_28 , V_104 ) ;
for ( V_106 = 0 ; V_106 < V_28 -> V_51 . V_96 ; V_106 ++ )
V_28 -> V_93 [ V_106 ] |= V_108 ;
...
return F_55 ( V_53 , V_112 ) ;
V_114 = V_53 -> V_116 ;
V_58 = V_114 -> V_117 -> V_67 -> V_100 ;
return F_56 ( V_53 , V_112 , & V_58 -> V_4 . V_5 ) ;
}
