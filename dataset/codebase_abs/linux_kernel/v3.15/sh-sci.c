...
static void F_118 ( struct V_2 * V_4 , int V_187 )
{
struct V_1 * V_42 = F_1 ( V_4 ) ;
struct V_7 * V_8 = V_43 [ V_42 -> V_14 -> V_16 ] + V_44 ;
...
static bool F_119 ( struct V_158 * V_159 , void * V_192 )
{
...
V_200 = F_129 ( V_4 -> V_29 , & V_42 -> V_145 , 1 , V_185 ) ;
if ( ! V_200 )
F_101 ( V_42 , false ) ;
else
F_50 ( V_4 -> V_29 , L_27 ,
...
int * V_211 , unsigned int * V_212 ,
unsigned int * V_213 )
{
int V_214 , V_36 , V_215 , V_216 ;
int V_217 = 1000 ;
for ( V_214 = 8 ; V_214 <= 32 ; V_214 ++ ) {
for ( V_36 = 0 ; V_36 <= 3 ; V_36 ++ ) {
V_215 = V_209 / ( V_214 * ( 1 << ( 2 * V_36 + 1 ) ) * V_208 ) - 1 ;
if ( V_215 < 0 || V_215 > 255 )
continue;
V_216 = V_209 / ( ( V_215 + 1 ) * V_208 * V_214 *
( 1 << ( 2 * V_36 + 1 ) ) / 1000 ) - 1000 ;
if ( V_217 > V_216 ) {
V_217 = V_216 ;
* V_211 = V_215 ;
* V_212 = V_214 - 1 ;
...
V_8 = F_4 ( V_4 , V_139 ) ;
if ( V_8 -> V_9 )
F_24 ( V_4 , V_139 , V_218 | V_219 ) ;
}
static void F_142 ( struct V_2 * V_4 , struct V_220 * V_221 ,
struct V_220 * V_222 )
{
struct V_1 * V_42 = F_1 ( V_4 ) ;
struct V_7 * V_8 ;
unsigned int V_223 , V_224 , V_225 , V_213 = 0 ;
int V_226 = - 1 ;
unsigned int V_212 = 15 ;
V_225 = V_4 -> V_31 ? V_4 -> V_31 / 16 : 115200 ;
V_223 = F_143 ( V_4 , V_221 , V_222 , 0 , V_225 ) ;
if ( F_144 ( V_223 && V_4 -> V_31 ) ) {
if ( V_42 -> V_14 -> type == V_26 ) {
F_140 ( V_223 , V_4 -> V_31 , & V_226 , & V_212 ,
& V_213 ) ;
} else {
V_226 = F_137 ( V_42 , V_223 , V_4 -> V_31 ) ;
for ( V_213 = 0 ; V_226 >= 256 && V_213 <= 3 ; V_213 ++ )
V_226 >>= 2 ;
}
}
F_13 ( V_42 ) ;
F_141 ( V_4 ) ;
V_224 = F_22 ( V_4 , V_227 ) & 3 ;
if ( ( V_221 -> V_228 & V_229 ) == V_230 )
V_224 |= V_231 ;
if ( V_221 -> V_228 & V_232 )
V_224 |= V_233 ;
if ( V_221 -> V_228 & V_234 )
V_224 |= V_233 | V_235 ;
if ( V_221 -> V_228 & V_236 )
V_224 |= V_237 ;
F_145 ( V_4 , V_221 -> V_228 , V_223 ) ;
F_50 ( V_4 -> V_29 , L_30 ,
V_144 , V_224 , V_213 , V_226 , V_42 -> V_14 -> V_108 ) ;
if ( V_226 >= 0 ) {
F_24 ( V_4 , V_227 , ( V_224 & ~ V_238 ) | V_213 ) ;
F_24 ( V_4 , V_239 , V_226 ) ;
V_8 = F_4 ( V_4 , V_240 ) ;
if ( V_8 -> V_9 )
F_24 ( V_4 , V_240 , V_212 | V_241 ) ;
F_146 ( ( 1000000 + ( V_223 - 1 ) ) / V_223 ) ;
} else
F_24 ( V_4 , V_227 , V_224 ) ;
F_32 ( V_4 , V_221 -> V_228 ) ;
V_8 = F_4 ( V_4 , V_139 ) ;
if ( V_8 -> V_9 ) {
...
#ifdef F_64
if ( V_42 -> V_98 ) {
V_42 -> V_103 = ( V_4 -> V_243 - V_244 / 50 ) * V_42 -> V_155 * 3 /
V_4 -> V_53 / 2 ;
F_50 ( V_4 -> V_29 , L_31 ,
V_42 -> V_103 * 1000 / V_244 , V_4 -> V_243 ) ;
if ( V_42 -> V_103 < F_147 ( 20 ) )
V_42 -> V_103 = F_147 ( 20 ) ;
}
#endif
if ( ( V_221 -> V_228 & V_245 ) != 0 )
F_100 ( V_4 ) ;
F_17 ( V_42 ) ;
}
static void F_148 ( struct V_2 * V_4 , unsigned int V_62 ,
unsigned int V_246 )
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
switch ( V_62 ) {
...
return 0 ;
if ( V_4 -> V_106 & V_248 ) {
V_4 -> V_10 = F_152 ( V_4 -> V_249 , V_9 ) ;
if ( F_77 ( ! V_4 -> V_10 ) ) {
F_80 ( V_4 -> V_29 , L_38 , V_4 -> line ) ;
return - V_250 ;
}
} else {
V_4 -> V_10 = ( void V_58 * ) ( V_59 ) V_4 -> V_249 ;
}
return 0 ;
}
...
struct V_251 * V_252 ;
int V_113 ;
V_252 = F_157 ( V_4 -> V_249 , V_9 , F_79 ( V_4 -> V_29 ) ) ;
if ( F_77 ( V_252 == NULL ) )
return - V_253 ;
V_113 = F_151 ( V_4 ) ;
if ( F_77 ( V_113 != 0 ) ) {
...
{
if ( V_106 & V_254 ) {
struct V_1 * V_255 = F_1 ( V_4 ) ;
V_4 -> type = V_255 -> V_14 -> type ;
F_156 ( V_4 ) ;
}
}
static int F_160 ( struct V_2 * V_4 , struct V_256 * V_257 )
{
if ( V_257 -> V_258 < 2400 )
return - V_28 ;
return 0 ;
}
static int F_161 ( struct V_259 * V_29 ,
struct V_1 * V_1 , unsigned int V_260 ,
struct V_13 * V_5 , bool V_261 )
{
struct V_2 * V_4 = & V_1 -> V_4 ;
...
V_4 -> V_263 = V_264 ;
V_4 -> line = V_260 ;
V_252 = F_162 ( V_29 , V_265 , 0 ) ;
if ( V_252 == NULL )
return - V_266 ;
V_4 -> V_249 = V_252 -> V_267 ;
for ( V_77 = 0 ; V_77 < F_163 ( V_1 -> V_128 ) ; ++ V_77 )
V_1 -> V_128 [ V_77 ] = F_164 ( V_29 , V_77 ) ;
if ( V_1 -> V_128 [ 0 ] < 0 )
return - V_250 ;
if ( V_1 -> V_128 [ 1 ] < 0 ) {
...
: V_210 ;
if ( ! V_261 ) {
V_1 -> V_30 = F_165 ( & V_29 -> V_29 , L_39 ) ;
if ( F_166 ( V_1 -> V_30 ) ) {
V_1 -> V_30 = F_165 ( & V_29 -> V_29 , L_40 ) ;
if ( F_166 ( V_1 -> V_30 ) ) {
F_80 ( & V_29 -> V_29 , L_41 ) ;
return F_167 ( V_1 -> V_30 ) ;
}
}
V_1 -> V_32 = F_165 ( & V_29 -> V_29 , L_42 ) ;
if ( F_166 ( V_1 -> V_32 ) )
V_1 -> V_32 = NULL ;
V_4 -> V_29 = & V_29 -> V_29 ;
F_168 ( & V_29 -> V_29 ) ;
...
V_1 -> V_33 . V_270 = F_57 ;
F_169 ( & V_1 -> V_33 ) ;
V_1 -> V_271 = ( V_5 -> type == V_15 ) ?
V_272 : V_273 ;
V_1 -> V_271 |= 1 << V_1 -> V_90 ;
V_4 -> type = V_5 -> type ;
V_4 -> V_106 = V_274 | V_5 -> V_106 ;
V_4 -> V_11 = V_5 -> V_11 ;
...
static void F_174 ( struct V_278 * V_279 , const char * V_42 ,
unsigned V_65 )
{
struct V_1 * V_1 = & V_280 [ V_279 -> V_260 ] ;
struct V_2 * V_4 = & V_1 -> V_4 ;
unsigned short V_281 , V_64 ;
unsigned long V_106 ;
int V_282 = 1 ;
F_175 ( V_106 ) ;
if ( V_4 -> V_283 )
...
F_178 ( V_4 , V_42 , V_65 , F_173 ) ;
V_281 = F_29 ( V_4 ) | F_31 ( V_4 ) ;
while ( ( F_22 ( V_4 , V_37 ) & V_281 ) != V_281 )
F_179 () ;
F_24 ( V_4 , V_66 , V_64 ) ;
if ( V_282 )
F_180 ( & V_4 -> V_107 ) ;
...
int V_286 = 'n' ;
int V_113 ;
if ( V_279 -> V_260 < 0 || V_279 -> V_260 >= V_287 )
return - V_288 ;
V_1 = & V_280 [ V_279 -> V_260 ] ;
V_4 = & V_1 -> V_4 ;
if ( ! V_4 -> V_45 )
return - V_288 ;
V_113 = F_151 ( V_4 ) ;
...
return V_113 ;
if ( V_285 )
F_183 ( V_285 , & V_223 , & V_85 , & V_281 , & V_286 ) ;
return F_184 ( V_4 , V_279 , V_223 , V_85 , V_281 , V_286 ) ;
}
static int F_185 ( struct V_259 * V_289 )
{
struct V_13 * V_14 = F_186 ( & V_289 -> V_29 ) ;
if ( V_290 . V_89 )
return - V_291 ;
V_290 . V_260 = V_289 -> V_292 ;
F_161 ( V_289 , & V_280 [ V_289 -> V_292 ] , V_289 -> V_292 , V_14 , true ) ;
F_182 ( & V_290 , V_293 ) ;
if ( ! strstr ( V_293 , L_44 ) )
V_290 . V_106 |= V_294 ;
F_187 ( & V_290 ) ;
return 0 ;
}
static inline int F_185 ( struct V_259 * V_289 )
{
return - V_28 ;
}
static int F_188 ( struct V_259 * V_29 )
{
struct V_1 * V_4 = F_189 ( V_29 ) ;
F_190 ( & V_4 -> V_119 ,
V_295 ) ;
F_191 ( & V_296 , & V_4 -> V_4 ) ;
F_170 ( V_4 ) ;
...
static struct V_13 *
F_192 ( struct V_259 * V_289 , unsigned int * V_297 )
{
struct V_298 * V_299 = V_289 -> V_29 . V_300 ;
const struct V_301 * V_302 ;
const struct V_303 * V_304 ;
struct V_13 * V_5 ;
int V_292 ;
if ( ! F_193 ( V_305 ) || ! V_299 )
return NULL ;
V_302 = F_194 ( V_306 , V_289 -> V_29 . V_300 ) ;
if ( ! V_302 )
return NULL ;
V_304 = V_302 -> V_89 ;
V_5 = F_195 ( & V_289 -> V_29 , sizeof( struct V_13 ) , V_130 ) ;
if ( ! V_5 ) {
F_80 ( & V_289 -> V_29 , L_45 ) ;
return NULL ;
}
V_292 = F_196 ( V_299 , L_46 ) ;
if ( V_292 < 0 ) {
F_80 ( & V_289 -> V_29 , L_47 , V_292 ) ;
return NULL ;
}
* V_297 = V_292 ;
V_5 -> V_106 = V_248 | V_307 ;
V_5 -> type = V_304 -> type ;
V_5 -> V_16 = V_304 -> V_16 ;
V_5 -> V_108 = V_308 | V_191 ;
return V_5 ;
}
static int F_197 ( struct V_259 * V_29 ,
unsigned int V_260 ,
struct V_13 * V_5 ,
struct V_1 * V_309 )
{
...
V_113 = F_161 ( V_29 , V_309 , V_260 , V_5 , false ) ;
if ( V_113 )
return V_113 ;
V_113 = F_198 ( & V_296 , & V_309 -> V_4 ) ;
if ( V_113 ) {
F_170 ( V_309 ) ;
return V_113 ;
}
...
static int F_199 ( struct V_259 * V_29 )
{
struct V_13 * V_5 ;
struct V_1 * V_310 ;
unsigned int V_297 ;
...
V_310 = & V_280 [ V_297 ] ;
F_201 ( V_29 , V_310 ) ;
V_113 = F_197 ( V_29 , V_297 , V_5 , V_310 ) ;
if ( V_113 )
return V_113 ;
V_310 -> V_119 . V_312 = F_74 ;
V_113 = F_202 ( & V_310 -> V_119 ,
V_295 ) ;
if ( F_77 ( V_113 < 0 ) ) {
F_191 ( & V_296 , & V_310 -> V_4 ) ;
F_170 ( V_310 ) ;
return V_113 ;
}
#ifdef F_203
...
static int F_205 ( struct V_176 * V_29 )
{
struct V_1 * V_255 = F_206 ( V_29 ) ;
if ( V_255 )
F_207 ( & V_296 , & V_255 -> V_4 ) ;
return 0 ;
}
static int F_208 ( struct V_176 * V_29 )
{
struct V_1 * V_255 = F_206 ( V_29 ) ;
if ( V_255 )
F_209 ( & V_296 , & V_255 -> V_4 ) ;
return 0 ;
}
