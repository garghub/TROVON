...
void * F_24 ( struct V_44 * V_45 , int V_8 )
{
void * V_46 ;
V_46 = F_21 ( V_45 , F_7 ( V_8 ) ) ;
memset ( V_46 , 0 , F_7 ( V_8 ) ) ;
return V_46 ;
}
struct V_1 * F_25 ( struct V_44 * V_45 , int V_33 , int V_8 )
{
if ( F_13 ( F_26 ( V_45 ) < F_11 ( V_8 ) ) )
return NULL ;
return F_20 ( V_45 , V_33 , V_8 ) ;
}
void * F_27 ( struct V_44 * V_45 , int V_8 )
{
if ( F_13 ( F_26 ( V_45 ) < F_7 ( V_8 ) ) )
return NULL ;
return F_24 ( V_45 , V_8 ) ;
}
void F_28 ( struct V_44 * V_45 , int V_33 , int V_8 ,
const void * V_40 )
{
struct V_1 * V_2 ;
...
void F_29 ( struct V_44 * V_45 , int V_8 , const void * V_40 )
{
void * V_46 ;
V_46 = F_24 ( V_45 , V_8 ) ;
memcpy ( V_46 , V_40 , V_8 ) ;
}
int F_30 ( struct V_44 * V_45 , int V_33 , int V_8 , const void * V_40 )
{
if ( F_13 ( F_26 ( V_45 ) < F_11 ( V_8 ) ) )
return - V_47 ;
F_28 ( V_45 , V_33 , V_8 , V_40 ) ;
return 0 ;
}
int F_31 ( struct V_44 * V_45 , int V_8 , const void * V_40 )
{
if ( F_13 ( F_26 ( V_45 ) < F_7 ( V_8 ) ) )
return - V_47 ;
F_29 ( V_45 , V_8 , V_40 ) ;
...
int F_32 ( struct V_44 * V_45 , int V_8 , const void * V_40 )
{
if ( F_13 ( F_26 ( V_45 ) < F_7 ( V_8 ) ) )
return - V_47 ;
