...
bool F_35 ( struct V_6 * V_7 , int V_27 )
{
return V_7 -> V_30 ( V_7 , V_27 ) ;
}
struct V_8 * F_36 ( struct V_6 * V_7 )
{
return V_7 -> V_28 ( V_7 ) ;
}
void F_37 ( struct V_6 * V_7 , struct V_8 * V_9 )
{
V_7 -> V_29 ( V_7 , V_9 ) ;
}
int F_38 ( struct V_6 * V_7 , struct V_8 * V_9 ,
const unsigned char * V_36 , T_2 * V_37 )
{
return V_7 -> V_11 -> V_2 ( V_36 , V_9 -> V_13 , V_37 ,
V_9 -> V_10 ) ;
}
int F_39 ( struct V_6 * V_7 , const unsigned char * V_36 ,
...
struct V_6 * F_41 ( const char * V_2 , int V_25 )
{
struct V_6 * V_7 ;
struct V_1 * V_11 ;
V_11 = F_1 ( V_2 ) ;
if ( ! V_11 )
return F_42 ( - V_41 ) ;
V_7 = F_43 ( sizeof( struct V_6 ) , V_14 ) ;
if ( ! V_7 )
return F_42 ( - V_31 ) ;
V_7 -> V_11 = V_11 ;
if ( V_25 > 1 )
