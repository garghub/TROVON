...
V_5 -> V_31 [ V_5 -> V_28 ] ) ;
if ( V_5 -> V_26 )
F_10 ( V_5 -> V_29 , V_5 -> V_22 ) ;
else
F_10 ( V_5 -> V_29 , V_5 -> V_27 ) ;
F_11 ( V_20 ) ;
F_12 ( V_5 -> V_29 ) ;
}
V_5 -> V_26 -- ;
...
{
unsigned int V_44 ;
V_44 = F_25 ( V_2 -> V_8 + V_45 ) << 8 ;
V_44 |= F_25 ( V_2 -> V_8 + V_43 ) ;
...
int V_73 = 0 ;
int V_74 ;
V_73 |= F_33 ( & V_18 -> V_75 , V_76 ) ;
V_73 |= F_33 ( & V_18 -> V_77 , V_78 ) ;
V_73 |= F_33 ( & V_18 -> V_79 , V_80 | V_81 ) ;
V_73 |= F_33 ( & V_18 -> V_82 , V_24 ) ;
V_73 |= F_33 ( & V_18 -> V_23 , V_24 | V_32 ) ;
if ( V_73 )
return 1 ;
V_73 |= F_34 ( V_18 -> V_79 ) ;
V_73 |= F_34 ( V_18 -> V_23 ) ;
if ( V_73 )
return 2 ;
V_73 |= F_35 ( & V_18 -> V_83 , 0 ) ;
V_73 |= F_35 ( & V_18 -> V_84 , 0 ) ;
if ( V_18 -> V_79 == V_81 )
V_73 |= F_36 ( & V_18 -> V_85 , 10000 ) ;
else
V_73 |= F_35 ( & V_18 -> V_85 , 0 ) ;
V_73 |= F_35 ( & V_18 -> V_86 , V_18 -> V_25 ) ;
if ( V_18 -> V_23 == V_24 )
V_73 |= F_36 ( & V_18 -> V_59 , 1 ) ;
else
V_73 |= F_35 ( & V_18 -> V_59 , 0 ) ;
if ( V_73 )
return 3 ;
if ( V_18 -> V_79 == V_81 ) {
V_74 = V_18 -> V_85 ;
...
return - V_53 ;
F_1 ( V_2 , false ) ;
V_40 = F_38 ( V_2 , V_16 , V_18 -> V_39 , V_18 -> V_25 ) ;
if ( V_40 < 1 )
return - V_90 ;
F_19 ( V_2 , V_18 -> V_39 , V_40 ) ;
F_4 ( 1 ) ;
V_5 -> V_57 = 0 ;
V_16 -> V_19 -> V_56 = 0 ;
V_5 -> V_68 = 1 ;
...
V_89 |= V_95 ;
F_16 ( V_89 , V_2 -> V_8 + V_96 ) ;
F_16 ( ( V_5 -> V_29 << 4 ) | V_2 -> V_64 , V_2 -> V_8 + V_51 ) ;
return 0 ;
}
...
break;
V_106 =
( F_20 ( V_105 [ V_41 - 1 ] ) + 1 ) % V_104 ;
if ( V_106 != F_20 ( V_39 [ V_41 ] ) ) {
F_46 ( V_2 -> V_108 ,
L_2 ,
V_41 , F_20 ( V_39 [ V_41 ] ) , V_106 ,
F_20 ( V_39 [ 0 ] ) ) ;
return 0 ;
}
...
F_46 ( V_2 -> V_108 ,
L_3 ,
V_41 , F_20 ( V_105 [ V_41 ] ) ,
F_21 ( V_105 [ V_41 ] ) ,
F_47 ( V_105 [ V_41 ] ) ,
F_20 ( V_39 [ V_41 % V_40 ] ) ,
F_21 ( V_39 [ V_41 % V_40 ] ) ,
F_47 ( V_105 [ V_41 % V_40 ] ) ) ;
return 0 ;
}
}
} else {
...
unsigned int * V_109 )
{
unsigned int V_33 = F_20 ( V_48 -> V_110 ) ;
unsigned int V_34 = F_21 ( V_48 -> V_110 ) ;
int V_111 = 0 ;
int V_41 ;
F_16 ( V_112 , V_2 -> V_8 + V_96 ) ;
F_15 ( V_2 , V_33 , V_34 ) ;
F_17 ( V_2 , V_33 , V_33 ) ;
for ( V_41 = 0 ; V_41 < V_48 -> V_113 ; V_41 ++ ) {
F_22 ( V_2 ) ;
F_23 ( V_2 ) ;
V_111 = F_49 ( V_2 , V_16 , V_48 , F_26 , 0 ) ;
if ( V_111 )
break;
V_109 [ V_41 ] = F_24 ( V_2 , V_16 ) ;
}
F_16 ( V_102 , V_2 -> V_8 + V_96 ) ;
F_22 ( V_2 ) ;
...
unsigned int * V_109 )
{
V_109 [ 1 ] = F_25 ( V_2 -> V_8 + V_114 ) |
( F_25 ( V_2 -> V_8 + V_115 ) << 8 ) ;
return V_48 -> V_113 ;
}
...
{
if ( F_52 ( V_16 , V_109 ) ) {
F_16 ( V_16 -> V_116 & 0xff , V_2 -> V_8 + V_114 ) ;
F_16 ( ( V_16 -> V_116 >> 8 ) , V_2 -> V_8 + V_115 ) ;
}
V_109 [ 1 ] = V_16 -> V_116 ;
return V_48 -> V_113 ;
}
...
F_16 ( 0 , V_2 -> V_8 + V_114 ) ;
F_16 ( 0 , V_2 -> V_8 + V_115 ) ;
}
static int F_54 ( struct V_1 * V_2 , struct V_117 * V_118 )
{
const struct V_119 * V_120 = F_55 ( V_2 ) ;
struct V_4 * V_5 ;
struct V_15 * V_16 ;
int V_111 ;
int V_41 ;
V_5 = F_56 ( V_2 , sizeof( * V_5 ) ) ;
if ( ! V_5 )
return - V_121 ;
V_111 = F_57 ( V_2 , V_118 -> V_122 [ 0 ] , 0x10 ) ;
if ( V_111 )
return V_111 ;
if ( V_118 -> V_122 [ 1 ] >= 2 && V_118 -> V_122 [ 1 ] <= 7 ) {
V_111 = F_58 ( V_118 -> V_122 [ 1 ] , F_30 , 0 ,
V_2 -> V_123 , V_2 ) ;
if ( V_111 == 0 )
V_2 -> V_64 = V_118 -> V_122 [ 1 ] ;
}
if ( V_2 -> V_64 && ( V_118 -> V_122 [ 2 ] == 3 || V_118 -> V_122 [ 2 ] == 1 ) ) {
V_111 = F_59 ( V_118 -> V_122 [ 2 ] , V_2 -> V_123 ) ;
if ( V_111 ) {
F_60 ( V_2 -> V_108 ,
L_4 ,
V_118 -> V_122 [ 2 ] ) ;
...
unsigned long V_71 ;
V_71 = F_61 ( V_126 , V_5 -> V_124 ) ;
if ( ! V_71 )
return - V_121 ;
V_5 -> V_71 [ V_41 ] = V_71 ;
V_5 -> V_31 [ V_41 ] = F_62 ( ( void * ) V_71 ) ;
}
}
V_111 = F_63 ( V_2 , 4 ) ;
if ( V_111 )
...
F_65 ( V_5 -> V_29 ) ;
if ( V_5 -> V_71 [ 0 ] )
F_66 ( V_5 -> V_71 [ 0 ] , V_5 -> V_124 ) ;
if ( V_5 -> V_71 [ 1 ] )
F_66 ( V_5 -> V_71 [ 1 ] , V_5 -> V_124 ) ;
}
F_67 ( V_2 ) ;
}
