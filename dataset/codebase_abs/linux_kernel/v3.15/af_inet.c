...
static T_8 int F_147 ( struct V_43 * V_43 )
{
F_148 ( & V_43 -> V_79 . V_356 . V_357 ) ;
V_43 -> V_79 . V_356 . V_358 [ 0 ] = 32768 ;
V_43 -> V_79 . V_356 . V_358 [ 1 ] = 61000 ;
F_148 ( & V_43 -> V_79 . V_359 . V_357 ) ;
V_43 -> V_79 . V_359 . V_358 [ 0 ] = F_149 ( & V_360 , 1 ) ;
V_43 -> V_79 . V_359 . V_358 [ 1 ] = F_149 ( & V_360 , 0 ) ;
return 0 ;
}
static T_9 void F_150 ( struct V_43 * V_43 )
{
}
...
struct V_220 * V_366 ;
int V_313 = - V_28 ;
F_159 ( sizeof( struct V_367 ) > F_160 ( struct V_252 , V_368 ) ) ;
V_369 = F_141 ( 65536 / 8 , V_69 ) ;
if ( ! V_369 )
goto V_31;
V_313 = F_161 ( & V_370 , 1 ) ;
if ( V_313 )
...
F_164 () ;
#endif
if ( F_165 ( & V_379 , V_380 ) < 0 )
F_154 ( L_11 , V_249 ) ;
if ( F_165 ( & V_381 , V_282 ) < 0 )
F_154 ( L_12 , V_249 ) ;
if ( F_165 ( & V_382 , V_156 ) < 0 )
F_154 ( L_13 , V_249 ) ;
#ifdef F_166
if ( F_165 ( & V_383 , V_384 ) < 0 )
F_154 ( L_14 , V_249 ) ;
#endif
for ( V_366 = & V_226 [ 0 ] ; V_366 < & V_226 [ V_224 ] ; ++ V_366 )
F_167 ( V_366 ) ;
for ( V_365 = V_385 ; V_365 < & V_385 [ V_386 ] ; ++ V_365 )
F_72 ( V_365 ) ;
F_168 () ;
F_169 () ;
F_170 () ;
