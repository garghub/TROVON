...
static void F_30 ( T_2 V_23 , T_3 V_55 , void * V_56 )
{
struct V_17 * V_18 ;
struct V_47 * V_22 ;
T_3 V_57 = V_58 ;
...
( void ) F_32 ( V_23 , V_55 , V_57 , NULL ) ;
return;
}
static int F_33 ( struct V_47 * V_22 )
{
int V_19 ;
...
F_11 ( & V_18 -> V_44 ) ;
V_18 -> V_22 = V_22 ;
sprintf ( F_34 ( V_22 ) , L_15 , V_65 ) ;
sprintf ( F_35 ( V_22 ) , L_15 , V_66 ) ;
V_22 -> V_67 = V_18 ;
V_19 = F_13 ( V_18 ) ;
if ( V_19 ) {
F_17 ( V_18 ) ;
...
static int F_36 ( struct V_47 * V_22 )
{
struct V_17 * V_18 = NULL ;
if ( ! V_22 || ! F_24 ( V_22 ) )
return - V_21 ;
