...
static int F_98 ( struct V_36 * V_26 , char * V_127 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
if ( F_1 ( V_1 ) || F_3 ( V_1 ) ) {
if ( ! F_99 ( V_127 ) && ! F_100 ( V_127 ) )
return - V_128 ;
} else {
if ( ! F_99 ( V_127 ) )
return - V_128 ;
...
static int F_101 ( struct V_36 * V_26 , void * V_131 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
...
static int F_105 ( struct V_36 * V_26 , void * V_131 )
{
struct V_132 * V_82 = V_131 ;
char * V_127 = V_82 -> V_133 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
...
if ( F_109 ( V_1 -> V_137 [ V_29 ] , V_137 [ V_140 ] ) )
break;
if ( V_140 == V_125 )
F_110 ( V_1 , V_1 -> V_137 [ V_29 ] ) ;
}
for ( V_29 = 0 ; V_29 < V_125 ; V_29 ++ ) {
for ( V_140 = 0 ; V_140 < V_1 -> V_125 ; V_140 ++ )
if ( F_109 ( V_137 [ V_29 ] , V_1 -> V_137 [ V_140 ] ) )
break;
if ( V_140 == V_1 -> V_125 )
F_111 ( V_1 , V_137 [ V_29 ] ) ;
}
for ( V_29 = 0 ; V_29 < V_125 ; V_29 ++ )
...
if ( F_109 ( V_1 -> V_141 [ V_29 ] , V_141 [ V_140 ] ) )
break;
if ( V_140 == V_126 )
F_110 ( V_1 , V_1 -> V_141 [ V_29 ] ) ;
}
for ( V_29 = 0 ; V_29 < V_126 ; V_29 ++ ) {
for ( V_140 = 0 ; V_140 < V_1 -> V_126 ; V_140 ++ )
if ( F_109 ( V_141 [ V_29 ] , V_1 -> V_141 [ V_140 ] ) )
break;
if ( V_140 == V_1 -> V_126 )
F_111 ( V_1 , V_141 [ V_29 ] ) ;
}
for ( V_29 = 0 ; V_29 < V_126 ; V_29 ++ )
...
static void F_117 ( struct V_36 * V_26 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
F_31 ( & V_1 -> V_52 ) ;
}
static int F_118 ( struct V_36 * V_26 , int V_8 , T_1 * V_151 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
struct V_152 * V_153 ;
int V_134 ;
F_119 ( V_1 , V_8 , V_153 , & V_134 ) ;
if ( V_134 )
return V_134 ;
if ( F_99 ( V_151 ) || F_100 ( V_151 ) ) {
if ( V_8 == V_154 ) {
...
static int F_122 ( struct V_36 * V_26 , int V_8 ,
struct V_158 * V_159 [] )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
struct V_152 V_160 ;
...
V_153 -> V_164 |= V_165 ;
V_153 -> V_166 = F_123 ( V_159 [ V_162 ] ) ;
if ( V_159 [ V_167 ] ) {
V_153 -> V_164 |= V_168 ;
memcpy ( V_153 -> V_169 , F_124 ( V_159 [ V_167 ] ) ,
V_170 ) ;
}
if ( V_159 [ V_171 ] ) {
V_153 -> V_164 |= V_172 ;
memcpy ( V_153 -> V_173 ,
F_124 ( V_159 [ V_171 ] ) , V_174 ) ;
}
if ( V_159 [ V_175 ] ) {
V_153 -> V_164 |= V_176 ;
memcpy ( V_153 -> V_177 ,
F_124 ( V_159 [ V_175 ] ) , V_174 ) ;
}
if ( V_8 == V_154 ) {
if ( ! F_100 ( V_160 . V_155 ) )
...
V_134 = F_126 ( V_1 , V_8 , & V_160 , & V_161 ) ;
if ( V_134 ) {
if ( V_161 ) {
memcpy ( V_153 , & V_160 , sizeof( * V_153 ) ) ;
} else {
...
return - V_184 ;
V_134 = F_128 ( V_1 , V_8 , V_153 -> V_166 , & V_182 ) ;
if ( V_134 )
return V_134 ;
if ( F_129 ( V_63 , V_162 , V_153 -> V_166 ) ||
F_129 ( V_63 , V_185 , V_182 ) ||
( ( V_153 -> V_164 & V_168 ) &&
F_130 ( V_63 , V_167 , V_170 , V_153 -> V_169 ) ) ||
( ( V_153 -> V_164 & V_172 ) &&
F_130 ( V_63 , V_171 , V_174 ,
V_153 -> V_173 ) ) ||
( ( V_153 -> V_164 & V_176 ) &&
F_130 ( V_63 , V_175 , V_174 , V_153 -> V_177 ) ) )
goto V_186;
return 0 ;
V_186:
return - V_187 ;
}
static void F_131 ( struct V_188 * V_33 , struct V_189 * V_13 )
{
...
static int F_132 ( struct V_188 * V_33 )
{
struct V_1 * V_1 = F_7 ( V_33 -> V_14 ) ;
struct V_36 * V_26 = V_1 -> V_26 ;
struct V_62 * V_63 ;
...
T_6 V_16 ;
V_63 = F_133 ( V_26 , V_17 ) ;
if ( ! V_63 )
return - V_193 ;
V_16 = F_71 ( V_1 -> V_2 , V_63 -> V_44 ,
V_17 , V_190 ) ;
F_134 ( V_33 , V_63 , V_192 ,
V_16 , V_17 ) ;
return 0 ;
}
static void F_135 ( struct V_188 * V_33 ,
...
return;
V_63 = V_13 -> V_19 ;
F_136 ( V_63 -> V_44 - V_218 ) ;
F_8 ( V_1 -> V_2 , V_13 -> V_16 ,
V_13 -> V_17 , V_190 ) ;
F_137 ( (struct V_219 * ) V_20 ,
...
unsigned int V_57 = - 1 ;
unsigned int V_237 , V_238 = 0 , V_58 ;
int V_134 ;
if ( V_233 > 0 )
...
0 ,
0 ) ;
V_134 = F_150 ( & V_1 -> V_33 [ V_33 ] , F_132 ) ;
if ( V_134 )
V_237 = V_239 ;
if ( V_237 < V_239 ) {
F_151 ( V_54 ) ;
...
F_185 ( & V_1 -> V_33 [ 0 ] , F_131 ) ;
F_186 ( & V_1 -> V_56 [ 0 ] ) ;
F_187 ( & V_1 -> V_49 [ 0 ] ) ;
V_26 -> V_35 = V_257 ;
F_150 ( & V_1 -> V_33 [ 0 ] , F_132 ) ;
...
if ( F_222 ( V_1 -> V_2 , V_1 -> V_60 ,
V_291 + V_292 + 2 , V_291 + V_292 + 2 ) > 0 ) {
V_1 -> V_32 = V_291 ;
V_1 -> V_31 = V_292 ;
V_1 -> V_256 = V_291 + V_292 ;
V_1 -> V_252 = V_291 + V_292 + 2 ;
