...
if ( V_22 && F_13 ( V_22 , V_6 -> V_26 ,
& V_20 -> V_27 ) && F_13 ( V_22 ,
V_22 , V_28 ) ) {
V_23 = F_14 ( V_22 ) ;
goto V_29;
} else if ( F_15 ( F_11 ( V_6 ) , & V_20 -> V_27 ) &&
F_4 ( V_25 -> V_30 , V_6 -> V_8 [ 0 ] . V_11 ) ) {
V_23 = F_11 ( V_6 ) ;
if ( V_22 )
F_16 ( V_23 , V_22 ) ;
}
...
void F_17 ( struct V_5 * V_6 , int V_9 , T_1 V_11 , int V_31 )
{
int V_32 , V_33 ;
unsigned long V_34 ;
F_9 ( ! F_10 ( V_9 ) ) ;
F_18 ( & V_6 -> V_35 , V_34 ) ;
V_32 = V_6 -> V_8 [ V_9 ] . V_12 ;
if ( ! V_31 ) {
if ( V_32 == V_18 ) {
goto V_29;
}
V_33 = V_6 -> V_8 [ V_6 -> V_16 - 1 ] . V_9 ;
V_6 -> V_8 [ V_32 ] . V_11 = V_6 -> V_8 [ V_6 -> V_16 - 1 ] . V_11 ;
V_6 -> V_8 [ V_32 ] . V_9 = V_33 ;
V_6 -> V_16 -- ;
V_6 -> V_8 [ V_33 ] . V_12 = V_32 ;
V_6 -> V_8 [ V_9 ] . V_12 = V_18 ;
while ( V_32 > 0 && F_4 (
V_6 -> V_8 [ F_1 ( V_32 ) ] . V_11 ,
V_6 -> V_8 [ V_32 ] . V_11 ) ) {
F_5 ( V_6 , V_32 , F_1 ( V_32 ) ) ;
V_32 = F_1 ( V_32 ) ;
}
F_16 ( V_9 , V_6 -> V_26 ) ;
F_7 ( V_6 , V_32 ) ;
