...
case F_29 ( V_109 ) :
V_2 -> V_3 = F_34 ( V_80 -> V_110 . V_111 . V_112 . V_113 ) ;
V_83 = 0 ;
break;
case F_29 ( V_114 ) :
...
( V_92 & V_119 ) ) {
F_35 ( V_82 ) ;
V_88 = (struct V_87 * ) F_36 ( V_82 , sizeof( * V_88 ) ) ;
V_88 -> V_120 = V_121 ;
}
V_106:
return V_83 ;
}
int F_37 ( struct V_122 * V_123 ,
struct V_124 * V_125 ,
T_5 * V_126 )
{
...
T_2 V_129 ;
T_5 V_130 , V_131 ;
if ( F_38 ( V_82 ) && ( F_39 ( V_82 ) -> V_132 != V_133 ) ) {
F_40 ( V_123 -> V_30 , L_7 ,
F_39 ( V_82 ) -> V_132 ) ;
return - V_84 ;
}
F_41 ( V_82 , V_82 -> V_134 ) ;
F_42 ( V_82 , V_82 -> V_134 +
sizeof( struct V_101 ) ) ;
V_130 = ( (struct V_101 * ) F_43 ( V_82 ) ) -> V_135 ;
switch ( V_130 ) {
case V_136 :
V_128 = V_137 ;
break;
...
break;
default:
F_44 ( V_123 -> V_30 , L_8 , V_130 ) ;
return - V_84 ;
}
F_45 ( V_82 , V_82 -> V_3 - 4 , & V_131 , 1 ) ;
switch ( V_131 ) {
case V_142 :
V_128 |= V_143 ;
break;
...
break;
default:
F_44 ( V_123 -> V_30 , L_9 , V_131 ) ;
return - V_84 ;
}
V_86 = (struct V_85 * ) F_46 ( V_82 ) ;
...
* V_126 += F_47 ( V_82 ) +
sizeof( struct V_85 ) ;
V_125 -> V_152 = F_48 ( V_82 -> V_3 - * V_126 ,
F_39 ( V_82 ) -> V_153 ) ;
V_125 -> V_154 += ( V_125 -> V_152 - 1 ) * * V_126 ;
V_125 -> V_155 |= V_156 ;
}
V_125 -> V_155 |= V_157 | V_158 ;
V_129 = F_39 ( V_82 ) -> V_153 << V_159 ;
V_127 = F_47 ( V_82 ) +
sizeof( struct V_85 ) ;
V_127 |= ( F_47 ( V_82 ) - 4 )
<< V_160 ;
V_127 |= V_125 -> V_155 & V_161 ;
F_49 ( V_123 , V_127 , V_128 ,
V_162 , V_129 ) ;
return 0 ;
}
static void F_50 ( struct V_12 * V_13 , unsigned int V_163 )
{
struct V_36 * V_37 ;
...
F_5 ( V_20 , F_56 ( V_186 ) , V_176 ) ;
F_5 ( V_20 , F_57 ( V_186 ) , 0 ) ;
if ( ! ( V_15 -> V_182 & V_187 ) )
return;
...
if ( ! V_13 -> V_37 )
return 0 ;
V_204 = F_64 ( V_43 , V_57 ) ;
if ( ! V_204 )
return - V_170 ;
V_205 = F_65 ( V_30 , V_204 , V_43 , V_31 ) ;
if ( F_66 ( V_30 , V_205 ) ) {
F_14 ( V_52 , L_11 ) ;
F_62 ( V_204 ) ;
return - V_170 ;
...
int F_80 ( struct V_9 * V_10 , V_62 * V_214 , int type )
{
int V_83 = - V_84 ;
T_1 V_215 = 0xffff ;
struct V_14 * V_15 = F_3 ( V_10 ) ;
...
L_17 ) ;
V_225 = F_83 ( V_15 -> V_29 , V_230 ) ;
if ( V_225 ) {
V_225 += 4 ;
for ( V_39 = 0 ; V_39 < 8 ; V_39 ++ )
F_84 ( V_15 -> V_29 , V_225 + V_39 , & V_226 [ V_39 ] ) ;
...
{
#ifdef F_86
return F_87 ( V_15 -> V_10 , V_15 -> V_13 . V_243 ) ;
#else
return 0 ;
#endif
}
