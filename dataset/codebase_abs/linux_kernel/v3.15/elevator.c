...
static T_4
F_99 ( struct V_27 * V_23 , struct V_108 * V_109 , char * V_110 )
{
...
static T_4
F_101 ( struct V_27 * V_23 , struct V_108 * V_109 ,
...
static int F_116 ( struct V_4 * V_5 , struct V_11 * V_131 )
{
struct V_6 * V_132 = V_5 -> V_8 ;
bool V_118 = V_132 -> V_118 ;
int V_22 ;
F_117 ( V_5 ) ;
if ( V_118 )
F_106 ( V_5 ) ;
...
struct V_1 * V_2 )
{
struct V_44 * V_141 = F_131 ( & V_2 -> V_44 ) ;
if ( V_141 )
return F_132 ( V_141 ) ;
return NULL ;
}
...
struct V_1 * V_2 )
{
struct V_44 * V_142 = F_134 ( & V_2 -> V_44 ) ;
if ( V_142 )
return F_132 ( V_142 ) ;
return NULL ;
}
