...
V_5 -> V_7 = F_127 ( & V_212 -> V_62 , V_229 ) ;
if ( F_67 ( V_5 -> V_7 ) )
return F_128 ( V_5 -> V_7 ) ;
V_203 = F_126 ( V_212 , V_245 , 0 ) ;
if ( ! V_203 ) {
F_129 ( & V_212 -> V_62 , L_7 ) ;
return - V_246 ;
}
if ( F_130 ( & V_212 -> V_62 , V_203 -> V_247 , F_100 , 0 ,
V_5 -> V_225 , V_5 ) ) {
F_129 ( V_5 -> V_62 , L_8 ) ;
return - V_166 ;
}
...
V_5 -> V_65 = F_131 ( V_5 -> V_225 , V_5 -> V_62 ,
V_63 * sizeof( struct V_49 ) , 8 , V_250 ) ;
if ( ! V_5 -> V_65 )
return - V_82 ;
F_132 ( & V_5 -> V_167 ) ;
V_5 -> V_213 = F_133 ( & V_212 -> V_62 , L_9 ) ;
if ( F_67 ( V_5 -> V_213 ) ) {
F_134 ( & V_212 -> V_62 , L_10 ) ;
F_135 ( & V_212 -> V_62 , & V_251 ) ;
return F_128 ( V_5 -> V_213 ) ;
}
if ( F_112 ( V_5 -> V_213 ) ) {
F_134 ( & V_212 -> V_62 , L_11 ) ;
F_136 ( V_5 -> V_213 ) ;
return - V_202 ;
}
V_117 = F_137 ( & V_212 -> V_62 , & V_251 ) ;
if ( V_117 ) {
F_110 ( V_5 -> V_213 ) ;
F_136 ( V_5 -> V_213 ) ;
return V_117 ;
...
F_7 ( V_252 | V_253 ,
V_5 -> V_7 + V_254 ) ;
F_138 ( & V_5 -> V_156 , F_101 ,
( unsigned long ) V_5 ) ;
F_139 ( & V_5 -> V_160 ) ;
F_139 ( & V_5 -> V_192 ) ;
F_139 ( & V_5 -> V_163 ) ;
V_5 -> V_161 = 0 ;
F_140 ( & V_5 -> V_135 , F_102 ,
( unsigned long ) V_5 ) ;
F_141 ( V_212 , V_5 ) ;
F_139 ( & V_5 -> V_255 ) ;
for ( V_61 = 0 ; V_61 < V_5 -> V_238 ; ++ V_61 ) {
V_5 -> V_236 [ V_61 ] . V_5 = V_5 ;
V_117 = F_142 ( & V_5 -> V_236 [ V_61 ] . V_3 ) ;
if ( ! V_117 ) {
