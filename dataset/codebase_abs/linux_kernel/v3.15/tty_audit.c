...
T_2 V_21 = F_11 ( V_19 ) ;
T_3 V_22 = F_12 ( & V_23 , F_13 ( V_19 ) ) ;
T_3 V_24 = F_12 ( & V_23 , F_14 ( V_19 ) ) ;
unsigned int V_25 = F_15 ( V_19 ) ;
V_17 = F_16 ( NULL , V_6 , V_26 ) ;
if ( V_17 ) {
char V_27 [ sizeof( V_19 -> V_28 ) ] ;
F_17 ( V_17 , L_1
L_2 , V_14 , V_21 , V_22 ,
V_24 , V_25 , V_2 , V_3 ) ;
F_18 ( V_27 , V_19 ) ;
...
void F_27 ( struct V_34 * V_35 , char V_36 )
{
struct V_1 * V_5 ;
int V_2 , V_3 , V_37 ;
unsigned long V_38 ;
F_28 ( & V_20 -> V_39 -> V_40 , V_38 ) ;
V_37 = V_20 -> signal -> V_32 ;
V_5 = V_20 -> signal -> V_1 ;
if ( V_5 )
F_29 ( & V_5 -> V_11 ) ;
F_30 ( & V_20 -> V_39 -> V_40 , V_38 ) ;
V_2 = V_35 -> V_41 -> V_2 ;
...
static struct V_1 * F_37 ( struct V_34 * V_35 ,
unsigned V_4 )
{
struct V_1 * V_5 , * V_47 ;
unsigned long V_38 ;
...
void F_40 ( struct V_34 * V_35 , unsigned char * V_8 ,
