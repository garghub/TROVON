...
static int F_47 ( struct V_56 * V_57 , struct V_28 * V_29 ,
struct V_12 * V_13 , int V_30 , int V_31 ,
unsigned int V_32 , unsigned int V_33 ,
T_2 V_34 , T_2 V_35 ,
T_2 V_36 , T_2 V_37 )
{
struct V_1 * V_1 = F_48 ( V_57 ) ;
int V_39 = 0 ;
F_8 ( L_11 , V_57 ) ;
if ( ! V_1 -> V_53 )
V_39 = F_30 ( V_1 ) ;
...
struct V_1 * F_54 ( struct V_61 * V_23 , struct V_62 * V_2 ,
