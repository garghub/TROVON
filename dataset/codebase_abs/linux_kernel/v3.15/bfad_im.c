...
struct V_16 *
F_32 ( struct V_52 * V_53 , int V_184 )
{
...
{
struct V_14 * V_15 =
(struct V_14 * ) V_190 -> V_191 ;
struct V_192 * V_78 = V_15 -> V_17 -> V_74 -> V_78 ;
struct V_193 * V_194 = V_15 -> V_17 -> V_74 -> V_190 ;
struct V_195 * V_196 = F_95 ( V_78 ) ;
int V_89 = 0 , V_197 = - V_198 ;
for ( V_89 = 0 ; V_89 < V_199 ; V_89 ++ ) {
if ( V_196 [ V_89 ] . V_98 == V_200 &&
F_96 ( & V_196 [ V_89 ] . V_85 ) == V_93 -> V_85 &&
V_196 [ V_89 ] . V_201 == V_194 -> V_202 &&
V_196 [ V_89 ] . V_203 == ( T_1 ) V_194 -> V_204 . V_203 ) {
V_197 = V_75 ;
break;
}
}
...
{
struct V_189 * V_190 = F_98 ( F_99 ( V_93 ) ) ;
struct V_14 * V_15 ;
struct V_192 * V_78 ;
if ( ! V_190 || F_100 ( V_190 ) )
return - V_198 ;
V_15 = (struct V_14 * ) V_190 -> V_191 ;
...
V_209:
V_93 -> V_34 = V_190 -> V_191 ;
return 0 ;
}
T_4
F_102 ( struct V_192 * V_78 )
{
struct V_210 * V_211 ;
T_4 V_212 = 0 ;
V_211 = F_35 ( sizeof( struct V_210 ) , V_122 ) ;
if ( ! V_211 )
return 0 ;
F_103 ( & V_78 -> V_213 , V_211 ) ;
if ( V_211 -> V_214 . V_215 == V_216 )
V_212 |= V_217 | V_218 |
V_219 | V_220 ;
else if ( V_211 -> V_214 . V_215 == V_221 ) {
if ( V_211 -> V_214 . V_222 ) {
V_212 |= V_218 |
V_219 |
V_220 | V_223 ;
} else {
...
} else if ( V_211 -> V_214 . V_215 == V_224 ) {
V_212 |= V_219 | V_220 |
V_223 ;
} else if ( V_211 -> V_214 . V_215 == V_225 ) {
V_212 |= V_226 ;
}
F_67 ( V_211 ) ;
return V_212 ;
...
char V_227 [ V_228 ] ;
struct V_229 * V_230 = F_105 ( & V_13 -> V_78 ) ;
F_106 ( V_32 ) =
F_107 ( ( F_108 ( V_105 -> V_231 ) ) ) ;
F_109 ( V_32 ) =
F_107 ( ( F_110 ( V_105 -> V_231 ) ) ) ;
...
F_114 ( V_32 ) [ 2 ] = 1 ;
F_114 ( V_32 ) [ 7 ] = 1 ;
F_115 ( V_227 , V_13 -> V_235 . V_236 . V_237 . V_238 . V_239 . V_227 ,
V_228 ) ;
sprintf ( F_116 ( V_32 ) , L_15 , V_227 ) ;
F_117 ( V_32 ) = F_102 ( & V_13 -> V_78 ) ;
F_118 ( V_32 ) = V_230 -> V_240 . V_241 ;
}
static void
...
V_243 . V_245 =
F_107 ( F_40 ( & V_17 -> V_81 ) ) ;
V_243 . V_246 =
F_121 ( F_41 ( & V_17 -> V_81 ) ) ;
V_243 . V_247 = V_248 ;
V_17 -> V_189 = V_189 =
F_122 ( V_53 -> V_50 , 0 , & V_243 ) ;
if ( ! V_189 )
return;
V_189 -> V_249 =
F_123 ( & V_17 -> V_81 ) ;
V_189 -> V_250 = F_124 ( & V_17 -> V_81 ) ;
V_15 = V_189 -> V_191 ;
V_15 -> V_17 = V_17 ;
V_243 . V_247 |= V_251 ;
if ( V_243 . V_247 != V_248 )
F_125 ( V_189 , V_243 . V_247 ) ;
if ( ( V_189 -> V_252 != - 1 )
&& ( V_189 -> V_252 < V_91 ) )
V_17 -> V_188 = V_189 -> V_252 ;
V_17 -> V_253 = V_189 -> V_253 ;
return;
}
static void
...
static int
F_128 ( struct V_10 * V_11 , void (* V_209) ( struct V_10 * ) )
{
struct V_52 * V_53 =
...
int V_60 ;
int V_256 = 0 ;
struct V_189 * V_190 = F_98 ( F_99 ( V_11 -> V_31 ) ) ;
V_60 = F_100 ( V_190 ) ;
if ( V_60 ) {
V_11 -> V_26 = V_60 ;
V_209 ( V_11 ) ;
...
V_11 -> V_26 = F_5 ( V_259 , 0 ) ;
goto V_263;
}
V_17 = V_15 -> V_17 ;
if ( ! V_17 ) {
V_11 -> V_26 = F_5 ( V_264 , 0 ) ;
goto V_263;
}
