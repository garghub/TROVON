...
if ( V_2 -> V_7 == V_8 &&
! ( V_2 -> V_15 -> V_21 & V_40 ) ) {
F_11 ( V_26 , V_26 -> V_35 -> V_41 - V_26 -> V_35 -> V_42 ) ;
return;
}
if ( V_2 -> V_43 . type != V_13 ) {
if ( F_12 ( V_2 -> V_10 , & V_2 -> V_43 , F_13 () , 0 ) < 0 )
return;
V_2 -> V_43 . type = V_13 ;
}
while ( 1 ) {
V_36 = F_14 ( V_26 , V_38 , sizeof( V_38 ) ) ;
if ( V_36 <= 0 )
break;
V_39 = V_38 ;
while ( V_36 > 0 ) {
V_37 = F_15 ( V_2 -> V_27 , V_39 , V_36 , & V_2 -> V_43 ) ;
if ( V_37 < 0 ) {
F_16 ( V_2 -> V_27 ) ;
continue;
}
...
static int F_17 ( struct V_33 * V_26 )
{
...
V_35 -> V_29 = V_2 ;
F_21 ( & V_15 -> V_18 , V_21 ) ;
F_22 ( & V_2 -> V_48 , & V_15 -> V_49 ) ;
F_23 ( & V_15 -> V_18 , V_21 ) ;
V_2 -> V_15 = V_15 ;
return 0 ;
}
static int F_24 ( struct V_33 * V_26 )
{
struct V_14 * V_15 = V_26 -> V_44 -> V_29 ;
struct V_45 * V_35 = V_26 -> V_35 ;
struct V_1 * V_2 ;
...
static int F_25 ( struct V_33 * V_26 )
{
struct V_1 * V_2 = V_26 -> V_35 -> V_29 ;
F_26 ( V_2 -> V_27 ) ;
F_27 ( & V_2 -> V_48 ) ;
...
static int F_29 ( void * V_29 ,
struct V_51 * V_52 )
{
struct V_14 * V_15 ;
V_15 = V_29 ;
if ( ! F_30 ( V_15 -> V_53 -> V_54 ) )
return - V_55 ;
V_15 -> V_21 |= V_40 ;
return 0 ;
}
static int F_31 ( void * V_29 ,
struct V_51 * V_52 )
{
struct V_14 * V_15 ;
V_15 = V_29 ;
...
if ( V_15 -> V_10 >= 0 )
return 0 ;
V_59 = F_18 ( sizeof( * V_59 ) , V_46 ) ;
if ( ! V_59 ) {
V_60 = - V_47 ;
goto V_61;
}
V_10 = F_36 ( V_15 -> V_53 , V_15 -> V_62 ,
L_1 , V_15 -> V_44 -> V_63 ,
V_15 -> V_53 -> V_64 ,
V_15 -> V_62 ) ;
if ( V_10 < 0 ) {
...
static int F_40 ( struct V_87 * V_44 )
{
...
static int F_42 ( struct V_87 * V_44 )
{
struct V_14 * V_15 = V_44 -> V_29 ;
if ( V_15 -> V_7 == V_8 )
F_39 ( V_15 ) ;
...
static void F_43 ( struct V_87 * V_44 )
{
struct V_14 * V_15 = V_44 -> V_29 ;
F_20 ( V_15 ) ;
}
int F_44 ( struct V_89 * V_53 , int V_62 , struct V_87 * * V_90 )
{
struct V_87 * V_44 ;
struct V_14 * V_15 ;
int V_60 ;
* V_90 = NULL ;
if ( ( V_60 = F_45 ( V_53 , L_4 , V_62 ,
16 ,
16 ,
& V_44 ) ) < 0 )
return V_60 ;
strcpy ( V_44 -> V_63 , V_44 -> V_91 ) ;
V_15 = F_18 ( sizeof( * V_15 ) , V_46 ) ;
if ( V_15 == NULL ) {
F_46 ( V_53 , V_44 ) ;
return - V_47 ;
}
