...
static T_3
F_165 ( struct V_243 * V_76 , struct V_244 * V_245 , char * V_158 )
{
struct V_247 * V_248 ;
V_248 = F_166 ( V_76 ) ;
if ( ! V_248 )
...
static T_3
F_167 ( struct V_243 * V_76 , struct V_244 * V_245 , char * V_158 )
{
struct V_18 * V_19 ;
V_19 = F_163 ( V_76 ) ;
...
static T_3
F_168 ( struct V_243 * V_76 , struct V_244 * V_245 , const char * V_158 , T_4 V_33 )
{
struct V_18 * V_19 ;
int V_246 ;
V_19 = F_163 ( V_76 ) ;
...
static T_3
F_169 ( struct V_243 * V_76 , struct V_244 * V_245 ,
...
if ( V_19 -> V_15 != V_165 )
return - V_61 ;
V_222 = F_170 ( V_158 , & V_149 , 16 ) ;
if ( V_222 == 1 )
F_129 ( V_19 ) ;
return V_33 ;
}
static int
F_171 ( struct V_247 * V_254 )
{
struct V_18 * V_19 ;
if ( ! F_172 ( & V_254 -> V_76 ) )
return - V_249 ;
...
return 0 ;
F_177 ( V_19 -> V_76 , & V_254 -> V_76 ) ;
return F_178 ( V_19 -> V_76 ) ;
}
static int
F_179 ( struct V_247 * V_254 )
{
struct V_18 * V_19 ;
...
V_261 = V_19 -> V_15 ;
V_20 = F_180 ( V_19 -> V_26 . V_77 ) ;
if ( V_20 )
goto V_262;
V_20 = F_180 ( V_19 -> V_27 . V_77 ) ;
if ( V_20 )
goto V_263;
F_9 ( 3 , V_8 , L_117 ) ;
F_40 ( V_19 ) ;
...
if ( F_176 ( V_254 ) != 0 )
goto V_164;
F_103 ( L_124 , V_19 -> V_76 -> V_228 ,
( V_19 -> V_143 & V_272 ) ?
L_125 : L_126 ) ;
F_103 ( L_127 , V_19 -> V_76 -> V_228 ,
( V_19 -> V_143 & V_147 ) ?
L_125 : L_126 ) ;
return 0 ;
V_164:
F_183 ( V_19 -> V_27 . V_77 ) ;
V_263:
F_183 ( V_19 -> V_26 . V_77 ) ;
V_262:
return - V_249 ;
}
static int
F_184 ( struct V_247 * V_254 , int V_273 )
{
struct V_18 * V_19 ;
enum V_260 V_261 ;
...
V_275 = F_183 ( V_19 -> V_26 . V_77 ) ;
V_276 = F_183 ( V_19 -> V_27 . V_77 ) ;
if ( ! V_274 )
...
int V_20 = 0 ;
if ( V_19 -> V_15 == V_271 )
V_20 = F_179 ( V_19 -> V_256 ) ;
if ( V_19 -> V_76 )
F_191 ( V_19 -> V_76 ) ;
if ( V_20 ) {
F_127 ( & V_19 -> V_256 -> V_76 , L_136
L_137 ) ;
}
return V_20 ;
}
static int F_192 ( struct V_247 * V_256 )
{
return 0 ;
}
static void F_193 ( struct V_247 * V_256 )
{
return;
}
...
static int F_196 ( struct V_247 * V_256 )
{
struct V_18 * V_19 = F_163 ( & V_256 -> V_76 ) ;
return F_190 ( V_19 ) ;
}
static T_3 F_197 ( struct V_280 * V_281 ,
const char * V_158 , T_4 V_33 )
{
int V_282 ;
V_282 = F_198 ( V_283 , & V_284 , 2 , V_158 ) ;
