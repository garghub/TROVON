...
static int F_45 ( struct V_94 * V_19 )
{
struct V_95 * V_65 ;
struct V_2 * V_3 ;
struct V_96 * V_97 ;
...
F_25 ( V_88 ) ;
V_38 = F_49 ( & V_19 -> V_20 , V_105 ,
V_106 , V_107 ,
sizeof( struct V_2 ) , & V_65 ) ;
if ( V_38 ) {
F_4 ( & V_19 -> V_20 , L_12 ) ;
goto V_108;
}
...
F_54 ( V_93 ) ;
F_55 ( V_113 , V_93 ) ;
V_3 -> V_10 . V_9 = F_56 ( V_93 , F_41 , & V_99 -> V_79 ) ;
if ( V_3 -> V_10 . V_9 ) {
struct V_114 V_115 = {
. V_116 = V_97 -> V_110 + V_117 ,
. V_118 = V_119 ,
. V_120 = 1 ,
. V_121 = 1 ,
. V_7 = V_23 ,
...
F_59 ( V_19 , V_65 ) ;
F_60 ( & V_19 -> V_20 , L_22 ,
V_3 -> V_97 , F_61 ( & V_3 -> V_10 . V_9 -> V_20 -> V_81 ) ) ;
return V_38 ;
V_126:
F_62 ( V_3 -> V_10 . V_9 ) ;
V_3 -> V_10 . V_9 = NULL ;
...
static int F_66 ( struct V_81 * V_19 )
{
struct V_95 * V_65 = F_67 ( V_19 ) ;
...
static int F_68 ( struct V_81 * V_19 )
{
struct V_95 * V_65 = F_67 ( V_19 ) ;
struct V_2 * V_3 = V_65 -> V_69 ;
F_25 ( V_3 -> V_88 ) ;
...
static int F_69 ( struct V_94 * V_19 )
{
struct V_95 * V_65 = F_70 ( V_19 ) ;
