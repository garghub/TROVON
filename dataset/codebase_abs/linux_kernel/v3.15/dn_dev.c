...
if ( V_156 -> V_165 != V_27 -> V_4 . V_165 )
return 0 ;
if ( F_92 ( V_156 -> V_135 ) < F_92 ( V_43 -> V_50 ) )
return 1 ;
return 0 ;
}
static void F_93 ( struct V_1 * V_2 , struct V_42 * V_43 )
{
int V_166 ;
struct V_26 * V_27 = F_10 ( V_2 -> V_32 ) ;
struct V_155 * V_156 = (struct V_155 * ) V_27 -> V_154 ;
...
struct V_96 * V_176 = F_96 ( V_97 , V_142 ) ;
if ( V_176 ) {
...
static void F_101 ( unsigned long V_66 )
{
...
int F_119 ( struct V_198 * V_199 )
{
return F_120 ( & V_53 , V_199 ) ;
}
int F_121 ( struct V_198 * V_199 )
{
return F_122 ( & V_53 , V_199 ) ;
}
static inline int F_123 ( struct V_1 * V_2 )
{
return V_2 -> V_32 != NULL ;
}
static void * F_124 ( struct V_200 * V_117 , T_3 * V_201 )
__acquires( T_7 )
{
int V_7 ;
struct V_1 * V_2 ;
...
static void * F_125 ( struct V_200 * V_117 , void * V_203 , T_3 * V_201 )
{
struct V_1 * V_2 ;
++ * V_201 ;
V_2 = V_203 ;
if ( V_203 == V_202 )
V_2 = F_126 ( & V_18 . V_204 ) ;
F_127 (&init_net, dev) {
if ( ! F_123 ( V_2 ) )
continue;
return V_2 ;
...
static void F_128 ( struct V_200 * V_117 , void * V_203 )
__releases( T_7 )
{
F_81 () ;
}
static char * F_129 ( char type )
{
switch ( type ) {
case V_205 :
return L_3 ;
...
static int F_130 ( struct V_200 * V_117 , void * V_203 )
{
if ( V_203 == V_202 )
F_131 ( V_117 , L_7 ) ;
else {
...
F_129 ( V_27 -> V_4 . V_211 ) ,
0 , 0 ,
V_27 -> V_158 , V_27 -> V_4 . V_158 ,
F_12 ( V_2 ) ,
V_27 -> V_4 . V_165 ,
V_27 -> V_4 . V_212 , V_27 -> V_4 . V_15 ,
V_27 -> V_154 ? F_133 ( F_92 ( * ( V_86 * ) V_27 -> V_154 -> V_213 ) , V_210 ) : L_11 ,
V_27 -> V_196 ? F_133 ( F_92 ( * ( V_86 * ) V_27 -> V_196 -> V_213 ) , V_208 ) : L_11 ) ;
}
return 0 ;
}
static int F_134 ( struct V_214 * V_214 , struct V_215 * V_215 )
{
return F_135 ( V_215 , & V_216 ) ;
}
void T_8 F_136 ( void )
{
...
F_118 () ;
F_138 ( V_218 , V_57 , F_57 , NULL , NULL ) ;
F_138 ( V_218 , V_52 , F_49 , NULL , NULL ) ;
F_138 ( V_218 , V_219 , NULL , F_76 , NULL ) ;
F_139 ( L_14 , V_220 , V_18 . V_221 , & V_222 ) ;
#ifdef F_140
{
int V_7 ;
