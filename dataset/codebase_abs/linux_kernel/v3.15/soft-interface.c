...
struct V_111 * F_64 ( struct V_8 * V_9 ,
unsigned short V_60 )
{
struct V_111 * V_115 , * V_116 = NULL ;
F_65 () ;
F_66 (vlan_tmp, &bat_priv->softif_vlan_list, list) {
if ( V_115 -> V_60 != V_60 )
continue;
if ( ! F_67 ( & V_115 -> V_113 ) )
continue;
...
int F_69 ( struct V_8 * V_9 , unsigned short V_60 )
{
struct V_111 * V_116 ;
int V_117 ;
V_116 = F_64 ( V_9 , V_60 ) ;
...
V_116 = F_70 ( sizeof( * V_116 ) , V_119 ) ;
if ( ! V_116 )
return - V_120 ;
V_116 -> V_60 = V_60 ;
F_71 ( & V_116 -> V_113 , 1 ) ;
F_71 ( & V_116 -> V_121 , 0 ) ;
V_117 = F_72 ( V_9 -> V_37 , V_116 ) ;
if ( V_117 ) {
F_73 ( V_116 ) ;
return V_117 ;
}
...
V_116 -> V_60 , L_2 , false ) ;
F_61 ( V_116 ) ;
}
static int F_80 ( struct V_5 * V_6 , T_2 V_125 ,
unsigned short V_60 )
{
struct V_8 * V_9 = F_9 ( V_6 ) ;
if ( V_125 != F_21 ( V_71 ) )
...
F_71 ( & V_9 -> V_149 , 1 ) ;
F_71 ( & V_9 -> V_147 . V_150 , 0 ) ;
F_71 ( & V_9 -> V_147 . V_151 , 0 ) ;
F_71 ( & V_9 -> V_147 . V_152 , 0 ) ;
F_71 ( & V_9 -> V_147 . V_153 , 0 ) ;
#endif
F_71 ( & V_9 -> V_62 , V_77 ) ;
F_71 ( & V_9 -> V_154 , 20 ) ;
F_71 ( & V_9 -> V_155 . V_156 , 100 ) ;
F_71 ( & V_9 -> V_155 . V_157 , 20 ) ;
F_71 ( & V_9 -> V_158 , 1000 ) ;
F_71 ( & V_9 -> V_159 , 15 ) ;
#ifdef F_97
F_71 ( & V_9 -> V_160 , 0 ) ;
#endif
F_71 ( & V_9 -> V_161 , 1 ) ;
F_71 ( & V_9 -> V_162 , V_163 ) ;
F_71 ( & V_9 -> V_164 , V_165 ) ;
F_71 ( & V_9 -> V_166 , V_167 ) ;
F_71 ( & V_9 -> V_29 , V_168 ) ;
F_71 ( & V_9 -> V_95 , 1 ) ;
F_71 ( & V_9 -> V_169 . V_170 , 0 ) ;
F_71 ( & V_9 -> V_169 . V_171 , 0 ) ;
F_71 ( & V_9 -> V_169 . V_172 , 0 ) ;
#ifdef F_94
F_71 ( & V_9 -> V_173 . V_174 , 0 ) ;
#endif
...
struct V_5 * F_119 ( const char * V_184 )
{
struct V_5 * V_37 ;
int V_56 ;
V_37 = F_120 ( sizeof( struct V_8 ) , V_184 ,
F_114 ) ;
if ( ! V_37 )
return NULL ;
V_37 -> V_195 = & V_196 ;
...
void F_123 ( struct V_5 * V_37 )
{
struct V_8 * V_9 = F_9 ( V_37 ) ;
F_124 ( V_197 , & V_9 -> V_137 ) ;
}
static void F_125 ( struct V_5 * V_37 ,
struct V_198 * V_199 )
{
struct V_39 * V_183 ;
F_126 (hard_iface, &batadv_hardif_list, list) {
if ( V_183 -> V_37 == V_37 )
F_109 ( V_183 ,
V_185 ) ;
}
...
int F_128 ( const struct V_5 * V_94 )
{
if ( V_94 -> V_187 -> V_200 == F_20 )
return 1 ;
return 0 ;
}
static int F_129 ( struct V_5 * V_6 , struct V_201 * V_202 )
{
V_202 -> V_203 = 0 ;
V_202 -> V_204 = 0 ;
F_130 ( V_202 , V_205 ) ;
...
struct V_217 * V_218 )
{
F_132 ( V_218 -> V_219 , L_4 , sizeof( V_218 -> V_219 ) ) ;
F_132 ( V_218 -> V_86 , V_220 , sizeof( V_218 -> V_86 ) ) ;
F_132 ( V_218 -> V_221 , L_5 , sizeof( V_218 -> V_221 ) ) ;
F_132 ( V_218 -> V_222 , L_6 , sizeof( V_218 -> V_222 ) ) ;
}
static T_5 F_133 ( struct V_5 * V_6 )
{
return - V_223 ;
}
static void F_134 ( struct V_5 * V_6 , T_5 V_224 )
{
}
static T_5 F_135 ( struct V_5 * V_6 )
{
return 1 ;
}
static void F_136 ( struct V_5 * V_6 , T_3 V_225 ,
T_1 * V_85 )
{
if ( V_225 == V_226 )
memcpy ( V_85 , V_227 ,
...
struct V_8 * V_9 = F_9 ( V_6 ) ;
int V_229 ;
for ( V_229 = 0 ; V_229 < V_141 ; V_229 ++ )
V_85 [ V_229 ] = F_10 ( V_9 , V_229 ) ;
}
static int F_138 ( struct V_5 * V_6 , int V_225 )
{
if ( V_225 == V_226 )
return V_141 ;
return - V_223 ;
