...
goto V_271;
V_272:
if ( ! F_39 ( V_273 , & V_79 -> V_111 ) ) {
V_69 = - V_31 ;
F_127 ( V_6 , V_274 , L_27 ,
...
static void F_130 ( struct V_281 * V_168 )
{
struct V_5 * V_6 = F_131 ( V_168 ) ;
struct V_19 * V_20 = V_6 -> V_34 -> V_20 ;
struct V_282 * V_283 ;
struct V_257 * V_284 , V_285 ;
struct V_27 * V_28 ;
T_3 V_286 ;
int V_30 ;
static const T_2 V_287 [ V_288 ] = {
...
F_132 ( V_168 ) ;
while ( ! F_26 ( V_284 ) ) {
V_283 = F_117 ( V_284 -> V_289 , struct V_282 , V_64 ) ;
F_133 ( & V_283 -> V_64 , & V_285 ) ;
}
F_134 ( V_168 ) ;
while ( ! F_26 ( & V_285 ) ) {
V_283 = F_117 ( ( & V_285 ) -> V_289 ,
struct V_282 , V_64 ) ;
if ( ! F_135 ( V_28 ) ) {
F_136 ( V_6 , V_287 , 0 ) ;
F_136 ( V_6 , V_283 -> V_290 , 0 ) ;
} else {
F_102 ( & V_28 -> V_44 ) ;
for ( V_30 = 0 ; V_30 < V_20 -> V_142 ; V_30 ++ ) {
V_286 = V_28 -> V_291 [ V_30 ] ;
if ( V_286 ) {
F_136 ( V_6 , V_287 ,
V_286 ) ;
F_136 ( V_6 ,
...
{
struct V_257 * V_284 = & V_22 -> V_41 ;
struct V_292 * V_293 ;
while ( ! F_26 ( V_284 ) ) {
V_293 = F_117 ( V_284 -> V_289 , struct V_292 ,
V_64 ) ;
F_34 ( & V_293 -> V_254 ) ;
F_28 ( & V_293 -> V_64 ) ;
F_23 ( V_293 ) ;
...
static void F_138 ( struct V_281 * V_168 )
{
struct V_5 * V_6 = F_131 ( V_168 ) ;
struct V_77 * V_34 = V_6 -> V_34 ;
T_1 V_294 = V_295 ;
if ( ! F_39 ( V_296 , & V_6 -> V_73 ) )
return;
if ( V_168 -> V_63 & V_297 ) {
if ( ! ( V_6 -> V_63 & V_298 ) )
V_294 = V_299 ;
} else if ( ( V_168 -> V_63 & V_300 ) ||
...
struct V_292 * V_293 ;
struct V_281 * V_168 ;
V_293 = F_107 ( V_254 , struct V_292 , V_254 ) ;
V_168 = (struct V_281 * ) V_293 -> V_261 ;
F_138 ( V_168 ) ;
return;
}
static struct V_292 *
...
V_293 = F_117 ( V_258 , struct V_292 , V_64 ) ;
if ( ! F_143 ( & V_293 -> V_254 ) ) {
V_302 = 1 ;
break;
}
}
if ( ! V_302 ) {
V_293 = F_11 ( sizeof( struct V_292 ) ,
V_199 ) ;
if ( V_293 == NULL )
return NULL ;
F_111 ( & V_293 -> V_64 , & V_22 -> V_41 ) ;
}
return V_293 ;
}
static void F_144 ( struct V_21 * V_22 ,
T_4 V_230 , void * V_303 )
{
struct V_292 * V_293 = NULL ;
V_293 = F_142 ( V_22 ) ;
if ( ! V_293 )
return;
V_293 -> V_261 = V_303 ;
F_18 ( & V_293 -> V_254 , V_230 ) ;
F_90 ( V_22 -> V_40 , & V_293 -> V_254 ) ;
}
void F_145 ( struct V_281 * V_168 )
{
struct V_5 * V_6 = F_131 ( V_168 ) ;
...
{
struct V_77 * V_34 = V_6 -> V_34 ;
struct V_307 * V_308 = V_34 -> V_308 ;
struct V_281 * V_168 = V_6 -> V_168 ;
T_2 V_30 , V_309 = V_34 -> V_310 - 1 ;
F_155 ( V_168 ) ;
F_156 ( V_6 ) ;
F_157 ( V_6 ) ;
if ( F_150 ( V_168 ) )
F_158 ( V_6 , V_168 ) ;
for ( V_30 = 0 ; V_30 < V_309 ; V_30 ++ ) {
V_308 [ V_30 ] . V_311 = V_30 ;
V_308 [ V_30 ] . V_312 = 0 ;
V_308 [ V_30 ] . V_313 = 0 ;
}
V_34 -> V_179 = 0 ;
...
struct V_77 * V_34 = V_6 -> V_34 ;
struct V_110 * V_9 = & V_6 -> V_10 -> V_9 ;
struct V_314 * V_171 = & V_34 -> V_171 ;
T_2 V_230 = V_34 -> V_42 ;
T_1 V_73 ;
if ( ( V_171 -> V_315 == V_316 ) ||
( V_171 -> V_315 == V_317 ) ) {
if ( ! F_146 ( V_6 ) ) {
F_149 ( V_6 ) ;
V_6 -> V_173 = 0 ;
...
{
struct V_314 * V_171 = & V_6 -> V_34 -> V_171 ;
F_13 ( & V_6 -> V_10 -> V_9 , L_43 ) ;
if ( V_171 -> V_315 == V_176 )
F_154 ( V_6 ) ;
F_77 ( V_177 , & V_171 -> V_111 ) ;
F_77 ( V_185 , & V_6 -> V_73 ) ;
return - V_31 ;
...
struct V_314 * V_171 ;
int V_143 = 0 ;
V_6 = F_107 ( V_254 , struct V_5 , V_321 . V_254 ) ;
V_171 = & V_6 -> V_34 -> V_171 ;
V_171 -> V_322 = F_72 ( V_6 -> V_34 , V_175 ) ;
switch ( V_171 -> V_322 ) {
case V_176 :
V_143 = F_161 ( V_6 ) ;
break;
...
if ( ! V_328 || F_168 ( V_20 , V_28 , V_327 ) )
return - V_198 ;
}
return 0 ;
}
static void F_172 ( struct V_27 * V_28 , T_3 V_286 ,
enum V_330 V_267 )
{
struct V_5 * V_6 = V_28 -> V_6 ;
struct V_19 * V_20 ;
...
switch ( V_267 ) {
case V_331 :
F_173 ( V_20 , V_28 , V_286 ) ;
break;
case V_332 :
F_174 ( V_20 , V_28 , V_286 ) ;
break;
default:
...
if ( V_143 )
return V_143 ;
V_62 . V_66 . V_67 [ 1 ] = ( V_263 & 1 ) | V_327 << 16 ;
F_33 ( & V_20 -> V_22 ) ;
V_143 = F_48 ( V_6 , & V_62 ) ;
if ( V_143 ) {
F_13 ( & V_6 -> V_10 -> V_9 ,
...
F_177 ( V_6 ) ;
if ( V_263 )
F_172 ( V_28 , V_327 , V_331 ) ;
else
F_172 ( V_28 , V_327 , V_332 ) ;
F_178 ( V_6 -> V_168 ) ;
}
F_29 ( & V_62 ) ;
return V_143 ;
...
{
struct V_257 * V_284 = & V_6 -> V_334 ;
struct V_282 * V_283 ;
while ( ! F_26 ( V_284 ) ) {
V_283 = F_117 ( V_284 -> V_289 , struct V_282 , V_64 ) ;
F_180 ( V_6 , V_283 -> V_290 , V_283 -> V_286 ,
V_335 ) ;
F_28 ( & V_283 -> V_64 ) ;
F_23 ( V_283 ) ;
}
