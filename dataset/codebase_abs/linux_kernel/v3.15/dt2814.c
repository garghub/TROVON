...
F_7 ( & V_26 -> V_39 ,
V_26 -> V_22 & V_44 ) ;
V_17 = F_4 ( V_26 -> V_50 [ 0 ] ) ;
V_46 -> V_51 = V_26 -> V_43 ;
F_5 ( V_17 | V_52 | ( V_49 << 5 ) , V_2 -> V_9 + V_10 ) ;
return 0 ;
}
...
int V_18 ;
int V_23 ;
V_18 = F_19 ( V_2 , V_62 -> V_63 [ 0 ] , V_64 ) ;
if ( V_18 )
return V_18 ;
F_5 ( 0 , V_2 -> V_9 + V_10 ) ;
F_20 ( 100 ) ;
if ( F_2 ( V_2 -> V_9 + V_10 ) & V_65 ) {
F_21 ( V_2 -> V_66 , L_2 ) ;
return - V_67 ;
}
...
V_23 = F_2 ( V_2 -> V_9 + V_20 ) ;
if ( V_62 -> V_63 [ 1 ] ) {
V_18 = F_22 ( V_62 -> V_63 [ 1 ] , F_15 , 0 ,
V_2 -> V_68 , V_2 ) ;
if ( V_18 == 0 )
V_2 -> V_53 = V_62 -> V_63 [ 1 ] ;
}
V_18 = F_23 ( V_2 , 1 ) ;
if ( V_18 )
return V_18 ;
V_46 = F_24 ( V_2 , sizeof( * V_46 ) ) ;
if ( ! V_46 )
return - V_69 ;
V_4 = & V_2 -> V_70 [ 0 ] ;
V_4 -> type = V_71 ;
