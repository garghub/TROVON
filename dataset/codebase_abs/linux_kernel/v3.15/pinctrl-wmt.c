...
int V_38 , V_68 ;
struct V_1 * V_2 = F_8 ( V_8 ) ;
V_31 = F_29 ( V_41 , L_7 , NULL ) ;
if ( ! V_31 ) {
F_12 ( V_2 -> V_23 , L_8 ) ;
return - V_24 ;
}
V_63 = F_29 ( V_41 , L_9 , NULL ) ;
V_64 = F_29 ( V_41 , L_10 , NULL ) ;
if ( ! V_63 && ! V_64 ) {
F_12 ( V_2 -> V_23 , L_11 ) ;
return - V_24 ;
}
...
if ( V_66 )
V_67 ++ ;
V_61 = V_44 = F_25 ( V_37 * V_67 * sizeof( * V_44 ) ,
V_52 ) ;
if ( ! V_44 )
return - V_53 ;
for ( V_38 = 0 ; V_38 < V_37 ; V_38 ++ ) {
V_68 = F_30 ( V_41 , L_7 , V_38 , & V_16 ) ;
if ( V_68 )
goto V_70;
if ( V_16 >= ( V_2 -> V_71 * 32 ) ) {
F_12 ( V_2 -> V_23 , L_14 ) ;
...
static void F_42 ( struct V_79 * V_80 , unsigned V_35 ,
int V_5 )
{
struct V_1 * V_2 = F_40 ( V_80 -> V_23 ) ;
T_1 V_17 = F_10 ( V_35 ) ;
...
V_68 = F_55 ( & V_2 -> V_79 , F_56 ( V_2 -> V_23 ) ,
0 , 0 , V_2 -> V_71 * 32 ) ;
if ( V_68 )
goto V_97;
F_57 ( & V_87 -> V_23 , L_21 ) ;
