...
struct V_148 * V_515 , * V_516 , * V_517 ;
T_1 V_518 , V_519 , V_147 , V_520 ;
volatile T_1 * V_89 = V_53 -> V_89 . V_90 ;
T_1 V_105 ;
...
V_522 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 >> 8 ) ;
V_53 -> V_105 += V_147 + 7 ;
break;
case 0 :
V_522 = F_43 ( V_53 , V_105 + 1 ) ;
V_522 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 2 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_516 -> V_188 ) & 0xff ;
V_53 -> V_105 += V_147 + 3 ;
break;
default:
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_516 -> V_188 ) & 0xff ;
...
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_516 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_516 -> V_188 ) & 0xff ;
} else {
...
if ( ( V_522 + V_147 ) > F_23 ( V_516 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_130 ,
V_522 + V_147 , F_23 ( V_516 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_515 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_516 -> V_188 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
...
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_516 -> V_188 & 0xffffffff ) ;
...
if ( ( V_523 + ( V_147 * 4 ) ) > F_23 ( V_517 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_135 ,
V_523 + ( V_147 * 4 ) , F_23 ( V_517 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_517 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 4 ] += F_91 ( V_516 -> V_188 ) & 0xff ;
V_89 [ V_105 + 5 ] += F_91 ( V_517 -> V_188 ) & 0xff ;
V_89 [ V_105 + 6 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_53 -> V_105 += 7 ;
break;
case 0x48 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 >> 8 ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_517 -> V_188 >> 8 ) ;
V_89 [ V_105 + 8 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 9 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_53 -> V_105 += 10 ;
break;
case 0x49 :
if ( V_53 -> V_114 < V_153 ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 >> 8 ) ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_516 -> V_188 >> 8 ) ;
V_53 -> V_105 += 13 ;
break;
case 0x4f :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( F_91 ( V_516 -> V_188 ) << 16 ) & 0x00ff0000 ;
V_53 -> V_105 += 4 ;
break;
case V_527 :
V_53 -> V_105 += 1 ;
...
static int F_110 ( struct V_602 * V_152 ,
...
int F_111 ( struct V_602 * V_152 , struct V_616 * V_89 )
{
int V_617 = 0 ;
T_1 V_105 = 0 ;
struct V_143 V_144 ;
...
int F_115 ( struct V_602 * V_152 , struct V_616 * V_89 )
{
T_1 V_105 = 0 ;
T_1 V_518 , V_519 , V_147 , V_520 ;
do {
