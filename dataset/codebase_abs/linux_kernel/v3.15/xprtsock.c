...
{
unsigned short V_209 = V_82 -> V_127 ;
...
V_244 . V_19 = V_245 ;
V_243 = F_152 ( V_82 -> V_7 , & V_244 , sizeof( V_244 ) , 0 ) ;
F_169 ( & V_82 -> V_11 ,
V_82 -> V_7 , V_243 ) ;
if ( ! V_243 )
F_110 ( & V_82 -> V_11 ) ;
...
{
unsigned int V_116 = V_82 -> V_85 -> V_183 ;
if ( V_116 == V_196 && V_82 -> V_7 -> V_116 == V_246 ) {
if ( V_82 -> V_85 -> V_186 == 0 )
return;
F_2 ( L_70 ,
V_104 , V_82 -> V_85 -> V_186 ) ;
}
if ( ( 1 << V_116 ) & ( V_247 | V_248 ) ) {
if ( V_82 -> V_85 -> V_186 == 0 )
return;
F_2 ( L_71
L_72 ,
...
if ( ! V_82 -> V_85 ) {
struct V_7 * V_8 = V_7 -> V_8 ;
unsigned int V_249 = V_11 -> V_181 -> V_250 / V_251 ;
unsigned int V_252 = V_11 -> V_181 -> V_253 + 1 ;
unsigned int V_254 = 1 ;
F_172 ( V_7 , V_255 , V_256 ,
( char * ) & V_254 , sizeof( V_254 ) ) ;
F_172 ( V_7 , V_257 , V_258 ,
( char * ) & V_249 , sizeof( V_249 ) ) ;
F_172 ( V_7 , V_257 , V_259 ,
( char * ) & V_249 , sizeof( V_249 ) ) ;
F_172 ( V_7 , V_257 , V_260 ,
...
V_11 -> V_228 . V_229 ++ ;
V_11 -> V_228 . V_230 = V_231 ;
V_89 = F_152 ( V_7 , F_4 ( V_11 ) , V_11 -> V_40 , V_266 ) ;
switch ( V_89 ) {
case 0 :
case - V_267 :
if ( V_11 -> V_130 < V_194 )
...
static void F_178 ( struct V_6 * V_11 , struct V_275 * V_276 )
{
long V_277 = 0 ;
if ( F_32 ( V_11 ) )
V_277 = ( long ) ( V_231 - V_11 -> V_278 ) / V_251 ;
F_179 ( V_276 , L_78
L_79 ,
V_11 -> V_228 . V_279 ,
V_11 -> V_228 . V_229 ,
...
static void F_180 ( struct V_6 * V_11 , struct V_275 * V_276 )
{
struct V_81 * V_82 = F_29 ( V_11 , struct V_81 , V_11 ) ;
F_179 ( V_276 , L_80
L_81 ,
...
static void F_181 ( struct V_6 * V_11 , struct V_275 * V_276 )
{
struct V_81 * V_82 = F_29 ( V_11 , struct V_81 , V_11 ) ;
long V_277 = 0 ;
if ( F_32 ( V_11 ) )
...
struct V_57 * V_57 ;
struct V_289 * V_4 ;
F_144 ( V_59 > V_290 - sizeof( struct V_289 ) ) ;
if ( V_59 > V_290 - sizeof( struct V_289 ) )
return NULL ;
V_57 = F_183 ( V_24 ) ;
if ( ! V_57 )
return NULL ;
...
static void F_185 ( void * V_291 )
{
struct V_289 * V_4 ;
if ( ! V_291 )
return;
V_4 = F_29 ( V_291 , struct V_289 , V_179 ) ;
F_186 ( ( unsigned long ) V_4 ) ;
}
static int F_187 ( struct V_87 * V_88 )
{
int V_73 ;
struct V_54 * V_292 = & V_88 -> V_101 ;
struct V_6 * V_11 = V_88 -> V_84 ;
struct V_81 * V_82 =
F_29 ( V_11 , struct V_81 , V_11 ) ;
struct V_39 * V_7 = V_82 -> V_7 ;
...
unsigned long V_294 ;
F_37 ( V_292 ) ;
V_294 = ( unsigned long ) V_292 -> V_78 [ 0 ] . V_52 & ~ V_69 ;
V_293 = ( unsigned long ) V_292 -> V_76 [ 0 ] . V_52 & ~ V_69 ;
V_73 = F_188 ( V_7 , V_292 ,
F_189 ( V_292 -> V_76 [ 0 ] . V_52 ) , V_293 ,
V_292 -> V_78 [ 0 ] . V_52 , V_294 ) ;
if ( V_73 != V_292 -> V_73 ) {
F_96 ( V_295 L_83 ) ;
V_73 = - V_90 ;
}
...
V_11 = V_88 -> V_84 -> V_297 ;
if ( ! F_191 ( & V_11 -> V_298 ) ) {
F_192 ( & V_11 -> V_299 , V_80 , NULL ) ;
if ( ! F_191 ( & V_11 -> V_298 ) )
return - V_90 ;
F_193 ( & V_11 -> V_299 , V_80 ) ;
}
...
static struct V_6 * F_199 ( struct V_307 * args ,
unsigned int V_308 ,
unsigned int V_309 )
{
struct V_6 * V_11 ;
...
V_11 = F_200 ( args -> V_312 , sizeof( * V_310 ) , V_308 ,
V_309 ) ;
if ( V_11 == NULL ) {
F_2 ( L_88
L_89 ) ;
...
V_310 = F_29 ( V_11 , struct V_81 , V_11 ) ;
memcpy ( & V_11 -> V_12 , args -> V_314 , args -> V_40 ) ;
V_11 -> V_40 = args -> V_40 ;
if ( args -> V_215 )
memcpy ( & V_310 -> V_215 , args -> V_215 , args -> V_40 ) ;
else {
int V_63 ;
V_63 = F_197 ( args -> V_314 -> V_19 ,
(struct V_10 * ) & V_310 -> V_215 ) ;
if ( V_63 != 0 ) {
F_69 ( V_11 ) ;
return F_149 ( V_63 ) ;
}
...
static struct V_6 * F_201 ( struct V_307 * args )
{
struct V_13 * V_18 = (struct V_13 * ) args -> V_314 ;
struct V_81 * V_82 ;
struct V_6 * V_11 ;
struct V_6 * V_89 ;
V_11 = F_199 ( args , V_315 ,
V_316 ) ;
if ( F_167 ( V_11 ) )
return V_11 ;
V_82 = F_29 ( V_11 , struct V_81 , V_11 ) ;
V_11 -> V_317 = 0 ;
V_11 -> V_318 = sizeof( V_99 ) / sizeof( T_1 ) ;
V_11 -> V_319 = V_320 ;
V_11 -> V_321 = V_322 ;
V_11 -> V_130 = V_194 ;
V_11 -> V_323 = V_324 ;
...
static struct V_6 * F_204 ( struct V_307 * args )
{
struct V_10 * V_12 = args -> V_314 ;
struct V_6 * V_11 ;
struct V_81 * V_82 ;
struct V_6 * V_89 ;
V_11 = F_199 ( args , V_330 ,
V_330 ) ;
if ( F_167 ( V_11 ) )
return V_11 ;
V_82 = F_29 ( V_11 , struct V_81 , V_11 ) ;
...
switch ( V_12 -> V_19 ) {
case V_25 :
if ( ( (struct V_14 * ) V_12 ) -> V_335 != F_205 ( 0 ) )
F_135 ( V_11 ) ;
F_202 ( & V_82 -> V_129 ,
F_166 ) ;
...
break;
case V_28 :
if ( ( (struct V_15 * ) V_12 ) -> V_337 != F_205 ( 0 ) )
F_135 ( V_11 ) ;
F_202 ( & V_82 -> V_129 ,
F_166 ) ;
...
static struct V_6 * F_206 ( struct V_307 * args )
{
struct V_10 * V_12 = args -> V_314 ;
struct V_6 * V_11 ;
struct V_81 * V_82 ;
...
V_11 -> V_22 [ V_35 ] ) ;
F_208 ( V_11 ) ;
args -> V_297 -> V_348 = V_11 ;
V_11 -> V_297 = args -> V_297 ;
V_346 = F_29 ( args -> V_297 , struct V_345 , V_349 ) ;
V_82 -> V_7 = V_346 -> V_350 ;
V_82 -> V_85 = V_346 -> V_351 ;
F_155 ( V_11 ) ;
if ( F_203 ( V_134 ) )
return V_11 ;
args -> V_297 -> V_348 = NULL ;
F_209 ( V_11 ) ;
V_89 = F_149 ( - V_273 ) ;
V_328:
F_68 ( V_11 ) ;
...
static int F_217 ( const char * V_358 ,
...
if ( ! V_358 )
return - V_273 ;
V_89 = F_218 ( V_358 , 0 , & V_363 ) ;
if ( V_89 == - V_273 || V_363 < V_361 || V_363 > V_362 )
return - V_273 ;
* ( ( unsigned int * ) V_360 -> V_178 ) = V_363 ;
return 0 ;
}
static int F_219 ( const char * V_358 , const struct V_359 * V_360 )
{
return F_217 ( V_358 , V_360 ,
V_364 ,
V_365 ) ;
}
static int F_220 ( const char * V_358 ,
const struct V_359 * V_360 )
{
return F_217 ( V_358 , V_360 ,
V_366 ,
...
static int F_221 ( const char * V_358 ,
const struct V_359 * V_360 )
{
return F_217 ( V_358 , V_360 ,
V_366 ,
