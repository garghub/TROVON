...
static int F_26 ( struct V_30 * V_19 )
{
F_20 ( V_19 , V_117 ) ;
return 0 ;
}
static int F_27 ( struct V_123 * V_124 ,
...
return - V_132 ;
F_29 ( V_124 , V_53 ) ;
V_53 -> V_12 = F_30 ( V_124 , & V_133 ) ;
if ( F_31 ( V_53 -> V_12 ) ) {
V_126 = F_32 ( V_53 -> V_12 ) ;
F_33 ( & V_124 -> V_2 , L_1 , V_126 ) ;
return V_126 ;
}
V_127 = F_34 ( V_53 -> V_12 , V_10 , & V_129 ) ;
V_128 = F_34 ( V_53 -> V_12 , V_11 , & V_130 ) ;
if ( V_127 != 0 || V_128 != 0 ) {
F_33 ( & V_124 -> V_2 ,
L_2 , V_127 , V_128 ) ;
return - V_134 ;
...
V_126 = F_35 ( & V_124 -> V_2 ,
& V_138 , & V_136 , 1 ) ;
if ( V_126 < 0 ) {
F_33 ( & V_124 -> V_2 , L_6 , V_126 ) ;
return V_126 ;
}
return V_126 ;
}
