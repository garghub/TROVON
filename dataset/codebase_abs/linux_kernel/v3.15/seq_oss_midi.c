...
V_14 -> V_25 = 0 ;
F_13 ( & V_14 -> V_18 ) ;
F_14 ( V_14 -> V_26 , V_5 -> V_26 , sizeof( V_14 -> V_26 ) ) ;
if ( F_15 ( V_27 , & V_14 -> V_28 ) < 0 ) {
F_12 ( L_2 ) ;
F_3 ( V_14 ) ;
return - V_7 ;
}
...
if ( V_55 -> type == V_107 ) {
if ( ( V_55 -> V_15 & V_108 ) == V_109 )
F_39 ( V_33 -> V_75 , V_14 -> V_30 ,
V_55 -> V_62 . V_110 . V_111 , V_55 -> V_62 . V_110 . V_104 ) ;
} else {
V_104 = F_40 ( V_14 -> V_28 , V_103 , sizeof( V_103 ) , V_55 ) ;
if ( V_104 > 0 )
F_39 ( V_33 -> V_75 , V_14 -> V_30 , V_103 , V_104 ) ;
}
return 0 ;
}
int
F_41 ( struct V_32 * V_33 , int V_13 , unsigned char V_56 , struct V_54 * V_55 )
{
struct V_12 * V_14 ;
if ( ( V_14 = F_26 ( V_33 , V_13 ) ) == NULL )
return - V_40 ;
if ( F_42 ( V_14 -> V_28 , V_56 , V_55 ) > 0 ) {
F_43 ( V_33 , V_55 , V_14 -> V_1 , V_14 -> V_10 ) ;
F_11 ( & V_14 -> V_18 ) ;
return 0 ;
}
F_11 ( & V_14 -> V_18 ) ;
...
int
F_44 ( struct V_32 * V_33 , int V_13 , struct V_113 * V_114 )
{
struct V_12 * V_14 ;
if ( ( V_14 = F_26 ( V_33 , V_13 ) ) == NULL )
return - V_43 ;
...
V_114 -> V_116 = 0 ;
V_114 -> V_117 = 0 ;
F_14 ( V_114 -> V_26 , V_14 -> V_26 , sizeof( V_114 -> V_26 ) ) ;
F_11 ( & V_14 -> V_18 ) ;
return 0 ;
}
static char *
