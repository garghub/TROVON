...
( unsigned long long )
V_75 >> ( V_39 -> V_78 - 9 ) ) ;
F_63 ( V_39 -> V_79 , error ) ;
}
if ( V_33 -> V_36 & V_37 ) {
V_12 -> V_41 = F_64 ( & V_33 -> V_12 , V_12 ) ;
F_58 ( V_33 ) ;
} else {
F_58 ( V_33 ) ;
F_8 ( V_12 ) ;
...
void F_65 ( struct F_65 * V_43 )
{
struct V_12 * V_12 = V_43 -> V_80 ;
if ( V_12 ) {
F_66 ( V_43 -> V_80 ) ;
F_67 ( V_43 -> V_81 , V_43 -> V_80 ) ;
F_23 ( F_68 ( V_43 -> V_80 , V_82 ) ) ;
F_30 ( V_43 -> V_80 ) ;
}
V_43 -> V_80 = NULL ;
}
void F_69 ( struct F_65 * V_43 ,
struct V_83 * V_84 )
{
V_43 -> V_81 = ( V_84 -> V_85 == V_86 ? V_87 : V_88 ) ;
V_43 -> V_80 = NULL ;
V_43 -> V_33 = NULL ;
}
static int F_70 ( struct F_65 * V_43 ,
struct V_5 * V_6 )
{
int V_89 = F_71 ( V_6 -> V_10 ) ;
struct V_12 * V_12 ;
V_12 = F_72 ( V_90 , F_73 ( V_89 , V_91 ) ) ;
if ( ! V_12 )
return - V_4 ;
...
static int F_74 ( struct F_65 * V_43 ,
struct V_39 * V_39 ,
struct V_5 * V_6 )
{
int V_46 ;
if ( V_43 -> V_80 && V_6 -> V_11 != V_43 -> V_93 ) {
V_94:
F_65 ( V_43 ) ;
}
if ( V_43 -> V_80 == NULL ) {
...
V_46 = F_75 ( V_43 -> V_80 , V_6 -> V_95 , V_6 -> V_31 , F_16 ( V_6 ) ) ;
if ( V_46 != V_6 -> V_31 )
goto V_94;
V_43 -> V_93 ++ ;
return 0 ;
}
int F_76 ( struct F_65 * V_43 ,
struct V_18 * V_18 ,
int V_96 ,
struct V_83 * V_84 )
{
struct V_39 * V_39 = V_18 -> V_28 -> V_97 ;
unsigned V_98 , V_99 ;
struct V_5 * V_6 , * V_20 ;
int V_46 = 0 ;
int V_100 = 0 ;
