...
switch ( V_93 ) {
case V_144 :
F_77 ( V_2 -> V_145 , (enum V_146 T_4 * ) V_136 ) ;
return 0 ;
case V_147 : {
V_140 = (struct V_139 T_4 * ) V_136 ;
if ( F_78 ( V_142 , & V_140 -> V_148 ) )
return - V_73 ;
if ( ( V_142 >= V_2 -> V_149 ) || ( V_142 & 0x7 ) )
return - V_65 ;
V_141 = F_79 ( V_2 , V_142 ) ;
F_77 ( V_141 , & V_140 -> V_150 ) ;
return 0 ;
}
case V_151 : {
V_140 = (struct V_139 T_4 * ) V_136 ;
...
if ( ( V_142 >= V_2 -> V_149 ) || ( V_142 & 0x7 ) )
return - V_65 ;
if ( F_78 ( V_141 , & V_140 -> V_150 ) )
return - V_73 ;
F_80 ( V_2 , V_142 , V_141 ) ;
return 0 ;
}
case V_156 : {
V_140 = (struct V_139 T_4 * ) V_136 ;
...
static long F_85 ( struct V_41 * V_42 , unsigned int V_93 ,
unsigned long V_136 )
{
...
F_89 ( & V_2 -> V_46 , & V_169 ) ;
V_2 -> V_46 . V_9 = V_170 ;
V_3 = F_90 ( & V_2 -> V_46 , V_2 -> V_165 , 1 ) ;
if ( V_3 < 0 ) {
F_16 ( & V_27 -> V_28 , L_12 ) ;
goto V_171;
}
V_2 -> V_28 = F_91 ( V_2 -> V_172 ,
& V_2 -> V_27 -> V_28 ,
V_2 -> V_165 , V_2 ,
V_173 ,
V_167 L_13 ,
...
return 0 ;
V_176:
F_95 ( V_2 -> V_172 , V_2 -> V_165 ) ;
V_175:
F_96 ( & V_2 -> V_46 ) ;
V_171:
F_97 ( V_2 -> V_165 , V_166 ) ;
V_168:
V_2 -> V_28 = NULL ;
return V_3 ;
}
...
return 1 ;
F_98 ( V_2 ) ;
V_3 = F_104 ( & V_2 -> V_46 . V_180 . V_181 . V_182 ) ;
if ( V_3 != 1 ) {
F_16 ( & V_27 -> V_28 ,
L_17 , V_29 , V_3 ) ;
F_105 ( L_18 ) ;
