...
static int F_37 ( struct V_102 * V_39 )
{
struct V_3 * V_4 ;
struct V_82 * V_83 ;
struct V_103 * V_42 ;
int V_104 ;
int V_50 = 0 ;
V_4 = F_38 ( & V_39 -> V_4 , sizeof( struct V_3 ) , V_105 ) ;
if ( ! V_4 ) {
F_8 ( & V_39 -> V_4 , L_57 ) ;
return - V_106 ;
}
V_104 = V_39 -> V_107 ;
V_4 -> V_43 = F_39 ( & V_39 -> V_4 , NULL ) ;
if ( F_40 ( V_4 -> V_43 ) ) {
F_8 ( & V_39 -> V_4 , L_58 ) ;
return F_41 ( V_4 -> V_43 ) ;
}
V_4 -> V_39 = V_39 ;
V_42 = F_42 ( V_39 , V_108 , 0 ) ;
V_4 -> V_6 = F_43 ( & V_39 -> V_4 , V_42 ) ;
F_30 ( & V_39 -> V_4 , L_59
L_60 , V_104 , V_4 -> V_6 ) ;
if ( F_40 ( V_4 -> V_6 ) )
return F_41 ( V_4 -> V_6 ) ;
V_4 -> V_40 = F_44 ( V_39 , 0 ) ;
V_50 = F_45 ( & V_39 -> V_4 , V_4 -> V_40 , F_9 , 0 , V_109 , V_4 ) ;
if ( V_50 < 0 )
return V_50 ;
V_4 -> V_65 = V_110 ;
F_46 ( V_4 -> V_43 ) ;
...
V_83 = & V_4 -> V_112 ;
V_83 -> V_113 = V_114 ;
V_83 -> V_115 = V_116 | V_117 ;
F_48 ( V_83 -> V_118 , L_62 ,
sizeof( V_83 -> V_118 ) ) ;
V_83 -> V_119 = V_104 ;
V_83 -> V_120 = & V_121 ;
V_83 -> V_4 . V_122 = & V_39 -> V_4 ;
V_83 -> V_4 . V_123 = V_39 -> V_4 . V_123 ;
F_49 ( V_83 , V_4 ) ;
V_50 = F_50 ( V_83 ) ;
if ( V_50 ) {
F_8 ( & V_39 -> V_4 , L_63
...
static int F_53 ( struct V_124 * V_124 )
{
struct V_3 * V_4 = F_54 ( V_124 ) ;
F_1 ( 0x00 , V_4 -> V_6 + V_7 ) ;
return 0 ;
}
static int F_55 ( struct V_124 * V_124 )
{
int V_50 = 0 ;
struct V_3 * V_4 = F_54 ( V_124 ) ;
F_10 ( V_4 -> V_43 ) ;
...
static int F_56 ( struct V_102 * V_39 )
{
struct V_3 * V_4 = F_57 ( V_39 ) ;
F_58 ( & V_4 -> V_112 ) ;
F_1 ( 0x00 , V_4 -> V_6 + V_7 ) ;
return 0 ;
}
