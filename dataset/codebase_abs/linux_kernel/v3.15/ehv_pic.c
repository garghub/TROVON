...
static int F_25 ( struct V_40 * V_41 , unsigned int V_45 ,
T_1 V_46 )
{
...
static int F_29 ( struct V_40 * V_41 , struct V_42 * V_56 ,
...
struct V_47 * V_47 ;
int V_36 = 1 ;
V_62 = F_31 ( NULL , NULL , L_1 ) ;
if ( ! V_62 ) {
F_32 ( L_2 ) ;
return;
}
if ( ! F_33 ( V_62 , L_3 , NULL ) )
V_36 = 0 ;
V_47 = F_34 ( sizeof( struct V_47 ) , V_64 ) ;
if ( ! V_47 ) {
F_35 ( V_62 ) ;
return;
}
V_47 -> V_39 = F_36 ( V_62 , V_65 ,
& V_66 , V_47 ) ;
if ( ! V_47 -> V_39 ) {
F_35 ( V_62 ) ;
F_37 ( V_47 ) ;
