...
static int F_37 ( struct V_40 * V_18 )
{
struct V_9 * V_9 ;
int V_23 ;
T_1 V_20 , V_94 ;
struct V_95 * V_96 = F_38 ( & V_18 -> V_7 ) ;
bool V_97 = false ;
if ( ( V_18 -> V_98 && V_18 -> V_98 != 8 )
|| ( V_18 -> V_99 > 2000000 )
|| ! ( V_18 -> V_100 & V_101 ) )
return - V_12 ;
V_9 = F_39 ( & V_18 -> V_7 , sizeof( * V_9 ) , V_102 ) ;
if ( ! V_9 )
return - V_103 ;
V_9 -> V_18 = V_18 ;
F_40 ( V_18 , V_9 ) ;
...
if ( V_18 -> V_69 ) {
F_45 ( & V_9 -> V_61 , F_19 ) ;
V_23 = F_46 ( & V_18 -> V_7 , V_18 -> V_69 , F_26 ,
0 , F_47 ( & V_9 -> V_64 -> V_7 ) , V_9 ) ;
if ( V_23 < 0 ) {
F_35 ( & V_18 -> V_7 , L_29 ,
V_18 -> V_69 , V_23 ) ;
} else {
...
V_23 = F_49 ( & V_18 -> V_7 . V_87 , & V_113 ) ;
if ( V_23 < 0 ) {
F_35 ( & V_18 -> V_7 , L_30 , V_23 ) ;
}
return 0 ;
}
static int F_50 ( struct V_40 * V_18 )
{
struct V_9 * V_9 = F_51 ( V_18 ) ;
F_52 ( & V_18 -> V_7 . V_87 , & V_113 ) ;
if ( V_18 -> V_69 ) {
F_53 ( V_67 , & V_9 -> V_68 ) ;
F_54 ( & V_18 -> V_7 , V_18 -> V_69 , V_9 ) ;
F_55 ( & V_9 -> V_61 ) ;
}
return 0 ;
}
