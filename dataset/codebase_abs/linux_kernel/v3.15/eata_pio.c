...
return 0 ;
if ( ! V_19 [ V_141 -> V_139 ] ) {
if ( ! F_50 ( V_141 -> V_139 , F_10 , 0 , L_50 , V_16 ) ) {
V_19 [ V_141 -> V_139 ] ++ ;
if ( ! V_141 -> V_152 )
V_162 [ V_141 -> V_139 ] = 1 ;
} else {
...
F_51 ( F_3 ( V_16 ) -> V_164 , & V_122 [ 8 ] , sizeof( F_3 ( V_16 ) -> V_164 ) ) ;
...
if ( ! V_138 [ V_183 ] )
continue;
if ( ! F_40 ( V_138 [ V_183 ] , V_126 ) )
continue;
if ( ! F_47 ( V_138 [ V_183 ] , V_126 , NULL ) )
F_6 ( V_138 [ V_183 ] , 9 ) ;
else
V_138 [ V_183 ] = 0 ;
}
...
#ifdef F_55
V_184 = F_14 ( ( V_189 ) V_14 - 8 ) ;
V_185 = F_14 ( ( V_189 ) V_14 - 7 ) ;
V_186 = F_14 ( ( V_189 ) V_14 - 6 ) ;
if ( ( ( V_184 == 0x12 ) && ( V_185 == 0x14 ) ) || ( ( V_184 == 0x38 ) && ( V_185 == 0xa3 ) && ( V_186 == 0x82 ) ) || ( ( V_184 == 0x06 ) && ( V_185 == 0x94 ) && ( V_186 == 0x24 ) ) ) {
F_26 ( V_131 , F_20 ( V_107 L_54 L_55 , ( int ) V_184 , ( int ) V_185 , ( int ) V_186 ) ) ;
#endif
if ( F_40 ( V_14 , V_126 ) ) {
F_26 ( V_131 && V_190 , F_42 ( V_126 ) ) ;
if ( V_126 -> V_139 ) {
...
while ( ( V_35 = F_58 ( V_191 , V_192 , V_35 ) ) != NULL ) {
F_26 ( V_131 && V_193 , F_20 ( L_59 , F_59 ( V_35 ) ) ) ;
if ( F_60 ( V_35 ) )
continue;
F_61 ( V_35 ) ;
V_14 = F_62 ( V_35 , 0 ) ;
