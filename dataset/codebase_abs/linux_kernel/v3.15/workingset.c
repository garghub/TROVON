...
unsigned int V_38 ;
int V_39 ;
V_37 = F_21 ( V_33 , struct V_36 , V_40 ) ;
V_17 = V_37 -> V_41 ;
if ( ! F_22 ( & V_17 -> V_42 ) ) {
F_23 ( V_34 ) ;
V_39 = V_43 ;
...
if ( V_37 -> V_48 [ V_38 ] ) {
F_25 ( ! F_26 ( V_37 -> V_48 [ V_38 ] ) ) ;
V_37 -> V_48 [ V_38 ] = NULL ;
F_25 ( V_37 -> V_45 < ( 1U << V_49 ) ) ;
V_37 -> V_45 -= 1U << V_49 ;
F_25 ( ! V_17 -> V_50 ) ;
V_17 -> V_50 -- ;
}
...
F_25 ( V_37 -> V_45 ) ;
F_11 ( F_8 ( F_27 ( V_37 ) ) , V_51 ) ;
if ( ! F_28 ( & V_17 -> V_52 , V_37 ) )
F_29 () ;
F_23 ( & V_17 -> V_42 ) ;
V_39 = V_53 ;
V_44:
