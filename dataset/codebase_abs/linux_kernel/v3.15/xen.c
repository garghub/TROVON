...
& V_66 ) ;
V_67 = ( T_1 ) ( V_66 & V_70 ) ;
V_14 . V_71 = F_37 ( V_2 , V_67 ) ;
V_14 . V_64 = V_40 -> V_72 . V_64 ;
}
V_37 = - V_73 ;
if ( V_74 )
V_37 = F_8 ( V_21 ,
& V_14 ) ;
if ( type == V_42 && V_36 > 1 && V_37 ) {
V_37 = 1 ;
goto V_24;
}
if ( V_37 == - V_73 && ! F_35 ( V_2 -> V_60 ) ) {
V_14 . type = V_75 ;
V_14 . V_20 = - 1 ;
V_14 . V_5 = - 1 ;
V_14 . V_60 = V_2 -> V_60 -> V_61 ;
...
if ( V_74 ) {
struct V_76 V_77 ;
V_77 . V_78 = F_35 ( V_2 -> V_60 ) ;
V_77 . V_60 = V_2 -> V_60 -> V_61 ;
V_77 . V_62 = V_2 -> V_62 ;
V_37 = F_8 ( V_79 ,
& V_77 ) ;
if ( V_37 == - V_80 )
V_74 = false ;
F_39 ( V_37 && V_37 != - V_80 , L_21 , V_37 ) ;
}
if ( ! V_74 ) {
struct V_81 V_82 ;
V_82 . V_60 = V_2 -> V_60 -> V_61 ;
V_82 . V_62 = V_2 -> V_62 ;
V_37 = F_8 ( V_83 , & V_82 ) ;
F_39 ( V_37 && V_37 != - V_80 , L_22 , V_37 ) ;
}
}
static void F_40 ( struct V_1 * V_2 )
{
struct V_39 * V_40 ;
V_40 = F_41 ( V_2 -> V_84 . V_85 , struct V_39 , V_86 ) ;
if ( V_40 -> V_72 . V_87 )
F_42 ( V_2 ) ;
else
F_43 ( V_2 ) ;
...
static T_2 F_47 ( struct V_39 * V_88 , T_2 V_89 , T_2 V_90 )
{
return 0 ;
}
static T_2 F_48 ( struct V_39 * V_88 , T_2 V_90 )
{
return 0 ;
}
int T_4 F_49 ( void )
...
V_27 = V_27 ? V_104 : V_23 ;
V_28 = V_28 ? V_105 : V_31 ;
F_9 ( V_34 L_26
L_27 , V_6 , V_27 , V_28 ) ;
if ( F_58 ( V_6 , & V_9 ) == 0 ) {
if ( V_9 >= 0 )
...
int F_63 ( struct V_1 * V_2 , T_5 V_110 )
{
struct V_108 * V_109 ;
V_109 = F_16 ( sizeof( struct V_108 ) , V_43 ) ;
if ( ! V_109 )
return - V_58 ;
F_61 ( & V_111 ) ;
if ( F_60 ( V_2 ) ) {
