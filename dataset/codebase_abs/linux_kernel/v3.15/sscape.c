...
struct V_1 * V_27 ;
int V_36 ;
V_36 = F_77 ( V_132 , V_137 [ V_52 ] , V_138 [ V_52 ] , V_139 ,
...
static int F_81 ( struct V_131 * V_141 , unsigned int V_52 )
{
F_80 ( F_82 ( V_141 ) ) ;
return 0 ;
}
static inline int F_83 ( int V_133 )
{
...
if ( V_147 >= V_142 )
return - V_149 ;
V_52 = F_85 ( V_144 , V_146 -> V_150 [ 0 ] . V_138 , NULL ) ;
if ( ! V_52 )
return - V_88 ;
if ( ! F_86 ( V_52 ) ) {
if ( F_87 ( V_52 ) < 0 ) {
...
V_36 = F_77 ( & V_144 -> V_49 -> V_52 ,
V_137 [ V_147 ] , V_138 [ V_147 ] , V_139 ,
sizeof( struct V_1 ) , & V_49 ) ;
if ( V_36 < 0 )
return V_36 ;
V_27 = F_1 ( V_49 ) ;
...
V_27 -> type = V_117 ;
V_90 [ V_147 ] = F_88 ( V_52 , 0 ) ;
V_76 [ V_147 ] = F_89 ( V_52 , 0 ) ;
V_119 [ V_147 ] = F_89 ( V_52 , 1 ) ;
V_35 [ V_147 ] = F_90 ( V_52 , 0 ) & 0x03 ;
if ( V_27 -> type == V_117 ) {
V_97 [ V_147 ] = V_35 [ V_147 ] ;
V_115 [ V_147 ] = F_91 ( V_90 [ V_147 ] ) ;
} else {
V_115 [ V_147 ] = F_88 ( V_52 , 1 ) ;
V_97 [ V_147 ] = F_90 ( V_52 , 1 ) ;
}
...
static void F_93 ( struct V_143 * V_144 )
{
F_80 ( F_94 ( V_144 ) ) ;
F_92 ( V_144 , NULL ) ;
}
