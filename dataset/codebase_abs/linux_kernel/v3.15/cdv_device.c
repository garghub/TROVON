...
{
struct V_9 * V_10 = F_46 ( V_118 , struct V_9 ,
V_119 ) ;
...
static void F_50 ( struct V_1 * V_2 , bool V_121 )
{
if ( V_121 ) {
T_2 V_122 = F_6 ( V_123 ) ;
V_122 |= V_124 | V_125 |
...
V_129 = V_10 -> V_130 ;
if ( V_129 == NULL ) {
V_129 = F_52 ( V_2 , V_131 ,
L_5 ,
F_53 ( V_132 ) ) ;
if ( V_129 == NULL )
return;
for ( V_48 = 0 ; V_48 < F_53 ( V_132 ) ; V_48 ++ )
F_54 ( V_129 , V_48 , V_48 - 1 , V_132 [ V_48 ] ) ;
V_10 -> V_130 = V_129 ;
}
F_55 ( & V_62 -> V_133 , V_129 , 0 ) ;
}
...
if ( V_129 == NULL )
return;
for ( V_48 = 0 ; V_48 < F_53 ( V_135 ) ; V_48 ++ )
F_54 ( V_129 , V_48 , V_48 , V_135 [ V_48 ] ) ;
V_10 -> V_134 = V_129 ;
}
F_55 ( & V_62 -> V_133 , V_129 , 0 ) ;
}
