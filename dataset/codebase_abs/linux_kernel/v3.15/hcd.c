...
int F_152 ( struct V_1 * V_277 , T_7 V_278 )
{
struct V_11 * V_12 = F_153 ( V_277 -> V_117 , struct V_11 , V_15 ) ;
int V_31 ;
int V_279 = V_12 -> V_280 ;
F_16 ( & V_277 -> V_50 , L_24 ,
( F_154 ( V_278 ) ? L_25 : L_20 ) ,
V_277 -> V_281 ) ;
if ( F_65 ( V_12 ) ) {
...
{
struct V_11 * V_12 = F_153 ( V_298 , struct V_11 , V_299 ) ;
...
F_163 ( V_300 , & V_12 -> V_299 ) ;
}
F_27 ( & V_37 , V_94 ) ;
}
int F_164 ( struct V_116 * V_117 , unsigned V_301 )
{
struct V_11 * V_12 ;
int V_31 = - V_302 ;
...
T_8 F_166 ( int V_304 , void * V_305 )
{
...
struct V_11 * F_173 ( const struct V_311 * V_20 ,
...
if ( V_312 == NULL ) {
V_12 -> V_314 = F_174 ( sizeof( * V_12 -> V_314 ) ,
V_44 ) ;
if ( ! V_12 -> V_314 ) {
F_19 ( V_12 ) ;
F_16 ( V_50 , L_34 ) ;
...
static void F_182 ( struct V_315 * V_315 )
{
struct V_11 * V_12 = F_153 ( V_315 , struct V_11 , V_315 ) ;
if ( F_169 ( V_12 ) )
F_19 ( V_12 -> V_314 ) ;
else
...
int V_105 ;
struct V_1 * V_277 ;
if ( F_191 ( V_325 ) && ! V_12 -> V_326 ) {
struct V_327 * V_326 = F_192 ( V_12 -> V_15 . V_79 , 0 ) ;
if ( F_193 ( V_326 ) ) {
V_105 = F_194 ( V_326 ) ;
if ( V_105 == - V_328 )
return V_105 ;
...
if ( V_120 < 0 || V_120 > 1 )
V_12 -> V_120 = V_12 -> V_330 ? 0 : 1 ;
else
V_12 -> V_120 = V_120 ;
F_26 ( V_331 , & V_12 -> V_94 ) ;
...
goto V_333;
if ( ( V_277 = F_198 ( NULL , & V_12 -> V_15 , 0 ) ) == NULL ) {
...
F_170 ( & V_12 -> V_232 ) ;
if ( F_169 ( V_12 ) && V_320 ) {
V_105 = F_188 ( V_12 , V_320 , V_321 ) ;
if ( V_105 )
goto V_338;
}
V_12 -> V_280 = V_294 ;
V_105 = V_12 -> V_20 -> V_339 ( V_12 ) ;
if ( V_105 < 0 ) {
...
goto V_341;
V_105 = F_200 ( & V_277 -> V_50 . V_342 , & V_343 ) ;
if ( V_105 < 0 ) {
F_49 ( V_136 L_48 ,
V_105 ) ;
goto V_344;
...
F_25 ( V_309 , & V_12 -> V_94 ) ;
F_204 ( & V_12 -> V_101 ) ;
V_12 -> V_20 -> V_345 ( V_12 ) ;
V_12 -> V_280 = V_346 ;
F_25 ( V_309 , & V_12 -> V_94 ) ;
F_204 ( & V_12 -> V_101 ) ;
V_340:
if ( F_169 ( V_12 ) && V_12 -> V_304 > 0 )
F_205 ( V_320 , V_12 ) ;
V_338:
V_337:
V_336:
...
void
F_210 ( struct V_347 * V_50 )
{
struct V_11 * V_12 = F_211 ( V_50 ) ;
if ( V_12 -> V_20 -> V_348 )
V_12 -> V_20 -> V_348 ( V_12 ) ;
}
int F_212 ( struct V_349 * V_350 )
{
if ( V_351 )
return - V_176 ;
V_351 = V_350 ;
