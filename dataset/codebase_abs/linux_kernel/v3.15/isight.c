...
struct V_1 * V_1 ;
int V_31 ;
V_31 = F_68 ( & V_42 -> V_43 , - 1 , NULL , V_168 ,
sizeof( * V_1 ) , & V_96 ) ;
if ( V_31 < 0 )
return V_31 ;
V_1 = V_96 -> V_83 ;
...
static void F_76 ( struct V_158 * V_42 )
{
struct V_1 * V_1 = F_77 ( & V_42 -> V_43 ) ;
if ( F_78 ( & V_1 -> V_48 ) < 0 ) {
F_6 ( V_1 ) ;
F_38 ( & V_1 -> V_91 ) ;
F_34 ( V_1 ) ;
...
static void F_79 ( struct V_158 * V_42 )
{
struct V_1 * V_1 = F_77 ( & V_42 -> V_43 ) ;
F_6 ( V_1 ) ;
F_80 ( V_1 -> V_96 ) ;
