...
F_2 ( V_3 , V_1 ) ;
V_15 = F_16 ( V_25 , V_20 [ V_26 ] , V_54 [ V_26 ] , V_55 ,
...
V_30 -> V_1 = V_1 ;
V_30 -> V_57 = V_3 ;
V_15 = F_17 ( V_11 , V_1 + 4 , - 1 , V_46 [ V_26 ] , V_49 [ V_26 ] ,
V_51 [ V_26 ] , V_58 , 0 , & V_30 -> V_59 ) ;
if ( V_15 < 0 )
goto error;
V_15 = F_18 ( V_30 -> V_59 , 0 , NULL ) ;
if ( V_15 < 0 )
goto error;
V_15 = F_19 ( V_30 -> V_59 ) ;
if ( V_15 < 0 )
...
if ( V_15 < 0 )
goto error;
if ( F_20 ( V_30 -> V_59 , 0 , NULL ) < 0 )
F_9 ( V_52 L_14 ) ;
if ( V_60 [ V_26 ] == V_61 ) {
V_60 [ V_26 ] = F_21 ( V_34 , 2 ) ;
if ( V_60 [ V_26 ] < 0 )
F_9 ( V_19 L_15 ) ;
}
if ( V_62 [ V_26 ] == V_47 ) {
...
if ( F_23 ( V_11 , 0x388 , 0x38a , V_65 , 0 , & V_28 ) < 0 )
F_9 ( V_19 L_20 ) ;
else
if ( F_24 ( V_28 , 0 , 1 , NULL ) < 0 )
F_9 ( V_52 L_21 ) ;
...
if ( ! V_69 [ V_26 ] )
return 0 ;
V_32 = F_27 ( 0x200 , 8 , L_25 ) ;
if ( ! V_32 )
F_9 ( V_52 L_26 ) ;
else {
struct V_69 * V_70 = V_30 -> V_69 = F_28 () ;
if ( ! V_30 -> V_69 )
F_29 ( V_32 ) ;
else {
F_30 ( V_70 , L_27 ) ;
F_31 ( V_70 , L_28 , F_32 ( V_25 ) ) ;
F_33 ( V_70 , V_25 ) ;
V_70 -> V_71 = 0x200 ;
F_34 ( V_70 , V_32 ) ;
F_4 ( V_1 , V_5 ,
...
static int F_37 ( struct V_24 * V_25 , unsigned int V_73 )
{
struct V_10 * V_11 = F_38 ( V_25 ) ;
struct V_29 * V_30 = V_11 -> V_56 ;
#ifdef F_13
if ( V_30 -> V_69 ) {
struct V_31 * V_32 = F_39 ( V_30 -> V_69 ) ;
F_40 ( V_30 -> V_69 ) ;
F_29 ( V_32 ) ;
}
#endif
...
static int F_41 ( struct V_24 * V_25 , unsigned int V_74 ,
T_3 V_75 )
{
struct V_10 * V_11 = F_38 ( V_25 ) ;
struct V_29 * V_30 ;
...
static int F_44 ( struct V_24 * V_25 , unsigned int V_74 )
{
struct V_10 * V_11 = F_38 ( V_25 ) ;
struct V_29 * V_30 ;
if ( ! V_11 )
