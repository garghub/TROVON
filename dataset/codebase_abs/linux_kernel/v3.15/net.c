...
static struct V_28 * F_90 ( int V_131 )
{
struct V_28 * V_29 ;
if ( V_131 == - 1 )
return NULL ;
...
static long F_91 ( struct V_12 * V_13 , unsigned V_130 , int V_131 )
{
...
static long F_96 ( struct V_12 * V_13 )
{
...
static int F_99 ( struct V_12 * V_13 , T_3 V_157 )
{
T_1 V_22 , V_23 , V_158 ;
int V_14 ;
V_158 = ( V_157 & ( 1 << V_114 ) ) ?
...
static long F_102 ( struct V_12 * V_13 )
{
int V_11 ;
F_36 ( & V_13 -> V_50 . V_77 ) ;
if ( F_103 ( & V_13 -> V_50 ) ) {
...
static long F_105 ( struct V_121 * V_122 , unsigned int V_163 ,
unsigned long V_164 )
{
struct V_12 * V_13 = V_122 -> V_78 ;
...
switch ( V_163 ) {
case V_169 :
if ( F_106 ( & V_168 , V_165 , sizeof V_168 ) )
return - V_150 ;
return F_91 ( V_13 , V_168 . V_130 , V_168 . V_131 ) ;
case V_170 :
V_157 = V_171 ;
if ( F_107 ( V_166 , & V_157 , sizeof V_157 ) )
return - V_150 ;
return 0 ;
case V_172 :
if ( F_106 ( & V_157 , V_166 , sizeof V_157 ) )
return - V_150 ;
if ( V_157 & ~ V_171 )
return - V_173 ;
return F_99 ( V_13 , V_157 ) ;
case V_174 :
return F_96 ( V_13 ) ;
case V_175 :
return F_102 ( V_13 ) ;
...
if ( V_11 == - V_176 )
V_11 = F_109 ( & V_13 -> V_50 , V_163 , V_165 ) ;
else
F_76 ( V_13 ) ;
F_47 ( & V_13 -> V_50 . V_77 ) ;
return V_11 ;
...
static long F_110 ( struct V_121 * V_122 , unsigned int V_163 ,
unsigned long V_164 )
{
return F_105 ( V_122 , V_163 , ( unsigned long ) F_111 ( V_164 ) ) ;
}
