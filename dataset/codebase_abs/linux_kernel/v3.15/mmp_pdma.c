...
static int F_64 ( struct V_27 * V_28 , int V_5 , int V_22 )
{
struct V_1 * V_2 = & V_28 -> V_2 [ V_5 ] ;
struct V_32 * V_35 ;
int V_30 ;
V_35 = F_65 ( V_28 -> V_21 , sizeof( struct V_32 ) ,
V_144 ) ;
if ( V_35 == NULL )
return - V_63 ;
V_2 -> V_5 = V_5 ;
...
F_68 ( & V_35 -> V_25 , F_57 , ( unsigned long ) V_35 ) ;
F_32 ( & V_35 -> V_45 ) ;
F_32 ( & V_35 -> V_47 ) ;
F_47 ( & V_35 -> V_35 . V_146 , & V_28 -> V_36 . V_147 ) ;
return 0 ;
}
...
struct V_61 * V_35 ;
V_35 = F_70 ( & V_152 -> V_36 ) ;
if ( ! V_35 )
return NULL ;
F_25 ( V_35 ) -> V_10 = V_149 -> args [ 0 ] ;
return V_35 ;
}
...
struct V_156 * V_157 = F_72 ( & V_143 -> V_21 ) ;
struct V_158 * V_159 ;
int V_29 , V_30 , V_22 = 0 ;
int V_40 = 0 , V_31 = 0 ;
V_28 = F_65 ( & V_143 -> V_21 , sizeof( * V_28 ) , V_144 ) ;
if ( ! V_28 )
return - V_63 ;
V_28 -> V_21 = & V_143 -> V_21 ;
F_67 ( & V_28 -> V_39 ) ;
V_159 = F_73 ( V_143 , V_160 , 0 ) ;
V_28 -> V_7 = F_74 ( V_28 -> V_21 , V_159 ) ;
if ( F_75 ( V_28 -> V_7 ) )
return F_76 ( V_28 -> V_7 ) ;
V_155 = F_77 ( V_161 , V_28 -> V_21 ) ;
if ( V_155 )
F_78 ( V_28 -> V_21 -> V_162 , L_12 ,
& V_40 ) ;
else if ( V_157 && V_157 -> V_40 )
V_40 = V_157 -> V_40 ;
else
V_40 = 32 ;
V_28 -> V_40 = V_40 ;
...
V_28 -> V_2 = F_80 ( V_28 -> V_21 ,
V_40 , sizeof( struct V_32 ) ,
V_144 ) ;
if ( V_28 -> V_2 == NULL )
return - V_63 ;
...
F_81 ( V_163 , V_28 -> V_36 . V_164 ) ;
F_81 ( V_165 , V_28 -> V_36 . V_164 ) ;
F_81 ( V_166 , V_28 -> V_36 . V_164 ) ;
F_81 ( V_167 , V_28 -> V_36 . V_164 ) ;
V_28 -> V_36 . V_21 = & V_143 -> V_21 ;
V_28 -> V_36 . V_168 = F_34 ;
V_28 -> V_36 . V_169 = F_42 ;
V_28 -> V_36 . V_170 = F_54 ;
V_28 -> V_36 . V_171 = F_44 ;
V_28 -> V_36 . V_172 = F_48 ;
V_28 -> V_36 . V_173 = F_52 ;
V_28 -> V_36 . V_174 = F_56 ;
V_28 -> V_36 . V_175 = F_53 ;
V_28 -> V_36 . V_176 = V_177 ;
if ( V_28 -> V_21 -> V_178 )
F_82 ( V_28 -> V_21 , V_28 -> V_21 -> V_178 ) ;
else
F_82 ( V_28 -> V_21 , F_83 ( 64 ) ) ;
V_30 = F_84 ( & V_28 -> V_36 ) ;
if ( V_30 ) {
...
F_86 ( V_143 , V_28 ) ;
F_87 ( V_28 -> V_36 . V_21 , L_15 , V_40 ) ;
return 0 ;
}
bool F_88 ( struct V_61 * V_35 , void * V_179 )
{
struct V_32 * V_180 = F_25 ( V_35 ) ;
if ( V_35 -> V_36 -> V_21 -> V_181 != & V_182 . V_181 )
return false ;
V_180 -> V_10 = * ( unsigned int * ) V_179 ;
return true ;
}
