...
V_13 = & V_3 -> V_13 ;
V_13 -> V_52 = V_190 ;
V_189 = F_51 ( V_191 , & V_182 -> V_91 ) ;
if ( ! V_189 )
return - V_177 ;
if ( V_189 -> V_1 == ( void * ) V_53 )
V_13 -> V_52 = V_53 ;
V_186 = 1 ;
F_52 ( V_184 , L_12 , & V_186 ) ;
V_13 -> V_20 = V_186 ;
F_52 ( V_184 , L_13 , & V_187 ) ;
V_13 -> V_187 = V_187 ;
return 0 ;
}
static struct V_12
...
static int F_53 ( struct V_181 * V_182 )
{
struct V_192 * V_19 ;
struct V_2 * V_3 ;
struct V_12 * V_13 ;
...
int V_197 = 0 , V_27 = 0 ;
T_1 V_198 ;
V_19 = F_54 ( & V_182 -> V_91 , sizeof( struct V_2 ) ) ;
if ( V_19 == NULL ) {
V_27 = - V_116 ;
goto V_199;
}
...
V_13 = & V_3 -> V_13 ;
V_173 = F_57 ( V_182 , V_201 , 0 ) ;
if ( V_173 == NULL ) {
V_27 = - V_202 ;
goto V_200;
}
V_3 -> V_139 = V_173 -> V_203 ;
V_3 -> V_24 = F_58 ( & V_182 -> V_91 , V_173 ) ;
if ( F_59 ( V_3 -> V_24 ) ) {
V_27 = F_60 ( V_3 -> V_24 ) ;
goto V_200;
}
V_3 -> V_170 = F_61 ( V_182 , 0 ) ;
if ( V_3 -> V_170 <= 0 ) {
V_27 = - V_29 ;
goto V_200;
}
V_27 = F_62 ( & V_182 -> V_91 , V_3 -> V_170 , F_44 ,
F_43 , 0 , F_41 ( & V_182 -> V_91 ) , V_3 ) ;
if ( V_27 )
goto V_200;
V_3 -> V_90 . V_19 = V_19 ;
V_3 -> V_28 = F_63 ( & V_182 -> V_91 , NULL ) ;
if ( F_59 ( V_3 -> V_28 ) ) {
V_27 = - V_177 ;
goto V_200;
}
...
V_19 -> V_204 = V_182 -> V_205 ;
V_19 -> V_20 = V_13 -> V_20 ;
V_19 -> V_206 = F_65 ( 2 , 16 ) ;
V_19 -> V_207 = F_17 ;
V_3 -> V_90 . V_208 = F_9 ;
V_3 -> V_90 . V_209 = F_16 ;
V_3 -> V_52 = V_13 -> V_52 ;
V_3 -> V_90 . V_210 = V_81 | V_46 | V_84 ;
if ( V_3 -> V_52 == V_53 )
V_3 -> V_90 . V_210 |= V_70 ;
V_173 = F_57 ( V_182 , V_211 , 0 ) ;
if ( V_173 )
V_194 = V_173 -> V_203 ;
V_173 = F_57 ( V_182 , V_211 , 1 ) ;
if ( V_173 )
V_196 = V_173 -> V_203 ;
V_3 -> V_90 . V_212 = F_25 ;
if ( V_194 != V_195 &&
...
if ( V_27 )
goto V_213;
F_66 ( & V_182 -> V_91 , L_14 ) ;
F_66 ( & V_182 -> V_91 , L_15
L_16 , & V_194 , & V_196 ,
V_13 -> V_214 ) ;
}
V_3 -> V_41 = F_1 ;
V_3 -> V_42 = F_3 ;
F_67 ( & V_3 -> V_114 ) ;
F_7 ( 0 , V_3 -> V_24 + V_215 ) ;
F_68 ( 100 ) ;
F_7 ( 1 , V_3 -> V_24 + V_215 ) ;
V_198 = V_216 | V_217 | V_218 ;
F_7 ( V_198 , V_3 -> V_24 + V_82 ) ;
if ( V_13 -> V_14 ) {
for ( V_197 = 0 ; V_197 < V_13 -> V_20 ; V_197 ++ ) {
if ( V_13 -> V_14 [ V_197 ] != V_21 )
F_69 ( V_13 -> V_14 [ V_197 ] , 1 ) ;
}
}
if ( V_13 -> V_187 )
F_7 ( V_219 , V_3 -> V_24 + V_220 ) ;
else
F_7 ( V_221 , V_3 -> V_24 + V_220 ) ;
F_7 ( V_17 , V_3 -> V_24 + V_222 ) ;
F_5 ( V_3 -> V_24 + V_85 , V_223 ) ;
F_5 ( V_3 -> V_24 + V_85 , V_224 ) ;
F_5 ( V_3 -> V_24 + V_85 , V_127 ) ;
V_27 = F_70 ( & V_3 -> V_90 ) ;
if ( V_27 )
goto V_225;
F_66 ( & V_182 -> V_91 , L_17 , V_3 -> V_24 ) ;
return V_27 ;
V_225:
F_49 ( V_3 -> V_152 ) ;
F_49 ( V_3 -> V_153 ) ;
...
static int F_73 ( struct V_181 * V_182 )
{
struct V_2 * V_3 ;
struct V_192 * V_19 ;
V_19 = F_74 ( V_182 ) ;
