...
static int
F_72 ( struct V_1 * V_2 , T_2 V_203 , T_2 V_204 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
if ( V_203 == 1 && V_204 == 1 )
F_24 ( V_8 , V_205 ) ;
else if ( V_203 == 2 && V_204 == 2 )
F_24 ( V_8 , V_206 ) ;
else if ( ( V_203 & 3 ) == 3 && ( V_204 & 3 ) == 3 )
F_24 ( V_8 , V_207 ) ;
else
return - V_141 ;
return 0 ;
...
static int
F_73 ( struct V_1 * V_2 , T_2 * V_203 , T_2 * V_204 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
switch ( V_8 -> V_59 ) {
case V_205 :
* V_203 = 1 ; * V_204 = 1 ; break;
case V_206 :
* V_203 = 2 ; * V_204 = 2 ; break;
case V_207 :
* V_203 = 3 ; * V_204 = 3 ; break;
}
return 0 ;
}
static void F_74 ( struct V_1 * V_2 ,
T_2 * V_208 , T_2 * V_209 , T_2 * V_210 , T_2 * V_211 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
* V_208 = V_8 -> V_14 [ V_212 ] . V_213 ;
* V_209 = V_214 ;
* V_210 = * V_211 = V_215 ;
}
static int F_75 ( struct V_1 * V_2 , T_2 V_208 , T_2 V_210 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
T_1 V_10 ;
if ( V_210 != V_215 )
...
if ( ! V_8 -> V_14 [ V_10 ] . V_216 )
continue;
if ( V_8 -> V_14 [ V_10 ] . V_10 < V_212 ||
V_8 -> V_14 [ V_10 ] . V_10 > V_217 )
continue;
V_8 -> V_14 [ V_10 ] . V_213 = V_208 ;
if ( V_8 -> V_14 [ V_10 ] . V_218 >= V_8 -> V_14 [ V_10 ] . V_213 )
