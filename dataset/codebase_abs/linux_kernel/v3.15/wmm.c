...
= V_34 -> V_97 [ 6 ] . V_101
= V_99 ;
V_34 -> V_97 [ 7 ] . V_98 = V_34 -> V_97 [ 7 ] . V_100
= V_34 -> V_97 [ 7 ] . V_101
= V_99 ;
F_32 ( V_34 ) ;
F_33 ( V_34 ) ;
...
struct V_13 *
F_50 ( struct V_33 * V_34 , T_1 V_89 , T_1 * V_113 )
{
struct V_13 * V_17 ;
...
{
T_1 * V_136 = ( T_1 * ) & V_135 -> V_137 . V_138 ;
T_4 V_139 = F_3 ( V_135 -> V_140 ) , V_141 ;
bool V_142 = true ;
struct V_143 * V_144 ;
struct V_145 * V_146 ;
struct V_60 * V_147 = NULL ;
struct V_81 * V_82 ;
F_8 ( V_34 -> V_15 -> V_23 , L_19 ,
V_139 ) ;
while ( ( V_139 >= sizeof( V_144 -> V_148 ) ) && V_142 ) {
V_144 = (struct V_143 * ) V_136 ;
V_141 = F_3 ( V_144 -> V_148 . V_149 ) ;
if ( V_139 < V_141 + sizeof( V_144 -> V_148 ) )
break;
switch ( F_3 ( V_144 -> V_148 . type ) ) {
case V_150 :
V_146 =
(struct V_145 * )
V_144 ;
...
V_146 -> V_84 ,
V_146 -> V_83 ) ;
V_82 = & V_34 -> V_47 . V_82 [ V_146 ->
V_151 ] ;
V_82 -> V_83 = V_146 -> V_83 ;
V_82 -> V_84 =
V_146 -> V_84 ;
V_82 -> V_152 = V_146 -> V_152 ;
break;
case V_153 :
V_147 =
(struct V_60 * ) ( V_136 +
2 ) ;
V_147 -> V_69 . V_149 = ( T_1 ) V_141 ;
V_147 -> V_69 . V_154 =
V_153 ;
F_8 ( V_34 -> V_15 -> V_23 ,
L_20
...
V_136 += ( V_141 + sizeof( V_144 -> V_148 ) ) ;
V_139 -= ( V_141 + sizeof( V_144 -> V_148 ) ) ;
}
F_24 ( V_34 , V_147 ) ;
F_28 ( V_34 ) ;
return 0 ;
...
V_61 -> V_69 . V_154 ) ;
if ( ( V_34 -> V_163 ||
( V_159 && ( V_34 -> V_15 -> V_164 & V_165 ||
V_34 -> V_15 -> V_164 & V_166 ) ) ) &&
V_61 -> V_69 . V_154 == V_153 ) {
V_161 = (struct V_160 * ) * V_157 ;
V_161 -> V_148 . type = F_64 ( ( T_3 ) V_167 [ 0 ] ) ;
V_161 -> V_148 . V_149 = F_64 ( ( T_3 ) V_167 [ 1 ] ) ;
memcpy ( V_161 -> V_61 , & V_167 [ 2 ] ,
F_3 ( V_161 -> V_148 . V_149 ) ) ;
if ( V_61 -> V_71 & V_168 )
memcpy ( ( T_1 * ) ( V_161 -> V_61
+ F_3 ( V_161 -> V_148 . V_149 )
- sizeof( V_34 -> V_169 ) ) ,
& V_34 -> V_169 , sizeof( V_34 -> V_169 ) ) ;
V_162 = sizeof( V_161 -> V_148 )
+ F_3 ( V_161 -> V_148 . V_149 ) ;
* V_157 += V_162 ;
}
return V_162 ;
...
{
T_1 V_170 ;
struct V_26 V_171 , V_172 ;
T_2 V_173 ;
F_10 ( & V_171 ) ;
V_172 = F_66 ( V_104 -> V_174 ) ;
V_173 = ( V_171 . V_29 - V_172 . V_29 ) * 1000 ;
V_173 += ( V_171 . V_30 - V_172 . V_30 ) / 1000 ;
V_170 = ( T_1 ) ( F_67 ( V_173 , V_34 -> V_47 . V_175 ) >> 1 ) ;
...
F_12 ( & V_15 -> V_183 [ V_65 ] . V_184 ,
V_181 ) ;
F_40 (adapter->bss_prio_tbl[j].bss_prio_cur,
&adapter->bss_prio_tbl[j].bss_prio_head,
list) {
V_176 = V_15 -> V_183 [ V_65 ] . V_185 -> V_34 ;
if ( F_35 ( & V_176 -> V_47 . V_102 ) == 0 )
continue;
V_180 = & V_176 -> V_47 . V_58 ;
for ( V_35 = F_35 ( V_180 ) ; V_35 >= V_186 ; -- V_35 ) {
F_12 ( & V_176 -> V_47 .
V_108 , V_182 ) ;
V_179 = & ( V_176 ) -> V_47 .
V_48 [ V_55 [ V_35 ] ] ;
...
{
struct V_14 * V_15 = V_34 -> V_15 ;
struct V_188 * V_189 = V_15 -> V_183 ;
struct V_178 * V_179 = & V_34 -> V_47 . V_48 [ V_89 ] ;
unsigned long V_38 ;
F_12 ( & V_189 [ V_34 -> V_190 ] . V_184 , V_38 ) ;
F_71 ( & V_189 [ V_34 -> V_190 ] . V_191 ,
& V_189 [ V_34 -> V_190 ] . V_185 -> V_19 ) ;
F_14 ( & V_189 [ V_34 -> V_190 ] . V_184 , V_38 ) ;
F_12 ( & V_34 -> V_47 . V_108 , V_38 ) ;
if ( F_51 ( V_34 , V_16 , V_89 ) ) {
V_34 -> V_47 . V_192 [ V_89 ] ++ ;
F_71 ( & V_179 -> V_17 , & V_16 -> V_19 ) ;
}
F_14 ( & V_34 -> V_47 . V_108 , V_38 ) ;
}
static int
...
struct V_103 * V_104 , * V_64 ;
int V_196 ;
if ( V_34 -> V_197 == V_198 && V_34 -> V_199 &&
V_177 -> V_41 )
V_196 = F_73 ( int , V_177 -> V_44 , V_193 ) ;
else
V_196 = V_193 ;
...
int V_203 = 0 , V_89 = 0 ;
unsigned long V_38 ;
V_177 = F_68 ( V_15 , & V_34 , & V_114 ) ;
if ( ! V_177 )
return - 1 ;
V_89 = F_79 ( V_177 ) ;
F_8 ( V_15 -> V_23 , L_26 , V_89 ) ;
F_12 ( & V_34 -> V_47 . V_108 , V_38 ) ;
if ( ! F_51 ( V_34 , V_177 , V_114 ) ) {
F_14 ( & V_34 -> V_47 . V_108 , V_38 ) ;
return - 1 ;
}
if ( F_75 ( V_34 , V_177 ) ) {
F_77 ( V_34 , V_177 , V_114 , V_38 ) ;
return 0 ;
}
if ( ! V_177 -> V_41 ||
F_80 ( V_34 , V_177 , V_89 ) ||
V_34 -> V_204 . V_205 ) {
if ( V_177 -> V_41 &&
F_80 ( V_34 , V_177 , V_89 ) &&
F_81 ( V_34 , V_177 , V_89 ) &&
F_82 ( V_34 , V_89 ) &&
F_72 ( V_34 , V_177 ,
V_15 -> V_95 ) )
F_83 ( V_34 , V_177 , V_114 , V_38 ) ;
else
F_74 ( V_34 , V_177 , V_114 , V_38 ) ;
} else {
if ( F_84 ( V_34 , V_177 , V_89 ) &&
V_177 -> V_45 > V_177 -> V_46 ) {
if ( F_85 ( V_15 ) ) {
F_86 ( V_34 , V_177 -> V_16 , V_89 ,
V_206 ) ;
F_87 ( V_34 , V_89 , V_177 -> V_16 ) ;
} else if ( F_88
( V_34 , V_89 , & V_203 , V_16 ) ) {
F_86 ( V_34 , V_177 -> V_16 , V_89 ,
V_206 ) ;
F_89 ( V_34 , V_203 , V_16 , 1 ) ;
}
}
if ( F_82 ( V_34 , V_89 ) &&
F_72 ( V_34 , V_177 ,
