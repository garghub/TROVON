...
if ( ! V_147 ) {
F_68 ( & V_145 -> V_25 , & V_22 -> V_148 ) ;
}
}
}
bool F_69 ( const char * V_149 ,
struct V_21 * V_22 ,
struct V_150 * V_2 )
{
const char * V_5 ;
...
unsigned int V_155 = 0 , V_156 = 0 , V_157 = 32 , V_98 = 0 ;
bool V_158 = false , V_159 = false , V_160 = false ;
bool V_38 = false , V_29 = false , V_161 = false ;
int V_162 ;
...
V_5 = V_149 ;
V_151 = strlen ( V_5 ) ;
for ( V_162 = V_151 - 1 ; V_162 >= 0 ; V_162 -- ) {
switch ( V_5 [ V_162 ] ) {
case '@' :
if ( ! V_154 && ! V_153 &&
! V_158 && ! V_159 && ! V_160 && V_161 ) {
V_98 = F_71 ( & V_5 [ V_162 + 1 ] , NULL , 10 ) ;
V_154 = true ;
V_161 = false ;
} else
goto V_168;
...
! V_160 && V_161 ) {
V_157 = F_71 ( & V_5 [ V_162 + 1 ] , NULL , 10 ) ;
V_153 = true ;
V_161 = false ;
} else
goto V_168;
...
case 'x' :
if ( ! V_158 && V_161 ) {
V_156 = F_71 ( & V_5 [ V_162 + 1 ] , NULL , 10 ) ;
V_158 = true ;
V_161 = false ;
} else
goto V_168;
...
if ( V_177 -> V_159 )
V_2 = F_13 ( V_17 ,
V_177 -> V_155 , V_177 -> V_156 ,
V_177 -> V_154 ? V_177 -> V_98 : 60 ,
V_177 -> V_160 , V_177 -> V_38 ,
V_177 -> V_29 ) ;
else
V_2 = F_42 ( V_17 ,
V_177 -> V_155 , V_177 -> V_156 ,
