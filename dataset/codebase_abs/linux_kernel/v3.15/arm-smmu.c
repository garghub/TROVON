...
int V_60 = - V_209 ;
struct V_68 * V_69 = V_67 -> V_70 ;
struct V_1 * V_210 = V_4 -> V_165 . V_166 ;
struct V_10 * V_16 ;
unsigned long V_59 ;
if ( ! V_210 ) {
F_10 ( V_4 , L_15 ) ;
...
unsigned long V_215 , int V_216 , int V_217 )
{
T_10 * V_218 , * V_40 ;
T_11 V_219 = V_220 | V_221 | V_222 ;
if ( F_67 ( * V_183 ) ) {
T_6 V_184 = F_91 ( V_223 | V_224 ) ;
if ( ! V_184 )
return - V_33 ;
...
V_42 &= ~ ( V_240 - 1 ) ;
V_242 = F_95 ( * V_183 ) + V_42 ;
for ( V_241 = 0 ; V_241 < V_240 ; ++ V_241 )
F_97 ( * ( V_242 + V_241 ) ) &= ~ V_239 ;
F_40 ( V_2 , V_242 ,
sizeof( * V_218 ) *
V_240 ) ;
}
do {
* V_218 = F_98 ( V_215 , F_99 ( V_219 ) ) ;
} while ( V_218 ++ , V_215 ++ , V_96 += V_134 , -- V_3 );
} while ( V_96 != V_41 );
F_40 ( V_2 , V_40 , sizeof( * V_218 ) * ( V_218 - V_40 ) ) ;
return 0 ;
}
static int F_100 ( struct V_1 * V_2 , T_7 * V_185 ,
unsigned long V_96 , unsigned long V_41 ,
V_131 V_243 , int V_216 , int V_217 )
{
int V_60 ;
T_5 * V_183 ;
unsigned long V_244 , V_215 = F_101 ( V_243 ) ;
#ifndef F_102
if ( F_71 ( * V_185 ) ) {
V_183 = ( T_5 * ) F_103 ( V_223 ) ;
if ( ! V_183 )
return - V_33 ;
...
do {
V_244 = F_106 ( V_96 , V_41 ) ;
V_60 = F_90 ( V_2 , V_183 , V_96 , V_244 , V_215 ,
V_216 , V_217 ) ;
V_243 += V_244 - V_96 ;
} while ( V_183 ++ , V_96 = V_244 , V_96 < V_41 );
return V_60 ;
}
...
do {
V_244 = F_111 ( V_96 , V_41 ) ;
V_60 = F_100 ( V_2 , V_185 , V_96 , V_244 , V_243 ,
V_216 , V_217 ) ;
V_243 += V_244 - V_96 ;
} while ( V_185 ++ , V_96 = V_244 , V_96 < V_41 );
return V_60 ;
}
static int F_112 ( struct V_68 * V_69 ,
unsigned long V_65 , V_131 V_245 ,
T_4 V_97 , int V_216 )
{
int V_60 , V_217 ;
unsigned long V_41 ;
...
V_41 = V_65 + V_97 ;
do {
unsigned long V_244 = F_114 ( V_65 , V_41 ) ;
V_60 = F_107 ( V_2 , V_127 , V_65 , V_244 , V_245 ,
V_216 , V_217 ) ;
if ( V_60 )
goto V_38;
V_245 += V_244 - V_65 ;
...
V_131 V_245 , T_4 V_97 , int V_216 )
{
struct V_68 * V_69 = V_67 -> V_70 ;
if ( ! V_69 )
return - V_168 ;
...
return - V_247 ;
return F_112 ( V_69 , V_65 , V_245 , V_97 , V_216 ) ;
}
...
if ( F_67 ( V_183 ) )
return 0 ;
V_218 = * ( F_95 ( V_183 ) + F_96 ( V_65 ) ) ;
if ( F_118 ( V_218 ) )
return 0 ;
return F_119 ( F_120 ( V_218 ) ) | ( V_65 & ~ V_99 ) ;
}
...
if ( V_252 -> V_36 == V_20 -> V_4 -> V_5 ) {
V_16 = F_4 ( V_252 , V_4 -> V_5 ) ;
if ( V_16 ) {
V_2 = NULL ;
break;
}
...
F_24 ( 0 , V_44 + V_256 ) ;
F_24 ( 0 , V_44 + V_257 ) ;
V_104 = F_25 ( F_39 ( V_2 ) + V_258 ) ;
V_104 |= ( V_259 | V_260 | V_261 | V_262 ) ;
V_104 |= ( V_263 | V_264 ) ;
V_104 &= ~ ( V_265 | V_266 ) ;
V_104 &= ~ V_267 ;
V_104 &= ~ ( V_268 << V_269 ) ;
F_22 ( V_2 ) ;
F_37 ( V_104 , F_39 ( V_2 ) + V_258 ) ;
}
...
T_3 V_198 ;
F_3 ( V_2 -> V_4 , L_19 ) ;
V_198 = F_25 ( V_44 + V_270 ) ;
V_2 -> V_106 = ( ( V_198 >> V_271 ) & V_272 ) + 1 ;
F_3 ( V_2 -> V_4 , L_20 , V_2 -> V_106 ) ;
V_198 = F_25 ( V_44 + V_273 ) ;
#ifndef F_35
if ( ( ( V_198 >> V_274 ) & V_275 ) == V_276 ) {
F_10 ( V_2 -> V_4 , L_21 ) ;
return - V_168 ;
}
#endif
...
if ( V_198 & V_282 ) {
T_3 V_283 , V_202 , V_197 ;
V_2 -> V_100 |= V_193 ;
V_2 -> V_195 = ( V_198 >> V_284 ) &
V_285 ;
if ( V_2 -> V_195 == 0 ) {
F_10 ( V_2 -> V_4 ,
L_27 ) ;
...
V_283 = V_286 << V_201 ;
V_283 |= ( V_287 << V_200 ) ;
F_24 ( V_283 , V_44 + F_78 ( 0 ) ) ;
V_283 = F_25 ( V_44 + F_78 ( 0 ) ) ;
V_197 = ( V_283 >> V_201 ) & V_286 ;
V_202 = ( V_283 >> V_200 ) & V_287 ;
...
V_198 = F_25 ( V_44 + V_288 ) ;
V_2 -> V_289 = ( V_198 & V_290 ) ? V_291 : V_135 ;
V_97 = 1 << ( ( ( V_198 >> V_292 ) & V_293 ) + 1 ) ;
V_97 *= ( V_2 -> V_289 << 1 ) ;
if ( V_2 -> V_97 != V_97 )
F_15 ( V_2 -> V_4 , L_30
L_31 , V_97 , V_2 -> V_97 ) ;
V_2 -> V_171 = ( V_198 >> V_294 ) &
V_295 ;
V_2 -> V_174 = ( V_198 >> V_296 ) & V_297 ;
...
F_3 ( V_2 -> V_4 , L_33 ,
V_2 -> V_174 , V_2 -> V_171 ) ;
V_198 = F_25 ( V_44 + V_298 ) ;
V_97 = F_131 ( ( V_198 >> V_299 ) & V_300 ) ;
#ifdef F_35
V_2 -> V_124 = F_133 ( 39UL , V_97 ) ;
#else
...
V_97 = F_133 ( V_306 , F_131 ( V_97 ) ) ;
#else
V_97 = 32 ;
#endif
V_2 -> V_116 = V_97 ;
if ( ( V_134 == V_135 && ! ( V_198 & V_307 ) ) ||
( V_134 == V_291 && ! ( V_198 & V_308 ) ) ||
( V_134 != V_135 && V_134 != V_291 ) ) {
F_10 ( V_2 -> V_4 , L_34 ,
V_134 ) ;
return - V_168 ;
}
...
V_2 -> V_4 = V_4 ;
V_312 = F_135 ( V_310 , V_315 , 0 ) ;
V_2 -> V_51 = F_136 ( V_4 , V_312 ) ;
if ( F_124 ( V_2 -> V_51 ) )
return F_125 ( V_2 -> V_51 ) ;
V_2 -> V_97 = F_137 ( V_312 ) ;
...
V_313 = 0 ;
while ( ( V_312 = F_135 ( V_310 , V_316 , V_313 ) ) ) {
V_313 ++ ;
if ( V_313 > V_2 -> V_177 )
V_2 -> V_175 ++ ;
}
...
V_2 -> V_176 = F_11 ( V_4 , sizeof( * V_2 -> V_176 ) * V_313 ,
V_32 ) ;
if ( ! V_2 -> V_176 ) {
F_10 ( V_4 , L_40 , V_313 ) ;
return - V_33 ;
...
static int F_147 ( struct V_309 * V_310 )
{
int V_3 ;
struct V_23 * V_4 = & V_310 -> V_4 ;
struct V_1 * V_323 , * V_2 = NULL ;
struct V_13 * V_14 ;
F_13 ( & V_37 ) ;
...
if ( ! F_149 ( V_2 -> V_173 , V_324 ) )
F_10 ( V_4 , L_50 ) ;
for ( V_3 = 0 ; V_3 < V_2 -> V_177 ; ++ V_3 )
F_56 ( V_2 -> V_176 [ V_3 ] , V_2 ) ;
F_37 ( V_265 , F_39 ( V_2 ) + V_258 ) ;
return 0 ;
}
