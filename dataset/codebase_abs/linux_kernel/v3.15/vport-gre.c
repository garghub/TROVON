...
F_8 ( V_60 ) : 0 ;
V_8 -> V_61 = 1 ;
return F_34 ( V_8 -> V_62 , V_34 , V_8 , V_32 . V_41 ,
F_5 ( V_8 ) -> V_11 -> V_40 , V_48 ,
F_5 ( V_8 ) -> V_11 -> V_44 ,
F_5 ( V_8 ) -> V_11 -> V_63 , V_36 , false ) ;
V_55:
F_35 ( V_34 ) ;
error:
return V_37 ;
...
static struct V_22 * F_43 ( const struct V_66 * V_67 )
{
struct V_29 * V_29 = F_20 ( V_67 -> V_30 ) ;
struct V_21 * V_21 ;
struct V_22 * V_22 ;
int V_37 ;
V_37 = F_36 () ;
...
V_22 = F_46 ( V_69 , & V_70 , V_67 ) ;
if ( F_7 ( V_22 ) )
goto error;
strncpy ( F_42 ( V_22 ) , V_67 -> V_71 , V_69 ) ;
