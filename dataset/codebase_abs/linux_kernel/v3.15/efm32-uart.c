...
if ( V_69 )
V_69 = F_68 ( V_146 , L_12 , & V_74 ) ;
if ( ! V_69 ) {
if ( V_74 > 5 ) {
F_69 ( & V_144 -> V_118 , L_13 ) ;
return - V_124 ;
}
F_30 ( V_2 , L_14 , V_74 ) ;
V_2 -> V_73 . V_74 = V_74 ;
...
V_69 = F_70 ( V_146 , L_16 ) ;
if ( V_69 < 0 ) {
F_69 ( & V_144 -> V_118 , L_17 , V_69 ) ;
return V_69 ;
} else {
V_2 -> V_5 . line = V_69 ;
return 0 ;
...
goto V_164;
line = V_2 -> V_5 . line ;
if ( line >= 0 && line < F_62 ( V_131 ) )
V_131 [ line ] = V_2 ;
V_69 = F_78 ( & V_165 , & V_2 -> V_5 ) ;
if ( V_69 ) {
F_73 ( & V_144 -> V_118 , L_22 , V_69 ) ;
if ( line >= 0 && line < F_62 ( V_131 ) )
V_131 [ line ] = NULL ;
V_164:
V_154:
...
unsigned int line = V_2 -> V_5 . line ;
F_83 ( & V_165 , & V_2 -> V_5 ) ;
if ( line >= 0 && line < F_62 ( V_131 ) )
V_131 [ line ] = NULL ;
F_79 ( V_2 ) ;
