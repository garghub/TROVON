...
switch ( V_45 & V_50 ) {
case V_51 :
V_9 |= F_2 ( V_2 , & V_44 -> V_52 , 2 ) ;
V_9 |= F_2 ( V_2 , & V_44 -> V_53 , 2 ) ;
break;
case V_54 :
V_9 |= F_2 ( V_2 , & V_44 -> V_52 , 2 ) ;
V_9 |= F_2 ( V_2 , & V_46 , 1 ) ;
V_44 -> V_53 = F_3 ( V_46 + V_55 ) ;
break;
case V_56 :
V_9 |= F_2 ( V_2 , & V_46 , 1 ) ;
V_44 -> V_52 = F_3 ( V_46 + V_55 ) ;
V_9 |= F_2 ( V_2 , & V_44 -> V_53 , 2 ) ;
break;
case V_50 :
V_9 |= F_2 ( V_2 , & V_46 , 1 ) ;
...
F_4 ( L_13 ,
F_18 ( V_44 -> V_52 ) , F_18 ( V_44 -> V_53 ) ) ;
if ( V_45 & V_58 ) {
F_19 ( L_14 ) ;
goto V_47;
} else {
V_9 |= F_2 ( V_2 , & V_44 -> V_59 , 2 ) ;
}
...
F_4 ( L_21 ) ;
V_47 = F_1 ( V_2 , & V_24 . V_60 , V_45 , V_60 ,
V_61 , V_62 ) ;
}
if ( V_47 )
goto V_70;
...
V_47 = F_1 ( V_2 , & V_24 . V_63 , V_45 , V_63 ,
V_64 , V_65 ) ;
F_4 ( L_23 ,
V_45 , & V_24 . V_63 ) ;
if ( V_47 )
...
static T_1 F_25 ( T_1 * * V_88 , T_1 V_89 ,
...
memcpy ( * V_88 , & V_4 -> V_17 [ 7 ] , 2 ) ;
* V_88 += 2 ;
V_46 = 2 ;
F_5 ( NULL , L_30 ,
* V_88 - 2 , 2 ) ;
} else {
memcpy ( * V_88 , & V_4 -> V_17 [ 4 ] , 8 ) ;
* V_88 += 8 ;
V_46 = 1 ;
F_5 ( NULL , L_31 ,
* V_88 - 8 , 8 ) ;
...
T_1 V_45 ;
if ( ( ( F_18 ( V_44 -> V_52 ) & V_90 ) ==
V_57 ) &&
( ( F_18 ( V_44 -> V_53 ) & V_90 ) ==
V_57 ) ) {
F_4 ( L_32 ) ;
V_45 = V_50 ;
F_31 ( V_88 , & V_45 , sizeof( V_45 ) ) ;
V_45 = F_18 ( V_44 -> V_53 ) - V_57 +
( ( F_18 ( V_44 -> V_52 ) - V_57 ) << 4 ) ;
F_31 ( V_88 , & V_45 , sizeof( V_45 ) ) ;
} else if ( ( F_18 ( V_44 -> V_53 ) & V_91 ) ==
V_55 ) {
F_4 ( L_33 ) ;
V_45 = V_54 ;
F_31 ( V_88 , & V_45 , sizeof( V_45 ) ) ;
F_31 ( V_88 , & V_44 -> V_52 , sizeof( V_44 -> V_52 ) ) ;
V_45 = F_18 ( V_44 -> V_53 ) - V_55 ;
F_31 ( V_88 , & V_45 , sizeof( V_45 ) ) ;
...
V_45 = V_56 ;
F_31 ( V_88 , & V_45 , sizeof( V_45 ) ) ;
V_45 = F_18 ( V_44 -> V_52 ) - V_55 ;
F_31 ( V_88 , & V_45 , sizeof( V_45 ) ) ;
F_31 ( V_88 , & V_44 -> V_53 , sizeof( V_44 -> V_53 ) ) ;
} else {
F_4 ( L_35 ) ;
V_45 = V_51 ;
F_31 ( V_88 , & V_45 , sizeof( V_45 ) ) ;
...
F_31 ( V_88 , & V_44 -> V_59 , sizeof( V_44 -> V_59 ) ) ;
F_22 ( V_2 , sizeof( struct V_43 ) ) ;
}
int F_32 ( struct V_1 * V_2 , struct V_25 * V_22 ,
...
F_4 ( L_45 ) ;
memcpy ( V_88 , & V_24 -> V_60 . V_17 [ 0 ] , 16 ) ;
V_88 += 16 ;
}
if ( F_37 ( & V_24 -> V_63 ) ) {
F_4 ( L_46 ) ;
...
F_4 ( L_47 ) ;
V_67 |= V_42 ;
* V_88 = V_24 -> V_63 . V_11 [ 15 ] ;
V_88 += 1 ;
} else if ( F_39 ( & V_24 -> V_63 ) ) {
F_4 ( L_48 ) ;
V_67 |= V_41 ;
* V_88 = V_24 -> V_63 . V_11 [ 1 ] ;
memcpy ( V_88 + 1 , & V_24 -> V_63 . V_11 [ 13 ] , 3 ) ;
V_88 += 4 ;
} else if ( F_40 ( & V_24 -> V_63 ) ) {
F_4 ( L_49 ) ;
V_67 |= V_40 ;
* V_88 = V_24 -> V_63 . V_11 [ 1 ] ;
memcpy ( V_88 + 1 , & V_24 -> V_63 . V_11 [ 11 ] , 5 ) ;
V_88 += 6 ;
} else {
F_4 ( L_50 ) ;
V_67 |= V_39 ;
memcpy ( V_88 , & V_24 -> V_63 . V_11 [ 0 ] , 16 ) ;
V_88 += 16 ;
}
} else {
if ( F_36 ( & V_24 -> V_63 ) ) {
...
F_4 ( L_52 , & V_24 -> V_63 ) ;
memcpy ( V_88 , & V_24 -> V_63 . V_17 [ 0 ] , 16 ) ;
V_88 += 16 ;
}
}
if ( V_24 -> V_76 == V_86 )
