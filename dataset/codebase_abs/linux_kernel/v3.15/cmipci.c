...
int V_353 , V_354 ;
static F_163 ( V_355 ) = {
{ F_164 (PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_82437VX) } ,
{ } ,
} ;
* V_346 = NULL ;
if ( ( V_161 = F_165 ( V_232 ) ) < 0 )
return V_161 ;
V_2 = F_166 ( sizeof( * V_2 ) , V_151 ) ;
if ( V_2 == NULL ) {
F_157 ( V_232 ) ;
return - V_135 ;
}
...
if ( ( V_161 = F_169 ( V_232 , V_68 -> V_224 ) ) < 0 ) {
F_62 ( V_2 ) ;
F_157 ( V_232 ) ;
return V_161 ;
}
V_2 -> V_5 = F_170 ( V_232 , 0 ) ;
if ( F_171 ( V_232 -> V_174 , F_75 ,
V_356 , V_357 , V_2 ) ) {
...
sprintf ( V_68 -> V_368 , L_31 , V_7 ) ;
if ( V_2 -> V_94 < 68 )
sprintf ( V_352 , L_32 , V_2 -> V_94 ) ;
else
V_352 [ 0 ] = '\0' ;
sprintf ( V_68 -> V_308 , L_33 ,
V_68 -> V_368 , V_352 , V_2 -> V_5 , V_2 -> V_174 ) ;
if ( ( V_161 = F_174 ( V_68 , V_369 , V_2 , & V_348 ) ) < 0 ) {
F_154 ( V_2 ) ;
return V_161 ;
}
if ( V_2 -> V_94 >= 39 ) {
...
static int F_177 ( struct V_345 * V_232 ,
...
V_161 = F_178 ( & V_232 -> V_69 , V_385 [ V_69 ] , V_150 [ V_69 ] , V_386 ,
0 , & V_68 ) ;
if ( V_161 < 0 )
return V_161 ;
switch ( V_232 -> V_222 ) {
...
static void F_182 ( struct V_345 * V_232 )
{
F_179 ( F_183 ( V_232 ) ) ;
}
static int F_184 ( struct V_222 * V_69 )
{
struct V_345 * V_232 = F_185 ( V_69 ) ;
struct V_283 * V_68 = F_186 ( V_69 ) ;
...
static int F_191 ( struct V_222 * V_69 )
{
struct V_345 * V_232 = F_185 ( V_69 ) ;
struct V_283 * V_68 = F_186 ( V_69 ) ;
struct V_1 * V_2 = V_68 -> V_185 ;
