...
if ( ! V_119 -> V_274 )
return - V_275 ;
V_14 = F_154 ( V_119 , sizeof( * V_14 ) , V_276 ) ;
if ( ! V_14 )
return - V_277 ;
V_271 = F_155 ( V_278 , V_119 -> V_274 ) ;
if ( V_271 )
V_268 = (struct V_130 * ) V_271 -> V_279 ;
V_14 -> V_5 = F_156 ( V_119 -> V_274 , L_14 ) ;
if ( ! V_268 || V_14 -> V_5 >= V_268 -> V_280 ||
V_14 -> V_5 < 0 ) {
F_157 ( V_119 , L_15 ,
V_119 -> V_274 -> V_281 ) ;
return - V_22 ;
...
F_159 ( & V_14 -> V_23 ) ;
F_160 ( & V_14 -> V_114 ) ;
V_273 = F_161 ( V_118 , V_282 , 0 ) ;
V_14 -> V_283 = F_162 ( V_119 , V_273 ) ;
if ( F_145 ( V_14 -> V_283 ) )
return F_151 ( V_14 -> V_283 ) ;
V_273 = F_161 ( V_118 , V_284 , 0 ) ;
if ( V_273 == NULL ) {
F_157 ( V_119 , L_16 ) ;
return - V_19 ;
}
...
if ( V_79 )
return V_79 ;
V_79 = F_163 ( V_119 , V_273 -> V_285 , F_32 ,
0 , F_85 ( V_119 ) , V_14 ) ;
if ( V_79 ) {
...
static int F_175 ( struct V_269 * V_119 )
{
struct V_13 * V_14 = F_172 ( V_119 ) ;
bool V_28 = F_28 ( V_117 , & V_14 -> V_32 ) ;
int V_79 ;
if ( F_44 ( V_289 , & V_14 -> V_32 ) )
return 0 ;
V_79 = F_23 ( V_14 , V_28 ) ;
if ( V_79 < 0 || ! F_24 ( V_14 ) )
return V_79 ;
...
static int F_176 ( struct V_267 * V_118 )
{
