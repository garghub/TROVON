...
static void F_61 ( struct V_6 * V_18 )
{
struct V_2 * V_36 ;
T_2 V_65 , V_45 ;
int V_1 , V_66 = 0 ;
...
F_62 ( V_40 ) ;
V_65 = F_63 () ;
F_64 (cpu, tick_broadcast_oneshot_mask) {
V_36 = & F_34 ( V_37 , V_1 ) ;
...
static int F_68 ( struct V_6 * V_7 , int V_1 )
{
if ( ! ( V_7 -> V_10 & V_71 ) )
return 0 ;
...
{
struct V_6 * V_7 = V_3 . V_20 ;
if ( ! V_7 || ! F_68 ( V_7 , V_75 ) )
return;
F_40 ( V_7 , V_7 -> V_45 , 1 ) ;
}
int F_71 ( unsigned long V_47 )
{
struct V_6 * V_7 , * V_18 ;
struct V_2 * V_36 ;
unsigned long V_32 ;
...
static void F_73 ( struct V_4 * V_28 ,
T_2 V_62 )
{
struct V_2 * V_36 ;
int V_1 ;
