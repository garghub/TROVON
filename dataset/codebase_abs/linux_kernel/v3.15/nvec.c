...
F_12 ( V_2 -> V_12 ,
L_26 ,
V_2 -> V_59 , V_2 -> V_59 ? V_2 -> V_59 -> V_28 : 0 ,
V_77 ) ;
break;
default:
V_2 -> V_44 = 0 ;
...
F_18 ( V_2 -> V_12 ,
L_28 ,
( V_62 & V_71 ) == 0 ? L_29 : L_30 ,
V_65 ,
( V_62 & ( V_71 | V_69 ) ) ? L_31 : L_32 ,
V_66 ,
V_44 ,
V_62 & V_69 ? L_33 : L_34 ,
V_62 & V_70 ? L_35 : L_34 ,
...
V_79 = V_82 | V_83 |
( 0x2 << V_84 ) ;
F_50 ( V_79 , V_2 -> V_72 + V_85 ) ;
F_58 ( V_2 -> V_80 , 8 * 80000 ) ;
F_50 ( V_86 , V_2 -> V_72 + V_87 ) ;
F_50 ( 0x1E , V_2 -> V_72 + V_88 ) ;
F_50 ( V_2 -> V_78 >> 1 , V_2 -> V_72 + V_89 ) ;
F_50 ( 0 , V_2 -> V_72 + V_90 ) ;
F_59 ( V_2 -> V_64 ) ;
}
static void F_60 ( struct V_1 * V_2 )
{
F_61 ( V_2 -> V_64 ) ;
F_50 ( V_86 | V_91 , V_2 -> V_72 + V_87 ) ;
F_62 ( V_2 -> V_80 ) ;
}
...
{
V_2 -> V_33 = F_65 ( V_2 -> V_12 -> V_95 , L_37 , 0 ) ;
if ( V_2 -> V_33 < 0 ) {
F_12 ( V_2 -> V_12 , L_38 ) ;
return - V_96 ;
}
if ( F_66 ( V_2 -> V_12 -> V_95 , L_39 ,
& V_2 -> V_78 ) ) {
F_12 ( V_2 -> V_12 , L_40 ) ;
return - V_96 ;
}
...
static int F_67 ( struct V_97 * V_98 )
{
int V_52 , V_99 ;
struct V_100 * V_80 ;
struct V_1 * V_2 ;
...
struct V_101 * V_102 ;
void T_4 * V_72 ;
char V_103 [] = { V_10 , V_104 } ,
V_105 [] = { V_106 , 0x10 , 0x59 , 0x95 } ,
V_107 [ 7 ] = { V_108 , V_109 , true } ;
if ( ! V_98 -> V_12 . V_95 ) {
F_12 ( & V_98 -> V_12 , L_41 ) ;
return - V_96 ;
}
V_2 = F_68 ( & V_98 -> V_12 , sizeof( struct V_1 ) , V_110 ) ;
if ( V_2 == NULL ) {
F_12 ( & V_98 -> V_12 , L_42 ) ;
return - V_35 ;
}
...
if ( V_52 < 0 )
return V_52 ;
V_102 = F_70 ( V_98 , V_111 , 0 ) ;
V_72 = F_71 ( & V_98 -> V_12 , V_102 ) ;
if ( F_72 ( V_72 ) )
return F_73 ( V_72 ) ;
V_102 = F_70 ( V_98 , V_112 , 0 ) ;
if ( ! V_102 ) {
F_12 ( & V_98 -> V_12 , L_43 ) ;
return - V_96 ;
}
V_80 = F_74 ( & V_98 -> V_12 , L_44 ) ;
if ( F_72 ( V_80 ) ) {
F_12 ( V_2 -> V_12 , L_45 ) ;
return - V_96 ;
}
V_2 -> V_81 = F_75 ( & V_98 -> V_12 , L_46 ) ;
if ( F_72 ( V_2 -> V_81 ) ) {
F_12 ( V_2 -> V_12 , L_47 ) ;
return F_73 ( V_2 -> V_81 ) ;
}
V_2 -> V_72 = V_72 ;
V_2 -> V_64 = V_102 -> V_113 ;
V_2 -> V_80 = V_80 ;
V_2 -> V_59 = & V_2 -> V_22 [ 0 ] ;
F_76 ( & V_2 -> V_6 ) ;
F_77 ( & V_2 -> V_42 ) ;
...
F_81 ( & V_2 -> V_55 , F_40 ) ;
F_81 ( & V_2 -> V_39 , F_33 ) ;
V_52 = F_82 ( & V_98 -> V_12 , V_2 -> V_33 , V_114 ,
L_48 ) ;
if ( V_52 < 0 ) {
F_12 ( V_2 -> V_12 , L_49 ) ;
return - V_96 ;
}
V_52 = F_83 ( & V_98 -> V_12 , V_2 -> V_64 , F_48 , 0 ,
L_50 , V_2 ) ;
if ( V_52 ) {
F_12 ( V_2 -> V_12 , L_51 ) ;
return - V_96 ;
...
V_94 = V_2 ;
V_116 = F_63 ;
V_9 = F_26 ( V_2 , V_103 , 2 ) ;
if ( V_9 ) {
F_7 ( V_2 -> V_12 , L_52 ,
V_9 -> V_8 [ 4 ] , V_9 -> V_8 [ 5 ] , V_9 -> V_8 [ 6 ] , V_9 -> V_8 [ 7 ] ) ;
F_13 ( V_2 , V_9 ) ;
}
V_99 = F_84 ( V_2 -> V_12 , - 1 , V_117 ,
F_85 ( V_117 ) , V_72 , 0 , NULL ) ;
if ( V_99 )
F_12 ( V_2 -> V_12 , L_53 ) ;
F_21 ( V_2 , V_105 , 4 ) ;
F_32 ( V_107 , V_118 ) ;
...
static int F_90 ( struct V_120 * V_12 )
{
struct V_97 * V_98 = F_91 ( V_12 ) ;
struct V_1 * V_2 = F_87 ( V_98 ) ;
struct V_16 * V_9 ;
char V_121 [] = { V_46 , V_122 } ;
F_18 ( V_2 -> V_12 , L_54 ) ;
F_31 ( V_2 , false ) ;
V_9 = F_26 ( V_2 , V_121 , sizeof( V_121 ) ) ;
F_13 ( V_2 , V_9 ) ;
F_60 ( V_2 ) ;
return 0 ;
}
static int F_92 ( struct V_120 * V_12 )
{
struct V_97 * V_98 = F_91 ( V_12 ) ;
struct V_1 * V_2 = F_87 ( V_98 ) ;
F_18 ( V_2 -> V_12 , L_55 ) ;
