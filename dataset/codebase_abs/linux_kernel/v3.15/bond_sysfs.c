...
{
struct V_10 * V_11 = F_14 ( V_29 ) ;
return sprintf ( V_5 , L_13 , V_11 -> V_39 . V_62 ) ;
}
...
struct V_10 * V_11 = F_14 ( V_29 ) ;
if ( V_11 -> V_69 )
V_19 = sprintf ( V_5 , L_14 , V_11 -> V_69 -> V_14 -> V_15 ) ;
return V_19 ;
}
...
V_75 = F_57 ( V_11 ) ;
if ( V_75 )
V_19 = sprintf ( V_5 , L_14 , V_75 -> V_15 ) ;
F_58 () ;
return V_19 ;
}
...
{
struct V_10 * V_11 = F_14 ( V_29 ) ;
return sprintf ( V_5 , L_14 , V_11 -> V_77 ? L_15 : L_16 ) ;
}
...
struct V_79 V_79 ;
if ( ! F_62 ( V_11 , & V_79 ) )
V_19 = sprintf ( V_5 , L_17 , V_79 . V_84 ) ;
}
return V_19 ;
}
