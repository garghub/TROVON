...
static int F_53 ( struct V_2 * V_117 ,
struct V_118 * V_119 )
{
V_119 -> V_120 = V_121 ;
V_119 -> V_122 = V_121 ;
V_119 -> V_123 = F_54 ( V_97 ) | F_54 ( V_96 ) ;
V_119 -> V_124 = true ;
V_119 -> V_125 = true ;
return 0 ;
}
static struct V_2 * F_55 ( struct V_126 * V_127 ,
struct V_128 * V_129 )
{
struct V_5 * V_9 = V_129 -> V_130 ;
unsigned int V_131 = V_127 -> args [ 0 ] ;
if ( V_131 >= V_116 )
return NULL ;
return F_56 ( & V_9 -> V_7 [ V_131 ] . V_4 ) ;
}
static int F_57 ( struct V_132 * V_133 )
{
struct V_134 * V_135 = V_133 -> V_77 . V_136 ;
struct V_114 * V_77 = & V_133 -> V_77 ;
struct V_137 * V_50 ;
struct V_5 * V_9 ;
struct V_1 * V_6 ;
struct V_138 V_139 ;
...
if ( F_60 ( V_135 , L_5 ) )
V_9 -> V_64 = true ;
if ( F_61 ( V_135 , L_6 , & V_142 ) ) {
F_59 ( V_77 , L_7 ) ;
return - V_143 ;
}
V_9 -> V_35 = F_62 ( V_135 , 0 ) ;
if ( V_9 -> V_35 == V_144 ) {
F_59 ( V_77 , L_8 ) ;
return - V_62 ;
}
V_9 -> V_145 = F_63 ( V_77 , NULL ) ;
if ( F_64 ( V_9 -> V_145 ) ) {
F_59 ( V_77 , L_9 ) ;
return F_65 ( V_9 -> V_145 ) ;
}
V_88 = F_66 ( V_135 , 0 , & V_139 ) ;
if ( V_88 ) {
F_59 ( V_77 , L_10 ) ;
goto V_146;
}
V_140 = V_139 . V_147 ;
V_141 = F_67 ( & V_139 ) ;
V_9 -> V_17 = F_68 ( V_77 , V_140 , V_141 ) ;
if ( ! V_9 -> V_17 ) {
F_59 ( V_77 , L_11 ) ;
V_88 = - V_82 ;
goto V_146;
}
V_88 = F_69 ( V_9 -> V_35 , & F_10 , 0 , V_148 , V_9 ) ;
if ( V_88 ) {
F_59 ( V_77 , L_12 ) ;
V_88 = - V_62 ;
goto V_146;
...
V_50 -> V_156 = F_53 ;
F_70 ( & V_50 -> V_7 ) ;
F_71 ( V_157 , V_50 -> V_158 ) ;
F_71 ( V_159 , V_50 -> V_158 ) ;
F_71 ( V_160 , V_50 -> V_158 ) ;
F_71 ( V_161 , V_50 -> V_158 ) ;
...
F_70 ( & V_6 -> V_41 ) ;
F_73 ( & V_6 -> V_40 ) ;
F_37 ( & V_6 -> V_4 . V_134 , & V_50 -> V_7 ) ;
}
F_74 ( & V_9 -> V_42 , F_24 , ( unsigned long ) V_9 ) ;
F_75 ( V_77 , V_9 ) ;
V_88 = F_76 ( V_50 ) ;
if ( V_88 )
goto V_162;
V_88 = F_77 ( V_135 , F_55 , V_9 ) ;
if ( V_88 ) {
F_59 ( V_77 , L_13 ) ;
goto V_163;
}
...
static int F_82 ( struct V_132 * V_133 )
{
struct V_114 * V_77 = & V_133 -> V_77 ;
struct V_5 * V_9 = F_83 ( V_77 ) ;
F_84 ( V_133 -> V_77 . V_136 ) ;
F_80 ( & V_9 -> V_50 ) ;
V_162 ( V_9 -> V_35 , V_9 ) ;
F_81 ( V_9 -> V_35 ) ;
F_85 ( & V_133 -> V_77 ) ;
...
static int F_87 ( struct V_114 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
F_88 ( V_9 -> V_145 ) ;
return 0 ;
}
static int F_89 ( struct V_114 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
int V_88 ;
V_88 = F_90 ( V_9 -> V_145 ) ;
...
static int F_91 ( struct V_114 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
struct V_164 * V_165 = & V_9 -> V_166 ;
struct V_11 * V_12 ;
struct V_1 * V_6 ;
int V_38 ;
int V_88 ;
...
struct V_11 ,
V_14 ) ;
V_165 -> V_167 [ V_38 ] = F_8 ( V_9 -> V_17 +
V_38 * 0x10 + V_23 ) ;
}
V_165 -> V_168 = F_8 ( V_9 -> V_17 + V_28 ) ;
F_87 ( V_77 ) ;
return 0 ;
}
static int F_92 ( struct V_114 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
struct V_164 * V_165 = & V_9 -> V_166 ;
struct V_11 * V_12 ;
