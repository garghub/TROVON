...
int F_49 ( struct V_94 * V_95 , struct V_96 * V_97 )
{
struct V_3 * V_13 = F_47 ( V_95 ) ;
struct V_5 * V_6 = & V_13 -> V_6 ;
struct V_98 * V_99 = & V_13 -> V_100 ;
...
bool V_109 = false ;
T_3 V_85 ;
if ( F_50 ( V_99 , V_97 -> V_101 , sizeof( * V_99 ) ) )
return - V_102 ;
if ( V_99 -> V_23 )
return - V_110 ;
switch ( V_99 -> V_111 ) {
...
| V_147 ) ;
V_143 &= ~ V_148 ;
F_7 ( F_52 ( 3 ) , F_53 ( V_149 ) ) ;
F_7 ( F_54 ( 3 ) ,
( V_150 | V_151 ) ) ;
if ( V_6 -> V_25 . type == V_26 ) {
F_7 ( F_55 ( 3 ) , F_53 ( V_149 ) ) ;
V_143 &= ~ V_152 ;
}
F_7 ( F_56 ( 3 ) , V_143 ) ;
} else {
...
case V_26 :
snprintf ( V_13 -> V_38 . V_153 , 16 , L_4 , V_95 -> V_154 ) ;
V_13 -> V_38 . V_155 = V_156 ;
V_13 -> V_38 . V_157 = 999999881 ;
V_13 -> V_38 . V_158 = 0 ;
V_13 -> V_38 . V_159 = 0 ;
V_13 -> V_38 . V_160 = F_14 ;
V_13 -> V_38 . V_161 = F_17 ;
V_13 -> V_38 . V_72 = F_23 ;
V_13 -> V_38 . V_162 = F_26 ;
V_13 -> V_38 . V_163 = F_28 ;
V_13 -> V_2 . V_164 = F_1 ;
V_13 -> V_2 . V_165 = F_59 ( 64 ) ;
V_13 -> V_2 . V_166 = 1 ;
V_13 -> V_2 . V_167 = V_42 ;
F_7 ( V_43 , V_44 | V_168 ) ;
break;
...
snprintf ( V_13 -> V_38 . V_153 , 16 , L_4 , V_95 -> V_154 ) ;
V_13 -> V_38 . V_155 = V_156 ;
V_13 -> V_38 . V_157 = 62499999 ;
V_13 -> V_38 . V_158 = 0 ;
V_13 -> V_38 . V_159 = 0 ;
V_13 -> V_38 . V_160 = F_16 ;
V_13 -> V_38 . V_161 = F_17 ;
V_13 -> V_38 . V_72 = F_23 ;
V_13 -> V_38 . V_162 = F_26 ;
V_13 -> V_38 . V_163 = F_28 ;
V_13 -> V_2 . V_164 = F_4 ;
V_13 -> V_2 . V_165 = F_59 ( V_169 ) ;
V_13 -> V_2 . V_166 = 1 ;
V_13 -> V_2 . V_167 = 0 ;
F_7 ( V_170 , 0x0 ) ;
break;
...
V_13 -> V_38 . V_159 = 0 ;
V_13 -> V_38 . V_160 = F_16 ;
V_13 -> V_38 . V_161 = F_20 ;
V_13 -> V_38 . V_72 = F_25 ;
V_13 -> V_38 . V_162 = F_27 ;
V_13 -> V_38 . V_163 = F_28 ;
F_7 ( V_170 , 0x0 ) ;
break;
default:
...
V_13 -> V_171 = F_66 ( & V_13 -> V_38 ,
& V_13 -> V_67 -> V_68 ) ;
if ( F_67 ( V_13 -> V_171 ) ) {
V_13 -> V_171 = NULL ;
F_68 ( & V_13 -> V_67 -> V_68 , L_5 ) ;
} else {
F_69 ( & V_13 -> V_67 -> V_68 , L_6 ,
V_13 -> V_95 -> V_153 ) ;
V_13 -> V_23 |= V_176 ;
}
}
void F_70 ( struct V_3 * V_13 )
{
switch ( V_13 -> V_6 . V_25 . type ) {
case V_26 :
case V_27 :
...
if ( V_13 -> V_171 ) {
F_73 ( V_13 -> V_171 ) ;
F_69 ( & V_13 -> V_67 -> V_68 , L_7 ,
V_13 -> V_95 -> V_153 ) ;
V_13 -> V_23 &= ~ V_176 ;
}
}
void F_74 ( struct V_3 * V_13 )
{
struct V_5 * V_6 = & V_13 -> V_6 ;
if ( ! ( V_13 -> V_23 & V_176 ) )
return;
memset ( & V_13 -> V_100 , 0 , sizeof( V_13 -> V_100 ) ) ;
switch ( V_13 -> V_6 . V_25 . type ) {
case V_26 :
F_7 ( V_43 , V_44 | V_168 ) ;
break;
