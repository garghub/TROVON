...
if ( F_31 ( V_2 ) )
F_32 ( V_2 ) ;
if ( V_2 -> V_10 . V_57 . V_58 . V_50 == V_51 ) {
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
return V_31 ;
F_9 ( V_14 ) ;
...
int F_68 ( struct V_13 * V_14 , int V_114 , unsigned int V_115 )
{
int V_104 , V_31 ;
if ( V_115 < V_14 -> V_105 )
return - V_116 ;
...
return V_31 ;
for ( V_104 = 0 ; V_104 < V_14 -> V_105 ; V_104 ++ ) {
struct V_35 * V_36 = V_14 -> V_75 [ V_104 ] -> V_16 ;
if ( ! V_36 ) {
F_70 ( V_114 + V_104 ) ;
continue;
}
V_31 = F_71 ( V_14 -> V_10 , V_114 + V_104 ,
V_117 ,
V_118 , V_119 ,
V_36 -> V_120 , V_14 -> V_75 [ V_104 ] ) ;
if ( V_31 )
goto V_121;
}
for ( V_104 = 0 ; V_104 < V_14 -> V_105 ; V_104 ++ )
F_72 ( V_14 -> V_75 [ V_104 ] , L_58 , V_114 + V_104 ) ;
V_31 = F_73 ( V_14 , & V_122 ) ;
if ( V_31 )
goto V_123;
return 0 ;
V_123:
...
F_74 ( V_14 -> V_10 , V_114 + V_104 , V_14 -> V_75 [ V_104 ] ) ;
return V_31 ;
}
static int F_75 ( struct V_1 * V_2 , const struct V_100 * V_124 )
{
unsigned int V_125 = V_124 -> V_89 ;
struct V_126 V_127 = V_128 [ V_125 ] ;
const struct V_126 * V_129 [] = { & V_127 , NULL } ;
struct V_9 * V_10 = & V_2 -> V_10 ;
struct V_3 * V_4 ;
struct V_13 * V_14 ;
int V_105 , V_115 , V_104 , V_31 ;
int V_130 = V_131 ;
F_13 ( L_4 ) ;
F_76 ( ( int ) V_132 > V_133 ) ;
F_77 ( & V_2 -> V_10 , V_134 ) ;
if ( V_2 -> V_7 == V_135 && ! V_136 )
return - V_137 ;
if ( F_31 ( V_2 ) )
F_32 ( V_2 ) ;
if ( V_2 -> V_7 == V_138 )
F_2 ( & V_2 -> V_10 ,
L_59 ) ;
if ( V_2 -> V_7 == V_139 && V_2 -> V_9 == 0xCC06 )
V_130 = V_140 ;
...
V_31 = F_80 ( V_2 , 1 << V_130 , V_144 ) ;
if ( V_31 == - V_145 )
F_81 ( V_2 ) ;
if ( V_31 )
return V_31 ;
V_4 = F_82 ( V_10 , sizeof( * V_4 ) , V_146 ) ;
if ( ! V_4 )
return - V_147 ;
V_4 -> V_11 |= ( unsigned long ) V_127 . V_16 ;
if ( V_125 == V_148 &&
( V_2 -> V_149 == 0xa1 || V_2 -> V_149 == 0xa2 ) )
V_4 -> V_11 |= V_109 ;
if ( V_125 == V_150 && V_2 -> V_149 >= 0x40 )
V_4 -> V_11 &= ~ V_151 ;
if ( F_47 ( V_2 ) )
V_4 -> V_11 &= ~ V_152 ;
V_4 -> V_48 = F_83 ( V_2 ) [ V_130 ] ;
if ( F_56 ( V_2 ) )
V_4 -> V_11 |= V_153 ;
F_1 ( V_2 , V_4 ) ;
if ( V_4 -> V_154 & V_155 ) {
...
V_105 = F_85 ( F_86 ( V_4 -> V_154 ) , F_87 ( V_4 -> V_18 ) ) ;
V_115 = F_62 ( V_2 , V_105 , V_4 ) ;
if ( V_115 > 1 )
V_4 -> V_11 |= V_164 ;
V_14 = F_88 ( & V_2 -> V_10 , V_129 , V_105 ) ;
if ( ! V_14 )
return - V_147 ;
V_14 -> V_16 = V_4 ;
if ( ! ( V_4 -> V_154 & V_165 ) || V_166 )
V_14 -> V_11 |= V_167 ;
else
F_2 ( & V_2 -> V_10 , L_63 ) ;
if ( V_127 . V_11 & V_168 )
...
for ( V_104 = 0 ; V_104 < V_14 -> V_105 ; V_104 ++ ) {
struct V_28 * V_29 = V_14 -> V_75 [ V_104 ] ;
F_90 ( V_29 , V_130 , - 1 , L_64 ) ;
F_90 ( V_29 , V_130 ,
0x100 + V_29 -> V_169 * 0x80 , L_65 ) ;
if ( V_29 -> V_11 & V_168 )
V_29 -> V_170 = V_4 -> V_171 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_104 ) ) )
V_29 -> V_76 = & V_172 ;
}
F_40 ( V_14 ) ;
F_59 ( V_14 ) ;
V_31 = F_34 ( V_2 , V_4 -> V_154 & V_173 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
...
F_91 ( V_2 ) ;
if ( V_4 -> V_11 & V_164 )
return F_68 ( V_14 , V_2 -> V_114 , V_115 ) ;
return F_92 ( V_14 , V_2 -> V_114 , V_174 , V_119 ,
& V_122 ) ;
}
