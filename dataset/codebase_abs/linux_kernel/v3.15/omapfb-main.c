...
if ( V_252 -> V_302 && strcmp ( V_324 , V_252 -> V_302 ) == 0 )
return V_252 ;
if ( strcmp ( V_324 , V_252 -> V_325 ) == 0 )
return V_252 ;
}
return NULL ;
}
...
int V_103 ;
V_252 = V_202 -> V_270 [ V_57 ] . V_252 ;
if ( V_252 -> V_219 -> V_326 == NULL )
continue;
V_103 = F_135 ( V_252 -> V_219 -> V_326 , L_67 ) ;
if ( V_103 == 0 )
return V_252 ;
}
return V_202 -> V_270 [ 0 ] . V_252 ;
}
static int F_136 ( struct V_327 * V_328 )
{
...
return - V_330 ;
if ( V_328 -> V_331 != 0 ) {
F_78 ( & V_328 -> V_219 , L_69 ) ;
V_16 = - V_309 ;
goto V_332;
}
V_202 = F_138 ( & V_328 -> V_219 , sizeof( struct V_201 ) ,
V_229 ) ;
if ( V_202 == NULL ) {
V_16 = - V_230 ;
goto V_332;
...
V_202 -> V_335 = F_147 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_335 ; V_57 ++ )
V_202 -> V_336 [ V_57 ] = F_148 ( V_57 ) ;
V_329 = F_133 ( V_202 ) ;
if ( V_329 == NULL ) {
...
if ( F_121 ( V_202 ) )
F_130 ( & V_328 -> V_219 , L_76 ) ;
} else if ( V_329 && V_329 -> V_109 -> V_295 &&
V_329 -> V_109 -> V_294 ) {
struct V_115 V_24 ;
V_16 = F_125 ( V_329 , & V_24 ) ;
if ( V_16 == 0 )
V_329 -> V_109 -> V_295 ( V_329 , & V_24 ) ;
}
V_16 = F_108 ( V_202 ) ;
if ( V_16 )
goto V_334;
...
if ( V_329 ) {
T_2 V_20 , V_22 ;
V_329 -> V_109 -> V_231 ( V_329 , & V_20 , & V_22 ) ;
F_150 ( V_202 -> V_219 , L_83 ,
V_329 -> V_302 , V_20 , V_22 ) ;
}
return 0 ;
V_334:
F_101 ( V_202 ) ;
F_151 () ;
V_332:
F_78 ( & V_328 -> V_219 , L_84 ) ;
return V_16 ;
}
static int T_7 F_152 ( struct V_327 * V_328 )
{
struct V_201 * V_202 = F_153 ( V_328 ) ;
F_154 ( V_202 ) ;
F_101 ( V_202 ) ;
F_151 () ;
return 0 ;
