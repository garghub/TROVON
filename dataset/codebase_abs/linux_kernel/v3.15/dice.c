...
if ( V_8 < 0 )
return V_8 ;
V_8 = F_130 ( & V_19 -> V_18 , - 1 , NULL , V_264 ,
sizeof( * V_5 ) , & V_25 ) ;
if ( V_8 < 0 )
return V_8 ;
V_5 = V_25 -> V_93 ;
...
if ( V_8 < 0 )
goto V_269;
V_8 = F_136 ( & V_5 -> V_103 , V_19 ) ;
if ( V_8 < 0 )
goto V_269;
V_5 -> V_103 . V_270 = 0x00000000ffffffffuLL ;
V_8 = F_137 ( & V_5 -> V_102 , V_19 ,
V_271 | V_272 ) ;
if ( V_8 < 0 )
goto V_108;
V_25 -> V_273 = F_114 ;
...
static void F_142 ( struct V_230 * V_19 )
{
struct V_5 * V_5 = F_143 ( & V_19 -> V_18 ) ;
F_144 ( & V_5 -> V_102 ) ;
F_145 ( V_5 -> V_25 ) ;
F_63 ( & V_5 -> V_114 ) ;
F_56 ( V_5 ) ;
...
static void F_147 ( struct V_230 * V_19 )
{
struct V_5 * V_5 = F_143 ( & V_19 -> V_18 ) ;
F_144 ( & V_5 -> V_102 ) ;
F_63 ( & V_5 -> V_114 ) ;
