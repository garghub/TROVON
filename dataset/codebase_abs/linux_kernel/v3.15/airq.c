...
unsigned long F_28 ( struct V_30 * V_32 , unsigned long V_47 )
{
unsigned long V_48 , V_49 ;
if ( ! V_32 -> V_38 || V_47 == 0 )
return - 1UL ;
F_5 ( & V_32 -> V_46 ) ;
V_48 = F_29 ( V_32 -> V_38 , V_32 -> V_31 ) ;
while ( V_48 + V_47 <= V_32 -> V_31 ) {
for ( V_49 = 1 ; V_49 < V_47 ; V_49 ++ )
if ( ! F_30 ( V_48 + V_49 , V_32 -> V_38 ) )
break;
if ( V_49 >= V_47 ) {
for ( V_49 = 0 ; V_49 < V_47 ; V_49 ++ )
F_31 ( V_48 + V_49 , V_32 -> V_38 ) ;
if ( V_48 + V_47 >= V_32 -> V_39 )
V_32 -> V_39 = V_48 + V_47 + 1 ;
break;
}
V_48 = F_32 ( V_32 -> V_38 , V_32 -> V_31 , V_48 + V_49 + 1 ) ;
}
if ( V_48 + V_47 > V_32 -> V_31 )
V_48 = - 1UL ;
F_7 ( & V_32 -> V_46 ) ;
return V_48 ;
}
void F_33 ( struct V_30 * V_32 , unsigned long V_48 , unsigned long V_47 )
{
unsigned long V_49 ;
if ( ! V_32 -> V_38 || V_47 == 0 )
return;
F_5 ( & V_32 -> V_46 ) ;
for ( V_49 = 0 ; V_49 < V_47 ; V_49 ++ ) {
F_31 ( V_48 + V_49 , V_32 -> V_35 ) ;
F_34 ( V_48 + V_49 , V_32 -> V_38 ) ;
}
if ( V_48 + V_47 >= V_32 -> V_39 ) {
while ( V_32 -> V_39 > 0 && ! F_30 ( V_32 -> V_39 - 1 , V_32 -> V_38 ) )
V_32 -> V_39 -- ;
}
F_7 ( & V_32 -> V_46 ) ;
}
unsigned long F_35 ( struct V_30 * V_32 , unsigned long V_50 ,
unsigned long V_39 )
{
unsigned long V_48 ;
V_48 = F_32 ( V_32 -> V_35 , V_39 , V_50 ) ;
if ( V_48 >= V_39 )
return - 1UL ;
F_31 ( V_48 , V_32 -> V_35 ) ;
return V_48 ;
