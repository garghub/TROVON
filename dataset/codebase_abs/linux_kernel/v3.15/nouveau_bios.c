...
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_55 * V_41 = F_16 ( V_22 -> V_41 ) ;
struct V_5 * V_6 = & V_22 -> V_28 ;
...
{
struct V_55 * V_41 = F_23 ( V_16 ) ;
if ( V_6 -> V_12 < 5 && V_6 -> V_1 [ 0x48 ] & 0x4 )
return F_24 ( V_16 , 0 , 0xf ) & 0xf ;
if ( V_41 -> V_70 >= V_71 )
return ( F_17 ( V_41 , V_72 ) >> 24 ) & 0xf ;
else
return ( F_17 ( V_41 , V_72 ) >> 16 ) & 0xf ;
}
...
int F_28 ( struct V_15 * V_16 , int V_8 , bool * V_20 , bool * V_51 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_5 * V_6 = & V_22 -> V_28 ;
...
V_107 = V_6 -> V_30 . V_31 = V_6 -> V_30 . V_47 + V_67 . V_68 + V_67 . V_69 * V_106 ;
switch ( V_67 . V_56 ) {
case 0x0a :
...
V_6 -> V_30 . V_51 = V_6 -> V_1 [ V_107 ] & 2 ;
V_6 -> V_30 . V_53 = V_6 -> V_1 [ V_6 -> V_30 . V_47 + 4 ] ;
V_6 -> V_30 . V_112 = F_3 ( V_6 -> V_1 [ V_6 -> V_30 . V_47 + 5 ] ) * 10 ;
break;
}
...
V_6 -> V_30 . V_47 = F_3 ( V_6 -> V_1 [ V_121 -> V_119 ] ) ;
return 0 ;
}
static int
...
T_3 V_194 ;
if ( V_188 & 0x1 )
V_141 -> V_49 . V_50 = true ;
if ( V_173 -> V_123 < 0x22 ) {
V_194 = ~ 0xd ;
V_141 -> V_49 . V_50 = true ;
if ( V_188 & 0x4 || V_188 & 0x8 )
V_141 -> V_49 . V_195 = true ;
} else {
V_194 = ~ 0x7 ;
if ( V_188 & 0x2 )
V_141 -> V_49 . V_196 = true ;
if ( V_188 & 0x4 )
V_141 -> V_49 . V_195 = true ;
V_141 -> V_49 . V_197 . V_198 = ( V_188 & 0x00000030 ) >> 4 ;
}
if ( V_188 & V_194 ) {
if ( V_173 -> V_123 >= 0x40 )
break;
...
F_20 ( V_41 , 0x00001304 , F_34 ( V_6 -> V_1 [ V_222 ] ) ) ;
V_221 -= 4 ;
for ( V_3 = 0 ; V_3 < V_221 ; V_3 += 4 )
F_20 ( V_41 , 0x00001400 + V_3 , F_34 ( V_6 -> V_1 [ V_222 + V_3 + 4 ] ) ) ;
F_20 ( V_41 , V_223 , F_17 ( V_41 , V_223 ) | 0x18 ) ;
return 0 ;
}
...
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_232 * V_6 = V_232 ( V_22 -> V_41 ) ;
