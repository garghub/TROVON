...
static int F_68 ( struct V_23 * V_39 , int line , char * V_25 )
{
return 0 ;
}
...
V_3 = F_75 ( F_76 ( sizeof( * V_3 ) , sizeof( long ) ) + V_60 ,
V_94 ) ;
if ( ! V_3 )
return F_74 ( - V_95 ) ;
V_3 -> V_31 = V_31 ;
...
V_3 -> V_33 = V_33 ;
V_3 -> V_60 = V_60 ;
V_3 -> V_53 = & ( ( char * ) V_3 ) [ F_76 ( sizeof( * V_3 ) , sizeof( long ) ) ] ;
F_77 ( & V_3 -> V_7 ) ;
V_3 -> V_7 . V_33 = & V_96 ;
F_78 ( & V_3 -> V_49 , F_39 ) ;
F_79 ( & V_3 -> V_6 ) ;
