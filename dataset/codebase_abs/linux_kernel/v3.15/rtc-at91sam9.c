...
V_6 = F_23 ( & V_47 -> V_2 , sizeof( * V_6 ) , V_54 ) ;
if ( ! V_6 )
return - V_55 ;
V_6 -> V_32 = V_32 ;
if ( ! F_24 ( & V_47 -> V_2 ) )
F_25 ( & V_47 -> V_2 , 1 ) ;
F_26 ( V_47 , V_6 ) ;
V_6 -> V_56 = F_27 ( & V_47 -> V_2 , V_49 -> V_57 , F_28 ( V_49 ) ) ;
if ( ! V_6 -> V_56 ) {
F_21 ( & V_47 -> V_2 , L_13 ) ;
return - V_55 ;
}
V_6 -> V_58 = F_27 ( & V_47 -> V_2 , V_50 -> V_57 ,
F_28 ( V_50 ) ) ;
if ( ! V_6 -> V_58 ) {
F_21 ( & V_47 -> V_2 , L_14 ) ;
return - V_55 ;
...
V_20 &= ~ ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 ) ;
V_6 -> V_43 = F_29 ( & V_47 -> V_2 , V_47 -> V_61 ,
& V_62 , V_63 ) ;
if ( F_30 ( V_6 -> V_43 ) )
return F_31 ( V_6 -> V_43 ) ;
V_51 = F_32 ( & V_47 -> V_2 , V_6 -> V_32 , F_16 ,
V_64 , F_33 ( & V_6 -> V_43 -> V_2 ) , V_6 ) ;
if ( V_51 ) {
...
struct V_5 * V_6 = F_36 ( V_47 ) ;
T_1 V_20 = F_4 ( V_6 , V_21 ) ;
V_6 -> V_65 = V_20 & ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 & ~ V_6 -> V_65 ) ;
}
