...
V_14 = F_18 ( V_33 , V_38 ) ;
if ( V_14 )
F_19 ( & V_1 -> V_17 -> V_15 , L_10 ,
V_21 , V_14 ) ;
}
static int F_32 ( struct V_1 * V_1 , int V_2 , T_2 V_84 )
{
int V_85 ;
if ( ! F_33 ( V_2 , & V_1 -> V_86 ) )
return 0 ;
F_34 ( & V_1 -> V_39 -> V_15 , L_11 , V_21 , V_2 ) ;
V_85 = F_18 ( V_1 -> V_87 [ V_2 ] , V_84 ) ;
if ( V_85 ) {
if ( V_85 != - V_88 ) {
F_19 ( & V_1 -> V_39 -> V_15 ,
L_10 ,
...
static int F_36 ( struct V_1 * V_1 , T_2 V_84 )
{
int V_85 ;
int V_22 ;
for ( V_22 = 0 ; V_22 < V_1 -> V_89 ; ++ V_22 ) {
V_85 = F_32 ( V_1 , V_22 , V_84 ) ;
if ( V_85 )
return V_85 ;
}
return 0 ;
}
static void F_37 ( struct V_1 * V_1 , struct V_33 * V_33 )
{
if ( ! V_33 -> V_90 )
return;
F_38 ( & V_1 -> V_7 , V_33 -> V_34 ,
V_33 -> V_90 ) ;
F_39 ( & V_1 -> V_7 ) ;
}
...
unsigned long V_29 ;
F_34 ( & V_1 -> V_39 -> V_15 , L_12 , V_21 ,
V_92 -> V_2 , V_33 -> V_90 ) ;
F_35 ( V_92 -> V_2 , & V_1 -> V_86 ) ;
if ( ! V_1 -> V_15 ) {
F_10 ( & V_1 -> V_39 -> V_15 , L_13 , V_21 ) ;
return;
}
F_26 ( V_1 -> V_15 ) ;
if ( V_33 -> V_54 ) {
F_10 ( & V_1 -> V_39 -> V_15 , L_14 ,
V_21 , V_33 -> V_54 ) ;
return;
}
F_37 ( V_1 , V_33 ) ;
F_13 ( & V_1 -> V_65 , V_29 ) ;
V_1 -> V_94 = V_1 -> V_95 ;
if ( ! V_1 -> V_94 && ! V_1 -> V_96 ) {
F_14 ( & V_1 -> V_65 , V_29 ) ;
F_32 ( V_1 , V_92 -> V_2 , V_38 ) ;
} else {
F_14 ( & V_1 -> V_65 , V_29 ) ;
}
}
...
static void F_43 ( struct V_98 * V_97 )
{
struct V_1 * V_1 = F_44 ( V_97 , struct V_1 , V_97 ) ;
F_34 ( & V_1 -> V_39 -> V_15 , L_16 , V_21 ) ;
F_45 ( & V_1 -> V_7 ) ;
}
static int F_46 ( struct V_99 * V_100 , struct V_101 * V_102 )
{
struct V_1 * V_1 ;
int V_14 ;
F_10 ( V_102 -> V_15 , L_16 , V_21 ) ;
V_1 = F_1 ( V_102 -> V_2 ) ;
if ( ! V_1 )
return - V_103 ;
V_14 = F_47 ( V_100 , V_102 ) ;
if ( V_14 )
goto V_104;
V_102 -> V_105 = V_1 ;
return 0 ;
...
static int F_49 ( struct V_101 * V_102 , struct V_106 * V_107 )
{
struct V_1 * V_1 = V_102 -> V_105 ;
F_10 ( V_102 -> V_15 , L_16 , V_21 ) ;
return F_50 ( & V_1 -> V_7 , V_102 , V_107 ) ;
}
static int F_51 ( struct V_108 * V_7 , struct V_101 * V_102 )
{
struct V_1 * V_1 = F_44 ( V_7 , struct V_1 , V_7 ) ;
int V_14 = - V_103 ;
F_10 ( & V_1 -> V_17 -> V_15 , L_16 , V_21 ) ;
F_2 ( & V_1 -> V_5 ) ;
if ( V_1 -> V_6 )
goto V_6;
V_14 = F_52 ( V_1 -> V_17 ) ;
if ( V_14 )
goto V_109;
F_35 ( V_110 , & V_102 -> V_29 ) ;
V_1 -> V_17 -> V_111 = 1 ;
V_1 -> V_112 -> V_15 = V_1 -> V_15 ;
if ( F_18 ( V_1 -> V_112 , V_113 ) ) {
F_19 ( & V_1 -> V_17 -> V_15 ,
L_17 , V_21 ) ;
F_53 ( V_1 -> V_17 ) ;
goto V_114;
}
V_1 -> V_115 = V_116 | V_117 ;
if ( F_54 ( V_1 , V_1 -> V_115 ) < 0 &&
( V_1 -> V_45 & V_118 ) ) {
F_53 ( V_1 -> V_17 ) ;
goto V_119;
}
...
static void F_58 ( struct V_108 * V_7 )
{
struct V_1 * V_1 = F_44 ( V_7 , struct V_1 , V_7 ) ;
F_10 ( & V_1 -> V_17 -> V_15 , L_16 , V_21 ) ;
F_6 ( V_1 ) ;
...
static void F_61 ( struct V_108 * V_7 )
{
struct V_1 * V_1 = F_44 ( V_7 , struct V_1 , V_7 ) ;
int V_22 ;
F_10 ( & V_1 -> V_17 -> V_15 , L_16 , V_21 ) ;
...
static void F_65 ( struct V_101 * V_102 , struct V_106 * V_107 )
{
struct V_1 * V_1 = V_102 -> V_105 ;
F_10 ( & V_1 -> V_17 -> V_15 , L_16 , V_21 ) ;
F_66 ( & V_1 -> V_7 , V_102 , V_107 ) ;
}
...
if ( ! V_121 )
return 0 ;
F_34 ( & V_1 -> V_39 -> V_15 , L_18 , V_21 , V_121 ) ;
F_13 ( & V_1 -> V_30 , V_29 ) ;
V_23 = F_11 ( V_1 ) ;
if ( V_23 < 0 ) {
F_14 ( & V_1 -> V_30 , V_29 ) ;
...
F_34 ( & V_1 -> V_39 -> V_15 , L_19 , V_21 , V_121 ) ;
...
if ( V_1 -> V_6 )
return 0 ;
return ( V_27 - F_12 ( V_1 ) ) * V_1 -> V_123 ;
}
...
static int F_73 ( struct V_101 * V_102 , int V_126 )
{
struct V_1 * V_1 = V_102 -> V_105 ;
int V_14 ;
V_14 = F_74 ( V_1 , V_126 ? 0xffff : 0 ) ;
if ( V_14 < 0 )
F_10 ( & V_1 -> V_17 -> V_15 , L_20 ,
V_21 ) ;
return V_14 ;
}
...
{
struct V_1 * V_1 = V_102 -> V_105 ;
return ( V_1 -> V_115 & V_116 ? V_127 : 0 ) |
( V_1 -> V_115 & V_117 ? V_128 : 0 ) |
...
unsigned int V_52 ;
V_52 = V_1 -> V_115 ;
V_133 = ( V_133 & V_127 ? V_116 : 0 ) |
( V_133 & V_128 ? V_117 : 0 ) ;
V_134 = ( V_134 & V_127 ? V_116 : 0 ) |
( V_134 & V_128 ? V_117 : 0 ) ;
V_52 = ( V_52 & ~ V_134 ) | V_133 ;
if ( V_1 -> V_115 == V_52 )
return 0 ;
return F_54 ( V_1 , V_1 -> V_115 = V_52 ) ;
}
static int F_77 ( struct V_1 * V_1 , struct V_135 T_3 * V_136 )
{
struct V_135 V_137 ;
if ( ! V_136 )
return - V_138 ;
...
V_137 . V_141 = F_78 ( V_1 -> line . V_142 ) ;
V_137 . V_143 = V_1 -> V_7 . V_143 / 10 ;
V_137 . V_144 = V_1 -> V_7 . V_144 == V_145 ?
V_145 :
V_1 -> V_7 . V_144 / 10 ;
if ( F_79 ( V_136 , & V_137 , sizeof( V_137 ) ) )
return - V_146 ;
else
return 0 ;
}
...
int V_14 = 0 ;
if ( F_81 ( & V_148 , V_147 , sizeof( V_148 ) ) )
return - V_146 ;
...
static int F_83 ( struct V_1 * V_1 , unsigned long V_151 )
{
int V_152 = 0 ;
F_84 ( V_153 , V_154 ) ;
...
if ( F_79 ( V_121 , & V_161 , sizeof( V_161 ) ) > 0 )
V_152 = - V_146 ;
return V_152 ;
}
static int F_91 ( struct V_101 * V_102 ,
...
switch ( V_162 ) {
case V_164 :
V_152 = F_77 ( V_1 , (struct V_135 T_3 * ) V_151 ) ;
break;
case V_165 :
V_152 = F_80 ( V_1 , (struct V_135 T_3 * ) V_151 ) ;
break;
case V_166 :
V_152 = F_52 ( V_1 -> V_17 ) ;
if ( V_152 < 0 ) {
...
V_152 = F_83 ( V_1 , V_151 ) ;
F_53 ( V_1 -> V_17 ) ;
break;
case V_168 :
V_152 = F_90 ( V_1 , (struct V_160 T_3 * ) V_151 ) ;
break;
}
return V_152 ;
}
...
{
struct V_1 * V_1 = V_102 -> V_105 ;
struct V_169 * V_171 = & V_102 -> V_171 ;
struct V_172 V_173 ;
int V_52 = V_1 -> V_115 ;
V_173 . V_142 = F_93 ( F_94 ( V_102 ) ) ;
...
int V_22 ;
struct V_24 * V_25 ;
struct V_188 * V_189 = F_97 ( V_1 -> V_17 ) ;
for ( V_25 = & V_1 -> V_25 [ 0 ] , V_22 = 0 ; V_22 < V_27 ; V_22 ++ , V_25 ++ )
F_98 ( V_189 , V_1 -> V_123 , V_25 -> V_12 , V_25 -> V_36 ) ;
}
...
struct V_24 * V_25 ;
for ( V_25 = & V_1 -> V_25 [ 0 ] , V_22 = 0 ; V_22 < V_27 ; V_22 ++ , V_25 ++ ) {
V_25 -> V_12 = F_101 ( V_1 -> V_15 , V_1 -> V_123 , V_113 ,
& V_25 -> V_36 ) ;
if ( ! V_25 -> V_12 ) {
while ( V_22 != 0 ) {
-- V_22 ;
-- V_25 ;
F_98 ( V_1 -> V_15 , V_1 -> V_123 ,
V_25 -> V_12 , V_25 -> V_36 ) ;
}
return - V_194 ;
}
...
V_205 = F_103 ( V_189 , V_198 -> V_239 ) ;
V_206 = F_103 ( V_189 , ( V_215 = V_198 -> V_240 ) ) ;
if ( ! V_205 || ! V_206 ) {
F_10 ( & V_44 -> V_15 , L_34 ) ;
return - V_103 ;
}
...
V_243:
F_10 ( & V_44 -> V_15 , L_41 ) ;
V_1 = F_110 ( sizeof( struct V_1 ) , V_113 ) ;
if ( V_1 == NULL ) {
F_19 ( & V_44 -> V_15 , L_42 ) ;
goto V_248;
}
...
F_114 ( & V_1 -> V_65 ) ;
F_115 ( & V_1 -> V_5 ) ;
V_1 -> V_249 = F_116 ( V_189 , V_209 -> V_250 ) ;
V_1 -> V_251 = F_117 ( V_209 ) ;
if ( V_1 -> V_251 )
V_1 -> V_252 = V_209 -> V_252 ;
F_118 ( & V_1 -> V_7 ) ;
V_1 -> V_7 . V_253 = & V_254 ;
V_12 = F_101 ( V_189 , V_211 , V_113 , & V_1 -> V_255 ) ;
if ( ! V_12 ) {
F_19 ( & V_44 -> V_15 , L_44 ) ;
goto V_256;
}
...
struct V_33 * V_33 ;
V_92 -> V_192 = F_101 ( V_1 -> V_15 , V_190 , V_113 ,
& V_92 -> V_193 ) ;
if ( ! V_92 -> V_192 ) {
F_19 ( & V_44 -> V_15 , L_47
L_48 ) ;
...
if ( F_117 ( V_210 ) )
F_120 ( V_263 -> V_33 , V_189 ,
F_123 ( V_189 , V_210 -> V_250 ) ,
NULL , V_1 -> V_123 , F_41 , V_263 , V_210 -> V_252 ) ;
else
F_121 ( V_263 -> V_33 , V_189 ,
F_124 ( V_189 , V_210 -> V_250 ) ,
NULL , V_1 -> V_123 , F_41 , V_263 ) ;
V_263 -> V_33 -> V_261 |= V_262 ;
V_263 -> V_93 = V_1 ;
}
F_125 ( V_44 , V_1 ) ;
V_22 = F_126 ( & V_44 -> V_15 , & V_265 ) ;
if ( V_22 < 0 )
goto V_264;
if ( V_200 ) {
V_1 -> V_46 = F_127 ( V_200 -> V_266 - 4 , V_113 ) ;
if ( ! V_1 -> V_46 )
goto V_267;
...
V_22 = F_126 ( & V_44 -> V_15 ,
& V_271 ) ;
if ( V_22 < 0 ) {
F_128 ( & V_44 -> V_15 , & V_270 ) ;
F_60 ( V_1 -> V_46 ) ;
V_1 -> V_46 = NULL ;
V_1 -> V_47 = 0 ;
goto V_267;
...
V_267:
F_120 ( V_1 -> V_112 , V_189 ,
F_129 ( V_189 , V_208 -> V_250 ) ,
V_1 -> V_257 , V_211 , F_25 , V_1 ,
V_208 -> V_252 ? V_208 -> V_252 : 16 ) ;
V_1 -> V_112 -> V_261 |= V_262 ;
V_1 -> V_112 -> V_35 = V_1 -> V_255 ;
F_130 ( & V_44 -> V_15 , L_51 , V_8 ) ;
F_54 ( V_1 , V_1 -> V_115 ) ;
V_1 -> line . V_142 = F_93 ( 9600 ) ;
V_1 -> line . V_183 = 8 ;
F_95 ( V_1 , & V_1 -> line ) ;
F_131 ( & V_272 , V_206 , V_1 ) ;
F_125 ( V_206 , V_1 ) ;
F_132 ( V_205 ) ;
V_219 = F_133 ( & V_1 -> V_7 , V_273 , V_8 ,
& V_205 -> V_15 ) ;
if ( F_134 ( V_219 ) ) {
V_152 = F_135 ( V_219 ) ;
goto V_274;
...
F_128 ( & V_1 -> V_17 -> V_15 , & V_265 ) ;
V_264:
F_125 ( V_44 , NULL ) ;
for ( V_22 = 0 ; V_22 < V_27 ; V_22 ++ )
F_136 ( V_1 -> V_25 [ V_22 ] . V_33 ) ;
V_260:
for ( V_22 = 0 ; V_22 < V_217 ; V_22 ++ )
F_136 ( V_1 -> V_87 [ V_22 ] ) ;
F_99 ( V_1 ) ;
...
F_96 ( V_1 ) ;
V_258:
F_98 ( V_189 , V_211 , V_1 -> V_257 , V_1 -> V_255 ) ;
V_256:
F_6 ( V_1 ) ;
F_60 ( V_1 ) ;
V_248:
...
static void F_139 ( struct V_43 * V_44 )
{
struct V_1 * V_1 = F_22 ( V_44 ) ;
struct V_188 * V_189 = F_97 ( V_44 ) ;
struct V_101 * V_102 ;
int V_22 ;
F_10 ( & V_44 -> V_15 , L_16 , V_21 ) ;
if ( ! V_1 )
return;
F_2 ( & V_1 -> V_5 ) ;
V_1 -> V_6 = true ;
...
F_136 ( V_1 -> V_87 [ V_22 ] ) ;
F_96 ( V_1 ) ;
F_98 ( V_189 , V_1 -> V_211 , V_1 -> V_257 , V_1 -> V_255 ) ;
F_99 ( V_1 ) ;
if ( ! V_1 -> V_218 )
F_144 ( & V_272 , V_44 == V_1 -> V_17 ?
V_1 -> V_39 : V_1 -> V_17 ) ;
F_48 ( & V_1 -> V_7 ) ;
}
static int F_145 ( struct V_43 * V_44 , T_5 V_275 )
{
struct V_1 * V_1 = F_22 ( V_44 ) ;
int V_276 ;
if ( F_146 ( V_275 ) ) {
...
if ( V_276 )
return 0 ;
if ( F_147 ( V_278 , & V_1 -> V_7 . V_29 ) )
F_137 ( V_1 ) ;
return 0 ;
}
static int F_148 ( struct V_43 * V_44 )
{
struct V_1 * V_1 = F_22 ( V_44 ) ;
struct V_24 * V_25 ;
int V_152 = 0 ;
...
if ( V_152 < 0 )
goto V_280;
V_152 = F_36 ( V_1 , V_279 ) ;
}
V_280:
return V_152 ;
}
static int F_149 ( struct V_43 * V_44 )
{
struct V_1 * V_1 = F_22 ( V_44 ) ;
if ( F_147 ( V_278 , & V_1 -> V_7 . V_29 ) )
F_28 ( & V_1 -> V_7 , false ) ;
...
V_273 -> type = V_286 ,
V_273 -> V_287 = V_288 ,
V_273 -> V_29 = V_289 | V_290 ;
V_273 -> V_291 = V_292 ;
V_273 -> V_291 . V_175 = V_293 | V_186 | V_294 |
V_295 | V_187 ;
F_152 ( V_273 , & V_296 ) ;
V_14 = F_153 ( V_273 ) ;
if ( V_14 ) {
...
F_157 (KERN_INFO KBUILD_MODNAME L_54 DRIVER_DESC L_55 ) ;
return 0 ;
}
