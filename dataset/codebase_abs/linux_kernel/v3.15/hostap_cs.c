...
static void F_39 ( struct V_54 * V_27 )
{
F_37 ( V_59 , L_19 ) ;
F_40 ( ( V_60 ) V_27 ) ;
if ( V_27 -> V_61 ) {
...
static int F_43 ( struct V_54 * V_55 , void * V_62 )
{
if ( V_55 -> V_63 == 0 )
return - V_64 ;
return F_44 ( V_55 ) ;
}
static int F_38 ( struct V_54 * V_27 )
{
struct V_1 * V_2 ;
struct V_5 * V_6 ;
T_2 * V_7 ;
...
static void F_40 ( V_60 V_81 )
{
struct V_54 * V_27 = (struct V_54 * ) V_81 ;
F_37 ( V_59 , L_24 ) ;
if ( V_27 -> V_61 ) {
struct V_1 * V_2 = V_27 -> V_61 ;
struct V_5 * V_6 ;
V_6 = F_2 ( V_2 ) ;
F_52 ( V_2 , 0 ) ;
V_6 -> V_7 -> V_80 = 1 ;
...
static int F_54 ( struct V_54 * V_27 )
{
struct V_1 * V_2 = (struct V_1 * ) V_27 -> V_61 ;
int V_82 = 0 ;
struct V_5 * V_6 = NULL ;
if ( ! V_2 )
return - V_37 ;
...
static int F_58 ( struct V_54 * V_27 )
{
struct V_1 * V_2 = (struct V_1 * ) V_27 -> V_61 ;
int V_82 = 0 ;
struct V_5 * V_6 = NULL ;
