...
struct V_1 * F_18 ( struct V_20 * V_20 ,
struct V_1 * V_6 ,
struct V_9 * V_10 ,
enum V_21 V_22 )
{
...
if ( V_6 ) {
F_10 ( V_6 -> V_8 , V_26 -> V_11 . V_12 ) ;
V_6 -> V_31 = V_22 ;
return V_6 ;
}
V_6 = F_21 ( sizeof( * V_6 ) , V_33 ) ;
if ( ! V_6 )
return NULL ;
F_10 ( V_6 -> V_7 , V_24 -> V_7 ) ;
F_10 ( V_6 -> V_8 , V_26 -> V_11 . V_12 ) ;
...
V_6 -> V_38 [ V_27 ] = F_22 ( V_26 -> V_39 . V_40 ) - 1 ;
F_17 ( & V_6 -> V_19 , & V_20 -> V_3 ) ;
return V_6 ;
}
void F_23 ( struct V_20 * V_20 , struct V_9 * V_10 )
{
struct V_11 * V_11 ;
struct V_1 * V_6 ;
if ( ! F_6 ( V_10 ) ) {
...
if ( V_6 )
F_10 ( V_11 -> V_12 , V_6 -> V_7 ) ;
F_14 () ;
}
void F_25 ( struct V_20 * V_20 , struct V_11 * V_11 ,
enum V_21 V_22 )
{
struct V_1 * V_6 ;
F_11 () ;
...
F_10 ( V_11 -> V_42 , V_6 -> V_8 ) ;
F_14 () ;
}
static bool F_26 ( T_1 V_43 , T_1 V_44 )
{
if ( ( int ) V_44 - V_43 == 32768 )
return false ;
return ( ( ( V_45 ) ( V_44 - V_43 ) ) < 0 ) ;
}
void F_27 ( struct V_1 * V_6 , enum V_21 V_22 )
{
if ( ( V_22 < 0 ) || ( V_22 >= V_35 ) ) {
F_24 ( 1 , L_2 , V_41 , V_22 ) ;
return;
}
V_6 -> V_36 [ V_22 ] = V_34 ;
V_6 -> V_46 [ V_22 ] = false ;
}
int F_28 ( struct V_1 * V_6 , enum V_21 V_22 ,
struct V_9 * V_10 )
{
struct V_47 * V_47 ;
T_1 V_40 ;
...
V_40 = F_22 ( V_47 -> V_49 . V_40 ) ;
if ( F_29 ( V_40 , V_6 -> V_38 [ V_22 ] ) )
return 1 ;
V_6 -> V_38 [ V_22 ] = V_40 ;
return 0 ;
}
static bool F_30 ( struct V_1 * V_6 , enum V_21 V_22 )
{
enum V_21 V_50 ;
if ( V_6 -> V_46 [ V_22 ] )
return true ;
...
if ( V_6 -> V_46 [ V_50 ] )
return false ;
if ( F_31 ( V_6 -> V_36 [ V_50 ] , V_6 -> V_36 [ V_22 ] +
F_32 ( V_53 ) ) )
return true ;
return false ;
}
void F_33 ( struct V_20 * V_20 )
{
struct V_1 * V_6 ;
unsigned long V_54 ;
...
V_55 = V_6 -> V_36 [ V_51 ] ;
V_56 = V_6 -> V_36 [ V_52 ] ;
if ( F_31 ( V_34 , V_55 + V_57 / 2 ) )
V_6 -> V_46 [ V_51 ] = true ;
if ( F_31 ( V_34 , V_56 + V_57 / 2 ) )
V_6 -> V_46 [ V_52 ] = true ;
V_54 = V_55 ;
if ( V_6 -> V_46 [ V_51 ] ||
( ! V_6 -> V_46 [ V_52 ] &&
...
void * F_38 ( struct V_20 * V_20 , void * V_59 ,
...
V_6 = V_59 ;
F_39 (node, &hsr_priv->node_db, mac_list) {
F_10 ( V_4 , V_6 -> V_7 ) ;
return V_6 ;
}
return NULL ;
}
int F_40 ( struct V_20 * V_20 ,
