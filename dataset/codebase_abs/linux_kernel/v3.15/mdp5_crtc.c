...
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
V_10 -> V_18 -> V_46 -> V_47 ( V_10 -> V_18 ) ;
F_33 ( V_3 ) ;
F_34 ( & V_10 -> V_28 ) ;
F_35 ( V_10 ) ;
}
static void F_36 ( struct V_2 * V_3 , int V_48 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
bool V_49 = ( V_48 == V_50 ) ;
F_13 ( L_2 , V_10 -> V_22 , V_48 ) ;
if ( V_49 != V_10 -> V_49 ) {
if ( V_49 ) {
F_37 ( V_1 ) ;
F_7 ( & V_1 -> V_11 , & V_10 -> V_51 ) ;
} else {
F_38 ( & V_1 -> V_11 , & V_10 -> V_51 ) ;
F_39 ( V_1 ) ;
}
V_10 -> V_49 = V_49 ;
}
...
V_48 = V_53 ;
F_13 ( L_3 ,
V_10 -> V_22 , V_48 -> V_11 . V_13 , V_48 -> V_22 ,
V_48 -> V_63 , V_48 -> clock ,
V_48 -> V_64 , V_48 -> V_65 ,
V_48 -> V_66 , V_48 -> V_67 ,
V_48 -> V_68 , V_48 -> V_69 ,
V_48 -> V_70 , V_48 -> V_71 ,
V_48 -> type , V_48 -> V_36 ) ;
F_17 ( V_3 -> V_27 -> V_26 ) ;
V_62 = F_51 ( V_10 -> V_18 , V_3 , V_3 -> V_27 -> V_26 ,
0 , 0 , V_48 -> V_64 , V_48 -> V_68 ,
V_60 << 16 , V_61 << 16 ,
V_48 -> V_64 << 16 , V_48 -> V_68 << 16 ) ;
if ( V_62 ) {
F_30 ( V_3 -> V_27 -> V_26 ) ;
...
static int F_58 ( struct V_2 * V_3 , int V_60 , int V_61 ,
struct V_23 * V_25 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
...
int V_62 ;
F_17 ( V_3 -> V_27 -> V_26 ) ;
V_62 = F_51 ( V_18 , V_3 , V_3 -> V_27 -> V_26 ,
0 , 0 , V_48 -> V_64 , V_48 -> V_68 ,
V_60 << 16 , V_61 << 16 ,
V_48 -> V_64 << 16 , V_48 -> V_68 << 16 ) ;
if ( V_62 ) {
...
F_23 ( & V_6 -> V_37 , V_36 ) ;
F_16 ( V_3 , V_24 ) ;
return F_62 ( V_75 , & V_10 -> F_25 ) ;
}
static int F_63 ( struct V_2 * V_3 ,
struct V_77 * V_78 , T_2 V_43 )
{
return - V_79 ;
}
static void F_64 ( struct V_80 * V_81 , T_1 V_82 )
{
struct V_10 * V_10 = F_26 ( V_81 , struct V_10 , V_12 ) ;
struct V_2 * V_3 = & V_10 -> V_11 ;
struct V_4 * V_5 = V_3 -> V_6 -> V_7 ;
unsigned V_9 ;
...
if ( V_9 & V_30 ) {
F_20 ( V_3 , NULL ) ;
F_66 ( & V_10 -> V_28 , V_5 -> V_83 ) ;
}
}
static void F_67 ( struct V_80 * V_81 , T_1 V_82 )
{
struct V_10 * V_10 = F_26 ( V_81 , struct V_10 , V_51 ) ;
struct V_2 * V_3 = & V_10 -> V_11 ;
F_13 ( L_7 , V_10 -> V_22 , V_82 ) ;
F_8 ( V_3 ) ;
}
T_1 F_68 ( struct V_2 * V_3 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
return V_10 -> V_12 . V_84 ;
}
...
void F_70 ( struct V_2 * V_3 , int V_85 ,
enum V_86 V_87 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
...
T_1 V_94 ;
V_10 -> V_51 . V_84 = F_71 ( V_85 ) ;
V_10 -> V_12 . V_84 = F_72 ( V_85 ) ;
if ( ! V_1 )
return;
V_94 = F_73 ( V_1 , V_95 ) ;
switch ( V_85 ) {
...
static void F_82 ( struct V_2 * V_3 , enum V_19 V_101 ,
struct V_17 * V_18 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
F_83 ( V_101 >= F_9 ( V_10 -> V_16 ) ) ;
if ( V_10 -> V_16 [ V_101 ] == V_18 )
return;
V_10 -> V_16 [ V_101 ] = V_18 ;
F_41 ( V_3 ) ;
if ( V_10 -> V_49 && ( V_18 != V_10 -> V_18 ) )
F_8 ( V_3 ) ;
}
...
F_88 ( F_10 ( V_18 ) ) , V_13 ) ;
V_62 = F_89 ( & V_10 -> V_28 , 16 ,
L_11 , F_28 ) ;
if ( V_62 )
goto V_104;
F_90 ( & V_10 -> F_25 , F_25 ) ;
F_91 ( V_6 , V_3 , V_18 , NULL , & V_105 ) ;
F_92 ( V_3 , & V_106 ) ;
