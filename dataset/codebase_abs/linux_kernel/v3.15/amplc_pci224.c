...
return V_167 ;
F_49 ( & V_9 -> V_40 ) ;
V_9 -> V_42 = F_50 ( V_151 , 2 ) ;
V_2 -> V_13 = F_50 ( V_151 , 3 ) ;
V_144 = V_151 -> V_144 ;
V_9 -> V_12 = F_51 ( sizeof( V_9 -> V_12 [ 0 ] ) *
V_7 -> V_168 , V_169 ) ;
if ( ! V_9 -> V_12 )
return - V_170 ;
V_9 -> V_77 = F_51 ( sizeof( V_9 -> V_77 [ 0 ] ) *
V_7 -> V_168 , V_169 ) ;
if ( ! V_9 -> V_77 )
return - V_170 ;
V_9 -> V_78 = F_51 ( sizeof( V_9 -> V_78 [ 0 ] ) *
V_7 -> V_168 , V_169 ) ;
if ( ! V_9 -> V_78 )
return - V_170 ;
V_9 -> V_41 = 0 ;
F_15 ( 0 , V_9 -> V_42 + V_43 ) ;
F_3 ( V_171 , V_2 -> V_13 + V_20 ) ;
F_3 ( 0 , V_2 -> V_13 + V_14 ) ;
F_3 ( 0 , V_2 -> V_13 + V_172 ) ;
V_9 -> V_15 = ( V_47 | V_22 |
V_173 |
V_48 ) ;
F_3 ( V_9 -> V_15 | V_19 ,
...
V_26 = & V_2 -> V_174 [ 0 ] ;
V_26 -> type = V_175 ;
V_26 -> V_176 = V_177 | V_178 | V_179 ;
V_26 -> V_180 = V_7 -> V_168 ;
V_26 -> V_181 = ( 1 << V_7 -> V_21 ) - 1 ;
V_26 -> V_182 = & F_6 ;
V_26 -> V_183 = & F_9 ;
V_26 -> V_184 = V_26 -> V_180 ;
V_2 -> V_146 = V_26 ;
V_26 -> V_185 = & F_32 ;
V_26 -> V_186 = & F_25 ;
V_26 -> V_187 = & F_36 ;
...
V_26 -> V_191 = V_191 =
F_51 ( sizeof( struct V_190 * ) * V_26 -> V_180 ,
V_169 ) ;
if ( ! V_26 -> V_191 )
return - V_170 ;
if ( V_158 ) {
for ( V_31 = 2 ; V_31 < 3 + V_26 -> V_180 ; V_31 ++ ) {
...
for ( V_31 = 0 ; V_31 < V_26 -> V_180 ; V_31 ++ ) {
if ( V_31 < V_193 - 3 && V_158 &&
V_158 [ 3 + V_31 ] == 1 ) {
if ( V_158 [ 2 ] == 1 )
V_191 [ V_31 ] = & V_194 ;
else
...
static int F_55 ( struct V_1 * V_2 , struct V_155 * V_156 )
{
struct V_8 * V_9 ;
struct V_151 * V_151 ;
F_56 ( V_2 -> V_75 , V_192 L_8 ) ;
V_9 = F_57 ( V_2 , sizeof( * V_9 ) ) ;
if ( ! V_9 )
return - V_170 ;
V_151 = F_43 ( V_2 , V_156 ) ;
if ( ! V_151 )
return - V_207 ;
return F_46 ( V_2 , V_151 , V_156 -> V_158 ) ;
}
static int
F_58 ( struct V_1 * V_2 , unsigned long V_208 )
{
struct V_151 * V_151 = F_59 ( V_2 ) ;
struct V_8 * V_9 ;
F_56 ( V_2 -> V_75 , V_192 L_9 ,
F_60 ( V_151 ) ) ;
V_9 = F_57 ( V_2 , sizeof( * V_9 ) ) ;
if ( ! V_9 )
return - V_170 ;
...
F_61 ( V_151 ) ;
return F_46 ( V_2 , V_151 , NULL ) ;
}
static void F_62 ( struct V_1 * V_2 )
{
struct V_8 * V_9 = V_2 -> V_10 ;
struct V_151 * V_209 = F_59 ( V_2 ) ;
if ( V_2 -> V_144 )
F_63 ( V_2 -> V_144 , V_2 ) ;
if ( V_2 -> V_174 ) {
struct V_25 * V_26 ;
...
static int F_67 ( struct V_151 * V_2 ,
const struct V_210 * V_211 )
{
return F_68 ( V_2 , & V_212 ,
V_211 -> V_213 ) ;
}
