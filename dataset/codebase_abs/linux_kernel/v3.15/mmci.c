...
bool V_172 = V_4 -> V_28 -> V_173 &&
( V_48 -> V_5 & V_174 ) ;
if ( V_4 -> V_175 && ( V_86 & V_10 ) )
return;
if ( ! V_4 -> V_175 && V_172 &&
! ( V_86 & ( V_176 | V_177 ) ) &&
( F_6 ( V_8 + V_9 ) & V_10 ) ) {
F_17 ( F_6 ( V_8 + V_52 ) | V_178 ,
V_8 + V_52 ) ;
V_4 -> V_175 = V_86 & ( V_179 | V_180 ) ;
return;
}
if ( V_4 -> V_175 ) {
F_17 ( F_6 ( V_8 + V_52 ) & ~ V_178 ,
...
if ( V_86 & V_177 ) {
V_48 -> error = - V_166 ;
} else if ( V_86 & V_176 && V_48 -> V_5 & V_181 ) {
V_48 -> error = - V_165 ;
} else {
V_48 -> V_182 [ 0 ] = F_6 ( V_8 + V_183 ) ;
V_48 -> V_182 [ 1 ] = F_6 ( V_8 + V_184 ) ;
V_48 -> V_182 [ 2 ] = F_6 ( V_8 + V_185 ) ;
V_48 -> V_182 [ 3 ] = F_6 ( V_8 + V_186 ) ;
}
...
static int F_69 ( struct V_3 * V_4 , char * V_187 , unsigned int V_162 )
{
void T_2 * V_8 = V_4 -> V_8 ;
char * V_188 = V_187 ;
T_1 V_86 ;
int V_189 = V_4 -> V_130 ;
do {
int V_190 = V_189 - ( F_6 ( V_8 + V_191 ) << 2 ) ;
if ( V_190 > V_162 )
V_190 = V_162 ;
if ( V_190 <= 0 )
break;
if ( F_70 ( V_190 & 0x3 ) ) {
if ( V_190 < 4 ) {
unsigned char V_192 [ 4 ] ;
F_71 ( V_8 + V_96 , V_192 , 1 ) ;
memcpy ( V_188 , V_192 , V_190 ) ;
} else {
F_71 ( V_8 + V_96 , V_188 , V_190 >> 2 ) ;
V_190 &= ~ 0x3 ;
}
} else {
F_71 ( V_8 + V_96 , V_188 , V_190 >> 2 ) ;
...
static int F_72 ( struct V_3 * V_4 , char * V_187 , unsigned int V_162 , T_1 V_86 )
{
struct V_27 * V_28 = V_4 -> V_28 ;
void T_2 * V_8 = V_4 -> V_8 ;
char * V_188 = V_187 ;
do {
unsigned int V_190 , V_194 ;
V_194 = V_86 & V_195 ?
V_28 -> V_113 : V_28 -> V_102 ;
V_190 = F_73 ( V_162 , V_194 ) ;
F_74 ( V_8 + V_96 , V_188 , ( V_190 + 3 ) >> 2 ) ;
V_188 += V_190 ;
V_162 -= V_190 ;
if ( V_162 == 0 )
break;
...
static T_4 F_75 ( int V_197 , void * V_198 )
{
struct V_3 * V_4 = V_198 ;
struct V_199 * V_59 = & V_4 -> V_59 ;
struct V_27 * V_28 = V_4 -> V_28 ;
void T_2 * V_8 = V_4 -> V_8 ;
unsigned long V_5 ;
T_1 V_86 ;
...
V_200 = 0 ;
if ( V_86 & V_203 )
V_200 = F_69 ( V_4 , V_187 , V_162 ) ;
if ( V_86 & V_204 )
V_200 = F_72 ( V_4 , V_187 , V_162 , V_86 ) ;
V_59 -> V_205 = V_200 ;
V_4 -> V_130 -= V_200 ;
V_162 -= V_200 ;
if ( V_162 )
...
F_78 ( V_59 ) ;
F_79 ( V_5 ) ;
if ( V_86 & V_203 && V_4 -> V_130 < V_28 -> V_102 )
F_25 ( V_4 , V_88 ) ;
if ( V_4 -> V_130 == 0 ) {
F_25 ( V_4 , 0 ) ;
F_17 ( F_6 ( V_8 + V_52 ) | V_121 , V_8 + V_52 ) ;
...
static T_4 F_80 ( int V_197 , void * V_198 )
{
struct V_3 * V_4 = V_198 ;
T_1 V_86 ;
int V_119 = 0 ;
...
F_17 ( V_86 , V_4 -> V_8 + V_207 ) ;
F_60 ( F_4 ( V_4 -> V_2 ) , L_16 , V_86 ) ;
V_48 = V_4 -> V_48 ;
if ( ( V_86 | V_4 -> V_175 ) & ( V_176 | V_177 |
V_179 | V_180 ) && V_48 )
F_68 ( V_4 , V_48 , V_86 ) ;
V_12 = V_4 -> V_12 ;
if ( V_86 & ( V_157 | V_158 | V_159 |
...
static void F_85 ( struct V_1 * V_2 , struct V_208 * V_37 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_27 * V_28 = V_4 -> V_28 ;
T_1 V_19 = 0 ;
...
F_3 ( F_4 ( V_2 ) ) ;
if ( V_4 -> V_63 -> V_209 &&
V_4 -> V_63 -> V_209 ( F_4 ( V_2 ) , V_37 ) )
F_12 ( F_4 ( V_2 ) , L_17 ) ;
switch ( V_37 -> V_210 ) {
case V_211 :
if ( ! F_86 ( V_2 -> V_212 . V_213 ) )
F_87 ( V_2 , V_2 -> V_212 . V_213 , 0 ) ;
if ( ! F_86 ( V_2 -> V_212 . V_214 ) && V_4 -> V_215 ) {
F_88 ( V_2 -> V_212 . V_214 ) ;
V_4 -> V_215 = false ;
}
break;
case V_216 :
if ( ! F_86 ( V_2 -> V_212 . V_213 ) )
F_87 ( V_2 , V_2 -> V_212 . V_213 , V_37 -> V_217 ) ;
V_19 |= V_28 -> V_218 ;
break;
case V_219 :
if ( ! F_86 ( V_2 -> V_212 . V_214 ) && ! V_4 -> V_215 ) {
V_119 = F_89 ( V_2 -> V_212 . V_214 ) ;
if ( V_119 < 0 )
F_12 ( F_4 ( V_2 ) ,
L_18 ) ;
else
...
if ( V_28 -> V_221 && V_37 -> V_210 != V_211 ) {
V_19 |= V_4 -> V_63 -> V_222 ;
if ( V_37 -> V_38 == V_39 )
V_19 &= ~ V_223 ;
else if ( V_37 -> V_38 == V_224 )
V_19 &= ( ~ V_223 &
~ V_225 &
~ V_226 ) ;
}
...
static int F_93 ( struct V_1 * V_2 , struct V_208 * V_37 )
{
int V_119 = 0 ;
if ( ! F_86 ( V_2 -> V_212 . V_214 ) ) {
F_3 ( F_4 ( V_2 ) ) ;
switch ( V_37 -> V_237 ) {
case V_238 :
V_119 = F_94 ( V_2 -> V_212 . V_214 ,
2700000 , 3600000 ) ;
break;
case V_239 :
V_119 = F_94 ( V_2 -> V_212 . V_214 ,
...
static T_4 F_95 ( int V_197 , void * V_198 )
{
struct V_3 * V_4 = V_198 ;
...
{
int V_38 = 0 ;
V_243 -> V_234 = F_99 ( V_242 , L_20 , 0 ) ;
V_243 -> V_235 = F_99 ( V_242 , L_21 , 0 ) ;
if ( F_100 ( V_242 , L_22 , NULL ) )
V_243 -> V_236 = true ;
else
V_243 -> V_236 = false ;
F_101 ( V_242 , L_23 , & V_243 -> V_244 ) ;
if ( ! V_243 -> V_244 )
F_102 ( L_24 , V_242 -> V_245 ) ;
if ( F_100 ( V_242 , L_25 , NULL ) )
V_243 -> V_246 |= V_247 ;
if ( F_100 ( V_242 , L_26 , NULL ) )
V_243 -> V_246 |= V_248 ;
F_101 ( V_242 , L_27 , & V_38 ) ;
switch ( V_38 ) {
case 0 :
break;
case 4 :
...
static int F_103 ( struct V_251 * V_75 ,
const struct V_252 * V_253 )
{
struct V_62 * V_63 = V_75 -> V_75 . V_254 ;
struct V_241 * V_242 = V_75 -> V_75 . V_255 ;
struct V_27 * V_28 = V_253 -> V_12 ;
struct V_3 * V_4 ;
struct V_1 * V_2 ;
int V_119 ;
if ( ! V_63 && ! V_242 ) {
...
if ( ! V_63 ) {
V_63 = F_104 ( & V_75 -> V_75 , sizeof( * V_63 ) , V_256 ) ;
if ( ! V_63 )
return - V_116 ;
}
if ( V_242 )
F_98 ( V_242 , V_63 ) ;
V_119 = F_105 ( V_75 , V_257 ) ;
if ( V_119 )
goto V_258;
...
V_4 -> V_235 = - V_125 ;
V_4 -> V_260 = - 1 ;
V_4 -> V_229 = F_107 ( V_75 ) ;
V_4 -> V_261 = F_108 ( V_75 ) ;
F_60 ( F_4 ( V_2 ) , L_30 , V_4 -> V_229 ) ;
F_60 ( F_4 ( V_2 ) , L_31 , V_4 -> V_261 ) ;
...
V_4 -> V_95 = V_75 -> V_264 . V_265 ;
V_4 -> V_8 = F_114 ( V_75 -> V_264 . V_265 , F_115 ( & V_75 -> V_264 ) ) ;
if ( ! V_4 -> V_8 ) {
V_119 = - V_116 ;
goto V_263;
}
if ( V_28 -> V_32 )
V_2 -> V_266 = F_21 ( V_4 -> V_30 , 257 ) ;
else
V_2 -> V_266 = F_21 ( V_4 -> V_30 , 512 ) ;
if ( V_63 -> V_244 )
V_2 -> V_244 = F_73 ( V_4 -> V_30 , V_63 -> V_244 ) ;
else
V_2 -> V_244 = F_73 ( V_4 -> V_30 , V_267 ) ;
F_60 ( F_4 ( V_2 ) , L_33 , V_2 -> V_244 ) ;
F_116 ( V_2 ) ;
if ( ! V_2 -> V_268 )
V_2 -> V_268 = V_63 -> V_269 ;
else if ( V_63 -> V_269 )
F_34 ( F_4 ( V_2 ) , L_34 ) ;
V_2 -> V_270 = V_63 -> V_246 ;
V_2 -> V_271 = V_63 -> V_272 ;
if ( V_28 -> V_173 ) {
V_273 . V_274 = F_1 ;
F_19 ( V_4 , V_24 ) ;
V_2 -> V_270 |= V_275 ;
...
V_2 -> V_278 = V_279 ;
V_2 -> V_280 = V_281 ;
V_2 -> V_282 = ( 1 << V_28 -> V_283 ) - 1 ;
V_2 -> V_76 = V_2 -> V_282 ;
V_2 -> V_284 = 1 << 11 ;
V_2 -> V_285 = V_2 -> V_282 >> 11 ;
F_117 ( & V_4 -> V_7 ) ;
F_17 ( 0 , V_4 -> V_8 + V_52 ) ;
F_17 ( 0 , V_4 -> V_8 + V_54 ) ;
F_17 ( 0xfff , V_4 -> V_8 + V_207 ) ;
if ( V_63 -> V_235 == - V_286 ) {
V_119 = - V_286 ;
goto V_287;
}
if ( F_118 ( V_63 -> V_235 ) ) {
V_119 = F_119 ( V_63 -> V_235 , V_257 L_35 ) ;
if ( V_119 == 0 )
V_119 = F_120 ( V_63 -> V_235 ) ;
if ( V_119 == 0 )
V_4 -> V_235 = V_63 -> V_235 ;
else if ( V_119 != - V_125 )
goto V_287;
V_119 = F_121 ( F_122 ( V_63 -> V_235 ) ,
F_95 ,
V_288 | V_289 ,
V_257 L_35 , V_4 ) ;
if ( V_119 >= 0 )
V_4 -> V_260 = F_122 ( V_63 -> V_235 ) ;
}
if ( V_63 -> V_234 == - V_286 ) {
V_119 = - V_286 ;
goto V_290;
...
if ( F_118 ( V_63 -> V_234 ) ) {
V_119 = F_119 ( V_63 -> V_234 , V_257 L_36 ) ;
if ( V_119 == 0 )
V_119 = F_120 ( V_63 -> V_234 ) ;
if ( V_119 == 0 )
V_4 -> V_234 = V_63 -> V_234 ;
else if ( V_119 != - V_125 )
goto V_290;
}
if ( ( V_4 -> V_63 -> V_86 || V_4 -> V_235 != - V_125 )
&& V_4 -> V_260 < 0 )
V_2 -> V_270 |= V_291 ;
V_119 = F_123 ( V_75 -> V_197 [ 0 ] , F_80 , V_292 , V_257 L_37 , V_4 ) ;
if ( V_119 )
goto V_293;
if ( ! V_75 -> V_197 [ 1 ] )
V_4 -> V_50 = true ;
else {
V_119 = F_123 ( V_75 -> V_197 [ 1 ] , F_75 , V_292 ,
V_257 L_38 , V_4 ) ;
if ( V_119 )
goto V_294;
}
F_17 ( V_295 , V_4 -> V_8 + V_52 ) ;
F_124 ( V_75 , V_2 ) ;
F_36 ( & V_75 -> V_75 , L_39 ,
F_125 ( V_2 ) , F_126 ( V_75 ) , F_107 ( V_75 ) ,
F_108 ( V_75 ) , ( unsigned long long ) V_75 -> V_264 . V_265 ,
V_75 -> V_197 [ 0 ] , V_75 -> V_197 [ 1 ] ) ;
F_29 ( V_4 ) ;
F_127 ( & V_75 -> V_75 , 50 ) ;
F_128 ( & V_75 -> V_75 ) ;
F_129 ( & V_75 -> V_75 ) ;
...
static int F_137 ( struct V_251 * V_75 )
{
...
{
struct V_251 * V_296 = F_141 ( V_75 ) ;
struct V_1 * V_2 = F_138 ( V_296 ) ;
if ( V_2 ) {
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_3 ( V_75 ) ;
F_17 ( 0 , V_4 -> V_8 + V_52 ) ;
