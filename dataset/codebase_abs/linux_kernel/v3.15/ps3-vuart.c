...
static T_3 F_52 ( int V_71 , void * V_72 )
{
...
return 0 ;
F_2 ( V_73 . V_6 ) ;
V_73 . V_6 = F_56 ( sizeof( struct V_5 ) , V_42 ) ;
if ( ! V_73 . V_6 ) {
F_4 ( L_50 , V_22 , __LINE__ ) ;
V_12 = - V_50 ;
goto V_81;
}
V_12 = F_57 ( V_82 , V_73 . V_6 ,
& V_73 . V_83 ) ;
if ( V_12 ) {
F_4 ( L_51 ,
V_22 , __LINE__ , V_12 ) ;
...
V_3 -> V_4 = F_56 ( sizeof( struct V_1 ) ,
V_42 ) ;
if ( ! V_3 -> V_4 ) {
V_12 = - V_50 ;
goto V_94;
...
V_64 -> V_21 . V_95 = F_62 ;
V_64 -> V_21 . remove = F_71 ;
V_64 -> V_21 . V_99 = F_72 ;
V_12 = F_78 ( & V_64 -> V_21 ) ;
return V_12 ;
}
void F_79 ( struct V_63 * V_64 )
{
F_4 ( L_57 , V_22 , __LINE__ , V_64 -> V_21 . V_21 . V_88 ) ;
F_80 ( & V_64 -> V_21 ) ;
}
