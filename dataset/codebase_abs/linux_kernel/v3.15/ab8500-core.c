...
L_28 ,
L_29 } ;
struct V_101 * V_102 = F_62 ( & V_98 -> V_5 ) ;
const struct V_103 * V_104 = F_63 ( V_98 ) ;
enum V_105 V_106 = V_107 ;
struct V_71 * V_72 = V_98 -> V_5 . V_108 ;
struct V_1 * V_1 ;
struct V_109 * V_109 ;
int V_4 ;
int V_24 ;
T_2 V_15 ;
V_1 = F_64 ( & V_98 -> V_5 , sizeof *V_1 , V_110 ) ;
if ( ! V_1 )
return - V_111 ;
V_1 -> V_5 = & V_98 -> V_5 ;
V_109 = F_65 ( V_98 , V_112 , 0 ) ;
if ( ! V_109 ) {
F_3 ( & V_98 -> V_5 , L_30 ) ;
return - V_113 ;
}
...
V_1 -> V_6 = F_64 ( & V_98 -> V_5 , V_1 -> V_25 , V_110 ) ;
if ( ! V_1 -> V_6 )
return - V_111 ;
V_1 -> V_27 = F_64 ( & V_98 -> V_5 , V_1 -> V_25 , V_110 ) ;
if ( ! V_1 -> V_27 )
return - V_111 ;
V_4 = F_17 ( V_1 , V_83 ,
V_84 , & V_15 ) ;
...
if ( V_15 ) {
for ( V_24 = 0 ; V_24 < F_69 ( V_99 ) ; V_24 ++ ) {
if ( V_15 & 1 )
F_70 ( V_128 L_34 ,
V_99 [ V_24 ] ) ;
V_15 = V_15 >> 1 ;
...
if ( V_4 )
return V_4 ;
V_4 = F_72 ( & V_98 -> V_5 , V_1 -> V_60 , NULL ,
F_36 ,
V_137 | V_138 ,
L_40 , V_1 ) ;
if ( V_4 )
return V_4 ;
#if V_139
V_140 [ 0 ] . V_114 = V_1 -> V_60 ;
V_140 [ 0 ] . V_141 = V_1 -> V_60 ;
#endif
if ( F_46 ( V_1 ) )
V_4 = F_73 ( V_1 -> V_5 , 0 , V_142 ,
F_69 ( V_142 ) , NULL ,
0 , V_1 -> V_53 ) ;
else if ( F_45 ( V_1 ) ) {
V_4 = F_73 ( V_1 -> V_5 , 0 , V_143 ,
F_69 ( V_143 ) , NULL ,
0 , V_1 -> V_53 ) ;
if ( V_4 )
return V_4 ;
if ( F_74 ( V_1 ) )
V_4 = F_73 ( V_1 -> V_5 , 0 , V_144 ,
F_69 ( V_144 ) , NULL ,
0 , V_1 -> V_53 ) ;
else
V_4 = F_73 ( V_1 -> V_5 , 0 , V_145 ,
F_69 ( V_145 ) , NULL ,
0 , V_1 -> V_53 ) ;
} else if ( F_47 ( V_1 ) )
V_4 = F_73 ( V_1 -> V_5 , 0 , V_146 ,
F_69 ( V_146 ) , NULL ,
0 , V_1 -> V_53 ) ;
else
V_4 = F_73 ( V_1 -> V_5 , 0 , V_147 ,
F_69 ( V_147 ) , NULL ,
0 , V_1 -> V_53 ) ;
if ( V_4 )
return V_4 ;
if ( ! V_148 ) {
V_4 = F_73 ( V_1 -> V_5 , 0 , V_149 ,
F_69 ( V_149 ) , NULL ,
0 , V_1 -> V_53 ) ;
if ( V_4 )
F_3 ( V_1 -> V_5 , L_41 ) ;
...
V_1 -> V_10 >= V_150 ) || F_45 ( V_1 ) )
V_4 = F_75 ( & V_1 -> V_5 -> V_151 ,
& V_152 ) ;
else
V_4 = F_75 ( & V_1 -> V_5 -> V_151 ,
& V_153 ) ;
...
{
struct V_1 * V_1 = F_77 ( V_98 ) ;
if ( ( ( F_47 ( V_1 ) || F_46 ( V_1 ) ) &&
V_1 -> V_10 >= V_150 ) || F_45 ( V_1 ) )
F_78 ( & V_1 -> V_5 -> V_151 , & V_152 ) ;
else
F_78 ( & V_1 -> V_5 -> V_151 , & V_153 ) ;
if ( ( F_47 ( V_1 ) || F_46 ( V_1 ) ) &&
V_1 -> V_10 >= V_150 )
F_78 ( & V_1 -> V_5 -> V_151 , & V_154 ) ;
F_79 ( V_1 -> V_5 ) ;
return 0 ;
}
