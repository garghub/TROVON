...
struct V_60 * V_30 ;
F_40 ( V_4 -> V_13 ) ;
V_4 -> V_56 = F_41 ( V_10 -> V_57 , V_10 -> V_9 , 0 ,
V_59 , V_61 ) ;
...
V_51 -> V_45 . V_81 = V_4 -> V_45 . V_81 ;
V_51 -> V_45 . V_82 = V_4 -> V_45 . V_83 / V_84 ;
V_51 -> V_46 = V_4 -> V_46 ;
V_51 -> V_43 = V_4 -> V_43 ;
V_51 -> V_5 = V_4 -> V_5 ;
V_4 -> V_36 = 1 ;
...
int F_57 ( struct V_1 * V_2 , void * V_85 )
{
int V_23 ;
unsigned long V_86 ;
...
F_27 ( & V_2 -> V_10 -> V_49 , V_86 ) ;
V_2 -> V_89 -> V_94 ( V_2 , V_85 ) ;
F_28 ( & V_2 -> V_10 -> V_49 , V_86 ) ;
V_88 -> V_46 = V_2 -> V_46 + V_2 -> V_95 ;
V_2 -> V_96 = 1 ;
...
static int F_60 ( struct V_1 * V_2 , int V_97 )
{
int V_23 = V_44 ;
if ( ! F_61 ( & V_2 -> V_77 , - 1 , 0 ) &&
V_97 == V_47 && V_2 -> V_65 == V_79 ) {
V_23 = F_23 ( V_2 ) ;
F_25 ( V_2 ) ;
}
return V_23 ;
...
static void F_64 ( struct V_1 * V_2 , T_4 V_99 )
{
if ( ( V_2 -> V_65 != V_100 &&
V_2 -> V_65 != V_79 ) && V_99 )
return;
V_2 -> V_89 -> V_101 ( V_2 , V_99 ) ;
if ( V_2 -> V_65 == V_102 && ! V_99 )
V_2 -> V_65 = V_66 ;
else if ( V_2 -> V_65 == V_100 && V_99 )
V_2 -> V_65 = V_79 ;
}
...
return;
F_27 ( & V_2 -> V_10 -> V_49 , V_86 ) ;
if ( V_2 -> V_65 == V_100 && ! V_2 -> V_67 &&
V_2 -> V_58 ) {
V_2 -> V_105 = 1 ;
F_25 ( V_2 ) ;
V_2 -> V_89 -> V_106 ( V_2 , V_2 -> V_104 ) ;
F_14 ( V_2 , V_2 -> V_41 ) ;
if ( ! F_58 ( V_2 ) )
F_68 ( & V_2 -> V_77 , 0 ) ;
F_64 ( V_2 , 1 ) ;
...
int F_71 ( struct V_1 * V_2 , T_4 V_101 )
{
unsigned long V_86 ;
F_12 ( V_2 -> V_10 -> V_9 , L_33 ,
V_2 -> V_27 . V_28 , V_101 ? L_34 : L_35 ) ;
F_54 ( & V_2 -> V_80 ) ;
F_27 ( & V_2 -> V_10 -> V_49 , V_86 ) ;
if ( ! V_2 -> V_96 && V_101 ) {
F_28 ( & V_2 -> V_10 -> V_49 , V_86 ) ;
...
int F_72 ( struct V_108 * V_27 , int V_101 )
{
...
static void F_75 ( struct V_1 * V_2 , int V_109 )
{
int V_23 = V_47 ;
int V_67 ;
unsigned long V_86 ;
...
F_28 ( & V_2 -> V_10 -> V_49 , V_86 ) ;
if ( ! F_62 ( V_2 ) ) {
if ( ! V_109 && V_2 -> V_89 -> V_113 )
V_23 = V_2 -> V_89 -> V_113 ( V_2 ) ;
if ( V_23 == V_114 )
return;
F_27 ( & V_2 -> V_10 -> V_49 , V_86 ) ;
if ( V_2 -> V_65 == V_102 ) {
...
V_111 = F_76 ( & V_2 -> V_27 . V_115 ) ;
V_2 -> V_43 = F_77 ( & V_111 -> V_43 ) ;
V_23 = F_60 ( V_2 , V_23 ) ;
if ( F_11 ( ! V_2 -> V_107 ) ) {
V_2 -> V_89 -> V_106 ( V_2 , V_2 -> V_104 ) ;
} else {
V_2 -> V_105 = 1 ;
V_2 -> V_89 -> V_106 ( V_2 , V_2 -> V_92 ) ;
V_2 -> V_107 = 0 ;
V_2 -> V_105 = 1 ;
}
F_14 ( V_2 , V_2 -> V_41 ) ;
...
int F_79 ( struct V_108 * V_27 ,
struct V_116 * V_117 ,
struct V_118 * V_119 )
{
struct V_1 * V_2 = F_73 ( V_27 ) ;
if ( V_119 -> type != V_2 -> V_78 )
return - V_24 ;
return F_80 ( V_117 , V_119 , V_120 , NULL ) ;
}
int F_81 ( struct V_108 * V_27 ,
struct V_116 * V_117 ,
struct V_118 * V_119 )
{
return F_82 ( V_117 , V_119 ) ;
}
...
struct V_121 * V_70 )
{
return F_86 ( V_70 , & V_2 -> V_27 ) ;
}
static int F_87 ( struct V_1 * V_2 , const char * V_28 ,
const struct V_122 * V_123 )
{
struct V_108 * V_27 = & V_2 -> V_27 ;
struct V_124 * V_125 = & V_27 -> V_115 ;
F_88 ( V_27 , V_123 ) ;
snprintf ( V_27 -> V_28 , V_126 , L_43 , V_28 ) ;
V_27 -> V_127 = 1 << 16 ;
V_27 -> V_48 |= V_128 | V_129 ;
F_89 ( V_27 , V_2 ) ;
V_2 -> V_130 . V_48 = V_131 | V_132 ;
V_125 -> V_89 = NULL ;
return F_90 ( V_125 , 1 , & V_2 -> V_130 , 0 ) ;
}
int F_91 ( struct V_1 * V_2 , const char * V_28 ,
const struct V_122 * V_123 )
{
int V_23 ;
V_2 -> V_4 = F_92 ( V_35 , sizeof( * V_2 -> V_4 ) , V_63 ) ;
if ( ! V_2 -> V_4 )
return - V_62 ;
F_19 ( V_2 ) ;
F_93 ( & V_2 -> V_80 ) ;
F_68 ( & V_2 -> V_77 , 0 ) ;
V_23 = F_87 ( V_2 , V_28 , V_123 ) ;
if ( V_23 < 0 ) {
F_94 ( & V_2 -> V_80 ) ;
F_95 ( V_2 -> V_4 ) ;
}
