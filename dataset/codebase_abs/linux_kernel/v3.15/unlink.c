...
void (* V_66)( struct V_17 * , struct V_61 * ) )
{
struct V_61 * V_2 ;
struct V_25 V_26 = { } ;
struct V_31 V_32 = {
...
V_2 -> args . V_71 = & V_65 -> V_9 ;
V_2 -> V_29 . V_68 = & V_2 -> V_68 ;
V_2 -> V_29 . V_69 = & V_2 -> V_69 ;
F_28 ( V_62 -> V_23 ) ;
F_15 ( V_2 -> V_62 ) -> F_69 ( & V_26 , V_62 ) ;
return F_33 ( & V_32 ) ;
}
static void
F_70 ( struct V_17 * V_18 , struct V_61 * V_2 )
{
struct V_6 * V_6 = V_2 -> V_64 ;
if ( V_18 -> V_20 != 0 ) {
F_56 ( V_6 ) ;
return;
}
...
int
F_72 ( struct V_12 * V_3 , struct V_6 * V_6 )
{
static unsigned int V_72 ;
unsigned char V_73 [ V_74 + 1 ] ;
...
goto V_58;
V_75 = F_76 ( V_6 -> V_44 ) ;
F_15 ( V_6 -> V_44 ) -> F_77 ( V_6 -> V_44 ) ;
V_76 = NULL ;
do {
int V_79 ;
F_26 ( V_76 ) ;
V_72 ++ ;
V_79 = F_78 ( V_73 , sizeof( V_73 ) ,
V_80 L_2 ,
V_81 , V_75 ,
V_82 , V_72 ) ;
F_73 ( V_77 , L_3 ,
V_6 , V_73 ) ;
V_76 = F_79 ( V_73 , V_6 -> V_83 , V_79 ) ;
if ( F_34 ( V_76 ) )
goto V_58;
} while ( V_76 -> V_44 != NULL );
error = F_50 ( V_3 , V_6 ) ;
if ( error )
goto V_55;
error = F_5 ( V_76 ,
