...
struct V_33 * V_34 ;
struct V_22 * V_23 ;
unsigned long V_37 , V_59 ;
T_5 V_60 ;
int V_52 ;
F_22 ( V_24 , V_4 -> V_5 + V_61 ) ;
V_60 = F_33 ( V_4 -> V_5 + V_62 ) ;
if ( ! V_60 || F_4 ( V_4 -> V_5 + V_63 ) )
return F_46 ( - V_64 ) ;
...
V_34 -> V_60 = V_60 ;
V_34 -> V_65 = V_58 ;
V_59 = F_47 ( F_48 ( V_60 , V_66 ) ) ;
V_34 -> V_67 = F_49 ( V_59 , V_54 | V_68 ) ;
if ( V_34 -> V_67 == NULL ) {
V_52 = - V_53 ;
goto V_69;
}
F_9 ( F_50 ( V_34 -> V_67 ) >> V_70 ,
V_4 -> V_5 + V_63 ) ;
V_23 = F_51 ( V_24 , V_34 -> V_60 , V_66 , V_3 ,
true , V_34 -> V_67 , F_21 , F_45 , V_50 ) ;
if ( ! V_23 ) {
V_52 = - V_53 ;
goto V_71;
}
...
V_34 -> V_23 = V_23 ;
if ( V_58 != V_45 ) {
F_22 ( V_58 , V_4 -> V_5 + V_73 ) ;
V_58 = F_33 ( V_4 -> V_5 + V_73 ) ;
if ( V_58 == V_45 ) {
V_52 = - V_56 ;
goto V_74;
}
...
{
struct V_1 * V_4 = F_1 ( V_23 -> V_3 ) ;
struct V_33 * V_34 = V_23 -> V_72 ;
unsigned long V_37 , V_59 ;
F_25 ( & V_4 -> V_38 , V_37 ) ;
F_57 ( & V_34 -> V_75 ) ;
F_28 ( & V_4 -> V_38 , V_37 ) ;
F_22 ( V_23 -> V_24 , V_4 -> V_5 + V_61 ) ;
if ( V_4 -> V_44 ) {
F_22 ( V_45 ,
V_4 -> V_5 + V_73 ) ;
F_12 ( V_4 -> V_5 + V_40 ) ;
...
static int F_60 ( struct V_2 * V_3 , unsigned V_78 ,
struct V_22 * V_79 [] ,
T_6 * V_80 [] ,
const char * V_81 [] ,
bool V_82 ,
...
V_79 [ V_13 ] = NULL ;
continue;
} else if ( ! V_80 [ V_13 ] || ! V_4 -> V_44 )
V_58 = V_45 ;
else if ( V_4 -> V_49 )
V_58 = V_83 ++ ;
else
V_58 = V_85 ;
V_79 [ V_13 ] = F_44 ( V_3 , V_13 , V_80 [ V_13 ] , V_81 [ V_13 ] , V_58 ) ;
if ( F_61 ( V_79 [ V_13 ] ) ) {
V_52 = F_62 ( V_79 [ V_13 ] ) ;
goto V_86;
}
if ( ! V_4 -> V_49 || V_58 == V_45 )
continue;
snprintf ( V_4 -> V_47 [ V_58 ] ,
sizeof * V_4 -> V_47 ,
L_3 ,
F_37 ( & V_4 -> V_3 . V_29 ) , V_81 [ V_13 ] ) ;
V_52 = F_42 ( V_4 -> V_20 [ V_58 ] . V_21 ,
F_27 , 0 ,
V_4 -> V_47 [ V_58 ] ,
V_79 [ V_13 ] ) ;
if ( V_52 ) {
...
static int F_63 ( struct V_2 * V_3 , unsigned V_78 ,
struct V_22 * V_79 [] ,
T_6 * V_80 [] ,
const char * V_81 [] )
{
int V_52 ;
V_52 = F_60 ( V_3 , V_78 , V_79 , V_80 , V_81 , true , true ) ;
if ( ! V_52 )
return 0 ;
V_52 = F_60 ( V_3 , V_78 , V_79 , V_80 , V_81 ,
true , false ) ;
if ( ! V_52 )
return 0 ;
return F_60 ( V_3 , V_78 , V_79 , V_80 , V_81 ,
false , false ) ;
}
...
static int F_66 ( struct V_22 * V_23 , int V_87 )
{
...
return - V_90 ;
if ( V_4 -> V_44 ) {
V_89 = V_4 -> V_43 [ V_34 -> V_65 ] ;
V_18 = V_4 -> V_20 [ V_34 -> V_65 ] . V_21 ;
if ( V_87 == - 1 )
F_67 ( V_18 , NULL ) ;
else {
F_68 ( V_87 , V_89 ) ;
...
struct V_1 * V_4 ;
int V_52 ;
if ( V_17 -> V_91 < 0x1000 || V_17 -> V_91 > 0x103f )
return - V_95 ;
if ( V_17 -> V_96 != V_97 ) {
F_71 ( V_98 L_4 ,
V_97 , V_17 -> V_96 ) ;
...
if ( V_4 == NULL )
return - V_53 ;
V_4 -> V_3 . V_29 . V_99 = & V_17 -> V_29 ;
V_4 -> V_3 . V_29 . V_100 = F_69 ;
V_4 -> V_3 . V_101 = & V_102 ;
V_4 -> V_17 = V_17 ;
F_53 ( & V_4 -> V_76 ) ;
F_72 ( & V_4 -> V_38 ) ;
...
F_77 ( V_17 , V_4 ) ;
F_78 ( V_17 ) ;
V_4 -> V_3 . V_94 . V_106 = V_17 -> V_107 ;
V_4 -> V_3 . V_94 . V_91 = V_17 -> V_108 ;
V_52 = F_79 ( & V_4 -> V_3 ) ;
if ( V_52 )
goto V_109;
return 0 ;
...
static int F_86 ( struct V_91 * V_29 )
{
...
struct V_27 , V_30 ) ;
V_35 = 0 ;
V_4 -> V_110 = F_15 ( & V_4 -> V_3 ) ;
if ( V_28 && V_28 -> V_111 )
V_35 = V_28 -> V_111 ( & V_4 -> V_3 ) ;
if ( ! V_35 )
F_82 ( V_17 ) ;
return V_35 ;
}
static int F_88 ( struct V_91 * V_29 )
{
struct V_17 * V_17 = F_87 ( V_29 ) ;
struct V_1 * V_4 = F_84 ( V_17 ) ;
struct V_27 * V_28 ;
