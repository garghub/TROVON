...
int F_16 ( struct V_31 * V_32 , T_2 V_16 ,
T_2 V_47 , T_1 V_48 )
{
struct V_1 * V_6 ;
struct V_36 * V_49 = F_7 ( V_32 -> V_4 ) ;
int V_50 = 0 ;
F_17 ( & V_49 -> V_51 ) ;
V_6 = F_1 ( V_16 , V_32 -> V_4 , V_52 ) ;
if ( ! V_6 || ( V_47 >= V_6 -> V_53 ) ) {
V_50 = - V_42 ;
goto V_54;
}
F_18 ( V_6 -> V_18 [ V_47 ] , 0 , V_48 ) ;
F_19 ( V_32 -> V_4 , V_6 , V_55 ) ;
F_20 ( V_32 -> V_4 ) ;
V_54:
F_21 ( & V_49 -> V_51 ) ;
return V_50 ;
}
int F_22 ( struct V_31 * V_32 , T_2 V_16 ,
T_2 V_47 , T_1 * V_48 )
{
struct V_1 * V_6 ;
struct V_36 * V_49 = F_7 ( V_32 -> V_4 ) ;
...
V_6 = F_1 ( V_16 , V_32 -> V_4 , V_52 ) ;
if ( ! V_6 || ( V_47 >= V_6 -> V_53 ) ||
V_6 -> V_18 [ V_47 ] -> V_25 < 1 ) {
V_50 = - V_42 ;
goto V_54;
}
F_19 ( V_32 -> V_4 , V_6 , V_56 ) ;
F_20 ( V_32 -> V_4 ) ;
* V_48 = V_6 -> V_18 [ V_47 ] -> V_48 [ 0 ] ;
V_54:
F_21 ( & V_49 -> V_51 ) ;
return V_50 ;
}
int F_23 ( struct V_31 * V_32 ,
T_2 V_29 ,
T_2 V_57 , T_2 V_16 )
{
struct V_36 * V_49 = F_7 ( V_32 -> V_4 ) ;
...
int V_59 = 0 ;
F_17 ( & V_49 -> V_51 ) ;
memset ( & V_49 -> V_60 , 0 , sizeof( V_49 -> V_60 ) ) ;
F_24 ( & V_49 -> V_60 . V_61 ) ;
V_49 -> V_60 . V_29 = V_29 ;
V_49 -> V_60 . V_57 = V_57 ;
V_49 -> V_60 . V_62 = 0 ;
...
goto V_66;
F_19 ( V_32 -> V_4 , V_6 , V_56 ) ;
F_27 ( & V_49 -> V_60 . V_61 , V_67 * 5 ) ;
switch ( V_49 -> V_60 . V_62 ) {
case 1 :
V_59 = * ( V_68 * ) V_49 -> V_60 . V_69 ;
break;
case 2 :
V_59 = * ( V_70 * ) V_49 -> V_60 . V_69 ;
break;
case 4 :
V_59 = * ( T_2 * ) V_49 -> V_60 . V_69 ;
break;
default:
V_59 = 0 ;
}
F_15 ( V_49 -> V_60 . V_69 ) ;
V_66:
V_49 -> V_60 . V_64 = false ;
F_21 ( & V_49 -> V_51 ) ;
return V_59 ;
}
int F_28 ( struct V_31 * V_32 ,
T_2 V_16 , int V_47 , T_2 V_29 )
{
struct V_1 * V_6 ;
struct V_17 * V_18 ;
int V_7 ;
...
V_6 -> V_18 [ V_7 ] -> V_25 ) / 8 ;
if ( V_37 -> V_60 . V_64 && V_37 -> V_60 . V_57 ==
V_6 -> V_18 [ V_7 ] -> V_72 -> V_73 ) {
F_31 ( V_4 , L_7 ) ;
V_37 -> V_60 . V_69 = F_35 ( V_83 , V_84 , V_43 ) ;
if ( V_37 -> V_60 . V_69 )
V_37 -> V_60 . V_62 = V_84 ;
else
V_37 -> V_60 . V_62 = 0 ;
...
if ( V_99 )
V_99 -> V_40 = V_7 ;
V_50 = F_52 ( & V_4 -> V_100 , 0 , V_91 -> V_107 ,
...
F_15 ( V_91 -> V_107 [ V_7 ] . V_97 ) ;
F_15 ( V_91 -> V_107 [ V_7 ] . V_115 ) ;
}
F_15 ( V_91 -> V_107 ) ;
V_106:
F_53 ( V_4 ) ;
...
F_26 ( & V_49 -> V_63 , V_58 ) ;
F_55 ( & V_4 -> V_100 ) ;
for ( V_7 = 0 ; V_7 < V_49 -> V_104 ; ++ V_7 ) {
F_15 ( V_49 -> V_107 [ V_7 ] . V_97 ) ;
F_15 ( V_49 -> V_107 [ V_7 ] . V_115 ) ;
}
F_15 ( V_49 -> V_107 ) ;
F_45 ( V_4 , NULL ) ;
F_56 ( & V_49 -> V_51 ) ;
