...
static void * F_20 ( struct V_79 * V_71 ,
struct V_80 * V_81 )
{
struct V_24 * V_25 ;
struct V_8 * V_9 ;
...
struct V_83 * V_84 ;
#endif
V_25 = F_21 ( sizeof( * V_25 ) , V_85 ) ;
if ( ! V_25 )
return NULL ;
for ( V_27 = 0 ; V_27 < V_86 ; V_27 ++ ) {
V_2 = V_71 -> V_87 -> V_88 [ V_27 ] ;
if ( V_2 && V_2 -> V_14 > V_82 )
V_82 = V_2 -> V_14 ;
}
V_9 = F_21 ( sizeof( * V_9 ) * V_82 , V_85 ) ;
if ( ! V_9 ) {
F_22 ( V_25 ) ;
return NULL ;
}
...
#ifdef F_3
V_84 = & V_25 -> V_98 ;
V_84 -> V_47 = F_23 ( L_1 , V_99 | V_100 ,
V_81 , & V_25 -> V_47 ) ;
V_84 -> V_37 = F_23 ( L_2 ,
V_99 | V_100 , V_81 ,
& V_25 -> V_37 ) ;
V_84 -> V_51 = F_23 ( L_3 , V_99 | V_100 ,
V_81 , ( T_1 * ) & V_25 -> V_51 ) ;
V_84 -> V_52 = F_23 ( L_4 , V_99 | V_100 ,
V_81 , ( T_1 * ) & V_25 -> V_52 ) ;
V_84 -> V_53 = F_23 ( L_5 , V_99 | V_100 ,
V_81 , ( T_1 * ) & V_25 -> V_53 ) ;
V_84 -> V_49 = F_23 ( L_6 ,
V_99 | V_100 , V_81 ,
& V_25 -> V_49 ) ;
