...
V_16 = F_3 ( V_7 , V_43 , V_51 , sizeof( V_43 ) ) ;
if ( V_16 < 0 ) {
F_27 ( & V_22 -> V_35 , L_2 ,
V_16 ) ;
goto V_50;
...
memcpy ( & V_7 -> V_37 , & V_54 , sizeof( V_7 -> V_37 ) ) ;
if ( F_1 ( V_43 [ 1 ] ) != V_55 ) {
T_1 V_1 ;
V_16 = F_3 ( V_7 , & V_1 , V_56 , sizeof( V_1 ) ) ;
if ( V_16 < 0 ) {
F_27 ( & V_22 -> V_35 ,
L_4 ,
V_16 ) ;
...
static int F_31 ( struct V_40 * V_22 )
{
struct V_58 * V_36 ;
V_36 = F_32 ( V_22 ) ;
F_33 ( & V_22 -> V_35 . V_30 , & V_54 ) ;
F_30 ( V_36 ) ;
return 0 ;
}
