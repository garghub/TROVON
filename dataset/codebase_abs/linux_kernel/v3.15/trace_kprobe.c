...
struct V_1 * V_2 = V_75 ;
int V_34 ;
F_72 ( V_73 , L_30 , F_1 ( V_2 ) ? 'r' : 'p' ) ;
F_72 ( V_73 , L_31 , V_2 -> V_29 . V_30 . V_31 -> system ,
F_24 ( & V_2 -> V_29 . V_30 ) ) ;
if ( ! V_2 -> V_5 )
F_72 ( V_73 , L_32 , V_2 -> V_3 . V_6 . V_14 ) ;
else if ( V_2 -> V_3 . V_6 . V_7 )
F_72 ( V_73 , L_33 , F_2 ( V_2 ) ,
V_2 -> V_3 . V_6 . V_7 ) ;
else
F_72 ( V_73 , L_34 , F_2 ( V_2 ) ) ;
for ( V_34 = 0 ; V_34 < V_2 -> V_29 . V_35 ; V_34 ++ )
F_72 ( V_73 , L_35 , V_2 -> V_29 . args [ V_34 ] . V_11 , V_2 -> V_29 . args [ V_34 ] . V_76 ) ;
F_72 ( V_73 , L_36 ) ;
return 0 ;
}
static int F_73 ( struct V_77 * V_77 , struct V_37 * V_37 )
{
int V_22 ;
...
return F_74 ( V_37 , & V_82 ) ;
}
static T_3 F_75 ( struct V_37 * V_37 , const char T_4 * V_83 ,
T_5 V_84 , T_2 * V_85 )
{
return F_76 ( V_37 , V_83 , V_84 , V_85 ,
F_56 ) ;
}
static int F_77 ( struct V_72 * V_73 , void * V_75 )
{
struct V_1 * V_2 = V_75 ;
F_72 ( V_73 , L_37 ,
...
static int F_78 ( struct V_77 * V_77 , struct V_37 * V_37 )
{
return F_74 ( V_37 , & V_88 ) ;
}
static T_1 void
F_79 ( struct V_1 * V_2 , struct V_89 * V_90 ,
struct V_36 * V_91 )
{
struct V_92 * V_93 ;
struct V_94 * V_18 ;
...
F_80 ( V_30 != V_91 -> V_100 ) ;
if ( F_81 ( V_91 ) )
return;
F_82 ( V_98 ) ;
V_97 = F_83 () ;
V_96 = F_84 ( & V_2 -> V_29 , V_90 ) ;
...
F_87 ( sizeof( * V_93 ) , & V_2 -> V_29 , V_90 , ( V_102 * ) & V_93 [ 1 ] , V_96 ) ;
F_88 ( V_91 , V_83 , V_18 ,
V_93 , V_98 , V_97 , V_90 ) ;
}
static T_1 void
F_89 ( struct V_1 * V_2 , struct V_89 * V_90 )
{
struct V_38 * V_39 ;
F_90 (link, &tk->tp.files, list)
F_79 ( V_2 , V_90 , V_39 -> V_37 ) ;
}
static T_1 void
F_91 ( struct V_1 * V_2 , struct V_103 * V_104 ,
struct V_89 * V_90 ,
struct V_36 * V_91 )
{
struct V_105 * V_93 ;
...
struct V_38 * V_39 ;
F_90 (link, &tk->tp.files, list)
F_91 ( V_2 , V_104 , V_90 , V_39 -> V_37 ) ;
}
static enum V_109
F_93 ( struct V_110 * V_111 , int V_41 ,
struct V_112 * V_18 )
{
struct V_92 * V_113 ;
...
V_29 = F_94 ( V_18 , struct V_117 , V_30 . V_18 ) ;
if ( ! F_95 ( V_115 , L_38 , F_24 ( & V_29 -> V_30 ) ) )
goto V_119;
if ( ! F_96 ( V_115 , V_113 -> V_101 , V_41 | V_120 ) )
goto V_119;
if ( ! F_97 ( V_115 , L_39 ) )
goto V_119;
V_57 = ( V_102 * ) & V_113 [ 1 ] ;
for ( V_34 = 0 ; V_34 < V_29 -> V_35 ; V_34 ++ )
if ( ! V_29 -> args [ V_34 ] . type -> V_121 ( V_115 , V_29 -> args [ V_34 ] . V_11 ,
...
static enum V_109
F_98 ( struct V_110 * V_111 , int V_41 ,
struct V_112 * V_18 )
{
struct V_105 * V_113 ;
struct V_114 * V_115 = & V_111 -> V_116 ;
...
if ( ! F_95 ( V_115 , L_38 , F_24 ( & V_29 -> V_30 ) ) )
goto V_119;
if ( ! F_96 ( V_115 , V_113 -> V_107 , V_41 | V_120 ) )
goto V_119;
if ( ! F_97 ( V_115 , L_40 ) )
goto V_119;
if ( ! F_96 ( V_115 , V_113 -> V_106 , V_41 & ~ V_120 ) )
goto V_119;
if ( ! F_97 ( V_115 , L_39 ) )
goto V_119;
V_57 = ( V_102 * ) & V_113 [ 1 ] ;
...
static int F_99 ( struct V_99 * V_100 )
{
int V_22 , V_34 ;
struct V_92 V_113 ;
...
for ( V_34 = 0 ; V_34 < V_2 -> V_29 . V_35 ; V_34 ++ ) {
struct V_68 * V_69 = & V_2 -> V_29 . args [ V_34 ] ;
V_22 = F_101 ( V_100 , V_69 -> type -> V_124 ,
V_69 -> V_11 ,
...
static T_1 void
F_103 ( struct V_1 * V_2 , struct V_89 * V_90 )
{
struct V_99 * V_30 = & V_2 -> V_29 . V_30 ;
struct V_92 * V_93 ;
struct V_127 * V_128 ;
int V_70 , V_129 , V_96 ;
int V_130 ;
V_128 = F_104 ( V_30 -> V_131 ) ;
if ( F_105 ( V_128 ) )
return;
V_96 = F_84 ( & V_2 -> V_29 , V_90 ) ;
V_129 = sizeof( * V_93 ) + V_2 -> V_29 . V_70 + V_96 ;
V_70 = F_106 ( V_129 + sizeof( V_132 ) , sizeof( V_133 ) ) ;
V_70 -= sizeof( V_132 ) ;
V_93 = F_107 ( V_70 , V_30 -> V_18 . type , V_90 , & V_130 ) ;
if ( ! V_93 )
return;
V_93 -> V_101 = ( unsigned long ) V_2 -> V_3 . V_6 . V_14 ;
memset ( & V_93 [ 1 ] , 0 , V_96 ) ;
F_87 ( sizeof( * V_93 ) , & V_2 -> V_29 , V_90 , ( V_102 * ) & V_93 [ 1 ] , V_96 ) ;
F_108 ( V_93 , V_70 , V_130 , 0 , 1 , V_90 , V_128 , NULL ) ;
}
static T_1 void
F_109 ( struct V_1 * V_2 , struct V_103 * V_104 ,
struct V_89 * V_90 )
{
struct V_99 * V_30 = & V_2 -> V_29 . V_30 ;
struct V_105 * V_93 ;
...
static T_1
int V_27 ( struct V_143 * V_6 , struct V_89 * V_90 )
{
...
static T_1
int V_25 ( struct V_103 * V_104 , struct V_89 * V_90 )
{
struct V_1 * V_2 = F_94 ( V_104 -> V_3 , struct V_1 , V_3 ) ;
V_2 -> V_86 ++ ;
if ( V_2 -> V_29 . V_41 & V_42 )
F_92 ( V_2 , V_104 , V_90 ) ;
#ifdef F_111
if ( V_2 -> V_29 . V_41 & V_43 )
F_109 ( V_2 , V_104 , V_90 ) ;
#endif
return 0 ;
}
...
V_30 -> V_31 -> V_147 = F_99 ;
}
if ( F_112 ( & V_2 -> V_29 , F_1 ( V_2 ) ) < 0 )
return - V_23 ;
V_22 = F_113 ( & V_30 -> V_18 ) ;
if ( ! V_22 ) {
F_11 ( V_30 -> V_149 ) ;
return - V_150 ;
}
V_30 -> V_41 = 0 ;
V_30 -> V_31 -> V_151 = F_110 ;
V_30 -> V_57 = V_2 ;
V_22 = F_114 ( V_30 ) ;
if ( V_22 ) {
F_57 ( L_41 ,
...
{
int V_22 ;
V_22 = F_116 ( & V_2 -> V_29 . V_30 ) ;
if ( ! V_22 )
F_11 ( V_2 -> V_29 . V_30 . V_149 ) ;
return V_22 ;
}
static T_6 int F_117 ( void )
{
struct V_152 * V_153 ;
struct V_152 * V_93 ;
if ( F_118 ( & V_154 ) )
...
if ( ! V_153 )
return 0 ;
V_93 = F_120 ( L_42 , 0644 , V_153 ,
NULL , & V_155 ) ;
if ( ! V_93 )
F_43 ( L_43
L_44 ) ;
V_93 = F_120 ( L_45 , 0444 , V_153 ,
NULL , & V_156 ) ;
if ( ! V_93 )
F_43 ( L_43
L_46 ) ;
...
static T_7 int F_121 ( int V_157 , int V_158 , int V_159 ,
int V_160 , int V_161 , int V_162 )
{
return V_157 + V_158 + V_159 + V_160 + V_161 + V_162 ;
}
static struct V_36 *
F_122 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
struct V_36 * V_37 ;
...
static T_6 int F_123 ( void )
{
int V_22 , V_165 = 0 ;
int (* F_124)( int , int , int , int , int , int );
struct V_1 * V_2 ;
struct V_36 * V_37 ;
F_124 = F_121 ;
F_57 ( L_47 ) ;
...
V_22 = F_125 ( L_61 , F_56 ) ;
if ( F_126 ( V_22 ) ) {
F_127 ( L_62 ) ;
V_165 ++ ;
}
V_22 = F_125 ( L_63 , F_56 ) ;
if ( F_126 ( V_22 ) ) {
F_127 ( L_62 ) ;
V_165 ++ ;
}
