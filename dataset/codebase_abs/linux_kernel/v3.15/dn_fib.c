...
if ( V_71 [ V_88 ] )
V_2 -> V_25 = F_22 ( V_71 [ V_88 ] ) ;
if ( V_71 [ V_79 ] ) {
if ( ( V_46 = F_20 ( V_2 , V_71 [ V_79 ] , V_37 ) ) != 0 )
goto V_82;
if ( V_71 [ V_89 ] &&
V_2 -> V_15 -> V_16 != F_33 ( V_71 [ V_89 ] ) )
goto V_77;
if ( V_71 [ V_45 ] &&
...
if ( V_37 -> V_75 == V_90 ) {
if ( ! V_71 [ V_45 ] || V_33 != 1 || V_71 [ V_89 ] )
goto V_77;
V_2 -> V_15 -> V_17 = F_22 ( V_71 [ V_45 ] ) ;
goto V_91;
}
if ( V_78 [ V_37 -> V_75 ] . error ) {
if ( V_71 [ V_45 ] || V_71 [ V_89 ] || V_71 [ V_79 ] )
goto V_77;
goto V_91;
}
if ( V_37 -> V_54 > V_70 )
...
if ( V_2 -> V_25 ) {
if ( V_37 -> V_75 != V_65 || ! V_71 [ V_93 ] ||
V_2 -> V_25 != F_22 ( V_71 [ V_93 ] ) )
...
static inline T_1 F_44 ( struct V_29 * V_71 [] , T_2 V_103 )
{
if ( V_71 [ V_104 ] )
V_103 = F_33 ( V_71 [ V_104 ] ) ;
return V_103 ;
}
static int F_45 ( struct V_105 * V_106 , struct V_72 * V_73 )
{
struct V_107 * V_107 = F_46 ( V_106 -> V_108 ) ;
struct V_109 * V_110 ;
struct V_36 * V_37 = F_47 ( V_73 ) ;
struct V_29 * V_71 [ V_111 + 1 ] ;
int V_46 ;
if ( ! F_48 ( V_106 , V_112 ) )
return - V_113 ;
if ( ! F_49 ( V_107 , & V_57 ) )
return - V_39 ;
V_46 = F_50 ( V_73 , sizeof( * V_37 ) , V_71 , V_111 , V_114 ) ;
if ( V_46 < 0 )
return V_46 ;
V_110 = F_51 ( F_44 ( V_71 , V_37 -> V_115 ) , 0 ) ;
if ( ! V_110 )
return - V_116 ;
return V_110 -> V_117 ( V_110 , V_37 , V_71 , V_73 , & F_52 ( V_106 ) ) ;
}
static int F_53 ( struct V_105 * V_106 , struct V_72 * V_73 )
{
struct V_107 * V_107 = F_46 ( V_106 -> V_108 ) ;
struct V_109 * V_110 ;
struct V_36 * V_37 = F_47 ( V_73 ) ;
...
if ( V_46 < 0 )
return V_46 ;
V_110 = F_51 ( F_44 ( V_71 , V_37 -> V_115 ) , 1 ) ;
if ( ! V_110 )
return - V_81 ;
return V_110 -> V_118 ( V_110 , V_37 , V_71 , V_73 , & F_52 ( V_106 ) ) ;
}
static void F_54 ( int V_119 , int type , T_3 V_120 , int V_121 , struct V_122 * V_123 )
{
struct V_109 * V_110 ;
struct {
struct V_72 V_73 ;
...
if ( V_110 == NULL )
return;
V_125 . V_73 . V_137 = sizeof( V_125 ) ;
V_125 . V_73 . V_138 = V_119 ;
V_125 . V_73 . V_139 = V_140 | V_141 | V_142 ;
V_125 . V_73 . V_143 = 0 ;
V_125 . V_73 . V_144 = 0 ;
V_125 . V_124 . V_145 = V_121 ;
V_125 . V_124 . V_115 = V_110 -> V_146 ;
V_125 . V_124 . V_83 = V_147 ;
V_125 . V_124 . V_54 = ( type != V_65 ? V_55 : V_70 ) ;
V_125 . V_124 . V_75 = type ;
if ( V_119 == V_148 )
V_110 -> V_118 ( V_110 , & V_125 . V_124 , V_71 , & V_125 . V_73 , NULL ) ;
else
V_110 -> V_117 ( V_110 , & V_125 . V_124 , V_71 , & V_125 . V_73 , NULL ) ;
}
static void F_55 ( struct V_122 * V_123 )
{
F_54 ( V_148 , V_65 , V_123 -> V_130 , 16 , V_123 ) ;
#if 0
if (!(dev->flags&IFF_UP))
return;
#endif
...
F_61 () ;
if ( V_149 == 0 ) {
F_54 ( V_155 , V_65 , V_123 -> V_130 , 16 , V_123 ) ;
if ( F_24 ( V_123 -> V_130 ) != V_65 ) {
if ( F_62 ( V_123 -> V_130 , NULL , 0 ) )
F_63 () ;
}
}
}
static void F_64 ( struct V_52 * V_53 , int V_156 )
{
if ( F_62 ( 0 , V_53 , V_156 ) )
F_63 () ;
F_65 ( 0 ) ;
F_66 ( & V_157 , V_53 ) ;
}
...
case V_162 :
F_55 ( V_123 ) ;
F_68 ( V_123 -> V_133 -> V_53 ) ;
F_65 ( - 1 ) ;
break;
case V_163 :
F_56 ( V_123 ) ;
if ( V_123 -> V_133 && V_123 -> V_133 -> V_153 == NULL ) {
F_64 ( V_123 -> V_133 -> V_53 , 1 ) ;
} else {
F_65 ( - 1 ) ;
}
break;
...
static int F_62 ( T_3 V_165 , struct V_52 * V_53 , int V_156 )
{
int V_166 = 0 ;
int V_67 = V_92 ;
if ( V_156 )
...
F_77 ( V_170 , V_155 , F_45 , NULL , NULL ) ;
}
