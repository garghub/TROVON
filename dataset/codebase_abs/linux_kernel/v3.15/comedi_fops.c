...
V_71 = F_96 ( V_2 , V_22 , V_211 , & V_34 -> V_68 ) ;
if ( V_71 )
goto V_212;
V_71 = V_22 -> V_209 ( V_2 , V_22 , & V_34 -> V_68 ) ;
if ( V_34 -> V_68 . V_59 & V_213 || V_71 ) {
...
V_22 = F_30 ( V_2 , V_7 ) ;
if ( V_22 && V_22 -> V_34 ) {
F_120 ( V_91 , & V_22 -> V_34 -> V_70 , V_263 ) ;
...
V_22 = F_31 ( V_2 , V_7 ) ;
if ( V_22 && V_22 -> V_34 ) {
unsigned int V_266 = F_122 ( V_22 -> V_34 -> V_87 ) ;
F_120 ( V_91 , & V_22 -> V_34 -> V_70 , V_263 ) ;
F_81 ( V_22 -> V_34 , V_22 -> V_34 -> V_45 ) ;
if ( ! V_22 -> V_39 || ! F_50 ( V_22 ) ||
F_123 ( V_22 -> V_34 ) >= V_266 )
V_57 |= V_267 | V_268 ;
}
V_227:
F_19 ( & V_2 -> V_5 ) ;
...
static int F_137 ( int V_291 , struct V_91 * V_91 , int V_292 )
{
struct V_1 * V_2 = V_91 -> V_223 ;
return F_138 ( V_291 , V_91 , V_292 , & V_2 -> V_293 ) ;
}
static int F_139 ( struct V_286 * V_286 , struct V_91 * V_91 )
{
struct V_1 * V_2 = V_91 -> V_223 ;
...
void F_140 ( const struct V_1 * V_2 , const char * V_22 )
{
F_58 ( V_2 -> V_9 , L_41 , V_2 -> V_13 -> V_96 , V_22 ) ;
}
void F_141 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_33 * V_34 = V_22 -> V_34 ;
unsigned V_61 = 0 ;
unsigned V_295 = 0 ;
...
return;
if ( V_22 ->
V_34 -> V_296 & ( V_216 | V_218 |
V_219 ) ) {
V_295 |= V_62 ;
}
if ( V_22 -> V_34 -> V_296 & ( V_218 | V_219 ) ) {
V_295 |= V_63 ;
V_61 |= V_63 ;
}
if ( V_295 ) {
...
if ( V_34 -> V_215 & V_22 -> V_34 -> V_296 ) {
F_142 ( & V_34 -> V_70 ) ;
if ( V_22 -> V_28 & V_29 )
F_143 ( & V_2 -> V_293 , V_297 , V_298 ) ;
if ( V_22 -> V_28 & V_31 )
F_143 ( & V_2 -> V_293 , V_297 , V_299 ) ;
}
V_22 -> V_34 -> V_296 = 0 ;
}
struct V_1 * F_144 ( struct V_27 * V_300 )
{
struct V_1 * V_2 ;
struct V_27 * V_46 ;
unsigned V_15 ;
...
V_2 -> V_7 = V_15 ;
V_46 = F_148 ( V_19 , V_300 ,
F_24 ( V_20 , V_15 ) , NULL , L_43 , V_15 ) ;
if ( ! F_98 ( V_46 ) )
V_2 -> V_9 = F_149 ( V_46 ) ;
return V_2 ;
}
static void F_150 ( unsigned V_7 )
{
F_26 ( V_7 >= V_23 ) ;
F_22 ( F_21 ( V_7 ) ) ;
}
void F_151 ( struct V_27 * V_300 )
{
int V_7 ;
struct V_1 * V_2 ;
...
V_15 += V_23 ;
V_22 -> V_7 = V_15 ;
V_46 = F_148 ( V_19 , V_2 -> V_9 ,
F_24 ( V_20 , V_15 ) , NULL , L_45 ,
V_2 -> V_7 , V_22 -> V_44 ) ;
if ( ! F_98 ( V_46 ) )
V_22 -> V_9 = V_46 ;
return 0 ;
...
V_36 = F_157 ( F_24 ( V_20 , 0 ) ,
V_302 , L_49 ) ;
if ( V_36 )
return - V_189 ;
F_158 ( & V_304 , & V_305 ) ;
V_304 . V_306 = V_307 ;
F_159 ( & V_304 . V_308 , L_49 ) ;
if ( F_160 ( & V_304 , F_24 ( V_20 , 0 ) , V_302 ) ) {
F_161 ( F_24 ( V_20 , 0 ) ,
V_302 ) ;
return - V_189 ;
}
V_19 = F_162 ( V_307 , L_49 ) ;
if ( F_98 ( V_19 ) ) {
F_147 ( L_50 ) ;
F_163 ( & V_304 ) ;
F_161 ( F_24 ( V_20 , 0 ) ,
