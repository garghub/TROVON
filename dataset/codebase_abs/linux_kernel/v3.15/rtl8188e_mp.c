...
for ( V_37 = 0 ; V_37 < V_40 ; V_37 ++ ) {
if ( V_7 -> V_15 . V_57 ) {
if ( ! memcmp ( ( void * ) & V_50 , ( void * ) & V_42 [ V_37 ] [ 2 ] , 4 ) ) {
V_52 = ( T_2 ) V_37 ;
break;
}
} else {
if ( ! memcmp ( ( void * ) & V_50 , ( void * ) & V_41 [ V_37 ] [ 2 ] , 4 ) ) {
V_52 = ( T_2 ) V_37 ;
break;
}
}
...
V_51 = 32 ;
if ( ! V_7 -> V_15 . V_57 ) {
F_15 ( V_20 , 0xa22 , V_41 [ V_51 ] [ 0 ] ) ;
F_15 ( V_20 , 0xa23 , V_41 [ V_51 ] [ 1 ] ) ;
F_15 ( V_20 , 0xa24 , V_41 [ V_51 ] [ 2 ] ) ;
F_15 ( V_20 , 0xa25 , V_41 [ V_51 ] [ 3 ] ) ;
F_15 ( V_20 , 0xa26 , V_41 [ V_51 ] [ 4 ] ) ;
F_15 ( V_20 , 0xa27 , V_41 [ V_51 ] [ 5 ] ) ;
F_15 ( V_20 , 0xa28 , V_41 [ V_51 ] [ 6 ] ) ;
F_15 ( V_20 , 0xa29 , V_41 [ V_51 ] [ 7 ] ) ;
} else {
F_15 ( V_20 , 0xa22 , V_42 [ V_51 ] [ 0 ] ) ;
F_15 ( V_20 , 0xa23 , V_42 [ V_51 ] [ 1 ] ) ;
F_15 ( V_20 , 0xa24 , V_42 [ V_51 ] [ 2 ] ) ;
F_15 ( V_20 , 0xa25 , V_42 [ V_51 ] [ 3 ] ) ;
F_15 ( V_20 , 0xa26 , V_42 [ V_51 ] [ 4 ] ) ;
F_15 ( V_20 , 0xa27 , V_42 [ V_51 ] [ 5 ] ) ;
F_15 ( V_20 , 0xa28 , V_42 [ V_51 ] [ 6 ] ) ;
F_15 ( V_20 , 0xa29 , V_42 [ V_51 ] [ 7 ] ) ;
}
}
}
void F_16 ( struct V_1 * V_20 )
{
struct V_4 * V_5 = F_2 ( V_20 ) ;
struct V_21 * V_22 = & V_20 -> V_23 ;
struct V_6 * V_7 = & ( V_5 -> V_8 ) ;
...
F_17 ( V_20 , V_58 , V_61 , 0x3FF , V_59 ) ;
F_7 ( V_20 ) ;
F_18 ( V_20 , V_59 ) ;
...
void F_19 ( struct V_1 * V_20 )
{
struct V_21 * V_22 = & V_20 -> V_23 ;
F_20 ( V_20 , V_22 -> V_63 , V_22 -> V_64 ) ;
F_7 ( V_20 ) ;
}
void F_21 ( struct V_1 * V_20 , T_2 * V_65 )
{
T_3 V_66 = 0 ;
...
V_112 = 0x3 ;
if ( V_5 -> V_123 == V_124 ) {
F_27 ( V_20 , V_125 , V_126 , 0 ) ;
F_27 ( V_20 , V_125 , V_127 , 1 ) ;
F_27 ( V_20 , V_128 , V_126 , 0 ) ;
F_27 ( V_20 , V_129 , V_130 , 1 ) ;
F_27 ( V_20 , V_129 , V_131 , 0 ) ;
}
break;
case V_93 :
V_104 -> V_116 = 0x2 ;
...
V_106 -> V_120 = 0x4 ;
V_109 = 1 ;
F_27 ( V_20 , V_121 , 0xe , 1 ) ;
F_27 ( V_20 , V_122 , 0xe , 2 ) ;
if ( V_5 -> V_123 == V_124 || V_5 -> V_123 == V_132 ) {
F_27 ( V_20 , V_125 , V_126 , 1 ) ;
F_27 ( V_20 , V_133 , V_126 , 0 ) ;
F_27 ( V_20 , V_125 , V_127 , 0 ) ;
F_27 ( V_20 , V_129 , V_130 , 0 ) ;
F_27 ( V_20 , V_129 , V_131 , 1 ) ;
}
break;
case V_134 :
V_104 -> V_116 = 0x3 ;
...
case V_98 :
case V_99 :
F_27 ( V_20 , V_138 , 0x7fffffff , V_111 ) ;
F_27 ( V_20 , V_139 , 0x0000000f , V_112 ) ;
F_27 ( V_20 , V_140 , 0x0000000f , V_107 ) ;
F_27 ( V_20 , V_141 , 0x0000000f , V_107 ) ;
F_27 ( V_20 , V_142 , V_143 , V_108 ) ;
break;
default:
break;
}
...
T_1 F_28 ( struct V_1 * V_20 , T_2 V_144 )
{
struct V_4 * V_5 = F_2 ( V_20 ) ;
if ( ! F_3 ( V_20 -> V_9 ) ) {
F_4 ( V_10 , V_11 , ( L_5 ) ) ;
...
void F_29 ( struct V_1 * V_20 )
{
F_17 ( V_20 , V_26 , V_146 , V_131 | V_147 , 0x03 ) ;
}
T_2 F_30 ( struct V_1 * V_20 )
{
T_3 V_148 = 0 ;
V_148 = F_31 ( V_20 , V_26 , V_146 , 0xfc00 ) ;
return ( T_2 ) V_148 ;
}
void F_32 ( struct V_1 * V_20 , T_2 * V_149 )
{
F_29 ( V_20 ) ;
F_33 ( 1000 ) ;
* V_149 = F_30 ( V_20 ) ;
}
void F_34 ( struct V_1 * V_20 , T_2 V_150 )
{
...
F_27 ( V_20 , V_153 , V_173 , 0x0 ) ;
F_27 ( V_20 , V_153 , V_154 , 0x0 ) ;
if ( V_168 ) {
F_17 ( V_20 , V_26 , 0x21 , V_174 , 0x01 ) ;
F_33 ( 1 ) ;
if ( V_88 == V_26 )
F_36 ( V_20 , V_29 , 0x00 , 0x10000 ) ;
else if ( V_88 == V_29 )
F_36 ( V_20 , V_26 , 0x00 , 0x10000 ) ;
F_36 ( V_20 , V_88 , 0x00 , 0x2001f ) ;
F_33 ( 1 ) ;
} else {
F_36 ( V_20 , V_88 , 0x21 , 0xd4000 ) ;
F_33 ( 1 ) ;
F_36 ( V_20 , V_88 , 0x00 , 0x2001f ) ;
F_33 ( 1 ) ;
}
...
if ( V_168 ) {
F_17 ( V_20 , V_26 , 0x21 , V_174 , 0x00 ) ;
F_33 ( 1 ) ;
F_36 ( V_20 , V_26 , 0x00 , 0x32d75 ) ;
F_36 ( V_20 , V_29 , 0x00 , 0x32d75 ) ;
F_33 ( 1 ) ;
} else {
F_36 ( V_20 , V_88 , 0x21 , 0x54000 ) ;
F_33 ( 1 ) ;
F_36 ( V_20 , V_88 , 0x00 , 0x30000 ) ;
F_33 ( 1 ) ;
}
F_12 ( V_20 , V_164 , V_44 , 0x01000100 ) ;
F_12 ( V_20 , V_165 , V_44 , 0x01000100 ) ;
...
void F_37 ( struct V_1 * V_20 , T_2 V_150 )
{
...
void F_38 ( struct V_1 * V_20 , T_2 V_150 )
{
T_3 V_178 ;
if ( V_150 ) {
F_4 ( V_10 , V_152 ,
...
void F_39 ( struct V_1 * V_20 , T_2 V_150 )
{
if ( V_150 ) {
F_4 ( V_10 , V_179 , ( L_15 ) ) ;
if ( ! F_11 ( V_20 , V_153 , V_154 ) )
