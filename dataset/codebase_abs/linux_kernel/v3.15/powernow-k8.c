...
if ( ! V_10 -> V_97 . V_98 )
return;
V_96 = V_10 -> V_97 . V_99 [ V_95 ] . V_96 ;
V_10 -> V_16 = ( V_96 >> V_100 ) & V_101 ;
V_10 -> V_35 = ( V_96 >> V_102 ) & V_103 ;
V_10 -> V_104 = ( V_96 >> V_105 ) & V_106 ;
V_10 -> V_27 = ( V_96 >> V_107 ) & V_108 ;
V_10 -> V_39 = 1 << ( ( V_96 >> V_109 ) & V_110 ) ;
V_10 -> V_17 = ( V_96 >> V_111 ) & V_112 ;
}
...
V_96 = V_10 -> V_97 . V_116 . V_117 ;
V_114 = V_10 -> V_97 . V_118 . V_117 ;
if ( ( V_96 != V_119 ) ||
( V_114 != V_119 ) ) {
F_9 ( L_84 ,
V_96 , V_114 ) ;
...
V_70 = F_31 ( ( sizeof( * V_70 )
* ( V_10 -> V_97 . V_98 + 1 ) ) , V_75 ) ;
if ( ! V_70 ) {
F_9 ( L_60 ) ;
goto V_115;
}
V_10 -> V_65 = V_10 -> V_97 . V_98 ;
F_36 ( V_10 , 0 ) ;
V_113 = F_39 ( V_10 , V_70 ) ;
if ( V_113 )
goto V_120;
V_70 [ V_10 -> V_97 . V_98 ] . V_72 =
V_79 ;
V_10 -> V_70 = V_70 ;
if ( F_33 ( F_1 ( V_10 -> V_2 ) ) == V_10 -> V_2 )
F_29 ( V_10 ) ;
F_40 ( V_121 ) ;
if ( ! F_41 ( & V_10 -> V_97 . V_122 , V_75 ) ) {
F_17 (KERN_ERR PFX
L_85 ) ;
V_113 = - V_76 ;
goto V_120;
...
{
int V_11 ;
for ( V_11 = 0 ; V_11 < V_10 -> V_97 . V_98 ; V_11 ++ ) {
T_1 V_3 ;
T_1 V_19 ;
T_1 V_77 , V_95 ;
T_3 V_114 , V_96 ;
if ( V_10 -> V_104 ) {
V_114 = V_10 -> V_97 . V_99 [ V_11 ] . V_114 ;
V_3 = V_114 & V_123 ;
V_19 = ( V_114 >> V_124 ) & V_125 ;
} else {
V_96 = V_10 -> V_97 . V_99 [ V_11 ] . V_96 ;
V_3 = V_96 & V_126 ;
V_19 = ( V_96 >> V_124 ) & V_127 ;
}
...
if ( V_77 != ( V_10 -> V_97 . V_99 [ V_11 ] . V_131 * 1000 ) ) {
...
int V_11 ;
for ( V_11 = 0 ; V_11 < V_10 -> V_97 . V_98 ; V_11 ++ ) {
int V_133 = V_10 -> V_97 . V_99 [ V_11 ] . V_134
+ V_10 -> V_97 . V_99 [ V_11 ] . V_135 ;
if ( V_133 > V_132 )
V_132 = V_133 ;
}
if ( V_132 == 0 ) {
...
struct V_139 V_140 ;
F_9 ( L_92 , F_14 () , V_95 ) ;
V_3 = V_10 -> V_70 [ V_95 ] . V_78 & 0xFF ;
V_19 = ( V_10 -> V_70 [ V_95 ] . V_78 & 0xFF00 ) >> 8 ;
F_9 ( L_93 , V_3 , V_19 ) ;
if ( F_8 ( V_10 ) )
return 1 ;
...
F_9 ( L_95 ,
F_14 () , V_3 , V_19 ) ;
V_140 . V_141 = F_4 ( V_10 -> V_14 ) ;
V_140 . V_142 = F_4 ( V_3 ) ;
V_137 = F_48 ( F_14 () ) ;
F_49 ( V_137 ) ;
F_50 ( V_137 , & V_140 ) ;
V_138 = F_20 ( V_10 , V_3 , V_19 ) ;
F_51 ( V_137 , & V_140 , V_138 ) ;
return V_138 ;
}
static long F_52 ( void * V_143 )
{
struct V_144 * V_145 = V_143 ;
struct V_136 * V_146 = V_145 -> V_146 ;
unsigned V_147 = V_145 -> V_147 ;
struct V_9 * V_10 = F_53 ( V_148 , V_146 -> V_2 ) ;
T_1 V_149 ;
T_1 V_150 ;
int V_151 ;
if ( ! V_10 )
...
F_9 ( L_97 ,
V_146 -> V_2 , V_10 -> V_70 [ V_147 ] . V_72 , V_146 -> V_152 ,
V_146 -> V_153 ) ;
if ( F_8 ( V_10 ) )
return - V_80 ;
F_9 ( L_98 ,
...
F_56 ( & V_155 ) ;
V_146 -> V_156 = F_4 ( V_10 -> V_14 ) ;
return 0 ;
}
static int F_57 ( struct V_136 * V_146 , unsigned V_95 )
{
struct V_144 V_145 = { . V_146 = V_146 , . V_147 = V_95 } ;
return F_58 ( V_146 -> V_2 , F_52 , & V_145 ) ;
}
static void F_59 ( void * V_157 )
{
...
static int F_60 ( struct V_136 * V_146 )
{
struct V_9 * V_10 ;
struct V_158 V_158 ;
int V_50 , V_2 ;
F_61 ( V_146 -> V_2 , F_24 , & V_50 , 1 ) ;
if ( V_50 )
return - V_51 ;
V_10 = F_31 ( sizeof( * V_10 ) , V_75 ) ;
if ( ! V_10 ) {
...
if ( V_50 != 0 )
goto V_161;
F_64 ( V_146 -> V_162 , F_1 ( V_146 -> V_2 ) ) ;
V_10 -> V_163 = V_146 -> V_162 ;
if ( F_65 ( V_146 , V_10 -> V_70 ) ) {
F_17 (KERN_ERR FW_BUG PFX L_106 ) ;
F_43 ( V_10 ) ;
F_32 ( V_10 -> V_70 ) ;
F_32 ( V_10 ) ;
return - V_67 ;
...
static int F_67 ( struct V_136 * V_146 )
{
struct V_9 * V_10 = F_53 ( V_148 , V_146 -> V_2 ) ;
int V_2 ;
if ( ! V_10 )
...
static void F_68 ( void * V_164 )
{
int * V_165 = V_164 ;
struct V_9 * V_10 = F_69 ( V_148 ) ;
* V_165 = F_8 ( V_10 ) ;
}
static unsigned int F_70 ( unsigned int V_2 )
{
struct V_9 * V_10 = F_53 ( V_148 , V_2 ) ;
unsigned int V_166 = 0 ;
int V_165 ;
if ( ! V_10 )
return 0 ;
F_61 ( V_2 , F_68 , & V_165 , true ) ;
if ( V_165 )
goto V_167;
V_166 = F_4 ( V_10 -> V_14 ) ;
V_167:
...
{
const char * V_168 , * V_169 = L_108 ;
V_168 = F_72 () ;
if ( ! V_168 )
goto V_170;
if ( strncmp ( V_168 , V_169 , F_73 ( V_171 , strlen ( V_168 ) , strlen ( V_169 ) ) ) )
F_74 ( V_154 L_109 , V_168 ) ;
return;
V_170:
F_74 ( V_154 L_110 ) ;
F_75 ( V_169 ) ;
...
if ( V_151 )
return V_151 ;
F_54 ( V_154 L_111 V_176 L_112 ,
F_83 () , V_177 . V_178 , V_172 ) ;
return V_151 ;
}
