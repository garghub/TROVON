...
T_1 V_5 , V_52 , V_53 ;
void * V_13 ;
unsigned long V_54 , V_25 , V_55 , V_56 ;
int V_34 , V_57 ;
F_25 ( & F_2 ( V_3 ) -> V_36 ) ;
V_34 = F_11 ( V_3 , & V_17 ) ;
if ( V_34 < 0 )
...
int F_48 ( struct V_2 * V_3 , struct V_69 * V_70 )
{
struct V_11 * V_17 ;
struct V_20 * V_21 ;
...
int F_58 ( struct V_2 * V_3 , T_1 V_93 )
{
struct V_71 * V_72 = V_3 -> V_73 -> V_74 ;
struct V_11 * V_17 ;
struct V_20 * V_21 ;
...
T_5 F_61 ( struct V_2 * V_3 , T_1 V_5 , void * V_95 ,
unsigned V_96 , T_3 V_97 )
{
struct V_11 * V_49 ;
struct V_10 * V_50 ;
...
V_99 -> V_102 = F_56 ( V_50 -> V_64 ) ;
V_99 -> V_103 = F_56 ( V_50 -> V_62 ) &
~ ( 1UL << V_104 ) ;
if ( F_57 ( V_72 , V_5 + V_57 ) )
V_99 -> V_103 |=
( 1UL << V_104 ) ;
}
F_19 ( V_13 ) ;
...
T_5 F_62 ( struct V_2 * V_3 , void * V_95 ,
unsigned V_105 , T_3 V_106 )
{
struct V_71 * V_72 = V_3 -> V_73 -> V_74 ;
struct V_11 * V_17 , * V_12 ;
...
if ( F_64 ( V_108 ) )
V_50 -> V_65 = F_36 ( V_108 -> V_119 . V_101 ) ;
if ( F_63 ( V_108 ) )
V_50 -> V_64 = F_40 ( V_108 -> V_119 . V_102 ) ;
if ( F_65 ( V_108 ) ) {
V_108 -> V_119 . V_103 &=
~ ( 1UL << V_104 ) ;
V_110 = F_66 ( & V_108 -> V_119 ) ;
V_111 = F_34 ( V_50 ) ;
V_112 = F_67 ( & V_108 -> V_119 ) ;
V_113 = F_41 ( V_50 ) ;
if ( V_110 && ! V_111 )
++ V_88 ;
else if ( ! V_110 && V_111 )
...
-- V_114 ;
V_50 -> V_62 = F_40 ( V_108 -> V_119 . V_103 ) ;
}
F_19 ( V_13 ) ;
...
int F_69 ( struct V_2 * V_3 , struct V_122 * V_123 )
{
struct V_71 * V_72 = V_3 -> V_73 -> V_74 ;
struct V_11 * V_49 ;
struct V_10 * V_50 ;
...
int F_74 ( struct V_138 * V_139 , T_3 V_140 ,
...
V_3 = F_75 ( V_139 , NULL , V_148 ) ;
if ( F_24 ( ! V_3 ) )
return - V_149 ;
if ( ! ( V_3 -> V_150 & V_151 ) )
goto V_35;
V_144 = F_76 ( V_3 , V_152 , sizeof( * V_44 ) ) ;
if ( V_144 )
goto V_153;
F_77 ( V_3 , V_140 ,
sizeof( struct V_20 ) ) ;
V_144 = F_78 ( V_3 , V_142 ) ;
if ( V_144 )
goto V_153;
V_144 = F_11 ( V_3 , & V_17 ) ;
if ( V_144 )
