...
static int F_181 ( struct V_347 * V_145 )
{
...
F_189 ( & V_2 -> V_357 ) ;
F_189 ( & V_2 -> V_358 ) ;
V_2 -> V_171 . V_359 = F_28 ;
V_2 -> V_171 . V_360 = F_27 ;
V_2 -> V_171 . V_361 = F_23 ;
V_2 -> V_171 . V_362 = F_25 ;
V_2 -> V_171 . V_363 = F_30 ;
V_2 -> V_171 . V_364 = F_29 ;
V_2 -> V_51 . V_365 =
V_2 -> V_51 . V_366 = ( 0x01 |
0x10 |
0x20 ) ;
...
V_2 -> V_367 = F_194 ( V_156 , 2 ) ;
V_2 -> V_368 = F_194 ( V_156 , 3 ) ;
if ( F_195 ( V_156 -> V_61 , F_45 , V_369 ,
V_370 , V_2 ) ) {
...
V_46 = F_196 ( V_49 , V_371 , V_2 , & V_52 ) ;
if ( V_46 < 0 ) {
F_175 ( V_2 ) ;
return V_46 ;
}
...
static int F_197 ( struct V_349 * V_156 ,
...
V_46 = F_198 ( & V_156 -> V_50 , V_192 [ V_50 ] , V_198 [ V_50 ] , V_379 ,
0 , & V_49 ) ;
if ( V_46 < 0 )
return V_46 ;
strcpy ( V_49 -> V_380 , L_70 ) ;
strcpy ( V_49 -> V_381 , L_72 ) ;
V_46 = F_182 ( V_49 , V_156 , V_306 [ V_50 ] , V_350 [ V_50 ] ,
...
V_2 -> V_382 = V_299 ;
strcpy ( V_49 -> V_381 , V_299 -> V_154 ) ;
if ( V_299 -> V_380 )
strcpy ( V_49 -> V_380 , V_299 -> V_380 ) ;
if ( V_299 -> V_383 ) {
V_46 = V_299 -> V_383 ( V_2 ) ;
if ( V_46 < 0 ) {
F_199 ( V_49 ) ;
return V_46 ;
}
...
V_299 = & V_385 ;
V_384:
V_46 = F_105 ( V_2 , V_374 ++ , NULL ) ;
if ( V_46 < 0 ) {
F_199 ( V_49 ) ;
return V_46 ;
}
if ( F_120 ( V_2 ) ) {
V_46 = F_77 ( V_2 , V_374 ++ , NULL ) ;
if ( V_46 < 0 ) {
F_199 ( V_49 ) ;
return V_46 ;
}
...
L_73 , V_299 -> V_393 , V_49 -> V_98 ) ;
if ( V_2 -> V_226 . V_8 [ V_238 ] & V_327 ) {
V_46 = F_200 ( V_49 , 1 , V_388 ,
F_12 ( V_2 , V_394 ) ,
V_299 -> V_395 |
V_391 | V_392 ,
- 1 , & V_2 -> V_67 [ 1 ] ) ;
...
static void F_203 ( struct V_349 * V_156 )
{
...
F_21 ( & V_2 -> V_34 ) ;
V_2 -> V_400 = F_1 ( V_2 ) ;
V_2 -> V_401 = F_15 ( F_3 ( V_2 , V_252 ) ) ;
V_2 -> V_402 = F_15 ( F_3 ( V_2 , V_250 ) ) ;
F_22 ( & V_2 -> V_34 ) ;
if ( V_2 -> V_403 )
V_2 -> V_403 ( V_2 ) ;
F_179 ( V_156 ) ;
...
F_13 ( V_2 -> V_401 , F_3 ( V_2 , V_252 ) ) ;
F_13 ( V_2 -> V_402 , F_3 ( V_2 , V_250 ) ) ;
if ( V_2 -> V_12 )
F_216 ( V_2 -> V_12 ) ;
F_208 ( V_49 , V_407 ) ;
return 0 ;
