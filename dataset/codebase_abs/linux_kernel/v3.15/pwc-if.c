...
static int F_62 ( struct V_63 * V_64 , const struct V_131 * V_132 )
{
...
V_138 = 0 ;
memset ( V_140 , 0 , 30 ) ;
F_66 ( V_60 , V_60 -> V_142 . V_148 , V_140 , 29 ) ;
F_64 ( L_104 , V_140 ) ;
...
F_74 ( V_170 , & V_3 -> V_166 . V_4 ) ;
F_75 ( & V_3 -> V_166 , V_3 ) ;
V_3 -> V_171 = F_24 ( V_60 -> V_142 . V_172 ) ;
F_64 ( L_108 , V_3 -> V_171 ) ;
V_3 -> V_107 = F_76 ( sizeof( V_3 -> V_173 ) , V_87 ) ;
if ( ! V_3 -> V_107 ) {
F_17 ( L_106 ) ;
V_136 = - V_88 ;
goto V_165;
...
V_136 = F_80 ( & V_64 -> V_91 , & V_3 -> V_105 ) ;
if ( V_136 ) {
F_17 ( L_111 , V_136 ) ;
goto V_175;
}
...
V_136 = F_81 ( & V_3 -> V_166 , V_176 , - 1 ) ;
if ( V_136 < 0 ) {
F_17 ( L_112 , V_136 ) ;
goto V_177;
}
F_65 ( L_113 , F_82 ( & V_3 -> V_166 ) ) ;
#ifdef F_9
V_3 -> V_12 = F_83 () ;
if ( ! V_3 -> V_12 ) {
V_136 = - V_88 ;
...
F_84 ( V_60 , V_3 -> V_179 , sizeof( V_3 -> V_179 ) ) ;
F_85 ( V_3 -> V_179 , L_114 , sizeof( V_3 -> V_179 ) ) ;
V_3 -> V_12 -> V_141 = L_115 ;
V_3 -> V_12 -> V_180 = V_3 -> V_179 ;
F_86 ( V_3 -> V_60 , & V_3 -> V_12 -> V_132 ) ;
V_3 -> V_12 -> V_91 . V_181 = & V_3 -> V_60 -> V_91 ;
V_3 -> V_12 -> V_182 [ 0 ] = F_87 ( V_183 ) ;
V_3 -> V_12 -> V_184 [ F_88 ( V_13 ) ] = F_87 ( V_13 ) ;
V_136 = F_89 ( V_3 -> V_12 ) ;
if ( V_136 ) {
F_90 ( V_3 -> V_12 ) ;
V_3 -> V_12 = NULL ;
