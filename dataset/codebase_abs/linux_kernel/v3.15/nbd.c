...
case V_3 :
V_32 -> V_146 = V_38 ;
V_32 -> V_147 &= ~ ( V_32 -> V_146 - 1 ) ;
V_139 -> V_148 -> V_149 = V_32 -> V_147 ;
F_86 ( V_139 , V_32 -> V_146 ) ;
F_87 ( V_32 -> V_36 , V_32 -> V_147 >> 9 ) ;
return 0 ;
case V_4 :
V_32 -> V_147 = V_38 & ~ ( V_32 -> V_146 - 1 ) ;
V_139 -> V_148 -> V_149 = V_32 -> V_147 ;
F_86 ( V_139 , V_32 -> V_146 ) ;
F_87 ( V_32 -> V_36 , V_32 -> V_147 >> 9 ) ;
return 0 ;
case V_5 :
V_32 -> V_75 = V_38 * V_150 ;
return 0 ;
case V_6 :
V_32 -> V_26 = V_38 ;
return 0 ;
case V_11 :
V_32 -> V_147 = ( ( V_94 ) V_38 ) * V_32 -> V_146 ;
V_139 -> V_148 -> V_149 = V_32 -> V_147 ;
F_86 ( V_139 , V_32 -> V_146 ) ;
F_87 ( V_32 -> V_36 , V_32 -> V_147 >> 9 ) ;
return 0 ;
...
V_32 -> V_36 -> V_153 ) ;
if ( V_32 -> V_26 & V_154 )
F_90 ( V_32 -> V_36 -> V_153 , V_136 ) ;
else
F_90 ( V_32 -> V_36 -> V_153 , 0 ) ;
V_151 = F_91 ( F_71 , V_32 , L_47 ,
V_32 -> V_36 -> V_29 ) ;
if ( F_53 ( V_151 ) ) {
F_9 ( & V_32 -> V_34 ) ;
return F_54 ( V_151 ) ;
...
F_80 ( F_11 ( V_32 -> V_36 ) ,
L_49 ,
V_32 -> V_126 . V_127 , V_32 -> V_126 . V_156 ,
& V_32 -> V_126 ) ;
return 0 ;
}
return - V_157 ;
}
static int F_96 ( struct V_138 * V_139 , T_4 V_158 ,
unsigned int V_1 , unsigned long V_38 )
{
struct V_31 * V_32 = V_139 -> V_159 -> V_122 ;
int error ;
if ( ! F_97 ( V_160 ) )
return - V_161 ;
F_58 ( V_32 -> V_90 != V_124 ) ;
...
V_167 = F_100 ( V_168 , sizeof( * V_167 ) , V_169 ) ;
if ( ! V_167 )
return - V_163 ;
V_165 = 0 ;
if ( V_144 > 0 ) {
...
if ( ( 1UL << V_165 ) > V_170 )
return - V_59 ;
if ( V_168 > 1UL << ( V_171 - V_165 ) )
return - V_59 ;
for ( V_164 = 0 ; V_164 < V_168 ; V_164 ++ ) {
struct V_121 * V_36 = F_102 ( 1 << V_165 ) ;
if ( ! V_36 )
goto V_106;
V_167 [ V_164 ] . V_36 = V_36 ;
V_36 -> V_153 = F_103 ( F_76 , & V_172 ) ;
if ( ! V_36 -> V_153 ) {
F_104 ( V_36 ) ;
goto V_106;
}
F_89 ( V_173 , V_36 -> V_153 ) ;
V_36 -> V_153 -> V_174 . V_175 = 512 ;
V_36 -> V_153 -> V_174 . V_176 = V_177 ;
V_36 -> V_153 -> V_174 . V_178 = 0 ;
F_105 ( V_36 -> V_153 , 65536 ) ;
V_36 -> V_153 -> V_174 . V_179 = 256 ;
}
if ( F_106 ( V_180 , L_52 ) ) {
V_103 = - V_23 ;
goto V_106;
}
F_15 ( V_181 L_53 , V_180 ) ;
F_4 ( V_182 , L_54 , V_183 ) ;
for ( V_164 = 0 ; V_164 < V_168 ; V_164 ++ ) {
struct V_121 * V_36 = V_167 [ V_164 ] . V_36 ;
V_167 [ V_164 ] . V_90 = V_124 ;
F_107 ( & V_167 [ V_164 ] . V_128 ) ;
F_108 ( & V_167 [ V_164 ] . V_30 ) ;
F_107 ( & V_167 [ V_164 ] . V_126 ) ;
F_109 ( & V_167 [ V_164 ] . V_34 ) ;
F_110 ( & V_167 [ V_164 ] . V_104 ) ;
F_110 ( & V_167 [ V_164 ] . V_137 ) ;
V_167 [ V_164 ] . V_146 = 1024 ;
V_167 [ V_164 ] . V_147 = 0 ;
V_36 -> V_184 = V_180 ;
V_36 -> V_185 = V_164 << V_165 ;
V_36 -> V_186 = & V_187 ;
V_36 -> V_122 = & V_167 [ V_164 ] ;
sprintf ( V_36 -> V_29 , L_55 , V_164 ) ;
F_87 ( V_36 , 0 ) ;
F_111 ( V_36 ) ;
}
return 0 ;
V_106:
while ( V_164 -- ) {
F_112 ( V_167 [ V_164 ] . V_36 -> V_153 ) ;
F_104 ( V_167 [ V_164 ] . V_36 ) ;
}
F_113 ( V_167 ) ;
return V_103 ;
}
