...
static T_6 F_92 ( struct V_31 * V_32 , int V_144 )
{
struct V_56 * V_54 = V_32 -> V_19 -> V_54 ;
int V_145 = V_32 -> V_62 + V_144 ;
if ( V_145 >= V_54 -> V_127 )
V_145 = 0 ;
return V_32 -> V_76 + F_33 ( V_54 , V_145 * V_32 -> V_60 ) ;
}
...
{
struct V_31 * V_32 = F_96 ( V_147 , struct V_31 , V_147 ) ;
struct V_13 * V_14 = F_31 ( V_32 ) ;
struct V_22 * V_27 ;
struct V_148 * V_149 ;
struct V_56 * V_54 ;
...
V_150 = F_33 ( V_54 , V_32 -> V_60 ) ;
for ( V_121 = 0 ; V_121 < V_32 -> V_142 ; V_121 ++ ) {
V_122 = F_92 ( V_32 , V_32 -> V_143 ) ;
F_97 ( V_27 -> V_66 , V_122 , V_150 , V_139 ) ;
V_149 = F_98 ( V_32 -> V_151 , V_122 , V_150 , V_139 ,
V_152 | V_153 ) ;
if ( ! V_149 ) {
F_36 ( V_27 -> V_66 , L_29 ) ;
return;
...
F_62 ( V_14 , V_156 , V_157 , V_157 ) ;
F_28 ( V_14 , V_45 , 0 ) ;
}
}
}
static int F_101 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
F_102 ( & V_32 -> V_147 ) ;
return 0 ;
}
static int F_103 ( struct V_13 * V_14 , struct V_31 * V_32 ,
int V_158 )
{
struct V_5 * V_6 = F_11 ( V_14 ) ;
T_1 V_109 = F_13 ( V_14 ) ? V_131 : V_132 ;
T_1 V_92 = V_158 ? V_159 : 0 ;
F_62 ( V_14 , V_85 , V_159 , V_92 ) ;
F_104 ( V_32 -> V_151 ) ;
if ( F_12 ( V_14 ) )
F_82 ( V_6 , V_133 , V_109 , ( V_92 ) ? V_109 : 0 ) ;
return 0 ;
}
static int F_105 ( struct V_13 * V_14 , struct V_31 * V_32 , struct V_70 * V_66 )
{
T_7 V_3 ;
int V_33 = F_22 ( V_14 , V_32 ) ;
F_106 ( V_3 ) ;
F_107 ( V_160 , V_3 ) ;
V_32 -> V_151 = F_108 ( V_3 ,
V_161 , ( void * ) V_32 -> V_162 ,
V_66 , V_33 ? L_31 : L_32 ) ;
if ( V_32 -> V_151 ) {
struct V_163 V_164 ;
int V_7 ;
V_164 . V_165 = V_32 -> V_162 ;
V_164 . V_166 = 0 ;
V_164 . V_167 = 0 ;
V_164 . V_168 = V_33 ? V_169 : V_170 ;
V_7 = F_109 ( V_32 -> V_151 , & V_164 ) ;
if ( V_7 < 0 ) {
F_110 ( V_32 -> V_151 ) ;
V_32 -> V_151 = NULL ;
}
...
if ( ! V_32 -> V_151 ) {
if ( V_33 )
V_14 -> V_49 . V_171 = & V_172 ;
else
V_14 -> V_53 . V_171 = & V_173 ;
F_111 ( V_66 , L_33 ) ;
return F_38 ( V_14 , V_66 ) ;
}
F_112 ( & V_32 -> V_147 , F_95 ) ;
return 0 ;
}
static int F_113 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
F_114 ( & V_32 -> V_147 ) ;
F_115 ( V_14 , V_32 ) ;
if ( V_32 -> V_151 )
...
T_1 V_35 , V_121 ;
int V_174 ;
V_35 = F_117 ( V_6 , V_175 ) ;
V_35 >>= F_21 ( V_14 , V_32 ) ;
V_35 &= V_176 ;
V_174 = 256 << V_35 ;
F_41 ( V_66 , L_34 , V_174 ) ;
for ( V_121 = 1 ; V_121 < V_14 -> V_41 ; V_121 <<= 1 )
V_174 >>= 1 ;
F_41 ( V_66 , L_35 ,
V_14 -> V_41 , V_174 ) ;
V_32 -> V_130 = F_23 ( V_14 , V_174 ) ;
if ( V_33 ) {
F_28 ( V_14 , V_177 , V_178 ) ;
F_62 ( V_14 , V_177 , V_157 , V_157 ) ;
} else {
F_28 ( V_14 , V_156 , V_178 ) ;
F_62 ( V_14 , V_156 , V_157 , V_157 ) ;
}
}
...
if ( F_12 ( V_14 ) )
V_2 = V_179 | V_180 ;
F_62 ( V_14 , V_106 , ( V_179 | V_180 ) , V_2 ) ;
V_2 = 0 ;
if ( V_14 -> V_181 )
V_2 |= ( 1 << 0 ) ;
if ( V_14 -> V_182 )
...
static int F_123 ( struct V_18 * V_19 , int V_186 ,
struct V_22 * V_27 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
...
static void F_139 ( struct V_209 * V_210 )
{
F_140 ( V_210 ) ;
}
static int F_141 ( struct V_23 * V_24 )
{
struct V_209 * V_210 = V_24 -> V_210 ;
return F_142 (
V_210 ,
V_211 ,
F_143 ( V_212 ) ,
...
for ( V_121 = 0 ; V_121 < F_145 ( V_221 ) ; V_121 ++ ) {
sprintf ( V_220 , L_39 , V_215 , V_221 [ V_121 ] . V_215 ) ;
if ( F_146 ( V_217 , V_220 , NULL ) )
V_8 |= V_221 [ V_121 ] . V_4 ;
}
V_219 -> V_8 = V_8 ;
F_41 ( V_66 , L_40 , V_215 , V_219 -> V_8 ) ;
}
...
V_14 -> V_53 . V_55 = V_14 ;
if ( V_219 -> V_225 ) {
V_14 -> V_49 . V_162 = V_219 -> V_225 ;
V_14 -> V_49 . V_171 = & V_226 ;
}
}
static int F_149 ( struct V_227 * V_228 )
{
struct V_5 * V_6 ;
struct V_216 * V_217 = V_228 -> V_66 . V_229 ;
struct V_230 V_219 ;
const struct V_231 * V_11 ;
struct V_13 * V_14 ;
struct V_232 * V_233 ;
unsigned int V_134 ;
int V_7 ;
...
V_235 = F_150 ( V_236 , & V_228 -> V_66 ) ;
if ( V_235 ) {
V_11 = V_235 -> V_2 ;
F_144 ( L_41 , V_217 , & V_219 . V_237 , & V_228 -> V_66 ) ;
F_144 ( L_42 , V_217 , & V_219 . V_238 , & V_228 -> V_66 ) ;
}
} else {
const struct V_239 * V_240 = V_228 -> V_240 ;
if ( V_240 )
V_11 = (struct V_231 * ) V_240 -> V_241 ;
if ( V_228 -> V_66 . V_242 )
memcpy ( & V_219 , V_228 -> V_66 . V_242 , sizeof( V_219 ) ) ;
}
if ( ! V_11 ) {
F_36 ( & V_228 -> V_66 , L_43 ) ;
return - V_243 ;
}
V_233 = F_151 ( V_228 , V_244 , 0 ) ;
V_134 = F_152 ( V_228 , 0 ) ;
if ( ! V_233 || ( int ) V_134 <= 0 ) {
F_36 ( & V_228 -> V_66 , L_44 ) ;
return - V_243 ;
}
V_6 = F_153 ( & V_228 -> V_66 , sizeof( * V_6 ) , V_212 ) ;
if ( ! V_6 ) {
F_36 ( & V_228 -> V_66 , L_45 ) ;
return - V_245 ;
}
V_6 -> V_10 = F_154 ( & V_228 -> V_66 ,
V_233 -> V_158 , F_155 ( V_233 ) ) ;
if ( ! V_6 -> V_10 ) {
F_36 ( & V_228 -> V_66 , L_46 ) ;
return - V_246 ;
}
V_6 -> V_11 = V_11 ;
F_156 ( & V_6 -> V_9 ) ;
...
V_14 -> V_10 = V_6 -> V_10 ;
V_14 -> V_6 = V_6 ;
F_147 ( V_14 , & V_219 . V_237 ) ;
F_148 ( V_14 , & V_219 . V_237 ) ;
V_7 = F_38 ( V_14 , & V_228 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_228 -> V_66 , L_47 ) ;
return V_7 ;
}
V_14 = & V_6 -> V_30 ;
V_14 -> V_10 = V_6 -> V_10 + 0x40 ;
V_14 -> V_6 = V_6 ;
F_147 ( V_14 , & V_219 . V_238 ) ;
F_148 ( V_14 , & V_219 . V_238 ) ;
V_7 = F_38 ( V_14 , & V_228 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_228 -> V_66 , L_48 ) ;
goto V_247;
}
F_157 ( & V_228 -> V_66 ) ;
F_158 ( & V_228 -> V_66 , V_6 ) ;
V_7 = F_159 ( & V_228 -> V_66 , V_134 , & F_86 , 0 ,
F_160 ( & V_228 -> V_66 ) , V_6 ) ;
if ( V_7 ) {
F_36 ( & V_228 -> V_66 , L_49 ) ;
goto V_248;
}
V_7 = F_161 ( & V_228 -> V_66 , & V_249 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_228 -> V_66 , L_50 ) ;
goto V_248;
}
V_7 = F_162 ( & V_228 -> V_66 , & V_250 ,
V_251 , F_145 ( V_251 ) ) ;
if ( V_7 < 0 ) {
F_36 ( & V_228 -> V_66 , L_51 ) ;
goto V_252;
}
return V_7 ;
V_252:
...
static int F_165 ( struct V_227 * V_228 )
{
struct V_5 * V_6 ;
V_6 = F_166 ( & V_228 -> V_66 ) ;
F_164 ( & V_228 -> V_66 ) ;
F_167 ( & V_228 -> V_66 ) ;
F_163 ( & V_228 -> V_66 ) ;
F_39 ( & V_6 -> V_29 ) ;
