...
static enum V_243 F_80 ( struct V_187
* V_202 , bool V_244 )
{
return V_245 ;
}
static void F_81 ( struct V_187 * V_202 )
{
struct V_203 * V_203 = F_70 ( V_202 ) ;
F_82 ( V_203 -> V_205 ) ;
F_83 ( V_202 ) ;
...
static struct V_187 * F_84 ( struct V_4 * V_5 )
{
struct V_187 * V_202 ;
struct V_203 * V_203 ;
...
struct V_187 * V_202 ;
int V_117 ;
V_7 -> V_191 . V_249 = true ;
V_7 -> V_5 -> V_250 . V_251 = V_252 ;
V_7 -> V_5 -> V_250 . V_253 = V_254 ;
V_7 -> V_5 -> V_250 . V_255 = V_7 -> V_236 . V_256 ;
F_51 ( V_7 ) ;
V_195 = F_66 ( V_7 -> V_5 ) ;
if ( ! V_195 ) {
F_33 ( L_5 ) ;
